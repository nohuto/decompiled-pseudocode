/*
 * XREFs of ?TrimCheckCandidatesList@COverlayContext@@CA_NAEBV?$span@PEAVCOverlayContext@@$0?0@gsl@@PEAV?$vector_facade@PEAVOverlayPlaneInfo@COverlayContext@@V?$buffer_impl@PEAVOverlayPlaneInfo@COverlayContext@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@@Z @ 0x1801B84D8
 * Callers:
...
LABEL_10:
    ...
    for ( i = &v8[*a1]; v8 != i; ++v8 )
    {
      ...
      gsl::span<COverlayContext::OverlayPlaneInfo *,-1>::span<COverlayContext::OverlayPlaneInfo *,-1>(
        (gsl::details *)v16,
        a2);
      COverlayContext::GetContextCandidates((__int64)v11, (__int64)v16, (detail::liberal_expansion_policy *)&v18);
      v12 = *((_BYTE *)v11 + 11328);
      gsl::span<COverlayContext::OverlayPlaneInfo *,-1>::span<COverlayContext::OverlayPlaneInfo *,-1>(
        (gsl::details *)v17,
        (__int64 *)&v18);
