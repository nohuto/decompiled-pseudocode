/*
 * XREFs of ?GdiSpriteBitmapUpdateSurface@CChannel@@UEAAJIW4DXGI_FORMAT@@@Z @ 0x1800D8B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::GdiSpriteBitmapUpdateSurface(CChannel *this, unsigned int a2, enum DXGI_FORMAT a3)
{
  unsigned int v6; // ebx
