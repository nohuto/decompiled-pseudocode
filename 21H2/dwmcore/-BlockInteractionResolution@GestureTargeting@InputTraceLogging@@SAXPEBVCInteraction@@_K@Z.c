/*
 * XREFs of ?BlockInteractionResolution@GestureTargeting@InputTraceLogging@@SAXPEBVCInteraction@@_K@Z @ 0x1801F1D78
 * Callers:
 ...
 *     ?InteractionInputSink@InputTraceLogging@@CAPEAXPEBVCInteraction@@@Z @ 0x18017C768 (-InteractionInputSink@InputTraceLogging@@CAPEAXPEBVCInteraction@@@Z.c)
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@U1@U?$_tlgWrapSz@D@@U2@U?$_tlgWrapperByVal@$03@@U1@U3@U3@U3@U3@U3@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@33AEBU?$_tlgWrapSz@D@@4AEBU?$_tlgWrapperByVal@$03@@3555553@Z @ 0x1801F1828 (--$Write@U-$_tlgWrapperByVal@$07@@U1@U1@U-$_tlgWrapSz@D@@U2@U-$_tlgWrapperByVal@$03@@U1@U3@U3@U3.c)
 */
        ...
        __int64 a2)
{
  ...
  if ( *(_DWORD *)v4[1] > 4u && tlgKeywordOn(v4[1], 2048LL) )
  {
    ...
    LODWORD(v25) = v6;
    LODWORD(v26) = InputTraceLogging::InteractionInputTransparency(a1);
    v14 = InputTraceLogging::InteractionFurtherProcessingForInput(a1);
    if ( a1 )
      v8 = *((_BYTE *)a1 + 192) & 1;
    else
      v8 = v7;
    ...
    if ( a1 )
      ...
      v9 = v7;
    v16 = v9;
    v19 = (__int64)InputTraceLogging::InteractionInputSink(a1);
    if ( a1 )
      v11 = *((_DWORD *)a1 + 426);
    v17 = v11;
    v20 = (__int64)InputTraceLogging::InteractionDefaultToString(v10);
    v21 = (__int64)InputTraceLogging::InteractionSourceTypeToString(a1);
    v22 = (__int64)a1;
    v23 = (__int64)a1;
    v24 = a2;
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapperByVal<8>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapperByVal<8>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<8>>(
      v13,
      (unsigned __int8 *)dword_18036FE1A,
      v12,
      v13,
      (__int64)&v24,
      (__int64)&v23,
