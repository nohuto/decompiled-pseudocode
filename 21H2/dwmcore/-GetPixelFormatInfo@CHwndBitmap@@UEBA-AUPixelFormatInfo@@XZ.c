/*
 * XREFs of ?GetPixelFormatInfo@CHwndBitmap@@UEBA?AUPixelFormatInfo@@XZ @ 0x1801C4830
 * Callers:
 *     ?IsOpaque@CHwndBitmap@@UEBA_NXZ @ 0x1801C4A60 (-IsOpaque@CHwndBitmap@@UEBA_NXZ.c)
 * Callees:
