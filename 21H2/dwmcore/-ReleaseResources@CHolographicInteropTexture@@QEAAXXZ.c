/*
 * XREFs of ?ReleaseResources@CHolographicInteropTexture@@QEAAXXZ @ 0x180259954
 * Callers:
 *     ?ReleaseInteropTextures@CHolographicManager@@QEAAXXZ @ 0x1802540F0 (-ReleaseInteropTextures@CHolographicManager@@QEAAXXZ.c)
