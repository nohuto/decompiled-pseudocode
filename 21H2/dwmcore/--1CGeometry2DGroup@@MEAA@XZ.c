/*
 * XREFs of ??1CGeometry2DGroup@@MEAA@XZ @ 0x180113A1A
 * Callers:
...
void __fastcall CGeometry2DGroup::~CGeometry2DGroup(CGeometry2DGroup *this)
{
  ...
  *((_QWORD *)this + 10) = &CGeometry2DGroup::`vftable'{for `CCyclicResourceListEntry'};
  CGeometry2DGroup::UnRegisterNotifiers(this);
  *((_QWORD *)this + 10) = &CCyclicResourceListEntry::`vftable';
  v2 = (CGeometry2DGroup **)*((_QWORD *)this + 11);
  if ( v2[1] != (CGeometry2DGroup *)((char *)this + 88)
    || (v3 = (CGeometry2DGroup **)*((_QWORD *)this + 12), *v3 != (CGeometry2DGroup *)((char *)this + 88)) )
  {
    __fastfail(3u);
  }
