/*
 * XREFs of ?RemoveDataProvider@DataProviderManager@@QEAAJPEAVDataProviderProxy@@@Z @ 0x180164E78
 * Callers:
 ...
 *     ?OnDisconnected@DataProviderProxy@@MEAAJXZ @ 0x180181AF0 (-OnDisconnected@DataProviderProxy@@MEAAJXZ.c)
 * Callees:
