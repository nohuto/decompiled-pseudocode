/*
 * XREFs of ?GetCurrentRenderingRealization@CGdiSpriteBitmap@@UEAAJPEAPEAVIBitmapRealization@@@Z @ 0x1800D0930
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IBitmapRealization **a2)
{
  ...
  *a2 = 0LL;
  if ( !this[41] )
  {
    ...
    if ( Bitmap < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0LL, Bitmap, 0x97u);
  }
  if ( this[41] )
  {
    v5 = this[41];
