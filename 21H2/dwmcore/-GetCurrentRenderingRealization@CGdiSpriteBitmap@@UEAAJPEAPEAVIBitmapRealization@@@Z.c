/*
 * XREFs of ?GetCurrentRenderingRealization@CGdiSpriteBitmap@@UEAAJPEAPEAVIBitmapRealization@@@Z @ 0x1800C329C
 * Callers:
 *     ?GetCurrentRenderingRealization@CGdiSpriteBitmap@@$4PPPPPPPM@A@EAAJPEAPEAVIBitmapRealization@@@Z @ 0x1800F66A0 (-GetCurrentRenderingRealization@CGdiSpriteBitmap@@$4PPPPPPPM@A@EAAJPEAPEAVIBitmapRealization@@@Z.c)
 * Callees:
