/*
 * XREFs of ?SetTint@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleColorBehavior@@@Z @ 0x18017378C
 * Callers:
...
__int64 __fastcall CParticleBehaviorsGeneratedT<CParticleBehaviors,CPropertyChangeResource>::SetTint(
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[14] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x262u, 0LL);
    }
    else
    {
