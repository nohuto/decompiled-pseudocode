/*
 * XREFs of ??4?$com_ptr_t@UID3D11PixelShader@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@PEAUID3D11PixelShader@@@Z @ 0x1800F40E0
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<ID3D11PixelShader,wil::err_returncode_policy>::operator=(__int64 *a1, __int64 a2)
{
  __int64 v2; // rdi
