/*
 * XREFs of ?ProcessCaptureBits@CDesktopTree@@QEAAJPEAVCChannelContext@@PEBUtagMILCMD_DESKTOPTREE_CAPTUREBITS@@@Z @ 0x1802448F4
 * Callers:
        ...
        const struct tagMILCMD_DESKTOPTREE_CAPTUREBITS *a3)
{
        ...
        (v9 = v8) != 0LL) )
  {
    ...
    v12 = v10;
    if ( v10 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0x25u);
    (*(void (__fastcall **)(struct CaptureBitsResponse *))(*(_QWORD *)v9 + 40LL))(v9);
  }
  else
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0LL, -2147024882, 0x21u);
  }
  return v12;
}
