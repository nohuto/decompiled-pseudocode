/*
 * XREFs of ?HrCreateDestBitmapCopy@@YAJPEAVIBitmapSource@@PEAUWICRect@@PEAPEAVIBitmapDest@@@Z @ 0x1802A72E8
 * Callers:
...
LABEL_6:
    v14 = v11;
LABEL_10:
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0LL, v14, v16);
  }
