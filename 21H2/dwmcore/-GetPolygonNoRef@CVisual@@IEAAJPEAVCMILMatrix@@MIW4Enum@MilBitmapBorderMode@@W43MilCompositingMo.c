/*
 * XREFs of ?GetPolygonNoRef@CVisual@@IEAAJPEAVCMILMatrix@@MIW4Enum@MilBitmapBorderMode@@W43MilCompositingMode@@W43MilBitmapInterpolationMode@@_N44PEAPEAVCPolygon@@@Z @ 0x1801F742C
 * Callers:
        ...
        __int64 *a11)
{
  ...
  void *v48[2]; // [rsp+C0h] [rbp-40h] BYREF
...
LABEL_14:
      v24 = v20;
LABEL_44:
      MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0LL, v24, v38);
      DynArrayImpl<1>::~DynArrayImpl<1>(v48);
      goto LABEL_45;
    }
    if ( v19 > (unsigned int)v50 )
    {
      v23 = DynArrayImpl<0>::AddMultipleAndSet((unsigned __int64)v48, 0x14u, 1, &v46);
      v20 = v23;
      v15 = v23;
      if ( v23 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v21, 0LL, 0LL, v23, 0xC0u);
        goto LABEL_13;
      }
      v19 = HIDWORD(v50);
    }
    ...
    *(_QWORD *)&v40 = __PAIR64__(DWORD1(v45), DWORD2(v45));
    ...
    if ( v19 + 1 < v19 )
    {
      v15 = -2147024362;
      v20 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v21, 0LL, 0LL, -2147024362, 0xB5u);
LABEL_22:
      v38 = 5866;
      goto LABEL_14;
    }
    ...
    {
      v28 = DynArrayImpl<0>::AddMultipleAndSet((unsigned __int64)v48, 0x14u, 1, &v46);
      v20 = v28;
      v15 = v28;
      if ( v28 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v26, 0LL, 0LL, v28, 0xC0u);
        goto LABEL_22;
      }
      v25 = HIDWORD(v50);
    }
    ...
    *(_QWORD *)&v41 = *((_QWORD *)&v45 + 1);
    ...
    if ( v25 + 1 < v25 )
    {
      v15 = -2147024362;
      v20 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v26, 0LL, 0LL, -2147024362, 0xB5u);
LABEL_30:
      v38 = 5868;
      goto LABEL_14;
    }
    ...
    {
      v32 = DynArrayImpl<0>::AddMultipleAndSet((unsigned __int64)v48, 0x14u, 1, &v46);
      v20 = v32;
      v15 = v32;
      if ( v32 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast((__int64)v30, 0LL, 0LL, v32, 0xC0u);
        goto LABEL_30;
      }
      v29 = HIDWORD(v50);
    }
    ...
    *(_QWORD *)&v42 = __PAIR64__(HIDWORD(v45), v45);
    ...
    if ( v29 + 1 < v29 )
    {
      v15 = -2147024362;
      v20 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v30, 0LL, 0LL, -2147024362, 0xB5u);
LABEL_41:
      v38 = 5870;
      goto LABEL_14;
    }
    ...
    {
      v35 = DynArrayImpl<0>::AddMultipleAndSet((unsigned __int64)v48, 0x14u, 1, &v46);
      v20 = v35;
      v15 = v35;
      if ( v35 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0LL, v35, 0xC0u);
        goto LABEL_41;
      }
    }
    else
