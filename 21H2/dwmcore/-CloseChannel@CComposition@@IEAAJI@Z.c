/*
 * XREFs of ?CloseChannel@CComposition@@IEAAJI@Z @ 0x1800CF8B0
 * Callers:
 ...
 *     ?ReleaseHandleTableEntries@CResourceTable@@QEAA_NPEAVCComposition@@PEAVCChannelContext@@@Z @ 0x18005EADC (-ReleaseHandleTableEntries@CResourceTable@@QEAA_NPEAVCComposition@@PEAVCChannelContext@@@Z.c)
 ...
 *     ?Remove@?$DynArray@PEAVCChannelContext@@$00@@QEAAHAEBQEAVCChannelContext@@@Z @ 0x1800CF9C4 (-Remove@-$DynArray@PEAVCChannelContext@@$00@@QEAAHAEBQEAVCChannelContext@@@Z.c)
...
__int64 __fastcall CComposition::CloseChannel(CComposition *this, unsigned int a2)
{
  ...
  else
  {
    ...
    CResourceTable::ReleaseHandleTableEntries(v8[3], v9, v8);
    CDrawListEntry::Release((CDrawListEntry *)v8);
