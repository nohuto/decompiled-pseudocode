/*
 * XREFs of wil_details_FeatureReporting_RecordUsageInCache @ 0x1800EB80C
 * Callers:
 ...
 * Callees:
 *     wil_details_FeatureReporting_IncrementOpportunityInCache @ 0x1800EB638 (wil_details_FeatureReporting_IncrementOpportunityInCache.c)
 *     wil_details_FeatureReporting_IncrementUsageInCache @ 0x1800EB720 (wil_details_FeatureReporting_IncrementUsageInCache.c)
 */
