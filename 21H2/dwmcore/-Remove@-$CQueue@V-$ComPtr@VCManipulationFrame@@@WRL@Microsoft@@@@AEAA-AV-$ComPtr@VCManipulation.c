/*
 * XREFs of ?Remove@?$CQueue@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@AEAA?AV?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@_NPEAI@Z @ 0x18017EC70
 * Callers:
 *     ??1?$CQueue@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@QEAA@XZ @ 0x1801002C8 (--1-$CQueue@V-$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@QEAA@XZ.c)
...
LABEL_8:
  if ( v8 != (__int64 *)a1 )
  {
    ...
    if ( v8 )
    {
      Microsoft::WRL::ComPtr<CVector3Force>::InternalRelease(v8 + 2);
      operator delete(v8);
    }
    --*(_DWORD *)(a1 + 16);
  }
