/*
 * XREFs of ?Remove@?$CQueue@V?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@@@AEAA?AV?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@_NPEAI@Z @ 0x1800E6630
 * Callers:
...
LABEL_10:
  ...
  v7 = (void **)qword_18034B568;
  v11 = *(_QWORD **)(qword_18034B568 + 8);
  if ( *(void ***)qword_18034B568 != &CManipulationManager::s_InputQueue || *v11 != qword_18034B568 )
    goto LABEL_10;
  qword_18034B568 = *(_QWORD *)(qword_18034B568 + 8);
