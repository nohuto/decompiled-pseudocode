/*
 * XREFs of ?RenderEffect@CTreeEffectLayer@@IEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBUD2D_SIZE_F@@@Z @ 0x1800051C4
 * Callers:
...
LABEL_12:
  ...
  *(_QWORD *)(v21 + 8) = this;
  ...
  v23 = (*(__int64 (__fastcall **)(__int64, struct CDrawingContext *, unsigned int *, _QWORD))(*(_QWORD *)v22 + 16LL))(
          v22,
          a2,
          a5,
          0LL);
