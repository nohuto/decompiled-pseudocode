/*
 * XREFs of ?_Tidy@?$vector@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@V?$allocator@V?$unique_ptr@VCSyncLockGroup@@U?$default_delete@VCSyncLockGroup@@@std@@@std@@@2@@std@@AEAAXXZ @ 0x180100524
 * Callers:
 *     _dynamic_atexit_destructor_for__CSyncLockGroup::g_syncLockGroups__ @ 0x18010D880 (_dynamic_atexit_destructor_for__CSyncLockGroup--g_syncLockGroups__.c)
 * Callees:
