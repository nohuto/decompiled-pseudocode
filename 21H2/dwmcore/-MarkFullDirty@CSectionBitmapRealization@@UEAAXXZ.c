/*
 * XREFs of ?MarkFullDirty@CSectionBitmapRealization@@UEAAXXZ @ 0x180267324
 * Callers:
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXXZ @ 0x1800F87D0 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXXZ.c)
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXXZ @ 0x1800F87E0 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXXZ.c)
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@EA@EAAXXZ @ 0x1800F89C0 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@EA@EAAXXZ.c)
 * Callees:
