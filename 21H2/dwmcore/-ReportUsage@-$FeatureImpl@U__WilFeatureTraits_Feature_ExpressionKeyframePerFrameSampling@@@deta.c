/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_ExpressionKeyframePerFrameSampling@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800F0070
 * Callers:
 *     ?PrepareForCalculation@CExpression@@MEAAXPEA_N@Z @ 0x1800AD490 (-PrepareForCalculation@CExpression@@MEAAXPEA_N@Z.c)
 * Callees:
...
_UNKNOWN **wil::details::FeatureImpl<__WilFeatureTraits_Feature_ExpressionKeyframePerFrameSampling>::ReportUsage(
        ...
        ...)
{
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *(_QWORD *)wil::details::FeatureImpl<__WilFeatureTraits_Feature_ExpressionKeyframePerFrameSampling>::GetCachedFeatureEnabledState(
                      a1,
                      (signed __int32 *)&v7);
    v7 = v3;
  }
