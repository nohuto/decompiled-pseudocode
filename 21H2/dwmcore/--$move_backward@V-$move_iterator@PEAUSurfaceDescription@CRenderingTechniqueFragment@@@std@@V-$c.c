/*
 * XREFs of ??$move_backward@V?$move_iterator@PEAUSurfaceDescription@CRenderingTechniqueFragment@@@std@@V?$checked_array_iterator@PEAUSurfaceDescription@CRenderingTechniqueFragment@@@stdext@@@std@@YA?AV?$checked_array_iterator@PEAUSurfaceDescription@CRenderingTechniqueFragment@@@stdext@@V?$move_iterator@PEAUSurfaceDescription@CRenderingTechniqueFragment@@@0@0V12@@Z @ 0x1802AC8C4
 * Callers:
        ...
        __int64 *a4)
{
  ...
  v6 = a3 - (_QWORD)a2;
  v7 = 0x5555555555555555LL * ((a3 - (__int64)a2) >> 2);
  if ( v7 >= 0 )
  {
    if ( v7 <= 0 )
      goto LABEL_7;
...
LABEL_7:
  v9 = *a4;
  a4[2] = 0xAAAAAAAAAAAAAAABuLL * (((__int64)memmove_0((void *)(*a4 + 12 * a4[2] - v6), a2, v6) - v9) >> 2);
  result = a1;
  v11 = a4[2];
  *(_OWORD *)a1 = *(_OWORD *)a4;
  *(_QWORD *)(a1 + 16) = v11;
