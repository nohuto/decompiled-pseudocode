/*
 * XREFs of ?FlattenToLineSegments@CShape@@UEBAJMPEAPEAV1@@Z @ 0x1801906F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CPolygonShape@@QEAA@PEAUID2D1Geometry@@@Z @ 0x1800D3448 (--0CPolygonShape@@QEAA@PEAUID2D1Geometry@@@Z.c)
...
__int64 __fastcall CShape::FlattenToLineSegments(CShape *this, float a2, struct CShape **a3)
{
  ...
  if ( v7 < 0 )
  {
    v16 = 419;
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, v16);
    goto LABEL_17;
  }
...
LABEL_10:
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0LL, -2147024882, 0x1A6u);
    goto LABEL_17;
  }
