/*
 * XREFs of ?ReleaseCopyBuffers@CWICBitmapWrapper@@UEAAJXZ @ 0x1802719B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWICBitmapWrapper::ReleaseCopyBuffers(CWICBitmapWrapper *this)
{
  ...
  if ( v1 )
  {
    ...
    if ( v2 >= 0 )
    {
      ...
      v3 = v4;
      if ( v4 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, v4, 0x96u);
      if ( v8 )
  ...
  {
    v3 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0LL, -2003292412, 0x9Cu);
  }
  return v3;
}
