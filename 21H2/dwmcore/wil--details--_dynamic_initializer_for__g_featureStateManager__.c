/*
 * XREFs of wil::details::_dynamic_initializer_for__g_featureStateManager__ @ 0x180001230
 * Callers:
 *     <none>
 * Callees:
 *     ??0FeatureStateManager@details@wil@@QEAA@XZ @ 0x1800AE834 (--0FeatureStateManager@details@wil@@QEAA@XZ.c)
 */
