        ...
        const char **a15)
{
  ...
  v31 = 8LL;
  v29 = 4LL;
  return tlgWriteTransfer_EventWriteTransfer((__int64)&dword_1803D1270, a2, 0LL, 0LL, 0xDu, &v27);
}
