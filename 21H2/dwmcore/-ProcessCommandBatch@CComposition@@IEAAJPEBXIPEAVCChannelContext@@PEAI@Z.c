/*
 * XREFs of ?ProcessCommandBatch@CComposition@@IEAAJPEBXIPEAVCChannelContext@@PEAI@Z @ 0x1800A3070
 * Callers:
 ...
 *     ?GetStackCaptureRootFailureAddress@@YAPEAXJ@Z @ 0x1802167A4 (-GetStackCaptureRootFailureAddress@@YAPEAXJ@Z.c)
