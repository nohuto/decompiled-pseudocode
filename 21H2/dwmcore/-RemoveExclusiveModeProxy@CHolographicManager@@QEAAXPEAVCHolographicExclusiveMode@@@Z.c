/*
 * XREFs of ?RemoveExclusiveModeProxy@CHolographicManager@@QEAAXPEAVCHolographicExclusiveMode@@@Z @ 0x18029660C
 * Callers:
 *     ??1CHolographicExclusiveMode@@MEAA@XZ @ 0x180298850 (--1CHolographicExclusiveMode@@MEAA@XZ.c)
