/*
 * XREFs of ?RemoveExclusiveModeProxy@CHolographicManager@@QEAAXPEAVCHolographicExclusiveMode@@@Z @ 0x180254130
 * Callers:
 *     ??1CHolographicExclusiveMode@@MEAA@XZ @ 0x180256920 (--1CHolographicExclusiveMode@@MEAA@XZ.c)
