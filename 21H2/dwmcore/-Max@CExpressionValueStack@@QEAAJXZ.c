/*
 * XREFs of ?Max@CExpressionValueStack@@QEAAJXZ @ 0x18024E608
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Max(CExpressionValueStack *this)
{
  ...
  if ( *((_DWORD *)this + 4) >= 2u )
  {
    ...
    if ( v11 == *((_DWORD *)v4 + 18) )
    {
      ...
      {
        case 18:
          v19 = fmaxf(*(float *)v7, *v4);
          *((_DWORD *)v7 + 18) = 18;
          *(float *)v7 = v19;
          break;
        case 35:
          v17 = fmaxf(*(float *)v7, *v4);
          v18 = fmaxf(*((float *)v7 + 1), v4[1]);
          *((_DWORD *)v7 + 18) = 35;
          *(float *)v7 = v17;
          *((float *)v7 + 1) = v18;
          break;
        case 52:
          v14 = fmaxf(COERCE_FLOAT(*v7), COERCE_FLOAT(*(_QWORD *)v4));
          v15 = fmaxf(COERCE_FLOAT(HIDWORD(*v7)), COERCE_FLOAT(HIDWORD(*(_QWORD *)v4)));
          v16 = fmaxf(*((float *)v7 + 2), v4[2]);
          *((_DWORD *)v7 + 18) = 52;
          *(float *)v7 = v14;
          *((float *)v7 + 1) = v15;
          *((float *)v7 + 2) = v16;
