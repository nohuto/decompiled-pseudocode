/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@PEBVCResource@@PEAVCWeakResourceReference@@V?$_Uhash_compare@PEBVCResource@@U?$hash@PEBVCResource@@@std@@U?$equal_to@PEBVCResource@@@3@@std@@V?$allocator@U?$pair@QEBVCResource@@PEAVCWeakResourceReference@@@std@@@4@$0A@@std@@@std@@IEAAX_K@Z @ 0x180032148
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  result = (unsigned __int64)std::_Hash_vec<std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<CResource const * const,CWeakResourceReference *>>>>>>::_Assign_grow(
                               ...
                               qword_1803D37B8);
  v8 = v5 - 1;
  *((_QWORD *)&xmmword_1803D37E0 + 1) = v5;
  *(_QWORD *)&xmmword_1803D37E0 = v5 - 1;
  v9 = *(const unsigned __int8 **)qword_1803D37B8;
  v10 = *(const unsigned __int8 **)qword_1803D37B8;
  while ( v9 != (const unsigned __int8 *)v3 )
  {
    ...
    v13 = qword_1803D37C8;
    v14 = 2 * (v8 & result);
    if ( *(_QWORD *)(qword_1803D37C8 + 16 * (v8 & result)) == v3 )
    {
      *(_QWORD *)(qword_1803D37C8 + 16 * (v8 & result)) = v12;
LABEL_6:
      *(_QWORD *)(v13 + 8 * v14 + 8) = v12;
      goto LABEL_7;
    }
    result = *(_QWORD *)(qword_1803D37C8 + 16 * (v8 & result) + 8);
    v7 = *v11;
    ...
    do
    {
      ...
      if ( *(_QWORD *)(qword_1803D37C8 + 8 * v14) == result )
      {
