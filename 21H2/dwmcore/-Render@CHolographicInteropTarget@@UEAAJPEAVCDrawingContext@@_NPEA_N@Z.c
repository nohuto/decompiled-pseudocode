/*
 * XREFs of ?Render@CHolographicInteropTarget@@UEAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1800F2900
 * Callers:
 *     ?Render@CHolographicInteropTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z @ 0x1800F8520 (-Render@CHolographicInteropTarget@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@_NPEA_N@Z.c)
 * Callees:
 ...
 *     ?PostInteropTextureUpdate@CHolographicManager@@QEAAXIPEAX0@Z @ 0x180253FC8 (-PostInteropTextureUpdate@CHolographicManager@@QEAAXIPEAX0@Z.c)
        ...
        bool *a4)
{
  ...
  LODWORD(v4) = 0;
  v5 = qword_1803474E8 + 1;
  *a4 = 0;
  qword_1803474E8 = v5;
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20000) != 0 )
    McTemplateU0xx_EventWriteTransfer(this, &EVTDESC_HOLOGRAPHICINTEROPTARGET_RENDER, v5, qword_1803474F0);
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20000) != 0 )
    McTemplateU0xxxx_EventWriteTransfer(
      ...
      qword_1803474E8,
      qword_1803474F0,
      qword_1803474E8 - qword_1803474F0,
      v4);
  return 0LL;
}
