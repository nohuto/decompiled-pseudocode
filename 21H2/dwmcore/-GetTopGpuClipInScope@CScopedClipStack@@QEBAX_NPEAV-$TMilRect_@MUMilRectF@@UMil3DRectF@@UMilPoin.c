/*
 * XREFs of ?GetTopGpuClipInScope@CScopedClipStack@@QEBAX_NPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800E02C4
 * Callers:
 *     ?PopCpuClip@CDrawingContext@@AEAAXXZ @ 0x180177A18 (-PopCpuClip@CDrawingContext@@AEAAXXZ.c)
 * Callees:
 *     ?HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ @ 0x18006BA34 (-HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ.c)
