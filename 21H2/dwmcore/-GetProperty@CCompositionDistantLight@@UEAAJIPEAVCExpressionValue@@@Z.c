/*
 * XREFs of ?GetProperty@CCompositionDistantLight@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801B9B30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CExpressionValue *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, -2147024809, 0x7Cu, (void *)(v7 & v10));
  }
  return v4;
}
