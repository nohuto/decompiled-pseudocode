/*
 * XREFs of ?GetProperty@CCompositionDistantLight@@UEAAJIPEAVCExpressionValue@@@Z @ 0x18020C670
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CExpressionValue *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, -2147024809, 0x6Eu);
  }
  return v4;
}
