/*
 * XREFs of ?_Change_array@?$vector@Ufloat4@Numerics@Foundation@Windows@@V?$allocator@Ufloat4@Numerics@Foundation@Windows@@@std@@@std@@AEAAXQEAUfloat4@Numerics@Foundation@Windows@@_K1@Z @ 0x1801A676C
 * Callers:
