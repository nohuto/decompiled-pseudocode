/*
 * XREFs of ?Snapshot@CCachedVisualImage@@IEAAJXZ @ 0x1800312D4
 * Callers:
...
__int64 __fastcall CCachedVisualImage::Snapshot(CCachedVisualImage::CCachedTarget ***this)
{
  ...
  CDisplayManager::GetPrimaryAdapterLuid((CDisplayManager *)this, (struct _LUID *)&v13);
  LODWORD(v14) = 0;
