/*
 * XREFs of ?EnsureShaderCache@CBrushRenderingGraphBuilder@@IEAAJ_N@Z @ 0x1800497D4
 * Callers:
 ...
 * Callees:
 *     ?GetUniqueShaderCache@CRenderingTechniqueFragment@@QEBAPEAVCCompiledEffectCache@@XZ @ 0x1800498E8 (-GetUniqueShaderCache@CRenderingTechniqueFragment@@QEBAPEAVCCompiledEffectCache@@XZ.c)
...
LABEL_12:
    ...
    *(_QWORD *)(*(_QWORD *)this + 184LL) = v13;
    ...
    {
      v3 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v13, 0LL, 0, -2147024882, 0x2A4u, 0LL);
    }
  }
  return v3;
}
