/*
 * XREFs of ?DriverUpdateInProgress@CDisplayManager@@IEAA_NXZ @ 0x180277428
 * Callers:
...
char __fastcall CDisplayManager::DriverUpdateInProgress(_RTL_CRITICAL_SECTION *this)
{
  ...
  _RTL_CRITICAL_SECTION *v14; // [rsp+80h] [rbp+30h] BYREF
    ...
    while ( 1 )
    {
      ...
      if ( (int)CKMAdapterHandle::Initialize((CKMAdapterHandle *)&v14, v16) >= 0 )
      {
        ...
        if ( v15 )
        {
          ...
          wil::com_ptr_t<CVisual,wil::err_returncode_policy>::~com_ptr_t<CVisual,wil::err_returncode_policy>((__int64 *)&v16);
          goto LABEL_13;
        }
      }
      CKMAdapterHandle::~CKMAdapterHandle((CKMAdapterHandle *)&v14);
