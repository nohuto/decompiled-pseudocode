/*
 * XREFs of ?DrawScene3D@CDrawingContext@@QEAAJPEAUISpectreWorld@@PEAVCCompositionEnvironmentLight@@AEBVCMILMatrix@@@Z @ 0x180176198
 * Callers:
        ...
        const struct CMILMatrix *a4)
{
  ...
  if ( *((_QWORD *)CurrentVisual + 78) > *(_QWORD *)(*((_QWORD *)CurrentVisual + 2) + 160LL) )
  {
    ...
    *(_OWORD *)v107 = 0LL;
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x416u, 0LL);
      goto LABEL_79;
    }
    _44 = v103._44;
      ...
      && !*((_DWORD *)this + 70) )
    {
      ...
      if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v30 - v21) & _xmm) >= 0.0000011920929 )
      {
        ...
        if ( v31 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v32, 0LL, 0, v31, 0x457u, 0LL);
          goto LABEL_30;
        }
        v97 = 1;
      }
      ...
      *(_QWORD *)&v115.left = v125;
      ...
      if ( v35 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0, v35, 0x462u, 0LL);
      }
      else
      {
        ...
        if ( v37 >= 0 )
        {
          ...
          v5 = v41;
          if ( v41 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v42, 0LL, 0, v41, 0x465u, 0LL);
          if ( !v40 )
            goto LABEL_30;
          v44 = (CD3DDevice *)((char *)v40 + 8);
          goto LABEL_29;
        }
        MilInstrumentationCheckHR_MaybeFailFast(v38, 0LL, 0, v37, 0x464u, 0LL);
      }
      if ( v99 )
      {
...
LABEL_30:
    ...
    if ( ExistingDevice < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v47, 0LL, 0, ExistingDevice, 0x46Fu, 0LL);
      v94 = v99;
      if ( !v99 )
        goto LABEL_68;
      goto LABEL_67;
    ...
    *(_QWORD *)&v112.y = 1LL;
    ...
    if ( v56 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v57, 0LL, 0, v56, 0x48Bu, 0LL);
      goto LABEL_66;
    }
    v58 = v98;
    v99 = 0LL;
    ...
    if ( v62 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v63, 0LL, 0, v62, 0x490u, 0LL);
LABEL_73:
...
LABEL_56:
      ...
      if ( v84 >= 0 )
      {
        ...
        if ( v88 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v89, 0LL, 0, v88, 0x4D0u, 0LL);
        }
        else
        {
          v99 = 0LL;
          ...
          if ( v90 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v91, 0LL, 0, v90, 0x4DAu, 0LL);
          }
          else
          {
            ...
            v5 = v92;
            if ( v92 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(v93, 0LL, 0, v92, 0x4DFu, 0LL);
          }
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v85, 0LL, 0, v84, 0x4C5u, 0LL);
      lambda_2c23dc335d575e6068a59f43383614b1_::operator()(v105);
      if ( v107[0] )
      {
        std::_Deallocate<16,0>(v107[0], (v108 - (unsigned __int64)v107[0]) & 0xFFFFFFFFFFFFFFF8uLL);
...
LABEL_51:
    ...
    if ( (v70 - v71) >> 3 )
    {
      do
      {
        if ( (*(int (__fastcall **)(_QWORD, _D3DMATRIX *, _BYTE *))(**((_QWORD **)v122[0] + (unsigned int)v74) + 304LL))(
