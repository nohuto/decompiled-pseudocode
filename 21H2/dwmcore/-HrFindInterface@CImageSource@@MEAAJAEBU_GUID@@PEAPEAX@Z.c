/*
 * XREFs of ?HrFindInterface@CImageSource@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CC5A0
 * Callers:
 *     ?HrFindInterface@CCachedVisualImage@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CC350 (-HrFindInterface@CCachedVisualImage@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
...
LABEL_8:
      if ( this )
        v6 = (char *)this + *(int *)(*((_QWORD *)this + 7) + 8LL) + 56;
      else
        v6 = 0LL;
      *a3 = v6;
      return 0LL;
