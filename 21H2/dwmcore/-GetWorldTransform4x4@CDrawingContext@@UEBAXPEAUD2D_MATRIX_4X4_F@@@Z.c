/*
 * XREFs of ?GetWorldTransform4x4@CDrawingContext@@UEBAXPEAUD2D_MATRIX_4X4_F@@@Z @ 0x180194A90
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDrawingContext::GetWorldTransform4x4(CDrawingContext *this, struct D2D_MATRIX_4X4_F *a2)
{
  ...
  TopByReference = CMatrixStack::GetTopByReference((CDrawingContext *)((char *)this + 344));
