/*
 * XREFs of ?DistanceSquared@CExpressionValueStack@@QEAAJXZ @ 0x1801FC324
 * Callers:
...
__int64 __fastcall CExpressionValueStack::DistanceSquared(CExpressionValueStack *this)
{
  ...
  if ( (unsigned int)v2 >= 2 )
  {
    ...
    if ( v10 == v6[4].m128i_i32[2] )
    {
      ...
      {
        case 18:
          v17 = (float)(*(float *)v8->m128i_i32 - *(float *)v6->m128i_i32)
              * (float)(*(float *)v8->m128i_i32 - *(float *)v6->m128i_i32);
          break;
        case 35:
          v17 = (float)((float)(*(float *)&v8->m128i_i32[1] - *(float *)&v6->m128i_i32[1])
                      * (float)(*(float *)&v8->m128i_i32[1] - *(float *)&v6->m128i_i32[1]))
              + (float)((float)(*(float *)v8->m128i_i32 - *(float *)v6->m128i_i32)
                      * (float)(*(float *)v8->m128i_i32 - *(float *)v6->m128i_i32));
          break;
        case 52:
          v17 = (float)((float)((float)(COERCE_FLOAT(HIDWORD(v8->m128i_i64[0])) - COERCE_FLOAT(HIDWORD(v6->m128i_i64[0])))
              ...
              + (float)((float)(*(float *)&v8->m128i_i32[2] - *(float *)&v6->m128i_i32[2])
                      * (float)(*(float *)&v8->m128i_i32[2] - *(float *)&v6->m128i_i32[2]));
          break;
        case 69:
