/*
 * XREFs of ??$_Insert_range@PEBUParticleBindingData@@@?$vector@UParticleBindingData@@V?$allocator@UParticleBindingData@@@std@@@std@@AEAAXV?$_Vector_const_iterator@V?$_Vector_val@U?$_Simple_types@UParticleBindingData@@@std@@@std@@@1@PEBUParticleBindingData@@1Uforward_iterator_tag@1@@Z @ 0x18019BB78
 * Callers:
 ...
 *     ?_Change_array@?$vector@UParticleBindingData@@V?$allocator@UParticleBindingData@@@std@@@std@@AEAAXQEAUParticleBindingData@@_K1@Z @ 0x1801A65F4 (-_Change_array@-$vector@UParticleBindingData@@V-$allocator@UParticleBindingData@@@std@@@std@@AEA.c)
 */
