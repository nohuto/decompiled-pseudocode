/*
 * XREFs of ?DrawLetterboxingMarginsInternal@CCompositionSurfaceBitmap@@AEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBVCMILMatrix@@@Z @ 0x180006498
 * Callers:
        ...
        const struct CMILMatrix *a4)
{
  ...
  if ( (unsigned __int8)CCompositionSurfaceBitmap::GetScaledLetterboxingMargins(a1, &v14) )
  {
    ...
    v15[2] = v10;
    v15[3] = v11;
    v12 = CCompositionSurfaceBitmap::DrawContentBorders(a2, v15, a3, &stru_180377378);
    v7 = v12;
    if ( v12 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x30Fu, 0LL);
