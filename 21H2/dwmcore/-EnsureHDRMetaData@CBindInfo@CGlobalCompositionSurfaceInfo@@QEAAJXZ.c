/*
 * XREFs of ?EnsureHDRMetaData@CBindInfo@CGlobalCompositionSurfaceInfo@@QEAAJXZ @ 0x180016038
 * Callers:
        ...
        CGlobalCompositionSurfaceInfo::CBindInfo *this)
{
  ...
  if ( CompositionSurfaceHDRMetaData < 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0, CompositionSurfaceHDRMetaData | 0x10000000, 0x611u, 0LL);
    if ( v2 < 0 )
      *v1 = 0;
  }
