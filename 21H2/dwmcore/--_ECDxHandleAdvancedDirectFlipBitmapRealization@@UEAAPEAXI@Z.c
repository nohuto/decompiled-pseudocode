/*
 * XREFs of ??_ECDxHandleAdvancedDirectFlipBitmapRealization@@UEAAPEAXI@Z @ 0x180263920
 * Callers:
 *     ??_ECDxHandleAdvancedDirectFlipBitmapRealization@@WBCA@EAAPEAXI@Z @ 0x1800F8D50 (--_ECDxHandleAdvancedDirectFlipBitmapRealization@@WBCA@EAAPEAXI@Z.c)
 * Callees:
