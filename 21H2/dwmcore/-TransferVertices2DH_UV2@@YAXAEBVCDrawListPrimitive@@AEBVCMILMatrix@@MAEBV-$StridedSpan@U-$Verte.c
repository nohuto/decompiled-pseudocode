/*
 * XREFs of ?TransferVertices2DH_UV2@@YAXAEBVCDrawListPrimitive@@AEBVCMILMatrix@@MAEBV?$StridedSpan@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@@Z @ 0x1801EC660
 * Callers:
...
_QWORD *__fastcall TransferVertices2DH_UV2(__int64 a1, CMILMatrix *a2, float a3, __int64 a4)
{
  ...
  {
    v11 = v4 + (int)(v5 * i);
    v12 = *(_QWORD *)a4 + (int)(v5 * *(_DWORD *)(a4 + 8));
    CMILMatrix::Transform(a2, (const struct D2D_POINT_2F *)v11, (struct HomogeneousPoint2D *)v12);
