/*
 * XREFs of ?GetProperty@CKeyframeAnimation@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801D15A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  v6 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024809, 0x886u, 0LL);
  return v6;
}
