/*
 * XREFs of ?GetRealization@CViewBox@@UEBAXAEBUD2D_SIZE_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801F1690
 * Callers:
 ...
 *     ?GetShapeTransformRealization@CProxyGeometry@@MEBAXPEBUD2D_SIZE_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801E6490 (-GetShapeTransformRealization@CProxyGeometry@@MEBAXPEBUD2D_SIZE_F@@PEAUD2D_MATRIX_3X2_F@@@Z.c)
 * Callees:
 *     ?SetProduct@Matrix3x2F@D2D1@@QEAAXAEBV12@0@Z @ 0x1800583B4 (-SetProduct@Matrix3x2F@D2D1@@QEAAXAEBV12@0@Z.c)
 *     __security_check_cookie @ 0x1800E6E00 (__security_check_cookie.c)
 *     ?Arrange@StretchAlign@@QEBA?AUD2D_RECT_F@@AEBUD2D_SIZE_F@@0PEAU2@@Z @ 0x1802122F8 (-Arrange@StretchAlign@@QEBA-AUD2D_RECT_F@@AEBUD2D_SIZE_F@@0PEAU2@@Z.c)
 */
        ...
        struct D2D_MATRIX_3X2_F *a3)
{
  ...
  if ( COERCE_FLOAT(LODWORD(this[28].width) & _xmm) < 0.0000011920929
    || COERCE_FLOAT(LODWORD(this[28].height) & _xmm) < 0.0000011920929 )
  {
  ...
  {
    StretchAlign::Arrange((StretchAlign *)&this[29], &v9, this + 28, a2, 0LL);
    v5 = LODWORD(this[27].width) ^ _xmm;
    v11[1] = 0;
    v11[2] = 0;
    v13 = v5;
    ...
    v14 = LODWORD(this[27].height) ^ _xmm;
    *(float *)v11 = v7;
    v11[5] = LODWORD(v9.top);
    *(float *)&v11[3] = (float)(v9.bottom - v9.top) / this[28].height;
