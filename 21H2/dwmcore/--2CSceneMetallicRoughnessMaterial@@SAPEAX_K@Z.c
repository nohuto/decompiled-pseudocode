/*
 * XREFs of ??2CSceneMetallicRoughnessMaterial@@SAPEAX_K@Z @ 0x18016BE7C
 * Callers:
...
LPVOID __fastcall CSceneMetallicRoughnessMaterial::operator new()
{
  LPVOID result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = DefaultHeap::AllocClear(0xB0uLL);
  if ( !result )
