/*
 * XREFs of ?GetBrushParameters@CBlurredWallpaperBackdropBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x180209E10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CBrushDrawListGenerator *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v4, 0LL, 0LL, BlurredWallpaperEffectInput, 0x30u);
LABEL_15:
    CBrushDrawListGenerator::Reset(a2);
    goto LABEL_16;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0LL, v6, 0x3Du);
    if ( v13 )
