/*
 * XREFs of ?InitializeWithD3DDevice@CHolographicFrameProcessor@@UEAAJPEAUID3D11Device1@@@Z @ 0x18029F940
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID3D11Device1 *a2)
{
  ...
  if ( !*((_QWORD *)this + 6) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, v7, v20);
LABEL_14:
    v2 = v6;
    goto LABEL_15;
  }
  ...
  {
    v6 = -2147418113;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0LL, -2147418113, 0x71u);
    goto LABEL_14;
  }
LABEL_15:
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v21);
