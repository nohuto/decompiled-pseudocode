        ...
        __int64 a8)
{
  ...
  if ( *(_QWORD *)(a1 + 104) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, SourceInputBounds, 0x2AFu, 0LL);
    }
    else
    {
      v14 = *(_DWORD *)(a4 + 64);
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, -2147024809, 0x2C1u, 0LL);
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x2BDu, 0LL);
      }
      else
      {
        v21 = v41;
  ...
  {
    v13 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, -2147024809, 0x2EEu, 0LL);
  }
  return v13 >= 0;
}
