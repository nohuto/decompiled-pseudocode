/*
 * XREFs of ?AnimationStarted@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x1801BEC34
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      return CoreUICallSend(v8, v11, 2LL, 0LL, 2, &unk_180345852);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
