/*
 * XREFs of ?SetOrientation@?$CParticleBehaviorsGeneratedT@VCParticleBehaviors@@VCPropertyChangeResource@@@@QEAAJPEAVCParticleVector4Behavior@@@Z @ 0x1801720E8
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[13] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x240u, 0LL);
    }
    else
    {
