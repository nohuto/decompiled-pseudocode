/*
 * XREFs of ?ProcessUpdateTransform@CRemoteRenderTarget@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_REMOTERENDERTARGET_UPDATETRANSFORM@@@Z @ 0x1800FF650
 * Callers:
        ...
        const struct tagMILCMD_REMOTERENDERTARGET_UPDATETRANSFORM *a3)
{
  ...
  __int64 v19; // rcx
  __int64 v20; // rcx
  unsigned int v21; // [rsp+30h] [rbp-128h] BYREF
  ...
  *((float *)this + 53) = v10;
  ...
  if ( *((_QWORD *)this + 24) == v13 )
  {
    if ( *((_QWORD *)this + 22) )
    {
      ...
      v21 = 0;
      v22 = 0;
      CMonitorTransform::Initialize((__int64)v25, &v21, (__int64)v4, 1.0, 1, 0LL);
      CDDARenderTarget::UpdateTransform(*((CDDARenderTarget **)this + 22), (const struct CMonitorTransform *)v25);
    }
  }
  else
  {
  ...
  v23 = (float)v16;
  v24 = v17;
  CMILMatrix::InferAffineMatrix((__int64)this + 216, v4, (float *)&v21);
  result = 0LL;
  *((_BYTE *)this + 141) = 1;
  return result;
}
