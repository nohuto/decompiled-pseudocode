/*
 * XREFs of McTemplateU0xdddddddqqddddddddddddqqq_EventWriteTransfer @ 0x1801B8B6C
 * Callers:
...
ULONG __fastcall McTemplateU0xdddddddqqddddddddddddqqq_EventWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a27)
{
  ...
  int v80; // [rsp+208h] [rbp+108h] BYREF
