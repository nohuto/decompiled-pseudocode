/*
 * XREFs of ?InitializeForFormatConversion@CScanPipeline@@QEAAJAEBUPixelFormatInfo@@0IE@Z @ 0x180219BD0
 * Callers:
 ...
 *     ?ResetPipeline@CScanPipeline@@MEAAXXZ @ 0x180219B80 (-ResetPipeline@CScanPipeline@@MEAAXXZ.c)
