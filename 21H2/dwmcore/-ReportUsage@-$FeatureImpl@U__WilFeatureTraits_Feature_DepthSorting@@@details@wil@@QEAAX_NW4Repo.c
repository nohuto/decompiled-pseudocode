/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DepthSorting@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180058C3C
 * Callers:
 *     ??0CPreComputeContext@@IEAA@PEAVCVisualTree@@@Z @ 0x18004460C (--0CPreComputeContext@@IEAA@PEAVCVisualTree@@@Z.c)
        ...
        ...)
{
  ...
  LODWORD(v9) = 0;
  BYTE4(v9) = 0;
  return wil::details::ReportUsageToService(a1 + 2, 13818272LL, (v5 >> 10) & 1, (v5 >> 11) & 1, (__int64 *)va, v6, v3);
}
