/*
 * XREFs of ??$move_backward@V?$move_iterator@PEAG@std@@V?$checked_array_iterator@PEAG@stdext@@@std@@YA?AV?$checked_array_iterator@PEAG@stdext@@V?$move_iterator@PEAG@0@0V12@@Z @ 0x1801E29DC
 * Callers:
...
LABEL_7:
  v9 = *a4;
  a4[2] = ((__int64)memmove_0((void *)(*a4 + 2 * a4[2] - v6), a2, v6) - v9) >> 1;
  result = a1;
  v11 = a4[2];
  *(_OWORD *)a1 = *(_OWORD *)a4;
  *(_QWORD *)(a1 + 16) = v11;
