/*
 * XREFs of ?GetContentRegion@CPrimitiveGroupDrawListGenerator@@QEAAPEBVCRegion@@XZ @ 0x1802ABB00
 * Callers:
        ...
        CPrimitiveGroupDrawListGenerator *this)
{
  ...
  if ( !*((_QWORD *)this + 12) )
  {
    ...
    *((_QWORD *)this + 12) = v2;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v3, 0LL, 0LL, -2147024882, 0x226u);
      v4 = (CRegion *)*((_QWORD *)this + 12);
      *((_QWORD *)this + 12) = 0LL;
      if ( v4 )
