/*
 * XREFs of ??0CDDASwapChain@@IEAA@PEAUIDXGISwapChainDWM1@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@@Z @ 0x180293648
 * Callers:
        ...
        const struct RenderTargetInfo *a4)
{
  ...
  *((_QWORD *)this + 20) = &ILegacySwapChain::`vftable'{for `IUnknown'};
  ...
  *(_QWORD *)this = &ILegacyStereoSwapChain::`vftable'{for `IDeviceResource'};
  ...
  *(_QWORD *)((char *)this + *(int *)(*((_QWORD *)this + 1) + 12LL) + 8) = &ILegacyStereoSwapChain::`vftable'{for `IDeviceResource'};
  *((_DWORD *)this + 4) = 0;
