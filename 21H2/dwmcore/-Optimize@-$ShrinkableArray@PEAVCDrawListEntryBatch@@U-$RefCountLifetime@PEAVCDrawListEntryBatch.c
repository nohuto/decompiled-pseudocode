/*
 * XREFs of ?Optimize@?$ShrinkableArray@PEAVCDrawListEntryBatch@@U?$RefCountLifetime@PEAVCDrawListEntryBatch@@@@@@QEAAXXZ @ 0x180020B90
 * Callers:
    ...
    if ( (int)DynArrayImpl<0>::Grow((unsigned int)v11, 8, v4, 1, 0LL) >= 0 )
    {
      ...
      if ( v3 > v4 )
      {
        ...
        if ( (_DWORD)v5 )
        {
          ...
          do
          {
            CMILRefCountBaseT<IMILRefCount>::InternalRelease(*(_QWORD *)(v7 + *(_QWORD *)a1) + 8LL);
            v7 += 8LL;
            --v8;
          }
          while ( v8 );
