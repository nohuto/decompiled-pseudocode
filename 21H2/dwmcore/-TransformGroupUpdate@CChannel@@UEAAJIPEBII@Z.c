/*
 * XREFs of ?TransformGroupUpdate@CChannel@@UEAAJIPEBII@Z @ 0x1801ACA20
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  {
    v12 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0LL, -2147024362, 0xAB6u);
    goto LABEL_21;
  }
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0LL, v10, 0xAB8u);
    goto LABEL_21;
  }
