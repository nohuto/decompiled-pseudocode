/*
 * XREFs of ??_GCDepthSortedVisualCollection@@QEAAPEAXI@Z @ 0x18016CFE8
 * Callers:
 ...
 *     ?pop_back@?$vector@VCDepthSortedVisualCollection@@V?$allocator@VCDepthSortedVisualCollection@@@std@@@std@@QEAAXXZ @ 0x18019A984 (-pop_back@-$vector@VCDepthSortedVisualCollection@@V-$allocator@VCDepthSortedVisualCollection@@@s.c)
 * Callees:
