/*
 * XREFs of ?Vector2TransformNormal@CExpressionValueStack@@QEAAJXZ @ 0x180201F8C
 * Callers:
...
LABEL_3:
  ...
  {
    v12 = *v6;
    v13 = (float)(_mm_shuffle_ps(v12, v12, 170).m128_f32[0] * v11) + (float)(COERCE_FLOAT(*v6) * *(float *)v8);
    v14 = (float)(_mm_shuffle_ps(*v6, *v6, 255).m128_f32[0] * v11)
        + (float)(_mm_shuffle_ps(v12, v12, 85).m128_f32[0] * *(float *)v8);
  }
  else
  {
    v14 = (float)(_mm_shuffle_ps(*v6, *v6, 85).m128_f32[0] * *(float *)v8)
        + (float)(_mm_shuffle_ps(v6[1], v6[1], 85).m128_f32[0] * v11);
    v13 = (float)(COERCE_FLOAT(*(_OWORD *)&v6[1]) * v11) + (float)(COERCE_FLOAT(*v6) * *(float *)v8);
  }
  *((_DWORD *)v8 + 18) = 35;
  *(float *)v8 = v13;
  *((float *)v8 + 1) = v14;
