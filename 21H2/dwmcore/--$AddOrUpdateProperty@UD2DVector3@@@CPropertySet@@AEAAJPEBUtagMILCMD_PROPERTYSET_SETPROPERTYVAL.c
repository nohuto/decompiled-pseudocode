/*
 * XREFs of ??$AddOrUpdateProperty@UD2DVector3@@@CPropertySet@@AEAAJPEBUtagMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DVector3@@@Z @ 0x180019938
 * Callers:
...
LABEL_11:
    ...
    updated = CPropertySet::UpdateProperty<D2DVector3>(v10);
    v5 = updated;
    if ( updated < 0 )
    {
      v12 = 339;
