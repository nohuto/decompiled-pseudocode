/*
 * XREFs of ?Calculate@CKeyframeAnimation@@AEAAJPEAVCExpressionValueStack@@@Z @ 0x1800ABFB4
 * Callers:
 ...
 *     ?GetIsComplete@Timer@@QEBA_NXZ @ 0x1800AC184 (-GetIsComplete@Timer@@QEBA_NXZ.c)
