/*
 * XREFs of ?RgnGeometryUpdate@CChannel@@UEAAJIPEBUtagRECT@@I@Z @ 0x1800CFD30
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  {
    v11 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0xFFFFFFFFLL, 0LL, 0, -2147024362, 0xAECu, 0LL);
  }
  else
  {
    v14 = 16 * a4;
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0xAEDu, 0LL);
    }
    else
    {
