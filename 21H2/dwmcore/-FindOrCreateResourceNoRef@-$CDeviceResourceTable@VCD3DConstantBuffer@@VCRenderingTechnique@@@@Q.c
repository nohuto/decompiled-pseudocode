/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD3DConstantBuffer@@VCRenderingTechnique@@@@QEAAJPEAVCD3DDevice@@PEAPEAVCD3DConstantBuffer@@@Z @ 0x18005053C
 * Callers:
...
LABEL_8:
        v15 = v27;
        v29 = a1;
        v16 = (const void **)((char *)v27 + 88);
        v17 = (_BYTE *)*((_QWORD *)v27 + 12);
        if ( *((_BYTE **)v27 + 13) == v17 )
        {
