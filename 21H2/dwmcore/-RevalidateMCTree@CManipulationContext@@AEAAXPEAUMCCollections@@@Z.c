/*
 * XREFs of ?RevalidateMCTree@CManipulationContext@@AEAAXPEAUMCCollections@@@Z @ 0x180235D70
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$07@@U1@U1@U1@U?$_tlgWrapperByVal@$03@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$07@@333AEBU?$_tlgWrapperByVal@$03@@@Z @ 0x1802336D0 (--$Write@U-$_tlgWrapperByVal@$07@@U1@U1@U1@U-$_tlgWrapperByVal@$03@@@-$_tlgWriteTemplate@$$A6AJP.c)
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)dword_180344EF0 > 4 && (qword_180344F00 & 2) != 0 && (qword_180344F08 & 2) == qword_180344F08 )
      {
        ...
        tlgWriteTransfer_EventWriteTransfer(
          (__int64)&dword_180344EF0,
          (unsigned __int8 *)dword_1802ED28F,
          0LL,
          0LL,
          5u,
          &v69);
...
LABEL_75:
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)dword_180344EF0 > 4 && (qword_180344F00 & 2) != 0 )
      {
        v42 = qword_180344F08 & 2;
        if ( v42 == qword_180344F08 )
        {
          LODWORD(v56) = v29;
          v59 = v39;
          v55 = v38;
