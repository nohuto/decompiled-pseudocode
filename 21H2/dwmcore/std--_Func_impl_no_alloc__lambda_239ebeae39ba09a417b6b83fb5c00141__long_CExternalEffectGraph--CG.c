/*
 * XREFs of std::_Func_impl_no_alloc__lambda_239ebeae39ba09a417b6b83fb5c00141__long_CExternalEffectGraph::CGraphRenderingContext___::_Do_call @ 0x1800E8AD0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a2)
{
  ...
  v2 = *a2;
  EffectInput::operator=(
    *(__int64 **)(*a2 + 24),
    (__int64 *)(*(_QWORD *)(*a2 + 48) + 104LL * *(unsigned int *)(*a2 + 36)));
  v3 = *(_DWORD *)(v2 + 36);
