/*
 * XREFs of ?Min@CExpressionValueStack@@QEAAJXZ @ 0x1800DD330
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Min(CExpressionValueStack *this)
{
  ...
  if ( (unsigned int)v2 >= 2 )
  {
    ...
    if ( v10 == *((_DWORD *)v6 + 18) )
    {
      ...
      {
        case 18:
          v18 = fminf(*(float *)v8, *v6);
          *((_DWORD *)v8 + 18) = 18;
          *(float *)v8 = v18;
          break;
        case 35:
          v16 = fminf(*(float *)v8, *v6);
          v17 = fminf(*((float *)v8 + 1), v6[1]);
          *((_DWORD *)v8 + 18) = 35;
          *(float *)v8 = v16;
          *((float *)v8 + 1) = v17;
          break;
        case 52:
          v13 = fminf(COERCE_FLOAT(*v8), COERCE_FLOAT(*(_QWORD *)v6));
          v14 = fminf(COERCE_FLOAT(HIDWORD(*v8)), COERCE_FLOAT(HIDWORD(*(_QWORD *)v6)));
          v15 = fminf(*((float *)v8 + 2), v6[2]);
          *((_DWORD *)v8 + 18) = 52;
          *(float *)v8 = v13;
          *((float *)v8 + 1) = v14;
          *((float *)v8 + 2) = v15;
