/*
 * XREFs of ?HolographicInteropTextureSetRoot@CChannel@@UEAAJII@Z @ 0x1801AABB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::HolographicInteropTextureSetRoot(CDataStreamWriter **this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckHandle((__int64)this, a2, 78);
