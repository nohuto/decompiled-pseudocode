/*
 * XREFs of ?EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ @ 0x18018A95C
 * Callers:
 ...
 *     ?SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z @ 0x18018AFFC (-SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z.c)
