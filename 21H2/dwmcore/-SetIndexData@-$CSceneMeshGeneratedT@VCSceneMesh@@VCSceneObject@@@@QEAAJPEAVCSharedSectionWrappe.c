/*
 * XREFs of ?SetIndexData@?$CSceneMeshGeneratedT@VCSceneMesh@@VCSceneObject@@@@QEAAJPEAVCSharedSectionWrapper@@@Z @ 0x1801710A0
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[11] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x9DEu, 0LL);
    }
    else
    {
