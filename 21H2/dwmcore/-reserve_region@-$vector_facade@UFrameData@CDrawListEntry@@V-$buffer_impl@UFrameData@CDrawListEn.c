/*
 * XREFs of ?reserve_region@?$vector_facade@UFrameData@CDrawListEntry@@V?$buffer_impl@UFrameData@CDrawListEntry@@$00$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAUFrameData@CDrawListEntry@@_K0@Z @ 0x1801A2A88
 * Callers:
 *     ??$emplace@W4Enum@BlendMode@@MVCMILMatrix@@@?$vector_facade@UFrameData@CDrawListEntry@@V?$buffer_impl@UFrameData@CDrawListEntry@@$00$00Vliberal_expansion_policy@detail@@@detail@@@detail@@QEAA?AV?$basic_iterator@UFrameData@CDrawListEntry@@@1@V?$basic_iterator@$$CBUFrameData@CDrawListEntry@@@1@W4Enum@BlendMode@@MVCMILMatrix@@@Z @ 0x1801A1764 (--$emplace@W4Enum@BlendMode@@MVCMILMatrix@@@-$vector_facade@UFrameData@CDrawListEntry@@V-$buffer.c)
 * Callees:
