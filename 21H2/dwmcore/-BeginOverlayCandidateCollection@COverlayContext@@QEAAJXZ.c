/*
 * XREFs of ?BeginOverlayCandidateCollection@COverlayContext@@QEAAJXZ @ 0x180091D20
 * Callers:
...
__int64 __fastcall COverlayContext::BeginOverlayCandidateCollection(COverlayContext *this)
{
  ...
  *((_BYTE *)this + 11422) = v7;
  ...
  v10 = dword_18034B2EC;
  v11 = dword_18034B2E4;
  if ( TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::sc_rcEmpty >= dword_18034B2E8
    || dword_18034B2E4 >= dword_18034B2EC )
  {
    **((_DWORD **)this + 1413) = 0;
  }
  else
