/*
 * XREFs of ??$emplace_back@AEBUScribbleFrame@CComputeScribbleScheduler@@@?$deque@UScribbleFrame@CComputeScribbleScheduler@@V?$allocator@UScribbleFrame@CComputeScribbleScheduler@@@std@@@std@@QEAAAEAUScribbleFrame@CComputeScribbleScheduler@@AEBU23@@Z @ 0x1801A3F78
 * Callers:
 ...
 *     ??0ScribbleFrame@CComputeScribbleScheduler@@QEAA@AEBU01@@Z @ 0x1801A40EC (--0ScribbleFrame@CComputeScribbleScheduler@@QEAA@AEBU01@@Z.c)
 *     ?_Growmap@?$deque@UScribbleFrame@CComputeScribbleScheduler@@V?$allocator@UScribbleFrame@CComputeScribbleScheduler@@@std@@@std@@AEAAX_K@Z @ 0x1801A5814 (-_Growmap@-$deque@UScribbleFrame@CComputeScribbleScheduler@@V-$allocator@UScribbleFrame@CCompute.c)
 */
