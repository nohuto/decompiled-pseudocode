/*
 * XREFs of ?FillShapeWithBitmapRealization@CDrawingContext@@IEAAJPEAVIBitmapRealization@@AEBVCShape@@AEBVMILMatrix3x2@@_N@Z @ 0x1800537C8
 * Callers:
        ...
        bool a5)
{
  ...
  {
    v19 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0, 0LL, 0, -2147024809, 0x829u, 0LL);
  ...
  {
    v19 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, -2147024882, 0x81Bu, 0LL);
    goto LABEL_17;
  }
  ...
  *((_QWORD *)&v27 + 1) = a2;
  ...
  if ( v19 < 0 )
  {
    ...
    *((_QWORD *)&v27 + 1) = 0LL;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v19, 0x81Fu, 0LL);
    goto LABEL_26;
  }
  v32 = a5;
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0x825u, 0LL);
LABEL_26:
    operator delete(v13);
    goto LABEL_17;
  }
