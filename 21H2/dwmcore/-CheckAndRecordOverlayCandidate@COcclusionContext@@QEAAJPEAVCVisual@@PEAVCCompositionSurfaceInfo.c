/*
 * XREFs of ?CheckAndRecordOverlayCandidate@COcclusionContext@@QEAAJPEAVCVisual@@PEAVCCompositionSurfaceInfo@@PEBVCMILMatrix@@PEBVCShape@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@@Z @ 0x180006A08
 * Callers:
  ...
  if ( v19[0] )
  {
       ...
       || (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v21 + 72LL))(v21)) )
    {
      ...
      if ( v13 != v14 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x66Du, 0LL);
      }
    }
LABEL_5:
