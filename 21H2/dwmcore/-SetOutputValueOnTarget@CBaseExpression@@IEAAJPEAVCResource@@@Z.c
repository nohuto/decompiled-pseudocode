/*
 * XREFs of ?SetOutputValueOnTarget@CBaseExpression@@IEAAJPEAVCResource@@@Z @ 0x180074090
 * Callers:
...
__int64 __fastcall CBaseExpression::SetOutputValueOnTarget(unsigned __int64 this, struct CResource *a2)
{
  ...
  else
  {
    ...
    if ( v11 && *(_BYTE *)(v11 + 4) )
    {
      ...
      if ( v50 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v51, 0LL, 0, v50, 0x263u, 0LL);
      }
      else
      {
...
LABEL_6:
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v54, 0LL, 0, v53, 0x267u, 0LL);
      }
      v60 = v73;
      if ( v73 )
      {
    ...
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x247u, 0LL);
    }
  }
LABEL_7:
  v12 = v77;
