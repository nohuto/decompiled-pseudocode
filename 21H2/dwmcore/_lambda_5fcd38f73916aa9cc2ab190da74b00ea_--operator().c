/*
 * XREFs of _lambda_5fcd38f73916aa9cc2ab190da74b00ea_::operator() @ 0x1800347D0
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_5fcd38f73916aa9cc2ab190da74b00ea__void_void___unsigned_long_unsigned___int64_unsigned_short_const___enum_ProcessAttributionFlags_ProcessAttributionResourceCounters_const_&_::_Do_call @ 0x1800EA750 (std--_Func_impl_no_alloc__lambda_5fcd38f73916aa9cc2ab190da74b00ea__void_void___unsi_ea_1800EA750.c)
 * Callees:
 *     ??$_Insert_at@AEB_KU_Not_a_node_tag@std@@@?$_Tree@V?$_Tset_traits@_KU?$less@_K@std@@V?$allocator@_K@2@$0A@@std@@@std@@IEAA?AV?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@_K@std@@@std@@@1@_NPEAU?$_Tree_node@_KPEAX@1@AEB_KU_Not_a_node_tag@1@@Z @ 0x18004FDA4 (--$_Insert_at@AEB_KU_Not_a_node_tag@std@@@-$_Tree@V-$_Tset_traits@_KU-$less@_K@std@@V-$allocator.c)
 */
