/*
 * XREFs of ?Present@CDDASwapChain@@UEAAJIIAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@@Z @ 0x180293E00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDDASwapChain::Present(__int64 a1)
{
        ...
        (v3 = v10) != 0LL) )
  {
    ...
    v8 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0LL, v6, 0x64u);
  }
  else
  {
    v8 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(v2, 0LL, 0LL, -2003304307, 0x68u);
  }
  **(_DWORD **)(a1 + 80) = 0;
  if ( v3 )
