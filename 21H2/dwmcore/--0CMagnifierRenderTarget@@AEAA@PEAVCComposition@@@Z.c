/*
 * XREFs of ??0CMagnifierRenderTarget@@AEAA@PEAVCComposition@@@Z @ 0x1801C7500
 * Callers:
        ...
        struct CComposition *a2)
{
  ...
  *(_QWORD *)((char *)this + *(int *)(*((_QWORD *)this + 272) + 4LL) + 2176) = &ILegacySwapChain::`vftable'{for `IUnknown'};
