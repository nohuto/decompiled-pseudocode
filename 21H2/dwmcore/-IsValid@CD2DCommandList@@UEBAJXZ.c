/*
 * XREFs of ?IsValid@CD2DCommandList@@UEBAJXZ @ 0x18024B6D0
 * Callers:
 *     ?IsValid@CD2DCommandList@@$4PPPPPPPM@A@EBAJXZ @ 0x1800F7830 (-IsValid@CD2DCommandList@@$4PPPPPPPM@A@EBAJXZ.c)
 * Callees:
