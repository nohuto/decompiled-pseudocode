/*
 * XREFs of ?ComputeLayoutSize@CVisual@@QEAA_NXZ @ 0x1800D22AC
 * Callers:
 *     ?EnsureRootLayoutSize@CPreComputeContext@@AEAAJXZ @ 0x18008F194 (-EnsureRootLayoutSize@CPreComputeContext@@AEAAJXZ.c)
 *     ?UpdateRelativeLayout@CPreComputeHelper@@IEAAXPEAVCVisual@@@Z @ 0x18019AEE0 (-UpdateRelativeLayout@CPreComputeHelper@@IEAAXPEAVCVisual@@@Z.c)
 * Callees:
