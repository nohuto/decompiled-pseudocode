/*
 * XREFs of ?LogEtwEvent@CBackdropVisualImage@@QEBAXVDbgString@DwmDbg@@0@Z @ 0x180053AAC
 * Callers:
...
void __fastcall CBackdropVisualImage::LogEtwEvent(__int64 a1, void **a2, void **a3)
{
  ...
  void *v50; // [rsp+120h] [rbp+10h] BYREF
  ...
  if ( dword_1803D0F60 )
  {
    ...
    ViewBoxToUVTransform = CBackdropVisualImage::GetViewBoxToUVTransform(a1, &v69);
    Matrix3x3::operator*(a1 + 1916, v38, ViewBoxToUVTransform);
    v13 = *(_QWORD *)(a1 + 1784);
    v62[2] = 0;
    v62[6] = 0;
    v66 = 0;
    ...
    v67 = v38[8];
    v65 = v38[7];
    CMILMatrix::Transform2DBoundsHelper<0>(v62, v13 + 172, &v69);
    v14 = 5;
    if ( (unsigned int)dword_1803D0F60 > 5 )
    {
      ...
      v48 = *(_QWORD *)DwmDbg::DbgString::DbgString((DwmDbg::DbgString *)&v50, "[%s] -> 0x%p", *v34, v33);
      ...
      *(_QWORD *)&v69 = *a2;
      ...
      if ( v53 )
        DefaultHeap::Free(v53);
      if ( v31 )
        DefaultHeap::Free(v31);
      if ( v54 )
        DefaultHeap::Free(v54);
      if ( v55 )
        DefaultHeap::Free(v55);
      if ( v56 )
