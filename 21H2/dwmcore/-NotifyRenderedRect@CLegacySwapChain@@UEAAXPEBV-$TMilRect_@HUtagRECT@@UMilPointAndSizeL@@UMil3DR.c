/*
 * XREFs of ?NotifyRenderedRect@CLegacySwapChain@@UEAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x180099D70
 * Callers:
 *     ?NotifyRenderedRect@CLegacySwapChain@@$4PPPPPPPM@A@EAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x1800F7600 (-NotifyRenderedRect@CLegacySwapChain@@$4PPPPPPPM@A@EAAXPEBV-$TMilRect_@HUtagRECT@@UMilPointAndSi.c)
 *     ?NotifyRenderedRect@CLegacySwapChain@@$4PPPPPPPM@BI@EAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x1800F7AA0 (-NotifyRenderedRect@CLegacySwapChain@@$4PPPPPPPM@BI@EAAXPEBV-$TMilRect_@HUtagRECT@@UMilPointAndS.c)
