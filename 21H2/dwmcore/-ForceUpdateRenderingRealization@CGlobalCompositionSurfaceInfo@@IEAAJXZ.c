/*
 * XREFs of ?ForceUpdateRenderingRealization@CGlobalCompositionSurfaceInfo@@IEAAJXZ @ 0x18006604C
 * Callers:
 ...
 *     ?GetRenderingRealization@CGlobalCompositionSurfaceInfo@@UEAAPEAVIBitmapRealization@@XZ @ 0x180066000 (-GetRenderingRealization@CGlobalCompositionSurfaceInfo@@UEAAPEAVIBitmapRealization@@XZ.c)
 * Callees:
      ...
      if ( (unsigned int)(v10[0] - 2) <= 1 && v10[1] == *((_DWORD *)this + 10) && v10[2] == *((_DWORD *)this + 11) )
      {
        ...
        if ( !v7 || v7 == v11 )
        {
          ...
          *((_BYTE *)this + 80) = 1;
          ...
          v3 = updated;
          if ( updated < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, updated, 0x1C0u, 0LL);
          *((_BYTE *)this + 80) = 0;
          v2 = 1;
        }
      }
