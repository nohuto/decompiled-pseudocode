/*
 * XREFs of ??$QueryInterface@VConnectionIndirector@BamoImpl@Microsoft@@UIMessageConversationHost@@UIMessageConversationBouncer@@@Util@BamoImpl@Microsoft@@YAJPEAVConnectionIndirector@12@AEBU_GUID@@PEAPEAX@Z @ 0x1800F1D20
 * Callers:
 *     ?QueryInterface@ConnectionIndirector@BamoImpl@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F1D10 (-QueryInterface@ConnectionIndirector@BamoImpl@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
