/*
 * XREFs of ?CalculateValueWorker@CConditionalExpression@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x1801BD8E0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a4 = 0;
  ...
  if ( v9 )
  {
    if ( v9 == 1 )
    {
      ...
      v10 = 1;
      v11 = (__int64)(*((_QWORD *)this + 41) - *((_QWORD *)this + 40)) >> 4;
      v37 = 0LL;
      v38 = 18;
      v39 = 0;
      if ( v11 )
      {
        do
        {
          ...
          {
            v10 = 0;
            v15 = *(_QWORD *)(*((_QWORD *)this + 40) + 16LL * v4 + 8);
...
LABEL_17:
  ...
  {
    v28 = *(_QWORD *)(*((_QWORD *)this + 40) + 16 * v27 + 8);
