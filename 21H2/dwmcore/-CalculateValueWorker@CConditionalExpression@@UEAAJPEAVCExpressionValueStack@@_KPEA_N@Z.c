/*
 * XREFs of ?CalculateValueWorker@CConditionalExpression@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x180210CA0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v10 == 1 )
    {
      ...
      if ( v12 )
      {
        do
        {
          ...
          if ( v13 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0LL, v13, 0x123u);
            goto LABEL_15;
          }
          if ( v35 )
          {
            ...
            if ( v16 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast((__int64)v17, 0LL, 0LL, v16, 0x12Au);
              goto LABEL_15;
            }
            ...
            if ( v18 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0LL, v18, 0x12Bu);
              goto LABEL_15;
            }
          }
          ++v4;
        ...
        v9 = v20;
        if ( v20 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0LL, v20, 0x13Fu);
      }
      else
      {
LABEL_16:
        ...
        if ( v22 )
        {
          ...
          v9 = v23;
          if ( v23 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0LL, v23, 0x134u);
        }
        else
        {
          v9 = 1;
...
LABEL_15:
  ...
  else
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v26, 0LL, 0LL, IsAnyConditionSatisfied, 0xF8u);
    }
    else
    {
      v27 = *((int *)this + 95);
      if ( (int)v27 < 0 )
      {
        ...
        if ( v31 )
        {
          ...
          v9 = v32;
          if ( v32 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0LL, v32, 0x100u);
        }
        else
        {
          return 1;
      ...
      else
      {
        ...
        v9 = v29;
        if ( v29 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v30, 0LL, 0LL, v29, 0xFCu);
      }
    }
  }
  return v9;
