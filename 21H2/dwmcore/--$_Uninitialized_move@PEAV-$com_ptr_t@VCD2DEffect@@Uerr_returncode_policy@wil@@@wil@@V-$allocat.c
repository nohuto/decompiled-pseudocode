/*
 * XREFs of ??$_Uninitialized_move@PEAV?$com_ptr_t@VCD2DEffect@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCD2DEffect@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@YAPEAV?$com_ptr_t@VCD2DEffect@@Uerr_returncode_policy@wil@@@wil@@QEAV12@0PEAV12@AEAV?$allocator@V?$com_ptr_t@VCD2DEffect@@Uerr_returncode_policy@wil@@@wil@@@0@@Z @ 0x18019A298
 * Callers:
...
__int64 *__fastcall std::_Uninitialized_move<wil::com_ptr_t<CD2DEffect,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<CD2DEffect,wil::err_returncode_policy>>>(
        __int64 *a1,
        __int64 *a2,
        __int64 *a3)
{
