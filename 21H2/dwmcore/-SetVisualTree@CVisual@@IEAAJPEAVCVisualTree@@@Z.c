/*
 * XREFs of ?SetVisualTree@CVisual@@IEAAJPEAVCVisualTree@@@Z @ 0x1800D8844
 * Callers:
 *     ?Initialize@CDesktopTree@@MEAAJXZ @ 0x1800D87C0 (-Initialize@CDesktopTree@@MEAAJXZ.c)
 *     ?Initialize@CVisualTree@@MEAAJXZ @ 0x1800D8830 (-Initialize@CVisualTree@@MEAAJXZ.c)
 * Callees:
...
__int64 __fastcall CVisual::SetVisualTree(CVisual *this, struct CVisualTree *a2)
{
  ...
  if ( (*((_BYTE *)this + 88) & 1) == 0 )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0xFB3u, 0LL);
    }
    else
    {
      v7 = v10;
