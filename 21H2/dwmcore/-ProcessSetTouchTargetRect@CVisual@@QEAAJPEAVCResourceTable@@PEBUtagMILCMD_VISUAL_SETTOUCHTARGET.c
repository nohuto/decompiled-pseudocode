/*
 * XREFs of ?ProcessSetTouchTargetRect@CVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_VISUAL_SETTOUCHTARGETRECT@@@Z @ 0x1800675B4
 * Callers:
        ...
        const struct tagMILCMD_VISUAL_SETTOUCHTARGETRECT *a3)
{
  ...
  *((float *)&v8 + 3) = v6;
  ...
  {
    v9 = v8;
    CVisual::SetTouchTargetBounds((__int64)this, &v9);
