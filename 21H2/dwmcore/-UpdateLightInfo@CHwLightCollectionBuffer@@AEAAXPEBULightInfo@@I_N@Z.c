/*
 * XREFs of ?UpdateLightInfo@CHwLightCollectionBuffer@@AEAAXPEBULightInfo@@I_N@Z @ 0x180010D04
 * Callers:
        ...
        char a4)
{
  ...
  *(_OWORD *)((char *)this + 504) = 0LL;
  if ( a3 )
  {
    ...
    do
    {
      ...
      {
        v8 = 1;
        *(__m128 *)((char *)this + 504) = _mm_add_ps(*(__m128 *)(v9 - 8), *(__m128 *)((char *)this + 504));
      }
      v9 += 240;
      --v10;
    }
  ...
  *((_DWORD *)this + 4) = -1;
  ...
  memset_0((char *)this + 128 * (unsigned __int64)v11 + 20, 0, 256 - ((unsigned __int64)v11 << 7));
  memset_0((char *)this + 112 * v11 + 280, 0, 224 - 112LL * v11);
  if ( v8 || !a4 )
