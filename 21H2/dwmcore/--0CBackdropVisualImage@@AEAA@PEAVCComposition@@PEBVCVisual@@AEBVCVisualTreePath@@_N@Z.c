/*
 * XREFs of ??0CBackdropVisualImage@@AEAA@PEAVCComposition@@PEBVCVisual@@AEBVCVisualTreePath@@_N@Z @ 0x1800D4568
 * Callers:
        ...
        bool a5)
{
  ...
  *(_QWORD *)((char *)this + *(int *)(*((_QWORD *)this + 253) + 4LL) + 2024) = &ILegacySwapChain::`vftable'{for `IUnknown'};
  ...
  *(_OWORD *)((char *)this + 1848) = *(_OWORD *)&TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::sc_rcEmpty;
