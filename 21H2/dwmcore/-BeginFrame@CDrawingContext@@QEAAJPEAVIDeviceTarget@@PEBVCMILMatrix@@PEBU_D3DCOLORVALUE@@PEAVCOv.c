/*
 * XREFs of ?BeginFrame@CDrawingContext@@QEAAJPEAVIDeviceTarget@@PEBVCMILMatrix@@PEBU_D3DCOLORVALUE@@PEAVCOverlayContext@@@Z @ 0x18007A2A8
 * Callers:
        ...
        struct COverlayContext *a5)
{
  ...
  *((_QWORD *)this + 435) = 0LL;
  if ( dword_18034B168 > *(_DWORD *)(v23 + 4) )
  {
    Init_thread_header(&dword_18034B168);
    if ( dword_18034B168 == -1 )
    {
      ...
      qword_180347568 = (__int64)v45;
      Init_thread_footer(&dword_18034B168);
    }
  }
  v24 = (struct CProcessAttribution *)qword_180347568;
  LODWORD(v42) = 11;
  v43 = 0LL;
