/*
 * XREFs of ?GetProperty@CRadialGradientBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x18023AFF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRadialGradientBrush::GetProperty(CRadialGradientBrush *this, int a2, struct CExpressionValue *a3)
{
  ...
  v10[0] = 3LL;
  v10[1] = &CRadialGradientBrush::k_rgAnimDef;
  v4 = 0;
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, v7, -2147024809, 0x21u);
  }
  return v4;
}
