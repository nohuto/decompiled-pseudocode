/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x18026B628
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x18026BFF0 (s_TransformPointByMatrix.c)
 */
