/*
 * XREFs of ?QueueForDeferredDestruction@DataProviderProxy@@QEAAJPEAVBamoDataSourceProxy@@@Z @ 0x1801BE3CC
 * Callers:
 *     ?OnDisconnected@DataSourceProxy@@MEAAJXZ @ 0x1801BCAD0 (-OnDisconnected@DataSourceProxy@@MEAAJXZ.c)
 * Callees:
 ...
 *     ??$_Emplace_reallocate@AEA_K@?$vector@_KV?$allocator@_K@std@@@std@@QEAAPEA_KQEA_KAEA_K@Z @ 0x1801BD7C0 (--$_Emplace_reallocate@AEA_K@-$vector@_KV-$allocator@_K@std@@@std@@QEAAPEA_KQEA_KAEA_K@Z.c)
