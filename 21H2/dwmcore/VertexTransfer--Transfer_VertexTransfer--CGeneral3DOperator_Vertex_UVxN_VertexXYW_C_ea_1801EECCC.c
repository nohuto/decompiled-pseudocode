/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____2_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801EECCC
 * Callers:
    ...
    do
    {
      ...
      VertexTransfer::CGeneral3DOperator<Vertex_UVxN<VertexXYW_ColorDW_WorldXYZ_Tangent>>::Transform(
        ...
        *(_DWORD *)(a1 + 40),
        v7,
        v18);
      *(_DWORD *)(v18 + 12) = BlendStraightColorDW(*(_DWORD *)(v17 + 12), v10);
