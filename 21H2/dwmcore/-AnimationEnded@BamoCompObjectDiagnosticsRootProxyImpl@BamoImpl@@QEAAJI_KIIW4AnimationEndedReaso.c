/*
 * XREFs of ?AnimationEnded@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIIW4AnimationEndedReasonType@@W4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x1801BEA04
 * Callers:
        ...
        const char *a4)
{
  ...
  else
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      return CoreUICallSend(v8, v11, 2LL, 0LL, 4, &unk_18034585B);
    }
    else
    {
      wil::details::in1diag3::Return_Hr(
