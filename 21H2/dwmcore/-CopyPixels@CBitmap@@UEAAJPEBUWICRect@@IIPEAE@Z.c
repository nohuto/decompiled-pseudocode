/*
 * XREFs of ?CopyPixels@CBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x18003D5E0
 * Callers:
 *     ?CopyPixels@CBitmap@@WCI@EAAJPEBUWICRect@@IIPEAE@Z @ 0x1800F5C90 (-CopyPixels@CBitmap@@WCI@EAAJPEBUWICRect@@IIPEAE@Z.c)
 * Callees:
