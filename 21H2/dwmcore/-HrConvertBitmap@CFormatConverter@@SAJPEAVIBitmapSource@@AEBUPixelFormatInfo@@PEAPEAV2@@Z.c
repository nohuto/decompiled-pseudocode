/*
 * XREFs of ?HrConvertBitmap@CFormatConverter@@SAJPEAVIBitmapSource@@AEBUPixelFormatInfo@@PEAPEAV2@@Z @ 0x1802197F8
 * Callers:
 ...
 *     ??0CFormatConverter@@QEAA@XZ @ 0x180218DC8 (--0CFormatConverter@@QEAA@XZ.c)
