/*
 * XREFs of ??1?$_List_node_emplace_op2@V?$allocator@U?$_List_node@U?$pair@QEAVCResource@@UResourceDebugInfo@CAnimationLoggingManager@@@std@@PEAX@std@@@std@@@std@@QEAA@XZ @ 0x180064FA4
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    v4 = *(_QWORD *)(a1 + 8);
    if ( v4 )
      return std::_Deallocate<16,0>(v4, 72LL);
  }
  return result;
}
