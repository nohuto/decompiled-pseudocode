/*
 * XREFs of ?CreateSectionBitmap@CaptureBitsResponse@@IEAAJXZ @ 0x1801B98A4
 * Callers:
...
__int64 __fastcall CaptureBitsResponse::CreateSectionBitmap(CaptureBitsResponse *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v3, 0LL, 0LL, v2, 0xE4u);
  }
  else
  {
    SetLastError(0);
    ...
    *((_QWORD *)this + 207) = FileMappingW;
    if ( !FileMappingW )
    {
      ...
      if ( v4 >= 0 )
        v4 = -2003304445;
      MilInstrumentationCheckHR_MaybeFailFast(v7, 0LL, 0LL, v4, 0xECu);
    }
  }
