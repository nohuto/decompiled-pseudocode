/*
 * XREFs of ?AddRule@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@UEAAXAEBV?$shared_ptr@VCreativeRule@RuleSetHandlers@CreativeFramework@@@std@@@Z @ 0x18007D3C0
 * Callers:
 ...
 *     ?GetFileNameForRule@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@AEAA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEAVCreativeRule@23@@Z @ 0x18007E068 (-GetFileNameForRule@DiagTrackRuleSetHandler@RuleSetHandlers@CreativeFramework@@AEAA-AV-$basic_st.c)
 ...
 *     ??$GetActivationFactory@UIStorageFolderStatics@Storage@Windows@@@wil@@YA?AV?$com_ptr_t@UIStorageFolderStatics@Storage@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x18007E500 (--$GetActivationFactory@UIStorageFolderStatics@Storage@Windows@@@wil@@YA-AV-$com_ptr_t@UIStorage.c)
 *     ??$GetActivationFactory@UIStorageFileStatics@Storage@Windows@@@wil@@YA?AV?$com_ptr_t@UIStorageFileStatics@Storage@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x18007E628 (--$GetActivationFactory@UIStorageFileStatics@Storage@Windows@@@wil@@YA-AV-$com_ptr_t@UIStorageFi.c)
 *     ?GetSoftLandingFolderForUser@@YAJPEAXPEA_W_K@Z @ 0x1800AD06C (-GetSoftLandingFolderForUser@@YAJPEAXPEA_W_K@Z.c)
...
void __fastcall CreativeFramework::RuleSetHandlers::DiagTrackRuleSetHandler::AddRule(__int64 a1, void ***a2)
{
  ...
  const WCHAR *v26; // [rsp+58h] [rbp-B0h] BYREF
  _QWORD v27[2]; // [rsp+60h] [rbp-A8h] BYREF
  wchar_t *v28; // [rsp+70h] [rbp-98h] BYREF
  __int64 v29; // [rsp+80h] [rbp-88h]
  unsigned __int64 v30; // [rsp+88h] [rbp-80h]
  void *v31[3]; // [rsp+90h] [rbp-78h] BYREF
  unsigned __int64 v32; // [rsp+A8h] [rbp-60h]
  HSTRING_HEADER hstringHeader; // [rsp+B0h] [rbp-58h] BYREF
  ...
  int v39; // [rsp+110h] [rbp+8h] BYREF
  char v40; // [rsp+114h] [rbp+Ch]
  int v41; // [rsp+138h] [rbp+30h] BYREF
  const char *v42; // [rsp+140h] [rbp+38h]
  __int64 v43; // [rsp+148h] [rbp+40h]
  char v44; // [rsp+150h] [rbp+48h]
  __int64 v45; // [rsp+158h] [rbp+50h]
  _BYTE v46[144]; // [rsp+160h] [rbp+58h] BYREF
  __int64 v47; // [rsp+1F0h] [rbp+E8h]
  __int128 v48; // [rsp+1F8h] [rbp+F0h]
  __int64 v49; // [rsp+208h] [rbp+100h]
  WCHAR sourceString[264]; // [rsp+218h] [rbp+110h] BYREF
  ...
  v29 = 0LL;
  LOWORD(v28) = 0;
  std::wstring::assign((void **)&v28, *a2, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  ...
  v44 = 0;
  v41 = 0;
  v42 = "DiagTrackRuleSetHandlerAddRule";
  v43 = 0LL;
  v45 = 1LL;
  v47 = 0LL;
  ...
  v29 = 0LL;
  LOWORD(v28) = 0;
  CreativeFramework::RuleSetHandlers::DiagTrackRuleSetHandler::GetFileNameForRule(v6, v31, *a2);
  ...
  if ( v10 < 0 )
  {
    ...
    JUMPOUT(0x18007D811LL);
  }
  Reserved1 = (const WCHAR *)string;
  v11 = (_QWORD *)wil::GetActivationFactory<Windows::Storage::IStorageFolderStatics>(&v23);
  ...
  v29 = 0LL;
  LOWORD(v28) = 0;
  std::wstring::assign((void **)&v28, v13 + 4, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  v14 = (const WCHAR *)&v28;
  if ( v30 >= 8 )
    v14 = v28;
  Reserved1 = v14;
  Reserved1 = (const WCHAR *)Microsoft::WRL::Wrappers::HStringReference::HStringReference(&hstringHeader, &Reserved1)[1].Reserved.Reserved1;
  v15 = (_QWORD *)wil::GetActivationFactory<Windows::Storage::IStorageFileStatics>(&v23);
  ___CallAndWaitForCompletion_UIStorageFileStatics_Storage_Windows__PEAUHSTRING____PEAPEAU__IAsyncOperation_PEAVStorageFile_Storage_Windows___Foundation_3___ZPEAU4__wil__YA_AV__ComPtr_UIStorageFile_Storage_Windows___WRL_Microsoft__PEAUIStorageFileStatics_Storage_Windows__P8456_EAAJPEAUHSTRING____PEAPEAU__IAsyncOperation_PEAVStorageFile_Storage_Windows___Foundation_6__Z__QEAPEAU7__Z(
    &v24,
    *v15,
    v16,
    &Reserved1);
  ...
  v17 = (const WCHAR *)v31;
  if ( v32 >= 8 )
    v17 = (const WCHAR *)v31[0];
  v26 = v17;
  v26 = (const WCHAR *)Microsoft::WRL::Wrappers::HStringReference::HStringReference(&hstringHeader, &v26)[1].Reserved.Reserved1;
  v27[0] = v25;
  ___CallAndWaitForCompletion_UIStorageFile_Storage_Windows__PEAUIStorageFolder_23_PEAUHSTRING____W4NameCollisionOption_23_PEAPEAU__IAsyncOperation_PEAVStorageFile_Storage_Windows___Foundation_3___ZPEAU423_PEAU5_W4623__wil__YA_AV__ComPtr_UIStorageFile_Storage_Windows___WRL_Microsoft__PEAUIStorageFile_Storage_Windows__P8456_EAAJPEAUIStorageFolder_56_PEAUHSTRING____W4NameCollisionOption_56_PEAPEAU__IAsyncOperation_PEAVStorageFile_Storage_Windows___Foundation_6__Z__QEAPEAU756___QEAPEAU8___QEAW4956__Z(
