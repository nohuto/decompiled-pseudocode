/*
 * XREFs of Windows::Services::TargetedContent::Internal::ExecuteActionOnTrigger__lambda_25fdd0f24a46fb884595cc4fd71754f0___ @ 0x18006BC4C
 * Callers:
        ...
        __int64 a2)
{
  ...
  PCWSTR v33; // [rsp+70h] [rbp-48h] BYREF
  PCWSTR v34; // [rsp+78h] [rbp-40h] BYREF
            ...
            if ( v16 >= 0 )
            {
              ...
              if ( v19 >= 0 )
              {
                ...
                if ( v21 >= 0 )
                {
                  ...
                  StringRawBuffer = WindowsGetStringRawBuffer(v41, 0LL);
                  ...
                  v36 = v23;
                  v24 = **(_QWORD **)(a2 + 16) + 8LL;
                  v33 = WindowsGetStringRawBuffer(**(HSTRING **)(a2 + 8), 0LL);
