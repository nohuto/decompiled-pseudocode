/*
 * XREFs of ?ShouldUseInternal@Policy@CreativeFramework@@YA_NXZ @ 0x1800A581C
 * Callers:
 ...
 *     ?GetLayoutType@Settings@TargetedContentLayoutHelpers@CreativeFramework@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEAUHSTRING__@@PEB_W@Z @ 0x1800A5B98 (-GetLayoutType@Settings@TargetedContentLayoutHelpers@CreativeFramework@@YA-AV-$basic_string@_WU-.c)
 * Callees:
...
char __fastcall CreativeFramework::Policy::ShouldUseInternal(CreativeFramework::Policy *this)
{
  ...
  AcquireSRWLockShared(&stru_18019D460);
  v1 = 0;
  if ( !byte_18019D411 )
  {
    ReleaseSRWLockShared(&stru_18019D460);
    AcquireSRWLockExclusive(&stru_18019D460);
    if ( byte_18019D411 )
    {
      v1 = byte_18019D410;
LABEL_16:
      ReleaseSRWLockExclusive(&stru_18019D460);
      return v1;
    }
