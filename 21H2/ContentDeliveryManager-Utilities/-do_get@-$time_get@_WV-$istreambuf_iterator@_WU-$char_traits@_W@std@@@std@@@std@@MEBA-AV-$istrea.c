/*
 * XREFs of ?do_get@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@DD@Z @ 0x1800ADB10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$_Getloctxt@DV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@YAHAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@0@0_KPEBD@Z @ 0x1800AF6AC (--$_Getloctxt@DV-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@YAHAEAV-$istreambuf_i.c)
...
LABEL_19:
                  v18 = 0;
LABEL_53:
                  *v16 |= std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getint(
                            a1,
                            (_DWORD)a3,
                            (_DWORD)a4,
                            v18,
          ...
          v23 = std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getint(
                  a1,
                  (_DWORD)a3,
                  (_DWORD)a4,
                  0,
  ...
  if ( a8 > 110 )
  {
    ...
    if ( a8 != 116 )
    {
      ...
      if ( a8 != 120 )
      {
        if ( a8 == 121 )
        {
          v30 = std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getint(
                  a1,
                  (_DWORD)a3,
                  (_DWORD)a4,
                  0,
...
LABEL_52:
  ...
  if ( a8 != 109 )
    goto LABEL_73;
  v28 = std::time_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getint(
          a1,
          (_DWORD)a3,
          (_DWORD)a4,
          1,
