/*
 * XREFs of ??$ReportEntitlementAcquisitionState@AEBQEB_WAEBQEB_WAEA_NIAEBQEB_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEBQEB_W0AEA_N$$QEAI0@Z @ 0x180086E64
 * Callers:
        ...
        const WCHAR **a5)
{
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
      ...
      && (*(_QWORD *)(v10 + 24) & 0x400000000000LL) == *(_QWORD *)(v10 + 24) )
    {
      ...
      v25 = v11;
      v26 = 0;
      LODWORD(v9) = tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_18017C986, 0LL, 0LL, 7u, &v23);
    }
  }
  return (int)v9;
}
