/*
 * XREFs of ?get_ScoreName@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180062DC0
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v2 = WindowsDuplicateString(this[21], a2);
  v3 = v2;
  if ( v2 >= 0 )
    return 0LL;
