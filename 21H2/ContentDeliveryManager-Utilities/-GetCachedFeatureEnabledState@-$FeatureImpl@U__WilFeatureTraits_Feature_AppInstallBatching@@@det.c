/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_AppInstallBatching@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18005D18C
 * Callers:
