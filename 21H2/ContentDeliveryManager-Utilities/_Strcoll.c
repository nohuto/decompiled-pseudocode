/*
 * XREFs of _Strcoll @ 0x1800CEDB0
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x1800CCB80 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800BBC6C (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800BBC78 (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x1800BBCD8 (__crtCompareStringA_Stub.c)
