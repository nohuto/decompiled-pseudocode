/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x180005084
 * Callers:
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x1800D0D4E (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
 * Callees:
