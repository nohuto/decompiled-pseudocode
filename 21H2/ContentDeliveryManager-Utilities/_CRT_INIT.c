/*
 * XREFs of _CRT_INIT @ 0x1800CF28C
 * Callers:
 *     __DllMainCRTStartup @ 0x1800CF514 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800CFF45 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800CFFB0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800D011E (_initterm_0.c)
