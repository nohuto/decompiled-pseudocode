/*
 * XREFs of ??1TriggerManagerGetTriggeredItemsForStateActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAA@XZ @ 0x18006785C
 * Callers:
 *     _Windows::Services::TargetedContent::Internal::TargetedContentTriggerManagerStatics::GetTriggeredItemsForStateAsync_::_1_::dtor$1 @ 0x1800D4E52 (_Windows--Services--TargetedContent--Internal--TargetedContentTriggerManagerStatics_ea_1800D4E52.c)
 *     __lambda_b59dbdfd0007f2d89c20db91cc7697cd_::operator()_::_1_::dtor$0 @ 0x1800D4ED6 (__lambda_b59dbdfd0007f2d89c20db91cc7697cd_--operator()_--_1_--dtor$0.c)
 * Callees:
