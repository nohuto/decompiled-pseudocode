/*
 * XREFs of _std::make_shared_CreativeFramework::Actions::LaunchAppByIdService_wchar_t_const____::_1_::dtor$1 @ 0x1800D7E7C
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::make_shared_CreativeFramework::Actions::LaunchAppByIdService_wchar_t_const____::_1_::dtor_1(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
