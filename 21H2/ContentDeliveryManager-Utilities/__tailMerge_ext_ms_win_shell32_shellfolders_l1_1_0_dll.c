/*
 * XREFs of __tailMerge_ext_ms_win_shell32_shellfolders_l1_1_0_dll @ 0x1800D04CA
 * Callers:
 *     __imp_load_SHGetKnownFolderPath @ 0x1800D04BE (__imp_load_SHGetKnownFolderPath.c)
 * Callees:
