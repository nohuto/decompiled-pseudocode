/*
 * XREFs of ?Release@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x180017434
 * Callers:
 *     wil::details::_dynamic_atexit_destructor_for__g_processLocalData__ @ 0x1800DABF0 (wil--details--_dynamic_atexit_destructor_for__g_processLocalData__.c)
 * Callees:
 ...
 *     ??1ThreadLocalData@details_abi@wil@@QEAA@XZ @ 0x1800066D0 (--1ThreadLocalData@details_abi@wil@@QEAA@XZ.c)
