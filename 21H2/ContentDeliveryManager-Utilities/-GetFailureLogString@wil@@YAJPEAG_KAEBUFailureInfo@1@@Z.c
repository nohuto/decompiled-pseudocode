/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x18000429C
 * Callers:
 *     ?what@ResultException@wil@@UEBAPEBDXZ @ 0x180004E00 (-what@ResultException@wil@@UEBAPEBDXZ.c)
 ...
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$0 @ 0x1800D0CB1 (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$0.c)
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$3 @ 0x1800D0D86 (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$3.c)
 * Callees:
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x18000424C (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
