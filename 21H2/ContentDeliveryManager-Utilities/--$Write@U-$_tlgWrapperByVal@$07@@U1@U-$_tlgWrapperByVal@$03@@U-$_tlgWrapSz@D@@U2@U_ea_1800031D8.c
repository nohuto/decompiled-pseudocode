        ...
        const unsigned __int16 **a25)
{
  ...
  const WCHAR *v75; // [rsp+C0h] [rbp-40h]
  ...
  const WCHAR *v96; // [rsp+140h] [rbp+40h]
  ...
  const unsigned __int16 *v108; // [rsp+190h] [rbp+90h]
