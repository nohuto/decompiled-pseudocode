/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_BannersCanTargetKnownFolders@@@wil@@SA_NXZ @ 0x180033F40
 * Callers:
 *     <none>
 * Callees:
...
char wil::Feature<__WilFeatureTraits_Feature_BannersCanTargetKnownFolders>::IsEnabled()
{
  ...
  if ( (`wil::Feature<__WilFeatureTraits_Feature_BannersCanTargetKnownFolders>::GetImpl'::`2'::impl & 4) == 0 )
  {
  ...
  wil::details::ReportUsageToService(
    (volatile signed __int32 *)&unk_18019D1D0,
    0x1067B86u,
    (v0 >> 10) & 1,
    (v0 >> 11) & 1,
    (__int64)&v2,
