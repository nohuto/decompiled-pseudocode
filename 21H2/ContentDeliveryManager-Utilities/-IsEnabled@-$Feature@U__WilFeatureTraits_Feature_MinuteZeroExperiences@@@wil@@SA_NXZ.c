/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_MinuteZeroExperiences@@@wil@@SA_NXZ @ 0x180033D00
 * Callers:
 *     <none>
 * Callees:
...
char wil::Feature<__WilFeatureTraits_Feature_MinuteZeroExperiences>::IsEnabled()
{
  ...
  if ( (`wil::Feature<__WilFeatureTraits_Feature_MinuteZeroExperiences>::GetImpl'::`2'::impl & 4) == 0 )
  {
  ...
  wil::details::ReportUsageToService(
    (volatile signed __int32 *)&unk_18019D1B0,
    0x81AA4Au,
    (v0 >> 10) & 1,
    (v0 >> 11) & 1,
    (__int64)&v2,
