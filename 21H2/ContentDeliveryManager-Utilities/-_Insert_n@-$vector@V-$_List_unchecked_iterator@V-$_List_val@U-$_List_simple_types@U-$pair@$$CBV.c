  ...
  if ( a4 )
  {
    ...
    if ( (a1[2] - v10) >> 3 >= a4 )
    {
      ...
      if ( (v10 - (__int64)a3) >> 3 >= a4 )
      {
        ...
        {
          v24 -= 8;
          *(_QWORD *)&v24[v20] = *(_QWORD *)v24;
        }
        v22 = (unsigned __int64)(v20 + 7) >> 3;
        v23 = a3 <= &a3[v20];
      }
      else
      {
      ...
      if ( !v23 )
        v22 = 0LL;
      if ( v22 )
        memset64(a3, (unsigned __int64)v19, v22);
    }
    else
    {
      v11 = (v10 - *a1) >> 3;
