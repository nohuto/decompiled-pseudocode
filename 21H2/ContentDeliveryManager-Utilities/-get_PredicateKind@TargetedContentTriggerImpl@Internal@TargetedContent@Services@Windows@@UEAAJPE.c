/*
 * XREFs of ?get_PredicateKind@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAW4TargetedContentPredicateKind@2345@@Z @ 0x180062770
 * Callers:
 *     <none>
 * Callees:
 *     <none>
