/*
 * XREFs of ?OnClose@?$AsyncOperation@U?$IAsyncOperation@PEAUHSTRING__@@@Foundation@Windows@@U?$IAsyncOperationCompletedHandler@PEAUHSTRING__@@@23@VCHSTRINGResult@Internal@3@VComTaskPoolHandler@63@UINilDelegate@63@U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@UEAAXXZ @ 0x180022440
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        __int64 a1)
{
  ...
  if ( result == 1 )
  {
    result = WindowsDeleteString(*(HSTRING *)(a1 + 288));
    *(_QWORD *)(a1 + 288) = 0LL;
  }
  return result;
}
