/*
 * XREFs of __tailMerge_ext_ms_win_rtcore_ntuser_cursor_l1_1_0_dll @ 0x1800D0152
 * Callers:
 *     __imp_load_SetCursor @ 0x1800D0146 (__imp_load_SetCursor.c)
 *     __imp_load_LoadCursorW @ 0x1800D01D1 (__imp_load_LoadCursorW.c)
 * Callees:
