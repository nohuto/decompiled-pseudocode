 ...
 *     ??$_Buffered_merge@PEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@_JV12@Uless_than_special_bindings@TargetedContentLayoutHelpers@CreativeFramework@@@std@@YAXPEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@0@00_J1AEAV?$_Temp_iterator@V?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@0@Uless_than_special_bindings@TargetedContentLayoutHelpers@CreativeFramework@@@Z @ 0x1800AB880 (--$_Buffered_merge@PEAV-$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@.c)
 * Callees:
 ...
 *     ?_Maxlen@?$_Temp_iterator@V?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@std@@QEAA_JXZ @ 0x1800AB394 (-_Maxlen@-$_Temp_iterator@V-$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@s.c)
 *     ??$_Buffered_merge@PEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@_JV12@Uless_than_special_bindings@TargetedContentLayoutHelpers@CreativeFramework@@@std@@YAXPEAV?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@0@00_J1AEAV?$_Temp_iterator@V?$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@@0@Uless_than_special_bindings@TargetedContentLayoutHelpers@CreativeFramework@@@Z @ 0x1800AB880 (--$_Buffered_merge@PEAV-$shared_ptr@UItem@TargetedContentLayoutHelpers@CreativeFramework@@@std@@.c)
        ...
        char a7)
{
  ...
  _QWORD *v37[12]; // [rsp+70h] [rbp-21h] BYREF
...
LABEL_28:
    result = *a2;
    v29 = *(double *)(*a2 + 32);
    v30 = *(double *)(*(_QWORD *)a1 + 32LL);
    if ( v30 > v29 || v29 == v30 && *(double *)(*(_QWORD *)a1 + 40LL) > *(double *)(result + 40) )
    {
      v31 = *((_QWORD *)a1 + 1);
      *((_QWORD *)a1 + 1) = a2[1];
      result = *a2;
  ...
  else
  {
    while ( 1 )
    {
      ...
      if ( v7 >= v8 )
      {
        ...
        if ( v20 > 0 )
        {
          ...
          do
          {
            ...
            v24 = *(double *)(v23 + 32);
            if ( v24 > v22 || v22 == v24 && *(double *)(v23 + 40) > *(double *)(*v13 + 40) )
            {
              v20 /= 2LL;
            }
            else
      ...
      else
      {
        ...
        if ( v12 > 0 )
        {
          v16 = *(double *)(*(_QWORD *)v15 + 32LL);
          do
          {
            v17 = v13[2 * (v12 / 2)];
            v18 = *(double *)(v17 + 32);
            if ( v16 > v18 || v18 == v16 && *(double *)(*(_QWORD *)v15 + 40LL) > *(double *)(v17 + 40) )
            {
              v13 += 2 * (v12 / 2) + 2;
              v12 += -1 - v12 / 2;
            }
      ...
      v39 = v8 - v14;
      v25 = std::_Buffered_rotate<std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item> *,__int64,std::shared_ptr<CreativeFramework::TargetedContentLayoutHelpers::Item>>(
              (_DWORD)v15,
              (_DWORD)a2,
              (_DWORD)v13,
              (int)v8 - (int)v14,
