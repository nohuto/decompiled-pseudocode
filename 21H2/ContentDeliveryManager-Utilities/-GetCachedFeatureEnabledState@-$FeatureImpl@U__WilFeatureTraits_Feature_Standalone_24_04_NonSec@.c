/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Standalone_24_04_NonSec@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800A40A0
 * Callers:
        ...
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  ...
  if ( (v7 & 0xFFFFFF3F) == 0 )
  {
    v10 = v9 | 0x40;
LABEL_11:
    if ( (`wil::Feature<__WilFeatureTraits_Feature_Servicing_Dcr_24_03_NonSec>::GetImpl'::`2'::impl & 4) == 0 )
      wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_Dcr_24_03_NonSec>::GetCachedFeatureEnabledState(
        (wil::details *)&`wil::Feature<__WilFeatureTraits_Feature_Servicing_Dcr_24_03_NonSec>::GetImpl'::`2'::impl,
        &v21);
    v12 = 1;
    goto LABEL_15;
  }
