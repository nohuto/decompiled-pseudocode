/*
 * XREFs of ?_Init@locale@std@@CAPEAV_Locimp@12@_N@Z @ 0x1800B31F0
 * Callers:
 ...
 * Callees:
 *     ??4?$_Yarn@D@std@@QEAAAEAV01@PEBD@Z @ 0x18004F5B4 (--4-$_Yarn@D@std@@QEAAAEAV01@PEBD@Z.c)
...
struct std::locale::_Locimp *__fastcall std::locale::_Init(char a1)
{
  ...
  v2 = (struct std::locale::_Locimp *)qword_18019C468;
  if ( !qword_18019C468 )
  {
    ...
    *((_DWORD *)v2 + 8) = 63;
    ...
    qword_18019C4A0 = (__int64)std::locale::_Locimp::_Clocptr;
  }
  if ( a1 )
    (*(void (__fastcall **)(struct std::locale::_Locimp *))(*(_QWORD *)v2 + 8LL))(v2);
