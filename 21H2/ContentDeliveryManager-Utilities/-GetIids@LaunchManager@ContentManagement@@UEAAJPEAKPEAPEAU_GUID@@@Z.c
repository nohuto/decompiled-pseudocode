/*
 * XREFs of ?GetIids@LaunchManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x18000F640
 * Callers:
 *     ?GetIids@LaunchManager@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180024260 (-GetIids@LaunchManager@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
