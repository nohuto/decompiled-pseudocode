/*
 * XREFs of _lambda_b7df6605325939df64e4896ead66165a_::operator() @ 0x180053F3C
 * Callers:
 *     Windows::Internal::COperationLambdaVar_0__lambda_b7df6605325939df64e4896ead66165a__Windows::Internal::CNoResult_::Run @ 0x180056C80 (Windows--Internal--COperationLambdaVar_0__lambda_b7df6605325939df64e4896ead66165a__Windows--Inte.c)
 * Callees:
 ...
 *     ?StartActivity@ActionInvokedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBG00@Z @ 0x180052134 (-StartActivity@ActionInvokedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryM.c)
 *     ??1?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAAAAAAA@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAA@XZ @ 0x180053158 (--1-$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAA.c)
