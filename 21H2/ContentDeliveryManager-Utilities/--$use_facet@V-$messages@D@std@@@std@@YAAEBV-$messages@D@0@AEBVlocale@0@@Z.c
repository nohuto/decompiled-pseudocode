/*
 * XREFs of ??$use_facet@V?$messages@D@std@@@std@@YAAEBV?$messages@D@0@AEBVlocale@0@@Z @ 0x1800C941C
 * Callers:
 ...
 *     ?_Getcat@?$messages@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800C9F6C (-_Getcat@-$messages@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
