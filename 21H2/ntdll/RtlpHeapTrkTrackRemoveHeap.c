/*
 * XREFs of RtlpHeapTrkTrackRemoveHeap @ 0x1800FEBD4
 * Callers:
...
PVOID *__fastcall RtlpHeapTrkTrackRemoveHeap(PVOID a1)
{
  ...
  {
    v3 = v2 & 0xF;
    RtlAcquireSRWLockExclusive(*(PRTL_SRWLOCK *)(qword_18016DBE0 + 8 * v3));
    v4 = *(PVOID **)(qword_18016DA70 + 16LL * v2);
    v5 = qword_18016DA70 + 16LL * v2;
    if ( v4 != (PVOID *)v5 )
    {
      do
      {
