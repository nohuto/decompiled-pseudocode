/*
 * XREFs of TimeToDaysAndFraction @ 0x18007BD58
 * Callers:
 *     RtlTimeToElapsedTimeFields @ 0x18007BCC0 (RtlTimeToElapsedTimeFields.c)
 * Callees:
 *     RtlExtendedMagicDivide @ 0x18007BDF0 (RtlExtendedMagicDivide.c)
 */
