/*
 * XREFs of RtlpEnsureLiveDeadListsInitialized @ 0x1800DF920
 * Callers:
...
__int64 RtlpEnsureLiveDeadListsInitialized()
{
  ...
  if ( !g_SxsLiveActivationContexts )
  {
    ...
    if ( !g_SxsLiveActivationContexts )
    {
      qword_18016D830 = (__int64)&g_SxsLiveActivationContexts;
      g_SxsLiveActivationContexts = (__int64)&g_SxsLiveActivationContexts;
      qword_18016D820 = (__int64)&g_SxsFreeActivationContexts;
