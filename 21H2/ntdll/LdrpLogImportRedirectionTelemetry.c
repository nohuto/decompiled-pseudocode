/*
 * XREFs of LdrpLogImportRedirectionTelemetry @ 0x1800CF684
 * Callers:
  ...
  if ( v1->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_1801664E8 > 5 )
    {
      ...
      if ( (_BYTE)v1 )
      {
        ...
        v8 = 2;
        v13 = 2;
        LOBYTE(v1) = tlgWriteTransfer_EtwEventWriteTransfer(v3, (unsigned __int8 *)dword_180131DDB, 2LL, v4, 6u, &v6);
      }
    }
  }
  return (char)v1;
