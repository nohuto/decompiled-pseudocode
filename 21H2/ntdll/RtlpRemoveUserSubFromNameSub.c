/*
 * XREFs of RtlpRemoveUserSubFromNameSub @ 0x180063BDC
 * Callers:
 *     RtlpSubscribeWnfStateChangeNotificationInternal @ 0x1800424AC (RtlpSubscribeWnfStateChangeNotificationInternal.c)
 *     RtlUnsubscribeWnfNotificationWithCompletionCallback @ 0x180063960 (RtlUnsubscribeWnfNotificationWithCompletionCallback.c)
 *     RtlUnsubscribeWnfStateChangeNotification @ 0x180063B20 (RtlUnsubscribeWnfStateChangeNotification.c)
