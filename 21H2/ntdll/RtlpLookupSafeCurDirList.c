/*
 * XREFs of RtlpLookupSafeCurDirList @ 0x1800DEFFC
 * Callers:
      ...
      *Heap = Heap;
      ...
      if ( !qword_18016D7D0 )
      {
        ...
        if ( v4 < 0 )
          v5 = -1LL;
        KeyHandle = (HANDLE)v5;
        v3 = (HANDLE)_InterlockedCompareExchange64((volatile signed __int64 *)&qword_18016D7D0, v5, 0LL);
        if ( v3 )
        {
          if ( v4 >= 0 )
            NtClose(KeyHandle);
