...
__int64 __fastcall RtlpHpFreeHeap(__int64 a1, unsigned __int64 a2, int a3, __int64 *a4, _WORD *a5)
{
  ...
  if ( a5 )
  {
    ...
    {
      v67 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016DC60, 2 * ((a2 - qword_18016DC58) >> 20));
...
LABEL_38:
  ...
  if ( (*(_DWORD *)(a1 + 20) & 0x10000000) == 0 || RtlpHpSizeHeap(a1, a2, v14) != -1 )
  {
    ...
    {
      v64 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016DC60, 2 * ((a2 - qword_18016DC58) >> 20));
