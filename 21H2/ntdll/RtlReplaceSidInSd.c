/*
 * XREFs of RtlReplaceSidInSd @ 0x1800E6CF0
 * Callers:
 *     <none>
 * Callees:
 *     RtlGetDaclSecurityDescriptor @ 0x180071D80 (RtlGetDaclSecurityDescriptor.c)
 *     RtlGetSaclSecurityDescriptor @ 0x180076C50 (RtlGetSaclSecurityDescriptor.c)
 *     RtlGetOwnerSecurityDescriptor @ 0x1800795E0 (RtlGetOwnerSecurityDescriptor.c)
 *     RtlGetGroupSecurityDescriptor @ 0x18007AA80 (RtlGetGroupSecurityDescriptor.c)
  ...
  if ( (int)result >= 0 )
  {
    if ( v34 )
    {
      if ( *(_BYTE *)v34 == *(_BYTE *)a2 )
      {
        ...
        if ( *(_BYTE *)(v34 + 1) == (_BYTE)v11 || *(unsigned __int8 *)(v34 + 1) == v11 + 1 )
        {
    ...
    if ( (int)result >= 0 )
    {
      if ( v34 )
      {
        if ( *(_BYTE *)v34 == *(_BYTE *)a2 )
        {
          ...
          if ( *(_BYTE *)(v34 + 1) == (_BYTE)v14 || *(unsigned __int8 *)(v34 + 1) == v14 + 1 )
          {
          ...
          if ( v30[0] )
          {
            ...
            if ( *(_WORD *)(v30[0] + 4LL) )
            {
              while ( *(_BYTE *)v18 > 3u )
              {
                if ( *(_BYTE *)v18 == 4 )
                {
                  v19 = v18 + 4 * (*(unsigned __int8 *)(v18 + 13) + 5LL);
                  goto LABEL_29;
                }
LABEL_37:
...
LABEL_29:
              if ( *(_BYTE *)v19 == *(_BYTE *)a2 )
              {
                ...
                if ( *(_BYTE *)(v19 + 1) == (_BYTE)v20 || *(unsigned __int8 *)(v19 + 1) == v20 + 1 )
                {
