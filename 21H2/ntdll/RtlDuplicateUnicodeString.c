/*
 * XREFs of RtlDuplicateUnicodeString @ 0x180079E70
 * Callers:
 *     RtlpTpIoDllProcessUnloads @ 0x180113588 (RtlpTpIoDllProcessUnloads.c)
 * Callees:
 *     NtdllpFreeStringRoutine @ 0x180022E70 (NtdllpFreeStringRoutine.c)
 *     NtdllpAllocateStringRoutine @ 0x18006EBE0 (NtdllpAllocateStringRoutine.c)
 *     RtlValidateUnicodeString @ 0x180079FB0 (RtlValidateUnicodeString.c)
