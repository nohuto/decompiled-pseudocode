/*
 * XREFs of Normalization__CanCombinableCharactersCombine @ 0x1800FFED0
 * Callers:
 ...
 *     NormBuffer__RecheckStartCombinations @ 0x1800FF9F8 (NormBuffer__RecheckStartCombinations.c)
