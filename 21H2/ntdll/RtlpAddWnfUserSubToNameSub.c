/*
 * XREFs of RtlpAddWnfUserSubToNameSub @ 0x1800425FC
 * Callers:
 ...
 *     NtSubscribeWnfStateChange @ 0x1800A0DB0 (NtSubscribeWnfStateChange.c)
        ...
        unsigned __int64 a4)
{
  ...
  *(_DWORD *)(a1 + 24) = v18;
  ...
  RtlReleaseSRWLockExclusive((volatile signed __int64 *)(qword_18016D250 + 8));
