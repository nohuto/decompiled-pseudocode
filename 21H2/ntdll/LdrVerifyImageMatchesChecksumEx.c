/*
 * XREFs of LdrVerifyImageMatchesChecksumEx @ 0x18008B190
 * Callers:
 *     LdrVerifyImageMatchesChecksum @ 0x1800CE790 (LdrVerifyImageMatchesChecksum.c)
 * Callees:
 *     RtlpImageDirectoryEntryToDataEx @ 0x180032920 (RtlpImageDirectoryEntryToDataEx.c)
 *     RtlImageNtHeaderEx @ 0x180032AD0 (RtlImageNtHeaderEx.c)
 *     RtlImageRvaToVa @ 0x180086F70 (RtlImageRvaToVa.c)
 ...
 *     NtMakeTemporaryObject @ 0x18009F830 (NtMakeTemporaryObject.c)
 *     _guard_dispatch_icall_nop @ 0x1800A1160 (_guard_dispatch_icall_nop.c)
 *     LdrpGenericExceptionFilter @ 0x1800D558C (LdrpGenericExceptionFilter.c)
 *     LdrVerifyMappedImageMatchesChecksum @ 0x1800F5B0C (LdrVerifyMappedImageMatchesChecksum.c)
 */
...
LABEL_30:
    if ( InformationFile < 0 || v4 == (_DWORD *)&unk_180123568 )
    {
      v14 = *((_QWORD *)v4 + 2);
