...
LABEL_12:
    ...
    else
    {
      while ( 1 )
      {
        ...
        else if ( v5 && (v8 == 45 && v11 == v4 + 1 || !ValidateStd3Range((unsigned __int16)v8)) || v8 < 0x20 )
        {
          return 0;
        }
        if ( ++v11 == v9 )
