/*
 * XREFs of _RtlpMuiRegLoadInstalled @ 0x180106B9C
 * Callers:
 ...
 *     RtlpMuiRegCreateLanguages @ 0x1801045A4 (RtlpMuiRegCreateLanguages.c)
 *     RtlpMuiRegCreateStringPool @ 0x180104638 (RtlpMuiRegCreateStringPool.c)
