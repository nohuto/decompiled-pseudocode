/*
 * XREFs of RtlpLookupCurDirSetting @ 0x18006DF40
 * Callers:
...
__int64 __fastcall RtlpLookupCurDirSetting(__int64 a1, unsigned __int32 a2, volatile signed __int32 *a3)
{
  ...
  {
    Handle = (HANDLE)qword_18016D500;
    v6 = (HANDLE)qword_18016D500;
    if ( !qword_18016D500 )
    {
...
LABEL_7:
      ...
      v6 = (HANDLE)_InterlockedCompareExchange64(&qword_18016D500, (signed __int64)Handle, 0LL);
      if ( v6 )
      {
        NtClose(Handle);
        Handle = v6;
