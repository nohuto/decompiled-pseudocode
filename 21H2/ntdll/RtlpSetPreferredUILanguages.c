/*
 * XREFs of RtlpSetPreferredUILanguages @ 0x1800F1270
 * Callers:
 ...
 *     RtlpGetMultiStringLength @ 0x1800F09F0 (RtlpGetMultiStringLength.c)
 *     RtlpSetInstallLanguage @ 0x1800F0BC0 (RtlpSetInstallLanguage.c)
 *     RtlpSetMachineUILanguagesImmediate @ 0x1800F10A8 (RtlpSetMachineUILanguagesImmediate.c)
 *     RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId @ 0x18010478C (RtlpMuiRegGetFallbackInstalledLanguageInfoByLangId.c)
 */
...
LABEL_103:
  ...
  if ( v13 >= 0 )
  {
    if ( !v4 )
    {
      v33 = 2;
      LODWORD(v51) = 262146;
      v34 = (WCHAR *)&unk_18013840C;
      v3 = v12;
      *((_QWORD *)&v51 + 1) = &unk_18013840C;
      v39 = 4;
      goto LABEL_133;
    }
    v15 = 4LL;
