/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x180076A10
 * Callers:
...
ULONG __cdecl RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_180130554[8 * v5] )
        {
          v8 = (unsigned __int16)word_180130556[4 * v5];
          if ( byte_180130555[8 * v5] == 1 )
