/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1800EE958
 * Callers:
 *     RtlSetDynamicTimeZoneInformation @ 0x1800EE8B0 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1800EE8C0 (RtlSetTimeZoneInformation.c)
 * Callees:
