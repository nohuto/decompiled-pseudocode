/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1800EE998
 * Callers:
 *     RtlSetDynamicTimeZoneInformation @ 0x1800EE8F0 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1800EE900 (RtlSetTimeZoneInformation.c)
 * Callees:
