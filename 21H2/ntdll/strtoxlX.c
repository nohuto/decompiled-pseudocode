/*
 * XREFs of strtoxlX @ 0x180091B9C
 * Callers:
 *     strtol @ 0x180091DC0 (strtol.c)
 *     strtolX @ 0x180091DF0 (strtolX.c)
 *     strtoul @ 0x180091E20 (strtoul.c)
 * Callees:
 *     _errno @ 0x1800858E0 (_errno.c)
 *     _invalid_parameter @ 0x18008C868 (_invalid_parameter.c)
 *     __pctype_func @ 0x180092C30 (__pctype_func.c)
 */
