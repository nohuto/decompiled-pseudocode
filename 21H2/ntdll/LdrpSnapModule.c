 ...
 *     RtlpImageDirectoryEntryToData32 @ 0x1800EB250 (RtlpImageDirectoryEntryToData32.c)
 */
...
LABEL_79:
  ...
  if ( qword_1801813A8 && (byte_18018138C & 1) == 0 )
  {
    if ( v15 < *((_QWORD *)&xmmword_180181510 + 1)
      || v15 >= *((_QWORD *)&xmmword_180181510 + 1) + (unsigned __int64)(unsigned int)qword_180181520 )
    {
