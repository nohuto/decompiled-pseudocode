 ...
 * Callees:
 *     NtCompareSigningLevels @ 0x18009E9B0 (NtCompareSigningLevels.c)
 *     NtGetCachedSigningLevel @ 0x18009F450 (NtGetCachedSigningLevel.c)
 *     ZwSetCachedSigningLevel @ 0x1800A0790 (ZwSetCachedSigningLevel.c)
 */
