/*
 * XREFs of LdrpRelocateImage @ 0x1800834FC
 * Callers:
...
__int64 __fastcall LdrpRelocateImage(PVOID BaseOfImage, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (*(_BYTE *)(a3 + 22) & 1) != 0 )
    goto LABEL_11;
  v9 = RtlpImageDirectoryEntryToDataEx((unsigned __int64)BaseOfImage, 1, 5u, &v15, (char **)v14);
  v10 = v14[0];
  if ( v9 < 0 )
    v10 = 0LL;
  if ( v10 && v15 )
  {
LABEL_11:
    v12 = RtlpImageDirectoryEntryToDataEx((unsigned __int64)BaseOfImage, 1, 0xEu, &v15, (char **)v14);
    v13 = v14[0];
    if ( v12 < 0 )
      v13 = 0LL;
