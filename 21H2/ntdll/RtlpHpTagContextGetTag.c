/*
 * XREFs of RtlpHpTagContextGetTag @ 0x18009CEB4
 * Callers:
...
__int64 __fastcall RtlpHpTagContextGetTag(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( SubProcessTag == (void *)RtlpHpNullGUID )
    v4 = *((_QWORD *)&v16 + 1) - qword_18016D5E0;
  if ( !v4 )
    return 0LL;
  if ( word_18016AB24 )
  {
    v6 = *(_QWORD *)(qword_18016AB18 + 8LL * (unsigned __int16)word_18016AB24 - 8);
