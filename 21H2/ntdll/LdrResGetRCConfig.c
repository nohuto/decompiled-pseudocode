/*
 * XREFs of LdrResGetRCConfig @ 0x1800580E0
 * Callers:
 ...
 *     CheckOneBitValidFlag @ 0x180058900 (CheckOneBitValidFlag.c)
...
LABEL_24:
        if ( a5 )
        {
          ...
          if ( v17 )
            v18 = (__int64)v17;
          LdrpSetAlternateResourceModuleHandle(v15, 0LL, 0LL, v18, 0, 2, v13, 0LL);
        }
        goto LABEL_10;
      }
      v13 = -1073020925;
