/*
 * XREFs of RtlpMuiRegGetFallbackLanguageInfoByIndex @ 0x1801048B8
 * Callers:
 *     RtlpMuiRegGetFallbackLanguagesAsMultiSZ @ 0x180104D48 (RtlpMuiRegGetFallbackLanguagesAsMultiSZ.c)
 * Callees:
 *     <none>
 */
