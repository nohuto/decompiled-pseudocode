/*
 * XREFs of RtlpMuiRegGetFallbackLanguageInfoByIndex @ 0x180104878
 * Callers:
 *     RtlpMuiRegGetFallbackLanguagesAsMultiSZ @ 0x180104D08 (RtlpMuiRegGetFallbackLanguagesAsMultiSZ.c)
 * Callees:
 *     <none>
 */
