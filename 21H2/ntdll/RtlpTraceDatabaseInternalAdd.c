/*
 * XREFs of RtlpTraceDatabaseInternalAdd @ 0x180102D04
 * Callers:
 ...
 *     RtlpTraceDatabaseInternalFind @ 0x180102EAC (RtlpTraceDatabaseInternalFind.c)
 */
...
char __fastcall RtlpTraceDatabaseInternalAdd(__int64 a1, unsigned int a2, const void *a3, _QWORD *a4)
{
  ...
  if ( a2 <= 0x100 )
  {
    ...
    {
      v12 = *(_QWORD *)(a1 + 24);
      if ( v12 && *(_QWORD *)(a1 + 32) > v12 || (v13 = RtlpTraceDatabaseAllocate(), (v10 = v13) == 0) )
      {
LABEL_11:
        if ( a4 )
          *a4 = 0LL;
