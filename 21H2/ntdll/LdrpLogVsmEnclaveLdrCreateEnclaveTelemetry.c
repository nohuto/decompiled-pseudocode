/*
 * XREFs of LdrpLogVsmEnclaveLdrCreateEnclaveTelemetry @ 0x1800CFE70
 * Callers:
  ...
  if ( v2->ProcessHeap )
  {
    ...
    if ( (unsigned int)dword_180166590 > 4 )
    {
      ...
      if ( (_BYTE)v2 )
      {
        ...
        v9 = a2;
        v19 = 4;
        LOBYTE(v2) = tlgWriteTransfer_EtwEventWriteTransfer(v5, (unsigned __int8 *)dword_180131C80, v6, v7, 5u, &v11);
      }
    }
  }
  return (char)v2;
