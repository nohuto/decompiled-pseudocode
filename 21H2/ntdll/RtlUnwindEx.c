 ...
 *     __C_specific_handler @ 0x18008CDE0 (__C_specific_handler.c)
 *     KiUserCallbackDispatcherHandler @ 0x1800A13E0 (KiUserCallbackDispatcherHandler.c)
 *     __longjmp_internal @ 0x1800A4330 (__longjmp_internal.c)
 * Callees:
 ...
 *     RtlpExecuteHandlerForUnwind @ 0x1800A2A50 (RtlpExecuteHandlerForUnwind.c)
