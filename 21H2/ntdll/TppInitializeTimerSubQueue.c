/*
 * XREFs of TppInitializeTimerSubQueue @ 0x180063294
 * Callers:
 ...
 *     ZwAssociateWaitCompletionPacket @ 0x18009E7F0 (ZwAssociateWaitCompletionPacket.c)
 *     NtCreateTimer2 @ 0x18009EE70 (NtCreateTimer2.c)
