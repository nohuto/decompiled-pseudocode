/*
 * XREFs of RtlpWow64CtxFromAmd64 @ 0x180086FE0
 * Callers:
 *     RtlpWow64GetContextOnAmd64 @ 0x18006FBF0 (RtlpWow64GetContextOnAmd64.c)
 * Callees:
 *     RtlFxToFnFrame @ 0x1800871C8 (RtlFxToFnFrame.c)
 */
