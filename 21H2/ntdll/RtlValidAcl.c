 ...
 *     RtlpValidAccessFilterAce @ 0x1800EAB14 (RtlpValidAccessFilterAce.c)
 *     RtlpValidAttributeAce @ 0x1800EACFC (RtlpValidAttributeAce.c)
 *     RtlpValidCompoundAce @ 0x1800EADF4 (RtlpValidCompoundAce.c)
 *     RtlpValidObjectAce @ 0x1800EAE70 (RtlpValidObjectAce.c)
 */
