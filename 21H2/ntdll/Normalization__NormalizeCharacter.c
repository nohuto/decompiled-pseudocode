 ...
 *     Normalization__AppendDecomposedChar @ 0x1800FFDBC (Normalization__AppendDecomposedChar.c)
 * Callees:
 *     NormBuffer__AppendEx @ 0x180080EC0 (NormBuffer__AppendEx.c)
 *     NormBuffer__Append @ 0x180080F0C (NormBuffer__Append.c)
 *     ComposeHangulLV @ 0x1800FF5E8 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1800FF618 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1800FF64C (IsHangulLV.c)
 *     NormBuffer__GetLastChar @ 0x1800FF774 (NormBuffer__GetLastChar.c)
 *     NormBuffer__Insert @ 0x1800FF80C (NormBuffer__Insert.c)
 *     NormBuffer__IsBlocked @ 0x1800FF8D4 (NormBuffer__IsBlocked.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x1800FFCAC (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1800FFDBC (Normalization__AppendDecomposedChar.c)
