/*
 * XREFs of PsspWalkHandleTable @ 0x180116324
 * Callers:
 ...
 *     ZwQueryObject @ 0x18009D800 (ZwQueryObject.c)
...
LABEL_19:
    ...
    if ( (a4 & 0x20) != 0 )
    {
      v16 = (const wchar_t **)&off_18011E270;
      ...
      v17 = 3LL * v7;
      if ( ((int (__fastcall *)(HANDLE, _BYTE *, __int64, int *))*(&off_18011E270 + v17 + 1))(
             TargetHandle,
             v26,
             64LL,
             &v18) < 0
