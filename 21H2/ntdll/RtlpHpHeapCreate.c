 ...
 *     RtlpGetHeapInterceptorIndex @ 0x180108198 (RtlpGetHeapInterceptorIndex.c)
...
__int64 __fastcall RtlpHpHeapCreate(unsigned int a1, unsigned __int64 a2, __int64 a3, __int128 *a4)
{
  ...
  *((_QWORD *)&v22 + 1) = RtlpHpSegLfhVsFree;
  ...
  RtlpHpVsContextInitialize(v9 + 640, v9 + 256, &v22, *(_DWORD *)a4 & 1, v18, (_DWORD *)&qword_180171508 + 1);
