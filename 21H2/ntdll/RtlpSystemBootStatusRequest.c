/*
 * XREFs of RtlpSystemBootStatusRequest @ 0x180085DE4
 * Callers:
 *     RtlSetSystemBootStatus @ 0x180085DB0 (RtlSetSystemBootStatus.c)
 *     RtlGetSystemBootStatus @ 0x18008BF10 (RtlGetSystemBootStatus.c)
 *     RtlGetSystemBootStatusEx @ 0x1800EE130 (RtlGetSystemBootStatusEx.c)
 *     RtlSetSystemBootStatusEx @ 0x1800EE2E0 (RtlSetSystemBootStatusEx.c)
 * Callees:
