/*
 * XREFs of RtlAddSIDToBoundaryDescriptorEx @ 0x180080060
 * Callers:
 *     RtlAddSIDToBoundaryDescriptor @ 0x180080050 (RtlAddSIDToBoundaryDescriptor.c)
 *     RtlAddIntegrityLabelToBoundaryDescriptor @ 0x1800EB200 (RtlAddIntegrityLabelToBoundaryDescriptor.c)
 * Callees:
 *     RtlFreeHeap @ 0x180024760 (RtlFreeHeap.c)
 *     RtlAllocateHeap @ 0x18002A9A0 (RtlAllocateHeap.c)
 *     RtlValidSid @ 0x180037950 (RtlValidSid.c)
 *     RtlEnumerateBoundaryDescriptorEntries @ 0x18007ECB0 (RtlEnumerateBoundaryDescriptorEntries.c)
