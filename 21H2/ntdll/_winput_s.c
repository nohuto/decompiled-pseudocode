/*
 * XREFs of _winput_s @ 0x18009AF8C
 * Callers:
...
__int64 __fastcall winput_s(FILE *Stream, wint_t *a2, __int64 a3)
{
  unsigned int v3; // ebx
...
LABEL_128:
      ...
      if ( v29 == 123 )
      {
        v37 = ReadStringDelimited_1(v36, &v75, (wint_t *)&v58, &v60, (void **)v73, v12, Stream, Src, v71);
        v4 = v75;
      }
      else
      {
        v37 = ReadString_1(v36, 0LL, (wint_t *)&v58, &v60, (void **)v73, v12, Stream, Src, v71);
      }
      v9 = v71[0];
      LOWORD(v5) = v58;
      v63 = v71[0];
...
LABEL_194:
  ...
  {
    v8 = ++v60;
    v30 = fgetwc_nolock(Stream);
  }
  else
  {
    v30 = whiteout(&v60, Stream);
    v8 = v60;
  }
  v5 = v30;
  LOWORD(v58) = v30;
