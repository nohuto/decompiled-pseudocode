/*
 * XREFs of RtlpInitializeUserList @ 0x18003F0BC
 * Callers:
 ...
 *     InitializeUserOrMachineLangList @ 0x180076944 (InitializeUserOrMachineLangList.c)
...
__int64 __fastcall RtlpInitializeUserList(__int64 a1)
{
  ...
  if ( !NtCurrentTeb()->UserPrefLanguages || !*(_QWORD *)NtCurrentTeb()->UserPrefLanguages )
  {
    ...
    {
      v4 = 1;
      updated = InitializeUserOrMachineLangList(a1, 1, (unsigned int)&v28, 3, 0);
      if ( updated >= 0 )
      {
        v5 = NtCurrentTeb();
        ...
        if ( !MuiImpersonation )
          updated = RtlpLoadLanguageConfigList(8LL, &v29, a1);
        if ( updated >= 0 )
        {
          v12 = v28;
          *(_DWORD *)(v28 + 40) |= 0x10u;
