/*
 * XREFs of RtlpFcUpdateUsageSubscriptions @ 0x180101ED8
 * Callers:
 *     RtlSubscribeForFeatureUsageNotification @ 0x180101DD0 (RtlSubscribeForFeatureUsageNotification.c)
 *     RtlUnsubscribeFromFeatureUsageNotifications @ 0x180101DE0 (RtlUnsubscribeFromFeatureUsageNotifications.c)
 * Callees:
