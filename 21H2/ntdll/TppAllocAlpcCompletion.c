/*
 * XREFs of TppAllocAlpcCompletion @ 0x18007A804
 * Callers:
 *     TpAllocAlpcCompletion @ 0x18007A6E0 (TpAllocAlpcCompletion.c)
 *     TpAllocAlpcCompletionEx @ 0x18007A7E0 (TpAllocAlpcCompletionEx.c)
 * Callees:
