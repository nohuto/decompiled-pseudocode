/*
 * XREFs of RtlValidRelativeSecurityDescriptor @ 0x180074C40
 * Callers:
 *     <none>
 * Callees:
 *     RtlValidAcl @ 0x180037760 (RtlValidAcl.c)
 *     RtlpValidateSDOffsetAndSize @ 0x180074DB0 (RtlpValidateSDOffsetAndSize.c)
 */
        ...
        SECURITY_INFORMATION RequiredInformation)
{
    ...
    && RtlValidAcl(v13) )
  {
    ...
    if ( !(_DWORD)v14 )
      return 1;
    if ( (unsigned __int8)RtlpValidateSDOffsetAndSize(v14, SecurityDescriptorLength, 8LL, &v18) )
    {
