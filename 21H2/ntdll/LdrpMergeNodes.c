/*
 * XREFs of LdrpMergeNodes @ 0x18006F638
 * Callers:
      ...
      else
      {
        ...
        if ( v21 )
        {
          ...
          *v26 = (_QWORD *)*v27;
          ...
          --*(_DWORD *)(v20 + 24);
          result = (_QWORD *)RtlFreeHeap(LdrpHeap, 0, (__int64)v19);
        }
        else
        {
          *v19 = v19;
  ...
  for ( k = *v23; ; k = *v24 )
  {
    if ( k[1] == a1 )
    {
      *v24 = (_QWORD *)*k;
      ...
      --*(_DWORD *)(a1 + 24);
      result = (_QWORD *)RtlFreeHeap(LdrpHeap, 0, (__int64)(k - 2));
    }
    else
    {
      v24 = (_QWORD **)k;
...
LABEL_57:
        --*(_DWORD *)(a1 + 24);
        result = (_QWORD *)RtlFreeHeap(LdrpHeap, 0, (__int64)v33);
      }
      else
      {
        *v32 = v32;
