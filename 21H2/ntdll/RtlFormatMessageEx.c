/*
 * XREFs of RtlFormatMessageEx @ 0x180067230
 * Callers:
 *     RtlFormatMessage @ 0x1800FC650 (RtlFormatMessage.c)
 * Callees:
 *     RtlStringCopyWorkerW_0 @ 0x1800671AC (RtlStringCopyWorkerW_0.c)
        ...
        __int64 a10)
{
  ...
  _WORD *v81; // [rsp+70h] [rbp-98h]
  __int64 *v82; // [rsp+80h] [rbp-88h]
  __int64 v83; // [rsp+88h] [rbp-80h] BYREF
  __int16 *v84; // [rsp+90h] [rbp-78h]
  unsigned int v85; // [rsp+98h] [rbp-70h]
  __int64 v86; // [rsp+A0h] [rbp-68h] BYREF
  _WORD *v87; // [rsp+A8h] [rbp-60h]
  __int16 *v88; // [rsp+B0h] [rbp-58h]
  _DWORD *v89; // [rsp+B8h] [rbp-50h]
...
LABEL_63:
      ...
      v23 = v21 - 48;
      v24 = *v17;
      if ( (unsigned __int16)*v17 >= 0x30u && (unsigned __int16)v24 <= 0x39u )
      {
...
LABEL_138:
        ...
        if ( *(_WORD *)v56 != 115 || (v62 = *(v30 - 2) - 104, v62 <= 0xFu) && _bittest(&v58, v62) )
        {
          if ( *(_WORD *)v56 == 83 )
          {
            *(_WORD *)v56 = 115;
          }
          else if ( *(_WORD *)v56 == 67 )
          {
            *(_WORD *)v56 = 99;
          }
          goto LABEL_37;
...
LABEL_87:
    ...
    {
      *(_DWORD *)(a10 + 4) = v80;
      *(_QWORD *)(a10 + 8) = v84 - v88;
      *(_QWORD *)(a10 + 16) = (__int64)((__int64)v15 - a7) >> 1;
      if ( v16 )
        v48 = (__int64)((__int64)v16 - a7) >> 1;
      else
        v48 = -1LL;
      *(_DWORD *)a10 |= 1u;
      *(_QWORD *)(a10 + 24) = v48;
  ...
  *v15 = 0;
  result = 0LL;
  if ( v89 )
    *v89 = 2 * ((__int64)((__int64)v15 - v13 + 2) >> 1);
  return result;
}
