/*
 * XREFs of RtlpLogCapabilityCheckLatency @ 0x180042364
 * Callers:
        ...
        if ( *a1 )
        {
          if ( *a2 )
          {
            if ( RtlpPerformanceCounterFrequency )
            {
              ...
              if ( !(_WORD)v6 )
              {
                if ( (unsigned int)dword_180166660 > 5
                  && (unsigned __int8)tlgKeywordOn(&dword_180166660, 0x200000000000LL) )
                {
                  v14 = *a2 - *a1;
                  v24 = 0;
                  v27 = 0;
                  ...
                  v32 = 1;
                  v35 = 1;
                  tlgWriteTransfer_EtwEventWriteTransfer(v11, (unsigned int)&unk_180131F43, v12, v13, 7, (__int64)v21);
                }
