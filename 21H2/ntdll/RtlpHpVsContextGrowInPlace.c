/*
 * XREFs of RtlpHpVsContextGrowInPlace @ 0x180071F18
 * Callers:
 ...
 *     RtlpHpVsCalculateChunkRequiredSize @ 0x1800721BC (RtlpHpVsCalculateChunkRequiredSize.c)
 *     RtlpHpVsChunkSetUnusedBytes @ 0x1800721DC (RtlpHpVsChunkSetUnusedBytes.c)
