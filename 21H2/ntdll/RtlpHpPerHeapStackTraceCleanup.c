/*
 * XREFs of RtlpHpPerHeapStackTraceCleanup @ 0x180108570
 * Callers:
 *     RtlpHpStackTraceHeapDestroy @ 0x180009638 (RtlpHpStackTraceHeapDestroy.c)
 *     RtlpHpStackTraceHeapDisable @ 0x1801092F0 (RtlpHpStackTraceHeapDisable.c)
 * Callees:
...
LABEL_13:
      ...
      v11 = 0LL;
LABEL_21:
      RtlStackDbStackRemove(&qword_18016D580, *(_QWORD *)(v11 + 16));
      v16 = RtlpHpEnvHandle;
