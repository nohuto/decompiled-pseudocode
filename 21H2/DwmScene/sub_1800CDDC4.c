/*
 * XREFs of sub_1800CDDC4 @ 0x1800CDDC4
 * Callers:
 *     sub_1800CF070 @ 0x1800CF070 (sub_1800CF070.c)
 * Callees:
...
_OWORD *__fastcall sub_1800CDDC4(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
