/*
 * XREFs of sub_180035708 @ 0x180035708
 * Callers:
...
__int64 **__fastcall sub_180035708(__int64 a1, __int64 **a2, __int64 a3, char a4, int a5)
{
  int v8; // eax
  __int64 v9; // r14
  ...
  if ( (a4 & 1) != 0 )
  {
    ...
    v15 = sub_180067F58(a1, v20);
    if ( *(_QWORD *)(v15 + 24) >= 0x10uLL )
      v15 = *(_QWORD *)v15;
    sub_180010534(v23, (const char *)v15);
    if ( v21 >= 0x10 )
    {
      v16 = v20[0];
      if ( v21 + 1 >= 0x1000 )
