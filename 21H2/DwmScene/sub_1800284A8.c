/*
 * XREFs of sub_1800284A8 @ 0x1800284A8
 * Callers:
 *     sub_18002C330 @ 0x18002C330 (sub_18002C330.c)
 * Callees:
...
_QWORD *__fastcall sub_1800284A8(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180027144((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
