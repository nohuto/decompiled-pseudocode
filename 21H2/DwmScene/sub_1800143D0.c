/*
 * XREFs of sub_1800143D0 @ 0x1800143D0
 * Callers:
 *     sub_180015490 @ 0x180015490 (sub_180015490.c)
 * Callees:
...
__int64 __fastcall sub_1800143D0(__int64 a1)
{
  __int64 v1; // rax
  ...
  *((_QWORD *)&v13 + 1) = v2;
  ...
  v12 = 0LL;
  sub_180013CC8(v13, &v12);
  v6 = qword_18021F908;
  v7 = *(volatile signed __int32 **)(qword_18021F908 + 104);
  if ( v7 )
  {
  ...
  result = (__int64)sub_180013A88(v13, &v15);
  if ( v16 )
  {
