...
__int64 __fastcall sub_180015C60(__int64 a1, __int64 a2)
{
  __int64 v3; // r14
  _QWORD *v4; // rsi
  __int64 v5; // r8
  ...
  *((_QWORD *)&v32 + 1) = v14;
  ...
  if ( (_QWORD)v49 != (_QWORD)v32 )
  {
    ...
    {
      sub_18007ABF8(*(_QWORD *)(v3 + 56), &v43);
      ...
      v50 = 0LL;
      v18 = v34;
      sub_180066E84(v34 + 16, &v50);
      v45[2] = 0LL;
      v45[3] = 0LL;
      sub_18001277C(v45, (__int64)&unk_18020F708);
      v19 = (__int64 *)sub_18008D2D0(v18, v46, v45);
    ...
    if ( (_QWORD)v48 == (_QWORD)v34 )
    {
      ...
      *(_QWORD *)&v40 = *v4;
      *((_QWORD *)&v40 + 1) = v26;
      sub_18008E4D4(v48, &v40, &v42);
    }
    else
    {
      v52 = 0LL;
      sub_180066E84(v34 + 16, &v52);
      v51 = 0LL;
      v41 = 0LL;
      if ( *((_QWORD *)&v32 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v32 + 1) + 8LL));
      v41 = v32;
      sub_180084808(*v4, &v51, 131075LL, &v41);
      v39 = 0LL;
      v24 = v4[1];
      if ( v24 )
      {
