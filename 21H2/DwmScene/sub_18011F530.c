/*
 * XREFs of sub_18011F530 @ 0x18011F530
 * Callers:
 ...
 *     sub_18011FB60 @ 0x18011FB60 (sub_18011FB60.c)
 *     __security_check_cookie @ 0x180123FC0 (__security_check_cookie.c)
 */

unsigned __int64 __fastcall sub_18011F530(_LocaleUpdate *a1, char *a2, char *a3, char *a4)
{
  ...
  if ( v8 == 1 && a2 == *((char **)a1 + 1) || (v46 = 0, v8) )
  {
    ...
    if ( v8 <= v12 )
    {
      try
      {
        ...
        if ( v8 >= result )
        {
          ...
          *((_QWORD *)a1 + 1) = v36;
          ...
          if ( a2 != v11 )
          {
            do
            {
              result = unknown_libname_103(v39);
              v39 += 4;
            }
        ...
        else
        {
          ...
          *((_QWORD *)a1 + 1) = v31;
          result = sub_18011FB60(a2, &v11[-v30], v11);
          v33 = (__int64 *)a2;
          if ( a2 != &a2[v47] )
          {
            do
            {
              result = unknown_libname_103(v33);
              v33 += 4;
            }
      ...
      {
        sub_1800B3A5C((__int64)a1, &a2[32 * v8], &a2[64 * v8], a2);
        LocaleT = (__int64 *)_LocaleUpdate::GetLocaleT(a1);
        sub_1800AC54C((__int64)&a2[64 * v8], *LocaleT, (__int64)&a2[32 * v8]);
        sub_1800713A4((__int64)a1, v45, (__int64 *)*LocaleT);
        *LocaleT = (__int64)v45;
        throw;
      }
    }
    else
    {
      ...
      return sub_1800B379C((__int64)a1, (__int64)v18, v48, v17);
    }
  }
  return result;
}
