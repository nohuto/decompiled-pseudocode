/*
 * XREFs of sub_1800FF63C @ 0x1800FF63C
 * Callers:
...
__int64 __fastcall sub_1800FF63C(__int64 a1)
{
  __int128 v1; // rcx
  __int64 v2; // rdi
  __int64 v3; // rax
  ...
  *(_QWORD *)&v1 = a1;
  ...
  if ( *(_DWORD *)(v1 + 1960) )
  {
    ...
    *((_QWORD *)&v24 + 1) = v1;
    sub_1800B1E40(v2, (__int64 *)&v24);
    v26 = 0LL;
    sub_1800B1C18(v2, (__int64 *)&v26);
    sub_1800B1EF0(v2, *(_DWORD *)(v2 + 1928), 0);
    sub_1800B1EF0(v2, *(_DWORD *)(v2 + 1932), 1);
    sub_1800B1EF0(v2, *(_DWORD *)(v2 + 1936), 1);
    *(_BYTE *)(v2 + 465) |= 1u;
    v17 = *(_DWORD *)(v2 + 404);
    v18 = *(_DWORD *)(v2 + 408);
    v19[0] = *(_DWORD *)(v2 + 400);
    ...
    v27[2] = 0LL;
    v27[3] = 0LL;
    sub_180020B7C(v27, (__int64)&qword_180213038);
    result = sub_1800B1FB0(v2, v27, v19, -1);
    if ( *((_QWORD *)&v1 + 1) )
    {
  ...
  else
  {
    ...
    *((_QWORD *)&v23 + 1) = v9;
    sub_1800B1C18(v2, (__int64 *)&v23);
    sub_1800B1EF0(v2, *(_DWORD *)(v2 + 1928), 1);
    sub_1800B1EF0(v2, *(_DWORD *)(v2 + 1932), 0);
    result = sub_1800B1EF0(v2, *(_DWORD *)(v2 + 1936), 0);
    *(_BYTE *)(v2 + 465) &= ~1u;
  }
  return result;
}
