/*
 * XREFs of sub_1800149C0 @ 0x1800149C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800149C0(_QWORD *a1, _QWORD *a2)
{
  __int64 v4; // rax
  ...
  try
  {
    ...
    if ( v4 )
    {
      ...
      *((_QWORD *)&v18 + 1) = v5;
      ...
      v20 = *(__int64 **)(v18 + 384);
      v21 = *(__int64 **)(v18 + 376);
      sub_180013FD0(&v16, v21, v20, 0);
      if ( v16 != *(__int64 **)(v9 + 384) )
        sub_180013F6C((__int64 *)&v17, v16);
      if ( a2 )
        v10 = a2 + 2;
      else
        v10 = (_QWORD *)(qword_18021F908 + 96);
  ...
  {
    sub_18000DD78(retaddr, 64, (__int64)"SpectreMeshComponent.cpp", 0x80004005);
    return 2147500037LL;
  }
  return result;
}
