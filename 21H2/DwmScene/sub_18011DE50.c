...
__int64 __fastcall sub_18011DE50(__int64 a1, _QWORD *a2, double *a3)
{
...
LABEL_27:
  ...
  if ( (unsigned __int8)sub_1801225A8(v9 + 64, v10) )
  {
    ...
    if ( (unsigned __int8)sub_180122630(v13) )
    {
      ...
      if ( (unsigned __int8)sub_1801225A8(v13, v14)
        && (v20[2] = 0LL,
            ...
            (unsigned __int8)sub_180122620(v15)) )
      {
        *a3 = sub_1801224AC(v15);
        v11 = 0;
      }
      else
      {
    ...
    else if ( (unsigned __int8)sub_180122620(v13) )
    {
      *a3 = *(double *)(v13 + 48);
      v11 = 0;
    }
