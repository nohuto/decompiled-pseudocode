/*
 * XREFs of sub_1800CB014 @ 0x1800CB014
 * Callers:
 ...
 *     sub_180101068 @ 0x180101068 (sub_180101068.c)
 *     sub_180101074 @ 0x180101074 (sub_180101074.c)
 *     sub_18010107C @ 0x18010107C (sub_18010107C.c)
 *     sub_1801010A0 @ 0x1801010A0 (sub_1801010A0.c)
 *     sub_1801010A8 @ 0x1801010A8 (sub_1801010A8.c)
 *     sub_1801010EC @ 0x1801010EC (sub_1801010EC.c)
 *     _guard_dispatch_icall_nop @ 0x180125480 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=2
_UNKNOWN **__fastcall sub_1800CB014(__int64 a1, __int64 *a2)
{
  __int64 v3; // r14
  int v4; // xmm7_4
  int v5; // xmm8_4
  ...
  v3 = sub_18007AB84(a1, *(_DWORD *)(*a2 + 112));
  v4 = 0;
  v5 = 0;
  v6 = 0;
  if ( (*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v3 + 64LL))(v3, &unk_180211088, 0LL) )
  {
    v7 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v3 + 88LL))(v3, &unk_180211028);
    v4 = LODWORD(v7);
    v8 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v3 + 88LL))(v3, &unk_180211048);
    v5 = LODWORD(v8);
    v9 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v3 + 88LL))(v3, &unk_180211068);
    v6 = LODWORD(v9);
  }
  v39 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v3 + 72LL))(v3, &unk_180210FE8, 0LL);
  v11 = &off_1802137B0;
  v12 = sub_1800BB82C(*a2, v10) + 16;
  do
  {
    ...
    if ( v14 )
    {
      ...
      v28 = LODWORD(v27);
      *(float *)&v27 = o_roundf();
      sub_18010107C(v15, (unsigned int)(int)*(float *)&v27);
      sub_1801010EC(v15, v39);
      *(_BYTE *)(v15 + 72) = v18;
    ...
    v12 += 16LL;
    v11 += 13;
    result = &off_1802138E8;
  }
  while ( (__int64)v11 < (__int64)&off_1802138E8 );
  return result;
}
