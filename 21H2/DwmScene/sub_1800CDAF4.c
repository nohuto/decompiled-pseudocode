/*
 * XREFs of sub_1800CDAF4 @ 0x1800CDAF4
 * Callers:
 *     sub_1800CF010 @ 0x1800CF010 (sub_1800CF010.c)
 * Callees:
...
_OWORD *__fastcall sub_1800CDAF4(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
