/*
 * XREFs of sub_1800B51BC @ 0x1800B51BC
 * Callers:
 ...
 *     sub_180066FEC @ 0x180066FEC (sub_180066FEC.c)
 ...
 *     sub_18009F234 @ 0x18009F234 (sub_18009F234.c)
...
signed __int32 __fastcall sub_1800B51BC(__int64 a1)
{
  int v2; // ecx
  __int64 v3; // rax
  bool v4; // dl
  ...
  *(_BYTE *)(a1 + 424) = 1;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)(a1 + 440) = 1000000000 * (perf_counter % perf_frequency) / perf_frequency
    ...
    v59 = 0LL;
    v7 = sub_18007B1D8(*(_QWORD *)(a1 + 24));
    sub_180066FEC(v7, (__int64)&v59);
    v42 = 0;
    v54 = 0uLL;
    if ( (_QWORD)v56 )
    {
      v8 = sub_180066E84(v56 + 16, (__int64)&v44);
      if ( &v54 != (__int128 *)v8 )
      {
        if ( BYTE8(v54) )
          sub_180067304(v54);
    ...
    if ( v10 )
      v12 = v10;
    v13 = sub_18007AB84(*(_QWORD *)(a1 + 24), v12);
...
LABEL_26:
      if ( v17 && (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v17 + 352LL))(v17) )
      {
        ...
        {
          v58 = 0LL;
          sub_180066E3C(v55 + 24, (__int64)&v58);
          v57 = 0LL;
          sub_180066E3C(v53 + 8, (__int64)&v57);
          v23 = sub_18007AB84(*(_QWORD *)(a1 + 24), v11);
          v24 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v23 + 72LL))(v23, &unk_18020FC08, 0LL);
          (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)v53 + 304LL))(v53, v24);
          (*(void (__fastcall **)(_QWORD))(*(_QWORD *)v53 + 72LL))(v53);
          v25 = v53;
          v26 = sub_18007ABC4(*(_QWORD *)(a1 + 24), &v50);
...
LABEL_57:
            ...
            {
              v33 = sub_1800AFAB0(*i, &v46);
              if ( sub_18009F234(v33, (unsigned __int64 *)v31 + 6)
                || (v34 = sub_1800AFAA0(*i, &v47), sub_18009F234(v34, (unsigned __int64 *)v31 + 7))
                || (unsigned int)sub_1800AFAC0(*i) != *((_DWORD *)v31 + 16) )
              {
                sub_1800B2100(*i, v31[6], v31[7], *((_DWORD *)v31 + 16));
              }
            }
          }
          (*(void (__fastcall **)(_QWORD, __int128 *))(**(_QWORD **)(a1 + 24) + 48LL))(*(_QWORD *)(a1 + 24), &v53);
          (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)v53 + 240LL))(v53, v11);
          sub_18007D560(*(_QWORD **)(a1 + 24), (__int64)&v56, a1 + 40, &v53);
          sub_18007C7D8(*(_QWORD **)(a1 + 24), &v55, &v53, (__int64)&v57, (__int64)&v58, (__int64)&v54);
          (*(void (__fastcall **)(_QWORD, __int128 *))(**(_QWORD **)(a1 + 24) + 56LL))(*(_QWORD *)(a1 + 24), &v53);
          (*(void (__fastcall **)(_QWORD))(*(_QWORD *)v53 + 248LL))(v53);
          v35 = sub_1800B3CEC(&v52, v14);
          sub_18007F580(*(_QWORD *)(a1 + 24), v35);
          if ( BYTE8(v57) )
            sub_180067304(v57);
          if ( BYTE8(v58) )
            sub_180067304(v58);
    ...
    sub_1800B5B54(a1, 1000000000 * (v39 % v38) / v38 + 1000000000 * (v39 / v38) - *(_QWORD *)(a1 + 440));
    if ( BYTE8(v54) )
      sub_180067304(v54);
    if ( BYTE8(v59) )
      sub_18006730C(v59);
