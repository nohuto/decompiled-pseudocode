/*
 * XREFs of sub_180042BE0 @ 0x180042BE0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180042BE0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
  ...
  {
    sub_18000FE28(v28);
    v24 = sub_18000FE28(v27);
    sub_18002D8C4(pExceptionObject, v24, 36, (__int64)v28, 0);
...
LABEL_6:
    ...
    v12 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD, __int64))(*(_QWORD *)v6 + 120LL))(
            ...
            0LL,
            a1 + 104);
    sub_18002BE74(v30, v12);
    if ( v12 >= 0 )
    {
      *(_BYTE *)(a1 + 96) = 1;
      v13 = sub_180067F58(a1, v25);
      v14 = (const char *)v13;
