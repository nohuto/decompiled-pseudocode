/*
 * XREFs of sub_1800B7F7C @ 0x1800B7F7C
 * Callers:
...
__m128 *__fastcall sub_1800B7F7C(__m128 *a1, __m128 *a2)
{
  __m128 *v4; // r14
  __m128 *v5; // rsi
  __m128 v6; // xmm6
  ...
  v5 = a2 + 4;
  v6 = _mm_mul_ps((__m128)xmmword_1801D84A0, *v4);
  if ( a2 == (__m128 *)-64LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v7 = a2 + 3;
  v8 = _mm_mul_ps((__m128)xmmword_1801D84B0, *v5);
  if ( a2 == (__m128 *)-48LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v9 = _mm_add_ps(v6, _mm_add_ps(v8, _mm_mul_ps((__m128)xmmword_1801D84B0, *v7)));
  ...
  if ( a2 == (__m128 *)-16LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v10 = _mm_mul_ps((__m128)xmmword_1801D84D0, a2[1]);
  ...
  if ( a2 == (__m128 *)-32LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v11 = _mm_mul_ps((__m128)xmmword_1801D84D0, a2[2]);
  ...
  if ( !a2 )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v12 = _mm_mul_ps((__m128)xmmword_1801D84D0, *a2);
  ...
  if ( a2 == (__m128 *)-128LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v13 = _mm_mul_ps(a2[8], (__m128)xmmword_1801D84E0);
  ...
  if ( a2 == (__m128 *)-96LL )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v14 = _mm_mul_ps((__m128)xmmword_1801D84E0, a2[6]);
  ...
  v15 = _mm_sub_ps(
          _mm_sub_ps(_mm_mul_ps((__m128)xmmword_1801D84F0, *v4), _mm_mul_ps(*v7, (__m128)xmmword_1801D84C0)),
          _mm_mul_ps((__m128)xmmword_1801D84C0, *v5));
  ...
  if ( !v16 )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v17 = _mm_mul_ps((__m128)xmmword_1801D84E0, *v16);
  ...
  if ( !v5 )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v18 = _mm_mul_ps((__m128)xmmword_1801D84E0, *v5);
  if ( !v7 )
    wassert(L"pSource", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXMathConvert.inl", 0x2A5u);
  v19 = _mm_sub_ps(_mm_mul_ps((__m128)xmmword_1801D84E0, *v7), v18);
  ...
  sub_1800B7DE8(a1, COERCE_DOUBLE(1078530011LL));
  return a1;
}
