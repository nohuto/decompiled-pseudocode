/*
 * XREFs of sub_18002EC90 @ 0x18002EC90
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_18002EC90(_QWORD *a1, _QWORD *a2)
{
  ...
  sub_18002EA60((__int64)a1, (__int64 *)&v20);
  v5 = a1 + 213;
  v6 = a1[213];
  if ( v6 )
  {
  ...
  v7 = (**(__int64 (__fastcall ***)(_QWORD, void *, __int64))*a2)(*a2, &unk_180143020, (__int64)(a1 + 213));
  v8 = v7;
  if ( v7 < 0 )
  {
