/*
 * XREFs of sub_180092894 @ 0x180092894
 * Callers:
...
char __fastcall sub_180092894(_QWORD *a1, int a2, int a3, int a4)
{
  ...
  v17 = a1[17];
  v18 = v8;
  v9 = (_QWORD *)sub_1800AA734(v17, v19);
  v10 = (_QWORD *)sub_1800A5C5C(*v9);
  v11 = v20;
  if ( v20 )
  {
  ...
  v21[1] = a4;
  v12 = a1[21];
  if ( !v12 || (result = sub_1800917D0(*(_QWORD *)(v12 + 112), (__int64)v21)) == 0 )
  {
    sub_180024740(v10, &v15, 1u);
    ...
    return sub_1800CC9E0(a1[21], v21, 0LL);
  }
  return result;
}
