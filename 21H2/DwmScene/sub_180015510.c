/*
 * XREFs of sub_180015510 @ 0x180015510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180015510(__int64 a1, __int64 *a2)
{
  __int64 v4; // r8
  __int64 v5; // rdx
  ...
  *((_QWORD *)&v15 + 1) = v7;
  ((void (__fastcall *)(_QWORD, __int128 *, __int64, __int128 *))sub_18008B8BC)(v17, &v18, -1LL, &v15);
  v16 = 0LL;
  v8 = sub_180015330(&v16, &v18);
  v9 = v8;
  if ( v8 >= 0 )
  {
    v11 = v16;
  ...
  {
    sub_18000DD78(retaddr, 82, (__int64)"SpectreNode.cpp", v8);
    v10 = v16;
  }
  if ( v10 )
  {
