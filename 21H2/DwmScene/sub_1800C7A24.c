/*
 * XREFs of sub_1800C7A24 @ 0x1800C7A24
 * Callers:
...
void *__fastcall sub_1800C7A24(__int64 a1, __int64 *a2)
{
  __int64 v3; // rdx
  _UNKNOWN **v4; // r15
  ...
  v63 = a1;
  v48 = sub_18007AB84(a1, *(_DWORD *)(*a2 + 112));
  v4 = &off_1802138F0;
  v52 = &off_1802138F0;
  v5 = (volatile signed __int32 **)(sub_1800BB82C(*a2, v3) + 64);
  do
  {
    v6 = *(v5 - 6);
    if ( v6 )
    ...
    if ( v7 && v10 )
    {
      ...
      *(_DWORD *)(v8 + 104) = v31;
      sub_180091044(v8, v56);
      sub_180091054(v8, v57);
      *(_DWORD *)(v8 + 116) = v58;
      *(float *)(v8 + 112) = v59;
      sub_180091050(v8, v51);
      v60 = 0LL;
      v54 = 0LL;
      v40 = *(_QWORD *)(v8 + 64);
      if ( v40 )
...
LABEL_27:
      ...
      v65 = *(__int64 **)(v41 + 384);
      v66 = *(__int64 **)(v41 + 376);
      sub_18006F0B8(&v61, v66, v65, 0);
      if ( v61 == *(__int64 **)(v41 + 384) )
        v60 = 0LL;
      else
        sub_18006EF68((__int64 *)&v60, v61);
      if ( *((_QWORD *)&v41 + 1) )
      {
    ...
    v4 += 18;
    v52 = v4;
    result = &unk_180213AA0;
  }
  while ( (__int64)v4 < (__int64)&unk_180213AA0 );
  return result;
}
