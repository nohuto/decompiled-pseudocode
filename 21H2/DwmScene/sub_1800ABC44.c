/*
 * XREFs of sub_1800ABC44 @ 0x1800ABC44
 * Callers:
...
unsigned __int64 __fastcall sub_1800ABC44(__int64 *a1, _QWORD *a2, __int64 a3)
{
  __int64 v5; // r12
  __int64 v6; // rax
  ...
  v11 = sub_180037240((__int64)a1, v10);
  v12 = v11;
  v26 = (__int64)v11;
  ...
  try
  {
    sub_18001277C((__int64 *)((char *)v11 + v13), a3);
    v22 = v14;
    v15 = (_QWORD *)a1[1];
    v16 = *a1;
    if ( a2 == v15 )
    ...
    sub_1800B379C(a1, v12, v7, v10);
    result = v13 + *a1;
  }
  catch ( ... )
  {
    sub_1800713A4((__int64)a1, v22, v25);
    sub_1800372B0((__int64)a1, v26, v10);
    throw;
  }
  return result;
}
