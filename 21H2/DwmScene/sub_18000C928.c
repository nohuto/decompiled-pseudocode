/*
 * XREFs of sub_18000C928 @ 0x18000C928
 * Callers:
...
__int64 (__fastcall *__fastcall sub_18000C928(unsigned __int64 a1, _BYTE *a2, __int64 a3))(_QWORD, _QWORD)
{
  char v3; // bp
  __int64 v4; // rbx
...
LABEL_7:
  ...
  {
    *a2 = 0;
    if ( (unsigned __int8)sub_18000CF94(v7, *v10, a2, a3) )
      *(_QWORD *)(v7 + 64) = a2;
    v11 = *v10;
    do
    {
  ...
  result = qword_18021F4C0;
  if ( qword_18021F4C0 )
  {
    LOBYTE(a1) = v3;
    return (__int64 (__fastcall *)(_QWORD, _QWORD))qword_18021F4C0(a1, v7);
  }
  return result;
}
