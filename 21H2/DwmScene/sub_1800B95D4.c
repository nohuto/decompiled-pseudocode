/*
 * XREFs of sub_1800B95D4 @ 0x1800B95D4
 * Callers:
 *     sub_1800B8634 @ 0x1800B8634 (sub_1800B8634.c)
 * Callees:
 *     memcpy @ 0x180123964 (memcpy.c)
 *     ??2@YAPEAX_K@Z @ 0x180124038 (--2@YAPEAX_K@Z.c)
 *     ?_Xbad_alloc@std@@YAXXZ @ 0x180125438 (-_Xbad_alloc@std@@YAXXZ.c)
 */

_DWORD *__fastcall sub_1800B95D4(__int64 a1, const void *a2, unsigned __int64 a3, int a4)
{
  _DWORD *result; // rax
  int v5; // ebp
