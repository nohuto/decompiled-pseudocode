/*
 * XREFs of sub_1800BE558 @ 0x1800BE558
 * Callers:
...
__int64 __fastcall sub_1800BE558(__int64 a1, const void **a2)
{
...
LABEL_14:
  ...
  {
LABEL_16:
    v27 = _mm_load_si128((const __m128i *)&xmmword_180142440);
    LOWORD(v26[0]) = 0;
    v14 = v31;
...
LABEL_31:
  ...
  if ( v9 )
  {
    ...
    if ( !v23 )
    {
      sub_1800BC650((_QWORD *)(*(_QWORD *)a1 + 1488LL), (__int64)v26, a2);
      v24 = Mtx_unlock(v22);
      if ( !v24 )
        goto LABEL_37;
    ...
    JUMPOUT(0x1800BE7B0LL);
  }
LABEL_37:
  unknown_libname_103(v30);
  return unknown_libname_103(v33);
}
