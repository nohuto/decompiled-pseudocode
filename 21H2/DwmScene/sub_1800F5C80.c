...
__int64 __fastcall sub_1800F5C80(__int64 a1, unsigned __int16 a2, __int64 *a3)
{
  _DWORD *v6; // rax
  __int64 result; // rax
  ...
  if ( !sub_1800F2CE4(*(_QWORD *)(a1 + 16), a2) )
  {
    ...
    sub_18002D8C4(v25, v16, 457, v15, 0);
  ...
  if ( v6[9] != 8 )
  {
    ...
    sub_18002D8C4(v26, v17, 461, (__int64)v20, 0);
  ...
  if ( v6[12] == 2 )
  {
    ...
    sub_18002D8C4(pExceptionObject, v11, 466, (__int64)v22, 0);
