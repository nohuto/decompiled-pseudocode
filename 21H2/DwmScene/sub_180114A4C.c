/*
 * XREFs of sub_180114A4C @ 0x180114A4C
 * Callers:
...
__int64 __fastcall sub_180114A4C(int a1, unsigned int a2, __int64 a3, int a4, int a5, _QWORD *a6, __int64 a7)
{
  int v9; // r10d
  _QWORD *v10; // r8
  __int64 v11; // r11
  ...
  if ( a4 != (_DWORD)result )
  {
    do
    {
      ...
      {
        sub_18000FE28(v23);
        sub_180115420(pExceptionObject, v23);
      ...
      v19 = a5 == 1 && (v14 & 1) != 0;
      result = sub_180115788(v9, v16, v17, v18, v19, v11);
