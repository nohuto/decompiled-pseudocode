...
__int64 __fastcall sub_1800932B0(__int64 a1, __int64 *a2, __int64 a3, int a4)
{
  float **v7; // rbx
  ...
  *(_QWORD *)(a1 + 48) = 0LL;
  *(_QWORD *)(a1 + 56) = 0LL;
  sub_180092F20((_QWORD *)(a1 + 40), 1uLL, &v16);
  if ( (int)**v7 != a4 )
    goto LABEL_9;
  v8 = a2[3];
  if ( v8 >= 0x10 )
...
LABEL_9:
    ...
    sub_18002D8C4(pExceptionObject, v15, 436, (__int64)v19, 0);
