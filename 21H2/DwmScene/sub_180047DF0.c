/*
 * XREFs of sub_180047DF0 @ 0x180047DF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180047DF0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
...
LABEL_6:
    ...
    if ( v12 < 0 )
    {
      sub_18011BCAC(&unk_18020F198, 5LL, "ERROR: Failed to create Domain shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
