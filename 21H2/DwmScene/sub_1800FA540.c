/*
 * XREFs of sub_1800FA540 @ 0x1800FA540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800FA540(__int64 a1, __int64 a2)
{
  __int64 v4; // rax
  __int64 v5; // rbx
  __int64 *v6; // rax
  ...
  v23[3] = 15LL;
  LOBYTE(v23[0]) = 0;
  sub_18000FC14(v23, 0x1EuLL, 0LL, "Image Processing Bloom Sampler");
  sub_180068194(*v14, v23);
  v16 = (_QWORD *)*v14;
  v34 = 0;
  v38 = 0;
  v39 = 2139095039;
  ...
  sub_1800A1030(v16, &si128, 0LL);
  v17 = *(int *)(a1 + 144);
  v18 = sub_1800F99EC((__int64 *)a1, &v31);
  ...
  return (*(__int64 (__fastcall **)(_QWORD, __int64, __int64, _QWORD, int))(**(_QWORD **)(a1 + 184) + 40LL))(
           *(_QWORD *)(a1 + 184),
           a2,
           2LL,
           (unsigned int)dword_1801DBC60[v17],
           dword_1801DBC50[v17]);
}
