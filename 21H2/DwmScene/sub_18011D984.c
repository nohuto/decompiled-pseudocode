/*
 * XREFs of sub_18011D984 @ 0x18011D984
 * Callers:
 *     sub_180120D20 @ 0x180120D20 (sub_180120D20.c)
 * Callees:
...
__int64 __fastcall sub_18011D984(__int64 a1, _QWORD *a2, char a3, int a4)
{
...
LABEL_28:
  ...
  if ( (unsigned __int8)sub_1801225A8(v18[0] + 64, v12) )
  {
    ...
    else
    {
      ...
      if ( (unsigned __int8)sub_180122630(v13) )
      {
        ...
        if ( (unsigned __int8)sub_1801225A8(v13, v14)
          && (v19 = 0LL,
              ...
              v15 = sub_180122450(v13, v18),
              (unsigned __int8)sub_180122618(v15)) )
        {
          if ( (unsigned __int8)sub_18012244C(v15) != a3 )
          {
            v19 = 0LL;
            v20 = 0LL;
            sub_18001277C(v18, (__int64)v25);
            sub_18011D8C8(v13, v18, a3);
            v10 = 1;
          }
        }
        else
      ...
      {
        if ( (unsigned __int8)sub_18012244C(v13) != a3 )
        {
          v22 = 0LL;
          v23 = 0LL;
          sub_18001277C(v21, (__int64)a2);
          sub_18011D8C8(v11, v21, a3);
          v10 = 1;
        }
      }
      else
