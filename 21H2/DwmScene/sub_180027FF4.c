/*
 * XREFs of sub_180027FF4 @ 0x180027FF4
 * Callers:
 *     sub_18002C250 @ 0x18002C250 (sub_18002C250.c)
 * Callees:
...
_QWORD *__fastcall sub_180027FF4(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180026A30((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
