/*
 * XREFs of sub_1800DA55C @ 0x1800DA55C
 * Callers:
 *     sub_1800DA6C4 @ 0x1800DA6C4 (sub_1800DA6C4.c)
 * Callees:
 *     sub_180020F10 @ 0x180020F10 (sub_180020F10.c)
 *     ?_Xlen@?$vector@PEAXV?$allocator@PEAX@std@@@std@@IEBAXXZ_3 @ 0x1800D66F0 (-_Xlen@-$vector@PEAXV-$allocator@PEAX@std@@@std@@IEBAXXZ_3.c)
 *     memset @ 0x18012396A (memset.c)
 *     memmove @ 0x180123982 (memmove.c)
 *     j_j__o_free @ 0x180123E3C (j_j__o_free.c)
 */

void *__fastcall sub_1800DA55C(_QWORD *a1, unsigned __int64 a2)
{
  ...
  v7 = a1[3];
  v8 = sub_180020F10((__int64)v21, v5);
  v9 = 8 * v7;
  v10 = 8LL * a1[2] - 8 * v7;
