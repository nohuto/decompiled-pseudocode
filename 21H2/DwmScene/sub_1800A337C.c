/*
 * XREFs of sub_1800A337C @ 0x1800A337C
 * Callers:
...
__int64 __fastcall sub_1800A337C(_QWORD *a1, __int64 a2, char a3, size_t *a4, _QWORD *a5)
{
  _QWORD *v7; // rax
  __int64 *v8; // rdx
  __int64 *v9; // r13
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)*v8 )
      {
        *(_QWORD *)a2 = *sub_1800A23A4(a1, &v35, 1, v9, (int)a4, v7);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180027CD0(&v33);
    ...
    {
      *(_QWORD *)a2 = *sub_1800A23A4(v35, &v33, v11, v9, (int)a4, v34);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
