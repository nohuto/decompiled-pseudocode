/*
 * XREFs of sub_18006BF54 @ 0x18006BF54
 * Callers:
...
__int64 __fastcall sub_18006BF54(__int64 a1)
{
  int v2; // r13d
  _QWORD *v3; // rax
  __int64 v4; // r14
      ...
      while ( v7 != v6 )
      {
        ...
        if ( v8 )
        {
          if ( v8 == 1 )
          {
            ...
            v33 = 0;
            v10 = sub_180069758((__int64)&v37, v37, (__int64)(v7 + 4), &v33);
            sub_18006A434(&v37, (__int64)&v36, 0, (size_t *)v10 + 4, v10);
        ...
        else
        {
          ...
          if ( (unsigned __int64)v7[7] >= 0x10 )
            v12 = (const void *)v7[4];
          v13 = v7[6];
          if ( v13 == (_QWORD)xmmword_180213BE8 && !memcmp(v12, v11, v13) )
          {
            sub_180069620(
              *(__int64 ***)(a1 + 384),
              (__int64)"..\\Source\\Engine\\RenderOutput.cpp",
          ...
          {
            v14 = sub_180012B88(Src, (__int64)&qword_18020F600, (__int64)(v7 + 4));
            if ( v14[3] >= 0x10uLL )
              v14 = (_QWORD *)*v14;
            sub_180069620(
              *(__int64 ***)(a1 + 384),
...
LABEL_56:
      ...
      while ( v20 != v19 )
      {
        v21 = sub_180012B88(Src, (__int64)&qword_18020F600, (__int64)(v20 + 4));
        v22 = &qword_180213BB8;
        if ( *((_QWORD *)&xmmword_180213BC8 + 1) >= 0x10uLL )
          v22 = (__int64 *)qword_180213BB8;
        v23 = std::string::append(v21, v22, xmmword_180213BC8);
        v39 = 0uLL;
        v38 = *(_OWORD *)v23;
        v39 = *((_OWORD *)v23 + 1);
        v23[2] = 0LL;
  ...
  return sub_180069F50((__int64 *)&v37, (__int64)&v37);
}
