/*
 * XREFs of sub_18003C8E0 @ 0x18003C8E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18003C8E0(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  __int64 v8; // rax
  char v9; // di
  __int64 *v10; // rcx
  ...
  v8 = sub_1800D14C8(a1);
  v9 = 1;
  sub_1800D14B0(v8, 7LL, 4LL, 1LL);
  if ( *(_QWORD *)a2 )
  {
    sub_1800392B0((__int64 *)(*(_QWORD *)a2 + 112LL), &v18, *(_DWORD *)(a1 + 88));
    v10 = &v18;
    v11 = v18;
  }
  else
  ...
  *v10 = 0LL;
  ...
  result = sub_18003DD20(a1, v14, a3, a4);
  if ( v17 )
  {
