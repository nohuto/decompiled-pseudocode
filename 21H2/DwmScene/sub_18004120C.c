/*
 * XREFs of sub_18004120C @ 0x18004120C
 * Callers:
...
void __fastcall sub_18004120C(__int64 a1, const wchar_t *a2)
{
  unsigned int v4; // eax
  ...
  if ( a1 )
  {
    ...
    (*(void (__fastcall **)(__int64, void *, _QWORD, char *))(*(_QWORD *)a1 + 24LL))(a1, &unk_1801DCBC0, v4, String);
  }
}
