...
_QWORD *__fastcall sub_1800D90D8(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v5; // rax
  __int64 v6; // r13
  __int64 ***v7; // r12
  ...
  *(_QWORD *)(a1 + 208) = v5;
  v75[1] = 0LL;
  v7 = (__int64 ***)(a3 + 17);
  sub_1800A754C(a3 + 17, &v75[1], (size_t *)Buf2);
  ...
  if ( dword_1802216D8 > *(_DWORD *)(v10 + 44) )
  {
    Init_thread_header(&dword_1802216D8);
    if ( dword_1802216D8 == -1 )
    {
      v79 = 15LL;
      v78 = 5LL;
      strcpy((char *)&v77, "#main");
      sub_1800D8E30(&qword_1802216B0, (__int64 *)&v77);
      if ( v79 >= 0x10 )
      {
        v72 = v77;
        if ( v79 + 1 >= 0x1000 )
      ...
      atexit(sub_180136D30);
      Init_thread_footer(&dword_1802216D8);
    }
  }
  if ( dword_180221708 > *(_DWORD *)(v10 + 44) )
  {
    Init_thread_header(&dword_180221708);
    if ( dword_180221708 == -1 )
    {
      v79 = 15LL;
      v78 = 5LL;
      strcpy((char *)&v77, "#post");
      sub_1800D8E30(&qword_1802216E0, (__int64 *)&v77);
      if ( v79 >= 0x10 )
      {
        v73 = v77;
        if ( v79 + 1 >= 0x1000 )
      ...
      atexit(sub_180136DA0);
      Init_thread_footer(&dword_180221708);
    }
  }
  if ( dword_180221738 > *(_DWORD *)(v10 + 44) )
  {
    Init_thread_header(&dword_180221738);
    if ( dword_180221738 == -1 )
    {
      v79 = 15LL;
      v78 = 8LL;
      strcpy((char *)&v77, "#present");
      sub_1800D8E30(&qword_180221710, (__int64 *)&v77);
      if ( v79 >= 0x10 )
      {
        v74 = v77;
        if ( v79 + 1 >= 0x1000 )
...
LABEL_67:
      atexit(sub_180136E10);
      Init_thread_footer(&dword_180221738);
    }
  }
  v11 = (unsigned __int64 *)sub_1800DA1CC(v6, &qword_1802216B0);
  v12 = (unsigned __int64 *)sub_1800DA1CC(v6, &qword_1802216E0);
  v13 = (unsigned __int64 *)sub_1800DA1CC(v6, &qword_180221710);
  v14 = _mm_mul_ps(
          _mm_add_ps(
            _mm_cvtepi32_ps(_mm_xor_si128(_mm_load_si128((const __m128i *)&xmmword_18013FC40), (__m128i)xmmword_18013FC30)),
            (__m128)xmmword_18013FC50),
          (__m128)xmmword_18013FC60);
  *(__m128 *)&v75[1] = v14;
  ...
  *(_QWORD *)&v9 = 1090519040LL;
  ...
  if ( v65 != (__int64 *)*v7 )
  {
    ...
    do
    {
      if ( *((_DWORD *)v65 + 16) == 1 )
      {
        ...
        v81 = 15LL;
        LOBYTE(v80[0]) = 0;
        sub_180012F14(v80, v65 + 4);
        v82 = _mm_sub_pd(*(__m128d *)(v65 + 9), v8);
        v66 = *((_QWORD *)&v77 + 1);
        if ( v78 == *((_QWORD *)&v77 + 1) )
        {
          sub_1800D77DC(&v77, *((_QWORD **)&v77 + 1), (__int64)v80);
        }
        else
        {
          *(_QWORD *)(*((_QWORD *)&v77 + 1) + 16LL) = 0LL;
          *(_QWORD *)(v66 + 24) = 0LL;
          sub_180020B7C((_QWORD *)v66, (__int64)v80);
          *(__m128d *)(v66 + 32) = v82;
          *((_QWORD *)&v77 + 1) += 48LL;
        }
        if ( v81 >= 0x10 )
  ...
  sub_1800D99B0(v76, a2, a3[16], (unsigned int)&v77, 1082130432, 1090519040, (__int64)&v75[1]);
  sub_1800D27A4((__int64 **)&v77);
  return sub_1800D9008(v6);
}
