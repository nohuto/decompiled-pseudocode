/*
 * XREFs of sub_1800BB8BC @ 0x1800BB8BC
 * Callers:
...
_QWORD *__fastcall sub_1800BB8BC(__int64 a1, _QWORD *a2)
{
  __int64 *v3; // rcx
  ...
  v17 = 0;
  v19 = 0LL;
  v12 = &Spectre::Engine::ImageProcessingEffectBloom `RTTI Type Descriptor';
  v18 = 0LL;
  sub_1800DDA3C(a1, &v18, &v12);
  v3 = (__int64 *)v18;
