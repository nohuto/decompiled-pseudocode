/*
 * XREFs of sub_180048950 @ 0x180048950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180048950(__int64 a1, __int64 a2, int a3)
{
  __int64 v6; // rbx
  __int64 v7; // rdx
  __int64 v8; // rbx
...
LABEL_4:
  ...
  v20 = 0LL;
  sub_1800391CC(*(_QWORD **)(a1 + 120), &v20);
  v10 = *(_DWORD *)(a1 + 140);
  if ( !v10 )
  {
    v23 = 0LL;
