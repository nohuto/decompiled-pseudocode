...
_QWORD *__fastcall sub_180066C28(_QWORD *a1, __int64 *a2, int a3, __int64 a4, char a5)
{
  ...
  sub_1800D12B8((_DWORD)a1, (unsigned int)v16, a3, -2147024891, a4, a5);
