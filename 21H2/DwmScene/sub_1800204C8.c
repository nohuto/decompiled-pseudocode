/*
 * XREFs of sub_1800204C8 @ 0x1800204C8
 * Callers:
...
__m128 __fastcall sub_1800204C8(__m128 *a1, double a2, double a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm13
  __m128 v6; // xmm14
  ...
  v13 = _mm_sub_ps(
          ...
          _mm_mul_ps(_mm_shuffle_ps(v12, v12, 80), _mm_shuffle_ps(v11, v11, 238)));
  v14 = _mm_sub_ps(
  ...
  if ( a1 )
    *a1 = v23;
  return _mm_mul_ps(_mm_div_ps((__m128)xmmword_18013FB80, v23), v19);
}
