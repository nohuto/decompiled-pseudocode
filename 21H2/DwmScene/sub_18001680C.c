/*
 * XREFs of sub_18001680C @ 0x18001680C
 * Callers:
...
__int64 *__fastcall sub_18001680C(__int64 *a1, __int64 a2, _QWORD *a3, _QWORD *a4, _QWORD *a5)
{
  char v8; // r13
  __int64 *v9; // rax
  ...
  try
  {
    ...
    if ( v13 )
    {
      ...
      *(_QWORD *)&v38 = *a3;
      *((_QWORD *)&v38 + 1) = v17;
      v18 = sub_1800BD730(v14, *(_DWORD *)(a2 + 20), (unsigned int)&v38, (unsigned int)&v37, (__int64)&v36);
    }
    else
    {
      v18 = 0LL;
    ...
    v48 = v18;
    v19 = (void **)sub_18007AF2C(v18, v54);
    if ( &Src != v19 )
      sub_180020E1C(&Src, v19, 0LL);
    if ( v55 >= 0x10 )
    {
      v20 = v54[0];
      if ( v55 + 1 >= 0x1000 )
    ...
    *(_QWORD *)(v18 + 560) = *(_QWORD *)(a2 + 32);
    sub_180019D00(v18 + 568, a2 + 40);
    *(_OWORD *)(v18 + 664) = *(_OWORD *)(a2 + 136);
    *(_OWORD *)(v18 + 680) = *(_OWORD *)(a2 + 152);
    v44 = 0LL;
    v56[0] = *(_OWORD *)(a2 + 136);
    v56[1] = *(_OWORD *)(a2 + 152);
    v21 = sub_180018DD4(v58, a2 + 40);
    sub_1800170A4(v18, &v44, v21, v56);
    sub_18007B440(v18, a2);
    if ( (unsigned int)_std_type_info_compare(&qword_180215BB8, &qword_180215BF8) )
    {
      v57[0] = *(_OWORD *)(a2 + 136);
      v57[1] = *(_OWORD *)(a2 + 152);
      v22 = sub_180018DD4(v59, a2 + 40);
      sub_180016EC0(v18, v42, v22, v57);
      if ( v43 )
      {
    ...
    {
      v8 = 1;
      if ( *(_QWORD *)sub_18007B318(v18, v52) )
        v24 = 1;
    }
    if ( (v8 & 1) != 0 )
    {
  ...
  catch ( Spectre::Utils::SpectreException *v49 )
  {
    if ( *a5 )
    {
      v32 = (__int64 *)sub_180012B84((__int64)a5);
      v33 = *v32;
      v34 = sub_18007B1E0();
