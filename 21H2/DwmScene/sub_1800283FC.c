/*
 * XREFs of sub_1800283FC @ 0x1800283FC
 * Callers:
 *     sub_18002C310 @ 0x18002C310 (sub_18002C310.c)
 * Callees:
...
_QWORD *__fastcall sub_1800283FC(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180026A9C((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
