/*
 * XREFs of sub_180029780 @ 0x180029780
 * Callers:
 *     <none>
 * Callees:
...
_OWORD *__fastcall sub_180029780(__int64 a1, _OWORD *a2, _OWORD *a3)
{
  __int64 v4; // rdx
...
LABEL_77:
      ...
      v50[0] = *a3;
      v50[1] = a3[1];
      v22 = sub_18002427C((_QWORD *)a1, &v43, (__int64)v50, (__int64)&v35, a1 + 592);
...
LABEL_76:
        ...
        v49[0] = *a3;
        v49[1] = a3[1];
        v17 = sub_180023BA4((_QWORD *)a1, &v41, (__int64)v49, (__int64)&v34, a1 + 592);
...
LABEL_75:
        ...
        v48[0] = *a3;
        v48[1] = a3[1];
        v12 = sub_180023DEC((_QWORD *)a1, &v39, (__int64)v48, (__int64)&v33, a1 + 592);
...
LABEL_74:
        ...
        v47[0] = *a3;
        v47[1] = a3[1];
        v6 = sub_18002395C((_QWORD *)a1, &v37, (__int64)v47, (__int64)&v32, a1 + 592);
...
LABEL_78:
    ...
    v51[0] = *a3;
    v51[1] = a3[1];
    v27 = sub_180024034((_QWORD *)a1, &v45, (__int64)v51, (__int64)&v36, a1 + 592);
