...
__int64 __fastcall sub_180013300(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v8; // rcx
  __int128 *v9; // r8
  char v10; // bl
  ...
  v29 = v10;
  sub_180092AE0(*(_QWORD *)(a1 + 16), a2, v9);
  if ( (v10 & 2) != 0 )
  {
    v10 &= ~2u;
    v29 = v10;
  ...
  v16 = v32;
  sub_180092DDC(*(_QWORD *)(v32 + 16), a2, v14);
  if ( (v15 & 8) != 0 )
  {
    v15 &= ~8u;
  ...
  v19 = sub_180012B88(Src, (__int64)a2, (__int64)aEnabled);
  LOBYTE(v20) = a3 != 0;
  sub_180092708(*(_QWORD *)(v16 + 16), v19, v20);
  if ( v36 >= 0x10 )
  {
    v21 = Src[0];
    if ( v36 + 1 >= 0x1000 )
