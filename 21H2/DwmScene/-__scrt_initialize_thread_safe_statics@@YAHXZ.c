/*
 * XREFs of ?__scrt_initialize_thread_safe_statics@@YAHXZ @ 0x180124460
 * Callers:
 *     <none>
 * Callees:
...
__int64 __scrt_initialize_thread_safe_statics(void)
{
  ...
  {
    hHandle = 0LL;
    ((void (__fastcall *)(void *))InitializeConditionVariable)(&unk_180222050);
    qword_180222060 = __ROR8__(SleepConditionVariableCS, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    qword_180222068 = __ROR8__(v4, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    goto LABEL_7;
  }
