/*
 * XREFs of sub_1800F4524 @ 0x1800F4524
 * Callers:
...
__int64 __fastcall sub_1800F4524(_QWORD *a1)
{
  ...
  *a1 = &Spectre::Engine::ShaderPropertyBlock::`vftable';
  ...
  if ( !*((_BYTE *)v5 + 25) )
  {
    do
    {
      sub_180025928((__int64)(a1 + 11), (__int64)(a1 + 11), (__int64 *)v5[2]);
      v6 = v5;
      v5 = (__int64 *)*v5;
      j_j__o_free(v6);
    }
