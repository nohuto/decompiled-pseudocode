/*
 * XREFs of sub_18008C434 @ 0x18008C434
 * Callers:
...
__int64 __fastcall sub_18008C434(_DWORD *a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  __m128 v3; // xmm8
  __m128 v4; // xmm6
  __m128 v5; // xmm7
  ...
  v10 = _mm_mul_ps(_mm_add_ps(v8, v7), (__m128)xmmword_180140600);
  if ( !a1 )
  ...
  *a1 = v10.m128_i32[0];
  ...
  v11 = _mm_mul_ps(_mm_sub_ps(v8, v7), (__m128)xmmword_180140600);
