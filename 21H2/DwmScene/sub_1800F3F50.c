/*
 * XREFs of sub_1800F3F50 @ 0x1800F3F50
 * Callers:
 ...
 *     sub_1800F41C8 @ 0x1800F41C8 (sub_1800F41C8.c)
 *     sub_1800F5F80 @ 0x1800F5F80 (sub_1800F5F80.c)
 */

__int64 __fastcall sub_1800F3F50(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rbx
  __int64 v6; // rbp
  __int64 v7; // rdi
  ...
  else
  {
    ...
    result = sub_1800F41C8(v11, a3, a1[1], a1);
    v15 = result;
  }
  a1[1] = v15;
  return result;
