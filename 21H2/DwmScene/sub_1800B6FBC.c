/*
 * XREFs of sub_1800B6FBC @ 0x1800B6FBC
 * Callers:
 *     sub_1800B7A90 @ 0x1800B7A90 (sub_1800B7A90.c)
 * Callees:
...
_QWORD *__fastcall sub_1800B6FBC(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_1800B6800((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
