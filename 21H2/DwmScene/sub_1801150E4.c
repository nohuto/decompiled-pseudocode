/*
 * XREFs of sub_1801150E4 @ 0x1801150E4
 * Callers:
...
__int64 __fastcall sub_1801150E4(
        int a1,
        unsigned int a2,
        __int64 a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  if ( a4 != (_DWORD)result )
  {
    do
    {
      ...
      {
        sub_18000FE28(v26);
        sub_180115420(pExceptionObject, v26);
      ...
      if ( a6 != 1 || (v18 & 1) == 0 )
        v16 = 0;
      sub_180116C4C(v12, v13, v20, v21, v22, v16, a9, a10);
      result = sub_180115788(a1, v20, v21, v22, v16, a8);
