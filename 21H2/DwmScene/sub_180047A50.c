...
char __fastcall sub_180047A50(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
  ...
  if ( *(_BYTE *)(a1 + 96) )
  {
    ...
    sub_18002D8C4(pExceptionObject, v20, 38, (__int64)v22, 0);
...
LABEL_6:
    ...
    if ( v12 < 0 )
    {
      sub_18011BCAC(&unk_18020F178, 5LL, "ERROR: Failed to create Geometry shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
