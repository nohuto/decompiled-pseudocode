/*
 * XREFs of sub_1800B9058 @ 0x1800B9058
 * Callers:
 ...
 *     sub_18009F84C @ 0x18009F84C (sub_18009F84C.c)
...
char __fastcall sub_1800B9058(__m128 *a1, __m128 *a2)
{
  __int32 v4; // eax
  _DWORD *v5; // rbx
  unsigned int v6; // edx
  ...
  if ( !*(_QWORD *)(a1[28].m128_u64[0] + 128) || (LOBYTE(v4) = sub_18008FED8(a2, a1 + 31), (_BYTE)v4) )
  {
    v12[0] = *sub_18009F84C(a2, &v13);
    v12[1] = v12[0];
    v12[2] = v12[0];
    v12[3] = v12[0];
    v12[4] = v12[0];
    ...
    while ( v6 < 6 );
    LODWORD(Size) = 24576;
    sub_18009FAA4(a1[28].m128_i64[0], 32, 32, 0, 16, 0, 17, v5, Size, 0LL);
