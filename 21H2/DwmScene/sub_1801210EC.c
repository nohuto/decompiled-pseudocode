/*
 * XREFs of sub_1801210EC @ 0x1801210EC
 * Callers:
...
_QWORD *__fastcall sub_1801210EC(_QWORD *a1, unsigned __int64 a2)
{
  ...
  if ( (_QWORD *)*result != result )
  {
    ...
    {
      v8 = *(_QWORD *)a1[1];
      result = (_QWORD *)sub_18011F95C(a1, (__int64)v9, (char *)(v8 + 16), v8);
    }
    while ( v8 != v7 );
  }
  return result;
