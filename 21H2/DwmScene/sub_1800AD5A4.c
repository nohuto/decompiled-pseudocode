/*
 * XREFs of sub_1800AD5A4 @ 0x1800AD5A4
 * Callers:
...
__int64 __fastcall sub_1800AD5A4(_QWORD *a1, __int64 a2, __int64 a3, _QWORD *a4, __int64 a5)
{
  __int64 v7; // rdx
  __int64 v8; // rbx
  int v9; // edi
  ...
  if ( a1[15] == v7 )
  {
    sub_1800ABA08(a1 + 13, (_BYTE *)v7, (__int64)v13);
    v8 = *((_QWORD *)&v17 + 1);
  }
  else
  {
  ...
  v19[2] = 0LL;
  v19[3] = 0LL;
  sub_180020B7C(v19, (__int64)&qword_180212A38);
  sub_1800B1FB0(a1, v19, v18, (unsigned int)v9, COERCE_UNSIGNED_INT((float)v9), 0LL);
  if ( v8 )
  {
