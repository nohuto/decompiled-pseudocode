/*
 * XREFs of sub_1800B3854 @ 0x1800B3854
 * Callers:
...
__int64 *__fastcall sub_1800B3854(__int64 **a1, unsigned __int64 a2)
{
  ...
  result = sub_180037240((__int64)a1, v3);
  *a1 = result;
  a1[2] = &result[4 * v3];
  a1[1] = result;
  return result;
