/*
 * XREFs of sub_180084F20 @ 0x180084F20
 * Callers:
...
__int64 __fastcall sub_180084F20(__int64 a1, __m128 *a2)
{
  __m128 v3; // xmm3
  __m128 v4; // xmm4
  __m128 v5; // xmm2
  ...
  *(_DWORD *)(a1 + 60) = 1065353216;
  ...
  v7 = _mm_sub_ps(
         _mm_sub_ps((__m128)xmmword_1801CC830, _mm_and_ps(_mm_shuffle_ps(v5, v5, 193), (__m128)xmmword_18013FB50)),
         _mm_and_ps(_mm_shuffle_ps(v5, v5, 218), (__m128)xmmword_18013FB50));
