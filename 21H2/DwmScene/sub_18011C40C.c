/*
 * XREFs of sub_18011C40C @ 0x18011C40C
 * Callers:
...
void __fastcall sub_18011C40C(__int64 *a1, __int64 *a2, char *a3, char *a4)
{
  ...
  else
  {
    ...
    sub_1800126C4(a1, (__int64)v16, v39, v15);
  }
}
