/*
 * XREFs of sub_1800A6E2C @ 0x1800A6E2C
 * Callers:
...
_QWORD *__fastcall sub_1800A6E2C(_QWORD *Src, _QWORD **a2)
{
  _WORD *v3; // rax
  char v4; // bp
  _QWORD **v5; // rdi
  ...
  *v3 = 123;
  ...
  {
    if ( v4 )
      std::string::append(Src, &unk_1801431FC, 1uLL);
    else
      v4 = 1;
    v7 = v6 + 4;
    if ( v6[7] >= 0x10uLL )
  ...
  std::string::append(Src, &unk_1801431F8, 1uLL);
  return Src;
}
