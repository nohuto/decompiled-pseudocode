/*
 * XREFs of sub_1800FAC40 @ 0x1800FAC40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800FAC40(__int64 a1, __int64 a2)
{
  _QWORD *v4; // rax
  __int64 *v5; // rsi
  ...
  v4 = (_QWORD *)sub_1800703D4(a2);
  sub_180017874(v4, &v12, 1u);
  v5 = (__int64 *)(a1 + 216);
  ...
  v14[3] = 15LL;
  LOBYTE(v14[0]) = 0;
  sub_18000FC14(v14, 0x1DuLL, 0LL, "Image Processing Blur Sampler");
  sub_180068194(*v5, v14);
  v7 = (_QWORD *)*v5;
  v18 = 0;
  v22 = 0;
  v23 = 2139095039;
  ...
  sub_1800A1030(v7, &si128, 0LL);
  v8 = *(int *)(a1 + 144);
  v9 = sub_1800F99EC((__int64 *)a1, &v15);
  ...
  return (*(__int64 (__fastcall **)(_QWORD, __int64, __int64, _QWORD, int))(**(_QWORD **)(a1 + 184) + 40LL))(
           *(_QWORD *)(a1 + 184),
           a2,
           2LL,
           (unsigned int)dword_1801DBD70[v8],
           dword_1801DBD60[v8]);
}
