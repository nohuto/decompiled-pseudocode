/*
 * XREFs of sub_18011A7C0 @ 0x18011A7C0
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_18011A7C0(__int64 a1, void *a2, __int64 a3, void *a4, void *a5, void *a6, int a7)
{
  ULONG result; // eax
  ...
  if ( (unsigned int)dword_180214BC8 > 5 )
  {
    ...
    return sub_180002B08(
             ...
             (unsigned __int8 *)dword_1801EE788,
             0LL,
             0LL,
             &v13,
             (__int64)&v12,
