/*
 * XREFs of sub_1800A0F1C @ 0x1800A0F1C
 * Callers:
...
__int64 __fastcall sub_1800A0F1C(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r8
  __int64 v5; // rdx
  ...
  v7 = *(_DWORD *)(*a2 + 88LL);
  sub_180067E20(a1, &v14);
  v13 = v7;
  sub_1800A0910((__int64 *)(a1 + 128), (__int64)&v12, &v13);
  std::shared_ptr<__ExceptionPtr>::operator=((_QWORD *)(v12 + 40), a2);
  result = sub_180068014(a1, v7);
