/*
 * XREFs of sub_18002814C @ 0x18002814C
 * Callers:
 *     sub_18002C290 @ 0x18002C290 (sub_18002C290.c)
 * Callees:
...
_QWORD *__fastcall sub_18002814C(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180026B9C((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
