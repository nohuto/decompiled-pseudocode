/*
 * XREFs of sub_180117A0C @ 0x180117A0C
 * Callers:
...
int __fastcall sub_180117A0C(_QWORD *a1)
{
  ...
  *a1 = &Spectre::Utils::TelemetryTraceLoggerWin::`vftable';
  v2 = _InterlockedExchangeAdd64(&qword_180221E60, 0xFFFFFFFFFFFFFFFFuLL);
  if ( v2 == 1 )
  {
    v3 = RegHandle;
    RegHandle = 0LL;
