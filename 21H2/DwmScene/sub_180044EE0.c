/*
 * XREFs of sub_180044EE0 @ 0x180044EE0
 * Callers:
...
__int64 __fastcall sub_180044EE0(__int64 a1, _QWORD *a2, __int64 *a3)
{
  _QWORD *v5; // r14
  double v6; // xmm0_8
  char v7; // r13
  ...
  v110 = (_QWORD *)a1;
  v111 = 0LL;
  sub_180044ADC(a1, &v111);
  v132 = 0LL;
  sub_180029F64(v111, &v132);
  v136 = 0LL;
  ...
  *(_BYTE *)(*a3 + 1) = v7;
  v135 = 0LL;
  v8 = (**v136)(v136, &unk_180142FC0, &v135);
  v9 = v8;
  if ( v8 < 0 )
  {
  ...
  sub_180010534(v135, "CameraBackBuffer");
  v10 = 0;
  v106 = 0;
  v11 = *a3;
  v12 = *(__int64 **)(*a3 + 8);
  ...
  if ( v12 != v135 )
  {
    ...
    *(_QWORD *)&v137 = v14 | 0x100000000LL;
    ...
    v156[1] = v138;
    v133 = 0LL;
    v27 = (**v136)(v136, &unk_1801442E0, (__int64 **)&v133);
    v28 = v27;
    if ( v27 < 0 )
    {
    ...
    *(_QWORD *)&v152[12] = 3LL;
    ...
    sub_180010534(*(__int64 **)(*a3 + 16), "BackBufferStaging");
    v47 = *a3;
    v48 = *(_QWORD *)(*a3 + 56);
    if ( v48 )
    {
  ...
  sub_180010534(*(__int64 **)(*a3 + 24), "BackBuffer_DepthStencilTexture");
  v140[0] = 0;
  v140[1] = (v7 != 0) + 3;
  v140[2] = 0;
  if ( (v7 != 0) == -2 )
...
LABEL_57:
  ...
  sub_180010534(*(__int64 **)(*a3 + 56), "BackBuffer_DepthStencilView_LeftEye");
  v66 = *a3;
  v67 = (__int64 *)(*a3 + 104);
  if ( v7 )
  {
    ...
    sub_180010534(*(__int64 **)(*a3 + 104), "BackBuffer_DepthStencilView_RightEye");
    v5 = v110;
  }
  else
  {
...
LABEL_80:
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      sub_180031D30(v85, &v114, &v113, &v112, *(_DWORD *)(v86 + 40), *(_DWORD *)(v86 + 44));
      v149 = 0LL;
      sub_18000F8A8(v84, &v149, 0);
      sub_18006885C(v149, &v148);
