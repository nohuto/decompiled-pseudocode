/*
 * XREFs of sub_18003B180 @ 0x18003B180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18003B180(__int64 a1, int a2, __int64 a3, unsigned int a4)
{
  __int64 *v7; // rcx
  char v8; // di
  __int64 v9; // rax
  ...
  if ( *(_QWORD *)a3 )
  {
    sub_1800392B0((__int64 *)(*(_QWORD *)a3 + 112LL), &v18, *(_DWORD *)(a1 + 88));
    v7 = &v18;
    v8 = 1;
    v9 = v18;
  }
