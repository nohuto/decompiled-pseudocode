/*
 * XREFs of sub_180089404 @ 0x180089404
 * Callers:
...
char __fastcall sub_180089404(_DWORD *a1, _OWORD *a2, _OWORD *a3, double a4)
{
  __m128 v4; // xmm0
  __m128 v5; // xmm1
  __m128 v6; // xmm2
...
LABEL_24:
  ...
  v31 = _mm_sqrt_ps(v30);
  v32 = _mm_cmpneq_ps(v30, (__m128)xmmword_18013FC00);
  v33 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_div_ps(*v27, v31), _mm_cmpneq_ps((__m128)0LL, v31)), v32),
          _mm_andnot_ps(v32, (__m128)xmmword_18013FC10));
  *v27 = v33;
  if ( *(float *)&v9[v26] < 0.000099999997 )
  {
    ...
    v38 = _mm_shuffle_ps(*(__m128 *)off_18020F6A8[v7], *(__m128 *)off_18020F6A8[v7], 210);
    *(__m128 *)v61[v26] = _mm_and_ps(
                            _mm_sub_ps(
                              _mm_mul_ps(v38, v37),
                              _mm_mul_ps(_mm_shuffle_ps(v38, v38, 210), _mm_shuffle_ps(v37, v37, 201))),
                            (__m128)xmmword_18013FB50);
  }
  v39 = (__m128 *)v61[v26];
  ...
  v43 = _mm_sqrt_ps(v42);
  v44 = _mm_cmpneq_ps(v42, (__m128)xmmword_18013FC00);
  v45 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_div_ps(*v39, v43), _mm_cmpneq_ps((__m128)0LL, v43)), v44),
          _mm_andnot_ps(v44, (__m128)xmmword_18013FC10));
  *v39 = v45;
  ...
  v52 = _mm_sqrt_ps(v51);
  v53 = _mm_cmpneq_ps(v51, (__m128)xmmword_18013FC00);
  *v48 = _mm_or_ps(
           _mm_and_ps(_mm_and_ps(_mm_cmpneq_ps((__m128)0LL, v52), _mm_div_ps(*v48, v52)), v53),
           _mm_andnot_ps(v53, (__m128)xmmword_18013FC10));
  v54 = v62.m128_u64[1];
  v58 = sub_1800898F4(a1, v20);
  if ( v58 < 0.0 )
  {
    v58 = -v58;
  ...
  if ( (float)((float)(v58 + -1.0) * (float)(v58 + -1.0)) > 0.000099999997 )
    return 0;
  *((_QWORD *)&v60 + 1) = v54;
  *(double *)&v60 = sub_180089D84(v56, v55, v57);
  *a2 = v60;
  return 1;
}
