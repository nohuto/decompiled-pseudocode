/*
 * XREFs of sub_18007A4C0 @ 0x18007A4C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18007A4C0(_QWORD *a1)
{
  __int64 v2; // rcx
  __int64 *v3; // rax
  ...
  sub_1800670D8((__int64)(a1 + 1));
  sub_180080C10(a1);
  sub_180078A90((__int64)a1);
  ...
  *((_QWORD *)&v13 + 1) = v2;
  ...
  v3 = (__int64 *)sub_18007ABC4(a1, v20);
  ...
  v14 = *v3;
  v15 = v4;
  sub_180076E98(&v18, &v14, (__int64)v16);
  ...
  LOBYTE(v16[0]) = 0;
  sub_18007CFC0(a1);
  if ( (unsigned int)sub_18007AD60(a1) > 1 )
  {
    v12 = 0LL;
    sub_18007AC9C(a1, &v12, 1LL);
    v8 = v12;
    if ( (_QWORD)v12 )
    {
      v9 = sub_18007AB84(a1, 1LL);
      v10 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v9 + 72LL))(v9, &unk_18020FBE8, 1LL);
    ...
    sub_18007DFAC(a1);
    sub_18007D258(a1);
    sub_180077C2C((__int64 *)&v18);
    sub_1801142C8(v22);
    return sub_18007F998(a1);
  }
  else
  {
    sub_180077C2C((__int64 *)&v18);
    return sub_1801142C8(v22);
  }
}
