/*
 * XREFs of sub_1800B5C84 @ 0x1800B5C84
 * Callers:
...
_QWORD *__fastcall sub_1800B5C84(__int64 a1, _QWORD *a2, _QWORD *a3, _QWORD *a4)
{
  _QWORD *v4; // rsi
  _QWORD *j; // rbx
  __int64 **v9; // rax
  ...
  {
    sub_1800B3E04(a1, a1, (__int64 *)v4[1]);
    v4[1] = v4;
    *v4 = v4;
    v4[2] = v4;
    *(_QWORD *)(a1 + 8) = 0LL;
