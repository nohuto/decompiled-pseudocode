/*
 * XREFs of sub_18006C920 @ 0x18006C920
 * Callers:
 *     <none>
 * Callees:
...
_DWORD *__fastcall sub_18006C920(__int64 a1, _DWORD *a2, __int64 a3)
{
  float v3; // xmm6_4
  __m128 v6; // xmm3
  _DWORD *result; // rax
  ...
  result = a2;
  v8 = _mm_div_ps(_mm_unpacklo_ps(v6, (__m128)v10), (__m128)v9);
  *a2 = v8.m128_i32[0];
