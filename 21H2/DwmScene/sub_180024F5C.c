/*
 * XREFs of sub_180024F5C @ 0x180024F5C
 * Callers:
...
int __fastcall sub_180024F5C(__int64 a1)
{
...
LABEL_6:
    ...
    JUMPOUT(0x180025048LL);
  }
  v9 = _std_type_info_hash(&qword_180216E40);
  sub_18002660C(a1, v6, &v9);
  v7[0] = &std::_Func_impl_no_alloc<_lambda_8063c925c9079455a8b5523fef35cede_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v8 = v7;
