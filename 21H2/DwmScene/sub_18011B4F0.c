...
__int64 *__fastcall sub_18011B4F0(__int64 *a1)
{
  ...
  if ( dword_180221EC8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_180221EC8);
    if ( dword_180221EC8 == -1 )
    {
      qword_180221EC0 = v5;
      Init_thread_footer(&dword_180221EC8);
    }
  }
  v6 = v5 - qword_180221EC0;
