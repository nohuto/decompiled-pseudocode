/*
 * XREFs of sub_1800E31CC @ 0x1800E31CC
 * Callers:
...
__int64 __fastcall sub_1800E31CC(__int64 a1, unsigned int a2)
{
  __int64 v4; // r8
  __int64 v5; // r8
  __int64 v6; // r8
  ...
  unknown_libname_103(v263);
  v262 = _mm_load_si128((const __m128i *)&xmmword_180142440);
  LOWORD(v261[0]) = 0;
  ...
  return unknown_libname_103(v535);
}
