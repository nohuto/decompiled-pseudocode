/*
 * XREFs of sub_1800972FC @ 0x1800972FC
 * Callers:
...
__int64 __fastcall sub_1800972FC(_DWORD *a1)
{
  __int64 result; // rax
  char v3; // bl
  BOOL v4; // r14d
  ...
  if ( !(_DWORD)result || (_DWORD)result == 3 )
  {
    ...
    if ( v5 )
    {
      v6 = (__int64 *)sub_180097F2C(a1, v29, 0LL);
      v7 = *v6;
      v18 = *v6;
    ...
    {
      v9 = (__int64 *)sub_180097F2C(a1, v27, 0LL);
      v7 = *v9;
    ...
    *v8 = 0LL;
    ...
    v23 = v22;
    v22 = 0LL;
    v14 = sub_180097F8C(a1, v31, 0LL);
    result = sub_180115870(v14, a1[30], (unsigned int)&v23, a1[28], v5, v4, (__int64)v32, 0LL, (__int64)&v24);
