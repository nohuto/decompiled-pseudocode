...
__int64 __fastcall sub_1800216CC(volatile signed __int32 *a1, int a2, int a3, _DWORD *a4)
{
  ...
  while ( 1 )
  {
    ...
    result = (unsigned int)_InterlockedCompareExchange(a1, (v9 ^ ((_DWORD)v13 << 15)) & 0x3F8000 ^ v9, v4);
    if ( v4 == (_DWORD)result )
      break;
    v4 = result;
  }
