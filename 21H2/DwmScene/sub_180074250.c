/*
 * XREFs of sub_180074250 @ 0x180074250
 * Callers:
...
_QWORD *__fastcall sub_180074250(__int64 **a1, _QWORD *a2, __int64 *a3, __int64 a4, _QWORD *a5)
{
  __int64 *v9; // rdi
  _QWORD *result; // rax
  _QWORD *v11; // r9
  ...
  if ( a1[1] )
  {
    if ( a3 == (__int64 *)*v9 )
    {
      ...
      {
        sub_180073194(a1, a2, 1, a3, a4, a5);
        return a2;
      }
      goto LABEL_30;
    }
    if ( a3 == v9 )
    {
      ...
      {
        sub_180073194(a1, a2, 0, v11, a4, a5);
        return a2;
      }
      goto LABEL_30;
    }
    ...
    if ( a3[5] > v12 )
    {
      ...
      {
        if ( *(_BYTE *)(v19[2] + 25) )
          sub_180073194(a1, a2, 0, v19, a4, a5);
        else
          sub_180073194(a1, a2, 1, a3, a4, a5);
        return a2;
      }
    ...
    {
LABEL_30:
      *a2 = *(_QWORD *)sub_180074EFC((_DWORD)a1, (unsigned int)&v21, 0, a4, (__int64)a5);
      return a2;
    }
    if ( v15 )
      sub_180073194(a1, a2, 0, a3, a4, a5);
    else
      sub_180073194(a1, a2, 1, (_QWORD *)v14, a4, a5);
    return a2;
  }
  else
  {
    try
    {
      sub_180073194(a1, a2, 1, v9, a4, a5);
      result = a2;
    }
    catch ( ... )
    {
      sub_180080E68(v21, v20);
      throw;
    }
  }
  return result;
