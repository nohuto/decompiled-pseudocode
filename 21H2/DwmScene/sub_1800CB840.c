/*
 * XREFs of sub_1800CB840 @ 0x1800CB840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800CB840(__int64 a1, __int64 *a2)
{
  __int64 v3; // rbx
  __int64 result; // rax
  __int64 v5; // r8
  ...
  v13 = *(__int64 **)(v3 + 384);
  v14 = *(__int64 **)(v3 + 376);
  result = (__int64)sub_18006F0B8(&v12, v14, v13, 0);
  if ( v12 == *(__int64 **)(v3 + 384) )
    v11 = 0LL;
  else
    result = (__int64)sub_18006EF68((__int64 *)&v11, v12);
  v5 = v11;
  if ( !(_QWORD)v11 )
    goto LABEL_10;
  result = *(_QWORD *)(a1 + 8);
