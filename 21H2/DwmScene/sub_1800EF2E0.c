/*
 * XREFs of sub_1800EF2E0 @ 0x1800EF2E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1800D25D4 @ 0x1800D25D4 (sub_1800D25D4.c)
...
__int64 __fastcall sub_1800EF2E0(__int64 a1)
{
  __int64 v2; // rdi
  __int64 v3; // rdi
  __int64 v4; // rbx
  ...
  v5 = v4 | sub_1800D2614(0, 4, 0LL);
  v6 = v5 | sub_1800D25F4(0, 3, 0LL);
  v7 = v6 | sub_1800D25D4(0, 3, 0LL);
  v8 = v7 | sub_1800D2634(0, 2, 0LL);
  result = v8 | sub_1800D2654(0, 2, 0LL);
