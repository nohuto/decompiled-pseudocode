/*
 * XREFs of sub_1800F0754 @ 0x1800F0754
 * Callers:
...
__int64 __fastcall sub_1800F0754(__int64 a1)
{
  __int64 v2; // rax
  unsigned int v3; // esi
  __int64 v4; // rdx
  ...
  if ( (__int64)(*((_QWORD *)&v12 + 1) - v12) >> 4 )
  {
    ...
    do
    {
      ...
      *((_QWORD *)&v11 + 1) = v7;
      v14 = 0LL;
      sub_180066E84(v8 + 24, (__int64)&v14);
      v10 = 0LL;
      if ( v7 )
      {
        _InterlockedIncrement(v7 + 2);
  ...
  return sub_180012A18((__int64 *)&v12);
}
