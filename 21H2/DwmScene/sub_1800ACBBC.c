/*
 * XREFs of sub_1800ACBBC @ 0x1800ACBBC
 * Callers:
...
__int64 __fastcall sub_1800ACBBC(__int64 a1, __int64 a2)
{
  __int64 v4; // rcx
  _QWORD *v5; // rax
  char *v6; // rbx
  ...
  *(_QWORD *)(a1 + 536) = 0LL;
  ...
  do
  {
    `vector constructor iterator'(v6, 64LL, 4LL, (void (__fastcall *)(char *))sub_180018F40);
    v6 += 256;
    --v7;
  }
  while ( v7 );
