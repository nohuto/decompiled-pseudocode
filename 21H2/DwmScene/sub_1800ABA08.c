/*
 * XREFs of sub_1800ABA08 @ 0x1800ABA08
 * Callers:
...
__int64 __fastcall sub_1800ABA08(_QWORD *a1, _BYTE *a2, __int64 a3)
{
  __int64 v6; // r12
  __int64 v7; // rdx
  ...
  *(_QWORD *)(v14 + 40) = *(_QWORD *)(a3 + 40);
  ...
  if ( a2 == (_BYTE *)v16 )
  {
    sub_1800B3AAC(a1, *a1, a1[1], v12, v14);
  }
  else
  {
    if ( v17 != a2 )
  ...
  sub_1800B36BC(a1, v12, v8, v11, v23);
  return v13 + *a1;
}
