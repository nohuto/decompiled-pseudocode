/*
 * XREFs of sub_1800C857C @ 0x1800C857C
 * Callers:
...
char __fastcall sub_1800C857C(_BYTE *a1, __int64 *a2, char a3)
{
  __int64 v6; // rbx
  ...
  v6 = sub_18007AB84((__int64)a1, *(_DWORD *)(*a2 + 112));
  LOBYTE(v7) = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v6 + 64LL))(v6, &unk_1802100C8, 0LL);
  if ( !(_BYTE)v7 )
    return v7;
  v8 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_1802100A8);
  LOBYTE(v9) = 1;
  (*(void (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v6 + 64LL))(v6, &unk_1802100E8, v9);
  v11 = v10;
  v12 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180210108);
  v13 = LODWORD(v12);
  v14 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180210128);
  v15 = LODWORD(v14);
  v16 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180210148);
  v17 = LODWORD(v16);
  v18 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180210168);
  v19 = LODWORD(v18);
  v20 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_180210188);
  v21 = LODWORD(v20);
  v22 = (*(double (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_1802101A8);
  v23 = LODWORD(v22);
  (*(void (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 88LL))(v6, &qword_1802101C8);
  v36 = 0LL;
  sub_1800C27F0((__int64)a1, &v36, a2);
  v24 = v36;
  ...
  if ( v11 )
  {
    ...
    v45 = *(__int64 **)(v24 + 384);
    v46 = *(__int64 **)(v24 + 376);
    sub_180014044(&v41, v46, v45, 0);
    if ( v41 != *(__int64 **)(v24 + 384) )
      sub_180013F08((__int64 *)&v42, v41);
    if ( (_QWORD)v42 )
  ...
  sub_180084098(v53, (unsigned __int64 *)&v49, &v51);
  sub_18008933C(v24);
  *(_DWORD *)(v24 + 144) = v53[0];
  *(_DWORD *)(v24 + 148) = v53[1];
  *(_DWORD *)(v24 + 152) = v53[2];
  v27 = _InterlockedIncrement64(&qword_18020F6C0);
  v28 = v36;
  *(_QWORD *)(v36 + 208) = v27;
  v29 = *(_QWORD *)(v28 + 216);
  if ( v27 >= v29 )
...
LABEL_21:
    ...
    sub_180089CA0(*(double *)v30.m128_u64);
    v54 = v30;
    v47 = v30;
    sub_1800882A0(v28, &v47);
    if ( a3 )
    {
LABEL_24:
      sub_180089274(v28);
      v43 = *(_QWORD *)(v28 + 172);
      v44 = *(_DWORD *)(v28 + 180);
      v31 = sub_18008FF50(v48, v8, &v43);
      v39 = *(_QWORD *)v31;
      v40 = v31[2];
      sub_18008933C(v28);
      *(_QWORD *)(v28 + 172) = v39;
      *(_DWORD *)(v28 + 180) = v40;
      v32 = _InterlockedExchangeAdd64(&qword_18020F6C0, 1uLL);
      v33 = v36;
