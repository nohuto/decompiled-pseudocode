/*
 * XREFs of sub_1800C3F40 @ 0x1800C3F40
 * Callers:
 *     sub_1800C8A84 @ 0x1800C8A84 (sub_1800C8A84.c)
 * Callees:
 *     sub_1800B93E4 @ 0x1800B93E4 (sub_1800B93E4.c)
 *     sub_1800BB82C @ 0x1800BB82C (sub_1800BB82C.c)
 */

__int64 __fastcall sub_1800C3F40(__int64 a1, _DWORD *a2, __int64 *a3)
{
  __int64 result; // rax
  __int64 *v5; // rdi
  __int64 v6; // rbx
  ...
  result = sub_1800BB82C(*a3, (__int64)a2);
  v5 = *(__int64 **)(result + 104);
  v6 = *v5;
  while ( (__int64 *)v6 != v5 )
  {
    sub_1800B93E4(*(_DWORD **)(v6 + 40), a2);
    result = *(_QWORD *)(v6 + 16);
    if ( *(_BYTE *)(result + 25) )
    {
