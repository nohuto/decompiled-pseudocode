/*
 * XREFs of sub_18003E050 @ 0x18003E050
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_18003E050(_QWORD *a1, __int64 a2, unsigned int a3, int a4, char *String)
{
  __int64 v6; // r14
  const char *v9; // rdi
  char result; // al
