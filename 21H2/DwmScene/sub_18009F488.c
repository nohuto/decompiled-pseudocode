/*
 * XREFs of sub_18009F488 @ 0x18009F488
 * Callers:
 ...
 *     sub_18009F1F0 @ 0x18009F1F0 (sub_18009F1F0.c)
...
__int64 __fastcall sub_18009F488(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r14
  __int64 *v5; // rbx
  char v6; // r15
  ...
  {
    sub_18000FE28(v24);
    v18 = (unsigned int)sub_18000FE28(v23);
    sub_1800D1210((unsigned int)v27, v18, 961, (unsigned int)v24, 0);
  ...
  {
    v6 = 0;
    if ( !sub_18009F1F0(*(_DWORD **)(a1 + 128), v5)
      || (v20 = *(_QWORD *)(v4 + 152),
          v22 = *(_QWORD *)(a1 + 144),
          v7 = 0LL,
    ...
    {
      sub_18000FE28(v26);
      v17 = (unsigned int)sub_18000FE28(v25);
      sub_1800D1210((unsigned int)pExceptionObject, v17, 977, (unsigned int)v26, 0);
