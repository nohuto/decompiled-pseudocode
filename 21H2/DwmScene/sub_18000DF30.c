/*
 * XREFs of sub_18000DF30 @ 0x18000DF30
 * Callers:
...
int __fastcall sub_18000DF30(__int64 a1, __int64 a2, int a3)
{
  __int64 *v3; // r15
  __int64 *v4; // r14
  _QWORD *v5; // r13
  ...
  *(_QWORD *)(a1 + 56) = 0LL;
  ...
  if ( !*(_QWORD *)(a1 + 64) || *(_QWORD *)(a1 + 72) < v18 )
  {
    ...
    {
      v21 = GetProcessHeap();
      LODWORD(v10) = ((__int64 (__fastcall *)(HANDLE, __int64))qword_18021F558)(v21, v20);
    }
    if ( v20 )
    {
      v22 = GetProcessHeap();
...
LABEL_32:
    ...
    if ( v26 - v23 >= v30 )
    {
      sub_18000F088(v23, v26 - v23, v29, v30);
      if ( v4 )
        *v4 = v23;
      v23 += v30;
    }
...
LABEL_42:
    ...
    v31 = (void *)sub_18000BE54(v23, v26, *(_WORD **)(a2 + 16), v5);
