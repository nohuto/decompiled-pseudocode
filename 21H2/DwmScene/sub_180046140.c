/*
 * XREFs of sub_180046140 @ 0x180046140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180046140(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
...
LABEL_3:
  v6 = (unsigned int *)*a2;
  v25[0] = _mm_load_si128((const __m128i *)&xmmword_180144380);
  v25[1] = _mm_load_si128((const __m128i *)&xmmword_180144360);
  v26 = 4;
  v27 = 5;
  v28 = 16;
  LODWORD(v33) = *((_DWORD *)v25 + *v6);
  si128 = _mm_load_si128((const __m128i *)&xmmword_180144370);
  v20 = 5;
