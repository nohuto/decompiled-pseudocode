/*
 * XREFs of sub_1800CDCD4 @ 0x1800CDCD4
 * Callers:
 *     sub_1800CF050 @ 0x1800CF050 (sub_1800CF050.c)
 * Callees:
...
_OWORD *__fastcall sub_1800CDCD4(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
