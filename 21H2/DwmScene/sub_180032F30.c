 ...
 *     sub_1800363E4 @ 0x1800363E4 (sub_1800363E4.c)
...
_QWORD *__fastcall sub_180032F30(_QWORD *a1, int a2, int a3, unsigned int a4, _DWORD *a5)
{
  unsigned int v9; // ebx
  int v10; // edx
  ...
  v37 = a3;
  v35 = 0;
  sub_1800363E4(&v31, (unsigned int)a5[4]);
  if ( HIDWORD(v31) == 1 )
    v9 = a2 | 8;
  else
    v9 = a2 & 0xFFFFFFF7;
  ...
  else
  {
    ...
    v33 = (__int64)v23;
    if ( v23 )
      v24 = sub_18009ED9C((_DWORD)v23, *a5, a5[1], v31, v21, v22);
    else
      v24 = 0LL;
    v33 = v24;
    v25 = &v33;
