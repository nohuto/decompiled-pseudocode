/*
 * XREFs of sub_180028804 @ 0x180028804
 * Callers:
 *     sub_18002C3D0 @ 0x18002C3D0 (sub_18002C3D0.c)
 * Callees:
...
_QWORD *__fastcall sub_180028804(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180026F6C((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
