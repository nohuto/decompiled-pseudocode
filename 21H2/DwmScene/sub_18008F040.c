/*
 * XREFs of sub_18008F040 @ 0x18008F040
 * Callers:
 ...
 *     sub_18008F71C @ 0x18008F71C (sub_18008F71C.c)
 *     __security_check_cookie @ 0x180123FC0 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x180125480 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=1
void __fastcall sub_18008F040(__int64 a1, __int64 a2)
{
  __int64 v3; // rcx
  __int64 v4; // rbx
  ...
  v5[0] = 1;
  if ( (unsigned __int8)((__int64 (__fastcall *)(__int64, char *, _QWORD, __int64))sub_18008F71C)(a2 + 72, v5, 0LL, 5LL) )
  {
    v7[0] = 0;
    *(_QWORD *)v6 = qword_180221E80;
    *(_DWORD *)&v6[8] = dword_180221E88;
    *(_QWORD *)&v6[12] = qword_180221E80;
    *(_DWORD *)&v6[20] = dword_180221E88;
    ...
    *(_QWORD *)&v6[8] = v3;
    sub_18008EEA4((__int64 *)v6, a2 + 48, (__int64)v7);
    if ( *(_QWORD *)&v6[8]
