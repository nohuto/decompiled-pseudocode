/*
 * XREFs of sub_1800C27F0 @ 0x1800C27F0
 * Callers:
 ...
 *     sub_180085510 @ 0x180085510 (sub_180085510.c)
...
_QWORD *__fastcall sub_1800C27F0(__int64 a1, _QWORD *a2, __int64 *a3)
{
...
LABEL_20:
  ...
  v10[2] = 0LL;
  v10[3] = 0LL;
  sub_18001277C(v10, (__int64)&unk_180220C48);
  sub_18008CDE8(*a3, (__int64 *)&v13, v10);
  if ( !(_QWORD)v13 )
  {
LABEL_16:
