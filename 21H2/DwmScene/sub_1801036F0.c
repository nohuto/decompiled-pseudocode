/*
 * XREFs of sub_1801036F0 @ 0x1801036F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1801036F0(__int64 a1, _QWORD *a2)
{
  __int64 result; // rax
  __int64 v5; // rcx
  ...
  if ( !(_BYTE)result )
  {
    ...
    {
      sub_18000FE28(v11);
      v9 = sub_18000FE28(v10);
      sub_180099C14(pExceptionObject, v9, 90, (__int64)v11, 0);
