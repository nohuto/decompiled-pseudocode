/*
 * XREFs of sub_180078570 @ 0x180078570
 * Callers:
...
__int64 __fastcall sub_180078570(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r9
  __int64 v5; // r8
  ...
  v19 = v24;
  sub_1800760F8((__int64 **)(a1 + 728), (__int64)&v22, &v19);
  v11 = (__int64 *)(v22 + 48);
  v12 = *(_QWORD **)(v22 + 56);
  if ( *(_QWORD **)(v22 + 64) == v12 )
  {
    sub_18001851C(v11, v12, a2);
  }
  else
  {
    *v12 = 0LL;
  ...
  if ( *((_QWORD *)&v24 + 1) )
    _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v24 + 1) + 12LL));
  v20 = v24;
  sub_1800760F8((__int64 **)(a1 + 728), (__int64)v23, &v20);
