/*
 * XREFs of sub_180028758 @ 0x180028758
 * Callers:
 *     sub_18002C3B0 @ 0x18002C3B0 (sub_18002C3B0.c)
 * Callees:
...
_QWORD *__fastcall sub_180028758(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180026B08((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
