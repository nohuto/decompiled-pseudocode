/*
 * XREFs of sub_1800F46B8 @ 0x1800F46B8
 * Callers:
 ...
 *     sub_18006E174 @ 0x18006E174 (sub_18006E174.c)
 *     sub_18006E184 @ 0x18006E184 (sub_18006E184.c)
...
__int64 __fastcall sub_1800F46B8(__int64 a1, __int64 *a2, int a3)
{
  int v3; // ebx
  __int64 *v4; // r15
  __int64 v6; // r8
...
LABEL_18:
      ...
      v34 = v41;
      sub_1800F4B70(a1, &v34);
    }
    if ( *(_QWORD *)(a1 + 112) )
      UnDecorator::getTemplateNonTypeArgument(a1);
    v43 = v7;
    sub_1800F40B8((__int64 **)(a1 + 88), (__int64)&v35, &v43);
    if ( *(_DWORD *)(a1 + 80) != *(_DWORD *)(v35 + 32) )
    {
      ...
      v44 = v7;
      sub_1800F40B8((__int64 **)(a1 + 88), (__int64)&v36, &v44);
  ...
  for ( i = 0; i < 6; ++i )
  {
    ...
    {
      if ( *(_QWORD *)(a1 + 128) )
        sub_18006E158(*v4, i, (_QWORD *)(a1 + 128), *(_DWORD *)(a1 + 144));
      if ( ((1 << i) & v45) != 0 )
      {
        v15 = 0;
        v31 = 0;
          ...
          do
          {
            ...
            *((_QWORD *)&v42 + 1) = v22;
            ...
            if ( v20 )
            {
              ...
              if ( !v24 )
                sub_18009F380(v46, (__int64 *)&v41);
              sub_18006E184(*a2, i, (__int64)&v46, v23);
              if ( (_QWORD)v42 )
              {
                v26 = *sub_1800A1304(v42, &v39, v7);
                v27 = v40;
                if ( v40 )
                {
                ...
                if ( !v26 )
                  sub_1800A0D20((_QWORD *)v42, (__int64 *)&v41);
                sub_18006E174(*a2, i, (__int64)&v42, v23);
              }
              v15 = v31;
