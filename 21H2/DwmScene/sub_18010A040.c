/*
 * XREFs of sub_18010A040 @ 0x18010A040
 * Callers:
...
__int64 __fastcall sub_18010A040(_QWORD *a1, __int64 *a2, __int64 *a3, __int64 *a4, __int64 a5, __int64 *a6)
{
  _QWORD *v9; // rbx
  _QWORD *v10; // rdi
  __int64 v11; // rcx
  ...
  while ( v9 != v10 )
  {
    ...
    *(_QWORD *)&v38 = *a2;
    *((_QWORD *)&v38 + 1) = v15;
    sub_18010A040(*v9, (unsigned int)&v38, (unsigned int)&v37, (unsigned int)&v36, (__int64)v49, (__int64)&v35);
    v9 += 2;
  }
  v16 = *(_QWORD *)(a5 + 56);
  if ( !v16 )
  ...
  *(_BYTE *)(v21 + 72) = 0;
  ...
  result = sub_1800DB77C((__int64)&v51);
