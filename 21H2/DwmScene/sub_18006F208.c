/*
 * XREFs of sub_18006F208 @ 0x18006F208
 * Callers:
...
__int64 __fastcall sub_18006F208(__int64 a1, __int64 a2, _QWORD *a3)
{
  unsigned int v6; // eax
  _QWORD *v7; // rax
  ...
  *(_QWORD *)(a1 + 16) = 0LL;
  if ( a2 )
    v6 = sub_180067094(a2 + 8);
  else
    v6 = 1;
  sub_180066D08(a1 + 24, v6);
  ...
  *(_WORD *)(a1 + 208) = 0;
  *(_DWORD *)(a1 + 240) = 1;
  *(_DWORD *)(a1 + 244) = _InterlockedExchangeAdd(&dword_18020F640, 1u);
  *(_QWORD *)(a1 + 248) = 0LL;
  *(_QWORD *)(a1 + 256) = 0LL;
  *(_QWORD *)(a1 + 264) = 0LL;
  *(_QWORD *)(a1 + 272) = 0LL;
  ...
  *a3 = 0LL;
  a3[1] = 0LL;
  sub_1800E2104(a1 + 608);
  sub_1800E2104(a1 + 832);
  sub_1800E2104(a1 + 1056);
  sub_1800E1A88(a1 + 1280);
  *(_QWORD *)(a1 + 3840) = 0LL;
  *(_QWORD *)(a1 + 3848) = 0LL;
  *(_QWORD *)(a1 + 3856) = 0LL;
  *(_QWORD *)(a1 + 3864) = 0LL;
  ...
  *(_DWORD *)(a1 + 4044) = 1065353216;
  sub_18006F198((_QWORD *)(a1 + 4096), a1);
  *(_OWORD *)(a1 + 424) = 0LL;
  *(_OWORD *)(a1 + 440) = 0LL;
  *(_OWORD *)(a1 + 456) = 0LL;
  *(_OWORD *)(a1 + 472) = 0LL;
