/*
 * XREFs of sub_18013038C @ 0x18013038C
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18013038C(__int64 a1, __int64 a2)
{
  __int64 v3; // rcx
  volatile signed __int32 *v4; // rbx

  sub_18011BCAC(&qword_180214B30, 3, "ComputeNormals threw unexpected exception");
  *(_OWORD *)(a2 + 128) = 0LL;
