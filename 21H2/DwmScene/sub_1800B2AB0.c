/*
 * XREFs of sub_1800B2AB0 @ 0x1800B2AB0
 * Callers:
...
char __fastcall sub_1800B2AB0(__int64 a1)
{
  __int128 v2; // xmm5
  int v3; // eax
  __int128 v4; // xmm2
  ...
  if ( (*(_BYTE *)(a1 + 544) & 2) == 0 )
    return 0;
  v3 = *(_DWORD *)(a1 + 316);
  v14 = xmmword_1801D7CA0;
  v15 = xmmword_1801D7CB0;
  v16 = xmmword_1801D7CD0;
  v17 = xmmword_1801CCE10;
  switch ( v3 )
  {
    case 1:
      v4 = 0x3A83126Fu;
...
LABEL_9:
  ...
  *(_OWORD *)&v13[24] = 0LL;
  ...
  v9 = v8;
  *(float *)&v9 = sub_1800208CC(*(float *)&v8 * *(float *)&v2, *(float *)&v8, *(float *)&v4, *(float *)&v7);
LABEL_10:
  *(_OWORD *)v13 = v9;
  v10 = (__int128 *)v13;
  *(_OWORD *)&v13[16] = v8;
...
LABEL_24:
  ...
  if ( *(_DWORD *)(a1 + 316) != 5 )
  {
    ...
    *(_OWORD *)&v13[32] = v16;
    *(_OWORD *)&v13[48] = v17;
    sub_180083CB4((_OWORD *)(a1 + 932), v13);
  }
  sub_18001BA00(&v14, (__int64)v13);
  v14 = *(_OWORD *)v13;
  v15 = *(_OWORD *)&v13[16];
  v16 = *(_OWORD *)&v13[32];
  v17 = *(_OWORD *)&v13[48];
  sub_180083CB4((_OWORD *)(a1 + 1124), &v14);
  *(_DWORD *)(a1 + 544) &= ~2u;
  return 1;
}
