/*
 * XREFs of sub_1800BAA58 @ 0x1800BAA58
 * Callers:
...
__int64 *__fastcall sub_1800BAA58(__int64 a1, __int64 *a2, _QWORD *a3, _QWORD *a4)
{
  __int64 v8; // r8
  __int64 v9; // rdx
  ...
  *((_QWORD *)&v26 + 1) = v11;
  ...
  if ( (_QWORD)v35 )
  {
    ...
    v32 = *(__int64 **)(v12 + 384);
    v33 = *(__int64 **)(v12 + 376);
    sub_1800112E0(&v23, v33, v32, 0);
    if ( v23 == *(__int64 **)(v12 + 384) )
      *(_OWORD *)v24 = 0LL;
    else
      sub_18001127C(v24, v23);
    v13 = v24;
    v14 = 13;
    v15 = v24[0];
  }
