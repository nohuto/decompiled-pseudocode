/*
 * XREFs of sub_1800FB430 @ 0x1800FB430
 * Callers:
...
__int64 __fastcall sub_1800FB430(unsigned __int64 a1, __int64 *a2, __int64 *a3, __int64 *a4, char a5)
{
  ...
  if ( v10 )
  {
    ...
    sub_1800F6178((__int64 *)&v37, v10);
  }
  v11 = v33;
  if ( v10 > (__int64)(v34 - v33) >> 3 )
  {
    sub_1800F6100((__int64 *)&v33, v10);
    v11 = v33;
  }
  v12 = v8[1];
  v13 = *v8;
  if ( *v8 != v12 )
  {
    do
    {
      ...
      if ( v38 == *((_QWORD *)&v37 + 1) )
      {
        sub_1800FB0BC((__int64 *)&v37, *((__int64 *)&v37 + 1), v14);
      }
      else
      {
      ...
      if ( v34 == *((_QWORD *)&v33 + 1) )
      {
        sub_1800FAF8C((__int64 *)&v33, *((char **)&v33 + 1), v16);
      }
      else
      {
        **((_QWORD **)&v33 + 1) = *v16;
  ...
  if ( a5 )
  {
    ...
    if ( v23 )
    {
      do
      {
        ...
        if ( v36 == v24 )
        {
          sub_1800FB0BC((__int64 *)&v35, v24, v25);
          v24 = *((_QWORD *)&v35 + 1);
        }
        else
        {
  ...
  return sub_1800F6218((__int64 *)&v37);
}
