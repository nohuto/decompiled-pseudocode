/*
 * XREFs of sub_1800F9F20 @ 0x1800F9F20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_18009D3E0 @ 0x18009D3E0 (sub_18009D3E0.c)
...
__int64 __fastcall sub_1800F9F20(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, _QWORD *a5)
{
  __int64 v9; // rcx
  __int64 v10; // rcx
  __int64 *v11; // r15
  ...
  *((_QWORD *)&v32 + 1) = v9;
  sub_1800B1E40(*(_QWORD *)(a1 + 24), (__int64 *)&v32);
  *(_OWORD *)v41 = 0LL;
  sub_1800B1C18(*(_QWORD *)(a1 + 24), v41);
  ...
  *((_QWORD *)&v33 + 1) = v10;
  v11 = (__int64 *)(a1 + 72);
  sub_18009D428(*(_QWORD *)(a1 + 72), &v33);
  sub_180092874(*(_QWORD *)(a1 + 248), -1LL, 0);
  sub_180092894(*(_QWORD **)(a1 + 248), 0, 0, 2);
  v39[0] = *a5;
  v39[1] = a5[1];
  *a5 = 0LL;
  a5[1] = 0LL;
  sub_1800F597C(*(_QWORD *)(a1 + 200), &qword_1802141B8, v39);
  v34 = 0LL;
  v12 = *(_QWORD *)(a1 + 48);
  if ( v12 )
  {
  ...
  *((_QWORD *)&v34 + 1) = v12;
  sub_1800F5BE8(*(_QWORD *)(a1 + 200), (__int64)&qword_1802141B8, &v34);
  v38 = 15LL;
  v37[2] = 13LL;
...
LABEL_48:
  ...
  *a4 = 0LL;
  a4[1] = 0LL;
  sub_1800F597C(*(_QWORD *)(a1 + 200), &qword_1802141B8, v40);
  sub_18009272C(*(_QWORD *)(a1 + 248), (__int64)&qword_180214058, 1);
  *(_BYTE *)(*(_QWORD *)(a1 + 24) + 465LL) &= 0xF8u;
  v19 = sub_1800703D4(a2);
  v20 = sub_18007AB84(v19, 1);
  v21 = (*(__int64 (__fastcall **)(__int64, void *, __int64))(*(_QWORD *)v20 + 72LL))(v20, &unk_180211148, 14LL);
  v22 = (_QWORD **)sub_18009B3A0(*v11, (__int64)v48);
  sub_180092894(*v22, v21, 0, 2);
  v23 = v49;
  if ( v49 )
  {
  ...
  v53 = (__m128i)_mm_mul_ps(_mm_shuffle_ps(v18, v18, 0), (__m128)xmmword_180214C78);
  v42[0] = v53.m128i_i64[0];
  v42[1] = _mm_srli_si128(v53, 8).m128i_u64[0];
  sub_18009D3E0((_DWORD *)*v11, v42);
  si128 = _mm_load_si128((const __m128i *)&xmmword_180140550);
  LOBYTE(v44[0]) = 0;
  sub_18000FC14(v44, 0x13uLL, 0LL, "Bloom Scene Overlay");
  v24 = *(_QWORD *)(a1 + 24);
  v36 = 0LL;
  v25 = *(_QWORD *)(a2 + 16);
  if ( !v25 )
...
LABEL_49:
  ...
  v50 = xmmword_180214C78;
  sub_18009D3E0((_DWORD *)*v11, &v50);
  v43 = 0LL;
  result = sub_1800F597C(*(_QWORD *)(a1 + 200), &qword_1802141B8, &v43);
