/*
 * XREFs of sub_1800D4520 @ 0x1800D4520
 * Callers:
...
__int64 __fastcall sub_1800D4520(_QWORD *a1, __int64 a2, char a3, int *a4, _QWORD *a5)
{
  _QWORD *v9; // rdx
  _QWORD *v10; // r9
  __int64 *v11; // rax
  ...
  try
  {
    ...
    if ( v12 )
    {
      if ( v10 == (_QWORD *)*v9 )
      {
        *(_QWORD *)a2 = *sub_1800D3C70(a1, &v22, 1, v10, (int)a4, a5);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      if ( *((_BYTE *)v10 + 25) )
...
LABEL_25:
    ...
    {
      *(_QWORD *)a2 = *sub_1800D3C70(a1, v23, v12, v10, (int)a4, a5);
      *(_BYTE *)(a2 + 8) = 1;
      result = a2;
    }
  }
