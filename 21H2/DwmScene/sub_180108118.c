/*
 * XREFs of sub_180108118 @ 0x180108118
 * Callers:
 *     sub_1801090C0 @ 0x1801090C0 (sub_1801090C0.c)
 * Callees:
 *     sub_180107C00 @ 0x180107C00 (sub_180107C00.c)
 *     memcmp @ 0x18012398E (memcmp.c)
 */

__int64 __fastcall sub_180108118(_QWORD *a1, __int64 a2, char a3, size_t *a4, _QWORD *a5)
{
  _QWORD *v8; // r13
  __int64 *v9; // rbx
  ...
  try
  {
    *(_QWORD *)a2 = *sub_180107C00(a1, &v26, v10, v8, (int)a4, v26);
    *(_BYTE *)(a2 + 8) = 1;
    result = a2;
  }
  catch ( ... )
  {
    sub_180109C3C(v28, v27);
    throw;
  }
  return result;
}
