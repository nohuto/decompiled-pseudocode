/*
 * XREFs of sub_180011A60 @ 0x180011A60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180011A60(__int64 a1, _OWORD *a2)
{
  __int64 v4; // rbx
  __int64 v5; // rdx
  __int64 v6; // rbx
...
LABEL_3:
  ...
  v14[2] = v8;
  v14[3] = v9;
  if ( (unsigned __int8)sub_180088444(*(_QWORD *)(a1 + 16), v14) )
  {
    v10 = 0;
  }
  else
  {
    v10 = -2147024809;
    sub_18000DD78(retaddr, 232, (__int64)"SpectreLightNode.cpp", 0x80070057);
  }
  if ( BYTE8(v15) )
    sub_180067304(v15);
  return v10;
