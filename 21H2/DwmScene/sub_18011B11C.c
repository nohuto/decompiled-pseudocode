/*
 * XREFs of sub_18011B11C @ 0x18011B11C
 * Callers:
...
__int64 __fastcall sub_18011B11C(__int64 a1, _BYTE *a2, unsigned int a3)
{
  unsigned int v5; // ecx
  unsigned int v6; // eax
  int v7; // r8d
  ...
  *(_QWORD *)(a1 + 16) = a2;
  *(_DWORD *)a1 = dword_180214E08;
  *(_DWORD *)(a1 + 4) = dword_180214E28;
  *(_DWORD *)(a1 + 8) = dword_180214E48;
  v5 = HIBYTE(a3) & 0xF;
  if ( !v5 )
    v5 = *(_DWORD *)a1;
  *(_DWORD *)a1 = v5;
  ...
  *(_DWORD *)(a1 + 8) = v7;
  *(_DWORD *)(a1 + 12) = 6;
  v8 = (struct _Mtx_internal_imp_t *)sub_18011B344();
  v16 = v8;
  v9 = Mtx_lock(v8);
  if ( v9 )
  {
LABEL_18:
  ...
  LOBYTE(v14[0]) = 0;
  unknown_libname_100(v14, a2);
  v10 = (__int64 *)sub_18011B2BC();
  sub_18011AFEC(v10, (__int64)v17, (size_t *)v14);
