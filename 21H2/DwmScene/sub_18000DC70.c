/*
 * XREFs of sub_18000DC70 @ 0x18000DC70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18000DC70(char *a1, __int64 a2, _BYTE *a3)
{
  __int64 result; // rax
  ...
  if ( a1 )
    *(_WORD *)a1 = 0;
  *a3 = 0;
  if ( !qword_18021F538 || (result = qword_18021F538(), (int)result >= 0) )
  {
    if ( !qword_18021F548 )
    {
      if ( qword_18021F4A0 )
      ...
      catch ( const wil::ResultException *v19 )
      {
        *a3 = 1;
        v7 = v19;
        if ( a1 )
          sub_18000CA8C(a1, a2, (__int64)v19 + 24);
      ...
      catch ( const wil::ResultException *v20 )
      {
        ...
        **((_BYTE **)v15 + 16) = 1;
        ...
        v10 = *((_QWORD *)v15 + 5);
        if ( v9 )
          sub_18000CA8C(v9, *((_QWORD *)v8 + 15), v10 + 24);
    ...
    return qword_18021F548(a1, a2, a3);
  }
  return result;
}
