/*
 * XREFs of sub_18007A10C @ 0x18007A10C
 * Callers:
...
unsigned __int64 __fastcall sub_18007A10C(_QWORD *a1, __int64 *a2)
{
  ...
  v18 = a2;
  v25 = 0LL;
  sub_180066E84((__int64)(a1 + 1), (__int64)&v25);
  v24 = 0LL;
  sub_180066E84((__int64)(a1 + 138), (__int64)&v24);
  v23 = 0LL;
  sub_180066E84(*a2 + 24, (__int64)&v23);
  v4 = sub_18007040C(*a2);
  v5 = (const char *)sub_180024850(v19);
  if ( *((_QWORD *)v5 + 3) >= 0x10uLL )
    v5 = *(const char **)v5;
  sub_18011BCAC(&unk_18020F648, 3LL, "Engine::DetachDevice() -- detaching device id %u -- %s", v4, v5);
  if ( v20 >= 0x10 )
  {
    v6 = v19[0];
    if ( v20 + 1 >= 0x1000 )
  ...
  *((_QWORD *)&v17 + 1) = v7;
  ...
  if ( v10 != v11 )
  {
    ...
    {
      v22 = 0LL;
      sub_180066E84(*v10 + 16, (__int64)&v22);
      sub_180071D90(*v10, (__int64)v26);
      if ( BYTE8(v22) )
        sub_180067304(v22);
      v10 += 2;
    }
  ...
  if ( BYTE8(v23) )
    result = sub_180067304(v23);
  if ( BYTE8(v24) )
    result = sub_180067304(v24);
  if ( BYTE8(v25) )
    result = sub_180067304(v25);
