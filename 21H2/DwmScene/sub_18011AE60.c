/*
 * XREFs of sub_18011AE60 @ 0x18011AE60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18011AE60(void *a1, void **a2, void **a3)
{
  void *v3; // rbx
  _QWORD *v4; // rax
  __int64 v5; // rcx
  ...
  try
  {
    ...
    *(_QWORD *)&v8 = v4;
    ...
    if ( v4 )
    {
      *(_OWORD *)v4 = 0LL;
      v4[2] = 0LL;
      v5 = sub_18011B11C(v4, *(_QWORD *)(*(_QWORD *)v3 + 8LL), *(unsigned int *)(*(_QWORD *)v3 + 16LL));
    }
    **(_QWORD **)v3 = v5;
    result = 1LL;
  }
