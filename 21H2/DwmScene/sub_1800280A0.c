/*
 * XREFs of sub_1800280A0 @ 0x1800280A0
 * Callers:
 *     sub_18002C270 @ 0x18002C270 (sub_18002C270.c)
 * Callees:
...
_QWORD *__fastcall sub_1800280A0(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_1800271B0((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
