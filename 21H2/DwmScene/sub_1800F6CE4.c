/*
 * XREFs of sub_1800F6CE4 @ 0x1800F6CE4
 * Callers:
 *     sub_1800AB190 @ 0x1800AB190 (sub_1800AB190.c)
 * Callees:
...
__int64 __fastcall sub_1800F6CE4(__int64 a1)
{
  ...
  `eh vector destructor iterator'((void *)(a1 + 496), 0x10uLL, 0xAuLL, (void (*)(void *))unknown_libname_98);
  sub_1800258BC((__int64 *)(a1 + 480), a1 + 480);
  `eh vector destructor iterator'((void *)(a1 + 384), 0x10uLL, 6uLL, (void (*)(void *))unknown_libname_98);
  ...
  result = sub_1800D27A4((__int64 **)(a1 + 144));
