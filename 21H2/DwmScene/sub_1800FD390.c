/*
 * XREFs of sub_1800FD390 @ 0x1800FD390
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall sub_1800FD390(__int64 a1, __int64 a2)
{
  __int64 v4; // rdi
  bool result; // al

  result = 0;
  if ( sub_1800AF1E0(a1, a2) )
  {
    v4 = _RTDynamicCast(
           a2,
           0LL,
           ...
           1);
    if ( !sub_180083E14((unsigned __int64 *)(v4 + 1800), (unsigned __int64 *)(a1 + 1800))
