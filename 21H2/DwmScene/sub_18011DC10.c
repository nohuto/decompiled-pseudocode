...
__int64 __fastcall sub_18011DC10(__int64 a1, _QWORD *a2, _DWORD *a3)
{
...
LABEL_27:
  ...
  if ( (unsigned __int8)sub_1801225A8(v9 + 64, v10) )
  {
    ...
    v13 = (Concurrency::details::WorkItem *)sub_180122450(v9 + 64, v19);
    if ( (unsigned __int8)sub_180122630(v13) )
    {
      ...
      if ( (unsigned __int8)sub_1801225A8(v13, v14)
        && (v20[2] = 0LL,
            ...
            v15 = (Concurrency::details::WorkItem *)sub_180122450(v13, v20),
            Concurrency::details::WorkItem::IsContext(v15)) )
      {
        *a3 = sub_1801224B4(v15);
        v11 = 0;
      }
      else
      {
