/*
 * XREFs of sub_1800BDA6C @ 0x1800BDA6C
 * Callers:
 *     sub_1800BDAFC @ 0x1800BDAFC (sub_1800BDAFC.c)
...
__int64 __fastcall sub_1800BDA6C(_QWORD *a1)
{
  __int64 v2; // rcx
