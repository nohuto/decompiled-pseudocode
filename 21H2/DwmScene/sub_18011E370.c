 ...
 *     sub_18012244C @ 0x18012244C (sub_18012244C.c)
 *     sub_180122450 @ 0x180122450 (sub_180122450.c)
 *     sub_1801225A8 @ 0x1801225A8 (sub_1801225A8.c)
 *     sub_180122618 @ 0x180122618 (sub_180122618.c)
...
__int64 __fastcall sub_18011E370(__int64 a1, _QWORD *a2, _BYTE *a3)
{
...
LABEL_27:
  ...
  if ( (unsigned __int8)sub_1801225A8(v9 + 64, v10) )
  {
    v19[2] = 0LL;
    v19[3] = 0LL;
    sub_18001277C(v19, (__int64)a2);
    v13 = sub_180122450(v9 + 64, v19);
    if ( (unsigned __int8)sub_180122630(v13) )
    {
      ...
      if ( (unsigned __int8)sub_1801225A8(v13, v14)
        && (v20[2] = 0LL,
            v20[3] = 0LL,
            sub_18001277C(v20, (__int64)v24),
            v15 = sub_180122450(v13, v20),
            (unsigned __int8)sub_180122618(v15)) )
      {
        *a3 = sub_18012244C(v15);
        v11 = 0;
      }
      else
      {
    ...
    else if ( (unsigned __int8)sub_180122618(v13) )
    {
      *a3 = *(_BYTE *)(v13 + 60);
      v11 = 0;
    }
  ...
  {
    v23 = 0LL;
    sub_18008D440(a1, &v23);
    if ( (_QWORD)v23 )
      v11 = sub_18011E370(v23, a2, a3);
    else
      v11 = 2;
