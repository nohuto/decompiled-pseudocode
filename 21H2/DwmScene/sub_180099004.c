/*
 * XREFs of sub_180099004 @ 0x180099004
 * Callers:
...
__int64 __fastcall sub_180099004(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  __int64 *v5; // rax
  unsigned int v6; // eax
  ...
  if ( *(_BYTE *)(a1 + 310) )
  {
    ...
    sub_1800D1210((unsigned int)pExceptionObject, v6, 604, (unsigned int)v8, 0);
  ...
  if ( !a2 )
  {
    sub_18000FE28(v7);
    v5 = sub_18000FE28(v8);
    sub_180096C40(pExceptionObject, v5, 609, (__int64)v7, 0);
    throw (Spectre::Engine::EngineInvalidPointerException *)pExceptionObject;
  }
  LOBYTE(a4) = a3;
  return sub_1800990D0(a1, a2, *(unsigned int *)(a1 + 120), a4);
}
