/*
 * XREFs of sub_1800464F0 @ 0x1800464F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800464F0(_QWORD *a1, __int64 a2)
{
  __int64 v3; // r8
  __int64 v4; // rbx
  __int64 *v5; // rax
  ...
  if ( v3 )
  {
    while ( 1 )
    {
      ...
      if ( v10 == _InterlockedCompareExchange((volatile signed __int32 *)(v3 + 8), v10 + 1, v10) )
      {
        v4 = a1[10];
        *((_QWORD *)&v11 + 1) = v4;
        v5 = (__int64 *)sub_180049068((unsigned int)&v12, (unsigned int)"VertexBuffer", a1[9], a1[12], a2, 1);
        goto LABEL_3;
      }
    }
  }
  v4 = 0LL;
  v5 = (__int64 *)sub_180049068((unsigned int)&v12, (unsigned int)"VertexBuffer", 0, a1[12], a2, 1);
LABEL_3:
  v6 = 0LL;
  if ( &v13 != v5 )
  {
  ...
  return sub_180068114(a1, *(unsigned int *)(a1[12] + 12LL), 5LL);
}
