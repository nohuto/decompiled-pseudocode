/*
 * XREFs of sub_1800CF64C @ 0x1800CF64C
 * Callers:
...
__int64 __fastcall sub_1800CF64C(__int64 *a1, __int64 a2, unsigned int *a3)
{
  __int64 v4; // r8
  __int64 v6; // rax
  unsigned int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_1800383F0(a1, v10, (__int64 *)v4, (__int64)&unk_1801D8F88, &v11);
    *(_BYTE *)(a2 + 8) = 1;
    *(_QWORD *)a2 = *v8;
  }
  else
