/*
 * XREFs of sub_1800A35B0 @ 0x1800A35B0
 * Callers:
...
__int64 __fastcall sub_1800A35B0(__int64 **a1, __int64 a2, char a3, unsigned __int64 *a4, _QWORD *a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rsi
  __int64 v10; // rax
  ...
  {
    sub_18003DF14((__int64)v17, (__int64)v16);
    throw;
  }
  return result;
}
