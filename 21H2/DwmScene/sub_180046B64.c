/*
 * XREFs of sub_180046B64 @ 0x180046B64
 * Callers:
 ...
 *     sub_1800D2588 @ 0x1800D2588 (sub_1800D2588.c)
 *     __security_check_cookie @ 0x180123FC0 (__security_check_cookie.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall sub_180046B64(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v6; // esi
  int v7; // eax
  int v8; // eax
  ...
  if ( (a2 & 1) != 0 )
  {
    v7 = dword_1801443E0[(int)sub_1800D2588(a2, 32LL) + ((a2 & 0x10000) != 0 ? 18LL : 12LL)];
    v6 = 1;
    *(_QWORD *)a3 = "POSITION";
    *(_DWORD *)(a3 + 8) = 0;
    *(_DWORD *)(a3 + 12) = v7;
  ...
  if ( (a2 & 2) != 0 )
  {
    v8 = dword_1801443E0[(int)sub_1800D2588(a2, 35LL) + ((a2 & 0x20000) != 0 ? 18LL : 12LL)];
    v9 = v6++;
    v9 *= 32LL;
  ...
  if ( (a2 & 4) != 0 )
  {
    v10 = dword_1801443E0[(int)sub_1800D2588(a2, 41LL) + ((a2 & 0x80000) != 0 ? 18LL : 12LL)];
    v11 = v6++;
    v11 *= 32LL;
  ...
  if ( (a2 & 8) != 0 )
  {
    v12 = dword_1801443E0[(int)sub_1800D2588(a2, 44LL) + 12];
    v13 = v6++;
    v13 *= 32LL;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v14 = dword_1801443E0[(int)sub_1800D2588(a2, 38LL) + ((a2 & 0x40000) != 0 ? 18LL : 12LL)];
    v15 = v6++;
    v15 *= 32LL;
  ...
  if ( (a2 & 0x20) != 0 )
  {
    v17 = dword_1801443E0[(int)sub_1800D2588(a2, 47LL)
                        + 6
  ...
  if ( (a2 & 0x40) != 0 )
  {
    v19 = dword_1801443E0[(int)sub_1800D2588(a2, 50LL) + (v16 != 0 ? 18LL : 6LL)];
    v20 = v6++;
    v20 *= 32LL;
  ...
  if ( (a2 & 0x200) != 0 )
  {
    v23 = dword_1801443E0[(int)sub_1800D2588(a2, 53LL) + 18];
    v24 = v6++;
    v24 *= 32LL;
  ...
  if ( (a2 & 0x400) != 0 )
  {
    v25 = dword_1801443E0[(int)sub_1800D2588(a2, 56LL) + 18];
    v26 = v6++;
    v26 *= 32LL;
