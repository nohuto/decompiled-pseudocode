/*
 * XREFs of sub_1800D1A04 @ 0x1800D1A04
 * Callers:
...
__int64 __fastcall sub_1800D1A04(__int64 *a1, __int64 a2, unsigned int *a3)
{
  __int64 v4; // r8
  __int64 v6; // rax
  unsigned int v7; // edx
...
LABEL_10:
    v11 = a3;
    v8 = sub_1800383F0(a1, v10, (__int64 *)v4, (__int64)&unk_1801D9300, &v11);
    *(_BYTE *)(a2 + 8) = 1;
    *(_QWORD *)a2 = *v8;
  }
  else
