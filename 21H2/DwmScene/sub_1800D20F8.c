/*
 * XREFs of sub_1800D20F8 @ 0x1800D20F8
 * Callers:
...
__int64 __fastcall sub_1800D20F8(__int64 a1, __int64 *a2)
{
  __int64 v4; // r8
  ...
  if ( *(_QWORD *)(a1 + 152) && (*(_DWORD *)(a1 + 152) != 1 || *(_DWORD *)(*(_QWORD *)*v6 + 32LL) != v5) )
  {
    ...
    if ( v8 )
    {
      if ( v8 != 1 )
        goto LABEL_19;
      v9 = sub_1800D1544((__int64 *)(a1 + 112), (_QWORD *)(v4 + 112));
    }
    else
    {
...
LABEL_19:
    sub_18000FE28(v19);
    v15 = sub_18000FE28(v18);
    sub_1800D1210(pExceptionObject, v15, 177LL, (__int64)v19, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
LABEL_10:
  v21 = v5;
  sub_1800D1A04(v6, (__int64)&v16, &v21);
  result = (__int64)std::shared_ptr<__ExceptionPtr>::operator=((_QWORD *)(v16 + 40), a2);
  if ( v7 )
  {
    v22[0] = v5;
    sub_1800D1A04(v6, (__int64)&v17, v22);
    v11 = *(_QWORD *)(v17 + 40);
    *(_DWORD *)(a1 + 96) = *(_DWORD *)(v11 + 96);
    *(_QWORD *)(a1 + 104) = *(_QWORD *)(v11 + 104);
    if ( a1 + 112 != v11 + 112 )
      sub_1800D1880((__int64 *)(a1 + 112), *(char **)(v11 + 112), *(char **)(v11 + 120));
