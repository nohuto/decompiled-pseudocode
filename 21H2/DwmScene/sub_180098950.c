/*
 * XREFs of sub_180098950 @ 0x180098950
 * Callers:
...
__int64 __fastcall sub_180098950(__int64 a1, __int64 a2)
{
  __int64 *v3; // rax
  unsigned int v4; // eax
  ...
  if ( *(_BYTE *)(a1 + 310) )
  {
    ...
    sub_1800D1210((unsigned int)pExceptionObject, v4, 743, (unsigned int)v6, 0);
  ...
  if ( !a2 )
  {
    sub_18000FE28(v5);
    v3 = sub_18000FE28(v6);
    sub_180096C40(pExceptionObject, v3, 748, (__int64)v5, 0);
    throw (Spectre::Engine::EngineInvalidPointerException *)pExceptionObject;
  }
  return sub_180098B24(a1, a2, *(unsigned int *)(a1 + 112));
}
