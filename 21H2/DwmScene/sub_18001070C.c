/*
 * XREFs of sub_18001070C @ 0x18001070C
 * Callers:
...
__int64 __fastcall sub_18001070C(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4)
{
  unsigned int v8; // eax
  unsigned int v9; // ecx
  ...
  unsigned int v24; // [rsp+60h] [rbp-39h]
  __int128 v25; // [rsp+68h] [rbp-31h]
  __int128 v26; // [rsp+78h] [rbp-21h] BYREF
  _DWORD v27[12]; // [rsp+88h] [rbp-11h] BYREF
