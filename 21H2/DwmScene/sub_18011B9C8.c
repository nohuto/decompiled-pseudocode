/*
 * XREFs of sub_18011B9C8 @ 0x18011B9C8
 * Callers:
...
void __fastcall sub_18011B9C8(__int64 a1, int a2, int a3, __int64 a4)
{
  __int64 v4; // rsi
  int v6; // r13d
  size_t v7; // rbx
  ...
  v4 = a2;
  if ( dword_180221EB8 <= 0 )
  {
    v17 = *(_DWORD *)(a1 + 8);
    v6 = *(_DWORD *)(a1 + 4);
    v18 = *(_DWORD *)a1;
    v7 = -1LL;
    sub_180125188((unsigned int)v28, 2048, -1, a3, a4);
    v8 = sub_18011B3BC(a1, v25);
    v9 = sub_18011B4F0(&v23);
    if ( (unsigned __int64)v8[3] >= 0x10 )
      v8 = (__int64 *)*v8;
    v10 = (&off_180214D50)[3 * v4];
    ...
    if ( (int)v4 >= v6 )
    {
      ...
      LOBYTE(v21[0]) = 0;
      unknown_libname_100(v21, *(_BYTE **)(a1 + 16));
      sub_18011B768((__int64)v21, v4, (__int64)v19);
