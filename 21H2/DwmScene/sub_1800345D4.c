/*
 * XREFs of sub_1800345D4 @ 0x1800345D4
 * Callers:
...
char __fastcall sub_1800345D4(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rax
  int v7; // ecx
  ...
  {
    sub_18000FE28(v75);
    v61 = (unsigned int)sub_18000FE28(v74);
    sub_1800D1210((unsigned int)v82, v61, 552, (unsigned int)v75, 0);
    throw (Spectre::Engine::EngineException *)v82;
  }
  v6 = sub_1800341F0((__int64)v85, a2, *(_DWORD *)(a3 + 48));
  v86 = *(_OWORD *)v6;
  v87 = *(_OWORD *)(v6 + 16);
  v88 = *(_QWORD *)(v6 + 32);
  v89 = *(_DWORD *)(v6 + 40);
      ...
      if ( v7 )
      {
        ...
        do
        {
          ...
          else
          {
            ...
            {
              sub_18000FE28(v77);
              v62 = (unsigned int)sub_18000FE28(v76);
              sub_1800D1210((unsigned int)v83, v62, 587, (unsigned int)v77, 0);
            ...
            if ( v21 && (v22 = *(_QWORD *)(a3 + 8)) != 0 )
              ...
              v23 = 0LL;
            *(_QWORD *)&v67 = v23;
            DWORD2(v67) = sub_18003659C(*(unsigned int *)(a2 + 16), v19);
            v16 = sub_18003663C(*(unsigned int *)(a2 + 16), (unsigned int)v65, (unsigned int)v64, 0LL);
          }
          HIDWORD(v67) = v16;
          if ( v92 == *((_QWORD *)&v91 + 1) )
          {
            sub_1800332F0((const void **)&v91, *((_BYTE **)&v91 + 1), &v67);
          }
          else
          {
            **((_OWORD **)&v91 + 1) = v67;
  ...
  *((_QWORD *)&v72 + 1) = v25;
  ...
  v31 = v29 * v28;
  *(_QWORD *)(a1 + 200) = v31;
  sub_180068114(a1, v31, (*(_DWORD *)(a2 + 20) & 6) != 0 ? 3 : 11);
  v90 = 0LL;
  v32 = v91;
  if ( (_QWORD)v91 == *((_QWORD *)&v91 + 1) )
    v32 = 0LL;
  v33 = *sub_180029F64(v24, &v65);
  v34 = v90;
  if ( v90 )
  {
    v90 = 0LL;
  ...
  sub_18002BE74(v24, v35);
  if ( v35 < 0 )
  {
    sub_18000FE28(v93);
    v54 = unknown_libname_106(v93, " File=");
    unknown_libname_106(v54, "..\\Source\\TextureD3D11.cpp");
    v55 = unknown_libname_106(v93, " Line=");
    unknown_libname_106(v55, "626");
    v56 = unknown_libname_106(v93, " Message=");
    unknown_libname_106(v56, "\"TextureD3D11::CreateRendererResources2D(): unable to create texture(2D)\"");
    sub_180036BB8(v78, &v86, &v91);
    v57 = unknown_libname_106(v93, " Details=\"");
    v58 = (_QWORD *)unknown_libname_105(v57);
    unknown_libname_106(v58, "\"");
    std::string::_Tidy_deallocate(v78);
    sub_18002C814(v79, v35);
    v59 = unknown_libname_106(v93, " HRESULT=");
    unknown_libname_105(v59);
    std::string::_Tidy_deallocate(v79);
    std::string::data(v93);
    sub_18000FE28(v81);
    v60 = (unsigned int)sub_18000FE28(v80);
    sub_1800D12B8((unsigned int)pExceptionObject, v60, 626, v35, (__int64)v81, 0);
    throw (Spectre::Engine::EngineException *)pExceptionObject;
  }
  v37 = (__int64 *)sub_180035404(a1, (unsigned int)&v64, v90, *(_DWORD *)(a2 + 20), DWORD2(v86));
  v38 = 0LL;
  if ( &v66 != v37 )
  {
    v38 = *v37;
  ...
  *(_QWORD *)(a1 + 168) = v41;
  ...
  v68 = (__int64)v43;
  if ( v43 )
    v44 = sub_1800337B4((__int64)v43, a2, SDWORD2(v86), SDWORD1(v87));
  else
    v44 = 0LL;
  v45 = (_QWORD *)v44;
  v68 = v44;
