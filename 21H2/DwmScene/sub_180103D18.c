/*
 * XREFs of sub_180103D18 @ 0x180103D18
 * Callers:
 *     sub_180105BD0 @ 0x180105BD0 (sub_180105BD0.c)
 * Callees:
...
__m128 *__fastcall sub_180103D18(__int64 a1, __m128 *a2, __m128 *a3)
{
  int v3; // edi
  __m128 v5; // xmm1
  int *v6; // r14
  ...
  *a3 = _mm_mul_ps(
          ...
          _mm_min_ps(_mm_max_ps(v5, (__m128)xmmword_18013FB90), (__m128)xmmword_18013FB80));
  ...
  *a2 = (__m128)xmmword_180214CE0;
  ...
  do
  {
    ...
    sub_180105880(a1, &X, ((v13 & 4) != 0 ? v3 * v3 : 0) + v16 + ((v13 & 2) != 0 ? v3 : 0) + (v14 & 1));
    ++v13;
    ++v14;
