/*
 * XREFs of sub_180067614 @ 0x180067614
 * Callers:
...
_QWORD *__fastcall sub_180067614(_QWORD *a1, _QWORD *a2, __int64 *a3, unsigned int *a4, _QWORD *a5)
{
  __int64 **v9; // rdi
  _QWORD *result; // rax
  __int64 *v11; // r9
  ...
  if ( a1[1] )
  {
    ...
    {
LABEL_30:
      *a2 = *(_QWORD *)sub_1800677FC((_DWORD)a1, (unsigned int)&v21, 0, (_DWORD)a4, (__int64)a5);
      return a2;
    }
    if ( v15 )
