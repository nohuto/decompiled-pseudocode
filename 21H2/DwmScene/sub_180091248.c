/*
 * XREFs of sub_180091248 @ 0x180091248
 * Callers:
...
__int64 __fastcall sub_180091248(__int64 **a1, __int64 a2, char a3, unsigned __int16 *a4, _QWORD *a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rsi
  __int64 v10; // rax
  ...
  {
    sub_180068230((__int64)v17, (__int64)v16);
    throw;
  }
  return result;
}
