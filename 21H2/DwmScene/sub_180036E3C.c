/*
 * XREFs of sub_180036E3C @ 0x180036E3C
 * Callers:
...
__int64 __fastcall sub_180036E3C(_QWORD *a1, int a2)
{
  bool v4; // r14
  __int64 v5; // rcx
  __int64 *v6; // rdi
  ...
  if ( v5 )
  {
    ...
    v7 = sub_180032F30(&v24, a2, 0, v27, &v25);
  }
  else
  {
    v12 = a1[22];
    ...
    v7 = sub_180033110(&v24, a2, v26, 1u, &v25);
  }
  if ( v6 != v7 )
  {
    v8 = *v7;
...
LABEL_23:
  ...
  if ( v14 && *v14 )
  {
    v15 = sub_1800A0720(a1);
    v16 = sub_1800A06AC(a1);
    v17 = sub_1800A0690(a1);
    v18 = sub_1800D1368(&v25, v17);
    if ( a1 + 15 != (_QWORD *)v18 )
      sub_180020E1C(a1 + 15, v18);
    if ( v28 >= 0x10 )
    {
      v19 = v25;
      if ( v28 + 1 >= 0x1000 )
...
LABEL_39:
  ...
  {
    v20 = sub_1800D1368(&v25, 0LL);
    if ( a1 + 15 != (_QWORD *)v20 )
      sub_180020E1C(a1 + 15, v20);
    if ( v28 >= 0x10 )
    {
      v19 = v25;
      if ( v28 + 1 >= 0x1000 )
  ...
  return sub_1800A073C(a1, _mm_unpacklo_ps(v21, v22).m128_u64[0]);
}
