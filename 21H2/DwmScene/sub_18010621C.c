/*
 * XREFs of sub_18010621C @ 0x18010621C
 * Callers:
...
unsigned __int8 __fastcall sub_18010621C(
        float *a1,
        float *a2,
        float *a3,
        __int64 a4,
        ...
        char a8)
{
  ...
  if ( a2 != a3 )
  {
    ...
    if ( a1 != a2 )
    {
      ...
      {
        if ( v14 > a7 )
          return sub_180105F74(v11, (__int64)a2, v13, a4, v14, a6, a7, a8);
        else
          return sub_180106A98(v11);
      }
      else
      {
        return sub_180106958(v11, a2, v13, a6, a8);
      }
    }
  }
  return result;
