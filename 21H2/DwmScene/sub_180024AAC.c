/*
 * XREFs of sub_180024AAC @ 0x180024AAC
 * Callers:
...
int __fastcall sub_180024AAC(__int64 a1)
{
...
LABEL_6:
    ...
    JUMPOUT(0x180024B98LL);
  }
  v9 = _std_type_info_hash(&qword_180216D50);
  sub_18002660C(a1, v6, &v9);
  v7[0] = &std::_Func_impl_no_alloc<_lambda_70a7c175e000a2384906e3376e592082_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v8 = v7;
