/*
 * XREFs of sub_1800CDBE4 @ 0x1800CDBE4
 * Callers:
 *     sub_1800CF030 @ 0x1800CF030 (sub_1800CF030.c)
 * Callees:
...
_OWORD *__fastcall sub_1800CDBE4(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
