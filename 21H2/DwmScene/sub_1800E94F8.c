/*
 * XREFs of sub_1800E94F8 @ 0x1800E94F8
 * Callers:
...
__int64 __fastcall sub_1800E94F8(_QWORD *a1, _DWORD *a2, _DWORD *a3, __int64 a4, __int64 *a5, __int64 *a6)
{
  __int64 v8; // rbx
  ...
  *(_DWORD *)v16 = *a3;
  ...
  try
  {
    ...
    v21 = v27;
LABEL_10:
    sub_1800E9B38(a1, v15, v32 + 1, v13);
    result = v21 + *a1;
  }
  catch ( ... )
  {
    sub_180080DEC((__int64)a1, v28, v16 + 7);
    sub_1800814CC((__int64)a1, v33, v13);
    throw;
  }
  return result;
}
