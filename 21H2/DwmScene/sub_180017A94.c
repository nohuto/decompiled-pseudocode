/*
 * XREFs of sub_180017A94 @ 0x180017A94
 * Callers:
...
void __fastcall sub_180017A94(struct _TP_TIMER **a1, _BYTE *a2, void *a3)
{
  ...
  _FILETIME pftDueTime; // [rsp+20h] [rbp-38h] BYREF
  ...
  if ( !*a2 )
  {
    ...
    ThreadpoolTimer = CreateThreadpoolTimer((PTP_TIMER_CALLBACK)pfnti, a3, 0LL);
    v9 = *a1;
    v10 = ThreadpoolTimer;
    if ( *a1 )
    {
