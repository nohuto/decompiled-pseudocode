/*
 * XREFs of sub_1800BA07C @ 0x1800BA07C
 * Callers:
 ...
 *     sub_1800BD028 @ 0x1800BD028 (sub_1800BD028.c)
...
_QWORD *__fastcall sub_1800BA07C(__int64 a1, _QWORD *a2)
{
  __int64 v4; // r14
  __int64 v5; // rcx
  __int64 v6; // rbx
