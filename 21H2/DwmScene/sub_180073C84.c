/*
 * XREFs of sub_180073C84 @ 0x180073C84
 * Callers:
 *     sub_180076D60 @ 0x180076D60 (sub_180076D60.c)
 * Callees:
 *     sub_180027CD0 @ 0x180027CD0 (sub_180027CD0.c)
 *     sub_180072C7C @ 0x180072C7C (sub_180072C7C.c)
 *     sub_180074B90 @ 0x180074B90 (sub_180074B90.c)
 *     memcmp @ 0x18012398E (memcmp.c)
 */

_QWORD *__fastcall sub_180073C84(__int64 **a1, _QWORD *a2, __int64 *a3, size_t *a4, _QWORD *a5)
{
  __int64 v9; // r12
  __int64 *v10; // rax
  const void *v11; // rdx
  ...
  if ( a1[1] )
  {
    if ( a3 == (__int64 *)*v10 )
    {
      ...
      if ( v16 < 0 )
      {
        sub_180072C7C(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
      goto LABEL_90;
    }
    if ( a3 == v10 )
    {
      ...
      if ( v24 < 0 )
      {
        sub_180072C7C(a1, a2, 0, v49, (int)a4, a5);
        return a2;
      }
      goto LABEL_91;
    }
    ...
    if ( v31 < 0 )
    {
      ...
      {
        if ( *(_BYTE *)(v32[2] + 25) )
          sub_180072C7C(a1, a2, 0, v32, (int)a4, a5);
        else
          sub_180072C7C(a1, a2, 1, a3, (int)a4, a5);
        return a2;
      }
...
LABEL_90:
        v9 = (__int64)a5;
LABEL_91:
        *a2 = *(_QWORD *)sub_180074B90((_DWORD)a1, (unsigned int)&v53, 0, (_DWORD)a4, v9);
        return a2;
      }
    }
    if ( v48 )
      sub_180072C7C(a1, a2, 0, a3, (int)a4, a5);
    else
      sub_180072C7C(a1, a2, 1, (_QWORD *)v40, (int)a4, a5);
    return a2;
  }
  else
  {
    try
    {
      sub_180072C7C(a1, a2, 1, v10, (int)a4, a5);
      result = a2;
    }
    catch ( ... )
    {
      sub_180080E20(v53, v52);
      throw;
    }
  }
  return result;
