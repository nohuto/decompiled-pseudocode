/*
 * XREFs of sub_1800B2FD8 @ 0x1800B2FD8
 * Callers:
...
char __fastcall sub_1800B2FD8(__int64 a1)
{
  __int64 v2; // rdx
  ...
  if ( (*(_BYTE *)(a1 + 544) & 4) == 0 || sub_1800AFCA4(a1, 4) )
    return 0;
  v2 = *(_QWORD *)(a1 + 64);
  if ( v2 )
  {
    while ( 1 )
    {
      ...
      if ( v3 == _InterlockedCompareExchange((volatile signed __int32 *)(v2 + 8), v3 + 1, v3) )
      {
        ...
        if ( v5 )
        {
          ...
          *(float *)(a1 + 1584) = v22;
          *(float *)(a1 + 1588) = v23;
          v24 = (unsigned __int64 *)sub_180084098(v32, (unsigned __int64 *)(a1 + 1584), (unsigned __int64 *)(a1 + 1572));
          sub_180083F74(v41, v24, COERCE_DOUBLE(1056964608LL));
          v25 = (unsigned __int64 *)sub_180083FF0(v33, (unsigned __int64 *)(a1 + 1584), (unsigned __int64 *)(a1 + 1572));
          sub_180083F74(&v38, v25, COERCE_DOUBLE(1056964608LL));
          v26 = *(float *)(a1 + 396) - *(float *)(a1 + 392);
          v41[2] = *(_DWORD *)(a1 + 392);
          v39 = v39 * -1.0;
          v40 = v26;
          v27 = (_OWORD *)sub_1800851C4((__int64)v36, v41);
          v28 = (_OWORD *)sub_18008513C((__int64)v37, (__int64)&v38);
          sub_180019F78((__int64)v42, v28, v27);
          sub_18001BA00(v42, (__int64)v43);
          v34[0] = v42[0];
          v34[1] = v42[1];
          v34[2] = v42[2];
          v34[3] = v42[3];
          sub_180083CB4((_OWORD *)(a1 + 1252), v34);
          v35[0] = v43[0];
          v35[1] = v43[1];
          v35[2] = v43[2];
          v35[3] = v43[3];
          sub_180083CB4((_OWORD *)(a1 + 1444), v35);
        }
        break;
      }
    }
