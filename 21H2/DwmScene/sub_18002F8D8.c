/*
 * XREFs of sub_18002F8D8 @ 0x18002F8D8
 * Callers:
...
_QWORD *__fastcall sub_18002F8D8(__int64 a1, _QWORD *a2, unsigned int a3)
{
  __int64 **v3; // rbx
  __int64 *v7; // rcx
  __int64 v8; // rax
