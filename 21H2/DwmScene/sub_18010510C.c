/*
 * XREFs of sub_18010510C @ 0x18010510C
 * Callers:
...
__int64 __fastcall sub_18010510C(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // r15
  __int64 v5; // r14
  char v6; // r13
...
LABEL_53:
  ...
  do
  {
    ...
    if ( v18 >= 0x10 )
      v21 = v17;
    v22 = sub_180103268((__int64)v21, v15, 0LL, (unsigned __int64)&unk_1801DC4E0, 2LL);
    if ( v15 < v22 )
      v22 = v15;
    v23 = Buf1;
    if ( v18 >= 0x10 )
    ...
    if ( v6 )
    {
      ...
      v51 = 0LL;
      v52 = 0LL;
      sub_180020B7C(v50, (__int64)v66);
      v54 = 0LL;
      v55 = 0LL;
      sub_180020B7C(v53, (__int64)Buf1);
      if ( (unsigned __int8)sub_180105A94(v53, v50) )
      {
        pExceptionObject[2] = 0LL;
        v74 = 15LL;
        LOBYTE(pExceptionObject[0]) = 0;
        sub_1800B970C(pExceptionObject, Buf1, v67 + 1, 0xFFFFFFFFFFFFFFFFuLL);
        v49 = (int)sub_180105D08(pExceptionObject, 0LL, 10LL);
        v5 = v49 * v49 * v49;
        v46 = 1;
        v12 = v74;
        if ( v74 >= 0x10 )
    ...
    if ( v46
      && (v57 = v53,
          v54 = 0LL,
          v55 = 0LL,
          sub_180020B7C(v53, (__int64)v71),
          v51 = 0LL,
          v52 = 0LL,
          sub_180020B7C(v50, (__int64)Buf1),
          (unsigned __int8)sub_180105A94(v50, v53)) )
    {
      v47 = 1;
    }
    else if ( v47 )
    {
      ...
      v54 = 0LL;
      v55 = 0LL;
      sub_180020B7C(v53, (__int64)&v69);
      v51 = 0LL;
      v52 = 0LL;
      sub_180020B7C(v50, (__int64)Buf1);
      if ( (unsigned __int8)sub_180105A94(v50, v53) )
      {
        v7 = 1;
        v45 = 1;
        goto LABEL_44;
...
LABEL_44:
    ...
    v33 = sub_1800B836C(v31, Buf1, v32);
...
LABEL_46:
  ...
  {
    sub_18000FE28(v50);
    v44 = sub_18000FE28(v53);
    sub_18002D8C4(pExceptionObject, v44, 395, (__int64)v50, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v34 = v56;
  result = sub_180105C94(v56 + 1, v5);
  if ( v5 )
  {
    v13 = (_DWORD *)v34[1];
    v35 = (int *)(v8 + 4);
...
LABEL_54:
  *v34 = v4;
  ...
  v72 = _mm_load_si128((const __m128i *)&xmmword_180140550);
  v71[0] = 0;
  if ( v68 >= 0x10 )
  {
    v41 = *(_QWORD *)v66;
