/*
 * XREFs of sub_18010CE84 @ 0x18010CE84
 * Callers:
...
__int64 __fastcall sub_18010CE84(_QWORD *a1, __int64 a2, size_t *a3, __int64 a4)
{
  size_t *v5; // r15
  size_t v8; // r9
  __int64 v9; // rdx
  ...
  {
    v29 = sub_18008F484((__int64)a1, &v31, a4);
    sub_18010D174(a1, &v32, *v29);
    throw;
  }
LABEL_30:
  try
