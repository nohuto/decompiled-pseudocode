/*
 * XREFs of sub_18003A420 @ 0x18003A420
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_18003A420(__int64 a1, _QWORD *a2, __int64 a3, unsigned int a4)
{
  __int64 v4; // r15
  char v5; // r14
  __int64 *v6; // rcx
  ...
  if ( *a2 )
  {
    v6 = (__int64 *)sub_1800A0674(*a2, v58, *(unsigned int *)(a1 + 88));
    v7 = 1;
    v8 = *v6;
  }
  else
  ...
  *v6 = 0LL;
  ...
  if ( (unsigned int)sub_1800A06E8(v8) == 1 )
  {
    v11 = *sub_180036B88(v8, &v40);
    v42 = v11;
    v12 = v40;
    if ( !v40 )
      goto LABEL_20;
...
LABEL_20:
  ...
  sub_18002BE74(v43, v13);
  if ( v13 < 0 )
  {
    sub_18011BCAC(&unk_18020F118, 3LL, "Failed to read Texture with HRESULT error 0x%.8x", v13);
    v5 = 0;
  }
  else
  {
    v17 = sub_1800A0690(v8);
    v50[0] = 0;
    v50[1] = 4;
    v50[2] = 4;
    v50[3] = 4;
    ...
    v57 = 2;
    v18 = v50[v17];
    v19 = (unsigned int)sub_1800A0690(v8);
    v60[0] = 0;
    v60[1] = 1;
    v20 = &v61;
    for ( i = 20LL; i; --i )
    ...
    v64 = 1;
    v22 = v60[v19];
    v23 = v18 * sub_1800A0720(v8);
    v35 = v23 * sub_1800A06AC(v8);
    v38 = v66;
    v37 = v67;
    v24 = v66;
    if ( v66 > v23 )
    ...
    v48 = v24;
    v46 = v65;
    v25 = sub_1800A06AC(v8);
    v34 = (v22 + v25 - 1) / v22;
    v26 = sub_1800A0658(v8, (v22 + v25 - 1) % v22);
    v33 = v26;
    v27 = 0;
    if ( v26 )
    {
      do
      {
        ...
        if ( v34 )
        {
          do
          {
            ...
            if ( v29 >= a4 )
              break;
            sub_18000F088((void *)(v47 + v29), v23, (const void *)(v46 + v38 * v28++ + v37 * v27), v48);
          }
          while ( v28 < v34 );
          v26 = v33;
        }
