/*
 * XREFs of sub_1800D0DCC @ 0x1800D0DCC
 * Callers:
...
__int64 __fastcall sub_1800D0DCC(__int64 *a1, _QWORD *a2, int a3)
{
  __int64 v6; // rsi
  unsigned int v7; // edi
  unsigned int v8; // ebx
  ...
  sub_1800D0A74(a1, v9, v8, v7, a3, 0LL);
  result = sub_1800D0528(a1, a2);
