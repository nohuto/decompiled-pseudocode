...
__int64 __fastcall sub_18002B7A0(__int64 a1, int a2)
{
  int v3; // r14d
  __int64 result; // rax
  unsigned int i; // r12d
  ...
  *(_DWORD *)(a1 + 416) = a2;
  ...
  {
    v29 = 0LL;
    sub_18007044C(a1, &v29, i);
    v30 = 0LL;
    sub_180066E84(v29 + 8, &v30);
    ...
    *((_QWORD *)&v27 + 1) = v7;
    ...
    if ( v12 )
    {
      ...
      if ( v15 )
      {
        v16 = (__int64 *)sub_1800A062C(v15, v28);
      }
      else
      {
        v23[0] = 0;
