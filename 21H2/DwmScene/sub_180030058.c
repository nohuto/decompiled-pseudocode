...
void __fastcall sub_180030058(__int64 a1)
{
  int v2; // ecx
  signed int v3; // esi
  __int64 **v4; // r15
  ...
  do
  {
    ...
    v38 = v5;
    if ( sub_180031664(a1 + 1648, &v38) )
    {
      sub_18002D618((__int64 **)(a1 + 1648), (__int64)&v35, &v38);
      sub_18002F8D8(a1, &v33, *(_DWORD *)(v35 + 44));
      v6 = v33;
      if ( v33 <= 0 )
        break;
      sub_18002D590((__int64 **)(a1 + 1680), (__int64)&v36, &v38);
      v7 = v36;
      goto LABEL_21;
    }
    v8 = *v4;
    ...
    if ( v9 == *(__int64 **)(a1 + 1648) )
      break;
    v12 = v32;
    sub_18002F8D8(a1, &v34, *((_DWORD *)v32 + 11));
    sub_18002F8D8(a1, &v31, *((_DWORD *)v9 + 11));
    if ( v34 <= 0 || v31 <= 0 )
      break;
    v6 = v34
       + (int)(v38 - *((_DWORD *)v12 + 8)) * ((v31 - v34) / (unsigned int)(*((_DWORD *)v9 + 8) - *((_DWORD *)v12 + 8)));
    sub_18002D590((__int64 **)(a1 + 1680), (__int64)&v37, &v38);
    v7 = v37;
LABEL_21:
    *(_QWORD *)(v7 + 40) = v6;
    --*(_DWORD *)(a1 + 1640);
  ...
  if ( v13 > 0x14 )
  {
    ...
    sub_1800318D8(a1 + 1648, &v31, **(_QWORD **)(a1 + 1648), k);
  }
  v19 = *(_QWORD *)(a1 + 1672);
  if ( v19 > 0x14 )
  {
    ...
    sub_180031774(a1 + 1664, &v31, **(_QWORD **)(a1 + 1664), ii);
  }
  v25 = *(_QWORD *)(a1 + 1688);
  if ( v25 > 0x14 )
  {
    ...
    sub_180031774(a1 + 1680, &v31, **(_QWORD **)(a1 + 1680), mm);
  }
}
