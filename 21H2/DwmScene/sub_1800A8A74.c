/*
 * XREFs of sub_1800A8A74 @ 0x1800A8A74
 * Callers:
...
__int64 __fastcall sub_1800A8A74(__int64 a1, _QWORD *a2, _QWORD *a3, _QWORD *a4)
{
  _QWORD *v8; // rcx
  _QWORD *v9; // rax
  _QWORD *v10; // rax
  ...
  *(_QWORD *)(a1 + 448) = a3[1];
  ...
  {
    v14 = (__int64 *)sub_1800A8788((__int64)v34, "<NullExtension>");
    v15 = 2;
  }
  *(_QWORD *)(a1 + 456) = 0LL;
  *(_QWORD *)(a1 + 464) = 0LL;
