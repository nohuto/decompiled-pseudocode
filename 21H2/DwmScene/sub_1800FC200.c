/*
 * XREFs of sub_1800FC200 @ 0x1800FC200
 * Callers:
...
_QWORD *__fastcall sub_1800FC200(__int64 a1, _QWORD *a2, __int64 *a3, _QWORD *a4)
{
  void *v8; // rax
  __int64 v9; // r8
  __int64 v10; // rdi
  ...
  *(_OWORD *)a2 = 0LL;
  ...
  if ( v8 )
  {
    ...
    *a4 = 0LL;
    v34 = v11;
    v12 = sub_1800FC894(v44, a3);
    v8 = (void *)sub_1800FC120(v10, v12, &v34);
  }
  *a2 = 0LL;
  a2[1] = 0LL;
  LOBYTE(v9) = v33;
  sub_1800FC638(a2, v8, v9);
  v13 = *a2;
  *(_QWORD *)(v13 + 8) = *(_QWORD *)(***(__int64 (__fastcall ****)(_QWORD, char *))(a1 + 136))(
  ...
  if ( *a3 )
  {
    ...
    *(_QWORD *)&v37 = v14;
    *((_QWORD *)&v37 + 1) = v15;
    v16 = (__int64 *)sub_1800FC4E0(&v35, &v37);
    v17 = *a2;
    v18 = *v16;
    *v16 = 0LL;
  ...
  else
  {
    ...
    *(_QWORD *)&v38 = a3[2];
    *((_QWORD *)&v38 + 1) = v22;
    v23 = (__int64 *)sub_1800FC58C(&v36, &v38);
    v24 = *a2;
    v25 = *v23;
    *v23 = 0LL;
  ...
  if ( v28 )
  {
    ...
    JUMPOUT(0x1800FC4DELL);
  }
  v29 = *(_QWORD **)(a1 + 32);
  if ( *(_QWORD **)(a1 + 40) == v29 )
  {
    sub_18001101C((_QWORD *)(a1 + 24), v29, a2);
  }
  else
  {
    *v29 = 0LL;
...
LABEL_28:
    sub_18000FE28(v42);
    sub_18011ABCC(pExceptionObject, v42, 0LL);
