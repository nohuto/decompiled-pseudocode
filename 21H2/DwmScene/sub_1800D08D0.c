/*
 * XREFs of sub_1800D08D0 @ 0x1800D08D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800D08D0(__int64 *a1, __int64 *a2)
{
  __int64 result; // rax
  unsigned int v5; // edi
  __int64 v6; // rcx
...
LABEL_9:
    ...
    if ( v7 == v6 )
    {
      ...
      v20 = 0LL;
      sub_18003E2B8(*a2, &v20);
      v9 = sub_180067F58((__int64)a1, v19);
      sub_180068194(v20, v9);
      v10 = a1[14];
