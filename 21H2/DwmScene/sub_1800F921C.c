/*
 * XREFs of sub_1800F921C @ 0x1800F921C
 * Callers:
...
__int64 *__fastcall sub_1800F921C(__int64 *a1, _QWORD *a2, __int64 a3)
{
  _QWORD *v6; // r8
  __int64 v7; // rdx
  ...
  *a1 = 0LL;
  a1[1] = 0LL;
  v6 = sub_18006DB10((_QWORD *)*a2, &v16);
  v20 = 0LL;
  v7 = v6[1];
  if ( v7 )
  {
  ...
  if ( (_QWORD)v20 )
  {
    v10 = sub_1800D5BC0(v20, &v18, a3, a2);
    v11 = *v10;
    v7 = v10[1];
    *v10 = 0LL;
    v10[1] = 0LL;
