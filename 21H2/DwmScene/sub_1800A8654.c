/*
 * XREFs of sub_1800A8654 @ 0x1800A8654
 * Callers:
...
__int64 __fastcall sub_1800A8654(__int64 *a1, __int64 a2, _DWORD *a3)
{
  __int64 v3; // rbx
  __int64 *v6; // rax
  int v7; // edx
...
LABEL_10:
    v8 = *a1;
    v12 = a3;
    v9 = sub_1800A77DC((__int64)a1, v8, (__int64)&unk_1801D7188, &v12);
    sub_1800A81F8(a1, &v11, (__int64 *)v3, (int *)v9 + 8, v9);
    *(_QWORD *)a2 = v11;
    *(_BYTE *)(a2 + 8) = 1;
  }
  else
