/*
 * XREFs of sub_18006CDF0 @ 0x18006CDF0
 * Callers:
...
__int64 __fastcall sub_18006CDF0(float *a1, float a2, float a3, float a4, float a5)
{
  __int64 result; // rax
  _QWORD *v7; // r8
  __int64 v8; // rdx
    ...
    *((_DWORD *)a1 + 42) = v13;
    ...
    if ( (_BYTE)result )
    {
      ...
      *(float *)&v24[1] = a1[42];
      ...
      sub_1800DD08C(*v14, v23, v24);
      sub_18006CCB0((__int64)a1);
      v15 = *v14;
      ...
      v20 = *(_QWORD *)(v15 + 456);
      v17 = sub_18007040C(v23);
      v18 = *(_QWORD *)(v20 + 136);
      if ( v18 )
        result = sub_18006BC54(v18, v17);
      else
        result = 0LL;
      *((_DWORD *)a1 + 43) = result;
      if ( v16 )
