 ...
 *     sub_180003990 @ 0x180003990 (sub_180003990.c)
...
__int64 sub_1800618F0()
{
  ...
  if ( dword_18022051C > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_18022051C);
    if ( dword_18022051C == -1 )
    {
      *(_QWORD *)&Src = &unk_180191E50;
      *((_QWORD *)&Src + 1) = &unk_1801920D0;
      *(_QWORD *)&v15 = 0x100000005LL;
      v16 = Src;
      v17 = v15;
      sub_18005AB60();
      v2 = (_QWORD *)sub_1800D4B98(v18);
      v3 = sub_18005A894(v2, 0LL, "ImageProcessingFullscreen/ShaderModel40/", 0x28uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v3;
      si128 = *((__m128i *)v3 + 1);
      v3[2] = 0LL;
      ...
      *(_BYTE *)v3 = 0;
      ...
      v4[3] = 15LL;
      *(_BYTE *)v4 = 0;
      byte_180220518 = sub_1800D4C70(&v14, &v16);
      ...
      Init_thread_footer(&dword_18022051C);
    }
  }
  if ( dword_180220524 > *(_DWORD *)(v0 + 44) )
  {
    Init_thread_header(&dword_180220524);
    if ( dword_180220524 == -1 )
    {
      *(_QWORD *)&Src = &unk_1801920D0;
      *((_QWORD *)&Src + 1) = &unk_1801926BC;
      *(_QWORD *)&v19 = 0x100000001LL;
      v16 = Src;
      v17 = v19;
      sub_18005AB60();
      v7 = (_QWORD *)sub_1800D4B98(v18);
      v8 = sub_18005A894(v7, 0LL, "ImageProcessingFullscreen/ShaderModel40/", 0x28uLL);
      si128 = 0LL;
      Src = *(_OWORD *)v8;
      si128 = *((__m128i *)v8 + 1);
      v8[2] = 0LL;
      ...
      *(_BYTE *)v8 = 0;
      ...
      v9[3] = 15LL;
      *(_BYTE *)v9 = 0;
      byte_180220520 = sub_1800D4C70(&v14, &v16);
      if ( si128.m128i_i64[1] >= 0x10uLL )
      {
        v10 = Src;
        if ( (unsigned __int64)(si128.m128i_i64[1] + 1) >= 0x1000 )
      ...
      Init_thread_footer(&dword_180220524);
    }
  }
  return 0LL;
}
