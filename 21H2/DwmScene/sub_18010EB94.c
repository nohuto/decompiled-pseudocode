/*
 * XREFs of sub_18010EB94 @ 0x18010EB94
 * Callers:
 ...
 *     sub_1800AB168 @ 0x1800AB168 (sub_1800AB168.c)
...
bool __fastcall sub_18010EB94(__int64 a1, __int64 a2, char a3)
{
  __int64 v6; // r13
  int v7; // edx
  int v8; // eax
  ...
  if ( (*(_DWORD *)(v6 + 560) & 2) == 0 )
    v8 = v7;
  v33 = v8;
  v9 = sub_1800AA22C(*(_QWORD *)(a1 + 56), (__int64)&qword_180213538);
  v10 = sub_1800AA22C(*(_QWORD *)(a1 + 56), (__int64)&qword_1802134D8);
  v11 = sub_1800AA22C(*(_QWORD *)(a1 + 56), (__int64)aSkinning);
  v12 = sub_1800AA22C(*(_QWORD *)(a1 + 56), (__int64)&qword_180213518);
  v32 = v12;
  v13 = 1LL << v9;
  v37 = v13;
  if ( a3 )
  ...
  while ( 1 )
  {
    ...
    {
      v62 = 0LL;
      sub_1800A99A4(*(_QWORD *)(a1 + 56), &v62, v19, v15 & ~v19, 1);
      v67 = 0;
      v68 = 0;
      v69 = 0;
      v70 = 0;
      ...
      v76 = 1;
      v61 = 0LL;
      sub_180024740((_QWORD *)v6, &v61, 1u);
      sub_1800CC9E0((_QWORD *)v61, (__int64)&v64, 0LL);
      v38 = 0LL;
      if ( *((_QWORD *)&v61 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v61 + 1) + 8LL));
      v38 = v61;
      sub_1800F8368(v62, &v38);
      if ( !v20 )
      {
        v65 = 1;
        sub_180024740((_QWORD *)v6, &v44, 1u);
        ...
        if ( *((_QWORD *)&v61 + 1) )
          _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v61 + 1) + 8LL));
        v39 = v61;
        sub_1800F82B0(v62, &v39);
        HIBYTE(v77) = 0;
        sub_180024740((_QWORD *)v6, &v46, 1u);
        ...
        if ( *((_QWORD *)&v61 + 1) )
          _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v61 + 1) + 8LL));
        v40 = v61;
        sub_1800F8254(v62, &v40);
        v65 = 2;
        HIBYTE(v77) = 0;
        sub_180024740((_QWORD *)v6, &v48, 1u);
      ...
      else
      {
        ...
        v59 = 0LL;
        v60 = 0LL;
        sub_1800F8FE0(v62, (__int64)&v56);
        v50[3] = 15LL;
        v50[2] = 0LL;
        LOBYTE(v50[0]) = 0;
        sub_1800F85B0((_QWORD *)v62, 5, v50);
      }
      v27 = *(_QWORD **)(a1 + 136);
      if ( *(_QWORD **)(a1 + 144) == v27 )
      {
        sub_18001101C((_QWORD *)(a1 + 128), v27, &v62);
      }
      else
      {
        *v27 = 0LL;
