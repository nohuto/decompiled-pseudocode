/*
 * XREFs of sub_18003FE78 @ 0x18003FE78
 * Callers:
...
__int64 __fastcall sub_18003FE78(__int64 a1, __int64 a2)
{
  _QWORD *v4; // r14
  _QWORD *v5; // rdi
  ...
  *((_QWORD *)&v50 + 1) = v7;
  v8 = a2 + 8;
  sub_18003ED08(a2 + 8, (__int64)&v50, *(_DWORD *)a2, 4);
  v9 = (__int64 *)sub_1800A0674(*v5, v67, *(unsigned int *)(a1 + 88));
  ...
  *((_QWORD *)&v57 + 1) = v13;
  ...
  if ( *(_BYTE *)(a2 + 4) )
  {
    ...
    *((_QWORD *)&v51 + 1) = v20;
    ...
    v22 = &v51;
LABEL_38:
    result = sub_18003ED08(a2 + 8, (__int64)v22, *(_DWORD *)a2, v21);
    goto LABEL_39;
  }
  if ( *(_BYTE *)(a2 + 5) )
  {
    sub_180017984(v4, &v60, 1u);
    v23 = (_QWORD *)(a1 + 192);
...
LABEL_39:
  if ( *(_BYTE *)(a2 + 5) )
  {
    ...
    {
      v80 = 0LL;
      sub_1800A0674(*(_QWORD *)(a1 + 144), &v80, *(unsigned int *)(a1 + 88));
      v79 = 0LL;
      if ( *((_QWORD *)&v80 + 1) )
        _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)&v80 + 1) + 8LL));
      v62 = v80;
      v27 = sub_180018B88(&v69, (__int64 *)&v62);
      sub_180036B88(*v27, &v79);
      v28 = v70;
      if ( v70 )
      {
      ...
      sub_18002BE74(v12, v31);
      if ( v31 < 0 )
      {
        sub_18000FE28(v76);
        v46 = (unsigned int)sub_18000FE28(v75);
        sub_1800D1210((unsigned int)pExceptionObject, v46, 362, (unsigned int)v76, 0);
        throw (Spectre::Engine::EngineException *)pExceptionObject;
      }
      v33 = sub_180067F58(a1, v73);
      if ( *(_QWORD *)(v33 + 24) >= 0x10uLL )
        v33 = *(_QWORD *)v33;
      sub_180010534(v78, (const char *)v33);
      if ( v74 >= 0x10 )
      {
        v34 = v73[0];
        if ( v74 + 1 >= 0x1000 )
      ...
      *((_QWORD *)&v63 + 1) = v37;
      ...
      sub_1800343B0(v36, (char *)&v49, (char *)&v48, 0x400u);
      sub_180017984(v54, &v64, 1u);
      ...
      sub_18006821C(*v26, 2LL);
      v53 = 0LL;
      if ( v37 )
        _InterlockedIncrement(v37 + 2);
      *(_QWORD *)&v53 = v36;
      *((_QWORD *)&v53 + 1) = v37;
      result = sub_18009F96C(*v26);
