/*
 * XREFs of sub_18010BED0 @ 0x18010BED0
 * Callers:
 ...
 *     sub_180090350 @ 0x180090350 (sub_180090350.c)
...
char *__fastcall sub_18010BED0(char *a1, __int64 *a2, __int64 a3)
{
  __int64 *v3; // rbx
...
LABEL_4:
    ...
    while ( 1 )
    {
      ...
      if ( !*(_BYTE *)(v66 + 72) )
      {
        v92.m128_u64[0] = xmmword_180214CE0;
        v92.m128_i32[2] = DWORD2(xmmword_180214CE0);
      }
      ...
      v19 = (float *)sub_18008556C(v65, (__int64)v85);
      v20 = -v19[10];
      v21 = -v19[9];
      *(float *)&v87 = -v19[8];
      *((float *)&v87 + 1) = v21;
...
LABEL_49:
      v24 = a3;
      *(_OWORD *)(*(_QWORD *)(a3 + 64) + 16 * (v5 + 25)) = xmmword_180221E90;
LABEL_50:
      v93 = v92.m128_u64[0];
      v94 = v92.m128_i32[2];
      if ( v11 == 2 )
      ...
      else
      {
        ...
        *(float *)&v25 = *(float *)&v14 * *(float *)&v14;
        sub_180084204(&v93, v25);
        v26 = 1065353216;
      }
      v33 = sub_180083F74(v83, &v93, *(double *)&v9);
      v69 = *(_QWORD *)v33;
      v70 = v33[2];
...
LABEL_67:
          ...
          v80 = *(__int64 **)(v40 + 384);
          v81 = *(__int64 **)(v40 + 376);
          sub_1800BCF40(&v71, v81, v80, 0);
          v41 = v60 | 2;
          if ( v71 == *(__int64 **)(v40 + 384) )
            v73 = 0LL;
          else
            sub_1800BCE14((__int64 *)&v73, v71);
        ...
        *((_QWORD *)&v78 + 1) = v44;
        if ( v45 )
        {
          ...
          if ( *(_BYTE *)(v66 + 124) )
          {
            sub_1800AFA1C(v45, v96);
            sub_1800B2630(v96, (_OWORD *)(v46 + *(_QWORD *)(a3 + 64)));
          }
          else
          {
            v48 = *(_QWORD *)(a3 + 64);
            v49 = (_OWORD *)sub_1800833F8(
                              (__int64)v86,
                              (int *)&xmmword_180221E90,
                              &xmmword_180221E90,
                              &xmmword_180221E90,
                              &xmmword_180221E90);
            sub_180083CB4((_OWORD *)(v48 + v46), v49);
            v47 = v66;
          }
