/*
 * XREFs of sub_180043C20 @ 0x180043C20
 * Callers:
 *     sub_1800235F4 @ 0x1800235F4 (sub_1800235F4.c)
 * Callees:
...
__int64 __fastcall sub_180043C20(__int64 a1, _OWORD *a2, _QWORD *a3, _QWORD *a4)
{
  _QWORD *v7; // rax
