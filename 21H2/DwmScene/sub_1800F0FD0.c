/*
 * XREFs of sub_1800F0FD0 @ 0x1800F0FD0
 * Callers:
...
__int64 __fastcall sub_1800F0FD0(__int64 *a1, __int64 a2, __int64 a3)
{
  __int64 v5; // r12
  __int64 v6; // rdx
  ...
  *(_DWORD *)(v13 + 32) = *(_DWORD *)(a3 + 32);
  ...
  {
    sub_1800F1550(v18, a2, v11, a1);
    v17 = a1[1];
    v18 = a2;
  }
  sub_1800F1550(v18, v17, v14, a1);
  sub_1800F366C(a1, v11, v7, v10);
  return *a1 + 8 * v12;
}
