/*
 * XREFs of sub_1800CB96C @ 0x1800CB96C
 * Callers:
...
_QWORD *__fastcall sub_1800CB96C(_QWORD *a1, unsigned __int64 a2)
{
  ...
  if ( (_QWORD *)*result != result )
  {
    ...
    {
      v8 = *(_QWORD *)a1[1];
      result = (_QWORD *)sub_1800BC840(a1, (__int64)v9, (char *)(v8 + 16), v8);
    }
    while ( v8 != v7 );
  }
  return result;
