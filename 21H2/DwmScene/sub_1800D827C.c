/*
 * XREFs of sub_1800D827C @ 0x1800D827C
 * Callers:
...
unsigned __int64 *__fastcall sub_1800D827C(unsigned __int64 *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  else
  {
    ...
    v12 = 96 * v10;
    v13 = 48 * v10 + a2;
    sub_1800D81C4(a2, v13, 96 * v10 + a2);
    sub_1800D81C4(v8 - v11, v8, v11 + v8);
    v14 = v6 - v11;
    sub_1800D81C4(a3 - 48 - v12, v14, a3 - 48);
    sub_1800D81C4(v13, v8, v14);
    v4 = a1;
  }
  v15 = v8 + 48;
  if ( a2 < v8 )
...
LABEL_52:
    ...
    if ( v32 != a3 )
    {
      sub_1800D8BD8(v32, v33);
      goto LABEL_38;
    }
    v8 -= 48LL;
    if ( v33 != v8 )
      sub_1800D8BD8(v33, v8);
    v15 -= 48LL;
    sub_1800D8BD8(v8, v15);
  }
  if ( v32 != a3 )
  {
    if ( v15 != v32 )
