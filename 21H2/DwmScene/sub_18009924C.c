...
__int64 __fastcall sub_18009924C(__int64 a1, __int64 a2)
{
  __int64 *v3; // rax
  unsigned int v4; // eax
  ...
  if ( *(_BYTE *)(a1 + 310) )
  {
    ...
    sub_1800D1210((unsigned int)pExceptionObject, v4, 658, (unsigned int)v6, 0);
  ...
  if ( !a2 )
  {
    sub_18000FE28(v5);
    v3 = sub_18000FE28(v6);
    sub_180096C40(pExceptionObject, v3, 663, (__int64)v5, 0);
    throw (Spectre::Engine::EngineInvalidPointerException *)pExceptionObject;
  }
  return sub_180099314(a1, a2, *(unsigned int *)(a1 + 120));
}
