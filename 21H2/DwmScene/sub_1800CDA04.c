/*
 * XREFs of sub_1800CDA04 @ 0x1800CDA04
 * Callers:
 *     sub_1800CEFF0 @ 0x1800CEFF0 (sub_1800CEFF0.c)
 * Callees:
...
_OWORD *__fastcall sub_1800CDA04(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
  ...
  *(_QWORD *)&v9 = a2;
  v11 = 0LL;
  sub_1800CCD98(*a4, (__int64 *)&v11);
  sub_180067F58(a1, v10);
  sub_180068194(v11, v10);
