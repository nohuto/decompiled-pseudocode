/*
 * XREFs of sub_18003C170 @ 0x18003C170
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_18003C170(__int64 a1, int a2, __int64 *a3, unsigned int a4)
{
  __int64 v5; // rcx
  __int64 v8; // r8
  __int64 v9; // rbx
  ...
  if ( *a3 )
  {
    ...
    v17 = 0LL;
    sub_1800A1304(v5, &v17, v8);
    v14 = 0LL;
    sub_180038260((__int64 *)&v14, &v17);
    v9 = *(_QWORD *)(v14 + 184);
    v15 = v9;
    if ( v9 )
