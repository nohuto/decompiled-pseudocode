/*
 * XREFs of sub_18011A850 @ 0x18011A850
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_18011A850(__int64 a1, void *a2, __int64 a3, double a4, void *a5, void *a6, int a7)
{
  ULONG result; // eax
  ...
  if ( (unsigned int)dword_180214BC8 > 5 )
  {
    ...
    return sub_180002C58(
             ...
             (unsigned __int8 *)dword_1801EE71F,
             0LL,
             0LL,
             &v13,
             (__int64)&v12,
