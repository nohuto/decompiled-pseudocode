/*
 * XREFs of sub_1801045F8 @ 0x1801045F8
 * Callers:
...
__int64 __fastcall sub_1801045F8(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v4; // rsi
      ...
      if ( v32 != 1 || (*v12 != 13 ? (v13 = *v12 < 0xDu ? -1 : 1) : (v13 = 0), v13) )
      {
        ...
        if ( *v14 != 35 )
        {
          if ( v5 )
          {
            ...
            sub_1800B8594((__int64)v34, (__int64)v31, 1, 1);
