/*
 * XREFs of sub_1800FBA20 @ 0x1800FBA20
 * Callers:
...
__int64 *__fastcall sub_1800FBA20(__int64 *a1, _QWORD *a2, __int64 a3, __int64 a4, char a5, int a6, char a7)
{
  __int64 *v7; // r13
  unsigned int v8; // edi
  int v9; // r8d
  ...
  v43 = 0LL;
  LOBYTE(v9) = a5;
  sub_1800FBE6C(v11, v10, v9, v8, (__int64)&v47, (__int64)&v45, (__int64)&v43);
  v12 = v8 + 1;
  v13 = 0LL;
  v41 = 0LL;
  v42 = 0LL;
    ...
    if ( v8 )
    {
      ...
      do
      {
        ...
        if ( v22 > 1 )
        {
          ...
          if ( v13 == v24 )
          {
            sub_1800FB24C((const void **)&v41, v24, v35);
            v13 = v42;
            v24 = (_BYTE *)*((_QWORD *)&v41 + 1);
          }
          else
        ...
        for ( i = 0; i <= v8; ++i )
        {
          ...
          if ( v13 == v27 )
          {
            sub_1800FB24C((const void **)&v41, v27, v35);
            v13 = v42;
            v24 = (_BYTE *)*((_QWORD *)&v41 + 1);
          }
          else
    ...
    if ( v8 )
    {
      ...
      do
      {
        ...
        if ( v14 > 1 )
        {
          ...
          if ( v13 == v16 )
          {
            sub_1800FB24C((const void **)&v41, v16, v35);
            v13 = v42;
            v16 = (_BYTE *)*((_QWORD *)&v41 + 1);
          }
          else
        ...
        else
        {
          ...
          do
          {
            ...
            if ( v13 == v20 )
            {
              sub_1800FB24C((const void **)&v41, v20, v35);
              v13 = v42;
              v16 = (_BYTE *)*((_QWORD *)&v41 + 1);
              v19 = v37;
            }
  ...
  *(_OWORD *)v7 = 0LL;
  sub_1800FB8EC(v7, v39, 3, (__int64 *)&v47, (__int64 *)&v41, (__int64 *)&v45, (__int64 *)&v43, a7, 1, 1);
  v36 = 1;
  sub_180097958(*v7, 0);
  v28 = v41;
  if ( (_QWORD)v41 )
  ...
  sub_1800F6218((__int64 *)&v45);
  sub_1800F6218((__int64 *)&v47);
  return v7;
}
