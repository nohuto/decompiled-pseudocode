/*
 * XREFs of sub_18010B5D4 @ 0x18010B5D4
 * Callers:
...
_QWORD *__fastcall sub_18010B5D4(__int64 *a1, unsigned __int64 a2)
{
  ...
  result = sub_180010BEC((__int64)a1, v3);
  *a1 = (__int64)result;
