/*
 * XREFs of sub_180119580 @ 0x180119580
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180119580(
        __int64 a1,
        float a2,
        float a3,
        float a4,
        ...
        __int64 a21)
{
  ...
  *(_QWORD *)(a1 + 112) = v26;
  ...
  sub_180118F70((__int64)v28);
  result = sub_18011A0CC(v28);
