/*
 * XREFs of sub_180112BD0 @ 0x180112BD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_18006B338 @ 0x18006B338 (sub_18006B338.c)
...
_QWORD *__fastcall sub_180112BD0(unsigned __int64 *a1, _QWORD *a2, __int64 a3, __int64 a4, __int64 *a5)
{
  __int64 v5; // r13
  __int64 v9; // rcx
  char *v10; // rax
...
LABEL_40:
  ...
  if ( v17 )
  {
    ...
    if ( v45 )
      ...
      v46 = 0;
    sub_18011238C((__int64)a1, (__int64)v136, (__int64)v138, (float)v46, (float)v43);
    v109 = 15LL;
    v108[2] = 15LL;
    strcpy((char *)v108, "BlurSampleArray");
    v47 = sub_1800F540C(a1[36], &v122);
    v48 = sub_1800F295C(*v47, (__int64)v108);
    v49 = v123;
    if ( v123 )
    {
    ...
    sub_1800F5EC8(a1[36], v48, v136, 0x10u);
    v51 = *(int **)(v17 + 128);
    if ( v51 )
      v52 = v51[1];
    else
...
LABEL_137:
    ...
    sub_1800F5EC8(a1[36], v48, v138, 0x10u);
    ...
    *((float *)&v100 + 1) = (float)v68;
    v129 = *(_QWORD *)sub_18006B338(&v124, a1 + 33, &v100);
...
LABEL_138:
  ...
  v120 = _mm_srli_si128((__m128i)xmmword_1801D7CC0, 8).m128i_u64[0];
  v84 = sub_18007B2B4(v21);
  sub_1800A6CA0(v84);
  v85 = a1[25];
  *a2 = 0LL;
  a2[1] = 0LL;
