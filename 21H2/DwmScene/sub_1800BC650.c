/*
 * XREFs of sub_1800BC650 @ 0x1800BC650
 * Callers:
...
__int64 __fastcall sub_1800BC650(_QWORD *a1, __int64 a2, _QWORD *a3)
{
  __int64 v5; // r11
  _QWORD *v6; // r9
  __int64 v7; // rdx
...
LABEL_18:
  ...
  sub_1800BBC6C((__int64)(a1 + 1), *v10, (__int64)a3);
  v21 = (__int64 *)a1[1];
  v22 = *v21;
  v33 = v22;
  v23 = *(_QWORD *)v22;
  ...
  {
    v32 = sub_18008F484((__int64)a1, &v33, v33);
    sub_1800CBD30(a1, &v34, *v32);
    throw;
  }
LABEL_37:
  try
