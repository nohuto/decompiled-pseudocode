/*
 * XREFs of sub_1800A4904 @ 0x1800A4904
 * Callers:
 *     sub_180080DD0 @ 0x180080DD0 (sub_180080DD0.c)
 * Callees:
...
__int64 __fastcall sub_1800A4904(_QWORD *a1)
{
  __int64 v2; // rcx
  ...
  sub_1800258BC(a1 + 2326, (__int64)(a1 + 2326));
  sub_1800A1F2C(a1 + 2324, (__int64)(a1 + 2324));
  sub_1800A1EC0(a1 + 2322, (__int64)(a1 + 2322));
  sub_1800A1F2C(a1 + 2320, (__int64)(a1 + 2320));
  v9 = a1[2319];
  if ( v9 >= 0x10 )
  {
    v10 = a1[2316];
