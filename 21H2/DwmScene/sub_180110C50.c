/*
 * XREFs of sub_180110C50 @ 0x180110C50
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180110C50(__int64 a1, __int64 a2, float a3, float a4, float a5, int a6)
{
  _UNKNOWN **v6; // rax
  __int64 v7; // rdi
  __int64 i; // rsi
  ...
  for ( i = *(_QWORD *)(a1 + 136); v7 != i; v7 += 16LL )
  {
    ...
    LOBYTE(v6) = sub_1800F9008(*(_QWORD **)v7, a3, a4, a5, 1, a6);
    if ( v9 )
    {
