/*
 * XREFs of Crashdump_SendUrb @ 0x1C004A2F0
 * Callers:
 *     <none>
 * Callees:
 *     Crashdump_DoBulkTransfer @ 0x1C0049600 (Crashdump_DoBulkTransfer.c)
 *     Crashdump_ResetPipe @ 0x1C004A270 (Crashdump_ResetPipe.c)
