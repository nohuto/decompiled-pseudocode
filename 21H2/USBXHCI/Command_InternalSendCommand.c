/*
 * XREFs of Command_InternalSendCommand @ 0x1C0003E9C
 * Callers:
 ...
 *     Etw_CommandWaitlisted @ 0x1C00480C8 (Etw_CommandWaitlisted.c)
...
LABEL_45:
  ...
  v7 = (_QWORD *)(a1 + 80);
  if ( (_QWORD *)*v7 != v7 && (*(_QWORD *)(*(_QWORD *)(a1 + 8) + 336LL) & 0x80000000LL) != 0 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_qLq(
        *(_QWORD *)(a1 + 16),
