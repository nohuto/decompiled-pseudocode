/*
 * XREFs of Register_RestoreRyzenFeatureBitsPostReset @ 0x1C0014130
 * Callers:
...
char __fastcall Register_RestoreRyzenFeatureBitsPostReset(__int64 a1, int a2, int a3, int a4)
{
  ...
  if ( (_mm_srli_si128(*(__m128i *)(*(_QWORD *)(a1 + 8) + 336LL), 8).m128i_u16[0] & 0x100) != 0 )
  {
    ...
    {
      v7 = XilRegister_ReadUlong(a1, (unsigned int *)(*(_QWORD *)(a1 + 24) + 49408LL));
      XilRegister_WriteUlong(a1, (_DWORD *)(*(_QWORD *)(a1 + 24) + 49408LL), v7 & 0xFF0FFFFF);
      v8 = XilRegister_ReadUlong(a1, (unsigned int *)(*(_QWORD *)(a1 + 24) + 49420LL));
      XilRegister_WriteUlong(a1, (_DWORD *)(*(_QWORD *)(a1 + 24) + 49420LL), v8 & 0xFBFFFFFF);
    }
  }
  ...
  if ( (v5 & 0x200) != 0 )
  {
    ...
    {
      v9 = XilRegister_ReadUlong(a1, (unsigned int *)(*(_QWORD *)(a1 + 24) + 49408LL));
      XilRegister_WriteUlong(a1, (_DWORD *)(*(_QWORD *)(a1 + 24) + 49408LL), v9 | 0xF00000);
      Interval.QuadPart = -200LL;
      KeDelayExecutionThread(0, 0, &Interval);
      v10 = XilRegister_ReadUlong(a1, (unsigned int *)(*(_QWORD *)(a1 + 24) + 49408LL));
      LOBYTE(v5) = XilRegister_WriteUlong(a1, (_DWORD *)(*(_QWORD *)(a1 + 24) + 49408LL), v10 & 0xFF0FFFFF);
    }
  }
  return v5;
}
