/*
 * XREFs of UsbDevice_ValidateEndpointConfigureRequest @ 0x1C00029BC
 * Callers:
...
LABEL_5:
        ...
        {
          LOBYTE(v7) = 2;
          WPP_RECORDER_SF_(*(_QWORD *)(v15 + 72), v7, 12, 36, (__int64)&WPP_5cc87a4a737631244eec1c43efcd9051_Traceguids);
        }
      ...
      else
      {
        ...
        {
          LOBYTE(v7) = 2;
          WPP_RECORDER_SF_(*(_QWORD *)(v15 + 72), v7, 12, 35, (__int64)&WPP_5cc87a4a737631244eec1c43efcd9051_Traceguids);
        }
