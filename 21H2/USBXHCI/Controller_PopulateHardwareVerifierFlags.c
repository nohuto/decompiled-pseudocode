/*
 * XREFs of Controller_PopulateHardwareVerifierFlags @ 0x1C006DE50
 * Callers:
  ...
  *(_QWORD *)&DestinationString.Length = 3407872LL;
  ...
  else
  {
    if ( result != 2 )
    {
      ...
      {
        LOBYTE(v6) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), v6, 4, 212, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
        goto LABEL_66;
      }
      goto LABEL_18;
    }
