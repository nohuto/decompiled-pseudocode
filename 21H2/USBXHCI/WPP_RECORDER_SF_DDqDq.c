/*
 * XREFs of WPP_RECORDER_SF_DDqDq @ 0x1C0005D50
 * Callers:
...
__int64 WPP_RECORDER_SF_DDqDq(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x2000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_d233b597c96c378d294c2d5b80e0f0a8_Traceguids,
      37LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
