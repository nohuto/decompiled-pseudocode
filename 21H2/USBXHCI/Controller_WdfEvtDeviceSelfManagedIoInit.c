...
__int64 __fastcall Controller_WdfEvtDeviceSelfManagedIoInit(__int64 a1)
{
  ...
  *(_BYTE *)(v3 + 16) = 1;
  ...
  {
    LOBYTE(v2) = 5;
    WPP_RECORDER_SF_i(*(_QWORD *)(v3 + 72), v2, 4, 53, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, v1);
  }
  if ( (unsigned __int8)Controller_InUseByDebugger(v3) )
  {
    ...
    {
      LOBYTE(v4) = 4;
      WPP_RECORDER_SF_i(*(_QWORD *)(v3 + 72), v4, 4, 54, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, v1);
    }
    ...
    {
      LOBYTE(v9) = 3;
      WPP_RECORDER_SF_d(*(_QWORD *)(v3 + 72), v9, 4, 55, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, v8);
    }
  }
  ...
  if ( (*(_QWORD *)(v3 + 336) & 0x400000000LL) != 0 )
  {
    ...
    *(_QWORD *)(v3 + 456) = v5;
    ...
    {
      LOBYTE(v6) = 3;
      WPP_RECORDER_SF_i(*(_QWORD *)(v3 + 72), v6, 4, 56, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, v1);
    }
  }
  return 0LL;
}
