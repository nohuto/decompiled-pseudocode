/*
 * XREFs of Command_Create @ 0x1C006D3CC
 * Callers:
 *     Controller_WdfEvtDeviceAdd @ 0x1C006D740 (Controller_WdfEvtDeviceAdd.c)
 * Callees:
 *     Command_IsProxyCommandRing @ 0x1C0001910 (Command_IsProxyCommandRing.c)
...
__int64 __fastcall Command_Create(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  else
  {
    ...
    *(_QWORD *)v8 = v20;
    ...
    {
      LOBYTE(v7) = 5;
      WPP_RECORDER_SF_i(*(_QWORD *)(a2 + 72), v7, 7, 11, (__int64)&WPP_7e0bcb5bda0632cd0b4b69ae4ee19d35_Traceguids, v20);
    }
    *(_QWORD *)(v8 + 8) = a2;
