/*
 * XREFs of UsbDevice_UcxEvtDeviceAdd @ 0x1C006F110
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbDevice_UcxEvtDeviceAdd(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v27 = 0LL;
  ((void (__fastcall *)(__int64, __int64, _QWORD *))qword_1C00617C0)(UcxDriverGlobals, v17, v26);
  v19 = 0;
  v21 = 0LL;
  v22 = 1;
  v23 = 1;
  ...
  v24 = 0LL;
  v18 = 56;
  v7 = ((__int64 (__fastcall *)(__int64, __int64, __int64 *, int *, __int64 *))qword_1C00617B8)(
         UcxDriverGlobals,
         a1,
         &v17,
         &v18,
  ...
  if ( v7 < 0 )
  {
    ...
    {
      LOBYTE(v8) = 2;
      WPP_RECORDER_SF_d(*(_QWORD *)(v6 + 72), v8, 12, 10, (__int64)&WPP_2e14ba44bfb4396fe7ac9baa15c70ba7_Traceguids, v7);
    }
  }
  else
  {
