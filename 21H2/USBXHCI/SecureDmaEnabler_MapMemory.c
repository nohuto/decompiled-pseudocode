/*
 * XREFs of SecureDmaEnabler_MapMemory @ 0x1C0078804
 * Callers:
...
__int64 __fastcall SecureDmaEnabler_MapMemory(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  ...
  {
    v10 = VslCreateSecureSection(&v14, *(_QWORD *)(*(_QWORD *)(a1 + 8) + 576LL), a2, 4LL, 1);
    v6 = v10;
    if ( v10 >= 0 )
    {
      ...
      *((_QWORD *)&v19 + 1) = v14;
      ...
      LODWORD(v19) = 5;
      LODWORD(v20) = 4096;
      v6 = SecureChannel_SendRequestSynchronously(*(_QWORD *)(v12 + 112), &v17, 56, (__int64)&v15, 24);
      if ( v6 >= 0 )
      {
        if ( (int)v15 >= 0 )
        {
