/*
 * XREFs of WppInitKm @ 0x1C007165C
 * Callers:
...
void __fastcall WppInitKm(__int64 a1, __int64 a2)
{
  ...
  if ( WPP_GLOBAL_Control != &WPP_MAIN_CB )
  {
    ...
    if ( LODWORD(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink) == 4 )
    {
      ...
      do
      {
        v5 = *(void (__fastcall **)(_DRIVER_OBJECT *, _QWORD, __int64 (__fastcall *)(__int64, unsigned __int8, __int64 *, __int64), struct _DEVICE_OBJECT *, _VPB **))&WPP_MAIN_CB.SectorSize;
        v4->Vpb = 0LL;
