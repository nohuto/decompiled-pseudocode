/*
 * XREFs of Controller_WdfEvtDeviceAdd @ 0x1C0070440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceAdd(__int64 a1, __int64 a2)
{
  ...
  v4 = ((__int64 (__fastcall *)(__int64, __int64))qword_1C0061828)(UcxDriverGlobals, a2);
  if ( v4 < 0 )
  {
...
LABEL_21:
        LOBYTE(v3) = 2;
        WPP_RECORDER_SF_d(v16, v3, 4, v14, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, v4);
      }
    }
    else
    {
