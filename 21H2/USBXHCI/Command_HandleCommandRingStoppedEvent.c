/*
 * XREFs of Command_HandleCommandRingStoppedEvent @ 0x1C002E2A4
 * Callers:
...
LABEL_34:
    ...
    if ( *(_QWORD *)(a1 + 80) != a1 + 80 )
    {
      ...
      {
        LOBYTE(v10) = 4;
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 16), v10, 7, 42, (__int64)&WPP_72168dd6ef593f221f3405957586a4e9_Traceguids);
      }
...
LABEL_29:
  ...
  else
  {
    ...
    {
      LOBYTE(v10) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 16), v10, 7, 43, (__int64)&WPP_72168dd6ef593f221f3405957586a4e9_Traceguids);
    }
