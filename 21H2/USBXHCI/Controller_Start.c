/*
 * XREFs of Controller_Start @ 0x1C0011B68
 * Callers:
...
__int64 __fastcall Controller_Start(__int64 a1)
{
  ...
  v3 = 0LL;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 116, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
  if ( Controller_IsControllerAccessible(a1) )
  {
    ...
    if ( (XilRegister_ReadUlong(v4, v5 + 4) & 1) != 0 )
    {
      ...
      *(_BYTE *)(a1 + 555) = Register_GetExtendedTBCTRBStatusSupported();
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 118, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
...
LABEL_14:
      if ( (v17 & 1) != 0 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          ...
          LOBYTE(v30) = 2;
          WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v30, v29, 119, Timeout, (v28 - UnbiasedInterruptTime) / 0x2710);
        }
      }
      else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        LOBYTE(v21) = 4;
        WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v21, v19, 120, Timeout, (v20 - UnbiasedInterruptTime) / 0xA);
      }
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2, 4, 117, (__int64)&WPP_ff2e52b0a40430e0f7756a6ff2f45ac0_Traceguids);
