...
__int64 __fastcall Controller_Start(__int64 a1, char a2, int a3, int a4)
{
  ...
  v6 = 0LL;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 116, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids);
  if ( Controller_IsControllerAccessible(a1) )
  {
    ...
    if ( (XilRegister_ReadUlong(v7, v8 + 4) & 1) != 0 )
    {
      ...
      ExtendedTBCEnable = Register_GetExtendedTBCEnable(
                            *(_QWORD *)(a1 + 88),
                            Ulong | 5u,
                            *(unsigned int *)(*(_QWORD *)(a1 + 88) + 108LL));
      ...
      *(_BYTE *)(a1 + 555) = Register_GetExtendedTBCTRBStatusSupported();
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 118, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids);
...
LABEL_14:
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2, 4, 117, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids);
