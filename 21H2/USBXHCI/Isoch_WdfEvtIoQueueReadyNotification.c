...
void __fastcall Isoch_WdfEvtIoQueueReadyNotification(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( KeGetCurrentIrql() != 2 )
  {
    ...
    if ( KeGetCurrentIrql() == 2 )
    {
      ...
      {
        LOBYTE(a2) = 2;
        WPP_RECORDER_SF_(*(_QWORD *)(v6 + 72), a2, 4, 306, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_sds(
...
LABEL_27:
  if ( v5 && KeGetCurrentIrql() == 2 )
  {
    ...
    if ( KeGetCurrentIrql() == 2 )
    {
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_d(v16[9], 2, 4, 308, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, v17);
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_d(v16[9], 2, 4, 309, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, v17);
    ...
    else
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_d(v16[9], 2, 4, 310, (__int64)&WPP_4d8d366f5fa2386b8519f650eb4534ed_Traceguids, CurrentIrql);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_sds(
            WPP_GLOBAL_Control->DeviceExtension,
            v35,
