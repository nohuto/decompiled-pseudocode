/*
 * XREFs of ?UpdateUIAHitTest@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EFFF4
 * Callers:
 ...
 *     ?Thunk_UpdateUIAHitTest_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED500 (-Thunk_UpdateUIAHitTest_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJ.c)
 * Callees:
