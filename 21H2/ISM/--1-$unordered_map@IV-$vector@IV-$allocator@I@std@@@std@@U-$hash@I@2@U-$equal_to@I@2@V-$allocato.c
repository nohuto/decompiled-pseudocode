/*
 * XREFs of ??1?$unordered_map@IV?$vector@IV?$allocator@I@std@@@std@@U?$hash@I@2@U?$equal_to@I@2@V?$allocator@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x18003B124
 * Callers:
 *     _dynamic_atexit_destructor_for__Win32kInterop::s_frameIdToPointerIdMap__ @ 0x1800524C0 (_dynamic_atexit_destructor_for__Win32kInterop--s_frameIdToPointerIdMap__.c)
 * Callees:
