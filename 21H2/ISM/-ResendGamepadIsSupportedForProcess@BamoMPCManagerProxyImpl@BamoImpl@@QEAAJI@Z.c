/*
 * XREFs of ?ResendGamepadIsSupportedForProcess@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18010AE3C
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 2;
      return CoreUICallSend(v8, v10, 2LL, 3LL, v9, &unk_1801C2959, a2);
    }
    else
    {
