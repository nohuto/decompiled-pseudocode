/*
 * XREFs of ?ProcessHomeGesture@MPCSixDofProcessor@@AEAAXPEAUInputInfo@@@Z @ 0x18018E694
 * Callers:
 ...
 *     ?TicksToSeconds@PerfCounter@@YAM_J@Z @ 0x18007C150 (-TicksToSeconds@PerfCounter@@YAM_J@Z.c)
 ...
 *     ?SendHomeEvent@MPCSixDofProcessor@@AEAAXPEAULegacyInputInfo@@@Z @ 0x18018F4B8 (-SendHomeEvent@MPCSixDofProcessor@@AEAAXPEAULegacyInputInfo@@@Z.c)
 */
