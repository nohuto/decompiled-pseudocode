/*
 * XREFs of ?SendMaterializeProxy@BamoInputSiteManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18000EB80
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v16, 2LL, 74LL, 31, &unk_1801C01AA, v14);
  if ( v8 < 0 )
  {
