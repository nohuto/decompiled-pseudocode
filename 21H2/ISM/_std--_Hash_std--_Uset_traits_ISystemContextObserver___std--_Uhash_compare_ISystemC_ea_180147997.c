...
void __fastcall __noreturn std::_Hash_std::_Uset_traits_ISystemContextObserver___std::_Uhash_compare_ISystemContextObserver___std::hash_ISystemContextObserver____std::equal_to_ISystemContextObserver______std::allocator_ISystemContextObserver____0___::_Insert_unverified_ISystemContextObserver___const___std::_List_unchecked_const_iterator_std::_List_val_std::_List_simple_types_ISystemContextObserver______std::_Iterator_base0____::_1_::catch_56(
        __int64 a1,
        __int64 a2)
{
