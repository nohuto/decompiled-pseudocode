/*
 * XREFs of ??0ForegroundManager@@AEAA@XZ @ 0x18003361C
 * Callers:
 ...
 * Callees:
 *     ??0?$KernelInputConnection@U_tagActivationObjectNotification@@@@QEAA@PEBD@Z @ 0x180046C40 (--0-$KernelInputConnection@U_tagActivationObjectNotification@@@@QEAA@PEBD@Z.c)
