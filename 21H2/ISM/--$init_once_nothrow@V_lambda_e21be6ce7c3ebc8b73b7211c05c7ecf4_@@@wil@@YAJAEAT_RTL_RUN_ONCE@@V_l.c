/*
 * XREFs of ??$init_once_nothrow@V_lambda_e21be6ce7c3ebc8b73b7211c05c7ecf4_@@@wil@@YAJAEAT_RTL_RUN_ONCE@@V_lambda_e21be6ce7c3ebc8b73b7211c05c7ecf4_@@PEA_N@Z @ 0x18004273C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( !InitOnceBeginInitialize(
          ...
          &fPending,
          0LL) )
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0x218, (unsigned int)"wil", v3);
  if ( fPending )
  {
