/*
 * XREFs of ?RegisterForSystemContext@ISMHeatFrameworkHost@@UEAAJW4HeatSystemContextInputType@@PEAUIHeatSystemContextClient@@@Z @ 0x18012CEE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_Input_HeatSystemContext@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18012D350 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_Input_HeatSystemContext@@@details@wil@@QE.c)
