/*
 * XREFs of ?SpatialObjectStateStatistics_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@II@Z @ 0x1800D8FA4
 * Callers:
        ...
        int a4)
{
  ...
  if ( **((_DWORD **)v7 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v7 + 1), 2LL) )
  {
    ...
    v13 = a2;
    v14 = 16LL;
    tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801CCD80, 0LL, 0LL, 5u, &v12);
  }
}
