/*
 * XREFs of ?FindEdge@Edges@@AEBAHAEBUCandidateIdentity@@@Z @ 0x180178FAC
 * Callers:
 *     ?GetCandidateEdgyDetectedInfo@EdgyConnection@@QEAA_NPEBUCandidateIdentity@@PEAUCandidateEdgyDetectedInfo@@@Z @ 0x1801775E0 (-GetCandidateEdgyDetectedInfo@EdgyConnection@@QEAA_NPEBUCandidateIdentity@@PEAUCandidateEdgyDete.c)
