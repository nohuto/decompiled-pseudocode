/*
 * XREFs of ?DestroyCursorShapeAnimation@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800E50AC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerProxyImpl::DestroyCursorShapeAnimation(
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 5;
      return CoreUICallSend(v8, v10, 2LL, 62LL, v9, &unk_1801C029D, a2);
    }
    else
    {
