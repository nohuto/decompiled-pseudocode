/*
 * XREFs of ?AllocateStub@BamoMPCConstantManagerClientPrincipal@@MEAAJPEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoMPCConstantManagerClientStub@@@Z @ 0x18006E3B0
 * Callers:
 *     <none>
 * Callees:
