/*
 * XREFs of ?Thunk_OnContinueProcessing_248@?$ISystemButtonEventControllerProxy_Receive@VBamoSystemButtonEventControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180102820
 * Callers:
 *     <none>
 * Callees:
