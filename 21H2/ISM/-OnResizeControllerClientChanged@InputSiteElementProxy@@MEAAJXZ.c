/*
 * XREFs of ?OnResizeControllerClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000C000
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  if ( v8 != v6 )
  {
    while ( 1 )
    {
      ...
      v13 = v11(v10, &GUID_0d261809_69db_1c99_27a1_d4a729938a2c, &v24) >= 0;
      if ( v9 && v13 )
        break;
      v8 += 2;
      if ( v8 == v6 )
  ...
  v16 = (*(__int64 (__fastcall **)(__int64))(*((_QWORD *)v4 + 1) + 160LL))((__int64)v4 + 8);
  if ( v16 )
  {
    v21 = v4;
    v18 = v16 + 8;
