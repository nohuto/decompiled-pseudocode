/*
 * XREFs of ?InitializeHelper@InputProviderManager@@AEAAJPEAUIRawInputClient@@W4InputProviderInitialization@@@Z @ 0x180027094
 * Callers:
 ...
 *     ??$_Emplace_reallocate@UInputProvider@@@?$vector@UInputProvider@@V?$allocator@UInputProvider@@@std@@@std@@QEAAPEAUInputProvider@@QEAU2@$$QEAU2@@Z @ 0x180028440 (--$_Emplace_reallocate@UInputProvider@@@-$vector@UInputProvider@@V-$allocator@UInputProvider@@@s.c)
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_DockInputProcessing@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18002A500 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_DockInputProcessing@@@details@wil@@QEAAX_.c)
 ...
 *     ??$construct@UInputProvider@@U1@@?$_Default_allocator_traits@V?$allocator@UInputProvider@@@std@@@std@@SAXAEAV?$allocator@UInputProvider@@@1@QEAUInputProvider@@$$QEAU3@@Z @ 0x1800895D0 (--$construct@UInputProvider@@U1@@-$_Default_allocator_traits@V-$allocator@UInputProvider@@@std@@.c)
 */
