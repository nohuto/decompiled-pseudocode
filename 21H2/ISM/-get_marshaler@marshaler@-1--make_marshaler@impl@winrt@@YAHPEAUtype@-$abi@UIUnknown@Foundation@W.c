/*
 * XREFs of ?get_marshaler@marshaler@?1??make_marshaler@impl@winrt@@YAHPEAUtype@?$abi@UIUnknown@Foundation@Windows@winrt@@X@34@PEAPEAX@Z@CA?AU?$com_ptr@UIMarshal@impl@winrt@@@4@XZ @ 0x1800BE688
 * Callers:
 ...
 *     CoCreateFreeThreadedMarshaler_0 @ 0x18003CC4F (CoCreateFreeThreadedMarshaler_0.c)
