/*
 * XREFs of ??1?$map@_JV?$shared_ptr@VSpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@@std@@U?$less@_J@2@V?$allocator@U?$pair@$$CB_JV?$shared_ptr@VSpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800CE42C
 * Callers:
 *     _Windows::Internal::SpatialInteractions::SpatialInteractionSourceDeviceCollection::SpatialInteractionSourceDeviceCollection_::_1_::dtor$15 @ 0x180051286 (_Windows--Internal--SpatialInteractions--SpatialInteractionSourceDeviceCollection--_ea_180051286.c)
 *     _SystemCursorController::SystemCursorController_::_1_::dtor$2 @ 0x1800517E2 (_SystemCursorController--SystemCursorController_--_1_--dtor$2.c)
 * Callees:
