/*
 * XREFs of ?UpdateMostRecentNodePoseValidity@SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@QEAAJAEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_VALIDITY_FLAGS@@@Z @ 0x180166C84
 * Callers:
 ...
 *     ?Update@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA?AW4SPATIAL_TRACKING_VALIDITY_FLAGS@@AEBUSPATIAL_NODE_ID@@W46@@Z @ 0x180166BE4 (-Update@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA-AW4SPATIAL_TRACKIN.c)
 */
