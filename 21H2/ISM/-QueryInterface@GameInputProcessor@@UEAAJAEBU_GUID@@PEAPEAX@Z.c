/*
 * XREFs of ?QueryInterface@GameInputProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180028890
 * Callers:
 *     ?Initialize@DWMInputRouter@@IEAAJXZ @ 0x1800272A4 (-Initialize@DWMInputRouter@@IEAAJXZ.c)
 *     ?QueryInterface@GameInputProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004DA00 (-QueryInterface@GameInputProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
