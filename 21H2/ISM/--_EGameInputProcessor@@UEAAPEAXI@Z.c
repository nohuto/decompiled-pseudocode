/*
 * XREFs of ??_EGameInputProcessor@@UEAAPEAXI@Z @ 0x18017C1B4
 * Callers:
 *     ??_EGameInputProcessor@@W7EAAPEAXI@Z @ 0x18004D9F0 (--_EGameInputProcessor@@W7EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1GameInputProcessor@@UEAA@XZ @ 0x18017C040 (--1GameInputProcessor@@UEAA@XZ.c)
 */
