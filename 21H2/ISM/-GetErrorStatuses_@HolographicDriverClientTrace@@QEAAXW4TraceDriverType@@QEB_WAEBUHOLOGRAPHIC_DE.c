/*
 * XREFs of ?GetErrorStatuses_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@QEB_WAEBUHOLOGRAPHIC_DEVICE_ERROR_STATUSES@@@Z @ 0x18015CE38
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapSz@D@@U?$_tlgWrapSz@_W@@U_tlgWrapperPtrSize@@U3@U?$_tlgWrapperByVal@$07@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapSz@D@@AEBU?$_tlgWrapSz@_W@@AEBU_tlgWrapperPtrSize@@5AEBU?$_tlgWrapperByVal@$07@@@Z @ 0x18014FEF4 (--$Write@U-$_tlgWrapSz@D@@U-$_tlgWrapSz@_W@@U_tlgWrapperPtrSize@@U3@U-$_tlgWrapperByVal@$07@@@-$.c)
  ...
  if ( *a4 < 0xFFFFu )
  {
    ...
    if ( **(_DWORD **)(v7 + 8) > 4u && tlgKeywordOn(*(_QWORD *)(v7 + 8), 0x400000000000LL) )
    {
      ...
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>,_tlgWrapSz<wchar_t>,_tlgWrapperPtrSize,_tlgWrapperPtrSize,_tlgWrapperByVal<8>>(
        v11,
        (unsigned __int8 *)dword_1801CF9AD,
        v9,
        v10,
