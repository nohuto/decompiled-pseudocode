/*
 * XREFs of ?UnregisterObserverClientOfType@BamoInputObserverManagerProxy@@UEAAJW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientPrincipal@@@Z @ 0x1800ED520
 * Callers:
 *     <none>
 * Callees:
