/*
 * XREFs of ?EffectiveHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXJKKE@Z @ 0x18016BD54
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v8[1] > 5u && tlgKeywordOn(v8[1], 2LL) )
  {
    ...
    v18 = 4LL;
    v16 = 4LL;
    tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801D2175, 0LL, 0LL, 6u, &v14);
  }
}
