/*
 * XREFs of ?SendHapticFeedbackForPlayCount@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJGMII@Z @ 0x1800EC654
 * Callers:
        ...
        float a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v10 = 2;
      return CoreUICallSend(v9, v12, 2LL, 58LL, v10, &unk_1801C0292, v4);
    }
    else
    {
