/*
 * XREFs of ?ReleasePublicReference@SharedObjectBase@@IEAAIXZ @ 0x1800BEF70
 * Callers:
 ...
 *     ?Release@?$SharedUnknownBase@UISIPCEndpoint@@@@UEAAKXZ @ 0x180043A10 (-Release@-$SharedUnknownBase@UISIPCEndpoint@@@@UEAAKXZ.c)
 *     ?Release@GameInputServerProxy@@UEAAKXZ @ 0x180043A20 (-Release@GameInputServerProxy@@UEAAKXZ.c)
 * Callees:
