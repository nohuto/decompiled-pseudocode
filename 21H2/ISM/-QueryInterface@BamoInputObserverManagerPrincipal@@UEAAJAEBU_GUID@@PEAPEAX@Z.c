/*
 * XREFs of ?QueryInterface@BamoInputObserverManagerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F40C0
 * Callers:
 *     ?QueryInterface@BamoInputObserverManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C030 (-QueryInterface@BamoInputObserverManagerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
