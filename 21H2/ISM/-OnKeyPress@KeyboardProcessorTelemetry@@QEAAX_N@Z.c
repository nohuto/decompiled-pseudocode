/*
 * XREFs of ?OnKeyPress@KeyboardProcessorTelemetry@@QEAAX_N@Z @ 0x180135A58
 * Callers:
 *     ?OnDeviceRemoval@KeyboardProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x1801356E0 (-OnDeviceRemoval@KeyboardProcessor@@UEAAJPEAUDeviceInfo@@@Z.c)
 * Callees:
...
void __fastcall KeyboardProcessorTelemetry::OnKeyPress(KeyboardProcessorTelemetry *this)
{
  ...
  if ( (unsigned int)dword_1802063F0 > 5 && tlgKeywordOn((__int64)&dword_1802063F0, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_1801CF490,
      0LL,
      0LL,
      3u,
      &v4);
