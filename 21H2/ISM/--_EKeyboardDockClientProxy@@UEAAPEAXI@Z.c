/*
 * XREFs of ??_EKeyboardDockClientProxy@@UEAAPEAXI@Z @ 0x180128BD0
 * Callers:
 *     <none>
 * Callees:
...
KeyboardDockClientProxy *__fastcall KeyboardDockClientProxy::`vector deleting destructor'(
        KeyboardDockClientProxy *this,
        char a2)
{
  __int64 v4; // rcx
