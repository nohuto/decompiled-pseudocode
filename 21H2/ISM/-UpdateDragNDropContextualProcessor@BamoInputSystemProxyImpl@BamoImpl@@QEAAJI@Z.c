/*
 * XREFs of ?UpdateDragNDropContextualProcessor@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EDF0C
 * Callers:
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoInputSystemProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x180044830 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoInputSystemProxyImpl@BamoImpl@@UEAAXPEAVBamoProx.c)
 *     ?Thunk_UpdateDragNDropContextualProcessor_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED220 (-Thunk_UpdateDragNDropContextualProcessor_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyIm.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSystemProxyImpl::UpdateDragNDropContextualProcessor(
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 6) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 72LL))((char *)this - 16);
    if ( v9 < 0 )
