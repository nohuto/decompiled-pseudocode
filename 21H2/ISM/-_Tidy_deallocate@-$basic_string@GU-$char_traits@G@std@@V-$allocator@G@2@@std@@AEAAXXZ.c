/*
 * XREFs of ?_Tidy_deallocate@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@AEAAXXZ @ 0x18003641C
 * Callers:
 ...
 *     ??1DevicePropertyHelper@DevicePropertyHelpers@@QEAA@XZ @ 0x180092930 (--1DevicePropertyHelper@DevicePropertyHelpers@@QEAA@XZ.c)
