/*
 * XREFs of ??$GetStaticConstant@_N@MPCConstantManager@@QEAA_NW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x18007CEC0
 * Callers:
 ...
 *     ?_Throw_bad_variant_access@std@@YAXXZ @ 0x180070C78 (-_Throw_bad_variant_access@std@@YAXXZ.c)
 */

char __fastcall MPCConstantManager::GetStaticConstant<bool>(__int64 a1, int a2, __m128i *a3)
{
  const char *v5; // r9
  __int64 v6; // r9
  __int64 *v7; // rcx
