/*
 * XREFs of ?CreateSpatialObjectWatcher@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEAUISpatialObject@234@AEBU_GUID@@PEAUISpatialObjectWatcherCallback@234@PEAPEAUISpatialObjectWatcher@234@@Z @ 0x1800D7500
 * Callers:
 *     <none>
 * Callees:
