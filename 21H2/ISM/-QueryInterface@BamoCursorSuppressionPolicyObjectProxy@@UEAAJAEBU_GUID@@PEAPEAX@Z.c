/*
 * XREFs of ?QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800EA380
 * Callers:
 *     ?QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004BE40 (-QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
