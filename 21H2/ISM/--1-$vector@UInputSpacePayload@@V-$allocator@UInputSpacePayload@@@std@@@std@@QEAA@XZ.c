/*
 * XREFs of ??1?$vector@UInputSpacePayload@@V?$allocator@UInputSpacePayload@@@std@@@std@@QEAA@XZ @ 0x18012C5F4
 * Callers:
 *     _std::variant_std::monostate_HeatInputConfigContextMessage_HeatLowPowerStateContextMessage_HeatHingeAngleContextMessage_HeatDisplayOcclusionContextMessage_HeatVirtualTouchpadContextMessage_::emplace_HeatInputConfigContextMessage_unsigned_long_&_INPUT_SPACE_PAYLOAD___&_1_0__::_1_::dtor$1 @ 0x18012C028 (_std--variant_std--monostate_HeatInputConfigContextMessage_HeatLowPowerStateContextMessage_HeatH.c)
 * Callees:
