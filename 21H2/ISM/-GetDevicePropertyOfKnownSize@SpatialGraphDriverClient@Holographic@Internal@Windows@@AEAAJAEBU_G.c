/*
 * XREFs of ?GetDevicePropertyOfKnownSize@SpatialGraphDriverClient@Holographic@Internal@Windows@@AEAAJAEBU_GUID@@PEAX_KP6AJPEBX_K@ZW4PropertyCacheBehavior@234@@Z @ 0x18015C1FC
 * Callers:
 ...
 *     ?GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAA_NXZ @ 0x18015EF80 (-GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAA_NXZ.c)
 * Callees:
