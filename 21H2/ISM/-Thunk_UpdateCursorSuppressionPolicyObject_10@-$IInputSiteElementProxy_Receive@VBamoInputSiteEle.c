/*
 * XREFs of ?Thunk_UpdateCursorSuppressionPolicyObject_10@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000F5A0
 * Callers:
 *     <none>
 * Callees:
