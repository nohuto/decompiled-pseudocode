/*
 * XREFs of ?GetSystemDirPath@GameInputModule@@CAJPEBGAEAV?$unique_ptr@$$BY0A@GU?$default_delete@$$BY0A@G@std@@@std@@PEA_K@Z @ 0x180011864
 * Callers:
...
__int64 __fastcall GameInputModule::GetSystemDirPath(__int64 a1, const struct std::nothrow_t *a2)
{
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  if ( v16 != v7 - 1 )
  {
    if ( v16 )
    {
      wil::details::in1diag0::Return_Hr((wil::details::in1diag0 *)0x8000FFFFLL, (int)v15);
      operator delete(v13, v20);
      return 2147549183LL;
    }
