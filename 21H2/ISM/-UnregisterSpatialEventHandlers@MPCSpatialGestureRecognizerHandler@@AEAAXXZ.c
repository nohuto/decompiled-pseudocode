/*
 * XREFs of ?UnregisterSpatialEventHandlers@MPCSpatialGestureRecognizerHandler@@AEAAXXZ @ 0x180082378
 * Callers:
 *     ??1MPCSpatialGestureRecognizerHandler@@UEAA@XZ @ 0x18008038C (--1MPCSpatialGestureRecognizerHandler@@UEAA@XZ.c)
 * Callees:
