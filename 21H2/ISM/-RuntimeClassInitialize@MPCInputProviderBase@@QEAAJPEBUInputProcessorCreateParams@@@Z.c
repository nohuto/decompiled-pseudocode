/*
 * XREFs of ?RuntimeClassInitialize@MPCInputProviderBase@@QEAAJPEBUInputProcessorCreateParams@@@Z @ 0x18001F7C0
 * Callers:
 ...
 *     ?Initialize@MPCPerfCounter@@QEAAXKI@Z @ 0x18001F998 (-Initialize@MPCPerfCounter@@QEAAXKI@Z.c)
