/*
 * XREFs of ?UpdateSimulatedPose@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAX_JAEBUPoseData@SpatialInteractionDevices@@PEAUISpatialGraphNodeReference@Holographic@34@AEBUMatrix4x4@Numerics@Foundation@4@3@Z @ 0x1801702C0
 * Callers:
        ...
        const struct Windows::Foundation::Numerics::Matrix4x4 *a6)
{
  ...
  else
  {
    ...
    v43[0] = a2;
    v12 = (__m128)xmmword_1801C74C0;
    v44 = 3;
    v13 = (__m128)xmmword_1801C74D0;
    v47 = xmmword_1801C74E0;
    v45 = xmmword_1801C74C0;
    v46 = xmmword_1801C74D0;
  }
