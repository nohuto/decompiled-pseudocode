/*
 * XREFs of ?get@?$static_lazy@VSpatialInteractionTrace@SpatialInteractionDevices@@@details@wil@@QEAAPEAVSpatialInteractionTrace@SpatialInteractionDevices@@P6AXXZ@Z @ 0x1800C7254
 * Callers:
...
LPVOID __fastcall wil::details::static_lazy<SpatialInteractionDevices::SpatialInteractionTrace>::get(
        __int64 a1,
        void (__cdecl *a2)())
{
    ...
    && (_DWORD)v4 )
  {
    ...
    qword_180209600 = (struct _tlgProvider_t *)&`SpatialInteractionDevices::SpatialInteractionTrace::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_1802095E8, qword_180209600, 0LL);
    InitOnceComplete(&`SpatialInteractionDevices::SpatialInteractionTrace::Instance'::`2'::wrapper, 0, &qword_1802095E8);
  }
  return v5;
}
