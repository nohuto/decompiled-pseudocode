/*
 * XREFs of ?Release@DWMCursor@@UEAAKXZ @ 0x1800104C0
 * Callers:
 *     ?Release@DWMCursor@@W7EAAKXZ @ 0x18004CF90 (-Release@DWMCursor@@W7EAAKXZ.c)
 *     ?Release@DWMCursor@@WBA@EAAKXZ @ 0x18004CFA0 (-Release@DWMCursor@@WBA@EAAKXZ.c)
 * Callees:
