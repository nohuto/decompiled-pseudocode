/*
 * XREFs of ?QueryInterface@BamoDataProviderPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180143440
 * Callers:
 *     ?QueryInterface@BamoDataProviderPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004D2D0 (-QueryInterface@BamoDataProviderPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
