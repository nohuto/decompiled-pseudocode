/*
 * XREFs of ??0DeviceState@MagnifierProcessor@@QEAA@XZ @ 0x18017CCA4
 * Callers:
 ...
 *     ??0GestureState@MagnifierRecognizer@@QEAA@XZ @ 0x18017CD50 (--0GestureState@MagnifierRecognizer@@QEAA@XZ.c)
 */
