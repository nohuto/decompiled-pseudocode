/*
 * XREFs of ?EnsureSubscribedToFeatureConfigurationChangesImpl@EnabledStateManager@details@wil@@AEAAIXZ @ 0x18003DA18
 * Callers:
        ...
        RTL_SRWLOCK *this)
{
  ...
  RTL_SRWLOCK *v3; // rsi
  void (__fastcall *v4)(RTL_SRWLOCK *, void (__fastcall *)(wil::details::EnabledStateManager *), RTL_SRWLOCK *); // rax
  ...
  {
    v4 = (void (__fastcall *)(RTL_SRWLOCK *, void (__fastcall *)(wil::details::EnabledStateManager *), RTL_SRWLOCK *))g_wil_details_internalSubscribeFeatureStateChangeNotification;
    v3->Ptr = 0LL;
    if ( v4
      || (v4 = (void (__fastcall *)(RTL_SRWLOCK *, void (__fastcall *)(wil::details::EnabledStateManager *), RTL_SRWLOCK *))g_wil_details_apiSubscribeFeatureStateChangeNotification) != 0LL )
    {
