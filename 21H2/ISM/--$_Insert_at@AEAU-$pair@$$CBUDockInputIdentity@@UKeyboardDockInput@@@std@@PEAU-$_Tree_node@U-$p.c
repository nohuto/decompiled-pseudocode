/*
 * XREFs of ??$_Insert_at@AEAU?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAU?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAX@2@@?$_Tree@V?$_Tmap_traits@UDockInputIdentity@@UKeyboardDockInput@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@@4@$0A@@std@@@std@@IEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@@std@@@std@@@1@_NPEAU?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAX@1@AEAU?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@1@1@Z @ 0x1801255C0
 * Callers:
 *     ??$_Insert_hint@AEAU?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAU?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAX@2@@?$_Tree@V?$_Tmap_traits@UDockInputIdentity@@UKeyboardDockInput@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@@4@$0A@@std@@@std@@IEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@@std@@@std@@@1@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@@std@@@std@@@1@AEAU?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@1@PEAU?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAX@1@@Z @ 0x1801258B0 (--$_Insert_hint@AEAU-$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAU-$_Tree_node@U-.c)
 *     ??$_Insert_nohint@AEAU?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAU?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAX@2@@?$_Tree@V?$_Tmap_traits@UDockInputIdentity@@UKeyboardDockInput@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@@4@$0A@@std@@@std@@IEAA?AU?$pair@V?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@@std@@@std@@@std@@_N@1@_NAEAU?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@1@PEAU?$_Tree_node@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAX@1@@Z @ 0x180125CC8 (--$_Insert_nohint@AEAU-$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@PEAU-$_Tree_node@.c)
 * Callees:
...
_QWORD *__fastcall std::_Tree<std::_Tmap_traits<DockInputIdentity,KeyboardDockInput,std::less<DockInputIdentity>,std::allocator<std::pair<DockInputIdentity const,KeyboardDockInput>>,0>>::_Insert_at<std::pair<DockInputIdentity const,KeyboardDockInput> &,std::_Tree_node<std::pair<DockInputIdentity const,KeyboardDockInput>,void *> *>(
        __int64 *a1,
        _QWORD *a2,
        char a3,
        _QWORD *a4,
        ...
        _QWORD *a6)
{
  ...
  {
    std::_Deallocate<16,0>(a6, (const struct std::nothrow_t *)0x68);
