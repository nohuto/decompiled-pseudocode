/*
 * XREFs of ?Initialize@HidLampArrayDevice@@AEAAJPEAVPnpDevice@@@Z @ 0x1800A716C
 * Callers:
 ...
 *     ?KeyboardHidUsageToVKey@HidUsageConverter@@SAIG@Z @ 0x1800A9B30 (-KeyboardHidUsageToVKey@HidUsageConverter@@SAIG@Z.c)
 */
