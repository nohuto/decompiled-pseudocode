/*
 * XREFs of ?Release@ConsumerControlManager@@UEAAKXZ @ 0x1800A03B0
 * Callers:
 ...
 *     ?WorkerThreadProcThunk@ConsumerControlManager@@CAKPEAX@Z @ 0x1800A0540 (-WorkerThreadProcThunk@ConsumerControlManager@@CAKPEAX@Z.c)
 * Callees:
 *     ?Release@RefCountedObject@@UEAAKXZ @ 0x180037280 (-Release@RefCountedObject@@UEAAKXZ.c)
 *     ?Shutdown@ConsumerControlManager@@AEAAXXZ @ 0x1800A03E8 (-Shutdown@ConsumerControlManager@@AEAAXXZ.c)
 */
