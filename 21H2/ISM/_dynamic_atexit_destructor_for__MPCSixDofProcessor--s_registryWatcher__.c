/*
 * XREFs of _dynamic_atexit_destructor_for__MPCSixDofProcessor::s_registryWatcher__ @ 0x180052630
 * Callers:
 *     <none>
 * Callees:
 *     ??$invoke@P6AXPEAUregistry_watcher_state@details@wil@@@ZAEAPEAU123@@wistd@@YAX$$QEAP6AXPEAUregistry_watcher_state@details@wil@@@ZAEAPEAU123@@Z @ 0x18003B30C (--$invoke@P6AXPEAUregistry_watcher_state@details@wil@@@ZAEAPEAU123@@wistd@@YAX$$QEAP6AXPEAUregis.c)
 */
