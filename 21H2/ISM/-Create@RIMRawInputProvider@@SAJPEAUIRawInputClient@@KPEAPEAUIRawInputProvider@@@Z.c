/*
 * XREFs of ?Create@RIMRawInputProvider@@SAJPEAUIRawInputClient@@KPEAPEAUIRawInputProvider@@@Z @ 0x180020460
 * Callers:
 *     <none>
 * Callees:
 *     ??0RIMRawInputProvider@@IEAA@PEAUIRawInputClient@@@Z @ 0x1800202CC (--0RIMRawInputProvider@@IEAA@PEAUIRawInputClient@@@Z.c)
