/*
 * XREFs of ??1?$map@KV?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@wil@@U?$less@K@std@@V?$allocator@U?$pair@$$CBKV?$com_ptr_t@VMPCGestureHandler@@Uerr_exception_policy@wil@@@wil@@@std@@@4@@std@@QEAA@XZ @ 0x18006B208
 * Callers:
 *     _MPCGestureHandlerManager::MPCGestureHandlerManager_::_1_::dtor$0 @ 0x18006B1AA (_MPCGestureHandlerManager--MPCGestureHandlerManager_--_1_--dtor$0.c)
 * Callees:
