/*
 * XREFs of ?AddNodePropertyRequests@SpatialGraphDriverClient@Holographic@Internal@Windows@@AEAAXAEAVHolographicDriverHandleWrapper@234@AEBUSPATIAL_NODE_ID@@@Z @ 0x180159920
 * Callers:
        ...
        int a4)
{
  ...
  while ( v10 != &HolographicDriverClientTrace::TelemetryCloseHolographicDevice::`vftable' );
}
