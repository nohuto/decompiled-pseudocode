/*
 * XREFs of ??0InfoMetadata@@QEAA@XZ @ 0x1801A460C
 * Callers:
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_ce8a15022103a02b96acfc2f7dcf1bbe_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x1801A4140 (--$_Callback_once@V-$tuple@$$QEAV_lambda_ce8a15022103a02b96acfc2f7dcf1bbe_@@AEAVexception_ptr@st.c)
 * Callees:
 *     __security_check_cookie @ 0x18003C220 (__security_check_cookie.c)
 *     ??0InputInfoMetadata@InfoMetadata@@QEAA@$$QEAU01@@Z @ 0x1801A4770 (--0InputInfoMetadata@InfoMetadata@@QEAA@$$QEAU01@@Z.c)
 *     ??1InputInfoMetadata@InfoMetadata@@QEAA@XZ @ 0x1801A4A5C (--1InputInfoMetadata@InfoMetadata@@QEAA@XZ.c)
