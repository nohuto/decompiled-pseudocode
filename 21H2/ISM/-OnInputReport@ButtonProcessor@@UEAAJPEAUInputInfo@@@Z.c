/*
 * XREFs of ?OnInputReport@ButtonProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x180188020
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z @ 0x180187D68 (-ButtonToVKeyMapping@ButtonProcessor@@AEAAJKPEAG@Z.c)
 */
