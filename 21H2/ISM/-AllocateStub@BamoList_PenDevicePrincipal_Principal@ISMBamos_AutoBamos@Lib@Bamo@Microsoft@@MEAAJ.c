/*
 * XREFs of ?AllocateStub@BamoList_PenDevicePrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@MEAAJPEAVBamoPeer@2@PEAPEAVBamoList_PenDevicePrincipal_Stub@2345@@Z @ 0x18012EFE0
 * Callers:
 *     <none>
 * Callees:
