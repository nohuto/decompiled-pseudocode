/*
 * XREFs of ?Create@ComboButtonProcessor@@SAJPEAPEAV1@@Z @ 0x180171E98
 * Callers:
 ...
 *     ?Initialize@ComboButtonProcessor@@AEAAJXZ @ 0x180171FAC (-Initialize@ComboButtonProcessor@@AEAAJXZ.c)
 */
