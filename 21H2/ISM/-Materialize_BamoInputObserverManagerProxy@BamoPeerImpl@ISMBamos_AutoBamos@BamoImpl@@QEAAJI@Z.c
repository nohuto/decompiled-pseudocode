/*
 * XREFs of ?Materialize_BamoInputObserverManagerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7A40
 * Callers:
 *     ?Thunk_Materialize_BamoInputObserverManagerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF80 (-Thunk_Materialize_BamoInputObserverManagerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoInputObserverManagerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoInputObserverManagerProxy::`vftable'{for `IInputObserverManagerProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
