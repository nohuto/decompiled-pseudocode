/*
 * XREFs of ?GetCurrentMicroSecTime@QpcTimeConverter@@QEBA_KXZ @ 0x180088924
 * Callers:
 *     ?ShellButtonRepeatCallback@GameControllerRawInputProvider@@CAJPEAX@Z @ 0x180041970 (-ShellButtonRepeatCallback@GameControllerRawInputProvider@@CAJPEAX@Z.c)
