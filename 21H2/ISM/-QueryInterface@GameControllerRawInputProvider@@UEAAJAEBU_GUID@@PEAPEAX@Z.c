/*
 * XREFs of ?QueryInterface@GameControllerRawInputProvider@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800188B0
 * Callers:
 *     ?QueryInterface@GameControllerRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B5C0 (-QueryInterface@GameControllerRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GameControllerRawInputProvider@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B5D0 (-QueryInterface@GameControllerRawInputProvider@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GameControllerRawInputProvider@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B5E0 (-QueryInterface@GameControllerRawInputProvider@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
