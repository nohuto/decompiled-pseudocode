/*
 * XREFs of ?Materialize_BamoContainerInfoInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E6C08
 * Callers:
 *     ?Thunk_Materialize_BamoContainerInfoInputObjectProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECDE0 (-Thunk_Materialize_BamoContainerInfoInputObjectProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@V.c)
 * Callees:
