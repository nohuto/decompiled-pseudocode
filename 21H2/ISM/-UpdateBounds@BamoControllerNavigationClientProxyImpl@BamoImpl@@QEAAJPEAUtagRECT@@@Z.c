/*
 * XREFs of ?UpdateBounds@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJPEAUtagRECT@@@Z @ 0x18011EB80
 * Callers:
 ...
 *     ?Thunk_UpdateBounds_39@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011EB00 (-Thunk_UpdateBounds_39@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClien.c)
 * Callees:
