/*
 * XREFs of ?BroadcastRemoteReplace@BamoList_PenDevicePrincipal_Principal@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJIPEAVBamoPenDevicePrincipal@@@Z @ 0x18012F6D0
 * Callers:
 *     <none>
 * Callees:
