/*
 * XREFs of ?UnregisterCursor@DWMCursorBroker@@QEAAJPEAVDWMCursor@@@Z @ 0x18019C42C
 * Callers:
 *     ??1DWMCursor@@MEAA@XZ @ 0x18019C944 (--1DWMCursor@@MEAA@XZ.c)
 * Callees:
 ...
 *     ?SendAndVerifyEndpoints@DWMCursorBroker@@AEAAJPEAUCursorMessage@@@Z @ 0x18019C1EC (-SendAndVerifyEndpoints@DWMCursorBroker@@AEAAJPEAUCursorMessage@@@Z.c)
