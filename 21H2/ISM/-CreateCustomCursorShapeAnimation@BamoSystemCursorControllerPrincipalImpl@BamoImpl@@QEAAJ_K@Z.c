/*
 * XREFs of ?CreateCustomCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x18013C090
 * Callers:
 *     ?Thunk_CreateCustomCursorShapeAnimation_2@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013D2A0 (-Thunk_CreateCustomCursorShapeAnimation_2@-$ISystemCursorControllerPrincipal_Receive@VBamoSystem.c)
 * Callees:
