/*
 * XREFs of ?OnKeyboardDockInput@BamoKeyboardDockClientProxy@@UEAAJIAEBUKeyboardDockInput@@@Z @ 0x180129470
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OnKeyboardDockInput@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJIAEBUKeyboardDockInput@@@Z @ 0x1801294DC (-OnKeyboardDockInput@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJIAEBUKeyboardDockInput@@@Z.c)
 */
