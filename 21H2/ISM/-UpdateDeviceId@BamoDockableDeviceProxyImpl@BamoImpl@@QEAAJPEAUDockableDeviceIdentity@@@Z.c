/*
 * XREFs of ?UpdateDeviceId@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJPEAUDockableDeviceIdentity@@@Z @ 0x1800EDD18
 * Callers:
 ...
 *     ?Thunk_UpdateDeviceId_58@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED1F0 (-Thunk_UpdateDeviceId_58@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@.c)
 * Callees:
