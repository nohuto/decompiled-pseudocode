 ...
 *     ?_Change_array@?$vector@UHandInputInfo@SpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@V?$allocator@UHandInputInfo@SpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@@std@@@std@@AEAAXQEAUHandInputInfo@SpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@_K1@Z @ 0x1800E23F4 (-_Change_array@-$vector@UHandInputInfo@SpatialInteractionSourceHand@SpatialInteractions@Internal.c)
 */
