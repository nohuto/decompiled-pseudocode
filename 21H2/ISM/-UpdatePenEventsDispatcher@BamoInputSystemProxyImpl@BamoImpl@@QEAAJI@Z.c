/*
 * XREFs of ?UpdatePenEventsDispatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF3F0
 * Callers:
 ...
 *     ?Thunk_UpdatePenEventsDispatcher_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED3D0 (-Thunk_UpdatePenEventsDispatcher_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
