/*
 * XREFs of ??0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x18001DE50
 * Callers:
 *     ??0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x180036B04 (--0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ.c)
 * Callees:
 *     <none>
 */
