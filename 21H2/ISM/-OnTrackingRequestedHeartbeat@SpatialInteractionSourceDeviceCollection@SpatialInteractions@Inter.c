/*
 * XREFs of ?OnTrackingRequestedHeartbeat@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJKPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800D1970
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CanSwitchTo6DOF@SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA_NXZ @ 0x1800CF1FC (-CanSwitchTo6DOF@SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA_NXZ.c)
    ...
    if ( (*(unsigned __int8 (__fastcall **)(Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice *))(*(_QWORD *)v22[0] + 104LL))(v22[0]) )
    {
      ...
      *(_QWORD *)v24 = (**(__int64 (__fastcall ***)(Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice *))v6)(v6);
      ...
      if ( Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice::CanSwitchTo6DOF(v6) )
      {
        ...
        v25.m256i_i64[0] = (__int64)off_1801B1928;
        LOBYTE(v13) = 1;
        v26 = &v25;
