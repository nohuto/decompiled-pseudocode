/*
 * XREFs of ?FeedAnimationData@SystemCursorShape@@AEAAJXZ @ 0x18013FDB4
 * Callers:
 ...
 *     ?lock@?$weak_ptr@VSystemCursorService@@@std@@QEBA?AV?$shared_ptr@VSystemCursorService@@@2@XZ @ 0x180140FD0 (-lock@-$weak_ptr@VSystemCursorService@@@std@@QEBA-AV-$shared_ptr@VSystemCursorService@@@2@XZ.c)
 */
