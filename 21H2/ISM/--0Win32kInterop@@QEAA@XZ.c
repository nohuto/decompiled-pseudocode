/*
 * XREFs of ??0Win32kInterop@@QEAA@XZ @ 0x18002332C
 * Callers:
 ...
 *     ??0?$_Hash@V?$_Umap_traits@KPEAVInputInfoValidator@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKPEAVInputInfoValidator@@@std@@@3@$0A@@std@@@std@@QEAA@AEBV?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@1@AEBV?$allocator@U?$pair@$$CBKPEAVInputInfoValidator@@@std@@@1@@Z @ 0x18002ACD8 (--0-$_Hash@V-$_Umap_traits@KPEAVInputInfoValidator@@V-$_Uhash_compare@KU-$hash@K@std@@U-$equal_t.c)
 *     ??_L@YAXPEAX_K1P6AX0@Z2@Z @ 0x18003D06C (--_L@YAXPEAX_K1P6AX0@Z2@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_ACCESSIBILITY_TIMER@@@@QEAA@PEBD@Z @ 0x180041E5C (--0-$KernelInputConnection@U_MIT_ACCESSIBILITY_TIMER@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041E88 (--0-$KernelInputConnection@U_MIT_DEVICE_IDENTIFICATION_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_HOTKEY_REGISTRATION_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041EB4 (--0-$KernelInputConnection@U_MIT_HOTKEY_REGISTRATION_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_INPUT_INTEROP_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041EE0 (--0-$KernelInputConnection@U_MIT_INPUT_INTEROP_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_KEYBOARD_INPUT_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041F04 (--0-$KernelInputConnection@U_MIT_KEYBOARD_INPUT_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041F30 (--0-$KernelInputConnection@U_MIT_KEYBOARD_OVERRIDER_INPUT_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_MOUSE_INPUT_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041F5C (--0-$KernelInputConnection@U_MIT_MOUSE_INPUT_MESSAGE@@@@QEAA@PEBD@Z.c)
 *     ??0?$KernelInputConnection@U_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@@@QEAA@PEBD@Z @ 0x180041F88 (--0-$KernelInputConnection@U_MIT_PNP_DEVICE_NOTIFICATION_MESSAGE@@@@QEAA@PEBD@Z.c)
 */
