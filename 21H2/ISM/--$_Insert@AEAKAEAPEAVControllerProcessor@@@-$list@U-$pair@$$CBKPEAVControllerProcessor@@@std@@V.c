...
_QWORD *__fastcall std::list<std::pair<unsigned long const,ControllerProcessor *>>::_Insert<unsigned long &,ControllerProcessor * &>(
        __int64 a1,
        __int64 a2,
        _DWORD *a3,
        _QWORD *a4)
