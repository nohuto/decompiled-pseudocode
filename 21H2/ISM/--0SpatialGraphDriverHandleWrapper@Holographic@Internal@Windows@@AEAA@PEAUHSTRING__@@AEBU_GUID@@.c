/*
 * XREFs of ??0SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@AEAA@PEAUHSTRING__@@AEBU_GUID@@W4HandleWrapperDesiredAccess@123@_NPEAX@Z @ 0x180156F54
 * Callers:
 ...
 *     ??0ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ @ 0x1801569F0 (--0ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ.c)
