/*
 * XREFs of _ISMHeatFrameworkHost::BroadcastContextMessage_::_1_::dtor$0 @ 0x18012CB53
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall ISMHeatFrameworkHost::BroadcastContextMessage_::_1_::dtor_0(__int64 a1, __int64 a2)
{
