/*
 * XREFs of ??1PropertyCache@Holographic@Internal@Windows@@QEAA@XZ @ 0x180157E4C
 * Callers:
 *     _Windows::Internal::Holographic::SpatialGraphDriverClient::SpatialGraphDriverClient_::_1_::dtor$6 @ 0x180156EEC (_Windows--Internal--Holographic--SpatialGraphDriverClient--SpatialGraphDriverClient_ea_180156EEC.c)
 * Callees:
