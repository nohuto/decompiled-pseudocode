/*
 * XREFs of ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x1800C38D8
 * Callers:
 ...
 *     ?TransitionZoomTypes@ManipulationInjector@@AEAAXXZ @ 0x1800C4018 (-TransitionZoomTypes@ManipulationInjector@@AEAAXXZ.c)
 *     ?UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z @ 0x1800C41F4 (-UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z.c)
 *     ?UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z @ 0x1800C4280 (-UpdateZoomContactsForThreshold@ManipulationInjector@@AEAAXI@Z.c)
 */
