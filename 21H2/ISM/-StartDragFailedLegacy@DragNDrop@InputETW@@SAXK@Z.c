/*
 * XREFs of ?StartDragFailedLegacy@DragNDrop@InputETW@@SAXK@Z @ 0x1801762BC
 * Callers:
...
void __fastcall InputETW::DragNDrop::StartDragFailedLegacy(unsigned int a1)
{
  ...
  if ( InputETW::IsVerboseEnabled(1LL) )
  {
    ...
    if ( **((_DWORD **)v3 + 1) > 5u && tlgKeywordOn(*((_QWORD *)v3 + 1), 1LL) )
    {
      ...
      v5 = v1;
      v8 = 8;
      tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801D2721, 0LL, 0LL, 3u, &v6);
    }
  }
}
