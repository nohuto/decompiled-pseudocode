...
_QWORD *__fastcall std::_Tree_val<std::_Tree_simple_types<std::pair<unsigned int const,std::shared_ptr<CustomCursorApplication>>>>::_Extract(
        _QWORD *a1,
        _QWORD *a2)
{
  _QWORD *v3; // r11
  ...
  __int64 v16; // rcx
  __int64 v17; // rcx
  _QWORD *v19; // [rsp+38h] [rbp+10h] BYREF
...
LABEL_5:
    ...
    if ( *(_QWORD **)*a1 == v3 )
    {
      if ( *((_BYTE *)v4 + 25) )
        ...
        v9 = std::_Tree_val<std::_Tree_simple_types<std::pair<wil::com_ptr_t<MPCManagerBamo_AutoBamos::BamoPeer,wil::err_exception_policy> const,wil::com_ptr_t<IMPCManagerClientProxy,wil::err_exception_policy>>>>::_Min(v4);
      *v7 = v9;
      v7 = (_QWORD *)*a1;
      v8 = (_QWORD *)*a1;
    }
