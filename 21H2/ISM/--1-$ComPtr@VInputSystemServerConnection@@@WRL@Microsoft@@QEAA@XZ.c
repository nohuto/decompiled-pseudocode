/*
 * XREFs of ??1?$ComPtr@VInputSystemServerConnection@@@WRL@Microsoft@@QEAA@XZ @ 0x1800BBF0C
 * Callers:
 *     _InputSystemServerConnection::Create_::_1_::dtor$2 @ 0x180051A2E (_InputSystemServerConnection--Create_--_1_--dtor$2.c)
 * Callees:
