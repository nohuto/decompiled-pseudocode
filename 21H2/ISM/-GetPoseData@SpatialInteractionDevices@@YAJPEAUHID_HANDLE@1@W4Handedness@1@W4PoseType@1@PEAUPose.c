/*
 * XREFs of ?GetPoseData@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@W4Handedness@1@W4PoseType@1@PEAUPoseData@1@PEA_N@Z @ 0x1800C61DC
 * Callers:
 ...
 *     _anonymous_namespace_::GetPoseSubKey @ 0x1800C63D4 (_anonymous_namespace_--GetPoseSubKey.c)
