/*
 * XREFs of ?CursorExists@SystemCursorService@@QEAA_N_K@Z @ 0x18013C468
 * Callers:
 ...
 *     ?OnCursorDestroyed@SystemCursorService@@UEAAJUCursorId@@UCursorDestroyData@@@Z @ 0x1801402C0 (-OnCursorDestroyed@SystemCursorService@@UEAAJUCursorId@@UCursorDestroyData@@@Z.c)
 ...
 *     ?OnCursorSuppressionStateChanged@SystemCursorService@@UEAAJUCursorId@@UCursorSuppressionStateData@@@Z @ 0x180140510 (-OnCursorSuppressionStateChanged@SystemCursorService@@UEAAJUCursorId@@UCursorSuppressionStateDat.c)
