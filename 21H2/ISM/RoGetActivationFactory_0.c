/*
 * XREFs of RoGetActivationFactory_0 @ 0x18003CC5B
 * Callers:
...
// attributes: thunk
__int64 __fastcall RoGetActivationFactory_0(__int64 a1, __int64 a2, __int64 a3)
{
  return RoGetActivationFactory(a1, a2, a3);
}
