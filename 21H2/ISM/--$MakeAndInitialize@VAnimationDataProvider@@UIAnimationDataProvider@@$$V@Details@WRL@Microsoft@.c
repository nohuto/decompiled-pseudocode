/*
 * XREFs of ??$MakeAndInitialize@VAnimationDataProvider@@UIAnimationDataProvider@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIAnimationDataProvider@@@Z @ 0x18002C298
 * Callers:
 ...
 * Callees:
 *     ??0AnimationDataProvider@@QEAA@XZ @ 0x18002C4E0 (--0AnimationDataProvider@@QEAA@XZ.c)
