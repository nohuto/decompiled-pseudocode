/*
 * XREFs of ?Init@?$PayloadFieldHelper@W4SPATIAL_GAZE_CALIBRATION_REQUEST_EVENTS@@@Holographic@Internal@Windows@@QEAAJPEAUISpatialPayloadDescriptor@234@AEBU_GUID@@@Z @ 0x1800DBC44
 * Callers:
