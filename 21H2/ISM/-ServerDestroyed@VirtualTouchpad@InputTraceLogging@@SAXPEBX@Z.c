/*
 * XREFs of ?ServerDestroyed@VirtualTouchpad@InputTraceLogging@@SAXPEBX@Z @ 0x1800F0CB4
 * Callers:
...
void __fastcall InputTraceLogging::VirtualTouchpad::ServerDestroyed(__int64 a1)
{
  ...
  if ( **((_DWORD **)v2 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v2 + 1), 512LL) )
  {
    ...
    v4 = a1;
    v7 = 8;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1801CE300, 0LL, 0LL, 3u, &v5);
  }
}
