/*
 * XREFs of ?RequestGripStatusForPanel@BamoHeatGripServicePrincipalImpl@BamoImpl@@QEAAJPEAUHeatPanelInfo@@@Z @ 0x18012A968
 * Callers:
 *     ?Thunk_RequestGripStatusForPanel_146@?$IHeatGripServicePrincipal_Receive@VBamoHeatGripServicePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18012AB20 (-Thunk_RequestGripStatusForPanel_146@-$IHeatGripServicePrincipal_Receive@VBamoHeatGripServicePri.c)
 * Callees:
        ...
        struct HeatPanelInfo *a2)
{
  ...
  v7 = (*(__int64 (__fastcall **)(char *, __int64, struct HeatPanelInfo *))(*((_QWORD *)this - 2) + 72LL))(
         (char *)this - 16,
         v6,
         a2);
  if ( v7 < 0 )
