/*
 * XREFs of ?SendMaterializeProxy@BamoAsyncResult_string_PrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18011B380
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v15, 2LL, 1LL, 3, &unk_1801C2933, v13);
  if ( v8 < 0 )
  {
  ...
  v16 = *(unsigned int *)(v3 + 40);
  LOWORD(v12) = 8;
  v11 = CoreUICallSend(a2, &v15, 2LL, 1LL, v12, &unk_1801C2933, v14);
  if ( v11 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
