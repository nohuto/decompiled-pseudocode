/*
 * XREFs of ?_Do_call@?$_Func_impl_no_alloc@V?$_Binder@U_Unforced@std@@P8GameInputProcessor@@EAAXPEAUDeviceInfo@@@ZPEAV3@AEBU?$_Ph@$00@2@@std@@XPEAUDeviceInfo@@@std@@EEAAX$$QEAPEAUDeviceInfo@@@Z @ 0x180038410
 * Callers:
 *     <none>
 * Callees:
 *     <none>
