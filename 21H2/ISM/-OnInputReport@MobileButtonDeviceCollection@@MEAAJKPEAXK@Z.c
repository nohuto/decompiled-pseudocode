/*
 * XREFs of ?OnInputReport@MobileButtonDeviceCollection@@MEAAJKPEAXK@Z @ 0x180098680
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  if ( a4 >= v15 )
  {
    while ( 1 )
    {
      Usages = HidP_GetUsages(HidP_Input, 7u, 0, UsageList, &UsageLength, PreparsedData, Report, (unsigned __int16)v15);
      if ( Usages < 0 )
      {
        v30 = 246LL;
      ...
      if ( MakeUsageList[0] )
      {
        while ( 1 )
        {
          ...
          DeviceInfo = MobileButtonDeviceCollection::CreateButtonInfo(
                         (MobileButtonDeviceCollection *)*v27,
                         a2,
                         TickCount,
                         PerformanceCount,
                         *v27,
                         1,
                         (struct InputInfo *)v37);
          if ( DeviceInfo < 0 )
            break;
