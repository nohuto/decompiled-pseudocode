/*
 * XREFs of ?CreateAndInitialize@HidLampMultiUpdateReportBuilder@@SAJPEAVHidLampArrayDevice@@IPEAPEAV1@@Z @ 0x1800A97C0
 * Callers:
 ...
 *     ??0HidLampMultiUpdateReportBuilder@@AEAA@XZ @ 0x1800A9638 (--0HidLampMultiUpdateReportBuilder@@AEAA@XZ.c)
