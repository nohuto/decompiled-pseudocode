/*
 * XREFs of ?Initialize@DockDevice@@QEAAJPEAUDockDeviceInfo@@@Z @ 0x18009E598
 * Callers:
...
__int64 __fastcall DockDevice::Initialize(DockDevice *this, struct DockDeviceInfo *a2)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_QWORD *)&v40 = LinkCollectionNodes;
    ...
    if ( v10 >= 0 )
    {
      if ( dword_18020A4FC > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                       + 16LL) )
      {
        Init_thread_header(&dword_18020A4FC);
        if ( dword_18020A4FC == -1 )
        {
          dword_18020A398 = 2;
          *(_OWORD *)&xmmword_18020A388 = DEVPKEY_Device_PanelId;
          dword_18020A39C = 0;
          qword_18020A3A0 = 0LL;
          Init_thread_footer(&dword_18020A4FC);
        }
      }
