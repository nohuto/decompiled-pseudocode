/*
 * XREFs of ?OnSetPropertyValueError@BamoDataSourcePrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18014333C
 * Callers:
 *     ?Thunk_OnSetPropertyValueError_5@?$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180144BF0 (-Thunk_OnSetPropertyValueError_5@-$IDataSourcePrincipal_Receive@VBamoDataSourcePrincipalImpl@Bam.c)
 * Callees:
