/*
 * XREFs of ?QueryInterface@BamoVirtualTouchpadControllerProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F0B90
 * Callers:
 *     ?QueryInterface@BamoVirtualTouchpadControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004BFE0 (-QueryInterface@BamoVirtualTouchpadControllerProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
