/*
 * XREFs of ?TryCreateAndInitialize@HidLampArrayAttributesReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800A9FA0
 * Callers:
 ...
 *     ??0HidLampArrayAttributesReportParser@@AEAA@XZ @ 0x1800A9BE8 (--0HidLampArrayAttributesReportParser@@AEAA@XZ.c)
