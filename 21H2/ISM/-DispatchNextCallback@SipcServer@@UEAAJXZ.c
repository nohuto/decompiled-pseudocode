/*
 * XREFs of ?DispatchNextCallback@SipcServer@@UEAAJXZ @ 0x180039730
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Disconnect@SipcEndpoint@@QEAAX_N@Z @ 0x1800C0494 (-Disconnect@SipcEndpoint@@QEAAX_N@Z.c)
 *     ?DispatchNextCallback@SipcEndpoint@@QEAAJPEAX@Z @ 0x1800C0568 (-DispatchNextCallback@SipcEndpoint@@QEAAJPEAX@Z.c)
