/*
 * XREFs of Windows::Internal::COperationLambdaVar_0__lambda_a408cc100a5b103155a70fabf7a2049b__Windows::Internal::CNoResult_::_scalar_deleting_destructor_ @ 0x1801124C0
 * Callers:
 *     <none>
 * Callees:
