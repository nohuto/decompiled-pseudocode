  ...
  for ( i = 0; i < 3; ++i )
    result = result
          && (int)SpatialInteractionDevices::Internal::HIDGetFloat(
                    this,
                    a2,
                    (struct SpatialInteractionDevices::HID_REPORT *)&unk_1801AEDE0,
                    (enum _HIDP_REPORT_TYPE)*((unsigned __int16 *)&unk_1801AEDE0 + 8 * i),
                    *((_WORD *)&unk_1801AEDE0 + 8 * i + 1),
                    *((_WORD *)&unk_1801AEDE0 + 8 * i + 2),
                    *((_WORD *)&unk_1801AEDE0 + 8 * i + 3),
