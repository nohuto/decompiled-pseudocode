/*
 * XREFs of ?OnConstantChanged@BamoMPCConstantManagerClientCallbacksProxyImpl@BamoImpl@@QEAAJW4InputType@@PEBGAEBUtagPROPVARIANT@@2@Z @ 0x180109064
 * Callers:
...
LABEL_3:
  ...
  v21 = v15;
  v22 = v16;
  return CoreUICallSend(v11, v18, 2LL, 2LL, 0, &unk_1801C295C, a2);
}
