/*
 * XREFs of ?OnDockDeviceRemoved@BamoKeyboardDockClientProxy@@UEAAJI@Z @ 0x180128ED0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OnDockDeviceRemoved@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180128F2C (-OnDockDeviceRemoved@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJI@Z.c)
 */
