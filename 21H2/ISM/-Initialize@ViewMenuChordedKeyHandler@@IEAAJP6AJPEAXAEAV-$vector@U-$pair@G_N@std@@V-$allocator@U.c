/*
 * XREFs of ?Initialize@ViewMenuChordedKeyHandler@@IEAAJP6AJPEAXAEAV?$vector@U?$pair@G_N@std@@V?$allocator@U?$pair@G_N@std@@@2@@std@@_N@Z0AEBV23@@Z @ 0x180124BE8
 * Callers:
 ...
 *     ??$_Assign_range@PEAU?$pair@G_N@std@@@?$vector@U?$pair@G_N@std@@V?$allocator@U?$pair@G_N@std@@@2@@std@@AEAAXPEAU?$pair@G_N@1@0Uforward_iterator_tag@1@@Z @ 0x1801244E4 (--$_Assign_range@PEAU-$pair@G_N@std@@@-$vector@U-$pair@G_N@std@@V-$allocator@U-$pair@G_N@std@@@2.c)
 */
...
__int64 ViewMenuChordedKeyHandler::Initialize(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v5 = (__int128 *)(a1 + 80);
  if ( v5 != &xmmword_180209C60 )
    std::vector<std::pair<unsigned short,bool>>::_Assign_range<std::pair<unsigned short,bool> *>(
      (__int64)v5,
      xmmword_180209C60,
      *((unsigned __int64 *)&xmmword_180209C60 + 1));
  *(_QWORD *)(a1 + 32) = ControllerProcessor::TaskSwitcherInvokedCallbackStatic;
  *(_QWORD *)(a1 + 40) = a3;
  *(_DWORD *)(a1 + 16) = 1;
  v13 = 0LL;
  Microsoft::WRL::ComPtr<IMessageProxy>::InternalRelease((__int64 *)va);
  v6 = CoreUICreate((__int64 *)va);
  v7 = v6;
  if ( v6 >= 0 )
  {
    v9 = v13;
    v10 = *(__int64 (__fastcall **)(__int64, int (__fastcall *)(ViewMenuChordedKeyHandler *), __int64, __int64))(*(_QWORD *)v13 + 136LL);
