/*
 * XREFs of ?GetActivationConfigurationInputObject@BamoInputSiteElementProxy@@UEAAPEAVBamoActivationConfigurationInputObjectProxy@@XZ @ 0x180010470
 * Callers:
 *     <none>
 * Callees:
