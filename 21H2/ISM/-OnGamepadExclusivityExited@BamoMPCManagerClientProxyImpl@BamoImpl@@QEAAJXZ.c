/*
 * XREFs of ?OnGamepadExclusivityExited@BamoMPCManagerClientProxyImpl@BamoImpl@@QEAAJXZ @ 0x18010934C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerClientProxyImpl::OnGamepadExclusivityExited(
