/*
 * XREFs of ?SetButtonLatencyMicroseconds@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAAXH@Z @ 0x18016EDF8
 * Callers:
        ...
        int a2)
{
  ...
  _InterlockedExchange64((volatile __int64 *)this + 86, qword_180209348 * a2 / 1000000);
