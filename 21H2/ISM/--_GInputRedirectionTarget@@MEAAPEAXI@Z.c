/*
 * XREFs of ??_GInputRedirectionTarget@@MEAAPEAXI@Z @ 0x18017F944
 * Callers:
 *     ??_EInputRedirectionTarget@@OBA@EAAPEAXI@Z @ 0x18004DAA0 (--_EInputRedirectionTarget@@OBA@EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1InputRedirectionTarget@@MEAA@XZ @ 0x18017F8A4 (--1InputRedirectionTarget@@MEAA@XZ.c)
 */
