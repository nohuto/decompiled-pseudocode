/*
 * XREFs of ?QueryInterface@BamoEdgyControllerServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801006A0
 * Callers:
 *     ?QueryInterface@BamoEdgyControllerServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C0F0 (-QueryInterface@BamoEdgyControllerServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
