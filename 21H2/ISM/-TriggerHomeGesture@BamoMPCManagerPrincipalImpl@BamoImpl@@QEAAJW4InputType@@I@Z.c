/*
 * XREFs of ?TriggerHomeGesture@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJW4InputType@@I@Z @ 0x180040278
 * Callers:
 *     ?Thunk_TriggerHomeGesture_21@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180040260 (-Thunk_TriggerHomeGesture_21@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImp.c)
 * Callees:
 ...
 *     ?GetCurrentCaller@BamoPrincipalImpl@BamoImpl@Microsoft@@IEAAPEAVBamoStubImpl@23@XZ @ 0x18006F1BC (-GetCurrentCaller@BamoPrincipalImpl@BamoImpl@Microsoft@@IEAAPEAVBamoStubImpl@23@XZ.c)
 */
