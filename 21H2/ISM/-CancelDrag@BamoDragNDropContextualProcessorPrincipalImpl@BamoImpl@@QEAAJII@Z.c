/*
 * XREFs of ?CancelDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800F5D54
 * Callers:
 *     ?Thunk_CancelDrag_112@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6490 (-Thunk_CancelDrag_112@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualP.c)
 * Callees:
