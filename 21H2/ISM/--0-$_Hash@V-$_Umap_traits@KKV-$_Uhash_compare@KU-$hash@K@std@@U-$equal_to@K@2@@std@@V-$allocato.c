/*
 * XREFs of ??0?$_Hash@V?$_Umap_traits@KKV?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKK@std@@@2@$0A@@std@@@std@@QEAA@AEBV?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@1@AEBV?$allocator@U?$pair@$$CBKK@std@@@1@@Z @ 0x180025428
 * Callers:
 *     ??0KeyboardModifierState@@AEAA@XZ @ 0x1800253C8 (--0KeyboardModifierState@@AEAA@XZ.c)
 * Callees:
