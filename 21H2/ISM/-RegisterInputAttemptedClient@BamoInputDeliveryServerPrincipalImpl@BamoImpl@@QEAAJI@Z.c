/*
 * XREFs of ?RegisterInputAttemptedClient@BamoInputDeliveryServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180004780
 * Callers:
 *     ?Thunk_RegisterInputAttemptedClient_10@?$IInputDeliveryServerPrincipal_Receive@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180004770 (-Thunk_RegisterInputAttemptedClient_10@-$IInputDeliveryServerPrincipal_Receive@VBamoInputDeliver.c)
 * Callees:
