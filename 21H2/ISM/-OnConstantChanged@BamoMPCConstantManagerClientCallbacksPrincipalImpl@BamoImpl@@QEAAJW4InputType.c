/*
 * XREFs of ?OnConstantChanged@BamoMPCConstantManagerClientCallbacksPrincipalImpl@BamoImpl@@QEAAJW4InputType@@PEBGPEAUtagPROPVARIANT@@2@Z @ 0x18011C044
 * Callers:
 *     ?Thunk_OnConstantChanged_28@?$IMPCConstantManagerClientCallbacksPrincipal_Receive@VBamoMPCConstantManagerClientCallbacksPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011C4A0 (-Thunk_OnConstantChanged_28@-$IMPCConstantManagerClientCallbacksPrincipal_Receive@VBamoMPCConsta.c)
 * Callees:
