/*
 * XREFs of ?UpdateInterfacePathRemoteCache@BamoDockableDevicePrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x180128678
 * Callers:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    v10[1] = v3;
    v9 = 0;
    v7 = CoreUICallSend(SendHost, v10, 2LL, 21LL, v9, &unk_1801C01D7, v2);
