/*
 * XREFs of ??0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x180036B04
 * Callers:
 *     _dynamic_initializer_for__Windows::Internal::Holographic::SpatialGraphDriverHandleWrapper::s_mostRecentDynamicNodePoseValidity__ @ 0x180001A20 (_dynamic_initializer_for__Windows--Internal--Holographic--SpatialGraphDriverHandleWrapper--s_mos.c)
 * Callees:
 *     ??0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x18001DE50 (--0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ.c)
        ...
        Windows::Internal::Holographic::Details::NodePoseValidityCollection *this)
{
  ...
  memset_0(
    ...
    0,
    0x400uLL);
  qword_18020A080 = (__int64)&Windows::Internal::Holographic::SpatialGraphDriverHandleWrapper::s_mostRecentDynamicNodePoseValidity;
  do
  {
