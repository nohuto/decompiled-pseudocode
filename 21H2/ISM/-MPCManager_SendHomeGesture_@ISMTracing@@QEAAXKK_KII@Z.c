/*
 * XREFs of ?MPCManager_SendHomeGesture_@ISMTracing@@QEAAXKK_KII@Z @ 0x18003FE90
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( *(_DWORD *)v9 > 4u && tlgKeywordOn((__int64)v9, 0x400000000001LL) )
  {
    ...
    v15 = a2;
    v17 = 50331648LL;
    tlgWriteTransfer_EventWriteTransfer(v11, (unsigned __int8 *)dword_1801C8895, 0LL, 0LL, v10 + 4, &v18);
  }
}
