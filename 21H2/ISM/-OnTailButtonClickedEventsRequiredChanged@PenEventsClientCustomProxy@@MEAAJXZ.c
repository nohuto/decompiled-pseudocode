/*
 * XREFs of ?OnTailButtonClickedEventsRequiredChanged@PenEventsClientCustomProxy@@MEAAJXZ @ 0x180133EB0
 * Callers:
 *     <none>
 * Callees:
        ...
        PenEventsClientCustomProxy *this)
{
  ...
  v2 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 80LL))((char *)this + 8);
