/*
 * XREFs of ??1KeyboardInjectionDevice@@QEAA@XZ @ 0x18011FCC4
 * Callers:
 *     _ControllerProcessor::ControllerProcessor_::_1_::dtor$8 @ 0x18011F9C7 (_ControllerProcessor--ControllerProcessor_--_1_--dtor$8.c)
 * Callees:
