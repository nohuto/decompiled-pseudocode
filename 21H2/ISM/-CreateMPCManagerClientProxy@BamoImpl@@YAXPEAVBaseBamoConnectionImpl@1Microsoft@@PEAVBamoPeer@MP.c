/*
 * XREFs of ?CreateMPCManagerClientProxy@BamoImpl@@YAXPEAVBaseBamoConnectionImpl@1Microsoft@@PEAVBamoPeer@MPCManagerBamo_AutoBamos@@PEAPEAVBamoProxy@Bamo@3@@Z @ 0x18007224C
 * Callers:
...
void __fastcall BamoImpl::CreateMPCManagerClientProxy(
        BamoImpl *this,
        ...
        struct Microsoft::Bamo::BamoProxy **a4)
{
  ...
  *(_QWORD *)a3 = 0LL;
  ...
  v8 = v5;
  *v5 = &BamoMPCManagerClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v5[1] = &BamoMPCManagerClientProxy::`vftable'{for `IMPCManagerClientProxy'};
  *((_DWORD *)v5 + 6) = 0;
  v5[4] = 0LL;
  *((_DWORD *)v5 + 10) = 0;
  *((_DWORD *)v5 + 11) = 0;
