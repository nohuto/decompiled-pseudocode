/*
 * XREFs of ??0SubscriptionList@details_abi@wil@@QEAA@XZ @ 0x180024730
 * Callers:
 *     ??0FeatureStateManager@details@wil@@QEAA@XZ @ 0x180024690 (--0FeatureStateManager@details@wil@@QEAA@XZ.c)
