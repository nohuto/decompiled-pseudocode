/*
 * XREFs of ?UpdateDisplayOcclusionSupported@BamoDockDeviceProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x1800EDE68
 * Callers:
 ...
 *     ?Thunk_UpdateDisplayOcclusionSupported_13@?$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED210 (-Thunk_UpdateDisplayOcclusionSupported_13@-$IDockDeviceProxy_Receive@VBamoDockDeviceProxyImpl@Ba.c)
 * Callees:
