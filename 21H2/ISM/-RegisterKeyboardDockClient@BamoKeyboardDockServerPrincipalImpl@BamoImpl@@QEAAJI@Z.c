/*
 * XREFs of ?RegisterKeyboardDockClient@BamoKeyboardDockServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180127648
 * Callers:
 *     ?Thunk_RegisterKeyboardDockClient_10@?$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180128310 (-Thunk_RegisterKeyboardDockClient_10@-$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockSer.c)
 * Callees:
