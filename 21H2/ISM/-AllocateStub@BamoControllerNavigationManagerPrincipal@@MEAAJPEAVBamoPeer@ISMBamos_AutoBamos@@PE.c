/*
 * XREFs of ?AllocateStub@BamoControllerNavigationManagerPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoControllerNavigationManagerStub@@@Z @ 0x18000FCB0
 * Callers:
 *     <none>
 * Callees:
