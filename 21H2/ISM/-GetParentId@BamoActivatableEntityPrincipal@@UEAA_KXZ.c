/*
 * XREFs of ?GetParentId@BamoActivatableEntityPrincipal@@UEAA_KXZ @ 0x1800060B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoActivatableEntityPrincipal::GetParentId(BamoActivatableEntityPrincipal *this)
{
  __int64 v1; // rdi
  __int64 v2; // rbx
  __int64 v4; // rbp
