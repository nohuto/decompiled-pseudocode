/*
 * XREFs of ??1?$com_ptr_t@VBamoPeer@MPCManagerBamo_AutoBamos@@Uerr_exception_policy@wil@@@wil@@QEAA@XZ @ 0x1800717EC
 * Callers:
 *     _MPCManager::OnPeerConnected_::_1_::dtor$0 @ 0x1800736CB (_MPCManager--OnPeerConnected_--_1_--dtor$0.c)
 * Callees:
