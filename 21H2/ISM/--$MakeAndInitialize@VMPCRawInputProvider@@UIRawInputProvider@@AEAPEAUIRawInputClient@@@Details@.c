/*
 * XREFs of ??$MakeAndInitialize@VMPCRawInputProvider@@UIRawInputProvider@@AEAPEAUIRawInputClient@@@Details@WRL@Microsoft@@YAJPEAPEAUIRawInputProvider@@AEAPEAUIRawInputClient@@@Z @ 0x180020200
 * Callers:
 ...
 *     ??0MPCRawInputProvider@@QEAA@XZ @ 0x180020134 (--0MPCRawInputProvider@@QEAA@XZ.c)
