/*
 * XREFs of ??$SE3_exp@M@ST@@YAXAEAU?$SE3@M@0@QEBM@Z @ 0x1801A51BC
 * Callers:
 ...
 * Callees:
 *     ??$SO3_build_exp_matrix@M@ST@@YAXQEAMQEBMMM@Z @ 0x1801A5A64 (--$SO3_build_exp_matrix@M@ST@@YAXQEAMQEBMMM@Z.c)
