        ...
        _QWORD *a5)
{
  ...
  try
  {
    ...
    if ( *(_QWORD *)(v11 + 32) >= *a4 )
    {
      ...
      if ( v18 )
      {
        v19 = (void (__fastcall ***)(_QWORD))(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v18 + 8LL))(v18);
        (**v19)(v19);
      }
