/*
 * XREFs of ?Materialize_BamoControllerNavigationOverrideProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E6E5C
 * Callers:
 *     ?Thunk_Materialize_BamoControllerNavigationOverrideProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECE10 (-Thunk_Materialize_BamoControllerNavigationOverrideProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Recei.c)
 * Callees:
