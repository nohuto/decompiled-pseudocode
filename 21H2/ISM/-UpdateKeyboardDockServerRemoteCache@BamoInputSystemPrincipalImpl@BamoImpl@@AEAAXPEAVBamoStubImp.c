/*
 * XREFs of ?UpdateKeyboardDockServerRemoteCache@BamoInputSystemPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x180008480
 * Callers:
 ...
 *     ?UpdateKeyboardDockServerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x1800F0770 (-UpdateKeyboardDockServerRemoteCacheStatic@BamoInputSystemPrincipalImpl@BamoImpl@@CAJPEAVBamoStu.c)
 * Callees:
...
void __fastcall BamoImpl::BamoInputSystemPrincipalImpl::UpdateKeyboardDockServerRemoteCache(
...
LABEL_8:
    ...
    v26[0] = v20;
    v26[1] = v19;
    v22 = CoreUICallSend(v21, v26, 2LL, 43LL, 8, &unk_1801C01AA, v5);
