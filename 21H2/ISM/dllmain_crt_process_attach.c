/*
 * XREFs of dllmain_crt_process_attach @ 0x18003B448
 * Callers:
 *     dllmain_crt_dispatch @ 0x18003B3F0 (dllmain_crt_dispatch.c)
 * Callees:
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18003B854 (-__scrt_initialize_type_info@@YAXXZ.c)
 ...
 *     __scrt_initialize_crt @ 0x18003BA40 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x18003BB48 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18003BBE8 (__scrt_release_startup_lock.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18003BCBC (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18003BCDC (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18003BE30 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18003C076 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18003C082 (_initterm_e_0.c)
