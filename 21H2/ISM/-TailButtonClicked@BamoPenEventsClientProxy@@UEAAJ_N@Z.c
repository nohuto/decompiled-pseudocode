/*
 * XREFs of ?TailButtonClicked@BamoPenEventsClientProxy@@UEAAJ_N@Z @ 0x180134780
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?TailButtonClicked@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x1801347DC (-TailButtonClicked@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z.c)
 */
