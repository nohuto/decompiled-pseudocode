/*
 * XREFs of ?ResizeEnded@BamoResizeControllerClientProxyImpl@BamoImpl@@QEAAJIAEBUtagPOINT@@0W4InputType@Input@Internal@UI@Windows@@@Z @ 0x1800EBF60
 * Callers:
        ...
        struct IMessageCallSendHost **a4)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v10 >= 0 )
    {
      ...
      v16[1] = v14;
      v13 = 2;
      return CoreUICallSend(v12, v16, 2LL, 56LL, v13, &unk_1801C027E, a2);
    }
    else
    {
