        ...
        int a5)
{
  ...
  if ( **(_DWORD **)(v8 + 8) > 4u )
  {
    ...
    if ( (_BYTE)v8 )
    {
      ...
      v18 = 16LL;
      v16 = 8LL;
      LOBYTE(v8) = tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801D04B8, 0LL, 0LL, 7u, &v14);
    }
  }
  return v8;
}
