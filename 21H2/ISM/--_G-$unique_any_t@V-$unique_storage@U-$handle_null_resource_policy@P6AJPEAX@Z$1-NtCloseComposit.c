/*
 * XREFs of ??_G?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@QEAAPEAXI@Z @ 0x1800F105C
 * Callers:
 ...
 *     ?_Destroy@?$_Ref_count_obj@V?$unique_any_t@V?$unique_storage@U?$handle_null_resource_policy@P6AJPEAX@Z$1?NtCloseCompositionInputSink@@YAJ0@Z@details@wil@@@details@wil@@@wil@@@std@@EEAAXXZ @ 0x180101880 (-_Destroy@-$_Ref_count_obj@V-$unique_any_t@V-$unique_storage@U-$handle_null_resource_policy@P6AJ.c)
 * Callees:
 *     <none>
 */
