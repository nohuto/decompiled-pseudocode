/*
 * XREFs of ?GetCursorSuppressionPolicyObject@BamoInputSiteElementProxy@@UEAAPEAVBamoCursorSuppressionPolicyObjectProxy@@XZ @ 0x1800109F0
 * Callers:
 *     <none>
 * Callees:
