/*
 * XREFs of ?GetPitchAngleBetweenTwoVectors@MPCMouseProcessor@@CAMUfloat3@Numerics@Foundation@Windows@@0@Z @ 0x180195A7C
 * Callers:
 ...
 * Callees:
 *     asinf_0 @ 0x18004B1E3 (asinf_0.c)
 */

__m128 __fastcall MPCMouseProcessor::GetPitchAngleBetweenTwoVectors(unsigned __int64 *a1, _DWORD *a2)
{
  __m128 v3; // xmm3
  __m128 v4; // xmm2
  __m128 v5; // xmm1
  ...
  *(_DWORD *)a1 = v6.m128_i32[0];
  *((_DWORD *)a1 + 1) = _mm_shuffle_ps(v6, v6, 85).m128_u32[0];
  *((_DWORD *)a1 + 2) = _mm_shuffle_ps(v6, v6, 170).m128_u32[0];
  v7 = _mm_movelh_ps((__m128)*(unsigned __int64 *)a2, (__m128)(unsigned int)a2[2]);
  v8 = _mm_mul_ps(v7, v7);
