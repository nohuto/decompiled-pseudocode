/*
 * XREFs of ?SendMaterializeProxy@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18000E6D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v16, 2LL, 74LL, 41, &unk_1801C01AA, v14);
  if ( v8 < 0 )
  {
