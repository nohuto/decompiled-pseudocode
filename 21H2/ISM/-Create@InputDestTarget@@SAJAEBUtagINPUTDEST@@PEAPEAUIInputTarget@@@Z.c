/*
 * XREFs of ?Create@InputDestTarget@@SAJAEBUtagINPUTDEST@@PEAPEAUIInputTarget@@@Z @ 0x18013A87C
 * Callers:
 ...
 *     ??0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z @ 0x18013A6F4 (--0InputDestTarget@@QEAA@AEBUtagINPUTDEST@@@Z.c)
 */
