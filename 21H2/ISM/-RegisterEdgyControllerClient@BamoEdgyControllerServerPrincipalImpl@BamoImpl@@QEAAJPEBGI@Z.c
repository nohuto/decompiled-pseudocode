/*
 * XREFs of ?RegisterEdgyControllerClient@BamoEdgyControllerServerPrincipalImpl@BamoImpl@@QEAAJPEBGI@Z @ 0x1801007B8
 * Callers:
 *     ?Thunk_RegisterEdgyControllerClient_142@?$IEdgyControllerServerPrincipal_Receive@VBamoEdgyControllerServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180100950 (-Thunk_RegisterEdgyControllerClient_142@-$IEdgyControllerServerPrincipal_Receive@VBamoEdgyContro.c)
 * Callees:
