/*
 * XREFs of ??0MPCButtonHoldHelper@@QEAA@M@Z @ 0x18008527C
 * Callers:
 ...
 *     ??$make_shared@VMPCButtonHoldHelper@@AEAM@std@@YA?AV?$shared_ptr@VMPCButtonHoldHelper@@@0@AEAM@Z @ 0x18008500C (--$make_shared@VMPCButtonHoldHelper@@AEAM@std@@YA-AV-$shared_ptr@VMPCButtonHoldHelper@@@0@AEAM@Z.c)
 * Callees:
        ...
        const char *a4)
{
  ...
  *((_QWORD *)this + 3) = (unsigned int)(int)((double)(int)qword_180209318 * a2);
  return this;
}
