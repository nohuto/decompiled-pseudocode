/*
 * XREFs of ?FailFast_Hr@in1diag0@details@wil@@YAXJ@Z @ 0x1800C06A4
 * Callers:
 *     ??1AlpcSectionListEntry@AlpcPort@@UEAA@XZ @ 0x1800BF258 (--1AlpcSectionListEntry@AlpcPort@@UEAA@XZ.c)
