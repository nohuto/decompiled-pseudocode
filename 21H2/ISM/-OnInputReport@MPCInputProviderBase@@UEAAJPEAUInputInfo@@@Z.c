/*
 * XREFs of ?OnInputReport@MPCInputProviderBase@@UEAAJPEAUInputInfo@@@Z @ 0x180084840
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsDesiredCursorActive@MPCHolographicInputManager@@QEAA_NW4InputType@@@Z @ 0x1800409A0 (-IsDesiredCursorActive@MPCHolographicInputManager@@QEAA_NW4InputType@@@Z.c)
 ...
 *     ?ReportPerf@MPCPerfCounter@@AEAAX_K@Z @ 0x180086E10 (-ReportPerf@MPCPerfCounter@@AEAAX_K@Z.c)
 */
