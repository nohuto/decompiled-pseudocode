/*
 * XREFs of ??1SipcPrivateNamespace@@QEAA@XZ @ 0x1800BF2F8
 * Callers:
 ...
 * Callees:
 *     ?_FailFast_GetLastError@in1diag0@details@wil@@YAXXZ @ 0x1800C1DD4 (-_FailFast_GetLastError@in1diag0@details@wil@@YAXXZ.c)
 */
