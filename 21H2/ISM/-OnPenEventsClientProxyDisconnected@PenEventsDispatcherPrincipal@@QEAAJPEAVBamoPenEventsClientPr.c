/*
 * XREFs of ?OnPenEventsClientProxyDisconnected@PenEventsDispatcherPrincipal@@QEAAJPEAVBamoPenEventsClientProxy@@@Z @ 0x180133A7C
 * Callers:
        ...
        struct BamoPenEventsClientProxy *a2)
{
  ...
  if ( *v5 > 4u && tlgKeywordOn(v4[1], 512LL) )
    tlgWriteTransfer_EventWriteTransfer((__int64)v5, (unsigned __int8 *)dword_1801CF3E6, 0LL, 0LL, 2u, &v27);
