/*
 * XREFs of ?AllocateStubThunk@BamoMPCConstantManagerClientCallbacksPrincipalImpl@BamoImpl@@UEAAJPEAVBaseBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x18011BFD0
 * Callers:
 *     <none>
 * Callees:
