/*
 * XREFs of ??$MakeAndInitialize@VKeyboardOverriderDispatcher@@V1@AEAV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAPEAVKeyboardOverriderDispatcher@@AEAV?$ComPtr@UIMessageSession@@@12@@Z @ 0x18002C01C
 * Callers:
 ...
 *     ??0KeyboardOverriderDispatcher@@QEAA@XZ @ 0x18002A898 (--0KeyboardOverriderDispatcher@@QEAA@XZ.c)
