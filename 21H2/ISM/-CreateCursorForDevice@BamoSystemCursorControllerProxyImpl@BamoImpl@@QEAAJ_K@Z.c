/*
 * XREFs of ?CreateCursorForDevice@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800E3BBC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoSystemCursorControllerProxyImpl::CreateCursorForDevice(
