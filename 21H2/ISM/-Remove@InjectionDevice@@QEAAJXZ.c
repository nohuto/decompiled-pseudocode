/*
 * XREFs of ?Remove@InjectionDevice@@QEAAJXZ @ 0x180121D54
 * Callers:
 *     ??1ControllerProcessor@@MEAA@XZ @ 0x18011FA68 (--1ControllerProcessor@@MEAA@XZ.c)
 *     ??1InjectionDevice@@QEAA@XZ @ 0x18011FCA4 (--1InjectionDevice@@QEAA@XZ.c)
 *     ??1KeyboardInjectionDevice@@QEAA@XZ @ 0x18011FCC4 (--1KeyboardInjectionDevice@@QEAA@XZ.c)
