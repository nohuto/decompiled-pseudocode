/*
 * XREFs of _std::vector_std::function_void___cdecl(DeviceInfo__)____std::allocator_std::function_void___cdecl(DeviceInfo__)______::_Emplace_reallocate_std::function_void___cdecl(DeviceInfo__)____const_&__::_1_::catch$61 @ 0x18005206C
 * Callers:
 *     <none>
 * Callees:
