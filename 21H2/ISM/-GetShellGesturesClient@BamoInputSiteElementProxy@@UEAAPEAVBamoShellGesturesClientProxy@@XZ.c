/*
 * XREFs of ?GetShellGesturesClient@BamoInputSiteElementProxy@@UEAAPEAVBamoShellGesturesClientProxy@@XZ @ 0x1800106D0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 168) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x1800569B2LL);
  }
  return (struct BamoShellGesturesClientProxy *)*((_QWORD *)this + 23);
}
