 ...
 *     ?put_Completed@?$AsyncOperation@U?$IAsyncOperation@PEAUIPropertyValue@Foundation@Windows@@@Foundation@Windows@@U?$IAsyncOperationCompletedHandler@PEAUIPropertyValue@Foundation@Windows@@@23@V?$CMarshaledInterfaceResult@UIPropertyValue@Foundation@Windows@@@Internal@3@VComTaskPoolHandler@63@UINilDelegate@63@U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@UEAAJPEAU?$IAsyncOperationCompletedHandler@PEAUIPropertyValue@Foundation@Windows@@@Foundation@3@@Z @ 0x18011A340 (-put_Completed@-$AsyncOperation@U-$IAsyncOperation@PEAUIPropertyValue@Foundation@Windows@@@Found.c)
 ...
 *     ?GetRoutingInfo@ContextualProcessorBuffer@@UEBA?AUtagMsgRoutingInfo@@XZ @ 0x18014C500 (-GetRoutingInfo@ContextualProcessorBuffer@@UEBA-AUtagMsgRoutingInfo@@XZ.c)
 ...
 *     ?GetNextWorkItem@ChainedThreadpoolWorker@ThreadHelpers@@AEAA_NPEAV?$shared_ptr@V?$function@$$A6AXXZ@std@@@std@@PEAPEAUIUnknown@@@Z @ 0x18015D498 (-GetNextWorkItem@ChainedThreadpoolWorker@ThreadHelpers@@AEAA_NPEAV-$shared_ptr@V-$function@$$A6A.c)
 ...
 *     ?_Tidy@?$deque@V?$ComPtr@UIUnknown@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIUnknown@@@WRL@Microsoft@@@std@@@std@@AEAAXXZ @ 0x180167688 (-_Tidy@-$deque@V-$ComPtr@UIUnknown@@@WRL@Microsoft@@V-$allocator@V-$ComPtr@UIUnknown@@@WRL@Micro.c)
 ...
 *     ??1EdgyProcessorTarget@@UEAA@XZ @ 0x18017A3CC (--1EdgyProcessorTarget@@UEAA@XZ.c)
