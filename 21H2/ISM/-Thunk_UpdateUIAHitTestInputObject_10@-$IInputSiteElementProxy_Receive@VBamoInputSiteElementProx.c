/*
 * XREFs of ?Thunk_UpdateUIAHitTestInputObject_10@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000EEE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IInputSiteElementProxy_Receive<BamoImpl::BamoInputSiteElementProxyImpl>::Thunk_UpdateUIAHitTestInputObject_10(
        __int64 a1,
        unsigned int **a2)
{
  __int64 v3; // r8
  ...
  *(_QWORD *)(a1 + 192) = v8;
  ...
  if ( *(_BYTE *)(a1 + 28) )
  {
    ...
    v12 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 216LL))(a1 - 16);
    if ( v12 < 0 )
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
        (void *)0x9A68,
