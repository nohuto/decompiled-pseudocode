/*
 * XREFs of ?ManualDragEnded@BamoDragAreaClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800F583C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoDragAreaClientProxyImpl::ManualDragEnded(
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 1;
      return CoreUICallSend(v8, v10, 2LL, 22LL, v9, &unk_1801C01AA, a2);
    }
    else
    {
