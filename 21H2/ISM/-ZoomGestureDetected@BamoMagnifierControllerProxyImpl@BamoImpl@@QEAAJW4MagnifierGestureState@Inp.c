/*
 * XREFs of ?ZoomGestureDetected@BamoMagnifierControllerProxyImpl@BamoImpl@@QEAAJW4MagnifierGestureState@Input@Internal@UI@Windows@@IAEBUPoint@Foundation@7@@Z @ 0x1801011E8
 * Callers:
        ...
        struct IMessageCallSendHost **a4)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      v13 = 2;
      v15 = v12;
      return CoreUICallSend(v11, v16, 2LL, 48LL, v13, &unk_1801C0277, a2);
    }
    else
    {
