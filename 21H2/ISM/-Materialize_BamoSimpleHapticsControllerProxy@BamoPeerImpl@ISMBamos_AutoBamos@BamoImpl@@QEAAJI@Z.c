/*
 * XREFs of ?Materialize_BamoSimpleHapticsControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E8334
 * Callers:
 *     ?Thunk_Materialize_BamoSimpleHapticsControllerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED0C0 (-Thunk_Materialize_BamoSimpleHapticsControllerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VB.c)
 * Callees:
