/*
 * XREFs of ?StartResize@ResizeProcessor@@QEAAJKPEAVBamoResizeControllerClientProxy@@@Z @ 0x1800FF3CC
 * Callers:
 *     ?StartResize@ResizeControllerHost@@MEAAJPEAVBamoResizeContextualProcessorStub@@IPEAVBamoResizeControllerClientProxy@@@Z @ 0x1800FD180 (-StartResize@ResizeControllerHost@@MEAAJPEAVBamoResizeContextualProcessorStub@@IPEAVBamoResizeCo.c)
 * Callees:
 ...
 *     ??B?$ComPtr@VInputSite@@@WRL@Microsoft@@QEBAPEQBoolStruct@Details@12@HXZ @ 0x180044FDC (--B-$ComPtr@VInputSite@@@WRL@Microsoft@@QEBAPEQBoolStruct@Details@12@HXZ.c)
 ...
 *     ??$_Try_emplace@AEBK$$V@?$unordered_map@KUMessageInfo@ResizeProcessor@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKUMessageInfo@ResizeProcessor@@@std@@@4@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKUMessageInfo@ResizeProcessor@@@std@@@std@@@std@@@std@@_N@1@AEBK@Z @ 0x1800FD6EC (--$_Try_emplace@AEBK$$V@-$unordered_map@KUMessageInfo@ResizeProcessor@@U-$hash@K@std@@U-$equal_t.c)
 *     ??A?$unordered_map@KUtagPOINT@@U?$hash@K@std@@U?$equal_to@K@3@V?$allocator@U?$pair@$$CBKUtagPOINT@@@std@@@3@@std@@QEAAAEAUtagPOINT@@AEBK@Z @ 0x1800FDB60 (--A-$unordered_map@KUtagPOINT@@U-$hash@K@std@@U-$equal_to@K@3@V-$allocator@U-$pair@$$CBKUtagPOIN.c)
