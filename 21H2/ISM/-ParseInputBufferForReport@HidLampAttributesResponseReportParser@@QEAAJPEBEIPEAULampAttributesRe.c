/*
 * XREFs of ?ParseInputBufferForReport@HidLampAttributesResponseReportParser@@QEAAJPEBEIPEAULampAttributesResponseDeviceReport@@@Z @ 0x1800AAAEC
 * Callers:
 ...
 *     ?ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z @ 0x1800ACB20 (-ParseValue@HidChannelValueInfo@@QEAAJ_KPEBEPEAE@Z.c)
