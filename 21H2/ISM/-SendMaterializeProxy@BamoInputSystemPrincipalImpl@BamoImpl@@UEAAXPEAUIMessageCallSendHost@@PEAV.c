/*
 * XREFs of ?SendMaterializeProxy@BamoInputSystemPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x1800073C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, v135, 2LL, 74LL, 32, &unk_1801C01AA, v129);
  if ( v8 < 0 )
  {
...
LABEL_13:
    ...
    v136[0] = v25;
    LOWORD(v127) = 0;
    v27 = CoreUICallSend(v26, v136, 2LL, 43LL, v127, &unk_1801C01AA, v11);
...
LABEL_29:
    ...
    v137[0] = v43;
    LOWORD(v127) = 2;
    v45 = CoreUICallSend(v44, v137, 2LL, 43LL, v127, &unk_1801C01AA, v29);
...
LABEL_45:
    ...
    v138[1] = v60;
    LOWORD(v127) = 11;
    v63 = CoreUICallSend(v62, v138, 2LL, 43LL, v127, &unk_1801C01AA, v47);
...
LABEL_61:
    ...
    v139[1] = v78;
    LOWORD(v127) = 12;
    v81 = CoreUICallSend(v80, v139, 2LL, 43LL, v127, &unk_1801C01AA, v65);
...
LABEL_77:
    ...
    v140[1] = v96;
    LOWORD(v127) = 13;
    v99 = CoreUICallSend(v98, v140, 2LL, 43LL, v127, &unk_1801C01AA, v83);
...
LABEL_92:
    ...
    v141[1] = v114;
    LOWORD(v127) = 14;
    v117 = CoreUICallSend(v116, v141, 2LL, 43LL, v127, &unk_1801C01AA, v9);
  ...
  LOWORD(v127) = 55;
  v120 = CoreUICallSend(a2, v142, 2LL, 74LL, v127, &unk_1801C01AA, v130);
  if ( v120 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
