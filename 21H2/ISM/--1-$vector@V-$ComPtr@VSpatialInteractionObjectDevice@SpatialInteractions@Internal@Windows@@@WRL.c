 ...
 *     _Windows::Internal::Holographic::SpatialGraphDriverHandleWrapper::SpatialGraphDriverHandleWrapper_::_1_::dtor$3 @ 0x18015704D (_Windows--Internal--Holographic--SpatialGraphDriverHandleWrapper--SpatialGraphDrive_ea_18015704D.c)
 *     _Windows::Internal::Holographic::DynamicNodeSourceBase::AddNodePropertiesUpdatedCallback_::_1_::dtor$2 @ 0x1801598C1 (_Windows--Internal--Holographic--DynamicNodeSourceBase--AddNodePropertiesUpdatedCal_ea_1801598C1.c)
 * Callees:
