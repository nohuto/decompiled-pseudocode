/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@MPCManagerBamo_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x180073D40
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  v6 = 0;
  v8 = v2;
  v5 = CoreUICallSend(v4, v7, 2LL, 1LL, v6, &unk_1801C292E, (unsigned int)&v8);
  if ( v5 < 0 )
  {
