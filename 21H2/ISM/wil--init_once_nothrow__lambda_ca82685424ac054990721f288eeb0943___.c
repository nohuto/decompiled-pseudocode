/*
 * XREFs of wil::init_once_nothrow__lambda_ca82685424ac054990721f288eeb0943___ @ 0x180145848
 * Callers:
 ...
 *     ?Create@VirtualTouchpadContextProvider@@CAJPEAPEAV1@@Z @ 0x180145C7C (-Create@VirtualTouchpadContextProvider@@CAJPEAPEAV1@@Z.c)
 */
