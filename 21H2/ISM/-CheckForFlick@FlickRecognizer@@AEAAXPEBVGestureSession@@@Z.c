/*
 * XREFs of ?CheckForFlick@FlickRecognizer@@AEAAXPEBVGestureSession@@@Z @ 0x180183C00
 * Callers:
 ...
 * Callees:
 *     ?FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ @ 0x180183D34 (-FindFirstRelevantFlickData@FlickRecognizer@@AEAAHXZ.c)
 */
