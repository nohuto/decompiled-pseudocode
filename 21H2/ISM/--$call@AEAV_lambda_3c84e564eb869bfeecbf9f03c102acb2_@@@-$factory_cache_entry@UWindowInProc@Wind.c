/*
 * XREFs of ??$call@AEAV_lambda_3c84e564eb869bfeecbf9f03c102acb2_@@@?$factory_cache_entry@UWindowInProc@WindowManagement@ApplicationModel@Internal@Windows@winrt@@UIWindowStatics@23456@@impl@winrt@@QEAA?AUWindowWatcher@WindowManagement@ApplicationModel@Internal@Windows@2@AEAV_lambda_3c84e564eb869bfeecbf9f03c102acb2_@@@Z @ 0x180033850
 * Callers:
 ...
 *     WINRT_InterlockedPushEntrySList @ 0x18003D979 (WINRT_InterlockedPushEntrySList.c)
        ...
        _QWORD *a2)
{
  ...
  v8 = a2;
  v9[3] = &qword_180209A28;
  _InterlockedIncrement64(&qword_180209A28);
  if ( `winrt::impl::call_factory<winrt::Windows::Internal::ApplicationModel::WindowManagement::WindowInProc,winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindowStatics,_lambda_3c84e564eb869bfeecbf9f03c102acb2_>'::`2'::factory )
  {
    winrt::impl::consume_Windows_Internal_ApplicationModel_WindowManagement_IWindowStatics<winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindowStatics>::CreateWatcher(
      ...
      a2);
    _InterlockedDecrement64(&qword_180209A28);
    return a2;
  }
  _InterlockedDecrement64(&qword_180209A28);
...
LABEL_5:
  ...
  if ( v5 )
  {
    ...
    {
      v7 = 0LL;
      WINRT_InterlockedPushEntrySList(&`winrt::impl::get_factory_cache'::`2'::cache, &stru_180209A30);
      v3 = 0LL;
    }
    winrt::impl::consume_Windows_Internal_ApplicationModel_WindowManagement_IWindowStatics<winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindowStatics>::CreateWatcher(
      &`winrt::impl::call_factory<winrt::Windows::Internal::ApplicationModel::WindowManagement::WindowInProc,winrt::Windows::Internal::ApplicationModel::WindowManagement::IWindowStatics,_lambda_3c84e564eb869bfeecbf9f03c102acb2_>'::`2'::factory,
