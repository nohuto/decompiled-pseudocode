/*
 * XREFs of ?OnDockableDeviceAdded@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJIPEAVBamoDockableDevicePrincipal@@@Z @ 0x18012909C
 * Callers:
        ...
        struct BamoDockableDevicePrincipal *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this[2] + 3) + 32LL) + 56LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v10 = 3;
      return CoreUICallSend(v9, v11, 2LL, 44LL, v10, &unk_1801C0210, a2);
    }
    else
    {
