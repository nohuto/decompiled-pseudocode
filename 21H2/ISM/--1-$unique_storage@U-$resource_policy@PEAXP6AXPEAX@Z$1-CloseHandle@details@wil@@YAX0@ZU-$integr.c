/*
 * XREFs of ??1?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@IEAA@XZ @ 0x18003211C
 * Callers:
 ...
 *     _SpatialRimDeviceCollection::SpatialRimDeviceCollection_::_1_::dtor$15 @ 0x18004EE59 (_SpatialRimDeviceCollection--SpatialRimDeviceCollection_--_1_--dtor$15.c)
 *     _wil::unique_any_t_wil::event_t_wil::details::unique_storage_wil::details::resource_policy_void___void_(__cdecl_)(void__)_&wil::details::CloseHandle_wistd::integral_constant_unsigned___int64_0__void___void___0_std::nullptr_t____wil::err_exception_policy___::unique_any_t_wil::event_t_wil::details::unique_storage_wil::details::resource_policy_void___void_(__cdecl_)(void__)_&wil::details::CloseHandle_wistd::integral_constant_unsigned___int64_0__void___void___0_std::nullptr_t____wil::err_exception_policy____enum_wil::EventOptions__::_1_::dtor$1 @ 0x18004EED3 (_wil--unique_any_t_wil--event_t_wil--details--unique_storage_wil--details--resource_policy_void_.c)
 *     _MPC3DStateHelper::MPC3DStateHelper_::_1_::dtor$38 @ 0x18004EF7F (_MPC3DStateHelper--MPC3DStateHelper_--_1_--dtor$38.c)
 *     _dynamic_atexit_destructor_for__MPC3DStateHelper::s_isInstanceCreatedEvent__ @ 0x180052450 (_dynamic_atexit_destructor_for__MPC3DStateHelper--s_isInstanceCreatedEvent__.c)
 *     ??1?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x1800646E8 (--1-$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ.c)
 *     ??1?$unique_any_t@V?$event_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_failfast_policy@3@@wil@@@wil@@QEAA@XZ @ 0x1800647B8 (--1-$unique_any_t@V-$event_t@V-$unique_storage@U-$resource_policy@PEAXP6AXPEAX@Z$1-CloseHandle@d.c)
 ...
 *     _MPCManagerClientFactory::CreateOnDedicatedThread_::_1_::dtor$7 @ 0x1801079EB (_MPCManagerClientFactory--CreateOnDedicatedThread_--_1_--dtor$7.c)
