 ...
 *     ?OnDisconnected@HotKeyClient@@UEAAJPEAUIMessageProxy@@@Z @ 0x180148570 (-OnDisconnected@HotKeyClient@@UEAAJPEAUIMessageProxy@@@Z.c)
 ...
 *     ??1?$pair@PEAUDeviceInfo@@V?$ComPtr@UICursor@@@WRL@Microsoft@@@std@@QEAA@XZ @ 0x180194F34 (--1-$pair@PEAUDeviceInfo@@V-$ComPtr@UICursor@@@WRL@Microsoft@@@std@@QEAA@XZ.c)
