/*
 * XREFs of ?OnDockableDeviceRemoved@BamoKeyboardDockClientProxy@@UEAAJI@Z @ 0x1801291D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OnDockableDeviceRemoved@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x18012922C (-OnDockableDeviceRemoved@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJI@Z.c)
 */
