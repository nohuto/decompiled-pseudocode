/*
 * XREFs of ?SendCheckProtocol@BamoPeerImpl@dataprovider_AutoBamos@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x180038210
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _GUID *a2)
{
  ...
  v6 = 0;
  v9 = v2;
  v5 = CoreUICallSend(v4, v8, 2LL, 6LL, v6, &unk_1801C18CB, (unsigned int)&v9);
  if ( v5 < 0 )
  {
