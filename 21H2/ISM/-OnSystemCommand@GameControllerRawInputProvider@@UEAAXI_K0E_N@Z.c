/*
 * XREFs of ?OnSystemCommand@GameControllerRawInputProvider@@UEAAXI_K0E_N@Z @ 0x180088F70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1?$unique_ptr@UShellButtonListEntry@GameControllerRawInputProvider@@U?$default_delete@UShellButtonListEntry@GameControllerRawInputProvider@@@std@@@std@@QEAA@XZ @ 0x180041818 (--1-$unique_ptr@UShellButtonListEntry@GameControllerRawInputProvider@@U-$default_delete@UShellBu.c)
 *     ??4?$com_ptr_t@UIRawInputClient@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@AEBV01@@Z @ 0x180041838 (--4-$com_ptr_t@UIRawInputClient@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@AEBV01@@Z.c)
 *     ??I?$com_ptr_t@UIMessageTimer@@Uerr_exception_policy@wil@@@wil@@QEAAPEAPEAUIMessageTimer@@XZ @ 0x18004188C (--I-$com_ptr_t@UIMessageTimer@@Uerr_exception_policy@wil@@@wil@@QEAAPEAPEAUIMessageTimer@@XZ.c)
 ...
 *     ?PushBack@?$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAXPEAUShellButtonListEntry@GameControllerRawInputProvider@@@Z @ 0x180041908 (-PushBack@-$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAXPEAUShellButtonL.c)
 *     ?RemoveAt@?$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAPEAUShellButtonListEntry@GameControllerRawInputProvider@@PEAU23@@Z @ 0x180041934 (-RemoveAt@-$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAPEAUShellButtonLi.c)
