/*
 * XREFs of ??$MakeAndInitialize@V?$Singleton@VSpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@V1234@@WRL@Microsoft@@UIInspectable@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIInspectable@@@Z @ 0x18014F6E0
 * Callers:
 ...
 *     SpatialGraphDriverClientHelpers::DefaultSpatialGraphSettings @ 0x18015B19C (SpatialGraphDriverClientHelpers--DefaultSpatialGraphSettings.c)
