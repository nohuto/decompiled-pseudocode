/*
 * XREFs of ?StartResize@Resize@InputETW@@SAXK@Z @ 0x1800FF320
 * Callers:
...
void __fastcall InputETW::Resize::StartResize(unsigned int a1)
{
  __int64 v1; // rbx
  __int64 v2; // rcx
  LPVOID v3; // rax
  ...
  if ( InputETW::IsVerboseEnabled(1LL) )
  {
    ...
    if ( **((_DWORD **)v3 + 1) > 5u && tlgKeywordOn(*((_QWORD *)v3 + 1), 1LL) )
    {
      ...
      v5 = v1;
      v8 = 8;
      tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801CE996, 0LL, 0LL, 3u, &v6);
    }
  }
}
