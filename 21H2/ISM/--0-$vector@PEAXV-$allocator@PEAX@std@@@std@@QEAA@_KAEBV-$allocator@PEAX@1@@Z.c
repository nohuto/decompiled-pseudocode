/*
 * XREFs of ??0?$vector@PEAXV?$allocator@PEAX@std@@@std@@QEAA@_KAEBV?$allocator@PEAX@1@@Z @ 0x180149270
 * Callers:
 ...
 *     ?_Buy_nonzero@?$vector@PEAXV?$allocator@PEAX@std@@@std@@AEAAX_K@Z @ 0x1801493D8 (-_Buy_nonzero@-$vector@PEAXV-$allocator@PEAX@std@@@std@@AEAAX_K@Z.c)
 */
