/*
 * XREFs of ?Thunk_DestroyCustomCursorShapeAnimation_2@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013D2E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
