/*
 * XREFs of ?OnEnumerationCompleted@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJXZ @ 0x18012937C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoKeyboardDockClientProxyImpl::OnEnumerationCompleted(
