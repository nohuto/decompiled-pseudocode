/*
 * XREFs of ?ExtractPenIdFromReport@PenIdentity@@YA_NPEAXKW4_HIDP_REPORT_TYPE@@PEAU_HIDP_PREPARSED_DATA@@PEAU_GUID@@@Z @ 0x1801320D8
 * Callers:
 ...
 *     ?CreatePenId@PenIdentity@@YA_NG_KPEAU_GUID@@@Z @ 0x1801320B8 (-CreatePenId@PenIdentity@@YA_NG_KPEAU_GUID@@@Z.c)
 */
