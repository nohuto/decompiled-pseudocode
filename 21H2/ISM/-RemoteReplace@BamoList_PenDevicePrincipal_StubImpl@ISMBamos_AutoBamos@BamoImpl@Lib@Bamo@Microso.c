/*
 * XREFs of ?RemoteReplace@BamoList_PenDevicePrincipal_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJIPEAVBamoPenDevicePrincipal@@@Z @ 0x18013021C
 * Callers:
...
LABEL_3:
  ...
  v10[1] = v13;
  v8 = 2;
  return CoreUICallSend(v9, v10, 2LL, 72LL, v8, &unk_1801C0210, a2);
}
