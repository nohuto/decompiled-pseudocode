/*
 * XREFs of _TestCommandHost::RegisterForTestCommandMessage_::_1_::catch$8 @ 0x18004F074
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall TestCommandHost::RegisterForTestCommandMessage_::_1_::catch_8(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
