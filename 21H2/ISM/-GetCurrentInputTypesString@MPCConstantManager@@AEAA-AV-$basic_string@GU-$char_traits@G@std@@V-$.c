/*
 * XREFs of ?GetCurrentInputTypesString@MPCConstantManager@@AEAA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@XZ @ 0x18006F1EC
 * Callers:
 *     ?GetActiveInputTypeList@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@PEAVBamoAsyncResult_string_Proxy@@@Z @ 0x18006EB50 (-GetActiveInputTypeList@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@PEAVBamoA.c)
 * Callees:
 ...
 *     ??$_UIntegral_to_buff@GI@std@@YAPEAGPEAGI@Z @ 0x18006DCF8 (--$_UIntegral_to_buff@GI@std@@YAPEAGPEAGI@Z.c)
...
__int64 __fastcall MPCConstantManager::GetCurrentInputTypesString(__int64 a1, __int64 a2)
{
  ...
  v12[1] = a2;
  std::wstring::wstring((_QWORD *)a2, (__int64)&word_1801C2344);
  v4 = 1;
  v5 = *(__int64 **)(a1 + 56);
  v6 = *v5;
  v12[0] = *v5;
