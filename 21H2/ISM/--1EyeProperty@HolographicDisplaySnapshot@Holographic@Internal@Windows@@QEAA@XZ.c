/*
 * XREFs of ??1EyeProperty@HolographicDisplaySnapshot@Holographic@Internal@Windows@@QEAA@XZ @ 0x1800C5AB0
 * Callers:
 *     <none>
 * Callees:
 *     ??_M@YAXPEAX_K1P6AX0@Z@Z @ 0x18003CF54 (--_M@YAXPEAX_K1P6AX0@Z@Z.c)
 *     ??1?$TimestampedProperty@U?$VariableSizeStructWrapper@UHOLOGRAPHIC_DISPLAY_DISTORTION_MESH@@@Holographic@Internal@Windows@@@Holographic@Internal@Windows@@QEAA@XZ @ 0x180044530 (--1-$TimestampedProperty@U-$VariableSizeStructWrapper@UHOLOGRAPHIC_DISPLAY_DISTORTION_MESH@@@Hol.c)
 */
