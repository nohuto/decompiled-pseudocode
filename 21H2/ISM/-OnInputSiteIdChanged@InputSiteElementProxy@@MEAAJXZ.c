/*
 * XREFs of ?OnInputSiteIdChanged@InputSiteElementProxy@@MEAAJXZ @ 0x1800F22E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AssociateWithInputSite@InputSiteElementProxy@@QEAAXAEBV?$ComPtr@VInputSite@@@WRL@Microsoft@@@Z @ 0x180012320 (-AssociateWithInputSite@InputSiteElementProxy@@QEAAXAEBV-$ComPtr@VInputSite@@@WRL@Microsoft@@@Z.c)
