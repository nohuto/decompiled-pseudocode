/*
 * XREFs of SpatialInteractionDevices::ParseFloatData_DirectX::XMFLOAT4_ @ 0x1800C7CC0
 * Callers:
 *     SpatialInteractionDevices::ReadPoseOrientation @ 0x1800CA338 (SpatialInteractionDevices--ReadPoseOrientation.c)
 * Callees:
  ...
  for ( i = 0; i < 4; ++i )
    result = result
          && (int)SpatialInteractionDevices::Internal::HIDGetFloat(
                    this,
                    a2,
                    (struct SpatialInteractionDevices::HID_REPORT *)&unk_1801AEDA0,
                    (enum _HIDP_REPORT_TYPE)*((unsigned __int16 *)&unk_1801AEDA0 + 8 * i),
                    *((_WORD *)&unk_1801AEDA0 + 8 * i + 1),
                    *((_WORD *)&unk_1801AEDA0 + 8 * i + 2),
                    *((_WORD *)&unk_1801AEDA0 + 8 * i + 3),
