/*
 * XREFs of ?TryCreateAndInitialize@HidLampAttributesResponseReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800AAD64
 * Callers:
 ...
 *     ??0HidLampAttributesResponseReportParser@@AEAA@XZ @ 0x1800AA634 (--0HidLampAttributesResponseReportParser@@AEAA@XZ.c)
