/*
 * XREFs of ?QueryInterface@ComboButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801720F0
 * Callers:
 *     ?QueryInterface@ComboButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004D920 (-QueryInterface@ComboButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
