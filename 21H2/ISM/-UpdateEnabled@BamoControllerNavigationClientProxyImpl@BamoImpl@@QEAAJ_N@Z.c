/*
 * XREFs of ?UpdateEnabled@BamoControllerNavigationClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x18011ECD0
 * Callers:
 ...
 *     ?Thunk_UpdateEnabled_13@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011EB20 (-Thunk_UpdateEnabled_13@-$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClie.c)
 * Callees:
