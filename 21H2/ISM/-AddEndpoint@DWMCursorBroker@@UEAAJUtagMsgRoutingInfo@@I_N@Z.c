/*
 * XREFs of ?AddEndpoint@DWMCursorBroker@@UEAAJUtagMsgRoutingInfo@@I_N@Z @ 0x18019BAA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextEndpointIndex@DWMCursorBroker@@AEAAJPEAI@Z @ 0x18019BFB4 (-GetNextEndpointIndex@DWMCursorBroker@@AEAAJPEAI@Z.c)
 */
