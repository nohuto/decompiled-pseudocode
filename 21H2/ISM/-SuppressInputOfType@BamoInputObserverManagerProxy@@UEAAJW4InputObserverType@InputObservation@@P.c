/*
 * XREFs of ?SuppressInputOfType@BamoInputObserverManagerProxy@@UEAAJW4InputObserverType@InputObservation@@PEAVBamoInputObserverClientPrincipal@@@Z @ 0x1800ECBA0
 * Callers:
 *     <none>
 * Callees:
