/*
 * XREFs of ?AllocateStubThunk@BamoList_PenDevicePrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAJPEAVBaseBamoPeerImpl@36@PEAPEAVBamoStub@56@@Z @ 0x18012F100
 * Callers:
 *     <none>
 * Callees:
