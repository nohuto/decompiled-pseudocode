  ...
  *(_BYTE *)(v8 + 237) = (_BYTE)v7;
  ...
  try
  {
    ...
    for ( j = 0; j < *((_DWORD *)this + 34); ++j )
    {
      ...
      LOBYTE(v52) = 0;
      v20 = SpatialInteractionDevices::StoreCapsIfMatches_1_((__int64)&off_1801B9EC0, v18, v19, &v52);
      v21 = v20;
      if ( v20 < 0 )
      {
      ...
      if ( !(_BYTE)v52 )
      {
        v24 = SpatialInteractionDevices::StoreCapsIfMatches_4_((__int64)&off_1801B9D00, v18, v19 + 48, &v52);
        v25 = v24;
        if ( v24 < 0 )
        {
          wil::details::in1diag3::Return_Hr(
        ...
        if ( !(_BYTE)v52 )
        {
          ...
          if ( !(_BYTE)v52 )
          {
            v28 = SpatialInteractionDevices::StoreCapsIfMatches_2_((__int64)&off_1801B9D80, v18, v19 + 8, &v52);
            v29 = v28;
            if ( v28 < 0 )
            {
              wil::details::in1diag3::Return_Hr(
