/*
 * XREFs of ?QueryInterface@BamoUIAHitTestStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801879B0
 * Callers:
 *     ?QueryInterface@BamoUIAHitTestStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004DB90 (-QueryInterface@BamoUIAHitTestStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
