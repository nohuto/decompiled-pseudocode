 ...
 *     _SystemCursorService::SystemCursorService_::_1_::dtor$3 @ 0x18013E7F2 (_SystemCursorService--SystemCursorService_--_1_--dtor$3.c)
 *     ??1?$vector@USPATIAL_NODE_ID@@V?$allocator@USPATIAL_NODE_ID@@@std@@@std@@QEAA@XZ @ 0x180157AAC (--1-$vector@USPATIAL_NODE_ID@@V-$allocator@USPATIAL_NODE_ID@@@std@@@std@@QEAA@XZ.c)
