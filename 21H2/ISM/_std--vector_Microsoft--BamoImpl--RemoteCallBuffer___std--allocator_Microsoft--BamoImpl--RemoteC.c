/*
 * XREFs of _std::vector_Microsoft::BamoImpl::RemoteCallBuffer___std::allocator_Microsoft::BamoImpl::RemoteCallBuffer_____::_Emplace_reallocate_Microsoft::BamoImpl::RemoteCallBuffer___const_&__::_1_::catch$33 @ 0x18003F9C8
 * Callers:
 *     <none>
 * Callees:
 *     _CxxThrowException_0 @ 0x18003C946 (_CxxThrowException_0.c)
 *     ?deallocate@?$allocator@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBEUTargetingInfo@KeyboardProcessor@@@std@@@std@@@std@@@std@@@std@@QEAAXQEAV?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBEUTargetingInfo@KeyboardProcessor@@@std@@@std@@@std@@@2@_K@Z @ 0x18004050C (-deallocate@-$allocator@V-$_List_unchecked_iterator@V-$_List_val@U-$_List_simple_types@U-$pair@$.c)
 */
