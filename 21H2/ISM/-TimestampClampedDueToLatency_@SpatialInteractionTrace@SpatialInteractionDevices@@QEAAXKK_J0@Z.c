/*
 * XREFs of ?TimestampClampedDueToLatency_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKK_J0@Z @ 0x18016FBE0
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( **((_DWORD **)v8 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v8 + 1), 2LL) )
  {
    ...
    v23 = 8LL;
    v21 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801D1F21, 0LL, 0LL, 6u, &v15);
  }
}
