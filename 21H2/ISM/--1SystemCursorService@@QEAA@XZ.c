/*
 * XREFs of ??1SystemCursorService@@QEAA@XZ @ 0x18013B6C8
 * Callers:
 *     ?_Destroy@?$_Ref_count_obj@VSystemCursorService@@@std@@EEAAXXZ @ 0x18013D440 (-_Destroy@-$_Ref_count_obj@VSystemCursorService@@@std@@EEAAXXZ.c)
 * Callees:
