/*
 * XREFs of ??1ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ @ 0x180157B0C
 * Callers:
 ...
 *     ?WaitForCompletion@ChainedThreadpoolWorker@ThreadHelpers@@QEAAXXZ @ 0x180166D80 (-WaitForCompletion@ChainedThreadpoolWorker@ThreadHelpers@@QEAAXXZ.c)
