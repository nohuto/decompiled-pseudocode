/*
 * XREFs of ??1CmNotifContext@HolographicDriverHandleWrapper@Holographic@Internal@Windows@@QEAA@XZ @ 0x180157C3C
 * Callers:
 ...
 * Callees:
 *     ?Destroy@?$DestroyThreadPoolWork@$01@details@wil@@SAXPEAU_TP_WORK@@@Z @ 0x18015B604 (-Destroy@-$DestroyThreadPoolWork@$01@details@wil@@SAXPEAU_TP_WORK@@@Z.c)
