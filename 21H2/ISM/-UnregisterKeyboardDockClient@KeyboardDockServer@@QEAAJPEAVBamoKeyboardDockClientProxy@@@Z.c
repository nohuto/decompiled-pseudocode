/*
 * XREFs of ?UnregisterKeyboardDockClient@KeyboardDockServer@@QEAAJPEAVBamoKeyboardDockClientProxy@@@Z @ 0x180128320
 * Callers:
 *     ?OnDisconnected@KeyboardDockClientProxy@@MEAAJXZ @ 0x180128CE0 (-OnDisconnected@KeyboardDockClientProxy@@MEAAJXZ.c)
 * Callees:
