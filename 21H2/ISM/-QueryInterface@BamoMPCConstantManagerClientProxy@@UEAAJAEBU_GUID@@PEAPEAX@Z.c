/*
 * XREFs of ?QueryInterface@BamoMPCConstantManagerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18010A680
 * Callers:
 *     ?QueryInterface@BamoMPCConstantManagerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C4D0 (-QueryInterface@BamoMPCConstantManagerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
