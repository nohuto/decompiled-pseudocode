/*
 * XREFs of ?SendMaterializeProxy@BamoActivationWatcherPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18000AEE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, v35, 2LL, 74LL, 5, &unk_1801C01AA, v33);
  if ( v8 < 0 )
  {
...
LABEL_13:
    ...
    LOWORD(v31) = 0;
    v36[1] = v23;
    v26 = CoreUICallSend(v25, v36, 2LL, 7LL, v31, &unk_1801C01AA, v10);
  ...
  LOWORD(v31) = 55;
  v29 = CoreUICallSend(a2, v37, 2LL, 74LL, v31, &unk_1801C01AA, v34);
  if ( v29 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
