 ...
 *     __lambda_fa6b829d8739de4b5d4653aa8baa7884_::operator()_::_1_::dtor$0 @ 0x180158F1E (__lambda_fa6b829d8739de4b5d4653aa8baa7884_--operator()_--_1_--dtor$0.c)
 *     _Windows::Internal::Holographic::DynamicNodeSourceBase::InvokeNodePropertiesUpdatedCallback_::_1_::dtor$0 @ 0x18016030B (_Windows--Internal--Holographic--DynamicNodeSourceBase--InvokeNodePropertiesUpdatedCallback_--_1.c)
 *     _InputSite::GetAllAttachedObjectsByType_IAttachableInputObjectSampleProxy__::_1_::dtor$0 @ 0x180170D7B (_InputSite--GetAllAttachedObjectsByType_IAttachableInputObjectSampleProxy__--_1_--dtor$0.c)
 *     _TestCommands::RequestHitTest_::_1_::dtor$2 @ 0x180171273 (_TestCommands--RequestHitTest_--_1_--dtor$2.c)
 * Callees:
