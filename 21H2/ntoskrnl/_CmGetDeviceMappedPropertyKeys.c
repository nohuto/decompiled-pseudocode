/*
 * XREFs of _CmGetDeviceMappedPropertyKeys @ 0x1406DA264
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  _DWORD v29[18]; // [rsp+50h] [rbp-48h] BYREF
  ...
  *a7 = 0;
  ...
  while ( 1 )
  {
    ...
    {
      if ( a4
        || (result = CmGetDeviceMappedPropertyFromRegProp(
                       a1,
                       a2,
                       a3,
                       (_DWORD)v12,
        ...
        || !(_DWORD)result )
      {
        if ( a5 )
        {
          ...
          {
            v15 = 5 * v14;
            *(_GUID *)(a5 + 4 * v15) = v12->fmtid;
            *(_DWORD *)(a5 + 4 * v15 + 16) = v12->pid;
          }
        }
        v16 = *v7 + 1;
        if ( v16 < *v7 )
...
LABEL_35:
  ...
  do
  {
    v22 = *v21;
    if ( a4
      || (result = CmGetDeviceMappedPropertyFromComposite(v30, v31, a3, *v21, v29, 0LL, 0, &a7, 0),
          (_DWORD)result == -1073741789)
      || !(_DWORD)result )
    {
      if ( a5 )
      {
        ...
        {
          v24 = 5 * v23;
          *(_GUID *)(a5 + 4 * v24) = v22->fmtid;
          *(_DWORD *)(a5 + 4 * v24 + 16) = v22->pid;
        }
      }
      v25 = *v7 + 1;
      if ( v25 < *v7 )
