/*
 * XREFs of DifPoFxCompleteDevicePowerNotRequiredWrapper @ 0x1406190B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall DifPoFxCompleteDevicePowerNotRequiredWrapper(ULONG_PTR BugCheckParameter2)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
...
LABEL_18:
  result = (__int64 *)PoFxCompleteDevicePowerNotRequired(BugCheckParameter2);
  if ( APIThunkContextById )
  {
