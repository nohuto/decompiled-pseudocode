/*
 * XREFs of Feature_Servicing_FSRTLQueryOpen__private_IsEnabled @ 0x140417574
 * Callers:
...
__int64 Feature_Servicing_FSRTLQueryOpen__private_IsEnabled()
{
  ...
  CachedFeatureEnabledState = wil_details_FeatureStateCache_GetCachedFeatureEnabledState(
                                (unsigned int *)&Feature_Servicing_FSRTLQueryOpen__private_featureState,
                                (__int64)&Feature_Servicing_FSRTLQueryOpen__private_descriptor);
  v1 = (CachedFeatureEnabledState >> 3) & 1;
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_Servicing_FSRTLQueryOpen__private_reporting,
    0x2EE5DB8u,
