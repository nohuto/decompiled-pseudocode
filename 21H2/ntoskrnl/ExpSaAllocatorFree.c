/*
 * XREFs of ExpSaAllocatorFree @ 0x140394354
 * Callers:
...
char __fastcall ExpSaAllocatorFree(ULONG_PTR BugCheckParameter2, __int64 *a2, __int64 a3, _DWORD *a4)
{
  char v7; // r13
...
LABEL_9:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, BugCheckParameter2, (__int64)v41, a4);
...
LABEL_41:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v17, BugCheckParameter2, (__int64)&v39, a4);
...
LABEL_80:
  ...
  LOBYTE(v16) = KiAbThreadRemoveBoosts((ULONG_PTR)v28, BugCheckParameter2, (__int64)&v37, (_DWORD *)v29);
