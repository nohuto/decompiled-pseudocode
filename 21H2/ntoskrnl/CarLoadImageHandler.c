/*
 * XREFs of CarLoadImageHandler @ 0x140602F2C
 * Callers:
...
void __fastcall CarLoadImageHandler(__int64 a1)
{
  ...
  if ( Pool2 )
  {
    ...
    *(_DWORD *)(Pool2 + 88) = *(_DWORD *)(a1 + 120);
    ...
    if ( CarEtwEventBook )
    {
      if ( (VfRuleClasses & 0x400000) != 0 && (unsigned int)dword_140C090C0 > 5 )
      {
        if ( tlgKeywordOn((__int64)&dword_140C090C0, 0x800000000000LL) )
        {
          v11 = 0;
          v4 = CarTipTag;
          v9 = &v4;
          v10 = 4;
          tlgCreate1Sz_wchar_t((__int64)v12, (const WCHAR *)(v3 + 8));
          v15 = 0;
          v18 = 0;
          v21 = 0;
          v13 = &v5;
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)byte_14003456B,
            0LL,
            0LL,
            7u,
            &v8);
