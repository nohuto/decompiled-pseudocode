/*
 * XREFs of KsepResolveApplicableShimsForDriver @ 0x1408C0634
 * Callers:
...
LABEL_25:
    if ( v5 )
    {
      ...
      if ( a2 )
      {
        ...
        dword_140C2AAA4[2 * v27] = LoadedModulesList;
...
LABEL_31:
  ...
  if ( a2 )
  {
    ...
    dword_140C2AAA4[2 * v25] = LoadedModulesList;
...
LABEL_22:
  ...
  dword_140C2AAA4[2 * v26] = -1073740782;
