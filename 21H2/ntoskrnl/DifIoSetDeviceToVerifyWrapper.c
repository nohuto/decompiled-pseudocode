/*
 * XREFs of DifIoSetDeviceToVerifyWrapper @ 0x140610F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoSetDeviceToVerifyWrapper(__int64 a1, __int64 a2)
{
  ...
  v13 = 0LL;
  v14 = 0LL;
  result = (__int64)DifGetAPIThunkContextById(210);
  v9 = result;
  if ( !result )
    goto LABEL_18;
  if ( ViVerifierEnabled
    && ((VfRuleClasses & 0xFFA9F6E6) != 0 || (v6 = HIDWORD(VfRuleClasses), (VfRuleClasses & 0x200000000LL) != 0))
