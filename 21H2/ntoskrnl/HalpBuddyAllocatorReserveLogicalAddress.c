/*
 * XREFs of HalpBuddyAllocatorReserveLogicalAddress @ 0x140534A70
 * Callers:
 *     <none>
 * Callees:
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          if ( !*((_BYTE *)v7 + 72) )
          {
            ...
            *(_QWORD *)(a1 + 72) += v16;
            ++*v17;
            HalpBuddyAllocatorBltRemove(v7, a1);
            goto LABEL_33;
          }
LABEL_32:
          if ( (_QWORD *)v7[5] != v17 )
...
LABEL_33:
        ...
        HalpBuddyAllocatorBltRemove(v7, a1);
        v3 = HalpBuddyAllocatorSplitNode(a1, v7);
        if ( (v3 & 0x80000000) != 0 )
          return v3;
        HalpBuddyAllocatorBltAdd((__int64 *)v7[4], a1);
    ...
    if ( (v3 & 0x80000000) != 0 )
      return v3;
    HalpBuddyAllocatorBltAdd((__int64 *)v7[4], a1);
    HalpBuddyAllocatorBltAdd((__int64 *)v7[3], a1);
    v9 = (__int64 *)v7[3];
LABEL_13:
    if ( v5 > v9[6] + v9[7] )
    {
