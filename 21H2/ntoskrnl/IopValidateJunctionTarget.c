/*
 * XREFs of IopValidateJunctionTarget @ 0x140892EE4
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  ULONG v11; // r12d
  struct _REPARSE_DATA_BUFFER *PoolWithQuota_1; // rax
  const void *v13; // rdx
  size_t v14; // r8
  ...
  *(_QWORD *)&String1.Length = 1441812LL;
  ...
  if ( a1 == 590860 )
  {
    v11 = v6 - 32;
    v35 = v6 - 32;
    PoolWithQuota_1 = (struct _REPARSE_DATA_BUFFER *)IopVerifierExAllocatePoolWithQuota_1(
                                                       NonPagedPoolNx,
                                                       (unsigned int)(v6 - 32));
    v13 = a2 + 2;
  ...
  else
  {
    v11 = v6;
    v35 = v6;
    PoolWithQuota_1 = (struct _REPARSE_DATA_BUFFER *)IopVerifierExAllocatePoolWithQuota_1(NonPagedPoolNx, v6);
    v14 = v6;
    v13 = a2;
  }
  v15 = PoolWithQuota_1;
  v33 = PoolWithQuota_1;
  memmove(PoolWithQuota_1, v13, v14);
...
LABEL_5:
        ...
        if ( appended >= 0 )
        {
          ...
          v24 = IopVerifierExAllocatePoolWithQuota_1(NonPagedPoolNx, v23);
          v9 = v24;
          v36 = v24;
          if ( a1 == 590860 )
          {
