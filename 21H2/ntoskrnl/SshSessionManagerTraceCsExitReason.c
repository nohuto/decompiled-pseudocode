/*
 * XREFs of SshSessionManagerTraceCsExitReason @ 0x14080788C
 * Callers:
...
__int64 __fastcall SshSessionManagerTraceCsExitReason(__int64 a1, __int64 a2, _DWORD *a3)
{
  int v4; // eax
  ...
  v18[30] = &v16;
  v18[31] = 8LL;
  return SshpSessionManagerSendControlEvent(SLEEPSTUDY_EVT_CS_EXIT_REASON_CONTROL_EVENT, 16LL, v18);
}
