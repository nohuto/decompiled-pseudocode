/*
 * XREFs of HalCreateCommonBufferFromMdlDmarThin @ 0x1405160A0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( CommonBufferFromMdlVerifyParams >= 0 )
  {
    ...
    if ( CommonBufferEntry >= 0 )
    {
      ...
      *((_QWORD *)&v21 + 1) = (char *)MemoryDescriptorList + 8 * (v14 >> 12) + 48;
      ...
      CommonBufferEntry = ((__int64 (__fastcall *)(__int64, __int64, __int128 *, _QWORD, __int128 *, char *, __int64 *))qword_140C4BDA8)(
                            v5[5],
                            v15,
                            &v21,
                            0LL,
      ...
      if ( CommonBufferEntry >= 0 )
      {
        ...
        ((void (__fastcall *)(__int64, __int64, unsigned __int64))qword_140C4BDB0)(v5[5], v18, v13 >> 12);
      }
