/*
 * XREFs of PfpPrefetchPrivatePages @ 0x140987430
 * Callers:
...
LABEL_10:
    ...
    if ( (int)PfpSourceBuildVaArray(v14, P) < 0 || (int)PfpSourceGetPrefetchSupport(v14, Handle) < 0 )
      goto LABEL_10;
    v11 = (char *)Handle[1];
    if ( (*(_DWORD *)(v1 + 80) & 4) == 0 )
    {
      ...
      *(_DWORD *)(v1 + 104) += LODWORD(P[0]);
      MmPrefetchVirtualMemory(v11, v16, (__int64)P[1], v9);
LABEL_32:
      ++*(_DWORD *)(v1 + 92);
      goto LABEL_11;
    }
    ...
    Handle[0] = P[1];
    MmQueryMemoryListInformation((ULONG_PTR **)0xFFFFFFFFFFFFFFFFLL, (_OWORD *)v2 + 3, 0xB0u, v15, &v27);
    if ( !v18 )
      goto LABEL_32;
    while ( !PfpCheckPrefetchAbort(v2)
         && (unsigned __int64)(*v17 + v17[1] + PfpGetPageListCount((__int64)(v17 + 5), 0, v20)) >= 0x80 )
    {
      v19 = v18;
      if ( v18 > 0x10 )
        v19 = 16;
      if ( MmPrefetchVirtualMemory(v11, v19, (__int64)Handle[0], v26) >= 0 )
        *(_DWORD *)(v1 + 104) += v19;
      PfpUpdateRepurposedByPrefetch(v17, v19);
