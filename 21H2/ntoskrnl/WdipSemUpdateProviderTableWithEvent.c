/*
 * XREFs of WdipSemUpdateProviderTableWithEvent @ 0x140840AEC
 * Callers:
 ...
 *     WdipSemQueryProviderTable @ 0x140840B90 (WdipSemQueryProviderTable.c)
  ...
  if ( a1 )
  {
    ...
    else
    {
      ...
      if ( v5 )
      {
        memset(v5, 0, 0x50uLL);
        *v6 = *(_OWORD *)a1;
        WdipSemProviderTable[dword_140C18E80++] = v6;
        *(_QWORD *)(a1 + 40) = v6;
      }
      else
      {
