/*
 * XREFs of WdipSemUpdateProviderTableWithEvent @ 0x14079A5E8
 * Callers:
 *     WdipSemUpdateProviderTableWithScenario @ 0x14079A574 (WdipSemUpdateProviderTableWithScenario.c)
 * Callees:
 *     EtwEventEnabled @ 0x14021BF30 (EtwEventEnabled.c)
 *     memset @ 0x140414200 (memset.c)
 *     WdipSemFastAllocate @ 0x1407889C0 (WdipSemFastAllocate.c)
 *     WdipSemQueryProviderTable @ 0x14079A68C (WdipSemQueryProviderTable.c)
...
__int64 __fastcall WdipSemUpdateProviderTableWithEvent(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    else if ( (unsigned int)dword_140C1C9C0 >= 0x400 )
    {
    ...
    else
    {
      ...
      if ( v5 )
      {
        memset(v5, 0, 0x50uLL);
        *v6 = *(_OWORD *)a1;
        WdipSemProviderTable[dword_140C1C9C0++] = v6;
        *(_QWORD *)(a1 + 40) = v6;
      }
      else
      {
