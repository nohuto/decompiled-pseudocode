/*
 * XREFs of TtmiLogSessionPowerRequestCreated @ 0x1409A9D3C
 * Callers:
...
void TtmiLogSessionPowerRequestCreated()
{
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v6 = v2;
      v11 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D3B908, (unsigned __int8 *)byte_140033033, 0LL, 0LL, 5u, &v7);
    }
  }
}
