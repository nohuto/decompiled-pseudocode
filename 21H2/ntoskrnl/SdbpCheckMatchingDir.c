/*
 * XREFs of SdbpCheckMatchingDir @ 0x140A10CF0
 * Callers:
 *     <none>
 * Callees:
        ...
        const WCHAR *P)
{
  ...
  if ( FirstTag )
  {
    ...
    do
      ++v12;
    while ( *(_WORD *)(StringTagPtr + 2 * v12) );
    v13 = P;
...
LABEL_3:
    ...
    if ( *v14 > 0 )
    {
      ...
      {
        P = 0LL;
        if ( !(unsigned int)SdbpResolveMatchingFile(a2, v13, v11, (unsigned int)v12, &v14[12 * v15 + 2], &P) )
          goto LABEL_3;
        v16 = (WCHAR *)P;
