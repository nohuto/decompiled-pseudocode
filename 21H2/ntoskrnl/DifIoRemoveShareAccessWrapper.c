/*
 * XREFs of DifIoRemoveShareAccessWrapper @ 0x140610B30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IoRemoveShareAccess @ 0x14074B990 (IoRemoveShareAccess.c)
 */

void __fastcall DifIoRemoveShareAccessWrapper(PFILE_OBJECT FileObject, PSHARE_ACCESS ShareAccess)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  ...
  PFILE_OBJECT v15; // [rsp+30h] [rbp-18h]
  __int64 retaddr; // [rsp+48h] [rbp+0h]

  v14 = 0LL;
  v15 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(201);
