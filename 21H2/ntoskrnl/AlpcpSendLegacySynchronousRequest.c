/*
 * XREFs of AlpcpSendLegacySynchronousRequest @ 0x1406666B4
 * Callers:
...
LABEL_17:
      ...
      *(_WORD *)(v13 + 244) = 8193;
      if ( v43 )
      {
        v14 = AlpcpAvailableBufferSize(v13, (__int16)v39);
        if ( v15 > v14 )
        {
      ...
      {
        v30 = AlpcpAvailableBufferSize(v13, (__int16)v39);
        if ( v31 <= v30 )
        {
        ...
        v16 = AlpcpCaptureMessageData(v32, v31, (char *)a3 + 40);
        v33 = v16;
      }
      if ( v16 < 0 )
      {
...
LABEL_56:
        ...
        else
        {
          ...
          *((_WORD *)v36 + 9) += 3;
          v22 = CurrentThread;
          _InterlockedExchange64((volatile __int64 *)&CurrentThread[1].RelativeTimerBias, v21);
          v23 = (ULONG_PTR)v34;
          *((_QWORD *)v34 + 4) = v22;
          AlpcpSetOwnerPortMessage(v23, a1);
          v24 = v37;
          *(_QWORD *)(v23 + 184) = v37;
          *(_QWORD *)(v23 + 192) = *v24;
          *(_QWORD *)(v5 + 8) = v23;
          if ( AlpcpLogEnabled )
          {
            AlpcpLogSendMessage(v23);
            if ( AlpcpLogEnabled )
              AlpcpLogWaitForReply(v23);
          }
          v25 = 0LL;
          v35 = 0LL;
          if ( *(_QWORD *)(v18 + 232) != v18 + 232 )
          {
            ...
            {
              v35 = v26 - 177;
              AlpcpInsertMessagePendingQueue(v18, v23);
              ++*((_WORD *)v36 + 9);
          ...
          *(_QWORD *)(v5 + 40) = 0LL;
          ...
          {
            AlpcpInsertMessageMainQueue(v18, v23);
