/*
 * XREFs of PpForEachDeviceInstanceDriver @ 0x14076B788
 * Callers:
...
__int64 __fastcall PpForEachDeviceInstanceDriver(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v7 = v27;
    DeviceRegProp = CmOpenDeviceRegKey(PiPnpRtlCtx, v27, 16, 0, 131097, 0, (__int64)&v26, 0LL);
    if ( DeviceRegProp >= 0 )
    {
      v22 = 78;
...
LABEL_14:
          ...
          else
          {
            if ( DeviceRegProp < 0 )
              goto LABEL_17;
            DeviceRegProp = PiForEachDriverQueryRoutine(v23, Pool2, v21, v28);
            if ( DeviceRegProp < 0 )
              goto LABEL_17;
          }
LABEL_16:
