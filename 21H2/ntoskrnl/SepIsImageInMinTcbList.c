...
LABEL_9:
    ...
    *a8 = v23;
    if ( !qword_140C1DB00 || (LOBYTE(v20) = *v22, LOBYTE(v17) = a6, !(unsigned int)qword_140C1DB00(v20, v17)) )
      *v22 = a6;
    if ( !qword_140C1DB00 || (LOBYTE(v20) = *a8, LOBYTE(v17) = a6, !(unsigned int)qword_140C1DB00(v20, v17)) )
      *a8 = a6;
