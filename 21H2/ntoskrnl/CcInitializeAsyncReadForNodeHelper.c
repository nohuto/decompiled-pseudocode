/*
 * XREFs of CcInitializeAsyncReadForNodeHelper @ 0x1403D0750
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CcInitializeAsyncReadForNodeHelper(__int64 a1, __int64 a2, __int64 a3, char *a4)
{
  ...
  PoolWithTagFromNode = ExpAllocatePoolWithTagFromNode(
                          ...
                          v4 | 0x80000000,
                          0);
  v10 = CcMaxNestingLevel;
  v11 = *(_DWORD *)(a3 + 24) | 0x80000000;
  *(_QWORD *)(a3 + 232) = PoolWithTagFromNode;
  v12 = ExpAllocatePoolWithTagFromNode(NonPagedPoolNx, 16LL * (unsigned int)(v10 + 1), 1901552451LL, v11, 0);
  v13 = CcMaxNestingLevel;
  v14 = *(_DWORD *)(a3 + 24) | 0x80000000;
  *(_QWORD *)(a3 + 256) = v12;
  v15 = ExpAllocatePoolWithTagFromNode(NonPagedPoolNx, 16LL * (unsigned int)(v13 + 1), 1901552451LL, v14, 0);
  v16 = CcMaxNestingLevel;
  v17 = *(_DWORD *)(a3 + 24) | 0x80000000;
  *(_QWORD *)(a3 + 264) = v15;
  v18 = ExpAllocatePoolWithTagFromNode(NonPagedPoolNx, 404LL * (unsigned int)(v16 + 1), 1901552451LL, v17, 0);
  v19 = *(_DWORD *)(a3 + 24);
  *(_QWORD *)(a3 + 280) = v18;
  v20 = ExpAllocatePoolWithTagFromNode(
          NonPagedPoolNx,
          24LL * (unsigned int)(CcMaxNestingLevel + 1),
          1901552451LL,
          v19 | 0x80000000,
          0);
  v21 = CcMaxNestingLevel;
  v22 = *(_DWORD *)(a3 + 24) | 0x80000000;
  *(_QWORD *)(a3 + 272) = v20;
  v23 = ExpAllocatePoolWithTagFromNode(NonPagedPoolNx, 4LL * (unsigned int)(v21 + 1), 1901552451LL, v22, 0);
  v24 = CcMaxNestingLevel;
  v25 = *(_DWORD *)(a3 + 24) | 0x80000000;
  *(_QWORD *)(a3 + 240) = v23;
  v26 = ExpAllocatePoolWithTagFromNode(NonPagedPoolNx, 4LL * (unsigned int)(v24 + 1), 1901552451LL, v25, 0);
  *(_QWORD *)(a3 + 248) = v26;
  if ( *(_QWORD *)(a3 + 232)
    && *(_QWORD *)(a3 + 256)
    && *(_QWORD *)(a3 + 264)
    ...
    && v26 )
  {
    ...
    while ( 1 )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(a3 + 248) + 4LL * v27) = 0;
      memset((void *)(v28 + *(_QWORD *)(a3 + 280)), 255, 4LL * (unsigned int)CcMaxAsyncReadWorkerThreads);
      ...
      if ( ++v27 > CcMaxNestingLevel )
      {
        ...
        while ( 1 )
        {
          ...
          *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
          StartContext = (_QWORD *)ExpAllocatePoolWithTagFromNode(NonPagedPoolNx, 0x50uLL, 1901552451LL, v42, 0);
          v44 = StartContext;
          if ( !StartContext )
            goto LABEL_21;
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)v37 = 0LL;
      ...
      if ( *v39 != v38 )
        __fastfail(3u);
      *(_QWORD *)v37 = v38;
      v40 = ++v36 < (unsigned int)CcMaxAsyncReadWorkerThreads;
      *(_QWORD *)(v37 + 8) = v39;
      *v39 = v37;
      *(_QWORD *)(v38 + 8) = v37;
      if ( !v40 )
