/*
 * XREFs of RtlpAllowsLowBoxAccess @ 0x140244198
 * Callers:
...
char __fastcall RtlpAllowsLowBoxAccess(__int64 a1)
{
  ...
  _BYTE v14[4]; // [rsp+80h] [rbp-80h] BYREF
  _BYTE v15[4]; // [rsp+84h] [rbp-7Ch] BYREF
  ...
  *(_OWORD *)Object = 0LL;
  ...
  if ( !v1 )
    return 1;
  v3 = (_DWORD *)PsReferenceEffectiveToken(KeGetCurrentThread(), 1836020801LL, v15, v11, v14, 0LL);
  Object[0] = v3;
  if ( (v3[50] & 0x400000) != 0 )
  {
    ...
    PoolWithTag = (wchar_t *)ExAllocatePoolWithTag(PagedPool, v6, 0x6D4E7441u);
    v8 = PoolWithTag;
    if ( PoolWithTag )
    {
      memset(PoolWithTag, 0, v6);
      if ( RtlStringCbCopyW(v8, v6, (NTSTRSAFE_PCWSTR)(a1 + 42)) < 0 )
