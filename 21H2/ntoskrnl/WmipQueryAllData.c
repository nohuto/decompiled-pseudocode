/*
 * XREFs of WmipQueryAllData @ 0x14078CD70
 * Callers:
...
__int64 __fastcall WmipQueryAllData(PVOID Object, IRP *a2, KPROCESSOR_MODE a3, __int64 a4, unsigned int a5, _DWORD *a6)
{
  ...
  *(_OWORD *)&v47[1] = 0LL;
  ...
  v40 = 16;
  P = v51;
  v11 = WmipPrepareForWnodeAD((__int64)v7, &v47[1], (int *)&v40, (__int64 *)&P, &v39);
  if ( (v11 & 0x80000000) != 0 )
    goto LABEL_33;
  v11 = 0;
  v12 = *(_DWORD *)(a4 + 44);
...
LABEL_60:
  ...
  {
    v22 = *v19;
    v41 = (volatile signed __int64 *)*v19;
    if ( v15 || v17 || v14 < 0x48 )
    {
      v14 = 72;
      v13 = v50;
...
LABEL_41:
      ...
      if ( v23 )
      {
        WmipAlign(4, (int *)&v40);
        v30 = v41;
        v37 = WmipStaticInstanceNameSize((__int64)v41);
        v40 += v37;
      }
      else
      {
    ...
    {
      WmipInsertStaticNames((int *)v13, v14, (__int64)v41);
      if ( (*((_DWORD *)v13 + 11) & 0x20) != 0 )
      {
        v15 = 1;
