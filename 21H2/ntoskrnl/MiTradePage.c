/*
 * XREFs of MiTradePage @ 0x140300BE0
 * Callers:
...
LABEL_119:
    ...
    v50 = MiTradeTransitionPage(v9, v11, (__int64)v48, v92, v4, &v87);
    if ( v50 == 3 )
    {
...
LABEL_86:
  ...
  if ( ((*(_QWORD *)(v9 + 40) >> 60) & 7) == 2 )
  {
    ...
    __writecr8(v11);
    if ( (unsigned int)MiSwapStackPage(v6, v9, v48, *(_DWORD *)(a1 + 28), v4, &v87, &v82) )
      goto LABEL_136;
    if ( ((*(_QWORD *)(v9 + 40) >> 60) & 7) == 2 )
      goto LABEL_130;
    goto LABEL_77;
  ...
  if ( (unsigned int)MI_PFN_IS_PROTO(v9) )
    ...
    v61 = MiStealPage(v60, v11, v4, (__int128 *)v48, *(_DWORD *)(a1 + 28), &v87);
  v65 = v61;
  _InterlockedAnd64((volatile signed __int64 *)(v9 + 24), 0x7FFFFFFFFFFFFFFFuLL);
  if ( KiIrqlFlags )
  {
