...
__int64 (__fastcall *KiInitSystem())(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  __int64 v0; // rcx
  _QWORD *v1; // rax
  __int64 (__fastcall *result)(__int64, __int64, __int64, _DWORD *); // rax

  if ( KiForceSymbolReferencesTrigger )
    KiForceSymbolReferences();
  v0 = 1024LL;
  LODWORD(xmmword_140E018F0) = 0;
  qword_140C32158 = (__int64)&KeBugCheckCallbackListHead;
  KeBugCheckCallbackListHead = (__int64)&KeBugCheckCallbackListHead;
  qword_140C31DA8 = (__int64)&KeBugCheckReasonCallbackListHead;
  KeBugCheckReasonCallbackListHead = &KeBugCheckReasonCallbackListHead;
  qword_140C31D98 = (__int64)&KeBugCheckAddRemovePagesCallbackListHead;
  KeBugCheckAddRemovePagesCallbackListHead = (__int64)&KeBugCheckAddRemovePagesCallbackListHead;
  qword_140C31DB8 = (__int64)&KeBugCheckTriageDumpDataArrayListHead;
  KeBugCheckTriageDumpDataArrayListHead = (__int64)&KeBugCheckTriageDumpDataArrayListHead;
  qword_140C31E48 = (__int64)&KiProfileListHead;
  KiProfileListHead = (__int64)&KiProfileListHead;
  qword_140C31E08 = (__int64)&KiProfileSourceListHead;
  ...
  *((_QWORD *)&xmmword_140E018D0 + 1) = KiArgumentTable;
  qword_140C32118 = (__int64)KiBalanceSetManagerDeferredRoutine;
  qword_140C32120 = (__int64)&KiBalanceSetManagerPeriodicEvent;
  qword_140C31E90 = (__int64)&qword_140C31E88;
  qword_140C31E88 = (__int64)&qword_140C31E88;
