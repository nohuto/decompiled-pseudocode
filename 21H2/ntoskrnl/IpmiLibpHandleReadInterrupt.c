/*
 * XREFs of IpmiLibpHandleReadInterrupt @ 0x1406536F0
 * Callers:
 *     IpmiLibpKcsReceiveResponseFromBmc @ 0x140653104 (IpmiLibpKcsReceiveResponseFromBmc.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x14042A5E0 (_guard_dispatch_icall.c)
 *     IpmiLibWriteOneByte @ 0x140652C64 (IpmiLibWriteOneByte.c)
 */
        ...
        unsigned __int16 *a5)
{
  ...
  if ( !qword_140C10CD0 )
    return 3221225485LL;
  result = qword_140C10CD0(qword_140C10CD8, &WheaIpmiContext, a2, &v11, v10, 0);
  if ( (int)result >= 0 )
  {
    if ( (_BYTE)v11 )
    {
