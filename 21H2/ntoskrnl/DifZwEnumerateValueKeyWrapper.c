/*
 * XREFs of DifZwEnumerateValueKeyWrapper @ 0x1406202D0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwEnumerateValueKeyWrapper(
        HANDLE KeyHandle,
        ULONG Index,
        unsigned __int32 KeyValueInformationClass,
        ...
        PULONG ResultLength)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(529);
...
LABEL_13:
  LODWORD(v22) = Length;
  *((_QWORD *)&v21 + 1) = ResultLength;
  *((_QWORD *)&v23 + 1) = KeyHandle;
  *(_QWORD *)&v23 = __PAIR64__(Index, KeyValueInformationClass);
  *((_QWORD *)&v22 + 1) = KeyValueInformation;
