/*
 * XREFs of RtlpHpSegContextCompact @ 0x140311520
 * Callers:
...
_QWORD *__fastcall RtlpHpSegContextCompact(__int64 a1, int a2)
{
  ...
  int v27; // edx
  _QWORD *v28; // [rsp+30h] [rbp-38h] BYREF
  _QWORD *v29; // [rsp+38h] [rbp-30h]
        ...
        if ( v8 < v9 )
        {
          while ( 1 )
          {
            if ( (*(_BYTE *)(v8 + 24) & 1) == 0 && *(_WORD *)(v8 + 28) != 0xFFFF )
            {
              ...
              *(_BYTE *)(v12 + v8 + 24) |= 1u;
              v8 = RtlpHpSegPageRangeCoalesce(a1, v8, a2, 1, (__int64)&v30);
          ...
          if ( *(_QWORD **)(*v13 + 8LL) != v13
            || (_QWORD *)*v22 != v13
            || (*v22 = v21, *(_QWORD *)(v21 + 8) = v22, v23 = (_QWORD **)v29, --*(_QWORD *)(a1 + 88), *v23 != &v28) )
          {
            __fastfail(3u);
          }
          v13[1] = v23;
...
LABEL_38:
  ...
  v10 = v28;
  for ( result = &v28; v10 != &v28; result = &v28 )
  {
    v10 = (_QWORD *)*v10;
