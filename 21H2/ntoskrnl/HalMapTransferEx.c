/*
 * XREFs of HalMapTransferEx @ 0x140517000
 * Callers:
...
LABEL_21:
  ...
  *(_QWORD *)(v21 + 8) = 0LL;
  ...
  if ( !*(_BYTE *)(a1 + 433) )
  {
    MaxFragments = HalpDmaControllerQueryMaxFragments(*(_QWORD *)(a1 + 360), a1, (unsigned int)v24);
    if ( MaxFragments < (unsigned int)v24 )
      v24 = MaxFragments;
    v59 = v24;
  }
  v26 = a6;
  HalpDmaCheckMdlAccessibility(a1, (__int64 *)v15, a4, *a6, &v68, &Mdl);
  v13 = *(_DWORD *)(a1 + 512) == 3;
  v60 = 0LL;
  if ( v13 )
  {
    ...
    while ( v31 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v23 >= (unsigned int)v59 )
          goto LABEL_73;
        v54 = v41;
        v42 = IoMapTransferInternal(a1, v15, v69, v27, &v54, a7, v68);
        v43 = v54;
        v44 = v42;
        if ( !v54 )
        {
...
LABEL_73:
        ...
        *((_QWORD *)&v62 + 1) = v42 & 0xFFFFFFFFFFFFF000uLL;
        ...
        if ( v13 )
        {
          ...
          v46 = ((__int64 (__fastcall *)(__int64 *, _QWORD, __int64, __int128 *, __int128 *))qword_140C4BE00)(
                  v58,
                  *(_QWORD *)(v69 + 40),
                  3LL,
                  &v62,
        ...
        if ( *(_DWORD *)(a1 + 512) == 1 )
          v56 = ((__int64 (__fastcall *)(_QWORD, __int64, __int128 *))qword_140C4BDB8)(*(_QWORD *)(v64 + 40), 3LL, &v62);
        v32 = v54 + v53;
        v27 = v65 + v57;
        v41 = v55 - v54;
        v53 += v54;
  ...
  else
  {
    ...
    do
    {
      ...
      if ( v13 )
      {
        HalpDmaFlushBuffer(v32, v15, a4 + v35 + *(_QWORD *)(v15 + 32), v34, a7, v68);
        v32 = v53;
        v28 = v55;
        v33 = v57;
        v36 = v58;
...
LABEL_75:
  ...
  *v49 = v32;
  ...
  {
    v51 = Mdl;
    HalpDmaFlushDriverMdl(Mdl, a7 == 0, v27, v28);
    if ( v51 )
    {
      do
      {
  ...
  if ( *(_BYTE *)(a1 + 433) )
    ...
    return HalpDmaControllerProgramChannel(*(_QWORD *)(a1 + 360), a1, a10, a11, v21, *(_QWORD *)(a1 + 448) + a5, v50);
}
