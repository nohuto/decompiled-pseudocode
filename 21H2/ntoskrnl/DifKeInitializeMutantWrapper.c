/*
 * XREFs of DifKeInitializeMutantWrapper @ 0x140613080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeInitializeMutantWrapper(__int64 a1, char a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
...
LABEL_18:
  result = KiInitializeMutant(a1, a2, 0, 0);
  if ( APIThunkContextById )
  {
