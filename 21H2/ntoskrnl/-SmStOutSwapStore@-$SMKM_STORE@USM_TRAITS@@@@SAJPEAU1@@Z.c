/*
 * XREFs of ?SmStOutSwapStore@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@@Z @ 0x14037556C
 * Callers:
...
LABEL_69:
      ...
      if ( v32 && ($CEA84C04E3712D858E5667A507841A2A *)v34->ApcState.ApcListHead[0].Flink != &v34->152 )
        KiCheckForKernelApcDelivery();
      v38 = 0;
      if ( (_DWORD)v4 )
      {
        v25 = SmPerformStoreSwapOperation(1LL);
        if ( v25 < 0 )
          goto LABEL_55;
        v7 = v5;
        *(_QWORD *)v5 = 0LL;
...
LABEL_40:
        ...
        do
        {
          SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(a1, *v29++, v26, v27, v35, 2);
          --v4;
        }
        while ( v4 );
        v3 = PoolWithTag;
...
LABEL_16:
  ...
  while ( 1 )
  {
    ...
    if ( (v18 & 0x7FFFFFFFFFFF0000LL) == 0 || v18 < 0 )
      goto LABEL_23;
    v37 = SMKM_STORE<SM_TRAITS>::SmStMapVirtualRegion(a1, v8, 0, v11, 4);
    if ( !(unsigned int)SmArrayGrow((unsigned int)v4, v19, &v39, &P) )
      break;
    v21 = P;
...
LABEL_23:
  ...
  SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(a1, v8, v20, v11, v35, 2);
  v25 = -1073741670;
LABEL_55:
  v2 = (void *)v5;
  v7 = 0LL;
...
LABEL_61:
    ...
    if ( v32 && ($CEA84C04E3712D858E5667A507841A2A *)v31->ApcState.ApcListHead[0].Flink != &v31->152 )
      KiCheckForKernelApcDelivery();
  }
  if ( v7 != -1 )
    goto LABEL_45;
