/*
 * XREFs of PpmIdleAllocateVetoReasons @ 0x14098A2C4
 * Callers:
...
__int64 __fastcall PpmIdleAllocateVetoReasons(_DWORD *a1)
{
  ...
  Pool2 = ExAllocatePool2(64LL, (v5 * *(_DWORD *)PpmPlatformStates) << 6, 1766674512LL);
...
LABEL_8:
  ...
  *(_DWORD *)v6 = *(_DWORD *)PpmIdleVetoList;
  ...
  v15 = 0;
  for ( PpmIdleVetoList = v7; v15 < *(_DWORD *)PpmPlatformStates; ++v15 )
  {
    PpmIdleInstallNewVetoList(448LL * v15 + v14 + 64, v5, (char *)(Pool2 + ((unsigned __int64)(v15 * v5) << 6)));
    v14 = PpmPlatformStates;
  }
