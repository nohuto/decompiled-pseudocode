/*
 * XREFs of DifKeRegisterNmiCallbackWrapper @ 0x140614220
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall DifKeRegisterNmiCallbackWrapper(PNMI_CALLBACK CallbackRoutine, PVOID Context)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
...
LABEL_18:
  result = KeRegisterNmiCallback(CallbackRoutine, Context);
  *((_QWORD *)&v16 + 1) = result;
  if ( APIThunkContextById )
  {
