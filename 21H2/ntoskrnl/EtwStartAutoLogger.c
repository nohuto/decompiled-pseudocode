/*
 * XREFs of EtwStartAutoLogger @ 0x140817CD8
 * Callers:
 ...
 *     EtwpParsePoolTagFilter @ 0x1409EC624 (EtwpParsePoolTagFilter.c)
    ...
    if ( Pool2 )
    {
      ...
      if ( v9 )
      {
        ...
        *(_DWORD *)(v6 + 176) = 1;
        ...
        LODWORD(v118[11]) = 4;
        v80 = 4;
        RegistryValues = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)KeyHandle, (__int64)v118, 0LL);
        if ( RegistryValues < 0 )
          goto LABEL_10;
        if ( !a3 )
        {
...
LABEL_7:
          if ( !v14 )
          {
            if ( Handle )
            {
              v118[5] = &v55;
              memset(&v118[7], 0, 56);
              RegistryValues = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)Handle, (__int64)v118, 0LL);
              if ( RegistryValues < 0 )
                RegistryValues = 0;
            }
          }
          ...
          LODWORD(v118[130]) = 1;
          v114 = 1;
          v118[133] = EtwpQueryRegistryCallback;
          v117 = v6 + 80;
          LODWORD(v62) = 8;
          LODWORD(v118[139]) = 8;
          v18 = RtlpQueryRegistryValues(0x40000000, (const WCHAR *)KeyHandle, (__int64)v118, 0LL);
          v19 = 0LL;
          RegistryValues = v18;
          if ( v18 < 0 )
            goto LABEL_10;
          if ( Handle )
          {
            ...
            RtlpQueryRegistryValues(0x40000000, (const WCHAR *)Handle, (__int64)v118, 0LL);
            v19 = 0LL;
          }
          v20 = 1LL;
          v21 = *(_DWORD *)(v6 + 112) | 2;
          *(_DWORD *)(v6 + 112) = v21;
          ...
          if ( v71.Buffer )
          {
            ...
            v40 = EtwpParsePoolTagFilter(&v71, v6 + 1256, v19, v20);
            v24 = v40;
            if ( v40 )
            {
              *v13 = v40 + 1;
...
LABEL_48:
            ...
            *(_DWORD *)v6 = v12;
            *(GUID *)(v6 + 24) = v27;
            started = EtwpStartLogger(v29, v6);
                  ...
                  *(_DWORD *)&GuidString.MaximumLength = (unsigned __int16)(v69.MaximumLength - v69.Length + 76);
                  if ( v43 <= 0x200 )
                  {
                    ...
                    if ( v43 )
                    {
                      while ( 1 )
                      {
                        RegistryValues = RtlGUIDFromString(&GuidString, (GUID *)(v44 + 16LL * v45));
                        if ( RegistryValues )
                          break;
...
LABEL_109:
                      if ( !RegistryValues )
                      {
                        ...
                        EtwpUpdateDisallowList(CurrentServerSiloGlobals[108], v31, v43, v44);
                      }
                    }
                  }
                }
              ...
              EtwpEnableKeyProviders(v32[108], v31, v76, (_DWORD)v75, v49);
            }
            goto LABEL_10;
          }
          if ( UnicodeString.Buffer )
            RegistryValues = RtlGUIDFromString(&UnicodeString, &Guid);
          else
...
LABEL_11:
  ...
  if ( KeyHandle )
  {
    if ( RegistryValues < 0 )
    {
      v47 = RtlNtStatusToDosError(RegistryValues);
      v15 = (const WCHAR *)KeyHandle;
      ValueData = v47;
    }
    if ( Handle )
