/*
 * XREFs of RtlpHpAllocVA @ 0x140351E90
 * Callers:
...
__int64 __fastcall RtlpHpAllocVA(__int64 *a1, __int64 *a2, __int64 a3, int a4, int a5, __int128 *a6)
{
  ...
  *((_QWORD *)&v24 + 1) = 0x20000000200000LL;
  ...
  {
    v24 = *a6;
    HeapManager = RtlpHpEnvGetHeapManager(&v24);
    v16 = 0;
    v22 = 0;
    if ( BYTE3(v20) )
      v21[0] = BYTE3(v20) - 1;
    ...
    *(_QWORD *)&v24 = v17 - (((_DWORD)v17 - 1) & 0xFFFFF) + 0xFFFFF;
    v18 = RtlpHpVaMgrCtxAlloc(HeapManager + 88, (__int64)&v24, v15, v21);
    if ( !v18 )
      return 3221225626LL;
    *a2 = v24;
    *a1 = v18;
  ...
  *(_QWORD *)&v24 = v10;
  ...
  if ( (((unsigned __int8)v20 >> 3) & ((a4 & 0x2000) != 0)) == 0 )
    v11 = a4 & 0xFEFFFFFF;
  result = RtlpHpEnvAllocVA((_DWORD)a1, (unsigned int)&v24, 0, v11, a5, ((unsigned __int8)v20 >> 1) & 3, BYTE1(v20));
  if ( (int)result >= 0 )
  {
    v13 = v24;
