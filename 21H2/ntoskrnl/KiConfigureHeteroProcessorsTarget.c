/*
 * XREFs of KiConfigureHeteroProcessorsTarget @ 0x140568D20
 * Callers:
 *     <none>
 * Callees:
...
volatile signed __int32 *__fastcall KiConfigureHeteroProcessorsTarget(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (v7 & 0x7FFFFFFF) != 0 )
  {
    ...
    while ( (*(_DWORD *)v5 & 0x80000000) != v8 )
      KeYieldProcessorEx(&v56, a2, a3, a4);
  }
  else
  {
  ...
  if ( !KeGetPcr()->Prcb.Number )
  {
    ...
    if ( KeNumberNodes )
    {
      ...
      {
        HIDWORD(v59) = 0;
        *(_QWORD *)&v59 = KeNodeBlock[v36];
        DWORD2(v59) = *(_DWORD *)(v59 + 16);
        while ( !(unsigned int)KeEnumerateNextSchedulerSubNodeInNode((__int64)&v59, &v58) )
          ++v35;
        v10 = 1LL;
        v36 = v37 + 1;
      }
      while ( v36 < (unsigned __int16)KeNumberNodes );
    }
    else
    {
      v10 = 1LL;
...
LABEL_64:
    ...
    KiTraceLogHeteroRundown(&dword_140C02FD0, a2, a3);
  }
LABEL_67:
  ...
  if ( (v53 & 0x7FFFFFFF) != 0 )
  {
    ...
    while ( (*(_DWORD *)v5 & 0x80000000) != v54 )
      KeYieldProcessorEx(&v57, a2, a3, v10);
  }
  else
  {
