/*
 * XREFs of NtCreateThread @ 0x140907170
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  ...
  if ( result >= 0 )
  {
    ...
    *(_INITIAL_TEB::$51A6825BF626353FB0168B5A96FF6713 *)v23 = InitialTeb->OldInitialTeb;
    if ( *(_OWORD *)v23 == 0LL )
    {
      *(_INITIAL_TEB::$51A6825BF626353FB0168B5A96FF6713 *)v23 = OldInitialTeb;
      *(_OWORD *)&v23[2] = *(_OWORD *)&InitialTeb->StackBase;
      v23[4] = (__int64)InitialTeb->StackAllocationBase;
      if ( v23[4] )
      {
