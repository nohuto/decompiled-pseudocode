/*
 * XREFs of MiLogContinueTrim @ 0x140596944
 * Callers:
...
void MiLogContinueTrim()
{
  ...
  {
    if ( tlgKeywordOn(*(__int64 *)&qword_140C53448, 1LL) )
    {
      v4 = *v1;
      v13 = 0;
      v16 = 0;
      ...
      v24 = v0 + 7;
      v12 = 4;
      tlgWriteTransfer_EtwWriteTransfer(v2, (unsigned __int8 *)&unk_14002CCF0, 0LL, 0LL, 7u, &v10);
    }
  }
}
