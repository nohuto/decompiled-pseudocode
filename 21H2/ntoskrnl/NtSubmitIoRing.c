/*
 * XREFs of NtSubmitIoRing @ 0x14055A160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtSubmitIoRing(HANDLE Handle, __int16 a2, unsigned int a3, LARGE_INTEGER *a4)
{
  ...
  Object = 0LL;
  v8 = ObReferenceObjectByHandle(Handle, 0, IoRingObjectType, PreviousMode, &Object, 0LL);
  v27 = (char *)Object;
  v26 = v8;
  if ( v8 >= 0 )
  {
...
LABEL_29:
      ...
      while ( v18 != v9 )
      {
        ...
        *(_QWORD *)&v36[5] = *(_QWORD *)&v10[v20 + 24];
        v32 = ++v18;
        *v10 = v18;
        IopProcessIoRingEntry(v27);
        v9 = v28;
      }
      if ( v13 )
      {
        v26 = KeWaitForSingleObject(v27 + 136, WrIoRing, PreviousMode, 0, a4);
        if ( v26 )
        {
          v21 = 0;
