/*
 * XREFs of HvlChangeIsolatedMemoryVisibility @ 0x140653C40
 * Callers:
...
__int64 __fastcall HvlChangeIsolatedMemoryVisibility(__int64 a1, unsigned __int64 a2, __int64 a3, _QWORD *a4)
{
  unsigned int v7; // edi
  _QWORD *v8; // r14
  unsigned int v9; // ebx
  ...
  *a4 = 0LL;
  v17 = 0LL;
  LODWORD(v18) = 0;
  v8 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v16, 1, 0LL, 0LL);
  v8[1] = 0LL;
  *v8 = -1LL;
  *((_DWORD *)v8 + 2) &= 0xFFFFFFFC;
  if ( a2 )
  {
    v9 = 0;
    while ( 1 )
