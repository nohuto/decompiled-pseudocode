/*
 * XREFs of RtlLookupFunctionEntry @ 0x1402640A0
 * Callers:
...
LABEL_29:
    ...
    {
      v19 = RtlpxLookupFunctionTable(ControlPc, &v30);
    }
    else
    {
      v19 = xmmword_140E00020;
    ...
    if ( v19 )
    {
      ...
      *ImageBase = *((_QWORD *)&v30 + 1);
      ...
      {
        v23 = ControlPc - v20;
        v24 = *(unsigned int *)(v19 + 12LL * (unsigned int)(v22 - 1));
        v25 = (_IMAGE_RUNTIME_FUNCTION_ENTRY *)(v19 + 12LL * (unsigned int)(v22 - 1));
        if ( v23 < v24 )
        {
          v26 = v22 - 2;
          ...
          {
            v28 = (i + v26) >> 1;
            v25 = (_IMAGE_RUNTIME_FUNCTION_ENTRY *)(v19 + 12LL * v28);
