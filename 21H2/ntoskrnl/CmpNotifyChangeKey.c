/*
 * XREFs of CmpNotifyChangeKey @ 0x1407E5F70
 * Callers:
...
LABEL_32:
  ...
  v22 = a2 + 2;
  if ( *(__int64 **)qword_140D3B690 != &CmpAsyncKernelPostList )
    goto LABEL_32;
...
LABEL_16:
  ...
  if ( *(int *)(v12 + 48) >= 0 )
    return 259LL;
  CmpPostNotify(v12, (__int64)SListFaultAddress, v11, 0x10Cu, 1, 0LL, 0LL);
  return 0LL;
}
