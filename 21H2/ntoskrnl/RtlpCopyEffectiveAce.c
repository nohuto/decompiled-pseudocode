/*
 * XREFs of RtlpCopyEffectiveAce @ 0x1407288D0
 * Callers:
...
LABEL_22:
    ...
    if ( v19 != 4 )
    {
      ...
      if ( !v42 )
        v44 = 3LL;
      Sid1 = &Src[4 * (Src[2] & 1) + v44];
      v45 = (_DWORD)Sid1 - (_DWORD)Src;
      Size = (unsigned int)((_DWORD)Sid1 - (_DWORD)Src);
      if ( (v42 & 2) != 0 )
        v46 = &Src[4 * v43 + 3];
      else
        v46 = 0LL;
...
LABEL_86:
          ...
          *a15 = 1;
          ...
          else
          {
            ...
            memmove(v77, Src, Size);
            v77[0] = *((_BYTE *)&RtlBaseAceType + *(unsigned __int8 *)Src);
          }
          Srca = v77;
        }
      }
