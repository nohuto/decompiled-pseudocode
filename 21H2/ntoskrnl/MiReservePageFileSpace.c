/*
 * XREFs of MiReservePageFileSpace @ 0x14033AC90
 * Callers:
...
void __fastcall MiReservePageFileSpace(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v4 >= 0x10 )
  {
    ...
    {
      v16 = 1;
      if ( !(unsigned int)MiGetPageFileSectionForReservation(a2, &v43, 1LL) )
        return;
      v15 = *((_QWORD *)&v44 + 1);
      v42 = v44;
      v48 = 1;
...
LABEL_15:
      ...
      if ( Address && *((int *)Address + 13) < 0 )
        v16 |= ((_DWORD)Address[6] & 0xF80 | 0x40u) >> 5;
      v19 = a2 - 8;
      v20 = 0;
      LODWORD(v46) = 0;
      if ( a2 - 8 >= v17 )
      {
        do
        {
          if ( !(unsigned int)MiReservePageFileSpaceForPage(a1, v19, v16) )
            break;
          ++v20;
          v19 -= 8LL;
        }
      ...
      {
        if ( !(unsigned int)MiReservePageFileSpaceForPage(a1, v21, v16) )
          break;
        i = (unsigned int)(i + 1);
      }
      v23 = v46;
      v24 = i + v46 + 1;
      v46 = 0LL;
      if ( MI_IS_PTE_IN_WS_SWAP_SET(a1, &v46) )
      {
        v46 = 0LL;
        v26 = 16;
      }
      ...
      FreePageFileSpace = MiFindFreePageFileSpace(a1, (unsigned __int64 *)&v46, v24, v26 | 1u);
...
LABEL_29:
        ...
        if ( v30 <= v28 )
        {
          ...
          do
          {
            v32 = MiReservePageFileSpaceForPage(a1, v30, v29);
            v33 = v46;
            if ( !v32 )
              MiReleasePageFileInfo(a1, v46, v31 != 0);
            v34 = v33;
            ...
            v30 += 8LL;
            v46 = MiSwizzleInvalidPte((v33 + 0x100000000LL) ^ (unsigned int)v34 ^ (unsigned int)v33);
          }
          while ( v30 <= v28 );
        }
      }
LABEL_41:
      if ( v48 )
        MiReleasePageFileSectionInfo(&v43, v25);
      return;
    }
    v8 = a2 << 25 >> 16;
    ...
    if ( Address )
    {
        ...
        && ((v9 & 0x200000) == 0 || (v9 & 0x800000) == 0 && (v9 & 0x180000u) < 0x100000) )
      {
        ...
        v13 = v10 + 2093056;
        v14 = *((unsigned int *)Address + 7) | ((unsigned __int64)*((unsigned __int8 *)Address + 33) << 32);
        v42 = v12;
        if ( v13 <= v14 << 12 )
        {
          v42 = v12;
