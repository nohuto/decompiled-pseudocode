/*
 * XREFs of MiReplacePageOfProtoPool @ 0x14026FB78
 * Callers:
...
__int64 __fastcall MiReplacePageOfProtoPool(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, __int64 a4)
{
  ...
  RTL_BITMAP v55; // [rsp+40h] [rbp-69h] BYREF
  ...
  *(_QWORD *)&v55.SizeOfBitMap = 512LL;
  v5 = a4;
  v53 = a4;
  v55.Buffer = (unsigned int *)v59;
  memset(v59, 0, sizeof(v59));
  if ( (unsigned int)MiGetPrototypePteRanges(v4, &v55) )
  {
    v51 = 0;
    v6 = 2;
    KeCopyPage(v5, v4);
...
LABEL_44:
        ...
        if ( v51 )
        {
          MiLockNestedPageAtDpcInline(48 * v54 - 0x220000000000LL);
        }
        else
        {
          LODWORD(v53) = 0;
...
LABEL_69:
          ...
          else if ( v44 != -1 )
          {
            v44 -= v52;
LABEL_61:
            v45 = MI_READ_PTE_LOCK_FREE(v36 + 8LL * v44);
            v54 = v45;
            if ( (v45 & 1) != 0 )
            {
              v45 = MI_READ_PTE_LOCK_FREE(&v54);
            }
...
LABEL_93:
            ...
            if ( (MI_READ_PTE_LOCK_FREE(v24) & 1) == 0 && (v27 & 0x20) != 0 )
            {
              ++dword_140C29D64;
              goto LABEL_86;
            }
