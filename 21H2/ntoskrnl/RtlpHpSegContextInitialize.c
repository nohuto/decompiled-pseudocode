/*
 * XREFs of RtlpHpSegContextInitialize @ 0x14036F8F8
 * Callers:
  ...
  if ( (_BYTE)v19 == 3 || (v20 = *(_QWORD *)v16 >> 8, (_BYTE)v20 == 2) )
  {
    ...
    *((_BYTE *)a1 + 13) = v20;
    if ( (v17 & 0x20) != 0 )
    {
      a8 = 0LL;
      v22 = v18;
      RtlpHpQueryVA(a3, &v22, &a8, &a9);
      RtlpHpSegMgrVaCtxInitialize((__int64)a1, a3, -*(_DWORD *)a1, 0x200000u);
      *(_WORD *)a8 = *(_WORD *)a8 & 0x7800 | 0x8001;
      LOBYTE(v20) = RtlpHpSegMgrVaCtxInsert((__int64)a1, a3);
    }
  }
  return v20;
}
