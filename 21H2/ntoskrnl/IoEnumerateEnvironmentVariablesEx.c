/*
 * XREFs of IoEnumerateEnvironmentVariablesEx @ 0x14093E3C0
 * Callers:
...
__int64 __fastcall IoEnumerateEnvironmentVariablesEx(unsigned int a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  if ( v8 >= 0 )
  {
    v11 = a3;
    v9 = Object;
    v8 = (*(__int64 (__fastcall **)(PVOID, PDEVICE_OBJECT, _QWORD, __int64, __int64, _DWORD *))(v15 + 16))(
           Object,
           DeviceObject,
           a1,
           a2,
  ...
  if ( (unsigned int)dword_140C06518 > 5 && tlgKeywordOn((__int64)&dword_140C06518, 0x200000000000LL) )
  {
    ...
    LODWORD(v15) = v8;
    v27 = 1;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C06518, (unsigned __int8 *)byte_14002B97B, 0LL, 0LL, 6u, &v16);
  }
