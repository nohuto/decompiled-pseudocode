/*
 * XREFs of EtwpPsProvTraceThread @ 0x1406F61A4
 * Callers:
...
NTSTATUS __fastcall EtwpPsProvTraceThread(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( CurrentThreadTeb )
    {
      ...
      if ( Process[1].Affinity.StaticBitmap[30]
        && ((v17 = WORD2(Process[2].Affinity.StaticBitmap[20]), v17 == 332) || v17 == 452 ? (v18 = 1) : (v18 = 0), v18) )
      {
  ...
  else
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7[1].Affinity.StaticBitmap[30]
        && ((v9 = WORD2(v7[2].Affinity.StaticBitmap[20]), v9 == 332) || v9 == 452 ? (v10 = 1) : (v10 = 0), v10) )
      {
        v8 = *(_DWORD *)(v6 + 12128);
      }
      else
