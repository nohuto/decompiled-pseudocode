/*
 * XREFs of CcCopyReadEx @ 0x14032B470
 * Callers:
 *     CcCopyRead @ 0x140620870 (CcCopyRead.c)
 *     CcFastCopyRead @ 0x1408678F0 (CcFastCopyRead.c)
        ...
        struct _KTHREAD *a7)
{
  ...
  if ( v27 )
  {
    ...
    if ( (*(_DWORD *)(v11 + 152) & 0x40000000) == 0 )
    {
      ...
      {
        CcUpdateSharedCacheMapFlag(v18, 0x200000, 0);
      }
    }
    v20 = a6;
    *a6 = 0;
