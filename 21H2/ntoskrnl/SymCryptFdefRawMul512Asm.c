/*
 * XREFs of SymCryptFdefRawMul512Asm @ 0x14040E690
 * Callers:
 *     SymCryptFdefModMulMontgomery512 @ 0x14040C490 (SymCryptFdefModMulMontgomery512.c)
 * Callees:
 *     <none>
 */

unsigned __int64 __fastcall SymCryptFdefRawMul512Asm(
        unsigned __int64 *a1,
        unsigned __int64 *a2,
        __int64 a3,
        unsigned __int64 *a4)
