/*
 * XREFs of sub_1406A2AFC @ 0x1406A2AFC
 * Callers:
...
__int64 __fastcall sub_1406A2AFC(__int64 a1, __int64 a2, unsigned int a3, int a4, _QWORD *a5)
{
  int v5; // ebx
  int v6; // r11d
  ...
  if ( a4 != -1 )
    goto LABEL_4;
  v5 = sub_14064ED58(a1, a2, a3, a5, &v9);
  if ( v5 >= 0 )
  {
    v6 = v9;
LABEL_4:
