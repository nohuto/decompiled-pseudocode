/*
 * XREFs of ?BTreeSearchKey@?$B_TREE@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@U?$B_TREE_KEY_COMPARATOR@T_SM_PAGE_KEY@@@@@@SAJPEAU1@T_SM_PAGE_KEY@@PEAUSEARCH_RESULT@1@@Z @ 0x140381130
 * Callers:
        ...
        __int64 a3)
{
  ...
  *v10 = v11;
  ...
  if ( v13 >= (unsigned __int16)*(_DWORD *)v11 || *(_DWORD *)v14 < a2 || *(_DWORD *)v14 != a2 )
    return (unsigned int)-1073741275;
  return v7;
}
