/*
 * XREFs of CcCanIWrite @ 0x14031DF20
 * Callers:
  ...
  if ( (Flags & 0x10) == 0 && (Flags & 0x1000000) == 0 )
  {
    ...
    *((_QWORD *)&v53 + 1) = &CcMasterLock;
    ...
    if ( SectionObjectPointer && (SharedCacheMap = SectionObjectPointer->SharedCacheMap) != 0LL )
      Partition = CcGetPartition(SharedCacheMap, (_BYTE)v12, (_BYTE)v11);
    else
      Partition = *((_QWORD *)PspSystemPartition + 1);
...
LABEL_24:
            ...
            if ( (xmmword_140CFC490 & 0x20000) != 0 )
            {
              ...
              v63[0] = v64;
              v63[1] = 32LL;
              EtwTraceKernelEvent((int)v63, 1, 0x80020000, 5638, 4200706);
            }
...
LABEL_29:
      ...
      v19 = KxWaitForLockChainValid((__int64 *)&v53);
    }
    *(_QWORD *)&v53 = 0LL;
