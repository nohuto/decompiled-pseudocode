/*
 * XREFs of _CmGetRegKeySecurityDescriptor @ 0x1407438D8
 * Callers:
  ...
  if ( Acl >= 0 )
  {
    ...
    *RtlSubAuthoritySid(Owner, 1u) = 544;
    ...
    if ( Pool2 )
    {
      ...
      if ( Acl >= 0 )
      {
        Acl = RtlpAddKnownAce((int)v10, 2, 2, 983103, Sid, 0);
        if ( Acl >= 0 )
        {
          Acl = RtlpAddKnownAce((int)v10, 2, 2, 131097, Src, 0);
          if ( Acl >= 0 )
          {
            Acl = RtlpAddKnownAce((int)v10, 2, 2, 983103, Owner, 0);
            if ( Acl >= 0 )
            {
              if ( !a1 || (Acl = RtlpAddKnownAce((int)v10, 2, 2, 131097, v4, 0), Acl >= 0) )
              {
