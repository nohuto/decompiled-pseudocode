/*
 * XREFs of PiPnpRtlGatherInterfaceDeleteInfo @ 0x140948814
 * Callers:
...
LABEL_22:
  ...
  if ( ObjectProperty != -1073741772 && ObjectProperty != -1073741275 )
  {
    ...
    {
      v6 = PiDmGetObject(4LL, (__int64)v16, (__int64 *)*a2 + 1);
  ...
  if ( v9 != -1073741772 && v9 != -1073741275 )
  {
    if ( v9 < 0 )
      goto LABEL_22;
    v6 = PiDmGetObject(1LL, v14, (__int64 *)*a2 + 2);
    if ( ((v6 + 0x80000000) & 0x80000000) == 0 && v6 != -1073741772 )
      goto LABEL_22;
  }
  ...
  if ( v10 != -1073741772 && v10 != -1073741275 )
  {
    ...
    if ( v6 < 0 )
      goto LABEL_22;
    v11 = PiDmGetObject(5LL, (__int64)v16, (__int64 *)*a2 + 3);
    v6 = v11;
    if ( v11 != -1073741772 )
    {
      if ( v11 >= 0 )
