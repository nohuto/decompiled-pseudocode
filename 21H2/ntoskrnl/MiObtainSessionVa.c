/*
 * XREFs of MiObtainSessionVa @ 0x14024D180
 * Callers:
...
LABEL_13:
  ...
  {
    v46 = KeGetCurrentThread()->ApcState.Process[1].Affinity.StaticBitmap[25] + 752;
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)v46, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock(v46);
    v47 = KeGetCurrentThread();
    if ( v46 - qword_140C50630 >= 0x8000000000LL )
      SessionId = -1;
    else
      SessionId = MmGetSessionIdEx(v47->ApcState.Process);
    _disable();
    p_Process = (char *)&v47[1].Process;
    v50 = 0LL;
    while ( (*(_QWORD *)p_Process & 0x7FFFFFFFFFFFFFFCLL) != (v46 & 0x7FFFFFFFFFFFFFFCLL)
         || !p_Process[18]
    ...
    if ( p_Process )
    {
      if ( *(__int64 *)p_Process < 0 )
      {
        *p_Process |= 2u;
        _enable();
        KiAbEntryRemoveFromTree(p_Process, 0x7FFFFFFFFFFFFFFCLL, v50);
        _disable();
      }
      v51 = *((_DWORD *)p_Process + 22);
      *((_DWORD *)p_Process + 22) = 0;
      p_Process[17] = 0;
      *(_QWORD *)p_Process = 0LL;
      v47->AbEntrySummary |= 1 << p_Process[16];
      _enable();
      if ( v51 )
        KiAbThreadRemoveBoostsSlow((ULONG_PTR)v47, v46, v51);
      goto LABEL_125;
    }
LABEL_122:
...
LABEL_125:
    ...
    if ( v25 && ($CEA84C04E3712D858E5667A507841A2A *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
  ...
  *(_DWORD *)(v2 + 800) += v1;
  ...
  if ( v22 )
  {
    if ( *(__int64 *)v22 < 0 )
    {
      *v22 |= 2u;
      _enable();
      KiAbEntryRemoveFromTree(v22, 0x7FFFFFFFFFFFFFFCLL, v23);
      _disable();
    }
    v24 = *((_DWORD *)v22 + 22);
    *((_DWORD *)v22 + 22) = 0;
    v22[17] = 0;
    *(_QWORD *)v22 = 0LL;
    v20->AbEntrySummary |= 1 << v22[16];
    _enable();
    if ( v24 )
      KiAbThreadRemoveBoostsSlow((ULONG_PTR)v20, v19, v24);
    goto LABEL_31;
  }
LABEL_36:
