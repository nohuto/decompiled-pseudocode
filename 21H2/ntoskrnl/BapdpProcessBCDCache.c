/*
 * XREFs of BapdpProcessBCDCache @ 0x140B1C78C
 * Callers:
 ...
 *     BcdOpenStoreFromFile @ 0x140A1CA9C (BcdOpenStoreFromFile.c)
...
void __fastcall BapdpProcessBCDCache(__int64 a1)
{
  ...
  if ( (unsigned int)BapdpQueryData(a1, &v28, 0, 0LL, &ExpBcdCacheDataBufferSize) != -1073741789 )
  {
LABEL_3:
    if ( ExpBcdCacheDataBuffer )
    {
  ...
  if ( v3 )
    BapdpQueryData(v4, &v28, 0, v3, &ExpBcdCacheDataBufferSize);
}
