/*
 * XREFs of SLUpdateLicenseDataInternal @ 0x1409FA6E0
 * Callers:
 ...
 *     ExpReducedLicenseData @ 0x1406EB390 (ExpReducedLicenseData.c)
...
LABEL_29:
  ...
  if ( v52 )
  {
    ...
    ExpGetLicenseTamperState(a1, &v56);
    v17 = v56 != 0;
    ...
    *(_WORD *)((char *)&v69 + 13) = 0;
    ...
    if ( !(_DWORD)v18 || a1 != -24 )
    {
      ...
      *(_QWORD *)&v69 = 10800LL;
      BYTE8(v69) = 1;
      updated = ExpLicUpdateChecksum((__int64)Object, v18, &v67);
      if ( !updated )
      {
        if ( (_DWORD)v19 )
        {
          ...
          if ( (unsigned __int64)(16 * v19) <= 0xFFFFFFFF )
            updated = ExpLicUpdateChecksum(v21, 0xFFFFFFFFLL, &v67);
        }
      }
      if ( updated )
      {
      ...
      v78 = v68;
      v79 = v69;
      ExpSetKernelDataProtection(a1, (__int64)&v77, 7, 1);
    }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  v75 = 0LL;
  v74 = 0LL;
  v49 = MiMapViewInSystemSpace((__int64)v55, &BugCheckParameter1, &v75, &v74, 0LL, 0LL);
  if ( v49 < 0 )
    goto LABEL_121;
  ...
  *(_WORD *)((char *)&v72 + 13) = 0;
  ...
  if ( BugCheckParameter1 )
  {
    ...
    if ( !(_DWORD)NumOfElements || Src )
    {
      ...
      *(_QWORD *)&v72 = 10800LL;
      BYTE8(v72) = 1;
      v40 = ExpLicUpdateChecksum(BugCheckParameter1 + 20, v37, &v70);
      if ( !v40 )
      {
        if ( (_DWORD)v39 )
        {
          ...
          if ( (unsigned __int64)(16 * v39) <= 0xFFFFFFFF )
            v40 = ExpLicUpdateChecksum(v41, 0xFFFFFFFFLL, &v70);
        }
      }
      if ( v40 )
      {
...
LABEL_96:
  ...
  else
  {
    ...
    *(_BYTE *)(a1 + 46828) = 1;
    ExpGetLicenseTamperState(a1, &v60);
    v43 = v50;
...
LABEL_123:
  ...
  if ( v50 )
  {
    ...
    ExAcquirePushLockExclusiveEx(a1 + 46840, 0LL);
    memset(v84, 0, 48);
    ExpSetKernelDataProtection(a1, (__int64)v84, 32, 0);
