/*
 * XREFs of SLUpdateLicenseDataInternal @ 0x14094E290
 * Callers:
 ...
 *     ExpReducedLicenseData @ 0x1406C3EC0 (ExpReducedLicenseData.c)
...
LABEL_146:
  ...
  *(_OWORD *)MappedBase = *(_OWORD *)a3;
  ...
  v51 = sub_1407AB87C((__int64)v24, 1, 0LL, 0, (unsigned int *)&NumOfElements);
  if ( v51 == -1073741789 )
  {
    ...
    v51 = sub_1407AB87C((__int64)MappedBase, 0, PoolWithTag, NumOfElements, 0LL);
    if ( v51 >= 0 )
      qsort(v7, v28, 0x10uLL, (int (__cdecl *)(const void *, const void *))sub_1407B1AE0);
  }
  else
  {
    v7 = 0LL;
  ...
  if ( !v62 )
  {
    ...
    while ( v30 < (unsigned int)NumOfElements )
    {
      ...
      v33 = sub_1407B1AE0(&v55[2 * v30], (_QWORD *)(16 * v31 + a1 + 24));
      v74 = v33;
      v34 = v55[2 * v30 + 1];
      v77 = v34;
