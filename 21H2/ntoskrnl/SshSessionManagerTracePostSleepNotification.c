/*
 * XREFs of SshSessionManagerTracePostSleepNotification @ 0x140807D78
 * Callers:
        ...
        char a6)
{
  ...
  v10[9] = 4LL;
  v10[11] = 4LL;
  return SshpSessionManagerSendControlEvent(SLEEPSTUDY_EVT_POST_SLEEP_NOTIFICATION_CONTROL_EVENT, 6LL, v10);
}
