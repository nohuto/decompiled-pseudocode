          ...
          if ( (unsigned int)dword_140C02E70 > 4 && tlgKeywordOn((__int64)&dword_140C02E70, 0x400000000000LL) )
          {
            ...
            *(_QWORD *)&v36.Length = *(_QWORD *)(v21 + 2496);
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              (unsigned __int8 *)byte_14002503F,
              0LL,
              0LL,
              0xBu,
              &v42);
        ...
        if ( (int)result >= 0 )
        {
          ...
          *(_DWORD *)&v25.Length = 4063292;
          ...
          if ( IopOpenRegistryKeyEx(&Handle, 0LL, &v25, 0x20019u) >= 0 )
          {
            ...
            {
              qword_140C45770 = (__int64)PipUpdateSetupInProgressCallback;
              qword_140C45778 = (__int64)Handle;
          ...
          CmSetDeviceRegProp(
            *(__int64 *)&PiPnpRtlCtx,
            ...
            0);
          ZwClose(v17);
          qword_140C44BE8 = (__int64)&IopPendingEjects;
          IopPendingEjects = (__int64)&IopPendingEjects;
          qword_140C44C78 = (__int64)&IopPendingSurpriseRemovals;
