/*
 * XREFs of MiPrepareToHotPatchImage @ 0x140976880
 * Callers:
...
__int64 __fastcall MiPrepareToHotPatchImage(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  *(_DWORD *)(a1 + 36) = 16 * *((_DWORD *)v3 + 4);
  ...
  v31 = a2 + *(unsigned int *)(RtlFindHotPatchBase(a2) + 24);
  ...
  if ( !v6 )
  {
    v17 = (RTL_BITMAP *)MiAllocatePool(64, 8 * ((v16 >> 6) + ((v16 & 0x3F) != 0) + 2), 0x20206D4Du);
    v18 = v17;
    *(_QWORD *)(a1 + 40) = v17;
    if ( v17 )
    {
  ...
  if ( *(_DWORD *)(a1 + 36) )
  {
    v9 = MiPrepareImagePagesForHotPatch((__int64 *)a1, *(_QWORD *)(a1 + 24), *((unsigned int *)v3 + 5));
    if ( v9 < 0 )
      return (unsigned int)v9;
  }
  *(_QWORD *)&v32 = a1;
  *((_QWORD *)&v32 + 1) = v6;
  v14 = (_DWORD *)a2;
  RtlEnumerateHotPatchPatches(a2, v31, MiPrepareToHotPatchImagePatchCallback, &v32);
