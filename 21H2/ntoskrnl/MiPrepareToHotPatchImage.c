/*
 * XREFs of MiPrepareToHotPatchImage @ 0x1408CD638
 * Callers:
 ...
 *     RtlEnumerateHotPatchPatches @ 0x14091AE98 (RtlEnumerateHotPatchPatches.c)
...
__int64 __fastcall MiPrepareToHotPatchImage(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  *(_DWORD *)(a1 + 36) = 8 * *((_DWORD *)v3 + 8);
  ...
  if ( !v6 )
  {
    ...
    v21 = (RTL_BITMAP *)MiAllocatePool(64, 8 * ((v18 >> 6) + ((v18 & 0x3F) != 0) + 2), 0x20206D4Du);
    v22 = v21;
    *(_QWORD *)(a1 + 40) = v21;
    if ( v21 )
    {
