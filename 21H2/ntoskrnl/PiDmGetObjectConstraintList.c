/*
 * XREFs of PiDmGetObjectConstraintList @ 0x14077747C
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  *a7 = 0;
  ...
  if ( v8 )
    *v9 = 0;
  Object = PiDmGetObject(LODWORD(PiDmListDefs[5 * (int)a1]), a2, &P);
  v13 = Object;
  if ( Object < 0 )
  {
  ...
  else
  {
    ...
    *(_QWORD *)&v17 = v9;
    *((_QWORD *)&v17 + 1) = v8;
    v13 = PiDmListEnumObjectsWithCallback(a1, P, PiDmGetObjectListCallback, &v16, PiDmCmObjectMatchCallback);
    if ( v13 < 0 )
      goto LABEL_10;
    *v7 = HIDWORD(v17);
  }
