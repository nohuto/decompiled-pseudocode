/*
 * XREFs of KeConnectInterrupt @ 0x1403AF5E4
 * Callers:
...
__int64 __fastcall KeConnectInterrupt(__int64 *a1, unsigned __int8 a2, __int64 a3)
{
  ...
  v11 = KiIntSteerConnect((_DWORD)a1, v4, (int)a3 + 8, (unsigned int)&v30, (__int64)&v29);
  if ( (v11 & 0x80000000) != 0 )
    goto LABEL_39;
  v8 = 0;
  if ( (_BYTE)v4 )
  ...
  if ( v7 )
  {
    if ( ((int (__fastcall *)(__int64, unsigned int *))off_140C01F30[0])(a3 + 8, &v27) < 0 )
      return 295;
    v26 = v31
        ? KiUnmaskSecondaryInterruptInternal(*(unsigned int *)(*a1 + 88), v27, v24, v25)
        : ((__int64 (__fastcall *)(_QWORD, _QWORD))off_140C01DC8[0])(v27, 0LL);
    v11 = v26;
    if ( v26 >= 0 )
      return 295;
    goto LABEL_39;
