/*
 * XREFs of IoWMISystemControl @ 0x14061E914
 * Callers:
 *     WmipSystemControl @ 0x14061E8F0 (WmipSystemControl.c)
 * Callees:
 ...
 *     WmipFindGuid @ 0x14061EC20 (WmipFindGuid.c)
...
LABEL_78:
    ...
    v40 = 0LL;
    *(_OWORD *)Src = 0LL;
    v20 = WmipQueryWmiRegInfo(v6, &v42, Src, &v43);
    v21 = Src[1];
    v17 = v20;
    if ( v20 >= 0 )
    {
