/*
 * XREFs of PopCheckConsoleTimeouts @ 0x1408F4FC4
 * Callers:
...
char PopCheckConsoleTimeouts()
{
  ...
  if ( !BYTE9(PopConsoleContext) || !PopInputTimeout )
  {
    ...
    BYTE4(qword_140C205A0) = v2 != 0;
    if ( !v2 )
      LOBYTE(DisplayTimeout) = PopSetSessionUserStatus(v0, 0);
  }
LABEL_8:
  if ( (_BYTE)xmmword_140C20590 && (_DWORD)v3 )
  {
    LOBYTE(DisplayTimeout) = -1;
    v4 = v3 + (HIDWORD(xmmword_140C20590) - DWORD2(xmmword_140C20590)) / 0x3E8u;
    if ( v4 > 0xFFFFFFFF )
      LODWORD(v4) = -1;
    LODWORD(v3) = v4;
  }
  if ( (_DWORD)v3 != HIDWORD(PopConsoleContext) )
  {
    ...
    LOBYTE(DisplayTimeout) = PopDiagTraceDisplayTimeout(
                               v3,
                               BYTE1(xmmword_140C20590),
                               (unsigned __int8)xmmword_140C20590);
