/*
 * XREFs of MiPfPrepareSequentialReadList @ 0x1407BCB30
 * Callers:
        ...
        __int64 *a8)
{
  ...
  __int64 AvailablePagesExcludeSlists; // [rsp+E0h] [rbp-58h]
  unsigned __int64 *v101; // [rsp+E8h] [rbp-50h]
  ...
  *a8 = 0LL;
  ...
  if ( a5 )
  {
    v15 = a5 >> 12;
    v98 = a5 >> 12;
    if ( a5 >> 12 >= 0x100000000LL || (unsigned int)v15 > ControlAreaPtes )
      return 3221225713LL;
  }
  else
  {
    if ( ControlAreaPtes >= 0x100000000LL )
      return 3221225713LL;
    LODWORD(v15) = ControlAreaPtes;
    v98 = (unsigned int)ControlAreaPtes;
  }
  v16 = (unsigned int)v15;
  if ( a4 && (unsigned int)v15 + ((a3 >> 12) & 0x3FuLL) > 0x40 )
    return 3221225713LL;
  Pool = MiAllocatePool(64, 8LL * (unsigned int)(v15 - 1) + 144, 0x6C526D4Du);
  v18 = (__int64)Pool;
  if ( !Pool )
    return 3221225626LL;
  Pool[1] = v12;
  ...
  *(_QWORD *)(v18 + 24) = v18 + 24;
  if ( (HvlEnlightenments & 0x200000) != 0 )
  {
    ...
    if ( v16 <= 0x1FF )
      v15 = v16;
    v68 = (unsigned int *)MiAllocatePool(66, 8 * v15 + 16, 0x6C68694Du);
    P = v68;
    if ( !v68 )
    {
      Mdls = -1073741670;
  ...
  v95 = v20;
  if ( v14 )
    BugCheckParameter2 = MiOffsetToProtos(v12, a3, &v94);
  ...
  *(_DWORD *)(v18 + 88) = 7;
  ...
  v26 = &KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.StaticBitmap[26];
  v93 = (_QWORD *)(v18 + 136);
  v101 = v26;
  MiInitializePageColorBase((__int64)v26, v25, (__int64)v102);
  Mdls = 0;
  v30 = 0LL;
  v88 = 0LL;
  v31 = 0;
  if ( !(_DWORD)v15 )
  {
    v51 = (__int64)ControlAreaPartition;
    v40 = 0LL;
    v53 = 0LL;
    v52 = 0LL;
    goto LABEL_59;
...
LABEL_57:
    ...
    if ( *(_QWORD *)(v28 + 24) )
    {
      SharedProtos = MiGetSharedProtos(v104, a7, v28);
      v28 = (__int64)BugCheckParameter2;
      if ( SharedProtos )
      {
        v46 = *(_QWORD *)(SharedProtos + 72);
LABEL_52:
        v23 = (__int64 *)(v46 + 8 * v94);
        v87 = v46 + 8LL * *(unsigned int *)(v28 + 44);
        v48 = MiStartingOffset(v28, v46, a7);
        v49 = MiEndingOffsetWithLock(BugCheckParameter2);
...
LABEL_15:
        ...
        {
          PteShadow = MiReadPteShadow((unsigned __int64)v23, *v23);
          v30 = v88;
          LOWORD(v32) = PteShadow;
        }
        if ( (v32 & 1) == 0 )
        {
          if ( (v32 & 0x400) != 0 )
          {
            if ( (*(_BYTE *)(v12 + 62) & 0xC) == 4 )
            {
              if ( P )
              {
                ...
                Mdls = MiRefillPurgedExtents((__int64 *)BugCheckParameter2, (__int64)v23, a7);
                MiLockDynamicMemoryShared((__int64)&MiSystemPartition, (__int64)CurrentThread);
                v72 = Mdls;
              }
              else
              {
                v72 = MiRefillPurgedExtents((__int64 *)BugCheckParameter2, (__int64)v23, a7);
                Mdls = v72;
              }
              if ( v72 < 0 )
              {
...
LABEL_59:
                ...
                if ( v53 )
                {
                  if ( !v40 )
                    goto LABEL_70;
                  v104 = v40;
                  v54 = MiProtectionToCacheAttribute(v95);
                  PageChain = MiGetPageChain(v51, (__int64)v101, 0LL, v56, v54, v55, -1LL, (unsigned __int64 *)&v104);
                  v58 = v104;
                  v59 = (_QWORD *)PageChain;
                  if ( v104 != v85 )
                  {
                    MiReturnFaultCharges(v51, v85 - v104, 1);
                    v78 = Mdls;
                    v79 = v58 - v85;
                    v11 = v79 + v53 == 0;
                    v53 += v79;
                  ...
                  if ( v59 )
                  {
                    do
                    {
                      ...
                      MiSetPfnLink(v59, *(_QWORD *)(v18 + 40));
                      *(_QWORD *)(v18 + 40) = v59;
                      MiSetPfnBlink(v62, 0LL, 0);
                      v59 = (_QWORD *)v61;
                    }
                    while ( v61 );
                    v53 = v83;
...
LABEL_70:
                    ...
                    *(_QWORD *)(v18 + 96) = v52;
                    ...
                    Mdls = MiPfAllocateMdls(v18, v64, v63);
...
LABEL_23:
              ...
              *v29 = v23;
              ...
              if ( v30 != BugCheckParameter2
                || (MiGetPteAddress((unsigned __int64)v99),
                    PteAddress = MiGetPteAddress((unsigned __int64)v23),
                    v39 != PteAddress) )
              {
                v36 |= 2uLL;
                v88 = v35;
              ...
              if ( (unsigned int)MiUseSlabAllocator(
                ...
                && (v66 = v90, v90 <= 3) )
              {
                NextPageColor = MiGetNextPageColor((__int64)v102);
                v74 = 2;
                if ( v25 )
                  v74 = 0;
...
LABEL_58:
                ...
                MiSetPfnLink((_QWORD *)(48 * SlabPage - 0x220000000000LL), *(_QWORD *)(v18 + 8 * v66 + 48));
                *(_QWORD *)(v18 + 8 * v66 + 48) = v76;
              }
              else
              {
                v40 = v85;
                if ( v85 > AvailablePagesExcludeSlists + 160 )
                  goto LABEL_129;
                ++v85;
              }
              ++v83;
...
LABEL_34:
          ...
          if ( (v32 & 0x800) == 0 )
          {
            if ( IS_PTE_NOT_DEMAND_ZERO(v32) )
              goto LABEL_23;
            goto LABEL_34;
          }
        }
        MiUpdatePfnForPrefetchByPte((unsigned __int64)v23, a6, (__int64)P);
        goto LABEL_34;
      }
      v23 = (__int64 *)(v22 - 8);
    }
...
LABEL_35:
  ...
  if ( P )
    v42 = 2052;
  result = MiAddViewsForSection((__int64 *)v28, *(unsigned int *)(v28 + 44), (_DWORD *)v42, v27);
  Mdls = result;
  if ( (int)result >= 0 )
  {
LABEL_45:
    ...
    {
      v45 = MiAllocatePool(256, 0x40uLL, 0x6C536D4Du);
      if ( !v45 )
      {
  ...
  if ( (v42 & 0x800) != 0 && (_DWORD)result == -1073741078 )
  {
    ...
    v65 = (__int64)CurrentThread;
    MiUnlockDynamicMemoryShared((__int64)&MiSystemPartition, (__int64)CurrentThread);
    Mdls = MiAddViewsForSection(
             (__int64 *)BugCheckParameter2,
             BugCheckParameter2[11],
             (_DWORD *)(v42 & 0xFFFFF7FF),
             v70);
    MiLockDynamicMemoryShared((__int64)&MiSystemPartition, (__int64)CurrentThread);
    if ( (Mdls & 0x80000000) != 0 )
    {
      result = Mdls;
      goto LABEL_124;
    }
...
LABEL_124:
  if ( v85 )
  {
    MiReturnFaultCharges((__int64)ControlAreaPartition, v85, 1);
    goto LABEL_80;
  }
LABEL_72:
  if ( P )
  {
    if ( P[1] )
      MiNotifyPageHeat(P);
    MiUnlockDynamicMemoryShared((__int64)&MiSystemPartition, v65);
