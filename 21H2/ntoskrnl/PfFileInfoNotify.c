/*
 * XREFs of PfFileInfoNotify @ 0x14031D600
 * Callers:
 *     <none>
 * Callees:
...
LABEL_148:
      ...
      if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C50408, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
        ExfTryToWakePushLock(&qword_140C50408);
  ...
  if ( v4 == 4 )
  {
    ...
    if ( dword_140C4FDE0 < (unsigned int)dword_140C4FDE4 )
    {
      ...
      *((_QWORD *)&v105 + 1) = v11 >> 12;
      ...
      if ( ExAcquireRundownProtection_0(&stru_140C4FD20) )
      {
        while ( 1 )
        {
...
LABEL_190:
        ++dword_140C4FD8C;
        dword_140C4FD90 += 64;
        ExReleaseRundownProtection_0(&stru_140C4FD20);
LABEL_16:
        if ( v22 >= 0 )
        {
          v23 = *v17;
