/*
 * XREFs of PopDiagTraceHiberStats @ 0x1407FDC18
 * Callers:
...
char PopDiagTraceHiberStats()
{
  ...
  v3 = qword_140C22DF0;
  qword_140C22DF8 = ResumeTimestamp;
  dword_140C22EFC = dword_140C22C04;
  dword_140C22EF8 = dword_140C22C88;
  v20 = qword_140C22DF0;
  LODWORD(qword_140C22EA8) = PopQpcTimeInMs(&qword_140C22CD8, &qword_140C22CE0);
  qword_140C22D58 = (unsigned int)PopQpcTimeInMs(&qword_140C22CA8, &qword_140C22D60);
  PopComputeDerivedHiberStats(&qword_140C22D18, v3, &v21);
  ...
  do
  {
    ...
    *v4 = v10;
    ...
    if ( (v11 & 0x10000000) != 0 )
    {
      v16 = PpmConvertTime(v10, PopQpcFrequency, 0x3E8uLL);
      v11 = *(_DWORD *)v7;
      *v4 = v16;
    }
    v12 = v11 & 0x20;
  ...
  qword_140C22E70 /= v3;
  qword_140C22D20 /= v3;
  v14 = 1000 * qword_140C22DF8 / (unsigned __int64)PopQpcFrequency
  ...
  if ( v1 )
  {
    ...
    if ( qword_140C22E98 )
    {
      dword_140C22BE4 += PopQpcTimeInMs(&qword_140C22CC8, &qword_140C22EA0);
