/*
 * XREFs of IvtUpdateContextEntry @ 0x14052F89C
 * Callers:
...
__int64 *__fastcall IvtUpdateContextEntry(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, int a5, __int64 *a6)
{
  ...
  {
    v18 = 1;
    BlockedDomain = IvtGetBlockedDomain(a1, &v24, &v23);
    v17 = v23;
    LOWORD(v13) = BlockedDomain;
    v20 = 0LL;
  }
  else if ( v16 )
  {
  ...
  *(_QWORD *)v14 = (4 * (v20 | (v17 << 10))) | 1;
  if ( v12 )
  {
    IvtInvalidateContextEntry(a1, v8, v15, v7, 1);
    if ( v18 )
      IvtInvalidateContextEntry(a1, v8, v13, v21, 1);
  }
  result = a6;
  if ( a6 )
    *a6 = v15;
