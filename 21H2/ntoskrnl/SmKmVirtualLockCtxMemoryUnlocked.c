/*
 * XREFs of SmKmVirtualLockCtxMemoryUnlocked @ 0x14059EBB0
 * Callers:
...
void __fastcall SmKmVirtualLockCtxMemoryUnlocked(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ...
  if ( v3 < v4 && (!v3 || v4 - v3 >= 0x800000) )
  {
    ...
    if ( v7 >= 0x800000 || !v6 && *(_QWORD *)(BugCheckParameter2 + 16) )
    {
      ...
      v26 = 0;
      v20 = 0LL;
      if ( (int)MmQueryWorkingSetInformation(&v22, &v21, &v20, &v18, &v19, &v26) >= 0 )
      {
        v8 = v18;
        ...
        *(_QWORD *)(BugCheckParameter2 + 16) -= v9;
        if ( v8 >= v9 )
        {
          v18 = v8 - v9;
          v23 = 0;
          MmAdjustWorkingSetSizeEx(v8 - v9, v19, 0, 0, 0, &v23);
        }
      }
    }
...
LABEL_29:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)v10, BugCheckParameter2, (unsigned int *)&v25);
    v15 = v10->SpecialApcDisable++ == -1;
    if ( v15 && ($C459BD0D405E8E46662177FB3D0A143F *)v10->ApcState.ApcListHead[0].Flink != &v10->152 )
