/*
 * XREFs of PnpWatchdogBugcheck @ 0x1405623A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn PnpWatchdogBugcheck(__int64 a1)
{
  ...
  *(_OWORD *)MaxDataSize = 0LL;
  v26 = PnpDeviceEventThread;
  v27 = PnpDeviceActionThread;
  v28 = PnpDelayedRemoveWorkerThread;
  v29 = &PnpDeviceCompletionQueue;
  v30 = ExWorkerQueue;
  v24 = *(_DWORD *)(a1 + 16);
  ...
  {
    IoAddTriageDumpDataBlock(MaxDataSize[0], (PVOID)*(unsigned __int16 *)(*(_QWORD *)MaxDataSize + 2LL));
    ...
    if ( v4 )
    {
      ...
      if ( *(_QWORD *)(v7 + 40) )
      {
        ...
        if ( *(_WORD *)(v8 + 40) )
        {
          IoAddTriageDumpDataBlock(v8 + 40, (PVOID)2);
          IoAddTriageDumpDataBlock(*(_QWORD *)(v8 + 48), (PVOID)*(unsigned __int16 *)(v8 + 40));
        }
        ...
        if ( *(_WORD *)(v10 + 56) )
        {
          ...
          if ( *(_QWORD *)MaxDataSize )
            ...
            v13 = 0LL;
          IoAddTriageDumpDataBlock(*(_QWORD *)(v13 + 64), (PVOID)*(unsigned __int16 *)(v12 + 56));
          v9 = *(_QWORD *)MaxDataSize;
        }
        if ( v9 )
        ...
        if ( *(_QWORD *)(v14 + 16) )
        {
          ...
          if ( *(_WORD *)(*(_QWORD *)(v15 + 16) + 56LL) )
          {
            if ( v9 )
              ...
              v16 = 0LL;
            IoAddTriageDumpDataBlock(*(_QWORD *)(v16 + 16) + 56, (PVOID)2);
            if ( *(_QWORD *)MaxDataSize )
  ...
  if ( v19 )
  {
    ...
    if ( v3 )
    {
      IoAddTriageDumpDataBlock(v3, (PVOID)0x310);
      if ( *(_WORD *)(v3 + 40) )
      {
        IoAddTriageDumpDataBlock(v3 + 40, (PVOID)2);
        IoAddTriageDumpDataBlock(*(_QWORD *)(v3 + 48), (PVOID)*(unsigned __int16 *)(v3 + 40));
      }
      if ( *(_WORD *)(v3 + 56) )
      {
        IoAddTriageDumpDataBlock(v3 + 56, (PVOID)2);
        IoAddTriageDumpDataBlock(*(_QWORD *)(v3 + 64), (PVOID)*(unsigned __int16 *)(v3 + 56));
      }
      v22 = *(_QWORD *)(v3 + 16);
      if ( v22 )
      {
