/*
 * XREFs of _woutput_l @ 0x1403D49A8
 * Callers:
 ...
 *     write_multi_char @ 0x1403D52E8 (write_multi_char.c)
 *     write_string @ 0x1403D5340 (write_string.c)
 *     _get_printf_count_output @ 0x1403D636C (_get_printf_count_output.c)
