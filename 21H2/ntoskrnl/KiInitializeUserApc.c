/*
 * XREFs of KiInitializeUserApc @ 0x14029A86C
 * Callers:
        ...
        unsigned int a7)
{
  ...
  __int64 UnbiasedInterruptTime; // [rsp+D0h] [rbp-E8h]
  ...
  else
  {
    ...
    *(_BYTE *)(v11 + 31) = *(_BYTE *)(v11 + 31);
    ...
    {
      v13 = KiUnwindUserSspForApcContextCopyBypass(v34);
      if ( v13 < 0 )
  ...
  *(_WORD *)(a2 + 368) = 51;
  ...
  LOBYTE(v22) = 1;
  result = KiQueryUnbiasedInterruptTime(v22);
