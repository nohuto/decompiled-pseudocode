/*
 * XREFs of NtAlpcOpenSenderThread @ 0x140663910
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v11 >= 0 )
  {
    if ( PreviousMode )
    {
      ...
      *(_QWORD *)v13 = *(_QWORD *)v13;
      AlpcpProbeAndCaptureMessageHeader(a3, v22, a4);
      if ( a6 < v12 )
        v12 = a6;
      *(_OWORD *)v25 = *v12;
      v26 = v12[1];
...
LABEL_17:
        ...
        else
        {
          ...
          v11 = PsOpenThread((unsigned __int64)v21, a5, (__int64)v25, &v22[2], 0, PreviousMode);
