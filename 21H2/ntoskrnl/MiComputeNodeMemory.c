/*
 * XREFs of MiComputeNodeMemory @ 0x14081DDB0
 * Callers:
...
__int64 __fastcall MiComputeNodeMemory(ULONG_PTR *a1, int a2)
{
  unsigned int *v2; // r13
  ...
  else
  {
    ...
    if ( !a2 )
    {
      v20 = (unsigned int *)MiReferencePageRuns((__int64)&MiSystemPartition, 1u);
      LODWORD(v7) = 0;
      a2 = v31;
      v5 = v20;
      v8 = &v20[4 * *v20 + 4];
  ...
  if ( KeNumberNodes )
  {
    ...
    do
    {
      ...
      {
        v16 = v36;
        v17 = (unsigned int)MmNumberOfChannels;
        do
        {
          v15 += *v16;
  ...
  a1[2088] = result;
  if ( v5 )
    return MiDereferencePageRuns((__int64)v5);
  return result;
}
