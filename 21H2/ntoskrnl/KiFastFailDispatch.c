/*
 * XREFs of KiFastFailDispatch @ 0x140412D80
 * Callers:
...
__int64 __fastcall KiFastFailDispatch(int a1, unsigned int a2, void *a3, unsigned __int64 a4, char a5)
{
  ...
  if ( v33 )
  {
    v62.ExceptionAddress = &loc_140412FFC;
    v77 = 0x140413113LL;
    v76 = 0x14041310ALL;
    v75 = 0x140413101LL;
    v74 = 0x1404130F8LL;
    ...
    v64 = 0x14041309ELL;
    v63 = 0x140413095LL;
    v62.ExceptionInformation[14] = 0x14041308CLL;
    v62.ExceptionInformation[13] = 0x140413083LL;
    v62.ExceptionInformation[12] = 0x14041307ALL;
    v62.ExceptionInformation[11] = 0x140413071LL;
    v62.ExceptionInformation[10] = 0x140413068LL;
    v62.ExceptionInformation[9] = 0x14041305FLL;
    v62.ExceptionInformation[8] = 0x140413056LL;
    v62.ExceptionInformation[7] = 0x14041304DLL;
    v62.ExceptionInformation[6] = 0x140413044LL;
    v62.ExceptionInformation[5] = 0x14041303BLL;
    v62.ExceptionInformation[4] = 0x140413032LL;
    v62.ExceptionInformation[3] = 0x140413029LL;
    v62.ExceptionInformation[2] = 0x140413020LL;
    v62.ExceptionInformation[1] = 0x140413017LL;
    v62.ExceptionInformation[0] = 0x14041300ELL;
    *(_QWORD *)&v62.NumberParameters = 0x140413005LL;
  }
  if ( (KiKvaShadow & 1) == 0 )
  {
