/*
 * XREFs of TtmiLogCleanupCurrentSessionStart @ 0x1409019B0
 * Callers:
...
void TtmiLogCleanupCurrentSessionStart()
{
  ...
  if ( (unsigned int)dword_140D2D8C8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8C8, 1LL) )
    {
      ...
      v4 = 4;
      v3 = &v1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8C8, (unsigned __int8 *)byte_14002AFDD, 0LL, 0LL, 3u, &v2);
    }
  }
}
