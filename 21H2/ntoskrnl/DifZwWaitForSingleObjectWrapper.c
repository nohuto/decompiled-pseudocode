/*
 * XREFs of DifZwWaitForSingleObjectWrapper @ 0x1406286F0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwWaitForSingleObjectWrapper(HANDLE Handle, BOOLEAN a2, LARGE_INTEGER *a3)
{
  __int64 v6; // rdx
  __int64 v7; // rcx
...
LABEL_18:
  result = ZwWaitForSingleObject(Handle, a2, a3);
  LODWORD(v19) = result;
  if ( APIThunkContextById )
  {
