/*
 * XREFs of KiSelectIdleProcessor @ 0x140574678
 * Callers:
...
__int64 __fastcall KiSelectIdleProcessor(_WORD *a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, char a6, char a7)
{
  __int64 v7; // r15
  __int64 v8; // rbx
  __int64 v13; // r10
  ...
  if ( !a5 )
  {
    ...
    v7 = KiProcessorBlock[KiProcessorNumberToIndexMappingTable[64 * (_DWORD)v13 + (((_BYTE)v19 + v20) & 0x3F)]];
  }
  ...
  if ( !v24 )
    return v8;
LABEL_15:
  if ( (*(_BYTE *)(a4 + 184) & 1) == 0 || a6 && KiFindRankBiasedIdleSmtSet(v7, &v51) )
    goto LABEL_49;
...
LABEL_49:
    ...
    else if ( (KiCacheAwareScheduling & 1) != 0 && (v47 & *(_QWORD *)(v7 + 34928)) != 0 )
    {
      v47 &= *(_QWORD *)(v7 + 34928);
    }
    v49 = *(_BYTE *)(v7 + 209);
    _BitScanForward64(&v50, __ROR8__(v47, v49));
    return KiProcessorBlock[KiProcessorNumberToIndexMappingTable[64 * *(unsigned __int8 *)(v7 + 208)
                                                               + (((unsigned __int8)v50 + v49) & 0x3F)]];
  }
  if ( !a6 )
  {
    v25 = *(_QWORD *)(a2 + 192);
      ...
      if ( v28 )
      {
        ...
        if ( (v26 & v27) == v27 && (*(_BYTE *)(a2 + 13244) & 1) == 0 && !*(_DWORD *)(a2 + 32472) )
        {
          ...
          if ( !*(_BYTE *)(a2 + 32) )
          {
            ...
            *(_DWORD *)(v29 + 80) = v34;
            if ( !v35 )
              KiEndThreadAccountingPeriodEx(a2, v29, v31, 0LL);
            v36 = __rdtsc();
            v37 = v36;
            ...
            *(_QWORD *)(a2 + 33400) += v38;
            ...
            if ( (v39 & 0x20) != 0 )
            {
              FrequencyBucket = PoGetFrequencyBucket(a2, (unsigned __int64)HIDWORD(v36) << 32, v31, v38);
              if ( KeHeteroSystem )
                v42 = *(_BYTE *)(a2 + 34056);
              else
                v42 = *(_BYTE *)(a2 + 34059);
              *(_QWORD *)(a2 + 8 * (v42 + 2LL * FrequencyBucket) + 33408) += v41;
              v39 = *(_BYTE *)(v29 + 2);
            }
            if ( (v39 & 0x40) != 0 )
            {
          ...
          v44 = *(_DWORD *)(v29 + 80);
          v45 = *(_DWORD *)(v29 + 84);
          if ( v44 >= v45 || v45 - v44 < KiShortExecutionCycles )
            v51 = v28;
        }
      }
    }
