/*
 * XREFs of KeInitializeVelocity @ 0x1408618D8
 * Callers:
...
__int64 (__fastcall *KeInitializeVelocity())(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD)
{
  ...
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_BamQosGrouping__private_reporting,
    0x1188553u,
    0,
    0,
  ...
  wil_details_FeatureReporting_ReportUsageToService(
    (__int64)&Feature_SchedulerFavoredCoreRotation__private_reporting,
    0x1188600u,
    0,
    0,
    (__int64)&Feature_HgsPlusParkingSupportRequired_logged_traits,
  ...
  result = wil_details_FeatureReporting_ReportUsageToService(
             (__int64)&Feature_SchedulerQosPreemption__private_reporting,
             0x126E6F7u,
             0,
             0,
             (__int64)&Feature_HgsPlusParkingSupportRequired_logged_traits,
