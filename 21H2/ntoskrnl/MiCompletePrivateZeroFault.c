/*
 * XREFs of MiCompletePrivateZeroFault @ 0x140321F70
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( v7 >= 0xFFFFF6FB7DBED000uLL && v7 <= 0xFFFFF6FB7DBED7F8uLL && (MiFlags & 0xC00000) != 0 )
    {
        ...
        && ((v26 & 0x20) == 0 || (v26 & 0x42) == 0) )
      {
        ...
        if ( Flink )
        {
          v94 = *((_QWORD *)&Flink->Flink + ((v7 >> 3) & 0x1FF));
          if ( (v94 & 0x20) != 0 )
            v26 |= 0x20uLL;
          if ( (v94 & 0x42) != 0 )
            v26 |= 0x42uLL;
...
LABEL_43:
    ...
    if ( *((_DWORD *)v4 + 9) && !v4[9] && (v26 & 0x400) != 0 )
    {
      ...
      v73 = (void *)MiMapPageInHyperSpaceWorker(v33, 0LL, 0x80000000);
      memset64(v73, v26 & 0xFFFFFFFFFFFFFFFDuLL, 0x200uLL);
      MiUnmapPageInHyperSpaceWorker((unsigned __int64)v73, 0x11u);
      v26 = MiSwizzleInvalidPte(128LL);
      v34 = v117 | 8;
    }
    else
    {
      ...
      && ((v38 & 0x20) == 0 || (v38 & 0x42) == 0) )
    {
      ...
      if ( v96 )
      {
        v97 = *((_QWORD *)&v96->Flink + ((v7 >> 3) & 0x1FF));
        if ( (v97 & 0x20) != 0 )
          v38 |= 0x20uLL;
        LOBYTE(v36) = v117;
        if ( (v97 & 0x42) != 0 )
    ...
    *(_WORD *)(v118 + 32) = 1;
      ...
      && ((v43 & 0x20) == 0 || (v43 & 0x42) == 0) )
    {
      ...
      if ( v99 )
      {
        v100 = *((_QWORD *)&v99->Flink + ((v42 >> 3) & 0x1FF));
        if ( (v100 & 0x20) != 0 )
          v43 |= 0x20uLL;
        if ( (v100 & 0x42) != 0 )
          v43 |= 0x42uLL;
    ...
    v131 = v43;
    v44 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v131);
    v46 = v118;
    ...
    Queue = (unsigned int)v51[1].Queue;
    if ( (Queue & 0x100) != 0 )
    {
      v53 = Queue >> 9;
    }
    ...
    {
      v53 = (*((_DWORD *)&v51[1].SwapListEntry + 2) >> 12) & 7;
      if ( (v51->Process[1].DirectoryTableBase & 0x10000000000000LL) != 0 )
      {
        v90 = 2;
        if ( v53 < 2 )
          v90 = v53;
    ...
    if ( (v117 & 1) == 0 )
    {
      if ( (v117 & 0x10) != 0 )
      {
        ...
        {
          do
            KeYieldProcessorEx(&v126, v47, v55, v45);
...
LABEL_70:
    ...
    if ( _interlockedbittestandset64((volatile signed __int32 *)(v50 + 24), 0x3FuLL) )
    {
      ...
      {
        do
          KeYieldProcessorEx(&v127, v47, v55, v45);
    ...
    *(_QWORD *)(v50 + 24) ^= ((*(_QWORD *)(v50 + 24) + 1LL) ^ *(_QWORD *)(v50 + 24)) & 0x3FFFFFFFFFFFFFFFLL;
    ...
    if ( v57 >> 6 != v119 )
    {
      MiChangePageAttribute(v46, v119, 1);
      v46 = v118;
      LODWORD(v55) = v117 & 1;
      v54 = v150;
      v57 = *(_BYTE *)(v118 + 34);
    ...
    *(_BYTE *)(v46 + 34) = v59;
    ...
    if ( (*(_DWORD *)v4 & 4) != 0 )
    {
      TransitionPte = MiMakeTransitionPte(v33, *((_DWORD *)v4 + 8));
      if ( MiPteInShadowRange(v7) )
      {
        if ( (unsigned int)MiPteHasShadow() )
        {
...
LABEL_288:
      ...
      MiLockAndDecrementShareCount(v118, 0);
      if ( v132
        && (__int64)(v7 << 25) >> 16 == *(_QWORD *)(v132[1] + 16LL * v132[3]) + (v132[4] << 12)
        && *(_BYTE *)v132 != 5 )
      {
        MiAdvanceFaultList(v132);
      }
      goto LABEL_101;
    }
...
LABEL_304:
  ...
  else
  {
    ...
    if ( (_WORD)v62 )
    {
      ...
      MiEmptyDeferredWorkingSetEntries((__int64 *)(v60 + 56));
      v46 = v118;
    }
LABEL_90:
    v63 = *(_WORD *)(v60 + 66);
  ...
  if ( (unsigned int)MiAllocateWsle(v130, v7, v46, 0, v23, v65, v135) )
  {
    if ( (*(_DWORD *)v4 & 0x40) != 0 )
      _InterlockedExchangeAdd64((volatile signed __int64 *)&Process[1].Affinity.StaticBitmap[13], 1uLL);
    __incgsdword(0x2E9Cu);
  ...
  {
    do
      KeYieldProcessorEx(&v149, v67, v68, v69);
    while ( *(__int64 *)(v118 + 24) < 0 );
  }
  MiCapturePageFileInfoInline((unsigned __int64 *)(v118 + 16), 1, 0);
  *(_QWORD *)(v118 + 16) &= ~2uLL;
  *(_QWORD *)(v118 + 24) |= 0x4000000000000000uLL;
  MiDecrementShareCount(v118, v109, v110, v111);
  _InterlockedAnd64((volatile signed __int64 *)(v118 + 24), 0x7FFFFFFFFFFFFFFFuLL);
  MiLockAndDecrementShareCount(v108, 0);
  v70 = -1073741801;
  MiFreePageChain(v148);
  if ( (v65 & 4) != 0 )
    --*(_WORD *)(v4[1] + 66LL);
LABEL_103:
  if ( v116 )
  {
    ...
    {
      MiEmptyDeferredWorkingSetEntries((__int64 *)(v88 + 56));
      v89 = v4[1];
    }
    *(_BYTE *)(v89 + 69) &= ~4u;
  }
...
LABEL_105:
  if ( !*((_DWORD *)v4 + 9) && v15 )
  {
      ...
      && ((v77 & 0x20) == 0 || (v77 & 0x42) == 0) )
    {
      ...
      if ( v112 )
      {
        v113 = *((_QWORD *)&v112->Flink + ((v76 >> 3) & 0x1FF));
        if ( (v113 & 0x20) != 0 )
          v77 |= 0x20uLL;
        if ( (v113 & 0x42) != 0 )
          v77 |= 0x42uLL;
    ...
    v130 = v77;
    v79 = 48 * (((unsigned __int64)MI_READ_PTE_LOCK_FREE((unsigned __int64)&v130) >> 12) & 0xFFFFFFFFFFLL)
        - 0x220000000000LL;
    LODWORD(v147) = 0;
    while ( _interlockedbittestandset64((volatile signed __int32 *)(v79 + 24), 0x3FuLL) )
    {
      do
        KeYieldProcessorEx(&v147, v78, v80, v81);
      ...
      do
      {
          ...
          && KeGetCurrentThread()->ApcState.Process->AddressPolicy != 1 )
        {
          ...
          if ( (v83 & 0x20) == 0 || (v83 & 0x42) == 0 )
          {
            ...
            if ( v114 )
            {
              v115 = *((_QWORD *)&v114->Flink + ((v82 >> 3) & 0x1FF));
              if ( (v115 & 0x20) != 0 )
                LOBYTE(v83) = v83 | 0x20;
              if ( (v115 & 0x42) != 0 )
                LOBYTE(v83) = v83 | 0x42;
