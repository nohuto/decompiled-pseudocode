/*
 * XREFs of IopQuerySecureDeviceClassState @ 0x14067A4C4
 * Callers:
...
LABEL_28:
  ...
  {
    SecurityDescriptorInformation = IopGetSecurityDescriptorInformation(SecurityDescriptor[0], &v24, &v25);
    if ( SecurityDescriptorInformation < 0 )
      goto LABEL_21;
    if ( !v24 )
    {
...
LABEL_16:
  if ( (*(_DWORD *)a2 & 8) != 0 )
    goto LABEL_21;
  v11 = IopGetRegistryValue(KeyHandle);
