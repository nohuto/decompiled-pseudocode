/*
 * XREFs of PnpMergeFilteredResourceRequirementsList @ 0x1408608EC
 * Callers:
...
__int64 __fastcall PnpMergeFilteredResourceRequirementsList(unsigned int *Src, unsigned int *a2, unsigned int **a3)
{
  unsigned int *v4; // rbx
  unsigned int v6; // ebp
  unsigned int *v7; // rax
