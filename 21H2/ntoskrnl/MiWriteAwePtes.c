/*
 * XREFs of MiWriteAwePtes @ 0x1405ACB84
 * Callers:
...
__int64 __fastcall MiWriteAwePtes(__int64 a1, _QWORD *a2, unsigned __int64 a3, __int64 a4, ULONG_PTR a5, char a6)
{
  ...
  v85 = *(_QWORD *)(a1 + 32);
  v8 = &KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.StaticBitmap[26];
  v73 = (__int64)v8;
  v74 = *(_QWORD *)(v85 + 16);
...
LABEL_7:
  ...
  if ( (a6 & 1) != 0 )
  {
    ...
    if ( (*(_DWORD *)(v11 + 8) & 1) != 0 )
      ...
      v20 = (v17 >> 7) & 0x1F;
    ValidPte = MiMakeValidPte(0xFFFFF6BFFFFFFF78uLL, 0LL, v20 | v19);
    v22 = (v17 >> 12) & 0x7F;
    v23 = MiLockWorkingSetShared((__int64)v8);
    v13 = v67;
    v66 = v23;
    v24 = 1LL;
  ...
  while ( 1 )
  {
    ...
    if ( v18 )
    {
      ...
      if ( v15 != v36 - 0x98000000000LL )
      {
        if ( v15 )
        {
          updated = MiUpdateAwePageTable(v15, v71, v68);
          ...
          if ( updated )
          {
            MiUnlockWorkingSetShared(v73, v66);
            MiGetLeafVa(v15 + 8);
            LeafVa = MiGetLeafVa(v15);
            MiDeleteEmptyPageTables(LeafVa, v40 - 1, 1);
            v66 = MiLockWorkingSetShared(v73);
          }
          v71 = 0LL;
          v68 = 0;
        }
        LOBYTE(v24) = v66;
        MiMakeSystemAddressValid(a5, 0LL, v22, v24, 0);
        v15 = v37;
      }
      v18 = v70;
    }
...
LABEL_64:
    MiWriteAweClusterPte(v73, (__int64 *)a5, v35, v42, v44);
    if ( v43 )
    {
      if ( (v43 & 1) != 0 )
      {
        if ( v18 )
        {
          if ( v67 )
          {
            if ( v69 )
            {
              ...
              do
              {
                MiInsertLargeTbFlushEntry((__int64)v89, v67, v46);
                v46 += 8LL;
                --v47;
              }
              while ( v47 );
          ...
          {
            MiInsertTbFlushEntry((__int64)v89, (__int64)(a5 << 25) >> 16, v69, 0);
          }
        }
      ...
      if ( v78 )
      {
        ...
        do
        {
          ...
          if ( _interlockedbittestandset64((volatile signed __int32 *)(v51 + 24), 0x3FuLL) )
          {
            ...
            {
              do
                KeYieldProcessorEx(&v77, v50, v54, v52);
          ...
          {
LABEL_91:
            MiDecrementAweMapCount(v45, v51, &v84, 0);
            v52 = v74;
            v54 = 1LL;
          }
          v50 = v78;
    ...
    v56 = v73;
    if ( MiWorkingSetIsContended(v73) || (unsigned int)MiPageTableLockIsContended(v73, v15) || KeShouldYieldProcessor() )
      break;
    v58 = v70;
LABEL_109:
    v26 = v75;
LABEL_110:
  ...
  if ( v55 != v80 )
  {
    v57 = MiUpdateAwePageTable(v15, v71, v68);
    MiFlushTbList((__int64)v89);
    if ( v72 )
      v76 = 0LL;
    MiUnlockPageTableInternal(v73, v15);
    ...
    if ( v57 && v70 )
    {
      MiGetLeafVa(v15 + 8);
      v59 = MiGetLeafVa(v15);
      MiDeleteEmptyPageTables(v59, v60 - 1, 1);
    }
    v15 = 0LL;
    v71 = 0LL;
    v68 = 0;
    MiLockWorkingSetShared(v73);
    v55 = v79;
    goto LABEL_109;
  }
  v58 = v70;
LABEL_113:
  if ( v15 )
  {
    v62 = MiUpdateAwePageTable(v15, v71, v68);
    if ( v58 )
    {
      MiFlushTbList((__int64)v89);
      MiUnlockPageTableInternal(v56, v15);
      goto LABEL_118;
    }
    return v84;
  }
LABEL_117:
  ...
  v62 = 0;
LABEL_118:
  MiUnlockWorkingSetShared(v56, v66);
  if ( v62 && v58 )
  {
    MiGetLeafVa(v15 + 8);
    v63 = MiGetLeafVa(v15);
    MiDeleteEmptyPageTables(v63, v64 - 1, 1);
  }
  return v84;
}
