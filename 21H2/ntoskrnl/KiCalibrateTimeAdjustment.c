/*
 * XREFs of KiCalibrateTimeAdjustment @ 0x140A48E70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiPollFreezeExecution @ 0x14038B894 (KiPollFreezeExecution.c)
...
void __fastcall KiCalibrateTimeAdjustment(ULONG_PTR Argument)
{
  ...
  if ( CurrentPrcb->Number == *(_DWORD *)(Argument + 4) )
  {
    ...
    v18 = v7 / (unsigned int)KeMaximumIncrement;
  ...
  if ( *(_BYTE *)Argument )
  {
    ...
    if ( (xmmword_140D06910 & 0x8000) != 0 )
    {
      ...
      v22 = 8;
      v21 = &v19;
      EtwTraceKernelEvent((__int64)&v21, 1u, 0x80008000, 0x1232u, 0x401802u);
    }
  }
