/*
 * XREFs of CmpInitializeTransactions @ 0x140A57C9C
 * Callers:
...
__int64 *CmpInitializeTransactions()
{
  ...
  qword_140C47BE8 = (__int64)&CmpRmListHead;
  ...
  _mm_lfence();
  if ( (void *)qword_140C4C7E0 == CmpRmListLock.Owner )
  {
    v0 = __rdtsc();
    ...
    qword_140C4C7F8 = v1;
    qword_140C4C7F0 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  CmpLazyCommitTimer = 8LL;
  qword_140C47D78 = (__int64)CmpLazyCommitDpcRoutine;
  CmpLazyCommitDpc = 275;
  qword_140C47DB0 = (__int64)&qword_140C47DA8;
  qword_140C47DA8 = (__int64)&qword_140C47DA8;
  qword_140C47B88 = (__int64)&CmpDelayFreeRMListHead;
  ...
  qword_140C47AF8 = (__int64)CmpDelayFreeRMDpcRoutine;
  qword_140C47D80 = 0LL;
  qword_140C47D98 = 0LL;
  qword_140C47D70 = 0LL;
  qword_140C47DB8 = 0LL;
  ...
  qword_140C47D48 = (__int64)&CmpLightTransactionList;
