/*
 * XREFs of MiUnlinkNodeLargePages @ 0x1402CA5E0
 * Callers:
        ...
        unsigned __int64 a9)
{
  ...
  v139 = 24512LL * a5;
  v120 = v13;
  if ( !*(_QWORD *)(v13 + 22608) && (MiFlags & 0x30) != 0 )
    return 0LL;
  v14 = a3;
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        if ( v22 )
        {
          ...
          if ( (a8 & 0x40) != 0 )
          {
            ...
            *(_QWORD *)(v13 + 22792) = &v134;
            ...
            __writecr8((unsigned __int8)v9);
            KeWaitForGate((__int64)&v135, 0x12u);
            v18 = v124;
            v22 = 0;
            v20 = v116;
            v19 = v125;
        ...
        else
        {
          ...
          v117 = v9;
          __writecr8(2uLL);
          if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && (unsigned __int8)v9 <= 0xFu )
          {
            v37 = KeGetCurrentPrcb()->SchedulerAssist;
            v37[5] |= ~((unsigned __int8)(1LL << ((unsigned __int8)v9 + 1)) - 1) & 4;
          }
...
LABEL_46:
      ...
      {
        LOBYTE(v16) = -1;
        ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(v40, v16);
      }
      else
      {
        v121 = 0;
        ...
        if ( _interlockedbittestandset(v40, 0x1Fu) )
        {
          ...
          v121 = ExpWaitForSpinLockExclusiveAndAcquire(v40, 0xFFu);
        }
    ...
    if ( a6 == 4 )
    {
      ...
      v47 = (unsigned __int8 *)(v13 + 22821 + (unsigned int)MmNumberOfChannels);
    }
    else
    {
      v111 = a6;
...
LABEL_119:
      if ( v64 )
      {
        ...
        *(_QWORD *)(v72 + 8) = v66;
        v80[1] = v72;
        *v66 = v72;
        if ( !(unsigned int)MiBeginPageAccessor(v64, v72, 0LL) )
        {
LABEL_124:
      ...
      {
        if ( !(unsigned int)MiUnlinkNodeLargePageHelper(v120, v72, a3, v67, a8) )
          goto LABEL_124;
        if ( (a8 & 0x80u) != 0 )
      ...
      PfnPageSizeIndex = MiGetPfnPageSizeIndex(v72 + 48 * v133);
      v85 = v145;
      if ( PfnPageSizeIndex != a3 )
      {
        v67 = v113;
        v114 = 0LL;
        goto LABEL_154;
      ...
      if ( *((_DWORD *)MiSearchNumaNodeTable(v83) + 2) == a5
        && *(_QWORD *)(qword_140C51F48 + 8 * ((*(_QWORD *)(v114 + 40) >> 43) & 0x3FFLL)) == a1 )
      {
        PfnChannel = MiGetPfnChannel(v114);
        v67 = v113;
        if ( PfnChannel == v113 && *(unsigned __int8 *)(v114 + 34) >> 6 == v56 )
        {
          if ( v83 >= 0x100000 )
          {
            v87 = v115;
...
LABEL_194:
  if ( (a8 & 0x100) == 0 && a7 != *(unsigned __int8 *)(v97 + 34) >> 6 )
  {
    ...
    {
      v109 = (_QWORD *)*v108;
      MiChangePageAttributeContiguous(0xAAAAAAAAAAAAAAABuLL * ((__int64)(v108 + 0x44000000000LL) >> 4), v107, a7);
      v108 = v109;
      if ( !v109 )
        return v97;
    }
    v110 = (__int64)((unsigned __int128)((__int64)(v108 + 0x44000000000LL) * (__int128)0x2AAAAAAAAAAAAAABLL) >> 64) >> 3;
    MiChangePageAttributeContiguous((v110 >> 63) + v110, v107, a7);
  }
  return v97;
}
