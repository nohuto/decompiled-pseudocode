/*
 * XREFs of RtlCreateAtomTableEx @ 0x140264090
 * Callers:
 *     RtlCreateAtomTable @ 0x14062D080 (RtlCreateAtomTable.c)
 * Callees:
 ...
 *     RtlpInitializeLockAtomTable @ 0x14062CF84 (RtlpInitializeLockAtomTable.c)
