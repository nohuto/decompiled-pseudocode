/*
 * XREFs of HvlpLogIommuEvent @ 0x1404F9D30
 * Callers:
...
__int64 __fastcall HvlpLogIommuEvent(__int64 a1)
{
  ...
  if ( (HvlpRootFlags & 1) != 0 && *(_BYTE *)a1 )
  {
    ...
    {
      case 1:
        v3 = (__int64 *)&HV_EVENTLOG_IOMMU_WARNING_SCOPE_CONFLICT;
        break;
      case 2:
        v3 = HV_EVENTLOG_IOMMU_FAILED_RID_CONFLICT;
        break;
      case 3:
        v3 = HV_EVENTLOG_IOMMU_FAILED_NO_RESOURCES;
        break;
      case 4:
        v3 = HV_EVENTLOG_IOMMU_FAILED_INVALID_IOAPIC;
        v4 = 1;
        v10[0] = 1;
        goto LABEL_17;
      case 5:
        v3 = HV_EVENTLOG_IOMMU_FAILED_NO_DEVICE_ASSIGNMENT;
        v10[2] = 8;
        v4 = 3;
LABEL_16:
        v10[1] = 8;
...
LABEL_17:
        ...
        while ( v6 );
        return HvlpWriteEventLog((PCEVENT_DESCRIPTOR)v3, v4, &UserData);
      case 6:
        v3 = HV_EVENTLOG_IOMMU_FAILED_RESERVED_DEVICE;
        break;
      default:
        return result;
    }
