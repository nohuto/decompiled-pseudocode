/*
 * XREFs of SepCommonAccessCheckExWithAdminlessChecks @ 0x140373074
 * Callers:
 ...
 *     AuthzBasepMergeAccessReasons @ 0x1405C1660 (AuthzBasepMergeAccessReasons.c)
        ...
        char a8)
{
  ...
  *v26 = (*(_DWORD *)(a3 + 16) & 0xFDFFFFFF) != (v209 & *(_DWORD *)(a3 + 16) & 0xFDFFFFFF) ? 0xC0000022 : 0;
  ...
  if ( (*(_DWORD *)(v30 + 4) & 4) == 0 )
  {
    v31 = SepFilterCheck(*(_QWORD *)(v30 + 8), (__int64 *)&P, ClientToken, 0, &v217);
    v25 = 0LL;
    **(_DWORD **)(a4 + 16) = v31;
    v32 = *(int **)(a4 + 16);
    if ( *v32 < 0 )
...
LABEL_49:
  ...
  LOBYTE(v50) = 1;
  LOBYTE(v49) = 1;
  v192 = SepAdtAuditThisEventWithContext(130LL, v49, v50, v10);
  v105 = v192;
  if ( v192 )
  {
...
LABEL_240:
  ...
  while ( 1 )
  {
    ...
    if ( !P )
    {
      v114 = AuthzBasepInitializeResourceClaimsFromSacl(v213, (__int64 *)&P);
      v113 = P;
