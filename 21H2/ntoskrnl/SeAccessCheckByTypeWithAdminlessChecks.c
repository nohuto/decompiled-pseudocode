        ...
        char a14)
{
  ...
  void *v151; // [rsp+1F8h] [rbp-C0h]
  __int64 v152; // [rsp+200h] [rbp-B8h]
...
LABEL_19:
  ...
  v24 = SepReferenceTokenByHandle(a3, 8u, v18, &DmaAdapter, v113, &v145);
  v106 = v24;
  if ( v24 < 0 )
  {
    v25 = 0LL;
...
LABEL_35:
  ...
  v103 = v30;
  v24 = SepTrustLevelCheck(&v132, v119, 0LL, v25);
  v106 = v24;
  if ( v24 < 0 )
    goto LABEL_176;
...
LABEL_176:
  ...
  if ( v32 >= 0 || (_BYTE)v16 )
  {
    v33 = SePrivilegePolicyCheck((unsigned int)&v109, (unsigned int)&v120, 0, (_DWORD)v25, (__int64)&Privileges, v105);
    v23 = v109;
    if ( !v109 )
    {
...
LABEL_172:
  ...
  IsOwner = SepTokenIsOwner(v25, v119, v37, v31);
