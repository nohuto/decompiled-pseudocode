/*
 * XREFs of EtwpReferenceStackLookasideList @ 0x140935AF0
 * Callers:
...
_SLIST_ENTRY *EtwpReferenceStackLookasideList()
{
  ...
  v0 = 2 * KeNumberProcessors_0 * _InterlockedIncrement(&dword_140C53DC0);
  do
  {
    ...
    result = (_SLIST_ENTRY *)(unsigned int)_InterlockedIncrement(&dword_140C53DC4);
  }
  while ( (int)result < v0 );
  return result;
}
