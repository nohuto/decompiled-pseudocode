/*
 * XREFs of MinAsn1DecodeGeneralizedTime @ 0x140A33600
 * Callers:
...
char __fastcall MinAsn1DecodeGeneralizedTime(__int64 a1, LARGE_INTEGER *a2)
{
  unsigned int v2; // edi
  char *v3; // rbx
  __int16 v4; // r12
...
LABEL_16:
  ...
  if ( !v27 )
  {
    ...
    {
      if ( I_MinAsn1AdjustFileTime((__int64 *)v33, v7, v8) )
        return 1;
    }
  }
  return 0;
