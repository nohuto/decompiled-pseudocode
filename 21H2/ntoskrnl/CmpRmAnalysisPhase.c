/*
 * XREFs of CmpRmAnalysisPhase @ 0x14091C1BC
 * Callers:
...
LABEL_24:
      ...
      while ( 1 )
      {
        NextElement = (void ***)CmListGetNextElement(v2, &plsnUser, 0LL);
        if ( !NextElement )
          goto LABEL_17;
        v13 = *((_DWORD *)NextElement + 12);
        if ( (v13 & 1) == 0 || (v13 & 2) != 0 || (v13 & 4) != 0 )
        {
          v14 = *NextElement;
          if ( (*NextElement)[1] != NextElement || (v15 = NextElement[1], *v15 != NextElement) )
            __fastfail(3u);
          *v15 = v14;
          v14[1] = v15;
