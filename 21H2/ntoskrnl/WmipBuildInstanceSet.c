/*
 * XREFs of WmipBuildInstanceSet @ 0x14075D4B8
 * Callers:
...
__int64 __fastcall WmipBuildInstanceSet(_DWORD *a1, __int64 a2, unsigned int a3, __int64 a4, int a5)
{
  ...
  *(_DWORD *)(a4 + 76) = 0;
  ...
  if ( (v12 & 4) == 0 )
  {
    if ( (v12 & 8) == 0 )
      goto LABEL_8;
    if ( (int)WmipValidateWmiRegInfoString(a2, a3, (unsigned int)v13, &v35) >= 0 )
    {
      v16 = v35;
      if ( v35 )
      {
        ...
        if ( PoolWithTag )
        {
          RtlStringCchCopyNW((NTSTRSAFE_PWSTR)PoolWithTag + 2, v17 + 1, v16 + 1, v17);
  ...
  if ( (_DWORD)v5 )
  {
    ...
    {
      v35 = 0LL;
      if ( (int)WmipValidateWmiRegInfoString(a2, a3, (unsigned int)v13, &v35) < 0 || !v35 )
        return (unsigned int)-1073741811;
  ...
  if ( (_DWORD)v5 )
  {
    ...
    do
    {
      *v28 = v29;
      ...
      v35 = v32 + 1;
      RtlStringCchCopyNW(v11, v31, v32 + 1, v33);
      v14 = WmipMangleInstanceName(a1, v11, v33 + 7, v29);
      if ( v14 < 0 )
        goto LABEL_34;
      v34 = -1LL;
      do
