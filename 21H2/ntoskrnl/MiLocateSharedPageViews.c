/*
 * XREFs of MiLocateSharedPageViews @ 0x14059854C
 * Callers:
...
LABEL_24:
  ...
  if ( (v24 & 0x400) != 0 )
  {
    v50 = MiPreventControlAreaDeletion(v6, (__int64 *)&BugCheckParameter2, &v53);
    if ( !v50 )
    {
      _InterlockedAnd64((volatile signed __int64 *)(v6 + 24), 0x7FFFFFFFFFFFFFFFuLL);
      if ( KiIrqlFlags )
  ...
  else
  {
    ...
    if ( v14 && ($CEA84C04E3712D858E5667A507841A2A *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
      KiCheckForKernelApcDelivery();
    v42 = MiReferencePfBackedSection(v15);
    v30 = (__int64)v42;
    if ( !v42 )
      return 3221225497LL;
    v35 = *v42;
  ...
  v47[4] = v30;
  v48 = 0;
  v36 = MiTrimSection(v47, a2, 1, 0);
  if ( BugCheckParameter2 )
    MiDecrementSubsection((__int64 *)BugCheckParameter2);
  v37 = (__int64 *)MiDecrementModifiedWriteCount(v35, 0);
  if ( v37 )
