/*
 * XREFs of MiZeroPage @ 0x140233310
 * Callers:
...
LABEL_102:
  ...
  {
    if ( v58 )
      ++dword_140C2A2B8[(unsigned int)v95];
    else
      ++dword_140C2A2F8[(unsigned int)v95];
    ++dword_140C2A294;
LABEL_141:
    v59 = 0LL;
LABEL_142:
  ...
  if ( v58 )
  {
    ++dword_140C2A2A8[(unsigned int)v95];
  }
  else if ( v80[70] )
  {
    ++dword_140C2A2C8[(unsigned int)v95];
  }
  else
  {
    ++dword_140C2A2E8[(unsigned int)v95];
  }
  ++dword_140C2A288;
  if ( (_DWORD)v43 != 1 )
    goto LABEL_141;
