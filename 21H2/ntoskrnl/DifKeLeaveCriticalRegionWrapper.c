/*
 * XREFs of DifKeLeaveCriticalRegionWrapper @ 0x140613A10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  LOBYTE(v8) = KiLeaveCriticalRegionUnsafe((__int64)KeGetCurrentThread());
  if ( APIThunkContextById )
  {
    ...
    for ( j = (__int64 *)APIThunkContextById[6]; j != v9; j = (__int64 *)*j )
    {
      v8 = j - 2;
      if ( j != (__int64 *)16 )
        LOBYTE(v8) = ((__int64 (__fastcall *)(__int64 *))v8[1])(&v13);
    }
  }
  return (char)v8;
}
