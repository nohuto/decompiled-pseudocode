/*
 * XREFs of IvtSetScalableModePasidTableEntry @ 0x14052F800
 * Callers:
...
__int64 __fastcall IvtSetScalableModePasidTableEntry(__int64 a1, __int64 a2, __int64 a3, signed __int64 *a4)
{
