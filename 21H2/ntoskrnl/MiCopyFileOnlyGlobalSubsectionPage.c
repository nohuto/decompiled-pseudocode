/*
 * XREFs of MiCopyFileOnlyGlobalSubsectionPage @ 0x14059DB28
 * Callers:
        ...
        __int64 a7)
{
  ...
  *(_BYTE *)(v12 + 35) ^= (*(_BYTE *)(v12 + 35) ^ (*(_DWORD *)(a1 + 192) >> 9)) & 7;
  ...
  if ( ((a3 ^ v17) & 0xFFFFFFFFF000LL) != 0 )
    v18 = MiTryLockProtoPoolPageAtDpc(v17, 0xFFFFFFFFF000LL, &v33, (__int64)&v36);
  else
    v18 = MiTryLockLeafPage((unsigned __int64 *)v17, 0LL, &v36);
  v22 = v18;
  if ( v18 < 0 )
    goto LABEL_29;
  if ( (*(_BYTE *)(v36 + 35) & 0x40) != 0 )
  {
    ...
    {
      LOBYTE(v19) = 2;
      MiUnlockProtoPoolPage(v33, v19, v20, v21);
    }
    v22 = -1073740023;
LABEL_29:
    LODWORD(a5) = 0;
    ...
    {
      do
        KeYieldProcessorEx(&a5, v19, v20, v21);
      while ( *(__int64 *)(v12 + 24) < 0 );
    }
  ...
  *(_QWORD *)(a1 + 320) = v26;
  v27 = MiStartingOffset(v16, a3, *(_DWORD *)(v25 + 64));
  *(_QWORD *)(a1 + 200) = 0LL;
  *(_QWORD *)(a1 + 208) = v16;
  v28 = a6;
  *(_QWORD *)(a1 + 248) = v12;
  ...
  *(_QWORD *)(a1 + 160) = v28;
  ...
  {
    LOBYTE(v29) = 2;
    MiUnlockProtoPoolPage(v33, v29, v30, v31);
  }
  LOBYTE(v29) = 2;
  MiUnlockProtoPoolPage(v28, v29, v30, v31);
