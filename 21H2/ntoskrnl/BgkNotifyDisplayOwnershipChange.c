/*
 * XREFs of BgkNotifyDisplayOwnershipChange @ 0x14039BB40
 * Callers:
 *     BgkSetDisplayOwnership @ 0x1403D0410 (BgkSetDisplayOwnership.c)
...
__int64 __fastcall BgkNotifyDisplayOwnershipChange(char a1, __int64 (__fastcall *a2)(_QWORD, _QWORD, _QWORD))
{
  ...
  if ( a1 != byte_140C50BAC )
  {
    ...
    if ( !qword_140C50B88 )
      return 3221225473LL;
    v7 = 0LL;
    result = qword_140C50B88(0LL, v8, &v7);
    if ( (int)result >= 0 )
    {
      qword_140C50BA0 = v7;
      ...
      if ( Interface )
        (*Interface)(0LL, 4291217094LL, (unsigned int)dword_140CF56C0, 0LL);
