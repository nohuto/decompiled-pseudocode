/*
 * XREFs of PopDirectedDripsDiagTraceNotifyDevices @ 0x14057CE90
 * Callers:
...
char __fastcall PopDirectedDripsDiagTraceNotifyDevices(unsigned __int8 a1, int a2, __int64 a3)
{
  ...
  int v37; // [rsp+F0h] [rbp+6Fh] BYREF
  __int64 v38; // [rsp+F8h] [rbp+77h] BYREF
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      *(_QWORD *)&UserData.Size = 1LL;
      ...
      v34 = &v38;
      v35 = 8LL;
      LOBYTE(v3) = EtwWriteEx(v25, &POP_ETW_EVENT_DIRECTED_DRIPS_NOTIFY_DEVICES, 0LL, 0, 0LL, 0LL, 4u, &UserData);
    }
  }
  return (char)v3;
}
