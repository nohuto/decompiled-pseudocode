/*
 * XREFs of IopCreateFile @ 0x1407ADB90
 * Callers:
          ...
          *(_DWORD *)v27 = *(_DWORD *)v27;
          ...
          if ( Src && (_DWORD)Size )
          {
            ...
            *((_QWORD *)&v21[4].Next + 1) = Pool2;
            LODWORD(v21[5].Next) = Size;
            memmove(Pool2, Src, (unsigned int)Size);
            v30 = IoCheckEaBufferValidity(*((PFILE_FULL_EA_INFORMATION *)&v21[4].Next + 1), Size, (PULONG)a4 + 2);
            if ( v30 < 0 )
            {
              *a4 = v30;
              RtlRaiseStatus(v30);
...
LABEL_91:
        ...
        *((_QWORD *)&v21[4].Next + 1) = v33;
        if ( v33 )
        {
          LODWORD(v21[5].Next) = Size;
          memmove(v33, Src, (unsigned int)Size);
          v31 = a4;
          v36 = IoCheckEaBufferValidity(*((PFILE_FULL_EA_INFORMATION *)&v21[4].Next + 1), Size, (PULONG)a4 + 2);
          v88 = v36;
          if ( v36 < 0 )
          {
...
LABEL_149:
  ...
  if ( !v48 )
  {
    ...
    if ( (v16 & 0x10000000) != 0 )
    {
      ...
      if ( CurrentProcess[1].Affinity.StaticBitmap[30]
        && ((v72 = WORD2(CurrentProcess[2].Affinity.StaticBitmap[20]), v72 == 332) || v72 == 452) )
      {
...
LABEL_208:
  ...
  if ( v58[1].Affinity.StaticBitmap[30] )
  {
    v59 = WORD2(v58[2].Affinity.StaticBitmap[20]);
    if ( v59 == 332 || v59 == 452 )
    {
      if ( (_DWORD)Size )
      {
