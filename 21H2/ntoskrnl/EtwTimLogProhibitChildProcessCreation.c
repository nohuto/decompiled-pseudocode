/*
 * XREFs of EtwTimLogProhibitChildProcessCreation @ 0x1407F74C4
 * Callers:
...
void __fastcall EtwTimLogProhibitChildProcessCreation(int a1, __int64 a2, UNICODE_STRING *a3, UNICODE_STRING *a4)
{
  ...
  if ( v37 == 2 && (unsigned int)dword_140C043A8 > 5 && tlgKeywordOn((__int64)&dword_140C043A8, 0x200000000001LL) )
  {
    HIDWORD(v49) = v33;
    v46 = &v49;
    v48 = (__int64 *)v5[1];
    ...
    v55 = v34;
    v59 = v34;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C043A8, (unsigned __int8 *)byte_140035CBB, 0LL, 0LL, 0xAu, v45);
  }
  if ( v5 && *(_WORD *)v5 )
  {
  ...
  v36 = v14;
  v74 = v13;
  v15 = EtwpTiFillProcessIdentity(v76, a2, &v41);
  ...
  *(&UserData.Reserved + 2 * v28) = 0;
  ...
  if ( (unsigned int)dword_140C043E0 > 5 && tlgKeywordOn((__int64)&dword_140C043E0, 0x400000000000LL) )
  {
    ...
    v64 = 2LL;
    v66[1] = 0;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C043E0, (unsigned __int8 *)byte_140035C23, 0LL, 0LL, 0xCu, v45);
  }
  if ( v8 )
