/*
 * XREFs of NtSetSecurityObject @ 0x1405F8450
 * Callers:
...
LABEL_63:
      ...
      if ( v26 )
      {
        ...
        v11 = ObpAllocateAndQuerySecurityDescriptorInfo(v17, v27, 0LL, &v32);
      }
      else
      {
        v7 &= 0xFFF3FFFF;
...
LABEL_12:
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( (v19 & 0x40) != 0 )
      {
        ...
        {
          v11 = ObpAllocateAndQuerySecurityDescriptorInfo(v17, 64LL, 0LL, &v36);
          v16 = ObTypeIndexTable;
        }
      }
      v21 = v32;
      ...
      if ( (v19 & 0x20) != 0 )
      {
        ...
        if ( (POBJECT_TYPE *)ObTypeIndexTable[v15] != IoFileObjectType
          || (HIDWORD(v17->DmaOperations->FreeAdapterChannel) & 0x10) == 0 )
        {
          v11 = ObpAllocateAndQuerySecurityDescriptorInfo(v17, 32LL, 0LL, &P);
        }
      }
