/*
 * XREFs of HaliHandlePCIConfigSpaceAccess @ 0x140523C80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HaliHandlePCIConfigSpaceAccess(char a1, int a2, unsigned int a3, _WORD *a4)
{
  ...
  else if ( (unsigned int)(a2 - 3324) <= 3 && byte_140D017B4 )
  {
    ...
    if ( a1 )
      HaliPciInterfaceReadConfig(0LL, BYTE2(dword_140D017B0), v7, a4, v6, a3);
    else
      HalpPCIConfig(0LL, BYTE2(dword_140D017B0), v7, a4, v6, a3, 1);
  }
  else
  {
