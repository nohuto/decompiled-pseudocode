/*
 * XREFs of RtlpInitializeHeapSegment @ 0x14058B330
 * Callers:
        ...
        unsigned __int64 a8)
{
  ...
  if ( v14 + 80 >= (unsigned __int64)BaseAddress )
  {
    if ( v14 + 80 < a8 )
    {
      ...
      RegionSize[0] = (v14 - (_QWORD)BaseAddress + 4111) & 0xFFFFFFFFFFFFF000uLL;
      if ( (unsigned int)RtlpHpHeapCheckCommitLimit(RegionSize[0], v16, a1, (unsigned __int64 *)(a1 + 376))
...
LABEL_7:
  ...
  *(_BYTE *)(v14 + 14) = v20;
  ...
  if ( RegionSize[0] )
    RtlpInsertFreeBlock(a1, v14, RegionSize[0]);
  v22 = a1 + 288;
  v23 = (__int64 *)(a2 + 24);
  v24 = *(__int64 **)(a1 + 296);
  if ( *v24 == a1 + 288 )
