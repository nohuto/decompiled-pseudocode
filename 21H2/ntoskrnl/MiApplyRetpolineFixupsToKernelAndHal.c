/*
 * XREFs of MiApplyRetpolineFixupsToKernelAndHal @ 0x140A5154C
 * Callers:
...
__int64 __fastcall MiApplyRetpolineFixupsToKernelAndHal(__int64 a1)
{
  ...
  v25 = 0LL;
  v3 = *(_QWORD *)(a1 + 16);
  dword_140C4CC8C = *(_DWORD *)(v1 + 3468) >> 12;
  if ( (KiSpeculationFeatures & 0x20000000000LL) != 0
    && (v25 = v3,
        ...
        dword_140C4CCC8 = (v12 >> 12) + ((v12 & 0xFFF) != 0),
        dword_140C4CCC8 > (unsigned int)dword_140C4CC8C) )
  {
    updated = -1073741811;
  }
