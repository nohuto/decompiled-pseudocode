...
char __fastcall KeDisableTimer2(__int64 a1, char a2, char a3, __int64 *a4)
{
  ...
  if ( a4 )
  {
    ...
    if ( v8 && v15 )
    {
      LOBYTE(v37) = 8;
      v35 = v15;
      v36 = 0x7E35C6C7F3DD7277LL * (KiWaitNever ^ __ROR8__(a1 ^ _byteswap_uint64(v16 ^ KiWaitAlways), KiWaitNever));
    }
...
LABEL_12:
        if ( v8 )
          EtwGetKernelTraceTimestamp((unsigned __int64)v38, 0x40020000uLL);
        ...
        if ( a3 && !updated )
        {
          ...
          KeAddProcessorAffinityEx((unsigned __int16 *)v39, KiClockTimerOwner);
