...
LABEL_11:
        if ( v8 )
          EtwGetKernelTraceTimestamp(v39, 1073872896LL);
...
LABEL_17:
  if ( v8 && !v32 )
  {
    ...
    if ( updated )
    {
      EtwTraceTimedEvent(3947, 1073872896, (unsigned int)&v35, 32, 4197890, (__int64)v39);
    }
    else
    {
      LOBYTE(v38) = v28 | 4;
      EtwTraceTimedEvent(3947, 1073872896, (unsigned int)&v35, 32, 1538, (__int64)v39);
    }
  }
  return v29;
}
