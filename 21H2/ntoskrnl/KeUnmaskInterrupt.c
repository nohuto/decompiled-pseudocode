/*
 * XREFs of KeUnmaskInterrupt @ 0x1403979C4
 * Callers:
 *     IopUnmaskInterrupt @ 0x140397944 (IopUnmaskInterrupt.c)
 * Callees:
...
LABEL_4:
    ...
    if ( v9 )
      ...
      v12 = ((__int64 (__fastcall *)(__int64, _QWORD, _BOOL8, __int64))off_140C01DC8[0])(v11, 0LL, v9, v8);
  }
  if ( v12 != 296 )
    return v12;
  return v7;
