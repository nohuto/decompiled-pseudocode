/*
 * XREFs of MiDecrementPartialVadSubsections @ 0x1402ED0C4
 * Callers:
...
void __fastcall MiDecrementPartialVadSubsections(__int64 a1)
{
  __int64 v1; // rsi
  _QWORD *v2; // rdi
  __int64 v3; // r15
  ...
  do
  {
    ...
    {
      if ( !v1 )
        MiDrainSystemAccessLog((__int64)&KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.StaticBitmap[26]);
      v1 = *v4;
      v5 = (_QWORD *)*v2;
      v6 = 0LL;
      ...
      while ( v4 != v5 )
      {
        v8 = MiDecrementSubsections((ULONG_PTR)v4, (__int64)v4, 8);
        v4 = (_QWORD *)v4[2];
        v6 += v8;
      }
