/*
 * XREFs of MiClearPartitionPageBitMap @ 0x140561694
 * Callers:
...
char __fastcall MiClearPartitionPageBitMap(unsigned __int64 a1, _QWORD **a2)
{
  ...
  while ( v8 )
  {
    ...
    MiActOnPartitionNodePages(v11, 7u, (__int16 **)&v26);
  }
  ...
  __writecr8(v9);
  MiFreePartitionTree(a1, &v28, 0LL, 1LL);
...
LABEL_39:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v18, v5, (unsigned int *)&v31);
