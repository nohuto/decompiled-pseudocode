/*
 * XREFs of MinAsn1DecodeUtcTime @ 0x140A33AD0
 * Callers:
 *     MinAsn1DecodeTime @ 0x140A33A58 (MinAsn1DecodeTime.c)
 * Callees:
 ...
 *     I_MinAsn1MultiplyAndDivide @ 0x140A33524 (I_MinAsn1MultiplyAndDivide.c)
 *     I_MinAsn1ScanFrac @ 0x140A33580 (I_MinAsn1ScanFrac.c)
 */

char __fastcall MinAsn1DecodeUtcTime(__int64 a1, LARGE_INTEGER *a2)
{
  unsigned int v2; // edi
  char *v3; // rbx
  __int16 v5; // r13
...
LABEL_6:
  ...
  if ( !v12 )
  {
    *(_DWORD *)&TimeFields.Milliseconds = 0;
    ...
    {
      if ( I_MinAsn1AdjustFileTime((__int64 *)a2, v6, v7) )
        return 1;
    }
  }
  return 0;
