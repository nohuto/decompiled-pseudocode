/*
 * XREFs of DifKeClearEventWrapper @ 0x1406128E0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall DifKeClearEventWrapper(PRKEVENT Event)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
...
LABEL_18:
  LODWORD(v10) = KeResetEvent(Event);
  if ( APIThunkContextById )
  {
    ...
    for ( j = (__int64 *)APIThunkContextById[6]; j != v11; j = (__int64 *)*j )
    {
      v10 = j - 2;
      if ( j != (__int64 *)16 )
        LODWORD(v10) = ((__int64 (__fastcall *)(__int128 *))v10[1])(&v14);
    }
  }
  return (int)v10;
}
