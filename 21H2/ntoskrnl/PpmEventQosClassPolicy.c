/*
 * XREFs of PpmEventQosClassPolicy @ 0x14069DF5C
 * Callers:
...
char __fastcall PpmEventQosClassPolicy(__int64 a1, char a2)
{
  ...
  v2 = &PPM_ETW_PERF_QOS_CLASS_POLICY;
  v3 = (const EVENT_DESCRIPTOR *)PPM_ETW_PERF_QOS_CLASS_POLICY_RUNDOWN;
  v4 = 6LL;
  if ( !a2 )
    v3 = &PPM_ETW_PERF_QOS_CLASS_POLICY;
  v10 = 6;
  if ( PpmEtwRegistered )
  {
    ...
    if ( (_BYTE)v2 )
    {
      ...
      v15 = 150LL;
      v17 = 24;
      LOBYTE(v2) = EtwWrite(PpmEtwHandle, v3, 0LL, 4u, &UserData);
    }
  }
  return (char)v2;
}
