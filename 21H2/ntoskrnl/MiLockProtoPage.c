/*
 * XREFs of MiLockProtoPage @ 0x1402C4364
 * Callers:
...
ULONG_PTR __fastcall MiLockProtoPage(ULONG_PTR BugCheckParameter1, unsigned __int64 a2, unsigned __int8 a3)
{
  ...
  if ( a2 )
  {
    ...
    v6 = v22;
    if ( (unsigned int)MiPteInShadowRange(&v22, v7) )
    {
      if ( (MiFlags & 0xC00000) != 0 && KeGetCurrentThread()->ApcState.Process->AddressPolicy != 1 && (v6 & 1) != 0 )
      {
        v8 = v6;
    ...
    v11 = (unsigned __int8)MiLockPageInline(v10, v8, Flink);
