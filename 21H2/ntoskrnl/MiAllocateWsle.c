/*
 * XREFs of MiAllocateWsle @ 0x140211CC0
 * Callers:
...
LABEL_52:
    ...
    && (v30 == 4 || v30 == 1) )
  {
    ...
    {
      v32 = KeSetPagePrivilege((__int64)(v27 + 0x58000000000LL) / 48, &v54, 1024LL);
      if ( v32 < 0 )
...
LABEL_106:
  ...
  {
    v42 = MI_PFN_IS_PROTO(v27);
    v44 = v47 | 2;
    if ( v42 )
      v44 = v47;
    if ( v43 || (v7 & 7) == 0 )
      v44 = (unsigned int)v44 | 4;
    MiAddWorkingSetEntries(a1, v31, 1LL, v44);
  }
