/*
 * XREFs of KiAbThreadRemoveBoosts @ 0x14034AD00
 * Callers:
...
char __fastcall KiAbThreadRemoveBoosts(ULONG_PTR BugCheckParameter1, __int64 a2, __int64 a3, _DWORD *a4)
{
  unsigned int v4; // eax
  unsigned int v8; // ecx
  ...
  if ( (*(_DWORD *)a3 & 0x1FFFF) != 0 )
  {
    ...
    if ( (*(_WORD *)a3 & 0x7FFF) != 0 )
      LOBYTE(v4) = KiAbThreadUnboostCpuPriority(BugCheckParameter1, *(_WORD *)a3 & 0x7FFF, a3, a4);
    if ( (WORD2(PerfGlobalGroupMask) & 0x200) != 0 )
      LOBYTE(v4) = EtwTraceAutoBoostClearFloor(BugCheckParameter1, a2, *(_DWORD *)a3 & 0x1FFFF);
  }
  return v4;
}
