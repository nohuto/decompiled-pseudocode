/*
 * XREFs of PopTransitionTelemetryOsState @ 0x14081B500
 * Callers:
...
__int64 __fastcall PopTransitionTelemetryOsState(int a1, int a2)
{
  ...
  v42 = 0LL;
  v4 = 0;
  if ( !dword_140C03A00 || !tlgKeywordOn((__int64)&dword_140C03A00, 0x800000000000LL) || !byte_140C2200C )
    return v4;
  switch ( a1 )
  {
    case 2:
      if ( a2 == 2 )
      {
        if ( (unsigned int)dword_140C08F84 >= MEMORY[0xFFFFF7800000037C] )
          break;
        if ( !dword_140C08F80 )
          dword_140C08F80 = TelemetryCoverageStringHashInternal(off_140C08F78, &v15);
        v5 = &off_140C08F78;
      }
      else
      {
        if ( (unsigned int)dword_140C08F9C >= MEMORY[0xFFFFF7800000037C] )
          break;
        if ( !dword_140C08F98 )
          dword_140C08F98 = TelemetryCoverageStringHashInternal(off_140C08F90, &v15);
        v5 = &off_140C08F90;
      }
      goto LABEL_12;
    case 3:
      switch ( a2 )
      {
        case 3:
          if ( (unsigned int)dword_140C067A4 >= MEMORY[0xFFFFF7800000037C] )
            goto LABEL_13;
          if ( !dword_140C067A0 )
            dword_140C067A0 = TelemetryCoverageStringHashInternal(off_140C06798, &v15);
          v5 = &off_140C06798;
          goto LABEL_12;
        case 4:
          if ( (unsigned int)dword_140C08F3C >= MEMORY[0xFFFFF7800000037C] )
            goto LABEL_13;
          if ( !dword_140C08F38 )
            dword_140C08F38 = TelemetryCoverageStringHashInternal(off_140C08F30, &v15);
          v5 = &off_140C08F30;
          goto LABEL_12;
        case 5:
          if ( (unsigned int)dword_140C08F24 >= MEMORY[0xFFFFF7800000037C] )
            goto LABEL_13;
          if ( !dword_140C08F20 )
            dword_140C08F20 = TelemetryCoverageStringHashInternal(off_140C08F18, &v15);
          v5 = &off_140C08F18;
          goto LABEL_12;
        case 6:
          if ( (unsigned int)dword_140C08F6C >= MEMORY[0xFFFFF7800000037C] )
            goto LABEL_13;
          if ( !dword_140C08F68 )
            dword_140C08F68 = TelemetryCoverageStringHashInternal(off_140C08F60, &v15);
          v5 = &off_140C08F60;
          goto LABEL_12;
      }
      ...
      {
        if ( !dword_140C08F50 )
          dword_140C08F50 = TelemetryCoverageStringHashInternal(off_140C08F48, &v15);
        v5 = &off_140C08F48;
        goto LABEL_12;
      }
      break;
    case 4:
      switch ( a2 )
      {
        case 3:
          ...
          {
            if ( !dword_140C06788 )
              dword_140C06788 = TelemetryCoverageStringHashInternal(off_140C06780, &v15);
            v5 = &off_140C06780;
LABEL_12:
        ...
        case 4:
          if ( (unsigned int)dword_140C08EDC >= MEMORY[0xFFFFF7800000037C] )
            goto LABEL_13;
          if ( !dword_140C08ED8 )
            dword_140C08ED8 = TelemetryCoverageStringHashInternal(off_140C08ED0, &v15);
          v5 = &off_140C08ED0;
          goto LABEL_12;
        case 5:
          if ( (unsigned int)dword_140C08F0C >= MEMORY[0xFFFFF7800000037C] )
            goto LABEL_13;
          if ( !dword_140C08F08 )
            dword_140C08F08 = TelemetryCoverageStringHashInternal(off_140C08F00, &v15);
          v5 = &off_140C08F00;
          goto LABEL_12;
        case 6:
          if ( (unsigned int)dword_140C08EF4 >= MEMORY[0xFFFFF7800000037C] )
            goto LABEL_13;
          if ( !dword_140C08EF0 )
            dword_140C08EF0 = TelemetryCoverageStringHashInternal(off_140C08EE8, &v15);
          v5 = &off_140C08EE8;
          goto LABEL_12;
        default:
          ...
          {
            if ( !dword_140C08EC0 )
              dword_140C08EC0 = TelemetryCoverageStringHashInternal(off_140C08EB8, &v15);
            v5 = &off_140C08EB8;
            goto LABEL_12;
          }
          break;
...
LABEL_13:
  ...
  {
    v7 = (KiQueryUnbiasedInterruptTime() - qword_140C21FE8) / 0x2710uLL;
    ...
    PopCurrentPowerState(&v42);
    v12 = 0;
    v13 = DWORD2(v42);
    if ( DWORD2(v42) )
      v12 = (unsigned int)(100 * HIDWORD(v42)) / DWORD2(v42);
    PopMeasureEnergyChange(&v34, &OsStateChangeEnergyCounter);
    v33 = qword_140C21FD8;
    if ( (unsigned int)dword_140C03A00 > 5 && tlgKeywordOn((__int64)&dword_140C03A00, 0x800000000000LL) )
    {
      v16 = a1;
      v44 = &v16;
      v46 = &v17;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&byte_14002F29F,
        0LL,
        0LL,
        0x16u,
        &v43);
