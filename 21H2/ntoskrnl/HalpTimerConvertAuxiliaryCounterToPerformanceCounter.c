/*
 * XREFs of HalpTimerConvertAuxiliaryCounterToPerformanceCounter @ 0x1405030B0
 * Callers:
 *     <none>
 * Callees:
 *     HalpTimerCaptureCurrentAuxiliaryQpcPair @ 0x140502F20 (HalpTimerCaptureCurrentAuxiliaryQpcPair.c)
 *     HalpTimerConvertAuxiliaryCounter @ 0x140502FE4 (HalpTimerConvertAuxiliaryCounter.c)
 */
...
__int64 __fastcall HalpTimerConvertAuxiliaryCounterToPerformanceCounter(unsigned __int64 a1, _QWORD *a2, _QWORD *a3)
{
  ...
  HalpTimerCaptureCurrentAuxiliaryQpcPair(&v11, (__int64 *)&v12, &v15);
  ...
  v8 = HalpTimerConvertAuxiliaryCounter(v12, v7, v11.QuadPart, v6, a1, &v13, v14);
  if ( v8 < 0 )
  {
LABEL_10:
    *a2 = 0LL;
