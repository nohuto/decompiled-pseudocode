/*
 * XREFs of PfpFlushBuffers @ 0x140678FB0
 * Callers:
...
char PfpFlushBuffers()
{
  ...
  if ( v22 < 0 )
    return 0;
  v3 = RtlpInterlockedFlushSList(&stru_140CEC380);
  if ( !v3 )
  {
LABEL_16:
    v14 = v22;
  ...
  while ( 1 )
  {
    ...
    v27 = HIDWORD(v28);
    v29 = dword_140C5031C + (((v8 << 8) + v9) >> 10);
    Src = 163851LL;
    PfpCopyEvent(&Src);
    if ( *((int *)&v6->Next + 2) > 1
          ...
          *((int *)&v6->Next + 2) > 1) )
    {
      ...
      if ( (unsigned __int64)Next <= *((_QWORD *)&v6[2].Next + 1) )
      {
        while ( 1 )
        {
          ...
          v22 = 0;
          v18 = PfTAcquireLogEntry(&unk_140C4FC18, &v22, 1LL);
          if ( !v18 )
            break;
