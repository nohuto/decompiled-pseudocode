/*
 * XREFs of CmpFindSubKeyInRoot @ 0x1407C5F80
 * Callers:
        ...
        int *a5)
{
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      CellFlat = (__int16 *)HvpGetCellFlat(BugCheckParameter3, v10, &v54);
    else
      CellFlat = (__int16 *)HvpGetCellPaged(BugCheckParameter3);
    v57 = (__int64)CellFlat;
    *a5 = -1;
    if ( !CellFlat )
      return 0x80000000LL;
    v12 = *CellFlat;
    v13 = (unsigned int)(unsigned __int16)CellFlat[1] - 1;
    if ( ((*CellFlat - 26220) & 0xFDFF) == 0 )
    {
      v17 = &CellFlat[4 * v13];
      v56 = v17;
      if ( v12 == 26220 )
          ...
          while ( 1 )
          {
            ...
            if ( v25 >= 0x61u )
            {
              ...
              else
              {
                ...
                v27 = NLS_UPCASE(CurrentServerSiloGlobals[154], v29);
              }
            }
            else
            {
...
LABEL_39:
      ...
      if ( v35 )
        ...
        CellPaged = HvpGetCellFlat(BugCheckParameter3, v34, &v55);
      if ( !CellPaged )
        goto LABEL_100;
      v37 = *(_WORD *)(CellPaged + 72);
      v38 = (unsigned __int8 *)(CellPaged + 76);
      if ( (*(_BYTE *)(CellPaged + 2) & 0x20) != 0 )
      {
        if ( a4 )
          v39 = CmpCompareTwoCompressedNames(*((unsigned __int8 **)a4 + 1), *a4, v38, v37);
        else
          v39 = CmpCompareCompressedName((__int64)v8, v38, v37, 0);
      }
      else
      {
        ...
        if ( a4 )
        {
          v40 = -(int)CmpCompareCompressedName((__int64)&String2, *((unsigned __int8 **)a4 + 1), *a4, 0);
          goto LABEL_54;
        }
...
LABEL_54:
      if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
        ...
        HvpReleaseCellPaged(BugCheckParameter3, &v55);
      if ( v40 )
      {
        v16 = 1;
        if ( v40 < 0 )
    ...
    v14 = &CellFlat[2 * v13];
    v15 = CmpDoCompareKeyName(BugCheckParameter3, v8, a4, *((unsigned int *)v14 + 1));
    v16 = v15;
    if ( v15 == 2 )
      goto LABEL_100;
    if ( !v15 )
...
LABEL_61:
    ...
    {
      v41 = CmpCompareInIndex(BugCheckParameter3, a3, (unsigned __int8 **)a4, 0, (__int16 *)v57, (__int64)a5);
      if ( v41 == 2 )
        goto LABEL_100;
      if ( v41 >= 0 )
      {
LABEL_99:
  ...
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    v44 = HvpGetCellFlat(BugCheckParameter3, *(unsigned int *)(v60 + 4LL * v6 + 4), &v54);
  else
    v44 = HvpGetCellPaged(BugCheckParameter3);
  v45 = (__int16 *)v44;
  if ( !v44 )
    goto LABEL_80;
  v47 = CmpCompareInIndex(
          BugCheckParameter3,
          a3,
          (unsigned __int8 **)a4,
  ...
  if ( v47 )
  {
    if ( v47 >= 0 )
    {
      ...
      if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
        v49 = HvpGetCellFlat(BugCheckParameter3, *(unsigned int *)(v60 + 4LL * (unsigned int)v5 + 4), &v54);
      else
        v49 = HvpGetCellPaged(BugCheckParameter3);
      if ( !v49 )
      {
LABEL_80:
        *a5 = -1;
    ...
    {
      v48 = CmpCompareInIndex(BugCheckParameter3, a3, (unsigned __int8 **)a4, 0, v45, (__int64)a5);
      if ( v48 != 2 )
      {
        LODWORD(v5) = v59;
        if ( v48 >= 0 )
