/*
 * XREFs of DifZwDuplicateObjectWrapper @ 0x14061FC20
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwDuplicateObjectWrapper(
...
LABEL_13:
  LODWORD(v22[2]) = DesiredAccess;
  v22[1] = __PAIR64__(HandleAttributes, Options);
  v22[6] = SourceProcessHandle;
  v22[5] = SourceHandle;
  v22[4] = TargetProcessHandle;
  v22[3] = TargetHandle;
