/*
 * XREFs of MiClearPteAccessed @ 0x140332A80
 * Callers:
...
LABEL_46:
      ...
      {
        v10 = 1;
        MiLockPageTableInternal(a1, a3, 0LL, 0x7FFFFFFFF8LL);
        v7 = 0LL;
      }
LABEL_4:
      if ( !v16 )
...
LABEL_48:
  ...
  {
    do
      KeYieldProcessorEx(&v44, v7, v11, v15);
...
LABEL_5:
    ...
    if ( v10 )
    {
      ...
      MiUnlockNestedPageTableWritePte(a1, (volatile __int64 *)a3, v35 & 0xCFFFFFFFFFFFFFDFuLL, 0);
    }
    else
    {
      v17 = *(_QWORD *)a3;
        ...
        && ((v17 & 0x20) == 0 || (v17 & 0x42) == 0) )
      {
        ...
        if ( v39 )
        {
          v40 = *((_QWORD *)&v39->Flink + ((a3 >> 3) & 0x1FF));
          if ( (v40 & 0x20) != 0 )
            v17 |= 0x20uLL;
          if ( (v40 & 0x42) != 0 )
            v17 |= 0x42uLL;
...
LABEL_19:
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(a4 + 16) += v31;
      ...
      {
        qsort((void *)(a4 + 24), v33, 8uLL, (int (__cdecl *)(const void *, const void *))MiTbFlushSort);
