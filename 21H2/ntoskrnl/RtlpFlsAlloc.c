/*
 * XREFs of RtlpFlsAlloc @ 0x1408530AC
 * Callers:
 ...
 *     ?SlotFree@?$RTL_BINARY_ARRAY@URTLP_FLS_CALLBACK_ENTRY@@$03$03@@SAXPEAU1@K@Z @ 0x1405F1A70 (-SlotFree@-$RTL_BINARY_ARRAY@URTLP_FLS_CALLBACK_ENTRY@@$03$03@@SAXPEAU1@K@Z.c)
 */
...
__int64 __fastcall RtlpFlsAlloc(__int64 a1, __int64 a2, __int64 a3, __int64 a4, unsigned int *a5)
{
  ...
  while ( 1 )
  {
    v9 = RTL_BINARY_ARRAY<RTLP_FLS_CALLBACK_ENTRY,4,4>::SlotAllocate((_DWORD **)&PspTlsContext + 1);
    v10 = v9;
    if ( v9 == -1 )
      break;
    v11 = v9 - 16;
      ...
      if ( v11 < 0xF0 )
      {
        ...
        *(_QWORD *)v15 = a4;
        ...
        if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&PspTlsContext, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
          ExfTryToWakePushLock(&PspTlsContext);
