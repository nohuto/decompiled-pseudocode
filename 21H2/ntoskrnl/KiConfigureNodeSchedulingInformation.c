/*
 * XREFs of KiConfigureNodeSchedulingInformation @ 0x1403DBF54
 * Callers:
...
__int64 __fastcall KiConfigureNodeSchedulingInformation(__int64 a1)
{
  ...
  v3 = 0LL;
  v4 = HalpInterruptHyperThreading;
  ...
  if ( v1 )
  {
    do
    {
      ...
      v10 = KiProcessorBlock[KiProcessorNumberToIndexMappingTable[(unsigned int)((v2 << 6) + v9)]];
      if ( v4 )
      {
    ...
    do
    {
      ...
      v12 |= 1LL << v14;
      v13 &= ~*(_QWORD *)(KiProcessorBlock[KiProcessorNumberToIndexMappingTable[(unsigned int)((v2 << 6) + v14)]] + 34928);
    }
    while ( v13 );
    do
    {
      _BitScanForward64(&v15, v1);
      v16 = *(_QWORD *)(KiProcessorBlock[KiProcessorNumberToIndexMappingTable[(unsigned int)((v2 << 6) + v15)]] + 34880);
      v3 |= v16;
      v1 &= ~v16 & ~(1LL << v15);
    }
    while ( v1 );
