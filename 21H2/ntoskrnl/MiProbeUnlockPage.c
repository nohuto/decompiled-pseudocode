/*
 * XREFs of MiProbeUnlockPage @ 0x1402B7320
 * Callers:
...
void __fastcall MiProbeUnlockPage(__int64 a1, __int16 a2, __int64 *a3, int *a4)
{
  ...
  if ( (a2 & 0x100) != 0 )
  {
      ...
      && (v8 & 0xFFFFFFFFFFLL) != 0x3FFFFFFFFELL )
    {
      ...
      if ( *a3 != (v8 & 0xFFFFFFFFFFLL) )
      {
        ...
        {
          MiUnlockPageTableCharges(48 * v9 - 0x220000000000LL);
          v8 = *(_QWORD *)(a1 + 40);
        }
        v28 = 1;
        if ( v8 >= 0 )
  ...
  if ( v6 < 0 )
  {
    if ( !v12 )
    {
      ...
      {
        v13 = MI_READ_PTE_LOCK_FREE(a1 + 16) & 0xFFFFFFFFFFFFFFFDuLL;
      ...
      if ( (_DWORD)CachedResidentAvailable != -1 )
      {
        if ( (unsigned __int64)(CachedResidentAvailable + 1) <= 0x100 )
        {
          while ( 1 )
          {
            ...
            v17 = (_DWORD)CachedResidentAvailable == v27;
...
LABEL_65:
        if ( (int)CachedResidentAvailable > 192
          && (_DWORD)CachedResidentAvailable == _InterlockedCompareExchange(
                                                  ...
                                                  CachedResidentAvailable) )
        {
          v24 = (int)CachedResidentAvailable - 192 + 1LL;
        }
        if ( !v24 )
          goto LABEL_29;
      }
...
LABEL_30:
    ...
    && *(_WORD *)(a1 + 32) == 2 )
  {
    *(_QWORD *)(a1 + 24) &= ~0x4000000000000000uLL;
    ...
    v35 = (*(_QWORD *)BaseResidentPage & 0xFFFFFFFFFFLL) - 1;
    *(_QWORD *)BaseResidentPage ^= (v35 ^ *(_QWORD *)BaseResidentPage) & 0xFFFFFFFFFFLL;
  ...
  if ( v13 )
    MiReleasePageFileInfo(v14, v13, 1LL);
  if ( v10 )
    MiFinishLargePageFree(v10, 1u, 1);
  if ( v11 )
    MiDereferenceControlAreaProbe(v11, 1);
