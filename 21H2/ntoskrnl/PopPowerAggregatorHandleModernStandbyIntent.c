/*
 * XREFs of PopPowerAggregatorHandleModernStandbyIntent @ 0x140995C40
 * Callers:
 *     PopPowerAggregatorHandleIntentUnsafe @ 0x1407F22AC (PopPowerAggregatorHandleIntentUnsafe.c)
 * Callees:
 *     PopPowerAggregatorAllowModernStandbyPromotion @ 0x140995830 (PopPowerAggregatorAllowModernStandbyPromotion.c)
 */
