/*
 * XREFs of MiIdealClusterPage @ 0x140555E14
 * Callers:
...
LABEL_36:
  ...
  if ( v29 != 16 )
  {
    ...
    if ( (unsigned __int8 *)v95 != a5 )
    {
      ...
      LODWORD(v93) = dword_140C4DEF8 & v26;
      goto LABEL_46;
    }
LABEL_43:
    *v109 = 1;
  ...
  v34 = HIDWORD(v110) >> byte_140C4DE8C;
  v35 = _InterlockedExchangeAdd((volatile signed __int32 *)v110, 1u);
  LODWORD(v93) = HIDWORD(v110) | DWORD2(v110) & v35;
LABEL_46:
  ...
  if ( v91 == 1 )
  {
    ...
    if ( LargePage )
    {
      ...
      do
      {
        ...
        {
          MiReleaseFreshPage(v94, v63, v58);
          v64 = v97;
        }
        v65 = v94;
        if ( v105 != v62 )
...
LABEL_108:
  v70 = 0;
  MiRelockFaultState((__int64)(v102 + 7), v111, v58, v57);
  if ( Buf2 )
  {
    *((_QWORD *)&v114 + 1) |= 0x8000000000000000uLL;
    ...
    if ( _interlockedbittestandset64((volatile signed __int32 *)Buf2 + 6, 0x3FuLL) )
    {
      ...
      {
        do
          KeYieldProcessorEx(&v98, v74, v75, v76);
    ...
    MiReturnPfnReferenceCount((__int64)v79, v80, v81);
  }
  v99 = 0;
  while ( _interlockedbittestandset64((volatile signed __int32 *)a5 + 6, 0x3FuLL) )
  {
    do
      KeYieldProcessorEx(&v99, v71, v72, (__int64)v73);
    while ( *((__int64 *)a5 + 3) < 0 );
  }
  if ( !v70 && !memcmp(v116, a5, 0x30uLL) && (*((_QWORD *)a5 + 3) & 0x4000000000000000LL) == 0 )
  {
    v82 = v112;
    if ( (unsigned int)MiIsFaultPteIntact((__int64)v102, *v102, v112, &v103) )
    {
      ...
      MiSwapHardFaultPage(v82, a5, v68);
      *(_WORD *)(v68 + 32) = 0;
      v83 = 1LL;
      if ( (ULONG_PTR *)v23 != &MiSystemPartition )
        goto LABEL_135;
      ...
      if ( v83 )
LABEL_135:
        _InterlockedExchangeAdd64((volatile signed __int64 *)(v23 + 7168), v83);
LABEL_136:
      *v109 = 1;
  ...
  {
    _InterlockedAnd64((volatile signed __int64 *)a5 + 3, 0x7FFFFFFFFFFFFFFFuLL);
    MiReleaseFreshPage(v68, v71, v72);
    MiReturnCommit(v23, 1LL);
    if ( (ULONG_PTR *)v23 != &MiSystemPartition )
      goto LABEL_148;
    v88 = KeGetCurrentPrcb();
    v87 = (int)v88->CachedResidentAvailable;
    if ( (_DWORD)v87 == -1 )
      goto LABEL_148;
    v89 = 256LL;
    if ( (unsigned __int64)(v87 + 1) <= 0x100 )
    {
      do
      {
        v90 = _InterlockedCompareExchange((volatile signed __int32 *)&v88->CachedResidentAvailable, v87 + 1, v87);
        v14 = (_DWORD)v87 == v90;
        v87 = v90;
        if ( v14 )
          goto LABEL_149;
    ...
    if ( (int)v87 > 192
      && (_DWORD)v87 == _InterlockedCompareExchange((volatile signed __int32 *)&v88->CachedResidentAvailable, 192, v87) )
    {
      v22 = (int)v87 - 192 + 1LL;
    }
    if ( v22 )
...
LABEL_149:
    ...
    {
      do
        KeYieldProcessorEx(&v100, v87, (__int64)v88, v89);
      while ( *((__int64 *)a5 + 3) < 0 );
    }
  }
