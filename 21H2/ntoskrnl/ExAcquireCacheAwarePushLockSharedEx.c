/*
 * XREFs of ExAcquireCacheAwarePushLockSharedEx @ 0x140355140
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  v9 = *(unsigned __int64 **)(BugCheckParameter2 + 8LL * (KeGetPcr()->Prcb.Number & 0x1F));
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)v9, 17LL, 0LL) && !ExfTryAcquirePushLockShared(v9) )
    ExfAcquirePushLockSharedEx(v9, (_RTL_BALANCED_NODE *)v2, BugCheckParameter2);
  if ( v2 )
    *(_BYTE *)(v2 + 26) |= 1u;
  return v9;
}
