/*
 * XREFs of PiDrvDbResolveFilePathKeyValues @ 0x14095D488
 * Callers:
...
LABEL_3:
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( (v4 & 2) != 0 )
    {
      ...
      {
LABEL_21:
        if ( (int)PnpCtxRegQueryInfoKey(v15, (int)Handle, 0, 0, (__int64)v10, (__int64)&v39, (__int64)&v42) >= 0 )
        {
          v8 = (unsigned int)v42;
...
LABEL_29:
        ...
        LODWORD(v42) = v6 >> 1;
        v39 = v8;
        v18 = PnpCtxRegEnumValue(v16, Handle, v17, v7, (__int64)&v42, (__int64)&v44, v9, (__int64)&v39);
        if ( v18 == -2147483622 )
          goto LABEL_87;
        if ( v18 == -1073741789 )
        {
...
LABEL_84:
        ...
        if ( v24 )
        {
          if ( v24 <= 2 )
          {
            ...
            v37 = PiDrvDbResolveSystemFilePath(
                    &v51,
                    a2,
                    a3,
          ...
          else
          {
            ...
            if ( *v26 )
            {
              while ( 1 )
              {
                ...
                UnicodeString.Length = 0;
                v30 = PiDrvDbResolveSystemFilePath(
                        &v51,
                        a2,
                        a3,
                        (unsigned __int64)&DestinationString & -(__int64)(DestinationString.Buffer != 0LL),
                ...
                appended = PiDevCfgAppendMultiSz(&v52, p_UnicodeString, 0LL, 1);
                if ( appended < 0 )
                  goto LABEL_78;
          ...
          appended = RegRtlSetValue(KeyHandle, v34, v23[1], Buffer, v28);
        }
LABEL_78:
