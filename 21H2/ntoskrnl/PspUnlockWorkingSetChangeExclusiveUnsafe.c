/*
 * XREFs of PspUnlockWorkingSetChangeExclusiveUnsafe @ 0x140581E10
 * Callers:
...
LABEL_20:
  ...
  LOBYTE(v8) = KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, (__int64)&qword_140C13270, (unsigned int *)&v10);
