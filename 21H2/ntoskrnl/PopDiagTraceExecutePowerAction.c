/*
 * XREFs of PopDiagTraceExecutePowerAction @ 0x1407FF0A8
 * Callers:
        ...
        ...)
{
  ...
  if ( dword_140C03A00 )
  {
    LOBYTE(ProcessImageFileName) = tlgKeywordOn((__int64)&dword_140C03A00, 0x800000000000LL);
    if ( (_BYTE)ProcessImageFileName )
    {
      if ( v18 > 5 )
      {
        ...
        if ( (_BYTE)ProcessImageFileName )
        {
          ...
          LOBYTE(ProcessImageFileName) = tlgWriteTransfer_EtwWriteTransfer(
                                           v20,
                                           (unsigned __int8 *)word_14002EF72,
                                           0LL,
                                           0LL,
                                           0x11u,
                                           &v66);
