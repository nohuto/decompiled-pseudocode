/*
 * XREFs of PnpFilterResourceRequirementsList @ 0x14083C0F4
 * Callers:
...
__int64 __fastcall PnpFilterResourceRequirementsList(_DWORD *Src, unsigned int *a2, _QWORD *a3, _DWORD *a4)
{
  unsigned int v4; // ebx
  unsigned int *v6; // r12
  int v8; // r13d
