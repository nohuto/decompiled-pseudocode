/*
 * XREFs of NtTraceEvent @ 0x14027E790
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( GuidEntryByGuid )
  {
    if ( *(_DWORD *)(GuidEntryByGuid + 96) )
    {
      ...
      if ( v10 >= 0 )
      {
        ...
        v30[52] = KeGetCurrentThread();
        LOBYTE(v32) = 1;
        EtwpUpdateEnableMask((_DWORD)v30, 0, 0, v32, (__int64)&v45);
        v30[52] = 0LL;
        ...
        if ( v30[50] )
        {
          ...
          v30[52] = KeGetCurrentThread();
          LOBYTE(v43) = 1;
          EtwpUpdateEnableMask(v30[50], 0, 1, v43, (__int64)&v45);
          v30[52] = 0LL;
          ExReleasePushLockEx((ULONG_PTR)(v30 + 51), 0LL);
          KeLeaveCriticalRegionThread(KeGetCurrentThread());
          v10 = EtwpWriteUserEvent(
