/*
 * XREFs of MiInitializeNumaRangesTemporary @ 0x140B3111C
 * Callers:
...
char *MiInitializeNumaRangesTemporary()
{
  ...
  v4 = 0LL;
  qword_140C506F8 = -1LL;
  if ( ((int (__fastcall *)(__int64, __int64, char **))off_140C020D8[0])(30LL, 16LL, &v4) >= 0 && (result = v4) != 0LL )
  {
    v1 = 0;
    if ( *(_QWORD *)v4 != -1LL )
    {
  ...
  {
    result = (char *)&unk_140C506E8;
  }
  qword_140C50708 = result;
  return result;
}
