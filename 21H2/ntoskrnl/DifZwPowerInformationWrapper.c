/*
 * XREFs of DifZwPowerInformationWrapper @ 0x140623190
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  DWORD2(v20) = OutputBufferLength;
  DWORD2(v22) = InformationLevel;
  *(_QWORD *)&v22 = InputBuffer;
  DWORD2(v21) = InputBufferLength;
  *(_QWORD *)&v21 = OutputBuffer;
