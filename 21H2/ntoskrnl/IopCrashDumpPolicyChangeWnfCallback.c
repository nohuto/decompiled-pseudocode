/*
 * XREFs of IopCrashDumpPolicyChangeWnfCallback @ 0x1409335E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IopCrashDumpPolicyChangeWnfCallback(__int64 a1, _QWORD *a2)
{
  ...
  *(_DWORD *)(&ValueName.MaximumLength + 1) = 0;
  ...
  if ( v2 )
  {
    ...
    if ( (unsigned int)dword_140C064A8 > 5 && tlgKeywordOn((__int64)&dword_140C064A8, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_14002AC64,
        0LL,
        0LL,
        5u,
        v15);
  ...
  else
  {
    ...
    if ( (unsigned int)dword_140C064A8 > 5 && tlgKeywordOn((__int64)&dword_140C064A8, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C064A8,
        (unsigned __int8 *)&dword_14002AC26 + 1,
        0LL,
        0LL,
        3u,
        v15);
