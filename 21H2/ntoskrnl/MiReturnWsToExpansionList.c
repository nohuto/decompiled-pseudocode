/*
 * XREFs of MiReturnWsToExpansionList @ 0x14035E6F8
 * Callers:
...
LABEL_8:
  ...
  result = *(_QWORD **)(*(_QWORD *)(qword_140C4E648 + 8LL * *(unsigned __int16 *)(a1 + 174)) + 6864LL);
  if ( (_QWORD *)*result != v3 )
    goto LABEL_8;
  *(_QWORD *)v2 = v3;
  *(_QWORD *)(a1 + 32) = result;
...
LABEL_4:
  v5 = *(_QWORD *)(a1 + 104);
  if ( v5 )
    return (_QWORD *)KeSignalGate(v5, 1LL, (__int64)v3, v2);
  return result;
}
