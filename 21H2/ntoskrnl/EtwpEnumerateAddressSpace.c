/*
 * XREFs of EtwpEnumerateAddressSpace @ 0x1406F6CA4
 * Callers:
...
void __fastcall EtwpEnumerateAddressSpace(ULONG_PTR a1, __int64 a2, int *a3)
{
  ...
  __int64 v53; // [rsp+B8h] [rbp-F0h] BYREF
  ...
  if ( Pool2 || (v8 &= ~1u, (v35 = v8) != 0) )
  {
    ...
    v10 = 0;
    v38 = 0;
    v11 = (void *)MmEnumerateAddressSpaceAndReferenceImages(v6);
    P = v11;
    if ( v11 )
    {
...
LABEL_57:
        if ( v5 )
        {
          ...
          *(_QWORD *)&v66 = i;
          *((_QWORD *)&v66 + 1) = v22;
          EtwpLogKernelEvent((__int64)&v66, *(_QWORD *)(v48 + 1096), *(_DWORD *)v48, 1u, v10, v29);
        }
        else
        {
          v30 = 5249282;
          ...
          v68 = v22;
          v69 = 0;
          EtwTraceKernelEvent((__int64)&v67, 1u, v24, v10, v30);
        }
LABEL_35:
        ;
      }
      ...
      *(_QWORD *)(i + 8) = v15 & 0xFFFFFFFFFFFFE03FuLL;
      ...
      if ( !FltMgrCallbacks
        || (NameStringMode = (*(__int64 (__fastcall **)(_QWORD, __int64, unsigned __int16 *, __int64 *))(FltMgrCallbacks + 24))(
            ...
            NameStringMode < 0) )
      {
        NameStringMode = ObQueryNameStringMode(*(_QWORD *)i, (_DWORD)Pool2, 0x2000, (unsigned int)&v31, 0);
      }
      v40 = 0;
      v51 = *(_DWORD *)(i + 40);
      v45 = v51;
      v61 = *(_QWORD *)(i + 16);
      v58 = v61;
      v17 = RtlImageNtHeader(*(_QWORD *)(i + 8));
      if ( v17 )
      {
        v18 = *(_DWORD *)(v17 + 88);
        v45 = v18;
