/*
 * XREFs of ExRecordOneTimerExpiry @ 0x1405B6960
 * Callers:
...
char __fastcall ExRecordOneTimerExpiry(unsigned __int8 a1, char a2)
{
  ...
  if ( ExpIRTimerExpiryCounts )
  {
    ...
    v3 = a1 < 0x10u ? a2 : 0;
    v4 = qword_140005300;
    LOBYTE(v5) = v3 < LOBYTE(qword_140005300[3 * v2]) ? v3 : 0;
    v6 = (unsigned __int8)v5;
    if ( ((unsigned __int8)v2 & (unsigned __int8)-(v3 < LOBYTE(qword_140005300[3 * v2]))) != 0 )
    {
      v7 = v3 < LOBYTE(qword_140005300[3 * v2]) ? (unsigned __int8)v2 : 0;
      do
      {
