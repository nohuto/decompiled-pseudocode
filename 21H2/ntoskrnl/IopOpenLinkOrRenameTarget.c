/*
 * XREFs of IopOpenLinkOrRenameTarget @ 0x1406C78D4
 * Callers:
...
NTSTATUS __fastcall IopOpenLinkOrRenameTarget(HANDLE *a1, __int64 a2, __int64 a3, struct _FILE_OBJECT *a4)
{
  bool v4; // zf
  HANDLE v9; // rsi
  NTSTATUS result; // eax
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  if ( !v4 || (result = IopGetBasicInformationFile(a4), result >= 0) )
  {
    v11 = *(void **)(a3 + 8);
    if ( v11 )
    {
