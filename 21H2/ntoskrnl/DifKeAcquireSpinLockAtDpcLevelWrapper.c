/*
 * XREFs of DifKeAcquireSpinLockAtDpcLevelWrapper @ 0x1406125C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DifKeAcquireSpinLockAtDpcLevelWrapper(PKSPIN_LOCK SpinLock)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
