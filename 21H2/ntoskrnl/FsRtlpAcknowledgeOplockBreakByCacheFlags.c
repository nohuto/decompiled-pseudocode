/*
 * XREFs of FsRtlpAcknowledgeOplockBreakByCacheFlags @ 0x14039F3B0
 * Callers:
...
LABEL_44:
    ...
    if ( !a4 )
    {
      FsRtlpModifyThreadPriorities(v52, 0LL, 0LL);
      FsRtlpClearOwner(v52, 0LL);
      *(_BYTE *)(v52 + 32) = 0;
...
LABEL_82:
      ...
      FsRtlpClearOwner(v52, 0LL);
      *(_BYTE *)(v52 + 32) = 0;
      v8 = FsRtlpGrantAnyOplockFromExclusive(v52, a3, v22, a4, a5, v39, &v45, &v41, &v42, a6);
      Pool2 = v45;
    }
LABEL_94:
    if ( v41 )
...
LABEL_8:
  ...
  while ( 1 )
  {
    ...
    if ( v14 )
    {
      ...
      if ( v27 != *v18 )
      {
        v28 = FsRtlpOplockKeysEqual(*v18, v27, 0);
        v15 = 0;
        v14 = v44;
        if ( v28 )
          break;
  ...
  if ( v19 != 0x800000 )
  {
    if ( v19 == 0x100000
      && (a4 & 0x7000) > 0x3000
      && (*(_QWORD *)(v52 + 88) != v52 + 88 || !(unsigned __int8)FsRtlpOplockUpperLowerCompatible(a4, a6)) )
    {
      v29 = *(_QWORD *)(a3 + 24);
      *(_OWORD *)v29 = 0LL;
      *(_QWORD *)(v29 + 16) = 0LL;
  ...
  if ( !a4 || *(_QWORD *)(v52 + 88) == v52 + 88 && (unsigned __int8)FsRtlpOplockUpperLowerCompatible(a4, a6) )
  {
LABEL_14:
...
LABEL_17:
      if ( !a4 )
      {
        ...
        *(_DWORD *)(a3 + 48) = 0;
        IofCompleteRequest((PIRP)a3, 1);
LABEL_19:
        FsRtlpModifyThreadPriorities(v52, (__int64)v17, 0LL);
        FsRtlpClearOwner(v52, (__int64)v17);
...
LABEL_72:
      ...
      {
        v8 = FsRtlpRequestShareableOplock(&v52, v53, a3, a4, a5, v39, 1, v20);
      }
      else
      {
        *(_QWORD *)v52 = a3;
        ...
        *(_QWORD *)(v52 + 16) = CurrentThread->ApcState.Process;
        ...
        *(_BYTE *)(a3 + 69) = KeAcquireQueuedSpinLock(7uLL);
        if ( *(_BYTE *)(a3 + 68) )
        {
          FsRtlpCancelExclusiveIrp(a3, 1, v39 ^ 1);
        }
        else
        {
