/*
 * XREFs of ?ReadPartitionTable@SC_GPT@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x14064FD74
 * Callers:
...
__int64 __fastcall SC_GPT::ReadPartitionTable(SC_DISK **this, struct SC_DISK_LAYOUT **a2)
{
  ...
  __int64 v22; // rdx
  int v23; // ecx
  struct GPT_ENTRY *v24; // [rsp+40h] [rbp+8h] BYREF
  ...
  *a2 = 0LL;
  ...
  do
  {
    ...
    if ( Header >= 0 )
    {
      Header = SC_GPT::ReadEntries((SC_GPT *)this, (struct GPT_HEADER *)v4, &v24);
      if ( Header >= 0 )
        goto LABEL_6;
    }
    ++v6;
...
LABEL_6:
  ...
  *((_QWORD *)v14 + 4) = (*(_QWORD *)(v4 + 48) - *(_QWORD *)(v4 + 40) + 1LL) << *((_DWORD *)*this + 60);
  for ( *((_DWORD *)v14 + 10) = *(_DWORD *)(v4 + 80); v18 < *(_DWORD *)(v4 + 80); ++v18 )
  {
    ...
    if ( v20 && *((_QWORD *)v19 + 4) >= *(_QWORD *)(v4 + 40) && *((_QWORD *)v19 + 5) <= *(_QWORD *)(v4 + 48) )
    {
      v21 = 18 * v17;
      *(_DWORD *)&v14[8 * v21 + 48] = 1;
      *(_QWORD *)&v14[8 * v21 + 56] = *((_QWORD *)v19 + 4) << *((_DWORD *)*this + 60);
      v22 = *((_QWORD *)v19 + 5) - *((_QWORD *)v19 + 4) + 1LL;
      v23 = *((_DWORD *)*this + 60);
      *(_DWORD *)&v14[8 * v21 + 72] = -1;
      *(_QWORD *)&v14[8 * v21 + 64] = v22 << v23;
      v17 = (unsigned int)(v17 + 1);
      *(_OWORD *)&v14[8 * v21 + 80] = *(_OWORD *)v19;
      *(_OWORD *)&v14[8 * v21 + 96] = *((_OWORD *)v19 + 1);
      *(_QWORD *)&v14[8 * v21 + 112] = *((_QWORD *)v19 + 6);
      *(_OWORD *)&v14[8 * v21 + 120] = *(_OWORD *)(v19 + 56);
      *(_OWORD *)&v14[8 * v21 + 136] = *(_OWORD *)(v19 + 72);
      *(_OWORD *)&v14[8 * v21 + 152] = *(_OWORD *)(v19 + 88);
      *(_OWORD *)&v14[8 * v21 + 168] = *(_OWORD *)(v19 + 104);
      *(_QWORD *)&v14[8 * v21 + 184] = *((_QWORD *)v19 + 15);
    }
  }
  *((_DWORD *)v14 + 1) = v17;
