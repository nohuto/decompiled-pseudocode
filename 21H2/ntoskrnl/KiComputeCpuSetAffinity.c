/*
 * XREFs of KiComputeCpuSetAffinity @ 0x140292BA4
 * Callers:
 *     KiComputeThreadAffinity @ 0x140292884 (KiComputeThreadAffinity.c)
 * Callees:
 *     KiCopyGroupMasksToAffinityEx @ 0x140292F10 (KiCopyGroupMasksToAffinityEx.c)
 *     KeIsEmptyAffinityEx @ 0x140292F90 (KeIsEmptyAffinityEx.c)
 *     KiGetSystemAllowedSetsAffinityEx @ 0x140293004 (KiGetSystemAllowedSetsAffinityEx.c)
...
__int64 __fastcall KiComputeCpuSetAffinity(__int64 a1, unsigned __int16 *a2)
{
  ...
  *a2 = 1;
  ...
  {
    v8 = 1;
    KiCopyAffinityEx(v19, HIWORD(v19[0]), v18);
    KiOrAffinityEx(v18, a2, v18, HIWORD(v18[0]));
  }
  else
  {
    v8 = 0;
    KiCopyAffinityEx(v18, HIWORD(v18[0]), a2);
    KiCopyAffinityEx(v19, HIWORD(v19[0]), a2);
  }
...
LABEL_14:
    ...
    KiCopyAffinityEx(v17, HIWORD(v17[0]), v11);
  }
  if ( !(unsigned int)KiAndAffinityEx(v17, v18, v17, HIWORD(v17[0])) )
    KiCopyAffinityEx(v17, HIWORD(v17[0]), v18);
  KiCopyGroupMasksToAffinityEx(a2, KiNonParkedCpuSets, v4);
  if ( (unsigned int)KiAndAffinityEx(v17, a2, a2, a2[1]) )
    KiCopyAffinityEx(v17, HIWORD(v17[0]), a2);
