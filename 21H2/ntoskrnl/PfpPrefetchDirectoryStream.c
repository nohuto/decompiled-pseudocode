/*
 * XREFs of PfpPrefetchDirectoryStream @ 0x1406AEA14
 * Callers:
...
__int64 PfpPrefetchDirectoryStream(_QWORD *a1, __int64 a2, __int64 a3, ...)
{
  ...
  *Src = 4;
  ...
  LODWORD(v7) = v33;
  *((_QWORD *)Src + 1) = v11;
  v12 = PfpOpenHandleCreate((unsigned int)v27, v3, *(_QWORD *)(v10 + 16), *(_QWORD *)(v10 + 8), 1048577, v7, 0, a2);
  if ( v12 >= 0 )
  {
    if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
      MmQueryMemoryListInformation((ULONG_PTR **)0xFFFFFFFFFFFFFFFFLL, (_OWORD *)a1 + 3, 0xB0u, v13, (__int64 *)va);
    v14 = 0;
...
LABEL_14:
      ...
      v12 = IopXxxControlFile(v27[0], (__int64)v26, 590112, Src, Size, 0LL, Length, 0);
      if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
