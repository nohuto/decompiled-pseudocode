/*
 * XREFs of MiInitializeNewPfns @ 0x1403B790C
 * Callers:
...
char __fastcall MiInitializeNewPfns(
        __m128i *a1,
        unsigned __int64 a2,
        const __m128i *a3,
        unsigned __int16 a4,
        ...
        unsigned __int64 *a7)
{
  ...
  if ( (a5 & 2) != 0 )
  {
    v16 = MiSwizzleInvalidPte(16 * ((a6 << 12) | *(_WORD *)(a6 + 32) & 0x3E | 0x40));
    v32 = v16;
    a5 = a3[2].m128i_i8[2] & 7;
    if ( a5 == 2 && (unsigned int)MiDetermineNewPfnHeatState(0, 1u) )
    {
      MiSetNonResidentPteHeat((unsigned __int64 *)&v32, 1);
      v16 = v32;
    }
    v18 = a7;
    ...
    v20 = (*v17 >> 1) & 0x1F;
    ContainingPageTable = MiGetContainingPageTable((unsigned __int64)v18);
    v22 = 48 * ContainingPageTable - 0x220000000000LL;
    v23 = a5 == 6;
    a3[2].m128i_i64[1] = v19 ^ (ContainingPageTable ^ v19) & 0xFFFFFFFFFFLL;
    if ( v23 )
      ValidPte = MiMakeValidPte((unsigned __int64)v18, v10, v20);
    else
      ValidPte = MiMakeTransitionPte(v10, v20);
    ...
    {
      do
        KeYieldProcessorEx(&v33, m128i_i64, v25, v26);
