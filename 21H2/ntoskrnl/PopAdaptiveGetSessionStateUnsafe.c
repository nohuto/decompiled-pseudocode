/*
 * XREFs of PopAdaptiveGetSessionStateUnsafe @ 0x1407EF190
 * Callers:
...
char __fastcall PopAdaptiveGetSessionStateUnsafe(__int64 a1, __int64 a2, int *a3)
{
  int v5; // ebx
  __int64 v6; // rax
  REGHANDLE v7; // rbx
  ...
  if ( dword_140C1F3B8 != (_DWORD)a1 || (_DWORD)a1 == -1 )
    PopAdaptiveGetRemoteSessionState(a1, a2, a3, &v10);
  else
    PopAdaptiveGetConsoleSessionState(a1, a2, a3, &v10);
  v15 = v10;
  v13 = a3[1];
  v12 = *a3;
  v17 = *(_QWORD *)(a2 + 24);
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( (_BYTE)v6 )
    {
      ...
      v20 = 8;
      v23 = 8;
      LOBYTE(v6) = EtwWrite(v7, &POP_ETW_EVENT_ADAPTIVE_SESSION_STATE, 0LL, 8u, &UserData);
    }
  }
  return v6;
}
