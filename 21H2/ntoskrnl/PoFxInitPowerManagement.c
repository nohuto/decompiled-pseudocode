/*
 * XREFs of PoFxInitPowerManagement @ 0x140A6E6E0
 * Callers:
...
__int64 PoFxInitPowerManagement()
{
  ...
  stru_140C24A40.Header.Size = 6;
  *(_QWORD *)&PopFxResidentTimer.Header.Lock = 9LL;
  qword_140C24818 = (__int64)&PopFxDeviceList;
  PopFxDeviceList = (ULONG_PTR)&PopFxDeviceList;
  qword_140C24808 = (__int64)&PopFxAcpiDeviceList;
  PopFxAcpiDeviceList = (__int64)&PopFxAcpiDeviceList;
  qword_140C24A08 = (__int64)&PopWorkOrderList;
  PopWorkOrderList = (__int64)&PopWorkOrderList;
  qword_140C24A90 = (__int64)PopFxResidentTimeoutRoutine;
  qword_140C24A30 = (__int64)&qword_140C24A28;
  qword_140C24A28 = (__int64)&qword_140C24A28;
  stru_140C24A40.Header.WaitListHead.Blink = &stru_140C24A40.Header.WaitListHead;
  stru_140C24A40.Header.WaitListHead.Flink = &stru_140C24A40.Header.WaitListHead;
  ...
  qword_140C247E8 = (__int64)&PopFxPluginList;
  ...
  LOWORD(stru_140C24A40.Header.Lock) = 0;
  stru_140C24A40.Header.SignalState = 1;
  ...
  memset(&byte_140C24841, 0, 0x6FuLL);
  ...
  qword_140C24A68 = (__int64)&SocSubsystemsList;
  ...
  *(_QWORD *)&PopPepIdleTimer.Header.Lock = 9LL;
  qword_140C21788 = (__int64)&PopPepDeviceList;
  PopPepDeviceList = (__int64)&PopPepDeviceList;
  qword_140C21710 = (__int64)PopPepIdleTimeoutRoutine;
