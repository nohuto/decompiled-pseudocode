...
__int64 PoFxInitPowerManagement()
{
  ...
  stru_140C247E0.Header.Size = 6;
  *(_QWORD *)&PopFxResidentTimer.Header.Lock = 9LL;
  qword_140C24898 = (__int64)&PopFxDeviceList;
  PopFxDeviceList = (ULONG_PTR)&PopFxDeviceList;
  qword_140C248A8 = (__int64)&PopFxAcpiDeviceList;
  PopFxAcpiDeviceList = (__int64)&PopFxAcpiDeviceList;
  qword_140C248C8 = (__int64)&PopWorkOrderList;
  PopWorkOrderList = (__int64)&PopWorkOrderList;
  qword_140C24870 = (__int64)PopFxResidentTimeoutRoutine;
  qword_140C247D0 = (__int64)&qword_140C247C8;
  qword_140C247C8 = (__int64)&qword_140C247C8;
  stru_140C247E0.Header.WaitListHead.Blink = &stru_140C247E0.Header.WaitListHead;
  stru_140C247E0.Header.WaitListHead.Flink = &stru_140C247E0.Header.WaitListHead;
  ...
  qword_140C247B8 = (__int64)&PopFxPluginList;
  ...
  LOWORD(stru_140C247E0.Header.Lock) = 0;
  stru_140C247E0.Header.SignalState = 1;
  ...
  memset(&byte_140C248E1, 0, 0x6FuLL);
  ...
  qword_140C24808 = (__int64)&SocSubsystemsList;
  ...
  *(_QWORD *)&PopPepIdleTimer.Header.Lock = 9LL;
  qword_140C21728 = (__int64)&PopPepDeviceList;
  PopPepDeviceList = (__int64)&PopPepDeviceList;
  qword_140C21670 = (__int64)PopPepIdleTimeoutRoutine;
