...
LABEL_20:
  ...
  if ( (v17 & a5 & 0xFDFFFFFF) != (a5 & 0xFDFFFFFF) )
  {
    ...
    *v12 = -1073741790;
    if ( v84 )
    {
      ...
      SeLogAccessFailure(v85, 0LL, 0LL, TokenTrustLevel, v13, v86, 0, 0);
    }
    if ( v127 )
      return 0;
    goto LABEL_155;
  ...
  *v12 = 0;
  ...
  if ( (a2 & 4) == 0 )
  {
    v25 = SepFilterCheck(v13, (unsigned int)&P, v24, 0, (__int64)&v153);
    v26 = v136;
    *v136 = v25;
    if ( v25 < 0 )
      goto LABEL_183;
    ...
    *v26 = -1073741790;
    if ( v84 )
      SeLogAccessFailure(v24, 0LL, 0LL, 0LL, v13, v132 | a5, 0, 0);
    if ( v127 )
      return 0;
LABEL_155:
...
LABEL_29:
  ...
  if ( !v27 )
  {
    v29 = SepMandatoryIntegrityCheck(v152, v13, v19, v24, 0, a12, (__int64)&v151);
    v30 = v136;
    *v136 = v29;
    if ( v29 < 0 )
      goto LABEL_183;
    ...
    {
      *v30 = -1073741790;
      if ( (*(_DWORD *)(v24 + 200) & 0x4000) == 0 || HIDWORD(v151) > 0x2000 )
      {
        if ( v127 )
          return 0;
        goto LABEL_155;
    ...
    {
      *v30 = 0;
      if ( (a5 & 0x2000000) == 0 || (*(_DWORD *)(v24 + 200) & 0x4000) == 0 || HIDWORD(v151) > 0x2000 )
      {
LABEL_36:
        v28 = a12;
        goto LABEL_37;
...
LABEL_70:
  ...
  v50 = v132;
LABEL_71:
  if ( !v14 && !v31 && ((*(_DWORD *)(v24 + 200) & 0x2000) != 0 || !v48) )
  {
    if ( !v127 )
...
LABEL_166:
  ...
  if ( v24 )
  {
    if ( ((_BYTE)v56
       || v61
       || !HIDWORD(v158[0]) && (*(_DWORD *)(v24 + 200) & 0x4000) != 0 && (*v59 < 0 || BYTE7(v158[1])))
      && !v145 )
    {
      v77 = *v59 >= 0;
      v78 = v132 | v14;
      v79 = SepLocateTokenTrustLevel(v52);
      SeLogAccessFailure(v24, 0LL, 0LL, v79, v13, v78, v77, 0);
      v57 = v137;
      v59 = v136;
    }
    if ( *v59 < 0 && !HIDWORD(v158[0]) && (*(_DWORD *)(v24 + 200) & 0x4000) != 0 )
    {
      if ( BYTE8(v158[1]) )
      {
