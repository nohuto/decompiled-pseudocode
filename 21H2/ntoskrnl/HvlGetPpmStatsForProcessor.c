/*
 * XREFs of HvlGetPpmStatsForProcessor @ 0x14039AEA4
 * Callers:
...
__int64 __fastcall HvlGetPpmStatsForProcessor(struct _KPRCB *a1, _QWORD *a2, _QWORD *a3)
{
  ...
  if ( a1 == KeGetCurrentPrcb() )
  {
    ...
    do
    {
      ...
      *a3 = a1->StatisticsPage[(unsigned int)xmmword_140CF70A0];
    }
  ...
  else
  {
    ...
    *a2 = ReferenceTime - a1->StatisticsPage[DWORD1(xmmword_140CF7090)];
