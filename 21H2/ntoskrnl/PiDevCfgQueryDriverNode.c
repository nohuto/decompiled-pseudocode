/*
 * XREFs of PiDevCfgQueryDriverNode @ 0x140746270
 * Callers:
...
__int64 __fastcall PiDevCfgQueryDriverNode(PCWSTR SourceString, PCWSTR a2, int a3, int a4, char a5, __int64 *a6)
{
  ...
  *(_QWORD *)&v36.Length = 0LL;
  ...
  v30 = 0LL;
  v29 = 0LL;
  DriverPackageId = PiDevCfgGetDriverPackageId((int)SourceString, (__int64)&UnicodeString);
...
LABEL_77:
  ...
  else
  {
    ...
    v39[3] = v12 + 88;
    LODWORD(v39[1]) = 288;
    DriverPackageId = RtlpQueryRegistryValues(3221225472LL, v30, v39, 0LL);
    if ( DriverPackageId < 0 )
      goto LABEL_65;
  ...
  if ( v19 )
  {
    ...
    if ( v20 != -1073741772 )
    {
      if ( v20 >= 0 )
      {
        ...
        v39[17] = v12 + 160;
        LODWORD(v39[15]) = 304;
        DriverPackageId = RtlpQueryRegistryValues(3221225472LL, v29, v39, 0LL);
        if ( DriverPackageId >= 0 )
        {
