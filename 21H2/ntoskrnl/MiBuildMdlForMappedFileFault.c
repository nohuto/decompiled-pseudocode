/*
 * XREFs of MiBuildMdlForMappedFileFault @ 0x140313DE0
 * Callers:
        ...
        __int64 a10)
{
  ...
  v79 = *(_QWORD *)(a1 + 232);
  v70 = a1;
  BitMapHeader.Buffer = (unsigned int *)v89;
  v72 = a4;
  v71 = a2;
  *(_QWORD *)&BitMapHeader.SizeOfBitMap = 512LL;
  ...
  {
    MiSetPfnBlink(48 * a6 - 0x220000000000LL, 0x3FFFFFFFFFLL, 0);
  ...
  else
  {
    ...
    v18 = v76;
    MiGetHardFaultPages((unsigned int)&v67, v15, v72, v76, a9, v70, v17, a10);
    v16 = v68;
  }
  if ( v16 == v13 )
    goto LABEL_26;
        ...
        while ( 1 )
        {
          ...
          *(_QWORD *)(v42 + 16) = v45;
            ...
            && ((v48 & 0x20) == 0 || (v48 & 0x42) == 0) )
          {
            ...
            if ( Flink )
            {
              v51 = *((_QWORD *)&Flink->Flink + ((v46 >> 3) & 0x1FF));
              v46 = v48 | 0x20;
              if ( (v51 & 0x20) == 0 )
                v46 = v48;
              v48 = v46;
          ...
          {
            do
              KeYieldProcessorEx(&v74, v46, v49, v47);
          ...
          *(_BYTE *)(v42 + 34) = v61 | 2;
          if ( *(unsigned __int8 *)(v42 + 34) >> 6 != v36 )
            MiChangePageAttribute(v42, v36, 1);
