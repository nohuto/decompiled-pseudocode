/*
 * XREFs of MiBuildMdlForMappedFileFault @ 0x14023DDD0
 * Callers:
        ...
        __int64 a10)
{
  ...
  RTL_BITMAP BitMapHeader; // [rsp+B0h] [rbp-50h] BYREF
...
LABEL_86:
    ...
    while ( 1 )
    {
      ...
      {
        v34 = v26 & 0x1F;
        if ( (*v33 | *((_DWORD *)qword_140011C70 + v34)) == 0xFFFFFFFF )
        {
          ++v33;
          v30 = v26 - v34 + 32;
          v54 = v30;
      ...
      if ( v33 == v32 )
        goto LABEL_47;
      if ( (~*((_DWORD *)qword_140011C70 + (v30 & 0x1F)) & *v33) != 0 )
        goto LABEL_46;
      v31 = 32 - (v30 & 0x1F);
      if ( v31 != -1 )
        break;
