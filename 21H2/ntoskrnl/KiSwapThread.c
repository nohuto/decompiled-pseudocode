/*
 * XREFs of KiSwapThread @ 0x1402B3140
 * Callers:
 ...
 *     KiUpdateVpBackingRequiresPriorityKickState @ 0x140210CCC (KiUpdateVpBackingRequiresPriorityKickState.c)
 ...
 *     KiEndCounterAccumulation @ 0x140571910 (KiEndCounterAccumulation.c)
...
LABEL_18:
    ...
    if ( KiHgsPlusEnabled )
      KiUpdateThreadHgsFeedback(a2, a1, v6, 1LL);
    v5 = *(_QWORD *)(a2 + 33200);
    if ( v5 )
    {
      if ( *(_BYTE *)(a1 + 125) )
      {
        ...
        if ( v122 < 6 )
        {
          ...
          if ( v124 <= *(_DWORD *)(a1 + 84) )
            v124 = *(_DWORD *)(a1 + 84);
          LOBYTE(v123) = v124 >= KiDynamicHeteroCpuPolicyExpectedCycles;
          v125 = *(unsigned __int8 *)(a1 + 516) + (unsigned int)KiHgsPlusConfiguration * (v123 + 2 * v122);
          *(_QWORD *)(v5 + 8 * v125) += v6;
        }
      }
    }
...
LABEL_235:
  ...
  {
    v104 = CurrentPrcb->SchedulerAssist;
    if ( v104 )
    {
      if ( CurrentPrcb->NestingLevel <= 1u )
      {
  ...
  if ( v33 )
  {
    ...
    if ( v96 )
    {
      while ( 1 )
      {
        ...
        {
          if ( KiCheckMaxOverQuotaTransition(v96, v34) )
          {
            if ( (*(_BYTE *)(v96 + 112) & 1) != 0 )
              KiRemoveSchedulingGroupQueue(a2, v96, 1);
          }
          else if ( *(_QWORD *)v96 >= *(_QWORD *)(v96 + 24) && (*(_BYTE *)(v96 + 112) & 2) == 0 )
          {
            KiRecomputeGroupSchedulingRank(v34, v96, a2);
          }
        }
        else
        {
          KiComputeGroupSchedulingRank(v34, a2, v96);
        }
        v9 += *(_DWORD *)(v96 + 116);
        v96 = *(_QWORD *)(v96 + 408);
        if ( !v96 )
...
LABEL_126:
  ...
  while ( 1 )
  {
    ...
    if ( !ready )
    {
      ...
      if ( KiPerfIsoEnabled )
      {
        ...
        if ( (unsigned int)((0x101010101010101LL
                           * (((v129 & 0x3333333333333333LL)
                             ...
                             + (((v129 & 0x3333333333333333LL) + ((v129 >> 2) & 0x3333333333333333LL)) >> 4)) & 0xF0F0F0F0F0F0F0FLL)) >> 32) >> 24 < KiPerfIsoEnabled )
          break;
        v130 = *(_QWORD *)(a2 + 200);
        ...
        if ( v130 != v131 )
        {
          ...
          if ( (*(_QWORD *)(*(_QWORD *)(a2 + 192) + 40LL) & v132) == 0 )
          {
            ...
            v134 = (unsigned int)KiProcessorNumberToIndexMappingTable[64 * *(unsigned __int8 *)(a2 + 208) + (int)v133];
            v174 = v134;
            if ( (*(_DWORD *)(KiProcessorBlock[v134] + 236) & 0x400) == 0 )
              break;
          }
        }
      }
      ...
      {
        v118 = v48 - 88;
        ready = KiSelectThreadFromSchedulingGroup(a2, v48 - 88, 0);
        if ( ready )
          break;
...
LABEL_41:
    if ( *(_QWORD *)(ready + 568) == KiCpuSetSequence || (*(_DWORD *)(ready + 116) & 8) != 0 )
    {
      ...
      if ( (*(_BYTE *)(ready + 2) & 4) != 0
        && *(char *)(ready + 195) < 16
        && *(_QWORD *)(ready + 104)
        && (v98 = *(_QWORD *)(ready + 104)) != 0
        && (v99 = *(unsigned int *)(a2 + 216) + v98) != 0
        && (unsigned int)KiGetThreadEffectiveRankNonZero(ready, v99, v36, 0, 0LL) )
      {
        v38 = 1;
      }
      else
      ...
      v39 = v38 & 0x7F | (*(_BYTE *)(ready + 119) << 7);
      *v37 = v39;
      v40 = *(_QWORD *)(a2 + 35000);
      if ( v40 )
      {
        if ( ready == *(_QWORD *)(a2 + 24) )
          ...
          v143 = v39 & 0x7F;
        KiSetSchedulerAssistPriority(v40, v143, 0LL);
      }
      v5 = *(_QWORD *)(a2 + 56);
      if ( KeHeteroSystem )
      {
        v144 = *(_DWORD *)(ready + 80);
        v145 = (*(_BYTE *)(v5 + 64) ^ *(_BYTE *)(ready + 512)) & 7 ^ *(_BYTE *)(v5 + 64);
        v146 = (v145 ^ (8 * *(_BYTE *)(ready + 516))) & 0x38 ^ v145;
        if ( v144 <= *(_DWORD *)(ready + 84) )
          v144 = *(_DWORD *)(ready + 84);
        v147 = 64;
        if ( v144 < KiDynamicHeteroCpuPolicyExpectedCycles )
          v147 = 0;
...
LABEL_284:
    ...
    v116 = (_QWORD *)(ready + 216);
    v180 = 0LL;
    *v116 = 0LL;
    do
    {
      KiDeferredReadySingleThread(a2, v116 - 27, &v180);
      v116 = v180;
      LOBYTE(v9) = v9 + 1;
      if ( v180 )
        v180 = (_QWORD *)*v180;
    ...
    while ( 1 )
    {
      KiSetVpThreadSpinLockCount((__int64)v117, 1);
      if ( !_interlockedbittestandset64((volatile signed __int32 *)(a2 + 48), 0LL) )
        break;
      KiSetVpThreadSpinLockCount((__int64)v117, 0);
      do
...
LABEL_66:
  ...
  *(_BYTE *)(a2 + 13243) = 0;
  ...
  if ( (*(_BYTE *)(v59 + 2) & 4) != 0
    ...
    && (unsigned int)KiGetThreadEffectiveRankNonZero(v59, v101, v36, 0, 0LL) )
  {
    v61 = 1;
  }
  else
  ...
  *v60 = v62;
  ...
  if ( v63 )
  {
    if ( v59 == *(_QWORD *)(a2 + 24) )
      ...
      v137 = v62 & 0x7F;
    KiSetSchedulerAssistPriority(v63, v137, 0LL);
  }
  v64 = *(_QWORD *)(a2 + 56);
  if ( KeHeteroSystem )
  {
    ...
    if ( v138 <= *(_DWORD *)(v59 + 84) )
      v138 = *(_DWORD *)(v59 + 84);
    v141 = 64;
    if ( v138 < KiDynamicHeteroCpuPolicyExpectedCycles )
      v141 = 0;
  ...
  if ( (v65 & 2) != 0 )
  {
    KiSetVpThreadSpinLockCount((__int64)v66, 0);
    if ( v52 )
      goto LABEL_86;
LABEL_104:
    ...
    while ( 1 )
    {
      KiSetVpThreadSpinLockCount((__int64)v85, 1);
      if ( !_interlockedbittestandset64((volatile signed __int32 *)(a2 + 48), 0LL) )
        break;
      KiSetVpThreadSpinLockCount((__int64)v85, 0);
      do
    ...
    if ( !ready )
    {
      ...
      while ( 1 )
      {
        KiSetVpThreadSpinLockCount((__int64)v148, 1);
        if ( !_interlockedbittestandset64((volatile signed __int32 *)(a2 + 48), 0LL) )
          break;
        KiSetVpThreadSpinLockCount((__int64)v148, 0);
        do
...
LABEL_108:
    ...
    if ( (*(_BYTE *)(ready + 2) & 4) != 0
      && *(char *)(ready + 195) < 16
      && *(_QWORD *)(ready + 104)
      && (v102 = *(_QWORD *)(ready + 104)) != 0
      && (v103 = *(unsigned int *)(a2 + 216) + v102) != 0
      && (unsigned int)KiGetThreadEffectiveRankNonZero(ready, v103, v86, 0, 0LL) )
    {
      v88 = 1;
    }
    else
    ...
    v89 = v88 & 0x7F | (*(_BYTE *)(ready + 119) << 7);
    *v87 = v89;
    v90 = *(_QWORD *)(a2 + 35000);
    if ( v90 )
    {
      if ( ready == *(_QWORD *)(a2 + 24) )
        v149 = (unsigned int)KiVpThreadSystemWorkPriority;
      else
        v149 = v89 & 0x7F;
      KiSetSchedulerAssistPriority(v90, v149, 0LL);
    }
    v5 = *(_QWORD *)(a2 + 56);
    if ( KeHeteroSystem )
    {
      v150 = *(_DWORD *)(ready + 80);
      v151 = (*(_BYTE *)(v5 + 64) ^ *(_BYTE *)(ready + 512)) & 7 ^ *(_BYTE *)(v5 + 64);
      v152 = (v151 ^ (8 * *(_BYTE *)(ready + 516))) & 0x38 ^ v151;
      if ( v150 <= *(_DWORD *)(ready + 84) )
        v150 = *(_DWORD *)(ready + 84);
      v153 = 64;
      if ( v150 < KiDynamicHeteroCpuPolicyExpectedCycles )
        v153 = 0;
...
LABEL_86:
  ...
  while ( 1 )
  {
    if ( !v73 && !v70 )
    {
      ...
      v171 = 0;
      v172 = KeNodeBlock[*(unsigned __int16 *)(v67 + 138)];
      v83 = *(_DWORD *)(v172 + 16);
      while ( 1 )
      {
        while ( !v83 )
        {
          v84 = v171 + 1;
          v171 = v84;
          if ( v84 == (unsigned __int16)KeNumberNodes )
            goto LABEL_104;
          v93 = *(unsigned int *)(qword_140C506D8 + 4LL * ((unsigned int)(unsigned __int16)KeNumberNodes * v170 + v84));
          if ( (_DWORD)v93 == -1 )
            goto LABEL_104;
          v172 = KeNodeBlock[v93];
          v83 = *(_DWORD *)(v172 + 16);
        }
        ...
        {
          v142 = KiSearchForNewThreadOnSubNode(a2);
          v5 = 0x140000000uLL;
          ready = v142;
          if ( v142 )
            goto LABEL_49;
...
LABEL_95:
    if ( (v73 & v69) != 0 )
    {
      ...
      do
      {
        ...
        ready = KiSearchForNewThreadOnProcessor(
                  a2,
                  KiProcessorBlock[KiProcessorNumberToIndexMappingTable[v81 + (((_BYTE)v82 + v68) & 0x3F)]],
                  0LL);
        if ( ready )
          goto LABEL_49;
        v81 = v169;
  ...
  while ( 1 )
  {
    ...
    v77 = KiProcessorBlock[KiProcessorNumberToIndexMappingTable[v75 + ((v68 + (_BYTE)v76) & 0x3F)]];
    v78 = *(_QWORD *)(v77 + 34880);
    v79 = *(_QWORD *)(v77 + 34888);
    v181 = ~v78 & v70;
    v74 &= __ROR8__(~v78, v68);
    ready = KiSearchForNewThreadOnProcessor(a2, 0LL, v79);
    if ( ready )
      break;
    v70 = v181;
    v75 = v168;
...
LABEL_49:
  if ( ready != *(_QWORD *)(a2 + 24) && ready != a1 && *(_BYTE *)(ready + 113) )
  {
    ...
    if ( (*(_BYTE *)(ready + 2) & 4) != 0
      && *(char *)(ready + 195) < 16
      && *(_QWORD *)(ready + 104)
      && (v119 = *(_QWORD *)(ready + 104)) != 0
      && (v120 = *(unsigned int *)(a2 + 216) + v119) != 0
      && (unsigned int)KiGetThreadEffectiveRankNonZero(ready, v120, v5, 0, 0LL) )
    {
      v107 = 1;
    }
    else
    {
      v107 = *(_BYTE *)(ready + 195);
    }
    v108 = v107 & 0x7F | (*(_BYTE *)(ready + 119) << 7);
    *v106 = v108;
    v109 = *(_QWORD *)(a2 + 35000);
    if ( v109 )
    {
      if ( ready == *(_QWORD *)(a2 + 24) )
        v154 = (unsigned int)KiVpThreadSystemWorkPriority;
      else
        v154 = v108 & 0x7F;
      KiSetSchedulerAssistPriority(v109, v154, 0LL);
    }
    v110 = *(_QWORD *)(a2 + 56);
    if ( KeHeteroSystem )
    {
      v155 = *(_DWORD *)(ready + 80);
      v156 = (*(_BYTE *)(v110 + 64) ^ *(_BYTE *)(ready + 512)) & 7 ^ *(_BYTE *)(v110 + 64);
      v157 = (v156 ^ (8 * *(_BYTE *)(ready + 516))) & 0x38 ^ v156;
      if ( v155 <= *(_DWORD *)(ready + 84) )
        v155 = *(_DWORD *)(ready + 84);
      v158 = 64;
      if ( v155 < KiDynamicHeteroCpuPolicyExpectedCycles )
        v158 = 0;
  ...
  if ( a1 == ready )
  {
    v44 = *(_BYTE *)(ready + 193) && !*(_WORD *)(ready + 486) && !(_BYTE)v41;
    _disable();
  ...
  else
  {
    ...
    if ( *(_BYTE *)(a1 + 793) )
    {
      ...
      while ( 1 )
      {
        KiSetVpThreadSpinLockCount((__int64)v159, 1);
        if ( !_interlockedbittestandset64((volatile signed __int32 *)(a1 + 64), 0LL) )
          break;
        KiSetVpThreadSpinLockCount((__int64)v159, 0);
        do
      ...
      if ( (*(_DWORD *)(a1 + 120) & 0x400000) != 0 && *(_BYTE *)(a1 + 388) == 5 )
      {
        KiUpdateVpBackingRequiresPriorityKickState(a1, 1);
        KiUpdateVPBackingThreadPriority(v160);
        v42 = 1;
      }
      KiReleaseThreadLockSafe(a1);
LABEL_54:
      v44 = KiSwapContext(a1, ready, (unsigned __int8)v41);
  ...
  {
    LOBYTE(v43) = 1;
    if ( !(unsigned __int8)KiCancelTimer(a1 + 256, v43) )
    {
      *(_BYTE *)(a1 + 481) = 4;
