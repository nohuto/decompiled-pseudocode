/*
 * XREFs of MiRemoveLargeFreeLoaderDescriptors @ 0x140B2920C
 * Callers:
...
LABEL_8:
      ...
      if ( (v19 == 2 || v19 == 24) && v7 )
      {
        do
        {
          v20 = MiRestrictRangeToNode(v8, v7);
          v21 = *((unsigned int *)MiSearchNumaNodeTable(v8) + 2);
          qword_140D69AF0[3 * v21] += v20;
          if ( v20 >= 0x200000 && v20 > qword_140D69AE8[3 * v21] )
          {
            MxBootDeferDescriptors[3 * v21] = v8;
            v12 = -1LL;
...
LABEL_20:
  ...
  do
  {
    ...
    v26 = v25 - 0x100000;
    v27 = *(_QWORD *)v11;
    v28 = MxBootDeferDescriptors[3 * v9];
...
LABEL_76:
    ...
    LODWORD(qword_140D6C0F8[v32]) = *(_DWORD *)(v29 + 24);
    v35 = v33 - v34;
    ...
    if ( v34 == v36 )
    {
      if ( v33 == v38 )
      {
        RtlRbRemoveNode((unsigned __int64 *)v11, v29);
        goto LABEL_22;
      }
...
LABEL_85:
    ...
    else
    {
      ...
      *((_DWORD *)v39 + 6) = *(_DWORD *)(v29 + 24);
      ...
      v40 = *(_QWORD *)(v29 + 32) - v34;
      *(_QWORD *)(v29 + 32) = v33;
      *(_QWORD *)(v29 + 40) += v40 - v35;
      v41 = *(_QWORD *)v11;
      if ( (*(_BYTE *)(v11 + 8) & 1) != 0 )
      {
        if ( v41 )
...
LABEL_97:
      ...
      RtlRbInsertNodeEx((unsigned __int64 *)v11, v41, v42, (unsigned __int64)&MxDeferredBootSplitDescriptor[v32]);
    }
LABEL_22:
    ++v9;
  }
