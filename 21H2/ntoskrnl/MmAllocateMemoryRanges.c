...
__int64 __fastcall MmAllocateMemoryRanges(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( *(_QWORD *)(BugCheckParameter2 + 24) != 0x40000000LL )
    return 3221225485LL;
  v6 = (v3 >> 1) & 1;
  v7 = MiPartitionObjectToPartition(*(ULONG_PTR ***)(BugCheckParameter2 + 8), 0LL, &v17);
  v20 = v7;
  if ( !v7 )
    return 3221225485LL;
  v19 = 0;
  ...
  while ( 1 )
  {
    ...
    v12 = HugeRangeFromNode;
    if ( (*(_QWORD *)&HugeRangeFromNode & 0x3FFFFFLL) != 0 )
      break;
    LODWORD(v18) = v18 - 1;
    if ( !(_DWORD)v18 )
    {
...
LABEL_20:
  ...
  v8 = MiAddRun(BugCheckParameter2, (__int64 *)&v14, HugeRangeFromNode);
  if ( v8 >= 0 )
    goto LABEL_20;
  v16[1] = 0LL;
  v16[0] = 1LL;
  ...
  v16[2] = (__int64)&v18;
  MiReleaseMemoryRuns(BugCheckParameter2, v16, 0);
LABEL_25:
  if ( (*(_DWORD *)(BugCheckParameter2 + 4) & 4) == 0 )
  {
    MiReleaseMemoryRuns(BugCheckParameter2, (__int64 *)&v14, 0);
LABEL_29:
    v7 = v20;
    goto LABEL_30;
  }
