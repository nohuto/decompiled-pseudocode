/*
 * XREFs of ExpLimitDpcInsertEntry @ 0x14063B3D4
 * Callers:
        ...
        if ( v2 )
        {
          ...
          *(_QWORD *)(v1 + 24 * v17 + 32) = v22 != 0;
          for ( result = (unsigned int)KeNumberProcessors_0;
                (unsigned int)v24 < (unsigned int)KeNumberProcessors_0;
                v24 = (unsigned int)(v24 + 1) )
          {
            v25 = (char *)*(&ExPoolTagTables + v24) + 80 * (unsigned int)v6;
            if ( *(_DWORD *)v25 )
            {
              if ( !*((_QWORD *)v25 + 9) )
...
LABEL_47:
            ...
            if ( result )
            {
              if ( result < *(__int64 *)((char *)v18 + v19 + 24) )
                result = ExpTrackRaiseLimitNotification(v1);
            }
          }
        }
  ...
  while ( 1 )
  {
    if ( !*((_DWORD *)PoolTrackTableExpansion + 20 * v10) )
      goto LABEL_22;
    if ( *((_DWORD *)PoolTrackTableExpansion + 20 * v10) == *(_DWORD *)(v1 + 8) )
      break;
    v10 = ++v9;
    if ( v9 >= (unsigned __int64)PoolTrackTableExpansionSize )
      goto LABEL_22;
  }
  v11 = 10 * v10;
  v12 = 0LL;
  *((_QWORD *)PoolTrackTableExpansion + 10 * v10 + 9) = v1;
  do
  {
    v13 = 3 * v12;
    *(_QWORD *)(v1 + 8 * v13 + 16) = a1[3 * v12 + 1];
    v14 = a1[3 * v12 + 2];
    v15 = PoolTrackTableExpansion;
