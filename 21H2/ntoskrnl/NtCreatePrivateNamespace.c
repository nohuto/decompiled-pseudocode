/*
 * XREFs of NtCreatePrivateNamespace @ 0x1406C08F0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      else
      {
        ...
        v12 = ObCreateObjectEx((_DWORD)p_Object, (_DWORD)ObpDirectoryObjectType, a3, PreviousMode);
        if ( v12 >= 0 )
        {
          v13 = Object;
          ...
          *((_DWORD *)v13 + 84) = 1;
          ...
          else
          {
            ...
            if ( inserted >= 0 )
            {
              ...
              inserted = ObInsertObjectEx(v13, 0LL, 0, 0LL, (__int64)&v26);
