 ...
 *     PpmIdleUpdateSynchronizationState @ 0x1405C86A4 (PpmIdleUpdateSynchronizationState.c)
 */
  ...
  while ( (_BYTE)v7 != 1 && ((unsigned __int8)(v7 - 1) <= 5u || (unsigned __int8)v7 >= 9u) )
  {
    ...
    else if ( (((_BYTE)v7 - 4) & 0xFD) != 0 )
    {
      if ( (_BYTE)v7 == 5 )
      {
        ...
        if ( (_BYTE)v7 == 5 )
        {
          ...
          KiCopyAffinityEx((__int64)v15, 0x20u, (unsigned __int16 *)(v5 + 72));
    ...
    else
    {
      ...
      if ( updated == v11 )
      {
        ...
        while ( !(*(unsigned __int8 (__fastcall **)(__int64))(v5 + 664))(v9) )
        {
          if ( HIBYTE(*v6) != 8 )
            return v8;
        ...
        return (*(__int64 (__fastcall **)(__int64))(v5 + 672))(v9);
      }
      LOBYTE(v7) = updated;
    }
    _mm_pause();
