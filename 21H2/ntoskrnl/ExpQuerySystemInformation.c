/*
 * XREFs of ExpQuerySystemInformation @ 0x140651070
 * Callers:
 ...
 *     KeQueryCycleTimeStatsProcessor @ 0x1402BD530 (KeQueryCycleTimeStatsProcessor.c)
 ...
 *     MmGetLowestPhysicalPage @ 0x1402D3C5C (MmGetLowestPhysicalPage.c)
 ...
 *     KeIsCetCapable @ 0x1403F2D10 (KeIsCetCapable.c)
 *     ZwFilterBootOption @ 0x1403FC020 (ZwFilterBootOption.c)
 *     _guard_dispatch_icall @ 0x1404085B0 (_guard_dispatch_icall.c)
 *     memmove @ 0x140413F40 (memmove.c)
 *     memset @ 0x140414200 (memset.c)
 *     HvlQueryActiveProcessors @ 0x1404F2210 (HvlQueryActiveProcessors.c)
 *     HvlQueryProcessorTopologyCount @ 0x1404F2410 (HvlQueryProcessorTopologyCount.c)
 ...
 *     IoQueryLowPriorityIoInformation @ 0x1406BE398 (IoQueryLowPriorityIoInformation.c)
 ...
 *     HvlQueryEnlightenmentInfo @ 0x1407D2EBC (HvlQueryEnlightenmentInfo.c)
 ...
 *     ExpGetSystemProcessorFeaturesInformation @ 0x14094A594 (ExpGetSystemProcessorFeaturesInformation.c)
 ...
 *     VfGetVerifierInformationEx @ 0x1409ECB7C (VfGetVerifierInformationEx.c)
        ...
        unsigned int *a6)
{
  ...
  _BYTE v132[4]; // [rsp+48h] [rbp-2F0h] BYREF
  ...
  int v149; // [rsp+98h] [rbp-2A0h] BYREF
  ...
  unsigned __int64 v158; // [rsp+E8h] [rbp-250h]
  __int64 v159; // [rsp+F0h] [rbp-248h] BYREF
  volatile void *v160; // [rsp+F8h] [rbp-240h]
...
LABEL_639:
        ...
        case 0x43u:
          ...
          v137 = *(_DWORD *)a4;
          v160 = *(volatile void **)(a4 + 8);
          v67 = *(unsigned int *)(a4 + 4);
          v144 = *(_DWORD *)(a4 + 4);
          if ( ((unsigned __int8)v160 & 7) != 0 )
            return -2147483646;
          SystemBasicInformation = ExGetSessionPoolTagInformation(v160, v67, &Size, &v137);
          goto LABEL_640;
        case 0x44u:
          if ( Length < 0x20 )
          {
        ...
        case 0x58u:
          ...
          *(_OWORD *)ProcessId = *(_OWORD *)a4;
          ...
          if ( v9 && WORD1(ProcessId[1]) )
          {
            ...
            if ( v56 > 0x7FFFFFFF0000LL || v56 < v158 )
          ...
          BootGraphicsInformation = PsQueryFullProcessImageName(Process, a4 + 8, v158, &v149);
...
LABEL_307:
        ...
        case 0x99u:
          ...
          if ( Length >= 0x20 )
          {
            ...
            *(_QWORD *)(a4 + 16) = xmmword_140C25090;
            *(_DWORD *)(a4 + 24) = DWORD2(xmmword_140C25090);
LABEL_521:
            BootGraphicsInformation = Size_4;
            goto LABEL_641;
          }
        ...
        case 0x9Du:
          ...
          if ( Length >= Size )
          {
            ...
            *(_DWORD *)(a4 + 8) = DWORD2(ExpManufacturingInformation);
            ...
            {
              *(_QWORD *)(a4 + 16) = v109;
              memmove(v109, qword_140C19870, WORD5(ExpManufacturingInformation));
            }
            BootGraphicsInformation = Size_4;
          }
          else
...
LABEL_259:
        ...
        case 0xC7u:
        case 0xD1u:
          SystemBasicInformation = SeCodeIntegrityQueryPolicyInformation(v16, v135[0], v20, a4, Length, (__int64)&Size);
          goto LABEL_640;
        case 0xA5u:
          Size = 16;
          if ( Length != 16 )
