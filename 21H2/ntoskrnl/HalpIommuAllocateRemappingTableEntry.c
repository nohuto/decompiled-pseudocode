/*
 * XREFs of HalpIommuAllocateRemappingTableEntry @ 0x140510A40
 * Callers:
 *     HalpIrtAllocateIndex @ 0x140909B14 (HalpIrtAllocateIndex.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x14042A5E0 (_guard_dispatch_icall.c)
 *     HalpIommuConvertPciBusMasterDescriptorToDeviceId @ 0x140510BAC (HalpIommuConvertPciBusMasterDescriptorToDeviceId.c)
 */
