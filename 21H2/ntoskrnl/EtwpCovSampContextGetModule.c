/*
 * XREFs of EtwpCovSampContextGetModule @ 0x1409435F0
 * Callers:
 ...
 *     EtwpCheckDebugInfoEqual @ 0x1405AE600 (EtwpCheckDebugInfoEqual.c)
 *     ProcessForExeModule @ 0x1405B04A8 (ProcessForExeModule.c)
 *     EtwpFindDebugId @ 0x1406099F0 (EtwpFindDebugId.c)
 *     EtwpCovSampCheckForSegments @ 0x140942DF4 (EtwpCovSampCheckForSegments.c)
 *     EtwpCovSampContextFastFindModule @ 0x1409434A4 (EtwpCovSampContextFastFindModule.c)
...
LABEL_17:
  ...
  *((_DWORD *)v10 + 30) ^= (*((_DWORD *)v10 + 30) ^ (*(_DWORD *)(a5 + 8) << 9)) & 0x20000;
  ...
  v88 = (__m128i *)v103;
  v107 = 1;
  if ( (int)EtwpFindDebugId(*(char **)(a5 + 16), v26, 1, (void **)v10 + 6, (_DWORD *)v10 + 14) >= 0 )
  {
    v27 = *((_QWORD *)v10 + 6);
