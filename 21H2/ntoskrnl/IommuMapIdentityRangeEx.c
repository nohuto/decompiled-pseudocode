/*
 * XREFs of IommuMapIdentityRangeEx @ 0x1405284B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IommuMapIdentityRangeEx(ULONG_PTR a1, int a2, int a3)
{
  ...
  if ( (int)IommupProcessPhysicalAddress(a3, (unsigned int)&v14, (unsigned int)&v18, (unsigned int)&v16, (__int64)&v15) < 0 )
  ...
  if ( v18 )
  {
    LogicalAddressRange = HalpIommuDomainGetLogicalAddressRange(a1, &v20, v14, 0LL, 0LL, &v17);
    if ( LogicalAddressRange < 0 )
      return (unsigned int)LogicalAddressRange;
    v6 = 1;
    v11 = HalpIommuDomainMapLogicalRange(a1, v19, v7, v14, v20);
    goto LABEL_14;
  }
  if ( (int)v9 <= 0 )
  {
LABEL_11:
    v11 = HalpIommuDomainMapIdentityRange(a1, v19, v8, v9);
LABEL_14:
    LogicalAddressRange = v11;
    if ( v11 >= 0 )
      return (unsigned int)LogicalAddressRange;
    goto LABEL_15;
  }
  ...
  {
    v20 = *v10 << 12;
    LogicalAddressRange = HalpIommuDomainGetLogicalAddressRange(a1, &v20, 4096LL, 0LL, 0LL, &v17);
    if ( LogicalAddressRange < 0 )
      break;
    ++v6;
    ++v10;
...
LABEL_15:
  if ( v6 > 0 )
  {
    if ( v18 )
    {
      HalpIommuDomainFreeLogicalAddressRange(a1, v20);
    }
    else
    {
      for ( i = v6; i >= 0; --i )
