/*
 * XREFs of KiShuffleAssignedSubNodes @ 0x140B51500
 * Callers:
                  ...
                  if ( i != v11 )
                  {
                    ...
                    if ( (*(_BYTE *)(v26 + 5) & 1) != 0 && *(_WORD *)(v26 + 6) == (_WORD)v18 )
                      v23 = *((_DWORD *)KeNodeDistance
                            ...
                            + (unsigned __int16)KeNumberNodes * *(unsigned __int16 *)(v40 + 2))
                  ...
                  if ( k != v11 )
                  {
                    ...
                    if ( (*(_BYTE *)(v30 + 5) & 1) != 0 && *(_WORD *)(v30 + 6) == (_WORD)v18 )
                      v23 = *((_DWORD *)KeNodeDistance
                            ...
                            + *(unsigned __int16 *)(v41 + 2) * (unsigned __int16)KeNumberNodes)
                          / (unsigned int)*(unsigned __int16 *)(a4 + 2 * v18)
                          + v23
                          - 1;
                  }
