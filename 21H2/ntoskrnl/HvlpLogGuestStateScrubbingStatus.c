/*
 * XREFs of HvlpLogGuestStateScrubbingStatus @ 0x14054B7FC
 * Callers:
...
char HvlpLogGuestStateScrubbingStatus()
{
  ...
  v0 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v15.m256i_i64[1], 1, (__int64)v39, 8LL);
  v1 = (int *)HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v14.m256i_i64[1], 2, (__int64)v40, 1032LL);
  *(_DWORD *)v0 = 25;
  ...
  if ( HvlpGuestStateScrubbingStatus )
  {
    ...
    *(_QWORD *)&v17.Size = 4LL;
    ...
    {
      v3 = (const EVENT_DESCRIPTOR *)HV_EVENTLOG_GUEST_STATE_SCRUBBING_DISABLED_CORE_SCHEDULER;
      if ( !(_BYTE)dword_140D051DC )
        v3 = &HV_EVENTLOG_GUEST_STATE_SCRUBBING_DISABLED_CORE_SCHEDULER_CLIENT_SKU;
