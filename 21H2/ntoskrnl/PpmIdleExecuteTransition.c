/*
 * XREFs of PpmIdleExecuteTransition @ 0x1402C6DB0
 * Callers:
 ...
 *     PpmIdleSetSynchronizationState @ 0x140567010 (PpmIdleSetSynchronizationState.c)
...
LABEL_53:
  ...
  *(_DWORD *)(BugCheckParameter4 + 32820) = v41;
  ...
  if ( v31 || *(_BYTE *)(v194 + 6) || *(_BYTE *)(v194 + 7) )
  {
    ...
    if ( *(_BYTE *)(v194 + 7) )
    {
      v45 = PpmCurrentProfile[342 * dword_140C2332C + 24];
...
LABEL_112:
  ...
  if ( *(_BYTE *)(v64 + 540) )
  {
    ...
    KePrepareClockTimerForIdle(a5, (unsigned __int8)v193, *(_QWORD *)(v64 + 520), v72);
  }
  v41 = BugCheckParameter2;
LABEL_135:
  ...
  *(_QWORD *)(BugCheckParameter4 + 32848) = v76;
  ...
  if ( (int)v20 >= 0 )
  {
    ...
    if ( v195 != -1 )
    {
      ...
      if ( !qword_140C50080 && v195 == dword_140C500C0 )
        _InterlockedCompareExchange64(&qword_140C50080, MEMORY[0xFFFFF78000000008], 0LL);
      if ( a5 )
      {
    ...
    if ( (WORD4(PerfGlobalGroupMask) & 0x8000) != 0 )
    {
      ...
      *((_QWORD *)&v225 + 1) = v91;
      ...
      WORD3(v225) = v92;
      v229[1] = 16LL;
      EtwTraceKernelEvent((int)v229, 1, 0x40008000u, 4665, 1538);
    }
    if ( a8 )
      ...
      if ( *(_BYTE *)(v211 + 1056) >= 2u && (HvlEnlightenments & 4) == 0 )
      {
        ...
        if ( !v94 )
        {
          ...
          if ( v105->CpuVendor != 1 )
          {
            ...
            if ( !v105->DeepSleep )
            {
              v107 = 8LL * ((unsigned int)KiProcessorIndexToNumberMappingTable[v105->Number] >> 6) + 12760008;
              _InterlockedAnd64(
              ...
              if ( KiFlushPcid )
              {
                ...
                if ( !Process->AddressPolicy )
                  KiSetUserTbFlushPending(Process, v107, 0x140000000uLL);
              }
              else
              {
                v110 = __readcr4();
    ...
    *(_WORD *)(BugCheckParameter4 + 1760) &= ~1u;
    if ( DeepSleep )
    {
      ...
      if ( v121 )
      {
        ...
        v122->DeepSleep = 0;
        _InterlockedAnd64(
          &qword_140C2B3C8[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[v123] >> 6],
    ...
    if ( (WORD4(PerfGlobalGroupMask) & 0x8000) != 0 )
    {
      ...
      v230[0] = &v212;
      v230[1] = 8LL;
      EtwTraceKernelEvent((int)v230, 1, 0x40008000u, 4666, 1538);
    }
  }
