/*
 * XREFs of MiLogReserveVaFailed @ 0x14096B308
 * Callers:
...
char __fastcall MiLogReserveVaFailed(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_QWORD *)&qword_140C53448 )
  {
    ...
    if ( ((unsigned __int16)v4 & 0x800) == 0 )
    {
      ...
      {
        LOBYTE(v4) = tlgKeywordOn(*(__int64 *)&qword_140C53448, 0x400000000000LL);
        if ( (_BYTE)v4 )
        {
          v27 = 0;
          v30 = 0;
          ...
          v18 = a3;
          v19 = a4;
          LOBYTE(v4) = tlgWriteEx_EtwWriteEx(v11, (unsigned __int8 *)&word_14002CAA6, 0LL, 1u, 0, 0, 0xAu, &v24);
        }
      }
    }
  }
