/*
 * XREFs of PopQueueQuerySetIrp @ 0x140398344
 * Callers:
...
LABEL_24:
  ...
  if ( v2 )
  {
    ...
    qword_140C23BD8 = (__int64)&v3->Tail.Overlay.ListEntry;
  }
  v11 = v10[1];
  if ( v11 )
  {
