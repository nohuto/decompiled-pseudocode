/*
 * XREFs of FsRtlNotifyFilterReportChange @ 0x14068FB50
 * Callers:
 *     FsRtlNotifyFullReportChange @ 0x14088D6E0 (FsRtlNotifyFullReportChange.c)
 *     FsRtlNotifyReportChange @ 0x14088D740 (FsRtlNotifyReportChange.c)
 * Callees:
