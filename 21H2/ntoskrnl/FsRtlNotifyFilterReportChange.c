/*
 * XREFs of FsRtlNotifyFilterReportChange @ 0x1405EF9C0
 * Callers:
 *     FsRtlNotifyFullReportChange @ 0x14088D840 (FsRtlNotifyFullReportChange.c)
 *     FsRtlNotifyReportChange @ 0x14088D8A0 (FsRtlNotifyReportChange.c)
 * Callees:
