/*
 * XREFs of KiLockExtendedServiceTable @ 0x1403DBEC8
 * Callers:
                ...
                do
                {
                  ...
                  if ( v96 && (v96 < v90 || v96 >= v90 + *(unsigned int *)(v89 + 80)) )
                  {
                    if ( MmIsSessionAddress(v96) )
                    {
                      ...
                      {
                        v99 = 0LL;
                        v100 = qword_140C13180;
                        while ( *v100 != v130 )
                        {
                          if ( !*v100 )
                          {
                            qword_140C13180[v99] = v130;
                            break;
                          }
...
LABEL_115:
  ...
  {
    v101 = (unsigned __int64)&qword_140C13090;
    v102 = (unsigned __int64)&qword_140C13090 & 0x3F;
    v133 = (unsigned __int64)&qword_140C13090 & 0x3F;
