/*
 * XREFs of KiLockExtendedServiceTable @ 0x1403EB1A8
 * Callers:
...
__int64 __fastcall KiLockExtendedServiceTable(ULONG_PTR BugCheckParameter1, ULONG_PTR a2, unsigned int a3, int a4)
{
  ...
  __int64 v129; // [rsp+48h] [rbp-99h] BYREF
  ...
  if ( a4 )
  {
    ...
    if ( dword_140C094D8 != SessionId )
    {
      *(_QWORD *)&v9 = (unsigned int)_InterlockedCompareExchange(&dword_140C094D8, SessionId, -1);
      if ( (_DWORD)v9 != -1 )
        return v9;
    }
    v10 = 4 * v4;
...
LABEL_42:
    ...
    v47 = v46 + *(unsigned __int16 *)(v46 + 20) + 24LL;
    v131 = v47 + 40LL * *(unsigned __int16 *)(v46 + 6);
    while ( 1 )
    {
      v48 = 0;
      if ( (*(_DWORD *)(v47 + 36) & 0x2000000) != 0 )
        goto LABEL_73;
      v49 = *(_DWORD *)v47;
...
LABEL_50:
        ...
        while ( 1 )
        {
          v52 = v51[v47 - (unsigned __int64)VfExcludeSections[0]];
          v53 = *v51++;
          if ( v52 != v53 )
            break;
          if ( !--v50 )
...
LABEL_74:
      ...
      if ( !v48 )
      {
        ...
        if ( v70 <= *(_DWORD *)(v47 + 8) )
          v70 = *(_DWORD *)(v47 + 8);
        v72 = (_QWORD *)(v129 + *(unsigned int *)(v47 + 12));
        v73 = v72;
      ...
      if ( v47 == v131 )
      {
        ...
        if ( !v147 )
        {
          v89 = v127;
          v90 = v129;
          v91 = *(unsigned int *)(v127 + 148);
          if ( (unsigned int)v91 >= 0x14 )
          {
            v92 = *(unsigned int *)(v127 + 144);
            v93 = v92 + v91 + v129;
            v94 = v92 + v129;
            if ( v92 + v129 != v93 )
            {
...
LABEL_110:
    ...
    if ( *(_DWORD *)(v47 + 4) == 1195525195 )
      goto LABEL_73;
LABEL_48:
    if ( v49 != 1095914053 || *(_WORD *)(v47 + 4) != 16724 )
      goto LABEL_50;
    goto LABEL_73;
  }
  ...
  RtlCaptureImageExceptionValues(0x40000000, &v137, &v128);
  v101 = v137;
  v102 = 0x140000000uLL;
