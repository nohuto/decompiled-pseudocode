/*
 * XREFs of ?SmStoreContentsRundown@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAU?$SMKM_STORE@USM_TRAITS@@@@@Z @ 0x1405FCF84
 * Callers:
  ...
  *(_OWORD *)&v10[0].LowPart = 0LL;
  ...
  if ( PoolWithTag )
  {
    ...
    *(_DWORD *)PoolWithTag = 3;
    v7 = SMKM_STORE_MGR<SM_TRAITS>::SmStoreRequestEx(v5, a2, (__int64)PoolWithTag, (__int64)Object, v10);
    if ( v7 >= 0 )
    {
