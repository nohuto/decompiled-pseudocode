/*
 * XREFs of PopPepUpdateIdleStateRefCount @ 0x1403B92D0
 * Callers:
...
unsigned __int64 __fastcall PopPepUpdateIdleStateRefCount(int a1, int a2, int a3, volatile signed __int32 *a4)
{
  ...
  {
    v15 &= v15 - 1;
    v18 = PopPepPlatformState + 448LL * v17;
    if ( a3 )
    {
...
LABEL_26:
    ...
    else
    {
      ...
      if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && CurrentIrql <= 0xFu )
      {
        ...
        v9 = (unsigned int)v11 | SchedulerAssist[5];
    ...
    {
      LOBYTE(v11) = 1;
      PopFxPlatformStateAvailable(v31, v11);
      result = *(int *)(v18 + 384);
      if ( (_DWORD)result != -1 )
...
LABEL_27:
  ...
  if ( (_DWORD)v12 )
  {
    ...
    while ( 1 )
    {
      KeYieldProcessorEx(&v33, v11, v9, (__int64)SchedulerAssist);
      v23 = 0LL;
      do
      {
        ...
        if ( v25 <= 0 )
        {
          ...
          {
            PopFxPlatformStateAvailable((__int64)(v24 - PopPepPlatformState) / 448, 0LL);
            if ( *(_DWORD *)(v24 + 384) != -1 )
