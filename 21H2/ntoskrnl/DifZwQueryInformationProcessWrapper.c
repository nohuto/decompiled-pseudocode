/*
 * XREFs of DifZwQueryInformationProcessWrapper @ 0x140624A80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifZwQueryInformationProcessWrapper(__int64 a1, unsigned int a2, __int64 a3, int a4, __int64 a5)
{
  __int64 v9; // rdx
  __int64 v10; // rcx
...
LABEL_18:
  result = ZwQueryInformationProcess(a1, a2);
  LODWORD(v23) = result;
  if ( APIThunkContextById )
  {
