/*
 * XREFs of PopPotsLogDirtyPowerTransition @ 0x140B53288
 * Callers:
...
void __fastcall PopPotsLogDirtyPowerTransition(int a1, unsigned int a2, int a3)
{
  ...
  if ( a1 )
  {
    ...
    {
      if ( (unsigned int)dword_140C045A8 > 5 && tlgKeywordOn((__int64)&dword_140C045A8, 0x400000000000LL) )
      {
        v14 = 0;
        v17 = 0;
        v12 = &v7;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_1400325F9,
          0LL,
          0LL,
          7u,
          &v11);
