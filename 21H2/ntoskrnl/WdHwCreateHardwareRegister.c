/*
 * XREFs of WdHwCreateHardwareRegister @ 0x1404DE608
 * Callers:
 ...
 *     WdHwpGetReadMethod @ 0x1404DE73C (WdHwpGetReadMethod.c)
 *     WdHwpGetWriteMethod @ 0x1404DE7AC (WdHwpGetWriteMethod.c)
 */
