/*
 * XREFs of KiInitializeSingleDpcRuntimeHistoryHashTable @ 0x140851878
 * Callers:
...
__int64 __fastcall KiInitializeSingleDpcRuntimeHistoryHashTable(__int64 a1)
{
  ...
  v2 = (unsigned __int64)KiDpcRuntimeHistoryHashTableAllocate(0x10uLL);
  if ( !v2 )
    return (unsigned int)-1073741801;
  v3 = (struct _KDPC *)KiDpcRuntimeHistoryHashTableAllocate(0x40uLL);
  v4 = v3;
  if ( v3 )
  {
    ...
    *(_QWORD *)(v2 + 8) = 0LL;
    *(_DWORD *)(v2 + 4) = 0;
    v5 = (char *)KiDpcRuntimeHistoryHashTableAllocate(0x200uLL);
    if ( v5 )
    {
