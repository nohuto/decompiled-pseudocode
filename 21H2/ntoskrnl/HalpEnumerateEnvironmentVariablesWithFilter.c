/*
 * XREFs of HalpEnumerateEnvironmentVariablesWithFilter @ 0x140508990
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  unsigned __int8 (__fastcall *v31)(__int128 *, _WORD *); // [rsp+60h] [rbp-A0h]
  ...
  {
    v24 = 1;
    v11 = KiProcessorIndexToNumberMappingTable[KeGetPcr()->Prcb.Number];
  ...
  while ( 1 )
  {
    ...
    if ( !v31 || v31(&v34, Src) )
    {
      ...
      else
      {
        ...
        v21 = ((__int64 (__fastcall *)(_WORD *, __int128 *, __int64, __int64 *, __int64))HalEfiRuntimeServicesTable[3])(
                Src,
                &v34,
                v20,
                &v26,
