/*
 * XREFs of MiUnlinkPageFromListEx @ 0x140326870
 * Callers:
...
__int64 __fastcall MiUnlinkPageFromListEx(ULONG_PTR BugCheckParameter2, char a2)
{
  ...
  __int64 v6; // r14
  char v7; // cl
  __int64 SlabAllocatorStandbyList; // r15
  int v9; // r13d
  ...
  v128 = 0LL;
  v129 = 0LL;
  SlabAllocatorStandbyList = *(_QWORD *)(v6 + 8LL * (v7 & 7) + 6632);
  v130 = 0LL;
  v131 = 0LL;
  v9 = *(_DWORD *)(SlabAllocatorStandbyList + 8);
  v132 = 0LL;
  if ( (a2 & 1) != 0 )
  {
    v3 = 320;
  ...
  if ( (v7 & 7) == 5 )
  {
    MiUnlinkPageFromBadList(v2, 0LL);
    return 0LL;
  }
  v10 = v3 | 0x20;
  ...
  if ( v9 != 2 )
  {
    if ( v9 == 3 )
    {
      ...
      if ( (v59 & 0x400) != 0 )
      {
        v60 = *(_BYTE *)(v2 + 36);
        v61 = v60 & 0xF;
        SlabAllocatorStandbyList = v6 + 88 * v61 + 5120;
        if ( v10 < 0x100 )
        {
          MiAcquirePageListLock(v6 + 88 * v61 + 5120, v2, 1LL, &v127);
          v60 = *(_BYTE *)(v2 + 36);
          v10 |= 0x200u;
        }
      ...
      else
      {
        if ( (v59 & 2) != 0 || (unsigned __int16)v59 >> 12 == *(_DWORD *)(v6 + 1172) )
          SlabAllocatorStandbyList = 88LL * ((unsigned __int16)v59 >> 12) + v6 + 3712;
        else
          SlabAllocatorStandbyList = v6 + 3584;
        if ( v10 < 0x100 )
        {
          MiAcquirePageListLock(SlabAllocatorStandbyList, v2, 1LL, &v127);
          v10 |= 0x200u;
        }
  ...
  if ( (v5 & 0x20000000000000LL) != 0 )
  {
    if ( (*(_BYTE *)(v2 + 35) & 0x10) != 0 )
    {
      ...
      if ( v10 < 0x100 )
        v89 = 0LL;
      MiUnlinkPageFromBadList(v2, v89);
    }
    *(_QWORD *)v2 = 0LL;
  ...
  SlabAllocatorStandbyList = 88LL * v13 + v6 + 2880;
  if ( (v10 & 8) != 0 )
  {
    ...
    {
      v83 = v10 | 0x10;
      SlabAllocatorStandbyList = MiGetSlabAllocatorStandbyList(v2, 0LL, v82);
    }
    else
    {
      v83 = v10 & 0xFFFFFFDF;
...
LABEL_137:
      ...
      v111 = v110;
      v108 = *((_DWORD *)MiSearchNumaNodeTable(0xAAAAAAAAAAAAAAABuLL * ((16 * ((__int64)(v2 + 0x220000000000LL) >> 4)) >> 4))
             + 2);
      LODWORD(v112) = v108;
      v73 = *(_BYTE *)(v14 + 35);
      if ( (v73 & 8) != 0 )
      ...
      v114 = v74;
      if ( qword_140C50710 )
        v75 = MiPageToChannel(0xAAAAAAAAAAAAAAABuLL * ((16 * ((__int64)(v2 + 0x220000000000LL) >> 4)) >> 4));
      else
        v75 = 0;
      ...
      for ( i = 0; i < 3; ++i )
      {
        StandbyLookaside = (_QWORD *)MiGetStandbyLookaside(&v111, i);
        v79 = StandbyLookaside;
        v107 = StandbyLookaside;
        v80 = 0LL;
        while ( *StandbyLookaside != v11 )
        {
          if ( StandbyLookaside[1] == v11 )
          {
            v80 = (unsigned int)(v80 + 1);
            goto LABEL_148;
          }
          if ( StandbyLookaside[2] == v11 )
          {
            v80 = (unsigned int)(v80 + 2);
            goto LABEL_148;
          }
          if ( StandbyLookaside[3] == v11 )
          {
...
LABEL_148:
        ...
        if ( !MiFindSuitableLookasideReplacement(i, v79, v80, v76, v104) )
          MiWriteStandbyLookasideEntry(&v107[v80], 3LL, 0xFFFFFFFFFFFFFFFFuLL);
LABEL_149:
        ;
      }
      v2 = BugCheckParameter2;
...
LABEL_32:
  ...
  if ( (v10 & 4) != 0 )
  {
    ...
    {
      MiSetPfnPteFrame(48 * v18 - 0x220000000000LL, v17);
    }
    if ( v66 )
      MiDecayNodeNowEmpty(v17);
    v18 = 0x3FFFFFFFFFLL;
    v16 = (_QWORD *)(v2 + 24);
    v17 = 0x3FFFFFFFFFLL;
  }
  else
  {
    if ( v18 != 0x3FFFFFFFFFLL && (v18 < qword_140C52CE0 || v18 >= qword_140C52CE0 + 2048) )
    {
      ...
      if ( v13 != v20 )
      {
        PfnPriority = MiGetPfnPriority(48 * v18 - 0x220000000000LL);
        KeBugCheckEx(0x1Au, 0x8886uLL, v2, v92, (v13 << 8) | (unsigned __int64)PfnPriority);
      }
    }
    if ( v17 != 0x3FFFFFFFFFLL && (v17 < qword_140C52CE0 || v17 >= qword_140C52CE0 + 2048) )
    {
      ...
      if ( v13 != v22 )
      {
        v93 = MiGetPfnPriority(48 * v17 - 0x220000000000LL);
...
LABEL_44:
  if ( v18 == 0x3FFFFFFFFFLL )
  {
    v28 = v10 >> 2;
    if ( (v10 & 4) == 0 )
      *(_QWORD *)(SlabAllocatorStandbyList + 24) = v17;
  }
  else
  {
  ...
  {
    if ( (v28 & 1) == 0 )
      *(_QWORD *)(SlabAllocatorStandbyList + 16) = v18;
  }
  else
  {
...
LABEL_57:
  ...
  LODWORD(v120) = v35;
  if ( qword_140C50710 )
    v36 = MiPageToChannel(0xAAAAAAAAAAAAAAABuLL * ((__int64)(48 * v11) >> 4));
  else
    v36 = 0;
  v37 = *(_DWORD *)(v2 + 36);
...
LABEL_68:
  *(_QWORD *)v2 = 0LL;
  if ( (v10 & 2) != 0 )
  {
    MiSetPfnBlink(v2, 0LL, 0);
    MiRemoveDecayClusterTimer(v2, v81);
    goto LABEL_71;
  }
...
LABEL_71:
  if ( (v10 & 0x100) == 0 )
  {
    if ( (_BYTE)v127 && v10 >= 0x200 )
    {
      ...
      v52 = (volatile signed __int32 *)(SlabAllocatorStandbyList + 32);
      if ( (BYTE6(PerfGlobalGroupMask) & 1) != 0 )
      {
        ExpReleaseSpinLockSharedFromDpcLevelInstrumented(v52, retaddr);
      }
      else
      {
      ...
      if ( SchedulerAssist )
      {
        ...
        {
          v99 = SchedulerAssist[6] - 1;
          SchedulerAssist[6] = v99;
          if ( !v99 )
  ...
  if ( (v101 & 0xC) == 8 )
    return v102;
  if ( (v56 >= 0x20 || (ULONG_PTR *)v55 != &MiSystemPartition)
