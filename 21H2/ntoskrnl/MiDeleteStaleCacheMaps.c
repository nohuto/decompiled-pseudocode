/*
 * XREFs of MiDeleteStaleCacheMaps @ 0x1405910C0
 * Callers:
 *     <none>
 * Callees:
...
PVOID *__fastcall MiDeleteStaleCacheMaps(__int64 a1)
{
  int v1; // r12d
  char v2; // si
  __int64 v3; // r13
  ...
  {
    v6 = MiState[v3 + 2085];
    v7 = (unsigned __int64 *)&MiState[v3 + 2072];
    v8 = -1LL;
    v41 = v7;
LABEL_3:
    v9 = MiState[v3 + 2081];
...
LABEL_14:
          ...
          if ( *(_DWORD *)(v11 + 68) )
          {
            ...
            if ( v8 == 1 )
              goto LABEL_60;
            if ( (++v37 & 0xF) == 0 && (unsigned int)MiIoPfnTreeLockContended(v2) )
              goto LABEL_53;
            if ( KeShouldYieldProcessor() )
            {
              v19 = 1;
LABEL_53:
              MiUnlockIoPfnTree(v4, v19 + (v2 != 0));
              MiLockIoPfnTree(1);
              v26 = 0;
              if ( !v2 )
                v26 = v1;
...
LABEL_57:
          ...
          else
          {
            ...
            {
              v6 = *(_QWORD *)(v11 + 24);
              MiUnlockIoPfnTree(v4, 1);
              v1 = 64;
              v2 = 1;
              v46 = 64;
              _InterlockedOr(v36, 0);
              v39 = KiCacheFlushTimeStamp;
              LOBYTE(v38) = 0;
              v45 = 0;
              MiLockIoPfnTree(2);
              v5 = 1LL;
            ...
            if ( !(_BYTE)v38 )
            {
              if ( *(_BYTE *)(v11 + 72) )
              {
                ...
                {
                  v22 = MiFlushStaleCacheMap(v11, 1LL, v7, v5);
            ...
            v24 = _InterlockedDecrement64(&MiState[v47 + 2074]);
            _InterlockedAdd64(&MiState[v47 + 2081], 0xFFFFFFFFFFFFFFFFuLL);
            v25 = P[0];
            if ( *((PVOID **)P[0] + 1) != P )
LABEL_77:
              __fastfail(3u);
