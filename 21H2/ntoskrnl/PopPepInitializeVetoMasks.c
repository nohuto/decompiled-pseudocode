/*
 * XREFs of PopPepInitializeVetoMasks @ 0x1405D5704
 * Callers:
 ...
 *     PopFxEnableEnhancedAccounting @ 0x1405D4A54 (PopFxEnableEnhancedAccounting.c)
  ...
  *(_OWORD *)&v54[1] = *(_OWORD *)(v4 + 216);
  ...
  for ( i = 0; i < (unsigned int)v2; ++i )
  {
    ...
    *(_QWORD *)&v53 = v54;
    DWORD2(v53) = 8;
    v50 = &v53;
    EmClientRuleEvaluate(&GUID_EM_PEP_UPADTE_DEVICE_CONTRAINT, &v50, 1LL, &v48);
    if ( v48 == 2 )
      *(_BYTE *)(a1 + 188) = 1;
  }
  v52 = *(_QWORD *)(*(_QWORD *)(v4 + 48) + 32LL);
  PopFxActivateDevice(v52, 0, 0);
  v8 = v55[0];
  ...
  v49 = DeepSleepPlatformStateIndex;
  v45 = 0;
  v47 = _InterlockedCompareExchange(&PopFxDeviceAccountingLevel, 0, 0);
  v12 = v47;
  KxAcquireSpinLock((PKSPIN_LOCK)(v4 + 600));
  *(_DWORD *)(v4 + 616) = v47;
  memset((void *)(v4 + 632), 0, 0xC0uLL);
  *(_BYTE *)(v4 + 608) = 0;
  if ( PopPluginRequestDeviceIdleConstraints(*(_QWORD *)(a1 + 32), (__int64)v55, v2) || *(_BYTE *)(a1 + 188) )
  {
    v45 = PopFxEnableEnhancedAccounting(&v47);
    if ( *(_BYTE *)(a1 + 188) )
    {
      if ( (_DWORD)v2 )
      {
...
LABEL_28:
      ...
      do
      {
        ...
        while ( v22 <= 3 );
        if ( DeepSleepPlatformStateIndex != -1 && v20 == DeepSleepPlatformStateIndex && v21 > 1 )
        {
          *(_DWORD *)(v4 + 612) = v21;
  ...
  *(_DWORD *)(v4 + 616) = v12;
  ...
  v25 = *(int *)(a1 + 168);
  if ( (_DWORD)v25 != 4 )
    PopPepUpdateIdleStateRefCount(0, *(_DWORD *)(a1 + 4 * v25 + 140), 1, (volatile signed __int32 *)(a1 + 184));
  if ( *(_BYTE *)(a1 + 124) )
  {
    v26 = 0;
    v46 = 0;
    ...
    while ( 1 )
    {
      ...
      v29 = v27 + 200;
      v51 = v29;
      KxAcquireSpinLock((PKSPIN_LOCK)v29);
      *(_DWORD *)(v29 + 16) = v12;
      memset((void *)(v29 + 32), 0, 0xC0uLL);
      *(_BYTE *)(v29 + 8) = 0;
      if ( PopPluginRequestComponentIdleConstraints(*(_QWORD *)(a1 + 32), v26, (__int64)v55, v2) )
      {
        v45 = PopFxEnableEnhancedAccounting(&v47);
        v30 = v55;
        v31 = 1;
        ...
        if ( (_DWORD)v2 )
        {
          ...
          do
          {
            if ( !*(_BYTE *)(v35 + PopPepPlatformState + 57) && *v34 )
              PopFxBugCheck(0x621uLL, v4, v26, v32);
            v36 = 0;
            if ( *(_DWORD *)(v28 + 380) )
            {
      ...
      *(_DWORD *)(v29 + 16) = v12;
      KxReleaseSpinLock((PKSPIN_LOCK)v29);
