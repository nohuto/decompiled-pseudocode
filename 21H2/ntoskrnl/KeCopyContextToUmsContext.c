/*
 * XREFs of KeCopyContextToUmsContext @ 0x1408BE9BC
 * Callers:
...
__int64 __fastcall KeCopyContextToUmsContext(__int64 a1, __int64 a2)
{
  ...
  _OWORD *v6; // rax
  _OWORD *v7; // rcx
  _WORD *v9; // [rsp+20h] [rbp-38h]
  int v10; // [rsp+70h] [rbp+18h] BYREF
  int v11; // [rsp+78h] [rbp+20h]

  v11 = *(_DWORD *)(a2 + 48);
  v10 = v11 & 0x100013;
  RtlpSanitizeContextFlags((unsigned int *)&v10, 1);
  ...
  *(_DWORD *)(a1 + 1264) |= 4u;
  ...
  if ( (v11 & 0x100040) == 0x100040 && MEMORY[0xFFFFF780000003D8] )
    KiCopyXStateArea((__int64)v9, MEMORY[0xFFFFF780000003D8] & 0xFFFFFFFFFFFFFFFCuLL, *(int *)(a2 + 1248) + a2 + 720);
