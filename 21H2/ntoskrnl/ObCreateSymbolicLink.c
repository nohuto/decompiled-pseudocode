/*
 * XREFs of ObCreateSymbolicLink @ 0x1406C505C
 * Callers:
...
__int64 __fastcall ObCreateSymbolicLink(_QWORD *a1, int a2, __int64 a3, __int64 a4, char a5)
{
  ...
  p_Object = &Object;
  LOBYTE(p_Object) = a5;
  IntegrityLevel = ObCreateObjectEx((_DWORD)p_Object, (_DWORD)ObpSymbolicLinkObjectType, a3, a5);
  if ( IntegrityLevel < 0 )
  {
    v9 = (char *)Object;
    goto LABEL_30;
...
LABEL_13:
    ...
    if ( IntegrityLevel >= 0 )
    {
      if ( (unsigned __int8)RtlIsSandboxedToken(0LL) )
        *((_DWORD *)v9 + 7) |= 2u;
      IntegrityLevel = ObInsertObjectEx(v9, 0LL, 0, 0LL, (__int64)v31);
      v9 = 0LL;
      Object = 0LL;
      if ( IntegrityLevel >= 0 )
      {
  ...
  if ( (*(_DWORD *)a4 & 5) == 0 )
  {
    ...
    if ( EtwApiCallsProvRegHandle )
    {
      ...
      *(_QWORD *)&UserData[v26].Size = 4LL;
      EtwWrite(v17, &KERNEL_AUDIT_API_CREATESYMBOLICLINKOBJECT, 0LL, v24 + 1, UserData);
    }
  }
