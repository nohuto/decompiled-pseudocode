/*
 * XREFs of MiFreeLargePages @ 0x1405C1CE0
 * Callers:
...
__int64 __fastcall MiFreeLargePages(__int64 a1, __int64 a2, _QWORD *a3, _QWORD *a4, char a5)
{
  ...
  unsigned int PfnPageSizeIndex; // [rsp+48h] [rbp-1A0h]
  ...
  *(_DWORD *)&v32[8] = 0;
  ...
  v39 = *(_QWORD *)(qword_140C51F48 + 8LL * Process[1].IdealProcessor[25]);
...
LABEL_2:
  ...
  v13 = *((_DWORD *)MiSearchNumaNodeTable(v12) + 2);
  v14 = v30;
  ...
  while ( 1 )
  {
    ...
    if ( (a5 & 1) == 0 && v14 != v39 )
      MiReturnCrossPartitionCharges(v14, 4, 1, *(__int64 *)&v32[4]);
    v6 += *(_QWORD *)&v32[4];
    if ( v30 != a1 )
      v6 = v15;
    v16 = v35 + v7;
...
LABEL_15:
    ...
    if ( PfnPageSizeIndex != 2 || v30 != v39 || !v42 )
      goto LABEL_34;
    v19 = 0;
    if ( v18 )
    {
    ...
    *(_QWORD *)(a2 + 16) = v9;
    ...
    if ( !v18 )
LABEL_34:
      v28 = MiFreeLargePageMemory(v12, PfnPageSizeIndex, 0);
    v35 += v28;
    *(_QWORD *)&v32[4] += v18;
    a2 = LeafPfnBuddy;
    v7 = v33;
