/*
 * XREFs of PopBatteryUpdateAlarms @ 0x1408556F0
 * Callers:
...
__int64 __fastcall PopBatteryUpdateAlarms(char a1, __int64 a2)
{
  ...
  v29[5] = v9;
  v30[0] = v10;
  v30[1] = *((_OWORD *)PopPolicy + 7);
  v11 = *((_OWORD *)PopPolicy + 9);
  v30[2] = *((_OWORD *)PopPolicy + 8);
  ...
  if ( (unsigned int)a2 < v17 )
  {
    ...
    do
    {
      if ( (int)PopGetPowerSettingValue(
                  *(_QWORD *)((char *)&GUIDS_BATTERY_DISCHARGE_ACTION + v20),
                  a2,
                  v2,
                  &v27,
                  4u,
      ...
      if ( (int)PopGetPowerSettingValue(
                  *(_QWORD *)((char *)&GUIDS_BATTERY_DISCHARGE_LEVEL + v20),
                  v21,
                  v2,
                  &v27,
                  4u,
      ...
      if ( (int)PopGetPowerSettingValue(
                  *(_QWORD *)((char *)&GUIDS_BATTERY_DISCHARGE_FLAGS + v20),
                  v23,
                  v2,
                  &v27,
                  4u,
  ...
  return PopApplyPolicy(1, v3, v29, 0xE8u);
}
