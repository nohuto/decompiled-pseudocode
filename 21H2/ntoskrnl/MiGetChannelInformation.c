/*
 * XREFs of MiGetChannelInformation @ 0x1407DECE0
 * Callers:
 ...
 *     MiGetNodeChannelPageCounts @ 0x1403608C0 (MiGetNodeChannelPageCounts.c)
 *     MiLockDynamicMemoryExclusive @ 0x140360A00 (MiLockDynamicMemoryExclusive.c)
 */

char __fastcall MiGetChannelInformation(__int64 a1, unsigned int a2, __int64 a3, _QWORD *a4)
{
...
LABEL_5:
      *(_QWORD *)(v11 + 4) = *(_QWORD *)(v9 + 8LL * v5 + 22576);
      MiGetNodeChannelPageCounts(a1, a2, v5, &v17, &v18, &v19);
      *(_QWORD *)(v11 + 12) = v17;
      *(_QWORD *)(v11 + 20) = v18;
      v12 = v19;
      *(_QWORD *)(v11 + 28) = v19;
