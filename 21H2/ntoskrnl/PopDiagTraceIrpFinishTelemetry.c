/*
 * XREFs of PopDiagTraceIrpFinishTelemetry @ 0x1403A51D0
 * Callers:
...
char __fastcall PopDiagTraceIrpFinishTelemetry(__int64 a1)
{
  ...
  wchar_t v52[64]; // [rsp+110h] [rbp+10h] BYREF
    ...
    if ( *(_BYTE *)(v5 + 196) )
    {
      ...
      if ( (unsigned int)(*((_QWORD *)&v4 + 1) >> 11) >= 0x1388 )
      {
        if ( v3 < 0 && !*(_DWORD *)(v5 + 188) )
        {
          ...
          DriverName = PopDiagGetDriverName(DeviceThatFailedIrp, v52);
          v11 = v52;
          if ( DriverName < 0 )
            v11 = (wchar_t *)&cchOriginalDestLength;
          v1 = v11;
        }
        LOBYTE(v4) = PopComputeWatchdogTimeout(v5);
        v13 = *(_DWORD *)(v12 + 192);
        if ( (unsigned int)dword_140C03A00 > 5 )
        {
          LOBYTE(v4) = tlgKeywordOn((__int64)&dword_140C03A00, 0x400000000000LL);
          if ( (_BYTE)v4 )
          {
            v29 = 0;
            v32 = 0;
            ...
            v24 = v7;
            v34 = 8;
            tlgCreate1Sz_wchar_t((__int64)v36, v1);
            v39 = 0;
            v42 = 0;
            v45 = 0;
            v48 = 0;
