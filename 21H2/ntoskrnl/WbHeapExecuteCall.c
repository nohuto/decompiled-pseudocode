/*
 * XREFs of WbHeapExecuteCall @ 0x14064D638
 * Callers:
...
__int64 __fastcall WbHeapExecuteCall(__int64 a1, _QWORD *a2, char *a3, unsigned int a4)
{
  ...
  HeapExecutedBlock = sub_14064CF94((__int64)a2, a4, v22);
  if ( HeapExecutedBlock >= 0 )
  {
    ...
    if ( HeapExecutedBlock >= 0 )
    {
      ...
      if ( HeapExecutedBlock >= 0 )
      {
        ...
        if ( HeapExecutedBlock >= 0 )
        {
          HeapExecutedBlock = sub_14064D36C(v18, v19, *((__int64 *)&v20 + 1), v20, v21);
          if ( HeapExecutedBlock >= 0 )
          {
            HeapExecutedBlock = sub_14064D470((__int64)v22, v19, (__int64 *)&v20, a2, a3, a4);
            if ( HeapExecutedBlock >= 0 )
            {
...
LABEL_11:
  sub_14064ECC0(a1, v18);
  sub_14064DAEC(a1, v19);
