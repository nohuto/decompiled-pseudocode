/*
 * XREFs of PipChangeDeviceObjectFromRegistryProperties @ 0x1406BCE90
 * Callers:
...
__int64 __fastcall PipChangeDeviceObjectFromRegistryProperties(__int64 a1, ACL *a2, __int64 a3, __int64 a4, char a5)
{
  ...
  v40 = 0;
  v38 = 0;
  RegistryDwordWithFallback = PipGetRegistryDwordWithFallback(26, v12, v7, a3, a4, (__int64)&v39);
  v16 = *(_QWORD *)(v9 + 48);
  v36 = RegistryDwordWithFallback;
  v17 = PipGetRegistryDwordWithFallback(27, v16, v7, v6, v43, (__int64)&v40);
  v18 = *(_QWORD *)(v9 + 48);
  v37 = v17;
  PipGetRegistryDwordWithFallback(28, v18, v7, v6, v43, (__int64)&v38);
  ...
  if ( v36 )
  {
    ...
    v33 = IopCreateDefaultDeviceSecurityDescriptor(v39, v23, v25, v47, &P, &v44, &v38);
    v13 = v44;
    v26 = (void *)v33;
    if ( !v33 )
    {
