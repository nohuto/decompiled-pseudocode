/*
 * XREFs of RtlpMuiRegAddLanguageByName @ 0x1408301C0
 * Callers:
 ...
 *     RtlpIsALicensedLIPLanguage @ 0x140A34CE8 (RtlpIsALicensedLIPLanguage.c)
 *     _RtlpMuiRegInitLIPLanguage @ 0x140A360D8 (_RtlpMuiRegInitLIPLanguage.c)
 *     _RtlpMuiRegInitPartialLanguage @ 0x140A3631C (_RtlpMuiRegInitPartialLanguage.c)
 */
