/*
 * XREFs of SeRegisterObjectTypeMandatoryPolicy @ 0x1403AD7E4
 * Callers:
...
LABEL_30:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v14, (__int64)&SepMandatoryObjectTypePolicyLock, (unsigned int *)&v28);
