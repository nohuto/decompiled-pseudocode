/*
 * XREFs of KiAltContextProcessMcheckAltReturn @ 0x14057C1C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall KiAltContextProcessMcheckAltReturn(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // r10
  __int64 v6; // r8
  int v7; // edx
  ...
  if ( *(_WORD *)(v4 + 10) )
  {
    while ( 1 )
    {
      v9 = *((_QWORD *)v8 + 2) - *(_QWORD *)&XPF_MCA_SECTION_GUID.Data1;
      if ( !v9 )
        v9 = *((_QWORD *)v8 + 3) - *(_QWORD *)XPF_MCA_SECTION_GUID.Data4;
      if ( !v9 )
        break;
      v8 += 18;
