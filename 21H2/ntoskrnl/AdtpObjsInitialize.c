/*
 * XREFs of AdtpObjsInitialize @ 0x14084CD18
 * Callers:
...
int AdtpObjsInitialize()
{
  ...
  *((_QWORD *)&v33 + 1) = 0LL;
  ...
  for ( i = v9 < 0; ; i = v10 < 0 )
  {
    ...
    v14 = v39;
    LODWORD(Size) = 0;
    v10 = NtEnumerateKey(v39, v11, 0, 0LL, Size, &v36);
    if ( v10 != -1073741789 )
      goto LABEL_23;
    ...
    if ( !Pool2 )
      return -1073741801;
    LODWORD(Size) = v36;
    v10 = NtEnumerateKey(v14, v11, 0, Pool2, Size, &v36);
    if ( v10 < 0 )
      goto LABEL_23;
...
LABEL_23:
    ...
    do
    {
      if ( !v2 )
        break;
      v22 = NtEnumerateValueKey(v1, v21, 1u, 0LL, 0, &v36);
      if ( v22 == -1073741789 )
      {
        ...
        if ( !v23 )
          return -1073741801;
        v22 = NtEnumerateValueKey(v1, v21, 1u, v23, v36, &v36);
        if ( v22 >= 0 )
        {
