/*
 * XREFs of CmReplaceKey @ 0x1409136B4
 * Callers:
...
__int64 __fastcall CmReplaceKey(ULONG_PTR BugCheckParameter3, __int64 a2, int a3, struct _LOOKASIDE_LIST_EX *a4)
{
  char v6; // r14
  char v7; // r12
  ...
  v11 = CmpCmdHiveOpen(a3, 0, (int)&v30, (__int64)&v31, 17367041, 0, 0LL, 0LL, TransientPoolWithTag);
  v12 = v31;
  v10 = v11;
  if ( v11 >= 0 )
  {
...
LABEL_5:
    ...
    {
      v10 = CmpPreserveSystemHiveData(BugCheckParameter3, v12);
      if ( v10 < 0 )
      {
LABEL_18:
        ...
        if ( v7 )
          CmpFinishBeingActiveFlusherAndReconciler(BugCheckParameter3, v27, v28);
        goto LABEL_20;
      }
    }
    HvUnlockHiveFlusherExclusive(BugCheckParameter3);
    ...
    if ( v10 >= 0 )
    {
      ...
      v7 = 1;
      CmpLockRegistry(v21, v20, v22);
      HvLockHiveFlusherExclusive(BugCheckParameter3);
      if ( (*(_DWORD *)(BugCheckParameter3 + 160) & 4) != 0 )
        goto LABEL_5;
      if ( (*(_DWORD *)(BugCheckParameter3 + 4112) & 0x20) == 0 )
      {
        v10 = CmpCmdRenameHive(*(HANDLE *)(BugCheckParameter3 + 1544), ObjectInformation, 0);
        if ( v10 >= 0 )
        {
          *(_DWORD *)(BugCheckParameter3 + 160) |= 4u;
          v10 = CmpCmdRenameHive(*(HANDLE *)(v12 + 1544), 0LL, 0);
          if ( v10 < 0 || (v10 = ZwFlushBuffersFile(*(HANDLE *)(v12 + 1544), &IoStatusBlock), v10 < 0) )
          {
            if ( (int)CmpCmdRenameHive(*(HANDLE *)(BugCheckParameter3 + 1544), 0LL, 0) < 0 )
              v10 = -1073741492;
          }
        }
        goto LABEL_18;
