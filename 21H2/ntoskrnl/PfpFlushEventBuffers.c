/*
 * XREFs of PfpFlushEventBuffers @ 0x140678C70
 * Callers:
...
__int64 PfpFlushEventBuffers()
{
  ...
  v0 = 0LL;
  v1 = 0;
  PfFbBufferListFlushStandby((_SLIST_ENTRY *)&stru_140C4FD60);
  v2 = RtlpInterlockedFlushSList(&stru_140C4FDE0);
  if ( v2 )
  {
    do
    {
