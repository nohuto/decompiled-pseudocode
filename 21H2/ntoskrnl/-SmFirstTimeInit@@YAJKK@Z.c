/*
 * XREFs of ?SmFirstTimeInit@@YAJKK@Z @ 0x1402A2388
 * Callers:
 ...
 *     ExAllocatePrivateWorkerPool @ 0x1407C2784 (ExAllocatePrivateWorkerPool.c)
...
__int64 __fastcall SmFirstTimeInit(int a1, int a2)
{
  ...
  _OWORD v26[3]; // [rsp+70h] [rbp-78h] BYREF
        ...
        (v6 & 0x10) != 0) )
  {
    ...
    else
    {
      ...
      v28 = v23 & 0xFFFF0 | 0x100002;
      v27 = v23 & 0xFFFF0 | 0x100005;
