/*
 * XREFs of FlushLookUpTableBucket @ 0x140375598
 * Callers:
 ...
 *     FlattenEventEntryTree @ 0x14037599C (FlattenEventEntryTree.c)
...
LABEL_36:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v17, v5, (unsigned int *)&v31);
