/*
 * XREFs of KiTraceLogHeteroRundown @ 0x1403DB8D8
 * Callers:
...
int __fastcall KiTraceLogHeteroRundown(_DWORD *a1, __int64 a2, __int64 a3)
{
  const char *v4; // rax
  int v5; // ebx
  _KSCHEDULER_SUBNODE *SchedulerSubNode; // r13
  __int64 v7; // rax
  __int64 v8; // rcx
  ...
  if ( KeHeteroSystem )
  {
    if ( *a1 > 5u )
    {
      ...
      v33 = 0;
      v36 = 0;
      LODWORD(v17) = KeHeteroSystem;
      v25 = &v17;
      LODWORD(v18) = KeHeteroSystemVirtual;
      v28 = (int *)&v18;
      LODWORD(v19) = KeHeteroSystemQos;
      v31 = &v19;
      v16 = KiEfficiencyClassSystem;
      v34 = &v16;
      v26 = 4;
      v29 = 4;
      v32 = 4;
      v35 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)a1, (unsigned __int8 *)&dword_14002C75C, 0LL, 0LL, 6u, v24);
    }
    v5 = 0;
    v21 = 0LL;
    SchedulerSubNode = KeGetCurrentPrcb()->SchedulerSubNode;
    v7 = SchedulerSubNode->Affinity.Reserved[0];
    v20 = SchedulerSubNode->Affinity.Reserved[0];
    v8 = KeNodeBlock[v7];
    v22 = 0;
    *(_QWORD *)((char *)&v21 + 4) = v8;
    HIDWORD(v21) = *(_DWORD *)(v8 + 16);
    while ( !(unsigned int)KiEnumerateNextSchedulerSubNodeInSystem(&v20, &v23, a3) )
      ++v5;
    if ( v5 != 1 )
      __int2c();
    v9 = KiHgsPlusConfiguration;
    ...
    for ( v41[3] = "KHeteroCpuPolicySmallOrIdle"; v10 < v9; ++v10 )
    {
      ...
      do
      {
        LODWORD(v4) = v10 + v11 * SchedulerSubNode->WorkloadClasses;
        if ( *a1 > 5u )
        {
          tlgCreate1Sz_char((__int64)&v25, *v12);
          v30 = 0;
          v33 = 0;
          v36 = 0;
          v39 = 0;
          ...
          LODWORD(v4) = tlgWriteTransfer_EtwWriteTransfer(
                          (__int64)a1,
                          (unsigned __int8 *)&word_14002C6D6,
                          0LL,
                          0LL,
                          7u,
                          v24);
