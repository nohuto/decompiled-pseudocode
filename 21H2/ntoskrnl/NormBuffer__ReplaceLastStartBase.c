/*
 * XREFs of NormBuffer__ReplaceLastStartBase @ 0x1405ED5A4
 * Callers:
 *     Normalization__NormalizeCharacter @ 0x1409BDBFC (Normalization__NormalizeCharacter.c)
 * Callees:
 *     NormBuffer__AppendAndSortDecomposed @ 0x1405ED0E8 (NormBuffer__AppendAndSortDecomposed.c)
 *     Normalization__GetSecondAndThirdDecomposedCharPlane0 @ 0x1409BD19C (Normalization__GetSecondAndThirdDecomposedCharPlane0.c)
 */
