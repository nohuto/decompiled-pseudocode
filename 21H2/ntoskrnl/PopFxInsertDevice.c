/*
 * XREFs of PopFxInsertDevice @ 0x1403BE3C4
 * Callers:
...
_QWORD *__fastcall PopFxInsertDevice(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  v5 = (_QWORD *)qword_140C24818;
  if ( *(ULONG_PTR **)qword_140C24818 != &PopFxDeviceList )
    __fastfail(3u);
  a3[1] = qword_140C24818;
  *a3 = &PopFxDeviceList;
  *v5 = a3;
  qword_140C24818 = (__int64)a3;
