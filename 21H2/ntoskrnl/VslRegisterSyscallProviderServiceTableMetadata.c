/*
 * XREFs of VslRegisterSyscallProviderServiceTableMetadata @ 0x1406584BC
 * Callers:
...
__int64 __fastcall VslRegisterSyscallProviderServiceTableMetadata(unsigned int a1, ULONG a2, struct _MDL *a3)
{
  __int64 v4; // rsi
  __int64 result; // rax
  unsigned int v7; // ebx
  ...
  if ( (int)result >= 0 )
  {
    ...
    v9[3] = v8[7];
    v9[1] = v4;
    v7 = VslpEnterIumSecureMode(2u, 227, 0, (__int64)v9);
