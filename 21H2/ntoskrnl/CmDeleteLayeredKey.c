/*
 * XREFs of CmDeleteLayeredKey @ 0x1404ED078
 * Callers:
 ...
 *     CmpInitializeKcbStack @ 0x1406C3CF0 (CmpInitializeKcbStack.c)
 ...
 *     CmpInitializeDiscardReplaceContext @ 0x140876230 (CmpInitializeDiscardReplaceContext.c)
