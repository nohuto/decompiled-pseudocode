/*
 * XREFs of Normalization__NormalizeCharacter @ 0x1409186F0
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x1409177CC (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x140918534 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x14058DBB0 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x14058DBE0 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x14058DC14 (IsHangulLV.c)
 ...
 *     NormBuffer__RecheckStartCombinations @ 0x14058E020 (NormBuffer__RecheckStartCombinations.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x14058E25C (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1409177CC (Normalization__AppendDecomposedChar.c)
