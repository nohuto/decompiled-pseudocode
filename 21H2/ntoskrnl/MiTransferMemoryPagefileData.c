/*
 * XREFs of MiTransferMemoryPagefileData @ 0x14059A568
 * Callers:
...
char __fastcall MiTransferMemoryPagefileData(__int64 a1, __int64 a2, int a3, int a4)
{
  _UNKNOWN **v4; // rax
  __int64 v9; // rsi
  _QWORD *v10; // r14
  ...
  while ( v11 )
  {
    ...
    v14 = v13;
    LOBYTE(v4) = MiCopyMemoryPagefileData(
                   v10,
                   v9,
                   *(_QWORD *)(PageFileMemoryExtent + 32) + (unsigned int)(a3 - *(_DWORD *)(PageFileMemoryExtent + 24)),
                   v13,
                   a4);
    v11 -= v14;
    v10 += v14;
