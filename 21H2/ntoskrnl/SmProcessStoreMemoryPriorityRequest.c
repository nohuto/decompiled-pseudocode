/*
 * XREFs of SmProcessStoreMemoryPriorityRequest @ 0x1406E5B58
 * Callers:
      ...
      else if ( ((__int64)Handle[0] & 0x100) != 0 )
      {
        ...
        if ( v7 >= 0 )
        {
          ...
          if ( ((__int64)Handle[0] & 0x200) != 0 )
          {
            ...
            {
              v5 = 1;
              KiStackAttachProcess((_KPROCESS *)Object, 0LL, (__int64)v15, v8);
            }
            v12 = Object;
            v10 = SmpKeyedStoreEntryGet((ULONG_PTR)&qword_140D321C8, &v12, 0LL, 0);
            if ( v10 )
              *(_BYTE *)(*(_QWORD *)SmKmStoreRefFromStoreIndex((__int64)&SmGlobals, *(_WORD *)(v10 + 16) & 0x3FF)
                       + 6023LL) = 1;
            else
              v7 = -1073741632;
          }
