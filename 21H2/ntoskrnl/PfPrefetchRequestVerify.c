/*
 * XREFs of PfPrefetchRequestVerify @ 0x1406C4FF0
 * Callers:
 ...
 *     PfRequestRangeCheck @ 0x1406C52FC (PfRequestRangeCheck.c)
 *     PfPrefetchRequestPrepareForVerify @ 0x1406C533C (PfPrefetchRequestPrepareForVerify.c)
 */
