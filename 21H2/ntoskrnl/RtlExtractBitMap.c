/*
 * XREFs of RtlExtractBitMap @ 0x140586FD0
 * Callers:
    ...
    if ( (TargetBit & 7) != 0 )
    {
      ...
      if ( SizeOfBitMap )
      {
        ...
        if ( SizeOfBitMap > 32 - v14 )
          *Buffer = ((v20 & -v16) >> v14) | ((v15[1] & ((1 << (SizeOfBitMap + v14 - 32)) - 1)) << (32 - v14)) | v21;
        else
          *Buffer = v21 | ((v20 & (((1 << SizeOfBitMap) - 1) << v14)) >> v14);
      }
    }
    else
    {
