/*
 * XREFs of ?StDmPageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x1402DED2C
 * Callers:
 ...
 * Callees:
 *     MmAreMdlPagesCached @ 0x1402AC740 (MmAreMdlPagesCached.c)
