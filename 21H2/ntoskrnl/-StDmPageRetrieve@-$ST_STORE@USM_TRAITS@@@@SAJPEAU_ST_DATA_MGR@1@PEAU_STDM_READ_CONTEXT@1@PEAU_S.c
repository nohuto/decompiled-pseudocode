/*
 * XREFs of ?StDmPageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x14029007C
 * Callers:
 ...
 * Callees:
 *     MmAreMdlPagesCached @ 0x14022A340 (MmAreMdlPagesCached.c)
