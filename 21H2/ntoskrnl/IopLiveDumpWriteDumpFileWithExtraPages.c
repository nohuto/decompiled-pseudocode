/*
 * XREFs of IopLiveDumpWriteDumpFileWithExtraPages @ 0x14093DA18
 * Callers:
 ...
 *     IopLiveDumpGetExtraMergePages @ 0x14093C6D4 (IopLiveDumpGetExtraMergePages.c)
...
__int64 __fastcall IopLiveDumpWriteDumpFileWithExtraPages(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 728) = 0LL;
  *(_QWORD *)(a1 + 736) = 0LL;
  IopLiveDumpGetNtMergePages(a1, (int)v6, &v52, &v50, &v55);
  v56 = v6;
  ...
  while ( v13 || v11 )
  {
    ...
    if ( v11 && v16[v11 - 1] < *v15 )
    {
      ...
      v58 = v55;
      v46 = 1;
      IopLiveDumpGetNtMergePages(a1, (int)v61, &v52, &v50, &v55);
      v56 = v23;
      v11 = v50;
      goto LABEL_38;
    }
                ...
                SecureDumpHeader >= 0) )
          {
            ...
            *(_DWORD *)(v2 + 4176) |= 0x10u;
            if ( *(_BYTE *)(a1 + 976) )
            {
              ...
              SecureDumpHeader = SecureDump_Get_SecureDumpHeader(v2, v42, *(_DWORD *)(a1 + 984));
              if ( SecureDumpHeader >= 0 )
                goto LABEL_81;
            }
            else
...
LABEL_81:
              ...
              if ( SecureDumpHeader >= 0 && *(_BYTE *)(a1 + 976) )
              {
                v44 = *(_DWORD *)(a1 + 984);
                ByteOffset.QuadPart = 0LL;
