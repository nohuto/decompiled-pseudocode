/*
 * XREFs of MiFindSuitableLookasideReplacement @ 0x1402E9070
 * Callers:
...
_BOOL8 __fastcall MiFindSuitableLookasideReplacement(int a1, _QWORD *a2, unsigned int a3, unsigned __int64 a4, int a5)
{
  __int64 v6; // r13
  ...
  if ( a1 )
    ...
    StandbyPageType = MiGetStandbyPageType(0xAAAAAAAAAAAAAAABuLL * ((__int64)(a4 + 0x220000000000LL) >> 4));
  v33 = StandbyPageType;
  v15 = 0LL;
  v32 = StandbyPageType;
  while ( 1 )
...
LABEL_21:
  ...
  v7 = v8 + 48 * v18;
LABEL_12:
  if ( !v13 && MiIsDecayPfn(v18) )
  {
    v32 = MiGetStandbyPageType(v30);
    goto LABEL_21;
  }
...
LABEL_23:
  ...
  if ( v22 != -1LL && (v22 < qword_140C52CE0 || v22 >= qword_140C52CE0 + 2048) )
    MiPurgingPageFromLookaside(3LL);
