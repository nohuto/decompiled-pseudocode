/*
 * XREFs of MiMapViewOfPhysicalSection @ 0x140852834
 * Callers:
...
LABEL_38:
    UNLOCK_ADDRESS_SPACE_UNORDERED(v35, v7);
    if ( v38 != -1LL )
    {
      v30 = -1LL;
      v31 = 0LL;
...
LABEL_44:
          if ( v31 )
          {
            MiDereferenceIoPages(1, v30, v31);
            v30 = -1LL;
            v31 = 0LL;
          }
        }
  ...
  v18 = v15 + *v43;
  if ( !MiIsVaRangeAvailable(v7, v18, *(_QWORD *)(a1 + 24), *(_QWORD *)a1, *(_QWORD *)(a1 + 8)) )
  {
    inserted = -1073741800;
    goto LABEL_38;
  }
LABEL_11:
  v41 = v19 >> 12;
  v40 = v17 >> 12;
  MiUpdateVadStartVpn(v11, v19 >> 12);
...
LABEL_14:
  ...
  if ( v14 <= v14 + ((unsigned int)v21 | ((unsigned __int64)BYTE4(v21) << 32)) - (v24 | (v22 << 32)) )
  {
    do
    {
      ...
      if ( v25 )
      {
        inserted = MiReferenceIoPages(1, v27, v25, v23, 0LL, 0LL);
        if ( inserted < 0 )
          goto LABEL_38;
        v29 = v25 + v34 - 1;
        v25 = 0LL;
...
LABEL_20:
  ...
  if ( inserted < 0 )
    goto LABEL_38;
  MiInsertViewOfPhysicalSection(v7, v11, v14);
  if ( v39 )
...
LABEL_26:
  ...
  MiLockVad(v35, v11);
  UNLOCK_ADDRESS_SPACE_UNORDERED(v35, v7);
  v33 = MiCommitVadMetadataBits(v11, 0LL, *(_DWORD *)(a1 + 120));
  if ( v33 >= 0 )
  {
    MiUnlockVad(v35, v11);
    goto LABEL_26;
  ...
  MiReferenceVad(v11);
  MiDeleteVad((unsigned __int8 *)v11, 0LL, 0);
