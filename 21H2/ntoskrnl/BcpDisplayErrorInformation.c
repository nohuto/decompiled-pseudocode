/*
 * XREFs of BcpDisplayErrorInformation @ 0x14064DF74
 * Callers:
 *     BgpFwDisplayBugCheckScreen @ 0x14064E9C0 (BgpFwDisplayBugCheckScreen.c)
 * Callees:
 *     __security_check_cookie @ 0x1403DF760 (__security_check_cookie.c)
 *     BcpConvertBugDataToString @ 0x14064D9B4 (BcpConvertBugDataToString.c)
 ...
 *     BcpSanitizeDriverName @ 0x14064E684 (BcpSanitizeDriverName.c)
 */
...
__int64 __fastcall BcpDisplayErrorInformation(unsigned int a1, int a2, __int64 a3, __int64 a4, __int64 a5, char a6)
{
  ...
  BcpDisplayCriticalString(&stru_140C5A7D0.Length, v9, a3, a1);
  BcpDisplayCriticalString(&stru_140C5A7E0.Length, dword_140C0B2E0[18 * v7 + 1], v11, (unsigned int)v7);
  v12 = dword_140C0B2E0[18 * v7 + 11];
  LODWORD(BcpCursor) = v6;
  HIDWORD(BcpCursor) = v12 + dword_140C4EF80;
  v14 = dword_140C0B2E0[18 * v7];
  dword_140C4EF80 += v12 + v12;
  v13 = dword_140C4EF80;
  BcpDisplayCriticalString(&stru_140C5A720.Length, v14, v15, (unsigned int)v7);
  v16 = v13 + dword_140C0B2E0[18 * v7 + 11];
  HIDWORD(BcpCursor) = v13;
  LODWORD(BcpCursor) = v6;
  v17 = dword_140C0B2E0[18 * v7];
  dword_140C4EF80 = v16;
  BcpDisplayCriticalString(&stru_140C5A7C0.Length, v17, v18, (unsigned int)v7);
  BcpDisplayCriticalCharacter(v19, dword_140C0B2E0[18 * v7]);
  BcpDisplayCriticalString((unsigned __int16 *)(a5 + 16), dword_140C0B2E0[18 * v7], v20, (unsigned int)v7);
  v22 = 0LL;
  if ( a4 )
  {
    ...
    BcpDisplayCriticalString(&stru_140C5A7B0.Length, v24, v21, (unsigned int)v7);
    BcpDisplayCriticalCharacter(v25, dword_140C0B2E0[18 * v7]);
    v36[0] = 0x800000;
    v37 = &v39;
    BcpSanitizeDriverName(a4, v36);
    BcpDisplayCriticalString((unsigned __int16 *)v36, dword_140C0B2E0[18 * v7], v26, (unsigned int)v7);
  }
  v27 = 4LL;
  v34 = BcpCursor;
  v28 = v38;
  ...
  do
  {
    ...
    {
      BcpDisplayCriticalString((unsigned __int16 *)(v22 + v28 + 32), dword_140C0B2E0[18 * v7], v30, (unsigned int)v7);
      LODWORD(BcpCursor) = 0;
      HIDWORD(BcpCursor) = dword_140C4EF80;
    }
    v22 += 16LL;
    ++v10;
    --v27;
