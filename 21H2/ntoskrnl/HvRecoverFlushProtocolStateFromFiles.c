/*
 * XREFs of HvRecoverFlushProtocolStateFromFiles @ 0x14091A344
 * Callers:
...
__int64 __fastcall HvRecoverFlushProtocolStateFromFiles(__int64 a1, __int64 a2)
{
  ...
  *(_OWORD *)v36 = 0LL;
  ...
  HiveHeader = HvpGetHiveHeader(a1, &v27, &v26);
  v8 = v27;
  v9 = 2;
  if ( HiveHeader == 2 )
  {
...
LABEL_3:
    ...
    v11 = -1073741670;
LABEL_4:
    SetFailureLocation(a2, 0, 38, v10, v25);
    goto LABEL_33;
  }
  if ( HiveHeader == 7 )
  {
...
LABEL_7:
  ...
  else
  {
    ...
    v15 = HvAnalyzeLogFiles((unsigned int)&v26, v12, v7, (unsigned int)v28, v9, (__int64)v37, v2);
    v11 = v15;
    if ( v15 >= 0 )
    {
      ...
      *(_BYTE *)(a1 + 194) = 0;
      if ( v18 )
      {
        ...
        do
        {
          v19 = HvpLogTypeToLogArrayIndex(v37[3 * *v16 + 1]);
      ...
      *(_QWORD *)(*(_QWORD *)(a1 + 64) + 12LL) = v26;
      v22 = HvpHeaderCheckSum(*(_QWORD *)(a1 + 64), v16, v17);
      *(_DWORD *)(v23 + 508) = v22;
      v11 = 0;
    }
    else
    {
      SetFailureLocation(a2, 0, 38, v15, 0x40u);
    }
    if ( v2 )
...
LABEL_33:
  if ( v8 )
    (*(void (__fastcall **)(char *, _QWORD))(a1 + 32))(v8, *(unsigned int *)(a1 + 132));
  if ( Privileges[1] )
    CmSiFreeMemory(Privileges[1]);
  if ( v36[0] )
    CmSiFreeMemory(v36[0]);
  return v11;
}
