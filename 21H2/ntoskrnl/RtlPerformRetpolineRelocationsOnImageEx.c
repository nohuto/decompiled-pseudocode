/*
 * XREFs of RtlPerformRetpolineRelocationsOnImageEx @ 0x1405900EC
 * Callers:
 ...
 *     RtlpConstructSwitchJumpRelocationFixup @ 0x140590694 (RtlpConstructSwitchJumpRelocationFixup.c)
 *     RtlpIsAddressInIgnoreRegion @ 0x14059075C (RtlpIsAddressInIgnoreRegion.c)
 */
