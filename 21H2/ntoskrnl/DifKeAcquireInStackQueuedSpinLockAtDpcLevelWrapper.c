/*
 * XREFs of DifKeAcquireInStackQueuedSpinLockAtDpcLevelWrapper @ 0x140611F10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifKeAcquireInStackQueuedSpinLockAtDpcLevelWrapper(volatile __int64 *a1, _QWORD *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  ...
  volatile __int64 *v16; // [rsp+30h] [rbp-18h]
...
LABEL_18:
  *a2 = 0LL;
  a2[1] = a1;
  result = KxAcquireQueuedSpinLock((__int64)a2, a1);
  if ( APIThunkContextById )
  {
