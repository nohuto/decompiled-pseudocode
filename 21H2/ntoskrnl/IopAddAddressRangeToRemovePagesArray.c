/*
 * XREFs of IopAddAddressRangeToRemovePagesArray @ 0x14055CDB4
 * Callers:
...
void __fastcall IopAddAddressRangeToRemovePagesArray(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  if ( IopRemovePagesArray && a2 )
  {
    ...
    if ( *(_DWORD *)IopRemovePagesArray )
    {
      ...
      {
        v9 = v8;
        v10 = *(_QWORD *)(IopRemovePagesArray + 16LL * (unsigned int)v7 + 16);
        v11 = *(_QWORD *)(IopRemovePagesArray + 16LL * (unsigned int)v7 + 8);
        v12 = v10 < v8;
        v8 = v10;
        if ( v12 )
          v6 = (unsigned int)v7;
        ...
        if ( v10 >= v9 )
          v8 = v9;
        v14 = v13 - 1;
        if ( (v13 - 1 >= *(_QWORD *)(*(_QWORD *)(CrashdmpDumpBlock + 8) + 48LL) || a1 <= v13) && (!v11 || v4 >= v11 - 1) )
          break;
        v7 = (unsigned int)(v7 + 1);
        if ( (unsigned int)v7 >= *(_DWORD *)IopRemovePagesArray )
          goto LABEL_24;
      }
      if ( a1 < v11 )
      {
        *(_QWORD *)(IopRemovePagesArray + 16LL * (unsigned int)v7 + 8) = a1;
        if ( v4 > v14 )
      ...
      {
        *(_QWORD *)(IopRemovePagesArray + 16 * (v7 + 1)) = v4 - v11 + 1;
      }
    }
    else
    {
      v8 = 0LL;
LABEL_24:
      if ( (unsigned int)v7 >= *(_DWORD *)(IopRemovePagesArray + 4) )
      {
        if ( v8 < a2 )
        {
          v16 = 2 * v6;
          *(_QWORD *)(IopRemovePagesArray + 8 * v16 + 8) = a1;
      ...
      else
      {
        ...
        *(_QWORD *)(IopRemovePagesArray + 8 * v15 + 8) = a1;
