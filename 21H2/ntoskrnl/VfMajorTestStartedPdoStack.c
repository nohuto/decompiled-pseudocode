/*
 * XREFs of VfMajorTestStartedPdoStack @ 0x140A92774
 * Callers:
...
__int64 (__fastcall *__fastcall VfMajorTestStartedPdoStack(__int64 a1))(_QWORD)
{
  ...
  if ( (_DWORD)result && (VfRuleClasses & 0x400000) == 0 )
  {
    ...
    do
    {
      v4 = (void (__fastcall *)(__int64))*((_QWORD *)&unk_140D597A0 + 12 * v3);
      if ( v4 )
        v4(a1);
    ...
    if ( qword_140D5A220 )
      return (__int64 (__fastcall *)(_QWORD))qword_140D5A220(a1);
  }
  return result;
}
