/*
 * XREFs of PspQueryJobHierarchyAccountingInformation @ 0x140685304
 * Callers:
...
__int64 __fastcall PspQueryJobHierarchyAccountingInformation(char *Object, __int64 a2)
{
  ...
  PspEnumJobsAndProcessesInJobHierarchy(Object, (__int64)v21, 1);
  v5 = v21[14];
  ...
  *(_QWORD *)(a2 + 440) = v21[25] + *((_QWORD *)Object + 223);
  ...
  if ( v7 )
    *(_QWORD *)(a2 + 152) += KeQuerySchedulingGroupReadyTime(v7 + 128);
  v8 = *((_QWORD *)Object + 190);
  v9 = (_OWORD *)(a2 + 160);
  if ( v8 )
  {
    PsAddProcessEnergyValues((__int64)&v21[32], v8);
    v10 = 2LL;
    v11 = &v21[32];
    do
    {
  ...
  return PspUnlockJob(v20, CurrentThread);
}
