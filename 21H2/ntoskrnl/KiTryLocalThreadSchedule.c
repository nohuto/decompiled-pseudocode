/*
 * XREFs of KiTryLocalThreadSchedule @ 0x140342260
 * Callers:
 ...
 *     KiQueryDpcRuntimeHistory @ 0x140342740 (KiQueryDpcRuntimeHistory.c)
 *     KiFindRankBiasedIdleSmtSet @ 0x140573CBC (KiFindRankBiasedIdleSmtSet.c)
 */

__int64 __fastcall KiTryLocalThreadSchedule(__int64 a1, __int64 a2, __int64 a3, _WORD *a4, char a5, char a6)
{
  bool v7; // zf
  __int64 v10; // rsi
  __int64 v11; // rax
  ...
  v25[0] = 0LL;
  if ( v7 || *(_BYTE *)(a3 + 643) != 15 && *(_DWORD *)(a3 + 84) >= (unsigned int)KiShortExecutionCycles )
    return 0LL;
  v10 = *(_QWORD *)(a1 + 192);
...
LABEL_19:
        if ( v17 != 2 )
        {
          ...
          if ( v17 < v20 || v17 - v20 < KiDispatchInterruptCost )
            return a1;
        }
        goto LABEL_24;
      }
      if ( (unsigned __int8)KiQueryDpcRuntimeHistory(a1, *(_QWORD *)(a1 + 13088), v25) )
      {
        v18 = v25[0];
...
LABEL_24:
  ...
  if ( (*(_BYTE *)(v10 + 184) & 1) == 0 )
    goto LABEL_29;
  v21 = a5;
  if ( !a5 || !(unsigned __int8)KiFindRankBiasedIdleSmtSet(a1, &v26) )
  {
...
LABEL_31:
  ...
  return KiProcessorBlock[KiProcessorNumberToIndexMappingTable[64 * v22 + (((_BYTE)v24 + (_BYTE)v23) & 0x3F)]];
}
