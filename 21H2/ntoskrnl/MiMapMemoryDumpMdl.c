...
char __fastcall MiMapMemoryDumpMdl(unsigned __int64 a1, __int64 a2, __int64 a3, char a4)
{
  ...
  *(_QWORD *)(a3 + 24) = a1 + v15;
  ...
  do
  {
    ...
    ValidPte = MiMakeValidPte((unsigned __int64)v14, v20, ProtectionPfnCompatible | 0xA0000000);
    v23 = 0;
