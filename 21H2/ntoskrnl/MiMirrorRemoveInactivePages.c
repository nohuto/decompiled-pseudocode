/*
 * XREFs of MiMirrorRemoveInactivePages @ 0x14058CF54
 * Callers:
 ...
 *     MiGetBaseResidentPageForBugCheck @ 0x1405AF110 (MiGetBaseResidentPageForBugCheck.c)
 */
  ...
  do
  {
    ...
    if ( (v10 & 0x10000000000LL) != 0 )
    {
      ...
      if ( (v20 & 0xFFFFFFFA) == 0 && v20 != 4
        || v21 == 1
        || (v19 & 0x40) != 0 && v14 && MiGetLeafVa(v14) <= 0xFFFF800000000000uLL )
      {
        goto LABEL_13;
      }
    }
