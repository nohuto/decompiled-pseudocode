/*
 * XREFs of MiInitializeLargePageColorSizes @ 0x1403B7AA0
 * Callers:
...
__int64 MiInitializeLargePageColorSizes()
{
  ...
  v7 = 0LL;
  v8 = 0LL;
  result = ((__int64 (__fastcall *)(__int64, __int64, int (__fastcall **)(_QWORD, __int64, __int128 *), int *))off_140C020D8[0])(
             49LL,
             8LL,
             &v5,
             &v4);
