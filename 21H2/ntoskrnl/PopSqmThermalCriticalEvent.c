/*
 * XREFs of PopSqmThermalCriticalEvent @ 0x1409A023C
 * Callers:
...
void *__fastcall PopSqmThermalCriticalEvent(__int64 a1, unsigned int a2, int a3)
{
  ...
  if ( result )
  {
    ...
    {
      if ( tlgKeywordOn((__int64)&dword_140C03A00, 0x800000000000LL) )
      {
        v10 = *(_BYTE *)(a1 + 65);
        v11 = *(_BYTE *)(a1 + 228) == 0;
        v22 = &v14;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_14003279B,
          0LL,
          0LL,
          0xBu,
          &v21);
