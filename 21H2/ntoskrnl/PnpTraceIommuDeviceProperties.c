/*
 * XREFs of PnpTraceIommuDeviceProperties @ 0x1408B1D00
 * Callers:
...
void PnpTraceIommuDeviceProperties()
{
  ...
  if ( (unsigned int)dword_140C02E00 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02E00, 0x400000000000LL) )
    {
      ...
      v5 = 2LL;
      v9 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02E00, (unsigned __int8 *)byte_14002523B, 0LL, 0LL, 5u, &v3);
    }
  }
}
