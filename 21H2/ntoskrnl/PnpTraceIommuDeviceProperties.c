/*
 * XREFs of PnpTraceIommuDeviceProperties @ 0x140957610
 * Callers:
...
void PnpTraceIommuDeviceProperties()
{
  ...
  if ( (unsigned int)dword_140C06550 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C06550, 0x400000000000LL) )
    {
      ...
      v8 = 2LL;
      v12 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C06550, (unsigned __int8 *)byte_14002BCA1, 0LL, 0LL, 6u, &v4);
    }
  }
}
