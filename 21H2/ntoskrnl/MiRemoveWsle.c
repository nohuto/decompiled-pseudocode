/*
 * XREFs of MiRemoveWsle @ 0x140343D30
 * Callers:
...
__int64 __fastcall MiRemoveWsle(__int64 a1, unsigned __int64 a2, __int64 a3, char a4, int a5, int a6)
{
  ...
  v40 = 0LL;
  if ( v6 == 2 )
    v11 = (volatile signed __int64 *)&unk_140C4F800;
  else
  ...
  if ( (*(_BYTE *)(a1 + 184) & 7) == 4 )
  {
    ...
    {
      LODWORD(xmmword_140C4CD88) = xmmword_140C4CD88 - a3;
    }
    else if ( (unsigned int)MiGetSystemRegionType(a2) == 12
           && MiLookupDataTableEntry((__int64)((((a2 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL) << 25) >> 16, 2) )
    {
