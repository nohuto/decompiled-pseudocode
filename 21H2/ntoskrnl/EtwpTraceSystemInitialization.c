/*
 * XREFs of EtwpTraceSystemInitialization @ 0x140AFAD4C
 * Callers:
...
char EtwpTraceSystemInitialization()
{
  ...
  if ( Version >= 0 )
  {
    ...
    if ( (unsigned int)dword_140C043E0 > 5 && tlgKeywordOn((__int64)&dword_140C043E0, 0x800000000000LL) )
    {
      ...
      *(_QWORD *)&v30 = v3;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140034933,
        0LL,
        0LL,
        0xCu,
        &v47);
    ...
    if ( (_BYTE)Version )
    {
      ...
      {
        LOBYTE(Version) = tlgKeywordOn((__int64)&dword_140C043E0, 0x400000000000LL);
        if ( (_BYTE)Version )
        {
          LOBYTE(v16) = v11;
      ...
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      if ( (_BYTE)Version )
      {
        *(_QWORD *)&UserData.Size = 264LL;
        ...
        LOBYTE(Version) = EtwWriteEx(v8, &BootPerformanceData, 0LL, 0, 0LL, 0LL, 1u, &UserData);
      }
      v9 = KeLoaderBlock_0;
      v10 = *(_QWORD *)(KeLoaderBlock_0 + 240);
      if ( (*(_DWORD *)(v10 + 132) & 0x100) != 0 || *(_QWORD *)(v10 + 224) )
      {
        v12 = EtwKernelProvRegHandle;
        ...
        if ( (_BYTE)Version )
        {
          *(_QWORD *)&UserData.Size = 8LL;
          ...
          v36 = 64LL;
          p_SystemTimePrecise = (__int64 *)v13;
          LOBYTE(Version) = EtwWriteEx(v12, &VsmPerformanceData, 0LL, 0, 0LL, 0LL, 2u, &UserData);
        }
      }
      if ( (qword_140C15C78 & 4) != 0 )
      {
        v27 = (*(_DWORD *)(*(_QWORD *)(KeLoaderBlock_0 + 240) + 2648LL) >> 14) & 1;
        SystemTimePrecise = RtlGetSystemTimePrecise();
        v14 = *(_QWORD *)(KeLoaderBlock_0 + 240) + 2944LL;
        *(_QWORD *)&UserData.Size = 8LL;
        UserData.Ptr = v14;
        p_SystemTimePrecise = &SystemTimePrecise;
        v36 = 8LL;
        v37 = (_DWORD *)(*(_QWORD *)(KeLoaderBlock_0 + 240) + 2936LL);
        v39 = &v27;
        v38 = 4LL;
        v40 = 4LL;
