/*
 * XREFs of CmpFindSubKeyByNumberFromMergedView @ 0x140916E20
 * Callers:
...
LABEL_85:
    ...
    if ( v14 != -1 )
    {
      ...
      v25 = (*(_BYTE *)(v24 + 140) & 1) != 0
          ? HvpGetCellFlat(v24, v14, &v47)
          : HvpGetCellPaged(v24, v14, (unsigned int *)&v47);
      v50 = v25;
      if ( !v25 )
      {
LABEL_35:
...
LABEL_37:
    ...
    else
    {
      ...
      if ( (*(_BYTE *)(v26 + 140) & 1) != 0 )
        CellFlat = HvpGetCellFlat(v26, v13, &v49);
      else
        CellFlat = HvpGetCellPaged(v26, v13, (unsigned int *)&v49);
      v48 = CellFlat;
      v28 = CellFlat;
      if ( !CellFlat )
        goto LABEL_35;
...
LABEL_75:
    if ( v28 )
    {
      ...
      if ( (*(_BYTE *)(v36 + 140) & 1) != 0 )
        HvpReleaseCellFlat(v36, &v49);
      else
        HvpReleaseCellPaged(v36, (unsigned int *)&v49);
      v48 = 0LL;
    }
    v9 = a3;
    if ( v50 )
    {
      ...
      if ( (*(_BYTE *)(v37 + 140) & 1) != 0 )
        HvpReleaseCellFlat(v37, &v47);
      else
        HvpReleaseCellPaged(v37, (unsigned int *)&v47);
      v9 = a3;
      goto LABEL_2;
    }
  }
  v33 = CmpCompareKeysByName(v28, v50);
  v34 = v33 < 0;
  v35 = v33 <= 0;
  v32 = v12 + 1;
  v11 = 1;
...
LABEL_38:
  ...
  if ( v50 )
  {
    ...
    if ( (*(_BYTE *)(v29 + 140) & 1) != 0 )
      ...
      HvpReleaseCellPaged(v29, (unsigned int *)&v47);
  }
  if ( v48 )
  {
    v38 = *(_QWORD *)(v17 + 32);
    if ( (*(_BYTE *)(v38 + 140) & 1) != 0 )
      HvpReleaseCellFlat(v38, &v49);
    else
      HvpReleaseCellPaged(v38, (unsigned int *)&v49);
  }
  *a9 = v11 != 0 ? v12 + 1 : 0;
  return v10;
}
