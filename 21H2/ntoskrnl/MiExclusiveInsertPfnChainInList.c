/*
 * XREFs of MiExclusiveInsertPfnChainInList @ 0x14022DBD4
 * Callers:
...
__int64 __fastcall MiExclusiveInsertPfnChainInList(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    ...
    *v6 ^= (v15 ^ *v6) & 0xFFFFFFFFFFLL;
    MiSetPfnBlink(v5, v19, 1LL);
    if ( ((v13 >> 12) & 0xFFFFFFFFFFLL) == v15 )
    {
      result = MiMakeTransitionPte(*(_QWORD *)(a1 + 16), 4LL);
      *(_QWORD *)(v4 + 16) = result;
    }
    else
    {
  ...
  if ( *(_DWORD *)(a1 + 8) == 2 )
  {
    ...
    MiPfnToStandbyLookaside(v9, v4, v17);
    v10 = v18;
    v11 = *(_QWORD *)(a1 + 16);
    v12 = *((_QWORD *)v18 + 3);
    if ( v12 == 0x3FFFFFFFFFLL )
      *((_QWORD *)v18 + 2) = v11;
      ...
      MiSetNextStandbyPageSameNodeNoLockAsserts(48 * v12 - 0x220000000000LL, v11);
    MiSetPfnNodeBlinkLow(v5, v12);
  ...
  if ( !v4 )
  {
    *v6 = *v6 & 0xFFFFFF0000000000uLL | 0x3FFFFFFFFFLL;
    return MiSetPfnBlink(v5, v7, 1LL);
  }
  return result;
}
