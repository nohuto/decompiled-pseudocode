/*
 * XREFs of PnpIsDeviceInstanceEnabled @ 0x14076B030
 * Callers:
...
__int64 __fastcall PnpIsDeviceInstanceEnabled(void *a1, __int64 a2, int a3)
{
  ...
  v7 = 0;
  v8 = 0LL;
  v9 = PnpDeviceObjectFromDeviceInstanceWithTag(a2, 1433431632LL);
  v10 = (void *)v9;
  if ( !v9
...
LABEL_6:
        v19 = 4;
        if ( (int)CmGetDeviceRegProp(PiPnpRtlCtx, v8, v13, 11, (__int64)&v20, (__int64)&v23, (__int64)&v19, 0) < 0
          || v20 == 4 && v19 == 4 )
        {
          v15 = v23;
        }
...
LABEL_13:
      ...
      if ( (int)CmOpenDeviceRegKey(PiPnpRtlCtx, v21, 16, 0, 131097, 0, (__int64)&Handle, 0LL) >= 0 )
      {
        v13 = (int)Handle;
        v7 = 1;
        goto LABEL_6;
...
LABEL_15:
  if ( v7 )
    ZwClose(Handle);
  if ( v8 )
    PnpUnicodeStringToWstrFree(v8, a2);
  return v6;
}
