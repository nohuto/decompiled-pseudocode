/*
 * XREFs of RtlpHpLfhSubsegmentFreeBlock @ 0x140364860
 * Callers:
...
__int64 __fastcall RtlpHpLfhSubsegmentFreeBlock(__int64 a1, signed __int64 *a2, __int64 a3, unsigned int a4)
{
  ...
  v11 = *(_QWORD *)(a1
                  + 8LL
                  * *((unsigned __int8 *)RtlpLfhBucketIndexMap + (((unsigned int)(unsigned __int16)v10 + 15) >> 4))
                  + 128);
  ...
  *((_WORD *)v4 + 18) = v17;
  ...
  {
    RtlpLogHeapFailure(17, *(_QWORD *)a1, v5, (_DWORD)v4, (unsigned int)v15, 0LL);
    return 0LL;
  }
  if ( *((_BYTE *)v4 + 45) > 1u )
  {
    ...
    if ( v24 < v25 )
    {
      ...
      if ( (_DWORD)v26 != -1 )
        RtlpHpLfhSubsegmentDecommitPages(a1, (_DWORD)v4, v26, 2, v7);
    }
  }
  v9 = a1;
LABEL_18:
    ...
    if ( !v6 && (!(_WORD)v30 || (unsigned __int16)v30 == v29 - 1) )
    {
      ...
      for ( i = v35; ; v35 = i )
      {
        while ( 1 )
        {
          ...
          v37 = v36 + 16;
          v6 = v36;
          v38 = RtlpHpAcquireLockExclusive(v36 + 16, v35);
          v36 = v4[2];
          ...
          else
          {
            ...
            for ( j = 0; j < 6; ++j )
            {
              if ( (*(_QWORD *)p_Process & 0x7FFFFFFFFFFFFFFCLL) == (v37 & 0x7FFFFFFFFFFFFFFCLL)
                && *(_BYTE *)(p_Process + 18)
                && (*(_DWORD *)p_Process & 1) == 0
                && *(_DWORD *)(p_Process + 8) == v75 )
              {
                ...
                *(_QWORD *)p_Process = 0LL;
                ...
                if ( v78 )
                {
                  KiAbThreadRemoveBoostsSlow((ULONG_PTR)CurrentThread, v37, v78);
                  v35 = 0;
                }
                goto LABEL_148;
              }
...
LABEL_148:
            ...
            v56 = v79->SpecialApcDisable++ == -1;
            if ( v56 && ($CEA84C04E3712D858E5667A507841A2A *)v79->ApcState.ApcListHead[0].Flink != &v79->152 )
            {
...
LABEL_45:
  ...
  if ( *(_BYTE *)(a1 + 57) )
  {
    ...
    if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && (v52 = KeGetCurrentIrql(), v52 <= 0xFu) )
    {
  ...
  else
  {
    ...
    for ( k = 0; k < 6; ++k )
    {
        ...
        && *(_DWORD *)(v58 + 8) == v51 )
      {
        ...
        *(_BYTE *)(v58 + 17) = 0;
        *(_QWORD *)v58 = 0LL;
        v50->AbEntrySummary |= 1 << *(_BYTE *)(v58 + 16);
        _enable();
        if ( v60 )
          KiAbThreadRemoveBoostsSlow((ULONG_PTR)v50, v48, v60);
        goto LABEL_86;
      }
      v58 += 96LL;
    }
...
LABEL_86:
    ...
    v56 = v61->SpecialApcDisable++ == -1;
    if ( v56 && ($CEA84C04E3712D858E5667A507841A2A *)v61->ApcState.ApcListHead[0].Flink != &v61->152 )
      KiCheckForKernelApcDelivery();
  }
  v6 = 0LL;
  if ( v4 )
    RtlpHpLfhBucketAddSubsegment(
      a1,
      *(_QWORD *)(a1
                + 8LL * *((unsigned __int8 *)RtlpLfhBucketIndexMap + (((unsigned int)(unsigned __int16)v10 + 15) >> 4))
                + 128),
      v4,
      a4);
LABEL_26:
  if ( v6 )
  {
    ...
    else
    {
      ...
      if ( v63 - qword_140C50630 < 0x8000000000LL )
        v33 = MmGetSessionIdEx((__int64)v64->ApcState.Process);
      _disable();
      v65 = (__int64)&v64[1].Process;
      for ( m = 0; m < 6; ++m )
      {
          ...
          && *(_DWORD *)(v65 + 8) == v33 )
        {
          ...
          *(_BYTE *)(v65 + 17) = 0;
          *(_QWORD *)v65 = 0LL;
          v64->AbEntrySummary |= 1 << *(_BYTE *)(v65 + 16);
          _enable();
          if ( v71 )
            KiAbThreadRemoveBoostsSlow((ULONG_PTR)v64, v63, v71);
          goto LABEL_125;
        }
        v65 += 96LL;
      }
...
LABEL_125:
      ...
      v56 = v72->SpecialApcDisable++ == -1;
      if ( v56 && ($CEA84C04E3712D858E5667A507841A2A *)v72->ApcState.ApcListHead[0].Flink != &v72->152 )
        KiCheckForKernelApcDelivery();
    }
  }
  return 1LL;
