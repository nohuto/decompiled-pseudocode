/*
 * XREFs of ExpLogRefreshTimeZoneInformationSuccess @ 0x14083601C
 * Callers:
...
int __fastcall ExpLogRefreshTimeZoneInformationSuccess(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 *a5)
{
  ...
  v10 = (_DWORD *)CurrentServerSiloGlobals[157];
  if ( (unsigned int)dword_140C06820 > 5 )
  {
    ...
    v41 = &v25;
    v42 = 8LL;
    tlgCreate1Sz_wchar_t((__int64)v43, (const WCHAR *)(v9 + 172));
    v12 = *((_BYTE *)v11 + 428);
    v44 = &v16;
    v20 = *v11;
    v16 = v12;
    ...
    LODWORD(CurrentServerSiloGlobals) = tlgWriteTransfer_EtwWriteTransfer(
                                          ...
                                          (unsigned __int8 *)byte_1400360BD,
                                          0LL,
                                          0LL,
                                          0x11u,
                                          &v26);
