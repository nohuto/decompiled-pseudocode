/*
 * XREFs of IopLiveDumpTraceCorralProcessorsDuration @ 0x14050964C
 * Callers:
...
char IopLiveDumpTraceCorralProcessorsDuration(const GUID *a1, ...)
{
  int v2; // eax
  _DWORD *v3; // rcx
  ...
  if ( (_BYTE)v2 )
  {
    if ( !v3[104] )
    {
      ...
      if ( (v2 & 1) != 0 )
      {
        UserData.Reserved = 0;
        v13 = 0;
        v4 = (const EVENT_DESCRIPTOR *)LIVEDUMP_EVENT_SIZING_WORKFLOW_SYSTEM_QUISCED_CORRAL_PROCESSORS;
        v16 = 0;
        v19 = 0;
        ...
        va_copy(v17, va3);
        if ( (v3[20] & 1) == 0 )
          v4 = &LIVEDUMP_EVENT_CAPTURE_PAGES_WORKFLOW_SYSTEM_QUISCED_CORRAL_PROCESSORS;
        UserData.Size = 8;
        v12 = 8;
        v15 = 8;
        v18 = 8;
        ...
        if ( (unsigned int)dword_140C044D8 > 5 )
        {
          ...
          if ( (_BYTE)v2 )
          {
            ...
            LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)&dword_140024ADC,
                           a1 + 54,
                           a1 + 53,
                           6u,
                           &v20);
