/*
 * XREFs of EtwTraceEvent @ 0x1405A60A0
 * Callers:
...
__int64 __fastcall EtwTraceEvent(__int64 a1, unsigned __int64 a2, unsigned int a3, int a4, char a5)
{
  __int64 v5; // r14
  unsigned int v7; // esi
  __int64 v8; // rbx
  ...
  signed __int64 v46[3]; // [rsp+80h] [rbp-178h] BYREF
  ...
  Size_4 = (unsigned __int16)a1;
  if ( a5 )
    v8 = *((_QWORD *)PsGetCurrentServerSiloGlobals(a1, a2) + 108);
  else
      ...
      if ( (v12 & 0x80u) == 0 )
      {
        if ( a5 || (v12 & 0x1000000) == 0 )
        {
          if ( a5 )
          {
            ...
            if ( a2 + v5 > 0x7FFFFFFF0000LL || a2 + v5 < a2 )
              MEMORY[0x7FFFFFFF0000] = 0;
          }
          LODWORD(v35) = *(unsigned __int16 *)a2;
          ...
          if ( v22 )
          {
            if ( (v14 & 0x100000) != 0 )
            {
              v40 = 0;
              v44 = &v22[Size];
              memmove(v22, (const void *)a2, Size);
              for ( j = 0; ; ++j )
              {
                v40 = j;
                if ( j >= v37 )
            ...
            else
            {
              if ( a5 && v15 )
              {
                if ( (a2 & 3) != 0 )
                  ExRaiseDatatypeMisalignment();
                v30 = a2 + v15;
                if ( v30 > 0x7FFFFFFF0000LL || v30 < a2 )
                  MEMORY[0x7FFFFFFF0000] = 0;
              }
              memmove(v22, (const void *)a2, v15);
            }
            if ( (v14 & 0x80000) != 0 )
            {
              v31 = *(_OWORD **)(a2 + 24);
