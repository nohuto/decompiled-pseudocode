/*
 * XREFs of ?SmFeSetEvictFailed@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KK@Z @ 0x1405991C0
 * Callers:
...
LABEL_31:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v15, (__int64)&qword_140D23B78, (unsigned int *)&v23);
