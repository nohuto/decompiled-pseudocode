/*
 * XREFs of SeLogAccessFailure @ 0x14024429C
 * Callers:
...
void __fastcall SeLogAccessFailure(char *Object, __int64 a2, __int64 a3, ULONGLONG a4, __int64 a5, char a6, char a7)
{
  ...
  {
    Object = (char *)PsReferenceEffectiveToken(KeGetCurrentThread(), 1732535635LL, &v99, v94, &v100, 0LL);
    if ( !Object )
      return;
    v9 = 1;
    v91 = 1;
  ...
  LearningModeObjectInformation = SepGetLearningModeObjectInformation(v92);
  ...
  v115 = v18;
  v116 = v19;
  v21 = KeGetCurrentThread()->Process[1].ActiveProcessors.StaticBitmap[2];
  if ( v21 )
  {
  ...
  Pool2 = (_DWORD *)ExAllocatePool2(256LL, v26, 1767073107LL, &cchOriginalDestLength);
  P = Pool2;
  v29 = Pool2;
  if ( Pool2 )
  {
...
LABEL_75:
  ...
  if ( v71 )
  {
    v74 = SepFlattenAcl(v71, &v107, &v102, &v95);
...
LABEL_87:
  ...
  v85 = SepFlattenAcl(v82, &v103, (char *)&v102 + 4, &v96);
