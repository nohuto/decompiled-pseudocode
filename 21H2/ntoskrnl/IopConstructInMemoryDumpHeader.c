/*
 * XREFs of IopConstructInMemoryDumpHeader @ 0x140554244
 * Callers:
...
__int64 IopConstructInMemoryDumpHeader()
{
  ...
  if ( (_DWORD)result != 1 )
  {
    dword_140C54DA8 = 0;
    if ( dword_140C54D74
      && (result = qword_140C54D90 & 1, (v1 = *(_DWORD **)&InMemData[2 * result + 2]) != 0LL)
      && (v2 = *(_QWORD *)&InMemData[2 * (((_BYTE)qword_140C54D90 - 1) & 1) + 2]) != 0 )
    {
