/*
 * XREFs of PopPotsLogPowerTransitionReliability @ 0x1407FE3D8
 * Callers:
...
char __fastcall PopPotsLogPowerTransitionReliability(int a1, int a2, int a3)
{
  ...
  if ( PotsPowerTransitionsHandleRegistered && (unsigned int)dword_140C045A8 > 5 )
  {
    result = tlgKeywordOn((__int64)&dword_140C045A8, 0x400000000000LL);
    if ( result )
    {
      v20 = 4LL;
      v19 = &v14;
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               (__int64)&dword_140C045A8,
               (unsigned __int8 *)byte_140032668,
               0LL,
               0LL,
               0xDu,
               &v18);
