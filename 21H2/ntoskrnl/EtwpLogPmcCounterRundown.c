/*
 * XREFs of EtwpLogPmcCounterRundown @ 0x1409EA3AC
 * Callers:
...
void __fastcall EtwpLogPmcCounterRundown(__int64 a1, unsigned int a2)
{
  ...
  *Pool2 = &v28;
  ...
  if ( v28 )
  {
    do
    {
      ...
      *(_DWORD *)v11 = *(_DWORD *)(*(_QWORD *)v7 + 4LL * v8);
      if ( ((int (__fastcall *)(__int64, __int64, __int64, int *))off_140C020D8[0])(1LL, 24LL, v11, &v29) < 0 )
        v12 = L"Unknown";
      else
  ...
  EtwpLogKernelEvent((__int64)Pool2, EtwpHostSiloState, a2, v9 + 1, 0xF30u, 0x401802u);
  if ( *(_QWORD *)(a1 + 24) != 1LL )
    goto LABEL_24;
  v15 = 16 * v28 + 24;
  ...
  while ( 1 )
  {
    if ( !*v17 )
      goto LABEL_22;
    *(_QWORD *)v4 = *v17;
    if ( ((int (__fastcall *)(__int64, _QWORD, _DWORD *, int *))off_140C020D8[0])(51LL, v15, v4, &v29) < 0 )
      goto LABEL_22;
    v18 = v4 + 4;
    Pool2[1] = 4LL;
    Pool2[2] = v4 + 4;
