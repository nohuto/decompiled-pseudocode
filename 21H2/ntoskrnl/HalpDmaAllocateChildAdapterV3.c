/*
 * XREFs of HalpDmaAllocateChildAdapterV3 @ 0x1407C36A8
 * Callers:
 *     HalGetAdapterV3 @ 0x1407C33B0 (HalGetAdapterV3.c)
 * Callees:
 *     HalPutDmaAdapter @ 0x1402C1740 (HalPutDmaAdapter.c)
 *     HalpIommuGetSecurityPolicy @ 0x1402D3F1C (HalpIommuGetSecurityPolicy.c)
 *     ExfTryToWakePushLock @ 0x1402F1570 (ExfTryToWakePushLock.c)
 *     KeAbPostRelease @ 0x140348C80 (KeAbPostRelease.c)
 *     ExAcquirePushLockExclusiveEx @ 0x14034A990 (ExAcquirePushLockExclusiveEx.c)
 *     ObReferenceObjectByPointer @ 0x1403600E0 (ObReferenceObjectByPointer.c)
 *     HalpDmaIsThinApiCapable @ 0x1403C70F0 (HalpDmaIsThinApiCapable.c)
