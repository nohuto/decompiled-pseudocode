/*
 * XREFs of HalpNumaAddRangeProximity @ 0x14051E390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpNumaAddRangeProximity(unsigned __int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned int)dword_140C04538 > 5 && tlgKeywordOn((__int64)&dword_140C04538, 0x400000000000LL) )
  {
    ...
    v36 = &v32;
    v37 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04538, (unsigned __int8 *)word_14002843A, 0LL, 0LL, 3u, v35);
  }
...
LABEL_21:
      if ( (unsigned int)dword_140C04538 > 5 && tlgKeywordOn((__int64)&dword_140C04538, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)word_1400283D2,
          0LL,
          0LL,
          6u,
          v35);
