/*
 * XREFs of HalCancelAdapterChannelDmarThin @ 0x140515FD0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HalCancelAdapterChannelDmarThin(PDMA_ADAPTER DmaAdapter, __int64 a2, volatile signed __int32 *a3)
{
  char v4; // al
  __int64 v5; // rdi
  char v6; // bl
