/*
 * XREFs of MiFreeMdlPageRun @ 0x1402C3410
 * Callers:
...
__int64 __fastcall MiFreeMdlPageRun(ULONG_PTR a1, unsigned __int64 a2, char a3)
{
  ...
  if ( a2 )
  {
    for ( i = 2LL; ; i = 2LL )
    {
      if ( (a1 & 0xF) == 0 )
      {
        v33 = (KeFeatureBits & 0x2000000000LL) == 0;
        while ( 1 )
        {
          v29 = MiLargePageSizes[v33];
          if ( ((v29 - 1) & a1) == 0 && v5 >= v29 && (unsigned int)MiResidentPageDangleFree(a1, v33) )
            break;
          if ( (unsigned int)++v33 >= 3 )
            goto LABEL_4;
        }
        v3 += MiFreeLargePageMemory(a1, v30, v31);
        a1 += v29;
        v5 -= v29;
        goto LABEL_30;
      }
...
LABEL_63:
      ...
      if ( *(_QWORD *)(v13 + 16056) )
      {
        ...
        v17 = MiRestockOverCommit(v13, v8);
      ...
      CachedCommit = v18->CachedCommit;
      if ( (unsigned __int64)(v17 + CachedCommit) > 0x100 )
        break;
      while ( 1 )
      {
        v32 = _InterlockedCompareExchange(
                (volatile signed __int32 *)&v18->CachedCommit,
                CachedCommit + v17,
                CachedCommit);
        if ( v32 == CachedCommit )
          break;
...
LABEL_46:
      ...
      if ( (unsigned __int64)(v8 + CachedResidentAvailable) <= 0x100 )
      {
        do
        {
          ...
          v14 = (_DWORD)CachedResidentAvailable == v26;
      ...
      if ( (int)CachedResidentAvailable > 192
        && (_DWORD)CachedResidentAvailable == _InterlockedCompareExchange(
                                                ...
                                                CachedResidentAvailable) )
      {
        v23 = v8 + (int)CachedResidentAvailable - 192;
      }
      if ( v23 )
        goto LABEL_46;
LABEL_29:
