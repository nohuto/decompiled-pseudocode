/*
 * XREFs of PspBuildCreateProcessContext @ 0x1406986F4
 * Callers:
 ...
 *     IsTrustletCreateAttributeWellFormed @ 0x140582C5C (IsTrustletCreateAttributeWellFormed.c)
 ...
 *     RtlValidProcessProtection @ 0x140622210 (RtlValidProcessProtection.c)
...
LABEL_158:
      ...
      if ( !v42 )
      {
        ...
        *(_DWORD *)(a4 + 412) = v44 >> 3;
        ...
        {
          v14 = ObpReferenceObjectByHandleWithTag(*(_QWORD *)(v45 + 8 * v47), 0x6C4A7350u, (__int64)&v131, 0LL, 0LL);
          if ( v14 < 0 )
            goto LABEL_305;
