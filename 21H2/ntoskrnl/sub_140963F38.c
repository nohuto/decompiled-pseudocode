/*
 * XREFs of sub_140963F38 @ 0x140963F38
 * Callers:
...
__int64 __fastcall sub_140963F38(__int64 a1, unsigned int *a2)
{
  unsigned int v2; // esi
  unsigned int v4; // r8d
  unsigned int v5; // edx
  ...
  Mdl = 0LL;
  v8 = sub_1406873F0(v7, v5 & 0xFFFFFFF, (v4 & 2) == 0);
  if ( v8 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v14 = a2[1] & 0xFFFFFFF;
      v16 = 0;
      v8 = sub_140687500(1, v7, v17, v11, (__int64 *)(v9 + 72), v14, (__int128 *)(v9 + 80), v15, &v16);
      if ( v8 >= 0 )
      {
