/*
 * XREFs of RtlpHpVsContextAllocateInternal @ 0x14034BBF0
 * Callers:
...
LABEL_18:
    ...
    *v9 = 0;
    v36 = RtlpHpVsSubsegmentCreate(a1, v7, a4);
    if ( !v36 )
      return 0LL;
    *a6 = 1;
    if ( (a4 & 1) == 0 )
      RtlpHpAcquireQueuedLockExclusive(a1, *(unsigned int *)(a1 + 8), a5);
    RtlpHpVsContextAddSubsegment(a1, v36);
    v10 = a5;
    v9 = a6;
  }
  v19 = v14 - 8;
  v20 = HIDWORD(RtlpHpHeapGlobals) ^ HIDWORD(*(_QWORD *)(v14 - 8)) ^ ((v14 - 8) >> 32);
  v21 = v14 - 8;
  if ( (v20 & 0xFF0000) != 0 )
  {
    v23 = (unsigned __int8)(RtlpHpHeapGlobals ^ v19 ^ *(_BYTE *)v14);
  }
  else
  {
    if ( (_WORD)v20 )
    {
      v21 -= 16LL * (unsigned __int16)((RtlpHpHeapGlobals ^ *(_QWORD *)(v14 - 8) ^ v19) >> 32);
      v22 = HIDWORD(RtlpHpHeapGlobals) ^ HIDWORD(*(_QWORD *)v21) ^ HIDWORD(v21);
      if ( (v22 & 0xFF0000) != 0 )
      {
        v23 = (unsigned __int8)(RtlpHpHeapGlobals ^ v21 ^ *(_BYTE *)(v21 + 8));
        goto LABEL_24;
      }
      if ( (_WORD)v22 )
      {
        v21 -= 16LL * (unsigned __int16)((RtlpHpHeapGlobals ^ *(_QWORD *)v21 ^ v21) >> 32);
        v23 = (unsigned __int8)(RtlpHpHeapGlobals ^ v21 ^ *(_BYTE *)(v21 + 8));
        goto LABEL_24;
      }
    }
...
LABEL_24:
  ...
  {
    RtlpLogHeapFailure(18, a1 ^ *(_DWORD *)(a1 + 128), v24, v14 - 8, 0LL, 0LL);
    return 0LL;
  }
  ...
  if ( !(unsigned int)RtlpHpVsChunkSplit(a1, v24, (int)v14 - 8, v25, a4, a5) )
    return 0LL;
  v26 = (char *)(v19 + 16);
  v27 = 16 * (WORD1(RtlpHpHeapGlobals) ^ WORD1(v19) ^ *(unsigned __int16 *)(v19 + 2)) - 16;
  if ( (*(_DWORD *)(a1 + 176) & 1) != 0 )
  {
    v28 = (char *)(v19 + 32);
