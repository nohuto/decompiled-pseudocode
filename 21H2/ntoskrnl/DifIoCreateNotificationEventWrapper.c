/*
 * XREFs of DifIoCreateNotificationEventWrapper @ 0x14060E1E0
 * Callers:
 *     <none>
 * Callees:
...
PKEVENT __fastcall DifIoCreateNotificationEventWrapper(PUNICODE_STRING EventName, PHANDLE EventHandle)
{
  ...
  v15 = 0LL;
  v16 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(150);
...
LABEL_13:
  *(_QWORD *)&v16 = EventName;
  *((_QWORD *)&v15 + 1) = EventHandle;
