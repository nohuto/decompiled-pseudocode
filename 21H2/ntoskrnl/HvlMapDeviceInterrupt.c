/*
 * XREFs of HvlMapDeviceInterrupt @ 0x140547570
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  {
    v10 = 0;
    v11 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v27, 2, (__int64)v34, 56LL);
    v12 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v23, 1, (__int64)v35, 144LL);
    memset(v12, 0, 0x48uLL);
    *(_OWORD *)(v12 + 5) = *a2;
    *(_OWORD *)(v12 + 7) = a2[1];
    if ( a3 )
    {
      v13 = HvlpAffinityToHvProcessorSet(v33, v12 + 8, (v23 & 2) != 0 ? 64 : 4016);
      if ( v13 == -1 )
      {
        ...
        *(_OWORD *)(v12 + 5) = *a2;
        *(_OWORD *)(v12 + 7) = a2[1];
        v13 = HvlpAffinityToHvProcessorSet(v33, v12 + 8, 4016LL);
      }
      *((_DWORD *)v12 + 15) |= 2u;
      v14 = v13 + 80;
      v10 = v14 - 72;
    ...
    *v12 = -1LL;
    ...
    if ( !HvlpHvStatusIsInsufficientMemory(v17) )
      break;
    if ( (int)HvlpHandleInsufficientMemory(v20, v19, v21) < 0 )
      v9 = 1;
  }
  if ( v18 >= 0 )
    HvlpLogIommuEvent(&v30);
