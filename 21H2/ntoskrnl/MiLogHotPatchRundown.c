/*
 * XREFs of MiLogHotPatchRundown @ 0x140975748
 * Callers:
 *     MiTracingEnabledCallback @ 0x140865400 (MiTracingEnabledCallback.c)
 * Callees:
...
struct _EX_RUNDOWN_REF *MiLogHotPatchRundown()
{
  ...
  __int64 v33; // r10
  _KPROCESS *ii; // rcx
  struct _EX_RUNDOWN_REF *p_Blink; // r13
  _DWORD *v36; // r9
  ...
  if ( *(_QWORD *)&qword_140C53448 && dword_140C4F478 )
  {
    ...
    while ( i )
    {
      if ( **(_DWORD **)&qword_140C53448 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C53448, 32LL) )
      {
        v45 = *(_DWORD *)(i + 24);
        v133 = 4LL;
        v132 = &v45;
        ...
        v137 = 2LL;
        v139[1] = 0;
        tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)&dword_14002D1A4, v4, 1u, v43, v44, 6u, &v131);
      }
      v6 = *(_QWORD ***)(i + 8);
      v7 = i;
      if ( v6 )
    ...
    while ( k )
    {
      ...
      while ( j )
      {
        if ( **(_DWORD **)&qword_140C53448 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C53448, 32LL) )
        {
          ...
          v130 = 0;
          v129 = 4 * v15 + 8;
          tlgWriteEx_EtwWriteEx(v14, (unsigned __int8 *)&unk_14002D000, v13, 1u, v43, v44, 7u, &v119);
        }
        v16 = *(_QWORD ***)(j + 8);
        v17 = j;
        if ( v16 )
    ...
    while ( m )
    {
      if ( **(_DWORD **)&qword_140C53448 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C53448, 32LL) )
      {
        ...
        v81 = 2LL;
        v83[1] = 0;
        tlgWriteEx_EtwWriteEx(v26, (unsigned __int8 *)&byte_14002D063, v25, 1u, v43, v44, 9u, &v69);
      }
      v27 = *(_QWORD ***)(m + 8);
      v28 = m;
      if ( v27 )
    ...
    for ( n = (PVOID *)PsLoadedModuleList; n != &PsLoadedModuleList; n = (PVOID *)*n )
    {
      if ( MiIsActiveSystemHotPatch((__int64)n)
        ...
        && tlgKeywordOn(*(__int64 *)&qword_140C53448, 32LL) )
      {
        v54 = *(_DWORD *)(v32 + 120);
        v86 = 4LL;
        v85 = &v54;
        ...
        v96 = 2LL;
        v98[1] = 0;
        tlgWriteEx_EtwWriteEx(v33, (unsigned __int8 *)&byte_14002D1F7, v31, 1u, v43, v44, 9u, &v84);
      }
    }
    ...
    for ( ii = 0LL; ; ii = v42 )
    {
      ...
      v42 = (_KPROCESS *)result;
      if ( !result )
        break;
      p_Blink = result + 139;
      if ( ExAcquireRundownProtection(result + 139) )
      {
        KiStackAttachProcess(v42, 0LL, (__int64)v68, v36);
        ProcessHotPatchContext = MiGetProcessHotPatchContext((__int64)v42, 0);
        if ( ProcessHotPatchContext )
        {
          MiFillLogProcessInfo((__int64)&v42[1].ActiveProcessors.StaticBitmap[26], v67, &v66);
          --CurrentThread->SpecialApcDisable;
          ExAcquirePushLockSharedEx((ULONG_PTR)(ProcessHotPatchContext + 2), 0LL);
          v38 = (_QWORD *)*ProcessHotPatchContext;
          if ( (_QWORD *)*ProcessHotPatchContext != ProcessHotPatchContext )
          {
            do
            {
              ...
              if ( **(_DWORD **)&qword_140C53448 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C53448, 32LL) )
              {
                ...
                v101 = 4LL;
                tlgCreate1Sz_char((__int64)v102, v66);
                v40 = *((_DWORD *)v38 + 8);
                v103 = &v60;
                v61 = *((_DWORD *)v38 + 9);
                v105 = &v61;
                ...
                v116[1] = 0;
                v118 = 4LL;
                tlgWriteEx_EtwWriteEx(v39, (unsigned __int8 *)&dword_14002D284, v41, 1u, v43, v44, 0xCu, &v99);
              }
              v38 = (_QWORD *)*v38;
            }
            while ( v38 != ProcessHotPatchContext );
            p_Blink = (struct _EX_RUNDOWN_REF *)&v42[1].ProfileListHead.Blink;
          }
