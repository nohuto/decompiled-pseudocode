...
__int64 __fastcall MiAgePte(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rdi
  int v5; // r11d
  __int64 v6; // r15
  ...
  if ( *(_BYTE *)(v4 + 6) )
  {
    *(_BYTE *)(v4 + 6) = 0;
    ...
    else
    {
      ...
      {
        LOBYTE(a2) = -1;
        ExpAcquireSpinLockExclusiveAtDpcLevelInstrumented(v16, a2);
      }
      else
      {
        ...
        if ( _interlockedbittestandset(v16, 0x1Fu) )
        {
          ...
          v52 = ExpWaitForSpinLockExclusiveAndAcquire(v16, 0xFFu);
        }
        for ( i = *v16; (*v16 & 0xBFFFFFFF) != 0x80000000; i = *v16 )
        {
          if ( (i & 0x40000000) == 0 )
            _InterlockedOr(v16, 0x40000000u);
          KeYieldProcessorEx(&v52, a2, a3, a4);
        }
      }
      if ( (v46 & 2) != 0 )
      {
    ...
    && ((v32 & 0x20) == 0 || (v32 & 0x42) == 0) )
  {
    ...
    if ( Flink )
    {
      v34 = *((_QWORD *)&Flink->Flink + ((v31 >> 3) & 0x1FF));
      if ( (v34 & 0x20) != 0 )
        v32 |= 0x20uLL;
      if ( (v34 & 0x42) != 0 )
        v32 |= 0x42uLL;
    ...
    && ((v32 & 0x20) == 0 || (v32 & 0x42) == 0) )
  {
    ...
    if ( v35 )
    {
      v36 = *((_QWORD *)&v35->Flink + (((unsigned __int64)&v49 >> 3) & 0x1FF));
      if ( (v36 & 0x20) != 0 )
        v32 |= 0x20uLL;
      if ( (v36 & 0x42) != 0 )
        v32 |= 0x42uLL;
    ...
    && !(unsigned int)MiIsPageTableLocked(v6, ((v30 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL) )
  {
    ...
    else
    {
      ...
      if ( (*(_DWORD *)v4 & 3) == 0 )
        v44 = (v49 >> 5) & 1;
      MiAgePteWorker(v6, (v30 >> 9) & 0xFFFFFFF8, v30, v37, v4, v44);
    }
