/*
 * XREFs of sub_14094D610 @ 0x14094D610
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14094D610(__int64 a1, _DWORD *a2, _DWORD *a3, unsigned int a4, _DWORD *a5, _BYTE *a6)
{
  _DWORD *v8; // rbx
...
LABEL_37:
  ...
  if ( v39 )
  {
    v26 = a5;
    *a6 = 1;
    return (unsigned int)sub_14094D46C(v8, a3, a4, v26, 0);
  }
  else
  {
    v25 = -1073741772;
