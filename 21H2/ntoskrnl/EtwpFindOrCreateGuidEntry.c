/*
 * XREFs of EtwpFindOrCreateGuidEntry @ 0x140796798
 * Callers:
...
__int64 __fastcall EtwpFindOrCreateGuidEntry(__int64 a1, _DWORD *a2, __int64 a3, char a4, __int64 **a5)
{
  int v6; // esi
  unsigned int v9; // ebx
  ...
  v6 = a3;
  v9 = 0;
  GuidEntryByGuid = (__int64 *)EtwpFindGuidEntryByGuid(a1, a2, a3);
