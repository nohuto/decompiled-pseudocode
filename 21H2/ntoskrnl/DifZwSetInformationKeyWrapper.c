/*
 * XREFs of DifZwSetInformationKeyWrapper @ 0x140627410
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  *(_QWORD *)&v21 = KeyHandle;
  DWORD2(v20) = KeySetInformationClass;
  *(_QWORD *)&v20 = KeySetInformation;
  DWORD2(v19) = KeySetInformationLength;
