/*
 * XREFs of PpmParkRecordNodeStatistics @ 0x14021C050
 * Callers:
 *     PpmCheckRecordAllUtility @ 0x14021BC70 (PpmCheckRecordAllUtility.c)
 * Callees:
 *     PpmParkComputeSnapStatistics @ 0x14021C1E0 (PpmParkComputeSnapStatistics.c)
...
__int64 PpmParkRecordNodeStatistics()
{
  ...
  for ( i = HIBYTE(PpmCurrentProfile[v1 + 20]); v3 < (unsigned int)PpmParkNumNodes; v27 = v3 )
  {
    v6 = PpmParkNodes + 336LL * v3;
      ...
      if ( PpmHeteroWorkloadClasses )
      {
        do
        {
          ...
          *(_QWORD *)&v36 = 0LL;
          ...
          {
            Prcb = KeGetPrcb(v30);
            v16 += *(_QWORD *)(*(_QWORD *)(Prcb + 34144) + 8 * v17 + 8);
            v18 += *(_QWORD *)(*(_QWORD *)(Prcb + 34136) + 8 * v17 + 8);
          }
          v12 = v16;
          v20 = v29;
          v13 = v18;
        ...
        while ( v20 + 1 < PpmHeteroWorkloadClasses );
        v3 = v27;
      }
      *(_QWORD *)(v6 + 320) = v13;
      v21 = 0;
