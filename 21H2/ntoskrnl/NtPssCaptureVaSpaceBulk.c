/*
 * XREFs of NtPssCaptureVaSpaceBulk @ 0x140A07780
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      if ( a2 <= 0x7FFFFFFEFFFFLL )
      {
        ...
        if ( v13 != -1LL )
        {
          ...
          KiStackAttachProcess((_KPROCESS *)Object, 0LL, (__int64)v30, v15);
          v7 |= 1u;
        }
        if ( PreviousMode )
        {
          v9 = ZwPssCaptureVaSpaceBulk(-1LL, v18);
        }
        else
        {
          *((_DWORD *)MappedSystemVa + 1) = 0;
          ...
          while ( v16 >= 0x30 )
          {
            ...
            v9 = MmQueryVirtualMemory(0xFFFFFFFFFFFFFFFFuLL, v18, 0, (unsigned __int64)v17, 0x30uLL, &v23, 2);
            if ( v9 < 0 )
            {
