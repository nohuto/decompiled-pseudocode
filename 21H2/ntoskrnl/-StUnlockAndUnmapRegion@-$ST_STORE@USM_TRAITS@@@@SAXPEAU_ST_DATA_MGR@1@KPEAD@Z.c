/*
 * XREFs of ?StUnlockAndUnmapRegion@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KPEAD@Z @ 0x140379950
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StUnlockAndUnmapRegion(__int64 a1, unsigned int a2, int a3)
{
  ...
  else
  {
    ...
    *(_QWORD *)(v11 + 8 * v5) = v13;
    if ( (v13 & 3) == 0 )
      SmFpFree(v3 + 6608, 5LL, KeGetCurrentThread(), v14);
  }
  v6 = *(_QWORD *)(a1 + 800);
  if ( (*(_BYTE *)(v6 + 6021) & 4) != 0 )
    return SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(v6, v5, a3, v6);
  ...
  *(_QWORD *)(result + 8 * v5) = v9;
  if ( (v9 & 3) == 0 )
    return SmFpFree(v6 + 6608, 5LL, KeGetCurrentThread(), v10);
  return result;
}
