/*
 * XREFs of MiInitializePartitionSpecialPurposeMemory @ 0x14096E4D8
 * Callers:
 *     MiInitializePartitionSpecialPurposeMemoryCallout @ 0x14059A1A0 (MiInitializePartitionSpecialPurposeMemoryCallout.c)
...
__int64 __fastcall MiInitializePartitionSpecialPurposeMemory(__int64 a1, _OWORD *a2)
{
  ...
  if ( (ULONG_PTR *)a1 != &MiSystemPartition )
  {
    ...
    *((_QWORD *)&Parameter + 1) = a2;
    Partition = KeExpandKernelStackAndCallout(
...
LABEL_10:
  ...
  if ( Pool )
  {
    ...
    v24 = 512;
    v26 = 0LL;
    Partition = PsCreatePartition((ULONG_PTR)v6, (HANDLE *)&v28, 2031619, (int)v21, 0, 2);
    if ( Partition >= 0 )
    {
      v5 = (HANDLE)v28;
      Partition = PsReferencePartitionByHandle(v28, 2031619, 0, 0x4D536D4Du, &v18);
      if ( Partition >= 0 )
      {
        v12 = *v18;
        ...
        *(_OWORD *)(v12 + 16656) = a2[1];
        v14 = a1 + 16624;
        *((_QWORD *)Pool + 2) = _InterlockedIncrement64(&qword_140C51858);
        v15 = v28;
        *(_OWORD *)(Pool + 24) = *a2;
        v16 = a2[1];
        *((_QWORD *)Pool + 8) = v12;
...
LABEL_18:
  ...
  if ( v5 )
    ZwClose(v5);
  if ( v18 )
    PsDereferencePartition((__int64)v18);
  if ( Pool )
