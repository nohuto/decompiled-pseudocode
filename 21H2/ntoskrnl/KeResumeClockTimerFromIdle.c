/*
 * XREFs of KeResumeClockTimerFromIdle @ 0x140224BE0
 * Callers:
 ...
 *     KiGetPendingTick @ 0x1402BC9E0 (KiGetPendingTick.c)
 ...
 *     ExRecordOneTimerExpiry @ 0x1405B6730 (ExRecordOneTimerExpiry.c)
 */
