/*
 * XREFs of RtlpGenericInverseCouplingWorker @ 0x1405EFE44
 * Callers:
 *     RtlScrubMemory @ 0x1405EFB90 (RtlScrubMemory.c)
 * Callees:
 *     RtlpTestAndFillMemoryUp @ 0x1405F068C (RtlpTestAndFillMemoryUp.c)
 *     RtlpTestMemory @ 0x1405F06B4 (RtlpTestMemory.c)
 */
