/*
 * XREFs of RtlValidateRetpolineRelocation @ 0x140235054
 * Callers:
...
__int64 __fastcall RtlValidateRetpolineRelocation(_QWORD *a1, unsigned int a2, unsigned int *a3)
{
  char v6; // bp
  unsigned int v7; // r9d
  ...
  v6 = 0;
  v10 = (unsigned int)RtlSizeOfRetpolineRelocationEntry(*a1);
  v11 = v7;
  v12 = v7;
  if ( v9 <= v8 )
  {
