/*
 * XREFs of KiDisplayBlueScreen @ 0x140518300
 * Callers:
 ...
 *     KeGetBugMessageText @ 0x140517D04 (KeGetBugMessageText.c)
 *     KiBugCheckConvertParameterValueToUnicodeString @ 0x140517ECC (KiBugCheckConvertParameterValueToUnicodeString.c)
...
__int64 __fastcall KiDisplayBlueScreen(int a1)
{
  ...
  *(_OWORD *)ppszDestEnd_8 = 0LL;
  ...
  v3 = KiBugCheckDriver;
  v4 = (unsigned __int64 *)&KiBugCheckData + 1;
  ...
  *((_QWORD *)&v26[1] + 1) = &v29;
  ...
  {
    RtlStringCbPrintfExA(pszDest, 0xBuLL, &ppszDestEnd, 0LL, 0, "0x%08x", (_DWORD)KiBugCheckData);
  ...
  *(_WORD *)(v11 + 2LL * v10) = 0;
  ...
  {
    BgpFwDisplayBugCheckScreen(v15, (unsigned int)&KiBugCheckData + 8, v3, (unsigned int)v26, a1);
    v11 = *((_QWORD *)&v26[1] + 1);
  }
  BgpFwReleaseLock();
