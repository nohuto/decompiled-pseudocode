/*
 * XREFs of PopSetHiberFileSize @ 0x14098F9D0
 * Callers:
...
__int64 __fastcall PopSetHiberFileSize(unsigned int a1, __int64 *a2)
{
  ...
  v4 = v6;
  result = PopValidateHiberFileSize(v6, 0LL, 0LL);
  if ( (int)result < 0
    || (unsigned int)PopHiberFileSizePercent >= 0x28 && (result = PopSetHiberFileType(2LL), (int)result < 0)
    || (result = PopSetHiberPersistedRegValue(1, PopHiberFileSizePercent), (int)result < 0) )
  {
