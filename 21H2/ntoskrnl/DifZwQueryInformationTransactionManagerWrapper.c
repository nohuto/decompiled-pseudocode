/*
 * XREFs of DifZwQueryInformationTransactionManagerWrapper @ 0x140625000
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwQueryInformationTransactionManagerWrapper(
...
LABEL_13:
  ...
  *((_QWORD *)&v22 + 1) = TransactionManagerHandle;
  LODWORD(v22) = TransactionManagerInformationClass;
  *((_QWORD *)&v21 + 1) = TransactionManagerInformation;
  LODWORD(v21) = TransactionManagerInformationLength;
...
LABEL_18:
  result = ZwQueryInformationTransactionManager(
