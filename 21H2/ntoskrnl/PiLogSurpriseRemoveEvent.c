/*
 * XREFs of PiLogSurpriseRemoveEvent @ 0x140811518
 * Callers:
...
char __fastcall PiLogSurpriseRemoveEvent(__int64 a1, int a2, int **a3)
{
  __int64 v4; // rax
  __int64 v5; // rdx
  const wchar_t *v6; // r9
  ...
  if ( a2 == 3 )
  {
    if ( (byte_140C0DD4C & 1) != 0 )
      LOBYTE(v7) = McTemplateK0zq_EtwWriteTransfer(
                     a1,
