/*
 * XREFs of DifZwOpenProcessWrapper @ 0x140622490
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifZwOpenProcessWrapper(
...
LABEL_18:
  result = ZwOpenProcess(ProcessHandle, DesiredAccess, ObjectAttributes, ClientId);
  DWORD2(v21) = result;
  if ( APIThunkContextById )
  {
