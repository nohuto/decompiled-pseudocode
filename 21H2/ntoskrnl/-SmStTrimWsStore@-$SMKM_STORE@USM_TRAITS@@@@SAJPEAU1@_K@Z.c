/*
 * XREFs of ?SmStTrimWsStore@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@_K@Z @ 0x1405F774C
 * Callers:
...
__int64 __fastcall SMKM_STORE<SM_TRAITS>::SmStTrimWsStore(__int64 a1, __int64 a2)
{
  ...
  KiStackAttachProcess(*(_KPROCESS **)(a1 + 6584), 0LL, (__int64)v39, v4);
...
LABEL_32:
      ...
      if ( (unsigned int)v12 < v19 + (int)v12 )
      {
        ...
        do
        {
          ...
          if ( (v25 & 0x7FFFFFFFFFFF0000LL) != 0 && v25 >= 0 )
          {
            v26 = v14;
            v40[v14++] = v13;
            v41[v26] = SMKM_STORE<SM_TRAITS>::SmStMapVirtualRegion(a1, v13, 0, v12, 4);
            if ( v14 == 8 )
            {
              SMKM_STORE<SM_TRAITS>::SmStTrimWsStoreBatch(a1, (unsigned int)v40, (unsigned int)v41, 8, v33, 0LL);
              v14 = 0;
            }
          }
          ++v13;
  ...
  for ( j = a2; v27 < *(_DWORD *)(a1 + 6212); ++v27 )
  {
    ...
    if ( (v29 & 0x7FFFFFFFFFFF0000LL) != 0 && v29 >= 0 && (!v8 || _bittest64((const signed __int64 *)v8[1], v27)) )
    {
      v30 = v10;
      v40[v10++] = v27;
      v41[v30] = SMKM_STORE<SM_TRAITS>::SmStMapVirtualRegion(a1, v27, 0, v12, 4);
      v28 = a2;
      if ( v10 == 8 )
      {
  ...
  if ( v10 )
    SMKM_STORE<SM_TRAITS>::SmStTrimWsStoreBatch(
      ...
      v10,
      v33,
      (unsigned __int64)&j & -(__int64)(v28 != 0));
LABEL_55:
  if ( _InterlockedCompareExchange64(v11, 0LL, 17LL) != 17 )
    ExfReleasePushLockShared(v11);
  KeAbPostRelease((ULONG_PTR)v11);
  v31 = KeGetCurrentThread();
  v7 = v31->SpecialApcDisable++ == -1;
  if ( v7 && ($CEA84C04E3712D858E5667A507841A2A *)v31->ApcState.ApcListHead[0].Flink != &v31->152 )
