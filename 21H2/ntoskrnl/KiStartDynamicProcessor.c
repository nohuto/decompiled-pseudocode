/*
 * XREFs of KiStartDynamicProcessor @ 0x1408BA678
 * Callers:
 ...
 *     HalRegisterDynamicProcessor @ 0x1404BDD00 (HalRegisterDynamicProcessor.c)
 ...
 *     KiRemoveProcessorFromGroupDatabase @ 0x140515A1C (KiRemoveProcessorFromGroupDatabase.c)
 ...
 *     KiComputeProcessorDataSize @ 0x14099F0F8 (KiComputeProcessorDataSize.c)
...
LABEL_57:
    ...
    if ( v12 < 0
      ...
      || (v12 = HvlInitializeProcessor((union _SLIST_HEADER *)v10), v12 < 0) )
    {
LABEL_47:
      if ( v10 )
