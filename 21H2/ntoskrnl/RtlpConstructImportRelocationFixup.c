/*
 * XREFs of RtlpConstructImportRelocationFixup @ 0x1402DB460
 * Callers:
        ...
        __int64 a7)
{
  ...
  __int64 v25; // r8
  __int64 v26; // rdx
  unsigned int (*v27)(void); // rax
  __int64 v28; // rdx
  unsigned int (*v29)(void); // rax
  char v30; // al
  ...
  if ( a5 )
  {
    ...
    if ( (*a4 & 0xFFFFE000) != 0xFFFFE000 )
    {
      ...
      else
      {
        ...
        if ( !v23 )
          goto LABEL_20;
        v27 = *(unsigned int (**)(void))(a2 + 40);
        v13 = *(_QWORD *)(v23 + 8 * (v11 >> 13)) - *(_QWORD *)(a2 + 32);
        if ( v27 )
        {
          if ( !v27() )
            goto LABEL_20;
...
LABEL_10:
        ...
        *(_BYTE *)(a7 + 4) = 21;
        ...
        if ( (v15 & 0xFFFFE000) != 0xFFFFE000 )
        {
          ...
          if ( v28 )
          {
            v29 = *(unsigned int (**)(void))(a2 + 40);
            v19 = *(_QWORD *)(v28 + 8 * ((unsigned __int64)v15 >> 13)) - *(_QWORD *)(a2 + 32);
            if ( !v29 || v29() )
            {
LABEL_16:
              if ( v19 )
