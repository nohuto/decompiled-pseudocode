/*
 * XREFs of KeUpdateQosGroupingSets @ 0x14023BA30
 * Callers:
...
__int64 __fastcall KeUpdateQosGroupingSets(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  result = KiIsQosGroupingActive(a1, a2, a3, a1);
  if ( (_BYTE)result )
  {
    v6 = *(_OWORD *)(*(_QWORD *)(v5 + 192) + 256LL);
    IsQosGroupingClass = KiIsQosGroupingClass(v4);
    v9 = *((_QWORD *)&v6 + 1);
    v10 = IsQosGroupingClass;
    v11 = v6;
    while ( 1 )
    {
      v12 = v8[25];
