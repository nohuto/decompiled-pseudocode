/*
 * XREFs of MiGetUltraHugeAlreadyActive @ 0x140205E40
 * Callers:
...
RTL_BITMAP *__fastcall MiGetUltraHugeAlreadyActive(__int64 a1, __int64 a2, unsigned int a3)
{
  RTL_BITMAP *v3; // rbx
  __int64 v4; // rdi
  __int64 v5; // r15
...
LABEL_7:
    ...
    MiDecrementHugeContext(v8, v3, a2);
    *(_QWORD *)(a2 + 224) = 0LL;
  }
  v12 = (RTL_BITMAP **)(v5 + 56);
  for ( i = *v12; i != (RTL_BITMAP *)v12; i = *(RTL_BITMAP **)&i->SizeOfBitMap )
  {
    v3 = i - 5;
