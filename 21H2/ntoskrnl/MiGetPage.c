/*
 * XREFs of MiGetPage @ 0x140213610
 * Callers:
 ...
 *     MiCheckNodeChannelStandbyCount @ 0x14054EDDC (MiCheckNodeChannelStandbyCount.c)
...
LABEL_210:
      ...
      {
        v105 = v39;
        v40 = (union _SLIST_HEADER *)(v36 + *(_QWORD *)(v22 + 8LL * v39 + 4200));
