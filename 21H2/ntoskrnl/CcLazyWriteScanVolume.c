/*
 * XREFs of CcLazyWriteScanVolume @ 0x140538E4C
 * Callers:
 ...
 *     CcIsCacheMapACursorInPrivateVCM @ 0x140538E2C (CcIsCacheMapACursorInPrivateVCM.c)
 *     CcPostDeferredWrites @ 0x14053A100 (CcPostDeferredWrites.c)
 *     CcAdjustThrottleForVolume @ 0x14053BC90 (CcAdjustThrottleForVolume.c)
 *     CcCalculatePagesToWriteForVolume @ 0x14053BD24 (CcCalculatePagesToWriteForVolume.c)
...
__int64 __fastcall CcLazyWriteScanVolume(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  __int64 v4; // r13
  int v9; // r14d
  ...
  unsigned __int64 v96; // [rsp+A8h] [rbp+Fh] BYREF
  ...
  if ( v4 == *((_QWORD *)PspSystemPartition + 1) )
    CcScanLogHandleList(v4, &v89, a4, v98);
  ...
  *(_QWORD *)(a1 + 1048) = v17;
  *(_QWORD *)(a1 + 1056) = v18;
  if ( !v16 && (unsigned __int8)CcIsDirtyCachemapListEmptyForVolume(a1) && !*(_BYTE *)(a1 + 986) )
  {
    ...
    CcRescheduleLazyWriteScanOnVolume(v19, 0LL);
    KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
    ...
    __writecr8(v25);
    return CcPostDeferredWrites(v4, a1);
  }
  v30 = (_QWORD **)(a1 + 784);
...
LABEL_107:
  ...
  *(_BYTE *)(a1 + 986) = 0;
  v89 = CcCalculatePagesToWriteForVolume(a1, a4);
  v34 = v89;
  ...
  *(_QWORD *)(a2 + 216) = MEMORY[0xFFFFF78000000014];
  ...
  if ( *(_QWORD *)(a1 + 664) != 560LL )
  {
    do
    {
      ...
      if ( v40 )
        v41 = v40;
      v92 = v41;
      if ( !CcIsCacheMapACursorInPrivateVCM(a1, v39) )
      {
        if ( CcShouldLazyWriteCacheMap(v39, 0LL, a1, v89, *(_QWORD *)(v39 + 96) & 0xFFFFFFFFFFFFFFF0uLL, a4) )
        {
          v96 = 0LL;
          v42 = CcGetNodeForLazyWrite(v39);
          ...
          *(_DWORD *)(v39 + 152) |= 0x20u;
          ...
          __writecr8(v56);
          WorkQueueEntry = CcAllocateWorkQueueEntry(v4, a1, v94, (PSLIST_ENTRY *)&v96);
          ...
          *(_QWORD *)(v63 + 16) = v39;
          ...
          CcPostWorkQueue((_QWORD *)v63, v67, v64, v65);
          v9 = 0;
          v87 = 1;
        }
        else
        {
          ...
          {
            CcIncrementWriteBehindPriority(v39);
          }
  ...
  while ( v78 != &v90 )
  {
    ...
    v90 = (_QWORD *)*v78;
    v80[1] = &v90;
    CcPostWorkQueue(v78, v78[19] + 104LL, v38, v35);
    v78 = v90;
  }
  if ( (_BYTE)dword_140D051DC
    || v79
    || *(_QWORD *)(a1 + 1104) != a1 + 1104
    || (CcComputeNextScanTime(v4, a1, v98, &v95), v95 != 0x7FFFFFFFFFFFFFFFLL) )
  {
    CcRescheduleLazyWriteScanOnVolume(a1, &v95);
    if ( *(_BYTE *)(a1 + 708) )
      *(_BYTE *)(a1 + 708) = 0;
  }
  else
  ...
  if ( (xmmword_140D06910 & 0x20000) != 0 )
    CcPerfLogLoggedStreamsStats(a4, *(_DWORD *)(v4 + 912));
  result = a1 + 1104;
