/*
 * XREFs of SmQueryStoreInformation @ 0x1407FA644
 * Callers:
...
__int64 __fastcall SmQueryStoreInformation(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  *(_QWORD *)v9 = *(_QWORD *)(a2 + 16);
  ...
  switch ( v8[1] )
  {
    ...
    case 8:
      return SmcProcessListRequest((unsigned int)&unk_140D32200, v8[2], v9[0], a5, PreviousMode);
    case 13:
      return SmcProcessStatsRequest((unsigned int)&unk_140D32200, v8[2], v9[0], a5, PreviousMode);
    case 15:
    ...
    case 23:
      ...
      return SmProcessProcessStoreInfoRequest(*(_QWORD *)&v8[2], (unsigned int)v9[0], a3);
    default:
      return 3221225475LL;
  }
}
