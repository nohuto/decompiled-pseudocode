/*
 * XREFs of PopLogNotifyDevice @ 0x1405D6E84
 * Callers:
    ...
    if ( a2 )
    {
      ...
      if ( v8 )
      {
        ...
        if ( (unsigned int)v9 > 0x6C )
          v10 = 108;
        RtlStringCchCopyW((NTSTRSAFE_PWSTR)&v12[4], 0x6DuLL, (NTSTRSAFE_PCWSTR)(v8 + 2LL * (unsigned int)(v9 - v10)));
        goto LABEL_11;
      }
    }
    else
...
LABEL_11:
    ...
    v13 = v12;
    v14 = 2 * v11 + 40;
    EtwTraceKernelEvent((__int64)&v13, 1u, 0x80008000, 0x1226u, 0x401802u);
  }
}
