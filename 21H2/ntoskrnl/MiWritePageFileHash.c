/*
 * XREFs of MiWritePageFileHash @ 0x14045D8D2
 * Callers:
...
void __fastcall MiWritePageFileHash(__int64 a1, __int64 a2, __int64 *a3, int a4, unsigned int a5)
{
  unsigned int v5; // esi
  __int64 v9; // rbp
  _QWORD *v10; // rbx
      ...
      *v13 = 0;
      ...
      if ( *a3 != qword_140C53278 )
      {
        ...
        if ( (unsigned int)v17 >> 3 == 3 )
        {
          ...
          {
LABEL_19:
            MiComputePageHash((__int64)v13, (__int64)v15, v16, v10);
            goto LABEL_20;
          }
        }
...
LABEL_25:
    ...
    do
    {
      if ( (*(_DWORD *)v20 > 1u || v11 && (*(_BYTE *)(v20 + 8) & 1) != 0) && !dword_140C52AC0 )
        MiPageHashBugCheck(0x60uLL, a4 + v19, (int)&v28[16 * v19]);
