/*
 * XREFs of PspChangeJobMemoryUsageByProcess @ 0x1406FECE0
 * Callers:
...
LABEL_19:
        if ( *(_QWORD *)(v10 + 1176) )
        {
          ...
          if ( a2 <= 0 )
            v21 = 0x8000LL;
          v26 |= PspGetJobMemoryUsageNotificationViolations(v10, v13, v16, v21);
        }
      }
LABEL_20:
      if ( a2 > 0 )
...
LABEL_69:
    ...
    if ( *(_QWORD *)(v10 + 552) && (*(_DWORD *)(v10 + 1068) & 0x200) != 0 && (*(_DWORD *)(v32 + 1120) & 0x24) == 4 )
    {
      ...
      PspSendJobNotification(v10, 10LL, *(_QWORD *)(v32 + 1088), 1);
      v16 = v30;
    }
    if ( !v6 )
      goto LABEL_20;
