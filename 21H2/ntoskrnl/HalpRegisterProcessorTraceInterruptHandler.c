/*
 * XREFs of HalpRegisterProcessorTraceInterruptHandler @ 0x140524894
 * Callers:
...
__int64 __fastcall HalpRegisterProcessorTraceInterruptHandler(__int64 (__fastcall *a1)(_QWORD))
{
  ...
  if ( qword_140D017C0 )
  {
    if ( qword_140D017C0 != KeGetCurrentThread()[1].CycleTime )
      return 3221225473LL;
    HalpProcessorTraceInterruptHandler = a1;
    qword_140D017C0 &= -(__int64)(a1 != 0LL);
  }
  else
  {
    HalpProcessorTraceInterruptHandler = a1;
    if ( a1 )
      qword_140D017C0 = KeGetCurrentThread()[1].CycleTime;
  }
