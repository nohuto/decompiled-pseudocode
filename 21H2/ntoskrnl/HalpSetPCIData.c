/*
 * XREFs of HalpSetPCIData @ 0x1403ADD44
 * Callers:
...
__int64 __fastcall HalpSetPCIData(__int64 a1, __int64 a2, __int64 a3, char *a4, unsigned int a5, size_t Size)
{
  ...
  if ( a5 < 0x40 )
  {
    ...
    v9 = v14;
    HalpWritePCIConfig(v11, v14, v8, (char *)v17 + a5, a5, v10);
    v6 = v10 + a5;
    v13 = &a4[v10];
    v7 -= v10;
  }
