/*
 * XREFs of PpmParkRegisterParking @ 0x1403CE6F8
 * Callers:
...
__int64 PpmParkRegisterParking()
{
  ...
  if ( PpmParkNodes )
  {
    ...
    v2 = PpmParkNodes;
    v3 = v0;
    Affinity = (PVOID)PpmParkHistograms;
    LODWORD(v84) = PpmParkNumNodes;
    ...
    if ( (_DWORD)v1 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( WORD1(v93[0]) > (unsigned __int16)v55 )
          break;
LABEL_87:
        PopExecuteOnTargetProcessors((__int64)v93, (__int64)PpmIdleRemoveConcurrency, 0LL, 0LL);
LABEL_7:
        v4 += 336;
        if ( !--v1 )
          goto LABEL_8;
...
LABEL_8:
  ...
  if ( PpmParkUseCoreGranularity )
  {
    ...
    *(_QWORD *)&v91 = PpmCheckRegistered;
    ...
    {
      Prcb = KeGetPrcb(v82);
      v10 = *(_QWORD *)(Prcb + 34912) - ((*(_QWORD *)(Prcb + 34912) >> 1) & 0x5555555555555555LL);
      if ( (_DWORD)v8 )
      {
...
LABEL_52:
    ...
    v42 = KeAcquireSpinLockRaiseToDpc(&PpmParkStateLock);
    PpmParkNodes = (__int64)Pool2;
    v43 = v42;
    PpmParkNumNodes = v6;
    PpmParkHistograms = (__int64)v32;
    KxReleaseSpinLock(&PpmParkStateLock);
    if ( KiIrqlFlags )
    {
      if ( (KiIrqlFlags & 1) != 0 )
  ...
  while ( 1 )
  {
    ...
    v14 = Affinity_8.Group >= (unsigned int)PpmCheckRegistered[0]
        ? 0LL
...
LABEL_40:
  ...
  if ( v12 < (unsigned int)v84 )
    ...
    v28 = 0LL;
  if ( (int)PpmIdleInitializeConcurrency(v93, v16 + 72, v28) >= 0 )
  {
...
LABEL_47:
      ...
      v16[135] = v23;
      v16[137] = v23;
      v29 = PpmParkMultiparkGranularity != 0;
      v16[145] = v23 / v29;
      v30 = v23 / v29;
      if ( v30 < (unsigned __int8)PpmParkGranularity )
...
LABEL_101:
      ...
      if ( (int)PpmIdleInitializeConcurrency(v93, &v16[8 * v21 + 152], v61) < 0 )
      {
        v32 = v86;
        goto LABEL_121;
      }
