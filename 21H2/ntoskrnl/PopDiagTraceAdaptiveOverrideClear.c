/*
 * XREFs of PopDiagTraceAdaptiveOverrideClear @ 0x140990F10
 * Callers:
...
void PopDiagTraceAdaptiveOverrideClear()
{
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03A00, 0x400000000000LL) )
    {
      ...
      v4 = 0x1000000LL;
      v11 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)byte_1400303F9, 0LL, 0LL, 5u, &v5);
    }
  }
}
