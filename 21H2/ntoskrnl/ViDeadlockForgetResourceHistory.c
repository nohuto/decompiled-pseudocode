/*
 * XREFs of ViDeadlockForgetResourceHistory @ 0x1409DF494
 * Callers:
 *     ViDeadlockTrimResources @ 0x1409DFEB8 (ViDeadlockTrimResources.c)
 * Callees:
 *     ViDeadlockRemoveNode @ 0x1409DF914 (ViDeadlockRemoveNode.c)
 */
