/*
 * XREFs of PiDmObjectProcessPropertyChange @ 0x1407783C4
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  *(_QWORD *)v35 = 0LL;
  ...
  if ( a4 )
    return;
  PiDmGetCacheKeys(a1, v41, &v37);
  if ( !v37 )
    return;
  v10 = a5;
  v11 = v41[0];
  CachedKeyIndex = PiDmGetCachedKeyIndex(v41[0], v37, a5);
  v13 = CachedKeyIndex;
  if ( CachedKeyIndex >= v14 )
    return;
  if ( !a3 )
  {
    Object = PiDmGetObject(v8, a2, &BugCheckParameter2);
    if ( Object < 0 )
      return;
    v45 = 1;
  }
  ...
  {
    Object = PnpGetObjectProperty(0x5A706E50u, 0LL, 0LL, v10, (__int64)v35, (__int64)&Buf2, (__int64)&Size_4, 0x10000);
  ...
  if ( v19 )
  {
    if ( v19 == 1 || Object < 0 || !*(_DWORD *)(v11 + 8 * v15 + 16) )
      goto LABEL_35;
    v20 = PiDmCacheDataDecode(&v17[2 * v15 + 28], &v35[4], 0LL, 0LL, &v35[8]);
    Object = v20;
    if ( v20 == -1073741275 )
    {
      *(_DWORD *)&v35[4] = 0;
    ...
    else
    {
      ...
      Object = PiDmCacheDataDecode(&v17[2 * v15 + 28], &v35[4], Pool2, v21, &v35[8]);
      if ( Object < 0 || *(_QWORD *)&v35[4] != __PAIR64__(Size_4, *(unsigned int *)v35) )
        goto LABEL_35;
      if ( !*(_DWORD *)&v35[8] )
      {
LABEL_22:
    ...
    if ( v23 )
      goto LABEL_22;
LABEL_35:
    PiDmCacheDataFree((__int64)&v17[2 * v15 + 28]);
    if ( Object >= 0 && *(_DWORD *)(v11 + 8 * v15 + 16) == 1 && !*(_DWORD *)(v11 + 8 * v15 + 12) )
...
LABEL_23:
  ...
  if ( *(_DWORD *)(v11 + 8 * v15 + 16) && !*v6 )
  {
    ...
    if ( v29 )
    {
      if ( (int)PiDmGetReferencedObjectFromProperty(v42, a2, (int)v17, v27, v29[2], *((_DWORD *)v29 + 6), (PVOID *)&v39) >= 0 )
      {
