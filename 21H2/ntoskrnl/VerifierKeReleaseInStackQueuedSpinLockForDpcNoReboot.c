/*
 * XREFs of VerifierKeReleaseInStackQueuedSpinLockForDpcNoReboot @ 0x1409DB120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierKeReleaseInStackQueuedSpinLockForDpcNoReboot(ULONG_PTR a1)
{
