/*
 * XREFs of KeWaitForAlertByThreadId @ 0x140217B04
 * Callers:
 *     PsDispatchIumService @ 0x1405E1764 (PsDispatchIumService.c)
 *     NtWaitForAlertByThreadId @ 0x140693F00 (NtWaitForAlertByThreadId.c)
 *     RtlpRunOnceWaitForInit @ 0x1409BEBF8 (RtlpRunOnceWaitForInit.c)
 * Callees:
...
LABEL_15:
    CurrentThread->WaitReason = 0;
    LOBYTE(v9) = v7;
    KiFastExitThreadWait(KeGetCurrentPrcb(), CurrentThread, v9);
    return v14;
  }
  return 258LL;
}
