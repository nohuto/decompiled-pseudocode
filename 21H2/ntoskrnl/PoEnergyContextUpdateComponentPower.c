/*
 * XREFs of PoEnergyContextUpdateComponentPower @ 0x1406831A8
 * Callers:
 ...
 *     RtlTimelineBitmapUpdate @ 0x140209470 (RtlTimelineBitmapUpdate.c)
...
LABEL_55:
    ...
    RtlTimelineBitmapUpdateRange(v38, v37, v35);
    goto LABEL_17;
  }
}
