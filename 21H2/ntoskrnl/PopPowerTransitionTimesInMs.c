/*
 * XREFs of PopPowerTransitionTimesInMs @ 0x14038B488
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  if ( a1 )
  {
    result = PopQpcTimeInMs(&qword_140C22CA8, &qword_140C22CB0);
    *a1 = result;
  }
  if ( a2 )
  {
    result = PopQpcTimeInMs(&qword_140C22CC8, &qword_140C22CD0);
    *a2 = result;
  }
  if ( a5 )
  {
    a5 = 0LL;
    result = PopQpcTimeInMs(&a5, &qword_140C22CE8);
    *v12 = result;
    if ( dword_140C22EF0 )
    {
