/*
 * XREFs of PiDevCfgFindDeviceDriver @ 0x1407449E0
 * Callers:
 ...
 *     PiDevCfgCompareDrivers @ 0x14056187C (PiDevCfgCompareDrivers.c)
...
LABEL_18:
      ...
      if ( *Str )
      {
        while ( 1 )
        {
          ...
          if ( !v16 )
            goto LABEL_40;
          DriverNode = DrvDbSplitDeviceIdDriverInfMatch(v15, 0LL, 0LL);
          if ( DriverNode < 0 )
            goto LABEL_43;
          v17 = v78;
          v18 = v15;
          *v16 = 0;
          ...
          if ( (_BYTE)v86 != 1 && (_BYTE)v86 != 2 && (_BYTE)v86 != 3 )
            goto LABEL_40;
          DriverNode = PiDevCfgQueryDriverNode(v18, v11, v20, (__int64)&P);
          if ( DriverNode >= 0 )
          {
            v21 = P;
            ...
            if ( v22 )
            {
              if ( *v22 )
              {
                do
                {
                  v30 = 0;
                  v31 = (PCWSTR *)(a1 + 32);
                  while ( !*v31 || !PnpMultiSzContainsString(*v31, v22) )
                  {
                    ++v30;
                    v31 += 2;
                    if ( v30 >= 3 )
...
LABEL_61:
            ...
            if ( v19 != 3 )
            {
              if ( !SourceString )
                goto LABEL_36;
              if ( !PiDevCfgMatchDriverConfigurationId((__int64)v21, SourceString) )
              {
                v35 = v69;
                v36 = (PVOID *)P;
                if ( *v69 != &v68 )
...
LABEL_39:
                ...
                if ( (int)PiDevCfgCompareDrivers((__int64)v21, (__int64)v7) < 0 )
                {
                  v37 = v69;
                  if ( *v69 != &v68 )
                    goto LABEL_175;
...
LABEL_47:
    while ( 2 )
    {
      ...
      *(_QWORD *)(v45 + 8) = &v71;
      P = v26;
      IsNullGuid = PnpIsNullGuid(v26 + 188);
      v47 = (char *)P;
            ...
            if ( !v60 )
            {
              if ( RtlEqualUnicodeString((PCUNICODE_STRING)(j + 9), (PCUNICODE_STRING)(v47 + 72), 1u) )
              {
                ...
                if ( !*((_QWORD *)P + 18) )
                  goto LABEL_158;
LABEL_165:
                if ( (int)PiDevCfgCompareDrivers((__int64)P, (__int64)j) >= 0 )
                {
LABEL_158:
                  v47 = 0LL;
                  j = v61;
...
LABEL_161:
        ...
        if ( v82 )
        {
          ...
          if ( v55 )
          {
            ...
            if ( !*v82 )
              goto LABEL_133;
            while ( !PiDevCfgMatchDriverConfigurationId((__int64)v47, v56) )
            {
              v57 = -1LL;
              do
                ++v57;
...
LABEL_133:
  ...
  {
    DriverNode = -1073741773;
    goto LABEL_49;
  }
  *v42 = 0;
  if ( (int)PiDevCfgQueryDriverNode(v24, v41 + 1, 4, (__int64)&P) < 0 )
    goto LABEL_109;
  v7 = P;
LABEL_45:
  if ( v7 )
...
LABEL_49:
  ...
  while ( 1 )
  {
    ...
    v66[1] = &v71;
    P = v28;
    PiDevCfgFreeDriverNode(v28);
  }
  if ( v7 )
    PiDevCfgFreeDriverNode(v7);
  if ( Str )
    ExFreePoolWithTag(Str, 0);
  return (unsigned int)DriverNode;
}
