/*
 * XREFs of DifRtlUnicodeStringToCountedOemStringWrapper @ 0x14061BD30
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlUnicodeStringToCountedOemStringWrapper(
        ...
        BOOLEAN AllocateDestinationString)
{
  ...
  v17 = 0LL;
  v18 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(426);
