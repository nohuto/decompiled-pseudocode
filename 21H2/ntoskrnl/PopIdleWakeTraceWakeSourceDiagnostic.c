/*
 * XREFs of PopIdleWakeTraceWakeSourceDiagnostic @ 0x14099C0B0
 * Callers:
...
LABEL_12:
  if ( (unsigned int)dword_140C03A00 > 5 && tlgKeywordOn((__int64)&dword_140C03A00, 0x400000000000LL) )
  {
    ...
    v58[1] = 0;
    v60 = 4LL;
    v72 = &PopIdleWakeIdleAccountingBucketLimitsMs;
    v62 = 8LL;
    v74 = a2 + 40;
    v76 = &PopIdleWakePeriodAccountingBucketLimitsMs;
    v78 = a2 + 76;
    v30 = *(_DWORD *)(a2 + 4);
    v80 = &v30;
    v64 = 8LL;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)byte_140031A38,
      0LL,
      0LL,
      0x21u,
      &v42);
    ...
    && EtwEventEnabled(PopDiagSleepStudyHandle, &SLEEPSTUDY_EVT_SCENARIO_DRIPS_WAKE_ACCOUNTING) )
  {
    ...
    *(_QWORD *)&UserData.Size = 1LL;
    ...
    v22 = 2LL * v16;
    *(&UserData.Ptr + v22) = (ULONGLONG)&PopWnfCsEnterScenarioId;
    v23 = PopDiagSleepStudyHandle;
    *((_QWORD *)&UserData.Size + v22) = 8LL;
    EtwWrite(v23, &SLEEPSTUDY_EVT_SCENARIO_DRIPS_WAKE_ACCOUNTING, 0LL, v16 + 1, &UserData);
  }
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_DRIPS_WAKE_SOURCE_MAPPING) )
    {
      ...
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v109 = *(_QWORD *)(a2 + 400);
      v110 = v25;
      EtwWrite(v24, &POP_ETW_EVENT_DRIPS_WAKE_SOURCE_MAPPING, 0LL, 3u, &UserData);
    }
  }
}
