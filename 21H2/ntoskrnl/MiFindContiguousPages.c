/*
 * XREFs of MiFindContiguousPages @ 0x1403016E0
 * Callers:
        ...
        __int64 *a11)
{
  ...
  if ( (v19 & 0x10000000) == 0 )
  {
    MiCreatePteCopyList(a5, 0x40uLL, (__int64)&v108, a4);
    if ( !DWORD1(v108) )
    {
      v27 = -1073741670;
      goto LABEL_128;
...
LABEL_64:
      ...
      else
      {
        if ( v39 == -1 )
        {
          ...
          v35 = (int *)v81;
          v39 = *(_DWORD *)(v44 + 8);
          v92 = qword_140C4DE98 + 4LL * v39 * (unsigned __int16)KeNumberNodes;
          v37 = v88;
...
LABEL_118:
                    ...
                    if ( (v77 & 0x40000000) == 0 )
                    {
                      ...
                      do
                      {
                        MiSetPfnOwnedAndActive((__int64)v59, 0LL, -8LL, v72, ((v77 & 0x100000) != 0) + 1);
                        v59 += 6;
                      }
                      while ( v59 != v73 );
                    }
                  ...
                  if ( *(_QWORD *)(qword_140C4E648 + 8 * ((v59[5] >> 39) & 0x3FF)) == a1 )
                  {
...
LABEL_111:
    if ( v66 && v83 == 1 )
    {
      if ( (DWORD1(PerfGlobalGroupMask) & 0x100000) != 0 )
      {
        ...
        v112[0] = v69;
        v111[0] = v112;
        EtwTraceKernelEvent((int)v111, 1, 0x20100000u, 625, 4200962);
      }
      v15 = a1;
      if ( byte_140C4EEDC )
