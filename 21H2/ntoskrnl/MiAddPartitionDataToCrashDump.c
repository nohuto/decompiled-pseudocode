/*
 * XREFs of MiAddPartitionDataToCrashDump @ 0x140592758
 * Callers:
...
__int64 __fastcall MiAddPartitionDataToCrashDump(__int64 a1)
{
  ...
  v1 = 0;
  LODWORD(v3) = MmAddRangeToCrashDump(a1, qword_140C51F48, 8LL);
  if ( (int)v3 < 0 )
    return (unsigned int)v3;
  LODWORD(v3) = MmAddRangeToCrashDump(a1, qword_140C51F28, 16LL);
  if ( (int)v3 < 0 )
    return (unsigned int)v3;
...
LABEL_18:
    ...
    if ( (_DWORD)v10 == -1 )
      break;
    v1 = v10 + 1;
    v15 = MiAddPartitionToCrashDump(a1, *(_QWORD *)(qword_140C51F48 + 8 * v10), v3);
    v3 = (unsigned int)v15;
  }
  while ( v15 >= 0 );
  if ( (int)v3 >= 0 )
  {
    if ( !qword_140C52960
      || (LODWORD(v3) = MmAddRangeToCrashDump(
                          a1,
                          qword_140C52960,
                          8 * (((unsigned __int64)qword_140C52958 >> 6) + ((qword_140C52958 & 0x3F) != 0))),
          (int)v3 >= 0) )
    {
      if ( qword_140C52968 )
        LODWORD(v3) = MmAddRangeToCrashDump(a1, qword_140C52968, 0x2000000LL);
    }
  }
  return (unsigned int)v3;
}
