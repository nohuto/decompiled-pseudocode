/*
 * XREFs of PpmInstallNewIdleStates @ 0x1403D1870
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x1403D1850 (PpmIdleInstallDefaultStates.c)
 * Callees:
 *     KxAcquireSpinLock @ 0x140211E00 (KxAcquireSpinLock.c)
 *     KxReleaseSpinLock @ 0x14021D070 (KxReleaseSpinLock.c)
 *     KeAddProcessorAffinityEx @ 0x140294460 (KeAddProcessorAffinityEx.c)
 *     PpmDeepestHardwareIdleState @ 0x1403D1DA8 (PpmDeepestHardwareIdleState.c)
...
__int64 __fastcall PpmInstallNewIdleStates(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (_DWORD)v9 )
  {
    ...
    if ( PpmIdleVetoList )
      v15 += ((_DWORD)v9 * *((_DWORD *)PpmIdleVetoList + 1)) << 6;
    ...
    if ( Pool2 )
    {
      ...
      *(_QWORD *)(Pool2 + 72) = 2097184LL;
      ...
      do
      {
        ...
        *(_QWORD *)(v23 + 40) = v23 + 40;
        ...
        v26 = (unsigned int *)PpmIdleVetoList;
        if ( PpmIdleVetoList )
        {
      ...
      *(_QWORD *)(v45 + 8) = v27;
      ...
      {
        v32 = a1;
        *(_QWORD *)(v27 + 24) = (unsigned int)KeMaximumIncrement
      ...
      LOBYTE(v33) = PpmDeepestHardwareIdleState(v44);
      ((void (__fastcall *)(__int64, _DWORD *))off_140C01CF8[0])(v33, v46);
