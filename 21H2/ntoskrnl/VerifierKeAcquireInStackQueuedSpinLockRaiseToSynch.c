/*
 * XREFs of VerifierKeAcquireInStackQueuedSpinLockRaiseToSynch @ 0x140A95C00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VerifierKeAcquireInStackQueuedSpinLockRaiseToSynch(__int64 a1, __int64 a2)
{
  ...
  ((void (__fastcall *)(__int64, __int64))pXdvKeAcquireInStackQueuedSpinLockRaiseToSynch)(a1, a2);
  if ( v5 )
