/*
 * XREFs of NtMapCMFModule @ 0x140959CF0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID *BaseAddress)
{
  ...
  PADAPTER_OBJECT *v51; // [rsp+90h] [rbp-E8h]
  unsigned int v52; // [rsp+98h] [rbp-E0h]
  HANDLE Handle; // [rsp+A0h] [rbp-D8h] BYREF
  __int64 v54[2]; // [rsp+A8h] [rbp-D0h] BYREF
