/*
 * XREFs of RawQueryFileSystemInformation @ 0x1409B54D8
 * Callers:
 ...
 *     RawComputeFileSystemInformationChecksum @ 0x1409B5484 (RawComputeFileSystemInformationChecksum.c)
...
__int64 __fastcall RawQueryFileSystemInformation(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_OWORD *)&v19[0].LowPart = 0LL;
  if ( (unsigned int)v4 >= 9 )
  {
    v7 = *(_QWORD **)(a1 + 24);
    memset(v7, 0, v4);
    Status = RawPerformDevIoCtrl(v8, *(struct _DEVICE_OBJECT **)(a3 + 184), v9, v10, v19);
    if ( Status >= 0 )
    {
      ...
      if ( HIDWORD(NumberOfBytes) >= 0x18 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          v13 = IopBuildSynchronousFsdRequest(3u, *(_QWORD *)(a3 + 184), PoolWithTag, v11, 0LL, &Event, &v18);
          if ( v13 )
          {
