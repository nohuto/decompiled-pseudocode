/*
 * XREFs of MiFlushTbAsNeeded @ 0x140340D60
 * Callers:
...
LABEL_13:
    ...
    if ( qword_140C4DF80 && (BugCheckParameter4 & 0x10) == 0 )
      BugCheckParameter4 &= ~qword_140C4DF80;
    v12 = ZeroPte;
...
LABEL_11:
    if ( (_DWORD)v13 )
    {
      ...
      {
        if ( MiCompareTbFlushTimeStamp(v13, -1) )
        {
          MiInsertTbFlushEntry((__int64)&v18, (__int64)(BugCheckParameter2 << 25) >> 16, 1LL, 0);
          v9 = 1;
        }
