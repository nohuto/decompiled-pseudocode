/*
 * XREFs of IopLiveDumpTraceCaptureProcessorContextDuration @ 0x1405092D0
 * Callers:
...
char __fastcall IopLiveDumpTraceCaptureProcessorContextDuration(const GUID *a1, __int64 a2)
{
  int v3; // eax
  _DWORD *v4; // rcx
  ...
  if ( (_BYTE)v3 )
  {
    if ( !v4[104] )
    {
      ...
      if ( (v3 & 1) != 0 )
      {
        ...
        v5 = (const EVENT_DESCRIPTOR *)LIVEDUMP_EVENT_SIZING_WORKFLOW_SYSTEM_QUISCED_CAPTURE_PROCESSOR_CONTEXT;
        if ( (v4[20] & 1) == 0 )
          v5 = &LIVEDUMP_EVENT_CAPTURE_PAGES_WORKFLOW_SYSTEM_QUISCED_CAPTURE_PROCESSOR_CONTEXT;
        UserData.Size = 8;
        ...
        if ( (unsigned int)dword_140C044D8 > 5 )
        {
          ...
          if ( (_BYTE)v3 )
          {
            ...
            LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)&dword_140024D44,
                           a1 + 54,
                           a1 + 53,
                           3u,
                           &v9);
