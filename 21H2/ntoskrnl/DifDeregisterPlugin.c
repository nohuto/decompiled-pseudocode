/*
 * XREFs of DifDeregisterPlugin @ 0x140604620
 * Callers:
 ...
 *     ViUnbindDifThunk @ 0x1405FEEA4 (ViUnbindDifThunk.c)
...
LABEL_34:
          ...
          *v15 = 0LL;
          ...
          if ( !ViUnbindDifThunk((__int64)&VfDifThunks, *((_DWORD *)v4 + 2))
            ...
            && !ViUnbindDifThunk((__int64)&VfMandatoryThunks, v18) )
          {
            ViUnbindDifThunk((__int64)&VfRegularThunks, v19);
          }
          if ( *v4 )
          {
      ...
      v20 = (_QWORD *)DifPluginSettings[v1];
      if ( v20 )
      {
        v21 = (void (*)(void))v20[1];
        if ( v21 )
