/*
 * XREFs of RtlpComputeMergedAcl2 @ 0x1409141B8
 * Callers:
    ...
    *v19 = 5120;
    if ( a3 )
    {
      if ( *a3 >= 2u )
        LOBYTE(v18) = *a3;
      LOBYTE(v25) = 0;
      result = RtlpCopyAces((__int64)a3, a7, 2, 16, 1, a5, a6, a5, a6, 1, v25, a8, &v28, v14);
LABEL_6:
  ...
  if ( (a2 & 0x1000) == 0 )
  {
    ...
    if ( a3 )
    {
      if ( *a3 >= 2u )
        v18 = *a3;
      LOBYTE(v25) = 0;
      result = RtlpCopyAces((__int64)a3, a7, 1, 0, 1, a5, a6, a5, a6, 1, v25, a8, &v28, v14);
      if ( (_DWORD)result == -1073741789 )
      {
        v16 = 1;
        result = 0LL;
  ...
  if ( a3 )
  {
    if ( *a3 >= 2u )
      LOBYTE(v18) = *a3;
    LOBYTE(v25) = 1;
    result = RtlpCopyAces((__int64)a3, a7, 2, 0, 1, a5, a6, a5, a6, 1, v25, a8, &v28, v14);
    goto LABEL_6;
  }
  if ( a8 == 1 )
    return 3221225591LL;
