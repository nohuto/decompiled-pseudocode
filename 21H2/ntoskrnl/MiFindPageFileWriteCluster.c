/*
 * XREFs of MiFindPageFileWriteCluster @ 0x14037E048
 * Callers:
 ...
 *     RtlFindLongestRunClearCapped @ 0x1405E58D0 (RtlFindLongestRunClearCapped.c)
...
unsigned int *__fastcall MiFindPageFileWriteCluster(__int64 a1, unsigned int *a2, unsigned int *a3, int a4)
{
  ...
  FreePageFileSpace = MiFindFreePageFileSpace(v10, &v29, v4, v11 != 0 ? 38 : 32);
  ...
  else
  {
    ...
    else
    {
      ...
      if ( _bittest16((const signed __int16 *)(a1 + 204), 0xBu) )
        v4 = 1;
      MiRefPageFileSpaceBitmaps(a1, v27);
      v20 = (char *)v27 + 8;
      v21 = (unsigned int *)(a1 + 120);
    }
    v31 = *v21;
    LongestRunClearCapped = RtlFindLongestRunClearCapped(v20, v4, &v31);
    v23 = a4 == 0;
