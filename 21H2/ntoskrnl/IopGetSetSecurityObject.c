/*
 * XREFs of IopGetSetSecurityObject @ 0x14064F760
 * Callers:
 *     <none>
 * Callees:
        ...
        char a9)
{
  ...
  void *(__fastcall *v37)(_DMA_ADAPTER *, _LARGE_INTEGER *, _LARGE_INTEGER *, unsigned int, unsigned int, _MEMORY_CACHING_TYPE *, unsigned int, _LARGE_INTEGER *); // [rsp+40h] [rbp-58h]
