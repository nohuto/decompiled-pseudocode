/*
 * XREFs of MiDeleteEmptyPageTableCommit @ 0x140233E34
 * Callers:
...
__int64 __fastcall MiDeleteEmptyPageTableCommit(_QWORD *a1)
{
  _QWORD *v2; // r9
  __int64 v3; // rdi
  __int64 v4; // r9
  ...
  else
  {
    ...
    HIDWORD(v22[1]) = (LeafVa >> 12) - 1;
    BYTE1(v22[2]) = ((LeafVa >> 12) - 1) >> 32;
    v8 = (char *)v22 + 1;
  }
  ...
  v12 = v11;
  MiCaptureDeleteHierarchy(LeafVa, v7, v11, &v24);
  LOBYTE(v13) = v12;
  MiUnlockWorkingSetShared(a1[3], v13);
  MiReturnPageTablePageCommitment(LeafVa, v7, (_DWORD)Process, (_DWORD)v8, (__int64)v9, v3, (__int64)&v24);
  v14 = v25;
  result = v25[2];
  v16 = *(_QWORD *)(result + 32);
  if ( v16 )
  {
    _InterlockedExchangeAdd64((volatile signed __int64 *)&Process[1].Affinity.StaticBitmap[13], -v16);
    result = v14[2];
