/*
 * XREFs of Xp10ReadAndDecodeHuffmanTables @ 0x1409C45C0
 * Callers:
 *     Xp10ExecuteHuffmanDecode @ 0x1409C2AF0 (Xp10ExecuteHuffmanDecode.c)
 * Callees:
 *     memset @ 0x140435E00 (memset.c)
 *     Xp10BuildHuffmanDecodeTable @ 0x1409C1F40 (Xp10BuildHuffmanDecodeTable.c)
 *     Xp10SortHuffmanSymbols @ 0x1409C5260 (Xp10SortHuffmanSymbols.c)
 */
...
LABEL_143:
    v118 = Xp10SortHuffmanSymbols(v22, (int)v9 + 728, a2, v52, v50);
    if ( !v118 )
      return 3221226050LL;
    *a8 = Xp10BuildHuffmanDecodeTable(v22, v9 + 37464, (_WORD *)(v9 + 728), v118, 0xCu, 6, v9 + 37464, v119, a6);
    return 0LL;
  }
  v23 = v18 - 1;
  if ( !v23 )
  ...
  if ( !v49 )
    return 3221226050LL;
  v50 = 8;
  v123 = Xp10BuildHuffmanDecodeTable(v9 + 24, v9 + 37464, (_WORD *)(v9 + 728), v49, 8u, 4, v9 + 37464, v119, v9 + 2136);
  v51 = v123;
