/*
 * XREFs of DifZwSetInformationTransactionWrapper @ 0x140627910
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  *(_QWORD *)&v21 = TransactionHandle;
  DWORD2(v20) = TransactionInformationClass;
  *(_QWORD *)&v20 = TransactionInformation;
  DWORD2(v19) = TransactionInformationLength;
