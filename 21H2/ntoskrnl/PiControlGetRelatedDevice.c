/*
 * XREFs of PiControlGetRelatedDevice @ 0x1407753A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiControlGetRelatedDevice(__int64 a1, __int16 *a2, __int64 a3, char a4)
{
  ...
  int v8; // eax
  unsigned int v9; // edx
  int BufferForUserModeCaller; // edi
  ...
  *((_QWORD *)&v16 + 1) = 0LL;
  ...
  if ( v7 && (v8 = *((_DWORD *)a2 + 8)) != 0 )
    ...
    v9 = 0;
  v17 = v9;
  BufferForUserModeCaller = PiControlAllocateBufferForUserModeCaller((__int64 *)&v15, v9, a4, v7);
