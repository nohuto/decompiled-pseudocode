/*
 * XREFs of HalpHvInitMcaPcrContext @ 0x1403D2700
 * Callers:
...
void HalpHvInitMcaPcrContext()
{
  ...
  if ( HalpHvWheaEnlightenedCpuManager )
  {
    ...
    if ( !*(_QWORD *)&Pcr->HalReserved[6] )
    {
      ...
      if ( !qword_140C4C4D0 )
        goto LABEL_21;
      v5 = qword_140C4C4D0(4294967294LL, &v17, 0LL);
      if ( v5 == -1073741789 )
      {
        v6 = 8 * v17;
        ...
        if ( qword_140C4C4D0 )
          v5 = qword_140C4C4D0(4294967294LL, &v17, Pool2);
        else
          v5 = -1073741823;
      }
      if ( v5 < 0 || !v17 )
LABEL_21:
      ...
      *(_QWORD *)&Pcr->HalReserved[6] = McaPcrContext;
      ...
      v15 = HalpGetMcaPcrContext(__SPAIR64__(v13, v14));
      *(_QWORD *)(v15 + 184) = 0LL;
