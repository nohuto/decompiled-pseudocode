/*
 * XREFs of PopPowerInformationInternal @ 0x140678DF4
 * Callers:
 ...
 *     PoDirectedDripsSetDeviceFlags @ 0x1403C9E40 (PoDirectedDripsSetDeviceFlags.c)
 *     __security_check_cookie @ 0x1403D0460 (__security_check_cookie.c)
 *     ZwUpdateWnfStateData @ 0x1403FDDA0 (ZwUpdateWnfStateData.c)
 *     PpmInternalPlatformIdleVeto @ 0x1405672D8 (PpmInternalPlatformIdleVeto.c)
 *     PpmInternalProcessorIdleVeto @ 0x14056732C (PpmInternalProcessorIdleVeto.c)
 *     PoDirectedDripsClearDeviceFlags @ 0x1405687C0 (PoDirectedDripsClearDeviceFlags.c)
...
LABEL_106:
    ...
    if ( (_DWORD)v9 == 29 )
    {
      ...
      *v64 = PopFirmwareResetReason;
      v64[1] = xmmword_140C54350;
      v65 = xmmword_140C54360;
LABEL_197:
      v64[2] = v65;
      *a5 = v64;
      *a6 = 48;
      ...
      if ( v37 )
      {
        ...
        if ( v38 )
        {
          ...
          if ( !v41 )
            return (unsigned int)-1073741670;
          if ( !PopPlatformAoAc
            || (v67 = (unsigned __int8)RtlIsMultiSessionSku() == 0, PowerButtonBugcheckEnabled = 1, v67) )
          {
