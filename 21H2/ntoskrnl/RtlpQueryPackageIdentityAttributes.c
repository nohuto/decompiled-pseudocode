...
__int64 __fastcall RtlpQueryPackageIdentityAttributes(int a1, __int64 a2, __int64 a3, _QWORD *a4, _QWORD *a5)
{
  ...
  {
    *v5 |= (2LL * v9) | 1;
    if ( (unsigned int)SeQuerySecurityAttributesToken(a1, (unsigned int)&qword_1400010A8, 1, 0, 0, (__int64)&v13) == -1073741789 )
      *v5 |= 4uLL;
    if ( (unsigned int)SeQuerySecurityAttributesToken(a1, (unsigned int)&qword_140001098, 1, 0, 0, (__int64)&v13) == -1073741789 )
      *v5 |= 8uLL;
  }
  return 0LL;
}
