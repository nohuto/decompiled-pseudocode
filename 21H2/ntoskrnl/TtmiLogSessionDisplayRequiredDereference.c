/*
 * XREFs of TtmiLogSessionDisplayRequiredDereference @ 0x140903B74
 * Callers:
...
void TtmiLogSessionDisplayRequiredDereference()
{
  ...
  if ( (unsigned int)dword_140D2D8C8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8C8, 1LL) )
    {
      ...
      v10 = 4LL;
      v12 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8C8, (unsigned __int8 *)&unk_14002BBB0, 0LL, 0LL, 5u, &v6);
    }
  }
}
