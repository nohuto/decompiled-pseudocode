/*
 * XREFs of TtmiLogSessionDisplayRequiredDereference @ 0x1409A9718
 * Callers:
...
void TtmiLogSessionDisplayRequiredDereference()
{
  ...
  if ( (unsigned int)dword_140D3B908 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D3B908, 1LL) )
    {
      ...
      v10 = 4LL;
      v12 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D3B908, (unsigned __int8 *)byte_1400338B9, 0LL, 0LL, 5u, &v6);
    }
  }
}
