/*
 * XREFs of DifRtlOemStringToCountedUnicodeStringWrapper @ 0x14061B550
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DifRtlOemStringToCountedUnicodeStringWrapper(
...
LABEL_18:
  result = RtlOemStringToCountedUnicodeString(DestinationString, SourceString, AllocateDestinationString);
  LODWORD(v19) = result;
  if ( APIThunkContextById )
  {
