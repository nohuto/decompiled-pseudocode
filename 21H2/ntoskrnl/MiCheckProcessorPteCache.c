/*
 * XREFs of MiCheckProcessorPteCache @ 0x140309C60
 * Callers:
...
LABEL_71:
      if ( !v25 )
      {
        if ( !(unsigned int)MiEmptyPteBins((__int64)&qword_140C534C0, 0) )
          return 0LL;
        v21 = 0LL;
        goto LABEL_25;
      }
...
LABEL_14:
    v4 = qword_140C534D0 + 8 * (v15 + CurrentPrcb->PteBitOffset);
  }
LABEL_15:
  if ( KiIrqlFlags )
  {
