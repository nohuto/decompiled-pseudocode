/*
 * XREFs of MiRelocateImageAgain @ 0x1406FF49C
 * Callers:
...
__int64 __fastcall MiRelocateImageAgain(__int64 a1, int a2)
{
  ...
  {
    v10 = *(_QWORD *)(v6 + 32);
    v7 = (_QWORD *)MiReservePtes((__int64)&qword_140C534C0, 1u);
    if ( !v7 )
    {
...
LABEL_12:
          ...
          MiSwitchBaseAddress((_QWORD *)a1, v12, (unsigned __int64)v7, SessionId);
          goto LABEL_10;
        }
        if ( qword_140C1B920 )
        {
          updated = qword_140C1B920(*(_QWORD *)(v2 + 40) & 0xFFFFFFFFFFFFFFF8uLL, v12);
          if ( updated >= 0 )
            goto LABEL_12;
        }
        else
...
LABEL_3:
  ...
  if ( v7 )
    MiReleasePtes((__int64)&qword_140C534C0, v7, 1u);
