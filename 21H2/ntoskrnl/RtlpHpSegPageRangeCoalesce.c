/*
 * XREFs of RtlpHpSegPageRangeCoalesce @ 0x140312B20
 * Callers:
...
__int64 __fastcall RtlpHpSegPageRangeCoalesce(__int64 a1, __int64 a2, unsigned int a3, int a4, _BYTE *a5)
{
  ...
  int v34; // eax
  int v35[18]; // [rsp+30h] [rbp-48h] BYREF
        ...
        if ( KiIrqlFlags )
        {
          if ( (KiIrqlFlags & 1) != 0 )
          {
            ...
            if ( CurrentIrql <= 0xFu && (unsigned __int8)v19 <= 0xFu && CurrentIrql >= 2u )
            {
              ...
              v34 = ~(unsigned __int16)(-1LL << ((unsigned __int8)v19 + 1));
              v27 = (v34 & SchedulerAssist[5]) == 0;
...
LABEL_51:
    ...
    RtlpHpSegPageRangeCommit(a1, 0, (__int64)v35);
