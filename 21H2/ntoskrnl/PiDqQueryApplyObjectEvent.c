/*
 * XREFs of PiDqQueryApplyObjectEvent @ 0x140775D50
 * Callers:
...
char __fastcall PiDqQueryApplyObjectEvent(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  int AddObjectToResultSet; // [rsp+30h] [rbp-10h]
  ...
  if ( (v4 & 4) != 0 )
  {
    AddObjectToResultSet = PiDqSameUserHive(a1 + 32, a2 + 24, &Buffer, a4);
...
LABEL_60:
          if ( AddObjectToResultSet >= 0 )
          {
            if ( !v36 )
              return v18;
            if ( (int)PiDqQueryActionQueueEntryCreate(v37, *(_QWORD *)(a2 + 8), a2, &v59) >= 0 )
            {
              v38 = KeGetCurrentThread();
              --v38->KernelApcDisable;
              ExAcquirePushLockExclusiveEx(a1 + 64, 0LL);
              PiDqQueryAppendActionEntry(a1, v59);
              v39 = a1 + 64;
LABEL_64:
              ExReleasePushLockEx(v39, 0LL);
              LOBYTE(v18) = KiLeaveCriticalRegionUnsafe((__int64)KeGetCurrentThread());
              return v18;
            }
          }
LABEL_134:
...
LABEL_84:
      ...
      if ( *(_QWORD *)(v18 + 88) )
      {
        LODWORD(v18) = PiDqQueryEvaluateFilter(a1, *(_QWORD *)(*(_QWORD *)(a2 + 8) + 16LL), &Buffer);
        AddObjectToResultSet = v18;
