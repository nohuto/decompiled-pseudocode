/*
 * XREFs of PiDevCfgEnumDeviceKeys @ 0x140697EF0
 * Callers:
        ...
        __int64 a7)
{
  ...
  while ( 1 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v14 )
    {
      DeviceRegProp = CmOpenDeviceRegKey(PiPnpRtlCtx, *(_QWORD *)(a2 + 8), v14, 0, 983103, a5, (__int64)&Handle, 0LL);
LABEL_19:
      if ( DeviceRegProp == -1073741772 )
        goto LABEL_35;
      if ( DeviceRegProp < 0 )
...
LABEL_14:
    ...
    if ( *v7 == 7 )
    {
      v20 = *(_QWORD *)(a2 + 8);
      v25 = 78;
      DeviceRegProp = CmGetDeviceRegProp(PiPnpRtlCtx, v20, 0, 9, (__int64)&v26, (__int64)SourceString, (__int64)&v25, 0);
      if ( DeviceRegProp < 0 )
        goto LABEL_19;
      if ( v26 != 1 )
      {
