/*
 * XREFs of Normalization__CanCombineWithStartBase @ 0x1409BCF40
 * Callers:
 ...
 *     Normalization__GetFirstDecomposedCharPlane0 @ 0x1409BD054 (Normalization__GetFirstDecomposedCharPlane0.c)
 */
