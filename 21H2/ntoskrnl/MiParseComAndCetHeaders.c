/*
 * XREFs of MiParseComAndCetHeaders @ 0x1407E4D40
 * Callers:
  ...
  *a3 = 0;
  ...
  if ( v25 >= 0 )
  {
    ...
    if ( (v6 & 1) != 0 )
    {
      ...
      MiLogRelocationRva((unsigned int)v20, 72LL, v10, a1);
      v21 = v32;
      if ( (v32 & 1) != 0 )
      {
        *a3 = 1;
    ...
    if ( (v6 & 2) != 0 )
    {
      ...
      for ( i = 0; ; i = v27 + 1 )
      {
        ...
        if ( i >= (v14 + (((unsigned __int64)a2[27] - v14) >> 1)) >> 4 )
          break;
        MiLogRelocationRva(a2[26] + 28 * i, 28LL, v26, a1);
        v29 = *(_QWORD *)(v12 + 16);
        if ( HIDWORD(*(_OWORD *)v12) == 20 )
        {
          ...
          if ( (unsigned int)v29 >= v16 || HIDWORD(v29) >= v16 || HIDWORD(v29) + (int)v29 >= v16 )
            break;
          MiLogRelocationRva(HIDWORD(v29), 4LL, v26, a1);
