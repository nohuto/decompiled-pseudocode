/*
 * XREFs of SepCommonAccessCheckEx @ 0x140383ABC
 * Callers:
 ...
 *     AuthzBasepMergeAccessReasons @ 0x14064A73C (AuthzBasepMergeAccessReasons.c)
        ...
        char a7)
{
  ...
  **(_DWORD **)(a4 + 16) = -1073741790;
  ...
  v17 = v212;
  AuthzBasepSetAccessReasons(v212, 0, 0, v16, 1);
  if ( a6 == v19 )
  {
    v71 = *(_DWORD *)(a3 + 16);
    v72 = *(int **)(a4 + 8);
  ...
  v22 = SepTrustLevelCheck(v18, *(_QWORD *)(v20 + 8), SubjectContext, 0LL, 0LL, 0, &v211);
  v24 = 0LL;
  **(_DWORD **)(a4 + 16) = v22;
  v25 = *(int **)(a4 + 16);
  if ( *v25 < 0 )
  ...
  *v25 = (*(_DWORD *)(a3 + 16) & 0xFDFFFFFF) != (v211 & *(_DWORD *)(a3 + 16) & 0xFDFFFFFF) ? 0xC0000022 : 0;
  ...
  if ( *v27 < 0 )
  {
    ...
    SeLogAccessFailure(PrimaryToken, 0LL, 0LL, TokenTrustLevel, *(_QWORD *)(v78 + 8), v77, 0);
    if ( !a2 )
  ...
  if ( (*(_DWORD *)(v29 + 4) & 4) == 0 )
  {
    v30 = SepFilterCheck(*(_QWORD *)(v29 + 8), (__int64 *)&P, ClientToken, 0, &v216);
    v24 = 0LL;
    **(_DWORD **)(a4 + 16) = v30;
    v31 = *(int **)(a4 + 16);
    if ( *v31 < 0 )
...
LABEL_34:
  ...
  if ( !v36 )
  {
    **(_DWORD **)(a4 + 16) = SepMandatoryIntegrityCheck(
    ...
    if ( **(int **)(a4 + 16) >= 0 )
    {
      v37 = SepMandatoryToDiscretionary(&v219, *(_DWORD *)(a3 + 16));
      *v38 = v37;
      ...
      v82 = v17 & ~(_DWORD)v219;
LABEL_107:
      AuthzBasepSetAccessReasons(v82, v81, 0, *(_QWORD *)(a4 + 24), v177);
      return 0;
    }
LABEL_116:
    v75 = a2 == 0;
...
LABEL_42:
  ...
  IsOwner = SepTokenIsOwner((__int64)ClientToken, *(_QWORD *)(*(_QWORD *)(a3 + 8) + 8LL));
  v41 = *(_DWORD *)(a3 + 16);
  v24 = 0LL;
  v193 = IsOwner;
  v42 = IsOwner;
...
LABEL_79:
  ...
  AuthzBasepSetAccessReasons(v70, 0x400000, 0, *(_QWORD *)(a4 + 24), 0);
  v24 = 0LL;
  v39 = v189;
...
LABEL_45:
  ...
  v52 = v208;
  v195 = v48;
  if ( !SepRmEnforceCap || (v212 = **(_DWORD **)(a4 + 16), v212 < 0) || !v189 )
  {
LABEL_47:
      ...
      if ( (_BYTE)v206 && !*(_WORD *)((char *)&v227 + 1) )
      {
        if ( (ClientToken[50] & 0x400000) == 0 || DWORD2(v226) )
        {
          ...
          **(_DWORD **)(a4 + 8) = 0;
          v169 = *(_DWORD **)(a4 + 8);
          v191 = 0;
          AuthzBasepSetAccessReasons(~*v169, 3145728, 0, *(_QWORD *)(a4 + 24), 0);
        }
        else
        {
          v168 = *(_DWORD **)(a4 + 16);
    ...
    else
    {
      ...
      {
        SepConstrainByMandatory((__int64)&v219, v49, v50, *(char **)(a4 + 16), &v191, 0);
    ...
    if ( ClientToken )
    {
        ...
        || (v62 = DWORD2(v226)) == 0 && (ClientToken[50] & 0x4000) != 0 && (**(int **)(a4 + 16) < 0 || BYTE3(v227)) )
      {
        ...
        v173 = *(_QWORD *)(a3 + 8);
        v174 = **(_DWORD **)(a4 + 16) >= 0;
        v175 = SepLocateTokenTrustLevel((__int64 *)SubjectContext);
        v178 = v172;
        ClientToken = Object;
        SeLogAccessFailure((char *)Object, 0LL, 0LL, v175, *(_QWORD *)(v173 + 8), v178, v174);
        v62 = DWORD2(v226);
      }
      if ( **(int **)(a4 + 16) < 0
        && !v62
  ...
  LOBYTE(v50) = 1;
  LOBYTE(v49) = 1;
  v101 = SepAdtAuditThisEventWithContext(129LL, v49, v50, SubjectContext);
  v102 = 0LL;
  v193 = v101;
  v103 = v101;
  if ( v101 )
  {
    ...
    if ( !Pool2 )
    {
      ...
      v108 = *(_QWORD *)(v52 + 32);
      if ( v108 )
        SepRmDereferenceCapTable(v108, v105, v106, v107);
      **(_DWORD **)(a4 + 8) = 0;
...
LABEL_218:
        ...
        if ( v109 )
        {
          ...
          do
          {
            ...
            if ( *((_BYTE *)v156 + 4) )
            {
              ...
              if ( v160 )
              {
                AuthzBasepSetAccessReasons(v160, 0x80000000, v158, (__int64)v232, 0);
                v157 = v201;
                v154 = v200;
              }
              v161 = ~v160 & v154;
              ...
              if ( v163 )
              {
                AuthzBasepSetAccessReasons(v163, 0x80000000, v158, (__int64)v232, 0);
                v163 = v201;
              }
              v153 = ~v163 & v162;
              v203 = v153;
  ...
  while ( 1 )
  {
    ...
    if ( !P )
    {
      v113 = AuthzBasepInitializeResourceClaimsFromSacl(v214, (__int64 *)&P);
      v102 = 0LL;
      v112 = P;
...
LABEL_192:
    if ( !(_BYTE)v203 && v123 != 1 )
      goto LABEL_216;
LABEL_194:
    v124 = SepBuildCapeSecurityDescriptor(SecurityDescriptor);
    if ( v124 < 0 )
    {
      if ( !a2 )
        SeUnlockSubjectContext(SubjectContext);
      v167 = *(_QWORD *)(v208 + 32);
      if ( v167 )
        SepRmDereferenceCapTable(v167, 0LL, v131, v132);
      **(_DWORD **)(a4 + 8) = 0;
      goto LABEL_248;
    }
    v133 = *(_DWORD *)(a3 + 16);
    ...
    if ( (v200 & (v200 ^ v141)) != 0 )
    {
      AuthzBasepSetAccessReasons(v200 & (v200 ^ v141), 327680, v201, (__int64)v231, 0);
      v200 &= v141;
      v138 = v204;
      v102 = 0LL;
    }
    ...
    if ( v193 )
    {
      if ( *(_QWORD *)(v207 + 40) )
      {
        v124 = SepBuildCapeSecurityDescriptor(v223);
        if ( v124 < 0 )
        {
          if ( !a2 )
            SeUnlockSubjectContext(SubjectContext);
          v166 = *(_QWORD *)(v208 + 32);
          if ( v166 )
            SepRmDereferenceCapTable(v166, v143, 0LL, v144);
          **(_DWORD **)(a4 + 8) = 0;
          goto LABEL_248;
        }
        v145 = *(_DWORD *)(a3 + 16);
...
LABEL_216:
  ...
  v130 = AuthzBasepEvaluateAceCondition(
           ClientToken,
           *((void **)ClientToken + 97),
           P,
           v126,
...
LABEL_237:
  ...
  v165 = *(_QWORD *)(v208 + 32);
  if ( v165 )
    SepRmDereferenceCapTable(v165, v120, v121, v122);
  **(_DWORD **)(a4 + 8) = 0;
LABEL_248:
  **(_DWORD **)(a4 + 16) = v124;
  SepFreeResourceInfo(P);
