/*
 * XREFs of KiFindNextTimerDueTime @ 0x14030A6F0
 * Callers:
  ...
  while ( 2 )
  {
    ...
    if ( KiSerializeTimerExpiration )
    {
      if ( !v6 )
        goto LABEL_25;
      v29 = v11;
      v30 = *(_DWORD *)(KiProcessorBlock[0] + 4LL * v11 + 32272);
      v31 = (unsigned __int8)(v13 - v30);
      if ( v31 > 1 )
        return 0LL;
      v32 = KiProcessorBlock[0] + (v29 << 13);
...
LABEL_92:
        ...
        if ( ++v46 >= (unsigned __int16)KiActiveGroups )
        {
          ...
          if ( v4 == -1 )
            ...
            v14 = (unsigned int)KePseudoHrTimeIncrement + (v8 & 0xFFFFFFFFFFFC0000uLL) + (v4 << 18);
          goto LABEL_24;
        }
      }
    }
    v16 = *(_QWORD *)(v9 + 200);
    v4 = 0;
    v17 = &KiPendingTimerBitmaps[2 * *(unsigned __int8 *)(v9 + 208)];
    while ( 2 )
    {
      v18 = *v17;
