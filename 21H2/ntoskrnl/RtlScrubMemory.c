/*
 * XREFs of RtlScrubMemory @ 0x140590568
 * Callers:
 ...
 *     RtlpGenericRandomPatternWorker @ 0x140590C0C (RtlpGenericRandomPatternWorker.c)
 *     RtlpGenericStrideWorker @ 0x140590F2C (RtlpGenericStrideWorker.c)
 */
