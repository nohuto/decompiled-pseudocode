/*
 * XREFs of WdipSemLoadNextEndEvent @ 0x14083F908
 * Callers:
...
LABEL_36:
    ...
    if ( v6 < 0 )
      goto LABEL_29;
    v15 = WdipSemQueryValueFromRegistry(Handle, &v23, (__int64)&ResultLength);
    v6 = v15;
    if ( v15 < 0 )
    {
      if ( v15 != -1073741772 )
    ...
    v17 = WdipSemQueryValueFromRegistry(Handle, &v26, (__int64)&ResultLength);
    v6 = v17;
    if ( v17 >= 0 )
    {
      v18 = v26;
...
LABEL_26:
      v19 = WdipSemQueryValueFromRegistry(Handle, &v24, (__int64)&ResultLength);
      v6 = v19;
      if ( v19 >= 0 )
      {
