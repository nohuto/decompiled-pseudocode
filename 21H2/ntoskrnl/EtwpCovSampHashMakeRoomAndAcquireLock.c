/*
 * XREFs of EtwpCovSampHashMakeRoomAndAcquireLock @ 0x1409F12F0
 * Callers:
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(BugCheckParameter2 + 1176) = v20;
            ...
            v21 = (unsigned int)(v21 + 1) )
      {
        ...
        if ( *v23 )
        {
          EtwpCovSampHashLookupInTable(*(_QWORD *)(BugCheckParameter2 + 1152), (unsigned __int8 *)(v22 + 8 * v21), &v30);
          *v30 = *v23;
          if ( (*((_DWORD *)v15 + 4))-- == 1 )
            break;
        }
...
LABEL_35:
      __fastfail(3u);
    *Table = BugCheckParameter2 + 1168;
    Table[1] = (__int64)v29;
    *v29 = Table;
    *(_QWORD *)(BugCheckParameter2 + 1176) = Table;
