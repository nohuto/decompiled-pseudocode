/*
 * XREFs of EtwTimLogControlProtectionUserModeReturnMismatch @ 0x1409E6BB0
 * Callers:
...
LABEL_8:
  ...
  *(_QWORD *)&UserData.Size = 2LL;
  ...
  v118 = v12;
  v119 = 0;
  EtwpQueryProcessCommandLine(a2, (__int64)&v76);
  ...
  v54[0] = v15;
  v124 = 0;
  v16 = EtwpTiFillProcessIdentity(v125, a2, &v70) + 4;
...
LABEL_20:
  ...
  *(&UserData.Reserved + 2 * v22) = 0;
  ...
  if ( v24 )
  {
    if ( ZwQueryVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, v66, (MEMORY_INFORMATION_CLASS)2, v24, 0x200uLL, 0LL) >= 0 )
    {
      if ( *v25 )
      {
        v53[0] = *v25 >> 1;
...
LABEL_24:
  ...
  *((_QWORD *)&UserData.Size + v31) = 4LL;
  if ( (int)MmGetImageInformation((unsigned __int64)v33, &v59, &v69, &v57) < 0 )
    v34 = 0LL;
  else
  ...
  *((_QWORD *)&UserData.Size + v39) = 4LL;
  if ( (int)MmGetImageInformation((unsigned __int64)v41, &v59, &v69, &v57) < 0 )
    v42 = 0LL;
  else
    v42 = (char *)v66 - v59;
  v68 = v42;
  ...
  *(&UserData.Ptr + v46) = (ULONGLONG)&v63;
  v47 = EtwSecurityMitigationsRegHandle;
  *((_QWORD *)&UserData.Size + v46) = 4LL;
  ...
  if ( (unsigned int)dword_140C043E0 > 5 && tlgKeywordOn((__int64)&dword_140C043E0, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&word_1400359E6,
      0LL,
      0LL,
      0x15u,
      &v77);
