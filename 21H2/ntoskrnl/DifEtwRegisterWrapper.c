/*
 * XREFs of DifEtwRegisterWrapper @ 0x140606620
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  *(_QWORD *)&v21 = ProviderId;
  *((_QWORD *)&v20 + 1) = EnableCallback;
  *(_QWORD *)&v20 = CallbackContext;
  *((_QWORD *)&v19 + 1) = RegHandle;
...
LABEL_18:
  result = EtwRegister(ProviderId, EnableCallback, CallbackContext, RegHandle);
  DWORD2(v21) = result;
  if ( APIThunkContextById )
  {
