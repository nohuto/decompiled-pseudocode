/*
 * XREFs of NtSetCachedSigningLevel2 @ 0x14072A630
 * Callers:
 *     NtSetCachedSigningLevel @ 0x14072A600 (NtSetCachedSigningLevel.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1404085B0 (_guard_dispatch_icall.c)
 *     memmove @ 0x140413F40 (memmove.c)
 *     RtlUnicodeStringValidateEx @ 0x1405852A8 (RtlUnicodeStringValidateEx.c)
    ...
    if ( (a1 & 4) == 0 )
    {
      ...
      if ( !qword_140C1DB00
        || (LOBYTE(Process) = (__int64)Process[2].Header.WaitListHead.Flink & 0xF,
            LOBYTE(v21) = v22,
            !(unsigned int)qword_140C1DB00(v21, Process)) )
      {
        v10 = v22;
      }
      v7 = (SIZE_T)a3;
...
LABEL_9:
      ...
      v12 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, __int64, UNICODE_STRING *, unsigned int, __int64, PCUNICODE_STRING))qword_140C1DAC8)(
              v8 & 0x807,
              v19,
              v16,
              v17,
