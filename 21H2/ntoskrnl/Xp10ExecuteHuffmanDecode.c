/*
 * XREFs of Xp10ExecuteHuffmanDecode @ 0x1409C2AF0
 * Callers:
...
__int64 __fastcall Xp10ExecuteHuffmanDecode(_WORD **a1, __int64 a2, __int64 *a3, int a4)
{
  _WORD *v4; // rax
  _DWORD *v5; // r14
  __int64 v6; // r12
  ...
  result = Xp10ReadAndDecodeHuffmanTables((_DWORD)v5, v103, (_DWORD)a3, a4, a2, (__int64)(v5 + 1174));
  if ( (int)result < 0 )
    return result;
  v14 = v9 + 1;
  if ( !v10 )
    v14 = v9;
  result = Xp10ReadAndDecodeHuffmanTables((_DWORD)v5, v14 + 232, v12, v13, v6, (__int64)(v5 + 5270));
  if ( (int)result < 0 )
    return result;
  v15 = *(_DWORD *)(v6 + 8);
  v16 = *(_DWORD *)(v6 + 12);
