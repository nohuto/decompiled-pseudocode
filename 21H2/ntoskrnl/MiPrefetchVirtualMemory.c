/*
 * XREFs of MiPrefetchVirtualMemory @ 0x140284EB0
 * Callers:
...
__int64 __fastcall MiPrefetchVirtualMemory(unsigned __int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( v10 != 1 )
  {
    if ( !v10 )
    {
      v12 = Process[1].IdealProcessor[25];
      goto LABEL_6;
    }
    return 3221225485LL;
  }
  v11 = Process[1].Affinity.StaticBitmap[25];
  if ( !v11 )
    return 3221225485LL;
...
LABEL_7:
  ...
  while ( 1 )
  {
    ...
    if ( (v48 & 0x40000) != 0 && (*(_DWORD *)(&CurrentThread[1].SwapListEntry + 1) & 1) != 0 )
    {
      v29 = -1073741749;
      goto LABEL_49;
    }
...
LABEL_49:
    ...
    if ( v19 >= qword_140C540C0 && v19 <= qword_140C51BF0
      || v19 >= 0xFFFF800000000000uLL && MiVaIsUltra(*(_QWORD *)v17 + (v44 << 12)) )
    {
LABEL_78:
...
LABEL_24:
    if ( (a4 & 0x20000) != 0 )
      MiPrefetchPreallocatePages((unsigned int)v51, (unsigned int)&v40, (_DWORD)v13, a3, v17, v19);
    v24 = v43;
    v25 = v44;
    v26 = MmAccessFault(0LL, v19);
    if ( BYTE1(v40) == 2 )
    {
      if ( (v48 & 0x80u) == 0 )
        goto LABEL_48;
...
LABEL_31:
    if ( v26 < 0 )
    {
      v52 = v26;
      v30 = v26;
      if ( v26 != -1073741819 || v43 == v42 || !(unsigned int)MiLeapPrefetch(&v40, 0LL) )
        goto LABEL_95;
    }
    if ( v47 >= 0x200000 )
      MiPfCoalesceAndIssueIOs(v46, (__int64)v45, &v47);
    if ( (v48 & 0x400) != 0 )
    {
      v34 = 0;
      v35 = 0;
...
LABEL_65:
      ...
      v38 = MiPfCompletePrefetchIos(v45, v46, a3);
      if ( v38 < 0 )
      {
        v39 = v54;
        if ( v54 >= 0 )
...
LABEL_50:
  if ( (a4 & 0x20000) != 0 )
    MiPrefetchReleasePreallocatedPages(v51, &v40, v13, 1LL);
  v31 = MiPfCompletePrefetchIos(v45, v46, a3);
  if ( v31 < 0 )
  {
    if ( v29 >= 0 )
      v29 = v31;
