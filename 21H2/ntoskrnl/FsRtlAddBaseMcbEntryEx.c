/*
 * XREFs of FsRtlAddBaseMcbEntryEx @ 0x14029D580
 * Callers:
 *     FsRtlAddLargeMcbEntry @ 0x14029CFF0 (FsRtlAddLargeMcbEntry.c)
 *     FsRtlAddBaseMcbEntry @ 0x14029D560 (FsRtlAddBaseMcbEntry.c)
 * Callees:
...
NTSTATUS __stdcall FsRtlAddBaseMcbEntryEx(PBASE_MCB Mcb, LONGLONG Vbn, LONGLONG Lbn, LONGLONG SectorCount)
{
  ...
  __int64 v56; // rax
  __int64 v57; // rdx
  int v58; // [rsp+20h] [rbp-38h]
  ULONG v59; // [rsp+24h] [rbp-34h]
  unsigned int v60; // [rsp+60h] [rbp+8h] BYREF

  if ( (unsigned int)Feature_1781732665__private_IsEnabledDeviceUsage() && (Vbn < 0 || Lbn < 0 || SectorCount <= 0) )
    return -1073741811;
  v9 = 0;
  v10 = 0;
...
LABEL_12:
  ...
  if ( v16 == -1 )
  {
    if ( !(unsigned __int8)FsRtlFindLargeIndex(Mcb, v17, &v60) )
      goto LABEL_36;
    v20 = v60 - 1;
    if ( v15 != (_DWORD)v20 )
      goto LABEL_36;
    ...
    if ( v60 )
      v21 = Mapping[2 * v20];
    if ( Mapping[2 * v60 + 1] == (_DWORD)Lbn + v21 - (_DWORD)Vbn )
    {
      if ( v60 )
        v22 = Mapping[2 * v20];
      else
...
LABEL_113:
    if ( v23
      && (v49 = Mcb->Mapping, v50 = v23 - 1, v51 = v49[2 * v50], v51 == (_DWORD)Vbn)
      && ((v52 = v49[2 * v50 + 1], v52 != -1)
        ? (v23 != 1 ? (v54 = v49[2 * v23 - 4]) : (v54 = 0), v53 = v51 + v52 - v54)
        : (v53 = 0),
          v53 == (_DWORD)Lbn) )
    {
      v49[2 * PairCount - 2] += SectorCount;
    }
    else
    {
      if ( !(_DWORD)Vbn )
...
LABEL_136:
      ...
      else
      {
        if ( !(unsigned __int8)FsRtlAddEntry(Mcb, v23, 2LL) )
          return -1073741670;
        v55 = 8LL * v23;
        *(_DWORD *)((char *)Mcb->Mapping + v55 + 4) = -1;
        *(_DWORD *)((char *)Mcb->Mapping + v55) = Vbn;
        v56 = v23 + 1;
      }
      v57 = 8 * v56;
      *(_DWORD *)((char *)Mcb->Mapping + v57 + 4) = Lbn;
      *(_DWORD *)((char *)Mcb->Mapping + v57) = Vbn + SectorCount;
    }
    return 0;
  }
  if ( !(unsigned __int8)FsRtlFindLargeIndex(Mcb, (unsigned int)Vbn, &v60) )
  {
    v23 = v60;
    goto LABEL_113;
  }
  ...
  if ( v24[(unsigned __int64)v26 / 4 + 1] != -1 || v60 && v24[2 * v60 - 2] > (unsigned int)Vbn )
    return -1073741823;
  v29 = *v27 - 1;
  if ( v28 > v29 )
    return -1073741823;
  ...
  if ( v30 >= (unsigned int)Vbn || v28 >= v29 )
  {
    ...
    if ( v32 == (_DWORD)Vbn && v28 < v29 )
    {
      ...
      {
        if ( !(unsigned __int8)FsRtlAddEntry(Mcb, v60, 1LL) )
          return -1073741670;
        *(_DWORD *)((char *)Mcb->Mapping + v26 + 4) = Lbn;
        *(_DWORD *)((char *)Mcb->Mapping + v26) = v58;
      }
      return 0;
    }
    if ( v60 )
    ...
    if ( v38 == (_DWORD)Lbn )
    {
      v43 = v60 < v42 ? v24[2 * v60 + 3] : -1;
      if ( v43 == (_DWORD)Lbn + (_DWORD)SectorCount )
      {
        if ( v60 )
        {
          v24[2 * v60 - 2] = v24[2 * v60 + 2];
...
LABEL_110:
  ...
  if ( (unsigned __int8)FsRtlAddEntry(Mcb, v60, 2LL) )
  {
    v31 = v25 + 1;
    *(_DWORD *)((char *)Mcb->Mapping + v26 + 4) = -1;
    *(_DWORD *)((char *)Mcb->Mapping + v26) = Vbn;
    *((_DWORD *)Mcb->Mapping + 2 * v31 + 1) = Lbn;
    *((_DWORD *)Mcb->Mapping + 2 * v31) = v58;
    return 0;
  }
  return -1073741670;
}
