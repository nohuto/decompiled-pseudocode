/*
 * XREFs of PopAccountBatteryEnergyChange @ 0x140994398
 * Callers:
  ...
  *(_DWORD *)(a1 + 192) = 0;
  ...
  if ( v10 != (_DWORD)v60 || (LODWORD(v1) = DWORD2(v60), *(_QWORD *)(a1 + 200) != *((_QWORD *)&v60 + 1)) )
  {
    if ( (unsigned int)dword_140C03A00 > 5 )
    {
      ...
      v66[1] = 0;
      v68 = 8LL;
      tlgCreate1Sz_char((__int64)v69, v11);
      v14 = "Relative Capacity Unit";
      if ( (*(_DWORD *)(v13 + 192) & 2) == 0 )
        v14 = v12;
      tlgCreate1Sz_char((__int64)v70, v14);
      v17 = "FCC Unavailable";
      if ( (*(_DWORD *)(v16 + 192) & 4) == 0 )
        v17 = v15;
      tlgCreate1Sz_char((__int64)v71, v17);
      ...
      *(_QWORD *)&v60 = v6;
      ...
      LODWORD(v1) = tlgWriteTransfer_EtwWriteTransfer(
                      ...
                      (unsigned __int8 *)byte_14003091B,
                      0LL,
                      0LL,
                      0x1Cu,
                      &v62);
