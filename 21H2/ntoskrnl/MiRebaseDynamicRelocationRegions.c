/*
 * XREFs of MiRebaseDynamicRelocationRegions @ 0x140A4F400
 * Callers:
...
__int64 __fastcall MiRebaseDynamicRelocationRegions(__int64 a1)
{
  ...
  v5 = qword_140C4FB58;
  v22 = qword_140C4FB18;
  if ( (MiFlags & 0x8000) == 0 && qword_140C4FB58 == 0xFFFFF68000000000uLL )
    goto LABEL_18;
  v6 = ((unsigned __int64)qword_140C4FB58 >> 39) & 0x1FF;
  v7 = 0;
...
LABEL_12:
  ...
  for ( i = 39LL; ; i -= 9LL )
  {
    MiApplyDynamicRelocations(*(_QWORD *)(v2 + 48), *(unsigned int *)(v2 + 64), v3, v15);
    if ( i >= 0xC )
...
LABEL_18:
  ...
  if ( (MiFlags & 0x8000) != 0 || v4 != 0xFFFFFA8000000000uLL )
    MiApplyDynamicRelocations(*(_QWORD *)(v2 + 48), *(unsigned int *)(v2 + 64), 0xFFFFFA8000000000uLL, v4);
