/*
 * XREFs of AstLogIoctl @ 0x1407305B0
 * Callers:
...
char __fastcall AstLogIoctl(unsigned __int64 a1, unsigned int a2)
{
  ...
  if ( dword_140C03958 )
  {
    ...
    v17 = AstIoctlBloomFilter == 0x8000 ? HIWORD(v16) & 0x7FFF : HIWORD(v16) % (unsigned int)AstIoctlBloomFilter;
    v18 = RtlHashBytes2((const unsigned __int8 *)&v32, 0xCuLL, (unsigned int)dword_140C46C30);
    ...
    {
      LOBYTE(v5) = AstAddBloomFilter(v19, (__int64)&v32);
      if ( (unsigned int)dword_140C03958 > 5 )
      {
        LOBYTE(v5) = tlgKeywordOn((__int64)&dword_140C03958, 0x200000000000LL);
        if ( (_BYTE)v5 )
        {
          v27 = 8LL;
          v24 = 0x80000000LL;
          ...
          LOBYTE(v5) = tlgWriteTransfer_EtwWriteTransfer(
                         (__int64)&dword_140C03958,
                         (unsigned __int8 *)&word_14002BA3E,
                         0LL,
                         0LL,
                         5u,
                         &v25);
