/*
 * XREFs of PiDevCfgLogDeviceConfigured @ 0x1407459F4
 * Callers:
 ...
 * Callees:
 *     PnpGetLogString @ 0x1402D0E78 (PnpGetLogString.c)
...
void __fastcall PiDevCfgLogDeviceConfigured(__int64 a1, __int64 a2, __int64 a3, int a4, int a5, __int64 a6, __int64 a7)
{
  ...
  wchar_t *v119; // [rsp+140h] [rbp+30h] BYREF
  size_t v120; // [rsp+148h] [rbp+38h] BYREF
  ...
  size_t pcchNewDestLength; // [rsp+188h] [rbp+78h] BYREF
  __int128 v127; // [rsp+190h] [rbp+80h] BYREF
  _QWORD v128[20]; // [rsp+1A0h] [rbp+90h] BYREF
  wchar_t pszDest[12]; // [rsp+240h] [rbp+130h] BYREF
  ...
  *(_QWORD *)&v110.Length = 0LL;
  ...
  if ( a3 )
  {
    ...
    v9 = *(_QWORD *)(v8 + 16);
    v10 = *(_QWORD *)(v8 + 64);
    v128[0] = &DEVPKEY_DriverPackage_OriginalInfName;
    v128[2] = &DestinationString;
    v128[5] = DEVPKEY_DriverPackage_DriverFlightIds;
    v128[7] = &UnicodeString;
    v128[10] = DEVPKEY_DriverPackage_SubmissionId;
    v128[12] = &v118;
    LODWORD(v128[1]) = 18;
    HIDWORD(v128[3]) = 6;
    LODWORD(v128[6]) = 8210;
    ...
    LODWORD(v128[11]) = 18;
    HIDWORD(v128[13]) = 6;
    if ( (int)PiDevCfgQueryObjectProperties(18, v10, 8, v9, (__int64)v128, 3) < 0 )
      goto LABEL_39;
    ...
    if ( RtlStringCchPrintfW(
           ...
           pcchRemaining) < 0 )
      pszDest[0] = 0;
    LODWORD(pcchRemaininga) = *(unsigned __int16 *)(v8 + 122);
    LODWORD(ppszDestEnda) = *(unsigned __int16 *)(v8 + 124);
    if ( RtlStringCchPrintfW(
           v130,
           0x18uLL,
           L"%u.%u.%u.%u",
    ...
    if ( v14 != v13 )
    {
      ...
      StringRoutine = (wchar_t *)ExpAllocateStringRoutine(v41);
      v112.Buffer = StringRoutine;
      if ( !StringRoutine )
        goto LABEL_39;
      v43 = v112;
      *StringRoutine = 0;
      v44 = *v13;
      TimeFields = (TIME_FIELDS)v43;
      if ( v44 != (__int64 *)v13 )
      {
        do
        {
...
LABEL_85:
              ...
              if ( v49 < 0 )
              {
                RtlUnicodeStringExHandleOtherFlags(v45, v47, (size_t)v46, &pcchNewDestLength, &v119, &v120, 0x800u);
                v46 = v119;
                v48 = v120;
              }
            }
  ...
  if ( a5 < 0 )
  {
    if ( a5 == -1073740959 )
    {
      if ( (byte_140C0DD4A & 0x20) != 0 )
      {
        ...
        PnpGetLogString((__int64)&v112);
        PnpGetLogString(v68);
        PnpGetLogString(v67);
        LogString = PnpGetLogString(v7);
    ...
    else if ( (byte_140C0DD4A & 0x10) != 0 )
    {
      ...
      {
        v77 = 0LL;
        v76 = PiDevCfgNullGuid;
      }
      PnpGetLogString(*(_QWORD *)(a1 + 16) + 40LL);
      PnpGetLogString((__int64)&v112);
      PnpGetLogString(v78);
      PnpGetLogString(v77);
      v79 = PnpGetLogString(v7);
      McTemplateK0zzjzzztzdzztdz_EtwWriteTransfer(
        v105,
  ...
  else if ( (byte_140C0DD4A & 8) != 0 )
  {
    ...
    {
      v17 = 0LL;
      v16 = PiDevCfgNullGuid;
    }
    PnpGetLogString(*(_QWORD *)(a1 + 16) + 40LL);
    PnpGetLogString((__int64)&v112);
    PnpGetLogString(v18);
    PnpGetLogString(v17);
    v19 = PnpGetLogString(v7);
    McTemplateK0zzjzzztzdzztdz_EtwWriteTransfer(
      v105,
  ...
  if ( v8 )
  {
    ...
    if ( v27 != (__int64 **)(v8 + 208) )
    {
      ...
      if ( v85 )
      {
        ...
        v110.Length = 0;
        v87 = (wchar_t *)ExpAllocateStringRoutine(v86);
        v110.Buffer = v87;
        v28 = v87;
        if ( !v87 )
          goto LABEL_39;
        ...
        do
        {
          ...
          if ( !*((_DWORD *)v88 + 97) )
            v90 = v89;
          PiDevCfgLogDeviceConfigured(v116, v109, v88, v90, a5, v25, v123);
          memset(v128, 0, sizeof(v128));
          v91 = v88[2];
          v128[0] = &DEVPKEY_DriverPackage_OriginalInfName;
          LODWORD(v128[1]) = 18;
          v128[2] = &v124;
          v128[5] = DEVPKEY_DriverPackage_ExtensionId;
          v128[7] = &v127;
          LODWORD(v128[16]) = 18;
          v128[10] = DEVPKEY_DriverPackage_DriverFlightIds;
          HIDWORD(v128[3]) = 6;
          v128[12] = &v111;
          v128[15] = DEVPKEY_DriverPackage_SubmissionId;
          v128[17] = &v125;
          v92 = v88[8];
          LODWORD(v128[6]) = 13;
          LODWORD(v128[8]) = 16;
          ...
          HIDWORD(v128[13]) = 6;
          HIDWORD(v128[18]) = 6;
          if ( (int)PiDevCfgQueryObjectProperties(6, v92, 8, v91, (__int64)v128, 4) >= 0 )
          {
            if ( SLODWORD(v128[4]) < 0 && !RtlCreateUnicodeString(&v124, (PCWSTR)v88[6]) )
              RtlInitUnicodeString(&v124, 0LL);
            if ( SLODWORD(v128[9]) < 0 || (int)RtlStringFromGUIDEx((unsigned int *)&v127, (__int64)&v117, 1) < 0 )
