/*
 * XREFs of DifZwOpenKeyTransactedExWrapper @ 0x140621E20
 * Callers:
 *     <none>
 * Callees:
        ...
        HANDLE TransactionHandle)
{
  ...
  v21 = 0LL;
  v22 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(554);
...
LABEL_13:
  *((_QWORD *)&v20 + 1) = TransactionHandle;
  *((_QWORD *)&v22 + 1) = KeyHandle;
  LODWORD(v22) = DesiredAccess;
  *((_QWORD *)&v21 + 1) = ObjectAttributes;
  LODWORD(v21) = OpenOptions;
