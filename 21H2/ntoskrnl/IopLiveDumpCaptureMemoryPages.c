/*
 * XREFs of IopLiveDumpCaptureMemoryPages @ 0x140A65D84
 * Callers:
...
__int64 __fastcall IopLiveDumpCaptureMemoryPages(__int64 a1)
{
  ...
  v3 = *(_BYTE *)(a1 + 40);
  v4 = MillisecondCounter;
  SaveSupervisorState = 1;
  v16[0] = IopLiveDumpStartMirroringCallback;
  v16[1] = IopLiveDumpEndMirroringCallback;
  v16[2] = IopLiveDumpMirrorPhysicalMemoryCallback;
  LODWORD(MillisecondCounter) = *(_DWORD *)(a1 + 80);
  DWORD2(v17) = (v3 & 4) != 0 ? 657 : 593;
  if ( (MillisecondCounter & 0x20) != 0 )
    DWORD2(v17) = ((v3 & 4) != 0 ? 657 : 593) | 0x100;
  v6 = MmDuplicateMemory((__int64)v16);
  if ( (*(_DWORD *)(a1 + 80) & 0x80u) != 0 )
  {
    v5 = (unsigned __int64)(1000LL * *(_QWORD *)(a1 + 504)) % PerformanceFrequency.QuadPart;
  ...
  if ( v6 < 0 || v6 == 258 )
  {
    ...
    {
      LOBYTE(v5) = 1;
      IopLiveDumpUncorralProcessors(a1 + 304, v5);
    }
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 480) = IopLiveDumpGetMillisecondCounter(0) - v4;
