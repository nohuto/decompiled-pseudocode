...
LABEL_9:
  ...
  v12 = MiReservePtes(&qword_140C534C0, (unsigned int)v11);
  v13 = a4 & 1;
  v14 = 0;
  v44 = v12;
  v15 = 4096 - v10;
  ...
  while ( 1 )
  {
    ...
    v18 = MiTranslatePageForCopy(a2, v46, &v35, &v41);
    v14 = v18;
    if ( v18 >= 0 )
    {
      v19 = v46[3];
...
LABEL_19:
      ...
      v21 = v35;
      LODWORD(v33) = v38;
      v14 = MiCopySinglePage(v36, v35, v20, v15, v16);
      if ( v19 )
      {
    ...
    *((_QWORD *)&v45 + 1) = v29;
    if ( (unsigned int)MiGetSystemRegionType(a2, v25, v26, v27) == 1 )
      break;
LABEL_49:
    ...
    v14 = MiPrefetchVirtualMemory(1LL, &v45, SessionVm, v28, &v40, v33);
    if ( v14 < 0 )
      goto LABEL_29;
    v16 = v37;
LABEL_28:
  ...
  if ( Process[1].Affinity.StaticBitmap[25] && (HIDWORD(Process[2].Header.WaitListHead.Flink) & 0x1000) == 0 )
  {
...
LABEL_30:
  if ( v44 )
    MiReleasePtes(&qword_140C534C0, v44, (unsigned int)v11);
  *v5 += v39;
