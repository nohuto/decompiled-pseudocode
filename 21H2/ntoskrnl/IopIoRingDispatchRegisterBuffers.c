/*
 * XREFs of IopIoRingDispatchRegisterBuffers @ 0x140938314
 * Callers:
...
LONG_PTR __fastcall IopIoRingDispatchRegisterBuffers(__int64 a1, __int64 a2)
{
  ...
  char PreviousMode; // [rsp+D0h] [rbp+18h]
  ...
  *(_DWORD *)(a1 + 176) = 0;
  *(_QWORD *)(a1 + 184) = 0LL;
  LODWORD(v23) = IopIoRingGetBuffer(a1, a2, PreviousMode, (unsigned int)&v24, (__int64)&v29);
  if ( (int)v23 >= 0 )
  {
...
LABEL_32:
  ...
  *((_QWORD *)&v23 + 1) = i;
  return IopCompleteIoRingEntry(a1, *(_QWORD *)(a2 + 48), &v23, 0);
}
