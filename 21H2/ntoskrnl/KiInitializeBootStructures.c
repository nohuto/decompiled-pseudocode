/*
 * XREFs of KiInitializeBootStructures @ 0x14099C160
 * Callers:
 ...
 *     KiSaveInitialProcessorControlState @ 0x1403FE120 (KiSaveInitialProcessorControlState.c)
 *     KiGetProcessorSignature @ 0x14099BEA8 (KiGetProcessorSignature.c)
 *     KiInitializeNXSupport @ 0x14099C02C (KiInitializeNXSupport.c)
 *     ExInitPoolLookasidePointers @ 0x14099C5A8 (ExInitPoolLookasidePointers.c)
 ...
 *     InitializeBuildStrings @ 0x140A38E88 (InitializeBuildStrings.c)
