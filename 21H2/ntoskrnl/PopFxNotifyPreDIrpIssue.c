/*
 * XREFs of PopFxNotifyPreDIrpIssue @ 0x1403B5A24
 * Callers:
 ...
 *     ReadFxComponentLowFlagsNoFence @ 0x1405CF43C (ReadFxComponentLowFlagsNoFence.c)
 */
...
bool __fastcall PopFxNotifyPreDIrpIssue(__int64 a1, __int64 a2)
{
  ...
  __int64 v7; // rbp
  __int64 v8; // rbx
  int FxComponentLowFlagsNoFence; // eax
  int v10; // ecx
  KIRQL v11; // al
  ...
  if ( *(_DWORD *)(*(_QWORD *)(a2 + 72LL * *(char *)(a2 + 66) + 200) + 192LL) == 1 )
  {
    ...
    v13 = 0LL;
    for ( i = 0LL; (unsigned __int8)PopFxNextDeviceParentRelationSafe(a1, i, &v13); i = v7 )
    {
      v7 = v13;
      if ( (*(_DWORD *)(v13 + 16) & 2) == 0 )
      {
        v8 = *(_QWORD *)(v13 + 24);
        PopFxActivateComponent(*(_QWORD *)(v8 + 80), v8, 10LL, 0LL);
        FxComponentLowFlagsNoFence = ReadFxComponentLowFlagsNoFence(v8 + 88);
        v10 = *(_DWORD *)(v7 + 16);
        if ( FxComponentLowFlagsNoFence < 0 )
        {
          *(_DWORD *)(v7 + 16) = v10 | 2;
        }
        else
