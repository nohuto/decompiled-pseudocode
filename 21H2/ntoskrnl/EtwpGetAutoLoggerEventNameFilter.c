/*
 * XREFs of EtwpGetAutoLoggerEventNameFilter @ 0x140853230
 * Callers:
...
LABEL_12:
    ...
    *a4 = (PVOID)v23;
    ...
    if ( v23 )
    {
      ...
      LODWORD(v52[39]) = 1;
      v50 = 1;
      if ( (int)RtlpQueryRegistryValues(0x40000000, (const WCHAR *)KeyHandle, (__int64)v52, 0LL) >= 0 )
      {
        ...
        if ( Handle )
        {
          ...
          RtlpQueryRegistryValues(0x40000000, v25, (__int64)v52, 0LL);
        }
