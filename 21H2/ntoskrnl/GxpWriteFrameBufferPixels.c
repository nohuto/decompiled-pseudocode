/*
 * XREFs of GxpWriteFrameBufferPixels @ 0x1403A8000
 * Callers:
 *     BgpGxDrawRectangle @ 0x1403A7F70 (BgpGxDrawRectangle.c)
 * Callees:
 *     GxpAdjustRectangleToFrameBuffer @ 0x1403A8230 (GxpAdjustRectangleToFrameBuffer.c)
 ...
 *     GxpGetRotatedPixelOffset @ 0x14064D7E8 (GxpGetRotatedPixelOffset.c)
...
__int64 __fastcall GxpWriteFrameBufferPixels(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  if ( (dword_140C0DF90 & 2) == 0 )
    return 3221225473LL;
  result = GxpAdjustRectangleToFrameBuffer(v3, v2, (unsigned int)&v32, (unsigned int)&v36, (__int64)&v35, 1);
  if ( (int)result >= 0 )
  {
    if ( !(_BYTE)BgInternal )
    {
      ...
      if ( (dword_140C0DF90 & 8) != 0 )
      {
        ...
        RotatedPixelOffset = BgpGxConvertRectangleEx(v3, 4LL, &v28, v25);
      ...
      RotatedPixelOffset = ((__int64 (__fastcall *)(_DWORD *, unsigned __int64, _QWORD))qword_140C0DF40)(v41, v2, 0LL);
      if ( v24 && v24 != v48 )
