/*
 * XREFs of FsRtlpOplockFsctrlInternal @ 0x14071C610
 * Callers:
 ...
 *     FsRtlpCallerIsAtomicRequestor @ 0x1402A3F9C (FsRtlpCallerIsAtomicRequestor.c)
  ...
  if ( !CurrentStackLocation->MajorFunction )
  {
    ...
    if ( (Options & 0x10000) != 0 )
    {
      ...
      if ( !v7 )
      {
        ...
        if ( !*Oplock )
        {
          v17 = (PFAST_MUTEX *)FsRtlpAllocateOplock();
          *Oplock = (__int64)v17;
        }
        v35 = v17;
        ...
        if ( P )
        {
          FsRtlpClearOwner((__int64)v17, (__int64)P);
...
LABEL_58:
  ...
  if ( *Oplock )
  {
    ...
    {
      if ( FsRtlpCallerIsAtomicRequestor(v24, (__int64)CurrentStackLocation->FileObject, &v35) )
      {
        v25 = v35;
        FsRtlpOplockDequeueRH((__int64)v35);
        v26 = v25[7];
        v27 = (_QWORD *)v25[8];
        ...
        *(_QWORD *)(v26 + 8) = v27;
        ...
        if ( v25[5] )
          FsRtlpClearOwner(v24, (__int64)v25);
        ExFreePoolWithTag(v25, 0);
        FsRtlpComputeShareableOplockState(v24);
        FsRtlpReleaseIrpsWaitingForRH(v28);
      }
    }
  }
  Irp->IoStatus.Status = 0;
