/*
 * XREFs of KeWakeWaitChain @ 0x1402BA75C
 * Callers:
...
LABEL_8:
        ...
        else if ( v17 == 2 )
        {
          ...
          *(_QWORD *)v15 = 0LL;
          ...
          if ( (_QWORD *)*v22 == v22
            ...
            || !KiWakeQueueWaiter((__int64)v24, v21, v15, (__int64)SchedulerAssist) )
          {
            ...
            *(_QWORD *)(v21 + 32) = v15;
            if ( !(_DWORD)a3 && (_QWORD *)*v22 != v22 )
              KiWakeOtherQueueWaiters((__int64)v24, v21);
          }
    ...
    if ( (v33 & 1) != 0 && (v19 = KiRemoveBoostThread((__int64)CurrentPrcb, (__int64)CurrentPrcb->CurrentThread), v6) )
    {
      v20 = 2;
      if ( v19 > (char)v6 )
        v6 = v19;
    ...
    if ( (v33 & 2) != 0 && v20 == 1 )
      v6 = 1;
    KiExitDispatcher((_DWORD)CurrentPrcb, 0, v20, v6, v31);
    *a1 = 0LL;
  }
  return v5;
}
