/*
 * XREFs of __C_specific_handler @ 0x1403D0600
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x1403F9C9C (__GSHandlerCheck_SEH.c)
 * Callees:
 *     KeCheckStackAndTargetAddress @ 0x1402301E0 (KeCheckStackAndTargetAddress.c)
 *     RtlUnwindEx @ 0x1402639D0 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x1403D1AD0 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x1403D1B00 (__NLG_Return2.c)
 */
