/*
 * XREFs of BiConvertNtDeviceToBootEnvironment @ 0x1408038B4
 * Callers:
...
__int64 BiConvertNtDeviceToBootEnvironment(int *a1, unsigned int a2, unsigned int a3, ...)
{
  int v4; // edx
  _QWORD *v6; // r12
  char *v7; // rdi
  ...
  if ( !v9 )
  {
    if ( a2 >= 0x16 )
    {
      if ( (unsigned __int8)BiIsVolumePartitionInformationRetained((PCWSTR)a1 + 10) )
      {
        v7 = v51;
        PartitionDevice = BiCreatePartitionDevice((PCWSTR)a1 + 10);
...
LABEL_81:
  ...
  if ( v16 )
  {
    ...
    if ( v17 )
    {
      if ( v17 != 1 || a2 < 0x28 )
        goto LABEL_10;
      v18 = *(_QWORD *)(a1 + 5) - CompositeDeviceSignature;
      if ( !v18 )
...
LABEL_6:
  ...
  if ( (_DWORD)v22 )
  {
    ...
    if ( v29 == 2 )
    {
      if ( v28 < 0x16 )
        goto LABEL_10;
      PartitionVhdFilePath = (void *)BiGetPartitionVhdFilePath((PCWSTR)(v27 + v26 + 20));
...
LABEL_11:
    ...
    PartitionDevice = BiConvertNtDeviceToBootEnvironment(v26, v25, 0LL, &Src);
    if ( PartitionDevice < 0 )
      goto LABEL_7;
    v24 = 40;
    v23 = *((_DWORD *)Src + 2) + 70;
