/*
 * XREFs of PspReferenceCidTableEntry @ 0x1407A8900
 * Callers:
...
_BYTE *__fastcall PspReferenceCidTableEntry(__int64 a1, char a2)
{
  ...
  if ( (a1 & 0x3FC) == 0 )
    return 0LL;
  v3 = (unsigned __int64 *)ExpLookupHandleTableEntry((unsigned int *)PspCidTable, a1);
  v4 = v3;
  if ( !v3 )
    return 0LL;
  v5 = PspCidTable;
...
LABEL_10:
    ...
    if ( (*v11 & 0x7F) == a2 )
    {
      ...
      if ( v16 )
      {
        ...
        if ( ObpTraceFlags )
          ObpPushStackInfo((__int64)(v11 - 48), 1, v15, 0x746C6644u);
LABEL_20:
        v18 = PspCidTable;
