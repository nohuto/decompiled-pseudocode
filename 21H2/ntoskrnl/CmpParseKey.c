/*
 * XREFs of CmpParseKey @ 0x1407349A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     CmpDoesParseEnterRegistryA @ 0x1406E08E4 (CmpDoesParseEnterRegistryA.c)
        ...
        _QWORD *a11)
{
  ...
  bool v37; // zf
  struct _PRIVILEGE_SET *v38; // rdi
  __int64 i; // rbx
  __int64 v41; // rdx
  __int64 v42; // r8
  int v43; // ebx
  struct _PRIVILEGE_SET *TransientPoolWithTag; // rax
  struct _PRIVILEGE_SET *v45; // rsi
  _DWORD *v46; // rsi
  int v47; // eax
...
LABEL_9:
  ...
  *(_DWORD *)(v15 + 96) = v22;
  ...
  if ( (*(_DWORD *)v15 & 0x800) == 0 || CmpDoesParseEnterRegistryA(a1, (unsigned __int16 *)&v50) )
  {
    ...
    if ( CmpCallBackCount && !CmpIsRegistryLockAcquired() )
    {
      ...
      *(_QWORD *)&v53 = &v69;
      ...
      if ( (*(_DWORD *)v15 & 1) != 0 )
      {
        ...
        *(_QWORD *)&v72 = a9;
        v67 = 0;
        v27 = CmpCallCallBacksEx(26, (unsigned int)&v69, (unsigned int)&v53, v25, 27, a1, (__int64)v51);
      }
      else
      {
        v27 = CmpCallCallBacksEx(28, (unsigned int)&v69, (unsigned int)&v53, v25, 29, a1, (__int64)v51);
      }
      v28 = v27;
      if ( v27 < 0 )
      {
...
LABEL_43:
          ...
          if ( v37
            && ($CEA84C04E3712D858E5667A507841A2A *)v36->ApcState.ApcListHead[0].Flink != &v36->152
...
LABEL_69:
    ...
    while ( 1 )
    {
      ...
      {
        v78 = v50;
        v30 = CmpDoParseKey(a1, v29, v83, a5, v24, (__int64)&v78, v15, a9, (__int64)&v52);
        v28 = v30;
        if ( v30 != 259 )
          break;
      ...
      {
        CmpRollbackTransactionArray(*(unsigned int *)(v15 + 120), *(_QWORD *)(v15 + 128), v31, &v81);
        *(_DWORD *)(v15 + 100) &= ~4u;
        *(_DWORD *)(v15 + 120) = 0;
        *(_QWORD *)(v15 + 128) = 0LL;
      }
...
LABEL_35:
        ...
        if ( CmpIsRegistryLockAcquired() || (_QWORD *)v51[0] == v51 )
        {
LABEL_34:
          v34 = HIDWORD(v72);
          v32 = v82;
      ...
      v56 = v28;
      v59 = v28;
      CmpCallCallBacksEx(v35, (unsigned int)&v55, (unsigned int)&v64, 0, Timeout, v49, (__int64)v51);
      v28 = v59;
      goto LABEL_34;
    }
LABEL_40:
