/*
 * XREFs of HalpTimerTraceTimingHardware @ 0x140822E6C
 * Callers:
...
void HalpTimerTraceTimingHardware()
{
  ...
  if ( (unsigned int)dword_140C04538 > 5 && tlgKeywordOn((__int64)&dword_140C04538, 0x400000000000LL) )
  {
    ...
    v28 = 4LL;
    v27 = &v13;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04538, (unsigned __int8 *)byte_140028279, 0LL, 0LL, 9u, &v14);
  }
}
