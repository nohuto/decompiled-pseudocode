/*
 * XREFs of NtQueryWnfStateData @ 0x14060EE80
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  volatile void *v39; // [rsp+98h] [rbp-70h]
  ...
  *(_QWORD *)v31 = 0LL;
  ...
  v40 = 0LL;
  v35 = a2;
  StateData = ExpCaptureWnfStateName(a1, &v34);
  if ( StateData >= 0 )
  {
    if ( PreviousMode )
    {
    ...
    StateData = ExpWnfCaptureScopeInstanceId(v9, a3, v11, &Sid, &v40);
    if ( StateData >= 0 )
    {
      if ( PreviousMode )
      {
