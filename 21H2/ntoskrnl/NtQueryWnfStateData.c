/*
 * XREFs of NtQueryWnfStateData @ 0x14069E930
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG BufferSize)
{
  ...
  *(_QWORD *)v31 = 0LL;
  ...
  if ( StateData >= 0 )
  {
    ...
    StateData = ExpWnfCaptureScopeInstanceId(v9, v6, v11, &Sid, &v40);
    if ( StateData >= 0 )
    {
      if ( PreviousMode )
      {
      ...
      if ( StateData >= 0 )
      {
        ...
        else
        {
          ...
          {
            StateData = ExpWnfCreateNameInstance(*(__int64 *)v31, v18, (__int64)P, v32, &v29);
