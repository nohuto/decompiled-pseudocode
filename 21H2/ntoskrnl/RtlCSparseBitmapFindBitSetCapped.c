/*
 * XREFs of RtlCSparseBitmapFindBitSetCapped @ 0x1403629E0
 * Callers:
 ...
 * Callees:
 *     RtlLengthCurrentClearRunBackwardEx @ 0x1405E6364 (RtlLengthCurrentClearRunBackwardEx.c)
 *     RtlLengthCurrentClearRunForwardEx @ 0x1405E6408 (RtlLengthCurrentClearRunForwardEx.c)
 */
      ...
      if ( _bittest64(*(const signed __int64 **)a1, a2 >> 15) )
      {
        ...
        *((_QWORD *)&v18[0] + 1) = v11;
        ...
        else
        {
          v13 = a2 & 0x7FFF;
          v12 = v7 <= 0
              ? -RtlLengthCurrentClearRunBackwardEx(v18, v13, -v7)
              : RtlLengthCurrentClearRunForwardEx(v18, v13);
        }
