/*
 * XREFs of EtwpApplyScopeFilters @ 0x140796D80
 * Callers:
...
LABEL_13:
      ...
      if ( (v13 & 0x80000008) == 0x80000008 )
        v11 = EtwpApplyExeFilter(a1, *(_QWORD *)(v14 + 16));
      if ( v11 )
      {
        if ( (v15 = *(_QWORD *)(v8 + 384), (*(_DWORD *)(v15 + 104LL * (unsigned int)v9) & 0x80000010) != 0x80000010)
          ...
          || (unsigned __int8)EtwpApplyPackageIdFilter(a1, *(_QWORD *)(v15 + v12 + 24), *(_QWORD *)(v15 + v12 + 32)) )
        {
          v16 = *(_QWORD *)(v8 + 384);
          if ( (*(_DWORD *)(v16 + 104LL * (unsigned int)v9) & 0x80008000) != 0x80008000
            || (unsigned __int8)EtwpApplyContainerFilter(a1, *(_QWORD *)(v16 + v12 + 40), v14) )
          {
            goto LABEL_13;
          }
        }
