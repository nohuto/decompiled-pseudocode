/*
 * XREFs of DifMmMapLockedPagesSpecifyCacheWrapper @ 0x140617430
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG Priority)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(335);
...
LABEL_13:
  ...
  *(_QWORD *)&v23 = MemoryDescriptorList;
  BYTE12(v22) = a2;
  DWORD2(v22) = a3;
  *(_QWORD *)&v22 = a4;
