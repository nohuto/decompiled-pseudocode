/*
 * XREFs of MiExpandSharedZeroCluster @ 0x1402E7400
 * Callers:
...
__int64 __fastcall MiExpandSharedZeroCluster(__int64 a1)
{
  ...
  v27 = MiComputeZeroClusterMaximum(
          (__int64)v5,
  ...
  do
  {
    if ( (unsigned int)MiIsPteEvaluated(v11, *(unsigned int *)(a1 + 32)) )
      break;
    ProtoPteAddress = MiGetProtoPteAddress(v2, v31, 4LL, &v33);
    v26 = ProtoPteAddress;
    ...
    v32 = v13;
    if ( (v13 & 1) != 0 || !v13 || (v13 & 0x400) != 0 || (v13 & 0x800) != 0 || (unsigned int)MiGetPagingFileOffset(&v32) )
      break;
    if ( !v3 )
      v9 = v26;
    ++v3;
  ...
  while ( v17 < v16 );
  if ( v14 )
    MiUpdatePageTableUseCount(v25, v14);
  return v16;
}
