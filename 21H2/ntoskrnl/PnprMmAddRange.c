/*
 * XREFs of PnprMmAddRange @ 0x1408AE4B0
 * Callers:
 *     PnprMmConstruct @ 0x1408AE5E8 (PnprMmConstruct.c)
 * Callees:
...
__int64 __fastcall PnprMmAddRange(unsigned int *a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  if ( a3 >> 12 )
  {
    while ( 1 )
    {
      ...
      if ( v5 > 0x80000000 )
        v7 = 0x80000000LL;
      PoolWithTag = (RTL_BITMAP *)ExAllocatePoolWithTag(
                                    NonPagedPoolNx,
