/*
 * XREFs of MiTimeSingleLargePageZeroWorker @ 0x1403B0728
 * Callers:
...
LABEL_26:
      *v18 = ValidPte;
      if ( v20 )
        MiWritePteShadow((__int64)v18, ValidPte, v21);
      KeZeroPages(UltraMapping, 0x200000LL, v21);
      v24 = ZeroPte;
      v25 = 0LL;
      if ( !v45 )
        goto LABEL_36;
...
LABEL_36:
      *v18 = v24;
      if ( (_DWORD)v25 )
        MiWritePteShadow((__int64)v18, v24, v25);
      v46 = 0;
