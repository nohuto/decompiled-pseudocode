/*
 * XREFs of SymCryptMontgomeryFillScratchSpaces @ 0x14040844C
 * Callers:
...
__int64 __fastcall SymCryptMontgomeryFillScratchSpaces(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 48) = v8 + v11 + 6 * v3;
  ...
  v13 = SymCryptSizeofEcpointEx(v9, 4u);
  v14 = 704 * v10 + 256;
  ...
  *(_DWORD *)(a1 + 56) = v15;
  ...
  v17 = v16 + SymCryptSizeofIntFromDigits();
  if ( v17 <= (unsigned int)SymCryptSizeofEcpointEx(v16, *(_DWORD *)(a1 + 8) & 0xF) )
  {
    result = SymCryptSizeofEcpointEx(*(_DWORD *)(a1 + 36), *(_DWORD *)(a1 + 8) & 0xF);
  }
  else
  {
    SymCryptEcurveDigitsofScalarMultiplier(a1);
    result = *(_DWORD *)(a1 + 36) + (unsigned int)SymCryptSizeofIntFromDigits();
  }
  v19 = *(_DWORD *)(a1 + 48);
  if ( v19 <= *(_DWORD *)(a1 + 56) )
    v19 = *(_DWORD *)(a1 + 56);
