/*
 * XREFs of DrvDbGetDriverFileMappedPropertyKeys @ 0x140A2E760
 * Callers:
        ...
        unsigned int *Handle)
{
  ...
  *v6 = 0;
  v10 = a1;
  v11 = v8;
  CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(a1, (_OWORD **)off_140C093D0, 1u, a4, v8, v6);
