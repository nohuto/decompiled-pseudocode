/*
 * XREFs of KeConfigureHeteroProcessors @ 0x14095FD08
 * Callers:
 ...
 *     KiComputeHgsScore @ 0x140573A60 (KiComputeHgsScore.c)
 */
...
__int64 __fastcall KeConfigureHeteroProcessors(__int64 a1, int a2, _DWORD *a3)
{
  ...
  v4 = 0;
  v5 = *(_DWORD *)(a1 + 4);
  v6 = KiDefaultHeteroCpuPolicy;
  v7 = KeHeteroSystem;
  v8 = *(unsigned int *)(KiHeteroConfig + 20);
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(v11 + 788) = 2097153LL;
      ...
      if ( (_DWORD)KeNumberProcessors_0 )
      {
        ...
        while ( v19 < (unsigned int)KeNumberProcessors_0 );
        v13 = v69;
        v12 = v68;
        v14 = KeNumberProcessors_0;
        v15 = v57;
      ...
      *(_WORD *)((char *)&unk_140D053AC + v12 - 16) = v40;
      ...
      v43 = KiComputeHgsScore(v41, v42);
      *(_WORD *)(v44 + v12) = v43;
      if ( v45 || v15 )
        break;
      for ( i = 0; i < v14; ++i )
        KeAddProcessorAffinityEx(v13, i);
      KiCopyAffinityEx((__int64)(v13 + 132), v13[133], v13);
      KiCopyAffinityEx((__int64)(v13 + 264), v13[265], v13);
      KiCopyAffinityEx((__int64)(v13 + 396), v13[397], v13);
      KiCopyAffinityEx((__int64)(v13 + 528), v13[529], v13);
      *(_DWORD *)(v3 + 12) = a2;
      *(_DWORD *)(v3 + 16) = v73 != 0;
LABEL_54:
      v11 = v67 + 1320;
...
LABEL_56:
  byte_140D053BC = v9;
  KeGenericCallDpc((__int64)KiConfigureHeteroProcessorsTarget, v3);
  v54 = KeHeteroSystem;
  v55 = 0;
  *a3 = KeHeteroSystem;
  for ( KiDefaultHeteroCpuPolicy = v54 != 0 ? KiDesiredHeteroCpuPolicy : 0; v55 < (unsigned int)KeNumberProcessors_0; ++v55 )
    KiConfigureCpuSetSchedulingInformation(KiProcessorBlock[v55]);
  if ( v6 != KiDefaultHeteroCpuPolicy || v7 != KeHeteroSystem )
    return 1;
  return v4;
}
