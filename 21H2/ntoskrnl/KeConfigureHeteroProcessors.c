/*
 * XREFs of KeConfigureHeteroProcessors @ 0x1408BA4B8
 * Callers:
...
__int64 __fastcall KeConfigureHeteroProcessors(_BYTE *a1, int a2, _DWORD *a3)
{
  ...
  _QWORD v30[88]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  v30[0] = a1;
  LODWORD(v30[1]) = a2;
  LODWORD(v30[3]) = 1310721;
  memset((char *)&v30[3] + 4, 0, 0xA4uLL);
  LODWORD(v30[24]) = 1310721;
  memset((char *)&v30[24] + 4, 0, 0xA4uLL);
  LODWORD(v30[45]) = 1310721;
  memset((char *)&v30[45] + 4, 0, 0xA4uLL);
  LODWORD(v30[66]) = 1310721;
  memset((char *)&v30[66] + 4, 0, 0xA4uLL);
...
LABEL_23:
  ...
  LODWORD(v30[2]) = v7 != 0;
LABEL_28:
  KeGenericCallDpc((__int64)KiConfigureHeteroProcessorsTarget, (__int64)v30);
  v21 = KeHeteroSystem;
  v22 = 0;
  *a3 = KeHeteroSystem;
