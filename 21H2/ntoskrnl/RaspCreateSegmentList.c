/*
 * XREFs of RaspCreateSegmentList @ 0x1403B37A0
 * Callers:
...
LABEL_54:
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(v27 + 16) & 1) != 0 )
    {
      ...
      else
      {
        ...
        *((_QWORD *)v20 - 1) = v35;
        ...
        {
          v38 = RaspInterpolatePoint(v35, v36, a6);
          *(_QWORD *)v20 = v38;
          if ( !v38 )
            break;
          v22 = v21 + 1;
    ...
    if ( (*(_BYTE *)(v30 + 16) & 1) != 0 )
    {
      v40 = RaspInterpolatePoint(v29, v28, a6);
      *((_QWORD *)v20 - 2) = v40;
      if ( !v40 )
        break;
      *((_QWORD *)v20 - 1) = v27;
    ...
    v31 = RaspInterpolatePoint(v29, v28, a6);
    *((_QWORD *)v20 - 2) = v31;
    if ( !v31 )
      break;
    *((_QWORD *)v20 - 1) = v27;
    v32 = RaspInterpolatePoint(v27, v30, a6);
    *(_QWORD *)v20 = v32;
    if ( !v32 )
      break;
    v20[8] = 5;
