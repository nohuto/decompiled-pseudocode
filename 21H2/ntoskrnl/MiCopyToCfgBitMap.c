/*
 * XREFs of MiCopyToCfgBitMap @ 0x140700460
 * Callers:
        ...
        size_t Size)
{
  ...
  {
    Pool = (char *)qword_140C53298;
    if ( !v9 )
      Pool = (char *)qword_140C532A0;
  }
  v61 = (__int64)Pool;
LABEL_6:
  v16 = (char *)a5;
  ...
  for ( i = v18; ; v18 = i )
  {
    ...
    if ( v63 == 1 )
    {
      ...
      memmove(Pool, v16, (unsigned int)v21);
      *((_QWORD *)&v66 + 1) = Pool;
      *(_QWORD *)&v66 = (unsigned int)(8 * v21);
      while ( 1 )
      {
        ...
        if ( (v50 & 8) != 0 )
        {
          _bittestandset64((signed __int64 *)Pool, v51 + 1);
          _bittestandreset64((signed __int64 *)Pool, v51);
        }
        else if ( (v50 & 0x15) != 0 )
        {
        ...
        {
          RtlClearBitsEx((__int64)&v66, v51, 2uLL);
        }
        v57 = ++v44;
      }
      v60 += v47;
    ...
    *((_QWORD *)&v66 + 1) = Pool;
    *(_QWORD *)&v66 = 8 * v20;
    RtlClearAllBitsEx((__int64)&v66);
    v23 = v13 + (v20 >> 1 << 7);
    v56 = v23;
    v24 = *a8;
    if ( !*a8 )
    {
      v25 = RtlEnumRvaListFirst(v11, a8 + 2, a8 + 1);
      *a8 = v25;
      v24 = v25;
      goto LABEL_39;
    }
...
LABEL_46:
          ...
          _bittestandreset64((signed __int64 *)Pool, v34);
          _bittestandset64((signed __int64 *)Pool, v34 + 1);
          goto LABEL_47;
        }
      ...
      {
        RtlSetBitsEx((__int64)&v66, 2 * ((unsigned __int64)(v24 - v13) >> 4), 2uLL);
      }
LABEL_47:
      v35 = ++a8[3];
      v24 = a8[2];
      ...
      if ( v38 )
      {
        while ( 1 )
        {
          ...
          --v38;
          v40 = v39 >> 6;
          v24 += (v39 & 0x3F) * *((_DWORD *)RtlpRvaCompressionTableScales + v40);
          if ( (_DWORD)v40 == 3 )
            break;
          if ( !v38 )
...
LABEL_59:
    ...
    *a8 = v24;
    v21 = v64;
LABEL_11:
    v12 = MiSplitPrivatePage((ULONG_PTR)Src, a6);
    if ( v12 < 0 || (v12 = MiCopyToUserVa((ULONG_PTR)Src, a6, Pool, v21), v12 < 0) )
    {
      v18 = i;
      break;
    }
