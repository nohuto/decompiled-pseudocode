/*
 * XREFs of Xp10ExecuteLz77PassMinMatchLen3 @ 0x1409C37DC
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  unsigned __int16 *v69; // [rsp+8h] [rbp-80h]
...
LABEL_16:
            ...
            {
              v28 = 2
                  * ((unsigned __int8)__ROR1__(*v18 ^ __ROL1__(*v9 + v9[3], 3), 1)
                   + 4 * (unsigned __int8)__ROL1__(*v9 ^ __ROR1__(*v18 + v9[2] + 97, 1), 3));
...
LABEL_100:
          ...
          {
            _BitScanReverse((unsigned int *)&v62, v52 - 249);
            v63 = v62 - 24;
            *v61 = v62 - 24;
            if ( v52 - 249 > 1 )
            {
