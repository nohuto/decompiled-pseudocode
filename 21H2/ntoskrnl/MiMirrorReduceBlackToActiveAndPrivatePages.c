/*
 * XREFs of MiMirrorReduceBlackToActiveAndPrivatePages @ 0x140534AD4
 * Callers:
...
LABEL_42:
    ...
    if ( v13 != (_DWORD *)v12 && (*v13 | *((_DWORD *)qword_140011C70 + (v6 & 0x1F))) == -1 )
    {
    ...
    {
      v14 = v11 & 0x1F;
      if ( (~*((_DWORD *)qword_140011C70 + v14) & *v13) == 0 )
      {
        v10 = 32 - v14;
        if ( v14 == 33 )
          goto LABEL_41;
