/*
 * XREFs of IopLiveDumpPolicyChangeWnfCallback @ 0x14093CC30
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)(&ValueName.MaximumLength + 1) = 0;
  ...
  if ( v2 )
  {
    ...
    if ( (unsigned int)dword_140C064E0 > 5 && tlgKeywordOn((__int64)&dword_140C064E0, 0x400000000000LL) )
    {
      ...
      v20 = 4LL;
      v22 = 1LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C064E0, (unsigned __int8 *)byte_14002AD1B, 0LL, 0LL, 5u, v16);
    }
    if ( KeyHandle )
      ZwClose(KeyHandle);
  ...
  else
  {
    ...
    if ( (unsigned int)dword_140C064E0 > 5 && tlgKeywordOn((__int64)&dword_140C064E0, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_14002AD74,
        0LL,
        0LL,
        3u,
        v16);
