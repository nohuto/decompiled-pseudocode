/*
 * XREFs of IoSaveInitialBugCheckProgress @ 0x140552D54
 * Callers:
...
void __fastcall IoSaveInitialBugCheckProgress(int a1, __int64 a2)
{
  ...
  v8 = 0;
  v9 = 8;
  if ( !BugCheckSaveInitialProgressCalled && (unsigned __int8)IopBugCheckProgressEfiVariableServicesAvailable() )
  {
