/*
 * XREFs of MiTimeSingleLargePageZero @ 0x1403D4314
 * Callers:
...
void __fastcall MiTimeSingleLargePageZero(__int64 a1)
{
  ...
  v25 = dword_140C50728;
  for ( i = 0; i < (unsigned __int16)KeNumberNodes; v2 = v28 )
  {
    v4 = *(_QWORD *)(120LL * i + qword_140C506E0 + 112);
    v30 = v4;
    v5 = *(unsigned __int16 *)(v4 + 16) / v1;
    v27 = *(struct _GROUP_AFFINITY *)v4;
    if ( !v5 )
      v5 = 1;
    v26 = v5;
    PoolMm = ExAllocatePoolMm(64LL, 8LL * v5, 0x20206D4Du, i | 0x80000000);
    v31 = PoolMm;
    v7 = PoolMm;
    if ( PoolMm )
    {
...
LABEL_30:
    ...
    if ( !*(_QWORD *)(v4 + 24) )
    {
      ...
      v24 = MiTimeSingleLargePageZeroWorker(v2, i);
      KeRevertToUserGroupAffinityThread(&PreviousAffinity);
      *(_QWORD *)(v4 + 32) = v24;
    }
    ++i;
