/*
 * XREFs of EtwpClockSourceRunDown @ 0x1409EA068
 * Callers:
 ...
 *     KeGetDynamicTickDisableReason @ 0x14056C938 (KeGetDynamicTickDisableReason.c)
 */
...
void __fastcall EtwpClockSourceRunDown(__int64 a1, char a2)
{
  ...
  if ( a2 )
  {
    ...
    v11 = 0;
    v8 = 0LL;
    ((void (__fastcall *)(__int128 *))off_140C01EC0[0])(&v8);
    v6 = *(_QWORD *)((char *)&v8 + 4);
