/*
 * XREFs of PfSnLogScenarioDecision @ 0x1407DD250
 * Callers:
...
void __fastcall PfSnLogScenarioDecision(__int64 a1, int a2, __int16 a3, char a4, char a5, char a6, __int64 a7)
{
  ...
  v36 = a2;
  v7 = a7;
  if ( qword_140C54788 && EtwEventEnabled(qword_140C54788, &PfSnEvt_ScenarioDecision_Info) )
  {
    v11 = -1LL;
    do
      ++v11;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v17 = v12;
    v35 = 4LL;
    EtwWrite(qword_140C54788, &PfSnEvt_ScenarioDecision_Info, 0LL, 9u, &UserData);
  }
}
