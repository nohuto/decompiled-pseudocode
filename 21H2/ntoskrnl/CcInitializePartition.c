/*
 * XREFs of CcInitializePartition @ 0x1403D0FE0
 * Callers:
...
char __fastcall CcInitializePartition(char *StartContext, __int64 a2, _QWORD *a3)
{
  ...
  *((_WORD *)StartContext + 488) = 0;
  ...
  if ( (_BYTE)dword_140D051DC )
  {
    ...
    *((_QWORD *)StartContext + 128) = NumberOfPhysicalPagesForPartitionObject >> 1;
    if ( v19 )
    ...
    *((_QWORD *)StartContext + 127) = v21;
    v9 = ExCriticalWorkerThreads - 1;
  }
  else
  {
    v8 = NumberOfPhysicalPagesForPartitionObject >> 3;
  ...
  *((_QWORD *)StartContext + 132) = 0LL;
  v10 = 10 * MmGetNumberOfPhysicalPagesForPartitionObject(a3);
  v11 = ExCriticalWorkerThreads - 1;
  *((_QWORD *)StartContext + 131) = v10;
  *((_DWORD *)StartContext + 194) = v11;
  *((_DWORD *)StartContext + 201) = CcMaxCachemapUninitWorkerThreads;
  v12 = (*((_QWORD *)StartContext + 127) >> 1) + (*((_QWORD *)StartContext + 127) >> 2);
  if ( CcAzure_LazyWriterPercentageOfNumProcs )
  {
    v22 = KeQueryActiveProcessorCountEx(0xFFFFu) * CcAzure_LazyWriterPercentageOfNumProcs / 0x64;
...
LABEL_11:
    if ( (unsigned __int8)CcInitializePartitionVacbs(StartContext) )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        *((_QWORD *)StartContext + 134) = PoolWithTag;
        if ( v13 || (unsigned __int8)CcInitializeAsyncRead(StartContext, 0LL) )
        {
          v3 = 1;
          StartContext[1300] = 1;
          DbgPrintEx(
  ...
  {
    while ( (unsigned __int8)CcInitializeNumaNode(StartContext, a2 + 288LL * v16, v15, v16) )
    {
      if ( ++v16 >= CcNumberNumaNodes )
        goto LABEL_11;
    }
  }
  return v3;
