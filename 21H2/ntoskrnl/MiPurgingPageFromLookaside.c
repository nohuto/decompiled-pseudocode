/*
 * XREFs of MiPurgingPageFromLookaside @ 0x1402E9540
 * Callers:
...
__int64 __fastcall MiPurgingPageFromLookaside(int a1, __int64 a2)
{
  ...
  v18 = v8;
  v9 = MiSearchNumaNodeTable(0xAAAAAAAAAAAAAAABuLL * ((48 * a2) >> 4));
  v10 = *(_BYTE *)(v4 + 35);
  ...
  v22 = v12;
  if ( qword_140C50710 )
    LODWORD(result) = MiPageToChannel(0xAAAAAAAAAAAAAAABuLL * ((v4 + 0x220000000000LL) >> 4));
  else
    LODWORD(result) = 0;
  v23 = result;
...
LABEL_8:
  ...
  else
  {
    ...
    while ( 1 )
    {
      result = MiGetStandbyLookaside(&v18, v15);
      if ( v16 != a1 )
        break;
LABEL_15:
      v15 = v16 + 1;
