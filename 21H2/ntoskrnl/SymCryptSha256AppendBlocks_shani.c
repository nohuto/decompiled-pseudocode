/*
 * XREFs of SymCryptSha256AppendBlocks_shani @ 0x1403EC484
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      __asm { sha256rnds2 xmm9, xmm11, xmm0 }
      __asm { sha256rnds2 xmm11, xmm9, xmm0 }
      __asm { sha256msg1 xmm5, xmm7 }
      _XMM8 = _mm_add_epi32(_mm_alignr_epi8(_XMM3, _XMM2, 4), _XMM5);
      __asm { sha256msg2 xmm8, xmm3 }
      __asm { sha256rnds2 xmm9, xmm11, xmm0 }
      __asm { sha256rnds2 xmm11, xmm9, xmm0 }
      __asm { sha256msg1 xmm7, xmm2 }
      ...
      __asm { sha256rnds2 xmm9, xmm11, xmm0 }
      __asm { sha256rnds2 xmm11, xmm9, xmm0 }
      __asm { sha256msg1 xmm8, xmm6 }
      _XMM7 = _mm_add_epi32(_mm_alignr_epi8(_XMM4, _XMM5, 4), _XMM8);
      __asm { sha256msg2 xmm7, xmm4 }
      __asm { sha256rnds2 xmm9, xmm11, xmm0 }
      __asm { sha256rnds2 xmm11, xmm9, xmm0 }
      __asm { sha256msg1 xmm6, xmm5 }
