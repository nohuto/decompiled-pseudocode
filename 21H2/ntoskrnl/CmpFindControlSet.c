/*
 * XREFs of CmpFindControlSet @ 0x14082F3C4
 * Callers:
...
__int64 __fastcall CmpFindControlSet(ULONG_PTR BugCheckParameter3, ULONG_PTR BugCheckParameter4, int a3, _BYTE *a4)
{
  ...
  CmpFindSubKeyByNameWithStatus(BugCheckParameter3, v9, &DestinationString, &BugCheckParameter4a);
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
...
LABEL_89:
  ...
  LODWORD(BugCheckParameter4a) = 0;
  CmpFindSubKeyByNameWithStatus(BugCheckParameter3, v21, &DestinationString, &BugCheckParameter4a);
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    HvpReleaseCellFlat(BugCheckParameter3, &v34);
  else
    HvpReleaseCellPaged(BugCheckParameter3, (unsigned int *)&v34);
