/*
 * XREFs of HalpTscAdvSynchLeader @ 0x1403AC640
 * Callers:
 ...
 *     HalpTscAdvSynchReadTimeStamp @ 0x1403AC88C (HalpTscAdvSynchReadTimeStamp.c)
  ...
  if ( *(_DWORD *)(a1 + 40) )
  {
    do
    {
      ...
      if ( v3 != CurrentPrcb->Number )
      {
        ...
        LODWORD(CurrentPrcb) = *(_DWORD *)(v15 + TscRequest);
