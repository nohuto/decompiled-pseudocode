/*
 * XREFs of PopDiagTraceSleepReliabilityDiagConfigUpdate @ 0x1409931D4
 * Callers:
...
void PopDiagTraceSleepReliabilityDiagConfigUpdate()
{
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C03A00, 0x400000000000LL) )
    {
      ...
      v2 = 0x1000000LL;
      v8 = 8;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)byte_140030251, 0LL, 0LL, 4u, &v3);
    }
  }
}
