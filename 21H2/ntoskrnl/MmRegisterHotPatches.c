/*
 * XREFs of MmRegisterHotPatches @ 0x140B2F2BC
 * Callers:
...
LABEL_22:
          ...
          *(_DWORD *)&SecureImageActivePatch[2].Length = *((_DWORD *)v5 + 16);
          *(_DWORD *)(&SecureImageActivePatch[2].MaximumLength + 1) = *((_DWORD *)v5 + 17);
          LODWORD(SecureImageActivePatch[2].Buffer) = *((_DWORD *)v5 + 15);
    ...
    if ( (_QWORD *)*v8 != v8 )
    {
      do
      {
        if ( (v11[5] & 3) == 0 )
        {
          v25[6] = *((_DWORD *)v11 + 8);
          v25[7] = *((_DWORD *)v11 + 9);
          v21 = MiFindHotPatchRecord((__int64 *)&qword_140C533B0, 0LL, *((_DWORD *)v11 + 8), *((_DWORD *)v11 + 9), 0LL);
          v27 = *((_DWORD *)v11 + 8);
          v26 = *((_DWORD *)v11 + 9);
          v22 = 9;
          if ( v21 >= 0 )
