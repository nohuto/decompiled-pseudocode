/*
 * XREFs of MiUnlockDynamicMemoryNestedExclusive @ 0x140583A70
 * Callers:
...
LABEL_12:
    ...
    if ( (result & 0x10000) == 0 )
      KeBugCheckEx(0x162u, (ULONG_PTR)CurrentThread, (ULONG_PTR)&qword_140C55040, SessionId, 0LL);
    _enable();
    return result;
  }
  ...
  *(_QWORD *)p_Process = 0LL;
  ...
  _enable();
  if ( v5 )
    return KiAbThreadRemoveBoostsSlow((ULONG_PTR)CurrentThread, (__int64)&qword_140C55040, v5);
  return result;
}
