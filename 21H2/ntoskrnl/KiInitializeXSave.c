/*
 * XREFs of KiInitializeXSave @ 0x140A56780
 * Callers:
 ...
 *     KiIntersectFeaturesWithLoader @ 0x140A55D78 (KiIntersectFeaturesWithLoader.c)
 *     KiIntersectFeaturesWithPolicy @ 0x140A55DCC (KiIntersectFeaturesWithPolicy.c)
 *     KiUpdateXSaveSizeAndVolatileFeatures @ 0x140A56014 (KiUpdateXSaveSizeAndVolatileFeatures.c)
 */
...
__int64 __fastcall KiInitializeXSave(__int64 a1, int a2)
{
  ...
  {
    KiIntersectFeaturesWithLoader(a1, (__int64 *)BugCheckParameter1);
    KiIntersectFeaturesWithPolicy(a1, (__int64 *)BugCheckParameter1);
    ...
    KiUpdateXSaveSizeAndVolatileFeatures((__int64 *)BugCheckParameter1);
    v7 = 6LL;
