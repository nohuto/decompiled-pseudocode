/*
 * XREFs of HvlDmaGetDmaGuardEnabled @ 0x140546200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HvlDmaGetDmaGuardEnabled(_BYTE *a1)
{
  ...
  v2 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v7.m256i_i64[1], 1, (__int64)v9, 8LL);
  v3 = HvlpAcquireHypercallPage((PHYSICAL_ADDRESS *)&v6.m256i_i64[1], 2, (__int64)v10, 1032LL);
  *v2 = 0LL;
  *(_DWORD *)v2 = 20;
