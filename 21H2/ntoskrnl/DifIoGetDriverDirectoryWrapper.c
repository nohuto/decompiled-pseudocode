/*
 * XREFs of DifIoGetDriverDirectoryWrapper @ 0x14060F590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DifIoGetDriverDirectoryWrapper(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  v19 = 0LL;
  v20 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(174);
...
LABEL_18:
  result = IoGetDriverDirectory(a1, a2, a3, a4, v19, *((_QWORD *)&v19 + 1), v20, *((_QWORD *)&v20 + 1), v21);
  LODWORD(v21) = result;
  if ( APIThunkContextById )
  {
