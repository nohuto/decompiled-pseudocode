/*
 * XREFs of MiApplyImportOptimizationToRuntimeDriver @ 0x14075CB78
 * Callers:
 ...
 *     MiDoesControlAreaRequireRetpolineFixups @ 0x140371E0C (MiDoesControlAreaRequireRetpolineFixups.c)
