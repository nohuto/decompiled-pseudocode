/*
 * XREFs of MiInsertProtectedStandbyPage @ 0x140329470
 * Callers:
...
__int64 __fastcall MiInsertProtectedStandbyPage(__int64 a1, __int64 a2)
{
  ...
  struct _KLOCK_QUEUE_HANDLE v34; // [rsp+38h] [rbp-40h] BYREF
...
LABEL_30:
        ...
        v34.LockQueue.Lock = (unsigned __int64 *volatile)(v8 + 4928);
        v20 = (struct _KEVENT *)(v8 + v19);
        KxAcquireQueuedSpinLock(&v34, v8 + 4928, v16);
        KeSetEvent(v20, 0, 0);
        ++v20[1].Header.LockNV;
  ...
  if ( (BYTE6(PerfGlobalGroupMask) & 1) == 0 )
  {
    ...
    if ( !LockHandle.LockQueue.Next )
    {
      ...
      if ( (struct _KLOCK_QUEUE_HANDLE *)result == &LockHandle )
        goto LABEL_46;
      result = KxWaitForLockChainValid((__int64 *)&LockHandle, v27, v28, v29);
    }
    LockHandle.LockQueue.Next = 0LL;
