/*
 * XREFs of ?StDmpSinglePageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAXPEAU_ST_PAGE_LOCATION@1@@Z @ 0x140391E54
 * Callers:
 ...
 *     ?StDmpSinglePageLookup@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAPEAU_ST_PAGE_RECORD@1@@Z @ 0x1403923A4 (-StDmpSinglePageLookup@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@P.c)
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  *(_WORD *)(a5 + 6) = (unsigned __int8)*(_WORD *)a3;
  ...
  else
  {
    ...
    {
      v17 = *(_QWORD *)(a1 + 16LL * IsCurrentRegion + 1256) + v15;
      goto LABEL_14;
    }
  }
  v16 = SMKM_STORE<SM_TRAITS>::SmStMapRegion(*(_QWORD *)(a1 + 800), v12, v15, a4, 1);
  v7 = v16;
  if ( v16 <= 3 )
  {
    v9 = -1073741550;
...
LABEL_14:
  *(_QWORD *)(a2 + 56) = a3;
  ...
  if ( v7 )
  {
    ...
    {
      SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(v19, v12, v18, v19, v26, 0);
    }
    else
    {
      v21 = *(_QWORD *)(v19 + 6216);
      ...
      *(_QWORD *)(v21 + 8 * v12) = v23;
      if ( (v23 & 3) == 0 )
        SmFpFree(v19 + 6608, 5, (__int64)KeGetCurrentThread(), v24);
    }
  }
LABEL_19:
  if ( v8 )
