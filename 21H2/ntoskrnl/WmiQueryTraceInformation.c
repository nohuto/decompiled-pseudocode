/*
 * XREFs of WmiQueryTraceInformation @ 0x140788A80
 * Callers:
  ...
  if ( TraceInformationClass > TraceHandleByNameClass )
  {
    ...
    if ( v17 )
    {
      ...
      if ( !v19 )
      {
        ...
        *((_OWORD *)TraceInformation + 1) = *(_OWORD *)off_140986A50;
        *((_OWORD *)TraceInformation + 2) = *(_OWORD *)&off_140986A60;
        *((_OWORD *)TraceInformation + 3) = *(_OWORD *)&off_140986A70;
        *((_OWORD *)TraceInformation + 4) = *(_OWORD *)off_140986A80;
        *((_OWORD *)TraceInformation + 5) = *(_OWORD *)&off_140986A90;
        *((_OWORD *)TraceInformation + 6) = *(_OWORD *)off_140986AA0;
