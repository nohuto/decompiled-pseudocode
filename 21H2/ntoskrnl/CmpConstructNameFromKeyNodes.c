/*
 * XREFs of CmpConstructNameFromKeyNodes @ 0x1407C8830
 * Callers:
...
__int64 __fastcall CmpConstructNameFromKeyNodes(__int64 a1, _QWORD *a2)
{
  ...
  *(_OWORD *)Privileges = 0LL;
  ...
  if ( v7 >= 2 )
  {
    ...
    TransientPoolWithTag = (struct _PRIVILEGE_SET *)CmpAllocateTransientPoolWithTag(PagedPool, v37, 0x35364D43u, v4);
    ...
    memset(TransientPoolWithTag, 0, v37);
  }
  LOWORD(v41) = v7;
  Privileges[1] = v8;
...
LABEL_27:
      ...
      if ( v18 )
      {
        ...
        if ( v33 )
        {
          do
          {
            CmpSetKcbAtLayerHeight((__int64)&v41, v34, *(_QWORD *)(v33 + 16));
            v33 = *(_QWORD *)(v35 + 24);
            v34 = v36 - 1;
          }
          while ( v33 );
...
LABEL_17:
      ...
      if ( v22 )
      {
        ...
        if ( v22 == (const void *)1 )
        {
          ...
          if ( (*(_DWORD *)v40 & 1) != 0 )
            CmpCopyCompressedName(v39, 2 * v19, (unsigned __int8 *)(v40 + 26), v19);
          else
      ...
      else
      {
        ...
        if ( (*(_BYTE *)(v23 + 140) & 1) != 0 )
          CellFlat = HvpGetCellFlat(v23, v21[2].PrivilegeCount, &v43);
        else
        ...
        if ( (*(_BYTE *)(v31 + 140) & 1) != 0 )
          HvpReleaseCellFlat(v31, &v43);
        else
          HvpReleaseCellPaged(v31, &v43);
      }
      v14 = v20 - 1;
