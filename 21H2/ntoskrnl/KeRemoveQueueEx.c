        ...
        ULONG Count)
{
  ...
  _DWORD *v17; // rcx
  $AC3BF0C7EA58B0FE9399BAAA5443B647 *v18; // r14
...
LABEL_32:
    ...
    v26 = (struct _LIST_ENTRY *)KiCommitThreadWait((_DWORD)CurrentThread, (int)CurrentThread + 320, v113, QuadPart, 0LL);
