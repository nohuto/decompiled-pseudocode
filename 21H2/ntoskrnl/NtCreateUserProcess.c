/*
 * XREFs of NtCreateUserProcess @ 0x14060A1D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PspGetProcessParameterOverrides @ 0x14060713C (PspGetProcessParameterOverrides.c)
...
LABEL_171:
              ...
              *(_DWORD *)&v72[4] = v27;
                          ...
                          v72[4]) )
              {
                ...
                LOBYTE(v35) = v31;
                LOBYTE(v36) = v68;
                if ( !(unsigned int)qword_140C1DB00(v36, v35) )
                  goto LABEL_167;
              ...
              else
              {
                ...
                if ( Info < 0 )
                {
                  ...
                  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)v70 + 135, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
                    ExfTryToWakePushLock(v51 + 1080);
                  KeAbPostRelease((ULONG_PTR)(v51 + 1080));
