/*
 * XREFs of CmpPreserveSystemHiveData @ 0x14091FEFC
 * Callers:
...
__int64 __fastcall CmpPreserveSystemHiveData(ULONG_PTR BugCheckParameter3, ULONG_PTR a2)
{
  ...
  if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    CellFlat = HvpGetCellFlat(BugCheckParameter3, v7, &v62);
  else
    CellFlat = HvpGetCellPaged(BugCheckParameter3, v7, (unsigned int *)&v62);
  v2 = CellFlat;
  v65 = CellFlat;
  if ( (*(_BYTE *)(a2 + 140) & 1) != 0 )
    CellPaged = HvpGetCellFlat(a2, v9, &v64);
  else
    CellPaged = HvpGetCellPaged(a2, v9, (unsigned int *)&v64);
  v63 = (_DWORD *)CellPaged;
  if ( !v2 || (LODWORD(v2) = 0, !CellPaged) )
  {
    v15 = -1073741670;
    goto LABEL_82;
  }
  v12 = CmpWalkPath(BugCheckParameter3, v7, L"WPA");
  v13 = CmpWalkPath(a2, v9, L"WPA");
  if ( v12 == -1 || v13 == -1 )
  {
    v15 = -1073741492;
LABEL_81:
  ...
  v14 = CmpCopySyncTree(BugCheckParameter3, v12, a2, (struct _LOOKASIDE_LIST_EX *)v13, 2, 1);
  LODWORD(v2) = 0;
  v15 = v14;
  if ( v14 >= 0 )
  {
    v16 = CmpWalkPath(BugCheckParameter3, v7, L"CurrentControlSet");
    v17 = v16;
    if ( v16 == -1 )
    {
      v15 = 0;
    ...
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
      v18 = HvpGetCellFlat(BugCheckParameter3, v16, &v60);
    else
      v18 = HvpGetCellPaged(BugCheckParameter3, v16, (unsigned int *)&v60);
    if ( !v18 )
    {
LABEL_20:
      v15 = -1073741670;
    ...
    ValueByName = CmpFindValueByName(BugCheckParameter3, v18, (int)&CmSymbolicLinkValueName);
    if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
    ...
    if ( ValueByName != -1 )
    {
      v20 = (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0
          ? HvpGetCellFlat(BugCheckParameter3, ValueByName, &v95)
          : HvpGetCellPaged(BugCheckParameter3, ValueByName, (unsigned int *)&v95);
      v21 = v20;
      if ( v20 )
      {
        if ( *(_DWORD *)(v20 + 12) == 6 )
        {
          ...
          if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
            v23 = HvpGetCellFlat(BugCheckParameter3, v22, &v59);
          else
            v23 = HvpGetCellPaged(BugCheckParameter3, v22, (unsigned int *)&v59);
          v24 = v23;
          if ( !v23 )
          {
            if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
              HvpReleaseCellFlat(BugCheckParameter3, &v95);
            else
              HvpReleaseCellPaged(BugCheckParameter3, (unsigned int *)&v95);
            goto LABEL_20;
          }
          ...
          LODWORD(v2) = 0;
          v5[v26] = 0;
          v17 = CmpWalkPath(BugCheckParameter3, v7, v5);
          if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
            HvpReleaseCellFlat(BugCheckParameter3, &v59);
          else
            HvpReleaseCellPaged(BugCheckParameter3, (unsigned int *)&v59);
...
LABEL_54:
    ...
    for ( i = 0; i < 2; ++i )
    {
      v30 = CmpWalkPath(BugCheckParameter3, v17, (PCWSTR)*(v28 - 1));
      *((_DWORD *)v28 + 2) = v30;
      if ( v30 != -1 )
      {
        if ( *v28 )
        {
          ...
          if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
            v32 = HvpGetCellFlat(BugCheckParameter3, v30, v31);
          else
            v32 = HvpGetCellPaged(BugCheckParameter3, v30, v31);
          v28[2] = v32;
          if ( !v32 )
          {
LABEL_79:
...
LABEL_80:
          ...
          v33 = CmpFindValueByName(BugCheckParameter3, v28[2], (int)&DestinationString);
          *((_DWORD *)v28 + 8) = v33;
          if ( v33 == -1 )
          {
            LODWORD(v2) = 0;
          ...
          else
          {
            ...
            if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
              v35 = HvpGetCellFlat(BugCheckParameter3, v33, v34);
            else
              v35 = HvpGetCellPaged(BugCheckParameter3, v33, v34);
            v28[5] = v35;
            if ( !v35 )
              goto LABEL_79;
    ...
    while ( 1 )
    {
      CmpFindSubKeyByNumber(a2, v37, v38, &BugCheckParameter4);
      v39 = BugCheckParameter4;
      v40 = (*(_BYTE *)(a2 + 140) & 1) != 0
          ? HvpGetCellFlat(a2, (unsigned int)BugCheckParameter4, &v94)
          : HvpGetCellPaged(a2, BugCheckParameter4, (unsigned int *)&v94);
      if ( !v40 )
        break;
      if ( *(_WORD *)(v40 + 72) == 13 )
      {
        ...
        v46 = v45 == 0;
        if ( (*(_BYTE *)(a2 + 140) & 1) != 0 )
          HvpReleaseCellFlat(a2, &v94);
        else
          HvpReleaseCellPaged(a2, (unsigned int *)&v94);
        if ( v46 )
        {
          v47 = 0;
          v48 = &v69;
          do
          {
            ...
            {
              v49 = CmpWalkPath(a2, v39, *((PCWSTR *)v48 - 2));
              if ( v49 != -1 )
              {
                if ( *((_QWORD *)v48 - 1) )
                {
                  if ( (*(_BYTE *)(a2 + 140) & 1) != 0 )
                    v50 = HvpGetCellFlat(a2, v49, &v94);
                  else
                    v50 = HvpGetCellPaged(a2, v49, (unsigned int *)&v94);
                  v51 = v50;
                  if ( !v50 )
                    goto LABEL_79;
                  RtlInitUnicodeString(&DestinationString, *((PCWSTR *)v48 - 1));
                  v52 = CmpFindValueByName(a2, v51, (int)&DestinationString);
                  if ( (*(_BYTE *)(a2 + 140) & 1) != 0 )
                    HvpReleaseCellFlat(a2, &v94);
                  else
                    HvpReleaseCellPaged(a2, (unsigned int *)&v94);
                  ...
                  {
                    if ( (*(_BYTE *)(a2 + 140) & 1) != 0 )
                      v53 = HvpGetCellFlat(a2, v52, &v61);
                    else
                      v53 = HvpGetCellPaged(a2, v52, (unsigned int *)&v61);
                    if ( !v53 )
                      goto LABEL_79;
                    LODWORD(Size) = v48[16];
                    ...
                    if ( (*(_BYTE *)(a2 + 140) & 1) != 0 )
                      ...
                      HvpReleaseCellPaged(a2, (unsigned int *)&v61);
                    if ( v15 < 0 )
                      goto LABEL_80;
                  }
                }
                ...
                {
                  CmpCopySyncTree(BugCheckParameter3, *v48, a2, (struct _LOOKASIDE_LIST_EX *)v49, 2, 1);
                }
              }
            }
            ++v47;
...
LABEL_82:
  ...
  do
  {
    ...
    if ( v55 )
    {
      ...
      else
      {
        ...
        if ( (*(_BYTE *)(BugCheckParameter3 + 140) & 1) != 0 )
          HvpReleaseCellFlat(BugCheckParameter3, v56);
        else
          HvpReleaseCellPaged(BugCheckParameter3, v56);
      }
    }
    ++v41;
    v42 += 11;
  ...
  {
    if ( (*(_BYTE *)(a2 + 140) & 1) != 0 )
      HvpReleaseCellFlat(a2, &v64);
    else
      HvpReleaseCellPaged(a2, (unsigned int *)&v64);
  }
  if ( v5 )
