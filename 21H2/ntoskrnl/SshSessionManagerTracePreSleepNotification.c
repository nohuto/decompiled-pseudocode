/*
 * XREFs of SshSessionManagerTracePreSleepNotification @ 0x140807CCC
 * Callers:
...
__int64 __fastcall SshSessionManagerTracePreSleepNotification(int a1, int a2, int a3, int a4, char a5)
{
  ...
  v6[8] = &a5;
  v6[9] = 4LL;
  return SshpSessionManagerSendControlEvent(SLEEPSTUDY_EVT_PRE_SLEEP_NOTIFICATION_CONTROL_EVENT, 5LL, v6);
}
