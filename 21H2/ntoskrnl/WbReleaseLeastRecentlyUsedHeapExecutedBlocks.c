/*
 * XREFs of WbReleaseLeastRecentlyUsedHeapExecutedBlocks @ 0x1406A2980
 * Callers:
  ...
  if ( a2 > 0 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        v16 = *(_QWORD *)(v14 + 48);
        v18 = 0LL;
        if ( (int)sub_1406A2AFC((int)a1 + 8, v16, 8, -1, (__int64)&v18) >= 0 )
          sub_14064DAEC(a1, v18);
      }
