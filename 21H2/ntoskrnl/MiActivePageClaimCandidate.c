/*
 * XREFs of MiActivePageClaimCandidate @ 0x140278960
 * Callers:
...
__int64 __fastcall MiActivePageClaimCandidate(__int64 a1, __int64 a2, char a3, int a4)
{
  int v5; // r14d
  __int64 v9; // rsi
  __int64 v10; // rbp
  ...
  if ( _bittest64((const signed __int64 *)(a2 + 40), 0x28u) )
  {
    ...
    else
    {
      v46 = 0;
      v50 = 0;
      PfnPageSizeIndex = MiGetPfnPageSizeIndexUnsynchronized(a2, &v46, &v50);
    }
  ...
  if ( (a3 & 2) == 0 )
  {
    PfnPageSizeIndex = MiPfnLargeBitSet(a1, v11);
    if ( PfnPageSizeIndex != -1 )
      return MiLargePageSizes[PfnPageSizeIndex];
  }
  v16 = *(_QWORD *)(a2 + 40);
  ...
  if ( (*(_BYTE *)a2 & 1) == 0 )
  {
    if ( (unsigned int)MiHyperPage(a2, v11) )
    {
    ...
    if ( MiVaIsPageFileHash(a1, (__int64)(v13 << 25) >> 16) )
      return 0LL;
    SystemRegionType = MiGetSystemRegionType((__int64)(v13 << 25) >> 16, v27, v28, v29);
    if ( SystemRegionType != 5 )
    {
      if ( v18 < MmPfnDatabase || v18 > MmPfnDatabase + (MxPfnAllocation << 12) )
      {
        if ( SystemRegionType == 1
          || v18 >= 0xFFFFF68000000000uLL
          && v18 <= 0xFFFFF6FFFFFFFFFFuLL
          && (unsigned int)MiGetSystemRegionType((__int64)(v18 << 25) >> 16, v30, v31, v32) == 1 )
        {
          if ( a4 )
            ++dword_140C29E4C;
          else
    ...
    {
      ++dword_140C29F78;
      v12 = MiLockPageInline(a2);
      if ( (*(_BYTE *)(a2 + 34) & 7) != 6
        || _bittest64((const signed __int64 *)(a2 + 40), 0x28u)
        || (*(_QWORD *)(a2 + 8) | 0x8000000000000000uLL) != v13
        || (unsigned int)MiGetSystemRegionType((__int64)(v13 << 25) >> 16, v34, v35, v36) != 5 )
      {
        ++dword_140C29F5C;
        goto LABEL_125;
      }
    }
    v48[0] = MI_READ_PTE_LOCK_FREE(v13);
    v37 = v48[0];
    if ( (v48[0] & 1) == 0 )
    {
      if ( !a4 )
...
LABEL_125:
  ...
  if ( PsInitialSystemProcess && v47 == PsInitialSystemProcess->DirectoryTableBase >> 12 )
  {
    if ( a4 )
      ++dword_140C29E60;
    else
  ...
  if ( (unsigned int)MiGetSystemRegionType(v18, 0x3FFFFFFFFFFFFFFFLL, v17, v21) == 6 )
  {
    if ( *(_WORD *)(a2 + 32) <= 1u )
    {
      if ( v23 < 0x10000 )
  ...
  else if ( (unsigned int)MiHyperPage(a2, v24) )
  {
    if ( *(_WORD *)(a2 + 32) <= 1u )
      return 0LL;
    if ( a4 )
