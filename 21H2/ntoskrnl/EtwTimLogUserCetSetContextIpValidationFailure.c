/*
 * XREFs of EtwTimLogUserCetSetContextIpValidationFailure @ 0x1409E8614
 * Callers:
...
void __fastcall EtwTimLogUserCetSetContextIpValidationFailure(int a1, __int64 a2, void *a3, int a4, int a5)
{
  ...
  *(_QWORD *)&UserData.Size = 2LL;
  ...
  v32[0] = v15;
  v71 = 0;
  v16 = EtwpTiFillProcessIdentity(v72, a2, &v36) + 4;
...
LABEL_13:
  v20 = 2LL * (v16 + 1);
  v21 = (const EVENT_DESCRIPTOR *)MITIGATION_AUDIT_USER_CET_SET_CONTEXT_IP_VALIDATION_FAILURE;
  v22 = v16 + 2;
  ...
  *((_QWORD *)&UserData.Size + v25) = 4LL;
  if ( v23 != 1 )
    v21 = &MITIGATION_ENFORCE_USER_CET_SET_CONTEXT_IP_VALIDATION_FAILURE;
  ...
  if ( (unsigned int)dword_140C043E0 > 5 && tlgKeywordOn((__int64)&dword_140C043E0, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&byte_1400358C7,
      0LL,
      0LL,
      0xDu,
      &v40);
