/*
 * XREFs of HvpMappedViewConvertRegionFromLockedToCOWByPolicy @ 0x1406086BC
 * Callers:
 *     HvpMappedViewConvertLockedPagesToCOWByPolicy @ 0x140608610 (HvpMappedViewConvertLockedPagesToCOWByPolicy.c)
 * Callees:
