/*
 * XREFs of MincryptValidateBasicConstraints @ 0x14065A018
 * Callers:
 *     MinCryptVerifyCertificateWithPolicy2 @ 0x140A32064 (MinCryptVerifyCertificateWithPolicy2.c)
 * Callees:
 *     __security_check_cookie @ 0x1403DF760 (__security_check_cookie.c)
 *     MinAsn1DecodeInteger @ 0x14065A150 (MinAsn1DecodeInteger.c)
...
__int64 __fastcall MincryptValidateBasicConstraints(_DWORD *a1, int a2, char a3, _DWORD *a4)
{
  ...
  if ( !*a1 )
    goto LABEL_14;
  if ( (int)MinAsn1ParseSingleExtensionValue(&qword_140A389D0, a1, v9, &v11) <= 0 )
    goto LABEL_15;
  if ( !v9[0] )
  {
LABEL_14:
...
LABEL_15:
  ...
  LODWORD(v10) = 3;
  if ( (int)MinAsn1ExtractValues(DWORD2(v11), v11, (unsigned int)&v10, (unsigned int)&qword_140007048, 3, (__int64)&v12) <= 0
    || v12 <= 0
    || !DWORD2(v13)
    || !*(_BYTE *)v14 )
  {
