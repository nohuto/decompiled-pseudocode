/*
 * XREFs of MiClearPageFileHash @ 0x140249FA4
 * Callers:
...
LABEL_24:
  ...
  *(_DWORD *)v4 = 1;
  v18 = v6;
  v19 = MiPteInShadowRange(&updated);
  if ( v19
    && (MiFlags & 0xC00000) != 0
  ...
  if ( qword_140C4DF80 && ((unsigned __int8)Next & 0x10) == 0 )
    v10 = (unsigned __int64)Next & ~qword_140C4DF80;
...
LABEL_9:
  ...
  v14 = 1;
  if ( !HIBYTE(word_140C4E048) && (v12 & 1) != 0 )
    v13 |= 0x8000000000000000uLL;
LABEL_10:
