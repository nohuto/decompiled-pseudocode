/*
 * XREFs of DifpLwSPProcessPrePoolAlloc @ 0x140AA6E1C
 * Callers:
 *     DifpExAllocatePoolWithTagPriority_LwSP_Enter @ 0x140AA6D70 (DifpExAllocatePoolWithTagPriority_LwSP_Enter.c)
 * Callees:
