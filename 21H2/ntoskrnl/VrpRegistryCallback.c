/*
 * XREFs of VrpRegistryCallback @ 0x140780EF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
    if ( a2 == 32 )
    {
      if ( !(unsigned int)VRegEnabledInJob((unsigned __int64 *)&v17) )
        return Key;
      v12 = v17;
...
LABEL_31:
  switch ( v14 )
  {
    case 0:
      ...
      if ( v15 )
        VrpDecommissionKeyContext(v15);
      break;
    case 6:
      Key = VrpPostEnumerateKey((__int64)a3, (__int64)v12);
      break;
    case 12:
      return (unsigned int)VrpPreOpenOrCreate((__int64)a3, v12);
    case 13:
