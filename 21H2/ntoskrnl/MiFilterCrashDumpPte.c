/*
 * XREFs of MiFilterCrashDumpPte @ 0x140592D90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiFilterCrashDumpPte(_QWORD *a1, unsigned __int64 a2, int a3)
{
  __int64 *v3; // rdi
  __int64 v7; // r14
    ...
    if ( (v10 & 1) != 0 )
    {
      ...
      if ( v11 <= qword_140C50840 && ((*(_QWORD *)(48 * v11 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
      {
        if ( (v10 & 0x80u) != 0LL )
        {
          ...
          v11 = (__int64)(a1[10] << 25) >> 16;
          if ( v14 >= v11 )
            v11 = v14;
          v15 = 1LL;
          v16 = ((a1[11] << 25) | 0xFFF0000LL) >> 16;
          if ( v13 <= v16 )
            v16 = v13;
          v12 = (v16 - v11 + 1) >> 12;
          goto LABEL_38;
...
LABEL_38:
  ...
  else
  {
    ...
    if ( v18 <= qword_140C50840 && ((*(_QWORD *)(48 * v18 - 0x21FFFFFFFFD8LL) >> 54) & 1) != 0 )
    {
      v20 = 48 * v18 - 0x220000000000LL;
      if ( !MiIsPageSecured(v20) )
      {
