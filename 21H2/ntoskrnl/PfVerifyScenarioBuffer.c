/*
 * XREFs of PfVerifyScenarioBuffer @ 0x1407D8870
 * Callers:
...
LABEL_128:
                                        ...
                                        while ( !(unsigned __int8)PfMetadataRecordIsEqual(v46 + 96LL * v48, &v91, v49) )
                                        {
                                          v48 = v76 + 1;
                                          if ( v48 >= v77 )
                                            goto LABEL_86;
...
LABEL_129:
                                        if ( v44 == *(_DWORD *)(a1 + 120) )
                                        {
                                          ...
                                          else
                                          {
                                            ...
                                            {
                                              if ( (_DWORD)v75
                                                && StringCbLengthW((STRSAFE_PCNZWCH)(v75 + a1), v74, 0LL) < 0 )
                                              {
                                                v3 = 360;
                                              }
                                              else
