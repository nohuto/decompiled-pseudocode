/*
 * XREFs of EtwTimLogControlProtectionKernelModeReturnMismatch @ 0x140631D34
 * Callers:
...
char __fastcall EtwTimLogControlProtectionKernelModeReturnMismatch(int a1, __int64 a2)
{
  ...
  _QWORD v16[8]; // [rsp+40h] [rbp+0h] BYREF
  UNICODE_STRING v17; // [rsp+80h] [rbp+40h] BYREF
  UNICODE_STRING v18; // [rsp+90h] [rbp+50h] BYREF
  __int64 v19; // [rsp+A0h] [rbp+60h] BYREF
  __int64 v20; // [rsp+A8h] [rbp+68h] BYREF
  __int64 v21; // [rsp+B0h] [rbp+70h] BYREF
  __int64 v22; // [rsp+B8h] [rbp+78h] BYREF
  __int64 v23; // [rsp+C0h] [rbp+80h] BYREF
  __int64 v24; // [rsp+C8h] [rbp+88h] BYREF
  ...
  __int64 *v64; // [rsp+220h] [rbp+1E0h]
  __int64 v65; // [rsp+228h] [rbp+1E8h]
  __int64 *v66; // [rsp+230h] [rbp+1F0h]
  __int64 v67; // [rsp+238h] [rbp+1F8h]
  __int64 *v68; // [rsp+240h] [rbp+200h]
  __int64 v69; // [rsp+248h] [rbp+208h]
  __int64 *v70; // [rsp+250h] [rbp+210h]
  __int64 v71; // [rsp+258h] [rbp+218h]
  _QWORD *v72; // [rsp+260h] [rbp+220h]
  __int64 v73; // [rsp+268h] [rbp+228h]
  _QWORD *v74; // [rsp+270h] [rbp+230h]
  ...
  if ( a1 == 1 )
  {
    ...
    if ( (int)RtlPcToFileName(v16[3], &v17) >= 0 )
    {
      Length = v17.Length;
    }
    else
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    if ( (int)RtlPcToFileName(v16[4], &v18) >= 0 )
    {
      v9 = v18.Length;
    }
    else
    ...
    if ( (unsigned int)dword_140C043E0 > 5 )
    {
      ...
      if ( (_BYTE)v2 )
      {
        ...
        LOBYTE(v2) = tlgWriteTransfer_EtwWriteTransfer(
                       ...
                       (unsigned __int8 *)word_14003571A,
                       0LL,
                       0LL,
                       0xEu,
                       &v53);
