/*
 * XREFs of PopPowerRequestStatsGetIdForBlocker @ 0x1407F10FC
 * Callers:
 *     PopPowerRequestStatsCreate @ 0x1407F0070 (PopPowerRequestStatsCreate.c)
 * Callees:
 *     SleepstudyHelperGetBlockerVerboseDescription @ 0x1407F1240 (SleepstudyHelperGetBlockerVerboseDescription.c)
