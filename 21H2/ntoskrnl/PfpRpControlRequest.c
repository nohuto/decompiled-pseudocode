/*
 * XREFs of PfpRpControlRequest @ 0x1406ADA90
 * Callers:
 *     PfSetSuperfetchInformation @ 0x1406AD6BC (PfSetSuperfetchInformation.c)
 * Callees:
 *     PfpRpControlRequestVerify @ 0x14023662C (PfpRpControlRequestVerify.c)
    ...
    else
    {
      ...
      if ( v2 >= 0 )
      {
        if ( (unsigned int)PfpRpControlRequestVerify(0LL) )
          ...
          return (unsigned int)PfpRpControlRequestPerform(&unk_140C54598, 0LL);
      }
    }
  }
  else
