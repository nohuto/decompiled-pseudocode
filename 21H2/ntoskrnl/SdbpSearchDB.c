/*
 * XREFs of SdbpSearchDB @ 0x14075BB10
 * Callers:
...
__int64 __fastcall SdbpSearchDB(int a1, void *a2, __int64 a3, __int64 a4, unsigned int *a5, int a6)
{
  ...
  {
    for ( i = SdbpFindFirstIndexedWildCardTag(a2, 28679LL, v12, Str1, (unsigned int *)v31);
          i;
          i = SdbpFindNextIndexedWildCardTag(a2, v31) )
    {
...
LABEL_42:
  ...
  if ( (unsigned int)SdbGetIndex(a2) )
  {
    for ( j = SdbpFindFirstIndexedWildCardTag(a2, 28679LL, v17, v30, (unsigned int *)v31);
          j;
          j = SdbpFindNextIndexedWildCardTag(a2, v31) )
    {
...
LABEL_7:
  if ( v9 > 0x10 || (v13 = v9) != 0 )
  {
    ...
    {
LABEL_15:
      v20 = SdbFindFirstTag(a2, *v6, 24582LL);
      if ( v20 )
