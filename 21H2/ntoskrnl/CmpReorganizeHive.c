/*
 * XREFs of CmpReorganizeHive @ 0x14068B1C8
 * Callers:
...
__int64 __fastcall CmpReorganizeHive(ULONG_PTR BugCheckParameter3, __int128 *a2, int a3)
{
  __int64 v3; // rax
  int v6; // ecx
  __int64 v8; // r13
...
LABEL_29:
    if ( (unsigned int)dword_140C03868 > 5 && tlgKeywordOn((__int64)&dword_140C03868, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140029A28,
        0LL,
        0LL,
        4u,
        &v106);
  ...
  if ( v14 == 2 || v14 != 1 && (*(_DWORD *)(BugCheckParameter3 + 4112) & 0x400) == 0 )
  {
    v45.LowPart = v13 | 2;
...
LABEL_12:
  ...
  v45.LowPart = v13 | 1;
  v10 = CmpCreateEmptyHiveClone(&v49, BugCheckParameter3);
  if ( v10 < 0 )
  {
LABEL_77:
    v20 = v49;
  ...
  v20 = v49;
  v10 = CmpCopyKeyPartial(BugCheckParameter3, 6, v44, 0, (__int64)&v50);
  if ( v10 >= 0 )
  {
    v21 = v50;
    *(_DWORD *)(*(_QWORD *)(v20 + 64) + 36LL) = v50;
    HvMarkBaseBlockDirty(v20);
    v10 = CmpCopySyncTree(BugCheckParameter3, *(_DWORD *)(*(_QWORD *)(BugCheckParameter3 + 64) + 36LL), v20, v21, 66, 0);
    if ( v10 >= 0 )
    {
      TransientPoolWithTag = CmpAllocateTransientPoolWithTag(PagedPool, 0x1B0uLL, 0x33394D43u, v22);
      v8 = (__int64)TransientPoolWithTag;
      ...
      v10 = CmCheckRegistry(v20, 983040, v8);
      if ( v10 >= 0 )
      {
          ...
          || *(_DWORD *)(BugCheckParameter3 + 4764) == *(_DWORD *)(v20 + 4764) )
        {
          *(_QWORD *)(v20 + 56) = 0LL;
          ...
          if ( (unsigned int)dword_140C03868 > 5 && tlgKeywordOn((__int64)&dword_140C03868, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C03868,
              (unsigned __int8 *)word_140029AD2,
              0LL,
              0LL,
              6u,
              &v90);
          ...
          *(LARGE_INTEGER *)(*(_QWORD *)(BugCheckParameter3 + 64) + 168LL) = v45;
          ...
          CmpLogReorganizeEvent(v58, v38, v37);
          if ( v37 < v38 )
          {
            if ( CmpFirstReorganize )
            {
              CmpReorganizeTotalBytesSaved = 0LL;
              CmpReorganizeLastRun = v45;
              CmpFirstReorganize = 0;
            }
            CmpReorganizeTotalBytesSaved += v38 - v37;
        ...
        else
        {
          if ( (unsigned int)dword_140C03868 > 5 && tlgKeywordOn((__int64)&dword_140C03868, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C03868,
              (unsigned __int8 *)word_140029A6A,
              0LL,
              0LL,
              5u,
              &v99);
      ...
      else
      {
        if ( (unsigned int)dword_140C03868 > 5 && tlgKeywordOn((__int64)&dword_140C03868, 0x400000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            (__int64)&dword_140C03868,
            (unsigned __int8 *)byte_140029B28,
            0LL,
            0LL,
            0xDu,
            &v64);
