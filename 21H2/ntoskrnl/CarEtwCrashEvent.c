/*
 * XREFs of CarEtwCrashEvent @ 0x140602478
 * Callers:
...
char CarEtwCrashEvent()
{
  ...
  if ( CarLogInitialized )
  {
    if ( dword_140C090C0 )
    {
      result = tlgKeywordOn((__int64)&dword_140C090C0, 0x800000000000LL);
      if ( result )
      {
        if ( v2 > 5 )
        {
          result = tlgKeywordOn((__int64)&dword_140C090C0, v1);
          if ( result )
          {
            v8 = 0;
            v16 = 0;
            ...
            return tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)byte_140034378,
                     0LL,
                     0LL,
                     0xBu,
                     &v13);
