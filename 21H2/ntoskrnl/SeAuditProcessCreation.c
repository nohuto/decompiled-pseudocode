/*
 * XREFs of SeAuditProcessCreation @ 0x140847BB4
 * Callers:
...
void __fastcall SeAuditProcessCreation(struct _EX_RUNDOWN_REF *a1, unsigned __int16 *a2)
{
  char v3; // si
  ...
  Count = a1[136].Count;
  v29 = Ptr;
  AllocatedFullProcessImageName = PsGetAllocatedFullProcessImageNameEx((__int64)a1, &P);
  if ( AllocatedFullProcessImageName >= 0 )
  {
    ...
    else
    {
      ...
      if ( Process[1].ActiveProcessors.StaticBitmap[2] )
        PsGetAllocatedFullProcessImageNameEx((__int64)Process, &v25);
      else
        v5 = 1844;
