/*
 * XREFs of PopFxComponentRelationsCleanup @ 0x1403B9594
 * Callers:
...
LABEL_30:
  ...
  while ( (unsigned __int8)PopFxNextComponentParentRelationSafe(a1, 0LL, &P) )
  {
    v13 = (char *)P;
    v14 = *((_QWORD *)P + 3);
    PopFxIdleComponent(*(_QWORD *)(v14 + 80), *(unsigned int *)(v14 + 16), 2);
    ...
    *((_QWORD *)v13 + 8) = v13 + 56;
    *v15 = v15;
    if ( KxTryToAcquireSpinLock((volatile signed __int32 *)(v14 + 128)) )
    {
      *((_DWORD *)v13 + 4) &= ~4u;
      v18 = v13 + 32;
      *((_QWORD *)v13 + 3) = 0LL;
      ...
      *((_QWORD *)v13 + 5) = v13 + 32;
      *v18 = v18;
      KxReleaseSpinLock((PKSPIN_LOCK)(v14 + 128));
      v21 = 1;
    }
    else
    {
    ...
    KxReleaseSpinLock((PKSPIN_LOCK)v13 + 1);
    if ( v21 )
