/*
 * XREFs of HalpInitializeConfigurationFromMadt @ 0x140AFA320
 * Callers:
...
LABEL_20:
    ...
    v26 = v5 * (v21 - 1);
    v27 = 0LL;
    *(_DWORD *)(*(_QWORD *)(HalpNumaConfig + 40) + 4 * v25 - 4) = v1 - v26;
    if ( v1 )
    {
      v11 = 0LL;
      do
    ...
    return HalpChannelInitializeStaticConfiguration(v25, v30, v27, v11);
  }
  return result;
}
