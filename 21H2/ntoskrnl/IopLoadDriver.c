/*
 * XREFs of IopLoadDriver @ 0x140740868
 * Callers:
...
__int64 __fastcall IopLoadDriver(HANDLE Handle, char a2, unsigned __int8 a3, int *a4)
{
  ...
  *(_DWORD *)v41 = 0;
  ...
  v44 = 0;
  v8 = NtQueryKey(Handle, 0, 0LL, 0, &v39);
  if ( v8 != -1073741789 && v8 != -2147483643 )
  {
    DriverNameFromKeyNode = -1073741472;
    goto LABEL_35;
  }
  if ( (int)v39 + 8 < (unsigned int)v39 )
  {
    DriverNameFromKeyNode = -1073741675;
    goto LABEL_35;
  }
  P = IopVerifierExAllocatePool(NonPagedPoolNx, (unsigned int)(v39 + 8));
  ...
  DriverNameFromKeyNode = NtQueryKey(Handle, 0, P, v39, &v39);
  if ( DriverNameFromKeyNode >= 0 )
  {
    ...
    if ( Pool )
    {
      v40.Length = Destination.Length;
      v40.MaximumLength = Destination.Length + 2;
      ...
      PnpDiagnosticTraceObject(&KMPnPEvt_DriverLoad_Start, &v40.Length);
      ...
      DriverNameFromKeyNode = IopBuildFullDriverPath(&v40, Handle, &Destination);
      if ( DriverNameFromKeyNode >= 0 )
      {
...
LABEL_53:
          ...
          else
          {
            ...
            *(_WORD *)&v41[2] = *(_WORD *)(v14 + 68);
            DriverNameFromKeyNode = PnpPrepareDriverLoading((int)&v40, Handle, v43, v5, &v44);
            if ( DriverNameFromKeyNode < 0
              ...
              *((_DWORD *)v16 + 8) = *(_DWORD *)(v17 + 80);
              ...
              if ( DriverNameFromKeyNode >= 0 )
              {
                ...
                *((_QWORD *)v50 + 9) = &CmRegistryMachineHardwareDescriptionSystemName;
                v23 = IopVerifierExAllocatePool(NonPagedPoolNx, v42.MaximumLength);
                *((_QWORD *)v22 + 8) = v23;
                if ( v23 )
                {
                ...
                if ( v24 )
                {
                  ...
                  else
                  {
                    ...
                    if ( v40.Buffer )
                    {
                      MaximumLength = v40.MaximumLength;
                      *(_QWORD *)(*((_QWORD *)v22 + 6) + 32LL) = IopVerifierExAllocatePool(
                      ...
                      if ( *(_QWORD *)(v26 + 32) )
                      {
                        ...
                        *(_WORD *)(*((_QWORD *)v22 + 6) + 24LL) = v40.Length;
        ...
        if ( RegistryValue >= 0 )
        {
            ...
            && (unsigned int)(*(_DWORD *)((char *)v53 + *((unsigned int *)v53 + 2)) - 2) <= 1 )
          {
            if ( ((unsigned __int64)&Destination & -(__int64)(Destination.Buffer != 0LL)) != 0 )
              v35 = *(_QWORD *)(((unsigned __int64)&Destination & -(__int64)(Destination.Buffer != 0LL)) + 8);
            else
              v35 = 0LL;
            if ( ((unsigned __int64)&v42 & -(__int64)(v42.Buffer != 0LL)) != 0 )
              v4 = *(_QWORD *)(((unsigned __int64)&v42 & -(__int64)(v42.Buffer != 0LL)) + 8);
            KeBugCheckEx(0x5Au, 1uLL, v4, v35, DriverNameFromKeyNode);
          }
