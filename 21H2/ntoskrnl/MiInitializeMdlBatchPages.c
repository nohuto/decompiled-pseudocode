/*
 * XREFs of MiInitializeMdlBatchPages @ 0x1402655A0
 * Callers:
...
LABEL_13:
  ...
  if ( (*(_DWORD *)(v14 + 8) & 0x80000200) != 0 )
    ...
    v16 = MiSwizzleInvalidPte(128LL, v3);
  ...
  if ( v6 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)v20 = v19 | v22;
      ...
      {
        MiConvertLargePfnToSmall(v20, v20, v1, 1LL);
        v23 = *(_QWORD *)(v20 + 40);
        v1 = 0LL;
      }
      *(_QWORD *)(v20 + 8) = 0xFFFFF68000000000uLL;
      ...
      *(_QWORD *)v20 = v19;
      ...
      else
      {
        ...
        *(_QWORD *)(v20 + 8) = v27;
        ...
        if ( (v24 & 0x200) != 0 )
        {
          MiAbortCombineScan(v20, 0xFFFFF68000000000uLL);
          MiSetPfnIdentity(v20, 3LL);
          if ( (v24 & 0x20000) == 0 )
