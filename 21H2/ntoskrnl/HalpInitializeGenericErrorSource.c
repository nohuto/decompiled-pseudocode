/*
 * XREFs of HalpInitializeGenericErrorSource @ 0x140A5AC18
 * Callers:
 *     HalpInitializeErrSrc @ 0x140A5A680 (HalpInitializeErrSrc.c)
 * Callees:
 *     MmMapIoSpaceEx @ 0x140215340 (MmMapIoSpaceEx.c)
 *     HalpRegisterPeiErrorSource @ 0x14051BE58 (HalpRegisterPeiErrorSource.c)
...
__int64 __fastcall HalpInitializeGenericErrorSource(int a1, __int64 a2)
{
  ...
  if ( !*(_BYTE *)(a2 + 64) )
  {
    ...
    *((_QWORD *)P + 2) = MEMORY[0xFFFFF78000000320];
    ...
    if ( *(__int64 **)qword_140C4BC48 == &HalpGenericPolledErrorSourceListHead )
    {
    ...
    switch ( *(_BYTE *)(a2 + 64) )
    {
      case 8:
        ...
        if ( v20 >= 0 )
        {
          ...
          if ( *(__int64 **)qword_140C4BB28 != &HalpGenericSeaErrorSourceListHead )
            goto LABEL_57;
          v22 = P;
      ...
      case 9:
        ...
        if ( v17 >= 0 )
        {
          ...
          if ( *(__int64 **)qword_140C4BB18 != &HalpGenericSeiErrorSourceListHead )
            goto LABEL_57;
          v19 = P;
      ...
      case 0xA:
        ...
        if ( *(__int64 **)qword_140C4BB08 == &HalpGenericPeiErrorSourceListHead )
        {
...
LABEL_16:
  ...
  if ( *v6 != -1 )
  {
    ...
    if ( v7 )
    {
      ...
      if ( *(__int64 **)qword_140C4BC68 == &HalpGenericNmiErrorSourceListHead )
      {
