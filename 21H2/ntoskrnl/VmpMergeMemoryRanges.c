/*
 * XREFs of VmpMergeMemoryRanges @ 0x1405A4570
 * Callers:
 *     VmMergeMemoryRanges @ 0x14092F1D0 (VmMergeMemoryRanges.c)
 * Callees:
 ...
 *     VmpVaRangeNumberOfGpaRanges @ 0x1405A5800 (VmpVaRangeNumberOfGpaRanges.c)
