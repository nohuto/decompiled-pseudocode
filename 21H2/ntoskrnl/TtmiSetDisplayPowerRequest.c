/*
 * XREFs of TtmiSetDisplayPowerRequest @ 0x1409A4E68
 * Callers:
...
__int64 __fastcall TtmiSetDisplayPowerRequest(__int64 a1, unsigned int *a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( a4 )
  {
    if ( !(unsigned __int8)TtmpFindPowerRequestEntryById(a1, a3, &v27) )
    {
      v9 = 818LL;
LABEL_28:
      v4 = -1073741275;
    ...
    {
      if ( (int)TtmiGetTerminalById(v28, a1, *(_DWORD *)(i - 8)) >= 0 && *(_DWORD *)(v28[0] + 28LL) == a2[7] )
      {
        v4 = -1073741270;
        v9 = 861LL;
        goto LABEL_29;
  ...
  for ( j = *(_QWORD *)(v27 + 48); ; j = *v21 )
  {
    ...
    if ( (int)TtmiGetTerminalById(v28, a1, *(_DWORD *)(j - 8)) >= 0 && *(_DWORD *)(v28[0] + 28LL) == a2[7] )
      break;
  }
  v23 = *v21;
...
LABEL_29:
    ...
    v15 = v4;
LABEL_30:
    TtmiLogError("TtmiSetDisplayPowerRequest", v9, v15, v16);
  }
LABEL_31:
