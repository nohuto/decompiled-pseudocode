/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x140645650
 * Callers:
 *     IoUpdateShareAccess @ 0x1407738C0 (IoUpdateShareAccess.c)
 *     IoUpdateLinkShareAccess @ 0x140894020 (IoUpdateLinkShareAccess.c)
 * Callees:
 *     <none>
 */
