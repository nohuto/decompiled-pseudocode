/*
 * XREFs of IoUpdateLinkShareAccessEx @ 0x140650830
 * Callers:
 *     IoUpdateShareAccess @ 0x140773700 (IoUpdateShareAccess.c)
 *     IoUpdateLinkShareAccess @ 0x140893EC0 (IoUpdateLinkShareAccess.c)
 * Callees:
 *     <none>
 */
