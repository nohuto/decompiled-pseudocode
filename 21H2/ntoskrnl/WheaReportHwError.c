/*
 * XREFs of WheaReportHwError @ 0x1405BB130
 * Callers:
 ...
 *     WheapGetWheaInfo @ 0x1405BAE20 (WheapGetWheaInfo.c)
 *     WheapAddToDumpFile @ 0x1405BB608 (WheapAddToDumpFile.c)
 *     WheapAllocErrorRecord @ 0x1405BB64C (WheapAllocErrorRecord.c)
 *     WheapApplyThresholdChecks @ 0x1405BB6E0 (WheapApplyThresholdChecks.c)
