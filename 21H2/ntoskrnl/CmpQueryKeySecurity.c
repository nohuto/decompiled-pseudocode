/*
 * XREFs of CmpQueryKeySecurity @ 0x14065A180
 * Callers:
...
__int64 __fastcall CmpQueryKeySecurity(_QWORD *a1, DWORD *a2, void *a3, ULONG *a4, __int64 a5)
{
  ...
  v14 = ExAcquireRundownProtection((PEX_RUNDOWN_REF)&CmpShutdownRundown);
  if ( v14 )
  {
    CmpLockRegistry();
    v5 = 1;
    ...
    if ( a1[7] || a1[8] )
    {
      ...
      if ( started < 0 || (v17 = a5, started = CmpPerformKeyBodyDeletionCheck(a1, a5), started < 0) )
      {
LABEL_9:
    ...
    ObjectsSecurityDescriptor = (PSECURITY_DESCRIPTOR)(CmpGetSecurityCacheEntryForKcbStack(&v24, v17, 0LL) + 32);
