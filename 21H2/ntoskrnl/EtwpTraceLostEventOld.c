/*
 * XREFs of EtwpTraceLostEventOld @ 0x14041A410
 * Callers:
        ...
        char a8)
{
  ...
  *(_OWORD *)Src = 0LL;
  v14 = 0LL;
  v24[0] = 0;
  if ( *a1 != *(_QWORD *)&EventTracingProvGuid.Data1 || a1[1] != *(_QWORD *)EventTracingProvGuid.Data4 )
  {
    v15 = 0;
    v28 = 0;
    while ( v15 < a5 )
    ...
    if ( v14 && Pool2 )
    {
      EventNameFromEventMetadata = EtwpGetEventNameFromEventMetadata(Pool2, *((unsigned int *)v14 + 2), &v25, v10);
      v12 = v25;
    }
    ...
    *(_QWORD *)&UserData.Size = 16LL;
    ...
    {
      v35 = (__int16 *)EventNameFromEventMetadata;
      v36 = v12;
      v37[0] = &EtwpNull;
      v37[1] = 1LL;
      UserDataCount = 6;
    ...
    *(_QWORD *)v22 = &EtwpNull;
    *((_QWORD *)v22 + 1) = 2LL;
    v23 = &ETW_EVENT_LOST_EVENT;
    if ( v12 )
      v23 = &ETW_EVENT_LOST_TLG_EVENT;
    EtwWriteEx(EtwpEventTracingProvRegHandle, v23, 0LL, 1u, 0LL, 0LL, UserDataCount, &UserData);
    if ( v24[0] )
