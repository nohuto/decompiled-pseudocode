/*
 * XREFs of TtmiLogSessionPowerRequestDeleted @ 0x140904260
 * Callers:
...
void TtmiLogSessionPowerRequestDeleted()
{
  ...
  if ( (unsigned int)dword_140D2D8C8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8C8, 1LL) )
    {
      ...
      v6 = v2;
      v11 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8C8, (unsigned __int8 *)byte_14002B0F7, 0LL, 0LL, 5u, &v7);
    }
  }
}
