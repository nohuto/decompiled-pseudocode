/*
 * XREFs of DifKeRemoveDeviceQueueWrapper @ 0x140614FF0
 * Callers:
 *     <none>
 * Callees:
...
PKDEVICE_QUEUE_ENTRY __fastcall DifKeRemoveDeviceQueueWrapper(PKDEVICE_QUEUE DeviceQueue)
{
  ...
  PKDEVICE_QUEUE_ENTRY v14; // [rsp+30h] [rbp-18h]
  __int64 retaddr; // [rsp+48h] [rbp+0h]

  v13 = 0LL;
  v14 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(290);
