/*
 * XREFs of EtwpCovSampCaptureSample @ 0x1405AF1D8
 * Callers:
 *     EtwpCovSampProfileInterrupt @ 0x1405AF5C0 (EtwpCovSampProfileInterrupt.c)
 ...
 * Callees:
 *     EtwpCovSampCaptureBufferAddIP @ 0x1405AE598 (EtwpCovSampCaptureBufferAddIP.c)
