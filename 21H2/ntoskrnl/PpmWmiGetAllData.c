/*
 * XREFs of PpmWmiGetAllData @ 0x1408F194C
 * Callers:
    ...
    *(_DWORD *)(a4 + 60) = v17;
    ...
    if ( v26 || !v15 )
    {
      ...
      if ( v27 || !*a1 )
      {
        ...
        if ( !v33 && v15 )
          PpmPerfGetCurrentState((__int64)(a1 - 4096), (unsigned __int64)v23, 0LL, v23 + 2, v23 + 1, 0LL);
      }
      else
      {
    ...
    {
      *v23 = 0;
      v23[1] = *(_DWORD *)(v15 + 316);
      *((_QWORD *)v23 + 1) = 0LL;
      *((_QWORD *)v23 + 2) = 0LL;
      *((_BYTE *)v23 + 28) = 100;
      *((_BYTE *)v23 + 29) = *(_BYTE *)(v15 + 353);
      v23[8] = HIDWORD(PpmCurrentProfile[342 * dword_140C2332C + 7]);
