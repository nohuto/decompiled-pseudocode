/*
 * XREFs of PopDirectedDripsDiagQueryAndResetPnpAccounting @ 0x140396E7C
 * Callers:
...
__int64 __fastcall PopDirectedDripsDiagQueryAndResetPnpAccounting(__int64 a1, _QWORD *a2, __int128 *a3, _OWORD *a4)
{
  ...
  v10 = v7;
  if ( byte_140C1CC10 )
    PopDirectedDripsDiagPnpActionQueueAccountingUpdateUnsafe(v8, 0LL);
  ...
  *v12 = xmmword_140C1CC30[8];
  ...
  {
    LOBYTE(v13) = 1;
    PopDirectedDripsDiagPnpActionQueueAccountingUpdateUnsafe(v14, v13);
  }
