/*
 * XREFs of SepNormalAccessCheckEx @ 0x14038473C
 * Callers:
 ...
 *     AuthzBasepSetAccessReasons @ 0x14022D300 (AuthzBasepSetAccessReasons.c)
...
LABEL_47:
                v36 = v23 + 2;
                SepMatchCapability(a2, a7, v29, *((_DWORD *)v26 + 1), (_BYTE *)v23 + 22, v23 + 2);
LABEL_48:
                v37 = ~*v36;
                v15 &= v37;
                *v23 &= v37;
...
LABEL_21:
            v31 = v26 + 8;
LABEL_22:
            if ( SepSidInTokenSidHash(v14 + v30, 0LL, v31, 0, v24, a12) )
              AuthzBasepAddAccessTypeList(v20, v17, 0, v25, *((_DWORD *)v26 + 1), 0);
            goto LABEL_24;
          }
          if ( v28 != 9 )
            goto LABEL_24;
        ...
        switch ( v28 )
        {
              ...
              if ( v26 != (char *)-12LL )
              {
                if ( a10
                  && SepSidInTokenSidHash(
                       a2 + (-(__int64)(v24 != 0) & 0x110) + 232,
                       0LL,
                       &v26[16 * (v35 & 1) + ((8LL * (v35 & 2)) | 0xC)],
                       0,
                       v24,
                       a12)
                  && (unsigned __int8)AuthzBasepObjectInTypeList(v26 + 12, v20, v17, &v63) )
                {
                  AuthzBasepAddAccessTypeList(v20, v17, v63, v25, *((_DWORD *)v26 + 1), 0);
                }
                goto LABEL_49;
              }
              v14 = a2;
          ...
          case 4:
            ...
            if ( SepSidInTokenSidHash(v38 + a2, 0LL, &v26[4 * (unsigned __int8)v26[13] + 20], 0, v24, a12)
              && SepSidInTokenSidHash(v38 + a3, 0LL, v26 + 12, 0, v24, a12) )
            {
              AuthzBasepAddAccessTypeList(v20, v17, 0, v25, *((_DWORD *)v26 + 1), 0);
            }
            goto LABEL_49;
...
LABEL_58:
            if ( SepSidInTokenSidHash(v14 + v39, 0LL, v26 + 8, 1, v24, a12)
              && (*(_DWORD *)(v20 + 24) & *((_DWORD *)v26 + 1)) != 0 )
            {
              return AuthzBasepSetAccessReasons(
                       *(_DWORD *)(v20 + 24) & *((_DWORD *)v26 + 1),
                       0x20000,
                       v25,
                       *(_QWORD *)(v20 + 40),
                       0);
          ...
          case 6:
            ...
            {
              if ( !(unsigned __int8)AuthzBasepObjectInTypeList(v26 + 12, v20, v17, &v63) )
                break;
