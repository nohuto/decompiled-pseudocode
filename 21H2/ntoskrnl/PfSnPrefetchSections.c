/*
 * XREFs of PfSnPrefetchSections @ 0x1407D7100
 * Callers:
...
__int64 __fastcall PfSnPrefetchSections(__int64 *a1, WORK_QUEUE_TYPE a2, int a3, __int64 a4, __int64 a5)
{
  ...
  *(_OWORD *)&RunRef_8[0].Count = 0LL;
  ...
  v32 = 0LL;
  v33 = 0LL;
  if ( v8 && qword_140C54788 && EtwEventEnabled(qword_140C54788, &PfSnEvt_PrefetchSections_Start) )
  {
    v22 = -1LL;
    do
      ++v22;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v45 = 4LL;
    v47 = 1LL;
    EtwWrite(qword_140C54788, &PfSnEvt_PrefetchSections_Start, 0LL, 7u, &UserData);
    v11 = *v5;
  }
...
LABEL_8:
  ...
  *(_QWORD *)&v32 = RunRef;
  RunRef_8[1].Count = (unsigned __int64)v5;
  LODWORD(v33) = v13;
  ...
  if ( v13 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)(v16 - 5) = v16 - 11;
      ExAcquireRundownProtection(RunRef_8);
  ...
  else
  {
    ...
    if ( DWORD1(v33) )
    {
      v19 = MmPrefetchPagesEx(DWORD2(v32), (__int64)v28, (__int64)(v5 + 13));
      if ( v19 >= 0 && !v5[13] )
        v19 = -2147483622;
    }
    else
  ...
  if ( v9 > 0x20 )
    v20 = 32LL;
  PfSnPrefetchSectionsCleanup(v29, v9, v20, RunRef);
LABEL_23:
  LODWORD(v28) = v9;
  LODWORD(v27) = v26;
  v29 = v10;
  LOBYTE(v23) = 0;
  QueueType = v7;
  if ( v8 && qword_140C54788 && EtwEventEnabled(qword_140C54788, &PfSnEvt_PrefetchSections_Stop) )
  {
    do
      ++v6;
    ...
    *(_QWORD *)&UserData.Size = 2LL;
    ...
    v49 = 8LL;
    v51 = 4LL;
    EtwWrite(qword_140C54788, &PfSnEvt_PrefetchSections_Stop, 0LL, 9u, &UserData);
  }
