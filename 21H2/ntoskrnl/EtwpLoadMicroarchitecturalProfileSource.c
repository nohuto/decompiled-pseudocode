/*
 * XREFs of EtwpLoadMicroarchitecturalProfileSource @ 0x1409E1514
 * Callers:
...
__int64 __fastcall EtwpLoadMicroarchitecturalProfileSource(const WCHAR *a1, unsigned __int16 *a2, const wchar_t *a3)
{
  ...
  v39 = 4;
  v40 = &v18;
  result = RtlpQueryRegistryValues(0x40000000, a1, (__int64)v41, 0LL);
  if ( (int)result < 0 )
    return result;
  if ( v11 == -1 || v12 == -1 )
    return 3221225473LL;
  ...
  *((_DWORD *)v9 + 2) = v19;
  ((void (__fastcall *)(__int64, _QWORD, char *))off_140C020E0[0])(20LL, 2 * v6 + 280, v9);
