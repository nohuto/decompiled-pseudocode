/*
 * XREFs of KiRundownMutants @ 0x140277650
 * Callers:
...
void *__fastcall KiRundownMutants(ULONG_PTR BugCheckParameter1)
{
  ...
  char v49; // [rsp+38h] [rbp-160h]
  struct _KPRCB *v50; // [rsp+40h] [rbp-158h]
  ...
  result = memset(v54, 0, sizeof(v54));
  v53 = 0LL;
      ...
      if ( v17 != v14 + 2 )
      {
        while ( 1 )
        {
          ...
          *((_QWORD *)v29 + 1) = v31;
          ...
          if ( v32 == 1 )
          {
            if ( (unsigned __int8)KiTryUnwaitThread(CurrentPrcb, v30, *(unsigned __int16 *)(v30 + 18), &v53) )
            {
              v33 = (*((_DWORD *)v14 + 1))-- == 1;
              if ( v33 )
                goto LABEL_75;
          ...
          else
          {
            ...
            if ( v32 == 2 )
            {
              ...
              *(_QWORD *)v30 = 0LL;
              ...
              {
                LOBYTE(v40) = KeIsThreadRunning(v38->CurrentThread);
              ...
              if ( (_QWORD *)*v36 == v36
                ...
                || !KiWakeQueueWaiter((__int64)v38, v35, v30, (__int64)SchedulerAssist) )
              {
                ...
                *(_QWORD *)(v35 + 32) = v30;
                if ( !(_DWORD)v4 && (_QWORD *)*v36 != v36 )
                  KiWakeOtherQueueWaiters((__int64)v38, v35);
              }
...
LABEL_75:
      ...
      {
        CurrentIrql = v49;
        KiExitDispatcher((_DWORD)v50, 0, 1, 1, v49);
        if ( v7 )
        {
          v42 = v54;
          v43 = v7;
  ...
  if ( v7 )
  {
    ...
    do
    {
      result = (void *)KeAbPostRelease(*v45++);
      --v46;
    }
    while ( v46 );
  }
