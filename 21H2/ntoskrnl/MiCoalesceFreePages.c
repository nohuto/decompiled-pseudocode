/*
 * XREFs of MiCoalesceFreePages @ 0x1402C7DF0
 * Callers:
...
LABEL_13:
  ...
  if ( *(_BYTE *)(CurrentThread + 792) )
    goto LABEL_14;
  v16 = KiAbTryReclaimOrphanedEntries((__int64)(v4 + 96), CurrentThread);
  v14 = (volatile signed __int64 *)(v4 + 96);
  if ( v16 )
  {
    CurrentThread = v77;
LABEL_14:
    ...
    *(_BYTE *)(CurrentThread + 792) = v16 & ~(1 << v17);
    ...
    {
      SessionId = MmGetSessionIdEx(*(_QWORD *)(CurrentThread + 184));
      v18 = v67;
      v14 = (volatile signed __int64 *)(v4 + 96);
    }
    else
  ...
  v18 = 0LL;
LABEL_17:
  if ( _InterlockedCompareExchange64(v14, 17LL, 0LL) && !ExfTryAcquirePushLockSharedEx((signed __int64 *)v14, 0) )
  {
    if ( v18 )
  ...
  while ( 1 )
  {
    if ( v5 == v1 )
    {
      v64 = (_QWORD *)(v5 + 16);
      if ( (*(_BYTE *)(v5 + 34) & 7) != 0 )
        MiSetOriginalPtePfnFromFreeList(v64, CurrentThread, v14);
      else
    ...
    if ( !(unsigned int)MiUnlinkFreeOrZeroedPage(v21) )
      break;
    v21 = v74;
  ...
  if ( v5 != v72 )
  {
    ...
    if ( v71 < v5 )
    {
      ...
      do
      {
        if ( v65 != v1 )
        {
          MiReturnFreeZeroPage(v65, 512LL);
...
LABEL_34:
  ...
  MiSetOriginalPtePfnFromFreeList(&v78, CurrentThread, v14);
LABEL_44:
  ...
  do
  {
    ...
    {
      MiChangePageAttribute(v27, v23, v30);
      v29 = v73;
      v25 = 0LL;
      v31 = v75;
      v23 = v69;
  ...
  while ( v29 < 0x10 );
  v34 = MiDetermineCoalescedLargePageHeatState();
  ...
  *((_QWORD *)&v80 + 1) = _mm_srli_si128((__m128i)xmmword_140C51E40, 8).m128i_u64[0] | 0x8000000000000000uLL;
  ...
  if ( !v34 )
    *(_QWORD *)&v80 = MiUpdatePageFileHighInPte(v80, 4294967293LL);
  ...
  {
    if ( v26 == v71 )
      MiInsertLargePageInNodeList((__int64)&v82);
    if ( v26 != v1 )
