/*
 * XREFs of NtCreateKeyTransacted_Stub @ 0x140A2D938
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( byte_140D04CB9 )
  {
    v8 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, PUNICODE_STRING, ULONG, HANDLE, PULONG))qword_140D04CD8;
  }
  else
  {
