/*
 * XREFs of NtCreateKeyTransacted_Stub @ 0x14097CB70
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( byte_140CFA4A9 )
  {
    v8 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, PUNICODE_STRING, ULONG, HANDLE, PULONG))qword_140CFA4B0;
  }
  else
  {
    v8 = ZwCreateKeyTransacted;
    byte_140CFA4A9 = 1;
    qword_140CFA4B0 = (__int64)ZwCreateKeyTransacted;
  }
  if ( v8 )
