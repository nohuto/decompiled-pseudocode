/*
 * XREFs of MiAllocatePfnRepurposeLogDispatch @ 0x14037B940
 * Callers:
 *     <none>
 * Callees:
...
void MiAllocatePfnRepurposeLogDispatch()
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  KxAcquireQueuedSpinLock((__int64)&LockHandle, (volatile __int64 *)&qword_140C4E880);
  v3 = P;
  if ( !dword_140C4E868 )
  {
LABEL_25:
...
LABEL_6:
  ...
  if ( v3 )
  {
    ...
    {
      RtlpInterlockedPushEntrySList(&stru_140CEC380, v3);
