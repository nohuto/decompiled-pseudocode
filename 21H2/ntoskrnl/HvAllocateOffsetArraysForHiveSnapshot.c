/*
 * XREFs of HvAllocateOffsetArraysForHiveSnapshot @ 0x1409220A0
 * Callers:
...
__int64 __fastcall HvAllocateOffsetArraysForHiveSnapshot(__int64 a1, unsigned int *a2, _QWORD *a3, unsigned int *a4)
{
