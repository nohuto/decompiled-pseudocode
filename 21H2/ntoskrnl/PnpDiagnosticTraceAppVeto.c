/*
 * XREFs of PnpDiagnosticTraceAppVeto @ 0x14056294C
 * Callers:
...
NTSTATUS __fastcall PnpDiagnosticTraceAppVeto(__int64 a1, int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v28 = 2 * v8;
  v29 = 0;
  return PnpDiagnosticTrace(&KMPnPEvt_DeviceEject_Pend, 7u, &UserData);
}
