/*
 * XREFs of HalpTimerRestartProfileInterrupt @ 0x14050DE34
 * Callers:
 *     HalpTimerProfilePowerChange @ 0x14050DDD8 (HalpTimerProfilePowerChange.c)
 *     DefaultRestartProfiling @ 0x140A61B10 (DefaultRestartProfiling.c)
 * Callees:
  ...
  if ( HalpProfileTimer )
  {
    ...
    if ( (*(_DWORD *)(HalpProfileTimer + 224) & 1) != 0 || !Number )
    {
      ...
      if ( v3 >= 0 )
      {
        ...
        {
          HalpSetTimer(v0, 2u, *(unsigned int *)(32LL * Number + HalpProfileData + 24), 1, &v5);
        }
        else
        {
