/*
 * XREFs of RtlStringCchCatExW @ 0x1403CB720
 * Callers:
 ...
 *     RtlStringLengthWorkerW @ 0x1403CB7AC (RtlStringLengthWorkerW.c)
 */
        ...
        ULONG dwFlags)
{
  ...
  if ( result >= 0 )
  {
    ...
    {
      result = RtlStringCopyWorkerW_2(&pszDest[pcchLength], cchDest - pcchLength, &pcchLength, v9, v10);
      if ( result >= 0 )
        return result;
    }
