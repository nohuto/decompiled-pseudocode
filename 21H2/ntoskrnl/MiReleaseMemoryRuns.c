/*
 * XREFs of MiReleaseMemoryRuns @ 0x14096AA38
 * Callers:
...
void __fastcall MiReleaseMemoryRuns(ULONG_PTR BugCheckParameter2, __int64 *a2, int a3)
{
  __int64 v3; // rdi
  __int64 v4; // rbx
  _QWORD *i; // r14
  ...
  for ( i = (_QWORD *)a2[2]; v3; --v3 )
  {
    ...
    do
    {
      ...
      else if ( MiHugeRangeIsZeroed(v4) )
      {
        v11 = 2;
      }
