/*
 * XREFs of PfpPrefetchRequestPerform @ 0x1406AE11C
 * Callers:
 ...
 *     PfpPrefetchRequestPatchOffsets @ 0x1406AF030 (PfpPrefetchRequestPatchOffsets.c)
  ...
  *(_QWORD *)(v29[5] + 24LL) = v29;
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( *(_BYTE *)(v29[0] + 81LL) )
    {
      ...
      v4 = PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140C54520, 0);
      if ( v4 < 0 )
      {
LABEL_55:
        _InterlockedDecrement(&dword_140CF5E58);
        PfpScenCtxPrefetchAbortSet((ULONG_PTR)&qword_140C54520, 0);
        goto LABEL_26;
      }
