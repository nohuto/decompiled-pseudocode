 ...
 *     WheapCountBadPageExtents @ 0x14095DC40 (WheapCountBadPageExtents.c)
 *     WheapIsPageInList @ 0x14095DC8C (WheapIsPageInList.c)
 *     WheapSortBadPages @ 0x14095DCB4 (WheapSortBadPages.c)
 *     BcdCreateObject @ 0x14096EDF8 (BcdCreateObject.c)
 *     BcdGetElementData @ 0x14096F608 (BcdGetElementData.c)
 *     BcdSetElementData @ 0x14096F628 (BcdSetElementData.c)
