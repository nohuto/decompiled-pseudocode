/*
 * XREFs of RtlStdInitializeStackDatabase @ 0x14091191C
 * Callers:
 *     RtlpInitializeStackTraceDatabase @ 0x140911A54 (RtlpInitializeStackTraceDatabase.c)
 * Callees:
...
__int64 __fastcall RtlStdInitializeStackDatabase(__int64 a1, __int64 a2, unsigned __int64 a3, _QWORD *a4)
{
  ...
  *(_QWORD *)(a1 + 136) = a1;
  ...
  v10 = (union _SLIST_HEADER *)(a1 + 208);
  v11 = a1 + v9;
  *(_QWORD *)(a1 + 160) = v11;
  *(_QWORD *)(a1 + 120) = v11;
  do
