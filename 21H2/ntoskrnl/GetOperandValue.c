/*
 * XREFs of GetOperandValue @ 0x1409D0A60
 * Callers:
 ...
 *     GetBinaryOperandLen @ 0x1409D07E0 (GetBinaryOperandLen.c)
    ...
    *(_BYTE *)(v18 + 1) = 80;
    if ( a1[1] )
    {
      while ( 1 )
      {
        ...
        if ( *v19 == 123 )
          goto LABEL_37;
        AttributeName = GetOperandValue((_DWORD)v19, 0, 0, (unsigned int)&v55, (__int64)v9, 0, 0, 0, 0);
        if ( AttributeName )
          goto LABEL_81;
        if ( a3 )
        {
...
LABEL_38:
  ...
  if ( !wcsnicmp(a1, L"SID", 3uLL) )
  {
    ...
    {
      v33 = a7 + 1;
      AttributeName = LocalGetSidForString(&a1[v33], &Sid, &v58, &a9);
      if ( AttributeName
        || (a7 = v33 + ((v58 - 2 * v33 - (__int64)a1) >> 1),
...
LABEL_41:
  ...
  if ( *a1 == 35 )
  {
    ...
    if ( a7 >= 2 )
    {
      ...
      *(_BYTE *)(v37 + 1) = 24;
      *(_DWORD *)(v37 + 4) = v38;
      v39 = SddlpAlloc((unsigned int)v38);
      *(_QWORD *)(*a4 + 8) = v39;
      if ( !v39 )
      {
LABEL_2:
...
LABEL_81:
      ...
      while ( v40 >= 1 )
      {
        if ( !GetDigitFromChar(a1[v40], &a6) || !GetDigitFromChar(a1[v41 - 1], &v60) )
          goto LABEL_2;
