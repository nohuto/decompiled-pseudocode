/*
 * XREFs of DifExfAcquirePushLockExclusiveWrapper @ 0x140609C80
 * Callers:
 *     <none>
 * Callees:
...
signed __int64 __fastcall DifExfAcquirePushLockExclusiveWrapper(unsigned __int64 *a1)
{
  __int64 v2; // rdx
  __int64 v3; // rcx
  ...
  v13 = 0LL;
  APIThunkContextById = DifGetAPIThunkContextById(79);
...
LABEL_18:
  result = ExfAcquirePushLockExclusiveEx(a1, 0LL, (__int64)a1);
  if ( APIThunkContextById )
  {
