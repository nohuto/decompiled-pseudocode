/*
 * XREFs of MiLogProcessWorkingSetsStop @ 0x1402A1948
 * Callers:
...
void __fastcall MiLogProcessWorkingSetsStop(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(*(_QWORD *)&qword_140C53448, 1LL, a3, a4) )
    {
      v8 = v7[2112];
      v17 = 0;
      v20 = 0;
      ...
      v19 = 8;
      v22 = 8;
      tlgWriteEx_EtwWriteEx(v6, (unsigned __int8 *)&byte_14002CE7D, v5, v4, v9, v10, 5u, &v14);
    }
  }
}
