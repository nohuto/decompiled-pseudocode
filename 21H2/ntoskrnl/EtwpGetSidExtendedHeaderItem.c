/*
 * XREFs of EtwpGetSidExtendedHeaderItem @ 0x14066A21C
 * Callers:
...
void *__fastcall EtwpGetSidExtendedHeaderItem(__int64 a1)
{
  ...
  v3 = (void *)PsReferenceEffectiveToken(CurrentThread, 1953654867LL, &v12, v11, v13, 0LL);
  v4 = v12;
  v5 = v3;
  if ( v12 == 2 && v13[0] < 2 )
  {
    ...
    v5 = (void *)PsReferencePrimaryTokenWithTag((__int64)CurrentThread->Process, 0x746C6644u);
    v4 = 1;
  }
  ...
  if ( v4 == 1 )
  {
    ObFastDereferenceObject(
      (signed __int64 *)&CurrentThread->Process[1].Affinity.StaticBitmap[5],
      (unsigned __int64)v5,
      0x74726853u);
  }
  else if ( v5 )
