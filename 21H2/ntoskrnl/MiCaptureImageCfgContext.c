/*
 * XREFs of MiCaptureImageCfgContext @ 0x140706680
 * Callers:
...
LABEL_59:
  ...
  memmove(Pool, (const void *)(v26 + a3), v28);
  v31 = 0;
  MiLogRelocationRva((unsigned int)v26, (unsigned int)v27, a2, a1);
  v32 = 0;
  if ( (_DWORD)v27 )
  {
    while ( 1 )
