/*
 * XREFs of PopFanUpdateSpeed @ 0x140999610
 * Callers:
 ...
 *     PopFanFindBucketIndex @ 0x140999154 (PopFanFindBucketIndex.c)
...
LABEL_24:
    if ( (unsigned int)dword_140C03A00 > 5 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&word_14003141E,
        0LL,
        0LL,
        7u,
        &v27);
...
LABEL_13:
    if ( dword_140C2230C != v5 )
    {
      if ( (unsigned int)dword_140C03A00 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C03A00,
          (unsigned __int8 *)&word_1400316C6,
          0LL,
          0LL,
          5u,
          v20);
  ...
  else if ( (unsigned int)dword_140C03A00 > 2 )
  {
    ...
    v23 = &v13;
    v24 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)&dword_1400313C4, 0LL, 0LL, 4u, v20);
  }
  ...
  if ( (unsigned int)dword_140C03A00 > 5 )
  {
    ...
    v42 = 4LL;
    v44 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C03A00, (unsigned __int8 *)byte_140031493, 0LL, 0LL, 5u, &v38);
    goto LABEL_24;
  }
  return v4;
}
