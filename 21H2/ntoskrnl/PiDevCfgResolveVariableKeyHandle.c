/*
 * XREFs of PiDevCfgResolveVariableKeyHandle @ 0x140805024
 * Callers:
...
LABEL_34:
  ...
  if ( (_DWORD)v14 )
  {
    v16 = CmOpenDeviceRegKey(*(__int64 *)&PiPnpRtlCtx, *(_QWORD *)(v15 + 48), v14, 0, 131097, 0, (__int64)&Handle, 0LL);
LABEL_10:
    DeviceRegProp = v16;
    if ( v16 < 0 )
      goto LABEL_15;
  ...
  DeviceRegProp = PnpCtxOpenContextBaseKey(v12, v20, v14, 131097, (__int64)&Handle);
  if ( DeviceRegProp < 0 )
    goto LABEL_15;
  if ( v21 )
  {
      ...
      if ( *v23 )
      {
        do
        {
          ...
          if ( *v27 == 36 )
          {
            ...
            v35 = PiDevCfgResolveVariable((__int64)v71, v27 + 1, v34);
            DeviceRegProp = v35;
            if ( v35 < 0 )
            {
              if ( v35 != -1073741772 )
...
LABEL_22:
  ...
  LODWORD(P) = 0;
  PnpRegSzToString(v58, v57, (int *)&P);
