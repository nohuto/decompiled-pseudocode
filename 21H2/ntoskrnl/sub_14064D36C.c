/*
 * XREFs of sub_14064D36C @ 0x14064D36C
 * Callers:
 *     WbHeapExecuteCall @ 0x14064D638 (WbHeapExecuteCall.c)
 * Callees:
 *     RtlULongAdd @ 0x140200578 (RtlULongAdd.c)
 *     ?RtlULongMult@@YAJKKPEAK@Z @ 0x1405C0824 (-RtlULongMult@@YAJKKPEAK@Z.c)
 *     sub_14064D450 @ 0x14064D450 (sub_14064D450.c)
 *     WbReAlloc @ 0x14068837C (WbReAlloc.c)
 */

NTSTATUS __fastcall sub_14064D36C(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
