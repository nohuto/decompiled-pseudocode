/*
 * XREFs of CarEtwRegister @ 0x140602644
 * Callers:
...
NTSTATUS CarEtwRegister()
{
  ...
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_140C090C0);
  ...
  if ( result >= 0 )
  {
    if ( dword_140C090C0 && tlgKeywordOn((__int64)&dword_140C090C0, 0x800000000000LL) && v3 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_140C090C0, 0x400000000000LL) )
      {
        v13 = 0;
        v9 = 0LL;
        v16 = 0;
        ...
        tlgCreate1Sz_wchar_t((__int64)v18, L"NA");
        v6 = 0;
        v21 = 0;
        v24 = 0;
        v27 = 0;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&dword_1400343FC,
          0LL,
          0LL,
          9u,
          &v10);
