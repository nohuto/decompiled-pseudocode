/*
 * XREFs of KiSwInterruptDispatch @ 0x1403EBF10
 * Callers:
 *     KiSwInterrupt @ 0x140427360 (KiSwInterrupt.c)
 * Callees:
 *     KeExitRetpoline @ 0x14024B6F8 (KeExitRetpoline.c)
 *     KiGetTrapFrameMode @ 0x1403A0A90 (KiGetTrapFrameMode.c)
 *     memmove @ 0x140435B40 (memmove.c)
 *     KiReadKernelDr7 @ 0x140569E30 (KiReadKernelDr7.c)
...
char __fastcall KiSwInterruptDispatch(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v4 = a1;
  if ( (*(_DWORD *)(*(_QWORD *)&MaxDataSize + 2396LL) & 0x100000) != 0 )
...
LABEL_140:
    if ( *((_DWORD *)v10 + 560) )
    {
      ...
      v112 = *(_QWORD *)((char *)&CurrentPrcb->MxCsr + v10[193]);
      v113 = *(_QWORD *)((char *)&CurrentPrcb->MxCsr + v10[195]);
      if ( !*((_BYTE *)&CurrentPrcb->MxCsr + v10[194])
                ...
                if ( v144 )
                {
                  if ( v144 == 1 )
                    _interlockedbittestandset(
                      *(volatile signed __int32 **)((char *)&KeGetCurrentPrcb()->MxCsr + v10[195]),
                ...
                else
                {
                  _interlockedbittestandset(
                    *(volatile signed __int32 **)(v10[207]
                                                + *(_QWORD *)((char *)&KeGetCurrentPrcb()->MxCsr + v10[195])
                                                + v10[203]),
                    (*((_DWORD *)v10 + 598) >> 10) & 0x1F);
                }
                goto LABEL_201;
...
LABEL_201:
      ...
      *(_QWORD *)(v113 + v10[206]) = 0LL;
      SdbpCheckDll(265, v109, v108, v107, v110, v10[41], v112);
  ...
  v139 = (_BYTE)KernelDr7 != 0;
  if ( (_BYTE)KernelDr7 )
  {
    _disable();
    KernelDr7 = *(const signed __int32 **)((char *)&KeGetCurrentPrcb()->MxCsr
                                         + *(_QWORD *)(*(_QWORD *)&MaxDataSize + 1560LL));
    _enable();
    v139 = _bittest(KernelDr7, 0x18u);
  }
