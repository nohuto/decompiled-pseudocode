/*
 * XREFs of IvtInitializeScalableModePasidTables @ 0x14052F0E8
 * Callers:
 *     IvtExtendScalableModePasidTables @ 0x14052E468 (IvtExtendScalableModePasidTables.c)
 * Callees:
...
LONGLONG __fastcall IvtInitializeScalableModePasidTables(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v9 && !a3 )
  {
    ...
    v20 = v13;
    IvtSetScalableModePasidTableEntry(v6, a2, v7, v17);
  }
  v14 = a3 << 6;
  IvtBuildScalableModePasidDirectoryEntry(v6, a2, v14, v8, v16);
  result = v16[0];
