...
LABEL_33:
      ...
      dword_140C31BB0 = KeTimeIncrement;
      dword_140C31BB4 = KeTimeIncrement;
      result = KiLastRequestedTimeIncrement;
      dword_140C31BB8 = KiLastRequestedTimeIncrement;
      dword_140C31BBC = KiLastRequestedTimeIncrement;
    }
    else
    {
