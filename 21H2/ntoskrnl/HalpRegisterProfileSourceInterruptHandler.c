/*
 * XREFs of HalpRegisterProfileSourceInterruptHandler @ 0x140524990
 * Callers:
...
__int64 __fastcall HalpRegisterProfileSourceInterruptHandler(__int64 (__fastcall *a1)(_QWORD))
{
  ...
  if ( qword_140D017C8 )
  {
    if ( qword_140D017C8 != KeGetCurrentThread()[1].CycleTime )
      return 3221225473LL;
    HalpPerfInterruptHandler = a1;
    qword_140D017C8 &= -(__int64)(a1 != 0LL);
  }
  else
  {
    HalpPerfInterruptHandler = a1;
    if ( a1 )
      qword_140D017C8 = KeGetCurrentThread()[1].CycleTime;
  }
