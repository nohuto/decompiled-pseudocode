/*
 * XREFs of WbGetWarbirdProcess @ 0x1407E2D60
 * Callers:
...
__int64 __fastcall WbGetWarbirdProcess(__int64 a1, int a2, PVOID *a3)
{
  ...
  v7 = KeAbPreAcquire((__int64)&qword_140C5A6F8, 0LL);
  if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C5A6F8, 17LL, 0LL) )
    ExfAcquirePushLockSharedEx((signed __int64 *)&qword_140C5A6F8, 0, v7, (__int64)&qword_140C5A6F8);
  if ( v7 )
    *(_BYTE *)(v7 + 18) = 1;
  v8 = 0;
  ...
  if ( dword_140C5A6D4 - 1 >= 0 )
  {
    ...
    {
      v11 = (v9 + v8) / 2;
      v12 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64))qword_140C5A6F0)(
              *(_QWORD *)((unsigned int)(v11 * dword_140C5A6D0) + qword_140C5A6E0),
              a1,
              8LL);
      if ( !v12 )
        break;
...
LABEL_10:
  ...
  if ( v10 == -1073741198 )
  {
    ...
    v18 = KeAbPreAcquire((__int64)&qword_140C5A6F8, 0LL);
    v20 = v18;
    if ( _interlockedbittestandset64((volatile signed __int32 *)&qword_140C5A6F8, 0LL) )
      ExfAcquirePushLockExclusiveEx(&qword_140C5A6F8, v18, (__int64)&qword_140C5A6F8);
    if ( v20 )
      *(_BYTE *)(v20 + 18) = 1;
