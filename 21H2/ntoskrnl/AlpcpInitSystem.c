/*
 * XREFs of AlpcpInitSystem @ 0x1407CE04C
 * Callers:
...
__int64 AlpcpInitSystem()
{
  ...
  if ( PoolWithTag )
  {
    ...
    qword_140C2A938 = (__int64)&AlpcpPortList;
    ...
    *(__int128 *)((char *)v5 + 12) = AlpcpPortMapping;
    ...
    if ( SystemInformation >= 0 )
    {
      ...
      qword_140C2A978 = (__int64)&qword_140C2A970;
      qword_140C2A970 = (__int64)&qword_140C2A970;
    }
  }
  else
  {
