/*
 * XREFs of PfCheckDeprioritizeFile @ 0x1407DBC0C
 * Callers:
...
__int64 __fastcall PfCheckDeprioritizeFile(int a1, __int64 a2, int a3)
{
  ...
  v6 = 0;
  if ( a2 && (unsigned int)PfLockSharedTryAcquire((ULONG_PTR)&qword_140C545C8) )
  {
    v7 = qword_140C545A8;
...
LABEL_4:
      ...
      KeAbPostRelease((ULONG_PTR)&qword_140C545C8);
...
LABEL_15:
      ...
      if ( (unsigned int)PfLockSharedTryAcquire((ULONG_PTR)&qword_140C545F0) )
      {
...
LABEL_12:
        ...
        KeAbPostRelease((ULONG_PTR)&qword_140C545F0);
        KeLeaveCriticalRegion();
        goto LABEL_15;
      }
    }
