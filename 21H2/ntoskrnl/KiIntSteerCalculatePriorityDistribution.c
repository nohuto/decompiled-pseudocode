/*
 * XREFs of KiIntSteerCalculatePriorityDistribution @ 0x1402FDFE0
 * Callers:
...
__int64 __fastcall KiIntSteerCalculatePriorityDistribution(
        _DWORD *a1,
        _QWORD **a2,
        __int64 *a3,
        __int64 *a4,
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)v14 )
      {
        ...
        *(_QWORD *)&v22 = v16 & *(v10 - 18);
        ...
        result = KiIntPartGetLowestClassProcessorInMask(&v22);
        if ( (_DWORD)result != -1 )
          break;
      }
LABEL_13:
    ...
    a1[v18 / 4 + 1] += 10000LL
                     * *(v10 - 2)
                     / ((unsigned __int64)*(unsigned int *)(KiProcessorBlock[(unsigned int)result] + 68)
                      * KiIntSteerPreviousPerfSnapDelta);
    if ( *a1 <= a1[v18 / 4 + 1] )
    {
      v21 = *(_DWORD *)&KiProcessorIndexToNumberMappingTable[v18] & 0x3F;
      v6 &= ~(1LL << (KiProcessorIndexToNumberMappingTable[v18] & 0x3F));
      v9 &= ~(1LL << (KiProcessorIndexToNumberMappingTable[v18] & 0x3F));
      *(_QWORD *)&v23 = v6;
      v11 &= ~(1LL << v21);
      *(_QWORD *)&v24 = v9;
      *(_QWORD *)&v25 = v11;
    }
    v19 = *(_DWORD *)&KiProcessorIndexToNumberMappingTable[v18];
