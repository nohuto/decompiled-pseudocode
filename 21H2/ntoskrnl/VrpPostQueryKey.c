/*
 * XREFs of VrpPostQueryKey @ 0x140780AA8
 * Callers:
...
__int64 __fastcall VrpPostQueryKey(__int64 a1)
{
  ...
  UINT *v21; // [rsp+48h] [rbp-59h] BYREF
  ...
  if ( (unsigned int)dword_140C038A0 > 5 )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)byte_14002A7B3,
      &ActivityId,
      0LL,
      5u,
      v24);
...
LABEL_34:
      ...
      HIDWORD(v28) = 0;
      v30[0] = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C038A0, (unsigned __int8 *)v15, &ActivityId, 0LL, v17, v24);
      goto LABEL_5;
    }
    goto LABEL_5;
  }
