/*
 * XREFs of GetBootSystemTime @ 0x140B2EBF4
 * Callers:
...
LARGE_INTEGER __fastcall GetBootSystemTime(__int64 a1, LARGE_INTEGER *a2)
{
  ...
  TIME_FIELDS v22; // [rsp+30h] [rbp-18h] BYREF
  ...
  v7 = ((__int64 (__fastcall *)(unsigned __int64 *))off_140C01E40)(&v25) - *(_QWORD *)(a1 + 2640);
  ...
  if ( v3 )
  {
    ...
    RtlpTimeToTimeFields((__int64 *)p_SystemTime, &v22, v6);
  ...
  if ( (qword_140C15C78 & 4) != 0 || !HalQueryRealTimeClock((__int64)&v22) )
    goto LABEL_16;
  v26.QuadPart = 0LL;
  v10 = (char *)ExLeapSecondData;
  if ( !ExLeapSecondData || !*(_BYTE *)ExLeapSecondData )
  {
    if ( RtlpTimeFieldsToTimeNoLeapSeconds(&v22.Year, &SystemTime) )
      goto LABEL_14;
    goto LABEL_16;
  }
  v11 = *((_DWORD *)ExLeapSecondData + 1);
  _InterlockedOr(v19, 0);
  if ( !RtlpTimeFieldsToTimeNoLeapSeconds(&v22.Year, &v26) )
    goto LABEL_16;
  v12 = v26;
  v13 = 0;
  if ( !v11 )
