/*
 * XREFs of PiDqObjectManagerEnumerateAndRegisterQuery @ 0x1407762E4
 * Callers:
...
__int64 __fastcall PiDqObjectManagerEnumerateAndRegisterQuery(PERESOURCE Resource, KSPIN_LOCK a2)
{
  ...
  wchar_t v42[40]; // [rsp+A0h] [rbp-39h] BYREF
    ...
    if ( !v9 )
    {
      ...
      for ( i = 0; i < 6; ++i )
      {
        ...
        if ( *(_DWORD *)v15 == *(_DWORD *)&Resource[2].ActiveCount )
        {
          ...
          v21 = *(_QWORD *)(a2 + 24);
          v40 = v20;
          EnumObject = ConstraintEval(*(_DWORD *)(v21 + 80), *(_DWORD **)(v21 + 88), (__int64)&v40, v19, (__int64)v37);
      ...
      else
      {
        ...
        if ( DWORD2(v38) == 13 )
        {
          EnumObject = PnpStringFromGuid(v39, v42);
          if ( EnumObject < 0 )
            goto LABEL_12;
          v6 = v42;
        }
        ...
        Object = PiDmGetObject(*((unsigned int *)v17 + 6), v6, &BugCheckParameter2);
        EnumObject = Object;
      ...
      if ( v10 == 1 )
      {
        ...
        while ( 2 )
        {
          if ( *v25 )
          {
            ...
            v29 = PiDmGetObject(*(unsigned int *)&Resource[2].ActiveCount, v25, &BugCheckParameter2);
            EnumObject = v29;
            if ( v29 == -1073741772 )
            {
              EnumObject = 0;
            ...
            else
            {
              ...
              if ( (unsigned __int8)PiDmObjectIsEnumerable(BugCheckParameter2) )
...
LABEL_59:
    ...
    else
    {
      ...
      if ( v11 != -1073741772 )
      {
        ...
        if ( (unsigned __int8)PiDmObjectIsEnumerable(BugCheckParameter2) )
          EnumObject = PiDqQueryEnumObject(a2, v12);
