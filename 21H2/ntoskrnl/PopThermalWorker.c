/*
 * XREFs of PopThermalWorker @ 0x140850980
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_BYTE *)(a1 + 70) = *(_BYTE *)(a1 + 220);
    ...
    if ( v25 < v26 )
    {
      if ( (*(_BYTE *)(a1 + 65) & 4) == 0 )
      {
        ...
        LOBYTE(v31) = 1;
        PopDiagTraceActiveCooling(a1 + 112, BugCheckParameter4, v31, 1LL);
        v27 = *(_BYTE *)(a1 + 65);
        *(_QWORD *)(a1 + 248) = v4;
        goto LABEL_51;
      }
...
LABEL_53:
  if ( *(_DWORD *)(a1 + 216) != *(_DWORD *)(a1 + 80) )
  {
    ...
    v46 = 1;
    *(_DWORD *)(a1 + 84) = v34;
    PopDiagTraceThermalZoneThrottlePerfTrack(v35, 100 - v34, (__int64)BugCheckParameter4);
    goto LABEL_80;
  }
  v29 = v28 & 1;
  if ( v22 )
...
LABEL_80:
    ...
    if ( v22 )
    {
      ...
      {
        LOBYTE(v36) = 1;
        PopDiagTracePassiveCooling(a1 + 112, (_DWORD)BugCheckParameter4, v36, v47, 1);
        *(_QWORD *)(a1 + 256) = v4;
      }
    }
    else if ( (v37 & 1) != 0 )
    {
      PopDiagTracePassiveCooling(a1 + 112, (_DWORD)BugCheckParameter4, 0, v47, 1);
      PopDiagTraceThermalZoneThrottleDurationPerfTrack(
        (v4 - *(_QWORD *)(a1 + 256)) / 0x2710uLL,
        (__int64)BugCheckParameter4);
    }
    v38 = *(_BYTE *)(a1 + 65);
    if ( v22 )
