/*
 * XREFs of BootApplicationPersistentDataInitialize @ 0x140A6C7CC
 * Callers:
...
void __fastcall BootApplicationPersistentDataInitialize(__int64 a1)
{
  ...
  qword_140CF29F8 = &qword_140CF29F0;
  qword_140CF29F0 = (__int64)&qword_140CF29F0;
    ...
    if ( *((_DWORD *)v3 + 6) )
    {
      ...
      *((_DWORD *)PoolWithTag + 6) = *((_DWORD *)v3 + 6);
      ...
      if ( *(__int64 **)qword_140CF29F8 != &qword_140CF29F0 )
        __fastfail(3u);
      *PoolWithTag = &qword_140CF29F0;
      PoolWithTag[1] = v6;
      *v6 = PoolWithTag;
      qword_140CF29F8 = PoolWithTag;
    }
  }
}
