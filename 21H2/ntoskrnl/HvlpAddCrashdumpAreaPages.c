/*
 * XREFs of HvlpAddCrashdumpAreaPages @ 0x1404F902C
 * Callers:
...
char __fastcall HvlpAddCrashdumpAreaPages(__int64 a1, char a2)
{
  ...
  if ( (!a2 || (HvlpFlags & 2) != 0) && KiHypervisorInitiatedCrashDump )
  {
    ...
    if ( a2 )
    {
      *(_QWORD *)(a1 + 16) = (unsigned __int64)qword_140C47520 >> 12;
      v3 = (unsigned int)dword_140C4751C;
      *(_DWORD *)(a1 + 8) |= 0x80000022;
    }
    else
    {
      *(_QWORD *)(a1 + 16) = (unsigned __int64)qword_140C47510 >> 12;
      v3 = (unsigned int)dword_140C47518;
