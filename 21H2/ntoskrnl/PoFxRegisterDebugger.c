/*
 * XREFs of PoFxRegisterDebugger @ 0x140AF86C4
 * Callers:
...
void PoFxRegisterDebugger()
{
  ...
  if ( ((unsigned int (__fastcall *)(__int64, _QWORD, _QWORD, __int64 *))off_140C020D8[0])(33LL, 0LL, 0LL, &v16) == -2147483643 )
  {
    v1 = v16;
    Pool2 = (unsigned int *)ExAllocatePool2(64LL, (unsigned int)v16, 0x4D584650u);
    if ( Pool2 )
    {
      if ( ((int (__fastcall *)(__int64, _QWORD, unsigned int *, __int64 *))off_140C020D8[0])(33LL, v1, Pool2, &v16) >= 0
        && (unsigned int)v16 <= v1 )
      {
        v3 = 0;
        v4 = Pool2 + 1;
