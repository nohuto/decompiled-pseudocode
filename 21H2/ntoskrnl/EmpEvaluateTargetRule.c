/*
 * XREFs of EmpEvaluateTargetRule @ 0x1402DC420
 * Callers:
...
__int64 __fastcall EmpEvaluateTargetRule(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (_DWORD)v7 )
  {
    v4 = EmpAllocatePool(8 * v7, &v24, &v28);
    if ( !v4 )
      goto LABEL_22;
  }
  if ( !(_DWORD)v8 || (v5 = EmpAllocatePool(4 * v8, &v24, &v28)) != 0 )
  {
    if ( !v11 )
    {
LABEL_18:
...
LABEL_9:
    ...
    do
    {
      ...
      if ( (_DWORD)v7 )
      {
        ...
        {
          v18 = v14 * v13 + v16++;
          *v17++ = *((_QWORD *)EmpStringTable + *(unsigned int *)(v15 + 4 * v18));
        }
      ...
      v6 = EmpEvaluateNodeLink(*(_QWORD *)(v12 + 96), v4, v7, v5, v8, v29, v30, 0LL, 0, v24, v28);
      if ( v6 - 1 <= 1 )
        break;
      ++v14;
    }
