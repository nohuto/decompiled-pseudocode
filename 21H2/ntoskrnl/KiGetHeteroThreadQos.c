/*
 * XREFs of KiGetHeteroThreadQos @ 0x14045AE34
 * Callers:
...
__int64 __fastcall KiGetHeteroThreadQos(__int64 a1, __int64 a2, BOOL *a3)
{
  unsigned int v3; // edx
  BOOL v5; // r11d
  __int64 result; // rax
  ...
  if ( (_DWORD)result == 6 )
  {
    ...
    if ( (KiDynamicHeteroCpuPolicyMask & 4) != 0 )
    {
      ...
      if ( (_DWORD)v12 != 8 )
      {
        if ( v3 < KiDynamicHeteroCpuPolicyExpectedCycles && KeHeteroSystemQos && (KiDynamicHeteroCpuPolicyMask & 8) != 0 )
        {
LABEL_36:
          result = v11;
          goto LABEL_37;
...
LABEL_27:
        if ( (KiDynamicHeteroCpuPolicyMask & 1) != 0 && KiIsForegroundThread(a1) )
          goto LABEL_29;
      }
    }
    ...
    result = (unsigned int)KiProcessPolicyToQosMappingTable[v12];
    if ( (_DWORD)result != 6 )
      goto LABEL_37;
    v13 = *(char *)(a1 + 195);
    if ( *(char *)(a1 + 195) < 15
      && (((unsigned __int8)KiDynamicHeteroCpuPolicyMask & (unsigned __int8)v11) == 0
       || v13 < KiDynamicHeteroCpuPolicyImportantPriority && ((*(_DWORD *)(a1 + 116) & 0x400) == 0 || (char)v13 < 8)) )
    {
      goto LABEL_36;
    }
LABEL_29:
