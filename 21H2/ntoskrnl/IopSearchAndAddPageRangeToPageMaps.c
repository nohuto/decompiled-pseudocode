/*
 * XREFs of IopSearchAndAddPageRangeToPageMaps @ 0x140554ED0
 * Callers:
 *     IopAddPageToPageMap @ 0x140553F1C (IopAddPageToPageMap.c)
 *     IopFilterAndAddPageRangeToPageMaps @ 0x14055D6F4 (IopFilterAndAddPageRangeToPageMaps.c)
 * Callees:
...
LABEL_28:
      ...
      if ( v15 > *a3 )
      {
        IopAddPageRangeToPageMaps(a1, (__int128 *)a2, v6, *a3, a6);
        *a3 = 0LL;
        return 3221225507LL;
      }
      IopAddPageRangeToPageMaps(a1, (__int128 *)a2, v6, v15, a6);
      *a3 -= v15;
      v6 += v15;
      if ( v6 >= v12 )
        return 0LL;
