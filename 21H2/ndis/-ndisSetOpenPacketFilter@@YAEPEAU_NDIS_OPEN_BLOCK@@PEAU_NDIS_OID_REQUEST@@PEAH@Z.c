/*
 * XREFs of ?ndisSetOpenPacketFilter@@YAEPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1C002D6F4
 * Callers:
 ...
 *     WPP_RECORDER_SF_qqDL @ 0x1C002D90C (WPP_RECORDER_SF_qqDL.c)
