/*
 * XREFs of WPP_RECORDER_SF_Ll @ 0x1C00B32A4
 * Callers:
...
__int64 WPP_RECORDER_SF_Ll(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(&WPP_f54e675e1845396bafe5da195840d2ea_Traceguids, 0x12u, va, 4LL, va1, 4LL, 0LL);
  LOWORD(v7) = 18;
  return WppAutoLogTrace(a1, 4LL, 22LL, &WPP_f54e675e1845396bafe5da195840d2ea_Traceguids, v7, (__int64 *)va);
}
