/*
 * XREFs of WPP_RECORDER_SF_qdL @ 0x1C003BC68
 * Callers:
 ...
 *     ?ndisUpdateMiniportFakeStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C001A13C (-ndisUpdateMiniportFakeStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
