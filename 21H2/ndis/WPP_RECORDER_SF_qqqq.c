/*
 * XREFs of WPP_RECORDER_SF_qqqq @ 0x1C002C860
 * Callers:
 ...
 *     ?ndisOidPreEthMulticastOid@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C003C530 (-ndisOidPreEthMulticastOid@@YAEPEAU_NDIS_REQ_TRACKER@@@Z.c)
