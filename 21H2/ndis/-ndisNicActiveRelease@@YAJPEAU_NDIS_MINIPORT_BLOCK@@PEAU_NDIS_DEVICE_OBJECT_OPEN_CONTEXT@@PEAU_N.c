/*
 * XREFs of ?ndisNicActiveRelease@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@PEAU_NDIS_PM_NIC_ACTIVE@@@Z @ 0x1C005C20C
 * Callers:
 ...
 *     WPP_RECORDER_SF_DDLqdL @ 0x1C005E950 (WPP_RECORDER_SF_DDLqdL.c)
 */
