 ...
 *     ?ndisIfDeleteStackEntries@@YAXPEAU_NDIS_IF_BLOCK@@@Z @ 0x1C00B11F0 (-ndisIfDeleteStackEntries@@YAXPEAU_NDIS_IF_BLOCK@@@Z.c)
 ...
 *     ?ndisIfFreeIfIndex@@YAXK@Z @ 0x1C00B583C (-ndisIfFreeIfIndex@@YAXK@Z.c)
...
LABEL_10:
  ...
  {
    v9 = 0;
    v158 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E4AF0);
    if ( ThreadSessionId < dword_1C00E6160 )
      v9 = *((_DWORD *)P + 6 * ThreadSessionId);
    KeReleaseSpinLock(&qword_1C00E4AF0, v158);
    if ( !v9 )
      v9 = 1;
    LODWORD(v221) = v9;
  }
  ...
  if ( qword_1C00E4B00 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E4B00 )
  {
    while ( *((_DWORD *)v18 + 4) != v10 )
    {
      if ( *((_DWORD *)v18 + 4) <= v10 )
      {
        ...
        if ( v18 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E4B00 )
          continue;
      }
      goto LABEL_18;
    }
