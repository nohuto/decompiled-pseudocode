/*
 * XREFs of ?UnbindOnDetach@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00FC2E4
 * Callers:
 ...
 *     WPP_RECORDER_SF__guid_D @ 0x1C00AC380 (WPP_RECORDER_SF__guid_D_ea_1C00AC380.c)
 ...
 *     ?GetActualBindingState@BindState@Ndis@@QEAA?AW4BINDING_ENABLED_OR_DISABLED@@XZ @ 0x1C0122824 (-GetActualBindingState@BindState@Ndis@@QEAA-AW4BINDING_ENABLED_OR_DISABLED@@XZ.c)
  ...
  for ( j = 0LL; j != v10; ++j )
  {
    ...
    else
    {
      ...
      if ( (v14 != 0) != ((v14 & 0xFFFFFBFF) != 0) || !*(_QWORD *)v13 )
      {
        ...
        v18 = (unsigned __int8)byte_1C00E444B < 4u;
