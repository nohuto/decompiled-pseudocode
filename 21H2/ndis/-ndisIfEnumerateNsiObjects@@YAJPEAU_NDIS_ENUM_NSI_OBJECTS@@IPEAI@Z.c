/*
 * XREFs of ?ndisIfEnumerateNsiObjects@@YAJPEAU_NDIS_ENUM_NSI_OBJECTS@@IPEAI@Z @ 0x1C01272AC
 * Callers:
 *     ?ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z @ 0x1C012BDB8 (-ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z.c)
 * Callees:
 *     memset @ 0x1C00403C0 (memset.c)
 *     NdisIfGetNetLuidFromInterfaceIndex @ 0x1C00B1D00 (NdisIfGetNetLuidFromInterfaceIndex.c)
 */
