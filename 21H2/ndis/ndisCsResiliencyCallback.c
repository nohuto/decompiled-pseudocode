/*
 * XREFs of ndisCsResiliencyCallback @ 0x1C005B510
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisCsResiliencyChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C005B620 (-ndisCsResiliencyChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z.c)
 */
