/*
 * XREFs of KRegKey::QueryValueMultisz__lambda_145828208f54867cbf19e2ec96475ca0___lambda_669a078cee999b45033530b9c5ed1c6f___ @ 0x1C01233B8
 * Callers:
 *     KRegKey::QueryValueMultisz__lambda_145828208f54867cbf19e2ec96475ca0___lambda_669a078cee999b45033530b9c5ed1c6f____0 @ 0x1C01235A8 (KRegKey--QueryValueMultisz__lambda_145828208f54867cbf19e2ec96475ca0___lambda_669a07_ea_1C01235A8.c)
 * Callees:
 ...
 *     ?append@?$KArray@PEAU_KStringAtom@Rtl@@$00@Rtl@@QEAA_NAEBQEAU_KStringAtom@2@@Z @ 0x1C0123F48 (-append@-$KArray@PEAU_KStringAtom@Rtl@@$00@Rtl@@QEAA_NAEBQEAU_KStringAtom@2@@Z.c)
...
LABEL_16:
  ...
  if ( !(unsigned __int8)Rtl::KArray<Rtl::_KStringAtom *,1>::reserve((char *)qword_1C00E4598 + 72, v12 + 4LL) )
    goto LABEL_3;
  while ( *v11 )
  {
    v16 = v11;
    do
      ++v16;
    while ( *v16 );
    Atom = Rtl::KStringAtomTableBase<1>::GetAtom(qword_1C00E4598, v11);
    if ( !Atom )
      goto LABEL_3;
    Rtl::KArray<Rtl::_KStringAtom *,1>::append((char *)qword_1C00E4598 + 72, &Atom);
    v11 = v16 + 1;
  }
  v8 = 0;
LABEL_17:
