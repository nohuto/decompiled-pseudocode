/*
 * XREFs of ?ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z @ 0x1C00BDFA0
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00BE1D0 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00BE280 (NdisImmediateWriteSharedMemory.c)
 * Callees:
 ...
 *     ndisStartMapping @ 0x1C00BE090 (ndisStartMapping.c)
 */
        ...
        unsigned __int8 a5)
{
  ...
  if ( !(unsigned int)ndisTranslateResources((struct _NDIS_MINIPORT_BLOCK *)v5, 3, (union _LARGE_INTEGER)a2, &v14, &v15) )
  {
    ...
    if ( !v15 )
      v11 = v7;
    if ( (int)ndisStartMapping(v11, v8, a2, a4, 0, (__int64)&BaseAddress, (__int64)&v17) >= 0 )
    {
      if ( a5 )
      {
        v12 = BaseAddress;
