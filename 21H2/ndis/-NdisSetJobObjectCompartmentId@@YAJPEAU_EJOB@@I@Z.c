/*
 * XREFs of ?NdisSetJobObjectCompartmentId@@YAJPEAU_EJOB@@I@Z @ 0x1C012629C
 * Callers:
 *     ?ndisNsiSetAllJobInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C00B0C10 (-ndisNsiSetAllJobInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z.c)
 * Callees:
 ...
 *     ndisIfSetCompartmentJobObject @ 0x1C00B0A10 (ndisIfSetCompartmentJobObject.c)
 *     NdisGetJobObjectCompartmentId @ 0x1C00B0CE0 (NdisGetJobObjectCompartmentId.c)
 *     ?ndisCmDereferenceCompartment@@YAXPEAX@Z @ 0x1C00B47E8 (-ndisCmDereferenceCompartment@@YAXPEAX@Z.c)
 */
