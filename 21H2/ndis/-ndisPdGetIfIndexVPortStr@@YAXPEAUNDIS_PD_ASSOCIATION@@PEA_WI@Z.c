/*
 * XREFs of ?ndisPdGetIfIndexVPortStr@@YAXPEAUNDIS_PD_ASSOCIATION@@PEA_WI@Z @ 0x1C007E14C
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCbPrintfW@@YAJPEA_W_KPEB_WZZ @ 0x1C002535C (-RtlStringCbPrintfW@@YAJPEA_W_KPEB_WZZ.c)
 */
...
void __fastcall ndisPdGetIfIndexVPortStr(struct NDIS_PD_ASSOCIATION *a1, wchar_t *a2)
{
  ...
  if ( *((_DWORD *)a1 + 16) == -1 )
  {
    RtlStringCbPrintfW(a2, 0x80uLL, (wchar_t *)L"IfIndex %u", v2);
  }
  else
  {
    v3 = *((_DWORD *)a1 + 16);
    RtlStringCbPrintfW(a2, 0x80uLL, (wchar_t *)L"IfIndex %u: VPort %u", v2, v3);
  }
}
