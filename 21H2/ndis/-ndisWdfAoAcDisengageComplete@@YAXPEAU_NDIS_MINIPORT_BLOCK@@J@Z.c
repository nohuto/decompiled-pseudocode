/*
 * XREFs of ?ndisWdfAoAcDisengageComplete@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x1C005D5F0
 * Callers:
 ...
 *     NdisWdfAsyncPowerReferenceCompleteNotification @ 0x1C0121590 (NdisWdfAsyncPowerReferenceCompleteNotification.c)
 * Callees:
