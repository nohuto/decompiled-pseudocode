/*
 * XREFs of ?CreateDynamicBinding@BindStack@Ndis@@QEAAPEAUNDIS_BIND_PROTOCOL_LINK@@AEAV?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@PEAU_NDIS_MINIPORT_BLOCK@@W4Flags@BindSource@2@@Z @ 0x1C01231E0
 * Callers:
 ...
 *     ?IsAlive@BindState@Ndis@@QEBA_NXZ @ 0x1C012283C (-IsAlive@BindState@Ndis@@QEBA_NXZ.c)
