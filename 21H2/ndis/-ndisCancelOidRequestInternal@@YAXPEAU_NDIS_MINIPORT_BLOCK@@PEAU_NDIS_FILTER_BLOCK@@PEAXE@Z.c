/*
 * XREFs of ?ndisCancelOidRequestInternal@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_FILTER_BLOCK@@PEAXE@Z @ 0x1C0099C14
 * Callers:
 *     ?ndisFCancelOidRequestInternal@@YAXPEAX@Z @ 0x1C0067D10 (-ndisFCancelOidRequestInternal@@YAXPEAX@Z.c)
 ...
 *     NdisCancelOidRequest @ 0x1C00A1910 (NdisCancelOidRequest.c)
 * Callees:
