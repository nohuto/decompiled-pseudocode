/*
 * XREFs of WPP_RECORDER_SF_DqLL @ 0x1C000F5B0
 * Callers:
...
__int64 WPP_RECORDER_SF_DqLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_c920fc8b5d2332d789f3c4881e4e0e63_Traceguids,
      0x14u,
      va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 20;
  return WppAutoLogTrace(a1, 4LL, 22LL, &WPP_c920fc8b5d2332d789f3c4881e4e0e63_Traceguids, v7, (__int64 *)va);
}
