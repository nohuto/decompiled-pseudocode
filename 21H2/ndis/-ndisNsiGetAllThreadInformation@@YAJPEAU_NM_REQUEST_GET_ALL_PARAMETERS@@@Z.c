/*
 * XREFs of ?ndisNsiGetAllThreadInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C0006FF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
    ...
    {
      v16 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E4AF0);
      if ( ThreadSessionId < dword_1C00E6160 )
        v6 = *((_DWORD *)P + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00E4AF0, v16);
      if ( !v6 )
        v6 = 1;
      v11 = v6;
    }
