/*
 * XREFs of ?NdisPDAllocateMemory@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KPEAKPEAT_LARGE_INTEGER@@PEAPEAXPEAPEAUPD_MEMORY_HANDLE__@@@Z @ 0x1C0119930
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00400D0 (_guard_dispatch_icall_nop.c)
 *     WPP_RECORDER_SF_qdD @ 0x1C005EBC8 (WPP_RECORDER_SF_qdD_ea_1C005EBC8.c)
 *     WPP_RECORDER_SF_qdqiqd @ 0x1C007F418 (WPP_RECORDER_SF_qdqiqd.c)
