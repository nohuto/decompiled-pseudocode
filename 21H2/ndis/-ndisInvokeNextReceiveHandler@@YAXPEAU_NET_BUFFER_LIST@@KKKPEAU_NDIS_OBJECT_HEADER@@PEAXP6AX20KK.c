/*
 * XREFs of ?ndisInvokeNextReceiveHandler@@YAXPEAU_NET_BUFFER_LIST@@KKKPEAU_NDIS_OBJECT_HEADER@@PEAXP6AX20KKK@Z@Z @ 0x1C003E320
 * Callers:
  ...
  else
  {
      ...
      || (a4 & 1) == 0 && (CurrentIrql = KeGetCurrentIrql(), (_BYTE)CurrentIrql != 2) )
    {
      ...
      if ( KeExpandKernelStackAndCalloutEx(
             ...
             0LL) < 0 )
      {
        if ( byte_1C00E3FD0 && (*((_DWORD *)&a5->PktMonComp + 13) & 2) != 0 )
