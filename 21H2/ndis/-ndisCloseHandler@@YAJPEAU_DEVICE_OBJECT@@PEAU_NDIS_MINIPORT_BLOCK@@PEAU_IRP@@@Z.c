/*
 * XREFs of ?ndisCloseHandler@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@@Z @ 0x1C006B1A8
 * Callers:
 *     NdisWdfCloseIrpHandler @ 0x1C0061D20 (NdisWdfCloseIrpHandler.c)
 * Callees:
