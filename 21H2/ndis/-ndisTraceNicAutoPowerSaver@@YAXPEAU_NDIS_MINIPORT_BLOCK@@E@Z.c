/*
 * XREFs of ?ndisTraceNicAutoPowerSaver@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C00A7DEC
 * Callers:
 ...
 *     ?NdisTraceLoggingNicAutoPowerSaver@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E_K1K11KPEAU_NDIS_NAPS_TELEMETRY_REASON_DATA@@KPEAU_NDIS_NAPS_TELEMETRY_OID_DATA@@@Z @ 0x1C008BA4C (-NdisTraceLoggingNicAutoPowerSaver@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E_K1K11KPEAU_NDIS_NAPS_TELEMETR.c)
 *     ndisNicAutoPowerInsertIntoSortedArray @ 0x1C00A5D30 (ndisNicAutoPowerInsertIntoSortedArray.c)
 *     WPP_RECORDER_SF__guid_ZDDDDDDDDDDDDDDDDDDDDDDDD @ 0x1C00A9450 (WPP_RECORDER_SF__guid_ZDDDDDDDDDDDDDDDDDDDDDDDD.c)
 *     WPP_RECORDER_SF__guid_ZDDDIDDDIDDDIDDDIDDDIDDDIDDDI @ 0x1C00A997C (WPP_RECORDER_SF__guid_ZDDDIDDDIDDDIDDDIDDDIDDDIDDDI.c)
 *     WPP_RECORDER_SF__guid_ZDIDIII @ 0x1C00A9F68 (WPP_RECORDER_SF__guid_ZDIDIII.c)
 */
    ...
    if ( SelectiveSuspend )
    {
      ...
      else
      {
        if ( a2 )
          ...
          v13 = *((_QWORD *)a1->AoAc + 106) / 0x2710uLL;
        p_InterfaceGuid = &a1->InterfaceGuid;
