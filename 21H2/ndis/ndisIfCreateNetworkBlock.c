/*
 * XREFs of ndisIfCreateNetworkBlock @ 0x1C0034FF0
 * Callers:
...
__int64 __fastcall ndisIfCreateNetworkBlock(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  *((_OWORD *)v13 + 2) = v14;
  ...
  while ( v11 );
  *v15 = *(_OWORD *)a3;
  for ( i = (__int64 *)qword_1C00E4B10; i != &qword_1C00E4B10; i = (__int64 *)*i )
  {
...
LABEL_41:
  ...
  if ( !byte_1C00E61D1 )
  {
    v20 = dword_1C00E3798 ^ (dword_1C00E3798 ^ (dword_1C00E3798 + 1)) & 0xFFFFFFF;
    dword_1C00E3798 = v20;
...
LABEL_32:
  ...
  {
    for ( j = qword_1C00E4B10; (__int64 *)j != &qword_1C00E4B10; j = *(_QWORD *)j )
    {
      if ( v21 == *(_DWORD *)(j + 88) )
        goto LABEL_32;
    }
