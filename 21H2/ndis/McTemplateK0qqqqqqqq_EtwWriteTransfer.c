/*
 * XREFs of McTemplateK0qqqqqqqq_EtwWriteTransfer @ 0x1C00A4510
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqqq_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a11)
{
  _EVENT_DATA_DESCRIPTOR v12; // [rsp+30h] [rbp-81h] BYREF
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, &RstLimitChange, a3, 9u, &v12);
}
