/*
 * XREFs of ?ndisPostProcessRestartParametersAfterFilters@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_RESTART_INFORMATION@@@Z @ 0x1C002A6B8
 * Callers:
        ...
        struct NDIS_RESTART_INFORMATION *a2)
{
  ...
  union _NET_LUID_LH v13; // [rsp+58h] [rbp+20h] BYREF
  ...
  if ( a2->Attributes.Oid )
  {
    ...
    *(_DWORD *)&a1->TopRecvScaleCapabilities.NumberOfIndirectionTableEntries = *(_DWORD *)&a2->RssCaps.NumberOfIndirectionTableEntries;
    ...
    v8 = a1->TopFilterRestartAttributes.SupportedOidListLength;
    if ( SupportedOidListLength != v8 )
    {
