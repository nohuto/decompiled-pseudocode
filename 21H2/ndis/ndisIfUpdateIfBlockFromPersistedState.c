/*
 * XREFs of ndisIfUpdateIfBlockFromPersistedState @ 0x1C0126A9C
 * Callers:
 ...
 *     ndisIfUpdateInterfaceFromPersistentStore @ 0x1C002F020 (ndisIfUpdateInterfaceFromPersistentStore.c)
 ...
 *     ?ndisIfUpdateInterfaceIsolationNetworkId@@YAJPEAU_NDIS_IF_BLOCK@@AEBU_GUID@@E@Z @ 0x1C00B20D8 (-ndisIfUpdateInterfaceIsolationNetworkId@@YAJPEAU_NDIS_IF_BLOCK@@AEBU_GUID@@E@Z.c)
 *     WPP_RECORDER_SF__guid_L @ 0x1C00B2404 (WPP_RECORDER_SF__guid_L.c)
 *     WPP_RECORDER_SF__guid__guid__guid_ @ 0x1C00B24D8 (WPP_RECORDER_SF__guid__guid__guid_.c)
...
void __fastcall ndisIfUpdateIfBlockFromPersistedState(struct _NDIS_IF_BLOCK *a1, struct KRegKey *this)
{
  ...
  if ( (int)NetSetupPropertyBag::ReadString(
              ...
              (const struct _NETSETUPPROPKEY *)&unk_1C00D3798,
              &v24) >= 0 )
  {
    v18 = 20;
  ...
  if ( (int)NetSetupPropertyBag::ReadString(
              (NetSetupPropertyBag *)&v21,
              (const struct _NETSETUPPROPKEY *)&unk_1C00D3780,
              &P) >= 0 )
  {
    v18 = 4;
