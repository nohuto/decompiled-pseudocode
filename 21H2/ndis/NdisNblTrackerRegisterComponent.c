/*
 * XREFs of NdisNblTrackerRegisterComponent @ 0x1C002D210
 * Callers:
 ...
 * Callees:
 *     ?ndisAllocatePerProcessorSlot@@YAPEAUPNDIS_PER_PROCESSOR_SLOT__@@K@Z @ 0x1C002D334 (-ndisAllocatePerProcessorSlot@@YAPEAUPNDIS_PER_PROCESSOR_SLOT__@@K@Z.c)
...
__int64 __fastcall NdisNblTrackerRegisterComponent(__int16 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)v7 = v7;
  ...
  v12 = (__int64 *)qword_1C00E4AB0;
  if ( *(struct _NDIS_NBL_TRACKER ***)qword_1C00E4AB0 != &ndisNblTrackerList )
    __fastfail(3u);
