/*
 * XREFs of ?NdisTraceLoggingGreTaskHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C001F8F4
 * Callers:
...
void __fastcall NdisTraceLoggingGreTaskHardwareOffloads(
