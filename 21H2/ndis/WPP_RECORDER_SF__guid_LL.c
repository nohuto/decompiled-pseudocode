/*
 * XREFs of WPP_RECORDER_SF__guid_LL @ 0x1C00B574C
 * Callers:
...
__int64 WPP_RECORDER_SF__guid_LL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, __int64 a6, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x200000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(&WPP_26d5752112ac3cd786e6296fc2fada98_Traceguids, 0x1Bu, a6, 16LL, va, 4LL, va1, 4LL, 0LL);
  LOWORD(v8) = 27;
  return WppAutoLogTrace(a1, 4LL, 22LL, &WPP_26d5752112ac3cd786e6296fc2fada98_Traceguids, v8, a6);
}
