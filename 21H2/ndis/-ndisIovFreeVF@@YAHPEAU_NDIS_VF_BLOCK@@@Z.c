/*
 * XREFs of ?ndisIovFreeVF@@YAHPEAU_NDIS_VF_BLOCK@@@Z @ 0x1C0077EE0
 * Callers:
 *     ?ndisOidPostIovFreeVF@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0079060 (-ndisOidPostIovFreeVF@@YAXPEAU_NDIS_REQ_TRACKER@@@Z.c)
 * Callees:
