/*
 * XREFs of ndisIfUpdateInterfaceFromPersistentStore @ 0x1C002F020
 * Callers:
 ...
 * Callees:
 *     WPP_RECORDER_SF_IL @ 0x1C002F100 (WPP_RECORDER_SF_IL.c)
 *     WPP_RECORDER_SF_I @ 0x1C002F190 (WPP_RECORDER_SF_I.c)
