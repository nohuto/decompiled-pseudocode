/*
 * XREFs of ?ndisFilterAttachCleanUp@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_MINIPORT_BLOCK@@E@Z @ 0x1C00686E0
 * Callers:
 ...
 *     NdisIfDeregisterInterface @ 0x1C0126870 (NdisIfDeregisterInterface.c)
 */
