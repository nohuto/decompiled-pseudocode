/*
 * XREFs of ?ndisIfLuidAllocatorSubsystemInitialize@@YAJXZ @ 0x1C0145174
 * Callers:
...
NTSTATUS ndisIfLuidAllocatorSubsystemInitialize(void)
{
  ...
  Status = 0;
  qword_1C00E5F20 = (__int64)&qword_1C00E5F18;
  qword_1C00E5F18 = (__int64)&qword_1C00E5F18;
        ...
        *(_QWORD *)&Keyword.Length = 917516LL;
        ...
        if ( !Status )
        {
          ...
          *((_WORD *)PoolWithTag + 8) = Length;
          ...
          v5 = qword_1C00E5F18;
          if ( *(__int64 **)(qword_1C00E5F18 + 8) != &qword_1C00E5F18 )
            __fastfail(3u);
          *PoolWithTag = qword_1C00E5F18;
          PoolWithTag[1] = &qword_1C00E5F18;
          *(_QWORD *)(v5 + 8) = PoolWithTag;
          qword_1C00E5F18 = (__int64)PoolWithTag;
        }
      }
