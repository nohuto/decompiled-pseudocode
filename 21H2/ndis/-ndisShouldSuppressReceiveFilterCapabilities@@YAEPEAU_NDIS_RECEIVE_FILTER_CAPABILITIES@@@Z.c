/*
 * XREFs of ?ndisShouldSuppressReceiveFilterCapabilities@@YAEPEAU_NDIS_RECEIVE_FILTER_CAPABILITIES@@@Z @ 0x1C001F194
 * Callers:
 ...
 * Callees:
 *     WPP_RECORDER_SF_qdDd @ 0x1C001F200 (WPP_RECORDER_SF_qdDd.c)
 */
