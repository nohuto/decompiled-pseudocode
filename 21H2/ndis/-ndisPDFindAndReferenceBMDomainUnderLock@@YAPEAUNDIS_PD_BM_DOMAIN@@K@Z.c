/*
 * XREFs of ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x1C011D1A0
 * Callers:
...
struct NDIS_PD_BM_DOMAIN *__fastcall ndisPDFindAndReferenceBMDomainUnderLock(int a1)
{
  ...
  for ( i = *(_QWORD **)(qword_1C00E44F8 + 8240); ; i = (_QWORD *)*i )
  {
    if ( i == (_QWORD *)(qword_1C00E44F8 + 8240) )
      return 0LL;
