/*
 * XREFs of NdisAllocateNetBufferPool @ 0x1C0038510
 * Callers:
...
LABEL_6:
    ...
    if ( Pool )
    {
      ...
      *((_QWORD *)v6 + 2) = (char *)v6 + 16;
      v11 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E5E30);
      v12 = qword_1C00E60B8;
      v13 = (_QWORD *)((char *)v6 + 72);
      if ( *(__int64 **)(qword_1C00E60B8 + 8) != &qword_1C00E60B8 )
        __fastfail(3u);
      *v13 = qword_1C00E60B8;
      *((_QWORD *)v6 + 10) = &qword_1C00E60B8;
      *(_QWORD *)(v12 + 8) = v13;
      qword_1C00E60B8 = (__int64)v6 + 72;
      KeReleaseSpinLock(&qword_1C00E5E30, v11);
      *((_QWORD *)v6 + 6) = retaddr;
    }
    goto LABEL_11;
  }
