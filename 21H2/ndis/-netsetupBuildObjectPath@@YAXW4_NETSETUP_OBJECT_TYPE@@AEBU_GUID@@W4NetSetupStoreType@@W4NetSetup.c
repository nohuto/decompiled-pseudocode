/*
 * XREFs of ?netsetupBuildObjectPath@@YAXW4_NETSETUP_OBJECT_TYPE@@AEBU_GUID@@W4NetSetupStoreType@@W4NetSetupSubkeyType@@PEA_W@Z @ 0x1C0102138
 * Callers:
 ...
 * Callees:
 *     netsetupGetPathForObjectType @ 0x1C0102280 (netsetupGetPathForObjectType.c)
 */
        ...
        wchar_t *Dst)
{
  ...
  if ( *((_BYTE *)qword_1C00E4598 + 96) && a4 == Writeback )
    a3 = 1;
  if ( a4 )
  {
    v6 = a4 - 1;
