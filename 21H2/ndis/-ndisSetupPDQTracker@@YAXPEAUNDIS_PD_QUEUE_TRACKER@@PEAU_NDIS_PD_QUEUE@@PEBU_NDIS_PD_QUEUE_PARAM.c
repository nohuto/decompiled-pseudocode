/*
 * XREFs of ?ndisSetupPDQTracker@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@PEAU_NDIS_PD_QUEUE@@PEBU_NDIS_PD_QUEUE_PARAMETERS@@PEAUNDIS_PD_ASSOCIATION@@PEAUNDIS_PD_COUNTER@@EE@Z @ 0x1C011D7CC
 * Callers:
 ...
 *     ?ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z @ 0x1C011C5E8 (-ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z.c)
 */
        ...
        unsigned __int8 a7)
{
  ...
  *((_DWORD *)DeferredContext + 68) = _InterlockedIncrement((volatile signed __int32 *)(qword_1C00E44F8 + 8236));
  if ( a7 )
    ndisInitPDQAWM(DeferredContext);
  Dispatch = a2->Dispatch;
  v17.m_State = Unlocked;
  a2->PDPlatformReserved[0] = (void *)Dispatch;
  a2->Dispatch = (const _NDIS_PD_QUEUE_DISPATCH *)&unk_1C00C8950;
  v17.m_Lock = (KPushLockBase *)qword_1C00E44F8;
