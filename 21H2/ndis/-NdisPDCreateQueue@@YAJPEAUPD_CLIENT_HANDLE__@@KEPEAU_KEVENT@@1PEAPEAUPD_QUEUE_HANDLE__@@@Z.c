/*
 * XREFs of ?NdisPDCreateQueue@@YAJPEAUPD_CLIENT_HANDLE__@@KEPEAU_KEVENT@@1PEAPEAUPD_QUEUE_HANDLE__@@@Z @ 0x1C011A0A0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qqd @ 0x1C0015590 (WPP_RECORDER_SF_qqd.c)
 *     memset @ 0x1C00403C0 (memset.c)
 *     WPP_RECORDER_SF_qddqq @ 0x1C007F000 (WPP_RECORDER_SF_qddqq_ea_1C007F000.c)
