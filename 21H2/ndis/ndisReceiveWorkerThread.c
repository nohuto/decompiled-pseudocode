/*
 * XREFs of ndisReceiveWorkerThread @ 0x1C0037490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisPeriodicReceivesGetTimerPeriod @ 0x1C00A39F8 (ndisPeriodicReceivesGetTimerPeriod.c)
...
int *__fastcall ndisReceiveWorkerThread(ULONG a1)
{
  ...
  v2 = (KSPIN_LOCK *)((char *)qword_1C00E4100 + 64 * (unsigned __int64)a1);
  ...
  while ( 1 )
  {
    ...
    if ( v6 == v2 )
    {
      *((_DWORD *)qword_1C00E40F8 + a1) = 0;
      KeCancelTimer((PKTIMER)((char *)qword_1C00E40F0 + v8));
    }
    else
    {
      v9.QuadPart = ndisPeriodicReceivesGetTimerPeriod(v5, v8);
      KeSetTimer((PKTIMER)((char *)qword_1C00E40F0 + v10), v9, (PKDPC)((char *)qword_1C00E40F0 + v10 + 64));
    }
