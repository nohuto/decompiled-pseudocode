/*
 * XREFs of ?ndisOidPreMiniportStats@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C009CD80
 * Callers:
 *     <none>
 * Callees:
 *     memset @ 0x1C00403C0 (memset.c)
 *     ?ndisOidGetStatisticAllProcessors@@YAEPEAU_NDIS_MINIPORT_STATS@@KPEA_K@Z @ 0x1C009B7A0 (-ndisOidGetStatisticAllProcessors@@YAEPEAU_NDIS_MINIPORT_STATS@@KPEA_K@Z.c)
 */
...
char __fastcall ndisOidPreMiniportStats(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  if ( !v4 && *(_BYTE *)(v5 + 32) < 6u )
  {
    if ( !*(_QWORD *)v3 )
      return v2;
    if ( ndisOidGetStatisticAllProcessors(*(struct _NDIS_MINIPORT_STATS **)(v5 + 3152), v6, &v15) != 1 )
    {
      v9 = v15;
LABEL_15:
      v10 = *(_DWORD *)(v1 + 48);
