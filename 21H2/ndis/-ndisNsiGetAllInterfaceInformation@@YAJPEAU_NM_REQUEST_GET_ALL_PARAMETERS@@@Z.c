/*
 * XREFs of ?ndisNsiGetAllInterfaceInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C000C870
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    ...
    if ( v16 < dword_1C00E6160 )
    {
      v10 = 0;
      v157 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E4AF0);
      if ( v16 < dword_1C00E6160 )
        v10 = *((_DWORD *)P + 6 * v16);
      KeReleaseSpinLock(&qword_1C00E4AF0, v157);
      if ( !v10 )
        v10 = 1;
    }
    else
  ...
  if ( qword_1C00E4B00 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E4B00 )
  {
    while ( *((_DWORD *)v20 + 4) != v12 )
    {
      if ( *((_DWORD *)v20 + 4) <= v12 )
      {
        ...
        if ( v20 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E4B00 )
          continue;
      }
      goto LABEL_19;
    }
