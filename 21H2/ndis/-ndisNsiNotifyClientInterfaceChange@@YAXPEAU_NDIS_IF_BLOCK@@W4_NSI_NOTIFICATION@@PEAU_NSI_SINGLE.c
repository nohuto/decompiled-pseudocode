/*
 * XREFs of ?ndisNsiNotifyClientInterfaceChange@@YAXPEAU_NDIS_IF_BLOCK@@W4_NSI_NOTIFICATION@@PEAU_NSI_SINGLE_PARAM_DESC@@W4_NDIS_NSI_OBJECT_INDEX@@@Z @ 0x1C00FD9BC
 * Callers:
...
char __fastcall ndisNsiNotifyClientInterfaceChange(__int64 a1, int a2, __int64 a3, __int16 a4)
{
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v13[1] = a1 + 1312;
    ...
    result = (*(__int64 (__fastcall **)(_OWORD *))(qword_1C00E49E0 + 8))(v13);
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v12) = a2;
