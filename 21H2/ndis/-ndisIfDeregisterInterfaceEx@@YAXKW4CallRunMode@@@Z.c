/*
 * XREFs of ?ndisIfDeregisterInterfaceEx@@YAXKW4CallRunMode@@@Z @ 0x1C00B1964
 * Callers:
 ...
 *     ?ndisIfFindInterface@@YAPEAU_NDIS_IF_BLOCK@@K@Z @ 0x1C0025ADC (-ndisIfFindInterface@@YAPEAU_NDIS_IF_BLOCK@@K@Z.c)
