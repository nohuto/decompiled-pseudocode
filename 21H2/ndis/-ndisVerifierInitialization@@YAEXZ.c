/*
 * XREFs of ?ndisVerifierInitialization@@YAEXZ @ 0x1C003A314
 * Callers:
  ...
  if ( MmIsVerifierEnabled(&VerifierFlags) >= 0 )
  {
    ...
    if ( ndisVerifierWdmDispatch )
    {
      ...
      if ( ndisVerifierNdisDispatch )
      {
        ...
        {
          qword_1C00E6288 = (__int64)&ndisMiniportTrackAllocList;
          ndisMiniportTrackAllocList.Flink = &ndisMiniportTrackAllocList;
          qword_1C00E6278 = (__int64)&ndisDriverTrackAllocList;
