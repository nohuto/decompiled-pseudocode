 ...
 *     NdisWdfCreateIrpHandler @ 0x1C0061D50 (NdisWdfCreateIrpHandler.c)
 * Callees:
...
LABEL_19:
    ...
    {
      v19 = 0;
      v61 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E4AF0);
      if ( ThreadSessionId < dword_1C00E6160 )
        v19 = *((_DWORD *)P + 6 * ThreadSessionId);
      KeReleaseSpinLock(&qword_1C00E4AF0, v61);
      if ( !v19 )
        v19 = 1;
    }
    else
  ...
  if ( qword_1C00E4B00 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E4B00 )
  {
    while ( *((_DWORD *)v26 + 4) != v20 )
    {
      if ( *((_DWORD *)v26 + 4) <= v20 )
      {
        ...
        if ( v26 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E4B00 )
          continue;
      }
      goto LABEL_27;
    }
