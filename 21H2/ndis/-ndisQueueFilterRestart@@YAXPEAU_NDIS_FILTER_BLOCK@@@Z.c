/*
 * XREFs of ?ndisQueueFilterRestart@@YAXPEAU_NDIS_FILTER_BLOCK@@@Z @ 0x1C0116790
 * Callers:
 *     NdisFRestartFilter @ 0x1C006AE00 (NdisFRestartFilter.c)
 *     ?ndisQueuedRestartFilter@@YAXPEAX@Z @ 0x1C01168C0 (-ndisQueuedRestartFilter@@YAXPEAX@Z.c)
 * Callees:
