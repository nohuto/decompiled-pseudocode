/*
 * XREFs of ?ndisOidPMRemove@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_OID_REQUEST@@@Z @ 0x1C0090F64
 * Callers:
 ...
 *     WPP_RECORDER_SF_sL @ 0x1C0096BF0 (WPP_RECORDER_SF_sL.c)
