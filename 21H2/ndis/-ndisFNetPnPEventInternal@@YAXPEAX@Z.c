/*
 * XREFs of ?ndisFNetPnPEventInternal@@YAXPEAX@Z @ 0x1C0015830
 * Callers:
 ...
 *     ?ndisShallowCopyNetPnPEvent@@YAXPEAU_NET_PNP_EVENT_NOTIFICATION@@PEBU1@@Z @ 0x1C00FDF80 (-ndisShallowCopyNetPnPEvent@@YAXPEAU_NET_PNP_EVENT_NOTIFICATION@@PEBU1@@Z.c)
