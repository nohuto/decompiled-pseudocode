/*
 * XREFs of NdisCoOidRequest @ 0x1C00BA100
 * Callers:
        ...
        PNDIS_OID_REQUEST OidRequest)
{
  ...
  NDIS_STATUS v11; // ebx
  void *v12; // rsi
  __int64 (__fastcall *v13)(__int64, __int64, __int64, PVOID); // rbx
  __int64 v15; // rax
  __int64 v16; // rax
  ...
  __int64 (__fastcall *v23)(__int64, __int64, __int64, PVOID); // [rsp+40h] [rbp-48h] BYREF
  ...
  if ( NdisAfHandle )
  {
    ...
    *(_DWORD *)&v9->NdisReserved[16] |= 8u;
    ...
    if ( *((NDIS_HANDLE *)NdisAfHandle + 46) == NdisBindingHandle )
    {
      ...
      {
        v13 = *(__int64 (__fastcall **)(__int64, __int64, __int64, PVOID))(*((_QWORD *)NdisAfHandle + 3) + 120LL);
        v23 = v13;
      }
      else
      {
...
LABEL_28:
    ...
    else
    {
      ...
      {
        v13 = (__int64 (__fastcall *)(__int64, __int64, __int64, PVOID))*((_QWORD *)NdisAfHandle + 10);
        v23 = v13;
      }
      else
      {
