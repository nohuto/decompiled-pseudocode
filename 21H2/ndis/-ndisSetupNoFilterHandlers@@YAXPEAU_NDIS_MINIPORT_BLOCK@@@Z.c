/*
 * XREFs of ?ndisSetupNoFilterHandlers@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C003891C
 * Callers:
...
void __fastcall ndisSetupNoFilterHandlers(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( v2 )
  {
    v5 = (void (__fastcall *)(void *, void *))NdisQueryOffloadState;
    v6 = (MajorNdisVersion < 6u) + 1;
  }
  else
  {
    a1->NextSendNetBufferListsHandler = SendNetBufferListsHandler;
    v5 = (void (__fastcall *)(void *, void *))NdisCancelSendPackets;
    v6 = (MajorNdisVersion < 6u) + 1;
    a1->SendPathType = v6;
  }
