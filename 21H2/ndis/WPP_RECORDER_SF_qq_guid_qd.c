/*
 * XREFs of WPP_RECORDER_SF_qq_guid_qd @ 0x1C0062A0C
 * Callers:
...
__int64 WPP_RECORDER_SF_qq_guid_qd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 1) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_66115b70b0283e09187d30b01541a16f_Traceguids,
      0x95u,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 149;
  return WppAutoLogTrace(a1, 4LL, 1LL, &WPP_66115b70b0283e09187d30b01541a16f_Traceguids, v7, (__int64 *)va);
}
