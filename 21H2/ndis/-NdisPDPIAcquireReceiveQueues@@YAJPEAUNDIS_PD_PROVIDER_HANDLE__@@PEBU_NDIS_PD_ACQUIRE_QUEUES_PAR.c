/*
 * XREFs of ?NdisPDPIAcquireReceiveQueues@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_ACQUIRE_QUEUES_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@PEAKPEAU_NDIS_PD_QUEUE_PARAMETERS@@33@Z @ 0x1C011A630
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00400D0 (_guard_dispatch_icall_nop.c)
 *     ?ndisGetNextPDCounterId@@YAKXZ @ 0x1C007D598 (-ndisGetNextPDCounterId@@YAKXZ.c)
 *     WPP_RECORDER_SF_qddS @ 0x1C007EC4C (WPP_RECORDER_SF_qddS.c)
 *     WPP_RECORDER_SF_qddd @ 0x1C007EDDC (WPP_RECORDER_SF_qddd_ea_1C007EDDC.c)
 ...
 *     ??0NDIS_PD_QUEUE_TRACKER@@QEAA@XZ @ 0x1C01190B4 (--0NDIS_PD_QUEUE_TRACKER@@QEAA@XZ.c)
        ...
        unsigned int *a7)
{
  ...
  v34.m_Lock = (KPushLockBase *)qword_1C00E44F8;
