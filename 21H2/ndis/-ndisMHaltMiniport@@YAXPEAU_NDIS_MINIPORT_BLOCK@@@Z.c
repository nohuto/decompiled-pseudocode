/*
 * XREFs of ?ndisMHaltMiniport@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C006CC2C
 * Callers:
 ...
 *     ?ndisCloseULongRef@@YAEPEAU_ULONG_REFERENCE@@@Z @ 0x1C00AB970 (-ndisCloseULongRef@@YAEPEAU_ULONG_REFERENCE@@@Z.c)
