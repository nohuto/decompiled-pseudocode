/*
 * XREFs of ?ndisSendPacketsWithPause@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C00C47C0
 * Callers:
 *     ?ndisSendWithPause@@YAHPEAXPEAU_NDIS_PACKET@@@Z @ 0x1C00C4AA0 (-ndisSendWithPause@@YAHPEAXPEAU_NDIS_PACKET@@@Z.c)
 * Callees:
