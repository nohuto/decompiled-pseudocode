/*
 * XREFs of ?ndisMSetOffloadAttributes@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@1PEAU_NDIS_TCP_CONNECTION_OFFLOAD@@2@Z @ 0x1C0024BC4
 * Callers:
 ...
 *     ?ndisValidateOffloadCapability@@YAEPEAU_NDIS_OFFLOAD@@@Z @ 0x1C0024BA4 (-ndisValidateOffloadCapability@@YAEPEAU_NDIS_OFFLOAD@@@Z.c)
 ...
 *     ?ndisValidateConnectionOffload@@YAEPEAU_NDIS_TCP_CONNECTION_OFFLOAD@@@Z @ 0x1C008F228 (-ndisValidateConnectionOffload@@YAEPEAU_NDIS_TCP_CONNECTION_OFFLOAD@@@Z.c)
 */
