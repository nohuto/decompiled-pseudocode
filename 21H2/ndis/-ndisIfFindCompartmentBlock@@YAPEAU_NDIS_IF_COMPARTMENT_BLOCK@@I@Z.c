 ...
 *     ndisConvertIdentifierForCompartment @ 0x1C0062B44 (ndisConvertIdentifierForCompartment.c)
 *     ndisIfGetCompartmentJobObject @ 0x1C00B0944 (ndisIfGetCompartmentJobObject.c)
 ...
 *     ?ndisIfGetCompartmentNamespaceGuid@@YAJIPEAU_GUID@@@Z @ 0x1C00B2EEC (-ndisIfGetCompartmentNamespaceGuid@@YAJIPEAU_GUID@@@Z.c)
...
struct _NDIS_IF_COMPARTMENT_BLOCK *__fastcall ndisIfFindCompartmentBlock(unsigned int a1)
{
  ...
  v1 = qword_1C00E4B00;
  v2 = 0LL;
  while ( v1 != (struct _NDIS_IF_COMPARTMENT_BLOCK *)&qword_1C00E4B00 )
  {
    if ( *((_DWORD *)v1 + 4) == a1 )
      return v1;
    if ( *((_DWORD *)v1 + 4) > a1 )
