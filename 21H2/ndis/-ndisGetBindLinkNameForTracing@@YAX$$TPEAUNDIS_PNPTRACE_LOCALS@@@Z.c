/*
 * XREFs of ?ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z @ 0x1C012306C
 * Callers:
...
void __fastcall ndisGetBindLinkNameForTracing(__int64 a1, struct NDIS_PNPTRACE_LOCALS *a2)
{
  *(_QWORD *)a2 = 0LL;
  *((_QWORD *)a2 + 1) = 0LL;
}
