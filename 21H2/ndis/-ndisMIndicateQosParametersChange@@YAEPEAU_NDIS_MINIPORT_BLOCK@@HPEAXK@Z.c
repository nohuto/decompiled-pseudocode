/*
 * XREFs of ?ndisMIndicateQosParametersChange@@YAEPEAU_NDIS_MINIPORT_BLOCK@@HPEAXK@Z @ 0x1C006F574
 * Callers:
 ...
 *     WPP_RECORDER_SF_LLLLLLLL @ 0x1C0072564 (WPP_RECORDER_SF_LLLLLLLL.c)
 *     WPP_RECORDER_SF_qDqL @ 0x1C0072B98 (WPP_RECORDER_SF_qDqL.c)
 *     ?NdisTraceLoggingQosOperationalStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C008C0F4 (-NdisTraceLoggingQosOperationalStatus@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
...
LABEL_43:
    if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
    {
      ...
      v10 = 2;
LABEL_45:
      WPP_RECORDER_SF_(v8[8], v10, 0x18u, v9, (struct _GUID *)&WPP_155eeae1e7503765e0b6eba6f413c090_Traceguids);
    }
    return 0;
  }
