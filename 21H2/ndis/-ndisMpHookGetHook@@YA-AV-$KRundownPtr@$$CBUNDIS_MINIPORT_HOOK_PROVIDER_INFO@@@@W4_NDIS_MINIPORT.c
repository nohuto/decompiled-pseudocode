/*
 * XREFs of ?ndisMpHookGetHook@@YA?AV?$KRundownPtr@$$CBUNDIS_MINIPORT_HOOK_PROVIDER_INFO@@@@W4_NDIS_MINIPORT_HOOK_DRIVER_TYPE@@@Z @ 0x1C0126208
 * Callers:
 *     NdisMRegisterWdiMiniportDriver @ 0x1C0125E10 (NdisMRegisterWdiMiniportDriver.c)
 * Callees:
 *     ?TryAcquire@KRundownBase@@QEAA_NXZ @ 0x1C00AC5C0 (-TryAcquire@KRundownBase@@QEAA_NXZ.c)
 *     ??1KLockHolder@@QEAA@XZ @ 0x1C00FE410 (--1KLockHolder@@QEAA@XZ.c)
 *     ?AcquireShared@KLockHolder@@QEAAXXZ @ 0x1C01055BC (-AcquireShared@KLockHolder@@QEAAXXZ.c)
 */
