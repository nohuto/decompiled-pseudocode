/*
 * XREFs of ?ndisMDoOidRequest@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C000BB00
 * Callers:
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)&p_Blink->NdisReserved[16] &= ~4u;
    ...
    if ( !p_Blink->PortNumber || (LODWORD(v22) = v22->InfoFlags, ((unsigned __int16)v22 & 0x200) == 0) )
    {
      ...
      {
        v11 = 3LL * v21;
        LODWORD(v22) = *((_DWORD *)&unk_1C00C7330 + 6 * v21);
          ...
          if ( (_DWORD)v22 == v23 )
          {
            ...
            *(_QWORD *)&v49 = p_Blink;
            ...
            if ( ((unsigned int)v22 & 0x840080) == 0 )
            {
              ...
              v25 = (__int64 (__fastcall *)(__int128 *))*((_QWORD *)&unk_1C00C7330
