/*
 * XREFs of NdisIfFreeNetLuidIndex @ 0x1C0126660
 * Callers:
 ...
 * Callees:
 *     WPP_RECORDER_SF_dl @ 0x1C00B17CC (WPP_RECORDER_SF_dl_ea_1C00B17CC.c)
 *     WPP_RECORDER_SF_dlL @ 0x1C00B1888 (WPP_RECORDER_SF_dlL.c)
...
LABEL_13:
  ...
  {
    for ( i = qword_1C00E5F18; (__int64 *)i != &qword_1C00E5F18; i = *(_QWORD *)i )
    {
