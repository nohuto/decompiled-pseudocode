/*
 * XREFs of ?ndisIfFindInterfaceByInterfaceGuid@@YAPEAU_NDIS_IF_BLOCK@@PEBU_GUID@@@Z @ 0x1C00215C0
 * Callers:
 *     ?IsIfBlockAvailable@@YA_NAEBU_GUID@@@Z @ 0x1C005F7C0 (-IsIfBlockAvailable@@YA_NAEBU_GUID@@@Z.c)
