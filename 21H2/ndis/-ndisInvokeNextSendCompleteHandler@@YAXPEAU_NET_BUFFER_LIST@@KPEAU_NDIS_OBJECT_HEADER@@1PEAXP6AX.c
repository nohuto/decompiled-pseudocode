/*
 * XREFs of ?ndisInvokeNextSendCompleteHandler@@YAXPEAU_NET_BUFFER_LIST@@KPEAU_NDIS_OBJECT_HEADER@@1PEAXP6AX20K@Z@Z @ 0x1C00693F8
 * Callers:
  ...
  if ( ndisIterativeDataPathDisabled || (a2 & 1) == 0 && (CurrentIrql = KeGetCurrentIrql(), (_BYTE)CurrentIrql != 2) )
  {
    if ( a3->Header.Type == 5 )
    {
      ...
      if ( KeExpandKernelStackAndCalloutEx(
             ...
             0,
             0LL) < 0 )
        ndisQueueStackExpansionFallbackNbls(a3, v9, 1u);
      return;
    }
LABEL_21:
  ...
  if ( v13 )
  {
    while ( *v10 )
    {
      ...
      *(_BYTE *)(v15 + 40) = 0;
      ...
      v11 = *(void (**)(void))&v14[116].Type;
      v12 = *(void **)&v14[118].Type;
      CurrentIrql = v22;
      if ( v7->Type != 5 )
      {
