/*
 * XREFs of ndisBindBuilderLoadSettings @ 0x1C014355C
 * Callers:
...
LABEL_8:
        ...
        if ( !ValueString )
        {
          Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_1C00E4598, *((_WORD **)P + 1));
          *((_QWORD *)qword_1C00E4598 + 11) = Atom;
          if ( Atom )
            goto LABEL_8;
          v3 = -1073741670;
        }
