/*
 * XREFs of ?ndisPcwGetECInstanceName@@YAJPEAXKPEAU_UNICODE_STRING@@@Z @ 0x1C011D35C
 * Callers:
...
__int64 __fastcall ndisPcwGetECInstanceName(char *a1, int a2, struct _UNICODE_STRING *a3)
{
  ...
  v5 = RtlStringCbPrintfW((wchar_t *)SourceString, 0x202uLL, (wchar_t *)L"%wZ: EC %u", v4, a2);
  if ( v5 < 0 )
