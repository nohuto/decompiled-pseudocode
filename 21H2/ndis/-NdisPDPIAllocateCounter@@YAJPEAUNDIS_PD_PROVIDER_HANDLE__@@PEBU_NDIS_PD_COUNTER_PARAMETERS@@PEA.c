/*
 * XREFs of ?NdisPDPIAllocateCounter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_COUNTER_PARAMETERS@@PEAPEAUNDIS_PD_COUNTER_HANDLE__@@@Z @ 0x1C011AB10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_RECORDER_SF_qdSS @ 0x1C007EA70 (WPP_RECORDER_SF_qdSS.c)
