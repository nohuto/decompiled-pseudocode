/*
 * XREFs of ?ndisPplAllocate@@YAPEAXPEAUPPL_POOL_HANDLE__@@KPEAK@Z @ 0x1C0018154
 * Callers:
 *     NdisAllocateNetBuffer @ 0x1C0018080 (NdisAllocateNetBuffer.c)
 * Callees:
 *     ndisPplLazyInitializeLookaside @ 0x1C0004324 (ndisPplLazyInitializeLookaside.c)
 *     ndisAllocateFromLookasideList @ 0x1C0018298 (ndisAllocateFromLookasideList.c)
 *     ndisAllocateFromNPagedPool @ 0x1C0018300 (ndisAllocateFromNPagedPool.c)
 */
