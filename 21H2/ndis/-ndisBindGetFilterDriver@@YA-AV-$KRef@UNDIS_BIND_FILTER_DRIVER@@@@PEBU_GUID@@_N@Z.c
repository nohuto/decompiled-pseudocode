/*
 * XREFs of ?ndisBindGetFilterDriver@@YA?AV?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@PEBU_GUID@@_N@Z @ 0x1C0102A74
 * Callers:
...
_QWORD *__fastcall ndisBindGetFilterDriver(_QWORD *a1, _QWORD *a2, char a3)
{
  ...
  v21.m_Lock = (KPushLockBase *)qword_1C00E4518;
  v21.m_Region.m_Entered = 0;
  KLockHolder::AcquireExclusive(&v21);
  v6 = qword_1C00E4518;
  v7 = 0LL;
  v8 = *(unsigned int *)(qword_1C00E4518 + 28);
  v20 = v8;
  while ( v7 != v8 )
  {
    ...
    *(_OWORD *)((char *)P + 24) = *(_OWORD *)a2;
    if ( ndisBindReadFilterDriverConfiguration(v14) )
    {
      ...
      if ( (unsigned __int8)Rtl::KArray<KRef<NDIS_BIND_FILTER_DRIVER>,1>::grow(
                              qword_1C00E4518 + 24,
                              (unsigned int)(*(_DWORD *)(qword_1C00E4518 + 28) + 1)) )
      {
