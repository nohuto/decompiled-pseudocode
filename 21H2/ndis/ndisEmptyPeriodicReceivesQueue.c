/*
 * XREFs of ndisEmptyPeriodicReceivesQueue @ 0x1C00A2C78
 * Callers:
 ...
 *     ndisTracePeriodicReceivesStart @ 0x1C00A43A8 (ndisTracePeriodicReceivesStart.c)
 */
