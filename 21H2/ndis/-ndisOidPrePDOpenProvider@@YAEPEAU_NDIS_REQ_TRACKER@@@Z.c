/*
 * XREFs of ?ndisOidPrePDOpenProvider@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C011CA10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_RECORDER_SF_qqdqqS @ 0x1C007F684 (WPP_RECORDER_SF_qqdqqS.c)
 *     WPP_RECORDER_SF_qqqqDd @ 0x1C007F86C (WPP_RECORDER_SF_qqqqDd.c)
 *     WPP_RECORDER_SF_qqqqq @ 0x1C007FAD8 (WPP_RECORDER_SF_qqqqq.c)
 ...
 *     ?ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z @ 0x1C011C5C8 (-ndisGetClientDriverHandleFromRequestSourceHandle@@YAPEAXPEAX@Z.c)
 */
...
LABEL_41:
  ...
  v30.m_Lock = (KPushLockBase *)qword_1C00E44F8;
  ...
  *(_QWORD *)(v25 + 8) = v24;
  ...
  if ( (_UNKNOWN *)v2[10] == &unk_1C00C8A70 )
    *((_BYTE *)v2 + 88) = 1;
  if ( *(int **)&WPP_RECORDER_INITIALIZED != &WPP_RECORDER_INITIALIZED )
  {
    v28 = L"PASS_THROUGH";
