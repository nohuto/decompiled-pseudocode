/*
 * XREFs of NdisIfAddIfStackEntry @ 0x1C0025910
 * Callers:
 ...
 *     WPP_RECORDER_SF_llL @ 0x1C002607C (WPP_RECORDER_SF_llL.c)
 *     ndisIfFindStackEntry @ 0x1C0026120 (ndisIfFindStackEntry.c)
 *     ndisIfStackTablePathExist @ 0x1C0026150 (ndisIfStackTablePathExist.c)
...
NDIS_STATUS __stdcall NdisIfAddIfStackEntry(NET_IFINDEX HigherLayerIfIndex, NET_IFINDEX LowerLayerIfIndex)
{
  ...
  *((_DWORD *)PoolWithTag + 5) = v2;
  ...
  else
  {
    ...
    v5[4] = Interface;
    v10 = qword_1C00E4B28;
    if ( *((PVOID **)qword_1C00E4B28 + 1) != &qword_1C00E4B28 )
      __fastfail(3u);
    *v5 = qword_1C00E4B28;
    v5[1] = &qword_1C00E4B28;
    v10[1] = v5;
    qword_1C00E4B28 = v5;
    ++*(_DWORD *)(v9 + 1296);
