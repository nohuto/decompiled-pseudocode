/*
 * XREFs of ndisCreateReceiveWorkerThreadPool @ 0x1C0028FF8
 * Callers:
...
__int64 ndisCreateReceiveWorkerThreadPool()
{
  ...
  if ( ActiveProcessorCount )
  {
    while ( 1 )
    {
      Thread = ndisCreateThread(v2, (unsigned int)v1, (unsigned int)dword_1C00E40C8, (char *)qword_1C00E4108 + 8 * v1);
      if ( Thread < 0 )
        break;
