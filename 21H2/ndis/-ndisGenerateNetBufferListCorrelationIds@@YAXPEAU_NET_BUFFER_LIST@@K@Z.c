/*
 * XREFs of ?ndisGenerateNetBufferListCorrelationIds@@YAXPEAU_NET_BUFFER_LIST@@K@Z @ 0x1C00AE210
 * Callers:
 ...
 * Callees:
 *     ndisGenerateCorrelationIds @ 0x1C00AE1EC (ndisGenerateCorrelationIds.c)
 */
