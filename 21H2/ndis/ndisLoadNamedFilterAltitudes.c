/*
 * XREFs of ndisLoadNamedFilterAltitudes @ 0x1C0124EE4
 * Callers:
...
LABEL_8:
  ...
  else if ( !v0 )
  {
    ...
    if ( !ValueMultisz__lambda_145828208f54867cbf19e2ec96475ca0___lambda_669a078cee999b45033530b9c5ed1c6f____0 )
    {
      ...
      while ( 1 )
      {
        Atom = Rtl::KStringAtomTableBase<1>::GetAtom((__int64)qword_1C00E4598, *(_WORD **)&v2->Length);
        if ( !Atom || !Rtl::KArray<Rtl::_KStringAtom *,1>::append((__int64)qword_1C00E4598 + 72, &Atom) )
          break;
