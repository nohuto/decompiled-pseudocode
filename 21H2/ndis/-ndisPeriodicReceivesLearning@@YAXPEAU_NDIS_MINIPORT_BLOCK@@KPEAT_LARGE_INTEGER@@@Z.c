/*
 * XREFs of ?ndisPeriodicReceivesLearning@@YAXPEAU_NDIS_MINIPORT_BLOCK@@KPEAT_LARGE_INTEGER@@@Z @ 0x1C003F894
 * Callers:
        ...
        union _LARGE_INTEGER *a3)
{
  ...
  v11 = v8 + 1;
  if ( (unsigned int)(v8 + 1) >= 0xB || v4 >= 0x200 )
  {
    if ( !(_DWORD)v8 || v4 <= 0x300 )
      return;
    v11 = v8 - 1;
  }
  if ( v11 != 11 )
