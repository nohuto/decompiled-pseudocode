/*
 * XREFs of ?ndisFdoInitializeSubsystem@@YAJXZ @ 0x1C014630C
 * Callers:
 ...
 *     ?ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z @ 0x1C0109718 (-ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z.c)
 *     ?CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z @ 0x1C014646C (-CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z.c)
 */
