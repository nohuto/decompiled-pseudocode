/*
 * XREFs of ndisUnloadPeriodicReceives @ 0x1C0147320
 * Callers:
  ...
  *(_WORD *)&LockState.OldIrql = 0;
  ...
  if ( Lock )
  {
    ...
    if ( ndisPeriodicReceives == 1 )
    {
      ...
      ExDeleteNPagedLookasideList(&stru_1C00E41C0);
  ...
  if ( qword_1C00E4108 )
  {
    ExFreePoolWithTag(qword_1C00E4108, 0);
    qword_1C00E4108 = 0LL;
  }
  if ( qword_1C00E4100 )
  {
    ExFreePoolWithTag(qword_1C00E4100, 0);
    qword_1C00E4100 = 0LL;
  }
  if ( qword_1C00E40F8 )
  {
    ExFreePoolWithTag(qword_1C00E40F8, 0);
    qword_1C00E40F8 = 0LL;
  }
  if ( qword_1C00E40F0 )
  {
    ExFreePoolWithTag(qword_1C00E40F0, 0);
    qword_1C00E40F0 = 0LL;
  }
}
