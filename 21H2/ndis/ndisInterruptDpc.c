/*
 * XREFs of ndisInterruptDpc @ 0x1C00077E0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( dword_1C00E40C4 != -1 && MiniportSupportsReceiveThrottle(v4)
  ...
  {
    ndisQueueDpcWorkItem(v8, (_DWORD)v7, v12, (_DWORD)SystemArgument2, byte_1C00E40C1);
    return;
  }
...
LABEL_40:
  ...
  ndisQueueDpcWorkItem((_DWORD)v36, (_DWORD)v7, v21, (_DWORD)SystemArgument2, byte_1C00E40C1);
LABEL_28:
  if ( v15 )
  {
