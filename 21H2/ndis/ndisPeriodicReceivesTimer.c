/*
 * XREFs of ndisPeriodicReceivesTimer @ 0x1C00A3A10
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemSpecific3)
{
  ...
  v4 = 0LL;
  v5 = (char *)qword_1C00E4100 + 64 * (unsigned __int64)KeGetPcr()->Prcb.Number;
  ...
  *v4 = 0LL;
  ...
  {
LABEL_5:
    *((_DWORD *)qword_1C00E40F8 + KeGetPcr()->Prcb.Number) = 0;
  }
  else
  {
    v8.QuadPart = qword_1C00E40E8;
    if ( !qword_1C00E40E8 )
      v8.QuadPart = -1LL;
    KeSetTimer(
  ...
  if ( v4 )
  {
    if ( (_BYTE)word_1C00E6154 )
    {
      ...
      *(_OWORD *)&v17.m256i_u64[2] = 0LL;
      ...
      WnodeEventItem = 56;
      v17.m256i_i64[0] = 0LL;
      *(_QWORD *)((char *)&v16 + 6) = qword_1C00E6148;
    ...
    if ( (_BYTE)word_1C00E6154 )
    {
      ...
      v10 = 48;
      *(_QWORD *)v12 = 0LL;
      *(_QWORD *)((char *)&v11 + 6) = qword_1C00E6148;
