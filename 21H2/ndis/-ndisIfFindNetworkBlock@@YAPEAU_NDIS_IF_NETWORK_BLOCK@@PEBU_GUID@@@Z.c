/*
 * XREFs of ?ndisIfFindNetworkBlock@@YAPEAU_NDIS_IF_NETWORK_BLOCK@@PEBU_GUID@@@Z @ 0x1C002C0DC
 * Callers:
 ...
 * Callees:
 *     ndisCompareGuid @ 0x1C002C144 (ndisCompareGuid.c)
 */
...
struct _NDIS_IF_NETWORK_BLOCK *__fastcall ndisIfFindNetworkBlock(const struct _GUID *a1)
{
  ...
  v1 = (__int64 *)qword_1C00E4B10;
  v3 = 0LL;
  while ( v1 != &qword_1C00E4B10 )
  {
