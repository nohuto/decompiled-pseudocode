/*
 * XREFs of ?NdisPDStartEC@@YAJPEAUPD_CLIENT_HANDLE__@@PEAPEAUPD_EC_HANDLE__@@@Z @ 0x1C011BEE0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GNDIS_PD_EC@@QEAAPEAXI@Z @ 0x1C01191DC (--_GNDIS_PD_EC@@QEAAPEAXI@Z.c)
    ...
    *((_DWORD *)v6 + 8) = CurrentThreadId;
    ...
    else
    {
      ...
      *((_QWORD *)v6 + 3) = CurrentThread;
      ...
      v12.m_Lock = (KPushLockBase *)qword_1C00E44F8;
