/*
 * XREFs of WPP_RECORDER_SF__guid_ZDDDDDDDDDDDDDDDDDDDDDDDD @ 0x1C00A9450
 * Callers:
        ...
        char a31)
{
  ...
  LOWORD(v36) = 45;
  return WppAutoLogTrace(a1, 4LL, 15LL, &WPP_2a2dccd345f53e67cf9f0e5760ed0100_Traceguids, v36, a6);
}
