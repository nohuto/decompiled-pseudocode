/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1C011765C
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x1C0144FAC (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C003DA60 (__security_check_cookie.c)
 *     memset @ 0x1C00403C0 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x1C0147300 (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
