/*
 * XREFs of ?ndisGetPerformanceCounters@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z @ 0x1C006BB4C
 * Callers:
    ...
    if ( MiniportDataBlock )
    {
      ...
      if ( LODWORD(v10.MasterIrp->ThreadListEntry.Flink) )
      {
        ...
        do
        {
          ...
          v19 = (_IO_STATUS_BLOCK *)((char *)v14 + v16 + v15 * ndisPcwPerCpuDataStride);
          do
          {
            v20 = *v19;
            v19 += 8;
