/*
 * XREFs of ?ndisIfReadNetworkGuidFromKey@@YAJAEAVKRegKey@@PEAU_GUID@@@Z @ 0x1C0026E00
 * Callers:
 ...
 *     ??0NetSetupPropertyBag@@QEAA@AEAVKRegKey@@@Z @ 0x1C00F8978 (--0NetSetupPropertyBag@@QEAA@AEAVKRegKey@@@Z.c)
