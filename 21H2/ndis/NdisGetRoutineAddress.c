/*
 * XREFs of NdisGetRoutineAddress @ 0x1C003CE00
 * Callers:
 *     ?ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z @ 0x1C00ABE40 (-ndisVerifierGetRoutineAddress@@YAPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
 *     FindExportedRoutineByName @ 0x1C003CE68 (FindExportedRoutineByName.c)
 */
