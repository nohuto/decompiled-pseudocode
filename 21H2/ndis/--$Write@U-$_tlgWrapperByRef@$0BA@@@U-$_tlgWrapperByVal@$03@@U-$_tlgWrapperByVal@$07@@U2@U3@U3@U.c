        ...
        __int64 *a32)
{
  ...
  int v33; // ecx
  _EVENT_DATA_DESCRIPTOR v35; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v39 = 4LL;
  v37 = 16LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00E3108, a2, 0LL, 0LL, 0x1Fu, &v35);
}
