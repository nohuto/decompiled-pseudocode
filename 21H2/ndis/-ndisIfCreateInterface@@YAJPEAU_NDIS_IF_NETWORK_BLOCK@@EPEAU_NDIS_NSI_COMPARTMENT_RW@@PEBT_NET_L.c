/*
 * XREFs of ?ndisIfCreateInterface@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@EPEAU_NDIS_NSI_COMPARTMENT_RW@@PEBT_NET_LUID_LH@@PEBU_GUID@@PEBUNdisNetworkInterfacePersistedState@@PEAU_NDIS_FILTER_BLOCK@@W4NdisIfBlockSource@@@Z @ 0x1C0105748
 * Callers:
 ...
 *     WPP_RECORDER_SF_qqqqL @ 0x1C002C344 (WPP_RECORDER_SF_qqqqL.c)
 *     ?ndisIfNdisProviderGetHandle@@YAPEAX_N@Z @ 0x1C002C41C (-ndisIfNdisProviderGetHandle@@YAPEAX_N@Z.c)
 ...
 *     NdisIfAllocateNetLuidIndexEx @ 0x1C0126630 (NdisIfAllocateNetLuidIndexEx.c)
...
LABEL_71:
          ...
          *(_QWORD *)(v13 + 632) = 1LL;
          if ( v44 )
          {
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00E45C2);
            ...
            *(_WORD *)(v13 + 48) = Destination.Length;
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00E47D2);
            *(_DWORD *)&Destination.Length = 0x2000000;
