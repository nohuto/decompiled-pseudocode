/*
 * XREFs of ndisIfRegisterInterfaceEx @ 0x1C002BA0C
 * Callers:
 *     NdisIfRegisterInterface @ 0x1C00B1D90 (NdisIfRegisterInterface.c)
 ...
 *     WPP_RECORDER_SF_Llq @ 0x1C002BEE8 (WPP_RECORDER_SF_Llq.c)
 ...
 *     WPP_RECORDER_SF_qllq @ 0x1C002C280 (WPP_RECORDER_SF_qllq.c)
...
LABEL_59:
  ...
  *(_OWORD *)(v12 + 135) = *(_OWORD *)(a4 + 52);
  ...
  if ( a1 == qword_1C00E60F0 || a1 == qword_1C00E60E8 )
  {
    v16 = 5LL;
    v17 = v12 + 144;
    v18 = (_OWORD *)(a4 + 96);
