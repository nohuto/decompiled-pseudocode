/*
 * XREFs of ?RtlUnicodeStringCopy@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z @ 0x1C0066168
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker_0 @ 0x1C0066248 (RtlUnicodeStringValidateWorker_0.c)
 */
