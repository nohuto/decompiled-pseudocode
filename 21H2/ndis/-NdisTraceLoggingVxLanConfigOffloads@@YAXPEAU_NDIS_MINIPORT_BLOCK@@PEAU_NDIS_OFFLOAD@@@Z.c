/*
 * XREFs of ?NdisTraceLoggingVxLanConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C001F3BC
 * Callers:
...
void __fastcall NdisTraceLoggingVxLanConfigOffloads(
