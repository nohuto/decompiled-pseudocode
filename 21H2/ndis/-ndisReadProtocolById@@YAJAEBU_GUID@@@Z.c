/*
 * XREFs of ?ndisReadProtocolById@@YAJAEBU_GUID@@@Z @ 0x1C01253E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1ProtocolBindProperties@@QEAA@XZ @ 0x1C00AC4D4 (--1ProtocolBindProperties@@QEAA@XZ.c)
...
__int64 __fastcall ndisReadProtocolById(const struct _GUID *a1)
{
  ...
  {
    m_ptr = (void **)&v5;
    v2 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D3588, (__int64)v9);
    if ( !v2 )
    {
      v2 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D34A0, (__int64)v11);
      if ( !v2 )
      {
        v2 = NetSetupPropertyBag::ReadString(
               (NetSetupPropertyBag *)&m_ptr,
               (const struct _NETSETUPPROPKEY *)&unk_1C00D35E8,
               &v8);
        if ( !v2 )
        {
          v2 = NetSetupPropertyBag::ReadBoolean(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D3570, &v13);
          if ( !v2 )
          {
            if ( Rtl::KArray<ProtocolBindProperties,1>::append((__int64)qword_1C00E4598 + 24, (__int64)&v7) )
              v2 = 0;
            else
              v2 = -1073741670;
          }
