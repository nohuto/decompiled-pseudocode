/*
 * XREFs of ?ndisOidPostPDOpenProvider@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C007D6E0
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisBugCheckEx@@YAX_K000@Z @ 0x1C005EE00 (-ndisBugCheckEx@@YAX_K000@Z.c)
 *     WPP_RECORDER_SF_qqqqd @ 0x1C007F9B0 (WPP_RECORDER_SF_qqqqd_ea_1C007F9B0.c)
...
void __fastcall ndisOidPostPDOpenProvider(struct _NDIS_REQ_TRACKER *a1, int a2, int a3, int a4)
{
  ...
  if ( !v7 && !*((_DWORD *)a1 + 10) && *(_UNKNOWN **)(v5 + 16) != &unk_1C00C8A70 )
