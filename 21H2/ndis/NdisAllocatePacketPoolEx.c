/*
 * XREFs of NdisAllocatePacketPoolEx @ 0x1C00326B0
 * Callers:
 *     ?ndisVerifierAllocatePacketPoolEx@@YAXPEAHPEAPEAXIII@Z @ 0x1C00ABD20 (-ndisVerifierAllocatePacketPoolEx@@YAXPEAHPEAPEAXIII@Z.c)
 *     NdisAllocatePacketPool @ 0x1C00C0F60 (NdisAllocatePacketPool.c)
 ...
 *     NdisPacketSize @ 0x1C0032CC0 (NdisPacketSize.c)
