/*
 * XREFs of ?ndisNblTrackerVerifyNoNblsHeld@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C0074600
 * Callers:
 ...
 *     ndisNblTrackerAreNblsOutstandingOnComponent @ 0x1C0073DD8 (ndisNblTrackerAreNblsOutstandingOnComponent.c)
 */
