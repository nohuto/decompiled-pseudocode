/*
 * XREFs of ?ndisGetPowerInfo@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAH@Z @ 0x1C006BD34
 * Callers:
 ...
 *     ?ndisXlateSSResume@@YA?AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z @ 0x1C006C620 (-ndisXlateSSResume@@YA-AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z.c)
 *     ?ndisGetListEntriesCount@@YAKPEAU_SINGLE_LIST_ENTRY@@@Z @ 0x1C008FEC8 (-ndisGetListEntriesCount@@YAKPEAU_SINGLE_LIST_ENTRY@@@Z.c)
 */
  ...
  if ( *((_BYTE *)CurrentStackLocation->FileObject->FsContext + 24) )
  {
    ...
    if ( Length >= 0x35C )
    {
      ...
      *((_DWORD *)&v9.MasterIrp[3].Tail.CompletionKey + 8) = a1->PMHardwareCapabilities.MediaSpecificWakeUpEvents;
      v31 = (unsigned int)(*((_DWORD *)&v9.MasterIrp[2].Tail.CompletionKey + 8) + 60);
      *((_DWORD *)&v9.MasterIrp[2].Tail.CompletionKey + 9) = v31;
      *(_OWORD *)((char *)&v9.MasterIrp->Type + v31) = *(_OWORD *)&a1->PMAdvertisedCapabilities.Header.Type;
      *(_OWORD *)((char *)&v9.MasterIrp->Flags + v31) = *(_OWORD *)&a1->PMAdvertisedCapabilities.MaxWoLPatternSize;
      *(_LIST_ENTRY *)((char *)&v9.MasterIrp->ThreadListEntry + v31) = *(_LIST_ENTRY *)&a1->PMAdvertisedCapabilities.NumArpOffloadIPv4Addresses;
      *(void **)((char *)&v9.MasterIrp->IoStatus.Pointer + v31) = *(void **)&a1->PMAdvertisedCapabilities.MinLinkChangeWakeUp;
      *(_DWORD *)((char *)&v9.MasterIrp->IoStatus.Information + (unsigned int)v31) = a1->PMAdvertisedCapabilities.MediaSpecificWakeUpEvents;
      v32 = (unsigned int)(*((_DWORD *)&v9.MasterIrp[2].Tail.CompletionKey + 9) + 60);
      *((_DWORD *)&v9.MasterIrp[2].Tail.CompletionKey + 10) = v32;
      *(_OWORD *)((char *)&v9.MasterIrp->Type + v32) = *(_OWORD *)&a1->PMCurrentParameters.Header.Type;
      *(unsigned int *)((char *)&v9.MasterIrp->Flags + (unsigned int)v32) = a1->PMCurrentParameters.MediaSpecificWakeUpEvents;
      v9.MasterIrp[3].Overlay.AllocationSize.LowPart = a1->LastWakeReason;
      SelectiveSuspend = a1->SelectiveSuspend;
      if ( SelectiveSuspend )
      {
        v34 = (MEMORY[0xFFFFF78000000014] - a1->TimeOfInitialization.QuadPart) / 10000 - a1->TotalSystemSleepTimeMs;
        LOBYTE(v36) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)a1->SelectiveSuspend);
        *(_DWORD *)&v9.MasterIrp[3].AllocationProcessorNumber = *((_DWORD *)SelectiveSuspend + 2);
        ...
        v37 = *((_QWORD *)SelectiveSuspend + 86);
        if ( (*((_DWORD *)SelectiveSuspend + 126) & 0x10) != 0 )
        {
          v35 = (MEMORY[0xFFFFF78000000014] - *((_QWORD *)SelectiveSuspend + 81)) / 10000LL;
          v37 += v35;
        }
        v38 = *((_DWORD *)SelectiveSuspend + 161);
        if ( v38 )
        {
          v9.MasterIrp[3].Flags = *((_QWORD *)SelectiveSuspend + 84) / (unsigned __int64)v38;
          v35 = v37 % *((unsigned int *)SelectiveSuspend + 161);
          v9.MasterIrp[3].AssociatedIrp.MasterIrp = (_IRP *)(v37 / *((unsigned int *)SelectiveSuspend + 161));
        }
        if ( v34 )
        {
          v35 = 100 * v37 % v34;
          LODWORD(v9.MasterIrp[3].ThreadListEntry.Flink) = 100 * v37 / v34;
        }
        ...
        KeReleaseSpinLock((PKSPIN_LOCK)SelectiveSuspend, v42);
      }
      AoAc = a1->AoAc;
      if ( AoAc )
      {
        HIDWORD(v9.MasterIrp[2].CancelRoutine) |= 0x80000u;
        v44 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)AoAc);
        ...
        KeReleaseSpinLock((PKSPIN_LOCK)AoAc, v44);
      }
