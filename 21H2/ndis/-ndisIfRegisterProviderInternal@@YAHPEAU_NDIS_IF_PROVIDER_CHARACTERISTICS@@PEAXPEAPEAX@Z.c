/*
 * XREFs of ?ndisIfRegisterProviderInternal@@YAHPEAU_NDIS_IF_PROVIDER_CHARACTERISTICS@@PEAXPEAPEAX@Z @ 0x1C0032E10
 * Callers:
  ...
  *a3 = 0LL;
  ...
  if ( v7 >= 0x58u && (PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, v7, 0x6669444Eu), (v9 = PoolWithTag) != 0LL) )
  {
    ...
    *((_WORD *)v9 + 1) = v7;
    ...
    v10 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E5F38);
    v11 = qword_1C00E5F28;
    v12 = v9 + 1;
    if ( *(__int64 **)(qword_1C00E5F28 + 8) != &qword_1C00E5F28 )
      __fastfail(3u);
    *v12 = qword_1C00E5F28;
    v9[2] = &qword_1C00E5F28;
    *(_QWORD *)(v11 + 8) = v12;
    qword_1C00E5F28 = (__int64)(v9 + 1);
    KeReleaseSpinLock(&qword_1C00E5F38, v10);
    *a3 = v9;
  }
  else
  {
