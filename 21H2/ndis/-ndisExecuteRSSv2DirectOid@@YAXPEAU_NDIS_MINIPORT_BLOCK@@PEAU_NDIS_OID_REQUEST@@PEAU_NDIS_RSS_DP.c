/*
 * XREFs of ?ndisExecuteRSSv2DirectOid@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAU_NDIS_RSS_DPC_WORKER_CONTEXT@@U_PROCESSOR_NUMBER@@@Z @ 0x1C0087CFC
 * Callers:
 ...
 *     ?ndisAreProcessorsEqual@@YAEU_PROCESSOR_NUMBER@@0@Z @ 0x1C0087B28 (-ndisAreProcessorsEqual@@YAEU_PROCESSOR_NUMBER@@0@Z.c)
        ...
        struct _PROCESSOR_NUMBER a4)
{
  ...
  if ( ProcessorHistory_high )
  {
    ...
    *(_DWORD *)SystemArgument1 = 16253590;
    *(_DWORD *)&SystemArgument1[88] = 16777224;
    v10 = KfRaiseIrql(2u);
    KeGetCurrentProcessorNumberEx(&ProcNumber);
    v11 = ndisAreProcessorsEqual(v13, ProcNumber);
    if ( v11 )
      a3[1].TargetInfoAsUlong = ndisSynchronousOidRequestInternal(
                                  0LL,
                                  a1,
                                  0LL,
    ...
    if ( a3[1].TargetInfoAsUlong )
    {
      ...
      ndisBugCheckEx(0x1CuLL, (ULONG_PTR)a1, 0x102C0uLL, (int)a3[1].TargetInfoAsUlong);
    }
  }
}
