/*
 * XREFs of ?ndisBindNdis6Protocol@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@@Z @ 0x1C0103D90
 * Callers:
 ...
 *     WPP_RECORDER_SF_ZZL @ 0x1C0029C44 (WPP_RECORDER_SF_ZZL.c)
