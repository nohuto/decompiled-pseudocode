/*
 * XREFs of ?ndisOidPrePDCloseProvider@@YAEPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C011C680
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_RECORDER_SF_qqdqq @ 0x1C007F55C (WPP_RECORDER_SF_qqdqq.c)
      ...
      && *((_DWORD *)Buffer + 16) == LODWORD(v3->StackExpansionFallback.PendingWork.DirectOidRequestsToComplete) )
    {
      ...
      *((_DWORD *)a1 + 10) = ndisMInvokeBlockingOidRequest(v1, (struct _NDIS_OID_REQUEST *)v23);
      ...
      if ( !*((_DWORD *)a1 + 10) )
      {
        ...
        v22.m_Lock = (KPushLockBase *)qword_1C00E44F8;
        Buffer[9] = 0LL;
        Buffer[7] = 0LL;
