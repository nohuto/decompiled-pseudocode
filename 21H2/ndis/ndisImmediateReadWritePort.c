/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00BDE30
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00BE170 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00BE190 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00BE1B0 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00BE1F0 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00BE220 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00BE250 (NdisImmediateWritePortUshort.c)
 * Callees:
