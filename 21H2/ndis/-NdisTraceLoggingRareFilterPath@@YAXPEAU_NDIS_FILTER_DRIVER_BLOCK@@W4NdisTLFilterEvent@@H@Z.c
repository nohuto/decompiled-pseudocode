/*
 * XREFs of ?NdisTraceLoggingRareFilterPath@@YAXPEAU_NDIS_FILTER_DRIVER_BLOCK@@W4NdisTLFilterEvent@@H@Z @ 0x1C011EA18
 * Callers:
...
void __fastcall NdisTraceLoggingRareFilterPath(__int64 a1)
{
  ...
  else if ( (unsigned int)dword_1C00E3108 > 5 && tlgKeywordOn((__int64)&dword_1C00E3108, 0x400000000000LL) )
  {
    ...
    v10 = v7;
    v9 = v8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00E3108, (unsigned __int8 *)dword_1C00CF59D, 0LL, 0LL, 4u, &v15);
  }
}
