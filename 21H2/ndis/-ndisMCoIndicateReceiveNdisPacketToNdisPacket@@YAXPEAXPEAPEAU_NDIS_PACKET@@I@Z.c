/*
 * XREFs of ?ndisMCoIndicateReceiveNdisPacketToNdisPacket@@YAXPEAXPEAPEAU_NDIS_PACKET@@I@Z @ 0x1C00BB830
 * Callers:
 *     <none>
 * Callees:
...
LABEL_29:
        ...
        ndisReturnPacketToNetBufferList((struct _NDIS_OBJECT_HEADER *)v6, v19);
      }
LABEL_34:
      ++a2;
    }
