/*
 * XREFs of NdisMIndicateReceiveNetBufferLists @ 0x1C0004A80
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v14 && *(_DWORD *)ndisNblTrackerMode )
      ndisNblTrackerTransferOwnershipInternal(
        ...
        *((_QWORD *)MiniportAdapterHandle + 510),
        0x8Eu,
        v13);
    if ( (Microsoft_Windows_Networking_CorrelationEnabled || byte_1C00E3FD0) && v14 )
      ndisMarkNetBufferListCorrelationIdsAsUsed(NetBufferList);
  }
  else
  {
    if ( byte_1C00E3FD0 && (*((_DWORD *)MiniportAdapterHandle + 1465) & 2) != 0 )
