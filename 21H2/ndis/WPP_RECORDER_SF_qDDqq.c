/*
 * XREFs of WPP_RECORDER_SF_qDDqq @ 0x1C000E7E0
 * Callers:
...
__int64 WPP_RECORDER_SF_qDDqq(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x400) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_0ab6cdb66a74331fb483b2e922e06dd7_Traceguids,
      0xCu,
      va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 12;
  return WppAutoLogTrace(a1, 4LL, 11LL, &WPP_0ab6cdb66a74331fb483b2e922e06dd7_Traceguids, v7, (__int64 *)va);
}
