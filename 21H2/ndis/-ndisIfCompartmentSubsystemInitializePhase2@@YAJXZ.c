/*
 * XREFs of ?ndisIfCompartmentSubsystemInitializePhase2@@YAJXZ @ 0x1C003487C
 * Callers:
 *     ndisIfInitializePhase2 @ 0x1C0108740 (ndisIfInitializePhase2.c)
 * Callees:
...
LABEL_11:
    ...
    else
    {
      ...
      *(_OWORD *)&v20[135] = xmmword_1C00D37F0;
