/*
 * XREFs of NdisNblTrackerTransferOwnership @ 0x1C00746B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z @ 0x1C0073ECC (-ndisNblTrackerHandleFromNdisObjectHandle@@YAPEAUNDIS_NBL_TRACKER_HANDLE__@@PEAU1@@Z.c)
 */
