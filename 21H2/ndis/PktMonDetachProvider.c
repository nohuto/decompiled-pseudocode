/*
 * XREFs of PktMonDetachProvider @ 0x1C00C6DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 PktMonDetachProvider()
{
  ...
  xmmword_1C00E3FE8 = 0LL;
  KeWaitForSingleObject(&PktMonCompMutex, Executive, 0, 0, 0LL);
  while ( (__int64 *)PktMonCompList != &PktMonCompList )
  {
    v0 = qword_1C00E3EE8;
    if ( *(__int64 **)qword_1C00E3EE8 != &PktMonCompList
      || (v1 = *(_QWORD **)(qword_1C00E3EE8 + 8), *v1 != qword_1C00E3EE8) )
    {
LABEL_11:
      __fastfail(3u);
    }
    --PktMonCompCount;
    qword_1C00E3EE8 = (__int64)v1;
    *v1 = &PktMonCompList;
    v2 = (_QWORD *)(v0 + 16);
    while ( (_QWORD *)*v2 != v2 )
    {
