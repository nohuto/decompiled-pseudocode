/*
 * XREFs of ndisIsOidAllowedFromUsermode @ 0x1C003EAF0
 * Callers:
 ...
 *     ndisIsOidAllowedFromUsermode_0 @ 0x1C003EB1C (ndisIsOidAllowedFromUsermode_0.c)
