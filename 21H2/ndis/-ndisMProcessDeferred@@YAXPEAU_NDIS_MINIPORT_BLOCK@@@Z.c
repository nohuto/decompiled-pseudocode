/*
 * XREFs of ?ndisMProcessDeferred@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C006FC60
 * Callers:
 ...
 *     NdisIMRevertBack @ 0x1C00717A0 (NdisIMRevertBack.c)
 *     ?ndisMDeferredDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C00AAAB0 (-ndisMDeferredDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
