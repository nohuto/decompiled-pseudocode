/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1C014C8E4
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C0084C40 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C009C530 (EtwDevLockEndTightUpdate.c)
 * Callees:
