/*
 * XREFs of ??0PDEVOBJ@@QEAA@PEAU_LDEV@@PEAU_devicemodeW@@PEAG22PEAXPEAUtagREMOTETYPEONENODE@@PEAU_GDIINFO@@PEAUtagDEVINFO@@HKK@Z @ 0x1C00B8D20
 * Callers:
 ...
 *     ?GeneratePDEVUniqueUMPDHandle@@YAPEAUHDEV__@@XZ @ 0x1C00A8EA4 (-GeneratePDEVUniqueUMPDHandle@@YAPEAUHDEV__@@XZ.c)
    ...
    if ( !a11 || (unsigned int)GreSetPaletteOwner(*(void **)v53, 0) )
    {
      ...
      *(_QWORD *)(v60 + 1808) = v53;
      ...
      if ( *(_DWORD *)(*(_QWORD *)(SemaphoreInternal + 1792) + 24LL) == 2 )
      {
        ...
        if ( v62 < 0 )
          goto LABEL_101;
        v63 = (__int64 (__fastcall *)(PDEVOBJ *))qword_1C0256758;
      }
      else
      {
        if ( qword_1C0256760 )
        ...
        if ( v64 < 0 )
          goto LABEL_101;
        v63 = (__int64 (__fastcall *)(PDEVOBJ *))qword_1C0256768;
      }
      if ( v63 )
        v65 = v63(this);
      else
...
LABEL_105:
      ...
      *(_QWORD *)(*(_QWORD *)this + 1776LL) = *(_QWORD *)(v18 + 3384);
      ...
      if ( v69 >= 0 )
      {
        v71 = qword_1C0256778 ? (int *)qword_1C0256778() : 0LL;
        ...
        if ( *v71 )
        {
          ...
          if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 1792LL) + 24LL) == 1 )
          {
            ...
            if ( v73 >= 0 && qword_1C0256788 )
              qword_1C0256788(*(unsigned int *)(v72 + 2180));
