/*
 * XREFs of EtwTraceAuditApiRegisterRawInputDevices @ 0x1C0054EC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EtwpTraceAuditApiQueryAddressVADInformation@@YAJPEAXPEAU_MEMORY_BASIC_INFORMATION@@PEAPEAU_OBJECT_NAME_INFORMATION@@@Z @ 0x1C005564C (-EtwpTraceAuditApiQueryAddressVADInformation@@YAJPEAXPEAU_MEMORY_BASIC_INFORMATION@@PEAPEAU_OBJE.c)
 */
