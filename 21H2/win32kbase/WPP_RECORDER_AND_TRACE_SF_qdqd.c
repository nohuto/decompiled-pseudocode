/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_qdqd @ 0x1C01DB21C
 * Callers:
        ...
        ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, const int *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
               a1,
               43LL,
