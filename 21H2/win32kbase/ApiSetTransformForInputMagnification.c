/*
 * XREFs of ApiSetTransformForInputMagnification @ 0x1C020FD90
 * Callers:
        ...
        __int64 a3))(_QWORD, _QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C029CCB8;
  if ( qword_1C029CCB8 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C029CCB8(v6, a2, a3, v8);
    if ( (int)result >= 0 )
    {
      result = qword_1C029CCC0;
      if ( qword_1C029CCC0 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C029CCC0(a1, v4, v3);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
