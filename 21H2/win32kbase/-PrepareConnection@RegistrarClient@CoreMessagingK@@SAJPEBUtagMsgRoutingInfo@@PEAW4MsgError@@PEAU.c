/*
 * XREFs of ?PrepareConnection@RegistrarClient@CoreMessagingK@@SAJPEBUtagMsgRoutingInfo@@PEAW4MsgError@@PEAU_GUID@@@Z @ 0x1C0072714
 * Callers:
        ...
        struct _GUID *a3)
{
  ...
  _QWORD v20[15]; // [rsp+A8h] [rbp-21h]
  __int64 v21; // [rsp+130h] [rbp+67h] BYREF
  unsigned int v22; // [rsp+138h] [rbp+6Fh] BYREF
  ...
  *(_OWORD *)&v20[3] = (unsigned __int64)v19;
  CoreMessagingK::RegistrarClient::s_Reply_Parameter1 = 0LL;
  *(_OWORD *)&v20[5] = v5;
  *(_OWORD *)&v20[7] = *(_OWORD *)v20;
  v20[9] = *(_OWORD *)&_mm_unpackhi_pd(*(__m128d *)&v20[1], *(__m128d *)&v20[1]);
  v21 = 0LL;
  v8 = CoreUICallSend((unsigned int)&v15, (unsigned int)&v21, 1, 1, 3);
  if ( v8 < 0 )
  {
