/*
 * XREFs of UpdateKeyLights @ 0x1C00B0860
 * Callers:
 ...
 *     ?ApplyGatheredKeyboardDeviceCount@CKeyboardProcessor@@QEAAXK@Z @ 0x1C00C4E80 (-ApplyGatheredKeyboardDeviceCount@CKeyboardProcessor@@QEAAXK@Z.c)
 * Callees:
...
void __fastcall UpdateKeyLights(__int64 a1)
{
  ...
  if ( (BYTE4(xmmword_1C0250900) & 2) != 0 )
  {
    HIWORD(gklp) = v3 | 2;
    v4 = byte_1C02508A4 | 2;
  }
  ...
  {
    v4 = byte_1C02508A4 & 0xFD;
  }
  if ( (BYTE4(xmmword_1C0250900) & 8) != 0 )
  {
    v7 = v3 | 2;
    if ( (BYTE4(xmmword_1C0250900) & 2) == 0 )
  ...
  if ( (_BYTE)gKeyboardInfo == 7
    || (!qword_1C0258050 ? (v5 = 0) : (v5 = qword_1C0258050(a1, 4LL)), v5 && (_DWORD)gRemoteClientKeyboardType == 7) )
  {
