/*
 * XREFs of ?DestroyHandle@CConnection@DirectComposition@@SAJPEAUHDCOMPOSITIONCONNECTION__@@@Z @ 0x1C00B68D8
 * Callers:
 ...
 *     NtDCompositionDestroyConnection @ 0x1C01D23D0 (NtDCompositionDestroyConnection.c)
 * Callees:
