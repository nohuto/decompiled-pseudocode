/*
 * XREFs of ?AddMapping@InputObjectMap@@SAJAEBU_LUID@@PEBUCompositionInputObject@@@Z @ 0x1C01FB264
 * Callers:
 ...
 * Callees:
 *     ??0CAutoPushLockEx@@QEAA@PEAU_EX_PUSH_LOCK@@@Z @ 0x1C0046D8C (--0CAutoPushLockEx@@QEAA@PEAU_EX_PUSH_LOCK@@@Z.c)
 ...
 *     ?AllocateBucket@InputObjectMap@@CAPEAX_KPEAX@Z @ 0x1C01FB624 (-AllocateBucket@InputObjectMap@@CAPEAX_KPEAX@Z.c)
 *     ?FindEntry@InputObjectMap@@CAPEAUInputObjectMapEntry@@AEBU_LUID@@@Z @ 0x1C01FB650 (-FindEntry@InputObjectMap@@CAPEAUInputObjectMapEntry@@AEBU_LUID@@@Z.c)
 */
...
__int64 __fastcall InputObjectMap::AddMapping(const struct _LUID *a1, const struct CompositionInputObject *a2)
{
  ...
  {
    v5 = 2 * ((unsigned int)dword_1C0255524 >> 5);
    if ( InputObjectMap::s_hashTable >= (unsigned int)v5 )
    {
      ...
      if ( Bucket )
      {
        ...
        v9 = dword_1C0255524;
        v10 = 0;
        v11 = -1LL << (dword_1C0255524 & 0x1F);
        if ( (dword_1C0255524 & 0xFFFFFFE0) != 0 )
        {
          do
          {
            v12 = Buffer;
          ...
          while ( v10 < (unsigned int)dword_1C0255524 >> 5 );
        }
        v15 = Buffer;
        Buffer = Bucket;
        dword_1C0255524 = (32 * v5) | v9 & 0x1F;
        if ( v15 )
          _lambda_63d17d6d41434870d2c55e28a74f5cc8_::_lambda_invoker_cdecl_<void *>(v15);
      }
      else if ( (dword_1C0255524 & 0xFFFFFFE0) == 0 )
      {
LABEL_26:
        v4 = -1073741670;
        goto LABEL_28;
    ...
    if ( PoolWithTag )
    {
      ...
      PoolWithTag[2] = *a1;
      PoolWithTag[3] = a2;
      v22 = v17 & (-1LL << (dword_1C0255524 & 0x1F));
      v18 = Buffer;
      v19 = (37
           * (BYTE6(v22)
            + 37
           ...
           + HIBYTE(v22)) & (((unsigned int)dword_1C0255524 >> 5) - 1);
