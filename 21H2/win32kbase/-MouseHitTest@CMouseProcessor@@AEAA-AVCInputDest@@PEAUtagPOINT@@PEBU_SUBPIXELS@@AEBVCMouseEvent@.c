/*
 * XREFs of ?MouseHitTest@CMouseProcessor@@AEAA?AVCInputDest@@PEAUtagPOINT@@PEBU_SUBPIXELS@@AEBVCMouseEvent@1@W4MouseHitTestOptions@@PEAI@Z @ 0x1C0043240
 * Callers:
 ...
 *     ?GetHitTestContext@CMouseEvent@CMouseProcessor@@QEBAKXZ @ 0x1C0043580 (-GetHitTestContext@CMouseEvent@CMouseProcessor@@QEBAKXZ.c)
...
LABEL_17:
        ...
        if ( v28 )
        {
          ...
          {
            if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 64LL, v50, v51) )
            {
        ...
        else if ( (unsigned int)dword_1C024BA90 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 64LL, v50, v51) )
        {
