/*
 * XREFs of NtUserGetKeyState @ 0x1C0006170
 * Callers:
 *     <none>
 * Callees:
    ...
    while ( *v9 != (_BYTE)a1 )
    {
      ...
      if ( v8 >= 0xE )
      {
        if ( (unsigned __int8)a1 < 0x5Bu || (unsigned __int8)a1 > 0x5Cu && (unsigned __int8)(a1 + 96) > 5u )
        {
          ...
          v10 = 0;
          if ( qword_1C0256E48 && (int)qword_1C0256E48() >= 0 && qword_1C0256E50 )
            v10 = qword_1C0256E50();
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED
            && LOWORD(WPP_GLOBAL_Control->DeviceType) )
          {
          ...
          v11 = 0;
          if ( qword_1C02582B8 && (int)qword_1C02582B8() >= 0 && qword_1C02582C0 )
            v11 = qword_1C02582C0(1LL);
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED
            && LOWORD(WPP_GLOBAL_Control->DeviceType) )
          {
            LOBYTE(v7) = 5;
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( CurrentThreadWin32Thread )
    {
      ...
      if ( (*(_DWORD *)(v31 + 44) || *(_DWORD *)(v31 + 48) || v32 > 0)
        ...
        && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v29, v30) )
      {
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218F81, v31 + 28, 0, 2u, &v33);
      }
      *(_DWORD *)(v31 + 44) = 0;
      *(_OWORD *)(v31 + 28) = 0LL;
    }
