/*
 * XREFs of ApiSetRemoveMagnificationOutputTransform @ 0x1C0034AD8
 * Callers:
...
__int64 (*__fastcall ApiSetRemoveMagnificationOutputTransform(__int64 a1))(void)
{
  ...
  result = qword_1C029CFF0;
  if ( qword_1C029CFF0 )
  {
    result = (__int64 (*)(void))qword_1C029CFF0();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029CFF8;
      if ( qword_1C029CFF8 )
        result = (__int64 (*)(void))qword_1C029CFF8(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
