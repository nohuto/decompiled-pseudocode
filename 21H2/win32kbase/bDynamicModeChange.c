/*
 * XREFs of bDynamicModeChange @ 0x1C00BA730
 * Callers:
...
LABEL_70:
                ...
                if ( !v44 )
                {
                  ...
                  v48 = HmgShareLock((unsigned int)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine, 16);
...
LABEL_81:
                  ...
                  *((_QWORD *)a1 + 333) = *(_QWORD *)v7;
                  ...
                  if ( qword_1C02566F0 )
                    v114 = qword_1C02566F0();
                  else
                    v114 = -1073741637;
                  if ( v114 >= 0 && qword_1C02566F8 )
                    qword_1C02566F8(a1, a2);
                  ++gcModeChanges;
                  v6 = 1;
                  break;
                }
