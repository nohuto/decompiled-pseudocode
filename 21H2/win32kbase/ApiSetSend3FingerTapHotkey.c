/*
 * XREFs of ApiSetSend3FingerTapHotkey @ 0x1C020F4EC
 * Callers:
...
__int64 (*ApiSetSend3FingerTapHotkey())(void)
{
  ...
  result = qword_1C029D690;
  if ( qword_1C029D690 )
  {
    result = (__int64 (*)(void))qword_1C029D690();
    if ( (int)result >= 0 )
    {
      result = qword_1C029D698;
      if ( qword_1C029D698 )
        result = (__int64 (*)(void))qword_1C029D698();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
