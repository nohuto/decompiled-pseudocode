/*
 * XREFs of ?QueueFrame@RIM@TelemetryDebug@InputTraceLogging@@SAXAEBUTELEMETRY_POINTER_FRAME_TIMES@@@Z @ 0x1C01A8EC4
 * Callers:
...
void __fastcall InputTraceLogging::TelemetryDebug::RIM::QueueFrame(const struct TELEMETRY_POINTER_FRAME_TIMES *a1)
{
  __int64 v2; // r8
  __int64 v3; // r9
  __int64 v4; // r8
  ...
  if ( isChildPartition() )
  {
    if ( (unsigned int)dword_1C028EE70 > 7 && tlgKeywordOn((__int64)&dword_1C028EE70, 0x10000LL) )
    {
      v21 = *((_QWORD *)a1 + 17);
      v22 = *((_QWORD *)a1 + 16);
      v23 = *((_QWORD *)a1 + 15);
  ...
  else if ( (unsigned int)dword_1C028EE70 > 7 && tlgKeywordOn((__int64)&dword_1C028EE70, 0x10000LL) )
  {
    v21 = *((_QWORD *)a1 + 7);
    v22 = *((_QWORD *)a1 + 6);
    v23 = *((_QWORD *)a1 + 5);
