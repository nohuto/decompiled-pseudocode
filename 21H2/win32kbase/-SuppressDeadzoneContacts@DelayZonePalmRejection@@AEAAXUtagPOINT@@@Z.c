/*
 * XREFs of ?SuppressDeadzoneContacts@DelayZonePalmRejection@@AEAAXUtagPOINT@@@Z @ 0x1C01ADB78
 * Callers:
...
void __fastcall DelayZonePalmRejection::SuppressDeadzoneContacts(DelayZonePalmRejection *this, struct tagPOINT a2)
{
  ...
  {
    LOBYTE(a2.x) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, a2.x, 8, 30, (__int64)&WPP_926a34ac5ff436dd04abf80f696c769b_Traceguids);
  }
  if ( v2 )
  {
    do
