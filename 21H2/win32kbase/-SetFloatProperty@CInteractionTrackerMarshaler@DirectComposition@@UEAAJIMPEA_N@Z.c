/*
 * XREFs of ?SetFloatProperty@CInteractionTrackerMarshaler@DirectComposition@@UEAAJIMPEA_N@Z @ 0x1C02306A0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( a2 <= 0x30 )
    {
      if ( a2 != 48 )
      {
        ...
        else
        {
          if ( a2 == 45 )
          {
            *((float *)this + 21) = a3 + *((float *)this + 21);
          }
          else
          {
            if ( a2 != 46 )
      ...
      *((float *)this + 24) = a3 + *((float *)this + 24);
LABEL_79:
      *((_DWORD *)this + 4) &= ~0x80u;
      goto LABEL_80;
    }
...
LABEL_80:
  ...
  {
    case 0xFu:
      *((float *)this + 36) = a3 + *((float *)this + 36);
      goto LABEL_12;
    case 4u:
      if ( *((float *)this + 41) == a3 )
        return v4;
...
LABEL_15:
  ...
  if ( a2 != 14 )
    return (unsigned int)DirectComposition::CResourceMarshaler::SetFloatProperty(this, a2, a3, a4);
  *((float *)this + 35) = a3 + *((float *)this + 35);
LABEL_12:
