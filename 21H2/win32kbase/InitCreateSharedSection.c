/*
 * XREFs of InitCreateSharedSection @ 0x1C0299F28
 * Callers:
...
__int64 __fastcall InitCreateSharedSection(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    WPP_RECORDER_SF_((_DWORD)gBaseLog, 4, 14, 11, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(v3) = 4;
      WPP_RECORDER_SF_DD((_DWORD)gBaseLog, v3, 14, 12, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids, 0, 0);
    }
  }
  v15 = 2129920LL;
