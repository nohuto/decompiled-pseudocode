/*
 * XREFs of McTemplateK0qm_EtwWriteTransfer @ 0x1C00C7A28
 * Callers:
 *     EtwTraceUiAuditWriteClipboard @ 0x1C00B2B20 (EtwTraceUiAuditWriteClipboard.c)
 *     EtwTraceUiLimitWriteClipboard @ 0x1C0124540 (EtwTraceUiLimitWriteClipboard.c)
 * Callees:
