/*
 * XREFs of ?EmitBeginTime@CAnimationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00AEFA4
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( !*((_QWORD *)this + 14) || !*((_QWORD *)this + 15) || (*((_DWORD *)this + 8) & 0x80u) != 0 )
    return 1;
  v5 = 0LL;
