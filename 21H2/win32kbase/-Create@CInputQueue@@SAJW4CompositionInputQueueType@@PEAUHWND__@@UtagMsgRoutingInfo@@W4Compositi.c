/*
 * XREFs of ?Create@CInputQueue@@SAJW4CompositionInputQueueType@@PEAUHWND__@@UtagMsgRoutingInfo@@W4CompositionInputFlags@@PEAPEAV1@@Z @ 0x1C00966C4
 * Callers:
...
__int64 __fastcall CInputQueue::Create(int a1, __int64 a2, __int64 a3, int a4, __int64 *a5)
{
  ...
  v9 = (NSInstrumentation::CLeakTrackingAllocator *)gpLeakTrackingAllocator;
  *a5 = 0LL;
  v10 = NSInstrumentation::CLeakTrackingAllocator::Allocate(v9, 260LL, 0x48uLL, 1902660937);
  v11 = v10;
  if ( v10 )
  {
    *(_QWORD *)(v10 + 16) = 0LL;
