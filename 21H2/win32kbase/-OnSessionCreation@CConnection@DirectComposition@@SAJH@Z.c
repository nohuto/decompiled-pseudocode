/*
 * XREFs of ?OnSessionCreation@CConnection@DirectComposition@@SAJH@Z @ 0x1C00AD500
 * Callers:
 ...
 *     ??0CConnection@DirectComposition@@AEAA@XZ @ 0x1C00AD844 (--0CConnection@DirectComposition@@AEAA@XZ.c)
