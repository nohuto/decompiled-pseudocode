/*
 * XREFs of ?Serialize@CIVSerializer@@QEAAJAEAU_IV_HID_POINTER_DEVICE_INFO@@AEAUtagHID_POINTER_DEVICE_INFO@@_N@Z @ 0x1C01B65D8
 * Callers:
        ...
        bool a4)
{
  ...
  v8 = &WPP_2ccd359dbff93ea23c150f58e4d81fa3_Traceguids;
