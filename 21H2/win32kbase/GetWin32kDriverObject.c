/*
 * XREFs of GetWin32kDriverObject @ 0x1C0004EF0
 * Callers:
...
__int64 GetWin32kDriverObject()
{
  ...
  dword_1C0250930 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  result = ObReferenceObjectByName(&DestinationString, 64LL, 0LL);
  dword_1C0250934 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  if ( (int)result < 0 )
    return 0LL;
  return result;
}
