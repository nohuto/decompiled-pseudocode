/*
 * XREFs of InitUserScreen @ 0x1C006A78C
 * Callers:
 ...
 *     GreGetSystemFont @ 0x1C006B060 (GreGetSystemFont.c)
...
__int64 InitUserScreen()
{
  ...
  {
    LOBYTE(v0) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v0, 14, 11, (__int64)&WPP_6c8a7949f294354c3e3996abc6998fe2_Traceguids);
  }
  v2 = gpsi;
  *((_DWORD *)gpsi + 1275) = 1;
  v2[1301] = 1;
  ...
  *(_QWORD *)(gpDispInfo + 56) = GreCreateDisplayDC(*(HDEV *)(gpDispInfo + 40), 0, 0);
  ...
  if ( !v3 )
    goto LABEL_43;
  if ( qword_1C0256AB8 )
    qword_1C0256AB8(v3, *((_QWORD *)v2 + 640));
  ...
  *(_QWORD *)(gpDispInfo + 64) = GreCreateCompatibleDC(*(HDC *)(gpDispInfo + 56));
  ...
  if ( !v4 )
    goto LABEL_43;
  if ( qword_1C0256AB8 )
    qword_1C0256AB8(v4, *((_QWORD *)v2 + 640));
        ...
        else
        {
          ...
          if ( v6 )
          {
            ...
            *((_DWORD *)gpsi + 547) = 0;
            ...
            v33 = qword_1C0257B18 ? qword_1C0257B18() : -1073741637;
            if ( v33 >= 0 && qword_1C0257B20 )
              qword_1C0257B20();
          }
        }
        goto LABEL_39;
...
LABEL_39:
  if ( ProfileUserName && qword_1C02570E8 )
    qword_1C02570E8(&v35);
  return v6;
}
