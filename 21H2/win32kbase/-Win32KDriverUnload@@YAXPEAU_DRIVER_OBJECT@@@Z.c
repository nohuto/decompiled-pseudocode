/*
 * XREFs of ?Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x1C011B880
 * Callers:
 ...
 *     UnloadWin32kCall @ 0x1C009BD70 (UnloadWin32kCall.c)
 ...
 *     McGenEventUnregister_EtwUnregister @ 0x1C00B81A8 (McGenEventUnregister_EtwUnregister.c)
...
void __fastcall Win32KDriverUnload(struct _DRIVER_OBJECT *a1, char a2)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_((_DWORD)gBaseLog, 4, 15, 15, (__int64)&WPP_a844338296dc32a54b50029aac15bf9a_Traceguids);
  v2 = -1073741637;
  if ( qword_1C0257EC0 )
    v3 = qword_1C0257EC0(a1);
  else
    v3 = -1073741637;
  if ( v3 >= 0 && qword_1C0257EC8 )
    qword_1C0257EC8();
  if ( qword_1C0256C40 )
    v4 = qword_1C0256C40();
  else
    v4 = -1073741637;
  if ( v4 >= 0 && qword_1C0256C48 )
    qword_1C0256C48();
  ...
  if ( qword_1C0256C60 )
    ...
    v5 = -1073741637;
  if ( v5 >= 0 && qword_1C0256C68 )
    qword_1C0256C68();
  v6 = qword_1C0251C30;
  if ( qword_1C0251C30 )
  {
    COPM::~COPM(qword_1C0251C30);
  ...
  if ( qword_1C024FD58 )
  {
    ...
    for ( i = (void (*)(void))DestroyHandleFirstPass; ; i = (void (*)(void))DestroyHandleSecondPass )
    {
      ...
      do
      {
        if ( *((_BYTE *)qword_1C024FD58 + 32 * v11 + 24) )
          i();
        ++v11;
      }
      while ( v11 <= giheLast );
  ...
  if ( qword_1C0256C70 )
    ...
    v14 = -1073741637;
  if ( v14 >= 0 && qword_1C0256C78 )
    qword_1C0256C78(&gMagnContext);
  WinSqmEndSession();
  if ( (int)IsUserkTraceLoggingSupported() >= 0 && qword_1C0257EE0 )
    qword_1C0257EE0();
  ...
  TlgUnregisterAggregateProvider(&dword_1C024A1E0);
  ...
  if ( qword_1C0256D30 )
    ...
    v23 = -1073741637;
  if ( v23 >= 0 && qword_1C0256D38 )
    qword_1C0256D38();
  if ( !v22 )
  {
    if ( qword_1C0256D10 )
      v2 = qword_1C0256D10();
    if ( v2 >= 0 && qword_1C0256D18 )
      qword_1C0256D18();
  }
  TlgUnregisterAggregateProvider(&dword_1C0246378);
  ...
  if ( (int)IsTelemetryAssertsSupported() >= 0 && qword_1C0257EF8 )
    qword_1C0257EF8();
  UnloadWin32kCall();
