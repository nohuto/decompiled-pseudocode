/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_5dc89212d77cc2b3abfa0526dfd9dff5___ @ 0x1C000DB40
 * Callers:
        ...
        __int64 a3)
{
  ...
  *((_DWORD *)v5 + 4) = *(_DWORD *)(*(_QWORD *)a3 + 84LL);
  result = 1;
  *((_DWORD *)v5 + 5) = *(_DWORD *)(*(_QWORD *)a3 + 88LL);
  return result;
}
