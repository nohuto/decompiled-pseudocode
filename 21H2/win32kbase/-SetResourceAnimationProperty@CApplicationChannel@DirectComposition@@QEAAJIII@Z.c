/*
 * XREFs of ?SetResourceAnimationProperty@CApplicationChannel@DirectComposition@@QEAAJIII@Z @ 0x1C0084088
 * Callers:
    ...
    if ( v5 < *((_QWORD *)this + 10) )
    {
      ...
      if ( v8 )
      {
        ...
        if ( v9 )
        {
          ...
          if ( !v11 )
            return 3221225506LL;
          v12 = *(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, _QWORD, _QWORD))(*(_QWORD *)v11 + 176LL);
