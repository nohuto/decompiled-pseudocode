...
LABEL_36:
  if ( (v5 & 0x80000) != 0 )
    v5 = v5 & 0xFFFFFFD5 | 2;
  if ( qword_1C0257678 && (int)qword_1C0257678(v17, v16, v18) >= 0 && qword_1C0257680 )
    v3 = qword_1C0257680(a1, v16, v18);
  if ( v3 && (*(_DWORD *)(*(_QWORD *)(v3 + 40) + 24LL) & 0x20000000) != 0 )
  {
    v23 = qword_1C0257688 && (int)qword_1C0257688(v17, v16, v18) >= 0 && qword_1C0257690
        ? qword_1C0257690(v3, v21, v22)
        : 0LL;
    v78 = v23;
...
LABEL_73:
    ...
    *(_DWORD *)(v27 + 64) = v36 | 0x1000;
    if ( a1 != *(_QWORD **)(v27 + 16) )
    {
      if ( (int)IsSpbCheckDceSupported() >= 0 && qword_1C02576E0 )
        qword_1C02576E0(v27);
      *(_QWORD *)(v27 + 16) = a1;
      ResetOrg(0LL, v27, 0);
    }
  ...
  else
  {
    ...
    if ( (*(_DWORD *)(v27 + 64) & 0x4000) != 0 )
    {
      ...
      if ( (int)IsGreSelectRedirectionBitmapSupported() >= 0 && qword_1C0256AA8 )
        qword_1C0256AA8(*(_QWORD *)(v27 + 8), 0LL);
    }
    if ( *(_QWORD **)(v27 + 16) != a1
      || *(_QWORD **)(v27 + 32) != v7
      || *(_QWORD **)(v27 + 24) != v87
...
LABEL_76:
    v84 = 1;
    if ( (*(_DWORD *)(v27 + 64) & 0x800) == 0 && (int)IsSpbCheckDceSupported() >= 0 && qword_1C02576E0 )
      qword_1C02576E0(v27);
    v33 = *(HDC *)(v27 + 8);
    *(_DWORD *)(v27 + 64) = v25 | 0x1000;
    GreValidateVisrgn(v33);
    v77 = 0LL;
    if ( !qword_1C0257698 || (int)qword_1C0257698() < 0 )
    {
      v34 = v87;
LABEL_182:
    ...
    v34 = v87;
    if ( !qword_1C02576A0 || !(unsigned int)qword_1C02576A0(&v77, a1, v87, v25) )
      goto LABEL_182;
LABEL_84:
    *(_QWORD *)(v27 + 16) = a1;
    *(_QWORD *)(v27 + 24) = v34;
...
LABEL_248:
  ...
  {
    if ( qword_1C0256AA0
      && (int)qword_1C0256AA0() >= 0
      && (!qword_1C0256AA8 || !(unsigned int)qword_1C0256AA8(*(_QWORD *)(v27 + 8), v78)) )
    {
      v37 = 1;
    }
...
LABEL_118:
    ...
    if ( qword_1C0256AC0 && (int)qword_1C0256AC0() >= 0 && qword_1C0256AC8 )
      qword_1C0256AC8(*(_QWORD *)(v27 + 8), *a1, 0LL, 0LL, 0);
    if ( v7 )
    {
