/*
 * XREFs of ?SetReferenceArrayProperty@CTransform3DGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C0226E00
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  result = DirectComposition::CResourceMarshalerArrayBase::Set(
             (DirectComposition::CTransform3DGroupMarshaler *)((char *)this + 80),
             a2,
             (__int64)a4,
             a5,
             0xBAu);
