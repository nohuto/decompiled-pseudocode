/*
 * XREFs of ?CoalesceNodeWithPrevious@CTouchProcessor@@AEAA_KPEBUCPointerInputFrame@@0PEAUCPointerInfoNode@@KH@Z @ 0x1C01C0B70
 * Callers:
 ...
 *     EtwTracePointerCoalesce @ 0x1C014E150 (EtwTracePointerCoalesce.c)
        ...
        int a6)
{
  ...
  MicrosoftTelemetryAssertTriggeredNoArgsKM(v19, v16, v18);
LABEL_27:
  ValidNodeInFrame = CTouchProcessor::FindValidNodeInFrame((CTouchProcessor *)this, a3, *((_WORD *)a4 + 86), &v37);
  if ( !ValidNodeInFrame )
  ...
  *((_DWORD *)a4 + 86) = v37;
  if ( v32 )
  {
    ...
    *(_DWORD *)a4 = v35;
    *(_DWORD *)a4 = v35 ^ (*(_DWORD *)ValidNodeInFrame ^ v35) & 0x400000;
  }
