/*
 * XREFs of ?ivHandleSettingsPacket@CBaseInput@@AEAA?AW4IVHandlerResult@@PEAXPEAURawInputManagerObject@@@Z @ 0x1C01B8F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseInput::ivHandleSettingsPacket(__int64 a1, int *a2)
{
  ...
  PVOID *v33; // [rsp+38h] [rbp-91h] BYREF
  ...
  UnpackTouchpadSettings(a2);
  UnpackMouseSettings(a2, v28);
  UnpackPenSettings((__int64)a2, v29);
