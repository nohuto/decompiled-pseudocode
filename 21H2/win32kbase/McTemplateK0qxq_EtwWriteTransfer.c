/*
 * XREFs of McTemplateK0qxq_EtwWriteTransfer @ 0x1C00D85C4
 * Callers:
 ...
 *     EtwTraceFlipManagerCanceledPresentShown @ 0x1C00D82F0 (EtwTraceFlipManagerCanceledPresentShown.c)
 *     EtwTraceFlipManagerUpdateExpectedConsumerPresentId @ 0x1C00D8360 (EtwTraceFlipManagerUpdateExpectedConsumerPresentId.c)
 *     EtwTraceFlipManagerPresentIFlipSubmitted @ 0x1C014D840 (EtwTraceFlipManagerPresentIFlipSubmitted.c)
 *     EtwTraceFlipManagerPresentSignaled @ 0x1C014DDA0 (EtwTraceFlipManagerPresentSignaled.c)
 * Callees:
