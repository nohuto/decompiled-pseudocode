/*
 * XREFs of ?Create@CSharedWriteCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F97E0
 * Callers:
 *     CreateSharedWriteCaptureControllerMarshaler @ 0x1C01F9940 (CreateSharedWriteCaptureControllerMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedWriteCaptureControllerMarshaler **a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 < 0 )
    {
      (*(void (__fastcall **)(struct DirectComposition::CSharedWriteCaptureControllerMarshaler *, __int64))(*(_QWORD *)v5 + 80LL))(
        v5,
        1LL);
      v5 = 0LL;
    }
