/*
 * XREFs of ?vUnreferencePdevWorker@@YAXPEAUtagUNREFDATA@@@Z @ 0x1C00B9900
 * Callers:
  ...
  *((_DWORD *)a1 + 3) = 0;
  ...
  while ( 1 )
  {
    ...
    if ( qword_1C02567D0 )
      ...
      v7 = -1073741637;
    if ( v7 >= 0 && qword_1C02567D8 )
      qword_1C02567D8(&v40, &v39, &v37, v2);
    v40 = 0LL;
  ...
  if ( v39[892] )
  {
    ...
    if ( qword_1C02567F0 )
      ...
      v10 = -1073741637;
    if ( v10 >= 0 && qword_1C02567F8 )
      v9 = qword_1C02567F8(&v42, v39, &v41);
  ...
  while ( v11 )
  {
    *(_DWORD *)(v11 + 228) = 1;
    ...
    if ( qword_1C0256810 )
      ...
      v13 = -1073741637;
    if ( v13 >= 0 && qword_1C0256818 )
      qword_1C0256818(v11 + 128);
    v11 = *(_QWORD *)(v11 + 248);
    Win32FreePool(v12);
  }
  if ( qword_1C0256820 )
    v6 = qword_1C0256820();
  if ( v6 >= 0 && qword_1C0256828 )
    qword_1C0256828(v1, v3);
  v14 = *(_QWORD *)(v1 + 1688);
  if ( v14 )
  {
    Win32FreePool(v14);
