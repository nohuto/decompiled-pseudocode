/*
 * XREFs of wil_details_FeatureStateCache_ReevaluateCachedFeatureEnabledState @ 0x1C00C6E6C
 * Callers:
 *     wil_details_IsEnabledFallback @ 0x1C00C6FC0 (wil_details_IsEnabledFallback.c)
 *     wil_details_FeatureStateCache_GetCachedFeatureEnabledState @ 0x1C0114378 (wil_details_FeatureStateCache_GetCachedFeatureEnabledState.c)
 * Callees:
