        ...
        void **a16)
{
  ...
  _BYTE *v40; // [rsp+90h] [rbp-70h]
  int v41; // [rsp+98h] [rbp-68h]
  int v42; // [rsp+9Ch] [rbp-64h]
  const WCHAR *v43; // [rsp+A0h] [rbp-60h]
  ...
  const WCHAR *v54; // [rsp+F0h] [rbp-10h]
  int v55; // [rsp+F8h] [rbp-8h]
  int v56; // [rsp+FCh] [rbp-4h]
  _BYTE *v57; // [rsp+100h] [rbp+0h]
  ...
  v35 = 4LL;
  v33 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer(a1, a2, 0LL, 0LL, 0xEu, &v31);
}
