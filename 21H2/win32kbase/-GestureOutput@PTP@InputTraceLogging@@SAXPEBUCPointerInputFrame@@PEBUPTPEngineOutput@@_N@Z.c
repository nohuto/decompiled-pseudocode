/*
 * XREFs of ?GestureOutput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@PEBUPTPEngineOutput@@_N@Z @ 0x1C01DE094
 * Callers:
        ...
        const struct PTPEngineOutput *a2)
{
  ...
  {
    v2 = tlgKeywordOn((__int64)&dword_1C028EE70, 128LL);
    v6 = 0LL;
    if ( v2 )
    {
      v7 = *(_DWORD *)(v5 + 8) == 0;
