/*
 * XREFs of ?iCombine@DC@@QEAAJPEAU_RECTL@@J@Z @ 0x1C0033AB0
 * Callers:
...
__int64 __fastcall DC::iCombine(DC *this, struct _RECTL *a2, int a3)
{
  ...
  if ( v11 )
  {
    ...
    if ( qword_1C0257D50 && (int)qword_1C0257D50(v10, v9, v12) >= 0 && qword_1C0257D58 )
    {
      v16 = qword_1C0257D58(v13, v14, v15);
      v8 = 0LL;
    }
    else
    {
