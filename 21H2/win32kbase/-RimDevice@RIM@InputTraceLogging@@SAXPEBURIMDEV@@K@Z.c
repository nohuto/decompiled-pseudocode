/*
 * XREFs of ?RimDevice@RIM@InputTraceLogging@@SAXPEBURIMDEV@@K@Z @ 0x1C005586C
 * Callers:
 ...
 *     ?RimDevTypeToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C0151548 (-RimDevTypeToString@InputTraceLogging@@CAPEBDK@Z.c)
