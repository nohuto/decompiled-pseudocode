/*
 * XREFs of ApiSetEditionPostInertiaMessage @ 0x1C01CD1D8
 * Callers:
...
__int64 __fastcall ApiSetEditionPostInertiaMessage(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( qword_1C0258788 )
    ...
    v10 = -1073741637;
  if ( v10 >= 0 && qword_1C0258790 )
    v6 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64, __int64, __int64))qword_1C0258790)(a1, v8, a3, a4, a5);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(a2) = 5;
    WPP_RECORDER_SF_(
