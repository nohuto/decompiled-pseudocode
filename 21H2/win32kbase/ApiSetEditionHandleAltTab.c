/*
 * XREFs of ApiSetEditionHandleAltTab @ 0x1C00C0240
 * Callers:
        ...
        __int16 a8)
{
  ...
  if ( qword_1C029D150 && (int)qword_1C029D150(v12, a2, a3, v14) >= 0 && qword_1C029D158 )
  {
    LOWORD(v18) = a8;
    v15 = a5;
    LOBYTE(v15) = a1;
    qword_1C029D158(v15, v10, v9, a4, a5, a6, a7, v18);
  }
