/*
 * XREFs of EtwTraceReleaseUserCrit @ 0x1C0035CC4
 * Callers:
...
char EtwTraceReleaseUserCrit()
{
  ...
  if ( CurrentThreadWin32Thread )
  {
    ...
    _InterlockedIncrement64(&qword_1C0251EF0[v4 + 30]);
LABEL_9:
    v5 = _InterlockedExchangeAdd64((volatile signed __int64 *)&xmmword_1C0252068, CurrentThreadWin32Thread);
    _InterlockedIncrement64((_QWORD *)&xmmword_1C0252078 + 1);
