/*
 * XREFs of HMIsHandleEntrySecureWorker @ 0x1C0113DA0
 * Callers:
 *     ??0CHMRefHwndByHandle@@QEAA@PEAUHWND__@@_N111@Z @ 0x1C0066820 (--0CHMRefHwndByHandle@@QEAA@PEAUHWND__@@_N111@Z.c)
 * Callees:
 *     ?IsHandleEntrySecureWorker@@YAHPEAXPEAU_HANDLEENTRY@@@Z @ 0x1C01139FC (-IsHandleEntrySecureWorker@@YAHPEAXPEAU_HANDLEENTRY@@@Z.c)
 */
...
__int64 __fastcall HMIsHandleEntrySecureWorker(void *a1)
{
  ...
  {
    v3 = (struct _HANDLEENTRY *)((char *)qword_1C024FD58 + (unsigned int)(unsigned __int16)a1 * dword_1C024FD60);
