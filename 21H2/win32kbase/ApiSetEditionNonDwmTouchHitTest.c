/*
 * XREFs of ApiSetEditionNonDwmTouchHitTest @ 0x1C0209C28
 * Callers:
...
_OWORD *__fastcall ApiSetEditionNonDwmTouchHitTest(_OWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( qword_1C029D280 && (int)qword_1C029D280(v10, v8, v9, v12) >= 0 )
  {
  ...
  if ( (_BYTE)v8 || v11 )
  {
    v20 = &WPP_0697f2bc7c5d31d94a4cce9255604f83_Traceguids;
    LOBYTE(v20) = v11;
    WPP_RECORDER_AND_TRACE_SF_(
      WPP_GLOBAL_Control->AttachedDevice,
      v8,
