/*
 * XREFs of ApiSetEditionInputExtensibilityCallout @ 0x1C0208578
 * Callers:
        ...
        __int64 a3))(_QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029CFA0;
  if ( qword_1C029CFA0 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029CFA0(v5, a2, a3, v7);
    if ( (int)result >= 0 )
    {
      result = qword_1C029CFA8;
      if ( qword_1C029CFA8 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029CFA8(a1, v3);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
