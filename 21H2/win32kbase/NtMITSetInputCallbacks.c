/*
 * XREFs of NtMITSetInputCallbacks @ 0x1C00753B0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v33 && (*(int *)(v33 + 24) > 0 || *(_DWORD *)(v41 + 48)) )
    {
      ...
      if ( (unsigned int)dword_1C024BA90 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
      {
        ...
        v46 = 4LL;
        v45 = &v38;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FF7, (int)&ActivityId, 0, 3u, &v44);
      }
    }
  }
  else
    ...
    *(GUID *)(v41 + 28) = ActivityId;
    if ( (unsigned int)dword_1C024BA90 > 6 )
    {
      if ( tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
      {
        ...
        v49 = 4LL;
        v48 = &v37;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FA0, (int)&ActivityId, 0, 3u, &v47);
        v34 = dword_1C024BA90;
      }
      if ( v34 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
      {
        ...
        v52 = 4LL;
        v51 = &v39;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FCD, (int)&ActivityId, 0, 3u, &v50);
      }
    }
  }
