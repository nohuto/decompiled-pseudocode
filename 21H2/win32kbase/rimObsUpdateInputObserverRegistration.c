/*
 * XREFs of rimObsUpdateInputObserverRegistration @ 0x1C017F5AC
 * Callers:
 *     NtRIMUpdateInputObserverRegistration @ 0x1C0154790 (NtRIMUpdateInputObserverRegistration.c)
 *     RIMUpdateInputObserverRegistration @ 0x1C01584C0 (RIMUpdateInputObserverRegistration.c)
 * Callees:
...
LABEL_14:
  ...
  {
    LOBYTE(v9) = 3;
    WPP_RECORDER_SF_q((_DWORD)gBaseLog, v9, 23, 45, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids, Handle);
  }
  return (unsigned int)v10;
}
