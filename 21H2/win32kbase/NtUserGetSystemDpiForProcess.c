/*
 * XREFs of NtUserGetSystemDpiForProcess @ 0x1C012FBD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetSystemDpiForProcess(char *Handle)
{
  ...
  PVOID v31; // [rsp+38h] [rbp-21h] BYREF
  __int64 v32; // [rsp+40h] [rbp-19h] BYREF
  unsigned __int8 v33; // [rsp+48h] [rbp-11h]
  GUID ActivityId; // [rsp+4Ch] [rbp-Dh] BYREF
  struct _EVENT_DATA_DESCRIPTOR v35; // [rsp+60h] [rbp+7h] BYREF
  int *v36; // [rsp+80h] [rbp+27h]
  int v37; // [rsp+88h] [rbp+2Fh]
  int v38; // [rsp+8Ch] [rbp+33h]
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    v32 = v4;
    if ( v4 && (*(int *)(v4 + 24) > 0 || *(_DWORD *)(v32 + 48)) )
    {
  ...
  {
    v31 = 0LL;
    v22 = ObReferenceObjectByHandle(Handle, 0x1000u, (POBJECT_TYPE)PsProcessType, 1, &v31, 0LL);
    v21 = v31;
    if ( v22 < 0 )
    {
  ...
  {
    v24 = *(unsigned __int16 *)(CurrentProcessWin32Process + 284);
    goto LABEL_45;
  }
  v26 = 5023LL;
LABEL_44:
