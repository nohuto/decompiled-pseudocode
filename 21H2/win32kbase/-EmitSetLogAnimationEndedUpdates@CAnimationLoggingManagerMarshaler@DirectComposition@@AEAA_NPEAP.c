/*
 * XREFs of ?EmitSetLogAnimationEndedUpdates@CAnimationLoggingManagerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C000ADF8
 * Callers:
 ...
 *     _lambda_11de8ce1c68e57a9e4c3213d43d7ad85_::operator() @ 0x1C022A550 (_lambda_11de8ce1c68e57a9e4c3213d43d7ad85_--operator().c)
 */
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (unsigned int)v2 < v4 )
  {
    ...
    do
    {
      v9 = *((_QWORD *)this + 14);
      v14 = 0LL;
      Src = *(_OWORD *)(*((_QWORD *)this + 18) * v8 + v9);
      ...
      if ( (_QWORD)Src )
      {
        ...
        v11 = *((_QWORD *)this + 18);
        *(_QWORD *)&Src = 0LL;
        memmove((void *)(*((_QWORD *)this + 14) + v11 * (unsigned int)v2), &Src, v11);
      }
      if ( !v6 )
        break;
      ++*((_DWORD *)this + 38);
