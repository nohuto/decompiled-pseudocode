/*
 * XREFs of RIMCmRemoveContactSuppressionReasons @ 0x1C01B69D4
 * Callers:
...
_BOOL8 __fastcall RIMCmRemoveContactSuppressionReasons(__int64 a1, unsigned int *a2, __int64 a3)
{
  unsigned int v4; // ebp
  ...
  if ( (v10 & v4) != 0 )
    InputTraceLogging::RIM::SuppressContact(*(const struct RIMDEV **)(a1 + 16), a2[1], v4, a2[2], v9);
  v13 = *(unsigned int *)(a1 + 1012);
  if ( *(_DWORD *)(a1 + 1008) < (unsigned int)v13 )
