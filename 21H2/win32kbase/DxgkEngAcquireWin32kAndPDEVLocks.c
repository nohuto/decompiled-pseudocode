/*
 * XREFs of DxgkEngAcquireWin32kAndPDEVLocks @ 0x1C0010270
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkEngAcquireWin32kAndPDEVLocks(__int64 a1, unsigned int a2)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v23 && (*(int *)(v23 + 24) > 0 || *(_DWORD *)(v28 + 48)) )
    {
      ...
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v24, v25) )
        {
          v34 = 0;
          v26 = v29;
          v33 = 4;
          v32 = &v26;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FF7, (int)&ActivityId, 0, 3u, &v31);
        }
      }
    }
  }
