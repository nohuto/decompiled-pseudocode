/*
 * XREFs of ApiSeEditionDeferWinEventNotify @ 0x1C00997AC
 * Callers:
...
__int64 (*ApiSeEditionDeferWinEventNotify())(void)
{
  ...
  result = qword_1C029CE60;
  if ( qword_1C029CE60 )
  {
    result = (__int64 (*)(void))qword_1C029CE60();
    if ( (int)result >= 0 )
    {
      result = qword_1C029CE68;
      if ( qword_1C029CE68 )
        result = (__int64 (*)(void))qword_1C029CE68();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
