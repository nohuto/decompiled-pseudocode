/*
 * XREFs of ApiSetEditionContactVisualization @ 0x1C01CAC04
 * Callers:
...
__int64 __fastcall ApiSetEditionContactVisualization(unsigned int a1, __int64 a2, __int64 a3, unsigned int a4, int a5)
{
  ...
  if ( qword_1C02587C8 )
    ...
    v9 = -1073741637;
  if ( v9 >= 0 && qword_1C02587D0 )
    v8 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, _QWORD, int))qword_1C02587D0)(a1, v6, 480LL, a4, a5);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(a2) = 5;
    WPP_RECORDER_SF_(
