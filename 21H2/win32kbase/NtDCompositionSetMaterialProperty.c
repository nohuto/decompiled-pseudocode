/*
 * XREFs of NtDCompositionSetMaterialProperty @ 0x1C009D310
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Store@MaterialProperty@@QEAAJPEBUResourceObject@DirectComposition@@@Z @ 0x1C009D404 (-Store@MaterialProperty@@QEAAJPEBUResourceObject@DirectComposition@@@Z.c)
 *     FindOrCreateMaterialProperty @ 0x1C009D478 (FindOrCreateMaterialProperty.c)
 *     CheckShellExperienceComposerAccess @ 0x1C01D2F9C (CheckShellExperienceComposerAccess.c)
 */
