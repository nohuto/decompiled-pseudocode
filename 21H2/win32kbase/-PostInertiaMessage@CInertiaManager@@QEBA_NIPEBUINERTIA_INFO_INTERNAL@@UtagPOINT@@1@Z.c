/*
 * XREFs of ?PostInertiaMessage@CInertiaManager@@QEBA_NIPEBUINERTIA_INFO_INTERNAL@@UtagPOINT@@1@Z @ 0x1C01E11D4
 * Callers:
 ...
 *     ?HandleInertiaTimer@CPTPProcessor@@QEAAXXZ @ 0x1C01DE418 (-HandleInertiaTimer@CPTPProcessor@@QEAAXXZ.c)
 * Callees:
        ...
        struct tagPOINT a5)
{
  ...
  if ( a2 - 571 > 1 )
    return 0;
  v10 = (CInertiaManager *)WPP_GLOBAL_Control;
  v11 = 0;
  ...
  if ( (v12 & 0x10) == 0 )
  {
    CInputDest::CInputDest(&v26, *((_QWORD *)a3 + 15), 2 - ((v12 & 0x20) != 0), 1);
          ...
          if ( !(unsigned int)ApiSetEditionPostInertiaMessage((unsigned int)v33, v8, *((_QWORD *)a3 + 1), a4.x, 0LL) )
          {
            ...
            if ( (_BYTE)v24 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            {
              ...
              WPP_RECORDER_AND_TRACE_SF_(
                ...
                21,
                14,
                (__int64)&WPP_e3305ffdbcc53ea24f672f84ddf5e9a4_Traceguids);
            }
          }
...
LABEL_43:
  ...
  CInertiaManager::RouteSyntheticTouchpadToMT(v10, v8, a4, a5, *((_QWORD *)a3 + 1));
  return 1;
}
