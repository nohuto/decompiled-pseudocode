/*
 * XREFs of rimObsCheckForRegistrationConflicts @ 0x1C017D1E8
 * Callers:
 ...
 *     rimObsIsObserverTarget @ 0x1C017D368 (rimObsIsObserverTarget.c)
...
char __fastcall rimObsCheckForRegistrationConflicts(char a1, unsigned int a2, unsigned int a3, unsigned int a4)
{
  ...
  while ( 1 )
  {
    if ( Flink == v9 )
    {
      ...
      {
        LOBYTE(a2) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 23, 40, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
      }
      return 1;
    }
    v11 = Flink - 1;
