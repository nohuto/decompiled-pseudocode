/*
 * XREFs of ?OnEndSession@Usage@PTPTelemetry@@SAX_J@Z @ 0x1C01DE50C
 * Callers:
...
void __fastcall PTPTelemetry::Usage::OnEndSession(__int64 a1)
{
  ...
  if ( qword_1C0296B18 > 0 )
  {
    ...
    {
      PerformanceCounter = KeQueryPerformanceCounter(0LL);
      qword_1C0296B20 = PerformanceCounter.QuadPart;
    }
    qword_1C0296B30 = PerformanceCounter.QuadPart;
  }
