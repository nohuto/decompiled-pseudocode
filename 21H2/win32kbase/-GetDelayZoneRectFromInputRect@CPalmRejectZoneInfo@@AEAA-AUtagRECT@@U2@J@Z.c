/*
 * XREFs of ?GetDelayZoneRectFromInputRect@CPalmRejectZoneInfo@@AEAA?AUtagRECT@@U2@J@Z @ 0x1C01E5B9C
 * Callers:
        ...
        int a4)
{
  ...
  v4 = (unsigned int (__fastcall *)(CPalmRejectZoneInfo *))qword_1C029CC80;
  *retstr = 0LL;
  if ( v4 && v4(this) )
  {
