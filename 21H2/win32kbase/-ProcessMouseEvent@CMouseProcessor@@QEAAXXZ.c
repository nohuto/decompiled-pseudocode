/*
 * XREFs of ?ProcessMouseEvent@CMouseProcessor@@QEAAXXZ @ 0x1C0040F54
 * Callers:
 ...
 *     ?Initialize@CMouseRawInput@CMouseProcessor@@QEAAXAEBVCMouseEvent@2@@Z @ 0x1C0041D90 (-Initialize@CMouseRawInput@CMouseProcessor@@QEAAXAEBVCMouseEvent@2@@Z.c)
 ...
 *     ??0RawMouseEvent@CMouseProcessor@@QEAA@XZ @ 0x1C0042300 (--0RawMouseEvent@CMouseProcessor@@QEAA@XZ.c)
...
void __fastcall CMouseProcessor::ProcessMouseEvent(CMouseProcessor *this)
{
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)v2 + 1) = 0LL;
    ...
    if ( (unsigned int)dword_1C024BA90 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 64LL, v7, v8) )
    {
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v41 && (*(int *)(v41 + 24) > 0 || *(_DWORD *)(v65 + 48)) )
      {
        ...
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v42, v43) )
          {
            v52 = v66;
            v82 = 4LL;
            v81 = &v52;
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v65 && (*(_DWORD *)(v65 + 48) || *(int *)(v65 + 24) > 0) )
    {
      ...
      *(GUID *)(v65 + 28) = ActivityId;
      if ( (unsigned int)dword_1C024BA90 > 6 )
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, (unsigned int)dword_1C024BA90, v18) )
        {
          v53 = v66;
          v85 = 4LL;
          v84 = &v53;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FA0, (int)&ActivityId, 0, 3u, &v83);
          v44 = (unsigned int)dword_1C024BA90;
        }
        if ( (unsigned int)v44 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v44, v45) )
        {
          v54 = v66;
          v88 = 4LL;
          v87 = &v54;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FCD, (int)&ActivityId, 0, 3u, &v86);
        }
      }
    }
...
LABEL_35:
    ...
    {
      LOBYTE(v30) = 3;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v30, 6, 15, (__int64)&WPP_bc237edca6b43ca924b1688b2fc88a86_Traceguids);
    }
