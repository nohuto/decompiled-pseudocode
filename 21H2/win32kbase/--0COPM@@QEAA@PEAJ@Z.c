/*
 * XREFs of ??0COPM@@QEAA@PEAJ@Z @ 0x1C005BC90
 * Callers:
...
COPM *__fastcall COPM::COPM(COPM *this, int *a2)
{
  ...
  *(_QWORD *)this = 0LL;
  if ( *a2 >= 0 )
  {
    Pool2 = (struct _LOOKASIDE_LIST_EX *)ExAllocatePool2(66LL, 96LL);
    *(_QWORD *)this = Pool2;
    if ( Pool2 )
  ...
  *((_QWORD *)this + 1) = 0LL;
  if ( *a2 >= 0 )
  {
    v5 = (struct _LOOKASIDE_LIST_EX *)ExAllocatePool2(66LL, 96LL);
    *((_QWORD *)this + 1) = v5;
    if ( v5 )
  ...
  *((_QWORD *)this + 2) = 0LL;
  if ( *a2 >= 0 )
  {
    v6 = (struct _LOOKASIDE_LIST_EX *)ExAllocatePool2(66LL, 96LL);
    *((_QWORD *)this + 2) = v6;
    if ( v6 )
