/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x1C01FFC9C
 * Callers:
 ...
 * Callees:
 *     CompareEventEntry @ 0x1C01FF704 (CompareEventEntry.c)
 *     ComputeEventEntryHash @ 0x1C01FF790 (ComputeEventEntryHash.c)
