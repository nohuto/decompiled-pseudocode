/*
 * XREFs of ?UnreferenceFrame@CTouchProcessor@@AEAAXPEBUCPointerInputFrame@@W4CPointerInputFramePhase@@@Z @ 0x1C00CD17C
 * Callers:
...
__int64 __fastcall CTouchProcessor::UnreferenceFrame(__int64 a1, __int64 a2)
{
  if ( *(struct _KTHREAD **)(a1 + 48) != KeGetCurrentThread() )
    MicrosoftTelemetryAssertTriggeredArgsKM("IXPTelAssert", 0x20000LL, 7693LL);
