/*
 * XREFs of ?CollectMousePacketPerfTelemetry@MousePerfSummary@@QEAAXAEBU_MousePacketPerf@@@Z @ 0x1C0038180
 * Callers:
        ...
        const struct _MousePacketPerf *a2)
{
  ...
  *(_QWORD *)(v11 + 448) = v10;
  ...
  if ( (unsigned int)dword_1C028D610 > 5 && tlgKeywordOn((__int64)&dword_1C028D610, 16LL) )
  {
    v26 = *((_QWORD *)a2 + 5);
    v27 = *((_QWORD *)a2 + 4);
    v28 = *((_QWORD *)a2 + 3);
