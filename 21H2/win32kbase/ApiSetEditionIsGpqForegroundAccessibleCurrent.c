/*
 * XREFs of ApiSetEditionIsGpqForegroundAccessibleCurrent @ 0x1C003D084
 * Callers:
...
__int64 __fastcall ApiSetEditionIsGpqForegroundAccessibleCurrent(unsigned int a1, __int64 a2, __int64 a3)
{
  ...
  v7 = 0;
  if ( qword_1C029CEA0 && (int)qword_1C029CEA0(v4, a2, a3, v6) >= 0 && qword_1C029CEA8 )
    v7 = qword_1C029CEA8(a1);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
