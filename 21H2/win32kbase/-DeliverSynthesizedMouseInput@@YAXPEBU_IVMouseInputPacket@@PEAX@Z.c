/*
 * XREFs of ?DeliverSynthesizedMouseInput@@YAXPEBU_IVMouseInputPacket@@PEAX@Z @ 0x1C01B4038
 * Callers:
...
void __fastcall DeliverSynthesizedMouseInput(const struct _IVMouseInputPacket *a1, void *a2)
{
  ...
  {
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 12, 126, (__int64)&WPP_2ccd359dbff93ea23c150f58e4d81fa3_Traceguids);
  }
}
