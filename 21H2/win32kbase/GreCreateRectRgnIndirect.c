/*
 * XREFs of GreCreateRectRgnIndirect @ 0x1C0034360
 * Callers:
 ...
 *     CreateEmptyRgn @ 0x1C006ADE0 (CreateEmptyRgn.c)
 * Callees:
...
struct HOBJ__ *__fastcall GreCreateRectRgnIndirect(struct _RECTL *a1)
{
  ...
  if ( gpTypeIsolation[7] )
  {
    ...
    if ( qword_1C0257D50 && (int)qword_1C0257D50(v5, v4, v7) >= 0 && qword_1C0257D58 )
      v11 = qword_1C0257D58(v8, v9, v10);
    else
      v11 = 0LL;
    *(_QWORD *)(v6 + 88) = v11;
    if ( v11 )
