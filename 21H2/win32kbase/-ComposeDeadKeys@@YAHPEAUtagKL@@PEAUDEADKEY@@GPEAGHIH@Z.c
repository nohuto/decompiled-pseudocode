/*
 * XREFs of ?ComposeDeadKeys@@YAHPEAUtagKL@@PEAUDEADKEY@@GPEAGHIH@Z @ 0x1C01B1920
 * Callers:
        ...
        int a7)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_Dd((__int64)gBaseLog, 4u, 0x10u, 0xBu, (__int64)&WPP_452ce174e4dd36ee8a008521dfdf54c5_Traceguids);
  if ( a5 >= 1 )
  {
...
LABEL_32:
  ...
  else
  {
    ...
    {
      LOBYTE(a2) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 16, 12, (__int64)&WPP_452ce174e4dd36ee8a008521dfdf54c5_Traceguids);
    }
    return 0LL;
  }
}
