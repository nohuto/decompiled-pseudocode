/*
 * XREFs of ApiSetEditionxxxBroadcastSPIChange @ 0x1C01CE668
 * Callers:
...
__int64 (__fastcall *__fastcall ApiSetEditionxxxBroadcastSPIChange(unsigned int a1))(_QWORD, _QWORD)
{
  ...
  if ( qword_1C0257908 )
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C0257908();
  else
    result = 0LL;
  if ( (int)result >= 0 )
  {
    result = qword_1C0257910;
    if ( qword_1C0257910 )
      result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C0257910(a1, 0LL);
  }
