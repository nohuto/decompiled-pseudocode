/*
 * XREFs of ?OnTelemetryOutput@CPTPProcessor@@UEAAXPEBUPTPTelemetryOutput@@@Z @ 0x1C01DEAD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     EtwTraceTouchPadAAP @ 0x1C014E860 (EtwTraceTouchPadAAP.c)
 *     EtwTraceTouchPadCurtainState @ 0x1C014E930 (EtwTraceTouchPadCurtainState.c)
 ...
 *     ?OnNewSession@Usage@PTPTelemetry@@SAX_J@Z @ 0x1C01DEA7C (-OnNewSession@Usage@PTPTelemetry@@SAX_J@Z.c)
        ...
        if ( v7 )
        {
          ...
          if ( v8 )
          {
            ...
            if ( v9 )
            {
              ...
              if ( v10 )
              {
                ...
                if ( v11 )
                {
                  ...
                  if ( v12 )
                  {
                    ...
                    if ( v13 )
                    {
                      ...
                      if ( (_DWORD)v14 )
                      {
                        if ( (_DWORD)v14 == 4 )
                        {
                          MicrosoftTelemetryAssertTriggeredNoArgsKM(v14, v6, a3);
                          if ( !*((_BYTE *)this + 2213) )
                          {
                            *((_BYTE *)this + 2213) = 1;
                    ...
                    else
                    {
                      ...
                      {
                        if ( v23 == 1 )
                          qword_1C029D908 = *(_QWORD *)((char *)a2 + 12);
                      }
                      else
                      {
                        qword_1C029D900 = *(_QWORD *)((char *)a2 + 12);
                      }
                    }
                  }
                  else
                  {
                    ...
                    {
                      qword_1C029D8E0 += v25;
                      if ( v25 > qword_1C029D8E8 )
                        qword_1C029D8E8 = v25;
                      if ( !qword_1C029D8F0 || v25 < qword_1C029D8F0 )
                        qword_1C029D8F0 = v25;
                    }
                  }
                }
              ...
              else if ( qword_1C0296B18 < qword_1C029AC88 )
              {
                qword_1C0296B18 = *((_QWORD *)a2 + 1);
              }
            }
            else
            {
