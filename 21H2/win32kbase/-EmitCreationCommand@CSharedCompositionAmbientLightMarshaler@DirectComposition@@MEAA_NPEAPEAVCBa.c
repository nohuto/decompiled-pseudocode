/*
 * XREFs of ?EmitCreationCommand@CSharedCompositionAmbientLightMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00B7F80
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CSharedCompositionAmbientLightMarshaler::EmitCreationCommand(
