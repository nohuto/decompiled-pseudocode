/*
 * XREFs of ?OpenSharedResourceHandle@CApplicationChannel@DirectComposition@@QEAAJIPEAPEAX@Z @ 0x1C00AFB08
 * Callers:
        ...
        void **a3)
{
  ...
  if ( a2
    && v3 < *((_QWORD *)this + 10)
    && (_mm_lfence(), (v4 = *(_QWORD *)(v3 * *((_QWORD *)this + 11) + *((_QWORD *)this + 7))) != 0) )
  {
