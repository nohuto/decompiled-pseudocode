/*
 * XREFs of ?Duplicate@InputSink@InputTraceLogging@@SAXPEBUCompositionInputObject@@PEAX1_N@Z @ 0x1C004ABB8
 * Callers:
...
void __fastcall InputTraceLogging::InputSink::Duplicate(const struct CompositionInputObject *a1, void *a2, void *a3)
{
  ...
  if ( (unsigned int)dword_1C024BA90 > 5 && tlgKeywordOn((__int64)&dword_1C024BA90, 4LL) )
  {
    ...
    v10 = v6;
    v11 = v7;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0221B9F, 0, 0, 6u, &v12);
  }
}
