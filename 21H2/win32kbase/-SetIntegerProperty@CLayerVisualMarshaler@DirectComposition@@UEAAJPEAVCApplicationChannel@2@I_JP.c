/*
 * XREFs of ?SetIntegerProperty@CLayerVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C00B9E10
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( a3 != 55 )
  {
    ...
    if ( *((_BYTE *)this + 401) == ((_DWORD)a4 != 0) )
      return v5;
    *((_DWORD *)this + 101) |= 8u;
    *((_BYTE *)this + 401) = (_DWORD)a4 != 0;
    goto LABEL_4;
  }
  if ( *((_BYTE *)this + 400) != ((_DWORD)a4 != 0) )
  {
    *((_DWORD *)this + 101) |= 4u;
    *((_BYTE *)this + 400) = (_DWORD)a4 != 0;
LABEL_4:
    *a5 = 1;
  }
  return v5;
