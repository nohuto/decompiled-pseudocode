/*
 * XREFs of ?DeliverMouseButtonToInputDest@CMouseProcessor@@AEAAXAEBVCButtonEvent@1@AEBVCInputDest@@AEBUInputDeliveryContext@1@@Z @ 0x1C004B9DC
 * Callers:
  ...
  if ( *(_DWORD *)a3 )
  {
    if ( !CMouseProcessor::BufferInputDestinedForContainer(this, a2, a3) )
    {
            ...
            !(unsigned int)ApiSetEditionReportMouseBreakToAccessibility(a3, v22, &v28, (v23 >> 7) & 1)) )
      {
        ...
        {
          LOBYTE(v25) = 3;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v25, 6, 36, (__int64)&WPP_bc237edca6b43ca924b1688b2fc88a86_Traceguids);
        }
        UserAtomicCheck::~UserAtomicCheck((UserAtomicCheck *)v30);
      }
      else
      {
        ...
        {
          LOBYTE(v26) = 4;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v26, 6, 37, (__int64)&WPP_bc237edca6b43ca924b1688b2fc88a86_Traceguids);
        }
      }
    }
  }
