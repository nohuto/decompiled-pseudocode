/*
 * XREFs of hdcOpenDCW @ 0x1C0021590
 * Callers:
    ...
    if ( a5 )
    {
      if ( v13 )
      {
        if ( qword_1C02566B0 )
          ...
          v21 = -1073741637;
        if ( v21 >= 0 && qword_1C02566B8 )
        {
          LOBYTE(a2) = 2;
          v22 = (struct _LDEV *)qword_1C02566B8(*((_QWORD *)v13 + 3), a2);
        }
        else
        {
          v22 = 0LL;
        ...
        if ( v22 )
        {
          ...
          else if ( (int)IsUMPD_ldevUnloadImageSupported() >= 0 && qword_1C02566C8 )
          {
            qword_1C02566C8(v22);
          }
        }
