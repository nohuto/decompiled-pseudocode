/*
 * XREFs of ?UpdateISODState@Delivery@InputTraceLogging@@SAXPEBUtagQMSG@@@Z @ 0x1C0001C44
 * Callers:
...
void __fastcall InputTraceLogging::Delivery::UpdateISODState(const struct tagQMSG *a1)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 16LL, v1, v2) )
    {
      v6 = *(_DWORD *)(v4 + 100);
      v11 = v3;
      v15 = 8LL;
      ...
      v14 = &v12;
      v10 = -__CFSHR__(v6, 20);
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0219534, 0, 0, 8u, &v13);
    }
  }
}
