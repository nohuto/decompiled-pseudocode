/*
 * XREFs of UserThreadCallout @ 0x1C003C590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UserThreadCallout(PETHREAD Thread, int a2)
{
  ...
  if ( a2 )
  {
    if ( a2 == 1 )
    {
      ...
      {
        LOBYTE(a2) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 14, 26, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
      }
      ...
      if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
      {
        ...
        if ( v55 && (*(int *)(v55 + 24) > 0 || *(_DWORD *)(v79 + 48)) )
        {
          ...
          {
            if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v56, v57) )
            {
              v72 = v80;
              v87 = 4LL;
              v86 = &v72;
      ...
      if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v79 && (*(_DWORD *)(v79 + 48) || *(int *)(v79 + 24) > 0) )
      {
        ...
        *(GUID *)(v79 + 28) = ActivityId;
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, (unsigned int)dword_1C024BA90, v36) )
          {
            v71 = v80;
            v90 = 4LL;
            v89 = &v71;
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              3u,
              &v88);
            v58 = (unsigned int)dword_1C024BA90;
          }
          if ( (unsigned int)v58 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v58, v59) )
          {
            v74 = v80;
            v93 = 4LL;
            v92 = &v74;
      ...
      *(_DWORD *)(v46 + 488) |= 1u;
      ...
      if ( (v48 & 1) == 0 )
      {
        if ( (int)IsGetAppCompatFlags2QuadWordSupported() >= 0 && qword_1C0257A20 )
          qword_1C0257A20(gptiCurrent);
  ...
  else
  {
    ...
    {
      LOBYTE(a2) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 14, 25, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
    }
    ...
    if ( gbUserInitialized )
    {
      ...
      if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
      {
        ...
        if ( v62 && (*(int *)(v62 + 24) > 0 || *(_DWORD *)(v82 + 48)) )
        {
          ...
          if ( (unsigned int)dword_1C024BA90 > 6 )
          {
            if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v63, v64) )
            {
              v76 = v83;
              v96 = 4LL;
              v95 = &v76;
              tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FF7, (int)&v84, 0, 3u, &v94);
            }
          }
        }
      }
        ...
        *(GUID *)(v82 + 28) = v84;
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, (unsigned int)dword_1C024BA90, v18) )
          {
            ...
            v99 = 4LL;
            v98 = &v77;
            tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FA0, (int)&v84, 0, 3u, &v97);
            v65 = (unsigned int)dword_1C024BA90;
          }
          if ( (unsigned int)v65 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v65, v66) )
          {
            LODWORD(v73) = v83;
            v102 = 4LL;
            v101 = (void **)&v73;
            tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FCD, (int)&v84, 0, 3u, &v100);
          }
        }
      }
      EtwTraceAcquiredExclusiveUserCrit();
      ...
      if ( ThreadInfo >= 0 && (int)IsGetAppCompatFlags2QuadWordSupported() >= 0 && qword_1C0257A20 )
        qword_1C0257A20(gptiCurrent);
      UserSessionSwitchLeaveCrit();
    }
    else
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 14, 27, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
  }
