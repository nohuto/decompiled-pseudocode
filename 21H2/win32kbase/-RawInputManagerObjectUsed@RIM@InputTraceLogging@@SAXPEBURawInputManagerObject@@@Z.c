/*
 * XREFs of ?RawInputManagerObjectUsed@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@@Z @ 0x1C005EAFC
 * Callers:
 *     RIMRegisterForInputWithCallbacks @ 0x1C005E080 (RIMRegisterForInputWithCallbacks.c)
 *     _lambda_7c683ce7e834e820b1e487ff164319c2_::_lambda_invoker_cdecl_ @ 0x1C017D560 (_lambda_7c683ce7e834e820b1e487ff164319c2_--_lambda_invoker_cdecl_.c)
 * Callees:
...
void __fastcall InputTraceLogging::RIM::RawInputManagerObjectUsed(const struct RawInputManagerObject *a1)
{
  ...
  {
    v2 = *(_DWORD *)(v1 + 84);
    LODWORD(v13) = -(*(_DWORD *)(v1 + 1108) & 1);
    LODWORD(v14) = *(_DWORD *)(v1 + 1088);
