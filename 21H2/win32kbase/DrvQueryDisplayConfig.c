/*
 * XREFs of DrvQueryDisplayConfig @ 0x1C001F020
 * Callers:
...
__int64 __fastcall DrvQueryDisplayConfig(unsigned int a1, unsigned int *a2, __int64 a3, _DWORD *a4)
{
  ...
  *(_QWORD *)(v8 + 24) = v5;
  ...
  if ( (unsigned int)DrvIsWddmDriverPresent(v10, v9) )
  {
    ...
    if ( (v5 & 7) == 4 )
    {
      v11 = (unsigned __int8)((__int64 (*)(void))qword_1C0251A90)() != 0;
    ...
    if ( !v11 )
      v12 = a4;
    v13 = qword_1C0251948((unsigned int)v5 & 0xFFFFFFEF, v5 & 0x10, a2, a3, v12);
    if ( v13 >= 0 && v11 && a4 )
    {
      v17 = *a2;
      if ( *a2 > 1 )
