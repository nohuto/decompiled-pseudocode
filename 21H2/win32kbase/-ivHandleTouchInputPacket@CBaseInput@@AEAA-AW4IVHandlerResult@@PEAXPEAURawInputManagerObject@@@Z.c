/*
 * XREFs of ?ivHandleTouchInputPacket@CBaseInput@@AEAA?AW4IVHandlerResult@@PEAXPEAURawInputManagerObject@@@Z @ 0x1C01B9480
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      else
      {
        ...
        *(_QWORD *)(a3 + 112) = 0LL;
        ...
        {
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
            WPP_RECORDER_SF_((_DWORD)gBaseLog, 2, 12, 42, (__int64)&WPP_2ccd359dbff93ea23c150f58e4d81fa3_Traceguids);
          v5 = 0;
        }
        ApiSetEditionCrit::~ApiSetEditionCrit((ApiSetEditionCrit *)&v19);
      }
