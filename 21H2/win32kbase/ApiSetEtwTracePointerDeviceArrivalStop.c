/*
 * XREFs of ApiSetEtwTracePointerDeviceArrivalStop @ 0x1C020C8E4
 * Callers:
...
__int64 ApiSetEtwTracePointerDeviceArrivalStop()
{
  ...
  result = EtwTracePointerDeviceArrivalStop((__int64)v0);
