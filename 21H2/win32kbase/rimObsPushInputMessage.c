/*
 * XREFs of rimObsPushInputMessage @ 0x1C017ECA0
 * Callers:
...
__int64 __fastcall rimObsPushInputMessage(__int64 a1, _DWORD *a2)
{
  ...
  if ( !v10 )
  {
    ...
    {
      LOBYTE(a2) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 23, 12, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    }
    v6 = -1073741670;
    goto LABEL_24;
  }
...
LABEL_24:
    ...
    {
      LOBYTE(a2) = 3;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 23, 14, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    }
    if ( v7 )
