/*
 * XREFs of ??$EmitSetProperty@UPropertySetMatrix3x2Value@@UD2D_MATRIX_3X2_F@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C000E61C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v10 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, 0x34uLL, &v10);
  v7 = (char *)v10;
  *(_DWORD *)v10 = 52;
  *(_OWORD *)(v7 + 4) = 0LL;
  *(_QWORD *)(v7 + 20) = 0LL;
  ...
  *(_QWORD *)(v7 + 44) = *(_QWORD *)(Property + 16);
  PropertySetStorage<CDynamicArrayDefaultTag,PropertySetKernelModeAllocator>::SetMarshalStatus(a1 + 80, a3, 0LL);
  return v6;
}
