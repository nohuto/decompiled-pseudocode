/*
 * XREFs of ??$EmitSetProperty@UPropertySetMatrix3x2Value@@UD2D_MATRIX_3X2_F@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C0063198
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( (unsigned __int64)(4096LL - *((_QWORD *)(*a2)[17] + 5)) < 0x34
    && !DirectComposition::CBatch::AllocateNewFragment(a2, (unsigned __int64 *)&v18) )
  {
    return 0;
  }
  v18 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x34uLL, &v18);
  v7 = (char *)v18;
  *(_DWORD *)v18 = 52;
  *(_OWORD *)(v7 + 4) = 0LL;
  *(_QWORD *)(v7 + 20) = 0LL;
