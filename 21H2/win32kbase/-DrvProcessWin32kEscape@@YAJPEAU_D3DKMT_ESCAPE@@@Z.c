/*
 * XREFs of ?DrvProcessWin32kEscape@@YAJPEAU_D3DKMT_ESCAPE@@@Z @ 0x1C00A4CA8
 * Callers:
 *     ?DxgkEngProcessWin32kEscape@@YAJPEAU_D3DKMT_ESCAPE@@@Z @ 0x1C00A4C90 (-DxgkEngProcessWin32kEscape@@YAJPEAU_D3DKMT_ESCAPE@@@Z.c)
 * Callees:
...
LABEL_50:
    ...
    else
    {
      if ( a1->PrivateDriverDataSize != 40 )
        goto LABEL_16;
      CurrentDpiInfoFromHDC = ((__int64 (__fastcall *)(_WORD *))qword_1C0251B10)(v4);
    }
    goto LABEL_38;
  }
  if ( Type != D3DKMT_ESCAPE_WIN32K_DDA_TEST_CTL )
...
LABEL_20:
        ...
        {
          if ( qword_1C0251A90 )
            *((_DWORD *)v4 + 1) = (unsigned __int8)qword_1C0251A90() != 0;
          else
            v3 = -1073741637;
          goto LABEL_77;
        }
...
LABEL_51:
    ...
    else
    {
      ...
      if ( v3 < 0 )
        goto LABEL_83;
      if ( qword_1C0256438 )
        CurrentDpiInfoFromHDC = ((__int64 (__fastcall *)(_WORD *))qword_1C0256438)(v4);
    }
LABEL_38:
