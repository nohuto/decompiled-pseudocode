/*
 * XREFs of ?ProcessInput@CTouchProcessor@@QEAAXPEAX0HHH@Z @ 0x1C0199ACC
 * Callers:
...
void __fastcall CTouchProcessor::ProcessInput(CTouchProcessor *this, __int64 *a2, struct RIMCOMPLETEFRAME *a3)
{
  ...
  if ( ApiSetSanitizeRIMCOMPLETEFRAME(a3) )
  {
    ...
    {
      LOBYTE(v12) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v12, 7, 13, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        v9 = WPP_GLOBAL_Control;
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
  ...
  {
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 7, 11, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v9 = WPP_GLOBAL_Control;
      if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
