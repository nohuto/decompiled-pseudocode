/*
 * XREFs of ?CitpLastInputUpdate@@YAXGI@Z @ 0x1C00485E4
 * Callers:
 ...
 *     ?CitpSetOtherInputInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1C01FEA90 (-CitpSetOtherInputInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z.c)
 * Callees:
...
void __fastcall CitpLastInputUpdate(unsigned __int16 a1, unsigned int a2)
{
  ...
  {
    if ( a2 < *((_DWORD *)&xmmword_1C0255560 + 2) )
      v3 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    v5 = xmmword_1C0255560;
    *((_DWORD *)&xmmword_1C0255560 + 2) = v3;
    CIT_USER_ACTIVE_TRACKER::OnUserActiveEvent((struct _CIT_IMPACT_CONTEXT *)((char *)xmmword_1C0255560 + 228), v3);
    if ( !v4 )
