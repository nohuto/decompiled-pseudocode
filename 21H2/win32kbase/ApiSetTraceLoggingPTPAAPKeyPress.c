/*
 * XREFs of ApiSetTraceLoggingPTPAAPKeyPress @ 0x1C020FAC4
 * Callers:
...
__int64 (*__fastcall ApiSetTraceLoggingPTPAAPKeyPress(unsigned int a1))(void)
{
  ...
  result = qword_1C029D6E0;
  if ( qword_1C029D6E0 )
  {
    result = (__int64 (*)(void))qword_1C029D6E0();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029D6E8;
      if ( qword_1C029D6E8 )
        result = (__int64 (*)(void))qword_1C029D6E8(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
