/*
 * XREFs of ApiSetEditionRimDeviceReadNotification @ 0x1C020B308
 * Callers:
...
PDEVICE_OBJECT *__fastcall ApiSetEditionRimDeviceReadNotification(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( qword_1C029CD18 && (int)qword_1C029CD18(v8, a2, a3, v10) >= 0 && qword_1C029CD20 )
    qword_1C029CD20(a1, v6, v5, a4);
