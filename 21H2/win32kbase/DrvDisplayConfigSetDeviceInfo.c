/*
 * XREFs of DrvDisplayConfigSetDeviceInfo @ 0x1C0146990
 * Callers:
...
__int64 __fastcall DrvDisplayConfigSetDeviceInfo(int *a1, __int64 a2)
{
  ...
  result = ((__int64 (__fastcall *)(int *, _QWORD, int *, int *))qword_1C0251AA0)(
             a1 + 2,
             (unsigned int)a1[4],
             a1 + 2,
             a1 + 4);
    ...
    else
    {
      switch ( v9 )
      {
        ...
        case -16:
          if ( a1[1] != 68 )
            return -1073741811LL;
          v52 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0251968)(0LL, a1);
          v10 = v52;
          if ( v52 < 0 )
            goto LABEL_58;
          if ( v52 != 259 )
        ...
        case -6:
          if ( a1[1] == 28 )
          {
            v51 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0251968)(0LL, a1);
            v10 = v51;
            if ( v51 >= 0 )
            {
              if ( !a1[6] )
        ...
        case 5:
          ...
          v26 = ((__int64 (*)(void))qword_1C0251980)();
          v10 = v26;
          if ( v26 < 0 )
          {
          ...
          if ( (v29 & 1) != 0 )
          {
            ...
            if ( PathsModality < 0 )
            {
              ...
              {
                if ( (int)((__int64 (*)(void))qword_1C0251988)() < 0 )
                {
          ...
          v40 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64, _QWORD))qword_1C0251950)(*(_QWORD *)v6, *v5, v39, 0LL);
          v10 = v40;
          if ( v40 >= 0 )
          {
            if ( !v30 )
              goto LABEL_40;
            v44 = ((__int64 (__fastcall *)(__int64, struct D3DKMT_GETPATHSMODALITY *))qword_1C0251920)(
                    0x40000000LL,
                    v30);
            v47 = v44;
            if ( v44 >= 0 )
...
LABEL_40:
        ...
        case 8:
          if ( a1[1] != 24 )
            return -1073741811LL;
          v24 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0251968)(0LL, a1);
          v10 = v24;
          if ( v24 < 0 )
            goto LABEL_58;
LABEL_18:
...
LABEL_59:
        ...
        case 10:
          if ( a1[1] == 24 )
          {
            v13 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0251968)(0LL, a1);
            v10 = v13;
            if ( v13 >= 0 )
            {
              if ( v13 == 255 )
...
LABEL_14:
    ...
    v54 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C0251968)(0LL, a1);
    v10 = v54;
    if ( v54 >= 0 )
      return (unsigned int)v10;
    goto LABEL_58;
