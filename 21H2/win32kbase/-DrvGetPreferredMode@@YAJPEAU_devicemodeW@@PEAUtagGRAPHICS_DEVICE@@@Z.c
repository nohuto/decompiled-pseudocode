/*
 * XREFs of ?DrvGetPreferredMode@@YAJPEAU_devicemodeW@@PEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C00AC808
 * Callers:
  ...
  do
  {
    ...
    if ( (*(_BYTE *)(v18 + 20LL * v8) & 3) == 3 )
    {
      ...
      *(_QWORD *)&v22[0] = 197511LL;
      ...
      DWORD2(v22[6]) = 1;
      LODWORD(v22[6]) = 21;
      if ( (int)((__int64 (__fastcall *)(_OWORD *, _DWORD *))qword_1C0251B40)(v22, v7) >= 0 )
      {
        v14 = v7[46];
        if ( v14 >= v6 )
          v14 = v6;
