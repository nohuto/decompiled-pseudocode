/*
 * XREFs of hdevEnumerate @ 0x1C0010E40
 * Callers:
...
struct PDEV *__fastcall hdevEnumerate(struct PDEV *a1, int a2, int a3)
{
  ...
  while ( v6 )
  {
    if ( (*((_DWORD *)v6 + 10) & 1) != 0 )
    {
      ...
      LODWORD(a1) = (_DWORD)qword_1C024C408;
      if ( v7 && qword_1C024C408 )
        NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C024C408, v7, 1);
      break;
    }
    v6 = *(struct PDEV **)v6;
  }
  ...
  if ( v8 > 1 )
  {
    ...
    LODWORD(a1) = (_DWORD)qword_1C024C408;
    if ( v9 && qword_1C024C408 )
    {
      NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C024C408, v9, 0);
      v8 = *((_DWORD *)v5 + 2);
    }
    *((_DWORD *)v5 + 2) = v8 - 1;
LABEL_16:
