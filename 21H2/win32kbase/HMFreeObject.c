/*
 * XREFs of HMFreeObject @ 0x1C0007F10
 * Callers:
 ...
 *     SharedFree @ 0x1C0093010 (SharedFree.c)
 *     Feature_Servicing_win32k_timers_bugcheck__private_IsEnabledDeviceUsage @ 0x1C00C6E18 (Feature_Servicing_win32k_timers_bugcheck__private_IsEnabledDeviceUsage.c)
 *     MicrosoftTelemetryAssertTriggeredArgsKM @ 0x1C00CE6A8 (MicrosoftTelemetryAssertTriggeredArgsKM.c)
 *     ?HMDoubleFree@@YAXPEAX@Z @ 0x1C01139D0 (-HMDoubleFree@@YAXPEAX@Z.c)
...
__int64 __fastcall HMFreeObject(_DWORD *a1)
{
  ...
  v3 = (unsigned int)*a1;
  v4 = &unk_1C020A46C;
  v5 = (char *)qword_1C024FD58 + dword_1C024FD60 * (unsigned int)(unsigned __int16)v3;
  BugCheckParameter4 = (char *)gpKernelHandleTable + 24 * (unsigned __int16)v3;
  v7 = (unsigned __int8)v5[24];
  v8 = *((_WORD *)&unk_1C020A46C + 12 * v7);
  v9 = a1[2];
  if ( v9 )
  {
    if ( (_BYTE)v7 )
...
LABEL_66:
  ...
  *((_QWORD *)BugCheckParameter4 + 2) = 0LL;
  ...
  if ( v22 != -1 )
    v23 = v22;
  *((_WORD *)v5 + 13) = v23;
  v24 = (v5 - (char *)qword_1C024FD58) >> 5;
  if ( (v24 & 1) != 0 )
  {
    *(_QWORD *)BugCheckParameter4 = qword_1C024FCE0;
    qword_1C024FCE0 = v24;
  }
  else
  {
    *(_QWORD *)BugCheckParameter4 = qword_1C024FCD8;
    qword_1C024FCD8 = v24;
  }
