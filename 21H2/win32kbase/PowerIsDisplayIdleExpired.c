/*
 * XREFs of PowerIsDisplayIdleExpired @ 0x1C00856F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z @ 0x1C00859B0 (-IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z.c)
 *     PowerIsDisplayBurstActive @ 0x1C011A1B0 (PowerIsDisplayBurstActive.c)
...
_BOOL8 __fastcall PowerIsDisplayIdleExpired(int a1, int *a2)
{
  ...
  v6 = 0;
  if ( CInputGlobals::GetGlobalTickCount(gpInputGlobals, 0LL) < (unsigned __int64)qword_1C0252178 )
  {
