/*
 * XREFs of ?Create@CSharedReadHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F9424
 * Callers:
 *     CreateSharedReadHolographicInteropTextureMarshaler @ 0x1C01F9520 (CreateSharedReadHolographicInteropTextureMarshaler.c)
 * Callees:
