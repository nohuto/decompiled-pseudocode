/*
 * XREFs of ??$EmitSetProperty@UPropertySetBooleanValue@@_N@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C022B960
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( (unsigned __int64)(4096LL - *((_QWORD *)(*a2)[17] + 5)) < 0x20
    && !DirectComposition::CBatch::AllocateNewFragment(a2, (unsigned __int64 *)&v15) )
  {
    return 0;
  }
  v15 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x20uLL, &v15);
  v7 = (char *)v15;
  *(_DWORD *)v15 = 32;
  *(_OWORD *)(v7 + 4) = 0LL;
  *(_QWORD *)(v7 + 20) = 0LL;
