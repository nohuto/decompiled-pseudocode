/*
 * XREFs of ?LogUmpdCallbackStatus@XDCOBJ@@AEAAXPEAVUMPDOBJ@@@Z @ 0x1C00C82B0
 * Callers:
...
void __fastcall XDCOBJ::LogUmpdCallbackStatus(XDCOBJ *this, struct UMPDOBJ *a2)
{
  ...
  if ( dword_1C024A250 )
  {
    if ( tlgKeywordOn((__int64)&dword_1C024A250, 0x400000000000LL) )
    {
      ...
      if ( *(_DWORD *)(*(_QWORD *)v3 + 2144LL) != (_DWORD)v5 )
      {
        *(_DWORD *)(*(_QWORD *)v3 + 2144LL) = v5;
        ...
        if ( (unsigned int)dword_1C024A250 > 5 && tlgKeywordOn((__int64)&dword_1C024A250, v2) )
        {
          v16 = v6;
          v12 = v5;
          v13 = v8;
