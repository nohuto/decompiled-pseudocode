/*
 * XREFs of ApiSetEditionPopProcessLaunchForegroundPolicy @ 0x1C00A2AB8
 * Callers:
...
__int64 __fastcall ApiSetEditionPopProcessLaunchForegroundPolicy(__int64 a1)
{
  char v2; // bl
  char v3; // dl
  char v4; // r8
