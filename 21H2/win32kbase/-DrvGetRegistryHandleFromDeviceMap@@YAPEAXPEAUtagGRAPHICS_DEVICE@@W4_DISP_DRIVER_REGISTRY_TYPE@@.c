/*
 * XREFs of ?DrvGetRegistryHandleFromDeviceMap@@YAPEAXPEAUtagGRAPHICS_DEVICE@@W4_DISP_DRIVER_REGISTRY_TYPE@@PEBKPEAGKPEAJ@Z @ 0x1C00297C0
 * Callers:
        ...
        NTSTATUS *a6)
{
  ...
  v17 = *((_DWORD *)a1 + 40) & 8;
  v18 = (WCHAR *)Win32AllocPool(512LL, 1886221383LL);
  v86 = v18;
  v10 = v18;
  if ( v18 )
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v19 < 0 )
    goto LABEL_119;
  v20 = (WCHAR *)Win32AllocPool(1024LL, 1886221383LL);
  v9 = v20;
  if ( v20 )
  ...
  if ( a2 != 3 )
  {
    ...
    if ( a4 )
    {
      ...
      *(_QWORD *)Length = 102LL;
      ...
      v40 = (unsigned __int16 *)PALLOCMEM2((unsigned int)v38);
      v85 = v40;
      v41 = v40;
      if ( v40 )
      {
