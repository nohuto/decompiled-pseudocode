/*
 * XREFs of bMigrateSurfaceForConversion @ 0x1C00B9E00
 * Callers:
 ...
 *     ?bUnMapImmediate@SURFREFVIEW@@QEAAHXZ @ 0x1C00793C0 (-bUnMapImmediate@SURFREFVIEW@@QEAAHXZ.c)
...
LABEL_8:
        ...
        v14) )
  {
    ...
    if ( qword_1C02562F0 )
      ...
      v28 = -1073741637;
    if ( v28 >= 0 && qword_1C02562F8 )
      v25 = (HLSURF)qword_1C02562F8(*((_QWORD *)this + 6), v27, 0LL, 1LL, 1);
      ...
      *((_DWORD *)a2 + 29) ^= (v39 ^ *((_DWORD *)a2 + 29)) & 0x390D;
      ...
      if ( v27 )
      {
        ...
        *((_QWORD *)&v96 + 1) = 0LL;
        ...
        if ( v24 )
        {
          ...
          if ( v70 >= 0 && qword_1C0256298 )
            qword_1C0256298(*((_QWORD *)v12 + 6), *((_QWORD *)&v96 + 1), a2, v101);
        }
        else
        {
          v71 = -1073741637;
      ...
      if ( (*((_DWORD *)a2 + 29) & 4) != 0 )
      {
        ...
        if ( v94 && *(_QWORD *)(v94 + 24) )
        {
          ...
          if ( v71 >= 0 && qword_1C02562B8 )
            qword_1C02562B8(*(_QWORD *)(v72 + 24), v99, v98);
        }
