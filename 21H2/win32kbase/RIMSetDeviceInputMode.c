/*
 * XREFs of RIMSetDeviceInputMode @ 0x1C00ACD80
 * Callers:
 ...
 *     ?InputModeToString@InputTraceLogging@@CAPEBDW4_WIN32K_INPUT_MODE@@@Z @ 0x1C0166498 (-InputModeToString@InputTraceLogging@@CAPEBDW4_WIN32K_INPUT_MODE@@@Z.c)
 */
