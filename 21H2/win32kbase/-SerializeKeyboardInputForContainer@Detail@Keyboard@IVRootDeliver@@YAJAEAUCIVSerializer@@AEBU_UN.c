/*
 * XREFs of ?SerializeKeyboardInputForContainer@Detail@Keyboard@IVRootDeliver@@YAJAEAUCIVSerializer@@AEBU_UNICODE_STRING@@AEBU_KEYBOARD_INPUT_DATA@@@Z @ 0x1C01BCF64
 * Callers:
...
LABEL_13:
    v12 = v7;
    LOBYTE(v8) = 2;
    WPP_RECORDER_SF_d((_DWORD)gBaseLog, v8, 12, v10, (__int64)&WPP_ce934868e6283481801d375bb45badae_Traceguids, v12);
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(v8) = 5;
