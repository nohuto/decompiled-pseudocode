/*
 * XREFs of NtUserGetKeyboardLayout @ 0x1C003D350
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)a1 )
  {
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v47 && (*(int *)(v47 + 24) > 0 || *(_DWORD *)(v59 + 48)) )
      {
        ...
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v48, v49) )
          {
            v54 = v60;
            v70 = 4LL;
            v69 = &v54;
            tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FF7, (int)&v61, 0, 3u, &v68);
          }
        }
      }
    }
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v59 && (*(_DWORD *)(v59 + 48) || *(int *)(v59 + 24) > 0) )
    {
      ...
      *(GUID *)(v59 + 28) = v61;
      if ( (unsigned int)dword_1C024BA90 > 6 )
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, (unsigned int)dword_1C024BA90, v31) )
        {
          v74 = 0;
          v56 = v60;
          v73 = 4;
          v72 = &v56;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FA0, (int)&v61, 0, 3u, &v71);
          v50 = (unsigned int)dword_1C024BA90;
        }
        if ( (unsigned int)v50 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v50, v51) )
        {
          v78 = 0;
          v57 = v60;
          v77 = 4;
          v76 = &v57;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FCD, (int)&v61, 0, 3u, &v75);
        }
      }
    }
  ...
  else
  {
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v44 && (*(int *)(v44 + 24) > 0 || *(_DWORD *)(v62 + 48)) )
      {
        ...
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v45, v46) )
          {
            v55 = ActivityId_4;
            v67 = 4LL;
            v66 = &v55;
