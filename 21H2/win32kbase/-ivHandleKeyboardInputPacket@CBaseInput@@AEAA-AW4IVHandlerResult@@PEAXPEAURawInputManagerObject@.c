/*
 * XREFs of ?ivHandleKeyboardInputPacket@CBaseInput@@AEAA?AW4IVHandlerResult@@PEAXPEAURawInputManagerObject@@@Z @ 0x1C01EDA20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseInput::ivHandleKeyboardInputPacket(__int64 a1, UNICODE_STRING *a2, __int64 a3)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        v9 = &WPP_4c82548882e434c25d4dd8d26e311b60_Traceguids;
        LOBYTE(v9) = v5;
