/*
 * XREFs of ?ivHandleKeyboardInputPacket@CBaseInput@@AEAA?AW4IVHandlerResult@@PEAXPEAURawInputManagerObject@@@Z @ 0x1C01B80A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseInput::ivHandleKeyboardInputPacket(__int64 a1, struct _IVKeyboardInputPacket *a2, __int64 a3)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 12, 45, (__int64)&WPP_2ccd359dbff93ea23c150f58e4d81fa3_Traceguids);
  }
  v11 = 0LL;
  v12 = 0LL;
  v5 = 1;
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_d((_DWORD)gBaseLog, 2, 12, 47, (__int64)&WPP_2ccd359dbff93ea23c150f58e4d81fa3_Traceguids, v6);
    v5 = 0;
  }
  else
  {
    ...
    else
    {
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_((_DWORD)gBaseLog, 2, 12, 46, (__int64)&WPP_2ccd359dbff93ea23c150f58e4d81fa3_Traceguids);
        v5 = 0;
      }
      *(_QWORD *)(a3 + 112) = 0LL;
      ExReleasePushLockExclusiveEx(a3 + 104, 0LL);
