/*
 * XREFs of ?Win32kLeakTrackingLiveDumpCallback@@YAJPEAXP6AJ0PEBU_GUID@@0K@ZK_K3330@Z @ 0x1C0146780
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a8)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
      v13 = 0;
      v15[0] = xmmword_1C0268350;
      v15[1] = xmmword_1C0268340;
      v15[2] = xmmword_1C0268330;
      do
      {
        if ( v12 < 0 )
          break;
