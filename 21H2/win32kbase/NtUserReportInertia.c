...
LABEL_16:
    LOBYTE(v15) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 21, v23, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids);
    goto LABEL_101;
  }
  if ( (a2 & 0xFFFFFFF8) != 0 )
  {
...
LABEL_100:
    LOBYTE(v15) = 2;
    WPP_RECORDER_SF_d((_DWORD)gBaseLog, v15, 21, v24, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids, a2);
    goto LABEL_101;
  }
  LOBYTE(v12) = a2 & 1;
  if ( (a2 & 1) == 0 )
...
LABEL_9:
  ...
  if ( !v26 )
  {
    ...
    {
      LOBYTE(v26) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v26, 21, 68, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids);
    }
    v21 = 0;
LABEL_31:
    v27 = 5LL;
...
LABEL_10:
  ...
  if ( !v16 )
  {
    ...
    {
      LOBYTE(v20) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v20, 21, 80, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids);
    }
    v21 = 0;
    goto LABEL_31;
  }
...
LABEL_36:
      LOBYTE(v28) = 2;
      WPP_RECORDER_SF_q((_DWORD)gBaseLog, v28, 21, v31, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids, a3);
      v30 = 0;
      goto LABEL_37;
    }
    a3 = v29;
...
LABEL_44:
    LOBYTE(v28) = 2;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v28, 21, v33, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids);
    goto LABEL_45;
  }
  if ( v17 )
  {
  ...
  else
  {
      ...
      && v14 != CInputDest::GetDelegateThreadInfo((CInputDest *)v63) )
    {
      ...
      {
        LOBYTE(v36) = 2;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v36, 21, 73, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids);
      }
      v21 = 0;
      goto LABEL_47;
    }
         ...
         &v52) )
  {
    ...
    {
      LOBYTE(v47) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v47, 21, 78, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids);
    }
    v43 = 5LL;
  }
  else
  {
    ...
    {
      LOBYTE(v42) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v42, 21, 77, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids);
    }
    v43 = 87LL;
  }
  v21 = 0;
