/*
 * XREFs of ApiSetEditionOverrideDefaultTouchGestureSettings @ 0x1C0086C54
 * Callers:
...
__int64 (*__fastcall ApiSetEditionOverrideDefaultTouchGestureSettings(__int64 a1))(void)
{
  ...
  result = qword_1C029D798;
  if ( qword_1C029D798 )
  {
    result = (__int64 (*)(void))qword_1C029D798();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029D7A0;
      if ( qword_1C029D7A0 )
        result = (__int64 (*)(void))qword_1C029D7A0(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
