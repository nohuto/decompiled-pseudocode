/*
 * XREFs of ApiSetEditionFreeIMEKeyboardLayouts @ 0x1C005033C
 * Callers:
...
__int64 (*__fastcall ApiSetEditionFreeIMEKeyboardLayouts(__int64 a1))(void)
{
  ...
  result = qword_1C029D030;
  if ( qword_1C029D030 )
  {
    result = (__int64 (*)(void))qword_1C029D030();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029D038;
      if ( qword_1C029D038 )
        result = (__int64 (*)(void))qword_1C029D038(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
