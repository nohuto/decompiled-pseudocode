/*
 * XREFs of rimFindMonitorForDigitizerWithQDCData @ 0x1C0165650
 * Callers:
...
LABEL_21:
    ...
    v18 = 200LL * v3;
    v57 = 0LL;
    if ( (int)((__int64 (__fastcall *)(__int64, _QWORD, PVOID *, struct _DEVICE_OBJECT **))qword_1C0251A38)(
  ...
  if ( (int)DrvDisplayConfigGetDeviceInfo((struct DISPLAYCONFIG_DEVICE_INFO_HEADER *)v53) < 0 )
  {
    ...
    {
      LOBYTE(v17) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v17, 12, 11, (__int64)&WPP_516b30da09af3a4d670a255114438942_Traceguids);
    }
    goto LABEL_20;
  }
