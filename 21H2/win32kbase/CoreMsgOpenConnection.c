/*
 * XREFs of CoreMsgOpenConnection @ 0x1C00AA18C
 * Callers:
 ...
 *     UserCoreMsgOpenConnectionHandle @ 0x1C01EBB30 (UserCoreMsgOpenConnectionHandle.c)
 * Callees:
