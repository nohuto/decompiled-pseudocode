/*
 * XREFs of ?SendRootPnpSyncState@PnP@IVRootDeliver@@YAJW4_IVPnPSyncState@@KAEBUCONTAINER_ID@@@Z @ 0x1C01BC758
 * Callers:
  ...
  if ( v17 )
  {
    ...
    *v7 = a1;
    ...
    if ( v11 < 0 )
    {
      ...
      LODWORD(v14) = v11;
      LOBYTE(v8) = 2;
      WPP_RECORDER_SF_d((_DWORD)gBaseLog, v8, 12, 88, (__int64)&WPP_ce934868e6283481801d375bb45badae_Traceguids, v14);
    }
  }
  else
  {
