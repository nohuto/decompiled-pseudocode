/*
 * XREFs of ?OpenSharedHandle@CSharedHolographicInteropTextureMarshaler@DirectComposition@@UEAAJPEAPEAX@Z @ 0x1C01F88A0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DirectComposition::CSharedHolographicInteropTextureMarshaler::OpenSharedHandle(
