/*
 * XREFs of Win32kBaseUserInitialize @ 0x1C0067B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Win32kBaseUserInitialize(HANDLE Handle, __int64 a2)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 14, 28, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
  }
  if ( !gpepCSRSS )
  {
    ...
    if ( !_InterlockedCompareExchange64((volatile signed __int64 *)&gpepCSRSS, BugCheckParameter4, 0LL) )
    {
      ...
      if ( (unsigned int)InitializeGreCSRSS() )
      {
        ...
        *(_DWORD *)(PsGetProcessWin32Process(gpepCSRSS) + 280) = 18;
        ...
        {
          LOBYTE(v12) = 4;
          WPP_RECORDER_SF_((_DWORD)gBaseLog, v12, 14, 29, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
        }
        return (unsigned int)v5;
      }
    }
