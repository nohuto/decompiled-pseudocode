/*
 * XREFs of ApiSetTraceLoggingUserIsActive @ 0x1C00D23D8
 * Callers:
        ...
        __int64 a3))(_QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029D738;
  if ( qword_1C029D738 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029D738(v5, a2, a3, v7);
    if ( (int)result >= 0 )
    {
      result = qword_1C029D740;
      if ( qword_1C029D740 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029D740(a1, v3);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
