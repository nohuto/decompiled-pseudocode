/*
 * XREFs of xxxInitProcessInfo @ 0x1C00B88C4
 * Callers:
 ...
 *     ?MarkImmersiveProcess@@YAXPEAUtagPROCESSINFO@@PEAXW4_PROCESS_IMMERSIVE_TYPE@@@Z @ 0x1C0095A10 (-MarkImmersiveProcess@@YAXPEAUtagPROCESSINFO@@PEAXW4_PROCESS_IMMERSIVE_TYPE@@@Z.c)
    ...
    *((_DWORD *)a1 + 205) ^= (*((_DWORD *)a1 + 205) ^ (a5 << 7)) & 0x80;
    ...
    else
    {
      ...
      *((_QWORD *)a1 + 47) = gppiList;
      ...
      {
        v25 = qword_1C02573C0 ? qword_1C02573C0() : -1073741637;
        if ( v25 >= 0 )
        {
          if ( qword_1C02573C8 ? qword_1C02573C8(*(_QWORD *)a1) : 0 )
            *((_DWORD *)a1 + 3) |= 0x100u;
        }
      }
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
