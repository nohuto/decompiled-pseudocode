/*
 * XREFs of ?IVSerializeRimDevForIVPnpCreatePacket@@YAJPEAURIMDEV@@AEBU_UNICODE_STRING@@AEAVCIVPnPCreateSerializer@@@Z @ 0x1C01ECEA0
 * Callers:
 ...
 * Callees:
 *     ?IVPopulateDeviceUIPIInfo@@YAXAEBURawInputManagerDeviceObject@@PEAU_IV_UIPI_INFO_INT@@@Z @ 0x1C01ECAAC (-IVPopulateDeviceUIPIInfo@@YAXAEBURawInputManagerDeviceObject@@PEAU_IV_UIPI_INFO_INT@@@Z.c)
 *     ?Serialize@CIVPnPCreateSerializer@@QEAAJAEAU_IV_HID_DEVICE_INFO@@AEBUtagHID_DEVICE_INFO@@_N@Z @ 0x1C01FDC50 (-Serialize@CIVPnPCreateSerializer@@QEAAJAEAU_IV_HID_DEVICE_INFO@@AEBUtagHID_DEVICE_INFO@@_N@Z.c)
 *     ?Serialize@CIVPnPCreateSerializer@@QEAAXAEAU_IV_KEYBOARD_DEVICE_INFO@@AEBUtagKEYBOARD_DEVICE_INFO@@@Z @ 0x1C01FDD0C (-Serialize@CIVPnPCreateSerializer@@QEAAXAEAU_IV_KEYBOARD_DEVICE_INFO@@AEBUtagKEYBOARD_DEVICE_INF.c)
