/*
 * XREFs of xxxUserSetDisplayConfig @ 0x1C0075A10
 * Callers:
        ...
        if ( (v11 & 0x80) != 0 )
        {
          ...
          else
          {
            if ( (unsigned int)DrvQueryMDEVPowerState(*(_QWORD *)(gpDispInfo + 16)) )
            {
              ...
              if ( qword_1C0257BE0 )
                qword_1C0257BE0();
              if ( qword_1C0252420 && qword_1C0257BF0 )
                qword_1C0257BF0();
              if ( qword_1C0256A98 )
...
LABEL_29:
            ...
            {
              if ( qword_1C0256B98 )
                qword_1C0256B98(*((_QWORD *)v14 + 5), &gRemoteWndsMonitorSnapshotHead);
              if ( qword_1C0256BA8 )
                qword_1C0256BA8(&gRemoteWndsMonitorSnapshotHead);
            }
          }
          else if ( qword_1C0257638 )
          {
            qword_1C0257638(v26, v27);
          }
          if ( v14 )
          {
            ...
            {
              if ( qword_1C0257AE0 )
                qword_1C0257AE0(v30[3], 1LL, 66693LL);
            }
          }
          if ( qword_1C02575D8 )
            qword_1C02575D8(1LL);
