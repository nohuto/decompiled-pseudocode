/*
 * XREFs of ?EmitAppendSurfaceResources@CPrimitiveGroupMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0011F9C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 25) < *((_DWORD *)this + 24); *((_DWORD *)this + 25) += v5 )
  {
    ...
    *((_DWORD *)v6 + 2) = *((_DWORD *)this + 8);
    ...
    {
      v9 = v7 + *((_DWORD *)this + 25);
      ++v7;
      *v8 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 11) + 8 * v9) + 32LL);
    }
  }
  return *((_DWORD *)this + 25) == *((_DWORD *)this + 24);
}
