/*
 * XREFs of ?WriteSystemMetricsKey@CInputSystemMetrics@@AEBAXKW4tagHPD_REGISTRY_HIVE@@@Z @ 0x1C008B454
 * Callers:
 *     ?Initialize@CInputSystemMetrics@@SAJXZ @ 0x1C008B3AC (-Initialize@CInputSystemMetrics@@SAJXZ.c)
 *     ForceUpdatePointerDeviceSystemMetrics @ 0x1C008B410 (ForceUpdatePointerDeviceSystemMetrics.c)
