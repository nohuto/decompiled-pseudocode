/*
 * XREFs of Win32kBaseDriverEntry @ 0x1C029B770
 * Callers:
 *     <none>
 * Callees:
 ...
 *     InitializeWin32kCall @ 0x1C009B7C0 (InitializeWin32kCall.c)
 *     ?InitializeWppLogging@@YAJPEAU_DRIVER_OBJECT@@@Z @ 0x1C00AB7F0 (-InitializeWppLogging@@YAJPEAU_DRIVER_OBJECT@@@Z.c)
 *     ?InitializeUserTypeIsolation@@YA_NXZ @ 0x1C00AEC40 (-InitializeUserTypeIsolation@@YA_NXZ.c)
 *     CreateKernelSemaphore @ 0x1C00AFB90 (CreateKernelSemaphore.c)
 *     OPMInitialize @ 0x1C00B0598 (OPMInitialize.c)
 ...
 *     InitializeTelemetryAssertsKMByName @ 0x1C00B3124 (InitializeTelemetryAssertsKMByName.c)
 *     ?CheckInitialSessions@@YAJXZ @ 0x1C00B5190 (-CheckInitialSessions@@YAJXZ.c)
 ...
 *     McGenEventRegister_EtwRegister @ 0x1C00B8354 (McGenEventRegister_EtwRegister.c)
 ...
 *     TlgRegisterAggregateProviderEx @ 0x1C027F5D8 (TlgRegisterAggregateProviderEx.c)
 *     TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x1C027F6CC (TraceLoggingRegisterEx_EtwRegister_EtwSetInformation.c)
 *     wil_InitializeFeatureStaging @ 0x1C0298078 (wil_InitializeFeatureStaging.c)
...
__int64 __fastcall Win32kBaseDriverEntry(__int64 a1)
{
  ...
  else
  {
    ...
    dword_1C025092C = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    if ( CurrentDisplayState < 0 )
      CurrentDisplayState = 0;
  }
  if ( !gpWin32kDriverObject )
...
LABEL_15:
  if ( dword_1C0255DE0 == 1 )
    CurrentDisplayState = -1073741801;
  if ( (int)IsTelemetryAssertsSupported() >= 0 && qword_1C0257EF0 )
    qword_1C0257EF0();
  if ( CurrentDisplayState >= 0 )
  {
    ...
    if ( CurrentDisplayState >= 0 )
    {
      v7 = qword_1C0256D20 ? qword_1C0256D20() : -1073741637;
      if ( v7 >= 0 )
      {
        if ( qword_1C0256D28 )
          CurrentDisplayState = qword_1C0256D28();
        else
          CurrentDisplayState = -1073741637;
      }
    }
  }
  if ( dword_1C0255DE0 == 2 )
    CurrentDisplayState = -1073741801;
  if ( qword_1C0257CE0 )
    v8 = qword_1C0257CE0();
  else
  ...
  if ( v8 >= 0 )
  {
    v9 = qword_1C0257CE8 ? qword_1C0257CE8() : 0;
    if ( !v9 && CurrentDisplayState >= 0 )
      CurrentDisplayState = -1073741801;
  }
  if ( dword_1C0255DE0 == 3 )
    CurrentDisplayState = -1073741801;
  if ( CurrentDisplayState >= 0 )
  {
    ...
    WdInitialize();
    TlgRegisterAggregateProviderEx(&dword_1C0246378);
  }
  if ( dword_1C0255DE0 == 4 )
    CurrentDisplayState = -1073741801;
  if ( CurrentDisplayState >= 0 )
    CurrentDisplayState = InitializeGraphicsInfrastructure();
  v11 = 64LL;
  if ( dword_1C0255DE0 == 5 )
    CurrentDisplayState = -1073741801;
  gdwHydraHint |= 1u;
  gpvWin32kImageBase = *(PVOID *)(a1 + 24);
  qword_1C0253B68 = (__int64)&gtmrListHead;
  gtmrListHead = (__int64)&gtmrListHead;
  qword_1C0253B78 = (__int64)&gtmrAdjustmentListHead;
  ...
  qword_1C0252770 = (__int64)&gPendingNotifiesList;
  ...
  if ( qword_1C0256C90 )
    ...
    v13 = -1073741637;
  if ( v13 >= 0 && qword_1C0256C98 )
    qword_1C0256C98();
  if ( qword_1C0256CA0 )
    v14 = qword_1C0256CA0();
  else
    v14 = -1073741637;
  if ( v14 >= 0 && qword_1C0256CA8 )
    qword_1C0256CA8();
  ...
  *(_QWORD *)&gCookie &= ~0x8000000000000000uLL;
  ...
  if ( qword_1C0255F78 )
    qword_1C0255F78(Win32KDriverUnload);
  ...
  if ( !gSessionId )
  {
    v19 = qword_1C0255F40 ? qword_1C0255F40() : 0LL;
    v20 = qword_1C0255F38 ? qword_1C0255F38() : 0;
    v21 = qword_1C0255F30 ? qword_1C0255F30() : 0LL;
  ...
  if ( !gSessionId )
  {
    if ( !qword_1C0255F68 || (qword_1C0255F68(), !gSessionId) )
  ...
  TlgRegisterAggregateProviderEx(&dword_1C024A1E0);
  ...
  if ( qword_1C0256CC0 )
    ...
    v35 = -1073741637;
  if ( v35 >= 0 && qword_1C0256CC8 )
    qword_1C0256CC8();
  if ( qword_1C0256CD0 )
    v36 = qword_1C0256CD0();
  else
    v36 = -1073741637;
  if ( v36 >= 0 && qword_1C0256CD8 )
    qword_1C0256CD8();
...
LABEL_89:
  ...
  dword_1C02521EC = LODWORD(OutputBuffer[3]) == 1;
  dword_1C02521F8 = HIDWORD(OutputBuffer[3]) == 0;
  dword_1C0252214 = LOBYTE(OutputBuffer[6]);
  dword_1C025220C = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  dword_1C02521F4 = 1;
  dword_1C0252218 = HIDWORD(OutputBuffer[6]) != 0;
  dword_1C02521A0 = 1;
  qword_1C0252168 = 0LL;
  qword_1C0252180 = 0LL;
  qword_1C0252178 = (((unsigned __int64)MEMORY[0xFFFFF78000000004] << 32)
  ...
  qword_1C0252170 = (v37 * (unsigned __int128)(unsigned __int64)(MEMORY[0xFFFFF78000000320] << 8)) >> 64;
  dword_1C0252198 = 0;
  dword_1C0252220 = 0;
  giDimTimeOutMs = 1000 * HIDWORD(OutputBuffer[2]);
  qword_1C02521B8 = OutputBuffer[5];
  dword_1C02521B0 = HIDWORD(OutputBuffer[4]);
  dword_1C02521A8 = OutputBuffer[4];
  dword_1C025221C = BYTE1(OutputBuffer[6]);
  gbManualDimTimeOut = PowerIsDimTimeOutManual((const unsigned __int16 *)v37);
  dword_1C02521C4 = dword_1C02521A8;
  dword_1C02521D4 = dword_1C02521B0;
  dword_1C02521C8 = -1;
  dword_1C02521CC = -1;
  dword_1C02521D0 = -1;
  dword_1C02521D8 = -1;
  ...
  if ( CurrentDisplayState < 0 )
    goto LABEL_80;
  v38 = qword_1C0256CE0 ? qword_1C0256CE0() : -1073741637;
  if ( v38 >= 0 )
  {
    CurrentDisplayState = qword_1C0256CE8 ? qword_1C0256CE8() : -1073741637;
    if ( CurrentDisplayState < 0 )
      goto LABEL_80;
  }
  v39 = qword_1C0256CF0 ? qword_1C0256CF0() : -1073741637;
  if ( v39 >= 0
    && (!qword_1C0256CF8 ? (CurrentDisplayState = -1073741637) : (CurrentDisplayState = qword_1C0256CF8()),
        CurrentDisplayState < 0)
    || (!qword_1C0257EB0 ? (v40 = -1073741637) : (v40 = qword_1C0257EB0()),
        v40 >= 0
     && (!qword_1C0257EB8 ? (CurrentDisplayState = -1073741637) : (CurrentDisplayState = qword_1C0257EB8()),
         CurrentDisplayState < 0)) )
  {
LABEL_80:
