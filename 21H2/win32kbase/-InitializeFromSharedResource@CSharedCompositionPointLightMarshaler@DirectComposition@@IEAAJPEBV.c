/*
 * XREFs of ?InitializeFromSharedResource@CSharedCompositionPointLightMarshaler@DirectComposition@@IEAAJPEBVCSharedSystemResource@2@@Z @ 0x1C01F9A60
 * Callers:
 ...
 * Callees:
 *     ?Initialize@CCompositionPointLightMarshaler@DirectComposition@@UEAAJXZ @ 0x1C01F25F0 (-Initialize@CCompositionPointLightMarshaler@DirectComposition@@UEAAJXZ.c)
 */
