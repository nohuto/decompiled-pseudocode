/*
 * XREFs of rimObsDeliverInputToObserver @ 0x1C017E1E8
 * Callers:
...
__int64 __fastcall rimObsDeliverInputToObserver(__int64 a1, __int64 a2)
{
  ...
  if ( v43 == (HANDLE)-1LL )
  {
    ...
    {
      LOBYTE(v7) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)v7, 23, 21, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    }
    ...
    else
    {
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_((_DWORD)gBaseLog, 2, 23, 22, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
        v6 = -1073741670;
      ...
      {
        LOBYTE(v9) = 4;
        WPP_RECORDER_SF_q((_DWORD)gBaseLog, v9, 23, 23, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids, v43);
      }
      v7 = *(_QWORD **)(v2 + 136);
      if ( *v7 != v2 + 128 )
        __fastfail(3u);
  ...
  else
  {
    if ( *(_QWORD *)(a1 + 264) > 0xFFFFFFCFuLL )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        goto LABEL_67;
      LOBYTE(v7) = 3;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)v7, 23, 25, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    }
    if ( v6 < 0 )
      goto LABEL_67;
...
LABEL_42:
  if ( *(_DWORD *)(v2 + 88) == 1 )
  {
    ...
    {
      LOBYTE(v13) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v13, 23, 27, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    }
    v15 = *(void ***)(v2 + 96);
...
LABEL_53:
      ...
      LOBYTE(v16) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v16, 23, 29, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    }
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(v19) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v19, 23, 30, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    }
    goto LABEL_53;
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LOBYTE(v13) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v13, 23, 31, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
  }
  v6 = rimObsPushInputMessage(v2, v29);
  if ( v6 == -1073741756 )
    v6 = 0;
LABEL_58:
  if ( (*(_DWORD *)(a1 + 184) & 0x2000) != 0 && (*(_DWORD *)(v2 + 120) & 2) != 0 )
  {
    ...
    LOBYTE(v21) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v21, 23, v23, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
  }
LABEL_67:
  *(_QWORD *)(v2 + 184) = 0LL;
