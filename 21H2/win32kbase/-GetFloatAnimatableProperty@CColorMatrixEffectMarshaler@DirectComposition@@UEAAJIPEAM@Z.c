/*
 * XREFs of ?GetFloatAnimatableProperty@CColorMatrixEffectMarshaler@DirectComposition@@UEAAJIPEAM@Z @ 0x1C02168B0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( (unsigned int)(a2 - 3) > 0x13 )
    ...
    *a3 = *((float *)this + 4 * ((unsigned __int64)(unsigned int)(a2 - 3) >> 2) + (((_BYTE)a2 + 1) & 3) + 30);
  return v3;
}
