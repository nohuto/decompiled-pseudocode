/*
 * XREFs of ?ProcessEnterLeave@CTouchProcessor@@IEAAHPEBUCPointerInputFrame@@PEAUCPointerInfoNode@@@Z @ 0x1C0199310
 * Callers:
        ...
        struct CPointerInfoNode *a3)
{
  ...
  if ( !a2 )
  {
    ...
    if ( !CPointerInfoNode::IsForManipulationThread(a3) )
    {
      ...
      {
        LOBYTE(v10) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v10, 7, 171, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
...
LABEL_37:
    ...
    if ( CInputDest::operator==(v27, (__int64)v29) )
    {
      ...
      {
        LOBYTE(v18) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v18, 7, 175, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        {
          v12 = WPP_GLOBAL_Control;
          if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    ...
    {
      LOBYTE(v18) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v18, 7, 177, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
    }
