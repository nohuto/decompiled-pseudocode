/*
 * XREFs of ?UpdateMsgData@CTouchProcessor@@AEAAX_KKK0@Z @ 0x1C01D9DC8
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( a5 )
  {
    if ( (*(_DWORD *)(a5 + 36) & 0x40) != 0 )
    {
      if ( (a2[9] & 0x40) != 0 )
        MicrosoftTelemetryAssertTriggeredNoArgsKM(this, a2, a3);
      CTouchProcessor::ReferenceMsgData((PDEVICE_OBJECT)this, (__int64)a2, 1LL, a4);
      CTouchProcessor::UnreferenceMsgData((PDEVICE_OBJECT)this, a5, 1LL);
    }
    *(_DWORD *)(a5 + 36) |= 0x20u;
  }
}
