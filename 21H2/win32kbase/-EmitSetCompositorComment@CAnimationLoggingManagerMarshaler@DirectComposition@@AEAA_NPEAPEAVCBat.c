/*
 * XREFs of ?EmitSetCompositorComment@CAnimationLoggingManagerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C000B418
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  {
    v5 = (const unsigned __int16 *)*((_QWORD *)this + 32);
    v6 = 0LL;
    v12 = 0LL;
    if ( v5 )
    {
      ...
      || DirectComposition::CBatch::AllocateNewFragment(a2, (unsigned __int64 *)&v12) && (unsigned __int64)v12 >= v9 )
    {
      ...
      *((_DWORD *)v10 + 3) = (_DWORD)v6;
      memmove(v10 + 16, *((const void **)this + 32), 2LL * (_QWORD)v6);
      *((_BYTE *)this + 264) &= ~1u;
    }
    else
    {
