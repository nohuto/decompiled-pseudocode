/*
 * XREFs of ?ForEachActivatableQueue@CActivationObjectManager@@QEAAXA6AXPEAUtagQ@@PEAX@Z1@Z @ 0x1C0127B6C
 * Callers:
 *     MarkQueuesForKeyStateUpdate @ 0x1C01AEB90 (MarkQueuesForKeyStateUpdate.c)
 * Callees:
 ...
 *     ?MarkQueuesForKeyStateUpdateWorker@KeyboardProcessing@@YAXPEAUtagQ@@QEAX@Z @ 0x1C01AE3D8 (-MarkQueuesForKeyStateUpdateWorker@KeyboardProcessing@@YAXPEAUtagQ@@QEAX@Z.c)
 */
...
LABEL_12:
    ...
    if ( v9 )
    {
      ...
      if ( v10 )
      {
        v12 = *(KeyboardProcessing **)(*(_QWORD *)(v10 + 16) + 432LL);
        if ( v12 )
