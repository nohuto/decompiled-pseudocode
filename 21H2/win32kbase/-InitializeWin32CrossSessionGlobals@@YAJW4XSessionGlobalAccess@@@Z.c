/*
 * XREFs of ?InitializeWin32CrossSessionGlobals@@YAJW4XSessionGlobalAccess@@@Z @ 0x1C00C2F58
 * Callers:
 *     Win32kBaseDriverEntry @ 0x1C02E4310 (Win32kBaseDriverEntry.c)
 * Callees:
 *     ZwWin32CreateSectionRetainHandle @ 0x1C00D58CC (ZwWin32CreateSectionRetainHandle.c)
 */
