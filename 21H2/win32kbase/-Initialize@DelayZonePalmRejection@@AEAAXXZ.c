/*
 * XREFs of ?Initialize@DelayZonePalmRejection@@AEAAXXZ @ 0x1C006C0E0
 * Callers:
...
void __fastcall DelayZonePalmRejection::Initialize(DelayZonePalmRejection *this)
{
  ...
  *((_QWORD *)v1 + 9) = (char *)v1 + 72;
  v5 = (DelayZoneTelemetry *)*((_QWORD *)v1 + 16);
  *((_DWORD *)v1 + 22) = 1;
  if ( v5 )
  {
  ...
  else
  {
    ...
    {
      LOBYTE(v7) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 8, 23, (__int64)&WPP_926a34ac5ff436dd04abf80f696c769b_Traceguids);
    }
  }
}
