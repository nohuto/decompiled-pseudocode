/*
 * XREFs of ?EmitSetDragCommand@CParticleEmitterVisualMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C022116C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x18uLL, &v5) )
  {
    ...
    *(_QWORD *)(v3 + 12) = *(_QWORD *)((char *)this + 460);
    *((_DWORD *)v3 + 5) = *((_DWORD *)this + 117);
