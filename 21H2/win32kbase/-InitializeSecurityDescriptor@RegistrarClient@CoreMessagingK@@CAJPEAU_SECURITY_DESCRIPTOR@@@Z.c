/*
 * XREFs of ?InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z @ 0x1C00AAD00
 * Callers:
 *     ?Connect@RegistrarClient@CoreMessagingK@@CAJXZ @ 0x1C00A9ACC (-Connect@RegistrarClient@CoreMessagingK@@CAJXZ.c)
 * Callees:
 *     ?Alloc@Runtime@CoreMessagingK@@CAJ_KW4PoolTag@2@PEAPEAX@Z @ 0x1C00AADD8 (-Alloc@Runtime@CoreMessagingK@@CAJ_KW4PoolTag@2@PEAPEAX@Z.c)
 */
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    v4 = v5;
    if ( v5 < 0
      || (v7 = RtlAddAccessAllowedAce(Acl, 2u, 1u, &unk_1C0250E38), v6 = Acl, v4 = v7, v7 < 0)
