/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_04ae90407365c29ae4b2e1045aef8826___ @ 0x1C0218CB0
 * Callers:
        ...
        __int64 *a3)
{
  ...
  *((_DWORD *)v5 + 2) = *(_DWORD *)(a1 + 32);
  v6 = *a3;
  *(_OWORD *)(v5 + 12) = *(_OWORD *)(*a3 + 192);
  *(_OWORD *)(v5 + 28) = *(_OWORD *)(v6 + 208);
  v7 = *(_QWORD *)(v6 + 224);
  result = 1;
  *(_QWORD *)(v5 + 44) = v7;
  return result;
