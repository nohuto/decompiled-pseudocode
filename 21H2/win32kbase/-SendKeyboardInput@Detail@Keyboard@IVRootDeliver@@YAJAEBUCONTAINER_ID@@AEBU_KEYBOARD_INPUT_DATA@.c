/*
 * XREFs of ?SendKeyboardInput@Detail@Keyboard@IVRootDeliver@@YAJAEBUCONTAINER_ID@@AEBU_KEYBOARD_INPUT_DATA@@PEAX@Z @ 0x1C01F4640
 * Callers:
        ...
        void *a4)
{
  ...
  if ( v7 )
  {
    ...
    v6 = v21;
    v19 = *(struct _UNICODE_STRING *)(v21 + 296);
  }
