/*
 * XREFs of ApiSetEditionCancelCoolSwitch @ 0x1C00425C8
 * Callers:
...
__int64 (*__fastcall ApiSetEditionCancelCoolSwitch(_DWORD *a1))(void)
{
  char v2; // bl
  char v3; // dl
  char v4; // r8
  ...
  if ( a1 )
    *a1 = 0;
  result = qword_1C029CE28;
  if ( qword_1C029CE28 )
  {
    result = (__int64 (*)(void))qword_1C029CE28();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029CE30;
      if ( qword_1C029CE30 )
        result = (__int64 (*)(void))qword_1C029CE30(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
