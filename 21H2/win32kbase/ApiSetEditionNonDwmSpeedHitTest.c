/*
 * XREFs of ApiSetEditionNonDwmSpeedHitTest @ 0x1C00B1ED0
 * Callers:
...
_OWORD *__fastcall ApiSetEditionNonDwmSpeedHitTest(_OWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( qword_1C029D250 && (int)qword_1C029D250(v10, v8, v9, v12) >= 0 )
  {
    v13 = (_OWORD *)EditionNonDwmSpeedHitTest(v22, a2, a3, a4);
    v14 = v13[1];
    *a1 = *v13;
    v15 = v13[2];
    a1[1] = v14;
