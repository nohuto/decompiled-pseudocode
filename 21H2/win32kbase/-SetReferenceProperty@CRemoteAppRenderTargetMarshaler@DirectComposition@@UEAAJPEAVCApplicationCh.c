/*
 * XREFs of ?SetReferenceProperty@CRemoteAppRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01ECCD0
 * Callers:
 *     <none>
 * Callees:
