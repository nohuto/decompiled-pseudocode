/*
 * XREFs of ApiSetEditionDevicePnpNotification @ 0x1C0048C08
 * Callers:
...
__int64 (*__fastcall ApiSetEditionDevicePnpNotification(__int64 a1))(void)
{
  ...
  result = qword_1C029CFD0;
  if ( qword_1C029CFD0 )
  {
    result = (__int64 (*)(void))qword_1C029CFD0();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029CFD8;
      if ( qword_1C029CFD8 )
        result = (__int64 (*)(void))qword_1C029CFD8(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
