/*
 * XREFs of ApiSetEditionHandleNonUniformHMonitorDpi @ 0x1C0208140
 * Callers:
...
__int64 (*ApiSetEditionHandleNonUniformHMonitorDpi())(void)
{
  char v0; // bl
  char v1; // dl
  char v2; // r8
  ...
  result = qword_1C029D7E8;
  if ( qword_1C029D7E8 )
  {
    result = (__int64 (*)(void))qword_1C029D7E8();
    if ( (int)result >= 0 )
    {
      result = qword_1C029D7F0;
      if ( qword_1C029D7F0 )
        result = (__int64 (*)(void))qword_1C029D7F0();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
