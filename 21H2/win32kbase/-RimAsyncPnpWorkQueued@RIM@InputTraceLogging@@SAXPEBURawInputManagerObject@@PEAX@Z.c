/*
 * XREFs of ?RimAsyncPnpWorkQueued@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@PEAX@Z @ 0x1C01AA2AC
 * Callers:
...
void __fastcall InputTraceLogging::RIM::RimAsyncPnpWorkQueued(const struct RawInputManagerObject *a1, void *a2)
{
  __int64 v2; // r8
  __int64 v3; // r9
