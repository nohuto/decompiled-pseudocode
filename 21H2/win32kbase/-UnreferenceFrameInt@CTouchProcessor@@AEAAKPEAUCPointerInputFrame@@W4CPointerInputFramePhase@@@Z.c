/*
 * XREFs of ?UnreferenceFrameInt@CTouchProcessor@@AEAAKPEAUCPointerInputFrame@@W4CPointerInputFramePhase@@@Z @ 0x1C00DC990
 * Callers:
...
__int64 __fastcall CTouchProcessor::UnreferenceFrameInt(CTouchProcessor *a1, __int64 a2, __int64 a3)
{
  ...
  CTouchProcessor::FreeFrame(a1, (PVOID)a2, 0);
  return 0LL;
}
