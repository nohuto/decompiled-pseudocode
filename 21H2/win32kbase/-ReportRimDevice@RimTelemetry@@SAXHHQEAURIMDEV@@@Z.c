/*
 * XREFs of ?ReportRimDevice@RimTelemetry@@SAXHHQEAURIMDEV@@@Z @ 0x1C00AC460
 * Callers:
...
void __fastcall RimTelemetry::ReportRimDevice(int a1, int a2, struct RIMDEV *const a3)
{
  ...
  if ( v5 < 0xFF00u )
  {
    if ( a1 )
    {
      if ( (unsigned int)dword_1C024A170 > 5 && tlgKeywordOn((__int64)&dword_1C024A170, 0x800000000000LL) )
      {
        v22 = &unk_1C021A4E4;
        v47 = v35;
        v44 = 2048LL;
...
LABEL_24:
    ...
    else if ( (unsigned int)dword_1C024A170 > 5 && tlgKeywordOn((__int64)&dword_1C024A170, 0x800000000000LL) )
    {
      v22 = &unk_1C021A68C;
      v53 = v35;
      v54 = v37;
