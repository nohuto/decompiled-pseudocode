/*
 * XREFs of ?DrvChangeDisplaySettingsInternal@@YAJPEAUtagGRAPHICS_DEVICE@@PEAU_devicemodeW@@PEAUD3DKMT_GETPATHSMODALITY@@PEAXHHPEAU_MDEV@@PEAPEAU4@KHHHU_CDS_INTERNAL_FLAGS@@@Z @ 0x1C0012620
 * Callers:
...
LABEL_229:
    ...
    v38 = 0LL;
    if ( v41 >= 0 && qword_1C0256408 )
    {
      qword_1C0256408(*(_QWORD *)a7, 1LL);
      v38 = 0LL;
    }
...
LABEL_70:
          if ( a7 )
          {
            ...
            *(_QWORD *)v120 = *(_QWORD *)a7;
            ...
            if ( (int)IsGreHideSpritesSupported(v37, v19, v38, v39) >= 0 && qword_1C0256408 )
            {
              v48 = MDEV;
              if ( v32 )
                v48 = a7;
              qword_1C0256408(*(_QWORD *)v48, 0LL);
            }
            v49 = v127;
            if ( v127 )
            {
