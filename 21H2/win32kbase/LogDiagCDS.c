/*
 * XREFs of LogDiagCDS @ 0x1C0018DD4
 * Callers:
 ...
 * Callees:
 *     ?FillSimpleDevModeField@@YAXQEAU_devicemodeW@@PEAU_DXGK_DIAG_SIMPLE_DEVMODE@@@Z @ 0x1C0018FF0 (-FillSimpleDevModeField@@YAXQEAU_devicemodeW@@PEAU_DXGK_DIAG_SIMPLE_DEVMODE@@@Z.c)
        ...
        struct _devicemodeW *a14)
{
  ...
  if ( v18 )
  {
    ...
    *((_DWORD *)v19 + 12) = v20;
    ...
    ((void (__fastcall *)(char *))qword_1C02519A0)(v19);
