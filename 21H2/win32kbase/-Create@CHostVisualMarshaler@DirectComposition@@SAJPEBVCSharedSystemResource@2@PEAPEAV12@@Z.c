/*
 * XREFs of ?Create@CHostVisualMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C008FFC4
 * Callers:
 *     CreateHostVisualMarshaler @ 0x1C008FF70 (CreateHostVisualMarshaler.c)
 * Callees:
