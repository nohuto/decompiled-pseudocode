/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0093444
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C0093400 (CreateSharedReadTransformMarshaler.c)
 * Callees:
