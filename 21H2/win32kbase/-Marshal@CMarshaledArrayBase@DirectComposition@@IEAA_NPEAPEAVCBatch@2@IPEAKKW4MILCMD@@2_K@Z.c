/*
 * XREFs of ?Marshal@CMarshaledArrayBase@DirectComposition@@IEAA_NPEAPEAVCBatch@2@IPEAKKW4MILCMD@@2_K@Z @ 0x1C021B59C
 * Callers:
 ...
 *     ?EmitUpdateCommands@CParticleBaseBehaviorMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C02248D0 (-EmitUpdateCommands@CParticleBaseBehaviorMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z.c)
  ...
  if ( (*a4 & a5) != 0 )
  {
    *a4 &= ~a5;
    for ( i = a1[2] == 0LL; a1[2] != *a1 || i; i = 0 )
    {
      ...
      *((_DWORD *)v14 + 2) = a3;
      *((_DWORD *)v14 + 3) = v13 * a8;
      memmove(v14 + 16, (const void *)(a1[1] + a8 * *a1), v13 * (unsigned int)a8);
      *a1 += v13;
    }
  }
  return a1[2] == *a1;
