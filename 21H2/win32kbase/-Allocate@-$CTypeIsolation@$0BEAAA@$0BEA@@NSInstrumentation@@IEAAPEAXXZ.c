/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0BEAAA@$0BEA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1C009328C
 * Callers:
 *     ??0PATHMEMOBJ@@QEAA@XZ @ 0x1C0097060 (--0PATHMEMOBJ@@QEAA@XZ.c)
 * Callees:
 *     ?Create@?$CSectionEntry@$0BEAAA@$0BEA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C008C714 (-Create@-$CSectionEntry@$0BEAAA@$0BEA@@NSInstrumentation@@SAPEAV12@XZ.c)
 *     ?Allocate@?$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1C009333C (-Allocate@-$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@QEAAPEAXXZ.c)
...
PSLIST_ENTRY __fastcall NSInstrumentation::CTypeIsolation<81920,320>::Allocate(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v7 )
    {
      v3 = NSInstrumentation::CSectionBitmapAllocator<81920,320>::Allocate(v7[4]);
      if ( v3 )
      {
        v9 = *(_QWORD *)(a1 + 16);
        KeEnterCriticalRegion();
