/*
 * XREFs of ApiSetEditionStopSonar @ 0x1C00EA0A8
 * Callers:
...
__int64 (*ApiSetEditionStopSonar())(void)
{
  char v0; // bl
  char v1; // dl
  char v2; // r8
  ...
  result = qword_1C029D530;
  if ( qword_1C029D530 )
  {
    result = (__int64 (*)(void))qword_1C029D530();
    if ( (int)result >= 0 )
    {
      result = qword_1C029D538;
      if ( qword_1C029D538 )
        result = (__int64 (*)(void))qword_1C029D538();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
