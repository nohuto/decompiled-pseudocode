/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_8f8eaaa443f4d57e360267fa81872f2d___ @ 0x1C000DCC8
 * Callers:
        ...
        __int64 a3)
{
  ...
  *((_DWORD *)v5 + 4) = *(_DWORD *)(*(_QWORD *)a3 + 116LL);
  *((_DWORD *)v5 + 5) = *(_DWORD *)(*(_QWORD *)a3 + 120LL);
  result = 1;
  *((_DWORD *)v5 + 6) = *(_DWORD *)(*(_QWORD *)a3 + 124LL);
  return result;
}
