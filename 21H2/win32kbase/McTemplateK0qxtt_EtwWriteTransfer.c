/*
 * XREFs of McTemplateK0qxtt_EtwWriteTransfer @ 0x1C00D8644
 * Callers:
 *     EtwTraceFlipManagerPresentIFlipCompleted @ 0x1C014D800 (EtwTraceFlipManagerPresentIFlipCompleted.c)
 *     EtwTraceFlipManagerStartCompleteToken @ 0x1C014DEA0 (EtwTraceFlipManagerStartCompleteToken.c)
 * Callees:
