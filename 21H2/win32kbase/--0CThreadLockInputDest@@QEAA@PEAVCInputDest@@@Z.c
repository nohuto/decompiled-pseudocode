/*
 * XREFs of ??0CThreadLockInputDest@@QEAA@PEAVCInputDest@@@Z @ 0x1C009EBB4
 * Callers:
  ...
  *((_QWORD *)this + 1) = v5;
  if ( v5 )
  {
    ...
    *((_QWORD *)this + 3) = v5;
    ...
    if ( qword_1C0256FC0 )
      qword_1C0256FC0(this, (char *)this + 40, lambda_694d91ef54da8f8582014362157fd67b_::_lambda_invoker_cdecl_);
    v7 = *(_QWORD *)this;
