/*
 * XREFs of ?SerializeContainerMouseInput@Detail@Mouse@IVRootDeliver@@YAJAEAUCIVSerializer@@AEBU_UNICODE_STRING@@_NAEBUContainerMouseInput@@@Z @ 0x1C01BCCE4
 * Callers:
        ...
        const struct ContainerMouseInputData **a4)
{
  ...
  v13 = v8;
  LOBYTE(v9) = 2;
  WPP_RECORDER_SF_d((_DWORD)gBaseLog, v9, 12, v11, (__int64)&WPP_ce934868e6283481801d375bb45badae_Traceguids, v13);
LABEL_14:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(v9) = 5;
