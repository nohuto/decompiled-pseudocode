/*
 * XREFs of _anonymous_namespace_::lookForMatchingMinuserHwnd @ 0x1C0138C90
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall anonymous_namespace_::lookForMatchingMinuserHwnd(_QWORD *a1, __int64 a2)
{
  ...
  v4 = (unsigned int)((a2 - (__int64)qword_1C024FD58) >> 5);
  result = *(_BYTE *)(a2 + 24) == 23
        && (v5 = *((_QWORD *)gpKernelHandleTable + 3 * v4 + 1), v6 = a1[2], *(_QWORD *)(v5 + 424) == a1[1])
        && (!v6 || v5 == v6)
