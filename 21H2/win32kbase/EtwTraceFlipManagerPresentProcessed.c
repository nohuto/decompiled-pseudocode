/*
 * XREFs of EtwTraceFlipManagerPresentProcessed @ 0x1C014DA90
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall EtwTraceFlipManagerPresentProcessed(
        int a1,
        char a2,
        char a3,
        __int64 a4,
        ...
        unsigned __int64 a6)
{
  ...
  if ( (Microsoft_Windows_Win32kEnableBits & 1) != 0 )
  {
    ...
    LODWORD(v6) = McTemplateK0qxxxxxi_EtwWriteTransfer(
                    v32,
