/*
 * XREFs of ?xxxDwmProcessShutdown@@YAJH@Z @ 0x1C0074AD8
 * Callers:
 ...
 *     ?SetDwmApiPort@@YAXPEAX@Z @ 0x1C0074DE8 (-SetDwmApiPort@@YAXPEAX@Z.c)
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v69 && (*(_DWORD *)(v69 + 48) || *(int *)(v69 + 24) > 0) )
    {
      ...
      *(GUID *)(v69 + 28) = v71;
      if ( (unsigned int)dword_1C024BA90 > 6 )
      {
        ...
        if ( v43 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
        {
          LODWORD(v61) = v70;
          v89 = 4LL;
          v88 = (void **)&v61;
