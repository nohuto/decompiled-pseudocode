/*
 * XREFs of ?CopyMouseInputToHoldingBuffer@MouseRateLimitHoldingFrame@CMouseSensor@@QEAA_NPEAU_MOUSE_INPUT_DATA@@K_J@Z @ 0x1C01B2214
 * Callers:
        ...
        __int64 a4)
{
  ...
  v5 = a3;
  if ( a3 / 0x18 > 0x10 )
    MicrosoftTelemetryAssertTriggeredArgsKM((int)"IXPTelAssert", 0x20000, 300);
  v8 = *((_WORD *)this + 204);
  v9 = 0;
  if ( a2 )
  {
