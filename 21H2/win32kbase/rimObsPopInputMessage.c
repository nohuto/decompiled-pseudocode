/*
 * XREFs of rimObsPopInputMessage @ 0x1C017E9F8
 * Callers:
...
__int64 __fastcall rimObsPopInputMessage(__int64 a1, int a2, void **a3, unsigned int a4)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_q((_DWORD)gBaseLog, a2, 23, 15, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids, a1);
  }
  v8 = a1 + 144;
  if ( *(_DWORD *)(v8 + 16) == -1 )
  ...
  if ( v9 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      LOBYTE(a2) = 3;
      WPP_RECORDER_SF_d((_DWORD)gBaseLog, a2, 23, 18, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids, v16);
      v9 = *(_DWORD *)(v8 + 20);
    }
    v17 = 1LL;
    v18 = 2;
  ...
  else if ( *(_DWORD *)(v8 + 16) )
  {
    ...
    else if ( v12 >= 0 )
    {
      ...
      {
        LOBYTE(a2) = 4;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 23, 17, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
      }
      v13 = *(_QWORD *)v11;
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    LODWORD(v16) = v10;
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_d((_DWORD)gBaseLog, a2, 23, 19, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids, v16);
  }
  return v10;
}
