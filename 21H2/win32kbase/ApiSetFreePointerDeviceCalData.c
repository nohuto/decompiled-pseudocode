/*
 * XREFs of ApiSetFreePointerDeviceCalData @ 0x1C020CD80
 * Callers:
...
__int64 (*__fastcall ApiSetFreePointerDeviceCalData(__int64 a1))(void)
{
  ...
  result = qword_1C029CBF8;
  if ( qword_1C029CBF8 )
  {
    result = (__int64 (*)(void))qword_1C029CBF8();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029CC00;
      if ( qword_1C029CC00 )
        result = (__int64 (*)(void))qword_1C029CC00(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
