/*
 * XREFs of ?EmitSetReferenceInfo@CExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C000F918
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 57) < *((_DWORD *)this + 56); *((_DWORD *)this + 57) += v5 )
  {
    ...
    if ( (unsigned __int64)v4 < 0x2C )
    {
      if ( !DirectComposition::CBatch::AllocateNewFragment(a2, (unsigned __int64 *)&v13) )
        return *((_DWORD *)this + 57) == *((_DWORD *)this + 56);
      v4 = v13;
    }
    v5 = (unsigned int)(*((_DWORD *)this + 56) - *((_DWORD *)this + 57));
    ...
    *((_DWORD *)v7 + 3) = v5;
    for ( *((_DWORD *)v7 + 4) = *((_DWORD *)this + 56);
          v8 < (unsigned int)v5;
          *((_QWORD *)v9 - 1) = *(_QWORD *)(v10 + 8 * v11 + 16) )
    {
      v10 = *((_QWORD *)this + 27);
      v11 = v8 + *((_DWORD *)this + 57);
      ++v8;
      v11 *= 3LL;
      *v9 = *(_OWORD *)(v10 + 8 * v11);
