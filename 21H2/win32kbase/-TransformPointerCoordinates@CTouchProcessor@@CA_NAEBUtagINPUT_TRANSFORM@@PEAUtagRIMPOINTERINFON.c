/*
 * XREFs of ?TransformPointerCoordinates@CTouchProcessor@@CA_NAEBUtagINPUT_TRANSFORM@@PEAUtagRIMPOINTERINFONODE@@@Z @ 0x1C01D8134
 * Callers:
  ...
  *((_QWORD *)a2 + 8) = v13;
  ...
  if ( (_BYTE)v8 || WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    WPP_RECORDER_AND_TRACE_SF_dddd(
      ...
      v8,
      v9,
      (unsigned int)&WPP_d3dee7beffef3928cf2f9a2bdffe19dc_Traceguids);
  }
  return 1;
}
