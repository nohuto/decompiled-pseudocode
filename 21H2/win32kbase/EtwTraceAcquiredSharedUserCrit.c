/*
 * XREFs of EtwTraceAcquiredSharedUserCrit @ 0x1C0037E20
 * Callers:
...
__int64 EtwTraceAcquiredSharedUserCrit()
{
  ...
  if ( result )
  {
    ...
    _InterlockedIncrement64(&qword_1C0251EF0[v7 + 15]);
LABEL_9:
    _InterlockedExchangeAdd64((_QWORD *)&xmmword_1C0252058 + 1, v6);
    _InterlockedIncrement64((volatile signed __int64 *)&xmmword_1C0252078);
