/*
 * XREFs of ?FKActivationTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C0183290
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FKActivationTimer(struct tagWND *a1, __int64 a2, __int64 a3)
{
  ...
  if ( gFilterKeysState != 2 )
  {
    if ( gFilterKeysState != 3 )
    {
      ...
      {
        HIDWORD(xmmword_1C0250C04) = 0;
        Value = 0;
        DWORD1(xmmword_1C0250C04) = 2000;
        if ( (xmmword_1C0250C04 & 0x10) != 0 )
