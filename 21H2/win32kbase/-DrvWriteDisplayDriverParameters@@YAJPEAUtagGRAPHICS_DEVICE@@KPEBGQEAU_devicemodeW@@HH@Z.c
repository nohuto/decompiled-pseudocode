/*
 * XREFs of ?DrvWriteDisplayDriverParameters@@YAJPEAUtagGRAPHICS_DEVICE@@KPEBGQEAU_devicemodeW@@HH@Z @ 0x1C00757A4
 * Callers:
 *     DrvUpdateDisplayDriverParameters @ 0x1C00756BC (DrvUpdateDisplayDriverParameters.c)
 * Callees:
 *     ?DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z @ 0x1C0075C34 (-DrvWriteAttachedSettings@@YAJKPEBGQEAU_devicemodeW@@HPEAK@Z.c)
  ...
  if ( !a5 )
  {
    if ( a4 )
    {
      ...
      if ( v9 >= 0 )
      {
        while ( v15 < v17 )
        {
          v16 = RtlWriteRegistryValue(0x40000000u, a3, off_1C024AEC0[v15], 4u, &v20[v15], 4u);
          ++v15;
          v9 = v16;
          if ( v16 < 0 )
