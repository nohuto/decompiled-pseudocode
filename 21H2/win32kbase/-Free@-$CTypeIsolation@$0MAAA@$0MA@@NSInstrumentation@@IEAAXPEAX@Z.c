/*
 * XREFs of ?Free@?$CTypeIsolation@$0MAAA@$0MA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C013BAD0
 * Callers:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0MAAA@$0MA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C009254C (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0MAAA@$0MA@@NSInstrumentation@@QEAA-AW4Allocat.c)
