/*
 * XREFs of ?Create@CSharedHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F9350
 * Callers:
 *     CreateSharedHolographicInteropTextureMarshaler @ 0x1C01F94E0 (CreateSharedHolographicInteropTextureMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedHolographicInteropTextureMarshaler **a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 < 0 )
    {
      (*(void (__fastcall **)(struct DirectComposition::CSharedHolographicInteropTextureMarshaler *, __int64))(*(_QWORD *)v5 + 80LL))(
        v5,
        1LL);
      v5 = 0LL;
    }
