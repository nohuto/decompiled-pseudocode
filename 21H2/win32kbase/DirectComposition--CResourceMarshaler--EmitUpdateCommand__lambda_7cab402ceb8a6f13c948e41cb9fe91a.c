/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_7cab402ceb8a6f13c948e41cb9fe91ad___lambda_d84e1ed4b8f486922f9c1a79d2402bc2___ @ 0x1C021DF08
 * Callers:
    ...
    *((_DWORD *)v13 + 4) = 4 * v12;
    ...
    if ( (_DWORD)v12 )
    {
      ...
      do
      {
        v16 = *a3;
        *a3 = v16 + 1;
        *v14++ = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v6 + 96LL) + 4 * v16);
        --v15;
      }
      while ( v15 );
    }
