/*
 * XREFs of ?InitializeFromSharedResource@CSharedCompositionAmbientLightMarshaler@DirectComposition@@IEAAJPEBVCSharedSystemResource@2@@Z @ 0x1C00A4C20
 * Callers:
        ...
        const struct DirectComposition::CSharedSystemResource *a2)
{
  ...
  *((_BYTE *)this + 88) = 1;
  *((_OWORD *)this + 6) = xmmword_1C02188E0;
