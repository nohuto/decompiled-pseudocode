/*
 * XREFs of WPP_RECORDER_SF_qiqdd @ 0x1C0001B60
 * Callers:
...
__int64 WPP_RECORDER_SF_qiqdd(_DWORD a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x40000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_1c7a2d3f68873b8e54a3fdd9a54d5a8c_Traceguids,
      a4,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
