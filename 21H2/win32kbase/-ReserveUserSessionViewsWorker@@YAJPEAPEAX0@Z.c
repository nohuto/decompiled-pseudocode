/*
 * XREFs of ?ReserveUserSessionViewsWorker@@YAJPEAPEAX0@Z @ 0x1C01378D4
 * Callers:
...
__int64 __fastcall ReserveUserSessionViewsWorker(void **a1, void **a2, __int64 a3)
{
  ...
  if ( qword_1C0257890 )
    v5 = qword_1C0257890(1LL);
  else
    v5 = 0;
  if ( qword_1C0257890 )
    v6 = qword_1C0257890(2LL);
  else
    v6 = 0;
  if ( qword_1C0257890 )
    v7 = qword_1C0257890(0LL);
  else
    v7 = 0;
  v8 = (int)qword_1C0257890;
  if ( qword_1C0257890 )
    v8 = qword_1C0257890(3LL);
