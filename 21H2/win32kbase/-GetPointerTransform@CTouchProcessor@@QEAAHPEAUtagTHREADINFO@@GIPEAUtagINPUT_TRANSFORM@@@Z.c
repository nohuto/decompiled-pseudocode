/*
 * XREFs of ?GetPointerTransform@CTouchProcessor@@QEAAHPEAUtagTHREADINFO@@GIPEAUtagINPUT_TRANSFORM@@@Z @ 0x1C0195408
 * Callers:
...
LABEL_14:
  ...
  if ( !ValidateHbwnd((unsigned __int64)v23, v9) && !ValidateHwndEx((__int64)v11, 1, 0) )
  {
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v9, 7, 313, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
    }
    goto LABEL_25;
  }
  if ( !(unsigned int)ApiSetHasInputTransform(v11) )
  {
    ...
    {
      LOBYTE(v9) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v9, 4, 314, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
    }
    v12 = 232LL;
    goto LABEL_14;
  }
  ...
  if ( !PointerDataQPCTimeList )
  {
    if ( !v24 )
    {
      ...
      {
        LOBYTE(v15) = 2;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 7, 316, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
      }
      v18 = 232LL;
      goto LABEL_33;
    }
...
LABEL_31:
      LOBYTE(v15) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v15, 7, v20, (__int64)&WPP_4ea2b35ef3aa38c2c6a59c3c8ae69e8c_Traceguids);
      goto LABEL_32;
    }
    goto LABEL_32;
  }
