/*
 * XREFs of ?xxxUserPowerEventCalloutWorker@@YAJPEAU_WIN32_POWEREVENT_PARAMETERS@@@Z @ 0x1C0076B30
 * Callers:
 ...
 *     EtwTraceStopPowerEventCalloutWorker @ 0x1C0077398 (EtwTraceStopPowerEventCalloutWorker.c)
        ...
        switch ( v7 )
        {
          case 2:
                ...
                && (*(_DWORD *)(v124 + 48) || *(int *)(v124 + 24) > 0) )
              {
                ...
                *(GUID *)(v124 + 28) = v126;
                if ( (unsigned int)dword_1C024BA90 > 6 )
                {
                  ...
                  if ( v82 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
                  {
                    v110 = v125;
                    v142 = 4LL;
                    v141 = &v110;
            ...
            if ( (int)IsxxxSendMessageBSMSupported(v9) < 0 )
              goto LABEL_31;
            v14 = (void (__fastcall *)(_QWORD, __int64, __int64, _QWORD, int *, int))qword_1C02574F8;
            if ( !qword_1C02574F8 )
              goto LABEL_31;
            v16 = 536LL;
            v15 = 10LL;
          ...
          case 5:
            ...
            if ( HIDWORD(InputBuffer) == 17 )
              goto LABEL_31;
            v59 = (void (__fastcall *)(__int64))qword_1C0257508;
            if ( !qword_1C0257508 )
              goto LABEL_31;
            v60 = 2LL;
            goto LABEL_93;
          case 6:
            ...
            {
              v69 = qword_1C0257550 ? qword_1C0257550() : -1073741637;
              if ( v69 >= 0 && !(qword_1C0257558 ? qword_1C0257558(*(_QWORD *)(gpqForeground + 120)) : 0) )
              {
                if ( (*(_DWORD *)gpsi & 0x200) != 0 && (int)IsStartScreenSaverSupported() >= 0 && qword_1C0257568 )
                  qword_1C0257568(1LL);
                if ( qword_1C0257338 )
                {
                  LOBYTE(v5) = (*(_DWORD *)gpsi & 0x200) != 0;
                  qword_1C0257338(*(_QWORD *)(gpqForeground + 120), 274LL, 61760LL, v5);
                  v11 = 0;
                  goto LABEL_32;
                }
                goto LABEL_31;
            ...
            if ( (int)IsStartScreenSaverSupported() < 0 )
              goto LABEL_31;
            v59 = (void (__fastcall *)(__int64))qword_1C0257568;
LABEL_91:
            if ( !v59 )
              goto LABEL_31;
            v60 = 0LL;
LABEL_93:
            ...
            goto LABEL_31;
          case 7:
            if ( gfSwitchInProgress || dword_1C02521F0 || !gPowerTransitionsState )
              goto LABEL_31;
            PowerDimMonitor();
            if ( !gProtocolType )
            ...
            && (*(_DWORD *)(v127 + 48) || *(int *)(v127 + 24) > 0) )
          {
            ...
            *(GUID *)(v127 + 28) = v129;
            if ( (unsigned int)dword_1C024BA90 > 6 )
            {
              ...
              if ( v98 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
              {
                v113 = v128;
                v151 = 4LL;
                v150 = &v113;
      ...
      if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
      {
        ...
        if ( v101 && (*(int *)(v101 + 24) > 0 || *(_DWORD *)(v130 + 48)) )
        {
          ...
          if ( (unsigned int)dword_1C024BA90 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            ...
            v154 = 4LL;
            v153 = &v114;
            tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FF7, (int)&v132, 0, 3u, &v152);
          }
        }
      }
      else
        ...
        *(GUID *)(v130 + 28) = v132;
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          if ( tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            ...
            v157 = 4LL;
            v156 = &v115;
            tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FA0, (int)&v132, 0, 3u, &v155);
            v102 = dword_1C024BA90;
          }
          if ( v102 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            v116 = v131;
            v160 = 4LL;
            v159 = &v116;
            tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FCD, (int)&v132, 0, 3u, &v158);
          }
        }
      }
      EtwTraceAcquiredExclusiveUserCrit();
...
LABEL_11:
      ...
      if ( dword_1C02521F0 || gfSwitchInProgress )
        goto LABEL_23;
      HIDWORD(InputBuffer) = v6;
      LOBYTE(InputBuffer) = gProtocolType == 0;
      if ( HIDWORD(qword_1C02521FC) && !gProtocolType && (_DWORD)v6 != 22 )
      {
        if ( (_DWORD)v6 != 1 || !ShouldEscapeProximity() )
          goto LABEL_26;
        HIDWORD(qword_1C02521FC) = 0;
      }
      ...
      if ( gLastResumeResult != 259 )
      {
        if ( gLastResumeResult != -1073741823 )
        {
          ...
          if ( !gbGDIOn && (int)IsPowerOnGdiSupported() >= 0 )
          {
            ...
            if ( qword_1C0257528 )
              qword_1C0257528(v133, 0LL, 0LL);
            DisarmPowerWatchdog(gpRequestWorkerWatchdog, 48LL);
            v10 = 1;
          }
          PowerOnMonitor(SHIDWORD(InputBuffer));
          if ( v10 && qword_1C0257538 )
            qword_1C0257538(v133);
LABEL_23:
          if ( (int)IsSetTimerCoalescingToleranceSupported() >= 0 && qword_1C0257508 )
            qword_1C0257508(0LL);
        }
LABEL_26:
        ExEnterCriticalRegionAndAcquireFastMutexUnsafe(gpPowerRequestMutex);
...
LABEL_310:
  ...
  if ( gfSwitchInProgress || dword_1C02521F0 )
    goto LABEL_31;
  if ( v6 == 1 )
  {
    gbBuiltinPanelOn = 1;
