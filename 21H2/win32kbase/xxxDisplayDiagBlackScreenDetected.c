/*
 * XREFs of xxxDisplayDiagBlackScreenDetected @ 0x1C011E9D0
 * Callers:
...
void __fastcall xxxDisplayDiagBlackScreenDetected(int a1, char a2, char a3, UUID *a4, int *a5)
{
        ...
        && (*(_DWORD *)(v161 + 48) || *(int *)(v161 + 24) > 0) )
      {
        ...
        *(GUID *)(v161 + 28) = v163;
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          ...
          if ( v20 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            v137 = v162;
            v181 = 4LL;
            v180 = &v137;
  ...
  if ( (unsigned int)UserIsWddmConnectedSession() )
  {
    ...
    if ( a2 )
    {
      ...
      xmmword_1C0259688 = *(_OWORD *)&v174[1];
        ...
        && (*(_DWORD *)(v164 + 48) || *(int *)(v164 + 24) > 0) )
      {
        ...
        *(GUID *)(v164 + 28) = v166;
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          ...
          if ( v51 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            v140 = v165;
            v190 = 4LL;
            v189 = &v140;
      ...
      && (*(_DWORD *)(v167 + 48) || *(int *)(v167 + 24) > 0) )
    {
      ...
      *(GUID *)(v167 + 28) = v169;
      if ( (unsigned int)dword_1C024BA90 > 6 )
      {
        ...
        if ( v78 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
        {
          v143 = v168;
          v199 = 4LL;
          v198 = &v143;
    ...
    *(_OWORD *)&v174[1] = xmmword_1C0259688;
    if ( v66 < 0
...
LABEL_244:
        ...
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          if ( tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              3u,
              &v203);
            v109 = dword_1C024BA90;
          }
          if ( v109 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            v146 = v171;
            v208 = 4LL;
            v207 = &v146;
  ...
  if ( !gProtocolType
    ...
    && tlgKeywordOn((__int64)&dword_1C0246378, 0x400000000008LL) )
  {
    v149 = HIDWORD(v154);
    v150 = DWORD2(v154);
    v151 = v155;
