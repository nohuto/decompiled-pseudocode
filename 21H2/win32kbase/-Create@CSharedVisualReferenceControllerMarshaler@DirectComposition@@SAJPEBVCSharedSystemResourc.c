/*
 * XREFs of ?Create@CSharedVisualReferenceControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F83B4
 * Callers:
 *     CreateSharedVisualReferenceControllerMarshaler @ 0x1C01F8590 (CreateSharedVisualReferenceControllerMarshaler.c)
 * Callees:
