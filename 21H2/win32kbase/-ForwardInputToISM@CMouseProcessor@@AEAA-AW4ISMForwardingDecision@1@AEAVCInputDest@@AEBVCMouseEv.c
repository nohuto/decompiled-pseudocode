/*
 * XREFs of ?ForwardInputToISM@CMouseProcessor@@AEAA?AW4ISMForwardingDecision@1@AEAVCInputDest@@AEBVCMouseEvent@1@AEBUInputDeliveryContext@1@AEBUtagPOINT@@II_K@Z @ 0x1C004BD08
 * Callers:
...
LABEL_40:
  ...
  else
  {
    ...
    {
      LOBYTE(v34) = 2;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v34, 6, 52, (__int64)&WPP_bc237edca6b43ca924b1688b2fc88a86_Traceguids);
    }
