/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0NOAAA@$0NOA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C00D9FD8
 * Callers:
 ...
 * Callees:
 *     ??R_lambda_3bbc91c13723ea673db256ec91dfd56c_@@QEBAPEAU_RTL_BITMAP@@I@Z @ 0x1C00D98F0 (--R_lambda_3bbc91c13723ea673db256ec91dfd56c_@@QEBAPEAU_RTL_BITMAP@@I@Z.c)
 */
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<909312,3552>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = Pool2;
  if ( !Pool2 )
    return 0;
  *Pool2 = 0LL;
  v10 = _lambda_3bbc91c13723ea673db256ec91dfd56c_::operator()(v9, 0xDEu);
  if ( !v10 )
    return 0;
