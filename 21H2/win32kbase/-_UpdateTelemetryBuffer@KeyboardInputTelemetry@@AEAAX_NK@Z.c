/*
 * XREFs of ?_UpdateTelemetryBuffer@KeyboardInputTelemetry@@AEAAX_NK@Z @ 0x1C0001DD8
 * Callers:
...
LABEL_7:
  if ( v6 > 0xC8 && (unsigned int)dword_1C024A250 > 5 )
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C024A250, 0x400000000000LL, a3, a4) )
