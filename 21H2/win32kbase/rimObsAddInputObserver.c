/*
 * XREFs of rimObsAddInputObserver @ 0x1C017D8AC
 * Callers:
 *     NtRIMAddInputObserver @ 0x1C0152FB0 (NtRIMAddInputObserver.c)
 *     RIMAddInputObserver @ 0x1C0154D30 (RIMAddInputObserver.c)
 * Callees:
        ...
        HANDLE *a9)
{
  ...
  if ( v30 < 0x30 )
  {
    ...
    {
      LOBYTE(a2) = 3;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 23, 60, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    }
    return 3221225507LL;
  }
  if ( !a1 )
...
LABEL_26:
      LOBYTE(a2) = 3;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, a2, 23, v13, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
      return 3221225485LL;
    }
    return 3221225485LL;
  }
  if ( a5 > 2 )
  {
    ...
    {
      LOBYTE(a2) = 3;
      WPP_RECORDER_SF_d((_DWORD)gBaseLog, a2, 23, 62, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids, a5);
    }
    return 3221225485LL;
  }
  if ( a5 == 2 )
      ...
      if ( v14 >= 0 )
      {
        ...
        *((_DWORD *)v19 + 30) = a8;
        ...
        if ( v14 < 0 )
        {
          ...
          {
            LOBYTE(v20) = 3;
            WPP_RECORDER_SF_((_DWORD)gBaseLog, v20, 23, 67, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
          }
        }
        else
        {
...
LABEL_47:
        if ( v14 < 0 )
        {
          if ( Handle != (HANDLE)-1LL )
          {
            ...
            {
              LOBYTE(v18) = 3;
              WPP_RECORDER_SF_((_DWORD)gBaseLog, v18, 23, 71, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
            }
    ...
    LOBYTE(v18) = 3;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v18, 23, v23, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids);
    goto LABEL_47;
  }
  v14 = -1073741823;
LABEL_57:
  ...
  {
    LOBYTE(v25) = 4;
    WPP_RECORDER_SF_d((_DWORD)gBaseLog, v25, 23, 72, (__int64)&WPP_6fc7381aee0e372bb3b376f4de323b29_Traceguids, v14);
  }
