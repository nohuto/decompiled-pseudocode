/*
 * XREFs of NtUserInjectPointerInput @ 0x1C0131BF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_54:
        LOBYTE(v8) = 2;
        WPP_RECORDER_SF_((_DWORD)gBaseLog, v8, 21, v10, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids);
        goto LABEL_55;
      }
      goto LABEL_55;
    }
    ...
    if ( v11 < 0 )
    {
      ...
      {
        LOBYTE(v12) = 2;
        WPP_RECORDER_SF_d((_DWORD)gBaseLog, v12, 21, 39, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids, v11);
      }
      v6 = 0;
...
LABEL_44:
      ...
      {
        LOBYTE(v24) = 2;
        WPP_RECORDER_SF_d((_DWORD)gBaseLog, v24, 21, 49, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids, v23);
      }
      v6 = 0;
...
LABEL_33:
    LOBYTE(v17) = 2;
    WPP_RECORDER_SF_d((_DWORD)gBaseLog, v17, 21, v20, (__int64)&WPP_72969ae93fdf3d9d80b76793b3525300_Traceguids, v29);
    goto LABEL_34;
  }
  v9 = 5LL;
LABEL_56:
