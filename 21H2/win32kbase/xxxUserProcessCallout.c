/*
 * XREFs of xxxUserProcessCallout @ 0x1C003BE30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxUserProcessCallout(__int64 a1, PEPROCESS *a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      LOBYTE(a2) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 14, 30, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
    }
    v6 = *(_DWORD *)(a1 + 12);
    inited = 1073741851;
    v88 = 1073741851;
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v66 && (*(int *)(v66 + 24) > 0 || *(_DWORD *)(v101 + 48)) )
      {
        ...
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v67, v68) )
          {
            v87 = v102;
            v109 = 4LL;
            v108 = &v87;
      ...
      && (*(_DWORD *)(v101 + 48) || *(int *)(v101 + 24) > 0) )
    {
      ...
      *(GUID *)(v101 + 28) = ActivityId;
      if ( (unsigned int)dword_1C024BA90 > 6 )
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, (unsigned int)dword_1C024BA90, 0LL) )
        {
          v85 = v102;
          v112 = 4LL;
          v111 = &v85;
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            3u,
            &v110);
          v69 = (unsigned int)dword_1C024BA90;
        }
        if ( (unsigned int)v69 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v69, v70) )
        {
          v91 = v102;
          v115 = 4LL;
          v114 = &v91;
  ...
  else
  {
    ...
    {
      LOBYTE(a2) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 14, 31, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
    }
    ...
    if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
    {
      ...
      if ( v75 && (*(int *)(v75 + 24) > 0 || *(_DWORD *)(v104 + 48)) )
      {
        ...
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v76, v77) )
          {
            v93 = v105;
            v118 = 4LL;
            v117 = &v93;
            tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FF7, (int)&v106, 0, 3u, &v116);
          }
        }
      }
    }
      ...
      *(GUID *)(v104 + 28) = v106;
      if ( (unsigned int)dword_1C024BA90 > 6 )
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, (unsigned int)dword_1C024BA90, 0LL) )
        {
          ...
          v121 = 4LL;
          v120 = &v94;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FA0, (int)&v106, v79, 3u, &v119);
          v78 = (unsigned int)dword_1C024BA90;
        }
        if ( (unsigned int)v78 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v78, v79) )
        {
          LODWORD(v95) = v105;
          v124 = 4LL;
          v123 = (void **)&v95;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FCD, (int)&v106, 0, 3u, &v122);
        }
      }
    }
    EtwTraceAcquiredExclusiveUserCrit();
    ...
    {
      v45 = qword_1C0257A58 ? qword_1C0257A58() : -1073741637;
      if ( v45 >= 0 && qword_1C0257A60 )
        qword_1C0257A60(v36);
    }
    if ( (unsigned int)DestroyProcessInfo(v36) )
    {
      v47 = giheLast;
      for ( i = (char *)qword_1C024FD58 + 32 * (unsigned int)giheLast; i > (char *)qword_1C024FD58 && !i[24]; i -= 32 )
        giheLast = --v47;
      GreLockVisRgn(*(_QWORD *)(gpDispInfo + 40), (int)qword_1C024FD58, v46);
  ...
  {
    LOBYTE(v24) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v24, 14, 32, (__int64)&WPP_658ee5f6f19939820aaea989098c75e5_Traceguids);
  }
