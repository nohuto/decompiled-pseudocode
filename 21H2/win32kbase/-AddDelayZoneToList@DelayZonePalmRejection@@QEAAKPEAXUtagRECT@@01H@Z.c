/*
 * XREFs of ?AddDelayZoneToList@DelayZonePalmRejection@@QEAAKPEAXUtagRECT@@01H@Z @ 0x1C01AC6D8
 * Callers:
...
LABEL_9:
    ...
    {
      LOBYTE(v15) = 2;
      WPP_RECORDER_SF_d((_DWORD)gBaseLog, v15, 8, 25, (__int64)&WPP_926a34ac5ff436dd04abf80f696c769b_Traceguids, v14);
    }
    goto LABEL_26;
  }
  if ( v11 )
