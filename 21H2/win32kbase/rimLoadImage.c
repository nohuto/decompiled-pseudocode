/*
 * XREFs of rimLoadImage @ 0x1C006C9A0
 * Callers:
...
struct _SYSTEM_GDI_DRIVER_INFORMATION *rimLoadImage()
{
  ...
  xmmword_1C0251CD8 = 0LL;
  xmmword_1C0251CE8 = 0LL;
      ...
      if ( v7 != -1073741820 )
      {
        if ( v7 >= 0 )
        {
          ...
          if ( *v6 )
          {
            ...
            AnsiString_4 = 0;
            v10 = *(char **)&v6[74 * v8 + 6];
            *((_QWORD *)&xmmword_1C0251CE8 + 1) = RtlImageDirectoryEntryToData(
                                                    *(PVOID *)&v6[74 * v9 + 6],
                                                    1u,
                                                    0,
                                                    &AnsiString_4);
            AddressOfEntryPoint = RtlImageNtHeader(v10)->OptionalHeader.AddressOfEntryPoint;
            *((_QWORD *)&xmmword_1C0251CD8 + 1) = 0LL;
            *(_QWORD *)&xmmword_1C0251CE8 = &v10[AddressOfEntryPoint];
            v1 = 1;
            *(_QWORD *)&xmmword_1C0251CD8 = v10;
          }
        }
LABEL_15:
