/*
 * XREFs of ?OnDispatcherObjectSignaled@CBaseInput@@AEAAJPEAX@Z @ 0x1C0044528
 * Callers:
 *     ?_OnDispatcherObjectSignaled@CBaseInput@@CAJPEAX0@Z @ 0x1C0044980 (-_OnDispatcherObjectSignaled@CBaseInput@@CAJPEAX0@Z.c)
 * Callees:
 ...
 *     ?DispatcherHandleNameToString@InputTraceLogging@@CAPEBDW4DispatcherHandleName@CRIMBase@@@Z @ 0x1C01A39AC (-DispatcherHandleNameToString@InputTraceLogging@@CAPEBDW4DispatcherHandleName@CRIMBase@@@Z.c)
 */
...
LABEL_9:
  ...
  else
  {
    ...
    if ( (unsigned int)dword_1C024BA90 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 2LL, v10, v11) )
    {
    ...
    if ( *((_BYTE *)&unk_1C020A6A0 + 24 * v36 + 16) )
    {
      ...
      if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
      {
        ...
        if ( v37 && (*(int *)(v37 + 24) > 0 || *(_DWORD *)(v50 + 48)) )
        {
          ...
          {
            if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v38, v39) )
            {
              v45 = ActivityId_4;
              v55 = 4LL;
              v54 = &v45;
      ...
      if ( InputTraceLogging::Perf::s_userCritLoggingEnabled && v50 && (*(_DWORD *)(v50 + 48) || *(int *)(v50 + 24) > 0) )
      {
        ...
        *(GUID *)(v50 + 28) = ActivityId_8;
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, (unsigned int)dword_1C024BA90, v21) )
          {
            v44 = ActivityId_4;
            v58 = 4LL;
            v57 = &v44;
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              3u,
              &v56);
            v40 = (unsigned int)dword_1C024BA90;
          }
          if ( (unsigned int)v40 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v40, v41) )
          {
      ...
      v31 = (*((__int64 (__fastcall **)(CBaseInput *))&unk_1C020A6A0 + 3 * v36 + 1))(v4);
