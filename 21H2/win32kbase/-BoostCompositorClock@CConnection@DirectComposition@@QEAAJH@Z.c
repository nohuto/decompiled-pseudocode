/*
 * XREFs of ?BoostCompositorClock@CConnection@DirectComposition@@QEAAJH@Z @ 0x1C0212800
 * Callers:
...
__int64 __fastcall DirectComposition::CConnection::BoostCompositorClock(DirectComposition::CConnection *this, int a2)
{
  ...
  if ( DirectComposition::CConnection::IsConnected(this) )
  {
    ...
    v9 = DirectComposition::CSystemChannel::BoostCompositorClock(*((DirectComposition::CSystemChannel **)this + 19), a2);
    v10 = *((_QWORD *)this + 19);
    v5 = v9;
