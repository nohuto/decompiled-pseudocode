/*
 * XREFs of ?Create@CBackTraceStorageUnit@NSInstrumentation@@SAPEAV12@_KQEBVCBackTrace@2@PEAV12@@Z @ 0x1C017B510
 * Callers:
        ...
        struct NSInstrumentation::CBackTraceStorageUnit *a3)
{
  ...
  result = (struct NSInstrumentation::CBackTraceStorageUnit *)ExAllocatePool2(262LL, 184LL);
  if ( result )
  {
    v7 = *(_OWORD *)a2;
    *((_QWORD *)result + 1) = a1;
