/*
 * XREFs of ?SerializeFullKeyboardStatesForContainer@Detail@Keyboard@IVRootDeliver@@YAJAEAUCIVSerializer@@@Z @ 0x1C01BCE3C
 * Callers:
...
LABEL_13:
    v8 = v3;
    LOBYTE(v4) = 2;
    WPP_RECORDER_SF_d((_DWORD)gBaseLog, v4, 12, v6, (__int64)&WPP_ce934868e6283481801d375bb45badae_Traceguids, v8);
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_(
      WPP_GLOBAL_Control->DeviceExtension,
