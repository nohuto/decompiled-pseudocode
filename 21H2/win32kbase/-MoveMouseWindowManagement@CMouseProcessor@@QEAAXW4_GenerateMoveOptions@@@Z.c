/*
 * XREFs of ?MoveMouseWindowManagement@CMouseProcessor@@QEAAXW4_GenerateMoveOptions@@@Z @ 0x1C0042B14
 * Callers:
...
void __fastcall CMouseProcessor::MoveMouseWindowManagement(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C024BA90 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 64LL, a3, a4) )
  {
    v11 = v8;
    LODWORD(v12) = a2;
    _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
      (unsigned int)&dword_1C024BA90,
      (unsigned int)&unk_1C0220EBE,
      v9,
      v10,
      (__int64)&v12,
      (__int64)&v11);
