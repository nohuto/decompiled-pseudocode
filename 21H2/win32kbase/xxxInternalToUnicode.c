/*
 * XREFs of xxxInternalToUnicode @ 0x1C0009CF0
 * Callers:
 *     xxxToUnicodeEx @ 0x1C0009BE0 (xxxToUnicodeEx.c)
 * Callees:
 *     InternalVkKeyScanEx @ 0x1C0009840 (InternalVkKeyScanEx.c)
        ...
        __int64 a8)
{
  ...
  *a7 = v14;
  if ( (_BYTE)a1 == 0xFF )
    return 0LL;
  if ( a8 || (v17 = *(_QWORD *)(ThreadWin32Thread + 440), (v59 = (struct tagKL *)v17) == 0LL) )
  {
  ...
  if ( v14 )
  {
    if ( a1 != 18 )
    {
      if ( a1 == (unsigned __int16)word_1C02520B4 )
        word_1C02520B4 = 0;
      goto LABEL_9;
    }
    if ( !word_1C02520B0 )
...
LABEL_76:
    ...
    {
      if ( (word_1C02520B0 & 0xFF00) != 0 )
      {
        v19 = _byteswap_ushort(word_1C02520B0);
        word_1C02520B0 = v19;
      }
      else if ( ((_WORD)v37 != 932 || (unsigned __int16)(word_1C02520B0 - 161) > 0x3Eu)
             && (unsigned __int16)(word_1C02520B0 - 128) <= 0x7Fu )
      {
        v37 = 1252LL;
      }
    }
...
LABEL_57:
      if ( v36 < 0 )
        goto LABEL_58;
      if ( (unsigned __int16)word_1C02520B4 == a1 )
        return 0LL;
      if ( (unsigned __int8)(byte_1C02520B2 - 2) > 1u )
      {
        word_1C02520B0 = v36 + 10 * v19;
        if ( !word_1C02520B0 )
        {
          v43 = byte_1C02520B2;
          if ( !v36 )
...
LABEL_82:
    ...
    LOBYTE(v23) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)v23, 16, v40, (__int64)&WPP_452ce174e4dd36ee8a008521dfdf54c5_Traceguids);
    goto LABEL_82;
  }
LABEL_12:
