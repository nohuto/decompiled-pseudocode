/*
 * XREFs of ?Initialize@CMaterialPropertiesTable@DirectComposition@@SAJXZ @ 0x1C00AD368
 * Callers:
 *     DCompositionSessionInitialize @ 0x1C00AD340 (DCompositionSessionInitialize.c)
 * Callees:
