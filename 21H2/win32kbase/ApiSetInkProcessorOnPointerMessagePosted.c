/*
 * XREFs of ApiSetInkProcessorOnPointerMessagePosted @ 0x1C020DFB4
 * Callers:
...
__int64 (__fastcall *__fastcall ApiSetInkProcessorOnPointerMessagePosted(
        unsigned int a1,
        __int64 a2,
        __int64 a3))(_QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029CCF8;
  if ( qword_1C029CCF8 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029CCF8(v5, a2, a3, v7);
    if ( (int)result >= 0 )
    {
      result = qword_1C029CD00;
      if ( qword_1C029CD00 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029CD00(a1, v3);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
