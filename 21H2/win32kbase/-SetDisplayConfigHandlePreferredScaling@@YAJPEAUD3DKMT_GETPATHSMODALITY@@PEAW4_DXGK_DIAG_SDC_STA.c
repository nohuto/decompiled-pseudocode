/*
 * XREFs of ?SetDisplayConfigHandlePreferredScaling@@YAJPEAUD3DKMT_GETPATHSMODALITY@@PEAW4_DXGK_DIAG_SDC_STAGE@@@Z @ 0x1C014615C
 * Callers:
        ...
        enum _DXGK_DIAG_SDC_STAGE *a2)
{
  ...
  if ( v12 )
  {
    if ( (int)((__int64 (__fastcall *)(struct D3DKMT_GETPATHSMODALITY *, struct D3DKMT_GETPATHSMODALITY *))qword_1C0251AC8)(
                v12,
                a1) < 0 )
    {
    ...
    if ( (int)((__int64 (__fastcall *)(__int64, struct D3DKMT_GETPATHSMODALITY *))qword_1C0251900)(47LL, v12) < 0 )
    {
