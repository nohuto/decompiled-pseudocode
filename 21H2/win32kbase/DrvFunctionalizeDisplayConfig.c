/*
 * XREFs of DrvFunctionalizeDisplayConfig @ 0x1C0147434
 * Callers:
        ...
        int a6)
{
  ...
  v14 = *a1;
  v25[0] = (struct D3DKMT_GETPATHSMODALITY *)&off_1C020B590;
  *(_OWORD *)v26 = 0LL;
  if ( (v6 & 1) != 0 )
  {
...
LABEL_21:
  ...
  if ( PathModalityForDisplayConfig >= 0 )
  {
    if ( a4 )
    {
      PathModalityForDisplayConfig = ((__int64 (__fastcall *)(__int64, __int64, struct D3DKMT_GETPATHSMODALITY **))qword_1C0251B68)(
                                       a4,
                                       0x20000LL,
                                       &v26[1]);
      if ( PathModalityForDisplayConfig < 0 )
    ...
    if ( (v6 & 1) != 0 )
    {
      ...
      v24 = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *, _QWORD, char *, char *))qword_1C0251B58)(
              v20,
              v22,
              v21,
              (char *)v8 - 176,
    ...
    {
      PathModalityForDisplayConfig = ((__int64 (__fastcall *)(_QWORD, struct D3DKMT_GETPATHSMODALITY *))qword_1C0251908)(
                                       v20 | 0x8000,
                                       v26[0]);
      if ( PathModalityForDisplayConfig < 0 )
        goto LABEL_35;
      ...
      v24 = ((__int64 (__fastcall *)(struct D3DKMT_GETPATHSMODALITY *, unsigned int *, struct DISPLAYCONFIG_PATH_INFO_INTERNAL *, __int64))qword_1C0251B38)(
              v26[0],
              a1,
              v8,
              a5);
