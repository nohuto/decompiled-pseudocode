/*
 * XREFs of ApiSetEditionPostAccessibilitySettingChangedEvent @ 0x1C020A3A8
 * Callers:
 *     ?FKActivationTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01B9070 (-FKActivationTimer@@YAXPEAUtagWND@@I_K_J@Z.c)
 *     ?MKButtonSelect@@YAHG@Z @ 0x1C01B9540 (-MKButtonSelect@@YAHG@Z.c)
...
__int64 (*__fastcall ApiSetEditionPostAccessibilitySettingChangedEvent(unsigned int a1))(void)
{
  ...
  result = qword_1C029CDC8;
  if ( qword_1C029CDC8 )
  {
    result = (__int64 (*)(void))qword_1C029CDC8();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029CDD0;
      if ( qword_1C029CDD0 )
        result = (__int64 (*)(void))qword_1C029CDD0(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
