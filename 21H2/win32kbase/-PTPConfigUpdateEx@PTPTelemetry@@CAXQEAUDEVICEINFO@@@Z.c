/*
 * XREFs of ?PTPConfigUpdateEx@PTPTelemetry@@CAXQEAUDEVICEINFO@@@Z @ 0x1C01A6B68
 * Callers:
...
void __fastcall PTPTelemetry::PTPConfigUpdateEx(struct DEVICEINFO *const a1)
{
  ...
  *(_QWORD *)&v12.Length = 0x100000LL;
  ...
  v15 = 0LL;
  v16[5] = -__CFSHR__(*(&qword_1C024FFD0 + 1), 3);
  v16[6] = -__CFSHR__(*(&qword_1C024FFD0 + 1), 5);
  v16[7] = qword_1C024FFD0;
  if ( a1 )
  {
    v8 = *((_QWORD *)a1 + 60);
    v5 = 0;
