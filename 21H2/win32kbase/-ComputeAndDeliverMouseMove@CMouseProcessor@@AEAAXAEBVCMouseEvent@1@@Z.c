/*
 * XREFs of ?ComputeAndDeliverMouseMove@CMouseProcessor@@AEAAXAEBVCMouseEvent@1@@Z @ 0x1C0041D10
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CMouseProcessor::CMouseEvent *a2)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, (_DWORD)a2, 6, 43, (__int64)&WPP_bc237edca6b43ca924b1688b2fc88a86_Traceguids);
  }
  v4[1] = *((_QWORD *)v2 + 1);
  v5 = 1;
