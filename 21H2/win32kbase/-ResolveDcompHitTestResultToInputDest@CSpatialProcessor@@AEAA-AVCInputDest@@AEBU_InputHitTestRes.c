/*
 * XREFs of ?ResolveDcompHitTestResultToInputDest@CSpatialProcessor@@AEAA?AVCInputDest@@AEBU_InputHitTestResult@@K_K@Z @ 0x1C00441A4
 * Callers:
...
LABEL_20:
  ...
  v15 = 0LL;
  if ( qword_1C02582B0 )
    v16 = qword_1C02582B0(*(_QWORD *)&v19[5]);
  else
    v16 = 0;
  if ( v16 )
  {
