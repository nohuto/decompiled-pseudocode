/*
 * XREFs of ??$AssociateAllocationWithBacktrace@$00@CLeakTrackingAllocator@NSInstrumentation@@AEAA_NPEAXPEAVCBackTrace@1@@Z @ 0x1C0179D2C
 * Callers:
        ...
        struct NSInstrumentation::CBackTrace *a3)
{
  ...
  {
    v8 = NSInstrumentation::CBackTraceStoreEx::AcquireBackTrace(v5, a3, 0LL);
    if ( v8 )
    {
