 ...
 * Callees:
 *     RtlUpcaseUnicodeToMultiByteN_0 @ 0x1C00C6DE6 (RtlUpcaseUnicodeToMultiByteN_0.c)
 *     RtlAnsiCharToUnicodeChar_0 @ 0x1C00C6DF8 (RtlAnsiCharToUnicodeChar_0.c)
 */
