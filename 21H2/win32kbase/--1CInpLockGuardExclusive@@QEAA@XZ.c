/*
 * XREFs of ??1CInpLockGuardExclusive@@QEAA@XZ @ 0x1C0088D40
 * Callers:
...
void __fastcall CInpLockGuardExclusive::~CInpLockGuardExclusive(CInpLockGuard **this, __int64 a2, __int64 a3)
{
  struct _KTHREAD *CurrentThread; // rdx

  CurrentThread = KeGetCurrentThread();
  if ( *((struct _KTHREAD **)this[5] + 1) != CurrentThread )
    MicrosoftTelemetryAssertTriggeredNoArgsKM(this, CurrentThread, a3);
