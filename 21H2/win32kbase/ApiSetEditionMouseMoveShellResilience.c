/*
 * XREFs of ApiSetEditionMouseMoveShellResilience @ 0x1C0033EEC
 * Callers:
...
__int64 (*__fastcall ApiSetEditionMouseMoveShellResilience(__int64 a1))(void)
{
  ...
  result = qword_1C029CF50;
  if ( qword_1C029CF50 )
  {
    result = (__int64 (*)(void))qword_1C029CF50();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C029CF58;
      if ( qword_1C029CF58 )
        result = (__int64 (*)(void))qword_1C029CF58(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
