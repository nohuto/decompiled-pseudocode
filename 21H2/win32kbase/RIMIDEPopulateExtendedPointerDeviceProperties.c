/*
 * XREFs of RIMIDEPopulateExtendedPointerDeviceProperties @ 0x1C016BDDC
 * Callers:
...
__int64 __fastcall RIMIDEPopulateExtendedPointerDeviceProperties(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(a2 + 24) == 7 )
  {
    ...
    *(_QWORD *)(a2 + 300) = 0LL;
    *(_DWORD *)(a2 + 308) = 0;
    *(_DWORD *)(a2 + 304) = dword_1C024A9F4;
    result = (unsigned int)dword_1C024AA04;
    *(_DWORD *)(a2 + 308) = dword_1C024AA04;
  }
  return result;
}
