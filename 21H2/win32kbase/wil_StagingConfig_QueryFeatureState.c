/*
 * XREFs of wil_StagingConfig_QueryFeatureState @ 0x1C0280248
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C01143AC (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00C5070 (__security_check_cookie.c)
 *     memset @ 0x1C00CF780 (memset.c)
 *     wil_details_StagingConfig_Load @ 0x1C0114548 (wil_details_StagingConfig_Load.c)
 *     wil_details_StagingConfig_QueryFeatureState @ 0x1C0114844 (wil_details_StagingConfig_QueryFeatureState.c)
 */
