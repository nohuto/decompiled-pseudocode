/*
 * XREFs of ?RemoveMapping@InputObjectMap@@SAJAEBU_LUID@@W4RemoveRestriction@1@@Z @ 0x1C01FB870
 * Callers:
...
LABEL_12:
  ...
  v10 = *((_QWORD *)Entry + 1) & (-1LL << (dword_1C0255524 & 0x1F));
  for ( i = (struct InputObjectMapEntry *)((char *)Buffer
                                         ...
                                         * ((37
                                           * (BYTE6(v10)
                                           ...
                                           + HIBYTE(v10)) & (((unsigned int)dword_1C0255524 >> 5) - 1)));
        (*(_QWORD *)i & 1) == 0;
