/*
 * XREFs of xxxRemoteConnect @ 0x1C01177E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SetConsoleSwitchInProgress @ 0x1C00B32A0 (SetConsoleSwitchInProgress.c)
...
__int64 __fastcall xxxRemoteConnect(__int64 a1, __int64 a2, unsigned __int16 *a3, __int64 a4)
{
  ...
  {
    if ( qword_1C0256D90 )
      result = qword_1C0256D90();
    else
      result = 3221225659LL;
    if ( (int)result >= 0 )
    {
      if ( qword_1C0256D98 )
        return qword_1C0256D98(a1, a3, a4);
      else
        return 3221225659LL;
    }
    return result;
  ...
  *(_OWORD *)&gRemoteDisplayDeviceName = *(_OWORD *)(a1 + 162);
  xmmword_1C0250118 = *(_OWORD *)(a1 + 178);
  qword_1C0250128 = *(_QWORD *)(a1 + 194);
  gWinStationInfo = *(_OWORD *)(a1 + 202);
  word_1C0250190 = *(_WORD *)(a1 + 218);
  xmmword_1C0250194 = *(_OWORD *)(a1 + 220);
  dword_1C02501A4 = *(_DWORD *)(a1 + 236);
  memset(&gstrBaseWinStationName, 0, 0x40uLL);
  *(_OWORD *)&gstrBaseWinStationName = *(_OWORD *)(a1 + 80);
  xmmword_1C0250060 = *(_OWORD *)(a1 + 96);
  xmmword_1C0250070 = *(_OWORD *)(a1 + 112);
  xmmword_1C0250080 = *(_OWORD *)(a1 + 128);
  v11 = wcschr(&gstrBaseWinStationName, 0x23u);
  if ( v11 )
    *v11 = 0;
  v12 = gbRemoteFxSession;
  gbRemoteFxSession = *(_DWORD *)(a1 + 292);
  dword_1C02522A0 = *(_DWORD *)(a1 + 292);
  if ( *(_DWORD *)(a1 + 292) )
    qword_1C02522A4 = *(_QWORD *)(a1 + 296);
