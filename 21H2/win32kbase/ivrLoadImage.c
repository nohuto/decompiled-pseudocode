/*
 * XREFs of ivrLoadImage @ 0x1C01BA9D8
 * Callers:
...
struct _SYSTEM_GDI_DRIVER_INFORMATION *ivrLoadImage()
{
  ...
  xmmword_1C0259618 = 0LL;
  xmmword_1C0259628 = 0LL;
      ...
      if ( v7 != -1073741820 )
      {
        if ( v7 >= 0 )
        {
          ...
          if ( *v6 )
          {
            ...
            AnsiString_4 = 0;
            v10 = *(char **)&v6[74 * v8 + 6];
            *((_QWORD *)&xmmword_1C0259628 + 1) = RtlImageDirectoryEntryToData(
                                                    *(PVOID *)&v6[74 * v9 + 6],
                                                    1u,
                                                    0,
                                                    &AnsiString_4);
            AddressOfEntryPoint = RtlImageNtHeader(v10)->OptionalHeader.AddressOfEntryPoint;
            *((_QWORD *)&xmmword_1C0259618 + 1) = 0LL;
            *(_QWORD *)&xmmword_1C0259628 = &v10[AddressOfEntryPoint];
            v1 = 1;
            *(_QWORD *)&xmmword_1C0259618 = v10;
          }
        }
LABEL_18:
