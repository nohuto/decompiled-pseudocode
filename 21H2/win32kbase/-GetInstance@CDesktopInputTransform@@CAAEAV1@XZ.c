/*
 * XREFs of ?GetInstance@CDesktopInputTransform@@CAAEAV1@XZ @ 0x1C008782C
 * Callers:
...
{
  if ( (dword_1C02520B8 & 1) == 0 )
  {
    dword_1C02520B8 |= 1u;
    qword_1C02520C0 = (__int64)&CPushLock::`vftable';
    xmmword_1C02520C8 = 0LL;
    xmmword_1C02520D8 = 0LL;
  }
  return (struct CDesktopInputTransform *)&qword_1C02520C0;
}
