/*
 * XREFs of ?ReleaseAllReferences@CInteractionTrackerMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C022FFB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CApplicationChannel *a2)
{
  ...
  v4 = (struct DirectComposition::CWeakReferenceBase **)((char *)this + 336);
  v5 = 3LL;
  do
  {
    if ( *v4 )
  ...
  while ( v5 );
  v6 = (struct DirectComposition::CResourceMarshaler **)((char *)this + 272);
  v7 = 4LL;
  do
  {
  ...
  while ( v7 );
  v9 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 28);
  if ( v9 )
  {
    DirectComposition::CApplicationChannel::ReleaseWeakReference(a2, v9);
    *((_QWORD *)this + 28) = 0LL;
  }
  v10 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 29);
  if ( v10 )
  {
