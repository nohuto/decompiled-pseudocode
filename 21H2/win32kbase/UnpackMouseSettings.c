/*
 * XREFs of UnpackMouseSettings @ 0x1C01AF9A0
 * Callers:
...
void *__fastcall UnpackMouseSettings(int *a1, int a2)
{
  ...
  v5 = a1[1];
  if ( v5 != (unsigned int)CMouseAcceleration::MOUSE_SENSITIVITY_INFO::GetMouseSensitivity((CDeviceAcceleration *)((char *)qword_1C0246098 + 104)) )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v9) = v5;
      LOBYTE(v6) = 4;
      WPP_RECORDER_SF_d((_DWORD)gBaseLog, v6, 12, 11, (__int64)&WPP_e18a3e3623fd345076d33ab3e1bf5af6_Traceguids, v9);
    }
    if ( v5 - 1 > 0x13 )
      v5 = *((_DWORD *)qword_1C0246098 + 24);
    ...
    CDeviceAcceleration::ResetAccelerationCurves(qword_1C0246098);
  }
  result = gpsi;
  v8 = a1[2];
  if ( v8 != *((_DWORD *)gpsi + 1247) )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v9) = a1[2];
      LOBYTE(v6) = 4;
      WPP_RECORDER_SF_d((_DWORD)gBaseLog, v6, 12, 12, (__int64)&WPP_e18a3e3623fd345076d33ab3e1bf5af6_Traceguids, v9);
    }
    result = gpsi;
    *((_DWORD *)gpsi + 1247) = v8;
  }
