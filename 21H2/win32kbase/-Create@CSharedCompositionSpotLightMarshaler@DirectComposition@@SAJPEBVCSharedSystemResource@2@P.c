/*
 * XREFs of ?Create@CSharedCompositionSpotLightMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00A49C0
 * Callers:
 *     CreateSharedCompositionSpotLightMarshaler @ 0x1C00A4980 (CreateSharedCompositionSpotLightMarshaler.c)
 * Callees:
