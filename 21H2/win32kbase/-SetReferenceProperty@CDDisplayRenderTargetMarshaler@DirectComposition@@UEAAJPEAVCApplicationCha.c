/*
 * XREFs of ?SetReferenceProperty@CDDisplayRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01EF130
 * Callers:
 *     <none>
 * Callees:
