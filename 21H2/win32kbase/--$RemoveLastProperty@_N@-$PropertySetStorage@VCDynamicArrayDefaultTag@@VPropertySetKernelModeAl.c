/*
 * XREFs of ??$RemoveLastProperty@_N@?$PropertySetStorage@VCDynamicArrayDefaultTag@@VPropertySetKernelModeAllocator@@@@QEAAXXZ @ 0x1C00CE358
 * Callers:
        ...
        __int64 a4)
{
  ...
  v4 = *(_DWORD *)(a1 + 8);
  if ( !v4 || (a2 = *(unsigned int *)(a1 + 24), !(_DWORD)a2) )
  {
