/*
 * XREFs of ?CitpContextTrackingDataStart@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C008BBDC
 * Callers:
...
__int64 __fastcall CitpContextTrackingDataStart(struct _CIT_IMPACT_CONTEXT *a1, const char *a2)
{
  ...
  if ( !BYTE5(qword_1C0255554) )
    return v2;
  v5 = -1;
  v6 = 96LL * (unsigned int)xmmword_1C0255534;
  if ( v6 > 0xFFFFFFFF )
  {
    v8 = -1073741675;
    v9 = 455;
...
LABEL_28:
  ...
  v10 = (unsigned int)xmmword_1C0255534;
  v11 = 0;
  if ( (_DWORD)xmmword_1C0255534 )
  {
    v12 = (char *)a1 + 8;
    do
    {
    ...
    while ( v11 < (unsigned int)xmmword_1C0255534 );
  }
  *((_DWORD *)a1 + 14) = v10;
