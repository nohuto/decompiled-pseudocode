/*
 * XREFs of NtUserSetSysColors @ 0x1C000B8B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetSysColors(unsigned int a1, char *a2, char *a3, int a4)
{
  ...
  if ( (*((_DWORD *)gptiCurrent + 122) & 0x20000000) != 0 )
    ...
    v10 = 0;
  if ( v10 || !(unsigned __int8)CheckAccessEx(*((_QWORD *)gptiCurrent + 53) + 880LL, v21, 0LL) )
  {
    v19 = 0;
