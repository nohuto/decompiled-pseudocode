/*
 * XREFs of ApiSetEditionGetInputTransform @ 0x1C003C1EC
 * Callers:
...
__int64 (__fastcall *__fastcall ApiSetEditionGetInputTransform(__int64 a1, __int64 a2, __int64 a3))(_QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029D680;
  if ( qword_1C029D680 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029D680(v5, a2, a3, v7);
    if ( (int)result >= 0 )
    {
      result = qword_1C029D688;
      if ( qword_1C029D688 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C029D688(a1, v3);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
