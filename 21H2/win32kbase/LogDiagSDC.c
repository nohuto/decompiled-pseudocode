/*
 * XREFs of LogDiagSDC @ 0x1C0075E24
 * Callers:
        ...
        char a8)
{
  ...
  v8 = a1;
  v12 = 192 * a1 + 88;
  v13 = (char *)PALLOCMEM2(v12, 1936876615LL, 1);
  v14 = (__int64)v13;
  if ( v13 )
  {
    *((_DWORD *)v13 + 10) = 0;
    ...
    *((_DWORD *)v13 + 19) = 192;
    ...
    ((void (__fastcall *)(__int64))qword_1C02519A0)(v14);
    Win32FreePool(v14);
  }
  else
  {
    ...
    *(_QWORD *)(v15 + 24) = v12;
    ...
    DrvDxgkLogCodePointPacket(3LL, a3, a4);
  }
}
