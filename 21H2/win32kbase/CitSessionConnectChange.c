/*
 * XREFs of CitSessionConnectChange @ 0x1C00B4EB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CitSessionConnectChange(char a1, char a2)
{
  ...
  if ( !xmmword_1C0255560 || ((*((_BYTE *)xmmword_1C0255560 + 112) & 2) != 0) == a1 )
    return;
  v5 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  if ( a1 )
    ++*((_WORD *)xmmword_1C0255560 + 57);
  else
  ...
  if ( !a2 )
  {
    if ( a1 )
    {
      if ( (unsigned int)dword_1C024BB8C >= MEMORY[0xFFFFF7800000037C] )
        goto LABEL_6;
      v8 = &off_1C024BB80;
    }
    else
    {
      if ( (unsigned int)dword_1C024A37C >= MEMORY[0xFFFFF7800000037C] )
        goto LABEL_6;
      v8 = &off_1C024A370;
    }
