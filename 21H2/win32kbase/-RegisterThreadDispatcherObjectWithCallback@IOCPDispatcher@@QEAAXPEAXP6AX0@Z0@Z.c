/*
 * XREFs of ?RegisterThreadDispatcherObjectWithCallback@IOCPDispatcher@@QEAAXPEAXP6AX0@Z0@Z @ 0x1C00545B0
 * Callers:
 *     AddThreadWakeEventDispatcherToIOCP @ 0x1C0054330 (AddThreadWakeEventDispatcherToIOCP.c)
