/*
 * XREFs of ?vReferencePdev@PDEVOBJ@@QEAAXXZ @ 0x1C0010F60
 * Callers:
...
void __fastcall PDEVOBJ::vReferencePdev(PDEVOBJ *this, __int64 a2, int a3)
{
  ...
  if ( v6 && qword_1C024C408 )
    NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C024C408, v6, 1);
  if ( v3 )
  {
    if ( gbLockEtw )
    {
