/*
 * XREFs of ?ReferenceAndThreadLock@CRefUnRefPointerMsgId@@QEAAXXZ @ 0x1C00E8DC0
 * Callers:
...
void __fastcall CRefUnRefPointerMsgId::ReferenceAndThreadLock(CRefUnRefPointerMsgId *this)
{
  ...
  {
    *((_BYTE *)this + 32) = 1;
    CTouchProcessor::ReferenceMsgDataFromGuard();
    if ( qword_1C029BD10 )
      qword_1C029BD10(*(_QWORD *)this, (char *)this + 8, CRefUnRefPointerMsgId::UnReferenceOnThreadTermination);
  }
}
