/*
 * XREFs of ??$EmitSetProperty@UPropertySetQuaternionValue@@UD2DQuaternion@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C01EC1C0
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v17 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x2CuLL, &v17);
  v7 = (char *)v17;
  *(_DWORD *)v17 = 44;
  *(_OWORD *)(v7 + 4) = 0LL;
  *(_QWORD *)(v7 + 20) = 0LL;
