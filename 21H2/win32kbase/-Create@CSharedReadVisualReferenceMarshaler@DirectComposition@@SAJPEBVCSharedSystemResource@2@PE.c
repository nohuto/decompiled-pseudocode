/*
 * XREFs of ?Create@CSharedReadVisualReferenceMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F8300
 * Callers:
 *     CreateSharedReadVisualReferenceMarshaler @ 0x1C01F8540 (CreateSharedReadVisualReferenceMarshaler.c)
 * Callees:
