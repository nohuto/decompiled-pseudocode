/*
 * XREFs of ?ivChildLoop@CBaseInput@@AEAAJKPEAURawInputManagerObject@@@Z @ 0x1C01BD1D8
 * Callers:
...
__int64 __fastcall CBaseInput::ivChildLoop(CBaseInput *this, int a2, struct RawInputManagerObject *a3)
{
  ...
  {
    LOBYTE(v7) = 4;
    WPP_RECORDER_SF_((_DWORD)gBaseLog, v7, 12, 11, (__int64)&WPP_887bca56a4463e19a9d2c8c54736f7bc_Traceguids);
  }
  *(_QWORD *)&v12 = this;
  *((_QWORD *)&v12 + 1) = a3;
...
LABEL_13:
    LODWORD(v11) = v8;
    LOBYTE(v7) = 2;
    WPP_RECORDER_SF_d((_DWORD)gBaseLog, v7, 12, v9, (__int64)&WPP_887bca56a4463e19a9d2c8c54736f7bc_Traceguids, v11);
  }
LABEL_14:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
