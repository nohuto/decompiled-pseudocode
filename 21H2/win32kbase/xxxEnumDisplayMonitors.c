/*
 * XREFs of xxxEnumDisplayMonitors @ 0x1C006FE90
 * Callers:
...
LABEL_47:
  ...
  v28 = v21[2];
  if ( (v21[8] & 0x4000) != 0 && qword_1C02576B0 )
    v9 = qword_1C02576B0(v21[2], 2848LL);
...
LABEL_3:
  ...
  for ( i = *(struct tagMONITOR **)(gpDispInfo + 104); i; i = (struct tagMONITOR *)*((_QWORD *)i + 7) )
  {
    ...
    *((_QWORD *)&v30 + 1) = i;
    ...
    if ( qword_1C0257710 )
    {
      v19 = qword_1C0257710(*(_QWORD *)i, MonitorDC, &v38, a4, a3);
LABEL_17:
      v13 = v19;
      goto LABEL_18;
    }
...
LABEL_18:
    if ( !ThreadUnlock1()
      || (CLockDomainSharedAllowAllRecursion<DLT_HANDLEMANAGER>::CLockDomainSharedAllowAllRecursion<DLT_HANDLEMANAGER>((__int64)v36),
          (*((_BYTE *)qword_1C024FD58 + dword_1C024FD60 * (unsigned int)(unsigned __int16)*(_DWORD *)i + 25) & 1) != 0) )
    {
      v13 = 0;
    }
    if ( MonitorDC )
