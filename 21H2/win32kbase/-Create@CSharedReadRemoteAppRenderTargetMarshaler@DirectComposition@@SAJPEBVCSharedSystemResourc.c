/*
 * XREFs of ?Create@CSharedReadRemoteAppRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F90F0
 * Callers:
 *     CreateSharedReadRemoteAppRenderTargetMarshaler @ 0x1C01F92D0 (CreateSharedReadRemoteAppRenderTargetMarshaler.c)
 * Callees:
