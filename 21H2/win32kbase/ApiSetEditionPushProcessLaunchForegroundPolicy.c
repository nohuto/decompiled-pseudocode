/*
 * XREFs of ApiSetEditionPushProcessLaunchForegroundPolicy @ 0x1C009D8A4
 * Callers:
        ...
        __int64 a3))(_QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  result = qword_1C029CEF0;
  if ( qword_1C029CEF0 )
    result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))qword_1C029CEF0(a1, v3, a3, v6);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
