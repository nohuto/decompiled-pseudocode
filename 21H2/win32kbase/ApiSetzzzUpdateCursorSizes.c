/*
 * XREFs of ApiSetzzzUpdateCursorSizes @ 0x1C005083C
 * Callers:
...
__int64 (*ApiSetzzzUpdateCursorSizes())(void)
{
  ...
  result = qword_1C029C458;
  if ( qword_1C029C458 )
  {
    result = (__int64 (*)(void))qword_1C029C458();
    if ( (int)result >= 0 )
    {
      result = qword_1C029C460;
      if ( qword_1C029C460 )
        result = (__int64 (*)(void))qword_1C029C460();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
