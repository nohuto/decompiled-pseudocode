/*
 * XREFs of _output_l @ 0x1C00D6548
 * Callers:
 ...
 *     write_multi_char @ 0x1C00D6DD4 (write_multi_char.c)
 *     write_string @ 0x1C00D6E2C (write_string.c)
 *     _get_printf_count_output @ 0x1C00D79B4 (_get_printf_count_output.c)
 *     wctomb_s @ 0x1C00D7A84 (wctomb_s.c)
...
LABEL_117:
                      ...
                      {
                        LOBYTE(v17) = 32;
                        write_multi_char(v17, v31, v54, &v45);
                      }
                      write_string(v46, v30, v54, &v45);
                      v33 = v54;
                      if ( (v6 & 0xC) == 8 )
                      {
                        LOBYTE(v32) = 48;
                        write_multi_char(v32, v31, v54, &v45);
                      }
                      v34 = SizeConverted;
                      if ( v50 && SizeConverted > 0 )
                      {
                        ...
                        while ( 1 )
                        {
                          ...
                          if ( wctomb_s(v55, v57, 6uLL, v36) || !v55[0] )
                            break;
                          write_string(v57, (unsigned int)v55[0], v54, &v45);
                          if ( !v34 )
                            goto LABEL_131;
                        }
                        v12 = -1;
                      ...
                      {
                        write_string(v9, (unsigned int)SizeConverted, v33, &v45);
LABEL_131:
                        v12 = v45;
                      }
                      if ( v12 >= 0 && (v6 & 4) != 0 )
                      {
                        LOBYTE(v37) = 32;
                        write_multi_char(v37, v31, v54, &v45);
                        v7 = v47;
                        v8 = v44;
                        goto LABEL_167;
                      }
