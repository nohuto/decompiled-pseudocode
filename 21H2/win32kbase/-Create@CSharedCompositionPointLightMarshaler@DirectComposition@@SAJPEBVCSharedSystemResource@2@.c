/*
 * XREFs of ?Create@CSharedCompositionPointLightMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F9994
 * Callers:
 *     CreateSharedCompositionPointLightMarshaler @ 0x1C01F9B40 (CreateSharedCompositionPointLightMarshaler.c)
 * Callees:
