/*
 * XREFs of ??1CInpLockGuardExclusiveIfNeeded@@QEAA@XZ @ 0x1C01BD260
 * Callers:
 ...
 *     ?GetMsgPointerIdFromEdition@CTouchProcessor@@QEAAG_K@Z @ 0x1C01C9190 (-GetMsgPointerIdFromEdition@CTouchProcessor@@QEAAG_K@Z.c)
