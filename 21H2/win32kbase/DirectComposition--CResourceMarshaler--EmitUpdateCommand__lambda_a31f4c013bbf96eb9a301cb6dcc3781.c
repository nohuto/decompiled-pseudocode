/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_a31f4c013bbf96eb9a301cb6dcc37814___ @ 0x1C021F5AC
 * Callers:
...
char __fastcall DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_a31f4c013bbf96eb9a301cb6dcc37814___(
        __int64 a1,
        ...
        __int64 a3)
{
  ...
  *(_OWORD *)(v6 + 1) = 0LL;
  ...
  if ( v7 )
    v3 = *(_DWORD *)(v7 + 32);
  v6[3] = v3;
  v6[4] = *(_DWORD *)(*(_QWORD *)a3 + 112LL);
  result = 1;
  v6[5] = *(_DWORD *)(*(_QWORD *)a3 + 116LL);
  return result;
}
