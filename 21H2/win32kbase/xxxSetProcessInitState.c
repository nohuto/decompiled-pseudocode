/*
 * XREFs of xxxSetProcessInitState @ 0x1C0047100
 * Callers:
        ...
        *(_DWORD *)(ProcessWin32Process + 12) = v7 | 0x20;
        ...
        if ( (a2 & 0x80u) == 0 )
        {
          ...
          if ( (int)IszzzCalcStartCursorHideSupported() < 0 )
            goto LABEL_24;
          v8 = (void (__fastcall *)(__int64, __int64))qword_1C0256FA0;
          if ( !qword_1C0256FA0 )
            goto LABEL_24;
          v9 = 2000LL;
...
LABEL_24:
  ...
  if ( qword_1C0256F88 )
    result = qword_1C0256F88();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = qword_1C0256F90 ? qword_1C0256F90(a1) : 3221225659LL;
    if ( (int)result >= 0 )
    {
      ProcessWin32Process = PsGetProcessWin32Process(a1);
      goto LABEL_9;
