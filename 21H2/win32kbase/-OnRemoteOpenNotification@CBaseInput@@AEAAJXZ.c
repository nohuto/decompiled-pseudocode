/*
 * XREFs of ?OnRemoteOpenNotification@CBaseInput@@AEAAJXZ @ 0x1C00C2720
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v5 != -1 )
  {
    if ( v5 )
    {
      ...
      if ( v6 < 0 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_d((_DWORD)gBaseLog, 2, 3, 13, (__int64)&WPP_f3c7c3b8e3c935fa60aa5d5f3732d730_Traceguids, v6);
    }
    else
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_((_DWORD)gBaseLog, 2, 3, 12, (__int64)&WPP_f3c7c3b8e3c935fa60aa5d5f3732d730_Traceguids);
      return 0;
    }
...
LABEL_12:
  ...
  {
    LOBYTE(v3) = 4;
    WPP_RECORDER_SF_d((_DWORD)gBaseLog, v3, 3, 11, (__int64)&WPP_f3c7c3b8e3c935fa60aa5d5f3732d730_Traceguids, v4);
  }
