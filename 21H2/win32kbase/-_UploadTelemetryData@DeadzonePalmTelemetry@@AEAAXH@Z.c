/*
 * XREFs of ?_UploadTelemetryData@DeadzonePalmTelemetry@@AEAAXH@Z @ 0x1C01811F4
 * Callers:
 *     ?ClearSession@DeadzonePalmTelemetry@@QEAAXXZ @ 0x1C01808E8 (-ClearSession@DeadzonePalmTelemetry@@QEAAXXZ.c)
 *     ?UpdateTelemetryBuffer@DeadzonePalmTelemetry@@QEAAXKKH@Z @ 0x1C0180B00 (-UpdateTelemetryBuffer@DeadzonePalmTelemetry@@QEAAXKKH@Z.c)
 * Callees:
 ...
 *     ?RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z @ 0x1C0180938 (-RtlStringCchLengthA@@YAJPEBD_KPEA_K@Z.c)
    ...
    *((_DWORD *)this + 1) = v6;
    if ( v6 )
    {
      ...
      do
      {
        ...
        if ( v16 + 32 >= 0x800 )
        {
          if ( (unsigned int)dword_1C024A1A8 > 5 && tlgKeywordOn((__int64)&dword_1C024A1A8, 0x400000000000LL) )
          {
            v17 = (__int64)v2;
            _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<char>>(
              (__int64)&dword_1C024A1A8,
              byte_1C021DBF2,
              0LL,
              0LL,
              (void **)&v17);
