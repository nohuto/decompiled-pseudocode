/*
 * XREFs of RIMOnTimerNotification @ 0x1C0157890
 * Callers:
 *     NtRIMOnTimerNotification @ 0x1C0153960 (NtRIMOnTimerNotification.c)
 *     ?OnAutoRepeatTimerNotification@CBaseInput@@AEAAJXZ @ 0x1C01A3D30 (-OnAutoRepeatTimerNotification@CBaseInput@@AEAAJXZ.c)
 *     ?OnTimerNotification@CBaseInput@@AEAAJXZ @ 0x1C01A45F0 (-OnTimerNotification@CBaseInput@@AEAAJXZ.c)
 * Callees:
