/*
 * XREFs of ?DrvCreatePathModalityFromAllPaths@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@I0@Z @ 0x1C0170EB8
 * Callers:
        ...
        struct D3DKMT_GETPATHSMODALITY **a3)
{
  ...
  if ( a2 < 2 )
  {
    ...
    v9 = PathsModality;
    if ( PathsModality < 0 )
      WdLogSingleEntry2(2LL, PathsModality, 26006LL);
    return v9;
  }
  if ( !*a1 )
  {
    ...
    if ( v11 < 0 )
    {
      WdLogSingleEntry2(2LL, v11, 26026LL);
      return v12;
    }
    if ( !*a1 )
      WdLogSingleEntry0(1LL);
