/*
 * XREFs of ?SetDisplayConfigHandleBrokerProvidedPaths@@YAJPEAX_NIPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_GETPATHSMODALITY@@PEA_NPEAW4_DXGK_DIAG_SDC_STAGE@@@Z @ 0x1C01459BC
 * Callers:
 ...
 *     _SetDisplayConfigHandleBrokerProvidedPaths_::_2_::_AUTO_USING_PM_VirtualTopologyButNotVirtualModePath14136::__AUTO_USING_PM_VirtualTopologyButNotVirtualModePath14136 @ 0x1C00CA99C (_SetDisplayConfigHandleBrokerProvidedPaths_--_2_--_AUTO_USING_PM_VirtualTopologyButNotVirtualMod.c)
      ...
      *((_WORD *)v11 + 10) = 0;
      ...
      if ( *((_WORD *)v45 + 10) )
      {
        do
        {
          ...
          if ( !(unsigned __int8)((__int64 (__fastcall *)(__int64, _QWORD, _QWORD))qword_1C0251B70)(
                                   a1,
                                   *(_QWORD *)(v15 + 16),
                                   *(unsigned int *)(v15 + 28)) )
          {
