/*
 * XREFs of xxxUserChangeDisplaySettings @ 0x1C0017D10
 * Callers:
  ...
  *(_OWORD *)String1 = 0LL;
  ...
  if ( v9 )
  {
    *(_OWORD *)Src = *v9;
    ...
    if ( qword_1C0256FC0 )
    {
      qword_1C0256FC0(v15, &String1[1], Win32FreePool);
      v15 = String1[0];
      v12 = 0LL;
    }
...
LABEL_55:
    ...
    if ( v12 )
    {
      if ( qword_1C0256FC0 )
      {
        qword_1C0256FC0(v12, &v48, Win32FreePool);
        v12 = v47;
      }
      if ( v43 + (_DWORD)v17 )
      {
...
LABEL_23:
  ...
  if ( v21 )
  {
    ...
    *(_DWORD *)(v25 + 52) = v20;
    ...
    ((void (__fastcall *)(__int64))qword_1C02519A0)(v25);
    v68 = MEMORY[0xFFFFF78000000320];
    v35 = v68 * KeQueryTimeIncrement();
    EtwActivityIdControl(3u, &ActivityId);
    v37 = (unsigned int)dword_1C0246378;
    if ( (unsigned int)dword_1C0246378 > 5
      && (unsigned __int8)tlgKeywordOn(&dword_1C0246378, 0x200000000004LL, (unsigned int)dword_1C0246378, v36) )
    {
      v69 = v35;
      v70 = v64;
      v51 = v20;
    ...
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_1C0246378, 0x200000000004LL, v37, v36) )
      {
        v54 = *(_DWORD *)(v25 + 104);
        v55 = *(_DWORD *)(v25 + 100);
        v56 = *(_DWORD *)(v25 + 96);
