/*
 * XREFs of ?EmitAddConditionAnimationResources@CConditionalExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C022B180
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 37) < *((_DWORD *)this + 36); *((_DWORD *)this + 37) += 2 * v5 )
  {
    ...
    if ( (unsigned __int64)v4 < 0x18 )
    {
      if ( !DirectComposition::CBatch::AllocateNewFragment(a2, (unsigned __int64 *)&v11) )
        return *((_DWORD *)this + 37) == *((_DWORD *)this + 36);
      v4 = v11;
    }
    v5 = (unsigned int)(*((_DWORD *)this + 36) - *((_DWORD *)this + 37)) >> 1;
    if ( (unsigned __int64)(unsigned int)(*((_DWORD *)this + 36) - *((_DWORD *)this + 37)) >> 1 >= ((unsigned __int64)v4
                                                                                                  - 16) >> 3 )
    ...
    *((_DWORD *)v6 + 2) = *((_DWORD *)this + 8);
    for ( *((_DWORD *)v6 + 3) = v5;
          v7 < v5;
          *(v8 - 1) = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 17)
                                            + 8LL * (unsigned int)(v9 + *((_DWORD *)this + 37) + 1))
                                + 32LL) )
    {
      v9 = 2 * v7++;
      *v8 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 17) + 8LL * (unsigned int)(v9 + *((_DWORD *)this + 37))) + 32LL);
      v8 += 2;
    }
  }
  return *((_DWORD *)this + 37) == *((_DWORD *)this + 36);
