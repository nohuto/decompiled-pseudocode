/*
 * XREFs of ?BufferMouseInput@Mouse@InputTraceLogging@@SAXPEAUDEVICEINFO@@@Z @ 0x1C01EBFDC
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::BufferMouseInput(struct DEVICEINFO *a1)
{
  ...
  if ( (unsigned int)dword_1C028EE70 > 4 && tlgKeywordOn((__int64)&dword_1C028EE70, 64LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C028EE70, (unsigned __int8 *)dword_1C02634AD, 0LL, 0LL, 3u, &v3);
  }
}
