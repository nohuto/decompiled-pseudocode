/*
 * XREFs of NtUserReleaseDC @ 0x1C0035A80
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall NtUserReleaseDC(__int64 a1)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v18 && (*(int *)(v18 + 24) > 0 || *(_DWORD *)(v27 + 48)) )
    {
      ...
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v19, v20) )
        {
          v26 = v28;
          v32 = 4LL;
          v31 = &v26;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218FF7, (int)&ActivityId, 0, 3u, &v30);
        }
      }
    }
  }
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v21 )
    {
      ...
      if ( (*(_DWORD *)(v24 + 44) || *(_DWORD *)(v24 + 48) || v25 > 0)
        ...
        && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 0x2000LL, v22, v23) )
      {
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C024BA90, (int)&dword_1C0218F81, v24 + 28, 0, 2u, &v33);
      }
      *(_DWORD *)(v24 + 44) = 0;
      *(_OWORD *)(v24 + 28) = 0LL;
    }
