/*
 * XREFs of ?IsPropertyAnimatable@CLinearTransferEffectMarshaler@DirectComposition@@UEAA_NIW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1C0217970
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CLinearTransferEffectMarshaler::IsPropertyAnimatable(
        ...
        int a3)
{
  if ( a2 <= 1 || a2 > 2 && (a2 <= 4 || a2 > 5 && (a2 <= 7 || a2 - 9 <= 1)) )
    return a3 == 18;
  else
