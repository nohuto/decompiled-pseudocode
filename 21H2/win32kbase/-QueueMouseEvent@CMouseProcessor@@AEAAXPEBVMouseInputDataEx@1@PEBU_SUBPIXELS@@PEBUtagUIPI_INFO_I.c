/*
 * XREFs of ?QueueMouseEvent@CMouseProcessor@@AEAAXPEBVMouseInputDataEx@1@PEBU_SUBPIXELS@@PEBUtagUIPI_INFO_INT@@PEBUtagPOINT@@@Z @ 0x1C0040740
 * Callers:
        ...
        const struct tagPOINT *a5)
{
  ...
  if ( v26 )
  {
    v20 = qword_1C0258908 ? qword_1C0258908() : -1073741637;
    if ( v20 >= 0 )
    {
...
LABEL_2:
  ...
  if ( v8 )
  {
    ...
    {
      LOBYTE(v16) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v16, 6, 19, (__int64)&WPP_bc237edca6b43ca924b1688b2fc88a86_Traceguids);
    }
  ...
  if ( v15 )
  {
    ...
    {
      LOBYTE(v16) = 4;
      WPP_RECORDER_SF_((_DWORD)gBaseLog, v16, 6, 21, (__int64)&WPP_bc237edca6b43ca924b1688b2fc88a86_Traceguids);
    }
...
LABEL_10:
    ...
    *((_QWORD *)v11 + 1) = 0LL;
    ...
    if ( (unsigned int)dword_1C024BA90 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C024BA90, 64LL, v18, v19) )
    {
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_((_DWORD)gBaseLog, 2, 6, 20, (__int64)&WPP_bc237edca6b43ca924b1688b2fc88a86_Traceguids);
  *((_QWORD *)v11 + 1) = 0LL;
  ExReleasePushLockExclusiveEx(v11, 0LL);
  KeLeaveCriticalRegion();
