/*
 * XREFs of ??$EmitSetProperty@UPropertySetMatrix4x4Value@@UD2DMatrix@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C006488C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v18 = 0LL;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x5CuLL, &v18);
  v7 = (char *)v18;
  *(_DWORD *)v18 = 92;
  *(_OWORD *)(v7 + 4) = 0LL;
  *(_QWORD *)(v7 + 20) = 0LL;
