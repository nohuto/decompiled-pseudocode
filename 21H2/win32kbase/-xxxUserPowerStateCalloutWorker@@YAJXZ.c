/*
 * XREFs of ?xxxUserPowerStateCalloutWorker@@YAJXZ @ 0x1C00C0DF8
 * Callers:
...
__int64 xxxUserPowerStateCalloutWorker(void)
{
  ...
  v97 = dword_1C0252148;
  LODWORD(v119[4]) = dword_1C0252148;
  LODWORD(v119[3]) = 17;
  LOBYTE(v119[6]) = -1;
  InputBuffer = 0LL;
  v109 = 0LL;
  ...
  if ( (Microsoft_Windows_Win32kEnableBits & 8) != 0 )
    McTemplateK0dq_EtwWriteTransfer(v1, &StartPowerStateCalloutWorker, v2, (unsigned int)dword_1C0252148, 0);
  v5 = -1073741637;
  if ( qword_1C0257540 )
    v6 = qword_1C0257540();
  else
...
LABEL_157:
  ...
  if ( v4 == 2 )
  {
    ...
    if ( !gbTtmEnabled )
      PowerOffMonitor(dword_1C025214C);
    ...
    if ( gSessionId != gServiceSessionId )
    {
      ...
      *((_DWORD *)&gPowerStateLog + 2 * v24 + 3) = 1;
      LOBYTE(v24) = 1;
      v25 = xxxSendWinlogonPowerMessage(v24, 262LL, &dword_1C0252138);
    ...
    if ( !(unsigned int)PowerResumeSuspendEvent(v23, v0, 0LL) && (int)IsxxxSendMessageBSMSupported(v27) >= 0 )
    {
      ...
      {
        LODWORD(v95) = 1;
        *(_QWORD *)OutputBufferLength = &dword_1C0252110;
        v28 = qword_1C02574F8(0LL, 536LL, 4LL);
      }
      else
      {
        v28 = 0;
...
LABEL_87:
      ...
      if ( (dword_1C0252140 & 8) != 0 )
      {
        if ( qword_1C0251A88 )
          v29 = qword_1C0251A88(0LL, 0LL);
        else
          v29 = 0;
        if ( v29 )
        {
      ...
      else
      {
        ...
        *((_DWORD *)&gPowerStateLog + 2 * v88 + 3) = 259;
        LOBYTE(v88) = 1;
        v89 = xxxSendWinlogonPowerMessage(v88, 259LL, &dword_1C0252138);
    ...
    if ( !gProtocolType && (int)IsPowerOffGdiSupported() >= 0 && qword_1C0257518 )
      qword_1C0257518();
    goto LABEL_87;
  }
  v7 = v4 - 3;
        ...
        && (*(_DWORD *)(v116 + 48) || *(int *)(v116 + 24) > 0) )
      {
        ...
        *(GUID *)(v116 + 28) = v118;
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          ...
          if ( v84 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            LODWORD(v107) = v117;
            v137 = 4LL;
            v136 = &v107;
...
LABEL_36:
    ...
    case 5u:
      ...
      SystemInformation = dword_1C025213C == 5;
      if ( gSessionId )
      {
        if ( dword_1C025213C == 5 )
        {
      ...
      if ( (int)IsPowerOnGdiSupported() >= 0 && qword_1C0257528 )
        qword_1C0257528(v119, 1LL, 5LL);
      dword_1C02521F0 = 0;
      _InterlockedOr(v93, 0);
      ...
      if ( !(unsigned int)PowerResumeSuspendEvent(0LL, v19, 0LL) && (int)IsxxxSendMessageBSMSupported(v20) >= 0 )
      {
        ...
        if ( qword_1C02574F8 )
        {
          ...
          *(_QWORD *)OutputBufferLength = v110;
          v21 = qword_1C02574F8(0LL, 536LL, 18LL);
        }
        else
        {
          v21 = 0;
        ...
        && (*(_DWORD *)(v112 + 48) || *(int *)(v112 + 24) > 0) )
      {
        ...
        *(GUID *)(v112 + 28) = v114;
        if ( (unsigned int)dword_1C024BA90 > 6 )
        {
          ...
          if ( v77 > 6 && tlgKeywordOn((__int64)&dword_1C024BA90, 0x2000LL) )
          {
            v104 = v113;
            v128 = 4LL;
            v127 = &v104;
...
LABEL_34:
    ...
    case 0xAu:
      ...
      if ( (int)IsPowerOffGdiSupported() >= 0 && qword_1C0257518 )
        qword_1C0257518();
      break;
    case 0xBu:
      if ( gbTtmEnabled )
      ...
      else if ( v4 == 13 )
      {
        ...
        if ( gSessionId != gServiceSessionId )
        {
          ...
          *((_DWORD *)&gPowerStateLog + 2 * v8 + 3) = 263;
          LOBYTE(v8) = 1;
          v9 = xxxSendWinlogonPowerMessage(v8, 263LL, &dword_1C0252138);
