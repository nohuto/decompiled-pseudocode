/*
 * XREFs of ?GetFloatAnimatableProperty@CAffineTransform2DEffectMarshaler@DirectComposition@@UEAAJIPEAM@Z @ 0x1C0219B30
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  {
    *a3 = *((float *)this + 2 * ((unsigned __int64)(unsigned int)(a2 - 4) >> 1) + (a2 & 1) + 32);
  }
  return v3;
}
