/*
 * XREFs of ?OnInput@PTPEngineTraceProducer@@QEAAJPEAUPTPInput@@PEAUtagTPAAPSTATE@@@Z @ 0x1C01C9E20
 * Callers:
 *     ?ProcessInput@CPTPProcessor@@QEAAXPEAX0HHH@Z @ 0x1C01A6E40 (-ProcessInput@CPTPProcessor@@QEAAXPEAX0HHH@Z.c)
 *     ?OnInput@PTPEngineTraceProducer@@UEAAJPEAUPTPInput@@@Z @ 0x1C01C9F60 (-OnInput@PTPEngineTraceProducer@@UEAAJPEAUPTPInput@@@Z.c)
 * Callees:
...
__int64 __fastcall PTPEngineTraceProducer::OnInput(PTPEngineTraceProducer *this, struct PTPInput *a2, __int64 a3)
{
  ...
  LODWORD(v3) = dword_1C024A170;
  if ( (unsigned int)dword_1C024A170 > 5 && tlgKeywordOn((__int64)&dword_1C024A170, 3LL) )
  {
    v14 = a3;
    v8 = -a3;
    v16 = a2;
  ...
  if ( *((_DWORD *)a2 + 12) && (unsigned int)v3 > 5 && tlgKeywordOn((__int64)&dword_1C024A170, 3LL) )
  {
    v11 = *((_WORD *)a2 + 24);
