/*
 * XREFs of EditionPostMouseWheelToForeground @ 0x1C01FC2DC
 * Callers:
        ...
        __int64 a9))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD, _QWORD)
{
  ...
  result = qword_1C02581C0;
  if ( qword_1C02581C0 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD, _QWORD))qword_1C02581C0(a1, a2, a3, a4, a5, a6, a7, a8, a9);
  return result;
}
