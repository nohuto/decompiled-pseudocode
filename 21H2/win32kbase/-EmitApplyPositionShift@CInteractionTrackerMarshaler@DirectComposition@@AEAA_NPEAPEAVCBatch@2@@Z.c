/*
 * XREFs of ?EmitApplyPositionShift@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C022EE4C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( i = *((unsigned int *)this + 100); *((_DWORD *)this + 104) < (unsigned int)i; *((_DWORD *)this + 104) += v6 )
  {
    ...
    v6 = (unsigned int)(i - *((_DWORD *)this + 104));
    ...
    *((_DWORD *)v7 + 2) = *((_DWORD *)this + 8);
    ...
    {
      v10 = *((_QWORD *)this + 47);
      v11 = *((_QWORD *)this + 51) * (v8 + *((_DWORD *)this + 104));
      ++v8;
