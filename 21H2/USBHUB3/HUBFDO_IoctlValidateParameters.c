/*
 * XREFs of HUBFDO_IoctlValidateParameters @ 0x1C0075D84
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( a3 < a2 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      v7 = 38;
LABEL_15:
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2520), 2u, 3u, v7, (__int64)&WPP_cbf4a43b0f133f2c4fe58f6ee8af390c_Traceguids);
  ...
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2520), 2u, 3u, 0x27u, (__int64)&WPP_cbf4a43b0f133f2c4fe58f6ee8af390c_Traceguids);
