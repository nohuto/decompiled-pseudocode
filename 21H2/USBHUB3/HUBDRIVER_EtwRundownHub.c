/*
 * XREFs of HUBDRIVER_EtwRundownHub @ 0x1C0073540
 * Callers:
...
__int64 __fastcall HUBDRIVER_EtwRundownHub(const GUID *a1, __int64 a2)
{
  ...
  for ( i = result - 248; a2 + 2360 != result; i = result - 248 )
  {
    v8 = *(_DWORD *)(i + 1256);
    if ( v8 == 3000 )
    {
    ...
    LOBYTE(v27) = v14;
    LOBYTE(v26) = v13 & 1;
    LODWORD(v25) = *(unsigned __int16 *)(i + 200);
...
LABEL_41:
    v21 = *(_DWORD *)(i + 204);
    if ( (v21 & 2) != 0 && ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 1) != 0 )
    {
      LODWORD(v26) = 12;
      LODWORD(v25) = *(unsigned __int16 *)(i + 200);
      McTemplateK0pqn_EtwWriteTransfer(
        *(unsigned __int16 *)(i + 200),
    ...
    if ( (v21 & 4) != 0 && ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 1) != 0 )
    {
      LODWORD(v26) = 16;
      LODWORD(v25) = *(unsigned __int16 *)(i + 200);
      McTemplateK0pqn_EtwWriteTransfer(
