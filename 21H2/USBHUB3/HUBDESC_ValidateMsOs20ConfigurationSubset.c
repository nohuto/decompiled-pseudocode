/*
 * XREFs of HUBDESC_ValidateMsOs20ConfigurationSubset @ 0x1C003AEC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_31:
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x13Bu, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
    return v7;
  }
  v12 = a3 + 4;
  v13 = 1;
  ...
  do
  {
    ...
    else
    {
      ...
      if ( !*((_BYTE *)&MsOs20DispatchTable + 16 * v15 + 8) )
      {
        ...
        (*(void (__fastcall **)(_QWORD, __int64, unsigned __int8 (__fastcall *)(__int64, _BYTE *, unsigned __int16 *, char *), __int64 (__fastcall **)()))(a1 + 32))(
          *(_QWORD *)(a1 + 40),
          159LL,
          v16,
          v14);
