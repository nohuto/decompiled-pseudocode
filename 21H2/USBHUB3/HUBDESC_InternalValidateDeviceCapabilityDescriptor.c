/*
 * XREFs of HUBDESC_InternalValidateDeviceCapabilityDescriptor @ 0x1C0038C7C
 * Callers:
  ...
  if ( (unsigned __int8)v17 >= 3u )
  {
    if ( v21 < 3 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_d(v19, 2u, 5u, 0xD7u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids, v18);
...
LABEL_14:
    if ( a1[2] == 2 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(v19, 2u, 5u, 0xD8u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
      v24 = 76LL;
      goto LABEL_37;
    }
    if ( a1[2] == 3 )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(v19, 2u, 5u, 0xD9u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
      v24 = 75LL;
      goto LABEL_37;
    }
    if ( a1[2] != 4 )
    {
      ...
      if ( a1[2] == 10 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(v19, 2u, 5u, 0xDAu, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
        v24 = 203LL;
      }
      else
      {
        ...
        {
          if ( a1[2] == 17 )
            HUBDESC_InternalValidateFirmwareStatusCapabilityDescriptor(a1, a2, (__int64)a3, v11, a9, a10, v19);
          goto LABEL_66;
        }
        HUBDESC_InternalValidateBillboardCapabilityDescriptor(a1, a2, (__int64)a3, v11, v19);
        if ( *v11 == 1 )
          goto LABEL_66;
        v23 = *(_QWORD *)(a2 + 80);
        if ( !*(_QWORD *)(v23 + 32) )
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(v19, 2u, 5u, 0xDCu, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
        v24 = 245LL;
      }
      goto LABEL_37;
    }
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(v19, 2u, 5u, 0xDBu, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
      v24 = 74LL;
LABEL_37:
...
LABEL_67:
  v20 = 0;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(v19, 2u, 5u, 0xDDu, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
  return v20;
}
