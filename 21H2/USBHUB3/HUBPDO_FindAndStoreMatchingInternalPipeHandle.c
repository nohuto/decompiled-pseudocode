/*
 * XREFs of HUBPDO_FindAndStoreMatchingInternalPipeHandle @ 0x1C0016174
 * Callers:
 *     HUBDSM_GettingMatchingPipeHandleOnClientResetPipe @ 0x1C001D340 (HUBDSM_GettingMatchingPipeHandleOnClientResetPipe.c)
 * Callees:
