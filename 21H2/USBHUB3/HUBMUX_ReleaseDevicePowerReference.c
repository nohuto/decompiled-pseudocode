/*
 * XREFs of HUBMUX_ReleaseDevicePowerReference @ 0x1C0010800
 * Callers:
 *     HUBDSM_FlushingHubPowerDownEventsForFailedDevice @ 0x1C001CE80 (HUBDSM_FlushingHubPowerDownEventsForFailedDevice.c)
 *     HUBDSM_FailedDeviceHubSuspended @ 0x1C001CF60 (HUBDSM_FailedDeviceHubSuspended.c)
 * Callees:
