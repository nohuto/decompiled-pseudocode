/*
 * XREFs of HUBPDO_CompleteWaitWake @ 0x1C0019FC4
 * Callers:
 ...
 *     HUBDSM_CompletingWaitWakeOnDetachDuringSuspending @ 0x1C0021F10 (HUBDSM_CompletingWaitWakeOnDetachDuringSuspending.c)
 * Callees:
