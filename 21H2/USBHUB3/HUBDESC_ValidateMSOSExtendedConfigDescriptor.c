/*
 * XREFs of HUBDESC_ValidateMSOSExtendedConfigDescriptor @ 0x1C003A170
 * Callers:
...
char __fastcall HUBDESC_ValidateMSOSExtendedConfigDescriptor(_DWORD *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 != *a1 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_DD(a4, 2u, 5u, 0x10Cu, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids, a2, *a1);
  ...
  do
  {
    if ( *v8 )
    {
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(a4, 2u, 5u, 0x10Eu, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
        v15 = 123LL;
LABEL_29:
  ...
  for ( i = 0; i < 8; ++i )
  {
    if ( *v12 )
    {
      ...
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_(a4, 2u, 5u, 0x10Fu, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
        v15 = 124LL;
        goto LABEL_29;
      }
    }
...
LABEL_30:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x110u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
  return v7;
}
