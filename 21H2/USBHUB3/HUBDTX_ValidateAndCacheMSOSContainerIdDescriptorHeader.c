/*
 * XREFs of HUBDTX_ValidateAndCacheMSOSContainerIdDescriptorHeader @ 0x1C0029CC0
 * Callers:
 *     HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor @ 0x1C001FA60 (HUBDSM_ValidatingMSOSContainerIdHeaderDescriptor.c)
 * Callees:
  ...
  if ( *(_DWORD *)(a1 + 256) == 8 )
  {
    ...
    if ( *(_WORD *)(a1 + 1738) != 6 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        WPP_RECORDER_SF_DD(v3, 2u, 5u, 0x106u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids, v8, v9);
      }
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_SF_DD(v3, 2u, 5u, 0x107u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids, v8, v9);
    }
    v5 = 118LL;
  }
  else
...
LABEL_19:
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(v3, 2u, 5u, 0x108u, (__int64)&WPP_4c38247a76be3626caea66f1aba69131_Traceguids);
