/*
 * XREFs of HUBSM_FindAndSetTargetState @ 0x1C000A49C
 * Callers:
...
LABEL_21:
    ...
    HUBHTX_CompleteGetPortStatusWithFailedStatus(*(_QWORD *)(a1 + 960), v30);
    return 0;
  }
  switch ( v11 )
  {
    case 0x3EEu:
      v18 = *(_QWORD **)(a1 + 960);
      v19 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64, _BYTE *))(WdfFunctions_01015 + 2280))(
              WdfDriverGlobals,
              v18[62],
              v12,
              a3);
...
LABEL_44:
      v33 = *(_QWORD *)(a1 + 960);
      WPP_RECORDER_SF_qLLL(v5, (__int64)v21, v12, v24, v32);
    }
LABEL_45:
    *(_DWORD *)(a1 + 12LL * *(unsigned __int8 *)(a1 + 832) + 4) = v23;
    *(_DWORD *)(a1 + 12LL * *(unsigned __int8 *)(a1 + 832) + 8) = v3;
    v25 = *(unsigned __int8 *)(a1 + 832);
    v5 = 3 * v25;
    *(_DWORD *)(a1 + 12 * v25) = 1000;
    *(_BYTE *)(a1 + 832) = (*(_BYTE *)(a1 + 832) + 1) & 0x3F;
    if ( SBYTE1(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) < 0 )
    {
      LODWORD(v36) = v3;
      LODWORD(v35) = 1000;
      LODWORD(v34) = **(_DWORD **)(*(_QWORD *)(a1 + 976) + 8LL * (unsigned int)(v23 - *(_DWORD *)(a1 + 984)));
      LODWORD(v33) = *(_DWORD *)(a1 + 984);
  ...
  v9 = v7;
LABEL_49:
  v26 = *(_QWORD *)(v39 + 8LL * (unsigned int)(*(_DWORD *)(a1 + 4 * v9 + 852) - v37));
  if ( (*(_DWORD *)(v26 + 16) & 0x40) != 0 )
    *v14 = 1;
...
LABEL_63:
      v33 = *(_QWORD *)(a1 + 960);
      WPP_RECORDER_SF_qLLL(v26, (__int64)&WPP_RECORDER_INITIALIZED, v12, v28, v32);
      goto LABEL_64;
  }
...
LABEL_64:
  ...
  *(_BYTE *)(a1 + 832) = (*(_BYTE *)(a1 + 832) + 1) & 0x3F;
  if ( SBYTE1(WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink) < 0 )
  {
    LODWORD(v36) = v7;
    LODWORD(v35) = a2;
    LODWORD(v34) = **(_DWORD **)(*(_QWORD *)(a1 + 976) + 8LL * (v11 - *(_DWORD *)(a1 + 984)));
    LODWORD(v33) = *(_DWORD *)(a1 + 984);
    McTemplateK0ppqqqq_EtwWriteTransfer(
      3 * v29,
      &USBHUB3_ETW_EVENT_STATE_MACHINE,
