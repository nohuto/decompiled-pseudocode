/*
 * XREFs of HUBDTX_ValidateAndCacheDeviceDescriptor @ 0x1C0029190
 * Callers:
 *     HUBDSM_ValidatingAlternateDeviceDescriptor @ 0x1C001EB10 (HUBDSM_ValidatingAlternateDeviceDescriptor.c)
 * Callees:
