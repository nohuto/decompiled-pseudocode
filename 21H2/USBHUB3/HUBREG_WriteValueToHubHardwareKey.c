/*
 * XREFs of HUBREG_WriteValueToHubHardwareKey @ 0x1C0080868
 * Callers:
...
LABEL_7:
    LODWORD(v9) = v5;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2520), 2u, 3u, v7, (__int64)&WPP_ec435a79b99d323019775391632c21d3_Traceguids, v9);
  }
LABEL_8:
  if ( v10 )
