/*
 * XREFs of InitializeTelemetryAssertsKMWorkerInternal @ 0x1C003F98C
 * Callers:
...
__int64 __fastcall InitializeTelemetryAssertsKMWorkerInternal(const void **a1)
{
  ...
  if ( Pool2 )
  {
    ...
    qword_1C006ACE8 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
    TraceLoggingRegister_EtwRegister_EtwSetInformation(&dword_1C0071040);
    TraceLoggingRegister_EtwRegister_EtwSetInformation(&dword_1C0071008);
    TraceLoggingRegister_EtwRegister_EtwSetInformation(&dword_1C0071078);
