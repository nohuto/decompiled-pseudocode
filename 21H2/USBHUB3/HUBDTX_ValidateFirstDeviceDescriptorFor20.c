/*
 * XREFs of HUBDTX_ValidateFirstDeviceDescriptorFor20 @ 0x1C00298EC
 * Callers:
 *     HUBDSM_ValidatingDeviceDescriptorInReEnumAtZero @ 0x1C001EA60 (HUBDSM_ValidatingDeviceDescriptorInReEnumAtZero.c)
 * Callees:
