/*
 * XREFs of HUBUCX_UpdateHubInformationUsingUCXIoctl @ 0x1C0026134
 * Callers:
 *     HUBHSM_UpdatingHubInfoInUCX @ 0x1C0009530 (HUBHSM_UpdatingHubInfoInUCX.c)
 * Callees:
...
LABEL_4:
    LODWORD(v8) = v3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2520), 2u, 3u, v5, (__int64)&WPP_a5663512bb0f384af60f2cebe8e2cf44_Traceguids, v8);
LABEL_17:
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LODWORD(v8) = v4;
