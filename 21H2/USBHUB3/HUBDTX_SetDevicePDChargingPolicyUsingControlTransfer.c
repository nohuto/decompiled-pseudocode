/*
 * XREFs of HUBDTX_SetDevicePDChargingPolicyUsingControlTransfer @ 0x1C002AD00
 * Callers:
 *     HUBDSM_SettingDevicePDChargingPolicy @ 0x1C001E400 (HUBDSM_SettingDevicePDChargingPolicy.c)
 * Callees:
