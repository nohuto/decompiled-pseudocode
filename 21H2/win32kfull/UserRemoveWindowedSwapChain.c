/*
 * XREFs of UserRemoveWindowedSwapChain @ 0x1C0161A40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$RemoveProp@VCSwapChainProp@@@CWindowProp@@SAHPEAUtagWND@@PEAPEAVCSwapChainProp@@@Z @ 0x1C023D4D4 (--$RemoveProp@VCSwapChainProp@@@CWindowProp@@SAHPEAUtagWND@@PEAPEAVCSwapChainProp@@@Z.c)
 */
