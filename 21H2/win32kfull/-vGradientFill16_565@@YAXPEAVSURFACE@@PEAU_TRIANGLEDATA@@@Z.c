/*
 * XREFs of ?vGradientFill16_565@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02D2D30
 * Callers:
 *     <none>
 * Callees:
 *     <none>
      ...
      if ( *((_QWORD *)v3 + 9) <= (unsigned __int64)(v7 + v12) && v12 < v10 )
      {
        ...
        if ( v19 )
        {
          ...
          do
          {
            ++v22;
            v23 = v20++ & 3;
            v24 = *(_DWORD *)(0x1C0000000LL + 16LL * (v9 & 3) + 3367792 + 4 * v23);
            v25 = HIDWORD(v16);
            v16 += v33;
            v26 = Saturation16_5[(unsigned __int64)(v24 + ((unsigned int)v25 >> 11)) >> 16];
            v27 = HIDWORD(v15);
            v15 += v34;
            v28 = Saturation16_6[(unsigned __int64)(v24 + ((unsigned int)v27 >> 10)) >> 16] | (unsigned __int16)(v26 << 6);
            v29 = HIDWORD(v14);
            v14 += v35;
