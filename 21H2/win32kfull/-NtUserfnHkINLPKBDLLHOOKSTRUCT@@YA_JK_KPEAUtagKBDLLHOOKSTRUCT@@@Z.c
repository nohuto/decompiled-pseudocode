/*
 * XREFs of ?NtUserfnHkINLPKBDLLHOOKSTRUCT@@YA_JK_KPEAUtagKBDLLHOOKSTRUCT@@@Z @ 0x1C016C9A0
 * Callers:
...
__int64 __fastcall NtUserfnHkINLPKBDLLHOOKSTRUCT(unsigned int a1, unsigned __int64 a2, struct tagKBDLLHOOKSTRUCT *a3)
{
