/*
 * XREFs of ?ProcessInkFeedbackCommand@HideInkCursorProvider@@UEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C0250F80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AddActiveCommand@InkFeedbackProviderBase@@IEAAXPEAVActiveCommand@1@@Z @ 0x1C0250904 (-AddActiveCommand@InkFeedbackProviderBase@@IEAAXPEAVActiveCommand@1@@Z.c)
 ...
 *     ?FindActiveCommandByTargetPointerId@InkFeedbackProviderBase@@IEBAPEAVActiveCommand@1@W4INK_FEEDBACK_COMMAND@@I@Z @ 0x1C0250C14 (-FindActiveCommandByTargetPointerId@InkFeedbackProviderBase@@IEBAPEAVActiveCommand@1@W4INK_FEEDB.c)
...
__int64 __fastcall HideInkCursorProvider::ProcessInkFeedbackCommand(__int64 a1, int a2, int *a3, __int64 a4)
{
  ...
  __int64 v17; // r8
  __int64 v18; // r9
  struct InkFeedbackProviderBase::ActiveCommand *v19; // rsi
  __int64 v20; // r8
  __int64 v21; // r9
...
LABEL_22:
      ...
      v19 = (struct InkFeedbackProviderBase::ActiveCommand *)v15;
      if ( v15 )
      {
        *(_DWORD *)(v15 + 20) = 0;
        *(_QWORD *)(v15 + 24) = 0LL;
        ...
        *(_QWORD *)(v15 + 24) = KeGetCurrentThread();
        ...
        if ( (v7 & 0x80000000) != 0 )
          ...
          InkFeedbackProviderBase::AddActiveCommand((InkFeedbackProviderBase *)a1, v19, v20, v21);
        return v7;
      }
      v7 = -1073741801;
...
LABEL_30:
    ...
    v30 = v8;
    v31 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0326250, (unsigned __int8 *)dword_1C02EFE22, 0LL, 0LL, 3u, &v29);
    return v7;
  }
  if ( (unsigned int)dword_1C0326250 > 4 )
  {
