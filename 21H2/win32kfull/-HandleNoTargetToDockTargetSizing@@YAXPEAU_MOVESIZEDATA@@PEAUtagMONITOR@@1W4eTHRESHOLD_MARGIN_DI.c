/*
 * XREFs of ?HandleNoTargetToDockTargetSizing@@YAXPEAU_MOVESIZEDATA@@PEAUtagMONITOR@@1W4eTHRESHOLD_MARGIN_DIRECTION@@PEAK@Z @ 0x1C020B050
 * Callers:
 ...
 * Callees:
 *     ?IsSizingLEFT@@YAEH@Z @ 0x1C020B7CC (-IsSizingLEFT@@YAEH@Z.c)
 *     ?IsSizingRIGHT@@YAEH@Z @ 0x1C020B7EC (-IsSizingRIGHT@@YAEH@Z.c)
