/*
 * XREFs of Feature_1508323640__private_IsEnabledDeviceUsage @ 0x1C016A12C
 * Callers:
...
__int64 Feature_1508323640__private_IsEnabledDeviceUsage()
{
  if ( (Feature_1508323640__private_featureState & 0x10) != 0 )
    return Feature_1508323640__private_featureState & 1;
  else
    return Feature_1508323640__private_IsEnabledFallback((unsigned int)Feature_1508323640__private_featureState, 3LL);
}
