/*
 * XREFs of ?bRotate@BLTRECORD@@QEAAHAEAVDCOBJ@@0KE@Z @ 0x1C028B878
 * Callers:
 ...
 *     LongLongMult @ 0x1C016B998 (LongLongMult.c)
 ...
 *     ?vExtrema@BLTRECORD@@QEAAXXZ @ 0x1C028C4D4 (-vExtrema@BLTRECORD@@QEAAXXZ.c)
 *     ?vMirror@BLTRECORD@@QEAAXPEAU_POINTFIX@@@Z @ 0x1C028C56C (-vMirror@BLTRECORD@@QEAAXPEAU_POINTFIX@@@Z.c)
 *     ?vOrder@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1C028FFA0 (-vOrder@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
 */
