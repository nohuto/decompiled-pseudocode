/*
 * XREFs of ?MsgSQMCleanupProcessPair@@YAXPEAUtagMSGSQM_PROCESSPAIR@@@Z @ 0x1C0218B98
 * Callers:
 *     ?MsgSQMFreeProcessPair@@YAXPEAUtagMSGSQM_PROCESSPAIR@@@Z @ 0x1C0218D7C (-MsgSQMFreeProcessPair@@YAXPEAUtagMSGSQM_PROCESSPAIR@@@Z.c)
 * Callees:
 *     <none>
 */
...
void __fastcall MsgSQMCleanupProcessPair(struct tagMSGSQM_PROCESSPAIR ***a1)
{
  ...
  {
    v1 = *a1;
    if ( (*a1)[1] != (struct tagMSGSQM_PROCESSPAIR *)a1
      || (v2 = a1[1], *v2 != (struct tagMSGSQM_PROCESSPAIR *)a1)
      || (*v2 = (struct tagMSGSQM_PROCESSPAIR *)v1,
          v1[1] = (struct tagMSGSQM_PROCESSPAIR *)v2,
          v3 = a1[2],
          v3[1] != (struct tagMSGSQM_PROCESSPAIR *)(a1 + 2))
