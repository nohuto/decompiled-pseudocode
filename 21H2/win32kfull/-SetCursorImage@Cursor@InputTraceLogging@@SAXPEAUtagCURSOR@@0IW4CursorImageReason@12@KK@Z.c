/*
 * XREFs of ?SetCursorImage@Cursor@InputTraceLogging@@SAXPEAUtagCURSOR@@0IW4CursorImageReason@12@KK@Z @ 0x1C00B2F40
 * Callers:
        ...
        int a6)
{
  ...
  {
    result = (_UNKNOWN **)tlgKeywordOn(&dword_1C032BE20, 8LL);
    if ( (_BYTE)result )
    {
