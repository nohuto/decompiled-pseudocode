/*
 * XREFs of ?MenuItemState@@YAKAEBV?$SmartObjStackRef@UtagMENU@@@@IKKPEAPEAUtagMENU@@@Z @ 0x1C00BC6A4
 * Callers:
...
__int64 __fastcall MenuItemState(__int64 a1, unsigned int a2, int a3, int a4, __int64 *a5)
{
  __int64 v7; // rcx
  _QWORD *v9; // rax
  __int64 v10; // r8
