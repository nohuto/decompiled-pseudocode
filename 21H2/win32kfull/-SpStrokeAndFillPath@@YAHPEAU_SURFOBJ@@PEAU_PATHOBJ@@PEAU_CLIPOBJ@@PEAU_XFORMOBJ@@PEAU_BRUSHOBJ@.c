/*
 * XREFs of ?SpStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C0142310
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?PATHOBJ_vOffset@@YAXPEAU_PATHOBJ@@JJ@Z @ 0x1C0146318 (-PATHOBJ_vOffset@@YAXPEAU_PATHOBJ@@JJ@Z.c)
        ...
        FLONG a10)
{
  ...
  LINEATTRS *v32; // [rsp+80h] [rbp-80h]
  XFORMOBJ *v33; // [rsp+88h] [rbp-78h]
  HDEV hdev; // [rsp+90h] [rbp-70h] BYREF
  POINTL *v35; // [rsp+98h] [rbp-68h]
  BRUSHOBJ *v36; // [rsp+A0h] [rbp-60h]
  BRUSHOBJ *v37; // [rsp+A8h] [rbp-58h]
...
LABEL_12:
        v11 = v33;
        if ( !(unsigned int)OffStrokeAndFillPath(
                              (__int64 (__fastcall *)(SURFOBJ *, struct _PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, LINEATTRS *, BRUSHOBJ *, POINTL *, MIX, FLONG))v21,
                              (int *)&v31,
                              v14,
                              this,
                              v28,
