/*
 * XREFs of ?xxxDiscardPointerWindowFrameMessages@@YAHPEAUtagTHREADINFO@@_K@Z @ 0x1C01EC128
 * Callers:
...
__int64 __fastcall xxxDiscardPointerWindowFrameMessages(struct tagTHREADINFO *a1, unsigned __int64 a2)
{
  ...
  unsigned int v22; // [rsp+B8h] [rbp+58h] BYREF

  LODWORD(v3) = 0;
  v22 = 0;
  v21 = 0;
  HwndReference = CTouchProcessor::GetHwndReference(gpTouchProcessor, a2, &v21, &v22);
  ...
  if ( result )
  {
    ...
    if ( ((*((_BYTE *)a1 + 680) | *(_BYTE *)(**((_QWORD **)a1 + 58) + 16LL)) & 0x10) != 0 )
    {
      ...
      if ( v7 <= 0xFFFFFFFF && (unsigned int)(v7 - 1) <= 0x270FFFE )
        v5 = Win32AllocPoolZInit((unsigned int)v7, 1735422805LL);
    }
    else
    {
      v6 = 0;
    ...
    if ( v11 )
    {
      ...
      while ( v3 );
      if ( v8 )
        CTouchProcessor::UpdateThreadPointerList(gpTouchProcessor, (struct tagTHREADINFO *)((char *)a1 + 1112), v21);
    }
    if ( v9 )
    {
      v19 = 0LL;
