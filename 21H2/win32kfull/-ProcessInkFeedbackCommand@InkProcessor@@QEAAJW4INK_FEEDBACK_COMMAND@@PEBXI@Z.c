/*
 * XREFs of ?ProcessInkFeedbackCommand@InkProcessor@@QEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C024F96C
 * Callers:
...
__int64 __fastcall InkProcessor::ProcessInkFeedbackCommand(__int64 a1)
{
  ...
  else if ( (unsigned int)dword_1C032B288 > 2 )
  {
    ...
    v13 = 4;
    v12 = &v9;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032B288, (unsigned __int8 *)dword_1C02F2FAC, 0LL, 0LL, 3u, &v11);
  }
  return v3;
}
