/*
 * XREFs of ?ProcessInkFeedbackCommand@InkProcessor@@QEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C024CEAC
 * Callers:
...
__int64 __fastcall InkProcessor::ProcessInkFeedbackCommand(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( *(_BYTE *)(a1 + 8) )
    {
      ...
      v3 = v6;
      if ( v6 < 0 && (unsigned int)dword_1C0326250 > 2 )
      {
        v13 = 0;
        LODWORD(v8) = v6;
        v12 = 4;
  ...
  else if ( (unsigned int)dword_1C0326250 > 2 )
  {
    ...
    v12 = 4;
    v11 = &v8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0326250, (unsigned __int8 *)dword_1C02EFE22, 0LL, 0LL, 3u, &v10);
  }
  return v3;
}
