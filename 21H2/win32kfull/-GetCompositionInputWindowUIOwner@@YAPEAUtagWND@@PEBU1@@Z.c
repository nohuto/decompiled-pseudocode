/*
 * XREFs of ?GetCompositionInputWindowUIOwner@@YAPEAUtagWND@@PEBU1@@Z @ 0x1C023A8B0
 * Callers:
 ...
 *     EditionGetCompositionInputWindowUIOwner @ 0x1C0210720 (EditionGetCompositionInputWindowUIOwner.c)
 * Callees:
