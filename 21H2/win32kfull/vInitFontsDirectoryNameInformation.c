 ...
 *     ?QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z @ 0x1C00A8B94 (-QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z.c)
 */
...
int vInitFontsDirectoryNameInformation()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (int)v0 >= 0 )
  {
    ...
    if ( v4 )
    {
      if ( (unsigned int)bAppendSysDirectory(v4, &word_1C02E597C, v5) )
      {
        v6 = -1LL;
        do
          ++v6;
