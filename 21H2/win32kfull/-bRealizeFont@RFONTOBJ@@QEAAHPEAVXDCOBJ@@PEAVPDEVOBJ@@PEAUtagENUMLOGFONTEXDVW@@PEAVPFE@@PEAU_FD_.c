/*
 * XREFs of ?bRealizeFont@RFONTOBJ@@QEAAHPEAVXDCOBJ@@PEAVPDEVOBJ@@PEAUtagENUMLOGFONTEXDVW@@PEAVPFE@@PEAU_FD_XFORM@@QEAU_POINTL@@KKHHK@Z @ 0x1C009D9E0
 * Callers:
 ...
 *     UmfdQueryFontCapsEx @ 0x1C009E744 (UmfdQueryFontCapsEx.c)
 ...
 *     ?ulSimpleDeviceOrientation@@YAKAEAVRFONTOBJ@@@Z @ 0x1C012E060 (-ulSimpleDeviceOrientation@@YAKAEAVRFONTOBJ@@@Z.c)
...
LABEL_22:
  ...
  *(_DWORD *)(*(_QWORD *)this + 656LL) = a10;
  ...
  if ( (struct PDEV *)v43 == qword_1C0341AF0 )
  {
