/*
 * XREFs of ?ImeCanDestroyDefIMEforChild@@YAHPEAUtagWND@@0@Z @ 0x1C0082AF4
 * Callers:
 *     xxxDestroyWindow @ 0x1C0062330 (xxxDestroyWindow.c)
 * Callees:
 *     _GetDesktopWindow @ 0x1C006FF60 (_GetDesktopWindow.c)
 *     unsafe_cast_fnid_or_class_to_PIMEWND @ 0x1C0082CB8 (unsafe_cast_fnid_or_class_to_PIMEWND.c)
 *     ?IsChildSameThread@@YAHPEAUtagWND@@0@Z @ 0x1C01DD7B4 (-IsChildSameThread@@YAHPEAUtagWND@@0@Z.c)
 */
