/*
 * XREFs of ?CreatePointerDeviceProcessEvent@@YAHKHEPEAGPEAPEAX@Z @ 0x1C01181A4
 * Callers:
 *     CreatePointerDeviceProcessEvents @ 0x1C0118148 (CreatePointerDeviceProcessEvents.c)
 * Callees:
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C00EFFE4 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
        ...
        void **a5)
{
  ...
  struct _SID_IDENTIFIER_AUTHORITY v25; // [rsp+90h] [rbp-70h] BYREF
    ...
    if ( RtlInitializeSid(v10, &IdentifierAuthority, 1u) >= 0 )
    {
      ...
      if ( v12 )
      {
        *RtlSubAuthoritySid(v12, 0) = 0;
        if ( RtlInitializeSid(v13, &v25, 1u) >= 0 )
        {
          ...
          if ( v16 )
          {
            ...
            if ( RtlCreateAcl(v16 + 5, v15, 2u) >= 0
              ...
              && StringCchPrintfW(
                   SourceString,
                   0x100uLL,
                   (size_t *)L"%ws\\%ld\\BaseNamedObjects\\%ws",
                   L"\\Sessions",
                   gSessionId,
                   a4) >= 0 )
            {
