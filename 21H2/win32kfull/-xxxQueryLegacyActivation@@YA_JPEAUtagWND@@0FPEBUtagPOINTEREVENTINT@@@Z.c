/*
 * XREFs of ?xxxQueryLegacyActivation@@YA_JPEAUtagWND@@0FPEBUtagPOINTEREVENTINT@@@Z @ 0x1C01EC71C
 * Callers:
        ...
        const struct tagPOINTEREVENTINT *a4)
{
  ...
  *(_DWORD *)(gptiCurrent + 768LL) = HIDWORD(v20);
  ...
  v12 = xxxSendTransformableMessageTimeout(BugCheckParameter2, 0x21u, v11, v6 | 0x2460000, 0, 0, 0LL, 1, 1);
  v13 = v18;
