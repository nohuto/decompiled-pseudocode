/*
 * XREFs of ?xxxProcessDesktopRecalc@@YAXPEAUtagASYNCDTOPRECALC@@@Z @ 0x1C0040A20
 * Callers:
...
LABEL_11:
            ...
            if ( v12 )
            {
              ...
              *(_QWORD *)(ThreadWin32Thread + 416) = v27;
              v27[1] = v9;
              HMLockObject(v9);
              Prop = (struct tagRECT *)GetProp(v9, (unsigned __int16)WPP_MAIN_CB.DeviceQueue.Type, 1LL);
              if ( v4 )
              {
