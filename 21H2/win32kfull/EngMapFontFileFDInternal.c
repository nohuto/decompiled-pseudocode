/*
 * XREFs of EngMapFontFileFDInternal @ 0x1C00A4F5C
 * Callers:
 *     ?MapFontFiles@@YA_NKPEAPEAU_FONTFILEVIEW@@PEAPEAXPEAK@Z @ 0x1C00A4EDC (-MapFontFiles@@YA_NKPEAPEAU_FONTFILEVIEW@@PEAPEAXPEAK@Z.c)
 *     EngMapFontFileFD @ 0x1C028A2F0 (EngMapFontFileFD.c)
 *     ?TryMapAllFileViews@UmfdClientSideFileViewMapper@@AEAAIXZ @ 0x1C02A7FE4 (-TryMapAllFileViews@UmfdClientSideFileViewMapper@@AEAAIXZ.c)
...
__int64 __fastcall EngMapFontFileFDInternal(__int64 a1, _QWORD *a2, _DWORD *a3, int a4)
{
  ...
  void *v25[10]; // [rsp+70h] [rbp-69h] BYREF
...
LABEL_17:
              ...
              (unsigned __int64 *)&v25[9]) >= 0 )
  {
    ...
    {
      v17 = bMapRoutine(a1, v25, 1LL, (unsigned int)v22);
      v8 = v17;
    }
    GreReleaseFastMutex(ghfmMemory);
    if ( !v17 )
      vUnmapFileFD((struct _FILEVIEW *)v25, 1u);
    goto LABEL_17;
  }
