/*
 * XREFs of ?bGetRealizedBrush@@YAHPEAVBRUSH@@PEAVEBRUSHOBJ@@P6AHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@33PEAU_XLATEOBJ@@K@Z@Z @ 0x1C00CFD3C
 * Callers:
 ...
 *     BRUSHOBJ_pvGetRbrush @ 0x1C026D370 (BRUSHOBJ_pvGetRbrush.c)
 * Callees:
 ...
 *     ?bIsCMYKColor@EBRUSHOBJ@@QEBAHXZ @ 0x1C026D1A0 (-bIsCMYKColor@EBRUSHOBJ@@QEBAHXZ.c)
 *     ?vAltCheckLock@SURFREF@@QEAAXPEAUHSURF__@@@Z @ 0x1C026D20C (-vAltCheckLock@SURFREF@@QEAAXPEAUHSURF__@@@Z.c)
 *     ?vAltLock@SURFREF@@QEAAXPEAUHSURF__@@@Z @ 0x1C026D23C (-vAltLock@SURFREF@@QEAAXPEAUHSURF__@@@Z.c)
