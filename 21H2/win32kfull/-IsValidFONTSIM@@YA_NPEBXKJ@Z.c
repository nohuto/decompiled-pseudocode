/*
 * XREFs of ?IsValidFONTSIM@@YA_NPEBXKJ@Z @ 0x1C02A8F9C
 * Callers:
 *     ?IsValidIFIMETRICS@@YA_NPEBU_IFIMETRICS@@K@Z @ 0x1C02A9010 (-IsValidIFIMETRICS@@YA_NPEBU_IFIMETRICS@@K@Z.c)
 * Callees:
 *     ?IsValidFONTDIFF@@YA_NPEBXKJ@Z @ 0x1C02A8F60 (-IsValidFONTDIFF@@YA_NPEBXKJ@Z.c)
 */
