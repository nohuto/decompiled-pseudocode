/*
 * XREFs of ?xxxSetForegroundThreadWithWindowHint@@YAXPEAUtagTHREADINFO@@PEAUtagWND@@@Z @ 0x1C0034BF4
 * Callers:
 ...
 *     xxxSetForegroundThread @ 0x1C01D2BB0 (xxxSetForegroundThread.c)
 * Callees:
