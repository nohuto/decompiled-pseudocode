/*
 * XREFs of ?TransitionForegroundPriority@PriorityBoostCUI@@YAXPEAUtagTHREADINFO@@PEAUtagWND@@@Z @ 0x1C00354F4
 * Callers:
 ...
 *     ?GetNearestCoreWindowAncestor@CoreWindowProp@@SAPEAUtagWND@@PEBU2@@Z @ 0x1C0037718 (-GetNearestCoreWindowAncestor@CoreWindowProp@@SAPEAUtagWND@@PEBU2@@Z.c)
        ...
        struct tagWND *a3)
{
  ...
  v7 = CoreWindowProp::GetNearestCoreWindowAncestor(qword_1C033D300);
  ...
  if ( qword_1C033D300 != a2 )
  {
    if ( qword_1C033D300 )
      HMAssignmentUnlock(&qword_1C033D300);
    if ( a2 )
    {
      v10[0] = &qword_1C033D300;
      v10[1] = a2;
