/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C01ED250
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x1C01ED30C (RtlUnicodeStringValidateSrcWorker.c)
 */
