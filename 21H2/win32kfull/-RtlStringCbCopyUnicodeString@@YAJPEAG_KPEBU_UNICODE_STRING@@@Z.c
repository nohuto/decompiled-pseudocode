/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C016C26C
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x1C01E79D0 (RtlUnicodeStringValidateSrcWorker.c)
 */
