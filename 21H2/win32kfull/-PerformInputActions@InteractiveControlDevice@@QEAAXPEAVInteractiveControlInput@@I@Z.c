/*
 * XREFs of ?PerformInputActions@InteractiveControlDevice@@QEAAXPEAVInteractiveControlInput@@I@Z @ 0x1C02545EC
 * Callers:
  ...
  if ( *((_QWORD *)this + 43) != -1LL )
  {
    ...
    if ( (a3 & 0x400) != 0 || (a3 & 0x1000) != 0 )
    {
      ...
      if ( v13 )
      {
        v14 = *((_QWORD *)this + 43);
        if ( v14 != -1 )
          RIMUpdatePointerDeviceDeadzoneOrigin(v13 + 88, v14, *((_QWORD *)a2 + 8));
      }
      if ( (a3 & 0x400) != 0 )
        goto LABEL_20;
    }
...
LABEL_20:
      ...
      if ( v15 )
      {
        v16 = *((_QWORD *)this + 43);
        if ( v16 != -1 )
          RIMActivatePointerDeviceDeadzone(v15 + 88, v16, (*((_DWORD *)a2 + 18) >> 1) & 1);
      }
    }
  }
}
