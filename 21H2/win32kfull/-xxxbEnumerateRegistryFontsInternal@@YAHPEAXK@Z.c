/*
 * XREFs of ?xxxbEnumerateRegistryFontsInternal@@YAHPEAXK@Z @ 0x1C00EEE2C
 * Callers:
 ...
 *     ?RtlStringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1C01D0228 (-RtlStringCchCatW@@YAJPEAG_KPEBG@Z.c)
 */
  ...
  if ( result )
  {
    ...
    for ( i = 0; ; ++i )
    {
      ...
      if ( v6 != -2147483643 && v6 != -1073741789 )
        goto LABEL_5;
      ResultLength += 10;
      v10 = Win32AllocPoolZInit(ResultLength, 1919972181LL);
      v11 = (void *)v10;
      if ( v10 )
      {
