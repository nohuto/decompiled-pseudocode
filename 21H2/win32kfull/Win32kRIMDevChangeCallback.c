/*
 * XREFs of Win32kRIMDevChangeCallback @ 0x1C012D670
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsPublicPointerDevice @ 0x1C01EE8E4 (IsPublicPointerDevice.c)
 *     UpdatePointerDeviceCount @ 0x1C01EEDC8 (UpdatePointerDeviceCount.c)
