/*
 * XREFs of NtUserSetBrokeredForeground @ 0x1C00D7200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetBrokeredForeground(__int64 a1)
{
  ...
  if ( !v5
    ...
    || GetProp((__int64)v6, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Flink), 1LL) )
  {
    goto LABEL_17;
  }
...
LABEL_18:
  ...
  v2 = InternalSetProp((__int64)v6, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Flink), gptiCurrent, 5u);
LABEL_13:
  UserAtomicCheck::~UserAtomicCheck((UserAtomicCheck *)&v12);
