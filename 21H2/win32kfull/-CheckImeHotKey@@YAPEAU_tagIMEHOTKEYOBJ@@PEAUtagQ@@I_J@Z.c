/*
 * XREFs of ?CheckImeHotKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAUtagQ@@I_J@Z @ 0x1C00F5400
 * Callers:
...
struct _tagIMEHOTKEYOBJ *__fastcall CheckImeHotKey(struct tagQ *a1, unsigned int a2, int a3)
{
  int v4; // edi
  ...
  if ( v4 )
  {
    ...
    else if ( dword_1C03363A0 != (*((_DWORD *)result + 4) & 7) )
    {
      return 0LL;
    }
    dword_1C03363A0 = 0;
