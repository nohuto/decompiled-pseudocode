/*
 * XREFs of RawInputThread @ 0x1C0009A50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InitTimerPowerSaving@@YAXXZ @ 0x1C00097D0 (-InitTimerPowerSaving@@YAXXZ.c)
 *     RitTakeOver @ 0x1C0009838 (RitTakeOver.c)
 ...
 *     ?GetRITWakeReason@@YAHPEAK@Z @ 0x1C000A558 (-GetRITWakeReason@@YAHPEAK@Z.c)
 ...
 *     ?SetWindowArrangementHotKeys@@YAXXZ @ 0x1C0030724 (-SetWindowArrangementHotKeys@@YAXXZ.c)
 *     ?SetWinlogonHotKeys@@YAXXZ @ 0x1C0030778 (-SetWinlogonHotKeys@@YAXXZ.c)
...
void __fastcall RawInputThread(__int64 *a1)
{
  ...
  *(_DWORD *)(gpsi + 2196LL) = 0;
  ...
  if ( !InkProcessor::s_pInstance )
  {
    ...
    if ( !v5 && (unsigned int)dword_1C032B288 > 2 )
    {
      v39 = -1073741801;
      v60 = &v39;
      v61 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C032B288, (int)&dword_1C02F2FAC, 0, 0, 3u, &v59);
    }
  }
...
LABEL_144:
      ...
      else
      {
        if ( ((v20 - 1) & 0xFFFFFFFD) == 0 )
        {
          ...
          UserSessionSwitchLeaveCrit();
          v21 = dword_1C033D5E0;
          if ( gnRetryReadInput != dword_1C033D5E0 )
        ...
        while ( 1 )
        {
          while ( 1 )
          {
            ...
            if ( (unsigned int)dword_1C0330B20 > 4
              && (qword_1C0330B30 & 2) != 0
              && (qword_1C0330B38 & 2) == qword_1C0330B38 )
            {
              switch ( v37[0] )
              {
                case 1u:
      ...
      if ( v22 == 64 )
      {
          ...
          && (qword_1C032B3F0 & 0x200000000000LL) == qword_1C032B3F0 )
        {
          ...
          _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapperByVal<4>>(
            (unsigned int)&dword_1C032B3D8,
            (unsigned int)&unk_1C02F3569,
            v29,
            v30,
            (__int64)&v51,
            (__int64)&v42);
