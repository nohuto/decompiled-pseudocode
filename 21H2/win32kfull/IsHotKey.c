...
struct tagHOTKEY * near *__fastcall IsHotKey(int a1, int a2)
{
  ...
  if ( (*((_DWORD *)*i + 122) & 0xC) != 0 )
    return i;
  if ( GetDesktopView(*((_QWORD *)*i + 53), grpdeskRitInput) )
  {
    if ( ((_BYTE)i[3] & 0xB) == 0
      && gpqForeground
      && (unsigned int)(a2 - 173) > 6
      && a2 != 7
      && !(unsigned __int8)CheckAccess(*((_QWORD *)*i + 53) + 880LL, gpqForeground + 428LL) )
    {
      EtwTraceUIPIInputError(*i, 0LL, gpqForeground, *(_QWORD *)(gpqForeground + 428LL), 7);
