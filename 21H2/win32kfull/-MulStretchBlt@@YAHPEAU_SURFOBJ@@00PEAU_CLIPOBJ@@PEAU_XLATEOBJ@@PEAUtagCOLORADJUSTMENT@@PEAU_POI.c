/*
 * XREFs of ?MulStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02A43A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_103:
        ...
        v40 = v63;
        v65 = v63;
        EXLATEOBJ::vAltUnlock((EXLATEOBJ *)&v71, (__int64)v42);
