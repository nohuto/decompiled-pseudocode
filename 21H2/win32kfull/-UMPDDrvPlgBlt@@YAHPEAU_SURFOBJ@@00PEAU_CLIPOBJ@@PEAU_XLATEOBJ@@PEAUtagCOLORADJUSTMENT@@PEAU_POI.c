/*
 * XREFs of ?UMPDDrvPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C02A9600
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  _QWORD v47[14]; // [rsp+130h] [rbp+20h] BYREF
  ...
  v47[7] = a5;
  v21 = 0;
  if ( (unsigned int)UMPDOBJ::pso(v17, (UMPDOBJ *)((char *)v17 + 64), (struct _SURFOBJ **)&v47[3]) )
  {
    if ( (unsigned int)UMPDOBJ::pso(v17, (UMPDOBJ *)((char *)v17 + 80), (struct _SURFOBJ **)&v47[4]) )
    {
      if ( (unsigned int)UMPDOBJ::pso(v17, (UMPDOBJ *)((char *)v17 + 96), (struct _SURFOBJ **)&v47[5]) )
      {
        if ( (unsigned int)UMPDOBJ::ThunkDDIOBJ(v17, (UMPDOBJ *)((char *)v17 + 112), (const void **)&v47[6], 0x18u, 0LL) )
        {
          if ( (unsigned int)UMPDOBJ::pxlo(v17, (struct _XLATEOBJ **)&v47[7]) )
          {
            if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v47[8], 0x18u) )
            {
              if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v47[9], 8u) )
              {
                if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v47[10], 0x18u) )
                {
                  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v47[11], 0x10u) )
                  {
                    if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v17, (const void **)&v47[12], 8u) )
                    {
                      LODWORD(Size) = 4;
