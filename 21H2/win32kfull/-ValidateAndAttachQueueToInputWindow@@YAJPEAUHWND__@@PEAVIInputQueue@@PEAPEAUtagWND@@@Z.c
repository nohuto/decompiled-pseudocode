/*
 * XREFs of ?ValidateAndAttachQueueToInputWindow@@YAJPEAUHWND__@@PEAVIInputQueue@@PEAPEAUtagWND@@@Z @ 0x1C010AD38
 * Callers:
 *     UserValidateAndAttachQueueToInputWindowApiExt @ 0x1C010AD20 (UserValidateAndAttachQueueToInputWindowApiExt.c)
 * Callees:
