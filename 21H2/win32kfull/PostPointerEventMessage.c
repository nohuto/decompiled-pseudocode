/*
 * XREFs of PostPointerEventMessage @ 0x1C01EE990
 * Callers:
 *     PostDeviceNotification @ 0x1C0108AA0 (PostDeviceNotification.c)
 *     PostPointerDeviceInRangeMessage @ 0x1C01EE950 (PostPointerDeviceInRangeMessage.c)
 *     PostPointerDeviceOutOfRangeMessage @ 0x1C01EE970 (PostPointerDeviceOutOfRangeMessage.c)
 * Callees:
