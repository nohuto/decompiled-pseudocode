/*
 * XREFs of NtGdiEngAlphaBlend @ 0x1C02B2650
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z @ 0x1C02B1794 (--$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z.c)
