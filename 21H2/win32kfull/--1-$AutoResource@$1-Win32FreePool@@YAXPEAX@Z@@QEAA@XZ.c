/*
 * XREFs of ??1?$AutoResource@$1?Win32FreePool@@YAXPEAX@Z@@QEAA@XZ @ 0x1C0014A8C
 * Callers:
...
__int64 __fastcall AutoResource<&void Win32FreePool(void *)>::~AutoResource<&void Win32FreePool(void *)>(__int64 *a1)
{
  __int64 v2; // rcx
  __int64 result; // rax
