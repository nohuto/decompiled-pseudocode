/*
 * XREFs of xxxLoadHmodIndex @ 0x1C002067C
 * Callers:
 ...
 *     UserGetLastStatus @ 0x1C012D0F4 (UserGetLastStatus.c)
 *     __security_check_cookie @ 0x1C0165D70 (__security_check_cookie.c)
 *     ??1?$CLockDomainExclusiveInUserCrit@VDLT_CLIENTLIB@@@@QEAA@XZ @ 0x1C02431C4 (--1-$CLockDomainExclusiveInUserCrit@VDLT_CLIENTLIB@@@@QEAA@XZ.c)
 */
