/*
 * XREFs of ?TabletButtonHandler@@YAXPEAUDEVICEINFO@@@Z @ 0x1C01D9160
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v5 )
    {
      Usages = HidP_GetUsages(
                 ...
                 *(PCHAR *)(*((_QWORD *)a1 + 58) + 24LL),
                 ReportLength);
      if ( dword_1C03341EC != 10 )
      {
        if ( Usages >= 0 && (v13 = 0LL, UsageLength[0]) )
        {
          while ( v5[v13] - 1 != dword_1C03341EC )
          {
