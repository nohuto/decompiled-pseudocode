/*
 * XREFs of pDCIAdjClr @ 0x1C001C210
 * Callers:
 ...
 *     CompareMemory @ 0x1C0127E9C (CompareMemory.c)
 *     __security_check_cookie @ 0x1C0165D70 (__security_check_cookie.c)
 *     GenCMYMaskXlate @ 0x1C0262544 (GenCMYMaskXlate.c)
 *     TintAngle @ 0x1C026277C (TintAngle.c)
 */
...
__int64 __fastcall pDCIAdjClr(__int64 a1, __m128i *a2, char **a3, unsigned int a4, __int16 a5, int a6, _DWORD *a7)
{
  ...
  if ( a1 && (v11 = a1 + 40, *(_DWORD *)(a1 + 40) == 1414021956) )
  {
    ...
    {
      dwABPreMul = 0;
      v90 = (unsigned int *)&unk_1C0334424;
      for ( i = 1; i < 0x100; ++i )
      {
        v92 = (i - 16777217) / i;
        *v90++ = v92;
