/*
 * XREFs of ?bWiden@EPATHOBJ@@QEAAHAEAV1@PEAU_XFORMOBJ@@PEAU_LINEATTRS@@@Z @ 0x1C013F6DC
 * Callers:
 ...
 * Callees:
 *     ??1WIDENER@@QEAA@XZ @ 0x1C013F7F8 (--1WIDENER@@QEAA@XZ.c)
 *     ?vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z @ 0x1C013F848 (-vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z.c)
