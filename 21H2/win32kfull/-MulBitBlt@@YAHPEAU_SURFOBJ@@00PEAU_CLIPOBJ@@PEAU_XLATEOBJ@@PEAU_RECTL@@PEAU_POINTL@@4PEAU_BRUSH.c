/*
 * XREFs of ?MulBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C02A1D40
 * Callers:
 ...
 *     ?vRestore@MSURF@@QEAAXXZ @ 0x1C02A7240 (-vRestore@MSURF@@QEAAXXZ.c)
