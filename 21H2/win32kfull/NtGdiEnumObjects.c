/*
 * XREFs of NtGdiEnumObjects @ 0x1C02B75C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_17:
      ...
      else
      {
        ...
        v11 = (char *)&unk_1C03310A0 + 4 * v9;
        v12 = a2 - 1;
        if ( v12 )
        {
          if ( v12 == 1 )
          {
            for ( i = (char *)&unk_1C03310A0; i < v11; i += 4 )
            {
              *v4 = 0;
              v4[1] = *(_DWORD *)i;
              *((_QWORD *)v4 + 1) = 0LL;
            ...
            for ( j = (unsigned int *)&gaulHatchStyles; j < dword_1C0331080; ++j )
            {
              for ( k = (char *)&unk_1C03310A0; k < v11; k += 4 )
              {
                *v4 = 2;
                v4[1] = *(_DWORD *)k;
                *((_QWORD *)v4 + 1) = *j;
        ...
        {
          for ( m = dword_1C0331080; m < dword_1C0331094; ++m )
          {
            for ( n = (char *)&unk_1C03310A0; n < v11; n += 4 )
            {
              *(_QWORD *)(v4 + 1) = 0LL;
              *v4 = *m;
              v4[3] = *(_DWORD *)n;
