/*
 * XREFs of ?CreateMoveSizeData@MOVESIZEDATA@@SAPEAU1@PEAUtagWND@@@Z @ 0x1C024A8C0
 * Callers:
...
struct MOVESIZEDATA *__fastcall MOVESIZEDATA::CreateMoveSizeData(struct tagWND *a1)
{
  ...
  if ( (unsigned int)Feature_1133322554__private_IsEnabled() && (*(_DWORD *)(gptiCurrent + 488LL) & 1) != 0 )
    return 0LL;
  v3 = Win32AllocPoolWithQuotaZInit(336LL, 1936552789LL);
  v4 = v3;
  if ( v3 )
  {
    v6[1] = a1;
