/*
 * XREFs of ?bIFIMetricsToLogFontW2@@YAHAEAVDCOBJ@@PEAUtagENUMLOGFONTEXW@@PEAU_IFIMETRICS@@VEFLOATEXT@@@Z @ 0x1C000F050
 * Callers:
        ...
        int a4)
{
  ...
  float v38; // [rsp+B0h] [rbp+30h] BYREF
  float v39; // [rsp+C0h] [rbp+40h] BYREF
  ...
  if ( (*(_DWORD *)(v37[0] + 48LL) & 0x3000010) != 0 )
  {
    ...
    v10 = (unsigned __int8)(SLODWORD(v38) >> 23);
    if ( v10 <= 0x9E )
    {
      ...
      v9 = -((unsigned __int64)(v12 + 0x80000000LL) >> 32);
      if ( v38 >= 0.0 )
        v9 = v13;
    }
    ...
    v15 = (unsigned __int8)(SLODWORD(v38) >> 23);
    if ( v15 <= 0x9E )
    {
