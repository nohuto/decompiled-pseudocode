/*
 * XREFs of ?zzzSetCursorPos@@YA_NHH@Z @ 0x1C0013324
 * Callers:
...
LABEL_15:
      LOBYTE(v5) = 2;
      WPP_RECORDER_SF_(v6, v5, 20, v10, (__int64)&WPP_bed3dcb17af239cd653be8870764ac10_Traceguids);
      return 0;
    }
    return 0;
  }
  v6 = *((_QWORD *)CurrentLogicalCursorThread + 57);
  ...
  if ( (unsigned __int8)IsSpatialDelegationEnabledForThread(gptiCurrent) )
  {
    ...
    {
      LOBYTE(v11) = 2;
      WPP_RECORDER_SF_(v12, v11, 20, 13, (__int64)&WPP_bed3dcb17af239cd653be8870764ac10_Traceguids);
    }
  }
  else
  {
