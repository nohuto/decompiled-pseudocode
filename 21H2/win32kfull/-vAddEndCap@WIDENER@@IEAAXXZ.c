/*
 * XREFs of ?vAddEndCap@WIDENER@@IEAAXXZ @ 0x1C013F400
 * Callers:
 ...
 *     ?vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z @ 0x1C02CF72C (-vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z.c)
