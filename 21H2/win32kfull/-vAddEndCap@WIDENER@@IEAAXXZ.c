/*
 * XREFs of ?vAddEndCap@WIDENER@@IEAAXXZ @ 0x1C012EE88
 * Callers:
 ...
 *     ?vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z @ 0x1C01705A8 (-vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z.c)
