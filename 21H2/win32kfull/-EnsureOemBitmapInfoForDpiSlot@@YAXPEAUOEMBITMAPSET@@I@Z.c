/*
 * XREFs of ?EnsureOemBitmapInfoForDpiSlot@@YAXPEAUOEMBITMAPSET@@I@Z @ 0x1C01074EC
 * Callers:
 ...
 * Callees:
 *     ?ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z @ 0x1C0107670 (-ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z.c)
