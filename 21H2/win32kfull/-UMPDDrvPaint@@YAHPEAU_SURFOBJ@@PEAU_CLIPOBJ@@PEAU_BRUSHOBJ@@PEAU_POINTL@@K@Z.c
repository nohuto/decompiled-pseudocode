/*
 * XREFs of ?UMPDDrvPaint@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@K@Z @ 0x1C02A9400
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  if ( v20 )
  {
          ...
          (v15 = v11) != 0) )
    {
      ...
      v22[5] = a2;
      v22[7] = a3;
      if ( !(unsigned int)UMPDOBJ::pso(v10, (UMPDOBJ *)((char *)v10 + 64), (struct _SURFOBJ **)&v22[3])
