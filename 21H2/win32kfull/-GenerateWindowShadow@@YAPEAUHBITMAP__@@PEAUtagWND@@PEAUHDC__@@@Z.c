/*
 * XREFs of ?GenerateWindowShadow@@YAPEAUHBITMAP__@@PEAUtagWND@@PEAUHDC__@@@Z @ 0x1C013E53C
 * Callers:
 ...
 *     ?DrawRoundedRectangularShadow@@YAXPEAXJJHJ@Z @ 0x1C013EAC8 (-DrawRoundedRectangularShadow@@YAXPEAXJJHJ@Z.c)
 *     ?DrawRegionalShadow@@YAXPEAXJJ@Z @ 0x1C014207C (-DrawRegionalShadow@@YAXPEAXJJ@Z.c)
