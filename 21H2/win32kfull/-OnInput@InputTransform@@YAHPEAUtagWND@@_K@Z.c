/*
 * XREFs of ?OnInput@InputTransform@@YAHPEAUtagWND@@_K@Z @ 0x1C01102C0
 * Callers:
 ...
 *     InputTransformOnInput @ 0x1C01F5920 (InputTransformOnInput.c)
 *     SetManipulationInputTargetTransform @ 0x1C01F5950 (SetManipulationInputTargetTransform.c)
 * Callees:
...
LABEL_6:
    ...
    if ( InputTraceLogging::Enabled(0)
      && (unsigned int)dword_1C0330B20 > 5
      && (qword_1C0330B30 & 4) != 0
      && (qword_1C0330B38 & 4) == qword_1C0330B38 )
    {
      v37 = *((_DWORD *)v6 + 21);
      v39 = *((_DWORD *)v6 + 20);
      v40 = *((_DWORD *)v6 + 19);
