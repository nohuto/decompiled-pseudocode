/*
 * XREFs of ?bLoadDeviceFontTable@PFFMEMOBJ@@QEAAHPEAVPDEVOBJ@@@Z @ 0x1C02BA244
 * Callers:
 ...
 *     ?bAllocPFEData@PFFMEMOBJ@@AEAAHK@Z @ 0x1C000D118 (-bAllocPFEData@PFFMEMOBJ@@AEAAHK@Z.c)
...
LABEL_14:
    ...
    if ( ++v9 > v6 )
    {
      FHMEMOBJ::FHMEMOBJ((__int64 **)v16, (__int64 *)(*(_QWORD *)this + 104LL), 0, v6);
      FHMEMOBJ::FHMEMOBJ((__int64 **)v16, (__int64 *)(*(_QWORD *)this + 112LL), 1, v6);
      FHMEMOBJ::FHMEMOBJ((__int64 **)v16, (__int64 *)(*(_QWORD *)this + 120LL), 2, v6);
      return 1;
    }
  }
  EngSetLastError(0x3EBu);
...
LABEL_22:
    if ( v11 )
    {
      v13 = *(void (__fastcall **)(struct _FD_GLYPHSET *, unsigned __int64))(*(_QWORD *)a2 + 3000LL);
      if ( v13 )
        v13(v11, v18);
    }
  }
LABEL_25:
  v14 = *(void (__fastcall **)(struct _IFIMETRICS *, unsigned __int64))(*(_QWORD *)a2 + 3000LL);
  if ( v14 )
    v14(v10, v15);
  return v5;
}
