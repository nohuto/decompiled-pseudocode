/*
 * XREFs of CancelForegroundActivate @ 0x1C004F7F0
 * Callers:
...
__int64 __fastcall CancelForegroundActivate(int a1)
{
  ...
  if ( (gdwPUDFlags & 0x8000000) != 0 )
  {
    for ( i = gppiStarting; i; i = *(_QWORD *)(i + 368) )
    {
      if ( !PsGetProcessDebugPort(*(_QWORD *)i) )
      {
        *(_DWORD *)(i + 12) &= ~0x100u;
        ...
        {
          LOBYTE(v3) = 4;
          WPP_RECORDER_SF_q(a1, v3, 2, 18, (__int64)&WPP_aa0cdaa0f1c33ddef9256642731d7c5d_Traceguids, i);
        }
      }
    }
    result = gdwPUDFlags;
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return WPP_RECORDER_SF_(a1, 4, 2, 19, (__int64)&WPP_aa0cdaa0f1c33ddef9256642731d7c5d_Traceguids);
  }
  return result;
}
