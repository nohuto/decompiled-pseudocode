/*
 * XREFs of ?bLoadSourceNotMetaDEVBITMAP@MULTISURF@@AEAAHPEAUHDEV__@@@Z @ 0x1C02A6B54
 * Callers:
 *     ?bLoadSource@MULTISURF@@QEAAHPEAUHDEV__@@@Z @ 0x1C02A6A8C (-bLoadSource@MULTISURF@@QEAAHPEAUHDEV__@@@Z.c)
