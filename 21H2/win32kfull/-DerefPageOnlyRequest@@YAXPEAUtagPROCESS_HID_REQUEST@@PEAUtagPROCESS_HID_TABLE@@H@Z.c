/*
 * XREFs of ?DerefPageOnlyRequest@@YAXPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@H@Z @ 0x1C000356C
 * Callers:
...
void __fastcall DerefPageOnlyRequest(struct tagPROCESS_HID_REQUEST *a1, struct tagPROCESS_HID_TABLE *a2, int a3)
{
  ...
  tagObjLock *v11; // [rsp+30h] [rbp-28h]
  ...
  if ( (v9 & 1) != 0 )
  {
    *((_DWORD *)a1 + 5) = v9 & 0xFFFFFFFE;
    ...
    {
      if ( v11 )
        tagObjLock::UnLockExclusive(v11);
    }
  }
}
