/*
 * XREFs of ?BltLnk@@YAHPEAVSURFACE@@00PEAVECLIPOBJ@@PEAVXLATE@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C00CD260
 * Callers:
 ...
 *     ?pvGetEngRbrush@@YAPEAXPEAU_BRUSHOBJ@@@Z @ 0x1C00CF018 (-pvGetEngRbrush@@YAPEAXPEAU_BRUSHOBJ@@@Z.c)
...
LABEL_18:
  ...
  *((_QWORD *)&v99[4] + 1) = *((_QWORD *)v14 + 10);
  ...
  {
    if ( (unsigned int)bUMPDSecurityGateEx() && !v90 )
    {
      if ( gfUMPDDebug )
