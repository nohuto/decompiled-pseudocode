/*
 * XREFs of ?xxxForceUpdateProcessDpiAwarenessContext@@YAXPEAUtagWND@@K@Z @ 0x1C0238468
 * Callers:
...
void __fastcall xxxForceUpdateProcessDpiAwarenessContext(struct tagWND *a1, unsigned int a2)
{
  ...
  if ( !(unsigned int)IsWindowBeingDestroyed((__int64)a1) )
  {
    ...
    *(_DWORD *)(v5 + 280) = a2;
    ...
    v8 = *(_QWORD **)(v5 + 664);
    if ( (unsigned int)Feature_1938628922__private_IsEnabled() && v8 )
    {
    ...
    if ( v8 )
    {
      ...
      while ( v9 )
      {
        v10 = BuildHwndList(*(ShellWindowManagement **)(v9[1] + 24LL), (const struct tagWND *)1, 0LL, 1);
        if ( v10 )
        {
          v17 = 0LL;
          v16 = 0LL;
    ...
    if ( (unsigned int)Feature_1938628922__private_IsEnabled() )
    {
      if ( v8 )
