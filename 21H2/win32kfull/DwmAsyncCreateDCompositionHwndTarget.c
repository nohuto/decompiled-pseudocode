/*
 * XREFs of DwmAsyncCreateDCompositionHwndTarget @ 0x1C010C7F8
 * Callers:
 *     ?ReNotifyDwm@CHwndTargetProp@@SAXPEAUtagWND@@@Z @ 0x1C00B347C (-ReNotifyDwm@CHwndTargetProp@@SAXPEAUtagWND@@@Z.c)
 *     EditionNotifyDwmForSystemVisualCreation @ 0x1C010C760 (EditionNotifyDwmForSystemVisualCreation.c)
 * Callees:
