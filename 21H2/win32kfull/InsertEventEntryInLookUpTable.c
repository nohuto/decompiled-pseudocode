/*
 * XREFs of InsertEventEntryInLookUpTable @ 0x1C0259DF4
 * Callers:
 ...
 * Callees:
 *     CompareEventEntry @ 0x1C016E4E6 (CompareEventEntry.c)
 *     ComputeEventEntryHash @ 0x1C02598F0 (ComputeEventEntryHash.c)
