/*
 * XREFs of TryDetachShellFrame @ 0x1C01DD074
 * Callers:
 ...
 *     AssociateShellFrameAppThreads @ 0x1C01D9814 (AssociateShellFrameAppThreads.c)
          ...
          if ( a4
            || (result = *(_QWORD *)(a1 + 432),
                (int)(((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24)
                    - *(_DWORD *)(result + 420)) >= v8) )
          {
            result = AssociateShellFrameAppThreads(a1, a2);
            if ( (_DWORD)result )
            {
              ThreadLock(*(_QWORD *)(*(_QWORD *)(a1 + 432) + 112LL), (__int64 *)&v20);
              LockW32Thread(a2, (__int64)&v18);
              v11 = zzzAttachThreadInput(a1, a2, 0x4000);
              v15 = ThreadUnlock1(v13, v12, v14);
              if ( v11 >= 0 )
              {
                *(_DWORD *)(a2 + 1256) |= 0x80000u;
                tagQ::LockFocusWnd(*(_QWORD *)(a1 + 432), *(_QWORD *)(*(_QWORD *)(a1 + 432) + 120LL), 0LL);
                if ( v15 )
                {
                  v16 = *(_QWORD *)(a2 + 432);
