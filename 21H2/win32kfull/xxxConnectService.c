/*
 * XREFs of xxxConnectService @ 0x1C012F544
 * Callers:
      ...
      if ( v10 )
      {
        ...
        if ( v11 )
        {
          ...
          if ( v13 )
          {
            v5 = (void *)v13;
            v27 = v13;
            SecurityDescriptor = (void *)CreateSecurityDescriptor(v13, TokenInformationLength, 0LL);
            v26 = SecurityDescriptor;
            if ( SecurityDescriptor )
            {
              PushW32ThreadLock((__int64)v4, &v33, (__int64)Win32FreePool);
              PushW32ThreadLock((__int64)v5, &v31, (__int64)Win32FreePool);
              PushW32ThreadLock((__int64)SecurityDescriptor, &v29, (__int64)Win32FreePool);
              LODWORD(v22) = 48;
              *((_QWORD *)&v22 + 1) = 0LL;
              DWORD2(v23) = 128;
              *(_QWORD *)&v23 = a1;
