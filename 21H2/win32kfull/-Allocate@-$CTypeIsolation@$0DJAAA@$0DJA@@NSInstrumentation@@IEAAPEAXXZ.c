/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1C00F9BD8
 * Callers:
 ...
 * Callees:
 *     ?Allocate@?$CSectionBitmapAllocator@$0DJAAA@$0DJA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1C00F9D28 (-Allocate@-$CSectionBitmapAllocator@$0DJAAA@$0DJA@@NSInstrumentation@@QEAAPEAXXZ.c)
...
PSLIST_ENTRY __fastcall NSInstrumentation::CTypeIsolation<233472,912>::Allocate(__int64 a1)
{
  __int64 v2; // rbx
  __int64 v3; // rbp
  _QWORD *i; // rsi
  ...
  else
  {
    ...
    if ( v7 )
    {
      v3 = NSInstrumentation::CSectionBitmapAllocator<233472,912>::Allocate(*(_QWORD *)(v7 + 32));
      if ( v3 )
      {
        v9 = *(_QWORD *)(a1 + 16);
        KeEnterCriticalRegion();
