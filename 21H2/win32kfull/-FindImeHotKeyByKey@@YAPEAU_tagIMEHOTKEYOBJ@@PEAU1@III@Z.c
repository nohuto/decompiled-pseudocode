/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C0107060
 * Callers:
 *     CheckImeHotKey @ 0x1C0106DFC (CheckImeHotKey.c)
 * Callees:
 *     GetActiveHKL @ 0x1C0107118 (GetActiveHKL.c)
 *     ?GetHotKeyLangID@@YAGK@Z @ 0x1C011762C (-GetHotKeyLangID@@YAGK@Z.c)
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C021D930 (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
