/*
 * XREFs of InitFNTCache @ 0x1C00E2390
 * Callers:
 *     <none>
 * Callees:
 *     ?vUnlock@SEMOBJ@@QEAAXXZ @ 0x1C001174C (-vUnlock@SEMOBJ@@QEAAXXZ.c)
 *     vGetLastBootTimeStatus @ 0x1C00E20A4 (vGetLastBootTimeStatus.c)
 *     bServicingStackModifiedFonts @ 0x1C00E20F8 (bServicingStackModifiedFonts.c)
 *     bSetFntCacheReg @ 0x1C00E214C (bSetFntCacheReg.c)
 *     bFntCacheDisabled @ 0x1C00E2238 (bFntCacheDisabled.c)
 ...
 *     vGetFontDriverLWT @ 0x1C00E2D78 (vGetFontDriverLWT.c)
...
LABEL_43:
  ...
  qword_1C0335DA8 = Win32AllocPoolZInit(128LL, 1128682580LL);
  v1 = qword_1C0335DA8;
  if ( !qword_1C0335DA8 )
    goto LABEL_19;
  ...
  *(_DWORD *)(v1 + 20) = 0;
  ...
  if ( (unsigned int)bServicingStackModifiedFonts()
    || !bMapFileRetainHandle(v4, (struct _FILEVIEW *)(qword_1C0335DA8 + 48), 0, v5) )
  {
    v1 = qword_1C0335DA8;
  }
  else
  {
    v1 = qword_1C0335DA8;
    *(_QWORD *)qword_1C0335DA8 = *(_QWORD *)(qword_1C0335DA8 + 56);
  }
  v6 = *(_DWORD **)v1;
  if ( !*(_QWORD *)v1 )
  {
  ...
  v10 = v24;
  if ( *v6
    && (v11 = *(_DWORD *)(v1 + 72), v11 == v6[6])
    && (v12 = ComputeFileviewCheckSum(v6 + 1, (unsigned int)(v11 - 4)),
        v1 = qword_1C0335DA8,
        v13 = *(_QWORD *)qword_1C0335DA8,
        **(_DWORD **)qword_1C0335DA8 == v12)
    && *(_QWORD *)(v13 + 48) == v10 )
  {
    v14 = AnsiCodePage;
    if ( *(_DWORD *)(v13 + 12) == AnsiCodePage )
    {
      v15 = *(_DWORD *)(qword_1C0335DA8 + 12);
      if ( (v15 & 1) == 0
        && (!G_fServiceSession
         || (v15 & 2) == 0 && *(_QWORD *)(v13 + 40) == v9 && v7 == *(_QWORD *)(v13 + 56) && v8 == *(_QWORD *)(v13 + 64)) )
      {
        dword_1C0335DA0 = 1;
        CurrentServiceSessionId = RtlGetCurrentServiceSessionId();
        v1 = qword_1C0335DA8;
        if ( CurrentServiceSessionId && v7 == *(_QWORD *)(*(_QWORD *)qword_1C0335DA8 + 56LL) )
          dword_1C0335DA0 |= 4u;
        goto LABEL_19;
      }
    }
  ...
  if ( G_fServiceSession )
  {
    v21 = bInitCacheTable(v3, v0, v7, v8, v9, v10, v14);
    v1 = qword_1C0335DA8;
    if ( v21 )
      dword_1C0335DA0 = 2;
  }
