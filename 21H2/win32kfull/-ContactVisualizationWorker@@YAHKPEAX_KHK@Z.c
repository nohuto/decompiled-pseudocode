/*
 * XREFs of ?ContactVisualizationWorker@@YAHKPEAX_KHK@Z @ 0x1C01D4A20
 * Callers:
 *     EditionContactVisualization @ 0x1C01D5450 (EditionContactVisualization.c)
 * Callees:
 ...
 *     DwmAsyncSendTouchContacts @ 0x1C016EB4A (DwmAsyncSendTouchContacts.c)
 *     ?GetWindowBarrelVisualizationSetting@Feedback@@YAHAEBUtagPOINTER_INFO@@H@Z @ 0x1C01D4E10 (-GetWindowBarrelVisualizationSetting@Feedback@@YAHAEBUtagPOINTER_INFO@@H@Z.c)
 *     ?GetWindowVisualizationSetting@Feedback@@YAHAEBUtagPOINTER_INFO@@HHHPEAH@Z @ 0x1C01D4ED0 (-GetWindowVisualizationSetting@Feedback@@YAHAEBUtagPOINTER_INFO@@HHHPEAH@Z.c)
 *     ?PointerEventIntToDigitizerContactInfo@Feedback@@YAXPEBUtagPOINTEREVENTINT@@HHHPEAUtagDIGITIZER_CONTACT_INFO@@@Z @ 0x1C01D5078 (-PointerEventIntToDigitizerContactInfo@Feedback@@YAXPEBUtagPOINTEREVENTINT@@HHHPEAUtagDIGITIZER_.c)
...
_BOOL8 __fastcall ContactVisualizationWorker(unsigned int a1, char *a2, __int64 a3, int a4, unsigned int a5)
{
  ...
  if ( (unsigned int)IsCurrentDesktopComposed() )
    v8 = Win32AllocPoolZInit(40 * v5, 1987081045LL);
  v12 = 0LL;
  if ( (_DWORD)v5 )
  {
    v13 = v47;
      ...
      if ( ContactVisualizationPointerEventInt )
      {
          ...
          && !(unsigned int)GetWorkspaceId(*((_QWORD *)ContactVisualizationPointerEventInt + 3)) )
        {
          if ( *(_DWORD *)v15 == 3 && (unsigned int)GetPointerDeviceType(*((_QWORD *)v15 + 2)) == 1 )
          {
            ...
            v43[0] = v17;
            v43[2] = v18;
            DeferPointerCursorOperation((const struct tagPOINTER_INFO *)v15, (const struct tagPOINTERCURSORDATA *)v43);
          }
          else if ( !Feedback::gfIntegratedPenActive )
          {
            ...
            if ( (v19 & 0x2000) != 0 )
            {
              ...
              {
                v22 = 0;
                if ( *(_DWORD *)v15 == 3 && (unsigned int)GetPointerDeviceType(*((_QWORD *)v15 + 2)) == 2 || v20 )
                {
                  v25 = 4;
                }
                else
              ...
              if ( !v20 )
                DeferPointerCursorOperation(
                  (const struct tagPOINTER_INFO *)v15,
  ...
  if ( v8 )
  {
    for ( i = 0LL; (unsigned int)i < (unsigned int)v12; i = v34 + (unsigned int)i )
    {
      ...
      v6 = DwmAsyncSendTouchContacts(v35, v8 + 40 * i, (__int64)CurrentIrp, v34);
      if ( v6 < 0 )
        break;
    }
    Win32FreePool(v8);
