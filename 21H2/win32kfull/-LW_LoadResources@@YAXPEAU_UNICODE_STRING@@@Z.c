/*
 * XREFs of ?LW_LoadResources@@YAXPEAU_UNICODE_STRING@@@Z @ 0x1C0131DE4
 * Callers:
...
void __fastcall LW_LoadResources(struct _UNICODE_STRING *a1)
{
  ...
  FastGetProfileStringFromIDW(a1, 12LL, 5LL, &szN, &v3, 4, 0);
  v2 = (_WORD)v3 == 49 || (_WORD)v3 == 89 || (_WORD)v3 == 121;
  *(_DWORD *)(gpsi + 1988LL) = v2;
  FastGetProfileStringFromIDW(a1, 11LL, 9LL, &szY, &v3, 4, 0);
  if ( (((_WORD)v3 - 89) & 0xFFDF) != 0 )
    gdwPUDFlags &= ~0x80000u;
  else
    gdwPUDFlags |= 0x80000u;
  FastGetProfileStringFromIDW(a1, 11LL, 220LL, &szN, &v3, 4, 0);
  if ( (((_WORD)v3 - 89) & 0xFFDF) != 0 )
