/*
 * XREFs of bUnloadEudcFont @ 0x1C00A1EB0
 * Callers:
 ...
 *     ?vFreePql@PFEOBJ@@QEAAXXZ @ 0x1C00A1F88 (-vFreePql@PFEOBJ@@QEAAXXZ.c)
...
__int64 __fastcall bUnloadEudcFont(__int64 a1)
{
  ...
  if ( v11 )
  {
    ...
    {
      v3 = 0;
      if ( (dword_1C033B0C0 & 0x10) != 0 || !bFinallyInitializeFontAssocDefault )
        goto LABEL_5;
      v4 = (char *)&unk_1C0334ABC;
      v8 = 7LL;
      do
      {
