/*
 * XREFs of ?AllocateFromPagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAXPEAX@Z @ 0x1C02DDBFC
 * Callers:
 *     Win32UAFMAllocateFromPagedLookasideListImpl @ 0x1C0220330 (Win32UAFMAllocateFromPagedLookasideListImpl.c)
 * Callees:
