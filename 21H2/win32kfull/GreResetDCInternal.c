/*
 * XREFs of GreResetDCInternal @ 0x1C015B1AC
 * Callers:
 *     NtGdiResetDC @ 0x1C015B060 (NtGdiResetDC.c)
 * Callees:
  ...
  *(_QWORD *)(v15 + 1712) = 0LL;
  ...
  if ( (*((_DWORD *)v38[0] + 9) & 0x100) == 0 && *((_DWORD *)v38[0] + 8) != 1 && (*(_DWORD *)(v15 + 40) & 0x80u) != 0 )
  {
    ...
    if ( XDCOBJ::bCleanDC((XDCOBJ *)v38, 0) )
    {
      if ( *(_DWORD *)(v15 + 8) == 1 )
      {
        v19 = (HDC)hdcOpenDCW(&word_1C02E597C, a2, 0LL, 0LL, *(_QWORD *)(v15 + 2560), v35, a4, a5, 0);
        v9 = v19;
        if ( v19 )
        {
          *(_QWORD *)(v15 + 2560) = 0LL;
