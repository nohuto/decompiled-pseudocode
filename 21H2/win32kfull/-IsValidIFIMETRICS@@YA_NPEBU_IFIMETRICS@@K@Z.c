/*
 * XREFs of ?IsValidIFIMETRICS@@YA_NPEBU_IFIMETRICS@@K@Z @ 0x1C02A77A0
 * Callers:
 *     ?ProbeAndReadIFIMETRICS@@YAPEAU_IFIMETRICS@@PEAU1@H_K@Z @ 0x1C02A7A70 (-ProbeAndReadIFIMETRICS@@YAPEAU_IFIMETRICS@@PEAU1@H_K@Z.c)
 * Callees:
 *     ?IsValidAXESLISTW@@YA_NPEBXKJ@Z @ 0x1C02A764C (-IsValidAXESLISTW@@YA_NPEBXKJ@Z.c)
 *     ?IsValidDESIGNVECTOR@@YA_NPEBXKJ@Z @ 0x1C02A76A0 (-IsValidDESIGNVECTOR@@YA_NPEBXKJ@Z.c)
 *     ?IsValidFONTSIM@@YA_NPEBXKJ@Z @ 0x1C02A772C (-IsValidFONTSIM@@YA_NPEBXKJ@Z.c)
 *     ?IsValidString@@YA_NPEBXKJ@Z @ 0x1C02A78E0 (-IsValidString@@YA_NPEBXKJ@Z.c)
 */
...
bool __fastcall IsValidIFIMETRICS(struct _IFIMETRICS *a1, unsigned int a2)
{
  ...
  if ( (_DWORD)dpCharSets )
  {
    if ( (dpCharSets & 0x80000000) == 0LL && dpCharSets < v2 )
    {
      ...
      v10 = 0;
      while ( a1->dpCharSets + (unsigned __int64)(unsigned int)v10 < v2 )
      {
        if ( *v9 != 1 )
        {
          ++v10;
