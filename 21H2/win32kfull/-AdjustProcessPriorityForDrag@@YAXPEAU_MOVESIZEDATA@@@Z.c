/*
 * XREFs of ?AdjustProcessPriorityForDrag@@YAXPEAU_MOVESIZEDATA@@@Z @ 0x1C020A68C
 * Callers:
 *     xxxMoveSize @ 0x1C0212874 (xxxMoveSize.c)
 * Callees:
 *     ?IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z @ 0x1C020B6AC (-IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z.c)
...
void __fastcall AdjustProcessPriorityForDrag(struct _MOVESIZEDATA *a1)
{
  ...
  if ( (v3 & 0x100000) != 0 )
  {
    ...
    if ( PriorityBoost::IsProcessPriorityByClassBackground(*(PriorityBoost **)(v4 + 424), v5)
      && !PriorityBoost::IsProcessPriorityByClassBackground(*(PriorityBoost **)(gptiForeground + 424LL), v6) )
    {
      v7 = 1LL;
LABEL_8:
