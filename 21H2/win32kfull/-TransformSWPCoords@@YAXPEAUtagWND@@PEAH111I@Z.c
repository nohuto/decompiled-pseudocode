/*
 * XREFs of ?TransformSWPCoords@@YAXPEAUtagWND@@PEAH111I@Z @ 0x1C01F10CC
 * Callers:
 ...
 *     ScaleDpiValueWithSubpixel @ 0x1C01DFE5C (ScaleDpiValueWithSubpixel.c)
 */
      ...
      if ( v11 )
      {
        ...
        if ( (a6 & 1) == 0 )
        {
          if ( IsChildWindowDpiBoundary(a1) )
          {
            *((_DWORD *)a1 + 58) = 0;
            *((_DWORD *)a1 + 59) = 0;
            ScaleDpiValueWithSubpixel(a4, (float *)a1 + 58, v15, v16);
