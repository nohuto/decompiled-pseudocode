/*
 * XREFs of PhysicalToLogicalInPlaceRgnWorker @ 0x1C004A618
 * Callers:
 ...
 *     ?TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z @ 0x1C016B8D2 (-TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z.c)
 */
