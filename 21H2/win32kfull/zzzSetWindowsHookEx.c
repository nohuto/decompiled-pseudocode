/*
 * XREFs of zzzSetWindowsHookEx @ 0x1C001FCE8
 * Callers:
 *     NtUserSetWindowsHookEx @ 0x1C001FBA0 (NtUserSetWindowsHookEx.c)
 *     NtUserSetWindowsHookAW @ 0x1C02036F0 (NtUserSetWindowsHookAW.c)
 * Callees:
...
LABEL_40:
  ...
  if ( !a3 )
  {
    if ( !a1 && (*((_BYTE *)&unk_1C02EB9F8 + a4 + 1) & 0x24) == 0 )
      goto LABEL_46;
    goto LABEL_10;
  }
  v9 = *((_BYTE *)&unk_1C02EB9F8 + a4 + 1);
  if ( (v9 & 2) == 0 )
  {
    v23 = 1429LL;
    goto LABEL_40;
...
LABEL_50:
    ...
    if ( (*(_DWORD *)(v7 + 488) & 0xC) != 0 && (*((_BYTE *)&unk_1C02EB9F8 + v6 + 1) & 0x10) == 0 )
    {
      v23 = 1458LL;
      goto LABEL_40;
    }
...
LABEL_10:
  v34 = v6;
  if ( (*((_BYTE *)&unk_1C02EB9F8 + v6 + 1) & 4) != 0
  ...
  *v19 = v16;
  ...
  if ( (*(_DWORD *)(v16 + 64) & 1) != 0 && (*((_BYTE *)&unk_1C02EB9F8 + v6 + 1) & 0x10) != 0 )
  {
