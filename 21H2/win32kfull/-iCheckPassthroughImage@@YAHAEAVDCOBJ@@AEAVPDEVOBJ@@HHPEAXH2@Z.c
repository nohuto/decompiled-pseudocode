/*
 * XREFs of ?iCheckPassthroughImage@@YAHAEAVDCOBJ@@AEAVPDEVOBJ@@HHPEAXH2@Z @ 0x1C013DC80
 * Callers:
  ...
  if ( a3 == 8 )
  {
    ...
    if ( v32 == 4119 )
    {
      if ( (unsigned int)XDCOBJ::bSupportsJPEG(a1) )
        return *(_QWORD *)(*(_QWORD *)a2 + 3272LL) != 0LL;
    }
    else
    {
      v13 = *(_QWORD *)a1;
...
LABEL_24:
  if ( XlateObject )
  {
    ...
    v20 = v33;
    LOBYTE(v10) = (*(unsigned int (__fastcall **)(struct _SURFOBJ *, _DWORD *, _QWORD, bool, int, _DWORD *, unsigned int, _DWORD *))(*(_QWORD *)a2 + 3272LL))(
                    v19,
                    v28,
                    0LL,
                    a3 != 4119,
