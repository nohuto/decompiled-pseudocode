/*
 * XREFs of ?vSortBltOrderWorker@@YAXPEAPEAU_SODISPSURF@@JJ@Z @ 0x1C02A72D8
 * Callers:
 *     ??0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z @ 0x1C02A1240 (--0MULTISORTBLTORDER@@QEAA@PEAU_VDEV@@JJ@Z.c)
 * Callees:
 *     ?isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z @ 0x1C02A6EC0 (-isSorted@@YA_NPEAU_SODISPSURF@@0JJ@Z.c)
 */
