/*
 * XREFs of GreAngleArc @ 0x1C029FD70
 * Callers:
 *     NtGdiAngleArc @ 0x1C02AE1E0 (NtGdiAngleArc.c)
 * Callees:
 ...
 *     ??0EBOX@@QEAA@AEAVEXFORMOBJ@@AEAU_RECTL@@@Z @ 0x1C02B0504 (--0EBOX@@QEAA@AEAVEXFORMOBJ@@AEAU_RECTL@@@Z.c)
