/*
 * XREFs of SfnINOUTLPPOINT5 @ 0x1C00F3340
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  __int128 v44; // [rsp+E8h] [rbp-60h]
  __int64 v45; // [rsp+F8h] [rbp-50h]
  __int64 v46; // [rsp+100h] [rbp-48h]
  __int64 v47; // [rsp+108h] [rbp-40h]
  ...
  *(_QWORD *)(*(_QWORD *)(v13 + 480) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(18LL, &v39, 80LL, &v32, v31);
  ...
  *(_QWORD *)(v22 + 80) = v34;
  ...
  {
    v26 = *(_QWORD *)(v32 + 16);
    if ( v26 + 40 < v26 || v26 + 40 > MmUserProbeAddress )
