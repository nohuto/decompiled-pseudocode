/*
 * XREFs of ?vXlatGlyphArray@RFONTOBJ@@QEAAXPEBGIPEAKKH@Z @ 0x1C00997C0
 * Callers:
...
LABEL_53:
        ...
        {
          v48 = *a2;
          if ( (unsigned __int16)v48 >= gqlTTSystem && (unsigned __int16)v48 <= (unsigned __int16)word_1C033D5CA )
          {
            v49 = v48 - gqlTTSystem;
            ...
            if ( ((0x80000000 >> v50) & *(_DWORD *)(qword_1C033D5D0 + 4LL * (v49 >> 5))) != 0 )
LABEL_55:
