/*
 * XREFs of MagGetLensContextInformation @ 0x1C01C9964
 * Callers:
 ...
 *     _GetMagnificationInputTransform @ 0x1C0212888 (_GetMagnificationInputTransform.c)
        ...
        int *a6)
{
  ...
  int v9; // r9d
  struct _MAG_THREAD_CONTEXT *v10; // rbp
  int v12; // r9d
  int v13; // r9d
  int v14; // r9d
  int v15; // r9d
  ...
  struct _MAG_LENS_CONTEXT *v23; // rsi
  ...
  struct _MAG_LENS_CONTEXT *v45; // rdx
  int v46; // r8d
  int v47; // ecx
  int v48; // eax
  __int64 v49; // r9
  ...
  __int128 v56; // [rsp+40h] [rbp-48h] BYREF
  ...
  if ( !v13 )
  {
    ...
    else
    {
      ...
      *(_OWORD *)(a5 + 16) = xmmword_1C032F268;
    }
    return 0;
  }
  v14 = v13 - 1;
  ...
  if ( !v15 )
  {
    ...
    else
    {
      ...
      *(_OWORD *)(a5 + 16) = xmmword_1C032F290;
      *(_OWORD *)(a5 + 32) = xmmword_1C032F2A0;
      *(_OWORD *)(a5 + 48) = xmmword_1C032F2B0;
      *(_OWORD *)(a5 + 64) = xmmword_1C032F2C0;
      *(_OWORD *)(a5 + 80) = xmmword_1C032F2D0;
      v53 = dword_1C032F2E0;
    }
    *(_DWORD *)(a5 + 96) = v53;
    return 0;
  ...
  v24 = *((_DWORD *)v22 + 4);
  v25 = (v24 >> 6) & 1;
  if ( (v24 & 0x20) != 0 || !*((_DWORD *)v23 + 60) )
  {
    *(_DWORD *)a5 = 0;
    *(_DWORD *)(a5 + 8) = 0;
    *(_QWORD *)(a5 + 40) = 0LL;
    *(_DWORD *)(a5 + 4) = *((_DWORD *)v23 + 60);
    *(_DWORD *)(a5 + 12) = *((_DWORD *)v23 + 61);
    *(_DWORD *)(a5 + 16) = *((_DWORD *)v23 + 62);
    *(_DWORD *)(a5 + 20) = *((_DWORD *)v23 + 63);
    return 0;
  }
  ThreadLock((__int64)a3, (__int64 *)&v56);
  v26 = ReferenceDwmProcess();
  v28 = (void *)ReferenceDwmApiPort(v27);
  UserSessionSwitchLeaveCrit(v29);
  if ( v28 && v26 )
  {
    updated = DwmSyncMagnUpdateWindowSharedTextures(v28, (__int64)v23 + 32, *(_QWORD *)(a5 + 24), v25, a5);
  }
  else
  {
    DereferenceDwmApiPort(v28);
    updated = -1073741823;
  }
  EnterCrit(1LL, 0LL);
  ...
  if ( !*(_DWORD *)(a5 + 8)
    || (Handle = (void **)(a5 + 40), (v34 = *(void **)(a5 + 40)) == 0LL)
    || (*Handle = 0LL,
