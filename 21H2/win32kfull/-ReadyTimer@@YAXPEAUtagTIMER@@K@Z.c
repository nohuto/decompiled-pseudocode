/*
 * XREFs of ?ReadyTimer@@YAXPEAUtagTIMER@@K@Z @ 0x1C01E5DD4
 * Callers:
 ...
 *     ?ApplyTimerDelay@@YAXPEAUtagTIMER@@@Z @ 0x1C01E5CFC (-ApplyTimerDelay@@YAXPEAUtagTIMER@@@Z.c)
 */
  ...
  if ( (v5 & 1) == 0 )
  {
    ...
    else
    {
      ...
      *((_DWORD *)a1 + 12) = v5 | 1;
      ...
      ++*(_DWORD *)(v6 + 604);
      v8 = *((_QWORD *)a1 + 3) + 1240LL;
      v9 = *(__int64 ***)(*((_QWORD *)a1 + 3) + 1248LL);
      if ( *v9 != (__int64 *)v8 )
        __fastfail(3u);
      *((_QWORD *)a1 + 8) = v9;
      *v7 = v8;
