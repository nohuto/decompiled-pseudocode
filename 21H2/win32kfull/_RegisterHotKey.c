/*
 * XREFs of _RegisterHotKey @ 0x1C0032C74
 * Callers:
 ...
 * Callees:
 *     ?FindHotKey@@YAHPEAUtagTHREADINFO@@PEAUtagWND@@HIIPEAPEAUtagHOTKEY@@@Z @ 0x1C0032FE0 (-FindHotKey@@YAHPEAUtagTHREADINFO@@PEAUtagWND@@HIIPEAPEAUtagHOTKEY@@@Z.c)
  ...
  if ( !(unsigned int)FindHotKey(gptiCurrent, a1, v30, v13, BugCheckParameter2, &v27) )
  {
    ...
    if ( v18 )
    {
      if ( v11 )
      {
        ...
        dword_1C0339C44[2 * v24] = BugCheckParameter2;
