/*
 * XREFs of ?LoadModuleWorkHorse@@YAPEAXPEAGH@Z @ 0x1C028646C
 * Callers:
 *     EngLoadModule @ 0x1C02870B0 (EngLoadModule.c)
 *     EngLoadModuleForWrite @ 0x1C02870D0 (EngLoadModuleForWrite.c)
 * Callees:
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x1C0014ED0 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
 *     ?GetModuleHandleAndIncrementRefcount@@YAPEAXPEBG@Z @ 0x1C02863A4 (-GetModuleHandleAndIncrementRefcount@@YAPEAXPEBG@Z.c)
