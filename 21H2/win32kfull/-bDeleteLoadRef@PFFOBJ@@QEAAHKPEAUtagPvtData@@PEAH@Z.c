/*
 * XREFs of ?bDeleteLoadRef@PFFOBJ@@QEAAHKPEAUtagPvtData@@PEAH@Z @ 0x1C0011FA8
 * Callers:
 ...
 *     ?bRemovePvtData@PFFOBJ@@QEAAHPEAUtagPvtData@@@Z @ 0x1C02BA4A8 (-bRemovePvtData@PFFOBJ@@QEAAHPEAUtagPvtData@@@Z.c)
 */
...
LABEL_22:
      ...
      v8 = *(_QWORD *)(*(_QWORD *)this + 144LL) == 0LL;
      goto LABEL_6;
    }
    v10 = *((_DWORD *)a3 + 2);
    if ( (a2 & 0x6C) != 0 )
