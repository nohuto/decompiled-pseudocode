/*
 * XREFs of ?xxxValidateCapture@CMoveSizeRequest@@CA_NPEAUtagWND@@KPEAUtagPOINT@@@Z @ 0x1C0241D00
 * Callers:
...
bool __fastcall CMoveSizeRequest::xxxValidateCapture(struct tagWND *a1, int a2, struct tagPOINT *a3)
{
  ...
  {
    v7 = a2;
    if ( !CTouchProcessor::ThreadHasPrimaryCaptureExternal(gpTouchProcessor, v9, a2)
      || !xxxPromotePointerToMouse(a2, 0x10001u) )
    {
      return 0;
    }
  }
