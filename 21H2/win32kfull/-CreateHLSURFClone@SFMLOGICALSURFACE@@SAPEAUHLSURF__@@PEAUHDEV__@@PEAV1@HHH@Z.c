/*
 * XREFs of ?CreateHLSURFClone@SFMLOGICALSURFACE@@SAPEAUHLSURF__@@PEAUHDEV__@@PEAV1@HHH@Z @ 0x1C00FE390
 * Callers:
 ...
 *     SFMLOGICALSURFACE_CreateHLSURFCloneWrap @ 0x1C00FE370 (SFMLOGICALSURFACE_CreateHLSURFCloneWrap.c)
 * Callees:
