/*
 * XREFs of _anonymous_namespace_::SetForegroundPriorityProcess @ 0x1C0039090
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::SetProcessPriorityByClass @ 0x1C00391B0 (_anonymous_namespace_--SetProcessPriorityByClass.c)
