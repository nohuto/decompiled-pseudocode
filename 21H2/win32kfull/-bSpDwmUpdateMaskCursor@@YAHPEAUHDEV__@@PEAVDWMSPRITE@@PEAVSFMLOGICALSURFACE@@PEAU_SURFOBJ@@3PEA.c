/*
 * XREFs of ?bSpDwmUpdateMaskCursor@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAU_SURFOBJ@@3PEAU_RECTL@@PEAKPEAPEAV3@@Z @ 0x1C026C464
 * Callers:
        ...
        struct SFMLOGICALSURFACE **a8)
{
  ...
  if ( DIB )
  {
    if ( !psoSrc
      || (v29 >>= 1,
          (DIB = SURFMEM::bCreateDIB((SURFMEM *)&v22, (struct _DEVBITMAPINFO *)v28, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0, 0)) != 0) )
    {
      v11 = *a6;
      v21 = 0LL;
      pxlo = 0LL;
      ...
      if ( DIB )
      {
        ...
        v16 = v35;
        v17 = v36;
        *((_DWORD *)v33 + 35) = ((_DWORD)psoDest != 0 ? 4 : 0) | *((_DWORD *)v33 + 35) & 0xFFFFFFFB;
