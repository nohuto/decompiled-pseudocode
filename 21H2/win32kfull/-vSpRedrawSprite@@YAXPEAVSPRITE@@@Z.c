/*
 * XREFs of ?vSpRedrawSprite@@YAXPEAVSPRITE@@@Z @ 0x1C00B6430
 * Callers:
...
void __fastcall vSpRedrawSprite(struct SPRITE *a1)
{
  ...
  _DWORD v34[84]; // [rsp+118h] [rbp+10h] BYREF
            ...
            while ( 1 )
            {
              if ( v34[0] )
              {
                do
                {
                  ...
                  if ( v18->bottom > v21 )
                    v18->bottom = v21;
                  vSpWriteToScreen((struct _SPRITESTATE *)v1, &v24, Composite, v18);
                  ++v5;
                }
                while ( v5 < v34[0] );
              }
...
LABEL_47:
          ...
          v22 = *(struct _RECTL *)&v27[4];
        }
        else
        {
          v22 = *v6;
        }
        *(struct _RECTL *)&v34[1] = v22;
        v34[0] = 1;
        v16 = 0;
        goto LABEL_30;
      }
