/*
 * XREFs of CheckImeHotKey @ 0x1C0106DFC
 * Callers:
 *     xxxImmProcessKey @ 0x1C0106C44 (xxxImmProcessKey.c)
 * Callees:
 *     ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C0107060 (-FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z.c)
 */
...
struct _tagIMEHOTKEYOBJ *__fastcall CheckImeHotKey(__int64 a1, unsigned int a2, int a3)
{
  ...
  if ( v4 )
  {
    ...
    else if ( dword_1C033B0E8 != (*((_DWORD *)result + 4) & 7) )
    {
      return 0LL;
    }
    dword_1C033B0E8 = 0;
