/*
 * XREFs of SfnOUTLPSCROLLBARINFO @ 0x1C022F380
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  _QWORD v37[8]; // [rsp+70h] [rbp-F8h] BYREF
  ...
  int v47; // [rsp+110h] [rbp-58h]
  int v48; // [rsp+114h] [rbp-54h]
  ...
  *(_QWORD *)(*(_QWORD *)(v13 + 480) + 80LL) = v18;
  ...
  v19 = KeUserModeCallback(105LL, &v39, 104LL, &v34, v33);
  ...
  *(_QWORD *)(v21 + 80) = v36;
  if ( v19 >= 0 && v33[0] == 24 )
  {
    ...
    {
      v25 = *(_QWORD *)(v34 + 16);
      if ( v25 + 60 < v25 || v25 + 60 > MmUserProbeAddress )
