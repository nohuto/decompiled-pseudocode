/*
 * XREFs of ?bInit@PFEMEMOBJ@@QEAAHPEAVPFF@@KPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@2HPEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C00A3434
 * Callers:
 ...
 *     IsAnyCharsetDbcs @ 0x1C00A38D4 (IsAnyCharsetDbcs.c)
        ...
        int a10)
{
  ...
  *(_DWORD *)(*(_QWORD *)this + 80LL) = _InterlockedIncrement(&dword_1C033D3AC);
