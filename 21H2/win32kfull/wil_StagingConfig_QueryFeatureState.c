/*
 * XREFs of wil_StagingConfig_QueryFeatureState @ 0x1C037B0CC
 * Callers:
 *     wil_details_GetCurrentFeatureEnabledState @ 0x1C016663C (wil_details_GetCurrentFeatureEnabledState.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0165D70 (__security_check_cookie.c)
 *     wil_details_StagingConfig_Load @ 0x1C0166890 (wil_details_StagingConfig_Load.c)
 *     wil_details_StagingConfig_QueryFeatureState @ 0x1C0166B8C (wil_details_StagingConfig_QueryFeatureState.c)
