/*
 * XREFs of ?xxxSetWindowShowState@@YA_NPEAUtagWND@@EPEAUtagRECT@@@Z @ 0x1C024243C
 * Callers:
...
bool __fastcall xxxSetWindowShowState(struct tagWND *this, unsigned __int8 a2, struct tagRECT *a3)
{
  ...
  if ( a3 )
  {
    Prop = (struct tagRECT *)GetProp((__int64)this, (unsigned __int16)WPP_MAIN_CB.DeviceQueue.Type, 1LL);
    if ( Prop )
    {
      *Prop = *a3;
    }
...
LABEL_9:
  ...
  return (unsigned int)PostEventMessageEx(
                         ...
                         *(struct tagQ **)(*((_QWORD *)this + 2) + 432LL),
                         1u,
                         this,
                         1u,
                         a3 != 0LL ? 4 : 0,
