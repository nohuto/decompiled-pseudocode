/*
 * XREFs of ?InjectInput@RIM@InputTraceLogging@@SAXPEBURIMDEV@@W4InputTracing_RimInjectionSource@@K@Z @ 0x1C01D5D44
 * Callers:
 ...
 *     ?PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z @ 0x1C01D5F70 (-PointerDeviceTypeToString@InputTraceLogging@@CAPEBDK@Z.c)
 */
  ...
  if ( (_BYTE)v3 != 2 )
  {
    if ( (_BYTE)v3 )
    {
      ...
      if ( (unsigned int)dword_1C032BE20 <= 4 )
        return v3;
      LOBYTE(v3) = tlgKeywordOn((__int64)&dword_1C032BE20, 256LL);
      if ( !(_BYTE)v3 )
        return v3;
      v17 = (unsigned __int8 *)&unk_1C02EE45B;
    }
    else
    {
      if ( (unsigned int)dword_1C032BE20 <= 4 )
      ...
      if ( !(_BYTE)v3 )
        return v3;
      v16 = 1;
      v17 = (unsigned __int8 *)&unk_1C02EE41E;
    }
  ...
  else if ( (unsigned int)dword_1C032BE20 > 4 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      LOBYTE(v3) = _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapSz<char>,_tlgWrapSz<char>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
                     (__int64)&dword_1C032BE20,
                     (unsigned __int8 *)dword_1C02EE36A,
                     v10,
                     v9,
                     (__int64)&v20,
                     (void **)&v19,
