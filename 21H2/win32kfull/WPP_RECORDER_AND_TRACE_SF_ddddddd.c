/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_ddddddd @ 0x1C01214F8
 * Callers:
...
_UNKNOWN **WPP_RECORDER_AND_TRACE_SF_ddddddd(
        __int64 a1,
        char a2,
        char a3,
        _DWORD a4,
        ...
        ...)
{
  ...
  if ( a2 )
    result = (_UNKNOWN **)((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
                            a1,
                            43LL,
