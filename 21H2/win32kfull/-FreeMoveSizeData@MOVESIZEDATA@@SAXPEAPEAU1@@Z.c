/*
 * XREFs of ?FreeMoveSizeData@MOVESIZEDATA@@SAXPEAPEAU1@@Z @ 0x1C024A98C
 * Callers:
 *     ?xxxMoveSize@@YAXPEAUtagWND@@IK@Z @ 0x1C020EBC4 (-xxxMoveSize@@YAXPEAUtagWND@@IK@Z.c)
 *     EditionFreeMoveSizeDataOnThreadDestroy @ 0x1C02101A0 (EditionFreeMoveSizeDataOnThreadDestroy.c)
 * Callees:
 *     <none>
 */
...
void __fastcall MOVESIZEDATA::FreeMoveSizeData(struct MOVESIZEDATA **a1)
{
  ...
  *(_QWORD *)(v3 + 8) = v4;
  ...
  Win32FreePool(*(_QWORD *)(gptiCurrent + 672LL));
