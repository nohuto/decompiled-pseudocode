/*
 * XREFs of ?vRemoveHash@PFFOBJ@@QEAAXXZ @ 0x1C00BA214
 * Callers:
 ...
 *     ?vFree@FHOBJ@@QEAAXXZ @ 0x1C00E6834 (-vFree@FHOBJ@@QEAAXXZ.c)
 */
...
void __fastcall PFFOBJ::vRemoveHash(PFFOBJ *this)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)this + 80LL) )
  {
    ...
    if ( *(struct PDEV **)(v2 + 88) == qword_1C0341AF0 && !*(_DWORD *)(*(_QWORD *)(v2 + 80) + 8LL) )
      --gcTrueTypeFonts;
  }
  else
  {
