/*
 * XREFs of ComputeAABBP @ 0x1C00E4C84
 * Callers:
...
LABEL_24:
  ...
  else
  {
    ...
    if ( !v25 )
      v26 = ExpandDIB_CX;
    v22 = (__int64 (__fastcall *)(int, int, int, int, int, int, int, __int64, __int64, int))BuildExpandAAInfo;
    v27 = ExpandMask_CX;
    v28 = ExpandAV_CX;
  }
  a3[2].m128i_i64[0] = (__int64)v27;
  a3[3].m128i_i64[0] = (__int64)v28;
  a3[1].m128i_i64[0] = (__int64)v22;
  a3->m128i_i64[1] = (__int64)v26;
  if ( (v41 & 0x40) != 0 )
  {
  ...
  v39 = v8;
  if ( !v31 && !(unsigned int)IntersectRECTL(&v39, &v44) )
    return 0LL;
  if ( (v41 & 0x10) != 0 )
  {
    if ( !(unsigned int)IntersectRECTL(&v39, &v45) )
      return 0LL;
    v9 -= v45;
    v32 = DWORD1(v45);
    v10 -= v45;
  ...
  *(_QWORD *)&v49 = *(_QWORD *)(a2 + 12);
  if ( !(unsigned int)IntersectRECTL(&v39, v48) )
    return 0LL;
  if ( (v23 & 1) != 0 )
  {
