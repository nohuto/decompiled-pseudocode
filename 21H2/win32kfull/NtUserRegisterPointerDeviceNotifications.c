/*
 * XREFs of NtUserRegisterPointerDeviceNotifications @ 0x1C011F310
 * Callers:
 *     <none>
 * Callees:
 *     UserSetLastError @ 0x1C007274C (UserSetLastError.c)
 *     _RegisterPointerDeviceNotifications @ 0x1C011F3E0 (_RegisterPointerDeviceNotifications.c)
 */
...
__int64 __fastcall NtUserRegisterPointerDeviceNotifications(__int64 a1, unsigned int a2)
{
  ...
  if ( v4 )
  {
    ...
    {
      if ( a2 && !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 424LL) + 880LL, &v11) )
      {
