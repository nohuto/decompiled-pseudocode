/*
 * XREFs of ?TrackBackground@@YAHPEAUtagWINDOWPOS@@PEAUtagWND@@1111@Z @ 0x1C008176C
 * Callers:
 ...
 *     ?IsLastTopMostWindow@@YAHPEBUtagWND@@@Z @ 0x1C0120E4C (-IsLastTopMostWindow@@YAHPEBUtagWND@@@Z.c)
 */
  ...
  if ( a4 || (a4 = (struct tagWND *)CalcForegroundInsertAfter(a2)) != 0LL )
  {
    if ( !a6 || *(_QWORD *)(*((_QWORD *)a2 + 2) + 432LL) != gpqForeground || !(unsigned int)IsLastTopMostWindow(a4) )
    {
      if ( (unsigned int)IsLastTopMostWindow(a4)
        || a5 != GetRootOwner(a2)
        || (v11 = *((_QWORD *)a5 + 2), !*(_QWORD *)(v11 + 1392))
        || *(_QWORD *)(v11 + 432) != gpqForeground
        || a5 != *(struct tagWND **)(gpqForeground + 120LL)
