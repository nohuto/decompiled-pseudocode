/*
 * XREFs of ?IsDockTargetActive@@YAEPEAU_MOVESIZEDATA@@PEAUtagMONITOR@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C020B66C
 * Callers:
...
bool __fastcall IsDockTargetActive(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (*(_DWORD *)(a1 + 196) & 0x100000) == 0 )
    return *(_BYTE *)(a3 + a2 + 272) != 0;
  result = 0;
  if ( *(_BYTE *)(a3 + a2 + 248) )
    return *(_BYTE *)(a3 + a2 + 252) != 0;
  return result;
}
