/*
 * XREFs of ?_OnInput@Edgy@@YA?AUtagSTATE_TRANSITION_DATA@1@AEAUtagEDGY_DATA@@PEAX@Z @ 0x1C020877C
 * Callers:
 ...
 *     ?_OnEnterDisambiguation@Edgy@@YAXAEAUtagEDGY_DATA@@AEBUtagARC_DATA@1@@Z @ 0x1C0208704 (-_OnEnterDisambiguation@Edgy@@YAXAEAUtagEDGY_DATA@@AEBUtagARC_DATA@1@@Z.c)
...
__int64 __fastcall Edgy::_OnInput(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v7 = 4;
  v8 = dword_1C02F6EF0[(_QWORD)v6];
  v9 = *(_OWORD *)(ArcData + 16);
  v10 = dword_1C02F6EF4[(_QWORD)v6];
  ...
  *(_QWORD *)&v9 = *(_QWORD *)(ArcData + 48);
  ...
  while ( v8 < v10 )
  {
    if ( ((__int64)v15[1] & dword_1C02F6F18[4 * v8]) == dword_1C02F6F1C[4 * v8] )
    {
      v7 = dword_1C02F6F14[4 * v8];
      break;
    }
    ++v8;
  }
