/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C02DFD60
 * Callers:
 ...
 *     GetImageTuple @ 0x1C02DFCE0 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C02E0488 (_tlgCreate1Sz_char.c)
 */
...
LABEL_48:
  ...
  if ( v35 )
  {
      ...
      && (qword_1C037A058 & 0x400000000000LL) == qword_1C037A058 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C02F5306,
        0LL,
        v25,
        0xEu,
        &v77);
  ...
  else if ( (unsigned int)dword_1C037A040 > 5
         && (qword_1C037A050 & 0x400000000000LL) != 0
         && (qword_1C037A058 & 0x400000000000LL) == qword_1C037A058 )
  {
    v46 = 10;
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C037A040, byte_1C02F5299, 0LL, v28, 0xBu, &v99);
  }
  if ( dword_1C037A078 && !v53 && !KeGetCurrentIrql() )
  {
      ...
      && (qword_1C037A058 & 0x400000000000LL) == qword_1C037A058 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C037A040,
        (unsigned __int8 *)dword_1C02F53B0,
        0LL,
        0LL,
        v30,
        &v61);
