/*
 * XREFs of ?xxxGetShellShowWindowAction@@YAEPEAUtagWND@@EPEAH@Z @ 0x1C0049690
 * Callers:
...
unsigned __int8 __fastcall xxxGetShellShowWindowAction(struct tagWND *a1, unsigned __int8 a2, int *a3)
{
  ...
  *a3 = 0;
  v4 = a2;
  if ( ShellWindowManagement::WindowSubjectToBehavior(a1, (struct tagWND *)1, (unsigned int)a3) )
  {
    v7 = 1;
    if ( v4 == 7 )
      goto LABEL_15;
