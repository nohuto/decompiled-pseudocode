/*
 * XREFs of ?BuildSignatureFeatureReport@@YAJPEAU_HIDP_CAPS@@PEAU_HIDP_VALUE_CAPS@@PEAU_DEVICE_OBJECT@@PEAU_FILE_OBJECT@@PEAPEAD4@Z @ 0x1C01E6770
 * Callers:
        ...
        char **a6)
{
  ...
  v11 = -1073741811;
  IoStatusBlock = 0LL;
  OutputBuffer = (char *)Win32AllocPoolNonPagedZInit(FeatureReportByteLength, 1768321877LL);
  *a5 = OutputBuffer;
  if ( OutputBuffer )
  {
    if ( a2 && a3 && a4 )
