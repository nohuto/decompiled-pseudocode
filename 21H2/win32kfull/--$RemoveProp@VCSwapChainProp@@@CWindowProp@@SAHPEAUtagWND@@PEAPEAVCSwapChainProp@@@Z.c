/*
 * XREFs of ??$RemoveProp@VCSwapChainProp@@@CWindowProp@@SAHPEAUtagWND@@PEAPEAVCSwapChainProp@@@Z @ 0x1C023D4D4
 * Callers:
...
__int64 __fastcall CWindowProp::RemoveProp<CSwapChainProp>(__int64 a1, __int64 *a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 144);
  v4 = WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc);
  v5 = 0;
  if ( WORD2(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc) == word_1C033AF44 )
