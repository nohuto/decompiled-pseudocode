/*
 * XREFs of ?vGrowPathAndAddPoint@WIDEPATHOBJ@@IEAAXPEAU_POINTFIX@@PEAVEVECTORFX@@H@Z @ 0x1C02CFAA4
 * Callers:
 ...
 * Callees:
 *     ?bGrowPath@WIDEPATHOBJ@@IEAAHXZ @ 0x1C0140D70 (-bGrowPath@WIDEPATHOBJ@@IEAAHXZ.c)
 */
