/*
 * XREFs of ?bTightBoundsToRegion@DEVLOCKOBJ@@QEAAHXZ @ 0x1C0042838
 * Callers:
          ...
          if ( *(_DWORD *)(v1 + 488) )
          {
            ...
            if ( !ERECTL::bEmpty((ERECTL *)&v13) )
            {
              ...
              if ( v10 )
              {
                ...
                v7 = (_DWORD *)(*((_QWORD *)this + 4) + 1080LL);
                *v7 = 0;
                v7[1] = 0;
                v7[2] = 0;
                v7[3] = 0;
                if ( v6 )
                {
                  ...
                  v8 = *(_QWORD *)(*((_QWORD *)this + 4) + 1184LL);
                  v9 = v8;
                  if ( v12[0] && v8 && RGNOBJ::bMerge((RGNOBJ *)v12, (struct RGNOBJ *)&v9, (struct RGNOBJ *)&v10, 0xEu) )
                  {
                    RGNOBJ::vSwap((RGNOBJ *)v12, (struct RGNOBJ *)&v9);
                    v3 = 1;
                    *(_QWORD *)(*((_QWORD *)this + 4) + 1184LL) = v9;
                  }
                  RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v12);
                }
                else
                {
                  *(_QWORD *)(*((_QWORD *)this + 4) + 1184LL) = v10;
                  v10 = 0LL;
                  v3 = 1;
                }
              }
