/*
 * XREFs of ??0EBOX@@QEAA@AEAVDCOBJ@@AEAU_RECTL@@PEAU_LINEATTRS@@H@Z @ 0x1C0142564
 * Callers:
...
EBOX *__fastcall EBOX::EBOX(EBOX *this, struct DCOBJ *a2, struct _RECTL *a3, struct _LINEATTRS *a4, int a5)
{
  ...
  int v50; // ecx
  int v51; // edx
  float v52; // [rsp+30h] [rbp-40h] BYREF
  float v53; // [rsp+34h] [rbp-3Ch] BYREF
  int v54; // [rsp+38h] [rbp-38h] BYREF
  int v55; // [rsp+3Ch] [rbp-34h]
  int v56; // [rsp+40h] [rbp-30h]
  int v57; // [rsp+44h] [rbp-2Ch]
  _BYTE v58[16]; // [rsp+48h] [rbp-28h] BYREF
  struct _POINTL v59; // [rsp+58h] [rbp-18h] BYREF
  LONG v60; // [rsp+60h] [rbp-10h]
  LONG v61; // [rsp+64h] [rbp-Ch]
  ...
  if ( *(_DWORD *)(v26 + 208) == 2 || v25 || *((_DWORD *)this + 1) || (*(_DWORD *)(v26 + 340) & 0x20) != 0 )
  {
    ...
    *((_DWORD *)this + 7) = v21;
    ...
    if ( v25 )
    {
      ...
      v57 = v46;
      v55 = v46;
      EXFORMOBJ::bXform((EXFORMOBJ *)v58, (struct _VECTORL *)&v54, (struct _VECTORFX *)&v54, 2uLL, 0);
      v49 = v56;
      v50 = v55 + 1;
      v51 = (v54 + 1) >> 1;
      *v33 += v51;
