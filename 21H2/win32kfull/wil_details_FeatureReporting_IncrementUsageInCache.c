/*
 * XREFs of wil_details_FeatureReporting_IncrementUsageInCache @ 0x1C01C94DC
 * Callers:
...
__int64 __fastcall wil_details_FeatureReporting_IncrementUsageInCache(__int64 a1, int a2, __int64 a3, _DWORD *a4)
{
  ...
  for ( i = Feature_Win32kBugcheckOnFailedBCryptgenRandom__private_reporting; ; i = result )
  {
    a4[1] = 0;
    v5 = i | 1;
    if ( (((i | 1u) >> 14) & 1) != (a2 == 4) )
