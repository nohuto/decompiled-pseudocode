/*
 * XREFs of ?Reset@InteractiveControlDefaultScroller@@AEAAXPEAUtagWND@@@Z @ 0x1C0259308
 * Callers:
...
void __fastcall InteractiveControlDefaultScroller::Reset(InteractiveControlDefaultScroller *this, struct tagWND *a2)
{
  ...
  dword_1C0341AA0 = 0;
  dword_1C0341A90 = v4;
  dword_1C0341A8C = *((_DWORD *)InteractiveControlManager::Instance() + 59);
  dword_1C0341A94 = *((_DWORD *)InteractiveControlManager::Instance() + 61);
  dword_1C0341A9C = *((_DWORD *)InteractiveControlManager::Instance() + 63);
  dword_1C0341AA4 = *((_DWORD *)InteractiveControlManager::Instance() + 65);
