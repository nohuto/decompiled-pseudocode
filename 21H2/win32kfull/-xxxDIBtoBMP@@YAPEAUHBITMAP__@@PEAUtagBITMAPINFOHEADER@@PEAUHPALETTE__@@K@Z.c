/*
 * XREFs of ?xxxDIBtoBMP@@YAPEAUHBITMAP__@@PEAUtagBITMAPINFOHEADER@@PEAUHPALETTE__@@K@Z @ 0x1C021EEB8
 * Callers:
 ...
 *     ?CreateScreenBitmap@@YAPEAUHBITMAP__@@HHI@Z @ 0x1C021EB40 (-CreateScreenBitmap@@YAPEAUHBITMAP__@@HHI@Z.c)
...
LABEL_9:
  ...
  if ( CompatibleDC )
  {
    ...
    if ( ScreenBitmap )
    {
      ...
      GreSetDIBits(CompatibleDC, v13, (__int64)v12, (__int64)a1);
      if ( v16 )
      {
