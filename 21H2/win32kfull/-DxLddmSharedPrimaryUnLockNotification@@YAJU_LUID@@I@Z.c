/*
 * XREFs of ?DxLddmSharedPrimaryUnLockNotification@@YAJU_LUID@@I@Z @ 0x1C0276178
 * Callers:
 *     NtGdiDdDDISharedPrimaryUnLockNotification @ 0x1C0278150 (NtGdiDdDDISharedPrimaryUnLockNotification.c)
 * Callees:
