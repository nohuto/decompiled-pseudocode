/*
 * XREFs of ?_SfnINBOXSTRING@@YA_JJPEAUtagWND@@I_K_J1P6A_JXZKPEAUtagSMS@@@Z @ 0x1C011EE0C
 * Callers:
 *     SfnINLBOXSTRING @ 0x1C011EDB0 (SfnINLBOXSTRING.c)
 *     SfnINCBOXSTRING @ 0x1C0161060 (SfnINCBOXSTRING.c)
 * Callees:
