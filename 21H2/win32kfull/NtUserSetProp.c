/*
 * XREFs of NtUserSetProp @ 0x1C00350F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetProp(HWND a1, int a2, __int64 a3)
{
  ...
  v5 = 0;
  EnterCrit(0LL, 1LL);
  CHMRefHwndByHandle::CHMRefHwndByHandle((CHMRefHwndByHandle *)v16, a1, 1, 1, 1, 1);
  if ( CHMRefHwndByHandle::bValid((CHMRefHwndByHandle *)v16) )
  {
    v7 = CHMRefHwndByHandle::rpwnd((CHMRefHwndByHandle *)v16);
    v8 = (char *)v7 + 144;
    ...
    else if ( (*((_DWORD *)v7 + 82) & 0x40) != 0 )
    {
      ...
      v15 = SetSharedPropForFilteredProcesses((__int64)v7, a2, a3);
