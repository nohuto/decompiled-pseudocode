/*
 * XREFs of IncPaintCountInterMoveSize @ 0x1C023E4C0
 * Callers:
 *     InternalInvalidate3 @ 0x1C0074764 (InternalInvalidate3.c)
 * Callees:
 *     ?SetWakeBitInterMoveSize@@YAXPEAUtagTHREADINFO@@I@Z @ 0x1C01D2C50 (-SetWakeBitInterMoveSize@@YAXPEAUtagTHREADINFO@@I@Z.c)
 */
