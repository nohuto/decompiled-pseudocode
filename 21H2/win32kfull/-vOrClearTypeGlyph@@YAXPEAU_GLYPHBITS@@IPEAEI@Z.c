/*
 * XREFs of ?vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x1C0278CF0
 * Callers:
 *     draw_clrt_f_ntb_o_to_temp_start @ 0x1C0279030 (draw_clrt_f_ntb_o_to_temp_start.c)
 * Callees:
 *     <none>
 */
...
LABEL_19:
    ...
    v11 = (unsigned __int8 *)off_1C032B0D0;
    v12 = aj - v5;
    while ( 1 )
    {
      v13 = *v10;
