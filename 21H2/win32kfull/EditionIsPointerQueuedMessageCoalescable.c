/*
 * XREFs of EditionIsPointerQueuedMessageCoalescable @ 0x1C0208EA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsPointerQueuedMessageCoalescable@@YAHPEAUtagQ@@PEAUtagQMSG@@KK_KK@Z @ 0x1C0208DB4 (-IsPointerQueuedMessageCoalescable@@YAHPEAUtagQ@@PEAUtagQMSG@@KK_KK@Z.c)
 */
