/*
 * XREFs of ?ObtainSectionForNetworkedFontFile@@YAJPEAU_UNICODE_STRING@@PEAU_FILEVIEW@@PEAU_OBJECT_ATTRIBUTES@@PEAT_LARGE_INTEGER@@_N@Z @ 0x1C0286674
 * Callers:
        ...
        bool a5)
{
  ...
  *(_QWORD *)v30 = a4;
  ...
  {
LABEL_8:
    AutoResource<&void Win32FreePool(void *)>::~AutoResource<&void Win32FreePool(void *)>((__int64 *)&Object);
    goto LABEL_22;
  }
  *((_DWORD *)Object + 8) = 1;
