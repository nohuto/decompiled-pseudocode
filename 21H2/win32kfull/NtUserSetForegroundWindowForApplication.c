/*
 * XREFs of NtUserSetForegroundWindowForApplication @ 0x1C010C450
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v2 )
  {
    ...
    if ( (((*(_WORD *)(v3 + 42) & 0x2FFF) - 669) & 0xFFFFFFFD) != 0 )
    {
      ...
      *((_QWORD *)&v11 + 1) = v2;
      ...
      v4 = (unsigned __int8)xxxSetForegroundWindowWithOptions(v5, 2LL, IsPartOfCompositeApplication != 0 ? 0x40 : 0, 1);
