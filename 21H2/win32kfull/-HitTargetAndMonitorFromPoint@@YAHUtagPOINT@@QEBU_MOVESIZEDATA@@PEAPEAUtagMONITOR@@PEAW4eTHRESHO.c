/*
 * XREFs of ?HitTargetAndMonitorFromPoint@@YAHUtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C020B3E8
 * Callers:
 ...
 *     ?ComputeSizeOutcome@@YA?AW4_MOUSE_SIZE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C020AA7C (-ComputeSizeOutcome@@YA-AW4_MOUSE_SIZE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@.c)
 ...
 *     ?PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C020BFFC (-PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z.c)
        ...
        enum eTHRESHOLD_MARGIN_DIRECTION *a4)
{
  ...
  {
    if ( !v10 )
      v10 = gWinArrGlobal[dword_1C02ED594[4 * (unsigned int)v9]];
    if ( !v11 )
      v11 = gWinArrGlobal[dword_1C02ED598[4 * v9]];
    if ( !v12 )
      v12 = gWinArrGlobal[dword_1C02ED59C[4 * v9]];
  }
  v13 = v25;
