/*
 * XREFs of ?BuildWindowListWithDpiBoundaryInfo@@YAPEAUtagWLDBI@@PEAUtagWND@@0PEAUtagBWL@@PEAH@Z @ 0x1C006A228
 * Callers:
        ...
        int *a4)
{
  ...
  v7 = a4;
  v8 = a3;
  if ( a3 || (v5 = 1, v8 = (struct tagBWL *)BuildHwndList(a1), v30 = 1, v8) )
  {
    ...
    if ( v11 != 1 )
    {
      ...
      do
      {
        ...
        if ( v13 && *(_QWORD *)(v13 + 104) && a2 && !(unsigned int)IsTopLevelWindow(v13) )
        {
          v16 = (*(_DWORD *)(*((_QWORD *)v14 + 5) + 288LL) >> 8) & 0x1FF;
          v17 = v16 != ((*(_DWORD *)(*(_QWORD *)(v15 + 40) + 288LL) >> 8) & 0x1FF);
          if ( v14 == a1 )
            v17 |= v16 != ((*(_DWORD *)(*((_QWORD *)a2 + 5) + 288LL) >> 8) & 0x1FF);
          if ( v17 )
          {
