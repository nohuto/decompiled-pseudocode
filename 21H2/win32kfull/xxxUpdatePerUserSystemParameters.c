/*
 * XREFs of xxxUpdatePerUserSystemParameters @ 0x1C0026814
 * Callers:
 ...
 *     UpdatePerUserKeyboardIndicators @ 0x1C002787C (UpdatePerUserKeyboardIndicators.c)
...
__int64 __fastcall xxxUpdatePerUserSystemParameters(int a1, __int64 a2)
{
  ...
  unsigned int j; // ebx
  unsigned int ProcessorHistory; // eax
  __int64 v21; // rdx
  __int64 v22; // rcx
  void *v23; // rax
  ...
  PVOID *p_SystemArgument1; // [rsp+2C8h] [rbp+1C8h]
  ...
  v155 = 50;
  v159 = 50;
  v182 = (char *)&WPP_MAIN_CB.Dpc.SystemArgument1 + 4;
  v186 = &v50;
  ...
  v170 = (char *)&WPP_MAIN_CB.Dpc.DeferredContext + 4;
  v172 = 12LL;
  v174 = &v46;
  v213 = 5000;
  v217 = 5000;
...
LABEL_13:
  ...
  if ( v42 == (_DWORD)v8 )
    v11 = v3;
  FastGetProfileValue(v7, 4LL, 607LL, &v40, &WPP_MAIN_CB.Dpc.DeferredContext, 4, v11);
  if ( (unsigned int)(LODWORD(WPP_MAIN_CB.Dpc.DeferredContext) - 1) > 0x3E6 )
    LODWORD(WPP_MAIN_CB.Dpc.DeferredContext) = 1000;
  if ( v4 )
  {
  ...
  if ( !v6 )
  {
    ...
    if ( LODWORD(WPP_MAIN_CB.Dpc.ProcessorHistory) < 0xA )
    {
      ProcessorHistory = 10;
      LODWORD(WPP_MAIN_CB.Dpc.ProcessorHistory) = 10;
    }
    if ( ProcessorHistory > 0x7FFFFFFF )
      LODWORD(WPP_MAIN_CB.Dpc.ProcessorHistory) = 0x7FFFFFFF;
