/*
 * XREFs of ?xxxGetNextSysMsg@@YAPEAUtagQMSG@@PEAUtagTHREADINFO@@PEAU1@1PEAVCMultiPerObjectLockExclusivePpiPtiQ@@@Z @ 0x1C01677B8
 * Callers:
    ...
    if ( !a2 )
    {
      ...
      if ( v7 != -1 )
      {
        ...
        *(_DWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 400LL) = *((_DWORD *)a3 + 6);
        qword_1C033AF28 = InternalSetTimer(0LL, qword_1C033AF28, v7, (__int64)JournalTimer, 32, 276);
      }
    }
    return 0LL;
  }
