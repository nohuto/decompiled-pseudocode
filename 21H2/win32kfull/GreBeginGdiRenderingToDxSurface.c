/*
 * XREFs of GreBeginGdiRenderingToDxSurface @ 0x1C0017FB8
 * Callers:
 *     NtGdiBeginGdiRendering @ 0x1C0017FA0 (NtGdiBeginGdiRendering.c)
 * Callees:
 ...
 *     ?bReset@DC@@QEAAHXZ @ 0x1C0019134 (-bReset@DC@@QEAAHXZ.c)
