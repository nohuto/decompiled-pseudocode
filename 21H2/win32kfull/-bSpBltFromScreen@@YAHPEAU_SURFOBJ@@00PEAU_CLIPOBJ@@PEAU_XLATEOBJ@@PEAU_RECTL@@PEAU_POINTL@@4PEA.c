/*
 * XREFs of ?bSpBltFromScreen@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C00EEAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  __int64 *v63[24]; // [rsp+178h] [rbp+70h] BYREF
  __int64 *v64[24]; // [rsp+238h] [rbp+130h] BYREF
  ...
  if ( a4 && a4->iDComplexity )
  {
    ...
    if ( ERECTL::bEmpty((ERECTL *)&v67) )
      return 1LL;
    v68 = rclBounds;
    ERECTL::operator*=(&v68.left, &a6->left);
    v12 = &v68;
    v49 = &v68;
  }
  hdev = a2->hdev;
...
LABEL_33:
      if ( !v52 )
      {
        ...
        SPRITEDDIACCESS::~SPRITEDDIACCESS(v63);
        goto LABEL_37;
      }
    }
    if ( v55 )
...
LABEL_49:
  ...
  SPRITEDDIACCESS::~SPRITEDDIACCESS(v64);
  v11 = v39;
LABEL_37:
