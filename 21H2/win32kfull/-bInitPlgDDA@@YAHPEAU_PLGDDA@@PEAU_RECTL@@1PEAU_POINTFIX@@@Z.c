/*
 * XREFs of ?bInitPlgDDA@@YAHPEAU_PLGDDA@@PEAU_RECTL@@1PEAU_POINTFIX@@@Z @ 0x1C02D613C
 * Callers:
 ...
 *     QDIV @ 0x1C02D6058 (QDIV.c)
 *     ROT_DIV @ 0x1C02D60A8 (ROT_DIV.c)
 *     ?bAddOverflow@@YAH_J0@Z @ 0x1C02D60F8 (-bAddOverflow@@YAH_J0@Z.c)
 *     ?bMulOverflow@@YAH_J0@Z @ 0x1C02D7448 (-bMulOverflow@@YAH_J0@Z.c)
 *     bScalePlgDDALToPlgDDA @ 0x1C02D74CC (bScalePlgDDALToPlgDDA.c)
 *     ?bSubOverflow@@YAH_J0@Z @ 0x1C02D8154 (-bSubOverflow@@YAH_J0@Z.c)
 */
...
LABEL_20:
              ...
              v36 = 3 * v29;
              v37 = 2 * v29;
              v38 = dword_1C02FC84C[2 * v36];
              v39 = *((int *)p_left + 1);
              v40 = *(int *)p_left;
              v41 = dword_1C02FC850[2 * v36];
              v42 = dword_1C02FC844[2 * v36];
              v43 = (v35 - 1) * dword_1C02FC848[2 * v36];
              ...
              v44 = v40 * v38;
              v45 = dword_1C02FC7C4[2 * v37];
              v46 = *((int *)&v270 + 2 * v45);
              v47 = v39 * v41 + v44 + (v34 - 1) * dword_1C02FC854[2 * v36];
              v48 = SLODWORD((&aiPlgSort)[v37]);
              v250 = v47;
              v49 = *((int *)&v270 + 2 * v48);
              v50 = *((int *)&v270 + 2 * v48 + 1);
              v51 = v46 - v49;
              v52 = dword_1C02FC7C8[2 * v37];
