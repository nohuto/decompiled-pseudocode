/*
 * XREFs of ?SpDdCreateFullscreenSprite@@YAJPEAUHDC__@@KPEAPEAXPEAPEAU1@@Z @ 0x1C026DAFC
 * Callers:
 *     NtGdiDdCreateFullscreenSprite @ 0x1C0277FF0 (NtGdiDdCreateFullscreenSprite.c)
 * Callees:
