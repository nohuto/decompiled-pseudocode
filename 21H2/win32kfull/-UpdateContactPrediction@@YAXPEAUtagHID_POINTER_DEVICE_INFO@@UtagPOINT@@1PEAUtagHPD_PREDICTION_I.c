/*
 * XREFs of ?UpdateContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x1C01ED4FC
 * Callers:
 *     DoPrediction @ 0x1C01EE630 (DoPrediction.c)
 * Callees:
 *     ?DeltaOvershootCompensation@Prediction@@YA_J_J0@Z @ 0x1C01EC1B4 (-DeltaOvershootCompensation@Prediction@@YA_J_J0@Z.c)
 ...
 *     ?Smooth@tagExpoSmoother@Prediction@@QEAA?AVCFixPred@2@V32@@Z @ 0x1C01ED36C (-Smooth@tagExpoSmoother@Prediction@@QEAA-AVCFixPred@2@V32@@Z.c)
 */
