/*
 * XREFs of xxxTimersProc @ 0x1C01688E8
 * Callers:
 *     RawInputThread @ 0x1C0009A50 (RawInputThread.c)
 * Callees:
 *     ?CoalescableDueTime@@YAKPEBUtagTIMER@@@Z @ 0x1C00D0FD0 (-CoalescableDueTime@@YAKPEBUtagTIMER@@@Z.c)
 *     ThreadLockExchangeWorker @ 0x1C00D16B0 (ThreadLockExchangeWorker.c)
