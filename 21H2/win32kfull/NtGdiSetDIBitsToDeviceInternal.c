/*
 * XREFs of NtGdiSetDIBitsToDeviceInternal @ 0x1C002D140
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a16)
{
  ...
  int v18; // r14d
  char *v19; // rcx
  const struct tagBITMAPINFO *v21; // [rsp+88h] [rbp-50h] BYREF
  ...
  v21 = 0LL;
  v18 = a12 & 3;
  if ( !(unsigned int)bCaptureBitmapInfo(Src, v18, (unsigned int)a14, &v21) )
    goto LABEL_8;
  if ( Address )
  {
    if ( (_DWORD)Size )
...
LABEL_8:
  ...
  if ( v16 == 1 )
    v16 = GreSetDIBitsToDeviceInternal(a1, a5, a6, a7, a8, a9, (__int64)Address, (__int64)v21, v18, Size, a14, a15, a16);
  if ( v17 )
