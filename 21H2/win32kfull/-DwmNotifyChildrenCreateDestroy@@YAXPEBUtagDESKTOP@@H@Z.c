/*
 * XREFs of ?DwmNotifyChildrenCreateDestroy@@YAXPEBUtagDESKTOP@@H@Z @ 0x1C00EA0AC
 * Callers:
 *     DwmNotifyChildrenAddRemove @ 0x1C00E9C54 (DwmNotifyChildrenAddRemove.c)
 * Callees:
 *     SendDwmIconChange @ 0x1C0038A00 (SendDwmIconChange.c)
 *     DwmAsyncTextChange @ 0x1C0047240 (DwmAsyncTextChange.c)
 *     IsDesktopWindow @ 0x1C004C5F0 (IsDesktopWindow.c)
 *     IsMessageParentWindow @ 0x1C004C650 (IsMessageParentWindow.c)
 ...
 *     IsMotherDesktopWindow @ 0x1C00EA338 (IsMotherDesktopWindow.c)
