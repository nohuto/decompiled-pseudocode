/*
 * XREFs of ?ValidateParents@@YAHPEAUtagWND@@H@Z @ 0x1C00C9954
 * Callers:
...
LABEL_10:
  ...
  if ( !v6 )
  {
    ...
    if ( !(unsigned int)IntersectWithParents((__int64)v7, &v14.left) )
      return 1LL;
    v12 = (HRGN)ghrgnInv1;
    v11 = LogicalToPhysicalInPlaceRgnWorker(a1, &v12, 0LL);
    InternalInvalidate2(v7, v12, v12, &v14, 0x8048u);
    if ( v11 )
      GreDeleteObject(v12);
    goto LABEL_10;
  }
