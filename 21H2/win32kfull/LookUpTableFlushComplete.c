/*
 * XREFs of LookUpTableFlushComplete @ 0x1C037BCC4
 * Callers:
 *     TlgUnregisterAggregateProvider @ 0x1C037BB6C (TlgUnregisterAggregateProvider.c)
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C037C5D0 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C037C660 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 ...
 *     UpdateInternalStatsOnFlush @ 0x1C037C74C (UpdateInternalStatsOnFlush.c)
 */
