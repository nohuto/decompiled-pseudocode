/*
 * XREFs of ?InitializeWindowGroupFunctionality@WindowGroupingFeature@@YAJ_K@Z @ 0x1C02406F0
 * Callers:
 ...
 *     ?Initialize@CWindowGroupManager@@SAJ_K@Z @ 0x1C0240690 (-Initialize@CWindowGroupManager@@SAJ_K@Z.c)
 */
