/*
 * XREFs of ?xxxDesktopWndProcWorker@@YA_JPEAUtagWND@@I_K_J@Z @ 0x1C004639C
 * Callers:
 *     xxxDesktopWndProc @ 0x1C0046330 (xxxDesktopWndProc.c)
 * Callees:
...
LABEL_49:
          ...
          break;
        case 0x401u:
          if ( !gProtocolType && WPP_MAIN_CB.Dpc.TargetInfoAsUlong && !WPP_MAIN_CB.Dpc.SystemArgument2 )
