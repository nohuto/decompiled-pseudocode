/*
 * XREFs of ?_FailFast_GetLastError@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x140007AE4
 * Callers:
 *     ?CloseHandle@details@wil@@YAXPEAX@Z @ 0x140005C5C (-CloseHandle@details@wil@@YAXPEAX@Z.c)
