/*
 * XREFs of ?NotifyChannelClosed@DXGCHANNELENDPOINTPROXY@@QEAAXXZ @ 0x1C0355E88
 * Callers:
  ...
  if ( *((_DWORD *)this + 15) != *((_DWORD *)this + 14) )
  {
    ...
    if ( UsedEntryCount )
    {
      do
      {
        ...
        v8 = v7;
        v9 = (v7 >> 6) & 0xFFFFFF;
        if ( (unsigned int)v9 < *((_DWORD *)this + 14) )
        {
          v10 = *(_DWORD *)(*v2 + 16 * v9 + 8);
          if ( ((v7 >> 25) & 0x60) == (v10 & 0x60) && (v10 & 0x2000) == 0 && (v10 & 0x1F) != 0 )
          {
            if ( EntryType == (*(_DWORD *)(*v2 + 16 * v9 + 8) & 0x1F) )
            {
              v11 = *(_QWORD *)(*v2 + 16LL * (unsigned int)v9);
              goto LABEL_13;
            }
