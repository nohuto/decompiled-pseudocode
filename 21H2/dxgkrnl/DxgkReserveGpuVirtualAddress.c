/*
 * XREFs of DxgkReserveGpuVirtualAddress @ 0x1C0164900
 * Callers:
...
LABEL_65:
  ...
  {
    WdLogSingleEntry2(3LL, -1073741811LL, 13147LL);
    goto LABEL_35;
  }
  v37 = 0LL;
  ...
  {
LABEL_14:
    v11 = (struct DXGPAGINGQUEUE *)*((_QWORD *)v35 + 350);
    v37 = v11;
    if ( *((_BYTE *)v35 + 209) )
    {
      v27 = (struct DXGADAPTER *)((char *)v35 + 4344);
      if ( v8 )
        v28 = *((_DWORD *)v8 + 7);
      else
        v28 = *((_DWORD *)v35 + 1108);
...
LABEL_57:
      ...
      {
        WdLogSingleEntry2(3LL, -1073741811LL, 13214LL);
        COREADAPTERACCESS::~COREADAPTERACCESS((COREADAPTERACCESS *)v44);
        DXGADAPTER_REFERENCE::Assign(&v35, 0LL);
        if ( v39 )
          DXGADAPTER::ReleaseReference(v39);
      ...
      v12 = (*(__int64 (__fastcall **)(_QWORD, struct DXGPROCESS *, __int64, D3DDDI_RESERVEGPUVIRTUALADDRESS *))(*(_QWORD *)(*((_QWORD *)v11 + 81) + 8LL) + 800LL))(
              *((_QWORD *)v11 + 82),
              Current,
              v10,
              v6);
