/*
 * XREFs of DpiDxgkDdiStopDevice @ 0x1C039727C
 * Callers:
...
__int64 __fastcall DpiDxgkDdiStopDevice(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v13 = 0;
    McTemplateK0pt_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventEnterDdiStopDevice, a3, a2, v13);
  }
  ...
  {
    LODWORD(v12) = v5;
    McTemplateK0pt_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventExitDdiStopDevice, v8, a2, v12);
  }
