/*
 * XREFs of _lambda_551b55b43c33c06817801b78f16a1bd1_::operator() @ 0x1C02CE3E8
 * Callers:
...
char __fastcall lambda_551b55b43c33c06817801b78f16a1bd1_::operator()(__int64 **a1)
{
  __int64 *v1; // rdx
  __int64 *v3; // rax
  int v4; // r9d
  ...
  if ( *(_BYTE *)v10 )
  {
    ...
    {
      LOBYTE(v10) = tlgKeywordOn((__int64)&dword_1C012F918, 0x800000000004LL);
      if ( (_BYTE)v10 )
      {
        v11 = *a1;
        v42 = 0;
        ...
        LOBYTE(v10) = tlgWriteTransfer_EtwWriteTransfer(
                        (__int64)&dword_1C012F918,
                        (unsigned __int8 *)dword_1C009779D,
                        0LL,
                        0LL,
                        6u,
                        &v30);
