/*
 * XREFs of ?DxgkAllocateMdlMemoryTracker@@YAJQEAXPEAU_MDL@@W4DXG_DRIVER_MEMORY_TRACKER_TYPE@@PEAPEAUDXG_DRIVER_MEMORY_TRACKER@@@Z @ 0x1C00425A8
 * Callers:
 *     DxgkAllocatePagesForMdlCB @ 0x1C0042B70 (DxgkAllocatePagesForMdlCB.c)
 *     DxgkMapMdlToIoMmuCB @ 0x1C0043050 (DxgkMapMdlToIoMmuCB.c)
 * Callees:
