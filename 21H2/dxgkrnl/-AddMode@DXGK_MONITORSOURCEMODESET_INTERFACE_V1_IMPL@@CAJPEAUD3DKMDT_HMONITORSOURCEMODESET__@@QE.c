/*
 * XREFs of ?AddMode@DXGK_MONITORSOURCEMODESET_INTERFACE_V1_IMPL@@CAJPEAUD3DKMDT_HMONITORSOURCEMODESET__@@QEAU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C020DA90
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v15, 7021);
    ...
    else
    {
      ...
      RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>::RESOURCE_LOCK<DxgMonitor::MonitorDescriptorState>(
        ...
        *(struct _ERESOURCE **)&v9[2].ActiveCount,
        1);
      v10 = Resource;
      inserted = DxgMonitor::MonitorModes::_InsertMonitorSourceMode((DxgMonitor::MonitorModes *)Resource, a2);
      if ( v10 )
      {
