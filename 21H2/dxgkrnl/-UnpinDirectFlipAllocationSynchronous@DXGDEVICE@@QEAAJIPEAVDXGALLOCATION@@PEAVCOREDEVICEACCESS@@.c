/*
 * XREFs of ?UnpinDirectFlipAllocationSynchronous@DXGDEVICE@@QEAAJIPEAVDXGALLOCATION@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C02E7B7C
 * Callers:
        ...
        struct COREDEVICEACCESS *a4)
{
  ...
  if ( DXGDEVICE::RemoveDirectFlipAllocationFromList((struct _KTHREAD **)this, a2, a3) )
  {
    ...
    if ( v10 )
    {
      if ( v14[0] <= 1 )
      {
        v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 648LL)
                                                                            + 8LL)
                                                                + 712LL))(
                *(_QWORD *)(*((_QWORD *)this + 2) + 656LL),
                *((_QWORD *)a3 + 3),
