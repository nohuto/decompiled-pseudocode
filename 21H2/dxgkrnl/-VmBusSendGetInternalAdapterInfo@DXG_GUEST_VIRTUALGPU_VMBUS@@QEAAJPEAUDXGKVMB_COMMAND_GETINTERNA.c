/*
 * XREFs of ?VmBusSendGetInternalAdapterInfo@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAUDXGKVMB_COMMAND_GETINTERNALADAPTERINFO_RETURN@@@Z @ 0x1C03784A4
 * Callers:
...
LABEL_18:
  ...
  if ( *((_DWORD *)DXGGLOBAL_GetGlobal() + 450) >= 0x22u )
  {
    ...
    *((_OWORD *)a2 + 3) = v31;
    *((_QWORD *)a2 + 8) = v32;
    if ( *((_DWORD *)DXGGLOBAL_GetGlobal() + 450) >= 0x21u && (BYTE12(v37) & 0x20) != 0 )
      *((_BYTE *)this + 80) = 1;
  }
  else
  {
