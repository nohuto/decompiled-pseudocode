/*
 * XREFs of SmmQueryRegistry @ 0x1C01F5030
 * Callers:
...
__int64 SmmQueryRegistry()
{
  ...
  if ( v5 >= 3 )
    v1 = v6;
  result = v10 & 1;
  dword_1C0130B08 = (v7 != 0 ? 4 : 0) | (dword_1C0130B08 ^ (v1 ^ (unsigned __int8)dword_1C0130B08) & 3) & 0xFFFFFF03 | (8 * (v0 & 3 | (4 * (result | (2 * (v9 & 1 | (2 * (v8 & 1))))))));
  return result;
}
