/*
 * XREFs of ?VidMmETWAllocationHandle@VIDMM_EXPORT@@QEAAPEAXPEAVVIDMM_GLOBAL@@I@Z @ 0x1C000B938
 * Callers:
...
{
  return (*(__int64 (__fastcall **)(struct VIDMM_GLOBAL *, _QWORD))(*((_QWORD *)this + 1) + 352LL))(a2, a3);
}
