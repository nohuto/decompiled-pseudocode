/*
 * XREFs of DxgkFreeGpuVirtualAddress @ 0x1C0175870
 * Callers:
 ...
 *     ?VmBusSendFreeGpuVirtualAddress@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJII_K0@Z @ 0x1C0248378 (-VmBusSendFreeGpuVirtualAddress@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJII_K0@Z.c)
    ...
    if ( v16 >= 0 )
    {
      ...
      if ( *((_BYTE *)v42 + 209) )
      {
        ...
        v18 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendFreeGpuVirtualAddress(
                (struct DXGADAPTER *)((char *)v17 + 4240),
                HostProcess,
                v37,
                *((_QWORD *)v10 + 1),
                *((_QWORD *)v10 + 2));
      ...
      {
        v18 = (*(__int64 (__fastcall **)(_QWORD, struct _KTHREAD **, unsigned int *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v42 + 338) + 640LL)
                                                                                                + 8LL)
                                                                                    + 808LL))(
                *(_QWORD *)(*((_QWORD *)v42 + 338) + 648LL),
                Current,
                v10);
      }
      v16 = v18;
