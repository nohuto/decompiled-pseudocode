/*
 * XREFs of NtFlipObjectQueryEndpointConnected @ 0x1C0069AE0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsEndpointConnected@FlipManagerObject@@QEAAJ_NPEA_N@Z @ 0x1C0068840 (-IsEndpointConnected@FlipManagerObject@@QEAAJ_NPEA_N@Z.c)
