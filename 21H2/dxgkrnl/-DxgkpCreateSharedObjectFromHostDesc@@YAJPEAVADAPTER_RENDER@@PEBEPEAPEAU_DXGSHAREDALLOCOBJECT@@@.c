/*
 * XREFs of ?DxgkpCreateSharedObjectFromHostDesc@@YAJPEAVADAPTER_RENDER@@PEBEPEAPEAU_DXGSHAREDALLOCOBJECT@@@Z @ 0x1C0238A64
 * Callers:
...
LABEL_42:
    ...
    if ( v67 )
    {
      ...
      DXGGLOBAL::DestroySyncObject(Global, v62, 0, 0);
    }
    goto LABEL_51;
  }
  v15 = *((_DWORD *)a2 + 18);
