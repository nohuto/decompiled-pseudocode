/*
 * XREFs of ?RegisterTtmDevice@CTTMDEVICE@@AEAAJPEAVDXGSESSIONDATA@@@Z @ 0x1C029EFD4
 * Callers:
...
__int64 __fastcall CTTMDEVICE::RegisterTtmDevice(CTTMDEVICE *this, struct DXGSESSIONDATA *a2)
{
  ...
  v21[1] = 0LL;
  v21[3] = 0LL;
  if ( *(struct _KTHREAD **)(*((_QWORD *)DXGGLOBAL::GetGlobal((__int64)this, (__int64)a2) + 102) + 344LL) != KeGetCurrentThread() )
  {
