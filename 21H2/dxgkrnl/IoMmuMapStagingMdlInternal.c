/*
 * XREFs of IoMmuMapStagingMdlInternal @ 0x1C00570E0
 * Callers:
 *     IoMmuMapStagingMdl @ 0x1C005707C (IoMmuMapStagingMdl.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0028C00 (_guard_dispatch_icall_nop.c)
 *     IoMmuReferenceMdl @ 0x1C0057224 (IoMmuReferenceMdl.c)
  ...
  while ( 1 )
  {
    ...
    if ( v8 )
    {
      ...
      *(_WORD *)(v9 + 8) = 8 * ((v10 >> 12) + 6);
      v7 = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD))qword_1C00B3070)(a1[1], 3LL, a1[6]);
      if ( v7 < 0 )
        break;
      v4 = a2[6];
    }
