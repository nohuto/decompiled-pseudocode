/*
 * XREFs of ?ApplyCsFunctionAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C0284180
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z @ 0x1C0048BB4 (-SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z.c)
