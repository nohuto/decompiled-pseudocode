/*
 * XREFs of ?VmBusSendReclaimAllocations@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEBVDXGDEVICE@@PEBVDXGPAGINGQUEUE@@PEAU_D3DKMT_RECLAIMALLOCATIONS2@@PEBI@Z @ 0x1C037BC74
 * Callers:
        ...
        const unsigned int *a6)
{
  ...
  struct DXGPROCESS *v24; // [rsp+60h] [rbp-1A8h]
    ...
    if ( a5->pResources )
    {
      *(_BYTE *)(v13 + 36) = 1;
      ...
      if ( a5->NumAllocations )
      {
        while ( 1 )
        {
          DXGPROCESS::GetResourceUnsafe((__int64)v24, (DXGRESOURCEREFERENCE *)&v21, a6[v15]);
          if ( !v21 )
            break;
          *(_DWORD *)(v13 + 4LL * v15 + 40) = HIDWORD(v21[2].Ptr);
          DXGRESOURCEREFERENCE::~DXGRESOURCEREFERENCE(&v21);
          if ( ++v15 >= a5->NumAllocations )
            goto LABEL_17;
        }
        WdLogSingleEntry3(3LL, v25, a6[v15], -1073741811LL);
        DXGRESOURCEREFERENCE::~DXGRESOURCEREFERENCE(&v21);
LABEL_23:
    ...
    else
    {
      *(_BYTE *)(v13 + 36) = 0;
      ...
      if ( a5->NumAllocations )
      {
        while ( 1 )
        {
          DXGPROCESS::GetAllocationUnsafe((__int64)v24, (DXGALLOCATIONREFERENCE *)&v21, a6[v16]);
          if ( !v21 )
            break;
          *(_DWORD *)(v13 + 4LL * v16 + 40) = HIDWORD(v21[2].Ptr);
          DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE(&v21);
          if ( ++v16 >= a5->NumAllocations )
            goto LABEL_17;
        }
        WdLogSingleEntry3(3LL, v25, a6[v16], -1073741811LL);
        DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE(&v21);
        goto LABEL_23;
      }
    }
LABEL_17:
    DXGAUTOPUSHLOCK::~DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v28);
    v17 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendSyncMessage(v26, (struct DXGVMBUSMESSAGE *)&v29, v14, &v22);
    v8 = v17;
    if ( v17 < 0 || v22 > v23 )
    {
