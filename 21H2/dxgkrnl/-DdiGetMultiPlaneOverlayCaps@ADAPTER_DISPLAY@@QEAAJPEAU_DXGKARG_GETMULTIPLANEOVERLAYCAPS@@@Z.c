/*
 * XREFs of ?DdiGetMultiPlaneOverlayCaps@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETMULTIPLANEOVERLAYCAPS@@@Z @ 0x1C021B8B4
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5084LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETMULTIPLANEOVERLAYCAPS *))(*((_QWORD *)this + 2) + 1152LL))(
