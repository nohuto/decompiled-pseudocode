/*
 * XREFs of McTemplateK0pqtqqqqqqqq_EtwWriteTransfer @ 0x1C003B8C8
 * Callers:
 *     ?CreateNewPostCompositionConfig@DISPLAY_SOURCE@@AEAAXEPEBUtagRECT@@0@Z @ 0x1C02110FC (-CreateNewPostCompositionConfig@DISPLAY_SOURCE@@AEAAXEPEBUtagRECT@@0@Z.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x1C000BC78 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x1C0024910 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pqtqqqqqqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  return McGenEventWrite_EtwWriteTransfer(
           ...
           &DisplayConfigPostCompositionChange,
           a3,
           0xCu,
           &v4);
}
