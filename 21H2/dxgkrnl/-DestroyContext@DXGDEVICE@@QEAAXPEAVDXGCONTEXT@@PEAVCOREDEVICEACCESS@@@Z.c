/*
 * XREFs of ?DestroyContext@DXGDEVICE@@QEAAXPEAVDXGCONTEXT@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C00E5B54
 * Callers:
 ...
 * Callees:
 *     ??_GDXGCONTEXT@@QEAAPEAXI@Z @ 0x1C00023B0 (--_GDXGCONTEXT@@QEAAPEAXI@Z.c)
