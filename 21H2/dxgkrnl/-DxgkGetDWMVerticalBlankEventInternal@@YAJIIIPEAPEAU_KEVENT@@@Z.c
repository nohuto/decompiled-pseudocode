/*
 * XREFs of ?DxgkGetDWMVerticalBlankEventInternal@@YAJIIIPEAPEAU_KEVENT@@@Z @ 0x1C016CCA8
 * Callers:
 *     DxgkGetDWMVerticalBlankEvent @ 0x1C016CB80 (DxgkGetDWMVerticalBlankEvent.c)
 * Callees:
