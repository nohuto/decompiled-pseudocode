/*
 * XREFs of ?DxgkHandleDiagnosticNotifications@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C0051880
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkHandleDiagnosticNotifications(struct _DXGK_DIAGNOSTIC_HEADER *a1)
{
  ...
  if ( (*(_BYTE *)&Value & 1) != 0 )
  {
    if ( v9 )
    {
      if ( (unsigned int)dword_1C012F988 > 4
        && tlgKeywordOn((__int64)&dword_1C012F988, 1LL)
        && tlgKeywordOn((__int64)&dword_1C012F988, v20) )
      {
        v34 = 1;
        v35[0] = 1;
        v39 = (v24 & 4) != 0;
    ...
    if ( (unsigned int)dword_1C012F988 > 4
      && tlgKeywordOn((__int64)&dword_1C012F988, 1LL)
      && tlgKeywordOn((__int64)&dword_1C012F988, v14) )
    {
      v18 = (unsigned __int8 *)&unk_1C00982D0;
      v41 = a1->TargetId;
...
LABEL_29:
  ...
  else
  {
    ...
    {
      if ( (unsigned int)dword_1C012F988 > 4
        && tlgKeywordOn((__int64)&dword_1C012F988, 2LL)
        && tlgKeywordOn((__int64)&dword_1C012F988, v26) )
      {
        v32 = 1;
        v31 = v29;
        v39 = (v30 & 4) != 0;
    ...
    if ( (unsigned int)dword_1C012F988 > 4
      && tlgKeywordOn((__int64)&dword_1C012F988, 2LL)
      && tlgKeywordOn((__int64)&dword_1C012F988, v25) )
    {
      v18 = (unsigned __int8 *)&unk_1C00981D3;
      v41 = a1->TargetId;
      v42 = a1->SequenceNumber;
      p_TargetId = v38;
      v40 = v17;
