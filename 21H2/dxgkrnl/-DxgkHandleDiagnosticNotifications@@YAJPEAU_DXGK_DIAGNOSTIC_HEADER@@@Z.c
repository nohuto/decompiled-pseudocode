/*
 * XREFs of ?DxgkHandleDiagnosticNotifications@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C004C9E0
 * Callers:
 *     <none>
 * Callees:
 *     _tlgKeywordOn @ 0x1C000B1A8 (_tlgKeywordOn.c)
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$00@@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$00@@4@Z @ 0x1C004C674 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$00@@U2@@-$_tlgWriteTemplate@$$A6AJP.c)
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$00@@U2@U2@U2@U2@U2@U2@U2@U2@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$00@@44444444@Z @ 0x1C004C720 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$00@@U2@U2@U2@U2@U2@U2@U2@U2@@-$_tlg.c)
 */
...
LABEL_8:
  ...
  if ( (Value & 1) != 0 )
  {
    if ( v5 )
    {
      if ( (unsigned int)dword_1C00B1B00 > 4
        && tlgKeywordOn((__int64)&dword_1C00B1B00, 1LL)
        && tlgKeywordOn((__int64)&dword_1C00B1B00, v13) )
      {
        v28 = v16;
        v29[0] = v16;
        v33 = v16 & (v17 >> 2);
    ...
    if ( (unsigned int)dword_1C00B1B00 > 4
      && tlgKeywordOn((__int64)&dword_1C00B1B00, 1LL)
      && tlgKeywordOn((__int64)&dword_1C00B1B00, v7) )
    {
      v11 = (unsigned __int8 *)&unk_1C00802B3;
      v35 = a1->TargetId;
...
LABEL_24:
  ...
  else
  {
    ...
    {
      if ( (unsigned int)dword_1C00B1B00 > 4
        && tlgKeywordOn((__int64)&dword_1C00B1B00, 2LL)
        && tlgKeywordOn((__int64)&dword_1C00B1B00, v20) )
      {
        v26 = v23;
        v25 = 0;
        v33 = v23 & (v24 >> 2);
    ...
    if ( (unsigned int)dword_1C00B1B00 > 4
      && tlgKeywordOn((__int64)&dword_1C00B1B00, 2LL)
      && tlgKeywordOn((__int64)&dword_1C00B1B00, v18) )
    {
      v11 = (unsigned __int8 *)&unk_1C008026B;
      v35 = a1->TargetId;
      v36 = a1->SequenceNumber;
      p_TargetId = v32;
      v34 = v19;
