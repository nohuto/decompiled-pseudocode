/*
 * XREFs of ?OpenKeyedMutexFromNtHandle@DXGGLOBAL@@QEAAJPEAXPEAPEAVDXGKEYEDMUTEX@@PEAI0I@Z @ 0x1C03408B4
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( !a3 )
  {
    WdLogSingleEntry1(1LL, 4654LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"ppKeyedMutex", 4654LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( !a4 )
  {
    WdLogSingleEntry1(1LL, 4655LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"phKeyedMutex", 4655LL, 0LL, 0LL, 0LL, 0LL);
  }
  *a3 = 0LL;
  *a4 = 0;
  ...
  else if ( v9 >= 0 )
  {
    ...
    if ( !Object )
    {
      WdLogSingleEntry1(1LL, 4690LL);
      DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pSharedKeyedMutexObject", 4690LL, 0LL, 0LL, 0LL, 0LL);
    }
    v13 = *v12;
