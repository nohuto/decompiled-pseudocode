/*
 * XREFs of DxgkGetProcessSchedulingPriorityBand @ 0x1C0286880
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetProcessSchedulingPriorityBand@DXGPROCESS@@QEAA?AW4_D3DKMT_SCHEDULING_PRIORITYBAND@@XZ @ 0x1C02853EC (-GetProcessSchedulingPriorityBand@DXGPROCESS@@QEAA-AW4_D3DKMT_SCHEDULING_PRIORITYBAND@@XZ.c)
 */
