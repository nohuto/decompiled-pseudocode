/*
 * XREFs of ?AcquireFirstDescriptorInfo@DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORDESCRIPTORSET__@@PEAPEBU_D3DKMDT_MONITOR_DESCRIPTOR@@@Z @ 0x1C0216070
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v15, 7028);
