/*
 * XREFs of ?Evict@DXGDEVICE@@QEAAJPEAVDXGALLOCATIONREFERENCE@@IUD3DDDI_EVICT_FLAGS@@PEA_K@Z @ 0x1C01DCAB0
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  if ( DXGDEVICE::UmdManagesResidency(this) )
  {
          ...
          a2 = (struct DXGALLOCATIONREFERENCE *)((char *)a2 + 8) )
    {
      ...
      if ( v12 )
        (*(void (__fastcall **)(_QWORD, _QWORD, __int64 *, __int64, int, unsigned __int64 *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 648LL) + 8LL)
                                                                                            + 792LL))(
