/*
 * XREFs of DpiPdoSetMonitorDriverInterfaceStateWorker @ 0x1C03980A0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall DpiPdoSetMonitorDriverInterfaceStateWorker(PVOID IoObject, PVOID Context, PIO_WORKITEM IoWorkItem)
{
  ...
  while ( 1 )
  {
    ...
    v4 = (PDEVICE_OBJECT *)qword_1C0130880;
    if ( (__int64 *)qword_1C0130880 == &qword_1C0130880 )
    {
      v4 = 0LL;
      byte_1C0130840 = 0;
    }
    ...
    {
      if ( *(__int64 **)(qword_1C0130880 + 8) != &qword_1C0130880
        || (v5 = *(_QWORD *)qword_1C0130880, *(_QWORD *)(*(_QWORD *)qword_1C0130880 + 8LL) != qword_1C0130880) )
      {
        __fastfail(3u);
      }
      qword_1C0130880 = *(_QWORD *)qword_1C0130880;
      *(_QWORD *)(v5 + 8) = &qword_1C0130880;
    }
