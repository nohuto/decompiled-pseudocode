/*
 * XREFs of ?PresentDisplayOnly@BLTQUEUE@@QEAAJPEAU_DXGKARG_PRESENT_DISPLAYONLY@@@Z @ 0x1C02FEDB0
 * Callers:
 ...
 *     ?TdrIsDodPresentTimeoutForcedFlip@@YA_NXZ @ 0x1C0265BF4 (-TdrIsDodPresentTimeoutForcedFlip@@YA_NXZ.c)
...
__int64 __fastcall BLTQUEUE::PresentDisplayOnly(struct _KEVENT *this, struct _DXGKARG_PRESENT_DISPLAYONLY *a2)
{
  ...
  else
  {
    ...
    {
      v7 = 258;
      v12 = 10000000LL * (unsigned int)dword_1C00B3168;
