/*
 * XREFs of ?Create@CBufferRealization@@SAJAEBUCSM_REALIZATION_INFO@@_NPEAPEAV1@@Z @ 0x1C0007780
 * Callers:
...
LABEL_4:
  ...
  if ( !*((_QWORD *)a1 + 1) )
    goto LABEL_4;
LABEL_5:
  v7 = operator new[](88LL, 1917670211LL, 256LL);
  if ( v7 )
  {
