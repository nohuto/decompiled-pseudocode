/*
 * XREFs of ?ConsumerCheckForSurfacesToFree@DXGSWAPCHAIN@@AEAAJPEAU_D3DKMT_RELEASESWAPCHAIN@@@Z @ 0x1C034A154
 * Callers:
        ...
        struct _D3DKMT_RELEASESWAPCHAIN *a2)
{
  ...
  {
    WdLogSingleEntry1(1LL, 3571LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"m_SwapChainLock.IsOwner()", 3571LL, 0LL, 0LL, 0LL, 0LL);
  }
