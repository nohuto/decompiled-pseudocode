/*
 * XREFs of ?CreatePlaneLiveDumpAtPassive@@YAXIIPEAU_MOCKDRIVERSTATE_VALIDATE_PLANE@@PEAVDXGADAPTER@@PEAU_MOCKDRIVERSTATE_PLANE@@@Z @ 0x1C0317F8C
 * Callers:
        ...
        struct _MOCKDRIVERSTATE_PLANE *a5)
{
  ...
  *((_QWORD *)v9 + 328) = *((_QWORD *)a3 + 6);
  ...
  v22 = *(_QWORD *)((char *)a4 + 404);
  if ( (unsigned int)dword_1C012F918 > 5 && tlgKeywordOn((__int64)&dword_1C012F918, 0x400000020000LL) )
  {
    LOBYTE(v10) = 1;
    ...
    v30 = *((_DWORD *)a4 + 722);
    v14 = *((unsigned __int8 *)a4 + 2742);
    v15 = *((_DWORD *)v9 + 655);
    v16 = *((_DWORD *)v9 + 654);
    v27 = *((_WORD *)a4 + 1346);
    v23 = *((_QWORD *)a4 + 212);
    v24 = (void *)*((_QWORD *)a4 + 211);
    v17 = *((_DWORD *)a4 + 107);
    v18 = *((_DWORD *)a4 + 106);
    v19 = *((_DWORD *)a4 + 105);
    v20 = *((_DWORD *)a4 + 104);
  ...
  DxgCreateLiveDumpWithWdLogs(0x193u, 2067LL, 0LL, *((int *)v9 + 654), *((_QWORD *)v9 + 328), 1);
}
