/*
 * XREFs of ?GetAdapterPerfData@DXGADAPTER@@QEAAJPEAU_D3DKMT_ADAPTER_PERFDATA@@@Z @ 0x1C02BB8DC
 * Callers:
...
__int64 __fastcall DXGADAPTER::GetAdapterPerfData(DXGADAPTER *this, struct _D3DKMT_ADAPTER_PERFDATA *a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( (unsigned int)PhysicalAdapterIndex < *((_DWORD *)this + 72) )
    {
      ...
      v5 = *((_QWORD *)this + 335) + 344 * PhysicalAdapterIndex;
      ...
      else
      {
        ...
        *(_QWORD *)&v12.Flags.0 = 0LL;
        ...
        v9 = DXGADAPTER::DdiQueryAdapterInfo(this, &v12, v7.QuadPart);
        v10 = v9;
        if ( v9 < 0 )
        {
      ...
      a2->MemoryFrequency = *(_QWORD *)(v5 + 120);
