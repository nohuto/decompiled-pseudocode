/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C00413F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  {
    v13 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00B42D8)(a1);
...
LABEL_8:
  ...
  if ( PoolWithTag )
  {
    ...
    v20[1].Parameter = (PVOID)((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00B42D8)(a1);
    ExQueueWorkItem(v20, NormalWorkQueue);
  }
  else
  {
    v23 = WdLogNewEntry5_WdLowResource(v17, v16, v18, v19);
    *(_QWORD *)(v23 + 24) = 6113LL;
