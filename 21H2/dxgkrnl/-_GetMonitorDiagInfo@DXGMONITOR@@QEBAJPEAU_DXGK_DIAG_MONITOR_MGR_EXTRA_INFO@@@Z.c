/*
 * XREFs of ?_GetMonitorDiagInfo@DXGMONITOR@@QEBAJPEAU_DXGK_DIAG_MONITOR_MGR_EXTRA_INFO@@@Z @ 0x1C0207244
 * Callers:
...
__int64 __fastcall DXGMONITOR::_GetMonitorDiagInfo(DXGMONITOR *this, struct _DXGK_DIAG_MONITOR_MGR_EXTRA_INFO *a2)
{
  ...
  *(_OWORD *)v16 = 0LL;
  if ( v6 )
  {
    ...
    v12[0] = 0x80000LL;
    *((_DWORD *)a2 + 1) = !v8;
    (*(void (__fastcall **)(__int64, _QWORD *))(*(_QWORD *)v6 + 64LL))(v6, v12);
    *(_QWORD *)&DestinationString.Length = 655360LL;
    DestinationString.Buffer = v13;
    (*(void (__fastcall **)(__int64, struct _UNICODE_STRING *))(*(_QWORD *)v6 + 72LL))(v6, &DestinationString);
