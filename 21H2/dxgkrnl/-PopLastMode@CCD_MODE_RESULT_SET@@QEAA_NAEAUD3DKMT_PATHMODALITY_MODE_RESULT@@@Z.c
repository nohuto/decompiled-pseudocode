/*
 * XREFs of ?PopLastMode@CCD_MODE_RESULT_SET@@QEAA_NAEAUD3DKMT_PATHMODALITY_MODE_RESULT@@@Z @ 0x1C03A9958
 * Callers:
...
LABEL_7:
  ...
  *((_DWORD *)this + 12) = v7;
  v8 = 112LL * (v7 % 0x32);
  *(_OWORD *)a2 = *(_OWORD *)(v8 + v6 + 24);
  *((_OWORD *)a2 + 1) = *(_OWORD *)(v8 + v6 + 40);
  *((_OWORD *)a2 + 2) = *(_OWORD *)(v8 + v6 + 56);
  *((_OWORD *)a2 + 3) = *(_OWORD *)(v8 + v6 + 72);
  *((_OWORD *)a2 + 4) = *(_OWORD *)(v8 + v6 + 88);
  *((_OWORD *)a2 + 5) = *(_OWORD *)(v8 + v6 + 104);
  *((_OWORD *)a2 + 6) = *(_OWORD *)(v8 + v6 + 120);
  if ( *((_DWORD *)this + 12) == 50 * (*((_DWORD *)this + 12) / 0x32u) )
  {
           ...
           v6) )
    {
      v9 = (_QWORD *)(v6 + 8);
      v10 = *(_QWORD *)(v6 + 8);
      if ( *(_QWORD *)(v10 + 8) != v6 + 8 || (v11 = *(_QWORD **)(v6 + 16), (_QWORD *)*v11 != v9) )
        __fastfail(3u);
      *v11 = v10;
      *(_QWORD *)(v10 + 8) = v11;
      *v9 = 0LL;
