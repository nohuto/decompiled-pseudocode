/*
 * XREFs of DxgkSignalSynchronizationObjectFromGpuByReference @ 0x1C00E9230
 * Callers:
 *     ?SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z @ 0x1C0002720 (-SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z.c)
 *     ?AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z @ 0x1C00647B0 (-AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z.c)
