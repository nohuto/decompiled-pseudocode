/*
 * XREFs of ?DxgkReadPnPRegistryPath@@YAJPEAVDXGADAPTER@@IW4_DXGK_PNP_KEY_TYPE@@PEAGPEAI@Z @ 0x1C02CF35C
 * Callers:
...
__int64 __fastcall DxgkReadPnPRegistryPath(__int64 a1, unsigned int a2, int a3, void *a4, ULONG64 a5)
{
  ...
  v11 = *v10;
  v12 = *(_QWORD *)(344LL * a2 + *(_QWORD *)(a1 + 2680) + 8);
  v18 = 0LL;
