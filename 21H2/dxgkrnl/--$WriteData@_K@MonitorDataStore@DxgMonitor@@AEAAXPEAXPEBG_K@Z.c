/*
 * XREFs of ??$WriteData@_K@MonitorDataStore@DxgMonitor@@AEAAXPEAXPEBG_K@Z @ 0x1C03B9510
 * Callers:
 *     ?WriteQWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_K@Z @ 0x1C03B98C0 (-WriteQWord@MonitorDataStore@DxgMonitor@@UEAAXPEAXPEBG_K@Z.c)
