/*
 * XREFs of ?SysMmCreateVirtualMemoryPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KKKW4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@@Z @ 0x1C03C0D00
 * Callers:
 *     SysMmTestCreateVirtualMemoryPhysicalObject @ 0x1C0071300 (SysMmTestCreateVirtualMemoryPhysicalObject.c)
 * Callees:
        ...
        __int64 a9)
{
  ...
  {
    _InterlockedIncrement(&dword_1C0130B48);
