/*
 * XREFs of ?Acquire@DXGDEVICEACCESSLOCKSHARED@@QEAAXXZ @ 0x1C0025C58
 * Callers:
 ...
 *     ?ReleasePowerTransitionLockShared@ADAPTER_RENDER@@QEAAXXZ @ 0x1C00259B4 (-ReleasePowerTransitionLockShared@ADAPTER_RENDER@@QEAAXXZ.c)
