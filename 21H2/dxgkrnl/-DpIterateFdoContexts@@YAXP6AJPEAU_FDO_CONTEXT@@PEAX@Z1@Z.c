/*
 * XREFs of ?DpIterateFdoContexts@@YAXP6AJPEAU_FDO_CONTEXT@@PEAX@Z1@Z @ 0x1C02D1D8C
 * Callers:
 *     ?DpiKsrCancel@@YAXPEAX@Z @ 0x1C02D2450 (-DpiKsrCancel@@YAXPEAX@Z.c)
 *     DpiKsrCallback @ 0x1C02D2A50 (DpiKsrCallback.c)
 *     DpiKsrDoKsrSave @ 0x1C02D2AA4 (DpiKsrDoKsrSave.c)
 * Callees:
