/*
 * XREFs of ?DxgkCddGdiCommand@@YAJPEAU_DXGKCDD_SUBMITRENDERTOHWQUEUE@@PEAD@Z @ 0x1C00EA370
 * Callers:
 ...
 *     ??A?$PagedPoolZeroedArray@PEAVDXGHWQUEUE@@$03@@QEAAAEAPEAVDXGHWQUEUE@@I@Z @ 0x1C022C244 (--A-$PagedPoolZeroedArray@PEAVDXGHWQUEUE@@$03@@QEAAAEAPEAVDXGHWQUEUE@@I@Z.c)
