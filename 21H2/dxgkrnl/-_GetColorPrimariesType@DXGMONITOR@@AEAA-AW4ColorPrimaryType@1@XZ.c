/*
 * XREFs of ?_GetColorPrimariesType@DXGMONITOR@@AEAA?AW4ColorPrimaryType@1@XZ @ 0x1C018F39C
 * Callers:
 *     ?_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ @ 0x1C018F2DC (-_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ.c)
 * Callees:
 *     ?_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z @ 0x1C018F620 (-_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z.c)
 *     ?_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z @ 0x1C018F6DC (-_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z.c)
 */
