/*
 * XREFs of DpiFdoStartAdapter @ 0x1C018071C
 * Callers:
 *     DpiFdoStartAdapterThreadImpl @ 0x1C0199C54 (DpiFdoStartAdapterThreadImpl.c)
 *     DpiLdaStartAdapterInChain @ 0x1C02D81F8 (DpiLdaStartAdapterInChain.c)
 * Callees:
 ...
 *     DpiHybridInternalPanelOverride @ 0x1C0021858 (DpiHybridInternalPanelOverride.c)
 ...
 *     ?DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z @ 0x1C0024618 (-DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z.c)
        ...
        _QWORD *a7)
{
  ...
  char v171; // [rsp+40h] [rbp-138h]
  char v172; // [rsp+41h] [rbp-137h]
  char v173; // [rsp+42h] [rbp-136h]
  char v174; // [rsp+42h] [rbp-136h]
  char v175; // [rsp+43h] [rbp-135h]
  unsigned int *v176; // [rsp+48h] [rbp-130h]
  char v177; // [rsp+50h] [rbp-128h]
  int v178; // [rsp+54h] [rbp-124h] BYREF
  char v179; // [rsp+58h] [rbp-120h]
  struct _DXGK_DISPLAY_SCENARIO_CONTEXT *v180; // [rsp+60h] [rbp-118h]
  union _LARGE_INTEGER Interval; // [rsp+68h] [rbp-110h] BYREF
  PVOID P; // [rsp+70h] [rbp-108h] BYREF
  HANDLE Handle; // [rsp+78h] [rbp-100h] BYREF
  __int64 v184; // [rsp+80h] [rbp-F8h] BYREF
  int v185; // [rsp+88h] [rbp-F0h] BYREF
  __int64 v186; // [rsp+90h] [rbp-E8h]
  char v187; // [rsp+98h] [rbp-E0h]
  void *v188; // [rsp+A0h] [rbp-D8h]
  _QWORD *v189; // [rsp+A8h] [rbp-D0h]
  __int64 v190; // [rsp+B0h] [rbp-C8h]
  struct _UNICODE_STRING DestinationString; // [rsp+B8h] [rbp-C0h] BYREF
  __int128 v192; // [rsp+C8h] [rbp-B0h] BYREF
  __int64 v193; // [rsp+D8h] [rbp-A0h]
  __int128 v194; // [rsp+E0h] [rbp-98h] BYREF
  __int64 v195; // [rsp+F0h] [rbp-88h]
  _DWORD v196[7]; // [rsp+F8h] [rbp-80h] BYREF
  _OWORD v197[2]; // [rsp+118h] [rbp-60h] BYREF
...
LABEL_9:
  ...
  if ( DeviceExtension[1152] == 1 )
  {
      ...
      && !(unsigned __int8)DpiFdoIsCompatibleWithHighResolutionBoot(a1) )
    {
      ...
      DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v185, 8006LL);
      memset(v197, 0, sizeof(v197));
      LODWORD(v197[0]) = 18;
      x86BiosCall(16LL, v197);
      DXGETWPROFILER_BASE::PopProfilerEntry((DXGETWPROFILER_BASE *)&v185, v38);
      if ( v187 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
        McTemplateK0q_EtwWriteTransfer(v39, &EventProfilerExit, v40, v185);
    }
    if ( v9 )
    {
      v41 = *(_DWORD *)(v11 + 28);
...
LABEL_73:
  ...
  *(_OWORD *)&v196[1] = *((_OWORD *)DeviceExtension + 166);
  *(_QWORD *)&v196[5] = *((_QWORD *)DeviceExtension + 334);
...
LABEL_10:
  ...
  v82 = (_BYTE *)(v9 + 3904);
  v83 = DxgkAddAdapter(a1, v188, (struct _DXGK_ADAPTER_CAPS *)(v9 + 3904), v180);
  started = v83;
  if ( v83 < 0 )
    goto LABEL_73;
  v84 = *(_QWORD *)(v9 + 3896);
...
LABEL_156:
  ...
  if ( *(_DWORD *)(v9 + 3480) )
  {
    ...
    v95 = *(_QWORD *)(v9 + 40);
    v192 = 0LL;
    LODWORD(v192) = 67108861;
    v193 = 0LL;
    v96 = DpiDxgkDdiDisplayDetectControl(v9, v95, v94, (unsigned int *)&v192);
    started = v96;
    if ( v96 < 0 )
    {
  ...
  v19 = v176;
  RelatedObjects = DpiFdoCreateRelatedObjects(a1, *(unsigned int *)(v9 + 2684), v176, v180);
  ...
  v105 = DpiOpenPnpRegistryKey(a1, 2LL, 131097LL, &Handle);
  v108 = v105;
  if ( v105 >= 0 )
  {
    ...
    if ( *(_QWORD *)(v116 + 56) && *(_BYTE *)(v116 + 1) )
    {
      *(_BYTE *)(v116 + 1) = 0;
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
      {
        ...
        McTemplateK0pq_EtwWriteTransfer((unsigned int)v170, &EventDpiFdoThermalPassiveCooling, v111, a1, v170);
      }
  ...
  v118 = DpiFdoInitializeGpuVirtualization((__int64)a1, v110, v111);
  started = v118;
  if ( v118 < 0
    || *(_BYTE *)(v9 + 482)
...
LABEL_12:
  ...
  if ( (int)started < 0 )
  {
    ...
    if ( v9 )
    {
      ...
      if ( v171 == 1 )
        DpiFdoDestroyRelatedObjects(a1, v180);
      if ( v19 )
      {
        v25 = *(_DWORD *)(v9 + 2684);
        if ( v25 )
        {
          do
          {
            ...
            LOBYTE(v24) = 1;
            DxgkReleaseGdiViewId(v23, *(_QWORD *)(v9 + 5936), v176[v25], v24);
          }
          while ( v25 );
          v11 = v190;
        }
    ...
    if ( v175 == 1 && v11 )
    {
      if ( !DeviceExtension[1152] )
        goto LABEL_225;
      v178 = DpiFdoStopDeviceAndReleasePostDisplayOwnership(a1);
...
LABEL_225:
    ...
    *(_QWORD *)DiagnosticInfoArgs = *((_QWORD *)DeviceExtension + 6);
    ...
    v178 = *(_DWORD *)(DiagnosticInfoArgs + 216);
    if ( (*(int (__fastcall **)(__int64, __int64))(v11 + 1344))(v144, DiagnosticInfoArgs) >= 0 )
    {
      if ( *(_DWORD *)(v143 + 220) > (unsigned int)v178 )
        *(_DWORD *)(v143 + 220) = 0;
...
LABEL_238:
  ...
  if ( v9 )
  {
    ...
    if ( v161 )
    {
      ...
      *((_QWORD *)v162 + 7) = *((_QWORD *)DeviceExtension + 334);
      v162[16] = DxgkDiagCalcDuration1us(&v184);
  ...
  else
  {
    ...
    if ( v165 )
    {
      ...
      v167 = DxgkDiagCalcDuration1us(&v184);
      *((_DWORD *)v166 + 10) = 0;
      *((_QWORD *)v166 + 4) = 0LL;
      *(_DWORD *)v166 = 6;
      *((_DWORD *)v166 + 1) = 64;
