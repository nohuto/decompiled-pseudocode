/*
 * XREFs of ?TdrCollectDbgInfoStage1@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N@Z @ 0x1C0264990
 * Callers:
 ...
 *     DpiGetAdapterDebugData @ 0x1C0051404 (DpiGetAdapterDebugData.c)
 *     DpiGetDbgInfoAdapters @ 0x1C0051488 (DpiGetDbgInfoAdapters.c)
 *     DpiGetGlobalDebugData @ 0x1C0051578 (DpiGetGlobalDebugData.c)
 ...
 *     ??0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z @ 0x1C0263DA4 (--0CTDR_DUMP_BUFFER@@QEAA@GPEAXK@Z.c)
 ...
 *     ?TdrIsDisplayOnlyTdr@@YA_NW4_TDR_TIMEOUT_REASON@@@Z @ 0x1C0265BD4 (-TdrIsDisplayOnlyTdr@@YA_NW4_TDR_TIMEOUT_REASON@@@Z.c)
