/*
 * XREFs of ?AcquireCoreResourceExclusive@DXGADAPTER@@AEAAXW4DXGADAPTER_EXCLUSIVEACCESS_REASON@@IPEAD@Z @ 0x1C00E8CC8
 * Callers:
...
void __fastcall DXGADAPTER::AcquireCoreResourceExclusive(__int64 a1, unsigned int a2, char a3)
{
  ...
  if ( a2 == 3 )
  {
    ...
    {
LABEL_68:
      v45 = *(DXGDODPRESENT **)(*(_QWORD *)(a1 + 2696) + 392LL);
      if ( v45 )
...
LABEL_11:
    if ( !*(_QWORD *)(a1 + 2704) )
    {
      v16 = *(DXGDODPRESENT **)(*(_QWORD *)(a1 + 2696) + 392LL);
      if ( v16 )
