/*
 * XREFs of ?AddProcessEntry@DripsBlockerTrackingHelper@@QEAAJ_KPEBDPEAU_EPROCESS@@W4_DXGKETW_PROFILER_TYPE@@@Z @ 0x1C02BFC34
 * Callers:
 ...
 * Callees:
 *     McTemplateK0qqsz_EtwWriteTransfer @ 0x1C004ED0C (McTemplateK0qqsz_EtwWriteTransfer.c)
