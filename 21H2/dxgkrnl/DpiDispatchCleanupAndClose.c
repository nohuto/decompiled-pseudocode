/*
 * XREFs of DpiDispatchCleanupAndClose @ 0x1C015B190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiDispatchCleanupAndClose(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    McTemplateK0pq_EtwWriteTransfer(a1, &EventEnterDpiDispatchClose, a3, a1, 0);
  v6 = *(_QWORD *)(a1 + 64);
  v7 = **(_BYTE **)(a2 + 184);
  ...
  {
    LODWORD(v12) = v3;
    McTemplateK0pq_EtwWriteTransfer(v9, &EventExitDpiDispatchClose, v10, a1, v12);
  }
  return v3;
}
