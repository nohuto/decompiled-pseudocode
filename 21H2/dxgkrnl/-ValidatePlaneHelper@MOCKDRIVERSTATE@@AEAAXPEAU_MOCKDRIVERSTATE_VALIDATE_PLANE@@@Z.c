/*
 * XREFs of ?ValidatePlaneHelper@MOCKDRIVERSTATE@@AEAAXPEAU_MOCKDRIVERSTATE_VALIDATE_PLANE@@@Z @ 0x1C004E588
 * Callers:
 ...
 *     ?DXGADAPTER_ValidateMockDriverState@@YAXPEAVDXGADAPTER@@W4MOCKDRIVERSTATE_VALIDATE_TYPE@@PEAX@Z @ 0x1C0042540 (-DXGADAPTER_ValidateMockDriverState@@YAXPEAVDXGADAPTER@@W4MOCKDRIVERSTATE_VALIDATE_TYPE@@PEAX@Z.c)
 * Callees:
 *     ?QueuePlaneViolationWorkItem@@YAXIIPEAU_MOCKDRIVERSTATE_VALIDATE_PLANE@@PEAVDXGADAPTER@@PEAU_MOCKDRIVERSTATE_PLANE@@@Z @ 0x1C004E450 (-QueuePlaneViolationWorkItem@@YAXIIPEAU_MOCKDRIVERSTATE_VALIDATE_PLANE@@PEAVDXGADAPTER@@PEAU_MOC.c)
 */
