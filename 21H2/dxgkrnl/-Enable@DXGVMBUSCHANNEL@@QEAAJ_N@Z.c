/*
 * XREFs of ?Enable@DXGVMBUSCHANNEL@@QEAAJ_N@Z @ 0x1C03510F4
 * Callers:
...
__int64 __fastcall DXGVMBUSCHANNEL::Enable(DXGVMBUSCHANNEL *this, char a2)
{
  ...
  if ( v5 )
  {
    if ( !*((_BYTE *)this + 26) && (!*((_BYTE *)this + 24) || *((_BYTE *)this + 25)) )
    {
      ...
      *((_BYTE *)this + 24) = 1;
      *((_BYTE *)this + 26) = 1;
      v7 = ((__int64 (__fastcall *)(__int64))qword_1C0131BD0)(v5);
      v4 = v7;
      if ( v7 < 0 )
      {
        WdLogSingleEntry5(
      ...
      {
        ((void (__fastcall *)(_QWORD))qword_1C0131C80)(*((_QWORD *)this + 2));
      }
    }
    v8 = a2 & *((_BYTE *)this + 24);
  }
