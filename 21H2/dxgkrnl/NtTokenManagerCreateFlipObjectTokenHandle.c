/*
 * XREFs of NtTokenManagerCreateFlipObjectTokenHandle @ 0x1C0075220
 * Callers:
 *     <none>
 * Callees:
        ...
        _OWORD *a8)
{
  ...
  __int128 v28; // [rsp+A8h] [rbp-70h] BYREF
  ...
  if ( a6 )
  {
    ...
    v12 = (*(__int64 (__fastcall **)(__int64, unsigned __int64 *))(*((_QWORD *)Global + 38073) + 424LL))(
            0x80000000LL,
            &v19);
    if ( v12 >= 0 )
    {
  ...
  if ( v19 )
  {
    ...
    (*(void (__fastcall **)(unsigned __int64))(*((_QWORD *)v16 + 38073) + 544LL))(v19);
  }
  if ( Handle )
    NtClose(Handle);
