/*
 * XREFs of ?CommitVidPnOnAdapter@VIDPN_MGR@@AEAAJKW4_DMM_CLIENT_TYPE@@QEBVDMMVIDPN@@KPEAU_DXGK_SET_TIMING_PATH_INFO@@PEAIPEAUD3DKMT_VIDPN_SOURCE_MASKS@@AEAK3PEAU_DXGK_SET_TIMING_RESULTS@@PEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@E@Z @ 0x1C014A6EC
 * Callers:
 ...
 *     DxgkIncrementGlobalConnectionChangeId @ 0x1C000CC14 (DxgkIncrementGlobalConnectionChangeId.c)
...
LABEL_84:
                  ...
                  *(_OWORD *)v243 = 0LL;
                  ...
                  v225 = *(_DWORD *)(*(_QWORD *)(v19 + 2696) + 368LL);
                  LOBYTE(v219) = 0;
                  BYTE4(v224) = BYTE4(v224) & 0xF8 | (v227 >> 14) & 4;
