/*
 * XREFs of ?_ReadUsageOverridesFromPnpRegistry@DXGMONITOR@@AEAAJPEAW4_D3DKMT_DISPLAY_TARGET_USAGE@@@Z @ 0x1C0191AFC
 * Callers:
        ...
        enum _D3DKMT_DISPLAY_TARGET_USAGE *a2)
{
  ...
  *(_DWORD *)a2 = 0;
  ...
  if ( v4 < 0 )
  {
    v11 = WdLogNewEntry5_WdTrace(v6, v5, v7, v8);
    *(_QWORD *)(v11 + 24) = this;
    *(_QWORD *)(v11 + 32) = v9;
  }
  else if ( g_OSTestSigningEnabled )
  {
    LODWORD(v9) = DXGMONITOR::_ReadUsageOverridesFromRegistry(v6, Handle, a2);
  }
  if ( Handle )
    ZwClose(Handle);
