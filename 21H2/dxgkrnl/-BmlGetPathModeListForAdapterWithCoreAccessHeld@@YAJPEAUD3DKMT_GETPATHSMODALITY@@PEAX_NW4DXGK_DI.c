/*
 * XREFs of ?BmlGetPathModeListForAdapterWithCoreAccessHeld@@YAJPEAUD3DKMT_GETPATHSMODALITY@@PEAX_NW4DXGK_DIAG_CCD_BML_ORIGIN@@IAEAVCCD_MODE_RESULT_SET@@@Z @ 0x1C03AB1B8
 * Callers:
        ...
        __int64 a6)
{
  ...
  __int64 v17; // rbx
  __int64 v18; // rax
  char v20[16]; // [rsp+50h] [rbp-38h] BYREF

  v6 = (unsigned __int16 *)&unk_1C0130300;
  v11 = 0;
  do
  {
    v12 = v6[1];
    ...
    PathModeListForAdapter = BmlGetPathModeListForAdapter(
                               ...
                               a4,
                               a5,
                               (struct BML_VIDPN_PATH_ORDER *)v20,
                               a6);
