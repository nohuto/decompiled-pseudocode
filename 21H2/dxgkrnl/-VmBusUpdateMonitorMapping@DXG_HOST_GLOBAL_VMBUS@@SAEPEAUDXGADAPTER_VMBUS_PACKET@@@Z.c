/*
 * XREFs of ?VmBusUpdateMonitorMapping@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0383010
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_GLOBAL_VMBUS::VmBusUpdateMonitorMapping(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v1 )
  {
    v6[0] = (__int64 *)&v7;
    v6[1] = &v9;
    v8 = lambda_369d4bf1093f23b208c35a56a1ae801e_::operator()(v6, v2, v3, v4);
