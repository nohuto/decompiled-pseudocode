/*
 * XREFs of ?OutputDuplPreIndirectPresent@@YAJPEAVDXGDEVICE@@IPEAPEAVDXGADAPTER@@PEA_K@Z @ 0x1C0322E18
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  *a3 = 0LL;
  ...
  if ( (*(_DWORD *)(v7 + 436) & 0x40000) == 0
    ...
    || DWORD1(v14) != 1 )
  {
    VidPnSourceOwner = ADAPTER_DISPLAY::GetVidPnSourceOwner(*(ADAPTER_DISPLAY **)(v7 + 2792), v5);
