/*
 * XREFs of ?DdiSetInterruptTargetPresentId@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_SETINTERRUPTTARGETPRESENTID@@@Z @ 0x1C0048A00
 * Callers:
 *     ?ADAPTER_DISPLAY_DdiSetInterruptTargetPresentId@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_SETINTERRUPTTARGETPRESENTID@@@Z @ 0x1C004B630 (-ADAPTER_DISPLAY_DdiSetInterruptTargetPresentId@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_SETINTERRU.c)
 * Callees:
