/*
 * XREFs of DxgkUpdateGdiInfo @ 0x1C0148B60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindPlateauIndexForScaleFactor@DpiInternal@@YAIIPEBU_DPI_SCALE_FACTOR_COLLECTION@@@Z @ 0x1C000C224 (-FindPlateauIndexForScaleFactor@DpiInternal@@YAIIPEBU_DPI_SCALE_FACTOR_COLLECTION@@@Z.c)
...
__int64 __fastcall DxgkUpdateGdiInfo(char *a1, struct _LUID *a2, struct _GDIINFO *a3, struct _DPI_INFORMATION *a4)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    *(_DWORD *)&v54.Length = 0;
    if ( v52 )
    {
      *(_DWORD *)&v54.Length = dword_1C00B2A84;
    }
    else
    {
