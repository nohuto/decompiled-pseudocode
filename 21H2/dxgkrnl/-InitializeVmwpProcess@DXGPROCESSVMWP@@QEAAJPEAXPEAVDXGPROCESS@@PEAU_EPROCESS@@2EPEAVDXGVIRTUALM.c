/*
 * XREFs of ?InitializeVmwpProcess@DXGPROCESSVMWP@@QEAAJPEAXPEAVDXGPROCESS@@PEAU_EPROCESS@@2EPEAVDXGVIRTUALMACHINE@@@Z @ 0x1C0285778
 * Callers:
  ...
  if ( !*((_BYTE *)this + 520) )
  {
    ...
    else
    {
      if ( (unsigned int)Feature_WSL_Device_GPU__private_IsEnabledDeviceUsage() )
        ...
        v12 = PagedPool;
      v11 = (DXGVIRTUALMACHINE *)operator new(0x1E8uLL, 0x4B677844u, 1, v12);
      if ( v11 )
