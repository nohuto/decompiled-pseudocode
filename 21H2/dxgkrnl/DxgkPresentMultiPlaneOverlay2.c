/*
 * XREFs of DxgkPresentMultiPlaneOverlay2 @ 0x1C02A7D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay2(struct _D3DKMT_PRESENT_MULTIPLANE_OVERLAY2 *a1)
{
  ...
  _BYTE v91[8]; // [rsp+260h] [rbp+160h] BYREF
      ...
      if ( v74 >= 0 )
      {
        ...
        if ( v57 )
        {
            ...
            || ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(v57 + 2696), v56, v90.VidPnSourceId) )
          {
            ...
            v74 = v2;
            if ( v2 == -1071775482 )
              DXGDEVICE::CloseInternalCddPrimaryHandle((DXGDEVICE *)v23[2], (struct COREDEVICEACCESS *)v91);
