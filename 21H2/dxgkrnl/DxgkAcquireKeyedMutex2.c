/*
 * XREFs of DxgkAcquireKeyedMutex2 @ 0x1C0342090
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkAcquireKeyedMutex2(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v20, 2068);
  if ( DXGPROCESS::GetCurrent(v5, v4, v6, v7) )
  {
    ...
    *(_OWORD *)v25 = v11[2];
    ...
    if ( (_QWORD)v24 )
    {
      ...
      v26 = *v13;
      v12 = (union _LARGE_INTEGER *)&v26;
    }
    v19[0] = (unsigned int)v25[1];
