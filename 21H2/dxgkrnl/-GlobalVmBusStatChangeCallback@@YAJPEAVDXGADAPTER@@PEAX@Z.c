/*
 * XREFs of ?GlobalVmBusStatChangeCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C0364BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GlobalVmBusStatChangeCallback(struct DXGADAPTER *a1, unsigned __int8 *a2)
{
  ...
  if ( !a1 )
  {
    WdLogSingleEntry1(1LL, 12832LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pDxgAdapter != NULL", 12832LL, 0LL, 0LL, 0LL, 0LL);
  }
  v7 = a1;
  v8 = 0;
  DXGADAPTERSTOPRESETLOCKSHARED::Acquire((DXGADAPTERSTOPRESETLOCKSHARED *)v6);
  if ( *((_DWORD *)a1 + 50) == 1 && !*((_QWORD *)a1 + 350) )
  {
    v4 = *(DXGDODPRESENT **)(*((_QWORD *)a1 + 349) + 448LL);
    if ( v4 )
