/*
 * XREFs of _BmlLogDiagnosticsPacket @ 0x1C01C0A6C
 * Callers:
...
__int64 __fastcall BmlLogDiagnosticsPacket(VIDPN_MGR *a1, int a2, __int64 a3, unsigned __int8 *a4)
{
  ...
  v7 = 408 * *a4 + 64;
  v8 = operator new[](v7, 0x63644356u, 256LL, (__int64)a4);
  v9 = 0;
  v10 = v8;
  if ( v8 )
  {
    ...
    for ( i = *(_QWORD *)(a3 + 48); v13 < *a4; ++v13 )
    {
      ...
      if ( (*(_QWORD *)v16 & 0x700000000000LL) == 0x700000000000LL )
      {
        ...
        *(_DWORD *)(v17 + v10 + 252) = *(_DWORD *)(v16 + 28);
        v24 = (_QWORD *)(v17 + v10 + 224);
        *v24 = 0x700000000000LL;
        ...
        if ( FirstPath )
        {
          ...
          while ( 1 )
          {
            ...
            v20 = *(_QWORD *)(v19 + 16);
            if ( *(_DWORD *)(v16 + 16) == *(_DWORD *)(v20 + 404)
              && *(_DWORD *)(v16 + 20) == *(_DWORD *)(v20 + 408)
              && *(_DWORD *)(v16 + 24) == *(_DWORD *)(*((_QWORD *)FirstPath + 11) + 24LL)
              && *(_DWORD *)(v16 + 28) == *(_DWORD *)(*((_QWORD *)FirstPath + 12) + 24LL) )
            {
              break;
            }
            v22 = (DMMVIDPNTOPOLOGY *)*((_QWORD *)FirstPath + 1);
            FirstPath = (DMMVIDPNTOPOLOGY *)((char *)v22 - 8);
            if ( v22 == (DMMVIDPNTOPOLOGY *)((char *)v11 + 24) )
              FirstPath = 0LL;
            if ( !FirstPath )
              goto LABEL_13;
          }
          _BmlFillOnePathModalityFromVidPn<_DXGK_DIAG_CCD_PATHMODALITY_DESCRIPTOR3>(FirstPath, v24);
        }
      }
      else
      {
