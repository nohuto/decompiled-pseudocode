/*
 * XREFs of BmlPinPathContentScaling @ 0x1C01BDD7C
 * Callers:
...
__int64 __fastcall BmlPinPathContentScaling(__int64 a1, __int64 a2, unsigned __int16 a3)
{
  ...
  else
  {
    ...
    {
      if ( (dword_1C013231C & 1) == 0 )
      {
        v12 = *(VIDPN_MGR **)(a2 + 48);
        dword_1C013231C |= 1u;
        dword_1C01322D0[0] = VIDPN_MGR::GetAdapterDefaultScaling(v12);
        dword_1C01322D4 = 3;
        dword_1C01322D8 = 4;
        dword_1C01322DC = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v13 >= 4 )
          break;
        v14 = (unsigned int)dword_1C01322D0[v13];
