/*
 * XREFs of ?ProcessTerminated@OUTPUTDUPL_SESSION_MGR@@QEAAXPEAU_EPROCESS@@@Z @ 0x1C0188744
 * Callers:
...
void __fastcall OUTPUTDUPL_SESSION_MGR::ProcessTerminated(OUTPUTDUPL_SESSION_MGR *this, struct _EPROCESS *a2)
{
  ...
  if ( *(_DWORD *)(v9 + v6) )
  {
    WdLogSingleEntry1(1LL, 4319LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pProcesses[i].RefCount == 0", 4319LL, 0LL, 0LL, 0LL, 0LL);
  }
  *(_QWORD *)(v9 + v6 + 8) = 0LL;
  if ( v11 )
  {
