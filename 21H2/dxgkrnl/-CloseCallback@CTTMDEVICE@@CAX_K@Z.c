/*
 * XREFs of ?CloseCallback@CTTMDEVICE@@CAX_K@Z @ 0x1C0347870
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CTTMDEVICE::CloseCallback(CTTMDEVICE *this)
{
  ...
  if ( !this )
  {
    WdLogSingleEntry1(1LL, 6114LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pThis != NULL", 6114LL, 0LL, 0LL, 0LL, 0LL);
  }
