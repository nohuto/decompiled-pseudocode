/*
 * XREFs of DmmDoForSpecifiedTarget__lambda_533853168684940ab58800475a78e255___ @ 0x1C03986D4
 * Callers:
        ...
        struct DXGDISPLAYMANAGEROBJECT ***a3)
{
  ...
  if ( v8 )
  {
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>(&v12, *(_QWORD *)(v7 + 104));
