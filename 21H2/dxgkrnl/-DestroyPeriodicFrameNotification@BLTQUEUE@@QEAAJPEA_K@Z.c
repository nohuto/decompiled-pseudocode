/*
 * XREFs of ?DestroyPeriodicFrameNotification@BLTQUEUE@@QEAAJPEA_K@Z @ 0x1C03BBB50
 * Callers:
...
__int64 __fastcall BLTQUEUE::DestroyPeriodicFrameNotification(struct _KTHREAD **this, unsigned __int64 *a2)
{
  ...
  *((_BYTE *)this[364] + v9 + 57) = 0;
  ...
  if ( *(_DWORD *)(v11 + 200) != 1 && *(_DWORD *)(v11 + 200) != 5 )
  {
  ...
  v16 = -1LL;
  if ( (*(int (__fastcall **)(__int64, unsigned __int64, _QWORD, __int64 *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v11 + 2800) + 624LL)
                                                                                       + 8LL)
                                                                           + 656LL))(
         1LL,
