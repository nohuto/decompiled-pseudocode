/*
 * XREFs of ?RemoveMappingEntry@REMOTEMONITORMAPPING@@AEAAXPEAUREMOTE_MONITOR_MAPPING_ENTRY@1@@Z @ 0x1C033D818
 * Callers:
...
void __fastcall REMOTEMONITORMAPPING::RemoveMappingEntry(struct _KTHREAD **this, struct _LUID *a2)
{
  ...
  __int64 v5; // rbx
  struct _LUID v6; // rax
  struct REMOTEMONITORMAPPING::REMOTE_MONITOR_MAPPING_ENTRY **v7; // rcx
  ...
  v3 = (DXG_GUEST_GLOBAL_VMBUS *)*((_QWORD *)DXGGLOBAL_GetGlobal() + 218);
  if ( v3 )
  {
