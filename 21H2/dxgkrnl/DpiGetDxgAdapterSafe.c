/*
 * XREFs of DpiGetDxgAdapterSafe @ 0x1C0184164
 * Callers:
...
LABEL_26:
              KeEnterCriticalRegion();
              if ( *((_BYTE *)v3 + 484) )
                _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v3[3] + 64) + 4088LL));
              ...
              {
                v20 = *(_QWORD *)(v3[3] + 64);
                if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v20 + 4088), 0xFFFFFFFF) == 1 )
