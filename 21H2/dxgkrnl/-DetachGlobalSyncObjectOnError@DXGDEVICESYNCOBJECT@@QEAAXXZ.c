/*
 * XREFs of ?DetachGlobalSyncObjectOnError@DXGDEVICESYNCOBJECT@@QEAAXXZ @ 0x1C03441C0
 * Callers:
...
void __fastcall DXGDEVICESYNCOBJECT::DetachGlobalSyncObjectOnError(DXGSYNCOBJECT **this)
{
  ...
  if ( this[7] )
  {
    v2 = *(_QWORD *)(*((_QWORD *)this[2] + 2) + 648LL);
    MonitoredFenceStorage = DXGSYNCOBJECT::GetMonitoredFenceStorage(this[4]);
    v4 = *(_QWORD *)(*((_QWORD *)this[2] + 5) + 64LL);
    if ( v4 )
      v4 = *(_QWORD *)(v4 + 8);
    (*(void (__fastcall **)(__int64, struct VIDMM_MONITORED_FENCE_STORAGE *))(*(_QWORD *)(v2 + 8) + 968LL))(
      v4,
