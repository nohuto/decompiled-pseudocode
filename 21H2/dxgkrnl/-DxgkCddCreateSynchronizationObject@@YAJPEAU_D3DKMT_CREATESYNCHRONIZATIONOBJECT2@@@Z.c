/*
 * XREFs of ?DxgkCddCreateSynchronizationObject@@YAJPEAU_D3DKMT_CREATESYNCHRONIZATIONOBJECT2@@@Z @ 0x1C01DE3E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddCreateSynchronizationObject(struct _D3DKMT_CREATESYNCHRONIZATIONOBJECT2 *a1)
{
  ...
  return DxgkCreateSynchronizationObjectImpl((struct DXGADAPTER *)a1, 0xFu, 0LL, 0LL, 0LL);
}
