/*
 * XREFs of ?DxgkpDuplicateHandleToVm@@YAJPEAU_D3DKMT_DUPLICATEHANDLE@@@Z @ 0x1C02775CC
 * Callers:
 ...
 *     ??0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z @ 0x1C02378DC (--0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z.c)
