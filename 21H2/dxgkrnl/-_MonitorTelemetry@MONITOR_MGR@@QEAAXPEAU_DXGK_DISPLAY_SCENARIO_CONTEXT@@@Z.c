/*
 * XREFs of ?_MonitorTelemetry@MONITOR_MGR@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C03B4664
 * Callers:
...
void __fastcall MONITOR_MGR::_MonitorTelemetry(MONITOR_MGR *this, struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a2)
{
  ...
  for ( i = (struct _KTHREAD ***)&v11; ; i = (struct _KTHREAD ***)&v12 )
  {
