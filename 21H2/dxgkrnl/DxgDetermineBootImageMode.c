/*
 * XREFs of DxgDetermineBootImageMode @ 0x1C01F60AC
 * Callers:
...
char __fastcall DxgDetermineBootImageMode(__int64 a1, _QWORD *a2, char a3, _BYTE *a4)
{
  ...
  *(_QWORD *)&v23.Length = 2228256LL;
  ...
  if ( v16 )
  {
    ...
    if ( v16 == 2 )
    {
      LOBYTE(v15) = WdLogSingleEntry1(3LL, 5230LL);
      goto LABEL_9;
    }
    if ( v16 != 3 )
    {
...
LABEL_9:
      if ( a3 )
      {
        *((_DWORD *)DXGGLOBAL_GetGlobal() + 384) = 1;
...
LABEL_24:
      ...
      if ( ((*(_DWORD *)(a1 + 12) - 20) & 0xFFFFFFFD) == 0 )
      {
        ...
        *((_OWORD *)Global + 97) = *(_OWORD *)a1;
        *((_OWORD *)Global + 98) = *(_OWORD *)(a1 + 16);
        *((_QWORD *)DXGGLOBAL_GetGlobal() + 193) = *a2;
        *((_QWORD *)DXGGLOBAL_GetGlobal() + 207) = a2[2];
        *((_DWORD *)DXGGLOBAL_GetGlobal() + 384) = 1;
        LOBYTE(v15) = DxgkSetBootAnimationRelayState(1LL);
        if ( (_BYTE)v15 )
          goto LABEL_11;
        v18 = 5279LL;
        WdLogSingleEntry1(1LL, 5279LL);
        goto LABEL_24;
      }
      v17 = *(int *)(a1 + 12);
      goto LABEL_21;
    }
    *((_DWORD *)DXGGLOBAL_GetGlobal() + 384) = 3;
    LOBYTE(v15) = DxgkSetBootAnimationRelayState(1LL);
  }
  return v15;
}
