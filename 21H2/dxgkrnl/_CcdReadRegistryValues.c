/*
 * XREFs of _CcdReadRegistryValues @ 0x1C01B77A8
 * Callers:
...
__int64 __fastcall CcdReadRegistryValues(HANDLE a1, _WORD *a2, const void *a3, __int64 a4, __int64 a5)
{
  ...
  if ( !is_mul_ok(v5, 0x38uLL) )
    v11 = -1LL;
  v13 = (char *)operator new[](v11, 0x63644356u, 64LL, a4);
  v14 = 56 * v5;
  v15 = v13;
  if ( v13 )
  {
