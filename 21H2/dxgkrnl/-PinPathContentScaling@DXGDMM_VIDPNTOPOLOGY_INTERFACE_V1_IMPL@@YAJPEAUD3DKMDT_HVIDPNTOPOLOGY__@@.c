/*
 * XREFs of ?PinPathContentScaling@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C0110C60
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING a5)
{
  ...
  if ( !v11 )
  {
    v49 = WdLogNewEntry5_WdError(v9, 0LL);
    *(_QWORD *)(v49 + 24) = this;
  ...
  if ( (_DWORD)v6 == 254 )
  {
    v50 = (_QWORD *)WdLogNewEntry5_WdError(v9, 0LL);
    v50[3] = 254LL;
    v50[4] = v8;
    v50[5] = v7;
    v50[6] = this;
...
LABEL_87:
  ...
  if ( v15 < 0 )
  {
    v52 = (_QWORD *)WdLogNewEntry5_WdError(v17, v16);
    v52[3] = v6;
    v52[4] = v8;
    v52[5] = v7;
    v52[6] = this;
  ...
  if ( !v18 )
  {
    v53 = WdLogNewEntry5_WdAssertion(0LL, v16);
...
LABEL_18:
  ...
  {
    v55 = WdLogNewEntry5_WdError(v18, v16);
    *(_QWORD *)(v55 + 24) = v20;
...
LABEL_67:
    ...
    if ( !(_BYTE)a5 )
    {
      ...
      v48[3] = 7LL;
      v48[4] = v20;
      v48[5] = v84.VidPnSourceId;
      v48[6] = v84.VidPnTargetId;
...
LABEL_47:
    ...
    *((_DWORD *)&v90.EnumPivot + 2) = 0;
    ...
    if ( (int)this >= 0 )
      goto LABEL_47;
    v77 = (_QWORD *)WdLogNewEntry5_WdTrace(v42, v41, v43, v44);
    v77[3] = v20;
    v77[4] = 7LL;
    v77[5] = &v84;
    v78 = *(_QWORD *)(v19 + 8);
...
LABEL_70:
  ...
  {
    v60 = (_QWORD *)WdLogNewEntry5_WdWarning(v42, v41, v43);
    v60[3] = v92;
    v60[4] = v7;
    v60[5] = a4;
  ...
  if ( v85 == D3DKMDT_VPPS_UNPINNED )
    v80 = DMMVIDPNPRESENTPATH::UnpinContentScaling((DMMVIDPNPRESENTPATH *)v14);
  else
