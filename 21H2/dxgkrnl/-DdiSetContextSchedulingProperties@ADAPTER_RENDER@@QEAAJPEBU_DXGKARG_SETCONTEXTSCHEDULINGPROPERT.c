/*
 * XREFs of ?DdiSetContextSchedulingProperties@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C021DA2C
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetContextSchedulingProperties@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C00423E0 (-ADAPTER_RENDER_DdiSetContextSchedulingProperties@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETCONTEX.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rcx
  __int64 (__fastcall *v13)(_QWORD, const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *); // rax
  int v14; // ebx
  __int64 v15; // rcx
  _QWORD *v16; // rax
  ...
  if ( (qword_1C00B19B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5117);
  }
  else
  {
    v27 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5117LL);
  ...
  v12 = *((_QWORD *)this + 2);
  v13 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *))(v12 + 1216);
  if ( v13 )
    v14 = v13(*(_QWORD *)(v12 + 272), a2);
  else
    v14 = -1073741822;
  if ( v28[0] )
  ...
  {
    v20 = WdLogNewEntry5_WdError(v15, v11);
    *(_QWORD *)(v20 + 24) = v14;
