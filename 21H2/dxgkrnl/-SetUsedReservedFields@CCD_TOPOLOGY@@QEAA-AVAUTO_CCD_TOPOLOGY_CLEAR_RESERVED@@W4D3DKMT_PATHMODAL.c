/*
 * XREFs of ?SetUsedReservedFields@CCD_TOPOLOGY@@QEAA?AVAUTO_CCD_TOPOLOGY_CLEAR_RESERVED@@W4D3DKMT_PATHMODALITY_RESERVED_FIELD@@@Z @ 0x1C01AC378
 * Callers:
...
_QWORD *__fastcall CCD_TOPOLOGY::SetUsedReservedFields(__int64 a1, _QWORD *a2, int a3)
{
  ...
  for ( i = 0; i < *(unsigned __int16 *)(*(_QWORD *)(a1 + 64) + 20LL); *(_DWORD *)(v7 + *(_QWORD *)(a1 + 64) + 312) = a3 )
  {
    v6 = i++;
    v7 = 296 * v6;
    v8 = *(_QWORD *)(a1 + 64);
    *(_OWORD *)(v7 + v8 + 312) = 0LL;
    *(_OWORD *)(v7 + v8 + 328) = 0LL;
    *(_QWORD *)(v7 + v8 + 344) = 0LL;
  }
  *(_DWORD *)(a1 + 88) = a3;
  result = a2;
  *a2 = a1;
