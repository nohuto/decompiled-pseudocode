/*
 * XREFs of ?Initialize@OUTPUTDUPL_CONTEXT@@QEAAJPEBU_D3DKMT_CREATE_OUTPUTDUPL@@@Z @ 0x1C02A1130
 * Callers:
 ...
 *     ?Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z @ 0x1C029A578 (-Initialize@DXGDXGIKEYEDMUTEX@@QEAAJPEAX@Z.c)
