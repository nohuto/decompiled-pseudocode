/*
 * XREFs of ?GetElapsed@TimeInterval@DripsBlockerTrackingHelper@@SA_K_K@Z @ 0x1C02C3634
 * Callers:
 ...
 * Callees:
 *     ?RtlULongLongMult@@YAJ_K0PEA_K@Z @ 0x1C004EBCC (-RtlULongLongMult@@YAJ_K0PEA_K@Z.c)
 */
