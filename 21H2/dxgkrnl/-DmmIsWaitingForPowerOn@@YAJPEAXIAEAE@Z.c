/*
 * XREFs of ?DmmIsWaitingForPowerOn@@YAJPEAXIAEAE@Z @ 0x1C017864C
 * Callers:
 ...
 *     ?IsPathFromSourcePoweredOff@DMMVIDPN@@QEBAEI@Z @ 0x1C017875C (-IsPathFromSourcePoweredOff@DMMVIDPN@@QEBAEI@Z.c)
 */
