/*
 * XREFs of ?GetMonitorDescriptorSet@DXGK_MONITOR_INTERFACE_V1_IMPL@@KAJQEAXIPEAPEAUD3DKMDT_HMONITORDESCRIPTORSET__@@PEAPEBU_DXGK_MONITORDESCRIPTORSET_INTERFACE@@@Z @ 0x1C02F7820
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGK_MONITORDESCRIPTORSET_INTERFACE **a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v35, 7055LL);
  ...
  if ( *(_QWORD *)(v20 + 2696) )
  {
    ...
    else if ( MonitorHandle >= 0 )
    {
      ...
      *a4 = &DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL::DxgMonitorDescriptorSetInterfaceV1;
      MonitorReleaseMonitorHandle(v20, v6, DXGK_MONITOR_INTERFACE_V1_IMPL::GetMonitorDescriptorSet, v28);
      LODWORD(v6) = 0;
    }
    else
    {
