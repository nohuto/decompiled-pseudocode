/*
 * XREFs of ?PresentMultiPlaneOverlay2@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY2@@PEAVCOREDEVICEACCESS@@PEAPEAV1@@Z @ 0x1C031999C
 * Callers:
        ...
        struct DXGCONTEXT **a4)
{
  ...
  char *v12; // r14
  char *v13; // rdi
  D3DKMT_HANDLE *p_hAllocation; // rbx
  int v15; // eax
  bool v16; // zf
  ...
  *(_DWORD *)&v20[24] = *(_DWORD *)&v20[24] & 0xFFFFFF87 | *(_BYTE *)&Value & 0x20 | (2 * (*(_BYTE *)&Value & 8)) | ((*(_BYTE *)&Value & 0x10 | (*(unsigned int *)&Value >> 20) & 0x80) >> 1);
  ...
  if ( (_DWORD)PresentPlaneCount )
  {
    ...
    do
    {
      ...
      *((_QWORD *)v13 + 6) = v12;
      *((_DWORD *)v13 + 1) = v15 & 0xFFFFFFFE | !v16;
