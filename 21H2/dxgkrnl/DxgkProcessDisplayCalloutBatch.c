/*
 * XREFs of DxgkProcessDisplayCalloutBatch @ 0x1C02F3490
 * Callers:
 *     <none>
 * Callees:
      ...
      *(_QWORD *)(a1 + 88) = *((_QWORD *)v6 + 16);
      ...
      else if ( v9 == 2 )
      {
        ...
        *(_QWORD *)(a1 + 16) = *((_QWORD *)v6 + 3);
        RAPID_HPD_MANAGER::ExtendExistingHPDPeriod((__int64)Global + 305224, 2u, *((_QWORD *)v6 + 3));
        v8 = 1;
      }
      else
      {
      ...
      if ( v10 )
        goto LABEL_21;
      v12 = (char *)DXGGLOBAL_GetGlobal() + 1872;
...
LABEL_21:
    ...
    DXGDISPLAYCALLOUTQUEUE::EndProcessingBatch((struct DXGGLOBAL *)((char *)v15 + 1872));
  }
