/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_BRIGHTNESS3@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C00460A4
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_BRIGHTNESS3(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C00B1A20 > 4 && tlgKeywordOn((__int64)&dword_1C00B1A20, 0x200000000020LL) )
  {
