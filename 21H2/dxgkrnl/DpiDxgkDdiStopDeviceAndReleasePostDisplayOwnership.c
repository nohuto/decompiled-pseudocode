/*
 * XREFs of DpiDxgkDdiStopDeviceAndReleasePostDisplayOwnership @ 0x1C02D8CC0
 * Callers:
 *     DpiFdoStopDeviceAndReleasePostDisplayOwnership @ 0x1C02CC688 (DpiFdoStopDeviceAndReleasePostDisplayOwnership.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0028C00 (_guard_dispatch_icall_nop.c)
 *     McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1C0059BC4 (McTemplateK0pqqqqqq_EtwWriteTransfer.c)
 */
