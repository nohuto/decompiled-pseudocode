/*
 * XREFs of ?DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C02CD700
 * Callers:
 *     ?ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C004B950 (-ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiStopCapture(ADAPTER_RENDER *this, struct _DXGKARG_STOPCAPTURE *a2, __int64 a3)
{
  ...
  __int64 v12; // rcx
  KIRQL v13; // al
  struct _DXGKARG_STOPCAPTURE *v14; // rax
  __int64 v15; // rcx
  __int64 v16; // r8
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 5039);
  ...
  v14 = (struct _DXGKARG_STOPCAPTURE *)WdLogNewEntry5_WdTrace(v12, v11);
  v14[3].hAllocation = (HANDLE)v10;
  v14[4].hAllocation = *(HANDLE *)(*((_QWORD *)this + 2) + 280LL);
  v14[5].hAllocation = a2->hAllocation;
  if ( (_DWORD)v10 )
  {
