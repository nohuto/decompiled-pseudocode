/*
 * XREFs of ?Initialize@VIDPNSOURCEINFO@@QEAAJPEAVDXGADAPTER@@I@Z @ 0x1C02EF3C8
 * Callers:
...
__int64 __fastcall VIDPNSOURCEINFO::Initialize(VIDPNSOURCEINFO *this, struct DXGADAPTER *a2, unsigned int a3)
{
  ...
  *((_DWORD *)this + 7) ^= (*((_DWORD *)this + 7) ^ (ADAPTER_DISPLAY::IsEmulatedVidPnSourceOwner(
                                                       *((DXGADAPTER ***)a2 + 349),
                                                       ...
                                                       v3) << 15)) & 0x8000;
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v27, (struct DXGFASTMUTEX *const)(v7 + 76), 0);
  ...
  for ( i = 0; i < 0xA; ++i )
  {
    ...
    {
      v23 = *((_DWORD *)LatestPlaneConfigInternal + 2);
      if ( (v23 & 1) != 0 && i )
      {
  ...
  if ( *(_QWORD *)this )
  {
    ...
    RtlStringCchCopyA((char *)this + 32, v25, ProcessImageFileName);
  }
  else
  {
    *((_BYTE *)this + 32) = 0;
