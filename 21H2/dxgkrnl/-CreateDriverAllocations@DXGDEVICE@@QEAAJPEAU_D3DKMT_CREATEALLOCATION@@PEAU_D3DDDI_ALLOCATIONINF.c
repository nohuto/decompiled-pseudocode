/*
 * XREFs of ?CreateDriverAllocations@DXGDEVICE@@QEAAJPEAU_D3DKMT_CREATEALLOCATION@@PEAU_D3DDDI_ALLOCATIONINFO2@@PEAU_DXGK_ALLOCATIONINFO@@PEAVDXGALLOCATION@@PEAVDXGRESOURCE@@PEAPEAX5PEAXPEBU_D3DKM_CREATESTANDARDALLOCATION@@HPEAU_D3DKMT_CREATESTANDARDALLOCATION@@@Z @ 0x1C011E450
 * Callers:
 ...
 *     ?DriverSupportsWDDM3Features@DXGADAPTER@@QEBAEXZ @ 0x1C0025D5C (-DriverSupportsWDDM3Features@DXGADAPTER@@QEBAEXZ.c)
