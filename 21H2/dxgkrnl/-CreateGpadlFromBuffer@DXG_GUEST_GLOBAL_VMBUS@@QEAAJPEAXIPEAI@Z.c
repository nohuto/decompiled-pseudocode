/*
 * XREFs of ?CreateGpadlFromBuffer@DXG_GUEST_GLOBAL_VMBUS@@QEAAJPEAXIPEAI@Z @ 0x1C0361674
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  v8 = *this;
  v12 = 1;
  LODWORD(a4) = ((__int64 (__fastcall *)(struct _KTHREAD *, _QWORD, void *, _QWORD, unsigned int *))qword_1C0131BB0)(
                  v8,
                  0LL,
                  a2,
                  a3,
