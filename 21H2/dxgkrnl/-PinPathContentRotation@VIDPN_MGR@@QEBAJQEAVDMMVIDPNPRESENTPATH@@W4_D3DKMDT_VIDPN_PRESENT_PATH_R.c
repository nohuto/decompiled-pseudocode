/*
 * XREFs of ?PinPathContentRotation@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C02DF594
 * Callers:
 ...
 *     ?GetContainer@?$ContainedBy@VDMMVIDPNTOPOLOGY@@@@QEBAPEAVDMMVIDPNTOPOLOGY@@XZ @ 0x1C005C114 (-GetContainer@-$ContainedBy@VDMMVIDPNTOPOLOGY@@@@QEBAPEAVDMMVIDPNTOPOLOGY@@XZ.c)
  ...
  *(_QWORD *)&v75.IsVidPnSupported = 0LL;
  ...
  if ( (int)v12 >= 0 )
  {
    ...
    *((_DWORD *)&v76.EnumPivot + 2) = 0;
    ...
    v76.EnumPivotType = D3DKMDT_EPT_ROTATION;
    v76.EnumPivot = v78;
    if ( !v61 )
    {
