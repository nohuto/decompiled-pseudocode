/*
 * XREFs of ?SetTimingsFromVidPn@VIDPN_MGR@@QEAAJKW4_DMM_CLIENT_TYPE@@PEAVDMMVIDPN@@PEAUD3DKMT_VIDPN_SOURCE_MASKS@@PEAU_DMM_SET_TIMING_RESULT@@EPEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C013FB1C
 * Callers:
 ...
 *     ?GetContainingAdapter@VIDPN_MGR@@QEBAPEAVDXGADAPTER@@XZ @ 0x1C002872C (-GetContainingAdapter@VIDPN_MGR@@QEBAPEAVDXGADAPTER@@XZ.c)
 *     ?IsRequestFromModeChange@@YA_NW4_DMM_CLIENT_TYPE@@@Z @ 0x1C0028770 (-IsRequestFromModeChange@@YA_NW4_DMM_CLIENT_TYPE@@@Z.c)
 *     _guard_dispatch_icall_nop @ 0x1C0028C00 (_guard_dispatch_icall_nop.c)
 *     memmove @ 0x1C0028C40 (memmove.c)
 *     ?NotifyMultiPlaneOverlayDisable@DXGADAPTER@@QEAAXI@Z @ 0x1C0037C5C (-NotifyMultiPlaneOverlayDisable@DXGADAPTER@@QEAAXI@Z.c)
 ...
 *     ?GetDisplayModeFromVidPnSource@DMMVIDPNTOPOLOGY@@QEBAJIAEAU_D3DKMT_DISPLAYMODE@@@Z @ 0x1C014B1D0 (-GetDisplayModeFromVidPnSource@DMMVIDPNTOPOLOGY@@QEBAJIAEAU_D3DKMT_DISPLAYMODE@@@Z.c)
              ...
              if ( v171 )
              {
                  ...
                  && ((*(_DWORD *)&v174[v170 + 32] & 0xF000000) != 0xE000000 || v174[v170 + 48] != 0xFF) )
                {
                  ...
                  if ( (*(_DWORD *)((_BYTE *)Src + v170 + 32) & 0xF000000) == 0xE000000 )
                  {
                    ...
                    {
                      v182 = *(_QWORD *)(*(_QWORD *)(v15 + 2696) + 392LL);
                      if ( v182 )
              ...
              do
              {
                ...
                if ( (v190 & *((_DWORD *)a5 + 20)) != 0 )
                {
                  ...
                  if ( IsRequestFromModeChange(v232) )
                  {
                    ...
                    ADAPTER_DISPLAY::SetContentRect(*(ADAPTER_DISPLAY **)(v15 + 2696), v188, &stru_1C00B34E8);
...
LABEL_197:
            ...
            if ( j >= 0 )
            {
              ...
              if ( (v124 & *((_DWORD *)a5 + 3)) != 0 )
              {
                ...
                ADAPTER_DISPLAY::SetContentRect(*(ADAPTER_DISPLAY **)(v15 + 2696), v122, &stru_1C00B34E8);
...
LABEL_233:
          ...
          if ( i )
          {
            v165 = *(_DWORD *)(*(_QWORD *)(v15 + 2696) + 368LL);
