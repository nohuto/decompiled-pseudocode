/*
 * XREFs of ??0DXGSESSIONDATA@@QEAA@K@Z @ 0x1C0155834
 * Callers:
 ...
 *     ?InitializeMaxActiveOutputDuplApps@OUTPUTDUPL_SESSION_MGR@@AEAAXXZ @ 0x1C0156128 (-InitializeMaxActiveOutputDuplApps@OUTPUTDUPL_SESSION_MGR@@AEAAXXZ.c)
 */
