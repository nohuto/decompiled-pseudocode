/*
 * XREFs of ?VSyncTelemetryBucket@ADAPTER_DISPLAY@@QEAAXXZ @ 0x1C003B008
 * Callers:
 *     ?VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z @ 0x1C003B360 (-VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall ADAPTER_DISPLAY::VSyncTelemetryBucket(ADAPTER_DISPLAY *this)
{
  ...
  if ( ++*((_DWORD *)this + 158) >= 0x384u || (v3 = 0, (unsigned int)(v2 - *((_DWORD *)this + 159)) > 0xE10) )
    v3 = 1;
  ...
  if ( v4 )
  {
    ...
    if ( v5 == v6 )
    {
      ...
      {
        *v4 &= 0xFC03FFFF;
        **((_DWORD **)this + 115) ^= (**((_DWORD **)this + 115) ^ *((_DWORD *)this + 158)) & 0x3FFFF;
        *((_DWORD *)this + 219) = 1;
        goto LABEL_14;
      }
      v7 = *((unsigned int *)this + 219);
      ...
      v4[v7] &= 0xFC03FFFF;
      *(_DWORD *)(*((_QWORD *)this + 115) + 4LL * *((unsigned int *)this + 219)) = *(_DWORD *)(*((_QWORD *)this + 115)
                                                                                             + 4LL
                                                                                             * *((unsigned int *)this
                                                                                               + 219)) & 0xFFFC0000 | 1;
    }
    ...
    {
      v4[*((unsigned int *)this + 219)] ^= (v4[*((unsigned int *)this + 219)] ^ ((v6 - v5) << 18)) & 0x3FC0000;
      *(_DWORD *)(*((_QWORD *)this + 115) + 4LL * *((unsigned int *)this + 219)) ^= (*((_DWORD *)this + 221) ^ *(_DWORD *)(*((_QWORD *)this + 115) + 4LL * *((unsigned int *)this + 219))) & 0x3FFFF;
      *((_QWORD *)this + 110) = *((unsigned int *)this + 218);
    }
    ++*((_DWORD *)this + 219);
  }
LABEL_14:
  if ( v3 )
  {
    if ( (*((_DWORD *)this + 218) || *((_DWORD *)this + 217))
      ...
      && tlgKeywordOn((__int64)&dword_1C00B1A20, v9) )
    {
      ...
      v20 = v13;
      v25 = v24 != 0 ? 0x180 : 0;
      v16 = 2 * *((_DWORD *)this + 222);
      v28 = 1;
      v30 = v16;
      v19 = *((_DWORD *)this + 217);
      v21 = v2 - *((_DWORD *)this + 159);
      v27 = *((_WORD *)this + 430);
      v29 = 2;
    ...
    v17 = (void *)*((_QWORD *)this + 114);
    if ( v17 )
      memset(v17, 0, 0x180uLL);
    v18 = (void *)*((_QWORD *)this + 115);
    if ( v18 )
      memset(v18, 0, 4LL * *((unsigned int *)this + 219));
    ++*((_DWORD *)this + 215);
    *(_QWORD *)((char *)this + 868) = 0LL;
    *(_QWORD *)((char *)this + 876) = 0LL;
    *((_DWORD *)this + 158) = 0;
    *((_DWORD *)this + 159) = v2;
  }
