/*
 * XREFs of ?PresentDisplayOnly@ADAPTER_DISPLAY@@QEAAJPEAVDXGCONTEXT@@IPEBU_D3DKMT_PRESENT@@PEBU_DXGKARG_PRESENT@@PEAVCOREDEVICEACCESS@@PEAUtagRECT@@@Z @ 0x1C0213AB4
 * Callers:
        ...
        struct tagRECT *a7)
{
  ...
  result = BLTQUEUE::Present((BLTQUEUE *)(*(_QWORD *)(*((_QWORD *)this + 49) + 8LL) + 2904LL * a3), a2, a4, a5, a6);
  if ( *((_DWORD *)this + 100) )
