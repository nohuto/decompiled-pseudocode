/*
 * XREFs of ?EDID_V1_GetDolbyVisionCaps@@YAJKPEBEPEAUDISPLAY_DVLL_CAPS@@@Z @ 0x1C002AC94
 * Callers:
...
__int64 __fastcall EDID_V1_GetDolbyVisionCaps(unsigned int a1, unsigned __int8 *a2, struct DISPLAY_DVLL_CAPS *a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    else
    {
      ...
      *(_BYTE *)a3 = 1;
      *((double *)a3 + 1) = dword_1C010EDB0[v18];
      v19 = v28;
      *((double *)a3 + 2) = dword_1C010EE30[(unsigned __int64)v16 >> 3];
