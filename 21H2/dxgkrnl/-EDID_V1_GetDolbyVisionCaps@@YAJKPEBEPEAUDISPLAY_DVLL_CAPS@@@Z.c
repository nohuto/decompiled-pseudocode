/*
 * XREFs of ?EDID_V1_GetDolbyVisionCaps@@YAJKPEBEPEAUDISPLAY_DVLL_CAPS@@@Z @ 0x1C00222E4
 * Callers:
...
__int64 __fastcall EDID_V1_GetDolbyVisionCaps(unsigned int a1, unsigned __int8 *a2, struct DISPLAY_DVLL_CAPS *a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    else
    {
      ...
      *(_BYTE *)a3 = 1;
      *((double *)a3 + 1) = dword_1C008FB20[v19];
      v20 = v29;
      *((double *)a3 + 2) = dword_1C008FBA0[(unsigned __int64)v17 >> 3];
