/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C02CC054
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 5017);
  ...
  v14[3] = v10;
  v14[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 280LL);
  v14[5] = a2->FirstEntry;
  v14[6] = a2->NumEntries;
  v14[7] = a2->VidPnSourceId;
  if ( (_DWORD)v10 )
  {
