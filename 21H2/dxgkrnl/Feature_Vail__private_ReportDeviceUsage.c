/*
 * XREFs of Feature_Vail__private_ReportDeviceUsage @ 0x1C0028010
 * Callers:
...
void Feature_Vail__private_ReportDeviceUsage()
{
  ...
  if ( (Feature_Vail__private_featureState & 0x10) == 0 )
  {
    ...
    wil_details_FeatureReporting_ReportUsageToService((__int64)&Feature_Vail__private_descriptor, v0, 3LL);
