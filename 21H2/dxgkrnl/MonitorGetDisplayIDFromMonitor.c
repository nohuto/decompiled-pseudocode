/*
 * XREFs of MonitorGetDisplayIDFromMonitor @ 0x1C01639A0
 * Callers:
 ...
 *     ??1?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@wistd@@@wistd@@QEAA@XZ @ 0x1C004D09C (--1-$unique_ptr@$$BY0A@EU-$default_delete@$$BY0A@E@wistd@@@wistd@@QEAA@XZ.c)
 */
