/*
 * XREFs of ?PresentDurationPlaneProperty@@YAJPEAVDXGPROCESS@@PEAU_D3DKMT_PROPERTIES_PRESENT_DURATION_PLANE@@_N@Z @ 0x1C030B9E8
 * Callers:
...
__int64 __fastcall PresentDurationPlaneProperty(struct DXGPROCESS *a1, struct _LUID *a2, char a3)
{
  __int64 v4; // rbx
  const wchar_t *v5; // r9
  DXGADAPTER *v6; // rdi
