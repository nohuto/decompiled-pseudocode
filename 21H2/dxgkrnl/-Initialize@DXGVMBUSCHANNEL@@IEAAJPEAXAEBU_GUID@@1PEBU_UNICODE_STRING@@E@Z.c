/*
 * XREFs of ?Initialize@DXGVMBUSCHANNEL@@IEAAJPEAXAEBU_GUID@@1PEBU_UNICODE_STRING@@E@Z @ 0x1C02B2F6C
 * Callers:
...
LABEL_9:
  ...
  LOBYTE(v15) = a6;
  v22 = ((__int64 (__fastcall *)(PDEVICE_OBJECT, __int64, char *))qword_1C00B4290)(
  ...
  LOBYTE(v23) = 1;
  ((void (__fastcall *)(_QWORD, __int64))qword_1C00B4348)(*v21, v23);
  v28 = *v21;
  if ( !a6 )
  {
    v39 = ((__int64 (__fastcall *)(__int64, __int128 *, __int128 *, _QWORD))qword_1C00B4380)(
            v28,
  ...
  v29 = ((__int64 (__fastcall *)(__int64, __int128 *, __int128 *))qword_1C00B4508)(v28, &v65, &v64);
  v17 = v29;
  if ( v29 < 0 )
  {
...
LABEL_17:
  ...
  if ( a2 )
  {
    v33 = ((__int64 (__fastcall *)(_QWORD, __int64))qword_1C00B4518)(*v21, a2);
    v17 = v33;
    if ( v33 >= 0 )
      goto LABEL_20;
...
LABEL_19:
  if ( (int)v17 < 0 )
    goto LABEL_30;
LABEL_20:
  v36 = ((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C00B44F0)(*v21, v8);
  v17 = v36;
  if ( v36 < 0 )
  {
...
LABEL_24:
  if ( a5 )
    ((void (__fastcall *)(_QWORD))qword_1C00B42F0)(*v21);
  if ( (int)v17 >= 0 )
  {
    v42 = ((__int64 (__fastcall *)(_QWORD, __int64))qword_1C00B4300)(*v21, 2048LL);
    v17 = v42;
    if ( v42 < 0 )
    {
...
LABEL_30:
  if ( !a6 )
  {
    v45 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64))qword_1C00B4378)(*((_QWORD *)this + 2), 8LL, 8LL);
    v17 = v45;
    if ( v45 >= 0 )
      goto LABEL_34;
  ...
  {
LABEL_46:
    ((void (__fastcall *)(_QWORD))qword_1C00B4298)(*((_QWORD *)this + 2));
    *((_QWORD *)this + 2) = 0LL;
    VmBusInterfaceDereference(v62, v61);
    return (unsigned int)v17;
  }
LABEL_34:
  ((void (__fastcall *)(_QWORD, DXGVMBUSCHANNEL *))qword_1C00B4358)(*((_QWORD *)this + 2), this);
  v49 = ((__int64 (__fastcall *)(_QWORD, void *, _QWORD))qword_1C00B4308)(
          *((_QWORD *)this + 2),
          &ProcessRingPacket,
          0LL);
  v17 = v49;
...
LABEL_38:
  ...
  v66[0] = 1;
  v66[1] = 48;
  v54 = ((__int64 (__fastcall *)(__int64, _DWORD *))qword_1C00B4310)(v53, v66);
  v17 = v54;
  if ( v54 < 0 )
  {
  ...
  if ( !a6 )
  {
    v57 = ((__int64 (__fastcall *)(_QWORD))qword_1C00B42C0)(*((_QWORD *)this + 2));
    v17 = v57;
    if ( v57 >= 0 )
    {
LABEL_44:
