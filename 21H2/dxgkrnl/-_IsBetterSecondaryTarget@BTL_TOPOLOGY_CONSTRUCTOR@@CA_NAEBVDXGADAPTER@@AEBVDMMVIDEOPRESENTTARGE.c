/*
 * XREFs of ?_IsBetterSecondaryTarget@BTL_TOPOLOGY_CONSTRUCTOR@@CA_NAEBVDXGADAPTER@@AEBVDMMVIDEOPRESENTTARGET@@PEBV3@@Z @ 0x1C03AF120
 * Callers:
...
LABEL_9:
  ...
  VotPreference = BTL_TOPOLOGY_CONSTRUCTOR::_GetVotPreference(v11, *((_DWORD *)a3 + 21), *((_DWORD *)a3 + 25), 0);
