/*
 * XREFs of ?GetAvailableIndex@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@_KPEA_KPEAIPEAH@Z @ 0x1C02BC95C
 * Callers:
 *     NtDxgkGetAvailableTrackedWorkloadIndex @ 0x1C02BDAB0 (NtDxgkGetAvailableTrackedWorkloadIndex.c)
 * Callees:
 *     ?GetIndexHelper@DXGTRACKEDWORKLOAD@@IEAAJPEAI@Z @ 0x1C02BCA18 (-GetIndexHelper@DXGTRACKEDWORKLOAD@@IEAAJPEAI@Z.c)
