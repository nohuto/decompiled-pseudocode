/*
 * XREFs of DxgkFlipOverlay @ 0x1C032AE90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkFlipOverlay(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  int v26; // [rsp+58h] [rbp-E0h] BYREF
  __int64 v27; // [rsp+60h] [rbp-D8h]
  char v28; // [rsp+68h] [rbp-D0h]
  DXGDEVICE *v29; // [rsp+70h] [rbp-C8h] BYREF
  _QWORD v30[2]; // [rsp+78h] [rbp-C0h] BYREF
  _D3DKMT_FLIPOVERLAY v31; // [rsp+88h] [rbp-B0h] BYREF
  _BYTE v32[16]; // [rsp+A8h] [rbp-90h] BYREF
  _BYTE v33[24]; // [rsp+B8h] [rbp-80h] BYREF
  _BYTE v34[80]; // [rsp+D0h] [rbp-68h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 2024);
...
LABEL_35:
  ...
  v31 = *v3;
  v29 = 0LL;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v25, v31.hDevice, (struct _KTHREAD **)Current, &v29);
...
LABEL_23:
  if ( !v17 )
  {
    WdLogSingleEntry2(3LL, v31.hOverlay, -1073741811LL);
  ...
  {
    WdLogSingleEntry3(3LL, v31.hOverlay, v31.hDevice, -1073741811LL);
    DXGAUTOPUSHLOCK::~DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v33);
    if ( v30[0] )
      DXGDEVICEACCESSLOCKEXCLUSIVE::Release((DXGDEVICEACCESSLOCKEXCLUSIVE *)v30);
    if ( v25 && _InterlockedExchangeAdd64((volatile signed __int64 *)v25 + 8, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
  ...
  if ( v19 >= 0 )
  {
    ...
    DXGOVERLAYMUTEX::DXGOVERLAYMUTEX((DXGOVERLAYMUTEX *)v32, v12[2]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v32);
    v22 = DXGOVERLAY::FlipOverlay(v17, &v31);
