/*
 * XREFs of DpiGetAdapterInfo @ 0x1C0187DA0
 * Callers:
...
__int64 __fastcall DpiGetAdapterInfo(__int64 a1, _DWORD *a2, _QWORD *a3, _OWORD *a4)
{
  ...
  HANDLE v98; // [rsp+48h] [rbp-B8h] BYREF
  ...
  struct _UNICODE_STRING v102; // [rsp+90h] [rbp-70h] BYREF
  _QWORD v103[36]; // [rsp+A0h] [rbp-60h] BYREF

  Handle = 0LL;
  memset(v103, 0, 0x118uLL);
  v8 = *(_QWORD *)(a1 + 64);
  v9 = 1;
  v10 = *(_QWORD *)(v8 + 40);
  if ( !a3 )
  ...
  *((_BYTE *)a3 + 80) = v31;
  ...
  MiniportInterface = DpiQueryMiniportInterface(
                        a1,
                        (__int64)&GUID_DEVINTERFACE_WDDM3_ON_VB,
                        56,
                        1,
                        v95,
    ...
    *(_BYTE *)a2 = 0;
    ...
    else if ( !*(_BYTE *)(*(_QWORD *)(v8 + 40) + 133LL) && !*(_BYTE *)(v8 + 481) )
    {
      *(_BYTE *)a2 = 1;
      ...
      v40 = DpiOpenPnpRegistryKey(a1, 2u, 0x20019u, &Handle);
      v34 = v40;
      if ( v40 >= 0 )
      {
        ...
        if ( v44 >= 0 )
        {
          ...
          *(&ObjectAttributes.Attributes + 1) = 0;
          KeyHandle = 0LL;
          v102 = 0LL;
          RtlInitUnicodeString(&v102, L"DX9");
          ObjectAttributes.RootDirectory = Handle;
          ObjectAttributes.Length = 48;
          ObjectAttributes.ObjectName = &v102;
          ...
          *(_QWORD *)(v78 + 24) = DxgkRetrieveStringFromRegistry;
          ...
          if ( *((_WORD *)a2 + 36) && **((_WORD **)a2 + 10) == 35 )
          {
            ...
            RtlInitUnicodeString(&v102, L"OpenGL");
            ObjectAttributes.RootDirectory = Handle;
            ObjectAttributes.Length = 48;
            ObjectAttributes.ObjectName = &v102;
            ObjectAttributes.Attributes = 576;
            *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
            if ( ZwOpenKey(&v98, 0x20019u, &ObjectAttributes) >= 0 )
            {
              RtlInitUnicodeString(&DestinationString, L"DriverName");
              if ( (int)DxgkRetrieveStringFromRegistry(v98, &DestinationString) < 0 )
              {
          ...
          if ( *((_QWORD *)a2 + 10) )
          {
            v103[5] = 0LL;
            LODWORD(v103[1]) = 288;
            LODWORD(v103[4]) = 0x4000000;
            v103[2] = L"OpenGLVersion";
            LODWORD(v103[6]) = 0;
            v103[3] = a2 + 22;
            LODWORD(v103[8]) = 288;
            v103[9] = L"OpenGLFlags";
            v103[10] = a2 + 23;
            v103[16] = L"OpenGLVersionWow";
            v103[17] = a2 + 28;
            v103[23] = L"OpenGLFlagsWow";
            v103[24] = a2 + 29;
            LODWORD(v103[11]) = 0x4000000;
            v103[12] = 0LL;
            LODWORD(v103[13]) = 0;
            LODWORD(v103[15]) = 288;
            LODWORD(v103[18]) = 0x4000000;
            v103[19] = 0LL;
            LODWORD(v103[20]) = 0;
            LODWORD(v103[22]) = 288;
            LODWORD(v103[25]) = 0x4000000;
            v103[26] = 0LL;
            LODWORD(v103[27]) = 0;
            if ( v9 )
            {
            ...
            if ( (int)RtlQueryRegistryValuesEx(v91, v90, v103, 0LL, 0LL) < 0 )
            {
