/*
 * XREFs of ?ApplyPresentAttributeMetadataToUpdateToken@CContentResourceState@@IEAAXPEAVCFlipPropertySet@@PEAVCFlipContentToken@@@Z @ 0x1C0081454
 * Callers:
        ...
        struct CFlipContentToken *a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( v10 )
    {
      ...
      *(_OWORD *)((char *)a3 + 200) = v6[4];
      *((_QWORD *)a3 + 27) = *((_QWORD *)v6 + 10);
      if ( (*(_BYTE *)v6 & 1) != 0 )
      {
        v7 = *((_QWORD *)this + 5);
        v10 = 0LL;
        ...
        if ( v10 )
        {
          *(_OWORD *)((char *)a3 + 228) = *v10;
          *(_QWORD *)((char *)a3 + 244) = *((_QWORD *)v8 + 2);
          *((_DWORD *)a3 + 63) = *((_DWORD *)v8 + 6);
        }
        else
        {
          ...
          if ( v11 )
          {
            *(_OWORD *)((char *)a3 + 228) = *v11;
            *(_OWORD *)((char *)a3 + 244) = v9[1];
            *(_OWORD *)((char *)a3 + 260) = v9[2];
            *(_OWORD *)((char *)a3 + 276) = v9[3];
            *(_QWORD *)((char *)a3 + 292) = *((_QWORD *)v9 + 8);
          }
        }
      }
    }
