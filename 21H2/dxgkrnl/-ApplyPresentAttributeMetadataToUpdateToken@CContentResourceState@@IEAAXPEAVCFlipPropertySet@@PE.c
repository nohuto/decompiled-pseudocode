/*
 * XREFs of ?ApplyPresentAttributeMetadataToUpdateToken@CContentResourceState@@IEAAXPEAVCFlipPropertySet@@PEAVCFlipContentToken@@@Z @ 0x1C006E3A0
 * Callers:
 ...
 * Callees:
 *     ??$FindProperty@UPresentedContentUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedContentUpdateFlags@@@Z @ 0x1C006BEF8 (--$FindProperty@UPresentedContentUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedConten.c)
 *     ??$FindProperty@UPresentAttributeFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentAttributeFlags@@@Z @ 0x1C006E270 (--$FindProperty@UPresentAttributeFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentAttributeFlags.c)
 *     ??$ReadData@I@CFlipBlobPropertyReader@@QEAA_NPEAI@Z @ 0x1C006E2D4 (--$ReadData@I@CFlipBlobPropertyReader@@QEAA_NPEAI@Z.c)
 *     ??$ReadData@UtagRECT@@@CFlipBlobPropertyReader@@QEAA_NPEAUtagRECT@@@Z @ 0x1C006E300 (--$ReadData@UtagRECT@@@CFlipBlobPropertyReader@@QEAA_NPEAUtagRECT@@@Z.c)
 *     ??$ReadData@_N@CFlipBlobPropertyReader@@QEAA_NPEA_N@Z @ 0x1C006E330 (--$ReadData@_N@CFlipBlobPropertyReader@@QEAA_NPEA_N@Z.c)
 *     ?FindBlobProperty@CFlipPropertySetBase@@QEAA_NPEAVCFlipBlobPropertyReader@@@Z @ 0x1C006E850 (-FindBlobProperty@CFlipPropertySetBase@@QEAA_NPEAVCFlipBlobPropertyReader@@@Z.c)
 */
