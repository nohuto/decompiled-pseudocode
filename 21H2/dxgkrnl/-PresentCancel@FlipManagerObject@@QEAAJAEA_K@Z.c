/*
 * XREFs of ?PresentCancel@FlipManagerObject@@QEAAJAEA_K@Z @ 0x1C00688B8
 * Callers:
 ...
 *     ?PresentCancel@CFlipManager@@QEAAJAEA_K@Z @ 0x1C006B980 (-PresentCancel@CFlipManager@@QEAAJAEA_K@Z.c)
 */
