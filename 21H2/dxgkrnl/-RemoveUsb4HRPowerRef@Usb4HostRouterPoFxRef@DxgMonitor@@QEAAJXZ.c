/*
 * XREFs of ?RemoveUsb4HRPowerRef@Usb4HostRouterPoFxRef@DxgMonitor@@QEAAJXZ @ 0x1C03B6118
 * Callers:
...
__int64 __fastcall DxgMonitor::Usb4HostRouterPoFxRef::RemoveUsb4HRPowerRef(DxgMonitor::Usb4HostRouterPoFxRef *this)
{
  ...
  if ( *((_BYTE *)this + 24) )
  {
    v2 = PoFxRemoveComponentRelation(*((_QWORD *)this + 2), *((unsigned int *)this + 2), *(_QWORD *)this, &GUID_NULL);
    v5 = v2;
    if ( v2 < 0 )
    {
    ...
    *((_BYTE *)this + 24) = 0;
    ...
    {
      if ( tlgKeywordOn((__int64)&dword_1C012F8A8, 0x8000LL) )
      {
        v7 = *((_DWORD *)this + 2);
        v14 = 0;
        v10 = v7;
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)dword_1C009AE55,
          0LL,
          0LL,
          3u,
          &v11);
