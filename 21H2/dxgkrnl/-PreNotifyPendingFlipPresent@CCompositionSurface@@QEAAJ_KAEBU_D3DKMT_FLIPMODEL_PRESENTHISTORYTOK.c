/*
 * XREFs of ?PreNotifyPendingFlipPresent@CCompositionSurface@@QEAAJ_KAEBU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@@Z @ 0x1C006650C
 * Callers:
        ...
        const struct _D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN *a3)
{
  ...
  {
    (*(void (__fastcall **)(struct CCompositionBuffer *, const struct _D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN *))(*(_QWORD *)v7 + 56LL))(
      v7,
      a3);
  }
  else
