/*
 * XREFs of ?SetPowerComponentIdleCBWorker@DXGADAPTER@@QEAAXIK@Z @ 0x1C00398E0
 * Callers:
 ...
 *     ?ScheduleComponentIdleListTimer@DXGADAPTER@@QEAAX_J@Z @ 0x1C003904C (-ScheduleComponentIdleListTimer@DXGADAPTER@@QEAAX_J@Z.c)
 ...
 *     ?RecordIdle@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C0047B5C (-RecordIdle@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 */
    ...
    *(_QWORD *)(v6 + 480) = MEMORY[0xFFFFF78000000014];
          ...
          *(int *)(v6 + 352) <= 0) )
    {
      *(_QWORD *)(v6 + 488) = *(_QWORD *)(v6 + 480) + *(_QWORD *)(v6 + 472);
      KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)this + 417, &v20);
      v13 = (char *)*((_QWORD *)this + 412);
      v14 = (char *)this + 3288;
      if ( v13 == (char *)this + 3288 )
        goto LABEL_29;
