/*
 * XREFs of ??1MultiMonitorDescriptor@DxgMonitor@@UEAA@XZ @ 0x1C006BADC
 * Callers:
 *     ??_GMultiMonitorDescriptor@DxgMonitor@@UEAAPEAXI@Z @ 0x1C006BB30 (--_GMultiMonitorDescriptor@DxgMonitor@@UEAAPEAXI@Z.c)
 * Callees:
