/*
 * XREFs of ?VmBusSendSignalGuestEventCblt@DXG_HOST_GLOBAL_VMBUS@@SAXPEAX@Z @ 0x1C002743C
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( v3 )
  {
    ...
    v15 = 0LL;
    v9 = 0LL;
    v4 = ((__int64 (__fastcall *)(_QWORD, __int64 *, __int64, _QWORD, _DWORD, _QWORD, _QWORD, __int64 *))qword_1C00B4340)(
           *v3,
           &v10,
           48LL,
           0LL,
