/*
 * XREFs of DxgkSubmitPresentToHwQueue @ 0x1C0271F60
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_BYTE *)&v7[94].Next + 8) = 1;
  ...
  if ( (v109 & 0x10000000) != 0 )
  {
    if ( !v100 )
    {
      ...
      *(_QWORD *)(v110 + 24) = 2251LL;
      goto LABEL_221;
    }
    if ( (*((_DWORD *)v100 + 87) & 0x100) == 0 )
    {
      v110 = WdLogNewEntry5_WdError(v109, v101);
      *(_QWORD *)(v110 + 24) = 2257LL;
      goto LABEL_221;
    }
    goto LABEL_251;
  }
