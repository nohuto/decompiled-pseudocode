/*
 * XREFs of ?InsertQueueTail@BLTQUEUE@@AEAAXPEAU_LIST_ENTRY@@PEAVBLTENTRY@@@Z @ 0x1C02FD904
 * Callers:
 ...
 * Callees:
 *     McTemplateK0dt_EtwWriteTransfer @ 0x1C005F4C4 (McTemplateK0dt_EtwWriteTransfer.c)
 */
