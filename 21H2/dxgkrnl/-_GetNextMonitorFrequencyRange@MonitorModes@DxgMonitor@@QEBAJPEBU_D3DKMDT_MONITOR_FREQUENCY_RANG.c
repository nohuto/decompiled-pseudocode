/*
 * XREFs of ?_GetNextMonitorFrequencyRange@MonitorModes@DxgMonitor@@QEBAJPEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@PEAPEBU3@@Z @ 0x1C01D1094
 * Callers:
...
LABEL_15:
  ...
  if ( v5 == v3 )
    return 1075708748LL;
  v7 = (const struct _D3DKMDT_MONITOR_FREQUENCY_RANGE *)(v5 - 6);
  if ( !v5 )
    v7 = 0LL;
  if ( !v7 )
    return 1075708748LL;
