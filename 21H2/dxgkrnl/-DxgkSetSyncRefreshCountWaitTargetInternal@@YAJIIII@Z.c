/*
 * XREFs of ?DxgkSetSyncRefreshCountWaitTargetInternal@@YAJIIII@Z @ 0x1C00F6D80
 * Callers:
                  ...
                  if ( *((_QWORD *)v55 + 49) )
                  {
                    *(_DWORD *)(v56 + 944) = v111;
                    BLTQUEUE::SetDWMTargetVsync(
                      (BLTQUEUE *)(*(_QWORD *)(*((_QWORD *)v55 + 49) + 8LL) + 2904 * v49),
                      v64);
                  }
                  else
                  {
