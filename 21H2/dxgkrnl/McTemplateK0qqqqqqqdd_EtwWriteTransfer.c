/*
 * XREFs of McTemplateK0qqqqqqqdd_EtwWriteTransfer @ 0x1C0055EE4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqqdd_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  return McGenEventWrite_EtwWriteTransfer(
           ...
           &Dxgk_Diag_OutputDupl_Process_Pointer_Shape,
           a3,
           0xAu,
           &v13);
}
