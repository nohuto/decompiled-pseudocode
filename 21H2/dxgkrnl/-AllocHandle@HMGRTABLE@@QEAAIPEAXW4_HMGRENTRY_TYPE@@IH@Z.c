/*
 * XREFs of ?AllocHandle@HMGRTABLE@@QEAAIPEAXW4_HMGRENTRY_TYPE@@IH@Z @ 0x1C010C9A0
 * Callers:
...
__int64 __fastcall HMGRTABLE::AllocHandle(unsigned int *a1, __int64 a2, int a3, int a4, int a5)
{
  ...
  {
    v15 = WdLogNewEntry5_WdAssertion(a1, v14);
    *(_QWORD *)(v15 + 24) = 170LL;
  ...
  {
    v20 = WdLogNewEntry5_WdAssertion(v16, v14);
    *(_QWORD *)(v20 + 24) = 177LL;
  ...
  *(_DWORD *)(*(_QWORD *)a1 + 16 * v12 + 8) &= ~0x4000u;
  if ( (unsigned int)(a3 - 4) <= 1 )
    *(_DWORD *)(*(_QWORD *)a1 + 16 * v12 + 8) |= 0x4000u;
  --a1[5];
  return (((v23 << 24) | v12 & 0xFFFFFF) << 6) | (*(_DWORD *)(*(_QWORD *)a1 + 16 * v12 + 8) >> 7) & 0x3F;
}
