/*
 * XREFs of ?VmBusCreateAllocationCblt@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C00D8180
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_U@YAPEAX_KIW4DXGK_POOL_FLAGS@@@Z @ 0x1C0027C40 (--_U@YAPEAX_KIW4DXGK_POOL_FLAGS@@@Z.c)
