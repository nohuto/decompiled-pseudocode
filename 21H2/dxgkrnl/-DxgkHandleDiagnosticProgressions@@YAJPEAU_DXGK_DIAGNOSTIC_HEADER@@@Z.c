/*
 * XREFs of ?DxgkHandleDiagnosticProgressions@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C004CE00
 * Callers:
 *     <none>
 * Callees:
 *     _tlgKeywordOn @ 0x1C000B1A8 (_tlgKeywordOn.c)
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$00@@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$00@@@Z @ 0x1C004C5D4 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$00@@@-$_tlgWriteTemplate@$$A6AJPEBU.c)
 */
...
LABEL_3:
  ...
  if ( (unsigned int)dword_1C00B1AC8 > 4 && tlgKeywordOn((__int64)&dword_1C00B1AC8, 1LL) )
  {
    if ( (v7 & 2) != 0 )
    {
      ...
      if ( (unsigned int)dword_1C00B1AC8 <= 4 || !tlgKeywordOn((__int64)&dword_1C00B1AC8, 1LL) )
        return 0LL;
      v11 = (unsigned __int8 *)&unk_1C00800B5;
    ...
    {
      LOBYTE(v10) = v10 & 1;
      v11 = (unsigned __int8 *)&unk_1C0080069;
      v12 = v10;
LABEL_18:
