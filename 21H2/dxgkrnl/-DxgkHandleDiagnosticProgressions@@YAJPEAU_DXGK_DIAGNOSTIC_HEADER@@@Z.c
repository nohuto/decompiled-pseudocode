/*
 * XREFs of ?DxgkHandleDiagnosticProgressions@@YAJPEAU_DXGK_DIAGNOSTIC_HEADER@@@Z @ 0x1C0051D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkHandleDiagnosticProgressions(struct _DXGK_DIAGNOSTIC_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C012F950 > 4 && tlgKeywordOn((__int64)&dword_1C012F950, 1LL) )
  {
    if ( (v14 & v15) != 0 )
    {
      ...
      if ( (unsigned int)dword_1C012F950 <= 4 || !tlgKeywordOn((__int64)&dword_1C012F950, 1LL) )
        return 0LL;
      v19 = (unsigned __int8 *)&unk_1C00980D2;
      v20 = *(_BYTE *)&a1[1].Category.0 & 1;
      goto LABEL_23;
    }
    if ( tlgKeywordOn((__int64)&dword_1C012F950, v13) )
    {
      LOBYTE(v18) = v18 & 1;
      v19 = (unsigned __int8 *)&unk_1C0098086;
      v20 = v18;
LABEL_23:
