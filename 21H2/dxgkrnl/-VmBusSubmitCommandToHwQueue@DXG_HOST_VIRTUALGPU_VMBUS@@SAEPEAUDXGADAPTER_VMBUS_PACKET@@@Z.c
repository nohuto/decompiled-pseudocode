/*
 * XREFs of ?VmBusSubmitCommandToHwQueue@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C03820B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
        ...
        WdLogSingleEntry2(2LL, v8, 5172LL);
        v11 = 5172LL;
      }
      else
      {
