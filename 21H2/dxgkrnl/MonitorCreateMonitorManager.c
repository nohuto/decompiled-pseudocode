/*
 * XREFs of MonitorCreateMonitorManager @ 0x1C019D074
 * Callers:
 ...
 *     ?_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ @ 0x1C019D110 (-_InitializeMonitorManager@MONITOR_MGR@@QEAAJXZ.c)
 */
