/*
 * XREFs of ?ReleaseModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@QEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C0156F50
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE *const a3)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rcx
  struct D3DKMDT_HVIDPNSOURCEMODESET__ *v13; // rbx
  char *v14; // rcx
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v27, 7004LL);
  ...
  *(_QWORD *)(v10 + 32) = this;
  if ( a2 )
  {
    ...
    if ( *(_DWORD *)v13 == 305419896 )
    {
      ...
      if ( v14 )
      {
        v15 = (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)*((_QWORD *)this + 6);
        v16 = (char *)this + 48;
        if ( v15 == (DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL *)((char *)this + 48) || (v17 = (char *)v15 - 8) == 0LL )
        {
LABEL_21:
