/*
 * XREFs of ?DestroyAdapterInfo@DXGPROCESS@@QEAAXPEAUDXGPROCESS_ADAPTER_INFO@@@Z @ 0x1C0114CCC
 * Callers:
  ...
  *(_QWORD *)(*((_QWORD *)this + 6) + 8LL * *(unsigned int *)(v8 + 232)) = 0LL;
  ...
  while ( v9 != (struct DXGPROCESS_ADAPTER_INFO *)(a2 + 13) )
  {
    ...
    if ( *((_QWORD *)v10 + 3)
      ...
      && tlgKeywordOn((__int64)&dword_1C00B1A90, 0x400000000010LL) )
    {
      v14 = *((_QWORD *)this + 8);
      v15 = *((_OWORD *)this + 20);
      v22 = &v28;
