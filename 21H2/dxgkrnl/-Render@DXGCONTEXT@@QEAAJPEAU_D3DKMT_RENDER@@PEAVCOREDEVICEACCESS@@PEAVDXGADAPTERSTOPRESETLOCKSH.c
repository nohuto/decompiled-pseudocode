/*
 * XREFs of ?Render@DXGCONTEXT@@QEAAJPEAU_D3DKMT_RENDER@@PEAVCOREDEVICEACCESS@@PEAVDXGADAPTERSTOPRESETLOCKSHARED@@PEAPEAV1@PEAPEAVDXGALLOCATION@@PEAPEAVDXGHWQUEUE@@@Z @ 0x1C00EAD80
 * Callers:
 ...
 *     ?DisableDdiRenderAllocationList@DXGCONTEXT@@QEAAEXZ @ 0x1C00027F4 (-DisableDdiRenderAllocationList@DXGCONTEXT@@QEAAEXZ.c)
 ...
 *     McTemplateK0ppxppttqddddddddq_EtwWriteTransfer @ 0x1C0048500 (McTemplateK0ppxppttqddddddddq_EtwWriteTransfer.c)
 *     McTemplateK0ppqx_EtwWriteTransfer @ 0x1C0049008 (McTemplateK0ppqx_EtwWriteTransfer.c)
