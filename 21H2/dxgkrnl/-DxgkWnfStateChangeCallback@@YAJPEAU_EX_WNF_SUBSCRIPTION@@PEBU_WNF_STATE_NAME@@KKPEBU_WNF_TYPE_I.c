/*
 * XREFs of ?DxgkWnfStateChangeCallback@@YAJPEAU_EX_WNF_SUBSCRIPTION@@PEBU_WNF_STATE_NAME@@KKPEBU_WNF_TYPE_ID@@PEAX@Z @ 0x1C01E3B00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _EX_RUNDOWN_REF *a6)
{
  ...
  DXGPUSHLOCK::AcquireShared((struct DXGGLOBAL *)((char *)Global + 1488));
  v11 = 0;
  ...
  ExReleasePushLockSharedEx((char *)v13 + 1488, 0LL);
