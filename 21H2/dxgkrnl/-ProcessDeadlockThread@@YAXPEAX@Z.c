  ...
  if ( a1 )
  {
    ...
    if ( (unsigned int)dword_1C00B1A90 > 5 )
    {
      if ( tlgKeywordOn((__int64)&dword_1C00B1A90, 0x400000004000LL) )
      {
        ...
        v8 = *((_DWORD *)a1 + 698);
        v9 = *((unsigned __int8 *)a1 + 2646);
        v10 = *((_DWORD *)a1 + 1120);
        v11 = *((_DWORD *)a1 + 1119);
        v12 = *((unsigned __int8 *)a1 + 209);
        v13 = *((unsigned __int8 *)a1 + 2540);
        v14 = *((unsigned __int8 *)a1 + 2535);
        v15 = *((_DWORD *)a1 + 70);
        v27 = *((_WORD *)a1 + 1298);
        v22 = a1[200];
        v23 = (void *)a1[199];
