/*
 * XREFs of DpiFdoWaitConnectionChangeComplete @ 0x1C038BE24
 * Callers:
...
LABEL_13:
  ...
  if ( !DxgkIsAdapterCoreSyncAcquired(*(DXGADAPTER **)(v2 + 3896), 1) )
  ...
  {
    Object[0] = (PVOID)(v2 + 3528);
    Object[1] = (PVOID)(v2 + 3696);
