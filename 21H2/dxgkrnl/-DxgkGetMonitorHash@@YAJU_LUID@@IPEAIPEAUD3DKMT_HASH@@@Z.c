/*
 * XREFs of ?DxgkGetMonitorHash@@YAJU_LUID@@IPEAIPEAUD3DKMT_HASH@@@Z @ 0x1C01D4190
 * Callers:
...
__int64 __fastcall DxgkGetMonitorHash(struct _LUID a1, unsigned int a2, unsigned int *a3, struct D3DKMT_HASH *a4)
{
  ...
  if ( a3 )
  {
    ...
    {
      v20 = 0;
      DisplayConfigBufferSizes = DxgkGetDisplayConfigBufferSizes(2LL, &v20, (__int64)a3);
