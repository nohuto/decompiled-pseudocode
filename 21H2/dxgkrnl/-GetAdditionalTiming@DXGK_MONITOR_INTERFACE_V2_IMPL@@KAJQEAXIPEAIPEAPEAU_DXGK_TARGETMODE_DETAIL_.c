/*
 * XREFs of ?GetAdditionalTiming@DXGK_MONITOR_INTERFACE_V2_IMPL@@KAJQEAXIPEAIPEAPEAU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z @ 0x1C019AA30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
  ...
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(DxgAdapter) || (v22 = *((_QWORD *)v19 + 337)) == 0 )
  {
  ...
  {
    v38 = WdLogNewEntry5_WdDmmEvent(v26, v25);
    *(_QWORD *)(v38 + 24) = v15;
    *(_QWORD *)(v38 + 32) = v23;
