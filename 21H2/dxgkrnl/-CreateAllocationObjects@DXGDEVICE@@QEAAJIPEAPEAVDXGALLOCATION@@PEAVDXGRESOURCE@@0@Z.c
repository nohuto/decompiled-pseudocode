/*
 * XREFs of ?CreateAllocationObjects@DXGDEVICE@@QEAAJIPEAPEAVDXGALLOCATION@@PEAVDXGRESOURCE@@0@Z @ 0x1C010C650
 * Callers:
 ...
 *     ??0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z @ 0x1C0227480 (--0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z.c)
 */
