/*
 * XREFs of ?AdjustDesktopLayout@CCD_TOPOLOGY@@QEAAJ_N@Z @ 0x1C0134A0C
 * Callers:
 ...
 *     ?_QueryDesktopSurfaceRegionWithRotation@CCD_TOPOLOGY@@CAXAEBUD3DKMT_PATHMODALITY_DESCRIPTOR@@_NPEAU_D3DKMDT_2DREGION@@@Z @ 0x1C014940C (-_QueryDesktopSurfaceRegionWithRotation@CCD_TOPOLOGY@@CAXAEBUD3DKMT_PATHMODALITY_DESCRIPTOR@@_NP.c)
...
__int64 __fastcall CCD_TOPOLOGY::AdjustDesktopLayout(CCD_TOPOLOGY *this, __int64 a2)
{
  ...
  __int64 v32; // r9
  const struct D3DKMT_PATHMODALITY_DESCRIPTOR *v33; // rdi
  __int64 v34; // rcx
  ...
  if ( v17 > 4u )
  {
    ...
    if ( !v67 )
    {
      v69 = WdLogNewEntry5_WdError(v68, v13);
LABEL_89:
  ...
  {
    v18 = *((_QWORD *)this + 8);
    v19 = v18 ? *(unsigned __int16 *)(v18 + 20) : 0LL;
    if ( v2 >= (unsigned __int16)v19 )
      break;
    v52 = CCD_TOPOLOGY::GetPathDescriptor(this, v2);
      ...
      && (v79 || !CCD_TOPOLOGY::IsVirtualSlate(v53, v52)) )
    {
      ...
      cx = v82.cx;
      v16[v81].left = *((_DWORD *)v52 + 36);
      v16[v81].top = *((_DWORD *)v52 + 37);
      v16[v81].right = *((_DWORD *)v52 + 36) + cx;
      v13 = *((_DWORD *)v52 + 37) + v82.cy;
      v16[v81].bottom = v13;
      if ( v12 == -1 && !*((_DWORD *)v52 + 36) && !*((_DWORD *)v52 + 37) )
        v12 = v81;
      ++v81;
    }
    ++v2;
  }
  v20 = (struct tagRECT *)v83;
  if ( v12 == -1 )
  {
    v71 = WdLogNewEntry5_WdWarning(v19, v13, v14);
  ...
  if ( !(*(unsigned int (__fastcall **)(struct tagRECT *, _QWORD, _QWORD))(v11 + 320))(v16, v81, v12) )
  {
    v69 = WdLogNewEntry5_WdError(v23, v22);
    *(_QWORD *)(v69 + 24) = *((_QWORD *)this + 8);
    goto LABEL_89;
  }
  v80 = 0;
  if ( v79 || (v24 = CCD_TOPOLOGY::AdjustSlateVirtualMonitorsPosition(this, v16, &v81, &v80), v27 = v24, v24 >= 0) )
  {
    v28 = 0;
    while ( 1 )
    {
      ...
      if ( v21 >= v30 )
        break;
      v31 = CCD_TOPOLOGY::GetPathDescriptor(this, v21);
      v33 = v31;
      if ( *((_DWORD *)v31 + 53) )
      {
        v73 = v80;
      ...
      else
      {
        v34 = *((_QWORD *)this + 8);
        v35 = 0;
        v36 = *(unsigned __int16 *)(v34 + 20);
        v37 = *(unsigned int *)(272LL * v21 + v34 + 232);
        if ( *(_WORD *)(v34 + 20) )
        {
          v38 = (_DWORD *)(v34 + 232);
...
LABEL_97:
        ...
        if ( v35 == v21 )
        {
          top = v16[v28].top;
          left = v16[v28].left;
          v41 = v16[v28].right - left;
          cy = (unsigned int)(v85[v28].bottom - top);
        ...
        {
          v84 = *((_QWORD *)CCD_TOPOLOGY::GetPathDescriptor(this, v35) + 18);
          v75 = CCD_TOPOLOGY::GetPathDescriptor(this, v35);
          top = HIDWORD(v84);
          left = v84;
        ...
        LODWORD(v84) = cy;
        if ( *((_QWORD *)v33 + 19) != __PAIR64__(v43.cy, v41) )
        {
          v76 = WdLogNewEntry5_WdAssertion(cy, v36);
          WdLogEvent5_WdAssertion(v76);
        }
        if ( *((_DWORD *)v33 + 36) != left )
        {
          v77 = (_QWORD *)WdLogNewEntry5_WdTrace(cy, v36, v37, v32);
          v77[3] = v21;
          v77[4] = *((int *)v33 + 36);
          cy = left;
          v77[5] = left;
        ...
        *((_DWORD *)v33 + 36) = left;
        if ( *((_DWORD *)v33 + 37) != top )
        {
          v78 = (_QWORD *)WdLogNewEntry5_WdTrace(cy, v36, v37, v32);
          v78[3] = v21;
          v78[4] = *((int *)v33 + 37);
          v78[5] = top;
        }
        ...
        *((_DWORD *)v33 + 37) = top;
        if ( v44 )
        {
          *(_QWORD *)(v44 + 76) = *((_QWORD *)v33 + 18);
          v45 = v84;
          *(_DWORD *)(*((_QWORD *)v33 + 28) + 172LL) = v41;
          *(_DWORD *)(*((_QWORD *)v33 + 28) + 176LL) = v45;
          *(_DWORD *)(*((_QWORD *)v33 + 28) + 72LL) |= 0x180020u;
        }
        v16 = v85;
      }
      ++v21;
  ...
  v72 = WdLogNewEntry5_WdError(v26, v25);
