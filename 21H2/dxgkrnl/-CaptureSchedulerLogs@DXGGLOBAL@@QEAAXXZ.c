/*
 * XREFs of ?CaptureSchedulerLogs@DXGGLOBAL@@QEAAXXZ @ 0x1C03097C0
 * Callers:
...
void __fastcall DXGGLOBAL::CaptureSchedulerLogs(DXGGLOBAL *this)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v7, (DXGGLOBAL *)((char *)this + 704), 0);
    ...
    if ( v3[350] )
    {
      ...
      if ( (_BYTE)v4 )
      {
        ...
        if ( *((_DWORD *)v3 + 50) == 1 )
        {
          v6 = (_QWORD *)v3[350];
          if ( !*(_BYTE *)(v6[2] + 209LL) )
            (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(v6[78] + 8LL) + 56LL))(v6[79]);
        }
        if ( v10 )
