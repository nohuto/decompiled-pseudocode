/*
 * XREFs of ??1COMMITVIDPNREQUEST@VIDPN_MGR@@UEAA@XZ @ 0x1C0067BC0
 * Callers:
 *     ??_GCOMMITVIDPNREQUEST@VIDPN_MGR@@UEAAPEAXI@Z @ 0x1C00686C0 (--_GCOMMITVIDPNREQUEST@VIDPN_MGR@@UEAAPEAXI@Z.c)
 * Callees:
