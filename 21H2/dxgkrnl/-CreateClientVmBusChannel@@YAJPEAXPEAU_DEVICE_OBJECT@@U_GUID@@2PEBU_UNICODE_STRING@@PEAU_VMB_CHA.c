/*
 * XREFs of ?CreateClientVmBusChannel@@YAJPEAXPEAU_DEVICE_OBJECT@@U_GUID@@2PEBU_UNICODE_STRING@@PEAU_VMB_CHANNEL_STATE_CHANGE_CALLBACKS@@P6AXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@0II@ZP6AX5I@ZPEAPEAU5@@Z @ 0x1C036141C
 * Callers:
        ...
        struct VMBCHANNEL__ **a9)
{
  ...
  *a9 = 0LL;
  ...
  {
    v17 = 0LL;
    v13 = ((__int64 (__fastcall *)(struct _DEVICE_OBJECT *, _QWORD, struct VMBCHANNEL__ **))qword_1C0131BA0)(
            a2,
            0LL,
            &v17);
    if ( v13 < 0 )
      goto LABEL_10;
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C0131C10)(v17, 0x20000LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64, __int64))qword_1C0131C88)(v17, 256LL, 256LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, struct _VMB_CHANNEL_STATE_CHANGE_CALLBACKS *))qword_1C0131C20)(
      v17,
      v21);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, void (*)(struct VMBCHANNEL__ *, struct VMBPACKETCOMPLETION__ *, void *, unsigned int, unsigned int), _QWORD))qword_1C0131C18)(
      v17,
      v22,
      0LL);
    ((void (__fastcall *)(struct VMBCHANNEL__ *, __int64))qword_1C0131C68)(v17, a1);
    v13 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *, struct _GUID *, struct _GUID *, _QWORD))qword_1C0131C90)(
            v17,
            a3,
            a4,
            0LL);
    if ( v13 < 0
      || (((void (__fastcall *)(struct VMBCHANNEL__ *, _QWORD))qword_1C0131C58)(v17, 0LL),
          ((void (__fastcall *)(struct VMBCHANNEL__ *, const struct _UNICODE_STRING *))qword_1C0131C00)(v17, a5),
          v13 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C0131BD0)(v17),
          v13 < 0) )
    {
LABEL_10:
      if ( v17 )
    ...
    {
      ((void (__fastcall *)(struct VMBCHANNEL__ *))qword_1C0131C80)(v17);
      *a9 = v17;
    }
  }
