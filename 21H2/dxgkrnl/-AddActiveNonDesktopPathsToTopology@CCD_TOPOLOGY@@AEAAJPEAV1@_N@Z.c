/*
 * XREFs of ?AddActiveNonDesktopPathsToTopology@CCD_TOPOLOGY@@AEAAJPEAV1@_N@Z @ 0x1C01C0964
 * Callers:
...
LABEL_20:
  ...
  *((_DWORD *)a2 + 21) |= 1u;
  ...
  v17 = i;
  if ( (unsigned __int16)CCD_TOPOLOGY::Reserve(a2, (unsigned __int16)(i + v16), v6, v7) < v17 + (unsigned int)v15 )
  {
    v18 = *((_QWORD *)this + 8);
    if ( v18 )
      v11 = *(_WORD *)(v18 + 20);
