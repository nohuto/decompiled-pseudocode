/*
 * XREFs of ?DdiDestroyProcess@ADAPTER_RENDER@@QEAAJPEAX@Z @ 0x1C016841C
 * Callers:
 *     ?ADAPTER_RENDER_DdiDestroyProcess@@YAJPEAVADAPTER_RENDER@@PEAX@Z @ 0x1C00422A0 (-ADAPTER_RENDER_DdiDestroyProcess@@YAJPEAVADAPTER_RENDER@@PEAX@Z.c)
...
__int64 __fastcall ADAPTER_RENDER::DdiDestroyProcess(ADAPTER_RENDER *this, void *a2, __int64 a3)
{
  ...
  if ( (qword_1C00B19B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5065);
  }
  else
  {
    v25 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v23, 5065LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, void *))(*((_QWORD *)this + 2) + 888LL))(
