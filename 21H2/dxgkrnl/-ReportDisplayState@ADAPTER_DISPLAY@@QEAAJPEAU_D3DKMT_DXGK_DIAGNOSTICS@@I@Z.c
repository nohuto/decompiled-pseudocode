/*
 * XREFs of ?ReportDisplayState@ADAPTER_DISPLAY@@QEAAJPEAU_D3DKMT_DXGK_DIAGNOSTICS@@I@Z @ 0x1C021408C
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)a2 < 0xFFFFFFFC && *(_DWORD *)a2 + 4 == a3 )
  {
    ...
    if ( (unsigned int)v6 >= 0x14 )
    {
      ...
      DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v29, (ADAPTER_DISPLAY *)((char *)this + 528), 0);
