/*
 * XREFs of ?ReportDisplayState@ADAPTER_DISPLAY@@QEAAJPEAU_D3DKMT_DXGK_DIAGNOSTICS@@I@Z @ 0x1C02C1E48
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)a2 < 0xFFFFFFFC && *(_DWORD *)a2 + 4 == a3 )
  {
    ...
    if ( (unsigned int)v6 >= 0x14 )
    {
      ...
      DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v29, (ADAPTER_DISPLAY *)((char *)this + 608), 0);
      ...
      if ( v10 )
      {
        do
        {
          v12 = *((_QWORD *)this + 16);
          v13 = 4000LL * v11;
          if ( *(_BYTE *)(v12 + v13 + 762) )
          {
            v14 = 0;
            v15 = *(_DWORD *)(v12 + v13 + 3764);
            if ( v15 <= *(_DWORD *)(v12 + v13 + 3760) )
              v15 = *(_DWORD *)(v12 + v13 + 3760);
            if ( v15 )
            {
              do
              {
                LatestPlaneConfigInternal = DISPLAY_SOURCE::GetLatestPlaneConfigInternal(
                                              (DISPLAY_SOURCE *)(v13 + *((_QWORD *)this + 16)),
                                              v14);
      ...
      if ( v10 )
      {
        do
        {
          v24 = (DISPLAY_SOURCE *)(*((_QWORD *)this + 16) + 4000LL * v23);
          if ( *((_BYTE *)v24 + 762) )
          {
