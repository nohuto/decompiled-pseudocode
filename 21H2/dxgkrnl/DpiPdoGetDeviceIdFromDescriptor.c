/*
 * XREFs of DpiPdoGetDeviceIdFromDescriptor @ 0x1C0206D64
 * Callers:
        ...
        (MonitorDescriptorIDs & 0x80000000) != 0) )
  {
    ...
    if ( v6 && (*(_DWORD *)(v2 + 496) != 1 || DpiIsValidEdid(v6)) )
    {
      ...
      *(_QWORD *)(v2 + 928) = PoolWithTag;
      ...
      {
        v9 = *(_OWORD **)(a2 + 8);
        memmove(PoolWithTag, v9, *(unsigned int *)(a2 + 4));
        v10 = *(_DWORD *)(v2 + 496);
        if ( v10 == 1 )
        {
          MonitorGetMonitorDescriptorIDs(*(_QWORD *)(v5 + 3896), *(unsigned int *)(v2 + 504), v2 + 512);
