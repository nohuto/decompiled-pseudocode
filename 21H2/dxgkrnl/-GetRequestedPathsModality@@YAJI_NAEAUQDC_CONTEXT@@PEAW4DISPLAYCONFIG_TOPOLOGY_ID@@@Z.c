/*
 * XREFs of ?GetRequestedPathsModality@@YAJI_NAEAUQDC_CONTEXT@@PEAW4DISPLAYCONFIG_TOPOLOGY_ID@@@Z @ 0x1C01B0DF8
 * Callers:
        ...
        enum DISPLAYCONFIG_TOPOLOGY_ID *a4)
{
  ...
  unsigned int v18; // [rsp+100h] [rbp+18h] BYREF
  ...
  if ( !v4 )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(a1, a2) + 24) = 1244LL;
    return 3221225507LL;
  }
  v18 = 0;
  if ( (a1 & 0x200000) != 0 )
