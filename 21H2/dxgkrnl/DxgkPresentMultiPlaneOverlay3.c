/*
 * XREFs of DxgkPresentMultiPlaneOverlay3 @ 0x1C02A8530
 * Callers:
 *     <none>
 * Callees:
 ...
 *     McTemplateK0qqqqqqq_EtwWriteTransfer @ 0x1C0027F48 (McTemplateK0qqqqqqq_EtwWriteTransfer.c)
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay3(struct _D3DKMT_PRESENT_MULTIPLANE_OVERLAY3 *a1)
{
  ...
  _BYTE v118[160]; // [rsp+1F0h] [rbp-C8h] BYREF
    ...
    if ( v91 >= 0 )
    {
      ...
      if ( v79 )
      {
          ...
          || ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(v79 + 2696), v78, v99.VidPnSourceId) )
        {
          ...
          if ( v91 == -1071775482 )
            DXGDEVICE::CloseInternalCddPrimaryHandle((DXGDEVICE *)v36[2], (struct COREDEVICEACCESS *)v118);
