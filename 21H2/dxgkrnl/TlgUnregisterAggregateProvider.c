/*
 * XREFs of TlgUnregisterAggregateProvider @ 0x1C0300F70
 * Callers:
 ...
 *     CancelTimerCallbacksAndDeleteTimer @ 0x1C0300C30 (CancelTimerCallbacksAndDeleteTimer.c)
...
void __fastcall TlgUnregisterAggregateProvider(__int64 a1)
{
  ...
  {
    v3 = 0LL;
    ExAcquirePushLockExclusiveEx(&unk_1C00B34F8, 0LL);
    v4 = qword_1C00B40D8;
    v5 = &qword_1C00B40D8;
    while ( v4 )
    {
    ...
    ExReleasePushLockExclusiveEx(&unk_1C00B34F8, 0LL);
    if ( v3 )
