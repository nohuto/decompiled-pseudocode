/*
 * XREFs of ?FinalizeTopologyOnAdapter@CCD_TOPOLOGY@@AEAAJPEAVDXGPROCESS@@K@Z @ 0x1C014D16C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  _QWORD *v34; // rax
  _QWORD *v35; // rax
  struct DXGDEVICE *v36; // [rsp+38h] [rbp-C8h] BYREF
  struct DXGDEVICE *v37; // [rsp+40h] [rbp-C0h]
