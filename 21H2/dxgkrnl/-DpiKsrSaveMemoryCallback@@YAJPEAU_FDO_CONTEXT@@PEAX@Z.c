/*
 * XREFs of ?DpiKsrSaveMemoryCallback@@YAJPEAU_FDO_CONTEXT@@PEAX@Z @ 0x1C03939B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  {
    LOBYTE(v5) = 1;
    KsrFreePersistedMemory((char *)a1 + 4784, v5);
    KsrFreePersistedMemory((char *)a1 + 4800, 0LL);
    return *((unsigned int *)a2 + 8);
  }
  if ( (int)v5 >= 0 )
  {
    if ( !*((_QWORD *)a2 + 2) )
    {
      v14 = *(_QWORD *)(*((_QWORD *)a1 + 487) + 2800LL);
      v15 = 0;
      if ( v14 && (v18 = 0, (v16 = *(_QWORD *)(v14 + 1728)) != 0) )
      {
    ...
    if ( v8 > 0x20 )
    {
      v9 = *((_QWORD *)a2 + 3);
      v10 = v8 - 32;
      v11 = *(_QWORD *)(*((_QWORD *)a1 + 487) + 2800LL);
      v12 = 0;
      v18 = 0;
      if ( v11 )
      {
