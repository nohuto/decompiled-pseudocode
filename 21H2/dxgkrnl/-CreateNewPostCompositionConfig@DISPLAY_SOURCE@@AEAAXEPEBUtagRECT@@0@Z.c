/*
 * XREFs of ?CreateNewPostCompositionConfig@DISPLAY_SOURCE@@AEAAXEPEBUtagRECT@@0@Z @ 0x1C02110FC
 * Callers:
 ...
 * Callees:
 *     McTemplateK0pqtqqqqqqqq_EtwWriteTransfer @ 0x1C003B8C8 (McTemplateK0pqtqqqqqqqq_EtwWriteTransfer.c)
