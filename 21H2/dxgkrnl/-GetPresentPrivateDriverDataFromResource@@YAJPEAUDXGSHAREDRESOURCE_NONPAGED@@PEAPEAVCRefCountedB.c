/*
 * XREFs of ?GetPresentPrivateDriverDataFromResource@@YAJPEAUDXGSHAREDRESOURCE_NONPAGED@@PEAPEAVCRefCountedBuffer@@PEAU_D3DDDI_GETRESOURCEPRESENTPRIVATEDRIVERDATA@@@Z @ 0x1C004AA7C
 * Callers:
        ...
        struct _D3DDDI_GETRESOURCEPRESENTPRIVATEDRIVERDATA *a3)
{
  ...
  if ( v8 )
  {
    ...
    {
      v7 = -1073741306;
      WdLogSingleEntry2(3LL, -1073741306LL, 13789LL);
      v8 = 0LL;
    }
  }
