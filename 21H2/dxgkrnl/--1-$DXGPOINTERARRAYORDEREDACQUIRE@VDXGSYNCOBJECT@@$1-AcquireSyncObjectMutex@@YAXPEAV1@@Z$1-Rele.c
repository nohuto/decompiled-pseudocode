/*
 * XREFs of ??1?$DXGPOINTERARRAYORDEREDACQUIRE@VDXGSYNCOBJECT@@$1?AcquireSyncObjectMutex@@YAXPEAV1@@Z$1?ReleaseSyncObjectMutex@@YAX0@Z$01@@QEAA@XZ @ 0x1C0007054
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( v3 )
  {
    if ( !*(_BYTE *)(a1 + 32) )
    {
      ...
      {
        do
          DXGFASTMUTEX::Release((struct _KTHREAD **)(*(_QWORD *)(*(_QWORD *)a1 + 8 * v4++) + 32LL), a2);
