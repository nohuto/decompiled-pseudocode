/*
 * XREFs of ??1?$DXGPOINTERARRAYORDEREDACQUIRE@VDXGSYNCOBJECT@@$1?AcquireSyncObjectMutex@@YAXPEAV1@@Z$1?ReleaseSyncObjectMutex@@YAX0@Z$01@@QEAA@XZ @ 0x1C002C640
 * Callers:
  ...
  if ( v2 )
  {
    if ( !*(_BYTE *)(a1 + 32) )
    {
      if ( *(_BYTE *)(a1 + 33) )
      {
        ...
        {
          do
            DXGFASTMUTEX::Release((struct _KTHREAD **)(*(_QWORD *)(*(_QWORD *)a1 + 8 * v3++) + 32LL));
