/*
 * XREFs of DxgkDdiGetVirtualGpuProfile @ 0x1C0359BC8
 * Callers:
 ...
 *     ?GetVirtualGpuProfile@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETVIRTUALGPUPROFILE@@@Z @ 0x1C0358090 (-GetVirtualGpuProfile@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETVIRTUALGPUPRO.c)
 */
...
__int64 __fastcall DxgkDdiGetVirtualGpuProfile(ADAPTER_RENDER **a1, int a2, unsigned int *a3)
{
  ...
  v5 = 0LL;
  VirtualGpuProfile = (int)ADAPTER_RENDER::GetVirtualGpuProfile(a1[350], a2, (__int64)a3);
  if ( bTracingEnabled )
  {
    v9 = *a3;
