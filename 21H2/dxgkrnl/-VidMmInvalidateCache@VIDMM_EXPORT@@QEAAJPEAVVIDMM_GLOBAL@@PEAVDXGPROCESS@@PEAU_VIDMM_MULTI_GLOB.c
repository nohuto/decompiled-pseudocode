/*
 * XREFs of ?VidMmInvalidateCache@VIDMM_EXPORT@@QEAAJPEAVVIDMM_GLOBAL@@PEAVDXGPROCESS@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAU_VIDMM_MULTI_ALLOC@@_K4@Z @ 0x1C004B038
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  return (*(__int64 (__fastcall **)(struct VIDMM_GLOBAL *, __int64, struct _VIDMM_MULTI_GLOBAL_ALLOC *, struct _VIDMM_MULTI_ALLOC *, unsigned __int64, unsigned __int64))(*((_QWORD *)this + 1) + 1072LL))(
           a2,
           v8,
           a4,
           a5,
