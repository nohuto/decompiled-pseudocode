/*
 * XREFs of DxgkConfirmToken @ 0x1C01E4FEC
 * Callers:
 *     ?ConfirmIndependentFlipEntry@CFlipExBuffer@@UEAAX_K0II0@Z @ 0x1C001E260 (-ConfirmIndependentFlipEntry@CFlipExBuffer@@UEAAX_K0II0@Z.c)
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( !a1 )
  {
    WdLogSingleEntry1(1LL, 2441LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pDxgAdapter != NULL", 2441LL, 0LL, 0LL, 0LL, 0LL);
  }
  ...
  if ( v10 < 0 )
    ...
    (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, __int64, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 350) + 624LL)
                                                                                          + 8LL)
                                                                              + 384LL))(
      *(_QWORD *)(*((_QWORD *)a1 + 350) + 632LL),
      a2,
      v7,
      a4,
      a5,
