/*
 * XREFs of ?Unlock@DXGDEVICE@@QEAAJPEBU_D3DKMT_UNLOCK@@E@Z @ 0x1C0150A60
 * Callers:
...
LABEL_33:
    ...
    if ( *((_DWORD *)this + 144) == 1 && ADAPTER_DISPLAY::IsVidPnSourceOwner(*((DXGADAPTER ***)v57 + 337), this, v48) )
    {
...
LABEL_67:
  ...
  if ( (_DWORD)NumAllocations == 1 )
  {
    ...
    return DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendUnlock2(
             (DXG_GUEST_VIRTUALGPU_VMBUS *)(v44 + 4240),
             Current,
             this,
             &v55,
             1u);
