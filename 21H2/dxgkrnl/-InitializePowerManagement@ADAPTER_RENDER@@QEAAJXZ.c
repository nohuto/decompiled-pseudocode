/*
 * XREFs of ?InitializePowerManagement@ADAPTER_RENDER@@QEAAJXZ @ 0x1C0215D70
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::InitializePowerManagement(ADAPTER_RENDER *this)
{
  ...
  if ( *(int *)(v1 + 2692) >= 1300 )
    v3 = DxgNotifyVSyncCB;
  v16 = v3;
  (*(void (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)(*((_QWORD *)this + 78) + 8LL) + 792LL))(
    *((_QWORD *)this + 79),
    v15);
  (*(void (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)(*((_QWORD *)this + 81) + 8LL) + 744LL))(
    *((_QWORD *)this + 82),
    v15);
  v4 = *(_DWORD *)(v1 + 3040);
  LODWORD(v5) = 0;
  ...
  for ( i = 0LL; ; i += 520LL )
  {
    ...
    {
      case 0:
        v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, int, __int64))(*(_QWORD *)(*((_QWORD *)this + 78)
                                                                                                  + 8LL)
                                                                                      + 800LL))(
                *((_QWORD *)this + 79),
                0LL,
...
LABEL_12:
        ...
        goto LABEL_9;
      case 3:
        v13 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, int))(*(_QWORD *)(*((_QWORD *)this + 81) + 8LL)
                                                                             + 752LL))(
                *((_QWORD *)this + 82),
                *(unsigned __int16 *)(i + v8 + 6),
                *(unsigned int *)(i + v8 + 212),
