/*
 * XREFs of ?CreateNewPathInfo@DXGK_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEAPEAU_D3DKMDT_VIDPN_PRESENT_PATH@@@Z @ 0x1C03A6D10
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)(v7 + 32) = a2;
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    {
      v18 = 0LL;
      v11 = DMMVIDPNTOPOLOGY::AcquireRawDdiEnumeratorCachedPathInfo(v8, &v18, v9, v10);
      v4 = v11;
      if ( v11 >= 0 )
      {
        LODWORD(v4) = 0;
