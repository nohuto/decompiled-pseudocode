/*
 * XREFs of DpiAcpiPrepareAcpiChildNameList @ 0x1C020EAFC
 * Callers:
...
LABEL_12:
  ...
  if ( *v11 != 1198089537 || !v11[1] || IoStatusBlock.Information != v7 )
    goto LABEL_35;
  *(_DWORD *)(a1 + 3280) = 0;
  v12 = ExAllocatePoolWithTag(PagedPool, 16LL * (unsigned int)v11[1], 0x74727044u);
  *(_QWORD *)(a1 + 3296) = v12;
  if ( !v12 )
  {
LABEL_29:
      ...
      if ( (*(_BYTE *)v15 & 1) != 0 )
      {
        ...
        else
        {
          if ( (_DWORD)v34 != 1114596673 || !DWORD2(v34) )
            goto LABEL_39;
          *(_DWORD *)(*(_QWORD *)(a1 + 3296) + 16LL * *(unsigned int *)(a1 + 3280)) = v35;
          *(_QWORD *)(*(_QWORD *)(a1 + 3296) + 16LL * (unsigned int)(*(_DWORD *)(a1 + 3280))++ + 8) = v15 + 8;
        }
      }
      ++v14;
    }
    while ( v14 < *(_DWORD *)(*(_QWORD *)(a1 + 3288) + 4LL) );
  }
LABEL_19:
  if ( (int)v10 < 0 )
  {
