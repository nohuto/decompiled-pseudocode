/*
 * XREFs of ?DdiSuspendContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1C021FC8C
 * Callers:
 *     ?ADAPTER_RENDER_DdiSuspendContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SUSPENDCONTEXT@@@Z @ 0x1C00424C0 (-ADAPTER_RENDER_DdiSuspendContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SUSPENDCONTEXT@@@Z.c)
 * Callees:
