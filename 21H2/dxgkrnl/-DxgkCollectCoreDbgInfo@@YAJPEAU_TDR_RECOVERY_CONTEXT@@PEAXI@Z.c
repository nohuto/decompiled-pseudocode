/*
 * XREFs of ?DxgkCollectCoreDbgInfo@@YAJPEAU_TDR_RECOVERY_CONTEXT@@PEAXI@Z @ 0x1C02CED4C
 * Callers:
...
__int64 __fastcall DxgkCollectCoreDbgInfo(struct _TDR_RECOVERY_CONTEXT *a1, void *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    v6 = *(_QWORD *)(*((_QWORD *)a1 + 4) + 2800LL);
    if ( !v6 )
      return v5;
    v7 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)(*(_QWORD *)(v6 + 624) + 8LL) + 456LL))(*((_QWORD *)a1 + 6));
    v9 = (DXGCONTEXT *)v7;
    if ( !v7 )
      return v5;
    v10 = *(DXGDEVICE **)(v7 + 16);
