/*
 * XREFs of McTemplateK0pqqqqxx_EtwWriteTransfer @ 0x1C004505C
 * Callers:
...
NTSTATUS McTemplateK0pqqqqxx_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
