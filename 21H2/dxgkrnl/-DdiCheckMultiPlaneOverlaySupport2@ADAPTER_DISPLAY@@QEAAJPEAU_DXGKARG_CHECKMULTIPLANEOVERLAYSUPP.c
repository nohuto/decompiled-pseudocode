/*
 * XREFs of ?DdiCheckMultiPlaneOverlaySupport2@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT2@@@Z @ 0x1C0217DA0
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiCheckMultiPlaneOverlaySupport2(
        ADAPTER_DISPLAY *this,
        struct _DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT2 *a2,
        __int64 a3)
{
  __int64 v5; // rdx
  __int64 v6; // rcx
  ...
  if ( (qword_1C00B19B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5067);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5067LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT2 *))(*((_QWORD *)this + 2) + 896LL))(
