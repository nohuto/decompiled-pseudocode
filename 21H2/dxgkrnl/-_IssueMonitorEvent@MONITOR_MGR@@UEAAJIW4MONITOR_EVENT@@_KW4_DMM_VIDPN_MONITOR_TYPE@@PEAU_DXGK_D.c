/*
 * XREFs of ?_IssueMonitorEvent@MONITOR_MGR@@UEAAJIW4MONITOR_EVENT@@_KW4_DMM_VIDPN_MONITOR_TYPE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01F3F00
 * Callers:
...
__int64 __fastcall MONITOR_MGR::_IssueMonitorEvent(_QWORD *a1, unsigned int a2, int a3, __int64 a4, int a5, __int64 a6)
{
  ...
  struct _KTHREAD **v21; // [rsp+78h] [rbp-61h] BYREF
  ...
  if ( !a3 || a3 == 7 )
  {
    ...
    RAPID_HPD_MANAGER::GetCurrenRapidHPDState(
      ...
      &v30,
      0LL);
    if ( (unsigned int)dword_1C012F918 > 5 && tlgKeywordOn((__int64)&dword_1C012F918, 0x400000000080LL) )
    {
      v26 = &v30;
      v27 = v22;
      if ( a6 )
...
LABEL_29:
  ...
  {
LABEL_15:
    if ( (unsigned int)(v7 - 1) <= 2 || (_DWORD)v7 == 7 )
      goto LABEL_16;
    goto LABEL_30;
  }
  if ( (int)v7 <= 7 )
  ...
  for ( i = (_QWORD *)a1[6]; ; i = (_QWORD *)*i )
  {
    ...
    if ( ((int (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, __int64, int, __int64))i[2])(
           *(_QWORD *)(a1[2] + 16LL),
           ...
           a5,
           a6) < 0 )
      WdLogSingleEntry4(2LL, i[2], i[3], v7, v9);
    MUTEX_LOCK::MUTEX_LOCK((MUTEX_LOCK *)&v21, (struct DXGFASTMUTEX *)(a1 + 15));
  }
  return 0LL;
}
