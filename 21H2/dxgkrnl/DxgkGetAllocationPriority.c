/*
 * XREFs of DxgkGetAllocationPriority @ 0x1C02D8080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetAllocationPriority(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _D3DKMT_GETALLOCATIONPRIORITY v27; // [rsp+88h] [rbp-E0h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v22, 2138);
...
LABEL_17:
  ...
  AllocationPriority = DXGDEVICE::GetAllocationPriority(v13, &v27, 1);
  COREDEVICEACCESS::~COREDEVICEACCESS((COREDEVICEACCESS *)v28);
  DXGDEVICEACCESSLOCKSHARED::~DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)v26);
  if ( v21 && _InterlockedExchangeAdd64((volatile signed __int64 *)v21 + 8, 0xFFFFFFFFFFFFFFFFuLL) == 1 )
    ADAPTER_RENDER::DestroyDeviceNoLocks(*((ADAPTER_RENDER **)v21 + 2), v21);
