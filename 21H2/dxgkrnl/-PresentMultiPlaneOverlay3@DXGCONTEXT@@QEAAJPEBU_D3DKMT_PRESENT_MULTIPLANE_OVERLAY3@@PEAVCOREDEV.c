/*
 * XREFs of ?PresentMultiPlaneOverlay3@DXGCONTEXT@@QEAAJPEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY3@@PEAVCOREDEVICEACCESS@@PEAPEAV1@@Z @ 0x1C02A45EC
 * Callers:
 ...
 *     ?IsHdrEnabled@ADAPTER_DISPLAY@@QEBAEI@Z @ 0x1C0048208 (-IsHdrEnabled@ADAPTER_DISPLAY@@QEBAEI@Z.c)
 ...
 *     McTemplateK0qqqpqddddddddddddqqqqqq_EtwWriteTransfer @ 0x1C004B4F4 (McTemplateK0qqqpqddddddddddddqqqqqq_EtwWriteTransfer.c)
 ...
 *     ?ConvertMPOThunkToLegacyPresentThunk@@YAXPEAU_D3DKMT_PRESENT@@PEBU_D3DKMT_PRESENT_MULTIPLANE_OVERLAY3@@PEBU_D3DKMT_MULTIPLANE_OVERLAY3@@@Z @ 0x1C02A3950 (-ConvertMPOThunkToLegacyPresentThunk@@YAXPEAU_D3DKMT_PRESENT@@PEBU_D3DKMT_PRESENT_MULTIPLANE_OVE.c)
 ...
 *     InverseXformMPORect3 @ 0x1C02A3E9C (InverseXformMPORect3.c)
