/*
 * XREFs of ?DxgkCddEvict@@YAJIEPEAU_D3DKMT_EVICT@@PEAD@Z @ 0x1C0151DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddEvict(__int64 a1, char a2, struct _D3DKMT_EVICT *a3, char *a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v58, 3061LL);
  v62[0] = 0LL;
  v63 = 0;
  if ( !a2 )
    goto LABEL_37;
