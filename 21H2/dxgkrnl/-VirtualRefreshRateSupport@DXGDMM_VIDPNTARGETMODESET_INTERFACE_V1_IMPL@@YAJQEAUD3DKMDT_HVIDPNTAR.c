/*
 * XREFs of ?VirtualRefreshRateSupport@DXGDMM_VIDPNTARGETMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTARGETMODESET__@@IPEBU_D3DDDI_RATIONAL@@I@Z @ 0x1C03A3450
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DDDI_RATIONAL *a4)
{
  ...
  if ( v7 )
  {
    v9 = (DMMVIDPNTARGETMODE *)IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(v7 + 24, v4);
    if ( v9 )
    {
      return DMMVIDPNTARGETMODE::SupportVirtualRefreshRate(v9, a3, v11) == 0 ? 0xC01E0306 : 0;
    }
    else
    {
