/*
 * XREFs of _lambda_f259e23562b9d456c7d694602274f108_::operator() @ 0x1C0058DF8
 * Callers:
...
char __fastcall lambda_f259e23562b9d456c7d694602274f108_::operator()(__int64 a1, __int64 a2)
{
  _DWORD *v4; // rcx
  ...
  if ( *(_DWORD *)(a2 + 16) == *v4 && *(_DWORD *)(a2 + 20) == v4[1] && *(_DWORD *)(a2 + 24) == **(_DWORD **)(a1 + 8) )
  {
    if ( *(_QWORD *)(a2 + 48) )
    {
      if ( !*(_QWORD *)(a2 + 88) )
      {
        PoolWithTag = ExAllocatePoolWithTag((POOL_TYPE)512, 0x10uLL, 0x42677844u);
