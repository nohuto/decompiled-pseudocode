/*
 * XREFs of ?_IsValidPacket@MonitorMipiDsiState@DxgMonitor@@AEAAEPEAU_DXGK_DSI_PACKET@@EI@Z @ 0x1C03BA30C
 * Callers:
...
bool __fastcall DxgMonitor::MonitorMipiDsiState::_IsValidPacket(
        DxgMonitor::MonitorMipiDsiState *this,
        struct _DXGK_DSI_PACKET *a2,
        char a3,
        int a4)
{
  unsigned int v7; // ecx
