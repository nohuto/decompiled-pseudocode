/*
 * XREFs of ?CheckOwnership@DXGDISPLAYMANAGEROBJECT@@SAJU_LUID@@IPEAX@Z @ 0x1C01C414C
 * Callers:
...
__int64 __fastcall DXGDISPLAYMANAGEROBJECT::CheckOwnership(struct _LUID a1, unsigned int a2, void *a3)
{
  ...
  if ( v16[0] )
  {
    ...
    else
    {
      ...
      {
        v13 = -1;
        v7 = DmmEnumClientVidPnPathTargetsFromSource((_QWORD *)v16[0], a2, i, &v13);
        v8 = v7;
        if ( v7 < 0 )
          break;
        ...
        if ( a3 )
        {
          ...
          {
            auto_rc<rc_buffer<DispBroker::AlpcRequest<8>>>::reset(&v14, 0LL);
LABEL_29:
            ...
            DxgkLogInternalTriageEvent(
              ...
              0LL,
              0LL);
            auto_rc<rc_buffer<DispBroker::AlpcRequest<8>>>::reset((ReferenceCounted **)&v15, 0LL);
            v8 = -1073741790;
            break;
          }
          auto_rc<rc_buffer<DispBroker::AlpcRequest<8>>>::reset(&v14, 0LL);
