/*
 * XREFs of ?VidMmReleaseDmaBuffer@VIDMM_EXPORT@@QEAAXPEAU_VIDMM_DMA_BUFFER@@PEAPEAU2@@Z @ 0x1C002EC2A
 * Callers:
...
{
  (*(void (__fastcall **)(struct _VIDMM_DMA_BUFFER *, struct _VIDMM_DMA_BUFFER **))(*((_QWORD *)this + 1) + 512LL))(
    a2,
    a3);
}
