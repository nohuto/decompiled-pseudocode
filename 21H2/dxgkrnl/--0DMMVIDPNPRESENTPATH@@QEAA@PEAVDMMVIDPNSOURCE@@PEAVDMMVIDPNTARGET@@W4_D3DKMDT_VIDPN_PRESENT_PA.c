/*
 * XREFs of ??0DMMVIDPNPRESENTPATH@@QEAA@PEAVDMMVIDPNSOURCE@@PEAVDMMVIDPNTARGET@@W4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@G@Z @ 0x1C000C610
 * Callers:
        ...
        unsigned __int16 a5)
{
  ...
  *((_QWORD *)this + 19) = 0LL;
  *((_DWORD *)this + 40) = 0;
  if ( (_DWORD)v5 && ((_DWORD)v5 == 255 || (int)v5 <= 32) )
  {
    *((_DWORD *)this + 26) = v5;
    *((_QWORD *)this + 15) = 0LL;
    *((_DWORD *)this + 30) |= 1u;
