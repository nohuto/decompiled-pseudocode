/*
 * XREFs of ?VmBusDdiGetNodeMetadata@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C036AD40
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDdiGetNodeMetadata(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( *(_BYTE *)(v2 + 173) )
  {
    ...
    if ( v17[4] >= 0 )
    {
      ...
      if ( v8 < v9 )
      {
        v10 = (unsigned __int16 *)(*(_QWORD *)(v5 + 2680) + 344LL * v8);
        ...
        WdLogSingleEntry1(3LL, 4685LL);
      }
      else
      {
        WdLogSingleEntry1(3LL, 4677LL);
      }
