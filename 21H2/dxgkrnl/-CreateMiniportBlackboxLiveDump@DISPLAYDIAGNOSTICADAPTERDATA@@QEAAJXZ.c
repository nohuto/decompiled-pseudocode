/*
 * XREFs of ?CreateMiniportBlackboxLiveDump@DISPLAYDIAGNOSTICADAPTERDATA@@QEAAJXZ @ 0x1C02EEB68
 * Callers:
...
__int64 __fastcall DISPLAYDIAGNOSTICADAPTERDATA::CreateMiniportBlackboxLiveDump(DISPLAYDIAGNOSTICADAPTERDATA *this)
{
  ...
  if ( !*(_QWORD *)this )
  {
    WdLogSingleEntry1(1LL, 1370LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pDisplayAdapter != NULL", 1370LL, 0LL, 0LL, 0LL, 0LL);
  }
  if ( *((_BYTE *)this + 3488) )
  {
