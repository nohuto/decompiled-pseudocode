/*
 * XREFs of DxgkGetPathsModality @ 0x1C01AE940
 * Callers:
        ...
        if ( Active >= 0 && (v4 & 0x2000000) != 0 )
        {
          ...
          for ( i = 0; i < *((unsigned __int16 *)v6 + 10); ++i )
          {
            ...
            if ( (int)CCD_TOPOLOGY::FindPathDescriptorByTarget(
                        ...
                        v6[v17 + 21],
                        &v36) < 0 )
              DxgkGetAdapterDefaultScaling(&v6[v17 + 18], v18 + 196);
            else
              *((_DWORD *)v18 + 49) = *((_DWORD *)CCD_TOPOLOGY::GetPathDescriptor((CCD_TOPOLOGY *)v34, v36) + 35);
