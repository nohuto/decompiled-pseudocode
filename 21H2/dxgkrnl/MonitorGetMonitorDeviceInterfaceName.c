/*
 * XREFs of MonitorGetMonitorDeviceInterfaceName @ 0x1C014660C
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C0019228 (-RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
