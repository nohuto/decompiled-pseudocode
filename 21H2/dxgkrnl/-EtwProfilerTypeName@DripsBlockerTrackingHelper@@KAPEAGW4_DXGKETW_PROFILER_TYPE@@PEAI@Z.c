/*
 * XREFs of ?EtwProfilerTypeName@DripsBlockerTrackingHelper@@KAPEAGW4_DXGKETW_PROFILER_TYPE@@PEAI@Z @ 0x1C02FBDF0
 * Callers:
  ...
  if ( a1 <= 7000 )
  {
    ...
    else
    {
      switch ( a1 )
      {
        case 6000:
          *a2 = 47;
          result = L"DmmInterfaceAcquiredPreferredMonitorSourceMode";
          break;
        case 6001:
          *a2 = 37;
