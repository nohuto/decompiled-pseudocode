/*
 * XREFs of ??_GDXG_GUEST_COMPOSITIONOBJECTCHANNEL@@IEAAPEAXI@Z @ 0x1C02B4164
 * Callers:
 *     ?Delete@DXG_GUEST_COMPOSITIONOBJECTCHANNEL@@UEAAXXZ @ 0x1C02B51A0 (-Delete@DXG_GUEST_COMPOSITIONOBJECTCHANNEL@@UEAAXXZ.c)
 * Callees:
