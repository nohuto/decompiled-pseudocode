/*
 * XREFs of ?AcquireDdiSync@DXGADAPTER@@QEAAXW4DXGADAPTERDDISYNC_LEVEL@@@Z @ 0x1C000B800
 * Callers:
...
char __fastcall DXGADAPTER::AcquireDdiSync(__int64 a1, int a2)
{
  ...
  if ( !v2
    || !*(_QWORD *)(v2 + 632)
    || (LOBYTE(CurrentThread) = (*(__int64 (**)(void))(*(_QWORD *)(*(_QWORD *)(v2 + 624) + 8LL) + 72LL))(),
        !(_BYTE)CurrentThread)
    && (CurrentThread = KeGetCurrentThread(), *(struct _KTHREAD **)(a1 + 2808) != CurrentThread) )
  {
