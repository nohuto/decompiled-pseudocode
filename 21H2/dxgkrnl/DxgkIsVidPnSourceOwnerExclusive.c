/*
 * XREFs of DxgkIsVidPnSourceOwnerExclusive @ 0x1C01C3800
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DxgkIsVidPnSourceOwnerExclusive(ADAPTER_DISPLAY **a1, unsigned int a2, _BYTE *a3)
{
  ...
  if ( !a1 )
  {
    WdLogSingleEntry1(1LL, 7786LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"NULL != pDisplayAdapter", 7786LL, 0LL, 0LL, 0LL, 0LL);
  }
...
LABEL_10:
  ...
  *a3 = 0;
  VidPnSourceOwnerType = ADAPTER_DISPLAY::GetVidPnSourceOwnerType(a1[349], a2);
