/*
 * XREFs of ??1?$NT_OBJECT_REFERENCE@PEAUDXGDISPLAYMANAGEROBJECT_CONTAINER@@@@QEAA@XZ @ 0x1C01660F4
 * Callers:
 ...
 *     DxgkDispMgrReferenceObjectByHandle @ 0x1C02B1E30 (DxgkDispMgrReferenceObjectByHandle.c)
