/*
 * XREFs of ?ReplaceDisplayedAllocation@ADAPTER_DISPLAY@@QEAAXPEBVDXGALLOCATION@@0@Z @ 0x1C00E0928
 * Callers:
 ...
 *     McTemplateK0ppqqt_EtwWriteTransfer @ 0x1C003B378 (McTemplateK0ppqqt_EtwWriteTransfer.c)
 *     ?GetDisplayPlaneConfigHead@@YAPEAU_DISPLAY_PLANE_CONFIG@@PEAU_DISPLAY_PLANE_CONFIG_QUEUE@@PEAH@Z @ 0x1C00E0AB4 (-GetDisplayPlaneConfigHead@@YAPEAU_DISPLAY_PLANE_CONFIG@@PEAU_DISPLAY_PLANE_CONFIG_QUEUE@@PEAH@Z.c)
        ...
        const struct DXGALLOCATION *a3)
{
  ...
  v31 = a3;
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v30, (ADAPTER_DISPLAY *)((char *)this + 528), 0);
