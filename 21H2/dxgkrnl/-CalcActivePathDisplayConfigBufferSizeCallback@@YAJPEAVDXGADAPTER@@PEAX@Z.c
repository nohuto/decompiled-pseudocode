/*
 * XREFs of ?CalcActivePathDisplayConfigBufferSizeCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C01DFEA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CalcActivePathDisplayConfigBufferSizeCallback(struct DXGADAPTER *a1, _DWORD *a2)
{
  ...
  if ( *((_QWORD *)a1 + 349) && *((_DWORD *)a1 + 50) == 1 )
  {
    v4 = *(_QWORD *)(*((_QWORD *)a1 + 349) + 104LL);
