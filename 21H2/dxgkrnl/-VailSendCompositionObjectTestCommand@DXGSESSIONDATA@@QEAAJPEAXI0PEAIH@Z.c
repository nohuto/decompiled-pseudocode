/*
 * XREFs of ?VailSendCompositionObjectTestCommand@DXGSESSIONDATA@@QEAAJPEAXI0PEAIH@Z @ 0x1C02B7084
 * Callers:
 ...
 *     ?AddReference@DXGVAILGUESTOBJECT@@QEAAXXZ @ 0x1C02B4298 (-AddReference@DXGVAILGUESTOBJECT@@QEAAXXZ.c)
