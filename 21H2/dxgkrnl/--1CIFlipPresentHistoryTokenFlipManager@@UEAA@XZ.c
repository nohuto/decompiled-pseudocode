/*
 * XREFs of ??1CIFlipPresentHistoryTokenFlipManager@@UEAA@XZ @ 0x1C0054560
 * Callers:
 *     ??_GCIFlipPresentHistoryTokenFlipManager@@UEAAPEAXI@Z @ 0x1C00545F0 (--_GCIFlipPresentHistoryTokenFlipManager@@UEAAPEAXI@Z.c)
 * Callees:
