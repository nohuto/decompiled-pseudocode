/*
 * XREFs of ?AcquireTargetOwnership@DXGDISPLAYMANAGEROBJECT@@QEAAJU_LUID@@I_NW4_D3DKMT_DISPLAY_TARGET_USAGE@@@Z @ 0x1C02F3954
 * Callers:
        ...
        int a5)
{
  ...
  if ( *(_QWORD *)(a1 + 72) )
  {
    v9 = operator new[](0x28uLL, 0x4B677844u, 256LL, a4);
