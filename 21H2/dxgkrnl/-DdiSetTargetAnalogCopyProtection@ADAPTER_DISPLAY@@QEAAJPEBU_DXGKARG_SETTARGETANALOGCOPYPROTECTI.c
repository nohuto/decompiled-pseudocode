/*
 * XREFs of ?DdiSetTargetAnalogCopyProtection@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETANALOGCOPYPROTECTION@@@Z @ 0x1C02CC908
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v16, 5079);
  ...
  v10 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETANALOGCOPYPROTECTION *))(*((_QWORD *)this + 2)
                                                                                             + 1176LL))(
