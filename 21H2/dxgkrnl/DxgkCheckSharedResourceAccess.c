/*
 * XREFs of DxgkCheckSharedResourceAccess @ 0x1C02D7DB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0DXGPROCESSACCESSLISTMUTEX@@QEAA@PEAVDXGSHAREDRESOURCEACCESS@@@Z @ 0x1C002B748 (--0DXGPROCESSACCESSLISTMUTEX@@QEAA@PEAVDXGSHAREDRESOURCEACCESS@@@Z.c)
 */
