/*
 * XREFs of ?LoadTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEAVCCD_TOPOLOGY@@@Z @ 0x1C0146248
 * Callers:
 ...
 *     ?QueryCloneInfo@CCD_SET_STRING_ID@@QEBAJIPEAI00@Z @ 0x1C012FED8 (-QueryCloneInfo@CCD_SET_STRING_ID@@QEBAJIPEAI00@Z.c)
 ...
 *     ?ClearPathDescriptor@CCD_TOPOLOGY@@SAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C014655C (-ClearPathDescriptor@CCD_TOPOLOGY@@SAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z.c)
        ...
        struct CCD_TOPOLOGY *a2)
{
  ...
  while ( 1 )
  {
    ...
    RegistryValues = CcdReadRegistryValues(Handle, 0LL, &unk_1C00B17E0, 8u, (__int64)v26);
    v13 = RegistryValues;
    if ( RegistryValues < 0 )
      goto LABEL_66;
    *((_QWORD *)v26 + 13) = *((_QWORD *)v26 + 12);
    v30 = CcdReadRegistryValues(Handle, 0LL, &unk_1C00B1500, 2u, (__int64)v53);
    v13 = v30;
    if ( v30 == -1073741772 )
    {
      v53[0] = 0;
