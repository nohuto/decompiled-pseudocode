/*
 * XREFs of ?UpdateDiagnosticReporting@DXGADAPTER@@QEAAJPEAU_ADAPTER_UPDATE_DIAGNOSTIC_REPORTING@1@@Z @ 0x1C02BE998
 * Callers:
...
__int64 __fastcall DXGADAPTER::UpdateDiagnosticReporting(DXGADAPTER *this, UINT *a2)
{
  ...
  v4 = a2[3];
  v6 = v4;
  if ( *((_DWORD *)this + v4 + 1132) < *((_DWORD *)this + v4 + 1134) )
  {
    *((_DWORD *)this + v4 + 1134) = 0;
    ...
    {
      if ( (_DWORD)v4 == 1 && *((int *)this + 606) >= 8960 )
        *((_DWORD *)this + v4 + 1132) = 1;
    }
    else
    {
      v7 = *a2;
      *(_QWORD *)&v13.NoninvasiveTypes.Notifications.0 = 0LL;
      ...
      {
        *((_DWORD *)this + v6 + 1132) = v13.NoninvasiveTypes.Notifications.Value | v13.InvasiveTypes.Notifications.Value;
      }
    }
  }
  v9 = *((_DWORD *)this + v6 + 1132);
  v10 = v9 & a2[1];
  if ( v9 && *((_DWORD *)this + v6 + 1134) != v10 )
  {
    if ( *((__int64 (__fastcall **)(void *const, const struct _DXGKARG_RELEASESWIZZLINGRANGE *))this + 166) == ADAPTER_RENDER::DefaultDdiReleaseSwizzlingRange
