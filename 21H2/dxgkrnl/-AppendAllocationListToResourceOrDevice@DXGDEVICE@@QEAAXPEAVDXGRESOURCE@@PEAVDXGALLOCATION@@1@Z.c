/*
 * XREFs of ?AppendAllocationListToResourceOrDevice@DXGDEVICE@@QEAAXPEAVDXGRESOURCE@@PEAVDXGALLOCATION@@1@Z @ 0x1C016F390
 * Callers:
        ...
        struct DXGALLOCATION *a4)
{
  ...
  DXGPUSHLOCK *v12[5]; // [rsp+30h] [rbp-28h] BYREF
  ...
  {
    DXGAUTOPUSHLOCK::AcquireExclusive(v12);
    *((_QWORD *)a4 + 8) = this[6];
    this[6] = a3;
    v8 = *((_QWORD *)a4 + 8);
    if ( v8 )
