/*
 * XREFs of ?SubmitSingleEntry@DXGDISPLAYCALLOUTQUEUE@@QEAAJPEAUDISPLAY_CALLOUT_ENTRY@@_K@Z @ 0x1C026BE18
 * Callers:
 ...
 *     DpiGdiAsyncDisplayCallout @ 0x1C02C6574 (DpiGdiAsyncDisplayCallout.c)
 */
