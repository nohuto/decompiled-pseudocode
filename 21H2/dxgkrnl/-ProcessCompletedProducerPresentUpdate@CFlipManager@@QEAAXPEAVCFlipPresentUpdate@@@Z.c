/*
 * XREFs of ?ProcessCompletedProducerPresentUpdate@CFlipManager@@QEAAXPEAVCFlipPresentUpdate@@@Z @ 0x1C006BA3C
 * Callers:
 *     ?Complete@CFlipPresentUpdate@@UEAAXXZ @ 0x1C006EA00 (-Complete@CFlipPresentUpdate@@UEAAXXZ.c)
 * Callees:
