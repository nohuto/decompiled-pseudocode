/*
 * XREFs of _lambda_3f5bab62b2f873cd95dd11ae8bfb13c7_::operator() @ 0x1C0157BEC
 * Callers:
...
void __fastcall lambda_3f5bab62b2f873cd95dd11ae8bfb13c7_::operator()(__int64 *a1)
{
  __int64 v1; // rax
  __int64 v3; // r9
  __int64 v4; // rcx
  ...
  if ( (unsigned int)dword_1C012F8A8 > 5 && tlgKeywordOn((__int64)&dword_1C012F8A8, 0x400000008000LL) )
  {
    v4 = a1[3];
    v16 = v3;
    v15 = v4 + 20;
