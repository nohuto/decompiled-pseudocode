/*
 * XREFs of ?DdiSetPointerShape@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPOINTERSHAPE@@@Z @ 0x1C0123EC0
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C00B19B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5018);
  }
  else
  {
    v30 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5018LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPOINTERSHAPE *))(*((_QWORD *)this + 2) + 472LL))(
  ...
  v16[4] = v17;
  v16[5] = a2->Flags.Value;
  v16[6] = a2->Width;
  Height = a2->Height;
  v16[7] = Height;
  if ( (_DWORD)v12 != -1073741801 && (_DWORD)v12 != -1073741637 && (_DWORD)v12 )
  {
    v27 = WdLogNewEntry5_WdError(Height, v17);
    *(_QWORD *)(v27 + 24) = v12;
