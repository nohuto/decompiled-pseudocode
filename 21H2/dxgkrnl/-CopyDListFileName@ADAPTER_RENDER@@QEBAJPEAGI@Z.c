/*
 * XREFs of ?CopyDListFileName@ADAPTER_RENDER@@QEBAJPEAGI@Z @ 0x1C02C322C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::CopyDListFileName(ADAPTER_RENDER *this, char *a2, __int64 a3, __int64 a4)
{
  ...
  if ( (*((_DWORD *)DXGPROCESS::GetCurrent((__int64)this, (__int64)a2, a3, a4) + 106) & 8) != 0 )
  {
    v7 = (char *)*((_QWORD *)this + 65);
    v8 = *((_WORD *)this + 256);
  }
  else
  {
