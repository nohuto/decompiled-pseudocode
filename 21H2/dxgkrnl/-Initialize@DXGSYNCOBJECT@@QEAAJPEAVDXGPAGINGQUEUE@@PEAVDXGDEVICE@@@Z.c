/*
 * XREFs of ?Initialize@DXGSYNCOBJECT@@QEAAJPEAVDXGPAGINGQUEUE@@PEAVDXGDEVICE@@@Z @ 0x1C00DCD40
 * Callers:
 ...
 *     ?Initialize@DXGSYNCOBJECTCA@@QEAAJXZ @ 0x1C0290F68 (-Initialize@DXGSYNCOBJECTCA@@QEAAJXZ.c)
 */
