/*
 * XREFs of ?UnpinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_N@Z @ 0x1C016D450
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v57, 6029LL);
  ...
  if ( a4 )
  {
    ...
    *((_DWORD *)&v60.EnumPivot + 2) = 0;
    ...
    v60.EnumPivotType = D3DKMDT_EPT_ROTATION;
    v60.EnumPivot = v55;
    if ( !v27 )
    {
