/*
 * XREFs of ?GetCCDMonitorID@DXGMONITOR@@UEBAJ_NKPEAG@Z @ 0x1C01B02B0
 * Callers:
...
__int64 __fastcall DXGMONITOR::GetCCDMonitorID(DXGMONITOR *this, unsigned __int8 a2, int a3, unsigned __int16 *a4)
{
  ...
  *(_DWORD *)&Destination.MaximumLength = (unsigned __int16)(2 * a3 - 2);
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v8 + 48LL))(v8) )
    goto LABEL_6;
  v16 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 21) + 56LL))(*((_QWORD *)this + 21));
  v17 = L"MSNIL";
  if ( !v16 )
    v17 = L"MSBDD_";
...
LABEL_6:
    ...
    if ( v9 >= 0 )
    {
      ...
      v19 = RtlAppendUnicodeStringToString(&Destination, (PCUNICODE_STRING)((char *)this + 424));
      v12 = v19;
      if ( v19 >= 0 )
        return 0LL;
    }
    *(_QWORD *)(WdLogNewEntry5_WdTrace(v11, v10) + 24) = v12;
  }
