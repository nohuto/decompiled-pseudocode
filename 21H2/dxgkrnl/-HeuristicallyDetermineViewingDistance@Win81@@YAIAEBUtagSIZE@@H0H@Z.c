/*
 * XREFs of ?HeuristicallyDetermineViewingDistance@Win81@@YAIAEBUtagSIZE@@H0H@Z @ 0x1C0316338
 * Callers:
 ...
 * Callees:
 *     ?IsNativeResolutionOnlyTVTiming@Win81@@YAHUtagSIZE@@H@Z @ 0x1C03164BC (-IsNativeResolutionOnlyTVTiming@Win81@@YAHUtagSIZE@@H@Z.c)
        ...
        const struct tagSIZE *a4)
{
  ...
  if ( v6 < 0x4204 )
  {
    if ( !(unsigned int)Win81::IsNetbookResolution(*a3, v5) )
      return 200LL;
    return 245LL;
  }
  if ( v6 < 0x57E4 )
