/*
 * XREFs of ?SysMmCreateContiguousMemoryPhysicalObject@@YAJPEAUSYSMM_ADAPTER@@_KT_LARGE_INTEGER@@22W4_MEMORY_CACHING_TYPE@@QEAXW4SYSMM_PHYSICAL_OBJECT_OWNER@@PEAPEAUSYSMM_PHYSICAL_OBJECT@@PEAPEAUSYSMM_ADAPTER_OBJECT@@PEAPEAX@Z @ 0x1C006EA10
 * Callers:
 ...
 *     SysMmTestCreateContiguousMemoryPhysicalObject @ 0x1C00710A0 (SysMmTestCreateContiguousMemoryPhysicalObject.c)
 * Callees:
        ...
        _QWORD *a11)
{
  ...
  {
    _InterlockedIncrement(&dword_1C0130B50);
  ...
  PhysicalObject = SmmCreatePhysicalObject(
                     a1,
                     5,
                     a2,
                     (int)&v24,
