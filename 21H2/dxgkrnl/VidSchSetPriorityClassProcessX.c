/*
 * XREFs of VidSchSetPriorityClassProcessX @ 0x1C01DF584
 * Callers:
...
__int64 __fastcall VidSchSetPriorityClassProcessX(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  for ( i = 272LL; ; i += 8LL )
  {
    if ( *(_QWORD *)((char *)DXGGLOBAL_GetGlobal() + i) )
    {
      ...
      {
        WdLogSingleEntry1(1LL, 286LL);
        DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"pVidSchProcess", 286LL, 0LL, 0LL, 0LL, 0LL);
      }
