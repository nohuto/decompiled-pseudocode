/*
 * XREFs of ?DxgCreateLiveDumpWithDriverBlob@@YAJPEAU_DEVICE_OBJECT@@K_K111PEAU_DXGKARG_COLLECTDIAGNOSTICINFO@@@Z @ 0x1C02CE860
 * Callers:
 ...
 *     ?DxgUnicodeStringFromCharBuffer@@YAJAEAU_UNICODE_STRING@@PEADG@Z @ 0x1C02CECE8 (-DxgUnicodeStringFromCharBuffer@@YAJAEAU_UNICODE_STRING@@PEADG@Z.c)
        ...
        struct _DXGKARG_COLLECTDIAGNOSTICINFO *a7)
{
  ...
  {
    WdLogSingleEntry1(2LL, 10752LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"WdDbgReportCreate failed", 10752LL, 0LL, 0LL, 0LL, 0LL);
    return 3221225473LL;
  }
}
