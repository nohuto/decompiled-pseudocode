/*
 * XREFs of ?GetMultiScreenDefaultShellTopology@@YAJPEAW4MultiScreenDefaultShellTopology@@@Z @ 0x1C004D540
 * Callers:
 ...
 * Callees:
 *     ?DetermineMultiScreenCapabilities@DefaultMultiScreenConfig@@YAJPEAW4MultiScreenShellCapabilities@@@Z @ 0x1C004D444 (-DetermineMultiScreenCapabilities@DefaultMultiScreenConfig@@YAJPEAW4MultiScreenShellCapabilities.c)
 *     ?IsMultiScreenClonedByDefault@@YA_NXZ @ 0x1C004D694 (-IsMultiScreenClonedByDefault@@YA_NXZ.c)
 *     ?IsXbox@@YA_NXZ @ 0x1C004D7C0 (-IsXbox@@YA_NXZ.c)
 */
