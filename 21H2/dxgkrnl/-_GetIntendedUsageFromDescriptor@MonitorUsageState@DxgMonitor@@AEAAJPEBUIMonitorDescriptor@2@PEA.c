/*
 * XREFs of ?_GetIntendedUsageFromDescriptor@MonitorUsageState@DxgMonitor@@AEAAJPEBUIMonitorDescriptor@2@PEAW4_DXGK_DISPLAY_USAGE@@PEA_N2@Z @ 0x1C0217544
 * Callers:
      ...
      else
      {
        if ( (_BYTE)a5 != 8 )
        {
          if ( (_BYTE)a5 != 16 )
          {
            ...
            if ( (unsigned __int8)a5 <= 0x11u || (unsigned __int8)a5 > 0x14u )
              goto LABEL_17;
          }
          v6 = 5;
LABEL_17:
