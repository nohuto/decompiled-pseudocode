/*
 * XREFs of ?CreateValidationProcessInCallerSession@DXGVALIDATION@@AEAAJPEAPEAU_EPROCESS@@@Z @ 0x1C005BA68
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)&SourceString.Length = 2883626LL;
  ...
  v5 = operator new[](0x46CuLL, 0x4B677844u, 256LL, a4);
  v6 = (void *)v5;
  if ( v5 )
  {
    *(_DWORD *)(v5 + 4) = 1132;
