/*
 * XREFs of ?DxgkSetPointerShape@@YAJQEAXPEBU_DXGKARG_SETPOINTERPOSITION@@PEBU_DXGKARG_SETPOINTERSHAPE@@IIHH@Z @ 0x1C01220C0
 * Callers:
  ...
  if ( v44 != (_QWORD *)((char *)v43 + 48) )
  {
    ...
    if ( v44 != (_QWORD *)56 )
    {
      ...
      for ( i = SESSION_VIEW::GetPrimaryDisplaySource(v43); i; i = SESSION_VIEW::GetNextDisplaySource(v43, i) )
      {
        ...
        {
          DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v96, (ADAPTER_DISPLAY *)((char *)v53[337] + 408), 0);
