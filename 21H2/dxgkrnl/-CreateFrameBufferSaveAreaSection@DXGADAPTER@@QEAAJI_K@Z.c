/*
 * XREFs of ?CreateFrameBufferSaveAreaSection@DXGADAPTER@@QEAAJI_K@Z @ 0x1C02B9E28
 * Callers:
...
__int64 __fastcall DXGADAPTER::CreateFrameBufferSaveAreaSection(DXGADAPTER *this, unsigned int a2, __int64 a3)
{
  ...
  v3 = 344LL * a2;
  if ( *(_QWORD *)(*((_QWORD *)this + 335) + v3 + 64) )
  {
    WdLogSingleEntry1(1LL, 11016LL);
  ...
  if ( v6 >= 0 )
  {
    *(_QWORD *)(*((_QWORD *)this + 335) + v3 + 64) = v9;
  }
  else
  {
