/*
 * XREFs of ?HandleMonitorArrival@@YAJPEAUMONITORSCOUNT_CALLBACK_CONTEXT@@AEBU_LUID@@IW4MONITOR_EVENT@@_KPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C029624C
 * Callers:
 ...
 *     ?GetPathsCount@CCD_TOPOLOGY@@QEBAGXZ @ 0x1C000A4F0 (-GetPathsCount@CCD_TOPOLOGY@@QEBAGXZ.c)
 ...
 *     ?DetermineDefaultTopology@@YA?AW4MultiScreenDefaultShellTopology@@IE@Z @ 0x1C0295738 (-DetermineDefaultTopology@@YA-AW4MultiScreenDefaultShellTopology@@IE@Z.c)
 ...
 *     ?IsValidCloneConfiguration@@YAEPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C0297604 (-IsValidCloneConfiguration@@YAEPEAUD3DKMT_GETPATHSMODALITY@@@Z.c)
 ...
 *     ?RemovePath@CCD_TOPOLOGY@@QEAAJI@Z @ 0x1C02EB440 (-RemovePath@CCD_TOPOLOGY@@QEAAJI@Z.c)
