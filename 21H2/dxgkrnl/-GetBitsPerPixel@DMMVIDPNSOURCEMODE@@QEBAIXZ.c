/*
 * XREFs of ?GetBitsPerPixel@DMMVIDPNSOURCEMODE@@QEBAIXZ @ 0x1C005C0A4
 * Callers:
 ...
 * Callees:
 *     ?GetBitsPerPixel@@YAIW4_D3DDDIFORMAT@@@Z @ 0x1C000A8D4 (-GetBitsPerPixel@@YAIW4_D3DDDIFORMAT@@@Z.c)
 */
