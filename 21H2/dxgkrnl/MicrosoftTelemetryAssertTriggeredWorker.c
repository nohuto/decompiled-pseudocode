/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C006F64C
 * Callers:
 ...
 *     GetImageTuple @ 0x1C006F5CC (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C006FB58 (_tlgCreate1Sz_char.c)
 *     TakeTelemetryAssertsLock @ 0x1C006FB8C (TakeTelemetryAssertsLock.c)
 */
...
LABEL_33:
  ...
  if ( (unsigned int)dword_1C00D5040 > 5 && tlgKeywordOn((__int64)&dword_1C00D5040, 0x400000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)dword_1C0081C67,
      0LL,
      v24,
      0xBu,
      &v66);
  ...
  if ( dword_1C00D5078 && !v19 && !KeGetCurrentIrql() )
  {
    ...
    if ( (unsigned int)dword_1C00D5040 > 5 )
    {
      ...
      if ( v29 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_1C00D5040,
          (unsigned __int8 *)dword_1C0081CD4,
          v31,
          0LL,
          v32,
          &v50);
