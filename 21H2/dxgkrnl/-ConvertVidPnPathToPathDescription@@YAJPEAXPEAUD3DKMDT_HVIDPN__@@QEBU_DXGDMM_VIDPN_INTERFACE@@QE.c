/*
 * XREFs of ?ConvertVidPnPathToPathDescription@@YAJPEAXPEAUD3DKMDT_HVIDPN__@@QEBU_DXGDMM_VIDPN_INTERFACE@@QEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_NPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C02F6A9C
 * Callers:
        ...
        struct D3DKMT_PATHMODALITY_DESCRIPTOR *a9)
{
  ...
  __int64 v27; // r15
  __int64 v28; // rdx
  const struct _DXGDMM_VIDPNTOPOLOGY_INTERFACE *v29; // rcx
  __int64 v30; // rax
  __int128 v31; // xmm1
  __int64 (__fastcall *v32)(struct D3DKMDT_HVIDPN__ *, _QWORD, __int64 *, __int64 *); // rax
  int v33; // eax
  __int64 v34; // r8
  int v35; // eax
  __int64 v36; // rdx
  ...
  bool v43; // [rsp+59h] [rbp-58h] BYREF
  bool v44; // [rsp+5Ah] [rbp-57h] BYREF
  ...
  v43 = 0;
  v42 = 0;
  if ( (int)DxgkQueryMonitorTypeLockHeld((__int64)a1, v11, 0LL, 0LL, 0LL, 0LL, 0LL, &v44, &v43, &v42) < 0 )
    v17 = 0;
  else
    v17 = (v42 != 0 ? 4 : 0) | (v43 ? 2 : 0) | v44;
  v18 = a9;
  *((_BYTE *)a9 + 129) = v17;
  v19 = v52;
  v20 = *(_DWORD *)(v52 + 12);
  ...
  DXGDMM::AutoRelease<_D3DKMDT_VIDPN_PRESENT_PATH const *,long (*)(D3DKMDT_HVIDPNTOPOLOGY__ *,_D3DKMDT_VIDPN_PRESENT_PATH const *),D3DKMDT_HVIDPNTOPOLOGY__ *>::Own(
    ...
    (__int64)a2);
  v46 = 0LL;
  v26 = (*(__int64 (__fastcall **)(const struct _DXGDMM_VIDPNTOPOLOGY_INTERFACE *, __int64 *))(v45 + 24))(v57, &v46);
  v23 = v26;
  if ( v26 < 0 )
  {
    v27 = v48;
    WdLogSingleEntry3(2LL, v12, v48, v26);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
  ...
  if ( v26 != 1075708679 )
  {
    ...
    *((_BYTE *)v18 + 128) = (unsigned int)(*(_DWORD *)(v46 + 4) - 3) <= 1;
    v30 = v45;
    *((_OWORD *)v18 + 6) = *(_OWORD *)(v28 + 8);
    v31 = *(_OWORD *)(v28 + 24);
    *(_QWORD *)v18 |= 0x100uLL;
    *((_OWORD *)v18 + 7) = v31;
    (*(void (__fastcall **)(const struct _DXGDMM_VIDPNTOPOLOGY_INTERFACE *))(v30 + 32))(v29);
  }
  if ( v47[0] )
    v49(v50, v48);
  v32 = (__int64 (__fastcall *)(struct D3DKMDT_HVIDPN__ *, _QWORD, __int64 *, __int64 *))*((_QWORD *)a3 + 3);
  v45 = 0LL;
  v46 = 0LL;
  v33 = v32(a2, (unsigned int)v11, &v45, &v46);
  v23 = v33;
  if ( v33 < 0 )
  {
    WdLogSingleEntry3(2LL, v11, a2, v33);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
  ...
  v54[0] = 0LL;
  LODWORD(v57) = 0;
  v35 = (*(__int64 (__fastcall **)(__int64, __int64 *, _QWORD *, const struct _DXGDMM_VIDPNTOPOLOGY_INTERFACE **))(v46 + 24))(
          v45,
          &v53,
          v54,
          &v57);
  v16 = v35;
  if ( v35 < 0 || v35 == 1075708679 )
  {
    v41 = v48;
    WdLogSingleEntry2(2LL, v48, v35);
    DxgkLogInternalTriageEvent(
      0LL,
      0x40000,
      -1,
  ...
  *((_OWORD *)v18 + 3) = *(_OWORD *)(v36 + 24);
  *((_OWORD *)v18 + 4) = *(_OWORD *)(v36 + 40);
  v39 = *(_QWORD *)(v36 + 56);
  ...
  *((_DWORD *)v18 + 60) = (_DWORD)v57;
  v40 = v46;
  *((_QWORD *)v18 + 10) = v39;
  (*(void (__fastcall **)(__int64))(v40 + 32))(v38);
  if ( a8 )
  {
