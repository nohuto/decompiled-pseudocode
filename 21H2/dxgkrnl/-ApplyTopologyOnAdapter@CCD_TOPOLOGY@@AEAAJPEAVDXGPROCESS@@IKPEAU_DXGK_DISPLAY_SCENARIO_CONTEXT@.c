/*
 * XREFs of ?ApplyTopologyOnAdapter@CCD_TOPOLOGY@@AEAAJPEAVDXGPROCESS@@IKPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0142C1C
 * Callers:
 ...
 *     ?GetDisplayId@ADAPTER_DISPLAY@@QEBAII@Z @ 0x1C000BA4C (-GetDisplayId@ADAPTER_DISPLAY@@QEBAII@Z.c)
 ...
 *     ?SetDisplayId@ADAPTER_DISPLAY@@QEAAXII@Z @ 0x1C001B3BC (-SetDisplayId@ADAPTER_DISPLAY@@QEAAXII@Z.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a5)
{
  ...
  struct DXGDEVICE *v87; // [rsp+48h] [rbp-B8h]
  ...
  if ( v91[0] )
  {
    v15 = *(_BYTE *)(*((_QWORD *)v91[0] + 337) + 248LL);
    v85 = v15;
    if ( v15 )
    {
      v72 = v91[0];
      *(_BYTE *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + v7 + 76) = 1;
      ...
      if ( (int)COREADAPTERACCESS::AcquireExclusive((__int64)v108, (unsigned int)(v73 + 1)) >= 0
        && ADAPTER_DISPLAY::HasAnyVidPnSourceOwner(*((ADAPTER_DISPLAY **)v14 + 337)) )
      {
        ADAPTER_DISPLAY::ReleaseAllVidPnSourceOwners(*((ADAPTER_DISPLAY **)v14 + 337), 0LL);
      }
    ...
    while ( 1 )
    {
      ...
      v19 = (int)COREDEVICEACCESS::AcquireExclusive((__int64)v105, 2u);
    ...
    {
      v92 = 0LL;
      DmmInterface = DxgkQueryDmmInterface(v91[0]);
      v19 = DmmInterface;
      if ( DmmInterface >= 0 )
      {
        ...
        for ( i = 1; v27 < *((_DWORD *)v26 + 20); i *= 2 )
        {
          ...
          {
            v58 = *((_QWORD *)this + 8);
            v59 = *(_QWORD *)(*((_QWORD *)v14 + 337) + 112LL);
            v60 = 3968LL * v27;
            ...
            *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v14 + 337) + 112LL) + v60 + 644) = *(_QWORD *)(v62 + v64 + 200);
        ...
        else
        {
          ...
          else
          {
            ...
            v42 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v41, v40);
            ...
            if ( *(_DWORD *)(v43 + 80) )
            {
              do
              {
                ...
                else if ( (v45 & *((_DWORD *)v11 + 1)) != 0 )
                {
                  ...
                  if ( v89 < 0 )
                  {
                    v84 = (_QWORD *)WdLogNewEntry5_WdDmmEvent(v50, v49);
                        ...
                        (!v52 & _bittest((const int *)&v53, v44)) != 0) )
                  {
                    ...
                    do
                      v70 = _InterlockedIncrement((volatile signed __int32 *)Global + 316);
                    while ( !v70 );
                    *(_DWORD *)(v88 + v48 + 236) = v70;
                    ADAPTER_DISPLAY::SetDisplayId(*((ADAPTER_DISPLAY **)v14 + 337), (unsigned int)v44, v70);
                  }
                  v54 = v88;
                ...
                if ( ((*((_DWORD *)v11 + 14) | *((_DWORD *)v11 + 20)) & v45) != 0 )
                  ADAPTER_DISPLAY::InvalidateDisplayModeListCacheOnSource(*((ADAPTER_DISPLAY **)v14 + 337), v44);
                v43 = *((_QWORD *)v14 + 337);
