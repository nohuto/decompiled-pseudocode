/*
 * XREFs of ?_QueryMonitorIdStr@CCD_TOPOLOGY@@CAJAEBU_LUID@@IPEAGG1@Z @ 0x1C01D7150
 * Callers:
        ...
        unsigned __int16 *a5)
{
  ...
  v12 = *(VIDPN_MGR **)(*((_QWORD *)v9 + 349) + 104LL);
...
LABEL_23:
  ...
  v15 = (int)VIDPN_MGR::ReleaseMonitorHandle(v12, (struct HDXGMONITOR__ *)v14);
  v16 = 0;
  if ( (int)v15 < 0 )
  {
