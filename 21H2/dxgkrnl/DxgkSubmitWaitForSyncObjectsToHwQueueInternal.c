/*
 * XREFs of DxgkSubmitWaitForSyncObjectsToHwQueueInternal @ 0x1C02746F8
 * Callers:
 ...
 *     DxgkSubmitWaitForSyncObjectsToHwQueue @ 0x1C02746E0 (DxgkSubmitWaitForSyncObjectsToHwQueue.c)
 * Callees:
