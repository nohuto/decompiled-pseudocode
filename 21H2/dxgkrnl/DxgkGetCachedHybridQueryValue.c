/*
 * XREFs of DxgkGetCachedHybridQueryValue @ 0x1C015FF50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetGpuPreferenceDListState@DXGPROCESS@@QEAA?AW4_D3DKMT_GPU_PREFERENCE_QUERY_STATE@@I@Z @ 0x1C0048B0C (-GetGpuPreferenceDListState@DXGPROCESS@@QEAA-AW4_D3DKMT_GPU_PREFERENCE_QUERY_STATE@@I@Z.c)
