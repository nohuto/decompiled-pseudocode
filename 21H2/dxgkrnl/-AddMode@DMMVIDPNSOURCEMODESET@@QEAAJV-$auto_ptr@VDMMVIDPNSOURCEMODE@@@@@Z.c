/*
 * XREFs of ?AddMode@DMMVIDPNSOURCEMODESET@@QEAAJV?$auto_ptr@VDMMVIDPNSOURCEMODE@@@@@Z @ 0x1C010F390
 * Callers:
...
LABEL_16:
  ...
  v20 = 2 - (DMMVIDPNSOURCEMODE::operator==(v8, (__int64)v2) != 0);
LABEL_51:
  ...
  {
    v25 = WdLogNewEntry5_WdTrace(v22, v7, v8, v5);
    *(_QWORD *)(v25 + 24) = *a2;
    *(_QWORD *)(v25 + 32) = v4;
    auto_ptr<DMMVIDPNSOURCEMODE>::~auto_ptr<DMMVIDPNSOURCEMODE>((__int64 (__fastcall ****)(_QWORD, __int64))a2);
    return 3223192340LL;
