/*
 * XREFs of ?_ParseMonitorDescriptors@CCD_SET_STRING_ID@@AEAAXXZ @ 0x1C0132B08
 * Callers:
 ...
 *     ?_CompareDescriptors@CCD_SET_STRING_ID@@AEBAHII@Z @ 0x1C02F0B30 (-_CompareDescriptors@CCD_SET_STRING_ID@@AEBAHII@Z.c)
 */
