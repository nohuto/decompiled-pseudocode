/*
 * XREFs of ?CreateCloned@CFlipToken@@SAJ_K0PEAVCompositionSurfaceObject@@PEBUtagCloneableFlipTokenData@@PEAPEAV1@@Z @ 0x1C0076C68
 * Callers:
        ...
        struct CFlipToken **a5)
{
  ...
  *a5 = 0LL;
  v9 = (CFlipToken *)operator new[](0x250uLL, 0x6F744D54u, 256LL, (__int64)a4);
