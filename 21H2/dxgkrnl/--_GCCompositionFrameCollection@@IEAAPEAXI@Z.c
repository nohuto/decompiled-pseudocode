/*
 * XREFs of ??_GCCompositionFrameCollection@@IEAAPEAXI@Z @ 0x1C000DA4C
 * Callers:
 *     ?Release@CCompositionFrameCollection@@UEAAJXZ @ 0x1C000DA20 (-Release@CCompositionFrameCollection@@UEAAJXZ.c)
 * Callees:
