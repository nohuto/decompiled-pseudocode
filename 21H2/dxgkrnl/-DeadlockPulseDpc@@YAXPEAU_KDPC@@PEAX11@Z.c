        ...
        PVOID SystemArgument2)
{
  ...
  {
    if ( (unsigned int)dword_1C00B1A90 > 5 && tlgKeywordOn((__int64)&dword_1C00B1A90, 0x400000004000LL) )
    {
      LOBYTE(v10) = 1;
