/*
 * XREFs of ?DeadlockPulseDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C0043680
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( UnbiasedInterruptTime - v6 > 10000 * (unsigned __int64)(v8 - *((_DWORD *)DeferredContext + 4))
    && v6 == _InterlockedCompareExchange64((volatile signed __int64 *)(v4 + 4568), UnbiasedInterruptTime, v6) )
  {
    if ( (unsigned int)dword_1C012F918 > 5 && tlgKeywordOn((__int64)&dword_1C012F918, 0x400000004000LL) )
    {
      LOBYTE(v10) = 1;
      v15 = DeferredContext[240];
      IsDebuggerPresent = (unsigned __int8)WdIsDebuggerPresent(v10);
      v17 = *(_DWORD *)(v4 + 2888);
      v18 = *(unsigned __int8 *)(v4 + 2742);
      v19 = *(_DWORD *)(v4 + 4592);
      v20 = *(_DWORD *)(v4 + 4588);
      v21 = *(unsigned __int8 *)(v4 + 209);
      v22 = *(unsigned __int8 *)(v4 + 2636);
      v23 = *(unsigned __int8 *)(v4 + 2631);
      v24 = *(_DWORD *)(v4 + 288);
      v37 = *(_WORD *)(v4 + 2692);
      v32 = *(_QWORD *)(v4 + 1696);
      v33 = *(void **)(v4 + 1688);
