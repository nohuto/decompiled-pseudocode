/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1C013C09C
 * Callers:
 *     BmlCompareTargetModesWithMonitor @ 0x1C013F830 (BmlCompareTargetModesWithMonitor.c)
 * Callees:
 ...
 *     MonitorGetNextMonitorSourceMode @ 0x1C013C230 (MonitorGetNextMonitorSourceMode.c)
 *     BmlGetMonitorModePreference @ 0x1C013C34C (BmlGetMonitorModePreference.c)
 *     BmlIsEDIDCapableOutputTechonology @ 0x1C013C8B0 (BmlIsEDIDCapableOutputTechonology.c)
 */
