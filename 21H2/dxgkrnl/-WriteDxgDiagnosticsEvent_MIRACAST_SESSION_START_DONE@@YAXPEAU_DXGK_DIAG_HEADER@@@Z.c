/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START_DONE@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0045FA4
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START_DONE(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C00B1A20 > 4 && tlgKeywordOn((__int64)&dword_1C00B1A20, 0x200000000400LL) )
  {
    if ( tlgKeywordOn((__int64)&dword_1C00B1A20, v1) )
    {
      v6 = *(_WORD *)(v4 + 4);
      v5 = v4;
      v7 = 5;
