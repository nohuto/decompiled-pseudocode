/*
 * XREFs of ?ReportHpdDepartureSkipped@MonitorUsb4State@DxgMonitor@@QEAAXXZ @ 0x1C01584E4
 * Callers:
...
void __fastcall DxgMonitor::MonitorUsb4State::ReportHpdDepartureSkipped(DxgMonitor::MonitorUsb4State *this)
{
  ...
  if ( !*((_BYTE *)this + 57) && (unsigned int)dword_1C012F8A8 > 5 && tlgKeywordOn((__int64)&dword_1C012F8A8, 0x8000LL) )
  {
    v2 = *(_QWORD *)this;
    v7 = 1;
