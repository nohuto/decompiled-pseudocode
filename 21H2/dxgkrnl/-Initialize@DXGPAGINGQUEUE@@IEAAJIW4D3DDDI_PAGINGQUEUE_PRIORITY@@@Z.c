/*
 * XREFs of ?Initialize@DXGPAGINGQUEUE@@IEAAJIW4D3DDDI_PAGINGQUEUE_PRIORITY@@@Z @ 0x1C016A628
 * Callers:
...
__int64 __fastcall DXGPAGINGQUEUE::Initialize(DXGPAGINGQUEUE *this, unsigned int a2, __int64 a3)
{
  ...
  *((_DWORD *)this + 12) = a2;
  ...
  if ( !v7 )
  {
    v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, char *))(*(_QWORD *)(*(_QWORD *)(v6 + 648) + 8LL) + 904LL))(
           *(_QWORD *)(v4 + 760),
           a2,
           a3,
           (char *)this + 32);
  ...
  LODWORD(v25[0]) = 5;
  v26 = 0;
  v25[1] = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(v10 + 16) + 16LL) + 2764LL);
