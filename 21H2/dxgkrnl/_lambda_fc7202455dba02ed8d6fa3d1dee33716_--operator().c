/*
 * XREFs of _lambda_fc7202455dba02ed8d6fa3d1dee33716_::operator() @ 0x1C0157E94
 * Callers:
...
char __fastcall lambda_fc7202455dba02ed8d6fa3d1dee33716_::operator()(__int64 *a1)
{
  ...
  {
    LOBYTE(v1) = tlgKeywordOn((__int64)&dword_1C012F8A8, 0x8000LL);
    if ( (_BYTE)v1 )
    {
      v4 = *(int **)(v2 + 24);
      v9 = v3;
      ...
      LOBYTE(v1) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)dword_1C009AF4C,
                     0LL,
                     0LL,
                     6u,
                     &v13);
