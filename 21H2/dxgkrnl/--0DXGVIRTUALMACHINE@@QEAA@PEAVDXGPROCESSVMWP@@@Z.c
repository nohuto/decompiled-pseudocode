/*
 * XREFs of ??0DXGVIRTUALMACHINE@@QEAA@PEAVDXGPROCESSVMWP@@@Z @ 0x1C0283D14
 * Callers:
...
DXGVIRTUALMACHINE *__fastcall DXGVIRTUALMACHINE::DXGVIRTUALMACHINE(DXGVIRTUALMACHINE *this, struct DXGPROCESSVMWP *a2)
{
  ...
  *((_DWORD *)this + 90) = 0;
  *((_DWORD *)this + 91) = 256;
  DXG_DEFERRED_WORK_QUEUE_DPC_CBLT::DXG_DEFERRED_WORK_QUEUE_DPC_CBLT((DXGVIRTUALMACHINE *)((char *)this + 368));
  *((_QWORD *)this + 7) = a2;
