/*
 * XREFs of ?VmBusWaitForSyncObjectFromCpuCblt@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C00DB9E0
 * Callers:
 *     <none>
 * Callees:
      ...
      && (v8 *= 8LL, v8 <= 0xFFFFFFFF) )
    {
      ...
      else
      {
        ...
        else if ( *(_DWORD *)(v1 + 128) >= (unsigned int)v16 )
        {
          ...
          *(_QWORD *)(v17 + 24) = 1342LL;
        }
        else
        {
          v17 = WdLogNewEntry5_WdWarning(v16, v13, 0xFFFFFFFFLL);
          *(_QWORD *)(v17 + 24) = 1333LL;
        }
      }
    }
    else
