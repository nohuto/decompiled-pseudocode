/*
 * XREFs of ??$?OU_D3DDDI_RATIONAL@@@@YA_NAEBU_D3DDDI_RATIONAL@@0@Z @ 0x1C0006500
 * Callers:
 ...
 *     ?IsValidFrequencyRange@@YAJAEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z @ 0x1C018C598 (-IsValidFrequencyRange@@YAJAEBU_D3DKMDT_MONITOR_FREQUENCY_RANGE@@@Z.c)
 *     SupportedPixelRate @ 0x1C02FC0E0 (SupportedPixelRate.c)
 *     SupportedVideoSignal @ 0x1C02FC254 (SupportedVideoSignal.c)
 * Callees:
 *     <none>
 */
