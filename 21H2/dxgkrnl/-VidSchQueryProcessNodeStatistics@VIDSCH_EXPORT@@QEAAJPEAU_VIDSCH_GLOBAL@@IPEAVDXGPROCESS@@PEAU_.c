/*
 * XREFs of ?VidSchQueryProcessNodeStatistics@VIDSCH_EXPORT@@QEAAJPEAU_VIDSCH_GLOBAL@@IPEAVDXGPROCESS@@PEAU_D3DKMT_QUERYSTATISTICS_PROCESS_NODE_INFORMATION@@@Z @ 0x1C004A49C
 * Callers:
        ...
        struct _D3DKMT_QUERYSTATISTICS_PROCESS_NODE_INFORMATION *a5)
{
  ...
  {
    WdLogSingleEntry1(1LL, 1233LL);
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x80000000LL) != 0 )
      McTemplateK0zqqzxxxxx_EtwWriteTransfer(v10, v9, v11, 0LL, 2, -1, L"pVidSchProcess", 1233LL, 0LL, 0LL, 0LL, 0LL);
  }
