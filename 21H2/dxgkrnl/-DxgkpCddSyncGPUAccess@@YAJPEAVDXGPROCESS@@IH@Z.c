/*
 * XREFs of ?DxgkpCddSyncGPUAccess@@YAJPEAVDXGPROCESS@@IH@Z @ 0x1C0158BF0
 * Callers:
 ...
 *     ?VmBusSendCddSyncGpuAccess@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@IE@Z @ 0x1C02464B8 (-VmBusSendCddSyncGpuAccess@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@IE@Z.c)
...
LABEL_13:
  ...
  v66 = v67;
  v67 = 0LL;
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v18, v17) + 311) )
  {
...
LABEL_89:
  ...
  if ( !*(_BYTE *)(v27 + 209) )
  {
    if ( *(_QWORD *)(v66 + 24) )
    {
      ...
      KeLeaveCriticalRegion();
      v36 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v27 + 2704)
                                                                                               + 640LL)
                                                                                   + 8LL)
                                                                       + 616LL))(
              *(_QWORD *)(*(_QWORD *)(v27 + 2704) + 648LL),
              *(_QWORD *)(v66 + 24),
              v6 & 0x3F,
              v35);
      v28 = v27 + 136;
...
LABEL_64:
  if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v40, v39) + 311) )
  {
