/*
 * XREFs of ?_PrepareMonitorCCDName@DXGMONITOR@@AEAAJXZ @ 0x1C018E9A8
 * Callers:
 ...
 *     MonitorUnifyCCDMonitorString @ 0x1C0180130 (MonitorUnifyCCDMonitorString.c)
...
LABEL_25:
          ...
          if ( Flink )
          {
            ...
            *(_WORD *)(v38 + 2 * v34 + 24) = 0;
            v46 = (__int64 *)qword_1C00B3F38;
            if ( *(struct _LIST_ENTRY **)qword_1C00B3F38 != &DXGMONITOR::_UniqueEntryList )
              __fastfail(3u);
