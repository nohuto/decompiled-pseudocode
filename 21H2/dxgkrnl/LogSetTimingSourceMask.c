/*
 * XREFs of LogSetTimingSourceMask @ 0x1C01E6720
 * Callers:
...
NTSTATUS __fastcall LogSetTimingSourceMask(__int64 a1, _BYTE *a2)
{
  ...
  __int64 v8; // rcx
  __int64 v9; // r8
  _QWORD v10[10]; // [rsp+B0h] [rbp-80h] BYREF
  ...
  HIBYTE(v10[7]) = a2[156];
  LOBYTE(v10[8]) = a2[52];
  v10[0] = 0x480000002DLL;
  memset(&v10[1], 0, 36);
  CurrentProcessSessionId = PsGetCurrentProcessSessionId(v4);
  result = DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v10, CurrentProcessSessionId);
