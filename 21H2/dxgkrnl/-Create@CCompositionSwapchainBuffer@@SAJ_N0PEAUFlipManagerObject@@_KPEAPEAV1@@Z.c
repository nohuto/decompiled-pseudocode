/*
 * XREFs of ?Create@CCompositionSwapchainBuffer@@SAJ_N0PEAUFlipManagerObject@@_KPEAPEAV1@@Z @ 0x1C0082EE0
 * Callers:
        ...
        struct CCompositionSwapchainBuffer **a5)
{
  ...
  *a5 = 0LL;
  v9 = (CFlipExBuffer *)operator new[](0x2E8uLL, 0x624D5343u, 256LL, a4);
  v10 = v9;
  if ( v9 )
  {
