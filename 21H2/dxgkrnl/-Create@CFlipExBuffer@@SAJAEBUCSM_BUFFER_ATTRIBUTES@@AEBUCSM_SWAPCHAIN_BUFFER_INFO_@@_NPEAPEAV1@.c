/*
 * XREFs of ?Create@CFlipExBuffer@@SAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_SWAPCHAIN_BUFFER_INFO_@@_NPEAPEAV1@@Z @ 0x1C0007530
 * Callers:
 ...
 *     ?ValidateBufferAttributes@@YAJAEBUCSM_BUFFER_ATTRIBUTES@@@Z @ 0x1C0007DD0 (-ValidateBufferAttributes@@YAJAEBUCSM_BUFFER_ATTRIBUTES@@@Z.c)
        ...
        struct CFlipExBuffer **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v7 >= 0 )
  {
    ...
    {
      v8 = (CFlipExBuffer *)operator new[](712LL, 1649234755LL, 256LL);
