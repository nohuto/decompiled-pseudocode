/*
 * XREFs of ?DelayCreateCddAllocations@ADAPTER_DISPLAY@@QEAAJPEAVDXGDEVICE@@IPEAI1PEAVCOREDEVICEACCESS@@@Z @ 0x1C015A878
 * Callers:
        ...
        struct COREDEVICEACCESS *a6)
{
  ...
  v14 = *(ADAPTER_DISPLAY **)(*((_QWORD *)this + 2) + 2792LL);
