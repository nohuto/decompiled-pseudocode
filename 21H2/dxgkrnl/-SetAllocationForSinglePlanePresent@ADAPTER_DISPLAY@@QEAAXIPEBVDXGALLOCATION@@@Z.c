/*
 * XREFs of ?SetAllocationForSinglePlanePresent@ADAPTER_DISPLAY@@QEAAXIPEBVDXGALLOCATION@@@Z @ 0x1C00EF400
 * Callers:
        ...
        const struct DXGALLOCATION *a3)
{
  ...
  v3 = (unsigned int)a2;
  v22 = (ADAPTER_DISPLAY *)((char *)this + 528);
  v23 = 0;
  if ( this == (ADAPTER_DISPLAY *)-528LL )
  {
    v15 = WdLogNewEntry5_WdAssertion(-528LL, a2);
    *(_QWORD *)(v15 + 24) = 762LL;
  ...
  if ( *(struct _KTHREAD **)(*(_QWORD *)(v9 + 8) + 544LL) != v8 )
  {
    v18 = WdLogNewEntry5_WdAssertion(v8, v7);
    *(_QWORD *)(v18 + 24) = 9136LL;
