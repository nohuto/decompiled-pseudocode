/*
 * XREFs of DxgkMiracastStartMiracastSession @ 0x1C0055770
 * Callers:
 ...
 *     ??_GMIRACAST_CHUNK_LIST@@QEAAPEAXI@Z @ 0x1C0052E58 (--_GMIRACAST_CHUNK_LIST@@QEAAPEAXI@Z.c)
 *     ?AllocateNewChunks@MIRACAST_CHUNK_LIST@@QEAAEK@Z @ 0x1C0052F20 (-AllocateNewChunks@MIRACAST_CHUNK_LIST@@QEAAEK@Z.c)
 ...
 *     McTemplateK0pxzqq_EtwWriteTransfer @ 0x1C005686C (McTemplateK0pxzqq_EtwWriteTransfer.c)
...
LABEL_27:
  ...
  *(_QWORD *)(DeviceContextFromName + 88) = KeGetCurrentThread();
  ...
  if ( !*(_DWORD *)(DeviceContextFromName + 408) )
  {
    ...
    *(_DWORD *)(DeviceContextFromName + 672) = dword_1C00B2F50;
    v39 = v101;
