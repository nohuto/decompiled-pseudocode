/*
 * XREFs of ?VmBusLogEventGlobalCblt@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C00D9880
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_GLOBAL_VMBUS::VmBusLogEventGlobalCblt(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v3 )
  {
    ...
    if ( *(_DWORD *)(v6 + 24) == 1 && !_InterlockedCompareExchange(&dword_1C00B3388, 1, 0) )
