/*
 * XREFs of ?DdiSetVirtualGpuResources@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALGPURESOURCES@@@Z @ 0x1C0234838
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v23, 5101LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALGPURESOURCES *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                            + 968LL)
                                                                                + 80LL))(
