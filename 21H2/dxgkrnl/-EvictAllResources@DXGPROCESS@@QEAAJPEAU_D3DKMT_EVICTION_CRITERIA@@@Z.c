/*
 * XREFs of ?EvictAllResources@DXGPROCESS@@QEAAJPEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C0335CB8
 * Callers:
  ...
  *((_QWORD *)v3 + 1) = KeGetCurrentThread();
  ...
  while ( 1 )
  {
    ...
    for ( i = *(_QWORD *)(v7 + 48); i; i = *(_QWORD *)(i + 64) )
    {
      v11 = *(_QWORD *)(i + 24);
      if ( v11 )
        (*(void (__fastcall **)(_QWORD, __int64, _QWORD, struct _D3DKMT_EVICTION_CRITERIA *))(*(_QWORD *)(*(_QWORD *)(v8 + 648) + 8LL)
                                                                                            + 736LL))(
          *(_QWORD *)(v8 + 656),
          v11,
          0LL,
