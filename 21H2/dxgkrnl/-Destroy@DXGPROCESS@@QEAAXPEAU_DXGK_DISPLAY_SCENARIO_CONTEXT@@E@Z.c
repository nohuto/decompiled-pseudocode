/*
 * XREFs of ?Destroy@DXGPROCESS@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@E@Z @ 0x1C011665C
 * Callers:
 ...
 *     ?GetEntryObject@HMGRTABLE@@QEAAPEAXI@Z @ 0x1C016722C (-GetEntryObject@HMGRTABLE@@QEAAPEAXI@Z.c)
 ...
 *     ?SetVmSyncObject@DXGSYNCOBJECT@@QEAAXPEAVDXGPROCESS@@@Z @ 0x1C0292088 (-SetVmSyncObject@DXGSYNCOBJECT@@QEAAXPEAVDXGPROCESS@@@Z.c)
        ...
        if ( (*(_DWORD *)(*v39 + 16LL * v38 + 8) & 0x1F) == 8 )
        {
          ...
          if ( (*((_BYTE *)this + 347) & 0x10) != 0 )
          {
            ...
            *((_DWORD *)EntryObject + 18) = 0;
            DXGPROCESS::FreeResourceHandleNoRefSafe(this, v45);
            if ( v130[8] )
          ...
          else
          {
            ...
            DXGGLOBAL::DestroySyncObject(v46, EntryObject, v45, 0);
          }
        }
        else
        {
          ...
          else
          {
            ...
            if ( (*(_DWORD *)(*v41 + 16LL * v40 + 8) & 0x1F) == 0xC )
            {
              ...
              if ( v139 )
                ...
                DXGPROCESS::FreeResourceHandleNoRefSafe(this, v96);
              if ( v101 )
                *(_QWORD *)(v101 + 8) = v138;
            }
            else if ( (*(_DWORD *)(*v41 + 16LL * v40 + 8) & 0x1F) == 0xD )
            {
              ...
              DXGPROCESS::FreeResourceHandleNoRefSafe(this, v94);
            }
            else if ( (_DWORD)v28 )
            {
