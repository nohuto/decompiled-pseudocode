/*
 * XREFs of ?InvalidateActiveVidPnDisplayModeListCache@ADAPTER_DISPLAY@@QEAAXIQEBU_DMM_COMMITVIDPNREQUEST_DIAGINFO@@@Z @ 0x1C0217198
 * Callers:
        ...
        const struct _DMM_COMMITVIDPNREQUEST_DIAGINFO *const a3)
{
  ...
  {
    WdLogSingleEntry1(1LL, 2935LL);
    DxgkLogInternalTriageEvent(0LL, 262146, -1, (__int64)L"IsCoreResourceExclusiveOwner()", 2935LL, 0LL, 0LL, 0LL, 0LL);
  }
  v5 = 0;
  if ( *((_DWORD *)this + 24) )
  {
