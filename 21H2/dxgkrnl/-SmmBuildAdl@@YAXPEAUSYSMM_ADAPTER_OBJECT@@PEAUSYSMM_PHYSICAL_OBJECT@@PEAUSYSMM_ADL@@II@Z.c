/*
 * XREFs of ?SmmBuildAdl@@YAXPEAUSYSMM_ADAPTER_OBJECT@@PEAUSYSMM_PHYSICAL_OBJECT@@PEAUSYSMM_ADL@@II@Z @ 0x1C006EF84
 * Callers:
 ...
 *     SmmBuildAdlFromAddress @ 0x1C006F01C (SmmBuildAdlFromAddress.c)
 *     SmmBuildAdlFromMdl @ 0x1C006F054 (SmmBuildAdlFromMdl.c)
 */
