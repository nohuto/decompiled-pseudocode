/*
 * XREFs of DxgNotifyDpcCB @ 0x1C0014800
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DxgNotifyDpcCB(__int64 a1)
{
  ...
  if ( (_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 64) + 3920LL), 0, 0) & 1) != 0 )
  {
    v2 = *(_QWORD *)(a1 + 64);
    if ( v2 && *(_DWORD *)(v2 + 16) == 1953656900 && *(_DWORD *)(v2 + 20) == 2 )
    {
      v3 = *(struct DXGADAPTER **)(v2 + 3896);
      if ( v3 )
      {
        v4 = *((_QWORD *)v3 + 350);
        if ( v4 )
        {
          (*(void (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v4 + 624) + 8LL) + 16LL))(a1);
        }
        else
        {
          v10 = *(DXGDODPRESENT **)(*((_QWORD *)v3 + 349) + 448LL);
          if ( v10 )
    ...
    if ( v6 )
    {
      ...
      *((_QWORD *)&v15 + 1) = *(_QWORD *)(v6 + 488);
      ...
      else
      {
        if ( (_BYTE)v16 )
          *(_BYTE *)(v6 + 588) = 1;
        if ( HIDWORD(v16) < 0x14 && *(_DWORD *)(v5 + 3252) + 5 < 40 )
        {
          v19 = *(_DWORD *)(v5 + 3216);
          v18 = 0;
          v17[1] = v17;
