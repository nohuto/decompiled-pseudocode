/*
 * XREFs of ?StartVSync@BLTQUEUE@@AEAAXHW4VsyncEvent@1@@Z @ 0x1C01CEF58
 * Callers:
...
void __fastcall BLTQUEUE::StartVSync(__int64 a1, int a2, char a3)
{
  ...
  if ( (v3 & 8) != 0 && (v3 & 2) == 0 )
  {
    ...
    if ( *(_DWORD *)(a1 + 136) == 2
      && *((_BYTE *)DXGGLOBAL_GetGlobal() + 304912)
      && (Global = DXGGLOBAL_GetGlobal(), DXGGLOBAL::IsVmConnectedToHost(Global)) )
    {
      ...
      if ( (unsigned int)dword_1C012F8A8 > 5 )
      {
        ...
        if ( v12 > 5 && tlgKeywordOn((__int64)&dword_1C012F8A8, 0x80000LL) )
        {
          v23 = *(_DWORD *)(a1 + 136);
          v24 = v9;
