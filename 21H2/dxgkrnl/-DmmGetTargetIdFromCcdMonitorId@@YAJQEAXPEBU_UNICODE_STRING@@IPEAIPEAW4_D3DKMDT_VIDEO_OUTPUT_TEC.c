/*
 * XREFs of ?DmmGetTargetIdFromCcdMonitorId@@YAJQEAXPEBU_UNICODE_STRING@@IPEAIPEAW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@3PEAE4@Z @ 0x1C012FF7C
 * Callers:
 ...
 *     ??1?$AutoBuffer@G@DMM@@UEAA@XZ @ 0x1C000A388 (--1-$AutoBuffer@G@DMM@@UEAA@XZ.c)
      ...
      if ( !v64 )
      {
        ...
        *a6 = v32;
        ...
        if ( v37 )
        {
          ...
          {
            v42 = WdLogNewEntry5_WdDmmEvent(v34, v20);
            *(_QWORD *)(v42 + 24) = v35;
            *(_QWORD *)(v42 + 32) = v10;
