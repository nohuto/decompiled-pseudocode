/*
 * XREFs of ??_GDXG_GUEST_REMOTEOBJECTCHANNEL@@IEAAPEAXI@Z @ 0x1C02B41BC
 * Callers:
 *     ?Delete@DXG_GUEST_REMOTEOBJECTCHANNEL@@UEAAXXZ @ 0x1C02B51C0 (-Delete@DXG_GUEST_REMOTEOBJECTCHANNEL@@UEAAXXZ.c)
 * Callees:
