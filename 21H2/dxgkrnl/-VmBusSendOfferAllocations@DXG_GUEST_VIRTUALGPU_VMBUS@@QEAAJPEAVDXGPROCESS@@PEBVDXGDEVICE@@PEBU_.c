/*
 * XREFs of ?VmBusSendOfferAllocations@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEBVDXGDEVICE@@PEBU_D3DKMT_OFFERALLOCATIONS@@PEBI@Z @ 0x1C0379FF8
 * Callers:
        ...
        const unsigned int *a5)
{
  ...
  {
    WdLogSingleEntry1(2LL, 10068LL);
    DxgkLogInternalTriageEvent(0LL, 0x40000, -1, (__int64)L"NumAllocations is invalid", 10068LL, 0LL, 0LL, 0LL, 0LL);
    ...
    *((_BYTE *)v10 + 40) = 1;
    ...
    if ( a4->NumAllocations )
    {
      while ( 1 )
      {
        ...
        if ( (unsigned int)v12 >= *((_DWORD *)a2 + 74) )
          goto LABEL_13;
        v13 = *((_QWORD *)a2 + 35);
        v14 = *(_DWORD *)(v13 + 16 * v12 + 8);
        if ( ((v25[v11] >> 25) & 0x60) != (*(_BYTE *)(v13 + 16 * v12 + 8) & 0x60)
          || (v14 & 0x2000) != 0
          || (v14 & 0x1F) == 0 )
        {
          goto LABEL_13;
...
LABEL_16:
  ...
  *((_BYTE *)v10 + 40) = 0;
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v19 >= *((_DWORD *)a2 + 74) )
      goto LABEL_29;
    v20 = *((_QWORD *)a2 + 35);
    v21 = *(_DWORD *)(v20 + 16 * v19 + 8);
    if ( ((v25[v18] >> 25) & 0x60) != (*(_BYTE *)(v20 + 16 * v19 + 8) & 0x60)
      || (v21 & 0x2000) != 0
      || (v21 & 0x1F) == 0 )
    {
      goto LABEL_29;
