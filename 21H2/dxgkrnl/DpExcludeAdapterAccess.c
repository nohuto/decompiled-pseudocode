/*
 * XREFs of DpExcludeAdapterAccess @ 0x1C0386800
 * Callers:
 *     <none>
 * Callees:
...
LABEL_35:
  ...
  if ( ((*((_DWORD *)DeviceExtension + 996) - 1) & 0xFFFFFFFB) == 0 )
  {
    v12 = -1073741661LL;
    v9 = -1073741661;
    goto LABEL_15;
  ...
  v11 = a2 & 2;
  if ( (a2 & 2) != 0 && ((a2 & 1) != 0 || !DxgkIsAdapterCoreSyncAcquired(*((DXGADAPTER **)DeviceExtension + 487), 2)) )
  {
    v9 = -1073741637;
    v12 = -1073741637LL;
LABEL_15:
...
LABEL_36:
  ...
  if ( (a2 & 4) != 0 && (!*((_QWORD *)DeviceExtension + 363) || !*((_QWORD *)DeviceExtension + 364)) )
  {
    v9 = -1073741637;
...
LABEL_30:
  ...
  *(_QWORD *)PoolWithTag = a3;
  *((_QWORD *)PoolWithTag + 1) = a4;
  *((_DWORD *)PoolWithTag + 4) = a2;
  *((_QWORD *)PoolWithTag + 3) = (unsigned __int64)&Event & -(__int64)(v11 != 0);
  memset(PoolWithTag + 32, 0, 0x48uLL);
  EtwActivityIdControl(3u, (LPGUID)(PoolWithTag + 40));
  *((_QWORD *)PoolWithTag + 12) = MEMORY[0xFFFFF78000000014];
