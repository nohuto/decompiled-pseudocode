/*
 * XREFs of DxgkOpenSyncObjectFromNtHandle @ 0x1C0279660
 * Callers:
 *     <none>
 * Callees:
...
LABEL_37:
  ...
  if ( bTracingEnabled )
  {
    v26 = v44 ? *((_QWORD *)v44 + 4) : 0LL;
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0ppp_EtwWriteTransfer(v23, &EventOpenSyncObject, v24, v26, v42.hSyncObject, 0LL);
  }
  if ( LOBYTE(Handle[1]) )
    DXGSYNCOBJECTLOCK::Release((DXGSYNCOBJECTLOCK *)Handle);
  ...
  Current = DXGPROCESS::GetCurrent(MmUserProbeAddress, (__int64)v27);
