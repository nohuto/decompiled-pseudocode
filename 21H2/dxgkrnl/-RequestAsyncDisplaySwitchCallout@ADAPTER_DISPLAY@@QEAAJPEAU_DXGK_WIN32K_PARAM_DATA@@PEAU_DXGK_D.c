/*
 * XREFs of ?RequestAsyncDisplaySwitchCallout@ADAPTER_DISPLAY@@QEAAJPEAU_DXGK_WIN32K_PARAM_DATA@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02143C8
 * Callers:
 ...
 *     ??0DISPLAY_CALLOUT_ENTRY@@QEAA@PEAU_DXGK_WIN32K_PARAM_DATA@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0268128 (--0DISPLAY_CALLOUT_ENTRY@@QEAA@PEAU_DXGK_WIN32K_PARAM_DATA@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v23, (struct DXGFASTMUTEX *const)(this + 58), 0);
  ...
  if ( v14 )
  {
    if ( *((_BYTE *)this + 504) )
    {
      v17 = (ADAPTER_DISPLAY **)this[65];
      if ( *v17 != (ADAPTER_DISPLAY *)(this + 64) )
        __fastfail(3u);
      *(_QWORD *)v14 = this + 64;
      *((_QWORD *)v14 + 1) = v17;
      *v17 = v14;
