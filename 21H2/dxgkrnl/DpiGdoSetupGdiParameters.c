/*
 * XREFs of DpiGdoSetupGdiParameters @ 0x1C0204478
 * Callers:
 ...
 *     DpiFdoGetAdapterUniqueGUID @ 0x1C0204CF4 (DpiFdoGetAdapterUniqueGUID.c)
 *     DpiCopyUnicodeString @ 0x1C0205560 (DpiCopyUnicodeString.c)
 */
