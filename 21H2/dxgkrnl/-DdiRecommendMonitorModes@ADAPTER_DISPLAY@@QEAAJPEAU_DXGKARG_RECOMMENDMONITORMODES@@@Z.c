/*
 * XREFs of ?DdiRecommendMonitorModes@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDMONITORMODES@@@Z @ 0x1C021A0B4
 * Callers:
 *     ?QueryDriverRecommendedMonitorModes@KernelDriver@@UEBAJXZ @ 0x1C021A050 (-QueryDriverRecommendedMonitorModes@KernelDriver@@UEBAJXZ.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v18, 5037);
  ...
  v13[3] = v10;
  v13[4] = *(_QWORD *)(*((_QWORD *)this + 2) + 280LL);
  v13[5] = a2->VideoPresentTargetId;
  v13[6] = a2->hMonitorSourceModeSet;
  v13[7] = a2->pMonitorSourceModeSetInterface;
