/*
 * XREFs of ??1?$PagedPoolZeroedArray@PEAVDXGALLOCATION@@$02@@QEAA@XZ @ 0x1C0251968
 * Callers:
...
void __fastcall PagedPoolZeroedArray<DXGALLOCATION *,3>::~PagedPoolZeroedArray<DXGALLOCATION *,3>(__int64 a1)
{
  void *v2; // rcx
