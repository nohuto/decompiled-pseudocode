/*
 * XREFs of ?DdiQueryDPCaps@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_QUERYDPCAPS@@@Z @ 0x1C021C978
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiQueryDPCaps(ADAPTER_DISPLAY *this, struct _DXGKARG_QUERYDPCAPS *a2, __int64 a3)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rcx
  __int64 (__fastcall *v13)(_QWORD, struct _DXGKARG_QUERYDPCAPS *); // rax
  int v14; // ebx
  _QWORD *v15; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5149LL);
  ...
  if ( v12 && (v13 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDPCAPS *))(v12 + 32)) != 0LL )
