/*
 * XREFs of ?DxgkWaitForVerticalBlankEventInternal@@YAJIIIIPEAPEAU_KEVENT@@@Z @ 0x1C0157380
 * Callers:
 ...
 *     ?ControlVSyncAdapter@ADAPTER_DISPLAY@@QEAAJI@Z @ 0x1C0210D78 (-ControlVSyncAdapter@ADAPTER_DISPLAY@@QEAAJI@Z.c)
