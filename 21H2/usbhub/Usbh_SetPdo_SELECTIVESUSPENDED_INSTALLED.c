/*
 * XREFs of Usbh_SetPdo_SELECTIVESUSPENDED_INSTALLED @ 0x1C0048560
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_SetPdo_SELECTIVESUSPENDED_INSTALLED(__int64 a1, const wchar_t *a2, _DWORD *a3, int a4)
{
  _UNKNOWN **result; // rax
