    ...
    else
    {
      ...
      if ( v35 )
      {
        ...
        if ( v36 )
        {
          ...
          v39 = (__int64 (__fastcall *)())qword_1C005FB28[2 * v38];
        }
        else
        {
          Log((_DWORD)v9, 4, 1129270885, (_DWORD)v7, 0LL);
          v39 = off_1C0061748[2 * v42];
        }
      }
      else
      {
        Log((_DWORD)v9, 4, 1129270883, (_DWORD)v7, 0LL);
        v39 = off_1C0061B48[2 * v43];
      }
    }
LABEL_54:
    if ( !v39 )
  ...
  switch ( a2 )
  {
    case 0x20000u:
      ...
      v39 = (__int64 (__fastcall *)())qword_1C005F928[2 * v41];
      goto LABEL_54;
    case 0x10000u:
      Log((_DWORD)v9, 4, 1129270900, (_DWORD)v7, 0LL);
      v39 = off_1C0061948[2 * v45];
      goto LABEL_54;
    case 0x40000u:
