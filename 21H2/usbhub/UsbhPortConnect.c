/*
 * XREFs of UsbhPortConnect @ 0x1C004C820
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
    ...
    do
    {
      if ( (unsigned __int64)(v10 - v8) > 0x1E8480 && v3 > 1 )
      {
        ...
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
        {
          LODWORD(v14) = *(unsigned __int16 *)(a2 + 4);
          WPP_RECORDER_SF_d(
            (__int64)WPP_GLOBAL_Control->DeviceExtension,
            0,
            1u,
      ...
      UsbhWait(a1, 0x14u);
      v10 = MEMORY[0xFFFFF78000000008];
      v11 = MEMORY[0xFFFFF78000000008] + v11 - v9;
      v9 = MEMORY[0xFFFFF78000000008];
    ...
    v12 = UsbhAllocateTimeoutObject(a1, a2, &P);
    if ( v12 >= 0 )
    {
    ...
    UsbhException(a1, *(_WORD *)(a2 + 4), 2u, 0LL, 0, v12, -1, usbfile_busfunc_c, 650, 0);
  }
  else
  {
    UsbhEtwLogHubIrpEvent(a1, 0LL, 0LL, &USBHUB_ETW_EVENT_HUB_ENUM_CREATE_PDO_FAILURE);
