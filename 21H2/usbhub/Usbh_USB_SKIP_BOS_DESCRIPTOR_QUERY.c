/*
 * XREFs of Usbh_USB_SKIP_BOS_DESCRIPTOR_QUERY @ 0x1C0048E30
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_USB_SKIP_BOS_DESCRIPTOR_QUERY(__int64 a1, const wchar_t *a2, _BYTE *a3, int a4)
{
  _UNKNOWN **result; // rax
