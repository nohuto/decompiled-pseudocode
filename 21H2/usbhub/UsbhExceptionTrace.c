/*
 * XREFs of UsbhExceptionTrace @ 0x1C004A388
 * Callers:
 ...
 *     log_xstr @ 0x1C0040EFC (log_xstr.c)
  ...
  if ( a2 && a3 )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        ...
        {
          if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
            WPP_RECORDER_SF_ds(WPP_GLOBAL_Control->DeviceExtension, a2, a3, a4, v13, *(_DWORD *)a3, *(_QWORD *)(a3 + 8));
          if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          {
            if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
              WPP_RECORDER_SF_sd(
