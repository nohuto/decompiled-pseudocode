/*
 * XREFs of UsbhRegQueryGlobalLegacyDeviceKeys @ 0x1C004753C
 * Callers:
...
__int64 __fastcall UsbhRegQueryGlobalLegacyDeviceKeys(__int64 a1, __int64 a2)
{
  ...
  __int64 (__fastcall *v14)(const wchar_t *, __int64, const void *, unsigned int, __int64, __int64); // [rsp+78h] [rbp-90h] BYREF
  ...
  __int64 (__fastcall *v21)(const wchar_t *, __int64, const void *, unsigned int, __int64, __int64); // [rsp+B0h] [rbp-58h]
  ...
  v3 = (const wchar_t **)PdoExt(a2);
  *((_DWORD *)v3 + 358) &= ~0x800u;
  ...
  *((_WORD *)PoolWithTag + 26) = 0;
  ...
  if ( (GlobalKey & 0xC0000000) != 0xC0000000 )
  {
    ...
    v29 = 0;
    v30 = 0LL;
    GlobalKey = UsbhRegQueryGlobalKey(2u, L"usbflags", 2LL, (__int64)&v14, 0xA8u);
    if ( (GlobalKey & 0xC0000000) != 0xC0000000 )
    {
      if ( (_BYTE)v11 )
        *((_DWORD *)v3 + 358) |= 0x800u;
  ...
  if ( *((_DWORD *)v3 + 549) && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
