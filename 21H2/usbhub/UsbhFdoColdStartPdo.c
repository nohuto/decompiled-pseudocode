/*
 * XREFs of UsbhFdoColdStartPdo @ 0x1C001C580
 * Callers:
...
__int64 __fastcall UsbhFdoColdStartPdo(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v7 = FdoExt(a1);
  v8 = PdoExt(a3);
  PortState = (int)UsbhQueryPortState(a1, *(_WORD *)(a4 + 4), (__int64)&v28, v27);
  ...
  if ( (PortState & 0xC0000000) == 0xC0000000 )
  {
    ...
    if ( !(unsigned __int8)Usb_Disconnected((unsigned int)PortState) )
    {
      ...
      v25 = 3079;
LABEL_13:
      UsbhException(a1, *(unsigned __int16 *)(a4 + 4), 48, v17, 0, PortState, v27[0], usbfile_fdopwr_c, v25, v26);
...
LABEL_3:
  ...
  if ( (v28 & 1) == 0 )
  {
    ...
    v19 = UsbhQueryPortState(a1, *(_WORD *)(a4 + 4), (__int64)&v28, v27);
...
LABEL_4:
  Log(a1, v11, 1667510577, v12, HIWORD(v28));
  if ( (v28 & 1) == 0 )
  {
    ...
    else
    {
      ...
      LOBYTE(v26) = 0;
      UsbhException(a1, *(unsigned __int16 *)(a4 + 4), 127, 0, 0, 0, 0, usbfile_fdopwr_c, 3197, v26);
  ...
  v20 = PdoExt(a3);
  v21 = UsbhFlushPortChange(a1, *(unsigned __int16 *)(a4 + 4), v27);
  ...
  if ( v21 >= 0 )
  {
    ...
    if ( (v22 & 0x8000000) == 0 )
    {
      ...
      if ( v23 )
      {
        ...
        LOBYTE(v26) = 0;
        UsbhException(a1, *(unsigned __int16 *)(a4 + 4), 114, 0, 0, PortState, v27[0], usbfile_fdopwr_c, 3156, v26);
        v20[596] = v7[1054];
      }
      return (unsigned int)PortState;
    }
  ...
  {
    LOBYTE(v26) = 0;
    UsbhException(a1, *(unsigned __int16 *)(a4 + 4), 52, 0, 0, PortState, v27[0], usbfile_fdopwr_c, 3172, v26);
    return (unsigned int)PortState;
  }
LABEL_12:
