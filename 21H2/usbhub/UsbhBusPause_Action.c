    ...
    for ( i = 1; ; ++i )
    {
      ...
      if ( v22 )
      {
        ...
        *(_DWORD *)(v67 + 1420) |= 0x10000000u;
        ...
        LOBYTE(v67) = KeAcquireSpinLockRaiseToDpc(&HubG);
        qword_1C006C500 = (__int64)&dword_1C006C508;
        UsbhDerefPdo((__int64)DeviceObject, v22, 0LL, 0x50617550u);
        qword_1C006C500 = 0LL;
        KeReleaseSpinLock(&HubG, v67);
      }
      HIDWORD(v75) = 0;
        ...
        if ( i <= v46[2938] )
        {
          ...
          if ( v47 )
          {
            ...
            if ( v48 )
            {
              ...
              v54 = KeAcquireSpinLockRaiseToDpc(&HubG);
              qword_1C006C500 = (__int64)&dword_1C006C508;
              if ( (UsbhLogMask & 8) != 0 )
              {
                  ...
                  if ( v58 )
                  {
                    ...
                    if ( v59 )
                    {
                      ...
                      if ( v50 )
                      {
                        ...
                        v69 = (char *)ExAllocatePoolWithTag(
                                        SHIDWORD(WPP_MAIN_CB.Dpc.ProcessorHistory),
                                        0x30uLL,
                                        0x42554855u);
                        if ( v69 )
