/*
 * XREFs of UsbhSyncPowerOnPorts @ 0x1C000BBF0
 * Callers:
...
__int64 __fastcall UsbhSyncPowerOnPorts(__int64 a1)
{
  ...
  for ( i = 1; ; ++i )
  {
    ...
    if ( (unsigned int)v2 >> 30 == 3 && !(unsigned __int8)Usb_Disconnected((unsigned int)v2) )
    {
      LOBYTE(v15) = 0;
  ...
  if ( (int)v2 >= 0 )
  {
    Log(a1, 8, 2002872692, dword_1C006C4F4, 0LL);
    UsbhRawWait(v11);
  }
