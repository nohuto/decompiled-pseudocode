/*
 * XREFs of USBD_ValidateExtendedConfigurationDescriptor @ 0x1C0032F14
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( a1 && a2 >= 0x10 )
  {
    ...
    if ( v10 < 9 || v10 > a4 )
      return (unsigned int)-1073741811;
    PoolWithTag = ExAllocatePoolWithTag(SHIDWORD(WPP_MAIN_CB.Dpc.ProcessorHistory), 0x100uLL, 0x42554855u);
    v9 = PoolWithTag;
    if ( !PoolWithTag )
