/*
 * XREFs of Usbh_SetPdo_ALLOWIDLEIRPIND3_INSTALLED @ 0x1C0048490
 * Callers:
 *     <none>
 * Callees:
...
_UNKNOWN **__fastcall Usbh_SetPdo_ALLOWIDLEIRPIND3_INSTALLED(__int64 a1, const wchar_t *a2, _DWORD *a3, int a4)
{
  _UNKNOWN **result; // rax
