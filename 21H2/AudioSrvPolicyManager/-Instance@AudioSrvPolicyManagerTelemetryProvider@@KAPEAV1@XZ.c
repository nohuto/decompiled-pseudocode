...
struct AudioSrvPolicyManagerTelemetryProvider *AudioSrvPolicyManagerTelemetryProvider::Instance(void)
{
    ...
    && fPending )
  {
    ...
    Context = &qword_18004FEA0;
    qword_18004FEA0 = (__int64)&AudioSrvPolicyManagerTelemetryProvider::`vftable';
    qword_18004FEB8 = (__int64)&`AudioSrvPolicyManagerTelemetryProvider::StaticHandle::StaticHandle'::`2'::__hInner;
