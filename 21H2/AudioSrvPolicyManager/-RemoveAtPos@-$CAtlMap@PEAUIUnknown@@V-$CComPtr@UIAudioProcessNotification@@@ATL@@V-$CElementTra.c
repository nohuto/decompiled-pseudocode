/*
 * XREFs of ?RemoveAtPos@?$CAtlMap@PEAUIUnknown@@V?$CComPtr@UIAudioProcessNotification@@@ATL@@V?$CElementTraits@PEAUIUnknown@@@3@V?$CElementTraits@V?$CComPtr@UIAudioProcessNotification@@@ATL@@@3@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x180018754
 * Callers:
 *     _ATL::CAtlMap_IUnknown___ATL::CComPtr_IAudioProcessNotification__ATL::CElementTraits_IUnknown____ATL::CElementTraits_ATL::CComPtr_IAudioProcessNotification_____::SetAt_::_1_::catch$0 @ 0x18003BF9A (_ATL--CAtlMap_IUnknown___ATL--CComPtr_IAudioProcessNotification__ATL--CElementTrait_ea_18003BF9A.c)
 * Callees:
