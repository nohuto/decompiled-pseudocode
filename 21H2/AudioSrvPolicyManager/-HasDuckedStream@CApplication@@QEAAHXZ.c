/*
 * XREFs of ?HasDuckedStream@CApplication@@QEAAHXZ @ 0x180011ED4
 * Callers:
 ...
 * Callees:
 *     ?SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ @ 0x1800168A0 (-SubjectToStreamClassPolicyGains@CProcess@@UEAAHXZ.c)
