/*
 * XREFs of ?TsSessionCreate@@YAJKPEAPEAXPEAPEAVTSSession@@@Z @ 0x180027B9C
 * Callers:
 ...
 *     WPP_SF_dii @ 0x1800256D8 (WPP_SF_dii.c)
 ...
 *     ??$_Setp@VDuckingDescriptor@@@?$shared_ptr@VDuckingDescriptor@@@std@@AEAAXPEAVDuckingDescriptor@@U?$integral_constant@_N$0A@@1@@Z @ 0x18002B6A8 (--$_Setp@VDuckingDescriptor@@@-$shared_ptr@VDuckingDescriptor@@@std@@AEAAXPEAVDuckingDescriptor@.c)
...
LABEL_20:
  ...
  *v17 = qword_18004FFA8;
  v17[1] = 0LL;
  if ( qword_18004FFA8 )
    *((_QWORD *)qword_18004FFA8 + 1) = v17;
  else
    qword_18004FFB0 = (__int64)v17;
  qword_18004FFA8 = v17;
  ++dword_18004FFB8;
