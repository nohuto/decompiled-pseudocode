/*
 * XREFs of ?RpcTryInitializeUserSettings@@YAJPEAVTSSession@@@Z @ 0x1800273FC
 * Callers:
...
__int64 __fastcall RpcTryInitializeUserSettings(struct TSSession *a1)
{
  ...
  if ( *v2 > 4u )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer((__int64)v2, (unsigned __int8 *)dword_1800466E0, 0LL, 0LL, 3u, &v21);
  }
