/*
 * XREFs of ??$_Emplace_reallocate@AEBQEAUIMixedRealitySpatialAudioFormatPolicyChange@@@?$vector@PEAUIMixedRealitySpatialAudioFormatPolicyChange@@V?$allocator@PEAUIMixedRealitySpatialAudioFormatPolicyChange@@@std@@@std@@QEAAPEAPEAUIMixedRealitySpatialAudioFormatPolicyChange@@QEAPEAU2@AEBQEAU2@@Z @ 0x1800183C0
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *v15 = *a3;
  ...
  if ( *a1 )
  {
    v21 = (const struct std::nothrow_t *)((a1[2] - (_QWORD)v20) & 0xFFFFFFFFFFFFFFF8uLL);
