/*
 * XREFs of ??1?$CLockedList@VCDuckingNotification@@$00$0A@@@QEAA@XZ @ 0x180009064
 * Callers:
 *     ??_ECDuckingManager@@UEAAPEAXI@Z @ 0x180008C50 (--_ECDuckingManager@@UEAAPEAXI@Z.c)
 *     _CDuckingManager::CDuckingManager_::_1_::dtor$3 @ 0x18003B216 (_CDuckingManager--CDuckingManager_--_1_--dtor$3.c)
 * Callees:
