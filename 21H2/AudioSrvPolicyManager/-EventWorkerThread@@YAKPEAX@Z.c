/*
 * XREFs of ?EventWorkerThread@@YAKPEAX@Z @ 0x180005B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EventWorkerThread(PVOID Parameter)
{
  ...
  if ( v1 )
  {
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_7ed73ea392833045c2a2189fc5dabbf5_Traceguids);
        v2 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
      if ( v2 != &WPP_GLOBAL_Control && (*((_DWORD *)v2 + 7) & 0x40000000) != 0 && *((_BYTE *)v2 + 25) >= 2u )
        WPP_SF_d((TRACEHANDLE)v2[2], 0xBu, &WPP_7ed73ea392833045c2a2189fc5dabbf5_Traceguids, v1);
    }
