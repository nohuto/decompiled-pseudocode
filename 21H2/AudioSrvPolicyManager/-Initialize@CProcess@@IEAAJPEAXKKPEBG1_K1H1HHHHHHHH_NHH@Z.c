/*
 * XREFs of ?Initialize@CProcess@@IEAAJPEAXKKPEBG1_K1H1HHHHHHHH_NHH@Z @ 0x180013E44
 * Callers:
        ...
        else
        {
          ...
          if ( i != v66 )
          {
            ...
            if ( *v68 > 4u )
            {
              ...
              v77 = &v73;
              v78 = 4LL;
              tlgWriteTransfer_EventWriteTransfer((__int64)v68, (unsigned __int8 *)dword_1800462B5, 0LL, 0LL, 4u, &v76);
            }
LABEL_63:
            v65 = (char *)hObject;
LABEL_64:
