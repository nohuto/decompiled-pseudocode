/*
 * XREFs of ?SendRefreshEndpointNotification@ApplicationSpecificEndpointInfo@@AEAAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@@Z @ 0x1800325C0
 * Callers:
 ...
 *     ?Reset@ApplicationSpecificEndpointInfo@@UEAAJXZ @ 0x180031440 (-Reset@ApplicationSpecificEndpointInfo@@UEAAJXZ.c)
 * Callees:
