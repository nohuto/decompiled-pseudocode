/*
 * XREFs of ??1?$CComPtr@VCApplication@@@ATL@@QEAA@XZ @ 0x1800066F0
 * Callers:
 *     _CApplicationManager::SendBackgroundStreamStateChangedNotifiction_::_1_::dtor$1 @ 0x18003B0EF (_CApplicationManager--SendBackgroundStreamStateChangedNotifiction_--_1_--dtor$1.c)
 * Callees:
