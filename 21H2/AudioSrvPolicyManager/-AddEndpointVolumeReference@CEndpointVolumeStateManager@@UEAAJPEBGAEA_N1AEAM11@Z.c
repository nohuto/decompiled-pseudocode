/*
 * XREFs of ?AddEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x18002E9C0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  _QWORD *v21; // rax
  __int64 v22; // rax
  bool *v24; // [rsp+20h] [rbp-E8h]
  float *v25; // [rsp+28h] [rbp-E0h]
  bool *v26; // [rsp+30h] [rbp-D8h]
  bool *v27; // [rsp+38h] [rbp-D0h]
  CEndpointVolumeState *v28; // [rsp+40h] [rbp-C8h]
  ...
  CEndpointVolumeState *v35; // [rsp+A0h] [rbp-68h]
  ...
  *a6 = 0;
  ...
  if ( !v13 )
  {
    ...
    v28 = v16;
    if ( v16 )
      v10 = CEndpointVolumeState::CEndpointVolumeState(v16, v14, a2);
    v17 = v31;
    v33 = v31;
    v18 = si128;
    v34 = si128;
    ...
    v35 = v10;
    v19 = **((_QWORD **)this + 8);
    if ( *((_QWORD *)this + 9) == 0x492492492492492LL )
      std::_Xlength_error("list<T> too long");
    v20 = *(_QWORD **)(v19 + 8);
    v21 = std::_Allocate<16,std::_Default_allocate_traits,0>(0x38uLL);
    *((_OWORD *)v21 + 1) = v17;
    *((__m128i *)v21 + 2) = v18;
    ...
    *(_QWORD *)(v19 + 8) = v21;
    *v20 = v21;
    std::_Hash<std::_Umap_traits<std::wstring,std::unique_ptr<CEndpointVolumeState>,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>,0>>::_Insert_unverified<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>>>>(
      v12,
      v30,
      **((_QWORD **)v12 + 1) + 16LL);
  ...
  std::wstring::wstring(&v31, a2);
  v22 = std::unordered_map<std::wstring,std::unique_ptr<CEndpointVolumeState>>::at(v12, &v31);
