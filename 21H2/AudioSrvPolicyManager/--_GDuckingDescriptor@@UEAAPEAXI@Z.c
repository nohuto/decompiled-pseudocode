/*
 * XREFs of ??_GDuckingDescriptor@@UEAAPEAXI@Z @ 0x18000EED0
 * Callers:
 *     _std::shared_ptr_DuckingDescriptor_::_Setp_DuckingDescriptor__::_1_::catch$1 @ 0x18003C7B1 (_std--shared_ptr_DuckingDescriptor_--_Setp_DuckingDescriptor__--_1_--catch$1.c)
 * Callees:
