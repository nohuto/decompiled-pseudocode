/*
 * XREFs of ?SetFailureInfo@StoredFailureInfo@wil@@QEAAXAEBUFailureInfo@2@@Z @ 0x180002A40
 * Callers:
 *     ??0ResultException@wil@@QEAA@AEBUFailureInfo@1@@Z @ 0x180002F68 (--0ResultException@wil@@QEAA@AEBUFailureInfo@1@@Z.c)
 * Callees:
