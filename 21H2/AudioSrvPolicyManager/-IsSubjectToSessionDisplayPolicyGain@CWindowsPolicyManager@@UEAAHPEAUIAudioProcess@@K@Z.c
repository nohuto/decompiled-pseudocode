/*
 * XREFs of ?IsSubjectToSessionDisplayPolicyGain@CWindowsPolicyManager@@UEAAHPEAUIAudioProcess@@K@Z @ 0x180006D60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  v7 = 0;
  v8 = 0;
  (*v3)((struct IAudioProcess *)a2, &GUID_2ea99478_7574_414c_8ba3_0c615b1716a4, &v14);
  v15 = 0LL;
