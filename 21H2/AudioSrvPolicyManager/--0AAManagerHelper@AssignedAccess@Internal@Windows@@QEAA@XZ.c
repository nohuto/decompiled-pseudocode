/*
 * XREFs of ??0AAManagerHelper@AssignedAccess@Internal@Windows@@QEAA@XZ @ 0x1800383AC
 * Callers:
 *     GetAssignedAccessTypeForUser @ 0x180037338 (GetAssignedAccessTypeForUser.c)
 * Callees:
 *     ?RaiseException@Details@WRL@Microsoft@@YAXJK@Z @ 0x1800387B0 (-RaiseException@Details@WRL@Microsoft@@YAXJK@Z.c)
