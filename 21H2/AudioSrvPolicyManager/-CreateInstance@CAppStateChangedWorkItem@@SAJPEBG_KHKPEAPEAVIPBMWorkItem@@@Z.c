/*
 * XREFs of ?CreateInstance@CAppStateChangedWorkItem@@SAJPEBG_KHKPEAPEAVIPBMWorkItem@@@Z @ 0x18002C5AC
 * Callers:
        ...
        struct IPBMWorkItem **a5)
{
  ...
  if ( v12 )
  {
    ...
    *((_QWORD *)v12 + 3) = a2;
    ...
    if ( v15 < 0 )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_c6f978e82fd73817a9c6bd1960ca45a6_Traceguids, v15);
      }
      AudPolicyLogError("CAppStateChangedWorkItem::Initialize", 545, v13);
    }
    if ( v13 >= 0 )
    {
  ...
  if ( v13 < 0 )
  {
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x12u, &WPP_c6f978e82fd73817a9c6bd1960ca45a6_Traceguids, v13);
    }
    AudPolicyLogError("CAppStateChangedWorkItem::CreateInstance", 525, v13);
  }
