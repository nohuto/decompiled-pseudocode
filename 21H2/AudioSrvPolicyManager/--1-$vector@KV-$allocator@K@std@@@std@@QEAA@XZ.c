/*
 * XREFs of ??1?$vector@KV?$allocator@K@std@@@std@@QEAA@XZ @ 0x18001A150
 * Callers:
 *     _CApplication::RegisterProcessWithApplicationSpecificEndpointInfo_::_1_::dtor$8 @ 0x18003BB84 (_CApplication--RegisterProcessWithApplicationSpecificEndpointInfo_--_1_--dtor$8.c)
 *     _CProcess::CProcess_::_1_::dtor$3 @ 0x18003BC88 (_CProcess--CProcess_--_1_--dtor$3.c)
 * Callees:
