/*
 * XREFs of ?ForEachDuckableSession@CDuckingManager@@AEAAJPEBG$$QEAV?$function@$$A6AJPEAUIAudioSessionInfo@@@Z@std@@@Z @ 0x18000C694
 * Callers:
 ...
 *     ?_Unchecked_end@?$forward_list@PEAUIAudioSessionInfo@@V?$allocator@PEAUIAudioSessionInfo@@@std@@@std@@QEBA?AU_Default_sentinel@2@XZ @ 0x18000CD54 (-_Unchecked_end@-$forward_list@PEAUIAudioSessionInfo@@V-$allocator@PEAUIAudioSessionInfo@@@std@@.c)
