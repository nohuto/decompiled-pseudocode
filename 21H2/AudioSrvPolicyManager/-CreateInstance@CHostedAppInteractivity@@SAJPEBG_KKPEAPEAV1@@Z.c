/*
 * XREFs of ?CreateInstance@CHostedAppInteractivity@@SAJPEBG_KKPEAPEAV1@@Z @ 0x180021D00
 * Callers:
        ...
        struct CHostedAppInteractivity **a4)
{
  ...
  if ( v13 < 0 )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, &WPP_8b174e4b3d6138c7fcfc76c86feeee8f_Traceguids, v13);
    }
    AudPolicyLogError("CHostedAppInteractivity::CreateInstance", 329, v13);
  }
