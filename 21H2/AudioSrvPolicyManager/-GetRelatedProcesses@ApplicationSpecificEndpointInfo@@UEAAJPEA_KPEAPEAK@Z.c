/*
 * XREFs of ?GetRelatedProcesses@ApplicationSpecificEndpointInfo@@UEAAJPEA_KPEAPEAK@Z @ 0x180031530
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180003AB0 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ?_Xrange@?$vector@KV?$allocator@K@std@@@std@@CAXXZ @ 0x1800330A0 (-_Xrange@-$vector@KV-$allocator@K@std@@@std@@CAXXZ.c)
 */
