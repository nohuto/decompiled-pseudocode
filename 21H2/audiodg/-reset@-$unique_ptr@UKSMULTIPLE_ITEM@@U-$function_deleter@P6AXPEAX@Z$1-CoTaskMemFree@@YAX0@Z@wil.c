/*
 * XREFs of ?reset@?$unique_ptr@UKSMULTIPLE_ITEM@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@QEAAXPEAUKSMULTIPLE_ITEM@@@Z @ 0x140028700
 * Callers:
 *     ??1?$unique_ptr@U_KSAUDIOMODULE_NOTIFICATION@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@QEAA@XZ @ 0x140020E1C (--1-$unique_ptr@U_KSAUDIOMODULE_NOTIFICATION@@U-$function_deleter@P6AXPEAX@Z$1-CoTaskMemFree@@YA.c)
