/*
 * XREFs of ?Return_CaughtException@in1diag3@details@wil@@YAJPEAXIPEBD@Z @ 0x14006AF88
 * Callers:
 *     _CSpatialCrossProcessBaseEndpoint::InitializeCPMemory_::_1_::catch$48 @ 0x14006AAE7 (_CSpatialCrossProcessBaseEndpoint--InitializeCPMemory_--_1_--catch$48.c)
 * Callees:
