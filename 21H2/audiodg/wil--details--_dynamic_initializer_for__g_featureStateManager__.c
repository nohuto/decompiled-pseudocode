/*
 * XREFs of wil::details::_dynamic_initializer_for__g_featureStateManager__ @ 0x1400012A0
 * Callers:
 *     <none>
 * Callees:
 *     ??0FeatureStateManager@details@wil@@QEAA@XZ @ 0x14001C75C (--0FeatureStateManager@details@wil@@QEAA@XZ.c)
 */
