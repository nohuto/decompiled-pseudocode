/*
 * XREFs of ?CommitWrite@CSpatialCrossProcessBaseEndpoint@@IEAAJII@Z @ 0x140069450
 * Callers:
 *     ?ProcessComplete@CSpatialCrossProcessClientOutputEndpoint@@UEAAJXZ @ 0x14006CE30 (-ProcessComplete@CSpatialCrossProcessClientOutputEndpoint@@UEAAJXZ.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x140029E50 (_guard_dispatch_icall_nop.c)
 *     ?SpatialCPTraceLoggingErrorHelper@@YAXPEBDIJ@Z @ 0x14006868C (-SpatialCPTraceLoggingErrorHelper@@YAXPEBDIJ@Z.c)
 *     ?GetState@PingPongState@@AEBA?AW4State@1@XZ @ 0x14006A21C (-GetState@PingPongState@@AEBA-AW4State@1@XZ.c)
 */
        ...
        __int64 a4)
{
  ...
  if ( a2 > 1 )
  {
    v4 = -2005139345;
LABEL_11:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::CommitWrite", 923, v4, a4);
    return v4;
  }
  v6 = (volatile signed __int32 **)((char *)this + 576);
  v7 = 16;
  _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this + 161) + 4LL * a2 + 24), a3);
...
LABEL_9:
  ...
  if ( a3 )
    ...
    v12 = 0;
  _InterlockedExchangeAdd64((volatile signed __int64 *)(*(_QWORD *)(v9 + 1288) + 32LL), v12);
  return v4;
}
