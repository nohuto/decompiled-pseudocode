/*
 * XREFs of ?GetFrameCount@CSpatialCrossProcessServerInputEndpoint@@UEAAJPEAI@Z @ 0x14006D5F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  if ( !*((_BYTE *)this + 80) )
  {
    v2 = -2005139437;
LABEL_5:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessServerInputEndpoint::GetFrameCount", 215, v2, (__int64)this);
    return v2;
  }
  if ( !a2 )
  {
    ...
    && *(_BYTE *)(v3 + 1480) )
  {
    ...
    if ( v5 >= 2 )
      ...
      v6 = _InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(v3 + 1272) + 4LL * v5 + 48), 0, 0);
    if ( v6 >= *(_DWORD *)(v3 + 268) )
      v6 = *(_DWORD *)(v3 + 268);
  }
  else
  {
    v7 = _InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(v3 + 1272) + 44LL), 0, 0);
    v6 = *(_DWORD *)(v3 + 268);
    if ( v7 < v6 )
      v6 = v7;
  }
