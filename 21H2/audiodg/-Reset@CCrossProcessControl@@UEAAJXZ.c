/*
 * XREFs of ?Reset@CCrossProcessControl@@UEAAJXZ @ 0x140061210
 * Callers:
 *     <none>
 * Callees:
 *     ?DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ @ 0x140060488 (-DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ.c)
