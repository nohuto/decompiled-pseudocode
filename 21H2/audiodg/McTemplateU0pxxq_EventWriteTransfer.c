/*
 * XREFs of McTemplateU0pxxq_EventWriteTransfer @ 0x140063CEC
 * Callers:
...
ULONG McTemplateU0pxxq_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  va_copy(v10, va3);
  v11 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, &EVT_GLITCH_CP_CLIENT_OUTPUT_SERVER_OVERREAD, v13, 5u, &v3);
}
