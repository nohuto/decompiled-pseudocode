...
__int64 __fastcall Microsoft::WRL::InvokeTraits<-2>::InvokeDelegates<_lambda_eabcc029d9695c45221ee9419ea5f562_,Windows::Foundation::ITypedEventHandler<Windows::Media::Devices::AudioDeviceModulesManager *,Windows::Media::Devices::AudioDeviceModuleNotificationEventArgs *>>(
        _QWORD **a1,
        __int64 a2,
        __int64 a3)
{
