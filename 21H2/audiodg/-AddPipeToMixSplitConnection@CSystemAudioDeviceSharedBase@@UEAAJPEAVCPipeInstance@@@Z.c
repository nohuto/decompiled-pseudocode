/*
 * XREFs of ?AddPipeToMixSplitConnection@CSystemAudioDeviceSharedBase@@UEAAJPEAVCPipeInstance@@@Z @ 0x140017280
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CPipeInstance *a2)
{
  ...
  {
    v6 = (*(__int64 (__fastcall **)(__int64, struct CPipeInstance *))(*(_QWORD *)v9 + 24LL))(v9, a2);
    v5 = v9;
    v7 = v6;
  }
  else
