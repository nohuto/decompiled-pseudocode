/*
 * XREFs of McTemplateU0p_EventWriteTransfer @ 0x14006168C
 * Callers:
 ...
 *     ?ReleaseInputDataPointer@CCrossProcessServerInputEndpoint@@UEAAXI_K@Z @ 0x140015E60 (-ReleaseInputDataPointer@CCrossProcessServerInputEndpoint@@UEAAXI_K@Z.c)
