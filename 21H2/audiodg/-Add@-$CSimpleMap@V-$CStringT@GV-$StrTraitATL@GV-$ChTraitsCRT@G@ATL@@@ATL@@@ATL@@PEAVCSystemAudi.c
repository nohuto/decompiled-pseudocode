        ...
        _QWORD *a3)
{
  ...
  v5 = (void *)_o__recalloc(qword_140090278, (int)qword_140090288 + 1, 8LL);
  if ( !v5 )
    return 0LL;
  qword_140090278 = v5;
  v6 = (char *)_o__recalloc(qword_140090280, (int)qword_140090288 + 1, 8LL);
  if ( !v6 )
    return 0LL;
  qword_140090280 = v6;
  v7 = qword_140090288;
  v8 = (int)qword_140090288;
  v9 = (char *)qword_140090278 + 8 * (int)qword_140090288;
  if ( v9 )
  {
    v10 = (char *)*a2;
    v11 = v10 - 24;
