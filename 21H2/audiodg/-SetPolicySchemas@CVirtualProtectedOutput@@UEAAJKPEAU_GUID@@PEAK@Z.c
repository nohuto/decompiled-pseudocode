/*
 * XREFs of ?SetPolicySchemas@CVirtualProtectedOutput@@UEAAJKPEAU_GUID@@PEAK@Z @ 0x140048C10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xDu, (__int64)&WPP_8a78b0fe90e638a027f0a1224aa299fc_Traceguids, v5);
  }
