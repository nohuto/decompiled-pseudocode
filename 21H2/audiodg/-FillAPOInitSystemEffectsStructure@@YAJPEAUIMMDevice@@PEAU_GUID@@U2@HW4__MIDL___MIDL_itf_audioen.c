/*
 * XREFs of ?FillAPOInitSystemEffectsStructure@@YAJPEAUIMMDevice@@PEAU_GUID@@U2@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@AEAUAPOInitSystemEffects2@@@Z @ 0x14000AA70
 * Callers:
        ...
        struct APOInitSystemEffects2 *a6)
{
  ...
  struct tWAVEFORMATEX *v42; // [rsp+58h] [rbp-A8h] BYREF
  IMMDeviceCollection *v43; // [rsp+60h] [rbp-A0h]
  IPropertyStore *v44; // [rsp+68h] [rbp-98h] BYREF
  UINT v45; // [rsp+70h] [rbp-90h]
  UINT v46; // [rsp+74h] [rbp-8Ch]
  PROPVARIANT pvar[2]; // [rsp+78h] [rbp-88h] BYREF
  void *Src; // [rsp+88h] [rbp-78h]
  LPVOID v49; // [rsp+90h] [rbp-70h] BYREF
  LPVOID v50; // [rsp+98h] [rbp-68h] BYREF
  IPropertyStore *v51; // [rsp+A0h] [rbp-60h] BYREF
  __int64 v52; // [rsp+A8h] [rbp-58h] BYREF
  void **p_pv; // [rsp+B0h] [rbp-50h]
  struct KSDATAFORMAT_WAVEFORMATEX *v54; // [rsp+B8h] [rbp-48h] BYREF
  char v55; // [rsp+C0h] [rbp-40h]
  BOOL v56; // [rsp+C8h] [rbp-38h]
  PROPVARIANT *v57; // [rsp+D0h] [rbp-30h] BYREF
  char v58; // [rsp+D8h] [rbp-28h]
  CLSID *v59; // [rsp+E0h] [rbp-20h]
  GUID *v60; // [rsp+E8h] [rbp-18h]
  PROPVARIANT *v61; // [rsp+F0h] [rbp-10h]
  ...
  v60 = a3;
  v59 = a2;
  *(_OWORD *)&a6->APOInit.cbSize = 0LL;
  *(_OWORD *)&a6->APOInit.clsid.Data4[4] = 0LL;
  *(_OWORD *)&a6->pAPOSystemEffectsProperties = 0LL;
  *(_OWORD *)&a6->pDeviceCollection = 0LL;
  a6->AudioProcessingMode = 0LL;
  *(_QWORD *)&a6->InitializeForDiscoveryOnly = 0LL;
  v7 = 0LL;
  v44 = 0LL;
          ...
          *(_OWORD *)pvar = 0LL;
            ...
            && LOWORD(pvar[0]) == 65 )
          {
            ...
            else
            {
              ...
              if ( LODWORD(pvar[1]) < (unsigned __int64)(v19 + 18) )
              {
                v9 = -2147024809;
              }
              else
...
LABEL_23:
            ...
            else
            {
              ...
              {
                if ( v57 )
                  (*((void (__fastcall **)(PROPVARIANT *))*v57 + 2))(v57);
                v24 = pv;
                pv = 0LL;
                if ( v24 )
                  CoTaskMemFree(v24);
...
LABEL_32:
                ...
                a6->nSoftwareIoDeviceInCollection = v45;
                a6->nSoftwareIoConnectorIndex = v46;
