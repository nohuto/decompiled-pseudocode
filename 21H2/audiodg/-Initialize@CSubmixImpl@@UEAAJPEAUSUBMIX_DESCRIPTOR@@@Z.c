/*
 * XREFs of ?Initialize@CSubmixImpl@@UEAAJPEAUSUBMIX_DESCRIPTOR@@@Z @ 0x140005970
 * Callers:
 ...
 *     ?ValidateSubmixDescriptor@@YAJPEAUSUBMIX_DESCRIPTOR@@@Z @ 0x1400058F0 (-ValidateSubmixDescriptor@@YAJPEAUSUBMIX_DESCRIPTOR@@@Z.c)
 ...
 *     ??1Completer@?$static_lazy@VAudioDgTelemetryProvider@@@details@wil@@QEAA@XZ @ 0x14001C08C (--1Completer@-$static_lazy@VAudioDgTelemetryProvider@@@details@wil@@QEAA@XZ.c)
  ...
  if ( !*((_BYTE *)this + 313) )
  {
    ...
    else
    {
        ...
        && fPending )
      {
        ...
        Context = &qword_140090368;
        qword_140090368 = (__int64)&AudioDgTelemetryProvider::`vftable';
        qword_140090380 = (__int64)&`AudioDgTelemetryProvider::StaticHandle::StaticHandle'::`2'::__hInner;
...
LABEL_48:
  ...
  v35 = SubmixList;
  i = (__int64 *)qword_14008F730;
  if ( !qword_14008F730 )
  {
    v37 = ATL::CAtlPlex::Create(&qword_14008F728, (unsigned int)dword_14008F738, 0x18uLL);
    if ( !v37 )
      ATL::AtlThrowImpl(-2147024882);
    v38 = (__int64 *)((char *)v37 + 24 * (unsigned int)(dword_14008F738 - 1) + 8);
    v39 = dword_14008F738 - 1;
    for ( i = (__int64 *)qword_14008F730; v39 >= 0; --v39 )
    {
      *v38 = (__int64)i;
      i = v38;
      qword_14008F730 = (__int64)v38;
      v38 -= 3;
    }
  }
  v40 = *i;
