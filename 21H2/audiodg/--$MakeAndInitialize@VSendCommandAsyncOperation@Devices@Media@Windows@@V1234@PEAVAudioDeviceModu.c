/*
 * XREFs of ??$MakeAndInitialize@VSendCommandAsyncOperation@Devices@Media@Windows@@V1234@PEAVAudioDeviceModule@234@AEAPEAUIBuffer@Streams@Storage@4@@Details@WRL@Microsoft@@YAJPEAPEAVSendCommandAsyncOperation@Devices@Media@Windows@@$$QEAPEAVAudioDeviceModule@456@AEAPEAUIBuffer@Streams@Storage@6@@Z @ 0x140054118
 * Callers:
 ...
 *     ??0SendCommandAsyncOperation@Devices@Media@Windows@@QEAA@XZ @ 0x140054974 (--0SendCommandAsyncOperation@Devices@Media@Windows@@QEAA@XZ.c)
    ...
    if ( v7 >= 0 )
    {
      if ( v8 )
      {
        ...
        while ( v9 >= 0 )
        {
          ...
          {
            v10 = v9;
            v9 = _InterlockedCompareExchange64(v8 + 21, v9 + 1, v9);
            if ( v10 != v9 )
              continue;
          }
          goto LABEL_11;
