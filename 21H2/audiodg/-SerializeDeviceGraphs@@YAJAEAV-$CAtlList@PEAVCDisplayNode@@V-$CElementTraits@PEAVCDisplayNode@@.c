/*
 * XREFs of ?SerializeDeviceGraphs@@YAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@PEAPEAEPEAI@Z @ 0x14004CE2C
 * Callers:
 ...
 *     ?SerializeMetaData@@YAJAEAPEAEAEAI@Z @ 0x14004CEE4 (-SerializeMetaData@@YAJAEAPEAEAEAI@Z.c)
