/*
 * XREFs of ?AddCaptureConnection@CConnectionInstance@@IEAAJPEAUIAudioProcessor@@_K@Z @ 0x14004AFAC
 * Callers:
...
LABEL_27:
    ...
    if ( v22 == 2 )
    {
      v23 = *(_QWORD *)(v21 + 32);
      v28 = 0LL;
      v12 = ATL::CComPtrBase<IAudioProcessingObject>::CopyTo((_QWORD *)(v23 + 40), &v28);
      v13 = v12;
      v14 = v28;
      if ( v12 < 0 )
      {
...
LABEL_22:
  ...
  v11 = *(_QWORD *)(v6 + 32);
  v28 = 0LL;
  v12 = ATL::CComPtrBase<IAudioProcessingObject>::CopyTo((_QWORD *)(v11 + 40), &v28);
  v13 = v12;
  v14 = v28;
  if ( v12 >= 0 )
  {
