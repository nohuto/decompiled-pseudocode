/*
 * XREFs of __tailMerge_api_ms_win_service_management_l2_1_0_dll @ 0x14001E1E9
 * Callers:
 *     __imp_load_QueryServiceStatusEx @ 0x14001E1DD (__imp_load_QueryServiceStatusEx.c)
 * Callees:
