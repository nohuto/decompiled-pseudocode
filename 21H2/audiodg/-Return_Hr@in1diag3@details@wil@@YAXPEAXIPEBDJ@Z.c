/*
 * XREFs of ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x14001B400
 * Callers:
 ...
 *     ?DisconnectFromStreamGroup@CProcessSubmix@@UEAAJPEAUIStreamGroup@@@Z @ 0x140001CB0 (-DisconnectFromStreamGroup@CProcessSubmix@@UEAAJPEAUIStreamGroup@@@Z.c)
 ...
 *     ?ConnectToStreamGroup@CProcessSubmix@@UEAAJPEAUIStreamGroup@@@Z @ 0x140003600 (-ConnectToStreamGroup@CProcessSubmix@@UEAAJPEAUIStreamGroup@@@Z.c)
 ...
 *     ?GetStreamingResourceManager@CSubmixImpl@@UEAAJPEAPEAUIAudioStreamingResourceRegistration@@@Z @ 0x140019FD0 (-GetStreamingResourceManager@CSubmixImpl@@UEAAJPEAPEAUIAudioStreamingResourceRegistration@@@Z.c)
 ...
 *     ?FindAll@AudioDeviceModulesManager@Devices@Media@Windows@@UEAAJPEAPEAU?$IVectorView@PEAVAudioDeviceModule@Devices@Media@Windows@@@Collections@Foundation@4@@Z @ 0x140055F40 (-FindAll@AudioDeviceModulesManager@Devices@Media@Windows@@UEAAJPEAPEAU-$IVectorView@PEAVAudioDev.c)
 ...
 *     ?get_ClassId@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x14005A7E0 (-get_ClassId@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAPEAUHSTRING__@@@Z.c)
 ...
 *     ?get_DisplayName@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x14005A890 (-get_DisplayName@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAPEAUHSTRING__@@@Z.c)
 *     ?get_InstanceId@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z @ 0x14005A950 (-get_InstanceId@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z.c)
 *     ?get_MajorVersion@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z @ 0x14005A990 (-get_MajorVersion@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z.c)
 *     ?get_MinorVersion@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z @ 0x14005A9D0 (-get_MinorVersion@AudioDeviceModule@Devices@Media@Windows@@UEAAJPEAI@Z.c)
 ...
 *     ?get_Status@ModuleCommandResult@Devices@Media@Windows@@UEAAJPEAW4SendCommandStatus@234@@Z @ 0x14005ABD0 (-get_Status@ModuleCommandResult@Devices@Media@Windows@@UEAAJPEAW4SendCommandStatus@234@@Z.c)
