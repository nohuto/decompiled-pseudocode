 ...
 * Callees:
 *     ??$?RUIAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@@InterfaceEquals@XWinRT@@QEBAJPEAUIAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@0PEA_N@Z @ 0x14001EE00 (--$-RUIAudioDeviceBrokerDevice@Internal@Devices@Media@Windows@@@InterfaceEquals@XWinRT@@QEBAJPEA.c)
 */
