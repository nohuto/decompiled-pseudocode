/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x140026190
 * Callers:
 ...
 *     ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x140020B7C (--0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z.c)
 ...
 *     ?NtStatusToHr@details@wil@@YAJJ@Z @ 0x140025194 (-NtStatusToHr@details@wil@@YAJJ@Z.c)
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)&v26 + 1) = &v25;
    ...
    if ( v32 )
    {
      updated = wil_details_NtUpdateWnfStateData((_DWORD)v5, v29, (int)v30 - (int)v29, v15, v20, v22, 1);
