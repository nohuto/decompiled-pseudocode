/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCVpoContext@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x14004E018
 * Callers:
 ...
 *     ??0?$CComObject@VCVpoContext@@@ATL@@QEAA@PEAX@Z @ 0x14004DC00 (--0-$CComObject@VCVpoContext@@@ATL@@QEAA@PEAX@Z.c)
