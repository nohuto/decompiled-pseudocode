/*
 * XREFs of ?SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x140015FC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CCrossProcessBaseEndpoint::SetCurrentTimeStamp(
        ...
        __int64 a3)
{
  CCrossProcessBaseEndpoint *v5; // r8
  __int32 v6; // edx
  __int64 v7; // rbx
  __int64 v8; // rdi
  __int64 v9; // r9
  ...
  *(_DWORD *)(v12 + *((_QWORD *)this + 9)) = a2->Flag;
  ...
  v14 = _InterlockedCompareExchange((volatile signed __int32 *)(*((_QWORD *)this + 9) + 164LL), 0, 0);
  LODWORD(this) = v14 & 2;
  if ( !(_BYTE)this )
  {
    *(_QWORD *)(*((_QWORD *)v5 + 9) + 112LL) = a2->u64DevicePosition;
    *(_QWORD *)(*((_QWORD *)v5 + 9) + 128LL) = a2->u64PaddingFrames;
    v13 = *((_QWORD *)v5 + 9);
    this = (CCrossProcessBaseEndpoint *)a2->hnsQPCPosition;
    *(_QWORD *)(v13 + 136) = this;
    _InterlockedExchange64((volatile __int64 *)(*((_QWORD *)v5 + 9) + 152LL), a3);
    _InterlockedOr((volatile signed __int32 *)(*((_QWORD *)v5 + 9) + 164LL), 6u);
  }
