        ...
        _QWORD *a1)
{
  ...
  *a1 = 0LL;
  v2 = (char *)operator new(0x38uLL, (const struct std::nothrow_t *)&std::nothrow);
  v3 = v2;
  if ( v2 )
  {
    v4 = v2 + 8;
    ...
    *((_OWORD *)v2 + 2) = 0LL;
    *((_QWORD *)v2 + 6) = 0LL;
    *(_QWORD *)v2 = &CSpatialCrossProcessClientEndpoint::`vftable'{for `IAudioClock2'};
