/*
 * XREFs of ?DumpDeviceGraph@CSystemAudioDeviceSharedBase@@UEAAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@AEAV?$CAtlMap@_KV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@V?$CElementTraits@_K@2@V?$CElementTraits@V?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@@2@@3@1@Z @ 0x1400438C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceSharedBase::DumpDeviceGraph(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  LODWORD(v7) = DumpDeviceGraph(*(_QWORD *)(v7 + 328), a2, a3, a4, v9, *((_QWORD *)&v9 + 1));
  EtwEventActivityIdControl(4LL, &v10);
