/*
 * XREFs of ?GetMany@?$IIterator_impl@U?$AggregateType@PEAVAudioDeviceModule@Devices@Media@Windows@@PEAUIAudioDeviceModule@234@@Internal@Foundation@Windows@@$00@Collections@Foundation@Windows@@UEAAJIPEAPEAUIAudioDeviceModule@Devices@Media@4@PEAI@Z @ 0x140023360
 * Callers:
 *     <none>
 * Callees:
 *     <none>
