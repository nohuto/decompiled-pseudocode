/*
 * XREFs of ??1CSpatialCrossProcessClientEndpoint@@UEAA@XZ @ 0x140065BBC
 * Callers:
 ...
 *     ??1CSpatialCrossProcessClientOutputEndpoint@@UEAA@XZ @ 0x140065870 (--1CSpatialCrossProcessClientOutputEndpoint@@UEAA@XZ.c)
