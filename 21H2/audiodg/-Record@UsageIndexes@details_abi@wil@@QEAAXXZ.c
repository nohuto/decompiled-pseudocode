/*
 * XREFs of ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x140025B40
 * Callers:
 *     ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x1400253DC (-ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ.c)
