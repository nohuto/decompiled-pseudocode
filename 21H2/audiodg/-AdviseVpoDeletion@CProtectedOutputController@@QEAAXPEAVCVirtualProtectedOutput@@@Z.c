/*
 * XREFs of ?AdviseVpoDeletion@CProtectedOutputController@@QEAAXPEAVCVirtualProtectedOutput@@@Z @ 0x1400484B4
 * Callers:
 *     ?Release@CVirtualProtectedOutput@@UEAAKXZ @ 0x140048A50 (-Release@CVirtualProtectedOutput@@UEAAKXZ.c)
 * Callees:
