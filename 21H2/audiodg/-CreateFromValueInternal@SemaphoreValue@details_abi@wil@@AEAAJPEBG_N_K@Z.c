/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x1400147E4
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  else
  {
    ...
    if ( (_DWORD)v17 )
      v8 = v17;
    v31 = (wil::details *)CreateSemaphoreExW(0LL, v17, v8, Name, 0, 0x1F0003u);
    if ( v31 )
    {
      wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void wil::details::CloseHandle(void *),wistd::integral_constant<unsigned __int64,0>,void *,void *,0,std::nullptr_t>>::reset(
        this + 1,
