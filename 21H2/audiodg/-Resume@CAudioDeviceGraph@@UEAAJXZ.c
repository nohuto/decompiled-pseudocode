/*
 * XREFs of ?Resume@CAudioDeviceGraph@@UEAAJXZ @ 0x1400014B0
 * Callers:
 *     <none>
 * Callees:
 *     ?Start@DurationTracker@CAudioDeviceGraph@@QEAAXXZ @ 0x140001480 (-Start@DurationTracker@CAudioDeviceGraph@@QEAAXXZ.c)
