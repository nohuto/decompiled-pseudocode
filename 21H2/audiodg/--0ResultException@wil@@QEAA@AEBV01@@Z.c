/*
 * XREFs of ??0ResultException@wil@@QEAA@AEBV01@@Z @ 0x14003AA9C
 * Callers:
 *     <none>
 * Callees:
 *     _o___std_exception_copy_0 @ 0x14001DDE6 (_o___std_exception_copy_0.c)
 *     ?assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z @ 0x14003C8F4 (-assign@shared_buffer@details@wil@@AEAAXPEAJ_K@Z.c)
 */
