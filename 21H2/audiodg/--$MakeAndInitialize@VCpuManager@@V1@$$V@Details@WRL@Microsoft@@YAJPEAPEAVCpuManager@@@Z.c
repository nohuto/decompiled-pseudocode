/*
 * XREFs of ??$MakeAndInitialize@VCpuManager@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVCpuManager@@@Z @ 0x140013988
 * Callers:
 *     ?InitializeCpuManager@@YAJXZ @ 0x140013B9C (-InitializeCpuManager@@YAJXZ.c)
 * Callees:
