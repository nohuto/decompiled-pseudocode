/*
 * XREFs of ?GetLatency@CPipeInstance@@QEBAJPEA_J@Z @ 0x140008200
 * Callers:
 *     ?AddPipe@CAudioDeviceGraph@@UEAAJPEAVCPipeInstance@@@Z @ 0x140008000 (-AddPipe@CAudioDeviceGraph@@UEAAJPEAVCPipeInstance@@@Z.c)
 *     ?GetLatency@CAudioDeviceGraph@@UEAAJ_KPEA_J@Z @ 0x140008100 (-GetLatency@CAudioDeviceGraph@@UEAAJ_KPEA_J@Z.c)
 * Callees:
      ...
      if ( *(_DWORD *)(v5 + 40) == 2 )
      {
        ...
        if ( *(_DWORD *)(v8 + 4) )
        {
            ...
            && fPending )
          {
            ...
            qword_140090370 = qword_140090380;
            byte_140090378 = 1;
            TraceLoggingRegisterEx_EtwEventRegister_EtwEventSetInformation();
            dword_14009037C = 1;
            (*(void (__fastcall **)(__int64 *))(qword_140090368 + 8))(&qword_140090368);
            InitOnceComplete(&`AudioDgTelemetryProvider::Instance'::`2'::wrapper, 0, &qword_140090368);
          }
