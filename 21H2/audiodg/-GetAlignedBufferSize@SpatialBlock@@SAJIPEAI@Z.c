/*
 * XREFs of ?GetAlignedBufferSize@SpatialBlock@@SAJIPEAI@Z @ 0x1400696E8
 * Callers:
 ...
 *     ?SetPointersFromDescriptor@SpatialBlock@@AEAAJPEAUDescriptor@1@@Z @ 0x14006B328 (-SetPointersFromDescriptor@SpatialBlock@@AEAAJPEAUDescriptor@1@@Z.c)
 * Callees:
