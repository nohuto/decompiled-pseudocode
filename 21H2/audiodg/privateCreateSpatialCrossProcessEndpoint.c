/*
 * XREFs of privateCreateSpatialCrossProcessEndpoint @ 0x140066DA0
 * Callers:
 *     CreateSpatialCrossProcessEndpointRT @ 0x140066ED4 (CreateSpatialCrossProcessEndpointRT.c)
 * Callees:
 ...
 *     ??0?$CComObject@VCSpatialCrossProcessServerInputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x14006527C (--0-$CComObject@VCSpatialCrossProcessServerInputEndpoint@@@ATL@@QEAA@PEAX@Z.c)
...
__int64 __fastcall privateCreateSpatialCrossProcessEndpoint(_QWORD *a1, _OWORD *a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( v6 )
  {
    ...
    v15 = (CSpatialCrossProcessClientOutputEndpoint *)AERTAllocate(0x5C8uLL, v13, v14);
    if ( v15 )
  ...
  else
  {
    ...
    v10 = (CSpatialCrossProcessServerInputEndpoint *)AERTAllocate(0x5E8uLL, v8, v9);
    if ( v10 )
