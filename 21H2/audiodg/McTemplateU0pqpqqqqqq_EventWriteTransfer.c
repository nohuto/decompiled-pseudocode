/*
 * XREFs of McTemplateU0pqpqqqqqq_EventWriteTransfer @ 0x140051278
 * Callers:
 *     ?AERTAllocate@@YAPEAX_KPEAX@Z @ 0x14000AEE0 (-AERTAllocate@@YAPEAX_KPEAX@Z.c)
 *     ?AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z @ 0x140013AA0 (-AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z.c)
