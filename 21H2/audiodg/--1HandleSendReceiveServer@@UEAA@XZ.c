/*
 * XREFs of ??1HandleSendReceiveServer@@UEAA@XZ @ 0x140018558
 * Callers:
 *     ??_EHandleSendReceiveServer@@UEAAPEAXI@Z @ 0x140018520 (--_EHandleSendReceiveServer@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x14005176C (-SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ.c)
 */
