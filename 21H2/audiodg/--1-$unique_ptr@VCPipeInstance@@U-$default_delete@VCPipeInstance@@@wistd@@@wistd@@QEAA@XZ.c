/*
 * XREFs of ??1?$unique_ptr@VCPipeInstance@@U?$default_delete@VCPipeInstance@@@wistd@@@wistd@@QEAA@XZ @ 0x140049080
 * Callers:
 *     _CAudioDeviceGraph::Initialize_::_1_::dtor$6 @ 0x14002C1D0 (_CAudioDeviceGraph--Initialize_--_1_--dtor$6.c)
 * Callees:
