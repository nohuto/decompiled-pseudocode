/*
 * XREFs of ?GetPositionForOffload@CSystemAudioDeviceSharedBase@@UEAAJPEA_K0@Z @ 0x140044120
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x140043968 (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
 *     WPP_SF_ii @ 0x1400448AC (WPP_SF_ii.c)
