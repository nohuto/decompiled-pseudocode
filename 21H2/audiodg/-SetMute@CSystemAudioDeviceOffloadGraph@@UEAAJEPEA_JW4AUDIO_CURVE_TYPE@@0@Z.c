/*
 * XREFs of ?SetMute@CSystemAudioDeviceOffloadGraph@@UEAAJEPEA_JW4AUDIO_CURVE_TYPE@@0@Z @ 0x1400462C0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum AUDIO_CURVE_TYPE a4)
{
  ...
  if ( v7 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, (__int64)&WPP_c7d7401b1d0b3a3d3d012976977ed4c6_Traceguids, v7);
    }
