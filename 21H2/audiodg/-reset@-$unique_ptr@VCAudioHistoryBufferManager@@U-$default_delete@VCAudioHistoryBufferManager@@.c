/*
 * XREFs of ?reset@?$unique_ptr@VCAudioHistoryBufferManager@@U?$default_delete@VCAudioHistoryBufferManager@@@wistd@@@wistd@@QEAAXPEAVCAudioHistoryBufferManager@@@Z @ 0x14001CAA0
 * Callers:
 *     _dynamic_atexit_destructor_for__g_AudioHistoryManager__ @ 0x14002DBF0 (_dynamic_atexit_destructor_for__g_AudioHistoryManager__.c)
 * Callees:
