/*
 * XREFs of ?AddToCpuManager@GraphStreamingResourceManager@@UEAAJ_J@Z @ 0x140003AB0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x140029E50 (_guard_dispatch_icall_nop.c)
 *     ?GetCpuManager@@YAJPEAPEAVCpuManager@@@Z @ 0x14003F36C (-GetCpuManager@@YAJPEAPEAVCpuManager@@@Z.c)
...
__int64 __fastcall GraphStreamingResourceManager::AddToCpuManager(struct CpuManager **this, __int64 a2)
{
  ...
  if ( a2 >= (unsigned int)dword_140090098 )
    goto LABEL_2;
  v7 = this + 34;
