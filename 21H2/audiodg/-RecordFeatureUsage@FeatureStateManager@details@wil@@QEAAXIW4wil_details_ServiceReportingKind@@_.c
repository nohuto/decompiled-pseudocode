/*
 * XREFs of ?RecordFeatureUsage@FeatureStateManager@details@wil@@QEAAXIW4wil_details_ServiceReportingKind@@_K@Z @ 0x140025D1C
 * Callers:
        ...
        unsigned int a4)
{
  ...
  {
    wil::srwlock::lock_exclusive((RTL_SRWLOCK *)a1 + 4, &v9);
