/*
 * XREFs of ?WilApiImpl_UnsubscribeFeatureStateChangeNotification@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x140028030
 * Callers:
 *     <none>
 * Callees:
        ...
        struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *a2)
{
  ...
  if ( ((unsigned int)this & 0x80000000) != 0 )
  {
    ...
    v3 = (wil::details_abi::SubscriptionList *)&unk_1400904A0;
  }
  else
  {
    if ( !wil::details::g_featureStateManager[0] )
      return;
    v2 = this;
    v3 = (wil::details_abi::SubscriptionList *)&unk_140090440;
  }
  wil::details_abi::SubscriptionList::Unsubscribe(v3, (RTL_SRWLOCK *)&unk_140090418, v2);
}
