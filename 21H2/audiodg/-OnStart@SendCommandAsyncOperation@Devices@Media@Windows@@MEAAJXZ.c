/*
 * XREFs of ?OnStart@SendCommandAsyncOperation@Devices@Media@Windows@@MEAAJXZ @ 0x140058D30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$?4VModuleCommandResult@Devices@Media@Windows@@X@?$com_ptr_t@UIModuleCommandResult@Devices@Media@Windows@@Uerr_returncode_policy@wil@@@wil@@QEAAAEAV01@$$QEAV?$ComPtr@VModuleCommandResult@Devices@Media@Windows@@@WRL@Microsoft@@@Z @ 0x14001ED98 (--$-4VModuleCommandResult@Devices@Media@Windows@@X@-$com_ptr_t@UIModuleCommandResult@Devices@Med.c)
 *     ??$?8UIModuleCommandResult@Devices@Media@Windows@@Uerr_returncode_policy@wil@@@wil@@YA_NAEBV?$com_ptr_t@UIModuleCommandResult@Devices@Media@Windows@@Uerr_returncode_policy@wil@@@0@$$T@Z @ 0x14001EDD0 (--$-8UIModuleCommandResult@Devices@Media@Windows@@Uerr_returncode_policy@wil@@@wil@@YA_NAEBV-$co.c)
        ...
        Windows::Media::Devices::SendCommandAsyncOperation *this)
{
  ...
  if ( !wil::operator==<Windows::Media::Devices::IModuleCommandResult,wil::err_returncode_policy>(&v17) )
  {
    ...
    if ( v10 >= 0 )
    {
      ...
      if ( wil::operator==<Windows::Media::Devices::IModuleCommandResult,wil::err_returncode_policy>((_QWORD *)this + 20) )
      {
        v2 = -2147024882;
        v3 = 2147942414LL;
        v4 = 1802LL;
