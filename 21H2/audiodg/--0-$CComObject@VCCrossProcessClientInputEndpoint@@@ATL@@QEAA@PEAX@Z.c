/*
 * XREFs of ??0?$CComObject@VCCrossProcessClientInputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x14005B210
 * Callers:
 ...
 *     ??0CCrossProcessClientInputEndpoint@@QEAA@XZ @ 0x14005B4C0 (--0CCrossProcessClientInputEndpoint@@QEAA@XZ.c)
 */
