/*
 * XREFs of ??0?$CComAggObject@VCSpatialCrossProcessClientOutputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x140064FFC
 * Callers:
 *     ?CreateInstance@?$CComCreator@V?$CComAggObject@VCSpatialCrossProcessClientOutputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x1400660E4 (-CreateInstance@-$CComCreator@V-$CComAggObject@VCSpatialCrossProcessClientOutputEndpoint@@@ATL@@.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  *v4 = &ATL::CComContainedObject<CSpatialCrossProcessClientOutputEndpoint>::`vftable'{for `IAudioEndpoint'};
  ...
  v4[164] = &ATL::CComContainedObject<CSpatialCrossProcessClientOutputEndpoint>::`vftable'{for `ISpatialAudioCrossProcessClientEndpoint'};
  v4[165] = &ATL::CComContainedObject<CSpatialCrossProcessClientOutputEndpoint>::`vftable'{for `IAudioClock'};
  v4[166] = &ATL::CComContainedObject<CSpatialCrossProcessClientOutputEndpoint>::`vftable'{for `IAudioClock2'};
  v4[172] = &ATL::CComContainedObject<CSpatialCrossProcessClientOutputEndpoint>::`vftable';
  v4[174] = a2;
