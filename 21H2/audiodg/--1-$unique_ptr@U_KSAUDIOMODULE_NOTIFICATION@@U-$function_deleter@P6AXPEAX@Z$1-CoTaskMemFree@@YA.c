/*
 * XREFs of ??1?$unique_ptr@U_KSAUDIOMODULE_NOTIFICATION@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@QEAA@XZ @ 0x140020E1C
 * Callers:
 ...
 *     _Windows::Media::Devices::AudioDeviceModulesManager::OnModuleChanged_::_1_::dtor$8 @ 0x140058CF7 (_Windows--Media--Devices--AudioDeviceModulesManager--OnModuleChanged_--_1_--dtor$8.c)
 * Callees:
 *     <none>
 */
