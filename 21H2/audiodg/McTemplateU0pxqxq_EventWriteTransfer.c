/*
 * XREFs of McTemplateU0pxqxq_EventWriteTransfer @ 0x140064D88
 * Callers:
 ...
 *     McGenEventWrite_EventWriteTransfer @ 0x140051214 (McGenEventWrite_EventWriteTransfer.c)
 */

ULONG McTemplateU0pxqxq_EventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  v11 = 8LL;
  v13 = 4LL;
  return McGenEventWrite_EventWriteTransfer(a1, &EVT_GLITCH_CP_SERVER_OUTPUT_QUEUE_FULL_PACKET_DROP, v15, 6u, &v3);
}
