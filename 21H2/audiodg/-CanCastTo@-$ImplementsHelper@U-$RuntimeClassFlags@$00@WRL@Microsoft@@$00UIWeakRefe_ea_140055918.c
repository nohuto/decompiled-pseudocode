        ...
        const struct _GUID *a2)
{
  ...
  else
  {
    ...
    {
      CanCastTo = Microsoft::WRL::FtmBase::CanCastTo((Microsoft::WRL::FtmBase *)(v8 + 80), v9, v6);
