/*
 * XREFs of ?SubscribeToEnabledStateChanges@FeatureStateManager@details@wil@@QEAAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x1400277BC
 * Callers:
        ...
        void *a4)
{
  ...
  *a2 = 0LL;
  if ( LOBYTE(this->Ptr) )
  {
    wil::srwlock::lock_exclusive(this + 4, &v8);
