/*
 * XREFs of ?Iterate@RawUsageIndex@details_abi@wil@@QEBA_NV?$function@$$A6A_NPEAX_K01I@Z@wistd@@@Z @ 0x140024B3C
 * Callers:
 ...
 * Callees:
 *     ??1?$function@$$A6A_NPEAX_K01I@Z@wistd@@QEAA@XZ @ 0x140020DCC (--1-$function@$$A6A_NPEAX_K01I@Z@wistd@@QEAA@XZ.c)
