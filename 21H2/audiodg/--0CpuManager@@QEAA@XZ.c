/*
 * XREFs of ??0CpuManager@@QEAA@XZ @ 0x14001384C
 * Callers:
 ...
 *     ??0?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIUnknown@@@WRL@Microsoft@@QEAA@XZ @ 0x140013720 (--0-$RuntimeClass@U-$RuntimeClassFlags@$01@WRL@Microsoft@@UIUnknown@@@WRL@Microsoft@@QEAA@XZ.c)
 *     ??0HandleRegistrations@CpuManager@@QEAA@XZ @ 0x1400138F4 (--0HandleRegistrations@CpuManager@@QEAA@XZ.c)
 */
