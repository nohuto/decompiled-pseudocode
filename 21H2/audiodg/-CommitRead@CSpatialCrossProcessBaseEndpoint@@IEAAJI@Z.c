/*
 * XREFs of ?CommitRead@CSpatialCrossProcessBaseEndpoint@@IEAAJI@Z @ 0x14006937C
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( a2 > 1 )
  {
    v4 = -2147024809;
LABEL_11:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::CommitRead", 950, v4, a4);
    return v4;
  }
