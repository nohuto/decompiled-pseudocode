/*
 * XREFs of ??I?$com_ptr_t@VSendCommandAsyncOperation@Devices@Media@Windows@@Uerr_returncode_policy@wil@@@wil@@QEAAPEAPEAVSendCommandAsyncOperation@Devices@Media@Windows@@XZ @ 0x140021280
 * Callers:
...
__int64 *__fastcall wil::com_ptr_t<Windows::Media::Devices::SendCommandAsyncOperation,wil::err_returncode_policy>::operator&(
        __int64 *a1)
{
  __int64 v2; // rcx
