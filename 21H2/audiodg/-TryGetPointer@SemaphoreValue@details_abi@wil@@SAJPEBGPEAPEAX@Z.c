/*
 * XREFs of ?TryGetPointer@SemaphoreValue@details_abi@wil@@SAJPEBGPEAPEAX@Z @ 0x140015388
 * Callers:
...
__int64 __fastcall wil::details_abi::SemaphoreValue::TryGetPointer(size_t *a1, void **a2, __int64 a3, bool *a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v7 < 0 )
  {
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x6B, (unsigned int)"wil", (const char *)(unsigned int)v7, v9);
