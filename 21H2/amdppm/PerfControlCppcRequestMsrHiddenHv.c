/*
 * XREFs of PerfControlCppcRequestMsrHiddenHv @ 0x1C00024C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PerfControlCppcRequestMsrHiddenHv(__int64 *a1, _QWORD *a2, char a3, char a4)
{
  ...
  if ( a3 || a4 )
  {
    if ( !*((_BYTE *)a1 + 105) || a4 )
    {
      ((void (__fastcall *)(_QWORD, _QWORD, _QWORD *))qword_1C00146E8)(
        *(unsigned int *)(*a1 + 84),
        *((unsigned int *)a1 + 31),
        v9);
      v6 = v9[0];
    ...
    ((void (__fastcall *)(_QWORD, __int64))qword_1C00146F0)(*(unsigned int *)(v8 + 84), v7);
    a1[17] = v9[0];
  }
}
