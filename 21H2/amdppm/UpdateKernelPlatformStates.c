/*
 * XREFs of UpdateKernelPlatformStates @ 0x1C000BB8C
 * Callers:
...
__int64 __fastcall UpdateKernelPlatformStates(__int64 a1, char a2)
{
  ...
  if ( v4 )
  {
    for ( i = 0LL; (unsigned int)i < v6; i = (unsigned int)(i + 1) )
    {
      ...
      *v4 = i;
      v4[8] = v5;
      if ( (int)((__int64 (__fastcall *)(_QWORD, _DWORD *, __int64))qword_1C00146B0)(*(_QWORD *)(a1 + 1104), v4, v22) >= 0 )
      {
...
LABEL_29:
    *((_BYTE *)v3 + 48) = 1;
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      qword_1C00143F8,
      0LL);
    ProcessorNumberFromIndex = ((__int64 (__fastcall *)(unsigned int *))qword_1C0014640)(v3);
    if ( ProcessorNumberFromIndex < 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_D(
