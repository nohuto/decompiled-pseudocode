/*
 * XREFs of ProcLibTraceBiosTStatesRundown @ 0x1C001F3AC
 * Callers:
  ...
  if ( EventDescriptorAndProcessorId )
  {
    ...
    if ( (_BYTE)EventDescriptorAndProcessorId )
    {
      ...
      if ( (v5 & 0x3300000) != 0 )
      {
        ...
        {
          v9 = 20 * v8;
          PoolWithTag = ExAllocatePoolWithTag(PagedPool, 20 * v8, 0x72637250u);
          v1 = PoolWithTag;
          if ( !PoolWithTag )
          {
LABEL_15:
          ...
          v11 = 0;
          v37 = v9;
          for ( i = 0; v11 < v19; *((_DWORD *)PoolWithTag + v13 + 4) = v7[5 * v12 + 5] )
          {
            v12 = v11++;
            v13 = 5 * v12;
            *((_DWORD *)PoolWithTag + v13) = v7[5 * v12 + 1];
            *((_DWORD *)PoolWithTag + v13 + 1) = v7[5 * v12 + 2];
            *((_DWORD *)PoolWithTag + v13 + 2) = v7[5 * v12 + 3];
            *((_DWORD *)PoolWithTag + v13 + 3) = v7[5 * v12 + 4];
          }
        }
      }
      v14 = *(_QWORD *)(a1 + 272);
