/*
 * XREFs of InitCoreProcessorSetAffinity @ 0x1C00209AC
 * Callers:
 *     InitEnergyCountersOnCurrentProcessor @ 0x1C0020A50 (InitEnergyCountersOnCurrentProcessor.c)
 * Callees:
 *     GetDevExtFromIndex @ 0x1C0001900 (GetDevExtFromIndex.c)
...
__int64 InitCoreProcessorSetAffinity()
{
  ...
  if ( ProcessorNumberFromIndex >= 0 )
  {
    ...
    ProcessorNumberFromIndex = KeQueryLogicalProcessorRelationship(
                                 ...
                                 &Length);
    if ( ProcessorNumberFromIndex >= 0 )
      *(_OWORD *)(GetDevExtFromIndex(Number) + 1200) = *(_OWORD *)&Information.Group.GroupInfo[0].MaximumProcessorCount;
  }
