/*
 * XREFs of CpcGuaranteedNotifyWorker @ 0x1C0022D5C
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C0023310 (CpcNativeInterruptWorker.c)
 *     AcpiCppcGuaranteedNotifyWorker @ 0x1C0025E40 (AcpiCppcGuaranteedNotifyWorker.c)
 * Callees:
 ...
 *     ProcLibTracePccCapChange @ 0x1C00036F8 (ProcLibTracePccCapChange.c)
          ...
          || (int)StartPccCommand(*(_QWORD *)(v5 + 248)) >= 0 && (int)ExecutePccCommand(*(_QWORD *)(v5 + 248), 0LL) >= 0 )
        {
          ...
          *(_DWORD *)(v7 + 84) = v12;
          if ( v12 != *(_DWORD *)(v5 + 724) )
          {
            ...
            ((void (__fastcall *)(__int64))qword_1C00147D0)(v5);
          }
