/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C002948C
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C00285A8 (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     GetDevExtByAcpiId @ 0x1C0002D00 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C00079F8 (RtlUnicodeStringCopyString.c)
      ...
      if ( v16 )
      {
        ...
        *(_QWORD *)(a3 + 32) = v17;
        ...
        for ( j = (char *)a1 + (unsigned int)a1[2 * v6 + 7]; v18 < a1[2 * v6 + 6]; v18 = v21 + 1 )
        {
          ...
          {
            if ( dword_1C0014C0C <= (unsigned int)dword_1C00143F4 )
              return -1073741275;
