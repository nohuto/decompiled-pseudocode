/*
 * XREFs of RetrieveEfficiencyClassInformation @ 0x1C00357C8
 * Callers:
 ...
 *     GetProcessorEfficiencyClass @ 0x1C00352F4 (GetProcessorEfficiencyClass.c)
 */
...
__int64 RetrieveEfficiencyClassInformation()
{
  ...
  InitializeEnumerationContext((__int64)&qword_1C0014410, 32, (__int64)v6);
  ...
  while ( !(unsigned int)EnumerateNextDevice((__int64 *)v6, &v8) )
  {
    ...
    if ( (*(_QWORD *)(v8 + 272) & 0x2000000000LL) != 0 )
    {
      if ( (int)GetProcessorEfficiencyClass(v8, &v7) < 0 )
      {
        ...
        dword_1C00149E4 = 1;
        qword_1C00149E8 = 0LL;
        LODWORD(qword_1C00149E8) = dword_1C00143F4;
        return v3;
      }
      v2 = v7;
      *(_BYTE *)(v1 + 368) = v7;
      ++*((_DWORD *)&qword_1C00149E8 + v2);
    }
  }
  for ( i = 0; i < 2; ++i )
  {
