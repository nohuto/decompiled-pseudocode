/*
 * XREFs of InitEnergyCountersOnCurrentProcessor @ 0x1C0020A50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsEnergyMsrSupported @ 0x1C0020BE0 (IsEnergyMsrSupported.c)
 */
    ...
    && (unsigned __int8)IsEnergyMsrSupported() )
  {
    ...
    if ( inited >= 0 )
    {
      ...
      if ( !Number )
      {
        ...
        if ( v4 )
        {
          qword_1C0014AE8[0] = (__int64)SnapEnergyCountersAndTimestamp;
          v8 = ComputeHyperThreadedProcessorEnergyUsingMsr;
        }
        else
        {
          qword_1C0014AE8[0] = (__int64)SnapEnergyCounters;
          v8 = ComputeProcessorEnergyUsingMsr;
        }
        qword_1C0014AE0[0] = (__int64)v8;
      }
    }
  }
  else
