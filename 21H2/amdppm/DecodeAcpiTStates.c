/*
 * XREFs of DecodeAcpiTStates @ 0x1C0032CCC
 * Callers:
 *     RegisterHvPerfStates @ 0x1C0024BD0 (RegisterHvPerfStates.c)
 * Callees:
 *     DecodeControlStatusRegisterIo @ 0x1C0032DF4 (DecodeControlStatusRegisterIo.c)
 */
        ...
        _DWORD *a7)
{
  ...
  *a7 = 0;
  v12 = *(_BYTE *)(a1 + 464);
  if ( v12 == 127 && (*(_DWORD *)(a1 + 272) & 0x2000000) != 0 && dword_1C00145F8 )
  {
    *a2 = *a2 & 0xFFFFFFFFFFFFFLL | 0x10000000000000LL;
    *(_DWORD *)a2 = dword_1C00145F8;
    *a4 = qword_1C0014600;
  }
  else if ( v12 == 1 && (*(_DWORD *)(a1 + 272) & 0x1100000) != 0 )
  {
    if ( *(_DWORD *)(a1 + 468) )
    {
      LOBYTE(v9) = 1;
