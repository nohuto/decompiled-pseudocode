/*
 * XREFs of RegisterKernelPepIdleStates @ 0x1C0030FF0
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00143F8,
    0LL);
  if ( !dword_1C001499C || PlatformStatesRegistered )
  {
    v7 = 0;
  }
  else
  {
    HIDWORD(v34[0]) = dword_1C001499C;
    LODWORD(v34[0]) = 62;
    v34[5] = PepQueryPlatformStateResidency;
    v7 = ((__int64 (__fastcall *)(_QWORD *))qword_1C0014640)(v34);
    if ( v7 >= 0 )
    {
    ...
    *(_DWORD *)(v3 + 40) = v14;
    ...
    while ( 1 )
    {
      ...
      if ( ((v8[v15 + 2] >> 3) & 0xF) != 0 )
      {
        ...
        if ( v20 != &v35 )
          *v17 = v20;
        if ( (int)DecodeAcpi2CState(v22, (__int64)v20, 0LL, (char *)&v29, (__int64)v17) < 0 )
        {
