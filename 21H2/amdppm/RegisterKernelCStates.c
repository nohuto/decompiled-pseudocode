/*
 * XREFs of RegisterKernelCStates @ 0x1C0030470
 * Callers:
  ...
  if ( v3 && *(_DWORD *)v3 )
  {
    ...
    *(_DWORD *)(a3 + 56) = 0;
    ...
    if ( *(_BYTE *)(v3 + 16) != 1 )
    {
      ...
      HIWORD(v26) = 0;
      v27 = 0;
      DecodeAcpi2CState(a1, (__int64)&v26, 0LL, v22, a3 + 64);
      v8 = 2;
      *(_DWORD *)(a2 + 120) = *(_DWORD *)(a2 + 120) & 0x7FFFFF80 | ((unsigned __int8)v22[0] << 31) | 0xF;
      *(_DWORD *)(a2 + 116) = 1;
      *(_DWORD *)(a3 + 56) = 1;
    }
    v9 = *(_DWORD *)v3;
      ...
      if ( v11 == v8 )
      {
        ...
        *v21 = v3 + 4 * (i + 4LL * i + 1);
        ...
        else
        {
          ...
          *(_DWORD *)(v15 + a2 + 120) = v17 & 0x7FFFFFFF | ((unsigned __int8)v22[0] << 31);
