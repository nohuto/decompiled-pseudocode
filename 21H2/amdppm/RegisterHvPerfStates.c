/*
 * XREFs of RegisterHvPerfStates @ 0x1C0024BD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeAcpiPStates @ 0x1C0032B28 (DecodeAcpiPStates.c)
 *     DecodeAcpiTStates @ 0x1C0032CCC (DecodeAcpiTStates.c)
 */
...
LABEL_18:
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      qword_1C00143F8,
      0LL);
    PerfDomain = GetPerfDomain(a1, v39, &v42);
    v43 = PerfDomain;
    if ( v42 == 253 )
    {
      v2 = 1;
    ...
    if ( v5 )
      v5[770] = dword_1C0014840;
    if ( v7 )
      v7[802] = dword_1C0014840;
    ++dword_1C0014840;
    v9 = 0;
