/*
 * XREFs of AcquirePccInterface @ 0x1C00251C0
 * Callers:
...
__int64 __fastcall AcquirePccInterface(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v3 >= 0 )
    {
      v3 = ValidatePccHeader(qword_1C00148F0);
      if ( v3 < 0 )
        goto LABEL_7;
      ...
      {
LABEL_7:
        ((void (__fastcall *)(__int64))qword_1C00148C0)(qword_1C00148B0);
        memset(&unk_1C00148A8, 0, 0x80uLL);
      }
    }
  }
