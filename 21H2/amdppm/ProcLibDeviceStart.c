/*
 * XREFs of ProcLibDeviceStart @ 0x1C002A3A0
 * Callers:
...
__int64 __fastcall ProcLibDeviceStart(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 48) = v4;
  *(_DWORD *)(a1 + 52) = v65;
  v6 = ((__int64 (__fastcall *)(__int64))qword_1C00147F8)(a1);
  v7 = v6;
  if ( v6 < 0 )
  {
    *(_QWORD *)(a1 + 272) = 0LL;
  ...
  *(_BYTE *)(a1 + 1161) = 1;
  ...
  if ( qword_1C0014520 )
  {
    v14 = AcpiEval_OSC(a1, (_DWORD *)qword_1C0014520, v13, &v58);
    if ( v14 >= 0 )
    {
      v15 = *v58;
      if ( (*v58 & 0xE) == 0 )
      ...
      if ( (v15 & 4) != 0 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_DDDDDDDDDDD(
          (__int64)WPP_GLOBAL_Control->DeviceExtension,
          *(unsigned __int8 *)(qword_1C0014520 + 13),
          *(unsigned __int8 *)(qword_1C0014520 + 12),
          *(unsigned __int8 *)(qword_1C0014520 + 11),
          Type);
...
LABEL_47:
      ...
      v17 = 2;
      v18 = 1;
      Sizeb[0] = *(_DWORD *)(qword_1C0014520 + 16);
LABEL_46:
      WPP_RECORDER_SF_D(
        (__int64)WPP_GLOBAL_Control->DeviceExtension,
        v17,
...
LABEL_48:
  if ( qword_1C0014518 )
    AcpiEval_PDC(a1, (const void *)qword_1C0014518, word_1C0014528);
LABEL_50:
  ...
  if ( !qword_1C0014530 || (v35 = qword_1C0014530(a1), v7 = v35, v35 >= 0) )
  {
    if ( dword_1C001483C == 1 )
      goto LABEL_133;
    v37 = *(_QWORD *)(a1 + 272);
    if ( (v37 & 0x60000000) != 0 && *(_BYTE *)(a1 + 408) == 127 )
    {
      if ( (v37 & 0x20000000) != 0 )
      {
        *(_QWORD *)(a1 + 288) = qword_1C0014550;
        *(_QWORD *)(a1 + 320) = qword_1C0014578;
        *(_QWORD *)(a1 + 304) = qword_1C0014560;
      }
      if ( (v37 & 0x40000000) == 0 )
        goto LABEL_120;
      v37 &= ~0x400000uLL;
...
LABEL_120:
    if ( (v37 & 0x4000000) != 0 )
      *(_QWORD *)(a1 + 328) = qword_1C0014580;
    if ( (v37 & 0xA8000000) != 0 )
    {
      *(_QWORD *)(a1 + 344) = qword_1C0014590;
      *(_QWORD *)(a1 + 352) = qword_1C0014598;
    }
    if ( (v37 & 0x2000000) != 0 && *(_BYTE *)(a1 + 464) == 127 )
    {
      *(_QWORD *)(a1 + 296) = qword_1C0014558;
      *(_QWORD *)(a1 + 312) = qword_1C0014568;
    }
...
LABEL_133:
    ...
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      *(_QWORD *)(a1 + 208),
      0LL);
    v40 = ((__int64 (__fastcall *)(__int64))qword_1C00147C0)(a1);
    ...
    else
    {
      if ( byte_1C0014838 )
      {
        if ( !(unsigned int)((__int64 (__fastcall *)(__int64))qword_1C0014800)(a1) )
        {
LABEL_168:
          if ( (int)ValidatePerfDomainSymmetry(a1) >= 0 )
          {
            ...
            {
              ((void (__fastcall *)(__int64))qword_1C00147F0)(a1);
            }
            else if ( (v48 & 0x8000000) != 0 )
            {
              ((void (__fastcall *)(__int64))qword_1C00147E8)(a1);
            }
            else if ( (v48 & 0x80000000) != 0 )
            {
              ((void (__fastcall *)(__int64))qword_1C00147E0)(a1);
            }
            else
            {
              v49 = (void (__fastcall *)(__int64))qword_1C00147C8;
              if ( (*(_QWORD *)(a1 + 272) & 0x73300000LL) == 0 )
                v49 = (void (__fastcall *)(__int64))qword_1C00147D8;
              v49(a1);
            }
          }
        }
LABEL_178:
        if ( (*(_QWORD *)(a1 + 272) & 0x2000000000LL) != 0 && ++dword_1C0014BF0 == dword_1C00143F4 )
...
LABEL_184:
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C0014810, (__int64)&PPM_ETW_IDLE_STATES_ERROR_HV, 0, 0LL);
    v50 = *(_DWORD *)(a1 + 264);
    v51 = *(_QWORD *)(a1 + 272);
  }
  v52 = v50 & 0x40000000;
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C0014818, (__int64)&PPM_ETW_PERF_STATES_ERROR_HV, 0, 0LL);
    v50 = *(_DWORD *)(a1 + 264);
    v51 = *(_QWORD *)(a1 + 272);
  }
  if ( ((unsigned int)v51 & v50 & 0x3300000) != (unsigned __int64)(v50 & 0x3300000) )
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C0014820, (__int64)&PPM_ETW_THROTTLE_STATES_ERROR_HV, 0, 0LL);
    v50 = *(_DWORD *)(a1 + 264);
    v51 = *(_QWORD *)(a1 + 272);
  }
