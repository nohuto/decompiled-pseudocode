/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C0024470
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C0025408 (DecodeDoorbellAddressIo.c)
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  v19 = dword_1C0014898;
  v14 = 0LL;
  if ( (unsigned __int8)qword_1C0014890 <= 1u )
  {
    v3 = qword_1C0014888;
    v5 = qword_1C0014880;
    if ( (_BYTE)qword_1C0014890 == 1 )
    {
  ...
  if ( v9 >= 0 )
  {
    HIDWORD(v23[0]) = dword_1C0014840;
    v23[2] = qword_1C0014870;
    LODWORD(v23[3]) = dword_1C0014878;
    v23[6] = v5 << v4;
    v23[5] = v3 << v4;
