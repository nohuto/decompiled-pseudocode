/*
 * XREFs of CpcHighestNotifyWorker @ 0x1C0023004
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C0023310 (CpcNativeInterruptWorker.c)
 *     AcpiCppcHighestNotifyWorker @ 0x1C0025E60 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
    ...
    else
    {
        ...
        || (int)StartPccCommand(*(_QWORD *)(v5 + 248)) >= 0 && (int)ExecutePccCommand(*(_QWORD *)(v5 + 248), 0LL) >= 0 )
      {
        ...
        *(_DWORD *)(v8 + 68) = v13;
        ...
        ((void (__fastcall *)(__int64 *))qword_1C0014618)(&v19);
