/*
 * XREFs of RegisterHvPackage @ 0x1C0024980
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C000EC50 (_guard_dispatch_icall_nop.c)
 *     GetHvPackage @ 0x1C00238AC (GetHvPackage.c)
 */
...
__int64 __fastcall RegisterHvPackage(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    while ( (__int64 *)v3 != &qword_1C0014430 );
    if ( !HvPackage )
    {
LABEL_6:
...
LABEL_11:
      ...
      v5 = (_QWORD *)qword_1C0014438;
      if ( *(__int64 **)qword_1C0014438 != &qword_1C0014430 )
LABEL_13:
        __fastfail(3u);
      *(_QWORD *)HvPackage = &qword_1C0014430;
      *((_QWORD *)HvPackage + 1) = v5;
      *v5 = HvPackage;
      qword_1C0014438 = (__int64)HvPackage;
    }
