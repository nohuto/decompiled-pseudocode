/*
 * XREFs of ValidateAcpiCStates @ 0x1C002BA04
 * Callers:
          ...
          if ( LOBYTE(v2[5 * j + 1]) != 127 )
          {
            switch ( LOBYTE(v2[5 * j + 4]) )
            {
              ...
              case 2:
                ...
                break;
              default:
                if ( !IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0014C54)
                  || !IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0014C24)
                  || !IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0014C3C) )
                {
                  if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                    return (unsigned int)-1073741823;
                  v6 = 27;
