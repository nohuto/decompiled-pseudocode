/*
 * XREFs of ProcLibTraceSummary2 @ 0x1C00201CC
 * Callers:
    ...
    if ( (_BYTE)EventDescriptorAndProcessorId )
    {
      ...
      else
      {
        if ( (v7 & 0x8000000) == 0 )
        {
          ...
          {
            v24 = 2;
            v21 = *(_DWORD *)(qword_1C00148F0 + 28);
            v22 = 100 * *(_DWORD *)(qword_1C00148F0 + 36) / v21;
            v23 = 100 * *(_DWORD *)(qword_1C00148F0 + 32) / v21;
          }
          else
          {
            if ( (v7 & 0x73300000) == 0 )
