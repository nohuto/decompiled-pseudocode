/*
 * XREFs of RegisterKernelIdleStates @ 0x1C000B430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelIdleStates(__int64 a1)
{
  ...
  v3 = 0LL;
  if ( *(_DWORD *)(a1 + 80) )
    return (unsigned int)((__int64 (*)(void))qword_1C0014830)();
...
LABEL_37:
    ...
    if ( (*(_QWORD *)(a1 + 272) & 0x100300000300LL) != 0 && *(_QWORD *)(a1 + 696) )
      HIBYTE(v1[4].Group) = 1;
    v25 = ((__int64 (__fastcall *)(struct _PROCESSOR_NUMBER *))qword_1C0014630)(v1);
