/*
 * XREFs of InitAcpi1CStates @ 0x1C0022718
 * Callers:
...
__int64 __fastcall InitAcpi1CStates(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 264) |= v1 & 7;
  ...
  if ( (v1 & 2) != 0
    ...
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0014C3C)
  ...
  if ( (v7 & 4) != 0
    && (unsigned __int16)word_1C0014C22 <= 0x3E8u
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0014C54)
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0014C24)
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0014C3C)
    && (unsigned __int8)IsValidAcpiGenericAddress(a1 + 184)
    && dword_1C00143F4 == 1 )
  {
  ...
  if ( PoolWithTag )
  {
    ...
    *v10 = v11;
    ...
    if ( v5 )
    {
      ...
      HIWORD(v10[5 * *v10 + 4]) = word_1C0014C22;
      v10[5 * *v10 + 5] = 0;
      if ( *(_DWORD *)(a1 + 188) != -5 )
      {
        LOBYTE(v10[5 * *v10 + 1]) = 1;
