/*
 * XREFs of PccInitiateExecuteCallback @ 0x1C000E600
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2528))(
      ...
      qword_1C0014968);
    v3 = qword_1C0014450;
    for ( i = 0; (__int64 *)v3 != &qword_1C0014450; v3 = *(_QWORD *)v3 )
    {
    ...
    if ( i )
    {
      LOBYTE(word_1C001497C) = 1;
      if ( !HIBYTE(word_1C001497C) )
      {
        HIBYTE(word_1C001497C) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_1C0014968);
    if ( v11 )
      IoQueueWorkItem(qword_1C0014970, (PIO_WORKITEM_ROUTINE)PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
