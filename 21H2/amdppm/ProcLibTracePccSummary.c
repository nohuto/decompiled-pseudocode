/*
 * XREFs of ProcLibTracePccSummary @ 0x1C001EF10
 * Callers:
...
BOOLEAN ProcLibTracePccSummary()
{
  ...
  if ( result )
  {
    if ( qword_1C00148F0 )
    {
      v2 = (unsigned int)(100 * *(_DWORD *)(qword_1C00148F0 + 36)) / *(_DWORD *)(qword_1C00148F0 + 28);
      v1 = (unsigned int)(100 * *(_DWORD *)(qword_1C00148F0 + 32)) / *(_DWORD *)(qword_1C00148F0 + 28);
      *(_QWORD *)&UserData.Size = 1LL;
      v3 = v1;
      UserData.Ptr = qword_1C00148F0 + 6;
      v5 = qword_1C00148F0 + 7;
      v7 = &v2;
      v9 = &v3;
      v6 = 1LL;
      v8 = 1LL;
