/*
 * XREFs of InitializeEnergyEstimationForEfficiencyClass @ 0x1C00354E8
 * Callers:
...
__int64 __fastcall InitializeEnergyEstimationForEfficiencyClass(unsigned int a1)
{
  ...
  InitializeEnumerationContext((__int64)&qword_1C0014410, 32, (__int64)v12);
  ...
  *(__int64 *)((char *)&Globals[225] + v1) = 0LL;
  v5 = 0LL;
  *(__int64 *)((char *)&Globals[224] + v1) = 0LL;
  v6 = 0LL;
  result = *(unsigned int *)((char *)&Globals[199] + v1);
  if ( (_DWORD)result )
  {
    do
    {
      if ( (*(_DWORD *)((_BYTE *)&Globals[200] + 12 * v6 + v1) & 1) == 0 )
      {
        if ( (_DWORD)v6 != (_DWORD)v5 )
        {
          v7 = (char *)Globals + v1;
          v8 = 3 * v5;
          *(_QWORD *)&v7[4 * v8 + 1596] = *(__int64 *)((char *)&Globals[199] + 12 * v6 + v1 + 4);
          *(_DWORD *)&v7[4 * v8 + 1604] = *(_DWORD *)((char *)&Globals[200] + 12 * v6 + v1 + 4);
        }
  ...
  {
    result = (__int64)memset((char *)&unk_1C0014A1C + 12 * v5 + v1, 0, 12LL * (unsigned int)(result - v5));
    *(_DWORD *)((char *)&Globals[199] + v1) = v5;
  }
  if ( !(_DWORD)v5 )
    goto LABEL_37;
  ResetEnumerationContext((__int64 *)v12);
  ...
  if ( v9 < 0 || !*(__int64 *)((char *)&Globals[224] + v1) )
  {
    InitializeEnumerationContext((__int64)&qword_1C0014410, 32, (__int64)v12);
    ResetEnumerationContext((__int64 *)v12);
    while ( 1 )
    ...
    *(__int64 *)((char *)&Globals[224] + v1) = 0LL;
LABEL_37:
    if ( !*(__int64 *)((char *)&Globals[224] + v1) )
    {
      result = (__int64)ComputeProcessorEnergy;
      *(__int64 *)((char *)&Globals[224] + v1) = (__int64)ComputeProcessorEnergy;
    }
  }
  return result;
}
