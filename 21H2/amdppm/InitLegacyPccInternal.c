/*
 * XREFs of InitLegacyPccInternal @ 0x1C000AE18
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x1C000BA00 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x1C0024750 (RegisterHvLegacyPccCounters.c)
 * Callees:
  ...
  if ( qword_1C0014970 )
  {
          ...
          (v3 = v12) != 0LL) )
    {
      ...
      *((_DWORD *)v3 + 8) = v16;
      ...
      if ( dword_1C00148EC )
      {
        v17 = 0x989680 % ((unsigned int)dword_1C00148EC >> 1);
        *((_DWORD *)v3 + 10) = 0x989680 / ((unsigned int)dword_1C00148EC >> 1);
      }
      *((_DWORD *)v13 + 3) = 0;
      *((_WORD *)v13 + 8) = 0;
        ...
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v29, &v32) )
        {
          ...
          do
          {
            *(_QWORD *)(v32 + 232) = v25 - 1;
            v27 = (__int64 *)qword_1C0014458;
            if ( *(__int64 **)qword_1C0014458 != v26 )
              __fastfail(3u);
            *v25 = v26;
            v25[1] = v27;
            *v27 = (__int64)v25;
            qword_1C0014458 = (__int64)v25;
          }
          while ( !(unsigned int)EnumerateNextDevice((__int64 *)v29, &v32) );
        }
