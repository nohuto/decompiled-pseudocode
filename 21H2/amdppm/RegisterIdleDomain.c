/*
 * XREFs of RegisterIdleDomain @ 0x1C00302D4
 * Callers:
...
bool __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  if ( *(_DWORD *)(v2 + 24LL * a2 + 24) >= **(_DWORD **)(a1 + 712) )
    return v3;
  v6 = qword_1C0014440;
  if ( (__int64 *)qword_1C0014440 == &qword_1C0014440 )
    goto LABEL_6;
  do
  {
    v7 = v6;
  ...
  while ( (__int64 *)v6 != &qword_1C0014440 );
  if ( !v7 )
  {
LABEL_6:
    ...
    *(_QWORD *)(v7 + 24) = v7 + 16;
    *(_QWORD *)(v7 + 16) = v7 + 16;
    v9 = (__int64 *)qword_1C0014448;
    if ( *(__int64 **)qword_1C0014448 != &qword_1C0014440 )
LABEL_14:
      __fastfail(3u);
    *(_QWORD *)v7 = &qword_1C0014440;
    *(_QWORD *)(v7 + 8) = v9;
    *v9 = v7;
    qword_1C0014448 = v7;
