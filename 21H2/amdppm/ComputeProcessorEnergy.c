/*
 * XREFs of ComputeProcessorEnergy @ 0x1C0001260
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        unsigned __int64 *a5)
{
  ...
  v6 = (unsigned int *)((char *)&unk_1C00149F0 + 256 * (unsigned __int64)a1);
  v8 = v6[1];
  if ( (v8 & 1) != 0 )
  {
...
LABEL_8:
  ...
  result = 10 * a2 * v13 * (unsigned __int64)v12 / qword_1C0014BF8;
  *a5 = result;
  return result;
}
