/*
 * XREFs of WPP_RECORDER_SF_ddd @ 0x1C0009EB8
 * Callers:
 *     ValidateAcpiCStates @ 0x1C002BA04 (ValidateAcpiCStates.c)
 *     ValidateAcpiIdleDomain @ 0x1C002BBA0 (ValidateAcpiIdleDomain.c)
 *     ValidateAcpiThrottleStates @ 0x1C002BD4C (ValidateAcpiThrottleStates.c)
 *     ValidateCoordinatedDependencyOptionsPlatform @ 0x1C002C220 (ValidateCoordinatedDependencyOptionsPlatform.c)
 *     ValidateCoordinatedDependencyOptionsProcessor @ 0x1C002C374 (ValidateCoordinatedDependencyOptionsProcessor.c)
