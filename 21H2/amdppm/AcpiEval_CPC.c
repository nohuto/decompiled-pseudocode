/*
 * XREFs of AcpiEval_CPC @ 0x1C0025E7C
 * Callers:
...
__int64 __fastcall AcpiEval_CPC(__int64 a1, _QWORD *a2)
{
  ...
  v5 = AcpiEvaluateMethod(a1, 1129333599, 0, (unsigned int)&P, (__int64)&v17);
  if ( v5 < 0 )
    goto LABEL_27;
    ...
    if ( v9 )
    {
      ...
      if ( v10 )
      {
        ...
        if ( v11 )
        {
          v12 = 31;
          v13 = v11 != 1;
          v14 = (unsigned int *)&Cpc3RegisterTable;
        }
        else
        {
          v12 = 27;
      ...
      v5 = AcpiParseCore((unsigned int)v20, v12, (int)v7 + 12, v7[1] - 12, (__int64)v4, 512, (__int64)"_CPC", v13);
      if ( v5 >= 0 )
      {
        do
        {
