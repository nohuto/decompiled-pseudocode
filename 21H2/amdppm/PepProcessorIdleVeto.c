/*
 * XREFs of PepProcessorIdleVeto @ 0x1C000CFA4
 * Callers:
...
NTSTATUS __fastcall PepProcessorIdleVeto(__int64 a1, __int64 a2)
{
  ...
  if ( !*(_QWORD *)(a1 + 696) || !*(_QWORD *)(a1 + 1136) && (*(_QWORD *)(a1 + 272) & 0x100000000000LL) == 0 )
    return -1073741637;
  v3 = *(_DWORD *)(a1 + 56);
  v5 = 62;
  *(_OWORD *)&ProcNumber[0].Group = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    return ((__int64 (__fastcall *)(int *))qword_1C0014660)(&v5);
  }
  return result;
}
