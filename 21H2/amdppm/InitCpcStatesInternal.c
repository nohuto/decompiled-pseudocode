/*
 * XREFs of InitCpcStatesInternal @ 0x1C002DEF8
 * Callers:
 *     RegisterHvCpcCounters @ 0x1C0023F50 (RegisterHvCpcCounters.c)
 *     RegisterKernelCpc @ 0x1C0030980 (RegisterKernelCpc.c)
 * Callees:
 ...
 *     ClearEnumerationContext @ 0x1C0002CEC (ClearEnumerationContext.c)
 ...
 *     GetPackageAffinity @ 0x1C002DCDC (GetPackageAffinity.c)
...
__int64 __fastcall InitCpcStatesInternal(__int64 *a1, __int64 (__fastcall *a2)(_QWORD *, _QWORD))
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00143F8,
    0LL);
  PerfDomain = GetPerfDomain(v3, v148, &v153);
  ...
  do
  {
    ...
    *v18 = IsSupported;
    ...
    if ( v20[296] != 127 )
      v29 = v32;
    v141 = v29;
    if ( !qword_1C00145A0 || (v33 = qword_1C00145A0(v20), LOBYTE(v28) = 0, !v33) )
      v134 = v28;
    memset(v156, 0, 12);
    v34 = 0LL;
    v35 = 0;
...
LABEL_71:
    if ( qword_1C00145B8 )
    {
      ...
      if ( (int)qword_1C00145B8(v18 - 92, &v158, &v162, &v163, &v159, &v135, &v151) < 0 )
        v17 = 0;
    }
    LOBYTE(v43) = v143;
...
LABEL_214:
    ...
    if ( v129 )
    {
      ...
      else
      {
        ...
        v96 = (void *)qword_1C0014570;
        if ( !qword_1C0014570 || !CpcHiddenProcessorMitigationReported )
        {
