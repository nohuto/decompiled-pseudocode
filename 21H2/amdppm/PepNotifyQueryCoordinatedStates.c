/*
 * XREFs of PepNotifyQueryCoordinatedStates @ 0x1C0033DAC
 * Callers:
...
__int64 __fastcall PepNotifyQueryCoordinatedStates(__int64 a1, PVOID **a2)
{
  ...
  v4 = 0LL;
  v5 = 0LL;
  v6 = (unsigned int)(16 * dword_1C001499C + 4);
        ...
        for ( i = 0; i < (unsigned int)v2; ++i )
        {
          ...
          for ( j = 0; j < HIDWORD(v4[v31 + 31]); ++j )
          {
            ...
            *v5 = i;
            v5[1] = j;
            v5[2] = v4[v31 + 31];
            v9 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C00146B8)(*(_QWORD *)(a1 + 1104), v5);
            if ( v9 < 0 )
              goto LABEL_31;
