/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C002F464
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x1C0024BB0 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x1C0031D30 (RegisterKernelPerfFeedback.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(__int64 a1, __int64 (__fastcall *a2)(_QWORD *, _QWORD))
{
  ...
  v4(WdfDriverGlobals, qword_1C00143F8, 0LL);
