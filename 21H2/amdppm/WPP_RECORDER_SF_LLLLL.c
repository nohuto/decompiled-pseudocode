/*
 * XREFs of WPP_RECORDER_SF_LLLLL @ 0x1C0009CD8
 * Callers:
...
__int64 WPP_RECORDER_SF_LLLLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_d7c5e771396e3b131ba8bdc028e38c61_Traceguids,
      101LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 101;
  return WppAutoLogTrace(a1, 5LL, 2LL, &WPP_d7c5e771396e3b131ba8bdc028e38c61_Traceguids, v7, (__int64 *)va);
}
