/*
 * XREFs of InitPerfStatesInternal @ 0x1C002F820
 * Callers:
 *     RegisterHvPerfStatesCounters @ 0x1C00250C0 (RegisterHvPerfStatesCounters.c)
 *     RegisterKernelPerfStates @ 0x1C0031D50 (RegisterKernelPerfStates.c)
 * Callees:
 ...
 *     CalculatePercentageCap @ 0x1C002D8F4 (CalculatePercentageCap.c)
...
LABEL_16:
        ...
        *((_QWORD *)v6 + 42) = PerfControlPTStates;
        LODWORD(v55) = v19;
        if ( dword_1C0014C08 == 1 || v19 == 252 || (v20 = v19 == 1, v21 = PerfControlPTStatesHidden, v20) )
