/*
 * XREFs of FxDriverEntryWorker @ 0x1C0002874
 * Callers:
 *     FxDriverEntry @ 0x1C0002840 (FxDriverEntry.c)
 * Callees:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_1C00141B0;
...
LABEL_8:
    ...
    {
      DriverUnload = (void (__fastcall *)(_DRIVER_OBJECT *))qword_1C00143B8;
      if ( DriverObject->DriverUnload )
        DriverUnload = DriverObject->DriverUnload;
      qword_1C00143B8 = (__int64)DriverUnload;
