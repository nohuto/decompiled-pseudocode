/*
 * XREFs of sub_1800E9878 @ 0x1800E9878
 * Callers:
...
__int64 *__fastcall sub_1800E9878(__int64 *a1, __int64 *a2, char a3, _QWORD *a4, int a5, __int64 a6)
{
  ...
  {
    sub_1800EE0B4(0x38E38E38E38E38DLL, a6);
