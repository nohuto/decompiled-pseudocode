/*
 * XREFs of sub_1800E68F0 @ 0x1800E68F0
 * Callers:
...
__int64 __fastcall sub_1800E68F0(__int64 a1, int a2)
{
  int v2; // r8d
  __int64 result; // rax
  ...
  *(_DWORD *)(a1 + 100) = result;
  if ( v2 != (_DWORD)result && (!v2 || !(_DWORD)result) )
    return (*(__int64 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(a1 + 200) + 304LL))(*(_QWORD *)(a1 + 200), a1 + 8);
  return result;
}
