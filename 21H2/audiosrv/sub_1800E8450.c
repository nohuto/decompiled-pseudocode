/*
 * XREFs of sub_1800E8450 @ 0x1800E8450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800E8450(__int64 a1, __int64 a2)
{
  __int64 *v4; // rsi
  ...
  try
  {
    ...
    for ( k = (__int64 *)v18; k != v8; ++k )
    {
      ...
      if ( v15 < 0 )
      {
        sub_18004BD84((int)retaddr, 865, (int)"avcore\\audiocore\\server\\audiosrv\\dll\\devicegraphstore.cpp", v15);
        if ( v13 )
        {
