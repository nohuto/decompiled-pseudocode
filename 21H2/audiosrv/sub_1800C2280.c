/*
 * XREFs of sub_1800C2280 @ 0x1800C2280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800C2280(_DWORD *a1, __int64 a2, __int64 a3)
{
  int v6; // ebx
  int v7; // edx
  float v9; // xmm6_4
  ...
  {
    sub_1800BB4B4(*((_QWORD *)off_18019C348 + 2), 0xEu, (__int64)&unk_18016DDC0);
  }
