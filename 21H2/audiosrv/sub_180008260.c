/*
 * XREFs of sub_180008260 @ 0x180008260
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall sub_180008260(_QWORD *a1)
{
  __int64 v2; // r14
  __int64 v3; // rdi
  int v4; // eax
...
LABEL_12:
  ...
  LODWORD(v7) = Mtx_unlock((_Mtx_t)(v3 + 32));
  if ( (_DWORD)v7 )
  {
    std::_Throw_C_error(v7);
    JUMPOUT(0x18007FA92LL);
  }
  if ( a1[2] )
  {
    v8 = Pdcv2ActivationClientDeactivate();
    a1[2] = 0LL;
    v7 = sub_180008448(v9, sub_1800B6240);
    v10 = *(_QWORD *)(v7 + 8);
    if ( *(_DWORD *)v10 > 4u )
    {
      v11 = a1[4];
      ...
      v28 = 76;
      v29 = 1;
      LODWORD(v17) = (unsigned int)&unk_18016D102 - (unsigned int)&unk_180165C78;
