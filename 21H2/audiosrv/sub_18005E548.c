/*
 * XREFs of sub_18005E548 @ 0x18005E548
 * Callers:
...
__int64 __fastcall sub_18005E548(__int64 a1, void (__fastcall ***a2)(_QWORD, __int64, __int64 *), __int64 a3)
{
  __int64 v6; // rcx
  int v7; // ebx
  _QWORD *v8; // rcx
  ...
  {
    sub_1800BD7DC(*((_QWORD *)off_18019C348 + 2), 14LL, &unk_18016DA10, a1);
    v6 = (__int64)v16;
  }
  if ( a2 )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( v7 >= 0 )
      {
        ...
        if ( off_18019C348 != (_UNKNOWN *)&off_18019C348 )
        {
          ...
          {
            sub_1800BD820(*((_QWORD *)off_18019C348 + 2), 15, (unsigned int)&unk_18016DA10, a1, (__int64)pv);
            v8 = off_18019C348;
          }
          if ( v8 != &off_18019C348 && (*((_DWORD *)v8 + 7) & 0x10000) != 0 && *((_BYTE *)v8 + 25) >= 4u )
            sub_1800BD7DC(v8[2], 16LL, &unk_18016DA10, a1);
        }
        v9 = (__int64)v16;
        if ( v16 != a2 )
        {
        ...
        if ( !v9 || (v7 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v9 + 88LL))(v9, &v15), v7 >= 0) )
        {
          ...
          if ( v11 >= 0 )
          {
            if ( off_18019C348 != (_UNKNOWN *)&off_18019C348
              ...
              && *((_BYTE *)off_18019C348 + 25) >= 4u )
            {
              sub_1800BD7DC(*((_QWORD *)off_18019C348 + 2), 17LL, &unk_18016DA10, a1);
            }
            v7 = (*(__int64 (__fastcall **)(_QWORD, __int64, void *, __int64))(**(_QWORD **)(a1 + 48) + 104LL))(
                   *(_QWORD *)(a1 + 48),
                   23LL,
                   &unk_18015C6A8,
                   a1 + 56);
    ...
    if ( v7 < 0 )
    {
      if ( *(_DWORD *)(a1 + 64) )
      {
        (*(void (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(a1 + 48) + 120LL))(*(_QWORD *)(a1 + 48), a1);
        *(_DWORD *)(a1 + 64) = 0;
      }
      sub_18005E8F8("CMuteHardware::FindMuteControlForEndpoint", 398LL, (unsigned int)v7);
    }
    if ( v14 )
