/*
 * XREFs of sub_18013F980 @ 0x18013F980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18013F980(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rbx
  int v7; // edi
  char v8; // al
...
LABEL_5:
    ...
    v9 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v14 + 40LL))(v14, a3);
    v7 = 0;
    if ( v9 < 0 )
      v7 = v9;
  }
