/*
 * XREFs of sub_1800C7DB0 @ 0x1800C7DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800C7DB0(__int64 a1, void **a2)
{
  int v4; // eax
  __int64 v5; // rbx
  int v6; // edi
  ...
  v4 = sub_180003D20(a1 + 656, (__int64)&v10, 0);
  v5 = v10;
  v6 = v4;
  if ( v4 < 0 )
    goto LABEL_6;
  ...
  *a2 = v8;
  if ( v8 )
  {
    ...
    *a2 = 0LL;
LABEL_6:
    sub_18005E8F8((__int64)"CAudioSession::GetId", 481, v6);
    goto LABEL_7;
  }
  v6 = -2147024882;
LABEL_7:
