/*
 * XREFs of sub_18006F568 @ 0x18006F568
 * Callers:
...
__int64 __fastcall sub_18006F568(__int64 a1, _QWORD *a2, _QWORD *a3, __int64 *a4)
{
  _QWORD *i; // rdi
  int v8; // eax
  ...
  for ( i = a2; i != a3; ++i )
  {
    ...
    {
      sub_1800BB4E0(*((_QWORD *)off_18019C348 + 2), 39LL, &unk_18015E5F0, (unsigned int)v8);
    }
  }
  sub_1800CD9A8(a1, a4);
  sub_18000FFC0(a4);
