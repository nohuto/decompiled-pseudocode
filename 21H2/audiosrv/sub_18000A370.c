/*
 * XREFs of sub_18000A370 @ 0x18000A370
 * Callers:
...
_QWORD *__fastcall sub_18000A370(__int64 a1, _QWORD *a2, __int64 a3)
{
  _DWORD *v3; // rsi
  char *v4; // r12
  __int64 v5; // r15
...
LABEL_31:
  ...
  if ( *(_BYTE **)(a1 + 24) == v10 )
  {
    sub_180008B0C((_QWORD *)(a1 + 8), v10, &v33);
    v5 = v33;
  }
  else
  {
...
LABEL_14:
    ...
    if ( *(_DWORD *)v22 > 4u )
    {
      ...
      v60 = 89;
      v61 = 1;
      LODWORD(v33) = (unsigned int)&unk_18016D102 - (unsigned int)&unk_180165C78;
