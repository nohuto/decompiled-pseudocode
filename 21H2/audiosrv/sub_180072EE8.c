/*
 * XREFs of sub_180072EE8 @ 0x180072EE8
 * Callers:
...
__int64 __fastcall sub_180072EE8(char **a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rcx
  int v6; // ebx
  __int64 v7; // rcx
  ...
  if ( (_BYTE)v13 && !v15 )
  {
      ...
      || (unsigned __int8)sub_1801360D8(v7, v11[0]) )
    {
      *((_DWORD *)*a1 + 46) = 2;
      ...
      v8 = retaddr;
      if ( v9 < 0 )
        sub_18006D26C((int)retaddr, 1698, (int)"avcore\\published\\audiocore\\lib\\atmoscheck\\atmoscheck.cpp", v9);
      if ( v14 || !(*a1)[209] )
      {
        v8 = *a1;
        if ( (*a1)[208] )
    ...
    sub_18005F1A8((__int64)v8, (__int64)"AppInstall check result", v6);
    sub_1800461B8(v11);
  }
  if ( v6 < 0 )
LABEL_15:
    sub_18005F1A8(v5, (__int64)"AppInstall check result", v6);
