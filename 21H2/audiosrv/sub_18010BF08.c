/*
 * XREFs of sub_18010BF08 @ 0x18010BF08
 * Callers:
...
__int64 *__fastcall sub_18010BF08(__int64 *a1, __int64 *a2, char a3, _QWORD *a4, int a5, __int64 a6)
{
  ...
  {
    sub_18010E48C(0x38E38E38E38E38DLL, a6);
