/*
 * XREFs of sub_18000A830 @ 0x18000A830
 * Callers:
...
volatile signed __int32 **__fastcall sub_18000A830(__int64 a1, volatile signed __int32 **a2)
{
...
LABEL_24:
  ...
  if ( !v9 && *(_BYTE *)(a1 + 88) != 1 )
  {
    v36[1] = -1;
    v36[0] = 3;
    v15 = RtlPublishWnfStateData(0x41840B3EA3BDB075LL, 0LL, v36, 8LL, 0LL);
    if ( v15 >= 0 )
      *(_BYTE *)(a1 + 88) = 1;
    v16 = sub_180008448(v14, sub_1800B6240)[1];
    if ( *(_DWORD *)v16 > 4u )
    {
      v19[0] = v15;
      v17 = 1;
      ...
      v30 = 52;
      v31 = 1;
      v19[1] = (unsigned int)&unk_18016D102 - (unsigned int)&unk_180165C78;
      EtwEventWriteTransfer(*(_QWORD *)(v16 + 32), v21, 0LL);
    }
  }
  v10 = Mtx_unlock((_Mtx_t)(a1 + 8));
  if ( v10 )
    goto LABEL_23;
  if ( !v9 )
  {
