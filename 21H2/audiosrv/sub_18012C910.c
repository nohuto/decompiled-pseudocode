/*
 * XREFs of sub_18012C910 @ 0x18012C910
 * Callers:
 *     sub_180074F60 @ 0x180074F60 (sub_180074F60.c)
 * Callees:
 *     memcpy @ 0x18007443F (memcpy.c)
 *     sub_180109778 @ 0x180109778 (sub_180109778.c)
 */

__int64 __fastcall sub_18012C910(__int64 a1, void *a2, unsigned int a3)
{
  ...
  if ( a2 && (v8 = v4, v4 == 2LL * *(unsigned int *)(a1 + 124)) )
  {
    memcpy(a2, *(const void **)(a1 + 128), v4);
  }
  else
  {
