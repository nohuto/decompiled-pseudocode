/*
 * XREFs of __isa_available_init @ 0x18006A88C
 * Callers:
...
int __cdecl _isa_available_init()
{
  ...
  if ( (v14 & 0x100000) != 0 )
  {
    ...
    if ( (v14 & 0x8000000) != 0 && (v14 & 0x10000000) != 0 )
    {
      ...
      if ( (_RAX & 6) == 6 )
      {
        v23 = dword_18019D20C | 8;
        dword_18019D208 = 3;
        dword_18019D20C |= 8u;
        if ( (v5 & 0x20) != 0 )
        {
          dword_18019D208 = 5;
          dword_18019D20C = v23 | 0x20;
        }
      }
    }
  }
