/*
 * XREFs of sub_1800D03E0 @ 0x1800D03E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1800D03E0(__int64 **a1)
{
  __int64 *v1; // rbx
  __int64 *v2; // rax
  __int64 v3; // r8
  ...
  v4 = sub_1800CE750(*v1, v1[1]);
  v7 = v4;
  if ( v4 < 0 )
    sub_18005E8F8((__int64)"AudioSessionManagerDeleteAudioSessionClientNotification", 2190, v4);
