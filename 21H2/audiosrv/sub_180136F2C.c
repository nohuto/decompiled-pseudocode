/*
 * XREFs of sub_180136F2C @ 0x180136F2C
 * Callers:
...
_UNKNOWN **sub_180136F2C(volatile signed __int32 *a1, unsigned __int8 a2, __int64 a3, ...)
{
  __int64 v3; // r8
  unsigned int v5; // edi
  ...
  if ( (*a1 & 4) == 0 )
  {
    v3 = *(_QWORD *)sub_180135010(a1, (signed __int32 *)va);
    v9 = v3;
  }
  LODWORD(v9) = 0;
  BYTE4(v9) = 0;
