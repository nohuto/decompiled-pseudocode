/*
 * XREFs of sub_18005C130 @ 0x18005C130
 * Callers:
 *     sub_180074E70 @ 0x180074E70 (sub_180074E70.c)
 * Callees:
...
__int64 __fastcall sub_18005C130(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v3; // rcx
  _QWORD *v4; // r8
  __int64 v5; // r9
  ...
  *a3 = 0LL;
  ...
  if ( (unsigned int)sub_18005C250(v3, &unk_18015BC88, v4, v5) )
  {
    *v7 = v8;
LABEL_4:
    v9 = 0;
