/*
 * XREFs of sub_180065320 @ 0x180065320
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180065320(__int64 a1, __int16 **a2)
{
  __int16 *v2; // r15
  __int64 v4; // r13
  int v5; // ebp
...
LABEL_7:
  ...
  while ( 1 )
  {
    if ( v12 < 0 || v11 >= v9[6] )
    {
      ...
      JUMPOUT(0x18006543BLL);
    }
    if ( (unsigned int)sub_18004B400((unsigned __int16 *)v2, **(unsigned __int16 ***)(v12 + *((_QWORD *)v9 + 2))) )
      return v6;
    ++v11;
    v12 += 8LL;
    if ( v11 >= v9[6] )
