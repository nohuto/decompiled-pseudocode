/*
 * XREFs of sub_18012CEA0 @ 0x18012CEA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18012CEA0(__int64 a1, _DWORD *a2)
{
  ...
  else
  {
    if ( (unsigned int)dword_18019C480 > 2 )
    {
      ...
      v11 = (__int64)"SpatialAudioMetadataDictionary::GetMaximumValueLength";
      LODWORD(v10) = 255;
