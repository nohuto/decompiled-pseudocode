/*
 * XREFs of sub_1801109B4 @ 0x1801109B4
 * Callers:
...
__int64 *__fastcall sub_1801109B4(__int64 *a1, __int64 *a2, char a3, _QWORD *a4, int a5, __int64 a6)
{
  ...
  {
    sub_180113C08(0x555555555555554LL, a6);
