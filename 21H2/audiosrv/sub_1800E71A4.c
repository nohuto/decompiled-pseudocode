/*
 * XREFs of sub_1800E71A4 @ 0x1800E71A4
 * Callers:
...
__int64 __fastcall sub_1800E71A4(__int64 *a1, __int64 a2, __int64 a3, char *a4, __int64 *a5)
{
  _QWORD *v8; // r15
  __int64 v9; // r9
  __int64 v10; // rax
...
LABEL_13:
  ...
  if ( (_BYTE)a3 )
  {
    ...
    {
      LOBYTE(a3) = 1;
      *(_QWORD *)a2 = *sub_1800089E4(a1, &v36, a3, (_QWORD *)v9, v35, (__int64)a5);
      *(_BYTE *)(a2 + 8) = 1;
      return a2;
    }
    if ( *(_BYTE *)(v9 + 25) )
