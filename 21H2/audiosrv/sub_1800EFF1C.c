/*
 * XREFs of sub_1800EFF1C @ 0x1800EFF1C
 * Callers:
...
__int64 __fastcall sub_1800EFF1C(__int64 *a1, __int64 a2, __int64 *a3)
{
  __int64 v6; // r15
  __int64 v7; // rax
  ...
  *v14 = v15;
  ...
  if ( a2 != v16 )
  {
    sub_1800F0320(v18, a2, v13);
    v17 = v20;
    v16 = a1[1];
    v18 = a2;
  }
  sub_1800F0320(v18, v16, v17);
  sub_1800F14D4(a1, v13, v8, v11, v13);
  return *a1 + 8 * v6;
}
