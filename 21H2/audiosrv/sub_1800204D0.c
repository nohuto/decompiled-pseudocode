/*
 * XREFs of sub_1800204D0 @ 0x1800204D0
 * Callers:
 *     <none>
 * Callees:
 *     sinf @ 0x18007440F (sinf.c)
 *     sub_180109778 @ 0x180109778 (sub_180109778.c)
 *     sub_18012A338 @ 0x18012A338 (sub_18012A338.c)
 */

__int64 __fastcall sub_1800204D0(__int64 a1, float *a2, __m128 *a3, int a4)
{
  ...
  v4 = (unsigned __int8 *)&unk_18015B6C8;
  v5 = a3;
  if ( a2 && a3 && a4 == 272 )
  {
    if ( *((_DWORD *)a2 + 27) )
    {
      sub_18012A338(a1, v65, a2);
      v34 = (__m128)v66;
      v33 = (__m128)v65[0];
      v35 = (__m128)v75;
      v31 = (__m128)v74;
    ...
    else
    {
      *(float *)&v77 = a2[1] * 0.5;
      ...
      v61 = v9;
      v11 = sinf(v8 * 0.017453292) * v10.m128_f32[0];
      v12 = sinf((float)(90.0 - v8) * 0.017453292);
      v13 = a2[6];
      v14 = v11 / v12;
      v62 = v9;
      v63 = LODWORD(v9) ^ 0x80000000;
      v15 = sinf(v13 * 0.017453292) * v7;
      v16 = sinf((float)(90.0 - v13) * 0.017453292);
      v17 = 90.0 - a2[7];
      *(float *)&v76 = v15 / v16;
      v18 = sinf(v17 * 0.017453292) * v9;
      v60 = v18 / sinf((float)(90.0 - v17) * 0.017453292);
      v19 = (__m128)0x43340000u;
      v20 = 180.0 - a2[8];
      v21 = sinf(v20 * 0.017453292) * v7;
      v22 = sinf((float)(90.0 - v20) * 0.017453292);
      v23 = a2[10];
      v24 = v21 / v22;
      v25 = (__m128)LODWORD(v23);
      *(float *)&v64 = v24;
      v25.m128_f32[0] = sinf(v23 * 0.017453292);
      v27 = v25;
      v26 = (__m128)0x42B40000u;
      v27.m128_f32[0] = v27.m128_f32[0] * v14;
      v26.m128_f32[0] = sinf((float)(90.0 - v23) * 0.017453292);
      v28 = (__m128)*((unsigned int *)a2 + 11);
      v29 = v26;
      v29.m128_f32[0] = v26.m128_f32[0] * v14;
      v19.m128_f32[0] = (float)(180.0 - v28.m128_f32[0]) * 0.017453292;
      v30 = v19;
      v30.m128_f32[0] = sinf(v19.m128_f32[0]);
      v31 = v30;
      v31.m128_f32[0] = v30.m128_f32[0] * v14;
      v28.m128_f32[0] = (float)(v28.m128_f32[0] - 90.0) * 0.017453292;
      v32 = v28;
      v32.m128_f32[0] = sinf(v28.m128_f32[0]);
...
LABEL_24:
      v42 = _mm_xor_ps(v43, (__m128)0x80000000);
LABEL_25:
      v44 = v4[1];
      v45 = 0LL;
      if ( v4[1] )
      {
        if ( v44 == 20 )
        {
          v59 = v10;
LABEL_53:
          v45 = _mm_xor_ps(v59, (__m128)0x80000000);
        }
        else if ( v44 == 21 )
        {
          v45 = v10;
      ...
      switch ( v46 )
      {
        case 19:
          ...
          break;
        case 16:
          v47 = _mm_xor_ps(v29, (__m128)0x80000000);
          break;
        case 5:
          v47 = v34;
          break;
        case 11:
          ...
          break;
        case 6:
          v47 = _mm_xor_ps((__m128)LODWORD(v60), (__m128)0x80000000);
          break;
        default:
          switch ( v4[2] )
          {
            case 1u:
              v47 = _mm_xor_ps((__m128)(unsigned int)v76, (__m128)0x80000000);
              break;
            case 2u:
              v47 = (__m128)(unsigned int)v76;
              break;
            case 3u:
              v47 = _mm_xor_ps(v33, (__m128)0x80000000);
              break;
            case 4u:
              v47 = v33;
              break;
            case 7u:
              v47 = _mm_xor_ps((__m128)(unsigned int)v77, (__m128)0x80000000);
              break;
            case 8u:
              v47 = (__m128)(unsigned int)v77;
              break;
            case 9u:
              v47 = _mm_xor_ps(v36, (__m128)0x80000000);
              break;
            case 0xAu:
              v47 = v36;
              break;
            case 0xCu:
              v47 = _mm_xor_ps(v27, (__m128)0x80000000);
              break;
            case 0xDu:
              v47 = v27;
              break;
            case 0xEu:
              v47 = _mm_xor_ps(v31, (__m128)0x80000000);
              break;
            case 0xFu:
              v47 = v31;
              break;
            case 0x11u:
              ...
              break;
            case 0x12u:
              v47 = _mm_xor_ps(v35, (__m128)0x80000000);
              break;
            case 0x14u:
              v47 = _mm_xor_ps(v10, (__m128)0x80000000);
              break;
            case 0x15u:
              v47 = v10;
              break;
...
LABEL_37:
      ...
      *v5 = v48;
      ...
      v51 = _mm_mul_ps(v49, (__m128)xmmword_1801602A0);
      v4 += 3;
      ++v37;
      ++v38;
      v52 = _mm_or_ps(_mm_and_ps(v51, (__m128)xmmword_18015EA00), (__m128)xmmword_18015E9E0);
      v53 = _mm_cmple_ps(_mm_and_ps(v51, (__m128)xmmword_18015E9F0), (__m128)xmmword_18015E9E0);
      v54 = _mm_and_ps(_mm_sub_ps(_mm_add_ps(v51, v52), v52), v53);
      v55 = _mm_andnot_ps(v53, v51);
      v34 = (__m128)v63;
      v56 = _mm_div_ps(_mm_xor_ps(v54, v55), (__m128)xmmword_1801602A0);
  ...
  if ( (unsigned int)dword_18019C480 > 2 )
  {
    ...
    LODWORD(v77) = 263;
    sub_180109778((int)&dword_18019C480, (__int64)&v64, (__int64)&v77, (__int64)&v76);
  }
  return 2147942487LL;
}
