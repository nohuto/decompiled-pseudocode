/*
 * XREFs of sub_18005C1F0 @ 0x18005C1F0
 * Callers:
 *     sub_180074EE0 @ 0x180074EE0 (sub_180074EE0.c)
 * Callees:
...
__int64 __fastcall sub_18005C1F0(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v3; // rcx
  _QWORD *v4; // r8
  __int64 v5; // r9
  ...
  *a3 = 0LL;
  ...
  if ( (unsigned int)sub_18005C250(v3, &unk_18015BCA8, v4, v5) )
  {
    *v7 = v8;
LABEL_4:
    v9 = 0;
