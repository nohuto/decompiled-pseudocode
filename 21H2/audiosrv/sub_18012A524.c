/*
 * XREFs of sub_18012A524 @ 0x18012A524
 * Callers:
 *     sub_18012B4A0 @ 0x18012B4A0 (sub_18012B4A0.c)
 * Callees:
...
__int64 __fastcall sub_18012A524(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  _DWORD *v3; // rcx
  _QWORD *v4; // r8
  __int64 v5; // r9
  ...
  *a3 = 0LL;
  ...
  {
    if ( sub_18005C250(v3, dword_180174A90) )
    {
      *v7 = v8;
    }
    else
