/*
 * XREFs of sub_180063E28 @ 0x180063E28
 * Callers:
...
signed __int32 *__fastcall sub_180063E28(volatile signed __int32 *a1, signed __int32 *a2)
{
  ...
  *a2 = *a1;
  if ( (v2 & 6) != 6 )
  {
    ...
    while ( v9 != v7 );
    if ( !v11 )
      sub_180034380((__int64)&byte_18019E560, a1, 1, v6);
    if ( (*(_BYTE *)a2 & 2) == 0 )
