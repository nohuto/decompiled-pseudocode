/*
 * XREFs of ?FormatTransferRequest@FxUsbPipe@@QEAAJPEAVFxRequestBase@@PEAUFxRequestBuffer@@K@Z @ 0x1C0080A24
 * Callers:
        ...
        unsigned int TransferFlags)
{
  ...
  if ( !FxUsbPipe::IsType(this, WdfUsbPipeTypeBulk) && !FxUsbPipe::IsType(this, WdfUsbPipeTypeInterrupt) )
  {
    ...
    WPP_IFR_SF_qL(this->m_Globals, 2u, v9 + 10, v9 + 8, WPP_FxUsbPipeKm_cpp_Traceguids, _a1, 0xC0000010);
    return -1073741808;
  }
...
LABEL_8:
  ...
  if ( _a3 < 0 )
  {
    WPP_IFR_SF_qqd(this->m_Globals, 2u, 0xEu, 0x10u, WPP_FxUsbPipeKm_cpp_Traceguids, this, Request, _a3);
    return v16;
  }
