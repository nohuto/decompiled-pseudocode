/*
 * XREFs of imp_WdfInterruptQueueWorkItemForIsr @ 0x1C0082E90
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall imp_WdfInterruptQueueWorkItemForIsr(_WDF_DRIVER_GLOBALS *DriverGlobals, WDFINTERRUPT__ *Interrupt)
{
  ...
  if ( KeGetCurrentIrql() <= 2u )
    return FxSystemWorkItem::EnqueueWorker(v2->m_SystemWorkItem, FxInterrupt::_InterruptWorkItemCallback, v2, 0);
  else
