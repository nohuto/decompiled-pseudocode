/*
 * XREFs of imp_VfWdfRequestCompleteWithPriorityBoost @ 0x1C00C2A10
 * Callers:
 *     <none>
 * Callees:
        ...
        char PriorityBoost)
{
  ...
  LOBYTE(v10) = PriorityBoost;
  WdfVersion.Functions.pfnWdfRequestCompleteWithPriorityBoost(DriverGlobals, Request, Status, v10);
}
