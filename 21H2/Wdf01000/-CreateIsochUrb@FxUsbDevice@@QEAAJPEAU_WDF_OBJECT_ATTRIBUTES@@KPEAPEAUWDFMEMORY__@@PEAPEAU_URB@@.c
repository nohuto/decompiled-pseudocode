/*
 * XREFs of ?CreateIsochUrb@FxUsbDevice@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@KPEAPEAUWDFMEMORY__@@PEAPEAU_URB@@@Z @ 0x1C007C744
 * Callers:
...
LABEL_18:
  ...
  *(_QWORD *)&v21.UsePoolType = 0LL;
  ...
  urbLocal = 0LL;
  v11 = FxObject::Commit(v15, (_FX_DRIVER_GLOBALS *)Attributes, (void **)&hMemory, pParent, 1u);
  if ( v11 < 0 )
  {
