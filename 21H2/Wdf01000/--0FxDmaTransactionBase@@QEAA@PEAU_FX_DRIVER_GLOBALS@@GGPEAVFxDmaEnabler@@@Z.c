/*
 * XREFs of ??0FxDmaTransactionBase@@QEAA@PEAU_FX_DRIVER_GLOBALS@@GGPEAVFxDmaEnabler@@@Z @ 0x1C0058EC4
 * Callers:
 ...
 *     ?Reset@FxDmaTransactionBase@@AEAAXXZ @ 0x1C0059D74 (-Reset@FxDmaTransactionBase@@AEAAXXZ.c)
 */
        ...
        FxDmaEnabler *DmaEnabler)
{
  ...
  if ( ExtraSize )
    ...
    v9 = ObjectSize;
  FxNonPagedObject::FxNonPagedObject(this, (_FX_DRIVER_GLOBALS *)0x1401, v9, FxDriverGlobals);
