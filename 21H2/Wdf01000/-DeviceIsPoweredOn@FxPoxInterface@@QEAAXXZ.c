/*
 * XREFs of ?DeviceIsPoweredOn@FxPoxInterface@@QEAAXXZ @ 0x1C000DB44
 * Callers:
 ...
 *     ?PowerPolStoppingD0Failed@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C008B740 (-PowerPolStoppingD0Failed@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z.c)
 ...
 *     ?PowerPolStoppingResetDeviceFailed@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C008B890 (-PowerPolStoppingResetDeviceFailed@FxPkgPnp@@KA-AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z.c)
