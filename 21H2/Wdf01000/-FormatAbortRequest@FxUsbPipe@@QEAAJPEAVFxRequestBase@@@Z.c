/*
 * XREFs of ?FormatAbortRequest@FxUsbPipe@@QEAAJPEAVFxRequestBase@@@Z @ 0x1C00797EC
 * Callers:
...
__int64 __fastcall FxUsbPipe::FormatAbortRequest(FxUsbPipe *this, FxRequestBase *Request)
{
  ...
  if ( _a3 < 0 )
  {
    WPP_IFR_SF_qqd(this->m_Globals, 2u, 0xEu, 0x21u, (const _GUID *)&WPP_FxUsbPipe_cpp_Traceguids, this, Request, _a3);
    return v5;
  }
