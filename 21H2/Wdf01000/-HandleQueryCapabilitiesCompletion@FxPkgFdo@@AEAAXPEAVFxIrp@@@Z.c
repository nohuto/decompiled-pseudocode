/*
 * XREFs of ?HandleQueryCapabilitiesCompletion@FxPkgFdo@@AEAAXPEAVFxIrp@@@Z @ 0x1C000FE78
 * Callers:
...
void __fastcall FxPkgFdo::HandleQueryCapabilitiesCompletion(FxPkgFdo *this, FxIrp *Irp)
{
  ...
  unsigned int i; // ecx
  signed int v11; // edx
  signed int SystemWake; // ecx
  int DeviceWake; // ecx
  unsigned int D1Latency; // ecx
  unsigned int D2Latency; // ecx
  unsigned int D3Latency; // ecx
  unsigned int m_PnpCapsAddress; // ecx
  unsigned int m_PnpCapsUINumber; // ecx
