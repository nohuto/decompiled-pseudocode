/*
 * XREFs of ?Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C0090314
 * Callers:
 *     FxRegisterBugCheckCallback @ 0x1C009086C (FxRegisterBugCheckCallback.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C001D510 (_guard_dispatch_icall_nop.c)
 *     WdmlibProcgrpInitialize @ 0x1C00BE458 (WdmlibProcgrpInitialize.c)
 */
