/*
 * XREFs of FxLibraryCommonUnregisterClient @ 0x1C0041E9C
 * Callers:
 *     LibraryUnregisterClient @ 0x1C002E310 (LibraryUnregisterClient.c)
 * Callees:
 ...
 *     FxFreeDriverGlobals @ 0x1C0056F64 (FxFreeDriverGlobals.c)
