/*
 * XREFs of FxLibraryCommonUnregisterClient @ 0x1C00600AC
 * Callers:
 *     LibraryUnregisterClient @ 0x1C0052D00 (LibraryUnregisterClient.c)
 * Callees:
 ...
 *     FxFreeDriverGlobals @ 0x1C006B930 (FxFreeDriverGlobals.c)
...
__int64 __fastcall FxLibraryCommonUnregisterClient(_WDF_BIND_INFO *Info, _WDF_DRIVER_GLOBALS *WdfDriverGlobals)
{
  ...
  {
    v4 = 0;
    v5 = *(_QWORD *)&WdfDriverGlobals[-7].DriverName[8];
    if ( v5 )
    {
    ...
    if ( *(_WORD *)&WdfDriverGlobals[-1].DriverName[4] )
