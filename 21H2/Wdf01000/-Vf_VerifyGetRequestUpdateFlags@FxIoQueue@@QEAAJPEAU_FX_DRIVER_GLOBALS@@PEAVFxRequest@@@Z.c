/*
 * XREFs of ?Vf_VerifyGetRequestUpdateFlags@FxIoQueue@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAVFxRequest@@@Z @ 0x1C00C8640
 * Callers:
  ...
  if ( TagRequest )
  {
    if ( _FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(FxDriverGlobals, (unsigned int)FxDriverGlobals, 0xBu) )
    {
      if ( this->m_Type != WdfIoQueueDispatchManual )
      {
        ...
        WPP_IFR_SF_qL(FxDriverGlobals, 2u, v7 + 2, v7 + 13, WPP_FxIoQueue_cpp_Traceguids, _a1, 0xC0000010);
