/*
 * XREFs of imp_WdfDriverRetrieveVersionString @ 0x1C004C5F0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFSTRING__ *String)
{
  ...
  if ( result >= 0 )
  {
    ...
    v6 = L"Kernel Mode Driver Framework (verifier on) version 01.031.0";
    if ( !m_Globals->FxVerifierOn )
      v6 = L"Kernel Mode Driver Framework version 01.031.0";
