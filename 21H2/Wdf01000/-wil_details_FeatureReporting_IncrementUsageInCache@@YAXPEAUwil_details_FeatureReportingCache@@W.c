/*
 * XREFs of ?wil_details_FeatureReporting_IncrementUsageInCache@@YAXPEAUwil_details_FeatureReportingCache@@W4wil_details_ServiceReportingKind@@IPEAUwil_details_RecordUsageResult@@@Z @ 0x1C006B670
 * Callers:
        ...
        wil_details_RecordUsageResult *a4)
{
  ...
  v6 = kind == wil_details_ServiceReportingKind_PotentialUniqueUsage;
  while ( 1 )
  {
    a4->countImmediate = 0;
    v7 = exchange | 1;
