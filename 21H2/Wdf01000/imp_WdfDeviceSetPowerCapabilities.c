/*
 * XREFs of imp_WdfDeviceSetPowerCapabilities @ 0x1C00488C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z @ 0x1C0082C78 (-SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z.c)
 */
