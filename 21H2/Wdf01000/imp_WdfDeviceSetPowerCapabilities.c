/*
 * XREFs of imp_WdfDeviceSetPowerCapabilities @ 0x1C002B0D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z @ 0x1C002B27C (-SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z.c)
      ...
      else
      {
        ...
        else
        {
          ...
          if ( m_PkgPnp->m_PowerPolicyMachine.m_Owner || (_a2 = PowerCapabilities->IdealDxStateForSx, _a2 == 5) )
          {
            ...
            WPP_IFR_SF_qL(m_Globals, 2u, 0x12u, 0x30u, WPP_FxDeviceApi_cpp_Traceguids, Device, IdealDxStateForSx);
            goto LABEL_27;
          }
          v15 = 47;
        }
      }
      WPP_IFR_SF_qL(m_Globals, 2u, 0x12u, v15, WPP_FxDeviceApi_cpp_Traceguids, Device, _a2);
      goto LABEL_27;
    }
  }
  WPP_IFR_SF_qsd(m_Globals, (unsigned __int8)p_Offset, v9, 0x2Bu, traceGuid, Device, offsets[v6].Name, v9);
LABEL_27:
