/*
 * XREFs of imp_WdfDeviceWdmDispatchPreprocessedIrp @ 0x1C0013730
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall imp_WdfDeviceWdmDispatchPreprocessedIrp(
        ...
        _IRP *Irp)
{
    ...
    && (_FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(v12->m_Globals, v5, 0xBu) || m_Globals->FxVerifyDownlevel) )
  {
    ...
    if ( Flink != &v6->m_CxDeviceInfoListHead )
    {
      ...
      {
LABEL_13:
        WPP_IFR_SF_(m_Globals, 2u, 0xDu, v9, WPP_FxDeviceApiKm_cpp_Traceguids);
