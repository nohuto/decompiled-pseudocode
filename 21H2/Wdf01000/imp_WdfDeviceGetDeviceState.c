/*
 * XREFs of imp_WdfDeviceGetDeviceState @ 0x1C0047D00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z @ 0x1C0080444 (-GetPnpState@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_STATE@@@Z.c)
 */
