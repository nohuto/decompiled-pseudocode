/*
 * XREFs of ?_GetEffectiveLock@FxObject@@SAJPEAV1@PEAVIFxHasCallbacks@@EEPEAPEAVFxCallbackLock@@PEAPEAV1@@Z @ 0x1C0019730
 * Callers:
 ...
 *     ?IsPassiveCallbacks@FxObject@@QEAAEE@Z @ 0x1C006D040 (-IsPassiveCallbacks@FxObject@@QEAAEE@Z.c)
 */
