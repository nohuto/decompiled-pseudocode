/*
 * XREFs of ?OpenServiceKey@CUmdfSvcConfig@@QEAAJPEBGKPEAPEAX@Z @ 0x1C0031A0C
 * Callers:
      ...
      else
      {
        ...
        if ( Pool2 )
        {
          ...
          if ( appended >= 0 )
          {
            ...
            if ( appended >= 0 )
            {
              appended = CUmdfSvcConfig::OpenKeyHelper(this, 0LL, &regPath, v13, this->m_AutoClose, &hServiceKey);
              if ( appended >= 0 )
                *a4 = hServiceKey;
            }
          }
