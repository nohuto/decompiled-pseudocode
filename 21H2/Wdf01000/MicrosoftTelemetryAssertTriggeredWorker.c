/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C008E768
 * Callers:
 ...
 *     GetImageTuple @ 0x1C008E624 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C008EE4C (_tlgCreate1Sz_char.c)
 */
