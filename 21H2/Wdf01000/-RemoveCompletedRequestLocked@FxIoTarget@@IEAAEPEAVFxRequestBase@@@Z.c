        ...
        unsigned __int8 a3)
{
  ...
  $55631384234A24007A0779E5E472941C *v7; // rax
  _IRP *Irp; // rdx
  ...
  v7 = &Request->120;
  if ( ($55631384234A24007A0779E5E472941C *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($55631384234A24007A0779E5E472941C **)&Irp->Type != v7) )
  {
    __fastfail(3u);
  }
