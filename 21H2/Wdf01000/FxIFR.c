        ...
        ...)
{
  ...
  if ( WdfLogHeader )
  {
    ...
    if ( v14 <= 0x100 )
    {
      ...
      v16 = *((_DWORD *)WdfLogHeader + 7);
      do
      {
        v17 = v16;
        if ( *((_QWORD *)WdfLogHeader + 2) + (unsigned __int64)*((unsigned int *)WdfLogHeader + 6) < v15 + *((_QWORD *)WdfLogHeader + 2) + (unsigned __int16)v16 )
        {
        ...
        {
          HIWORD(offsetNew) = v16;
          LOWORD(offsetNew) = v15 + v16;
          v18 = v16;
        }
        v16 = _InterlockedCompareExchange((volatile signed __int32 *)WdfLogHeader + 7, offsetNew, v16);
      }
      while ( v17 != v16 );
      v19 = *((_QWORD *)WdfLogHeader + 2) + v18;
      *(_WORD *)(v19 + 8) = HIWORD(v16);
      *(_WORD *)v19 = 21068;
      *(_WORD *)(v19 + 2) = v15;
      *(_WORD *)(v19 + 10) = MessageNumber;
      v20 = (char *)(v19 + 28);
      *(_DWORD *)(v19 + 4) = _InterlockedIncrement((volatile signed __int32 *)WdfLogHeader + 8);
      va_copy((va_list)v21, va);
      *(_GUID *)(v19 + 12) = *MessageGuid;
      v22 = a6;
      if ( a6 )
      {
        do
