/*
 * XREFs of imp_WdfUsbTargetDeviceSendUrbSynchronously @ 0x1C0077230
 * Callers:
 *     <none>
 * Callees:
        ...
        IFxMemory *Urb)
{
  ...
  if ( _a3 >= 0 )
  {
    ...
    if ( _a3 >= 0 )
    {
      ...
      if ( m_Globals->FxVerboseOn )
        WPP_IFR_SF_qqd(m_Globals, 5u, 0xEu, 0xDu, WPP_FxUsbDeviceApiKm_cpp_Traceguids, UsbDevice, Urb, _a3);
    }
  }
