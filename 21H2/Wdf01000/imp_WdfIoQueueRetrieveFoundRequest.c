/*
 * XREFs of imp_WdfIoQueueRetrieveFoundRequest @ 0x1C0019880
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **OutRequest)
{
  ...
  Request = FxIoQueue::GetRequest(pQueue, 0LL, pTagRequest, ($55631384234A24007A0779E5E472941C **)&pOutputRequest);
  if ( Request >= 0 )
