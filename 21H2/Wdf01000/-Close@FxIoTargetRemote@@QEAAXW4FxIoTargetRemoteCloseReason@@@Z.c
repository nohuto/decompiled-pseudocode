/*
 * XREFs of ?Close@FxIoTargetRemote@@QEAAXW4FxIoTargetRemoteCloseReason@@@Z @ 0x1C0066C2C
 * Callers:
 ...
 *     ?Remove@FxIoTargetRemote@@UEAAXXZ @ 0x1C0067630 (-Remove@FxIoTargetRemote@@UEAAXXZ.c)
