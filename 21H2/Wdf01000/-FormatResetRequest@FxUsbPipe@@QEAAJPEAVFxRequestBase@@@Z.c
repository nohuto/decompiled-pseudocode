/*
 * XREFs of ?FormatResetRequest@FxUsbPipe@@QEAAJPEAVFxRequestBase@@@Z @ 0x1C0079B6C
 * Callers:
 ...
 *     ?AllocateUrb@FxUsbPipeRequestContext@@QEAAJPEAUUSBD_HANDLE__@@@Z @ 0x1C007960C (-AllocateUrb@FxUsbPipeRequestContext@@QEAAJPEAUUSBD_HANDLE__@@@Z.c)
 */
...
__int64 __fastcall FxUsbPipe::FormatResetRequest(FxUsbPipe *this, FxRequestBase *Request)
{
  ...
  if ( _a3 < 0 )
  {
    WPP_IFR_SF_qqd(this->m_Globals, 2u, 0xEu, 0x22u, (const _GUID *)&WPP_FxUsbPipe_cpp_Traceguids, this, Request, _a3);
    return v5;
  }
