/*
 * XREFs of ?AddSidMappingToLsa@@YAJPEAU_UNICODE_STRING@@0PEAXPEAW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z @ 0x180008994
 * Callers:
        ...
        enum _LSA_SID_NAME_MAPPING_OPERATION_ERROR *a4)
{
  ...
  *(_QWORD *)&v12[32] = a3;
  ...
  {
    v5 = v7 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_180010830, 3u, v7 | 0x10000000, 0x1DFu, v11);
  }
  v9 = Buffer;
  if ( Buffer )
  {
