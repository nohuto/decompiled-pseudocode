/*
 * XREFs of ?MapDwmVirtualAccountAndAdjustPrivileges@@YAJXZ @ 0x180008A74
 * Callers:
 ...
 *     ?LsaCollisionResult@@YA_NW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z @ 0x18000889C (-LsaCollisionResult@@YA_NW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z.c)
...
__int64 MapDwmVirtualAccountAndAdjustPrivileges(void)
{
  ...
  _SID_IDENTIFIER_AUTHORITY IdentifierAuthority; // [rsp+B0h] [rbp+47h] BYREF
...
LABEL_4:
  ...
  v4 = v2;
LABEL_18:
  MilInstrumentationCheckHR_MaybeFailFast(v1, &dword_180010840, 2u, v4, SubAuthority2, SubAuthority3);
LABEL_19:
  if ( v9 )
    RtlFreeSid(v9);
  if ( v10 )
