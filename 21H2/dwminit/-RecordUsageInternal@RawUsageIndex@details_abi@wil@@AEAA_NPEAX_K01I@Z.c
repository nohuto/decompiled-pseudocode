/*
 * XREFs of ?RecordUsageInternal@RawUsageIndex@details_abi@wil@@AEAA_NPEAX_K01I@Z @ 0x180004C80
 * Callers:
 ...
 *     memcmp_0 @ 0x18000DE97 (memcmp_0.c)
 *     memmove_0 @ 0x18000DEAF (memmove_0.c)
 */
  ...
  while ( 1 )
  {
    ...
    if ( *((_QWORD *)this + 2) )
    {
      ...
      if ( v44 > v14 && v44 != (_DWORD)v14 )
      {
        ...
        {
          Source = v14;
          memcpy_s(Buf2[0], 2uLL, &Source, 2uLL);
        }
        else if ( v43 == 2 )
        {
          memcpy_s(Buf2[0], 4uLL, &v44, 4uLL);
          v15 = v44;
        }
      }
    ...
    else
    {
      ...
      if ( v16 != v17 )
      {
        ...
        memcpy_s(Buf2[0], v19, p_Source, v18);
      }
LABEL_26:
      v10 = v53;
    }
