/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_2431961401@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18000BB58
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_2431961401>::GetCachedFeatureEnabledState(
        wil::details *a1,
        signed __int32 *a2)
{
