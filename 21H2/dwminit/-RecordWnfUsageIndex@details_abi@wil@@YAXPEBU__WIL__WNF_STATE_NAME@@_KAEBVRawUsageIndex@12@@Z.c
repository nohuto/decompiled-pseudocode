/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x180005078
 * Callers:
 ...
 *     ??$?0V_lambda_8db0ce862824541f40dfb767113f1e28_@@X@?$function@$$A6A_NPEAX_K01I@Z@wistd@@QEAA@V_lambda_8db0ce862824541f40dfb767113f1e28_@@@Z @ 0x180007C38 (--$-0V_lambda_8db0ce862824541f40dfb767113f1e28_@@X@-$function@$$A6A_NPEAX_K01I@Z@wistd@@QEAA@V_l.c)
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  _BYTE v55[128]; // [rsp+100h] [rbp+0h] BYREF
  char v56[4096]; // [rsp+180h] [rbp+80h] BYREF
  ...
  while ( 1 )
  {
    ...
    wil::details_abi::RawUsageIndex::SetBuffer((wil::details_abi::RawUsageIndex *)v32, v56, v12, (const char *)0x1000);
    if ( HIBYTE(v40) )
      break;
    v42 = 0LL;
    v54[0] = &v42;
    v54[1] = &v43;
    v54[2] = v32;
    v13 = wistd::function<bool (void *,unsigned __int64,void *,unsigned __int64,unsigned int)>::function<bool (void *,unsigned __int64,void *,unsigned __int64,unsigned int)>(
            v55,
            v54);
...
LABEL_22:
    ...
    if ( (_BYTE)v40 )
    {
      updated = wil_details_NtUpdateWnfStateData((__int64)v7, v37, (int)v38 - (int)v37, v21, v28, v31, 1);
      ...
      if ( updated )
        wil_details_NtUpdateWnfStateData((__int64)v7, v37, v38 - v37, v23, v29, 0, 0);
    }
