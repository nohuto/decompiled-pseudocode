/*
 * XREFs of ?ReportFailure_GetLastErrorHr@details@wil@@YAJPEAXIPEBD110W4FailureType@2@@Z @ 0x1800022E8
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( !LastError )
  {
    wil::details::ReportFailure_Hr(a1, a2, (__int64)"wil", 0LL, 0LL, a6, 2, 0x8007029C);
    LastError = 668;
  }
  v9 = (unsigned __int16)LastError | 0x80070000;
  if ( LastError <= 0 )
    v9 = LastError;
  wil::details::ReportFailure(a1, a2, (__int64)"wil", 0LL, 0LL, a6, 1, v9);
  return v9;
}
