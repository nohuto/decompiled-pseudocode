/*
 * XREFs of ?ReportAggregatedValues@_unnamed_type_gDwmInitTelemetryAggregator_@@QEAAXXZ @ 0x1800081DC
 * Callers:
        ...
        _unnamed_type_gDwmInitTelemetryAggregator_ *this)
{
  ...
  if ( (gDwmInitTelemetryAggregator
     || (_DWORD)qword_180014B4C
     || __PAIR64__(HIDWORD(qword_180014B4C), 0) != (unsigned int)qword_180014B54)
    ...
    && (qword_180014018 & 0x400000000000LL) == qword_180014018 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_180010E92,
      0LL,
      0LL,
      0xAu,
      &v7);
