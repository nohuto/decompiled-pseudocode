/*
 * XREFs of ?Write@UsageIndexProperty@details_abi@wil@@QEBA_NAEAPEAEPEAE@Z @ 0x180004444
 * Callers:
...
LABEL_11:
  ...
  if ( *((_WORD *)this + 4) )
  {
    memcpy_s(v4, a3 - v4, *((const void *const *)this + 3), *((unsigned __int16 *)this + 4));
    LOWORD(v11) = *((_WORD *)this + 4);
  }
  result = 1;
  *a2 = &v4[(unsigned __int16)v11];
  return result;
}
