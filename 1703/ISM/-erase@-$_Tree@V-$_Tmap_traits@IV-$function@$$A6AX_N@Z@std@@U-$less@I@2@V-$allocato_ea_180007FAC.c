...
char **__fastcall std::_Tree<std::_Tmap_traits<unsigned int,std::function<void (bool)>,std::less<unsigned int>,std::allocator<std::pair<unsigned int const,std::function<void (bool)>>>,0>>::erase(
        _QWORD *a1,
        char **a2,
        char *a3)
{
...
LABEL_81:
  ...
  v10[24] = 1;
LABEL_114:
  v35 = (char *)*((_QWORD *)a3 + 12);
  if ( v35 )
  {
    LOBYTE(v11) = v35 != a3 + 40;
    (*(void (__fastcall **)(char *, char *))(*(_QWORD *)v35 + 32LL))(v35, v11);
    *((_QWORD *)a3 + 12) = 0LL;
  }
  std::_Deallocate(a3, 1uLL, 0x68uLL);
  v36 = a1[1];
  if ( v36 )
    a1[1] = v36 - 1;
  result = a2;
