/*
 * XREFs of ?RegisterSystemCompositor@DWMInputRouter@@UEAAJU_GUID@@V?$function@$$A6AJPEAUIHitTestRequest@@PEAXPEAV?$vector@V?$ComPtr@UIInputTarget@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@std@@@std@@@Z@std@@@Z @ 0x180016540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMInputRouter::RegisterSystemCompositor(__int64 a1, _QWORD *a2, __int64 a3)
{
  ...
  v3 = a1 + 704;
  if ( *a2 == *(_QWORD *)(a1 + 720) && a2[1] == *(_QWORD *)(a1 + 728) || (v6 = 0LL, !*(_DWORD *)(v3 + 8)) )
  {
LABEL_7:
    ...
    if ( v8 < 0 )
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v9, &MinInput_Warning_CheckResult, 0, 2034, v8);
  ...
  else
  {
    ...
    v10 = -2147024809;
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v6, &MinInput_Warning_CheckResult, 0, 2030, 87);
  }
  v11 = *(_QWORD *)(a3 + 56);
  if ( v11 )
  {
