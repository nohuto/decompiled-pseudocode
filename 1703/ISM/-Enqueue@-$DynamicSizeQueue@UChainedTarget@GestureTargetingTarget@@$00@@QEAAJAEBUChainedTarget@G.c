/*
 * XREFs of ?Enqueue@?$DynamicSizeQueue@UChainedTarget@GestureTargetingTarget@@$00@@QEAAJAEBUChainedTarget@GestureTargetingTarget@@@Z @ 0x1800108B0
 * Callers:
...
LABEL_11:
  ...
  v6 = *a1;
  v7 = 2 * v2;
  v8 = (char *)operator new[](saturated_mul((unsigned int)(2 * v2), 0x770uLL));
  *a1 = v8;
  v9 = v8;
  if ( v8 )
  {
    if ( *((_DWORD *)a1 + 3) )
    {
      v12 = 1904LL * (unsigned int)(*((_DWORD *)a1 + 2) - *((_DWORD *)a1 + 3));
      memcpy_0(v8, &v6[1904 * *((unsigned int *)a1 + 3)], v12);
    ...
    memcpy_0(v9, v6, 1904 * v11);
    memset(&(*a1)[1904 * *((unsigned int *)a1 + 2)], 0, 1904LL * *((unsigned int *)a1 + 2));
