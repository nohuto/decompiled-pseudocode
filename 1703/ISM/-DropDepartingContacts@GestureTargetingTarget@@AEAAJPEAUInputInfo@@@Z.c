/*
 * XREFs of ?DropDepartingContacts@GestureTargetingTarget@@AEAAJPEAUInputInfo@@@Z @ 0x180010478
 * Callers:
...
__int64 __fastcall GestureTargetingTarget::DropDepartingContacts(GestureTargetingTarget *this, struct InputInfo *a2)
{
  ...
  if ( PointersFromInput < 0 )
  {
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v5, &MinInput_Warning_CheckResult, 4, 670, PointersFromInput);
LABEL_12:
    if ( (v6 & 0x80000000) == 0 )
      return v6;
    goto LABEL_16;
...
LABEL_14:
  ...
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
    return v6;
  Template_qqq(v5, &MinInput_Warning_CheckResult, 4, 692, 255);
LABEL_16:
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    Template_qqq(v5, &MinInput_Warning_CheckResult, 4, 648, v6);
  return v6;
}
