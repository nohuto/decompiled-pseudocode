/*
 * XREFs of ?InformTargetOfAttachedDevices@DWMInputRouter@@IEAAJPEAUIInputTarget@@@Z @ 0x1800143C0
 * Callers:
...
__int64 __fastcall DWMInputRouter::InformTargetOfAttachedDevices(DWMInputRouter *this, struct IInputTarget *a2)
{
  ...
  v3 = (**(__int64 (__fastcall ***)(struct IInputTarget *, GUID *, __int64 *))a2)(
         a2,
         &GUID_8f2e54af_e6e4_4354_a186_91990afaebb7,
         &v17);
  if ( v3 < 0 )
  {
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v4, &MinInput_Warning_CheckResult, 0, 1006, v3);
    goto LABEL_4;
  }
  if ( !v17 )
  {
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v4, &MinInput_Warning_CheckResult, 0, 1010, 255);
    goto LABEL_4;
  }
  ...
  if ( (_DWORD)v5 )
  {
    ...
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v7, &MinInput_Warning_CheckResult, 0, 1026, 14);
LABEL_4:
    ...
    for ( i = 0; i < *((_DWORD *)this + 50); ++i )
    {
      ...
      if ( *(_DWORD *)(v11 + 16LL * i) != *((_DWORD *)this + 52) )
      {
        ...
        {
          if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
            Template_qqq(v7, &MinInput_Warning_CheckResult, 0, 350, 87);
          if ( IsDebuggerPresent() )
            __debugbreak();
          __fastfail(7u);
        }
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v14, &MinInput_Warning_CheckResult, 0, 1040, v13);
  }
LABEL_31:
  v15 = v17;
  v17 = 0LL;
