/*
 * XREFs of ?SetValueForKey@?$FixedSizeMap@KPEAUIInputProcessor@@$0BAA@@@QEAAJAEBKAEBQEAUIInputProcessor@@@Z @ 0x1800071D0
 * Callers:
...
__int64 __fastcall FixedSizeMap<unsigned long,IInputProcessor *,256>::SetValueForKey(__int64 a1, int *a2, _QWORD *a3)
{
  ...
  if ( *a2 == v7 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      v8 = 133;
LABEL_4:
      Template_qqq(a1, &MinInput_Warning_CheckResult, 1, v8, v4);
    }
  }
  else
  {
