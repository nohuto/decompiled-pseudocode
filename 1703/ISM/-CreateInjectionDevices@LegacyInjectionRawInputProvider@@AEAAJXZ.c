/*
 * XREFs of ?CreateInjectionDevices@LegacyInjectionRawInputProvider@@AEAAJXZ @ 0x18006FE7C
 * Callers:
...
__int64 __fastcall LegacyInjectionRawInputProvider::CreateInjectionDevices(LegacyInjectionRawInputProvider *this)
{
  ...
  if ( *((_QWORD *)this + 14) || *((_QWORD *)this + 10) )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq((__int64)this, &MinInput_Warning_CheckResult, 0, 792, 255);
  }
  else
  {
      ...
      if ( (gdwMitConfig & 4) == 0 )
      {
        ...
        *(_DWORD *)(*((_QWORD *)this + 10) + 4LL) = 8;
        ...
        if ( v9 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          Template_qqq(v10, &MinInput_Warning_CheckResult, 0, 827, v9);
      }
    }
    else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      Template_qqq(v5, &MinInput_Warning_CheckResult, 0, 809, v4);
    }
  }
  return v6;
}
