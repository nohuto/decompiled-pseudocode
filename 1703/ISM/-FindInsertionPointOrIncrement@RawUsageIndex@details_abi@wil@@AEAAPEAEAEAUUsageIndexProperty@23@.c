/*
 * XREFs of ?FindInsertionPointOrIncrement@RawUsageIndex@details_abi@wil@@AEAAPEAEAEAUUsageIndexProperty@23@PEAEPEAX_KI@Z @ 0x18003E720
 * Callers:
...
LABEL_9:
    ...
    memcpy_s_0(*((void *const *)a2 + 2), v18, v16, v17);
    goto LABEL_9;
  }
  ...
  if ( *v25 != v26 )
  {
    ...
    *v25 = v26;
    if ( v29 == 1 )
    {
      ...
      v31 = 2LL;
LABEL_35:
      memcpy_s_0(*((void *const *)a2 + 2), v31, v30, v31);
      goto LABEL_36;
    }
    if ( v29 == 2 )
    {
    ...
    if ( v38 )
    {
      ...
      if ( Source != Source + a6 )
      {
        ...
        if ( v38 == 1 )
        {
          ...
          v34 = 2LL;
LABEL_44:
          memcpy_s_0(Destination[0], v34, p_Source, v34);
          goto LABEL_46;
        }
        if ( v38 == 2 )
        {
