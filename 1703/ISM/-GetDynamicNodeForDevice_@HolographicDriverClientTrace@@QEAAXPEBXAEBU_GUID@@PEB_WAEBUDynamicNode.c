/*
 * XREFs of ?GetDynamicNodeForDevice_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@PEB_WAEBUDynamicNodeInfo@Holographic@Internal@Windows@@@Z @ 0x18008FD20
 * Callers:
        ...
        const struct Windows::Internal::Holographic::DynamicNodeInfo *a5)
{
  ...
  const void **v12; // [rsp+68h] [rbp-21h]
  __int64 v13; // [rsp+70h] [rbp-19h]
  const struct _GUID *v14; // [rsp+78h] [rbp-11h]
  __int64 v15; // [rsp+80h] [rbp-9h]
  const wchar_t *v16; // [rsp+88h] [rbp-1h]
  int v17; // [rsp+90h] [rbp+7h]
  int v18; // [rsp+94h] [rbp+Bh]
  const struct Windows::Internal::Holographic::DynamicNodeInfo *v19; // [rsp+98h] [rbp+Fh]
  __int64 v20; // [rsp+A0h] [rbp+17h]
  int *v21; // [rsp+A8h] [rbp+1Fh]
  __int64 v22; // [rsp+B0h] [rbp+27h]
  const void *v23; // [rsp+F0h] [rbp+67h] BYREF
  ...
  if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 2) != 0 && (*(_QWORD *)(v7 + 24) & 2LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    LODWORD(v8) = 0;
    v15 = 16LL;
    v9 = (const wchar_t *)&unk_1800AE6CC;
    if ( a4 )
    {
      v9 = a4;
      v8 = -1LL;
    ...
    v21 = &v10;
    v22 = 4LL;
    TlgWrite((TraceLoggingHProvider)v7, &unk_1800BA288, 0LL, 0LL, 7u, &pData);
  }
}
