/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VHolographicDriverClientTrace@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180090EF0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  const unsigned __int16 *v107; // [rsp+1E0h] [rbp+E0h]
  int v108; // [rsp+1E8h] [rbp+E8h]
  int v109; // [rsp+1ECh] [rbp+ECh]
  int *v110; // [rsp+1F0h] [rbp+F0h]
  __int64 v111; // [rsp+1F8h] [rbp+F8h]
  const unsigned __int16 *v112; // [rsp+200h] [rbp+100h]
  int v113; // [rsp+208h] [rbp+108h]
  int v114; // [rsp+20Ch] [rbp+10Ch]
  int *v115; // [rsp+210h] [rbp+110h]
  __int64 v116; // [rsp+218h] [rbp+118h]
  void *v117; // [rsp+220h] [rbp+120h]
  int v118; // [rsp+228h] [rbp+128h]
  int v119; // [rsp+22Ch] [rbp+12Ch]
  int *v120; // [rsp+230h] [rbp+130h]
  __int64 v121; // [rsp+238h] [rbp+138h]
  const unsigned __int16 *v122; // [rsp+240h] [rbp+140h]
  int v123; // [rsp+248h] [rbp+148h]
  int v124; // [rsp+24Ch] [rbp+14Ch]
  int *v125; // [rsp+250h] [rbp+150h]
  __int64 v126; // [rsp+258h] [rbp+158h]
  const unsigned __int16 *v127; // [rsp+260h] [rbp+160h]
  int v128; // [rsp+268h] [rbp+168h]
  int v129; // [rsp+26Ch] [rbp+16Ch]
  void *v130; // [rsp+270h] [rbp+170h]
  int v131; // [rsp+278h] [rbp+178h]
  int v132; // [rsp+27Ch] [rbp+17Ch]
  int *v133; // [rsp+280h] [rbp+180h]
  __int64 v134; // [rsp+288h] [rbp+188h]
  const unsigned __int16 *v135; // [rsp+290h] [rbp+190h]
  int v136; // [rsp+298h] [rbp+198h]
  int v137; // [rsp+29Ch] [rbp+19Ch]
  void *v138; // [rsp+2A0h] [rbp+1A0h]
  ...
  if ( v5 )
  {
      ...
      && (*((_QWORD *)v24 + 3) & 0x400000000000LL) == *((_QWORD *)v24 + 3) )
    {
      ...
      v102 = v27 + 1;
      v103 = 0;
      TlgWrite(v24, &unk_1800BA6D4, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &v60);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v6 > 5u
      && (*((_QWORD *)v6 + 2) & 0x600000000000LL) != 0
      && (*((_QWORD *)v6 + 3) & 0x600000000000LL) == *((_QWORD *)v6 + 3) )
    {
      v7 = &word_1800ACD3A;
      ...
      v139 = 2 * v9 + 2;
      v140 = 0;
      TlgWrite(v6, &unk_1800BA5CF, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x10u, &pData);
    }
  }
