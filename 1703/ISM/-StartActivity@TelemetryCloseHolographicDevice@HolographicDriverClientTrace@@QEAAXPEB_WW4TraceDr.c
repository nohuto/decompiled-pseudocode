/*
 * XREFs of ?StartActivity@TelemetryCloseHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x1800936D4
 * Callers:
  ...
  *(_DWORD *)v8 = 1;
  ...
  if ( *(_DWORD *)v13 > 5u && (*((_QWORD *)v13 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( Local == *((struct HolographicDriverClientTrace **)v13 + 3) )
    {
      ...
      LODWORD(Local) = TlgWrite(v13, &unk_1800BB502, (LPCGUID)(v18 + 8), v19, 6u, &pData);
    }
  }
  if ( !*(_DWORD *)(a1 + 32) )
  {
