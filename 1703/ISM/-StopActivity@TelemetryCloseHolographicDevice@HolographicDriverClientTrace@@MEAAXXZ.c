/*
 * XREFs of ?StopActivity@TelemetryCloseHolographicDevice@HolographicDriverClientTrace@@MEAAXXZ @ 0x180093BB0
 * Callers:
 *     <none>
 * Callees:
        ...
        HolographicDriverClientTrace::TelemetryCloseHolographicDevice *this)
{
  ...
  EVENT_DATA_DESCRIPTOR v74; // [rsp+160h] [rbp+60h] BYREF
  PSRWLOCK *v75; // [rsp+180h] [rbp+80h]
  __int64 v76; // [rsp+188h] [rbp+88h]
  DWORD *v77; // [rsp+190h] [rbp+90h]
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x400000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v72 = 2 * v9 + 2;
      v73 = 0;
      TlgWrite(v6, &unk_1800BB64B, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v24 + 3) & 0x400000000000LL) == *((_QWORD *)v24 + 3) )
    {
      ...
      v32 = CurrentThreadId;
      v77 = &v32;
      TlgWrite(v24, &unk_1800BB762, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v74);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
