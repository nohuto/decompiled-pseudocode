/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x180042FB4
 * Callers:
 ...
 *     ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x18003F1B8 (--0UsageIndexes@details_abi@wil@@QEAA@XZ.c)
        ...
        _QWORD *a2)
{
  ...
  HANDLE v26[2]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  *a2 = 0LL;
  ...
  v25 = 0LL;
  v9 = 0LL;
  ValueInternal = wil::details_abi::SemaphoreValue::TryGetValueInternal((char *)Buffer, v10, &v25, v11);
  v6 = ValueInternal;
  if ( ValueInternal >= 0 )
  {
    v9 = v25;
...
LABEL_31:
  ...
  if ( !v8 )
  {
    *a2 = 0LL;
    ...
    v16 = HeapAlloc(ProcessHeap, 8u, 0xE8uLL);
    v17 = v16;
    if ( v16 )
    {
      *(_OWORD *)v26 = 0LL;
      v18 = wil::details_abi::SemaphoreValue::CreateFromPointer(
              (wil::details_abi::SemaphoreValue *)v26,
              (char *)Buffer,
      ...
      if ( v18 >= 0 )
      {
        ...
        *(_DWORD *)v17 = 1;
        ...
        v17[2] = v26[0];
        v17[3] = v26[1];
        memset(v17 + 4, 0, 0xC8uLL);
        v17[4] = 0LL;
        wil::details_abi::UsageIndexes::UsageIndexes((wil::details_abi::UsageIndexes *)(v17 + 5));
        v6 = 0;
        *a2 = v17;
      }
      else
