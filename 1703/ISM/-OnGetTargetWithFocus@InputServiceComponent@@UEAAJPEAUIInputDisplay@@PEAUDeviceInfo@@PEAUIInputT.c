/*
 * XREFs of ?OnGetTargetWithFocus@InputServiceComponent@@UEAAJPEAUIInputDisplay@@PEAUDeviceInfo@@PEAUIInputTarget@@PEAUInputTargetingDecision@@@Z @ 0x1800253A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputTargetingDecision *a5)
{
  ...
  if ( a5 )
  {
             ...
             v13) >= 0 )
      {
        if ( !v13[0] )
        {
          if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
            Template_qqq(0LL, &MinInput_Warning_CheckResult, 0, 131, 255);
    ...
    else
    {
      *(_DWORD *)a5 = 0;
      ...
      if ( v11 )
        (*(void (__fastcall **)(_QWORD *, _QWORD, struct DeviceInfo *, struct IInputTarget *))(*v11 + 16LL))(
          v11,
          *v11,
          a3,
          a4);
  ...
  else
  {
    v6 = -2147024809;
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq((__int64)this, &MinInput_Warning_CheckResult, 0, 118, 87);
  }
  return v6;
}
