/*
 * XREFs of ?SetClosestInteractiveBounds@DWMCursorBroker@@UEAAJUCursorIdInfo@@UCursorClosestInteractiveBoundsRect@@@Z @ 0x18001E570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMCursorBroker::SetClosestInteractiveBounds(__int64 a1, __int64 a2, __int128 *a3)
{
  ...
  *((_QWORD *)&v7 + 1) = *(_QWORD *)(a2 + 8);
  ...
  {
    Template_qqq(v5, &MinInput_Warning_CheckResult, 0, 276, ValueForKey);
  }
  return 0LL;
}
