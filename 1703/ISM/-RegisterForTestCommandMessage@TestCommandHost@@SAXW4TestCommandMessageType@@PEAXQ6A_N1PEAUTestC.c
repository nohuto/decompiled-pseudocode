/*
 * XREFs of ?RegisterForTestCommandMessage@TestCommandHost@@SAXW4TestCommandMessageType@@PEAXQ6A_N1PEAUTestCommandMessageDataHeader@@@ZAEAVCommandRegistrationToken@1@@Z @ 0x180009B18
 * Callers:
...
__int64 __fastcall TestCommandHost::RegisterForTestCommandMessage(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    return wil::details::in1diag3::Log_CaughtException(retaddr, (void *)0x3E, v8, v9);
  }
  return result;
}
