/*
 * XREFs of ?SetHapticsWaveForm@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@GE@Z @ 0x180067C3C
 * Callers:
 *     ?StartContinuousBuzz@SpatialInteractionDevice@@UEAAJE@Z @ 0x180064880 (-StartContinuousBuzz@SpatialInteractionDevice@@UEAAJE@Z.c)
 *     ?StopHapticsFeedback@SpatialInteractionDevice@@UEAAJXZ @ 0x180064890 (-StopHapticsFeedback@SpatialInteractionDevice@@UEAAJXZ.c)
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  PCHAR nNumberOfBytesToWrite; // [rsp+30h] [rbp-18h] BYREF
  ...
  v11 = (_BYTE *)*((_QWORD *)this + 31);
  LODWORD(nNumberOfBytesToWrite) = *((unsigned __int16 *)this + 55);
...
LABEL_10:
  ...
  if ( WriteFile(v16, lpBuffer, (DWORD)nNumberOfBytesToWrite, &NumberOfBytesWritten, (LPOVERLAPPED)((char *)this + 48))
    || GetLastError() == 997
