/*
 * XREFs of ?Add@DragRecognizer@@UEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x1800391B0
 * Callers:
 *     <none>
 * Callees:
 *     ?Reset@DragRecognizer@@UEAAXPEBVGestureSession@@@Z @ 0x1800392E0 (-Reset@DragRecognizer@@UEAAXPEBVGestureSession@@@Z.c)
 *     ?AddPoint@DragRecognizer@@AEAAXPEBVGestureSession@@PEBUtagPOINT@@_N@Z @ 0x1800393C8 (-AddPoint@DragRecognizer@@AEAAXPEBVGestureSession@@PEBUtagPOINT@@_N@Z.c)
 */
