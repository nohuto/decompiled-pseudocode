 ...
 *     ?_Make_iter@?$_Hash@V?$_Umap_traits@KPEAVControllerProcessor@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKPEAVControllerProcessor@@@std@@@3@$0A@@std@@@std@@QEBA?AV?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKPEAVControllerProcessor@@@std@@@std@@@std@@@2@V?$_List_unchecked_const_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBKPEAVControllerProcessor@@@std@@@std@@@std@@U_Iterator_base0@2@@2@@Z @ 0x18000A60C (-_Make_iter@-$_Hash@V-$_Umap_traits@KPEAVControllerProcessor@@V-$_Uhash_compare@KU-$hash@K@std@@.c)
 *     _CxxThrowException_0 @ 0x18009E220 (_CxxThrowException_0.c)
 */

void __fastcall __noreturn std::_Hash_std::_Umap_traits_enum_TestCommandMessageType_std::pair_void_____ptr64_bool____cdecl___void_____ptr64_TestCommandMessageDataHeader_____ptr64___std::_Uhash_compare_enum_TestCommandMessageType_std::hash_enum_TestCommandMessageType__std::equal_to_enum_TestCommandMessageType____std::allocator_std::pair_enum_TestCommandMessageType_const__std::pair_void_____ptr64_bool____cdecl___void_____ptr64_TestCommandMessageDataHeader_____ptr64_______0___::_Insert_std::pair_enum_TestCommandMessageType_const__std::pair_void_____ptr64_bool____cdecl___void_____ptr64_TestCommandMessageDataHeader_____ptr64_________ptr64_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_enum_TestCommandMessageType_const__std::pair_void_____ptr64_bool____cdecl___void_____ptr64_TestCommandMessageDataHeader_____ptr64_____________::_1_::catch_117(
        __int64 a1,
        __int64 a2)
{
  char **iter; // rax
