        ...
        char **a1)
{
  ...
  for ( i = v2; !*((_BYTE *)i + 25); v2 = i )
  {
    ...
    v2[4] = 0LL;
    std::_Deallocate((char *)v2, 1uLL, 0x38uLL);
  }
  *((_QWORD *)*a1 + 1) = *a1;
  *(_QWORD *)*a1 = *a1;
  *((_QWORD *)*a1 + 2) = *a1;
