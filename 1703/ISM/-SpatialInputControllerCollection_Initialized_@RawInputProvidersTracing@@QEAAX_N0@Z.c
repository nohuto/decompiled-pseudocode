/*
 * XREFs of ?SpatialInputControllerCollection_Initialized_@RawInputProvidersTracing@@QEAAX_N0@Z @ 0x180076090
 * Callers:
        ...
        char a3)
{
  ...
  char v11; // [rsp+A8h] [rbp+10h] BYREF
  ...
  if ( *(_DWORD *)v3 > 4u && (*(_BYTE *)(v3 + 16) & 2) != 0 && (*(_QWORD *)(v3 + 24) & 2LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v6 = 1;
    v9 = 1;
    TlgWrite((TraceLoggingHProvider)v3, &unk_1800B9D8E, 0LL, 0LL, 4u, &pData);
  }
}
