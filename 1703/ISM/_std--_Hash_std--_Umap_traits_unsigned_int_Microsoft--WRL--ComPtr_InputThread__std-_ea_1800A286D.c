...
void __fastcall __noreturn std::_Hash_std::_Umap_traits_unsigned_int_Microsoft::WRL::ComPtr_InputThread__std::_Uhash_compare_unsigned_int_std::hash_unsigned_int__std::equal_to_unsigned_int____std::allocator_std::pair_unsigned_int_const__Microsoft::WRL::ComPtr_InputThread______0___::_Insert_std::pair_unsigned_int_const__Microsoft::WRL::ComPtr_InputThread________ptr64_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_unsigned_int_const__Microsoft::WRL::ComPtr_InputThread____________::_1_::catch_117(
        __int64 a1,
        __int64 a2)
{
  char **iter; // rax
