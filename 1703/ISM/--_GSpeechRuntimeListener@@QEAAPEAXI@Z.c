/*
 * XREFs of ??_GSpeechRuntimeListener@@QEAAPEAXI@Z @ 0x180054730
 * Callers:
 ...
 *     ??1?$unique_ptr@VSpeechRuntimeListener@@U?$default_delete@VSpeechRuntimeListener@@@std@@@std@@QEAA@XZ @ 0x18005460C (--1-$unique_ptr@VSpeechRuntimeListener@@U-$default_delete@VSpeechRuntimeListener@@@std@@@std@@QE.c)
 * Callees:
  ...
  if ( *((_DWORD *)this + 6) )
  {
    (*(void (__fastcall **)(_QWORD, const wchar_t *, __int64))(**((_QWORD **)this + 1) + 48LL))(
      *((_QWORD *)this + 1),
      ...
      1LL);
    (*(void (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)this + 144LL))(*(_QWORD *)this, *((unsigned int *)this + 6));
  }
  v2 = *((_QWORD *)this + 1);
  if ( v2 )
  {
