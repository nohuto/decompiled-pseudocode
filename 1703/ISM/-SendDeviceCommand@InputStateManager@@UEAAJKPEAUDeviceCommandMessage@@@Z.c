/*
 * XREFs of ?SendDeviceCommand@InputStateManager@@UEAAJKPEAUDeviceCommandMessage@@@Z @ 0x180006FC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
      ...
      v13 = 785;
LABEL_20:
      Template_qqq(v12, &MinInput_Warning_CheckResult, 1, v13, ValueForKey);
      goto LABEL_21;
    }
  }
  return v9;
