/*
 * XREFs of ?ReportFailure_CaughtExceptionMsg@details@wil@@YAJPEAXIPEBD110W4FailureType@2@1PEAD@Z @ 0x18006ED9C
 * Callers:
        ...
        va_list a9)
{
  ...
  return wil::details::ReportFailure_CaughtExceptionCommon(a1, a2, a3, v12, v14, a6, 3, v17, v15, v16);
}
