/*
 * XREFs of ?RegisterWaitHandler@RIMDeviceCollection@@AEAAJPEAXP6AJ0K0@Z0@Z @ 0x180073258
 * Callers:
        ...
        void *a4)
{
  ...
  if ( v13 )
  {
    ...
    if ( v7 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      v10 = 1238;
LABEL_10:
      Template_qqq(v8, &MinInput_Warning_CheckResult, 2, v10, v7);
    }
  }
  else
  {
    v9 = -2147418113;
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v8, &MinInput_Warning_CheckResult, 2, 1232, 255);
  }
LABEL_11:
  v11 = v13;
  v13 = 0LL;
