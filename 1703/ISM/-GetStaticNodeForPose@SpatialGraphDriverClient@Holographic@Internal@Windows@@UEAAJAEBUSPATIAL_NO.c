/*
 * XREFs of ?GetStaticNodeForPose@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAAJAEBUSPATIAL_NODE_ID@@AEBUXMFLOAT4X3@DirectX@@PEAU5@@Z @ 0x180089240
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SPATIAL_NODE_ID *a4)
{
  ...
  DWORD v18; // [rsp+40h] [rbp-49h] BYREF
  ...
  *(_OWORD *)a4 = 0uLL;
  ...
  v8 = *(_OWORD *)a2;
  v9 = (Windows::Internal::Holographic::HolographicDriverHandleWrapper *)*((_QWORD *)this + 7);
  v10 = *(_OWORD *)a3;
  v18 = 0;
  InBuffer[0] = v8;
  v11 = *((_OWORD *)a3 + 1);
