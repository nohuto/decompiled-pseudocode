/*
 * XREFs of ?QueryInterface@?$RuntimeClass@U?$InterfaceList@UIDisplayBinding@@U?$InterfaceList@UIInputDisplay@@U?$InterfaceList@UIPropertyChangedListener@Input@@U?$InterfaceList@UIInputDisplayOrientationListener@@VNil@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$01@34@$00$0A@$0A@@Details@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180019B70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
