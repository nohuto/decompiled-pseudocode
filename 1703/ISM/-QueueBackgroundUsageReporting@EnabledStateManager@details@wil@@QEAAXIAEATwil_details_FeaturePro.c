/*
 * XREFs of ?QueueBackgroundUsageReporting@EnabledStateManager@details@wil@@QEAAXIAEATwil_details_FeaturePropertyCache@@@Z @ 0x18003FF98
 * Callers:
 *     ?RecordFeatureUsageCallback@details@wil@@YAXIPEATwil_details_FeaturePropertyCache@@PEAUwil_details_RecordUsageResult@@@Z @ 0x180040670 (-RecordFeatureUsageCallback@details@wil@@YAXIPEATwil_details_FeaturePropertyCache@@PEAUwil_detai.c)
 * Callees:
    ...
    if ( !v6 )
    {
      ...
      if ( wil::details_abi::heap_buffer::ensure((wil::details_abi::heap_buffer *)&pv[5], 0x10uLL) )
      {
        ...
        if ( Ptr < v8 )
          ...
          v9 = 0LL;
        memcpy_s_0(Ptr, v9, &Source, 0x10uLL);
