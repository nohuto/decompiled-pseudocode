/*
 * XREFs of ?SetValueForKey@?$DynamicSizeMap@UtagMsgRoutingInfo@@PEAUIInputTarget@@$00@@QEAAJAEBUtagMsgRoutingInfo@@AEBQEAUIInputTarget@@@Z @ 0x1800189CC
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  if ( (unsigned __int8)operator==(a2, a1 + 16) )
  {
    ...
    v11 = 153;
LABEL_4:
    Template_qqq(v9, &MinInput_Warning_CheckResult, 0, v11, v10);
LABEL_5:
...
LABEL_16:
  ...
  v7 = -2147467259;
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    Template_qqq(v9, &MinInput_Warning_CheckResult, 0, 180, 5);
  return v7;
}
