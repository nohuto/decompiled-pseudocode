/*
 * XREFs of ?IsSameByInputDest@MPCHFXInputTarget@@UEBA_NAEBUtagINPUTDEST@@@Z @ 0x180086210
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall MPCHFXInputTarget::IsSameByInputDest(MPCHFXInputTarget *this, const struct tagINPUTDEST *a2)
{
  int v3; // eax
  char v4; // bl
  __int64 v5; // rcx
