/*
 * XREFs of ?SpatialGraphNodeReferenceFactoryCreated_@HolographicDriverClientTrace@@QEAAXPEBX@Z @ 0x18008F1F0
 * Callers:
        ...
        const void *a2)
{
  ...
  if ( *(_DWORD *)v2 > 4u && (*(_BYTE *)(v2 + 16) & 2) != 0 && (*(_QWORD *)(v2 + 24) & 2LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v4 = &v7;
    v5 = 8;
    TlgWrite((TraceLoggingHProvider)v2, &unk_1800BAF88, 0LL, 0LL, 3u, &pData);
  }
}
