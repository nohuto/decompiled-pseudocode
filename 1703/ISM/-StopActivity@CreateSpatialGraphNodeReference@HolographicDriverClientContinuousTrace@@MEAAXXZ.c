/*
 * XREFs of ?StopActivity@CreateSpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@MEAAXXZ @ 0x180091E10
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u )
    {
      ...
      v84 = v9 + 1;
      v85 = 0;
      TlgWrite(v6, &unk_1800BA98D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 5u )
    {
      ...
      v35 = CurrentThreadId;
      v89 = &v35;
      TlgWrite(v26, &unk_1800BAAC7, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v86);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
