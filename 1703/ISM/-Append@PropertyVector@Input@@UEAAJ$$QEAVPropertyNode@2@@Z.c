/*
 * XREFs of ?Append@PropertyVector@Input@@UEAAJ$$QEAVPropertyNode@2@@Z @ 0x180028560
 * Callers:
 ...
 *     ?Append@?$PropertyVectorModifiedAdapter@V?$ModifiedNotifier@VPropertyVector@Input@@@Input@@@Input@@UEAAJ$$QEAVPropertyNode@2@@Z @ 0x18001CC00 (-Append@-$PropertyVectorModifiedAdapter@V-$ModifiedNotifier@VPropertyVector@Input@@@Input@@@Inpu.c)
 * Callees:
