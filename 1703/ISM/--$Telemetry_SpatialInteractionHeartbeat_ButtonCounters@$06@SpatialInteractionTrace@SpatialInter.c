/*
 * XREFs of ??$Telemetry_SpatialInteractionHeartbeat_ButtonCounters@$06@SpatialInteractionTrace@SpatialInteractionDevices@@SAXAEBU_GUID@@GGGIAEAY06$$CBW4ButtonFlags@1@AEAY06$$CBI@Z @ 0x18009B458
 * Callers:
        ...
        __int64 a7)
{
  ...
  __int16 *v16; // [rsp+68h] [rbp-41h]
  int v17; // [rsp+70h] [rbp-39h]
  int v18; // [rsp+74h] [rbp-35h]
  __int16 *v19; // [rsp+78h] [rbp-31h]
  ...
  void *v28; // [rsp+A8h] [rbp-1h]
  int v29; // [rsp+B0h] [rbp+7h]
  int v30; // [rsp+B4h] [rbp+Bh]
  __int64 v31; // [rsp+B8h] [rbp+Fh]
  int v32; // [rsp+C0h] [rbp+17h]
  int v33; // [rsp+C4h] [rbp+1Bh]
  __int16 v34; // [rsp+100h] [rbp+57h] BYREF
  __int16 v35; // [rsp+108h] [rbp+5Fh] BYREF
  __int16 v36; // [rsp+110h] [rbp+67h] BYREF
  ...
  if ( v9 )
  {
    if ( *v9 )
    {
      ...
      if ( *(_DWORD *)v10 > 5u && (*((_QWORD *)v10 + 2) & 0x400000000000LL) != 0 )
      {
        v8 = (struct SpatialInteractionDevices::SpatialInteractionTrace *)(*((_QWORD *)v10 + 3) & 0x400000000000LL);
        if ( v8 == *((struct SpatialInteractionDevices::SpatialInteractionTrace **)v10 + 3) )
        {
          ...
          v29 = 28;
          v32 = 28;
          LODWORD(v8) = TlgWrite(v10, &unk_1800BB90B, 0LL, 0LL, 9u, &pData);
        }
      }
    }
  }
