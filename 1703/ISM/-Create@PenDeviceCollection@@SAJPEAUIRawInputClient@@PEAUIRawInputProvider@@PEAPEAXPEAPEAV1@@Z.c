/*
 * XREFs of ?Create@PenDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x180074348
 * Callers:
...
LABEL_13:
  ...
  {
    Template_qqq(v13, &MinInput_Warning_CheckResult, 0, 38, v11);
  }
  if ( v11 < 0 )
