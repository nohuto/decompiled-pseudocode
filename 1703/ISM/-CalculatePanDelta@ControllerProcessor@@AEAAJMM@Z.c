/*
 * XREFs of ?CalculatePanDelta@ControllerProcessor@@AEAAJMM@Z @ 0x180033CF4
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculatePanDelta(ControllerProcessor *this, float a2, float a3)
{
  ...
  if ( v6 > 0.00000011920929 || (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(a2) & _xmm) > 0.00000011920929 )
  {
    ...
    if ( v8 == 0.0
      ...
      || *(float *)&dword_1800D38C8 >= v10
      || v10 >= (float)(1.0 / *(float *)&dword_1800D38C8) )
    {
    ...
    v12 = v9 + *((float *)this + 95);
    *((float *)this + 94) = v8 + *((float *)this + 94);
    *((float *)this + 95) = v12;
  }
  return 0LL;
}
