/*
 * XREFs of ?OnTouch@ClickRecognizer@@AEAAXPEBVGestureSession@@KKPEBUTouchContactInfo@@@Z @ 0x180038A34
 * Callers:
 ...
 * Callees:
 *     ?ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z @ 0x180038B14 (-ChangeTapAndHoldState@ClickRecognizer@@AEAAJPEAK@Z.c)
        ...
        const struct TouchContactInfo *a5)
{
  ...
  *((_DWORD *)this + 32) = a3;
  ...
  else if ( (unsigned int)(((int)(*((_DWORD *)this + 5) << 28) >> 28) - 1) <= 3 )
  {
    ...
    v7 = (int)(*((_QWORD *)a2 + 166) - *((_DWORD *)a5 + 1));
    if ( (HIDWORD(v7) ^ (unsigned int)v7) - HIDWORD(v7) > v6
      || abs32(HIDWORD(*((_QWORD *)a2 + 166)) - *((_DWORD *)a5 + 2)) > v6 )
    {
      ClickRecognizer::CancelTapAndHold(this);
    }
