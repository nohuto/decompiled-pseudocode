        ...
        char *a5)
{
  ...
  try
  {
    ...
    if ( *((_DWORD *)v11 + 8) >= *a4 )
    {
      std::_Deallocate(a5, 1uLL, 0x790uLL);
      *(_QWORD *)a2 = v11;
      *(_BYTE *)(a2 + 8) = 0;
    }
    else
