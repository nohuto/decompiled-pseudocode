/*
 * XREFs of ?GetThreadIdFromViewId@ViewHelper@@SAKI@Z @ 0x18002BAC0
 * Callers:
...
__int64 __fastcall ViewHelper::GetThreadIdFromViewId(unsigned int a1)
{
  unsigned int v2; // edi
  _QWORD *v3; // rax
  __int64 v4; // rcx
  ...
  if ( v16 )
  {
    ...
    if ( WindowA >= 0 )
    {
      ...
      if ( v17 )
      {
        v10 = (*(__int64 (__fastcall **)(__int64 *, unsigned int *))(*v17 + 112))(v17, &v15);
        if ( v10 < 0 )
        {
    ...
    else
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v7, &MinInput_Warning_CheckResult, 0, 170, WindowA);
      if ( !v17 )
        goto LABEL_16;
      v8 = *v17;
    }
