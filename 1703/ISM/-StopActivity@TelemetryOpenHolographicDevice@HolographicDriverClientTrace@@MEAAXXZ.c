/*
 * XREFs of ?StopActivity@TelemetryOpenHolographicDevice@HolographicDriverClientTrace@@MEAAXXZ @ 0x180091550
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v6 + 3) & 0x400000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v73 = 2 * v9 + 2;
      v74 = 0;
      TlgWrite(v6, &unk_1800BA7FC, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v24 + 3) & 0x400000000000LL) == *((_QWORD *)v24 + 3) )
    {
      ...
      v33 = CurrentThreadId;
      v78 = &v33;
      TlgWrite(v24, &unk_1800BA912, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v75);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
