/*
 * XREFs of ?OnDeviceRemoval@ConsumerControlDeviceCollection@@MEAAJK@Z @ 0x18007CE80
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a2)
{
  ...
  __int128 Block; // [rsp+48h] [rbp-7B0h] BYREF
  _BYTE v18[1888]; // [rsp+60h] [rbp-798h] BYREF
  unsigned int v19; // [rsp+808h] [rbp+10h] BYREF
    ...
    if ( DWORD2(Block) )
    {
      while ( 1 )
      {
        ...
        ValueForKey = ConsumerControlDeviceCollection::CreateButtonInfo(
                        (ConsumerControlDeviceCollection *)(unsigned __int16)v11[v10],
                        a2,
                        TickCount,
                        PerformanceCount,
                        v11[v10],
