        ...
        __int64 a3)
{
  ...
  if ( *a2 == *(_QWORD *)(a1 + 16) && a2[1] == *(_QWORD *)(a1 + 24) )
  {
    ...
    v10 = 153;
LABEL_5:
    Template_qqq(a1, &MinInput_Warning_CheckResult, 0, v10, v9);
LABEL_6:
  ...
  if ( *(_DWORD *)(v5 + 12) == v12 )
  {
    ...
    *(_QWORD *)v5 = v6;
    if ( !v6 )
    {
      ...
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
        goto LABEL_6;
      Template_qqq((__int64)v21, &MinInput_Warning_CheckResult, 0, 386, 14);
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
        goto LABEL_6;
      v10 = 185;
      goto LABEL_5;
