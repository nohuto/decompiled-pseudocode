/*
 * XREFs of ?QueueInput@MPCRawInputProvider@@QEAAJAEAUInputInfo@@@Z @ 0x1800542B8
 * Callers:
...
__int64 __fastcall MPCRawInputProvider::QueueInput(MPCRawInputProvider *this, struct InputInfo *a2)
{
  ...
  std::vector<InputInfo>::emplace_back<InputInfo &>((char *)this + 120, a2);
  if ( this != (MPCRawInputProvider *)-144LL )
