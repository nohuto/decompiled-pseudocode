/*
 * XREFs of ?OnIRInputReceived@WGIController@@UEAAJ_KW4GipIRCode@Internal@Input@Gaming@Windows@@W4GipIRStatus@3456@@Z @ 0x180062A40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall WGIController::OnIRInputReceived(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  _DWORD *v23; // rax
  DWORD TickCount; // eax
  _QWORD v26[236]; // [rsp+30h] [rbp-D0h] BYREF
  LARGE_INTEGER PerformanceCount; // [rsp+7A0h] [rbp+6A0h] BYREF

  if ( !*(_QWORD *)(a1 + 96) )
  {
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(a1, &MinInput_Warning_CheckResult, 0, 325, 255);
