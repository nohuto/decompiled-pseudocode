/*
 * XREFs of ?GetWindowId@MPCHFXInputTarget@@UEAAJPEA_K@Z @ 0x180086D00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCHFXInputTarget::GetWindowId(MPCHFXInputTarget *this, unsigned __int64 *a2)
{
  int v3; // eax
  unsigned int v4; // ebx
  __int64 v5; // rcx
