/*
 * XREFs of ?QueryInterface@ControllerNavigationManager@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180030DA0
 * Callers:
 *     ?QueryInterface@ControllerNavigationManager@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800317B0 (-QueryInterface@ControllerNavigationManager@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
