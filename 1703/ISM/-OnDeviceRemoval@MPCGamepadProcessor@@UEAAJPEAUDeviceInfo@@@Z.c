/*
 * XREFs of ?OnDeviceRemoval@MPCGamepadProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x18002D600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCGamepadProcessor::OnDeviceRemoval(MPCGamepadProcessor *this, struct DeviceInfo *a2)
{
  ...
  if ( v4 < 0 )
  {
    ...
    JUMPOUT(0x18002D654LL);
  }
  return (*(__int64 (__fastcall **)(_QWORD, struct DeviceInfo *))(**((_QWORD **)this + 21) + 40LL))(
           *((_QWORD *)this + 21),
           a2);
}
