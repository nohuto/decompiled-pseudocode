        ...
        char *a5)
{
  ...
  try
  {
    ...
    if ( *((_DWORD *)v11 + 7) >= *a4 )
    {
      std::_Deallocate(a5, 1uLL, 0x30uLL);
      *(_QWORD *)a2 = v11;
      *(_BYTE *)(a2 + 8) = 0;
    }
    else
