/*
 * XREFs of ?SetInteractionObject@MPCHFXInputTarget@@UEAAJI@Z @ 0x1800868A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCHFXInputTarget::SetInteractionObject(MPCHFXInputTarget *this, unsigned int a2)
{
  int v3; // eax
  unsigned int v4; // ebx
  __int64 v5; // rcx
