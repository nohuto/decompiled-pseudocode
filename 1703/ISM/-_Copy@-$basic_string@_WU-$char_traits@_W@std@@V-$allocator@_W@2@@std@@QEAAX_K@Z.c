/*
 * XREFs of ?_Copy@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAX_K@Z @ 0x1800669E0
 * Callers:
 ...
 *     ?_Xlen@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@SAXXZ @ 0x1800669CC (-_Xlen@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@SAXXZ.c)
