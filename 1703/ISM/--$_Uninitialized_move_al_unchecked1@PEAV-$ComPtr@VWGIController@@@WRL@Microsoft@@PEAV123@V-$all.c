/*
 * XREFs of ??$_Uninitialized_move_al_unchecked1@PEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@PEAV123@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@@std@@YAPEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@PEAV123@00AEAU?$_Wrap_alloc@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@@0@U_General_ptr_iterator_tag@0@U_Any_tag@0@@Z @ 0x180061C90
 * Callers:
...
volatile signed __int64 **__fastcall std::_Uninitialized_move_al_unchecked1<Microsoft::WRL::ComPtr<WGIController> *,Microsoft::WRL::ComPtr<WGIController> *,std::allocator<Microsoft::WRL::ComPtr<WGIController>>>(
