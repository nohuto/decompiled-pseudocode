/*
 * XREFs of ?Add@GestureSession@@UEAAJKKKPEBUTouchContactInfo@@@Z @ 0x1800367B0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct TouchContactInfo *a5)
{
  ...
  else if ( a4 )
  {
    ...
    TouchContactFilter::RecordContacts((GestureSession *)((char *)this + 880), a4, a5);
    if ( (v6 & 1) != 0 )
      *((_QWORD *)this + 166) = *(_QWORD *)((char *)this + 1292);
    v10 = v6;
    v11 = 0;
    for ( i = (_QWORD *)((char *)this + 824); ; ++i )
    {
