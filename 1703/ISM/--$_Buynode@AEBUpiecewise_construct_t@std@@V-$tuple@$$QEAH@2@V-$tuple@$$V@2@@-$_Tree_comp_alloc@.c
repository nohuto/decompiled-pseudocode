 ...
 * Callees:
 *     ?_Buynode0@?$_Tree_comp_alloc@V?$_Tmap_traits@HUCursorGlyphInfo@@U?$less@H@std@@V?$allocator@U?$pair@$$CBHUCursorGlyphInfo@@@std@@@3@$0A@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CBHUCursorGlyphInfo@@@std@@PEAX@2@XZ @ 0x180022358 (-_Buynode0@-$_Tree_comp_alloc@V-$_Tmap_traits@HUCursorGlyphInfo@@U-$less@H@std@@V-$allocator@U-$.c)
        ...
        _DWORD **a3)
{
  ...
  *(_WORD *)(v4 + 24) = 0;
  ...
  {
    std::_Wrap_alloc<std::allocator<std::_Tree_node<std::pair<int const,CursorGlyphInfo>,void *>>>::deallocate(v5, v9);
    throw;
  }
  return v6;
}
