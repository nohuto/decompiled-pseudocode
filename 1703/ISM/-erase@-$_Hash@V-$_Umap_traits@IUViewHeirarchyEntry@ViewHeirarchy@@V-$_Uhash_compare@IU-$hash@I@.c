/*
 * XREFs of ?erase@?$_Hash@V?$_Umap_traits@IUViewHeirarchyEntry@ViewHeirarchy@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@std@@V?$allocator@U?$pair@$$CBIUViewHeirarchyEntry@ViewHeirarchy@@@std@@@4@$0A@@std@@@std@@QEAA?AV?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBIUViewHeirarchyEntry@ViewHeirarchy@@@std@@@std@@@std@@@2@V?$_List_const_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBIUViewHeirarchyEntry@ViewHeirarchy@@@std@@@std@@@std@@@2@@Z @ 0x18006E7A4
 * Callers:
 ...
 *     _std::_Hash_std::_Umap_traits_unsigned_int_ViewHeirarchy::ViewHeirarchyEntry_std::_Uhash_compare_unsigned_int_std::hash_unsigned_int__std::equal_to_unsigned_int____std::allocator_std::pair_unsigned_int_const__ViewHeirarchy::ViewHeirarchyEntry____0___::_Insert_std::pair_unsigned_int_const__ViewHeirarchy::ViewHeirarchyEntry__&___ptr64_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_unsigned_int_const__ViewHeirarchy::ViewHeirarchyEntry__________::_1_::catch$117 @ 0x1800A2C57 (_std--_Hash_std--_Umap_traits_unsigned_int_ViewHeirarchy--ViewHeirarchyEntry_std--__ea_1800A2C57.c)
 * Callees:
 *     ?_Deallocate@std@@YAXPEAX_K1@Z @ 0x180001914 (-_Deallocate@std@@YAXPEAX_K1@Z.c)
 *     _guard_dispatch_icall_nop @ 0x18009EB10 (_guard_dispatch_icall_nop.c)
 */

_QWORD *__fastcall std::_Hash<std::_Umap_traits<unsigned int,ViewHeirarchy::ViewHeirarchyEntry,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,ViewHeirarchy::ViewHeirarchyEntry>>,0>>::erase(
        _QWORD *a1,
        _QWORD *a2,
        char *a3)
{
