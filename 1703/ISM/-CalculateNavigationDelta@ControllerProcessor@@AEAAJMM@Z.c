/*
 * XREFs of ?CalculateNavigationDelta@ControllerProcessor@@AEAAJMM@Z @ 0x180033A24
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculateNavigationDelta(ControllerProcessor *this, double a2, double a3)
{
  ...
  *(double *)v11.m128_u64 = v8.m128_f32[0];
  ...
  if ( v12.m128_f32[0] > 0.00000011920929 )
  {
    ...
    v14 = GetTickCount64() - *((_QWORD *)this + 43);
    v15 = 0LL;
  ...
  {
    *((_QWORD *)this + 43) = GetTickCount();
  }
  result = 0LL;
  v17 = _mm_mul_ps(_mm_mul_ps((__m128)_xmm, v9), (__m128)_xmm);
  v18 = _mm_shuffle_ps(v17, v17, 85).m128_f32[0] + *((float *)this + 84);
  v17.m128_f32[0] = v17.m128_f32[0] + *((float *)this + 83);
  *((float *)this + 84) = v18;
  *((_DWORD *)this + 83) = v17.m128_i32[0];
  return result;
}
