/*
 * XREFs of ?Stop@?$ActivityBase@VHolographicDriverClientTrace@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x180090D68
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  if ( v5 )
  {
    ...
    if ( *(_DWORD *)v7 > 5u && (*((_QWORD *)v7 + 2) & 0x400000000000LL) != 0 )
    {
      ...
      if ( v6 == *((struct HolographicDriverClientTrace **)v7 + 3) )
      {
        ...
        p_SRWLock = &SRWLock;
        v22 = 4;
        LODWORD(v6) = TlgWrite(v7, &unk_1800BA586, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &pData);
      }
    }
  }
  else
  ...
  if ( *(_DWORD *)(a1 + 32) )
  {
    ...
    v6 = *(struct HolographicDriverClientTrace **)v9;
    *(_DWORD *)(v9 + 24) = 0;
    if ( *(_QWORD *)v6 )
    {
      while ( 1 )
