/*
 * XREFs of ?Create@NonPointerProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x18005A560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NonPointerProcessor::Create(struct DeviceInfo **a1, struct IInputProcessor **a2)
{
  ...
  if ( *a1 && (*((_BYTE *)*a1 + 4) & 0x3B) != 0 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      v6 = 49;
LABEL_5:
      Template_qqq((__int64)a1, &MinInput_Warning_CheckResult, 0, v6, v5);
    }
  }
  else
  {
