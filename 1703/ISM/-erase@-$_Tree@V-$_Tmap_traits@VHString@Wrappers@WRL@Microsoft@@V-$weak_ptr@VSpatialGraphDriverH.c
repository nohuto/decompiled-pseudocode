...
LABEL_81:
  ...
  if ( v35 && _InterlockedExchangeAdd(v35 + 3, 0xFFFFFFFF) == 1 )
    (*(void (__fastcall **)(volatile signed __int32 *, char *))(*(_QWORD *)v35 + 8LL))(v35, v11);
