/*
 * XREFs of ?OnInputReport@PTPDeviceCollection@@MEAAJKPEAXK@Z @ 0x1800737D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PTPDeviceCollection::OnInputReport(struct IInputClient **this, int a2, _DWORD *a3, unsigned int *a4)
{
  ...
  _QWORD v26[236]; // [rsp+50h] [rbp-B0h] BYREF
    ...
    if ( v11 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( *(_DWORD *)(v14 + v13 + 16) != 5 )
          break;
        v8 = 6 * v12;
        HIDWORD(v26[v8 + 6]) = *(unsigned __int16 *)(v14 + v13 + 8);
        LODWORD(v26[v8 + 8]) = *(_DWORD *)(v14 + v13 + 56);
        HIDWORD(v26[v8 + 8]) = *(_DWORD *)(v14 + v13 + 60);
        if ( (*(_BYTE *)(v14 + v13 + 28) & 2) != 0 )
          LODWORD(v26[6 * v12 + 7]) |= 1u;
        if ( (*(_BYTE *)(v14 + v13 + 28) & 4) != 0 )
          LODWORD(v26[6 * v12 + 7]) |= 2u;
        if ( (*(_DWORD *)(v14 + v13 + 28) & 0x8000) != 0 )
          LODWORD(v26[6 * v12 + 7]) |= 4u;
        ++LODWORD(v26[6]);
...
LABEL_38:
        ...
        v21 = 262;
LABEL_37:
        Template_qqq(v20, &MinInput_Warning_CheckResult, 0, v21, ValueForKey);
        goto LABEL_38;
      }
      v18 = v23;
    }
