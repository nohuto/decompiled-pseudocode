/*
 * XREFs of ?InputReportReceived_@RawInputProvidersTracing@@QEAAXKK@Z @ 0x180076298
 * Callers:
...
void __fastcall RawInputProvidersTracing::InputReportReceived_(RawInputProvidersTracing *this, int a2, int a3)
{
  __int64 v3; // rcx
  ...
  if ( *(_DWORD *)v3 > 5u && (*(_BYTE *)(v3 + 16) & 2) != 0 && (*(_QWORD *)(v3 + 24) & 2LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v6 = 4;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)v3, &unk_1800B9B67, 0LL, 0LL, 4u, &pData);
  }
}
