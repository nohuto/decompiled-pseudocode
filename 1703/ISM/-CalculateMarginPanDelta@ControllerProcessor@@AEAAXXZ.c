/*
 * XREFs of ?CalculateMarginPanDelta@ControllerProcessor@@AEAAXXZ @ 0x180033B70
 * Callers:
...
void __fastcall ControllerProcessor::CalculateMarginPanDelta(ControllerProcessor *this)
{
  ...
  (*(void (__fastcall **)(_QWORD, POINT *, LONG *))(**((_QWORD **)this + 33) + 24LL))(
    *((_QWORD *)this + 33),
    &pt,
    &pt.y);
  v3 = (LONG *)((char *)this + 352);
  v4 = !PtInRect((const RECT *)this + 22, pt);
  *((_BYTE *)this + 368) = v4;
  if ( !v4 )
    return;
...
LABEL_10:
  v12 = *v3;
  if ( pt.x > *v3 && (v12 = *((_DWORD *)this + 90), pt.x < v12) )
    v13 = 0LL;
  else
  ...
  v8.m128_f32[0] = fmaxf(0.0, (float)(int)(v6 - *((_DWORD *)this + 93)) / 1000.0);
  if ( v8.m128_f32[0] <= 1.0 )
    v14 = v8;
  v16 = _mm_mul_ps(_mm_mul_ps(_mm_div_ps(v15, (__m128)_xmm), (__m128)_xmm), _mm_shuffle_ps(v14, v14, 0));
  v17 = _mm_shuffle_ps(v16, v16, 85).m128_f32[0] + *((float *)this + 95);
  *((float *)this + 94) = v16.m128_f32[0] + *((float *)this + 94);
  v18 = _mm_mul_ps(v16, (__m128)_xmm);
  v16.m128_f32[0] = _mm_shuffle_ps(v18, v18, 85).m128_f32[0] + *((float *)this + 84);
  v18.m128_f32[0] = v18.m128_f32[0] + *((float *)this + 83);
  *((float *)this + 95) = v17;
  *((_DWORD *)this + 84) = v16.m128_i32[0];
  *((_DWORD *)this + 83) = v18.m128_i32[0];
}
