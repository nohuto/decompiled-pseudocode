/*
 * XREFs of ?SetHapticsFeedback_@RawInputProvidersTracing@@QEAAXJKEEG@Z @ 0x18007684C
 * Callers:
        ...
        char a6)
{
  ...
  int v18; // [rsp+E0h] [rbp+5Fh] BYREF
  int v19; // [rsp+E8h] [rbp+67h] BYREF
  char v20; // [rsp+F0h] [rbp+6Fh] BYREF
  ...
  if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 2) != 0 && (*(_QWORD *)(v6 + 24) & 2LL) == *(_QWORD *)(v6 + 24) )
  {
    ...
    v15 = 1LL;
    v17 = 2LL;
    TlgWrite((TraceLoggingHProvider)v6, &unk_1800B99E1, 0LL, 0LL, 7u, &pData);
  }
}
