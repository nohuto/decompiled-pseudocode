/*
 * XREFs of ?OnPromotedToPrimary@MPCGamepadProcessor@@MEAAXXZ @ 0x18002E5E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::OnPromotedToPrimary(MPCGamepadProcessor *this)
{
  ...
  *(_QWORD *)((char *)this + 2548) = *((_QWORD *)Instance + 22);
  *((_DWORD *)this + 639) = *((_DWORD *)Instance + 46);
  ...
  v13 = *((_OWORD *)v3 + 1);
  v14 = *((float *)this + 638);
  v15 = (__m128)*((unsigned int *)this + 637);
  ...
  *((_QWORD *)this + 320) = _mm_unpacklo_ps(v16, v18).m128_u64[0];
  *((_DWORD *)this + 642) = v15.m128_i32[0];
  *((_QWORD *)this + 323) = _mm_unpacklo_ps((__m128)0LL, (__m128)0LL).m128_u64[0];
  *((_DWORD *)this + 648) = 0;
}
