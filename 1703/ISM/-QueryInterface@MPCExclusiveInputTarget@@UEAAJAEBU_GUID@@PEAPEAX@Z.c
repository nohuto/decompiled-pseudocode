/*
 * XREFs of ?QueryInterface@MPCExclusiveInputTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180087490
 * Callers:
 *     ?QueryInterface@MPCExclusiveInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180088350 (-QueryInterface@MPCExclusiveInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCExclusiveInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180088370 (-QueryInterface@MPCExclusiveInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCExclusiveInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180088390 (-QueryInterface@MPCExclusiveInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
