/*
 * XREFs of ?SetValueForKey@?$DynamicSizeMap@I_N$09@@QEAAJAEBIAEB_N@Z @ 0x180010E64
 * Callers:
...
__int64 __fastcall DynamicSizeMap<unsigned int,bool,10>::SetValueForKey(__int64 a1, int *a2, _BYTE *a3)
{
  int v3; // r11d
  unsigned int v4; // ebx
  int v5; // r10d
...
LABEL_5:
  ...
  do
  {
    if ( *(_DWORD *)&v15[8 * v14] == v3 )
    {
      v15[8 * v14 + 4] = *a3;
      return v4;
    }
    if ( !v7 && *(_DWORD *)&v15[8 * v14] == v5 )
    {
      v6 = v14;
      v7 = 1;
    }
...
LABEL_16:
  if ( *(_DWORD *)(a1 + 12) == v13 )
  {
    ...
    *(_QWORD *)a1 = v18;
    if ( !v18 )
    {
      ...
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
        goto LABEL_5;
      Template_qqq(v19, &MinInput_Warning_CheckResult, 4, 386, 14);
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
        goto LABEL_5;
      v12 = 185;
      goto LABEL_4;
  ...
  v4 = -2147467259;
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    Template_qqq(v14, &MinInput_Warning_CheckResult, 4, 180, 5);
  return v4;
}
