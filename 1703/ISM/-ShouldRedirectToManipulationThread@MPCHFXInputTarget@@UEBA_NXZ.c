/*
 * XREFs of ?ShouldRedirectToManipulationThread@MPCHFXInputTarget@@UEBA_NXZ @ 0x180086690
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall MPCHFXInputTarget::ShouldRedirectToManipulationThread(MPCHFXInputTarget *this)
{
  int v1; // eax
  char v2; // bl
  __int64 v3; // rcx
