/*
 * XREFs of ?RuntimeClassInitialize@InputQueue@@UEAAJPEAUIInputQueueHost@@I@Z @ 0x18006C190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InputQueue::RuntimeClassInitialize(InputQueue *this, struct IInputQueueHost *a2, int a3)
{
  ...
  *((_DWORD *)this + 10) = 0;
  ...
  v24 = (*(__int64 (__fastcall **)(__int64, wchar_t *, _QWORD, __int64, _DWORD, _DWORD, _QWORD, char *, char *))(*(_QWORD *)v22 + 304LL))(
          v22,
          Buffer,
          *v18,
          3LL,
  ...
  v28 = (*(__int64 (__fastcall **)(__int64, wchar_t *, _QWORD, char *, char *))(*(_QWORD *)v25 + 312LL))(
          v25,
          Buffer,
          *((_QWORD *)this + 2),
          (char *)this + 36,
