/*
 * XREFs of ?ResultFromCaughtExceptionInternal@details@wil@@YAJPEAG_KPEA_N@Z @ 0x180002B30
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  *a3 = 0;
  ...
  return g_pfnResultFromCaughtException_WinRt(this, a2, a3, 0LL, v33, v34, v35);
}
