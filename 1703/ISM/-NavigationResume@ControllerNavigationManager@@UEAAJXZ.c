/*
 * XREFs of ?NavigationResume@ControllerNavigationManager@@UEAAJXZ @ 0x180031230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ControllerNavigationManager::NavigationResume(ControllerNavigationManager *this)
{
  ...
  {
    updated = ControllerProcessor::UpdateNavigationState(i[3], 3LL, 0LL, 0LL);
    if ( updated < 0 )
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v5, &MinInput_Warning_CheckResult, 12, 656, updated);
