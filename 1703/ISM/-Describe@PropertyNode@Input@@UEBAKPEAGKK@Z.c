/*
 * XREFs of ?Describe@PropertyNode@Input@@UEBAKPEAGKK@Z @ 0x1800276E0
 * Callers:
 *     ?Describe@Property@Input@@UEBAKPEAGKK@Z @ 0x180027AD0 (-Describe@Property@Input@@UEBAKPEAGKK@Z.c)
 *     ?Describe@PropertyMap@Input@@UEBAKPEAGKK@Z @ 0x180028390 (-Describe@PropertyMap@Input@@UEBAKPEAGKK@Z.c)
 * Callees:
