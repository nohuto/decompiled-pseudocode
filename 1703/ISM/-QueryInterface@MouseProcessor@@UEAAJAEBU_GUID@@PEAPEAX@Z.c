/*
 * XREFs of ?QueryInterface@MouseProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800589D0
 * Callers:
 *     ?QueryInterface@MouseProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180059D50 (-QueryInterface@MouseProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WKI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180059D60 (-QueryInterface@MouseProcessor@@WKI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WLA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180059D90 (-QueryInterface@MouseProcessor@@WLA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WLI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180059DC0 (-QueryInterface@MouseProcessor@@WLI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MouseProcessor@@WMA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180059E00 (-QueryInterface@MouseProcessor@@WMA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
