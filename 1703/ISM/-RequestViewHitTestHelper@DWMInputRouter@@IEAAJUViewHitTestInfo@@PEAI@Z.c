/*
 * XREFs of ?RequestViewHitTestHelper@DWMInputRouter@@IEAAJUViewHitTestInfo@@PEAI@Z @ 0x180016190
 * Callers:
...
__int64 __fastcall DWMInputRouter::RequestViewHitTestHelper(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  _QWORD v16[24]; // [rsp+60h] [rbp-A0h] BYREF
  ...
  if ( LODWORD(v16[6]) > 0x64 )
  {
    ...
    if ( !v6 )
    {
      ...
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v10, &MinInput_Warning_CheckResult, 0, 1942, 14);
      return v7;
    }
    ...
    if ( !(**v12)(v12, v16) )
    {
      v7 = -2147418113;
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v13, &MinInput_Warning_CheckResult, 0, 1952, 255);
      goto LABEL_14;
    }
    v9 = v16[6];
  }
