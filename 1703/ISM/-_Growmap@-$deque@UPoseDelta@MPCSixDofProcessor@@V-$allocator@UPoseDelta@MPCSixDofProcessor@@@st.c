/*
 * XREFs of ?_Growmap@?$deque@UPoseDelta@MPCSixDofProcessor@@V?$allocator@UPoseDelta@MPCSixDofProcessor@@@std@@@std@@IEAAX_K@Z @ 0x180046474
 * Callers:
...
void __fastcall std::deque<MPCSixDofProcessor::PoseDelta>::_Growmap(_QWORD *a1)
{
