/*
 * XREFs of ??$MakeAndInitialize@VHitTestRequest@@UIHitTestRequest@@PEAUIDisplayBinding@@AEAPEAUIInputTarget@@AEAV?$RefPtr@UIInputTarget@@@@AEAUInputInfo@@AEAK@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@UIHitTestRequest@@@WRL@Microsoft@@@012@$$QEAPEAUIDisplayBinding@@AEAPEAUIInputTarget@@AEAV?$RefPtr@UIInputTarget@@@@AEAUInputInfo@@AEAK@Z @ 0x180018F84
 * Callers:
 ...
 * Callees:
 *     ?RuntimeClassInitialize@HitTestRequest@@QEAAJPEAUIDisplayBinding@@PEAUIInputTarget@@1AEBUInputInfo@@K@Z @ 0x18001BA5C (-RuntimeClassInitialize@HitTestRequest@@QEAAJPEAUIDisplayBinding@@PEAUIInputTarget@@1AEBUInputIn.c)
 *     ??2@YAPEAX_KAEBUnothrow_t@std@@@Z @ 0x18009E02C (--2@YAPEAX_KAEBUnothrow_t@std@@@Z.c)
 *     _guard_dispatch_icall_nop @ 0x18009EB10 (_guard_dispatch_icall_nop.c)
 */

__int64 __fastcall Microsoft::WRL::Details::MakeAndInitialize<HitTestRequest,IHitTestRequest,IDisplayBinding *,IInputTarget * &,RefPtr<IInputTarget> &,InputInfo &,unsigned long &>(
        __int64 *a1,
