/*
 * XREFs of ??1?$unique_ptr@VMPCCursorManager@@U?$default_delete@VMPCCursorManager@@@std@@@std@@QEAA@XZ @ 0x18004D93C
 * Callers:
 *     _MPCHolographicInputManager::MPCHolographicInputManager_::_1_::dtor$7 @ 0x1800A1624 (_MPCHolographicInputManager--MPCHolographicInputManager_--_1_--dtor$7.c)
 * Callees:
