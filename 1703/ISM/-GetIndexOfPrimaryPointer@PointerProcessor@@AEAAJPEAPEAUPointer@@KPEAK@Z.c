/*
 * XREFs of ?GetIndexOfPrimaryPointer@PointerProcessor@@AEAAJPEAPEAUPointer@@KPEAK@Z @ 0x18005E32C
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( !a2 )
  {
    ...
    {
      Template_qqq((__int64)this, &MinInput_Warning_CheckResult, 0, 127, 87);
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v10, &MinInput_Warning_CheckResult, 0, 524, 87);
    }
    return v9;
  }
  v11 = 0LL;
...
LABEL_23:
  ...
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    Template_qqq(v14, &MinInput_Warning_CheckResult, 0, 531, NewPrimaryPointer);
  return v9;
}
