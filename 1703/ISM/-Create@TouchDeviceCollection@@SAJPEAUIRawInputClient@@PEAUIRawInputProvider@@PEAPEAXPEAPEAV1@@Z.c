/*
 * XREFs of ?Create@TouchDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x180073BB4
 * Callers:
...
LABEL_22:
  ...
  *((_QWORD *)v9 + 3) = a2;
  ...
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    Template_qqq(v13, &MinInput_Warning_CheckResult, 0, 83, v11);
LABEL_13:
    v14 = Microsoft_OneCore_MinInputEnableBits;
  }
  if ( v11 >= 0 )
