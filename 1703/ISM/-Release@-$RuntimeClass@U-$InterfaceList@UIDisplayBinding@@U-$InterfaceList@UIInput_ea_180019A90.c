/*
 * XREFs of ?Release@?$RuntimeClass@U?$InterfaceList@UIDisplayBinding@@U?$InterfaceList@UIInputDisplay@@U?$InterfaceList@UIPropertyChangedListener@Input@@U?$InterfaceList@UIInputDisplayOrientationListener@@VNil@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$01@34@$00$0A@$0A@@Details@WRL@Microsoft@@WBI@EAAKXZ @ 0x180019A90
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall Microsoft::WRL::Details::RuntimeClass<Microsoft::WRL::Details::InterfaceList<IDisplayBinding,Microsoft::WRL::Details::InterfaceList<IInputDisplay,Microsoft::WRL::Details::InterfaceList<Input::IPropertyChangedListener,Microsoft::WRL::Details::InterfaceList<IInputDisplayOrientationListener,Microsoft::WRL::Details::Nil>>>>,Microsoft::WRL::RuntimeClassFlags<2>,1,0,0>::Release(
        __int64 a1)
{
  return Microsoft::WRL::Details::RuntimeClass<Microsoft::WRL::Details::InterfaceList<IDisplayBinding,Microsoft::WRL::Details::InterfaceList<IInputDisplay,Microsoft::WRL::Details::InterfaceList<Input::IPropertyChangedListener,Microsoft::WRL::Details::InterfaceList<IInputDisplayOrientationListener,Microsoft::WRL::Details::Nil>>>>,Microsoft::WRL::RuntimeClassFlags<2>,1,0,0>::Release((volatile signed __int32 *)(a1 - 24));
}
