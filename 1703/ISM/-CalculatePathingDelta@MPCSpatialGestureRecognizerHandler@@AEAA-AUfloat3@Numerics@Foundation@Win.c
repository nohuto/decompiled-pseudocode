/*
 * XREFs of ?CalculatePathingDelta@MPCSpatialGestureRecognizerHandler@@AEAA?AUfloat3@Numerics@Foundation@Windows@@PEAUISpatialManipulationUpdatedEventArgs@Spatial@Input@UI@5@@Z @ 0x180051DF4
 * Callers:
        ...
        __int64 a3)
{
  ...
  __int64 v48; // [rsp+8C8h] [rbp+7C0h] BYREF
  int v49; // [rsp+8D0h] [rbp+7C8h] BYREF
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  if ( v49 == 1 )
  {
    updated = MPCSpatialGestureRecognizerHandler::UpdateCoordinateSystemForTick(a1, *((_QWORD *)a1 + 12));
    if ( updated < 0 )
    {
      wil::details::in1diag3::_FailFast_Hr(
        retaddr,
    ...
    v48 = 0LL;
    v8 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)a3 + 56LL))(a3, *((_QWORD *)a1 + 8), &v48);
    if ( v8 < 0 )
    {
      wil::details::in1diag3::_FailFast_Hr(
        retaddr,
