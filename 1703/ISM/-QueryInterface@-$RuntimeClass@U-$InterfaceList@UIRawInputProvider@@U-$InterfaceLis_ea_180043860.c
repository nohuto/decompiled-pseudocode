/*
 * XREFs of ?QueryInterface@?$RuntimeClass@U?$InterfaceList@UIRawInputProvider@@U?$InterfaceList@UIMouseProcessorForwarding@@U?$InterfaceList@UICursorBasedInputProcessor@@U?$InterfaceList@UIGetClosestInteractiveBounds@@U?$InterfaceList@VMPCInputProviderBase@@VNil@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$01@34@$00$0A@$0A@@Details@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180043860
 * Callers:
 *     <none>
 * Callees:
 *     <none>
