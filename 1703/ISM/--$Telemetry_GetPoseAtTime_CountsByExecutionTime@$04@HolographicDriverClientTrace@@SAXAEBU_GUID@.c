/*
 * XREFs of ??$Telemetry_GetPoseAtTime_CountsByExecutionTime@$04@HolographicDriverClientTrace@@SAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0W4GetPoseAtTimePurpose@Holographic@Internal@Windows@@IAEAY04$$CBMAEAY05$$CBI@Z @ 0x1800900FC
 * Callers:
...
int __fastcall HolographicDriverClientTrace::Telemetry_GetPoseAtTime_CountsByExecutionTime<5>(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
    ...
    if ( *v12 )
    {
      ...
      if ( *(_DWORD *)v13 > 5u && (*((_QWORD *)v13 + 2) & 0x400000000000LL) != 0 )
      {
        ...
        if ( v11 == *((struct HolographicDriverClientTrace **)v13 + 3) )
        {
          ...
          v26 = &v15;
          v29 = &a5;
          v32 = &Windows::Internal::Holographic::GetPoseAtTimeHeartbeat::ExecutionTimeMsecBuckets;
          v35 = a7;
          v17 = a1;
          v20 = a2;
          v23 = a3;
          ...
          v33 = 20;
          v36 = 24;
          LODWORD(v11) = TlgWrite(v13, &unk_1800BA460, 0LL, 0LL, 9u, &pData);
        }
      }
    }
  }
