/*
 * XREFs of ?GetProcessId@MPCExclusiveInputTarget@@UEAAJPEAK@Z @ 0x180087F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCExclusiveInputTarget::GetProcessId(MPCExclusiveInputTarget *this, unsigned int *a2)
{
  int v3; // eax
  unsigned int v4; // ebx
  __int64 v5; // rcx
