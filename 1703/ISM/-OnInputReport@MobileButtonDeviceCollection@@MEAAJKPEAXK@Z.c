/*
 * XREFs of ?OnInputReport@MobileButtonDeviceCollection@@MEAAJKPEAXK@Z @ 0x18007C300
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  _BYTE v36[1888]; // [rsp+70h] [rbp-90h] BYREF
  ...
  unsigned int v40; // [rsp+898h] [rbp+798h] BYREF
        ...
        if ( a4 >= v16->InputReportByteLength )
        {
          while ( 1 )
          {
            ...
            if ( Usages < 0 )
            {
              ...
              if ( (ButtonInfo & 0x80000000) != 0 )
              {
                if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
                  Template_qqq(v18, &MinInput_Warning_CheckResult, 0, 253, ButtonInfo);
                return ButtonInfo;
              }
            }
            ...
            if ( UsageListLength > 0x14 )
            {
              ...
              if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
                Template_qqq(v10, &MinInput_Warning_CheckResult, 0, 265, 5);
              return ButtonInfo;
            }
            ...
            if ( v21 < 0 )
            {
              ...
              if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
                Template_qqq(0LL, &MinInput_Warning_CheckResult, 0, 273, v21);
              return ButtonInfo;
            }
...
LABEL_24:
            ...
            if ( MakeUsageList[0] )
            {
              while ( 1 )
              {
                ...
                {
                  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
                    Template_qqq(v27, &MinInput_Warning_CheckResult, 0, 339, ButtonInfo);
                  return ButtonInfo;
                }
                if ( !*++v24 )
                  goto LABEL_28;
              ...
              if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
                Template_qqq(v26, &MinInput_Warning_CheckResult, 0, 332, ButtonInfo);
              return ButtonInfo;
            }
LABEL_28:
      ...
      {
        Template_qqq((__int64)v14, &MinInput_Warning_CheckResult, 0, 225, ButtonInfo);
      }
    }
    else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
