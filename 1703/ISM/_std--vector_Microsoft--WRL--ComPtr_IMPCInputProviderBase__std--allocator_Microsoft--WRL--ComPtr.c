/*
 * XREFs of _std::vector_Microsoft::WRL::ComPtr_IMPCInputProviderBase__std::allocator_Microsoft::WRL::ComPtr_IMPCInputProviderBase_____::emplace_back_Microsoft::WRL::ComPtr_IMPCInputProviderBase____::_1_::catch$69 @ 0x1800A1804
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$destroy@V?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@?$_Wrap_alloc@V?$allocator@V?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@std@@@std@@QEAAXPEAV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@@Z @ 0x1800195E4 (--$destroy@V-$ComPtr@UIInputTarget@@@WRL@Microsoft@@@-$_Wrap_alloc@V-$allocator@V-$ComPtr@UIInpu.c)
 *     _CxxThrowException_0 @ 0x18009E220 (_CxxThrowException_0.c)
 */

void __fastcall __noreturn std::vector_Microsoft::WRL::ComPtr_IMPCInputProviderBase__std::allocator_Microsoft::WRL::ComPtr_IMPCInputProviderBase_____::emplace_back_Microsoft::WRL::ComPtr_IMPCInputProviderBase____::_1_::catch_69(
        __int64 a1,
        _QWORD *a2)
{
  char *v3; // rbx
  ...
  v3 = (char *)a2[14];
  v4 = (__int64 *)std::_Unfancy<Microsoft::WRL::ComPtr<WGIController>>((__int64)&v3[8 * a2[17]]);
