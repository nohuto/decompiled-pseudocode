/*
 * XREFs of _WGIController::RuntimeClassInitialize_::_1_::dtor$1 @ 0x1800A23C1
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall WGIController::RuntimeClassInitialize_::_1_::dtor_1(__int64 a1, __int64 a2)
{
