/*
 * XREFs of ??$Telemetry_GetPoseAtTime_CountsByPredictionType@$02@HolographicDriverClientTrace@@SAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0W4GetPoseAtTimePurpose@Holographic@Internal@Windows@@IAEAY02$$CBW4TracePredictionType@@AEAY02$$CBI@Z @ 0x18008FFB0
 * Callers:
...
int __fastcall HolographicDriverClientTrace::Telemetry_GetPoseAtTime_CountsByPredictionType<3>(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        __int64 a7)
{
  ...
  enum TracePredictionType near **v32; // [rsp+B8h] [rbp-1h]
    ...
    if ( *v12 )
    {
      ...
      if ( *(_DWORD *)v13 > 5u && (*((_QWORD *)v13 + 2) & 0x400000000000LL) != 0 )
      {
        ...
        if ( v11 == *((struct HolographicDriverClientTrace **)v13 + 3) )
        {
          ...
          v26 = &v15;
          v29 = &a5;
          v32 = &Windows::Internal::Holographic::GetPoseAtTimeHeartbeat::PredictionTypeBuckets;
          v27 = 4;
          v30 = 4;
          v35 = a7;
          v17 = a1;
          ...
          v33 = 12;
          v36 = 12;
          LODWORD(v11) = TlgWrite(v13, &unk_1800BA3D5, 0LL, 0LL, 9u, &pData);
        }
      }
    }
  }
