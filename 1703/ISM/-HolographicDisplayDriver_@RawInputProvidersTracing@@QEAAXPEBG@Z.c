/*
 * XREFs of ?HolographicDisplayDriver_@RawInputProvidersTracing@@QEAAXPEBG@Z @ 0x1800766F8
 * Callers:
...
void __fastcall RawInputProvidersTracing::HolographicDisplayDriver_(
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( *(_DWORD *)v3 > 4u && (*(_BYTE *)(v3 + 16) & 2) != 0 && (*(_QWORD *)(v3 + 24) & 2LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v8 = 2 * v5 + 2;
    v9 = 0;
    TlgWrite((TraceLoggingHProvider)v3, &unk_1800B9D27, 0LL, 0LL, 3u, &pData);
  }
}
