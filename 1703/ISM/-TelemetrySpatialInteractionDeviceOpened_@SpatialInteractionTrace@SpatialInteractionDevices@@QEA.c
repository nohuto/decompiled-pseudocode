/*
 * XREFs of ?TelemetrySpatialInteractionDeviceOpened_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_WPEAX@Z @ 0x180064070
 * Callers:
        ...
        void *a3)
{
    ...
    && (*((_QWORD *)v4 + 3) & 0x400000000000LL) == *((_QWORD *)v4 + 3) )
  {
    ...
    v10 = 0;
    v12 = 8LL;
    TlgWrite(v4, &unk_1800B993F, 0LL, 0LL, 4u, &pData);
  }
}
