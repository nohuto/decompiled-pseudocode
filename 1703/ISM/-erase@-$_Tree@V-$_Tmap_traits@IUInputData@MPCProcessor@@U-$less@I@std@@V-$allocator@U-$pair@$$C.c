...
char **__fastcall std::_Tree<std::_Tmap_traits<unsigned int,MPCProcessor::InputData,std::less<unsigned int>,std::allocator<std::pair<unsigned int const,MPCProcessor::InputData>>,0>>::erase(
        _QWORD *a1,
        char **a2,
        char *a3)
{
...
LABEL_81:
  ...
  v10[24] = 1;
LABEL_114:
  std::_Deallocate(a3, 1uLL, 0x790uLL);
  v35 = a1[1];
  if ( v35 )
    a1[1] = v35 - 1;
  result = a2;
