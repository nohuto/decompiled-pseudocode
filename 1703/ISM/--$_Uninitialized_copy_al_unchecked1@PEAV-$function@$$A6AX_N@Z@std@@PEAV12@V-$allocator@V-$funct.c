/*
 * XREFs of ??$_Uninitialized_copy_al_unchecked1@PEAV?$function@$$A6AX_N@Z@std@@PEAV12@V?$allocator@V?$function@$$A6AX_N@Z@std@@@2@@std@@YAPEAV?$function@$$A6AX_N@Z@0@PEAV10@00AEAU?$_Wrap_alloc@V?$allocator@V?$function@$$A6AX_N@Z@std@@@std@@@0@U_General_ptr_iterator_tag@0@U_Any_tag@0@@Z @ 0x180008DFC
 * Callers:
...
_QWORD *__fastcall std::_Uninitialized_copy_al_unchecked1<std::function<void (bool)> *,std::function<void (bool)> *,std::allocator<std::function<void (bool)>>>(
        __int64 a1,
        __int64 a2,
        _QWORD *a3)
{
