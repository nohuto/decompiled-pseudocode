/*
 * XREFs of ?GetWeakReference@?$RuntimeClass@U?$InterfaceList@UISpatialGraphDriverClient@Holographic@Internal@Windows@@U?$InterfaceList@VFtmBase@WRL@Microsoft@@VNil@Details@23@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$02@34@$00$00$0A@@Details@WRL@Microsoft@@UEAAJPEAPEAUIWeakReference@@@Z @ 0x18004FB10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL::Details::RuntimeClass<Microsoft::WRL::Details::InterfaceList<Windows::Internal::Holographic::ISpatialGraphDriverClient,Microsoft::WRL::Details::InterfaceList<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::Nil>>,Microsoft::WRL::RuntimeClassFlags<3>,1,1,0>::GetWeakReference(
        __int64 a1,
        struct IUnknown *a2)
{
  __int64 v2; // rax
  ...
  if ( v2 >= 0 )
  {
    ...
    *(_DWORD *)(WeakReference + 16) = v5;
    ...
    v12 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 40), v10, v5);
