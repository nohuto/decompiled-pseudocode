/*
 * XREFs of ?GetWindowId@MPCExclusiveInputTarget@@UEAAJPEA_K@Z @ 0x180088290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCExclusiveInputTarget::GetWindowId(MPCExclusiveInputTarget *this, unsigned __int64 *a2)
{
  int v3; // eax
  unsigned int v4; // ebx
  __int64 v5; // rcx
