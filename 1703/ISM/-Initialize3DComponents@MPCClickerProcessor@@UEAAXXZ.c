/*
 * XREFs of ?Initialize3DComponents@MPCClickerProcessor@@UEAAXXZ @ 0x18004A4F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCClickerProcessor::Initialize3DComponents(struct IInputProcessorHost **this)
{
