/*
 * XREFs of ??$Telemetry_GetPoseAtTime_CountsByTrackingValidityFlags@$03@HolographicDriverClientTrace@@SAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0W4GetPoseAtTimePurpose@Holographic@Internal@Windows@@AEAY03$$CBI33@Z @ 0x18009039C
 * Callers:
...
int __fastcall HolographicDriverClientTrace::Telemetry_GetPoseAtTime_CountsByTrackingValidityFlags<4>(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
    ...
    if ( *v12 )
    {
      ...
      if ( *(_DWORD *)v13 > 5u && (*((_QWORD *)v13 + 2) & 0x400000000000LL) != 0 )
      {
        ...
        if ( v11 == *((struct HolographicDriverClientTrace **)v13 + 3) )
        {
          ...
          v37 = 0;
          v26 = &v15;
          v29 = &Windows::Internal::Holographic::GetPoseAtTimeHeartbeat::TrackingValidityFlagsBuckets;
          v32 = a6;
          v35 = a7;
          v17 = a1;
          v18 = 16;
          ...
          v33 = 16;
          v36 = 16;
          LODWORD(v11) = TlgWrite(v13, &unk_1800BA4EE, 0LL, 0LL, 9u, &pData);
        }
      }
    }
  }
