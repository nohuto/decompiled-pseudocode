/*
 * XREFs of ?CreateAndRegisterTarget@DWMInputRouter@@IEAAJKKKK_KPEAPEAUIInputTarget@@@Z @ 0x180013E50
 * Callers:
  ...
  if ( (_DWORD)v12 )
  {
    ...
    if ( !v13 )
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v14, &MinInput_Warning_CheckResult, 0, 883, 3);
      goto LABEL_5;
    }
    Keys = DynamicSizeMap<tagMsgRoutingInfo,IInputTarget *,1>::GetKeys(v11, v13, (unsigned int)v12);
    if ( Keys < 0 )
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v17, &MinInput_Warning_CheckResult, 0, 885, Keys);
      goto LABEL_5;
    }
    v18 = 0LL;
    while ( v15[10 * v18] != a2 )
    ...
    v34 = 0LL;
    ValueForKey = DynamicSizeMap<tagMsgRoutingInfo,IInputTarget *,1>::GetValueForKey(v11, &v15[10 * v18], &v34);
    if ( ValueForKey < 0 )
    {
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v20, &MinInput_Warning_CheckResult, 0, 901, ValueForKey);
LABEL_5:
...
LABEL_20:
    ...
    if ( v10 )
    {
      ...
      if ( !a7 )
      {
        ...
        v24 = 49;
LABEL_30:
        Template_qqq((__int64)this, &MinInput_Warning_CheckResult, 0, v24, v23);
        if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          Template_qqq(v27, &MinInput_Warning_CheckResult, 0, 920, v23);
        goto LABEL_44;
      }
      *a7 = 0LL;
      v25 = malloc(0x50uLL);
...
LABEL_43:
  ...
  Template_qqq((__int64)this, &MinInput_Warning_CheckResult, 0, v30, v28);
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    Template_qqq(v32, &MinInput_Warning_CheckResult, 0, 930, v29);
LABEL_44:
  if ( v10 )
