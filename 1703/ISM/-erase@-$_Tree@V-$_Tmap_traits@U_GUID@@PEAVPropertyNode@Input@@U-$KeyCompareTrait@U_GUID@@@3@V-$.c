/*
 * XREFs of ?erase@?$_Tree@V?$_Tmap_traits@U_GUID@@PEAVPropertyNode@Input@@U?$KeyCompareTrait@U_GUID@@@3@V?$allocator@U?$pair@$$CBU_GUID@@PEAVPropertyNode@Input@@@std@@@std@@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBU_GUID@@PEAVPropertyNode@Input@@@std@@@std@@@std@@@2@V?$_Tree_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBU_GUID@@PEAVPropertyNode@Input@@@std@@@std@@@std@@@2@@Z @ 0x180018364
 * Callers:
...
char **__fastcall std::_Tree<std::_Tmap_traits<_GUID,Input::PropertyNode *,Input::KeyCompareTrait<_GUID>,std::allocator<std::pair<_GUID const,Input::PropertyNode *>>,0>>::erase(
        _QWORD *a1,
        char **a2,
        char *a3)
{
  ...
  else if ( *(_BYTE *)(*((_QWORD *)a3 + 2) + 25LL) )
  {
    v10 = *(char **)a3;
  }
  else
...
LABEL_47:
  if ( a3[24] != 1 )
    goto LABEL_114;
  for ( j = v10 == *(char **)(*a1 + 8LL); !j; j = v19 == *(char **)(*a1 + 8LL) )
  {
    v19 = v11;
    if ( v10[24] != 1 )
      break;
