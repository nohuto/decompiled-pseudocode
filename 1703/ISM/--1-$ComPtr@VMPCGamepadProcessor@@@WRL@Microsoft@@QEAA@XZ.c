/*
 * XREFs of ??1?$ComPtr@VMPCGamepadProcessor@@@WRL@Microsoft@@QEAA@XZ @ 0x18002F284
 * Callers:
 *     _MPCGamepadProcessor::Create_::_1_::dtor$0 @ 0x1800A0CFD (_MPCGamepadProcessor--Create_--_1_--dtor$0.c)
 * Callees:
...
__int64 __fastcall Microsoft::WRL::ComPtr<MPCGamepadProcessor>::~ComPtr<MPCGamepadProcessor>(__int64 *a1)
{
  ...
  {
    *(_QWORD *)result = 0LL;
    result = (unsigned int)_InterlockedExchangeAdd((volatile signed __int32 *)(v2 + 172), 0xFFFFFFFF);
    if ( (_DWORD)result == 1 )
    {
