/*
 * XREFs of ?OnMessageCallback@InputEdgyNotifier@@AEAAJPEBXH@Z @ 0x180024F78
 * Callers:
 *     ?OnMessageCallbackStatic@InputEdgyNotifier@@CAJPEAXPEBXH@Z @ 0x180024F70 (-OnMessageCallbackStatic@InputEdgyNotifier@@CAJPEAXPEBXH@Z.c)
 * Callees:
  ...
  if ( (_DWORD)v4 )
  {
    if ( (_DWORD)v4 == 1 )
    {
        ...
        && *((_DWORD *)this + 13) == *((_DWORD *)a2 + 3) )
      {
        ...
        {
          Template_qqq(v4, &MinInput_Warning_CheckResult, 0, 177, v5);
        }
      }
      if ( v3 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      {
        v8 = 209;
LABEL_28:
        Template_qqq(v4, &MinInput_Warning_CheckResult, 0, v8, v3);
  ...
  if ( !*((_DWORD *)this + 10) )
  {
    ...
    else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
    {
      v10 = 151;
LABEL_24:
      Template_qqq(v4, &MinInput_Warning_CheckResult, 0, v10, v9);
    }
  }
  if ( v3 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
