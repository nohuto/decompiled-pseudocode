/*
 * XREFs of __tailMerge_ext_ms_win_rtcore_ntuser_dpi_l1_2_0_dll @ 0x18009E8A5
 * Callers:
 *     __imp_load_GetDpiForMonitorInternal @ 0x18009E899 (__imp_load_GetDpiForMonitorInternal.c)
 * Callees:
