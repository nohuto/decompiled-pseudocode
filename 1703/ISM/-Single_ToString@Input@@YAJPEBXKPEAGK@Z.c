/*
 * XREFs of ?Single_ToString@Input@@YAJPEBXKPEAGK@Z @ 0x18002B3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Input::Single_ToString(Input *this, const void *a2, char *a3, unsigned __int16 *a4)
{
  __int64 v4; // rbx
  ...
  if ( Input::NullValue_ToString(this, a3, (unsigned __int16 *)(unsigned int)a4) )
    return 0LL;
  return StringCchPrintfW((wchar_t *)a3, v4, L"%.04f", *(float *)this);
}
