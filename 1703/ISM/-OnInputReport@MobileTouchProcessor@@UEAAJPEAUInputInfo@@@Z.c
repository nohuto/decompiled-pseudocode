/*
 * XREFs of ?OnInputReport@MobileTouchProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x180058330
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  if ( !*((_BYTE *)a2 + 697) && v6 && (*((_DWORD *)v6 + 3) || *((_BYTE *)this + 260)) )
  {
    v9 = *((_DWORD *)this + 64);
    if ( v9 == 0x7FFFFFFF )
    {
      if ( *((_BYTE *)a2 + 708) )
      {
        ...
        *((_DWORD *)a2 + 17) = *((__int16 *)v6 + 3);
        *((_DWORD *)a2 + 14) = 3;
        *((_DWORD *)this + 64) = v5;
      }
    }
    else if ( v9 == v5 && !*((_BYTE *)a2 + 708) )
    {
      *(_DWORD *)a2 = 136;
      *((_DWORD *)a2 + 12) = 1;
      *((_DWORD *)a2 + 16) = *((__int16 *)v6 + 2);
...
LABEL_27:
  ...
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    v15 = 651;
LABEL_36:
    Template_qqq(v14, &MinInput_Warning_CheckResult, 0, v15, v13);
  }
  return v2;
}
