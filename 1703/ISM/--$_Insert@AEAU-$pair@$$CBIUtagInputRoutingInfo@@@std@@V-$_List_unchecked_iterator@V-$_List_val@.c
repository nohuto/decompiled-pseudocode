...
__int64 __fastcall std::_Hash<std::_Umap_traits<unsigned int,tagInputRoutingInfo,std::_Uhash_compare<unsigned int,std::hash<unsigned int>,std::equal_to<unsigned int>>,std::allocator<std::pair<unsigned int const,tagInputRoutingInfo>>,0>>::_Insert<std::pair<unsigned int const,tagInputRoutingInfo> &,std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned int const,tagInputRoutingInfo>>>>>(
        float *a1,
        __int64 a2,
        unsigned int *a3,
        char *a4)
...
LABEL_12:
  ...
  else
  {
    ...
    *(_QWORD *)(*(_QWORD *)a4 + 8LL) = *((_QWORD *)a4 + 1);
    --*((_QWORD *)a1 + 2);
    std::_Deallocate(a4, 1uLL, 0x48uLL);
    result = a2;
    *(_QWORD *)a2 = v13;
    *(_BYTE *)(a2 + 8) = 0;
  }
