/*
 * XREFs of ??$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ?AW4OrthonormalMatrixValidationFailures@1@UXMMATRIX@1@@Z @ 0x18008C344
 * Callers:
        ...
        double a4)
{
  ...
  if ( (_mm_movemask_ps(_mm_cmple_ps(_mm_max_ps(_mm_sub_ps((__m128)0LL, v29), v29), (__m128)_xmm)) & 7) == 7 )
  {
    ...
    if ( (_mm_movemask_ps(_mm_cmple_ps(_mm_max_ps(_mm_sub_ps((__m128)0LL, v31), v31), (__m128)_xmm)) & 7) == 7 )
    {
  ...
  return (v21 == 0 ? 2 : 0) | (v14 == 0 ? 4 : 0) | ((_mm_movemask_ps(_mm_cmplt_ps((__m128)_xmm, _mm_shuffle_ps(v35, v35, 0))) & 7) != 7
                                                  ? 8
                                                  : 0) | !v13;
}
