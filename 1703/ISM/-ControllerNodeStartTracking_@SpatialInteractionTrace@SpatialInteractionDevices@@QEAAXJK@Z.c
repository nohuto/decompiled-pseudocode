/*
 * XREFs of ?ControllerNodeStartTracking_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXJK@Z @ 0x180098FD0
 * Callers:
...
void __fastcall SpatialInteractionDevices::SpatialInteractionTrace::ControllerNodeStartTracking_(
