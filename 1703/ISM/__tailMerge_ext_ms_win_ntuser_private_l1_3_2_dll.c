/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_private_l1_3_2_dll @ 0x18009E3DC
 * Callers:
 *     __imp_load_GetWindowCompositionAttribute @ 0x18009E3D0 (__imp_load_GetWindowCompositionAttribute.c)
 * Callees:
