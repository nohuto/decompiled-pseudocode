/*
 * XREFs of ??1?$unique_ptr@VSpeechRuntimeListener@@U?$default_delete@VSpeechRuntimeListener@@@std@@@std@@QEAA@XZ @ 0x18005460C
 * Callers:
 *     _MPCRawInputProvider::_MPCRawInputProvider_::_1_::dtor$3 @ 0x1800A1B64 (_MPCRawInputProvider--_MPCRawInputProvider_--_1_--dtor$3.c)
 * Callees:
