/*
 * XREFs of ?OnTargetChanged@MobileCursorBroker@@UEAAJPEAUCursorId@@@Z @ 0x180025F90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_19:
  ...
  if ( (v6 & 0x80000000) != 0 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) == 0 )
      goto LABEL_11;
    Template_qqq(v9, &MinInput_Warning_CheckResult, 0, 581, v6);
  }
  v10 = Microsoft_OneCore_MinInputEnableBits;
LABEL_11:
  if ( (v6 & 0x80000000) != 0 )
  {
    if ( (v10 & 2) != 0 )
      Template_qqq(v9, &MinInput_Warning_CheckResult, 0, 240, v6);
    return v6;
  }
  v11 = *((_DWORD *)v8 + 16) == 0;
  *((_BYTE *)v8 + 56) = 1;
