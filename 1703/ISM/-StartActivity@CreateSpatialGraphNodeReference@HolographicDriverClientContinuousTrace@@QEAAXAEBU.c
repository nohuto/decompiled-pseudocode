/*
 * XREFs of ?StartActivity@CreateSpatialGraphNodeReference@HolographicDriverClientContinuousTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@@Z @ 0x18008EB50
 * Callers:
        ...
        const struct SPATIAL_NODE_ID *a3)
{
  ...
  _QWORD *v13; // rbx
  _QWORD *Local; // rcx
  PSRWLOCK SRWLock[2]; // [rsp+30h] [rbp-39h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+40h] [rbp-29h] BYREF
  PSRWLOCK *v17; // [rsp+60h] [rbp-9h]
  int v18; // [rsp+68h] [rbp-1h]
  int v19; // [rsp+6Ch] [rbp+3h]
  const struct _GUID *v20; // [rsp+70h] [rbp+7h]
  int v21; // [rsp+78h] [rbp+Fh]
  int v22; // [rsp+7Ch] [rbp+13h]
  const struct SPATIAL_NODE_ID *v23; // [rsp+80h] [rbp+17h]
  ...
  *(_DWORD *)v6 = 1;
  ...
  if ( *(_DWORD *)v9 > 5u )
  {
    ...
    TlgWrite(v9, &unk_1800BAEAF, (LPCGUID)(v11 + 8), v12, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
