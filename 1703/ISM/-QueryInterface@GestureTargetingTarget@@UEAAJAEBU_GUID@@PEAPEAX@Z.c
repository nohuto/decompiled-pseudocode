/*
 * XREFs of ?QueryInterface@GestureTargetingTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18000F2F0
 * Callers:
 *     ?QueryInterface@GestureTargetingTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180011060 (-QueryInterface@GestureTargetingTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
  ...
  if ( a3 )
  {
    ...
    else
    {
      ...
      if ( v6 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v7, &MinInput_Warning_CheckResult, 4, 136, v6);
    }
  }
  else
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq((__int64)this, &MinInput_Warning_CheckResult, 4, 107, 87);
  }
  return v3;
}
