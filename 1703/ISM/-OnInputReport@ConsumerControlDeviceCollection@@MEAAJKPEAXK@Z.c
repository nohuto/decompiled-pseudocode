/*
 * XREFs of ?OnInputReport@ConsumerControlDeviceCollection@@MEAAJKPEAXK@Z @ 0x18007D050
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  _BYTE v33[1888]; // [rsp+70h] [rbp-90h] BYREF
  USHORT UsageList[20]; // [rsp+7D0h] [rbp+6D0h] BYREF
  USHORT BreakUsageList[20]; // [rsp+7F8h] [rbp+6F8h] BYREF
  USHORT MakeUsageList[20]; // [rsp+820h] [rbp+720h] BYREF
  unsigned int v37; // [rsp+898h] [rbp+798h] BYREF
  ...
  {
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq((__int64)v14, &MinInput_Warning_CheckResult, 0, 215, v12);
    return v12;
  }
  ...
  while ( 1 )
  {
    ...
    if ( Usages < 0 )
    {
      ...
      {
        if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          Template_qqq(v18, &MinInput_Warning_CheckResult, 0, 243, v12);
        return v12;
      }
    }
    ...
    if ( DWORD2(PreviousUsageList) > 0x14 )
    {
      v12 = -2147467259;
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(v10, &MinInput_Warning_CheckResult, 0, 255, 5);
      return v12;
    }
    ...
    if ( v21 < 0 )
    {
      v12 = v21 | 0x10000000;
      if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
        Template_qqq(0LL, &MinInput_Warning_CheckResult, 0, 263, v21);
      return v12;
    }
  ...
  if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    v13 = 247;
LABEL_44:
    Template_qqq(v10, &MinInput_Warning_CheckResult, 0, v13, DeviceInfo);
  }
  return v12;
}
