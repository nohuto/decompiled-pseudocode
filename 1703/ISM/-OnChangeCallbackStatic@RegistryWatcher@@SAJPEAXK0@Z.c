/*
 * XREFs of ?OnChangeCallbackStatic@RegistryWatcher@@SAJPEAXK0@Z @ 0x1800097F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegistryWatcher::OnChangeCallbackStatic(RegistryWatcher *a1, int a2, void *a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq((__int64)a1, &MinInput_Warning_CheckResult, 0, 181, 255);
  }
  else
  {
    ...
    if ( v3 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v4, &MinInput_Warning_CheckResult, 0, 177, v3);
  }
  return v5;
}
