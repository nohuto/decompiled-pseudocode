/*
 * XREFs of ?SendGamepadAsPointerAndManipulation@ControllerProcessor@@AEAAJPEAUGamepadReading@Input@Gaming@Windows@@@Z @ 0x1800337C8
 * Callers:
 ...
 * Callees:
 *     SignedNormalize @ 0x1800317DC (SignedNormalize.c)
 ...
 *     ?CalculateMarginPanDelta@ControllerProcessor@@AEAAXXZ @ 0x180033B70 (-CalculateMarginPanDelta@ControllerProcessor@@AEAAXXZ.c)
        ...
        struct Windows::Gaming::Input::GamepadReading *a2)
{
  ...
  if ( *((_BYTE *)this + 1213) )
  {
    if ( (*((_BYTE *)this + 312) & 0xC) != 0 )
    {
      if ( *((float *)this + 94) == 0.0 && *((float *)this + 95) == 0.0 )
      {
        if ( *((_DWORD *)this + 302) == 1 )
