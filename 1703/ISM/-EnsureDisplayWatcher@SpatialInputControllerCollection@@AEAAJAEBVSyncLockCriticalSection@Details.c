/*
 * XREFs of ?EnsureDisplayWatcher@SpatialInputControllerCollection@@AEAAJAEBVSyncLockCriticalSection@Details@Wrappers@WRL@Microsoft@@@Z @ 0x180079690
 * Callers:
        ...
        const struct Microsoft::WRL::Wrappers::Details::SyncLockCriticalSection *a2)
{
  ...
  if ( !*((_QWORD *)this + 367) )
  {
    ...
    v20 = 0LL;
    v6 = (***((__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))this + 364))(
           *((_QWORD *)this + 364),
...
LABEL_19:
    ...
    v15 = this;
    v16[0] = v19;
    v7 = ((__int64 (__fastcall *)(char *, _QWORD *, SpatialInputControllerCollection **, const struct Microsoft::WRL::Wrappers::Details::SyncLockCriticalSection **))Microsoft::WRL::Details::MakeAndInitialize<DisplayChangedHandler,DisplayChangedHandler,Windows::Graphics::Holographic::Internal::IHolographicDisplayWatcher *,SpatialInputControllerCollection * const,bool>)(
           (char *)this + 2920,
           v16,
           &v15,
           &v18);
    ...
    v16[0] = this;
    v15 = v19;
    v7 = ((__int64 (__fastcall *)(char *, SpatialInputControllerCollection **, _QWORD *, const struct Microsoft::WRL::Wrappers::Details::SyncLockCriticalSection **))Microsoft::WRL::Details::MakeAndInitialize<DisplayChangedHandler,DisplayChangedHandler,Windows::Graphics::Holographic::Internal::IHolographicDisplayWatcher *,SpatialInputControllerCollection * const,bool>)(
           (char *)this + 2928,
           &v15,
           v16,
           &v18);
