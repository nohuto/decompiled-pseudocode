/*
 * XREFs of ?GetProcessId@MPCHFXInputTarget@@UEAAJPEAK@Z @ 0x180086A00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCHFXInputTarget::GetProcessId(MPCHFXInputTarget *this, unsigned int *a2)
{
  int v3; // eax
  unsigned int v4; // ebx
  __int64 v5; // rcx
