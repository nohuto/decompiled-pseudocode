/*
 * XREFs of std::_Func_impl__lambda_8f2520fc876669629b4fe94c8242ed3f__std::allocator_int__bool_Navigation::Server::IMonitorView_____ptr64_::_Do_call @ 0x18002C2F0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall std::_Func_impl__lambda_8f2520fc876669629b4fe94c8242ed3f__std::allocator_int__bool_Navigation::Server::IMonitorView_____ptr64_::_Do_call(
        __int64 a1,
        __int64 *a2)
{
  __int64 v2; // r9
