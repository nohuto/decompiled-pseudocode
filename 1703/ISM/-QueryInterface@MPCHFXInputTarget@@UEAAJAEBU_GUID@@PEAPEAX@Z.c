/*
 * XREFs of ?QueryInterface@MPCHFXInputTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180085D30
 * Callers:
 *     ?QueryInterface@MPCHFXInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180086DC0 (-QueryInterface@MPCHFXInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCHFXInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180086DF0 (-QueryInterface@MPCHFXInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCHFXInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180086E00 (-QueryInterface@MPCHFXInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall MPCHFXInputTarget::QueryInterface(
        ...
        const char *a4)
{
  ...
  {
    (*(void (__fastcall **)(MPCHFXInputTarget *))(*(_QWORD *)this + 8LL))(this);
    v7 = (char *)this + 24;
LABEL_13:
    *a3 = v7;
    return v6;
