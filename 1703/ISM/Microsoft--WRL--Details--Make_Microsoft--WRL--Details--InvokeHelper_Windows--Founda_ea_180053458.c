 ...
 * Callers:
 *     ??$Callback@U?$ITypedEventHandler@PEAVSpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAVSpatialNavigationUpdatedEventArgs@2345@@Foundation@Windows@@VMPCSpatialGestureRecognizerHandler@@PEAUISpatialGestureRecognizer@Spatial@Input@UI@3@PEAUISpatialNavigationUpdatedEventArgs@6783@@WRL@Microsoft@@YA?AV?$ComPtr@U?$ITypedEventHandler@PEAVSpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAVSpatialNavigationUpdatedEventArgs@2345@@Foundation@Windows@@@01@PEAVMPCSpatialGestureRecognizerHandler@@P83@EAAJPEAUISpatialGestureRecognizer@Spatial@Input@UI@Windows@@PEAUISpatialNavigationUpdatedEventArgs@5678@@Z@Z @ 0x180052914 (--$Callback@U-$ITypedEventHandler@PEAVSpatialGestureRecognizer@Spatial@Input@UI@Win_ea_180052914.c)
 * Callees:
