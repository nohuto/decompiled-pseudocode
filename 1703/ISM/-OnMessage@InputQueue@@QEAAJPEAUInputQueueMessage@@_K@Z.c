/*
 * XREFs of ?OnMessage@InputQueue@@QEAAJPEAUInputQueueMessage@@_K@Z @ 0x18006C590
 * Callers:
 ...
 *     ?OnItemMessage@InputQueueConversationHost@InputQueue@@UEAAJPEBX0I@Z @ 0x18006CBD0 (-OnItemMessage@InputQueueConversationHost@InputQueue@@UEAAJPEBX0I@Z.c)
 * Callees:
 *     ?_FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z @ 0x18000326C (-_FailFast_Unexpected@in1diag3@details@wil@@YAXPEAXIPEBD@Z.c)
 *     ?_FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x18000742C (-_FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ??$MakeAndInitialize@VInputAcknowledge@@V1@AEAIQEAVInputQueue@@@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@VInputAcknowledge@@@WRL@Microsoft@@@012@AEAI$$QEBQEAVInputQueue@@@Z @ 0x18006C868 (--$MakeAndInitialize@VInputAcknowledge@@V1@AEAIQEAVInputQueue@@@Details@WRL@Microsoft@@YAJV-$Com.c)
...
__int64 __fastcall InputQueue::OnMessage(void **this, struct InputQueueMessage *a2, unsigned int a3, const char *a4)
{
  ...
  if ( *(_DWORD *)a2 )
  {
    ...
    v15 = 0LL;
    v16 = (InputQueue *)this;
    v6 = Microsoft::WRL::Details::MakeAndInitialize<InputAcknowledge,InputAcknowledge,unsigned int &,InputQueue * const>(
           &v15,
           a2,
           &v16);
    if ( v6 < 0 )
    ...
    std::vector<unsigned int>::emplace_back<unsigned int const &>(this + 11, &InputQueue::s_nextEventId);
