/*
 * XREFs of ?UpdateMagnifier@MagnifierComponent@@AEAAJXZ @ 0x180081714
 * Callers:
...
__int64 __fastcall MagnifierComponent::UpdateMagnifier(MagnifierComponent *this)
{
  ...
  if ( *((_QWORD *)this + 9) )
  {
    ...
    if ( v13 < 0 && (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v14, &MinInput_Warning_CheckResult, 0, 553, v13);
  }
  else
  {
    v2 = -2147418113;
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq((__int64)this, &MinInput_Warning_CheckResult, 0, 548, 255);
  }
  return v2;
}
