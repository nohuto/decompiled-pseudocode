/*
 * XREFs of ?GetProperties@GestureTargetingTarget@@UEAAJPEAPEAVPropertyMap@Input@@@Z @ 0x18000F4E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GestureTargetingTarget::GetProperties(GestureTargetingTarget *this, struct Input::PropertyMap **a2)
{
    ...
    if ( v4 >= 0 )
    {
      if ( !v7 )
      {
        if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
          Template_qqq(0LL, &MinInput_Warning_CheckResult, v7 + 4, 197, 255);
  ...
  else
  {
    v4 = -2147418113;
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(0LL, &MinInput_Warning_CheckResult, 4, 186, 255);
  }
  v5 = v7;
  v7 = 0LL;
  if ( v5 )
