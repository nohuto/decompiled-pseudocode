/*
 * XREFs of ?GetProperties@MPCHFXInputTarget@@UEAAJPEAPEAVPropertyMap@Input@@@Z @ 0x180086950
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCHFXInputTarget::GetProperties(MPCHFXInputTarget *this, struct Input::PropertyMap **a2)
{
