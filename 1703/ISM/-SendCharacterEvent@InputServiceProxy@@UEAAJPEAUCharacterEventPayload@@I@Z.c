/*
 * XREFs of ?SendCharacterEvent@InputServiceProxy@@UEAAJPEAUCharacterEventPayload@@I@Z @ 0x1800886A0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a3)
{
  ...
  if ( (unsigned __int16)(v4 + 10240) > 0x3FFu )
  {
    ...
    else
    {
      ...
      if ( !v7 )
      {
        wil::details::in1diag3::Return_Hr_NoOriginate(
          retaddr,
          (void *)0x95,
          (__int64)"onecoreuap\\windows\\moderncore\\inputv2\\systeminputrouters\\dwm\\components\\inputservice\\lib\\inp"
                   "utserviceproxy.cpp",
    ...
    if ( *((_QWORD *)this + 4) )
    {
      ...
      v13 = -1;
      v12 = -1;
      v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64, __int16, __int16, _DWORD, int))(**((_QWORD **)this + 4) + 232LL))(
              *((_QWORD *)this + 4),
              *(unsigned __int16 *)a2,
              0LL,
              v14,
