/*
 * XREFs of ?Create@MobileButtonDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x18007BD4C
 * Callers:
...
LABEL_17:
        ...
        {
          Template_qqq(v14, &MinInput_Warning_CheckResult, 0, 45, v12);
        }
        if ( v12 < 0 )
          (*(void (__fastcall **)(_DWORD *, __int64))(*(_QWORD *)v10 + 24LL))(v10, 1LL);
        return (unsigned int)v12;
      }
      Template_qqq(v14, &MinInput_Warning_CheckResult, 0, 95, v12);
    }
    v15 = Microsoft_OneCore_MinInputEnableBits;
    goto LABEL_17;
  }
