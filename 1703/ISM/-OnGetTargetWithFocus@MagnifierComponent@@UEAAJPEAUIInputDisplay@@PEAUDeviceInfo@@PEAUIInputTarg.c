/*
 * XREFs of ?OnGetTargetWithFocus@MagnifierComponent@@UEAAJPEAUIInputDisplay@@PEAUDeviceInfo@@PEAUIInputTarget@@PEAUInputTargetingDecision@@@Z @ 0x180081320
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputTargetingDecision *a5)
{
  ...
  else
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq((__int64)this, &MinInput_Warning_CheckResult, 0, 235, 87);
  }
  return v5;
}
