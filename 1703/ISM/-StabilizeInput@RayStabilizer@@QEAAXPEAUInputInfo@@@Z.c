/*
 * XREFs of ?StabilizeInput@RayStabilizer@@QEAAXPEAUInputInfo@@@Z @ 0x18004E23C
 * Callers:
...
void __fastcall RayStabilizer::StabilizeInput(RayStabilizer *this, struct InputInfo *a2, __int64 a3, const char *a4)
{
  ...
  v5 = 1;
  v8 = *(_QWORD *)((char *)a2 + 740);
  *(_OWORD *)((char *)v26.m256i_i64 + 4) = *(_OWORD *)((char *)a2 + 724);
  v26.m256i_i32[0] = 1;
  ...
  *((_QWORD *)this + 3) = v11;
  ...
  if ( !v5 )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      a4);
    JUMPOUT(0x18004E432LL);
  }
  RayStabilizationResult::GetAtStep(&v26, &v24, (unsigned int)(v5 - 1));
  v23 = v25;
  *(_OWORD *)((char *)a2 + 724) = v24;
  *(_QWORD *)((char *)a2 + 740) = v23;
}
