/*
 * XREFs of ?DeviceAttached_@RawInputProvidersTracing@@QEAAXJKK@Z @ 0x180076140
 * Callers:
...
void __fastcall RawInputProvidersTracing::DeviceAttached_(RawInputProvidersTracing *this, int a2, int a3, int a4)
{
  __int64 v4; // rcx
  ...
  if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 2) != 0 && (*(_QWORD *)(v4 + 24) & 2LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    TlgWrite((TraceLoggingHProvider)v4, &unk_1800B9E1E, 0LL, 0LL, 5u, &pData);
  }
}
