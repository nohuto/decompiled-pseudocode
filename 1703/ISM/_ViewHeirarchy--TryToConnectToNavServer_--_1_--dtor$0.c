/*
 * XREFs of _ViewHeirarchy::TryToConnectToNavServer_::_1_::dtor$0 @ 0x1800A2B58
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall ViewHeirarchy::TryToConnectToNavServer_::_1_::dtor_0(__int64 a1, __int64 a2)
{
