/*
 * XREFs of ?DeliverInputToTarget@PointerProcessor@@AEAAJPEAUISystemInputRouter@@PEAUIInputDisplay@@PEAUInputInfo@@PEAPEAUPointer@@KPEAUIInputTarget@@@Z @ 0x18005E460
 * Callers:
        ...
        struct IInputTarget *a7)
{
  ...
  if ( v12 >= 0 )
  {
    v16 = a7;
    *((_QWORD *)a4 + 4) = v18;
    v12 = (*(__int64 (__fastcall **)(struct ISystemInputRouter *, struct InputInfo *, struct IInputTarget *))(*(_QWORD *)a2 + 64LL))(
            a2,
            a4,
            v16);
    v14 = v12;
  ...
  else if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
  {
    v15 = 580;
LABEL_10:
    Template_qqq(v13, &MinInput_Warning_CheckResult, 0, v15, v12);
  }
  return v14;
}
