/*
 * XREFs of _std::vector_Microsoft::WRL::ComPtr_WGIController__std::allocator_Microsoft::WRL::ComPtr_WGIController_____::emplace_back_Microsoft::WRL::ComPtr_WGIController____::_1_::catch$102 @ 0x1800A22EF
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$destroy@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@?$_Wrap_alloc@V?$allocator@V?$ComPtr@VWGIController@@@WRL@Microsoft@@@std@@@std@@QEAAXPEAV?$ComPtr@VWGIController@@@WRL@Microsoft@@@Z @ 0x180061AA8 (--$destroy@V-$ComPtr@VWGIController@@@WRL@Microsoft@@@-$_Wrap_alloc@V-$allocator@V-$ComPtr@VWGIC.c)
 *     _CxxThrowException_0 @ 0x18009E220 (_CxxThrowException_0.c)
 */

void __fastcall __noreturn std::vector_Microsoft::WRL::ComPtr_WGIController__std::allocator_Microsoft::WRL::ComPtr_WGIController_____::emplace_back_Microsoft::WRL::ComPtr_WGIController____::_1_::catch_102(
        __int64 a1,
        _QWORD *a2)
{
  char *v3; // rbx
  ...
  v3 = (char *)a2[16];
  v4 = (volatile signed __int64 **)std::_Unfancy<Microsoft::WRL::ComPtr<WGIController>>((__int64)&v3[8 * a2[19]]);
