/*
 * XREFs of ?RequestViewHitTest@DWMInputRouter@@UEAAJUViewHitTestInfo@@PEAUIRemoteViewHitTestRequestClient@@@Z @ 0x180016400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DWMInputRouter::RequestViewHitTest(__int64 a1, __int128 *a2, __int64 *a3)
{
  ...
  {
    Template_qqq(v7, &MinInput_Warning_CheckResult, 0, 1995, v6);
  }
  return v8;
}
