/*
 * XREFs of ?OnOrientationChanged@DWMCursorBroker@@UEAAJPEAUIInputDisplay@@W4DISPLAYCONFIG_ROTATION@@@Z @ 0x18001EC50
 * Callers:
 *     <none>
 * Callees:
        ...
        enum DISPLAYCONFIG_ROTATION a3)
{
  ...
  if ( (_DWORD)v8 )
  {
    ...
    if ( (Microsoft_OneCore_MinInputEnableBits & 2) != 0 )
      Template_qqq(v13, &MinInput_Warning_CheckResult, 0, 572, v12);
  }
  return v3;
}
