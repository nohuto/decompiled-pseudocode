/*
 * XREFs of ?OnMouseRegistryKeyChange@MouseAccelerator@@AEAAXPEAUHKEY__@@@Z @ 0x180059E24
 * Callers:
 *     ?OnMouseRegistryKeyChangeStatic@MouseAccelerator@@SAXPEAXPEAUHKEY__@@@Z @ 0x180059E10 (-OnMouseRegistryKeyChangeStatic@MouseAccelerator@@SAXPEAXPEAUHKEY__@@@Z.c)
 * Callees:
...
void __fastcall MouseAccelerator::OnMouseRegistryKeyChange(MouseAccelerator *this, HKEY hKey)
{
  ...
  {
LABEL_12:
    *(_OWORD *)this = xmmword_1800D2CF8;
    *((_OWORD *)this + 1) = xmmword_1800D2D08;
    *((_QWORD *)this + 4) = qword_1800D2D18;
    *(_OWORD *)((char *)this + 40) = xmmword_1800D2CD0;
    *(_OWORD *)((char *)this + 56) = xmmword_1800D2CE0;
    *((_QWORD *)this + 9) = qword_1800D2CF0;
  }
