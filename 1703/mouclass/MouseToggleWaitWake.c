/*
 * XREFs of MouseToggleWaitWake @ 0x1C0004DC8
 * Callers:
 *     MouseClassWaitWakeComplete @ 0x1C0004C10 (MouseClassWaitWakeComplete.c)
 *     MouseClassSetWmiDataBlock @ 0x1C000DFF0 (MouseClassSetWmiDataBlock.c)
 *     MouseClassSetWmiDataItem @ 0x1C000E080 (MouseClassSetWmiDataItem.c)
 * Callees:
