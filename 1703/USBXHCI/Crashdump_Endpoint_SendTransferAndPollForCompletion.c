/*
 * XREFs of Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x1C003508C
 * Callers:
 *     Crashdump_Endpoint_SendBulkTransfer @ 0x1C0034C3C (Crashdump_Endpoint_SendBulkTransfer.c)
...
__int64 __fastcall Crashdump_Endpoint_SendTransferAndPollForCompletion(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 24);
  v3 = *(_DWORD *)(a1 + 32);
  *(_DWORD *)(*(_QWORD *)(**(_QWORD **)(v1 + 8) + 48LL) + 4LL * *(unsigned __int8 *)(v1 + 56)) = (unsigned __int8)v3 | ((*(_BYTE *)(a1 + 160) != 0) << 16);
  _InterlockedOr(v9, 0);
