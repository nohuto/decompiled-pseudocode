/*
 * XREFs of Command_HandleCommandRingStoppedEvent @ 0x1C0017CAC
 * Callers:
...
void __fastcall Command_HandleCommandRingStoppedEvent(__int64 a1, __int64 *a2)
{
  ...
  _QWORD *v26; // rax
  __int64 v27; // rcx
  signed __int32 v28[10]; // [rsp+0h] [rbp-60h] BYREF
  _QWORD *i; // [rsp+40h] [rbp-20h] BYREF
  _QWORD *v30; // [rsp+48h] [rbp-18h]
  ...
  *(_BYTE *)(a1 + 137) = 0;
  ...
  WPP_RECORDER_SF_xx(*(_QWORD *)(a1 + 16), v7, v12, v13, v28[8], v11, *a2);
  if ( v10 == v11 || v10 == *(_QWORD *)(a1 + 56) && !*(_DWORD *)(a1 + 72) )
  {
    ...
    if ( *v14 != (__int64 *)v14 )
    {
      ...
      else
      {
        ...
        *(_DWORD *)(a1 + 72) = v20;
        ...
        v24 = *(_DWORD **)(a1 + 40);
        v25 = *(_OWORD *)(*(_QWORD *)(a1 + 8) + 232LL) & 1;
        v31 = *(_OWORD *)(*(_QWORD *)(a1 + 8) + 232LL);
        if ( v25 )
        {
          *v24 = v23;
      ...
      if ( *v14 != (__int64 *)v14 )
      {
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 16), 4u, 6u, 0x28u, (__int64)&WPP_d70eb0a3d0963e3ced97f288f7a4c0c9_Traceguids);
        **(_DWORD **)(a1 + 48) = 0;
        _InterlockedOr(v28, 0);
      }
    }
    ...
    {
      v26 = (_QWORD *)*v17;
      if ( (_QWORD **)v17[1] != &i || (_QWORD *)v26[1] != v17 )
        __fastfail(3u);
      i = (_QWORD *)*v17;
      v26[1] = &i;
...
LABEL_24:
  ...
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 16), 4u, 6u, 0x29u, (__int64)&WPP_d70eb0a3d0963e3ced97f288f7a4c0c9_Traceguids);
  ...
  {
    *((_BYTE *)v5 + 68) = 25;
    Etw_CommandCompleteError(v27, a1, v5, 2LL);
