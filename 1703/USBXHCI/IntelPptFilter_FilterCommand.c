/*
 * XREFs of IntelPptFilter_FilterCommand @ 0x1C00570E0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_ @ 0x1C0002180 (WPP_RECORDER_SF_.c)
 *     IntelPptFilter_CheckAndIncreaseEndpointCount @ 0x1C005701C (IntelPptFilter_CheckAndIncreaseEndpointCount.c)
