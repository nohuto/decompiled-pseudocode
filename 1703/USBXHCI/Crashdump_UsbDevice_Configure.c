/*
 * XREFs of Crashdump_UsbDevice_Configure @ 0x1C0035560
 * Callers:
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C00360B8 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C00361F4 (Crashdump_UsbDevice_ReConfigureOnPortReset.c)
 * Callees:
...
__int64 __fastcall Crashdump_UsbDevice_Configure(__int64 a1, int a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      v7 = *(_QWORD *)(a1 + 152);
      v17 = *(unsigned __int8 *)(a1 + 401);
      v16 = 2304;
      v18 = 0;
      v8 = Crashdump_Endpoint_SendControlTransfer(v7, (unsigned __int8 *)&v16, 0, 0LL);
      v4 = v8;
      if ( v8 >= 0 )
      {
        v9 = *(_BYTE *)(a1 + 403);
        if ( v9
          && (v10 = *(_QWORD *)(a1 + 152),
              v17 = v9,
              v18 = *(unsigned __int8 *)(a1 + 402),
              v16 = 2817,
              v11 = Crashdump_Endpoint_SendControlTransfer(v10, (unsigned __int8 *)&v16, 0, 0LL),
              v4 = v11,
              v11 < 0) )
        {
        ...
        else if ( *(_BYTE *)(a1 + 400) )
        {
          if ( a2 == 30 )
          {
            ...
            v16 = 3104;
            v18 = 0;
            v13 = Crashdump_Endpoint_SendControlTransfer(v12, (unsigned __int8 *)&v16, 0, 0LL);
            v4 = v13;
            if ( v13 < 0 )
              DbgPrintEx(
                0x93u,
