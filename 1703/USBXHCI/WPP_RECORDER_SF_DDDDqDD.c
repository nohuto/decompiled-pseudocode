/*
 * XREFs of WPP_RECORDER_SF_DDDDqDD @ 0x1C002C1C0
 * Callers:
...
__int64 WPP_RECORDER_SF_DDDDqDD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      ...
      0LL);
  LOWORD(v7) = 19;
  return WppAutoLogTrace(a1, 5LL, 13LL, &WPP_d7490787d28e3e661d2cad56214ea32b_Traceguids, v7, (__int64 *)va);
}
