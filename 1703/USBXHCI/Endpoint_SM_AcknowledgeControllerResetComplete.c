/*
 * XREFs of Endpoint_SM_AcknowledgeControllerResetComplete @ 0x1C001FCD0
 * Callers:
 *     ESM_AcknowledgingControllerResetCompleteInDisabled @ 0x1C0037790 (ESM_AcknowledgingControllerResetCompleteInDisabled.c)
 * Callees:
 *     <none>
 */
