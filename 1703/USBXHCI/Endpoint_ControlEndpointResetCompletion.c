/*
 * XREFs of Endpoint_ControlEndpointResetCompletion @ 0x1C001D1E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Endpoint_ControlEndpointResetCompletion(_QWORD *a1, int a2, _QWORD *a3)
{
  ...
  if ( a2 == 3 )
  {
    ...
    WPP_RECORDER_SF_dd(v3[10], 4u, 0xCu, 0x51u, (__int64)&WPP_dfd1540ede223d0a50a10695a1612c8d_Traceguids, v12, v14);
  }
  else
  {
    v6 = *((_BYTE *)a1 + 68);
