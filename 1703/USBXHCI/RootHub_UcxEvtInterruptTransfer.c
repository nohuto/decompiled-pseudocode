/*
 * XREFs of RootHub_UcxEvtInterruptTransfer @ 0x1C0006590
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RootHub_HideInvalidDebugPortStatusAndChange @ 0x1C0023C0C (RootHub_HideInvalidDebugPortStatusAndChange.c)
 */
