/*
 * XREFs of RootHub_PrepareHardware @ 0x1C004F420
 * Callers:
 ...
 *     RootHub_DumpPortData @ 0x1C0009820 (RootHub_DumpPortData.c)
 *     Register_FindNextExtendedCapability @ 0x1C0009A1C (Register_FindNextExtendedCapability.c)
...
LABEL_25:
    ...
    for ( k = 0; k < *(_DWORD *)(a1 + 16); ++k )
    {
      ...
      {
        v23 = ExAllocatePoolWithTag(*((POOL_TYPE *)&WPP_MAIN_CB.AlignmentRequirement + 1), 0x10uLL, 0x49434858u);
        v24 = v23;
        if ( !v23 )
        {
          v28 = -1073741670;
