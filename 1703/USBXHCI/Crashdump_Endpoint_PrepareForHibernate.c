/*
 * XREFs of Crashdump_Endpoint_PrepareForHibernate @ 0x1C0034B7C
 * Callers:
 *     Crashdump_UsbDevice_PrepareForHibernate @ 0x1C0035FC4 (Crashdump_UsbDevice_PrepareForHibernate.c)
 * Callees:
 *     memset @ 0x1C0010E80 (memset.c)
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x1C00351AC (Crashdump_Endpoint_SetDequeuePointer.c)
 *     Crashdump_Endpoint_StopEndpoint @ 0x1C003527C (Crashdump_Endpoint_StopEndpoint.c)
 */
