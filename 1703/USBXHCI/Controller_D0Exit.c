/*
 * XREFs of Controller_D0Exit @ 0x1C00043A8
 * Callers:
...
__int64 __fastcall Controller_D0Exit(_QWORD *a1, char a2, __int64 a3)
{
  ...
  {
    LOBYTE(v5) = 5;
    WPP_RECORDER_SF_qL(a1[8], v5, 3, 120, (__int64)&WPP_701346eebafd3a8cb9c6116049697060_Traceguids, (char)a1, a2);
  }
  result = Register_ControllerStop(a1[10]);
  if ( (int)result < 0 )
  {
    LOBYTE(v7) = 2;
    return WPP_RECORDER_SF_d(a1[8], v7, 3, 121, (__int64)&WPP_701346eebafd3a8cb9c6116049697060_Traceguids, result);
  }
  return result;
}
