/*
 * XREFs of RootHub_UcxEvtGetPortStatus @ 0x1C0006A70
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( *(_WORD *)(v5 + 130) == 2 )
          {
            ...
            *(_DWORD *)(v27 + 4) = 0;
            if ( *(_WORD *)(*(_QWORD *)(v3 + 48) + v11 + 46) || (v10 & 0x3C00) != 0x400 )
              ...
              *(_DWORD *)(v27 + 4) = 68;
            v41 = ((unsigned __int16)(v40 >> 8) ^ *(_WORD *)(v27 + 4) ^ (*(_WORD *)(v27 + 4) ^ (unsigned __int16)(v40 >> 8)) & 0xF00) & 0xF000 ^ *(_DWORD *)(v27 + 4) ^ (*(_DWORD *)(v27 + 4) ^ (v40 >> 8)) & 0xF00;
            *(_DWORD *)(v27 + 4) = v41;
            LODWORD(v55) = v41;
            WPP_RECORDER_SF_d(
              *(_QWORD *)(*(_QWORD *)(v3 + 8) + 64LL),
