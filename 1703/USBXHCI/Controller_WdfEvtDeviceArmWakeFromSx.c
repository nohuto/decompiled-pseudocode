/*
 * XREFs of Controller_WdfEvtDeviceArmWakeFromSx @ 0x1C001C390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceArmWakeFromSx(__int64 a1)
{
  ...
  v2 = *(_QWORD *)((*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
                     ...
                     off_1C0045318)
                 + 8);
  WPP_RECORDER_SF_q(*(_QWORD *)(v2 + 64), 4u, 3u, 0x5Bu, (__int64)&WPP_701346eebafd3a8cb9c6116049697060_Traceguids, a1);
  *(_BYTE *)(v2 + 356) = 1;
  return 0LL;
}
