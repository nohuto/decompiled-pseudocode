/*
 * XREFs of UsbDevice_UcxEvtDeviceAdd @ 0x1C0056120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UsbDevice_UcxEvtDeviceAdd(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _QWORD v22[7]; // [rsp+50h] [rbp-61h] BYREF
  ...
  v23[1] = UsbDevice_UcxEvtEndpointsConfigure;
  v23[2] = UsbDevice_UcxEvtEnable;
  v23[3] = UsbDevice_UcxEvtDisable;
  v23[4] = UsbDevice_UcxEvtReset;
  v23[5] = UsbDevice_UcxEvtAddress;
  v23[6] = UsbDevice_UcxEvtUpdate;
  v23[7] = UsbDevice_UcxEvtHubInfo;
  v23[8] = Endpoint_UcxEvtUsbDeviceDefaultEndpointAdd;
  v23[9] = Endpoint_UcxEvtUsbDeviceEndpointAdd;
  LODWORD(v23[0]) = 96;
  ((void (__fastcall *)(void *, __int64, _QWORD *))qword_1C0046760)(WPP_MAIN_CB.Dpc.SystemArgument2, v24, v23);
  memset(v22, 0, sizeof(v22));
  LODWORD(v22[0]) = 56;
  v22[3] = 0x100000001LL;
  v22[6] = off_1C0045250;
  v22[1] = UsbDevice_EvtUsbDeviceCleanupCallback;
  v7 = ((__int64 (__fastcall *)(void *, __int64, __int64 *, _QWORD *, __int64 *))qword_1C0046758)(
  ...
  if ( v7 >= 0 )
  {
    WPP_RECORDER_SF_q(v5[8], 4u, 0xBu, 0xBu, (__int64)&WPP_b259b106ca84381176d433aab66af5b0_Traceguids, v25);
  ...
  {
    WPP_RECORDER_SF_d(v5[8], 2u, 0xBu, 0xAu, (__int64)&WPP_b259b106ca84381176d433aab66af5b0_Traceguids, v7);
  }
  return v8;
}
