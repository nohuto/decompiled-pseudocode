/*
 * XREFs of WPP_RECORDER_SF_ddqqD @ 0x1C00227A0
 * Callers:
...
__int64 WPP_RECORDER_SF_ddqqD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x800) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      ...
      43LL,
      &WPP_dfd1540ede223d0a50a10695a1612c8d_Traceguids,
      114LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 114;
  return WppAutoLogTrace(a1, 4LL, 12LL, &WPP_dfd1540ede223d0a50a10695a1612c8d_Traceguids, v7, (__int64 *)va);
}
