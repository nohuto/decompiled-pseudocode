/*
 * XREFs of Endpoint_OnResetEndpointConfigureCompletion_EpDropped @ 0x1C001F630
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Endpoint_OnResetEndpointConfigureCompletion_EpDropped(__int64 a1, int a2)
{
  ...
  if ( a2 == 3 )
  {
    ...
    WPP_RECORDER_SF_dd(v3[10], 4u, 0xCu, 0x31u, (__int64)&WPP_dfd1540ede223d0a50a10695a1612c8d_Traceguids, v12, v15);
    goto LABEL_5;
  }
  v7 = *(_BYTE *)(a1 + 68);
  if ( v7 != 1 )
...
LABEL_5:
  ...
  WPP_RECORDER_SF_dd(v3[10], 4u, 0xCu, 0x33u, (__int64)&WPP_dfd1540ede223d0a50a10695a1612c8d_Traceguids, v14, v17);
  for ( i = 1;
        i <= *(_DWORD *)(v3[17] + 8);
