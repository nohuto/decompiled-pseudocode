/*
 * XREFs of Endpoint_UcxEvtUsbDeviceDefaultEndpointAdd @ 0x1C00550D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtUsbDeviceDefaultEndpointAdd(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  ...
  ((void (__fastcall *)(void *, __int64, _QWORD *))qword_1C0046790)(WPP_MAIN_CB.Dpc.SystemArgument2, a4, v21);
