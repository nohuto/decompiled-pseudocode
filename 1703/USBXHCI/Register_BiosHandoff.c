/*
 * XREFs of Register_BiosHandoff @ 0x1C0006044
 * Callers:
...
LABEL_5:
    ...
    LOBYTE(v3) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v6 + 64), v3, 5, 50, (__int64)&WPP_f8b782a53c8b302afa62a8c5f226bdbd_Traceguids, 208);
    v11 = 1LL;
    goto LABEL_19;
  }
  WPP_RECORDER_SF_(*(_QWORD *)(a1[1] + 64LL), 3u, 5u, 0x2Eu, (__int64)&WPP_f8b782a53c8b302afa62a8c5f226bdbd_Traceguids);
LABEL_6:
  if ( (*(_DWORD *)(a1[4] + 4LL) & 1) == 0 )
  {
    v12 = a1[1];
    v18 = *(_OWORD *)(v12 + 232);
    if ( (unsigned __int64)v18 >= 0x8000000000000000uLL )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(v12 + 64), 2u, 5u, 0x33u, (__int64)&WPP_f8b782a53c8b302afa62a8c5f226bdbd_Traceguids);
      v11 = 2LL;
LABEL_19:
      Etw_StartDeviceFail(a1[1], v10, v11);
      return (unsigned int)-1073741823;
    }
    WPP_RECORDER_SF_(*(_QWORD *)(v12 + 64), 2u, 5u, 0x34u, (__int64)&WPP_f8b782a53c8b302afa62a8c5f226bdbd_Traceguids);
