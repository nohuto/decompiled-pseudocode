...
NTSTATUS __stdcall DriverEntry_0(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  qword_1C00464F0 = (__int64)DriverObject;
  DestinationString.Buffer = (wchar_t *)&unk_1C0046500;
  *(_DWORD *)&DestinationString.Length = 34078720;
  RtlCopyUnicodeString(&DestinationString, RegistryPath);
  result = WdfVersionBind_0(DriverObject, &DestinationString, &unk_1C0045000, &WdfDriverGlobals);
  if ( result >= 0 )
  {
    WdfDriverMiniportUnloadOverride = *(_QWORD *)(WdfFunctions_01015 + 1608);
    inited = FxStubBindClasses((struct _WDF_BIND_INFO *)&unk_1C0045000);
    if ( inited < 0
    ...
    else
    {
      ...
      {
        DriverUnload = (void (__fastcall *)(_DRIVER_OBJECT *))qword_1C00464D8;
        if ( DriverObject->DriverUnload )
          DriverUnload = DriverObject->DriverUnload;
        qword_1C00464D8 = (__int64)DriverUnload;
