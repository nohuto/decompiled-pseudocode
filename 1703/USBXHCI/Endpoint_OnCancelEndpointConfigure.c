/*
 * XREFs of Endpoint_OnCancelEndpointConfigure @ 0x1C001E794
 * Callers:
 *     ESM_ReconfiguringEndpointAfterStop @ 0x1C0037E30 (ESM_ReconfiguringEndpointAfterStop.c)
 * Callees:
...
void __fastcall Endpoint_OnCancelEndpointConfigure(__int64 *a1)
{
  ...
  else
  {
    ...
    WPP_RECORDER_SF_dd(a1[10], 2u, 0xCu, 0x43u, (__int64)&WPP_dfd1540ede223d0a50a10695a1612c8d_Traceguids, v13, v14);
