/*
 * XREFs of Controller_D0EntryRestoreState @ 0x1C001A6AC
 * Callers:
...
__int64 __fastcall Controller_D0EntryRestoreState(__int64 a1)
{
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 4u, 3u, 0x6Au, (__int64)&WPP_701346eebafd3a8cb9c6116049697060_Traceguids);
  ...
  if ( (v5 & 0x200) != 0 )
  {
    v6 = 109;
LABEL_5:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, v6, (__int64)&WPP_701346eebafd3a8cb9c6116049697060_Traceguids);
LABEL_16:
    v15 = -1073741630;
    goto LABEL_17;
  }
  *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 80) + 32LL) + 20LL) = 2;
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 4u, 3u, 0x6Eu, (__int64)&WPP_701346eebafd3a8cb9c6116049697060_Traceguids);
