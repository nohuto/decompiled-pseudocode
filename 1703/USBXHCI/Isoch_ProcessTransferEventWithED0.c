/*
 * XREFs of Isoch_ProcessTransferEventWithED0 @ 0x1C00286C0
 * Callers:
...
char __fastcall Isoch_ProcessTransferEventWithED0(__int64 a1, __int64 a2)
{
  ...
  PMDL v14; // rbx
  __int64 v15; // rcx
  PMDL *v17; // [rsp+60h] [rbp-38h] BYREF
    ...
    if ( v8 == 20 )
    {
      WPP_RECORDER_SF_DDLx(
        ...
        *(unsigned __int8 *)(*(_QWORD *)(a2 + 48) + 135LL),
        20,
        v7);
      ((void (__fastcall *)(void *, _QWORD))qword_1C00467B0)(
  ...
  if ( (*(_DWORD *)(a2 + 280) & 0x40) == 0 )
  {
    ...
    if ( (unsigned int)*(unsigned __int8 *)(a1 + 11) - 26 > 2 )
    {
      ...
      if ( !v17 )
        return v4;
      v14 = *v17;
      Isoch_CompleteStaleTransfers(a2, (__int64 ***)*v17);
