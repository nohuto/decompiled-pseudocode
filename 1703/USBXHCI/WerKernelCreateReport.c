/*
 * XREFs of WerKernelCreateReport @ 0x1C003885C
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C0056760 (TelemetryData_SubmitReport.c)
 * Callees:
 *     CheckSpaceAvailable @ 0x1C0038694 (CheckSpaceAvailable.c)
 *     WerpCreateRegistryKey @ 0x1C0039304 (WerpCreateRegistryKey.c)
 */
