/*
 * XREFs of Crashdump_UsbDevice_SendAddressDeviceCommand @ 0x1C00364A4
 * Callers:
...
__int64 __fastcall Crashdump_UsbDevice_SendAddressDeviceCommand(__int64 *a1)
{
  ...
  *(_DWORD *)(v5 + v3) ^= (*(_DWORD *)(v5 + v3) ^ *((_DWORD *)a1 + 20)) & 0xFFFFF;
  v6 = *(_DWORD *)(v5 + v3) ^ (*((_DWORD *)a1 + 20) ^ *(_DWORD *)(v5 + v3)) & 0xF00000;
  *(_DWORD *)(v5 + v3) = v6;
  v7 = *((_BYTE *)a1 + 86);
  *(_DWORD *)(v5 + v3) = v6 & 0x7FFFFFF | 0x8000000;
  *(_BYTE *)(v5 + v3 + 6) = v7;
  v8 = a1[19];
  *(_DWORD *)(v4 + v3 + 4) ^= (*(_DWORD *)(v8 + 52) ^ *(_DWORD *)(v4 + v3 + 4)) & 0x38;
  *(_WORD *)(v4 + v3 + 6) = *(_WORD *)(v8 + 54);
  *(_DWORD *)(v4 + v3 + 4) ^= (*(_DWORD *)(v8 + 52) ^ *(_DWORD *)(v4 + v3 + 4)) & 6;
  if ( *(_BYTE *)(v8 + 160) )
    v9 = *(_QWORD *)(v8 + 168);
  else
