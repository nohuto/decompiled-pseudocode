/*
 * XREFs of Endpoint_OnCancelEndpointConfigureCompletion_EpDropped @ 0x1C001EAB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Endpoint_OnCancelEndpointConfigureCompletion_EpDropped(__int64 a1, int a2)
{
  ...
  if ( a2 == 3 )
  {
    ...
    WPP_RECORDER_SF_dd(v2[10], 4u, 0xCu, 0x44u, (__int64)&WPP_dfd1540ede223d0a50a10695a1612c8d_Traceguids, v7, v10);
  }
  else
  {
    v5 = *(_BYTE *)(a1 + 68);
    if ( v5 == 1 )
    {
      ...
      WPP_RECORDER_SF_dd(v2[10], 4u, 0xCu, 0x46u, (__int64)&WPP_dfd1540ede223d0a50a10695a1612c8d_Traceguids, v9, v12);
