/*
 * XREFs of Endpoint_UcxEvtEndpointStaticStreamsAdd @ 0x1C00212B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtEndpointStaticStreamsAdd(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v18[3] = 0x100000001LL;
  v18[5] = 88 * v4 + 40;
  v6 = ((__int64 (__fastcall *)(void *, __int64, __int64 *, _QWORD *, __int64 *))qword_1C00467C0)(
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_DWORD *)(v8 + 8) = v4;
    ...
    for ( i = v8 + 40; ; i += 88LL )
    {
      ...
      v17[0] = 24LL;
      v17[2] = v12;
      ((void (__fastcall *)(void *, __int64, _QWORD *))qword_1C00467B8)(WPP_MAIN_CB.Dpc.SystemArgument2, v20, v17);
      ++v10;
