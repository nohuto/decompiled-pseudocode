/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x1C00326C4
 * Callers:
 *     Crashdump_Initialize @ 0x1C0031FB0 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_EventRing_PrepareForHibernate @ 0x1C003432C (Crashdump_EventRing_PrepareForHibernate.c)
 *     Crashdump_Command_PrepareForDump @ 0x1C00344EC (Crashdump_Command_PrepareForDump.c)
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C0034904 (Crashdump_Command_TestCommandRingOperation.c)
...
__int64 __fastcall Crashdump_InitializeWithoutControllerReset(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 71), 408 * Address[134], 0x43434858u);
  PoSetHiberRange(0LL, 0x10000u, *(PVOID *)Address, 0x78uLL, 0x43434858u);
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 77), 0x1A8uLL, 0x43434858u);
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 22), 0x50uLL, 0x43434858u);
  **(_DWORD **)(*(_QWORD *)Address + 32LL) &= ~0x400u;
  ...
  Crashdump_EventRing_PrepareForHibernate(Address + 50, *(_QWORD *)(*((_QWORD *)Address + 77) + 96LL));
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( Address[134] )
      {
        while ( 1 )
        {
          v9 = Crashdump_UsbDevice_PrepareForHibernate(*((_QWORD *)Address + 71) + 408LL * v8);
          v6 = v9;
          if ( v9 < 0 )
            break;
          if ( ++v8 >= Address[134] )
