/*
 * XREFs of WPP_RECORDER_SF_DDqDDDD @ 0x1C0029CF0
 * Callers:
...
__int64 WPP_RECORDER_SF_DDqDDDD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      ...
      0LL);
  LOWORD(v7) = 44;
  return WppAutoLogTrace(a1, 4LL, 13LL, &WPP_c87b452ab34c376f0ccab5d524638647_Traceguids, v7, (__int64 *)va);
}
