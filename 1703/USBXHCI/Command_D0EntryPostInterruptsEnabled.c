/*
 * XREFs of Command_D0EntryPostInterruptsEnabled @ 0x1C00051FC
 * Callers:
  ...
  if ( a2 == 5 )
  {
    ...
    if ( v4 == 4147 || v4 == 6418 || v4 == 6945 || !_stricmp((const char *)(v3 + 200), "NVDA") )
    {
      *(_QWORD *)(*(_QWORD *)(a1 + 8) + 224LL) = -1LL;
      PoolWithTag = ExAllocatePoolWithTag(*((POOL_TYPE *)&WPP_MAIN_CB.AlignmentRequirement + 1), 0x70uLL, 0x49434858u);
      if ( !PoolWithTag )
      {
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 16), 3u, 6u, 0x1Au, (__int64)&WPP_d70eb0a3d0963e3ced97f288f7a4c0c9_Traceguids);
        return 0LL;
      }
