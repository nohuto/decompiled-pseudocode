/*
 * XREFs of DriverEntry @ 0x1C00505D0
 * Callers:
 *     DriverEntry_0 @ 0x1C0010680 (DriverEntry_0.c)
 * Callees:
 *     McGenEventRegister @ 0x1C000AEA0 (McGenEventRegister.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)v4 = v4;
  ...
  dword_1C00453B8 = WPP_MAIN_CB.Queue.Wcb.WaitQueueEntry.SortKey;
  qword_1C00453BC = (__int64)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine;
  dword_1C00453C4 = *((_DWORD *)&WPP_MAIN_CB.Queue.Wcb.1 + 5);
  dword_1C00453C8 = (int)WPP_MAIN_CB.Queue.Wcb.DeviceContext;
  qword_1C00453E0 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 3448))(WdfDriverGlobals);
