/*
 * XREFs of UsbDevice_InitializeEndpointContext @ 0x1C002DE50
 * Callers:
 ...
 *     Endpoint_GetMaxPrimaryStreams @ 0x1C001E670 (Endpoint_GetMaxPrimaryStreams.c)
 */
...
__int64 __fastcall UsbDevice_InitializeEndpointContext(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  signed __int64 v25[3]; // [rsp+20h] [rbp-18h] BYREF

  v4 = 0;
  *(_DWORD *)(a3 + 4) ^= (*(_DWORD *)(a3 + 4) ^ (8 * *(_DWORD *)(a2 + 120))) & 0x38;
  *(_WORD *)(a3 + 6) = *(_WORD *)(a2 + 100) & 0x7FF;
  v7 = *(_BYTE *)(a2 + 99) & 3;
  *(_OWORD *)v25 = *(_OWORD *)(*(_QWORD *)a2 + 232LL);
  if ( v7 == 1
    || ((v7 == 3) & _bittest64(v25, 0x34u)) != 0
    && *(_BYTE *)(a2 + 98) >= 0x80u
  ...
  v10 = (2 * v9) | *(_DWORD *)(a3 + 4) & 0xFFFFFFF9;
  *(_DWORD *)(a3 + 4) = v10;
  v11 = *(_DWORD *)(a1 + 20);
  v12 = *(_BYTE *)(a2 + 102);
  switch ( v11 )
...
LABEL_26:
    ...
    case 3:
      if ( ((((v10 >> 3) & 7) - 1) & 0xFFFFFFF9) == 0 )
      {
        ...
        if ( v17 < 0x80u )
        {
          ...
          *(_DWORD *)a3 ^= (*(_DWORD *)a3 ^ (v17 << 8)) & 0x300;
        }
        else
        {
          v4 = *(_DWORD *)(a2 + 113);
  ...
  *v19 ^= (*v19 ^ (MaxPrimaryStreams << 10)) & 0x7C00;
  result = Endpoint_GetDequeuePointer(v20, 0);
  *(_QWORD *)(v22 + 8) = result;
  if ( (v23 & 0x7C00) != 0 )
    v24 = v23 | 0x8000;
  else
