/*
 * XREFs of Bulk_ProcessStreamOnEndpointStopOrHalt @ 0x1C002B0B8
 * Callers:
 *     Bulk_EP_EndpointHalted @ 0x1C002A9F0 (Bulk_EP_EndpointHalted.c)
 *     Bulk_EP_FSEReceived @ 0x1C002AA50 (Bulk_EP_FSEReceived.c)
 * Callees:
