/*
 * XREFs of Controller_WdfEvtDeviceReleaseHardware @ 0x1C0054360
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RootHub_ReleaseHardware @ 0x1C0055890 (RootHub_ReleaseHardware.c)
 */
...
__int64 __fastcall Controller_WdfEvtDeviceReleaseHardware(__int64 a1)
{
  ...
  v2 = *(__int64 **)((*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
                       ...
                       off_1C0045318)
                   + 8);
  WPP_RECORDER_SF_q(v2[8], 4u, 3u, 0x34u, (__int64)&WPP_701346eebafd3a8cb9c6116049697060_Traceguids, a1);
