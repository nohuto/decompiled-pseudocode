/*
 * XREFs of Command_InternalSendCommand @ 0x1C0017F70
 * Callers:
 ...
 *     Etw_CommandWaitlisted @ 0x1C0030AE8 (Etw_CommandWaitlisted.c)
...
LABEL_34:
  ...
  *(_DWORD *)(a2 + 64) = 10;
  ...
  v14 = *(_DWORD *)(a1 + 68);
  v15 = *(_DWORD *)(a1 + 72);
  if ( v14 + 1 != *(_DWORD *)(a1 + 64) )
    v13 = v14 + 1;
  if ( v13 == v15 )
  {
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_qddd(*(_QWORD *)(a1 + 16), v13, v14, v12, v23, a2, v14, v15, v13);
    *(_DWORD *)(a2 + 16) = 0;
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc & 0x20) != 0 )
    Template_ppb(v11, v13, v14, *(_QWORD *)(*(_QWORD *)(a1 + 8) + 8LL), a2, a2 + 24);
  *(_DWORD *)(a2 + 36) = *(_DWORD *)(a2 + 36) & 0xFFFFFFFE | (*(_DWORD *)(a1 + 76) != 1);
