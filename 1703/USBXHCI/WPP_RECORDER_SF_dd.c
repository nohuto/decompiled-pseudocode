/*
 * XREFs of WPP_RECORDER_SF_Dd @ 0x1C0022DF8
 * Callers:
...
__int64 WPP_RECORDER_SF_Dd(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x80u) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
      ...
      43LL,
      &WPP_d9801d1a90713b0d37c531873c83c241_Traceguids,
      a4,
      (__int64 *)va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 2LL, 8LL, &WPP_d9801d1a90713b0d37c531873c83c241_Traceguids, v8, (__int64 *)va);
}
