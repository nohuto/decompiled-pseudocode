/*
 * XREFs of Controller_WdfEvtDeviceFilterRemoveResourceRequirements @ 0x1C004DE30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Interrupter_DetermineSecondaryInterrupterCount @ 0x1C0055480 (Interrupter_DetermineSecondaryInterrupterCount.c)
