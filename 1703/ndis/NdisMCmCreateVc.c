/*
 * XREFs of NdisMCmCreateVc @ 0x1C0108840
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)NdisAfHandle + 46) + 24LL) + 56LL) < 6u )
  {
    if ( Flink >= 6u )
    {
      if ( (unsigned __int8)byte_1C009261A >= 4u )
        WPP_SF_(0x1Eu, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids);
      v12[15].Blink = 0LL;
      ...
      v21 = (_LIST_ENTRY *)ndisMCoIndicateReceiveNetBufferListsToNdisPacket;
      goto LABEL_32;
    }
    if ( (unsigned __int8)byte_1C009261A >= 4u )
      WPP_SF_(0x1Fu, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids);
    v12[15].Blink = 0LL;
    v12[16].Blink = (_LIST_ENTRY *)ndisCoSendPacketsToNdisPackets;
    v12[17].Flink = (_LIST_ENTRY *)ndisMCoSendCompleteToNdisPacket;
    v22 = (_LIST_ENTRY *)ndisMCoIndicateReceiveNdisPacketToNdisPacket;
LABEL_36:
    v12[16].Flink = 0LL;
    v12[17].Blink = v22;
    v12[18].Flink = 0LL;
  ...
  {
    if ( (unsigned __int8)byte_1C009261A >= 4u )
      WPP_SF_(0x1Du, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids);
    v12[16].Blink = 0LL;
  ...
  if ( (unsigned __int8)byte_1C009261A >= 4u )
    WPP_SF_(0x1Cu, &WPP_a122a54394bd3dbe970a397dccec41bf_Traceguids);
  v12[16].Blink = 0LL;
  ...
  v21 = (_LIST_ENTRY *)ndisMCoIndicateReceiveNetBufferListsToNetBufferLists;
LABEL_32:
  v12[17].Blink = 0LL;
  v12[17].Flink = 0LL;
  v12[18].Flink = v21;
