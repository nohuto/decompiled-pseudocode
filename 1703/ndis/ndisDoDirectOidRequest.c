/*
 * XREFs of ndisDoDirectOidRequest @ 0x1C0046784
 * Callers:
...
__int64 __fastcall ndisDoDirectOidRequest(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqqq(0x3Bu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2, a3, a4);
  v9 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a2 + 96));
  *(_QWORD *)(a2 + 520) = KeGetCurrentThread();
  *(_DWORD *)(a2 + 1856) = 2297983;
  if ( a3 )
    v10 = *(_QWORD **)(a3 + 848);
  else
    v10 = *(_QWORD **)(a2 + 2664);
...
LABEL_42:
  ...
  {
    LODWORD(v15) = v11;
    WPP_SF_qqd(0x3Cu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2, v15);
  }
  return v11;
}
