/*
 * XREFs of NdisFreeSharedMemory @ 0x1C0025D90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
      ...
      *v10 = v9;
      ...
      if ( v4 )
      {
        ...
        v14 = (NDIS_HANDLE *)*((_QWORD *)AllocationHandle + 3);
        if ( v13[1] != (char *)AllocationHandle + 16 || *v14 != (char *)AllocationHandle + 16 )
          __fastfail(3u);
        *v14 = v13;
        v13[1] = v14;
      }
      v11 = (NDIS_HANDLE *)*((_QWORD *)AllocationHandle + 4);
      v12 = (NDIS_HANDLE *)*((_QWORD *)AllocationHandle + 5);
      if ( v11[1] != (char *)AllocationHandle + 32 || *v12 != (char *)AllocationHandle + 32 )
        __fastfail(3u);
      *v12 = v11;
      v11[1] = v12;
