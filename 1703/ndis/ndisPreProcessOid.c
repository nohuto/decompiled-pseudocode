/*
 * XREFs of ndisPreProcessOid @ 0x1C000BAF0
 * Callers:
...
__int64 __fastcall ndisPreProcessOid(__int64 a1, __int64 a2, unsigned int a3, unsigned int *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qLqL(35LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a3, a2, *(_DWORD *)(a2 + 32));
  if ( a3 == 17 )
  {
    v20 = *(_DWORD *)(a2 + 12);
    if ( v20 < 0x3C )
  ...
  *(_DWORD *)(a2 + 88) &= ~4u;
  ...
  if ( !*(_DWORD *)(a2 + 8) || (*(_DWORD *)(v12 + 1872) & 0x200) == 0 )
  {
    ...
    while ( v11 >= v10 )
    {
      v15 = *((_DWORD *)&unk_1C007A350 + 6 * v11);
      if ( v15 > v13 )
      {
        if ( !v11 )
          break;
      ...
      else
      {
        if ( v15 == v13 )
        {
          ...
          *(_DWORD *)(a2 + 88) |= 4u;
          ...
          {
            v17 = (__int64 (__fastcall *)(__int64 *))*((_QWORD *)&unk_1C007A350 + 3 * *(unsigned int *)(a2 + 92) + 1);
            if ( v17 )
            {
              v4 = v17(v22);
              if ( v4 == 1 )
  ...
  *a4 = v9;
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qdD(36LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a2, v9, v4);
  return v4;
}
