/*
 * XREFs of ndisMapOpenByName @ 0x1C00509FC
 * Callers:
...
__int64 __fastcall ndisMapOpenByName(PCUNICODE_STRING SourceString, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_Zq(0x27u, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, &SourceString->Length, a2);
...
LABEL_17:
    ...
    if ( (unsigned __int8)byte_1C009260D >= 4u )
      WPP_SF_q(0x29u, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, v4);
    return v4;
  }
  else
  {
    if ( (unsigned __int8)byte_1C009260D >= 2u )
      WPP_SF_(0x28u, &WPP_bde249736f00345f1574c6c7be067711_Traceguids);
    return 0LL;
  }
}
