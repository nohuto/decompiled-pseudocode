/*
 * XREFs of ndisOidPreSupportedList @ 0x1C001F840
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreSupportedList(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_q(81LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1);
...
LABEL_14:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_q(82LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1);
  return v4;
}
