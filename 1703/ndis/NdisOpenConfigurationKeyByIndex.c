/*
 * XREFs of NdisOpenConfigurationKeyByIndex @ 0x1C00AC620
 * Callers:
        ...
        PNDIS_HANDLE KeyHandle)
{
  ...
  *(_QWORD *)&SubKeyName.Length = 0LL;
  ...
  if ( (unsigned __int8)byte_1C009260F >= 4u )
    WPP_SF_q(0xFu, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids, (__int64)ConfigurationHandle);
  v9 = KeyHandle;
  *KeyHandle = 0LL;
  ...
  if ( (unsigned __int8)byte_1C009260F >= 4u )
    WPP_SF_q(0x10u, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids, (__int64)ConfigurationHandle);
}
