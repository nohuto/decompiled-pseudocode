/*
 * XREFs of NdisFreeFragmentNetBufferList @ 0x1C0024530
 * Callers:
 ...
 *     ?ndisFreeMdl@@YAXPEAU_MDL@@@Z @ 0x1C00247C0 (-ndisFreeMdl@@YAXPEAU_MDL@@@Z.c)
...
LABEL_15:
    ...
    ++*(_DWORD *)(v20 + 32);
LABEL_43:
    v23 = NdisPoolHandle + 128;
    ++*((_DWORD *)v23 + 7);
    if ( ExQueryDepthSList((PSLIST_HEADER)v23) >= *((_WORD *)v23 + 8) )
    {
      ++*((_DWORD *)v23 + 8);
      (*((void (__fastcall **)(_NET_BUFFER *, char *))v23 + 7))(FirstNetBuffer, v23);
    }
    else
    {
      ExpInterlockedPushEntrySList((PSLIST_HEADER)v23, (PSLIST_ENTRY)FirstNetBuffer);
    }
    goto LABEL_15;
  }
LABEL_16:
...
LABEL_28:
  ...
  {
    v17 = (_SLIST_HEADER *)v22;
    goto LABEL_28;
  }
  ++*((_DWORD *)v22 + 8);
  (*((void (__fastcall **)(PNET_BUFFER_LIST, char *))v22 + 7))(FragmentNetBufferList, v22);
}
