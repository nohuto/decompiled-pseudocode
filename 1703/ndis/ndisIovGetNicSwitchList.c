/*
 * XREFs of ndisIovGetNicSwitchList @ 0x1C0026438
 * Callers:
...
__int64 __fastcall ndisIovGetNicSwitchList(__int64 a1, __int64 *a2)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_q(85LL, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, a1);
  v5 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 96));
  *(_QWORD *)(a1 + 520) = KeGetCurrentThread();
  *(_DWORD *)(a1 + 1856) = 2890556;
  *a2 = 0LL;
  ...
  *(_DWORD *)(a1 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qD(86LL, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, a1, v4);
  return v4;
}
