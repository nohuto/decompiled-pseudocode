/*
 * XREFs of ndisMSendNetBufferListsCompleteToNdisPackets @ 0x1C0057350
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendNetBufferListsCompleteToNdisPackets(__int64 a1, struct _NET_BUFFER_LIST *a2, char a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x2Eu, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2);
  ...
  while ( Alignment );
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x2Fu, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, 0LL);
}
