/*
 * XREFs of ?ndisIfCreateCompartmentBlock@@YAJIPEAU_GUID@@PEAU_NDIS_NSI_COMPARTMENT_RW@@PEAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@@Z @ 0x1C0013374
 * Callers:
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a4)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_dq(124LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, a3);
  *a4 = 0LL;
