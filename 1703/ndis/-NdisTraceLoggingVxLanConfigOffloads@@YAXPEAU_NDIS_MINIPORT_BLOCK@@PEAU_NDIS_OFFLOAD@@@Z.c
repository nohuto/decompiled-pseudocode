/*
 * XREFs of ?NdisTraceLoggingVxLanConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0077BB8
 * Callers:
...
void __fastcall NdisTraceLoggingVxLanConfigOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( (unsigned int)dword_1C0091010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v27 = 2LL;
      v29 = 1LL;
      TlgWrite(v6, &unk_1C007F47A, (LPCGUID)1, (LPCGUID)v3, 0xAu, &pData);
    }
  }
}
