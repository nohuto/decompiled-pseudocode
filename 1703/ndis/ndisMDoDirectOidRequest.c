/*
 * XREFs of ndisMDoDirectOidRequest @ 0x1C004751C
 * Callers:
...
__int64 __fastcall ndisMDoDirectOidRequest(__int64 a1, _DWORD *a2, char a3)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0x1Fu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2);
  if ( !a3
    && *(_QWORD *)(a1 + 4480)
    && !ndisSetBusyAsync((struct _NDIS_MINIPORT_BLOCK *)a1, 1u, NdisBusyDirectOid, a2, 0) )
  {
    if ( (unsigned __int8)byte_1C0092612 >= 4u )
      WPP_SF_q(0x20u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, (__int64)a2);
    v7 = 259;
    goto LABEL_41;
  }
  ...
  *(_DWORD *)(a1 + 1856) = 2295975;
  ...
  else
  {
    ...
    {
      LODWORD(v18) = 20000;
      WPP_SF_qqDD(0x21u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2, v18, v9);
    }
    v7 = -1073741670;
  }
  *(_QWORD *)(a1 + 520) = 0LL;
...
LABEL_41:
  ...
  {
    LODWORD(v18) = v7;
    WPP_SF_qqd(0x22u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2, v18);
  }
  return v7;
}
