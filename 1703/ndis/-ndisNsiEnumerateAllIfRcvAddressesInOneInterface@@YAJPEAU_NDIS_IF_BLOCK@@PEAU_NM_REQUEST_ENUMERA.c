/*
 * XREFs of ?ndisNsiEnumerateAllIfRcvAddressesInOneInterface@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C0041C50
 * Callers:
        ...
        struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a2)
{
  ...
  if ( !ndisIfReferenceMiniport((__int64)a1, 9u) )
  {
    *((_DWORD *)a2 + 22) = 0;
    return 0LL;
  }
