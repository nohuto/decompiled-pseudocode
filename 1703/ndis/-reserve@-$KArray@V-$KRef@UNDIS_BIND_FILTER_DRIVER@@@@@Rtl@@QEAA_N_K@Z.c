/*
 * XREFs of ?reserve@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@@Rtl@@QEAA_N_K@Z @ 0x1C00AD278
 * Callers:
...
char __fastcall Rtl::KArray<KRef<NDIS_BIND_FILTER_DRIVER>>::reserve(unsigned int *a1, unsigned __int64 a2)
{
  unsigned int v2; // esi
  unsigned int v4; // edi
