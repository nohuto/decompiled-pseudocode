/*
 * XREFs of ndisBindRequest @ 0x1C0064564
 * Callers:
 ...
 *     ?ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z @ 0x1C00F138C (-ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z.c)
 */
        ...
        ULONG_PTR BugCheckParameter3)
{
  ...
  switch ( *(_DWORD *)(BugCheckParameter3 + 8) )
  {
    case 0x12:
      ...
      v11 = 57;
LABEL_28:
      WPP_SF_Zq(v11, &WPP_7f404e1ae4803d6fc8eef9c80d758293_Traceguids, v15, v14);
      break;
    case 0x13:
    ...
    case 0x15:
      ...
      v9 = 60;
LABEL_23:
      WPP_SF_Zq(v9, &WPP_7f404e1ae4803d6fc8eef9c80d758293_Traceguids, v15, v14);
LABEL_24:
      v7 = RunSynchronous;
      break;
  }
