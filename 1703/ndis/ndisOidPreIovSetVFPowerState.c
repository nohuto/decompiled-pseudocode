/*
 * XREFs of ndisOidPreIovSetVFPowerState @ 0x1C00E7A90
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovSetVFPowerState(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x45u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v1);
    v4 = byte_1C0092621;
  }
  v5 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
...
LABEL_13:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x46u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v5, v9);
  }
  return v5;
}
