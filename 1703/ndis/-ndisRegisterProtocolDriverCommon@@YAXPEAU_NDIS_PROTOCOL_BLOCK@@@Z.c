/*
 * XREFs of ?ndisRegisterProtocolDriverCommon@@YAXPEAU_NDIS_PROTOCOL_BLOCK@@@Z @ 0x1C001D1C4
 * Callers:
 ...
 *     ?SetDirty@BindEngine@Ndis@@QEAAXXZ @ 0x1C00F14F4 (-SetDirty@BindEngine@Ndis@@QEAAXXZ.c)
 */
