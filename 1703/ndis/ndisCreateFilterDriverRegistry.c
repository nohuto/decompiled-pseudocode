/*
 * XREFs of ndisCreateFilterDriverRegistry @ 0x1C00AC898
 * Callers:
...
__int64 __fastcall ndisCreateFilterDriverRegistry(PCUNICODE_STRING Source, unsigned __int8 a2)
{
  ...
  *(_DWORD *)&DestinationString.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x55u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, (__int64)Source);
  ...
  v7 = RegistryValues;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_dd(0x56u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, RegistryValues, a2);
  if ( !v7 )
    goto LABEL_8;
  if ( v7 != -1073741772 )
  {
...
LABEL_10:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x57u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, (__int64)Source, v3);
  return v3;
}
