/*
 * XREFs of WdmlibRtlInitUnicodeStringEx @ 0x1C00787C8
 * Callers:
 ...
 *     PpRegStateUpdateStackCreationSettings @ 0x1C00F3C5C (PpRegStateUpdateStackCreationSettings.c)
 *     CmRegUtilCreateWstrKey @ 0x1C00F3E48 (CmRegUtilCreateWstrKey.c)
