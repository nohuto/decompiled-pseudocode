/*
 * XREFs of ndisOidPrePortState @ 0x1C0048D20
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePortState(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qD(0xBEu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1, *(_DWORD *)(v3 + 8));
  if ( *(_QWORD *)a1 )
  {
      ...
      *(_DWORD *)(v1 + 1856) = 2307333;
      ...
      else
      {
        ...
        *((_QWORD *)v7 + 2) = *(_QWORD *)(v1 + 800);
        v7[6] = *(_DWORD *)(*(_QWORD *)(v1 + 4064) + 532LL);
        v7[7] = *(_DWORD *)(v1 + 3336);
        v7[8] = *(_DWORD *)(v1 + 3340);
        v7[9] = *(_DWORD *)(v1 + 3344);
        v8 = *(_DWORD *)(v1 + 3348);
...
LABEL_17:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qD(0xBFu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1, *(_DWORD *)(v3 + 8));
  return v4;
}
