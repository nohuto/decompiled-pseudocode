/*
 * XREFs of NdisOpenFile @ 0x1C00DA7B0
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_PHYSICAL_ADDRESS HighestAcceptableAddress)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_(0xEu, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids);
  ...
  else
  {
    ...
    *((_DWORD *)PoolWithTag + 14) = *(_DWORD *)L"\\";
    ...
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_Z(0xFu, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, &Destination.Length);
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v12 >= 0 )
      {
        ...
        if ( (_DWORD)NumberOfBytes )
        {
          ...
          if ( v14 )
          {
            ...
            else
            {
              if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
                WPP_SF_d(0x14u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, v16);
              *Status = -1073676260;
            }
          ...
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_(0x13u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids);
        }
        else if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
        {
          WPP_SF_d(0x12u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, NumberOfBytes);
        }
      }
      else if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      {
        WPP_SF_d(0x11u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, v12);
      }
      ZwClose(FileHandlea);
      *Status = -1073676260;
      goto LABEL_32;
    ...
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_d(0x10u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, v11);
    *Status = -1073676261;
  }
LABEL_32:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_d(0x15u, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, *Status);
}
