/*
 * XREFs of ?ndisOidPostOpenSetEncapsulation@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0020CC0
 * Callers:
...
void __fastcall ndisOidPostOpenSetEncapsulation(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  {
    WPP_SF_qqq(202LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, *(_QWORD *)(v3 + 16), v1, v3);
    v4 = byte_1C0092612;
  }
  v5 = *(_QWORD *)(v3 + 792);
  if ( v5 )
  ...
  if ( (unsigned __int8)v4 >= 4u )
    WPP_SF_qq(203LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v3, v1);
}
