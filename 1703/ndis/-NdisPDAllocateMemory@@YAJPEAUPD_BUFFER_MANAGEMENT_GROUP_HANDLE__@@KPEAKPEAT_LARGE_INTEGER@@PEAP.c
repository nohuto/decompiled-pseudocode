/*
 * XREFs of ?NdisPDAllocateMemory@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KPEAKPEAT_LARGE_INTEGER@@PEAPEAXPEAPEAUPD_MEMORY_HANDLE__@@@Z @ 0x1C00EB780
 * Callers:
 *     <none>
 * Callees:
        ...
        struct PD_MEMORY_HANDLE__ **a6)
{
  ...
  *a6 = 0LL;
  ...
  {
    v14 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v12 + 32) + 5608LL) + 72LL);
    ...
    if ( v9 )
    {
      ...
      if ( v13 >= 0 )
      {
        v9[2] = v21;
        *((_DWORD *)v9 + 6) = *a3;
        v20.m_Lock = (KPushLockBase *)qword_1C00926D0;
        *((_DWORD *)v9 + 18) = a2;
