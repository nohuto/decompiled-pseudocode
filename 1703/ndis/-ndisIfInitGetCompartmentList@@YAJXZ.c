/*
 * XREFs of ?ndisIfInitGetCompartmentList@@YAJXZ @ 0x1C0013120
 * Callers:
...
__int64 ndisIfInitGetCompartmentList(void)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_(35LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids);
...
LABEL_11:
    ...
    else
    {
      ...
      *(_OWORD *)&v21[135] = xmmword_1C00815F0;
...
LABEL_24:
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_d(36LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (unsigned int)v1);
