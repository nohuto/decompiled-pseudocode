/*
 * XREFs of ?ndisExpandStackTrace@@YAEPEAPEAU_NDIS_STACK_TRACE@@PEAU_RTL_DYNAMIC_HASH_TABLE_CONTEXT@@PEA_K@Z @ 0x1C006C4A0
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  else
  {
    ...
    *((_OWORD *)PoolWithTag + 3) = *((_OWORD *)a3 + 1);
    ...
    RtlInsertEntryHashTable(&HashTable, v10, v3->Signature, a2);
    *a1 = v10;
