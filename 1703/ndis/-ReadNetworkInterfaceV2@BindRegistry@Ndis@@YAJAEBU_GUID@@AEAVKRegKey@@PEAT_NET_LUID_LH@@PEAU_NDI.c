/*
 * XREFs of ?ReadNetworkInterfaceV2@BindRegistry@Ndis@@YAJAEBU_GUID@@AEAVKRegKey@@PEAT_NET_LUID_LH@@PEAU_NDIS_NSI_INTERFACE_PERSIST_RW@@@Z @ 0x1C00B01A0
 * Callers:
...
LABEL_82:
          if ( (unsigned __int8)byte_1C009261D >= 2u )
            WPP_SF_Sd(0x17u, &WPP_ae77cdcf3d7d3f019c4f0d9a724dcfbd_Traceguids, v33, v43);
...
LABEL_86:
      ...
      v42 = 24;
LABEL_88:
      WPP_SF_d(v42, &WPP_ae77cdcf3d7d3f019c4f0d9a724dcfbd_Traceguids, v43);
      return (unsigned int)v43;
    }
  }
  return result;
