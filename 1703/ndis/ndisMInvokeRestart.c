/*
 * XREFs of ndisMInvokeRestart @ 0x1C00AB594
 * Callers:
...
__int64 __fastcall ndisMInvokeRestart(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0xD3u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1);
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64))(v2 + 168))(*(_QWORD *)(a1 + 24), a2);
  v6 = v5;
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qD(0xD4u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, v5);
  return v6;
}
