/*
 * XREFs of NdisClIncomingCallComplete @ 0x1C01062C0
 * Callers:
        ...
        PCO_CALL_PARAMETERS CallParameters)
{
  ...
  if ( !Status )
  {
    ...
    v9 = v6;
    v10 = (_QWORD *)*((_QWORD *)NdisVcHandle + 5);
    if ( *(NDIS_HANDLE *)(v8 + 8) != (char *)NdisVcHandle + 32 || (_QWORD *)*v10 != v7 )
      __fastfail(3u);
    *v10 = v8;
    *(_QWORD *)(v8 + 8) = v10;
    v11 = *((_QWORD *)NdisVcHandle + 10) + 1088LL;
    v12 = *(_QWORD *)v11;
