/*
 * XREFs of ndisSriovInterfaceWriteVfConfigBlock @ 0x1C00E9200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceWriteVfConfigBlock(void *a1, __int16 a2, int a3, const void *a4, size_t Size)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_q(0x5Fu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qD(0x60u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
