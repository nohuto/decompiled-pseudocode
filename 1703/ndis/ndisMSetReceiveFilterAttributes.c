/*
 * XREFs of ndisMSetReceiveFilterAttributes @ 0x1C00BFD4C
 * Callers:
 ...
 *     ndisMCheckReceiveFilterPacketCoalescingAttributes @ 0x1C00BFF40 (ndisMCheckReceiveFilterPacketCoalescingAttributes.c)
...
__int64 __fastcall ndisMSetReceiveFilterAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qq(0x79u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 16);
...
LABEL_30:
    ...
    || (unsigned __int8)ndisShouldSuppressReceiveFilterCapabilities(*(_QWORD *)(a2 + 24)) )
  {
    if ( (unsigned __int8)byte_1C0092614 < 4u )
      return v4;
    WPP_SF_qqq(0x7Au, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, *(_QWORD *)(a2 + 16), *(_QWORD *)(a2 + 24));
    goto LABEL_21;
  }
      ...
      if ( v9 )
      {
        ...
        *(_QWORD *)(a1 + 3552) = v10;
        if ( v10 )
        {
          ...
          if ( v12 >= 0x54u )
            v13 = 84LL;
          memmove(*(void **)(a1 + 3552), v11, v13);
          v14 = *(_WORD **)(a2 + 24);
          v15 = v14[1];
          if ( v15 < 0x54u )
            v7 = v15;
          memmove(*(void **)(a1 + 3560), v14, v7);
...
LABEL_21:
  ...
  {
    LODWORD(v20) = v4;
    WPP_SF_qqd(0x7Bu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, a2, v20);
  }
  return v4;
}
