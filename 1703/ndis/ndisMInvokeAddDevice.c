/*
 * XREFs of ndisMInvokeAddDevice @ 0x1C00AA4D0
 * Callers:
...
__int64 __fastcall ndisMInvokeAddDevice(__int64 a1)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0xBDu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, v1, a1);
  v3 = (*(__int64 (__fastcall **)(__int64, _QWORD))(v1 + 784))(a1, *(_QWORD *)(v1 + 64));
  v4 = v3;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    v6 = v3;
    WPP_SF_qqd(0xBEu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, v1, a1, v6);
  }
  return v4;
}
