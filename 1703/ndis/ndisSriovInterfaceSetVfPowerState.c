/*
 * XREFs of ndisSriovInterfaceSetVfPowerState @ 0x1C00E8F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceSetVfPowerState(void *a1, __int16 a2, int a3, char a4)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_q(0x67u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, (__int64)a1);
  LODWORD(v12) = 1048960;
  WORD2(v12) = a2;
  LODWORD(v13) = a3;
  BYTE4(v13) = a4;
  ...
  *(_DWORD *)&v11[48] = 16;
  ...
  v9 = SetMiniport;
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qD(0x68u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, (__int64)a1, SetMiniport);
  return v9;
}
