/*
 * XREFs of NdisMAllocatePort @ 0x1C003F280
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisMAllocatePort(NDIS_HANDLE NdisMiniportHandle, PNDIS_PORT_CHARACTERISTICS PortCharacteristics)
{
  ...
  if ( !ndisReferenceMiniport((__int64)NdisMiniportHandle, 0x63u) )
  {
    v5 = -1073676286;
    goto LABEL_43;
  }
...
LABEL_41:
  ...
  *(_OWORD *)(v7 + 9) = *(_OWORD *)&PortCharacteristics->RcvControlState;
  ...
  v21 = 0;
  v22 = (_QWORD *)*((_QWORD *)NdisMiniportHandle + 341);
  if ( v22 == (_QWORD *)((char *)NdisMiniportHandle + 2728) )
  {
LABEL_36:
    v25 = (__int64 *)v22[1];
    v26 = *v25;
...
LABEL_43:
  if ( (unsigned __int8)byte_1C009261E >= 4u )
    WPP_SF_qdD(11LL, &WPP_496de192e5de378341c8fe36eb970aad_Traceguids, NdisMiniportHandle, v5, v3);
  return v5;
}
