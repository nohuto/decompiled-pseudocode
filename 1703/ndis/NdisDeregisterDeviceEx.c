/*
 * XREFs of NdisDeregisterDeviceEx @ 0x1C00270B0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisDeregisterDeviceEx(NDIS_HANDLE NdisDeviceHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(106LL, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, NdisDeviceHandle);
...
LABEL_9:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(107LL, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, NdisDeviceHandle);
}
