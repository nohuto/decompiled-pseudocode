/*
 * XREFs of ?ndisValidateGFPWildcardMatchProfileBuffer@@YAEKPEBU_NDIS_GFP_WILDCARD_MATCH_PROFILE@@@Z @ 0x1C0075328
 * Callers:
 ...
 * Callees:
 *     ?ndisValidateGFPWildcardMatchHGProfileBuffer@@YAEKPEBU_NDIS_GFP_HEADER_GROUP_WILDCARD_MATCH_PROFILE@@@Z @ 0x1C00752C8 (-ndisValidateGFPWildcardMatchHGProfileBuffer@@YAEKPEBU_NDIS_GFP_HEADER_GROUP_WILDCARD_MATCH_PROF.c)
      ...
      if ( ndisValidateTrailingElementSpace(a1, (const struct _NDIS_OBJECT_HEADER *)a2, v5, *((_DWORD *)a2 + 6), v6) )
      {
        ...
        if ( v7 )
        {
          while ( ndisValidateGFPWildcardMatchHGProfileBuffer(
                    a1 - (v5 + v8 * v6),
                    (const struct _NDIS_GFP_WILDCARD_MATCH_PROFILE *)((char *)a2 + v5 + v8 * v6)) )
          {
            v8 = v9 + 1;
            if ( v8 >= v10 )
              return 1;
