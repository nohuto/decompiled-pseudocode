/*
 * XREFs of ?ndisNsiGetIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0042570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetIfRcvAddress(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_q(0x5Eu, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (__int64)a1);
...
LABEL_42:
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qD(0x5Fu, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (__int64)a1, IfRcvAddressRodInformation);
