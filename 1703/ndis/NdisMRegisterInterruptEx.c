/*
 * XREFs of NdisMRegisterInterruptEx @ 0x1C00FA020
 * Callers:
 *     <none>
 * Callees:
 *     ?GetMsgDpc@@YAPEAU_KDPC@@PEAU_NDIS_INTERRUPT_BLOCK@@KK@Z @ 0x1C0010524 (-GetMsgDpc@@YAPEAU_KDPC@@PEAU_NDIS_INTERRUPT_BLOCK@@KK@Z.c)
        ...
        PNDIS_HANDLE NdisInterruptHandle)
{
  ...
  $EC6697E2AD50F501A855E713DD941A61 *v32; // r15
  bool v33; // zf
  ...
  v9 = *((unsigned int *)MiniportAdapterHandle + 857);
  ...
  {
    WPP_SF_q(0x12u, &WPP_8a5864e380f63192cebb74f600d7ef38_Traceguids, (__int64)MiniportAdapterHandle);
    v12 = v50;
  }
    ...
    *(_WORD *)&v4->SharedInterrupt = 257;
    ...
    if ( *((_DWORD *)MiniportAdapterHandle + 857) )
    {
      while ( 1 )
      {
        ...
        if ( (unsigned int)++v22 >= *((_DWORD *)MiniportAdapterHandle + 857) )
          break;
        v16 = ndisMaxNumberOfProcessors;
      }
      v21 = v49;
    ...
    *(_WORD *)&Parameters.MessageBased.SynchronizeIrql = 0;
    ...
    if ( v35 < 0 )
    {
      ...
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
        WPP_SF_qD(0x13u, &WPP_8a5864e380f63192cebb74f600d7ef38_Traceguids, (__int64)MiniportAdapterHandle, v35);
      v32->Generic = 0LL;
    }
    else
    {
...
LABEL_37:
        ...
        *((_QWORD *)v39 + 6) = *((_QWORD *)Generic + 6);
        ...
        if ( v37 > 1 )
        {
          *((_BYTE *)MiniportAdapterHandle + 1992) = 1;
          if ( *((_WORD *)MiniportAdapterHandle + 1349) )
          {
            *((_DWORD *)MiniportAdapterHandle + 675) |= 0x8000000u;
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 657273;
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 0;
  ...
  if ( (Microsoft_Windows_NDISEnableBits & 0x100) != 0 )
    Template_jqxqqq(
      ...
      (unsigned __int64)MiniportAdapterHandle + 4032,
...
LABEL_40:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x14u, &WPP_8a5864e380f63192cebb74f600d7ef38_Traceguids, (__int64)MiniportAdapterHandle, v8);
  return v8;
}
