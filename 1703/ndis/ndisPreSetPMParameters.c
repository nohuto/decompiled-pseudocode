/*
 * XREFs of ndisPreSetPMParameters @ 0x1C00BAE84
 * Callers:
 *     ndisOidPrePMParameters @ 0x1C00BAE00 (ndisOidPrePMParameters.c)
 ...
 *     ndisXlatePMParametersToWakeUpEnableOid @ 0x1C004D070 (ndisXlatePMParametersToWakeUpEnableOid.c)
...
unsigned __int8 __fastcall ndisPreSetPMParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0x34u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, MiniportFromReqTracker, v1);
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_19:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qdD(0x35u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v7, *(_DWORD *)(a1 + 40), v2);
  return v2;
}
