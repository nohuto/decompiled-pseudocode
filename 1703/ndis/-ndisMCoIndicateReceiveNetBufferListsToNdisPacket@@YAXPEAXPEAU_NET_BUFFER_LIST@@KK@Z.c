/*
 * XREFs of ?ndisMCoIndicateReceiveNetBufferListsToNdisPacket@@YAXPEAXPEAU_NET_BUFFER_LIST@@KK@Z @ 0x1C0054090
 * Callers:
 *     <none>
 * Callees:
...
LABEL_31:
  ...
  if ( v23->PmodeOpens )
  {
    ...
    v27 = v32;
    v28 = v33;
    ndisCoIndicatePromiscNetBuffer(v37, v23, *(struct _NDIS_OPEN_BLOCK **)v35, v36, v33, v32, 1u);
