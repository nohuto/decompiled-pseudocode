/*
 * XREFs of ndisPostSetRemoveWakeUpPattern @ 0x1C004CA60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisPostSetRemoveWakeUpPattern(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqq(0x29u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v1, v4, v3);
  if ( *(_DWORD *)(a1 + 40) )
  {
    v7 = *(_QWORD **)(v3 + 144);
    if ( v7 )
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqq(0x2Au, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v1, v4, v3);
}
