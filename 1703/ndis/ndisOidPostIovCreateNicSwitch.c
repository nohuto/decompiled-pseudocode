/*
 * XREFs of ndisOidPostIovCreateNicSwitch @ 0x1C006B2E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovCreateNicSwitch(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qq(0xEu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v1);
  if ( *(_QWORD *)a1 )
  {
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qq(0xFu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v1);
}
