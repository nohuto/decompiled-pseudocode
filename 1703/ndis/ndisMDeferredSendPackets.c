/*
 * XREFs of ndisMDeferredSendPackets @ 0x1C00559D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSendPackets(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_q(0x16u, &WPP_baff752c64773449955de141535fd9df_Traceguids, (__int64)a1);
...
LABEL_50:
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_q(0x17u, &WPP_baff752c64773449955de141535fd9df_Traceguids, (__int64)a1);
  return 0;
}
