/*
 * XREFs of ndisIfReferenceCompartmentForUser @ 0x1C0044F04
 * Callers:
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a3)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_d(0xA1u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a2);
  ...
  if ( v6 < 0 )
    *a3 = 0LL;
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_dq(162LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (unsigned int)v6, a3);
