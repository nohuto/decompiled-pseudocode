/*
 * XREFs of ndisMSetNicSwitchAttributes @ 0x1C00BFF90
 * Callers:
...
__int64 __fastcall ndisMSetNicSwitchAttributes(void **a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qq(0x7Cu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 32);
  v6 = *(_BYTE *)(v5 + 1);
  if ( v6
      ...
      if ( PoolWithTag )
      {
        ...
        if ( v13 )
        {
          ...
          if ( v14 )
          {
            ...
            if ( v16 >= 0x84u )
              v17 = 132LL;
            memmove(a1[447], v15, v17);
            v18 = *(_WORD **)(a2 + 40);
            v19 = v18[1];
            if ( v19 < 0x84u )
              v11 = v19;
            memmove(a1[448], v18, v11);
...
LABEL_27:
  ...
  {
    v24 = v4;
    WPP_SF_qqd(0x7Du, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, a2, v24);
  }
  return v4;
}
