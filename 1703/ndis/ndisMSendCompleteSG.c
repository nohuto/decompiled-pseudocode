/*
 * XREFs of ndisMSendCompleteSG @ 0x1C0056F30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendCompleteSG(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qqd(0x24u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, a3);
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x25u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2);
}
