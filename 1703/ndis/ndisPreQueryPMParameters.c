/*
 * XREFs of ndisPreQueryPMParameters @ 0x1C00D628C
 * Callers:
...
char __fastcall ndisPreQueryPMParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x32u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, MiniportFromReqTracker, v1);
    v7 = byte_1C0092612;
  }
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_19:
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qdD(0x33u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v6, *(_DWORD *)(a1 + 40), 1);
  return 1;
}
