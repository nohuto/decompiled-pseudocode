/*
 * XREFs of ndisOidPostIovNicSwitchParameters @ 0x1C006B790
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovNicSwitchParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qq(
      0x1Bu,
      &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids,
      v3,
      v1,
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qq(0x1Cu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v1);
}
