/*
 * XREFs of ?ndisValidateGFPWildcardMatchHGProfileBuffer@@YAEKPEBU_NDIS_GFP_HEADER_GROUP_WILDCARD_MATCH_PROFILE@@@Z @ 0x1C00752C8
 * Callers:
        ...
        const struct _NDIS_GFP_HEADER_GROUP_WILDCARD_MATCH_PROFILE *a2)
{
  ...
  if ( *((_BYTE *)a2 + 1) != 1
    ...
    || (*((_QWORD *)a2 + 2) & 0xFFFFFFFFFF000000uLL) != 0
    || *((int *)a2 + 6) >= 4
    || *((int *)a2 + 7) >= 4
    || *((int *)a2 + 8) >= 4
    || *((int *)a2 + 9) >= 4
