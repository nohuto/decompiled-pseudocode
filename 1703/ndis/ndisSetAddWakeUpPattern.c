/*
 * XREFs of ndisSetAddWakeUpPattern @ 0x1C00D6FD8
 * Callers:
...
__int64 __fastcall ndisSetAddWakeUpPattern(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  {
    WPP_SF_qq(0x1Au, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1, a2);
    v4 = a2 + 72;
  }
  *(_QWORD *)(a1 + 192) = 0LL;
  *(_DWORD *)(a2 + 56) = 0;
...
LABEL_11:
    ...
    if ( (unsigned __int8)byte_1C0092612 >= 2u )
      WPP_SF_(0x1Cu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids);
    goto LABEL_44;
  }
...
LABEL_24:
    ...
    if ( v23 > 0xFFFF && ndisPMPatternIdExist(v16, v23) )
    {
      if ( (unsigned __int8)byte_1C0092615 >= 2u )
        WPP_SF_d(0x1Bu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v24);
    }
    else
    {
...
LABEL_44:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qdD(0x1Du, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1, (unsigned __int8)*a3, v11);
  return v11;
}
