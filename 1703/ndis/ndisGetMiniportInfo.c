/*
 * XREFs of ndisGetMiniportInfo @ 0x1C00DDD7C
 * Callers:
...
__int64 __fastcall ndisGetMiniportInfo(__int64 a1, __int64 a2, _DWORD *a3, char *a4, _DWORD *a5)
{
  ...
  _QWORD v59[5]; // [rsp+A8h] [rbp-58h] BYREF
  struct _NDIS_PNP_CAPABILITIES v60; // [rsp+D0h] [rbp-30h] BYREF
  ...
  *(_DWORD *)&Keyword.Length = 1048590;
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0x94u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1);
  *a5 = 1;
  v9 = (_DWORD *)(*(_QWORD *)(a1 + 3784) + 480LL);
  if ( !*v9 )
  {
...
LABEL_28:
    ...
    if ( v22 )
    {
      if ( *(int *)(a1 + 464) < 20 )
      {
        if ( (unsigned __int8)byte_1C0092614 >= 3u )
          WPP_SF_(0x95u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids);
  ...
  if ( (unsigned int)v23 <= 0x13 && ndisMediaTypeCl[v23] || (_DWORD)v23 == 3 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0092614 >= 3u )
        WPP_SF_q(0x96u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        Template_jqxqqq(
          v24,
          &OidQueryFailed,
  ...
  if ( (*(_BYTE *)(a1 + 928) & 1) != 0 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0092614 >= 3u )
        WPP_SF_q(0x97u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        Template_jqxqqq(
          v26,
          &OidQueryFailed,
  ...
  if ( !v30 )
  {
    ...
    if ( v22 )
    {
      v5 = 1;
      if ( (unsigned __int8)byte_1C0092614 >= 3u )
        WPP_SF_q(0x98u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
        Template_jqxqqq(
          v32,
          &OidQueryFailed,
    ...
    else
    {
      *(_WORD *)(a2 + 92) = 6;
      ...
      {
        if ( (unsigned __int8)byte_1C0092614 >= 3u )
          WPP_SF_q(0x99u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
          Template_jqxqqq(
            v34,
            &OidQueryFailed,
...
LABEL_77:
      ...
      {
        if ( (unsigned __int8)byte_1C0092614 >= 3u )
          WPP_SF_q(0x9Bu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
          Template_jqxqqq(
            v35,
            &OidQueryFailed,
...
LABEL_92:
  ...
  if ( v30 == 3 )
  {
    *(_WORD *)(a2 + 92) = 6;
    ...
    if ( (unsigned __int8)byte_1C0092614 >= 3u )
      WPP_SF_q(0x9Cu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1);
    if ( (Microsoft_Windows_NDISEnableBits & 0x10000000) != 0 )
      Template_jqxqqq(
        v31,
        &OidQueryFailed,
...
LABEL_93:
  if ( ((*(_DWORD *)(a1 + 124) & 0x8001) != 0 || (*(_BYTE *)(*(_QWORD *)(a1 + 3784) + 26LL) & 1) != 0)
    && *(_DWORD *)(a1 + 464) <= 0x13u )
  {
    *(_QWORD *)&v60.Flags = 0LL;
    *(_QWORD *)&v60.WakeUpCapabilities.MinPatternWakeUp = 0LL;
...
LABEL_109:
  ...
  *v56 = v5;
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qD(0x9Du, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, v8);
  return v8;
}
