/*
 * XREFs of NdisMCmRegisterAddressFamilyEx @ 0x1C0052EA0
 * Callers:
 *     <none>
 * Callees:
        ...
        PCO_ADDRESS_FAMILY AddressFamily)
{
  ...
  v5 = (_OWORD *)(*((_QWORD *)MiniportAdapterHandle + 473) + 640LL);
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 1578957;
  if ( v7 )
  {
    v4 = -1073741823;
  }
  else if ( *(_BYTE *)v5 == 0xA5 )
  {
    ...
    if ( ndisReferenceMiniport((__int64)MiniportAdapterHandle, 0x50u) )
    {
