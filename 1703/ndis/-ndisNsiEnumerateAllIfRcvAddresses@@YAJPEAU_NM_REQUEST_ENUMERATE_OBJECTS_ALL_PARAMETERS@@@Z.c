/*
 * XREFs of ?ndisNsiEnumerateAllIfRcvAddresses@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C0041B50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllIfRcvAddresses(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_q(0x62u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qD(0x63u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (__int64)a1, v2);
  return v2;
}
