/*
 * XREFs of ?NdisPDPIAllocateCounter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_COUNTER_PARAMETERS@@PEAPEAUNDIS_PD_COUNTER_HANDLE__@@@Z @ 0x1C00EC6C0
 * Callers:
 *     <none>
 * Callees:
    ...
    *a3 = 0LL;
      ...
      && (unsigned int)(*((_DWORD *)a2 + 4) - 1) <= 2 )
    {
      ...
      *((_DWORD *)v4 + 17) = ndisGetNextPDCounterId();
      ...
      if ( !v11
        || RtlCreateUnicodeString((PUNICODE_STRING)v4 + 6, v11)
        && RtlCreateUnicodeString((PUNICODE_STRING)v4 + 7, *((PCWSTR *)a2 + 1)) )
      {
        v8 = (*(__int64 (__fastcall **)(_QWORD, const struct _NDIS_PD_COUNTER_PARAMETERS *, __int64 *))(*((_QWORD *)a1 + 10) + 40LL))(
               *((_QWORD *)a1 + 9),
               a2,
               &v14);
        if ( v8 >= 0 )
