/*
 * XREFs of ndisFreeReceiveQueue @ 0x1C003D724
 * Callers:
 *     ndisOidPostRcvFilterAllocateQueue @ 0x1C003D810 (ndisOidPostRcvFilterAllocateQueue.c)
 *     ndisOidPostRcvFilterFreeQueue @ 0x1C003DA80 (ndisOidPostRcvFilterFreeQueue.c)
 * Callees:
...
__int64 __fastcall ndisFreeReceiveQueue(__int64 a1, unsigned int a2)
{
  ...
  *(_DWORD *)(a1 + 1856) = 0;
  ...
  if ( v6 )
    ...
    v4 = -1073741811;
  if ( (unsigned __int8)byte_1C0092620 >= 4u )
    WPP_SF_qdD(19LL, &WPP_ffc4cf2032893579d26374b00adf8efd_Traceguids, a1, a2, v4);
  return v4;
}
