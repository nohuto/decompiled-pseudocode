/*
 * XREFs of ndisMLoopbackNetBufferLists @ 0x1C0056B2C
 * Callers:
...
void __fastcall ndisMLoopbackNetBufferLists(__int64 a1, __int64 a2, unsigned int a3, char a4, __int64 *a5)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x42u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2);
  v9 = a2;
  v15 = 0;
  v10 = a2;
  v16[0] = 0;
...
LABEL_18:
  ...
  *a5 = v10;
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x43u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2);
}
