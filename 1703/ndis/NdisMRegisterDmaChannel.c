/*
 * XREFs of NdisMRegisterDmaChannel @ 0x1C0104090
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG MaximumLength)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x24u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, (__int64)MiniportAdapterHandle);
  ...
  *(_DWORD *)&DeviceDescription[20] = v9;
    ...
    && (v18 = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, 0x38uLL, 0x6264444Eu), (v19 = v18) != 0LL) )
  {
    ...
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_d(0x25u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, v22);
    ExFreePoolWithTag(v19, 0);
    v12 = -1073741670;
    if ( (Microsoft_Windows_NDISEnableBits & 0x100) != 0 )
      Template_qqq(v23, &AllocateAdapterChannelFailed, (const GUID *)MiniportAdapterHandle + 252, v22, 240, 0);
  }
  else
  {
    v12 = -1073741670;
...
LABEL_21:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x26u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, (__int64)MiniportAdapterHandle, v12);
  return v12;
}
