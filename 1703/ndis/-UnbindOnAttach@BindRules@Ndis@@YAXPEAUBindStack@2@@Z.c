/*
 * XREFs of ?UnbindOnAttach@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00B40D0
 * Callers:
...
LABEL_48:
      ...
      v10 = *(_QWORD *)(v6 + 8 * i);
      v11 = *(_QWORD *)(v10 + 80);
      if ( (*(_DWORD *)(v11 + 48) & 4) != 0 && !*(_DWORD *)(v10 + 32) && !*(_BYTE *)(v10 + 9) && !*(_DWORD *)(v10 + 52) )
      {
        v3 = BindingDisabled;
        if ( (unsigned __int8)byte_1C0092623 >= 5u )
          WPP_SF__guid_D(0x32u, v10, v11 + 32, *(_DWORD *)(v10 + 88));
      }
      continue;
    }
  }
        ...
        *(_BYTE *)(*(_QWORD *)v15 + 5240LL) = 1;
        if ( !v18 )
          WPP_SF_Zq(
            ...
            *(const wchar_t **)(*(_QWORD *)(*(_QWORD *)(v14 + 8 * j) + 80LL) + 32LL),
            **(_QWORD **)(v14 + 8 * j));
      }
    }
    else
