/*
 * XREFs of ?NdisTraceLoggingGreTaskeConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0026BF0
 * Callers:
...
void __fastcall NdisTraceLoggingGreTaskeConfigOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  char v9; // [rsp+31h] [rbp-58h] BYREF
  char v10; // [rsp+32h] [rbp-57h] BYREF
  char v11; // [rsp+33h] [rbp-56h] BYREF
  ...
  if ( (unsigned int)dword_1C0091010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v23 = 1LL;
      v25 = 4LL;
      TlgWrite(v7, &unk_1C007F5A7, v3, (LPCGUID)v4, 8u, &pData);
    }
  }
}
