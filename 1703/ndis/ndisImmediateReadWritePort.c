/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00DAB60
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00DA680 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00DA6A0 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00DA6C0 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00DA700 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00DA730 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00DA760 (NdisImmediateWritePortUshort.c)
 * Callees:
 *     ndisTranslateResources @ 0x1C00BD228 (ndisTranslateResources.c)
 *     ndisStartMapping @ 0x1C00DAD94 (ndisStartMapping.c)
 */
