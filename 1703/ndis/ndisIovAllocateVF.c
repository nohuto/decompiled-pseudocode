/*
 * XREFs of ndisIovAllocateVF @ 0x1C00E5B3C
 * Callers:
...
char __fastcall ndisIovAllocateVF(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_q(0x1Fu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3);
  ...
  *(_DWORD *)(*(_QWORD *)(a1 + 32) + 60LL) = 0;
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qD(0x20u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, *(_DWORD *)(a1 + 40));
  return v4;
}
