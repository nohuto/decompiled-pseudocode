/*
 * XREFs of ndisMOpenAdapter @ 0x1C00F7CE4
 * Callers:
 ...
 *     ethAllocateOpenMulticastBuffer @ 0x1C001A390 (ethAllocateOpenMulticastBuffer.c)
...
void __fastcall ndisMOpenAdapter(_DWORD *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_qqq(0x25u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, v3, a3, a2);
...
LABEL_13:
  ...
  *(_QWORD *)(a2 + 568) = *(_QWORD *)(a2 + 296);
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_qq(0x68u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a3, a2);
  v14 = *(unsigned int *)(a3 + 1520);
  if ( (((_DWORD)v14 - 1) & 0xFFFFFFFC) != 0 || (_DWORD)v14 == 3 )
  {
    if ( (unsigned __int8)byte_1C009260D >= 4u )
      WPP_SF_qq(0x69u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a3, a2);
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
  {
    ...
    WPP_SF_qqd(0x6Au, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a3, a2, v22);
  }
  if ( (_BYTE)v6 )
  {
    v7 = 1;
    if ( (unsigned __int8)byte_1C009260D >= 4u )
      WPP_SF_qq(0x2Au, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, a2, v3);
    ...
    {
      LODWORD(v22) = v16;
      WPP_SF_qqd(0x2Bu, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, a2, v3, v22);
    }
    if ( !v16 )
    {
      v4 = 0;
...
LABEL_43:
  ...
  {
    LODWORD(v23) = *a1;
    WPP_SF_qqqL(0x27u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, v3, a3, a2, v23);
  }
}
