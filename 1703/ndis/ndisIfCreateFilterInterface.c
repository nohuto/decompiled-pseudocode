/*
 * XREFs of ndisIfCreateFilterInterface @ 0x1C001C71C
 * Callers:
...
__int64 __fastcall ndisIfCreateFilterInterface(struct _NDIS_FILTER_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_q(201LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1);
...
LABEL_8:
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qD(202LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, v5);
  return v5;
}
