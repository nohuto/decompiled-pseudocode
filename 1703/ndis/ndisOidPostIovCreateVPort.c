/*
 * XREFs of ndisOidPostIovCreateVPort @ 0x1C006B420
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_qq @ 0x1C003CA44 (WPP_SF_qq.c)
 *     ndisIovAddVPortToPFList @ 0x1C006A13C (ndisIovAddVPortToPFList.c)
 *     ndisIovAddVPortToVFList @ 0x1C006A18C (ndisIovAddVPortToVFList.c)
 */
...
void __fastcall ndisOidPostIovCreateVPort(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qq(0x2Fu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v1);
  if ( *a1 )
  {
    v4 = *(_QWORD *)(v1 + 152);
    if ( *((_DWORD *)a1 + 10) )
    {
      ...
      {
        v5 = *(void **)(v1 + 152);
        *(_BYTE *)(((unsigned __int64)*(unsigned int *)(v4 + 124) >> 3) + *(_QWORD *)(v3 + 4792)) &= ~(1 << (*(_BYTE *)(v4 + 124) & 7));
...
LABEL_13:
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qq(0x30u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v1);
}
