/*
 * XREFs of ndisOidPrePMProtocolOffloadList @ 0x1C00D55F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMProtocolOffloadList(__int64 *a1)
{
  ...
  {
    WPP_SF_qqq(0x6Bu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v1, v3, v5);
    v8 = byte_1C0092612;
  }
  v9 = a1[3];
  if ( v9
...
LABEL_33:
  if ( (unsigned __int8)v8 >= 4u )
    WPP_SF_qqqL(0x6Cu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v1, v3, v5, *((_DWORD *)a1 + 10));
  return v2;
}
