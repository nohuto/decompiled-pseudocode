/*
 * XREFs of ndisOidPreIovEnumNicSwitches @ 0x1C006BB90
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumNicSwitches(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_q(0x13u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, a1);
...
LABEL_19:
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qD(0x14u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v3;
}
