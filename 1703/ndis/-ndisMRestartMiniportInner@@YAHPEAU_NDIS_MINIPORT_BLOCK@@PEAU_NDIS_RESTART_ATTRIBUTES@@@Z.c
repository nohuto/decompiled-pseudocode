/*
 * XREFs of ?ndisMRestartMiniportInner@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RESTART_ATTRIBUTES@@@Z @ 0x1C00F6D74
 * Callers:
 ...
 *     ndisLWM5RestartMinport @ 0x1C005F590 (ndisLWM5RestartMinport.c)
...
__int64 __fastcall ndisMRestartMiniportInner(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_RESTART_ATTRIBUTES *a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xFu, &WPP_13438080fb613be0f003217e669c8259_Traceguids, (__int64)a1);
  if ( ndisReferenceMiniportByHandle(a1, 0, 0x1Bu) )
  {
    ...
    if ( v6 )
    {
      ...
      if ( !AsyncOpCompletionStatus )
        ndisUpdateOperationalStatus((struct _TlgProvider_t *)a1);
    }
    else
    {
      a1->MiniportThread = 0LL;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x11u, &WPP_13438080fb613be0f003217e669c8259_Traceguids, (__int64)a1, AsyncOpCompletionStatus);
