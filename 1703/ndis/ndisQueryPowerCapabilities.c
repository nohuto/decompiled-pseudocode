/*
 * XREFs of ndisQueryPowerCapabilities @ 0x1C00BCEAC
 * Callers:
...
__int64 __fastcall ndisQueryPowerCapabilities(char *NdisAdapterHandle)
{
  ...
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_q(0xDu, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)NdisAdapterHandle);
  ...
  if ( *((_QWORD *)NdisAdapterHandle + 483) )
  {
    ...
    if ( Irp )
    {
      ...
      *(_WORD *)&CurrentStackLocation[-1].MajorFunction = 2331;
      ...
      {
        if ( (unsigned __int8)byte_1C0092615 >= 4u )
          WPP_SF_qD(0xFu, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)NdisAdapterHandle, v18);
        goto LABEL_19;
      }
...
LABEL_19:
    ...
    if ( (unsigned __int8)byte_1C0092615 >= 2u )
      WPP_SF_q(0xEu, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)NdisAdapterHandle);
    NdisWriteErrorLogEntry(NdisAdapterHandle, 0xC0001389, 0);
    v2 = -1073741670;
  }
LABEL_20:
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_qD(0x10u, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)NdisAdapterHandle, v2);
  return v2;
}
