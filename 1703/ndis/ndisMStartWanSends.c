/*
 * XREFs of ndisMStartWanSends @ 0x1C0057EB0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMStartWanSends(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_q(0x20u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1);
  v2 = (_QWORD **)(a1 + 128);
  while ( 1 )
  {
    v3 = *v2;
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_q(0x21u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1);
  return 0;
}
