/*
 * XREFs of ?ndisPDInitializeMiniportBufferManagement@@YAJPEAU_NDIS_PD_BLOCK@@@Z @ 0x1C00EE1A0
 * Callers:
 ...
 *     ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x1C00EE170 (-ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z.c)
 *     ?ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z @ 0x1C00EE8AC (-ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z.c)
 */
...
__int64 __fastcall ndisPDInitializeMiniportBufferManagement(struct _NDIS_PD_BLOCK *a1)
{
  ...
  *(_WORD *)((char *)&v22 + 13) = 0;
  ...
  if ( a1->PDDomainId )
  {
    v23.m_Lock = (KPushLockBase *)qword_1C00926D0;
...
LABEL_32:
  ...
  *((_QWORD *)v4 + 12) = PDBMFreeCommonBuffer;
  ...
  if ( !PDDomainId )
  {
    ...
    v14 = qword_1C00926D0 + 8240;
    v15 = *(__int64 ***)(qword_1C00926D0 + 8248);
    if ( *v15 != (__int64 *)(qword_1C00926D0 + 8240) )
      __fastfail(3u);
    goto LABEL_30;
  }
