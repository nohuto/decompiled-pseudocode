/*
 * XREFs of ndisMSetSriovAttributes @ 0x1C00C018C
 * Callers:
 ...
 *     ndisIovInitVf @ 0x1C00E6124 (ndisIovInitVf.c)
 */
...
__int64 __fastcall ndisMSetSriovAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qq(0x7Eu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 48);
...
LABEL_36:
  ...
  if ( !*(_BYTE *)(v7 + 1)
    ...
    || (*(_BYTE *)(v7 + 8) & 3) == 3 && ((v17 = *(_QWORD *)(a1 + 3584)) == 0 || *(_BYTE *)(v17 + 1) < 2u) )
  {
    LocallyUniqueId = -1073741811;
LABEL_38:
    v18 = *(void **)(a1 + 4640);
...
LABEL_22:
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qqd(0x7Fu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, a2, LocallyUniqueId);
