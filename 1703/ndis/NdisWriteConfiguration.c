/*
 * XREFs of NdisWriteConfiguration @ 0x1C00D9970
 * Callers:
        ...
        PNDIS_CONFIGURATION_PARAMETER ParameterValue)
{
  ...
  if ( (unsigned __int8)byte_1C009260F >= 4u )
    WPP_SF_q(0x15u, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids, (__int64)ConfigurationHandle);
  *Status = 0;
...
LABEL_24:
  if ( (unsigned __int8)byte_1C009260F >= 4u )
    WPP_SF_q(0x16u, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids, (__int64)ConfigurationHandle);
}
