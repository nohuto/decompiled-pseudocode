/*
 * XREFs of ndisIovCreateVPort @ 0x1C00E5D54
 * Callers:
...
char __fastcall ndisIovCreateVPort(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_q(0x2Du, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v4);
...
LABEL_45:
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qD(0x2Eu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v4, *(_DWORD *)(a1 + 40));
  return v7;
}
