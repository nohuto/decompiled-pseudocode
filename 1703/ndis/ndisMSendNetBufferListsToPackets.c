/*
 * XREFs of ndisMSendNetBufferListsToPackets @ 0x1C0057440
 * Callers:
...
void __fastcall ndisMSendNetBufferListsToPackets(__int64 a1, struct _NET_BUFFER_LIST *a2, __int64 a3, int a4)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x3Au, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2);
  LODWORD(v11) = 10;
  v10 = v17;
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x3Bu, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, v10, v11);
}
