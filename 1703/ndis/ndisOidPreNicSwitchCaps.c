/*
 * XREFs of ndisOidPreNicSwitchCaps @ 0x1C00CF980
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreNicSwitchCaps(__int64 *a1)
{
  ...
  *((_DWORD *)a1 + 10) = 0;
  ...
  if ( !*((_DWORD *)a1 + 10) )
  {
    ...
    if ( !v1 )
      goto LABEL_20;
    v7 = *(_DWORD *)(v3 + 32) == 66094 ? *(__int128 **)(v1 + 3576) : *(__int128 **)(v1 + 3584);
    if ( !v7 )
    {
LABEL_7:
...
LABEL_20:
  if ( (unsigned __int8)v6 >= 4u )
  {
    v17 = *((_DWORD *)a1 + 10);
    LODWORD(v16) = v4;
    WPP_SF_qqDD(0x21u, &WPP_ffc4cf2032893579d26374b00adf8efd_Traceguids, v1, v5, v16, v17);
  }
  return v4;
}
