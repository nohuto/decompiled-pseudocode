/*
 * XREFs of ?ndisNblTrackerReadConfiguration@@YAXXZ @ 0x1C0111260
 * Callers:
...
LABEL_7:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_DDD(0xAu, &WPP_0f567d7dfc7c36c58892c3982a44c53d_Traceguids, v1, ndisNblTrackerStuckNblDisposition);
}
