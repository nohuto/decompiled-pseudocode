/*
 * XREFs of ?ndisGetMiniportIndicateList@@YAPEAU_NET_BUFFER_LIST@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0067CA0
 * Callers:
 *     ndisPeriodicReceivesWorker @ 0x1C00691D0 (ndisPeriodicReceivesWorker.c)
 * Callees:
 *     ndisPeriodicReceivesGetMaxNblCount @ 0x1C0069178 (ndisPeriodicReceivesGetMaxNblCount.c)
 */
