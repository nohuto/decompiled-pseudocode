/*
 * XREFs of ?grow@?$KArray@V?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@@Rtl@@AEAA_N_K@Z @ 0x1C00BC2CC
 * Callers:
...
char __fastcall Rtl::KArray<KRef<NDIS_BIND_PROTOCOL_DRIVER>>::grow(unsigned int *a1, unsigned __int64 a2)
{
  ...
  if ( v5 >= v6 )
    v6 = v5;
  return Rtl::KArray<KRef<NDIS_BIND_PROTOCOL_DRIVER>>::reserve(a1, v6);
}
