/*
 * XREFs of ?NdisMTcpOffloadForwardComplete@@YAXPEAXPEAU_NET_BUFFER_LIST@@@Z @ 0x1C0066810
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0028760 (_guard_dispatch_icall_nop.c)
 *     ?GroupCompletionContext@@YAPEAU_NDIS_OPEN_BLOCK@@PEAU_NET_BUFFER_LIST@@PEAPEAU2@@Z @ 0x1C0066778 (-GroupCompletionContext@@YAPEAU_NDIS_OPEN_BLOCK@@PEAU_NET_BUFFER_LIST@@PEAPEAU2@@Z.c)
 */
