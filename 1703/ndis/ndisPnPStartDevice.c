/*
 * XREFs of ndisPnPStartDevice @ 0x1C00AB254
 * Callers:
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 2u )
    WPP_SF_qD(0x3Fu, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, (__int64)DeferredContext, v16);
  v14 = -1073741823;
LABEL_21:
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0x40u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, (__int64)DeferredContext);
  return v14;
}
