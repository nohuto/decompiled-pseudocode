/*
 * XREFs of ndisOidPreIovAllocateVF @ 0x1C00E65B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovAllocateVF(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qqq(0x1Du, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, *a1, a1[3], v1);
  if ( v1[1] == 12 )
  {
    VF = 0;
    *((_DWORD *)a1 + 10) = 0;
...
LABEL_16:
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
  {
    v8 = *((_DWORD *)a1 + 10);
    LODWORD(v7) = VF;
    WPP_SF_qqDD(0x1Eu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, *a1, a1[3], v7, v8);
  }
  return VF;
}
