/*
 * XREFs of ?ndisIfUpdateStringIfNeeded@@YAXPEAU_NDIS_IF_BLOCK@@PEBU_UNICODE_STRING@@PEAU_IF_COUNTED_STRING_LH@@W4_NSI_STRUCT_TYPE@@K@Z @ 0x1C0041514
 * Callers:
...
char __fastcall ndisIfUpdateStringIfNeeded(const unsigned __int16 *a1, __int16 *a2, _WORD *a3, unsigned int a4, int a5)
{
  ...
  if ( *a2 != *a3 || (v10 = memcmp(*((const void **)a2 + 1), a3 + 1, v5)) != 0 )
  {
    ...
    else if ( (unsigned __int8)byte_1C009261D >= 3u )
    {
      LOBYTE(v10) = WPP_SF_Z(191LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a2);
    }
  }
  return v10;
}
