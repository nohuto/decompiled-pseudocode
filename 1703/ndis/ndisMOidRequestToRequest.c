/*
 * XREFs of ndisMOidRequestToRequest @ 0x1C00477EC
 * Callers:
...
__int64 __fastcall ndisMOidRequestToRequest(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqd(0x45u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2, *(_DWORD *)(a2 + 32));
  if ( *(_DWORD *)(a2 + 4) == 12 )
  {
    v6 = -1073741637;
    goto LABEL_33;
...
LABEL_30:
    ...
    if ( (v10 & 0x40000) == 0 )
    {
      ...
      for ( *(_DWORD *)(a1 + 1856) = 2298726; ; *(_DWORD *)(a1 + 1856) = 2298727 )
      {
    ...
    if ( v14 )
    {
      ...
      if ( !v15 )
      {
        v16 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD *, _DWORD *))(*(_QWORD *)(a1 + 3784)
                                                                                            + 208LL))(
                *(_QWORD *)(a1 + 24),
                (unsigned int)v8[10],
                *((_QWORD *)v8 + 6),
...
LABEL_26:
    ...
    v16 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD *, _DWORD *))(*(_QWORD *)(a1 + 3784) + 176LL))(
            *(_QWORD *)(a1 + 24),
            (unsigned int)v8[10],
            *((_QWORD *)v8 + 6),
            (unsigned int)v8[14],
...
LABEL_33:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
  {
    LODWORD(v21) = v6;
    LODWORD(v20) = v2;
    WPP_SF_qqDL(0x46u, a2, a1, a2, v20, v21);
  }
  return v6;
}
