/*
 * XREFs of ndisReferenceProtocolByName @ 0x1C01033F8
 * Callers:
...
__int64 __fastcall ndisReferenceProtocolByName(PCUNICODE_STRING SourceString, __int64 *a2, char a3, unsigned __int8 a4)
{
  ...
  if ( (unsigned __int8)byte_1C009260C >= 4u )
    WPP_SF_Z(0x23u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, &SourceString->Length);
...
LABEL_24:
  if ( (unsigned __int8)byte_1C009260C >= 4u )
    WPP_SF_qD(0x24u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, *a2, v8);
  return v8;
}
