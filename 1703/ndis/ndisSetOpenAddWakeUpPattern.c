/*
 * XREFs of ndisSetOpenAddWakeUpPattern @ 0x1C00D75D4
 * Callers:
...
__int64 __fastcall ndisSetOpenAddWakeUpPattern(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0x17u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1, a2);
  v6 = 0;
  *a3 = 1;
  *(_DWORD *)(a2 + 56) = 0;
  v7 = *(_QWORD *)(a1 + 24);
...
LABEL_14:
    ...
    if ( (unsigned __int8)byte_1C0092612 >= 2u )
      WPP_SF_(0x18u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids);
    goto LABEL_29;
  }
  *v10 = 0;
...
LABEL_29:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qdD(0x19u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1, (unsigned __int8)*a3, v6);
  return v6;
}
