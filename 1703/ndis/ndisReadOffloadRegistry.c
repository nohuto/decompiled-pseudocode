/*
 * XREFs of ndisReadOffloadRegistry @ 0x1C00AE3F8
 * Callers:
...
__int64 __fastcall ndisReadOffloadRegistry(struct _TlgProvider_t *a1)
{
  ...
  unsigned int CallbackContext; // edx
  ...
  if ( !v2 )
  {
    LODWORD(a1[57].CallbackContext) |= 0x20000u;
    ...
    if ( IntegerData )
    {
      ...
      if ( v6 )
      {
        if ( v6 != 1 )
        {
          LODWORD(a1[57].CallbackContext) &= 0xFFFFFFFC;
          goto LABEL_9;
        }
        v16 = (__int64)a1[57].CallbackContext & 0xFFFFFFFC | 1;
      }
      else
      {
        v16 = (__int64)a1[57].CallbackContext & 0xFFFFFFFC | 2;
      }
      LODWORD(a1[57].CallbackContext) = v16;
    }
    else
    {
      LODWORD(a1[57].CallbackContext) |= 3u;
    }
LABEL_9:
    ...
    if ( v7 )
    {
      ...
      if ( v8 )
      {
        if ( v8 != 1 )
        {
          LODWORD(a1[57].CallbackContext) &= 0xFFFFFFF3;
          goto LABEL_14;
        }
        v17 = (__int64)a1[57].CallbackContext & 0xFFFFFFF3 | 4;
      }
      else
      {
        v17 = (__int64)a1[57].CallbackContext & 0xFFFFFFF3 | 8;
      }
      LODWORD(a1[57].CallbackContext) = v17;
    }
    else
    {
      LODWORD(a1[57].CallbackContext) |= 0xCu;
    }
LABEL_14:
    ...
    if ( v9 )
    {
      ...
      if ( v10 )
      {
        if ( v10 != 1 )
        {
          LODWORD(a1[57].CallbackContext) &= 0xFFFFFFCF;
          goto LABEL_19;
        }
        v18 = (__int64)a1[57].CallbackContext & 0xFFFFFFCF | 0x10;
      }
      else
      {
        v18 = (__int64)a1[57].CallbackContext & 0xFFFFFFCF | 0x20;
      }
      LODWORD(a1[57].CallbackContext) = v18;
    }
    else
    {
      LODWORD(a1[57].CallbackContext) |= 0x30u;
    }
LABEL_19:
    ...
    if ( v11 )
    {
      ...
      if ( v12 )
      {
        if ( v12 != 1 )
        {
          LODWORD(a1[57].CallbackContext) &= 0xFFFFFF3F;
          goto LABEL_24;
        }
        v19 = (__int64)a1[57].CallbackContext & 0xFFFFFF3F | 0x40;
      }
      else
      {
        v19 = (__int64)a1[57].CallbackContext & 0xFFFFFF3F | 0x80;
      }
      LODWORD(a1[57].CallbackContext) = v19;
    }
    else
    {
      LODWORD(a1[57].CallbackContext) |= 0xC0u;
    }
LABEL_24:
    ...
    if ( !Status )
    {
      ...
      if ( !v13 )
      {
        LODWORD(a1[57].CallbackContext) |= 0x300u;
        goto LABEL_29;
      }
      v14 = v13 - 1;
      if ( v14 )
      {
        if ( v14 != 1 )
        {
          LODWORD(a1[57].CallbackContext) &= 0xFFFFFCFF;
          goto LABEL_29;
        }
        v20 = (__int64)a1[57].CallbackContext & 0xFFFFFCFF | 0x100;
      }
      else
      {
        v20 = (__int64)a1[57].CallbackContext & 0xFFFFFCFF | 0x200;
      }
      LODWORD(a1[57].CallbackContext) = v20;
    }
LABEL_29:
    ...
    if ( !Status )
    {
      if ( ParameterValue->ParameterData.IntegerData )
        LODWORD(a1[57].CallbackContext) &= ~0x1000u;
      else
        LODWORD(a1[57].CallbackContext) |= 0x1000u;
    }
    ...
    {
      if ( ParameterValue->ParameterData.IntegerData )
        LODWORD(a1[57].CallbackContext) &= ~0x800u;
      else
        LODWORD(a1[57].CallbackContext) |= 0x800u;
    }
    ...
    {
      if ( ParameterValue->ParameterData.IntegerData )
        LODWORD(a1[57].CallbackContext) &= ~0x400u;
      else
        LODWORD(a1[57].CallbackContext) |= 0x400u;
    }
    ...
    if ( !Status )
    {
      ...
      if ( v21 )
      {
        ...
        if ( v22 )
        {
          if ( v22 != 1 )
          {
            LODWORD(a1[57].CallbackContext) &= 0xFFFF9FFF;
            goto LABEL_39;
          }
          v23 = (__int64)a1[57].CallbackContext & 0xFFFF9FFF | 0x2000;
        }
        else
        {
          v23 = (__int64)a1[57].CallbackContext & 0xFFFF9FFF | 0x4000;
        }
        LODWORD(a1[57].CallbackContext) = v23;
      }
      else
      {
        LODWORD(a1[57].CallbackContext) |= 0x6000u;
      }
    }
LABEL_39:
    ...
    {
      if ( ParameterValue->ParameterData.IntegerData )
        LODWORD(a1[57].CallbackContext) &= ~0x8000u;
      else
        LODWORD(a1[57].CallbackContext) |= 0x8000u;
    }
    ...
    {
      if ( ParameterValue->ParameterData.IntegerData )
        LODWORD(a1[57].CallbackContext) &= ~0x10000u;
      else
        LODWORD(a1[57].CallbackContext) |= 0x10000u;
    }
    ...
    if ( Status )
    {
      ...
      if ( !Status )
      {
        LODWORD(a1[57].CallbackContext) |= 0x400000u;
        CallbackContext = (unsigned int)a1[57].CallbackContext;
        ...
        if ( v28 )
        {
          ...
          {
            if ( v29 == 1 )
              v30 = CallbackContext & 0xFFCFFFFF | 0x100000;
            else
              v30 = CallbackContext & 0xFFCFFFFF;
          }
          else
          {
            v30 = CallbackContext & 0xFFCFFFFF | 0x200000;
          }
        }
        else
        {
          v30 = CallbackContext | 0x300000;
        }
        LODWORD(a1[57].CallbackContext) = v30;
      }
      goto LABEL_43;
    }
    ...
    if ( !v24 )
    {
      LODWORD(a1[57].CallbackContext) |= 0xC0000u;
      goto LABEL_43;
    }
    v25 = v24 - 1;
    if ( v25 )
    {
      if ( v25 != 1 )
      {
        LODWORD(a1[57].CallbackContext) &= 0xFFF3FFFF;
LABEL_43:
        NdisReadConfiguration(&Status, &ParameterValue, v3, &RscIPv4Str, NdisParameterInteger);
        if ( !Status )
        {
          if ( ParameterValue->ParameterData.IntegerData )
            LODWORD(a1[57].CallbackContext) &= ~0x800000u;
          else
            LODWORD(a1[57].CallbackContext) |= 0x800000u;
        }
        ...
        {
          if ( ParameterValue->ParameterData.IntegerData )
            LODWORD(a1[57].CallbackContext) &= ~0x1000000u;
          else
            LODWORD(a1[57].CallbackContext) |= 0x1000000u;
        }
        ...
        {
          if ( ParameterValue->ParameterData.IntegerData )
            LODWORD(a1[57].CallbackContext) &= ~0x2000000u;
          else
            LODWORD(a1[57].CallbackContext) |= 0x2000000u;
        }
        ...
        {
          if ( ParameterValue->ParameterData.IntegerData )
            LODWORD(a1[57].CallbackContext) &= ~0x4000000u;
          else
            LODWORD(a1[57].CallbackContext) |= 0x4000000u;
        }
        NdisReadConfiguration(
        ...
        {
          if ( ParameterValue->ParameterData.IntegerData )
            LODWORD(a1[57].CallbackContext) &= ~0x8000000u;
          else
            LODWORD(a1[57].CallbackContext) |= 0x8000000u;
        }
        goto LABEL_48;
      }
      v26 = (__int64)a1[57].CallbackContext & 0xFFF3FFFF | 0x40000;
    }
    else
    {
      v26 = (__int64)a1[57].CallbackContext & 0xFFF3FFFF | 0x80000;
    }
    LODWORD(a1[57].CallbackContext) = v26;
    goto LABEL_43;
  }
LABEL_48:
  if ( v3 )
