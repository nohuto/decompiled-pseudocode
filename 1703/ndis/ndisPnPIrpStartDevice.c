/*
 * XREFs of ndisPnPIrpStartDevice @ 0x1C00AA5E4
 * Callers:
...
__int64 __fastcall ndisPnPIrpStartDevice(__int64 a1, __int64 a2, _IRP *a3, _BYTE *a4, _BYTE *a5)
{
  ...
  if ( (unsigned __int8)byte_1C0092610 >= 4u )
    WPP_SF_qZ(0x21u, &WPP_7f404e1ae4803d6fc8eef9c80d758293_Traceguids, a2, *(const wchar_t **)(a2 + 3880));
  ...
  *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetLock + 24) = *(_OWORD *)(&CurrentStackLocation->Parameters.SetLock
  ...
  if ( *(_QWORD *)(*(_QWORD *)(a2 + 3784) + 808LL) )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_q(0xC5u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a2);
    v10 = (*(__int64 (__fastcall **)(_QWORD, _IRP *))(*(_QWORD *)(a2 + 3784) + 808LL))(*(_QWORD *)(a2 + 4136), a3);
    v11 = v10;
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_qD(0xC6u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a2, v10);
  }
  else
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_q(0xC7u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a2);
    v11 = 0;
  }
  if ( v11 )
  {
    ...
    else
    {
      ...
      *a4 = 0;
      ...
      if ( (unsigned __int8)byte_1C0092614 >= 2u )
        WPP_SF_qD(0x22u, &WPP_7f404e1ae4803d6fc8eef9c80d758293_Traceguids, a2, v15);
