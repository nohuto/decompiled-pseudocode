/*
 * XREFs of ndisMediaDisconnectTimeout @ 0x1C0065210
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemSpecific3)
{
  ...
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_q(0x17u, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)FunctionContext);
  ...
  *((_DWORD *)FunctionContext + 464) = 0;
  ...
  else
  {
    ...
    if ( (unsigned __int8)byte_1C0092615 < 4u )
      return;
    WPP_SF_q(0x18u, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)FunctionContext);
  }
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_q(0x19u, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)FunctionContext);
}
