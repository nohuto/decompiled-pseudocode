/*
 * XREFs of ndisIovFreeVF @ 0x1C006ABD8
 * Callers:
 *     ndisOidPostIovFreeVF @ 0x1C006B740 (ndisOidPostIovFreeVF.c)
 * Callees:
...
__int64 __fastcall ndisIovFreeVF(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qq(0x25u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, 0LL, P);
  if ( *((_DWORD *)v2 + 19) )
  {
    v1 = -1073741811;
  }
  ...
  {
    v14 = v1;
    WPP_SF_qqd(0x26u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v2, v14);
  }
  return v1;
}
