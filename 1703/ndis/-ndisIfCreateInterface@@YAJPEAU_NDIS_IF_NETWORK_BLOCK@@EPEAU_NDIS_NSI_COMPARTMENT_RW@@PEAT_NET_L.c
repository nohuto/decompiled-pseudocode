/*
 * XREFs of ?ndisIfCreateInterface@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@EPEAU_NDIS_NSI_COMPARTMENT_RW@@PEAT_NET_LUID_LH@@PEAU_NDIS_NSI_INTERFACE_PERSIST_RW@@PEAU_NDIS_FILTER_BLOCK@@W4NdisIfBlockSource@@@Z @ 0x1C00B673C
 * Callers:
        ...
        enum NdisIfBlockSource a7)
{
  ...
  *(_DWORD *)&Source.Length = 262146;
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qqqqq(0x80u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, a3, a4, a5, a6);
  if ( !a1
...
LABEL_77:
          ...
          *((_QWORD *)v13 + 79) = 1LL;
          if ( v43 )
          {
            RtlInitUnicodeString(&DestinationString, &xmmword_1C0092152);
            ...
            *((_WORD *)v13 + 24) = Destination.Length;
            RtlInitUnicodeString(&DestinationString, &xmmword_1C0092362);
            *(_DWORD *)&Destination.Length = 0x2000000;
