/*
 * XREFs of NdisMDeregisterInterrupt @ 0x1C00E06F0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisMDeregisterInterrupt(PNDIS_MINIPORT_INTERRUPT Interrupt)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x10u, &WPP_8a5864e380f63192cebb74f600d7ef38_Traceguids, (__int64)Miniport);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x11u, &WPP_8a5864e380f63192cebb74f600d7ef38_Traceguids, (__int64)Interrupt->Miniport);
}
