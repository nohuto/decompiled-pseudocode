/*
 * XREFs of ndisSendCompleteWithPause @ 0x1C00584B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisSendCompleteWithPause(__int64 a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qqd(0x34u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, a3);
  ...
  *(_BYTE *)(a1 + 728) = v8;
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x35u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2);
}
