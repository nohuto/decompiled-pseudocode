/*
 * XREFs of ?ndisBindReadFilterDriverSettingsFromV2Registry@@YA_NPEAUNDIS_BIND_FILTER_DRIVER@@AEAVKRegKey@@@Z @ 0x1C00AFC10
 * Callers:
...
LABEL_20:
  ...
  *(_DWORD *)&v13.Length = 0;
  ...
  v13.MaximumLength = v13.Length + 2;
  KRegKey::QueryValueString(a2, &v13, &a1->FilterClass);
  return 1;
}
