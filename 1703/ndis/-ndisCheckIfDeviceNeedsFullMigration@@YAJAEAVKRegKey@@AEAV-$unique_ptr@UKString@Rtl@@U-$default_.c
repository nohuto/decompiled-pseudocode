/*
 * XREFs of ?ndisCheckIfDeviceNeedsFullMigration@@YAJAEAVKRegKey@@AEAV?$unique_ptr@UKString@Rtl@@U?$default_delete@UKString@Rtl@@@wistd@@@wistd@@AEA_N@Z @ 0x1C00A9340
 * Callers:
...
__int64 __fastcall ndisCheckIfDeviceNeedsFullMigration(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  else
  {
    ...
    if ( (unsigned __int8)byte_1C0092614 >= 3u )
      WPP_SF_S(0x39u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, *(const wchar_t **)(*(_QWORD *)a2 + 8LL));
    *a3 = 1;
  }
  v8 = 0;
LABEL_8:
