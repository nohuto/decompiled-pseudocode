/*
 * XREFs of ?ndisNsiGetInterfaceRosEnumObject@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00A3320
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qq(0x5Au, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, a3);
    v7 = byte_1C009261D;
    v18 = byte_1C009261D;
  }
  v8 = (char *)*((_QWORD *)a3 + 5);
...
LABEL_26:
  ...
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qqd(0x5Bu, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, a3, v3);
  return v3;
}
