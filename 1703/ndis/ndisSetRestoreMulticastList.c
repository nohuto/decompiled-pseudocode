/*
 * XREFs of ndisSetRestoreMulticastList @ 0x1C00D315C
 * Callers:
...
void __fastcall ndisSetRestoreMulticastList(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0x7Bu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2);
  v5 = v2;
  v6 = *v2;
...
LABEL_18:
  ...
  *(_DWORD *)(a2 + 48) = 6 * *((_DWORD *)v2 + 92);
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0x7Cu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2);
}
