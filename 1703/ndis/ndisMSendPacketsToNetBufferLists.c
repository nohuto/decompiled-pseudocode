/*
 * XREFs of ndisMSendPacketsToNetBufferLists @ 0x1C0057D60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsToNetBufferLists(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qqd(0x36u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, a3);
  ...
  do
  {
    ...
    if ( v12 )
    {
      if ( ndisNblTrackerMode )
        ndisNblTrackerTransferOwnershipInternal(v12, *(_QWORD *)(v6 + 680), *(_QWORD *)(a1 + 2568), 0x8Fu, v14 & 1);
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x37u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2);
}
