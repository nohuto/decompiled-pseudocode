/*
 * XREFs of NdisMAllocateSharedMemoryAsync @ 0x1C0061260
 * Callers:
 *     NdisMAllocateSharedMemoryAsyncEx @ 0x1C00613C0 (NdisMAllocateSharedMemoryAsyncEx.c)
 * Callees:
        ...
        PVOID Context)
{
  ...
  if ( (unsigned __int8)byte_1C009261C >= 4u )
    WPP_SF_qD(0x20u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, (__int64)MiniportAdapterHandle, Length);
...
LABEL_13:
  if ( (unsigned __int8)byte_1C009261C >= 4u )
    WPP_SF_d(0x21u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, v9);
  return v9;
}
