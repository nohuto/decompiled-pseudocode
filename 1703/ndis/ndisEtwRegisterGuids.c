/*
 * XREFs of ndisEtwRegisterGuids @ 0x1C00BE134
 * Callers:
...
__int64 __fastcall ndisEtwRegisterGuids(char *a1, unsigned int a2, unsigned int *a3)
{
  ...
  {
    WPP_SF_(0x4Du, &WPP_bde249736f00345f1574c6c7be067711_Traceguids);
    v6 = (unsigned __int8)ndisWppEnabledLevelPerFlag;
  }
  if ( !a3 || !a1 || a2 < 4 )
    return 3221225485LL;
  ...
  *a3 = 0;
  ...
  else
  {
    ...
    *((_WORD *)v10 + 15) = aMofresourcenam[14];
    if ( v6 >= 4u )
      WPP_SF_d(0x4Eu, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, 0);
    return 0LL;
  }
  return result;
}
