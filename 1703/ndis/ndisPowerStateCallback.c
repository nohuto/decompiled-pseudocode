/*
 * XREFs of ndisPowerStateCallback @ 0x1C00A8F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisPowerStateCallback(LPCGUID SettingGuid, int *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( Value && ValueLength >= 4 )
  {
    if ( (unsigned __int8)byte_1C0092615 >= 4u )
      WPP_SF_d(0x3Cu, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, *Value);
    ...
    if ( (unsigned __int8)byte_1C0092615 >= 4u )
      WPP_SF_d(0x3Du, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, *Value);
  }
  return 0LL;
}
