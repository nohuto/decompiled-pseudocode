/*
 * XREFs of ndisNdkPcwAddCounter @ 0x1C0067038
 * Callers:
 ...
 *     ?ndisPcwGetMiniportName@@YAPEBU_UNICODE_STRING@@PEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00E51AC (-ndisPcwGetMiniportName@@YAPEBU_UNICODE_STRING@@PEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
...
__int64 __fastcall ndisNdkPcwAddCounter(__int64 a1)
{
  ...
  {
    if ( v3->NDKBlock && ndisReferenceMiniport((__int64)v3, 0x5Bu) )
    {
      ...
      if ( ndisWildCardStringMatch(*(const struct _UNICODE_STRING **)(a1 + 8), MiniportName, v6) )
      {
        ...
        if ( v7 )
        {
          ...
          else if ( ndisReferenceMiniport((__int64)v3, 0x5Cu) )
          {
