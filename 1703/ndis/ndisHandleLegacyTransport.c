/*
 * XREFs of ndisHandleLegacyTransport @ 0x1C00ACB98
 * Callers:
...
__int64 __fastcall ndisHandleLegacyTransport(__int64 a1)
{
  ...
  {
    WPP_SF_q(0x2Au, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, a1);
    v2 = byte_1C009260C;
  }
  Context = 0LL;
...
LABEL_9:
          if ( (unsigned __int8)byte_1C009260C >= 4u )
            WPP_SF_(0x2Cu, &WPP_bde249736f00345f1574c6c7be067711_Traceguids);
  ...
  if ( (unsigned __int8)v2 >= 4u )
    WPP_SF_(0x2Bu, &WPP_bde249736f00345f1574c6c7be067711_Traceguids);
  return 3221225473LL;
}
