/*
 * XREFs of ndisMFakeSendPackets @ 0x1C005F850
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMFakeSendPackets(__int64 a1, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x52u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, v3);
  v7 = -1073741823;
  if ( v3 )
    v7 = *(_DWORD *)(v3 + 540);
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x53u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, v3);
}
