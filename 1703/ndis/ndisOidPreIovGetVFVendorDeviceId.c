/*
 * XREFs of ndisOidPreIovGetVFVendorDeviceId @ 0x1C00E6FE0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovGetVFVendorDeviceId(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x47u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v1);
    v4 = byte_1C0092621;
  }
  if ( *(_DWORD *)(v1 + 4) != 12 )
    goto LABEL_4;
...
LABEL_15:
  ...
  {
    v8 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x48u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v5, v8);
  }
  return v5;
}
