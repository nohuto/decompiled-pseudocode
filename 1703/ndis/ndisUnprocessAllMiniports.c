/*
 * XREFs of ndisUnprocessAllMiniports @ 0x1C0102934
 * Callers:
...
void __fastcall ndisUnprocessAllMiniports(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0x49u, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, a1);
  while ( 1 )
  {
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0x4Au, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, a1);
}
