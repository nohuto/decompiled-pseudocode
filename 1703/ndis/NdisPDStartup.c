/*
 * XREFs of NdisPDStartup @ 0x1C00EECB0
 * Callers:
 *     <none>
 * Callees:
  ...
  *a4 = 0LL;
  ...
  if ( v15 )
  {
    ...
    *a5 = &unk_1C007BAC0;
    ...
    for ( i = *(__int64 **)(qword_1C00926D0 + 8); i != (__int64 *)(qword_1C00926D0 + 8); i = (__int64 *)*i )
    {
    ...
    ClearBitsAndSet = RtlFindClearBitsAndSet((PRTL_BITMAP)(qword_1C00926D0 + 24), 1u, 0);
...
LABEL_22:
    ...
    *((_WORD *)v13 + 52) = ClearBitsAndSet;
    v18 = qword_1C00926D0 + 8;
    v19 = *(__int64 ***)(qword_1C00926D0 + 16);
    if ( *v19 != (__int64 *)(qword_1C00926D0 + 8) )
      __fastfail(3u);
    *v13 = v18;
    v13[1] = (__int64)v19;
    *v19 = v13;
