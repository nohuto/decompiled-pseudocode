/*
 * XREFs of ndisCancelIdleRequest @ 0x1C006E618
 * Callers:
 *     ndisCancelIdleRequestSync @ 0x1C006E724 (ndisCancelIdleRequestSync.c)
 *     ndisIdleCancelWorkItem @ 0x1C006E990 (ndisIdleCancelWorkItem.c)
 * Callees:
  ...
  if ( (*(_DWORD *)(v3 + 504) & 0x84) == 4 )
  {
    ...
    *(_QWORD *)(v3 + 656) = MEMORY[0xFFFFF78000000014];
    ...
    if ( (unsigned __int8)byte_1C0092616 >= 4u )
      WPP_SF_qD(0x1Au, &WPP_3059abd58ba5345e836db04510415190_Traceguids, (__int64)a1, a2);
