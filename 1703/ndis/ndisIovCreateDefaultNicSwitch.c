/*
 * XREFs of ndisIovCreateDefaultNicSwitch @ 0x1C00BCD98
 * Callers:
 ...
 *     ndisIovFinalizeNicSwitch @ 0x1C006AA64 (ndisIovFinalizeNicSwitch.c)
...
__int64 __fastcall ndisIovCreateDefaultNicSwitch(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_q(0xAu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, (__int64)a1);
    ...
    if ( SriovCurrentCapabilities )
    {
      if ( (SriovCurrentCapabilities->SriovCapabilities & 3) == 3 )
      {
          ...
          && NicSwitchCurrentCapabilities->Header.Size >= 0x74u )
        {
          ...
          if ( DWORD1(v27[33]) > v11->MaxNumVFs )
            MaxNumVFs = v11->MaxNumVFs;
          DWORD1(v27[33]) = MaxNumVFs;
          DWORD2(v27[33]) = v11->MaxNumVPorts;
          HIDWORD(v27[33]) = v11->NdisReserved7;
...
LABEL_6:
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qD(0xBu, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, (__int64)a1, SwitchConfiguration);
