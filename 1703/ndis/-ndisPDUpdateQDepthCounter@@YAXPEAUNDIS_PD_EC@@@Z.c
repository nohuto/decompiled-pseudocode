/*
 * XREFs of ?ndisPDUpdateQDepthCounter@@YAXPEAUNDIS_PD_EC@@@Z @ 0x1C0074F68
 * Callers:
...
void __fastcall ndisPDUpdateQDepthCounter(LARGE_INTEGER *a1)
{
  ...
  if ( !PerformanceFrequency.QuadPart )
  {
    ...
    qword_1C0094130 = PerformanceFrequency.QuadPart / 100;
  }
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  if ( PerformanceCounter.QuadPart - a1[18].QuadPart >= (unsigned __int64)qword_1C0094130 )
  {
    v8.m_State = Unlocked;
