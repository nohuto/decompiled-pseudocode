/*
 * XREFs of ?ndisNsiSetAllNetworkInfo@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C0042C00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetAllNetworkInfo(struct _NM_REQUEST_SET_ALL_PARAMETERS *a1)
{
  ...
  *(_DWORD *)&NewIrql[4] = 0;
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_q(0x74u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (__int64)a1);
...
LABEL_46:
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qD(0x75u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (__int64)a1, v4);
