/*
 * XREFs of ?NdisTraceLoggingCsStateChange@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_MINIPORT_AOAC@@EPEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS@@PEAU_NDIS_MINIPORT_CS_SPURIOUS_WAKE_STATS_EX@@PEAU_NDIS_MINIPORT_CS_TRAFFIC_STATS@@4@Z @ 0x1C0076620
 * Callers:
        ...
        TraceLoggingHProvider hProvider)
{
  ...
  TraceLoggingHProvider v72; // [rsp+1C0h] [rbp+C0h]
  __int64 v73; // [rsp+1C8h] [rbp+C8h]
  const unsigned __int16 **p_ProviderMetadataPtr; // [rsp+1D0h] [rbp+D0h]
  __int64 v75; // [rsp+1D8h] [rbp+D8h]
  unsigned __int64 *p_KeywordAny; // [rsp+1E0h] [rbp+E0h]
  __int64 v77; // [rsp+1E8h] [rbp+E8h]
  unsigned __int64 *p_KeywordAll; // [rsp+1F0h] [rbp+F0h]
  __int64 v79; // [rsp+1F8h] [rbp+F8h]
  unsigned __int64 *p_RegHandle; // [rsp+200h] [rbp+100h]
  __int64 v81; // [rsp+208h] [rbp+108h]
  void (__fastcall **p_EnableCallback)(const _GUID *, unsigned int, unsigned __int8, unsigned __int64, unsigned __int64, _EVENT_FILTER_DESCRIPTOR *, void *); // [rsp+210h] [rbp+110h]
  ...
  _OWORD v90[4]; // [rsp+260h] [rbp+160h] BYREF
  _BYTE v91[128]; // [rsp+2A0h] [rbp+1A0h] BYREF

  memset(v91, 0, sizeof(v91));
  memset(v90, 0, 0x3CuLL);
  v29 = (MEMORY[0xFFFFF78000000008] - ndisLastCsEntryTime) / 0x2710;
  if ( v29 >= 0x927C0 )
  {
    v11 = 16LL;
    v12 = (struct _TlgProvider_t *)v91;
    CsRefTimes = a2->CsRefTimes;
    do
    {
      TotalRefTime = CsRefTimes->TotalRefTime;
      ++CsRefTimes;
      *(_QWORD *)&v12->LevelPlus1 = TotalRefTime;
      v12 = (struct _TlgProvider_t *)((char *)v12 + 8);
      --v11;
    }
    while ( v11 );
    ...
    *(_OWORD *)((char *)&v90[2] + 12) = v17;
    if ( (unsigned int)dword_1C0091010 > 5 )
    {
      if ( TlgKeywordOn(v12, 0x400000000000uLL) )
      {
        ...
        v87 = 64LL;
        v89 = 128LL;
        TlgWrite(hProvider, &unk_1C007FD05, v18, v19, 0x1Fu, &pData);
      }
    }
  }
}
