/*
 * XREFs of ?ndisCleanupPDQTracker@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z @ 0x1C00EDA88
 * Callers:
...
void __fastcall ndisCleanupPDQTracker(struct NDIS_PD_QUEUE_TRACKER ***a1)
{
  ...
  v2 = *a1;
  v3 = a1[1];
  if ( (*a1)[1] != (struct NDIS_PD_QUEUE_TRACKER *)a1 || *v3 != (struct NDIS_PD_QUEUE_TRACKER *)a1 )
    __fastfail(3u);
  ...
  *a1 = 0LL;
  ...
  if ( v4 )
  {
    ...
    v6 = a1[29];
    v7 = a1[30];
    if ( v6[1] != (struct NDIS_PD_QUEUE_TRACKER *)(a1 + 29) || *v7 != v5 )
      __fastfail(3u);
