/*
 * XREFs of ndisPreTaskOffloadSet @ 0x1C00D2D20
 * Callers:
...
unsigned __int8 __fastcall ndisPreTaskOffloadSet(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0xD6u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1, v3);
...
LABEL_20:
  ...
  {
    v13 = v11;
    WPP_SF_qdD(0xD7u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, (__int64)v1, *v5, v13);
  }
  return v11;
}
