/*
 * XREFs of ?ndisIfInitGetNetworkList@@YAJXZ @ 0x1C0012ED4
 * Callers:
...
__int64 ndisIfInitGetNetworkList(void)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_(33LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids);
...
LABEL_23:
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_d(34LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (unsigned int)v1);
