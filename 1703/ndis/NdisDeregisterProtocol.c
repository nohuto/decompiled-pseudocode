/*
 * XREFs of NdisDeregisterProtocol @ 0x1C0103230
 * Callers:
...
void __fastcall NdisDeregisterProtocol(int *a1, _NDIS_PROTOCOL_BLOCK *a2)
{
  ...
  if ( (unsigned __int8)byte_1C009260C >= 4u )
    WPP_SF_qZ(0x12u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, (__int64)a2, &a2->Name.Length);
  ...
  else
  {
    *a1 = -1073741823;
    if ( (unsigned __int8)byte_1C009260C < 4u )
      return;
    WPP_SF_qD(0x13u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, (__int64)a2, -1073741823);
  }
  if ( (unsigned __int8)byte_1C009260C >= 4u )
    WPP_SF_qD(0x14u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, (__int64)a2, *a1);
}
