/*
 * XREFs of ndisRejectUnsupportedWoLPatterns @ 0x1C00D6C10
 * Callers:
...
LONG __fastcall ndisRejectUnsupportedWoLPatterns(char *MiniportAdapterHandle)
{
  ...
  KeWaitForSingleObject(MiniportAdapterHandle + 3944, Executive, 0, 0, 0LL);
LABEL_2:
  v9[0] = 0;
  for ( i = *((_QWORD *)MiniportAdapterHandle + 121); i; i = *v3 )
  {
    if ( !ndisIsWoLPacketTypeSupported(*(_DWORD *)(i + 60), (__int64)MiniportAdapterHandle) )
    {
      ...
      v6 = *((_DWORD *)v3 + 11);
      if ( !v5 )
        return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 3944), 0, 1, 0);
      if ( v5 == v4 )
      {
        if ( (unsigned __int8)byte_1C0092615 >= 2u )
          WPP_SF_d(0x7Eu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v5);
      }
      else
      {
        memset(v11, 0, sizeof(v11));
        ...
        *(_DWORD *)&v11[48] = 4;
        ...
        if ( (unsigned __int8)byte_1C0092615 >= 2u )
          WPP_SF_d(0x7Fu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, SetMiniport);
      }
      return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 3944), 0, 1, 0);
    }
  }
