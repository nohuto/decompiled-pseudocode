/*
 * XREFs of ndisOidPreHDSplitCurrentConfig @ 0x1C0048A50
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreHDSplitCurrentConfig(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0xC4u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1, v3);
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qdD(0xC5u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1, *(_DWORD *)(a1 + 40), v4);
  return v4;
}
