/*
 * XREFs of ndisQueryMediaStatus @ 0x1C00E2060
 * Callers:
...
void __fastcall ndisQueryMediaStatus(void *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_q(0x8Au, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)a1);
  ...
  *(_DWORD *)&v3[48] = 4;
  ...
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_q(0x8Bu, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, (__int64)a1);
}
