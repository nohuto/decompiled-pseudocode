/*
 * XREFs of ndisRemoveOpenWakeUpPattern @ 0x1C004CD14
 * Callers:
...
void __fastcall ndisRemoveOpenWakeUpPattern(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqd(0x25u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
    v6 = *(_DWORD **)(a1 + 496);
    v7 = 0LL;
  ...
  {
    LODWORD(v15) = a3;
    WPP_SF_qqd(0x26u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1, a2, v15);
  }
}
