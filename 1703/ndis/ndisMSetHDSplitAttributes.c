/*
 * XREFs of ndisMSetHDSplitAttributes @ 0x1C00AAFEC
 * Callers:
 *     NdisMSetMiniportAttributes @ 0x1C00AA760 (NdisMSetMiniportAttributes.c)
 * Callees:
 *     NdisGetHypervisorInfo @ 0x1C00234D0 (NdisGetHypervisorInfo.c)
...
__int64 __fastcall ndisMSetHDSplitAttributes(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&HypervisorInfo.Header.Type = 0LL;
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qq(0x76u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, a2);
  *(_DWORD *)(a1 + 124) &= ~0x40000000u;
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qqd(0x77u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, a2, v2);
  return v2;
}
