/*
 * XREFs of NdisMSendNetBufferListsComplete @ 0x1C00018F0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG SendCompleteFlags)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(60LL, &WPP_baff752c64773449955de141535fd9df_Traceguids, MiniportAdapterHandle, NetBufferList);
  if ( *((_QWORD *)v5 + 560) )
  {
...
LABEL_25:
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(61LL, &WPP_baff752c64773449955de141535fd9df_Traceguids, v5, NetBufferList);
}
