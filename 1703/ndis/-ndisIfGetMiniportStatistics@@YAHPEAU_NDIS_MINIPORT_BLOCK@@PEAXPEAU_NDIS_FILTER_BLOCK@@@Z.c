/*
 * XREFs of ?ndisIfGetMiniportStatistics@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAXPEAU_NDIS_FILTER_BLOCK@@@Z @ 0x1C00A4E40
 * Callers:
        ...
        struct _NDIS_FILTER_BLOCK *a3)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qqq(0x3Eu, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, a2, a3);
  memset(a2, 0, 0x90uLL);
  if ( !ndisReferenceMiniportByHandleForNsi((__int64)a1, 3u, 0x3Bu) )
    goto LABEL_10;
  memset(v26, 0, sizeof(v26));
  *(_DWORD *)v26 = 15466902;
  *(_DWORD *)&v26[32] = 0;
...
LABEL_10:
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qqqL(0x3Fu, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, a2, a3, SetMiniport);
  return 0LL;
}
