/*
 * XREFs of ndisCleanUpForProtocol @ 0x1C00BFBA4
 * Callers:
...
void __fastcall ndisCleanUpForProtocol(__int64 a1, int a2)
{
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_q(0x37u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, a1);
  v3 = *(_DWORD **)(a1 + 16);
  if ( *(_DWORD *)(a1 + 432) )
  {
    v6 = 0;
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_q(0x38u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, a1);
}
