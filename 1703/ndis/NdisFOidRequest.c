/*
 * XREFs of NdisFOidRequest @ 0x1C000A120
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisFOidRequest(NDIS_HANDLE NdisFilterHandle, PNDIS_OID_REQUEST OidRequest)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(51LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, NdisFilterHandle, OidRequest);
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qD(52LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, OidRequest, v4);
  return v4;
}
