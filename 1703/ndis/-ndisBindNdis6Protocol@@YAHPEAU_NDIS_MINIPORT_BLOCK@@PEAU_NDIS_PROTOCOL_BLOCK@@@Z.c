/*
 * XREFs of ?ndisBindNdis6Protocol@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@@Z @ 0x1C00B5D68
 * Callers:
...
__int64 __fastcall ndisBindNdis6Protocol(struct _NDIS_MINIPORT_BLOCK *a1, _NDIS_PROTOCOL_BLOCK *this)
{
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_qq(0x1Au, &WPP_114284bbd43b3e03b71249c63194bfc4_Traceguids, a1, this);
  ...
  if ( ndisReferenceProtocol((__int64)this, 8u) )
  {
    if ( !a1->EthDB )
    {
      ...
      if ( (unsigned __int8)byte_1C009260D >= 2u )
        WPP_SF_qq(0x1Bu, &WPP_114284bbd43b3e03b71249c63194bfc4_Traceguids, a1, this);
      goto LABEL_66;
    }
    p_Mutex = &this->Mutex;
    v9 = 1;
...
LABEL_15:
          ...
          || (v48[37] = a1->SriovCurrentCapabilities, !(unsigned int)ndisIovGetNicSwitchList((__int64)a1, &v48[38])) )
        {
          ...
          ndisIfQueryBindingMiniportIfIndex((__int64)a1, &v48[20], &v48[19], &v48[22], &v48[21]);
          v30 = a1->IfBlock;
          ...
          if ( !(unsigned int)ndisGetPortList((__int64)a1, &v48[25]) )
          {
            ...
            *(_QWORD *)&BugCheckParameter3[2].Header.Lock = Paths;
            ...
            v9 = 0;
            if ( (unsigned __int8)byte_1C009260D >= 4u )
              WPP_SF_q(0x59u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, (__int64)this);
            ...
            Blink = v31;
            if ( (unsigned __int8)byte_1C009260D >= 4u )
              WPP_SF_qD(0x5Au, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, (__int64)this, v31);
            if ( Blink == 259 )
            {
            ...
            {
              if ( !ndisReferenceOpenByHandle(
                      (struct _NDIS_OPEN_BLOCK *)BugCheckParameter3[0].Header.WaitListHead.Blink,
                      2u) )
                KeBugCheckEx(
                  0x7Cu,
                  0x16uLL,
...
LABEL_67:
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_qq(0x1Du, &WPP_114284bbd43b3e03b71249c63194bfc4_Traceguids, a1, this);
  return Blink;
}
