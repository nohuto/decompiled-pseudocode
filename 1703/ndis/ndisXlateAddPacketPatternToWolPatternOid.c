/*
 * XREFs of ndisXlateAddPacketPatternToWolPatternOid @ 0x1C00D7F88
 * Callers:
  ...
  *a2 = 0;
  ...
  if ( wistd::operator==<_NDIS_PM_WOL_PATTERN,KFreePool<_NDIS_PM_WOL_PATTERN>>(&v18) )
  {
    if ( (unsigned __int8)byte_1C0092612 >= 4u )
      WPP_SF_q(0x6Du, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1);
    v6 = -1073741670;
    if ( !v5 )
      goto LABEL_27;
    goto LABEL_26;
      ...
      if ( !(unsigned int)NdisConvertNtStatusToNdisStatus(v11 + v12 < v11 ? 0xC0000095 : 0) )
      {
        if ( *(_DWORD *)(a1 + 48) >= v13 )
        {
          ...
          if ( !v6 )
          {
            ...
            if ( (unsigned __int8)byte_1C0092612 >= 4u )
              WPP_SF_q(0x6Eu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1);
            v6 = -1073741670;
            if ( P )
