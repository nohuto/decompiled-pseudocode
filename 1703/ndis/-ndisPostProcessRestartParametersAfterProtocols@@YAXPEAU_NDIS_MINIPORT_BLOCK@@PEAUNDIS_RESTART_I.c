/*
 * XREFs of ?ndisPostProcessRestartParametersAfterProtocols@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_RESTART_INFORMATION@@@Z @ 0x1C0016BE4
 * Callers:
    ...
    else
    {
      ...
      if ( IoWMIRegistrationControl(a1->DeviceObject, 4u) )
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 3u )
          WPP_SF_q(37LL, &WPP_114284bbd43b3e03b71249c63194bfc4_Traceguids, a1);
      }
    }
  }
}
