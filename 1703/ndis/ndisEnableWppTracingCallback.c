/*
 * XREFs of ndisEnableWppTracingCallback @ 0x1C0050710
 * Callers:
 *     WppClassicProviderCallback @ 0x1C0050320 (WppClassicProviderCallback.c)
...
void __fastcall ndisEnableWppTracingCallback(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, unsigned __int8 a5)
{
  ...
  {
    if ( byte_1C0092609 )
      WPP_SF_(0x63u, &WPP_bde249736f00345f1574c6c7be067711_Traceguids);
    v10 = KeAcquireSpinLockRaiseToDpc(&ndisMiniportListLock);
    v11 = ndisMiniportList;
    v12 = v10;
    while ( v11 )
    {
      if ( (unsigned int)++v7 > 1 && byte_1C0092609 )
        WPP_SF_(0x64u, &WPP_bde249736f00345f1574c6c7be067711_Traceguids);
      ...
      {
        WPP_SF_qq(0x65u, &WPP_bde249736f00345f1574c6c7be067711_Traceguids, v11, v11->DriverHandle);
      }
      v11 = v11->NextGlobalMiniport;
    }
    KeReleaseSpinLock(&ndisMiniportListLock, v12);
    if ( byte_1C0092609 )
      WPP_SF_(0x66u, &WPP_bde249736f00345f1574c6c7be067711_Traceguids);
  }
}
