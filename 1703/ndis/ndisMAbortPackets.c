/*
 * XREFs of ndisMAbortPackets @ 0x1C00258E0
 * Callers:
...
__int64 **__fastcall ndisMAbortPackets(__int64 a1, __int64 a2, struct _NDIS_STACK_RESERVED *a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(67LL, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, 0LL);
  v4 = *(_QWORD **)(a1 + 832);
  if ( v4 )
  {
    *(_QWORD *)(a1 + 832) = *v4;
  ...
  *(_QWORD *)(a1 + 144) = 0LL;
  while ( 1 )
  {
    ...
    *(_DWORD *)(a1 + 1856) = 726110;
  }
  *(_DWORD *)(a1 + 120) |= 0x400000u;
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    return (__int64 **)WPP_SF_qq(68LL, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, 0LL);
  return result;
}
