/*
 * XREFs of ?NdisPDAllocateBufferSet@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KGPEAKKPEAPEAUPD_BUFFER_SET_HANDLE__@@@Z @ 0x1C00EB430
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisPDInitializePDBuffers@@YAXPEAPEAU_PD_BUFFER@@KT_LARGE_INTEGER@@PEAEKKG@Z @ 0x1C00EE544 (-ndisPDInitializePDBuffers@@YAXPEAPEAU_PD_BUFFER@@KT_LARGE_INTEGER@@PEAEKKG@Z.c)
 */
...
LABEL_5:
  ...
  v16 = *(_QWORD *)(*(_QWORD *)(v16 + 32) + 5608LL);
...
LABEL_24:
  ...
  v32.m_Lock = (KPushLockBase *)qword_1C00926D0;
