/*
 * XREFs of ndisCreateFilterAdapterRegistry @ 0x1C00B79C4
 * Callers:
...
__int64 __fastcall ndisCreateFilterAdapterRegistry(PCUNICODE_STRING Source, __int64 a2)
{
  ...
  *(_DWORD *)&Destination.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x58u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, Source, a2);
  v5 = *(const GUID **)(a2 + 16);
  if ( v5 )
  {
...
LABEL_10:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqd(0x59u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, Source, a2, v2);
  return v2;
}
