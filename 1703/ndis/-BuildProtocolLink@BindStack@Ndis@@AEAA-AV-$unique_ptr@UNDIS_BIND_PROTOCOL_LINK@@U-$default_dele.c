/*
 * XREFs of ?BuildProtocolLink@BindStack@Ndis@@AEAA?AV?$unique_ptr@UNDIS_BIND_PROTOCOL_LINK@@U?$default_delete@UNDIS_BIND_PROTOCOL_LINK@@@wistd@@@wistd@@PEAU_UNICODE_STRING@@@Z @ 0x1C00B1C74
 * Callers:
...
_QWORD *__fastcall Ndis::BindStack::BuildProtocolLink(void *a1, _QWORD *a2, __int64 a3)
{
  ...
  if ( P )
  {
    ...
    if ( _InterlockedExchangeAdd(v5 + 14, 0xFFFFFFFF) == 1 )
