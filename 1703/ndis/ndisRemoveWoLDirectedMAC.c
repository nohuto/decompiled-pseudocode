/*
 * XREFs of ndisRemoveWoLDirectedMAC @ 0x1C00D6E60
 * Callers:
...
__int64 __fastcall ndisRemoveWoLDirectedMAC(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_q(0x95u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1);
  v5 = 131073;
  memset(v6, 0, sizeof(v6));
  *(_DWORD *)&v6[8] = 0;
  ...
  *(_DWORD *)&v6[48] = 4;
  ...
  if ( v3 )
  {
    if ( (unsigned __int8)byte_1C0092615 >= 2u )
      WPP_SF_d(0x96u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v3);
  }
  else
  {
    *(_BYTE *)(v2 + 1068) = 0;
  ...
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_qD(0x97u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a1, v3);
  return v3;
}
