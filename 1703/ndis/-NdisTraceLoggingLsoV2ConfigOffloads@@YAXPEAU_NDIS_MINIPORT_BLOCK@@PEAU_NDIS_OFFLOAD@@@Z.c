/*
 * XREFs of ?NdisTraceLoggingLsoV2ConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C00157C4
 * Callers:
...
void __fastcall NdisTraceLoggingLsoV2ConfigOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( (unsigned int)dword_1C0091010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v31 = 1LL;
      v33 = 1LL;
      TlgWrite(v2, &unk_1C0080C06, v3, (LPCGUID)v4, 0xBu, &pData);
    }
  }
}
