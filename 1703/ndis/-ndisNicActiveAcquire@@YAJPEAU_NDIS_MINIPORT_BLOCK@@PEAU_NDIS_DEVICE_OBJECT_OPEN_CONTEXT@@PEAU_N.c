/*
 * XREFs of ?ndisNicActiveAcquire@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@PEAU_NDIS_PM_NIC_ACTIVE@@PEAU_IRP@@@Z @ 0x1C00719C4
 * Callers:
        ...
        struct _IRP *a4)
{
  ...
  {
    if ( AoAc->ActiveRef == 1 && (unsigned __int8)byte_1C0092610 >= 4u )
      WPP_SF_LqZ(
        0xCu,
    ...
    if ( v16 != 259 )
    {
      if ( v16 && (unsigned __int8)byte_1C0092615 >= 2u )
        WPP_SF_dq(0xDu, &WPP_d5f9bd1644a2353086e1469436a05243_Traceguids, v16, a1);
  ...
  {
    LODWORD(v18) = v5;
    WPP_SF_qdD(0xEu, &WPP_d5f9bd1644a2353086e1469436a05243_Traceguids, (__int64)a1, ActiveRef, v18);
  }
  return v5;
}
