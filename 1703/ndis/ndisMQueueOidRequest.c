/*
 * XREFs of ndisMQueueOidRequest @ 0x1C0047B44
 * Callers:
...
__int64 __fastcall ndisMQueueOidRequest(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(0x15u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2);
    v6 = byte_1C0092612;
  }
  *v3 = 0LL;
  v3[1] = 0LL;
...
LABEL_11:
  ...
  {
    v11 = v5;
    WPP_SF_qqd(0x16u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a2, v11);
  }
  return v5;
}
