/*
 * XREFs of ndisMKillOpen @ 0x1C00FB908
 * Callers:
 ...
 *     EthDeleteFilterOpenAdapter @ 0x1C00261A0 (EthDeleteFilterOpenAdapter.c)
 *     WPP_SF_q @ 0x1C003C9C8 (WPP_SF_q.c)
 *     ndisMRestoreFilterSettings @ 0x1C0047C1C (ndisMRestoreFilterSettings.c)
 *     nullDeleteFilterOpenAdapter @ 0x1C00641A8 (nullDeleteFilterOpenAdapter.c)
...
void __fastcall ndisMKillOpen(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_q(0xAu, &WPP_750a86c9627131e70d92a3a5e350e831_Traceguids, a1);
  ...
  *(_DWORD *)(v1 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_q(0xBu, &WPP_750a86c9627131e70d92a3a5e350e831_Traceguids, a1);
  KeLowerIrql(v3);
