/*
 * XREFs of ?NdisPDPostAndDrainItems@@YAXPEAUPD_QUEUE_HANDLE__@@PEAPEAU_SINGLE_LIST_ENTRY@@PEAPEAPEAU2@K@Z @ 0x1C00744B0
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)a1 + 15) = v10;
  if ( *((_QWORD *)a1 + 5) && _InterlockedCompareExchange((volatile signed __int32 *)a1 + 14, 0, 1) == 1 )
  {
    if ( (unsigned __int8)byte_1C0092624 >= 5u )
      WPP_SF_q(0x64u, &WPP_2929d52fc6803c0d5180733d460ecc8a_Traceguids, (__int64)a1);
