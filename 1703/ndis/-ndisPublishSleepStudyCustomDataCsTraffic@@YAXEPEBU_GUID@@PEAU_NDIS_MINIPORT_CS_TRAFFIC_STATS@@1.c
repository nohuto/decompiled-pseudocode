/*
 * XREFs of ?ndisPublishSleepStudyCustomDataCsTraffic@@YAXEPEBU_GUID@@PEAU_NDIS_MINIPORT_CS_TRAFFIC_STATS@@1@Z @ 0x1C00EA160
 * Callers:
        ...
        struct _NDIS_MINIPORT_CS_TRAFFIC_STATS *a4)
{
  ...
  do
  {
    ndisPublishSleepStudyCustomData(a1, a2, off_1C007BE70[v4], v15[v4]);
    ++v4;
    --v14;
  }
  while ( v14 );
