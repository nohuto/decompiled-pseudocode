/*
 * XREFs of NdisMGetDeviceProperty @ 0x1C00BE510
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        PCM_RESOURCE_LIST *AllocatedResourcesTranslated)
{
  ...
  if ( PhysicalDeviceObject )
    *PhysicalDeviceObject = (PDEVICE_OBJECT)*((_QWORD *)MiniportAdapterHandle + 482);
  if ( FunctionalDeviceObject )
    *FunctionalDeviceObject = (PDEVICE_OBJECT)*((_QWORD *)MiniportAdapterHandle + 481);
  if ( NextDeviceObject )
    *NextDeviceObject = (PDEVICE_OBJECT)*((_QWORD *)MiniportAdapterHandle + 483);
