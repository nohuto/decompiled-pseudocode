/*
 * XREFs of ndisPowerSuspendRequestComplete @ 0x1C006EC90
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a5)
{
  ...
  if ( (unsigned __int8)byte_1C0092615 >= 4u )
    WPP_SF_qD(0x15u, &WPP_3059abd58ba5345e836db04510415190_Traceguids, (__int64)a4, *a5);
  ndisLogMiniportEvent((__int64)a4, 0xFu);
  if ( *a5 < 0 )
  {
    v11 = a4->SelectiveSuspend;
    NdisTraceLoggingUnexpectedSelectiveSuspendError(a4, 0x49Au, *a5);
    v11->LastUnexpectedFailureLine[1] = v11->LastUnexpectedFailureLine[0];
    v11->LastUnexpectedFailureLine[0] = 1178;
    if ( (unsigned __int8)byte_1C0092616 >= 2u )
      WPP_SF_dq(0x17u, &WPP_3059abd58ba5345e836db04510415190_Traceguids, *a5, a4);
  ...
  else
  {
    ...
    if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
      Template_jqxqq(
        ...
        &a4->InterfaceGuid,
        (unsigned __int64)&a4->InterfaceGuid,
        a4->IfIndex,
        a4->NetLuid.Value,
        1,
        SelectiveSuspend->LastRequestedIdlePowerState);
    if ( (unsigned __int8)byte_1C0092610 >= 4u )
      WPP_SF_qZ(0x16u, &WPP_3059abd58ba5345e836db04510415190_Traceguids, (__int64)a4, &a4->pAdapterInstanceName->Length);
  }
}
