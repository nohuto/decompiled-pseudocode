/*
 * XREFs of ?ndisNsiGetInterfaceRodInformation@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00A3830
 * Callers:
 ...
 *     ?ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z @ 0x1C00A47DC (-ndisGetMiniportIfBlock@@YAPEAU_NDIS_IF_BLOCK@@PEAU1@@Z.c)
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qqq(0x4Eu, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, a2, v5);
    v4 = v24;
    v7 = a2;
    v6 = a1;
  }
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qqqL(0x4Fu, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, v6, v7, v5, v3);
  return v3;
}
