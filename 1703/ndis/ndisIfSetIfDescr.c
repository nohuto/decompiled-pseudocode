/*
 * XREFs of ndisIfSetIfDescr @ 0x1C0044FFC
 * Callers:
...
__int64 __fastcall ndisIfSetIfDescr(__int64 a1)
{
  ...
  *(_DWORD *)&String2.Length = 0;
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_q(0xC7u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1);
  if ( a1 )
  {
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qD(0xC8u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, updated);
  return updated;
}
