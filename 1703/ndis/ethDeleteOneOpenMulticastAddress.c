/*
 * XREFs of ethDeleteOneOpenMulticastAddress @ 0x1C00E0C78
 * Callers:
...
__int64 __fastcall ethDeleteOneOpenMulticastAddress(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_q(0xBu, &WPP_ba5984028d6c3cd85818b9c96967d805_Traceguids, a1);
...
LABEL_8:
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_dd(0xCu, &WPP_ba5984028d6c3cd85818b9c96967d805_Traceguids, (unsigned __int8)*a3, 0);
  return 0LL;
}
