/*
 * XREFs of ?ndisNsiGetInterfaceRodEnumObject@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00A4190
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qq(0x58u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, a3);
    v4 = v32;
    v7 = v33;
    v6 = v34;
  }
...
LABEL_50:
            ...
            if ( v7->IsNdisFilter )
            {
              ...
              v35 = Miniport;
              if ( (unsigned __int8)byte_1C009261D >= 4u )
                WPP_SF_qq(0xD1u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, Miniport, v37);
              ...
              if ( (unsigned __int8)byte_1C009261D >= 4u )
                WPP_SF_qq(0xD2u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, Miniport, v37);
              v8 = v31;
...
LABEL_17:
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qqd(0x59u, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, v7, v5, v3);
  return v3;
}
