/*
 * XREFs of ndisQueueRestoreRequestsOnTop @ 0x1C0049E40
 * Callers:
 ...
 *     ndisFQueueOidRequest @ 0x1C0046B74 (ndisFQueueOidRequest.c)
...
__int64 __fastcall ndisQueueRestoreRequestsOnTop(__int64 a1, __int64 **a2, int a3, char a4)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qD(0x3Du, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1, a3);
  ...
  else
  {
    ...
    if ( *(_BYTE *)v13 == 5 )
    {
      ...
      if ( v7 > 1 )
      {
        ...
        for ( ; v16; --v16 )
          ndisDereferenceRef((PKSPIN_LOCK)(v13 + 320), 0xFu);
      }
LABEL_22:
      if ( *(_BYTE *)v13 != 5 )
      {
...
LABEL_11:
  ...
  if ( v6 && v7 )
  {
    do
    {
      ndisDereferenceRef((PKSPIN_LOCK)(v4 + 320), 0xFu);
      --v7;
    }
    while ( v7 );
  }
...
LABEL_49:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqd(0x3Eu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v9, a2, v10);
  return v10;
}
