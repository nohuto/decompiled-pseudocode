/*
 * XREFs of ?NdisTraceLoggingRareFilterPath@@YAXPEAU_NDIS_FILTER_DRIVER_BLOCK@@W4NdisTLFilterEvent@@H@Z @ 0x1C00EFE6C
 * Callers:
...
void __fastcall NdisTraceLoggingRareFilterPath(const struct _TlgProvider_t *a1)
{
  ...
  _DWORD v20[2]; // [rsp+88h] [rbp-1h] BYREF
  ...
  if ( a1 )
  {
    if ( (unsigned int)dword_1C0091010 > 5 )
    {
      if ( TlgKeywordOn(a1, 0x400000000000uLL) )
      {
        ...
        v11[0] = v2;
        v27 = 4;
        TlgWrite((TraceLoggingHProvider)4, &unk_1C007F989, (LPCGUID)2, (LPCGUID)v1, 8u, &pData);
      }
    }
  }
  else if ( (unsigned int)dword_1C0091010 > 5 && TlgKeywordOn(0LL, 0x400000000000uLL) )
  {
    v15 = 0;
    v18 = 0;
    v13 = v11;
    ...
    v10 = v8;
    v17 = 4;
    TlgWrite((TraceLoggingHProvider)4, &unk_1C007F441, v6, v7, 4u, &pData);
  }
}
