/*
 * XREFs of ndisOidPreIovNicSwitchParameters @ 0x1C00E71B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovNicSwitchParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qq(0x19u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v1, v3);
  v7 = *(_DWORD *)(v3 + 4);
  v8 = 548;
  if ( v7 == 12 )
  {
...
LABEL_52:
  if ( (unsigned __int8)byte_1C0092621 >= 4u )
    WPP_SF_qqDD(0x1Au, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v1, v4, v2, *(_DWORD *)(a1 + 40));
  return v2;
}
