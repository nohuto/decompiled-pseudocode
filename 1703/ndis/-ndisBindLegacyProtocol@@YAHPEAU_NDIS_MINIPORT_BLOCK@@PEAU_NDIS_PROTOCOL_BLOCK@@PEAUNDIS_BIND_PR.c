/*
 * XREFs of ?ndisBindLegacyProtocol@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@PEAUNDIS_BIND_PROTOCOL_LINK@@@Z @ 0x1C00EAB6C
 * Callers:
        ...
        struct NDIS_BIND_PROTOCOL_LINK *a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260D >= 4u )
    WPP_SF_qq(0xAu, &WPP_114284bbd43b3e03b71249c63194bfc4_Traceguids, a1, a2);
    ...
    || PnPDeviceState == NdisPnPDeviceStopped )
  {
    if ( (unsigned __int8)byte_1C009260D >= 3u )
      WPP_SF_qq(0xBu, &WPP_114284bbd43b3e03b71249c63194bfc4_Traceguids, a1, a2);
  }
  else if ( a1->EthDB )
  {
  ...
  {
    LODWORD(Timeout) = v32;
    WPP_SF_qqd(0xDu, &WPP_114284bbd43b3e03b71249c63194bfc4_Traceguids, a1, a2, Timeout);
  }
