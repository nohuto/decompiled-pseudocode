/*
 * XREFs of ?ndisNsiEnumerateAllIfStackEntriesFull@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C001ECF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllIfStackEntriesFull(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_q(102LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1);
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_qD(103LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, a1, v8);
  return v8;
}
