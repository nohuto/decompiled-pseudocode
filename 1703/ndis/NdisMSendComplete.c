/*
 * XREFs of NdisMSendComplete @ 0x1C0054A70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisMSendComplete(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qqd(0x10u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, a3);
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qq(0x11u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2);
}
