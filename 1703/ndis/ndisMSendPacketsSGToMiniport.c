/*
 * XREFs of ndisMSendPacketsSGToMiniport @ 0x1C00578A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsSGToMiniport(__int64 a1, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qqd(0x22u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, a3);
  if ( (_DWORD)v3 )
  {
    v6 = a2;
    v7 = v3;
  ...
  {
    LODWORD(v16) = v3;
    WPP_SF_qqd(0x23u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, v16);
  }
}
