/*
 * XREFs of NdisMPromoteMiniport @ 0x1C005E450
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisMPromoteMiniport(NDIS_HANDLE MiniportHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x64u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, (__int64)MiniportHandle);
  ...
  *((_DWORD *)MiniportHandle + 464) = 727523;
  if ( v4
...
LABEL_16:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x65u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, (__int64)MiniportHandle);
