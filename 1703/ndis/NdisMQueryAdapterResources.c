/*
 * XREFs of NdisMQueryAdapterResources @ 0x1C00DFA50
 * Callers:
 *     <none>
 * Callees:
        ...
        PUINT BufferSize)
{
  ...
  {
    WPP_SF_q(0x36u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, v4);
    v8 = (unsigned __int8)ndisWppEnabledLevelPerFlag;
  }
  v9 = *(_QWORD *)(v4 + 944);
  if ( v9 )
  ...
  if ( v8 >= 4u )
    WPP_SF_qD(0x37u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, v4, *Status);
}
