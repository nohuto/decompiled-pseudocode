/*
 * XREFs of NdisAllocatePacketPoolEx @ 0x1C0013C50
 * Callers:
 *     NdisAllocatePacketPool @ 0x1C0051AA0 (NdisAllocatePacketPool.c)
 *     ndisVerifierAllocatePacketPoolEx @ 0x1C0065AC0 (ndisVerifierAllocatePacketPoolEx.c)
 *     DriverEntry @ 0x1C01129E0 (DriverEntry.c)
 * Callees:
 *     NdisFreePacket @ 0x1C0013E40 (NdisFreePacket.c)
 *     NdisAllocatePacket @ 0x1C0013EF0 (NdisAllocatePacket.c)
 *     NdisPacketSize @ 0x1C0016810 (NdisPacketSize.c)
        ...
        UINT ProtocolReservedLength)
{
  ...
  if ( (unsigned __int8)byte_1C009261C >= 4u )
    WPP_SF_(10LL, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids);
  *PoolHandle = 0LL;
    ...
    && (PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, 0x70uLL, v10), (v15 = PoolWithTag) != 0LL) )
  {
    ...
    *((_DWORD *)v15 + 4) = 0;
    ...
    if ( *Status )
    {
      ...
      v22 = v19->Flink;
      v23 = (_LIST_ENTRY **)v15[12];
      if ( v19->Flink->Blink != v19 || *v23 != v19 )
        __fastfail(3u);
      *v23 = v22;
    ...
    if ( (unsigned __int8)byte_1C009261C >= 4u )
      WPP_SF_d(11LL, &WPP_2149d9bc815e3bedf819412f93ade2f1_Traceguids, (unsigned int)*Status);
  }
  else
  {
LABEL_28:
