/*
 * XREFs of ndisXlateWakeUpPatternListToWolPatternList @ 0x1C00D8740
 * Callers:
 *     ndisOidPostWolPatternList @ 0x1C004C0D0 (ndisOidPostWolPatternList.c)
 * Callees:
...
void __fastcall ndisXlateWakeUpPatternListToWolPatternList(__int64 a1)
{
  ...
  if ( (unsigned int)v5 > *(_DWORD *)(v1 + 48) )
  {
    if ( (unsigned __int8)byte_1C0092612 >= 2u )
      WPP_SF_(0x76u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids);
    return;
  }
  if ( !(_DWORD)v5 )
    return;
