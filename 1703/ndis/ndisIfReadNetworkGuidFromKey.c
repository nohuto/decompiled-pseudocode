/*
 * XREFs of ndisIfReadNetworkGuidFromKey @ 0x1C0016938
 * Callers:
 ...
 *     ?QueryValueGuid@KRegKey@@QEAAJPEBGPEAU_GUID@@@Z @ 0x1C00B1090 (-QueryValueGuid@KRegKey@@QEAAJPEBGPEAU_GUID@@@Z.c)
 */
...
__int64 __fastcall ndisIfReadNetworkGuidFromKey(KRegKey *this, struct _GUID *a2)
{
  ...
  if ( ValueGuid >= 0 )
  {
    if ( (unsigned __int8)byte_1C009261D >= 3u )
      WPP_SF_(192LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids);
    return (unsigned int)-1073741823;
  }
  ...
  KeReleaseSpinLock(&ndisIfListLock, v8);
  if ( (unsigned __int8)byte_1C009261D >= 3u )
    WPP_SF__guid_(193LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, &v11);
  return 3221225473LL;
}
