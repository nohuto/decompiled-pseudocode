/*
 * XREFs of NdisOpenConfigurationKeyByName @ 0x1C00AF9D0
 * Callers:
        ...
        PNDIS_HANDLE SubKeyHandle)
{
  ...
  if ( (unsigned __int8)byte_1C009260F >= 4u )
    WPP_SF_q(0xDu, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids, (__int64)ConfigurationHandle);
  ...
  if ( (unsigned __int8)byte_1C009260F >= 4u )
    WPP_SF_q(0xEu, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids, (__int64)ConfigurationHandle);
}
