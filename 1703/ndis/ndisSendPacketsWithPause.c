/*
 * XREFs of ndisSendPacketsWithPause @ 0x1C00585D0
 * Callers:
...
void __fastcall ndisSendPacketsWithPause(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qqd(0x30u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, a3);
...
LABEL_37:
  if ( (unsigned __int8)byte_1C009260A >= 4u )
  {
    ...
    WPP_SF_qqd(0x31u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, v4, BugCheckOnFailure);
  }
}
