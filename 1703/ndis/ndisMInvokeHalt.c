/*
 * XREFs of ndisMInvokeHalt @ 0x1C00BF9B4
 * Callers:
...
void __fastcall ndisMInvokeHalt(__int64 a1, _NDIS_HALT_ACTION a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0xCDu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, v2);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0xCEu, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, a1, v2);
}
