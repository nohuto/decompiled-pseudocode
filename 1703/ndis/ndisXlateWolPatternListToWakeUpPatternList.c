/*
 * XREFs of ndisXlateWolPatternListToWakeUpPatternList @ 0x1C00D89B0
 * Callers:
 *     ndisOidPostWakeUpPatternList @ 0x1C004C090 (ndisOidPostWakeUpPatternList.c)
 * Callees:
...
void __fastcall ndisXlateWolPatternListToWakeUpPatternList(__int64 a1)
{
  ...
  if ( (unsigned int)v4 > *(_DWORD *)(v1 + 48) )
  {
    if ( (unsigned __int8)byte_1C0092612 >= 2u )
      WPP_SF_(0x75u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids);
    return;
  }
  if ( !(_DWORD)v4 )
    return;
