/*
 * XREFs of ?ndisIfCreateCompartment@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@PEAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@@Z @ 0x1C0040768
 * Callers:
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a2)
{
  ...
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_(0x9Cu, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids);
  *a2 = 0LL;
...
LABEL_29:
  if ( (unsigned __int8)byte_1C009261D >= 4u )
    WPP_SF_dq(157LL, &WPP_af1106a9a46b3e0e2b308003762cd579_Traceguids, (unsigned int)Network, *a2);
