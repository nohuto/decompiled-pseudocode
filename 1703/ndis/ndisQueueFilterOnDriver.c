/*
 * XREFs of ndisQueueFilterOnDriver @ 0x1C001CFB4
 * Callers:
...
unsigned __int8 __fastcall ndisQueueFilterOnDriver(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(45LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, a2);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqd(46LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, a2, v4);
  return v4;
}
