/*
 * XREFs of ?NdisTraceLoggingDeviceAdded@@YAXPEAU_NDIS_IF_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@PEAUNDIS_ADDDEVICE_PARAMETERS@@JPEBG@Z @ 0x1C0014AA0
 * Callers:
 *     ndisAddDevice @ 0x1C00F6250 (ndisAddDevice.c)
 * Callees:
 *     _TlgKeywordOn @ 0x1C0015A3C (_TlgKeywordOn.c)
 *     _TlgWrite @ 0x1C0015A70 (_TlgWrite.c)
 *     _TlgCreateWsz @ 0x1C0015B40 (_TlgCreateWsz.c)
...
void __fastcall NdisTraceLoggingDeviceAdded(const struct _TlgProvider_t *a1, int a2, __int64 a3, int a4)
{
  ...
  if ( a4 < 0 )
  {
    if ( (unsigned int)dword_1C0091010 > 5 && TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      TlgWrite(v18, &unk_1C0080264, v19, v20, 7u, &pData);
    }
  }
  else if ( (unsigned int)dword_1C0091010 > 5 && TlgKeywordOn(a1, 0x400000000000uLL) )
  {
    ...
    v27 = &v31;
    v30 = v5 + 598;
    v8 = *(_WORD *)(v5 + 596) & 0xFFFE;
    v25 = 4;
    v31 = v8;
    p_Size = &v36.Size;
    v36.Ptr = v5 + 10;
    v9 = *(_WORD *)(v5 + 8) & 0xFFFE;
    v28 = 2;
    v36.Size = v9;
    v10 = (const WCHAR *)&unk_1C007D350;
    v34 = 2;
    v37 = v5 + 540;
    v38 = 16;
    v40 = v5 + 1312;
    ...
    TlgWrite(v11, &unk_1C0080611, v12, v13, 0xAu, &pData);
  }
}
