/*
 * XREFs of ?ndisNblTrackerTransferOwnershipSingleNbl@@YAXPEAU_NET_BUFFER_LIST@@PEAUNDIS_NBL_TRACKER_HANDLE__@@1E@Z @ 0x1C00664D4
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  if ( ndisNblTrackerMode >= NdisTrackNblFullLogNoStack )
    ndisNblTrackerRecordEvent(a1, 0LL, 0x86u, a3, 1u);
  v6 = a3 & 0xFFFFFFFFFFFFFFFDuLL;
  v7 = (void *)ndisSourceHandleFromOwner(v6, a2);
  if ( (v6 & 1) != 0 )
    v6 ^= ((unsigned __int8)v6 ^ (unsigned __int8)(2 * v3)) & 2;
  v8 = (unsigned __int64)a1->NetBufferListInfo[26];
