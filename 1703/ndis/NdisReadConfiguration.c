/*
 * XREFs of NdisReadConfiguration @ 0x1C00AE8B0
 * Callers:
 ...
 *     ndisOpenProtocolSubkey @ 0x1C00D9B2C (ndisOpenProtocolSubkey.c)
        ...
        NDIS_PARAMETER_TYPE ParameterType)
{
  ...
  if ( (unsigned __int8)byte_1C009260F >= 4u )
    WPP_SF_Z(0x12u, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids, &Keyword->Length);
  v10 = 0;
  P = Keyword->Buffer;
  v31 = -1073741823;
  do
  {
    if ( RtlEqualUnicodeString(Keyword, (PCUNICODE_STRING)&unk_1C007A1A0 + v10, 1u) )
    {
      v26 = (struct _NDIS_CONFIGURATION_PARAMETER *)((char *)&unk_1C0081B30 + 24 * v10);
      goto LABEL_84;
    }
    ++v10;
  }
  ...
  if ( !RtlEqualUnicodeString(Keyword, &stru_1C007A200, 1u)
...
LABEL_88:
    do
    {
      if ( RtlEqualUnicodeString(Keyword, (PCUNICODE_STRING)&unk_1C007A110 + v9, 1u) )
        break;
      ++v9;
    }
    while ( v9 < 9 );
    ...
    if ( v9 >= 9 )
    {
      if ( RtlEqualUnicodeString(Keyword, &stru_1C007A1F0, 1u) )
      {
        if ( ParameterType )
          goto LABEL_24;
      ...
      if ( RtlEqualUnicodeString(Keyword, &stru_1C007A1E0, 1u) )
      {
        if ( ParameterType )
          goto LABEL_24;
        dword_1C00940E0 = ndisReadNDKGlobalFlags();
        v26 = (struct _NDIS_CONFIGURATION_PARAMETER *)&unk_1C00940D8;
        goto LABEL_71;
      }
...
LABEL_16:
      ...
      {
        if ( (unsigned __int8)byte_1C009260F >= 3u )
          WPP_SF_(0x13u, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids);
LABEL_70:
        v26 = (struct _NDIS_CONFIGURATION_PARAMETER *)&unk_1C0081B18;
LABEL_71:
        v7 = Status;
LABEL_84:
        *ParameterValue = v26;
...
LABEL_33:
        ...
        if ( RtlEqualUnicodeString(Keyword, &stru_1C007A220, 1u) )
        {
...
LABEL_30:
  if ( (unsigned __int8)byte_1C009260F >= 4u )
    WPP_SF_(0x14u, &WPP_99a60aa0491337cae2647d317c30bcf5_Traceguids);
}
