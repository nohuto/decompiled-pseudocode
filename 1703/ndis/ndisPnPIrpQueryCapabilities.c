/*
 * XREFs of ndisPnPIrpQueryCapabilities @ 0x1C00AD188
 * Callers:
...
__int64 __fastcall ndisPnPIrpQueryCapabilities(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _BYTE *a5)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0x2Du, &WPP_7f404e1ae4803d6fc8eef9c80d758293_Traceguids, a2);
  ...
  *(_BYTE *)(v8 - 69) = 0;
  ...
  if ( v9 >= 0 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0092614 >= 4u )
        WPP_SF_q(0x2Eu, &WPP_7f404e1ae4803d6fc8eef9c80d758293_Traceguids, a2);
      *(_DWORD *)(*(_QWORD *)(v5 + 8) + 4LL) |= 0x200u;
    }
    if ( (*(_DWORD *)(a2 + 124) & 0x2000) == 0 && (*(_DWORD *)(a2 + 1816) & 0x80u) == 0 )
    {
      if ( (unsigned __int8)byte_1C0092614 >= 4u )
        WPP_SF_q(0x2Fu, &WPP_7f404e1ae4803d6fc8eef9c80d758293_Traceguids, a2);
      *(_DWORD *)(*(_QWORD *)(v5 + 8) + 4LL) &= ~0x200u;
    }
    if ( (*(_BYTE *)(*(_QWORD *)(a2 + 3784) + 26LL) & 0x20) != 0 )
    {
      if ( (unsigned __int8)byte_1C0092614 >= 4u )
        WPP_SF_q(0x30u, &WPP_7f404e1ae4803d6fc8eef9c80d758293_Traceguids, a2);
