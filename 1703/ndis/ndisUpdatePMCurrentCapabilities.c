/*
 * XREFs of ndisUpdatePMCurrentCapabilities @ 0x1C00219F4
 * Callers:
 ...
 * Callees:
 *     ndisResetPMCapabilities @ 0x1C00A6480 (ndisResetPMCapabilities.c)
 *     ndisComparePMCapabilities @ 0x1C00BC6C8 (ndisComparePMCapabilities.c)
 *     ?ndisConvertPMCapabilitiesToPnp@@YAXPEAU_NDIS_PM_CAPABILITIES@@PEAU_NDIS_PNP_CAPABILITIES@@@Z @ 0x1C00BC6E8 (-ndisConvertPMCapabilitiesToPnp@@YAXPEAU_NDIS_PM_CAPABILITIES@@PEAU_NDIS_PNP_CAPABILITIES@@@Z.c)
 */
  ...
  *(_DWORD *)(a1 + 1116) = v7;
    ...
    && *(_DWORD *)(a1 + 1268) )
  {
    ...
    *(_DWORD *)(a1 + 1088) = v15;
    ...
    v16 = *(_DWORD *)(a1 + 3888);
    if ( (v16 & 0x10000000) != 0 && (*(_BYTE *)(a1 + 1088) & 1) == 0 && *(_DWORD *)(a1 + 3800) != 8 )
      *(_DWORD *)(a1 + 3888) = v16 | 0x100;
    v17 = *(_DWORD *)(a1 + 3888);
    if ( (v17 & 0x10) == 0 )
    {
      v18 = *(_DWORD *)(a1 + 1040);
  ...
  return (unsigned __int8)ndisComparePMCapabilities(v21, v24) == 0;
}
