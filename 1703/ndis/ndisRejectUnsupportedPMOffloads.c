/*
 * XREFs of ndisRejectUnsupportedPMOffloads @ 0x1C00D6A14
 * Callers:
    ...
    if ( !ndisIsPMProtocolOffloadSupported(*(_DWORD *)(i + 60), (__int64)MiniportAdapterHandle) )
    {
      ...
      if ( v5 == v4 )
      {
        if ( (unsigned __int8)byte_1C0092615 >= 2u )
          WPP_SF_d(0x7Cu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v5);
      }
      else
      {
        memset(v11, 0, sizeof(v11));
        ...
        *(_DWORD *)&v11[48] = 4;
        ...
        if ( (unsigned __int8)byte_1C0092615 >= 2u )
          WPP_SF_d(0x7Du, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, SetMiniport);
      }
      return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 3976), 0, 1, 0);
    }
  }
