/*
 * XREFs of NdisMIndicateStatus @ 0x1C005E1A0
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT StatusBufferSize)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qD(0xA4u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, (__int64)MiniportHandle, GeneralStatus);
  ...
  if ( !*((_QWORD *)MiniportHandle + 3) )
  {
    ...
    *((_DWORD *)MiniportHandle + 464) = 732811;
...
LABEL_11:
  ...
  NewIrql[0] = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)MiniportHandle + 12);
  *((_QWORD *)MiniportHandle + 65) = KeGetCurrentThread();
  *((_DWORD *)MiniportHandle + 464) = 732885;
  if ( GeneralStatus == 1073807371 )
  {
...
LABEL_25:
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qD(0xA5u, &WPP_ce03a118a6ed3e1c1740a62e9d2221ee_Traceguids, (__int64)MiniportHandle, GeneralStatus);
}
