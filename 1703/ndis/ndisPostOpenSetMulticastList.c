/*
 * XREFs of ndisPostOpenSetMulticastList @ 0x1C001DAB0
 * Callers:
...
__int64 __fastcall ndisPostOpenSetMulticastList(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    WPP_SF_qqqL(127LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v3, a1, a2, a3);
    v8 = byte_1C0092612;
  }
  if ( *(_DWORD *)(a2 + 160) )
  {
  ...
  if ( (unsigned __int8)v8 >= 4u )
    return WPP_SF_qqqL(128LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v3, a1, a2, a3);
  return result;
}
