/*
 * XREFs of ndisOidPostPMRemoveWOLPattern @ 0x1C004BD90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisUpdateWmiPMParamsForPatterns @ 0x1C004CFA0 (ndisUpdateWmiPMParamsForPatterns.c)
...
void __fastcall ndisOidPostPMRemoveWOLPattern(__int64 *a1)
{
  ...
  else
  {
    ...
    if ( v9 && (*(_DWORD *)(v4 + 88) & 0x4000) == 0 )
      ndisDeletePatternEntry((_DWORD *)(v9 + 864), v8);
  }
}
