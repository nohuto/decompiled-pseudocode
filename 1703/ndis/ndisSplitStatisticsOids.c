/*
 * XREFs of ndisSplitStatisticsOids @ 0x1C00B9AD0
 * Callers:
...
__int64 __fastcall ndisSplitStatisticsOids(__int64 a1, int *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_q(0x15u, &WPP_1a1a0ae58f2132a5e47c5daabd3d204f_Traceguids, v3);
  ...
  *(_QWORD *)(a1 + 24) = PoolWithTag;
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qD(0x16u, &WPP_1a1a0ae58f2132a5e47c5daabd3d204f_Traceguids, v3, v7);
  return v7;
}
