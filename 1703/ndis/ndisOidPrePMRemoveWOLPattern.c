/*
 * XREFs of ndisOidPrePMRemoveWOLPattern @ 0x1C00D5840
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMRemoveWOLPattern(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0x58u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v8, v4);
  v9 = *(_QWORD *)(a1 + 24);
  v10 = 6;
  LOBYTE(a4) = 20;
  if ( v9
...
LABEL_31:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qD(0x59u, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, *(_QWORD *)a1, *(_DWORD *)(a1 + 40));
  return v5;
}
