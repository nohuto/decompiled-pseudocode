/*
 * XREFs of ndisOidPreEthMulticastList @ 0x1C00BA080
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisQueryMiniportEthMulticastList @ 0x1C00D2F20 (ndisQueryMiniportEthMulticastList.c)
 *     ndisQueryOpenEthMulticastList @ 0x1C00D2FF8 (ndisQueryOpenEthMulticastList.c)
...
unsigned __int8 __fastcall ndisOidPreEthMulticastList(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqqq(0x7Du, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v5, v3, v1, a1);
  v6 = *(_DWORD *)(v1 + 4);
  if ( v6 == 2 )
  {
    if ( *(_QWORD *)a1 )
...
LABEL_10:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
  {
    ...
    LODWORD(v11) = v4;
    WPP_SF_qqDD(0x7Eu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v5, v3, v11, v12);
  }
  return v4;
}
