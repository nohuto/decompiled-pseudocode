/*
 * XREFs of ndisLWM5IndicateReceive @ 0x1C0068314
 * Callers:
 *     EthIndicateReceive @ 0x1C0067FF0 (EthIndicateReceive.c)
 * Callees:
...
LABEL_34:
  ...
  *(_QWORD *)Packet->ProtocolReserved = Head;
  ...
  v16 = (*(__int64 (__fastcall **)(PNDIS_PACKET, int *, _QWORD, __int64, _DWORD, _DWORD))(*(_QWORD *)(v7 + 3784) + 216LL))(
          v24,
          &v30,
          *(_QWORD *)(v7 + 24),
          v34,
