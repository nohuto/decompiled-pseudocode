/*
 * XREFs of ndisMUnload @ 0x1C0102AF0
 * Callers:
...
void __fastcall ndisMUnload(PDRIVER_OBJECT DriverObject)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x20u, &WPP_750a86c9627131e70d92a3a5e350e831_Traceguids, (__int64)DriverObject);
...
LABEL_9:
    ...
    if ( !i )
      break;
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_q(0x21u, &WPP_750a86c9627131e70d92a3a5e350e831_Traceguids, (__int64)i);
    i->Flags |= 0x8000u;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x22u, &WPP_750a86c9627131e70d92a3a5e350e831_Traceguids, DriverObject, 0LL);
}
