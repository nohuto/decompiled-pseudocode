/*
 * XREFs of ndisOidCloneForCompatibility @ 0x1C000BD2C
 * Callers:
...
LABEL_8:
  ...
  if ( v12 )
  {
    ...
    v17 = 55LL;
LABEL_28:
    WPP_SF_qqd(v17, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a2, *a4, *(_DWORD *)(a2 + 32));
    goto LABEL_11;
  }
