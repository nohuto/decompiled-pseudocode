/*
 * XREFs of NdisCancelDirectOidRequest @ 0x1C0045610
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisCancelDirectOidRequest(NDIS_HANDLE NdisBindingHandle, PVOID RequestId)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0xBAu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, NdisBindingHandle, RequestId);
  v7 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v2 + 96));
  *(_QWORD *)(v2 + 520) = KeGetCurrentThread();
  v8 = *(_QWORD *)(v2 + 2664);
  *(_DWORD *)(v2 + 1856) = 2307055;
  if ( *(_BYTE *)v8 == 5 )
  {
    v3 = v8;
  ...
  *(_DWORD *)(v2 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(0xBBu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, NdisBindingHandle, RequestId);
}
