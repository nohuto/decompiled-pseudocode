/*
 * XREFs of ndisGetOrCreateFilterInstanceKey @ 0x1C00DB224
 * Callers:
        ...
        PUNICODE_STRING Destination)
{
  ...
  *(_DWORD *)&v43.Length = 262146;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x61u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, a3, a2);
...
LABEL_28:
    ...
    if ( v11 )
    {
      do
      {
        if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v11 + 16) + 464LL) + 48LL) & 2) == 0 )
          break;
        v11 = *(_QWORD *)(v11 + 112);
      }
      while ( v11 );
...
LABEL_20:
        ...
        for ( i = 0; i <= 0x270F; ++i )
        {
          ...
          v21 = RegistryValues;
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
            WPP_SF_dd(0x62u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, RegistryValues, v30);
          if ( v21 )
            goto LABEL_68;
...
LABEL_29:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    ...
    WPP_SF_qqqL(0x63u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, Source, v6, v40, ResultLength);
  }
  return v7;
}
