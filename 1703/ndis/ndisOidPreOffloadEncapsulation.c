/*
 * XREFs of ndisOidPreOffloadEncapsulation @ 0x1C00BB9C0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreOffloadEncapsulation(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqq(0xC8u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1, v4, v3);
  v5 = (_DWORD *)(a1 + 40);
...
LABEL_9:
  ...
  {
    LODWORD(v12) = v10;
    WPP_SF_qqDD(0xC9u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v1, v4, v12, *v5);
  }
  return v10;
}
