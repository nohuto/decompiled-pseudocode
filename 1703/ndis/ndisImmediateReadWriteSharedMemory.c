/*
 * XREFs of ndisImmediateReadWriteSharedMemory @ 0x1C00DACB8
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00DA6E0 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00DA790 (NdisImmediateWriteSharedMemory.c)
 * Callees:
