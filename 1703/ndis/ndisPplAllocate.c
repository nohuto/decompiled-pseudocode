/*
 * XREFs of ndisPplAllocate @ 0x1C000E174
 * Callers:
 *     NdisAllocateNetBuffer @ 0x1C000E090 (NdisAllocateNetBuffer.c)
 * Callees:
 *     ?ndisAllocateFromLookasideList@@YAPEAXPEAU_NDIS_NPAGED_LOOKASIDE_LIST@@@Z @ 0x1C000E2A0 (-ndisAllocateFromLookasideList@@YAPEAXPEAU_NDIS_NPAGED_LOOKASIDE_LIST@@@Z.c)
