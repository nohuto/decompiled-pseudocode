/*
 * XREFs of ndisMDeleteMiniportBlockOnRemove @ 0x1C00BED60
 * Callers:
 ...
 *     ?ndisGetNthEntry@@YAPEAU_NDIS_EVENT_LOG_ENTRY@@PEAU_NDIS_EVENT_LOG@@K@Z @ 0x1C006C790 (-ndisGetNthEntry@@YAPEAU_NDIS_EVENT_LOG_ENTRY@@PEAU_NDIS_EVENT_LOG@@K@Z.c)
...
void __fastcall ndisMDeleteMiniportBlockOnRemove(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_q(0x98u, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, a1);
  v3 = *(void **)(a1 + 5616);
  if ( v3 )
  {
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_q(0x99u, &WPP_8366cf1575bf39c3737a7bb71aad7eff_Traceguids, a1);
  v4 = *(void **)(a1 + 4008);
  if ( v4 )
  {
  ...
  *(_QWORD *)(a1 + 4504) = 0LL;
  ...
  {
    *v23 = 0LL;
    ExFreePoolWithTag(*(PVOID *)(a1 + 5608), 0);
    *(_QWORD *)(a1 + 5608) = 0LL;
  }
  v24 = *(struct _NDIS_REFCOUNT_BLOCK **)(a1 + 5600);
  if ( v24 != (struct _NDIS_REFCOUNT_BLOCK *)-1LL )
    ndisFreeWatchdog(v24);
  v25 = *(struct _NDIS_REFCOUNT_BLOCK **)(a1 + 5592);
  if ( v25 != (struct _NDIS_REFCOUNT_BLOCK *)-1LL )
