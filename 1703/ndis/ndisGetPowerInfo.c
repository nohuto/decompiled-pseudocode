/*
 * XREFs of ndisGetPowerInfo @ 0x1C005D5A8
 * Callers:
 *     ndisDeviceControlHandler @ 0x1C00A5594 (ndisDeviceControlHandler.c)
 * Callees:
 *     memmove @ 0x1C0028840 (memmove.c)
 *     memset @ 0x1C0028B80 (memset.c)
 *     ?ndisXlateSSResume@@YA?AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z @ 0x1C005D0F4 (-ndisXlateSSResume@@YA-AW4_NDIS_USER_RESUME_REASON@@T_NDIS_SS_RESUME_REASON@@@Z.c)
 *     ndisGetListEntriesCount @ 0x1C00D4BC8 (ndisGetListEntriesCount.c)
 *     ndisXlateMiniportFlags @ 0x1C00DD624 (ndisXlateMiniportFlags.c)
 *     ndisXlatePnPFlags @ 0x1C00DD688 (ndisXlatePnPFlags.c)
 */
