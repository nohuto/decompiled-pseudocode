/*
 * XREFs of ndisRestoreFilterHandlersForMediaDisconnect @ 0x1C00222B0
 * Callers:
...
char __fastcall ndisRestoreFilterHandlersForMediaDisconnect(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qqq(79LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, a2, a3);
  if ( a3 )
  {
    ...
    *(_BYTE *)(a3 + 384) &= ~1u;
    ...
    {
      if ( (unsigned __int8)byte_1C0092614 >= 4u )
        WPP_SF_q(78LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a3);
...
LABEL_8:
    ...
    if ( (unsigned __int8)byte_1C0092614 >= 4u )
      WPP_SF_qD(80LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a3, *(unsigned __int8 *)(a3 + 384));
  ...
  else
  {
    ...
    if ( (unsigned __int8)byte_1C0092614 >= 4u )
      WPP_SF_qD(81LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, *(unsigned __int8 *)(a1 + 930));
    LOBYTE(v7) = Microsoft_Windows_NDISEnableBits;
    if ( (Microsoft_Windows_NDISEnableBits & 0x80u) != 0LL )
      LOBYTE(v7) = Template_jqxq(
                     v8,
...
LABEL_10:
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    LOBYTE(v7) = WPP_SF_qqq(82LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, v4, a3);
  return (char)v7;
}
