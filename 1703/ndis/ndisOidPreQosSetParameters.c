/*
 * XREFs of ndisOidPreQosSetParameters @ 0x1C00D2310
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreQosSetParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x83u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v3, v1);
    v5 = byte_1C0092612;
  }
  if ( *(_DWORD *)(v1 + 4) != 12 )
  {
...
LABEL_21:
  if ( (unsigned __int8)v5 >= 4u )
  {
    ...
    WPP_SF_qdD(0x84u, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, v3, v4, v9);
  }
  return v4;
}
