/*
 * XREFs of ndisOidPreCurrentLookahead @ 0x1C0021CA0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreCurrentLookahead(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(83LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, *a1, v1);
  v4 = *(_DWORD *)(v1 + 4);
  if ( (v4 & 0xFFFFFFFD) != 0 )
  {
    if ( v4 != 1 )
    ...
    *((_DWORD *)a1 + 10) = 0;
    ...
    {
      if ( (unsigned __int8)byte_1C0092612 >= 4u )
        WPP_SF_qqd(84LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, 0LL, v1, *((_DWORD *)a1 + 10));
    }
    else
    {
      v5 = **(_DWORD **)(v1 + 40);
...
LABEL_17:
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(85LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, *a1, v1);
  return v3;
}
