/*
 * XREFs of ?NdisPDPIAcquireReceiveQueues@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_ACQUIRE_QUEUES_PARAMETERS@@PEAPEAU_NDIS_PD_QUEUE@@PEAKPEAU_NDIS_PD_QUEUE_PARAMETERS@@33@Z @ 0x1C00EC230
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0028760 (_guard_dispatch_icall_nop.c)
 *     ?ndisGetNextPDCounterId@@YAKXZ @ 0x1C00748E8 (-ndisGetNextPDCounterId@@YAKXZ.c)
        ...
        unsigned int *a7)
{
  ...
  if ( *((_BYTE *)a1 + 88) )
  {
    ...
    if ( *a4 )
    {
      do
      {
        *(_QWORD *)(*(_QWORD *)((char *)a5 + (unsigned int)v14 * *a7 + 48) + 40LL) = a1;
  ...
  v34.m_Lock = (KPushLockBase *)qword_1C00926D0;
      ...
      if ( (unsigned int)v14 >= 0x38 && (v14 & 0xFFFFFFF8) == v14 )
      {
        ...
        if ( v19 <= 0xFFFFFFFF && (unsigned int)v19 <= *a6 )
        {
          ...
          while ( 1 )
          {
            v20 = 0LL;
            v33.Flink = *v35;
            v21 = (char *)a5 + (unsigned int)(v15 * v14);
            if ( *v21 != (char)0x80
              || v21[1] != 1
              || *((_WORD *)v21 + 1) < 0x38u
              || (*((_DWORD *)v21 + 1) & 0xFFFFFFFE) != 0
              || *((_DWORD *)v21 + 2) != 1 )
            {
              break;
            }
            if ( *((_QWORD *)v21 + 6) )
            {
              PoolWithTag = ExAllocatePoolWithTag(PagedPool, 0x80uLL, 0x6E41444Eu);
              v20 = PoolWithTag;
              if ( PoolWithTag )
              {
                PoolWithTag[4] = 0LL;
...
LABEL_41:
              ...
              LOBYTE(v27) = 1;
              ndisSetupPDCounter(v20, *((_QWORD *)v21 + 6), 1LL, a1, (_DWORD)v27);
              *((_QWORD *)v21 + 6) = v20;
            }
            ...
            ndisSetupPDQTracker(
              ...
              (const struct _NDIS_PD_QUEUE_PARAMETERS *)v21,
              a1,
...
LABEL_48:
    ...
    *(_QWORD *)&v34.m_State = &v34;
    v33.Blink = &v33;
    v33.Flink = &v33;
    ndisCleanupPDRSSObjects(a1, (struct _LIST_ENTRY *)&v34, &v33);
