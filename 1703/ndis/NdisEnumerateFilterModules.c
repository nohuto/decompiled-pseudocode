/*
 * XREFs of NdisEnumerateFilterModules @ 0x1C0058C90
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG BytesWritten)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0x29u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, (__int64)NdisHandle);
  switch ( *(_BYTE *)v5 )
  {
    case 5:
      v7 = (_QWORD *)v5[4];
      ...
      if ( v14 )
      {
        ...
        do
        {
          ...
          *((_DWORD *)v7 + 464) = 0;
          ...
          v16 = 0;
          v17 = *(__int128 **)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 464LL) + 56LL);
          if ( v17 )
          {
            v18 = *v17;
            v16 = *v17;
          ...
          if ( v10 >= v19 )
          {
            ...
            *(_DWORD *)(v15 + 10) = (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 464LL) + 48LL) & 1) + 1;
            *(_DWORD *)(v15 + 6) = 2 - ((*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 464LL) + 48LL) & 2) != 0);
            ...
            *(_QWORD *)(v15 + 54) = v8;
            ...
            v20 = *(unsigned __int16 **)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 464LL) + 56LL);
            if ( v20 )
            {
              v8 -= *v20;
              *(_QWORD *)(v15 + 38) = v8;
              v21 = *(const void ***)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 464LL) + 56LL);
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qD(0x2Au, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, (__int64)v5, v9);
  return v9;
}
