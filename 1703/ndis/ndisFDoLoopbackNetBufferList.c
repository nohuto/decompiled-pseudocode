/*
 * XREFs of ndisFDoLoopbackNetBufferList @ 0x1C0059DF8
 * Callers:
...
void __fastcall ndisFDoLoopbackNetBufferList(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, char a5)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qqq(0x66u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, a2, a3);
...
LABEL_36:
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_qqq(0x67u, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, a2, v5);
}
