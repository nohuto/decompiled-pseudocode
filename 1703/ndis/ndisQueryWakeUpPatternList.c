/*
 * XREFs of ndisQueryWakeUpPatternList @ 0x1C004CB98
 * Callers:
 *     ndisOidPrePMWOLPatternList @ 0x1C00D5A00 (ndisOidPrePMWOLPatternList.c)
 *     ndisOidPreWakeUpPatternList @ 0x1C00D5F30 (ndisOidPreWakeUpPatternList.c)
 * Callees:
...
__int64 __fastcall ndisQueryWakeUpPatternList(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqq(0x2Eu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, a2, a1, a3);
  if ( !v5 )
    v5 = *(_QWORD *)(v6 + 16);
  ...
  *(_DWORD *)(v5 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qqqL(0x2Fu, &WPP_67a444f786a83633dadd9d4483e3f504_Traceguids, v5, v6, a3, v12);
  return v12;
}
