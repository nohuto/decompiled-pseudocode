/*
 * XREFs of ndisReadMiniportMediaSpecificPortAuthStates @ 0x1C00AB964
 * Callers:
...
__int64 __fastcall ndisReadMiniportMediaSpecificPortAuthStates(__int64 a1)
{
  ...
  *(_DWORD *)&Destination.Length = 0;
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0x33u, &WPP_a222eda86a353c9b09f74c8666d4f83e_Traceguids, a1);
...
LABEL_9:
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_qD(0x34u, &WPP_a222eda86a353c9b09f74c8666d4f83e_Traceguids, a1, MiniportSpecificPortAuthStates);
