/*
 * XREFs of ndisIndicateInitialStateToFilter @ 0x1C0016FF0
 * Callers:
...
void __fastcall ndisIndicateInitialStateToFilter(__int64 a1)
{
  ...
  KSPIN_LOCK *v25; // rcx
  void (__fastcall *v26)(_QWORD *, struct _NET_BUFFER_LIST *, int, unsigned int, int); // rax
  KIRQL v27; // dl
  ...
  *(_DWORD *)(a1 + 160) = 0;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)(v4 + 152) = KeGetCurrentThread();
    for ( *(_DWORD *)(v4 + 160) = 2102890; (*(_DWORD *)(v4 + 56) & 0x2000) != 0; *(_DWORD *)(v4 + 160) = 2102890 )
    {
      v15 = NewIrql[0];
      *(_QWORD *)(v4 + 152) = 0LL;
      *(_DWORD *)(v4 + 160) = 0;
    ...
    *(_DWORD *)(v4 + 160) = 0;
      ...
      if ( !v19 || !(unsigned int)ndisFAllocateFilterOffload(a1) )
      {
        ...
        *(_DWORD *)(v4 + 160) = 0;
        ...
        if ( *(_QWORD *)(v23 + 288) )
        {
          ...
          {
            WPP_SF_qD(131LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, HIDWORD(v31[2]));
            v23 = v29;
          }
          (*(void (__fastcall **)(_QWORD, _QWORD *))(v23 + 288))(*(_QWORD *)(a1 + 24), v31);
          if ( (unsigned __int8)byte_1C009261F >= 4u )
            WPP_SF_qD(132LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, v24);
          v1 = v30;
        }
        else
        {
    ...
    v26 = (void (__fastcall *)(_QWORD *, struct _NET_BUFFER_LIST *, int, unsigned int, int))&ndisFakeFilterReceiveHandler;
    if ( *(_DWORD *)(v4 + 352) == 1 )
  ...
  if ( *(_QWORD *)(v11 + 288) )
  {
    ...
    if ( (unsigned __int8)byte_1C009261F >= 4u )
      WPP_SF_qD(132LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1, v12);
  }
  else
  {
    ndisFIndicateStatusInternal(a1, v31);
  ...
  *(_DWORD *)(a1 + 160) = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(74LL, &WPP_12c6ddfa26473c7e20361ffad7c5cbde_Traceguids, a1);
}
