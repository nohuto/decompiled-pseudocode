/*
 * XREFs of NdisFreeCloneOidRequest @ 0x1C000FB50
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisFreeCloneOidRequest(NDIS_HANDLE SourceHandle, PNDIS_OID_REQUEST Request)
{
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(180LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, SourceHandle, Request);
  if ( v2 )
  {
  ...
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
    WPP_SF_qq(181LL, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, SourceHandle, 0LL);
}
