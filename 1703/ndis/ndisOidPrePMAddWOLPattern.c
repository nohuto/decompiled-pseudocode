/*
 * XREFs of ndisOidPrePMAddWOLPattern @ 0x1C00BAB50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisIsValidWoLPattern @ 0x1C00BACAC (ndisIsValidWoLPattern.c)
...
char __fastcall ndisOidPrePMAddWOLPattern(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 40) = 0;
  ...
  if ( *(_DWORD *)(a1 + 40) )
    return v2;
  if ( !(unsigned __int8)ndisIsValidWoLPattern(v7, *(unsigned int *)(v5 + 48)) )
  {
