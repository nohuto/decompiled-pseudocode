/*
 * XREFs of NdisMMapIoSpace @ 0x1C00BD170
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT Length)
{
  ...
  if ( (*((_DWORD *)MiniportAdapterHandle + 926) & 0x10) != 0 )
  {
    *VirtualAddress = 0LL;
    return -1073741670;
  }
  else
  {
    ...
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_qD(0x19u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, (__int64)MiniportAdapterHandle, v9);
    return v9;
  }
}
