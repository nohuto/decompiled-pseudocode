/*
 * XREFs of NdisMFreeSharedMemory @ 0x1C0025D10
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_PHYSICAL_ADDRESS PhysicalAddress)
{
  if ( (unsigned __int8)byte_1C009261C >= 4u )
    WPP_SF_qLq(34LL, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, MiniportAdapterHandle, Length, VirtualAddress);
  if ( KeGetCurrentIrql() )
  {
  ...
  if ( (unsigned __int8)byte_1C009261C >= 4u )
    WPP_SF_qLq(35LL, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, MiniportAdapterHandle, Length, VirtualAddress);
}
