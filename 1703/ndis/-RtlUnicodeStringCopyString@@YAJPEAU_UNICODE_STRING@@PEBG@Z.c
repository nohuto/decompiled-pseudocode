/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C0069814
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C00698AC (RtlWideCharArrayCopyStringWorker.c)
 */
