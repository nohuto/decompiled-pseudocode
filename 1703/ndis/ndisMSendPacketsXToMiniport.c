/*
 * XREFs of ndisMSendPacketsXToMiniport @ 0x1C00272F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMSendPacketsXToMiniport(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    LOBYTE(v3) = WPP_SF_qqd(14LL, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, a3);
  v7 = 0;
  v8 = a2;
  v9 = a2;
  if ( (_DWORD)v4 )
    ...
    do
    {
      ...
      *(unsigned __int64 *)((char *)(*v9)->Reserved + (*v9)->Private.NdisPacketOobOffset) = 0LL;
      ...
      else
      {
        ...
        if ( v12 )
        {
          LODWORD(v3) = (*(__int64 (__fastcall **)(_QWORD, struct _NDIS_PACKET *, _QWORD))(a1 + 4096))(
                          *(_QWORD *)(a1 + 24),
                          v14,
                          v14->Private.Flags);
          if ( (_DWORD)v3 != 259 )
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    LOBYTE(v3) = WPP_SF_qqd(15LL, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1, a2, v7);
  return (char)v3;
}
