/*
 * XREFs of ndisFindMiniportOnGlobalList @ 0x1C0104398
 * Callers:
...
wchar_t *__fastcall ndisFindMiniportOnGlobalList(PCUNICODE_STRING SourceString)
{
  ...
  if ( (unsigned __int8)byte_1C0092614 >= 4u )
    WPP_SF_q(0x5Fu, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, (__int64)SourceString);
  ...
  if ( result )
  {
    ...
    if ( (unsigned __int8)byte_1C0092614 >= 4u )
      WPP_SF_q(0x60u, &WPP_412f75d4855739ae1f29fadf11bfdb6b_Traceguids, (__int64)v5);
    return (wchar_t *)v5;
  }
  return result;
}
