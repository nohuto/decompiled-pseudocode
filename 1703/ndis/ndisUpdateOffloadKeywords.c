/*
 * XREFs of ndisUpdateOffloadKeywords @ 0x1C00D3A00
 * Callers:
 ...
 *     ndisConvertOffloadValueToString @ 0x1C00D1740 (ndisConvertOffloadValueToString.c)
...
__int64 __fastcall ndisUpdateOffloadKeywords(__int64 a1, __int64 a2, int a3)
{
  ...
  _NDIS_CONFIGURATION_PARAMETER::<unnamed_type_ParameterData> v55; // [rsp+68h] [rbp-29h]
  ...
  v9 = 0;
  v58 = 0;
  v55.StringData.Buffer = (wchar_t *)L"0";
  if ( (unsigned __int8)byte_1C0092612 >= 4u )
  {
    WPP_SF_q(0xDCu, &WPP_9ab300306c87378029e09c5cce5d7151_Traceguids, a1);
    LOBYTE(a2) = v52;
    LOBYTE(a3) = v53;
    v5 = 0;
    v9 = 0;
  ...
  v12 = *(_BYTE *)(v6 + 4);
  v13 = *(_BYTE *)(*(_QWORD *)(a1 + 4120) + 680LL) & 1;
  if ( v12 > 4u )
    goto LABEL_189;
  v14 = *(_BYTE *)(v6 + 5);
  if ( v14 > 4u )
...
LABEL_172:
  if ( v61 )
  {
    ...
    *(_DWORD *)(a1 + 3696) = *(_DWORD *)(a1 + 3696) & 0xFF7FFFFF | ((v61 == 1) << 23);
  }
  if ( v60 )
  {
    v51.ParameterType = NdisParameterString;
    ...
    *(_DWORD *)(a1 + 3696) = *(_DWORD *)(a1 + 3696) & 0xFEFFFFFF | ((v60 == 1) << 24);
  }
  if ( v8 )
  {
    v51.ParameterType = NdisParameterString;
