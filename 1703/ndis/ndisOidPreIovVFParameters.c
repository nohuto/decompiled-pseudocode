/*
 * XREFs of ndisOidPreIovVFParameters @ 0x1C00E7BA0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovVFParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x27u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v1);
    v4 = byte_1C0092621;
  }
  v5 = 12LL;
  if ( *(_DWORD *)(v1 + 4) != 12 )
  ...
  *(_DWORD *)(a1 + 40) = 0;
  ...
  if ( !*(_QWORD *)a1 )
    goto LABEL_20;
  v8 = *(_QWORD *)(v7 + 4640);
  if ( v8 && *(_QWORD *)(v7 + 3584) && (*(_BYTE *)(v8 + 8) & 3) == 3 )
  {
    v9 = *(_QWORD *)(v1 + 40);
    *(_DWORD *)(v1 + 64) = 1632;
...
LABEL_20:
  if ( (unsigned __int8)v4 >= 4u )
    WPP_SF_qdD(0x28u, &WPP_e97265b1e1743feddb6afdd4d4a609a3_Traceguids, v3, v6, *(_DWORD *)(a1 + 40));
  return v6;
}
