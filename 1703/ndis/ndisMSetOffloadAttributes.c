/*
 * XREFs of ndisMSetOffloadAttributes @ 0x1C00AAC50
 * Callers:
 ...
 *     ndisValidateOffloadCapability @ 0x1C00AAFCC (ndisValidateOffloadCapability.c)
 *     ndisValidateConnectionOffload @ 0x1C00E3A7C (ndisValidateConnectionOffload.c)
 */
