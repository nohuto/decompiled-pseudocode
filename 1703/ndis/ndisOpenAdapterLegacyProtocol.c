/*
 * XREFs of ndisOpenAdapterLegacyProtocol @ 0x1C005C920
 * Callers:
 ...
 *     NdisOpenAdapter @ 0x1C01033A0 (NdisOpenAdapter.c)
 * Callees:
...
LABEL_18:
            ...
            *a4 = v26;
            ...
            else
            {
              ...
              *(_DWORD *)(BindingAdapter + 1856) = 984279;
              ...
              {
                if ( (unsigned __int8)byte_1C009260D >= 4u )
                  WPP_SF_qqq(0x17u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, OpenBlock, v17, BindingAdapter);
                if ( v59 )
                {
                ...
                if ( (*v48 & 0x20000) != 0 && OpenBlock->ProtocolHandle->CoAfRegisterNotifyHandler )
                {
                  ...
                  {
                    WPP_SF_q(0x18u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, (__int64)OpenBlock);
                  }
                }
              }
              if ( (*v48 & 0x40000) == 0 )
              ...
              if ( !*a1 )
              {
                ...
                if ( !*a1 )
                {
                  ...
                  if ( PoolWithTag )
                  {
                    ...
                    ndisQueueWorkItem((PLIST_ENTRY)(v39 + 1));
                    *a1 = 259;
                  }
                }
              }
  ...
  if ( DynamicBinding )
  {
      ...
      && (unsigned __int8)byte_1C0092623 >= 4u )
    {
      ...
      WPP_SF_Zq(0x16u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, (const wchar_t *)v56[1], v56[0]);
    }
  }
  else
  {
...
LABEL_81:
  ...
  {
    LODWORD(v44) = *a1;
    WPP_SF_qqqL(0x19u, &WPP_766e1c326e8d3beaf7bd49aa3741dac3_Traceguids, v17, BindingAdapter, OpenBlock, v44);
  }
}
