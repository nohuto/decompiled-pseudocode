/*
 * XREFs of ?ndisVBusNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z @ 0x1C00A8930
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _NPI_REGISTRATION_INSTANCE *a3)
{
  ...
  if ( v8 || a3->Number || a3->NpiSpecificCharacteristics )
    return 3221226169LL;
  v9 = NmrClientAttachProvider(NmrBindingHandle, 0LL, 0LL, &::NmrBindingHandle + 1, (const void **)&ProviderDispatch);
  if ( v9 >= 0 )
  {
    ::NmrBindingHandle = NmrBindingHandle;
    ExReInitializeRundownProtection(&RunRef);
    byte_1C0092118 = 1;
    ndisBindEnumerateProtocolDrivers(lambda_727c6594aeeec297d735c04587a6780c_::_lambda_invoker_cdecl_, 0LL);
  }
