/*
 * XREFs of ndisMDeferredSendPacketsSG @ 0x1C0055E40
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSendPacketsSG(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_q(0x26u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1);
  v3 = *(_DWORD *)(a1 + 120);
  v4 = 0LL;
...
LABEL_55:
  if ( (unsigned __int8)byte_1C009260A >= 4u )
    WPP_SF_q(0x27u, &WPP_baff752c64773449955de141535fd9df_Traceguids, a1);
  return 0;
}
