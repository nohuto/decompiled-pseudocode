/*
 * XREFs of InitPerfFeedbackInternal @ 0x1C002BE98
 * Callers:
 *     RegisterHvPerfFeedbackCounters @ 0x1C00281C0 (RegisterHvPerfFeedbackCounters.c)
 *     RegisterKernelPerfFeedback @ 0x1C002D610 (RegisterKernelPerfFeedback.c)
 * Callees:
...
__int64 __fastcall InitPerfFeedbackInternal(__int64 a1, __int64 (__fastcall *a2)(char *, _QWORD))
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C0015D98,
    0LL);
  PerfDomain = GetPerfDomain((_QWORD *)a1, (__int64)v21, &v23);
