/*
 * XREFs of ProcLibTraceBiosCStatesRundown @ 0x1C0023190
 * Callers:
...
char __fastcall ProcLibTraceBiosCStatesRundown(_QWORD *a1)
{
  ...
  __int64 v12; // xmm0_8
  char *v13; // r8
  unsigned int v15; // [rsp+38h] [rbp-49h] BYREF
  struct _PROCESSOR_NUMBER v16; // [rsp+3Ch] [rbp-45h] BYREF
