/*
 * XREFs of AcpiEval_CPC @ 0x1C001D37C
 * Callers:
...
__int64 __fastcall AcpiEval_CPC(__int64 a1, _QWORD *a2)
{
  ...
  P = 0LL;
  _InterlockedOr((volatile signed __int32 *)(a1 + 1076), 0x40000u);
...
LABEL_2:
  ...
  v5 = P;
  v4 = AcpiParseCore(v19, 2LL, (unsigned __int64)P + 12, *((_DWORD *)P + 1) - 12, (__int64)v3, 236, "_CPC", 1);
  if ( v4 < 0 )
  {
    v8 = 48;
LABEL_15:
  ...
  if ( v9 )
  {
    ...
    v4 = AcpiParseCore(v19, v11, (unsigned __int64)(v5 + 3), v5[1] - 12, (__int64)v3, 236, "_CPC", v12);
    if ( v4 < 0 )
    {
      v8 = 50;
      goto LABEL_15;
    ...
    do
    {
      AcpiTranslateAccessSize((char *)v3 + *v13, v14);
      v13 += 6;
    }
    while ( v15 != 1 );
    *v18 = v3;
