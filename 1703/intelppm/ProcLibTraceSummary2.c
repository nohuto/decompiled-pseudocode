/*
 * XREFs of ProcLibTraceSummary2 @ 0x1C001F54C
 * Callers:
...
LABEL_10:
          ...
          else
          {
            if ( (v5 & 0x8000000) == 0 )
            {
              ...
              {
                v28 = 2;
                v11 = *(_DWORD *)(qword_1C0016260 + 28);
                v25 = v11;
                v26 = 100 * *(_DWORD *)(qword_1C0016260 + 36) / v11;
                v27 = 100 * *(_DWORD *)(qword_1C0016260 + 32) / v11;
              }
              else
              {
                if ( (v5 & 0x73300000) == 0 )
