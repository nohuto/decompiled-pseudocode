/*
 * XREFs of RetrieveEfficiencyClassInformation @ 0x1C002FADC
 * Callers:
 ...
 *     GetProcessorEfficiencyClass @ 0x1C002F650 (GetProcessorEfficiencyClass.c)
 */
...
__int64 RetrieveEfficiencyClassInformation()
{
  ...
  qword_1C0016318 = 0LL;
  InitializeEnumerationContext((__int64)&qword_1C0015DA8, 32, (__int64)v7);
...
LABEL_5:
  ...
  dword_1C0016314 = 1;
  qword_1C0016318 = 0LL;
  LODWORD(qword_1C0016318) = dword_1C0015D94;
  return v5;
}
