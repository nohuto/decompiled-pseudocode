/*
 * XREFs of ProcLibTraceBiosTStatesRundown @ 0x1C0023674
 * Callers:
...
char __fastcall ProcLibTraceBiosTStatesRundown(__int64 a1)
{
  ...
  __int64 v12; // rdx
  __int64 v13; // rax
  unsigned int v15; // [rsp+38h] [rbp-89h] BYREF
  struct _PROCESSOR_NUMBER v16; // [rsp+3Ch] [rbp-85h] BYREF
  ...
  unsigned int *v33; // [rsp+C8h] [rbp+7h]
  __int64 v34; // [rsp+D0h] [rbp+Fh]
  PVOID v35; // [rsp+D8h] [rbp+17h]
  int v36; // [rsp+E0h] [rbp+1Fh]
  int i; // [rsp+E4h] [rbp+23h]
...
LABEL_13:
      ...
      *(_QWORD *)&UserData.Size = 2LL;
      ...
      v32 = 12LL;
      v34 = 4LL;
      EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, &PPM_ETW_BIOS_T_STATES_RUNDOWN, 0LL, v5, &UserData);
      if ( v2 )
