/*
 * XREFs of ValidateAcpiCStates @ 0x1C001C098
 * Callers:
...
LABEL_24:
          ...
          case 1:
            return (unsigned int)-1073741823;
          case 2:
            if ( !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001653C) )
            {
              v9 = 26;
              goto LABEL_24;
            }
            break;
          default:
            if ( !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0016554)
              || !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0016524)
              || !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001653C) )
            {
              v9 = 27;
              goto LABEL_24;
            }
