/*
 * XREFs of ValidateAcpiCPC @ 0x1C0025E54
 * Callers:
 ...
 *     ValidateAcpiCPCRegister @ 0x1C0025F9C (ValidateAcpiCPCRegister.c)
 */
...
LABEL_8:
  ...
  for ( i = 0LL; ; i += 24LL )
  {
    ...
    if ( ++v10 >= v9 )
    {
      if ( !(unsigned __int8)CpcRegisterIsSupported((__int64)(a1 + 17)) && *v12 != 126 && *((_QWORD *)a1 + 9) != 1LL )
      {
        WPP_RECORDER_SF_D(
          (__int64)WPP_GLOBAL_Control->DeviceExtension,
          2u,
