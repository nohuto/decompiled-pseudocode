/*
 * XREFs of PepParkMask @ 0x1C000DC30
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  if ( !PepSkipParkNotification && dword_1C00162C0 >= (unsigned int)dword_1C0015D94 )
  {
    memset(&PepParkLists, 0, (unsigned int)(16 * dword_1C0015D94));
    v4 = 0;
    KeInitializeEnumerationContext(v11, &unk_1C0016088);
    if ( !(unsigned int)KeEnumerateNextProcessor(&v12, v11) )
    {
      ...
      if ( v4 )
      {
        ...
        v8 = v4;
        v10 = &PepParkLists;
        v7 = ((__int64 (__fastcall *)(_QWORD, unsigned int *))qword_1C0016028)(*(_QWORD *)(v6 + 1088), &v8);
        if ( v7 < 0 )
        {
          WPP_RECORDER_SF_D(
