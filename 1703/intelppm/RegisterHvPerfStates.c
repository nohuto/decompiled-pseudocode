/*
 * XREFs of RegisterHvPerfStates @ 0x1C00281E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeAcpiPStates @ 0x1C002DAA0 (DecodeAcpiPStates.c)
 *     DecodeAcpiTStates @ 0x1C002DC44 (DecodeAcpiTStates.c)
 */
...
LABEL_18:
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      qword_1C0015D98,
      0LL);
    PerfDomain = GetPerfDomain((_QWORD *)a1, (__int64)v36, &v37);
    v39 = PerfDomain;
    if ( (_DWORD)v37 == 253 )
    {
      v12 = 1;
    ...
    if ( v3 )
      v3[770] = dword_1C00161B0;
    if ( v5 )
      v5[802] = dword_1C00161B0;
    ++dword_1C00161B0;
    v8 = 0;
