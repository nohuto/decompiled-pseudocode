/*
 * XREFs of ProcLibTraceGetProcessorIdleStatesV2 @ 0x1C0024180
 * Callers:
...
void __fastcall ProcLibTraceGetProcessorIdleStatesV2(__int64 a1, char a2)
{
  ...
  struct _PROCESSOR_NUMBER v11[4]; // [rsp+30h] [rbp-29h] BYREF
    ...
    if ( v4 )
    {
      if ( (int)ProcLibGetProcessorNumber(a1, v11) >= 0 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          v16 = v4;
          v17 = 4;
          EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v3, 0LL, 4u, &UserData);
