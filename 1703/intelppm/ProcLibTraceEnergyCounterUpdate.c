/*
 * XREFs of ProcLibTraceEnergyCounterUpdate @ 0x1C00073C8
 * Callers:
...
char __fastcall ProcLibTraceEnergyCounterUpdate(__int64 a1, int a2, __int64 a3)
{
  ...
  unsigned __int8 Number; // [rsp+38h] [rbp-19h] BYREF
  unsigned __int16 Group; // [rsp+3Ch] [rbp-15h] BYREF
  struct _PROCESSOR_NUMBER v8; // [rsp+40h] [rbp-11h] BYREF
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+48h] [rbp-9h] BYREF
  unsigned __int8 *p_Number; // [rsp+58h] [rbp+7h]
