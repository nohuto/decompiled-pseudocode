/*
 * XREFs of InitLegacyPccInternal @ 0x1C000BEEC
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x1C000C320 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x1C0028020 (RegisterHvLegacyPccCounters.c)
 * Callees:
  ...
  if ( qword_1C00162B8 )
  {
          ...
          (v3 = v12) != 0LL) )
    {
      ...
      *((_DWORD *)v3 + 7) = v16;
      ...
      if ( dword_1C001625C )
      {
        v17 = 0x989680 % ((unsigned int)dword_1C001625C >> 1);
        *((_DWORD *)v3 + 9) = 0x989680 / ((unsigned int)dword_1C001625C >> 1);
      }
      *((_DWORD *)v13 + 3) = 0;
      *((_WORD *)v13 + 8) = 0;
        ...
        if ( !(unsigned int)EnumerateNextDevice((__int64)v29, &v31) )
        {
          ...
          do
          {
            *(_QWORD *)(v31 + 232) = v25 - 1;
            v27 = (__int64 *)qword_1C0015DF0;
            if ( *(__int64 **)qword_1C0015DF0 != v26 )
              __fastfail(3u);
            *v25 = v26;
            v25[1] = v27;
            *v27 = (__int64)v25;
            qword_1C0015DF0 = (__int64)v25;
          }
          while ( !(unsigned int)EnumerateNextDevice((__int64)v29, &v31) );
        }
