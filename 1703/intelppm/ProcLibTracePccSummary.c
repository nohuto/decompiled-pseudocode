/*
 * XREFs of ProcLibTracePccSummary @ 0x1C0024400
 * Callers:
...
BOOLEAN ProcLibTracePccSummary()
{
  ...
  if ( result )
  {
    if ( qword_1C0016260 )
    {
      v2 = (unsigned int)(100 * *(_DWORD *)(qword_1C0016260 + 36)) / *(_DWORD *)(qword_1C0016260 + 28);
      v1 = (unsigned int)(100 * *(_DWORD *)(qword_1C0016260 + 32)) / *(_DWORD *)(qword_1C0016260 + 28);
      *(_QWORD *)&UserData.Size = 1LL;
      v3 = v1;
      UserData.Ptr = qword_1C0016260 + 6;
      v5 = qword_1C0016260 + 7;
      v7 = &v2;
      v9 = &v3;
      v6 = 1LL;
      v8 = 1LL;
