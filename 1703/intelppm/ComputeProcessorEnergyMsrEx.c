/*
 * XREFs of ComputeProcessorEnergyMsrEx @ 0x1C0006240
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ComputeProcessorEnergyMsr @ 0x1C00061A0 (ComputeProcessorEnergyMsr.c)
        ...
        unsigned __int64 *a5)
{
  ...
  unsigned int SystemArgument1; // r8d
  ...
  double v35; // xmm1_8
  int *v36; // rcx
  __int64 SystemArgument1_low; // r10
  double *v38; // r9
  __int64 v39; // r13
  int v40; // eax
  __int64 v41; // rcx
...
LABEL_11:
    ...
    v81 = 0LL;
    v82 = 0LL;
    v75[0] = (__int64)&qword_1C0015DA8;
    v75[1] = (__int64)&qword_1C0015DA8;
    v75[2] = 0LL;
    ...
    v26 = 1000000 * a3 / (qword_1C00164D8 * (unsigned __int64)(unsigned int)dword_1C00164D0);
    if ( !v26 )
      goto LABEL_79;
    v27 = (double)(int)a2;
    if ( a2 < 0 )
    ...
    LODWORD(v33) = WPP_MAIN_CB.Dpc.SystemArgument1;
    v84[2] = v29;
    v84[1] = v30 / v32 * v29;
    v84[3] = 1.0 - v29;
    ...
    {
      v41 = (*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.Type >> 1) & 0x1FLL;
      v42 = (double)(int)v26;
      if ( v26 < 0 )
...
LABEL_52:
    ...
    if ( HIDWORD(WPP_MAIN_CB.Dpc.DpcData) )
    {
      v49 = (double)((int)v26 * (int)qword_1C00164E0);
      if ( v26 * qword_1C00164E0 < 0 )
