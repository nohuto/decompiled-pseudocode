/*
 * XREFs of AcpiParseLpiObject @ 0x1C00298DC
 * Callers:
...
__int64 __fastcall AcpiParseLpiObject(__int64 a1, const wchar_t *a2, char a3, _QWORD *a4)
{
  ...
  __int64 (__fastcall *v113)(__int64, __int64, unsigned int); // [rsp+220h] [rbp+120h]
  char v114; // [rsp+228h] [rbp+128h]
  int v115; // [rsp+22Ah] [rbp+12Ah]
  const char *v116; // [rsp+230h] [rbp+130h]
  __int64 (__fastcall *v117)(__int64, __int64, unsigned int); // [rsp+238h] [rbp+138h]
  char v118; // [rsp+240h] [rbp+140h]
  int v119; // [rsp+242h] [rbp+142h]
  const char *v120; // [rsp+248h] [rbp+148h]
  NTSTATUS (__fastcall *v121)(__int64, struct _UNICODE_STRING *, unsigned int); // [rsp+250h] [rbp+150h]
