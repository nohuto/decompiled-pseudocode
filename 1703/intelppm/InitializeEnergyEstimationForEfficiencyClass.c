/*
 * XREFs of InitializeEnergyEstimationForEfficiencyClass @ 0x1C002F82C
 * Callers:
...
__int64 __fastcall InitializeEnergyEstimationForEfficiencyClass(int a1)
{
  ...
  v2 = &dword_1C0016320[54 * a1];
  InitializeEnumerationContext((__int64)&qword_1C0015DA8, 32, (__int64)v11);
