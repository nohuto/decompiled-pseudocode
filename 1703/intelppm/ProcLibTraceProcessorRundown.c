/*
 * XREFs of ProcLibTraceProcessorRundown @ 0x1C0024F3C
 * Callers:
...
char __fastcall ProcLibTraceProcessorRundown(__int64 a1)
{
  ...
  int v8; // eax
  int v9; // eax
  ULONG Type; // [rsp+40h] [rbp-39h] BYREF
  int Data; // [rsp+44h] [rbp-35h] BYREF
  int v13; // [rsp+48h] [rbp-31h] BYREF
  int v14; // [rsp+4Ch] [rbp-2Dh] BYREF
  int v15; // [rsp+50h] [rbp-29h] BYREF
  ULONG RequiredSize; // [rsp+54h] [rbp-25h] BYREF
  struct _PROCESSOR_NUMBER v17; // [rsp+58h] [rbp-21h] BYREF
  ...
  struct _PROCESSOR_NUMBER *v25; // [rsp+90h] [rbp+17h]
  int v26; // [rsp+98h] [rbp+1Fh]
  int v27; // [rsp+9Ch] [rbp+23h]
  unsigned __int8 *p_Number; // [rsp+A0h] [rbp+27h]
