/*
 * XREFs of ProcLibTraceCap @ 0x1C00238F8
 * Callers:
...
char __fastcall ProcLibTraceCap(__int64 a1, int a2, int a3, int a4, char a5, PCEVENT_DESCRIPTOR EventDescriptor)
{
  ...
  struct _PROCESSOR_NUMBER v10[4]; // [rsp+38h] [rbp-59h] BYREF
  ...
  char *v24; // [rsp+98h] [rbp+7h]
  int v25; // [rsp+A0h] [rbp+Fh]
  int v26; // [rsp+A4h] [rbp+13h]
  int v27; // [rsp+F0h] [rbp+5Fh] BYREF
  int v28; // [rsp+F8h] [rbp+67h] BYREF
  int v29; // [rsp+100h] [rbp+6Fh] BYREF

  v29 = a4;
  v28 = a3;
  v27 = a2;
  v6 = EventDescriptor;
  LOBYTE(ProcessorNumber) = EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, EventDescriptor);
  if ( (_BYTE)ProcessorNumber )
  {
    ...
    if ( ProcessorNumber >= 0 )
    {
      ...
      UserData.Size = 2;
      v13 = 1;
      LOBYTE(ProcessorNumber) = EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v6, 0LL, 6u, &UserData);
    }
  }
