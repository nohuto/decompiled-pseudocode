...
NTSTATUS __stdcall DriverEntry_0(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  qword_1C00131B0 = (__int64)DriverObject;
  DestinationString.Buffer = (wchar_t *)&unk_1C00131C0;
  *(_DWORD *)&DestinationString.Length = 34078720;
  RtlCopyUnicodeString(&DestinationString, RegistryPath);
  result = WdfVersionBind_0(DriverObject, &DestinationString, &unk_1C0013000, &WdfDriverGlobals);
  if ( result >= 0 )
  {
    WdfDriverMiniportUnloadOverride = *(_QWORD *)(WdfFunctions_01015 + 1608);
    inited = FxStubBindClasses((struct _WDF_BIND_INFO *)&unk_1C0013000);
    if ( inited < 0
    ...
    else
    {
      ...
      {
        DriverUnload = (void (__fastcall *)(_DRIVER_OBJECT *))qword_1C0013198;
        if ( DriverObject->DriverUnload )
          DriverUnload = DriverObject->DriverUnload;
        qword_1C0013198 = (__int64)DriverUnload;
