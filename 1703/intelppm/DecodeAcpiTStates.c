/*
 * XREFs of DecodeAcpiTStates @ 0x1C002DC44
 * Callers:
 *     RegisterHvPerfStates @ 0x1C00281E0 (RegisterHvPerfStates.c)
 * Callees:
 *     DecodeControlStatusRegisterIo @ 0x1C002DD6C (DecodeControlStatusRegisterIo.c)
 */
        ...
        _DWORD *a7)
{
  ...
  *a7 = 0;
  v12 = *(_BYTE *)(a1 + 448);
  if ( v12 == 127 && (*(_DWORD *)(a1 + 264) & 0x2000000) != 0 && dword_1C0015F80 )
  {
    *a2 = *a2 & 0xFFFFFFFFFFFFFLL | 0x10000000000000LL;
    *(_DWORD *)a2 = dword_1C0015F80;
    *a4 = qword_1C0015F88;
  }
