/*
 * XREFs of ACPIDevicePowerProcessPhase3 @ 0x1C00078D8
 * Callers:
        ...
        if ( _InterlockedCompareExchange((volatile signed __int32 *)v7 + 16, 4, 3) == 3 )
        {
          ...
          if ( (v13 & 0x440) == 0 && ((v13 & 0x2220) != 0 || v9) )
          {
            ...
            *((_DWORD *)v7 + 17) = 0;
            ...
            {
              v18 = AMLIAsyncEvalObject(v14, 0LL, 0LL, 0LL, v16, v7);
              v19 = v7[2];
              if ( (v19 & 0x2000) != 0 )
            ...
            if ( _InterlockedCompareExchange((volatile signed __int32 *)v20 + 16, 1, 4) == 4 )
            {
              ...
              *((_DWORD *)v20 + 17) = 0;
              ...
              if ( (unsigned __int8)ACPIIsPowerNodeMissingDependencies(v20) )
                ...
                v23 = AMLIAsyncEvalObject(v20[10], 0LL, 0LL, 0LL, ACPIDeviceCompletePhase3Off, v20);
              LOBYTE(v22) = 4;
              WPP_RECORDER_SF_qD(
                WPP_GLOBAL_Control->DeviceExtension,
                v22,
