/*
 * XREFs of ACPIMatchKernelPorts @ 0x1C002AD1C
 * Callers:
  ...
  if ( KdComPortInUse || KdHvComPortInUse || v7 )
  {
    ...
    if ( *(_DWORD *)(a2 + 24) )
    {
      do
      {
          ...
          default:
            switch ( (unsigned __int8)v6 )
            {
              ...
              case 0x88u:
                ...
                v15 = *(unsigned __int16 *)(v2 + 8) + (unsigned __int64)*(unsigned __int16 *)(v2 + 12);
                break;
              case 0x8Au:
                if ( *(_BYTE *)(v2 + 3) )
                {
        ...
        if ( v11 && (void *)v15 == QuadPart || v12 && v15 == v9 || v7 && v15 == v7 )
        {
          _InterlockedOr64((volatile signed __int64 *)(a1 + 8), 0x680003uLL);
          if ( KdComPortInUse && (void *)v15 == QuadPart || KdHvComPortInUse && v15 == v9 )
          {
          ...
          LOBYTE(v10) = WPP_RECORDER_SF_qqss(
                          ...
                          6u,
                          v21,
                          (__int64)&WPP_5b4423268ba73509d671d93121fe7801_Traceguids,
                          v15,
                          v3,
                          v18,
                          v19);
