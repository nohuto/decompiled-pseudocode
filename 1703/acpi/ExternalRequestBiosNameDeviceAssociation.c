/*
 * XREFs of ExternalRequestBiosNameDeviceAssociation @ 0x1C009EC10
 * Callers:
 ...
 *     AMLISetNSObjectNotifyFlag @ 0x1C005AEF0 (AMLISetNSObjectNotifyFlag.c)
...
__int64 __fastcall ExternalRequestBiosNameDeviceAssociation(char *a1, __int64 a2, char a3)
{
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  v5 = 0LL;
  v17 = 0LL;
  v7 = AMLIGetNameSpaceObject(a1, 0LL, &v16);
  if ( v7 >= 0 )
  {
