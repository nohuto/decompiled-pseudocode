/*
 * XREFs of PciConfigSpaceHandlerWorker @ 0x1C0011420
 * Callers:
...
__int64 __fastcall PciConfigSpaceHandlerWorker(__int64 a1, __int64 a2, __int64 a3, unsigned int *a4)
{
  ...
  if ( !*((_QWORD *)a4 + 7) )
  {
    ...
    v30 = *((_QWORD *)a4 + 1);
    a4[19] = v29 | 0x1000;
    OpRegionScope = GetOpRegionScope(v30, a2, a4, a4 + 14);
    ...
    if ( *v5 )
    {
      if ( *v5 == 1 )
      {
        ...
        do
        {
          ...
          v37 = a3;
          v26 = 4 * a3;
          v24 = (char *)&PciConfigDisallowedRanges + 4 * a3 + 2;
          v39 = v24;
        }
        while ( *(_WORD *)v24 );
        if ( !(_DWORD)a4 )
...
LABEL_16:
  ...
  if ( v14 < 0 )
  {
    ...
    if ( v34 )
    {
      dword_1C0077574 = *(_DWORD *)(*(_QWORD *)v34 + 40LL);
      byte_1C0077578 = 0;
      v43 = dword_1C0077574;
    }
    v35 = *((_QWORD *)v5 + 7);
    if ( v35 )
    {
      dword_1C0077574 = *(_DWORD *)(*(_QWORD *)v35 + 40LL);
      byte_1C0077578 = 0;
      v41 = dword_1C0077574;
    }
    WPP_RECORDER_SF_ss(WPP_GLOBAL_Control->DeviceExtension, a2, a3, (_DWORD)a4, Offset, (__int64)&v43, (__int64)&v41);
  }
  v17 = *((_QWORD *)v5 + 1);
  if ( v17 )
  {
