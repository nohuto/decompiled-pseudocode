/*
 * XREFs of AcpiPlatformLevelDeviceReset @ 0x1C004BA68
 * Callers:
 *     AcpiDeviceReset @ 0x1C009DBE0 (AcpiDeviceReset.c)
 * Callees:
 *     AcpiResetDeviceAlreadyProcessed @ 0x1C004BB58 (AcpiResetDeviceAlreadyProcessed.c)
 */
