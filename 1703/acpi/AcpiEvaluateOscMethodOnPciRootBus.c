/*
 * XREFs of AcpiEvaluateOscMethodOnPciRootBus @ 0x1C000617C
 * Callers:
 *     AcpiEvaluateBiosMethodsOnPciRootBus @ 0x1C0008CA0 (AcpiEvaluateBiosMethodsOnPciRootBus.c)
 *     PciRootBusBiosMethodDispatcherOnResume @ 0x1C002B060 (PciRootBusBiosMethodDispatcherOnResume.c)
 * Callees:
