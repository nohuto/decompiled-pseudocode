/*
 * XREFs of ACPIIoctlGetDeviceInformation @ 0x1C0050AC0
 * Callers:
  ...
  if ( DeviceExtension )
  {
    ...
    if ( v3 >= v7 )
    {
      ...
      if ( (*(_QWORD *)(v9 + 8) & 0x200000000000LL) != 0 )
      {
        ...
        memmove(&MasterIrp->ThreadListEntry, (const void *)(*(_QWORD *)(v9 + 560) + 5LL), v18 + 1LL);
      ...
      if ( (*(_BYTE *)(v9 + 952) & 0x10) != 0 )
      {
        ...
        memmove((char *)MasterIrp + v6, *(const void **)(v9 + 576), (unsigned __int16)v19 + 1LL);
