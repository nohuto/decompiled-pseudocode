/*
 * XREFs of ACPIBuildProcessPowerResourcePhasePep @ 0x1C00440F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessPowerResourcePhasePep(__int64 a1, __int64 a2, int a3)
{
  ...
  *(_DWORD *)(a1 + 32) = 4;
  ...
  if ( (*(_DWORD *)(v3 + 16) & 0x4000LL) == 0 )
  {
    ...
    v5 = AcpiNotifyPlExtDiscoverDeviceAsync(
           *(volatile signed __int32 **)(v3 + 32),
           (__int64)ACPIBuildDiscoverPowerNodeCompletion,
           a1);
    if ( v5 < 0 )
