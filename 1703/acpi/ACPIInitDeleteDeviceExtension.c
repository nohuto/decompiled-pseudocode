/*
 * XREFs of ACPIInitDeleteDeviceExtension @ 0x1C004F6A4
 * Callers:
...
LABEL_4:
  ...
  *((_DWORD *)Entry + 212) = *(_DWORD *)(**((_QWORD **)Entry + 89) + 40LL);
  v26 = (_QWORD *)qword_1C0077068;
  if ( *(__int64 **)qword_1C0077068 != &AcpiDevicesWhichMightNeedEnumerationList )
    __fastfail(3u);
  *v25 = &AcpiDevicesWhichMightNeedEnumerationList;
  *((_QWORD *)Entry + 105) = v26;
  *v26 = v25;
  qword_1C0077068 = (__int64)(Entry + 208);
