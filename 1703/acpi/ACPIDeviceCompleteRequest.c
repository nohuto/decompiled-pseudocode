/*
 * XREFs of ACPIDeviceCompleteRequest @ 0x1C000A974
 * Callers:
 ...
 *     ACPIDevicePowerProcessInvalid @ 0x1C00496E0 (ACPIDevicePowerProcessInvalid.c)
 * Callees:
...
LABEL_15:
    ...
    *((_QWORD *)&v16->Next + 1) = v17;
    ...
    {
      ACPIDereferenceWaitWakePowerRequest(ListEntry);
    }
    else
    {
      ++dword_1C0077C5C;
      if ( ExQueryDepthSList(&RequestLookAsideList) < (unsigned __int16)word_1C0077C50 )
      {
      ...
      {
        ++dword_1C0077C60;
        ((void (__fastcall *)(PSLIST_ENTRY))qword_1C0077C78)(ListEntry);
      }
    }
    return;
  }
