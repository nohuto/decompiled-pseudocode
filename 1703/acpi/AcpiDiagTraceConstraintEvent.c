/*
 * XREFs of AcpiDiagTraceConstraintEvent @ 0x1C004159C
 * Callers:
        ...
        PEVENT_DATA_DESCRIPTOR a5)
{
  ...
  if ( AcpiDiagHandle )
  {
    ...
    {
      if ( (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a1 + 712), (__int64)&v14, 1) >= 0 )
      {
        v8 = *(_QWORD *)(a2 + 712);
        LOWORD(v16) = v14.Length >> 1;
        if ( (int)ACPIAmliBuildObjectPathnameUnicode(v8, (__int64)&DestinationString, 1) >= 0 )
        {
          UserData = a5;
