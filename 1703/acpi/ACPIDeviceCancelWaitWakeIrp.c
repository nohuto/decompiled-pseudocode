/*
 * XREFs of ACPIDeviceCancelWaitWakeIrp @ 0x1C0048950
 * Callers:
...
void __fastcall ACPIDeviceCancelWaitWakeIrp(ULONG_PTR a1, __int64 a2)
{
  ...
  __int64 v20; // rcx
  void (__fastcall *v21)(__int64, int *); // rax
  int v22; // [rsp+90h] [rbp+18h] BYREF
  char v23; // [rsp+94h] [rbp+1Ch]
  ...
  v17 = *(_QWORD *)i;
  v18 = *(__int64 **)(i + 8);
  if ( *(_QWORD *)(*(_QWORD *)i + 8LL) != i || *v18 != i )
    __fastfail(3u);
  *v18 = v17;
  *(_QWORD *)(v17 + 8) = v18;
  ...
  *(_DWORD *)(i + 256) = -1073741536;
  ...
  if ( (*(_QWORD *)(v6 + 952) & 0x4000000000LL) != 0 )
  {
    v20 = *(_QWORD *)(v6 + 944);
    v22 = *(_DWORD *)(v6 + 928);
    v21 = *(void (__fastcall **)(__int64, int *))(v6 + 936);
    v23 = 0;
    v21(v20, &v22);
  }
