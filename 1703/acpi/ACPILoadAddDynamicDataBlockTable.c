/*
 * XREFs of ACPILoadAddDynamicDataBlockTable @ 0x1C00AC434
 * Callers:
...
__int64 __fastcall ACPILoadAddDynamicDataBlockTable(__int64 a1, char a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    {
      v7 = (_QWORD *)qword_1C0077EB0;
      if ( *(__int64 **)qword_1C0077EB0 != &AcpiDynamicDataBlockTableList )
        __fastfail(3u);
      *v6 = &AcpiDynamicDataBlockTableList;
      v6[1] = v7;
      *v7 = v6;
      qword_1C0077EB0 = (__int64)v6;
    }
  }
  else
  {
