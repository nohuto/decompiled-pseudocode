/*
 * XREFs of AcpiValidatePepDeviceControlResources @ 0x1C00A0B5C
 * Callers:
 ...
 *     AMLICheckIfIoRangeValid @ 0x1C005AB20 (AMLICheckIfIoRangeValid.c)
 *     AMLIValidateFirmwareMemoryAddress @ 0x1C005AF00 (AMLIValidateFirmwareMemoryAddress.c)
 */
...
__int64 __fastcall AcpiValidatePepDeviceControlResources(_DWORD *a1, int a2, int a3, int a4)
{
  ...
  unsigned __int64 v22; // [rsp+C0h] [rbp+58h] BYREF
...
LABEL_23:
    ...
    v22 = MinimumAddress;
    v4 = AMLIValidateFirmwareMemoryAddress((__int64 *)&v22, v8);
    if ( v4 < 0 )
    {
