/*
 * XREFs of IsPciBusAsyncWorker @ 0x1C001FBD0
 * Callers:
...
LABEL_76:
  ...
  *((_DWORD *)a4 + 2) = v10 | 1;
  ...
  AMLIDereferenceHandleEx((volatile signed __int32 *)v12, 0LL);
  if ( v6 == 259 )
    return 259LL;
  if ( v6 >= 0 )
  {
      ...
      *((_DWORD *)a4 + 2) = v14 | 0x80;
      ...
      if ( v16 )
      {
        v6 = ACPIGet(
               ...
               (__int64)(a4 + 3),
               0LL);
        AMLIDereferenceHandleEx((volatile signed __int32 *)v16, 0LL);
        if ( v6 == 259 )
          return 259LL;
        if ( v6 < 0 )
          goto LABEL_21;
...
LABEL_17:
      ...
      if ( (v25 & 0x20) == 0 )
      {
        ...
        *((_DWORD *)a4 + 2) = v25 | 0x20;
        v27 = (volatile signed __int32 *)AMLIGetParent((__int64)v26);
        v28 = v27;
        if ( v27 )
        {
          v6 = IsPciBusAsync(v27, (__int64)IsPciBusAsyncWorker, (__int64)a4, (_BYTE *)a4 + 36);
          AMLIDereferenceHandleEx(v28, 0LL);
        }
        else
        {
          v6 = -1073741661;
...
LABEL_48:
        if ( *((_WORD *)a4 + 36) != 0xFFFF && *((_WORD *)a4 + 37) != 0xFFFF )
        {
          ...
          if ( v32 != -1 && *((_BYTE *)a4 + 83) != 0xFF && *((_BYTE *)a4 + 82) != 0xFF && *((_BYTE *)a4 + 81) != 0xFF )
          {
            ...
            v33 = (volatile signed __int32 *)AMLIGetParent(*a4);
            if ( v33 )
            {
              v34 = *(_QWORD *)(*(_QWORD *)v33 + 104LL);
              AMLIDereferenceHandleEx(v33, 0LL);
            }
            else
            {
              v34 = 0LL;
...
LABEL_23:
  ...
  if ( *a4 )
  {
    AMLIDereferenceHandleEx((volatile signed __int32 *)*a4, 0LL);
    *a4 = 0LL;
  }
