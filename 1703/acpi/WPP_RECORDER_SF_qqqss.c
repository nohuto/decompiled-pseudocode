/*
 * XREFs of WPP_RECORDER_SF_qqqss @ 0x1C0042C54
 * Callers:
 *     ACPIDeviceCancelWaitWakeIrp @ 0x1C0048950 (ACPIDeviceCancelWaitWakeIrp.c)
 *     ACPIIsPowerNodeInTransition @ 0x1C004AAF0 (ACPIIsPowerNodeInTransition.c)
        ...
        const char *a10)
{
  ...
  if ( !v13 )
    v13 = "NULL";
  LOWORD(v29) = a4;
  return WppAutoLogTrace(a1, a2, a3, a5, v29, &a6, 8LL, &a7, 8LL, &a8, 8LL, v13, v27, v11, v26, 0LL);
}
