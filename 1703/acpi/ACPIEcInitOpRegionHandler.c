/*
 * XREFs of ACPIEcInitOpRegionHandler @ 0x1C002AB00
 * Callers:
 ...
 *     ACPIEcDisconnectGpioInterrupt @ 0x1C009E034 (ACPIEcDisconnectGpioInterrupt.c)
 */
      ...
      *(_QWORD *)EcData = 0LL;
        ...
        && !PoolWithTag[50] )
      {
        ...
        *(_DWORD *)(EcData + 16) = *((_DWORD *)PoolWithTag + 15);
        if ( (int)AMLIGetNameSpaceObject(PoolWithTag + 65, 0LL, (_QWORD *)(EcData + 56)) >= 0 )
        {
