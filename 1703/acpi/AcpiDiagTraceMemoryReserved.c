/*
 * XREFs of AcpiDiagTraceMemoryReserved @ 0x1C009AD40
 * Callers:
...
{
  _UNKNOWN **v3; // rax
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+38h] [rbp-69h] BYREF
  char *v6; // [rsp+48h] [rbp-59h]
  int v7; // [rsp+50h] [rbp-51h]
  int v8; // [rsp+54h] [rbp-4Dh]
  char *v9; // [rsp+58h] [rbp-49h]
  int v10; // [rsp+60h] [rbp-41h]
  int v11; // [rsp+64h] [rbp-3Dh]
  va_list v12; // [rsp+68h] [rbp-39h]
  int v13; // [rsp+70h] [rbp-31h]
  int v14; // [rsp+74h] [rbp-2Dh]
  va_list v15; // [rsp+78h] [rbp-29h]
  int v16; // [rsp+80h] [rbp-21h]
  int v17; // [rsp+84h] [rbp-1Dh]
  va_list v18; // [rsp+88h] [rbp-19h]
  int v19; // [rsp+90h] [rbp-11h]
  int v20; // [rsp+94h] [rbp-Dh]
  va_list v21; // [rsp+98h] [rbp-9h]
  int v22; // [rsp+A0h] [rbp-1h]
  int v23; // [rsp+A4h] [rbp+3h]
  va_list v24; // [rsp+A8h] [rbp+7h]
  int v25; // [rsp+B0h] [rbp+Fh]
  int v26; // [rsp+B4h] [rbp+13h]
  _UNKNOWN *retaddr; // [rsp+E0h] [rbp+3Fh] BYREF
  char v28; // [rsp+E8h] [rbp+47h] BYREF
  char v29; // [rsp+F0h] [rbp+4Fh] BYREF
  char v30; // [rsp+F8h] [rbp+57h] BYREF
  __int64 v31; // [rsp+100h] [rbp+5Fh] BYREF
  va_list va; // [rsp+100h] [rbp+5Fh]
  __int64 v33; // [rsp+108h] [rbp+67h] BYREF
  va_list va1; // [rsp+108h] [rbp+67h]
  __int64 v35; // [rsp+110h] [rbp+6Fh] BYREF
  va_list va2; // [rsp+110h] [rbp+6Fh]
  __int64 v37; // [rsp+118h] [rbp+77h] BYREF
