/*
 * XREFs of ProcessorpReserveIdtEntriesApic @ 0x1C00854F0
 * Callers:
 *     <none>
 * Callees:
        ...
        _OWORD *a9)
{
  ...
  *((_DWORD *)UserData + 6) = a5;
  LODWORD(Start) = v15;
  v17 = *(_QWORD *)(a4 + 16);
  v18 = (((a6 & 1) != 0) + 1) | (a3 >= 0xFFF00000 ? 4 : 0);
  for ( i = 0; ; ++i )
  {
    if ( !v17 )
    {
...
LABEL_14:
  ...
  if ( a8 == 1 )
    ++v21;
  v22 = RtlAddRange(v21, (unsigned int)Start, a5 + (unsigned int)Start - 1LL, v18, 2 * (a7 & 1) + 1, UserData, a1);
  if ( v22 >= 0 )
  {
    *UserData |= 1LL << i;
    goto LABEL_14;
