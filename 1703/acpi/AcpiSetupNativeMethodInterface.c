/*
 * XREFs of AcpiSetupNativeMethodInterface @ 0x1C0093C70
 * Callers:
    ...
    if ( AttachedDeviceReference )
    {
      ...
      *((_QWORD *)&OutputBuffer[5] + 1) = AcpiTranslatePepDeviceControlResources;
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_1C0076A70 = OutputBuffer[1];
        unk_1C0076A80 = OutputBuffer[2];
        xmmword_1C0076A90 = OutputBuffer[3];
        xmmword_1C0076AA0 = OutputBuffer[4];
        xmmword_1C0076AB0 = OutputBuffer[5];
