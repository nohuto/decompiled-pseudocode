/*
 * XREFs of ACPIBusIrpQueryCompatibleId @ 0x1C0092148
 * Callers:
...
LABEL_40:
  ...
  if ( PoolWithTag )
  {
    ...
    memmove(v36, v19, v18);
    if ( !ACPIValidateStringVendorDeviceIdFormat((__int64)v36, Size) && (*(_BYTE *)(a3 + 952) & 0x1C) == 0 )
    {
LABEL_18:
      LODWORD(v7) = ACPIGet((__int64 *)a3, 1145652063, 268960023, 0LL, 0, 0LL, 0LL, (__int64)P, (__int64)&v32);
      if ( (int)v7 < 0 && v11 == *a2 )
      ...
      if ( v11 >= v32 )
      {
        ...
        if ( v11 < v32 )
          goto LABEL_22;
LABEL_33:
        v25 = RtlStringCbPrintfExW(&v10[v24 >> 1], v11 - v24, &ppszDestEnd, &pcbRemaining, 0, &word_1C0067334);
LABEL_34:
        LODWORD(v7) = v25;
        goto LABEL_20;
      }
