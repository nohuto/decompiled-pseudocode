/*
 * XREFs of AMLILoadDDB @ 0x1C00ABDC8
 * Callers:
...
__int64 __fastcall AMLILoadDDB(int *a1, _QWORD *a2)
{
  ...
  {
    pszSrc = *a1;
    RtlStringCchCopyNA(byte_1C0077978, 5uLL, (STRSAFE_PCNZCH)&pszSrc, 4uLL);
    PrintDebugMessage(85, KeGetCurrentThread(), byte_1C0077978, a1, 0LL);
  }
  v5 = 0;
  v11 = 0;
  ...
  if ( !DDB )
  {
    ...
    DDB = LoadDDB((__int64)v8, (const char *)a1, gpnsNameSpaceRoot, (__int64)v10);
    if ( !DDB )
      DDB = SyncLoadDDB(v7);
  }
  if ( a2 )
