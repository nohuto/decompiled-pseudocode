/*
 * XREFs of ACPIGetConvertToDeviceIDWide @ 0x1C00244A4
 * Callers:
 ...
 *     ACPIAnsiStringToWideHelper @ 0x1C0005220 (ACPIAnsiStringToWideHelper.c)
 *     ACPIGetProcessorIDWide @ 0x1C0023C60 (ACPIGetProcessorIDWide.c)
 *     ACPIAmliDoubleToNameWide @ 0x1C00246D4 (ACPIAmliDoubleToNameWide.c)
...
__int64 __fastcall ACPIGetConvertToDeviceIDWide(__int64 a1, __int64 a2, __int64 a3, int a4, char **a5, int *a6)
{
  ...
  if ( (a4 & 0x4000000) == 0 )
  {
    ...
    if ( (v8 & 0x800000000000LL) != 0 )
    {
      ...
      RtlStringCchPrintfA(v10, v19, "%s", *(_QWORD *)(a1 + 560));
      goto LABEL_21;
    }
  }
  if ( (int)a2 < 0 )
