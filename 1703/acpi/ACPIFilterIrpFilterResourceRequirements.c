/*
 * XREFs of ACPIFilterIrpFilterResourceRequirements @ 0x1C008BDF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIInternalInterruptPolarityCacheStorePolarity @ 0x1C0006D4C (ACPIInternalInterruptPolarityCacheStorePolarity.c)
