/*
 * XREFs of ACPIBuildProcessRunMethodPhaseRunMethod @ 0x1C000BE90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIBuildProcessRunMethodPhaseRunMethod(__int64 a1)
{
  ...
  _QWORD v38[10]; // [rsp+50h] [rbp-78h] BYREF
  ...
  if ( v6 )
  {
    ...
    else
    {
      ...
      if ( (v22 & 0x80u) != 0 )
      {
        ...
        {
          v34 = v33;
          v33 = _InterlockedCompareExchange64(v2 + 119, v33 | 0x4000, v33);
        }
        while ( v34 != v33 );
        if ( (v33 & 0x4000) != 0 )
          goto LABEL_8;
...
LABEL_29:
    ...
    *(_QWORD *)(a1 + 56) = v6;
    ...
    if ( (v28 & 4) != 0 )
      _InterlockedIncrement(v6 + 2);
    v5 = AMLIAsyncEvalObject(v6, v7, v26, v25, ACPIBuildCompleteMustSucceed, a1);
  }
LABEL_8:
  v15 = 0;
  v16 = &unk_1C0066CD0;
