/*
 * XREFs of WPP_RECORDER_SF_qDqqss @ 0x1C004AF6C
 * Callers:
 *     ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum @ 0x1C004A9D0 (ACPIIsPhase3ListEmptyOfUnblockedItemsPowerNodeEnum.c)
 * Callees:
