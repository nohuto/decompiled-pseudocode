/*
 * XREFs of IrqArbGetNextAllocationRange @ 0x1C0088F00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IrqArbpFindBootConfig @ 0x1C00892A0 (IrqArbpFindBootConfig.c)
 *     ArbGetNextAllocationRange @ 0x1C00896D0 (ArbGetNextAllocationRange.c)
 *     IrqArbIrqFromGsiv @ 0x1C00A5BA0 (IrqArbIrqFromGsiv.c)
 *     IrqArbpFindIrqInAlternatives @ 0x1C00A5F94 (IrqArbpFindIrqInAlternatives.c)
 */
...
LABEL_28:
  ...
  {
LABEL_9:
    v8 = &WPP_7e722731483c3b8ec3839991a228af4a_Traceguids;
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        *v7 = 4099;
        ...
        if ( v18 >= 0 )
        {
          ...
          if ( v26 )
          {
            ...
            if ( (_DWORD)v23 != -1 )
            {
              v21 = (unsigned int)IrqArbIrqFromGsiv(v23, &WPP_7e722731483c3b8ec3839991a228af4a_Traceguids);
              v22 = v21;
LABEL_41:
              v28 = v21;
