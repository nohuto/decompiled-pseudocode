/*
 * XREFs of NotifyHalWithMachineStatesAndRetrieveInterruptModel @ 0x1C00AA430
 * Callers:
...
__int64 __fastcall NotifyHalWithMachineStatesAndRetrieveInterruptModel(int *a1)
{
  ...
  *((_BYTE *)PoolWithTag + 14) = 0;
  ...
  do
  {
    v6 = byte_1C0068328[v4];
    v7 = *(_DWORD *)((char *)&unk_1C0068308 + v4);
    ...
    if ( *((_BYTE *)AcpiInformation + 133) && v5 >= 5 )
      goto LABEL_10;
    v8 = Src[v6];
    if ( (int)AMLIGetNameSpaceObject(v8, 0LL, &BugCheckParameter4) >= 0 )
    {
...
LABEL_12:
  ...
  if ( (unsigned int)(v21 - 1) <= 3 )
    v15 = v21;
  *v26 = v15;
  if ( (int)AMLIGetNameSpaceObject(v29, 0LL, &BugCheckParameter4) < 0 )
  {
    return 0;
  }
  else
