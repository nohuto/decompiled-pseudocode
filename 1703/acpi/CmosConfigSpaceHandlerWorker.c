/*
 * XREFs of CmosConfigSpaceHandlerWorker @ 0x1C0047B98
 * Callers:
 *     CmosConfigSpaceHandler @ 0x1C0047A60 (CmosConfigSpaceHandler.c)
 *     CmosTranslatePNPIDToEnum @ 0x1C0047CC0 (CmosTranslatePNPIDToEnum.c)
 * Callees:
...
__int64 __fastcall CmosConfigSpaceHandlerWorker(__int64 a1, __int64 a2, __int64 a3, unsigned int *a4)
{
  ...
  AMLIDereferenceHandleEx(*((volatile signed __int32 **)a4 + 1), v6);
  AMLIDereferenceHandleEx(*((volatile signed __int32 **)a4 + 7), v7);
