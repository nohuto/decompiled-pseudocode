/*
 * XREFs of ProcessorpSelectProcessorSet @ 0x1C008833C
 * Callers:
...
__int64 __fastcall ProcessorpSelectProcessorSet(__int16 a1, char a2, char a3, KAFFINITY *a4, __int64 a5)
{
  ...
  else
  {
    if ( a2 )
    {
      ...
      *(_QWORD *)(v17 + 8) = &ProcessorGroupListHead;
      v9 = (__int64 *)qword_1C0076548;
      if ( *(__int64 **)qword_1C0076548 != &ProcessorGroupListHead )
        __fastfail(3u);
    }
    else
    {
      ...
      v8 = *(_QWORD **)(*(_QWORD *)ProcessorGroupByNumber + 8LL);
      if ( *(_QWORD *)(v7 + 8) != *(_QWORD *)ProcessorGroupByNumber || *v8 != v6 )
        __fastfail(3u);
      *v8 = v7;
      *(_QWORD *)(v7 + 8) = v8;
      v9 = (__int64 *)qword_1C0076548;
...
LABEL_29:
  ...
  v11 = *(__int64 **)(v6 + 16);
  v12 = *v11;
  if ( v11[1] != v6 + 16 || *(__int64 **)(v12 + 8) != v11 )
    __fastfail(3u);
  *v10 = v12;
  *(_QWORD *)(v12 + 8) = v10;
  v13 = *(__int64 ***)(v6 + 24);
