/*
 * XREFs of IsPciDeviceWorker @ 0x1C001F2D0
 * Callers:
    ...
    if ( (v9 & 1) == 0 )
    {
      ...
      *((_DWORD *)a4 + 2) = v9 | 1;
      ...
      if ( v23 )
      {
        ...
        AMLIDereferenceHandleEx((volatile signed __int32 *)v23, 0LL);
        if ( v6 == 259 )
          return 259LL;
        if ( v6 < 0 )
          goto LABEL_60;
      ...
      *((_DWORD *)a4 + 2) = v11 | 0x80;
      ...
      if ( v25 )
      {
        v6 = ACPIGet(
               ...
               (__int64)(a4 + 3),
               0LL);
        AMLIDereferenceHandleEx((volatile signed __int32 *)v25, 0LL);
        if ( v6 == 259 )
          return 259LL;
        if ( v6 < 0 )
          goto LABEL_60;
...
LABEL_10:
      ...
      *((_DWORD *)a4 + 2) = v14 | 0x20;
      v16 = AMLIGetParent((__int64)v15);
      v17 = (volatile signed __int32 *)v16;
      if ( v16 )
      {
        v6 = IsPciBusAsync(v16, &IsPciDeviceWorker, a4);
        AMLIDereferenceHandleEx(v17, 0LL);
      }
      else
      {
        v6 = -1073741661;
...
LABEL_29:
            ...
            *(_BYTE *)a4[7] = 1;
            v27 = (volatile signed __int32 *)AMLIGetParent(*a4);
            if ( v27 )
            {
