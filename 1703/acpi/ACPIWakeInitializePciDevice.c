/*
 * XREFs of ACPIWakeInitializePciDevice @ 0x1C0027360
 * Callers:
  ...
  if ( (*(_DWORD *)(DeviceExtension + 8) & 0x10020) == 0x10000LL )
  {
    ...
    if ( PciPmeInterfaceInstantiated )
    {
      (*(void (__fastcall **)(_QWORD, char *, _BYTE *, char *))(PciPmeInterface + 32))(
        *(_QWORD *)(DeviceExtension + 736),
        &v5,
        v4,
        &v7);
      if ( v5 == 1 )
      {
        (*(void (__fastcall **)(_QWORD, char *))(PciPmeInterface + 56))(*(_QWORD *)(DeviceExtension + 736), &v6);
        if ( v6 == 1 )
        {
          _InterlockedOr64((volatile signed __int64 *)(DeviceExtension + 8), 0x800000000000000uLL);
          if ( v7 )
          {
            (*(void (__fastcall **)(_QWORD, _QWORD))(PciPmeInterface + 48))(*(_QWORD *)(DeviceExtension + 736), 0LL);
          }
          else if ( v4[0] )
          {
            (*(void (__fastcall **)(_QWORD))(PciPmeInterface + 40))(*(_QWORD *)(DeviceExtension + 736));
          }
        }
      }
    }
