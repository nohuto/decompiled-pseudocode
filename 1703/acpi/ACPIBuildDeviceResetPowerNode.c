/*
 * XREFs of ACPIBuildDeviceResetPowerNode @ 0x1C0042FFC
 * Callers:
...
__int64 __fastcall ACPIBuildDeviceResetPowerNode(_QWORD *BugCheckParameter2, ULONG_PTR BugCheckParameter3, __int64 a3)
{
  ...
  volatile signed __int32 *v20; // [rsp+80h] [rbp+18h] BYREF
  ...
  if ( PoolWithTag )
  {
    ...
    v9 = *(_QWORD *)(a3 + 32);
    v20 = 0LL;
    if ( (int)AMLIGetNameSpaceObject(*(_BYTE **)(v9 + 40), BugCheckParameter3, &v20) < 0 )
    {
      WPP_RECORDER_SF_sLqss(WPP_GLOBAL_Control->DeviceExtension, 0, BugCheckParameter2[1], 15);
      KeBugCheckEx(0xA5u, 6uLL, (ULONG_PTR)BugCheckParameter2, BugCheckParameter3, *(_QWORD *)(v9 + 40));
    }
    v10 = v20;
    if ( !v20 || *(_WORD *)(*(_QWORD *)v20 + 66LL) != 11 )
    {
      ...
      WPP_RECORDER_SF_sqss(
        ...
        *(const char **)(v9 + 40),
        ...
        v17,
        v18);
      KeBugCheckEx(0xA5u, 0x12uLL, (ULONG_PTR)BugCheckParameter2, BugCheckParameter3, *(_QWORD *)(v9 + 40));
    }
    ...
    *v14 = v13;
    *(_QWORD *)(v12 + 8) = v13;
    AMLIDereferenceHandleEx(v10, (__int64)v14);
