/*
 * XREFs of IrqArbpPrepareForTestOrConflict @ 0x1C0088800
 * Callers:
 *     IrqArbTestAllocation @ 0x1C0088630 (IrqArbTestAllocation.c)
 *     IrqArbRetestAllocation @ 0x1C00A5C40 (IrqArbRetestAllocation.c)
