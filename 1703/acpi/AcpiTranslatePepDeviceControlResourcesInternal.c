/*
 * XREFs of AcpiTranslatePepDeviceControlResourcesInternal @ 0x1C00A09B0
 * Callers:
 *     AcpiTranslatePepDeviceControlResources @ 0x1C00A0970 (AcpiTranslatePepDeviceControlResources.c)
 * Callees:
