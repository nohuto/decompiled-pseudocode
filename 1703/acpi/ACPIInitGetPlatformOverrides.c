/*
 * XREFs of ACPIInitGetPlatformOverrides @ 0x1C00AB560
 * Callers:
 ...
 *     ACPIIsSystemStartOptionPresent @ 0x1C00AB668 (ACPIIsSystemStartOptionPresent.c)
 */
...
__int64 ACPIInitGetPlatformOverrides()
{
  ...
  Handle = 0LL;
  P = 0LL;
  v0 = OSOpenHandle("\\Registry\\Machine\\System\\CurrentControlSet\\Control", 0LL, (__int64)&Handle);
  if ( v0 >= 0 )
  {
