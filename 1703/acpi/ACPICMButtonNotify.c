/*
 * XREFs of ACPICMButtonNotify @ 0x1C00471AC
 * Callers:
 *     ACPICMButtonNotifyByDeviceExtension @ 0x1C00472A0 (ACPICMButtonNotifyByDeviceExtension.c)
...
void __fastcall ACPICMButtonNotify(ULONG_PTR a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v7 != 126 )
  {
    ...
    {
      v8 = *(const char **)(a2 + 560);
      if ( (v6 & 0x400000000000LL) != 0 )
        v9 = *(const char **)(a2 + 568);
    }
