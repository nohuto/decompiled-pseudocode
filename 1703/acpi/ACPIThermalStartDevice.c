/*
 * XREFs of ACPIThermalStartDevice @ 0x1C00919A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIThermalStartDevice(PDEVICE_OBJECT PhysicalDeviceObject, PIRP Irp)
{
  ...
  *(_DWORD *)(DeviceExtension + 192) |= 0x8000000u;
  ...
  WPP_RECORDER_SF_qqss(
    ...
    5u,
    0x14u,
    (__int64)&WPP_e8a71974e51b30e49c3e0986e671468e_Traceguids,
    (char)Irp,
    DeviceExtension,
    v6,
    v7);
  ...
  *(_QWORD *)(v9 + 112) = AMLIGetNamedChild(*(__int64 **)(DeviceExtension + 712), 1347245151);
  ...
  if ( (int)ACPIAmliEvaluateDsm(v10, (unsigned int)&v27, 0, 0, (__int64)v28, (__int64)&v26) >= 0 )
  {
    v18 = v26;
