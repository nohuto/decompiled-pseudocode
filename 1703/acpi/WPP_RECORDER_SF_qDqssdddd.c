/*
 * XREFs of WPP_RECORDER_SF_qDqssdddd @ 0x1C002255C
 * Callers:
...
__int64 WPP_RECORDER_SF_qDqssdddd(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  __int64 v17; // [rsp+110h] [rbp+4Fh] BYREF
  va_list va; // [rsp+110h] [rbp+4Fh]
  __int64 v19; // [rsp+118h] [rbp+57h] BYREF
  va_list va1; // [rsp+118h] [rbp+57h]
  __int64 v21; // [rsp+120h] [rbp+5Fh] BYREF
  va_list va2; // [rsp+120h] [rbp+5Fh]
  const char *v23; // [rsp+128h] [rbp+67h]
  const char *v24; // [rsp+130h] [rbp+6Fh]
  ...
  v23 = va_arg(va3, const char *);
  v24 = va_arg(va3, const char *);
  v5 = v24;
  v6 = -1LL;
  v7 = v23;
