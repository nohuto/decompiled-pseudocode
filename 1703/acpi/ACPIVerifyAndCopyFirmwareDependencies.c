/*
 * XREFs of ACPIVerifyAndCopyFirmwareDependencies @ 0x1C0028E8C
 * Callers:
...
__int64 __fastcall ACPIVerifyAndCopyFirmwareDependencies(ULONG_PTR a1, __int64 a2, _QWORD *a3)
{
  ...
  __int64 v21; // r14
  __int64 v22; // rax
  volatile signed __int32 *v24; // [rsp+78h] [rbp+10h] BYREF
  ...
  *a3 = 0LL;
  ...
  if ( *(_WORD *)(a2 + 2) == 4 )
  {
    ...
    if ( (_DWORD)v10 )
    {
      ...
      do
      {
        v17 = AMLIGetNameSpaceObject(*((_BYTE **)v16 + 1), v6, &v24);
        if ( v17 < 0 )
        {
          LOBYTE(v18) = 2;
          WPP_RECORDER_SF_D(
        ...
        AMLIDereferenceHandleEx(v24, v18);
        ++v8;
        v9 += *v16;
        v24 = 0LL;
        v6 = a1;
