  ...
  do
  {
    while ( 1 )
    {
      do
      {
        ...
        if ( qword_1C00776E8 )
          ((void (__fastcall *)(const CHAR *, CHAR *, __int64, __int64))qword_1C00776E8)(
            "\nAMLI(? for help)-> ",
            Response,
            256LL,
            qword_1C00776F0);
