/*
 * XREFs of RestartContext @ 0x1C0012000
 * Callers:
 ...
 *     RestartCtxtCallback @ 0x1C0011EC0 (RestartCtxtCallback.c)
 *     SleepQueueDpc @ 0x1C002BE40 (SleepQueueDpc.c)
 *     AMLIRestartContext @ 0x1C005AD84 (AMLIRestartContext.c)
 *     AsyncCallBack @ 0x1C005EFAC (AsyncCallBack.c)
 *     TimeoutCallback @ 0x1C005F490 (TimeoutCallback.c)
...
__int64 __fastcall RestartContext(PSLIST_ENTRY ListEntry, char a2)
{
  ...
  {
    v10 = _InterlockedExchangeAdd((_DWORD *)&qword_1C00776C8 + 1, 1u);
    if ( (_DWORD)qword_1C00776C8 == 204 )
      v11 = v10 % 0xCC;
    else
      v11 = v10 % (unsigned int)qword_1C00776C8;
    v12 = 72LL * v11;
    *(_QWORD *)((char *)qword_1C00776D0 + v12 + 8) = MEMORY[0xFFFFF78000000008];
    *(_DWORD *)((char *)qword_1C00776D0 + v12) = 1380275028;
    *(_QWORD *)((char *)qword_1C00776D0 + v12 + 16) = CurrentThread;
    *(_QWORD *)((char *)qword_1C00776D0 + v12 + 24) = v8;
    *(_QWORD *)((char *)qword_1C00776D0 + v12 + 32) = ListEntry;
    *(_QWORD *)((char *)qword_1C00776D0 + v12 + 40) = v9;
    *(_QWORD *)((char *)qword_1C00776D0 + v12 + 48) = ListEntry;
    *(_QWORD *)((char *)qword_1C00776D0 + v12 + 56) = v5;
    *(_QWORD *)((char *)qword_1C00776D0 + v12 + 64) = v7;
  }
