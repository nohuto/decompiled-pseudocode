/*
 * XREFs of ExprOp2_64 @ 0x1C001AB40
 * Callers:
...
__int64 __fastcall ExprOp2_64(__int64 a1, _QWORD *a2)
{
  ...
  if ( (_WORD)v8 == 128 )
  {
    if ( !(unsigned __int8)MatchObjType((unsigned __int16)v5[1], 135LL) )
    {
      v7 = -1072431094;
      LogError(3222536202LL);
      AcpiDiagTraceAmlError(a1, 3222536202LL);
...
LABEL_10:
      ...
      else if ( *((_QWORD *)v5 + 4) )
      {
        ...
        {
          if ( v5[1] == 4 )
            FreeDataBuffs(*((_QWORD *)v5 + 4) + 8LL, **((_DWORD **)v5 + 4));
          FreeObjData((__int64)v5);
        }
        else
        {
          *v5 |= 8u;
