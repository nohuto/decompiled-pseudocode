/*
 * XREFs of ACPIDispatchAddDevice @ 0x1C00AD890
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPICreateRootSymbolicLink @ 0x1C0093BA0 (ACPICreateRootSymbolicLink.c)
 *     AcpiSetupNativeMethodInterface @ 0x1C0093C70 (AcpiSetupNativeMethodInterface.c)
 *     ACPIGetPortRangeInterfaces @ 0x1C00ADBE0 (ACPIGetPortRangeInterfaces.c)
 */
    ...
    if ( v9 )
    {
      ...
      if ( v16 )
      {
        ...
        *v4 = &gAcpiTriageInfo;
        ...
        RootDeviceExtension = (__int64)v4;
...
LABEL_10:
  v21 = (const char *)&unk_1C00A9BB3;
  v22 = (const char *)&unk_1C00A9BB3;
  if ( v4 )
  {
    v23 = v4[1];
    v2 = (char)v4;
