/*
 * XREFs of AcpiConvertMethodArgumentsToObjData @ 0x1C005328C
 * Callers:
 *     AcpiConvertPackageArgumentToPackageObj @ 0x1C0053634 (AcpiConvertPackageArgumentToPackageObj.c)
 *     AcpiNativeMethodEvalRequestHandler @ 0x1C0053AE0 (AcpiNativeMethodEvalRequestHandler.c)
 * Callees:
 ...
 *     AcpiCleanupObjDataArguments @ 0x1C0053208 (AcpiCleanupObjDataArguments.c)
 *     AcpiConvertPackageArgumentToPackageObj @ 0x1C0053634 (AcpiConvertPackageArgumentToPackageObj.c)
...
LABEL_15:
    ...
    *(_WORD *)v10 = 4;
    v14 = AcpiConvertPackageArgumentToPackageObj(a1, v10 + 22, v10 + 30);
    if ( v14 < 0 )
    {
      LOBYTE(v13) = 2;
      WPP_RECORDER_SF_qD(
...
LABEL_16:
  ...
  WPP_RECORDER_SF_DDPP(WPP_GLOBAL_Control->DeviceExtension, v11, 2, 1);
LABEL_25:
  v14 = -1073741788;
LABEL_21:
