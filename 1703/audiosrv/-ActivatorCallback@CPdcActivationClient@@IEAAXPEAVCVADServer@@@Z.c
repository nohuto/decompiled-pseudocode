/*
 * XREFs of ?ActivatorCallback@CPdcActivationClient@@IEAAXPEAVCVADServer@@@Z @ 0x1800ADF80
 * Callers:
 *     ?PdcTimerActivatorCallback@CPdcActivationClient@@KAXPEAXW4_PDC_ACTIVATOR_ERROR_DETAIL@@00@Z @ 0x1800AE0C0 (-PdcTimerActivatorCallback@CPdcActivationClient@@KAXPEAXW4_PDC_ACTIVATOR_ERROR_DETAIL@@00@Z.c)
 * Callees:
 ...
 *     ?QueryState@CVADServer@@QEAAJPEAH00@Z @ 0x18007AB30 (-QueryState@CVADServer@@QEAAJPEAH00@Z.c)
...
void __fastcall CPdcActivationClient::ActivatorCallback(CPdcActivationClient *this, struct CVADServer *a2)
{
  ...
  if ( *(_DWORD *)v7 > 4u )
  {
    *(_QWORD *)v15 = a2;
    ...
    v20 = 8;
    v21 = 0;
    TlgWrite(v7, &unk_1800FA487, v8, v9, 3u, &pData);
  }
