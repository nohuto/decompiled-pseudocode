/*
 * XREFs of ?CalculateDynamicObjectGrantCount@CStreamResource@Sarm@@QEBAIII@Z @ 0x1800C578C
 * Callers:
        ...
        const GUID *a3)
{
  ...
  unsigned int v43; // [rsp+138h] [rbp+38h] BYREF
  ...
  if ( (unsigned int)dword_18012A220 > 5 )
  {
    ...
    v38 = 1;
    v41 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_18012A220, &unk_1800FAC44, a3, (LPCGUID)v4, 0xCu, &pData);
    LODWORD(v4) = v10;
  }
