/*
 * XREFs of ?SetAt@?$CAtlMap@PEAUISaDeviceProxy@@VCEndpointResourcePool@Sarm@@V?$CElementTraits@PEAUISaDeviceProxy@@@ATL@@V?$CElementTraits@VCEndpointResourcePool@Sarm@@@5@@ATL@@QEAAPEAU__POSITION@@AEBQEAUISaDeviceProxy@@AEBVCEndpointResourcePool@Sarm@@@Z @ 0x1800C4540
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( Node )
  {
    ...
    *(_DWORD *)(Node + 20) = *(_DWORD *)(a3 + 12);
    std::shared_ptr<Sarm::CEndpointResourcePool::Pool>::operator=(Node + 24, (__int64 *)(a3 + 16));
  }
  else
  {
    ...
    try
    {
      ...
      *(_DWORD *)(v8 + 20) = *(_DWORD *)(a3 + 12);
      std::shared_ptr<Sarm::CEndpointResourcePool::Pool>::operator=(v8 + 24, (__int64 *)(a3 + 16));
    }
    catch ( ... )
    {
