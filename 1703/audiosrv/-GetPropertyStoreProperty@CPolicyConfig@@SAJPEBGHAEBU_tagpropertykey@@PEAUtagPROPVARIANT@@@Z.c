/*
 * XREFs of ?GetPropertyStoreProperty@CPolicyConfig@@SAJPEBGHAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x18009C794
 * Callers:
        ...
        struct tagPROPVARIANT *a4)
{
  ...
  {
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyStoreProperty", 4567, PropertyStoreProperty);
  }
  if ( v9[0] )
