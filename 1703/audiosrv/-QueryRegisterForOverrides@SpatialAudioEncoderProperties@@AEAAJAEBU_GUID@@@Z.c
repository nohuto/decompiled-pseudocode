/*
 * XREFs of ?QueryRegisterForOverrides@SpatialAudioEncoderProperties@@AEAAJAEBU_GUID@@@Z @ 0x1800CB83C
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  {
    *(_DWORD *)Data = *((unsigned __int16 *)this + 58);
    cbData = 4;
    RegQueryValueExW(hKey, L"MaxDynamicObjectCount", 0LL, 0LL, Data, &cbData);
    v8 = hKey;
    *((_WORD *)this + 58) = *(_WORD *)Data;
    *(_DWORD *)Data = *((_DWORD *)this + 27);
    cbData = 4;
    ...
    *(_DWORD *)Data = 116;
    ...
    if ( cbData == 116 )
      RegQueryValueExW(hKey, L"ProjectionData", 0LL, 0LL, (LPBYTE)this + 118, &cbData);
  }
  return 0LL;
}
