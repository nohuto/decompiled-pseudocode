/*
 * XREFs of ?QueryInterface@?$RuntimeClass@U?$InterfaceList@UIDeviceGraphStore@@VNil@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$01@34@$00$0A@$0A@@Details@WRL@Microsoft@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800A6D80
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    IsEqualGUID = InlineIsEqualGUID(v3, &GUID_710cfcec_379b_4172_8c25_f7aaf06573c4);
    if ( IsEqualGUID )
      *v7 = v8;
