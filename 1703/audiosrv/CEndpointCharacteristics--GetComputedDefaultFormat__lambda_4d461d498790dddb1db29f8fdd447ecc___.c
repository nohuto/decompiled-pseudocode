/*
 * XREFs of CEndpointCharacteristics::GetComputedDefaultFormat__lambda_4d461d498790dddb1db29f8fdd447ecc___ @ 0x1800BAB88
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::GetComputedDefaultFormat__lambda_4d461d498790dddb1db29f8fdd447ecc___(
        __int64 a1,
        int a2,
        __int128 *a3,
...
{
  GUID fmtid; // xmm0
  int FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a; // edi
  __int64 v9; // rcx
  __int64 v10; // rdi
  char *v11; // rbx
  void *v12; // rcx
  ...
  *(_QWORD *)v32.Data4 = 0x67257A6871B668BCLL;
  ...
  v32 = fmtid;
  FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = (*(__int64 (__fastcall **)(_QWORD, GUID *, PROPVARIANT *))(**(_QWORD **)(a1 + 32) + 40LL))(
                                                                            *(_QWORD *)(a1 + 32),
                                                                            &v34,
                                                                            &pvar);
  if ( FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a < 0 )
    goto LABEL_30;
  FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = (*(__int64 (__fastcall **)(_QWORD, GUID *, PROPVARIANT *))(**(_QWORD **)(a1 + 32) + 40LL))(
                                                                            *(_QWORD *)(a1 + 32),
                                                                            &v32,
  ...
  if ( FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a < 0 )
    goto LABEL_30;
  FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = CoCreateInstance(
  ...
  if ( FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a < 0 )
    goto LABEL_30;
  FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = (*(__int64 (__fastcall **)(LPVOID, __int64, __int64 *))(*(_QWORD *)ppv + 40LL))(
                                                                            ppv,
                                                                            v25,
                                                                            &v20);
  if ( FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a < 0 )
    goto LABEL_30;
  FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = (*(__int64 (__fastcall **)(__int64, GUID *, __int64, _QWORD, __int64 *))(*(_QWORD *)v20 + 24LL))(
                                                                            v20,
  ...
  if ( FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a < 0 )
    goto LABEL_30;
  FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)v19 + 56LL))(
                                                                            v19,
                                                                            (unsigned int)v28,
                                                                            &v17);
  if ( FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a < 0 )
    goto LABEL_30;
  v15 = 0LL;
  FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = (*(__int64 (__fastcall **)(__int64, __int64, GUID *, LPVOID *))(*(_QWORD *)v17 + 104LL))(
                                                                            v17,
                                                                            1LL,
  ...
  if ( (*(int (__fastcall **)(LPVOID, LPVOID *))(*(_QWORD *)v15 + 32LL))(v15, &pv) >= 0 )
  {
    ...
    *(_QWORD *)&v23[48] = *((_QWORD *)a3 + 8);
    FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_4d461d498790dddb1db29f8fdd447ecc___(
                                                                              v9,
                                                                              (__int64)&v22,
                                                                              (unsigned int *)pv,
                                                                              a4);
...
LABEL_11:
  ...
  if ( v15 )
    (*(void (__fastcall **)(LPVOID))(*(_QWORD *)v15 + 16LL))(v15);
  FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = (*(__int64 (__fastcall **)(__int64, __int64, GUID *, __int64 *))(*(_QWORD *)v17 + 104LL))(
                                                                            v17,
                                                                            1LL,
                                                                            &GUID_3cb4a69d_bb6f_4d2b_95b7_452d2c155db5,
                                                                            &v18);
  if ( FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a >= 0 && !*a4 )
  {
    v10 = v18;
    v15 = 0LL;
    ...
    if ( !v15 )
    {
      FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = -2147024882;
      v12 = 0LL;
LABEL_22:
      CoTaskMemFree(v12);
      goto LABEL_30;
    ...
    *(_QWORD *)&v23[72] = *((_QWORD *)a3 + 8);
    ...
    v31[4] = *(_OWORD *)&v23[48];
    v31[5] = *(_OWORD *)&v23[64];
    FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a___(
                                                                              a1,
                                                                              (__int64)(v11 + 64),
                                                                              v31);
    v12 = v11;
    ...
    if ( *a4 )
      goto LABEL_30;
    v15 = 0LL;
    FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = (*(__int64 (__fastcall **)(__int64, LPVOID *))(*(_QWORD *)v18 + 32LL))(
                                                                              v18,
                                                                              &v15);
    if ( FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a < 0 )
    {
    ...
    *(_QWORD *)&v23[48] = *((_QWORD *)a3 + 8);
    ...
    CoTaskMemFree(v15);
    if ( !*a4 )
      FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a = -2004287480;
  }
LABEL_30:
  ...
  LogEPCError(
    ...
    5822,
    FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a);
  if ( v19 )
  ...
  return (unsigned int)FirstMatchingPreferredFormat__lambda_8adf4450fafdaef51724fc9dfbdde94a;
}
