/*
 * XREFs of ??1?$CAutoPtrList@UDeviceStateChangedContext@CMonitorManager@@@ATL@@QEAA@XZ @ 0x1800B0F74
 * Callers:
 *     _CMonitorManager::CMonitorManager_::_1_::dtor$5 @ 0x18005C0F0 (_CMonitorManager--CMonitorManager_--_1_--dtor$5.c)
 * Callees:
 *     <none>
 */
