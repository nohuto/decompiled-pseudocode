/*
 * XREFs of ?IndexOf@?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$VectorOptions@PEAUHSTRING__@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@UEAAJPEAUHSTRING__@@PEAIPEAE@Z @ 0x1800D62D0
 * Callers:
 *     <none>
 * Callees:
        ...
        _BYTE *a4)
{
  ...
  *a4 = 0;
  v8 = 0LL;
  v9 = 0LL;
  XWinRT::SerializingLockPolicy::Read(&v17, a1 + 96, &v18);
  v11 = v18;
  if ( v18 >= 0 )
  {
    if ( *(_DWORD *)(a1 + 72) )
    {
      v12 = 8LL * *(unsigned int *)(a1 + 64);
      if ( !is_mul_ok(*(unsigned int *)(a1 + 64), 8uLL) )
        v12 = -1LL;
      ...
      if ( v8 )
      {
        ...
        {
          v11 = WindowsDuplicateString(*(HSTRING *)(*(_QWORD *)(a1 + 80) + 8 * i), &v8[i]);
          if ( v11 < 0 )
            break;
