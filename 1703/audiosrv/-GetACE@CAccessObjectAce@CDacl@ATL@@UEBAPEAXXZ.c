/*
 * XREFs of ?GetACE@CAccessObjectAce@CDacl@ATL@@UEBAPEAXXZ @ 0x18009C240
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !*((_QWORD *)this + 17) )
  {
    ...
    *((_DWORD *)v4 + 1) = v6;
    ...
    if ( LengthSid )
    {
      if ( !v5 )
        goto LABEL_15;
      if ( this == (ATL::CDacl::CAccessObjectAce *)-16LL || v17 < LengthSid )
      {
        memset(v5, 0, v5 - v4);
        if ( this != (ATL::CDacl::CAccessObjectAce *)-16LL )
        {
          if ( v17 >= v16 )
            goto LABEL_25;
          *(_DWORD *)_o__errno(v13, v12, v14, v15) = 34;
LABEL_24:
...
LABEL_15:
        *(_DWORD *)_o__errno(v13, v12, v14, v15) = 22;
        goto LABEL_24;
      }
