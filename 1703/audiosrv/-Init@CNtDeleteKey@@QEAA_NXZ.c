/*
 * XREFs of ?Init@CNtDeleteKey@@QEAA_NXZ @ 0x18009C9F0
 * Callers:
...
bool __fastcall CNtDeleteKey::Init(CNtDeleteKey *this)
{
  ...
  else
  {
    ...
    if ( Library )
    {
      qword_18012C580 = (__int64 (__fastcall *)(_QWORD))GetProcAddress(Library, "NtDeleteKey");
      LOBYTE(Library) = qword_18012C580 != 0LL;
    }
  }
  return (char)Library;
}
