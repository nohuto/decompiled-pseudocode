/*
 * XREFs of ?wil_details_RecordUsageInPropertyCache@@YA?AUwil_details_RecordUsageResult@@PEATwil_details_FeaturePropertyCache@@W4wil_details_ServiceReportingKind@@II@Z @ 0x180029074
 * Callers:
        ...
        unsigned int a5)
{
  ...
  __int64 (__fastcall *v11)(signed __int32 *, void *); // rdx
...
LABEL_23:
  ...
  v11 = (__int64 (__fastcall *)(signed __int32 *, void *))wil_details_SetPropertyCacheUsageCallback;
  v20 = a5;
  v18 = a1;
  v19 = a3;
  if ( (a3 & 0xFFFFFFFB) != 0 )
    v11 = (__int64 (__fastcall *)(signed __int32 *, void *))wil_details_SetPropertyCacheOpportunityCallback;
  LOBYTE(v5) = wil_details_ModifyFeatureData((union wil_details_FeaturePropertyCache *)a2, v11, &v18) == 0;
LABEL_13:
  *(_DWORD *)(a1 + 16) = v5;
  return a1;
}
