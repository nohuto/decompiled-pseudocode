/*
 * XREFs of ?GetHidCollectionsInContainer@@YAJU_GUID@@PEAV?$CAtlList@PEAGV?$CElementTraits@PEAG@ATL@@@ATL@@@Z @ 0x180082B08
 * Callers:
...
__int64 __fastcall GetHidCollectionsInContainer(__int64 a1, __int64 a2)
{
  ...
  *(_QWORD *)&v10[32] = 0LL;
  *(DEVPROPKEY *)&v10[8] = DEVPKEY_Device_ContainerId;
