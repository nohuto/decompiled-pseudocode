/*
 * XREFs of ??0CDeviceGraphStore@@QEAA@XZ @ 0x180037E50
 * Callers:
...
CDeviceGraphStore *__fastcall CDeviceGraphStore::CDeviceGraphStore(CDeviceGraphStore *this)
{
  ...
  *((_QWORD *)this + 7) = 0LL;
  *((_QWORD *)this + 8) = 0LL;
  *((_QWORD *)this + 7) = std::_Tree_comp_alloc<std::_Tmap_traits<std::wstring,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,Microsoft::WRL::ComPtr<IDeviceGraphObjectsStore>>>,0>>::_Buyheadnode(v2);
  return this;
}
