/*
 * XREFs of ?Initialize@CVolumeSoftware@@UEAAJPEAUIMMDevice@@@Z @ 0x180085430
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IMMDevice *a2)
{
  ...
  if ( PolicyConfig < 0 )
LABEL_13:
    AudSrvTraceLoggingErrorHelper("CVolumeSoftware::Initialize", 1960, PolicyConfig);
  if ( v10 )
