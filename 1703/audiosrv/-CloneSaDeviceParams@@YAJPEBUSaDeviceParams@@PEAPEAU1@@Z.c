/*
 * XREFs of ?CloneSaDeviceParams@@YAJPEBUSaDeviceParams@@PEAPEAU1@@Z @ 0x180012790
 * Callers:
          ...
          if ( v8 )
          {
            ...
            **((_WORD **)&v3 + 1) = 0;
            ...
            if ( v11 >= 0 && v16 > 1 && 2 * v16 > 2 )
              memset((void *)(v9 + 2 * (v12 + 1)), 0, 2 * v16 - 2);
          }
          goto LABEL_20;
        }
        if ( v7 != -1LL )
