/*
 * XREFs of ?GetVpoContext@CProcessSubmixProxy@@UEAAJPEAPEAUIVpoContext@@@Z @ 0x1800A6410
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcessSubmixProxy::GetVpoContext(CProcessSubmixProxy *this, struct IVpoContext **a2)
{
  ...
  if ( v4 >= 0 )
  {
    v15 = 0LL;
    v6 = *((_QWORD *)this + 19);
    wil::com_ptr_t<ISaDeviceProxy,wil::err_returncode_policy>::reset(&v15);
    v7 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v6 + 208LL))(v6, &v15);
    v5 = v7;
    if ( v7 < 0 )
    {
...
LABEL_13:
  wil::com_ptr_t<IAudioSessionInfo,wil::err_returncode_policy>::~com_ptr_t<IAudioSessionInfo,wil::err_returncode_policy>((__int64 *)&ppv);
  return v5;
}
