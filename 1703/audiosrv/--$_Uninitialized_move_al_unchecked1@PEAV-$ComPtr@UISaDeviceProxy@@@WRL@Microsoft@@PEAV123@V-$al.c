...
__int64 *__fastcall std::_Uninitialized_move_al_unchecked1<Microsoft::WRL::ComPtr<ISaDeviceProxy> *,Microsoft::WRL::ComPtr<ISaDeviceProxy> *,std::allocator<Microsoft::WRL::ComPtr<ISaDeviceProxy>>>(
        __int64 *a1,
        __int64 *a2,
        __int64 *a3)
{
