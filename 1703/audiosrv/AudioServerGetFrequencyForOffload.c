/*
 * XREFs of AudioServerGetFrequencyForOffload @ 0x1800A2B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetFrequencyForOffload(_OWORD *a1, __int64 a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_OWORD *, __int64))(*(_QWORD *)a1 + 112LL))(a1, a2);
  v5 = v4;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetFrequencyForOffload", 3473, v4);
