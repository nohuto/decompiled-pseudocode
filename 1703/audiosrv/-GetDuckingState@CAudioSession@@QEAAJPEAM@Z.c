/*
 * XREFs of ?GetDuckingState@CAudioSession@@QEAAJPEAM@Z @ 0x18008C050
 * Callers:
 *     ?GetDuckingState@CServerAudioSessionControl@@UEAAJPEAM@Z @ 0x180091020 (-GetDuckingState@CServerAudioSessionControl@@UEAAJPEAM@Z.c)
 * Callees:
 ...
 *     WPP_SF_qSg @ 0x180090B50 (WPP_SF_qSg.c)
 */
...
__int64 __fastcall CAudioSession::GetDuckingState(CAudioSession *this, float *a2)
{
  ...
  {
    v10 = v4;
    WPP_SF_qSg(*((_QWORD *)WPP_GLOBAL_Control + 2), v5, v6, (_DWORD)this, *((_QWORD *)this + 108), SLOBYTE(v10));
  }
  *a2 = v4;
  if ( v12 )
