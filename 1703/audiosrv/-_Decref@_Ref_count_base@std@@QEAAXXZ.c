/*
 * XREFs of ?_Decref@_Ref_count_base@std@@QEAAXXZ @ 0x18002AA50
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__Sarm::CEndpointResourcePool::s_sharedPool___0 @ 0x18005C8D0 (_dynamic_atexit_destructor_for__Sarm--CEndpointResourcePool--s_sharedPool___0.c)
 ...
 *     ?_Destroy@?$_Ref_count_obj@VSystemEffectChainDescriptor@@@std@@EEAAXXZ @ 0x1800C1380 (-_Destroy@-$_Ref_count_obj@VSystemEffectChainDescriptor@@@std@@EEAAXXZ.c)
 *     ??1CEndpointResourcePool@Sarm@@QEAA@XZ @ 0x1800C1D54 (--1CEndpointResourcePool@Sarm@@QEAA@XZ.c)
 ...
 *     ?FreeNode@?$CAtlMap@PEAUISaDeviceProxy@@VCEndpointResourcePool@Sarm@@V?$CElementTraits@PEAUISaDeviceProxy@@@ATL@@V?$CElementTraits@VCEndpointResourcePool@Sarm@@@5@@ATL@@AEAAXPEAVCNode@12@@Z @ 0x1800C2A38 (-FreeNode@-$CAtlMap@PEAUISaDeviceProxy@@VCEndpointResourcePool@Sarm@@V-$CElementTraits@PEAUISaDe.c)
