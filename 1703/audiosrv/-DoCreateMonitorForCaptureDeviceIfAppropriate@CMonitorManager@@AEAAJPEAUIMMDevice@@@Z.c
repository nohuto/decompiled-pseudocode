/*
 * XREFs of ?DoCreateMonitorForCaptureDeviceIfAppropriate@CMonitorManager@@AEAAJPEAUIMMDevice@@@Z @ 0x1800B1CD4
 * Callers:
 *     ?CreateMonitorIfAppropriateWorker@CMonitorManager@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WORK@@@Z @ 0x1800B1CB0 (-CreateMonitorIfAppropriateWorker@CMonitorManager@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WOR.c)
 * Callees:
        ...
        struct IMMDevice *a2)
{
  ...
  if ( CMonitor::IsCaptureMonitorEnabled(a2, &v12, &v19) )
  {
    ...
    if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control )
    {
      ...
      if ( v6 != (CVolumeStrip *)&WPP_GLOBAL_Control
