/*
 * XREFs of ?GetVolumeRange@CVolumeStrip@@UEAAJIPEAM00@Z @ 0x180017D70
 * Callers:
...
__int64 __fastcall CVolumeStrip::GetVolumeRange(CVolumeStrip *this, __int64 a2, float *a3, float *a4, float *a5)
{
  ...
  v6 = *(__int64 (__fastcall **)(CVolumeControlBase *, unsigned int, float *, float *, float *))(*(_QWORD *)v5 + 152LL);
