/*
 * XREFs of ?Release@CUnknown@@UEAAKXZ @ 0x18007A9E0
 * Callers:
 ...
 *     ?Release@CPerEndpointVolumeAudioSession@@EEAAKXZ @ 0x18008EE90 (-Release@CPerEndpointVolumeAudioSession@@EEAAKXZ.c)
 * Callees:
