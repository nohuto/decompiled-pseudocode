/*
 * XREFs of ?GetDictionaryMetadataFormatId@SpatialAudioMetadataDictionaryData@@UEAAJPEAU_GUID@@@Z @ 0x1800CC3E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID *a2)
{
  ...
  v4 = 0;
  Microsoft::WRL::Wrappers::CriticalSection::Lock((__int64)this[2].Data4, (__int64)&lpCriticalSection);
