/*
 * XREFs of ??$AsWeak@UIStreamGroupProxy@@@WRL@Microsoft@@YAJPEAUIStreamGroupProxy@@PEAVWeakRef@01@@Z @ 0x18002B320
 * Callers:
        ...
        __int64 *a2)
{
  ...
  __int64 v11; // rcx
  volatile signed __int32 *v13; // [rsp+30h] [rbp+10h] BYREF
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( WeakReference >= 0 )
    {
      ...
      *a2 = v8;
      if ( v9 )
      {
        (*(void (__fastcall **)(__int64, volatile signed __int32 *))(*(_QWORD *)v9 + 16LL))(v9, v7);
        v7 = v13;
      }
      v4 = 0;
    }
