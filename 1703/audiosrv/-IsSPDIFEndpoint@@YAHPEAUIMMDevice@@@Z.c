/*
 * XREFs of ?IsSPDIFEndpoint@@YAHPEAUIMMDevice@@@Z @ 0x1800A1268
 * Callers:
...
__int64 __fastcall IsSPDIFEndpoint(struct IMMDevice *a1)
{
  ...
  if ( (_WORD)pvar != 19 )
  {
    v3 = -2147467259;
LABEL_17:
    AudSrvTraceLoggingErrorHelper("IsSPDIFEndpoint", 4753, v3);
    goto LABEL_18;
  }
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x49u, (__int64)&WPP_6a2f5d392ebc3a7b5b56686ced9a2fbc_Traceguids);
  }
  ...
  if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x4Au, (__int64)&WPP_6a2f5d392ebc3a7b5b56686ced9a2fbc_Traceguids, v4);
  }
  if ( v5 )
LABEL_16:
    v2 = 1;
