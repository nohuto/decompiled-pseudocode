/*
 * XREFs of ?ConfigureDolbyAtmosHeadphonesEncoder@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x1800C81F4
 * Callers:
              ...
              if ( MetadataDictionaryData >= 0 )
              {
                ...
                if ( MetadataDictionaryData >= 0 )
                {
                  ...
                  if ( MetadataDictionaryData < 0 && (unsigned int)dword_18012A260 > 2 )
                  {
                    ...
                    v38 = &v30;
                    v39 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&dword_18012A260, &unk_1800FBA44, v27, v28, 5u, &pData);
                  }
                }
                else if ( (unsigned int)dword_18012A260 > 2 )
                {
                  ...
                  v38 = &v30;
                  v39 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_18012A260, &unk_1800FBA44, v25, v26, 5u, &pData);
                }
              }
              else if ( (unsigned int)dword_18012A260 > 2 )
              {
