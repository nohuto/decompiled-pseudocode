/*
 * XREFs of _CDeviceGraphStore::GetStreamGroups_::_1_::catch$104 @ 0x1800A8E8A
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetStreamGroups_::_1_::catch_104(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
