/*
 * XREFs of ?get_AudioSession@CVADServer@@UEAAJPEAPEAVCServerAudioSessionControl@@@Z @ 0x18001C8A0
 * Callers:
  ...
  if ( *((_DWORD *)this + 46) )
  {
    ...
    if ( !*((_QWORD *)this + 20) )
    {
      ...
      if ( v2 )
      {
        ...
        {
          WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 30LL, &WPP_6a2f5d392ebc3a7b5b56686ced9a2fbc_Traceguids, v2);
        }
        goto LABEL_24;
      }
      if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 29LL, &WPP_6a2f5d392ebc3a7b5b56686ced9a2fbc_Traceguids, *v6);
      }
    }
...
LABEL_24:
    if ( (v2 & 0x80000000) == 0 )
      return v2;
LABEL_25:
    AudSrvTraceLoggingErrorHelper("CVADServer::get_AudioSession", 0x49Eu, v2);
    return v2;
  }
  if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
    && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x100) != 0
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 28LL, &WPP_6a2f5d392ebc3a7b5b56686ced9a2fbc_Traceguids);
  }
  return 2290679809LL;
}
