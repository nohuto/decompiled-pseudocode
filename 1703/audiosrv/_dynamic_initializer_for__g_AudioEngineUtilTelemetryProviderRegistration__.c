/*
 * XREFs of _dynamic_initializer_for__g_AudioEngineUtilTelemetryProviderRegistration__ @ 0x1800012E0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_AudioEngineUtilTelemetryProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_18012A2A0, a2, a3);
