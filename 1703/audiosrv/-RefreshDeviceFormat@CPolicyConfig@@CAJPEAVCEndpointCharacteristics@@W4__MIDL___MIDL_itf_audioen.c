/*
 * XREFs of ?RefreshDeviceFormat@CPolicyConfig@@CAJPEAVCEndpointCharacteristics@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x18009D248
 * Callers:
        ...
        enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001 a2)
{
  ...
  struct IUnknown *v18; // [rsp+50h] [rbp-41h] BYREF
  LPVOID pv[2]; // [rsp+58h] [rbp-39h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+68h] [rbp-29h] BYREF
  struct _EVENT_DATA_DESCRIPTOR pDesc; // [rsp+88h] [rbp-9h] BYREF
  struct IUnknown **v22; // [rsp+98h] [rbp+7h]
        ...
        + 1) > 4u )
  {
    ...
    v22 = &v18;
    v23 = cData;
    TlgWrite(v8, &unk_1800F91D1, v6, v7, cData, &pData);
  }
  v9 = this[2];
  v18 = v9;
  ...
  if ( v17 != v9 )
  {
    ATL::AtlComQIPtrAssign(&v17, v9, &GUID_eecca8a7_a629_4dba_9f23_20f6db42d990);
    v10 = v17;
  }
  if ( v10 )
  {
