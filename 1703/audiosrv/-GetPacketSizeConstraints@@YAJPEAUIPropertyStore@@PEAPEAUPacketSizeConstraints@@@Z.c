/*
 * XREFs of ?GetPacketSizeConstraints@@YAJPEAUIPropertyStore@@PEAPEAUPacketSizeConstraints@@@Z @ 0x1800BD668
 * Callers:
...
__int64 __fastcall GetPacketSizeConstraints(struct IPropertyStore *a1, LPVOID **a2)
{
  ...
  Size = 0LL;
  Src = 0LL;
  if ( dword_18012C7A8 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18012C7A8);
    if ( dword_18012C7A8 == -1 )
    {
      xmmword_18012C698 = DEVPKEY_KsAudio_PacketSize_Constraints2;
      dword_18012C6A8 = 2;
      xmmword_18012C6AC = DEVPKEY_KsAudio_PacketSize_Constraints;
      dword_18012C6BC = 2;
      Init_thread_footer(&dword_18012C7A8);
    }
  }
  v6 = &xmmword_18012C698;
  while ( 1 )
  {
    v21 = 0LL;
