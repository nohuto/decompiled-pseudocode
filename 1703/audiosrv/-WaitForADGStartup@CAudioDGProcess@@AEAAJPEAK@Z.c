/*
 * XREFs of ?WaitForADGStartup@CAudioDGProcess@@AEAAJPEAK@Z @ 0x180017808
 * Callers:
...
unsigned int __fastcall CAudioDGProcess::WaitForADGStartup(CAudioDGProcess *this, unsigned int *a2)
{
  ...
  HANDLE Handles[3]; // [rsp+38h] [rbp-41h] BYREF
  ...
  if ( v3 )
  {
    ...
    if ( !GetExitCodeProcess(*((HANDLE *)this + 11), a2) )
    {
      ...
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 21LL, &WPP_f5e0f8228e953c2ec26d9246ffcc9fec_Traceguids, result);
LABEL_12:
        v7 = WPP_GLOBAL_Control;
        result = v10;
      }
LABEL_13:
    ...
    if ( *a2 != -1073740760 )
    {
      if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 22LL, &WPP_f5e0f8228e953c2ec26d9246ffcc9fec_Traceguids, *a2);
        v7 = WPP_GLOBAL_Control;
      }
      result = *a2;
      if ( (int)*a2 > 0 )
...
LABEL_25:
  if ( v7 != (CVolumeStrip *)&WPP_GLOBAL_Control && (*((_BYTE *)v7 + 28) & 4) != 0 && *((_BYTE *)v7 + 25) >= 2u )
  {
    WPP_SF_d(*((_QWORD *)v7 + 2), 23LL, &WPP_f5e0f8228e953c2ec26d9246ffcc9fec_Traceguids, result);
    result = v10;
  }
  if ( (unsigned int)dword_18012A2A0 > 2 )
  {
    ...
    v16 = 4;
    v19 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_18012A2A0, &unk_1800FBB26, v8, v9, 5u, &pData);
    return v10;
  }
  return result;
}
