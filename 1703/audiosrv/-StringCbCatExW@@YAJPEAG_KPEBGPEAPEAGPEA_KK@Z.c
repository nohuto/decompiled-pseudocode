/*
 * XREFs of ?StringCbCatExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x18002DE88
 * Callers:
 *     ?LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z @ 0x180017938 (-LaunchADGProcess@CAudioDGProcess@@AEAAJ_N@Z.c)
 * Callees:
 *     StringCopyWorkerW @ 0x18002DF40 (StringCopyWorkerW.c)
 *     StringLengthWorkerW @ 0x18002DFAC (StringLengthWorkerW.c)
 */
