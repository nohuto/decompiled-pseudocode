/*
 * XREFs of ?LoadPropertyStore@CAudioSessionStore@@AEAAJXZ @ 0x1800312B0
 * Callers:
...
LABEL_92:
        ...
        case 0x2004:
          ...
          {
            WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 53LL, &WPP_063b73282fa230620b2f84334c1c051f_Traceguids);
            v20 = WPP_GLOBAL_Control;
          }
          v21 = cbData - 24;
          v22 = ((unsigned __int64)cbData - 24) >> 2;
          if ( v20 != (CVolumeStrip *)&WPP_GLOBAL_Control
            && (*((_BYTE *)v20 + 28) & 8) != 0
            && *((_BYTE *)v20 + 25) >= 4u )
          {
            WPP_SF_q(*((_QWORD *)v20 + 2), 54LL, &WPP_063b73282fa230620b2f84334c1c051f_Traceguids, cbData - 24LL);
            v20 = WPP_GLOBAL_Control;
          }
          if ( (v21 & 3) != 0 )
          {
            if ( v20 != (CVolumeStrip *)&WPP_GLOBAL_Control
              ...
              && *((_BYTE *)v20 + 25) >= 4u )
            {
              WPP_SF_(*((_QWORD *)v20 + 2), 55LL, &WPP_063b73282fa230620b2f84334c1c051f_Traceguids);
            }
LABEL_55:
            v2 = this;
            break;
...
LABEL_59:
            if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
              ...
              && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
            {
              WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 56LL, &WPP_063b73282fa230620b2f84334c1c051f_Traceguids);
            }
            goto LABEL_72;
          }
...
LABEL_78:
          ...
          if ( v3 )
          {
            if ( v28 != (CVolumeStrip *)&WPP_GLOBAL_Control
              && (*((_BYTE *)v28 + 28) & 8) != 0
              && *((_BYTE *)v28 + 25) >= 4u )
            {
              WPP_SF_d(*((_QWORD *)v28 + 2), 59LL, &WPP_063b73282fa230620b2f84334c1c051f_Traceguids, (unsigned int)v3);
            }
LABEL_72:
