/*
 * XREFs of ?CreateStream@CSharedStreamGroupProxy@@UEAAJPEAUIAudioStreamInfo@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1800A5880
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  v9 = (*(__int64 (__fastcall **)(_QWORD, struct SYSTEM_AUDIO_STREAM_DESCRIPTOR *, struct IAudioGraphCallback *, struct SYSTEM_AUDIO_STREAM *))(**((_QWORD **)this + 9) + 24LL))(
         *((_QWORD *)this + 9),
         a3,
         a4,
         a5);
  ...
  *((_QWORD *)a5 + 8) = (unsigned __int64)this & -(__int64)(this != (CSharedStreamGroupProxy *)8);
  ...
  {
    v13 = v12;
    v12 = _InterlockedCompareExchange64((volatile signed __int64 *)this + 29, v12 + 1, v12);
    if ( v13 == v12 )
      goto LABEL_11;
  }
