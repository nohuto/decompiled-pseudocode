/*
 * XREFs of ?DeviceRemovalEvent@CAudioSrv@@UEAAJV?$CHeapPtr@U_DEV_BROADCAST_DEVICEINTERFACE_W@@VCCRTAllocator@ATL@@@ATL@@@Z @ 0x180080AE0
 * Callers:
 *     <none>
 * Callees:
 *     ?MME_AudioInterfaceRemove@@YAJPEBG@Z @ 0x1800B01E8 (-MME_AudioInterfaceRemove@@YAJPEBG@Z.c)
