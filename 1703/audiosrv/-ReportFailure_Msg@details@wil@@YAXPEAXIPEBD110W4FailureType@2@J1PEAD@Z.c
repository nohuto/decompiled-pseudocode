/*
 * XREFs of ?ReportFailure_Msg@details@wil@@YAXPEAXIPEBD110W4FailureType@2@J1PEAD@Z @ 0x1800C658C
 * Callers:
        ...
        char *a10)
{
  ...
  wil::details::ReportFailure(a1, a2, a3, 0LL, 0LL, a6, 3, 0x8000FFFF, v13, 0);
}
