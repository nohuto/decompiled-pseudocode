/*
 * XREFs of ?GetEncoderStaticObjectPositionAndVolume@SpatialAudioEncoderProperties@@UEAAJW4AudioObjectType@@PEAM111@Z @ 0x1800CB2B0
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a6)
{
  ...
  if ( *(double *)&lpCriticalSection != 0.0 )
  ...
  *(double *)&lpCriticalSection = (double)(a2 | 1);
  *(_DWORD *)a3 = *(_OWORD *)(v11 + 16LL * (unsigned int)((HIDWORD(lpCriticalSection) >> 20) - 1024));
  *a4 = *(float *)(*((_QWORD *)this + 5)
                 + 16LL * (((unsigned int)HIDWORD(COERCE_UNSIGNED_INT64((double)(a2 | 1))) >> 20) - 1024)
                 + 4);
  *a5 = *(float *)(*((_QWORD *)this + 5)
                 + 16LL * (((unsigned int)HIDWORD(COERCE_UNSIGNED_INT64((double)(a2 | 1))) >> 20) - 1024)
                 + 8);
  if ( a6 )
    *a6 = *(float *)(*((_QWORD *)this + 5)
                   + 16LL * (((unsigned int)HIDWORD(COERCE_UNSIGNED_INT64((double)(a2 | 1))) >> 20) - 1024)
                   + 12);
  return v10;
}
