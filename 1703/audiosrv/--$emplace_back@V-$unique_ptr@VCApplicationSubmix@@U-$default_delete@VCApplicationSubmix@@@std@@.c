...
__int64 __fastcall std::vector<std::unique_ptr<CApplicationSubmix>>::emplace_back<std::unique_ptr<CApplicationSubmix>>(
        unsigned __int64 *a1,
        __int64 *a2)
{
  __int64 result; // rax
  ...
  CApplicationSubmix **v10; // rax
  CApplicationSubmix **v11; // r15
  __int64 *v12; // rax
  __int64 v13; // rcx
  __int64 v14; // rcx
  CApplicationSubmix **v15; // [rsp+80h] [rbp+18h]
  ...
  if ( (__int64 *)result == v5 )
  {
    ...
    v10 = (CApplicationSubmix **)std::_Allocate(v9, 8uLL);
    v11 = v10;
    v15 = v10;
    try
    {
      ...
      std::_Uninitialized_move_al_unchecked1<std::unique_ptr<CApplicationSubmix> *,std::unique_ptr<CApplicationSubmix> *,std::allocator<std::unique_ptr<CApplicationSubmix>>>(
        *a1,
        a1[1],
        v11);
    }
    ...
    return std::vector<std::unique_ptr<CApplicationSubmix>>::_Change_array(a1, v11, v6 + 1, v9);
  }
  else
  {
    if ( v5 )
