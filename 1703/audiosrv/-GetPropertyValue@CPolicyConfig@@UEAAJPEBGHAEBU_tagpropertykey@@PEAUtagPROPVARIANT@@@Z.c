/*
 * XREFs of ?GetPropertyValue@CPolicyConfig@@UEAAJPEBGHAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x18009C850
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyValue", 4020, PropertyStoreProperty);
    goto LABEL_7;
  }
