/*
 * XREFs of ?GetDictionaryDataLength@SpatialAudioMetadataDictionaryData@@UEAAJPEAI@Z @ 0x1800CC200
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  else
  {
    ...
    {
      TlgCreateSz(&pDesc, "SpatialAudioMetadataDictionaryData::GetDictionaryDataLength");
      v8 = 181;
      v12 = &v8;
