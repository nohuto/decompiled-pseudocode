/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_4d461d498790dddb1db29f8fdd447ecc___ @ 0x1800B9920
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_4d461d498790dddb1db29f8fdd447ecc___(
        __int64 a1,
        __int64 a2,
        unsigned int *a3,
      ...
      if ( !v9 && *a3 > 0x40 )
      {
        ...
        if ( v10 <= 0x28 )
        {
          ...
          if ( _bittest64(&v11, v10) )
          {
            ...
            {
              v16[0] = 0;
              lambda_0a80d7e3d12d42377e48064cdd362aeb_::operator()(a2, v12, v16);
              if ( v16[0] )
