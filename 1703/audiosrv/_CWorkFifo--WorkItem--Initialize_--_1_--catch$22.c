/*
 * XREFs of _CWorkFifo::WorkItem::Initialize_::_1_::catch$22 @ 0x1800C321A
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CWorkFifo::WorkItem::Initialize_::_1_::catch_22(__int64 a1, __int64 a2)
{
