/*
 * XREFs of ?KsNotifications_AudioInterfaceArrival@@YAXPEBG@Z @ 0x1800C16D4
 * Callers:
 *     ?DeviceArrivalEvent@CAudioSrv@@UEAAJV?$CHeapPtr@U_DEV_BROADCAST_DEVICEINTERFACE_W@@VCCRTAllocator@ATL@@@ATL@@@Z @ 0x180080A30 (-DeviceArrivalEvent@CAudioSrv@@UEAAJV-$CHeapPtr@U_DEV_BROADCAST_DEVICEINTERFACE_W@@VCCRTAllocato.c)
 * Callees:
...
void __fastcall KsNotifications_AudioInterfaceArrival(const unsigned __int16 *a1)
{
  ...
  if ( !v7 )
    goto LABEL_12;
  if ( (*(int (__fastcall **)(__int64, const unsigned __int16 *, struct IUnknown **))(*(_QWORD *)v7 + 40LL))(v7, a1, v5) >= 0 )
  {
    v2 = v6;
    if ( v6 != v5[0] )
    {
