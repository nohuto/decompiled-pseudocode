/*
 * XREFs of ??_GPropertyChangedContext@@QEAAPEAXI@Z @ 0x1800B1690
 * Callers:
 ...
 *     ??1?$CAutoPtr@UPropertyChangedContext@@@ATL@@QEAA@XZ @ 0x1800B1490 (--1-$CAutoPtr@UPropertyChangedContext@@@ATL@@QEAA@XZ.c)
