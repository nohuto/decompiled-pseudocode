/*
 * XREFs of ?UpdateMasterVolumeLevel@CVolumeHardware@@MEAAJXZ @ 0x180087280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_Pg @ 0x180087794 (WPP_SF_Pg.c)
 */
...
__int64 __fastcall CVolumeHardware::UpdateMasterVolumeLevel(CVolumeHardware *this)
{
  ...
  if ( Block )
  {
    if ( *((_QWORD *)this + 11) )
    {
      ...
      do
      {
        DB = CVolumeUnit::GetDB((CVolumeUnit *)(v6 + *((_QWORD *)this + 10)));
        v3[v2] = DB;
    ...
    v4 = (*(__int64 (__fastcall **)(_QWORD, float *, _QWORD, char *))(**((_QWORD **)this + 31) + 64LL))(
           *((_QWORD *)this + 31),
           v3,
