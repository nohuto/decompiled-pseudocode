/*
 * XREFs of ?InitializeAPORemote@CAPOWrapperSrv@@UEAAJPEBGPEAU_GUID@@U2@HHHPEAU__MIDL___MIDL_itf_audioenginepolicy_0000_0010_0002@@@Z @ 0x1800CE870
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
        if ( (unsigned int)dword_18012A2A0 > 2 )
        {
          ...
          *(_QWORD *)&pData[48] = &v26;
          ...
          v32 = 4;
          TlgWrite(
            (TraceLoggingHProvider)&dword_18012A2A0,
            &unk_1800FBB26,
            v18,
            v19,
            5u,
