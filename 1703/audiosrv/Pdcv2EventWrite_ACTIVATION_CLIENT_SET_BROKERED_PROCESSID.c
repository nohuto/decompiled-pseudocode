/*
 * XREFs of Pdcv2EventWrite_ACTIVATION_CLIENT_SET_BROKERED_PROCESSID @ 0x180028360
 * Callers:
...
void __fastcall Pdcv2EventWrite_ACTIVATION_CLIENT_SET_BROKERED_PROCESSID(__int64 a1, _DWORD *a2, int a3)
{
  int v3; // esi
  const WCHAR *v4; // rbp
  __int64 v5; // rdi
  ...
  if ( (Microsoft_Windows_PDCEnableBits & 0x200000) != 0 )
  {
    ...
    do
      ++v5;
    while ( v13[v5] );
    Template_qqzr1qzr3qqqxqqqpqzr13(
      a3,
      v15,
      v10,
      v5,
