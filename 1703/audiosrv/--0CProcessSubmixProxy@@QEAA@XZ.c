/*
 * XREFs of ??0CProcessSubmixProxy@@QEAA@XZ @ 0x180007C60
 * Callers:
...
CProcessSubmixProxy *__fastcall CProcessSubmixProxy::CProcessSubmixProxy(CProcessSubmixProxy *this)
{
  ...
  *((_QWORD *)this + 5) = 1LL;
  *(_QWORD *)this = &Microsoft::WRL::RuntimeClass<Microsoft::WRL::RuntimeClassFlags<3>,IProcessSubmixProxy,IInspectable,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil>::`vftable'{for `IInspectable'};
