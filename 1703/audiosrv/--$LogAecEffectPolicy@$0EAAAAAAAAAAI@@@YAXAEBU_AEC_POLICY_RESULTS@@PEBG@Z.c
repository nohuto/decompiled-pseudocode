/*
 * XREFs of ??$LogAecEffectPolicy@$0EAAAAAAAAAAI@@@YAXAEBU_AEC_POLICY_RESULTS@@PEBG@Z @ 0x180046900
 * Callers:
...
void LogAecEffectPolicy<70368744177672>()
{
  const WCHAR *v0; // r9
  __int64 v1; // r10
  __int64 v2; // r11
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000008uLL) )
    {
      ...
      v34 = v2;
      v36 = v2;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1800FA59F, v3, v4, 0x11u, &pData);
    }
  }
}
