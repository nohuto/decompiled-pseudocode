/*
 * XREFs of ?GetSubmix@CProcessSubmixProxy@@UEAAJPEAPEAUISubmix@@@Z @ 0x1800A6260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CProcessSubmixProxy::GetSubmix(CProcessSubmixProxy *this, struct ISubmix **a2)
{
  ...
  wil::com_ptr_t<IAudioSessionInfo,wil::err_returncode_policy>::~com_ptr_t<IAudioSessionInfo,wil::err_returncode_policy>((__int64 *)&v9);
  return v5;
}
