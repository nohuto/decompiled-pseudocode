/*
 * XREFs of AudioServerSetChannelVolume @ 0x1800A3990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerSetChannelVolume(_OWORD *a1, unsigned int a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_OWORD *, _QWORD))(*(_QWORD *)a1 + 144LL))(a1, a2);
  v5 = v4;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerSetChannelVolume", 3250, v4);
