/*
 * XREFs of ?GetWatcher@AudioEffectsWatcherFactory@@QEAAJPEBGKHPEAPEAVAudioEffectsWatcher@@@Z @ 0x180088FB4
 * Callers:
        ...
        struct AudioEffectsWatcher **a5)
{
  ...
  *a5 = 0LL;
  ...
  for ( i = (_QWORD *)qword_18012C0E8; i; i = (_QWORD *)*i )
  {
    v10 = i[2];
  ...
  if ( v13 )
  {
    ...
    if ( v11 >= 0 )
    {
      v14 = ATL::CAtlList<unsigned short *,ATL::CElementTraits<unsigned short *>>::NewNode(
              (__int64)&qword_18012C0E8,
              (__int64 *)&v18,
              qword_18012C0F0);
      if ( qword_18012C0F0 )
        *(_QWORD *)qword_18012C0F0 = v14;
      else
        qword_18012C0E8 = (__int64)v14;
      qword_18012C0F0 = (__int64)v14;
      *((_QWORD *)v13 + 10) = v14;
      ++*((_DWORD *)v13 + 18);
      *v8 = v13;
      v13 = 0LL;
