/*
 * XREFs of ??_GSpatialAudioDevicePropertyWriter@@UEAAPEAXI@Z @ 0x1800C9BE0
 * Callers:
 *     <none>
 * Callees:
...
struct _RTL_CRITICAL_SECTION *__fastcall SpatialAudioDevicePropertyWriter::`scalar deleting destructor'(
