/*
 * XREFs of ?GetAcceptableSPDIFTypeForDevice@@YAJPEAUIMMDevice@@PEBUtWAVEFORMATEX@@PEAPEAU2@H@Z @ 0x1800A04EC
 * Callers:
 ...
 *     ?FormatHasSpecifiedSubtype@@YAHPEBUtWAVEFORMATEX@@PEBU_GUID@@@Z @ 0x1800A0478 (-FormatHasSpecifiedSubtype@@YAHPEBUtWAVEFORMATEX@@PEBU_GUID@@@Z.c)
 *     ?SetFormatSubType@@YAHPEAUtWAVEFORMATEX@@PEBU_GUID@@@Z @ 0x1800A1848 (-SetFormatSubType@@YAHPEAUtWAVEFORMATEX@@PEBU_GUID@@@Z.c)
 *     ?SpdifSampleRateFlag@@YAKK@Z @ 0x1800A19A0 (-SpdifSampleRateFlag@@YAKK@Z.c)
 */
        ...
        int a4)
{
  ...
  v11 = v29[2];
  v12 = 16LL * v11;
  if ( v12 > 0xFFFFFFFF || (v13 = v12 + 12, v13 < 0xC) || (_DWORD)v28 != v13 )
  {
    v9 = -2004287467;
    goto LABEL_36;
  }
...
LABEL_36:
  ...
  if ( v8 )
    CoTaskMemFree(v8);
  if ( v9 < 0 )
    AudSrvTraceLoggingErrorHelper("GetAcceptableSPDIFTypeForDevice", 5094, v9);
  if ( v24 )
