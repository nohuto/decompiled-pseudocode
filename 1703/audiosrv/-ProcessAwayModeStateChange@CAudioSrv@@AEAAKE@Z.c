/*
 * XREFs of ?ProcessAwayModeStateChange@CAudioSrv@@AEAAKE@Z @ 0x180080F74
 * Callers:
...
__int64 __fastcall CAudioSrv::ProcessAwayModeStateChange(CAudioSrv *this, unsigned __int8 a2)
{
        ...
        if ( (*(int (__fastcall **)(_QWORD, _QWORD, __int64 *))(*(_QWORD *)v15[0] + 32LL))(v15[0], i, &v21) >= 0 )
        {
          ...
          else
          {
            ...
            if ( (*(int (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v21 + 32LL))(v21, 2LL, &v22) >= 0 )
            {
              ...
              else if ( (*(int (__fastcall **)(__int64, int *))(*(_QWORD *)v13 + 192LL))(v13, &v20) >= 0 )
              {
                ...
                if ( (_BYTE)v2 )
                {
                  ...
                  v10 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v22 + 48LL))(
                          ...
                          &pvar);
                  if ( v10 < 0 )
                    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessAwayModeStateChange", 1434, v10);
                }
                else
                {
                  v8 = ((unsigned int)v17 >> 2) & 1;
                  if ( v9 != (CVolumeStrip *)&WPP_GLOBAL_Control
                    && (*((_BYTE *)v9 + 28) & 0x10) != 0
                    && *((_BYTE *)v9 + 25) >= 4u )
                  {
                    WPP_SF_d(
                ...
                if ( v20 != v8 )
                {
                  v11 = (*(__int64 (__fastcall **)(__int64, _QWORD, void *))(*(_QWORD *)v13 + 184LL))(
                          v13,
                          v8,
                          &EVENTCONTEXT_POWEREVENT);
                  if ( v11 < 0 )
                    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessAwayModeStateChange", 1457, v11);
                }
              }
            }
          }
  ...
  if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x22u, (__int64)&WPP_45152eef543736c8acd7716a7d1bb4fd_Traceguids, v5);
LABEL_47:
    v4 = v15[0];
  }
LABEL_48:
