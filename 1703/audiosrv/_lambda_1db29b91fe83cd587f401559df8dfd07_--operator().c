/*
 * XREFs of _lambda_1db29b91fe83cd587f401559df8dfd07_::operator() @ 0x1800A8524
 * Callers:
 *     std::_Func_impl__lambda_1db29b91fe83cd587f401559df8dfd07__std::allocator_int__bool_ISaDeviceProxy_____ptr64_::_Do_call @ 0x1800A9860 (std--_Func_impl__lambda_1db29b91fe83cd587f401559df8dfd07__std--allocator_int__bool__ea_1800A9860.c)
 * Callees:
 *     __security_check_cookie @ 0x180048BE0 (__security_check_cookie.c)
 *     memcmp_0 @ 0x180057F9A (memcmp_0.c)
 *     _guard_dispatch_icall_nop @ 0x180057FC0 (_guard_dispatch_icall_nop.c)
 *     WPP_SF_qdd @ 0x180090C54 (WPP_SF_qdd.c)
 *     WPP_SF_qDD @ 0x1800A9914 (WPP_SF_qDD.c)
 *     WPP_SF_qdddd @ 0x1800A9974 (WPP_SF_qdddd.c)
 *     WPP_SF_qii @ 0x1800A99F0 (WPP_SF_qii.c)
 */

char __fastcall lambda_1db29b91fe83cd587f401559df8dfd07_::operator()(__int64 *a1, __int64 a2)
{
  __int64 v4; // rbx
  __int64 v5; // rax
  __int64 v6; // rdx
  ...
  if ( v4 == (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a2 + 32LL))(a2) )
  {
    ...
    else
    {
      ...
      {
        v17 = *(_QWORD *)(v16 + 16);
        if ( *(unsigned __int16 *)(v17 + 16) == (unsigned __int64)*(unsigned __int16 *)((*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a2 + 48LL))(a2)
                                                                                      + 16) )
        {
             ...
             && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        ...
        WPP_SF_qdd(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0xCu,
          (__int64)&WPP_c0d3f1d39da7343a6f5ac3fe6f252d19_Traceguids,
          a2,
          v28,
          v29);
      }
