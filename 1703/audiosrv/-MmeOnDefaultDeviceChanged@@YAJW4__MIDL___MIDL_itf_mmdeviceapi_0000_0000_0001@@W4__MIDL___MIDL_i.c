/*
 * XREFs of ?MmeOnDefaultDeviceChanged@@YAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@PEBG@Z @ 0x1800B02EC
 * Callers:
 *     s_mmeNotifyDefaultDeviceChanged @ 0x1800B0580 (s_mmeNotifyDefaultDeviceChanged.c)
 * Callees:
 *     WPP_SF_ddS @ 0x1800B04E0 (WPP_SF_ddS.c)
 */
