/*
 * XREFs of ?GetVpoContext@CBaseStreamGroupProxy@@UEAAJPEAPEAUIVpoContext@@@Z @ 0x1800A6330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBaseStreamGroupProxy::GetVpoContext(CBaseStreamGroupProxy *this, struct IVpoContext **a2)
{
  ...
  if ( v4 < 0 )
    goto LABEL_8;
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64 *))(**((_QWORD **)this + 10) + 56LL))(*((_QWORD *)this + 10), &v10);
  if ( v5 < 0
