/*
 * XREFs of ??1?$_Deque_alloc@U?$_Deque_base_types@V?$shared_ptr@VWorkItem@CWorkFifo@@@std@@V?$allocator@V?$shared_ptr@VWorkItem@CWorkFifo@@@std@@@2@@std@@@std@@QEAA@XZ @ 0x1800C1D04
 * Callers:
 *     _CWorkFifo::CWorkFifo_::_1_::dtor$3 @ 0x18005BA9B (_CWorkFifo--CWorkFifo_--_1_--dtor$3.c)
 * Callees:
