/*
 * XREFs of CEndpointCharacteristics::GetComputedDefaultFormat__lambda_6fb9f0bf803c6c508ee46d3f26d5b6c2___ @ 0x18004BC5C
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::GetComputedDefaultFormat__lambda_6fb9f0bf803c6c508ee46d3f26d5b6c2___(
        __int64 a1,
        __int64 a2,
        __int128 *a3,
...
LABEL_8:
              ...
              if ( (*(int (__fastcall **)(unsigned int *, unsigned int **))(*(_QWORD *)v13 + 32LL))(v13, &v14) >= 0 )
              {
                ...
                Instance = CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_6fb9f0bf803c6c508ee46d3f26d5b6c2___(
                             v8,
                             (__int64)&v20,
                             v14,
                             a4);
...
LABEL_16:
                ...
                *(_OWORD *)&v21.m256i_u64[1] = *a3;
                ...
                v29 = v20;
                v30 = v21;
                Instance = CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_c141487702b332cfbac99d1239064ae6___(
                             a1,
                             (__int64)(v10 + 16),
                             &v29);
                if ( Instance < 0 )
...
LABEL_23:
  ...
  LogEPCError("CEndpointCharacteristics::GetComputedDefaultFormat", 5822, Instance);
