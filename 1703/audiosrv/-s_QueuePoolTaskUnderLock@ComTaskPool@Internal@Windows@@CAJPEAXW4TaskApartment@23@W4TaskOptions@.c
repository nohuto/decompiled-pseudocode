/*
 * XREFs of ?s_QueuePoolTaskUnderLock@ComTaskPool@Internal@Windows@@CAJPEAXW4TaskApartment@23@W4TaskOptions@23@KPEAUIComPoolTask@23@PEAVTaskList@123@PEAPEAVCThread@123@@Z @ 0x1800D85E0
 * Callers:
 ...
 *     ?CheckForDeadlock@CThread@ComTaskPool@Internal@Windows@@QEAAXXZ @ 0x1800D54E8 (-CheckForDeadlock@CThread@ComTaskPool@Internal@Windows@@QEAAXXZ.c)
 ...
 *     ?PushBack@TaskList@ComTaskPool@Internal@Windows@@QEAAJ$$QEAUTaskData@234@@Z @ 0x1800D6AC8 (-PushBack@TaskList@ComTaskPool@Internal@Windows@@QEAAJ$$QEAUTaskData@234@@Z.c)
        ...
        HMODULE **a7)
{
  ...
  bool v32; // [rsp+3Ch] [rbp-CCh]
  DWORD TickCount; // [rsp+40h] [rbp-C8h]
...
LABEL_11:
            ...
            if ( *(_DWORD *)(v16 + 136) == a4 )
            {
                ...
                && Windows::Internal::ComTaskPool::s_dwThreadIdReuse == *(_DWORD *)(v16 + 88) )
              {
                ...
                if ( !*(_QWORD *)(v16 + 24) && !v17 && *(int *)(v16 + 92) <= 1 )
                {
                  ...
                  Microsoft::WRL::ComPtr<Windows::Internal::IComPoolTask>::InternalRelease(&v43);
                  if ( started >= 0 )
    ...
    if ( *v15 )
    {
      ...
      v28 = (__int64 *)&v49;
LABEL_66:
      Microsoft::WRL::ComPtr<Windows::Internal::IComPoolTask>::InternalRelease(v28);
      return (unsigned int)started;
    }
...
LABEL_62:
    ...
    Microsoft::WRL::ComPtr<Windows::Internal::IComPoolTask>::InternalRelease(&v47);
    if ( !v32 || v35 )
    {
  ...
  Microsoft::WRL::ComPtr<Windows::Internal::IComPoolTask>::InternalRelease(&v41);
