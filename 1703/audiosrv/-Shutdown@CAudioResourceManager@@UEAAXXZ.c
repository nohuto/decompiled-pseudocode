/*
 * XREFs of ?Shutdown@CAudioResourceManager@@UEAAXXZ @ 0x1800ACD80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CAudioResourceManager::Shutdown(CAudioResourceManager *this)
{
  ...
  *((_BYTE *)this + 72) = 0;
  ...
  {
    v3 = (__int64 **)std::deque<std::shared_ptr<SaDeviceReevaluationContext>>::begin((char *)this + 80, v9);
    v4 = v3;
    if ( *v3 )
      v5 = **v3;
    else
      v5 = 0LL;
    v6 = *(_QWORD *)(*(_QWORD *)(v5 + 8) + 8 * ((unsigned __int64)v4[2] & (*(_QWORD *)(v5 + 16) - 1LL)));
