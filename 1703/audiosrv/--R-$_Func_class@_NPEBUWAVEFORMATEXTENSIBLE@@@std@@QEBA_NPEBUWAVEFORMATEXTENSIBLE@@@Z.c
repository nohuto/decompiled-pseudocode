/*
 * XREFs of ??R?$_Func_class@_NPEBUWAVEFORMATEXTENSIBLE@@@std@@QEBA_NPEBUWAVEFORMATEXTENSIBLE@@@Z @ 0x180040580
 * Callers:
...
__int64 __fastcall std::_Func_class<bool,WAVEFORMATEXTENSIBLE const *>::operator()(__int64 a1, __int64 a2)
{
  ...
  if ( (char *)v3 == (char *)std::_Func_impl__lambda_d46c42d8c87c8b0eef0423a918fcc8ac__std::allocator_int__bool_WAVEFORMATEXTENSIBLE_const_____ptr64_::_Do_call )
    return std::_Func_impl__lambda_d46c42d8c87c8b0eef0423a918fcc8ac__std::allocator_int__bool_WAVEFORMATEXTENSIBLE_const_____ptr64_::_Do_call(
             v2,
             &v5);
  else
    return v3(v2, &v5);
