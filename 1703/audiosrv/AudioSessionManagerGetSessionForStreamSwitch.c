/*
 * XREFs of AudioSessionManagerGetSessionForStreamSwitch @ 0x180094AD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionManagerGetSessionForStreamSwitch(CAudioSessionManager ***a1, char *a2, _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x49u, (__int64)&WPP_011fda66b4cb384044e4321f2ccefedb_Traceguids, *v3);
  }
  ...
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionManagerGetSessionForStreamSwitch", 2331, v6);
  CAudioSessionInstanceId::~CAudioSessionInstanceId((CAudioSessionInstanceId *)v21);
