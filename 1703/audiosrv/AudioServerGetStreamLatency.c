/*
 * XREFs of AudioServerGetStreamLatency @ 0x1800A2F60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetStreamLatency(_OWORD *a1, __int64 a2, __int64 a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(_OWORD *, __int64, __int64))(*(_QWORD *)a1 + 120LL))(a1, a2, a3);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetStreamLatency", 3505, v6);
