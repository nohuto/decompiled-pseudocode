/*
 * XREFs of ?ScheduleWorkItem@CWorkFifo@@QEAAJV?$function@$$A6AXXZ@std@@@Z @ 0x1800C41D8
 * Callers:
 ...
 *     ?ResetEvent@details@wil@@YAXPEAX@Z @ 0x1800C405C (-ResetEvent@details@wil@@YAXPEAX@Z.c)
...
__int64 __fastcall CWorkFifo::ScheduleWorkItem(wil::details **this, __int64 a2)
{
  ...
  if ( !*((_BYTE *)this + 136) )
  {
    ...
    *(_OWORD *)v19 = 0LL;
    std::shared_ptr<CWorkFifo::WorkItem>::_Resetp<CWorkFifo::WorkItem>((__int64)v19, v10);
    v11 = v19[0];
    if ( !v19[0] )
    {
      v7 = -2147024882;
