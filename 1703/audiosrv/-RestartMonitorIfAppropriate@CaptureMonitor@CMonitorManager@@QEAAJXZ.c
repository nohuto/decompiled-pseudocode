/*
 * XREFs of ?RestartMonitorIfAppropriate@CaptureMonitor@CMonitorManager@@QEAAJXZ @ 0x1800B4A2C
 * Callers:
...
LABEL_32:
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Bu, (__int64)&WPP_f44a6138b15d3ac2c57129b0cddf5064_Traceguids, v2);
  }
  return (unsigned int)v2;
}
