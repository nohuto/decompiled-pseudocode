/*
 * XREFs of ?IsOffloadDisabled@@YAHPEAUIMMDevice@@@Z @ 0x18002D5D8
 * Callers:
...
__int64 __fastcall IsOffloadDisabled(struct IMMDevice *a1)
{
  ...
  {
    v3 = (*(__int64 (__fastcall **)(__int64, void *, PROPVARIANT *))(*(_QWORD *)v8 + 40LL))(
           v8,
  ...
  if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 70LL, &WPP_6a2f5d392ebc3a7b5b56686ced9a2fbc_Traceguids, v1);
  }
  return v1;
}
