/*
 * XREFs of ?GetDefaultConnectorProcessingModeConfiguration@CEndpointCharacteristics@@QEAAXW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAU_GUID@@11@Z @ 0x18000D2D0
 * Callers:
        ...
        struct _GUID *a5)
{
  ...
  v10 = *(struct _GUID *)CEndpointCharacteristics::GetDefaultConnectorProcessingMode(this, &v13, (unsigned int)a2, 0LL);
  v14 = v10;
  if ( a4 )
  {
    v13 = v10;
