/*
 * XREFs of _ATL::CAtlMap_ISaDeviceProxy_____ptr64_Sarm::CEndpointResourcePool_ATL::CElementTraits_ISaDeviceProxy_____ptr64__ATL::CElementTraits_Sarm::CEndpointResourcePool___::SetAt_::_1_::catch$2 @ 0x1800C45F8
 * Callers:
 *     <none>
 * Callees:
