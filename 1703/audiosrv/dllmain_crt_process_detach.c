/*
 * XREFs of dllmain_crt_process_detach @ 0x1800489C4
 * Callers:
 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x180048FE0 (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x1800491BC (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x1800491E0 (__scrt_uninitialize_crt.c)
 *     ?__scrt_uninitialize_type_info@@YAXXZ @ 0x18004972C (-__scrt_uninitialize_type_info@@YAXXZ.c)
