/*
 * XREFs of _CAudioSessionInstanceId::Initialize_::_1_::dtor$0_0 @ 0x1800983EC
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioSessionInstanceId::Initialize_::_1_::dtor_0_0(__int64 a1, __int64 a2)
{
