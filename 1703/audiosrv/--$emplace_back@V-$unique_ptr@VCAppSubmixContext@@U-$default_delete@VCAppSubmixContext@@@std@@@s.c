 ...
 *     ??$_Uninitialized_move_al_unchecked1@PEAV?$unique_ptr@VCAppSubmixContext@@U?$default_delete@VCAppSubmixContext@@@std@@@std@@PEAV12@V?$allocator@V?$unique_ptr@VCAppSubmixContext@@U?$default_delete@VCAppSubmixContext@@@std@@@std@@@2@@std@@YAPEAV?$unique_ptr@VCAppSubmixContext@@U?$default_delete@VCAppSubmixContext@@@std@@@0@PEAV10@00AEAU?$_Wrap_alloc@V?$allocator@V?$unique_ptr@VCAppSubmixContext@@U?$default_delete@VCAppSubmixContext@@@std@@@std@@@std@@@0@U_General_ptr_iterator_tag@0@U_Any_tag@0@@Z @ 0x1800AE5C4 (--$_Uninitialized_move_al_unchecked1@PEAV-$unique_ptr@VCAppSubmixContext@@U-$default_delete@VCAp.c)
        ...
        __int64 *a2)
{
  ...
  if ( (__int64 *)result == v5 )
  {
    ...
    try
    {
      ...
      std::_Uninitialized_move_al_unchecked1<std::unique_ptr<CAppSubmixContext> *,std::unique_ptr<CAppSubmixContext> *,std::allocator<std::unique_ptr<CAppSubmixContext>>>(
        *a1,
        a1[1],
        v11);
    }
