/*
 * XREFs of ??$_Uninitialized_move_al_unchecked1@PEAVWeakRef@WRL@Microsoft@@PEAV123@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@std@@YAPEAVWeakRef@WRL@Microsoft@@PEAV123@00AEAU?$_Wrap_alloc@V?$allocator@VWeakRef@WRL@Microsoft@@@std@@@0@U_General_ptr_iterator_tag@0@U_Any_tag@0@@Z @ 0x18002C99C
 * Callers:
...
_QWORD *__fastcall std::_Uninitialized_move_al_unchecked1<Microsoft::WRL::WeakRef *,Microsoft::WRL::WeakRef *,std::allocator<Microsoft::WRL::WeakRef>>(
        _QWORD *a1,
        _QWORD *a2,
        _QWORD *a3)
{
