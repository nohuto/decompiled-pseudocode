/*
 * XREFs of ?RemoveGainStage@CAudioSession@@UEAAJPEBU_GUID@@0_NPEA_J@Z @ 0x18008EEF0
 * Callers:
 *     <none>
 * Callees:
        ...
        CRefCountedObject *a5)
{
  ...
  {
    WPP_SF_S_guid_(*((_QWORD *)WPP_GLOBAL_Control + 2), 108, v10, *((_QWORD *)this + 105), (__int64)a2);
  }
  v11 = (char *)this + 520;
  ...
  else
  {
    ...
    v6 = -2147024894;
    AudSrvTraceLoggingErrorHelper("CAudioSession::RemoveGainStage", 4611, -2147024894);
  }
  if ( v17 )
