/*
 * XREFs of ?GetAPOSupportedProcessingModes@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@AEAVCAudioSignalProcessingModeArray@@@Z @ 0x180079C78
 * Callers:
        ...
        struct CAudioSignalProcessingModeArray *a3)
{
  ...
  if ( v6 || (_DWORD)v4 == 3 )
    v7 = 1;
  return SystemEffectDescriptor::GetSupportedProcessingModes((__int64)this + 96 * v4 + 608, (__int64)a3, v7);
}
