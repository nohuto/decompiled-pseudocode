/*
 * XREFs of ?AERTMemoryShutdown@@YAJXZ @ 0x1800D10AC
 * Callers:
...
__int64 AERTMemoryShutdown(void)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x16u, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
  }
  ...
  if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control )
  {
    ...
    {
LABEL_16:
      if ( v1 != (CVolumeStrip *)&WPP_GLOBAL_Control
        && (*((_DWORD *)v1 + 7) & 0x40000) != 0
        && *((_BYTE *)v1 + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)v1 + 2), 0x19u, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
      }
      goto LABEL_20;
    }
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x18u, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
LABEL_15:
    v1 = WPP_GLOBAL_Control;
    goto LABEL_16;
  }
LABEL_20:
  ...
  if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Au, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
  }
  return 0LL;
}
