/*
 * XREFs of ?InitWaveFormatEx@@YAXPEAUWAVEFORMATEXTENSIBLE@@_NHHHHK@Z @ 0x18009CA54
 * Callers:
        ...
        DWORD a7)
{
  ...
  if ( a2 )
  {
    ...
    v8 = GUID_00000003_0000_0010_8000_00aa00389b71;
  }
  else
  {
  ...
  a1->Format.cbSize = 22;
  v9 = a6 * (a1->Format.wBitsPerSample >> 3);
  a1->SubFormat = v8;
  a1->dwChannelMask = v7;
  a1->Format.nSamplesPerSec = a3;
  a1->Format.nBlockAlign = v9;
  a1->Format.nAvgBytesPerSec = a3 * v9;
}
