/*
 * XREFs of ?GetPropertyStoreProperty@CPolicyConfig@@SAJPEAUIMMDevice@@HAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x18009C6DC
 * Callers:
        ...
        struct tagPROPVARIANT *a4)
{
  ...
  if ( v7 < 0 )
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyStoreProperty", 4608, v7);
  if ( v9[0] )
