/*
 * XREFs of ?OnNotify@CPerEndpointVolumeAudioSession@@EEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x18008DE10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_q_guid__guid_ @ 0x180090BEC (WPP_SF_q_guid__guid_.c)
 *     WPP_SF_qdd @ 0x180090C54 (WPP_SF_qdd.c)
 *     WPP_SF_qgg_HEX__HEX_ @ 0x180090CA8 (WPP_SF_qgg_HEX__HEX_.c)
 */
        ...
        struct AUDIO_VOLUME_NOTIFICATION_DATA *a2)
{
  ...
  if ( v9 )
  {
    if ( v7 != (CVolumeStrip *)&WPP_GLOBAL_Control && (*((_BYTE *)v7 + 28) & 0x40) != 0 && *((_BYTE *)v7 + 25) >= 4u )
    ...
    if ( v37 || v38 || v4 )
    {
      if ( v12 != (CVolumeStrip *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)v12 + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)v12 + 2), 0x9Fu, (__int64)&WPP_0c5ff841e5503cc39024c97173620901_Traceguids);
        v12 = WPP_GLOBAL_Control;
      }
      if ( v4 )
      {
        ...
        if ( v12 != (CVolumeStrip *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v12 + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)v12 + 2), 0xA0u, (__int64)&WPP_0c5ff841e5503cc39024c97173620901_Traceguids);
        }
        v32 = 0;
        lpCriticalSection = (LPCRITICAL_SECTION)((char *)this - 176);
        ATL::CCritSecLock::Lock(&lpCriticalSection);
        ...
        if ( v32 )
          LeaveCriticalSection(lpCriticalSection);
        if ( v23 )
          CAudioSession::RecalculateSessionVolume((__int64)this - 1040, 1u, &a2->guidEventContext, v24, 1, 0LL);
        v12 = WPP_GLOBAL_Control;
      }
      if ( v37 )
      {
        CAudioSession::SetMute(
          (CPerEndpointVolumeAudioSession *)((char *)this - 1056),
          a2->bMuted,
      ...
      if ( v38 )
      {
        if ( v12 != (CVolumeStrip *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v12 + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)v12 + 2), 0xA1u, (__int64)&WPP_0c5ff841e5503cc39024c97173620901_Traceguids);
        }
        v32 = 0;
        lpCriticalSection = (LPCRITICAL_SECTION)((char *)this - 176);
        ATL::CCritSecLock::Lock(&lpCriticalSection);
        *v15 = *(_DWORD *)p_fMasterVolume;
        if ( v32 )
          LeaveCriticalSection(lpCriticalSection);
        CAudioSession::RecalculateSessionVolume((__int64)this - 1040, 0, &a2->guidEventContext, 0, 1, 0LL);
      }
    }
    operator delete(v5);
  }
  else if ( v7 != (CVolumeStrip *)&WPP_GLOBAL_Control && (*((_BYTE *)v7 + 28) & 0x40) != 0 && *((_BYTE *)v7 + 25) >= 4u )
  {
    WPP_SF_q(*((_QWORD *)v7 + 2), 0x9Au, (__int64)&WPP_0c5ff841e5503cc39024c97173620901_Traceguids, (char *)this - 1056);
  }
  return 0LL;
}
