/*
 * XREFs of Pdcv2EventWrite_ACTIVATION_CLIENT_CALLBACK @ 0x1800D202C
 * Callers:
...
void __fastcall Pdcv2EventWrite_ACTIVATION_CLIENT_CALLBACK(__int64 a1, _DWORD *a2, int a3, int a4)
{
  ...
  if ( dword_18012A3B0 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18012A3B0, 0x400000000000uLL) )
    {
      ...
      v48 = 4LL;
      TlgCreateWsz(&v49, v6);
      TlgWrite((TraceLoggingHProvider)&dword_18012A3B0, &unk_1800FBC73, v17, v18, 0xEu, &pData);
    }
  }
}
