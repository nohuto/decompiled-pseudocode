/*
 * XREFs of ?ReportHang@CWatchdogTimer@@AEAAXXZ @ 0x1800A1534
 * Callers:
 *     ?TimerCallback@CWatchdogTimer@@SAXPEAXE@Z @ 0x1800A1B00 (-TimerCallback@CWatchdogTimer@@SAXPEAXE@Z.c)
 * Callees:
...
void __fastcall CWatchdogTimer::ReportHang(CWatchdogTimer *this)
{
  ...
  if ( **((_DWORD **)this + 1) > 2u && TlgKeywordOn(*((TraceLoggingHProvider *)this + 1), 0x400000000002uLL) )
  {
    ...
    v13 = (char *)this + 16;
    v14 = 4;
    TlgWrite(v5, &unk_1800F9210, v3, v4, 5u, &pData);
  }
