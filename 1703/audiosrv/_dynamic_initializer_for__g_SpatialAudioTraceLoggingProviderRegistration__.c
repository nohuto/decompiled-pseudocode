/*
 * XREFs of _dynamic_initializer_for__g_SpatialAudioTraceLoggingProviderRegistration__ @ 0x1800012C0
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_SpatialAudioTraceLoggingProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_18012A260, a2, a3);
