/*
 * XREFs of ?GetAllVolumes@CAudioSession@@UEAAJIPEAM@Z @ 0x18008BA70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetAllVolumes(const wchar_t **this, unsigned int a2, float *a3)
{
  ...
  {
    v6 = -2147024809;
    AudSrvTraceLoggingErrorHelper("CAudioSession::GetAllVolumes", 1281, -2147024809);
  }
  if ( v11 )
