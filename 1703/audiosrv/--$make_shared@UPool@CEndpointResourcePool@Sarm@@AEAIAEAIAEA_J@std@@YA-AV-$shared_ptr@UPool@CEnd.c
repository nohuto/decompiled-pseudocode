/*
 * XREFs of ??$make_shared@UPool@CEndpointResourcePool@Sarm@@AEAIAEAIAEA_J@std@@YA?AV?$shared_ptr@UPool@CEndpointResourcePool@Sarm@@@0@AEAI0AEA_J@Z @ 0x1800C5198
 * Callers:
 ...
 *     ??0Pool@CEndpointResourcePool@Sarm@@QEAA@II_J@Z @ 0x1800C5230 (--0Pool@CEndpointResourcePool@Sarm@@QEAA@II_J@Z.c)
 */
