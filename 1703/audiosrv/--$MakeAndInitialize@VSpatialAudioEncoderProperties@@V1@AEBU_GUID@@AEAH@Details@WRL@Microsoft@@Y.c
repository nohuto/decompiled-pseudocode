/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioEncoderProperties@@V1@AEBU_GUID@@AEAH@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioEncoderProperties@@AEBU_GUID@@AEAH@Z @ 0x1800CAA40
 * Callers:
        ...
        int *a3)
{
  ...
  *a1 = 0LL;
  v10 = 0LL;
  v6 = (SpatialAudioEncoderProperties *)operator new(0x220uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v6 )
  {
