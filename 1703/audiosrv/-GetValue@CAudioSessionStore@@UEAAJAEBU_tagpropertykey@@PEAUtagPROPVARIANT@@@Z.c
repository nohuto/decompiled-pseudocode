/*
 * XREFs of ?GetValue@CAudioSessionStore@@UEAAJAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x180031210
 * Callers:
...
LABEL_3:
  ...
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSessionStore::GetValue", 0x149Bu, v6);
