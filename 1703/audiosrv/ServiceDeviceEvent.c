/*
 * XREFs of ServiceDeviceEvent @ 0x1800B92C0
 * Callers:
 ...
 *     WPP_SF_DPS @ 0x1800B9608 (WPP_SF_DPS.c)
 *     WPP_SF_PS @ 0x1800B96A8 (WPP_SF_PS.c)
 */
...
__int64 __fastcall ServiceDeviceEvent(unsigned int a1, struct _DEV_BROADCAST_DEVICEINTERFACE_W *a2)
{
  ...
  {
    if ( v4 != (CVolumeStrip *)&WPP_GLOBAL_Control && (*((_BYTE *)v4 + 28) & 0x20) != 0 && *((_BYTE *)v4 + 25) >= 4u )
