/*
 * XREFs of std::_For_each_unchecked_Microsoft::WRL::ComPtr_IStreamGroupProxy______ptr64__lambda_d62dc145dcfedba70546eeba8120cc1b___ @ 0x1800A9B10
 * Callers:
...
void __fastcall std::_For_each_unchecked_Microsoft::WRL::ComPtr_IStreamGroupProxy______ptr64__lambda_d62dc145dcfedba70546eeba8120cc1b___(
        _QWORD *a1,
        _QWORD *a2,
        _QWORD *a3)
{
