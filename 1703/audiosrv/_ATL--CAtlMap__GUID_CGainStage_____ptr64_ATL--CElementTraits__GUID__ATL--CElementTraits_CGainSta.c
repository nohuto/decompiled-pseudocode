/*
 * XREFs of _ATL::CAtlMap__GUID_CGainStage_____ptr64_ATL::CElementTraits__GUID__ATL::CElementTraits_CGainStage_____ptr64___::NewNode_::_1_::catch$1 @ 0x18008DBAB
 * Callers:
 *     <none>
 * Callees:
