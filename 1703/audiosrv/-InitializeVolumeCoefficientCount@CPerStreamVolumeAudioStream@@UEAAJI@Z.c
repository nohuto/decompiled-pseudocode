/*
 * XREFs of ?InitializeVolumeCoefficientCount@CPerStreamVolumeAudioStream@@UEAAJI@Z @ 0x180016C00
 * Callers:
...
LABEL_20:
  ...
  if ( *v13 && *v17 )
  {
    for ( j = 0; j < *((_DWORD *)this + 22); v19[v21] = 1065353216 )
      v21 = j++;
  }
  else
  {
    v10 = -2147024882;
    AudSrvTraceLoggingErrorHelper("CAudioStream::InitializeVolumeCoefficientCount", 0x116u, -2147024882);
  }
LABEL_24:
  v22 = v10;
  if ( v10 < 0 )
LABEL_31:
    AudSrvTraceLoggingErrorHelper("CPerStreamVolumeAudioStream::InitializeVolumeCoefficientCount", 0x8F3u, v22);
  return v22;
}
