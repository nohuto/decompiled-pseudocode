/*
 * XREFs of ?IsProcessAllowed@@YAHKPEBG@Z @ 0x18002C040
 * Callers:
...
__int64 __fastcall IsProcessAllowed(DWORD dwProcessId, const unsigned __int16 *a2)
{
  ...
  if ( v7 )
  {
    ...
    if ( v8 < 0 )
    {
      AudSrvTraceLoggingErrorHelper("IsProcessAllowed", 0x1F3u, v8);
      goto LABEL_16;
    }
  }
  v5 = 1;
  ...
  if ( v5 )
  {
    ...
    if ( v9 )
    {
      if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_6a2f5d392ebc3a7b5b56686ced9a2fbc_Traceguids, v9);
      }
    }
  }
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("IsProcessAllowed", 0x245u, v8);
  if ( v12 )
