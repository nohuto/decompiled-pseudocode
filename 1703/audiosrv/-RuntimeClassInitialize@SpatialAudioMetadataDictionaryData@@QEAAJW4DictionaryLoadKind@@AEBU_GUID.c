/*
 * XREFs of ?RuntimeClassInitialize@SpatialAudioMetadataDictionaryData@@QEAAJW4DictionaryLoadKind@@AEBU_GUID@@G@Z @ 0x1800CC59C
 * Callers:
...
LABEL_6:
  *(_OWORD *)(a1 + 96) = *v5;
  *(_WORD *)(a1 + 92) = *((_WORD *)v5 + 8);
  *(_DWORD *)(a1 + 88) = *((_DWORD *)v5 + 8);
  *(_QWORD *)(a1 + 80) = *((_QWORD *)v5 + 3);
  return (unsigned int)v9;
}
