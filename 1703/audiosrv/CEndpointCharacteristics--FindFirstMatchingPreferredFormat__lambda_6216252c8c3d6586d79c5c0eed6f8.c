/*
 * XREFs of CEndpointCharacteristics::FindFirstMatchingPreferredFormat__lambda_6216252c8c3d6586d79c5c0eed6f8f6d___ @ 0x1800B9A7C
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  while ( 1 )
  {
    ...
    *(_WORD *)(a2 + 16) = 22;
    ...
    if ( v16 < 0 )
      break;
    if ( v18 && lambda_068f763f677867854f08eaa5008b23ee_::operator()((__int64)(a3 + 3), (unsigned __int16 *)a2) )
    {
