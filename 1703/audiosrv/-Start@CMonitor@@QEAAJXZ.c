/*
 * XREFs of ?Start@CMonitor@@QEAAJXZ @ 0x1800B76D8
 * Callers:
 ...
 *     ?AllocateBytes@?$CHeapPtrBase@EVCCRTAllocator@ATL@@@ATL@@QEAA_N_K@Z @ 0x1800B5630 (-AllocateBytes@-$CHeapPtrBase@EVCCRTAllocator@ATL@@@ATL@@QEAA_N_K@Z.c)
...
__int64 __fastcall CMonitor::Start(CMonitor *this)
{
  ...
  {
    if ( v3 != (CVolumeStrip *)&WPP_GLOBAL_Control && (*((_DWORD *)v3 + 7) & 0x800000) != 0 && *((_BYTE *)v3 + 25) >= 4u )
