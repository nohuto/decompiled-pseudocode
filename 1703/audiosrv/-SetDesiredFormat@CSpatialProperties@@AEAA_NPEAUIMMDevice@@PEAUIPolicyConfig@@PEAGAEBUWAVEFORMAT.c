/*
 * XREFs of ?SetDesiredFormat@CSpatialProperties@@AEAA_NPEAUIMMDevice@@PEAUIPolicyConfig@@PEAGAEBUWAVEFORMATEXTENSIBLE@@@Z @ 0x1800C753C
 * Callers:
        ...
        const struct WAVEFORMATEXTENSIBLE *a5)
{
  ...
  if ( (unsigned int)hProvider > 4 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000000uLL) )
  {
    ...
    v45 = 2;
    v48 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1800FAFC9, v13, v14, 0xCu, &pData);
  }
  if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control
    && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x1000) != 0
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_Sdd(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      0x1Bu,
      (__int64)&WPP_1108182ce8c13c0b5d2500d454403f98_Traceguids,
      a4 + 17);
  }
  return v7 >= 0;
}
