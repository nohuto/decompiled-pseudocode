/*
 * XREFs of ?FindMuteControlForEndpoint@CMuteHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18003A8B4
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_c071410194bb3e21497a264ebdcc8fa3_Traceguids, this);
    v6 = v17;
  }
  if ( a2 )
  {
      ...
      if ( v7 >= 0 )
      {
        ...
        if ( WPP_GLOBAL_Control != (CVolumeStrip *)&WPP_GLOBAL_Control )
        {
          ...
          if ( v8 != (CVolumeStrip *)&WPP_GLOBAL_Control
            ...
            && *((_BYTE *)v8 + 25) >= 4u )
          {
            WPP_SF_q(*((_QWORD *)v8 + 2), 16LL, &WPP_c071410194bb3e21497a264ebdcc8fa3_Traceguids, this);
          }
        }
        v9 = v17;
        if ( v17 != a2 )
          ...
          if ( v11 >= 0 )
          {
              ...
              && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
            {
              WPP_SF_q(
                *((_QWORD *)WPP_GLOBAL_Control + 2),
                17LL,
                &WPP_c071410194bb3e21497a264ebdcc8fa3_Traceguids,
                this);
            }
    ...
    if ( v7 < 0 )
    {
      ...
      AudSrvTraceLoggingErrorHelper("CMuteHardware::FindMuteControlForEndpoint", 0x19Au, v7);
    }
    if ( v14 )
