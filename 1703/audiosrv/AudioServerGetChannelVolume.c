/*
 * XREFs of AudioServerGetChannelVolume @ 0x1800A1DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetChannelVolume(_OWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(_OWORD *, _QWORD, __int64))(*(_QWORD *)a1 + 152LL))(a1, a2, a3);
  v7 = v6;
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetChannelVolume", 3292, v6);
