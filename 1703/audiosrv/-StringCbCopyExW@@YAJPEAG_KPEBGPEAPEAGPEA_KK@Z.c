/*
 * XREFs of ?StringCbCopyExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x180082FE0
 * Callers:
 *     s_sndevtResolveSoundAlias @ 0x1800832E0 (s_sndevtResolveSoundAlias.c)
 *     ?GetSoundRegistryPath@@YAHPEAG_KPEBG22@Z @ 0x1800D30A0 (-GetSoundRegistryPath@@YAHPEAG_KPEBG22@Z.c)
 * Callees:
 *     memset @ 0x180049B8A (memset.c)
 *     StringCopyWorkerW_1 @ 0x1800831AC (StringCopyWorkerW_1.c)
        ...
        DWORD a6)
{
  ...
  if ( (a6 & 0xFFFFE000) == 0 )
  {
    if ( v8 )
    {
      ...
      v11 = StringCopyWorkerW_1(pszDest, v8, &pcchNewDestLength, pszSrc, (size_t)pcchRemaining);
      ...
      if ( (dwFlags & 0x200) != 0 )
      {
        ...
        if ( (unsigned __int64)pszSrc > 2 )
          memset(v12 + 1, (unsigned __int8)dwFlags, (size_t)(pszSrc - 1));
      }
    }
    else
    {
