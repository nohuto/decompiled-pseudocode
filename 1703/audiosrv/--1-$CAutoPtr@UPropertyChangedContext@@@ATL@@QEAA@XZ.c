/*
 * XREFs of ??1?$CAutoPtr@UPropertyChangedContext@@@ATL@@QEAA@XZ @ 0x1800B1490
 * Callers:
 *     _CMonitorManager::OnPropertyValueChanged_::_1_::dtor$1 @ 0x18005BDEC (_CMonitorManager--OnPropertyValueChanged_--_1_--dtor$1.c)
 * Callees:
