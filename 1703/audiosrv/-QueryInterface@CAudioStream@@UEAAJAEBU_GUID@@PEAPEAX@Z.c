/*
 * XREFs of ?QueryInterface@CAudioStream@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180019390
 * Callers:
 *     ?QueryInterface@CAudioStream@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180058300 (-QueryInterface@CAudioStream@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CAudioStream@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180058310 (-QueryInterface@CAudioStream@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall CAudioStream::QueryInterface(CAudioStream *this, const struct _GUID *a2, char **a3)
{
  ...
  if ( v5 )
  {
    v6 = *(_QWORD *)&GUID_9b8a7740_a0c4_407f_ab8a_6058ad80845c.Data1 - *(_QWORD *)&a2->Data1;
    if ( *(_QWORD *)&GUID_9b8a7740_a0c4_407f_ab8a_6058ad80845c.Data1 == *(_QWORD *)&a2->Data1 )
      v6 = *(_QWORD *)GUID_9b8a7740_a0c4_407f_ab8a_6058ad80845c.Data4 - *(_QWORD *)a2->Data4;
    if ( v6 )
    {
      v7 = (char *)this + 16;
