/*
 * XREFs of ?s_GetTaskPoolTlsSlot@ComTaskPool@Internal@Windows@@CAJPEAK@Z @ 0x1800D82A8
 * Callers:
...
__int64 __fastcall Windows::Internal::ComTaskPool::s_GetTaskPoolTlsSlot(unsigned int *a1)
{
  ...
  if ( `Windows::Internal::ComTaskPool::s_GetTaskPoolTlsSlot'::`2'::s_tlsTaskPool == -1 )
  {
    ...
    Error = StringCchPrintfW(Name, 0x104uLL, (size_t *)L"ComTaskPool:%d", CurrentProcessId);
    while ( Error >= 0 )
    {
      if ( `Windows::Internal::ComTaskPool::s_GetTaskPoolTlsSlot'::`2'::s_tlsTaskPool != -1 )
        break;
