/*
 * XREFs of RaUnitTelemetryIdIoctl @ 0x1C001BB10
 * Callers:
...
__int64 __fastcall RaUnitTelemetryIdIoctl(__int64 a1, IRP *a2)
{
  ...
  unsigned __int8 v13; // [rsp+30h] [rbp-59h] BYREF
  unsigned __int8 v14; // [rsp+31h] [rbp-58h] BYREF
  unsigned __int8 v15; // [rsp+32h] [rbp-57h] BYREF
  ...
  unsigned __int8 *v24; // [rsp+90h] [rbp+7h]
  __int64 v25; // [rsp+98h] [rbp+Fh]
  unsigned __int8 *v26; // [rsp+A0h] [rbp+17h]
  __int64 v27; // [rsp+A8h] [rbp+1Fh]
  unsigned __int8 *v28; // [rsp+B0h] [rbp+27h]
...
LABEL_13:
  ...
  *(_OWORD *)(a1 + 1688) = *(_OWORD *)&MasterIrp->MdlAddress;
  ...
  *(_OWORD *)&MasterIrp->AssociatedIrp.MasterIrp = *(_OWORD *)(*(_QWORD *)(a1 + 24) + 5192LL);
  ...
  if ( (unsigned int)dword_1C0055010 > 5 && TlgKeywordOn(Length, 0x400000000000uLL) )
  {
    ...
    v27 = 1LL;
    v29 = 1LL;
    TlgWrite((TraceLoggingHProvider)v10, &unk_1C004B756, v7, v8, 8u, &pData);
  }
  v11 = 0;
  return RaidCompleteRequestEx(a2, 0, v11);
}
