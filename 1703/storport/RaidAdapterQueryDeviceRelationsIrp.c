/*
 * XREFs of RaidAdapterQueryDeviceRelationsIrp @ 0x1C0012A74
 * Callers:
...
NTSTATUS __fastcall RaidAdapterQueryDeviceRelationsIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 14LL, &WPP_43677b6b8a68310e2fabd5fd066069ea_Traceguids, a1, a2);
  }
  ...
  else
  {
    ...
    else
    {
      if ( StorEtwLoggingEnabled != (_BYTE)v2 )
      {
        ...
        if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x200000) != 0 )
          Template_pq(v8, &EventPnpRequestComplete, v22, a2, v7);
      }
