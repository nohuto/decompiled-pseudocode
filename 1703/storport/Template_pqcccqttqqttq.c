/*
 * XREFs of Template_pqcccqttqqttq @ 0x1C0037AFC
 * Callers:
...
NTSTATUS Template_pqcccqttqqttq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v26 = 4LL;
  v28 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventUnitPoFxRegistered, 0LL, 0xDu, &UserData);
}
