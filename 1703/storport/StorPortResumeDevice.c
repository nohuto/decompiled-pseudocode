/*
 * XREFs of StorPortResumeDevice @ 0x1C000CFA0
 * Callers:
 *     StorPortResumeDeviceVrfy @ 0x1C0067630 (StorPortResumeDeviceVrfy.c)
 * Callees:
...
char __fastcall StorPortResumeDevice(__int64 a1, unsigned __int8 a2, __int64 a3, __int64 a4)
{
  ...
  if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 4) != 0 )
    Template_pqccc(v9, a2, a3, v7, v9, a2, v5, v4);
  if ( v8 )
  {
    LOBYTE(v14) = a2;
    BYTE1(v14) = v5;
    ...
    {
      WPP_SF_ddd(WPP_GLOBAL_Control->AttachedDevice, 18LL, &WPP_b8c4fabb6c503934ded1881555415092_Traceguids, a2, v5, v4);
    }
