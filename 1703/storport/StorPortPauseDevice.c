/*
 * XREFs of StorPortPauseDevice @ 0x1C000CE20
 * Callers:
 *     StorPortPauseDeviceVrfy @ 0x1C0067600 (StorPortPauseDeviceVrfy.c)
 * Callees:
    ...
    if ( Unit )
    {
      ...
      if ( (qword_1C00551F8 & 0x800) != 0 )
        DbgLogRequest(v9, 22, (_DWORD)retaddr, 0, 0LL, 0LL, 0LL);
           ...
           && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    {
      WPP_SF_ddd(WPP_GLOBAL_Control->AttachedDevice, 16LL, &WPP_b8c4fabb6c503934ded1881555415092_Traceguids, a2, v6, v5);
    }
  }
  return 0;
}
