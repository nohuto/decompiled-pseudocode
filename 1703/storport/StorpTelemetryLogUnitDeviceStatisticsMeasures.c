/*
 * XREFs of StorpTelemetryLogUnitDeviceStatisticsMeasures @ 0x1C0043918
 * Callers:
...
void __fastcall StorpTelemetryLogUnitDeviceStatisticsMeasures(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0055010 > 5 && TlgKeywordOn(a1, 0x400000000000uLL) )
  {
    v4 = *(_QWORD *)(v1 + 24);
    v5 = v2 + 1688;
    v6 = *(_QWORD **)(v3 + 40);
    ...
    *(_QWORD *)&hProvider.LevelPlus1 = *(_QWORD *)&WPP_MAIN_CB.DeviceLock.Header.Lock;
    ...
    v114[1] = 0;
    v116 = 1LL;
    TlgWrite(&hProvider, &unk_1C004DD85, v29, 0LL, 0x25u, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAll);
  }
}
