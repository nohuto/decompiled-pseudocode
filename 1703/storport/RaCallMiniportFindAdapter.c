/*
 * XREFs of RaCallMiniportFindAdapter @ 0x1C0010DCC
 * Callers:
...
__int64 __fastcall RaCallMiniportFindAdapter(PVOID *a1, const GUID *a2, unsigned int a3, __int64 a4)
{
  ...
  *((_BYTE *)a1 + 248) |= 1u;
  ...
  {
    v11 = (*((__int64 (__fastcall **)(__int64, _QWORD, __int64, _QWORD, void *, _DWORD *, char *))v10 + 4))(
            (__int64)a1[30] + 16,
            *((_QWORD *)*a1 + 4),
            v9,
            *((_QWORD *)*a1 + 3),
  ...
  {
LABEL_8:
    v11 = (*((__int64 (__fastcall **)(__int64, _QWORD, _QWORD, void *, _DWORD *, char *))v10 + 4))(
            (__int64)a1[30] + 16,
            0LL,
            0LL,
            v5,
