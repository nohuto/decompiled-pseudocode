/*
 * XREFs of RaidAdapterRemoveUnit @ 0x1C0014790
 * Callers:
...
void __fastcall RaidAdapterRemoveUnit(__int64 a1, __int64 a2)
{
  ...
  StorRemoveDictionary(
    a1 + 144,
    (unsigned __int8)BYTE2(*(_DWORD *)(a2 + 88)) | ((((unsigned __int64)(unsigned __int8)*(_DWORD *)(a2 + 88) << 8) | (unsigned __int8)BYTE1(*(_DWORD *)(a2 + 88))) << 8));
