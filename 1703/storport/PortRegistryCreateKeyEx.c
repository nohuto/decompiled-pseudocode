/*
 * XREFs of PortRegistryCreateKeyEx @ 0x1C0015D54
 * Callers:
 *     PortMapBuildAdapterEntry @ 0x1C0013558 (PortMapBuildAdapterEntry.c)
 ...
 *     PortMapBuildBusEntry @ 0x1C0015CE8 (PortMapBuildBusEntry.c)
 * Callees:
...
__int64 PortRegistryCreateKeyEx(void *a1, ULONG a2, void **a3, const wchar_t *a4, ...)
{
  ...
  wchar_t Dest[72]; // [rsp+90h] [rbp-70h] BYREF
