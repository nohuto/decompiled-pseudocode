/*
 * XREFs of StorpTelemetryLogUnitQosDataMeasures @ 0x1C0044584
 * Callers:
...
void __fastcall StorpTelemetryLogUnitQosDataMeasures(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0055010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      *(_DWORD *)hProvider = *(_DWORD *)(v2 + 2580);
      *(_DWORD *)&hProvider[4] = *(_DWORD *)(v2 + 2584);
      *(_QWORD *)&hProvider[8] = *(_QWORD *)(v2 + 2588);
      *(_QWORD *)&hProvider[16] = *(_QWORD *)(v2 + 2596);
      v6 = (*(_BYTE *)(v2 + 154) & 2) != 0;
      v20 = 16LL;
      v14 = v6;
      ...
      *(_DWORD *)&hProvider[32] = *(_DWORD *)(v3 + 28);
      ...
      v61 = 4LL;
      v63 = 4LL;
      TlgWrite((TraceLoggingHProvider)hProvider, &unk_1C004C578, v9, v10, 0x1Au, &pData);
    }
  }
}
