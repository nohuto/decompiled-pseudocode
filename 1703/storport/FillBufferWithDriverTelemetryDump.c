/*
 * XREFs of FillBufferWithDriverTelemetryDump @ 0x1C0046260
 * Callers:
 *     RaidStandardSecondaryDumpCallback @ 0x1C0046530 (RaidStandardSecondaryDumpCallback.c)
 * Callees:
...
LABEL_34:
    ...
    while ( 1 )
    {
      v19 = *(_QWORD *)(*(_QWORD *)(v3 + 24) + 5064LL) + 48LL * v17;
      v20 = *(_QWORD *)(v19 + 32) >> 24;
      *((_BYTE *)v13 + 16) = v20;
