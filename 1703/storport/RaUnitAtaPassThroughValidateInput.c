/*
 * XREFs of RaUnitAtaPassThroughValidateInput @ 0x1C00017B0
 * Callers:
  ...
  if ( v17 != -76 || g_InWinPE )
  {
    ...
    if ( !a3 )
    {
      if ( g_InWinPE )
      {
        ...
        {
          v23 = "AutoATAWindowsString12345678901";
          v24 = v22 - "AutoATAWindowsString12345678901";
          while ( *(unsigned __int8 *)v23 == v23[v24 + 2] )
          {
            ++v9;
            ++v23;
            if ( v9 >= 0x20 )
