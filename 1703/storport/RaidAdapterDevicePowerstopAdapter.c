/*
 * XREFs of RaidAdapterDevicePowerstopAdapter @ 0x1C0011F10
 * Callers:
...
NTSTATUS __fastcall RaidAdapterDevicePowerstopAdapter(PIRP Irp, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_e84d6fd860f635d2c40ebca745df63f2_Traceguids, a2, Irp);
  }
  RaidAdapterStop(a2);
