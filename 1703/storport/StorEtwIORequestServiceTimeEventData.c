/*
 * XREFs of StorEtwIORequestServiceTimeEventData @ 0x1C0040B30
 * Callers:
...
unsigned __int64 __fastcall StorEtwIORequestServiceTimeEventData(_QWORD *a1, char a2, unsigned __int64 a3)
{
  ...
  if ( !a2 )
  {
    if ( v10.QuadPart <= 0 || (v12 = a1[87], v10.QuadPart >= v12) )
      v13 = v10.QuadPart - a1[87];
    else
