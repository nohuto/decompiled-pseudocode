/*
 * XREFs of Template_qcccjjzssxcxqqqqqxxxxxzqb @ 0x1C0002C9C
 * Callers:
...
NTSTATUS __fastcall Template_qcccjjzssxcxqqqqqxxxxxzqb(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        __int64 a28)
{
  ...
  const wchar_t *v89; // [rsp+1A8h] [rbp+A0h]
  ...
  int v96; // [rsp+1D4h] [rbp+CCh]
  int v97; // [rsp+220h] [rbp+118h] BYREF

  v97 = a4;
  v28 = -1LL;
  v42 = *(_QWORD *)&WPP_MAIN_CB.DeviceLock.Header.Lock;
  UserData.Ptr = (unsigned __int64)&v97;
  v44 = &a5;
  v29 = 10;
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v93 = 4LL;
  v96 = 0;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventUnitPerformance, 0LL, 0x19u, &UserData);
}
