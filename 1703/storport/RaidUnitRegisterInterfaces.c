/*
 * XREFs of RaidUnitRegisterInterfaces @ 0x1C0013BA8
 * Callers:
 *     RaUnitStartDeviceIrp @ 0x1C005ED90 (RaUnitStartDeviceIrp.c)
 * Callees:
 *     PortMapBuildLunEntry @ 0x1C0013CC0 (PortMapBuildLunEntry.c)
      ...
      if ( v5 >= 0 )
      {
        v5 = IoRegisterDeviceInterface(
               *(PDEVICE_OBJECT *)(a1 + 8),
               ...
               0LL,
               (PUNICODE_STRING)(a1 + 1544));
        if ( v5 >= 0 )
        {
          v5 = IoSetDeviceInterfaceState((PUNICODE_STRING)(a1 + 1544), 1u);
          if ( v5 < 0 )
    ...
    if ( (**(_BYTE **)(a1 + 96) & 0x1F) == 0xD )
    {
      v5 = IoRegisterDeviceInterface(
             *(PDEVICE_OBJECT *)(a1 + 8),
             ...
             0LL,
             (PUNICODE_STRING)(a1 + 1664));
      if ( v5 >= 0 )
      {
        v5 = IoSetDeviceInterfaceState((PUNICODE_STRING)(a1 + 1664), 1u);
        if ( v5 < 0 )
          RtlFreeUnicodeString((PUNICODE_STRING)(a1 + 1664));
      }
    }
