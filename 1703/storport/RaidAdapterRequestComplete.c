/*
 * XREFs of RaidAdapterRequestComplete @ 0x1C002CF98
 * Callers:
...
LABEL_10:
  ...
  *(_BYTE *)(a2 + 16) = *(_BYTE *)(a2 + 16) & 0xE3 | 0x10;
  ...
  if ( (unsigned int)v8.Group >= HIDWORD(WPP_MAIN_CB.Reserved)
    || (unsigned int)ProcNumber.Number >= *((_DWORD *)&WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink->Flink + v8.Group) )
  {
LABEL_20:
  ...
  v6 = ExpInterlockedPushEntrySList(
         (PSLIST_HEADER)(((ProcNumber.Number + ((unsigned __int64)v8.Group << 6)) << 7)
  ...
  if ( !v6 )
  {
    ...
    v9 = *((_QWORD *)&WPP_MAIN_CB.Reserved + 1) + ((ProcNumber.Number + ((unsigned __int64)ProcNumber.Group << 6)) << 7);
    if ( *(_DWORD *)(v9 + 80) != 2 )
    {
      v10 = *(void **)(a1 + 8);
LABEL_21:
