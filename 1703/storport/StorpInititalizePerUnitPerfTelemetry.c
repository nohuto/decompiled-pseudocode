/*
 * XREFs of StorpInititalizePerUnitPerfTelemetry @ 0x1C005F19C
 * Callers:
  ...
  if ( (_DWORD)Size && g_RaidNumberProcessors )
  {
    ...
    if ( Pool
      && (memset(Pool, 0, (unsigned int)Size),
          v4 = RaidAllocatePool(NonPagedPoolNx, (unsigned int)dword_1C00553C4, 0x65546152u, a1[1].QuadPart),
          (a1[233].QuadPart = (__int64)v4) != 0) )
    {
      memset(v4, 0, (unsigned int)dword_1C00553C4);
      if ( UseQPCTime )
      ...
      v7 = RaidAllocatePool(NonPagedPoolNx, (unsigned int)dword_1C00553DC, 0x65546152u, QuadPart);
      a1[234].QuadPart = (__int64)v7;
      if ( v7 )
        memset(v7, 0, (unsigned int)dword_1C00553DC);
      a1[235].QuadPart = 0LL;
      a1[236].QuadPart = 0LL;
      return 0LL;
    }
