/*
 * XREFs of RaidAdapterQueryCapabilitiesIrpCompletion @ 0x1C001BC90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterQueryCapabilitiesIrpCompletion(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_BYTE *)(v3 + 104) & 1) != 0 && (*(_DWORD *)(*(_QWORD *)(v3 + 528) + 184LL) & 4) != 0 )
  {
    *(_QWORD *)((char *)&v9 + 2) = 0LL;
    ...
    v11 = 0;
    v12 = 0;
    v6 = *(_DWORD *)(v4 + 4) & 0x3FF | (*(_DWORD *)(v4 + 4) >> 7) & 0x400;
    LODWORD(v9) = 1572865;
    v7 = *(_DWORD *)(v4 + 12);
    DWORD1(v9) = v6;
    *(_DWORD *)((char *)&v10 + 2) = v7;
    RaidPnPPassToMiniPort(a1, 9LL, v4, (__int64)&v9, 24);
  }
