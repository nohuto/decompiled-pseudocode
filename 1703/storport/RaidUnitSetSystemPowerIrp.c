/*
 * XREFs of RaidUnitSetSystemPowerIrp @ 0x1C000E530
 * Callers:
...
__int64 __fastcall RaidUnitSetSystemPowerIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 200) = EaLength;
  ...
  {
    v9 = (REQUEST_POWER_COMPLETE *)RaidUnitDeviceStackPowerUpCompletion;
    Context = (void *)a1;
  }
  ...
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 57LL, &WPP_e84d6fd860f635d2c40ebca745df63f2_Traceguids, a1, a2, v12);
  }
  return v12;
}
