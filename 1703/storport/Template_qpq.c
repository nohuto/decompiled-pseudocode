/*
 * XREFs of Template_qpq @ 0x1C00384B8
 * Callers:
...
NTSTATUS __fastcall Template_qpq(__int64 a1, __int64 a2, const GUID *a3, int a4, char a5, char a6)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v10 = &a6;
  v11 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventAdapterPowerRequestComplete, a3, 3u, &UserData);
}
