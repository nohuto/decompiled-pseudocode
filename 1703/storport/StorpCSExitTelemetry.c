/*
 * XREFs of StorpCSExitTelemetry @ 0x1C0042B08
 * Callers:
...
void __fastcall StorpCSExitTelemetry(__int64 a1)
{
  ...
  unsigned __int64 *v105; // [rsp+2D0h] [rbp+1D0h]
  ...
  __int64 *v111; // [rsp+300h] [rbp+200h]
  ...
  if ( a1 )
  {
    ...
    if ( *(_QWORD *)(a1 + 5088) )
    {
      ...
      if ( (unsigned int)dword_1C0055010 > 5 && TlgKeywordOn(v6, 0x400000000000uLL) )
      {
        v25 = *(_DWORD *)(a1 + 56);
        v10 = *(_QWORD *)(v9 + 8);
        v44 = v8;
        ...
        v126 = 8LL;
        v128 = 4LL;
        TlgWrite(v11, &unk_1C004D3FE, v7, v8, 0x11u, &pData);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 6)) )
      {
        ...
        if ( (unsigned int)dword_1C0055010 > 5 )
        {
          if ( TlgKeywordOn(v15, 0x400000000000uLL) )
          {
            ...
            v95 = 8LL;
            v97 = 4LL;
            TlgWrite(v20, &unk_1C004BE8E, (LPCGUID)1, v16, 0x17u, &v55);
          }
        }
