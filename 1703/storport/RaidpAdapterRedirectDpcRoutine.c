/*
 * XREFs of RaidpAdapterRedirectDpcRoutine @ 0x1C001E370
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( StorEtwLoggingEnabled && ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x4000000) != 0 && v5 >= 0x19 )
  {
    ...
    if ( v13.QuadPart <= 0 || v13.QuadPart >= v19.QuadPart )
      v10 = v13.QuadPart - v19.QuadPart;
    else
      v10 = v13.QuadPart - v19.QuadPart - 1;
    if ( UseQPCTime )
    {
