/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C004417C
 * Callers:
  ...
  if ( (unsigned int)dword_1C0055010 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x800000000000uLL) )
    {
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = v12 / 0x2710;
      ...
      v90 = v10;
      v92 = 0;
      TlgWrite(&hProvider, &unk_1C004CB62, v16, v17, 0x21u, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAny);
    }
  }
}
