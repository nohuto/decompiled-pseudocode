/*
 * XREFs of RaidUnitRequestTimeout @ 0x1C003E02C
 * Callers:
 ...
 *     RaidUnitUnresponsiveDeviceMarkingNeeded @ 0x1C003F6AC (RaidUnitUnresponsiveDeviceMarkingNeeded.c)
  ...
  if ( *(_DWORD *)(a1 + 1004) )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
    {
      ...
      if ( v5 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v5->Timer) & 8) != 0 && BYTE1(v5->Timer) >= 2u )
        WPP_SF_((__int64)v5->AttachedDevice, 0x46u, (__int64)&WPP_95124dee8acf35750318326cda357b29_Traceguids);
    }
