/*
 * XREFs of RaidAdapterQuerySystemPowerCompletionRoutine @ 0x1C000F2B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterQuerySystemPowerCompletionRoutine(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 34LL, &WPP_e84d6fd860f635d2c40ebca745df63f2_Traceguids, v2, a2);
  }
  if ( *(_BYTE *)(a2 + 65) )
  ...
  if ( v6 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v6->Timer) & 4) != 0 && BYTE1(v6->Timer) >= 4u )
    WPP_SF_qqD(v6->AttachedDevice, 35LL, &WPP_e84d6fd860f635d2c40ebca745df63f2_Traceguids, v2, a2, v4);
