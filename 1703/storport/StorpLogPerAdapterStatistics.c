/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C0001A10
 * Callers:
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
  ...
  if ( ((_DWORD)v2
     ...
     || *(_DWORD *)(a1 + 5248)
     || *(_DWORD *)(a1 + 5260))
    && (unsigned int)dword_1C0055010 > 5
    && TlgKeywordOn(v2, 0x400000000000uLL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    TlgWrite(v5, &unk_1C004D6D7, v6, v7, 0x13u, &pData);
  }
    ...
    && TlgKeywordOn(v3, 0x400000000000uLL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    TlgWrite(v8, &unk_1C004E0A9, v9, v10, 0x13u, &pData);
  }
