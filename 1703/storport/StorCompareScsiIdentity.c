...
__int64 __fastcall StorCompareScsiIdentity(__int64 *a1, __int64 *a2)
{
  ...
  if ( !v14 )
    return 1LL;
  v15 = IsBlankIdPage(a1[4]);
  v16 = IsBlankIdPage(v14);
  if ( v15 )
    return 0LL;
  if ( v16 )
    return 2LL;
