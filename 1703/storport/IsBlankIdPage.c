/*
 * XREFs of IsBlankIdPage @ 0x1C00164B8
 * Callers:
 *     StorCompareScsiIdentity @ 0x1C0016388 (StorCompareScsiIdentity.c)
 * Callees:
 *     StorGetNextVPDIdDescriptor @ 0x1C0016678 (StorGetNextVPDIdDescriptor.c)
 *     StorInitVPDIdEnumeration @ 0x1C00166C4 (StorInitVPDIdEnumeration.c)
 */
