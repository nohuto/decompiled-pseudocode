/*
 * XREFs of RaidUnitResetUnit @ 0x1C003E4F0
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C0042674 (StorpAggregateHierarchicalResetLun.c)
 */
...
__int64 __fastcall RaidUnitResetUnit(__int64 a1)
{
  ...
  _IO_STATUS_BLOCK v30; // [rsp+68h] [rbp-A0h] BYREF
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0055010 > 5 )
      {
        ...
        v45 = 1LL;
        v47 = 8LL;
        TlgWrite((TraceLoggingHProvider)(v22 + 5192), &unk_1C004B8B2, v17, v18, 0xAu, &pData);
      }
