/*
 * XREFs of RaidAdapterSendRPMBCommandSynchronously @ 0x1C002DDE0
 * Callers:
...
__int64 __fastcall RaidAdapterSendRPMBCommandSynchronously(__int64 a1, IRP *a2, char a3, __int64 a4, int a5)
{
  ...
  _BYTE *v23; // r14
  IRP *v24; // rbx
  $A27DC56A689DD4F447A7DF03D6E3A259 *p_AssociatedIrp; // rcx
  __int64 v26; // rax
  __int16 v27; // ax
  __int64 v28; // r8
  int v29; // eax
...
LABEL_42:
  ...
  else
  {
    ...
    *((_QWORD *)Srb + 6) = v10;
    ...
    p_AssociatedIrp = ($A27DC56A689DD4F447A7DF03D6E3A259 *)(Srb + 72);
    *(_QWORD *)(v10 + 168) = Srb;
    v26 = *((_QWORD *)Srb + 3);
    *(_QWORD *)(v10 + 176) = a2;
    v24 = a2;
