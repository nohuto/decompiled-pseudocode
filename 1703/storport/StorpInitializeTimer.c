/*
 * XREFs of StorpInitializeTimer @ 0x1C001B9E4
 * Callers:
...
__int64 __fastcall StorpInitializeTimer(__int64 a1, _QWORD *a2)
{
  ...
  if ( !a1 || !a2 )
  {
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 69LL, &WPP_b8c4fabb6c503934ded1881555415092_Traceguids, a1, a2);
    }
    return 3238002694LL;
  }
  if ( KeGetCurrentIrql() <= 2u )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 71LL, &WPP_b8c4fabb6c503934ded1881555415092_Traceguids, a1);
    }
    return 3238002694LL;
  }
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 70LL, &WPP_b8c4fabb6c503934ded1881555415092_Traceguids, a1);
  }
  return 3238002696LL;
}
