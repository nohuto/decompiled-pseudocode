/*
 * XREFs of StorPortUnitIdleState @ 0x1C0036EB0
 * Callers:
...
void __fastcall StorPortUnitIdleState(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
    ...
    if ( a3 )
    {
      *(_QWORD *)(a1 + 1720) = MEMORY[0xFFFFF78000000008];
      v8 = *(_QWORD *)(a1 + 1456);
      if ( *(_BYTE *)(*(_QWORD *)(a1 + 24) + 108LL) < 0x80u )
        *(_DWORD *)(v8 + 32) &= ~0x40u;
      else
        *(_DWORD *)(v8 + 32) |= 0x40u;
    }
    else
    {
      ...
      if ( *(_QWORD *)(a1 + 1720) )
      {
        ...
        {
          v7 = MEMORY[0xFFFFF78000000008] - *(_QWORD *)(a1 + 1720);
          *(_QWORD *)(a1 + 1728) += v7 / 0x2710;
          if ( v7 / 0x2710 >= 0x2710 )
            ++*(_DWORD *)(a1 + 1780);
        }
        *(_QWORD *)(a1 + 1720) = 0LL;
