/*
 * XREFs of RaidQueryD3ColdInterface @ 0x1C00137E8
 * Callers:
...
__int64 __fastcall RaidQueryD3ColdInterface(PDEVICE_OBJECT DeviceObject, void *a2)
{
  ...
  if ( v5 )
  {
    ...
    CurrentStackLocation->Parameters.WMI.ProviderId = (unsigned __int64)&GUID_D3COLD_SUPPORT_INTERFACE;
    CurrentStackLocation->MinorFunction = 8;
    CurrentStackLocation->Parameters.Create.Options = 65608;
    CurrentStackLocation->Parameters.Read.ByteOffset.QuadPart = (__int64)a2;
