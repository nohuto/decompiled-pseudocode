/*
 * XREFs of RaidInitializeAdapter @ 0x1C005F66C
 * Callers:
 ...
 *     PortGetLinkTimeoutValue @ 0x1C00134E4 (PortGetLinkTimeoutValue.c)
 *     RaidDriverGetName @ 0x1C0018C0C (RaidDriverGetName.c)
 *     RaGetBusInterface @ 0x1C001BE9C (RaGetBusInterface.c)
 *     RaidAllocateDeviceProperty @ 0x1C001BF3C (RaidAllocateDeviceProperty.c)
 *     StorpInitializeAdapterTelemetry @ 0x1C001C1DC (StorpInitializeAdapterTelemetry.c)
 *     __security_check_cookie @ 0x1C001EB90 (__security_check_cookie.c)
 *     memset @ 0x1C001F180 (memset.c)
 *     PortRegistryWriteDeviceKey @ 0x1C005E5BC (PortRegistryWriteDeviceKey.c)
 *     PortGetDriverParameters @ 0x1C005E61C (PortGetDriverParameters.c)
  ...
  if ( (int)result >= 0 )
  {
    ...
    *(_QWORD *)Uuid.Data4 = 0LL;
    ...
    if ( (int)PortRegistryReadDeviceKey(
      ...
      && ExUuidCreate(&Uuid) >= 0 )
    {
      PortRegistryWriteDeviceKey(DeviceObject, (__int64)&DestinationString, (__int64)&v34, 3u, (__int64)p_Uuid, 16);
    }
    *(UUID *)(a1 + 5192) = Uuid;
    ...
    if ( (unsigned int)dword_1C0055010 > 5 )
    {
      if ( TlgKeywordOn(v27, 0x400000000000uLL) )
      {
        ...
        v64 = 4LL;
        v66 = 4LL;
        TlgWrite(v28, &unk_1C004B2B4, v29, v30, 8u, &pData);
      }
    }
    KeInitializeDpc(
