/*
 * XREFs of RaidSyncAcpiEvalMethod @ 0x1C001DD3C
 * Callers:
...
LABEL_9:
  ...
  if ( !v11 )
  {
    ...
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 12LL, &WPP_95124dee8acf35750318326cda357b29_Traceguids, DeviceObject);
    }
    Status = -1073741670;
    goto LABEL_9;
  }
