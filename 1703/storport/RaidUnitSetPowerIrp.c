/*
 * XREFs of RaidUnitSetPowerIrp @ 0x1C000E478
 * Callers:
...
LABEL_8:
    if ( v6 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v6->Timer) & 4) != 0 && BYTE1(v6->Timer) >= 4u )
      WPP_SF_qqDD(v6->AttachedDevice, 49LL, &WPP_e84d6fd860f635d2c40ebca745df63f2_Traceguids, Context, Irp, Options, v8);
    return v8;
  }
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 47LL, &WPP_e84d6fd860f635d2c40ebca745df63f2_Traceguids, Context, Irp);
  }
  return v8;
}
