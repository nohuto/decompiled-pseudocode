/*
 * XREFs of HUBMISC_CreateNewDSM @ 0x1C0028400
 * Callers:
 *     HUBPSM30_CreatingDeviceInConnectedWithResetInProgress @ 0x1C000E4E0 (HUBPSM30_CreatingDeviceInConnectedWithResetInProgress.c)
 * Callees:
...
LABEL_24:
  ...
  if ( v3 >= 0 )
  {
    ...
    {
      g_IoSetActivityIdIrp(*(_QWORD *)(v2 + 248), v2 + 1500);
      if ( g_IoSetActivityIdIrp )
        g_IoSetActivityIdIrp(*(_QWORD *)(v2 + 408), v2 + 1500);
    }
