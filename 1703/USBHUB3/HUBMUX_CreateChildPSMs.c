/*
 * XREFs of HUBMUX_CreateChildPSMs @ 0x1C000CF20
 * Callers:
 *     HUBHSM_CreatingChildPSMs @ 0x1C00075C0 (HUBHSM_CreatingChildPSMs.c)
 * Callees:
      ...
      while ( 1 )
      {
        ...
        if ( *(_BYTE *)(a1 + 232) )
        {
          ...
          if ( *(_BYTE *)(a1 + 253) )
          {
            ...
            v11 = v27[0];
            HIDWORD(v27[2]) = *(_DWORD *)(a1 + 156);
          }
          v27[3] = *(_QWORD *)(a1 + 2472);
          LODWORD(v27[4]) = *(_DWORD *)(a1 + 2480);
          BYTE2(v27[0]) = *(_BYTE *)(a1 + 2458);
        }
        else
        {
