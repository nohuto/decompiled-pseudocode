/*
 * XREFs of HUBPARENT_ResetHub @ 0x1C0006BF0
 * Callers:
 *     HUBHSM_ResettingHubOnResume @ 0x1C0007BF0 (HUBHSM_ResettingHubOnResume.c)
 * Callees:
...
__int64 __fastcall HUBPARENT_ResetHub(__int64 a1)
{
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x2000) != 0 )
    Template_p(v3, &USBHUB3_ETW_EVENT_HUB_RESET_REQUEST_START, 0LL, *(_QWORD *)(a1 + 240));
...
LABEL_8:
  if ( v5 < 0 )
  {
    ...
    return HUBSM_AddEvent(a1 + 1232, 2070LL);
  }
  return result;
}
