/*
 * XREFs of HUBHTX_SetLinkStateToSSDisabledUsingControlTransfer @ 0x1C00060AC
 * Callers:
 *     HUBPSM30_DisablingSuperSpeedOnPortForUnsupportedHubs @ 0x1C000F490 (HUBPSM30_DisablingSuperSpeedOnPortForUnsupportedHubs.c)
