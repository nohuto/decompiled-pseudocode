/*
 * XREFs of DriverEntry_0 @ 0x1C0037D00
 * Callers:
 *     FxDriverEntry @ 0x1C0037CD0 (FxDriverEntry.c)
 * Callees:
 *     ?FxStubDriverUnloadCommon@@YAXXZ @ 0x1C0037C90 (-FxStubDriverUnloadCommon@@YAXXZ.c)
 *     ?FxStubInitTypes@@YAJXZ @ 0x1C0037E70 (-FxStubInitTypes@@YAJXZ.c)
 *     ?FxStubBindClasses@@YAJPEAU_WDF_BIND_INFO@@@Z @ 0x1C0037EF0 (-FxStubBindClasses@@YAJPEAU_WDF_BIND_INFO@@@Z.c)
 *     WdfVersionBind_0 @ 0x1C0038030 (WdfVersionBind_0.c)
...
NTSTATUS __stdcall DriverEntry_0(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  qword_1C005E750 = (__int64)DriverObject;
  DestinationString.Buffer = (wchar_t *)&unk_1C005E760;
  *(_DWORD *)&DestinationString.Length = 34078720;
  ...
  if ( result >= 0 )
  {
    ...
    else
    {
      ...
      {
        DriverUnload = (void (__fastcall *)(_DRIVER_OBJECT *))qword_1C005E738;
        if ( DriverObject->DriverUnload )
          DriverUnload = DriverObject->DriverUnload;
        qword_1C005E738 = (__int64)DriverUnload;
