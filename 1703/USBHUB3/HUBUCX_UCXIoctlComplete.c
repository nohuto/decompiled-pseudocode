/*
 * XREFs of HUBUCX_UCXIoctlComplete @ 0x1C001E650
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HUBUCX_UCXIoctlComplete(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( v4 < 0 )
  {
    ...
    if ( (unsigned int)v8 > 0x38 || (v9 = 0x100000001000001LL, !_bittest64(&v9, v8)) )
    {
      ...
      v10 = *(_QWORD *)(a4 + 8);
      v11 = *(unsigned int *)(*(_QWORD *)v10 + 2560LL);
      if ( (v11 & 0x80u) != 0LL )
    ...
    case 0x491017:
                      ...
                      + 32) & 3) != 0 )
      {
        ...
        *(_DWORD *)(a4 + 1548) = -2147481856;
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64))(v52 + 2552))(v54, v53, -10000000LL);
      }
      else if ( v4 < 0 )
      {
        if ( v4 == -1073741823 )
...
LABEL_88:
    ...
    case 0x49101B:
      ...
      {
        v47 = (_QWORD *)(v46 + 16);
        v48 = *(_QWORD *)(v46 + 16) - 8LL;
        for ( i = (_QWORD *)(v48 + 8); v47 != i; i = (_QWORD *)*i )
        {
          for ( j = 0; j < *(_DWORD *)(v48 + 24); ++j )
          {
            v51 = (unsigned __int64)j << 6;
            if ( *(_DWORD *)(v51 + v48 + 48) == 5 )
              *(_DWORD *)(v51 + v48 + 48) = 6;
          }
          v48 = *i - 8LL;
        }
    ...
    case 0x49101F:
      ...
      if ( v4 < 0 )
      {
        *(_DWORD *)(a4 + 2416) = 1073807361;
        ...
        {
          LODWORD(v56) = v4;
          Template_pq(v44, &USBHUB3_ETW_EVENT_SET_ADDRESS_FAILURE, (const GUID *)(a4 + 1500), *(_QWORD *)(a4 + 24), v56);
        }
        if ( (*(_DWORD *)(a4 + 1440) & 0x20000) != 0 && (*(_DWORD *)(a4 + 1620) & 0x10000) == 0 )
        {
          WPP_RECORDER_SF_(
      ...
      {
        *(_DWORD *)(a4 + 1632) = *(_DWORD *)((*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 1552))(
                                               WdfDriverGlobals,
                                               *(_QWORD *)(a4 + 416),
                                               0LL)
                                           + 28);
        if ( (*(_DWORD *)(a4 + 1620) & 0x10000) != 0 )
        {
          WPP_RECORDER_SF_(
            *(_QWORD *)(*(_QWORD *)(a4 + 8) + 1432LL),
            2u,
...
LABEL_45:
    ...
    if ( v39 )
    {
      for ( kk = *(_QWORD *)(v39 + 16); ; kk = *(_QWORD *)(v43 + 8) )
      {
        v43 = kk - 8;
        if ( v39 + 16 == v43 + 8 )
          break;
        ...
        {
          v42 = (unsigned __int64)mm << 6;
          if ( *(_DWORD *)(v42 + v43 + 48) == 3 )
            *(_DWORD *)(v42 + v43 + 48) = ((v4 >> 31) & 2) + 4;
        }
      }
    }
    *(_DWORD *)(a4 + 128) = 0;
