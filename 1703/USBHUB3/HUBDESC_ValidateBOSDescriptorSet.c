/*
 * XREFs of HUBDESC_ValidateBOSDescriptorSet @ 0x1C0030AD0
 * Callers:
        ...
        __int64 a11)
{
  ...
  {
    v19 = a11;
    WPP_RECORDER_SF_dD(a11, 2u, 5u, 0xE7u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, a3, 5);
    (*(void (__fastcall **)(_QWORD, __int64))(a4 + 24))(*(_QWORD *)(a4 + 40), 23LL);
LABEL_9:
    v20 = 0;
LABEL_40:
    WPP_RECORDER_SF_(v19, 2u, 5u, 0xEDu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
    return v20;
  }
  v19 = a11;
  v41 = 0;
  ...
  {
    (*(void (__fastcall **)(_QWORD, __int64))(a4 + 24))(*(_QWORD *)(a4 + 40), 23LL);
    WPP_RECORDER_SF_ddd(v19, v21, v22, 0xE8u, v30);
    v20 = 0;
  }
  if ( a3 > *(unsigned __int16 *)(a1 + 2) )
  {
  ...
  if ( (unsigned __int64)v24 < v36 )
  {
    while ( 1 )
    {
      ...
      else
      {
        ...
        WPP_RECORDER_SF_dD(v19, 2u, 5u, 0xEAu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31, v32);
...
LABEL_25:
  if ( *(unsigned __int8 *)(a1 + 4) != v11 )
  {
    ...
    LODWORD(v31) = v11;
    WPP_RECORDER_SF_dD(v19, 2u, 5u, 0xEBu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31, v32);
  ...
  {
    WPP_RECORDER_SF_(v19, 2u, 5u, 0xECu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
