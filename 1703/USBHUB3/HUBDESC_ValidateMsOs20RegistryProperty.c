/*
 * XREFs of HUBDESC_ValidateMsOs20RegistryProperty @ 0x1C0032620
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
    ...
    v6 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x14Fu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
    return v6;
  }
  v8 = a3[3];
