/*
 * XREFs of Template_pqccxqqqqqqqsss @ 0x1C00016D0
 * Callers:
...
NTSTATUS Template_pqccxqqqqqqqsss(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  __int64 v68; // [rsp+1D0h] [rbp+D0h] BYREF
  va_list va11; // [rsp+1D0h] [rbp+D0h]
  const char *v70; // [rsp+1D8h] [rbp+D8h]
  const char *v71; // [rsp+1E0h] [rbp+E0h]
  const char *v72; // [rsp+1E8h] [rbp+E8h]
