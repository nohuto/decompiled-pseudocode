/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedPlusDeviceCapabilityDescriptor @ 0x1C002F35C
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *a1 < 0x10u )
  {
    ...
    {
      *v6 = 1;
      WPP_RECORDER_SF_DDD(a5, 2u, v12, 0xABu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v9, *a1, 16);
      goto LABEL_80;
    }
    *v6 = 2;
    *a3 = 16;
    WPP_RECORDER_SF_DDDD(a5, v11, v12, 0xAAu, v30);
  }
  ...
  if ( *a3 <= v10 )
  {
    if ( *((_DWORD *)a1 + 1) >= 0x200u )
    {
      ...
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xAEu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
    ...
    if ( (a1[8] & 0xF0) != 0 )
    {
      ...
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xAFu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
    ...
    if ( a1[3] )
    {
      if ( *(_BYTE *)(a2 + 15) )
        *v6 = 2;
      LODWORD(v31) = a1[3];
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xB0u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
    ...
    if ( *((_WORD *)a1 + 5) )
    {
      ...
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xB1u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
    ...
    do
    {
      ...
      if ( (v16 & 0x80u) != 0 )
      {
        if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
          *v6 = 2;
        LODWORD(v31) = v15;
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0xB2u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
        v13 = 220LL;
        goto LABEL_79;
      }
      if ( (_DWORD)v15 == v14 )
      {
        if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
          *v6 = 2;
        LODWORD(v31) = v15 + 1;
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0xB3u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
        v13 = 222LL;
        goto LABEL_79;
      }
      ...
      if ( (v17 & 0x80u) == 0 )
      {
        if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
          *v6 = 2;
        LODWORD(v31) = v15 + 1;
        WPP_RECORDER_SF_d(a5, 2u, 5u, 0xB4u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
        v13 = 221LL;
        goto LABEL_79;
      }
      ...
      if ( (v20 & 0x40) == 0
        && (((a1[4 * v18 + 12] ^ (unsigned __int8)v20) & 0x30) != 0
      ...
      if ( _bittest(&v25, v26) )
      {
        ...
        LODWORD(v31) = v15;
        WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xB8u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31, v32);
    ...
    if ( ((*((_DWORD *)a1 + 1) >> 5) & 0xF) + 1 != v27 )
    {
      ...
      LODWORD(v31) = v28;
      WPP_RECORDER_SF_dD(a5, 2u, 5u, 0xB9u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31, v32);
    ...
    if ( !v37 )
    {
      ...
      WPP_RECORDER_SF_d(a5, 2u, 5u, 0xBAu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
      v13 = 228LL;
      goto LABEL_79;
    }
  }
  else
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v6 = 2;
    LODWORD(v31) = v9;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0xADu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v31);
    v13 = 217LL;
LABEL_79:
...
LABEL_80:
  result = 0LL;
  if ( *v6 )
    return WPP_RECORDER_SF_(a5, 2u, 5u, 0xBBu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
  return result;
}
