/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSet @ 0x1C0032BB0
 * Callers:
...
LABEL_23:
    *(_DWORD *)a2 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x164u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
    return v5;
  }
  if ( v7 < 0xA )
  {
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x163u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
