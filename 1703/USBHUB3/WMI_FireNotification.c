/*
 * XREFs of WMI_FireNotification @ 0x1C0074E28
 * Callers:
 ...
 *     HUBMISC_GenerateUserNotificationForPersistentOverCurrent @ 0x1C006E3F4 (HUBMISC_GenerateUserNotificationForPersistentOverCurrent.c)
 * Callees:
...
__int64 __fastcall WMI_FireNotification(__int64 a1, unsigned __int16 a2, int a3)
{
  ...
  HUBMISC_StripSymbolicNamePrefix((unsigned __int16 *)(a1 + 2512), &v11);
  v12[5] = v11 + 6;
  v9 = *(_QWORD *)(a1 + 2504);
  v12[1] = a2;
  v12[0] = a3;
