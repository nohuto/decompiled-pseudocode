/*
 * XREFs of HUBDTX_GetConfigDescriptorWithDefaultSizeUsingControlTransfer @ 0x1C002296C
 * Callers:
 *     HUBDSM_GettingConfigDescriptorWhileRenuemrating @ 0x1C001A610 (HUBDSM_GettingConfigDescriptorWhileRenuemrating.c)
 * Callees:
