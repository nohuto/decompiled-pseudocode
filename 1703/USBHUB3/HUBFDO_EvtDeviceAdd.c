/*
 * XREFs of HUBFDO_EvtDeviceAdd @ 0x1C00661A0
 * Callers:
 *     <none>
 * Callees:
 *     RtlStringCchPrintfA @ 0x1C0001008 (RtlStringCchPrintfA.c)
 *     TemplateEventDescriptor @ 0x1C0001210 (TemplateEventDescriptor.c)
...
LABEL_6:
    WPP_RECORDER_SF_d(v8, 2u, v9, v7, (__int64)&WPP_655f8cdbe4fd3d78bdf33e2084db6386_Traceguids, v34);
    goto LABEL_32;
  }
  ...
  *(_DWORD *)(v3 + 96) = USBD_AllocateHubNumber();
  ...
  v14 = (__int64 *)(v3 + 2488);
  if ( (int)imp_WppRecorderLogCreate(WPP_GLOBAL_Control, &v52, v3 + 2488) < 0 )
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, __int64))(WdfFunctions_01015 + 392))(
    ...
    4LL,
    v18);
  DeviceCapabilities = HUBFDO_GetDeviceCapabilities(v36, (_DWORD *)(v3 + 680), *v14);
  if ( DeviceCapabilities < 0 )
  {
    v6 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, WDFDRIVER__ *, void *))(WdfFunctions_01015 + 1616))(
           WdfDriverGlobals,
...
LABEL_18:
  ...
  *(_QWORD *)((char *)v41 + 4) = 1LL;
  ...
  if ( DeviceCapabilities >= 0 )
  {
    ...
    KeResetEvent((PRKEVENT)(v3 + 1120));
    HUBSM_AddHsmEvent(v3, 2023LL);
    v26 = (const void *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 1632))(
                          WdfDriverGlobals,
                          v3);
    HUBMISC_WaitForSignal((PVOID)(v3 + 1120), "Hub FDO PnpCallback", v26);
    DeviceCapabilities = *(_DWORD *)(v3 + 1144);
  }
LABEL_32:
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 2) != 0 )
  {
    ...
    Template_pq(v10, &USBHUB3_ETW_EVENT_HUB_ADD_DEVICE_COMPLETE, 0LL, v27, v31);
  }
  if ( DeviceCapabilities < 0 )
  {
    if ( v3 && *(_DWORD *)(v3 + 96) )
