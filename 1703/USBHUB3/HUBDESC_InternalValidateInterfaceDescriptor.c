/*
 * XREFs of HUBDESC_InternalValidateInterfaceDescriptor @ 0x1C002D9EC
 * Callers:
        ...
        __int64 a5)
{
  ...
  *a3 = v9;
  if ( (unsigned __int8)v9 < 9u )
  {
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_DDD(v12, 2u, v15, 0x68u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, *a1, v10, v15);
      goto LABEL_58;
    }
    ...
    if ( *v5 != 1 )
    {
      if ( v32 )
      {
        if ( _bittest64(*(const signed __int64 **)(a2 + 216), v18) )
        {
          ...
          LODWORD(v30) = v18;
          LODWORD(v29) = v10;
          WPP_RECORDER_SF_dD(v12, 2u, 5u, 0x6Cu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v29, v30);
...
LABEL_58:
  ...
  {
    v11 = 0;
    WPP_RECORDER_SF_(v12, 2u, 5u, 0x71u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
  }
  return v11;
}
