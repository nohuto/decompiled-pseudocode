/*
 * XREFs of HUBFDO_BuildUsb20HubDescriptor @ 0x1C000B828
 * Callers:
    ...
    if ( (int)v5 > 0 )
    {
      if ( (int)v5 <= 2 )
      {
        *a2 = *(_OWORD *)(a1 + 1148);
        ...
        a2[2] = *(_OWORD *)(a1 + 1180);
        a2[3] = *(_OWORD *)(a1 + 1196);
        *((_DWORD *)a2 + 16) = *(_DWORD *)(a1 + 1212);
        *((_WORD *)a2 + 34) = *(_WORD *)(a1 + 1216);
        LOBYTE(v5) = *(_BYTE *)(a1 + 1218);
        *((_BYTE *)a2 + 70) = v5;
      }
      else if ( (_DWORD)v5 == 3 )
      {
        ...
        *((_BYTE *)a2 + 2) = v7;
        v8 = v7;
        v9 = 0;
        *(_WORD *)((char *)a2 + 3) = *(_WORD *)(a1 + 1151) & 0x1F;
        *((_BYTE *)a2 + 5) = *(_BYTE *)(a1 + 1153);
        LOBYTE(v5) = *(_BYTE *)(a1 + 1154);
        *((_BYTE *)a2 + 6) = v5;
        v10 = (v8 >> 3) + 1;
        if ( (_DWORD)v10 )
        {
