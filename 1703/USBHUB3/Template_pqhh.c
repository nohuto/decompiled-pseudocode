/*
 * XREFs of Template_pqhh @ 0x1C0001B3C
 * Callers:
...
NTSTATUS Template_pqhh(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v8 = 2LL;
  v10 = 2LL;
  return EtwWrite(Microsoft_Windows_USB_USBHUB3Handle, a2, 0LL, 4u, &UserData);
}
