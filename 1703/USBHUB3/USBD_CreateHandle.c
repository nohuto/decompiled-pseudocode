/*
 * XREFs of USBD_CreateHandle @ 0x1C0034E64
 * Callers:
 *     HUBFDO_SetupHubPostErrataQuery @ 0x1C000C40C (HUBFDO_SetupHubPostErrataQuery.c)
 * Callees:
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C00347A8 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
