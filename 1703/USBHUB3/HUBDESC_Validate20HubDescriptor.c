/*
 * XREFs of HUBDESC_Validate20HubDescriptor @ 0x1C0031A38
 * Callers:
...
char __fastcall HUBDESC_Validate20HubDescriptor(unsigned __int8 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !a1 )
  {
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x125u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 2LL);
LABEL_38:
    v19 = 0;
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x130u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
    return v19;
  }
  if ( !a1[2] )
  {
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x127u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, 0);
  ...
  {
    LODWORD(v17) = *a1;
    WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x128u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v17, v9);
  ...
  if ( *a1 > v9 )
  {
    LODWORD(v18) = v9;
    LODWORD(v17) = *a1;
    WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x129u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v17, v18);
  ...
  {
    LODWORD(v17) = v11;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x12Au, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v17);
  ...
  if ( (v12 & 2) != 0 )
  {
    if ( *(_BYTE *)(a3 + 15) )
      v4 = 2;
    LODWORD(v17) = v12;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x12Bu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v17);
  ...
  if ( (v12 & 0xFF00) != 0 )
  {
    if ( *(_BYTE *)(a3 + 15) )
      v4 = 2;
    LODWORD(v17) = v12;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x12Cu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v17);
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 9LL);
  }
  if ( (a1[7] & 1) != 0 )
  {
    if ( *(_BYTE *)(a3 + 15) )
      v4 = 2;
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x12Du, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
  ...
  if ( v14 != 0xFF && (v14 & a1[v22 + 6]) != 0 )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a3) )
      v4 = 2;
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x12Eu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
  ...
  for ( i = 0; i < v21; ++i )
  {
    if ( a1[i + 7 + v13] != 0xFF )
    {
      if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a3) )
        v4 = 2;
      WPP_RECORDER_SF_(a4, 2u, 5u, 0x12Fu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
