/*
 * XREFs of HUBHTX_ValidateAndCacheHubConfigDescriptor @ 0x1C0002DA8
 * Callers:
...
__int64 __fastcall HUBHTX_ValidateAndCacheHubConfigDescriptor(__int64 a1)
{
  ...
  LOWORD(v12[0]) = *(_WORD *)(a1 + 2426);
  HIDWORD(v12[0]) = *(_DWORD *)(a1 + 248);
  v12[3] = HUBMISC_LogDescriptorValidationErrorForHub;
  v12[4] = HUBMISC_LogDescriptorValidationWarningForHub;
  v3 = *(unsigned __int16 **)(a1 + 1224);
  v12[5] = a1;
  if ( v3[1] < 0xFFu )
  {
    v2 = v3;
    PoolWithTag = ExAllocatePoolWithTag(ExDefaultNonPagedPoolType, v3[1], 0x68334855u);
    *(_QWORD *)(a1 + 1224) = PoolWithTag;
    if ( !PoolWithTag )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2488), 2u, 3u, 0x15u, (__int64)&WPP_aebd157f2d2c311e8b884f2de7866b9a_Traceguids);
      v5 = -1073741670;
      goto LABEL_10;
    }
  ...
  if ( !(unsigned __int8)HUBDESC_ValidateConfigurationDescriptorSet(
                           *(_QWORD *)(a1 + 1224),
                           *(unsigned __int16 *)(*(_QWORD *)(a1 + 1224) + 2LL),
                           (unsigned int)v12,
                           *(_QWORD *)(a1 + 2488),
                           0LL) )
    goto LABEL_6;
  v6 = *(_WORD *)(*(_QWORD *)(a1 + 1224) + 2LL);
  v7 = *(_WORD *)(a1 + 2572);
  if ( v6 != v7 )
  {
    v11 = v7;
