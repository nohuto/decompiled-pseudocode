/*
 * XREFs of HUBREG_EvtWorkItemPerformPostSurpriseRemovalRecoveryActions @ 0x1C0072210
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  LODWORD(v11) = v6;
  WPP_RECORDER_SF_d(*(_QWORD *)(v7 + 64), 2u, 2u, v8, (__int64)&WPP_c583747ee8293f01720d1e741a546fd1_Traceguids, v11);
LABEL_14:
  if ( v15 )
