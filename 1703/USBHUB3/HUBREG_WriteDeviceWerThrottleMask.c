/*
 * XREFs of HUBREG_WriteDeviceWerThrottleMask @ 0x1C0072C38
 * Callers:
...
__int64 __fastcall HUBREG_WriteDeviceWerThrottleMask(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      {
        LODWORD(v11) = v8;
        WPP_RECORDER_SF_d(a3, 2u, 5u, 0x6Du, (__int64)&WPP_c583747ee8293f01720d1e741a546fd1_Traceguids, v11);
      }
    }
    else
    {
      LODWORD(v11) = v7;
      WPP_RECORDER_SF_d(a3, 2u, 5u, 0x6Cu, (__int64)&WPP_c583747ee8293f01720d1e741a546fd1_Traceguids, v11);
    }
  }
  else
  {
    LODWORD(v10) = v5;
    WPP_RECORDER_SF_d(a3, 2u, 5u, 0x6Bu, (__int64)&WPP_c583747ee8293f01720d1e741a546fd1_Traceguids, v10);
  }
  if ( v13 )
