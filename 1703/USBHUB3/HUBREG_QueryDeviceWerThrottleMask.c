/*
 * XREFs of HUBREG_QueryDeviceWerThrottleMask @ 0x1C0072A4C
 * Callers:
...
__int64 __fastcall HUBREG_QueryDeviceWerThrottleMask(__int64 a1, __int64 a2)
{
  ...
  if ( v3 >= 0 )
  {
    ...
    {
      LODWORD(v9) = v4;
      WPP_RECORDER_SF_d(a2, 2u, 5u, 0x69u, (__int64)&WPP_c583747ee8293f01720d1e741a546fd1_Traceguids, v9);
    }
  }
  else
  {
    LODWORD(v8) = v3;
    WPP_RECORDER_SF_d(a2, 2u, 5u, 0x68u, (__int64)&WPP_c583747ee8293f01720d1e741a546fd1_Traceguids, v8);
  }
  if ( v12 )
