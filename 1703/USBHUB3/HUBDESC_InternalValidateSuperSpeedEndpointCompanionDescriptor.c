/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedEndpointCompanionDescriptor @ 0x1C002CE54
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  *a3 = v13;
  ...
  {
    v14 = a5;
    WPP_RECORDER_SF_d(a5, 2u, 5u, 0x47u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v11);
    v15 = 40LL;
LABEL_102:
  ...
  if ( (unsigned __int8)v13 < 6u )
  {
    ...
    *v6 = 2;
    if ( v17 < 6 )
    {
      v18 = 1;
      *v6 = 1;
      WPP_RECORDER_SF_DDD(v14, 2u, v16, 0x48u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, *a1, v11, 6);
      goto LABEL_104;
    }
  ...
  if ( *a1 > 6u )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a2) )
      *v6 = 2;
    WPP_RECORDER_SF_DDD(v14, 2u, v19, 0x4Au, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, *a1, v11, 6);
  ...
  {
    LODWORD(v36) = v11;
    WPP_RECORDER_SF_d(v14, 2u, 5u, 0x4Bu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36);
    (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 41LL);
    *v6 = 2;
LABEL_105:
    v18 = 0;
    WPP_RECORDER_SF_(v14, 2u, 5u, 0x5Eu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
    return v18;
  }
  v21 = v40;
  v22 = (unsigned int)a6;
  ...
  *(_DWORD *)(a2 + 256) = v23;
  if ( *v21 > v22 )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v6 = 2;
    LODWORD(v36) = v11;
    WPP_RECORDER_SF_d(v14, 2u, 5u, 0x4Cu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36);
    v15 = 44LL;
    goto LABEL_102;
  }
  v24 = *(_QWORD *)(a2 + 192);
  switch ( *(_BYTE *)(v24 + 3) & 3 )
  {
    case 0:
      if ( a1[2] )
      {
        ...
        LODWORD(v37) = a1[2];
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x4Du, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      if ( a1[3] )
      {
        ...
        LODWORD(v37) = a1[3];
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x4Eu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      LODWORD(v36) = v11;
      WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x4Fu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      v15 = 39LL;
      goto LABEL_102;
    case 1:
      v29 = v23 & 0xFFFFFFDF;
      ...
      *(_DWORD *)(a2 + 256) = v30 | (a1[3] >> 4) & 0xFFFFFF8;
      if ( a1[2] > 0xFu )
      {
        ...
        LODWORD(v37) = a1[2];
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x58u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      if ( (*(_DWORD *)(a2 + 256) & 8) == 0 && (a1[3] & 3) == 3 )
      {
        ...
        LODWORD(v37) = a1[3] & 3;
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_Dd(v14, v32, 5u, 0x5Au, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      if ( (a1[3] & 0x7C) != 0 )
      {
        ...
        LODWORD(v37) = a1[3];
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x5Bu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      if ( *((_WORD *)a1 + 2) != 1 )
      {
        ...
        LODWORD(v37) = *((unsigned __int16 *)a1 + 2);
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_Dd(v14, v30, 5u, 0x5Du, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
    ...
    case 2:
      if ( a1[2] > 0xFu )
      {
        ...
        LODWORD(v37) = a1[2];
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x50u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      if ( (a1[3] & 0x1Fu) > 0x10 )
      {
        ...
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_Dd(v14, v28, 5u, 0x51u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      if ( a1[3] >= 0x20u )
      {
        ...
        LODWORD(v37) = a1[3];
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x52u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      LODWORD(v37) = *((unsigned __int16 *)a1 + 2);
      LODWORD(v36) = v11;
      WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x53u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      v15 = 36LL;
      goto LABEL_102;
    case 3:
      if ( a1[2] > 0xFu )
      {
        ...
        LODWORD(v37) = a1[2];
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x54u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
      ...
      if ( a1[3] )
      {
        ...
        LODWORD(v37) = a1[3];
        LODWORD(v36) = v11;
        WPP_RECORDER_SF_dD(v14, 2u, 5u, 0x56u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v36, v37);
