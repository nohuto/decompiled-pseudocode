/*
 * XREFs of HUBDSM_ComputingU1U2TimeoutsAndExitLatency @ 0x1C001DDA0
 * Callers:
 *     <none>
 * Callees:
 *     HUBMISC_ComputeU1Timeout @ 0x1C0027B4C (HUBMISC_ComputeU1Timeout.c)
 *     HUBMISC_ComputeU2Timeout @ 0x1C0027D68 (HUBMISC_ComputeU2Timeout.c)
 */
...
__int64 __fastcall HUBDSM_ComputingU1U2TimeoutsAndExitLatency(__int64 a1)
{
  ...
  if ( v5 || v4 )
  {
    ...
    v9 = *(unsigned __int16 *)(v1 + 2558)
       + *(unsigned __int16 *)(*(_QWORD *)v1 + 1156LL)
       + *(unsigned __int16 *)(*(_QWORD *)v1 + 2460LL);
