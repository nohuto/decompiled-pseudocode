/*
 * XREFs of HUBREG_WriteValueToHubHardwareKey @ 0x1C00705E0
 * Callers:
...
__int64 __fastcall HUBREG_WriteValueToHubHardwareKey(__int64 a1, __int64 a2, int a3)
{
  ...
  LODWORD(v9) = v5;
  WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2488), 2u, 3u, v7, (__int64)&WPP_c583747ee8293f01720d1e741a546fd1_Traceguids, v9);
LABEL_6:
  if ( v10 )
