/*
 * XREFs of WerKernelSubmitReport @ 0x1C00375F4
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C0075848 (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpGetRegistryKey @ 0x1C0036DE8 (WerpGetRegistryKey.c)
 *     WerpAllocateAndInitializeSid @ 0x1C0036EA0 (WerpAllocateAndInitializeSid.c)
 *     WerpParseKeyName @ 0x1C0036F88 (WerpParseKeyName.c)
 *     WerStartSystemErrorHandler @ 0x1C0037438 (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C0037544 (WerWaitForSystemErrorHandler.c)
