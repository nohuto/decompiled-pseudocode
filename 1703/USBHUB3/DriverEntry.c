 ...
 *     McGenEventRegister @ 0x1C00011C4 (McGenEventRegister.c)
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  if ( v5 >= 0 )
  {
    ...
    *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters = MmGetSystemRoutineAddress(&DestinationString);
    ...
    qword_1C005E530 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 3448))(WdfDriverGlobals);
    dword_1C005E500 = WPP_MAIN_CB.Queue.Wcb.WaitQueueEntry.SortKey;
    qword_1C005E504 = (__int64)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine;
    dword_1C005E50C = *((_DWORD *)&WPP_MAIN_CB.Queue.Wcb.1 + 5);
    dword_1C005E510 = (int)WPP_MAIN_CB.Queue.Wcb.DeviceContext;
  }
  else
  {
