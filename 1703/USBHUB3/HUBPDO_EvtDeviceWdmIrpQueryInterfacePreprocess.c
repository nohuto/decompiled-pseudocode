/*
 * XREFs of HUBPDO_EvtDeviceWdmIrpQueryInterfacePreprocess @ 0x1C0013480
 * Callers:
...
__int64 __fastcall HUBPDO_EvtDeviceWdmIrpQueryInterfacePreprocess(__int64 a1, IRP *a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
         ...
         off_1C005B070);
  v5 = v4;
  if ( (*(_DWORD *)(*(_QWORD *)(v4 + 24) + 1620LL) & 2) != 0 )
  {
    ...
    if ( CurrentStackLocation->Parameters.CreatePipe.Parameters != (_NAMED_PIPE_CREATE_PARAMETERS *)v4 )
    {
      ...
      if ( RtlCompareMemory(CurrentStackLocation->Parameters.Create.SecurityContext, &GUID_USBD_INTERFACE_V1, 0x10uLL) == 16 )
      {
        CurrentStackLocation->Parameters.CreatePipe.Parameters = *(_NAMED_PIPE_CREATE_PARAMETERS **)(*(_QWORD *)(v5 + 24) + 24LL);
        if ( CurrentStackLocation->Parameters.QueryInterface.Size == 152
          || CurrentStackLocation->Parameters.QueryInterface.Version == 1538 )
        {
