/*
 * XREFs of HUBFDO_EvtDeviceD0Entry @ 0x1C000AB80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_EvtDeviceD0Entry(__int64 a1)
{
  ...
  *(_DWORD *)(v2 + 2568) = 1;
  ...
  v4 = (PVOID *)(v2 + 2528);
  if ( !*(_QWORD *)(v2 + 2528) && (*(_DWORD *)(v2 + 40) & 0x4000000) != 0 )
  {
  ...
  {
    v7 = EtwActivityIdControl(3u, (LPGUID)(v3 + 2244));
    if ( v7 >= 0 )
    {
      if ( g_IoSetActivityIdIrp )
        g_IoSetActivityIdIrp(*(_QWORD *)(v3 + 784), v3 + 2244);
      v8 = 1;
    }
  }
