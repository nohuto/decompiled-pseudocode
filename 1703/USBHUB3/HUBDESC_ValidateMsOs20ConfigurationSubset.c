/*
 * XREFs of HUBDESC_ValidateMsOs20ConfigurationSubset @ 0x1C0031F30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x139u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
...
LABEL_4:
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Au, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
  return v8;
}
