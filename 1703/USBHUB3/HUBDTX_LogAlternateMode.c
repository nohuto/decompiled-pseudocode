/*
 * XREFs of HUBDTX_LogAlternateMode @ 0x1C0024D28
 * Callers:
 *     HUBDSM_CheckingIfAlternateModeStringDescriptorShouldBeQueried @ 0x1C001B430 (HUBDSM_CheckingIfAlternateModeStringDescriptorShouldBeQueried.c)
