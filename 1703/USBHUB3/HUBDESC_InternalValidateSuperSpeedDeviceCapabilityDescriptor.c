/*
 * XREFs of HUBDESC_InternalValidateSuperSpeedDeviceCapabilityDescriptor @ 0x1C002FA98
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( v15 )
  {
    ...
    if ( v14 < 0xA )
    {
      v19 = 1;
      *v9 = 1;
      WPP_RECORDER_SF_DDD(v13, 2u, v17, 0xBDu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v12, *a1, 10);
      goto LABEL_59;
    }
    v18 = v31;
    *v9 = 2;
    *v18 = 10;
    WPP_RECORDER_SF_DDDD(v13, v16, v17, 0xBCu, v27);
  }
  if ( *a1 > 0xAu )
  {
    if ( *(_BYTE *)(a2 + 12) || (unsigned __int16)(*(_WORD *)a2 - 768) <= 0x10u )
      *v9 = 2;
    WPP_RECORDER_SF_DDD(v13, 2u, a3, 0xBEu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v12, *a1, 10);
  ...
  if ( *v31 <= (unsigned int)a7 )
  {
    if ( (a1[3] & 0xFD) != 0 )
    {
      if ( *(_BYTE *)(a2 + 15) )
        *v9 = 2;
      LODWORD(v28) = a1[3];
      WPP_RECORDER_SF_d(v13, 2u, 5u, 0xC0u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28);
    ...
    if ( (*((_WORD *)a1 + 2) & 0xFFF0) != 0 )
    {
      ...
      WPP_RECORDER_SF_d(v13, 2u, 5u, 0xC1u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28);
      (*(void (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), 143LL);
    }
    if ( !*((_WORD *)a1 + 2) )
    {
      *v9 = 2;
      WPP_RECORDER_SF_(v13, 2u, 5u, 0xC2u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
...
LABEL_44:
        ...
        if ( v24 < 0xBu )
        {
          if ( a5 )
          {
            *a5 = v24;
            LODWORD(v28) = a1[7];
            WPP_RECORDER_SF_d(v13, 4u, 5u, 0xC6u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28);
          }
        }
        else
        {
          if ( *(_BYTE *)(a2 + 12) || (unsigned __int16)(*(_WORD *)a2 - 768) <= 0x10u )
            *v9 = 2;
          LODWORD(v28) = a1[7];
          WPP_RECORDER_SF_d(v13, 2u, 5u, 0xC5u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28);
        ...
        if ( v25 < 0x800u )
        {
          if ( a6 )
          {
            *a6 = v25;
            ...
            WPP_RECORDER_SF_d(v13, 4u, 5u, 0xC8u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28);
          }
        }
        else
        {
          if ( *(_BYTE *)(a2 + 12) || (unsigned __int16)(*(_WORD *)a2 - 768) <= 0x10u )
            *v9 = 2;
          LODWORD(v28) = *((unsigned __int16 *)a1 + 4);
          WPP_RECORDER_SF_d(v13, 2u, 5u, 0xC7u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28);
      ...
      *v9 = 2;
      ...
      LODWORD(v28) = a1[6];
      WPP_RECORDER_SF_dD(v13, 2u, 5u, 0xC4u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28, v29);
      v21 = 141LL;
    }
    else
    {
      if ( *(_BYTE *)(a2 + 15) )
        *v9 = 2;
      LODWORD(v28) = a1[6];
      WPP_RECORDER_SF_d(v13, 2u, 5u, 0xC3u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28);
      v21 = 142LL;
    }
  ...
  if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
    *v9 = 2;
  LODWORD(v28) = v12;
  WPP_RECORDER_SF_d(v13, 2u, 5u, 0xBFu, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids, v28);
...
LABEL_59:
  ...
  {
    v19 = 0;
    WPP_RECORDER_SF_(v13, 2u, 5u, 0xC9u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
  }
  return v19;
}
