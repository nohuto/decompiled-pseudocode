/*
 * XREFs of HUBACPI_EvalAcpiMethodEx @ 0x1C007337C
 * Callers:
...
LABEL_3:
  ...
  if ( (unsigned __int64)(v12 + 6) <= 0x100 )
  {
    ...
    *v18 = 0;
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, _QWORD *))(WdfFunctions_01015 + 2024))(
            ...
            v21,
            v29) )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2488), 2u, 3u, 0x15u, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2488), 2u, 3u, 0x17u, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
      v10 = -1072431089;
    }
  }
  else
  {
    v10 = -1073741811;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2488), 2u, 3u, 0x12u, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
  }
LABEL_23:
  if ( v26 )
