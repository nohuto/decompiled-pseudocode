/*
 * XREFs of HUBHTX_CheckAndSelectIfAny30PortChangeSet @ 0x1C0004640
 * Callers:
 *     HUBPSM30_CheckIfThereIsAPortChangeOnStartResumeOnGetPortStatus @ 0x1C000FE90 (HUBPSM30_CheckIfThereIsAPortChangeOnStartResumeOnGetPortStatus.c)
 * Callees:
