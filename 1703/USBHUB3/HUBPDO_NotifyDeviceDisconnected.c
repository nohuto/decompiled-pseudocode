/*
 * XREFs of HUBPDO_NotifyDeviceDisconnected @ 0x1C0012C90
 * Callers:
 ...
 *     HUBDSM_NotifyingDeviceDisconnectedOnDetachWithSpecialFile @ 0x1C0018ED0 (HUBDSM_NotifyingDeviceDisconnectedOnDetachWithSpecialFile.c)
 *     HUBDSM_PurgingDeviceIoOnDetachInConfigured @ 0x1C0018F30 (HUBDSM_PurgingDeviceIoOnDetachInConfigured.c)
 *     HUBDSM_ReportingDeviceMissing @ 0x1C0019230 (HUBDSM_ReportingDeviceMissing.c)
 *     HUBDSM_WaitingForReportedMissingOnDetachInUnConfigured @ 0x1C0019B40 (HUBDSM_WaitingForReportedMissingOnDetachInUnConfigured.c)
 * Callees:
