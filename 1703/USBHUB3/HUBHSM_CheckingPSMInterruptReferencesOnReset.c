/*
 * XREFs of HUBHSM_CheckingPSMInterruptReferencesOnReset @ 0x1C0007470
 * Callers:
 *     <none>
 * Callees:
 *     HUBMUX_QueueSurpriseRemovalToAllPSMs @ 0x1C000D6DC (HUBMUX_QueueSurpriseRemovalToAllPSMs.c)
 *     HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased @ 0x1C000D7FC (HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased.c)
 */
