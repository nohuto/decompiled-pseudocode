/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionInformationExV2 @ 0x1C00692FC
 * Callers:
 ...
 *     HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher @ 0x1C00280AC (HUBMISC_IsDeviceSuperSpeedPlusCapableOrHigher.c)
 *     HUBMISC_IsDeviceOperatingAtSuperSpeedPlusOrHigher @ 0x1C00280F0 (HUBMISC_IsDeviceOperatingAtSuperSpeedPlusOrHigher.c)
        ...
        if ( (v12 & 4) != 0 )
        {
          ...
          *((_DWORD *)v28 + 1) = 16;
          (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64))(WdfFunctions_01015 + 2200))(
            ...
            a2,
            16LL);
          for ( i = *(_QWORD *)(v9 + 2328); ; i = *(_QWORD *)(v14 + 248) )
          {
            v14 = i - 248;
            if ( v9 + 2328 == v14 + 248 )
              break;
            if ( *(_WORD *)(v14 + 200) == (_WORD)v7 )
            {
              ...
              {
                *((_DWORD *)v28 + 2) |= 1u;
                if ( *(_DWORD *)(v9 + 248) == 2 || *(_DWORD *)(v9 + 2184) == 4 )
                  *((_DWORD *)v28 + 2) |= 2u;
              }
              else if ( v19 == 768 )
              {
