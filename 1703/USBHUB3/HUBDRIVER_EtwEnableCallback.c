/*
 * XREFs of HUBDRIVER_EtwEnableCallback @ 0x1C0065EF0
 * Callers:
  ...
  if ( a2 == 1 )
  {
    ...
    *(_QWORD *)ActivityId.Data4 = 0LL;
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 1) != 0 )
      TemplateEventDescriptor(v4, &USBHUB3_ETW_EVENT_RUNDOWN_START, &ActivityId);
    for ( i = *(_QWORD *)(v3 + 16); ; i = *(_QWORD *)(v8 + 2400) )
    {
      v8 = i - 2400;
      if ( v3 + 16 == v8 + 2400 )
        break;
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 1) != 0 )
      TemplateEventDescriptor(v4, &USBHUB3_ETW_EVENT_RUNDOWN_COMPLETE, &ActivityId);
  }
  else if ( !a2 )
  {
