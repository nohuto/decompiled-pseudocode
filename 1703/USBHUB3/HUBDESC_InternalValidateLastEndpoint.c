/*
 * XREFs of HUBDESC_InternalValidateLastEndpoint @ 0x1C002BDF8
 * Callers:
...
bool __fastcall HUBDESC_InternalValidateLastEndpoint(__int64 a1, int *a2, __int64 a3)
{
  ...
  if ( (v6 & 2) != 0 )
  {
    if ( *(_DWORD *)(a1 + 4) == 3 )
    {
      ...
      {
        *v4 = 2;
        WPP_RECORDER_SF_(a3, 2u, 5u, 0x19u, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
      ...
      {
        *v4 = 2;
        WPP_RECORDER_SF_(a3, 2u, 5u, 0x1Au, (__int64)&WPP_12a06aa43bd1352a4a1eaab3037908e2_Traceguids);
