/*
 * XREFs of HUBACPI_GetAcpiPortAttributes @ 0x1C0073AD0
 * Callers:
...
LABEL_3:
  ...
  if ( v5 == -1073741637 )
  {
    ...
    v7 = 4;
LABEL_6:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2488), v7, 3u, v6, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
    goto LABEL_47;
  }
  if ( v5 == -2147483643 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2488), 4u, 3u, 0x22u, (__int64)&WPP_1f8d4bc1bafd3b07a71bc23db7e99769_Traceguids);
...
LABEL_10:
    ...
    if ( *(_DWORD *)(v40 + 4) > 1u )
    {
      while ( 1 )
      {
        ...
        for ( i = *(_QWORD *)(a1 + 2328); ; i = *(_QWORD *)(v14 + 248) )
        {
          v14 = i - 248;
          if ( a1 + 2328 == v14 + 248 )
            goto LABEL_45;
