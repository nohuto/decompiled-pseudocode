/*
 * XREFs of HUBHTX_GetRequestedPortStatusUsingControlTransfer @ 0x1C000552C
 * Callers:
 *     HUBHSM_GettingPortStatusOnPDORequestFromConfigWithIntTransfer @ 0x1C0007610 (HUBHSM_GettingPortStatusOnPDORequestFromConfigWithIntTransfer.c)
 * Callees:
...
__int64 __fastcall HUBHTX_GetRequestedPortStatusUsingControlTransfer(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 2552);
  v3 = *(_BYTE *)(a1 + 920) & 0x1C;
  *(_BYTE *)(a1 + 921) = 0;
  *(_BYTE *)(a1 + 920) = v3 | 0xA3;
  *(_WORD *)(a1 + 924) = *(_WORD *)(v1 + 200);
