/*
 * XREFs of HUBFDO_IoctlGetPortConnectorProperties @ 0x1C0068F38
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    *((_WORD *)v31 + 6) = v12;
    *((_DWORD *)v31 + 1) = 18;
    for ( i = v9[291]; ; i = *(_QWORD *)(v14 + 248) )
    {
      v14 = i - 248;
      if ( v9 + 291 == (_QWORD *)(v14 + 248) )
        goto LABEL_8;
    ...
    if ( v14 )
    {
      ...
      if ( *((_WORD *)v31 + 6) <= 1u )
      {
        ...
        if ( CompanionPort )
        {
          v23 = (unsigned __int16 *)(*(_QWORD *)CompanionPort + 2512LL);
...
LABEL_8:
  ...
  WPP_RECORDER_SF_d(v9[311], 2u, 3u, 0x2Du, (__int64)&WPP_655f8cdbe4fd3d78bdf33e2084db6386_Traceguids, v10);
LABEL_10:
