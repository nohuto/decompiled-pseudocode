/*
 * XREFs of HUBUCX_ForwardRequestToUCX @ 0x1C0021448
 * Callers:
 *     HUBDSM_FowardingStreamsRequestToUcxInConfiguredSuspendedWithSpecialFile @ 0x1C0018DD0 (HUBDSM_FowardingStreamsRequestToUcxInConfiguredSuspendedWithSpecialFile.c)
 * Callees:
...
void __fastcall HUBUCX_ForwardRequestToUCX(_QWORD *a1)
{
          ...
          0LL) )
  {
    ...
    HUBSM_AddEvent((__int64)(a1 + 61), 4016);
  }
}
