/*
 * XREFs of HUBMISC_LogResetTimeout @ 0x1C002A6F4
 * Callers:
 *     HUBDSM_LoggingResetTimeoutInResettingFor30 @ 0x1C001A0D0 (HUBDSM_LoggingResetTimeoutInResettingFor30.c)
 * Callees:
...
char __fastcall HUBMISC_LogResetTimeout(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 2416) = 1073807362;
  ...
  {
    v2 = *(_QWORD *)v3;
    if ( (*(_DWORD *)(*(_QWORD *)v3 + 2560LL) & 0x40) != 0 )
