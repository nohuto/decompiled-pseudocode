/*
 * XREFs of HUBUCX_UpdateHubInformationUsingUCXIoctl @ 0x1C0020BD0
 * Callers:
 *     HUBHSM_UpdatingHubInfoInUCX @ 0x1C0008750 (HUBHSM_UpdatingHubInfoInUCX.c)
 * Callees:
...
LABEL_3:
    LODWORD(v6) = v3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2488), 2u, 3u, v5, (__int64)&WPP_085dd3e5d97b340416555628d039db45_Traceguids, v6);
    goto LABEL_14;
  }
  memset(v7, 0, 0x38uLL);
  v7[4] = v9;
  ...
  memset(v8, 0, 0x28uLL);
  *(_DWORD *)v8 = 40;
  *((_QWORD *)v8 + 1) = *(_QWORD *)(a1 + 240);
  *((_QWORD *)v8 + 2) = *(_QWORD *)(a1 + 240);
  *((_DWORD *)v8 + 6) = *(unsigned __int16 *)(a1 + 48);
  if ( *(_DWORD *)(a1 + 248) == 2 )
  {
    ...
    *((_DWORD *)v8 + 7) = 1;
           ...
           *(_QWORD *)(a1 + 2488)) )
    {
      ...
      *((_DWORD *)v8 + 7) = *(unsigned __int16 *)(a1 + 48);
    }
    *((_DWORD *)v8 + 8) = (*(unsigned __int16 *)(a1 + 1151) >> 5) & 3;
  }
