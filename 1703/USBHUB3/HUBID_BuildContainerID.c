/*
 * XREFs of HUBID_BuildContainerID @ 0x1C00180D8
 * Callers:
 ...
 *     RtlUnicodeStringCbCatStringN @ 0x1C0017234 (RtlUnicodeStringCbCatStringN.c)
  ...
  if ( Property < 0 )
  {
    ...
    WPP_RECORDER_SF_d(
      *(_QWORD *)(*(_QWORD *)(a1 + 8) + 1432LL),
      ...
      5u,
      0xCu,
      (__int64)&WPP_8b5c7ac4e48a30523d0afcec844bc517_Traceguids,
      dwFlags);
  }
}
