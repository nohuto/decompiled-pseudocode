/*
 * XREFs of HUBFDO_GetPortStatusForDebugging @ 0x1C000B70C
 * Callers:
...
void __fastcall HUBFDO_GetPortStatusForDebugging(_QWORD *a1, int a2)
{
  ...
  for ( i = a1[291]; ; i = *(_QWORD *)(v4 + 248) )
  {
    v4 = i - 248;
    if ( a1 + 291 == (_QWORD *)(v4 + 248) )
      break;
    if ( *(unsigned __int16 *)(v4 + 200) == a2 )
    {
      ...
      *(_WORD *)(v4 + 174) = v6;
      ...
      {
        LODWORD(v8) = v7;
        WPP_RECORDER_SF_d(a1[311], 2u, 3u, 0x20u, (__int64)&WPP_655f8cdbe4fd3d78bdf33e2084db6386_Traceguids, v8);
      }
      return;
    }
  }
