/*
 * XREFs of HUBFDO_EvtDeviceReleaseHardware @ 0x1C00672E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_EvtDeviceReleaseHardware(__int64 a1)
{
  ...
  v3 = (const void *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 1632))(
                       WdfDriverGlobals,
                       v2);
  HUBMISC_WaitForSignal((PVOID)(v2 + 1120), "Hub FDO PnpCallback", v3);
  v4 = *(_DWORD *)(v2 + 1144);
  ...
  v6 = *(_QWORD *)(v2 + 2400);
  v7 = *(_QWORD **)(v2 + 2408);
  if ( *(_QWORD *)(v6 + 8) != v2 + 2400 || *v7 != v2 + 2400 )
    __fastfail(3u);
  ...
  *(_QWORD *)(v6 + 8) = v7;
  ...
  RtlInitUnicodeString((PUNICODE_STRING)(v2 + 2512), 0LL);
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 2) != 0 )
  {
    v11 = v4;
    Template_pq(
