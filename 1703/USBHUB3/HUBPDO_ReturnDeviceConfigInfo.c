/*
 * XREFs of HUBPDO_ReturnDeviceConfigInfo @ 0x1C0011EF8
 * Callers:
...
LABEL_3:
  ...
  *(_DWORD *)(v4 + 4) = 204;
  v7 = *(_DWORD *)(v4 + 8);
  if ( (*(_BYTE *)(*(_QWORD *)(a1 + 16) + 2464LL) & 2) != 0 )
    v7 = 1;
  *(_DWORD *)(v4 + 8) = v7;
  if ( *(_WORD *)(*(_QWORD *)(a1 + 16) + 2426LL) >= 0x200u )
    *(_DWORD *)(v4 + 8) |= 1u;
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 16) + 40LL) & 2) != 0 )
    *(_DWORD *)(v4 + 8) |= 8u;
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 16) + 40LL) & 2) != 0 )
    *(_DWORD *)(v4 + 8) |= 4u;
  if ( *(_DWORD *)(*(_QWORD *)(a1 + 16) + 248LL) == 2 )
    *(_DWORD *)(v4 + 8) |= 2u;
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 16) + 40LL) & 0x100) != 0 )
    *(_DWORD *)(v4 + 8) |= 0x20u;
  if ( !*(_BYTE *)(*(_QWORD *)(a1 + 16) + 232LL) )
    *(_DWORD *)(v4 + 8) |= 0x10u;
