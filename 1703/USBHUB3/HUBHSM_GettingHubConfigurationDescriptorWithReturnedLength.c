/*
 * XREFs of HUBHSM_GettingHubConfigurationDescriptorWithReturnedLength @ 0x1C00084B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_GettingHubConfigurationDescriptorWithReturnedLength(__int64 a1)
{
  ...
  *(_QWORD *)(v1 + 1224) = PoolWithTag;
  ...
  {
    WPP_RECORDER_SF_(*(_QWORD *)(v1 + 2488), 2u, 3u, 0x13u, (__int64)&WPP_aebd157f2d2c311e8b884f2de7866b9a_Traceguids);
