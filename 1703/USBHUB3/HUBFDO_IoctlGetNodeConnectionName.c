/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionName @ 0x1C006832C
 * Callers:
 ...
 *     HUBMISC_StripSymbolicNamePrefix @ 0x1C002A228 (HUBMISC_StripSymbolicNamePrefix.c)
...
__int64 __fastcall HUBFDO_IoctlGetNodeConnectionName(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( v10 >= 0 )
  {
                    ...
                    + 1616LL) & 2) != 0 )
    {
      ...
      *(_DWORD *)v22 = v7;
      v23 = 0LL;
      DeviceInterfacePath = HUBMISC_GetDeviceInterfacePath((__int64)&GUID_DEVINTERFACE_USB_HUB, v12, &v23, v9[311]);
...
LABEL_12:
  ...
  WPP_RECORDER_SF_d(v9[311], 2u, 3u, 0x28u, (__int64)&WPP_655f8cdbe4fd3d78bdf33e2084db6386_Traceguids, v10);
LABEL_15:
