/*
 * XREFs of KiApcInterrupt @ 0x140185430
 * Callers:
 *     KiApcInterruptShadow @ 0x14026CB00 (KiApcInterruptShadow.c)
 * Callees:
  ...
  if ( (v53 & 1) != 0 )
  {
    ...
    else
    {
      if ( (a2 & 2) != 0 && (KeGetPcr()->Prcb.BpbFeatures & 4) == 0 )
      {
        ...
        v48 = 0x140185637LL;
        v47 = 0x14018562ELL;
        *((_QWORD *)&v46 + 1) = 0x140185625LL;
        *(_QWORD *)&v46 = 0x14018561CLL;
        *((_QWORD *)&v45 + 1) = 0x140185613LL;
        *(_QWORD *)&v45 = 0x14018560ALL;
        *((_QWORD *)&v44 + 1) = 0x140185601LL;
        *(_QWORD *)&v44 = 0x1401855F8LL;
        *((_QWORD *)&v43 + 1) = 0x1401855EFLL;
        *(_QWORD *)&v43 = 0x1401855E6LL;
        *((_QWORD *)&v42 + 1) = 0x1401855DDLL;
        *(_QWORD *)&v42 = 0x1401855D4LL;
        *((_QWORD *)&v41 + 1) = 0x1401855CBLL;
        *(_QWORD *)&v41 = 0x1401855C2LL;
        v40 = 0x1401855B9LL;
        v39 = 0x1401855B0LL;
        v38 = 0x1401855A7LL;
        v37 = 0x14018559ELL;
