/*
 * XREFs of MiCopyTopLevelMappings @ 0x1400639EC
 * Callers:
...
__int64 __fastcall MiCopyTopLevelMappings(__int64 a1, __int64 a2)
{
  ...
  memmove(
    ...
    8 * ((((unsigned __int64)qword_14036D870 >> 39) & 0x1FF) - 256));
  MiShadowTopLevelPxes(a1, TopPteAddress + 2048, 256LL);
  v5 = (((unsigned __int64)qword_14036C5D0 >> 39) & 0x1FF) + 1;
  memmove((void *)(a2 + 8 * v5), (const void *)(TopPteAddress + 8 * v5), 8LL * (unsigned int)(512 - v5));
  result = *(_QWORD *)(a1 + 1024);
  v7 = ((unsigned __int64)qword_14036C170 >> 39) & 0x1FF;
  if ( result )
  {
