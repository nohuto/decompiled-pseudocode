/*
 * XREFs of SecureDump_EncryptSymmetricKeyWithPublicKey @ 0x1401F6618
 * Callers:
    ...
    if ( Property >= 0 )
    {
      ...
      if ( Property >= 0 )
      {
        ...
        else if ( pbOutput == 2048 )
        {
          ...
          if ( Property >= 0 )
          {
            qword_14036BC48 = ExAllocatePoolWithTag(NonPagedPoolNx, ::pcbResult, 0x706D6453u);
            if ( !qword_14036BC48 )
              goto LABEL_3;
