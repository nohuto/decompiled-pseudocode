/*
 * XREFs of ObpInsertOrLocateNamedObject @ 0x1404F3FB0
 * Callers:
        ...
        char **a7)
{
  ...
  *(_QWORD *)Revision = a3;
  ...
  if ( Object == a2 )
  {
    ...
    if ( v20 )
    {
      if ( (*(_DWORD *)(v20 + 336) & 8) != 0 || ObpObjectSecurityInheritance )
        v40 = 3;
    ...
    v42 = v14;
    v23 = (_OWORD *)a4;
    if ( !v22 || (*(_DWORD *)(v22 + 336) & 8) == 0 && !ObpObjectSecurityInheritance || !*(_QWORD *)(a4 + 64) )
    {
LABEL_19:
      if ( !*((_QWORD *)v23 + 8) && v40 )
        LOBYTE(v14) = 1;
...
LABEL_45:
      ObpDeleteDirectoryEntry((__int64)v46);
      ObpReleaseLookupContext((__int64)v46);
      ObpDecrementHandleCount(BugCheckParameter1);
