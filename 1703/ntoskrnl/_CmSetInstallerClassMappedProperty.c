/*
 * XREFs of _CmSetInstallerClassMappedProperty @ 0x140740D1C
 * Callers:
 ...
 *     _CmSetInstallerClassMappedPropertyFromRegProp @ 0x140740FC8 (_CmSetInstallerClassMappedPropertyFromRegProp.c)
...
LABEL_24:
    ...
    if ( a6 < 2 )
      ...
      v22 = CmSetInstallerClassMappedPropertyFromCoInstallers((int)a1, (int)a2, (int)v18, a6, a7, a8);
    v11 = v22;
    if ( v22 >= 0 )
      PnpObjectRaisePropertyChangeEvent((__int64)a1, (__int64)a2, 2LL, (__int64)a3, 0LL, a5);
    if ( v11 == -1073741802 )
