/*
 * XREFs of MiStoreLogNotCandidate @ 0x14013DD00
 * Callers:
...
void __fastcall MiStoreLogNotCandidate(int a1)
{
  ...
  if ( qword_14036CFD8 && a1 != -1073741401 && qword_14036CFD8->LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(qword_14036CFD8, 0x400000000002uLL) )
    {
      v12 = 0;
      v15 = 0;
      v10 = &v7;
      ...
      v11 = 4;
      v14 = 4;
      TlgWriteEx(v2, &unk_1402ACC06, v1, (ULONG)v2, v5, v6, 4u, &pData);
    }
  }
}
