/*
 * XREFs of ?ReadPartitionTable@PC_GPT@@QEAAJPEAPEAU_DRIVE_LAYOUT_INFORMATION_EX@@@Z @ 0x140268EC4
 * Callers:
...
__int64 __fastcall PC_GPT::ReadPartitionTable(PC_DISK **this, struct _DRIVE_LAYOUT_INFORMATION_EX **a2)
{
  ...
  *a2 = 0LL;
  for ( i = 0; i < 2; ++i )
  {
    ...
    if ( Header >= 0 )
    {
      Header = PC_GPT::ReadEntries((PC_GPT *)this, (struct GPT_HEADER *)v6, &v23);
      if ( Header >= 0 )
        goto LABEL_6;
    }
  }
...
LABEL_6:
  ...
  *((_QWORD *)v13 + 4) = (*(_QWORD *)(v6 + 48) - *(_QWORD *)(v6 + 40) + 1LL) << *((_DWORD *)*this + 10);
  ...
  {
    v18 = (char *)v14 + 128 * (unsigned __int64)v17;
  ...
  *((_DWORD *)v13 + 1) = v16;
  if ( v3 )
    PC_GPT::WritePartitionTable((PC_GPT *)this, (struct _DRIVE_LAYOUT_INFORMATION_EX *)v13, 0);
