/*
 * XREFs of __C_specific_handler @ 0x1401692D0
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x14017DAE0 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x140009D90 (RtlUnwindEx.c)
 *     KeCheckStackAndTargetAddress @ 0x140024760 (KeCheckStackAndTargetAddress.c)
 *     _NLG_Notify @ 0x1401698B0 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x1401698E0 (__NLG_Return2.c)
 */
        ...
        struct _DISPATCHER_CONTEXT *DispatcherContext)
{
  ...
  else
  {
    ...
    {
      if ( v9 >= HandlerData[4 * v11 + 1] && v9 < HandlerData[4 * v11 + 2] && HandlerData[4 * v11 + 4] )
      {
