/*
 * XREFs of ?SmStEtwFillStoreStatsEvent@?$SMKM_STORE@USM_TRAITS@@@@SAKPEAU1@PEAU_SMKM_EVENT_DESCRIPTOR@@@Z @ 0x14024F3D0
 * Callers:
...
__int64 __fastcall SMKM_STORE<SM_TRAITS>::SmStEtwFillStoreStatsEvent(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(a1 + 1880) )
  {
    ...
    *v10 = v9;
    ...
    ++*(_DWORD *)(a2 + 16);
    *(_DWORD *)(a2 + 24) += 1348;
    ST_STORE<SM_TRAITS>::StCopyIoStats(v9, a1 + 4248);
    StLcBucketsCopy(v9 + 321, v11, *(_QWORD **)(a1 + 5568), *(_DWORD *)(a1 + 5560));
    return 1;
  }
  return v2;
}
