/*
 * XREFs of BgpConsoleDisplayCharacterEx @ 0x140759F74
 * Callers:
...
__int64 BgpConsoleDisplayCharacterEx(unsigned __int16 a1, unsigned int a2, unsigned int a3, int a4, int a5, ...)
{
  ...
  if ( a2 > 0x50 )
    return 3221225485LL;
  v7 = qword_14036F150;
  if ( a3 > *(_DWORD *)(qword_14036F150 + 4) )
    return 3221225485LL;
  v8 = (int *)(qword_14036F150 + 68);
  v9 = 0;
  v10 = (_DWORD *)(qword_14036F150 + 60);
  v11 = (_DWORD *)(qword_14036F150 + 48);
  ...
  if ( !(_DWORD)v12 )
  {
    ...
    *v8 = v21;
    ...
    if ( v9 >= 0 )
    {
      ...
      v22 = 3 * v12;
      *(_WORD *)(qword_14036F150 + 4 * v22 + 88) = 32;
...
LABEL_22:
    ...
    v9 = BgpDisplayCharacterEx(
           ...
           *(_DWORD *)(qword_14036F150 + 60) + *v11 * *v8,
    ...
    if ( v9 >= 0 )
    {
      ...
      v7 = qword_14036F150;
      *(_WORD *)(qword_14036F150 + 4 * v12 + 88) = a1;
  ...
  if ( v15 >= 5 || (v12 = v15) != 0 )
  {
    ...
    do
    {
      ...
      if ( v18 >= 0 )
      {
        v12 = (unsigned int)v8[1] + 25LL * (unsigned int)*v8;
        v19 = 3 * v12;
        *(_WORD *)(qword_14036F150 + 4 * v19 + 88) = 32;
