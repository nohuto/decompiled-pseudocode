/*
 * XREFs of DbgkpQueueMessage @ 0x14067F83C
 * Callers:
...
__int64 __fastcall DbgkpQueueMessage(PVOID Object, char *a2, __int64 a3, int a4, PRKEVENT a5)
{
  ...
  else
  {
    ...
    if ( (unsigned int)(v14 - 1) <= 1 && (a2[1736] & 0x40) != 0 )
      a5 = 0LL;
    if ( v14 == 5 && ((unsigned __int8)a4 & (unsigned __int8)a2[1736] & 0x40) != 0 )
      a5 = 0LL;
    if ( (unsigned int)(v14 - 3) <= 1 && a2[1736] < 0 )
      a5 = 0LL;
