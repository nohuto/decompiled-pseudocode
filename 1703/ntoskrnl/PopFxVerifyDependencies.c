/*
 * XREFs of PopFxVerifyDependencies @ 0x1406C8C3C
 * Callers:
...
LABEL_26:
      ...
      while ( 1 )
      {
        ...
        if ( v13 == 2 )
          break;
        _mm_lfence();
        v14 = *(unsigned int **)(*(_QWORD *)(*(_QWORD *)(a2 + 632) + 8 * v11) + 176LL);
        _mm_lfence();
        if ( v13 == 1 )
        {
          a1[3 * v11] = 2;
          --v8;
          v15 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 632) + 8LL * (unsigned int)v11) + 172LL);
          if ( v15 )
          {
            v16 = a1[3 * v11 + 1];
            v17 = v15;
        ...
        else
        {
          a1[3 * v11] = 1;
          v20 = 0;
          v21 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 632) + 8LL * (unsigned int)v11) + 172LL);
          if ( v21 )
          {
            do
            {
