/*
 * XREFs of FsRtlPrivateLock @ 0x14004F440
 * Callers:
        ...
        BOOLEAN AlreadySynchronized)
{
  ...
  if ( ExclusiveLock )
    v20 = FsRtlPrivateCheckForExclusiveLockAccess(v19, (__int64)v32);
  else
...
LABEL_29:
  ...
  if ( Irp && v21->Status != 259 )
  {
    ...
    FsRtlCompleteLockIrpReal(LockInformation[1], Context, Irp, (unsigned int)v21->Status, &v29, FileObject);
    v26 = v29;
