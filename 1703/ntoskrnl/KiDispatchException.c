...
int __fastcall KiDispatchException(PEXCEPTION_RECORD ExceptionRecord, __int64 a2, __int64 a3, char a4, char a5)
{
  ...
  unsigned int v33; // [rsp+38h] [rbp+8h] BYREF
  ...
  RtlGetExtendedContextLength(v15, &v33);
  v16 = v33 + 15LL;
  if ( v16 <= v33 )
  ...
  if ( v5 )
    memset(&v31, 0, v33);
  v34 = RtlInitializeExtendedContext(&v31, v15, &v37);
        ...
        || !(unsigned __int8)KdTrap(a3, (_DWORD)v22, (_DWORD)ExceptionRecord, (unsigned int)&v31, v5, 0) )
      {
        ...
        if ( !(_BYTE)CurrentThread )
        {
          ...
          *(_DWORD *)(a3 + 376) &= ~0x100u;
          ...
          {
            v23 = (v20 - *(unsigned int *)(v37 + 20)) & 0xFFFFFFFFFFFFFFC0uLL;
            v36 = v23;
          }
          ...
          *v26 = v49;
          ...
          v27 = v44;
          LOBYTE(v28) = 1;
          RtlpCopyExtendedContext(v28, v44, (unsigned int)&v50, v15, v37, 0LL);
          *(_OWORD *)v27 = v50;
          *(_QWORD *)(v27 + 16) = v51;
          v34 = 0;
          _disable();
