/*
 * XREFs of IopInitializeResourceMap @ 0x14080D3D8
 * Callers:
 *     IopInitializePlugPlayServices @ 0x1407FAEC0 (IopInitializePlugPlayServices.c)
 * Callees:
 *     RtlInitUnicodeString @ 0x1400F0F60 (RtlInitUnicodeString.c)
 *     RtlCmEncodeMemIoResource @ 0x140156D70 (RtlCmEncodeMemIoResource.c)
  ...
  do
  {
    if ( v2 )
    {
      if ( v2 == 1 )
      {
        ...
        LOBYTE(v30) = 1;
        v31 = 1;
        v5 = (unsigned int *)MmInitializeMemoryLimits(v1, v29);
        if ( !v5 )
          goto LABEL_25;
      }
      else
...
LABEL_20:
    ...
    {
      IopWriteResourceList((__int64)Handle, (__int64)&DestinationString, (__int64)&v27, &v26, v12, v10);
      ZwClose(Handle);
    }
