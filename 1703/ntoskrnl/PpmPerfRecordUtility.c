/*
 * XREFs of PpmPerfRecordUtility @ 0x140046730
 * Callers:
...
__int64 __fastcall PpmPerfRecordUtility(__int64 a1)
{
  ...
  _DWORD *v47; // [rsp+78h] [rbp-88h] BYREF
  ...
  *v1 = v9 + v10;
  ...
  {
    result = *v5;
    *(_DWORD *)(a1 + 24372) = *v5 * v5[1];
    return result;
  }
  v13 = *(_DWORD *)(a1 + 24356);
  v14 = v10 * (unsigned int)(100 * v13) / v8;
  v15 = 100LL;
  v16 = v10 * (unsigned int)(v13 * *(_DWORD *)(a1 + 24364)) / v8;
  if ( v6 )
    v17 = *(_DWORD *)(v6 + 140);
  else
    v17 = 100;
...
LABEL_18:
  ...
  if ( v23 )
  {
    v44 = *(_DWORD *)v23;
    v45 = *(_DWORD *)(v23 + 4);
    v26 = (unsigned __int16 *)(v23 + 28 + 8LL * (unsigned int)v45);
