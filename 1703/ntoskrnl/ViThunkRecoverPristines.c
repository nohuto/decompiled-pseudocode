/*
 * XREFs of ViThunkRecoverPristines @ 0x1407747E0
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x140773FC0 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x140774BB8 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x140774C28 (ViThunkReplaceSpecialPristine.c)
 */
