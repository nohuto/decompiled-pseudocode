/*
 * XREFs of KiIntSteerLogState @ 0x14014C888
 * Callers:
...
NTSTATUS __fastcall KiIntSteerLogState(__int64 a1, const EVENT_DESCRIPTOR *a2)
{
  ...
  _DWORD *v18; // [rsp+A0h] [rbp+17h]
  __int64 v19; // [rsp+A8h] [rbp+1Fh]
  _DWORD *v20; // [rsp+B0h] [rbp+27h]
  ...
  if ( (_BYTE)result )
  {
    ...
    *(_QWORD *)&UserData.Size = 4LL;
    ...
    v19 = 4LL;
    v21 = 4LL;
    return EtwWriteEx(KiIntSteerEtwHandle, a2, 0LL, 0, 0LL, 0LL, 7u, &UserData);
  }
  return result;
}
