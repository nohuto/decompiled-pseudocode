/*
 * XREFs of FsRtlCheckUpperOplock @ 0x140585C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FsRtlCheckUpperOplock(__int64 *a1, char a2, __int64 a3, __int64 a4, __int64 a5, unsigned int a6)
{
  ...
  __int64 v21; // r14
  unsigned __int8 v22; // [rsp+50h] [rbp-88h]
...
LABEL_35:
          ...
          {
            v21 = a5;
            v10 = FsRtlpOplockBreakByCacheFlags(v23, (__int64)v24, 0LL, a6 | v22, v9, v19, a4, a5, &v25, 0LL);
            if ( v22 )
              v10 = FsRtlpOplockBreakByCacheFlags(v23, (__int64)v24, 0LL, a6, 0x2000, v19, a4, v21, &v25, 0LL);
          }
          goto LABEL_39;
        }
        v20 = FsRtlpOplockBreakToNone(v23, (__int64)v24, 0LL, a6, v26, a4, a5, &v25, 0LL);
      }
      else
      {
