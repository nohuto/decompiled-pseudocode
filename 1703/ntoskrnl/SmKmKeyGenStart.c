/*
 * XREFs of SmKmKeyGenStart @ 0x1407028A0
 * Callers:
 *     SmcCacheManagerStart @ 0x1407040A0 (SmcCacheManagerStart.c)
 * Callees:
 *     SmAlloc @ 0x14012F798 (SmAlloc.c)
 *     ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x14024D60C (-RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
 */
