/*
 * XREFs of ?SmStoreMgrCallback@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU_SMKM_STORE_LIST@@PEAXW4_SMKM_CALLBACK_TYPE@@@Z @ 0x14001ECF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmStoreMgrCallback(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  switch ( a3 )
  {
    ...
    case 7u:
      *(_BYTE *)(a2 + 5989) |= 2u;
      break;
    case 2u:
      SMKM_STORE_MGR<SM_TRAITS>::SmFeStoreDelete(a1, *(_DWORD *)(a2 + 5984) & 0x3FF);
      break;
    case 4u:
  ...
  result = 0LL;
  if ( *(_QWORD *)(a1 + 1808) )
    return (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(a1 + 1808))(a1, a2, a3);
  return result;
}
