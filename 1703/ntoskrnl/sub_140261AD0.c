/*
 * XREFs of sub_140261AD0 @ 0x140261AD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsQueryThreadTerminationPort @ 0x14041C3A8 (PsQueryThreadTerminationPort.c)
 *     KeRundownApcQueues @ 0x140540148 (KeRundownApcQueues.c)
 */

void __fastcall __noreturn sub_140261AD0(__int64 a1)
{
