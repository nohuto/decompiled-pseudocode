/*
 * XREFs of MiSwitchBaseAddress @ 0x1404499D4
 * Callers:
 *     MiRelocateImageAgain @ 0x140511290 (MiRelocateImageAgain.c)
 * Callees:
 *     MiApplyBytestreamFixup @ 0x14002F774 (MiApplyBytestreamFixup.c)
 *     MiWalkEntireImage @ 0x1400C9D50 (MiWalkEntireImage.c)
 *     DbgUnLoadImageSymbolsUnicode @ 0x140148EB4 (DbgUnLoadImageSymbolsUnicode.c)
 */

__int64 __fastcall MiSwitchBaseAddress(__int64 *a1, __int64 a2, __int64 a3, unsigned int a4)
{
  __int64 v4; // rdi
  __int64 v5; // r10
  _QWORD *v7; // rsi
