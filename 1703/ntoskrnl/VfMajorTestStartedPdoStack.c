/*
 * XREFs of VfMajorTestStartedPdoStack @ 0x1407733C0
 * Callers:
 *     PpvUtilTestStartedPdoStack @ 0x140067978 (PpvUtilTestStartedPdoStack.c)
 * Callees:
...
__int64 (__fastcall *__fastcall VfMajorTestStartedPdoStack(__int64 a1))(_QWORD)
{
  ...
  if ( (_DWORD)result && VfVerifyMode > 2 )
  {
    ...
    result = qword_140791910;
    if ( qword_140791910 )
      return (__int64 (__fastcall *)(_QWORD))qword_140791910(a1);
  }
  return result;
}
