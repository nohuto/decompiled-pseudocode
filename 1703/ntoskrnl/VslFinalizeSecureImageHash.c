/*
 * XREFs of VslFinalizeSecureImageHash @ 0x14026A1D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VslFinalizeSecureImageHash(__int64 a1, __int64 a2)
{
  ...
  MemoryDescriptorList.Size = 8 * ((((unsigned __int64)(a2 & 0xFFF) + 4167) >> 12) + 6);
  ...
  v9 = v2;
  v10 = v6;
  LODWORD(v2) = VslpEnterIumSecureMode(1, 25LL, 0LL, (__int64)v7);
