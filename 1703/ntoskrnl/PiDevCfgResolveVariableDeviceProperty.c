/*
 * XREFs of PiDevCfgResolveVariableDeviceProperty @ 0x1405944B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiDevCfgResolveVariableDeviceProperty(__int64 *a1, void *a2, __int64 a3)
{
  ...
  *(_DWORD *)&UnicodeString.Length = 0;
  ...
  if ( !PnpValidateRegistryString(*(_DWORD **)&GuidString.Length) )
    goto LABEL_20;
  PnpRegSzToString(v7 + *(unsigned int *)(v7 + 8), *(unsigned int *)(v7 + 12), &GuidString);
...
LABEL_57:
  ...
  else
  {
    ...
    if ( !PnpValidateRegistryDword(*(__int64 *)&GuidString.Length) )
      goto LABEL_20;
    v8 = *a1;
    v21 = *(_DWORD *)(*(unsigned int *)(v7 + 8) + v7);
