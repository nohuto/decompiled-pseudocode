/*
 * XREFs of PfSnLogScenarioDecision @ 0x1405646C8
 * Callers:
...
void __fastcall PfSnLogScenarioDecision(__int64 a1, int a2, __int16 a3, char a4, char a5, char a6, __int64 a7)
{
  REGHANDLE v7; // rdi
  __int64 v11; // rax
  char v12; // [rsp+30h] [rbp-A1h] BYREF
  char v13; // [rsp+31h] [rbp-A0h] BYREF
  __int16 v14; // [rsp+34h] [rbp-9Dh] BYREF
  __int16 v15; // [rsp+38h] [rbp-99h] BYREF
  int v16; // [rsp+3Ch] [rbp-95h] BYREF
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+40h] [rbp-91h] BYREF
