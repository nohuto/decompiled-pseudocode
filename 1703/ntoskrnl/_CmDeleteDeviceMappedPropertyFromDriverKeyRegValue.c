/*
 * XREFs of _CmDeleteDeviceMappedPropertyFromDriverKeyRegValue @ 0x14073EF3C
 * Callers:
...
__int64 __fastcall CmDeleteDeviceMappedPropertyFromDriverKeyRegValue(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v12 = CmOpenDeviceRegKey(a1, a2, 0x12u, 0, 2, 0, (__int64)&KeyHandle, 0LL);
  v11 = v12;
  if ( v12 == -1073741772 )
  {
    v11 = 0;
...
LABEL_18:
      if ( *(_DWORD *)(a3 + 16) == 2 )
      {
        ...
        if ( !v16 && RtlInitUnicodeStringEx(&DestinationString, L"DriverDate") >= 0 )
