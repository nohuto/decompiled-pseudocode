/*
 * XREFs of RtlStringCbCopyExW @ 0x1400819F0
 * Callers:
 ...
 *     PiDqConvertQueryFlagsToString @ 0x140698474 (PiDqConvertQueryFlagsToString.c)
 *     RtlFormatMessageEx @ 0x1406E73C4 (RtlFormatMessageEx.c)
 *     _PnpMultiSzAppend @ 0x140741B1C (_PnpMultiSzAppend.c)
 ...
 * Callees:
 *     RtlStringCopyWorkerW_2 @ 0x14008197C (RtlStringCopyWorkerW_2.c)
