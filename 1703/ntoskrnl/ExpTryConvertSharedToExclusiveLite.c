/*
 * XREFs of ExpTryConvertSharedToExclusiveLite @ 0x14025C3A0
 * Callers:
 ...
 *     ExpTryUpgradeResource @ 0x14025EED4 (ExpTryUpgradeResource.c)
 */
...
char __fastcall ExpTryConvertSharedToExclusiveLite(__int64 a1)
{
  ...
  if ( v7 )
  {
    ...
    v9 = ExpFindCurrentThread(v6, CurrentThread, &LockHandle, 0, 0, v8);
    if ( v9 != (_QWORD *)(a1 + 48) )
    {
