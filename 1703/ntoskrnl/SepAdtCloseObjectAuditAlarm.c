/*
 * XREFs of SepAdtCloseObjectAuditAlarm @ 0x1406F2820
 * Callers:
 ...
 *     SeCloseObjectAuditAlarmForNonObObject @ 0x1406F5160 (SeCloseObjectAuditAlarmForNonObObject.c)
 * Callees:
        ...
        char a5)
{
  ...
  P = 0LL;
  if ( (unsigned __int8)SepAdtAuditObjectAccessWithContext(a4, a1, 1, 0, (__int64)a3, a5, &v20)
