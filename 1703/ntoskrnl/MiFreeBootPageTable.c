/*
 * XREFs of MiFreeBootPageTable @ 0x140813674
 * Callers:
...
__int64 __fastcall MiFreeBootPageTable(ULONG_PTR BugCheckParameter2)
{
  ...
  {
    *(_QWORD *)(v2 + 40) = ((unsigned __int64)(unsigned int)MiPageToNode(BugCheckParameter2, 0LL) << 58) | *(_QWORD *)(v2 + 40) & 0x3FFFFFFFFFFFFFFLL;
