/*
 * XREFs of VfDeadlockAcquireResource @ 0x140778A28
 * Callers:
 ...
 *     ViKeObjectAcquired @ 0x140778558 (ViKeObjectAcquired.c)
 ...
 *     ViDeadlockCheckDuplicatesAmongChildren @ 0x14077A51C (ViDeadlockCheckDuplicatesAmongChildren.c)
 *     ViDeadlockCheckDuplicatesAmongRoots @ 0x14077A59C (ViDeadlockCheckDuplicatesAmongRoots.c)
 ...
 *     ViDeadlockSimilarNode @ 0x14077B340 (ViDeadlockSimilarNode.c)
      ...
      if ( *(_DWORD *)v20 != (_DWORD)v5 )
      {
        if ( ((unsigned int)(v5 - 3) > 1 || (unsigned int)(v22 - 3) > 1) && (v22 != 7 || (unsigned int)(v5 - 5) > 1) )
        {
          ViDeadlockPreprocessOptions(
            ...
            (const void *)0x1008);
          VfReportIssueWithOptions(0xC4u, 4104, a1, *(_DWORD *)v20, v5, byte_140341434);
LABEL_36:
          v18 = v53;
          v19 = 0;
LABEL_80:
      ...
      if ( v23 )
      {
        if ( v25 > 1u )
        {
          ...
          ViDeadlockPreprocessOptions(
            ...
            (const void *)0x1000);
          VfReportIssueWithOptions(0xC4u, 4096, a1, v20, v9, &dword_140341438);
          goto LABEL_36;
        }
        v26 = a4;
        v27 = (_QWORD *)(v23 + 8);
