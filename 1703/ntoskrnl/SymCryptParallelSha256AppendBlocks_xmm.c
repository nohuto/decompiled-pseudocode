/*
 * XREFs of SymCryptParallelSha256AppendBlocks_xmm @ 0x1401792A0
 * Callers:
  ...
  *a4 = v12;
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      v59 = _mm_add_epi32(_mm_load_si128(a4 + 3), v43);
      a4[11] = v59;
      v60 = _mm_load_si128(a4 + 2);
      a4[3] = v59;
      v61 = _mm_add_epi32(v60, v45);
      a4[10] = v61;
      v62 = _mm_load_si128(a4 + 1);
      a4[2] = v61;
      v63 = _mm_add_epi32(v62, v47);
      a4[9] = v63;
      v64 = _mm_load_si128(a4);
      a4[1] = v63;
      v65 = _mm_add_epi32(v64, v48);
      a4[8] = v65;
      *a4 = v65;
      a4[7] = _mm_add_epi32(_mm_load_si128(a4 + 7), a4[71]);
      a4[6] = _mm_add_epi32(_mm_load_si128(a4 + 70), a4[6]);
      v66 = _mm_load_si128(a4 + 4);
  ...
  v67 = _mm_load_si128(a4 + 10);
  v68 = _mm_load_si128(a4 + 11);
  v69 = _mm_load_si128(a4 + 9);
  v70 = _mm_unpacklo_epi32(v68, v67);
  v71 = _mm_unpackhi_epi32(v68, v67);
  v72 = _mm_load_si128(a4 + 8);
  v73 = _mm_unpackhi_epi32(v69, v72);
  v74 = _mm_unpacklo_epi32(v69, v72);
  **a1 = _mm_unpacklo_epi64(v70, v74);
  *a1[1] = _mm_unpackhi_epi64(v70, v74);
  *a1[2] = _mm_unpacklo_epi64(v71, v73);
  *a1[3] = _mm_unpackhi_epi64(v71, v73);
  v75 = _mm_load_si128(a4 + 7);
  v76 = _mm_load_si128(a4 + 5);
  v77 = _mm_unpacklo_epi32(v75, a4[6]);
  v78 = _mm_unpacklo_epi32(v76, a4[4]);
  v79 = _mm_unpackhi_epi32(v75, a4[6]);
  v80 = _mm_unpackhi_epi32(v76, a4[4]);
  (*a1)[1] = _mm_unpacklo_epi64(v77, v78);
  a1[1][1] = _mm_unpackhi_epi64(v77, v78);
  a1[2][1] = _mm_unpacklo_epi64(v79, v80);
  result = a1[3];
  result[1] = _mm_unpackhi_epi64(v79, v80);
  return result;
}
