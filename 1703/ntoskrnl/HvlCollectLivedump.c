/*
 * XREFs of HvlCollectLivedump @ 0x1401EA82C
 * Callers:
...
NTSTATUS __fastcall HvlCollectLivedump(__int64 a1, __int64 a2, _QWORD *a3, __int64 a4)
{
  ...
  if ( (HvlpRootFlags & 2) == 0 || !qword_14036A708 )
    return -1073741637;
  if ( VslVsmEnabled )
  {
    memset(v16, 0, 0x68uLL);
    result = VslpEnterIumSecureMode(1, 234LL, 0LL, (__int64)v16);
    if ( result >= 0 )
    {
  ...
  else
  {
    ...
    *(_QWORD *)(v8 + 24) = *(_QWORD *)(a2 + 16);
    ...
    {
      v12 = *(void **)(a4 + 32);
      v13 = dword_14036A718 << 12;
      if ( v12 == *(void **)a4 && *(_DWORD *)(a4 + 8) >= v13 )
        memmove(v12, qword_14036A708, v13);
      else
        *(_QWORD *)(a4 + 32) = qword_14036A708;
      *(_DWORD *)(a4 + 40) = v13;
