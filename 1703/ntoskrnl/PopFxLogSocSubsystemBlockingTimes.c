/*
 * XREFs of PopFxLogSocSubsystemBlockingTimes @ 0x1406C7CDC
 * Callers:
...
__int64 __fastcall PopFxLogSocSubsystemBlockingTimes(__int64 a1, unsigned int a2)
{
  ...
  __int64 v12; // rax
  __int64 v13; // rcx
  char v15; // [rsp+20h] [rbp-89h] BYREF
  unsigned int v16; // [rsp+28h] [rbp-81h] BYREF
  __int64 v17; // [rsp+30h] [rbp-79h] BYREF
  _QWORD v18[5]; // [rsp+38h] [rbp-71h] BYREF
  struct _EVENT_DATA_DESCRIPTOR v19; // [rsp+60h] [rbp-49h] BYREF
  __int64 v20; // [rsp+70h] [rbp-39h]
  int v21; // [rsp+78h] [rbp-31h]
  int v22; // [rsp+7Ch] [rbp-2Dh]
  unsigned int *v23; // [rsp+80h] [rbp-29h]
