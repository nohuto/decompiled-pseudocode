/*
 * XREFs of HvpApplyLogEntry @ 0x1406786E0
 * Callers:
        ...
        int *a6)
{
  ...
  *(_DWORD *)(v6 + 40) = v8;
  ...
  {
    v16 = CmpDoFileSetSizeEx(BugCheckParameter2, 0LL, v15, 1);
    if ( v16 < 0 )
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    if ( v18 && (v23 = v18 - 1, v24 = *(_DWORD *)(a3 + 8 * v23 + 4), v25 = *(_DWORD *)(a3 + 8 * v23), v25 + v24 >= v14) )
      v26 = v21 - v25 - v24;
    else
      v26 = v21 - v14;
    if ( v26 )
