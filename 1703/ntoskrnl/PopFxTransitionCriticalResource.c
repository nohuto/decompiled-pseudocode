/*
 * XREFs of PopFxTransitionCriticalResource @ 0x14022C330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopFxTransitionCriticalResource(__int64 a1, unsigned int a2, unsigned __int8 a3)
{
  ...
  v6 = *(_QWORD *)(*(_QWORD *)(a1 + 632) + 8LL * a2);
  v7 = v6 + 88;
  ...
  LOBYTE(v7) = a3;
  return (*(__int64 (__fastcall **)(_QWORD, _QWORD, ULONG_PTR))(a1 + 160))(*(_QWORD *)(a1 + 176), a2, v7);
}
