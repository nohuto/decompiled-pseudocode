/*
 * XREFs of MiAllocateEnclaveVad @ 0x1406BA9FC
 * Callers:
...
__int64 __fastcall MiAllocateEnclaveVad(unsigned __int64 a1, unsigned __int64 a2, __int64 a3, __int64 *a4)
{
  ...
  v15 = MiReservePtes((__int64)&qword_14036D0A0, 1uLL, v14);
  *(_QWORD *)(v13 + 64) = v15;
  if ( !v15 )
  {
...
LABEL_20:
      ...
      MiReleasePtes((__int64)&qword_14036D0A0, *(_QWORD **)(v13 + 64), 1u);
      ExFreePoolWithTag((PVOID)v13, 0);
