/*
 * XREFs of PopDiagTraceRtcWakeInfo @ 0x140138514
 * Callers:
...
char __fastcall PopDiagTraceRtcWakeInfo(__int64 a1, int a2, int a3, int a4, int a5, int a6, __int64 a7)
{
  ...
  int *v64; // [rsp+1F8h] [rbp+F0h]
  __int64 v65; // [rsp+200h] [rbp+F8h]
  int *v66; // [rsp+208h] [rbp+100h]
  ...
  char *v76; // [rsp+258h] [rbp+150h]
  __int64 v77; // [rsp+260h] [rbp+158h]
  int *v78; // [rsp+268h] [rbp+160h]
  __int64 v79; // [rsp+270h] [rbp+168h]
  char *v80; // [rsp+278h] [rbp+170h]
  __int64 v81; // [rsp+280h] [rbp+178h]
  _BYTE *v82; // [rsp+288h] [rbp+180h]
  __int64 v83; // [rsp+290h] [rbp+188h]
  int *v84; // [rsp+298h] [rbp+190h]
  __int64 v85; // [rsp+2A0h] [rbp+198h]
  int v86; // [rsp+300h] [rbp+1F8h] BYREF
  int v87; // [rsp+308h] [rbp+200h] BYREF
  int v88; // [rsp+310h] [rbp+208h] BYREF

  v88 = a4;
  v87 = a3;
  v86 = a2;
  v12 = PopFixedWakeSourceMask;
  v13 = ((unsigned __int8)PopFixedWakeSourceMask >> 3) & 1;
  v14 = ((unsigned __int8)PopFixedWakeSourceMask >> 4) & 1;
  v15 = ((unsigned __int8)PopFixedWakeSourceMask >> 2) & 1;
  PopDiagInterruptTimeToSystemTime(qword_14034B1F0, v26);
  PopDiagInterruptTimeToSystemTime(qword_14034B208, v27);
  PopDiagInterruptTimeToSystemTime(qword_14034B1C8, v28);
  result = PopDiagInterruptTimeToSystemTime(a7, v29);
  v25 = PopPendingUserPresenceDuringSystemSleep != 0;
  if ( hProvider.LevelPlus1 > 5 )
  {
    result = TlgKeywordOn(&hProvider, 0x400000000000uLL);
    if ( result )
    {
      v16 = v86;
      LOBYTE(v11) = v87;
      ...
      v83 = 8LL;
      v85 = 4LL;
      result = TlgWrite(&hProvider, &unk_1402ACFCD, 0LL, 0LL, 0x10u, &pData);
    }
  }
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( result )
    {
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v54 = 8LL;
      v56 = 4LL;
      return EtwWriteEx(v8, &POP_ETW_EVENT_RTC_WAKE_INFO, 0LL, 0, 0LL, 0LL, 0xEu, &UserData);
    }
  }
  return result;
}
