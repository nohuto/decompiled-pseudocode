/*
 * XREFs of RtlpCompressRvaList @ 0x140514DC0
 * Callers:
 *     RtlCreateRvaList @ 0x140497F7C (RtlCreateRvaList.c)
 * Callees:
 *     MiImageRvaRawEnumFirst @ 0x140423C24 (MiImageRvaRawEnumFirst.c)
 *     RtlpSetRvaListRvaStateBits @ 0x1404473E0 (RtlpSetRvaListRvaStateBits.c)
...
__int64 __fastcall RtlpCompressRvaList(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _DWORD *a5, _QWORD *a6, int *a7)
{
  ...
  if ( v7 )
  {
    ...
    v12 = v7 + 1;
    *v7 = v14;
    RtlpSetRvaListRvaStateBits(a1, 0, v16);
  }
  v13 = 4;
  v17 = v15;
  v11 = 1;
...
LABEL_12:
      v20 = 0;
      v21 = v17 - v15;
      while ( v21 < RtlpRvaCompressionTableScales[v20] )
      {
