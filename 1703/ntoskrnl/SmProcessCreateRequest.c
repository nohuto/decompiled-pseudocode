/*
 * XREFs of SmProcessCreateRequest @ 0x140567BBC
 * Callers:
...
LABEL_36:
  ...
  v14 = SmAlloc(0x1A20uLL, 0x74536D73u);
  v7 = (__int64)v14;
  if ( !v14 )
  {
    TimeInit = -1073741670;
