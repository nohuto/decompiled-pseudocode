/*
 * XREFs of ?StDmSinglePageRetrieveSync@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAX1K@Z @ 0x14024C5F4
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmSinglePageRetrieveSync(__int64 a1, _DWORD *a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (int)result >= 1 )
  {
    ...
    if ( v9 )
    {
      *(_DWORD *)(v9 + 28) = *(_DWORD *)(v9 + 28) & 0xFFFFFFEF | (v6 != 0 ? 0x10 : 0) | 0xC;
      v12 = &v11;
      v11 = 0LL;
