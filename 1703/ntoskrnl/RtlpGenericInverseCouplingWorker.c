/*
 * XREFs of RtlpGenericInverseCouplingWorker @ 0x14024135C
 * Callers:
 *     RtlScrubMemory @ 0x14024108C (RtlScrubMemory.c)
 * Callees:
 *     RtlpTestAndFillMemoryUp @ 0x140241BDC (RtlpTestAndFillMemoryUp.c)
 *     RtlpTestMemory @ 0x140241C04 (RtlpTestMemory.c)
 */
