/*
 * XREFs of SmHpUnprotectListNeighbors @ 0x1400384C4
 * Callers:
...
__int64 __fastcall SmHpUnprotectListNeighbors(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( !a3 )
  {
    ...
    return SmHpBufferProtect(v8, *(_QWORD *)(a1 + 8 * v8) + 16 * v9, 1LL);
  }
  if ( *a3 != a2 )
  {
    v10 = *(unsigned int *)(*a3 + 16LL);
    _BitScanReverse((unsigned int *)&v11, v10);
    SmHpBufferProtect(v11, *(_QWORD *)(a1 + 8 * v11) + 16 * (v10 ^ (unsigned int)(1 << v11)), 1LL);
  }
  result = a3[1];
  if ( result != a2 )
  {
