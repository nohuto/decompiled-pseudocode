/*
 * XREFs of PpmEventProcessorPerfStateChange @ 0x14014717C
 * Callers:
...
__int64 __fastcall PpmEventProcessorPerfStateChange(struct _KPRCB *a1)
{
  ...
  if ( (xmmword_1403E4010 & 0x8000) != 0 && a1 == KeGetCurrentPrcb() )
  {
    v13 = 0LL;
    v14 = 0LL;
    GroupSetMember = 0LL;
    ...
    v16 = &v13;
    EtwTraceKernelEvent((int)&v16, 1, 0x80008000, 4659, 4200450);
  }
