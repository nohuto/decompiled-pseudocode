/*
 * XREFs of NtCreateTimer @ 0x14053EE40
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( PreviousMode )
    {
      ...
      if ( (*(_DWORD *)&Process->0 & 0x10) != 0 )
      {
        ...
        if ( v14 )
        {
          ...
          v15 = (*(_DWORD *)(v14 + 1304) & 0x40000) != 0 && *(_DWORD *)(v14 + 856);
        }
        v10 = (struct _KTIMER *)DeferredContext;
        PsInsertVirtualizedTimer((__int64)Process, (__int64)DeferredContext + 288, 0, v15, p_DueTime);
        if ( !v14 )
          goto LABEL_10;
...
LABEL_10:
    inserted = ObInsertObjectEx(v10, 0LL, DesiredAccess, 0, 0, 0LL, &v19);
    if ( inserted >= 0 )
