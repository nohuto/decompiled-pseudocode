/*
 * XREFs of IopUpdateMinidumpContext @ 0x1401F2830
 * Callers:
...
LABEL_9:
  ...
  if ( a1 == 257 )
  {
    ...
    IoAddTriageDumpDataBlock(*(_QWORD *)(a4 + 25600), 1232);
    v18 = *(_QWORD *)(v17 + 88);
    v19 = *(_QWORD *)(*(_QWORD *)(a4 + 25600) + 152LL) - 4096LL;
