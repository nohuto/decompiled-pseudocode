/*
 * XREFs of PnprReplaceStart @ 0x1406A2F38
 * Callers:
...
__int64 PnprReplaceStart()
{
  ...
  if ( (*(_DWORD *)(PnprContext + 64) & 0x20) != 0 )
    LODWORD(v11[0]) = v1 | 2;
  v2 = ((__int64 (__fastcall *)(_QWORD *, __int64))off_14033B388[0])(v11, PnprContext + 10632);
  if ( v2 >= 0 )
  {
    v6 = PnprContext;
    if ( *(_DWORD *)(*(_QWORD *)(PnprContext + 24) + 4LL) )
    {
      ...
      *((_QWORD *)v0 + 7) = PnprMapTargetSparePhysicalPages;
      v2 = (*(__int64 (__fastcall **)(_DWORD *, __int64))(v6 + 10672))(v0, v6 + 10640);
      if ( v2 < 0 )
      {
        v7 = PnprContext;
