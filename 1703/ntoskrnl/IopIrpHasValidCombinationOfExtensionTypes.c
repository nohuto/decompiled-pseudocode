/*
 * XREFs of IopIrpHasValidCombinationOfExtensionTypes @ 0x1401F549C
 * Callers:
 *     IoSetAdapterCryptoEngineExtension @ 0x1401F5340 (IoSetAdapterCryptoEngineExtension.c)
 *     IoSetFsTrackOffsetState @ 0x1401F5390 (IoSetFsTrackOffsetState.c)
