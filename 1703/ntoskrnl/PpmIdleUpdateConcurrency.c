/*
 * XREFs of PpmIdleUpdateConcurrency @ 0x1401508F8
 * Callers:
 *     PpmIdleExecuteTransition @ 0x1400F4810 (PpmIdleExecuteTransition.c)
 *     PpmIdleRemoveConcurrency @ 0x140150820 (PpmIdleRemoveConcurrency.c)
 *     PpmIdleInstallConcurrency @ 0x140150890 (PpmIdleInstallConcurrency.c)
 * Callees:
