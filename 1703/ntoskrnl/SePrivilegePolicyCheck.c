/*
 * XREFs of SePrivilegePolicyCheck @ 0x14003E1B8
 * Callers:
...
__int64 __fastcall SePrivilegePolicyCheck(_DWORD *a1, _DWORD *a2, __int64 *a3, int a4, __int64 a5, char a6)
{
  ...
  if ( (*a1 & 0x1000000) != 0 )
  {
    ...
    if ( !(unsigned __int8)SepPrivilegeCheck(v9, (unsigned int)&v21, 1, 1, a6) )
      return 3221225569LL;
    *a1 &= ~0x1000000u;
    v8 = v12;
    *a2 |= 0x1000000u;
  ...
  if ( (unsigned __int8)SepPrivilegeCheck(v9, (unsigned int)&v21, v12, v12, a6) )
  {
    *a1 &= ~0x80000u;
    v8 += v12;
    *a2 |= 0x80000u;
...
LABEL_7:
  if ( v8 == NonPagedPool )
    return 0LL;
  v16 = v12;
  PoolWithTag = ExAllocatePoolWithTag(v12, (unsigned int)(12 * v8 + 8), 0x72506553u);
