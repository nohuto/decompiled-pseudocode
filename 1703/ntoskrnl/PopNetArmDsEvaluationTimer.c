/*
 * XREFs of PopNetArmDsEvaluationTimer @ 0x1406CFD14
 * Callers:
...
_BOOL8 PopNetArmDsEvaluationTimer()
{
  ...
  if ( MEMORY[0xFFFFF78000000008] < (unsigned __int64)(v1 + qword_14036E148) )
    v0 = qword_14036E148 + v1 - MEMORY[0xFFFFF78000000008];
