/*
 * XREFs of KeBalanceSetManager @ 0x14015E600
 * Callers:
 *     <none>
 * Callees:
 *     ExpScanGeneralLookasideList @ 0x14000C5F0 (ExpScanGeneralLookasideList.c)
 *     ExpScanSystemLookasideList @ 0x14000C6F0 (ExpScanSystemLookasideList.c)
...
void __noreturn KeBalanceSetManager()
{
  ...
  Object[1] = (PVOID)(qword_1403817A8 + 104);
  while ( 1 )
  {
    while ( 1 )
    {
...
LABEL_8:
    ...
    if ( !PopEnergyEstimationDisabled && KiTimelineBitmapTime != (unsigned int)(MEMORY[0xFFFFF78000000320] >> 12) )
      KiTimelineBitmapTime = MEMORY[0xFFFFF78000000320] >> 12;
  }
