/*
 * XREFs of KeQuerySpeculationControlInformation @ 0x14041CED8
 * Callers:
...
__int64 __fastcall KeQuerySpeculationControlInformation(_DWORD *a1, unsigned int a2, _DWORD *a3)
{
  ...
  *a1 ^= (*a1 ^ (HIWORD(KiSpeculationFeatures) >> 4)) & 1;
  v5 = *a1 ^ (*a1 ^ (HIWORD(KiSpeculationFeatures) >> 1)) & 2;
  *a1 = v5;
  ...
  *a1 ^= (*a1 ^ (4 * (unsigned __int16)KiSpeculationFeatures)) & 0x20;
  v7 = *a1 ^ (*a1 ^ (2 * (unsigned __int16)KiSpeculationFeatures)) & 0x40;
  *a1 = v7;
  ...
  *a1 = v11;
  v12 = v11 ^ ((unsigned __int16)v11 ^ ((unsigned __int8)~(_BYTE)KiSpeculationFeatures >> 7 << 12)) & 0x1000;
  *a1 = v12;
  ...
  *a1 = v13;
  v14 = KeFeatureBits2;
  v15 = v13 ^ (v13 ^ ((((unsigned __int8)KeFeatureBits2 >> 5) & 1) << 24)) & 0x1000000;
  *a1 = v15;
  v16 = 0;
  if ( !KiKvaShadow || (v17 = 1, (v14 & 8) == 0) )
    v17 = 0;
  v18 = v15 ^ (v15 ^ (v17 << 25)) & 0x2000000;
  *a1 = v18;
  v18 |= 0x4000000u;
  *a1 = v18;
  v19 = v18 | 0x20000000;
