/*
 * XREFs of ExpWatchProductTypeInitialization @ 0x14081062C
 * Callers:
...
char ExpWatchProductTypeInitialization()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  qword_1403449F0 = (__int64)ExpWatchProductTypeWork;
  qword_1403449F8 = 0LL;
    ...
    if ( PoolWithTag )
    {
      ...
      else
      {
        ...
        if ( NtQueryValueKey(ExpProductTypeKey, &ValueName, KeyValuePartialInformation, v44, 0x10u, &ResultLength) != -2147483643 )
          goto LABEL_18;
        ResultLength += 16;
        qword_14036EDE8 = ExAllocatePoolWithTag(PagedPool, ResultLength, 0x2079654Bu);
        if ( !qword_14036EDE8 )
        ...
        if ( NtQueryValueKey(
               ...
               ResultLength,
               &ResultLength) >= 0
          || (ExFreePoolWithTag(qword_14036EDE8, 0), qword_14036EDE8 = 0LL, !ExpSetupModeDetected) )
        {
LABEL_18:
          v10 = -1LL;
          do
