/*
 * XREFs of EtwTiLogAllocExecVm @ 0x1404C9A04
 * Callers:
...
BOOLEAN __fastcall EtwTiLogAllocExecVm(_KPROCESS *a1, __int64 a2, __int64 a3, int a4, char a5)
{
  BOOLEAN result; // al
  ...
  v24 = a3;
  v23 = a2;
  result = EtwProviderEnabled(EtwThreatIntProvRegHandle, 0, 0x10uLL);
  if ( result )
  {
    v7 = (const EVENT_DESCRIPTOR *)&THREATINT_ALLOCVM_REMOTE;
    v8 = EtwThreatIntProvRegHandle;
    Process = KeGetCurrentThread()->ApcState.Process;
    if ( Process == a1 )
      v7 = &THREATINT_ALLOCVM_LOCAL;
