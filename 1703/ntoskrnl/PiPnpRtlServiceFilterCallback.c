/*
 * XREFs of PiPnpRtlServiceFilterCallback @ 0x1406970F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall PiPnpRtlServiceFilterCallback(__int64 a1, const WCHAR *a2, unsigned int a3, __int64 a4)
{
  ...
  unsigned int v32; // [rsp+54h] [rbp-75h]
  ...
  while ( 1 )
  {
    ...
    DeviceRegProp = CmGetDeviceRegProp(v8, v7, 0LL, 5, (__int64)&v29, *(_QWORD *)(a4 + 16), (__int64)&NumberOfBytes, 0);
...
LABEL_16:
      ...
      while ( 1 )
      {
        ...
        {
          NumberOfBytes = 78;
          DeviceRegProp = CmGetDeviceRegProp(v8, v7, 0LL, 9, (__int64)&v29, (__int64)v39, (__int64)&NumberOfBytes, 0);
