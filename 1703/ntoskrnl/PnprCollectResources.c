/*
 * XREFs of PnprCollectResources @ 0x1406A1B70
 * Callers:
...
__int64 __fastcall PnprCollectResources(__int64 *a1, __int64 *a2)
{
  ...
  void *v32; // rcx
  void *v33; // rcx
  char v35; // [rsp+20h] [rbp-38h] BYREF
  __int64 *v36; // [rsp+28h] [rbp-30h]
  _QWORD v37[5]; // [rsp+30h] [rbp-28h] BYREF
  ...
  if ( PoolWithTag )
  {
    ...
    *(_DWORD *)a2[3] = 4;
    ...
    if ( v16 )
      ...
      v17 = 0LL;
    v7 = PipForAllChildDeviceNodes(v17, v15, (__int64)v37);
    if ( v7 < 0 )
    {
      v19 = PnprContext;
    ...
    if ( v22 )
      ...
      v23 = 0LL;
    v7 = PipForAllChildDeviceNodes(v23, v18, (__int64)v37);
    if ( v7 >= 0 )
    {
      v27 = *(_DWORD *)(a1[2] + 16);
...
LABEL_48:
    ...
    {
      v24 = PnprContext;
      v25 = *(_DWORD *)(PnprContext + 10744);
      if ( !v25 )
        v25 = 1125;
      *(_DWORD *)(PnprContext + 10744) = v25;
      v26 = *(_DWORD *)(v24 + 10748);
      if ( !v26 )
        v26 = 1;
    }
    *(_DWORD *)(v24 + 10748) = v26;
    goto LABEL_48;
  }
  v5 = 1028;
LABEL_3:
