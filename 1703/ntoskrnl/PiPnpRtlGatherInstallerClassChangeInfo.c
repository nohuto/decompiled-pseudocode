/*
 * XREFs of PiPnpRtlGatherInstallerClassChangeInfo @ 0x14059A668
 * Callers:
...
__int64 __fastcall PiPnpRtlGatherInstallerClassChangeInfo(_WORD *a1, _WORD *a2, __int64 **a3)
{
  ...
  *PoolWithTag = 0LL;
  ...
  else
  {
    ...
    if ( Object < 0 )
      goto LABEL_12;
    Object = PiDmGetObject(2, v13, *a3 + 1);
