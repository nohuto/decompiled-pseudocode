/*
 * XREFs of MmCreatePeb @ 0x14049B450
 * Callers:
...
__int64 __fastcall MmCreatePeb(_KPROCESS *a1, char *a2, _QWORD *a3, _QWORD *a4)
{
  ...
  struct _IMAGE_NT_HEADERS64 *v33; // [rsp+80h] [rbp-148h]
  ...
  $5BC46E0569261879018906DEC3127961 v63; // [rsp+158h] [rbp-70h] BYREF
  ...
  *((_WORD *)a4 + 4) = v6;
  ...
  v43 = NtGlobalFlag;
  v46 = qword_14036C190;
  v48 = (unsigned int)dword_1403E3130;
  v49 = qword_1403E3140;
  v50 = qword_1403E3138;
  v51 = *a2;
  v52 = a2[3];
  ...
  {
    v24 = _InterlockedExchangeAdd(&dword_14036C18C, 1u) + 1;
    do
    {
      v25 = v24 & 0x3F;
      v26 = 1LL << v25;
  ...
  *(_QWORD *)(v10 + 192) = qword_14036C190;
  *(_QWORD *)(v10 + 792) = (unsigned int)dword_1403E3130;
  *(_QWORD *)(v10 + 240) = v47;
  *(_QWORD *)(v10 + 216) = qword_1403E3140;
  *(_QWORD *)(v10 + 224) = qword_1403E3138;
  *(_DWORD *)(v10 + 236) = 268;
  ...
  *(_QWORD *)(v10 + 176) = v57;
  ...
  if ( v23 != 332 && v23 != 452 )
    goto LABEL_22;
  v7 = MiInitializeWowPeb((__int64)&v34, (__int64)v11, (__int64)a1, (__int64)a4);
  if ( v7 < 0 )
  {
LABEL_29:
