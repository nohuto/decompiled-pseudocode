/*
 * XREFs of CMFCreateSecurityDescriptor @ 0x14072104C
 * Callers:
...
__int64 __fastcall CMFCreateSecurityDescriptor(PVOID *a1, GENERIC_MAPPING *a2)
{
  ...
  int v29; // r9d
  PVOID v30; // rax
  struct _SID_IDENTIFIER_AUTHORITY v32; // [rsp+30h] [rbp-40h] BYREF
  ...
  struct _SID_IDENTIFIER_AUTHORITY v38; // [rsp+C8h] [rbp+58h] BYREF
