/*
 * XREFs of DrvDbCreateDatabaseNode @ 0x1405CD648
 * Callers:
      ...
      *(_QWORD *)(a1 + 24) = v13;
      if ( (v16 & 0x10) == 0
        ...
        || (LOBYTE(pszFormat) = 1,
            ...
            v18 = DrvDbOpenObjectRegKey(a1, v23, 1u, a2, dwFlags, pszFormat, Handle, &v31),
            v18 >= 0)
        && (v31 != 1
...
LABEL_13:
  ...
  if ( v13 )
  {
    ...
    RtlFreeUnicodeString((PUNICODE_STRING)v13 + 1);
    RtlFreeUnicodeString((PUNICODE_STRING)(v13 + 20));
