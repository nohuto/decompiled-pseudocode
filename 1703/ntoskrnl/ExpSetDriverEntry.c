/*
 * XREFs of ExpSetDriverEntry @ 0x14071AA20
 * Callers:
 *     NtAddDriverEntry @ 0x14071C080 (NtAddDriverEntry.c)
 *     NtModifyDriverEntry @ 0x14071D0F0 (NtModifyDriverEntry.c)
 * Callees:
...
LABEL_34:
        ...
        EnvironmentVariable = ZwTranslateFilePath(v6, 4u, v7, (ULONG)&v28);
        if ( EnvironmentVariable < 0 )
          goto LABEL_58;
        Length = OutputFilePathLength;
LABEL_38:
        OutputFilePathLength = Length - 12;
        v37 = Size + 6 + Length - 12;
        v23 = v37;
        v24 = ExAllocatePoolWithTag(NonPagedPoolNx, v37, 0x72766E45u);
        P = v24;
        if ( !v24 )
          goto LABEL_34;
        v25 = v24;
