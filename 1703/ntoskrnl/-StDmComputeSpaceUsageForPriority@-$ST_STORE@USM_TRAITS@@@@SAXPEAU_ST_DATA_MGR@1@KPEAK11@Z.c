/*
 * XREFs of ?StDmComputeSpaceUsageForPriority@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KPEAK11@Z @ 0x14005B878
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  v5 = 0;
  v6 = a2;
  v10 = *(_DWORD *)(a1 + 8LL * a2 + 1808);
  v11 = *(_DWORD *)(a1 + 8LL * a2 + 1812);
  ...
  {
    v17 = *(unsigned int *)(a1 + 16 * (v6 + 77));
    if ( (_DWORD)v17 != -1 )
      v15 = v14 + (*(_WORD *)(*(_QWORD *)(a1 + 1016) + 2 * v17) & 0x1FFF) - v13 + v15 - 1;
    if ( v15 >= v13 )
      v5 = v15;
  }
  *a3 += v10;
