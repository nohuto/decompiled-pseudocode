/*
 * XREFs of AlpcpSendLegacySynchronousRequest @ 0x140472A18
 * Callers:
...
__int64 __fastcall AlpcpSendLegacySynchronousRequest(__int64 a1, __int64 a2, __int128 *a3, __int64 a4)
{
  ...
  if ( (unsigned __int64)WORD1(v40) > *(_QWORD *)(a1 + 272) )
    return 3221225519LL;
  LOBYTE(a2) = 1;
  result = AlpcpValidateMessage(&v40, a2);
  if ( (int)result >= 0 )
  {
    ...
    v13 = (ULONG_PTR)v34;
    *(_OWORD *)(v34 + 62) = *(_OWORD *)&CurrentThread[1].CurrentRunTime;
    *(_DWORD *)(v13 + 240) = v40;
    *(_WORD *)(v13 + 244) = 8193;
    if ( v43 )
    {
...
LABEL_26:
    ...
    if ( v21 && v22 )
    {
      ...
      ExAcquirePushLockSharedEx(v22 + 352, 0LL);
      if ( (*(_DWORD *)(v35 + 416) & 0x20) != 0 )
        goto LABEL_29;
      *(_QWORD *)(v13 + 120) = *(_QWORD *)(v35 + 56);
        ...
        *(_QWORD *)(v5 + 8) = v26;
        ...
        if ( *(_QWORD *)(v21 + 232) != v21 + 232 )
        {
          ...
          if ( v29 != v21 + 232 )
          {
            ...
            *(_QWORD *)(v35 + 1760) = v26;
            ++*((_WORD *)v36 + 9);
            *(_DWORD *)(v26 + 40) |= 0x4000u;
            AlpcpInsertMessagePendingQueue(v21, v26);
            v30 = (_QWORD *)(v35 + 1768);
            v31 = *(_QWORD *)(v35 + 1768);
            v32 = *(_QWORD **)(v35 + 1776);
            if ( *(_QWORD *)(v31 + 8) != v35 + 1768 || (_QWORD *)*v32 != v30 )
              __fastfail(3u);
            *v32 = v31;
            *(_QWORD *)(v31 + 8) = v32;
            *v30 = 0LL;
