/*
 * XREFs of CcInsertVacbArray @ 0x14015E408
 * Callers:
...
LABEL_6:
  ...
  do
  {
    if ( *(result - 2) )
    {
      v7 = (_QWORD *)qword_14036B498;
      if ( *(__int64 **)qword_14036B498 != &CcVacbFreeHighPriorityList )
        __fastfail(3u);
      *result = &CcVacbFreeHighPriorityList;
      result[1] = v7;
      *v7 = result;
      ++CcNumberOfFreeHighPriorityVacbs;
      qword_14036B498 = (__int64)result;
    }
    else
    {
      v6 = (_QWORD *)qword_14036B488;
      if ( *(__int64 **)qword_14036B488 != &CcVacbFreeList )
        __fastfail(3u);
      *result = &CcVacbFreeList;
      result[1] = v6;
      *v6 = result;
      ++CcNumberOfFreeVacbs;
      qword_14036B488 = (__int64)result;
    }
    ++v4;
    result += 5;
  }
