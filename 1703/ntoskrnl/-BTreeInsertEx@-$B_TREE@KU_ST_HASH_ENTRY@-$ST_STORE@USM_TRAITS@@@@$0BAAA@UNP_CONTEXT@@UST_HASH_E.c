/*
 * XREFs of ?BTreeInsertEx@?$B_TREE@KU_ST_HASH_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_HASH_ENTRY_COMPARATOR@2@@@SAJPEAU1@PEAUSEARCH_RESULT@1@PEAK@Z @ 0x14005890C
 * Callers:
        ...
        _DWORD *a3)
{
  ...
  if ( (unsigned __int16)*(_DWORD *)*v10 >= v12 )
  {
    ...
    {
      v18 = (unsigned __int8 *)B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_HASH_ENTRY,4096,NP_CONTEXT,ST_STORE<SM_TRAITS>::ST_HASH_ENTRY_COMPARATOR>::BTreeRedistribute(
                                 a1,
                                 a2);
...
LABEL_41:
      ...
      v28 = (unsigned __int8 *)((unsigned __int64)v20 & 0xFFFFFFFFFFFFFFFEuLL);
...
LABEL_38:
      ...
      v11 = v28;
      LODWORD(v17) = (unsigned __int16)*(_DWORD *)v28 + (_DWORD)v17;
      goto LABEL_38;
    }
    if ( v20 && v11[3] )
    {
    ...
    v20 = B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_HASH_ENTRY,4096,NP_CONTEXT,ST_STORE<SM_TRAITS>::ST_HASH_ENTRY_COMPARATOR>::BTreeSplitChild(
            a1,
            a2);
    if ( v20 )
    {
      v10 = (unsigned __int8 **)(*(_QWORD *)a2 + 16LL * (unsigned int)(*(_DWORD *)(a2 + 24) - 1));
      v27 = (unsigned __int16)*(_DWORD *)v11;
      v19 = (unsigned __int64)*(v10 - 1);
      if ( (int)v17 > v27 )
      {
        v29 = v11[3];
