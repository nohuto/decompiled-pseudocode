/*
 * XREFs of BootApplicationPersistentDataInitialize @ 0x1408207B8
 * Callers:
...
void __fastcall BootApplicationPersistentDataInitialize(__int64 a1)
{
  ...
  qword_140386CF0 = &qword_140386CE8;
  qword_140386CE8 = (__int64)&qword_140386CE8;
  ...
  while ( v2 != v1 )
  {
    ...
    if ( *((_DWORD *)v3 + 6) )
    {
      ...
      *((_DWORD *)PoolWithTag + 6) = *((_DWORD *)v3 + 6);
      ...
      v6 = qword_140386CF0;
      if ( *(__int64 **)qword_140386CF0 != &qword_140386CE8 )
        __fastfail(3u);
      *PoolWithTag = &qword_140386CE8;
      PoolWithTag[1] = v6;
      *v6 = PoolWithTag;
      qword_140386CF0 = PoolWithTag;
    }
  }
}
