/*
 * XREFs of WheapWmiExecuteMethod @ 0x140260CB4
 * Callers:
 *     WheaWmiDispatch @ 0x140166DC0 (WheaWmiDispatch.c)
 * Callees:
 *     WheapWmiExecuteErrorInjectionMethod @ 0x1402607DC (WheapWmiExecuteErrorInjectionMethod.c)
