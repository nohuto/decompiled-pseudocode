/*
 * XREFs of CmpNotifyChangeKey @ 0x140491AD8
 * Callers:
...
LABEL_9:
  ...
  *v15 = a2;
  ...
  {
    v19 = (_QWORD *)qword_1407AC630;
    v20 = &CmpAsyncKernelPostList;
    v21 = (_QWORD *)(a2 + 16);
    if ( *(__int64 **)qword_1407AC630 != &CmpAsyncKernelPostList )
      __fastfail(3u);
    *v21 = &CmpAsyncKernelPostList;
    *(_QWORD *)(a2 + 24) = v19;
    *v19 = v21;
    qword_1407AC630 = a2 + 16;
  }
