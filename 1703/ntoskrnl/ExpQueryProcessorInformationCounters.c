/*
 * XREFs of ExpQueryProcessorInformationCounters @ 0x1404F6DA4
 * Callers:
...
__int64 __fastcall ExpQueryProcessorInformationCounters(__int64 a1, char a2, char a3, char a4, __int64 a5)
{
  ...
  if ( a2 )
  {
    ...
    *(_QWORD *)(a5 + 120) = v22;
    v10 = v8 * v9;
    *(_QWORD *)a5 = v10;
    *(_QWORD *)(a5 + 8) = v10 + v8 * *(unsigned int *)(a1 + 23472);
  ...
  *(_QWORD *)(a5 + 16) = (unsigned int)v8 * (unsigned __int64)*(unsigned int *)(a1 + 23432);
  *(_DWORD *)(a5 + 32) = *(_DWORD *)(a1 + 23424);
  *(_QWORD *)(a5 + 48) = (unsigned int)v8 * (unsigned __int64)*(unsigned int *)(a1 + 23440);
  *(_DWORD *)(a5 + 60) = *(_DWORD *)(a1 + 11804);
  *(_DWORD *)(a5 + 64) = *(_DWORD *)(a1 + 11868);
  *(_QWORD *)(a5 + 40) = (unsigned int)v8 * (unsigned __int64)*(unsigned int *)(a1 + 23436);
