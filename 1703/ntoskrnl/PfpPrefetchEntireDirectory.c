/*
 * XREFs of PfpPrefetchEntireDirectory @ 0x140465B88
 * Callers:
...
__int64 PfpPrefetchEntireDirectory(__int64 a1, __int64 a2, _DWORD *a3, __int64 a4, ...)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    LODWORD(NumberOfBytes) = 8 * a3[1] + 16;
    v10 = IopXxxControlFile(Handle[0], (__int64)&v14, 590112, a3, NumberOfBytes, 0LL, 0, 0);
    if ( v10 >= 0 )
      v10 = 0;
  }
