/*
 * XREFs of MiConstructLoaderEntry @ 0x1404B65FC
 * Callers:
...
__int64 __fastcall MiConstructLoaderEntry(__int64 a1, const void **a2, const void **a3, int a4, int a5, _QWORD *a6)
{
  ...
  unsigned __int64 v61; // [rsp+40h] [rbp-D8h]
  ...
  *((_QWORD *)&v64 + 1) = PoolWithTag;
  ...
  v22 = 8 * ((v21 >> 6) + ((v21 & 0x3F) != 0)) + 16;
  v23 = v22 + 282;
  v61 = v22;
  if ( v22 >= 0xFFFFFFFFFFFFFEE6uLL || v22 == 0 )
    goto LABEL_73;
  if ( v20 )
  {
    if ( v23 + v20 <= v23 )
  ...
  v24 = (*(unsigned __int16 *)v6 + 7LL) & 0xFFFFFFFFFFFFFFF8uLL;
  v25 = v24 + v23;
  if ( v24 + v23 <= v23 )
  {
LABEL_73:
  ...
  {
    if ( v25 + 4LL * (unsigned int)NumberOfSections > v25 )
    {
      v25 += 4LL * (unsigned int)NumberOfSections;
      goto LABEL_11;
    }
    goto LABEL_73;
  }
LABEL_11:
  v62 = ExAllocatePoolWithTag(NonPagedPoolNx, v25, 0x644C6D4Du);
  v11 = v62;
  if ( !v62
    || (v26 = *(_QWORD *)(a1 + 112), (v63 = v26) != 0)
    && (v27 = *(_QWORD *)MiSectionControlArea(v26),
        v29 = v28,
        LOBYTE(v29) = (*(_DWORD *)(v27 + 8) & 0xFFF) != 0,
        v60 = (unsigned int)((*(_DWORD *)(v27 + 8) >> 12) + v29),
        !(unsigned int)MiChargeResident(&MiSystemPartition, (unsigned int)v60, v28)) )
  {
    v55 = -1073741670;
LABEL_75:
  ...
  memset(v62, 0, v25);
  v30 = v62 + 10;
  v31 = (char *)v62 + v61 + 280;
  *((_QWORD *)v62 + 30) = (char *)v62 + 280;
  v32 = &v31[v20];
  *((_QWORD *)v62 + 27) = v60;
  *((_QWORD *)v62 + 29) = v31;
  if ( v56 )
    *((_QWORD *)v62 + 28) = &v32[v24];
  *v62 = *(_OWORD *)a1;
  v62[1] = *(_OWORD *)(a1 + 16);
  v62[2] = *(_OWORD *)(a1 + 32);
  v62[3] = *(_OWORD *)(a1 + 48);
    ...
    if ( v19 )
    {
      ...
      if ( v47 / 0x1CuLL )
      {
        ...
        do
        {
          ...
          {
            memmove(&v31[v47 + 32], (const void *)(v59 + v51), v52);
            v48 = v57;
            *(_DWORD *)&v31[28 * v49 + 52] = v47;
            v47 += v52;
          }
          else
          {
            *(_DWORD *)&v31[28 * v49 + 52] = 0;
          }
          v49 = ++v48;
        ...
        while ( v48 < (*((_QWORD *)&v54 + 1) + (((unsigned __int64)v58->Size - *((_QWORD *)&v54 + 1)) >> 1)) >> 4 );
        v11 = v62;
        v30 = v62 + 10;
      }
      v33 = v67;
  ...
  *((_DWORD *)v11 + 39) = v16->FileHeader.TimeDateStamp;
  ...
  if ( !a5 )
    *((_DWORD *)v30 + 9) |= 1u;
  if ( (dword_1403E3104 & 1) != 0 || (v68 & 2) != 0 )
    *((_DWORD *)v30 + 9) |= 0x10u;
  *((_QWORD *)v11 + 16) = 0LL;
  ...
  *((_QWORD *)v30 + 12) = v30 + 6;
  ...
  if ( !v33 )
  {
    if ( v63 )
    {
      *((_DWORD *)v30 + 8) = -2;
      *((_QWORD *)v30 + 2) = v59 | 3;
      *((_QWORD *)v30 + 3) = (v36 << 12) + v59 - 1;
      v65[0] = v34;
      MiManageSubsectionView((__int64 *)v65, v30, 3);
    }
  }
  *a6 = v11;
  return 0LL;
