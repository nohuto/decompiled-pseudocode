/*
 * XREFs of VslIumEfiRuntimeService @ 0x1401ED320
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall VslIumEfiRuntimeService(unsigned int a1, __int64 a2, int a3, __int128 *a4)
{
  ...
  if ( a2 )
  {
    LODWORD(result) = VslpLockPagesForTransfer((unsigned int)v14, a2, a3, 2, 1);
  ...
  v11 = VslpEnterIumSecureMode(1, 233LL, 0LL, (__int64)v15);
