/*
 * XREFs of ?SmIoCtxQueueWork@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU_SM_IO_CONTEXT@1@PEAU1@KPEAU_SM_WORK_ITEM@1@@Z @ 0x140053590
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmIoCtxQueueWork(__int64 *a1, __int64 a2, __int16 a3, int *a4)
{
  ...
  else
  {
    if ( v9 != 2 )
      goto LABEL_3;
    v17 = *(void (__fastcall **)(__int64, __int64 *, __int64))(a2 + 1808);
    if ( v17 )
    {
      v24 = *a1;
      v25 = a4[6];
    ...
    v20 = *(_QWORD *)v19;
    if ( (*(_BYTE *)(*(_QWORD *)v19 + 5989LL) & 4) != 0
      && (a4[2] & 0x4000000) != 0
