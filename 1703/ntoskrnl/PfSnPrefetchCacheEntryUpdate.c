/*
 * XREFs of PfSnPrefetchCacheEntryUpdate @ 0x140563990
 * Callers:
...
__int64 __fastcall PfSnPrefetchCacheEntryUpdate(_DWORD *a1)
{
  ...
  v8 = qword_14036E050 - 16;
  if ( !memcmp((const void *)(qword_14036E050 - 16 + 32), v1, 0x40uLL)
    || (v8 = PfSnPrefetchCacheEntryGet(&unk_14036E038, v1, v4, 0LL)) != 0 )
  {
    *(_DWORD *)(v8 + 112) = a1[17];
    *(_DWORD *)(v8 + 116) = a1[18];
  }
