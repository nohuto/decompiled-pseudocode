/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x1405BAB50
 * Callers:
 *     LdrRelocateImageWithBias @ 0x1405BAA74 (LdrRelocateImageWithBias.c)
 * Callees:
 *     LdrpGenericProcessRelocation @ 0x14015A690 (LdrpGenericProcessRelocation.c)
 *     LdrpArmProcessRelocation @ 0x14023FF30 (LdrpArmProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x140240004 (LdrpThumbProcessRelocation.c)
 */
