/*
 * XREFs of CmRenameKey @ 0x140663778
 * Callers:
 ...
 *     CmpComputeKcbConvKey @ 0x14066599C (CmpComputeKcbConvKey.c)
 ...
 *     CmpInsertKeyHash @ 0x14066603C (CmpInsertKeyHash.c)
...
__int64 __fastcall CmRenameKey(__int64 a1, __m128i *a2, char a3)
{
  ...
  volatile signed __int32 *v84; // [rsp+B0h] [rbp-58h] BYREF
  unsigned int v85; // [rsp+B8h] [rbp-50h] BYREF
  __int64 v86; // [rsp+C0h] [rbp-48h] BYREF
  _DWORD v87[2]; // [rsp+C8h] [rbp-40h] BYREF
  PVOID v88; // [rsp+D0h] [rbp-38h]
  ...
  while ( 1 )
  {
    ...
    {
      v12 = CmpTransSearchAddTransFromKeyBody(a1, &v82);
      if ( v12 < 0 )
        goto LABEL_124;
      v11 = v82;
      v5 = a3;
...
LABEL_122:
    ...
    if ( v6 == CmpMasterHive
      || (v15 = *(_QWORD *)(v10 + 64)) == 0
      || (v16 = *(_QWORD *)(v15 + 24), v16 == CmpMasterHive) )
    {
LABEL_123:
      v12 = -1073741790;
      goto LABEL_124;
    ...
    LOBYTE(v14) = v5;
    v12 = CmpCheckKeyAccess(v16, *(_DWORD *)(v15 + 32), v14, 4, 0);
    if ( v12 < 0 )
      goto LABEL_124;
    LOBYTE(v17) = a3;
    ...
    if ( v11 )
    {
      ...
      if ( v12 < 0 )
        goto LABEL_111;
      if ( !CmpLockIXLockExclusive(*(_QWORD *)(v10 + 64) + 240LL, v23, 0)
        || !CmpLockIXLockExclusive(*(_QWORD *)(v10 + 64) + 256LL, v23, 1)
        || !CmpLockIXLockExclusive(v10 + 240, v24, 0)
        || !CmpLockIXLockExclusive(v10 + 256, v24, 1) )
      {
        v12 = -1072103423;
        goto LABEL_111;
      }
...
LABEL_111:
        ...
        if ( v84 )
        {
          ...
          CmpDereferenceKeyControlBlockWithLock(v68, 1u);
        }
        ExReleaseRundownProtection((PEX_RUNDOWN_REF)&CmpShutdownRundown);
        KiLeaveCriticalRegionUnsafe((__int64)KeGetCurrentThread());
      ...
      CmpFindSubKeyByNameWithStatus(v6, v8, (__int64)a2, &v85);
      if ( v85 != -1 )
      {
        v12 = -1073741535;
        goto LABEL_102;
      ...
      if ( v82 )
      {
        ...
        if ( v51 )
        {
          ...
          *(_DWORD *)(v52 + 32) = BugCheckParameter3;
          v84 = (volatile signed __int32 *)v52;
        ...
        if ( !v53 )
          goto LABEL_96;
        v55 = (ULONG_PTR)v84;
        CmpTransEnlistUowInKcb(v53, (ULONG_PTR)v84);
        v56 = v82;
        v12 = CmpTransEnlistUowInCmTrans(v54, v82);
        if ( v12 >= 0 )
        {
          v57 = P;
          CmpLockIXLockExclusive(v55 + 240, P, 0);
          CmpLockIXLockExclusive(v55 + 256, v57, 1);
          v58 = v83;
          ...
          *((_DWORD *)v57 + 18) = v59 >> 31;
          ...
          if ( v12 >= 0 )
          {
            CmpDereferenceKeyControlBlockWithLock((volatile signed __int32 *)v10, 1u);
            LOBYTE(v62) = 1;
            DelistKeyBodyFromKCB(a1, v62);
            *(_QWORD *)(a1 + 8) = v55;
            EnlistKeyBodyWithKCB((__int64 *)a1, 2);
LABEL_94:
            v12 = 0;
            v8 = 0LL;
            goto LABEL_124;
