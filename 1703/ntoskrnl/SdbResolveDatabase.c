/*
 * XREFs of SdbResolveDatabase @ 0x14072D64C
 * Callers:
...
__int64 __fastcall SdbResolveDatabase(__int64 a1, _QWORD *a2, int *a3, wchar_t *a4, unsigned int a5)
{
  ...
  const char *v23; // r9
  __int16 v24; // ax
  UNICODE_STRING v25; // [rsp+38h] [rbp-31h] BYREF
  ...
  *a4 = 0;
  ...
  v11 = *((_DWORD *)&(&off_14033DF50)[2 * (int)v14] + 2);
  a5 = v11;
LABEL_9:
  if ( v14 < 3 )
  {
  ...
  if ( (int)AslGuidToString_UStr(&Source, a2, v13) >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    {
      AslLogCallPrintf(1, (unsigned int)"SdbResolveDatabase", 1362, (unsigned int)"Failed to open Key \"%ws\" [%x]");
      goto LABEL_42;
    }
    if ( a3 )
    {
      ...
      {
        AslLogCallPrintf(1, (unsigned int)"SdbResolveDatabase", 1374, (unsigned int)"Failed to get database type [%x]");
        *a3 = 0;
        goto LABEL_42;
      }
      *a3 = a5 & 0x7FFFFFFF;
    ...
    if ( RtlAppendUnicodeToString(&v25, L"\\CUSTOM\\") >= 0 )
    {
      v24 = *(_WORD *)(a1 + 576);
      if ( (v24 == -31132 || v24 == 512 || v24 == -21916) && RtlAppendUnicodeToString(&v25, L"CUSTOM64\\") < 0 )
      {
        v22 = 1399;
      }
      else
      {
        if ( RtlAppendUnicodeStringToString(&v25, &Source) < 0 )
        {
          v23 = "RtlAppendUnicodeStringToString failed while creating CustomSdb path [%x]";
          v22 = 1408;
          goto LABEL_28;
        }
        if ( RtlAppendUnicodeToString(&v25, L".sdb") >= 0 )
        {
          if ( v25.Length < (unsigned __int64)v25.MaximumLength - 2 )
          {
            v10 = v25.Length >> 1;
            a4[v10] = 0;
            goto LABEL_42;
