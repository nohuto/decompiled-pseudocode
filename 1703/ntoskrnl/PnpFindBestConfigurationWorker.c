/*
 * XREFs of PnpFindBestConfigurationWorker @ 0x1405B0B14
 * Callers:
 *     PnpFindBestConfiguration @ 0x1405B0ABC (PnpFindBestConfiguration.c)
 * Callees:
 *     IopSaveRestoreConfiguration @ 0x140596EE0 (IopSaveRestoreConfiguration.c)
 *     IopRetestConfiguration @ 0x14059A5B0 (IopRetestConfiguration.c)
 *     IopTestConfiguration @ 0x1405B0C98 (IopTestConfiguration.c)
 *     PnpSelectFirstConfiguration @ 0x1405B0FD4 (PnpSelectFirstConfiguration.c)
 *     IopAddRemoveReqDescs @ 0x1405B299C (IopAddRemoveReqDescs.c)
 *     IopSelectNextConfiguration @ 0x1405D4124 (IopSelectNextConfiguration.c)
 */
