/*
 * XREFs of HvpFindNextDirtyBlock @ 0x1404B7A5C
 * Callers:
        ...
        char a7)
{
  ...
  if ( !a7 || (PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v14, 0x33354D43u)) != 0LL )
  {
    ...
    v16 = CellMap;
    if ( !CellMap )
      KeBugCheckEx(0x51u, 1uLL, a1, v13, 0x12D3uLL);
    ...
    *a6 = v13 + 4096;
    ...
    if ( v21 > v20 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !FreeBin )
          KeBugCheckEx(0x51u, 1uLL, v25, v23, 0x133DuLL);
...
LABEL_21:
        ...
        v39 = HvpMapEntryGetFreeBin(BlockAddress);
        if ( v39 )
        {
