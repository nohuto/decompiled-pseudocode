/*
 * XREFs of MmGetNumberOfFreeSystemPtes @ 0x140085094
 * Callers:
...
__int64 __fastcall MmGetNumberOfFreeSystemPtes(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  NumberOfCachedPtes = MiGetNumberOfCachedPtes(&qword_14036D0A0, a2, a3, a4);
  v6 = qword_14036D100 + NumberOfCachedPtes + v5;
  if ( v6 >= 0x100000000LL )
    LODWORD(v6) = -1;
