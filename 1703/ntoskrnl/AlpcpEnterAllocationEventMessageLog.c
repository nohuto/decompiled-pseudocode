/*
 * XREFs of AlpcpEnterAllocationEventMessageLog @ 0x1406B112C
 * Callers:
 ...
 *     AlpcpAllocateMessageLog @ 0x1406B0F00 (AlpcpAllocateMessageLog.c)
 */
...
__int64 __fastcall AlpcpEnterAllocationEventMessageLog(__int64 a1)
{
  ...
  if ( MessageLog )
  {
    ...
    *(_DWORD *)(MessageLog + 44) = 1;
    v3 = (__int64 *)qword_14034F768;
    if ( *(__int64 **)qword_14034F768 != &AlpcpMessageLogListHead )
      __fastfail(3u);
    *(_QWORD *)(MessageLog + 8) = qword_14034F768;
    *(_QWORD *)MessageLog = &AlpcpMessageLogListHead;
    v4 = (char *)(MessageLog + 16);
    *v3 = MessageLog;
    qword_14034F768 = MessageLog;
