/*
 * XREFs of VfSuspectDriversGetVerifierInformation @ 0x14077B4F8
 * Callers:
 ...
 *     VfTargetDriversGetZeroCounters @ 0x140774DD0 (VfTargetDriversGetZeroCounters.c)
  ...
  *a3 = 0;
  ...
  if ( (__int64 *)VfSuspectDriversList != &VfSuspectDriversList )
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)(v6 + 24) = dword_14034F664;
      *(_DWORD *)(v6 + 28) = dword_14034F668;
      *(_DWORD *)(v6 + 76) = dword_14034F698;
      *(_DWORD *)(v6 + 32) = dword_14034F66C;
      *(_DWORD *)(v6 + 36) = dword_14034F670;
      *(_DWORD *)(v6 + 40) = dword_14034F674;
      *(_DWORD *)(v6 + 44) = dword_14034F678;
      *(_DWORD *)(v6 + 48) = dword_14034F67C;
      *(_DWORD *)(v6 + 52) = dword_14034F680;
      *(_DWORD *)(v6 + 56) = dword_14034F684;
      *(_DWORD *)(v6 + 60) = dword_14034F688;
      *(_DWORD *)(v6 + 64) = dword_14034F68C;
