/*
 * XREFs of DrvDbDeleteObjectRegKey @ 0x140742610
 * Callers:
...
__int64 __fastcall DrvDbDeleteObjectRegKey(__int64 a1, int a2, wchar_t *a3, unsigned int a4)
{
  ...
  v18 = 0LL;
  v7 = 0;
  ObjectDatabaseNode = DrvDbGetObjectDatabaseNode(a1, a3, &v19, &v18);
  v10 = v18;
  ...
  if ( ObjectDatabaseNode >= 0 )
  {
    if ( v18 )
    {
      v12 = DrvDbAcquireDatabaseNodeBaseKey((__int64 **)a1, (__int64)v18, a2, &v17);
      v11 = v12;
      if ( v12 >= 0 )
      {
    ...
    {
      for ( i = *(const UNICODE_STRING **)(a1 + 16);
            i != (const UNICODE_STRING *)(a1 + 16);
            i = *(const UNICODE_STRING **)&i->Length )
      {
        v10 = i;
        v14 = DrvDbAcquireDatabaseNodeBaseKey((__int64 **)a1, (__int64)i, a2, &v17);
        v11 = v14;
        if ( v14 == -1073740697 )
        {
          v11 = -1073741662;
        ...
        else
        {
          ...
          DrvDbReleaseDatabaseNodeBaseKey(a1, (__int64)i, v15, v17);
          v17 = 0LL;
          if ( v11 < 0 )
          {
            if ( v11 != -1073741772 )
...
LABEL_20:
  if ( v17 )
    DrvDbReleaseDatabaseNodeBaseKey(a1, (__int64)v10, v9, v17);
