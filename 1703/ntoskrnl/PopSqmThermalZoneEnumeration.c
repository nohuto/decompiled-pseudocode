/*
 * XREFs of PopSqmThermalZoneEnumeration @ 0x1406D6C00
 * Callers:
        ...
        int a12)
{
  ...
  {
    LOBYTE(v12) = TlgKeywordOn(&hProvider, 0x400000000000uLL);
    if ( (_BYTE)v12 )
    {
      ...
      v60 = &v29;
      v61 = v18;
      LOBYTE(v12) = TlgWrite(&hProvider, &unk_1402ADC22, 0LL, 0LL, 0xEu, &pData);
    }
  }
  return v12;
}
