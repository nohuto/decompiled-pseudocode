/*
 * XREFs of MiOutSwapKernelStackPage @ 0x14007CC6C
 * Callers:
...
__int64 __fastcall MiOutSwapKernelStackPage(__int64 a1, __int64 a2, ULONG_PTR a3)
{
  __int64 v3; // rbx
  ...
  BYTE4(v10[4]) = 17;
  *(_OWORD *)&v10[5] = v8;
  MiOutSwapWorkingSetCallback((__int64)v10, a3, a3);
  result = 0LL;
