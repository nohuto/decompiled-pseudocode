/*
 * XREFs of PspInitializeProtectedProcessParameters @ 0x1405CC41C
 * Callers:
...
__int64 __fastcall PspInitializeProtectedProcessParameters(__int64 a1)
{
  ...
  *(_OWORD *)(a1 + 960) = *(_OWORD *)(a1 + 1016);
  v7 = *(_OWORD *)(a1 + 1016);
  v2 = 2 * (*(_WORD *)(a1 + 1016) + 42);
  *(_WORD *)(a1 + 976) = v2;
  v2 += 2;
  *(_WORD *)(a1 + 978) = v2;
  PoolWithTag = ExAllocatePoolWithTag(PagedPool, v2, 0x6C537350u);
  *(_QWORD *)(a1 + 984) = PoolWithTag;
  if ( !PoolWithTag )
    return 3221225626LL;
  *(_QWORD *)PoolWithTag = *(_QWORD *)L"Path=";
  PoolWithTag[4] = aPath[4];
  v4 = (char *)(PoolWithTag + 5);
  memmove(PoolWithTag + 5, *(const void **)(a1 + 1024), *(unsigned __int16 *)(a1 + 1016));
  v5 = &v4[*(unsigned __int16 *)(a1 + 1016)];
  ...
  *((_WORD *)v5 + 10) = aSystemroot_5[10];
  memmove(v5 + 22, *(const void **)(a1 + 1024), *(unsigned __int16 *)(a1 + 1016));
  *(_DWORD *)&v5[*(unsigned __int16 *)(a1 + 1016) + 22] = 0;
  return 0LL;
}
