/*
 * XREFs of EtwpWriteProcessStarted @ 0x140451038
 * Callers:
...
void __fastcall EtwpWriteProcessStarted(__int64 a1, int *a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  _DWORD v58[6]; // [rsp+198h] [rbp+98h] BYREF

  if ( stru_14033C520.LevelPlus1 > 5 && TlgKeywordOn(&stru_14033C520, 3uLL) )
  {
    v20 = *(_QWORD *)(a1 + 776);
    v15 = *(_DWORD *)(a1 + 736);
    v16 = *(_DWORD *)(a1 + 992);
    ProcessSessionId = PsGetProcessSessionId(a1);
    v9 = *(unsigned __int16 **)(a1 + 1128);
    v17 = ProcessSessionId;
    ProcessStartKey = PsGetProcessStartKey(a1);
    v22 = *(_QWORD *)(a1 + 1848);
    v23 = *(_QWORD *)(a1 + 1856);
    Time = MmGetSessionCreateTime(v10);
    v18 = *a2;
    v19 = a2[1];
    v27 = 8LL;
    v26 = &v20;
    ...
    v56 = 2LL;
    v58[1] = 0;
    TlgWrite(&stru_14033C520, &unk_1402AF14E, 0LL, 0LL, 0x13u, &pData);
  }
}
