/*
 * XREFs of SepRmCommandServerThread @ 0x1405C5730
 * Callers:
 *     <none>
 * Callees:
 *     PsGetHostSilo @ 0x14001ED90 (PsGetHostSilo.c)
 *     SepRmProcessCreationCommandLineAuditSettingsWrkr @ 0x14003CC20 (SepRmProcessCreationCommandLineAuditSettingsWrkr.c)
 ...
 *     SepRmAddLogonSessionInfoWrkr @ 0x140454C00 (SepRmAddLogonSessionInfoWrkr.c)
...
void __fastcall SepRmCommandServerThread(PVOID StartContext)
{
  ...
  $899616CA535F31E7B2C291907A0FBA2E v21; // [rsp+290h] [rbp+188h]
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( PsIsHostSilo((__int64)HostSilo) )
      {
        ...
        ExAcquireResourceExclusiveLite(&stru_14036F020, 1u);
        qword_14036F0C0 = (__int64)&Event;
        v8 = SepLsaAuditQueueInfo == (_QWORD)&SepLsaAuditQueueInfo;
        ExReleaseResourceLite(&stru_14036F020);
        KiLeaveCriticalRegionUnsafe((__int64)KeGetCurrentThread());
        inited = SepAdtInitLsaDeadEventForNonPagedList((__int64)&Object);
        v10 = KeGetCurrentThread();
        v11 = inited;
        --v10->KernelApcDisable;
        ExAcquireResourceExclusiveLite(&stru_14036EEF0, 1u);
        qword_14036EF90 = (__int64)&v17;
        v12 = SepLsaDeletedLogonQueueInfo == (_QWORD)&SepLsaDeletedLogonQueueInfo;
        ExReleaseResourceLite(&stru_14036EEF0);
        KiLeaveCriticalRegionUnsafe((__int64)KeGetCurrentThread());
        if ( !v8 )
