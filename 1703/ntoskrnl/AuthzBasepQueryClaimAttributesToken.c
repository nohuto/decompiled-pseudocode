/*
 * XREFs of AuthzBasepQueryClaimAttributesToken @ 0x14044266C
 * Callers:
 ...
 *     AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x140732AD0 (AuthzBasepGetClaimAttributesCopyoutBufferSize.c)
 */
