/*
 * XREFs of PopMarkHiberPhase @ 0x14040D278
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_14034B2F0, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_14034B2B8, (unsigned int)dword_14034B2C0, 0);
