/*
 * XREFs of VfCheckImageCompliance @ 0x140766238
 * Callers:
        ...
        *(_QWORD *)Str1 = *(_QWORD *)v5;
        ...
        if ( stricmp(Str1, "INIT") || (VfOptionFlags & 0x100) != 0 )
        {
          ViCiPreprocessOptions(
            ...
            v5,
            Str1);
          VfReportIssueWithOptions(0xC4u, 8195, a1 + 88, v5, (__int64)Str1, Response);
          if ( (MmVerifierData & 0x1000) != 0 )
            ViTargetIncrementCounter(*(_QWORD *)(a1 + 56), 260LL);
          _InterlockedIncrement(&dword_14034F6FC);
        }
      }
      if ( v2 )
      {
          ...
          && (*(_DWORD *)(v5 + 36) & 0x20000000) != 0 )
        {
          *(_QWORD *)Str1 = *(_QWORD *)v5;
          ...
          ViCiPreprocessOptions(
            ...
            v6,
            Str1);
          VfReportIssueWithOptions(0xC4u, 8198, a1 + 88, (int)v6, (__int64)Str1, byte_140341334);
          if ( (MmVerifierData & 0x1000) != 0 )
            ViTargetIncrementCounter(*(_QWORD *)(a1 + 56), 272LL);
          _InterlockedIncrement(&dword_14034F708);
        }
      }
      ...
      if ( !SectionAlignment || (SectionAlignment & 0xFFF) != 0 )
      {
        *(_QWORD *)Str1 = *(_QWORD *)v5;
        ...
        ViCiPreprocessOptions(
          ...
          v5,
          Str1);
        VfReportIssueWithOptions(0xC4u, 8196, a1 + 88, v5, (__int64)Str1, byte_140341328);
        if ( (MmVerifierData & 0x1000) != 0 )
          ViTargetIncrementCounter(*(_QWORD *)(a1 + 56), 264LL);
        _InterlockedIncrement(&dword_14034F700);
      }
      v5 += 40LL;
      ++v7;
    }
    ...
    do
    {
      ...
      if ( *v15 >> 12 == 10 )
      {
        ...
        ViCiPreprocessOptions(
          ...
          v13,
          v15);
        VfReportIssueWithOptions(0xC4u, 8197, a1 + 88, v13, (__int64)v15, &dword_14034132C);
      }
      else
      {
        ViCiPreprocessOptions(
          ...
          v13,
          v15);
        VfReportIssueWithOptions(0xC4u, 8197, a1 + 88, v13, (__int64)v15, byte_140341324);
      }
      if ( (MmVerifierData & 0x1000) != 0 )
        ViTargetIncrementCounter(*(_QWORD *)(a1 + 56), 268LL);
      _InterlockedIncrement(&dword_14034F704);
LABEL_43:
      ++v15;
    }
