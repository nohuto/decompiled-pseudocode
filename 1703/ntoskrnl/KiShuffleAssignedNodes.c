/*
 * XREFs of KiShuffleAssignedNodes @ 0x14083475C
 * Callers:
            ...
            if ( v16 != v40 )
            {
              ...
              if ( *(_DWORD *)(v7 + 4LL * v18) >= (unsigned int)(v17 - v19) )
              {
                ...
                do
                {
                  if ( v21 != v9 )
                  {
                    ...
                    if ( *(_WORD *)(v22 + 144) == v16 && (*(_BYTE *)(v22 + 173) & 2) != 0 )
                      v20 += v43[v36 * *(unsigned __int16 *)(v12 + 146) + *(unsigned __int16 *)(v22 + 146)]
                ...
                do
                {
                  if ( v23 != v38 )
                  {
                    ...
                    if ( *(_WORD *)(v24 + 144) == v40 && (*(_BYTE *)(v24 + 173) & 2) != 0 )
                      v20 += v43[v36 * *(unsigned __int16 *)(v45 + 146) + *(unsigned __int16 *)(v24 + 146)]
                ...
                do
                {
                  ...
                  {
                    v27 = a1[v26];
                    if ( *(_WORD *)(v27 + 144) == *(_WORD *)(v45 + 144) && (*(_BYTE *)(v27 + 173) & 2) != 0 )
                      v25 += v43[v36 * *(unsigned __int16 *)(v46 + 146) + *(unsigned __int16 *)(v27 + 146)]
                ...
                do
                {
                  ...
                  {
                    v29 = a1[v28];
                    if ( *(_WORD *)(v29 + 144) == *(_WORD *)(v46 + 144) && (*(_BYTE *)(v29 + 173) & 2) != 0 )
                      v25 += v43[v36 * *(unsigned __int16 *)(v45 + 146) + *(unsigned __int16 *)(v29 + 146)]
