/*
 * XREFs of KdPollBreakIn @ 0x1401FC2C0
 * Callers:
    ...
    if ( (_BYTE)KdDebuggerEnabled || KdEventLoggingEnabled )
    {
      ...
      if ( v4 )
      {
        ...
        *v5 = ((unsigned __int64)HIDWORD(v6) << 32) | (unsigned int)v6;
        v5[1] = 4LL * ((unsigned __int8)KdDebuggerNotPresent & 1);
      }
      if ( BYTE4(KdpContext) )
      {
        v2 = 1;
      ...
      if ( v7 )
      {
        v8 = (unsigned int)*v7;
        v9 = __rdtsc();
        *(_QWORD *)&v7[4 * v8 + 6] = v7[4 * v8 + 6] & 4 | (2LL * ((unsigned __int8)KdDebuggerNotPresent & 1)) | ((((unsigned __int64)HIDWORD(v9) << 32) | (unsigned int)v9) - *(_QWORD *)&v7[4 * v8 + 4]) & 0xFFFFFFFFFFFFFFF0uLL;
        if ( (_DWORD)v8 == 254 )
          *v7 = 0;
        else
          *v7 = v8 + 1;
