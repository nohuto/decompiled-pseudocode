/*
 * XREFs of ?BTreeMergeNodes@?$B_TREE@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@U?$B_TREE_KEY_COMPARATOR@T_SM_PAGE_KEY@@@@@@SAXPEAU1@PEAUSEARCH_RESULT@1@PEAUNODE@?$B_TREE_HEADER@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@@@@Z @ 0x14013BAD8
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( *(_BYTE *)(v6 + 3) )
  {
    ...
    if ( v10 == -1 )
      *(_QWORD *)(v6 + 8) = v11;
    v12 = (void *)(v6 + 8 * (v9 + 2));
    v13 = 8LL * (unsigned __int16)*(_DWORD *)v7;
  }
  else
  {
    v17 = 2 * v9;
