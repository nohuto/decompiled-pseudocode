/*
 * XREFs of IopStartNextPacketByKeyEx @ 0x14013FAD4
 * Callers:
 *     IoStartNextPacket @ 0x14013FAA0 (IoStartNextPacket.c)
 *     IoStartNextPacketByKey @ 0x1401F4210 (IoStartNextPacketByKey.c)
 * Callees:
