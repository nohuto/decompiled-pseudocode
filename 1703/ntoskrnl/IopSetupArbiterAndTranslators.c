/*
 * XREFs of IopSetupArbiterAndTranslators @ 0x1405B1FC8
 * Callers:
 *     IopResourceRequirementsListToReqList @ 0x1405B1A14 (IopResourceRequirementsListToReqList.c)
 * Callees:
 *     ExAllocatePoolWithTag @ 0x140285010 (ExAllocatePoolWithTag.c)
 *     IopFindResourceHandlerInfo @ 0x1405B23C0 (IopFindResourceHandlerInfo.c)
 *     IopFindLegacyBusDeviceNode @ 0x1405B2450 (IopFindLegacyBusDeviceNode.c)
...
LABEL_20:
          ...
          *(_QWORD *)(PoolWithTag + 24) = v28;
          *(_QWORD *)(PoolWithTag + 32) = LegacyBusDeviceNode;
          v30 = *(unsigned __int64 **)(LegacyBusDeviceNode + 512);
          if ( *v30 != LegacyBusDeviceNode + 504 )
            __fastfail(3u);
          *(_QWORD *)(PoolWithTag + 8) = v30;
          v31 = v28 != 0;
          v13 = v36;
          *(_QWORD *)PoolWithTag = LegacyBusDeviceNode + 504;
          *v30 = PoolWithTag;
          v14 = PoolWithTag & -(__int64)v31;
