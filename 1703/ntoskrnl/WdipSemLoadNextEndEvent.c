/*
 * XREFs of WdipSemLoadNextEndEvent @ 0x1405C9FD8
 * Callers:
...
LABEL_38:
    ...
    if ( v6 >= 0 )
    {
      ...
      if ( v6 >= 0 )
      {
        ...
        if ( v6 >= 0 )
        {
          v14 = WdipSemQueryValueFromRegistry(Handle, L"Level", 4, 4u, &v22, &ResultLength);
          v6 = v14;
          if ( v14 < 0 )
          {
            if ( v14 != -1073741772 )
          ...
          v16 = WdipSemQueryValueFromRegistry(Handle, L"Keyword", 11, 8u, &v25, &ResultLength);
          v6 = v16;
          if ( v16 >= 0 )
          {
            v17 = v25;
...
LABEL_28:
            v18 = WdipSemQueryValueFromRegistry(Handle, L"EnableProperty", 4, 4u, &v23, &ResultLength);
            v6 = v18;
            if ( v18 >= 0 )
            {
