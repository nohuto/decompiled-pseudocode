/*
 * XREFs of ?StAcquireReadContext@?$ST_STORE@USM_TRAITS@@@@SAPEAXPEAU1@@Z @ 0x14011FA24
 * Callers:
...
PSLIST_ENTRY __fastcall ST_STORE<SM_TRAITS>::StAcquireReadContext(__int64 a1)
{
  ...
  v2 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(a1 + 4016));
  if ( !v2 )
  {
    v4 = (unsigned int)(*(_DWORD *)(a1 + 3992) + 4528);
    if ( (*(_DWORD *)(a1 + 856) & 0x40000) == 0 )
      v4 = (unsigned int)(*(_DWORD *)(a1 + 3992) + 432);
