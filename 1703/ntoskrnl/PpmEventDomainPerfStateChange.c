/*
 * XREFs of PpmEventDomainPerfStateChange @ 0x14014B088
 * Callers:
...
BOOLEAN __fastcall PpmEventDomainPerfStateChange(__int64 a1)
{
  ...
  if ( WmiPerfStateDomainEventEnabled )
  {
    ...
    v30 = v3;
    LODWORD(v29) = v26;
    result = PpmFireWmiEvent(v4 + 24160, &PPM_PERFSTATE_DOMAIN_CHANGE_GUID, 24LL, &v28);
  }
  if ( PpmEtwRegistered )
  {
    ...
    if ( result )
    {
      ...
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v16 = 2LL * v11;
      *(&UserData.Ptr + v16) = a1 + 400;
      *((_QWORD *)&UserData.Size + v16) = 4LL;
      v17 = v11 + 1;
      v18 = v11 + 2;
      v17 *= 2LL;
      *(&UserData.Ptr + v17) = a1 + 408;
      *((_QWORD *)&UserData.Size + v17) = 4LL;
      v19 = 2LL * v18;
      *(&UserData.Ptr + v19) = a1 + 412;
      *((_QWORD *)&UserData.Size + v19) = 4LL;
      v20 = v18 + 1;
      v18 += 2;
      v20 *= 2LL;
      *(&UserData.Ptr + v20) = a1 + 416;
