/*
 * XREFs of KeLoadMTRR @ 0x14040E400
 * Callers:
 *     KiLoadMTRRTarget @ 0x140412B80 (KiLoadMTRRTarget.c)
 * Callees:
 *     __security_check_cookie @ 0x140169210 (__security_check_cookie.c)
 *     KeFlushCurrentTbImmediately @ 0x14017BB00 (KeFlushCurrentTbImmediately.c)
 *     KiLockStepExecution @ 0x14040E5E4 (KiLockStepExecution.c)
 *     KiWriteFixedMtrr @ 0x14040E628 (KiWriteFixedMtrr.c)
 *     KiReadFixedMtrr @ 0x14040E738 (KiReadFixedMtrr.c)
 *     KiCompareVarMtrr @ 0x14040E848 (KiCompareVarMtrr.c)
 */
...
__int64 __fastcall KeLoadMTRR(__int64 a1)
{
  ...
  if ( byte_14034FFB0 )
  {
    ...
    if ( (_BYTE)qword_14034FFA8 )
    {
      ...
      {
        v12 = 2 * v10;
        __writemsr(v11 - 1, *((_QWORD *)qword_14034FFB8 + v12));
        v8 = HIDWORD(*((_QWORD *)qword_14034FFB8 + v12 + 1));
        __writemsr(v11, *((_QWORD *)qword_14034FFB8 + v12 + 1));
        v10 = ++v9;
        v11 += 2;
      }
      while ( v9 < (unsigned __int64)(unsigned __int8)qword_14034FFA8 );
    }
    if ( qword_14034FFC0 )
    {
      ...
      {
        v13 = 0LL;
        v14 = (PVOID)((_BYTE *)qword_14034FFC0 - v17);
        v15 = v17;
...
LABEL_17:
      KiWriteFixedMtrr(qword_14034FFC0, v13, v14);
    }
