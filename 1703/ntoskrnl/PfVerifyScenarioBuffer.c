/*
 * XREFs of PfVerifyScenarioBuffer @ 0x140565B70
 * Callers:
 ...
 *     PfMetadataRecordIsEqual @ 0x1404667CC (PfMetadataRecordIsEqual.c)
 *     PfVerifyScenarioId @ 0x140566AB8 (PfVerifyScenarioId.c)
 */
...
__int64 __fastcall PfVerifyScenarioBuffer(unsigned int *a1, unsigned int a2, int *a3)
{
  ...
  __int64 v76; // [rsp+20h] [rbp-118h]
  __int64 v77; // [rsp+28h] [rbp-110h]
  int v78; // [rsp+30h] [rbp-108h]
  unsigned int v79; // [rsp+34h] [rbp-104h]
  unsigned int v80; // [rsp+38h] [rbp-100h]
  unsigned __int64 v81; // [rsp+40h] [rbp-F8h]
  unsigned int v83; // [rsp+50h] [rbp-E8h]
  int v84; // [rsp+54h] [rbp-E4h]
  unsigned int v85; // [rsp+5Ch] [rbp-DCh]
  unsigned int v86; // [rsp+60h] [rbp-D8h]
  unsigned __int64 v87; // [rsp+68h] [rbp-D0h]
  unsigned __int64 v88; // [rsp+70h] [rbp-C8h] BYREF
  unsigned __int64 v89; // [rsp+78h] [rbp-C0h]
  unsigned int *v90; // [rsp+80h] [rbp-B8h]
  unsigned __int64 v91; // [rsp+88h] [rbp-B0h]
  _WORD v92[16]; // [rsp+90h] [rbp-A8h] BYREF
  ...
  else if ( *a1 == 30 && a1[1] == 1094927187 )
  {
    ...
    else if ( a2 == a1[3] )
    {
      ...
      else
      {
        ...
        v85 = v6;
        if ( v6 > 0x4000
          || (v7 = a1[28], v86 = v7, (unsigned int)v7 > 0x4000)
          ...
          else if ( (unsigned __int8)PfVerifyScenarioId(a1 + 4) )
          {
            ...
            if ( (v13 & 3) != 0 )
            {
              v3 = 38;
                   ...
                   || (v14 = (char *)v12 + v10, v87 = (unsigned __int64)v12 + v10, v13 >= (unsigned __int64)v12 + v10) )
            {
              v3 = 40;
            }
            else
...
LABEL_87:
                                          ...
                                          if ( v50 < (unsigned __int64)v12 || v50 >= v87 )
                                          {
                                            v3 = 200;
                                            goto LABEL_66;
                                          }
                                          v51 = (unsigned __int16 *)(v50 + 2LL * v47[1]);
                                          if ( (char *)v51 + 1 < (char *)v12 || (unsigned __int64)v51 + 1 >= v87 )
                                          {
                                            v3 = 210;
                                            goto LABEL_66;
                                          }
                                          ...
                                          v12 = a1;
                                          if ( v57 < a1 || (unsigned __int64)v57 >= v87 )
                                          {
                                            v3 = 230;
                                            goto LABEL_66;
                                          }
                                          ...
                                          v59 = (char *)v57 + v58 - 1;
                                          if ( v59 < (char *)a1 || (unsigned __int64)v59 >= v87 )
                                          {
                                            v3 = 245;
                                            goto LABEL_66;
                                          }
                                          ...
                                          if ( v67 )
                                          {
                                            while ( v71 >= v12 && (unsigned __int64)v71 < v87 )
                                            {
                                              if ( (unsigned int *)((char *)v71 + 3) < v12
                                                || (unsigned __int64)v71 + 3 >= v87 )
                                              {
                                                v3 = 290;
                                                goto LABEL_66;
                                              }
                                              ...
                                              v73 = (_WORD *)v71 + *(unsigned __int16 *)v71;
                                              if ( (unsigned int *)((char *)v73 + 3) < v12
                                                || (unsigned __int64)v73 + 3 >= v87 )
                                              {
                                                v3 = 310;
                                                goto LABEL_66;
                                              }
...
LABEL_129:
                                        ...
                                        while ( !PfMetadataRecordIsEqual(v81 + 96LL * v48, &v88, v49) )
                                        {
                                          v48 = v74 + 1;
                                          if ( v48 >= v75 )
                                            goto LABEL_87;
