/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x1406A611C
 * Callers:
...
char __fastcall PnpTraceDeviceRemovalForResetComplete(__int64 a1, UCHAR a2)
{
  ...
  _DWORD v35[6]; // [rsp+118h] [rbp+18h] BYREF

  LOBYTE(v2) = TraceLoggingProviderEnabled(&stru_14033C440, a2, 0x400000000000uLL);
  if ( (_BYTE)v2 )
  {
    v2 = *(_QWORD *)(v3 + 184);
    if ( v2 )
    ...
    {
      LOBYTE(v2) = TlgKeywordOn(&stru_14033C440, 0x400000000000uLL);
      if ( (_BYTE)v2 )
      {
        v8 = *(_DWORD *)(v4 + 300);
        v9 = *(_DWORD *)(v5 + 164);
        ...
        v33 = 2LL;
        v35[1] = v6;
        LOBYTE(v2) = TlgWrite(&stru_14033C440, &unk_1402ABF0D, 0LL, 0LL, 0xDu, &pData);
      }
    }
  }
  return v2;
