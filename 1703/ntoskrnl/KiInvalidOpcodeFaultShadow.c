/*
 * XREFs of KiInvalidOpcodeFaultShadow @ 0x14026C400
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall KiInvalidOpcodeFaultShadow(int a1, unsigned __int64 a2, int a3, int a4, char a5)
{
  ...
  if ( (v11.OffsetLow & 1) != 0 )
  {
    ...
    return KiInvalidOpcodeFault(a1, a2, a3, a4, a5);
  }
  else
  {
    _mm_lfence();
