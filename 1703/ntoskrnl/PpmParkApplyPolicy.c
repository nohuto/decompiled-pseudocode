/*
 * XREFs of PpmParkApplyPolicy @ 0x1401604C8
 * Callers:
...
void __fastcall PpmParkApplyPolicy(__int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
  ...
  {
    v5 = 64;
    v6 = 175LL * dword_14034BB2C;
    v60 = PpmCurrentProfile[v6 + 17];
    v59 = WORD1(PpmCurrentProfile[v6 + 17]);
    if ( (((unsigned __int64)qword_140340078[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[0] >> 6] >> (KiProcessorIndexToNumberMappingTable[0] & 0x3F)) & 1) == 0 )
    {
    ...
    if ( PpmParkNumNodes )
    {
      ...
      do
      {
        ...
        do
        {
          v24 = *((_BYTE *)&v59 + v23 + v20 + 104);
          if ( v24 )
          {
            v25 = (v24 * (unsigned int)*((unsigned __int8 *)&v59 + v23) + 50) / 0x64;
            v26 = (v24 - (unsigned __int8)v25) % v8 + v25;
            v27 = (v24 * (unsigned int)*((unsigned __int8 *)&v60 + v23) + 50) / 0x64;
...
LABEL_24:
    ...
    while ( v9 )
    {
      ...
      if ( v44 )
      {
        v45 = v8 + *(_BYTE *)(v43 + v12 + 110);
        if ( v45 < v44 )
        {
          *(_BYTE *)(v43 + v12 + 110) = v45;
          v9 -= v10;
        }
      }
      if ( ++v42 >= v7 )
    ...
    while ( v11 )
    {
      ...
      if ( v7 )
      {
        while ( v11 )
        {
          ...
          if ( v48 )
          {
            v49 = v8 + *(_BYTE *)(v47 + v12 + 112);
            if ( v49 < v48 )
            {
              *(_BYTE *)(v47 + v12 + 112) = v49;
              v11 -= v10;
            }
          }
          if ( ++v46 >= v7 )
