/*
 * XREFs of DrvDbDispatchDriverInfFile @ 0x1404E8230
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  if ( v14 )
  {
    ...
    if ( v15 )
    {
      ...
      {
        DriverInfFileMappedProperty = DrvDbGetObjectList(v23[0], 3, *a5, a5[1], a5[2], *((_DWORD *)a5 + 6), a5[4], 0);
      }
    }
    else
    {
      DriverInfFileMappedProperty = DrvDbDeleteObjectRegKey(v23[0], 3LL, a2);
    }
    goto LABEL_11;
  }
  v22 = *(_DWORD *)a5;
  LODWORD(v23[0]) = 0;
  LODWORD(v9) = DrvDbOpenObjectRegKey(v10, 0LL, 3u, a2, v22, 1, a5 + 1, v23);
  if ( (int)v9 >= 0 )
