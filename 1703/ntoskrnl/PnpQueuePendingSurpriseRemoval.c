/*
 * XREFs of PnpQueuePendingSurpriseRemoval @ 0x14056D958
 * Callers:
 ...
 *     IopMergeRelationLists @ 0x1406A760C (IopMergeRelationLists.c)
 */
...
__int64 __fastcall PnpQueuePendingSurpriseRemoval(PVOID a1, void **a2, int a3, int a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v4 == v10 )
  {
    ...
    v12 = (__int64 *)qword_140367ED8;
    if ( *(PVOID **)qword_140367ED8 != &IopPendingSurpriseRemovals )
      __fastfail(3u);
    *(_QWORD *)CriticalMemory = &IopPendingSurpriseRemovals;
    *(_QWORD *)(CriticalMemory + 8) = v12;
    *v12 = CriticalMemory;
    qword_140367ED8 = CriticalMemory;
  }
  else
  {
