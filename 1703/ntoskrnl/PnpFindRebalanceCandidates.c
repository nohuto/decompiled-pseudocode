/*
 * XREFs of PnpFindRebalanceCandidates @ 0x1406A9930
 * Callers:
 *     PnpRebalance @ 0x1406A9D3C (PnpRebalance.c)
 * Callees:
 *     PnpQueryRebalance @ 0x1406A9A48 (PnpQueryRebalance.c)
 */
        ...
        __int64 a6)
{
  ...
  {
    v9 = (_DWORD *)a6;
    PnpQueryRebalance(IopRootDeviceNode, a3, (_DWORD)a4, a6 + 64 + 8 * a1, a6 + 80 + 4LL * a1, a5);
