/*
 * XREFs of SepRmFetchGlobalSacl @ 0x1405C5920
 * Callers:
 *     SepRmGlobalSaclSetWrkr @ 0x1405C5890 (SepRmGlobalSaclSetWrkr.c)
 * Callees:
 *     RtlStringCchCatNW @ 0x14016283C (RtlStringCchCatNW.c)
...
__int64 __fastcall SepRmFetchGlobalSacl(STRSAFE_PCNZWCH *a1, ULONG *a2, _QWORD *a3)
{
  ...
  v3 = *(unsigned __int16 *)a1 + 98;
  KeyHandle = 0LL;
  ResultLength = 0;
  v6 = v3;
  PoolWithTag = (wchar_t *)ExAllocatePoolWithTag(PagedPool, v3, 0x6C635347u);
  v9 = PoolWithTag;
  if ( !PoolWithTag )
  {
    v15 = -1073741801;
