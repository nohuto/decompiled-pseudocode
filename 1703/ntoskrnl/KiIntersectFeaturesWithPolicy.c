/*
 * XREFs of KiIntersectFeaturesWithPolicy @ 0x140412664
 * Callers:
 ...
 *     KiIsXSaveFeatureAllowed @ 0x1404127A8 (KiIsXSaveFeatureAllowed.c)
 *     KiLoadPolicyFromImage @ 0x14041283C (KiLoadPolicyFromImage.c)
 */
