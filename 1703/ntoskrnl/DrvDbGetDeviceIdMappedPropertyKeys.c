/*
 * XREFs of DrvDbGetDeviceIdMappedPropertyKeys @ 0x140742C9C
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  if ( CompositeMappedPropertyKeys >= 0 && v15 )
    CompositeMappedPropertyKeys = DrvDbGetCompositeMappedPropertyKeys(v10, (_OWORD **)off_14033DFD8, 2u, a4, a5, v6);
LABEL_7:
  if ( Handle[0] )
    ZwClose(Handle[0]);
