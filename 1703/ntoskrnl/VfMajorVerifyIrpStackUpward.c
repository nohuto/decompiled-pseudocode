/*
 * XREFs of VfMajorVerifyIrpStackUpward @ 0x140773594
 * Callers:
        ...
        int a5))(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD)
{
  ...
  result = qword_1407918D8;
  if ( qword_1407918D8 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD))qword_1407918D8(
                                                                                     a1,
                                                                                     a2,
                                                                                     *(_QWORD *)(a3 + 8),
                                                                                     a3,
