/*
 * XREFs of ExInitializeLookasideListExInternal @ 0x14012F2B0
 * Callers:
 *     ExInitializeLookasideListEx @ 0x14012F260 (ExInitializeLookasideListEx.c)
 * Callees:
        ...
        int a9)
{
  ...
  __int64 *v16; // rdi
  int v17; // esi
  PVOID (__stdcall *v18)(POOL_TYPE, SIZE_T, ULONG); // rax
