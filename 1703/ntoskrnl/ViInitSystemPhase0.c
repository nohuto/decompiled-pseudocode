/*
 * XREFs of ViInitSystemPhase0 @ 0x140812964
 * Callers:
 ...
 *     VfDisableCodeIntegrityBreaks @ 0x1407668AC (VfDisableCodeIntegrityBreaks.c)
...
void __fastcall ViInitSystemPhase0(__int64 a1)
{
  ...
  qword_1403485D8 = (__int64)&VfSuspectDriversList;
  VfSuspectDriversList = (__int64)&VfSuspectDriversList;
  qword_140348088 = (__int64)&VfExcludedDriversList;
  VfExcludedDriversList = (__int64)&VfExcludedDriversList;
  qword_1403480F8 = (__int64)&VfXdvExcludedDriversList;
...
LABEL_25:
  ...
  qword_140790250 = (__int64)&VfRandomTargetsBitMap;
  ...
  if ( v9 )
  {
    do
    {
      ...
      if ( _bittest((const signed __int32 *)qword_140790250, Number) )
        ++v10;
      else
        _bittestandset((signed __int32 *)qword_140790250, Number);
      v9 = VfRandomVerifiedDrivers;
      ++v11;
    }
