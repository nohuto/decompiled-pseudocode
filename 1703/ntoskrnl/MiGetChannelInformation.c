/*
 * XREFs of MiGetChannelInformation @ 0x14043CB04
 * Callers:
 *     MiManagePartition @ 0x14043C484 (MiManagePartition.c)
 *     MmGetChannelInformation @ 0x140599888 (MmGetChannelInformation.c)
 * Callees:
 *     MiGetNodeChannelPageCounts @ 0x1400205F4 (MiGetNodeChannelPageCounts.c)
