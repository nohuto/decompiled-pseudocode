/*
 * XREFs of EtwpCheckGuidAccessAndDoRundown @ 0x14070FEBC
 * Callers:
...
LABEL_10:
        ...
        LOBYTE(v16) = a4;
        if ( a6 <= 1 )
          EtwpLogKernelTraceRundown(a3, (unsigned int)v17, v16, 0, 0);
        else
          EtwpLogKernelTraceRundown(a3, (unsigned int)v17, v16, (_DWORD)a5 + 16, a6 - 1);
        return v11;
      }
      return 3221225485LL;
    }
