/*
 * XREFs of KiVerifyPdata @ 0x140818E0C
 * Callers:
...
__int64 __fastcall KiVerifyPdata(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( BugCheckParameter2 < *(&xmmword_1403F7020 + 1)
    || BugCheckParameter2 >= *(&xmmword_1403F7020 + 1) + (unsigned int)qword_1403F7030 )
  {
    v2 = (unsigned int *)RtlpxLookupFunctionTable(BugCheckParameter2, &v7);
  }
  else
  {
    v2 = (unsigned int *)xmmword_1403F7020;
    BugCheckParameter3 = qword_1403F7030;
  }
  result = v9;
  if ( v2 )
  {
