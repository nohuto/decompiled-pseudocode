/*
 * XREFs of MiStoreLogWriteIssueRetry @ 0x140220F00
 * Callers:
...
void __fastcall MiStoreLogWriteIssueRetry(__int64 a1, int a2, int a3, __int64 a4, int a5)
{
  ...
  __int64 *v10; // r11
  __int64 v11; // rax
  const GUID *v12; // [rsp+20h] [rbp-91h]
  const GUID *v13; // [rsp+28h] [rbp-89h]
  int v14; // [rsp+40h] [rbp-71h] BYREF
  int v15; // [rsp+44h] [rbp-6Dh] BYREF
  ULONG v16; // [rsp+48h] [rbp-69h] BYREF
  int v17; // [rsp+4Ch] [rbp-65h] BYREF
  __int64 v18; // [rsp+50h] [rbp-61h] BYREF
  __int64 v19; // [rsp+58h] [rbp-59h] BYREF
  ...
  int v25; // [rsp+98h] [rbp-19h]
  int v26; // [rsp+9Ch] [rbp-15h]
  ...
  ULONG *v33; // [rsp+C0h] [rbp+Fh]
  int v34; // [rsp+C8h] [rbp+17h]
  int v35; // [rsp+CCh] [rbp+1Bh]
  int *v36; // [rsp+D0h] [rbp+1Fh]
  int v37; // [rsp+D8h] [rbp+27h]
  int v38; // [rsp+DCh] [rbp+2Bh]
  ...
  if ( qword_14036CFD8 && qword_14036CFD8->LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(qword_14036CFD8, 2uLL) )
    {
      ...
      v34 = 4;
      v37 = 4;
      TlgWriteEx(v9, &unk_1402ACB4F, v7, v8, v12, v13, 8u, &pData);
    }
  }
}
