/*
 * XREFs of KiIpiSendRequest @ 0x140120590
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( a2 )
  {
    ...
    if ( LOWORD(KeActiveProcessors[0]) )
      memmove(v57, qword_1403E42B8, 8LL * LOWORD(KeActiveProcessors[0]));
    if ( v7 == 1 )
    {
...
LABEL_25:
          ...
          _m_prefetchw((const void *)(v33 + 27264));
          ...
          v34[1] = v20;
          v35 = *(_QWORD *)(v33 + 27264);
          do
          {
            v36 = v35;
            *v34 = v35;
            v35 = _InterlockedCompareExchange64((volatile signed __int64 *)(v33 + 27264), (signed __int64)v34, v35);
          }
          while ( v35 != v36 );
          if ( v35 )
          {
    ...
    if ( v23 )
    {
      result = (unsigned int)(_InterlockedExchangeAdd((volatile signed __int32 *)(a1 + 11652), -v23) - v23);
      if ( !(_DWORD)result )
      {
        *(_DWORD *)(a1 + 11648) = 0;
        return result;
