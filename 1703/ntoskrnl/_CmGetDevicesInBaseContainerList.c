/*
 * XREFs of _CmGetDevicesInBaseContainerList @ 0x14073CE10
 * Callers:
  ...
  if ( CachedContextBaseKey >= 0 )
  {
    ...
    if ( CachedContextBaseKey >= 0 )
    {
      ...
      if ( CachedContextBaseKey >= 0 )
      {
        ...
        if ( CachedContextBaseKey >= 0 )
        {
          CachedContextBaseKey = PnpCtxRegQueryInfoKey(v13, Handle, 0LL, v14, &v22, (unsigned int *)&v26);
          if ( CachedContextBaseKey >= 0 )
          {
            v15 = v22 * (v26 + 1) + 1;
...
LABEL_14:
            ...
            {
              LODWORD(v26) = v15 - 1;
              v20 = PnpCtxRegEnumValue(v17, Handle, i, v8, (unsigned int *)&v26, 0LL, 0LL, 0LL);
