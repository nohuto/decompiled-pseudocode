/*
 * XREFs of WdipSemAddEndEventToScenario @ 0x1405D9684
 * Callers:
 *     WdipSemMergeScenarios @ 0x1405D9530 (WdipSemMergeScenarios.c)
 * Callees:
 *     WdipSemFastAllocate @ 0x140467AE4 (WdipSemFastAllocate.c)
 *     WdipSemMergeEvents @ 0x1405D9714 (WdipSemMergeEvents.c)
 */
...
__int64 __fastcall WdipSemAddEndEventToScenario(__int64 a1, __int64 a2)
{
  ...
  if ( a1 && a2 )
  {
    ...
    if ( (_DWORD)v5 )
    {
      ...
      WdipSemMergeEvents(*(_QWORD *)(a1 + 8LL * v6 + 1048), a2, v5, v7);
    }
    else
    {
LABEL_12:
