/*
 * XREFs of PopFxComponentPerfWork @ 0x14022A8D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PopFxComponentPerfWork(volatile signed __int32 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rdi
  unsigned int v6; // esi
  __int64 v7; // rbp
  ...
  IoReleaseRemoveLockEx((PIO_REMOVE_LOCK)(*(_QWORD *)(v4 + 80) + 216LL), 0LL, 0x20u);
}
