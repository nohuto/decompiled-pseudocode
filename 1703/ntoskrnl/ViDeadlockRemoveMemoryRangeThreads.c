/*
 * XREFs of ViDeadlockRemoveMemoryRangeThreads @ 0x140251758
 * Callers:
 ...
 *     VfUtilAddressRangeFit @ 0x140764F88 (VfUtilAddressRangeFit.c)
 *     ViDeadlockDatabaseHashIndex @ 0x14077A698 (ViDeadlockDatabaseHashIndex.c)
