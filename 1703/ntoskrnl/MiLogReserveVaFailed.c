/*
 * XREFs of MiLogReserveVaFailed @ 0x1406B4BC8
 * Callers:
  ...
  if ( qword_14036CFD8 )
  {
    ...
    do
    {
      ...
      LODWORD(v3) = _InterlockedCompareExchange(
                      ...
                      (unsigned int)v3 | 0x400000,
                      (signed __int32)v3);
    }
    while ( v8 != (_DWORD)v3 );
    if ( ((unsigned int)v3 & 0x400000) == 0 )
    {
      ...
      {
        LOBYTE(v3) = TlgKeywordOn(qword_14036CFD8, 0x400000000000uLL);
        if ( (_BYTE)v3 )
        {
          ...
          v42 = 8;
          v45 = 8;
          LOBYTE(v3) = TlgWriteEx(v10, &unk_1402AC5E8, v9, (ULONG)v10, v13, v14, 9u, &pData);
        }
      }
    }
  }
