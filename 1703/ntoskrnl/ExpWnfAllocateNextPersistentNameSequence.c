/*
 * XREFs of ExpWnfAllocateNextPersistentNameSequence @ 0x140722D4C
 * Callers:
...
__int64 __fastcall ExpWnfAllocateNextPersistentNameSequence(__int64 a1, unsigned __int64 *a2)
{
  ...
  if ( NameStoreRegistryRoot < 0 )
    goto LABEL_33;
  v8 = (_BYTE *)KeAbPreAcquire((ULONG_PTR)(v7 + 32), 0LL, 0LL);
  v9 = v8;
...
LABEL_13:
    ...
    if ( v11 > Data )
    {
      ...
      if ( !v2 )
      {
        v12 = (_BYTE *)KeAbPreAcquire((ULONG_PTR)(v7 + 32), 0LL, 0LL);
        v13 = v12;
        if ( _interlockedbittestandset64((volatile signed __int32 *)v7 + 8, 0LL) )
