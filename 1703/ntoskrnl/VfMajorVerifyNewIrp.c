/*
 * XREFs of VfMajorVerifyNewIrp @ 0x140773650
 * Callers:
        ...
        __int64 a5))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  if ( v11 )
    v11(a1);
  result = qword_140791900;
  if ( qword_140791900 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD))qword_140791900(a1, a2, a3, a4, a5);
  return result;
}
