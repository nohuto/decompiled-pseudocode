/*
 * XREFs of PoRegisterSystemState @ 0x14022DBD0
 * Callers:
 *     <none>
 * Callees:
...
PVOID __stdcall PoRegisterSystemState(PVOID StateHandle, EXECUTION_STATE Flags)
{
  ...
  if ( (Flags & 0x7FFFFFF8) == 0 )
  {
    if ( (int)Flags <= 0 )
    {
      ...
      v3 = StateHandle;
      if ( !StateHandle
        && ((v7 = PoCaptureReasonContext(0LL, 0LL, 0LL, 1, 0LL, &v13), v2 = v13, v7 < 0)
         || (v8 = PopCreateKernelPowerRequest(&v12, v13), v3 = v12, v4 = v8, v8 < 0))
