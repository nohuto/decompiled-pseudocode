/*
 * XREFs of FsRtlQueryOpen @ 0x140685364
 * Callers:
...
__int64 __fastcall FsRtlQueryOpen(struct _DEVICE_OBJECT *a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  result = FsFilterCtrlInit((__int64)v15, 249, (__int64)AttachedDevice, v9, 0LL, 1u);
  if ( (int)result >= 0 )
  {
    v19 = a5;
    v16 = a2;
    ...
    v13 = v12;
    if ( v20 )
      FsFilterPerformCompletionCallbacks((__int64)v15, v12);
