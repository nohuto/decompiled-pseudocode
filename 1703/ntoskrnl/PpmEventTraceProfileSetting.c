/*
 * XREFs of PpmEventTraceProfileSetting @ 0x1405CC7D8
 * Callers:
        ...
        char a8)
{
  ...
  int v19; // [rsp+60h] [rbp-51h]
  int v20; // [rsp+64h] [rbp-4Dh]
  BOOL *v21; // [rsp+68h] [rbp-49h]
  int v22; // [rsp+70h] [rbp-41h]
  int v23; // [rsp+74h] [rbp-3Dh]
  char *v24; // [rsp+78h] [rbp-39h]
  int v25; // [rsp+80h] [rbp-31h]
  int v26; // [rsp+84h] [rbp-2Dh]
  ...
  int v35; // [rsp+B4h] [rbp+3h]
  _UNKNOWN *retaddr; // [rsp+F0h] [rbp+3Fh] BYREF
  char v37; // [rsp+F8h] [rbp+47h] BYREF
  char v38; // [rsp+110h] [rbp+5Fh] BYREF
