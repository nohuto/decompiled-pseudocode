/*
 * XREFs of TtmiLogProximityBlockedRequest @ 0x1406DBED4
 * Callers:
...
char __fastcall TtmiLogProximityBlockedRequest(char a1, int a2, int a3)
{
  ...
  if ( stru_1407AC710.LevelPlus1 > 5 )
  {
    ...
    if ( (_BYTE)v3 )
    {
      ...
      v22 = 2;
      v25[0] = 4;
      LOBYTE(v3) = TlgWrite(&stru_1407AC710, &unk_1402ADEF4, 0LL, 0LL, 7u, &pData);
    }
  }
  return (char)v3;
}
