/*
 * XREFs of PipMigrateResetDeviceCallback @ 0x140833620
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall PipMigrateResetDeviceCallback(__int64 *a1, const wchar_t *a2)
{
  ...
  {
    v7 = 4;
    if ( (int)CmGetDeviceRegProp((__int64)a1, (__int64)a2, 0LL, 11, (__int64)&v8, (__int64)&v6, (__int64)&v7, 0) >= 0
      && v8 == 4
      && v7 == 4 )
    {
      v4 = v6;
    ...
    if ( (v4 & 0x20) != 0
      || (v6 = v4 | 0x20, (int)CmSetDeviceRegProp((__int64)a1, (__int64)a2, 0LL, 0xBu, 4u, (__int64)&v6, 4u, 0) >= 0) )
    {
