/*
 * XREFs of RtlSuffixUnicodeString @ 0x1406E5880
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        if ( *Buffer >= 0x61u )
        {
          if ( v13 > 0x7Au )
            v13 += *(_WORD *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * (v13 & 0xF)
                                                                           + 2
                                                                           * (unsigned __int64)*(unsigned __int16 *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * ((unsigned __int8)v13 >> 4) + 2 * *(unsigned __int16 *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * ((unsigned __int64)v13 >> 8)]]];
          else
            v13 -= 32;
        }
        ...
        if ( v14 >= 0x61u )
        {
          if ( v14 > 0x7Au )
            v14 += *(_WORD *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * (v14 & 0xF)
                                                                           + 2
                                                                           * (unsigned __int64)*(unsigned __int16 *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * ((unsigned __int8)v14 >> 4) + 2 * *(unsigned __int16 *)&(*(BOOLEAN **)((char *)&NlsMbCodePageTag + 7))[2 * ((unsigned __int64)v14 >> 8)]]];
          else
            v14 -= 32;
        }
        if ( v13 != v14 )
