/*
 * XREFs of EtwpAddLogHeader @ 0x140557C2C
 * Callers:
...
unsigned __int64 __fastcall EtwpAddLogHeader(__int64 a1, unsigned int *a2)
{
  ...
  {
    if ( ((int (__fastcall *)(__int64, __int64, __int64 *, int *))off_14033C718[0])(25LL, 12LL, &v25, &v22) < 0 )
    {
      v25 = 0LL;
      v26 = 0;
    }
    ...
    *((_WORD *)a2 + 54) = 10;
    ...
    v24 = &v13[*(unsigned __int16 *)(a1 + 136)];
    ...
    *((_WORD *)v12 + 82) = WORD1(v17);
    ...
    memmove(v24 + 2, *(const void **)(a1 + 160), *(unsigned __int16 *)(a1 + 152) + 2LL);
