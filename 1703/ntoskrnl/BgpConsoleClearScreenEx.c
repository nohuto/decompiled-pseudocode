/*
 * XREFs of BgpConsoleClearScreenEx @ 0x140759DC8
 * Callers:
...
__int64 BgpConsoleClearScreenEx()
{
  ...
  v0 = qword_14036F150;
  v1 = *(_DWORD *)(qword_14036F150 + 16);
  *(_DWORD *)(qword_14036F150 + 68) = 0;
  *(_DWORD *)(v0 + 72) = 0;
  v2 = BgpClearScreen(v1);
  if ( v2 >= 0 )
  {
    v3 = (_DWORD *)qword_14036F150;
    v4 = 0LL;
    v5 = *(_DWORD *)(qword_14036F150 + 4);
    v6 = 80LL;
    do
    {
