/*
 * XREFs of MiInitializeWowPeb @ 0x14042AE48
 * Callers:
...
__int64 __fastcall MiInitializeWowPeb(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v8 )
  {
    ...
    if ( v9 == 332 || v9 == 452 )
    {
      ...
      if ( v11 )
      {
        ...
        v13 = v20[12];
        if ( ((unsigned int)v13 & (unsigned __int64)qword_1403E42B8[*(unsigned __int16 *)(a4 + 8)]) != v13 )
          v13 = 0LL;
        *(_QWORD *)a4 = v13;
        v12 = v20;
      }
  ...
  result = MiCreatePebOrTeb(8LL, 0LL, v21);
  if ( (int)result >= 0 )
  {
    v16 = v21[0];
    ...
    *(_DWORD *)(a1 + 56) = 736;
    ...
    if ( v17 && ((v18 = *(_WORD *)(v17 + 8), v18 == 332) || v18 == 452) )
    {
      ...
      *(_QWORD *)(v16 + 112) = qword_14036C190;
      *(_DWORD *)(v16 + 520) = dword_1403E3130;
      *(_DWORD *)(v16 + 144) = *(_DWORD *)(a1 + 72);
      *(_DWORD *)(v16 + 128) = qword_1403E3140;
      *(_DWORD *)(v16 + 132) = qword_1403E3138;
    ...
    else
    {
      ...
      *(_QWORD *)(v16 + 192) = qword_14036C190;
      *(_QWORD *)(v16 + 792) = (unsigned int)dword_1403E3130;
      *(_QWORD *)(v16 + 240) = *(_QWORD *)(a1 + 72);
      *(_QWORD *)(v16 + 216) = qword_1403E3140;
      *(_QWORD *)(v16 + 224) = qword_1403E3138;
