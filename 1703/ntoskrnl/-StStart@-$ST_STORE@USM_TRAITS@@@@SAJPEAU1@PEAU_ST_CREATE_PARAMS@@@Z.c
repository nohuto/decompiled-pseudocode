/*
 * XREFs of ?StStart@?$ST_STORE@USM_TRAITS@@@@SAJPEAU1@PEAU_ST_CREATE_PARAMS@@@Z @ 0x14012D4E0
 * Callers:
...
int __fastcall ST_STORE<SM_TRAITS>::StStart(__int64 a1, __int64 a2)
{
  ...
  ULONG CompressFragmentWorkSpaceSize; // [rsp+98h] [rbp+58h] BYREF
  ...
  if ( !(_BYTE)v6 && (*(_DWORD *)(a2 + 16) || *(_QWORD *)(a2 + 56))
  ...
  *(_QWORD *)(a1 + 56) = PoolWithTag;
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 3996) = CompressBufferWorkSpaceSize;
    if ( v14 )
      v12 = v13;
    *(_DWORD *)(a1 + 3992) = v13;
    ...
    {
      result = StEtaHelper::StartHelper((struct _ST_ETA_CONTEXT *)(a1 + 3928), 0);
      if ( result < 0 )
        return result;
      *(_QWORD *)(a1 + 3920) = a1 + 3928;
    }
    if ( !(unsigned __int8)*(_DWORD *)a2 )
    {
      if ( *(_DWORD *)(a2 + 40) )
    ...
    if ( !*(_DWORD *)(a2 + 40) )
      goto LABEL_36;
    result = SmCrEncStart(a1 + 4032, *(_QWORD *)(a2 + 32));
    if ( result < 0 )
      return result;
    if ( ((*(_DWORD *)(a1 + 4040) + 15) & ~(*(_DWORD *)(a1 + 4040) - 1)) == 0x10 )
    {
LABEL_36:
...
LABEL_45:
              ...
              if ( result >= 0 )
              {
                ...
                result = ST_STORE<SM_TRAITS>::StDmStart(a1, (int)a1 + 2000, (unsigned int)&v31, v24);
                if ( result >= 0 )
                  return 0;
              }
              return result;
