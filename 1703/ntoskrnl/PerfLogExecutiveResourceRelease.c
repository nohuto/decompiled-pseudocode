/*
 * XREFs of PerfLogExecutiveResourceRelease @ 0x140255ECC
 * Callers:
      ...
      if ( *(_DWORD *)(result + 32) )
      {
        ...
        else
        {
                ...
                % EtwpExecutiveResourceReleaseSampleRate)) )
          {
            ...
            v24 = v18;
            result = (signed __int64)EtwTraceKernelEvent((int)&v24, 1, 0x20020000u, 1323, 22026242);
          }
          *(_DWORD *)(v12 + 28) = 0;
        }
      }
