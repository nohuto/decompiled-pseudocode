/*
 * XREFs of ObpCreateDefaultObjectTypeSD @ 0x14059F218
 * Callers:
...
__int64 __fastcall ObpCreateDefaultObjectTypeSD(_QWORD *a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *PoolWithTag = 1;
    ...
    if ( Acl < 0
      || (Acl = RtlpAddKnownAce((ACL *)(PoolWithTag + 20), 2u, 0, 983041, (unsigned __int8 *)SeWorldSid, 0), Acl < 0)
      || (Acl = RtlpAddKnownAce((ACL *)(PoolWithTag + 20), 2u, 0, 983041, (unsigned __int8 *)SeAliasAdminsSid, 0),
          Acl < 0)
      || (Acl = RtlpAddKnownAce((ACL *)(PoolWithTag + 20), 2u, 0, 983041, (unsigned __int8 *)SeLocalSystemSid, 0),
          Acl < 0) )
    {
