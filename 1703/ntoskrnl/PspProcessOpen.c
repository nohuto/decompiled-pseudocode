/*
 * XREFs of PspProcessOpen @ 0x1405461B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PspProcessOpen(__int64 a1, unsigned __int8 a2, __int64 a3, __int64 a4, int *a5)
{
  ...
  v8 = dword_14074AE74[3 * ((unsigned __int64)*(unsigned __int8 *)(a4 + 1738) >> 4)];
  if ( *(_QWORD *)(a4 + 992) == *(_QWORD *)(a3 + 736) )
    v8 &= ~1u;
  v9 = a5;
  v10 = *a5;
  if ( (*a5 & v8) != 0 && (unsigned __int8)PsTestProtectedProcessIncompatibility(a2, a3, a4)
    || *(_QWORD *)(a4 + 1808) && !*(_QWORD *)(a3 + 1808) && a2 && (~DWORD2(xmmword_140348E60) & v10) != 0 )
  {
    return 3221225506LL;
  }
