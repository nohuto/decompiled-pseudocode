/*
 * XREFs of ExpRegisterFirmwareTableInformationHandler @ 0x1405CF2CC
 * Callers:
    ...
    if ( *(_BYTE *)(a1 + 4) )
    {
      ...
      if ( PoolWithTag )
      {
        *(_DWORD *)PoolWithTag = *(_DWORD *)a1;
        ...
        v12 = (_QWORD *)qword_140344AB8;
        if ( *(__int64 **)qword_140344AB8 != &ExpFirmwareTableProviderListHead )
          __fastfail(3u);
        *v11 = &ExpFirmwareTableProviderListHead;
        v11[1] = v12;
        *v12 = v11;
        qword_140344AB8 = (__int64)v11;
      }
      else
      {
        v3 = -1073741670;
