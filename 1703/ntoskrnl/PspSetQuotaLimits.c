/*
 * XREFs of PspSetQuotaLimits @ 0x14044B53C
 * Callers:
...
__int64 __fastcall PspSetQuotaLimits(ULONG_PTR BugCheckParameter1, __int64 a2, int a3, KPROCESSOR_MODE a4)
{
  ...
  $5BC46E0569261879018906DEC3127961 v31; // [rsp+F8h] [rbp-60h] BYREF
...
LABEL_55:
      ...
      v17 = PspAssignProcessQuotaBlock((__int64)v28, (__int64)v18, (__int64)v19);
