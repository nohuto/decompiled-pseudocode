/*
 * XREFs of PopHiberReadChecksums @ 0x140406740
 * Callers:
...
void __fastcall PopHiberReadChecksums(ULONG_PTR BugCheckParameter3)
{
  ...
  if ( v1 )
  {
    ...
    {
      IoLocation = PopGetIoLocation(*(_QWORD *)(BugCheckParameter3 + 160), v7, &v26);
      ...
      *(_WORD *)(v5 + 10) = 1;
      ...
      v18 = (*(__int64 (__fastcall **)(_QWORD, __int64 *, __int64, __int64))(*(_QWORD *)(BugCheckParameter3 + 168)
                                                                           + 160LL))(
              0LL,
              &v23,
              v5,
    ...
    *(_QWORD *)(BugCheckParameter3 + 424) = *(_QWORD *)(v4 + 128);
    v20 = __rdtsc();
    qword_14034B750 += (((unsigned __int64)HIDWORD(v20) << 32) | (unsigned int)v20) - v24;
  }
}
