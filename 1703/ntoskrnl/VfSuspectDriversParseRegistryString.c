/*
 * XREFs of VfSuspectDriversParseRegistryString @ 0x140835AE4
 * Callers:
 ...
 *     VfSuspectDriversInsert @ 0x14077B70C (VfSuspectDriversInsert.c)
...
LABEL_28:
    ...
    else
    {
      ...
      {
        VfDriverLock();
        v11 = (_QWORD *)qword_140348088;
        if ( *(__int64 **)qword_140348088 != &VfExcludedDriversList )
          __fastfail(3u);
        *v10 = &VfExcludedDriversList;
        v10[1] = v11;
        *v11 = v10;
        qword_140348088 = (__int64)v10;
        goto LABEL_28;
      }
    }
    v4 = 0x100002601LL;
