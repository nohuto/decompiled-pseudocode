/*
 * XREFs of SeGetLogonSessionToken @ 0x1406F68D0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall SeGetLogonSessionToken(void *a1, KPROCESSOR_MODE a2, __int64 *a3)
{
  ...
  if ( result >= 0 )
  {
    ...
    if ( v7 )
    {
      ...
      v12 = 0LL;
      v13 = a2 == 0 ? 0x200 : 0;
      inserted = SepDuplicateToken(v7, (int)&v10, 0, 1, 0, 0, 0, (__int64 *)&Object);
      if ( inserted >= 0 )
      {
        inserted = ObInsertObjectEx(Object, 0LL, 983551LL, 0, 0, 0LL, &v9);
        if ( inserted >= 0 )
          *a3 = v9;
      }
    }
