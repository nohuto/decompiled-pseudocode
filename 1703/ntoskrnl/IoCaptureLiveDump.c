/*
 * XREFs of IoCaptureLiveDump @ 0x14068DFA4
 * Callers:
 ...
 *     IopLiveDumpValidateParameters @ 0x14068F568 (IopLiveDumpValidateParameters.c)
...
__int64 __fastcall IoCaptureLiveDump(int a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, _QWORD *a7)
{
  ...
  bool v30; // [rsp+39h] [rbp-CFh] BYREF
  ...
  unsigned __int64 v37; // [rsp+68h] [rbp-A0h] BYREF
  __int64 v38; // [rsp+70h] [rbp-98h]
  unsigned __int64 v39; // [rsp+78h] [rbp-90h] BYREF
  UNICODE_STRING DestinationString; // [rsp+80h] [rbp-88h] BYREF
  GUID pActivityId; // [rsp+90h] [rbp-78h] BYREF
  EVENT_DATA_DESCRIPTOR v42; // [rsp+A8h] [rbp-60h] BYREF
  ...
  unsigned __int64 *v49; // [rsp+F8h] [rbp-10h]
...
LABEL_24:
  ...
  *((_QWORD *)v12 + 75) = v11;
  ...
  if ( stru_14033C990.LevelPlus1 > 5 && TlgKeywordOn(&stru_14033C990, 0x400000000000uLL) )
    TlgWrite(&stru_14033C990, &unk_1402ABBAB, (LPCGUID)v12 + 39, (LPCGUID)v12 + 38, 2u, &pData);
...
LABEL_28:
      ...
      if ( inited >= 0 )
      {
        ...
        else
        {
          ...
          if ( stru_14033C990.LevelPlus1 > 5 && TlgKeywordOn(&stru_14033C990, 0x400000000000uLL) )
          {
            ...
            v54 = &v37;
            TlgWrite(&stru_14033C990, &unk_1402ABB62, (LPCGUID)v12 + 39, (LPCGUID)v12 + 38, 4u, &v51);
          }
  ...
  if ( stru_14033C990.LevelPlus1 > 5 && TlgKeywordOn(&stru_14033C990, 0x400000000000uLL) )
  {
    ...
    TlgWrite(&stru_14033C990, &unk_1402ABAEB, v28, p_pActivityId, 6u, &v42);
  }
  if ( v12 )
  {
    if ( (*((_DWORD *)v12 + 10) & 8) == 0 )
