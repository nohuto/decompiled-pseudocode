/*
 * XREFs of PiDqQueryEnumObject @ 0x1404B9B98
 * Callers:
 *     PiDqEnumQueryObjectsCallback @ 0x1404B9B80 (PiDqEnumQueryObjectsCallback.c)
...
LABEL_12:
          ...
          AddObjectToResultSet >= 0 && v7) )
    {
      if ( (*((_DWORD *)a1->ProcessAuditId + 10) & 1) == 0
        || (AddObjectToResultSet = PiDqQueryAddObjectToResultSet((__int64)a1, a2), AddObjectToResultSet >= 0) )
      {
