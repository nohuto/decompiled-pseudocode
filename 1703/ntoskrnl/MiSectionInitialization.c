/*
 * XREFs of MiSectionInitialization @ 0x140804AC4
 * Callers:
  ...
  *(_OWORD *)((char *)&v12[1] + 4) = MiSectionMapping;
  ...
  if ( (int)ObCreateObjectType(&v4, (__int64)v12, 0LL, (__int64)&MmSectionObjectType) >= 0 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      memset(&qword_14036BE30, 0, 0xF0uLL);
      v1[5] = 0LL;
      dword_14036BED8 |= 0x400u;
      v8 = 0LL;
      v9 = &v5;
      qword_14036BE30 = (__int64)&qword_14036BEA0;
      qword_14036BEA0 = (__int64)v1;
      qword_14036BEB8 = 1LL;
      *v1 = &qword_14036BEA0;
      v7 = 48;
      v10 = 65552;
      ...
      {
        v2 = Object;
        *((_QWORD *)Object + 5) = &qword_14036BEA0;
