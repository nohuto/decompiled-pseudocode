/*
 * XREFs of FsRtlpRegisterUncProvider @ 0x1405CE20C
 * Callers:
 *     FsRtlRegisterUncProviderEx2 @ 0x1405CE1F0 (FsRtlRegisterUncProviderEx2.c)
 *     FsRtlRegisterUncProvider @ 0x140685540 (FsRtlRegisterUncProvider.c)
 *     FsRtlRegisterUncProviderEx @ 0x140685580 (FsRtlRegisterUncProviderEx.c)
 * Callees:
