/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x14024D60C
 * Callers:
 *     SmKmKeyGenStart @ 0x1407028A0 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x14024D6B4 (RtlUnicodeStringValidateSrcWorker.c)
 */
