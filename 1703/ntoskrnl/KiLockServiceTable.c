/*
 * XREFs of KiLockServiceTable @ 0x140145BB8
 * Callers:
 ...
 *     KiFastGetCallersAddress @ 0x1407F65CC (KiFastGetCallersAddress.c)
...
__int64 __fastcall KiLockServiceTable(ULONG_PTR a1, __int64 a2, __int64 a3, int a4)
{
  ...
  if ( !a4 )
  {
    v6 = RtlpImageDirectoryEntryToDataEx(0x140000000uLL, 1, 3u, &v22, &v18);
    v7 = v18;
    if ( v6 < 0 )
      v7 = 0LL;
    v18 = v7;
