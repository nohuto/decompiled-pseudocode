/*
 * XREFs of PiPnpRtlApplyMandatoryDeviceContainerFilters @ 0x14041FD94
 * Callers:
        ...
        _BYTE *a5)
{
  ...
  if ( wcsicmp(a2, L"{00000000-0000-0000-FFFF-FFFFFFFFFFFF}") )
  {
    ...
    if ( Object >= 0 )
    {
      ...
      v13 = a4;
      LOBYTE(v14) = 0;
      v7 = ((__int64 (__fastcall *)(__int64, PVOID, __int64 (__fastcall *)(), __int64 *))PiDmListEnumObjectsWithCallback)(
             3LL,
             P,
