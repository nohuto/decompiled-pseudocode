/*
 * XREFs of PspValidateThread @ 0x14004BE30
 * Callers:
...
__int64 __fastcall PspValidateThread(_KTHREAD *a1)
{
  ...
  if ( KeGetCurrentIrql() >= 2u
    || (POBJECT_TYPE *)ObTypeIndexTable[(unsigned __int8)ObHeaderCookie ^ LOBYTE(a1[-1].OtherTransferCount) ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)((_WORD)a1 - 48) >> 8)] == PsThreadType )
  {
