/*
 * XREFs of sub_140282ED4 @ 0x140282ED4
 * Callers:
...
__int64 __fastcall sub_140282ED4(_DWORD *a1, unsigned int a2, int a3)
{
  _DWORD *v4; // rdi
  __int64 v5; // rbx
  char v6; // r12
  ...
  if ( a3 != 3 )
  {
    ...
    {
      v16 = (*((__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))v4 + 31))(v6 == 0 ? 0x200 : 0, v10 + a2, v113);
    }
    if ( v16 )
    {
      v17 = (_QWORD *)v16;
      ...
      if ( v34 )
      {
        ...
        *(_QWORD *)(v34 + 1480) = v16;
        if ( (v39 & 0x10000000) == 0 )
          *(_DWORD *)(v34 + 1864) = v39 | 0x20000000;
...
LABEL_86:
  ...
  *(_QWORD *)(v108 + 24) = v102;
  ...
  if ( (v73 & 0x1000000) != 0 )
    ...
    v4[466] = v73 | 0x1000000;
  v109 = a2 + v115;
  v74 = (*((__int64 (__fastcall **)(_QWORD, __int64, _QWORD, __int64, int, int))v4 + 104))(0LL, -1LL, 0LL, v109, 1, v72);
  v103 = v74;
  if ( !v74
    || (*v68 = v74, (v75 = (*((__int64 (__fastcall **)(__int64, _QWORD))v4 + 105))(v109, v112)) == 0)
    || (v68[1] = v75,
        v104 = (*((__int64 (__fastcall **)(__int64, _QWORD, __int64, __int64))v4 + 106))(v75, v112, v103, 1LL),
        !(*((unsigned __int8 (__fastcall **)(__int64, _QWORD, __int64))v4 + 70))(
           v104,
           ((_DWORD)v109 + 4095) & 0xFFFFF000,
           64LL)) )
  {
    (*((void (__fastcall **)(__int64 *))v4 + 108))(v68);
    goto LABEL_86;
  }
  v76 = v105;
  v77 = (_QWORD *)v104;
  ...
  if ( v104 + v106 )
  {
    ...
    v100 = *(_DWORD *)(v95 + 1864);
    *(_DWORD *)(v95 + 1508) = v87;
    *(_QWORD *)(v95 + 1480) = v68;
    *(_DWORD *)(v95 + 1772) = 3;
    if ( (v100 & 0x10000000) == 0 )
      *(_DWORD *)(v95 + 1864) = v100 | 0x20000000;
    return v95;
  }
  return 0LL;
}
