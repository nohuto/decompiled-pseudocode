/*
 * XREFs of ?BTreeRedistribute@?$B_TREE@T_SM_PAGE_KEY@@USMKM_FRONTEND_ENTRY@?$SMKM_STORE_MGR@USM_TRAITS@@@@$0BAAA@UB_TREE_DUMMY_NODE_POOL@@U?$B_TREE_KEY_COMPARATOR@T_SM_PAGE_KEY@@@@@@SAPEAUNODE@?$B_TREE_HEADER@T_SM_PAGE_KEY@@USMKM_FRONTEND_ENTRY@?$SMKM_STORE_MGR@USM_TRAITS@@@@@@PEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x14002B548
 * Callers:
        ...
        __int64 a2)
{
  ...
  *v10 = v11;
  ...
  if ( v15 + v14 >= v8 && v16 < 2 * v8 - 1 )
  {
    ...
    if ( v19 == v13 )
    {
      memmove(&v25[v20 * v4], v25, v4 * (unsigned __int16)*v21);
    ...
    *(_WORD *)v19 -= v20;
    if ( v19 == v12 )
      memmove(v26, &v26[v20 * v4], v4 * (unsigned __int16)*v19);
    if ( *((_BYTE *)v12 + 3) )
      *v7 = v12[4];
  }
  return v35;
