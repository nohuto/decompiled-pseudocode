/*
 * XREFs of IopSendMessageToTrackService @ 0x140689EC4
 * Callers:
  ...
  while ( 1 )
  {
    if ( !IopLinkTrackingServiceObject )
    {
      ...
      else
      {
        ...
        KeResetEvent(&stru_140369180);
        ExQueueWorkItem(&IopLinkTrackingPacket, DelayedWorkQueue);
        v9 = KeWaitForSingleObject(&stru_140369180, Executive, PreviousMode, 0, 0LL);
        v10 = v9;
        if ( v9 != 192 && v9 != 257 && dword_140369198 < 0 )
          v10 = dword_140369198;
        KeSetEvent(&IopLinkTrackingPortObject, 0, 0);
        if ( v10 )
          return v10;
    ...
    *v12 = 12058768LL;
    v16 = LpcpRequestWaitReplyPort((int)IopLinkTrackingServiceObject, (int)v12, (__int64)v17, 0, 0, 2);
    v10 = v16;
    if ( v16 >= 0 )
      return v18;
    if ( v16 != -1073741769
