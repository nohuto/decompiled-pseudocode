...
void __fastcall ExpWnfDeleteProcessContext(unsigned __int64 *P, int a2)
{
  ...
  v2 = P + 10;
  v5 = (_BYTE *)KeAbPreAcquire((ULONG_PTR)(P + 10), 0LL, 0LL);
  v6 = v5;
  ...
  while ( 1 )
  {
    ...
    v10 = (_BYTE *)KeAbPreAcquire((ULONG_PTR)v2, 0LL, 0LL);
    v11 = v10;
    if ( _interlockedbittestandset64((volatile signed __int32 *)v2, 0LL) )
  ...
  v13 = (_BYTE *)KeAbPreAcquire((ULONG_PTR)(P + 7), 0LL, 0LL);
  v14 = v13;
  ...
  while ( 1 )
  {
    ...
    v25 = (_BYTE *)KeAbPreAcquire((ULONG_PTR)(P + 7), 0LL, 0LL);
    v26 = v25;
  ...
  if ( a2 )
  {
    v17 = (_BYTE *)KeAbPreAcquire((ULONG_PTR)&ExpWnfProcessesListLock, 0LL, 0LL);
