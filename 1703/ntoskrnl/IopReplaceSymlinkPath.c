/*
 * XREFs of IopReplaceSymlinkPath @ 0x14068CB18
 * Callers:
 ...
 *     FsRtlRemoveDotsFromPath @ 0x140571A20 (FsRtlRemoveDotsFromPath.c)
 */
...
LABEL_9:
  ...
  if ( (*(_WORD *)(a3 + 88) & 0xFFFE) != 0 )
  {
    ...
    {
      v25 = *(_QWORD *)(a3 + 96);
      v26 = *(_WORD *)(v25 + 2LL * v22);
      if ( v26 == 92 )
      {
        --v24;
        if ( v23 == 59 || v24 != 2 )
          goto LABEL_34;
        if ( (unsigned __int16)(v22 + 1) < (unsigned __int16)(*(_WORD *)(a3 + 88) >> 1)
          && *(_WORD *)(v25 + 2LL * v22 + 2) != 59 )
        {
          break;
        }
      }
...
LABEL_37:
  if ( v22 < (unsigned __int16)(*(_WORD *)(a3 + 88) >> 1) )
  {
    v27 = *(_WORD *)(*(_QWORD *)(a3 + 96) + 2LL * v22);
    do
    {
      *v13 = v27;
      ++v22;
    ...
    while ( v27 != 92 && v22 < (unsigned __int16)(*(_WORD *)(a3 + 88) >> 1) );
  }
  v28 = (unsigned int)v7 + v22;
  v18 = 2 * v22 + a6;
  v12 = (WCHAR *)&a1[v28];
LABEL_10:
  if ( v30 )
