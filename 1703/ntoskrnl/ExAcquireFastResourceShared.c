...
char __fastcall ExAcquireFastResourceShared(ULONG_PTR BugCheckParameter2, ULONG_PTR a2, char a3)
{
  ...
  _BYTE v30[40]; // [rsp+48h] [rbp-50h] BYREF
...
LABEL_18:
  ...
  *(_QWORD *)(BugCheckParameter2 + 56) = v27;
  ExpPrepareToWaitForResourceShared(BugCheckParameter2, (__int64)v30);
  *(_BYTE *)(a2 + 19) = 1;
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
  ExpAddFastOwnerEntryToThreadList((__int64)CurrentThread, v28, 0, a2);
  __writecr8(v13);
  ExpWaitForResource((_DWORD *)BugCheckParameter2, (__int64)v30, 0x10244u, 0LL);
  *(_BYTE *)(a2 + 19) = 0;
  if ( v7 )
