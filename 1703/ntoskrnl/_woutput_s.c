/*
 * XREFs of _woutput_s @ 0x1401713E4
 * Callers:
 *     _swoutput_s @ 0x1401712CC (_swoutput_s.c)
 * Callees:
 *     xHalTimerWatchdogStop @ 0x14014A440 (xHalTimerWatchdogStop.c)
 *     __security_check_cookie @ 0x140169210 (__security_check_cookie.c)
 *     _safecrt_mbtowc @ 0x14016A8D0 (_safecrt_mbtowc.c)
 *     write_char_1 @ 0x140171CD0 (write_char_1.c)
 *     write_multi_char_1 @ 0x140171D30 (write_multi_char_1.c)
 *     write_string_2 @ 0x140171D80 (write_string_2.c)
 */

__int64 __fastcall woutput_s(__int64 a1, wchar_t *a2, wchar_t *a3)
{
  int v4; // edx
  int v5; // edi
  int v6; // r15d
  ...
  do
  {
    ...
    v14 = _lookuptable_s[8 * v4 + v12 + v4];
    v4 = 0;
    v12 = v14 >> 4;
    v51 = v12;
    switch ( v12 )
          ...
          if ( v10 != 83 )
          {
            if ( v10 != 88 )
            {
              if ( v10 == 90 )
              {
                ...
                v48 = a3 + 4;
                if ( v18 && (v13 = (wchar_t *)*((_QWORD *)v18 + 1)) != 0LL )
                {
                  if ( v18[1] < *v18 )
                    goto LABEL_180;
                  LODWORD(v11) = *v18;
...
LABEL_115:
                ...
                if ( (v5 & 0xC) == 0 )
                {
                  write_multi_char_1(32LL, v36, v55, &v47);
                  v35 = v45;
                }
                write_string_2(v54, v35, v55, &v47);
                v37 = v55;
                if ( (v5 & 0xC) == 8 )
                  write_multi_char_1(48LL, v36, v55, &v47);
                if ( v49 || (int)v11 <= 0 )
                {
                  write_string_2(v13, (unsigned int)v11, v37, &v47);
                  v4 = 0;
                }
                else
                {
                  ...
                  {
                    --v39;
                    v40 = safecrt_mbtowc(v53, v38, _mb_cur_max);
                    if ( v40 == 2 )
                      --v39;
                    v4 = 0;
                    if ( v40 <= 0 )
                      break;
                    write_char_1(v53[0], v55, &v47);
                    v38 += v41;
                    v4 = 0;
                    if ( v39 <= 0 )
                      goto LABEL_129;
...
LABEL_129:
                ...
                write_multi_char_1(32LL, v36, v37, &v47);
                v7 = v46;
                v8 = v45;
                v6 = v50;
                goto LABEL_134;
...
LABEL_52:
              ...
              if ( (v5 & 0x20) != 0 )
              {
                SrcCh[1] = 0;
                SrcCh[0] = v22;
                v23 = safecrt_mbtowc(DstCh, SrcCh, _mb_cur_max);
                v7 = v46;
                v4 = 0;
                if ( v23 < 0 )
                  v57 = 1;
