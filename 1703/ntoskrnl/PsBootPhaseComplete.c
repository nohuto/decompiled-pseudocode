/*
 * XREFs of PsBootPhaseComplete @ 0x1405A529C
 * Callers:
...
__int64 __fastcall PsBootPhaseComplete(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  _DWORD v26[2]; // [rsp+D8h] [rbp-30h] BYREF
  const wchar_t *v27; // [rsp+E0h] [rbp-28h]
  _DWORD v28[4]; // [rsp+E8h] [rbp-20h] BYREF
  const wchar_t *v29; // [rsp+F8h] [rbp-10h]
  int v30; // [rsp+100h] [rbp-8h]
  int v31; // [rsp+108h] [rbp+0h]
  const wchar_t *v32; // [rsp+110h] [rbp+8h]
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  ServerSiloGlobals[1008] = PspQueryForwardersEnabled();
