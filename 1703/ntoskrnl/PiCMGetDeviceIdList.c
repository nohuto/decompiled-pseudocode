/*
 * XREFs of PiCMGetDeviceIdList @ 0x140558CB8
 * Callers:
 ...
 *     PiCMConvertDeviceListFilters @ 0x140558FF4 (PiCMConvertDeviceListFilters.c)
        ...
        _DWORD *a6)
{
  ...
  *a6 = 0;
  ...
  if ( (Microsoft_Windows_Kernel_PnPEnableBits & 0x2000000) != 0 )
  {
    ...
    Template_zzt((__int64)v21, v10, v13, v26, v21, BYTE2(v25) & 1);
  }
  if ( !a3 || a4 < 0x14 )
  {
