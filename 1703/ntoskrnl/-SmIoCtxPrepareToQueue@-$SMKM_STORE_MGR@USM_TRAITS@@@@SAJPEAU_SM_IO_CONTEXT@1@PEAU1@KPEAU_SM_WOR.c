/*
 * XREFs of ?SmIoCtxPrepareToQueue@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU_SM_IO_CONTEXT@1@PEAU1@KPEAU_SM_WORK_ITEM@1@PEAU_SM_QUEUE_CONTEXT@1@@Z @ 0x140053ADC
 * Callers:
  ...
  *(_QWORD *)&v18 = 0LL;
  ...
  if ( (v5 & 7) == 2 )
  {
    ...
    if ( (v15 & 2) != 0 )
    {
      ...
      v7 = SmFpAllocate((PEX_SPIN_LOCK)(a2 + 1512), v16);
      if ( !v7 )
      {
        v13 = -1073741670;
        goto LABEL_17;
