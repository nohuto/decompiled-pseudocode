/*
 * XREFs of WdipSemUpdateProviderTableWithEvent @ 0x1405AEFE0
 * Callers:
 ...
 *     WdipSemQueryProviderTable @ 0x1405AF084 (WdipSemQueryProviderTable.c)
...
__int64 __fastcall WdipSemUpdateProviderTableWithEvent(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    else if ( (unsigned int)dword_140347D80 >= 0x400 )
    {
    ...
    else
    {
      ...
      if ( v5 )
      {
        memset(v5, 0, 0x50uLL);
        *v6 = *(_OWORD *)a1;
        WdipSemProviderTable[dword_140347D80++] = v6;
        *(_QWORD *)(a1 + 40) = v6;
      }
      else
      {
