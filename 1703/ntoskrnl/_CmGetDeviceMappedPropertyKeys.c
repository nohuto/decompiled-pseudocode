/*
 * XREFs of _CmGetDeviceMappedPropertyKeys @ 0x14073FAD4
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  _DWORD v37[18]; // [rsp+50h] [rbp-48h] BYREF
  _QWORD *v38; // [rsp+A0h] [rbp+8h]
