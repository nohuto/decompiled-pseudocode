/*
 * XREFs of VrpDereferenceDiffHiveEntryWithLock @ 0x14067DAEC
 * Callers:
...
void __fastcall VrpDereferenceDiffHiveEntryWithLock(volatile signed __int64 *P)
{
  ...
  if ( v1 <= 0 )
  {
    if ( v1 )
      __fastfail(0xEu);
    v3 = P[1] & (-1LL << (dword_14036AB04 & 0x1F));
    v2 = (volatile signed __int64 *)(qword_14036AB08
                                   + 8LL
                                   * ((37
                                     * (BYTE6(v3)
                                      + 37
                                     ...
                                     + HIBYTE(v3)) & (((unsigned int)dword_14036AB04 >> 5) - 1)));
