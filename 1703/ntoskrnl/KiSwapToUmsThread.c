/*
 * XREFs of KiSwapToUmsThread @ 0x1406ADA00
 * Callers:
 *     KiUmsTrapEntry @ 0x140192440 (KiUmsTrapEntry.c)
 *     KiUmsCallEntry @ 0x140192640 (KiUmsCallEntry.c)
 *     KiUmsExceptionEntry @ 0x140192800 (KiUmsExceptionEntry.c)
 * Callees:
 *     RtlXSave @ 0x140007620 (RtlXSave.c)
 ...
 *     KeSaveLegacyFloatingPointControlWord @ 0x140181F00 (KeSaveLegacyFloatingPointControlWord.c)
...
NTSTATUS __fastcall KiSwapToUmsThread(_QWORD *a1)
{
  ...
  if ( ThreadForTeb )
  {
    ...
    else
    {
      ...
      if ( SBYTE8(PerfGlobalGroupMask) < 0 )
      {
        v33[0] = CurrentThread[1].CurrentRunTime;
