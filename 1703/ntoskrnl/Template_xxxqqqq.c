/*
 * XREFs of Template_xxxqqqq @ 0x1401E4254
 * Callers:
 *     FsRtlHeatLogTierMove @ 0x140686960 (FsRtlHeatLogTierMove.c)
 * Callees:
 *     EtwWriteEx @ 0x140094690 (EtwWriteEx.c)
 *     __security_check_cookie @ 0x140169210 (__security_check_cookie.c)
 */

NTSTATUS Template_xxxqqqq(__int64 a1, __int64 a2, const GUID *ActivityId, ...)
{
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+40h] [rbp-69h] BYREF
  va_list v5; // [rsp+50h] [rbp-59h]
  __int64 v6; // [rsp+58h] [rbp-51h]
  va_list v7; // [rsp+60h] [rbp-49h]
  __int64 v8; // [rsp+68h] [rbp-41h]
  va_list v9; // [rsp+70h] [rbp-39h]
  __int64 v10; // [rsp+78h] [rbp-31h]
  va_list v11; // [rsp+80h] [rbp-29h]
  __int64 v12; // [rsp+88h] [rbp-21h]
  va_list v13; // [rsp+90h] [rbp-19h]
  __int64 v14; // [rsp+98h] [rbp-11h]
  va_list v15; // [rsp+A0h] [rbp-9h]
  __int64 v16; // [rsp+A8h] [rbp-1h]
  __int64 v17; // [rsp+F8h] [rbp+4Fh] BYREF
  va_list va; // [rsp+F8h] [rbp+4Fh]
  __int64 v19; // [rsp+100h] [rbp+57h] BYREF
  va_list va1; // [rsp+100h] [rbp+57h]
  __int64 v21; // [rsp+108h] [rbp+5Fh] BYREF
  ...
  va_list va5; // [rsp+120h] [rbp+77h]
  va_list va6; // [rsp+128h] [rbp+7Fh] BYREF

  va_start(va6, ActivityId);
  va_start(va5, ActivityId);
