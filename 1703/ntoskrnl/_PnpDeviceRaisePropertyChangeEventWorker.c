/*
 * XREFs of _PnpDeviceRaisePropertyChangeEventWorker @ 0x1404DE940
 * Callers:
        ...
        void (__fastcall *a6)(__int64, __int64, __int64))
{
  ...
  _BYTE Source2[24]; // [rsp+B8h] [rbp-48h] BYREF
...
LABEL_16:
  if ( v11 || v22 )
  {
    ...
    if ( ObjectProperty < 0 )
      goto LABEL_70;
    if ( RtlCompareMemory(&unk_140294818, Source2, 0x10uLL) == 16 )
      goto LABEL_19;
    if ( (int)PnpStringFromGuid(Source2, v50) < 0 )
    {
LABEL_70:
      *(_QWORD *)&v42 = 0LL;
    ...
    if ( v22 )
    {
      ...
      do
      {
        ...
        if ( *(_DWORD *)v34 )
        {
          ...
          v43 = v34[1];
          ((void (__fastcall *)(__int64, _BYTE *, __int64, __int64, __int128 *))a6)(a1, v50, 5LL, 4LL, &v42);
        }
LABEL_52:
        v34 += 3;
        --v35;
