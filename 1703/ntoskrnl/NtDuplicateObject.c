/*
 * XREFs of NtDuplicateObject @ 0x140517390
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG Options)
{
  ...
  *(_QWORD *)v19 = 0LL;
  ...
  result = ObpReferenceObjectByHandleWithTag((ULONG_PTR)SourceProcessHandle, 1967415887, (__int64)Object, 0LL, 0LL);
  if ( result >= 0 )
  {
    if ( TargetProcessHandle )
    {
      v14 = ObpReferenceObjectByHandleWithTag((ULONG_PTR)TargetProcessHandle, 1967415887, (__int64)&v18, 0LL, 0LL);
      if ( v14 < 0 )
        v18 = 0LL;
      else
        v10 = v18;
