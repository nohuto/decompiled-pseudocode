/*
 * XREFs of ?StDmpCurrentRegionWrite@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@@Z @ 0x14024C7E0
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmpCurrentRegionWrite(__int64 a1)
{
  ...
  v1 = (_DWORD *)(a1 + 1232);
  v3 = ST_STORE<SM_TRAITS>::StDmReuseCurrentRegion(a1, (unsigned int *)(a1 + 1232));
  if ( v3 == -1073741697 )
  {
    v4 = (_DWORD *)(a1 + 1088);
    v3 = 0;
