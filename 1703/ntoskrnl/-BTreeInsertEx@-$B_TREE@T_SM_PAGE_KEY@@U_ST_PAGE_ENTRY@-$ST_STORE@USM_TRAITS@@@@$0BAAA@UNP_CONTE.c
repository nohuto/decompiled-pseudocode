/*
 * XREFs of ?BTreeInsertEx@?$B_TREE@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@U?$B_TREE_KEY_COMPARATOR@T_SM_PAGE_KEY@@@@@@SAJPEAU1@PEAUSEARCH_RESULT@1@PEAT_SM_PAGE_KEY@@@Z @ 0x140059430
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  v11 = *v10;
  v12 = (unsigned __int8)-((*v10)[3] != 0) + 255;
  if ( (unsigned __int16)*(_DWORD *)*v10 >= v12 )
  {
    ...
    {
      v18 = (unsigned __int8 *)B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT,B_TREE_KEY_COMPARATOR<_SM_PAGE_KEY>>::BTreeRedistribute(
                                 a1,
                                 a2);
...
LABEL_37:
    ...
    v20 = B_TREE<_SM_PAGE_KEY,ST_STORE<SM_TRAITS>::_ST_PAGE_ENTRY,4096,NP_CONTEXT,B_TREE_KEY_COMPARATOR<_SM_PAGE_KEY>>::BTreeSplitChild(
            a1,
            a2);
    if ( v20 )
    {
...
LABEL_7:
  ...
  if ( v11[3] )
  {
    memmove(v13 + 8, v13, (size_t)&v11[8LL * (unsigned __int16)v14 + 16 - (_QWORD)v13]);
    *(_QWORD *)v13 = *a3;
    ++*((_QWORD *)a1 + 1);
  }
  else
