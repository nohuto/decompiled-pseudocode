/*
 * XREFs of SdbpGetRegistryMatchingAttributes @ 0x14072C8AC
 * Callers:
...
LABEL_34:
  ...
  {
    case 3u:
      v28 = SdbFindFirstTag(a1, v11, 36882);
      v29 = v28;
      if ( !v28 )
      {
      ...
      break;
    case 4u:
      v27 = SdbFindFirstTag(a1, v11, 16466);
      if ( !v27 )
      {
    ...
    case 7u:
LABEL_28:
      v30 = SdbFindFirstTag(a1, v11, 24625);
      if ( !v30 )
      {
...
LABEL_18:
      ...
      break;
    case 0xBu:
      v25 = SdbFindFirstTag(a1, v11, 20507);
      if ( !v25 )
      {
