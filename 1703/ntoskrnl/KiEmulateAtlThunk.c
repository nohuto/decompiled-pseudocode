/*
 * XREFs of KiEmulateAtlThunk @ 0x140207F28
 * Callers:
 *     KiCheckForAtlThunk @ 0x140206850 (KiCheckForAtlThunk.c)
 * Callees:
...
__int64 __fastcall KiEmulateAtlThunk(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  ...
  v23 = (unsigned int)*a2;
  v22 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.$FD99E398B9CE9653B759FFC9FDEDD739::$F77F79717011C0370B4D23A77E221CBE::Self[218].SubSystemTib
      + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
