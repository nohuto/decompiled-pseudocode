/*
 * XREFs of EtwpTraceSystemInitialization @ 0x140811798
 * Callers:
...
char EtwpTraceSystemInitialization()
{
  ...
  __int64 SystemTimePrecise; // [rsp+78h] [rbp-90h] BYREF
  ...
  EVENT_DATA_DESCRIPTOR pData; // [rsp+248h] [rbp+140h] BYREF
  DWORD *p_dwMajorVersion; // [rsp+268h] [rbp+160h]
  __int64 v38; // [rsp+270h] [rbp+168h]
  DWORD *p_dwMinorVersion; // [rsp+278h] [rbp+170h]
  __int64 v40; // [rsp+280h] [rbp+178h]
  DWORD *p_dwBuildNumber; // [rsp+288h] [rbp+180h]
  __int64 v42; // [rsp+290h] [rbp+188h]
  int *v43; // [rsp+298h] [rbp+190h]
  __int64 v44; // [rsp+2A0h] [rbp+198h]
  __int64 *v45; // [rsp+2A8h] [rbp+1A0h]
  __int64 v46; // [rsp+2B0h] [rbp+1A8h]
  int *v47; // [rsp+2B8h] [rbp+1B0h]
  __int64 v48; // [rsp+2C0h] [rbp+1B8h]
  char *v49; // [rsp+2C8h] [rbp+1C0h]
  __int64 v50; // [rsp+2D0h] [rbp+1C8h]
  _QWORD *v51; // [rsp+2D8h] [rbp+1D0h]
  __int64 v52; // [rsp+2E0h] [rbp+1D8h]
  int *v53; // [rsp+2E8h] [rbp+1E0h]
  __int64 v54; // [rsp+2F0h] [rbp+1E8h]
  EVENT_DATA_DESCRIPTOR v55; // [rsp+308h] [rbp+200h] BYREF
  int *v56; // [rsp+328h] [rbp+220h]
  __int64 v57; // [rsp+330h] [rbp+228h]
  int *v58; // [rsp+338h] [rbp+230h]
  __int64 v59; // [rsp+340h] [rbp+238h]
  ...
  {
    v17 = KeBootTime;
    if ( stru_14033C690.LevelPlus1 > 5 && TlgKeywordOn(&stru_14033C690, 0x200000000000uLL) )
    {
      ...
      v52 = 8LL;
      v54 = 4LL;
      TlgWrite(&stru_14033C690, &unk_1402AF0C9, 0LL, 0LL, 0xBu, &pData);
    }
    ...
    if ( (_BYTE)Version )
    {
      ...
      {
        LOBYTE(Version) = TlgKeywordOn(&stru_14033C690, 0x400000000000uLL);
        if ( (_BYTE)Version )
        {
          LOBYTE(v9) = v6;
          v10 = (v20[0] >> 10) & 0xF;
          ...
          v57 = 4LL;
          v59 = 1LL;
          LOBYTE(Version) = TlgWrite(&stru_14033C690, &unk_1402AF094, 0LL, 0LL, 4u, &v55);
        }
      }
    }
