/*
 * XREFs of IoRemoveIoCompletion @ 0x1400E9520
 * Callers:
        ...
        BOOLEAN a8)
{
  ...
  char v27[8]; // [rsp+70h] [rbp-A8h] BYREF
  ...
  $5BC46E0569261879018906DEC3127961 v34; // [rsp+A8h] [rbp-70h] BYREF
  ...
  for ( i = 0LL; ; i = (unsigned int)(i + 1) )
  {
    ...
    if ( Flink )
    {
      if ( Flink == 2 )
      {
        ...
        *((_QWORD *)&v22 + 1) = v12[4].Flink;
        ...
        {
          KxWaitForSpinLockAndAcquire((volatile signed __int32 *)&v12[6]);
        }
    ...
    else
    {
      ...
      if ( (v19 & 0x2000) != 0 )
      {
        ...
        {
          IopCompleteRequest((__int64)(p_Blink + 15), (__int64)v27, &v23, (__int64 *)p_Blink + 24, &v23);
          v9 = a2;
        }
        else
        {
          ...
          {
            KiStackAttachProcess((_KPROCESS *)v20, 0, (__int64)&v34);
            IopCompleteRequest((__int64)(p_Blink + 15), (__int64)v27, &v23, (__int64 *)p_Blink + 24, &v23);
