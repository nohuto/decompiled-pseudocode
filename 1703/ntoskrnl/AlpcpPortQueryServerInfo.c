/*
 * XREFs of AlpcpPortQueryServerInfo @ 0x1406B2164
 * Callers:
        ...
        KPROCESSOR_MODE AccessMode)
{
  ...
  if ( result >= 0 )
  {
    ...
    v20 = 0;
    v24 = 0LL;
    PortNameInformation = AlpcpReferenceMessageByWaitingThread((__int64)Object, (__int64 *)&v21);
