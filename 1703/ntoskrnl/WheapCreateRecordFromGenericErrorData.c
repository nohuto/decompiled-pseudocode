/*
 * XREFs of WheapCreateRecordFromGenericErrorData @ 0x1402600C8
 * Callers:
 *     WheapDefaultErrSrcCreateRecord @ 0x1402602C0 (WheapDefaultErrSrcCreateRecord.c)
 * Callees:
...
LABEL_2:
  ...
  *(_DWORD *)(a3 + 104) ^= (*(_DWORD *)(a3 + 104) ^ (2 * *(_DWORD *)(a2 + 12))) & 2;
  v17 = (*(_DWORD *)(a3 + 104) ^ (*(_DWORD *)(a2 + 12) >> 1)) & 4;
  *(_DWORD *)(a3 + 20) = a4;
  *(_DWORD *)(a3 + 104) ^= v17;
  v18 = (*v5 >> 4) & 0x3FF;
  if ( v18 )
  {
    while ( v8 + 64 >= v8 && v8 + 64 <= v12 )
    {
      ...
      if ( v20 + v8 > v12 )
        break;
      v11 = WheapAddSectionFromGenericErrorData(a1, a3, a4, v19, v20, 1);
      if ( v11 < 0 )
        goto LABEL_28;
      v8 = v24;
      if ( !--v18 )
...
LABEL_25:
  ...
  if ( (v26 = v5[2]) == 0 )
    return 0;
  v11 = WheapAddSectionFromGenericErrorData(a1, a3, a4, (__int64)v5 + v25, v26, 0);
  if ( v11 >= 0 )
    return 0;
LABEL_28:
