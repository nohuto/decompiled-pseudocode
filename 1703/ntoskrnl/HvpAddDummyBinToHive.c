/*
 * XREFs of HvpAddDummyBinToHive @ 0x140678468
 * Callers:
...
__int64 __fastcall HvpAddDummyBinToHive(ULONG_PTR BugCheckParameter2, _OWORD *a2, int a3, _QWORD *a4)
{
  ...
  else
  {
    ...
    HvpPointMapEntriesToBuffer(BugCheckParameter2, (__int64)v18, (__int64)v17, 0x1000u, a3, 0LL);
    v14 = 0LL;
    *a4 = v9;
    v15 = 0LL;
    Bin = 0;
  ...
  if ( v14 || v15 )
    HvpFreeBin(BugCheckParameter2, 0x1000u, 0, v14, (__int64)v15);
