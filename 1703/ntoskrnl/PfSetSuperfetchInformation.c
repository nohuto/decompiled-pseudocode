/*
 * XREFs of PfSetSuperfetchInformation @ 0x1405630D4
 * Callers:
...
__int64 __fastcall PfSetSuperfetchInformation(__int64 a1, _OWORD *a2, int a3, KPROCESSOR_MODE a4)
{
  ...
  if ( DWORD2(v23[0]) == 14 )
  {
    v8 = PfpRpControlRequest((__int64)v23, a4);
    goto LABEL_11;
  }
  if ( SDWORD2(v23[0]) > 14 )
  {
...
LABEL_11:
    ...
    if ( (_DWORD)v25 == 2 && HIDWORD(v25) < 2 && (v18 & 0xFFFFFFFC) == 0 )
    {
      ...
      PfpScenCtxServiceThreadSet((ULONG_PTR)&qword_14036DE60, HIDWORD(v25) == 0);
      goto LABEL_12;
    }
LABEL_87:
    v9 = -1073741811;
...
LABEL_54:
    ...
    case 4:
      ...
      goto LABEL_12;
    case 5:
      v8 = PfpPrefetchRequest((__int64)v23, a4);
      goto LABEL_11;
    case 7:
      goto LABEL_10;
    case 0xA:
