/*
 * XREFs of ExReleaseFastResourceExclusive @ 0x14025BB40
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ExReleaseFastResourceExclusive(ULONG_PTR BugCheckParameter2, ULONG_PTR a2)
{
