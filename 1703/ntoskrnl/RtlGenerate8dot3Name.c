/*
 * XREFs of RtlGenerate8dot3Name @ 0x140437580
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlComputeLfnChecksum @ 0x140437A38 (RtlComputeLfnChecksum.c)
 */
...
LABEL_11:
  ...
  do
  {
    if ( !LastIndexValue )
      break;
    v17 = LastIndexValue / 0xA;
    v18 = 8 - v15;
    v19 = LastIndexValue % 0xA + 48;
    if ( (_WORD)v19 != 57 )
      v16 = 0;
    ++v15;
    *((_WORD *)v55 + v18) = v19;
  ...
  *((_WORD *)v55 + 8 - v15) = 126;
  ...
  {
    memmove(v4->Buffer, v6->NameBuffer, 2LL * v20);
    v4->Length = 2 * v6->NameLength;
  }
  memmove(&v4->Buffer[(unsigned __int64)v4->Length >> 1], (char *)v55 + 2 * (8 - v15), 2 * v15);
  v4->Length += 2 * v15;
