/*
 * XREFs of _CmSetDeviceMappedPropertyFromDriverKeyRegValue @ 0x1405926B4
 * Callers:
...
LABEL_10:
  ...
  if ( v16 >= 0 )
  {
    v17 = RegRtlSetValue(Handle, (const WCHAR *)v13[2], *((_DWORD *)v13 + 6), Time, a6);
    if ( v17 == -1073741444 )
    {
      v16 = -1073741772;
    }
    ...
    else if ( *(_DWORD *)(a3 + 16) == 2 )
    {
      ...
      if ( !v19 )
      {
        ...
        {
          RegRtlSetValue(Handle, L"DriverDate", 1u, pszDest, 2 * (*(_DWORD *)&TimeFields.Year + 1));
        }
      }
    }
  }
