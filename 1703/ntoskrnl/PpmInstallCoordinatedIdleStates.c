/*
 * XREFs of PpmInstallCoordinatedIdleStates @ 0x1406C5A80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PpmCheckCoordinatedStateInitiator @ 0x140227930 (PpmCheckCoordinatedStateInitiator.c)
 ...
 *     PpmIdleUpdateCoordinatedDependencies @ 0x1406D62B4 (PpmIdleUpdateCoordinatedDependencies.c)
 */
...
__int64 __fastcall PpmInstallCoordinatedIdleStates(unsigned int *a1)
{
  ...
  if ( !PpmPlatformStates )
  {
    ...
    v65 = (v10 + 7 + 24 * v5) & 0xFFFFFFF8;
    v11 = v65 + 24 * v6;
    v66 = (v11 + 3) & 0xFFFFFFFC;
    v12 = (v11 + 4 * v3 * KeNumberProcessors_0 + 7) & 0xFFFFFFF8;
    v67 = (4 * v3 + 15) & 0xFFFFFFF8;
    v62 = (v12 + 1008 * v3 + 31) & 0xFFFFFFF8;
    v13 = (KeNumberProcessors_0 * v67 + 7 + v62) & 0xFFFFFFF8;
    v14 = v13;
    if ( PpmIdleVetoList )
      v13 += ((_DWORD)v3 * *(_DWORD *)PpmIdleVetoList) << 6;
    v15 = v13;
    PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNxCacheAligned, v13, 0x694D5050u);
    ...
    *(_QWORD *)(v17 + 48) = v18;
    ...
    if ( *v1 )
    {
      ...
      {
        v22 = 384 * v19;
        v23 = (_QWORD *)(384 * v19 + v17 + 88);
        v23[1] = v23;
        *v23 = v23;
        *(_BYTE *)(384 * v19 + v17 + 104) = 7;
        if ( v21 )
        {
          if ( (_DWORD)v19 == *v1 - 1 )
            *(_BYTE *)(v22 + v17 + 105) = 1;
          *(_DWORD *)(v22 + v17 + 108) = *v21;
          *(_QWORD *)(v22 + v17 + 112) = v20;
          v20 += (unsigned __int64)(unsigned int)*v21 << 6;
          *(_QWORD *)&v18[252 * (unsigned int)v19 + 48] = v17 + v22 + 80;
        }
    ...
    do
    {
      *(_OWORD *)(v28 + 168) = *(_OWORD *)(v26 - 18);
      *(_QWORD *)(v28 - 64) = *(_QWORD *)(v26 - 10);
      KeCopyAffinityEx(v28, v26 - 102);
      v29 = 0LL;
    ...
    if ( v4 )
    {
      do
      {
        ...
        *(_DWORD *)(v36 + 776) = v3;
        *(_DWORD *)(v36 + 792) = v3;
        *(_QWORD *)(v36 + 752) = v17 + v62 + v32 * v67;
        v37 = (_QWORD *)(v17 + 312);
        do
        {
          v38 = *(_QWORD *)(v36 + 784);
...
LABEL_31:
  ...
  do
  {
    ...
    *(_DWORD *)(v41 - 4) = *(v42 - 1);
    *(_DWORD *)v41 = *v42;
    for ( *(_BYTE *)(v41 + 45) = *((_BYTE *)v42 + 12); (unsigned int)v44 < v42[2]; v44 = (unsigned int)(v44 + 1) )
    {
      v45 = *(_QWORD *)(v41 + 236);
      v46 = 3 * v44;
      v47 = 0LL;
      ...
      if ( v49 )
      {
        do
        {
          ...
          *(_BYTE *)(v51 + 8 * v52 + 2) = *(_BYTE *)(v50 + 4 * v47 + 3);
          ...
          {
            v54 = 384LL * v53;
            *(_DWORD *)(v51 + 8 * v52 + 8) = *(_DWORD *)(v54 + v17 + 124);
            *(_QWORD *)(v51 + 8 * v52 + 16) = *(_QWORD *)(v54 + v17 + 312);
          }
          else
          {
  ...
  {
    v56 = 0;
    v57 = *(_QWORD *)(KeGetPrcb(i) + 23936);
    do
    {
      v58 = PpmCheckCoordinatedStateInitiator(
              i,
              *(_DWORD *)(*(_QWORD *)(v57 + 784) + 24LL * ((unsigned int)v3 - v56 - 1) + 8),
              *(_QWORD *)(*(_QWORD *)(v57 + 784) + 24LL * ((unsigned int)v3 - v56 - 1) + 16));
      ++v56;
