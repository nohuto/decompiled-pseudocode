/*
 * XREFs of AslPathToNetworkPathNt @ 0x1405BC658
 * Callers:
...
__int64 __fastcall AslPathToNetworkPathNt(wchar_t **a1, _WORD *a2)
{
  ...
  *a1 = 0LL;
    ...
    && ((v10 = a2 + 2, v11 = a2[2], v11 != 46) && v11 != 63 || (v12 = a2[3], v12 != 92) && v12 != 47 && v12) )
  {
    ...
    while ( a2[v3] );
    v13 = v3 + 9;
    v14 = (wchar_t *)AslAlloc((__int64)a1, 2 * v13);
    v5 = v14;
    if ( v14 )
    {
    ...
    {
      v6 = -1073741801;
      AslLogCallPrintf(1, (unsigned int)"AslPathToNetworkPathNt", 251, (unsigned int)"Out of memory");
    }
  }
  else
  {
