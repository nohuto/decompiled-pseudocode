/*
 * XREFs of RtlIoDecodeMemIoResource @ 0x140156B10
 * Callers:
 *     IopGenericScoreRequirement @ 0x1405B3300 (IopGenericScoreRequirement.c)
 *     PnpFilterResourceRequirementsList @ 0x1405B3B10 (PnpFilterResourceRequirementsList.c)
 *     IopGenericUnpackRequirement @ 0x1405B5290 (IopGenericUnpackRequirement.c)
 * Callees:
 *     <none>
 */
