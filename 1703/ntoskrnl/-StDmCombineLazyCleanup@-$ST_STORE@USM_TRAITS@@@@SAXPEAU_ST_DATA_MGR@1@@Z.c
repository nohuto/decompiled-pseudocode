/*
 * XREFs of ?StDmCombineLazyCleanup@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@@Z @ 0x14024AE1C
 * Callers:
...
LABEL_18:
      ...
      {
LABEL_23:
        *(_DWORD *)(a1 + 1048) = *(_DWORD *)v10;
        goto LABEL_25;
      }
    }
  }
  v3 = 1024;
  *(_BYTE *)(a1 + 1889) = *(_BYTE *)(a1 + 1889) & 0xFC | 1;
LABEL_25:
  if ( *(_DWORD *)(a1 + 1880) <= v3 )
    *(_BYTE *)(a1 + 1889) &= 0xFCu;
  else
    ST_STORE<SM_TRAITS>::StLazyWorkMgrQueueWork(*(_QWORD *)(a1 + 1896), 5LL, 0x7530u, 0xFFFFFFFE);
