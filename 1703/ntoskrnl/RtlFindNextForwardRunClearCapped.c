/*
 * XREFs of RtlFindNextForwardRunClearCapped @ 0x1400AC7C0
 * Callers:
 ...
 *     RtlFindFirstRunClear @ 0x14023CCF0 (RtlFindFirstRunClear.c)
...
__int64 __fastcall RtlFindNextForwardRunClearCapped(__int64 a1, unsigned int a2, unsigned int a3, unsigned int *a4)
{
  ...
  if ( v10 != v11 && (*v10 | dword_14029CF70[a2 & 0x1F]) == -1 )
  {
    ++v10;
  ...
  v12 = 0;
  if ( v10 == v11 || (~dword_14029CF70[i & 0x1F] & *v10) != 0 )
    goto LABEL_14;
  v12 = 32 - (i & 0x1F);
  if ( v12 < a3 )
  {
