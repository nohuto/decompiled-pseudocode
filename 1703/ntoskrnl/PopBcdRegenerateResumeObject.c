/*
 * XREFs of PopBcdRegenerateResumeObject @ 0x1406D5770
 * Callers:
...
__int64 __fastcall PopBcdRegenerateResumeObject(__int64 a1, void *a2, _QWORD *a3)
{
  ...
  Object = BcdCreateObject(a1, 0LL, &v17, &Handle);
  if ( Object < 0 )
  {
    v7 = Handle;
  }
  else
  {
    ...
    else
    {
      ...
      v7 = Handle;
      v9 = BcdSetElementDataWithFlags(Handle, 0x12000004u, v8, *(__int64 *)&v15[1], v14);
      v3 = v18;
      Object = v9;
      if ( v9 >= 0 )
      {
