/*
 * XREFs of PfpPrefetchFilesTrickle @ 0x14053CED0
 * Callers:
...
LABEL_9:
      ...
      if ( (int)PfpFileBuildReadSupport((_DWORD)a1, (_DWORD)v8, v4, v11, (__int64)v27) >= 0 )
      {
        ...
        *(_QWORD *)v27[0] = v27[2];
        ...
        v21 = v15;
        v29 = 0;
        MmQueryMemoryListInformation((ULONG_PTR **)0xFFFFFFFFFFFFFFFFLL, (_OWORD *)a1 + 3, 0xB0u, v12, &v24);
        if ( v15 )
        {
               ...
               && (unsigned __int64)(a1[6] + a1[7] + PfpGetPageListCount(a1 + 11, 0LL, v31)) >= 0x80 )
          {
            ...
            *(_QWORD *)(v13 + 16) |= (8 * (v31 & 7)) | (unsigned __int64)(*(_DWORD *)(*a1 + 28LL) & 7);
            v16 = MmPrefetchPagesEx(1LL, &v25, 0LL);
