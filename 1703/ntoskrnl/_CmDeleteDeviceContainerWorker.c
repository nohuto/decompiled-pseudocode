/*
 * XREFs of _CmDeleteDeviceContainerWorker @ 0x14073C678
 * Callers:
 *     _CmDeleteDeviceContainer @ 0x14073C1F8 (_CmDeleteDeviceContainer.c)
 * Callees:
 *     ExAllocatePoolWithTag @ 0x140285010 (ExAllocatePoolWithTag.c)
 *     ExFreePoolWithTag @ 0x140286010 (ExFreePoolWithTag.c)
 *     _CmSetDeviceContainerMappedProperty @ 0x140596CA0 (_CmSetDeviceContainerMappedProperty.c)
 *     _CmDeleteDeviceContainerRegKey @ 0x14073C328 (_CmDeleteDeviceContainerRegKey.c)
 *     _CmGetDeviceContainerMappedPropertyKeys @ 0x14073CCEC (_CmGetDeviceContainerMappedPropertyKeys.c)
