/*
 * XREFs of ?StGetStatsWorker@?$ST_STORE@USM_TRAITS@@@@SAJPEAU1@W4_ST_STATS_LEVEL@@PEAU_ST_STATS@@PEAK@Z @ 0x140034B74
 * Callers:
 ...
 *     StLcBucketsCopy @ 0x14024D434 (StLcBucketsCopy.c)
 */
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StGetStatsWorker(__int64 a1, int a2, __int64 a3, unsigned int *a4)
{
  ...
  else
  {
    ...
    *(_DWORD *)a3 ^= (*(_DWORD *)a3 ^ (a2 << 8)) & 0xF00;
    v9 = *(_DWORD *)a3 ^ (*(_DWORD *)a3 ^ (*(_DWORD *)a1 << 12)) & 0xF000;
    *(_DWORD *)a3 = v9;
    v10 = v9 ^ (v9 ^ (*(_DWORD *)a1 << 8)) & 0x10000;
    *(_DWORD *)a3 = v10;
    v11 = v10 ^ (v10 ^ (*(_DWORD *)a1 << 7)) & 0x20000;
    *(_DWORD *)a3 = v11;
    v12 = v11 ^ (v11 ^ (*(_DWORD *)(a1 + 4056) << 21)) & 0x3FFC0000;
    *(_DWORD *)a3 = v12;
    v13 = v12 ^ (*(_DWORD *)(a1 + 856) << 12);
    *(_DWORD *)(a3 + 4) = v8;
    *(_DWORD *)a3 = v12 ^ v13 & 0x40000000;
    *(_WORD *)(a3 + 8) = *(_WORD *)(a1 + 4000);
    *(_DWORD *)(a3 + 12) = *(_DWORD *)(a1 + 8);
    *(_DWORD *)(a3 + 16) = *(_DWORD *)(a1 + 936) + *(_DWORD *)(a1 + 2856);
    ...
    *(_DWORD *)(a3 + 40) = *(_DWORD *)(a1 + 920) - RtlNumberOfSetBits((PRTL_BITMAP)(a1 + 920));
    ...
    {
      ++v15;
      *v14 = *(_DWORD *)((char *)v14 + v17 + 1792);
      v14[1] = *(_DWORD *)((char *)v14 + v17 + 1796);
      v14 += 2;
    }
    while ( v15 < v16 );
    memset((void *)(a3 + 108), 0, 0x50uLL);
    *(_DWORD *)(a3 + 108) = *(_DWORD *)(a1 + 2856);
    *(_DWORD *)(a3 + 112) = *(_DWORD *)(a1 + 2008);
    *(_DWORD *)(a3 + 120) = *(_DWORD *)(a1 + 2840) - RtlNumberOfSetBits((PRTL_BITMAP)(a1 + 2840));
    v18 = (_DWORD *)(a3 + 124);
    v19 = 0;
    v20 = (unsigned __int8)*(_DWORD *)(a1 + 2776) != 0 ? 1 : 8;
    v21 = a1 + 2000 - (a3 + 108);
    do
    {
      ++v19;
      *v18 = *(_DWORD *)((char *)v18 + v21 + 1792);
      v18[1] = *(_DWORD *)((char *)v18 + v21 + 1796);
      v18 += 2;
    }
    while ( v19 < v20 );
    if ( !a2 )
      goto LABEL_10;
    ST_STORE<SM_TRAITS>::StCopyIoStats(a3 + 188, a1 + 4248);
    StLcBucketsCopy(a3 + 1472, v25, *(_QWORD *)(a1 + 5568), *(unsigned int *)(a1 + 5560));
    if ( a2 == 1 )
      goto LABEL_10;
    v26 = *(_WORD **)(a1 + 56);
    ...
    *(_DWORD *)(v30 + 8) = v31;
    ...
    {
      *(_QWORD *)v30 = v33;
      result = ST_STORE<SM_TRAITS>::StDmGetStatsBitmap(a1 + 2000, v32, v30 + 12, &v33);
      if ( (int)result >= 0 )
      {
LABEL_10:
        *v34 = v8;
