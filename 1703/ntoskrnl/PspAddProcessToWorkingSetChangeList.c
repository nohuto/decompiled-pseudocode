/*
 * XREFs of PspAddProcessToWorkingSetChangeList @ 0x1406E1118
 * Callers:
      ...
      if ( (_BYTE)PoolWithTag )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          *(_QWORD *)(PoolWithTag + 24) = *(_QWORD *)(v3 + 792);
          v4 = (__int64 *)qword_140341788;
          if ( *(__int64 **)qword_140341788 != &PspWorkingSetChangeHead )
            __fastfail(3u);
          *(_QWORD *)PoolWithTag = &PspWorkingSetChangeHead;
          *(_QWORD *)(PoolWithTag + 8) = v4;
          *v4 = PoolWithTag;
          qword_140341788 = PoolWithTag;
        }
        else
        {
