/*
 * XREFs of PipProcessStartPhase3 @ 0x1404A7014
 * Callers:
 ...
 *     PnpSetDeviceInstanceStartedEvent @ 0x140067990 (PnpSetDeviceInstanceStartedEvent.c)
  ...
  if ( DeviceState >= 0 )
  {
      ...
      && (int)PnpDeviceObjectToDeviceInstance(*(_QWORD *)(a1 + 32), &Handle, 131097LL) >= 0 )
    {
      ...
      if ( v11 || v10 )
      {
        ...
        {
          v19 = 0;
          if ( !P || (LOBYTE(v22) = 1, v19 = PnpCheckDeviceIdsChanged(a1, Handle, P, v27, v22, &v34), !v34) )
          {
            if ( v18 )
            {
              LOBYTE(v22) = 0;
      ...
      KiLeaveCriticalRegionUnsafe((__int64)KeGetCurrentThread());
      ZwClose(Handle);
      PnpRaiseNtPlugPlayDevicePropertyChangeEvent(v21, *(_QWORD *)(a1 + 48), 1LL);
