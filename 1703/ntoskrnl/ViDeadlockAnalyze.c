/*
 * XREFs of ViDeadlockAnalyze @ 0x14077A004
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x140779C74 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x14077A004 (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x14077A31C (ViDeadlockCertify.c)
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)v13 + 4107) = a1;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(0xC4u, 4097, a1, a2, 0LL, byte_140341444);
      return 0LL;
    }
    v6 = 0;
LABEL_33:
