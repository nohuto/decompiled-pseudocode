/*
 * XREFs of EtwpFindUserBufferSpace @ 0x14055067C
 * Callers:
 *     EtwpRealtimeInjectEtwBuffer @ 0x140550490 (EtwpRealtimeInjectEtwBuffer.c)
 * Callees:
 *     RtlFindNextAlignedForwardRunClear @ 0x1401221F4 (RtlFindNextAlignedForwardRunClear.c)
 *     RtlInterlockedSetClearRun @ 0x140122300 (RtlInterlockedSetClearRun.c)
