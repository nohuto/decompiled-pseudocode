/*
 * XREFs of PspSetupReservedUserMappings @ 0x14044ED4C
 * Callers:
...
__int64 __fastcall PspSetupReservedUserMappings(_KPROCESS *a1, $5BC46E0569261879018906DEC3127961 *a2, _QWORD *a3)
{
  int v5; // ebx
