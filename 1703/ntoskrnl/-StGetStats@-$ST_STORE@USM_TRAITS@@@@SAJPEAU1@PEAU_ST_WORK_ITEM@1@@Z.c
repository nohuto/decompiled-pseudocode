/*
 * XREFs of ?StGetStats@?$ST_STORE@USM_TRAITS@@@@SAJPEAU1@PEAU_ST_WORK_ITEM@1@@Z @ 0x14024C8C8
 * Callers:
 ...
 *     ?StDmEtwRegionRundown@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@@Z @ 0x14024B964 (-StDmEtwRegionRundown@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@@Z.c)
 */
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StGetStats(__int64 a1, __int64 a2)
{
  ...
  ST_STORE<SM_TRAITS>::StDmEtwRegionRundown(a1 + 2000);
  result = ST_STORE<SM_TRAITS>::StDmEtwPageRundown((char **)(a1 + 80));
  if ( (int)result >= 0 )
    return ST_STORE<SM_TRAITS>::StDmEtwPageRundown((char **)(a1 + 2000));
  return result;
}
