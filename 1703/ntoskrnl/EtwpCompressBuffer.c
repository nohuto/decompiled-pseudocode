/*
 * XREFs of EtwpCompressBuffer @ 0x140257484
 * Callers:
 ...
 *     EtwpGetNextEventOffsetType @ 0x140257E90 (EtwpGetNextEventOffsetType.c)
...
__int64 __fastcall EtwpCompressBuffer(__int64 a1, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( *(_DWORD *)(v8 + 8) == 72 || v5 < CompressedBufferSize * *(_DWORD *)(a1 + 1020) )
    {
      v7 = RtlCompressBuffer(
             3u,
             (PUCHAR)(a2 + v6),
             v5,
             (PUCHAR)(*(unsigned int *)(*(_QWORD *)(a1 + 1000) + 8LL) + 72LL + v8),
      ...
      if ( v7 >= 0 )
      {
        ...
        *(_DWORD *)(v8 + v9 + 12) = 0;
        *(_DWORD *)(v8 + v9 + 44) = 3;
        *(_DWORD *)(*(_QWORD *)(a1 + 1000) + 8LL) += 72;
        *(_DWORD *)(*(_QWORD *)(a1 + 1000) + 8LL) += FinalCompressedSize;
...
LABEL_27:
  ...
  while ( 1 )
  {
    ...
    if ( *(_DWORD *)(*(_QWORD *)(a1 + 1000) + 8LL) != 72 )
      goto LABEL_26;
