/*
 * XREFs of IovpCompleteRequest2 @ 0x14076DDF0
 * Callers:
 ...
 *     IovpSessionDataReference @ 0x14077D140 (IovpSessionDataReference.c)
 */
...
void __fastcall IovpCompleteRequest2(__int64 a1, __int64 a2)
{
  ...
  *(_BYTE *)(v5 + 16) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v5 + 8));
  ...
  {
    MdlInvariantPostProcessing1(v5, a1, (_BYTE *)(*(_QWORD *)(a1 + 184) - 72LL));
  }
