/*
 * XREFs of PspCopyAndFixupParameters @ 0x14049C2C0
 * Callers:
...
__int64 __fastcall PspCopyAndFixupParameters(int a1, unsigned int *a2, __int64 a3)
{
  ...
  {
    v9 = ObDuplicateObject(a1, *((_QWORD *)v4 + 2), (int)Process, (int)&v30, 0, 0, 6, PreviousMode);
    a1 = v28;
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *(_QWORD *)v24 )
      {
        ...
        {
          result = ObDuplicateObject(a1, v25, (int)Process, (int)&v30, 0, 0, 6, PreviousMode);
          v26 = v30;
          v21 = v4 + 8;
        }
        if ( (int)result < 0 )
