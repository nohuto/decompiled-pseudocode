/*
 * XREFs of KiInvalidOpcodeFault @ 0x14018CFC0
 * Callers:
 *     KiInvalidOpcodeFaultShadow @ 0x14026C400 (KiInvalidOpcodeFaultShadow.c)
 * Callees:
...
__int64 __fastcall KiInvalidOpcodeFault(int a1, unsigned __int64 Object, int a3, int a4, char a5)
{
  ...
  if ( (v26 & 1) != 0 )
  {
    ...
    v6 = *(_QWORD *)&CurrentThread->Process[2].FreezeCount;
