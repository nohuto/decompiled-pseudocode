/*
 * XREFs of CmpKeyEnumStackStartFromKcbStack @ 0x1406707E8
 * Callers:
...
__int64 __fastcall CmpKeyEnumStackStartFromKcbStack(__int64 a1, __int64 a2)
{
  __int64 v4; // rdx
  int started; // ebx
  __int64 v6; // r8
  ...
  if ( started >= 0 )
  {
    started = CmpKeyEnumStackStartFromKeyNodeStack(a1, v9);
    if ( started >= 0 )
      started = 0;
  }
