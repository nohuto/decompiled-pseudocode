/*
 * XREFs of PipChangeDeviceObjectFromRegistryProperties @ 0x1404E3894
 * Callers:
...
__int64 __fastcall PipChangeDeviceObjectFromRegistryProperties(__int64 a1, ACL *a2, __int64 a3, __int64 a4, char a5)
{
  ...
  void *v24; // r14
  __int64 i; // rax
  NTSTATUS OwnerSecurityDescriptor; // esi
  char v27; // dl
  __int64 v28; // r8
  ...
  unsigned int v38; // [rsp+48h] [rbp-69h] BYREF
...
LABEL_10:
      ...
      *(_DWORD *)(v5 + 52) = v22 | *(_DWORD *)(v5 + 52) & 0xFFFAFEF0;
      ...
      if ( v24 )
        OwnerSecurityDescriptor = ObSetSecurityObjectByPointer(v5, v20);
      v27 = v33;
      v28 = v46;
      do
      {
    ...
    v30 = v39;
    v32 = IopCreateDefaultDeviceSecurityDescriptor(v39, v22, v31, v47, &v43, (ACL **)&Owner, &v38);
    v10 = v43;
    v24 = v32;
    v12 = Owner;
    if ( !v32 )
