/*
 * XREFs of PopEtProcessSnapshotUpdateFromSnapshotContext @ 0x1406D32B0
 * Callers:
...
__int16 __fastcall PopEtProcessSnapshotUpdateFromSnapshotContext(__int64 a1, _QWORD *a2)
{
  ...
  v3 = a2[1];
  v5 = *(_QWORD *)(*a2 + 1832LL);
  PopEtStringSet(a1 + 24, *(_QWORD *)(v5 + 368));
  v6 = (_OWORD *)a2[3];
  v7 = (_OWORD *)(a1 + 48);
  v8 = 2LL;
  do
  ...
  *v7 = *v6;
  ...
  v7[3] = v6[3];
  v7[4] = v6[4];
  *((_QWORD *)v7 + 10) = *((_QWORD *)v6 + 10);
  *(_DWORD *)(a1 + 392) = *(_DWORD *)(v5 + 380);
  result = *(_WORD *)(v3 + 36) & *(_WORD *)(v5 + 376);
  *(_WORD *)(a1 + 44) = result;
  return result;
}
