/*
 * XREFs of KeRemoveByKeyDeviceQueue @ 0x1402018A0
 * Callers:
...
LABEL_10:
    ...
    if ( Blink == &DeviceQueue->DeviceListHead )
      Blink = 0LL;
    ...
    v9 = Flink->DeviceListEntry.Blink;
    if ( (struct _KDEVICE_QUEUE_ENTRY *)Flink->DeviceListEntry.Flink->Blink != Flink
      || (struct _KDEVICE_QUEUE_ENTRY *)v9->Flink != Flink )
    {
      __fastfail(3u);
    }
    v9->Flink = v8;
