/*
 * XREFs of KiProcessPendingForegroundBoosts @ 0x140064FB0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  v7 = (__int64 *)qword_1403569C8;
  if ( (__int64 *)qword_1403569C8 != &qword_1403569C8 )
  {
    do
    {
      v8 = v7 - 179;
    ...
    while ( v7 != &qword_1403569C8 );
    v7 = (__int64 *)qword_1403569C8;
  }
  v13 = v7 != &qword_1403569C8;
  KxReleaseSpinLock(&qword_1403569D8);
  if ( v13 )
  {
    v18[1] = -1LL;
    v18[0] = 0LL;
    KeSetTimer2((__int64)&KiForegroundState, -150000LL * (2 - v5), 0LL, (__int64)v18);
  }
  while ( v4 )
  {
    v14 = v4;
