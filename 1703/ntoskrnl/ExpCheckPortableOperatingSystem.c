/*
 * XREFs of ExpCheckPortableOperatingSystem @ 0x1405578EC
 * Callers:
 *     ExIsWindowsToGo @ 0x140557980 (ExIsWindowsToGo.c)
...
__int64 __fastcall ExpCheckPortableOperatingSystem(_DWORD *a1)
{
  ...
  *(_QWORD *)&NumberOfBytes[1] = 0LL;
  ...
  if ( DevicePropertyData >= 0 && IsPortable )
  {
    ...
    SourceString[4] = **((_WORD **)PsGetServerSiloGlobals(HostSilo) + 128);
