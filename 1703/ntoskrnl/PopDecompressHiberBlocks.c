/*
 * XREFs of PopDecompressHiberBlocks @ 0x14040749C
 * Callers:
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  v5 = 0;
  v6 = (int)qword_14034B338;
  v47 = a5;
  v48 = 0LL;
  v44 = (char *)qword_14034B338;
  v43 = 0;
  while ( 1 )
  {
    PopHiberCheckForDebugBreak();
    if ( !qword_14034B758 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_14034B2E0 )
      qword_14034B758 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_14034B2E1
      && ((unsigned int)dword_14034B2C4 > 0x640 || !byte_14034B2E0) )
    {
      v37 = __rdtsc();
      if ( byte_14036E288 )
      {
      ...
      v38 = __rdtsc();
      qword_14034B740 += (((unsigned __int64)HIDWORD(v38) << 32) | (unsigned int)v38) - v37;
    }
    v42 = 4;
