/*
 * XREFs of PoInitiateProcessorWake @ 0x140227750
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PpmIdleUpdateSynchronizationState @ 0x140228E48 (PpmIdleUpdateSynchronizationState.c)
 */
...
char __fastcall PoInitiateProcessorWake(ULONG a1)
{
  ...
  v5 = (_DWORD *)(Prcb + 24000);
  v6 = HIBYTE(*(_DWORD *)(Prcb + 24000));
  v7 = 0;
  v8 = *(_QWORD *)(v4 + 488);
