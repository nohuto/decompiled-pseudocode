/*
 * XREFs of BcpDisplayProgress @ 0x140266DD0
 * Callers:
 ...
 *     BcpCursorLessThan @ 0x140266688 (BcpCursorLessThan.c)
...
__int64 __fastcall BcpDisplayProgress(unsigned int a1, int a2, unsigned int a3)
{
  ...
  if ( !v5 )
    v6 = &stru_14036EAF0;
  BcpDisplayCriticalString((__int16 *)v6, dword_14033FBD0[18 * a2 + 2], a3, a2);
  LODWORD(v20) = 0x80000;
  v21 = &v25;
  BcpConvertProgressToString(a1, (__int64)&v20);
  BcpDisplayCriticalString((__int16 *)&v20, dword_14033FBD0[2 * v7 + 2], v8, a2);
  v10 = &stru_14036EAE0;
  if ( a1 != 1 )
    v10 = &stru_14036EB00;
  BcpDisplayCriticalString((__int16 *)v10, dword_14033FBD0[2 * v7 + 2], v9, a2);
  v11 = BcpCursor;
  v12 = dword_14036B980;
  v20 = BcpCursor;
  LODWORD(v21) = dword_14036B980;
  if ( BcpCursorLessThan(&v20) )
  {
    v13 = v20;
    v14 = HIDWORD(v20);
    v24 = v20;
    v15 = *(_DWORD *)(*(_QWORD *)(qword_14036EB40 + 24) + 40LL);
    if ( BcpTextBoxLeftEdgeOverride )
      v16 = *(_DWORD *)BcpTextBoxLeftEdgeOverride;
    else
      v16 = dword_14033FBD0[2 * v7 + 4] + dword_14033FBD0[2 * v7 + 8];
    if ( BcpTextBoxRightEdgeOverride )
      v17 = *(_DWORD *)BcpTextBoxRightEdgeOverride;
    else
      v17 = dword_14033FBD0[2 * v7 + 4] + dword_14033FBD0[2 * v7 + 6] + dword_14033FBD0[2 * v7 + 8];
    while ( BcpCursorLessThan(&v24) )
    {
      if ( (int)BgpDisplayCharacterEx(0x20u, (__int64 *)qword_14036EB40, v13, v14, v15, v15, &v22, &v23, v19) < 0 )
        return 0LL;
      v13 += v22;
      LODWORD(v24) = v13;
      if ( v13 > v17 )
