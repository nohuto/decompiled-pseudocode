/*
 * XREFs of _CmGetInterfaceClassMappedPropertyFromRegValue @ 0x1404E31E8
 * Callers:
  ...
  *v10 = 0;
  ...
  if ( (_DWORD)v15 == 2 )
  {
    ...
    if ( !v21 )
    {
      ...
      v22 = PnpOpenPropertiesKey(a1, (__int64)a3, 0LL, 1u, 0, v25, &KeyHandle);
      v9 = v22;
      if ( v22 == -1073741772 )
      {
LABEL_16:
      ...
      {
        LODWORD(a5) = v14;
        v24 = RegRtlQueryValue(KeyHandle, L"Default", &a6, v13, (unsigned int *)&a5);
        ZwClose(KeyHandle);
