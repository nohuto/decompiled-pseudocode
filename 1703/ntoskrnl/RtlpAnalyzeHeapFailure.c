/*
 * XREFs of RtlpAnalyzeHeapFailure @ 0x140243E68
 * Callers:
...
void __fastcall RtlpAnalyzeHeapFailure(ULONG_PTR a1, ULONG_PTR a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 112) & 0x4000000) == 0
    && *(_BYTE *)(a2 + 11) != ((unsigned __int8)v7 ^ (unsigned __int8)(*(_BYTE *)(a2 + 9) ^ *(_BYTE *)(a2 + 10))) )
  {
    goto LABEL_33;
  }
  v5 = 1;
  ...
  if ( v8 )
  {
    v4 = (a2 & 0xFFFFFFFFFFFF0000uLL) + ((1LL - v8) << 16);
    v22 = v4;
  }
  else
  {
  ...
  if ( v9 == 3 )
  {
    ...
    if ( v11 < *(_QWORD *)(v4 + 48) )
      goto LABEL_33;
    if ( *(_QWORD *)(a2 + 56) + v11 > *(_QWORD *)(v4 + 72) )
      goto LABEL_33;
    v5 = 4;
    v12 = **(_QWORD **)(a2 + 24);
