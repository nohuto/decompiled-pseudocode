/*
 * XREFs of MiAssignSessionRanges @ 0x140812DC8
 * Callers:
...
__int64 MiAssignSessionRanges()
{
  ...
  {
    v9 = 16;
    v10 = ((v6[1] + 0x3FFFFFFFLL) & 0xFFFFFFFFC0000000uLL) >> 30;
  ...
  while ( v7 );
  qword_14036C138 = v14[1];
  qword_14036C140 = v14[4];
  qword_14036C5A8 = v14[7];
  result = v14[10];
  qword_14036C178 = v14[10];
  qword_14036C170 = v2;
  return result;
}
