/*
 * XREFs of PopAddPagesToCompressedPageSet @ 0x140406B88
 * Callers:
        ...
        __int64 a7)
{
  ...
  if ( v8 )
  {
    ...
    else
    {
      v13 = a4;
      v18 = *(_DWORD *)(a2 + 120);
      v19 = *((_QWORD *)qword_14034B338 + 5) - *((_QWORD *)qword_14034B338 + 7);
      if ( v18 && (v20 = *(_DWORD *)(a2 + 124), (int)(100 * v20 / v18) <= dword_14034B2E4) )
      {
        v21 = *((_DWORD *)qword_14034B338 + 2);
      ...
      {
        LOBYTE(v7) = v19 >= (__int64)((unsigned __int64)*((unsigned int *)qword_14034B338 + 2) >> 1);
      }
      *(_DWORD *)(a2 + 120) = v18 + 1;
    }
    v14 = __rdtsc();
