/*
 * XREFs of EtwTracePool @ 0x14017D8C0
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  while ( !v12 )
  {
    ...
    {
      v17 = (unsigned int *)(0x140000000LL + 20 * v13 + 3427652);
...
LABEL_17:
    ...
    EtwpLogKernelEvent((__int64)&v25, EtwpHostSiloState, (unsigned __int8)EtwpSystemLogger[2 * v14], v9, v8, 0x1401B02u);
LABEL_21:
