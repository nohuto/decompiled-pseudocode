/*
 * XREFs of PpmEventIdleDurationExpiration @ 0x1402357EC
 * Callers:
...
void __fastcall PpmEventIdleDurationExpiration(unsigned __int16 *a1)
{
  ...
  __int64 v11; // rcx
  __int64 v12; // rcx
  unsigned __int16 v13; // [rsp+40h] [rbp-3F8h] BYREF
  _QWORD v14[40]; // [rsp+50h] [rbp-3E8h] BYREF
  ...
  if ( PpmEtwRegistered )
  {
    ...
    if ( EtwEventEnabled(PpmEtwHandle, &PPM_ETW_IDLE_DURATION_EXPIRATION) )
    {
      ...
      *(_QWORD *)&UserData[0].Size = 2LL;
      ...
      EtwWriteEx(v2, &PPM_ETW_IDLE_DURATION_EXPIRATION, 0LL, 0, 0LL, 0LL, UserDataCount, UserData);
    }
  }
}
