/*
 * XREFs of HvlReadPerformanceStateCounters @ 0x1401E9720
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HvlReadPerformanceStateCounters(ULONG a1, unsigned int a2, _QWORD *a3, _QWORD *a4)
{
  ...
  if ( a2 < 2 )
  {
    ...
    v8 = *((unsigned int *)&xmmword_140389228 + 2 * v4 + 7);
    *a3 = Prcb->StatisticsPage[*((unsigned int *)&xmmword_140389228 + 2 * v4 + 6)];
