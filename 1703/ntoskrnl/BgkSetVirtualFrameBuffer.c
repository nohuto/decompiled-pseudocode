/*
 * XREFs of BgkSetVirtualFrameBuffer @ 0x140166C60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BgGetIsColorOverridden @ 0x140758E8C (BgGetIsColorOverridden.c)
 *     BgConvertResources @ 0x140759C8C (BgConvertResources.c)
 */
