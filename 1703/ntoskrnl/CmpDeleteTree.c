/*
 * XREFs of CmpDeleteTree @ 0x14058E778
 * Callers:
...
char __fastcall CmpDeleteTree(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  ...
  for ( i = a2; ; i = v6 )
  {
    while ( 1 )
    {
      ...
      if ( !(v5[5] + v5[6]) )
        break;
      SubKeyByNumber = CmpFindSubKeyByNumber(BugCheckParameter2, v5, 0, &v13);
      (*(void (__fastcall **)(ULONG_PTR, int *))(BugCheckParameter2 + 16))(BugCheckParameter2, &v11);
      if ( SubKeyByNumber < 0 )
        return 0;
      if ( v13 == -1 )
        return 0;
      v8 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, int *))(BugCheckParameter2 + 8))(BugCheckParameter2, v13, &v11);
      if ( !v8 )
        return 0;
      ...
      else if ( (int)CmpFreeKeyByCell(BugCheckParameter2, v13, 1) < 0 )
      {
        return 0;
      }
    }
