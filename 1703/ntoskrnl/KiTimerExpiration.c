/*
 * XREFs of KiTimerExpiration @ 0x14013B724
 * Callers:
...
__int64 __fastcall KiTimerExpiration(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( result )
  {
    v12 = *(unsigned int *)(v9 + 27184);
    *(_DWORD *)(a1 + 27184) = ((_BYTE)v12 + 1) & 0xF;
    *(_QWORD *)(a1 + 16 * (v12 + 1683)) = v10;
    *(LARGE_INTEGER *)(a1 + 16 * (v12 + 1683) + 8) = KeQueryPerformanceCounter(0LL);
    v13 = a3 >> 18;
