/*
 * XREFs of NtQueryWnfStateData @ 0x1404EF144
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  _DWORD *v38; // [rsp+80h] [rbp-88h]
  PSID Sid; // [rsp+88h] [rbp-80h] BYREF
  volatile void *v40; // [rsp+90h] [rbp-78h]
  ...
  *(_QWORD *)v35 = 0LL;
  ...
  StateData = ExpCaptureWnfStateName(a1, &v36, a3);
  if ( StateData >= 0 )
  {
    if ( PreviousMode )
    {
      ...
      *(_DWORD *)v16 = *(_DWORD *)v16;
      if ( (_DWORD)v10 )
        ProbeForWrite(Address, (unsigned int)v10, 1u);
    }
    else
    {
      v31 = *v12;
    ...
    StateData = ExpWnfCaptureScopeInstanceId(v9, v6, v10, &Sid, v41);
    if ( StateData >= 0 )
    {
      v30 = PreviousMode == 0;
      if ( PreviousMode )
...
LABEL_30:
  ...
  if ( *(_QWORD *)v35 )
    ExReleaseRundownProtection((PEX_RUNDOWN_REF)(*(_QWORD *)v35 + 8LL));
  if ( P )
