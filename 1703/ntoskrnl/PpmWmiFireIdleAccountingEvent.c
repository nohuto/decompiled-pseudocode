/*
 * XREFs of PpmWmiFireIdleAccountingEvent @ 0x140234540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PpmWmiFireIdleAccountingEvent(__int64 a1)
{
  ...
  v1 = (_QWORD *)(a1 + 23936);
  v2 = *(_DWORD **)(a1 + 23944);
  if ( *(_QWORD *)(a1 + 23936) && v2 && *(_DWORD *)(a1 + 24168) )
  {
    v3 = PpmAllocWmiEvent((PDEVICE_OBJECT)(a1 + 24160), (__int128 *)&PPM_IDLE_ACCOUNTING_EX_GUID, 416 * *v2 + 24);
    v4 = v3;
    if ( v3 )
    {
