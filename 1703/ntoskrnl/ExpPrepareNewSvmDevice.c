/*
 * XREFs of ExpPrepareNewSvmDevice @ 0x14025E2A8
 * Callers:
...
__int64 __fastcall ExpPrepareNewSvmDevice(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  *((_OWORD *)v9 + 5) = *(_OWORD *)(a3 + 48);
  v10 = ((__int64 (__fastcall *)(_QWORD, _QWORD *))v9[11])(v9[5], v9 + 12);
  if ( v10 >= 0 )
  {
    ...
    if ( v10 >= 0 )
    {
      ...
      v10 = ((__int64 (__fastcall *)(__int64, _QWORD, int *, _QWORD *))HalIommuDispatch[3])(a2, v9[12], &v13, v9 + 13);
      if ( v10 < 0 )
      {
