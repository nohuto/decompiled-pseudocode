/*
 * XREFs of ?StDmpSinglePageLookup@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAPEAU_ST_PAGE_RECORD@1@@Z @ 0x14005D3B8
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmpSinglePageLookup(__int64 a1, __int64 a2, _DWORD *a3, _QWORD *a4)
{
  ...
  v5 = *(_QWORD *)(a2 + 24);
  if ( (unsigned __int8)*a3 && *(_DWORD *)(a2 + 40) == *(_DWORD *)(*(_QWORD *)(a1 + 800) + 6004LL) )
  {
  ...
  *(_DWORD *)(v5 + 32) |= 1u;
  ...
  if ( (int)result >= 0 )
  {
    *(_DWORD *)(a2 + 40) = *(_DWORD *)(*(_QWORD *)(a1 + 800) + 6004LL);
LABEL_6:
