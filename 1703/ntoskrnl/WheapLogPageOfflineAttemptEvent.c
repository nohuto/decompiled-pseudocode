/*
 * XREFs of WheapLogPageOfflineAttemptEvent @ 0x140260598
 * Callers:
...
{
  bool v6; // [rsp+40h] [rbp-31h] BYREF
  bool v7; // [rsp+41h] [rbp-30h] BYREF
  bool v8; // [rsp+42h] [rbp-2Fh] BYREF
  bool v9; // [rsp+43h] [rbp-2Eh] BYREF
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+50h] [rbp-21h] BYREF
  bool *v11; // [rsp+60h] [rbp-11h]
  __int64 v12; // [rsp+68h] [rbp-9h]
  bool *v13; // [rsp+70h] [rbp-1h]
  __int64 v14; // [rsp+78h] [rbp+7h]
  bool *v15; // [rsp+80h] [rbp+Fh]
  __int64 v16; // [rsp+88h] [rbp+17h]
  bool *v17; // [rsp+90h] [rbp+1Fh]
