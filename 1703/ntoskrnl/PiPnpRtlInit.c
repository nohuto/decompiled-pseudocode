/*
 * XREFs of PiPnpRtlInit @ 0x14059DDFC
 * Callers:
 ...
 *     _PnpCtxSetNtPlugPlayRoutine @ 0x14059DF1C (_PnpCtxSetNtPlugPlayRoutine.c)
...
int __fastcall PiPnpRtlInit(unsigned int a1)
{
  ...
  qword_140367598 = (__int64)&PiPnpRtlActiveOperations;
