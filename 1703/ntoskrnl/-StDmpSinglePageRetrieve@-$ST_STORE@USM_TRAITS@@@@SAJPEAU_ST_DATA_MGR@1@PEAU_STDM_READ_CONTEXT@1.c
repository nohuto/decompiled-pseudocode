/*
 * XREFs of ?StDmpSinglePageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAXPEAU_ST_PAGE_LOCATION@1@@Z @ 0x14005DCDC
 * Callers:
        ...
        __int64 a5)
{
  ...
  {
    v9 = ST_STORE<SM_TRAITS>::StDmpSinglePageLookup(a1, a2, (_DWORD *)a3, v30);
    if ( v9 < 0 )
  ...
  *(_WORD *)(a5 + 6) = (unsigned __int8)*(_WORD *)a3;
  ...
  {
    v20 = *(_QWORD *)(a1 + 16LL * IsCurrentRegion + 1240) + v17;
  }
  v9 = ST_STORE<SM_TRAITS>::StDmSinglePageTransfer(a1, *(_QWORD *)(a2 + 16), v20 | v6, a4, *(_QWORD *)(a3 + 8), a5, a2);
  if ( v9 >= 0 )
    v9 = 0;
  if ( v7 )
  {
    v22 = *(_QWORD *)(a1 + 800);
    if ( (*(_BYTE *)(v22 + 5989) & 4) != 0 )
    {
    ...
    else
    {
      ...
      *(_QWORD *)(v24 + 8 * v12) = v26;
      if ( (v26 & 3) == 0 )
        SmFpFree(v22 + 6560, 5, (__int64)KeGetCurrentThread(), v27);
    }
  }
LABEL_22:
  if ( v8 )
