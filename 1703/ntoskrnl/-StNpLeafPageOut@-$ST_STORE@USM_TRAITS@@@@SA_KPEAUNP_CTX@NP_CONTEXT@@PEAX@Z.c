/*
 * XREFs of ?StNpLeafPageOut@?$ST_STORE@USM_TRAITS@@@@SA_KPEAUNP_CTX@NP_CONTEXT@@PEAX@Z @ 0x14024CCC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StNpLeafPageOut(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(v5 + 56) |= 1u;
  ...
  if ( (int)ST_STORE<SM_TRAITS>::StDmpSinglePageAdd(v5, (__int64)v9, 0LL, &v11) >= 0 )
    return 4 * v6;
  return v3;
}
