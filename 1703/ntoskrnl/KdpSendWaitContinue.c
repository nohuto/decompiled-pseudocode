/*
 * XREFs of KdpSendWaitContinue @ 0x14078AC78
 * Callers:
 ...
 *     KdpGetBusData @ 0x140789E9C (KdpGetBusData.c)
 ...
 *     KdpReadPhysicalMemoryLong @ 0x14078A1FC (KdpReadPhysicalMemoryLong.c)
 ...
 *     KdpSetContext @ 0x14078B588 (KdpSetContext.c)
        ...
        switch ( LODWORD(v64[0]) )
        {
          ...
          case 0x3146:
            ...
            *(_OWORD *)&v64[2] = KdVersionBlock;
            v11 = &v58;
            LODWORD(v64[1]) = 0;
            v64[6] = (PVOID)qword_14033E110;
            *(_OWORD *)&v64[4] = xmmword_14033E100;
            LODWORD(v64[0]) = 12614;
            goto LABEL_51;
          case 0x3147:
