/*
 * XREFs of _CmGetInterfaceClassMappedPropertyKeys @ 0x140740890
 * Callers:
...
LABEL_39:
  ...
  if ( (int)result >= 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( a4 )
        goto LABEL_40;
      result = CmGetInterfaceClassMappedPropertyFromComposite((__int64)a1, a2, (__int64)a3, *v16, v24, 0LL, 0, &a7);
      if ( (_DWORD)result == -1073741789 || !(_DWORD)result )
      {
        v18 = 1;
      }
