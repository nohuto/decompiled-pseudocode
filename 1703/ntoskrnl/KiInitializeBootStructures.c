/*
 * XREFs of KiInitializeBootStructures @ 0x14040F390
 * Callers:
 ...
 *     InitializeBuildStrings @ 0x1407F63E8 (InitializeBuildStrings.c)
...
__int64 __fastcall KiInitializeBootStructures(__int64 a1)
{
  ...
  *(_DWORD *)&CurrentPrcb->MinorVersion = 65537;
  ...
  if ( !(_DWORD)Number )
  {
    ...
    v5 = *(_QWORD *)(a1 + 240);
    KiFeatureSettings = (*(_DWORD *)(v5 + 116) >> 12) & 0x3FFF;
  ...
  *((_WORD *)Pcr->NtTib.StackBase + 51) = 104;
  ...
  if ( !(_DWORD)Number )
  {
    ...
    memset(&unk_1403E42B4, 0, 0xA4uLL);
