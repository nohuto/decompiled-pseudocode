/*
 * XREFs of CmpInsertSecurityCellList @ 0x140455FCC
 * Callers:
...
char __fastcall CmpInsertSecurityCellList(ULONG_PTR BugCheckParameter2, unsigned int a2, unsigned int a3, char a4)
{
  __int64 v6; // r13
  __int64 v7; // r14
  __int64 v8; // rsi
  ...
  v17[1] = 0;
  v20 = 0;
  v10 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, _DWORD *))(BugCheckParameter2 + 8))(BugCheckParameter2, a3, v19);
  v11 = v10;
  if ( !v10 )
    return 0;
  if ( a3 >= 0x80000000 )
...
LABEL_29:
  ...
  *(_DWORD *)(v6 + 8) = a3;
  v20 = 1;
LABEL_4:
  if ( (int)CmpAddSecurityCellToCache(BugCheckParameter2, a3, 0LL) < 0 )
  {
    if ( v20 )
    {
