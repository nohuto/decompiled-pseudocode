/*
 * XREFs of KiChooseLowestRankedThread @ 0x140112D54
 * Callers:
...
_QWORD *__fastcall KiChooseLowestRankedThread(struct _KPRCB *a1, _KTHREAD *a2, unsigned int a3)
{
  ...
  if ( !SchedulingGroup )
    return 0LL;
  v7 = (__int64)SchedulingGroup + a1->ScbOffset;
  if ( !v7 )
    return 0LL;
  if ( a1 == KeGetCurrentPrcb() || (v8 = 0, a2 != a1->CurrentThread) )
    v8 = 1;
  if ( !(unsigned int)KiGetThreadEffectiveRankNonZero((_DWORD)a2, v7, a3, v8, 0LL) )
    return 0LL;
  ...
  if ( v14 >= v11 )
  {
    ...
    while ( 1 )
    {
      result = (_QWORD *)KiSelectThreadFromSchedulingGroup(a1, v13, Priority);
      if ( v13 == v7 )
      {
        v15 = 1;
      }
      else
      {
        ...
        if ( !*(_QWORD *)(v13 + 392) )
          goto LABEL_21;
        result = (_QWORD *)KiSelectThreadFromScbQueue((int)v13 + 392, (_DWORD)a1, Priority, v7, (__int64)&v18);
        v15 = v18;
      }
      if ( result )
        return result;
...
LABEL_21:
  ...
  return (_QWORD *)KiSelectThreadFromSchedulingGroup(a1, v13, 0LL);
}
