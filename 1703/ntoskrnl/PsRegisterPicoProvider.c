/*
 * XREFs of PsRegisterPicoProvider @ 0x1406E35F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140348E30 = *(_OWORD *)(a1 + 16);
  xmmword_140348E40 = *(_OWORD *)(a1 + 32);
  xmmword_140348E50 = *(_OWORD *)(a1 + 48);
  xmmword_140348E60 = *(_OWORD *)(a1 + 64);
  qword_140348E70 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_140348E50, 8).m128i_u64[0];
