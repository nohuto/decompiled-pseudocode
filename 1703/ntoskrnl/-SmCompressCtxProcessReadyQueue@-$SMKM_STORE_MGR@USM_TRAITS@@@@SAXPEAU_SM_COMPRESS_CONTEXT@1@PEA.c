/*
 * XREFs of ?SmCompressCtxProcessReadyQueue@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU_SM_COMPRESS_CONTEXT@1@PEAU1@EK@Z @ 0x140055574
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmCompressCtxProcessReadyQueue(__int64 a1, __int64 a2, KIRQL a3, int a4)
{
  ...
  for ( i = (volatile LONG *)(a1 + 112); ; v6 = ExAcquireSpinLockExclusive(i) )
  {
    ...
    if ( v14 < 0 )
    {
      if ( v14 == -1073741739 )
      {
        v15 = ExAcquireSpinLockExclusive(i);
        v16 = *v4[1];
      ...
      *(_QWORD *)(v12[4] + 8) = 0LL;
      ...
      v20 = (struct _EX_RUNDOWN_REF *)SmKmStoreRefFromStoreIndex(a2, *(_DWORD *)(v12[13] + 5984) & 0x3FF);
