/*
 * XREFs of MiGetHighestPteConsumer @ 0x14022581C
 * Callers:
...
__int64 __fastcall MiGetHighestPteConsumer(unsigned __int64 *a1)
{
  ...
  *a1 = 0LL;
  if ( (dword_1403E310C & 1) == 0 || byte_14036CD9D == 1 )
    return 0LL;
  v3 = 0;
  v4 = &unk_14036D570;
  do
  ...
  while ( (PVOID *)v5 != &PsLoadedModuleList )
  {
    ...
    v18 = v6;
    v9 = v5;
    v10 = (void **)&unk_14036D570;
    v11 = (char *)&unk_14036D570;
    v12 = 16LL;
    do
    {
      for ( i = (char *)*v10; i != v11; i = *(char **)i )
      {
        ...
        if ( (v14 & 2) == 0 )
        {
          if ( (v16 = *(_QWORD *)(v5 + 48), v15 >= v16) && v15 < v16 + *(unsigned int *)(v5 + 64)
            || (v17 = *((_QWORD *)i + 11), v17 >= v16) && v17 < v16 + *(unsigned int *)(v5 + 64) )
          {
            v8 += *((_QWORD *)i + 3);
            *((_DWORD *)i + 16) = v14 | 2;
          }
