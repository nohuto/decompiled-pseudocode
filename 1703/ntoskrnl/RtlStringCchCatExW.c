/*
 * XREFs of RtlStringCchCatExW @ 0x140156E80
 * Callers:
 ...
 *     RtlStringLengthWorkerW @ 0x140156FE8 (RtlStringLengthWorkerW.c)
        ...
        ULONG dwFlags)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    {
      v6 = RtlStringCopyWorkerW_3(&pszDest[v11], cchDest - v11, &pcchLength, v7, (size_t)v13);
      if ( v6 >= 0 )
        return v6;
    }
    if ( cchDest )
