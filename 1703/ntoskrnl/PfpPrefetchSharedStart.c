/*
 * XREFs of PfpPrefetchSharedStart @ 0x1404669E8
 * Callers:
...
__int64 __fastcall PfpPrefetchSharedStart(ULONG_PTR BugCheckParameter2)
{
  ...
  *(_DWORD *)(BugCheckParameter2 + 68) |= 1u;
  ...
  if ( (dword_14036DFA8 & 1) == 0 )
  {
    v5 = qword_14036DF98;
    if ( *(__int64 **)(qword_14036DF98 + 8) != &qword_14036DF98 )
      __fastfail(3u);
    *(_QWORD *)BugCheckParameter2 = qword_14036DF98;
    *(_QWORD *)(BugCheckParameter2 + 8) = &qword_14036DF98;
    *(_QWORD *)(v5 + 8) = BugCheckParameter2;
    qword_14036DF98 = BugCheckParameter2;
  }
