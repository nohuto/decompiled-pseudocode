/*
 * XREFs of PpmEventParkNodePreference @ 0x140235B08
 * Callers:
...
char __fastcall PpmEventParkNodePreference(__int16 a1, __int64 a2, char a3, __int64 a4, char a5, char a6, char a7)
{
  ...
  int v14; // [rsp+74h] [rbp-35h]
  char *v15; // [rsp+78h] [rbp-31h]
  ...
  int v23; // [rsp+A4h] [rbp-5h]
  char *v24; // [rsp+A8h] [rbp-1h]
  int v25; // [rsp+B0h] [rbp+7h]
  int v26; // [rsp+B4h] [rbp+Bh]
  char *v27; // [rsp+B8h] [rbp+Fh]
  int v28; // [rsp+C0h] [rbp+17h]
  int v29; // [rsp+C4h] [rbp+1Bh]
  _UNKNOWN *retaddr; // [rsp+F0h] [rbp+47h] BYREF
  __int16 v31; // [rsp+F8h] [rbp+4Fh] BYREF
  __int64 v32; // [rsp+100h] [rbp+57h] BYREF
  char v33; // [rsp+108h] [rbp+5Fh] BYREF
