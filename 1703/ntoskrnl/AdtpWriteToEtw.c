/*
 * XREFs of AdtpWriteToEtw @ 0x1405AB9F4
 * Callers:
 ...
 *     AdtpNormalizeAuditInfoHelper @ 0x1401638C0 (AdtpNormalizeAuditInfoHelper.c)
 *     __security_check_cookie @ 0x140169210 (__security_check_cookie.c)
 *     memset @ 0x140192D80 (memset.c)
 *     AdtpGetCategoryAndSubCategoryId @ 0x1405ABC8C (AdtpGetCategoryAndSubCategoryId.c)
 */
...
LABEL_15:
  ...
  {
LABEL_21:
    v7 = EtwWriteKMSecurityEvent(&v26, v9, v23[0], (unsigned __int64)&v33 & -(__int64)(v23[0] != 0));
    if ( v7 == -1073741058 )
      *a2 = 1;
  }
LABEL_23:
