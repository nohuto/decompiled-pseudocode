/*
 * XREFs of NtCreateTokenEx @ 0x14046F5F4
 * Callers:
 *     NtCreateToken @ 0x1406F64F8 (NtCreateToken.c)
 * Callees:
        ...
        __int64 a17)
{
  ...
  __int64 v52; // [rsp+118h] [rbp-A0h] BYREF
  __int64 v53; // [rsp+120h] [rbp-98h] BYREF
  ...
  *(_QWORD *)v56 = 0LL;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( v28 >= 0 )
    {
      ...
      v40 = v28;
      LODWORD(v41) = (v41 - 16 * v31 + 3) & 0xFFFFFFFC;
      v18 = a1;
    }
    if ( v28 >= 0 )
    {
...
LABEL_52:
        ...
        *(_OWORD *)v62 = *(_OWORD *)a17;
        ...
        if ( v25 && v28 >= 0 )
        {
          v28 = SepCaptureTokenSecurityAttributesInformation(v25, PreviousMode, 0, (const void ***)&v52);
          v40 = v28;
        }
        if ( a11 && v28 >= 0 )
        {
          v28 = SepCaptureTokenSecurityAttributesInformation(a11, PreviousMode, 0, (const void ***)&v53);
          v40 = v28;
        }
        if ( a13 && v28 >= 0 )
        {
