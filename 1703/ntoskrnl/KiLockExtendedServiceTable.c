/*
 * XREFs of KiLockExtendedServiceTable @ 0x140173EEC
 * Callers:
...
__int64 __fastcall KiLockExtendedServiceTable(ULONG_PTR BugCheckParameter1, ULONG_PTR a2, unsigned int a3, int a4)
{
  ...
  if ( a4 )
  {
    ...
    if ( dword_14033E060 == SessionId
      || (*(_QWORD *)&v8 = (unsigned int)_InterlockedCompareExchange(&dword_14033E060, SessionId, -1), (_DWORD)v8 == -1) )
    {
      v9 = 4 * v4;
      v10 = ((unsigned __int64)&qword_140341670 ^ qword_140341678) & 0x3F;
      ...
      v14 = v9 >> 7;
      v15 = (unsigned __int64)&qword_140341670 ^ qword_140341678;
      if ( v9 >> 7 )
      {
        do
        {
          ...
          while ( v16 );
          v20 = __ROL8__((unsigned __int64)&qword_140341670 ^ qword_140341678 ^ ((unsigned __int64)v12 - v6), 17) ^ (unsigned __int64)&qword_140341670 ^ qword_140341678 ^ ((unsigned __int64)v12 - v6);
      ...
      v26 = v15 ^ qword_140341670;
      BugCheckParameter3 = v4;
      v27 = (_QWORD *)a2;
      v28 = (v15 ^ qword_140341670) & 0x3F;
      *(_QWORD *)&v8 = a2;
      if ( a2 < a2 + v4 )
      {
        do
      ...
      if ( (v5 & 2) != 0 )
      {
        qword_140341678 = v6 ^ v29 ^ BugCheckParameter3;
      }
      else
      {
        ...
        v146 = 0;
        qword_1403416D0[0] = v130;
        v40 = 0LL;
        v127 = 0LL;
        do
        {
          v41 = (void *)qword_1403416D0[v40];
          v124 = (__int64)v41;
          if ( !v41 )
            break;
          v42 = v39 & 0x3F;
...
LABEL_109:
        *(_QWORD *)&v8 = memset(qword_1403416D0, 0, sizeof(qword_1403416D0));
        if ( v39 == qword_140341670 || !v39 )
        {
  ...
  {
    v95 = (unsigned __int64)&qword_140341680;
    v96 = (unsigned __int64)&qword_140341680 & 0x3F;
    RtlImageNtHeader((PVOID)0x140000000LL);
    RtlCaptureImageExceptionValues(0x140000000uLL, &v136, &v123);
    v97 = v136;
    v98 = 0x140000000uLL;
    v137 = 0x140000000uLL;
    ...
    while ( v97 && v97 != v99 )
    {
      ...
      *v139 = v100;
      ...
      if ( v102 >> 7 )
      {
        ...
        while ( v109 );
        LODWORD(v96) = (unsigned __int64)&qword_140341680 & 0x3F;
      }
      v117 = v102 & 0x7F;
      if ( v117 >= 8 )
      {
    ...
    qword_140341670 = v8 ^ *((_QWORD *)&v8 + 1);
    if ( (unsigned __int64)v8 == *((_QWORD *)&v8 + 1) )
    {
      *(_QWORD *)&v8 = 0x95EA5DE843D5D824uLL;
      qword_140341670 = 0x95EA5DE843D5D824uLL;
    }
  }
  return v8;
}
