/*
 * XREFs of ?StDeviceIoIssue@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_PF_QUEUE@@@Z @ 0x14024ABD8
 * Callers:
 ...
 * Callees:
 *     StEtaIoStart @ 0x14024D2B8 (StEtaIoStart.c)
