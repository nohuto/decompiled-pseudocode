/*
 * XREFs of ?SmPerformStoreMaintenance@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAU?$SMKM_STORE@USM_TRAITS@@@@W4_ST_MAINTENANCE_TYPE@@@Z @ 0x1400048FC
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmPerformStoreMaintenance(int a1, __int64 a2, unsigned __int8 a3)
{
  ...
  *v7 = *v7 & 0xFFFFFFF8 | 5;
  ...
  v15[0] = v15;
  v13 = 6;
  LowPart = SMKM_STORE_MGR<SM_TRAITS>::SmStoreRequest(a1, v8, (_DWORD)v7, (unsigned int)&Object, (__int64)&v11);
