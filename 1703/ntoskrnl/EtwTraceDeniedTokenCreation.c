/*
 * XREFs of EtwTraceDeniedTokenCreation @ 0x14070A5D8
 * Callers:
...
void __fastcall EtwTraceDeniedTokenCreation(__int64 a1, UNICODE_STRING *a2)
{
  ...
  _DWORD v30[6]; // [rsp+110h] [rbp+8h] BYREF

  *(_QWORD *)&v10.Length = 0LL;
  v10.Buffer = 0LL;
  if ( TraceLoggingProviderEnabled(&stru_14033C520, (UCHAR)a2, 0x200000000001uLL) )
  {
    ...
    Buffer = v10.Buffer;
    if ( stru_14033C520.LevelPlus1 > 5 && TlgKeywordOn(&stru_14033C520, 0x200000000001uLL) )
    {
      v16 = 2LL;
      v15 = v18;
      ...
      v28 = 2LL;
      v30[1] = 0;
      TlgWrite(&stru_14033C520, &unk_1402AEFA6, 0LL, 0LL, 0xAu, &pData);
    }
    if ( v6 )
