/*
 * XREFs of sub_1407F58FC @ 0x1407F58FC
 * Callers:
...
__int64 __fastcall sub_1407F58FC(__int64 a1)
{
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD))(a1 + 248))(
         512LL,
         (unsigned int)(v4 + 48),
         *(unsigned int *)(a1 + 1552));
  v9 = v8;
  if ( v8 )
  {
    v11 = v7;
  ...
  *(_QWORD *)v10 = v10 + 24;
  ...
  {
    *(_DWORD *)(a1 + 1864) |= 0x2000000u;
    *(_QWORD *)(v10 + 8) = 1LL;
  }
  _InterlockedOr(v39, 0);
  __rdtsc();
  v33 = (unsigned __int8)(*(_BYTE *)(a1 + 1768) - 1);
  v34 = __rdtsc();
  v35 = __ROR8__(v34, 3);
  v36 = v33
      + ((((v35 ^ v34) * (unsigned __int128)0x7010008004002001uLL) >> 64) ^ (0x7010008004002001LL * (v35 ^ v34)))
      % (unsigned int)(63 - v33);
  do
  {
    v37 = __rdtsc();
  ...
  while ( v33
        + (((v38 * (unsigned __int128)0x7010008004002001uLL) >> 64) ^ (0x7010008004002001LL * v38))
        % (unsigned int)(63 - v33) == v36 );
  _disable();
