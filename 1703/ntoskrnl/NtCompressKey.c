/*
 * XREFs of NtCompressKey @ 0x14065EA94
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall NtCompressKey(HANDLE Key)
{
  ...
  if ( v6 < 0 )
    return v6;
  v7 = Object;
  for ( i = *(_QWORD *)(*((_QWORD *)Object + 1) + 24LL); ; CmpWaitOnHiveWriteQueue(i, v11, 0) )
  {
  ...
  v12 = *(_QWORD *)(v9 + 24);
  if ( v12 == CmpMasterHive || !*(_QWORD *)(v12 + 2664) || (*(_DWORD *)(v12 + 144) & 0x8003) != 0 )
  {
LABEL_14:
    v6 = -1073741811;
    goto LABEL_21;
