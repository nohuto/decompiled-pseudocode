/*
 * XREFs of _CmIsDeviceSafeRemovalRequired @ 0x1404E5E60
 * Callers:
...
bool __fastcall CmIsDeviceSafeRemovalRequired(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v19 = 0;
  v6 = 0;
  if ( (int)CmGetDeviceStatus(a1, a2, a3, (unsigned int)&v18, (__int64)&v20, (__int64)&v19) >= 0 )
  {
    v7 = v18;
    v16 = 4;
    DeviceRegProp = CmGetDeviceRegProp(a1, a2, a3, 16, (__int64)v23, (__int64)&v17, (__int64)&v16, 0);
    v9 = v17;
    if ( DeviceRegProp < 0 )
      v9 = 0;
    v17 = v9;
      ...
      if ( !v10 && v6 )
      {
        ...
        for ( i = (wchar_t *)a2; RtlStringCchCopyExW(pszDest, 0xC8uLL, i, 0LL, 0LL, 0x800u) >= 0; i = pszSrc )
        {
          ...
          if ( (int)CmGetDeviceParent(a1, pszDest, pszSrc, &v22) < 0 )
            return v10;
          v16 = 4;
          v13 = CmGetDeviceRegProp(a1, (__int64)pszSrc, 0LL, 16, (__int64)v23, (__int64)&v17, (__int64)&v16, 0);
          v14 = v17;
          if ( v13 < 0 )
            v14 = 0;
          v17 = v14;
