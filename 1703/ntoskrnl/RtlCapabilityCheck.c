...
__int64 __fastcall RtlCapabilityCheck(HANDLE ExistingTokenHandle, UNICODE_STRING *SourceString, _BYTE *a3)
{
  ...
  char Group[48]; // [rsp+B0h] [rbp-50h] BYREF
  ...
  *(_DWORD *)IdentifierAuthority.Value = 0;
  ...
  {
    *a3 = 0;
    v7 = RtlDeriveCapabilitySidsFromName(SourceString, Group, v21);
    if ( v7 < 0 )
      goto LABEL_19;
      ...
      && ZwQueryValueKey(KeyHandle, SourceString, KeyValuePartialInformation, KeyValueInformation, 0x10u, &ResultLength) >= 0 )
    {
      ...
      *v8 = 18;
      v9 = RtlCheckTokenMembership(ExistingTokenHandle, Sid, &v11);
    }
    else
    {
      v7 = RtlCheckTokenMembershipEx(ExistingTokenHandle, Group, 2, &v11);
      if ( v7 < 0 )
        goto LABEL_19;
      if ( v11 )
        goto LABEL_17;
      ...
      v8 = RtlSubAuthoritySid(Sid, 0);
      *v8 = 18;
      v7 = RtlCheckTokenMembership(ExistingTokenHandle, Sid, &v11);
      if ( v7 < 0 )
        goto LABEL_19;
      if ( v11 )
        goto LABEL_17;
