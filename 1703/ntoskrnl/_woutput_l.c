/*
 * XREFs of _woutput_l @ 0x14016CCC4
 * Callers:
 ...
 *     write_multi_char @ 0x14016D5FC (write_multi_char.c)
 *     write_string @ 0x14016D654 (write_string.c)
...
LABEL_123:
                              v45 = v58 - v14 - v44;
                              if ( (v7 & 0xC) == 0 )
                                write_multi_char(32LL, v45, v61, &v57);
                              write_string(v64, v44, v61, &v57);
                              v46 = v61;
                              if ( (v7 & 0xC) == 8 )
                                write_multi_char(48LL, v45, v61, &v57);
                              if ( v60 || (int)v14 <= 0 )
                              {
                                write_string(v15, (unsigned int)v14, v46, &v57);
LABEL_137:
                                v13 = v57;
                              }
                              else
                              {
                                ...
                                {
                                  --v48;
                                  v49 = safecrt_mbtowc(&v63, v47, _mb_cur_max);
                                  v50 = v49;
                                  if ( v49 == 2 )
                                    --v48;
                                  if ( v49 <= 0 )
                                    break;
                                  write_char(v63, v61, &v57);
                                  v47 += v50;
                                  if ( v48 <= 0 )
                                  {
                                    v46 = v61;
                              ...
                              if ( v13 >= 0 && (v7 & 4) != 0 )
                              {
                                write_multi_char(32LL, v45, v46, &v57);
                                v13 = v57;
                              }
                              a2 = v68;
                              v10 = v56;
