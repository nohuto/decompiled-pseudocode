/*
 * XREFs of CmpLightWeightPrepareDeleteValueKeyUoW @ 0x140674D18
 * Callers:
  ...
  if ( TransientPoolWithTag )
  {
    ...
    *TransientPoolWithTag = -1;
    ...
    if ( v8 )
    {
      ...
      v10 = PoolWithTag;
      if ( PoolWithTag
        && (CmpInitializeValueNameString(v8, (__int64)v14, (__int64)PoolWithTag),
            CmpFindNameInList(v4, (int)v1 + 4, (int)v14, 0, (__int64)&v16, (__int64)&BugCheckParameter3)) )
      {
