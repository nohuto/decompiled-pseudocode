/*
 * XREFs of PpmTranslateIdleAccounting @ 0x140233830
 * Callers:
...
unsigned __int64 __fastcall PpmTranslateIdleAccounting(_QWORD *a1, __int64 a2, unsigned __int64 *a3)
{
  ...
  *(_QWORD *)(a2 + 16) = *((_QWORD *)v6 + 2);
  ...
  if ( v8 )
  {
    ...
    {
      v13 += *((_QWORD *)v12 - 104);
      *(_DWORD *)v10 = *(v12 - 206) + *(v12 - 205) + *(v12 - 204);
      *(_DWORD *)(v10 + 4) = *(v12 - 205);
      *(_DWORD *)(v10 + 20) = *(v12 - 206);
      *(_DWORD *)(v10 + 8) = *(v12 - 203);
      *(_QWORD *)(v10 - 8) = PpmConvertTime(*((_QWORD *)v12 - 104), v7, 0xF4240uLL);
      *(_DWORD *)(v10 + 12) = PpmConvertTime(*((_QWORD *)v12 - 101), v7, 0xF4240uLL);
      *(_DWORD *)(v10 + 16) = PpmConvertTime(*((_QWORD *)v12 - 100), v7, 0xF4240uLL);
      v14 = v12 - 130;
      v15 = (_DWORD *)(v10 + 36);
      v16 = 16LL;
      do
