/*
 * XREFs of AdtpPackageParameters @ 0x140155F00
 * Callers:
 *     AdtpWriteToEtwEx @ 0x1402644A4 (AdtpWriteToEtwEx.c)
 *     AdtpWriteToEtw @ 0x1405AB9F4 (AdtpWriteToEtw.c)
 * Callees:
 *     AdtpIsCorrectlyFormedUnicodeString @ 0x1401563E8 (AdtpIsCorrectlyFormedUnicodeString.c)
...
LABEL_35:
          ...
          case 3:
            ...
            goto LABEL_35;
          case 4:
            v56 = *(_QWORD *)(v20 + v14 + 24);
            v57 = 4 * *(unsigned __int8 *)(v56 + 1) + 8;
            if ( *(_DWORD *)(v20 + v14 + 4) < v57 || (valid = RtlValidSid(*(PSID *)(v20 + v14 + 24)), v9 = 0LL, !valid) )
            {
              v12 = -1073741704;
              goto LABEL_39;
            }
            ...
            v15 = 2LL;
            v59 = 2LL * v10++;
            *(_QWORD *)(v17 + 8 * v59) = v56;
            *(_DWORD *)(v17 + 8 * v59 + 8) = v57;
            *(_DWORD *)(v17 + 8 * v59 + 12) = 0;
            goto LABEL_31;
        }
        if ( v21 != 5 )
        {
          if ( v21 == 6 )
          {
            v51 = 2LL * v10;
            v52 = v18 + v10;
            v53 = 4 * (unsigned __int8)byte_1407ACEA1 + 8;
            *(_QWORD *)(v17 + 8 * v51) = v19;
            *(_DWORD *)(v17 + 8 * v51 + 8) = v53;
            *(_DWORD *)(v17 + 8 * v51 + 12) = (_DWORD)v9;
            do
            {
              AdtpEtwBuildDashString(v17 + 16LL * v52, v15, v18);
              v52 += v18;
              v15 = v54 - v18;
            }
            while ( v15 );
            v55 = 2LL * v52;
            v10 = v18 + v52;
            *(_QWORD *)(v17 + 8 * v55) = &AdtpNullLuid;
            *(_QWORD *)(v17 + 8 * v55 + 8) = 8LL;
LABEL_57:
            v15 = 2LL;
            goto LABEL_38;
          }
