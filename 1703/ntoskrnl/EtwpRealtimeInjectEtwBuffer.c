/*
 * XREFs of EtwpRealtimeInjectEtwBuffer @ 0x140550490
 * Callers:
...
__int64 __fastcall EtwpRealtimeInjectEtwBuffer(_DWORD *a1, __int64 a2, __int64 a3)
{
  ...
  $5BC46E0569261879018906DEC3127961 v21; // [rsp+50h] [rbp-48h] BYREF
  ...
  if ( !ExAcquireRundownProtection((PEX_RUNDOWN_REF)(*(_QWORD *)(a2 + 24) + 760LL)) )
    return 3221225738LL;
  ...
  **(_DWORD **)(a2 + 144) = a1[65];
  ...
  ExReleaseRundownProtection((PEX_RUNDOWN_REF)(*(_QWORD *)(a2 + 24) + 760LL));
