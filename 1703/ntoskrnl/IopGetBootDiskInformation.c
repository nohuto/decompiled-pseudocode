/*
 * XREFs of IopGetBootDiskInformation @ 0x140832E04
 * Callers:
 *     IoGetBootDiskInformation @ 0x14068B8B0 (IoGetBootDiskInformation.c)
 * Callees:
...
__int64 __fastcall IopGetBootDiskInformation(__int64 a1, unsigned int a2)
{
  ...
  struct _IO_STATUS_BLOCK v35; // [rsp+A8h] [rbp-60h] BYREF
  ...
  for ( i = 0; v11 < DiskCount; i = v11 )
  {
    ...
    if ( DeviceObjectPointer < 0 )
      goto LABEL_26;
    v13 = DeviceObject;
    v14 = IopBuildDeviceIoControlRequest(458752, (__int64)DeviceObject, 0LL, 0, &v41, 0x18u, 0, &Object, &v35, retaddr);
    if ( !v14 )
      goto LABEL_11;
    ...
    if ( Status >= 0 )
    {
      ...
      for ( j = 4096; ; v16 = j )
      {
        ...
        if ( !PoolWithTag )
          break;
        v18 = IopBuildDeviceIoControlRequest(458832, (__int64)v13, 0LL, 0, PoolWithTag, j, 0, &Object, &v35, retaddr);
        if ( !v18 )
          break;
        KeResetEvent(&Object);
...
LABEL_23:
      ...
      if ( v19 >= 0 )
      {
        ...
        for ( k = *v9; k != v9; k = (_QWORD *)*k )
        {
          ...
          {
            v23 = IopVerifyDiskSignature(PoolWithTag, (__int64)k, &v26);
            v4 = v26;
            if ( !v23 )
              continue;
          }
