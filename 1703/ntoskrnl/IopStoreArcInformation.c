/*
 * XREFs of IopStoreArcInformation @ 0x1407F8A30
 * Callers:
...
__int64 __fastcall IopStoreArcInformation(__int64 a1)
{
  ...
  v4 = 0;
  qword_1407ACC88 = (__int64)&IoArcTableListHead;
  v5 = (_QWORD *)*v1;
  if ( (_QWORD *)*v1 == v1 )
  {
LABEL_17:
    ...
    while ( 1 )
    {
      ...
      *((_QWORD *)v7 + 3) = v11;
      if ( v2 == 1 && v9 >= 9 && !strnicmp(&v11[v9 - 9], "rdisk(0)", 8uLL) )
        *((_BYTE *)v7 + 76) = 1;
      v12 = (_QWORD *)qword_1407ACC88;
      if ( *(PVOID **)qword_1407ACC88 != &IoArcTableListHead )
        __fastfail(3u);
      *(_QWORD *)v7 = &IoArcTableListHead;
      *((_QWORD *)v7 + 1) = v12;
      *v12 = v7;
      qword_1407ACC88 = (__int64)v7;
      v5 = (_QWORD *)*v5;
      if ( v5 == v1 )
      {
        v3 = (PVOID *)IoArcTableListHead;
