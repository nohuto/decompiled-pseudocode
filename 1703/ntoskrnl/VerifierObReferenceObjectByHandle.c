/*
 * XREFs of VerifierObReferenceObjectByHandle @ 0x1407830F0
 * Callers:
 *     <none>
 * Callees:
 *     PsIsSystemThread @ 0x140028760 (PsIsSystemThread.c)
...
__int64 __fastcall VerifierObReferenceObjectByHandle(ULONG_PTR a1, __int64 a2, ULONG_PTR a3, char a4)
{
  ...
  v7 = ((__int64 (__fastcall *)(ULONG_PTR, __int64))pXdvObReferenceObjectByHandle)(a1, a2);
  v8 = v7;
