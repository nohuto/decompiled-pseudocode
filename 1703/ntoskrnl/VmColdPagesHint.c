/*
 * XREFs of VmColdPagesHint @ 0x140251B90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VmpProcessMemoryRangeCompareGpn @ 0x14025252C (VmpProcessMemoryRangeCompareGpn.c)
 */
...
__int64 __fastcall VmColdPagesHint(unsigned __int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v4 = KeGetCurrentThread()->ApcState.Process[2].ActiveProcessors.Bitmap[13];
  if ( !v4 )
