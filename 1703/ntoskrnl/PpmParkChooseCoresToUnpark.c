/*
 * XREFs of PpmParkChooseCoresToUnpark @ 0x140237400
 * Callers:
      ...
      || v13 )
    {
      ...
      else
      {
        ...
        while ( !(unsigned int)KeEnumerateNextProcessor(&v44, v50) )
          v15 |= *(_QWORD *)(KeGetPrcb(v44) + 25176);
      }
      ...
      *a7 |= v9;
      ...
      for ( i = a1 == 0; !i && v23 > (unsigned int)v24; i = v23 == 0 )
      {
        ...
        *a7 &= ~v32;
        ...
        v9 &= ~*(_QWORD *)(*(_QWORD *)(v31 + 192) + 136LL);
        v37 = (void (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))(~*(_QWORD *)(v31 + 8LL * *(unsigned __int8 *)(v31 + 208) + 24864) & v45);
        v22 &= ~*(_QWORD *)(v31 + 25176);
        v45 = (__int64)v37;
        if ( !v9 )
        {
          if ( !v37 )
