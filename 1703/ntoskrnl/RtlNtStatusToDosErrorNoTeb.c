/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x140013E10
 * Callers:
...
ULONG __stdcall RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_1402A0964[8 * v5] )
        {
          v8 = (unsigned __int16)word_1402A0966[4 * v5];
          if ( byte_1402A0965[8 * v5] == 1 )
