/*
 * XREFs of LocalConvertStringSDToSD_Rev1 @ 0x14057F358
 * Callers:
 *     SeConvertStringSecurityDescriptorToSecurityDescriptor @ 0x140143A10 (SeConvertStringSecurityDescriptorToSecurityDescriptor.c)
 * Callees:
