/*
 * XREFs of PspAddSchedulingGroupToJobChain @ 0x1404372D4
 * Callers:
  ...
  if ( a1 )
  {
    while ( (*(_DWORD *)(a1 + 1304) & 0x20) == 0 )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(a1 + 1008) + 40LL) |= 0x40u;
      ...
      if ( !v15 )
      {
        PspFreeRateControl(*(_QWORD *)(a1 + 1008), 2u);
        *(_QWORD *)(a1 + 1008) = 0LL;
LABEL_26:
        while ( 1 )
        {
  ...
  while ( v3 != P )
  {
    v7 = v3[2];
    v8 = *(_QWORD *)(v7 + 1072);
    v9 = (__int64 *)(*(_QWORD *)(v7 + 1008) + 128LL);
    if ( v8 )
    {
    ...
    else
    {
      ...
      if ( PsCpuFairShareEnabled && v10 )
        ObfReferenceObject(*(PVOID *)(v7 + 1112));
    }
