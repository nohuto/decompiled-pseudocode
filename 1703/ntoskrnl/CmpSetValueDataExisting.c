/*
 * XREFs of CmpSetValueDataExisting @ 0x140458748
 * Callers:
...
LABEL_14:
    ...
    if ( (unsigned __int16)v13 > v12 )
    {
      ...
      v30 = 0LL;
      v21 = HvReallocateCell(BugCheckParameter2, v20, (__int64)&v30, (__int64)&v27);
      v11 = v30;
      if ( v21 == -1 )
        goto LABEL_26;
      v22 = *(_WORD *)(v10 + 2);
      *(_DWORD *)(v10 + 4) = v21;
      ...
      {
        Cell = HvAllocateCell(BugCheckParameter2, 16344LL, a4, 0LL, 0LL);
    ...
    else if ( (unsigned __int16)v13 < v12 )
    {
      ...
      v30 = 0LL;
      v26 = HvReallocateCell(BugCheckParameter2, v25, (__int64)&v30, (__int64)&v27);
      v11 = v30;
      if ( v26 == -1 )
        goto LABEL_26;
      *(_DWORD *)(v10 + 4) = v26;
