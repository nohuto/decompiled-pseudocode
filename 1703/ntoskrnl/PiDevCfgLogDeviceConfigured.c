...
void __fastcall PiDevCfgLogDeviceConfigured(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  struct _TIME_FIELDS TimeFields; // [rsp+B0h] [rbp-1D8h] BYREF
  ...
  UNICODE_STRING v120; // [rsp+140h] [rbp-148h] BYREF
  ...
  unsigned int v128[4]; // [rsp+190h] [rbp-F8h] BYREF
  ...
  *(_DWORD *)&v119.Length = 0;
  ...
  if ( a3 )
  {
    ...
    *StringRoutine = 0;
    v39 = *v14;
    TimeFields = (struct _TIME_FIELDS)v38;
    v117 = v39;
    if ( v39 == v14 )
    {
LABEL_18:
...
LABEL_26:
  if ( a3 )
  {
    ...
    if ( v74 )
    {
      ...
      v75 = *v27;
      TimeFields = (struct _TIME_FIELDS)v119;
      v109 = (__int64 **)v75;
      if ( v75 == (__int64 *)v27 )
        goto LABEL_138;
      v76 = a5;
      ...
      while ( 1 )
      {
        ...
        if ( (int)PiDevCfgQueryObjectProperties(v82, (_DWORD)v81, 7, (_DWORD)v80, (__int64)v129, 3) >= 0 )
        {
          ...
          if ( SLODWORD(v129[9]) < 0 || (int)RtlStringFromGUIDEx(v128, (__int64)&v120, 1) < 0 )
