/*
 * XREFs of KdSystemDebugControl @ 0x1406AB880
 * Callers:
 *     <none>
 * Callees:
 *     ExUnlockUserBuffer @ 0x14003C654 (ExUnlockUserBuffer.c)
 *     KdpSysReadIoSpace @ 0x1401FC494 (KdpSysReadIoSpace.c)
 *     KdpSysReadMsr @ 0x1401FC550 (KdpSysReadMsr.c)
 *     KdpSysWriteIoSpace @ 0x1401FC584 (KdpSysWriteIoSpace.c)
 *     KdpSysWriteMsr @ 0x1401FC63C (KdpSysWriteMsr.c)
 *     ExLockUserBuffer @ 0x14055C224 (ExLockUserBuffer.c)
 *     KdpSysCheckLowMemory @ 0x14078B644 (KdpSysCheckLowMemory.c)
 *     KdpSysGetVersion @ 0x14078B664 (KdpSysGetVersion.c)
        ...
        KPROCESSOR_MODE a7)
{
  ...
  struct _MDL *v28; // [rsp+50h] [rbp-128h] BYREF
  ...
  if ( a1 > 14 )
  {
    ...
    if ( !v19 )
    {
      ...
      if ( v26 )
      {
        v15 = ExLockUserBuffer(v39.m128i_u64[1], v26, a7, IoReadAccess, &v27[1], &v28);
        if ( v15 >= 0 )
        {
    ...
    if ( !v22 )
    {
      ...
      if ( v25 )
      {
        v15 = ExLockUserBuffer(v37.m128i_u64[1], v25, a7, IoWriteAccess, &v27[1], &v28);
        if ( v15 >= 0 )
        {
    ...
    if ( !v23 )
    {
      ...
      if ( v24 )
      {
        v15 = ExLockUserBuffer(v35.m128i_u64[1], v24, a7, IoReadAccess, &v27[1], &v28);
        if ( v15 >= 0 )
        {
  ...
  if ( a1 == 14 )
  {
    ...
    if ( v18 )
    {
      v15 = ExLockUserBuffer(v33.m128i_u64[1], v18, a7, IoWriteAccess, &v27[1], &v28);
      if ( v15 >= 0 )
      {
  ...
  if ( !v9 )
  {
    ...
    if ( (_DWORD)v48 )
    {
      v15 = ExLockUserBuffer(v47.m128i_u64[1], v48, a7, IoWriteAccess, &v27[1], &v28);
      if ( v15 >= 0 )
      {
  ...
  if ( !v10 )
  {
    ...
    if ( (_DWORD)v46 )
    {
      v15 = ExLockUserBuffer(v45.m128i_u64[1], v46, a7, IoReadAccess, &v27[1], &v28);
      if ( v15 >= 0 )
      {
  ...
  if ( !v11 )
  {
    ...
    if ( (_DWORD)v44 )
    {
      v15 = ExLockUserBuffer(v43.m128i_u64[1], v44, a7, IoWriteAccess, &v27[1], &v28);
      if ( v15 >= 0 )
      {
  ...
  if ( !v12 )
  {
    ...
    *(__m128i *)BaseAddress = *a2;
    ...
    if ( (_DWORD)v42 )
    {
      v15 = ExLockUserBuffer((unsigned __int64)BaseAddress[1], v42, a7, IoReadAccess, &v27[1], &v28);
      if ( v15 >= 0 )
      {
  ...
  if ( v13 )
  {
    if ( v13 == 1 )
    {
      ...
      if ( (_DWORD)v30 )
      {
        v15 = ExLockUserBuffer(v29.m128i_u64[1], v30, a7, IoReadAccess, &v27[1], &v28);
        if ( v15 >= 0 )
        {
...
LABEL_60:
  ...
  if ( !(_DWORD)v32 )
    goto LABEL_43;
  v15 = ExLockUserBuffer(v31.m128i_u64[1], v32, a7, IoWriteAccess, &v27[1], &v28);
  if ( v15 >= 0 )
  {
