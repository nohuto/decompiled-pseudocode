/*
 * XREFs of MmGetDumpRange @ 0x140213238
 * Callers:
...
char __fastcall MmGetDumpRange(ULONG_PTR BugCheckParameter2, int a2, char a3)
{
  ...
  while ( 1 )
  {
    v13 = v12 < qword_14036C8D8->SizeOfBitMap ? v12 : 0;
    v14 = qword_14036C8D8->SizeOfBitMap - 1;
    v15 = ((__int64)qword_14036C8D8->Buffer & 4) != 0LL ? 0x20 : 0;
    v16 = (char *)qword_14036C8D8->Buffer - (((__int64)qword_14036C8D8->Buffer & 4) != 0 ? 4 : 0);
    while ( 1 )
    {
      v17 = v14 + v15;
      if ( v14 - v13 == -1 )
        goto LABEL_19;
      v19 = &v16[8 * ((unsigned __int64)(v13 + v15) >> 6)];
      for ( j = ~*(_QWORD *)v19 | ((1LL << ((v13 + v15) & 0x3F)) - 1); j == -1; j = ~*(_QWORD *)v19 )
      {
        v19 += 8;
...
LABEL_19:
      ...
      if ( !v13 )
        break;
      SizeOfBitMap = v12 + 1;
      if ( v12 + 1 > qword_14036C8D8->SizeOfBitMap )
    ...
    if ( v23 < v12 || v23 == -1 )
      break;
    v12 = v23 + 1;
    v24 = *(_QWORD *)(qword_14036C8F8 + 8LL * v23);
    if ( (*(_DWORD *)(v24 + 4) & 4) != 0 )
    {
      for ( k = *(_QWORD *)(v24 + 3856); k != 0xFFFFFFFFFLL; k = *(_QWORD *)(48 * k - 0x58000000000LL) & 0xFFFFFFFFFLL )
  ...
  if ( qword_14036C298 )
    LOBYTE(v23) = (unsigned __int8)MiRemoveEnclavePagesFromDump(BugCheckParameter2);
  return v23;
}
