/*
 * XREFs of IopIoRateStartRateControl @ 0x140003BAC
 * Callers:
        ...
        __int64 a7)
{
  ...
  _QWORD v16[3]; // [rsp+58h] [rbp-59h] BYREF
  __int64 v17; // [rsp+70h] [rbp-41h]
  _QWORD v18[2]; // [rsp+78h] [rbp-39h] BYREF
  ...
  if ( ExtensionTable )
  {
    ...
    v11 = *(_QWORD *)(a5 + 24);
    v20[2] = v17 + v19.m128i_i64[0];
    v20[3] = v17 + _mm_srli_si128(v19, 8).m128i_u64[0];
    v20[0] = v16[0] + v18[0];
    v20[1] = v16[1] + v18[1];
