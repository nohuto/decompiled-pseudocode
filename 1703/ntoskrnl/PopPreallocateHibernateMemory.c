/*
 * XREFs of PopPreallocateHibernateMemory @ 0x1405D9F4C
 * Callers:
...
__int64 PopPreallocateHibernateMemory()
{
  ...
  if ( (HvlpFlags & 2) == 0 || (result = HvlpPreallocatePageListResources(), (int)result >= 0) )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        qword_14034B308 = (__int64)(v13 + 4096);
        Length = v11;
        qword_14034B2F0 = v13;
        qword_14034B300 = (__int64)v13;
        if ( dword_140344B30 == 2 )
          qword_14034B358 = (__int64)&v13[v0];
        else
          qword_14034B358 = 0LL;
        LODWORD(xmmword_14034B320) = v4;
        *((_QWORD *)&xmmword_14034B320 + 1) = &v13[v17];
        LODWORD(xmmword_14034B310) = v4;
        *((_QWORD *)&xmmword_14034B310 + 1) = &v13[v18];
        qword_14034B330 = (__int64)&v13[v19];
        if ( dword_140344B30 == 2 )
          qword_14034B360 = (__int64)&v13[v8];
        else
          qword_14034B360 = 0LL;
        qword_14034B338 = &v13[v10];
        qword_14034B340 = &v13[((_DWORD)v10 + 4159) & 0xFFFFF000];
        qword_14034B348 = &v13[v9];
        qword_14034B350 = (__int64)&v13[v6];
        return 0LL;
      }
