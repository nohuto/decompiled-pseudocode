/*
 * XREFs of AuthzBasepEvaluateSetRelationship @ 0x140115DDC
 * Callers:
  ...
  *a3 = 0;
  if ( !a1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *(_WORD *)(a2 + 40) == 4 )
      {
        v5 = AuthzBasepGetNextValue(a2, (__int64)v27);
        if ( v5 < 0 )
          goto LABEL_11;
        v18 = *(_BYTE *)(a2 + 4);
        DWORD2(v23) = 0;
        ...
        v24 = *(_QWORD *)(a2 + 16);
        v25 = *(_DWORD *)(a2 + 8);
        v26 = *(_QWORD *)(a2 + 32) + v16;
      }
      ++v4;
      v5 = AuthzBasepValueInSet(&v23, (__int16 *)(a2 + 40), a3, 0);
      if ( v5 < 0 )
      {
LABEL_11:
        *a3 = -1;
...
LABEL_46:
      ...
      while ( 1 )
      {
        ...
        if ( *(_WORD *)a2 == 4 )
        {
          v5 = AuthzBasepGetNextValue(a2 + 40, (__int64)v27);
          if ( v5 < 0 )
            goto LABEL_11;
          v22 = *(_BYTE *)(a2 + 44);
          DWORD2(v23) = 0;
          ...
          v24 = *(_QWORD *)(a2 + 56);
          v25 = *(_DWORD *)(a2 + 48);
          v26 = *(_QWORD *)(a2 + 72) + v20;
        }
        ++v6;
        v5 = AuthzBasepValueInSet(&v23, (__int16 *)a2, a3, 0);
        if ( v5 < 0 )
          goto LABEL_11;
        if ( *a3 != 1 )
          return (unsigned int)v5;
...
LABEL_43:
  ...
  if ( v8 )
  {
    ...
    while ( 1 )
    {
      ...
      v5 = AuthzBasepValueInSet(&v23, (__int16 *)(a2 + 40), a3, 1);
      if ( v5 < 0 )
        goto LABEL_11;
      if ( *a3 )
        return (unsigned int)v5;
