/*
 * XREFs of PiDmCacheDataEncode @ 0x1404DF6B8
 * Callers:
...
__int64 __fastcall PiDmCacheDataEncode(int a1, __int128 *a2, unsigned int a3, int a4, int a5, __int64 a6)
{
  SIZE_T v6; // r14
  __int128 *v7; // rbp
  unsigned int v9; // edi
  ...
  if ( a2 )
  {
    Object = PiDmGetObject(a5, a2, (__int64 *)(a6 + 16));
    v9 = Object;
