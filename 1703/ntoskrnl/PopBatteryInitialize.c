/*
 * XREFs of PopBatteryInitialize @ 0x1406CA5D0
 * Callers:
...
NTSTATUS __fastcall PopBatteryInitialize(__int64 a1)
{
  ...
  *(_QWORD *)v17 = *(unsigned int *)(a1 + 108);
  PopPrepareIoctl(v2, 0x294044u, 0, (struct _IRP *)v17, 0xCu, 0x24u);
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v7 = (_QWORD *)(a1 + 64);
    v8 = (_QWORD *)qword_14034B3B8;
    if ( *(__int64 **)qword_14034B3B8 != &qword_14034B3B0 )
      __fastfail(3u);
    v7[1] = qword_14034B3B8;
    *v7 = &qword_14034B3B0;
    *v8 = v7;
    ++dword_14034B394;
    ++dword_14034B3F8;
    result = 0;
    qword_14034B3B8 = (__int64)v7;
    byte_14034B398 = 1;
  }
  return result;
}
