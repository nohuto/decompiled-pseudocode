/*
 * XREFs of MiCheckVadSequential @ 0x1400BD3B0
 * Callers:
...
__int64 __fastcall MiCheckVadSequential(__int64 a1)
{
  ...
  *(_DWORD *)a1 = v4;
  ...
  else if ( v1 > v9 && (v10 = (v1 - v9) >> 12, v10 < 8) )
  {
    ...
    if ( (*(_DWORD *)a1 & 0x10) != 0 )
    {
      v16 = ((v1 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000008LL;
      v19 = v16;
      if ( v14 )
      {
        while ( 1 )
...
LABEL_24:
        ...
        if ( (unsigned __int64)(v18 + v7) > 0xFFF )
          v5 = (v6 + ((unsigned __int64)((unsigned int)v18 + (v6 & 0xFFF) - 4095) << 12)) | 0xFFF;
        else
