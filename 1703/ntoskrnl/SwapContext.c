...
/*
 * XREFs of SwapContext @ 0x1401887A0
 * Callers:
...
bool __fastcall SwapContext(unsigned __int8 a1)
{
  ...
  *(_QWORD *)(v1 + 23488) += v5;
  ...
  ++*(_DWORD *)(v1 + 11580);
  v7 = KeFeatureBits;
  KiCheckAndApplyVirtualLittle(v1, v3);
  _RCX = *(_DWORD **)(v2 + 96);
  ...
  *(_QWORD *)(v2 + 88) = v28;
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v2 + 544) + 1064LL) )
    *(_QWORD *)(v2 + 1952) = __readmsr(0xC0000100);
  v11 = *(_QWORD *)(v3 + 544);
  ...
  *(_BYTE *)(v2 + 113) = 0;
  ...
  if ( !_bittest((const signed __int32 *)(v3 + 116), 0xAu) )
  {
    ...
    *(_BYTE *)(v19 + 87) = BYTE1(v20);
    __writemsr(0xC0000100, *(_QWORD *)(v3 + 1952));
