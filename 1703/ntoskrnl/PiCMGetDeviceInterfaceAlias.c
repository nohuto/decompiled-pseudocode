/*
 * XREFs of PiCMGetDeviceInterfaceAlias @ 0x14056BBEC
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  *a6 = 0;
  ...
  if ( inited >= 0 )
  {
    v12 = PiCMReturnBufferResultData(inited, 2 * (int)v10, 0, PoolWithTag, 2 * (int)v10, v20, a3, a4, a6);
    goto LABEL_21;
  }
LABEL_29:
  v12 = PiCMReturnBufferResultData(inited, 2 * (int)v10, 0, 0LL, 0, v20, a3, a4, a6);
LABEL_21:
  inited = v12;
  if ( PoolWithTag )
