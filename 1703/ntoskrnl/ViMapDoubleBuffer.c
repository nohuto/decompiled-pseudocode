/*
 * XREFs of ViMapDoubleBuffer @ 0x14076CA00
 * Callers:
...
__int64 __fastcall ViMapDoubleBuffer(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned int a4, char a5)
{
  ...
  if ( !a4 )
  {
    ViHalPreprocessOptions(byte_1403413B8, "Driver is attempting to map a 0-length transfer.", 33LL, a1, 0LL, 0LL);
    Priority = byte_1403413B8;
    v9 = 0;
...
LABEL_3:
  ...
  {
    v13 = 1;
    ViHalPreprocessOptions(&dword_1403413BC, "Virtual address %p is before the first MDL %p.", 268435487LL, 1LL, a3, a2);
    Priority = (CHAR *)&dword_1403413BC;
    v9 = a3;
...
LABEL_10:
  ...
  {
    ViHalPreprocessOptions(&dword_1403413B0, "Virtual address %p is after the first MDL %p.", 268435487LL, 2LL, a3, a2);
    Priority = (CHAR *)&dword_1403413B0;
    v9 = a3;
    BugCheckOnFailure = a2;
    v10 = 2;
LABEL_11:
  ...
  if ( !(unsigned int)ViAllocateMapRegistersFromFile(a1, v18, v5, a5, &v40) )
    return 0LL;
  v19 = (unsigned int)(v40 << 12) + (v18 & 0xFFF);
  v20 = *(_QWORD *)(a1 + 72);
