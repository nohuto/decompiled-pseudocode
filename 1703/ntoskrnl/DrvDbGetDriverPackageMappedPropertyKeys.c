/*
 * XREFs of DrvDbGetDriverPackageMappedPropertyKeys @ 0x140743484
 * Callers:
  ...
  *(_DWORD *)a6 = 0;
  ...
  if ( CompositeMappedPropertyKeys >= 0 )
  {
    ...
    if ( a3
      || (LOBYTE(pszDest) = 0,
          LODWORD(v37) = 1,
          CompositeMappedPropertyKeys = DrvDbOpenObjectRegKey((__int64)a1, 0LL, 2u, a2, v37, pszDest, Handle, 0LL),
          CompositeMappedPropertyKeys >= 0) )
    {
      v15 = 0;
      v16 = (__int64 *)off_14028EBC0;
      while ( 1 )
      {
        v17 = Handle[0];
        if ( a3 )
