/*
 * XREFs of ExpAcquireFannedOutPushLockExclusive @ 0x14014EFA0
 * Callers:
...
int __fastcall ExpAcquireFannedOutPushLockExclusive(unsigned __int64 a1, _BYTE *a2, ULONG_PTR a3)
{
  unsigned int v3; // esi
