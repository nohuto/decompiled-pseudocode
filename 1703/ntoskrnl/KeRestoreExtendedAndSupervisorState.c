/*
 * XREFs of KeRestoreExtendedAndSupervisorState @ 0x140030B9C
 * Callers:
 *     KeRestoreExtendedProcessorState @ 0x140030B90 (KeRestoreExtendedProcessorState.c)
 ...
 *     XRestoreSHelper @ 0x140189F40 (XRestoreSHelper.c)
 */
