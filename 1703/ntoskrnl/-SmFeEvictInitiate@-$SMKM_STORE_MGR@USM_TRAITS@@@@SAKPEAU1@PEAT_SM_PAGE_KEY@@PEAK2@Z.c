...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmFeEvictInitiate(__int64 a1, unsigned int *a2, int a3, int a4)
{
      ...
      if ( v18->LockState.0 )
      {
        if ( v18 )
        {
          ...
          if ( (__int64)v18->LockState.LockState < 0 )
            KiAbEntryRemoveFromTree((__int64)&v10->LockEntries[v17], v13, SessionId);
          v23[0] = 0;
  ...
  if ( (*((_DWORD *)&v10->0 + 1) & 0x8000) == 0 )
    KeBugCheckEx(0x162u, (ULONG_PTR)v10, (ULONG_PTR)&qword_1403F9BB8, (unsigned int)SessionId, 0LL);
LABEL_17:
