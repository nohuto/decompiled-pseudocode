/*
 * XREFs of MiLockImageSection @ 0x1404B2ED0
 * Callers:
...
__int64 __fastcall MiLockImageSection(
        __int64 a1,
        ...
        unsigned __int64 a4)
{
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v9 != 1 )
        break;
      ExBlockOnAddressPushLock((__int64)&qword_14036C0F0, a2, &v13, 4uLL, 0LL);
      v9 = *a2;
    }
    v10 = v9;
  ...
  if ( v9 < 2 )
  {
    ...
    if ( qword_14036C0F0 )
      ExfUnblockPushLock(&qword_14036C0F0, 0LL);
  }
