/*
 * XREFs of PopProcessorQueryCoordinatedDependencyNotification @ 0x14022D160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopProcessorQueryCoordinatedDependencyNotification(__int64 a1, __int64 a2)
{
  ...
  unsigned int v3; // ebx
  __int64 v4; // rcx
  unsigned __int8 (__fastcall *v6)(__int64, __int64, __int64); // rax
  __int64 v7; // rax
