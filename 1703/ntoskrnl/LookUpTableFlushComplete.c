/*
 * XREFs of LookUpTableFlushComplete @ 0x1405CAEC8
 * Callers:
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( *(_QWORD *)(v5 + 344) )
    {
      if ( stru_14033CC50.LevelPlus1 > 5 && TlgKeywordOn(&stru_14033CC50, 0x400000000000uLL) )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite(&stru_14033CC50, &unk_1402AFAD3, 0LL, 0LL, 0xBu, &pData);
      }
