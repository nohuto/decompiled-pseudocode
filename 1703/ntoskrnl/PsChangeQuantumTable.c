/*
 * XREFs of PsChangeQuantumTable @ 0x1405839EC
 * Callers:
 ...
 *     PspComputeQuantum @ 0x1404A0FC0 (PspComputeQuantum.c)
 */
...
char __fastcall PsChangeQuantumTable(char a1, char a2)
{
  ...
  result = v6[2];
  PspUseJobSchedulingClasses = v6 == byte_14074A25B;
  byte_1407ACD5A = result;
  if ( a1 )
  {
    ...
    {
      v11 = PspComputeQuantum((__int64)(i - 93), *((_BYTE *)i + 730));
