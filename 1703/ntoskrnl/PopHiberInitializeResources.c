/*
 * XREFs of PopHiberInitializeResources @ 0x14057AC78
 * Callers:
...
void __fastcall PopHiberInitializeResources(_QWORD *MemoryMap)
{
  ...
  PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, v27, 0x72626968u);
  if ( !PoolWithTag )
    goto LABEL_23;
...
LABEL_23:
    PoolWithTag = qword_14034B348;
    v1 = 1;
    v20 = 1;
    v7 = 1;
    memset(qword_14034B348, 0, 0x80uLL);
    v21 = 12288;
    PoolWithTag[1] = xmmword_14034B2C8;
    v19 = qword_14034B340;
    v12 = (char *)qword_14034B340;
    goto LABEL_21;
  }
  if ( PopHiberChecksummingEnabledReg )
  {
  ...
  if ( v1 )
  {
    ...
    do
    {
      v17 = (char *)&PoolWithTag[0x4000 * v13] + v14;
      *(v15 - 1) = v17;
      v15[2] = v17 + 0x10000;
      *v15 = DumpHibernateResources + (v13 << 16);
      if ( CompressBufferWorkSpaceSize )
        v15[1] = (char *)PoolWithTag + v16 + v13 * CompressBufferWorkSpaceSize;
      ++v13;
      v15 += 16;
    }
    while ( v13 < v1 );
