/*
 * XREFs of SepAdtAuditPrivilegeUseWithContext @ 0x14046C750
 * Callers:
 ...
 *     SepAdtCheckPrivilegeForSensitivity @ 0x140247634 (SepAdtCheckPrivilegeForSensitivity.c)
        ...
        _WORD *a5)
{
  ...
  if ( !v9 && !v10 || !SepFilterPrivilegeAudits(0, a1) )
    return 0;
