/*
 * XREFs of RtlpNameprepAsciiWorker @ 0x1406EC0CC
 * Callers:
 *     RtlIdnToAscii @ 0x1406EBD50 (RtlIdnToAscii.c)
 *     RtlIdnToNameprepUnicode @ 0x1406EBD80 (RtlIdnToNameprepUnicode.c)
 * Callees:
...
LABEL_47:
              ...
              result = punycode_encode(DestinationString, v29, v12);
...
LABEL_73:
            ...
            v21 = RtlNormalizeString(v28 != 0 ? 13 : 269, &a2[v15], v8 - v15, v16, &DestinationStringLength);
            v20 = v21;
