/*
 * XREFs of HvWriteExternal @ 0x14066CD24
 * Callers:
...
__int64 __fastcall HvWriteExternal(ULONG_PTR BugCheckParameter2)
{
  ...
  v37 = v6;
  result = CmpDoFileSetSizeEx(BugCheckParameter2, 2LL, v6 + 4096, 0);
  v7 = result;
  if ( (int)result >= 0 )
  {
    v8 = 0;
    if ( v6 )
    {
      while ( 1 )
      {
        ...
        v4 = CellMap;
        if ( !CellMap )
          KeBugCheckEx(0x51u, 1uLL, BugCheckParameter2, v8, 0xB59uLL);
...
LABEL_40:
    ...
    while ( 1 )
    {
      ...
      v4 = v25;
      if ( !v25 )
        KeBugCheckEx(0x51u, 1uLL, BugCheckParameter2, v24, 0xBC2uLL);
