/*
 * XREFs of BgpDisplayCharacterEx @ 0x140266350
 * Callers:
 ...
 *     BgpConsoleDrawCursor @ 0x14075A2B8 (BgpConsoleDrawCursor.c)
 *     BgpConsoleScrollScreen @ 0x14075A450 (BgpConsoleScrollScreen.c)
 * Callees:
