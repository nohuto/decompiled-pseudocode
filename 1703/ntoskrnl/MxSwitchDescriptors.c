/*
 * XREFs of MxSwitchDescriptors @ 0x140835120
 * Callers:
 *     MxGetNextPage @ 0x14080182C (MxGetNextPage.c)
 * Callees:
 *     MiPageToNode @ 0x1400B70B0 (MiPageToNode.c)
 *     MiInitializeBootMemoryDescriptor @ 0x140801A8C (MiInitializeBootMemoryDescriptor.c)
 */
...
unsigned __int64 *__fastcall MxSwitchDescriptors(unsigned int a1)
{
  ...
  v5 = (unsigned __int64 *)&qword_1407C84E0[5 * a1];
  while ( 2 )
  {
    v6 = v5[4];
    if ( !v6 )
...
LABEL_14:
      ...
      if ( v7 == 2 || v7 == 24 )
      {
        ...
        {
          if ( (unsigned int)MiPageToNode(*(_QWORD *)(v6 + 24), 0LL) == (_DWORD)v3
