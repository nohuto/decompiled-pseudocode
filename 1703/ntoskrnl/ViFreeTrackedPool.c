/*
 * XREFs of ViFreeTrackedPool @ 0x14076481C
 * Callers:
...
signed __int64 __fastcall ViFreeTrackedPool(__int64 a1, __int64 a2, char a3, int a4)
{
  __int64 v5; // rbx
  ...
  if ( (*v8 & 3) != 0 || !MiIsAddressValid(*v8) )
    VerifierBugCheckIfAppropriate(0xC4u, (ULONG_PTR)v8);
  ...
  if ( (v10 & 3) != 0 || !MiIsAddressValid(v10 + 40) )
    VerifierBugCheckIfAppropriate(0xC4u, (v9 & 0xFFFFFFFFFFFFF000uLL) + 8);
  if ( *(_QWORD *)(v10 + 40) != 2557876544LL )
    VerifierBugCheckIfAppropriate(0xC4u, 0x98761940uLL);
  if ( *(_QWORD *)v9 != a1 )
    VerifierBugCheckIfAppropriate(0xC4u, v9);
  if ( *(_QWORD *)(v9 + 16) != v5 )
    VerifierBugCheckIfAppropriate(0xC4u, v9 + 16);
  *(_QWORD *)(v9 + 16) |= 1uLL;
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    _InterlockedExchangeAdd64(&qword_14034F6B0, v11);
    _InterlockedDecrement(&dword_14034F6A0);
  }
  else
  {
    result = _InterlockedExchangeAdd64((volatile signed __int64 *)(v10 + 104), v11);
    _InterlockedDecrement((volatile signed __int32 *)(v10 + 84));
    _InterlockedExchangeAdd64(&qword_14034F6B8, v11);
    _InterlockedDecrement(&dword_14034F6A4);
  }
  return result;
}
