/*
 * XREFs of RtlUnicodeStringCat @ 0x140026D10
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker @ 0x140026E00 (RtlUnicodeStringValidateWorker.c)
 */
...
NTSTATUS __stdcall RtlUnicodeStringCat(PUNICODE_STRING DestinationString, PCUNICODE_STRING SourceString)
{
  ...
  v5 = 0LL;
  v6 = 0LL;
  v10 = RtlUnicodeStringValidateWorker(DestinationString, (const size_t)SourceString, v2);
  if ( v10 >= 0 )
  {
    if ( v8 )
    {
    ...
    Buffer = 0LL;
    v12 = 0LL;
    v10 = RtlUnicodeStringValidateWorker(SourceString, v7, v9);
    if ( v10 >= 0 )
    {
      if ( SourceString )
      {
