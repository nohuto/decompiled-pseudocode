/*
 * XREFs of CmpRegisterCallbackInternal @ 0x1405D2288
 * Callers:
 *     CmRegisterCallback @ 0x1405D2260 (CmRegisterCallback.c)
 *     CmRegisterCallbackEx @ 0x1406602C0 (CmRegisterCallbackEx.c)
