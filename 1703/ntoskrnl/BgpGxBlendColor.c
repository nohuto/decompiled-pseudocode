/*
 * XREFs of BgpGxBlendColor @ 0x1401412B0
 * Callers:
...
__int64 __fastcall BgpGxBlendColor(int a1, int a2, unsigned __int8 a3)
{
  ...
  v3 = 255 - a3;
  HIWORD(v5) = (unsigned __int8)(a3 * (unsigned int)BYTE2(a2) / 0xFF + v3 * BYTE2(a1) / 255);
  BYTE1(v5) = a3 * (unsigned int)BYTE1(a2) / 0xFF - (-1 - a3) * BYTE1(a1);
