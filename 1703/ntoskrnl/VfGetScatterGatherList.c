/*
 * XREFs of VfGetScatterGatherList @ 0x140769FC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 VfGetScatterGatherList(__int64 a1, __int64 a2, ...)
{
  ...
  __int64 (__fastcall *v35)(__int64, __int64, __int64, __int64, unsigned int, __int64 (__fastcall *)(), __int64, _BYTE); // [rsp+58h] [rbp-10h]
  ...
  LOBYTE(v8) = 1;
  v35 = (__int64 (__fastcall *)(__int64, __int64, __int64, __int64, unsigned int, __int64 (__fastcall *)(), __int64, _BYTE))RealDmaOperation;
  ...
  if ( *(_DWORD *)(v11 + 192) == 3 )
  {
    ...
    if ( v13 )
    {
      ...
      ViHalPreprocessOptions(
        ...
        0LL,
        0LL);
      VfReportIssueWithOptions(0xE6u, 36, v14, 0, 0LL, byte_1403413C8);
    }
  }
