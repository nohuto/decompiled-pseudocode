/*
 * XREFs of MiMakeIoRangePermanent @ 0x140211F64
 * Callers:
...
__int64 __fastcall MiMakeIoRangePermanent(unsigned __int64 a1)
{
  ...
  do
  {
    for ( i = (_QWORD *)qword_14036CE10; ; i = (_QWORD *)i[1] )
    {
      while ( 1 )
      {
        if ( !i )
        {
          v15 = MiRemoveUnmappedIoNode((unsigned __int64 *)&qword_14036CE18, v1);
          v16 = v15;
          if ( !v15 )
          {
            v17 = v1 & 0x1FF;
...
LABEL_39:
  ...
  v23 = 0;
LABEL_42:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_14036CE60, (unsigned __int64)v22, v23, v3);
LABEL_43:
