/*
 * XREFs of CmSetKeyFlags @ 0x1406645C4
 * Callers:
  ...
  for ( i = 0; ; i = 1 )
  {
    ...
    if ( *(_QWORD *)(a1 + 56) || *(_QWORD *)(a1 + 64) )
    {
      if ( CmpIsKeyDeletedForKeyBody(a1, v27) )
        goto LABEL_53;
      v5 = CmpTransSearchAddTransFromKeyBody(a1, &v27);
      if ( v5 < 0 )
        goto LABEL_59;
...
LABEL_59:
      ...
      if ( v5 >= 0 )
      {
        if ( CmpLockIXLockIntent((unsigned int *)(v11 + 240), v6) && CmpLockIXLockExclusive(v11 + 256, (_QWORD *)v6, 1) )
        {
          *(_DWORD *)(v6 + 68) = 7;
          *(_DWORD *)(v6 + 88) = a3;
