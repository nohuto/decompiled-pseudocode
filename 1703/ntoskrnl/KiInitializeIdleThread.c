/*
 * XREFs of KiInitializeIdleThread @ 0x140411BB0
 * Callers:
...
unsigned __int64 __fastcall KiInitializeIdleThread(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_BYTE *)(a1 + 195) = 127;
  if ( !*(_DWORD *)(a4 + 36) )
  {
    qword_1403FAE50 = (__int64)&qword_1403FAE48;
    qword_1403FAE48 = (__int64)&qword_1403FAE48;
  }
  *(_QWORD *)(a1 + 1816) = a1 + 1808;
  *(_QWORD *)(a1 + 1808) = a1 + 1808;
  *(_QWORD *)(a1 + 1832) = a1 + 1824;
  *(_QWORD *)(a1 + 1824) = a1 + 1824;
  *(_QWORD *)(a1 + 1840) = 0LL;
  v8 = (_QWORD *)(a1 + 1696);
  v9 = (_QWORD *)qword_1403FAE50;
  if ( *(__int64 **)qword_1403FAE50 != &qword_1403FAE48 )
    __fastfail(3u);
  *v8 = &qword_1403FAE48;
  v8[1] = v9;
  *v9 = v8;
  qword_1403FAE50 = (__int64)v8;
