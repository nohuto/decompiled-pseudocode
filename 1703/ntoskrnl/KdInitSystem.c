/*
 * XREFs of KdInitSystem @ 0x140789150
 * Callers:
 ...
 *     MmGetPagedPoolCommitPointer @ 0x14003CCA8 (MmGetPagedPoolCommitPointer.c)
...
LABEL_25:
  ...
  if ( !KdpDebuggerDataListHead )
  {
    *((_QWORD *)&KdpContext + 1) = KdDebugDevice;
    qword_14033BA80 = (__int64)MmGetPagedPoolCommitPointer();
    KdpPowerSpinLock = 0LL;
    qword_140365218 = (__int64)&KdpPowerListHead;
    KdpPowerListHead = (__int64)&KdpPowerListHead;
    qword_140365208 = (__int64)&KdpDebuggerDataListHead;
    ...
    *((_QWORD *)&xmmword_14033E100 + 1) = &PsLoadedModuleList;
    LODWORD(KdVersionBlock) = 987168783;
    *(_WORD *)((char *)&KdVersionBlock + 11) = 13059;
    qword_14033E110 = (__int64)&KdpDebuggerDataListHead;
  }
  ...
  if ( a2 )
  {
    ...
    off_14033BBE8 = &KdpLoaderDebuggerBlock;
    KdpLoaderDebuggerBlock = a2 + 16;
    v9 = *(char **)(a2 + 216);
    *(_QWORD *)&xmmword_14033E100 = v8;
    if ( !v9 )
    {
      KdPitchDebugger = 1;
      v10 = 0;
  ...
  {
    *(_QWORD *)&xmmword_14033E100 = PsNtosImageBase;
  }
  v10 = 1;
LABEL_19:
  Base = (PVOID)xmmword_14033E100;
  if ( !v5 )
  {
