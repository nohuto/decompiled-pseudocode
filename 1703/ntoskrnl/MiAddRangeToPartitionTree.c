/*
 * XREFs of MiAddRangeToPartitionTree @ 0x14021D2DC
 * Callers:
...
LABEL_8:
    ...
    if ( v9 )
    {
      ...
      v14 = (__int64)(v9 + 4);
      v19 = v9[3];
      if ( v19 < 0x8000000000000000uLL || a4 != 1 )
...
LABEL_9:
    ...
    if ( PoolWithTag )
    {
      ...
      if ( v13 )
      {
        ...
        PoolWithTag[5] = (unsigned __int64)v13;
        v15 = PoolWithTag + 3;
        ...
        if ( *a1 )
        {
          while ( 1 )
          {
            if ( (*v15 & 0x7FFFFFFFFFFFFFFFLL) < (v16[3] & 0x7FFFFFFFFFFFFFFFuLL) )
            {
              v18 = (_QWORD *)*v16;
              if ( !*v16 )
              {
