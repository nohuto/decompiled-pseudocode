/*
 * XREFs of IopSymlinkAllocateAndAddECP @ 0x14057C1B0
 * Callers:
 ...
 * Callees:
 *     IoClearIrpExtraCreateParameter @ 0x1401F38A0 (IoClearIrpExtraCreateParameter.c)
 *     IoGetIrpExtraCreateParameter @ 0x140428960 (IoGetIrpExtraCreateParameter.c)
 *     IoSetIrpExtraCreateParameter @ 0x140435DA0 (IoSetIrpExtraCreateParameter.c)
