/*
 * XREFs of SiGetSystemDeviceName @ 0x14056951C
 * Callers:
 *     SyspartDirectGetSystemPartition @ 0x140569500 (SyspartDirectGetSystemPartition.c)
 *     SyspartGetSystemPartition @ 0x1405895F8 (SyspartGetSystemPartition.c)
 *     SyspartDirectGetSystemDisk @ 0x14059A7A0 (SyspartDirectGetSystemDisk.c)
