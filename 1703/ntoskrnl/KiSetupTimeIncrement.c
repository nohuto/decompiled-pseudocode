/*
 * XREFs of KiSetupTimeIncrement @ 0x140160B1C
 * Callers:
 *     KeInitializeClock @ 0x140819AAC (KeInitializeClock.c)
 * Callees:
 *     RtlGenerateQpcToIncrementConstants @ 0x140160C54 (RtlGenerateQpcToIncrementConstants.c)
...
__int64 __fastcall KiSetupTimeIncrement(unsigned __int64 a1, unsigned int a2)
{
  ...
  KeTimeAdjustment = v5;
  KiTickOffset = v5;
  KiMaximumIncrementReciprocal = RtlpComputeFraction(1LL, v5, &v12);
