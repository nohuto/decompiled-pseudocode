/*
 * XREFs of MiSessionRemoveImage @ 0x140149B04
 * Callers:
...
__int64 __fastcall MiSessionRemoveImage(ULONG_PTR BugCheckParameter2, _QWORD *a2)
{
  ...
  _QWORD *i; // rcx
  _QWORD *k; // rcx
  __int64 v24[14]; // [rsp+30h] [rbp-98h] BYREF
  ...
  *a2 = 0LL;
  ...
  __writecr8(v25);
  MiUnlockWorkingSetExclusive(v6 + 3008, v9);
  if ( !v5 )
    return 0LL;
  if ( *(_BYTE *)(v11 + 65) == 1 )
    MiReturnCrossPartitionControlAreaCharges(*(_QWORD *)(v11 + 80));
  v24[0] = *(_QWORD *)(v11 + 80);
  MiManageSubsectionView(v24, (_QWORD *)(v11 + 24), 4);
  a2[2] = *(_QWORD *)(v11 + 72);
  if ( *(_BYTE *)(v11 + 64) == 1 )
