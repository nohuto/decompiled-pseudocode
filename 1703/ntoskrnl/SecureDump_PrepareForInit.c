/*
 * XREFs of SecureDump_PrepareForInit @ 0x14015A094
 * Callers:
...
void __fastcall SecureDump_PrepareForInit(__int64 a1, _BYTE *a2)
{
  ...
  if ( !a2 )
    return;
  *a2 = 0;
  memset(&dword_14036BC18, 0, 0x28uLL);
      ...
      if ( v5 >= 0 )
      {
        ...
        if ( !dword_14036BC1C
          ...
          && (int)SecureDump_ReadRegistry(
                    ...
                    1,
                    (unsigned int)&qword_14036BC30,
                    (__int64)&dword_14036BC38) >= 0 )
        {
          ForceDumpDisabled = 0;
          goto LABEL_8;
        }
