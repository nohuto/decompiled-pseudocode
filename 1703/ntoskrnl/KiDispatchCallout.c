/*
 * XREFs of KiDispatchCallout @ 0x14003C180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KiDispatchCallout(__int64 a1, __int64 a2, __int64 a3, __int64 *a4)
{
  ...
  *(_QWORD *)(a1 + 56) = v4 ^ (unsigned __int64)&retaddr;
  ...
  while ( v6 < 0x19 );
  v25 = *(_QWORD *)v10 ^ 0x85131481131482ELL;
  *(_DWORD *)v10 = -1390710795;
  *(_DWORD *)v10 ^= 0xBC2A27DB;
  ((void (__fastcall *)(unsigned __int64, __int64, _QWORD, _QWORD))v10)(v10, v25, 0LL, 0LL);
  result = CurrentIrql;
