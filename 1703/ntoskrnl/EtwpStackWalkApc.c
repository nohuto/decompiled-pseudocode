/*
 * XREFs of EtwpStackWalkApc @ 0x140256E30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EtwpStackWalkApc(PSLIST_ENTRY ListEntry, _QWORD *a2, unsigned int *a3, int *a4, int *a5)
{
  ...
  v10 = *(_QWORD *)(KeGetPrcb((ULONG)ListEntry[6].Next) + 24784);
  RtlpInterlockedPushEntrySList((PSLIST_HEADER)(v10 + 96), ListEntry);
  ...
  _InterlockedDecrement((volatile signed __int32 *)(v10 + 1456));
  *a2 = 0LL;
  return result;
}
