/*
 * XREFs of PfSnAsyncPrefetchWorker @ 0x140464FF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PfSnAsyncPrefetchWorker(PVOID P)
{
  ...
  $5BC46E0569261879018906DEC3127961 v16; // [rsp+B8h] [rbp-9h] BYREF
      ...
      if ( PoolWithTag )
      {
        ...
        *(_DWORD *)(v15[1] + 56LL) = 15;
        if ( (int)PfpPrefetchSharedStart(v15[1]) >= 0 && (int)PfSnOpenVolumesForPrefetch(v15, v14) >= 0 )
        {
          ...
          {
            _InterlockedExchange((volatile __int32 *)(*((_QWORD *)P + 27) + 1824LL), 5000);
...
LABEL_21:
  _InterlockedExchange((volatile __int32 *)(*((_QWORD *)P + 27) + 1824LL), 0);
  v12 = *((_QWORD *)P + 28);
  if ( v12 )
  {
