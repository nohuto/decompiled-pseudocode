/*
 * XREFs of PiUEventProcessBroadcastNotifications @ 0x140464A2C
 * Callers:
...
LABEL_19:
  ...
  if ( v5 )
  {
    ...
    if ( !v6 )
    {
      ...
      if ( v13 )
        return (unsigned int)ObjectProperty;
      v27 = ExAllocatePoolWithTag(PagedPool, 0x1C0uLL, 0x59706E50u);
      v28 = v27;
      if ( v27 )
      {
...
LABEL_32:
    ...
    if ( !v21 )
    {
      v29 = (char *)ExAllocatePoolWithTag(PagedPool, 0x1C0uLL, 0x59706E50u);
      v18 = v29;
      if ( !v29 )
        return (unsigned int)-1073741670;
      memset(v29, 0, 0x1C0uLL);
