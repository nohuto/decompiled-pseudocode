/*
 * XREFs of WheaWmiDispatch @ 0x140166DC0
 * Callers:
 *     <none>
 * Callees:
 *     WheapWmiExecuteMethod @ 0x140260CB4 (WheapWmiExecuteMethod.c)
 *     WheapWmiGetAllData @ 0x140260ED0 (WheapWmiGetAllData.c)
 *     WheapWmiGetSingleInstance @ 0x140260F30 (WheapWmiGetSingleInstance.c)
 */
