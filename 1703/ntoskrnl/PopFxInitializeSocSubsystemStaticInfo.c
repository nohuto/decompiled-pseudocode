/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x1406C7904
 * Callers:
...
LABEL_18:
      ...
      if ( v3 )
        goto LABEL_29;
      v20 = (_QWORD *)qword_14034C2C8;
      if ( *(__int64 **)qword_14034C2C8 != &SocSubsystemsList )
        __fastfail(3u);
      *v5 = &SocSubsystemsList;
      v5[1] = v20;
      *v20 = v5;
      qword_14034C2C8 = (__int64)v5;
    }
    else
    {
