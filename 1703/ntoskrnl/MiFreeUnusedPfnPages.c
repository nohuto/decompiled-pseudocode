...
__int64 __fastcall MiFreeUnusedPfnPages(ULONG_PTR *a1)
{
  ...
  SIZE_T v53; // [rsp+30h] [rbp-59h]
  unsigned int v54; // [rsp+40h] [rbp-49h] BYREF
  __int64 v55; // [rsp+48h] [rbp-41h] BYREF
  char *AnyMultiplexedVm; // [rsp+50h] [rbp-39h]
  struct _KTHREAD *CurrentThread; // [rsp+58h] [rbp-31h]
  ULONG_PTR *v58; // [rsp+60h] [rbp-29h]
  ULONG_PTR v59; // [rsp+68h] [rbp-21h] BYREF
  __int16 v60; // [rsp+70h] [rbp-19h] BYREF
  char v61; // [rsp+72h] [rbp-17h]
  int v62; // [rsp+74h] [rbp-15h]
  _QWORD v63[2]; // [rsp+78h] [rbp-11h] BYREF
  PVOID Source; // [rsp+88h] [rbp-1h]
  unsigned __int64 v65; // [rsp+90h] [rbp+7h]
  ULONG_PTR *v66; // [rsp+98h] [rbp+Fh]
  __int64 v68; // [rsp+F0h] [rbp+67h]
  KIRQL v69; // [rsp+F8h] [rbp+6Fh]
  int v70; // [rsp+100h] [rbp+77h] BYREF
  int v71; // [rsp+108h] [rbp+7Fh] BYREF
  ...
  while ( 1 )
  {
    v52 = (v5 & ((unsigned __int64)(48 * qword_14036C290 - 0x57FFFFFFFD0LL) >> 9)) + v6;
    v7 = v52 - 8;
    v65 = v52 - 8;
    ...
    if ( !v2 && *((_BYTE *)v1 + 236) == 1 )
    {
      ...
      LODWORD(v25) = ((char)v21->AbEntrySummary | (char)v21->AbOrphanedEntrySummary) ^ 0x3F;
      while ( 1 )
      {
        v14 = !_BitScanReverse((unsigned int *)&v26, v25);
        if ( v14 )
          break;
        v27 = 1 << v26;
        v28 = v26;
        ...
        if ( (v29->AcquiredByte & 1) != 0
          ...
          && (*(_QWORD *)&v29->LockState.0 & 0x7FFFFFFFFFFFFFFCLL) == v24
          ...
          if ( v29->LockState.0 )
          {
            if ( v29 )
            {
              ...
              if ( (__int64)v29->LockState.LockState < 0 )
                KiAbEntryRemoveFromTree((__int64)&v21->LockEntries[v28], v25, v24);
              v71 = 0;
              v71 = v29->BoostBitmap.AllFields & 0x1FFFF;
...
LABEL_52:
      ...
      KiAbThreadRemoveBoosts(&v21->Header.Lock, v4, (unsigned int *)&v71);
      v32 = v21->SpecialApcDisable + 1;
      v21->SpecialApcDisable = v32;
      if ( !v32 && ($69CD3F157F9F39B6F7113F2231989901 *)v21->ApcState.ApcListHead[0].Flink != &v21->152 )
        KiCheckForKernelApcDelivery(v31);
      return KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
    }
    SharedVm = MiGetSharedVm((__int64)AnyMultiplexedVm);
    v69 = ExAcquireSpinLockExclusive(SharedVm);
    SharedVm[1] = 0;
    ...
    __writecr8(2uLL);
    MiUnlockWorkingSetExclusive((__int64)AnyMultiplexedVm, v69);
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)v4, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)v4);
    v70 = 0;
        ...
        *(_BYTE *)(v16 + 26) &= ~1u;
        if ( *(_QWORD *)(v16 + 32) )
        {
          if ( v16 )
          {
            *(_BYTE *)(v16 + 32) |= 2u;
            if ( *(__int64 *)(v16 + 32) < 0 )
              KiAbEntryRemoveFromTree(v16, v11, v13);
            v70 = 0;
            v70 = *(_DWORD *)(v16 + 88) & 0x1FFFF;
...
LABEL_27:
    ...
    KiAbThreadRemoveBoosts(&v10->Header.Lock, v4, (unsigned int *)&v70);
    ...
    if ( !a1 )
      return result;
    KeWaitForGate((__int64)&v60, 0x12u);
    v1 = v58;
    v5 = 0x7FFFFFFFF8LL;
  ...
  if ( v3 <= v7 )
  {
    ...
    {
      LOBYTE(v9) = 17;
      NextPageTable = MiGetNextPageTable(v3, v7, 0LL, v9, 7, &v54);
      v34 = NextPageTable;
      if ( !NextPageTable )
        goto LABEL_100;
      if ( v54 )
      {
        ...
        v37 = (__int64)(v7 - NextPageTable) >> 3;
        v38 = NextPageTable;
        if ( i >> 12 > v37 + 1 )
          i = (v37 + 1) << 12;
      }
      else
      {
        ...
        while ( 1 )
        {
          v55 = MI_READ_PTE_LOCK_FREE(v3);
          if ( (v55 & 1) != 0 )
          {
            if ( v9 == v39 )
              break;
            v40 = MI_READ_PTE_LOCK_FREE(&v55);
            if ( ((v40 >> 12) & 0xFFFFFFFFFLL) != v9 )
              break;
          }
          v3 += 8LL;
          if ( v3 > v7 )
        ...
        for ( i = 4096LL; v41 <= v7; i += 4096LL )
        {
          ...
          if ( v9 != v43 )
          {
            v44 = MI_GET_PAGE_FRAME_FROM_PTE(&v55);
            if ( v44 == v9 )
              break;
          }
        }
      ...
      do
      {
        if ( *(_QWORD *)v45 )
          goto LABEL_96;
        v46 = RtlCompareMemoryUlong((PVOID)v45, i, 0);
        v53 = v46;
        if ( v46 < 0x1000 )
        {
          if ( v46 )
...
LABEL_96:
        ...
        v49 = (char *)(v45 + (v53 & 0xFFFFFFFFFFFFF000uLL));
        v50 = (char *)(48 * ((__int64)(v49 + 0x58000000000LL) / 48) - 0x58000000000LL);
        Source = v50;
        if ( v50 != v49 && (!MiIsAddressValid((__int64)(v50 + 48)) || RtlCompareMemoryUlong(Source, 0x30uLL, 0) != 48) )
          v49 -= 4096;
        MiPfnRangeIsZero(v68, v49);
        v46 = v53;
LABEL_97:
        v51 = (v46 + 4095) & 0xFFFFFFFFFFFFF000uLL;
        v45 += v51;
        i -= v51;
      }
      while ( i >= 0x1000 );
