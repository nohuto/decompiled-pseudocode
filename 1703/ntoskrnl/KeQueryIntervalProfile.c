/*
 * XREFs of KeQueryIntervalProfile @ 0x14056DB38
 * Callers:
 *     NtQueryIntervalProfile @ 0x14056DAD4 (NtQueryIntervalProfile.c)
...
__int64 __fastcall KeQueryIntervalProfile(int a1)
{
  ...
  v2 = a1;
  if ( ((int (__fastcall *)(__int64, __int64, int *, char *))off_14033C718[0])(1LL, 24LL, &v2, &v5) >= 0 && v3 )
    return v4;
  else
    return 0LL;
}
