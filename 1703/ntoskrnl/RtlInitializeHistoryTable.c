/*
 * XREFs of RtlInitializeHistoryTable @ 0x140820C2C
 * Callers:
 *     MiInitSystem @ 0x1408032EC (MiInitSystem.c)
 * Callees:
 *     RtlLookupFunctionEntry @ 0x14000A970 (RtlLookupFunctionEntry.c)
 *     RtlpFunctionAddressTableEntry @ 0x140820D14 (RtlpFunctionAddressTableEntry.c)
 */
...
PRUNTIME_FUNCTION RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v3 + 8] = v2;
    if ( v4 < qword_1403F8918 )
      qword_1403F8918 = v4;
    if ( v5 > qword_1403F8920 )
      qword_1403F8920 = v5;
  }
