/*
 * XREFs of IopConnectInterrupt @ 0x14058887C
 * Callers:
        ...
        __int64 a10)
{
  ...
  *a1 = 0LL;
  ...
  v38 = v11;
  v35 = v12;
  v13 = qword_1403E42B8[(unsigned __int16)_mm_extract_epi16(v11, 4)] & v11.m128i_i64[0];
  v50 = *(_BYTE *)(a10 + 16);
  v38.m128i_i64[0] = v13;
  if ( !*(_DWORD *)(a10 + 8)
    && !((unsigned __int8 (__fastcall *)(_QWORD, _QWORD))off_14033B490[0])(0LL, *(unsigned int *)(a10 + 64))
        ...
        (_BYTE)v15) )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *((_QWORD *)v17 + 1) = v13;
      ...
      v24 = KeConnectInterrupt((__int64 *)v17 + 58, v15, (__int64)(v17 + 16));
      if ( v42 )
