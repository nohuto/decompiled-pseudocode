/*
 * XREFs of PpmInfoAdjustSetting @ 0x1404C23F0
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x1404C13FC (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x140152938 (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x1404C24B0 (PpmInfoWriteData.c)
 */
