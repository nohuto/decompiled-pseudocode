/*
 * XREFs of MiWalkPageTables @ 0x1400D7BB0
 * Callers:
 ...
 *     MiInitializeWalkBounds @ 0x1400D80B0 (MiInitializeWalkBounds.c)
...
__int64 __fastcall MiWalkPageTables(__int64 a1)
{
  ...
  if ( !*(_BYTE *)(a1 + 6) )
    *(_BYTE *)(a1 + 6) = 15;
  v34 = *(void (__fastcall **)(__int64))(a1 + 128);
  *(_QWORD *)(a1 + 40) = *(_QWORD *)(qword_14036C8F8 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 172LL));
  v2 = *(_QWORD *)(a1 + 32);
  if ( v2 )
  {
        ...
        if ( v14 <= v18 )
        {
          ...
          if ( v15 >= v19 )
          {
            ...
            *(_QWORD *)(a1 + 88) = v25;
            v26 = v7 + (v8 & (v24 >> 9));
            *(_QWORD *)(a1 + 96) = v26;
            *(_QWORD *)(a1 + 104) = v7 + (v8 & (v25 >> 9));
            v12 = MiWalkPageTablesRecursively((unsigned int *)a1, v26, 3u);
            if ( v34 )
              v34(a1);
            if ( v12 - 2 <= 1 )
              return v12;
