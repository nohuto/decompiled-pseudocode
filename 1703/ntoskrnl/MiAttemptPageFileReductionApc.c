/*
 * XREFs of MiAttemptPageFileReductionApc @ 0x1402196E0
 * Callers:
 *     <none>
 * Callees:
 *     RtlFindLastBackwardRunClear @ 0x1400230E0 (RtlFindLastBackwardRunClear.c)
...
LONG __fastcall MiAttemptPageFileReductionApc(struct _KEVENT *a1)
{
  ...
  if ( Flink >= 0x10 )
  {
    LOBYTE(v7) = MiOkToShrinkPageFiles(*(_QWORD *)(v2 + 6128), *(_QWORD *)(v2 + 6248));
    if ( !v7 )
...
LABEL_35:
            ...
            *(_QWORD *)v13 = v29;
            ...
            {
              if ( !(unsigned int)MiChargeCommit(v2, LastBackwardRunClear + v39, 2uLL) )
              {
                KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v13 + 232), &LockHandle);
                v32 = *(_QWORD *)(v13 + 112);
                *(_QWORD *)(v13 + 24) += LastBackwardRunClear;
