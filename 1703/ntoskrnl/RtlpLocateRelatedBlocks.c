/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x140244458
 * Callers:
...
LABEL_71:
    ...
    v26 = 2LL * v25;
    if ( v15 )
      word_140340B50 = *(_WORD *)(a1 + 140) ^ *(_WORD *)(v15 + 12);
    if ( v16 )
    {
      if ( *(_DWORD *)(a1 + 124) )
      {
    ...
    if ( word_140340B50 == (_WORD)result )
    {
      if ( word_140340B54 != (*(_WORD *)(a1 + 140) ^ *(_WORD *)(v16 + 8 * v26 + 12)) )
        dword_140340AF8 = 7;
    }
    else
    {
