/*
 * XREFs of MiExpandVadBitMapDown @ 0x1406B7F10
 * Callers:
...
__int64 __fastcall MiExpandVadBitMapDown(unsigned int a1)
{
  ...
  *((_QWORD *)v1 + 7) = v6;
  ...
  v1[18] = v7;
  MiUpdateVadBits(
    (*((_QWORD *)v1 + 7) - qword_14036C5C8) << 19,
    ((*((_QWORD *)v1 + 7) - qword_14036C5C8) << 19) + ((unsigned __int64)v5 << 31));
  return 1LL;
}
