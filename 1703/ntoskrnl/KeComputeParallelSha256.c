/*
 * XREFs of KeComputeParallelSha256 @ 0x1401FD520
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall KeComputeParallelSha256(__int64 a1, unsigned __int64 a2)
{
  ...
  SymCryptParallelSha256Process(v3, a2, v3 + 1024, 2 * a2, v3 + 1664, 2926LL);
}
