/*
 * XREFs of HvlpSelectLpSet @ 0x1401E5E1C
 * Callers:
 ...
 *     HvlpLpComparison @ 0x1401E5BD8 (HvlpLpComparison.c)
...
__int64 __fastcall HvlpSelectLpSet(unsigned int a1, __int64 a2)
{
  ...
  __int64 (__fastcall *v10)(__int64, _BYTE *, unsigned int *); // rax
  __int64 v11; // rcx
  int v12; // eax
  int ProximityNode; // eax
  int v14; // r8d
  int v15; // r15d
  int v16; // r11d
  int v17; // ebx
      ...
      *((_BYTE *)v7 - 10) = 1;
      ...
      else
      {
        if ( ApicIdAndNumaNode < 0 )
          return v9;
        v10 = (__int64 (__fastcall *)(__int64, _BYTE *, unsigned int *))HvlpQueryProximityId;
        v11 = v41[0];
        *(v7 - 1) = v41[0];
        if ( v10 )
        {
        ...
        if ( v12 < 0
          || (!HvlpQueryProximityNode
            ...
            : (ProximityNode = HvlpQueryProximityNode(v49, v43), LOWORD(v11) = v41[0]),
              ProximityNode < 0) )
        {
          *v7 = v11;
        }
