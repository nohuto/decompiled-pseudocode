/*
 * XREFs of PerfLogSpinLockRelease @ 0x1402563D8
 * Callers:
...
__int64 __fastcall PerfLogSpinLockRelease(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v7 = *(_QWORD *)(result + 24784) + 1472LL;
  v8 = *(_BYTE *)(*(_QWORD *)(result + 24784) + 1728LL);
  if ( v8 )
  {
    v9 = *(_BYTE *)(*(_QWORD *)(result + 24784) + 1728LL);
    while ( 1 )
    {
      result = 32LL * --v9;
...
LABEL_19:
        ...
        v27 = v19;
        v28 = 56;
        result = (__int64)EtwTraceKernelEvent((int)&v27, 1, 0x20010000u, 1321, 1538);
        *(_BYTE *)(v7 + 257) = 0;
LABEL_20:
        v16 = v8 - 1;
        while ( v9 < v16 )
