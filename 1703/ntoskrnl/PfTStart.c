 ...
 *     PfFbBufferListUpdateMax @ 0x14003CCCC (PfFbBufferListUpdateMax.c)
...
__int64 __fastcall PfTStart(__int64 a1, void *a2, unsigned int a3)
{
  ...
  Handle = a2;
  v3 = a3;
  if ( (a3 & 1) != 0 && (xmmword_14036DC84 & 1) == 0 )
    v3 = a3 & 0xFFFFFFFE;
  if ( (v3 & 2) != 0 && (xmmword_14036DC84 & 1) == 0 && (_DWORD)qword_14036DCA0 != 1 && HIDWORD(qword_14036DCA0) != 1 )
    v3 &= ~2u;
  if ( (v3 & 1) != 0 )
  {
