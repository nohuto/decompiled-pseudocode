        ...
        __int64 a6)
{
  ...
  while ( 1 )
  {
    ...
    while ( IsDiscardable || (unsigned __int8)HvpMapEntryIsTrimmed(v23) || !(unsigned __int8)HvpMapEntryIsNewAlloc(v24) );
    BinAddress = HvpMapEntryGetBinAddress((__int64)v25, v25, &v34);
    v28 = *(_BYTE *)(BugCheckParameter2 + 4168);
    if ( v28 && (_DWORD)v7 != 1 && (v28 != 1 || v18 < *(_DWORD *)(BugCheckParameter2 + 4172)) )
      goto LABEL_19;
    FreeCellInBin = HvpFindFreeCellInBin(BugCheckParameter2, (__int64)&v33, a5, a6);
    if ( FreeCellInBin >= 0 )
      break;
