/*
 * XREFs of ?StReleaseReadContext@?$ST_STORE@USM_TRAITS@@@@SAXPEAU1@PEAX@Z @ 0x14011FD0C
 * Callers:
...
void __fastcall ST_STORE<SM_TRAITS>::StReleaseReadContext(_SLIST_HEADER *a1, __int64 a2)
{
  ...
  B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT,ST_STORE<SM_TRAITS>::ST_REGION_ENTRY_COMPARATOR>::BTreeSearchResultDeref(
    (__int64 *)&a1[9],
    *(_QWORD *)(a2 + 32));
  if ( LOWORD(a1[251].Alignment) >= 0x10u )
    ExFreePoolWithTag((PVOID)a2, 0);
  else
    RtlpInterlockedPushEntrySList(a1 + 251, (PSLIST_ENTRY)a2);
}
