/*
 * XREFs of KeBuildLogicalProcessorSystemInformation @ 0x14044300C
 * Callers:
      ...
      if ( (_WORD)v12 == v7 )
      {
        ...
        if ( *(_DWORD *)(v11 + 24756) )
        {
          ...
          while ( 1 )
          {
            v18 = *(_QWORD *)(v11 + 200);
            v19 = v16;
            v20 = *(_QWORD *)(v11 + 8LL * v16 + 25200);
            if ( !v20 )
              goto LABEL_24;
            v27 = *(_QWORD *)(v11 + 8LL * v16 + 25200);
            v18 = v20;
            if ( *(_DWORD *)(v11 + 36) == (unsigned int)KeFindFirstSetLeftGroupAffinity((__int64)&v27) )
              break;
LABEL_12:
            if ( ++v16 >= *(_DWORD *)(v11 + 24756) )
            {
              v10 = v30;
              v5 = a3;
              goto LABEL_14;
...
LABEL_24:
          ...
          else
          {
            ...
            *((_DWORD *)v17 - 2) = 2;
            ...
            a2 += 32LL;
            *v17 = 0LL;
            *v17 = *(_QWORD *)(v11 + 12 * v19 + 24696);
            *((_DWORD *)v17 + 2) = *(_DWORD *)(v11 + 12 * v19 + 24704);
            v17 += 4;
          }
          goto LABEL_12;
        }
