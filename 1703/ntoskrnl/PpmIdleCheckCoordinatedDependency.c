/*
 * XREFs of PpmIdleCheckCoordinatedDependency @ 0x140228054
 * Callers:
...
LABEL_24:
    ...
    if ( !*(_BYTE *)(v17 + 24 * v15 + 2) )
      goto LABEL_26;
    v22 = *(_DWORD *)(v21 + PpmPlatformStates + 320);
    if ( (v22 & 0x4000000) == 0 )
    {
...
LABEL_26:
  ...
  if ( *(_BYTE *)(v17 + 8 * v18) )
  {
    v31 = 0;
    v13 = 0LL;
    v30[0] = (unsigned __int16 *)(v21 + v19 + 128);
