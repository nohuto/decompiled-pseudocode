/*
 * XREFs of AslEnvExpandStrings @ 0x1405BBDA4
 * Callers:
...
__int64 __fastcall AslEnvExpandStrings(__int64 a1, _WORD *a2, __int64 a3, _WORD *a4, unsigned __int64 a5, _QWORD *a6)
{
  ...
  do
  {
    ...
    if ( v13 && v13 < v14 )
    {
      v16 = AslEnvVarQuery(v9, a2 + 1, v13, a4, v6, &v19);
      if ( v16 == -1073741789 )
      {
        a2 = v15 + 1;
        v9 = a1;
      ...
      {
        if ( v16 != -1073741568 )
          AslLogCallPrintf(1, (unsigned int)"AslEnvExpandStrings", 636, (unsigned int)"AslEnvVarQuery failed [%x]");
        a2 = v17;
        ++v11;
        v9 = a1;
        --v7;
