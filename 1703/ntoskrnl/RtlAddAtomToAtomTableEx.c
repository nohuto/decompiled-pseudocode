/*
 * XREFs of RtlAddAtomToAtomTableEx @ 0x14008B560
 * Callers:
 *     NtAddAtomEx @ 0x140441FE4 (NtAddAtomEx.c)
 *     RtlAddAtomToAtomTable @ 0x14045BD90 (RtlAddAtomToAtomTable.c)
 * Callees:
 *     RtlpAllocateAtomTableEntry @ 0x14006B124 (RtlpAllocateAtomTableEntry.c)
 *     RtlpReferenceAtom @ 0x14008B504 (RtlpReferenceAtom.c)
...
__int64 __fastcall RtlAddAtomToAtomTableEx(__int64 a1, _WORD *a2, _WORD *a3, char a4)
{
  int v8; // edi
  __int64 v9; // rcx
  __int64 *v10; // r13
  ...
  if ( (unsigned __int8)RtlpLockAtomTable() )
  {
    ...
    if ( *a2 )
    {
      v8 = RtlpHashStringToAtom(a1, a2, 0LL, &v20, &Size, &v18, &v19);
      Size_4 = v8;
      if ( v8 < 0 )
      {
LABEL_27:
      ...
      if ( v20 )
      {
        v8 = -1073741801;
        Size_4 = -1073741801;
        v11 = RtlpAllocateAtomTableEntry(Size, &v18, a4);
        v12 = v11;
        v19 = v11;
        if ( v11 )
        {
