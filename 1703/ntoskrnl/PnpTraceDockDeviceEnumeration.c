/*
 * XREFs of PnpTraceDockDeviceEnumeration @ 0x1406A63EC
 * Callers:
...
void PnpTraceDockDeviceEnumeration()
{
  ...
  _DWORD *v5; // [rsp+60h] [rbp-9h]
  __int64 v6; // [rsp+68h] [rbp-1h]
  __int64 v7; // [rsp+70h] [rbp+7h]
  _DWORD v8[2]; // [rsp+78h] [rbp+Fh] BYREF
  ...
  if ( stru_14033C440.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&stru_14033C440, 0x400000000000uLL) )
    {
      ...
      v10 = 4LL;
      v12 = 4LL;
      TlgWrite(&stru_14033C440, &unk_1402AC00A, 0LL, 0LL, 6u, &pData);
    }
  }
}
