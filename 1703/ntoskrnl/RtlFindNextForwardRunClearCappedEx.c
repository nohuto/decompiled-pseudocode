/*
 * XREFs of RtlFindNextForwardRunClearCappedEx @ 0x1400ACB30
 * Callers:
 ...
 *     IopAddPageToPageMap @ 0x1401F1AC4 (IopAddPageToPageMap.c)
        ...
        unsigned __int64 *a4)
{
  ...
  if ( *(_QWORD *)a1 > a2 )
  {
    ...
    v8 = (_DWORD *)v7 + ((v4 - 1) >> 5);
    v9 = (_DWORD *)v7 + (a2 >> 5);
    if ( v9 != v8 && (*v9 | dword_14029CF70[a2 & 0x1F]) == -1 )
    {
      ++v9;
