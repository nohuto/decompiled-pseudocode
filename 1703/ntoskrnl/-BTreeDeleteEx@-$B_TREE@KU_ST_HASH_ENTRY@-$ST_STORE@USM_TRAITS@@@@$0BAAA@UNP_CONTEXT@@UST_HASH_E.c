/*
 * XREFs of ?BTreeDeleteEx@?$B_TREE@KU_ST_HASH_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@UST_HASH_ENTRY_COMPARATOR@2@@@SAJPEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x14005BACC
 * Callers:
        ...
        __int64 a2)
{
  ...
  else
  {
    ...
    {
      v16 = (unsigned __int64)B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_HASH_ENTRY,4096,NP_CONTEXT,ST_STORE<SM_TRAITS>::ST_HASH_ENTRY_COMPARATOR>::BTreeRedistribute(
                                a1,
                                a2);
      if ( !v16 )
      ...
      if ( v17 < v9 )
      {
        ...
        if ( (v16 & 1) != 0 )
        {
          ...
          *v5 = v23;
          v24 = *(_DWORD *)v23;
          if ( *(_BYTE *)(v23 + 3) )
            v25 = 4LL * (unsigned __int16)v24 + 16;
          else
