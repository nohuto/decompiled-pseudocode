/*
 * XREFs of EtwpObjectHandleEnumCallback @ 0x140710550
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  v28 = v8;
  *(int *)((char *)&v37 + v25) = 0;
  (&v35)[(unsigned __int64)v25 / 8] = (unsigned __int64 *)&EtwpNull;
  *(int *)((char *)&v36 + v25) = 2;
  EtwpLogKernelEvent((__int64)&v35, EtwpHostSiloState, v24, v13 + 1, v28, v29);
