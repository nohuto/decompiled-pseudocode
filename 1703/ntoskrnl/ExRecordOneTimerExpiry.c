/*
 * XREFs of ExRecordOneTimerExpiry @ 0x14025CEE8
 * Callers:
...
char __fastcall ExRecordOneTimerExpiry(unsigned __int8 a1, char a2)
{
  ...
  if ( ExpIRTimerExpiryCounts )
  {
    v2 = a1 < 0xEu ? a1 : 0;
    v3 = a1 < 0xEu ? a2 : 0;
    v4 = (unsigned __int8 *)&unk_1402889B0;
    v5 = v3 < *((_BYTE *)&unk_1402889B0 + 24 * v2) ? v3 : 0;
    LOBYTE(v6) = v3 < *((_BYTE *)&unk_1402889B0 + 24 * v2) ? v2 : 0;
