/*
 * XREFs of CmpFileReadEx @ 0x14007FD50
 * Callers:
 *     CmpFileRead @ 0x1404D47B0 (CmpFileRead.c)
 * Callees:
...
LABEL_13:
  ...
  while ( 1 )
  {
    ...
    if ( IoStatusBlock.Information != Length )
    {
      ...
      CmRegistryIODebug = 1;
      dword_1407ACDD8 = LODWORD(IoStatusBlock.Information) - Length;
      result = 3221225489LL;
      qword_1407ACDD0 = (__int64)v7;
      return result;
    }
LABEL_12:
    v6 = v18;
