/*
 * XREFs of BiConvertNtDeviceToBootEnvironment @ 0x14058C478
 * Callers:
...
LABEL_39:
  ...
  if ( !v13 )
  {
    ...
    if ( !(_DWORD)v36 )
      goto LABEL_10;
    P = 0LL;
    PartitionDevice = BiConvertNtFilePathToBootEnvironment((char *)a1 + v36, a2 - (unsigned int)v36, a1 + 12, 0LL, &P);
    if ( PartitionDevice < 0 )
      goto LABEL_7;
    v37 = (unsigned int *)P;
    v38 = *((_DWORD *)P + 1) + 40;
...
LABEL_32:
    ...
    *(_QWORD *)&DestinationString.Length = v17;
    ...
    if ( v27 )
    {
      memset(v27, 0, *(size_t *)&DestinationString.Length);
      v28 = (int)P;
      *(_DWORD *)v7 = 8;
      *((_DWORD *)v7 + 2) = v28;
      if ( *((_DWORD *)a1 + 5) )
