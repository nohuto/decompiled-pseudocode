/*
 * XREFs of SeExamineSacl @ 0x1406F5210
 * Callers:
...
LABEL_51:
      ...
      {
        if ( !SepSidInToken((__int64)v9, 0LL, &v16[1], 1, 0, 0)
          && (!Size || *(_WORD *)v12 != *(_WORD *)&v16[1].AclRevision || memcmp(v12, &v16[1], Size)) )
        {
          goto LABEL_50;
        }
        if ( (*(_DWORD *)&v16->AceCount & DesiredAccess) == 0 )
        {
          v15 = GenerateAudita;
