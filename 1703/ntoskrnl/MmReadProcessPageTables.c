/*
 * XREFs of MmReadProcessPageTables @ 0x14021BAAC
 * Callers:
...
__int64 __fastcall MmReadProcessPageTables(__int64 a1)
{
  ...
  v3 = ValidPte;
  __wbinvd();
  result = ExTryAcquireSpinLockSharedAtDpcLevel(&dword_1403802E8);
  v5 = 0;
  if ( (_DWORD)result )
  {
    ...
    if ( *(_DWORD *)MmPhysicalMemoryBlock )
    {
      while ( 1 )
      {
        ...
        v12 = 48 * (v10 + *(_QWORD *)&v9[4 * v5 + 6]) - 0x58000000000LL;
        if ( v11 < v12 )
          break;
LABEL_17:
...
LABEL_18:
    ...
    KeFlushSingleCurrentTb(v6, 0);
    ExReleaseSpinLockSharedFromDpcLevel(&dword_1403802E8);
    return 1LL;
  }
  return result;
}
