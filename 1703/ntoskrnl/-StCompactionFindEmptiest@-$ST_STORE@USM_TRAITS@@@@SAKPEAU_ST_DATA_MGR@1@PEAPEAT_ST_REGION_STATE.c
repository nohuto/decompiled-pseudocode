/*
 * XREFs of ?StCompactionFindEmptiest@?$ST_STORE@USM_TRAITS@@@@SAKPEAU_ST_DATA_MGR@1@PEAPEAT_ST_REGION_STATE@1@KK@Z @ 0x140139950
 * Callers:
...
LABEL_6:
  while ( 1 )
  {
    ...
    if ( (*v13 & 0x1FFF) != 0 && (v14 & 0x1FFFu) <= a4 )
    {
      ...
      if ( (_DWORD)v12 != *(_DWORD *)(a1 + 16 * (v15 + 77LL)) )
      {
