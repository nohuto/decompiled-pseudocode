/*
 * XREFs of sub_1407184B0 @ 0x1407184B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1407184B0(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // eax
...
LABEL_12:
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_140717EA8(a1, a2, a3, a4, 4);
  }
  else
  {
    v15 = -1073741772;
