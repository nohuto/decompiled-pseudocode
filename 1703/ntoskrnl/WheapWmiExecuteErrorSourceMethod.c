/*
 * XREFs of WheapWmiExecuteErrorSourceMethod @ 0x1402608B0
 * Callers:
 *     WheapWmiExecuteMethod @ 0x140260CB4 (WheapWmiExecuteMethod.c)
 * Callees:
...
LABEL_28:
  ...
  else
  {
    ...
    if ( !dword_14036F11C )
      goto LABEL_35;
    v10 = 972 * dword_14036F11C + 12;
    if ( v10 > a2 )
      goto LABEL_37;
    *a3 = 0;
    v34 = (__int64 *)qword_14036F120;
    v35 = a3 + 3;
    v36 = 0;
    for ( i = 0; v34 != &qword_14036F120; v34 = (__int64 *)*v34 )
    {
      if ( i >= dword_14036F11C )
        break;
      v38 = v35;
      v39 = (char *)v34 + 89;
      v40 = 7LL;
