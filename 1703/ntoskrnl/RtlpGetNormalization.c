/*
 * XREFs of RtlpGetNormalization @ 0x1406EFEA8
 * Callers:
 *     RtlIsNormalizedString @ 0x1406EEA10 (RtlIsNormalizedString.c)
 *     RtlNormalizeString @ 0x1406EEAA0 (RtlNormalizeString.c)
 * Callees:
 ...
 *     NormalizationList__InsertTail @ 0x140244C50 (NormalizationList__InsertTail.c)
 *     NormalizationList__Lock @ 0x140244C84 (NormalizationList__Lock.c)
 *     NormalizationList__Lookup @ 0x140244CA8 (NormalizationList__Lookup.c)
