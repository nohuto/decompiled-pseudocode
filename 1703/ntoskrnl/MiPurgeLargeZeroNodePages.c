/*
 * XREFs of MiPurgeLargeZeroNodePages @ 0x140138C1C
 * Callers:
                ...
                if ( *v15 != (volatile signed __int32 *)v15 )
                {
                  while ( 1 )
                  {
                    ...
                    *(_QWORD *)(v13 + 8) = v17;
                    ...
                    ++*v14;
                    --*v16;
                    _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 1984), -(__int64)v9);
                    _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 2048), v9);
