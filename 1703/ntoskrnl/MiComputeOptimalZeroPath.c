/*
 * XREFs of MiComputeOptimalZeroPath @ 0x1408043E0
 * Callers:
...
__int64 MiComputeOptimalZeroPath()
{
  ...
  while ( 1 )
  {
    ...
    if ( v2 >= 2 )
    {
      v43 = 0LL;
      v7 = &v39;
      v34 = (unsigned __int64 *)&unk_14036C270;
      v33 = &v39;
      v8 = 0LL;
      v35 = 2LL;
      do
      ...
      do
      {
        ...
        result = (__int64)MiInsertPageInFreeOrZeroedList(v38[v0 + 2], 2);
  ...
  if ( v2 )
  {
    ...
    do
    {
      ...
      result = (__int64)MiInsertPageInFreeOrZeroedList(v38[v29 + 2], 2);
