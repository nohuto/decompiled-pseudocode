/*
 * XREFs of EtwpTraceThreadRundown @ 0x14006B3EC
 * Callers:
...
__int64 __fastcall EtwpTraceThreadRundown(__int64 a1, __int64 a2)
{
  ...
  return EtwpLogSystemEventUnsafe(EtwpHostSiloState, (unsigned int)v34, v10, v3, v2, v6, v5);
}
