/*
 * XREFs of RtlFindClearRunsEx @ 0x14023CA64
 * Callers:
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      if ( v14 )
      {
        ...
        v3 = v13 - v8 + 8;
        v22 = byte_14029EB30[v15] | byte_14029EB40[8 - v8] | v14;
        if ( v22 != 0xFF )
        {
          do
          {
            ...
            for ( j = byte_14029EB30[v24]; ((unsigned __int8)j & v22) != 0; j *= 2 )
              ++v23;
            v26 = v7 + 1;
            if ( v7 )
              v26 = v7;
