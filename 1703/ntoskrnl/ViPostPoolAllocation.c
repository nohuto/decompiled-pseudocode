/*
 * XREFs of ViPostPoolAllocation @ 0x140764A98
 * Callers:
...
LABEL_18:
  ...
  *(_QWORD *)(a1 + 16) = v10;
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v14 > *(_DWORD *)(v8 + 88) )
      *(_DWORD *)(v8 + 88) = v14;
    v15 = v10 + _InterlockedExchangeAdd64(&qword_14034F6B0, v10);
    if ( v15 > qword_14034F6C0 )
      qword_14034F6C0 = v15;
    v16 = _InterlockedIncrement(&dword_14034F6A0);
    if ( v16 > dword_14034F6A8 )
      dword_14034F6A8 = v16;
  }
  else
  {
    ...
    if ( v18 > *(_DWORD *)(v8 + 92) )
      *(_DWORD *)(v8 + 92) = v18;
    v19 = v10 + _InterlockedExchangeAdd64(&qword_14034F6B8, v10);
    if ( v19 > qword_14034F6C8 )
      qword_14034F6C8 = v19;
    v20 = _InterlockedIncrement(&dword_14034F6A4);
    if ( v20 > dword_14034F6AC )
      dword_14034F6AC = v20;
  }
  result = v2;
  *v12 = a1;
