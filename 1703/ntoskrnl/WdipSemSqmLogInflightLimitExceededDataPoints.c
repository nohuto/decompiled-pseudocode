/*
 * XREFs of WdipSemSqmLogInflightLimitExceededDataPoints @ 0x140454B34
 * Callers:
 ...
 *     WdipSemGetGuidKey @ 0x140706400 (WdipSemGetGuidKey.c)
...
__int64 WdipSemSqmLogInflightLimitExceededDataPoints()
{
  ...
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_140345B28, 0LL);
  v3 = (unsigned int)dword_140345B20;
  if ( dword_140345B20 )
  {
    v1 = WdipSemSqmIncrementDword(v2, (unsigned int)dword_140345B20);
    if ( v1 < 0 )
      v1 = 0;
    if ( (_DWORD)v3 )
    {
  ...
  for ( i = 0; i < dword_140345B20; WdipSemFrequentScenarioTable[v8] = 0LL )
  {
    v8 = i;
    WdipSemFastFree(5LL, WdipSemFrequentScenarioTable[i++]);
  }
  dword_140345B20 = 0;
  ExReleasePushLockEx((ULONG_PTR)&qword_140345B28, 0LL);
