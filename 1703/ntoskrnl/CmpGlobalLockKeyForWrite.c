/*
 * XREFs of CmpGlobalLockKeyForWrite @ 0x1405C668C
 * Callers:
...
LABEL_5:
  ...
  if ( GlobalKeyLockEntry )
  {
    *(_WORD *)(a1 + 4) |= 0x80u;
    ...
    v9 = (_QWORD *)qword_14036AF70;
    if ( *(__int64 **)qword_14036AF70 != &qword_14036AF68 )
      __fastfail(3u);
    *GlobalKeyLockEntry = &qword_14036AF68;
    GlobalKeyLockEntry[1] = v9;
    *v9 = GlobalKeyLockEntry;
    qword_14036AF70 = (__int64)GlobalKeyLockEntry;
