/*
 * XREFs of KiDisplayBlueScreen @ 0x1402000B4
 * Callers:
 ...
 *     KeGetBugMessageText @ 0x1401FFD28 (KeGetBugMessageText.c)
...
__int64 __fastcall KiDisplayBlueScreen(int a1)
{
  ...
  if ( (dword_140341A30 & 2) != 0 )
    BgpFwDisplayBugCheckScreen(v14, (unsigned int)&qword_140350128, v3, (unsigned int)&v22, a1);
  BgpFwReleaseLock();
