/*
 * XREFs of HvpGetLogHeader @ 0x140676C8C
 * Callers:
 ...
 *     HvpDetermineLatestLogFile @ 0x140678A9C (HvpDetermineLatestLogFile.c)
 */
...
LABEL_20:
  if ( stru_14033C3C0.LevelPlus1 > 5 )
  {
    ...
    v92 = 4;
    v95 = 4;
    TlgWrite(&stru_14033C3C0, &unk_1402AB377, 0LL, 0LL, 7u, &pData);
  }
  if ( !a7 )
  {
    if ( v13 )
...
LABEL_97:
  ...
  while ( v57 );
  if ( v17 == 1 && stru_14033C3C0.LevelPlus1 > 5 && TlgKeywordOn(&stru_14033C3C0, 0x400000000000uLL) )
    TlgWrite(&stru_14033C3C0, &unk_1402AB353, 0LL, 0LL, 2u, &v80);
  return v17;
}
