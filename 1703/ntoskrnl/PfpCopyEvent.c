...
__int64 __fastcall PfpCopyEvent(_QWORD *Src)
{
  ...
  if ( (*Src & 0x1F000LL) == 0xA000 )
  {
    ...
    v16 = 0LL;
    v3 = v2;
    if ( (v2 & 0x7FFFFFFFFFFFFFFFLL) >= 0xFF )
      v3 = -1;
    v4 = 2LL;
    ...
    if ( v8 )
    {
      v9 = ((qword_14036D958 + 47) & 0xFFFFFFFFFFFFFFF8uLL)
         + 40LL * (*(unsigned __int16 *)(v8 + 10) - (unsigned int)*(unsigned __int16 *)(qword_14036D958 + 36));
      if ( (*(_BYTE *)(v9 + 8) & 4) != 0
        && PsLookupProcessByProcessId((HANDLE)*((unsigned int *)Src + 13), &Process) >= 0 )
      {
          ...
          && PfpIsProcessInfoPresent((__int64)Process) )
        {
          ...
          *(_QWORD *)(v9 + 8) = v14;
          *(_QWORD *)(v9 + 8) = v14 & 7 | (8 * ((unsigned __int64)v13 ^ (unsigned __int64)v13[1].ThreadListHead.Flink));
          *(_DWORD *)(v9 + 28) = v13[1].ThreadSeed[1];
          *(_DWORD *)(v9 + 24) = v13[1].Header.WaitListHead.Flink;
          *(_QWORD *)(v9 + 16) = v13;
        }
  ...
  else
  {
    v11 = qword_14036D930;
    v12 = (*Src >> 2) & 0x3FFLL;
    if ( (unsigned int)(v12 + *(_DWORD *)(qword_14036D930 + 16)) > *(_DWORD *)(qword_14036D930 + 20) )
    {
      while ( (unsigned int)PfTReplaceCurrentBuffer(&unk_14036D918, v11) != -1073741823 )
      {
        v11 = qword_14036D930;
        if ( (unsigned int)(v12 + *(_DWORD *)(qword_14036D930 + 16)) <= *(_DWORD *)(qword_14036D930 + 20) )
          goto LABEL_10;
