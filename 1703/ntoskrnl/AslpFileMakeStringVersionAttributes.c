/*
 * XREFs of AslpFileMakeStringVersionAttributes @ 0x140731088
 * Callers:
...
LABEL_8:
    ...
    do
    {
      v14 = *(int *)((char *)&unk_14028E9D0 + v2);
      pszSrc = *(const wchar_t **)((char *)&unk_14028E9D0 + v2 + 8);
      LODWORD(v24) = *(_DWORD *)((char *)&unk_14028E9D0 + v2);
