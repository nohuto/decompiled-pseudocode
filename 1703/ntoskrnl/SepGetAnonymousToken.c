/*
 * XREFs of SepGetAnonymousToken @ 0x14003D7D8
 * Callers:
...
__int64 __fastcall SepGetAnonymousToken(__int64 a1, _QWORD *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( a1 )
    {
      ...
      v8 = AppContainerPrivilegesEnabledExt(v7, 0x200800000LL, &v18, &v11);
      v4 = v8;
      if ( v8 == -1073741637 )
      {
        v5[9] &= 0x200800000uLL;
...
LABEL_15:
      ...
      v9 = v5[25] & 0xFFFF9FFF | 0x4000;
      *((_DWORD *)v5 + 50) = v9;
      *((_DWORD *)v5 + 50) = v9 | *(_DWORD *)(a1 + 200) & 0x80000;
    }
    *a2 = v5;
    if ( v4 < 0 )
      goto LABEL_15;
