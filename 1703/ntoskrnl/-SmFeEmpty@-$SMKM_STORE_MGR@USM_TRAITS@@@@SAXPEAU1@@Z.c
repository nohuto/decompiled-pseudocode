/*
 * XREFs of ?SmFeEmpty@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@@Z @ 0x140249920
 * Callers:
...
LABEL_22:
  ...
  KiAbThreadRemoveBoosts(&v5->Header.Lock, v3, (unsigned int *)&v18);
  v16 = v5->SpecialApcDisable + 1;
  v5->SpecialApcDisable = v16;
  if ( !v16 && ($69CD3F157F9F39B6F7113F2231989901 *)v5->ApcState.ApcListHead[0].Flink != &v5->152 )
