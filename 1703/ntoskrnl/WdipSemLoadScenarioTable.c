/*
 * XREFs of WdipSemLoadScenarioTable @ 0x1405ADC7C
 * Callers:
 ...
 *     WdipSemUpdateProviderEntriesForScenario @ 0x1405AEEAC (WdipSemUpdateProviderEntriesForScenario.c)
 *     WdipSemUpdateProviderTableWithScenario @ 0x1405AEF6C (WdipSemUpdateProviderTableWithScenario.c)
 *     WdipSemEnableAllProviders @ 0x1405CA948 (WdipSemEnableAllProviders.c)
 *     WdipSemAddScenarioToTable @ 0x1405D1478 (WdipSemAddScenarioToTable.c)
...
LABEL_16:
        if ( (int)WdipSemOpenRegistryKey(L"Instrumentation") >= 0 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( (unsigned int)dword_140345D60 >= 0x40 )
              break;
            v9 = dword_140347D80;
