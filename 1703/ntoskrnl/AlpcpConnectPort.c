/*
 * XREFs of AlpcpConnectPort @ 0x140474C88
 * Callers:
 *     NtAlpcConnectPort @ 0x140472848 (NtAlpcConnectPort.c)
 *     NtAlpcConnectPortEx @ 0x1404728C4 (NtAlpcConnectPortEx.c)
 * Callees:
        ...
        LARGE_INTEGER *a13)
{
  ...
  *(_QWORD *)a1 = *(_QWORD *)a1;
  ...
  if ( !Src || (ClientPort = SeCaptureSid(Src, v22, 1, (__int64)&v25), ClientPort >= 0) )
  {
    if ( !a7
      || (LOBYTE(v16) = PreviousMode, ClientPort = SeCaptureSecurityDescriptor(a7, v16, 1LL, 0LL), ClientPort >= 0) )
    {
LABEL_15:
