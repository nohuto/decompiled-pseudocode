/*
 * XREFs of KsepDsEventIoCreateDevice @ 0x1402092FC
 * Callers:
...
BOOLEAN __fastcall KsepDsEventIoCreateDevice(__int64 a1, __int64 a2, int a3, int a4, unsigned __int8 a5, char a6)
{
  ...
  int v12; // [rsp+74h] [rbp-2Dh]
  int *v13; // [rsp+78h] [rbp-29h]
  int v14; // [rsp+80h] [rbp-21h]
  int v15; // [rsp+84h] [rbp-1Dh]
  int *v16; // [rsp+88h] [rbp-19h]
  int v17; // [rsp+90h] [rbp-11h]
  int v18; // [rsp+94h] [rbp-Dh]
  ...
  __int64 v25; // [rsp+F8h] [rbp+57h] BYREF
  __int64 v26; // [rsp+100h] [rbp+5Fh] BYREF
