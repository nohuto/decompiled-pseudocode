/*
 * XREFs of PpmUpdateTargetProcessorPolicy @ 0x14017D478
 * Callers:
 *     PpmUpdateProcessorPolicyCallback @ 0x1401496D0 (PpmUpdateProcessorPolicyCallback.c)
        ...
        __int64 a5))(__int64, _QWORD)
{
  ...
  if ( v12 && (PpmAllowedActions & 0x400) != 0 )
