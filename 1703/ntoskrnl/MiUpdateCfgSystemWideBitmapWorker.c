/*
 * XREFs of MiUpdateCfgSystemWideBitmapWorker @ 0x140514AB0
 * Callers:
...
__int64 __fastcall MiUpdateCfgSystemWideBitmapWorker(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  *(_QWORD *)&BitMapHeader.SizeOfBitMap = (a4 >> 15) + ((((a3 >> 3) & 0xFFF) + 4095 + ((a4 >> 3) & 0xFFF)) >> 12);
  result = MiMapViewInSystemSpace(a1, (__int64)&unk_14036C0F8, &MappedBase, (unsigned __int64 *)&v31, &v30, 0LL, 0LL);
  if ( (int)result >= 0 )
  {
    ...
    v30 = v9 >> 12;
    v13 = MiLocatePagefileSubsection(v12 + 128, &v30);
    v14 = *(_QWORD *)&BitMapHeader.SizeOfBitMap;
    if ( (unsigned int)MiChargeSegmentCommit(v13, *(_QWORD *)(v13 + 8) + 8 * v30, *(_QWORD *)&BitMapHeader.SizeOfBitMap) )
    {
