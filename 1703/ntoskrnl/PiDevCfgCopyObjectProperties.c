/*
 * XREFs of PiDevCfgCopyObjectProperties @ 0x140593580
 * Callers:
        ...
        GenericStorePropertyKeys >= 0) )
  {
    if ( a7
      || (GenericStorePropertyKeys = PnpOpenObjectRegKey(
          ...
          GenericStorePropertyKeys >= 0) )
    {
      GenericStorePropertyKeys = PnpGetGenericStorePropertyKeys(v7, a4, 0LL, 0LL, 0LL, 0, &v24);
      if ( (int)(GenericStorePropertyKeys + 0x80000000) < 0 || GenericStorePropertyKeys == -1073741789 )
      {
        if ( v24 )
        {
          ...
          if ( PoolWithTag )
          {
            GenericStorePropertyKeys = PnpGetGenericStorePropertyKeys(v7, a4, 0LL, 0LL, PoolWithTag, v24, &v24);
            if ( GenericStorePropertyKeys >= 0 )
            {
              v13 = 256;
              v14 = ExAllocatePoolWithTag(PagedPool, 0x100uLL, 0x63647050u);
              if ( v14 )
              {
                if ( v24 )
                {
                  do
                  {
                    ...
                    if ( GenericStoreProperty == -1073741789 )
                    {
                      ...
                      v13 = NumberOfBytes;
                      v14 = ExAllocatePoolWithTag(PagedPool, NumberOfBytes, 0x63647050u);
                      if ( !v14 )
                      {
