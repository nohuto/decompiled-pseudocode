/*
 * XREFs of AlpcpInitSystem @ 0x1405D0188
 * Callers:
...
__int64 AlpcpInitSystem()
{
  ...
  if ( PoolWithTag )
  {
    ...
    qword_14034F738 = (__int64)&AlpcpPortList;
    ...
    *(__int128 *)((char *)v5 + 12) = AlpcpPortMapping;
    ...
    if ( v2 >= 0 )
    {
      ...
      ExInitializePagedLookasideListInternal(
        ...
        32,
        0);
      ExInitializePagedLookasideListInternal((__int64)&stru_140380100, 0LL, 0LL, 0, 128, 1632136257, 32, 0);
      ...
      else
      {
        ...
        qword_14034F768 = (__int64)&AlpcpMessageLogListHead;
        AlpcpMessageLogListHead = (__int64)&AlpcpMessageLogListHead;
        qword_14034F798 = (__int64)&AlpcpFreeMessageLogListHead;
        AlpcpFreeMessageLogListHead = (__int64)&AlpcpFreeMessageLogListHead;
        qword_14034F788 = (__int64)&AlpcpFreeMessageSnapshotListHead;
        AlpcpFreeMessageSnapshotListHead = (__int64)&AlpcpFreeMessageSnapshotListHead;
      }
      AlpcpCompletionListDatabase = 0LL;
      qword_14034F758 = (__int64)&qword_14034F750;
      qword_14034F750 = (__int64)&qword_14034F750;
    }
  }
  else
  {
