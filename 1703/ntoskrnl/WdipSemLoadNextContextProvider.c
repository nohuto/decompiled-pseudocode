/*
 * XREFs of WdipSemLoadNextContextProvider @ 0x1405CA6D0
 * Callers:
...
__int64 __fastcall WdipSemLoadNextContextProvider(HANDLE KeyHandle, ULONG Index, GUID *Guid)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *((_WORD *)&KeyInformation[4] + ((unsigned __int64)KeyInformation[3] >> 1)) = 0;
    ...
    v6 = WdipSemOpenRegistryKey((PCWSTR)&KeyInformation[4], KeyHandle, &Handle);
    if ( v6 < 0 )
      goto LABEL_24;
    v8 = WdipSemQueryValueFromRegistry(Handle, L"Level", 4, 4u, &v18, &ResultLength);
    v6 = v8;
    if ( v8 < 0 )
    {
      if ( v8 != -1073741772 )
    ...
    v10 = WdipSemQueryValueFromRegistry(Handle, L"Keyword", 11, 8u, &v20, &ResultLength);
    v6 = v10;
    if ( v10 < 0 )
    {
      if ( v10 != -1073741772 )
    ...
    v12 = WdipSemQueryValueFromRegistry(Handle, L"CaptureState", 4, 4u, &v16, &ResultLength);
    v6 = v12;
    if ( v12 >= 0 )
    {
      Guid[2].Data1 = v16;
LABEL_21:
      v13 = WdipSemQueryValueFromRegistry(Handle, L"EnableProperty", 4, 4u, &v19, &ResultLength);
      v6 = v13;
      if ( v13 >= 0 )
      {
