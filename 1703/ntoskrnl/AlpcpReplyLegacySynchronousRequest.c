/*
 * XREFs of AlpcpReplyLegacySynchronousRequest @ 0x14042F9B0
 * Callers:
...
LABEL_29:
  ...
  if ( v7 >= 0 )
  {
    ...
    *(_WORD *)(v18 + 244) = 2;
    v20 = v33;
    *(_OWORD *)(v33 + 248) = *(_OWORD *)&KeGetCurrentThread()[1].CurrentRunTime;
    *(_DWORD *)(v8 + 40) |= 0x200u;
    ...
    *(_DWORD *)(v8 + 40) = *(_DWORD *)(v8 + 40) & 0xFFFEFEFF | 0x100;
    ...
    if ( (a1[6] & 4) != 0 )
      ...
      KeReleaseSemaphoreEx(v24 + 1608, 1, 1, v25, 2);
    return v28;
  }
  else
  {
