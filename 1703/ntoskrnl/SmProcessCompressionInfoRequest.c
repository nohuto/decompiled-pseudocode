/*
 * XREFs of SmProcessCompressionInfoRequest @ 0x140491F24
 * Callers:
  ...
  if ( a2 == 40 )
  {
    ...
    *(_QWORD *)&v20[32] = *(_QWORD *)(a1 + 32);
    ...
    else
    {
      ...
      if ( qword_1403FA178 )
      {
        *(_DWORD *)&v20[4] = *((_DWORD *)qword_1403FA178 + 184);
        *(_QWORD *)&v20[8] = *((_QWORD *)qword_1403FA178 + 178) << 12;
