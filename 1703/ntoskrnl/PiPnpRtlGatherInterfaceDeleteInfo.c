/*
 * XREFs of PiPnpRtlGatherInterfaceDeleteInfo @ 0x140696E00
 * Callers:
...
__int64 __fastcall PiPnpRtlGatherInterfaceDeleteInfo(_WORD *a1, __int64 **a2)
{
  void *v2; // rsi
  ...
  *a2 = PoolWithTag;
  if ( PoolWithTag )
  {
    ...
    if ( ObjectProperty != -1073741772 && ObjectProperty != -1073741275 )
    {
      ...
      {
        Object = PiDmGetObject(4, v14, *a2 + 1);
        if ( (int)(Object + 0x80000000) >= 0 && Object != -1073741772 )
          goto LABEL_24;
      }
    }
    ...
    if ( v8 != -1073741772 && v8 != -1073741275 )
    {
      if ( v8 < 0 )
        goto LABEL_24;
      Object = PiDmGetObject(1, (_WORD *)v12, *a2 + 2);
      if ( (int)(Object + 0x80000000) >= 0 && Object != -1073741772 )
        goto LABEL_24;
    }
    ...
    else
    {
      ...
      if ( Object < 0 )
        goto LABEL_24;
      Object = PiDmGetObject(5, v14, *a2 + 3);
