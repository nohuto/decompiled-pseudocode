/*
 * XREFs of PopNewWakeInfo @ 0x14040A2B8
 * Callers:
...
LONG PopNewWakeInfo()
{
  ...
  PopAcquireWakeSourceSpinLock(&v9);
  ...
  if ( v1 )
  {
    ...
    if ( v3 == 1 )
    {
      v7 = (_QWORD *)qword_14034BE48;
      v8 = *(_QWORD **)(qword_14034BE48 + 8);
      if ( *(__int64 **)qword_14034BE48 != &PopWakeInfoList || *v8 != qword_14034BE48 )
        __fastfail(3u);
      qword_14034BE48 = *(_QWORD *)(qword_14034BE48 + 8);
      *v8 = &PopWakeInfoList;
      v7[1] = v7;
      *v7 = v7;
  ...
  PopReleaseWakeSourceSpinLock(&v9);
