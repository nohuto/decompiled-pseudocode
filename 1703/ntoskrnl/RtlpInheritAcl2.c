/*
 * XREFs of RtlpInheritAcl2 @ 0x14051E100
 * Callers:
        ...
        int *a18)
{
  ...
  char v43; // [rsp+81h] [rbp-57h]
  USHORT AceCount; // [rsp+82h] [rbp-56h]
  unsigned int v45; // [rsp+84h] [rbp-54h]
  __int64 v46; // [rsp+88h] [rbp-50h] BYREF
...
LABEL_43:
    v38 = v42;
    if ( v37 == 2 && (v26 || v42 || a2 && !*((_WORD *)a2 + 2)) )
      *v30 = 1;
    goto LABEL_31;
  }
  v37 = a12;
