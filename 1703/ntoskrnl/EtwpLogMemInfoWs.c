/*
 * XREFs of EtwpLogMemInfoWs @ 0x14070B538
 * Callers:
...
LABEL_20:
    ...
    *(_QWORD *)(v8 + 60) = *((_QWORD *)NextProcess + 237);
    ...
    *(_QWORD *)(v8 + 44) = 0LL;
    if ( v22 )
      v23 = *(_QWORD *)(v8 + 28);
    *(_QWORD *)(v8 + 28) = v23;
    *(_QWORD *)(v8 + 52) = *((_QWORD *)NextProcess + 186);
    if ( (int)SmProcessQueryStoreStats(NextProcess, &v24, &v25) >= 0 )
    {
      *(_QWORD *)(v8 + 36) = v24 >> 12;
      *(_QWORD *)(v8 + 44) = v25 >> 12;
    }
