/*
 * XREFs of HvlGetPpmStatsForProcessor @ 0x1401E9324
 * Callers:
 *     PpmUpdatePerformanceFeedback @ 0x1400F5DE0 (PpmUpdatePerformanceFeedback.c)
 * Callees:
 *     HvlGetReferenceTime @ 0x1401E6D1C (HvlGetReferenceTime.c)
 */
...
__int64 __fastcall HvlGetPpmStatsForProcessor(struct _KPRCB *a1, _QWORD *a2, _QWORD *a3)
{
  ...
  {
    v6 = HIDWORD(xmmword_140389228);
    StatisticsPage = a1->StatisticsPage;
    do
    {
      v8 = StatisticsPage[v6];
      *a3 = a1->StatisticsPage[(unsigned int)xmmword_140389238];
    }
    while ( v8 != StatisticsPage[v6] );
    v9 = DWORD1(xmmword_140389238);
  ...
  {
    ReferenceTime = HvlGetReferenceTime();
    v12 = (unsigned int)xmmword_140389238;
    *a2 = ReferenceTime - a1->StatisticsPage[DWORD1(xmmword_140389228)];
