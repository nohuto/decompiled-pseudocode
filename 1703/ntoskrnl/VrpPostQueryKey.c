/*
 * XREFs of VrpPostQueryKey @ 0x14067C12C
 * Callers:
...
__int64 __fastcall VrpPostQueryKey(__int64 a1)
{
  ...
  void *v21; // [rsp+48h] [rbp-69h] BYREF
  void *v22; // [rsp+50h] [rbp-61h] BYREF
  GUID ActivityId; // [rsp+58h] [rbp-59h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+68h] [rbp-49h] BYREF
  __int64 *v25; // [rsp+88h] [rbp-29h]
  __int64 v26; // [rsp+90h] [rbp-21h]
  _QWORD *v27; // [rsp+98h] [rbp-19h]
  __int64 v28; // [rsp+A0h] [rbp-11h] BYREF
  __int64 *v29; // [rsp+A8h] [rbp-9h]
  _QWORD v30[5]; // [rsp+B0h] [rbp-1h] BYREF
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( stru_14033C400.LevelPlus1 > 5 )
  {
    ...
    v30[0] = *v10;
    v28 = 2LL;
    TlgWrite(&stru_14033C400, &unk_1402AB6A6, &ActivityId, 0LL, 5u, &pData);
  }
  if ( (*(_DWORD *)(v2 + 32) & 0x20000000) == 0 )
  {
    v11 = *(_DWORD *)(v3 + 8);
    if ( v11 != 3 && v11 != 8 )
      goto LABEL_22;
            ...
            if ( v13 >= 0 )
            {
              ...
              if ( v15 >= 0 )
              {
                ...
                *(_DWORD *)(v20 + 24) = v5;
                ...
                v30[0] = 4LL;
                v30[2] = 4LL;
                TlgWrite(&stru_14033C400, &unk_1402AB863, &ActivityId, 0LL, 6u, &pData);
              }
              else
              {
                v5 = v15;
...
LABEL_22:
  ...
  if ( v5 != -1073740541 && stru_14033C400.LevelPlus1 > 2 )
  {
    if ( *(_QWORD *)(v2 + 24) )
    ...
    v26 = 2LL;
    v30[0] = 4LL;
    TlgWrite(&stru_14033C400, &unk_1402AB66B, &ActivityId, 0LL, 5u, &pData);
  }
LABEL_28:
