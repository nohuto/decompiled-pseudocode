/*
 * XREFs of RtlSelfRelativeToAbsoluteSD @ 0x140572A50
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x140192A40 (memmove.c)
 *     RtlpQuerySecurityDescriptor @ 0x140572D44 (RtlpQuerySecurityDescriptor.c)
 */
        ...
        PULONG PrimaryGroupSize)
{
    ...
    && v27 <= *PrimaryGroupSize )
  {
    ...
    *((_QWORD *)AbsoluteSecurityDescriptor + 4) = 0LL;
    ...
    {
      v24 = Owner;
      memmove(Owner, v29, 4LL * *((unsigned __int8 *)v29 + 1) + 8);
