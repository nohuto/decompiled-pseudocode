/*
 * XREFs of SymCryptSha256AppendBlocks_ul1 @ 0x140177E04
 * Callers:
...
__int64 __fastcall SymCryptSha256AppendBlocks_ul1(int *a1, __int64 a2, unsigned __int64 a3, unsigned __int64 *a4)
{
  ...
  unsigned __int32 v110; // [rsp+8h] [rbp-F8h]
  _DWORD *v111; // [rsp+10h] [rbp-F0h]
  unsigned __int32 v112; // [rsp+18h] [rbp-E8h]
  unsigned __int32 v113; // [rsp+1Ch] [rbp-E4h]
  unsigned __int32 v114; // [rsp+20h] [rbp-E0h]
  int v115; // [rsp+30h] [rbp-D0h]
  unsigned __int32 v116; // [rsp+30h] [rbp-D0h]
  unsigned __int32 v117; // [rsp+40h] [rbp-C0h]
  unsigned __int32 v118; // [rsp+50h] [rbp-B0h]
  unsigned __int32 v119; // [rsp+58h] [rbp-A8h]
  unsigned __int32 v120; // [rsp+5Ch] [rbp-A4h]
  unsigned __int32 v121; // [rsp+60h] [rbp-A0h]
  unsigned __int32 v122; // [rsp+70h] [rbp-90h]
  unsigned __int32 v123; // [rsp+80h] [rbp-80h]
  int v124; // [rsp+90h] [rbp-70h]
  unsigned __int32 v125; // [rsp+90h] [rbp-70h]
  int v126; // [rsp+A0h] [rbp-60h]
  unsigned __int32 v127; // [rsp+A0h] [rbp-60h]
  unsigned __int32 v128; // [rsp+B0h] [rbp-50h]
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      v111 = (_DWORD *)&xmmword_14029B940 + 2;
      v62 = v125;
      v63 = (__ROR4__(v57, 2) ^ __ROR4__(v57, 13) ^ __ROR4__(v57, 22)) + v61;
      do
      {
        v114 += ((v112 >> 3) ^ __ROR4__(v112, 7) ^ __ROR4__(v112, 18))
              + v128
        ...
        v112 += ((v110 >> 3) ^ __ROR4__(v110, 7) ^ __ROR4__(v110, 18))
              + v118
        ...
        v110 += ((v113 >> 3) ^ __ROR4__(v113, 7) ^ __ROR4__(v113, 18))
              + v120
        ...
        v113 += ((v112 >> 10) ^ __ROR4__(v112, 17) ^ __ROR4__(v112, 19))
              + v122
        ...
        v117 += ((v110 >> 10) ^ __ROR4__(v110, 17) ^ __ROR4__(v110, 19))
              + v123
      ...
      while ( (__int64)v111 < (__int64)((_DWORD *)&_xmm + 2) );
      v4 = v135 + v60;
      v6 = v136 + v56;
      v8 = v137 + v53;
      v11 = v133 + v54;
