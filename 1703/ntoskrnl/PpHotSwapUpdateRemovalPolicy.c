/*
 * XREFs of PpHotSwapUpdateRemovalPolicy @ 0x1404501DC
 * Callers:
 *     PiProcessNewDeviceNode @ 0x1404DC8A4 (PiProcessNewDeviceNode.c)
 * Callees:
 *     PiHotSwapGetDetachableNode @ 0x1404502E4 (PiHotSwapGetDetachableNode.c)
...
LABEL_10:
  ...
  *(_BYTE *)(a1 + 467) = v5;
  v6 = *(_QWORD *)(a1 + 48);
  v10 = 4;
  result = CmGetDeviceRegProp(PiPnpRtlCtx, v6, (__int64)&v9, (__int64)&v8, (__int64)&v10, 0);
  if ( (int)result >= 0 )
  {
    if ( v9 != 4 )
      result = 3221225712LL;
