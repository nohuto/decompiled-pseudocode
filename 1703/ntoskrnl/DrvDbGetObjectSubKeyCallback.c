/*
 * XREFs of DrvDbGetObjectSubKeyCallback @ 0x1407439F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DrvDbGetObjectSubKeyCallback(__int64 *a1, __int64 a2, const wchar_t *a3, __int64 a4)
{
  ...
  v4 = (const wchar_t **)&off_14028D588;
  Handle = 0LL;
  v5 = 0LL;
  v33 = 0;
  v6 = 0;
...
LABEL_9:
      ...
      if ( (int)SysCtxRegOpenKey(v17, a2, (__int64)a3, 8u, 0x20019u, (__int64)&Handle) < 0
        || (int)PnpCtxRegQueryInfoKey(v18, Handle, &v33, v19, &v29, 0LL) < 0 )
      {
        goto LABEL_28;
      }
      ...
      if ( v29 )
      {
        ...
        if ( (!v25 || v25(a1, v13, 0LL, *(_QWORD *)(a4 + 528))) && RtlInitUnicodeStringEx(&ppszDestEnd, v13) >= 0 )
        {
          v26 = *(_DWORD *)(a4 + 544);
