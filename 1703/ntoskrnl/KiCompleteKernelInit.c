/*
 * XREFs of KiCompleteKernelInit @ 0x14041193C
 * Callers:
...
__int64 __fastcall KiCompleteKernelInit(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    qword_1403569D8 = 0LL;
    qword_1403569D0 = (__int64)&qword_1403569C8;
    qword_1403569C8 = (__int64)&qword_1403569C8;
    KeInitializeTimer2((__int64)&KiForegroundState, (__int64)KiForegroundTimerCallback, 0LL, 8LL);
    KeInitializeDpc((PRKDPC)&stru_140356948, (PKDEFERRED_ROUTINE)KiProcessPendingForegroundBoosts, 0LL);
    KeInitializeDpc(&stru_140356988, (PKDEFERRED_ROUTINE)KiTriggerForegroundBoostDpc, 0LL);
  }
  v6 = 0;
