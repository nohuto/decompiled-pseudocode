/*
 * XREFs of CmpKeyEnumStackAdvanceInternal @ 0x1406702E8
 * Callers:
...
__int64 __fastcall CmpKeyEnumStackAdvanceInternal(__int64 a1)
{
      ...
      do
      {
        ...
        if ( EntryAtLayerHeight[2] )
        {
          ...
          *((_DWORD *)EntryAtLayerHeight + 2) = -1;
          HvpGetCellContextReinitialize((__int64)(EntryAtLayerHeight + 3));
        }
        ++v3;
      }
      while ( v3 <= *(__int16 *)a1 );
  ...
  *(_BYTE *)(a1 + 2) = 1;
  ...
  do
  {
    ...
    v11 = *(_QWORD *)(v10 + 104);
    if ( v11 && (!v8 || (int)CmpCompareKeysByName(*(_QWORD *)(v10 + 104), v8) < 0) )
    {
      v8 = v11;
      v9 = v7;
    }
