/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_FrameworkScalability@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180030054
 * Callers:
...
__int64 wil::Feature<__WilFeatureTraits_Feature_FrameworkScalability>::GetCachedFeatureEnabledState()
{
  ...
  else
  {
    ...
    if ( (unsigned int)wil_HasFeatureTestState(7328759, (enum wil_FeatureEnabledState *)&v11) )
    {
      v3 = v11;
      goto LABEL_11;
    }
...
LABEL_11:
  ...
  {
    if ( *((_DWORD *)i + 1) == 7328759 && !*(_DWORD *)i )
    {
      v7 = 1;
      break;
    }
...
LABEL_22:
    ...
    {
      do
        v9 = `wil::Feature<__WilFeatureTraits_Feature_FrameworkScalability>::GetFeaturePropertyCache'::`2'::data;
