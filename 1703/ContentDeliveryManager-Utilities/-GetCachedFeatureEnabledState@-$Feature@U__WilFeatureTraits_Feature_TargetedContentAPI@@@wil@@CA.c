/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_TargetedContentAPI@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18003D708
 * Callers:
...
__int64 wil::Feature<__WilFeatureTraits_Feature_TargetedContentAPI>::GetCachedFeatureEnabledState()
{
  ...
  int v9; // r9d
  __int16 v11; // [rsp+24h] [rbp-Ch]
  int v12; // [rsp+68h] [rbp+38h] BYREF
  int v13; // [rsp+70h] [rbp+40h]
  __int16 v14; // [rsp+74h] [rbp+44h]
  ...
  {
    v2 = ((__int64 (__fastcall *)(__int64, _QWORD))g_wil_details_internalGetFeatureEnabledState)(8299381LL, 0LL);
  }
  else
  {
    ...
    if ( (unsigned int)wil_HasFeatureTestState(8299381, (enum wil_FeatureEnabledState *)&v12) )
    {
      v3 = v12;
      goto LABEL_11;
    }
    v2 = ((__int64 (__fastcall *)(__int64, _QWORD))g_wil_details_apiGetFeatureEnabledState)(8299381LL, 0LL);
  }
  v3 = v2;
LABEL_11:
  v1 = 2;
  ...
  {
    if ( *((_DWORD *)i + 1) == 8299381 && !*(_DWORD *)i )
    {
      v7 = 1;
      break;
    }
...
LABEL_27:
    ...
    {
      do
        v9 = `wil::Feature<__WilFeatureTraits_Feature_TargetedContentAPI>::GetFeaturePropertyCache'::`2'::data;
      while ( (((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_TargetedContentAPI>::GetFeaturePropertyCache'::`2'::data >> 4) & 3) != (unsigned __int8)v4
           && v9 != _InterlockedCompareExchange(
                      &`wil::Feature<__WilFeatureTraits_Feature_TargetedContentAPI>::GetFeaturePropertyCache'::`2'::data,
                      ((unsigned __int8)`wil::Feature<__WilFeatureTraits_Feature_TargetedContentAPI>::GetFeaturePropertyCache'::`2'::data ^ (unsigned __int8)(16 * v4)) & 0x30 ^ `wil::Feature<__WilFeatureTraits_Feature_TargetedContentAPI>::GetFeaturePropertyCache'::`2'::data,
                      `wil::Feature<__WilFeatureTraits_Feature_TargetedContentAPI>::GetFeaturePropertyCache'::`2'::data) );
    }
    else
    {
