/*
 * XREFs of ?_Getffldx@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x1800633E4
 * Callers:
        ...
        int *a6)
{
  ...
  size_t v78[3]; // [rsp+80h] [rbp-71h] BYREF
  ...
  v10 = std::use_facet<std::numpunct<wchar_t>>(v9);
  v74 = v10;
  if ( v72 )
  {
...
LABEL_13:
  *v15 = 30768;
  ...
  LOWORD(v78[0]) = 0;
  v78[2] = 1LL;
  v28 = std::istreambuf_iterator<wchar_t>::equal(a3, v71);
  v29 = (size_t *)v78[0];
  if ( v28 )
  {
LABEL_57:
...
LABEL_51:
    std::istreambuf_iterator<unsigned short>::_Inc(a3);
    if ( std::istreambuf_iterator<wchar_t>::equal(a3, v71) )
      goto LABEL_52;
  }
  v37 = v78;
  if ( v27 >= 0x10 )
