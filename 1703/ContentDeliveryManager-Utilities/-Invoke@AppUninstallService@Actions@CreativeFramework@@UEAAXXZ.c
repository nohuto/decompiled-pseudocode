/*
 * XREFs of ?Invoke@AppUninstallService@Actions@CreativeFramework@@UEAAXXZ @ 0x180056F80
 * Callers:
 *     <none>
 * Callees:
        ...
        CreativeFramework::Actions::AppUninstallService *this)
{
  ...
  wil::ActivateInstance<ContentManagement::IContentManagementBroker>(&v8);
  v7 = 0LL;
  v2 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v8 + 48LL))(v8, &v7);
  if ( v2 < 0 )
  {
  ...
  v6 = (*(__int64 (__fastcall **)(__int64, PVOID))(*(_QWORD *)v4 + 72LL))(v4, v5[1].Reserved.Reserved1);
  if ( v6 < 0 )
    wil::details::in1diag3::_Throw_Hr(
      retaddr,
      (void *)0xDB,
