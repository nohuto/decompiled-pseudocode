/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_SilentInstalledApps@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800310CC
 * Callers:
...
__int64 wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetCachedFeatureEnabledState()
{
  ...
  else
  {
    ...
    if ( (unsigned int)wil_HasFeatureTestState(8025889, (enum wil_FeatureEnabledState *)&v12) )
    {
      v3 = v12;
      goto LABEL_11;
    }
...
LABEL_11:
  ...
  {
    if ( *((_DWORD *)i + 1) == 8025889 && !*(_DWORD *)i )
    {
      v7 = 1;
      break;
    }
...
LABEL_27:
    ...
    {
      do
        v9 = `wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data;
      while ( (((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data >> 4) & 3) != (unsigned __int8)v4
           && v9 != _InterlockedCompareExchange(
                      &`wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data,
                      ((unsigned __int8)`wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data ^ (unsigned __int8)(16 * v4)) & 0x30 ^ `wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data,
                      `wil::Feature<__WilFeatureTraits_Feature_SilentInstalledApps>::GetFeaturePropertyCache'::`2'::data) );
    }
    else
    {
