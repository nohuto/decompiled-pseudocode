/*
 * XREFs of ?_FailFast_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x1800589CC
 * Callers:
        ...
        const char *a4)
{
  ...
  wil::details::ReportFailure_Hr((__int64)this, 0xA37u, (__int64)"wil", 0LL, 0LL, retaddr, 3, (unsigned int)a4);
}
