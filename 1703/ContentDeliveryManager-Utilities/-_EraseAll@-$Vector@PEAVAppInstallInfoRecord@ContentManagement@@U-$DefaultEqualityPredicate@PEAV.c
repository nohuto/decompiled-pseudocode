  ...
  *(_QWORD *)(a1 + 80) = 0LL;
  ...
  else if ( v3 )
  {
    if ( (_DWORD)v4 )
    {
      ...
      do
      {
        XWinRT::InterfaceLifetimeTraits::Destroy<ContentManagement::IAppInstallInfoRecord>(v5, a2, a3);
        v5 += 16;
        --v6;
      }
      while ( v6 );
