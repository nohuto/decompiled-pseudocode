        ...
        __int64 a2)
{
  ...
  else if ( _InterlockedIncrement((volatile signed __int32 *)(a1 + 12)) == 1 )
  {
    ...
    {
      v18 = 0LL;
      AgileReference = RoGetAgileReference(0LL, &GUID_ff35ba04_0b83_5f86_aa01_90b39bdb586f, a2, &v18);
      if ( AgileReference < 0 )
      {
        v7 = v18;
      }
