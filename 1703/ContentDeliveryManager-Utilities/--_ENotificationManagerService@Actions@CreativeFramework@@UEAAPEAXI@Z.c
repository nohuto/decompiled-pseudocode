/*
 * XREFs of ??_ENotificationManagerService@Actions@CreativeFramework@@UEAAPEAXI@Z @ 0x180061420
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  std::unique_ptr<CreativeFramework::NotificationManager::ToastHelpers>::_Delete((char *)this + 104);
  v4 = (char *)this + 88;
