/*
 * XREFs of _wil::GetActivationFactory_Windows::Services::TargetedContent::ITargetedContentContainerStatics__::_1_::dtor$0 @ 0x180072553
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall wil::GetActivationFactory_Windows::Services::TargetedContent::ITargetedContentContainerStatics__::_1_::dtor_0(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
