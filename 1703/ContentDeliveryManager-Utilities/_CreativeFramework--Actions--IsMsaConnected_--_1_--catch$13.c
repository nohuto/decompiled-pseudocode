/*
 * XREFs of _CreativeFramework::Actions::IsMsaConnected_::_1_::catch$13 @ 0x18007384F
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CreativeFramework::Actions::IsMsaConnected_::_1_::catch_13(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
