/*
 * XREFs of ?do_truename@?$numpunct@_W@std@@MEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@XZ @ 0x180064170
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::numpunct<wchar_t>::do_truename(__int64 a1, _QWORD *a2)
{
