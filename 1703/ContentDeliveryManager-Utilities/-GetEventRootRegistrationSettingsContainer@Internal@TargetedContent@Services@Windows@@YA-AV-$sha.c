/*
 * XREFs of ?GetEventRootRegistrationSettingsContainer@Internal@TargetedContent@Services@Windows@@YA?AV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@XZ @ 0x18004C45C
 * Callers:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::GetEventRootRegistrationSettingsContainer(__int64 a1)
{
  __int64 v2; // rbx
  ...
  v3 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v9, (const WCHAR **)off_180089138);
  LOBYTE(v4) = 1;
