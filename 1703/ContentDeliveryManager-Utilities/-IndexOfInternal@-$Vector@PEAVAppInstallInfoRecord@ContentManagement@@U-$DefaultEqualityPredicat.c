        ...
        _BYTE *a6)
{
  ...
  for ( i = 0; i < a3; ++i )
  {
    ...
    {
      v19 = 0LL;
      v9 = (*(__int64 (__fastcall **)(__int64, _QWORD, GUID *, __int64 *))(*(_QWORD *)qword_1800F4758 + 40LL))(
             qword_1800F4758,
