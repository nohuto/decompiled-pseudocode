        ...
        __int64 a1)
{
  ...
  if ( *(_QWORD *)(a1 + 16) && _InterlockedIncrement((volatile signed __int32 *)(a1 + 8)) == 1 )
  {
    ...
    if ( (**(int (__fastcall ***)(__int64, GUID *, __int64 *))a1)(a1, &GUID_6c200718_e9a6_597e_84e2_fb5c63be8174, &v13) >= 0 )
    {
      v12 = -2;
