        ...
        __int64 a1)
{
  ...
  v1 = a1 - 176;
  if ( *(int *)(a1 - 176 + 128) > 0 && _InterlockedExchangeAdd((volatile signed __int32 *)(v1 + 128), 0xFFFFFFFF) == 1 )
  {
    _InterlockedOr(v4, 0);
    v2 = *(_QWORD *)(v1 + 112);
    if ( v2 )
