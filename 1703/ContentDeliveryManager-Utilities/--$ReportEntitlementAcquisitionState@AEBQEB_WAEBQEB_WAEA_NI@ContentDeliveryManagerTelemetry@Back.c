/*
 * XREFs of ??$ReportEntitlementAcquisitionState@AEBQEB_WAEBQEB_WAEA_NI@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEBQEB_W0AEA_N$$QEAI@Z @ 0x18005770C
 * Callers:
        ...
        __int64 a4)
{
  ...
  const WCHAR *v16; // [rsp+58h] [rbp-9h]
  int v17; // [rsp+60h] [rbp-1h]
  int v18; // [rsp+64h] [rbp+3h]
  const WCHAR *v19; // [rsp+68h] [rbp+7h]
  ...
  if ( *(_DWORD *)v8 > 5u )
  {
      ...
      && (*((_QWORD *)v9 + 3) & 0x400000000000LL) == *((_QWORD *)v9 + 3) )
    {
      ...
      v24 = a4;
      v25 = 4LL;
      LODWORD(v8) = TlgWrite(v9, &unk_1800E03CF, 0LL, 0LL, 6u, &pData);
    }
  }
  return (int)v8;
}
