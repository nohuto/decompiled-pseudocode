        ...
        _QWORD *a3)
{
  ...
  if ( v4 )
  {
    ...
    while ( 1 )
    {
      v17 = XWinRT::InterfaceLifetimeTraits::Construct<Windows::Services::TargetedContent::Internal::ITargetedContentTriggerInternal>(
              &v3[(unsigned int)v10],
              *a3);
      v9 = v17;
      if ( v17 < 0 )
...
LABEL_11:
  ...
  if ( v3 )
  {
    if ( (_DWORD)v10 )
    {
      ...
      do
      {
        XWinRT::InterfaceLifetimeTraits::Destroy<ContentManagement::IAppInstallInfoRecord>(v14);
        v14 += 16LL;
        --v10;
      }
      while ( v10 );
