/*
 * XREFs of ?SetUriParam@CreativeEventUriParser@LaunchCreativeHelpers@CreativeFramework@@AEAAJPEBG0@Z @ 0x180044E10
 * Callers:
...
LABEL_6:
  ...
  v8 = Windows::Internal::NativeString<Windows::Internal::CoTaskMemPolicy<unsigned short>>::Initialize(
         (char *)this + 24 * v7,
         a3);
  if ( (v8 & 0x80000000) == 0 )
    return v8;
