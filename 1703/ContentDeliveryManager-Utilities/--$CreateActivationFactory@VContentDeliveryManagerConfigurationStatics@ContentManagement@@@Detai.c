/*
 * XREFs of ??$CreateActivationFactory@VContentDeliveryManagerConfigurationStatics@ContentManagement@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x180021340
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a4)
{
  ...
  if ( v9 )
  {
    ...
    *((_QWORD *)v10 + 4) = &ContentManagement::ContentDeliveryManagerConfigurationStatics::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,Microsoft::WRL::Details::InterfaceList<ContentManagement::IContentDeliveryManagerConfiguration,Microsoft::WRL::Details::Nil>,1,0>'};
