/*
 * XREFs of ?_Getffld@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@1AEAVios_base@2@PEAH@Z @ 0x1800628AC
 * Callers:
 ...
 *     ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEAN@Z @ 0x180061D50 (-do_get@-$num_get@_WV-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@MEB_ea_180061D50.c)
 *     ?do_get@?$num_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHAEAM@Z @ 0x180061E30 (-do_get@-$num_get@_WV-$istreambuf_iterator@_WU-$char_traits@_W@std@@@std@@@std@@MEB_ea_180061E30.c)
 * Callees:
        ...
        __int64 a6)
{
  ...
  size_t v69[3]; // [rsp+78h] [rbp-59h] BYREF
  ...
  v11 = std::use_facet<std::numpunct<wchar_t>>(v10);
  v64 = v11;
  if ( v65 )
  {
...
LABEL_44:
      ...
      if ( std::istreambuf_iterator<wchar_t>::equal(a3, v63) )
        goto LABEL_45;
    }
  }
  if ( !std::istreambuf_iterator<wchar_t>::equal(a3, v6) )
