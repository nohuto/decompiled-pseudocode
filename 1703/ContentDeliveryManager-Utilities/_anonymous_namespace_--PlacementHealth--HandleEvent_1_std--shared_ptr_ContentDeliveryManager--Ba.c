/*
 * XREFs of _anonymous_namespace_::PlacementHealth::HandleEvent_1_std::shared_ptr_ContentDeliveryManager::Background::CorrelationVectorWrapper___ @ 0x180033608
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::StartsWith @ 0x180027570 (_anonymous_namespace_--StartsWith.c)
        ...
        __int64 *a2)
{
  ...
  {
    v5 = std::shared_ptr<CreativeFramework::RuleSetHandlers::CreativeRule>::shared_ptr<CreativeFramework::RuleSetHandlers::CreativeRule>(
           &v11,
           a2);
  ...
  {
    v6 = std::shared_ptr<CreativeFramework::RuleSetHandlers::CreativeRule>::shared_ptr<CreativeFramework::RuleSetHandlers::CreativeRule>(
           &v12,
           a2);
  ...
  else if ( anonymous_namespace_::StartsWith(Src) )
  {
    ...
    v8 = std::shared_ptr<CreativeFramework::RuleSetHandlers::CreativeRule>::shared_ptr<CreativeFramework::RuleSetHandlers::CreativeRule>(
           &v13,
           a2);
