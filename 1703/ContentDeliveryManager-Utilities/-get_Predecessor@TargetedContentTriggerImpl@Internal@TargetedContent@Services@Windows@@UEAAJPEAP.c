/*
 * XREFs of ?get_Predecessor@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAPEAUHSTRING__@@@Z @ 0x180045E50
 * Callers:
 *     <none>
 * Callees:
        ...
        HSTRING *a2)
{
  ...
  v2 = WindowsDuplicateString(this[12], a2);
  v3 = v2;
  if ( v2 >= 0 )
    return 0LL;
