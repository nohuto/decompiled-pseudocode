/*
 * XREFs of ?Close@?$AsyncBase@UIAsyncActionCompletedHandler@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncCausalityOptions@$1?ProcessCreativeEventOperationName@?A0xb8965cb7@@3QBGB$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@UEAAJXZ @ 0x18001BAF0
 * Callers:
 *     <none>
 * Callees:
        ...
        volatile signed __int32 *a1)
{
  ...
  v3 = v6;
  if ( v6 - 1 <= 3 && (_DWORD)v3 == _InterlockedCompareExchange(a1 + 10, 4, v6) )
  {
