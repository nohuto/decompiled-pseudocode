/*
 * XREFs of ?GetIids@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x18001FE80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        struct _GUID **a3)
{
  ...
  *a2 = 0;
  ...
  if ( v6 )
  {
    *v6 = GUID_f4251157_4c58_48fe_b495_bcaf364fbb3c;
