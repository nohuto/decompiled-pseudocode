/*
 * XREFs of ?StartThreadWithFallback@CThread@ComTaskPool@Internal@Windows@@QEAAJXZ @ 0x180004B0C
 * Callers:
...
__int64 __fastcall Windows::Internal::ComTaskPool::CThread::StartThreadWithFallback(HMODULE *pv)
{
  ...
  v3 = operator new(0x20uLL, (const struct std::nothrow_t *)&TLV::nothrow);
  v4 = (HMODULE)v3;
  if ( v3 )
  {
    v5 = pv[18];
