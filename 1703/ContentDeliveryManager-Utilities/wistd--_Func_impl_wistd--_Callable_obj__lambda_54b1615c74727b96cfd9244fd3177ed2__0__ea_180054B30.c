/*
 * XREFs of wistd::_Func_impl_wistd::_Callable_obj__lambda_54b1615c74727b96cfd9244fd3177ed2__0__wistd::details::function_allocator_wistd::_Func_class_void_long_Windows::Storage::IStorageFolder_____ptr64_wistd::_Nil_wistd::_Nil_wistd::_Nil_wistd::_Nil_wistd::_Nil____void_long_Windows::Storage::IStorageFolder_____ptr64_wistd::_Nil_wistd::_Nil_wistd::_Nil_wistd::_Nil_wistd::_Nil_::_Copy @ 0x180054B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall wistd::_Func_impl_wistd::_Callable_obj__lambda_54b1615c74727b96cfd9244fd3177ed2__0__wistd::details::function_allocator_wistd::_Func_class_void_long_Windows::Storage::IStorageFolder_____ptr64_wistd::_Nil_wistd::_Nil_wistd::_Nil_wistd::_Nil_wistd::_Nil____void_long_Windows::Storage::IStorageFolder_____ptr64_wistd::_Nil_wistd::_Nil_wistd::_Nil_wistd::_Nil_wistd::_Nil_::_Copy(
        __int64 a1,
        __int64 a2)
{
  if ( !a2 )
    __fastfail(7u);
  *(_QWORD *)a2 = off_180080BE0;
  ...
  *(_QWORD *)(a2 + 40) = 0LL;
  *(_WORD *)(a2 + 24) = 0;
  std::wstring::assign((void **)(a2 + 24), (void **)(a1 + 24), 0LL, 0xFFFFFFFFFFFFFFFFuLL);
