/*
 * XREFs of ??$CreateActivationFactory@VTargetedContentTriggerManagerStatics@Internal@TargetedContent@Services@Windows@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x1800218A0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a4)
{
  ...
  if ( v9 )
  {
    ...
    *(_QWORD *)(v10 + 32) = &Microsoft::WRL::ActivationFactory<Microsoft::WRL::Implements<Microsoft::WRL::FtmBase,Windows::Services::TargetedContent::Internal::ITargetedContentTriggerManagerStaticsInternal,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil>,Microsoft::WRL::Details::Nil,Microsoft::WRL::Details::Nil,0>::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,Microsoft::WRL::Details::InterfaceList<Windows::Services::TargetedContent::Internal::ITargetedContentTriggerManagerStaticsInternal,Microsoft::WRL::Details::Nil>,1,0>'};
    *(_DWORD *)(v10 + 44) = 1;
    *(_DWORD *)(v10 + 64) = 4;
    if ( !v12 )
    ...
    *(_QWORD *)(v10 + 32) = &Windows::Services::TargetedContent::Internal::TargetedContentTriggerManagerStatics::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<1>,Microsoft::WRL::Details::InterfaceList<Windows::Services::TargetedContent::Internal::ITargetedContentTriggerManagerStaticsInternal,Microsoft::WRL::Details::Nil>,1,0>'};
    v13 = *(_DWORD *)(v10 + 44);
    if ( v13 == 0x7FFFFFFF )
      goto LABEL_9;
    do
...
LABEL_9:
    ...
    {
      if ( *(_DWORD *)a3 != -1905802574
        || *(_DWORD *)(a3 + 4) != *(_DWORD *)&GUID_8e67c2b2_5490_4ab7_b9d1_f722fa29af14.Data2
        || *(_DWORD *)(a3 + 8) != *(_DWORD *)GUID_8e67c2b2_5490_4ab7_b9d1_f722fa29af14.Data4
        || *(_DWORD *)(a3 + 12) != *(_DWORD *)&GUID_8e67c2b2_5490_4ab7_b9d1_f722fa29af14.Data4[4] )
      {
        v15 = -2147467262;
        goto LABEL_31;
      }
