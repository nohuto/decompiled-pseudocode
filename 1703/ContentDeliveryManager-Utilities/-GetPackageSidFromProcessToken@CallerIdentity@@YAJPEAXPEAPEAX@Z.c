/*
 * XREFs of ?GetPackageSidFromProcessToken@CallerIdentity@@YAJPEAXPEAPEAX@Z @ 0x1800452C8
 * Callers:
...
__int64 __fastcall CallerIdentity::GetPackageSidFromProcessToken(HANDLE TokenHandle, _QWORD *a2, void **a3)
{
  ...
  v5 = -GetTokenInformation(TokenHandle, TokenAppContainerSid, 0LL, 0, (PDWORD)&uBytes);
  v6 = v5 != 0 ? 0x8000FFFF : 0;
  if ( !v5 )
  {
