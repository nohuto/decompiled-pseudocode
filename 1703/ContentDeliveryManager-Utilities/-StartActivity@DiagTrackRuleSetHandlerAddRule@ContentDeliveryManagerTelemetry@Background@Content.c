/*
 * XREFs of ?StartActivity@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEB_WIPEBD@Z @ 0x180051064
 * Callers:
 *     ??$Start@PEB_WIPEBD@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SA?AV0123@$$QEAPEB_W$$QEAI$$QEAPEBD@Z @ 0x180053878 (--$Start@PEB_WIPEBD@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@Co.c)
 * Callees:
        ...
        const char *a4)
{
  ...
  *(_DWORD *)v7 = 1;
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
    ...
    TlgWrite(v10, &unk_1800DFC9C, (LPCGUID)(v16 + 8), v17, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
