/*
 * XREFs of __GSHandlerCheck_EH @ 0x18006F9A8
 * Callers:
 *     <none>
 * Callees:
 *     __CxxFrameHandler3_0 @ 0x18006F39C (__CxxFrameHandler3_0.c)
 *     __GSHandlerCheckCommon @ 0x18006F93C (__GSHandlerCheckCommon.c)
 */
