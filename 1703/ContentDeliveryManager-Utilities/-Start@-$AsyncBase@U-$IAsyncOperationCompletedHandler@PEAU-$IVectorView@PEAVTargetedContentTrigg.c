        ...
        __int64 a1)
{
  ...
  if ( v7 == -1 && (v3 = _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 40), 0, -1), v3 == v7) )
  {
    ...
    {
      v8 = L"Windows.Foundation.AsyncOperationCompletedHandler`1<Windows.Foundation.Collections.IVectorView`1<Windows.Serv"
            "ices.TargetedContent.Internal.TargetedContentTriggerInternal>>";
