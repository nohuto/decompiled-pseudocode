        ...
        __int64 *a5)
{
  ...
  {
    v9 = a1[1];
    if ( (__int64)(a1[2] - v9) >> 3 >= a4 )
    {
      v19 = a1[1];
      if ( (__int64)(v9 - a3) >> 3 >= a4 )
      {
        v24 = *a5;
        v25 = a4;
        v26 = (__int64 *)(v9 - 8 * a4);
        for ( a1[1] = (unsigned __int64)std::_Uninit_move<std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0> *,std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0> *,std::_Wrap_alloc<std::allocator<std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0>>>,std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0>>(
                                          (unsigned __int64)v26,
                                          v19,
                                          (_QWORD *)a1[1]); v26 != v6; v26[v25] = *v26 )
          --v26;
        v27 = &v6[v25];
        while ( v6 != v27 )
          *v6++ = v24;
    ...
    else
    {
      ...
      a1[2] = (unsigned __int64)&v15[8 * v11];
