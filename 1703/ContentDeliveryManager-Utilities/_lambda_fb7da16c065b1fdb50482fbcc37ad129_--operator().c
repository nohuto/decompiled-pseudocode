/*
 * XREFs of _lambda_fb7da16c065b1fdb50482fbcc37ad129_::operator() @ 0x180042754
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_fb7da16c065b1fdb50482fbcc37ad129____Windows::Internal::CNoResult_::Run @ 0x180043770 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_fb7da16c065b1fd.c)
 * Callees:
...
__int64 __fastcall lambda_fb7da16c065b1fdb50482fbcc37ad129_::operator()(__int64 a1)
{
  const char *v2; // r9
  ...
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionReverted::Start<unsigned short const *,unsigned short const *,unsigned short const *>((ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionReverted *)v14);
  if ( v7 >= 8 )
  ...
  try
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 64LL) + 16LL))(*(_QWORD *)(*(_QWORD *)a1 + 64LL));
  }
  catch ( ... )
  {
    v4 = wil::details::in1diag3::Return_CaughtException(
           ...
           v2);
    v14[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionReverted::`vftable';
