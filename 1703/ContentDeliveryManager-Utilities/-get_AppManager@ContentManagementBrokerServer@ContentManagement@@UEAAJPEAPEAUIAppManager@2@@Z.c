/*
 * XREFs of ?get_AppManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIAppManager@2@@Z @ 0x18000ED60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  *v8 = &ContentManagement::AppManager::`vftable'{for `IInspectable'};
  *v10 = &ContentManagement::AppManager::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::Details::InterfaceList<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::InterfaceList<IWeakReferenceSource,Microsoft::WRL::Details::InterfaceList<ContentManagement::IAppManager,Microsoft::WRL::Details::Nil>>>,1,1>'};
  v8[4] = &ContentManagement::AppManager::`vftable'{for `IWeakReferenceSource'};
  v8[5] = &ContentManagement::AppManager::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::Details::InterfaceList<ContentManagement::IAppManager,Microsoft::WRL::Details::Nil>,1,0>'};
  v9 = ((__int64 (__fastcall *)(_QWORD *, GUID *, _QWORD))ContentManagement::AppManager::`vftable'{for `IInspectable'})(
         v8,
         &GUID_05e033e9_71df_4144_a1c6_a80806e71984,
         &v17);
  (*(void (__fastcall **)(_QWORD *))(*v8 + 16LL))(v8);
  if ( v9 < 0 )
    goto LABEL_13;
  v13 = (**v17)(v17, &GUID_05e033e9_71df_4144_a1c6_a80806e71984, a2);
  v9 = v13;
  if ( v13 >= 0 )
  {
    v9 = 0;
