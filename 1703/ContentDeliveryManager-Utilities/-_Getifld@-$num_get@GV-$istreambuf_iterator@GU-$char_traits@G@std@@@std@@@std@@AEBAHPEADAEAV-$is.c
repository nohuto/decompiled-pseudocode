/*
 * XREFs of ?_Getifld@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@AEBAHPEADAEAV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@1HAEBVlocale@2@@Z @ 0x18002F7D8
 * Callers:
 ...
 *     ?do_get@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHAEA_J@Z @ 0x18002E080 (-do_get@-$num_get@GV-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@MEBA-A_ea_18002E080.c)
 ...
 *     ?do_get@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHAEAJ@Z @ 0x18002E2E0 (-do_get@-$num_get@GV-$istreambuf_iterator@GU-$char_traits@G@std@@@std@@@std@@MEBA-A_ea_18002E2E0.c)
        ...
        __int64 a6)
{
  ...
  _QWORD *v39; // rax
  char *v40; // rax
  __int16 v42; // [rsp+38h] [rbp-99h]
  __int16 v43; // [rsp+3Ah] [rbp-97h]
  int v44; // [rsp+3Ch] [rbp-95h]
  unsigned __int64 v45; // [rsp+40h] [rbp-91h]
  __int64 v48; // [rsp+60h] [rbp-71h]
  _QWORD v49[3]; // [rsp+68h] [rbp-69h] BYREF
  __int64 v50; // [rsp+80h] [rbp-51h]
  _QWORD v51[3]; // [rsp+88h] [rbp-49h] BYREF
  unsigned __int64 v52; // [rsp+A0h] [rbp-31h]
  _WORD v53[28]; // [rsp+A8h] [rbp-29h] BYREF

  HIBYTE(v48) = -1;
  v8 = a2;
  v9 = std::use_facet<std::numpunct<unsigned short>>(a6);
  std::numpunct<unsigned short>::grouping(v9, (__int64)v51);
  if ( v51[2] )
    v43 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v9 + 32LL))(v9);
  else
    v43 = 0;
...
LABEL_24:
  ...
  if ( (unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, a4)
    || (v19 = (_WORD *)std::istreambuf_iterator<unsigned short>::operator*(a3), *v19 != v53[25])
    && (v20 = (_WORD *)std::istreambuf_iterator<unsigned short>::operator*(a3), *v20 != v53[24])
    || (v16 & 0xFFFFFFEF) != 0 )
  {
    if ( !v16 )
      v16 = 8;
...
LABEL_29:
  ...
  while ( 1 )
  {
    ...
    *v11 = v29;
    if ( (HIBYTE(v42) || v29 != 48) && v11 < v8 + 31 )
    {
      ++v11;
      HIBYTE(v42) = 1;
    }
...
LABEL_52:
  ...
  if ( v22 >= 0x10 )
    v32 = v24;
  if ( *((_BYTE *)v32 + v23) && v43 && *(_WORD *)std::istreambuf_iterator<unsigned short>::operator*(a3) == v43 )
  {
    std::string::append(v49, 1LL);
    ++v23;
    goto LABEL_51;
  }
LABEL_53:
