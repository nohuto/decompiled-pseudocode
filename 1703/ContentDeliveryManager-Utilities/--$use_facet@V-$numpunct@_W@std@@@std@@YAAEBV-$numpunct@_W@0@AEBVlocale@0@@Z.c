/*
 * XREFs of ??$use_facet@V?$numpunct@_W@std@@@std@@YAAEBV?$numpunct@_W@0@AEBVlocale@0@@Z @ 0x180064470
 * Callers:
 ...
 *     ?_Facet_Register@std@@YAXPEAV_Facet_base@1@@Z @ 0x18006B148 (-_Facet_Register@std@@YAXPEAV_Facet_base@1@@Z.c)
 *     ?_Getgloballocale@locale@std@@CAPEAV_Locimp@12@XZ @ 0x18006B180 (-_Getgloballocale@locale@std@@CAPEAV_Locimp@12@XZ.c)
