        ...
        void **a2)
{
  ...
  if ( v7 )
  {
    ...
    (*(void (__fastcall **)(PVOID, GUID *, PVOID *))(*(_QWORD *)v7 + 24LL))(
      v7,
      &GUID_45028a9c_53a4_5173_b928_7e53e1d6acfd,
      &v12);
    ...
    {
      v13 = 0LL;
      if ( (int)RoGetAgileReference(0LL, &GUID_45028a9c_53a4_5173_b928_7e53e1d6acfd, v12, &v13) < 0 )
      {
        v9 = v13;
      }
      else
  ...
  *a2 = 0LL;
  ...
  {
    v10 = CMarshaledInterface::_Unmarshal((CMarshaledInterface *)&v14, &GUID_45028a9c_53a4_5173_b928_7e53e1d6acfd, a2);
    Ptr = v14;
  }
  else
  {
