/*
 * XREFs of ??5?$basic_istream@_WU?$char_traits@_W@std@@@std@@QEAAAEAV01@AEA_K@Z @ 0x1800618F8
 * Callers:
 ...
 *     ?_Ipfx@?$basic_istream@_WU?$char_traits@_W@std@@@std@@QEAA_N_N@Z @ 0x18006487C (-_Ipfx@-$basic_istream@_WU-$char_traits@_W@std@@@std@@QEAA_N_N@Z.c)
...
__int64 __fastcall std::wistream::operator>>(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)std::wistream::_Ipfx(v3) )
  {
    ...
    v6 = std::use_facet<std::num_get<wchar_t,std::istreambuf_iterator<wchar_t>>>(v5);
    if ( v25 )
    {
