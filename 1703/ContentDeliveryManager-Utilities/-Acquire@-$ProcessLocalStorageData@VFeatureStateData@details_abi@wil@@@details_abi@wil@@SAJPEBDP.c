/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x180012254
 * Callers:
 ...
 *     ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x180009294 (--0UsageIndexes@details_abi@wil@@QEAA@XZ.c)
 *     ?create@?$mutex_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@QEAAJPEBGKKPEAU_SECURITY_ATTRIBUTES@@@Z @ 0x180012E24 (-create@-$mutex_t@V-$unique_storage@U-$resource_policy@PEAXP6AXPEAX@Z$1-CloseHandle@details@wil@.c)
        ...
        _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v6 < 0 )
  {
    v14 = 286LL;
LABEL_31:
    wil::details::in1diag3::Return_Hr_NoOriginate(retaddr, (void *)v14, (__int64)"wil", (const char *)(unsigned int)v6);
    goto LABEL_17;
  }
  if ( !v9 )
  {
...
LABEL_17:
  ...
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x87B, v15, v16);
    __debugbreak();
  }
LABEL_3:
