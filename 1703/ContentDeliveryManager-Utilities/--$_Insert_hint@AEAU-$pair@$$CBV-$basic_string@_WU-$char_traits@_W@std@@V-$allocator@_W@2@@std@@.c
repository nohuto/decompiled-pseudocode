        ...
        __int64 a5)
{
  ...
  char v23[24]; // [rsp+38h] [rbp-30h] BYREF
  ...
  if ( a3 == *(__int64 **)*a1 )
  {
    if ( (unsigned __int8)std::less<std::wstring>::operator()((__int64)a1, a4, a3 + 4) )
    {
      std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_at<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
        a1,
        a2,
  ...
  else
  {
    ...
    if ( *(_BYTE *)(*v13 + 25) )
    {
      for ( i = v13[1]; !*(_BYTE *)(i + 25) && v14 == *(_QWORD *)i; i = *(_QWORD *)(i + 8) )
        v14 = i;
      v15 = (__int64 *)v14;
      if ( !*(_BYTE *)(v14 + 25) )
        v15 = (__int64 *)i;
  ...
  if ( (unsigned __int8)std::less<std::wstring>::operator()(i, v15 + 4, a4) )
  {
    if ( *(_BYTE *)(v15[2] + 25) )
      std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_at<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
        a1,
  ...
  {
LABEL_47:
    if ( !(unsigned __int8)std::less<std::wstring>::operator()(i, v13 + 4, a4) )
      goto LABEL_44;
    v19 = (__int64 *)v18;
    if ( !*(_BYTE *)(v18 + 25) )
    {
      ...
      if ( *(_BYTE *)(v20 + 25) )
      {
        for ( k = *(_QWORD *)(v18 + 8); !*(_BYTE *)(k + 25) && v19 == *(__int64 **)(k + 16); k = *(_QWORD *)(k + 8) )
          v19 = (__int64 *)k;
        v19 = (__int64 *)k;
      }
      else
    ...
    if ( v19 != (__int64 *)*a1 && !(unsigned __int8)std::less<std::wstring>::operator()(v17, a4, v19 + 4) )
    {
LABEL_44:
