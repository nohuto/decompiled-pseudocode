/*
 * XREFs of ?Stop@SubscriptionManagerContentUpdatedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXIIII@Z @ 0x1800387AC
 * Callers:
        ...
        int a3)
{
  ...
  EVENT_DATA_DESCRIPTOR v83; // [rsp+1B0h] [rbp+B0h] BYREF
  PSRWLOCK *v84; // [rsp+1D0h] [rbp+D0h]
  __int64 v85; // [rsp+1D8h] [rbp+D8h]
  DWORD *v86; // [rsp+1E0h] [rbp+E0h]
  ...
  int v96; // [rsp+288h] [rbp+188h] BYREF
  int v97; // [rsp+290h] [rbp+190h] BYREF
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v8 + 3) & 0x200000000000LL) == *((_QWORD *)v8 + 3) )
    {
      ...
      v80 = 4LL;
      v82 = 4LL;
      TlgWrite(v9, &unk_1800DF282, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x14u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v27 + 3) & 0x200000000000LL) == *((_QWORD *)v27 + 3) )
    {
      ...
      v93 = 4LL;
      v95 = 4LL;
      TlgWrite(v28, &unk_1800DF6B1, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 8u, &v83);
    }
  }
