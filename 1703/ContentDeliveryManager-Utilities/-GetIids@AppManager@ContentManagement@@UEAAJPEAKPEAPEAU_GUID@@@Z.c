/*
 * XREFs of ?GetIids@AppManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x18000AF00
 * Callers:
 *     ?GetIids@AppManager@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x18001F4E0 (-GetIids@AppManager@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
