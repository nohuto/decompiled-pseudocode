/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_AppInstallBatching@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180013278
 * Callers:
...
__int64 wil::Feature<__WilFeatureTraits_Feature_AppInstallBatching>::GetCachedFeatureEnabledState()
{
  ...
  else
  {
    ...
    if ( (unsigned int)wil_HasFeatureTestState(6867405, (enum wil_FeatureEnabledState *)&v11) )
    {
      v3 = v11;
      goto LABEL_11;
    }
...
LABEL_11:
  ...
  {
    if ( *((_DWORD *)i + 1) == 6867405 && !*(_DWORD *)i )
    {
      v7 = 1;
      break;
    }
