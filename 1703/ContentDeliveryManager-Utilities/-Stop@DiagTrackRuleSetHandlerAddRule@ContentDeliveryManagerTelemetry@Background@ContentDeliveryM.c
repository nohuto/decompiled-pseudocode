/*
 * XREFs of ?Stop@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBD@Z @ 0x180051234
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v6 )
  {
    ...
    if ( *(_DWORD *)v8 > 5u )
    {
      ...
      v90 = v12 + 1;
      v91 = 0;
      TlgWrite(v8, &unk_1800E00FD, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x14u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v29 > 5u )
    {
      ...
      v98 = v32 + 1;
      v99 = 0;
      TlgWrite(v29, &unk_1800DFD77, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v92);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
