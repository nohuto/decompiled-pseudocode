/*
 * XREFs of _CreativeFramework::Actions::ConvertToStoreRecord_::_1_::dtor$4 @ 0x18007398D
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreativeFramework::Actions::ConvertToStoreRecord_::_1_::dtor_4(__int64 a1, __int64 a2)
{
  __int64 result; // rax
