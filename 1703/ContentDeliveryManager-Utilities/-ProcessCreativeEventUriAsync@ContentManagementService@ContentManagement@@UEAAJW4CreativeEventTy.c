/*
 * XREFs of ?ProcessCreativeEventUriAsync@ContentManagementService@ContentManagement@@UEAAJW4CreativeEventType@2@PEAUHSTRING__@@PEAU?$ITypedEventHandler@PEAUIInspectable@@PEAUHSTRING__@@@Foundation@Windows@@PEAUICreativeEventReportedCache@2@PEAPEAUIAsyncAction@67@@Z @ 0x180028290
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_M@YAXPEAX_K1P6AX0@Z@Z @ 0x18006F6AC (--_M@YAXPEAX_K1P6AX0@Z@Z.c)
 *     ??_L@YAXPEAX_K1P6AX0@Z2@Z @ 0x18006F88C (--_L@YAXPEAX_K1P6AX0@Z2@Z.c)
 */
        ...
        __int64 a6)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    {
      v15 += 2;
      if ( v15 == (_DWORD *)&TLV::nothrow )
        goto LABEL_9;
    }
    if ( v15[1] != -1 )
    {
      v16 = (const WCHAR *)v28[3 * v15[1]];
      goto LABEL_10;
    }
LABEL_9:
    v16 = 0LL;
LABEL_10:
    v22 = v16;
    if ( v16 )
      v17 = *(HSTRING *)Windows::Internal::StringReference::StringReference((__int64)v24, &v22);
    else
      v17 = 0LL;
    if ( v14 )
      v18 = *(HSTRING *)Windows::Internal::StringReference::StringReference((__int64)v25, v23);
    else
      v18 = 0LL;
    v23[0] = (const WCHAR *)v28[3];
    v22 = (const WCHAR *)v28[0];
    v19 = *(HSTRING *)Windows::Internal::StringReference::StringReference((__int64)v26, v23);
