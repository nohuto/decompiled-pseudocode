/*
 * XREFs of _anonymous_namespace_::GetImpressionEventExpirationTime @ 0x1800276B8
 * Callers:
 ...
 *     ??1?$vector@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$allocator@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@2@@std@@QEAA@XZ @ 0x18002AA1C (--1-$vector@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V-$allocator@V-$basic_.c)
 ...
 *     ??5?$basic_istream@GU?$char_traits@G@std@@@std@@QEAAAEAV01@AEA_K@Z @ 0x18002CE18 (--5-$basic_istream@GU-$char_traits@G@std@@@std@@QEAAAEAV01@AEA_K@Z.c)
 *     ??5?$basic_istream@GU?$char_traits@G@std@@@std@@QEAAAEAV01@AEAI@Z @ 0x18002CFA8 (--5-$basic_istream@GU-$char_traits@G@std@@@std@@QEAAAEAV01@AEAI@Z.c)
...
__int64 __fastcall anonymous_namespace_::GetImpressionEventExpirationTime(void *Src, _WORD *a2, __int64 a3)
{
  ...
  anonymous_namespace_::SplitString(&v15, (__int64)v20);
  if ( v22 >= 8 )
