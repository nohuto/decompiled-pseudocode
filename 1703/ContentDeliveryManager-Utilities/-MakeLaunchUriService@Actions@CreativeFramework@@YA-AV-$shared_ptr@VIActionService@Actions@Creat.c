 ...
 *     ??0LaunchUriService@Actions@CreativeFramework@@QEAA@QEB_WPEB_W1AEBV?$com_ptr_t@U?$IMapView@W4WindowPosition@ContentManagement@@I@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@0_N@Z @ 0x18005AB04 (--0LaunchUriService@Actions@CreativeFramework@@QEAA@QEB_WPEB_W1AEBV-$com_ptr_t@U-$IMapView@W4Win.c)
 ...
 *     ??$_Resetp@VLaunchUriService@Actions@CreativeFramework@@@?$shared_ptr@VIActionService@Actions@CreativeFramework@@@std@@AEAAXPEAVLaunchUriService@Actions@CreativeFramework@@@Z @ 0x18005E0EC (--$_Resetp@VLaunchUriService@Actions@CreativeFramework@@@-$shared_ptr@VIActionService@Actions@Cr.c)
...
_QWORD *__fastcall CreativeFramework::Actions::MakeLaunchUriService(_QWORD *a1, __int64 a2, void ***a3)
{
  ...
  if ( v8 )
  {
    ...
    if ( (unsigned __int64)v11[3] >= 8 )
      v11 = (void **)*v11;
    v14 = CreativeFramework::Actions::LaunchUriService::LaunchUriService(
            (__int64)v8,
            (char *)v11,
            v13,
            v12,
  ...
  *a1 = 0LL;
  a1[1] = 0LL;
  std::shared_ptr<CreativeFramework::Actions::IActionService>::_Resetp<CreativeFramework::Actions::LaunchUriService>(
    a1,
    v14);
  v15 = v5 | 0x10;
  if ( (v15 & 8) != 0 )
