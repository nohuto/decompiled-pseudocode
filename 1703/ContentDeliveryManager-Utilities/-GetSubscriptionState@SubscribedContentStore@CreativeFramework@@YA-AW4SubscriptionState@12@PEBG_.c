/*
 * XREFs of ?GetSubscriptionState@SubscribedContentStore@CreativeFramework@@YA?AW4SubscriptionState@12@PEBG_N@Z @ 0x1800390A8
 * Callers:
...
_BOOL8 __fastcall CreativeFramework::SubscribedContentStore::GetSubscriptionState(__int64 a1)
{
  ...
  __int16 dwHighDateTime; // [rsp+34h] [rbp-3Ch]
  LPVOID v11; // [rsp+38h] [rbp-38h]
  int v12; // [rsp+40h] [rbp-30h]
  LPVOID pv[5]; // [rsp+48h] [rbp-28h] BYREF
