/*
 * XREFs of ?do_get@?$num_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0AEAVios_base@2@AEAHAEA_N@Z @ 0x18002E680
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  if ( (*(_DWORD *)(a5 + 24) & 0x4000) != 0 )
  {
    ...
    v15 = std::numpunct<wchar_t>::truename(v12, (__int64)v32);
  ...
  if ( (unsigned __int8)std::istreambuf_iterator<wchar_t>::equal(a3, v17) )
    *a6 |= 1u;
  if ( v10 >= 0 )
    *v28 = v10 != 0;
  else
