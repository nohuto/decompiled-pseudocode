/*
 * XREFs of ?GetIids@?$ActivationFactory@U?$Implements@VFtmBase@WRL@Microsoft@@UIContentDeliveryManagerConfiguration@ContentManagement@@VNil@Details@23@V6723@V6723@V6723@V6723@V6723@V6723@V6723@@WRL@Microsoft@@VNil@Details@23@V4523@$0A@@WRL@Microsoft@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x18001FD40
 * Callers:
 *     ?GetIids@ContentDeliveryManagerConfigurationStatics@ContentManagement@@WCA@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180022670 (-GetIids@ContentDeliveryManagerConfigurationStatics@ContentManagement@@WCA@EAAJPEAKPEAPEAU_GUID@.c)
 * Callees:
 *     <none>
 */
