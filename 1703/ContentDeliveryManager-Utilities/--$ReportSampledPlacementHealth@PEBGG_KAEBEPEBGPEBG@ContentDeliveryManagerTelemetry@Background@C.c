/*
 * XREFs of ??$ReportSampledPlacementHealth@PEBGG_KAEBEPEBGPEBG@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEBG$$QEAG$$QEA_KAEBE00PEBD@Z @ 0x1800318D0
 * Callers:
        ...
        const unsigned __int16 *a7)
{
  ...
  const WCHAR *v20; // [rsp+58h] [rbp-51h]
  ...
  const WCHAR *v29; // [rsp+98h] [rbp-11h]
  int v30; // [rsp+A0h] [rbp-9h]
  int v31; // [rsp+A4h] [rbp-5h]
  const WCHAR *v32; // [rsp+A8h] [rbp-1h]
  int v33; // [rsp+B0h] [rbp+7h]
  int v34; // [rsp+B4h] [rbp+Bh]
  const unsigned __int16 *v35; // [rsp+B8h] [rbp+Fh]
  int v36; // [rsp+C0h] [rbp+17h]
  int v37; // [rsp+C4h] [rbp+1Bh]
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
      ...
      && (*((_QWORD *)v11 + 3) & 0x400000000000LL) == *((_QWORD *)v11 + 3) )
    {
      ...
      v36 = v14 + 1;
      v37 = 0;
      LODWORD(v10) = TlgWrite(v11, &unk_1800DE8BA, 0LL, 0LL, 9u, &pData);
    }
  }
  return (int)v10;
}
