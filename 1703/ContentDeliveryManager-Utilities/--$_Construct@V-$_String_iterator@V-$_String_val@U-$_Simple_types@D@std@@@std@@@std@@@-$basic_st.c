/*
 * XREFs of ??$_Construct@V?$_String_iterator@V?$_String_val@U?$_Simple_types@D@std@@@std@@@std@@@?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@QEAAXV?$_String_iterator@V?$_String_val@U?$_Simple_types@D@std@@@std@@@1@0Uforward_iterator_tag@1@@Z @ 0x1800333A0
 * Callers:
 *     _anonymous_namespace_::StringToWString @ 0x180027608 (_anonymous_namespace_--StringToWString.c)
 * Callees:
        ...
        char *a3)
{
  ...
  {
    while ( v5 != a3 )
      LOBYTE(v3) = (unsigned __int8)std::wstring::append((_WORD **)a1, 1uLL, *v5++);
  }
  catch ( ... )
  {
