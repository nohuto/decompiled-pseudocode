/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x18000A0D0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)this = 0LL;
  if ( wil::details::g_featureStateManager )
  {
    ...
    wil::details::FeatureStateManager::EnsureSubscribedToStateChangesUnderLock(
      (__int64 *)&xmmword_1800F3100,
      (const struct __WIL__WNF_TYPE_ID *)0x418A073AA3BC7C75LL,
      &wil::details::g_featureStateManager);
    wil::details::FeatureStateManager::EnsureSubscribedToStateChangesUnderLock(
      (__int64 *)&xmmword_1800F3100 + 1,
      (const struct __WIL__WNF_TYPE_ID *)0x418A073AA3BC88F5LL,
      &wil::details::g_featureStateManager);
    v7 = 0LL;
    v8 = (*(&xmmword_1800F3110 + 1) - xmmword_1800F3110) >> 4;
    if ( v8 )
    {
      v9 = 0LL;
      while ( *(_QWORD *)(v9 + xmmword_1800F3110) )
      {
        ++v7;
        v9 += 16LL;
        if ( v7 >= v8 )
      ...
      *(_QWORD *)&Source = a2;
      *((_QWORD *)&Source + 1) = a3;
      *(_OWORD *)(xmmword_1800F3110 + 16 * v7) = Source;
      v11 = v7 + 1;
    }
    else
    {
LABEL_6:
      *(_QWORD *)&Source = a2;
      *((_QWORD *)&Source + 1) = a3;
      if ( !wil::details_abi::heap_buffer::ensure((wil::details_abi::heap_buffer *)&xmmword_1800F3110, 0x10uLL) )
        goto LABEL_13;
      if ( *(&xmmword_1800F3110 + 1) < (unsigned __int64)xmmword_1800F3120 )
        v10 = xmmword_1800F3120 - *(&xmmword_1800F3110 + 1);
      else
        v10 = 0LL;
      memcpy_s(*(&xmmword_1800F3110 + 1), v10, &Source, 0x10uLL);
      *(&xmmword_1800F3110 + 1) += 16LL;
      v11 = (*(&xmmword_1800F3110 + 1) - xmmword_1800F3110) >> 4;
    }
    *(_QWORD *)this = v11;
LABEL_13:
    if ( SRWLock )
