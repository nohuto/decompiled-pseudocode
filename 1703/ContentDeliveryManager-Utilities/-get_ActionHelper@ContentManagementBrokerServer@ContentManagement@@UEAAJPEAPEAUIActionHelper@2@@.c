/*
 * XREFs of ?get_ActionHelper@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIActionHelper@2@@Z @ 0x18000F950
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a3)
{
  ...
  *a2 = 0LL;
  v4 = CallerIdentity::CheckCallerCapability(this, &v16, a3);
  v5 = v4;
  if ( v4 >= 0 )
  {
    if ( !(_BYTE)v16 )
...
LABEL_7:
  ...
  if ( v5 < 0 )
    goto LABEL_7;
  v17 = 0LL;
  v7 = operator new(0x40uLL, (const struct std::nothrow_t *)&TLV::nothrow);
  v8 = v7;
  if ( !v7 )
  {
    v9 = -2147024882;
LABEL_13:
  ...
  *v10 = &ContentManagement::ActionHelper::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::Details::InterfaceList<Microsoft::WRL::FtmBase,Microsoft::WRL::Details::InterfaceList<IWeakReferenceSource,Microsoft::WRL::Details::InterfaceList<ContentManagement::IActionHelper,Microsoft::WRL::Details::Nil>>>,1,1>'};
  v8[4] = &ContentManagement::ActionHelper::`vftable'{for `IWeakReferenceSource'};
  v8[5] = &ContentManagement::ActionHelper::`vftable'{for `Microsoft::WRL::Details::ImplementsHelper<Microsoft::WRL::RuntimeClassFlags<3>,Microsoft::WRL::Details::InterfaceList<ContentManagement::IActionHelper,Microsoft::WRL::Details::Nil>,1,0>'};
