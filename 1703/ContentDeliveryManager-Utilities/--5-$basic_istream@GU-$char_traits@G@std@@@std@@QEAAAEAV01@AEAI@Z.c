/*
 * XREFs of ??5?$basic_istream@GU?$char_traits@G@std@@@std@@QEAAAEAV01@AEAI@Z @ 0x18002CFA8
 * Callers:
 ...
 *     ?_Ipfx@?$basic_istream@GU?$char_traits@G@std@@@std@@QEAA_N_N@Z @ 0x18002EB4C (-_Ipfx@-$basic_istream@GU-$char_traits@G@std@@@std@@QEAA_N_N@Z.c)
...
__int64 __fastcall std::basic_istream<unsigned short>::operator>>(__int64 a1, __int64 a2)
{
  ...
  {
    v5 = std::ios_base::getloc(v3 + *(int *)(*(_QWORD *)v3 + 4LL), &v25);
    v6 = std::use_facet<std::num_get<unsigned short,std::istreambuf_iterator<unsigned short>>>(v5);
    if ( v25 )
    {
      v7 = (void (__fastcall ***)(_QWORD, __int64))(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v25 + 16LL))(v25);
      if ( v7 )
        (**v7)(v7, 1LL);
    }
    try
    {
      ...
      v18 = *(_QWORD *)(v8 + 72);
      v19 = v18 == 0;
      (*(void (__fastcall **)(__int64, _BYTE *, __int64 *, __int64 *, __int64, int *, __int64))(*(_QWORD *)v6 + 88LL))(
        v6,
        v22,
        &v18,
        &v16,
