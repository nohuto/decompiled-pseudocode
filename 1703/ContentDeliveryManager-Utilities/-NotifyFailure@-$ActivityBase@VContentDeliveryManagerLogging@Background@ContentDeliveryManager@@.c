/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x18003BE30
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD *, _QWORD))(*a1 + 16LL))(a1, (unsigned int)a2[2]) )
  {
      ...
      && (*((_QWORD *)v23 + 3) & 0x200000000000LL) == *((_QWORD *)v23 + 3) )
    {
      ...
      v96 = v27 + 1;
      v97 = 0;
      TlgWrite(v24, &unk_1800DF7EA, (LPCGUID)(a1[6] + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v4 + 3) & 0x200000000000LL) == *((_QWORD *)v4 + 3) )
    {
      ...
      v89 = 2 * v8 + 2;
      v90 = 0;
      TlgWrite(v5, &unk_1800DF48B, (LPCGUID)(a1[6] + 8LL), 0LL, 0x10u, &pData);
    }
  }
