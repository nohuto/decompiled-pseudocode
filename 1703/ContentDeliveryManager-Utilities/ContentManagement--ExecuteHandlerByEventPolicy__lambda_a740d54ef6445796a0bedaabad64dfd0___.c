/*
 * XREFs of ContentManagement::ExecuteHandlerByEventPolicy__lambda_a740d54ef6445796a0bedaabad64dfd0___ @ 0x180032298
 * Callers:
...
__int64 __fastcall ContentManagement::ExecuteHandlerByEventPolicy__lambda_a740d54ef6445796a0bedaabad64dfd0___(
        void *Src,
        __int64 a2,
        HSTRING a3,
        unsigned int a4,
...
LABEL_12:
  ...
  v17 = lambda_a740d54ef6445796a0bedaabad64dfd0_::operator()(a6, a4);
  v18 = v17;
  if ( v17 < 0 )
  {
  ...
  if ( (_BYTE)v31 )
  {
    v21 = lambda_a740d54ef6445796a0bedaabad64dfd0_::operator()(a6, 0xCu);
    if ( v21 < 0 )
    {
      v22 = 301LL;
LABEL_25:
