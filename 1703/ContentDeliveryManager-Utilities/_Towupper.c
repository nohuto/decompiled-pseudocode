/*
 * XREFs of _Towupper @ 0x18006BE40
 * Callers:
 *     ?do_toupper@?$ctype@G@std@@MEBAGG@Z @ 0x180023450 (-do_toupper@-$ctype@G@std@@MEBAGG@Z.c)
 *     ?do_toupper@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x180023460 (-do_toupper@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
