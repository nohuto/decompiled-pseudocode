  ...
  else
  {
    ...
    if ( v6 > 0 )
    {
      ...
      if ( v6 > 0 )
      {
        ...
        if ( v7 )
        {
          (*(void (__fastcall **)(_QWORD))(*(_QWORD *)v7 + 8LL))(*(_QWORD *)(a1 + 88));
