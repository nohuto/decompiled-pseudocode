/*
 * XREFs of ?message@_Generic_error_category@std@@UEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@H@Z @ 0x1800068F0
 * Callers:
 ...
 *     ?_Syserror_map@std@@YAPEBDH@Z @ 0x18006A768 (-_Syserror_map@std@@YAPEBDH@Z.c)
 */
