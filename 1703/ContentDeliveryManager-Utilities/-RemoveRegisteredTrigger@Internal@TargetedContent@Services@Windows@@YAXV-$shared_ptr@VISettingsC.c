/*
 * XREFs of ?RemoveRegisteredTrigger@Internal@TargetedContent@Services@Windows@@YAXV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@PEAUITargetedContentTriggerInternal@1234@@Z @ 0x18004CCA0
 * Callers:
...
HRESULT __fastcall Windows::Services::TargetedContent::Internal::RemoveRegisteredTrigger(__int64 *a1, __int64 a2)
{
  ...
  HSTRING_HEADER v23; // [rsp+70h] [rbp+1Fh] BYREF
  ...
  {
    v9 = v15;
    v10 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v23, &v17);
    v5 = (*(__int64 (__fastcall **)(__int64, PVOID))(*(_QWORD *)v9 + 88LL))(v9, v10[1].Reserved.Reserved1);
    v6 = v5;
    v24 = 0LL;
    if ( v5 >= 0 )
    {
