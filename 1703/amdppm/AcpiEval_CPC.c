/*
 * XREFs of AcpiEval_CPC @ 0x1C00199B4
 * Callers:
...
__int64 __fastcall AcpiEval_CPC(__int64 a1, _QWORD *a2)
{
  ...
  v4 = AcpiEvaluateMethod(a1, 1129333599, 0LL, (unsigned int **)&P, &v16);
  if ( v4 < 0 )
    goto LABEL_19;
  *(_QWORD *)(a1 + 256) |= *(_DWORD *)(a1 + 264) & 0x8000000;
  if ( v16 )
  {
    ...
    v6 = P;
    v4 = AcpiParseCore((unsigned int)v19, 2, (int)P + 12, *((_DWORD *)P + 1) - 12, (__int64)v3, 236, (__int64)"_CPC", 1);
    if ( v4 < 0 )
    {
      v7 = 48;
LABEL_8:
    ...
    if ( v8 )
    {
      ...
      v4 = AcpiParseCore((unsigned int)v19, v10, (int)v6 + 12, v6[1] - 12, (__int64)v3, 236, (__int64)"_CPC", v11);
      if ( v4 < 0 )
      {
        v7 = 50;
        goto LABEL_8;
      ...
      do
      {
        AcpiTranslateAccessSize((char *)v3 + *v12, v13);
        v12 += 6;
      }
      while ( v14 != 1 );
      *v18 = v3;
