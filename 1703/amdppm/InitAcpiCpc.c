/*
 * XREFs of InitAcpiCpc @ 0x1C0021788
 * Callers:
...
LABEL_24:
    ...
    while ( v9 < v7 );
    if ( !(unsigned __int8)CpcRegisterIsSupported(v5 + 224) || *(_BYTE *)v12 == 126 && !*(_QWORD *)(v5 + 228) )
    {
      v13 = *(_DWORD *)(v5 + 28);
    ...
    if ( (unsigned __int8)CpcRegisterIsSupported(v5 + 176) )
