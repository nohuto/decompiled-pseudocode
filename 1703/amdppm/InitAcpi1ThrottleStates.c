/*
 * XREFs of InitAcpi1ThrottleStates @ 0x1C0026BD4
 * Callers:
...
__int64 __fastcall InitAcpi1ThrottleStates(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( ((unsigned int)dword_1C00113E4 <= 1 || (*(_DWORD *)(a1 + 264) & 0x200000) != 0)
    ...
    && (unsigned __int8)(byte_1C0011BA6 - 1) <= 3u
    && (unsigned __int8)byte_1C0011BA6 + (unsigned int)(unsigned __int8)byte_1C0011BA7 <= 0x20 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1072), 4u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1076), 4u);
    v7 = 1 << byte_1C0011BA6;
    PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)(20 * (1 << byte_1C0011BA6) + 4), 0x72637250u);
      ...
      **(_DWORD **)(a1 + 472) = v7;
      if ( v7 > 1 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)(v11 + v10 - 4) = (v12 << byte_1C0011BA7) | 0x10;
        }
        while ( v9 < v7 );
      }
