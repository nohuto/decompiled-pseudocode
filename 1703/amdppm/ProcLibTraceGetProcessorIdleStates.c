/*
 * XREFs of ProcLibTraceGetProcessorIdleStates @ 0x1C001ECF4
 * Callers:
...
char __fastcall ProcLibTraceGetProcessorIdleStates(__int64 a1, char a2)
{
  ...
  struct _PROCESSOR_NUMBER v15; // [rsp+34h] [rbp-35h] BYREF
  int v16; // [rsp+38h] [rbp-31h] BYREF
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+40h] [rbp-29h] BYREF
  unsigned __int8 *p_Number; // [rsp+50h] [rbp-19h]
  ...
  PVOID v27; // [rsp+80h] [rbp+17h]
  int i; // [rsp+88h] [rbp+1Fh]
    ...
    if ( *(_QWORD *)(a1 + 1112) )
    {
      ...
      if ( ProcessorNumber >= 0 )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
          ...
          *(_QWORD *)(a1 + 208),
          0LL);
        v5 = (unsigned int)(13 * *(_DWORD *)(a1 + 1100));
        v14 = *(_DWORD *)(a1 + 1100);
