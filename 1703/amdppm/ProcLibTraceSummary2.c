/*
 * XREFs of ProcLibTraceSummary2 @ 0x1C001D178
 * Callers:
...
char __fastcall ProcLibTraceSummary2(__int64 a1, char a2)
{
  ...
  unsigned int v25; // [rsp+34h] [rbp-95h] BYREF
  unsigned int v26; // [rsp+38h] [rbp-91h] BYREF
  int v27; // [rsp+3Ch] [rbp-8Dh] BYREF
  int v28; // [rsp+40h] [rbp-89h] BYREF
  int v29; // [rsp+44h] [rbp-85h] BYREF
  int v30; // [rsp+48h] [rbp-81h] BYREF
  struct _PROCESSOR_NUMBER v31; // [rsp+4Ch] [rbp-7Dh] BYREF
  ...
  unsigned int *v43; // [rsp+B0h] [rbp-19h]
  __int64 v44; // [rsp+B8h] [rbp-11h]
  unsigned int *v45; // [rsp+C0h] [rbp-9h]
