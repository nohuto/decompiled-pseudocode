/*
 * XREFs of RegisterXsdDomain @ 0x1C0021594
 * Callers:
...
bool __fastcall RegisterXsdDomain(_QWORD *a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    0LL);
  v4 = qword_1C0011408;
  if ( (__int64 *)qword_1C0011408 == &qword_1C0011408 )
    goto LABEL_5;
  do
  {
    v5 = v4;
  ...
  while ( (__int64 *)v4 != &qword_1C0011408 );
  if ( !v5 )
  {
LABEL_5:
    ...
    *(_QWORD *)(v5 + 24) = v5 + 16;
    *(_QWORD *)(v5 + 16) = v5 + 16;
    v7 = (__int64 *)qword_1C0011410;
    if ( *(__int64 **)qword_1C0011410 != &qword_1C0011408 )
      __fastfail(3u);
    *(_QWORD *)v5 = &qword_1C0011408;
    *(_QWORD *)(v5 + 8) = v7;
    *v7 = v5;
    qword_1C0011410 = v5;
    *(_DWORD *)(v5 + 36) = v2[3];
