/*
 * XREFs of PepParkMask @ 0x1C000AEA0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  if ( !PepSkipParkNotification && dword_1C0011910 >= (unsigned int)dword_1C00113E4 )
  {
    memset(PepParkLists, 0, (unsigned int)(16 * dword_1C00113E4));
    v4 = 0;
    KeInitializeEnumerationContext(v11, &unk_1C00116D8);
