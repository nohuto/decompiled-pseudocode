/*
 * XREFs of PopulateEnergyEstimationModel @ 0x1C002DEAC
 * Callers:
 *     ProcLibGlobalInit @ 0x1C002D3E4 (ProcLibGlobalInit.c)
 * Callees:
 *     RtlStringCchCatW @ 0x1C000970C (RtlStringCchCatW.c)
 *     RtlStringCchPrintfW @ 0x1C00097A4 (RtlStringCchPrintfW.c)
