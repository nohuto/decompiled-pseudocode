/*
 * XREFs of ProcLibTraceBiosPStatesRundown @ 0x1C001DEF0
 * Callers:
...
char __fastcall ProcLibTraceBiosPStatesRundown(_QWORD *a1)
{
  ...
  struct _PROCESSOR_NUMBER v15[3]; // [rsp+3Ch] [rbp-CCh] BYREF
  ...
  _QWORD *v25; // [rsp+98h] [rbp-70h]
  __int64 v26; // [rsp+A0h] [rbp-68h]
  _QWORD *v27; // [rsp+A8h] [rbp-60h]
  __int64 v28; // [rsp+B0h] [rbp-58h]
  _QWORD *v29; // [rsp+B8h] [rbp-50h]
  ...
  PVOID v35; // [rsp+E8h] [rbp-20h]
  int v36; // [rsp+F0h] [rbp-18h]
  int i; // [rsp+F4h] [rbp-14h]
