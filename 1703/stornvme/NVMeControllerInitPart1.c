/*
 * XREFs of NVMeControllerInitPart1 @ 0x1C00044B4
 * Callers:
...
char __fastcall NVMeControllerInitPart1(__int64 a1, char a2)
{
  ...
  *(_DWORD *)(*(_QWORD *)(a1 + 112) + 20LL) = 4587520;
  ...
  LODWORD(v11) = (3435973837u * (unsigned __int64)*(unsigned int *)(a1 + 140)) >> 32;
  v12 = *(_DWORD *)(a1 + 140) / 0xAu;
  *(_DWORD *)(*(_QWORD *)(a1 + 112) + 20LL) |= 1u;
  _InterlockedOr(v16, 0);
  v13 = *(_QWORD *)(a1 + 112);
  for ( i = 0; ; ++i )
  {
