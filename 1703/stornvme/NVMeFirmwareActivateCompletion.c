/*
 * XREFs of NVMeFirmwareActivateCompletion @ 0x1C000A800
 * Callers:
 *     <none>
 * Callees:
 *     NVMeControllerAsyncReset @ 0x1C0005390 (NVMeControllerAsyncReset.c)
 */
...
LABEL_25:
  ...
  *(_DWORD *)(a1 + 20) |= 0x20u;
  v11 = (v10 & 0x1FE) == 32;
LABEL_14:
  if ( !NVMeControllerAsyncReset(a1, v11, 510LL, a2) )
  {
LABEL_22:
    *(_DWORD *)(v9 + 20) = 32;
    *(_BYTE *)(a2 + 3) = 1;
