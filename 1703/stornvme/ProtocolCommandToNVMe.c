/*
 * XREFs of ProtocolCommandToNVMe @ 0x1C000CAE0
 * Callers:
 ...
 *     NVMeValidateProtocolCommandRequest @ 0x1C000C688 (NVMeValidateProtocolCommandRequest.c)
...
__int64 __fastcall ProtocolCommandToNVMe(_DWORD *a1, __int64 a2)
{
  ...
  if ( !v9 )
  {
    ...
    else
    {
      if ( !*(_DWORD *)(v7 + 32) )
        goto LABEL_26;
      LODWORD(v10) = *(_DWORD *)(v7 + 48);
      v6 = v7 + (unsigned int)v10;
    }
    if ( v6 )
    {
      if ( (a1[13] & 8) == 0 )
...
LABEL_26:
    ...
    *(_BYTE *)(v5 + 4245) = (2 * (v6 != 0)) | *(_BYTE *)(v5 + 4245) & 0xFC | (*(_DWORD *)(v7 + 56) == 1);
