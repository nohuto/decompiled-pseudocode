/*
 * XREFs of IoQueuesCreation @ 0x1C0003C34
 * Callers:
 *     NVMeControllerInitPart2 @ 0x1C0004640 (NVMeControllerInitPart2.c)
 * Callees:
 *     IoQueuesFreeResources @ 0x1C0004124 (IoQueuesFreeResources.c)
  ...
  if ( *(_WORD *)(a1 + 234) )
  {
    ...
    while ( 1 )
    {
      ...
      *(_WORD *)(*(_QWORD *)(a1 + 656) + 4236LL) = 0;
      ...
      v9 = 168LL * (v4 - 1);
      *(_BYTE *)v8 = 5;
      *(_QWORD *)(v8 + 24) = *(_QWORD *)(v9 + *(_QWORD *)(a1 + 552) + 8);
      *(_WORD *)(v8 + 40) = v4;
      ...
      *(_DWORD *)(v8 + 44) = v11;
      *(_WORD *)(v8 + 46) = *(_WORD *)(v9 + *(_QWORD *)(a1 + 552) + 104);
...
LABEL_8:
    ...
    while ( 1 )
    {
      ...
      *(_WORD *)(*(_QWORD *)(a1 + 656) + 4236LL) = 0;
      ...
      v17 = 136LL * (v13 - 1);
      *(_BYTE *)v16 = 1;
      *(_QWORD *)(v16 + 24) = *(_QWORD *)(*(_QWORD *)(a1 + 544) + v17 + 8);
      *(_WORD *)(v16 + 40) = v13;
      *(_WORD *)(v16 + 42) = *(_WORD *)(a1 + 230) - 1;
      *(_DWORD *)(v16 + 44) = *(_DWORD *)(v16 + 44) & 0xFFFFFFF8 | 5;
      *(_WORD *)(v16 + 46) = *(_WORD *)(*(_QWORD *)(a1 + 544) + v17 + 50);
