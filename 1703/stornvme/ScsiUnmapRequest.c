/*
 * XREFs of ScsiUnmapRequest @ 0x1C0008F74
 * Callers:
...
LABEL_16:
    ...
    v11 = v8 + 8;
    HIBYTE(v19) = *(_BYTE *)(v8 + 2);
    LOBYTE(v19) = *(_BYTE *)(v8 + 3);
    v12 = v19 >> 4;
    if ( (unsigned __int16)(v19 >> 4) > 0x100u )
    {
      v10 = -1056964602;
      goto LABEL_16;
    }
    ...
    *(_BYTE *)(v7 + 4245) = *(_BYTE *)(v7 + 4245) & 0xFC | 2;
    ...
    *(_BYTE *)(v7 + 4136) = v12 - 1;
    PhysicalAddress = StorPortGetPhysicalAddress(a1, 0LL, v7, &v19);
    *(_BYTE *)(v7 + 4245) |= 4u;
