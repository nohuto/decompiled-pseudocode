/*
 * XREFs of IoQueuesInitialize @ 0x1C0002DAC
 * Callers:
 *     NVMeControllerInitPart2 @ 0x1C0004640 (NVMeControllerInitPart2.c)
 * Callees:
 *     NVMeAllocateDmaBuffer @ 0x1C0002610 (NVMeAllocateDmaBuffer.c)
 *     NVMeSubmissionQueueInit @ 0x1C000276C (NVMeSubmissionQueueInit.c)
 *     NVMeCompletionQueueInit @ 0x1C0002868 (NVMeCompletionQueueInit.c)
