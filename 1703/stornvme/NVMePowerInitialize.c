/*
 * XREFs of NVMePowerInitialize @ 0x1C00054B0
 * Callers:
...
char __fastcall NVMePowerInitialize(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 1120) & 1) == 0 )
  {
    ...
    if ( *(unsigned __int8 *)(v1 + 263) != -1 )
    {
      ...
      {
        v10 = *(_QWORD *)(a1 + 1080);
        if ( v9 > 0x1Fu || v9 > *(_BYTE *)(v10 + 263) )
        {
          v11 = 0LL;
        }
        else
        {
          v11 = (unsigned __int16 *)(v10 + 32 * (v9 + 64LL));
          if ( v11 )
          {
...
LABEL_12:
    ...
    else
    {
      ...
      {
        v27 = *(_DWORD *)(a1 + 80) == -1;
        *(_DWORD *)(a1 + 1120) = (*(_DWORD *)(a1 + 1120) | 5) ^ *(_BYTE *)(a1 + 1120) & 8;
        ...
        *(_DWORD *)(a1 + 1144) = 100;
        if ( v40 )
        {
          StorPortExtendedFunction(32LL, a1, a1 + 1152, v25);
        ...
        if ( !(unsigned int)StorPortExtendedFunction(0LL, a1, 24 * (unsigned int)v4 + 40, 1701672526LL) )
        {
          ...
          if ( v4 )
          {
            ...
            do
            {
              ...
              *(_DWORD *)(v33 + 4) = 24;
              v34 = *(_QWORD *)(a1 + 1080);
              if ( v29 <= 0x1Fu && v29 <= *(_BYTE *)(v34 + 263) && (v35 = (unsigned __int16 *)(v31 + v34 + 2048)) != 0LL )
                v36 = *v35 * ((*((_BYTE *)v35 + 3) & 1) != 0 ? 100 : 10000);
              else
                v36 = -1;
              *(_QWORD *)(v33 + 16) = v30;
              ++v29;
              ...
              v32 += 24LL;
              v31 += 32LL;
              *(_QWORD *)(v33 + 8) = v36 / 0x3E8;
            }
            while ( v29 < v4 );
          }
          v37 = StorPortExtendedFunction(65LL, a1, 0LL, 0LL);
          if ( v37 )
          {
