/*
 * XREFs of ScsiReadCapacityRequest @ 0x1C0007DE4
 * Callers:
...
__int64 __fastcall ScsiReadCapacityRequest(__int64 a1, __int64 a2, _BYTE *a3, __int64 a4)
{
  ...
  v11 = *(_QWORD *)(a1 + 8 * v10 + 1184);
  v12 = 0;
  v13 = (unsigned int)v10;
  v14 = *(_DWORD *)(v11 + 52);
  v15 = *(_QWORD *)(v11 + 56) - 1LL;
  v19 = v15;
  v16 = *(_QWORD *)(a1 + 8LL * (unsigned __int8)v10 + 1184);
  ...
  if ( (a3[1] & 0x1F) == 0x10 )
  {
    ...
    *v8 = HIBYTE(v19);
    ...
    if ( *v9 >= 0x10u )
    {
      ...
      v18 = v8[14];
      v8[15] = 0;
      v8[14] = v18 & 0x3F | (*(_BYTE *)(*(_QWORD *)(a1 + 8 * v13 + 1184) + 65LL) << 7);
      LODWORD(v16) = *v9 < 0x20u ? 16 : 32;
    }
    *v9 = v16;
LABEL_26:
    *(_BYTE *)(a2 + 3) = 1;
