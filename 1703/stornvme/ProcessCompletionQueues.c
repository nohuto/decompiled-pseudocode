/*
 * XREFs of ProcessCompletionQueues @ 0x1C0010094
 * Callers:
...
__int64 __fastcall ProcessCompletionQueues(__int64 a1, unsigned __int16 a2, char a3)
{
  ...
  if ( a2 == 0xFFFF || *(_WORD *)(a1 + 200) <= 1u )
  {
    ...
    if ( (*(_WORD *)(16LL * *(unsigned __int16 *)(a1 + 474) + result + 14) & 1) != *(_WORD *)(a1 + 476) )
    {
      v8 = *(_WORD *)(a1 + 472);
      if ( !*(_BYTE *)(a1 + 18) && (unsigned int)(*(_DWORD *)(a1 + 12) - 1) <= 1 )
      {
        *(_DWORD *)(*(_QWORD *)(a1 + 112) + 12LL) = 1 << v8;
    ...
    for ( i = 0; *(_QWORD *)(a1 + 552); ++i )
    {
      ...
      if ( (*(_WORD *)(16LL * *(unsigned __int16 *)(v10 + 98) + *(_QWORD *)v10 + 14) & 1) != *(_WORD *)(v10 + 100) )
      {
        if ( !*(_BYTE *)(a1 + 18) && (unsigned int)(*(_DWORD *)(a1 + 12) - 1) <= 1 )
        {
          *(_DWORD *)(*(_QWORD *)(a1 + 112) + 12LL) = 1 << *(_WORD *)(v10 + 96);
          _InterlockedOr(v11, 0);
          *(_BYTE *)(a1 + 18) = 1;
        }
        if ( v4 )
  ...
  else
  {
    ...
    if ( !*(_BYTE *)(a1 + 18) && (unsigned int)(*(_DWORD *)(a1 + 12) - 1) <= 1 )
    {
      *(_DWORD *)(*(_QWORD *)(a1 + 112) + 12LL) = 1 << *(_WORD *)(v5 + 96);
      _InterlockedOr(v11, 0);
      *(_BYTE *)(a1 + 18) = 1;
    }
    if ( v4 )
