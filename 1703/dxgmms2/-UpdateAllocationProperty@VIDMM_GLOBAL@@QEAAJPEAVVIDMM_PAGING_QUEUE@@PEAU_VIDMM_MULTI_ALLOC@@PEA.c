/*
 * XREFs of ?UpdateAllocationProperty@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_UPDATEALLOCPROPERTY@@PEA_K@Z @ 0x1C0095BEC
 * Callers:
 *     ?VidMmUpdateAllocationProperty@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_UPDATEALLOCPROPERTY@@PEA_K@Z @ 0x1C001EBF0 (-VidMmUpdateAllocationProperty@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_AL.c)
 * Callees:
        ...
        unsigned __int64 *a5)
{
  ...
  *(_OWORD *)((char *)&v27[4] + 4) = *(_OWORD *)a4;
  ...
  if ( (_mm_srli_si128(*(__m128i *)(v27 + 36), 8).m128i_i8[4] & 2) != 0 )
  {
    ...
    if ( !HIDWORD(v27[4]) )
      goto LABEL_3;
    v17 = *((_QWORD *)this + 5021) + 472LL * v10;
    ...
    if ( ((unsigned __int8)v9 & ((*((_BYTE *)a3 + 28) & 8) != 0)) != 0 )
      goto LABEL_3;
    v18 = *(struct _DXGK_ALLOCATIONINFOFLAGS_WDDM2_0 **)(v11 + 520);
    v29 = 0;
    ...
    {
      LOBYTE(v19) = v29 & 1;
      v20 = WdLogNewEntry5_WdWarning(v19, v8);
  ...
  if ( v22 )
  {
    if ( (_DWORD)v9 == v13.0 )
    {
      v23 = WdLogNewEntry5_WdWarning(v9, v8);
  ...
  if ( (v21 & 1) != 0 )
  {
    v25 = *(_DWORD **)(v11 + 520);
    v9 = *v25 & 0x8000;
    if ( (*v25 & 0x8000) == 0 || (v27[5] & 0x100000000LL) != 0 )
    {
      if ( (_DWORD)v9 )
      {
        v26 = WdLogNewEntry5_WdWarning(v9, v8);
