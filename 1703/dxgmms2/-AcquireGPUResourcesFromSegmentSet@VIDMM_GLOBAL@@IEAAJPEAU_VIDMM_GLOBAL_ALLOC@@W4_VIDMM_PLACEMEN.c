/*
 * XREFs of ?AcquireGPUResourcesFromSegmentSet@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_VIDMM_PLACEMENT_RESTRICTION@@E@Z @ 0x1C005B03C
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::AcquireGPUResourcesFromSegmentSet(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  v4 = 0;
  v8 = *(_QWORD *)(a1 + 40168) + 472LL * (*(_DWORD *)(a2 + 76) & 0x3F);
  v10 = -1071775488;
  if ( *(_DWORD *)(v8 + 24) )
  {
    while ( 1 )
...
LABEL_5:
    if ( (_DWORD)v11 == *(unsigned __int16 *)(v8 + 28) && (**(_DWORD **)(a2 + 520) & 0x8000) != 0 )
    {
LABEL_28:
      v10 = -1071775488;
LABEL_29:
    ...
    v16 = ((a3 - 3) & 0xFFFFFFFA) == 0
       && a3 != 8
       && ((v15 = **(_DWORD **)(a2 + 520), (v15 & 0x20000000) == 0) || v15 < 0x80000000)
       && (v15 & 0x80000) == 0;
    LOBYTE(v13) = 1;
    LOBYTE(v21) = v16;
