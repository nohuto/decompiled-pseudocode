/*
 * XREFs of CopyNodeStatistics @ 0x1C00AB7C4
 * Callers:
 *     VidSchQueryNodeStatistics @ 0x1C00ABF70 (VidSchQueryNodeStatistics.c)
 *     VidSchQueryProcessNodeStatistics @ 0x1C00AC020 (VidSchQueryProcessNodeStatistics.c)
 * Callees:
 *     <none>
 */
