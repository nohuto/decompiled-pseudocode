/*
 * XREFs of VidSchiComputePriority @ 0x1C006BCD8
 * Callers:
...
__int64 __fastcall VidSchiComputePriority(__int64 a1, int a2, int a3, char a4, _DWORD *a5)
{
  ...
  *a5 = v11;
  if ( v11 < 0x10 || a3 || *(_BYTE *)(*(_QWORD *)(v10 + 8) + 273LL) || SeSinglePrivilegeCheck((LUID)14LL, 1) )
  {
    if ( (*(_DWORD *)(v8 + 2152) & 0x4000) != 0 && (a4 & 1) != 0 && *a5 < 0x10u )
      *a5 = 16;
    return 0LL;
  }
  return 3221225506LL;
