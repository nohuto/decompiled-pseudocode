/*
 * XREFs of ?PurgeAllSegments@VIDMM_GLOBAL@@QEAAXU_VIDMM_PURGE_FLAGS@@PEAVVIDMM_PROCESS@@@Z @ 0x1C006F1E8
 * Callers:
 *     VidMmPurgeAllSegments @ 0x1C0013C80 (VidMmPurgeAllSegments.c)
 * Callees:
...
void __fastcall VIDMM_GLOBAL::PurgeAllSegments(VIDMM_GLOBAL *a1, __int64 a2, __int64 a3)
{
  ...
  {
    v11 = (_QWORD *)WdLogNewEntry5_WdWarning(a1, a2);
    v11[3] = a1;
    v11[4] = v4;
    v11[5] = a3;
