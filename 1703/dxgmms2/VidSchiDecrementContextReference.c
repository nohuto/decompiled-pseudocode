/*
 * XREFs of VidSchiDecrementContextReference @ 0x1C0010100
 * Callers:
...
void __fastcall VidSchiDecrementContextReference(struct _VIDSCH_CONTEXT *a1, int a2)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)a1 + 18, 0xFFFFFFFF) == 1 )
  {
    ...
    if ( *(struct _VIDSCH_CONTEXT **)(v6 + 8) != (struct _VIDSCH_CONTEXT *)((char *)a1 + 8)
      || *v7 != (struct _VIDSCH_CONTEXT *)((char *)a1 + 8) )
    {
      __fastfail(3u);
    }
    ...
    *(_QWORD *)(v6 + 8) = v7;
    ...
    if ( *(struct _VIDSCH_CONTEXT **)(v8 + 8) != (struct _VIDSCH_CONTEXT *)((char *)a1 + 24)
      || *v9 != (struct _VIDSCH_CONTEXT *)((char *)a1 + 24) )
    {
      __fastfail(3u);
    }
    ...
    *(_QWORD *)(v8 + 8) = v9;
    while ( 1 )
    {
      v10 = VidSchiInterlockedRemoveHeadListIfExist((KSPIN_LOCK *)(v4 + 1888), (__int64 **)a1 + 90, (_DWORD *)a1 + 184);
      if ( !v10 )
        break;
