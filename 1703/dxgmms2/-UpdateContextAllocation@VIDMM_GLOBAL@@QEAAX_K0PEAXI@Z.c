/*
 * XREFs of ?UpdateContextAllocation@VIDMM_GLOBAL@@QEAAX_K0PEAXI@Z @ 0x1C0095E44
 * Callers:
        ...
        UINT a5)
{
  ...
  v5 = 0;
  for ( i = -1071775743; v5 < *((_DWORD *)this + 1604); ++v5 )
  {
    ...
    while ( i == -1071775743 )
    {
      ...
      VIDMM_GLOBAL::CompleteBuildPagingBufferIteration((signed __int64)this, v5, 0LL, &v12, i, 0, 0LL);
    }
  }
}
