/*
 * XREFs of ?InitContextAllocation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@EPEA_NPEAPEAU2@@Z @ 0x1C005A190
 * Callers:
        ...
        struct VIDMM_ALLOC **a5)
{
  ...
  *a5 = 0LL;
  ...
  {
    v25 = WdLogNewEntry5_WdEvent(v15, v14);
    *(_QWORD *)(v25 + 24) = a2;
    *(_QWORD *)(v25 + 32) = v16;
  ...
  else
  {
    ...
    do
    {
      ...
      {
        if ( (**(_DWORD **)(v9 + 520) & 8) != 0 )
          v33.MapApertureSegment.OffsetInPages = *(_QWORD *)(v9 + 368);
        else
          v33.MapApertureSegment.OffsetInPages = *(_QWORD *)(*(_QWORD *)(v9 + 104) + 16LL);
      }
      v20.QuadPart = VIDMM_ALLOC::GetGpuVirtualAddress((VIDMM_ALLOC *)a2, v10);
      v21 = this[2];
      v33.Transfer.Source.SegmentAddress = v20;
      ...
      if ( bTracingEnabled )
      {
        ...
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
        {
          v32 = 0LL;
          v31 = (int)v26;
          Template_pppxxq(v29, v28, v30, CurrentProcessId, v9);
        }
      }
