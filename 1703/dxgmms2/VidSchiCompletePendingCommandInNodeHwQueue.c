/*
 * XREFs of VidSchiCompletePendingCommandInNodeHwQueue @ 0x1C002AC84
 * Callers:
  ...
  if ( *(_DWORD *)(a1 + 2768) )
  {
    ...
    if ( *(_DWORD *)(a1 + 2768) )
    {
      ...
      if ( *(_DWORD *)(a1 + 2776) )
      {
        ...
        v18[0] = 2;
        v18[3] = a2;
        v18[4] = *(unsigned __int16 *)(*(_QWORD *)(v10 + 8 * v9 + 416) + 8LL);
        v11 = *(_QWORD *)(v10 + 8 * v9 + 416);
      ...
      else
      {
        v18[0] = 1;
        v18[2] = a2;
        v18[3] = *(unsigned __int16 *)(*(_QWORD *)(v10 + 8 * v9 + 416) + 8LL);
        v14 = *(_QWORD *)(v10 + 8 * v9 + 416);
