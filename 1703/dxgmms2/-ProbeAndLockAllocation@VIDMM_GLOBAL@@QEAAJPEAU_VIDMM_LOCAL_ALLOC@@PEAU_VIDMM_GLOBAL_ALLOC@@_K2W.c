/*
 * XREFs of ?ProbeAndLockAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@_K2W4_LOCK_OPERATION@@PEAVVIDMM_SEGMENT@@E@Z @ 0x1C0056C04
 * Callers:
  ...
  if ( *((_QWORD *)a2 + 3) )
    return (*(__int64 (__fastcall **)(_QWORD, struct _VIDMM_GLOBAL_ALLOC *, __int64, SIZE_T, int, struct VIDMM_SEGMENT *, unsigned __int8))(**(_QWORD **)(*((_QWORD *)a2 + 1) + 24LL) + 32LL))(
             *(_QWORD *)(*((_QWORD *)a2 + 1) + 24LL),
             ...
             a7,
             a8);
  v10 = VidMmiProbeAndLockAllocation(a3, a4, Length, IoModifyAccess, a7, a2);
  if ( !v10 )
    return 3223191809LL;
  if ( a8 )
    *((_QWORD *)a2 + 11) = v10;
