/*
 * XREFs of ?BlockMemoryRanges@VIDMM_SEGMENT@@QEAAJW4_VIDMM_POOL_BLOCK_STATE@@W4_DXGK_QUERYADAPTERINFOTYPE@@IAEA_K@Z @ 0x1C00A13B8
 * Callers:
 ...
 *     ?ValidateMemoryRanges@VIDMM_SEGMENT@@QEAAJIPEAU_DXGK_MEMORYRANGE@@AEA_K@Z @ 0x1C00A4364 (-ValidateMemoryRanges@VIDMM_SEGMENT@@QEAAJIPEAU_DXGK_MEMORYRANGE@@AEA_K@Z.c)
 *     ?MarkMemoryBlocks@VIDMM_LINEAR_POOL@@QEAAJW4_VIDMM_POOL_BLOCK_STATE@@IPEAU_DXGK_MEMORYRANGE@@@Z @ 0x1C00A9F20 (-MarkMemoryBlocks@VIDMM_LINEAR_POOL@@QEAAJW4_VIDMM_POOL_BLOCK_STATE@@IPEAU_DXGK_MEMORYRANGE@@@Z.c)
 */
        ...
        unsigned __int64 *a5)
{
  ...
  __int64 v24; // rdx
  __int64 v25; // rcx
  __int16 v27; // [rsp+20h] [rbp-40h] BYREF
  _BYTE v28[14]; // [rsp+22h] [rbp-3Eh]
  struct _DXGKARG_QUERYADAPTERINFO v29; // [rsp+30h] [rbp-30h] BYREF
  ...
  if ( a4 )
  {
    ...
    v29.InputDataSize = 16;
    *(_QWORD *)v28 = 0LL;
    v27 = *(_WORD *)(a1 + 16);
    *(_WORD *)v28 = *(_WORD *)(a1 + 404);
    v29.pInputData = &v27;
    v15 = *(_QWORD *)(a1 + 8);
    *(_DWORD *)&v28[2] = a4;
    *(_QWORD *)&v28[6] = v13;
    v29.Type = v7;
    v16 = DXGADAPTER::DdiQueryAdapterInfo(*(DXGADAPTER **)(v15 + 24), &v29);
    v5 = v16;
    if ( v16 >= 0 )
    {
      ...
      {
        LOBYTE(v21) = a2;
        v23 = VIDMM_LINEAR_POOL::MarkMemoryBlocks(*(_QWORD *)(a1 + 176), v21, a4, v13);
        v5 = v23;
        if ( v23 >= 0 )
        {
LABEL_14:
