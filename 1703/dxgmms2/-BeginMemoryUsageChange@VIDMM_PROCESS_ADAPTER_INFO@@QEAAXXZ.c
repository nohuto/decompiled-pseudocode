/*
 * XREFs of ?BeginMemoryUsageChange@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ @ 0x1C004EC08
 * Callers:
...
void __fastcall VIDMM_PROCESS_ADAPTER_INFO::BeginMemoryUsageChange(VIDMM_PROCESS_ADAPTER_INFO *this)
{
  ...
  v1 = 0;
  if ( bTracingEnabled && *(_DWORD *)(*(_QWORD *)this + 6416LL) )
  {
    do
    {
      v3 = v1++;
      v4 = (_QWORD *)(*((_QWORD *)this + 6) + 264 * v3);
      v4[20] = v4[17];
      v4[21] = v4[18];
      v4[22] = v4[19];
    }
    while ( v1 < *(_DWORD *)(*(_QWORD *)this + 6416LL) );
  }
}
