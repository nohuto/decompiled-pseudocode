/*
 * XREFs of ?Evict@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1C006310C
 * Callers:
 *     ?VidMmEvict@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z @ 0x1C0012A10 (-VidMmEvict@@YAXPEAVVIDMM_GLOBAL@@PEAVVIDMM_DEVICE@@PEAPEAU_VIDMM_MULTI_ALLOC@@IKPEA_K@Z.c)
        ...
        unsigned __int64 *a6)
{
  ...
  for ( i = &v6[v7]; v6 != i; ++v6 )
  {
    ...
    if ( !((unsigned int)v16 | *((_DWORD *)v11 + 38)) && !*((_DWORD *)v11 + 39) )
    {
      ...
      v19[2] = v11;
      LODWORD(v19[4]) = a5;
      v17 = dword_1C003C3C8 || (*(_DWORD *)(v11[1][1] + 64) & 1) != 0;
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
    {
      ...
      Template_pq(v16, &EventVidMmEvict, v9, v11, v18);
    }
  }
}
