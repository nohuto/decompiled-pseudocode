/*
 * XREFs of VidSchSetMonitorPowerState @ 0x1C006EAF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( v11 && (v12 = *(_DWORD *)(a4 + 16) / v11) != 0 )
    _InterlockedExchange((volatile __int32 *)(*(_QWORD *)(a1 + 8 * v4 + 2992) + 51060LL), 0x3E8 / v12);
  else
    _InterlockedExchange((volatile __int32 *)(*(_QWORD *)(a1 + 8 * v4 + 2992) + 51060LL), 0);
