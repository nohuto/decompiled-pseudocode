/*
 * XREFs of VidSchiAddSyncObjectToCrossAdapterInfo @ 0x1C0025940
 * Callers:
...
void __fastcall VidSchiAddSyncObjectToCrossAdapterInfo(__int64 a1)
{
  ...
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)(a1 + 184) + 8LL), &LockHandle);
  _InterlockedIncrement(*(volatile signed __int32 **)(a1 + 184));
  v2 = (_QWORD *)(a1 + 120);
  v3 = *(_QWORD *)(a1 + 184) + 16LL;
  v4 = *(_QWORD *)v3;
