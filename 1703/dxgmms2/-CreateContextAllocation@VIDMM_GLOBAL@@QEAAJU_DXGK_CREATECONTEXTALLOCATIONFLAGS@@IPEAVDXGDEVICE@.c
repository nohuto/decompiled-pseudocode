/*
 * XREFs of ?CreateContextAllocation@VIDMM_GLOBAL@@QEAAJU_DXGK_CREATECONTEXTALLOCATIONFLAGS@@IPEAVDXGDEVICE@@PEAVDXGCONTEXT@@PEAX_KKKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXGK_SEGMENTBANKPREFERENCE@@U_DXGK_ALLOCATIONINFOFLAGS@@PEAPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C0062978
 * Callers:
 *     ?VidMmCreateContextAllocation@@YAJPEAVVIDMM_GLOBAL@@IU_DXGK_CREATECONTEXTALLOCATIONFLAGS@@PEAVDXGDEVICE@@PEAVDXGCONTEXT@@PEAX_KKKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXGK_SEGMENTBANKPREFERENCE@@U_DXGK_ALLOCATIONINFOFLAGS@@PEAPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C0012770 (-VidMmCreateContextAllocation@@YAJPEAVVIDMM_GLOBAL@@IU_DXGK_CREATECONTEXTALLOCATIONFLAGS@@PEAVDX.c)
 * Callees:
        ...
        struct _VIDMM_CONTEXT_ALLOC **a14)
{
  ...
  __int64 v42; // rax
  __int64 v43; // rax
  struct VIDMM_ALLOC *v44; // [rsp+90h] [rbp-69h] BYREF
  struct _VIDMM_GLOBAL_ALLOC *v45; // [rsp+98h] [rbp-61h] BYREF
  struct VIDMM_DEVICE *v46; // [rsp+A0h] [rbp-59h]
  _QWORD v47[16]; // [rsp+B0h] [rbp-49h] BYREF
  unsigned int v48; // [rsp+150h] [rbp+57h]
  void *v49; // [rsp+158h] [rbp+5Fh] BYREF
  ...
  if ( a4 )
    ...
    v21 = 0LL;
  v46 = v21;
  if ( !a4 || *((_BYTE *)a4[5] + 273) )
  {
    v43 = WdLogNewEntry5_WdAssertion(this, a2);
    *(_QWORD *)(v43 + 24) = 1685LL;
...
LABEL_7:
  ...
  {
    v24 = -1;
    v25 = !_BitScanForward((unsigned int *)&v26, *((_DWORD *)a5 + 85));
  ...
  v27 = VIDMM_GLOBAL::CreateOneAllocation(
          this,
          v21,
          v15,
          a7,
...
LABEL_35:
  ...
  if ( (v16 & 2) != 0 )
  {
    ...
    if ( !CVirtualAddressAllocator::MapVirtualAddressRange(
            ...
            *((_QWORD *)v18 + 2),
            ...
            0LL,
            *((_DWORD *)v18 + 8),
            (struct _LIST_ENTRY *)0x11,
            0LL,
            v33,
            0LL) )
    {
      v41 = WdLogNewEntry5_WdAssertion(v35, v34);
      *(_QWORD *)(v41 + 32) = 1796LL;
      goto LABEL_26;
    }
  }
  ...
  if ( inserted < 0 )
  {
    ...
    {
      v42 = WdLogNewEntry5_WdWarning(v38, v37);
      v20 = v49;
      *(_QWORD *)(v42 + 24) = v49;
      *(_QWORD *)(v42 + 32) = 1811LL;
      WdLogEvent5_WdWarning(v42);
      goto LABEL_31;
    }
    v41 = WdLogNewEntry5_WdAssertion(v38, v37);
    *(_QWORD *)(v41 + 32) = 1815LL;
LABEL_26:
    v20 = v49;
    *(_QWORD *)(v41 + 24) = v49;
