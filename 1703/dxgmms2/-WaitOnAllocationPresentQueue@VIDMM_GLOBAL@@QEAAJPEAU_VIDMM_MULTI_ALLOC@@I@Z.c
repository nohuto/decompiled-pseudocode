/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C0097F4C
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x1C001EE80 (VidMmWaitOnAllocationPresentQueue.c)
...
__int64 __fastcall VIDMM_GLOBAL::WaitOnAllocationPresentQueue(VIDMM_GLOBAL *this, struct _VIDMM_MULTI_ALLOC *a2)
{
  ...
  else
  {
    ...
    VidSchiInterlockedRemoveEntryList((KSPIN_LOCK *)(v6 + 1896), v13, 0LL);
