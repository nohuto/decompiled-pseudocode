/*
 * XREFs of ?Init@VIDMM_DEVICE@@QEAAJPEAVVIDMM_PROCESS@@@Z @ 0x1C004CA30
 * Callers:
 *     VidMmInitDevice @ 0x1C0012C10 (VidMmInitDevice.c)
...
__int64 __fastcall VIDMM_DEVICE::Init(VIDMM_DEVICE *this, struct VIDMM_PROCESS *a2)
{
  ...
  *((_QWORD *)this + 1) = v5;
  ...
  if ( *((_QWORD *)this + 3) )
  {
    ...
    if ( v7 < 0 )
    {
      _InterlockedAdd(&dword_1C003C578, 1u);
  ...
  *((_QWORD *)this + 5) = v9;
  if ( !v9 )
  {
    _InterlockedAdd(&dword_1C003C57C, 1u);
...
LABEL_60:
  ...
  if ( *((_DWORD *)this + 15) )
  {
    ...
    {
      v31 = 160 * v30;
      result = VIDMM_DEVICE_PAGING_QUEUE::Initialize(160 * v30 + *((_QWORD *)this + 9), this, (unsigned int)v30, 1LL);
      if ( (int)result < 0 )
        break;
      result = VIDMM_DEVICE_PAGING_QUEUE::Initialize(v31 + *((_QWORD *)this + 10), this, (unsigned int)v30, 2LL);
      if ( (int)result < 0 )
        break;
      v33 = *((_QWORD *)this + 11);
      if ( v33 )
      {
        result = VIDMM_DEVICE_PAGING_QUEUE::Initialize(v31 + v33, this, (unsigned int)v30, 3LL);
        if ( (int)result < 0 )
          break;
      }
...
LABEL_38:
    ...
    *((_QWORD *)this + 27) = qword_1C003C398 + v34 * KeQueryTimeIncrement();
    return 0LL;
  }
  return result;
}
