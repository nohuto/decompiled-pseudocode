/*
 * XREFs of VidSchiMarkDeviceAsError @ 0x1C00127A4
 * Callers:
 ...
 *     ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C009691C (-ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z.c)
 ...
 *     ExtractAggregateFieldTypes @ 0x1C002BA10 (ExtractAggregateFieldTypes.c)
...
LONG __fastcall VidSchiMarkDeviceAsError(__int64 a1, int a2)
{
  ...
  if ( !_InterlockedCompareExchange((volatile signed __int32 *)(a1 + 160), a2, 0) && a2 != 14 )
  {
      ...
      && (qword_1C003C018 & 0x400000000010LL) == qword_1C003C018 )
    {
      ...
      *(_DWORD *)&EventDescriptor.Level = 5;
      UserData.Ptr = (ULONGLONG)off_1C003C008;
      *(_DWORD *)&EventDescriptor.Id = ((unsigned int)&unk_1C003074F - (unsigned int)&TraceLoggingMetadata) | 0xB000000;
      EventDescriptor.Keyword = 0x400000000010LL;
      UserData.Size = *(unsigned __int16 *)off_1C003C008;
      v24 = &unk_1C003075A;
      UserData.Reserved = v13;
      v25 = 116;
      v26 = v14;
      if ( (ETWENABLECALLBACK *)qword_1C003C028 == RegisteredProviderEtwCallback )
      {
        v15 = ExtractAggregateFieldTypes(
                ((unsigned int)&unk_1C003074F - (unsigned int)&TraceLoggingMetadata) | 0xB000000,
                &UserData);
        if ( v15 )
        {
          LOBYTE(v17) = 10;
  ...
  *(_QWORD *)(*(_QWORD *)(a1 + 32) + 1376LL) = MEMORY[0xFFFFF78000000320];
  return KeSetEvent((PRKEVENT)(*(_QWORD *)(a1 + 32) + 1344LL), 0, 0);
}
