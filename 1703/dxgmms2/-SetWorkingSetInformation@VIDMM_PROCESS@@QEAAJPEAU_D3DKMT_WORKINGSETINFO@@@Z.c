/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C0099C78
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C001EDB0 (VidMmSetWorkingSetInformation.c)
 * Callees:
