/*
 * XREFs of VidSchiUpdateCurrentIsrFrameTime @ 0x1C00131AC
 * Callers:
...
__int64 __fastcall VidSchiUpdateCurrentIsrFrameTime(__int64 a1, __int64 a2, char a3)
{
  ...
  v16.QuadPart = 0LL;
  v5 = a3 != 0;
  if ( _InterlockedExchange((volatile __int32 *)(a2 + 18840), 0) )
  {
    v16 = KeQueryPerformanceCounter(&PerformanceFrequency);
    if ( !*(_QWORD *)(a2 + 18832) )
      *(union _LARGE_INTEGER *)(a2 + 18832) = PerformanceFrequency;
    v10 = _InterlockedCompareExchange64((volatile signed __int64 *)(a2 + 18856), 0LL, 0LL);
    v9 = v16;
    v11 = v10;
    v12 = *(_QWORD *)(a2 + 18776);
  ...
  if ( (_DWORD)result )
  {
    *(_QWORD *)(a2 + 18784) += (unsigned int)result;
    *(LARGE_INTEGER *)(a2 + 18776) = v9;
    if ( *(_BYTE *)(a2 + 8) )
    {
      if ( !*(_BYTE *)(a1 + 132) )
      {
