/*
 * XREFs of VidSchiReadCommandFromContextQueue @ 0x1C0026C00
 * Callers:
 ...
 *     VidSchiSetNextRunPacket @ 0x1C000DEEC (VidSchiSetNextRunPacket.c)
 */
  ...
  if ( v8 )
  {
    ...
    if ( v9 == a1 + 672 )
    {
      ...
      *(_DWORD *)(a1 + 652) &= 0xFFFFFFF0;
      VidSchiUpdateContextStatus(a1, (_QWORD *)1, 16216LL);
    }
    else
    {
