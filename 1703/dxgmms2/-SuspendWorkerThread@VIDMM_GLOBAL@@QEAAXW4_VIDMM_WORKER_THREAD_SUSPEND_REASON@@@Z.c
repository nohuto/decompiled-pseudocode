/*
 * XREFs of ?SuspendWorkerThread@VIDMM_GLOBAL@@QEAAXW4_VIDMM_WORKER_THREAD_SUSPEND_REASON@@@Z @ 0x1C0060F7C
 * Callers:
 *     VidMmSuspendWorkerThread @ 0x1C0012CE0 (VidMmSuspendWorkerThread.c)
 * Callees:
