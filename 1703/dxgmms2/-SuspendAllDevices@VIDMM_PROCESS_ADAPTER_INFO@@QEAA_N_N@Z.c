/*
 * XREFs of ?SuspendAllDevices@VIDMM_PROCESS_ADAPTER_INFO@@QEAA_N_N@Z @ 0x1C009953C
 * Callers:
 ...
 *     ?IsResumedRecently@VIDMM_DEVICE@@QEBA_NXZ @ 0x1C00993C8 (-IsResumedRecently@VIDMM_DEVICE@@QEBA_NXZ.c)
 */
