/*
 * XREFs of ?TrimOfferLists@VIDMM_SEGMENT@@QEAAJU_VIDMM_TRIM_PROCESS_FLAGS@@_K1@Z @ 0x1C00A3F68
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::TrimOfferLists(__int64 a1, char a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  result = VIDMM_SEGMENT::TrimOfferList(a1, (_QWORD **)(a1 + 304), a2, a3, a4);
  if ( (int)result < 0 )
    return VIDMM_SEGMENT::TrimOfferList(a1, (_QWORD **)(a1 + 320), a2, a3, a4);
  return result;
}
