/*
 * XREFs of Template_pqxqt @ 0x1C00252CC
 * Callers:
...
NTSTATUS Template_pqxqt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v10 = 4LL;
  v12 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventDmaDpcComplete, 0LL, 5u, &UserData);
}
