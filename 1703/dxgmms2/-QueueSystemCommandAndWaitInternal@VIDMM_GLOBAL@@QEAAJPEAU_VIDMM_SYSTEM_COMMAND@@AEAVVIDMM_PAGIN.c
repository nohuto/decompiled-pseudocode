/*
 * XREFs of ?QueueSystemCommandAndWaitInternal@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_SYSTEM_COMMAND@@AEAVVIDMM_PAGING_QUEUE@@PEAU_VIDSCH_SYNC_OBJECT@@_N@Z @ 0x1C005DF5C
 * Callers:
...
{
  __int64 v6; // rbx
  struct VIDMM_PAGING_QUEUE_PACKET *v10; // rsi
  __int64 v11; // r13
  ...
  *(_QWORD *)(v6 + 136) = KeGetCurrentThread();
  v11 = *((_QWORD *)a3 + 13);
  *((_QWORD *)a3 + 13) = v11 + 1;
  NewPacket = (struct VIDMM_PAGING_QUEUE_PACKET *)*((_QWORD *)a3 + 2);
  v13 = *(_QWORD *)NewPacket;
  if ( *((struct VIDMM_PAGING_QUEUE **)NewPacket + 1) != (struct VIDMM_PAGING_QUEUE *)((char *)a3 + 16)
    || *(struct VIDMM_PAGING_QUEUE_PACKET **)(v13 + 8) != NewPacket )
  {
    __fastfail(3u);
  }
  *(_QWORD *)v10 = v13;
  ...
  *(_QWORD *)(v14 + 8) = 0LL;
  ...
  else
  {
    ...
    if ( !NewPacket )
    {
      ...
      NewPacket = VIDMM_PAGING_QUEUE::GetNewPacket(a3);
    }
  }
  ...
  *((_QWORD *)NewPacket + 16) = *((_QWORD *)a2 + 10);
  if ( !v15 )
  {
  ...
  {
    v25 = -1073741776;
    *((_QWORD *)NewPacket + 10) = &v25;
  }
  VIDMM_PAGING_QUEUE::AppendReadyPacket(a3, NewPacket, &v20);
  if ( v16 )
  {
    if ( v15 )
    {
