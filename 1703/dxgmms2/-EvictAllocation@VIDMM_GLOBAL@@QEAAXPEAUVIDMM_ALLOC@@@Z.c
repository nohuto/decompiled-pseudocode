/*
 * XREFs of ?EvictAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C006DD5C
 * Callers:
...
void __fastcall VIDMM_GLOBAL::EvictAllocation(VIDMM_GLOBAL *this, __int64 **a2)
{
  ...
  DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v3 + 320), v4, v5);
  (*(void (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD))(**(_QWORD **)(v3 + 136) + 24LL))(
    *(_QWORD *)(v3 + 136),
    v3,
    *(_QWORD *)(v3 + 152),
    *(_QWORD *)(v3 + 16));
