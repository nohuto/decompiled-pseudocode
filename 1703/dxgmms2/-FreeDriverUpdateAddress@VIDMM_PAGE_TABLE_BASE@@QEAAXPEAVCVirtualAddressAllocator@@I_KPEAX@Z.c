/*
 * XREFs of ?FreeDriverUpdateAddress@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@I_KPEAX@Z @ 0x1C0053A44
 * Callers:
        ...
        void *a5)
{
                                                ...
                                                + 40352) != a2 )
  {
    ...
    *(_QWORD *)(*((_QWORD *)&v7 + 1) + 16LL) = *(_QWORD *)(v5 + 8LL * ((*(_DWORD *)this >> 7) & 0x1F) + 4880);
    v9 = 472LL * ((*(_DWORD *)this >> 7) & 0x1F) + *(_QWORD *)(v5 + 40168) + 456LL;
