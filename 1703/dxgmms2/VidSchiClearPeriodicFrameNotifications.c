/*
 * XREFs of VidSchiClearPeriodicFrameNotifications @ 0x1C0013C2C
 * Callers:
...
void __fastcall VidSchiClearPeriodicFrameNotifications(__int64 a1, unsigned int a2)
{
  ...
  if ( *(_QWORD *)(v3 + 46936) )
  {
    ...
    ExFreePoolWithTag(*(PVOID *)(v3 + 46936), 0x68536956u);
    *(_QWORD *)(v3 + 46936) = 0LL;
