/*
 * XREFs of ?ReferencePrimaryAllocationForSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0061C64
 * Callers:
 *     VidMmReferencePrimaryAllocationForSubmission @ 0x1C0002CF0 (VidMmReferencePrimaryAllocationForSubmission.c)
 * Callees:
 *     <none>
 */
        ...
        struct VIDMM_ALLOC **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( !*(_BYTE *)(v6 + 96) )
  {
    v7 = **(unsigned int **)(v6 + 520);
    if ( (v7 & 0x40000100) != 0 || (unsigned int)v7 >= 0x80000000 )
    {
      if ( *(_DWORD *)(v6 + 164) )
      {
