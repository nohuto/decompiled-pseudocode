/*
 * XREFs of ?LogProcessInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAU_GUID@@@Z @ 0x1C00A676C
 * Callers:
    ...
    if ( a2 )
    {
      ...
      if ( *(_DWORD *)(v6 + 6416) )
      {
        ...
        do
        {
          ...
          if ( hProvider > 5u )
          {
            if ( (qword_1C003C010 & 0x400000000008LL) == 0 || (v10 = 1, (v8 & 0x400000000008LL) != v8) )
              v10 = 0;
            if ( v10 )
            {
              v11 = *(unsigned __int16 **)(*(_QWORD *)(v6 + 24) + 1224LL);
              v26 = v29;
              v27 = 2LL;
              v12 = *v11;
              v28 = *((_QWORD *)v11 + 1);
              ...
              v51 = 8LL;
              v53 = 8LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0030220, a3, v21, 0x11u, &pData);
              v8 = qword_1C003C018;
            }
          }
          v6 = *(_QWORD *)this;
