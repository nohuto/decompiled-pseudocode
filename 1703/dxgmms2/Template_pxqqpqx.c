/*
 * XREFs of Template_pxqqpqx @ 0x1C00254C0
 * Callers:
...
NTSTATUS Template_pxqqpqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v14 = 4LL;
  v16 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventCancelFlip, 0LL, 7u, &UserData);
}
