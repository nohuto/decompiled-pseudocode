/*
 * XREFs of Template_piixqq @ 0x1C0023EF4
 * Callers:
 ...
 *     VidSchiResetContextQuantumAtISR @ 0x1C0011000 (VidSchiResetContextQuantumAtISR.c)
 *     VidSchiStartContextRunningTimeAtISR @ 0x1C0011070 (VidSchiStartContextRunningTimeAtISR.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0014430 (__security_check_cookie.c)
 */

NTSTATUS Template_piixqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 4LL;
  v14 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventUpdateContextRunningTime, 0LL, 6u, &UserData);
}
