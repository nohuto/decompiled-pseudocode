/*
 * XREFs of ?NotifyAllocationResident@VIDMM_DEVICE@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C0079F60
 * Callers:
...
void __fastcall VIDMM_DEVICE::NotifyAllocationResident(VIDMM_DEVICE *this, __int64 **a2)
{
  ...
  v3 = **a2;
  v4 = *(_QWORD *)(*((_QWORD *)this + 2) + 48LL) + 264LL * (*(_DWORD *)(v3 + 76) & 0x3F);
  if ( (*((_BYTE *)a2 + 36) & 1) != 0 && (*(_DWORD *)(v3 + 76) & 0xF0000) == 0x20000 )
    v5 = 0;
  else
    v5 = *(_WORD *)(v3 + 78) & 0xF;
  *(_QWORD *)(v4 + 8LL * v5 + 72) += *(_QWORD *)(v3 + 16);
  v6 = (unsigned __int8)HIBYTE(*(_WORD *)(v3 + 76)) >> 4;
  ...
  *v9 = (VIDMM_DEVICE *)v8;
  ...
  v10 = (VIDMM_DEVICE **)*((_QWORD *)this + 19);
  if ( *v10 != (VIDMM_DEVICE *)((char *)this + 144) )
    __fastfail(3u);
  *(_QWORD *)v7 = (char *)this + 144;
  *((_QWORD *)v7 + 1) = v10;
  *v10 = v7;
  *((_QWORD *)this + 19) = v7;
}
