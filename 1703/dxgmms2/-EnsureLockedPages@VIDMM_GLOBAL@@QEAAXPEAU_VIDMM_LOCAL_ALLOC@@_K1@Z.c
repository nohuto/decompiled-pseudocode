/*
 * XREFs of ?EnsureLockedPages@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_LOCAL_ALLOC@@_K1@Z @ 0x1C0092B0C
 * Callers:
...
void __fastcall VIDMM_GLOBAL::EnsureLockedPages(VIDMM_GLOBAL *this, PRKPROCESS **a2, __int64 a3, SIZE_T a4)
{
  ...
  if ( !v9 )
  {
    _InterlockedIncrement(&dword_1C003C68C);
    v10 = WdLogNewEntry5_WdLowResource(v8);
    *(_QWORD *)(v10 + 24) = 22133LL;
