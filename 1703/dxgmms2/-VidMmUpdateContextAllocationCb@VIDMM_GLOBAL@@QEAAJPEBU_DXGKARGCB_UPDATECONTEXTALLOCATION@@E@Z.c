/*
 * XREFs of ?VidMmUpdateContextAllocationCb@VIDMM_GLOBAL@@QEAAJPEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@E@Z @ 0x1C009718C
 * Callers:
 *     ?VidMmUpdateContextAllocationCb@@YAJPEAVVIDMM_GLOBAL@@PEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@@Z @ 0x1C001EC00 (-VidMmUpdateContextAllocationCb@@YAJPEAVVIDMM_GLOBAL@@PEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@@Z.c)
        ...
        char a3)
{
  ...
  __int64 v9; // rdi
  __int64 v10; // rbp
  CVirtualAddressAllocator *v11; // r12
  __int64 v12; // rax
  ...
  if ( a3 )
  {
    ...
    v9 = **(_QWORD **)v8;
    v10 = *(_QWORD *)(v9 + 136);
    v11 = (CVirtualAddressAllocator *)*((_QWORD *)this + (*(_DWORD *)(v9 + 76) & 0x3F) + 5044);
    if ( (*(_DWORD *)(v8 + 28) & 3) == 2 )
    {
      ...
      if ( v13 )
      {
        v18 = (struct _RTL_BALANCED_NODE *)v13[12];
        ...
        CVirtualAddressAllocator::FreeVirtualAddressRange((struct _KTHREAD **)v11, v18);
        return 0LL;
      }
      else
      {
        v17 = WdLogNewEntry5_WdAssertion(v15, v14);
        *(_QWORD *)(v17 + 24) = 21683LL;
