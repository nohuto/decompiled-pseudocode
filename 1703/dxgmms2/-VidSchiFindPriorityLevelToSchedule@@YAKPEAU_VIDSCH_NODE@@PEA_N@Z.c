/*
 * XREFs of ?VidSchiFindPriorityLevelToSchedule@@YAKPEAU_VIDSCH_NODE@@PEA_N@Z @ 0x1C00227A4
 * Callers:
...
__int64 __fastcall VidSchiFindPriorityLevelToSchedule(struct _VIDSCH_NODE *a1, bool *a2)
{
  ...
  v5 = *((unsigned int *)a1 + 422);
  if ( *((_BYTE *)a1 + 1944) && (v5 & 0xC0000000) == 0 && (v5 & (0xFFFFFFFFuLL >> (31 - *(_BYTE *)(v2 + 176)))) != 0 )
  {
  ...
  {
    MostSignificantBit = RtlFindMostSignificantBit(*((unsigned int *)a1 + 422));
    *a2 = 0;
  }
