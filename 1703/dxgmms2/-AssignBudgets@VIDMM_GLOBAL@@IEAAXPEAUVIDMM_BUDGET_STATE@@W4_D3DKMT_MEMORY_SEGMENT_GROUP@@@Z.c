/*
 * XREFs of ?AssignBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1C00A4C90
 * Callers:
        ...
        enum _D3DKMT_MEMORY_SEGMENT_GROUP a3)
{
  ...
  v3 = 0;
  v4 = a3;
  v6 = *((_QWORD *)this + 5150) + 280LL * *((unsigned int *)a2 + 69);
  if ( *(_BYTE *)((int)a3 + v6 + 272) )
  {
    v8 = 0LL;
    v9 = 3LL;
