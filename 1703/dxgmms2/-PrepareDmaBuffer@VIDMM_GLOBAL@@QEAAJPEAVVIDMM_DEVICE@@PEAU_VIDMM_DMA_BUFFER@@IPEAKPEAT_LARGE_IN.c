/*
 * XREFs of ?PrepareDmaBuffer@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_DMA_BUFFER@@IPEAKPEAT_LARGE_INTEGER@@@Z @ 0x1C00947D8
 * Callers:
        ...
        union _LARGE_INTEGER *a6)
{
  ...
  for ( i = v13 + 8; ; i += 24LL )
  {
    ...
    if ( (*(_DWORD *)(v17 + 76) & 0x100000) != 0 )
      break;
    v18 = (VIDMM_GLOBAL *)*(unsigned __int16 *)(*(_QWORD *)(v17 + 520) + 4LL);
