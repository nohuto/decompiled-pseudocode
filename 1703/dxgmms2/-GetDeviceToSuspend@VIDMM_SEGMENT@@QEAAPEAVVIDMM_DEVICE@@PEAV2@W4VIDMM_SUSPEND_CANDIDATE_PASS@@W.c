/*
 * XREFs of ?GetDeviceToSuspend@VIDMM_SEGMENT@@QEAAPEAVVIDMM_DEVICE@@PEAV2@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_PRIORITY_BAND@@PEAPEAV2@@Z @ 0x1C0099008
 * Callers:
        ...
        struct VIDMM_DEVICE **a5)
{
  ...
  if ( v7 != (_QWORD *)(a1 + 160) )
  {
    do
    {
      v8 = v7 - 3;
      v7 = (_QWORD *)*v7;
      if ( !(unsigned __int8)PsIsSystemProcess(*(_QWORD *)*v8) && !*(_BYTE *)(*(_QWORD *)(*v8 + 32LL) + 272LL) )
      {
        v9 = (_QWORD *)v8[5];
        while ( v9 != v8 + 5 )
        {
          ...
          if ( VIDMM_DEVICE::CanSuspendThisDevice(v10, a2, a3, a4) )
          {
            if ( !VIDMM_DEVICE::IsResumedRecently(v10) )
            {
              ...
              v15 = v8[3];
              v16 = (_QWORD *)v8[4];
              if ( *(_QWORD **)(v15 + 8) != v8 + 3 || (_QWORD *)*v16 != v14 )
                __fastfail(3u);
              *v16 = v15;
              *(_QWORD *)(v15 + 8) = v16;
              v17 = (_QWORD *)v5[1];
