/*
 * XREFs of ?FlushEvictQueue@VIDMM_WORKER_THREAD@@AEAAXPEAVVIDMM_PAGING_QUEUE@@@Z @ 0x1C0098EBC
 * Callers:
...
void __fastcall VIDMM_WORKER_THREAD::FlushEvictQueue(VIDMM_WORKER_THREAD *this, struct VIDMM_PAGING_QUEUE *a2)
{
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)this + 17) = KeGetCurrentThread();
    ...
    v6 = *v5;
    if ( v5[1] != (struct VIDMM_PAGING_QUEUE *)((char *)a2 + 32) || *((struct VIDMM_PAGING_QUEUE ***)v6 + 1) != v5 )
      __fastfail(3u);
    *v4 = v6;
    *((_QWORD *)v6 + 1) = v4;
    *v5 = 0LL;
