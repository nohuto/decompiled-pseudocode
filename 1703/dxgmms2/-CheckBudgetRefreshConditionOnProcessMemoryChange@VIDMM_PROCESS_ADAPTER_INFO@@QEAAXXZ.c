/*
 * XREFs of ?CheckBudgetRefreshConditionOnProcessMemoryChange@VIDMM_PROCESS_ADAPTER_INFO@@QEAAXXZ @ 0x1C0091BF8
 * Callers:
        ...
        VIDMM_PROCESS_ADAPTER_INFO *this)
{
  ...
  if ( *(_DWORD *)(*(_QWORD *)this + 6416LL) )
  {
    do
    {
      v4 = (VIDMM_PROCESS_BUDGET_STATE *)(*((_QWORD *)this + 6) + 264LL * v2);
      DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED((DXGAUTOPUSHLOCKSHARED *)v12, (struct _KTHREAD **)this + 41);
      v5 = (_QWORD *)((char *)v4 + 184);
      v6 = 0;
      v7 = (unsigned int *)(280LL * v2 + *(_QWORD *)(*(_QWORD *)this + 41200LL) + 240LL);
      while ( 1 )
      {
        v8 = *(v5 - 6);
        if ( v6 == 1 )
