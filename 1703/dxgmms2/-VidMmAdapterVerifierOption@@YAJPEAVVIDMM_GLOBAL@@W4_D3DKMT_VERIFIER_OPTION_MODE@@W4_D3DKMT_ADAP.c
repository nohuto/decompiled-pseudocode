/*
 * XREFs of ?VidMmAdapterVerifierOption@@YAJPEAVVIDMM_GLOBAL@@W4_D3DKMT_VERIFIER_OPTION_MODE@@W4_D3DKMT_ADAPTER_VERIFIER_OPTION_TYPE@@PEAT_D3DKMT_ADAPTER_VERIFIER_OPTION_DATA@@@Z @ 0x1C001E9B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
