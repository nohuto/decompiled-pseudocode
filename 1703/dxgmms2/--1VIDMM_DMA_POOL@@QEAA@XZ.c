/*
 * XREFs of ??1VIDMM_DMA_POOL@@QEAA@XZ @ 0x1C006E65C
 * Callers:
 ...
 *     ?UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ @ 0x1C006E8FC (-UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ.c)
 */
...
void __fastcall VIDMM_DMA_POOL::~VIDMM_DMA_POOL(VIDMM_DMA_POOL **this)
{
  ...
  if ( ((_DWORD)this[4] & 2) != 0 )
  {
    ...
    v2 = this[14];
    v3 = this[15];
    if ( *((VIDMM_DMA_POOL ***)v2 + 1) != this + 14 || *(VIDMM_DMA_POOL ***)v3 != this + 14 )
      __fastfail(3u);
    *(_QWORD *)v3 = v2;
    *((_QWORD *)v2 + 1) = v3;
