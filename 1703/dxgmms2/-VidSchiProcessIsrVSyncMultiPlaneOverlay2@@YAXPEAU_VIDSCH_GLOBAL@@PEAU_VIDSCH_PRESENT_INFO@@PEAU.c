/*
 * XREFs of ?VidSchiProcessIsrVSyncMultiPlaneOverlay2@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@PEAU_DXGKARGCB_NOTIFY_INTERRUPT_DATA@@PEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x1C0023114
 * Callers:
        ...
        struct _VIDSCH_VSYNC_COOKIE *a4)
{
  ...
  *((_QWORD *)a2 + 2349) = a3->MiracastEncodeChunkCompleted.pPrivateDriverData;
  *((_BYTE *)a4 + 104) ^= (*((_BYTE *)a4 + 104) ^ (a3->Flags.Value >> 1)) & 1;
  memset((char *)a4 + 112, 0, 0x80uLL);
  for ( i = 0LL;
                                                                                           ...
                                                                                           + 2 * v12) )
  {
    ...
    if ( (unsigned int)v13 >= *((_DWORD *)a1 + 32) )
    {
      ...
      v14[7] = *((unsigned int *)a1 + 32);
      WdLogEvent5_WdCriticalError(v14);
      JUMPOUT(0x1C0023236LL);
    }
    i = (unsigned int)(i + 1);
