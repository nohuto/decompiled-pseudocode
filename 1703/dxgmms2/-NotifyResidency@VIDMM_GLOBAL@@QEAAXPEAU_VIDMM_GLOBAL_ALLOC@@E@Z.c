/*
 * XREFs of ?NotifyResidency@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C005A34C
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a3)
{
  ...
  int v10; // ebx
  __int64 v11; // rax
  _DXGKARG_BUILDPAGINGBUFFER v12; // [rsp+40h] [rbp-C0h] BYREF
  ...
  if ( ((_BYTE)this[5109] & 8) == 0 )
  {
    ...
    do
    {
      ...
      VIDMM_GLOBAL::CompleteBuildPagingBufferIteration((signed __int64)this, v6, a2, &v12, v10, 0, 0LL);
    }
    while ( v10 < 0 );
    if ( this[5115] )
