/*
 * XREFs of VidSchiCheckPendingDeviceCommand @ 0x1C000E8C8
 * Callers:
...
void __fastcall VidSchiCheckPendingDeviceCommand(_QWORD *a1)
{
  ...
  v1 = a1[4];
  v38 = *(VIDMM_GLOBAL **)(*(_QWORD *)(v1 + 8) + 440LL);
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v1 + 1912), &LockHandle);
  v4 = (_QWORD **)(v1 + 1936);
  v5 = *v4;
  if ( *v4 != v4 )
  {
  ...
  while ( v7 != a1 + 153 )
  {
    ...
    while ( v19 != v18 )
    {
      ...
      v22 = v20[27];
      v23 = (_QWORD *)v20[28];
      if ( *(_QWORD **)(v22 + 8) != v20 + 27 || (_QWORD *)*v23 != v21 )
        __fastfail(3u);
      *v23 = v22;
      *(_QWORD *)(v22 + 8) = v23;
    ...
    while ( v25 != v24 )
    {
      ...
      v28 = v26[25];
      v29 = (__int64 **)v26[26];
      if ( *(_QWORD **)(v28 + 8) != v26 + 25 || *v29 != v27 )
        __fastfail(3u);
      *v29 = (__int64 *)v28;
      *(_QWORD *)(v28 + 8) = v29;
      ...
      {
        KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(a1[4] + 1912LL), &LockHandle);
        v31 = a1[4] + 1936LL;
        v32 = *(__int64 ***)(a1[4] + 1944LL);
        if ( *v32 != (__int64 *)v31 )
          __fastfail(3u);
        v27[1] = (__int64)v32;
        *v27 = v31;
      ...
      *v34 = v33;
      ...
      if ( !v35 )
      {
        ...
        if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
          Template_px(v33, v9, v6, v36, v8[2]);
      }
