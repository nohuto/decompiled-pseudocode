/*
 * XREFs of ?TrackAndValidatePagesOnLock@VIDMM_SEGMENT@@QEAAEPEAU_VIDMM_MDL@@_KPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C004B170
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a4)
{
  ...
  while ( 1 )
  {
    ...
    if ( v9 )
    {
      *(_QWORD *)(v9 + 16LL * *((unsigned int *)v5 + 67)) = *(_QWORD *)&v7[2 * v6];
      *(_QWORD *)(*((_QWORD *)v5 + 34) + 16LL * (unsigned int)(*((_DWORD *)v5 + 67))++ + 8) = a4;
      v11 = *((_DWORD *)v5 + 67);
      this = v11;
      if ( v11 >= *((_DWORD *)v5 + 66) )
        this = 0LL;
    ...
    if ( *(_QWORD *)&v7[2 * v6] << 12 > *((_QWORD *)v5 + 18) )
      break;
    if ( ++v6 >= v8 )
      return 1;
  }
