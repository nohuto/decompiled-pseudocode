/*
 * XREFs of VidSchQueryVidPnSourceStatistics @ 0x1C002A4C0
 * Callers:
 *     <none>
 * Callees:
 *     CopyVidPnSourceStatistics @ 0x1C00AB848 (CopyVidPnSourceStatistics.c)
 */
...
__int64 __fastcall VidSchQueryVidPnSourceStatistics(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( a2 >= *(_DWORD *)(a1 + 40) )
    return 3221225485LL;
  CopyVidPnSourceStatistics(a3, *(_QWORD *)(a1 + 8LL * a2 + 5544));
