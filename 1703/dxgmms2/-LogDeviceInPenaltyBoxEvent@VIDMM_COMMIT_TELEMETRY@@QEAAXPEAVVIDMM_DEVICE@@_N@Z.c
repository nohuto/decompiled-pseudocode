/*
 * XREFs of ?LogDeviceInPenaltyBoxEvent@VIDMM_COMMIT_TELEMETRY@@QEAAXPEAVVIDMM_DEVICE@@_N@Z @ 0x1C00A5C64
 * Callers:
        ...
        char a3)
{
  ...
  _DWORD v40[2]; // [rsp+F8h] [rbp-8h] BYREF
    ...
    && (unsigned int)_InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 1) + 260LL)) <= 6 )
  {
      ...
      && (qword_1C003C018 & 0x400000000008LL) == qword_1C003C018 )
    {
      ...
      TlgCreateSz(&v45, v11);
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C002FFAE, &ActivityId, v13, 7u, &pData);
    }
    if ( a3 )
    {
      ...
      if ( hProvider > 5u
        ...
        && (qword_1C003C018 & 0x400000000008LL) == qword_1C003C018 )
      {
        v14 = *(unsigned __int16 **)(*(_QWORD *)(*(_QWORD *)this + 24LL) + 1224LL);
        v28 = 0;
        v26 = v30;
        v27 = 2;
        v15 = *v14;
        ...
        v23 = v19;
        v33 = 8;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C002FF55, &ActivityId, v20, 6u, &v25);
      }
