/*
 * XREFs of ??1VIDMM_RECYCLE_HEAP_MGR@@UEAA@XZ @ 0x1C0065324
 * Callers:
 *     ??_EVIDMM_RECYCLE_HEAP_MGR@@UEAAPEAXI@Z @ 0x1C0002D60 (--_EVIDMM_RECYCLE_HEAP_MGR@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1VIDMM_RECYCLE_HEAP@@QEAA@XZ @ 0x1C0066B50 (--1VIDMM_RECYCLE_HEAP@@QEAA@XZ.c)
...
void __fastcall VIDMM_RECYCLE_HEAP_MGR::~VIDMM_RECYCLE_HEAP_MGR(VIDMM_RECYCLE_HEAP_MGR *this, __int64 a2)
{
  ...
  *(_QWORD *)this = &VIDMM_RECYCLE_HEAP_MGR::`vftable';
  ...
  while ( v13 != (VIDMM_RECYCLE_HEAP_MGR *)((char *)this + 1392) )
  {
    ...
    if ( v12 )
      VIDMM_RECYCLE_MULTIRANGE::MergeSubrangesWherePossible(v12, 0);
  }
  ...
  while ( 1 )
  {
    ...
    if ( !v32 )
      VIDMM_RECYCLE_MULTIRANGE::MergeSubrangesWherePossible(v20[17], 0);
  }
