/*
 * XREFs of ?RemoveVaRangeFromVad@CVirtualAddressAllocator@@QEAAXPEAU_LIST_ENTRY@@EE@Z @ 0x1C00516D0
 * Callers:
        ...
        char a4)
{
  ...
  Flink = a2->Flink;
  v12 = a2->Blink;
  if ( a2->Flink->Blink != a2 || v12->Flink != a2 )
    __fastfail(3u);
  v12->Flink = Flink;
  Flink->Blink = v12;
  ...
  if ( VidMmAllocFromOwner )
  {
    ...
    if ( p_Blink[5] )
    {
      ...
      v21 = *(_QWORD *)v19;
      v22 = (char **)p_Blink[6];
      if ( *(char **)(*(_QWORD *)v19 + 8LL) != v19 || *v22 != v19 )
        __fastfail(3u);
      *v22 = (char *)v21;
      *(_QWORD *)(v21 + 8) = v22;
      *(_QWORD *)v19 = 0LL;
