/*
 * XREFs of ?RemoveAllocationFromDecommitList@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z @ 0x1C0094D64
 * Callers:
        ...
        struct VIDMM_PROCESS_ADAPTER_INFO *a3)
{
  ...
  v5 = v4 + 304;
  ExAcquirePushLockSharedEx(v4 + 304, 0LL);
  v6 = (_QWORD *)(v4 + 320);
  for ( i = (_QWORD *)*v6; i != v6; i = (_QWORD *)*i )
  {
    v8 = (struct _VIDMM_GLOBAL_ALLOC *)i[2];
    if ( v8 == (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 448) )
      i[2] = *(_QWORD *)v8;
  }
  ExReleasePushLockSharedEx(v5, 0LL);
  KeLeaveCriticalRegion();
  v9 = (_QWORD *)((char *)a2 + 448);
  v10 = *((_QWORD *)a2 + 56);
  v11 = (_QWORD *)*((_QWORD *)a2 + 57);
  if ( *(struct _VIDMM_GLOBAL_ALLOC **)(v10 + 8) != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 448)
    || (_QWORD *)*v11 != v9 )
  {
    __fastfail(3u);
  }
