/*
 * XREFs of ?RotateCopyCallback@VIDMM_MEMORY_SEGMENT@@KAJPEAU_MDL@@0PEAX@Z @ 0x1C00A0DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VIDMM_MEMORY_SEGMENT::RotateCopyCallback(struct _MDL *a1, struct _MDL *a2, union _LARGE_INTEGER *a3)
{
  ...
  if ( (*(_BYTE *)(472LL * (*(_DWORD *)(a3->QuadPart + 76) & 0x3F) + *((_QWORD *)v5 + 5021) + 436) & 4) == 0 )
    return 3221225473LL;
  ...
  else
  {
    ...
    {
      v14 = *(_QWORD *)(*((_QWORD *)v5 + 2) + 416LL);
      if ( (*(_BYTE *)(v14 + 2844) & 4) != 0 )
      {
