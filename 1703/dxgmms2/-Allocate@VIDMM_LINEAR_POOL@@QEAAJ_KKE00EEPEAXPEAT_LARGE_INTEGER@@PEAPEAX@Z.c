/*
 * XREFs of ?Allocate@VIDMM_LINEAR_POOL@@QEAAJ_KKE00EEPEAXPEAT_LARGE_INTEGER@@PEAPEAX@Z @ 0x1C004BFC8
 * Callers:
 ...
 *     ?AllocateScratchRange@VIDMM_MEMORY_SEGMENT@@UEAAJKPEAPEAXPEA_K@Z @ 0x1C00A08B0 (-AllocateScratchRange@VIDMM_MEMORY_SEGMENT@@UEAAJKPEAPEAXPEA_K@Z.c)
...
LABEL_20:
    if ( *((_QWORD *)this + 4) )
    {
      v27 = VIDMM_LINEAR_POOL::FindBlockRun((__int64)this, a2, a3, a4, a5, a6, 1, &v51, (__int64 *)&v52, &v54, &v53);
      v11 = v51;
      BlockRun = v27;
    }
    if ( BlockRun >= 0 )
      goto LABEL_4;
    BlockRun = VIDMM_LINEAR_POOL::FindBlockRun((__int64)this, a2, a3, a4, a5, a6, 2, &v51, (__int64 *)&v52, &v54, &v53);
    goto LABEL_27;
  }
LABEL_3:
  v11 = v51;
  ...
  if ( v21 != (VIDMM_LINEAR_POOL *)((char *)this + 40) )
  {
    ...
    if ( v22[56] == 2 && *(_QWORD *)v22 + *((_QWORD *)v22 + 1) == *(_QWORD *)v11 )
    {
      ...
      *((_QWORD *)v11 + 1) += *((_QWORD *)v22 + 1);
      v38 = v22 + 24;
      v39 = *((_QWORD *)v22 + 3);
      v40 = (_QWORD *)*((_QWORD *)v22 + 4);
      if ( *(char **)(v39 + 8) != v22 + 24 || (_QWORD *)*v40 != v38 )
        __fastfail(3u);
      *v40 = v39;
      *(_QWORD *)(v39 + 8) = v40;
      *v38 = 0LL;
      ...
      *((_QWORD *)v22 + 4) = 0LL;
      v42 = *((_QWORD *)v22 + 5);
      v43 = (_QWORD *)*((_QWORD *)v22 + 6);
      if ( *(char **)(v42 + 8) != v22 + 40 || (_QWORD *)*v43 != v41 )
        __fastfail(3u);
      *v43 = v42;
      *(_QWORD *)(v42 + 8) = v43;
      *v41 = 0LL;
  ...
  if ( *v17 != (VIDMM_LINEAR_POOL *)((char *)this + 40) )
  {
    ...
    if ( *(_BYTE *)(v23 + 56) == 2 && *(_QWORD *)v23 == *((_QWORD *)v11 + 1) + *(_QWORD *)v11 )
    {
      ...
      *((_QWORD *)v11 + 1) += *(_QWORD *)(v23 + 8);
      ...
      v46 = *(_QWORD *)(v23 + 24);
      v47 = *(_QWORD **)(v23 + 32);
      if ( *(_QWORD *)(v46 + 8) != v23 + 24 || (_QWORD *)*v47 != v45 )
        __fastfail(3u);
      *v47 = v46;
      *(_QWORD *)(v46 + 8) = v47;
      *v45 = 0LL;
      ...
      *(_QWORD *)(v23 + 32) = 0LL;
      v49 = *(_QWORD *)(v23 + 40);
      v50 = *(_QWORD **)(v23 + 48);
      if ( *(_QWORD *)(v49 + 8) != v23 + 40 || (_QWORD *)*v50 != v48 )
        __fastfail(3u);
      *v50 = v49;
      *(_QWORD *)(v49 + 8) = v50;
      *v48 = 0LL;
