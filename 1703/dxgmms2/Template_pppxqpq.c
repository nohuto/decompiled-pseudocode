/*
 * XREFs of Template_pppxqpq @ 0x1C0020DF0
 * Callers:
...
NTSTATUS Template_pppxqpq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v14 = 8LL;
  v16 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingQueueSubmit, 0LL, 7u, &UserData);
}
