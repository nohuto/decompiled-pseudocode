/*
 * XREFs of VidSchiDeferredVisibilityThread @ 0x1C0013CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchiDeferredVisibilityThread(__int64 a1)
{
  ...
  {
    v3 = 0;
    v4 = *(_QWORD *)(*(_QWORD *)(a1 + 2288) + 416LL);
    _InterlockedExchange((volatile __int32 *)(v4 + 2080), 0);
    if ( *(_DWORD *)(v4 + 40) )
    {
      do
      {
        if ( _InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(v4 + 8LL * v3 + 2992) + 46928LL), 0, 3) == 3 )
        {
          LOBYTE(v2) = 1;
          LOBYTE(v11) = 0;
