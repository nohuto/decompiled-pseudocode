/*
 * XREFs of ?HandleFullPageTableCoverage@VIDMM_PAGE_DIRECTORY@@QEAAEPEAVCVirtualAddressAllocator@@PEBU_DXGK_GPUMMUCAPS@@PEBUCOMMIT_VA_STATE@@PEBUVIDMM_PAGE_TABLE_LEVEL_DESC@@III_KPEAE@Z @ 0x1C009C32C
 * Callers:
        ...
        unsigned __int8 *a10)
{
  ...
  if ( !v13 )
  {
    ...
    *(_QWORD *)(v20 + 16LL * a6) |= 1uLL;
    ...
    if ( v10 )
    {
      *(_QWORD *)(v21 + 16LL * a6) |= 2uLL;
    }
    else
    {
      *(_QWORD *)(v21 + 16LL * a6) |= 0x400uLL;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6 + 8) = a9 >> 12;
      v22 = *(_QWORD *)a4;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= (*(_DWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^ (32 * *((_DWORD *)a4 + 13))) & 0x3E0;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= ((unsigned __int8)v22 ^ (unsigned __int8)*(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6)) & 8;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= ((unsigned __int8)v22 ^ (unsigned __int8)*(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6)) & 0x10;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= ((unsigned __int8)v22 ^ (unsigned __int8)*(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6)) & 4;
      *(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6) ^= ((unsigned int)v22 ^ (unsigned int)*(_QWORD *)(*((_QWORD *)this + 3) + 16LL * a6)) & 0x1F800;
      v14[2] = *((_DWORD *)a4 + 12);
