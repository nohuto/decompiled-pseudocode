/*
 * XREFs of ?BuildInitContextAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@_N@Z @ 0x1C00924C8
 * Callers:
  ...
  do
  {
    ...
    if ( bTracingEnabled )
    {
      ...
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x200) != 0 )
      {
        v19 = 0LL;
        v18 = (int)v12;
        Template_pppxxq(v15, v14, v16, CurrentProcessId, v4);
      }
    }
