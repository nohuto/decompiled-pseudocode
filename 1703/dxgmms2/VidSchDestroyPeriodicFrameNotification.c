/*
 * XREFs of VidSchDestroyPeriodicFrameNotification @ 0x1C0029780
 * Callers:
...
void __fastcall VidSchDestroyPeriodicFrameNotification(_DWORD *P, __int64 a2, __int64 a3)
{
  ...
  if ( *((_QWORD *)P + 4) )
  {
    ...
    v6 = ((__int64 (__fastcall *)(_QWORD, _QWORD *))DxgCoreInterface[53])(
           *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v5 + 8) + 16LL) + 2280LL),
           v24);
    v9 = v6;
    if ( v6 < 0 )
    {
  ...
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)(*(_QWORD *)P + 8LL) + 1880LL), &LockHandle);
  *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)P + 8LL) + 8LL * (unsigned int)P[2] + 2992) + 46936LL)
