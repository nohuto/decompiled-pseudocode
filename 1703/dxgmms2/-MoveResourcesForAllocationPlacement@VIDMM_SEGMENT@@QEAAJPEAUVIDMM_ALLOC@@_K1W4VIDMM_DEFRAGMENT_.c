/*
 * XREFs of ?MoveResourcesForAllocationPlacement@VIDMM_SEGMENT@@QEAAJPEAUVIDMM_ALLOC@@_K1W4VIDMM_DEFRAGMENT_DIRECTION@@PEA_NPEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00A2940
 * Callers:
...
{
  __int64 v8; // rbx
  __int64 v10[3]; // [rsp+30h] [rbp-28h] BYREF
  char v11; // [rsp+48h] [rbp-10h]

  v8 = *MEMORY[0];
  VIDMM_LINEAR_POOL::FindBestDefragmentRegion(*(_QWORD *)(a1 + 176), v10);
  if ( v11 )
  {
