/*
 * XREFs of ?ResetBackingStore@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C005E21C
 * Callers:
 ...
 *     ?VidMmiSetPriorityForMemoryPages@@YAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAX_K@Z @ 0x1C006D3E0 (-VidMmiSetPriorityForMemoryPages@@YAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAX_K@Z.c)
 */
...
LABEL_17:
      *((_QWORD *)this + 920) += *((_QWORD *)a2 + 1);
      ...
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      {
        ...
        Template_pqtt(*((_QWORD *)a2 + 1) >> 12, (int)v14 >= 0, v9, a2, AllocationType, Protect, v26);
      }
