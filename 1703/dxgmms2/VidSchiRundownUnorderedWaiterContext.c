/*
 * XREFs of VidSchiRundownUnorderedWaiterContext @ 0x1C0015900
 * Callers:
 *     ??$VidSchRundownUnorderedWaiter@U_VIDSCH_DEVICE@@@@YAJPEAU_VIDSCH_DEVICE@@PEAU_VIDSCH_GLOBAL@@W4_VIDSCH_FLUSH_STAGE@@_NP6AX0@Z@Z @ 0x1C0001E2C (--$VidSchRundownUnorderedWaiter@U_VIDSCH_DEVICE@@@@YAJPEAU_VIDSCH_DEVICE@@PEAU_VIDSCH_GLOBAL@@W4.c)
...
void __fastcall VidSchiRundownUnorderedWaiterContext(__int64 a1)
{
  ...
  while ( v3 != v1 )
  {
    ...
    if ( v5 )
    {
      ...
      else if ( (v6 & 8) != 0 && (*(_BYTE *)(*(_QWORD *)(*(_QWORD *)(a1 + 104) + 32LL) + 2844LL) & 1) != 0 )
      {
