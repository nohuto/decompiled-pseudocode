/*
 * XREFs of VidSchiStartNodeYield @ 0x1C0011BC0
 * Callers:
...
__int64 __fastcall VidSchiStartNodeYield(__int64 a1, __int64 a2, unsigned __int64 a3, int a4)
{
  ...
  if ( !*(_QWORD *)(v4 + 168) )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      Template_p(v10, &EventYieldSetExpirationTimer, v11, *(_QWORD *)(v4 + 16));
  }
  v12 = 100LL * *(_QWORD *)(a1 + 1928);
  *(_QWORD *)(a1 + 1920) = a2;
  *(_QWORD *)(v4 + 168) = a2 + 10 * (v12 / v8);
  ...
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
  {
    ...
    {
      v16 /= a3;
      v17 = 10000000 * (*(_QWORD *)(a1 + 1928) % a3) / a3 + 10000000 * v16;
    }
