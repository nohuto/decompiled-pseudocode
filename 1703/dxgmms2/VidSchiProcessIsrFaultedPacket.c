/*
 * XREFs of VidSchiProcessIsrFaultedPacket @ 0x1C0026704
 * Callers:
...
void __fastcall VidSchiProcessIsrFaultedPacket(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(a1 + 64) != a2 && *(_DWORD *)(a1 + 72) != a2 )
  {
    ...
    if ( v9 == v5[13].Alignment || v9 == v5[14].Alignment )
    {
    ...
    *(_DWORD *)(*(_QWORD *)(v11 + 104) + 188LL) = *(_DWORD *)(a4 + 60);
    ...
    {
      if ( v16 != v11 )
        *(_QWORD *)(v16 + 472) = *(_QWORD *)(v11 + 472);
    }
    _InterlockedDecrement((volatile signed __int32 *)(a1 + 2772));
    VidSchiProfilePerformanceTick(12LL, (__int64)v5, a1, v15, 0LL, 0LL, v8, a4);
    ExpInterlockedPushEntrySList(v5 + 120, (PSLIST_ENTRY)(v8 + 32));
  }
}
