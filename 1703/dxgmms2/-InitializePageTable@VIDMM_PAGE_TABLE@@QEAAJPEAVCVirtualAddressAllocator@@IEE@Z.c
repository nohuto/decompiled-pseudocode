/*
 * XREFs of ?InitializePageTable@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@IEE@Z @ 0x1C0050DC8
 * Callers:
        ...
        char a5)
{
  ...
  v7 = a3;
  v9 = *(_QWORD *)(*((_QWORD *)a2 + 10) + 40168LL) + 472LL * ((*(_DWORD *)this >> 7) & 0x1F);
  ...
  *((_QWORD *)this + 3) = v13;
  ...
  {
    _InterlockedIncrement(&dword_1C003C688);
    v20 = WdLogNewEntry5_WdLowResource(v14);
    *(_QWORD *)(v20 + 24) = 3949LL;
