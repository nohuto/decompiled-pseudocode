/*
 * XREFs of ?ETWAllocationHandle@VIDMM_GLOBAL@@QEAAPEAXI@Z @ 0x1C0092A4C
 * Callers:
 *     VidMmETWAllocationHandle @ 0x1C001ECA0 (VidMmETWAllocationHandle.c)
 * Callees:
...
__int64 __fastcall VIDMM_GLOBAL::ETWAllocationHandle(VIDMM_GLOBAL *this, unsigned int a2)
{
  ...
  v5 = (a2 >> 6) & 0xFFFFFF;
  if ( v5 < *((_DWORD *)Current + 52)
    && (v6 = *((_QWORD *)Current + 24),
