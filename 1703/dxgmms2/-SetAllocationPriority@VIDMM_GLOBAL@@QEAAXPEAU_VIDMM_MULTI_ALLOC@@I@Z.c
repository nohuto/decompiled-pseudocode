/*
 * XREFs of ?SetAllocationPriority@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00950D0
 * Callers:
 *     VidMmSetAllocationPriority @ 0x1C001EDA0 (VidMmSetAllocationPriority.c)
 * Callees:
 *     <none>
 */
