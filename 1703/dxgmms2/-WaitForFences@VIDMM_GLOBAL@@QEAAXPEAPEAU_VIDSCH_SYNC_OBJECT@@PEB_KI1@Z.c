/*
 * XREFs of ?WaitForFences@VIDMM_GLOBAL@@QEAAXPEAPEAU_VIDSCH_SYNC_OBJECT@@PEB_KI1@Z @ 0x1C0062DF0
 * Callers:
 *     ?VidMmWaitForFences@@YAXPEAVVIDMM_GLOBAL@@PEAPEAU_VIDSCH_SYNC_OBJECT@@PEB_KI@Z @ 0x1C0014290 (-VidMmWaitForFences@@YAXPEAVVIDMM_GLOBAL@@PEAPEAU_VIDSCH_SYNC_OBJECT@@PEB_KI@Z.c)
 ...
 *     ?VidMmEvictAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@PEAU_D3DKMT_EVICTION_CRITERIA@@@Z @ 0x1C0096AB0 (-VidMmEvictAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@.c)
 * Callees:
...
LABEL_13:
  ...
  if ( (_DWORD)v10 )
  {
    ...
    do
    {
      ...
      v6 += 8;
      a3 = (const unsigned __int64 *)((char *)a3 - 1);
    }
    while ( a3 );
  }
  v9 = (const unsigned __int64 *)v32;
...
LABEL_21:
  ...
  if ( (int)ObCreateObject(0LL, ExEventObjectType, &v27, 0LL, 0LL, 24, 0, 0, &Event) >= 0 )
  {
    ...
    if ( (int)VidSchSubmitWaitFromCpu(
                ...
                0,
                1,
                *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 416LL) + 224LL),
                0LL) < 0 )
