/*
 * XREFs of Template_pqqqdddddddd @ 0x1C0024A68
 * Callers:
...
NTSTATUS Template_pqqqdddddddd(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v24 = 4LL;
  v26 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &MMIOFlipMultiPlaneOverlay3, 0LL, 0xCu, &UserData);
}
