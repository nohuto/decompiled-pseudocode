/*
 * XREFs of ?PerformDefragmentationEscape@VIDMM_GLOBAL@@QEAAXW4_D3DKMT_DEFRAG_ESCAPE_OPERATION@@IPEA_K111@Z @ 0x1C0094668
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( (unsigned int)(a2 - 1) <= 1 )
  {
    ...
    {
      if ( (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 2192LL) + 48 * i + 16) & 4) == 0 )
        continue;
      v7 = *((_QWORD *)this + 5021) + 472LL * (unsigned int)i;
      v8 = *(_DWORD *)(v7 + 20);
      v9 = v8 + *(_DWORD *)(v7 + 24);
      if ( v8 >= v9 )
        continue;
      v10 = *((_QWORD *)this + 464);
      while ( (*(_DWORD *)(*(_QWORD *)(v10 + 8LL * v8) + 80LL) & 0x1001) != 0 )
      {
        if ( ++v8 >= v9 )
          goto LABEL_16;
      }
      ...
      if ( (*(_BYTE *)(v11 + 82) & 1) != 0 )
      {
        v12[9] = 0LL;
        LODWORD(v12[7]) = 1;
        if ( (int)VIDMM_GLOBAL::QueueSystemCommandAndWait(this, (struct _VIDMM_SYSTEM_COMMAND *)v12, 1) < 0 )
          continue;
        LODWORD(v12[7]) = 2;
        if ( (int)VIDMM_GLOBAL::QueueSystemCommandAndWait(this, (struct _VIDMM_SYSTEM_COMMAND *)v12, 1) < 0 )
          continue;
      ...
      VIDMM_GLOBAL::QueueSystemCommandAndWait(this, (struct _VIDMM_SYSTEM_COMMAND *)v12, 1);
LABEL_16:
      ;
    }
  }
