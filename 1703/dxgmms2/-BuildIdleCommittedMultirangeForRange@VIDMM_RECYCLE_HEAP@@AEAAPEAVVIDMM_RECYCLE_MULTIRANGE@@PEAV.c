/*
 * XREFs of ?BuildIdleCommittedMultirangeForRange@VIDMM_RECYCLE_HEAP@@AEAAPEAVVIDMM_RECYCLE_MULTIRANGE@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C009DF90
 * Callers:
        ...
        struct VIDMM_RECYCLE_RANGE *a2)
{
  ...
  if ( Multirange )
  {
    if ( v8 )
    {
      ...
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree((__int64)this, 1LL, (__int64)Multirange);
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree((__int64)this, 1LL, v8);
