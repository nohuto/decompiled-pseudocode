/*
 * XREFs of ?ReportState@VIDMM_DMA_POOL@@QEAAXXZ @ 0x1C009A0FC
 * Callers:
 *     VidMmReportDmaPoolState @ 0x1C001ED60 (VidMmReportDmaPoolState.c)
...
LABEL_26:
    ...
    if ( v18 && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    {
      ...
      LODWORD(v20) = v19;
      Template_pqx(v19, &EventReportCommittedGlobalAllocation, a3, v7, v20, *(_QWORD *)(v7 + 144));
    }
    goto LABEL_26;
  }
}
