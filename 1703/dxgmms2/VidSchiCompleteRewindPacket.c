/*
 * XREFs of VidSchiCompleteRewindPacket @ 0x1C000DCA4
 * Callers:
...
__int64 __fastcall VidSchiCompleteRewindPacket(__int64 a1, int a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 176) & 8) == 0 )
  {
    *(_DWORD *)(a1 + 176) &= ~4u;
    ...
    v10 = v21[0];
    *(_QWORD *)(v9 + 24) = a1;
    *(_QWORD *)(v9 + 32) = *(_QWORD *)(a1 + 656);
    *(_QWORD *)(v9 + 40) = *(_QWORD *)(a1 + 664);
    *(_OWORD *)(v9 + 48) = v10;
    ...
    if ( v13 )
    {
      ...
      do
      {
        ...
        v15[4] = *(int *)(v13 + 52);
        v15[5] = *(_QWORD *)(a1 + 656);
        v15[6] = *(unsigned int *)(a1 + 788);
        WdLogEvent5_WdEvent(v15);
        v16 = *(_DWORD *)(v13 + 80);
        if ( (v16 & 0x10) != 0 )
        {
          *(_DWORD *)(v13 + 80) = v16 & 0xFFFFFFEF;
          v11 = *(unsigned int *)(v2 + 2792);
          if ( (_DWORD)v11 != -1 )
          {
            v20 = *(void (__fastcall **)(_QWORD))(v6 + 2880);
            if ( v20 )
              v20(*(_QWORD *)(v6 + 2912));
          }
        }
        ...
        if ( a2 )
        {
          ...
          {
            _InterlockedIncrement((volatile signed __int32 *)(v2 + 2752));
            *(_QWORD *)(v6 + 400) |= 1LL << *(_WORD *)(v2 + 4);
          }
        }
        v12 = *(_QWORD *)(v13 + 32);
        v13 = v12 - 32;
      }
      while ( v12 - 32 != *(_QWORD *)(a1 + 656) && v12 != a1 + 672 );
      VidSchiSetNextRunPacket(a1, *(_QWORD *)(a1 + 664));
    }
LABEL_14:
    v18 = *(_DWORD *)(a1 + 176);
    *(_QWORD *)(a1 + 664) = 0LL;
    if ( (v18 & 0x200) != 0 )
    {
      if ( (((unsigned __int8)(*(_DWORD *)(a1 + 176) >> 9) | *(_BYTE *)(a1 + 176)) & 2) == 0 )
        VidSchiUpdateContextStatus(a1, (_QWORD *)0xA, 13288LL);
    }
    ...
    {
      return (unsigned int)VidSchiUpdateContextStatus(a1, (_QWORD *)5, 13301LL);
    }
  }
  return v3;
}
