/*
 * XREFs of ?LockAllocInCpuHostAperture@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@PEAVVIDMM_CPU_HOST_APERTURE@@@Z @ 0x1C0093A30
 * Callers:
        ...
        struct VIDMM_CPU_HOST_APERTURE *a3)
{
  ...
  if ( v7 >= 0 )
  {
    ...
    v13 = VIDMM_GLOBAL::Rotate(
            this,
            *(struct VIDMM_PROCESS_HEAP_INTERFACE **)(v3[1] + 24),
            (void *)v3[3],
            1u,
            (struct _MDL *)P,
            *(_QWORD *)(v6 + 16),
