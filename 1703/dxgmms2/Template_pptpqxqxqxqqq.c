/*
 * XREFs of Template_pptpqxqxqxqqq @ 0x1C00150F8
 * Callers:
...
NTSTATUS Template_pptpqxqxqxqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v29; // [rsp+148h] [rbp+48h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v26 = 4LL;
  v28 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpSpecialLockTransfer, 0LL, 0xDu, &UserData);
}
