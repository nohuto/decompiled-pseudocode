/*
 * XREFs of ?InitializePagingQueue@VIDMM_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IPEAVVIDMM_GLOBAL@@W4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C0069A04
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_QUEUE::InitializePagingQueue(__int64 a1, __int64 a2, int a3, __int64 a4, int a5)
{
  ...
  *(_DWORD *)(a1 + 132) = dword_1C003C37C;
  *(_DWORD *)(a1 + 116) = a5;
  v7 = *(_QWORD *)(a4 + 24);
  if ( *(int *)(v7 + 1944) < 0x2000 )
    v8 = 1;
  else
    v8 = *(_DWORD *)(v7 + 248);
  if ( v8 > 1 )
      ...
      *(_QWORD *)(a1 + 24) = v12;
      if ( v10 >= 2 )
      {
        ...
        *(_BYTE *)(a1 + 128) = v15;
        ...
        if ( v16 )
        {
          if ( !*(_BYTE *)(v16 + 272) && !*(_BYTE *)(v16 + 274) )
            v6 = 0;
          *(_BYTE *)(a1 + 129) = v6;
        }
