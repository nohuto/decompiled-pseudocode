/*
 * XREFs of Template_qqqq @ 0x1C0025658
 * Callers:
...
NTSTATUS __fastcall Template_qqqq(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v12 = 4LL;
  v14 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventDWMVsyncSignal, 0LL, 4u, &UserData);
}
