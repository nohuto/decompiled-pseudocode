/*
 * XREFs of ?GetCpuVisibleAddress@VIDMM_PAGE_TABLE_BASE@@QEAAPEAXPEAVVIDMM_GLOBAL@@PEAPEAX@Z @ 0x1C0072FD4
 * Callers:
        ...
        PMDL *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (v7 & 0x2000) != 0 )
  {
    v8 = *(VIDMM_CPU_HOST_APERTURE **)(v6 + 504);
    ...
    v15 = WdLogNewEntry5_WdWarning(v11, v10);
    WdLogEvent5_WdWarning(v15);
    return 0LL;
  }
  if ( (v7 & 4) == 0 )
  {
    v14 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v6, a2, a3);
    v14[3] = 270LL;
    v14[4] = 48LL;
    v14[5] = this;
    v14[6] = 0LL;
