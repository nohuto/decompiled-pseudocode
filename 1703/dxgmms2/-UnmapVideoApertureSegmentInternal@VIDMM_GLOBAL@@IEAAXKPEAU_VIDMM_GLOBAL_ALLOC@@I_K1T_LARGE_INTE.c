/*
 * XREFs of ?UnmapVideoApertureSegmentInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@I_K1T_LARGE_INTEGER@@H@Z @ 0x1C00958F4
 * Callers:
 *     ?UnmapVideoApertureSegment@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@I_K11T_LARGE_INTEGER@@H@Z @ 0x1C00958A8 (-UnmapVideoApertureSegment@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@I_K11T_LARGE_INTEGER@@H@Z.c)
        ...
        int a8)
{
  ...
  v9 = 0;
  VIDMM_GLOBAL::SetupForBuildPagingBuffer((VIDMM_GLOBAL *)this, a2, a3, &v19);
  do
  {
    VIDMM_GLOBAL::SetupForBuildPagingBufferIteration((VIDMM_GLOBAL *)this, a2, a3, &v19);
    ...
    if ( a3 && *((_QWORD *)a3 + 13) && (**((_DWORD **)a3 + 65) & 0x10000000) == 0 && (*((_DWORD *)a3 + 21) & 4) == 0 )
    {
      DXGFASTMUTEX::Acquire(*((DXGFASTMUTEX **)a3 + 40));
      v15 = (struct _KTHREAD **)*((_QWORD *)a3 + 40);
      v19.UpdateContextAllocation.ContextAllocation = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 13) + 40LL)
                                                                                        - 32LL)
                                                                            + 24LL)
                                                                + 416LL);
    ...
    v9 |= VIDMM_GLOBAL::CompleteBuildPagingBufferIteration((signed __int64)this, a2, a3, &v19, v18, a8, 0LL);
  }
