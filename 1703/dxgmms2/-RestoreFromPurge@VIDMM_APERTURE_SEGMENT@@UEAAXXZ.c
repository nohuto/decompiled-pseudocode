/*
 * XREFs of ?RestoreFromPurge@VIDMM_APERTURE_SEGMENT@@UEAAXXZ @ 0x1C006F9F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VIDMM_APERTURE_SEGMENT::RestoreFromPurge(VIDMM_APERTURE_SEGMENT *this)
{
  ...
  while ( v3 != v1 )
  {
    v5 = (struct _VIDMM_GLOBAL_ALLOC *)(v3 - 416);
    v3 = *(char **)v3;
    v6 = **((_DWORD **)v5 + 65);
    if ( (v6 & 0x10000000) == 0 )
    {
  ...
  v4 = (VIDMM_APERTURE_SEGMENT *)*((_QWORD *)this + 25);
  while ( v4 != (VIDMM_APERTURE_SEGMENT *)((char *)this + 200) )
  {
    v11 = (char *)v4 - 416;
