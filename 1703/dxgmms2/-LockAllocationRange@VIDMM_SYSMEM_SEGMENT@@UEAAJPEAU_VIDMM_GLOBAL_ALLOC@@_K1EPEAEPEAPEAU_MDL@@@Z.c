/*
 * XREFs of ?LockAllocationRange@VIDMM_SYSMEM_SEGMENT@@UEAAJPEAU_VIDMM_GLOBAL_ALLOC@@_K1EPEAEPEAPEAU_MDL@@@Z @ 0x1C00493B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _MDL **a7)
{
  ...
  *v11 = 0;
  ...
  {
    v16 = VIDMM_GLOBAL::ProbeAndLockAllocation(v14, (struct _VIDMM_LOCAL_ALLOC *)v13, a2, a3, a4, v22, this, 1u);
    if ( v16 >= 0 )
    {
LABEL_10:
      *((_QWORD *)a2 + 35) = a4;
