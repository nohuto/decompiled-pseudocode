/*
 * XREFs of VidSchUpdatePostCompositionAttributes @ 0x1C002A8E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall VidSchUpdatePostCompositionAttributes(__int64 a1, unsigned int a2, int a3, __int128 *a4, __int128 *a5)
{
  ...
  *(_BYTE *)(*(_QWORD *)(a1 + 8 * v7 + 2992) + 2264LL) = a3 != 0;
  *(_OWORD *)(*(_QWORD *)(a1 + 8 * v7 + 2992) + 2268LL) = v6;
  *(_OWORD *)(*(_QWORD *)(a1 + 8 * v7 + 2992) + 2284LL) = v9;
