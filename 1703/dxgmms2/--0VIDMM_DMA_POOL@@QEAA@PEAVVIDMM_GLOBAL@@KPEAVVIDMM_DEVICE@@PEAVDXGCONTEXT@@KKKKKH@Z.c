/*
 * XREFs of ??0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z @ 0x1C006E490
 * Callers:
        ...
        int a11)
{
  ...
  *((_DWORD *)this + 8) = v13;
  if ( !a5 || (v14 = 16, !*((_BYTE *)a5 + 366)) )
    v14 = 0;
  v15 = v14 | v13 & 0xFFFFFFEF;
  *((_DWORD *)this + 8) = v15;
  if ( !a5 || (v16 = 32, !*((_BYTE *)a5 + 367)) )
    v16 = 0;
