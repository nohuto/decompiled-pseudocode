/*
 * XREFs of ?RestoreFromPurge@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C006F274
 * Callers:
 *     VidMmRestoreFromPurge @ 0x1C0013C90 (VidMmRestoreFromPurge.c)
 * Callees:
