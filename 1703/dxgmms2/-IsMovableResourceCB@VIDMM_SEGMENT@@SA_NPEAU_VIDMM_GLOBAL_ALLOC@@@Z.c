/*
 * XREFs of ?IsMovableResourceCB@VIDMM_SEGMENT@@SA_NPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00A20C0
 * Callers:
...
bool __fastcall VIDMM_SEGMENT::IsMovableResourceCB(struct _VIDMM_GLOBAL_ALLOC *a1)
{
  ...
  return a1
      && (**((_DWORD **)a1 + 65) & 0x200) == 0
      && (*((_DWORD *)a1 + 19) & 0x100) == 0
      && ((v1 = *((_QWORD *)a1 + 13)) == 0 || (*(_BYTE *)(v1 + 32) & 1) == 0)
      && *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 17) + 8LL) + 16LL) + 416LL) + 128LL) <= 1u;
}
