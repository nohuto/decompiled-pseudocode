/*
 * XREFs of ?PageInDeviceInternal@VIDMM_GLOBAL@@IEAAJPEAVVIDMM_DEVICE@@_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0058948
 * Callers:
 ...
 *     ?FaultCommitment@VIDMM_DEVICE@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C004D934 (-FaultCommitment@VIDMM_DEVICE@@QEAAXPEAUVIDMM_ALLOC@@@Z.c)
        ...
        while ( 1 )
        {
          ...
          if ( *v6 != v6 )
          {
            while ( 1 )
            {
              ...
              if ( v15 )
              {
                if ( v15 != 1 || *(_DWORD *)(**v12 + 408) >= 0xA0000000 )
                {
LABEL_13:
                  v16 = **v12;
                  if ( *(_DWORD *)(v16 + 128) == 1 )
...
LABEL_41:
                      if ( (*((_DWORD *)v12 + 7) & 3) == 2 )
                        ...
                        VIDMM_DEVICE::FaultCommitment(v17, (struct VIDMM_ALLOC *)v12);
                      *((_QWORD *)a2 + 30) = *a5;
                      goto LABEL_27;
                    }
                  }
...
LABEL_39:
        ...
        v20 = VIDMM_GLOBAL::PageInFaultedAllocation(v8, *((__int64 ***)a2 + 30), a3, a4, a5);
      }
      v9 = v20;
      goto LABEL_39;
    }
