/*
 * XREFs of ?TrimAllocation@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@U_VIDMM_TRIM_PROCESS_FLAGS@@_K2@Z @ 0x1C00A3D08
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  *(_DWORD *)(a2 + 80) |= 0x40u;
  ...
  if ( (a3 & 1) != 0 && v11 >= a4
    || (a3 & 2) != 0 && (int)VIDMM_SEGMENT::VerifyCommitLimit((VIDMM_SEGMENT *)a1, a4) >= 0 )
  {
    return 0LL;
  }
  return 3221225473LL;
