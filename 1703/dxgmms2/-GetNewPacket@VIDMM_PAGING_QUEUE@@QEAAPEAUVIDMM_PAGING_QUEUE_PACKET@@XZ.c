/*
 * XREFs of ?GetNewPacket@VIDMM_PAGING_QUEUE@@QEAAPEAUVIDMM_PAGING_QUEUE_PACKET@@XZ @ 0x1C00913C8
 * Callers:
...
struct VIDMM_PAGING_QUEUE_PACKET *__fastcall VIDMM_PAGING_QUEUE::GetNewPacket(VIDMM_PAGING_QUEUE *this)
{
  ...
  *(_QWORD *)(v7 + 8) = 0LL;
  ...
  if ( v5 != v3
    || (result = (struct VIDMM_PAGING_QUEUE_PACKET *)operator new[](0xA0uLL, 0x38346956u, PagedPool),
        (v5 = result) != 0LL) )
  {
    memset(v5, 0, 0xA0uLL);
    result = v5;
