/*
 * XREFs of ?AddRangeToTree@VIDMM_RECYCLE_HEAP@@QEAAXW4VIDMM_RECYCLE_HEAP_TREE@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C009DE14
 * Callers:
...
LABEL_9:
  ...
  v11 = (_QWORD *)WdLogNewEntry5_WdCriticalError((unsigned int)(v4 - 1), v7, v8);
  v11[3] = 270LL;
  v11[4] = 52LL;
  v11[5] = 13LL;
  v11[6] = v4;
