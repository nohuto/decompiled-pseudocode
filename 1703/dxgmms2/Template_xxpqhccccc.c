/*
 * XREFs of Template_xxpqhccccc @ 0x1C0021CCC
 * Callers:
...
NTSTATUS Template_xxpqhccccc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v23; // [rsp+118h] [rbp+37h] BYREF
  va_list va; // [rsp+118h] [rbp+37h]
  __int64 v25; // [rsp+120h] [rbp+3Fh] BYREF
  va_list va1; // [rsp+120h] [rbp+3Fh]
  __int64 v27; // [rsp+128h] [rbp+47h] BYREF
  va_list va2; // [rsp+128h] [rbp+47h]
  __int64 v29; // [rsp+130h] [rbp+4Fh] BYREF
  va_list va3; // [rsp+130h] [rbp+4Fh]
  __int64 v31; // [rsp+138h] [rbp+57h] BYREF
  va_list va4; // [rsp+138h] [rbp+57h]
  __int64 v33; // [rsp+140h] [rbp+5Fh] BYREF
  va_list va5; // [rsp+140h] [rbp+5Fh]
  __int64 v35; // [rsp+148h] [rbp+67h] BYREF
  va_list va6; // [rsp+148h] [rbp+67h]
  __int64 v37; // [rsp+150h] [rbp+6Fh] BYREF
  va_list va7; // [rsp+150h] [rbp+6Fh]
  __int64 v39; // [rsp+158h] [rbp+77h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v20 = 1LL;
  v22 = 1LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventVidMmProcessBudgetChange, 0LL, 0xAu, &UserData);
}
