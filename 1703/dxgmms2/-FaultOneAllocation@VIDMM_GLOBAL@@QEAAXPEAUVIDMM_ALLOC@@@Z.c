/*
 * XREFs of ?FaultOneAllocation@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C0056F40
 * Callers:
...
void __fastcall VIDMM_GLOBAL::FaultOneAllocation(VIDMM_GLOBAL *this, VIDMM_DEVICE **a2)
{
  ...
  if ( !*(_DWORD *)(v4 + 160) && (**(_DWORD **)(v4 + 520) & 0x40000000) == 0 && !*(_DWORD *)(v4 + 164) )
  {
    ...
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      Template_p(v6, &EventMarkAllocation, v5, a2);
    v7 = *(_QWORD *)(v4 + 16);
    ++*((_DWORD *)this + 1802);
    *((_QWORD *)this + 902) += v7;
  }
