/*
 * XREFs of ?ReportHeapStates@VIDMM_RECYCLE_HEAP_MGR@@QEAAXXZ @ 0x1C009EB88
 * Callers:
 ...
 *     ?ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ @ 0x1C009EADC (-ReportBlockStates@VIDMM_RECYCLE_HEAP@@QEAAXXZ.c)
 */
