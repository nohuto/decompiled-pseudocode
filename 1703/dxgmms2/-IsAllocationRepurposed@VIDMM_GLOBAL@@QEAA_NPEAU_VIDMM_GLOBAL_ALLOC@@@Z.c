/*
 * XREFs of ?IsAllocationRepurposed@VIDMM_GLOBAL@@QEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0093894
 * Callers:
...
bool __fastcall VIDMM_GLOBAL::IsAllocationRepurposed(VIDMM_GLOBAL *this, DXGFASTMUTEX **a2)
{
  ...
  if ( *((_WORD *)a2[65] + 2) == 3 )
  {
    ...
    if ( dword_1C003C404 == 1 )
    {
      v2 = (unsigned int)VIDMM_GLOBAL::QueryLocalAllocationResidency(this, v8) == 3;
    }
    else if ( dword_1C003C404 == 2 )
    {
