/*
 * XREFs of ?VidSchiEnqueueDeviceCommandToWorkerThreadAtDpc@@YAXPEBXW4_VIDSCH_DEVICE_COMMAND_TYPE@@@Z @ 0x1C0022300
 * Callers:
...
LABEL_7:
  ...
  *((_QWORD *)PacketFromGuaranteedPacketPool + 11) = v15;
  ...
  v18 = v26[1];
  v27 = 0;
  *(_OWORD *)((char *)PacketFromGuaranteedPacketPool + 264) = v26[0];
  *((_QWORD *)PacketFromGuaranteedPacketPool + 12) = CurrentThread;
  v19 = v26[2];
  *(_OWORD *)((char *)PacketFromGuaranteedPacketPool + 280) = v18;
  v20 = v26[3];
  *(_OWORD *)((char *)PacketFromGuaranteedPacketPool + 296) = v19;
  v21 = v26[4];
  *(_OWORD *)((char *)PacketFromGuaranteedPacketPool + 312) = v20;
  v22 = v26[5];
  *(_OWORD *)((char *)PacketFromGuaranteedPacketPool + 328) = v21;
  v23 = v26[6];
  *(_OWORD *)((char *)PacketFromGuaranteedPacketPool + 344) = v22;
  v24 = v26[7];
  *(_OWORD *)((char *)PacketFromGuaranteedPacketPool + 360) = v23;
  *(_OWORD *)((char *)PacketFromGuaranteedPacketPool + 376) = v24;
