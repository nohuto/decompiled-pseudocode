/*
 * XREFs of ?MapPagingBuffer@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C009F8B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VIDMM_APERTURE_SEGMENT::MapPagingBuffer(VIDMM_APERTURE_SEGMENT *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  v4 = *((__int64 *)a2 + 18);
  v5 = *(_QWORD *)this;
  v6 = (**((_DWORD **)a2 + 65) & 0x800004) == 4;
  FullMDL = VidMmGetFullMDL(a2, 0LL);
  (*(void (__fastcall **)(VIDMM_APERTURE_SEGMENT *, struct _VIDMM_GLOBAL_ALLOC *, _QWORD, __int64, __int64, struct _MDL *, _DWORD, BOOL))(v5 + 200))(
    this,
    a2,
    *((_QWORD *)a2 + 1) >> 12,
    v4 / 4096,
