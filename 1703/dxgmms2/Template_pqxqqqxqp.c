/*
 * XREFs of Template_pqxqqqxqp @ 0x1C00251D4
 * Callers:
...
NTSTATUS Template_pqxqqqxqp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v18 = 4LL;
  v20 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventDmaIsrComplete, 0LL, 9u, &UserData);
}
