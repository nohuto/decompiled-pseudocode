/*
 * XREFs of ?ShrinkOnTailRangeFree@VIDMM_RECYCLE_BLOCK@@QEAA?AW4VIDMM_RECYCLE_BLOCK_SHRINK_RESULT@@PEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C0069408
 * Callers:
...
LABEL_19:
  ...
  else
  {
    ...
    if ( v31 < 0 )
    {
      v33 = (_QWORD *)WdLogNewEntry5_WdWarning(v11, v9);
      v33[3] = BaseAddress;
      v33[4] = a1;
      v33[5] = v32;
