/*
 * XREFs of ?MapCpuVA@VIDMM_FENCE_STORAGE_PAGE@@QEAAJPEAVVIDMM_PROCESS@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@_N2PEAPEAX@Z @ 0x1C004F678
 * Callers:
    ...
    *((_QWORD *)v11 + 1) = KeGetCurrentThread();
    for ( i = (char *)*((_QWORD *)this + 2); i != v12; i = *(char **)i )
    {
      ...
      if ( a2 == *((struct VIDMM_PROCESS **)i - 1) )
      {
        ++*((_DWORD *)v14 + 8);
LABEL_6:
        *v6 = *(_QWORD *)v14 + *((unsigned int *)v27 + 4);
        *((_QWORD *)v11 + 1) = 0LL;
    ...
    if ( PoolWithTag )
    {
      ...
      *((_QWORD *)v14 + 1) = a2;
      ...
      if ( PsGetProcessWow64Process(v17) || (v18 = 2, a4) )
        v18 = 4;
      v19 = MmMapViewOfSection(*((_QWORD *)this + 9), v10, v14, 0LL, a6, &v26, &a6, 2, 0, v18);
      if ( v19 >= 0 )
      {
