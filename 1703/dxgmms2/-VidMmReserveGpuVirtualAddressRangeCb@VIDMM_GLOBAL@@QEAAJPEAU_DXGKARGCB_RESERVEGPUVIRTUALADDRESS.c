/*
 * XREFs of ?VidMmReserveGpuVirtualAddressRangeCb@VIDMM_GLOBAL@@QEAAJPEAU_DXGKARGCB_RESERVEGPUVIRTUALADDRESSRANGE@@@Z @ 0x1C0061700
 * Callers:
 *     VidMmReserveGpuVirtualAddressRangeCb @ 0x1C0012CA0 (VidMmReserveGpuVirtualAddressRangeCb.c)
 * Callees:
...
LABEL_9:
  ...
  v10 = 1;
  if ( *(_BYTE *)(*((_QWORD *)v2->hDxgkProcess + 4) + 273LL) )
  {
