/*
 * XREFs of ?ReadPhysicalAdapterConfiguration@VIDMM_GLOBAL@@IEAAXI@Z @ 0x1C0073090
 * Callers:
...
void __fastcall VIDMM_GLOBAL::ReadPhysicalAdapterConfiguration(VIDMM_GLOBAL *this, unsigned int a2)
{
  ...
  v2 = (unsigned __int64 *)(*((_QWORD *)this + 5021) + 472LL * a2);
  DpiGetPnpRegistryKeyName(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 2192LL) + 48LL * a2 + 8));
  v3 = Source;
  v4 = 0;
