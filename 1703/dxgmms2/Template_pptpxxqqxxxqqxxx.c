/*
 * XREFs of Template_pptpxxqqxxxqqxxx @ 0x1C00156B8
 * Callers:
...
NTSTATUS Template_pptpxxqqxxxqqxxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v37; // [rsp+180h] [rbp+80h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v32 = 8LL;
  v34 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpVirtualTransfer, 0LL, 0x10u, &UserData);
}
