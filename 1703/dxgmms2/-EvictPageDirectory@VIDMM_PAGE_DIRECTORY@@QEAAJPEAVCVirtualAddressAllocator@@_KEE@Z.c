/*
 * XREFs of ?EvictPageDirectory@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@_KEE@Z @ 0x1C0055260
 * Callers:
        ...
        char a5)
{
  ...
  if ( !VIDMM_PAGE_TABLE_BASE::IsResident((VIDMM_PAGE_TABLE_BASE *)this) )
    return 0LL;
  v11 = *v8;
  v12 = (struct _PAGED_LOOKASIDE_LIST *)*((_QWORD *)v6 + 10);
  v13 = ((unsigned int)*v8 >> 7) & 0x1F;
  v39 = v12;
  v14 = *(_QWORD *)&v12[313].L.Future[4] + 472 * v13;
  v43[0] = v14;
  if ( (v11 & 0x10) != 0 )
    v15 = *(_DWORD *)(32 * v13 + *((_QWORD *)v6 + 14) + 16);
  else
    v15 = *(_DWORD *)(v14 + 48LL * (v11 & 7) + 88);
  v37 = v15;
  *(_QWORD *)v38 = v9;
  v42 = *(void **)(v14 + 48LL * (v11 & 7) + 128);
  if ( v15 )
  {
    v16 = 0LL;
    v17 = 0LL;
