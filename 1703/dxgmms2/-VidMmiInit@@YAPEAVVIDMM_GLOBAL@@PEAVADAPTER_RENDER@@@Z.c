/*
 * XREFs of ?VidMmiInit@@YAPEAVVIDMM_GLOBAL@@PEAVADAPTER_RENDER@@@Z @ 0x1C0075314
 * Callers:
 *     VidMmInitializeAdapter @ 0x1C0014000 (VidMmInitializeAdapter.c)
 * Callees:
...
struct VIDMM_GLOBAL *__fastcall VidMmiInit(struct ADAPTER_RENDER *a1)
{
  ...
  if ( ZwQuerySystemInformation(SystemBasicInformation, SystemInformation, 0x40u, 0LL) < 0
    || *(_QWORD *)(v2 + 1608) < (unsigned __int64)v31 << 12 )
  {
...
LABEL_11:
  v14 = (VIDMM_GLOBAL *)operator new(0xA300uLL, 0x35316956u, v9, (POOL_TYPE)512);
  if ( v14 )
...
LABEL_24:
  ...
  if ( v17 < 0 )
  {
    _InterlockedIncrement(&dword_1C003C5AC);
