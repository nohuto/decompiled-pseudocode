/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C0096A0C
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C001EC80 (VidMmCreateCompanionContext.c)
 * Callees:
