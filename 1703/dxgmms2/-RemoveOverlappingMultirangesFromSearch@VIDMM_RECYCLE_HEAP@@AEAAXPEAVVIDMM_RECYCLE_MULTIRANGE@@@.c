/*
 * XREFs of ?RemoveOverlappingMultirangesFromSearch@VIDMM_RECYCLE_HEAP@@AEAAXPEAVVIDMM_RECYCLE_MULTIRANGE@@@Z @ 0x1C00667C0
 * Callers:
        ...
        struct VIDMM_RECYCLE_MULTIRANGE *a2)
{
  ...
  for ( i = (struct VIDMM_RECYCLE_RANGE *)*((_QWORD *)a2 + 8); ; i = VIDMM_RECYCLE_RANGE::GetNextRange(i) )
  {
    ...
    *(_QWORD *)(v5 + 24) = i;
    ...
    if ( *((_DWORD *)a2 + 54) != 2 )
    {
      v11 = (struct VIDMM_RECYCLE_MULTIRANGE *)*((_QWORD *)i + 19);
      if ( v11 )
      {
