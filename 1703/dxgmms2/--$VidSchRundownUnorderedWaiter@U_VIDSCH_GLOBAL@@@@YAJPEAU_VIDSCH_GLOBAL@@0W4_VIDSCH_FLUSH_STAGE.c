/*
 * XREFs of ??$VidSchRundownUnorderedWaiter@U_VIDSCH_GLOBAL@@@@YAJPEAU_VIDSCH_GLOBAL@@0W4_VIDSCH_FLUSH_STAGE@@_NP6AX0@Z@Z @ 0x1C0028820
 * Callers:
...
__int64 __fastcall VidSchRundownUnorderedWaiter<_VIDSCH_GLOBAL>(__int64 a1, __int64 a2, int a3)
{
  ...
  v3 = 0;
  if ( a3 != 5 && *(_DWORD *)(a1 + 980) )
  {
    if ( a3 < 6 )
    {
      return (unsigned int)-2147483631;
    }
    else if ( *(_DWORD *)(a1 + 980) )
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(a2 + 1880), &LockHandle);
      v5 = (_QWORD **)(a1 + 248);
