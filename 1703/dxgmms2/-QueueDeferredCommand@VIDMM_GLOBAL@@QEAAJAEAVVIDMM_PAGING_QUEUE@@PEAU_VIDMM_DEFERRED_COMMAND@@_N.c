/*
 * XREFs of ?QueueDeferredCommand@VIDMM_GLOBAL@@QEAAJAEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_DEFERRED_COMMAND@@_NPEA_K@Z @ 0x1C005CFE0
 * Callers:
        ...
        unsigned __int64 *a5)
{
  ...
  *(_QWORD *)(v15 + 8) = 0LL;
  ...
  if ( NewPacket != v11
    || (NewPacket = (struct VIDMM_PAGING_QUEUE_PACKET *)operator new[](0xA0uLL, 0x38346956u, PagedPool)) != 0LL )
  {
  ...
  *((_OWORD *)NewPacket + 7) = *((_OWORD *)a3 + 4);
  if ( a4 )
    *((_QWORD *)NewPacket + 9) = &v23;
  if ( *(_DWORD *)a3 == 206 )
  {
    v17 = MEMORY[0xFFFFF78000000320];
    *((_QWORD *)NewPacket + 17) = v17 * KeQueryTimeIncrement();
  }
  VIDMM_PAGING_QUEUE::AppendReadyPacket(a2, NewPacket, &v18);
  if ( a4 )
  {
    v21 = v18;
    v22 = v5;
