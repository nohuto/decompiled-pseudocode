/*
 * XREFs of Template_pqqiix @ 0x1C0024618
 * Callers:
...
NTSTATUS Template_pqqiix(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 8LL;
  v14 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPeriodicFrameNotificationTimer, 0LL, 6u, &UserData);
}
