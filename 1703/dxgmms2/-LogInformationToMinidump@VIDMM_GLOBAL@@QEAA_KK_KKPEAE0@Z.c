/*
 * XREFs of ?LogInformationToMinidump@VIDMM_GLOBAL@@QEAA_KK_KKPEAE0@Z @ 0x1C0093CE4
 * Callers:
 *     VidMmLogInformationToMinidump @ 0x1C001ED10 (VidMmLogInformationToMinidump.c)
 * Callees:
 ...
 *     ?WritePagingHistoryToMinidump@VIDMM_GLOBAL@@QEAA_KPEAU_VIDMM_MINIDUMP_HEADER@@PEAE_K@Z @ 0x1C009DCEC (-WritePagingHistoryToMinidump@VIDMM_GLOBAL@@QEAA_KPEAU_VIDMM_MINIDUMP_HEADER@@PEAE_K@Z.c)
 */
        ...
        unsigned __int64 a6)
{
  ...
  if ( a6 < 0x488 )
    return 0LL;
  v11 = (unsigned __int8 *)a5 + 1160;
  memset(a5, 0, 0x488uLL);
  v12 = 6LL;
  *(_DWORD *)a5 = 1;
  ...
  *((_QWORD *)v17 + 8) = *((_QWORD *)v18 + 8);
  v20 = VIDMM_GLOBAL::WriteSegmentInformationToMinidump(this, a5, v11, a6 - 1160);
  v21 = &v11[v20];
  v22 = a6 - 1160 - v20;
  v23 = 10240LL;
  if ( v22 < 0x2800 )
