/*
 * XREFs of ?ReadBudgetConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C007821C
 * Callers:
...
void VIDMM_GLOBAL::ReadBudgetConfiguration(void)
{
  ...
  v4 = 10000 * v26;
  v5 = 10000 * v24;
  dword_1C003C368 = 10000 * v26;
  dword_1C003C35C = 10000 * v2;
  dword_1C003C364 = 10000 * v24;
  dword_1C003C360 = 10000 * v3;
  if ( 10000 * v24 <= 0xEA60 )
  {
    if ( v5 < 0x10 )
    {
