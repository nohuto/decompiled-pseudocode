/*
 * XREFs of ?AssignMaximumBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@W4_D3DKMT_MEMORY_SEGMENT_GROUP@@@Z @ 0x1C00A5134
 * Callers:
...
void __fastcall VIDMM_GLOBAL::AssignMaximumBudgets(VIDMM_GLOBAL *this, struct VIDMM_BUDGET_STATE *a2, int a3)
{
  ...
  for ( i = 3LL * a3; ; i = 3 * v10 )
  {
    ...
    do
    {
      *(_QWORD *)(v13 + v6 + 96) = *(_QWORD *)(v6 + 8 * v10 + 64);
      v13 += 8LL;
      --v12;
    }
    while ( v12 );
