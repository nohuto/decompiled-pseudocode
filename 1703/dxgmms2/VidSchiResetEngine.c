/*
 * XREFs of VidSchiResetEngine @ 0x1C0026D04
 * Callers:
...
char __fastcall VidSchiResetEngine(__int64 a1, __int64 a2)
{
  ...
  _DWORD *v92; // [rsp+1D8h] [rbp+D0h]
  __int64 v93; // [rsp+1E0h] [rbp+D8h]
  __int64 v94; // [rsp+1E8h] [rbp+E0h]
  _DWORD v95[2]; // [rsp+1F0h] [rbp+E8h] BYREF
  struct _TDR_RECOVERY_CONTEXT **v96; // [rsp+1F8h] [rbp+F0h]
  __int64 v97; // [rsp+200h] [rbp+F8h]
  unsigned int *v98; // [rsp+208h] [rbp+100h]
  ...
  EVENT_DATA_DESCRIPTOR v104; // [rsp+248h] [rbp+140h] BYREF
  __int64 *v105; // [rsp+268h] [rbp+160h]
  __int64 v106; // [rsp+270h] [rbp+168h]
  _DWORD *v107; // [rsp+278h] [rbp+170h]
  __int64 v108; // [rsp+280h] [rbp+178h]
  __int64 v109; // [rsp+288h] [rbp+180h]
  _DWORD v110[2]; // [rsp+290h] [rbp+188h] BYREF
  struct _TDR_RECOVERY_CONTEXT **v111; // [rsp+298h] [rbp+190h]
  ...
  if ( *(_DWORD *)(a1 + 2772) )
  {
    ...
    if ( _InterlockedIncrement((volatile signed __int32 *)(a1 + 2776)) == 1 )
    {
      *(_QWORD *)(a1 + 232) = 0LL;
  ...
  *((_QWORD *)v6 + 4) = v60[4];
  *((_QWORD *)v6 + 6) = v60[6];
  if ( LODWORD(v60[6]) != HIDWORD(v60[6]) || *(_DWORD *)(a1 + 1948) )
  {
    if ( *(_QWORD *)(v5 + 2832) == a1 )
    {
      RecoveryContext = TdrCreateRecoveryContext();
      *(_QWORD *)(v5 + 2824) = RecoveryContext;
      v10 = RecoveryContext;
      if ( RecoveryContext )
      {
        *((_QWORD *)RecoveryContext + 350) = a2;
        *((_QWORD *)RecoveryContext + 1) = v5 + 2820;
        ...
        *((_DWORD *)v10 + 14) = *(unsigned __int16 *)(*(_QWORD *)(v5 + 2832) + 4LL);
        v18 = *((_QWORD *)v10 + 4);
        v19 = *(_QWORD *)(v18 + 456);
        if ( !v19 )
          v19 = *(_QWORD *)(v18 + 312);
        *((_QWORD *)v10 + 13) = v19;
        TdrCollectDbgInfoStage1(*(struct _TDR_RECOVERY_CONTEXT **)(v5 + 2824), 1);
      }
      v11 = 0x400000000010LL;
    }
    ++*(_DWORD *)(a1 + 484);
    ...
    v68 = 0LL;
    v69 = 0;
    HIDWORD(v68) = *(unsigned __int16 *)(*(_QWORD *)(v5 + 8 * v20 + 416) + 6LL);
    LODWORD(v68) = *(unsigned __int16 *)(*(_QWORD *)(v5 + 8 * v20 + 416) + 8LL);
    if ( hProvider > 5u
      ...
      && (qword_1C003C018 & 0x400000000010LL) == qword_1C003C018 )
    {
      ...
      *(_DWORD *)&v55[2] = v21;
      v88 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00305B2, 0LL, (LPCGUID)0x400000000010LL, 0xBu, &pData);
    }
    ...
    *((_BYTE *)v6 + 61) = 1;
    ...
    if ( hProvider > 5u )
    {
      ...
      if ( (qword_1C003C010 & 0x400000000010LL) != 0 && (qword_1C003C018 & 0x400000000010LL) == qword_1C003C018 )
      {
        v29 = *(_QWORD *)(v5 + 16);
        v63 = *(_QWORD *)(v29 + 268);
        v90 = &v63;
        v91 = 8LL;
        v30 = *(unsigned __int16 **)(v29 + 1224);
        v92 = v95;
        v93 = 2LL;
        LODWORD(v29) = *v30;
        v94 = *((_QWORD *)v30 + 1);
        ...
        v101 = 4LL;
        v103 = 4LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0030538, 0LL, v28, 9u, &v89);
      }
    }
    v31 = v69;
    *((_QWORD *)v6 + 5) = v69;
  ...
  if ( v10 )
  {
            ...
            *(_DWORD *)(v43 + 4 * v44) |= 1 << (*(_BYTE *)(v5 + 4) & 0x1F);
            if ( bTracingEnabled )
            {
              if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
                Template_dp(v45, v43, v44, *(_DWORD *)(v5 + 4), *((_QWORD *)v10 + 351));
            }
          }
        }
      }
      ...
      && (qword_1C003C018 & 0x400000000010LL) == qword_1C003C018 )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00304C1, 0LL, v49, 9u, &v104);
    }
