/*
 * XREFs of ?CheckForApertureGuardPageCorruption@VIDMM_APERTURE_SEGMENT@@QEAAJPEAPEAKE@Z @ 0x1C00214A0
 * Callers:
...
LABEL_18:
  ...
  if ( !v10 )
    v10 = *((_QWORD *)v9 + 1) - qword_1C003C0F0;
  if ( v10 )
  {
    v11 = (_QWORD *)WdLogNewEntry5_WdAssertion(v10, v8);
    v11[4] = v9 + 16;
    v11[3] = v9;
    v11[5] = this;
