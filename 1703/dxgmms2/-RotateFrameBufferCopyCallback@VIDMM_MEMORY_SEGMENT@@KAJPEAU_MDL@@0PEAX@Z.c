/*
 * XREFs of ?RotateFrameBufferCopyCallback@VIDMM_MEMORY_SEGMENT@@KAJPEAU_MDL@@0PEAX@Z @ 0x1C006D680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VIDMM_MEMORY_SEGMENT::RotateFrameBufferCopyCallback(struct _MDL *a1, struct _MDL *a2, char *a3)
{
  ...
  v5 = v3[1];
  if ( (*(_BYTE *)(472LL * (*(_DWORD *)(*(_QWORD *)a3 + 76LL) & 0x3F) + *((_QWORD *)v5 + 5021) + 436) & 4) == 0 )
    return 3221225473LL;
