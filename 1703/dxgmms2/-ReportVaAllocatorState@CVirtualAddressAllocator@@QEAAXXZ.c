/*
 * XREFs of ?ReportVaAllocatorState@CVirtualAddressAllocator@@QEAAXXZ @ 0x1C009DAA0
 * Callers:
...
void __fastcall CVirtualAddressAllocator::ReportVaAllocatorState(CVirtualAddressAllocator *this)
{
  ...
  while ( v5 )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40000) != 0 )
    {
      ...
      Template_pqxx(v2, &ReportGpuVirtualAddressRange, v3, this, v12, *(_QWORD *)(v5 + 24), *(_QWORD *)(v5 + 32));
    }
