/*
 * XREFs of VidSchSubmitWaitFromCpu @ 0x1C000D480
 * Callers:
 ...
 *     ??_GVIDSCH_CPU_WAITER@@QEAAPEAXI@Z @ 0x1C001E818 (--_GVIDSCH_CPU_WAITER@@QEAAPEAXI@Z.c)
 */
    ...
    *((_DWORD *)v16 + 26) = v8;
    ...
    if ( v18 )
    {
      ...
      *((_BYTE *)v16 + 112) = v21;
      ...
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v19 + 1880), &LockHandle);
      v25 = *(_QWORD **)(v19 + 1016);
      if ( *v25 != v19 + 1008 )
        __fastfail(3u);
      v16[1] = v25;
