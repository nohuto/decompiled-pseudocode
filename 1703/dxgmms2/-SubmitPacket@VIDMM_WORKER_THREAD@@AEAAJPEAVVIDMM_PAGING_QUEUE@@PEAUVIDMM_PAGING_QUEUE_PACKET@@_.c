/*
 * XREFs of ?SubmitPacket@VIDMM_WORKER_THREAD@@AEAAJPEAVVIDMM_PAGING_QUEUE@@PEAUVIDMM_PAGING_QUEUE_PACKET@@_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0091A78
 * Callers:
 *     ?FlushEvictQueue@VIDMM_WORKER_THREAD@@AEAAXPEAVVIDMM_PAGING_QUEUE@@@Z @ 0x1C0098EBC (-FlushEvictQueue@VIDMM_WORKER_THREAD@@AEAAXPEAVVIDMM_PAGING_QUEUE@@@Z.c)
 * Callees:
    ...
    *a6 = 0LL;
    ...
    v13 = VIDMM_GLOBAL::ProcessSystemCommand(
            *this,
            (struct VIDMM_PAGING_QUEUE_PACKET *)((char *)a3 + 48),
            v18,
            *((struct _RTL_BALANCED_NODE **)a3 + 4),
            *((struct _VIDSCH_SYNC_OBJECT **)a2 + 11));
  }
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
    Template_ppxx(v15, &EventPagingQueueComplete, v16, a2, a3, *((_QWORD *)a3 + 5), 0LL);
  return v13;
}
