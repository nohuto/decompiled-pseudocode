/*
 * XREFs of ?InitializeFlipQueueEntry@VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z @ 0x1C0013964
 * Callers:
        ...
        struct _VIDSCH_GLOBAL *a2)
{
  ...
  PoolWithTag = ExAllocatePoolWithTag(
                  (POOL_TYPE)512,
                  *((_DWORD *)a2 + 32) * (48 * *((_DWORD *)a2 + 14) + ((8 * *((_DWORD *)a2 + 14) + 167) & 0xFFFFFFF8))
                + 16,
                  0x68536956u);
  *((_QWORD *)this + 144) = PoolWithTag;
  ...
  if ( PoolWithTag )
  {
    ...
    v7[2] = v8;
    v7[1] = v9;
    v7[3] = v9 * (48 * v8 + ((8 * v8 + 167) & 0xFFFFFFF8)) + 16;
    return 0LL;
  }
  else
  {
