/*
 * XREFs of VidSchQueryLastCompletedPresentIdDWM @ 0x1C0010F10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall VidSchQueryLastCompletedPresentIdDWM(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a1 && a3 )
  {
    ...
    else
    {
      ...
      KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v6 + 1888), &v10);
      ...
      *(_DWORD *)(a3 + 16) = *(_DWORD *)(*(_QWORD *)(v6 + 8 * v3 + 2992) + 18800LL);
      *(_QWORD *)(a3 + 24) = *(_QWORD *)(*(_QWORD *)(v6 + 8 * v3 + 2992) + 18808LL);
      *(_DWORD *)(a3 + 32) = *(_DWORD *)(*(_QWORD *)(v6 + 8 * v3 + 2992) + 120LL);
