/*
 * XREFs of Template_pptpxxqqxx @ 0x1C00155AC
 * Callers:
...
NTSTATUS Template_pptpxxqqxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v20 = 8LL;
  v22 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventPagingOpVirtualFill, 0LL, 0xAu, &UserData);
}
