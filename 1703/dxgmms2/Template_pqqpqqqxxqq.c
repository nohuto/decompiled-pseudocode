/*
 * XREFs of Template_pqqpqqqxxqq @ 0x1C00246DC
 * Callers:
...
NTSTATUS Template_pqqpqqqxxqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v25; // [rsp+128h] [rbp+2Fh] BYREF
  va_list va; // [rsp+128h] [rbp+2Fh]
  __int64 v27; // [rsp+130h] [rbp+37h] BYREF
  va_list va1; // [rsp+130h] [rbp+37h]
  __int64 v29; // [rsp+138h] [rbp+3Fh] BYREF
  va_list va2; // [rsp+138h] [rbp+3Fh]
  __int64 v31; // [rsp+140h] [rbp+47h] BYREF
  va_list va3; // [rsp+140h] [rbp+47h]
  __int64 v33; // [rsp+148h] [rbp+4Fh] BYREF
  va_list va4; // [rsp+148h] [rbp+4Fh]
  __int64 v35; // [rsp+150h] [rbp+57h] BYREF
  va_list va5; // [rsp+150h] [rbp+57h]
  __int64 v37; // [rsp+158h] [rbp+5Fh] BYREF
  va_list va6; // [rsp+158h] [rbp+5Fh]
  __int64 v39; // [rsp+160h] [rbp+67h] BYREF
  va_list va7; // [rsp+160h] [rbp+67h]
  __int64 v41; // [rsp+168h] [rbp+6Fh] BYREF
  va_list va8; // [rsp+168h] [rbp+6Fh]
  __int64 v43; // [rsp+170h] [rbp+77h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v22 = 4LL;
  v24 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndependentFlip, 0LL, 0xBu, &UserData);
}
