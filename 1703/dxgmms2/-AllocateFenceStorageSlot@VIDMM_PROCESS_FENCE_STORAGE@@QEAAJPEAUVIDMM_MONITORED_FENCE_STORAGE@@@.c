/*
 * XREFs of ?AllocateFenceStorageSlot@VIDMM_PROCESS_FENCE_STORAGE@@QEAAJPEAUVIDMM_MONITORED_FENCE_STORAGE@@@Z @ 0x1C0001BD8
 * Callers:
        ...
        struct VIDMM_MONITORED_FENCE_STORAGE *a2)
{
  ...
  VIDMM_PROCESS_FENCE_STORAGE **v14; // rax
  ...
  else
  {
    ...
    if ( *((_QWORD *)v6 + 8) == -1LL )
    {
      ...
      if ( *(VIDMM_PROCESS_FENCE_STORAGE **)(*(_QWORD *)v6 + 8LL) != v6 || *v14 != v6 )
        __fastfail(3u);
      *v14 = v13;
      *((_QWORD *)v13 + 1) = v14;
  ...
  if ( v7 )
    return 0LL;
  v9 = (VIDMM_FENCE_STORAGE_PAGE *)operator new[](0x80uLL, 0x34346956u, (enum _POOL_TYPE)512);
  if ( v9 )
  ...
  if ( !v10 )
    return 3221225495LL;
  v11 = VIDMM_FENCE_STORAGE_PAGE::Init(v10);
  if ( v11 >= 0 )
  {
