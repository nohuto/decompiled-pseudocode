/*
 * XREFs of ?PostMessageToClient@CConnection@@QEAAJPEBUUCE_RDP_HEADER@@@Z @ 0x1800655D8
 * Callers:
...
__int64 __fastcall CConnection::PostMessageToClient(CConnection *this, const struct UCE_RDP_HEADER *a2)
{
  ...
  if ( *(_DWORD *)a2 != 11 )
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, MasterTableEntry, 0x1D8u);
      v4 = 0;
      goto LABEL_12;
    }
    if ( *(_DWORD *)v5 != 1 )
    {
      ...
      else
      {
        ...
        v4 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x20Fu);
      }
      goto LABEL_12;
    }
    SetLastError(0);
    ...
    if ( (unsigned int)HANDLE_TABLE::ValidEntry((CConnection *)((char *)this + 16), i) )
    {
      ...
      if ( (int)CChannelTable::GetMasterTableEntry((CConnection *)((char *)this + 16), i, &v18) >= 0 )
      {
        ...
        if ( *((_BYTE *)v12 + 210) )
        {
          ...
          v14 = v13;
          if ( v13 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x1CDu);
          if ( !v4 || v4 >= 0 && v14 < 0 )
            v4 = v14;
        }
      }
