/*
 * XREFs of ?RectToSurfaceRect@CHwDisplayRenderTarget@@IEBA_NPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMILSurfaceRect_@RectUniqueness@@@@@Z @ 0x180039F00
 * Callers:
...
char __fastcall CHwDisplayRenderTarget::RectToSurfaceRect(CHwDisplayRenderTarget *this, float *a2, __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 8) = 0LL;
  ...
  if ( v7 )
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1801E9F58, 2u, v8, 0x516u);
    }
    else
    {
      v9 = *(__int64 (**)(void))(*(_QWORD *)this + 48LL);
