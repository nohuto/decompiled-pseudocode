/*
 * XREFs of ?TelemetryRecordInputActivity@CIndependentRefreshRateScheduler@@UEAAXI_K@Z @ 0x18013E310
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CIndependentRefreshRateScheduler::TelemetryRecordInputActivity(
