/*
 * XREFs of ?Construct@AdapterInfo@CSurfaceManager@@QEAAJAEBU_GUID@@PEAVCDXGIAdapterLimited@@PEAVCD3DDeviceManager@@@Z @ 0x1800B6444
 * Callers:
        ...
        struct CD3DDeviceManager *a4)
{
  ...
  *((_QWORD *)this + 4) = 0LL;
  ...
  else
  {
    ...
    if ( ExistingDevice >= 0 )
    {
      *((_QWORD *)this + 3) = *((_QWORD *)v15 + 76);
      *((_QWORD *)this + 4) = *((_QWORD *)v5 + 77);
    }
  }
  if ( v5 )
    CMILPoolResource::Release((struct CD3DDeviceLevel1 *)((char *)v5 + 488));
  return v11;
}
