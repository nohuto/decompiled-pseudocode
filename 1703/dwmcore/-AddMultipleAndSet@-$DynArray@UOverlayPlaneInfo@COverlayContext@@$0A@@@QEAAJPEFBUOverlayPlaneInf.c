/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@UOverlayPlaneInfo@COverlayContext@@$0A@@@QEAAJPEFBUOverlayPlaneInfo@COverlayContext@@I@Z @ 0x18014E884
 * Callers:
        ...
        unsigned int a3)
{
  ...
  {
    v11 = DynArrayImpl<0>::AddMultipleAndSet(a1, 0xF0u, 1, a2);
    v7 = v11;
    if ( v11 < 0 )
