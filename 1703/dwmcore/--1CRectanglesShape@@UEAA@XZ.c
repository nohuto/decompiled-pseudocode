/*
 * XREFs of ??1CRectanglesShape@@UEAA@XZ @ 0x1800941B0
 * Callers:
 ...
 *     _dynamic_atexit_destructor_for__CRectanglesShape::sc_emptyShape__ @ 0x1800D6DF0 (_dynamic_atexit_destructor_for__CRectanglesShape--sc_emptyShape__.c)
...
void __fastcall CRectanglesShape::~CRectanglesShape(CRectanglesShape *this)
{
  ...
  *((_DWORD *)this + 8) = 0;
  ...
  if ( *(_QWORD *)v1 != *((_QWORD *)v1 + 1) )
  {
    WPF::ProcessHeapImpl::Free(*(void **)v1);
    *(_QWORD *)v1 = 0LL;
  }
}
