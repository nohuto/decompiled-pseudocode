/*
 * XREFs of ?NotifyMatrix4x4PropertyChanged@CPropertyChangeResource@@QEAAJIAEBUD2DMatrix@@@Z @ 0x18002AEA8
 * Callers:
        ...
        const struct D2DMatrix *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this, 0x11u) )
  {
    ...
    v3 = CoreUICallSend(v10, v13, 2LL, 7LL, 7, &unk_1801D544E);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
