/*
 * XREFs of ?UpdateSysmemBitmap@CD2DBitmapCache@@IEAAJXZ @ 0x180024E9C
 * Callers:
...
__int64 __fastcall CD2DBitmapCache::UpdateSysmemBitmap(CD2DBitmapCache *this)
{
  ...
  v2 = 0;
  if ( !(*(unsigned __int8 (__fastcall **)(__int64, _QWORD, _BYTE *))(*(_QWORD *)(*((_QWORD *)this + 8) + 16LL) + 48LL))(
          *((_QWORD *)this + 8) + 16LL,
          0LL,
          v5) )
  {
    v3 = (*(__int64 (__fastcall **)(__int64, _BYTE *, _QWORD))(*(_QWORD *)(*((_QWORD *)this + 8) + 16LL) + 56LL))(
           *((_QWORD *)this + 8) + 16LL,
           v5,
           *((_QWORD *)this + 6));
    v2 = v3;
    if ( v3 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v3, 0x19Au);
  }
  return v2;
}
