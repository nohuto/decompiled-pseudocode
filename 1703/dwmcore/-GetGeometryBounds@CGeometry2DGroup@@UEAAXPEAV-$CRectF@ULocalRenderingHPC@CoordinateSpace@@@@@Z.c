/*
 * XREFs of ?GetGeometryBounds@CGeometry2DGroup@@UEAAXPEAV?$CRectF@ULocalRenderingHPC@CoordinateSpace@@@@@Z @ 0x180178B80
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (v4 & 6) == 2 )
  {
    if ( (*(_BYTE *)(a1 + 152) & 2) != 0 )
    {
      ...
      for ( i = 0uLL; (unsigned int)v5 < *(_DWORD *)(a1 + 96); v5 = (unsigned int)(v5 + 1) )
      {
        ...
        if ( v6 )
        {
          (*(void (__fastcall **)(__int64, float *))(*(_QWORD *)v6 + 152LL))(v6, v10);
