/*
 * XREFs of ?SetScale@CComponentTransform2D@@AEAAJMM@Z @ 0x1800AC364
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetScale(CComponentTransform2D *this, double a2, double a3)
{
  ...
  if ( *((float *)this + 24) != *(float *)&a2 || *((float *)this + 25) != *(float *)&a3 )
  {
    ...
    *((_DWORD *)this + 25) = LODWORD(a3);
    ...
    v6 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 5LL, (const struct D2DVector2 *)&v7);
    v3 = v6;
    if ( v6 < 0 )
