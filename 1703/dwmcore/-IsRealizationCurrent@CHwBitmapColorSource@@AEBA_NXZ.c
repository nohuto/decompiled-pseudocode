/*
 * XREFs of ?IsRealizationCurrent@CHwBitmapColorSource@@AEBA_NXZ @ 0x180045084
 * Callers:
 ...
 * Callees:
 *     ?GetUniquenessToken@CBitmap@@UEAAJPEAI@Z @ 0x180055D10 (-GetUniquenessToken@CBitmap@@UEAAJPEAI@Z.c)
