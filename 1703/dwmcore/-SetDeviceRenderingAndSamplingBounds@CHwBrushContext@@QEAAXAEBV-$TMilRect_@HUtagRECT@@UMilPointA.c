/*
 * XREFs of ?SetDeviceRenderingAndSamplingBounds@CHwBrushContext@@QEAAXAEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMILSurfaceRect_@RectUniqueness@@@@@Z @ 0x18004ACEC
 * Callers:
 ...
 *     ?SetDeviceSamplingBounds@CHwBrushContext@@QEAAXAEBV?$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z @ 0x18019C268 (-SetDeviceSamplingBounds@CHwBrushContext@@QEAAXAEBV-$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z.c)
 */
