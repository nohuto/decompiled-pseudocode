/*
 * XREFs of ?Create@?$XamlPowerInterpolation@VCartesianCoordinateSpace@Animations@Components@@@Animations@Components@@SAJW4Dwm__InterpolationMode@23@MPEAPEAVInterpolation@23@@Z @ 0x180028AA0
 * Callers:
...
__int64 __fastcall Components::Animations::XamlPowerInterpolation<Components::Animations::CartesianCoordinateSpace>::Create(
        unsigned int a1,
        float a2,
        float **a3)
{
  ...
  if ( v7 )
  {
    ...
    *((_DWORD *)v8 + 2) = 1;
    *(_QWORD *)v8 = &Components::Animations::XamlPowerInterpolation<Components::Animations::CartesianCoordinateSpace>::`vftable';
  }
  else
  {
    v8 = 0LL;
