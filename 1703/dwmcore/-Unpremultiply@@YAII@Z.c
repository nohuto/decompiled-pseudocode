/*
 * XREFs of ?Unpremultiply@@YAII@Z @ 0x1801ADF2C
 * Callers:
 *     ?AlphaDivide_32bppPARGB@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x1801ACFB0 (-AlphaDivide_32bppPARGB@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z.c)
 * Callees:
 *     <none>
 */
