/*
 * XREFs of ?ProcessSetTransform@CVisual@@QEAAJPEBVCResourceTable@@PEBUMILCMD_VISUAL_SETTRANSFORM@@@Z @ 0x180085938
 * Callers:
        ...
        const struct MILCMD_VISUAL_SETTRANSFORM *a3)
{
  ...
  Resource = 0LL;
  v5 = *((_DWORD *)a3 + 2);
  if ( v5 && (Resource = (struct CTransform3D *)CResourceTable::GetResource((__int64)a2, v5, 0x17u)) == 0LL )
  {
    v8 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x82Bu);
  }
  else
  {
    ...
    v8 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x82Fu);
  }
  return v8;
}
