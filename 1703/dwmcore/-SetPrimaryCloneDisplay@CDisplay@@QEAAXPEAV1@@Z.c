/*
 * XREFs of ?SetPrimaryCloneDisplay@CDisplay@@QEAAXPEAV1@@Z @ 0x1800B7F60
 * Callers:
...
void __fastcall CDisplay::SetPrimaryCloneDisplay(CDisplay *this, struct CDisplay *a2)
{
  ...
  *((_QWORD *)this + 16) = a2;
  if ( v2 )
  {
    ...
    (*(void (__fastcall **)(__int64, _QWORD))(v5 + 456))(v6, *DisplayId);
  }
  if ( *((_QWORD *)this + 7) )
  {
    v7 = (unsigned int *)CDisplay::GetDisplayId(this, &v10);
    (*(void (__fastcall **)(__int64, _QWORD))(v8 + 456))(v9, *v7);
  }
}
