/*
 * XREFs of ?Create@CBoundsBitmap@@SAJPEAVCImageSource@@PEAPEAV1@@Z @ 0x1800C6384
 * Callers:
...
__int64 __fastcall CBoundsBitmap::Create(struct CImageSource *a1, struct CBoundsBitmap **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v6 = (*(__int64 (__fastcall **)(char *, unsigned __int64 *, _BYTE *))(*(_QWORD *)v2 + 120LL))(v2, &v14, v15);
    v5 = v6;
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x24u);
    }
    else
    {
