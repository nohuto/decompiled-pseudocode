/*
 * XREFs of ?GetEffectiveLayerSizeAndTransform@CTreeEffectLayer@@IEAAXMMMMAEBUD2D_POINT_2F@@PEAVCMILMatrix@@PEAUD2D_SIZE_F@@@Z @ 0x1800C4A64
 * Callers:
        ...
        struct D2D_SIZE_F *a8)
{
  ...
  *((_OWORD *)a7 + 3) = _xmm;
  ...
  if ( *(_BYTE *)(*(_QWORD *)(v9 + 240) + 504LL) )
  {
    CMILMatrix::Translate(v8, *(float *)(v9 + 216) - a6->x, *(float *)(v9 + 220) - a6->y);
    v12 = a8;
    a8->width = v11[66] * v11[56];
    v13 = v11[67] * v11[57];
  }
  else
  {
