/*
 * XREFs of ?IsSameGeometry@CRgnGeometry@@UEBA_NPEBVCGeometry@@@Z @ 0x180058200
 * Callers:
 *     ?SetClip@CVisual@@QEAAJPEAVCGeometry@@@Z @ 0x18008524C (-SetClip@CVisual@@QEAAJPEAVCGeometry@@@Z.c)
 * Callees:
 *     ?IsOfType@CRgnGeometry@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1800583A0 (-IsOfType@CRgnGeometry@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z.c)
...
char __fastcall CRgnGeometry::IsSameGeometry(CRgnGeometry *this, const struct CGeometry *a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( (char *)v5 == (char *)CRgnGeometry::IsOfType ? CRgnGeometry::IsOfType(a2, 74LL) : (unsigned __int8)v5(a2, 74LL) )
    {
      v7 = *((_DWORD *)this + 26) >> 4;
