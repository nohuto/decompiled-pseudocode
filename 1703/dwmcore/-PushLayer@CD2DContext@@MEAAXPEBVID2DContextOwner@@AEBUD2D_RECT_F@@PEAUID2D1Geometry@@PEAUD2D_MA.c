/*
 * XREFs of ?PushLayer@CD2DContext@@MEAAXPEBVID2DContextOwner@@AEBUD2D_RECT_F@@PEAUID2D1Geometry@@PEAUD2D_MATRIX_3X2_F@@MW4D2D1_ANTIALIAS_MODE@@W4D2D1_LAYER_OPTIONS1@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x1800100C0
 * Callers:
        ...
        enum D2D1_PRIMITIVE_BLEND a9)
{
  ...
  v13 = 0LL;
  if ( v12 )
    v13 = *(CD2DTarget **)(*((_QWORD *)this + 42) + 8LL * (unsigned int)(v12 - 1));
