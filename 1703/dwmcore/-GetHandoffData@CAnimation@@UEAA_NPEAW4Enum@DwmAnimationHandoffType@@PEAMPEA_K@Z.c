/*
 * XREFs of ?GetHandoffData@CAnimation@@UEAA_NPEAW4Enum@DwmAnimationHandoffType@@PEAMPEA_K@Z @ 0x1800BC630
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (*((_BYTE *)this + 8) & 0x40) == 0 )
    {
      if ( *((_DWORD *)this + 49) )
      {
        ...
        if ( (_DWORD)v12 )
        {
          ...
          v13 = *((_QWORD *)this - 11);
          v16[1] = v12;
          CoreUICallSend(*(_QWORD *)(*(_QWORD *)(v13 + 1352) + 56LL), v16, 2LL, 1LL, 1, &unk_1801D53D6);
          *((_BYTE *)this + 8) |= 0x40u;
        }
      }
    }
