/*
 * XREFs of ?CalculateMatrixFromDelta@CManipulationTransform@@SAXAEBUD2DVector3@@00PEAUD2DMatrix@@@Z @ 0x1800291A0
 * Callers:
 ...
 *     ?GetProperty@CManipulationTransform@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180029080 (-GetProperty@CManipulationTransform@@UEAAJIPEAVCExpressionValue@@@Z.c)
        ...
        struct D2DMatrix *a4)
{
  ...
  int v25; // xmm0_4
  int v26; // xmm1_4
  const struct D2DMatrix *v27; // rdx
  int *v28; // r10
  int v29; // xmm0_4
  int v30; // xmm1_4
  ...
  *(_QWORD *)(v18 + 4) = 0LL;
  if ( (_BYTE)v16 )
  {
    if ( v8 )
    {
      ...
      *(_DWORD *)(v18 + 56) = v24;
      *(_DWORD *)(v18 + 52) = v22 ^ _xmm;
      *(_DWORD *)(v18 + 48) = v23 ^ _xmm;
      *(_QWORD *)(v18 + 32) = 0LL;
      *(_QWORD *)(v18 + 24) = 0LL;
      *(_QWORD *)(v18 + 12) = 0LL;
      *(_QWORD *)(v18 + 4) = 0LL;
    ...
    if ( v8 )
    {
      ...
      v36 = 1065353216;
      v31 = 1065353216;
      D2DMatrixMultiply((struct D2DMatrix *)v18, v27, (const struct D2DMatrix *)&v31);
    }
  }
  if ( v9 )
  {
