/*
 * XREFs of ?ReleaseDDAHwRenderTarget@CDisplay@@QEAAXXZ @ 0x1800B7FB0
 * Callers:
 ...
 *     ?ReleaseHwRenderTarget@CHwndRenderTargetDDA@@EEAAXXZ @ 0x180155F60 (-ReleaseHwRenderTarget@CHwndRenderTargetDDA@@EEAAXXZ.c)
