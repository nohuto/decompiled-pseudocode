/*
 * XREFs of ?CreateBuffer@CD3DDeviceLevel1@@QEAAJAEBUD3D11_BUFFER_DESC@@PEBUD3D11_SUBRESOURCE_DATA@@PEAPEAUID3D11Buffer@@@Z @ 0x180077E70
 * Callers:
        ...
        struct ID3D11Buffer **a4)
{
  ...
  v5 = (*(__int64 (__fastcall **)(_QWORD, const struct D3D11_BUFFER_DESC *, const struct D3D11_SUBRESOURCE_DATA *, struct ID3D11Buffer **))(**((_QWORD **)this + 80) + 24LL))(
         *((_QWORD *)this + 80),
         a2,
         a3,
         a4);
  v6 = v5;
  if ( v5 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x5FBu);
