/*
 * XREFs of ??1CGeometry2DGroup@@MEAA@XZ @ 0x180178B14
 * Callers:
...
void __fastcall CGeometry2DGroup::~CGeometry2DGroup(CGeometry2DGroup *this)
{
  ...
  *((_QWORD *)this + 9) = &CCyclicResourceListEntry::`vftable';
  ...
  v3 = (CGeometry2DGroup **)*((_QWORD *)this + 11);
  if ( v2[1] != (CGeometry2DGroup *)((char *)this + 80) || *v3 != (CGeometry2DGroup *)((char *)this + 80) )
    __fastfail(3u);
