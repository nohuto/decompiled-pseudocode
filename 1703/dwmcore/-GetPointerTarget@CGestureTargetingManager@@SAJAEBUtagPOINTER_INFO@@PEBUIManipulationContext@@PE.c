/*
 * XREFs of ?GetPointerTarget@CGestureTargetingManager@@SAJAEBUtagPOINTER_INFO@@PEBUIManipulationContext@@PEAUTargetingInfo@@@Z @ 0x1800D00E4
 * Callers:
        ...
        struct TargetingInfo *a3)
{
  ...
  v22 = 1;
  v23 = 0LL;
  Microsoft::WRL::ComPtr<IAccelerator>::InternalRelease((__int64 *)&v23);
  ...
  Microsoft::WRL::ComPtr<IAccelerator>::InternalRelease(&v27);
      ...
      if ( v23 != v21 )
      {
               ...
               *(unsigned int *)a1) == (_DWORD)v15 )
        {
                 ...
                 1LL) )
          {
            ...
            if ( (*(int (__fastcall **)(__int64, _QWORD, __int64 *))(*(_QWORD *)v17 + 120LL))(
                   v17,
                   *(unsigned int *)a1,
                   &v24) >= 0 )
            {
              ...
              if ( ((v30 & 1) == 0 || v18) && (unsigned int)(*v23)[16](v23) )
              {
                Microsoft::WRL::ComPtr<IInteractionResource>::operator=(&v21, &v23);
                v20 = v22;
              }
            }
            Microsoft::WRL::ComPtr<CBrushRenderingGraph>::InternalRelease(&v24);
...
LABEL_24:
        *(_DWORD *)a3 = v20;
        Microsoft::WRL::ComPtr<IInteractionResource>::operator=((char *)a3 + 8, &v21);
        goto LABEL_25;
      }
      v20 = 1;
      Microsoft::WRL::ComPtr<IAccelerator>::InternalRelease((__int64 *)&v21);
