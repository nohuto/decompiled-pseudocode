/*
 * XREFs of ?Initialize@CTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z @ 0x18004EDE0
 * Callers:
 ...
 *     ?Initialize@CDesktopTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z @ 0x180134690 (-Initialize@CDesktopTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z.c)
 * Callees:
 *     ?Initialize@CVisualOcclusionInfo@@MEAAXXZ @ 0x18004F7B0 (-Initialize@CVisualOcclusionInfo@@MEAAXXZ.c)
