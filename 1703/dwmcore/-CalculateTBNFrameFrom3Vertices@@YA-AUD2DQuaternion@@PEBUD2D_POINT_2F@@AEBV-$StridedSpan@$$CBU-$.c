/*
 * XREFs of ?CalculateTBNFrameFrom3Vertices@@YA?AUD2DQuaternion@@PEBUD2D_POINT_2F@@AEBV?$StridedSpan@$$CBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@AEBVCMILMatrix@@2@Z @ 0x18015EFB0
 * Callers:
 ...
 *     CalculateTBNFrame @ 0x18015ED80 (CalculateTBNFrame.c)
        ...
        CMILMatrix *a5)
{
  ...
  CalculateTBNFrame(v28, v27, &v29.x, (__int64)&v31, (__int64)&v30);
