/*
 * XREFs of ?ComputeRealizationSize@CHwBitmapColorSource@@CAJIIAEBV?$CDelayComputedBounds@URealizationSampling@CoordinateSpace@@@@PEBVCMILMatrix@@W4Enum@MilBitmapWrapMode@@HMHAEAURealizationParameters@1@@Z @ 0x18007BFF0
 * Callers:
  ...
  *(_DWORD *)(a9 + 40) = v18;
  if ( v16 > a1 || v18 > a2 )
  {
    *(_BYTE *)(a9 + 88) = 1;
    ...
    {
      v10 = -2147467263;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467263, 0x438u);
      return v10;
    }
