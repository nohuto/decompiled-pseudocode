/*
 * XREFs of ?SyncTargetCaptureBits@CChannel@@UEAAJINIIIIPEAW4DXGI_FORMAT@@_KIIPEAPEAX@Z @ 0x1800806D0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a12)
{
  ...
  struct _RTL_CRITICAL_SECTION *v36; // [rsp+B8h] [rbp+27h] BYREF

  v36 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 168);
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x7D0u);
  }
  else
  {
    v17 = v24;
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v24, 0x7D2u);
    }
    else
    {
      v18 = a12;
