/*
 * XREFs of ?AddResponseItem@CIndependentRefreshRateScheduler@@UEAAJPEAVCResponseItem@@@Z @ 0x18013C570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CIndependentRefreshRateScheduler::AddResponseItem(
        ...
        struct CResponseItem *a2)
{
  ...
  if ( v2 )
  {
    ...
    v3 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x878u);
  }
  return v3;
}
