/*
 * XREFs of ?SetCommonStateMinusTransform@CD2DContext@@AEAAXPEBVID2DContextOwner@@W4D2D1_PRIMITIVE_BLEND@@PEBW4D2D1_ANTIALIAS_MODE@@PEAUD2D_MATRIX_4X4_F@@@Z @ 0x180199814
 * Callers:
        ...
        struct D2D_MATRIX_4X4_F *a5)
{
  ...
  (*(void (__fastcall **)(const struct ID2DContextOwner *, _OWORD *))(*(_QWORD *)a2 + 24LL))(a2, v16);
  if ( a4 )
