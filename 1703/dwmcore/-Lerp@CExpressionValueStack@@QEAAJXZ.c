/*
 * XREFs of ?Lerp@CExpressionValueStack@@QEAAJXZ @ 0x18017DFE8
 * Callers:
...
LABEL_20:
    v2 = -2147467259;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, v49);
    return v2;
  }
  v4 = *((_QWORD *)this + 3);
  ...
  {
    case 18:
      v47 = *(float *)(v4 + 72LL * (v1 - 2)) - *(float *)(v4 + 72LL * (v1 - 3));
      *(_DWORD *)(v4 + 72LL * (v1 - 3) + 64) = 18;
      *(float *)(v4 + 72LL * (v1 - 3)) = (float)(fmaxf(0.0, fminf(v6, 1.0)) * v47) + *(float *)(v4 + 72LL * (v1 - 3));
      break;
    case 35:
      v61 = *(_QWORD *)(v4 + 72LL * (v1 - 3));
      v62 = *(_QWORD *)(v4 + 72LL * (v1 - 2));
      v44 = (__m128)(unsigned int)v62;
      v45 = (__m128)HIDWORD(v62);
      v46 = fmaxf(0.0, fminf(v6, 1.0));
      *(_DWORD *)(v4 + 72LL * (v1 - 3) + 64) = 35;
      v44.m128_f32[0] = (float)((float)(*(float *)&v62 - *(float *)&v61) * v46) + *(float *)&v61;
      v45.m128_f32[0] = (float)((float)(*((float *)&v62 + 1) - *((float *)&v61 + 1)) * v46) + *((float *)&v61 + 1);
      *(_QWORD *)(v4 + 72LL * (v1 - 3)) = _mm_unpacklo_ps(v44, v45).m128_u64[0];
      break;
    case 52:
      v53 = *(_QWORD *)(v4 + 72LL * (v1 - 3));
      v52 = *(_QWORD *)(v4 + 72LL * (v1 - 2));
      v40 = (__m128)(unsigned int)v52;
      v41 = (__m128)HIDWORD(v52);
      v42 = fmaxf(0.0, fminf(v6, 1.0));
      v54 = *(float *)(v4 + 72LL * (v1 - 3) + 8);
      v43 = *(float *)(v4 + 72LL * (v1 - 2) + 8) - v54;
      *(_DWORD *)(v4 + 72LL * (v1 - 3) + 64) = 52;
      v40.m128_f32[0] = (float)((float)(*(float *)&v52 - *(float *)&v53) * v42) + *(float *)&v53;
      v41.m128_f32[0] = (float)((float)(*((float *)&v52 + 1) - *((float *)&v53 + 1)) * v42) + *((float *)&v53 + 1);
      *(_QWORD *)(v4 + 72LL * (v1 - 3)) = _mm_unpacklo_ps(v40, v41).m128_u64[0];
      *(float *)(v4 + 72LL * (v1 - 3) + 8) = (float)(v43 * v42) + v54;
      break;
    case 69:
    ...
    case 104:
      ...
      v29 = v28;
      v55 = *(_QWORD *)(v4 + 72LL * (v1 - 3) + 16);
      *(_QWORD *)v60 = *(_QWORD *)(v4 + 72LL * (v1 - 2) + 16);
      v30 = fmaxf(0.0, fminf(v6, 1.0));
      *(_DWORD *)(v4 + 72LL * (v1 - 3) + 64) = 104;
      *(float *)&v50 = (float)((float)(v28.m128_f32[0] - v27.m128_f32[0]) * v30) + v27.m128_f32[0];
      ...
      *((float *)&v50 + 1) = v31;
      v32 = (__m128)LODWORD(v60[0]);
      v32.m128_f32[0] = (float)((float)(v60[0] - *(float *)&v55) * v30) + *(float *)&v55;
      *((float *)&v50 + 2) = (float)((float)(_mm_shuffle_ps(v29, v29, 170).m128_f32[0] - v28.m128_f32[0]) * v30)
                           + v28.m128_f32[0];
      v33 = (__m128)LODWORD(v60[1]);
      *((float *)&v50 + 3) = (float)((float)(_mm_shuffle_ps(v29, v29, 255).m128_f32[0] - v27.m128_f32[0]) * v30)
                           + v27.m128_f32[0];
      *(_OWORD *)(v4 + 72LL * (v1 - 3)) = v50;
      v33.m128_f32[0] = (float)((float)(v60[1] - *((float *)&v55 + 1)) * v30) + *((float *)&v55 + 1);
    ...
    case 265:
      ...
      *(float *)&v56 = (float)((float)(v8.m128_f32[0] - v7.m128_f32[0]) * v15) + v7.m128_f32[0];
      ...
      *((float *)&v56 + 1) = v17;
      *((float *)&v56 + 2) = (float)((float)(_mm_shuffle_ps(v8, v8, 170).m128_f32[0] - v18) * v15) + v18;
      *((float *)&v56 + 3) = (float)((float)(_mm_shuffle_ps(v8, v8, 255).m128_f32[0] - v7.m128_f32[0]) * v15)
                           + v7.m128_f32[0];
      *(float *)&v57 = (float)((float)(v10.m128_f32[0] - v9.m128_f32[0]) * v15) + v9.m128_f32[0];
      ...
      *((float *)&v57 + 1) = v20;
      *((float *)&v57 + 2) = (float)((float)(_mm_shuffle_ps(v10, v10, 170).m128_f32[0] - v21) * v15) + v21;
      *((float *)&v57 + 3) = (float)((float)(_mm_shuffle_ps(v10, v10, 255).m128_f32[0] - v9.m128_f32[0]) * v15)
                           + v9.m128_f32[0];
      *(float *)&v58 = (float)((float)(v11.m128_f32[0] - v12.m128_f32[0]) * v15) + v12.m128_f32[0];
      v22 = _mm_shuffle_ps(v12, v12, 85).m128_f32[0];
      *((float *)&v58 + 1) = (float)((float)(_mm_shuffle_ps(v11, v11, 85).m128_f32[0] - v22) * v15) + v22;
      v23 = _mm_shuffle_ps(v12, v12, 170).m128_f32[0];
      v12.m128_f32[0] = _mm_shuffle_ps(v12, v12, 255).m128_f32[0];
      *(_DWORD *)(v4 + 72LL * (v1 - 3) + 64) = 265;
      *((float *)&v58 + 2) = (float)((float)(_mm_shuffle_ps(v11, v11, 170).m128_f32[0] - v23) * v15) + v23;
      *((float *)&v58 + 3) = (float)((float)(_mm_shuffle_ps(v11, v11, 255).m128_f32[0] - v12.m128_f32[0]) * v15)
                           + v12.m128_f32[0];
      v59[0] = (float)((float)(v14.m128_f32[0] - v13.m128_f32[0]) * v15) + v13.m128_f32[0];
      ...
      v59[1] = v25;
      *(_OWORD *)(v4 + 72LL * (v1 - 3)) = v56;
      *(_OWORD *)(v4 + 72LL * (v1 - 3) + 16) = v57;
      v59[2] = (float)((float)(_mm_shuffle_ps(v14, v14, 170).m128_f32[0] - v26) * v15) + v26;
      *(_OWORD *)(v4 + 72LL * (v1 - 3) + 32) = v58;
      v59[3] = (float)((float)(_mm_shuffle_ps(v14, v14, 255).m128_f32[0] - v13.m128_f32[0]) * v15) + v13.m128_f32[0];
      *(_OWORD *)(v4 + 72LL * (v1 - 3) + 48) = *(_OWORD *)v59;
      break;
    default:
      v49 = 3282;
      goto LABEL_20;
