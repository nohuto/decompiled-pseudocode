/*
 * XREFs of ?GetBits@CDesktopRenderTarget@@UEAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x1800694E0
 * Callers:
 *     ?GetBits@CDesktopRenderTarget@@WDA@EAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z @ 0x1800D55A0 (-GetBits@CDesktopRenderTarget@@WDA@EAAJPEBUtagRECT@@PEAVIBitmapDest@@@Z.c)
 * Callees:
...
LABEL_7:
    ...
    if ( *((_DWORD *)this + 20) )
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, Bits, 0x7C3u);
    }
  }
  return v3;
}
