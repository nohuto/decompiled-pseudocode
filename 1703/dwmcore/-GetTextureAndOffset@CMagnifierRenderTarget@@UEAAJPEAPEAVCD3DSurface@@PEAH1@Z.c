/*
 * XREFs of ?GetTextureAndOffset@CMagnifierRenderTarget@@UEAAJPEAPEAVCD3DSurface@@PEAH1@Z @ 0x180148420
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x393u);
  }
  else
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, D3DSurfaceLevel, 0x398u);
    }
    else
    {
      *a3 = *((_DWORD *)this + 129);
