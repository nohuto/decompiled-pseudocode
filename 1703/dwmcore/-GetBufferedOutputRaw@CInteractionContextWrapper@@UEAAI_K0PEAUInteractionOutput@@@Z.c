/*
 * XREFs of ?GetBufferedOutputRaw@CInteractionContextWrapper@@UEAAI_K0PEAUInteractionOutput@@@Z @ 0x180190340
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?PeekFirst@?$CQueue@PEAVCBufferedInteractionOutput@@@@QEAAPEAXPEAXPEAPEAVCBufferedInteractionOutput@@@Z @ 0x1801908F0 (-PeekFirst@-$CQueue@PEAVCBufferedInteractionOutput@@@@QEAAPEAXPEAXPEAPEAVCBufferedInteractionOut.c)
        ...
        struct InteractionOutput *a4)
{
    ...
    && *((_DWORD *)this + 124) )
  {
    ...
    v9 = CQueue<CBufferedInteractionOutput *>::PeekFirst((char *)this + 480, v8, &PerformanceCount);
    if ( v9 )
    {
      ...
      do
      {
        ...
        v11 = 0LL;
        EnterCriticalSection((LPCRITICAL_SECTION)((char *)this + 504));
        if ( v9 && *(CInteractionContextWrapper **)v9 != (CInteractionContextWrapper *)((char *)this + 480) )
        {
