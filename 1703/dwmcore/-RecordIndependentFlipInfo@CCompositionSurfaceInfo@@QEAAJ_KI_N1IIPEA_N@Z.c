/*
 * XREFs of ?RecordIndependentFlipInfo@CCompositionSurfaceInfo@@QEAAJ_KI_N1IIPEA_N@Z @ 0x180175AD0
 * Callers:
        ...
        bool *a8)
{
  ...
  if ( v16 >= 0 )
  {
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
      Template_xxqqqqq(v18, v17, *((_DWORD *)this + 10), v21, v13, a4, v8, v9, v22);
  ...
  {
    v11 = v16 | 0x10000000;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v16 | 0x10000000, 0x10Fu);
  }
  return v11;
}
