/*
 * XREFs of ?FullyContains@CCpuClip@@QEBA_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x1800C12E0
 * Callers:
...
char __fastcall CCpuClip::FullyContains(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_BYTE *)(a1 + 32) )
  {
    if ( !CShape::IsAxisAlignedRectangle(*(CShape **)(a1 + 16)) )
      return v3;
    v8 = *(CShape **)(a1 + 16);
    if ( !a3 )
      goto LABEL_5;
