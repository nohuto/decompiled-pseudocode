/*
 * XREFs of ?AddLines@GeometrySink@CDrawListPrimitiveBuilder@@EEAAXPEBUD2D_POINT_2F@@I@Z @ 0x18015B710
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  if ( v3 < 0 )
  {
    v15 = 237;
LABEL_19:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v3, v15);
    goto LABEL_20;
  }
  v7 = (char *)this + 24;
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xEFu);
  }
  else
  {
    v9 = 0LL;
