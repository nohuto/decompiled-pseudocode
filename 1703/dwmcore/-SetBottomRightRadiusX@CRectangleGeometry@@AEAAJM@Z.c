/*
 * XREFs of ?SetBottomRightRadiusX@CRectangleGeometry@@AEAAJM@Z @ 0x180094B90
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetBottomRightRadiusX(CRectangleGeometry *this, float a2)
{
  ...
  if ( *((float *)this + 36) != a2 )
  {
    *((float *)this + 36) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyScalarPropertyChanged(this, 0xBu, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x269u);
    else
      CResource::InvalidateAnimationSources(this, 11LL);
  }
  return v2;
}
