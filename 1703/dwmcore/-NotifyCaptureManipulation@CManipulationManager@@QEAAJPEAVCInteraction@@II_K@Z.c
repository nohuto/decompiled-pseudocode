/*
 * XREFs of ?NotifyCaptureManipulation@CManipulationManager@@QEAAJPEAVCInteraction@@II_K@Z @ 0x18018A378
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
  {
    ...
    if ( v8 )
      v9 = *(_QWORD *)(v8 + 8);
    Template_ppqqx((_DWORD)a2 + 8, (_DWORD)a2, a2 != 0LL ? (_DWORD)a2 + 8 : 0, v9, a3, a4, a5);
  }
  ...
  if ( v11 )
  {
    ...
    *(_QWORD *)(v11 + 32) = a5;
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x18Fu);
  ...
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x17Fu);
  }
  return v12;
}
