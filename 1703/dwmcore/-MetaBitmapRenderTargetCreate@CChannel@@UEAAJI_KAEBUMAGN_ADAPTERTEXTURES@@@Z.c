/*
 * XREFs of ?MetaBitmapRenderTargetCreate@CChannel@@UEAAJI_KAEBUMAGN_ADAPTERTEXTURES@@@Z @ 0x180139B90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MetaBitmapRenderTargetCreate(
        CChannel *this,
        int a2,
        __int64 a3,
