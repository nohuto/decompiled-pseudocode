/*
 * XREFs of ?SendFrameStatisticsTelemetry@CTelemetryFrameStatistics@@AEAAX_K@Z @ 0x1800BC14C
 * Callers:
...
void __fastcall CTelemetryFrameStatistics::SendFrameStatisticsTelemetry(CTelemetryFrameStatistics *this, __int64 a2)
{
  ...
  if ( *((_DWORD *)this + 8) )
  {
    ...
    if ( dword_18023D720 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_18023D720, 0x400000000000uLL) )
    {
      ...
      v49 = 4;
      v21 = v12 / v6;
      TlgWrite((TraceLoggingHProvider)&dword_18023D720, &unk_1801F66B6, (LPCGUID)4, (LPCGUID)8, 0xBu, &pData);
    }
