/*
 * XREFs of ?CalculateInertiaCallbackValues@CInteractionTracker@@AEAA?AUInertiaCallbackValues@@XZ @ 0x18016C49C
 * Callers:
...
__int64 __fastcall CInteractionTracker::CalculateInertiaCallbackValues(CScrollAnimation **a1, __int64 a2)
{
  ...
  {
    v2.m128_f32[0] = CScrollAnimation::GetInertiaStartVelocity(*(CScrollAnimation **)(v6 + 376));
    v8 = v2;
    v2.m128_f32[0] = CScrollAnimation::GetInertiaStartVelocity(a1[48]);
    v9 = a1[46];
    ...
    *(_DWORD *)(a2 + 12) = v2.m128_i32[0];
    ...
    v11 = v2;
    v2.m128_f32[0] = CScrollAnimation::GetNaturalEndpoint(a1[48]);
    v12 = a1[46];
    ...
    *(_DWORD *)(a2 + 28) = v2.m128_i32[0];
    ...
    v14 = v2;
    v2.m128_f32[0] = CScrollAnimation::GetModifiedRestingValue(a1[48]);
    v15 = a1[46];
    ...
    *(float *)(a2 + 48) = ModifiedRestingValue;
    if ( CScrollAnimation::CanDetermineModifiedRestingValue(v17) )
      CanDetermineModifiedRestingValue = CScrollAnimation::CanDetermineModifiedRestingValue(a1[48]);
    v18 = a1[46];
