/*
 * XREFs of ?GetVBlankEvent@CHwDisplayRenderTarget@@UEAAJPEAPEAX@Z @ 0x18003A1B0
 * Callers:
 ...
 *     ?GetVBlankEvent@CDWMSwapChain@@UEAAJPEAPEAX@Z @ 0x18003E040 (-GetVBlankEvent@CDWMSwapChain@@UEAAJPEAPEAX@Z.c)
...
__int64 __fastcall CHwDisplayRenderTarget::GetVBlankEvent(CHwDisplayRenderTarget *this, void **a2)
{
  ...
  {
LABEL_16:
    MilInstrumentationCheckHR(0x14u, &dword_1801D55C8, 1u, v6, 0x3B1u);
    return v9;
  }
  ...
  v9 = VBlankEvent;
  if ( VBlankEvent < 0 )
    MilInstrumentationCheckHR(0x14u, &dword_1801D55C8, 1u, VBlankEvent, 0x3B3u);
  return v9;
}
