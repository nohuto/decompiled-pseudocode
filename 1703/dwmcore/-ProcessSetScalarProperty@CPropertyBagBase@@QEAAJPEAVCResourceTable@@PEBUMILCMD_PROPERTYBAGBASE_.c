/*
 * XREFs of ?ProcessSetScalarProperty@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETSCALARPROPERTY@@@Z @ 0x1800310FC
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETSCALARPROPERTY *a3)
{
  ...
  v6 = *(__int64 (__fastcall **)(CPropertyBagBase *, __int64, _QWORD, __int64, struct CResourceTable **))(v3 + 144);
  ...
  v8 = updated;
  if ( updated < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, updated, 0x6Cu);
  return v8;
}
