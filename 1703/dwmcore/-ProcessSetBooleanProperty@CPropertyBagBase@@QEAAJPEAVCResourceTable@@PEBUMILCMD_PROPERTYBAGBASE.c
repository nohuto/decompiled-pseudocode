/*
 * XREFs of ?ProcessSetBooleanProperty@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETBOOLEANPROPERTY@@@Z @ 0x18012FA7C
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETBOOLEANPROPERTY *a3)
{
  ...
  LOBYTE(v10) = !v3;
  v7 = (*(__int64 (__fastcall **)(CPropertyBagBase *, _QWORD, __int64, __int64, struct CResourceTable **))(v4 + 144))(
         this,
         *((unsigned int *)a3 + 3),
         v6,
         17LL,
