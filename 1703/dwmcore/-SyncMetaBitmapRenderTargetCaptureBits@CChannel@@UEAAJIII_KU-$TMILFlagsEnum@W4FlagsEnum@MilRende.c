/*
 * XREFs of ?SyncMetaBitmapRenderTargetCaptureBits@CChannel@@UEAAJIII_KU?$TMILFlagsEnum@W4FlagsEnum@MilRenderPassFlags@@@@IAEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAI@Z @ 0x18013A5E0
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a9)
{
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x7F2u);
  }
  else
  {
    v15 = v18;
    if ( v18 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v18, 0x7F4u);
    else
      *a9 = v19;
  }
