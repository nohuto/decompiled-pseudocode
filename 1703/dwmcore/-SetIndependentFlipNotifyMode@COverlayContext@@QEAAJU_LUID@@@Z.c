/*
 * XREFs of ?SetIndependentFlipNotifyMode@COverlayContext@@QEAAJU_LUID@@@Z @ 0x180152000
 * Callers:
...
__int64 __fastcall COverlayContext::SetIndependentFlipNotifyMode(COverlayContext *this, struct _LUID a2)
{
  ...
  if ( !v2 )
    goto LABEL_5;
  v5 = *((_QWORD *)this + 30);
  while ( *(_QWORD *)(*(_QWORD *)(240LL * v4 + v5 + 24) + 40LL) != a2 )
  {
    if ( ++v4 >= v2 )
      goto LABEL_5;
  }
  ...
  {
LABEL_5:
    v6 = (CDirectFlipInfo *)*((_QWORD *)this + 121);
    if ( v6 )
    {
      if ( *(_QWORD *)(*((_QWORD *)v6 + 4) + 40LL) == a2 )
      {
        ...
        v3 = v7;
        if ( v7 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x5BAu);
      }
    }
  }
  else
  {
    v9 = COverlayContext::EnsureIndependentFlipState(
           this,
           (struct COverlayContext::OverlayPlaneInfo *)(v5 + 240LL * v4),
           1,
           1);
    v3 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x5B4u);
  }
  return v3;
}
