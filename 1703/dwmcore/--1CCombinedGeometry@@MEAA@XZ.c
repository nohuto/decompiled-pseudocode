/*
 * XREFs of ??1CCombinedGeometry@@MEAA@XZ @ 0x18017B3DC
 * Callers:
...
void __fastcall CCombinedGeometry::~CCombinedGeometry(CCombinedGeometry *this)
{
  ...
  *((_QWORD *)this + 13) = &CCyclicResourceListEntry::`vftable';
  ...
  v3 = (CCombinedGeometry **)*((_QWORD *)this + 15);
  if ( v2[1] != (CCombinedGeometry *)((char *)this + 112) || *v3 != (CCombinedGeometry *)((char *)this + 112) )
    __fastfail(3u);
