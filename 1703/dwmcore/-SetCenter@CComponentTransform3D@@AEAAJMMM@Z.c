/*
 * XREFs of ?SetCenter@CComponentTransform3D@@AEAAJMMM@Z @ 0x18002BF28
 * Callers:
...
__int64 __fastcall CComponentTransform3D::SetCenter(CComponentTransform3D *this, float a2, float a3, float a4)
{
  ...
  if ( *((float *)this + 40) != a2 || *((float *)this + 41) != a3 || *((float *)this + 42) != a4 )
  {
    ...
    *(float *)&v8[1] = a3;
    *(float *)&v8[2] = a4;
    v7 = CPropertyChangeResource::NotifyVector3PropertyChanged(this, 18LL, (const struct D2DVector3 *)v8);
    v4 = v7;
    if ( v7 < 0 )
