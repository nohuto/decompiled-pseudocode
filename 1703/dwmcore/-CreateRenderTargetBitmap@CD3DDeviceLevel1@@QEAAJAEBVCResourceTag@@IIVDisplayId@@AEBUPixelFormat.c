/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDeviceLevel1@@QEAAJAEBVCResourceTag@@IIVDisplayId@@AEBUPixelFormatInfo@@_NPEAPEAVIRenderTargetBitmap@@@Z @ 0x180079250
 * Callers:
        ...
        _QWORD *a8)
{
  ...
  v18[0] = 0LL;
  *a8 = 0LL;
  Microsoft::WRL::ComPtr<IDCompositionDirectInkPartner>::InternalRelease(v18);
  v12 = CHwTextureRenderTarget::Create(a1, a2, a3, a4, a5, a6, a7, v18);
  v13 = v12;
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x4DEu);
  }
  else
  {
    ...
    v13 = v14;
    if ( v14 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x4E0u);
  }
