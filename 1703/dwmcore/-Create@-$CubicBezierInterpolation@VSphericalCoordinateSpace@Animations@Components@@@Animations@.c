/*
 * XREFs of ?Create@?$CubicBezierInterpolation@VSphericalCoordinateSpace@Animations@Components@@@Animations@Components@@SAJMMMMPEAPEAVInterpolation@23@@Z @ 0x1801B8590
 * Callers:
        ...
        float **a5)
{
  ...
  if ( v10 )
  {
    ...
    *((_DWORD *)v11 + 2) = 1;
    *(_QWORD *)v11 = &Components::Animations::CubicBezierInterpolation<Components::Animations::SphericalCoordinateSpace>::`vftable';
  }
  else
  {
    v11 = 0LL;
