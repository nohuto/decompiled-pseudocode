/*
 * XREFs of ?CalcInversedOffsetInputBoundsFromVisibleWorldOutputBounds@CLayerVisual@@AEAAXAEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@1PEAV3@2@Z @ 0x1801613E8
 * Callers:
        ...
        __int64 a6)
{
  ...
  v7 = *(_OWORD *)(a2 + 16);
  *(_QWORD *)v20 = *(_QWORD *)(*(_QWORD *)(a1 + 496) + 104LL);
  v9 = *(_OWORD *)a3;
  v23 = *(_DWORD *)(a2 + 64);
  v22[1] = v7;
  v10 = *(_OWORD *)(a2 + 48);
