/*
 * XREFs of ?BuildD2DBitmapList@CPrimitiveGroup@@AEAAJPEAVID2DContextOwner@@PEAVID2DContext@@IIPEAPEAUID2D1Bitmap@@@Z @ 0x18000BC5C
 * Callers:
  ...
  if ( a5 )
  {
    for ( i = a6; ; ++i )
    {
      D2DBitmapRealizationForContextOwner = CCompositionSurfaceBitmap::GetD2DBitmapRealizationForContextOwner(
                                              (CCompositionSurfaceBitmap *)(*(_QWORD *)(*((_QWORD *)this + 21)
                                                                                      + 8LL * (v7 + a4))
                                                                          + 88LL),
                                              a2,
                                              &v14);
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, D2DBitmapRealizationForContextOwner, 0x46Cu);
  }
  return v6;
}
