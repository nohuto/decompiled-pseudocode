/*
 * XREFs of ?EvaluateCurve@?$XamlBounceInterpolation@VCartesianCoordinateSpace@Animations@Components@@@Animations@Components@@MEAANN@Z @ 0x1801B9420
 * Callers:
 *     <none>
 * Callees:
 *     floor_0 @ 0x1800D5366 (floor_0.c)
 *     log_0 @ 0x1800D537E (log_0.c)
 *     pow_0 @ 0x1800D53A2 (pow_0.c)
 */
