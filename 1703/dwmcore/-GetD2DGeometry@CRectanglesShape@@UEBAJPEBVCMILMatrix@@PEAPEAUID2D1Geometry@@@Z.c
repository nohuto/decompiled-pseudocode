/*
 * XREFs of ?GetD2DGeometry@CRectanglesShape@@UEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x180006750
 * Callers:
        ...
        struct ID2D1Geometry **a3)
{
      ...
      else
      {
        ...
        else
        {
          for ( i = 0; i < *((_DWORD *)this + 8); ++i )
          {
            ...
            v25 = v15;
            v27 = v14;
            CMILMatrix::Transform(a2, (const struct MilPoint2F *)&v21, (struct MilPoint2F *)v29, 4u);
  ...
  ReleaseInterface<ID2D1PrivateCompositorBuffer>(&v19);
