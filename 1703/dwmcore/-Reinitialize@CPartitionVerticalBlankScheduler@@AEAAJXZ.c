/*
 * XREFs of ?Reinitialize@CPartitionVerticalBlankScheduler@@AEAAJXZ @ 0x180068F08
 * Callers:
...
__int64 __fastcall CPartitionVerticalBlankScheduler::Reinitialize(CPartitionVerticalBlankScheduler *this)
{
  ...
  *((_BYTE *)this + 21824) = 0;
  if ( *((_BYTE *)this + 21828) )
  {
    CPartitionScheduler::Initialize((CPartitionVerticalBlankScheduler *)((char *)this + 8));
  ...
  v8 = (char *)this + 1512;
  v15 = *(_BYTE *)(v2 + 1312);
  v9 = (CPartitionVerticalBlankScheduler *)((char *)this + 216);
  v10 = 16LL;
  do
  {
    CFrameInfo::Clear(v9);
  ...
  *(_QWORD *)(*((_QWORD *)this + 2686) + 88LL) = v16;
  *(_QWORD *)(*((_QWORD *)this + 2686) + 1296LL) = v17;
  *(_BYTE *)(*((_QWORD *)this + 2686) + 1312LL) = v15;
  *(_QWORD *)(*((_QWORD *)this + 2685) + 1296LL) = v6;
  *(_QWORD *)(*((_QWORD *)this + 2685) + 1304LL) = v7;
  *(_BYTE *)(*((_QWORD *)this + 2686) + 512LL) = 1;
  v11 = CRateInfo::Initialize((CPartitionVerticalBlankScheduler *)((char *)this + 136));
  v13 = v11;
  if ( v11 < 0 )
  {
  ...
  else
  {
    if ( *((_BYTE *)this + 21828) )
      *((_BYTE *)this + 21828) = 0;
    CRateInfo::SetRefreshesPerFrame((CPartitionVerticalBlankScheduler *)((char *)this + 136), v12);
    *((_WORD *)this + 12736) = 0;
    CIndependentRefreshRateScheduler::GetDisplayInfo(this);
    *((_DWORD *)this + 5455) = -1;
    *((_QWORD *)this + 3766) = this;
    CTelemetryFrameStatistics::Reinitialize((CPartitionVerticalBlankScheduler *)((char *)this + 25264));
  }
  return v13;
}
