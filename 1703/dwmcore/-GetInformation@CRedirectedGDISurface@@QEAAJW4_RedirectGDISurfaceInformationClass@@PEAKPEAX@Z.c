/*
 * XREFs of ?GetInformation@CRedirectedGDISurface@@QEAAJW4_RedirectGDISurfaceInformationClass@@PEAKPEAX@Z @ 0x1800B0910
 * Callers:
...
LABEL_37:
      v4 = v15;
LABEL_38:
      MilInstrumentationCheckHR(0x14u, &dword_1801F3E10, 3u, v15, v18);
      return v4;
    }
