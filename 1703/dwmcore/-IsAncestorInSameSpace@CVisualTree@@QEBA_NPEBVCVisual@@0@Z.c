/*
 * XREFs of ?IsAncestorInSameSpace@CVisualTree@@QEBA_NPEBVCVisual@@0@Z @ 0x180012278
 * Callers:
 ...
 * Callees:
 *     ?IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z @ 0x1800132F4 (-IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z.c)
 */
