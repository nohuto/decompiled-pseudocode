/*
 * XREFs of ??$ChangePropertyValue@UD2DVector2@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DVector2@@@Z @ 0x1800232B8
 * Callers:
...
__int64 __fastcall CPropertyBag::ChangePropertyValue<D2DVector2>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  int v8; // eax
  unsigned int v9; // esi
