/*
 * XREFs of ?DrawAsDrawList@CCompositionSurfaceBitmap@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCDrawListCache@@@Z @ 0x18000AD00
 * Callers:
...
__int64 __fastcall CCompositionSurfaceBitmap::DrawAsDrawList(
        ...
        __int64 a6)
{
  return CCompositionSurfaceBitmap::DrawWorker(a1, a4, a5, a6);
}
