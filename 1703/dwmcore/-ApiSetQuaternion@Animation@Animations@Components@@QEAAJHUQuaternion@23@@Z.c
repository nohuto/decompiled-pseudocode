/*
 * XREFs of ?ApiSetQuaternion@Animation@Animations@Components@@QEAAJHUQuaternion@23@@Z @ 0x1801B78B0
 * Callers:
...
__int64 __fastcall Components::Animations::Animation::ApiSetQuaternion(__int64 a1, int a2, const __m128i *a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *((_DWORD *)v7 + 3) = 71;
    v8 = Components::Animations::Sequence::SetKeyframeValue(*(Components::Animations::Sequence **)(a1 + 8), a2, v10);
    if ( v8 >= 0 )
      v8 = 0;
  }
  if ( v7 )
