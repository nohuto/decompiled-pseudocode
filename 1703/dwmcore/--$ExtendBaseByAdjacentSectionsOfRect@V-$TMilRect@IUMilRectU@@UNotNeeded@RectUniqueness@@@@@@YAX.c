/*
 * XREFs of ??$ExtendBaseByAdjacentSectionsOfRect@V?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@@YAXAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@0AEAV0@@Z @ 0x18019EC50
 * Callers:
        ...
        _DWORD *a3)
{
  ...
  if ( a2[2] < *a1 || *a2 > a1[2] || a2[1] > v5 || a1[3] > v3 )
  {
    v4 = 0;
    goto LABEL_14;
  }
...
LABEL_15:
  *a3 = *v7;
  ...
  if ( !v4 || (v9 = a2[2], v9 <= a1[2]) )
    v9 = a1[2];
  a3[2] = v9;
  if ( !v6 || (result = (unsigned int)a2[3], (unsigned int)result <= a1[3]) )
