/*
 * XREFs of ?IsPositionLessThan@CGradientTextureGenerator@@CAHMM@Z @ 0x1801C11B0
 * Callers:
 ...
 *     ?SetMiddleStops@CGradientTextureGenerator@@CAXPEAV?$DynArray@UMILGradientStop@@$0A@@@PEAI1@Z @ 0x1801C171C (-SetMiddleStops@CGradientTextureGenerator@@CAXPEAV-$DynArray@UMILGradientStop@@$0A@@@PEAI1@Z.c)
 * Callees:
 *     <none>
 */
