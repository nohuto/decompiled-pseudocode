/*
 * XREFs of ?RemoveHwndBitmap@CWindowManager@@QEAAJPEAVCHwndBitmap@@@Z @ 0x1801448CC
 * Callers:
...
__int64 __fastcall CWindowManager::RemoveHwndBitmap(CWindowManager *this, struct CHwndBitmap *a2)
{
  ...
  v11 = 0LL;
  Entry = CWindowManager::FindEntry(this, *((_QWORD *)a2 + 58), &v11);
  if ( Entry >= 0 )
  {
    v5 = v11;
    ...
    else if ( !*((_QWORD *)v5 + 1) )
    {
      ...
      if ( !v8 )
      {
        v9 = CWindowManager::RemoveEntry(this, *((_QWORD *)a2 + 58));
        Entry = v9;
        if ( v9 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0xF2u);
      }
    }
  }
