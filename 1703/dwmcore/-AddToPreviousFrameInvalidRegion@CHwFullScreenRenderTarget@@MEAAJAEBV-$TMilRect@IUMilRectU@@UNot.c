/*
 * XREFs of ?AddToPreviousFrameInvalidRegion@CHwFullScreenRenderTarget@@MEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180070530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwFullScreenRenderTarget::AddToPreviousFrameInvalidRegion(__int64 a1, int *a2)
{
  ...
  if ( *(_QWORD *)(a1 + 328) )
  {
    ...
    {
      SetLastError(0);
      if ( !CombineRgn(*(HRGN *)(a1 + 328), *(HRGN *)(a1 + 328), RectRgn, 2) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x455u);
      }
    ...
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x450u);
    }
  }
  else
  {
    ...
    *(_QWORD *)(a1 + 328) = v7;
    if ( !v7 )
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x449u);
    }
  }
