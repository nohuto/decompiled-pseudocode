/*
 * XREFs of ?ProcessNotifyDxImmediateUpdate@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUMILCMD_WINDOWNODE_NOTIFYDXIMMEDIATEUPDATE@@@Z @ 0x18012AB4C
 * Callers:
        ...
        const struct MILCMD_WINDOWNODE_NOTIFYDXIMMEDIATEUPDATE *a3)
{
  ...
  _DWORD v21[4]; // [rsp+48h] [rbp-60h] BYREF
...
LABEL_3:
  ...
  Resource = CResourceTable::GetResource((__int64)a2, v10, 0x60u);
  v13 = (CFlipChain *)(Resource - 16);
  if ( !Resource )
    v13 = 0LL;
  v14 = (const struct CWindowNode ***)((char *)this + 976);
  v15 = 0;
  if ( *((_QWORD *)this + 122) )
    goto LABEL_31;
  if ( !v9 )
...
LABEL_17:
  ...
  if ( v6 )
  {
    ...
    if ( v13 )
    {
      ...
      CFlipChain::ProcessVistaBltToken(v13, v18.QuadPart, *(_QWORD *)((char *)a3 + 12), (__int64)v21);
      do
      {
        v22[v5] = (int)*(float *)&v21[v5];
        ++v5;
      }
      while ( v5 < 4 );
