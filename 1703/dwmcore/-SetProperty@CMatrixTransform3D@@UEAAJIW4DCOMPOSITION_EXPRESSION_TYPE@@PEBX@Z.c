/*
 * XREFs of ?SetProperty@CMatrixTransform3D@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801764E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMatrixTransform3D::SetProperty(_DWORD *a1, unsigned int a2, int a3, float *a4)
{
  ...
  v4 = 0;
  if ( a3 == 18 && (v6 = *a4, a2 < 0x10) && (v7 = (float *)&a1[4 * ((unsigned __int64)a2 >> 2) + 38 + (a2 & 3)]) != 0LL )
  {
    if ( *v7 != v6 )
    {
      *v7 = v6;
