/*
 * XREFs of ?GetLightInfo@CCompositionPointLight@@UEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAULightInfo@@@Z @ 0x180173760
 * Callers:
 *     <none>
 * Callees:
        ...
        struct LightInfo *a4)
{
  ...
  *(_DWORD *)a4 = 2;
  *(_OWORD *)((char *)a4 + 4) = *(_OWORD *)((char *)this + 124);
  v6 = CCompositionLight::CalcLocalToDeviceMatrix(
         this,
         a2,
         a3,
         *((struct CVisual **)this + 18),
  ...
  {
    *((_OWORD *)a4 + 5) = *(_OWORD *)CCompositionLight::CalcEyePointOrVector(v7, v11, *((_QWORD *)this + 18));
    *(_QWORD *)((char *)a4 + 36) = *((_QWORD *)this + 19);
    v9 = (CCompositionLight *)*((unsigned int *)this + 40);
    *((_DWORD *)a4 + 11) = (_DWORD)v9;
    CCompositionLight::TransformAttenuation(
      v9,
      (CCompositionPointLight *)((char *)this + 112),
