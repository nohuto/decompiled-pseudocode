/*
 * XREFs of ?ProcessUpdate@CCombinedGeometry@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMBINEDGEOMETRY@@@Z @ 0x180128848
 * Callers:
...
__int64 __fastcall CCombinedGeometry::ProcessUpdate(struct CResource **this, struct CResourceTable *a2, __m128i *a3)
{
  ...
  *((_DWORD *)this + 32) = _mm_cvtsi128_si32(_mm_srli_si128(v13, 8));
  if ( v6 )
  {
    Resource = CResourceTable::GetResource((__int64)a2, v6, 0x46u);
    this[17] = (struct CResource *)Resource;
    if ( !Resource )
    {
      v8 = -2003303421;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0xDDAu);
LABEL_15:
      CCombinedGeometry::UnRegisterNotifiers((CCombinedGeometry *)this);
      goto LABEL_16;
    }
  ...
  if ( v3 )
  {
    v9 = CResourceTable::GetResource((__int64)a2, v3, 0x46u);
    this[18] = (struct CResource *)v9;
    if ( !v9 )
    {
      v8 = -2003303421;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0xDEEu);
      goto LABEL_15;
    }
  }
  else
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0xE12u);
  }
  else
  {
    ...
    v8 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0xE13u);
  }
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xDF8u);
    goto LABEL_15;
  }
LABEL_16:
