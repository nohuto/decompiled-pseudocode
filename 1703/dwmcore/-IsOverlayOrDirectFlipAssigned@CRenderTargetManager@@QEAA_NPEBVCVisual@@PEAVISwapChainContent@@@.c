/*
 * XREFs of ?IsOverlayOrDirectFlipAssigned@CRenderTargetManager@@QEAA_NPEBVCVisual@@PEAVISwapChainContent@@@Z @ 0x18001E120
 * Callers:
        ...
        struct ISwapChainContent *a3)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 12); ++i )
  {
    ...
    if ( v10 )
    {
      v11 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 8LL * i) + 776LL);
      if ( v11 )
      {
        v12 = *(_DWORD *)(v11 + 264);
        v13 = 0;
...
LABEL_7:
        ...
        if ( v14
          ...
          && *(_QWORD *)(*(_QWORD *)(v11 + 968) + 32LL) == (*(__int64 (__fastcall **)(struct ISwapChainContent *))(*(_QWORD *)a3 + 184LL))(a3) )
        {
          return 1;
        }
      }
