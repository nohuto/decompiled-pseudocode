/*
 * XREFs of ?GetShapeDataWorker@CGeometry@@AEBAJPEBUD2D_SIZE_F@@PEAVCShapePtr@@@Z @ 0x1800297CC
 * Callers:
...
__int64 __fastcall CGeometry::GetShapeDataWorker(CGeometry *this, unsigned __int64 a2, struct CShapePtr *a3)
{
  ...
  int (*v6)(CRgnGeometry *__hidden, const struct D2D_SIZE_F *, struct CShapePtr *); // rax
  ...
  v6 = *(int (**)(CRgnGeometry *__hidden, const struct D2D_SIZE_F *, struct CShapePtr *))(*(_QWORD *)this + 152LL);
  ...
  else
  {
    ...
    if ( v9 )
    {
      ...
      if ( *(_QWORD *)a3 )
      {
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x92u);
        }
        else
        {
