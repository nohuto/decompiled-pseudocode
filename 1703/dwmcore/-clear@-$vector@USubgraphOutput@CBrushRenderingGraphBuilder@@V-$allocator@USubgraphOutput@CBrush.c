/*
 * XREFs of ?clear@?$vector@USubgraphOutput@CBrushRenderingGraphBuilder@@V?$allocator@USubgraphOutput@CBrushRenderingGraphBuilder@@@std@@@std@@QEAAXXZ @ 0x1801848B8
 * Callers:
...
__int64 __fastcall std::vector<CBrushRenderingGraphBuilder::SubgraphOutput>::clear(__int64 *a1)
{
  ...
  for ( i = *a1; i != v1; i += 16LL )
  {
    ...
    if ( v4 )
    {
      ...
      Microsoft::WRL::ComPtr<IAccelerator>::InternalRelease((__int64 *)v4);
