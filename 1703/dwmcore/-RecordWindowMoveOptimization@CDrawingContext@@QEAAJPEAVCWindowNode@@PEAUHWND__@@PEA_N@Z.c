/*
 * XREFs of ?RecordWindowMoveOptimization@CDrawingContext@@QEAAJPEAVCWindowNode@@PEAUHWND__@@PEA_N@Z @ 0x1800A62D0
 * Callers:
        ...
        bool *a4)
{
  ...
  if ( !*((_BYTE *)this + 6772) )
    goto LABEL_2;
  v10 = *(_DWORD *)(*((_QWORD *)this + 4) + 1224LL);
  v47 = 0;
  v44[0] = _xmm;
  v45 = 32085;
  v44[1] = _xmm;
  v44[2] = _xmm;
  v44[3] = _xmm;
  CMatrixStack::Top((CDrawingContext *)((char *)this + 472), (struct CMILMatrix *)v46);
  if ( v10 >= 2 )
  {
    v11 = *((_QWORD *)this + 48);
    if ( v11 )
    {
      LocalToWorldTransform = (*(__int64 (__fastcall **)(__int64, unsigned __int64 *))(*(_QWORD *)v11 + 248LL))(
                                v11,
                                &v50);
...
LABEL_24:
  ...
  if ( v42[1] )
  {
    ...
    CScopedClipStack::GetTopGpuClipInScope((__int64 *)this + 114, 1, (__int64)&v53);
...
LABEL_62:
      ...
      v35 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 48) + 256LL))(*((_QWORD *)this + 48));
      v38 = MoveOptimizationInfo::Create((_DWORD)a2, v36, v37, (unsigned int)&v50, (__int64)RectRgn, v35, (__int64)&v43);
      v39 = v43;
      v7 = v38;
      if ( v38 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v38, 0x1EBAu);
      }
      else
      {
        ...
        v7 = v40;
        if ( v40 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v40, 0x1EC0u);
      }
      if ( v39 )
