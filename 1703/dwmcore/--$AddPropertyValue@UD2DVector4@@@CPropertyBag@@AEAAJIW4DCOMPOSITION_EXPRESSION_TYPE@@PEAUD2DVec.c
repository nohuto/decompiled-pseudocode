/*
 * XREFs of ??$AddPropertyValue@UD2DVector4@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DVector4@@@Z @ 0x18017C038
 * Callers:
...
__int64 __fastcall CPropertyBag::AddPropertyValue<D2DVector4>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  unsigned int v4; // edi
  int v9; // r9d
  _QWORD *inserted; // r13
