/*
 * XREFs of ?SynchronizeChannel@CConnection@@QEAAJI@Z @ 0x1800656E8
 * Callers:
...
__int64 __fastcall CConnection::SynchronizeChannel(CConnection *this, unsigned int a2)
{
  ...
  {
    v7 = -2003303402;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303402, 0x12Eu);
LABEL_9:
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, MasterTableEntry, 0x132u);
    goto LABEL_9;
  }
  v14 = *(__m128i *)v17;
