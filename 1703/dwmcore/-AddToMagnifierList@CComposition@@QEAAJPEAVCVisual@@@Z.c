/*
 * XREFs of ?AddToMagnifierList@CComposition@@QEAAJPEAVCVisual@@@Z @ 0x18013F3F4
 * Callers:
...
__int64 __fastcall CComposition::AddToMagnifierList(CComposition *this, struct CVisual *a2)
{
  ...
  if ( Magnifier == *(_DWORD *)(v6 + 984) )
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, WeakReferenceBase, 0x112Eu);
    }
    else
    {
      v8 = (unsigned int)v14;
      ...
      if ( v3 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v3, 0x112Fu);
    }
  }
