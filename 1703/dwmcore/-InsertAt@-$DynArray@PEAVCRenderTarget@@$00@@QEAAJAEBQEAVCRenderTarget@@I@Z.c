/*
 * XREFs of ?InsertAt@?$DynArray@PEAVCRenderTarget@@$00@@QEAAJAEBQEAVCRenderTarget@@I@Z @ 0x1800B19B4
 * Callers:
...
__int64 __fastcall DynArray<CRenderTarget *,1>::InsertAt(__int64 *a1, _QWORD *a2, unsigned int a3, int a4)
{
  __int64 v5; // rsi
  int v6; // eax
  unsigned int v7; // edi
  ...
  {
    v14 = a2;
    v6 = DynArrayImpl<1>::Grow((_DWORD)a1, 8, 1, a4, (__int64)&v14);
    v7 = v6;
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x1CCu);
    }
    else
    {
      ++*((_DWORD *)a1 + 6);
      v8 = *a1;
      v9 = (unsigned int)(*((_DWORD *)a1 + 6) - 1);
      ...
      v10 = v14;
      v11 = (_QWORD *)(v8 + 8 * v5);
      if ( v14 >= v11 && (unsigned __int64)v14 < v8 + 8 * ((unsigned __int64)*((unsigned int *)a1 + 6) - 1) )
        v10 = v14 + 1;
      *v11 = *v10;
    }
  }
