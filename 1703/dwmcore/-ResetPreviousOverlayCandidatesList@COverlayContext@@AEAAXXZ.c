/*
 * XREFs of ?ResetPreviousOverlayCandidatesList@COverlayContext@@AEAAXXZ @ 0x180071630
 * Callers:
...
void __fastcall COverlayContext::ResetPreviousOverlayCandidatesList(COverlayContext *this)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 58); ++i )
    COverlayContext::OverlayPlaneInfo::Reset((COverlayContext::OverlayPlaneInfo *)(*((_QWORD *)this + 26) + 240LL * i));
  *((_DWORD *)this + 58) = 0;
  DynArrayImpl<0>::ShrinkToSize((__int64)this + 208, 0xF0u);
}
