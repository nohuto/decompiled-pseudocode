/*
 * XREFs of ?UnregisterExpression@CExpressionManager@@QEAAXPEAVCBaseExpression@@@Z @ 0x18002CCE0
 * Callers:
...
LABEL_8:
    if ( !*((_QWORD *)v6 + 2) )
    {
      ...
      RtlDeleteElementGenericTable((PRTL_GENERIC_TABLE)((char *)this + 304), v6);
    }
  }
  else
  {
