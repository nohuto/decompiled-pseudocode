/*
 * XREFs of ?GetRemoteAppParameters@CHwndRenderTarget@@IEAAJPEAURenderTargetPresentParameters@@@Z @ 0x180145E90
 * Callers:
        ...
        double a3)
{
  ...
  v23 = 0LL;
  v24 = 0LL;
  v7 = (*(__int64 (__fastcall **)(CHwndRenderTarget *, char *))(v3 + 248))(this, (char *)a2 + 8);
  v8 = v7;
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x650u);
  }
  else
  {
    do
    ...
    v9 = (*(__int64 (__fastcall **)(CHwndRenderTarget *))(*(_QWORD *)this + 256LL))(this);
    v10 = v25[0];
    *(_QWORD *)a2 = v9;
    ...
    *((_DWORD *)a2 + 5) = v17;
    *((_QWORD *)a2 + 3) = (*(__int64 (__fastcall **)(CHwndRenderTarget *))(*(_QWORD *)this + 264LL))(this);
  }
  return v8;
}
