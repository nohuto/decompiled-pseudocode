/*
 * XREFs of ?ProcessSetCoordinateSpace@CCompositionPointLight@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPOSITIONPOINTLIGHT_SETCOORDINATESPACE@@@Z @ 0x18012B830
 * Callers:
        ...
        const struct MILCMD_COMPOSITIONPOINTLIGHT_SETCOORDINATESPACE *a3)
{
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x149u);
  }
  return v4;
}
