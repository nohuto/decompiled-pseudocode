/*
 * XREFs of ?GammaConvert_64bppABGR_128bppABGR@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x1801ACE80
 * Callers:
 *     <none>
 * Callees:
 *     ?Convert_sRGB_UINT16_To_scRGB_float@@YAMG@Z @ 0x1801ADD78 (-Convert_sRGB_UINT16_To_scRGB_float@@YAMG@Z.c)
 */
