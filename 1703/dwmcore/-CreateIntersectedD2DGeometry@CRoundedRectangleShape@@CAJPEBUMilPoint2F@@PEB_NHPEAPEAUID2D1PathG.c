/*
 * XREFs of ?CreateIntersectedD2DGeometry@CRoundedRectangleShape@@CAJPEBUMilPoint2F@@PEB_NHPEAPEAUID2D1PathGeometry@@@Z @ 0x1801B0E88
 * Callers:
        ...
        struct ID2D1PathGeometry **a4)
{
  ...
  for ( i = 1; v7 > 0; ++a2 )
  {
    if ( *a2 )
    {
      v11 = CRoundedRectangleShape::IntersectGeometryBuilder(a1, &dword_1801FE510[7 * v5], a4, i);
      v4 = v11;
      if ( v11 < 0 )
      {
