/*
 * XREFs of ?PushStacksForBspRootVisual@CBspPreComputeHelper@@AEAAJPEAVCVisual@@@Z @ 0x1801B3984
 * Callers:
...
__int64 __fastcall CBspPreComputeHelper::PushStacksForBspRootVisual(CBspPreComputeHelper *this, struct CVisual *a2)
{
  ...
  v11 = a2;
  v9 = 0;
  CVisual::CalcEffectiveTransform((__int64)a2, 5, 0LL, &v10, (CMILMatrix *)v8, 0LL);
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x68u);
  }
  else
  {
    ...
    LODWORD(v11) = -1;
    v3 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((unsigned int *)this + 32, &v11);
    v4 = v3;
    if ( v3 < 0 )
    {
      v7 = 110;
    ...
    *(float *)&v11 = FLOAT_1_0;
    v3 = CWatermarkStack<float,64,2,10>::Push((unsigned int *)this + 64, &v11);
    v4 = v3;
    if ( v3 < 0 )
    {
      v7 = 122;
