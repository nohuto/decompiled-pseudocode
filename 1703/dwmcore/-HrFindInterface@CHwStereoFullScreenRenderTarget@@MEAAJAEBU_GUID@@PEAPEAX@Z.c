/*
 * XREFs of ?HrFindInterface@CHwStereoFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801A0590
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      *a3 = (void *)(((unsigned __int64)this + 240) & -(__int64)(this != (CHwStereoFullScreenRenderTarget *)128));
      return 0LL;
    }
  }
  return result;
