/*
 * XREFs of ??2CAffineTransform2DEffect@@KAPEAX_K@Z @ 0x180153698
 * Callers:
...
void *__fastcall CAffineTransform2DEffect::operator new()
{
  void *result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = WPF::ProcessHeapImpl::AllocClear(0x118uLL);
  if ( !result )
  {
