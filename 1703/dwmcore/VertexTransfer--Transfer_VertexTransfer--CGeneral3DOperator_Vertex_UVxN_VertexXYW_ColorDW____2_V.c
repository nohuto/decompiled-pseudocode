/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1801BCEE0
 * Callers:
        ...
        float *a2)
{
        ...
        *(_DWORD *)(v13 + 12) = result | (((int)(float)BYTE1(v14) | (((int)(float)BYTE2(v14) | ((int)(float)((float)HIBYTE(v14) * v7) << 8)) << 8)) << 8) )
  {
    ...
    VertexTransfer::CGeneral3DOperator<Vertex_UVxN<VertexXYW_ColorDW>>::Transform(
      (__int64)v15,
      (float *)v12,
      (float *)(*(_QWORD *)(a1 + 24) + (int)(v6 * *(_DWORD *)(a1 + 32))),
      *(_DWORD *)(a1 + 40),
      (__int64)a2,
      (char *)v13);
    v14 = *(_DWORD *)(v12 + 12);
