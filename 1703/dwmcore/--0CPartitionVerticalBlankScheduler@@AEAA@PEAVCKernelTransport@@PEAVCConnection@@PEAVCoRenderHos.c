/*
 * XREFs of ??0CPartitionVerticalBlankScheduler@@AEAA@PEAVCKernelTransport@@PEAVCConnection@@PEAVCoRenderHost@@@Z @ 0x180069120
 * Callers:
        ...
        struct CoRenderHost *a4)
{
  ...
  *(_QWORD *)((char *)this + 172) = 0x100000000LL;
  `vector constructor iterator'(
    (CPartitionVerticalBlankScheduler *)((char *)this + 216),
    0x530uLL,
    0x10uLL,
    (void *(*)(void *))CFrameInfo::CFrameInfo);
  CAnimationTracking::CAnimationTracking((CPartitionVerticalBlankScheduler *)((char *)this + 21832));
  CTelemetryTouchLatencyAnalysis::CTelemetryTouchLatencyAnalysis((CPartitionVerticalBlankScheduler *)((char *)this + 22408));
  CTelemetryTracking::CTelemetryTracking((CPartitionVerticalBlankScheduler *)((char *)this + 24728));
  CDebugFrameCounter::CDebugFrameCounter((CPartitionVerticalBlankScheduler *)((char *)this + 25480));
