/*
 * XREFs of ??$ChangePropertyValue@UD2DMatrix@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DMatrix@@@Z @ 0x180031678
 * Callers:
...
__int64 __fastcall CPropertyBag::ChangePropertyValue<D2DMatrix>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  int v8; // eax
  unsigned int v9; // esi
