/*
 * XREFs of ?InvalidateMCs@CManipulationContext@@SAXPEAUMCCollections@@PEAVCVisual@@PEAVCInteraction@@W4MidManipulationUpdateType@@PEAI@Z @ 0x180193228
 * Callers:
...
LABEL_6:
  ...
  else if ( a2 )
  {
    ...
    if ( !ManipulationContext )
      goto LABEL_34;
    if ( (*((_BYTE *)ManipulationContext + 200) & 2) != 0 && a2[10] )
    {
