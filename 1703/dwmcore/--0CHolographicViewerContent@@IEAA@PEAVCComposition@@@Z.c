/*
 * XREFs of ??0CHolographicViewerContent@@IEAA@PEAVCComposition@@@Z @ 0x1801A4E00
 * Callers:
...
CHolographicViewerContent *__fastcall CHolographicViewerContent::CHolographicViewerContent(
