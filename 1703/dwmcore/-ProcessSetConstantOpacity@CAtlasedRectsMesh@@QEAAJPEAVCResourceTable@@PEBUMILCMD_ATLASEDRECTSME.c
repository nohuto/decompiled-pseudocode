/*
 * XREFs of ?ProcessSetConstantOpacity@CAtlasedRectsMesh@@QEAAJPEAVCResourceTable@@PEBUMILCMD_ATLASEDRECTSMESH_SETCONSTANTOPACITY@@@Z @ 0x180023A88
 * Callers:
        ...
        const struct MILCMD_ATLASEDRECTSMESH_SETCONSTANTOPACITY *a3)
{
  ...
  {
    v3 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x2Eu);
  }
  return v3;
}
