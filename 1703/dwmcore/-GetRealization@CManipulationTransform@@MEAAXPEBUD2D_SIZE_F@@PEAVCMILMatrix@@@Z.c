/*
 * XREFs of ?GetRealization@CManipulationTransform@@MEAAXPEBUD2D_SIZE_F@@PEAVCMILMatrix@@@Z @ 0x180022E40
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)a3 + 16) = 0;
  if ( dword_18023D7F0 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18023D7F0, 1uLL) )
    {
      ...
      v43 = 4LL;
      v45 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_18023D7F0, &unk_1801F75B4, v8, v9, 0x12u, &pData);
      LODWORD(v9) = dword_18023D7F0;
    }
    if ( (unsigned int)v9 > 4 )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18023D7F0, 1uLL) )
      {
        ...
        v35 = 4LL;
        v37 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_18023D7F0, &unk_1801F7639, v11, v12, 0xEu, &pData);
      }
    }
  }
}
