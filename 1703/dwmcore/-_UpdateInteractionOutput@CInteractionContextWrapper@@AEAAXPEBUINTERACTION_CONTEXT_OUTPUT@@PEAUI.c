/*
 * XREFs of ?_UpdateInteractionOutput@CInteractionContextWrapper@@AEAAXPEBUINTERACTION_CONTEXT_OUTPUT@@PEAUInteractionOutput@@@Z @ 0x180190CC8
 * Callers:
  ...
  *((_DWORD *)a3 + 11) = *((_DWORD *)a2 + 4);
    ...
    && !CCommonRegistryData::m_cForceDisableInteractionOutputPrediction )
  {
    ...
    if ( !(unsigned int)GetPointerDeviceRects(v9, v21, v24) )
      v10 = 0LL;
    NtDCompositionGetFrameStatistics(v25, 0LL);
