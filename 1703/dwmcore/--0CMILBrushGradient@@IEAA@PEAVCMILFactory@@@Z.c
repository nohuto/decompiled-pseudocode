/*
 * XREFs of ??0CMILBrushGradient@@IEAA@PEAVCMILFactory@@@Z @ 0x1801B293C
 * Callers:
 *     ??0CLinearGradientLegacyMilBrush@@IEAA@PEAVCComposition@@@Z @ 0x180153354 (--0CLinearGradientLegacyMilBrush@@IEAA@PEAVCComposition@@@Z.c)
 * Callees:
 *     <none>
 */
