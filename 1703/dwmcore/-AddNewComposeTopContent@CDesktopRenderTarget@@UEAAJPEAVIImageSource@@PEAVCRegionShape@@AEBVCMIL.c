/*
 * XREFs of ?AddNewComposeTopContent@CDesktopRenderTarget@@UEAAJPEAVIImageSource@@PEAVCRegionShape@@AEBVCMILMatrix@@@Z @ 0x180146A00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x6F0u);
  return v4;
}
