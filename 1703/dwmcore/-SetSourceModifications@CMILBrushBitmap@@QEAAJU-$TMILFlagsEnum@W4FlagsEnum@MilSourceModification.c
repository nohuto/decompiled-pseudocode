/*
 * XREFs of ?SetSourceModifications@CMILBrushBitmap@@QEAAJU?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@PEBU_D3DCOLORVALUE@@1@Z @ 0x1800542F4
 * Callers:
 ...
 * Callees:
 *     ?IsNonEmpty@CColorKey@@QEBA_NXZ @ 0x18005A044 (-IsNonEmpty@CColorKey@@QEBA_NXZ.c)
 */
