/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____0_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1800BE170
 * Callers:
  ...
  if ( v5 )
  {
    do
    {
      ...
      *v17 = _mm_shuffle_ps(
      ...
      result = (__m128 *)(_mm_movemask_ps(_mm_cmpeq_ps(v27, DirectX::g_XMZero)) & 3);
      if ( (_BYTE)result == 3 )
      {
