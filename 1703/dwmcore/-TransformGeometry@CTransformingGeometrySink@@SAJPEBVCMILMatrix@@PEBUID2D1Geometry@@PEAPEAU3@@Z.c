/*
 * XREFs of ?TransformGeometry@CTransformingGeometrySink@@SAJPEBVCMILMatrix@@PEBUID2D1Geometry@@PEAPEAU3@@Z @ 0x1801B07B4
 * Callers:
        ...
        struct ID2D1Geometry **a3)
{
  ...
  v4 = D2DGeometry;
  if ( D2DGeometry < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, D2DGeometry, 0x4Du);
  return v4;
}
