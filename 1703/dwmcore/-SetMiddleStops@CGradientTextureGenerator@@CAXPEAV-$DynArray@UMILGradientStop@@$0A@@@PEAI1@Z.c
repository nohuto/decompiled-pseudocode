/*
 * XREFs of ?SetMiddleStops@CGradientTextureGenerator@@CAXPEAV?$DynArray@UMILGradientStop@@$0A@@@PEAI1@Z @ 0x1801C171C
 * Callers:
 ...
 * Callees:
 *     ?IsPositionLessThan@CGradientTextureGenerator@@CAHMM@Z @ 0x1801C11B0 (-IsPositionLessThan@CGradientTextureGenerator@@CAHMM@Z.c)
 */
