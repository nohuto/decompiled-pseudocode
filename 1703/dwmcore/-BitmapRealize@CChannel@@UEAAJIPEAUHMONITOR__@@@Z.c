/*
 * XREFs of ?BitmapRealize@CChannel@@UEAAJIPEAUHMONITOR__@@@Z @ 0x180138EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::BitmapRealize(CChannel *this, int a2, HMONITOR a3)
{
  unsigned int v6; // ebx
  _DWORD v8[2]; // [rsp+20h] [rbp-18h] BYREF
  HMONITOR v9; // [rsp+28h] [rbp-10h]
