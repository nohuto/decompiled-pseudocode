/*
 * XREFs of ?ProcessUpdate@CGaussianBlurEffect@@QEAAJPEAVCResourceTable@@PEBUMILCMD_GAUSSIANBLUREFFECT@@@Z @ 0x180002D74
 * Callers:
...
__int64 __fastcall CGaussianBlurEffect::ProcessUpdate(CGaussianBlurEffect *this, struct CResourceTable *a2, __m128 *a3)
{
  ...
  *((_DWORD *)this + 54) = v4;
  *((_DWORD *)this + 53) = _mm_cvtsi128_si32(_mm_srli_si128((__m128i)v5, 12));
