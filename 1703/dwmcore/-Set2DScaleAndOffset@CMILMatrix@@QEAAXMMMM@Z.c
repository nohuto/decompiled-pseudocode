/*
 * XREFs of ?Set2DScaleAndOffset@CMILMatrix@@QEAAXMMMM@Z @ 0x180011304
 * Callers:
...
void __fastcall CMILMatrix::Set2DScaleAndOffset(CMILMatrix *this, float a2, float a3, float a4, float a5)
{
  ...
  *((_BYTE *)this + 65) = 125;
  ...
  if ( v6 >= 0.00012207031 || (v7 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(a3 - 1.0)) & _xmm), v7 >= 0.00012207031) )
    v8 = v5 | 0x3C;
  else
    v8 = v5 & 0xC3 | 0x14;
  *((_BYTE *)this + 64) = v8;
