/*
 * XREFs of ?SetInformation@CRedirectedGDISurface@@QEAAJW4_RedirectGDISurfaceInformationClass@@KPEAX@Z @ 0x1800B0A9C
 * Callers:
...
__int64 __fastcall CRedirectedGDISurface::SetInformation(__int64 a1, int a2, unsigned int a3, unsigned int *a4)
{
  ...
  {
    SetLastError(0);
    if ( (unsigned int)DwmHLSurfSetSignalOnDirty(*(_QWORD *)(a1 + 24), 0LL, qword_180241A68, *a4) )
      return v4;
  ...
  if ( a3 < 0x20 )
  {
    ...
    v8 = -2147024872;
LABEL_22:
    MilInstrumentationCheckHR(0x14u, &dword_1801F3E08, 1u, v8, v10);
    return v4;
  }
  SetLastError(0);
