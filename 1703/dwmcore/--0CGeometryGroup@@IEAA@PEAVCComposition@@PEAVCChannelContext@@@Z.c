/*
 * XREFs of ??0CGeometryGroup@@IEAA@PEAVCComposition@@PEAVCChannelContext@@@Z @ 0x180153240
 * Callers:
        ...
        struct CResourceTable **a3)
{
  ...
  *((_BYTE *)this + 88) = 0;
  *((_DWORD *)this + 8) |= 1u;
  CCyclicResourceListEntry::CCyclicResourceListEntry((CGeometryGroup *)((char *)this + 104), a3[4]);
