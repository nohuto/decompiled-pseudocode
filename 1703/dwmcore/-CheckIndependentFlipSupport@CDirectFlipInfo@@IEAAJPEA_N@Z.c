/*
 * XREFs of ?CheckIndependentFlipSupport@CDirectFlipInfo@@IEAAJPEA_N@Z @ 0x180154DC8
 * Callers:
...
__int64 __fastcall CDirectFlipInfo::CheckIndependentFlipSupport(CDirectFlipInfo *this, bool *a2)
{
  ...
  v6 = (*(__int64 (__fastcall **)(__int64, bool *))(*(_QWORD *)v11 + 416LL))(v11, &v10);
  v2 = v6;
  if ( v6 < 0 )
  {
    v9 = 650;
LABEL_12:
  ...
  if ( v10 )
  {
    ...
    {
      v2 = -2147467259;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x296u);
      goto LABEL_8;
    }
    v3 = *((_DWORD *)RenderingRealizationNoRef + 60) != 3;
    v10 = v3;
  }
LABEL_7:
  *a2 = v3;
LABEL_8:
  ReleaseInterfaceNoNULL<CD2DPencil>(v11);
  return v2;
}
