/*
 * XREFs of ?SetCenter@CComponentTransform2D@@AEAAJMM@Z @ 0x1800AC424
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetCenter(CComponentTransform2D *this, double a2, double a3)
{
  ...
  if ( *((float *)this + 20) != *(float *)&a2 || *((float *)this + 21) != *(float *)&a3 )
  {
    ...
    *((_DWORD *)this + 21) = LODWORD(a3);
    ...
    v6 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 1LL, (const struct D2DVector2 *)&v7);
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x106u);
    else
