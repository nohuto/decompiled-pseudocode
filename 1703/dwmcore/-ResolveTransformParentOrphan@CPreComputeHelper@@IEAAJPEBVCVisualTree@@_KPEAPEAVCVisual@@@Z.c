/*
 * XREFs of ?ResolveTransformParentOrphan@CPreComputeHelper@@IEAAJPEBVCVisualTree@@_KPEAPEAVCVisual@@@Z @ 0x1801B407C
 * Callers:
        ...
        struct CVisual **a4)
{
  ...
  *a4 = 0LL;
  while ( *v5 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x132u);
      return v4;
    }
    v10 = v15;
