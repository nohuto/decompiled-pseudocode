/*
 * XREFs of ?AnimationTelemetrySetAnimationScenarioGUID@CChannel@@UEAAJIAEBU_GUID@@@Z @ 0x180138CE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::AnimationTelemetrySetAnimationScenarioGUID(CChannel *this, int a2, const struct _GUID *a3)
{
  __int128 v6; // xmm0
  unsigned int v7; // ebx
