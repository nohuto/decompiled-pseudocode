/*
 * XREFs of ??R?$_Uhash_compare@UEffectDescriptionKey@@U?$hash@UEffectDescriptionKey@@@std@@U?$equal_to@UEffectDescriptionKey@@@3@@std@@QEBA_NAEBUEffectDescriptionKey@@0@Z @ 0x180002904
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( *(_DWORD *)a2 != *(_DWORD *)a3 )
    return 1;
  v3 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(a2 + 8) + 120LL))(
         *(_QWORD *)(a2 + 8),
         *(_QWORD *)(a3 + 8));
  v4 = 0;
  if ( !v3 )
