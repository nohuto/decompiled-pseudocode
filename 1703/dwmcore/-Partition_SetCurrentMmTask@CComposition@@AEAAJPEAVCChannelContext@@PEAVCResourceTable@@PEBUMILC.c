/*
 * XREFs of ?Partition_SetCurrentMmTask@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_PARTITION_SETCURRENTMMTASK@@@Z @ 0x18005C754
 * Callers:
        ...
        const struct MILCMD_PARTITION_SETCURRENTMMTASK *a4)
{
  ...
  v15[8] = v11;
  v12 = CMmcssTask::Set((CComposition *)((char *)this + 160), (const struct DWM_MMTASK *)v15, 1);
  v13 = v12;
  if ( v12 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x5A6u);
  else
