/*
 * XREFs of ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800C780C
 * Callers:
...
char __fastcall CCommonRegistryData::IsShaderLinkingBlacklistedGpu(const char *a1, unsigned __int16 a2)
{
  ...
  {
    v2 = (struct CCommonRegistryData::GpuId *)&unk_1801FD070;
    LODWORD(CCommonRegistryData::m_cShaderLinkingBlacklistedGpuIds) = 0;
    CCommonRegistryData::m_rgwShaderLinkingBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_1801FD070;
    v6 = 0;
  }
  if ( !v6 )
    return 0;
