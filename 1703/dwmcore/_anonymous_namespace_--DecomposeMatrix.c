/*
 * XREFs of _anonymous_namespace_::DecomposeMatrix @ 0x18018E454
 * Callers:
 ...
 * Callees:
 *     ?Set2DRotation@CMILMatrix@@QEAAXMMM@Z @ 0x180012018 (-Set2DRotation@CMILMatrix@@QEAAXMMM@Z.c)
 ...
 *     TransformPoint @ 0x1801B23A4 (TransformPoint.c)
 */
  ...
  *((_DWORD *)a6 + 16) = *((_DWORD *)v10 + 16);
  ...
  if ( dword_18023D7F0 > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_18023D7F0, 2uLL) )
    {
      ...
      v148 = v22;
      v150 = v22;
      TlgWrite(v20, &unk_1801F8EAA, v21, v22, 0x25u, &pData);
    }
  }
}
