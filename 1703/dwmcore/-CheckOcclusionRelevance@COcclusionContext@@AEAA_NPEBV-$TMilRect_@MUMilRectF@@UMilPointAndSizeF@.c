/*
 * XREFs of ?CheckOcclusionRelevance@COcclusionContext@@AEAA_NPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18009AF48
 * Callers:
...
char __fastcall COcclusionContext::CheckOcclusionRelevance(__int64 a1, float *a2)
{
  ...
  if ( v4 )
    v3 = *(_DWORD *)(*(_QWORD *)(a1 + 1000) + 4LL * (unsigned int)(v4 - 1));
  v7 = *(_DWORD *)(a1 + 552);
  v8 = 0;
  if ( v7 )
  {
    for ( i = (float *)(a1 + 684); ((v3 >> v8) & 1) == 0 || v6 <= (float)(*i * 0.25); ++i )
    {
      if ( ++v8 >= v7 )
        return v2;
    }
