/*
 * XREFs of ?HrFindInterface@CDxHandleAdvancedDirectFlipBitmapRealization@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801B55E0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      *a3 = (void *)(((unsigned __int64)this + 424) & -(__int64)(this != 0LL));
      return 0LL;
    }
  }
  return result;
