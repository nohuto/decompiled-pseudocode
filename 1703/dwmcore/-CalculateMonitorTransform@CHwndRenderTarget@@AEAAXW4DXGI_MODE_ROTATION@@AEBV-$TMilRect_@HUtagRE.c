/*
 * XREFs of ?CalculateMonitorTransform@CHwndRenderTarget@@AEAAXW4DXGI_MODE_ROTATION@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMILSurfaceRect_@RectUniqueness@@@@1PEAU?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@@Z @ 0x18006C0D4
 * Callers:
        ...
        const struct tagRECT *a4)
{
  ...
  v8 = *(unsigned __int8 (__fastcall **)(CHwndRenderTarget *))(*(_QWORD *)this + 176LL);
  v17[0] = _xmm;
  v18 = 32085;
  v17[1] = _xmm;
  v17[2] = _xmm;
