/*
 * XREFs of ?GetSize@CBitmapLock@@UEAAJPEAI0@Z @ 0x18007EA30
 * Callers:
 *     ?CopyPixels@CBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x180055D30 (-CopyPixels@CBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z.c)
 *     ?GetSize@CBitmapLock@@W7EAAJPEAI0@Z @ 0x1800D6710 (-GetSize@CBitmapLock@@W7EAAJPEAI0@Z.c)
 * Callees:
...
__int64 __fastcall CBitmapLock::GetSize(CBitmapLock *this, unsigned int *a2, unsigned int *a3)
{
  ...
  if ( a2 )
  {
    if ( a3 )
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x7Du);
      }
    }
    else
    {
  ...
  {
    v6 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0x7Au);
  }
