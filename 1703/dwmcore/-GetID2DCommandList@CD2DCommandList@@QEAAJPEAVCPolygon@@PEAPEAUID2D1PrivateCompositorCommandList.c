/*
 * XREFs of ?GetID2DCommandList@CD2DCommandList@@QEAAJPEAVCPolygon@@PEAPEAUID2D1PrivateCompositorCommandList@@@Z @ 0x1800AF840
 * Callers:
...
LABEL_12:
  ...
  if ( v7 == -1 )
  {
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v22, 0x51u);
      goto LABEL_7;
    }
