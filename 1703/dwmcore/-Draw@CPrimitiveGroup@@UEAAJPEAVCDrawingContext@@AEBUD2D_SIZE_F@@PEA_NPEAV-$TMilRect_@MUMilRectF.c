/*
 * XREFs of ?Draw@CPrimitiveGroup@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18000C830
 * Callers:
...
__int64 __fastcall CPrimitiveGroup::Draw(CPrimitiveGroup *a1, __int64 a2, struct D2D_SIZE_F *a3, bool *a4, float *a5)
{
