/*
 * XREFs of ?DrawPerspectiveBitmap@CD2DContext@@MEAAJPEBVID2DContextOwner@@PEAUID2D1Bitmap1@@PEBUD2D_RECT_F@@2MW4D2D1_ANTIALIAS_MODE@@W4D2D1_INTERPOLATION_MODE@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x180198B30
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_PRIMITIVE_BLEND a9)
{
  ...
  (*(void (__fastcall **)(_QWORD, struct ID2D1Bitmap1 *, const struct D2D_RECT_F *))(**((_QWORD **)this + 22) + 680LL))(
    *((_QWORD *)this + 22),
    a3,
    a5);
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
