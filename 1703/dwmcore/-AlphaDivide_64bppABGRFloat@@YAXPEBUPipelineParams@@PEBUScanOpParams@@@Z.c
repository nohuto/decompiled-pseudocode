/*
 * XREFs of ?AlphaDivide_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x1801AD010
 * Callers:
 *     <none>
 * Callees:
 *     ??BCFloat16@@QEAAMXZ @ 0x1801A1560 (--BCFloat16@@QEAAMXZ.c)
 */
...
void __fastcall AlphaDivide_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( v2 )
  {
    ...
    do
    {
      ...
      if ( v4 != CFloat16::operator float((unsigned __int16 *)&word_18023E918) )
      {
        v5 = CFloat16::operator float(v3);
        if ( v5 != CFloat16::operator float((unsigned __int16 *)&word_1802419C8) )
        {
