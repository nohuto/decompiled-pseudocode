/*
 * XREFs of ?InsertAt@?$DynArray@UOverlayPlaneInfo@COverlayContext@@$0A@@@QEAAJAEBUOverlayPlaneInfo@COverlayContext@@I@Z @ 0x18015115C
 * Callers:
      ...
      *(_DWORD *)(a1 + 24) = v7 + 1;
      if ( (unsigned int)v7 > (unsigned int)v4 )
      {
        ...
        do
        {
          v10 = v9 + 8;
          LODWORD(v7) = v7 - 1;
          v11 = (_OWORD *)(v8 + 240LL * (unsigned int)v7);
          v12 = v11[1];
          *v9 = *v11;
          v13 = v11[2];
          v9[1] = v12;
      ...
      v25 = v31;
      v26 = (_OWORD *)(v8 + 240 * v4);
      if ( v31 >= v26 && (unsigned __int64)v31 < 240 * (unsigned __int64)*(unsigned int *)(a1 + 24) + v8 - 240 )
        v25 = v31 + 15;
      *v26 = *v25;
      v26[1] = v25[1];
      v26[2] = v25[2];
