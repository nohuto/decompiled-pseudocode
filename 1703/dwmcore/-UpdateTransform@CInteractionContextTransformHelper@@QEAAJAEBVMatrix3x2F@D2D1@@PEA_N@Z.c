/*
 * XREFs of ?UpdateTransform@CInteractionContextTransformHelper@@QEAAJAEBVMatrix3x2F@D2D1@@PEA_N@Z @ 0x180134CB0
 * Callers:
 ...
 *     GetInverse @ 0x1801B1A14 (GetInverse.c)
 *     IsEqualMatrix @ 0x1801B1B94 (IsEqualMatrix.c)
 */
