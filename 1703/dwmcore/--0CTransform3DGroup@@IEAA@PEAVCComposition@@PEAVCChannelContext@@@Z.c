/*
 * XREFs of ??0CTransform3DGroup@@IEAA@PEAVCComposition@@PEAVCChannelContext@@@Z @ 0x1801534E0
 * Callers:
        ...
        struct CResourceTable **a3)
{
  ...
  *((_DWORD *)this + 8) |= 1u;
  *((_BYTE *)this + 148) = 0;
  CCyclicResourceListEntry::CCyclicResourceListEntry((CTransform3DGroup *)((char *)this + 152), a3[4]);
