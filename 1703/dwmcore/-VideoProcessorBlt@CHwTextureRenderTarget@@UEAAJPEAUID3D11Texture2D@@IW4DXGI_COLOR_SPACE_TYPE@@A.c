/*
 * XREFs of ?VideoProcessorBlt@CHwTextureRenderTarget@@UEAAJPEAUID3D11Texture2D@@IW4DXGI_COLOR_SPACE_TYPE@@AEBUtagRECT@@2@Z @ 0x18019C130
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagRECT *a6)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x2A7u);
  }
  else
  {
    ...
    v12 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x2B2u);
  }
  if ( v18 )
