/*
 * XREFs of ?Initialize@CCustomBlur@@AEAAJPEAUID2D1DeviceContext@@@Z @ 0x18001B3D8
 * Callers:
...
__int64 __fastcall CCustomBlur::Initialize(CCustomBlur *this, struct ID2D1DeviceContext *a2)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x3Bu);
    return v7;
  }
  v12 = *v9;
  v30 = 1;
  ...
  if ( v6 < 0 )
  {
    v29 = 77;
LABEL_37:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, v29);
    return v7;
  }
