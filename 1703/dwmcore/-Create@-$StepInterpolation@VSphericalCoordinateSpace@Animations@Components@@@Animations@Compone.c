/*
 * XREFs of ?Create@?$StepInterpolation@VSphericalCoordinateSpace@Animations@Components@@@Animations@Components@@SAJHHH_N0PEAPEAVInterpolation@23@@Z @ 0x1801B8800
 * Callers:
...
__int64 __fastcall Components::Animations::StepInterpolation<Components::Animations::SphericalCoordinateSpace>::Create(
        int a1,
        int a2,
        int a3,
        unsigned __int8 a4,
...
LABEL_20:
  ...
  if ( v12 )
  {
    ...
    *((_DWORD *)v13 + 2) = 1;
    *(_QWORD *)v13 = &Components::Animations::StepInterpolation<Components::Animations::SphericalCoordinateSpace>::`vftable';
  }
  else
  {
    v13 = 0LL;
