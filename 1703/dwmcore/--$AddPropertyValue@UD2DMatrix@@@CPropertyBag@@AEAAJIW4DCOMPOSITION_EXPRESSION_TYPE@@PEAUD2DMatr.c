/*
 * XREFs of ??$AddPropertyValue@UD2DMatrix@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DMatrix@@@Z @ 0x18003176C
 * Callers:
...
__int64 __fastcall CPropertyBag::AddPropertyValue<D2DMatrix>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  unsigned int v4; // edi
  _QWORD *inserted; // r13
  char *v10; // rax
