/*
 * XREFs of ?BeginRender@CoRenderHost@@QEAAJPEAUHMONITOR__@@PEAVCD3DSurface@@AEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18013AFE0
 * Callers:
        ...
        float *a5)
{
  ...
  else
  {
    ...
    v20 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD, __int64, _DWORD *))(*(_QWORD *)v10 + 72LL))(
            v10,
            a2,
            *(_QWORD *)(*((_QWORD *)a1 + 4) + 136LL),
            *(_QWORD *)(*((_QWORD *)a1 + 4) + 200LL),
            a4,
            v23);
    v9 = v20;
    if ( v20 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v20, 0xD3u);
  }
  return v9;
}
