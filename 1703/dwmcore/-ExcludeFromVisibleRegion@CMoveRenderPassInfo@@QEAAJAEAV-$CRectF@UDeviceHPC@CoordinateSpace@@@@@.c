/*
 * XREFs of ?ExcludeFromVisibleRegion@CMoveRenderPassInfo@@QEAAJAEAV?$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z @ 0x1800D12A0
 * Callers:
...
__int64 __fastcall CMoveRenderPassInfo::ExcludeFromVisibleRegion(CMoveRenderPassInfo *this, float *a2, double a3)
{
  ...
  {
    if ( *((_QWORD *)this + 1)
      || (SetLastError(0), v18 = CreateRectRgn(0, 0, 0, 0), (*((_QWORD *)this + 1) = v18) != 0LL) )
    {
      SetLastError(0);
