/*
 * XREFs of ?ProcessSetRoot@CRenderTarget@@UEAAJPEAVCResourceTable@@PEBUMILCMD_TARGET_SETROOT@@@Z @ 0x1800B4BB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct MILCMD_TARGET_SETROOT *a3)
{
  ...
  {
    v8 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x89u);
  }
  else
  {
    ...
    v8 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x8Du);
  }
  return v8;
}
