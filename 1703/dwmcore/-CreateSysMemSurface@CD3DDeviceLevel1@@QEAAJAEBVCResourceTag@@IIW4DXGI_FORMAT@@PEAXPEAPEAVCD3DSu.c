/*
 * XREFs of ?CreateSysMemSurface@CD3DDeviceLevel1@@QEAAJAEBVCResourceTag@@IIW4DXGI_FORMAT@@PEAXPEAPEAVCD3DSurface@@@Z @ 0x1801964D4
 * Callers:
        ...
        struct CD3DSurface **a7)
{
  ...
  *a7 = 0LL;
  ...
  v11[8] = 8;
  v11[9] = 0x10000;
  v8 = CD3DSurface::Create(this + 116, (const struct DWM_TEXTURE2D_DESC *)v11, 0LL, a7);
  v9 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x841u);
  return v9;
}
