/*
 * XREFs of ?CreateFromSharedHandle@CD2DBitmap@@SAJAEBU_GUID@@U_LUID@@PEAXW4D2D1_ALPHA_MODE@@MMVDisplayId@@PEAPEAV1@@Z @ 0x18007CACC
 * Callers:
        ...
        _QWORD *a8)
{
  ...
  v11[0] = 0LL;
  v8 = CD3DDeviceManager::OpenSharedHandleAsD2DBitmap((__int64)&qword_18023E820, a1, a2, a3, a4, a5, a6, a7, v11);
  v9 = v8;
  if ( v8 < 0 )
  {
