/*
 * XREFs of ?TransformEdgeFlags_AxisAlignedPreserving@D2DMatrixHelper@@YAIIAEBUD2D_MATRIX_3X2_F@@@Z @ 0x1801AE374
 * Callers:
        ...
        const struct D2D_MATRIX_3X2_F *a3)
{
  ...
  else
  {
    ...
    v28[7] = 0x20000;
    if ( v4 >= 0.00012207031 || (v5 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64(a2[2]) & _xmm), v5 >= 0.00012207031) )
    {
      v12 = a2[2];
      v13 = 3;
      if ( v12 > 0.0 )
