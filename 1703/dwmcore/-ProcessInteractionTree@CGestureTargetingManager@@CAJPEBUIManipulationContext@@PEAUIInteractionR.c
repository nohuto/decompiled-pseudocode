/*
 * XREFs of ?ProcessInteractionTree@CGestureTargetingManager@@CAJPEBUIManipulationContext@@PEAUIInteractionResource@@KPEAUInteractionAxisGroup@@2PEAV?$DynArray@PEAUInteractionConfigurationGroup@@$0A@@@PEAUInteractionAxis@@PEAW4InteractionState@@PEAPEAU3@6@Z @ 0x1801953E0
 * Callers:
        ...
        _QWORD *a10)
{
  ...
  *a10 = 0LL;
  ...
  if ( v17 >= 0 )
  {
    v17 = ((__int64 (__fastcall *)(__int64 (__fastcall ***)(_QWORD), __int64, __int64, int *, __int64, int *, __int64, unsigned int *))(*a2)[3])(
            a2,
            v32,
            v34,
            &v28,
