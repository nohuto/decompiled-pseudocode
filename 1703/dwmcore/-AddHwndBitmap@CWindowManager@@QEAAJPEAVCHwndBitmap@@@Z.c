/*
 * XREFs of ?AddHwndBitmap@CWindowManager@@QEAAJPEAVCHwndBitmap@@@Z @ 0x1801446E0
 * Callers:
...
__int64 __fastcall CWindowManager::AddHwndBitmap(CWindowManager *this, struct CHwndBitmap *a2)
{
  ...
  v21 = 0LL;
  if ( (int)CWindowManager::FindEntry(this, *((_QWORD *)a2 + 58), &v21) < 0 )
  {
...
LABEL_34:
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, v20);
    goto LABEL_34;
  }
  v4 = v21;
  v5 = *((_QWORD *)v21 + 2);
