/*
 * XREFs of ?CheckAndNotifyFullScreenSwapChain@COverlayContext@@QEAAJPEAVISwapChainContent@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18014EC64
 * Callers:
...
__int64 __fastcall COverlayContext::CheckAndNotifyFullScreenSwapChain(COverlayContext *this, __int64 a2, float *a3)
{
  ...
  *(float *)&v10 = v10 + 6291456.25;
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, updated, 0x342u);
  }
