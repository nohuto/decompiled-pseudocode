/*
 * XREFs of ?GetD2DBitmapRealization@CCommandListBitmapRepresentation@@AEAAJPEAVID2DContextOwner@@PEAPEAUID2D1Bitmap@@@Z @ 0x18000A068
 * Callers:
        ...
        struct ID2D1Bitmap **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, D2DBitmapRealizationForContextOwner, 0x11Au);
  }
  else
  {
    if ( !v9 )
