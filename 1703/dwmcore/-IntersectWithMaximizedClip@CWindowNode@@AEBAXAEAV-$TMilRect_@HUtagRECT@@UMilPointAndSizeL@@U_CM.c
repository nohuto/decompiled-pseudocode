/*
 * XREFs of ?IntersectWithMaximizedClip@CWindowNode@@AEBAXAEAV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x1800501A0
 * Callers:
...
char __fastcall CWindowNode::IntersectWithMaximizedClip(__int64 a1, LONG *a2)
{
  ...
  LOBYTE(v4) = AreAllMarginsZero((const struct _MARGINS *)(a1 + 880));
  if ( !(_BYTE)v4 )
  {
    v6 = *(_DWORD *)(a1 + 888) + *(_DWORD *)(a1 + 608);
    v7 = *(_DWORD *)(a1 + 616) - *(_DWORD *)(a1 + 892);
    v8 = *v5 + *(_DWORD *)(a1 + 604);
    rcSrc1.right = *(_DWORD *)(a1 + 612) - *(_DWORD *)(a1 + 884);
    rcSrc1.top = v6;
    rcSrc1.bottom = v7;
    rcSrc1.left = v8;
    IntersectRect(&rcSrc1, &rcSrc1, (const RECT *)(a1 + 652));
    v4 = EqualRect(&rcSrc1, (const RECT *)(a1 + 652));
    if ( !v4 )
    {
      OffsetRect(&rcSrc1, -*(_DWORD *)(a1 + 652), -*(_DWORD *)(a1 + 656));
      if ( rcSrc1.left > *a2 )
        *a2 = rcSrc1.left;
      if ( rcSrc1.top > a2[1] )
        a2[1] = rcSrc1.top;
