/*
 * XREFs of ?ProcessAddSurfaceResources@CPrimitiveGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PRIMITIVEGROUP_ADDSURFACERESOURCES@@PEBXI@Z @ 0x18004CC48
 * Callers:
        ...
        unsigned int a5)
{
  ...
  void (*v18)(void); // rax
  int v20; // eax
  CBitmapOfDeviceBitmaps *v21; // [rsp+70h] [rbp+18h] BYREF
  ...
  if ( *((_DWORD *)a3 + 2) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !ResourceWithoutType )
        break;
      v14 = *(_BOOL8 (__fastcall **)(__int64, int))(*(_QWORD *)ResourceWithoutType + 48LL);
      if ( !(v14 == CCompositionSurfaceBitmap::IsOfType ? CCompositionSurfaceBitmap::IsOfType(v13, 97) : v14(v13, 97)) )
        break;
      ...
      {
        v20 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 168, 8LL, 1LL, &v21);
        v5 = v20;
        if ( v20 < 0 )
      ...
      if ( v5 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x113u);
        goto LABEL_17;
      }
      v18 = *(void (**)(void))(*(_QWORD *)v21 + 8LL);
      if ( (char *)v18 == (char *)CBitmapOfDeviceBitmaps::AddRef )
        CBitmapOfDeviceBitmaps::AddRef(v21);
      else
        v18();
      ++a4;
    ...
    v5 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x10Bu);
    goto LABEL_27;
  }
LABEL_16:
