/*
 * XREFs of ?AddAntiOccluderRect@CArrayBasedCoverageSet@@UEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@H@Z @ 0x18015A7A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CArrayBasedCoverageSet::AddAntiOccluderRect(__int64 a1, __int128 *a2, int a3)
{
  __int128 v3; // xmm0
  __int64 v4; // r10
  __int64 v5; // rcx
  ...
  {
    v11 = DynArrayImpl<0>::AddMultipleAndSet(v4, 0x14u, 1, &v14);
    v8 = v11;
    if ( v11 < 0 )
