/*
 * XREFs of ??0CLinearGradientLegacyMilBrush@@IEAA@PEAVCComposition@@@Z @ 0x180153354
 * Callers:
 ...
 * Callees:
 *     ??0CMILBrushGradient@@IEAA@PEAVCMILFactory@@@Z @ 0x1801B293C (--0CMILBrushGradient@@IEAA@PEAVCMILFactory@@@Z.c)
 */
