/*
 * XREFs of Template_xxqqhhqqxxqqz @ 0x18014189C
 * Callers:
...
ULONG Template_xxqqhhqqxxqqz(__int64 a1, __int64 a2, ...)
{
  ...
  __int64 v34; // [rsp+138h] [rbp+38h] BYREF
  ...
  va_list va11; // [rsp+188h] [rbp+88h]
  const wchar_t *v56; // [rsp+190h] [rbp+90h]
  va_list va12; // [rsp+198h] [rbp+98h] BYREF
