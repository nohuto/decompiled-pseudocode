/*
 * XREFs of ?AddBlockData@CDataStreamWriter@@QEAAJPEBXI@Z @ 0x18008336C
 * Callers:
 ...
 *     ?GetWritePointer@CDataStreamBlock@@UEAAPEAEXZ @ 0x180083860 (-GetWritePointer@CDataStreamBlock@@UEAAPEAEXZ.c)
