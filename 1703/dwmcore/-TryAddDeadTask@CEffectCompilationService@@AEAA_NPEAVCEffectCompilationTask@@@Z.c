/*
 * XREFs of ?TryAddDeadTask@CEffectCompilationService@@AEAA_NPEAVCEffectCompilationTask@@@Z @ 0x18000518C
 * Callers:
        ...
        struct CEffectCompilationTask *a2)
{
  ...
  v3 = (char *)this + 176;
  v4 = *((_QWORD *)this + 22);
  v5 = *((_QWORD *)this + 25) + *((_QWORD *)this + 26);
  v6 = *((_QWORD *)v3 + 3) + *((_QWORD *)v3 + 4);
  v9[1] = 0LL;
  v8[2] = v5;
  v9[2] = *((_QWORD *)v3 + 3);
  v8[0] = v4;
