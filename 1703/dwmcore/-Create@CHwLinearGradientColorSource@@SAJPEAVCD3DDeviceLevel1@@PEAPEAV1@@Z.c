/*
 * XREFs of ?Create@CHwLinearGradientColorSource@@SAJPEAVCD3DDeviceLevel1@@PEAPEAV1@@Z @ 0x1801A2E74
 * Callers:
        ...
        struct CHwLinearGradientColorSource **a2)
{
  ...
  v4 = 0;
  v5 = (CHwLinearGradientColorSource *)HeapAlloc(WPF::g_processHeap, 0, 0x128uLL);
  if ( !v5 )
  {
