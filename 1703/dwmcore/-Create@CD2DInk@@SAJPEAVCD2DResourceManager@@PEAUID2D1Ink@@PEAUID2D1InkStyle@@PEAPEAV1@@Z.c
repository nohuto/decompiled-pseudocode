/*
 * XREFs of ?Create@CD2DInk@@SAJPEAVCD2DResourceManager@@PEAUID2D1Ink@@PEAUID2D1InkStyle@@PEAPEAV1@@Z @ 0x180001520
 * Callers:
        ...
        struct CD2DInk **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v9 )
  {
    ...
    *((_QWORD *)v10 + 13) = 0LL;
    *((_QWORD *)v10 + 2) = &CSecondaryD2DBitmap::`vftable'{for `IDeviceResource'};
