/*
 * XREFs of ?SetProperty@CInteractionTracker@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x18016E100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CInteractionTracker::SetProperty(CInteractionTracker *a1, int a2, int a3, float *a4)
{
  ...
  v10 = -2147024809;
  MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0x52Du);
  return v10;
}
