/*
 * XREFs of ?CreateD2DInk@CSwRenderTargetGetBounds@@UEAAJAEBUD2D1_INK_POINT@@AEBUD2D1_INK_STYLE_PROPERTIES@@PEAPEAVCD2DInk@@@Z @ 0x18019A230
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CD2DInk **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, FirstAvailableD2DContext, 0x161u);
  }
  else
  {
