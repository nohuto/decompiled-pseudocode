/*
 * XREFs of ?RenderLayer@CColorTransformLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x180158434
 * Callers:
...
__int64 __fastcall CColorTransformLayer::RenderLayer(CColorTransformLayer *this, struct CDrawingContext *a2)
{
  ...
  *(float *)&v30[2] = (float)*((int *)this + 6);
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x6Au);
  }
  else
  {
    v10 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64 *))(**((_QWORD **)a2 + 49) + 256LL))(
            *((_QWORD *)a2 + 49),
            1LL,
            &v25);
    v9 = v10;
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            v22 = CDrawingContext::FillEffect(a2, v25, (__int64)v30, (__int64)v28, 1);
            v9 = v22;
            if ( v22 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0, v22, 0xCAu);
            }
