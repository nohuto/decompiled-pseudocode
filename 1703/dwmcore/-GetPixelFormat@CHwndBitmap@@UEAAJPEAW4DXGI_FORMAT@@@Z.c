/*
 * XREFs of ?GetPixelFormat@CHwndBitmap@@UEAAJPEAW4DXGI_FORMAT@@@Z @ 0x180164C00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwndBitmap::GetPixelFormat(CHwndBitmap *this, enum DXGI_FORMAT *a2)
{
  ...
  v2 = (CCachedVisualImage *)*((_QWORD *)this + 62);
  v3 = 0;
  if ( v2 )
  {
    ...
    v3 = PixelFormat;
    if ( PixelFormat < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, PixelFormat, 0x208u);
  }
  else
  {
