/*
 * XREFs of ?Append_Convert@ScanPipelineBuilder@@QEAAJPEBUPixelFormatInfo@@0W4Subpipe@1@@Z @ 0x1801AC238
 * Callers:
 ...
 *     ?GetNearestInterchangeFormat@@YA?AW4DXGI_FORMAT@@W41@@Z @ 0x1801AC6D0 (-GetNearestInterchangeFormat@@YA-AW4DXGI_FORMAT@@W41@@Z.c)
 *     ?GetOp_AlphaDivide@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z @ 0x1801AC6F4 (-GetOp_AlphaDivide@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z.c)
 *     ?GetOp_AlphaMultiply@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z @ 0x1801AC738 (-GetOp_AlphaMultiply@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z.c)
 *     ?GetOp_IgnoreAlpha@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z @ 0x1801AC77C (-GetOp_IgnoreAlpha@@YAP6AXPEBUPipelineParams@@PEBUScanOpParams@@@ZW4DXGI_FORMAT@@@Z.c)
 */
...
__int64 __fastcall ScanPipelineBuilder::Append_Convert(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)a2 == *(_DWORD *)a3 )
  {
    if ( *(_DWORD *)(a3 + 4) == 3 )
    {
      ...
      if ( Op_IgnoreAlpha )
      {
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v24, 0x205u);
          return v6;
        }
      }
    }
    else if ( *(_DWORD *)(a3 + 4) == 1 )
    {
      ...
      if ( Op_AlphaDivide )
      {
        ...
        if ( v27 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v27, 0x20Eu);
          return v6;
        }
      }
    }
  ...
  else
  {
    ...
    if ( *(_DWORD *)(v10 + 4) == 3 )
    {
      ...
      if ( v12 )
      {
        ...
        if ( v13 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x1C4u);
          return v6;
        }
      }
    }
    ...
    if ( *(_DWORD *)a3 != v11 )
    {
      ...
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v18, 0x1DDu);
        return v6;
      }
    }
    ...
    if ( appended < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, appended, 0x1E5u);
      return v6;
    }
      ...
      && (*(_DWORD *)a2 != 88 || NearestInterchangeFormat != DXGI_FORMAT_B8G8R8A8_UNORM) )
    {
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v21, 0x1F7u);
        return v6;
      }
    }
  }
  if ( *(_DWORD *)(a2 + 4) == 3 )
  {
    ...
    if ( v28 )
    {
      ...
      v6 = v30;
      if ( v30 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v30, 0x21Cu);
    }
  }
  else if ( *(_DWORD *)(a2 + 4) == 1 )
  {
    ...
    if ( Op_AlphaMultiply )
    {
      ...
      v6 = v33;
      if ( v33 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v33, 0x227u);
    }
  }
  return v6;
}
