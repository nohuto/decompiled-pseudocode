/*
 * XREFs of ??$ChangePropertyValue@UD2DVector3@@@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEAUD2DVector3@@@Z @ 0x1800230D4
 * Callers:
...
__int64 __fastcall CPropertyBag::ChangePropertyValue<D2DVector3>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  int v8; // eax
  unsigned int v9; // esi
