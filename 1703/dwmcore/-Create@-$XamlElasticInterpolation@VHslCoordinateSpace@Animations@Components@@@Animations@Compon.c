/*
 * XREFs of ?Create@?$XamlElasticInterpolation@VHslCoordinateSpace@Animations@Components@@@Animations@Components@@SAJW4Dwm__InterpolationMode@23@HMPEAPEAVInterpolation@23@@Z @ 0x1801B8E98
 * Callers:
...
__int64 __fastcall Components::Animations::XamlElasticInterpolation<Components::Animations::HslCoordinateSpace>::Create(
        unsigned int a1,
        int a2,
        float a3,
        float **a4)
{
  ...
  if ( v9 )
  {
    ...
    *((_DWORD *)v10 + 2) = 1;
    *(_QWORD *)v10 = &Components::Animations::XamlElasticInterpolation<Components::Animations::HslCoordinateSpace>::`vftable';
  }
  else
  {
    v10 = 0LL;
