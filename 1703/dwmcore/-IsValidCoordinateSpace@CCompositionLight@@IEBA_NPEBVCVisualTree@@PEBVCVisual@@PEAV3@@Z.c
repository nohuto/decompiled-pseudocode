/*
 * XREFs of ?IsValidCoordinateSpace@CCompositionLight@@IEBA_NPEBVCVisualTree@@PEBVCVisual@@PEAV3@@Z @ 0x180172F58
 * Callers:
        ...
        struct CVisual *a4)
{
  ...
  {
    v10 = 0;
    if ( (int)CVisual::GetWorldTransform(a4, (__int64)a2, 3, (__int64)v9, 0LL, 0LL) >= 0 )
    {
