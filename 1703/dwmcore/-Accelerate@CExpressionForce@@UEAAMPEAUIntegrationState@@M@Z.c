/*
 * XREFs of ?Accelerate@CExpressionForce@@UEAAMPEAUIntegrationState@@M@Z @ 0x180188C80
 * Callers:
 *     <none>
 * Callees:
...
float __fastcall CExpressionForce::Accelerate(CExpressionForce *this, struct IntegrationState *a2, float a3)
{
  ...
  v3 = *((_QWORD *)this + 12);
  v4 = (struct CExpressionValueStack *)*((_QWORD *)this + 11);
  v5 = (CConditionalExpression *)*((_QWORD *)this + 9);
  v7 = 0.0;
