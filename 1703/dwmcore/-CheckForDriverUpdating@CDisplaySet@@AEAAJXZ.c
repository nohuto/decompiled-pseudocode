/*
 * XREFs of ?CheckForDriverUpdating@CDisplaySet@@AEAAJXZ @ 0x1800B7174
 * Callers:
...
__int64 __fastcall CDisplaySet::CheckForDriverUpdating(CDisplaySet *this)
{
  ...
  *((_BYTE *)this + 112) = 0;
  while ( (unsigned int)v2 < *((_DWORD *)this + 18) )
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, AdapterNoRefFromLuid, 0x15Bu);
    }
    else
    {
      v8 = v15;
      v6[31].LowPart = *((_DWORD *)v15 + 74);
      v6[31].HighPart = *((_DWORD *)v8 + 75);
    }
    if ( v1 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v1, 0x51Cu);
    ...
    *((_BYTE *)this + 112) = 0;
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0xADu);
    }
    else
    {
      if ( !v16 )
