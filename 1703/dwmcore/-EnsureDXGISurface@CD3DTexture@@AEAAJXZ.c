/*
 * XREFs of ?EnsureDXGISurface@CD3DTexture@@AEAAJXZ @ 0x180045798
 * Callers:
...
__int64 __fastcall CD3DTexture::EnsureDXGISurface(CD3DTexture *this)
{
  ...
  {
    v2 = -2003292412;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003292412, 0x2B2u);
    goto LABEL_5;
  }
  if ( *((_QWORD *)this + 27) )
    goto LABEL_5;
  ...
  if ( *((_DWORD *)this + 37) == 1 )
  {
    v6 = v5(v4, &GUID_cafcb56c_6ac3_4889_bf47_9e23bbd260ec, (char *)this + 216);
    v2 = v6;
    if ( v6 >= 0 )
      goto LABEL_5;
    v8 = 698;
