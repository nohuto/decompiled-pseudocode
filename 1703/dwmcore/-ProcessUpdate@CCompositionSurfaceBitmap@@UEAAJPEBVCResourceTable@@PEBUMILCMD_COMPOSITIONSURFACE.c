/*
 * XREFs of ?ProcessUpdate@CCompositionSurfaceBitmap@@UEAAJPEBVCResourceTable@@PEBUMILCMD_COMPOSITIONSURFACEBITMAP@@@Z @ 0x180037E00
 * Callers:
        ...
        const struct MILCMD_COMPOSITIONSURFACEBITMAP *a3)
{
  ...
  if ( v3 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x308u);
      v4 = v13;
      goto LABEL_8;
    }
    v4 = v13;
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, updated, 0x30Eu);
  }
  else
  {
    *((_BYTE *)this + 522) = *((_DWORD *)a3 + 4) != 0;
    *((_BYTE *)this + 523) = *((_DWORD *)a3 + 5) != 0;
    *((_BYTE *)this + 524) = *((_DWORD *)a3 + 6) != 0;
  }
LABEL_8:
  if ( v4 )
    CMILCOMBase::InternalRelease(v4);
  TranslateDXGIorD3DErrorInContext(v8, 11LL, &v12);
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
