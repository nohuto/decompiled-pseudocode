/*
 * XREFs of ?ComputeVSyncInfo@CIndependentRefreshRateScheduler@@AEAAJXZ @ 0x18013C9B4
 * Callers:
 *     ?UpdateTimes@CIndependentRefreshRateScheduler@@EEAAJXZ @ 0x18013E820 (-UpdateTimes@CIndependentRefreshRateScheduler@@EEAAJXZ.c)
 * Callees:
 *     ?ComputeLastVSyncFromPreviousFrame@CIndependentRefreshRateScheduler@@AEAAXXZ @ 0x18013C90C (-ComputeLastVSyncFromPreviousFrame@CIndependentRefreshRateScheduler@@AEAAXXZ.c)
 */

__int64 __fastcall CIndependentRefreshRateScheduler::ComputeVSyncInfo(CIndependentRefreshRateScheduler *this)
{
  ...
  {
    CIndependentRefreshRateScheduler::ComputeLastVSyncFromPreviousFrame(this);
  }
  else
  {
