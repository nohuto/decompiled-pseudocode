/*
 * XREFs of ??$SetOutputTexel@I@CGradientTextureGenerator@@CAXPEBU_D3DCOLORVALUE@@W4Enum@MilColorInterpolationMode@@PEAI@Z @ 0x1801C06EC
 * Callers:
 ...
 *     ??$FillSingleTexelGradientSpan@I@CGradientTextureGenerator@@CAXPEAPEAUMILGradientStop@@0PEBU1@W4Enum@MilColorInterpolationMode@@HMMPEAI@Z @ 0x1801C0394 (--$FillSingleTexelGradientSpan@I@CGradientTextureGenerator@@CAXPEAPEAUMILGradientStop@@0PEBU1@W4.c)
 *     ??$FillTexture@I@CGradientTextureGenerator@@CAXPEBV?$DynArray@UMILGradientStop@@$0A@@@W4Enum@MilGradientWrapMode@@W42MilColorInterpolationMode@@PEBU_D3DCOLORVALUE@@3PEBVCGradientSpanInfo@@IPEAI@Z @ 0x1801C0480 (--$FillTexture@I@CGradientTextureGenerator@@CAXPEBV-$DynArray@UMILGradientStop@@$0A@@@W4Enum@Mil.c)
 * Callees:
 ...
 *     ?Premultiply@@YAII@Z @ 0x1801ADEC8 (-Premultiply@@YAII@Z.c)
 */
...
__int64 __fastcall CGradientTextureGenerator::SetOutputTexel<unsigned int>(const __m128i *a1, int a2, int *a3)
{
  ...
  else if ( !a2 )
  {
    ...
    v19 = ((v18 << 8) | Convert_scRGB_Channel_To_sRGB_Byte(v6)) << 8;
    v20 = (Convert_scRGB_Channel_To_sRGB_Byte(v7) | v19) << 8;
    v21 = Convert_scRGB_Channel_To_sRGB_Byte(v8);
    result = Premultiply(v20 | (unsigned int)v21);
    *a3 = result;
  }
  return result;
}
