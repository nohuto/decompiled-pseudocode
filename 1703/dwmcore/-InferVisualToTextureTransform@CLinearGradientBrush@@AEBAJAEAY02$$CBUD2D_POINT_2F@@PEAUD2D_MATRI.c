/*
 * XREFs of ?InferVisualToTextureTransform@CLinearGradientBrush@@AEBAJAEAY02$$CBUD2D_POINT_2F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x18001A4AC
 * Callers:
 ...
 * Callees:
 *     ?InferAffineMatrix@CMILMatrix@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBUMilPoint2F@@@Z @ 0x180011D78 (-InferAffineMatrix@CMILMatrix@@QEAAXAEBV-$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@Re.c)
        ...
        struct D2D_MATRIX_3X2_F *a3)
{
  ...
  *((_QWORD *)&v14 + 1) = LODWORD(v3) | 0x3F80000000000000LL;
  ...
  v11 = _xmm;
  v12 = _xmm;
  CMILMatrix::InferAffineMatrix((__int64)&v9, (float *)&v14, (float *)a2);
  *(_QWORD *)&v14 = v9;
  *((_QWORD *)&v14 + 1) = v10;
  ...
  *(_QWORD *)&v6->m[2][0] = v5;
  ...
  {
    v7 = -2003304441;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003304441, 0x13Eu);
  }
  return v7;
}
