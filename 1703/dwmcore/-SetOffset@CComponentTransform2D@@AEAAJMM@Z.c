/*
 * XREFs of ?SetOffset@CComponentTransform2D@@AEAAJMM@Z @ 0x1800AC3C4
 * Callers:
...
__int64 __fastcall CComponentTransform2D::SetOffset(CComponentTransform2D *this, double a2, double a3)
{
  ...
  v3 = 0;
  if ( *((float *)this + 22) != *(float *)&a2 || *((float *)this + 23) != *(float *)&a3 )
  {
    *((_DWORD *)this + 22) = LODWORD(a2);
    *((_DWORD *)this + 23) = LODWORD(a3);
    CResource::NotifyOnChanged(this, 0LL, 0LL);
    v7 = _mm_unpacklo_ps(*(__m128 *)&a2, *(__m128 *)&a3).m128_u64[0];
    v6 = CPropertyChangeResource::NotifyVector2PropertyChanged(this, 2LL, (const struct D2DVector2 *)&v7);
    v3 = v6;
    if ( v6 < 0 )
