/*
 * XREFs of ?WindowNodeSetCompositionSurface@CChannel@@UEAAJIPEAX@Z @ 0x18013AE60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::WindowNodeSetCompositionSurface(CChannel *this, int a2, void *a3)
{
  unsigned int v6; // ebx
