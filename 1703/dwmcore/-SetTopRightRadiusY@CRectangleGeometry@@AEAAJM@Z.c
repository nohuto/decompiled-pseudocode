/*
 * XREFs of ?SetTopRightRadiusY@CRectangleGeometry@@AEAAJM@Z @ 0x180094C50
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetTopRightRadiusY(CRectangleGeometry *this, float a2)
{
  ...
  if ( *((float *)this + 33) != a2 )
  {
    *((float *)this + 33) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyScalarPropertyChanged(this, 8u, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x227u);
    else
