/*
 * XREFs of ?ImageLegacyMilBrushUpdate@CChannel@@UEAAJINAEBUMilRectF@@0IIIW4Enum@MilBrushMappingMode@@1IIW43MilStretch@@W43MilTileMode@@W43MilHorizontalAlignment@@W43MilVerticalAlignment@@I@Z @ 0x18007F9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a17)
{
  ...
  struct _RTL_CRITICAL_SECTION *v41; // [rsp+C8h] [rbp+17h] BYREF
