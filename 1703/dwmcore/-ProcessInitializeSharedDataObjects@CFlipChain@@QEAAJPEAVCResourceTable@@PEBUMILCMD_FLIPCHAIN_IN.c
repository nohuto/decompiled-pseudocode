/*
 * XREFs of ?ProcessInitializeSharedDataObjects@CFlipChain@@QEAAJPEAVCResourceTable@@PEBUMILCMD_FLIPCHAIN_INITIALIZESHAREDDATAOBJECTS@@@Z @ 0x18012D7C8
 * Callers:
        ...
        const struct MILCMD_FLIPCHAIN_INITIALIZESHAREDDATAOBJECTS *a3)
{
  ...
  v8 = CLocalMrowWriter<SharedBufferDataFlipChain>::Create(this, v3);
  v9 = v8;
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x168u);
  }
  else
  {
    CFlipChain::ReadSharedDataFromDwm(this);
    v10 = (void (__fastcall ***)(_QWORD, __int64))*((_QWORD *)this + 27);
    if ( v10 )
    {
      (**v10)(v10, 1LL);
      *((_QWORD *)this + 27) = 0LL;
    ...
    *v12 = 0LL;
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x182u);
    }
    else
    {
      *v12 = v15;
