/*
 * XREFs of ??0CD2DBitmap@@IEAA@PEAVCD2DResourceManager@@_N@Z @ 0x18007AC70
 * Callers:
...
CD2DBitmap *__fastcall CD2DBitmap::CD2DBitmap(CD2DBitmap *this, struct CD2DResourceManager *a2, char a3)
{
  __int64 v3; // r10
  ...
  *(_QWORD *)(v3 + 16) = &CSecondaryD2DBitmap::`vftable'{for `IDeviceResource'};
  *(_QWORD *)(v3 + 104) = &CD2DBitmap::`vftable'{for `ID2DBitmap'};
  *(_QWORD *)(v3 + 112) = &CD2DBitmap::`vftable'{for `ID2DBitmapCacheSource'};
  *(_QWORD *)(v3 + 120) = &CSecondaryD2DBitmap::`vftable'{for `IBitmapUnlock'};
  *(_QWORD *)(v3 + 128) = 0LL;
  *(_QWORD *)(v3 + 136) = 0LL;
  *(_QWORD *)(v3 + 144) = 0LL;
  *(_QWORD *)(v3 + 152) = 0LL;
  *(_QWORD *)(v3 + 160) = 0LL;
  *(_DWORD *)(v3 + 252) = DisplayId::None;
