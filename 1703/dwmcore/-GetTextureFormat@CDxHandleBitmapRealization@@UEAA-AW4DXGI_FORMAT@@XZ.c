/*
 * XREFs of ?GetTextureFormat@CDxHandleBitmapRealization@@UEAA?AW4DXGI_FORMAT@@XZ @ 0x18000B3B0
 * Callers:
 ...
 *     ?GetTextureFormat@CD2DBitmap@@UEBA?AW4DXGI_FORMAT@@XZ @ 0x18007AA80 (-GetTextureFormat@CD2DBitmap@@UEBA-AW4DXGI_FORMAT@@XZ.c)
