/*
 * XREFs of ?ProcessSetHeatMapMode@CVisual@@QEAAJPEAVCResourceTable@@PEBUMILCMD_VISUAL_SETHEATMAPMODE@@@Z @ 0x18012B1D4
 * Callers:
        ...
        const struct MILCMD_VISUAL_SETHEATMAPMODE *a3)
{
  ...
  if ( *((_DWORD *)a3 + 6) )
  {
    *((_BYTE *)this + 89) |= 0x80u;
    ...
    if ( v4 )
      CSparseStorage::SetData((char **)this + 26, 6, 0x10u, &v6);
    else
