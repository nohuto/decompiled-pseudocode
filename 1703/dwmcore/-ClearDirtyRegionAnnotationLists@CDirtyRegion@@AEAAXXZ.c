/*
 * XREFs of ?ClearDirtyRegionAnnotationLists@CDirtyRegion@@AEAAXXZ @ 0x180092ADC
 * Callers:
...
void __fastcall CDirtyRegion::ClearDirtyRegionAnnotationLists(CDirtyRegion *this)
{
  ...
  while ( v2 );
  v3 = (CDirtyRegion *)((char *)this + 1128);
  CDirtyRegionAnnotationAllocationSet::ReleaseDirtyRegionAnnotationBuffers((CDirtyRegion *)((char *)this + 1128));
