/*
 * XREFs of ?PrepareSysMemBufferAsSourcePixels@CBitmapOfDeviceBitmaps@@AEAAJXZ @ 0x18019B788
 * Callers:
...
__int64 __fastcall CBitmapOfDeviceBitmaps::PrepareSysMemBufferAsSourcePixels(CBitmapOfDeviceBitmaps *this)
{
  ...
  if ( (PixelFormatSize & 7) != 0 )
  {
    ...
    v17 = 1363;
LABEL_18:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v3, v17);
    ...
    *((_DWORD *)this + 63) = v5;
    if ( v6 <= 0xFFFFFFFF )
    {
      *((_DWORD *)this + 62) = v6;
      ...
      v3 = 0;
      if ( this == (CBitmapOfDeviceBitmaps *)-240LL || !(_DWORD)v6 )
      {
        v3 = -2147024809;
      }
      else
      ...
      memset_0(*v7, 0, *((unsigned int *)this + 62));
    ...
    {
      v3 = -2147024362;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024362, 0x561u);
    }
  }
  else
  {
    v3 = -2147024362;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024362, 0x55Fu);
  }
  return (unsigned int)v3;
}
