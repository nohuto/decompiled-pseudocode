/*
 * XREFs of ??1CPartitionVerticalBlankScheduler@@UEAA@XZ @ 0x18013B684
 * Callers:
...
LABEL_17:
  ...
  CTelemetryFrameStatistics::~CTelemetryFrameStatistics((CPartitionVerticalBlankScheduler *)((char *)this + 25264));
  CTelemetryTracking::ClearAllTelemetry((CPartitionVerticalBlankScheduler *)((char *)this + 24728));
