/*
 * XREFs of ?GetDestinationRect@COcclusionContext@@AEBA?AV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBV2@@Z @ 0x18009B288
 * Callers:
...
__int64 __fastcall COcclusionContext::GetDestinationRect(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v4 = *(_DWORD *)(a1 + 8);
  if ( v4 )
    v6 = (void *)(*(_QWORD *)(a1 + 24) + 68LL * (unsigned int)(v4 - 1));
  else
    v6 = &CMILMatrix::Identity;
  CMILMatrix::Transform2DBoundsHelper<0>((__int64)v6, a3, v8);
