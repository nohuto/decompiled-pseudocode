/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1801BD580
 * Callers:
        ...
        __int64 a2)
{
  ...
  for ( i = a1; v3 < v2; *(_DWORD *)(v10 + 12) = a1 )
  {
    ...
    LODWORD(a1) = result | (((int)(float)BYTE1(v7) | (((int)(float)BYTE2(v7) | ((int)(float)((float)HIBYTE(v7) * v8) << 8)) << 8)) << 8);
  }
  return result;
}
