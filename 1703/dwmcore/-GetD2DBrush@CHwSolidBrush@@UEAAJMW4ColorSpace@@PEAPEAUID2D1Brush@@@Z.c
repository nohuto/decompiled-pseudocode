/*
 * XREFs of ?GetD2DBrush@CHwSolidBrush@@UEAAJMW4ColorSpace@@PEAPEAUID2D1Brush@@@Z @ 0x1800C3CC0
 * Callers:
...
__int64 __fastcall CHwSolidBrush::GetD2DBrush(const __m128i *a1, float a2, int a3, _QWORD *a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    v13 = (*(__int64 (__fastcall **)(_QWORD, struct _D3DCOLORVALUE *, _QWORD, const __m128i *))(**(_QWORD **)(a1->m128i_i64[1] + 176)
                                                                                              + 64LL))(
