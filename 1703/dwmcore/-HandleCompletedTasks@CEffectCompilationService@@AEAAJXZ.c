/*
 * XREFs of ?HandleCompletedTasks@CEffectCompilationService@@AEAAJXZ @ 0x1800052FC
 * Callers:
 *     _lambda_6c2a3186a1eef4a9e99997b9c70e4e2b_::_lambda_invoker_cdecl_ @ 0x1800240D0 (_lambda_6c2a3186a1eef4a9e99997b9c70e4e2b_--_lambda_invoker_cdecl_.c)
 * Callees:
  ...
  if ( *((_DWORD *)this + 19) )
  {
    do
    {
      ...
      *(_DWORD *)(v3 + 40) = 0;
      ...
      DynArray<CCursorVisual *,0>::RemoveAt((char *)this + 80, 0LL);
    }
