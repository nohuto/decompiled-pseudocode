/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x180136C4C
 * Callers:
 ...
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x180137598 (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
 */
