/*
 * XREFs of ?GetFrontBufferSurface@CHwStereoFullScreenRenderTarget@@UEAAJW4StereoContext@@_NPEAPEAVCD3DSurface@@@Z @ 0x1801A04D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CD3DSurface **a4)
{
  ...
  *a4 = 0LL;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, FrontBufferSurface, 0x17Du);
  }
  else
  {
    if ( v5 != 2 )
    ...
    v9 = ViewOfTexture;
    if ( ViewOfTexture < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, ViewOfTexture, 0x18Au);
  }
  if ( v8 )
