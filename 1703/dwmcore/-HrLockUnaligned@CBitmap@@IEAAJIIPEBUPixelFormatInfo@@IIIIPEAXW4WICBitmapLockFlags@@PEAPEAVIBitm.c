/*
 * XREFs of ?HrLockUnaligned@CBitmap@@IEAAJIIPEBUPixelFormatInfo@@IIIIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x1801A990C
 * Callers:
...
LABEL_22:
  ...
  *((_QWORD *)v18 + 3) = &CBitmapLockUnaligned::`vftable'{for `IWICBitmapLock'};
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v19, 0x32Du);
    if ( (a10 & 2) != 0 )
    {
      *v13 = 0;
    }
