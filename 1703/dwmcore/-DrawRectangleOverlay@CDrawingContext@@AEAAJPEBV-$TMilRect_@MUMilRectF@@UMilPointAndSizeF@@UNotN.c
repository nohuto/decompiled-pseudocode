/*
 * XREFs of ?DrawRectangleOverlay@CDrawingContext@@AEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18014C1A8
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawRectangleOverlay(__int64 a1, struct D2D_RECT_F *a2)
{
  ...
  v3 = v2;
  if ( v2 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x2757u);
  else
