/*
 * XREFs of ??2CCompositionSurfaceBitmap@@KAPEAX_K@Z @ 0x1800C76B8
 * Callers:
...
void *__fastcall CCompositionSurfaceBitmap::operator new()
{
  void *result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = WPF::ProcessHeapImpl::AllocClear(0x210uLL);
  if ( !result )
  {
