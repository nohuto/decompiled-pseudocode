/*
 * XREFs of ?TotalContactsCapturedUnderVisual@CManipulationContext@@SAIPEBUMCCollections@@PEAVCVisual@@PEAPEAVCInteraction@@@Z @ 0x180194F10
 * Callers:
        ...
        struct CInteraction **a3)
{
  ...
  if ( CVisual::GetInteractionInternal(a2) )
  {
    ...
    Microsoft::WRL::ComPtr<CInteraction>::operator=(
      ...
      *((CArrayBasedCoverageSet **)InteractionInternal + 28));
  ...
  else
  {
    ...
    if ( v18 )
    {
      for ( i = v18[31]; i; i = (CInteraction *)*((_QWORD *)i + 29) )
      {
