/*
 * XREFs of ?ComputePrefilteringDimensions@CMILMatrix@@QEBAXIIMAEAI0@Z @ 0x18009A48C
 * Callers:
 ...
 *     ?ComputePrefilteredSize@@YAXIMMAEAI@Z @ 0x1800C65B4 (-ComputePrefilteredSize@@YAXIMMAEAI@Z.c)
 */
