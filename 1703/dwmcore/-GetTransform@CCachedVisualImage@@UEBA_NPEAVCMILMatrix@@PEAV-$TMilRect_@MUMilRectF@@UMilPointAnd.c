/*
 * XREFs of ?GetTransform@CCachedVisualImage@@UEBA_NPEAVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801657A0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CCachedVisualImage::GetTransform(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  CCachedVisualImage::GetCurrentSize((CCachedVisualImage *)(a1 - 80), (unsigned int *)&v9, (unsigned int *)&v10);
  if ( a3 )
  {
    v6 = LODWORD(v9);
    *(_QWORD *)a3 = 0LL;
  ...
  *(_OWORD *)(a2 + 32) = _xmm;
  *(_OWORD *)(a2 + 48) = _xmm;
  if ( *(_BYTE *)(a1 + 242) && CVisual::GetEffectiveOffset(*(CVisual **)(a1 + 56), &v10, &v9, &v11) )
