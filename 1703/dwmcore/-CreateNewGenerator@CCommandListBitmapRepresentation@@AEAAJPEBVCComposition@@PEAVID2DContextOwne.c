/*
 * XREFs of ?CreateNewGenerator@CCommandListBitmapRepresentation@@AEAAJPEBVCComposition@@PEAVID2DContextOwner@@PEAVID2DContext@@PEAPEAVCPrimitiveGroupDrawListGenerator@@@Z @ 0x180009ED0
 * Callers:
        ...
        struct CPrimitiveGroupDrawListGenerator **a5)
{
  ...
  *a5 = 0LL;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, D2DBitmapRealization, 0x149u);
    goto LABEL_7;
  }
  if ( !v21 )
    goto LABEL_7;
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x156u);
    goto LABEL_21;
  }
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x159u);
LABEL_21:
    v9 = v22;
    v10 = a5;
    goto LABEL_7;
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v17, 0x166u);
    v8 = v19;
  }
  else
  {
