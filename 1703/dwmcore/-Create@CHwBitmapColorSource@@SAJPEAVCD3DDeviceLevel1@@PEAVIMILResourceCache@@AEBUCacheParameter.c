/*
 * XREFs of ?Create@CHwBitmapColorSource@@SAJPEAVCD3DDeviceLevel1@@PEAVIMILResourceCache@@AEBUCacheParameters@1@_NPEAPEAV1@@Z @ 0x1800C5DD8
 * Callers:
        ...
        struct CHwBitmapColorSource **a5)
{
  ...
  *(_QWORD *)&v13.CPUAccessFlags = 0LL;
  v10 = (CHwBitmapColorSource *)HeapAlloc(WPF::g_processHeap, 0, 0x148uLL);
  if ( !v10 )
  {
  ...
  *a5 = v11;
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x6A2u);
  }
  return v5;
}
