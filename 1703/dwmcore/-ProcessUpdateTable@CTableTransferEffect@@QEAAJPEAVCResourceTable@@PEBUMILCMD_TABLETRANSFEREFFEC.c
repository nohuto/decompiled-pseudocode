/*
 * XREFs of ?ProcessUpdateTable@CTableTransferEffect@@QEAAJPEAVCResourceTable@@PEBUMILCMD_TABLETRANSFEREFFECT_UPDATETABLE@@PEBXI@Z @ 0x180129D00
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( a4 )
  {
    if ( !*((_DWORD *)a3 + 2) )
    {
      v9 = (char *)this + 32 * *((unsigned int *)a3 + 3) + 8 * *((unsigned int *)a3 + 3) + 232;
      *((_DWORD *)v9 + 6) = 0;
      DynArrayImpl<0>::ShrinkToSize((__int64)v9, 4u);
    }
    v10 = DynArray<float,0>::AddMultipleAndSet(
            (__int64)this + 32 * *((unsigned int *)a3 + 3) + 8 * *((unsigned int *)a3 + 3) + 232,
            a4,
            a5 >> 2);
    v5 = v10;
    if ( v10 < 0 )
