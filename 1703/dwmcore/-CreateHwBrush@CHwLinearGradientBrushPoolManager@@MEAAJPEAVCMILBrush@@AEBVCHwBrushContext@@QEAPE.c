/*
 * XREFs of ?CreateHwBrush@CHwLinearGradientBrushPoolManager@@MEAAJPEAVCMILBrush@@AEBVCHwBrushContext@@QEAPEAVCHwBrush@@@Z @ 0x1801A25E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CHwBrush **const a4)
{
  ...
  *((_DWORD *)v8 + 20) = 1;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x36u);
