/*
 * XREFs of ?IsColorKey@CColorKey@@QEBA_NAEBU_D3DCOLORVALUE@@@Z @ 0x1801B2C04
 * Callers:
...
_BOOL8 __fastcall CColorKey::IsColorKey(CColorKey *this, const struct _D3DCOLORVALUE *a2)
{
  float a; // xmm1_4
  float g; // xmm1_4
  float b; // xmm1_4
