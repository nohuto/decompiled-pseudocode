/*
 * XREFs of ?OnContactDepart@CManipulationContext@@QEAAXIKPEAVCInteraction@@_N1@Z @ 0x1800D5114
 * Callers:
        ...
        bool a6)
{
  ...
  CMap<unsigned int,Microsoft::WRL::ComPtr<CInteraction>,CMapEqualHelper<unsigned int,Microsoft::WRL::ComPtr<CInteraction>>>::RemoveKey(
    ...
    &v13);
  if ( !a5
    && (*(unsigned __int8 (__fastcall **)(CArrayBasedCoverageSet *, _QWORD))(*(_QWORD *)v6 + 208LL))(v6, 0LL)
    && (*(unsigned __int8 (__fastcall **)(CArrayBasedCoverageSet *, _QWORD, _QWORD))(*(_QWORD *)v6 + 216LL))(
         v6,
         a2,
         0LL) )
  {
    (*(void (__fastcall **)(CArrayBasedCoverageSet *, _QWORD))(*(_QWORD *)v6 + 224LL))(v6, a2);
  }
  else
  {
  ...
  CManipulationContext::CleanTreeState(v6, this, *((struct CComposition **)this + 6), a6, a3);
  if ( v6 )
    (*(void (__fastcall **)(CArrayBasedCoverageSet *))(*(_QWORD *)v6 + 8LL))(v6);
}
