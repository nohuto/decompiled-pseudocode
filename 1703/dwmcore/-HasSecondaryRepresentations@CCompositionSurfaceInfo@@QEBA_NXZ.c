/*
 * XREFs of ?HasSecondaryRepresentations@CCompositionSurfaceInfo@@QEBA_NXZ @ 0x180175274
 * Callers:
...
bool __fastcall CCompositionSurfaceInfo::HasSecondaryRepresentations(CCompositionSurfaceInfo *this)
{
  ...
  if ( v1 )
  {
    ...
    do
    {
      (***(void (__fastcall ****)(_QWORD, char *, bool *))(v5 + *((_QWORD *)this + 43)))(
        *(_QWORD *)(v5 + *((_QWORD *)this + 43)),
        &v7,
        &v6);
      result = v6;
      if ( v6 )
