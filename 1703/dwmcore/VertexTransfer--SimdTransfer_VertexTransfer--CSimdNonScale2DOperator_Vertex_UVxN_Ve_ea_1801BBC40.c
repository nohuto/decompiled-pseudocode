/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801BBC40
 * Callers:
        ...
        CMILMatrix *a4)
{
  ...
  __int128 v31; // [rsp+40h] [rbp-B8h] BYREF
  _OWORD v32[8]; // [rsp+50h] [rbp-A8h] BYREF
  struct D2DQuaternion *v33; // [rsp+100h] [rbp+8h]
