/*
 * XREFs of ?GetPixelColor@CSystemMemoryBitmap@@QEBAJAEBUD2D_POINT_2F@@PEAU_D3DCOLORVALUE@@@Z @ 0x1801A8E28
 * Callers:
 *     ?GetPixelColor@CGdiSpriteBitmap@@UEBAJAEBUD2D_POINT_2F@@PEAU_D3DCOLORVALUE@@@Z @ 0x1801637E0 (-GetPixelColor@CGdiSpriteBitmap@@UEBAJAEBUD2D_POINT_2F@@PEAU_D3DCOLORVALUE@@@Z.c)
 * Callees:
        ...
        struct _D3DCOLORVALUE *a3)
{
  ...
  {
    v6 = (char *)this + 224;
    v7 = *(void (__fastcall **)(char *, float *, unsigned int *))(*(_QWORD *)v6 + 24LL);
    v8 = a2->x + 6291456.25;
    v13 = v8;
