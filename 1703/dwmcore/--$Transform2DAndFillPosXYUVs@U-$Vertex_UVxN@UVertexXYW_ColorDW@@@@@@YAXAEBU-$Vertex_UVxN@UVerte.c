/*
 * XREFs of ??$Transform2DAndFillPosXYUVs@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@YAXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@IAEBVCMILMatrix@@PEAU0@PEAUD2D_POINT_2F@@@Z @ 0x180021EEC
 * Callers:
  ...
  *a5 = (float)(v18 * v19) + v16;
  ...
  if ( (_DWORD)v13 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)((char *)result + (char *)a5 - (char *)a1 - 4) = _mm_unpacklo_ps(v25, v26).m128_u64[0];
      result += 2;
      --v24;
    }
    while ( v24 );
