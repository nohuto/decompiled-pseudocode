/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD3DPixelShader@@VCLinkedShader@@VCD3DDeviceLevel1@@@@QEAAJPEAVCD3DDeviceLevel1@@PEAPEAVCD3DPixelShader@@@Z @ 0x1800181C4
 * Callers:
        ...
        struct CD3DPixelShader **a3)
{
  ...
  {
    while ( a2
         && *(struct CD3DPixelShader **)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 8 * v6) + 16LL) + 128LL) != a2 )
    {
...
LABEL_33:
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x5Au);
    goto LABEL_33;
  }
