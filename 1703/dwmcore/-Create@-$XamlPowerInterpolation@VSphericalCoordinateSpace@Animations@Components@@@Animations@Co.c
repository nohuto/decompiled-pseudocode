/*
 * XREFs of ?Create@?$XamlPowerInterpolation@VSphericalCoordinateSpace@Animations@Components@@@Animations@Components@@SAJW4Dwm__InterpolationMode@23@MPEAPEAVInterpolation@23@@Z @ 0x1801B9230
 * Callers:
...
__int64 __fastcall Components::Animations::XamlPowerInterpolation<Components::Animations::SphericalCoordinateSpace>::Create(
        unsigned int a1,
        float a2,
        float **a3)
{
  ...
  if ( v7 )
  {
    ...
    *((_DWORD *)v8 + 2) = 1;
    *(_QWORD *)v8 = &Components::Animations::XamlPowerInterpolation<Components::Animations::SphericalCoordinateSpace>::`vftable';
  }
  else
  {
    v8 = 0LL;
