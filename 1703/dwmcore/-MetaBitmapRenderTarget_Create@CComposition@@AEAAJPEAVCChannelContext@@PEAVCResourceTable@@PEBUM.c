/*
 * XREFs of ?MetaBitmapRenderTarget_Create@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_METABITMAPRENDERTARGET_CREATE@@@Z @ 0x180130E94
 * Callers:
        ...
        const struct MILCMD_METABITMAPRENDERTARGET_CREATE *a4)
{
  ...
  Resource = (CMagnifierRenderTarget *)CResourceTable::GetResource((__int64)a3, *((_DWORD *)a4 + 1), 0x3Au);
  v8 = Resource;
  if ( Resource )
  {
