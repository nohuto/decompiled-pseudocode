/*
 * XREFs of ?UnsafeUpdateFromSource@CSystemMemoryBitmap@@QEAAJPEAVIBitmapSource@@AEBUMilRectU@@II@Z @ 0x1801A95A4
 * Callers:
        ...
        int a4)
{
  ...
  v14 = (*(__int64 (__fastcall **)(struct IBitmapSource *, _DWORD *, _QWORD, _QWORD, unsigned __int64))(*(_QWORD *)a2 + 64LL))(
          a2,
          v17,
  ...
  v15 = v14;
  if ( v14 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x161u);
  return v15;
}
