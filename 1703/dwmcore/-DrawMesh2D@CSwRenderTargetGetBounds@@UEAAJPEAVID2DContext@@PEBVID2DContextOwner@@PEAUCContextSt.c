/*
 * XREFs of ?DrawMesh2D@CSwRenderTargetGetBounds@@UEAAJPEAVID2DContext@@PEBVID2DContextOwner@@PEAUCContextState@@PEAVCGeometry2D@@PEAVIBitmapSource@@@Z @ 0x18019A630
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CGeometry2D *a5)
{
  ...
  (*(void (__fastcall **)(struct CGeometry2D *, _BYTE *, const struct ID2DContextOwner *))(*(_QWORD *)a5 + 152LL))(
    a5,
    v8,
    a3);
