/*
 * XREFs of ?CreateD2DInk@CD2DContext@@UEAAJAEBUD2D1_INK_POINT@@AEBUD2D1_INK_STYLE_PROPERTIES@@PEAPEAVCD2DInk@@@Z @ 0x18000FF10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CD2DInk **a4)
{
  ...
  else
  {
    ...
    else
    {
      ...
      v8 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x226u);
    }
  }
  ReleaseInterfaceNoNULL<ID2D1Ink>((__int64)v13);
