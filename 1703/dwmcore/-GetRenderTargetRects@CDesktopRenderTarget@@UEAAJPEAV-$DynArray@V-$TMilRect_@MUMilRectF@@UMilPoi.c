/*
 * XREFs of ?GetRenderTargetRects@CDesktopRenderTarget@@UEAAJPEAV?$DynArray@V?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@$0A@@@@Z @ 0x180147400
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDesktopRenderTarget::GetRenderTargetRects(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(a1 + 32) )
  {
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x5FFu);
  }
  return v2;
}
