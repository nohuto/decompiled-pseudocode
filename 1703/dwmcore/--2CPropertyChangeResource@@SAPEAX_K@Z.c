/*
 * XREFs of ??2CPropertyChangeResource@@SAPEAX_K@Z @ 0x180153968
 * Callers:
...
void *__fastcall CPropertyChangeResource::operator new()
{
  void *result; // rax
  void *retaddr; // [rsp+28h] [rbp+0h]

  result = WPF::ProcessHeapImpl::AllocClear(0x48uLL);
  if ( !result )
  {
