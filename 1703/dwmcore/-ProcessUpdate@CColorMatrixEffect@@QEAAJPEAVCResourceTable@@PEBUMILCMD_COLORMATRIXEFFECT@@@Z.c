/*
 * XREFs of ?ProcessUpdate@CColorMatrixEffect@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COLORMATRIXEFFECT@@@Z @ 0x180129948
 * Callers:
        ...
        const struct MILCMD_COLORMATRIXEFFECT *a3)
{
  ...
  *((_OWORD *)this + 14) = *(_OWORD *)&v5[24];
  *((_OWORD *)this + 15) = *(_OWORD *)&v5[40];
  *((_OWORD *)this + 16) = *(_OWORD *)&v5[56];
  *((_OWORD *)this + 17) = *(_OWORD *)&v5[72];
  *((_DWORD *)this + 72) = _mm_cvtsi128_si32(_mm_srli_si128(*(__m128i *)&v5[80], 8));
  *((_DWORD *)this + 73) = _mm_cvtsi128_si32(_mm_srli_si128(*(__m128i *)&v5[80], 12));
