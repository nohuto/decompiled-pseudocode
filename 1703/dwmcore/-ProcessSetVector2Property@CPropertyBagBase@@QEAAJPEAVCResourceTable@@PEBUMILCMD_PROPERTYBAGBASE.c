/*
 * XREFs of ?ProcessSetVector2Property@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETVECTOR2PROPERTY@@@Z @ 0x180023F8C
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETVECTOR2PROPERTY *a3)
{
  ...
  v8 = *(__int64 (__fastcall **)(CPropertyBagBase *, __int64, __int64, __int64, struct CResourceTable **))(*(_QWORD *)this + 144LL);
  v12 = (struct CResourceTable *)_mm_unpacklo_ps(v4, v3).m128_u64[0];
  v9 = v8(this, v7, v6, 35LL, &v12);
  v10 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x84u);
  return v10;
}
