/*
 * XREFs of ?MetaBitmapRenderTargetSetTransform@CChannel@@UEAAJII@Z @ 0x180139DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MetaBitmapRenderTargetSetTransform(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
