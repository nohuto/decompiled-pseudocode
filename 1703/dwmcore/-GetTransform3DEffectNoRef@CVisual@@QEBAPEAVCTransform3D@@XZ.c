/*
 * XREFs of ?GetTransform3DEffectNoRef@CVisual@@QEBAPEAVCTransform3D@@XZ @ 0x180086E24
 * Callers:
...
struct CTransform3D *__fastcall CVisual::GetTransform3DEffectNoRef(CVisual *this)
{
  ...
  if ( (*(_DWORD *)(*((_QWORD *)this + 26) + 4LL) & 0x8000000) != 0 )
  {
    ...
    if ( (char *)v4 == (char *)CEffectGroup::IsOfType )
      v5 = CEffectGroup::IsOfType(EffectInternal, 23LL);
    else
      v5 = v4(EffectInternal, 23LL);
    if ( v5 )
    {
    ...
    else
    {
      ...
      if ( (char *)v6 == (char *)CEffectGroup::IsOfType )
        v7 = CEffectGroup::IsOfType(EffectInternal, 7LL);
      else
        v7 = v6(EffectInternal, 7LL);
      if ( v7 )
