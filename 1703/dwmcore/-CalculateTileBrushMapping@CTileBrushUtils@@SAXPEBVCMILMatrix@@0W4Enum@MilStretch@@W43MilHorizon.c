/*
 * XREFs of ?CalculateTileBrushMapping@CTileBrushUtils@@SAXPEBVCMILMatrix@@0W4Enum@MilStretch@@W43MilHorizontalAlignment@@W43MilVerticalAlignment@@W43MilBrushMappingMode@@4PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@5MMPEAV8@6PEAV2@77PEAH@Z @ 0x18007D430
 * Callers:
        ...
        _DWORD *a17)
{
  ...
  *a17 = 0;
  ...
  v32 = 0;
  v34 = 0;
  CTileBrushUtils::GetAbsoluteViewRectangles(a6, a7, a8, a9, a12, a13, (__int64)a17);
  if ( !*a17 )
  {
