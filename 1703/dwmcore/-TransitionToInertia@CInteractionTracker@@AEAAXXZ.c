/*
 * XREFs of ?TransitionToInertia@CInteractionTracker@@AEAAXXZ @ 0x18016EC44
 * Callers:
...
LABEL_9:
  ...
  if ( v11 )
  {
    v12 = *(_QWORD *)(*((_QWORD *)this + 64) + 364LL);
    if ( COERCE_FLOAT(*(_OWORD *)(*((_QWORD *)this + 64) + 364LL)) != 0.0 || *((float *)&v12 + 1) != 0.0 )
      CInteraction::ReportInertiaStart(
        v11,
        HIDWORD(*(_QWORD *)(*((_QWORD *)this + 64) + 396LL)),
        *(float *)&v12,
        *((float *)&v12 + 1));
  }
