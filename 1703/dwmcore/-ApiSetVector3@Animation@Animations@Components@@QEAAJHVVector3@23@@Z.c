/*
 * XREFs of ?ApiSetVector3@Animation@Animations@Components@@QEAAJHVVector3@23@@Z @ 0x1801B7984
 * Callers:
...
__int64 __fastcall Components::Animations::Animation::ApiSetVector3(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *((double *)v7 + 4) = v14;
    *((_DWORD *)v7 + 3) = 52;
    v8 = Components::Animations::Sequence::SetKeyframeValue(*(Components::Animations::Sequence **)(a1 + 8), a2, v9);
    if ( v8 >= 0 )
      v8 = 0;
  }
  if ( v7 )
