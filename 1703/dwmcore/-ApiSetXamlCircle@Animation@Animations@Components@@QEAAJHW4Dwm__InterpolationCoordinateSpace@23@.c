/*
 * XREFs of ?ApiSetXamlCircle@Animation@Animations@Components@@QEAAJHW4Dwm__InterpolationCoordinateSpace@23@W4Dwm__InterpolationMode@23@@Z @ 0x1801B7CBC
 * Callers:
...
__int64 __fastcall Components::Animations::Animation::ApiSetXamlCircle(__int64 a1, int a2, int a3, unsigned int a4)
{
  ...
  if ( !a3 )
  {
    ...
    if ( v13 )
    {
      *((_QWORD *)v13 + 1) = 0LL;
      *((_QWORD *)v13 + 2) = 0LL;
      v11 = &Components::Animations::XamlCircleInterpolation<Components::Animations::CartesianCoordinateSpace>::`vftable';
      goto LABEL_11;
    }
    goto LABEL_12;
  }
  ...
  if ( !v7 )
  {
    ...
    if ( v12 )
    {
      *((_QWORD *)v12 + 1) = 0LL;
      *((_QWORD *)v12 + 2) = 0LL;
      v11 = &Components::Animations::XamlCircleInterpolation<Components::Animations::SphericalCoordinateSpace>::`vftable';
      goto LABEL_11;
    }
LABEL_12:
    v8 = 0LL;
  ...
  *((_QWORD *)v10 + 1) = 0LL;
  *((_QWORD *)v10 + 2) = 0LL;
  v11 = &Components::Animations::XamlCircleInterpolation<Components::Animations::HslCoordinateSpace>::`vftable';
LABEL_11:
  v8[2] = 1;
  *(_QWORD *)v8 = v11;
LABEL_13:
