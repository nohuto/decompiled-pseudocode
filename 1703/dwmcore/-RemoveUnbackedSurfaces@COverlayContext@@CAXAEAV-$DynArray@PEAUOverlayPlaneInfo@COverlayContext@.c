/*
 * XREFs of ?RemoveUnbackedSurfaces@COverlayContext@@CAXAEAV?$DynArray@PEAUOverlayPlaneInfo@COverlayContext@@$0A@@@@Z @ 0x1800C8610
 * Callers:
...
void __fastcall COverlayContext::RemoveUnbackedSurfaces(__int64 *a1)
{
  ...
  for ( i = 0LL; (unsigned int)i < v1; i = (unsigned int)(i + 1) )
  {
    ...
    if ( *(_BYTE *)(v5 + 169) && *(_BYTE *)(v5 + 173) )
    {
      ...
      {
LABEL_10:
        DynArray<MoveOptimizationInfo *,0>::RemoveAt(a1, (unsigned int)i, v5, v4);
        LODWORD(i) = i - 1;
      }
    }
    v1 = *((_DWORD *)a1 + 6);
