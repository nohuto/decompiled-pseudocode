/*
 * XREFs of ?SetD2DEffectProperties@CAffineTransform2DEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x18017A7C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ID2D1Effect *a2)
{
  ...
  v7 = v2 * *((float *)this + 56);
  v30 = v6;
  v8 = (float)((float)(v7 + (float)(v4 * *((float *)this + 54))) + *((float *)this + 58)) - v4;
  v9 = (float)(v4 * *((float *)this + 55)) + (float)(v2 * *((float *)this + 57));
  v10 = *(_OWORD *)((char *)this + 252);
  *(float *)&v31 = v8;
  v11 = v9 + *((float *)this + 59);
  *(_QWORD *)&v32.m[2][0] = *(_QWORD *)((char *)this + 268);
  *(_OWORD *)&v32.m11 = v10;
  *((float *)&v31 + 1) = v11 - v2;
  ...
  v18 = *((float *)this + 65);
  v19 = (__m128)*((unsigned int *)this + 66);
  ...
  v29[0] = (float)(v18 * v14) + (float)(*((float *)this + 63) * v13);
  ...
  v12.m128_f32[0] = (float)((float)(v12.m128_f32[0] * v21) + (float)(v18 * v20)) + *((float *)this + 67);
  v29[3] = (float)(v19.m128_f32[0] * v16) + (float)(v15 * v17);
  v19.m128_f32[0] = (float)((float)(v19.m128_f32[0] * v20) + (float)(v15 * v21)) + *((float *)this + 68);
  v30 = *(_OWORD *)v29;
  v31 = _mm_unpacklo_ps(v12, v19).m128_u64[0];
  v23 = v22(a2, 0LL, 0LL, (char *)this + 208, 4);
  v24 = v23;
  if ( v23 < 0 )
  {
