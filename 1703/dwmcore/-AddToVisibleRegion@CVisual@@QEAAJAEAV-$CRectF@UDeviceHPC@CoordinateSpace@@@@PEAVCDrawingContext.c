/*
 * XREFs of ?AddToVisibleRegion@CVisual@@QEAAJAEAV?$CRectF@UDeviceHPC@CoordinateSpace@@@@PEAVCDrawingContext@@@Z @ 0x18012B628
 * Callers:
...
__int64 __fastcall CVisual::AddToVisibleRegion(CVisual *this, __int64 a2, const struct CDrawingContext *a3)
{
  ...
  if ( !MoveRenderPassInfoRef )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0xFDCu);
      return v8;
    }
  ...
  v8 = v9;
  if ( v9 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0xFDFu);
  return v8;
}
