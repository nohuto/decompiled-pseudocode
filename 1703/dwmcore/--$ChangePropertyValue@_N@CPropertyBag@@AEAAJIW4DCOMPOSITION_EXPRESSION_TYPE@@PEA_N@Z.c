/*
 * XREFs of ??$ChangePropertyValue@_N@CPropertyBag@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEA_N@Z @ 0x18017C454
 * Callers:
...
__int64 __fastcall CPropertyBag::ChangePropertyValue<bool>(CResource *this, unsigned int a2, int a3, __int64 a4)
{
  int v8; // eax
  unsigned int v9; // esi
