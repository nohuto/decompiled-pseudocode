/*
 * XREFs of ?DiscardRectangle@CHwSurfaceRenderTarget@@UEAAXAEBUMilRectF@@@Z @ 0x1801302D8
 * Callers:
 *     ?DiscardRectangle@CHwTextureRenderTarget@@UEAAXAEBUMilRectF@@@Z @ 0x18019BC90 (-DiscardRectangle@CHwTextureRenderTarget@@UEAAXAEBUMilRectF@@@Z.c)
 * Callees:
...
void __fastcall CHwSurfaceRenderTarget::DiscardRectangle(CHwSurfaceRenderTarget *this, const struct MilRectF *a2)
{
  ...
  if ( (*(int (__fastcall **)(CHwSurfaceRenderTarget *, CD3DDeviceLevel1 **))(*(_QWORD *)this + 208LL))(this, &v12) >= 0 )
  {
    v4 = *((_QWORD *)this + 21);
