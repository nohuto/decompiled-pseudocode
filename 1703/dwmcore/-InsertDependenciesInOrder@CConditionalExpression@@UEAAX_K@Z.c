/*
 * XREFs of ?InsertDependenciesInOrder@CConditionalExpression@@UEAAX_K@Z @ 0x18016B650
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CConditionalExpression::InsertDependenciesInOrder(CConditionalExpression *this, __int64 a2)
{
  ...
  {
    v5 = *(CBaseExpression **)(*((_QWORD *)this + 29) + 16LL * i);
    if ( v5 )
      CBaseExpression::InsertInOrder(v5, a2);
    v6 = *(CBaseExpression **)(*((_QWORD *)this + 29) + 16LL * i + 8);
    if ( v6 )
      CBaseExpression::InsertInOrder(v6, a2);
  }
  v7 = (CBaseExpression *)*((_QWORD *)this + 33);
  if ( v7 )
