/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801BD014
 * Callers:
  ...
  if ( v12 )
  {
    do
    {
      ...
      VertexTransfer::CGeneral3DOperator<Vertex_UVxN<VertexXYW_ColorDW_WorldXYZ_Tangent>>::Transform(
        ...
        v7,
        v18);
      *(_DWORD *)(v18 + 12) = (int)(float)((float)(unsigned __int8)*(_DWORD *)(v17 + 12) * v10) | (((int)(float)((float)(unsigned __int8)BYTE1(*(_DWORD *)(v17 + 12)) * v10) | (((int)(float)((float)(unsigned __int8)BYTE2(*(_DWORD *)(v17 + 12)) * v10) | ((int)(float)((float)HIBYTE(*(_DWORD *)(v17 + 12)) * v10) << 8)) << 8)) << 8);
