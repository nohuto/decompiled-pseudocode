/*
 * XREFs of ?DesktopRectToRenderTargetRect@CHwndRenderTarget@@IEAAX_NPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x18006C390
 * Callers:
...
__int64 __fastcall CHwndRenderTarget::DesktopRectToRenderTargetRect(__int64 a1, char a2, __int64 a3, _OWORD *a4)
{
  ...
  if ( !a2 || (v19 = *(_QWORD *)(a1 + 776)) == 0 || (v20 = *(_BYTE *)(v19 + 1097) == 0, v5 = 232LL, v20) )
    v5 = 164LL;
  result = CMILMatrix::Transform2DBoundsHelper<0>(v5 + a1, a3, &X);
  v7 = *(float *)&X;
