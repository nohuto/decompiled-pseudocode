/*
 * XREFs of ?ClipToPolygon@ClipPlaneIterator@@QEAAJPEAVCPolygon@@AEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801566BC
 * Callers:
  ...
  if ( v38 )
  {
    ...
    if ( v36 )
    {
      ...
      *((float *)&v32 + 3) = -2.0 / (float)(int)v7;
      ...
      v12 = v30;
      if ( v30 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v30, 0x298u);
      else
        *((_QWORD *)a1 + 15) = a2;
    }
    else
    {
      v12 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x287u);
    }
  }
  else
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x284u);
  }
