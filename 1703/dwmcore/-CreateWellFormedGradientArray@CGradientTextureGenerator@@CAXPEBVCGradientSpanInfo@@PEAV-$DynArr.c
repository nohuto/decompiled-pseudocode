/*
 * XREFs of ?CreateWellFormedGradientArray@CGradientTextureGenerator@@CAXPEBVCGradientSpanInfo@@PEAV?$DynArray@UMILGradientStop@@$0A@@@W4Enum@MilColorInterpolationMode@@_NPEAU_D3DCOLORVALUE@@4@Z @ 0x1801C0FD4
 * Callers:
 ...
 * Callees:
 *     ??$ArrayInsertionSort@UMILGradientStop@@@@YAXPEAUMILGradientStop@@I@Z @ 0x1801C0178 (--$ArrayInsertionSort@UMILGradientStop@@@@YAXPEAUMILGradientStop@@I@Z.c)
