/*
 * XREFs of ?Channel_DuplicateHandleOnTarget@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_CHANNEL_DUPLICATEHANDLEONTARGET@@@Z @ 0x18005C33C
 * Callers:
        ...
        const struct MILCMD_CHANNEL_DUPLICATEHANDLEONTARGET *a4)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, AttachedChannel, 0x8D2u);
  }
  else
  {
    ...
    v8 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x8DAu);
  }
