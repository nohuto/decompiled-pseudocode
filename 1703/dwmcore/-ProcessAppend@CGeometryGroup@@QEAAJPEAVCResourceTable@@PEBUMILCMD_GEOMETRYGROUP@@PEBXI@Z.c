/*
 * XREFs of ?ProcessAppend@CGeometryGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_GEOMETRYGROUP@@PEBXI@Z @ 0x1801746B4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v11 = UnmarshalResourceArray(&v23, &a5, _mm_cvtsi128_si32(v8), 0x46u, v19, &v22, &Src, (__int64)a2, 0);
...
LABEL_22:
  ...
  if ( v14 + v22 >= v14 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0xD5Fu);
      }
      else
      {
        v16 = *((_DWORD *)this + 32);
  ...
  v6 = -2147024362;
  MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024362, 0xD53u);
LABEL_25:
  if ( v12 )
    WPF::ProcessHeapImpl::Free(v12);
  if ( v7 )
