/*
 * XREFs of ??$IsConstantOpaqueInternal@$$CBVCLinearGradientLegacyMilBrush@@@CGradientLegacyMilBrush@@KA_NPEBVCLinearGradientLegacyMilBrush@@@Z @ 0x180152DF8
 * Callers:
 *     ?IsConstantOpaque@CLinearGradientLegacyMilBrush@@UEBA_NXZ @ 0x1801540C0 (-IsConstantOpaque@CLinearGradientLegacyMilBrush@@UEBA_NXZ.c)
 * Callees:
