/*
 * XREFs of ?ProcessSetViewboxRight@CCachedVisualImage@@QEAAJPEAVCResourceTable@@PEBUMILCMD_CACHEDVISUALIMAGE_SETVIEWBOXRIGHT@@@Z @ 0x18012DAE4
 * Callers:
        ...
        const struct MILCMD_CACHEDVISUALIMAGE_SETVIEWBOXRIGHT *a3)
{
  ...
  v3 = CCachedVisualImage::SetViewboxRight(this, *((float *)a3 + 2));
  v4 = v3;
  if ( v3 < 0 )
