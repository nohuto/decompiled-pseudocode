/*
 * XREFs of ?SetExcludeSubtree@CVisualGroup@@QEAAX_N@Z @ 0x180163498
 * Callers:
...
void __fastcall CVisualGroup::SetExcludeSubtree(CVisualGroup *this, char a2)
{
  ...
  while ( (unsigned int)v2 < *((_DWORD *)this + 20) )
  {
    ...
    {
      CWeakReferenceBase::Release(*(struct _RTL_GENERIC_TABLE ***)(v5 + 8 * v2));
  ...
  while ( (unsigned int)v7 < *((_DWORD *)this + 28) )
  {
    ...
    {
      CWeakReferenceBase::Release(*(struct _RTL_GENERIC_TABLE ***)(v8 + 8 * v7));
