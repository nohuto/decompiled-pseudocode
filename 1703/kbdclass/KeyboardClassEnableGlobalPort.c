/*
 * XREFs of KeyboardClassEnableGlobalPort @ 0x1C000E4BC
 * Callers:
 *     KeyboardClassPlugPlayNotification @ 0x1C000E5A0 (KeyboardClassPlugPlayNotification.c)
 * Callees:
...
LABEL_6:
    ...
    *((_BYTE *)v7 + 16) = a2;
    ExReleaseFastMutex((PFAST_MUTEX)&WPP_MAIN_CB.Queue.Wcb.DeviceObject);
    if ( a2 != v8 )
      return (unsigned int)KbdEnableDisablePort(a2, 0LL, a1, v7);
  }
  return v4;
}
