/*
 * XREFs of KeyboardPnP @ 0x1C0001F20
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qqc @ 0x1C00022F0 (WPP_RECORDER_SF_qqc.c)
 ...
 *     KeyboardClassRemoveDevice @ 0x1C0004DD0 (KeyboardClassRemoveDevice.c)
