/*
 * XREFs of KeyboardClassPower @ 0x1C0001BA0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qqsd @ 0x1C0001200 (WPP_RECORDER_SF_qqsd.c)
 *     WPP_RECORDER_SF_qq @ 0x1C00017D0 (WPP_RECORDER_SF_qq.c)
 *     KeyboardClassCheckWaitWakeEnabled @ 0x1C0004790 (KeyboardClassCheckWaitWakeEnabled.c)
 *     KeyboardClassCreateWaitWakeIrp @ 0x1C000D170 (KeyboardClassCreateWaitWakeIrp.c)
 */
...
LABEL_15:
  ...
  WPP_RECORDER_SF_qqsd((__int64)WPP_GLOBAL_Control->DeviceExtension, (__int64)"D", v9, v10, RemlockSize);
  if ( Options )
  {
    if ( Options == 1 )
    {
