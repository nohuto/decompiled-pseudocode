/*
 * XREFs of DriverEntry @ 0x1C000F030
 * Callers:
 ...
 *     WppInitKm @ 0x1C000CFC0 (WppInitKm.c)
 *     WppLoadTracingSupport @ 0x1C000D060 (WppLoadTracingSupport.c)
 *     WppCleanupKm @ 0x1C000E774 (WppCleanupKm.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  PDEVICE_OBJECT v31; // [rsp+40h] [rbp-C0h] BYREF
  ...
  _BYTE v38[512]; // [rsp+A0h] [rbp-60h] BYREF
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  qword_1C00094F0 = (__int64)&qword_1C00094E8;
  qword_1C00094E8 = (__int64)&qword_1C00094E8;
  ...
  *(_DWORD *)&::DestinationString.Length = 0x2000000;
  ::DestinationString.Buffer = (PWSTR)&unk_1C00092E8;
  memset(v38, 0, sizeof(v38));
  *(_DWORD *)&DestinationString.Length = 0x2000000;
  DestinationString.Buffer = (PWSTR)v38;
  word_1C00092C8 = RegistryPath->Length;
  word_1C00092CA = RegistryPath->Length + 2;
  PoolWithTag = ExAllocatePoolWithTag((POOL_TYPE)512, (unsigned __int16)word_1C00092CA, 0x4364624Bu);
  ::P = PoolWithTag;
  if ( !PoolWithTag )
  {
    LOBYTE(v9) = 2;
  ...
  *((_WORD *)::P + ((unsigned __int64)RegistryPath->Length >> 1)) = 0;
  ...
  {
    v2 = KbdCreateClassObject(DriverObject, (__int128 *)&WPP_MAIN_CB.Dpc, &v31, (__int64 *)P, 1);
    if ( v2 < 0 )
    {
      v3 = P[0];
      goto LABEL_12;
  ...
  else
  {
    ...
    KbdDeterminePortsServiced(&DestinationString.Length, &v34);
    LOBYTE(v11) = 4;
    WPP_RECORDER_SF_d(WPP_GLOBAL_Control->DeviceExtension, v11, v12, 12, *(_DWORD *)v30, v34);
    ...
    if ( v13 )
    {
      ...
      for ( i = 0; i < *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Busy; ++i )
      {
        ...
        v20 = KbdCreateClassObject(DriverObject, (__int128 *)&WPP_MAIN_CB.Dpc, &v31, (__int64 *)P, 1);
        if ( v20 >= 0 )
        {
          v21 = (char *)v31->DeviceExtension;
          *(_QWORD *)v21 = v31;
          v21[64] = 0;
          v31->Flags &= ~0x80u;
          if ( IoGetDeviceObjectPointer(&Destination, 0x80u, &FileObject, (PDEVICE_OBJECT *)v21 + 2) >= 0 )
          {
            v3 = P[0];
            v23 = (const WCHAR *)P[0];
            v31->StackSize = *(_BYTE *)(*((_QWORD *)v21 + 2) + 76LL) + 1;
      ...
      v16 = (__int64 *)qword_1C00094E8;
      v2 = 0;
      if ( (__int64 *)qword_1C00094E8 != &qword_1C00094E8 )
      {
