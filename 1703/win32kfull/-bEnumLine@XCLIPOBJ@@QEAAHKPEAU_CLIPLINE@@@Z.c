/*
 * XREFs of ?bEnumLine@XCLIPOBJ@@QEAAHKPEAU_CLIPLINE@@@Z @ 0x1C01297EC
 * Callers:
 ...
 *     ?bRecordRun@XCLIPOBJ@@IEAAHAEAJ@Z @ 0x1C0128EB8 (-bRecordRun@XCLIPOBJ@@IEAAHAEAJ@Z.c)
 ...
 *     ?bFindNextScan@XCLIPOBJ@@IEAAHXZ @ 0x1C0129244 (-bFindNextScan@XCLIPOBJ@@IEAAHXZ.c)
  ...
  while ( 1 )
  {
    *((_DWORD *)this + 24) += *((_DWORD *)this + 25);
    ...
    else
    {
      ...
      v10 = this;
      v11 = (int *)(*((_QWORD *)this + 18) + 32LL);
    }
    if ( !(unsigned int)XCLIPOBJ::bRecordRun(v10, v11) )
      return 1LL;
