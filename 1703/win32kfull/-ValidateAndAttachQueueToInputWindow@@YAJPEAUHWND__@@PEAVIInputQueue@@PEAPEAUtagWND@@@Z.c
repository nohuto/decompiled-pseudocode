/*
 * XREFs of ?ValidateAndAttachQueueToInputWindow@@YAJPEAUHWND__@@PEAVIInputQueue@@PEAPEAUtagWND@@@Z @ 0x1C001AD5C
 * Callers:
 *     UserValidateAndAttachQueueToInputWindowApiExt @ 0x1C001AD50 (UserValidateAndAttachQueueToInputWindowApiExt.c)
 * Callees:
...
__int64 __fastcall ValidateAndAttachQueueToInputWindow(HWND a1, struct IInputQueue *a2, struct tagWND **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    CurrentProcessWin32Process = (_QWORD *)PsGetCurrentProcessWin32Process(v9, v8);
    v14 = *(_QWORD **)(v12 + 16);
    ...
    if ( CurrentProcessWin32Process == (_QWORD *)v14[47]
      ...
      || v14[158] == GetAncestor(v12, 1) && (v18 = v14[159]) != 0 && v15 == *(_QWORD **)(*(_QWORD *)(v18 + 16) + 376LL) )
    {
