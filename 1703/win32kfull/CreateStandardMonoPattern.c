/*
 * XREFs of CreateStandardMonoPattern @ 0x1C01309F8
 * Callers:
 *     GetCachedSMP @ 0x1C00F41D4 (GetCachedSMP.c)
 *     FindCachedSMP @ 0x1C00F43A0 (FindCachedSMP.c)
 * Callees:
      ...
      if ( (unsigned __int8)v5 > 2u )
      {
        if ( (unsigned __int8)v5 <= 0x11u )
        {
          ...
          if ( v34 == 2 )
          {
            ...
            for ( i = (unsigned __int16)v16 >> 1; i; v28 -= 2 * v40 )
            {
              --i;
              for ( j = v40; j; --j )
              {
...
LABEL_35:
    ...
    if ( v5 != 1 )
    {
      ...
      if ( (_WORD)v23 )
        v24 = v23;
      memset(&Src[v40 * (((unsigned __int16)v16 - v24) >> 1)], 255, v40 * v24);
    }
    goto LABEL_34;
  }
