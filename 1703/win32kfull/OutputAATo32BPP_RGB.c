/*
 * XREFs of OutputAATo32BPP_RGB @ 0x1C00A33D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall OutputAATo32BPP_RGB(unsigned int *a1, __int64 a2, unsigned __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( (result & 0x80u) != 0LL )
  {
    if ( (unsigned __int64)v6 < a3 )
    {
      ...
      do
      {
        if ( v6[3] )
        {
          v10[1] = ~*(_BYTE *)(a5 + 4LL * v6[2] + 2048);
          *v10 = ~*(_BYTE *)(a5 + 4LL * v6[1] + 1024);
          result = *v6;
  ...
  else if ( (unsigned __int64)v6 < a3 )
  {
    ...
    {
      v8 += 4LL;
      *(_BYTE *)(v8 - 3) = ~*(_BYTE *)(a5 + 4LL * v6[2] + 2048);
      *(_BYTE *)(v8 - 4) = ~*(_BYTE *)(a5 + 4LL * v6[1] + 1024);
      result = *v6;
