/*
 * XREFs of ?zzzJournalAttach@@YAHPEAUtagTHREADINFO@@H@Z @ 0x1C01C0F70
 * Callers:
 *     zzzUnhookWindowsHookEx @ 0x1C00D9098 (zzzUnhookWindowsHookEx.c)
 *     zzzSetWindowsHookEx @ 0x1C00E45A4 (zzzSetWindowsHookEx.c)
 *     zzzRegisterSystemThread @ 0x1C0139B10 (zzzRegisterSystemThread.c)
 * Callees:
