/*
 * XREFs of ??0MULTISPRITEDDIACCESS@@QEAA@AEAVPDEVOBJ@@@Z @ 0x1C00A7C58
 * Callers:
    ...
    *(_QWORD *)this = v5;
    if ( *(_DWORD *)(v5 + 68) )
    {
      ...
      do
      {
        ...
        if ( !*(_DWORD *)(v7 + 168) && (*(_DWORD *)(v7 + 32) & 0x20000) == 0 )
          vSpDirectDriverAccess((struct _SPRITESTATE *)(v7 + 72), 1);
        v6 = (unsigned int)(v6 + 1);
      }
      while ( (unsigned int)v6 < *(_DWORD *)(*(_QWORD *)this + 68LL) );
    }
    else if ( !*(_DWORD *)(v5 + 96) && (*(_DWORD *)(*(_QWORD *)a2 + 32LL) & 0x20000) == 0 )
    {
