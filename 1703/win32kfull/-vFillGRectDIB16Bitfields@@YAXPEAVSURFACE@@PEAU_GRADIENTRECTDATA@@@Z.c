/*
 * XREFs of ?vFillGRectDIB16Bitfields@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02ABC60
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vFillGRectDIB16Bitfields(struct SURFACE *a1, struct _GRADIENTRECTDATA *a2)
{
  ...
  if ( v2 < v5 )
  {
    ...
    do
    {
      ...
      v16 = v10;
      v17 = v11;
      v38 = 0x1C0000000LL + 16LL * (((_BYTE)v14 + (_BYTE)v2) & 3) + 3318832;
      v18 = *((int *)v3 + 44);
      if ( (_DWORD)v18 )
      {
        v15 = v9 + v33 * v18;
      ...
      if ( v23 )
      {
        ...
        do
        {
          v27 = *(_DWORD *)(v38 + 4LL * (v25 & 3));
          v28 = XEPALOBJ::ulDispatchGFPEFunction(
                  v39,
                  *(unsigned int *)(*(_QWORD *)v39 + 100LL),
                  8
