/*
 * XREFs of ?vInit@PRECOMPUTE@@QEAAXPEAVSURFACE@@PEAVPDEVOBJ@@PEAVEPATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_LINEATTRS@@KKW4PRECOMPUTETYPE@@@Z @ 0x1C01258A4
 * Callers:
 ...
 *     ??1RGNMEMOBJ@@QEAA@XZ @ 0x1C009C094 (--1RGNMEMOBJ@@QEAA@XZ.c)
        ...
        int a10)
{
  ...
  *(_DWORD *)(a4 + 64) = 0;
  *(_QWORD *)(a4 + 72) = 0LL;
  if ( (*(_DWORD *)(*(_QWORD *)a3 + 32LL) & 0x8000) != 0
