/*
 * XREFs of xxxPointerCallHook @ 0x1C00071B4
 * Callers:
...
__int64 __fastcall xxxPointerCallHook(int a1, int a2, __int64 a3, unsigned int a4, unsigned int a5)
{
  ...
  if ( !ThreadPointerData || (unsigned int)IsPointerMsgRedirected(ThreadPointerData, &v22) && !v22 )
    return a5;
  switch ( a4 )
  {
    case 3u:
      ThreadPointerHookData = MakeThreadPointerHookData((struct tagTHREADINPUTPOINTERLIST *)(gptiCurrent + 968LL), *v9);
