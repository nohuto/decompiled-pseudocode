/*
 * XREFs of ?SecureConnectPort@PROXYPORT@@QEAAJPEAPEAXPEAU_UNICODE_STRING@@PEAU_SECURITY_QUALITY_OF_SERVICE@@PEAU_PORT_VIEW@@PEAXPEAU_REMOTE_PORT_VIEW@@PEAK46@Z @ 0x1C0038BE4
 * Callers:
        ...
        unsigned int *MaxMessageLength)
{
  ...
  _DWORD v19[2]; // [rsp+58h] [rbp-51h] BYREF
  PVOID Object; // [rsp+60h] [rbp-49h] BYREF
  PVOID v21; // [rsp+68h] [rbp-41h] BYREF
  ...
  if ( v12 >= 0 )
  {
    v13 = ObReferenceObjectByHandle(ClientView->SectionHandle, 6u, MmSectionObjectType, 0, &v21, 0LL);
    v15 = v21;
    v12 = v13;
    if ( v13 < 0
      || (v19[0] = ClientView->SectionOffset,
          v19[1] = 0,
