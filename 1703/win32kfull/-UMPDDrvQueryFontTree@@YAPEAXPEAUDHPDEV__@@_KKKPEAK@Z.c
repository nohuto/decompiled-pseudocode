/*
 * XREFs of ?UMPDDrvQueryFontTree@@YAPEAXPEAUDHPDEV__@@_KKKPEAK@Z @ 0x1C028A540
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bSandboxedClient@UMPDOBJ@@QEAAHXZ @ 0x1C013C280 (-bSandboxedClient@UMPDOBJ@@QEAAHXZ.c)
...
LABEL_28:
  ...
  if ( Src[6] )
  {
    LODWORD(Size) = 8;
    v14 = -1;
    if ( (unsigned int)UMPDOBJ::Thunk(v11, Src, 0x48u, &v27, Size) != -1 )
    {
      v15 = (WCRUN *)v27;
      if ( v27 )
      {
