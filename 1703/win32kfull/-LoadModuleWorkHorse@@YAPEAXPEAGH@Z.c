/*
 * XREFs of ?LoadModuleWorkHorse@@YAPEAXPEAGH@Z @ 0x1C0269C38
 * Callers:
 *     EngLoadModule @ 0x1C026A720 (EngLoadModule.c)
 *     EngLoadModuleForWrite @ 0x1C026A730 (EngLoadModuleForWrite.c)
 * Callees:
 *     PALLOCMEM2 @ 0x1C002CB34 (PALLOCMEM2.c)
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x1C002DCAC (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
 *     ?GetModuleHandleAndIncrementRefcount@@YAPEAXPEAG@Z @ 0x1C0269B88 (-GetModuleHandleAndIncrementRefcount@@YAPEAXPEAG@Z.c)
      ...
      if ( (unsigned int)MakeSystemRelativePath((PCWSTR)Source, &Destination) )
      {
        ...
        if ( v9 )
        {
          ...
          if ( (unsigned int)bMapFile(Destination.Buffer, &v9[v8 + 24], a2, 0LL) )
          {
            ...
            {
              StringCchCopyW(v10, (unsigned __int64)(unsigned int)v8 >> 1, Source);
            }
            v17 = GreEngLoadModuleAllocListLock;
            *((_DWORD *)v11 + 4) = 1;
            *((_DWORD *)v11 + 5) = v8 + 24;
            ...
            *((_QWORD *)v11 + 1) = Blink;
            ...
            if ( v19 )
            {
              EtwTraceGreLockReleaseSemaphore(L"GreEngLoadModuleAllocListLock", v19);
