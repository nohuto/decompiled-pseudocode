/*
 * XREFs of ?TraceLoggingPTPKeyToGestureTiming@@YAX_J0PEBUtagTPTELEMTIMINGS@@00@Z @ 0x1C0196E84
 * Callers:
        ...
        LPCGUID pActivityId)
{
  ...
  if ( dword_1C0324850 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0324850, 0x200000000000uLL) )
    {
      ...
      v52 = &v23;
      TlgWrite((TraceLoggingHProvider)&dword_1C0324850, &unk_1C02EB3DB, pActivityId, v6, 0xCu, &pData);
    }
  }
}
