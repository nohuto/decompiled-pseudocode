/*
 * XREFs of ?vFillGRectDIB4@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02AD530
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Xlate555 )
  {
    ...
    if ( v2 < v47 )
    {
      ...
      do
      {
        ...
        v21 = v15;
        v22 = *((int *)v3 + 44);
        v41 = (char *)&gDitherMatrix16x16Default + 16 * (((_BYTE)v2 + (_BYTE)v17) & 0xFu);
        v23 = v16;
        if ( (_DWORD)v22 )
        {
          v20 = v14 + v18 * v22;
        ...
        if ( v24 < v30 )
        {
          ...
          do
          {
            ...
            v28 = v11[Xlate555[((unsigned __int64)DefaultSaturationTable[v27 + BYTE6(v23)] >> 3) | (4
                                                                                                  * (DefaultSaturationTable[v27 + BYTE6(v21)] & 0xF8 | (32LL * (DefaultSaturationTable[v27 + BYTE6(v20)] & 0xF8))))]];
            v29 = *v25;
            if ( (v24 & 1) != 0 )
              *v25++ = v28 | v29 & 0xF0;
            else
