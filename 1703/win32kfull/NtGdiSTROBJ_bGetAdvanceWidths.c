/*
 * XREFs of NtGdiSTROBJ_bGetAdvanceWidths @ 0x1C0293AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiSTROBJ_bGetAdvanceWidths(__int64 a1, ULONG a2, unsigned int a3, char *a4)
{
  __int64 v5; // r14
  ...
  {
    v15 = &a4[16 * v5];
    if ( (unsigned __int64)v15 > W32UserProbeAddress || v15 <= a4 || ((unsigned __int8)a4 & 7) != 0 )
