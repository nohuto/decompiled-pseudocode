/*
 * XREFs of SfnINSTRINGNULL @ 0x1C0039AF0
 * Callers:
        ...
        char a7)
{
  ...
  if ( v11 )
  {
    v9 = (unsigned __int8 *)AllocCallbackMessage(0x58u, v11, (unsigned int)v12, v42, 1, 0x200uLL);
    if ( !v9 )
      return 0LL;
  }
  else
  ...
  *((_QWORD *)v9 + 7) = RegionSize[0];
  if ( v11 )
  {
    ...
    if ( a4[1] >= 0x80000000 )
    {
      ...
      v31 = CaptureUnicodeCallbackData((struct _CAPTUREBUF *)v9, v29, 2 * v28 + 2, v27);
    }
    else
    {
      if ( (a7 & 1) == 0 )
      {
        v30 = v28 + 2;
LABEL_40:
        v31 = CaptureCallbackData((struct _CAPTUREBUF *)v9, v29, v30, v27);
        goto LABEL_41;
      }
      v31 = CaptureAnsiCallbackData((struct _CAPTUREBUF *)v9, (PCWCH)v29, (v28 >> 1) + 1, v27);
    }
LABEL_41:
    if ( v31 < 0 )
      goto LABEL_55;
...
LABEL_13:
  ...
  *((_QWORD *)v9 + 2) = 0LL;
  v19 = KeUserModeCallback(27LL, v9, *(unsigned int *)v9, &v35, v33);
