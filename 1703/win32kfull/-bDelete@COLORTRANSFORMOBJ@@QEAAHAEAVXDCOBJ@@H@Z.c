/*
 * XREFs of ?bDelete@COLORTRANSFORMOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C0273C54
 * Callers:
 *     XDCOBJ_vCleanupColorTransformWrap @ 0x1C00E1430 (XDCOBJ_vCleanupColorTransformWrap.c)
 ...
 *     ?bRemoveColorTransform@XDCOBJ@@QEAAHPEAX@Z @ 0x1C0273D8C (-bRemoveColorTransform@XDCOBJ@@QEAAHPEAX@Z.c)
 */
