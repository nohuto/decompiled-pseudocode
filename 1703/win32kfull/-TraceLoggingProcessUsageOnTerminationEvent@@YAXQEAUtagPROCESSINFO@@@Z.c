/*
 * XREFs of ?TraceLoggingProcessUsageOnTerminationEvent@@YAXQEAUtagPROCESSINFO@@@Z @ 0x1C00B9E34
 * Callers:
 *     DestroyProcessInfoEditionRundown @ 0x1C00B9DE0 (DestroyProcessInfoEditionRundown.c)
 * Callees:
...
void __fastcall TraceLoggingProcessUsageOnTerminationEvent(struct tagPROCESSINFO *const a1)
{
  ...
  if ( dword_1C0324850 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0324850, 0x400000000000uLL) )
    {
      ...
      v14 = -__CFSHR__(v4, 3);
      v42 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0324850, &unk_1C02EB86B, v5, v6, 0x10u, &pData);
    }
  }
}
