/*
 * XREFs of ?xxxWindowHitTestWithoutTargeting@@YAPEAUHWND__@@PEAUtagTHREADINFO@@PEAUtagWND@@I_K_JUtagPOINT@@PEAHKPEBUtagPOINTEREVENTINT@@PEAU4@@Z @ 0x1C01D14A8
 * Callers:
        ...
        unsigned int a8)
{
  ...
  if ( !(unsigned int)IsThreadDesktopComposed((__int64)a1) )
    return (HWND)xxxWindowHitTest((__int64)v10);
  v14 = a5;
  v15 = a7;
  v12 = v8;
  v17 = 0;
  ...
  v16 = a8;
  v13 = v9;
  return xxxDCEWindowHitTestIndirect(v10, a6, (__int64)&v12);
}
