/*
 * XREFs of ?LogFontLoadAttempt@@YAXPEAXW4_W32KFontSourceType@@PEBGH@Z @ 0x1C0249810
 * Callers:
...
char __fastcall LogFontLoadAttempt(void *a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  unsigned int v13; // [rsp+38h] [rbp-31h] BYREF
  ...
  {
    result = TlgKeywordOn((TraceLoggingHProvider)&dword_1C0324850, 0x200000000000uLL);
    if ( result )
    {
      v17 = 0;
      v20 = 0;
      ...
      v16 = 4;
      v19 = 4;
      result = TlgWrite((TraceLoggingHProvider)&dword_1C0324850, &unk_1C02ECEE9, v10, v11, 4u, &pData);
    }
  }
  if ( v7 )
