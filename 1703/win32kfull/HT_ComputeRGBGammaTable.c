/*
 * XREFs of HT_ComputeRGBGammaTable @ 0x1C023C8A0
 * Callers:
 *     <none>
 * Callees:
        ...
        LPBYTE pGammaTable)
{
  ...
  LONG v22; // [rsp+28h] [rbp-30h]
  signed int v23; // [rsp+60h] [rbp+8h]
  ...
  if ( v18 )
  {
    do
    {
      *v15 = (char)(32 - RaisePower(v11, v23, 1)) / 64;
      *v16 = (char)(32 - RaisePower(v11, v21, 1)) / 64;
      v19 = RaisePower(v11, 100 * (unsigned int)BlueGamma, 1);
      v15 += v12;
      v16 += v12;
      v11 += v13;
      *v17 = (255 * v19 + 500000) / 1000000;
      v17 += v12;
      --v18;
    }
    while ( v18 );
