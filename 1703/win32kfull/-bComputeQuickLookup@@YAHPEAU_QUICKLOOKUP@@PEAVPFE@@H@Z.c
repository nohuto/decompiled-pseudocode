/*
 * XREFs of ?bComputeQuickLookup@@YAHPEAU_QUICKLOOKUP@@PEAVPFE@@H@Z @ 0x1C00E3714
 * Callers:
        ...
        if ( *v16 )
        {
          if ( v9->cRuns )
          {
            do
            {
              ...
              v20 = (v9->awcrun[v3].wcLow + cGlyphs - v7 - 1) / 32;
              v21 = v20;
              if ( (_DWORD)v19 == v20 )
              {
              ...
              else
              {
                ...
                *((_DWORD *)*v16 + v21) |= -1 << (31 - (v9->awcrun[v3].cGlyphs - v7 + v9->awcrun[v3].wcLow - 1) % 32);
              }
              ++v3;
            }
            while ( v3 < v9->cRuns );
