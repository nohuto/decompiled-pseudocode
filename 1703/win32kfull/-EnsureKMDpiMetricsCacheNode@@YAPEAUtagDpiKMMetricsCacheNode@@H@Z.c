/*
 * XREFs of ?EnsureKMDpiMetricsCacheNode@@YAPEAUtagDpiKMMetricsCacheNode@@H@Z @ 0x1C01C3BE4
 * Callers:
...
LABEL_7:
  ...
  {
    if ( (__int64)++v4 >= (__int64)dword_1C02E36B8 )
      goto LABEL_13;
  }
  v5 = Win32AllocPoolZInit(216LL, 1768973397LL);
