/*
 * XREFs of vSrcTranCopyS1D8 @ 0x1C012E7D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  *(_QWORD *)v49 = a5 & 7;
  ...
  if ( (a6 & 0xFFFFFFF8) != (a5 & 0xFFFFFFF8) )
  {
    ...
    do
    {
      ...
      {
        v22 = 0x101010101010101LL * a9;
        v39 = dword_1C02EA850[(unsigned __int64)(unsigned __int8)v21 >> 4] | ((unsigned __int64)dword_1C02EA850[(unsigned __int8)v48 & *v19 & 0xF] << 32);
      ...
      if ( v31 != *(_QWORD *)&v49[4] )
      {
        do
        {
          ...
          {
            v27 = v49[4];
            v38 = dword_1C02EA850[(unsigned __int64)(unsigned __int8)*v29 >> 4] | ((unsigned __int64)dword_1C02EA850[*v29 & 0xF] << 32);
            v21 = v22 & v38 | *(_QWORD *)v28 & ~v38;
            *(_QWORD *)v28 = v21;
          }
          ++v29;
          v28 += 8;
