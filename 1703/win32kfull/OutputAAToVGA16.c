/*
 * XREFs of OutputAAToVGA16 @ 0x1C0240D80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a9)
{
  ...
  if ( (_BYTE)a9 )
  {
    v12 = a2 + 4;
    if ( a2[7] )
      *a4 = *a4 & 0xF0 | VGA16Xlate[((HIDWORD(v22) & (*(_DWORD *)(a5 + 4LL * *v12) - (unsigned int)*a6) | (unsigned int)v23 & (*(_DWORD *)(a5 + 4LL * v12[1] + 1024) - a6[1]) | (unsigned __int64)(HIDWORD(v23) & (*(_DWORD *)(a5 + 4LL * v12[2] + 2048) - (unsigned int)a6[2]))) ^ 0x70000) >> 16];
    ++a4;
    v10 = a6 + 3;
...
LABEL_15:
    ...
    LOBYTE(v13) = v18 | VGA16Xlate[v17 >> 16];
    goto LABEL_15;
  }
...
LABEL_25:
  if ( HIBYTE(a9) && v14[3] )
  {
    LOBYTE(v13) = *a4 & 0xF | VGA16Xlate[(((unsigned int)v22 & (*(_DWORD *)(a5 + 4LL * *v14) - *v10) | DWORD1(v22) & (*(_DWORD *)(a5 + 4LL * v14[1] + 1024) - (unsigned int)v10[1]) | (unsigned __int64)(DWORD2(v22) & (*(_DWORD *)(a5 + 4LL * v14[2] + 2048) - (unsigned int)v10[2]))) ^ 0x700000) >> 16];
    *a4 = v13;
  }
  return v13;
}
