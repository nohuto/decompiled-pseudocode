/*
 * XREFs of vSpDynamicModeChange @ 0x1C00A78A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z @ 0x1C00A7D20 (-vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z.c)
...
void __fastcall vSpDynamicModeChange(HDEV a1, HDEV a2)
{
  ...
  *((_DWORD *)v5 + 276) = 0;
  ...
  v44 = (_DWORD)v70[8] & 0x20000;
  if ( v44 && ((_DWORD)v69[8] & 0x20000) != 0 )
  {
    v49 = *((_QWORD *)v8 + 10);
    if ( v49 )
    {
      ...
      {
        v50 = *(_QWORD *)(v49 + 16);
        v51 = pSpTransferMetaSprite(v2, a1, (struct _METASPRITE *)v49);
        if ( v51 )
          *(_DWORD *)v51 |= 2u;
        v49 = v50;
      }
      ...
      do
      {
        ...
        if ( (*(_DWORD *)v52 & 2) != 0 )
          *(_DWORD *)v52 &= ~2u;
          ...
          pSpTransferMetaSprite(a1, v2, (struct _METASPRITE *)v52);
        v52 = v53;
      }
      while ( v53 );
    }
LABEL_18:
    if ( ((_DWORD)v70[8] & 0x20000) != 0 )
      vFixupMetaSpriteList((struct PDEVOBJ *)&v70);
    if ( ((_DWORD)v69[8] & 0x20000) != 0 )
  ...
  if ( !v44 && ((_DWORD)v69[8] & 0x20000) == 0 )
  {
    ...
    if ( v45 )
    {
      ...
      {
        v54 = *(_QWORD *)(v45 + 24);
        v55 = pSpTransferSprite(v2, (struct SPRITE *)v45);
        if ( v55 )
          *(_DWORD *)v55 |= 2u;
        v45 = v54;
      }
      ...
      do
      {
        ...
        if ( (*(_DWORD *)v46 & 2) != 0 )
          *(_DWORD *)v46 &= ~2u;
          ...
          pSpTransferSprite(a1, (struct SPRITE *)v46);
        v46 = v56;
      }
      while ( v56 );
    }
...
LABEL_53:
    ...
    if ( v61 )
    {
      ...
      {
        v62 = *(_QWORD *)(v61 + 24);
        v63 = pSpConvertSpriteToMeta(v57, v2, (struct SPRITE *)v61);
        if ( v63 )
          *(_DWORD *)v63 |= 2u;
        v61 = v62;
      }
      ...
      do
      {
        ...
        if ( (*(_DWORD *)v64 & 2) != 0 )
          *(_DWORD *)v64 &= ~2u;
          ...
          pSpConvertSpriteFromMeta(v2, v57, (struct _METASPRITE *)v64);
        v64 = v65;
      }
      while ( v65 );
    }
