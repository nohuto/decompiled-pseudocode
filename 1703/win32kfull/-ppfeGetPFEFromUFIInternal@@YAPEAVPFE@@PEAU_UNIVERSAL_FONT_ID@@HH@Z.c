/*
 * XREFs of ?ppfeGetPFEFromUFIInternal@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z @ 0x1C002C9D0
 * Callers:
 ...
 *     ?ppfeGetPFEFromUFI@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z @ 0x1C0255720 (-ppfeGetPFEFromUFI@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z.c)
 * Callees:
 ...
 *     ?SameProccess@PFEOBJ@@QEAAHXZ @ 0x1C002FEC0 (-SameProccess@PFEOBJ@@QEAAHXZ.c)
 */
...
struct PFE *__fastcall ppfeGetPFEFromUFIInternal(struct _UNIVERSAL_FONT_ID *a1, int a2, int a3)
{
  ...
  if ( v8 )
  {
    v19[0] = v8 + 2;
    v19[1] = v8[2];
    v9 = FHOBJ::pbktSearch((FHOBJ *)v19, 0LL, 0LL, a1, 0);
    if ( v9 )
    {
      for ( i = (_QWORD *)*((_QWORD *)v9 + 1); i; i = (_QWORD *)*i )
      {
        ...
        if ( *(_DWORD *)(v11 + 92) == v12
          ...
          && (!a3 || (unsigned int)PFEOBJ::SameProccess((PFEOBJ *)&v20)) )
        {
          v13 = *(_DWORD *)(v11 + 12);
          if ( (v13 & 2) == 0 )
          {
