/*
 * XREFs of ?_InertiaRegionIntersectsTopEdge@Edgy@@YAHPEBUINERTIA_INFO_INTERNAL@@PEBUtagRECT@@@Z @ 0x1C01CE478
 * Callers:
 ...
 *     GetInertiaRegionInVirtualizedScreen @ 0x1C020A690 (GetInertiaRegionInVirtualizedScreen.c)
 */
