/*
 * XREFs of VertCrossings @ 0x1C02CD324
 * Callers:
...
__int64 __fastcall VertCrossings(int a1, __int16 a2)
{
  ...
  if ( a1 < dword_1C0338B28 || a1 >= dword_1C0338B2C )
    return 0LL;
  v3 = 0;
  v4 = a1 - dword_1C0338B28;
  v5 = *(_WORD **)(qword_1C0338B98 + 8LL * v4);
  v6 = *(__int16 **)(qword_1C0338BA0 + 8LL * v4);
  v7 = *(_QWORD *)(qword_1C0338BA8 + 8LL * v4);
