/*
 * XREFs of HorizCrossings @ 0x1C02CD090
 * Callers:
...
__int64 __fastcall HorizCrossings(__int16 a1, int a2)
{
  ...
  if ( a2 < dword_1C0338B40 || a2 >= dword_1C0338B3C )
    return 0LL;
  v3 = 0;
  v4 = a2 - dword_1C0338B40;
  v5 = *(_WORD **)(qword_1C0338B58 + 8LL * v4);
  v6 = *(__int16 **)(qword_1C0338B60 + 8LL * v4);
  v7 = *(_QWORD *)(qword_1C0338B68 + 8LL * v4);
  if ( (unsigned __int64)v5 < v7 )
  {
    v8 = 2LL * (__int16)dword_1C0338C32;
    do
    {
      v9 = v3 + 1;
      v10 = *v6;
