/*
 * XREFs of xxxPerformTargetingWithinPwnd @ 0x1C01D1F44
 * Callers:
 ...
 *     PerformTargetingWithinPwnd @ 0x1C01D1840 (PerformTargetingWithinPwnd.c)
 * Callees:
...
__int64 __fastcall xxxPerformTargetingWithinPwnd(ULONG_PTR a1, __int64 a2, _DWORD *a3)
{
  __int64 result; // rax
  __int128 *v7; // r14
  __int64 v8; // r8
  ...
  *a3 = 0;
  a3[1] = 0;
  result = GetProp(a1, gatomPtrTargetFlags, 1);
  if ( (result & 0xFFFD) != 0 )
  {
    ...
    if ( (_DWORD)result )
    {
      ...
      if ( v26 )
      {
        if ( v27 )
        {
          ...
          v11 = xxxSendTransformableMessageTimeout(a1, 0x24Du, 0LL, (struct _LARGE_STRING *)&v17, 0, 0, 0LL, 1, 0);
          result = 4093LL;
