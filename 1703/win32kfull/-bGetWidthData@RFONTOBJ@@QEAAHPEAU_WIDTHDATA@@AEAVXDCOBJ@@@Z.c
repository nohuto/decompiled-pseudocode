/*
 * XREFs of ?bGetWidthData@RFONTOBJ@@QEAAHPEAU_WIDTHDATA@@AEAVXDCOBJ@@@Z @ 0x1C008C9B8
 * Callers:
...
__int64 __fastcall RFONTOBJ::bGetWidthData(RFONTOBJ *this, struct _WIDTHDATA *a2, struct XDCOBJ *a3)
{
  ...
  if ( (unsigned __int8)v13 <= 8u && (v14 = 323, _bittest(&v14, v13)) )
  {
    ...
    {
      v19 = 12288;
      while ( (unsigned int)RFONTOBJ::bGetGlyphMetrics(this, (struct RFONTOBJ *)1, &v18, &v19, a3, 0LL)
           && v18.hg != *(_DWORD *)(*(_QWORD *)this + 456LL) )
      {
        v7 = (unsigned int)(v7 + 1);
        v19 = word_1C02F36A8[v7];
        if ( !v19 )
        {
          LODWORD(v17) = 0;
          LODWORD(v7) = WORD2(v18.pgdf[1].ppo);
          v19 = 12450;
          while ( (unsigned int)RFONTOBJ::bGetGlyphMetrics(this, (struct RFONTOBJ *)1, &v18, &v19, 0LL, 0LL) )
          {
            if ( WORD2(v18.pgdf[1].ppo) > (int)v7 )
              LODWORD(v7) = WORD2(v18.pgdf[1].ppo);
            v17 = (unsigned int)(v17 + 1);
            v19 = word_1C02F3698[v17];
            if ( !v19 )
            {
