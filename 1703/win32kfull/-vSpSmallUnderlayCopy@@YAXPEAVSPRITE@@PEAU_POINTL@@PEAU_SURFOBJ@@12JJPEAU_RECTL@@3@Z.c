/*
 * XREFs of ?vSpSmallUnderlayCopy@@YAXPEAVSPRITE@@PEAU_POINTL@@PEAU_SURFOBJ@@12JJPEAU_RECTL@@3@Z @ 0x1C0263F3C
 * Callers:
        ...
        struct _RECTL *a9)
{
  ...
  v11 = *((_QWORD *)a1 + 2);
  if ( (*(_DWORD *)(*(_QWORD *)v11 + 32LL) & 0x400) == 0 )
  {
...
LABEL_53:
      v17 = 0;
      v28 = cSpSubtract(a8, a9, v34);
      do
        vSpReadFromScreen((struct _SPRITESTATE *)v11, v16, a3, &v34[v17++]);
      while ( v17 != v28 );
      v18 = a8;
      for ( i = pSpFindInZ(*(struct SPRITE **)(v11 + 16), a8); ; i = pSpFindInZ(*((struct SPRITE **)v27 + 3), v18) )
      {
        v27 = i;
        if ( !i )
          return;
...
LABEL_93:
            ...
            if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(a3) + 112) & 0x400) == 0 )
              goto LABEL_102;
            v26 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)a3->hdev + 166);
          }
          else
          {
            if ( v24->iType == 1
...
LABEL_102:
            ...
            v26 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(*((_QWORD *)v27 + 20) + 24LL) + 1328LL);
          }
LABEL_103:
          OffCopyBits(
...
LABEL_28:
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(a5) + 112) & 0x400) != 0 )
        {
          hdev = a5->hdev;
LABEL_46:
          v15 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)hdev + 166);
          goto LABEL_48;
        }
        goto LABEL_47;
      }
