/*
 * XREFs of ?vSrcCopyS32D16@@YAXPEAUBLTINFO@@@Z @ 0x1C02A6B00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_22:
    ...
    for ( i = v20; ; v20 = i )
    {
      ...
      do
      {
        *v5 = v20((struct _XLATEOBJ *)v2, *(_DWORD *)v4);
        v4 += 4;
        ++v5;
        --v21;
      }
  ...
  while ( 1 )
  {
    ...
    if ( v16 >= 0 )
    {
      ...
      do
      {
        v18 = *v4 >> 3;
        v19 = 4
            * ((v4[1] | (v4[4] << 11)) & 0x1F07C0F8 | (32
                                                     * (((v4[6] & 0xF8) << 16) | (v4[2] | ((v4[5] & 0xF8) << 11)) & 0x7C0F8)));
        v4 += 8;
        *(_DWORD *)v5 = v18 | v19;
        v5 += 2;
        --v17;
