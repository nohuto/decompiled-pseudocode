/*
 * XREFs of ?vPatCpyRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02A2BD0
 * Callers:
 *     <none>
 * Callees:
 *     vFetchAndCopy @ 0x1C02B6D94 (vFetchAndCopy.c)
 *     vFetchShiftAndCopy @ 0x1C02B6E64 (vFetchShiftAndCopy.c)
 */
    ...
    do
    {
      ...
      else
      {
        ...
        if ( v16 )
        {
          ...
          v15 %= v21;
          v23 = v21;
          if ( (((unsigned __int8)v17 | (unsigned __int8)v21) & 3) != 0 )
          {
            vFetchShiftAndCopy(&v18);
          }
          else
          {
            v23 = v21 >> 2;
            vFetchAndCopy(&v18, v17);
          }
          v14 = v24;
          v9 = v19;
          v16 = v22;
        ...
        if ( v25 )
          *(_DWORD *)(v11 + v6) = *(_DWORD *)(v11 + v6) & ~v14 | v14 & *(_DWORD *)(((int)v15 + 4 * (unsigned __int64)v16)
                                                                                 % *((unsigned int *)a1 + 10)
                                                                                 + v9);
      }
      if ( ++v8 == *((_DWORD *)a1 + 11) )
