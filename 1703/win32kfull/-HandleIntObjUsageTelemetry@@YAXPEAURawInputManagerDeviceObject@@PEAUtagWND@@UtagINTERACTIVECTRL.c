/*
 * XREFs of ?HandleIntObjUsageTelemetry@@YAXPEAURawInputManagerDeviceObject@@PEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYPE@@@Z @ 0x1C0220FF4
 * Callers:
 ...
 *     ?ProcessGetAppSessionGuid@@YA?AU_GUID@@PEAUtagPROCESSINFO@@@Z @ 0x1C0221348 (-ProcessGetAppSessionGuid@@YA-AU_GUID@@PEAUtagPROCESSINFO@@@Z.c)
 *     ?UpdateIntObjUsage@@YAXPEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYPE@@_K@Z @ 0x1C02213A4 (-UpdateIntObjUsage@@YAXPEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYP.c)
 */
...
LABEL_16:
    ...
    if ( memcmp(&gIntObjTelemetryState, Buf2, 0x60uLL) )
    {
      ...
      {
        v18 = (struct tagINTOBJTELEMETRYSTATE *)(6LL * (((unsigned int)dword_1C0338954 >> 1) & 1));
        *(&gIntObjTelemetryState + 6 * (((unsigned int)dword_1C0338954 >> 1) & 1) + 5) = (struct tagINTOBJTELEMETRYSTATE near *)((char *)*(&gIntObjTelemetryState + 6 * (((unsigned int)dword_1C0338954 >> 1) & 1) + 5) + v11 - gmsInputStartTime);
      }
