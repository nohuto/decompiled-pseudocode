/*
 * XREFs of bSetDevPreviewRect @ 0x1C02668BC
 * Callers:
...
__int64 __fastcall bSetDevPreviewRect(HDEV a1, __int64 a2, _OWORD *a3, char a4, __int64 a5, __int64 a6)
{
  ...
  HDEV v26; // [rsp+58h] [rbp-51h] BYREF
  _OWORD *v27; // [rsp+60h] [rbp-49h]
  char v28[8]; // [rsp+68h] [rbp-41h] BYREF
  __int64 v29; // [rsp+70h] [rbp-39h] BYREF
  char v30[8]; // [rsp+78h] [rbp-31h] BYREF
  _BYTE v31[56]; // [rsp+80h] [rbp-29h] BYREF
