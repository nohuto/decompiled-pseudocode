/*
 * XREFs of FreeWindowGCData @ 0x1C005D7A4
 * Callers:
...
__int64 __fastcall FreeWindowGCData(struct tagWND *a1, unsigned __int64 a2, __int64 a3, int a4)
{
  ...
  result = VWPLRemoveBase(
             (struct tagVWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 376LL) + 816LL),
             a2,
             a1,
             a4,
  ...
  if ( (_DWORD)result )
  {
    ...
    if ( v10 )
    {
      ...
      Win32FreePool(v6);
      return VWPLRemoveBase((struct tagVWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 376LL) + 816LL), v8, a1, v9, 0LL);
    }
  }
  return result;
}
