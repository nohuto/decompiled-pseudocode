/*
 * XREFs of ?_OnInput@Edgy@@YA?AUtagSTATE_TRANSITION_DATA@1@AEAUtagEDGY_DATA@@PEAX@Z @ 0x1C01CE6FC
 * Callers:
...
__int64 __fastcall Edgy::_OnInput(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&v9 = *(_QWORD *)(ArcData + 48);
  v14[2] = v10;
  v15 = v9;
  v11 = dword_1C02EE1E0[(int)v6 + 1];
  if ( v8 < v11 )
  {
    v12 = (_DWORD *)((char *)&unk_1C02EE06C + 16 * v8);
