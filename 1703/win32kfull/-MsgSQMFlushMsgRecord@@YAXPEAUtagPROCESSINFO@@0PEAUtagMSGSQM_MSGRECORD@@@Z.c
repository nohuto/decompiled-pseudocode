/*
 * XREFs of ?MsgSQMFlushMsgRecord@@YAXPEAUtagPROCESSINFO@@0PEAUtagMSGSQM_MSGRECORD@@@Z @ 0x1C01E64AC
 * Callers:
        ...
        struct tagMSGSQM_MSGRECORD *a3)
{
  ...
  v3 = (const struct tagMSGSQM_PROCESSSQMINFO *)*((_QWORD *)a1 + 101);
  v5 = (const struct tagMSGSQM_PROCESSSQMINFO *)*((_QWORD *)a2 + 101);
  v6 = 0;
  if ( v3 || v5 )
  {
    v7 = *((_DWORD *)a3 + 6);
