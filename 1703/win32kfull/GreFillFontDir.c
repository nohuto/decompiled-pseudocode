/*
 * XREFs of GreFillFontDir @ 0x1C0297010
 * Callers:
...
__int64 __fastcall GreFillFontDir(__int64 a1, int a2, __int64 a3)
{
  ...
  *(_QWORD *)a3 = qword_1C0329D58;
  v25[0] = a1;
  *(_WORD *)(a3 + 8) = word_1C0329D60;
  ...
  *(_BYTE *)(a3 + 94) = ((*(_DWORD *)(a1 + 48) & 1) != 0 ? 6 : 0) | ((*(_DWORD *)(a1 + 48) & 0x401000) == 0) | *(_BYTE *)(a1 + 45) & 0xF0 | ((unsigned __int8)*(_DWORD *)(a1 + 48) >> 1) & 2;
  v8 = *(_WORD *)(a1 + 76);
  if ( !v8 )
    v8 = *(__int16 *)(a1 + 78) / 2;
  *(_BYTE *)(a3 + 95) = v8;
