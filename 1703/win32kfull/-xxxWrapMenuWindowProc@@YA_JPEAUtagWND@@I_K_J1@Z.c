/*
 * XREFs of ?xxxWrapMenuWindowProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C01BE8C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxWrapMenuWindowProc(struct tagWND *a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  int v4; // ebx
  int v5; // edi
  int v6; // esi
