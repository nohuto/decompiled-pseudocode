/*
 * XREFs of NtGdiGetGlyphIndicesWInternal @ 0x1C00FA150
 * Callers:
 *     NtGdiGetGlyphIndicesW @ 0x1C00FA120 (NtGdiGetGlyphIndicesW.c)
 * Callees:
...
__int64 __fastcall NtGdiGetGlyphIndicesWInternal(HDC a1, char *a2, int a3, char *a4, unsigned int a5, int a6)
{
  ...
  if ( v8 )
  {
    ...
    if ( (_DWORD)v7 != -1 )
    {
      ...
      {
        v11 = 2LL * (int)v7;
        if ( &a4[v11] <= a4 || (unsigned __int64)&a4[v11] > W32UserProbeAddress )
          *W32UserProbeAddress = 0;
        memmove(a4, v8, v11);
      }
    }
