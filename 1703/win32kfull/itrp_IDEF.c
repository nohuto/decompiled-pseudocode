/*
 * XREFs of itrp_IDEF @ 0x1C02D2730
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall itrp_IDEF(__int16 a1)
{
  ...
  v1 = *(unsigned __int8 *)(qword_1C032CA00 + 333);
  if ( *(unsigned __int8 *)(qword_1C032CA00 + 333) < 2u )
  {
    v3 = *(_QWORD *)(qword_1C032CA00 + 16 * v1 + 200);
    ...
    *(_DWORD *)IDef = (_DWORD)v7 - v3;
    ...
    if ( (unsigned __int64)v7 >= qword_1C032CA60 )
    {
      v13 = v7 + 1;
      if ( (unsigned __int64)(v7 + 1) <= qword_1C032CA58 && v13 >= v7 )
      {
        v14 = 45;
        while ( *v7 != v14 )
        {
