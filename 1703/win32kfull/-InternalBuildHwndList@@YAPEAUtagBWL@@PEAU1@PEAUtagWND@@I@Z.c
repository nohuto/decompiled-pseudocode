/*
 * XREFs of ?InternalBuildHwndList@@YAPEAUtagBWL@@PEAU1@PEAUtagWND@@I@Z @ 0x1C0068B20
 * Callers:
...
struct tagBWL *__fastcall InternalBuildHwndList(struct tagBWL *a1, struct tagWND *a2, __int64 a3)
{
  ...
  {
    v7 = *((_QWORD *)v5 + 3);
    if ( (!v6 || (unsigned int)IsNonImmersiveBand(v4, a2))
      && ((v3 & 0x40) == 0
       || (*((_BYTE *)v4 + 71) & 0x11) != 0x10
       || (*((_BYTE *)v4 + 60) & 0x40) != 0
       || !(unsigned int)IsWindowSubjectToShellWindowBehavior((__int64)v4, 127LL, a3))
      && (!v7 || v7 == *((_QWORD *)v4 + 2)) )
    {
