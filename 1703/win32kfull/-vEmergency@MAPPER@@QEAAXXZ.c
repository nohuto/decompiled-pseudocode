/*
 * XREFs of ?vEmergency@MAPPER@@QEAAXXZ @ 0x1C00563D0
 * Callers:
  ...
  *((_DWORD *)this + 45) = -2;
  ...
  for ( i = ENUMFHOBJ::ppfeFirst((ENUMFHOBJ *)v15); ; i = ENUMFHOBJ::ppfeNext((ENUMFHOBJ *)v15) )
  {
    ...
    if ( !i )
      break;
    v18 = i;
    if ( (unsigned int)MAPPER::bNearMatch(this, (struct PFEOBJ *)&v18, &v17, 1) )
    {
      v5 = v17;
...
LABEL_8:
  v12 = ulCharsetToCodePage(v5, v8, v9, *((_QWORD *)this + 29));
  *v13 |= v12 << 8;
}
