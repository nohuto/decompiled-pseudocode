/*
 * XREFs of vFill_RotateGLYPHDATA @ 0x1C0233958
 * Callers:
        ...
        if ( a3 )
        {
          ...
          *a3 = a2[1];
          ...
          for ( a3[3] = result; v27 < v26; ++v27 )
          {
            ...
            if ( v28 )
            {
              v32 = glyphBits[((_BYTE)v26 - (_BYTE)v27 - 1) & 7];
              do
              {
                v33 = v30 & 7;
          ...
          *a3 = -v19;
          ...
          if ( v21 )
          {
            do
            {
              ...
              {
                v25 = v23 & 7;
                if ( (*((_BYTE *)a2 + v22 * (v21 - v20 - 1) + ((unsigned __int64)(v19 - v23 - 1) >> 3) + 16) & glyphBits[((_BYTE)v19 - (_BYTE)v23 - 1) & 7]) != 0 )
                  *i |= glyphBits[v25];
                else
                  *i &= BitOFF[v25];
                ++v23;
