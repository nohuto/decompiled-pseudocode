/*
 * XREFs of InitializeWin32PoolTracking @ 0x1C011A630
 * Callers:
 *     <none>
 * Callees:
 *     ?IsWin32kRefreshed@@YA_NXZ @ 0x1C013BC6C (-IsWin32kRefreshed@@YA_NXZ.c)
 *     ?StopWin32PoolTracking@@YAXXZ @ 0x1C013BFD0 (-StopWin32PoolTracking@@YAXXZ.c)
 *     ?LoadWin32PoolTrackingSettings@@YAXXZ @ 0x1C01E8B74 (-LoadWin32PoolTrackingSettings@@YAXXZ.c)
 */
...
__int64 InitializeWin32PoolTracking()
{
  ...
  {
    gpLeakTrackingAllocator = &unk_1C02E5150;
    return 0LL;
  }
}
