/*
 * XREFs of GatherDeviceInfoSummaryInformation @ 0x1C0104FC0
 * Callers:
...
LABEL_16:
          v15 = gKeyboardInfo[2];
          *(_OWORD *)gKeyboardInfo = *(_OWORD *)(a1 + 456);
          *(_QWORD *)&gKeyboardInfo[8] = *(_QWORD *)(a1 + 472);
          *(_DWORD *)&gKeyboardInfo[12] = *(_DWORD *)(a1 + 480);
