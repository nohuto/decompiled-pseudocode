/*
 * XREFs of ?BasicTargetingHitTest@@YAHPEAUtagWND@@PEAUtagTOUCHTARGETINGCONTACT@@UtagPOINT@@PEAGPEAU3@HPEAUtagRECT@@W4tagTARGETING_PROPERTY@@HKH@Z @ 0x1C01CEC10
 * Callers:
        ...
        int a11)
{
  ...
  __int128 v33; // [rsp+68h] [rbp-41h] BYREF
  ...
  *(_QWORD *)a5 = 0LL;
  ...
  if ( a11 == v14 )
  {
    ...
    if ( v16 || !PtInRect(&v33, a3) )
    {
      if ( v20 && (*(_BYTE *)(a1 + 70) & 4) == 0 )
        return 0LL;
      v33 = v18;
      v34 = v18;
      v23 = TouchTargetingRankForRect((unsigned int)&v34, (unsigned int)&v33, v13, (_DWORD)a7, a5, v19);
      *a4 = v23;
      if ( v23 > 0xFFDu )
        return 0LL;
      v21 = 0LL;
