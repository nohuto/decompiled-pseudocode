/*
 * XREFs of ?GrepSfmGetDirtyRgn@@YAJPEAVSFMLOGICALSURFACE@@_KPEAPEAUHRGN__@@222PEAU_POINTL@@PEAH4@Z @ 0x1C002431C
 * Callers:
 *     GreSfmGetDirtyRgn @ 0x1C00241D0 (GreSfmGetDirtyRgn.c)
 * Callees:
    ...
    if ( a3 )
    {
      ...
      if ( v15 == a2 )
      {
        ...
        if ( a9 )
        {
          ...
          v21 = RGNOBJ::hrgnAssociate((RGNOBJ *)&a9);
          *a3 = v21;
          if ( v21 )
          {
            *((_QWORD *)a1 + 17) = 0LL;
...
LABEL_22:
    ...
    else
    {
      if ( v17 )
        ...
        v18 = (struct RGNOBJ *)&v32;
      RGNOBJ::bCopy((RGNOBJ *)&v29, v18);
    }
    v17 = a9;
LABEL_19:
    if ( v17 && (*((_DWORD *)a1 + 64) & 0x10) != 0 )
