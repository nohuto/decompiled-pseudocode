/*
 * XREFs of ?vSpOrderInY@@YAXPEAVSPRITE@@@Z @ 0x1C0261C84
 * Callers:
  ...
  if ( v1 && *(_DWORD *)(v1 + 84) > v2 )
  {
    ...
    *(_QWORD *)(v1 + 48) = a1;
    if ( i )
      ...
      *(_QWORD *)(*((_QWORD *)a1 + 2) + 32LL) = a1;
  }
  else
  {
    v5 = *((_QWORD *)a1 + 5);
    if ( v5 && *(_DWORD *)(v5 + 84) < v2 )
    {
      *(_QWORD *)(v5 + 48) = v1;
      if ( v1 )
        *(_QWORD *)(v1 + 40) = v5;
      else
        *(_QWORD *)(*((_QWORD *)a1 + 2) + 32LL) = v5;
      for ( j = *(_QWORD *)(v5 + 40); j && *(_DWORD *)(j + 84) < v2; j = *(_QWORD *)(j + 40) )
        v5 = j;
      *((_QWORD *)a1 + 6) = v5;
      *((_QWORD *)a1 + 5) = j;
      *(_QWORD *)(v5 + 40) = a1;
