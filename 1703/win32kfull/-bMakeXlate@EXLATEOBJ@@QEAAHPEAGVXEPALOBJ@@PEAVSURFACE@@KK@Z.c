/*
 * XREFs of ?bMakeXlate@EXLATEOBJ@@QEAAHPEAGVXEPALOBJ@@PEAVSURFACE@@KK@Z @ 0x1C029B65C
 * Callers:
  ...
  if ( a6 <= 0x3FFFFFFF && 4 * (unsigned __int64)a6 + 88 >= 4 * (unsigned __int64)a6 )
  {
    ...
    *a1 = (XLATE *)v10;
    if ( v10 )
    {
      ...
      *(_QWORD *)(v10 + 4) = 2LL;
      *(_QWORD *)(v10 + 16) = v10 + 80;
      *(_QWORD *)(v10 + 24) = 0LL;
      *(_DWORD *)(v10 + 32) = 0;
      *(_QWORD *)(v10 + 40) = 0LL;
      *(_QWORD *)(v10 + 48) = v32;
      *(_QWORD *)(v10 + 56) = a3;
      memset((void *)(v10 + 4 * (v12 + 20)), 0, 4LL * (v6 - (unsigned int)v12));
      v15 = *(_DWORD *)(a3 + 28);
      v31[0] = ghsemPalette;
        ...
        if ( (struct PALETTE *)a3 != ppalDefault )
        {
          ...
          if ( (_DWORD)v12 )
          {
            do
            {
              ...
              if ( v26 >= v15 )
                v26 %= v15;
              v27 = *(unsigned int *)(*(_QWORD *)(a3 + 120) + 4LL * v26);
              if ( HIBYTE(*(_DWORD *)(*(_QWORD *)(a3 + 120) + 4LL * v26)) == 2 )
              {
      ...
      else if ( (_DWORD)v12 )
      {
        while ( 1 )
        {
          ...
          if ( v17 >= v15 )
            v17 %= v15;
          v18 = *(unsigned int *)(*(_QWORD *)(a3 + 120) + 4LL * v17);
          if ( HIBYTE(*(_DWORD *)(*(_QWORD *)(a3 + 120) + 4LL * v17)) == 2 )
          {
            v19 = *(_DWORD *)(v16 + 28);
            if ( v19 )
            {
