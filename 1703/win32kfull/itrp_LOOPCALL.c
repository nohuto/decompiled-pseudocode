/*
 * XREFs of itrp_LOOPCALL @ 0x1C02D4940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_LOOPCALL(__int64 a1)
{
  ...
  v3 = *v2;
  if ( (int)v3 >= *(unsigned __int16 *)(*(_QWORD *)(qword_1C032CA00 + 344) + 20LL) || (int)v3 < 0 )
  {
    dword_1C032CA50 = 4372;
    return qword_1C032CA58;
  }
  v4 = *(_QWORD *)(qword_1C032CA00 + 160);
  v5 = *v2;
  v6 = *(_WORD *)(v4 + 8 * v3 + 6);
  if ( v6 >= 2u )
  {
  ...
  v7 = *(int *)(v4 + 8 * v3);
  v8 = *(_QWORD *)(qword_1C032CA00 + 16LL * v6 + 200);
  v9 = v8 + (int)(v7 + *(unsigned __int16 *)(v4 + 8 * v3 + 4));
  v10 = v8 + v7;
  if ( v8 + v7 < v8 || v9 > v8 + *(unsigned int *)(qword_1C032CA00 + 16 * (v6 + 13LL)) || v9 < v10 )
  {
    dword_1C032CA50 = 4363;
    return qword_1C032CA58;
  }
  v11 = qword_1C032CA58;
  v12 = dword_1C032CA6C == 1;
  v13 = dword_1C032CA6C - 1;
  v14 = qword_1C032CA60;
  qword_1C032C9E8 = (__int64)(v2 - 1);
  v15 = *(v2 - 1);
  --dword_1C032CA6C;
  if ( v12 )
  {
  ...
  else
  {
    while ( --v15 >= 0 && !dword_1C032CA50 )
    {
      ...
      {
        InvokeInterpreter(dword_1C032CA38, v10, v10 + *(unsigned __int16 *)(v4 + 8 * v5 + 4));
      }
      v13 = dword_1C032CA6C;
    }
    qword_1C032CA58 = v11;
    dword_1C032CA6C = v13 + 1;
    if ( dword_1C032CA50 )
      a1 = v11;
    qword_1C032CA60 = v14;
    return a1;
