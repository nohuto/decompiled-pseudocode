/*
 * XREFs of ?vSrcCopyS32D24@@YAXPEAUBLTINFO@@@Z @ 0x1C00ADA10
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vSrcCopyS32D24(struct BLTINFO *a1)
{
  ...
  int j; // ecx
  char v18; // al
  unsigned int (*v19)(struct _XLATEOBJ *, unsigned int); // rbp
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      {
        v21 = *v4;
        if ( (char *)v19 == (char *)iXlateBitfieldsToBitfields )
        {
          v26 = *((_QWORD *)v2 + 5);
          v22 = XEPALOBJ::ulIndexToRGB((XEPALOBJ *)&v26, v21);
          v27 = *((_QWORD *)v2 + 6);
          LODWORD(v23) = XEPALOBJ::ulDispatchGFPEFunction(&v27, *(unsigned int *)(v27 + 96), v22);
        }
        else
        {
          v23 = ((__int64 (__fastcall *)(XLATE *, __int64))v19)(v2, v21);
        }
        *(_BYTE *)v6 = v23;
        ++v4;
        *(_BYTE *)(v6 + 1) = BYTE1(v23);
        *(_BYTE *)(v6 + 2) = BYTE2(v23);
        v6 += 3LL;
        --v20;
      }
      while ( v20 );
