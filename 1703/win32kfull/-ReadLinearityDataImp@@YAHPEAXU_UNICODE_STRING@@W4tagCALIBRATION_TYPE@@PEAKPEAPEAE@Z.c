/*
 * XREFs of ?ReadLinearityDataImp@@YAHPEAXU_UNICODE_STRING@@W4tagCALIBRATION_TYPE@@PEAKPEAPEAE@Z @ 0x1C0013A54
 * Callers:
 *     ?ReadLinearityData@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@U_UNICODE_STRING@@PEAX@Z @ 0x1C0013784 (-ReadLinearityData@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@U_UNICODE_STRING@@PEAX@Z.c)
 * Callees:
        ...
        _QWORD *a5)
{
    ...
    && *ResultLength - 12 <= 0xCA0 )
  {
    ...
    v11 = (_DWORD *)Win32AllocPool(*ResultLength, 2020635477LL);
    v12 = v11;
    if ( v11 )
    {
