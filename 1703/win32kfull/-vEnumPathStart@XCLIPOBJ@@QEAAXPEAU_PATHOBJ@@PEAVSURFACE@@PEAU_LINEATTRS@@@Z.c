/*
 * XREFs of ?vEnumPathStart@XCLIPOBJ@@QEAAXPEAU_PATHOBJ@@PEAVSURFACE@@PEAU_LINEATTRS@@@Z @ 0x1C0129670
 * Callers:
        ...
        struct _LINEATTRS *a4)
{
  ...
  *(_DWORD *)(*((_QWORD *)this + 18) + 200LL) = 1;
  ...
  else if ( a4->pstyle )
  {
    ...
    if ( v8 )
    {
      *(_DWORD *)(*((_QWORD *)this + 18) + 192LL) = v8[557];
      *(_DWORD *)(*((_QWORD *)this + 18) + 196LL) = v8[558];
      *(_DWORD *)(*((_QWORD *)this + 18) + 200LL) = v8[559];
    }
    else
    {
