/*
 * XREFs of vtfdOpenFontContext @ 0x1C0238ACC
 * Callers:
 *     vtfdQueryAdvanceWidths @ 0x1C0238390 (vtfdQueryAdvanceWidths.c)
...
_QWORD *__fastcall vtfdOpenFontContext(__int64 a1)
{
  ...
  *((_DWORD *)v9 + 30) = v12;
  if ( (*(_DWORD *)(a1 + 12) & 0x4000) != 0 )
    *((_DWORD *)v9 + 30) |= 2u;
  *((_DWORD *)v9 + 31) = v7;
  if ( !(unsigned int)bInitXform((__int64)v9, (XFORMOBJ *)(a1 + 216)) )
  {
    if ( !*(_DWORD *)(v1 + 32) )
      EngUnmapFontFileFD(*(_QWORD *)(v1 + 8));
    EngFreeMem(v9);
