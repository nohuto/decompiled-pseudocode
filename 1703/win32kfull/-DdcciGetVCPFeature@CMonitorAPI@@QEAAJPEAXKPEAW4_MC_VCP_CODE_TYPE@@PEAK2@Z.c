/*
 * XREFs of ?DdcciGetVCPFeature@CMonitorAPI@@QEAAJPEAXKPEAW4_MC_VCP_CODE_TYPE@@PEAK2@Z @ 0x1C0248854
 * Callers:
 *     NtGdiDDCCIGetVCPFeature @ 0x1C0249230 (NtGdiDDCCIGetVCPFeature.c)
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  v13 = this;
  v6 = (char *)qword_1C032C900;
  CAutoMutex::CAutoMutex((CAutoMutex *)v12, (struct CMutex *)qword_1C032C900);
