/*
 * XREFs of ?GdiDeleteSprite@@YAJPEAUHDEV__@@PEAUHWND__@@PEAX@Z @ 0x1C0257424
 * Callers:
...
__int64 __fastcall GdiDeleteSprite(HDEV a1, HWND a2, void *a3)
{
  ...
  v6 = v30;
  v7 = 0;
  v8 = (const struct _SPRITESTATE *)(v30 + 18);
  if ( *((_DWORD *)v30 + 35) )
  {
...
LABEL_33:
  ...
  if ( !(unsigned int)SURFACE::bRedirectionBitmap((SURFACE *)v25) )
    goto LABEL_32;
  v27 = (W32PIDLOCK *)(v26 + 280);
  W32PIDLOCK::vLockSingleThread((W32PIDLOCK *)(v26 + 280));
  if ( *(_DWORD *)(v25 + 332) )
  {
    v28 = *(_DWORD *)(v25 + 116);
    if ( (v28 & 2) == 0 )
