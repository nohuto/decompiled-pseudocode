/*
 * XREFs of ShrinkDIB_CY @ 0x1C0246940
 * Callers:
 *     <none>
 * Callees:
    ...
    do
    {
      ...
      if ( (v36 & 0x4000) != 0 )
      {
        ...
        if ( v42 <= 0 )
        {
          ...
          do
          {
            ...
            *(_DWORD *)((char *)v47 + v50 + 4) += v18[(unsigned __int8)v51];
            v53 = (6 * v47[1] - *(_DWORD *)((char *)v47 + v49 + 4) - *(_DWORD *)((char *)v47 + v50 + 4)) >> 15;
            if ( (v53 & 0xFF00) != 0 )
        ...
        else
        {
          ...
          while ( (unsigned __int64)(v44 - 1) < v78 );
          if ( v74 )
          {
            memmove(v21, v22, v20);
            v74 = 0;
