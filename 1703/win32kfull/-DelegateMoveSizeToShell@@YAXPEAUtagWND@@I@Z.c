/*
 * XREFs of ?DelegateMoveSizeToShell@@YAXPEAUtagWND@@I@Z @ 0x1C01EDB90
 * Callers:
...
void __fastcall DelegateMoveSizeToShell(struct tagWND *this, unsigned int a2)
{
  __int64 v3; // rdi
  __int64 v4; // rsi
  __int64 v5; // r8
  ...
  if ( v6 )
  {
    ...
    PostInputMessage(
      *(struct tagMLIST **)(v3 + 384),
      this,
      0x202u,
      0LL,
      (*(unsigned __int16 *)(v3 + 680) << 16) | *(unsigned __int16 *)(v3 + 676),
      0,
      0LL,
      0LL,
      0,
