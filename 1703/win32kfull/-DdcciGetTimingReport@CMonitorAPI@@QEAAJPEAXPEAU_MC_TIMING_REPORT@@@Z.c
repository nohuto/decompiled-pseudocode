/*
 * XREFs of ?DdcciGetTimingReport@CMonitorAPI@@QEAAJPEAXPEAU_MC_TIMING_REPORT@@@Z @ 0x1C024870C
 * Callers:
 *     NtGdiDDCCIGetTimingReport @ 0x1C02491D0 (NtGdiDDCCIGetTimingReport.c)
 * Callees:
...
__int64 __fastcall CMonitorAPI::DdcciGetTimingReport(CMonitorAPI *this, void *a2, struct _MC_TIMING_REPORT *a3)
{
  ...
  v8 = this;
  v3 = (char *)qword_1C032C900;
  CAutoMutex::CAutoMutex((CAutoMutex *)&v9, (struct CMutex *)qword_1C032C900);
