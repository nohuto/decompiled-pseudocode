/*
 * XREFs of ?bFindRFONT@RFONTOBJ@@QEAAHPEAU_FD_XFORM@@KKAEAVPDEVOBJ@@PEAVEXFORMOBJ@@PEAVPFE@@HHHK@Z @ 0x1C0002F64
 * Callers:
 ...
 * Callees:
 *     ?bMatchRealization@RFONTOBJ@@AEAAHPEAU_FD_XFORM@@KKPEAVEXFORMOBJ@@PEAVPFE@@HHHK@Z @ 0x1C0002D34 (-bMatchRealization@RFONTOBJ@@AEAAHPEAU_FD_XFORM@@KKPEAVEXFORMOBJ@@PEAVPFE@@HHHK@Z.c)
    ...
    *(_QWORD *)this = v22;
    if ( v22 )
    {
      ...
      if ( (*(_DWORD *)(*(_QWORD *)v15 + 32LL) & 0x800000) != 0 )
        *(_DWORD *)(*(_QWORD *)(v25 + 3536) + 1544LL) = v26;
      else
        *(_DWORD *)(v25 + 1544) = v26;
      v29 = PDEVOBJ::prfntActive(v15);
      RFONTOBJ::vInsert(this, &v29, 1LL);
