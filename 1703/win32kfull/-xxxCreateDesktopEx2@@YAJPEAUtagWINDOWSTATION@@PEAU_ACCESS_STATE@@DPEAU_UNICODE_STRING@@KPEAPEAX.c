/*
 * XREFs of ?xxxCreateDesktopEx2@@YAJPEAUtagWINDOWSTATION@@PEAU_ACCESS_STATE@@DPEAU_UNICODE_STRING@@KPEAPEAX@Z @ 0x1C010B644
 * Callers:
 ...
 *     GetDesktopHeapSize @ 0x1C010BAD0 (GetDesktopHeapSize.c)
        ...
        void **a6)
{
  ...
  v36 = 0;
  v37 = 0LL;
  result = ObCreateObject(0LL, ExDesktopObjectType, &v33, v13, 0LL, 344, 0, 0, &Objecta);
        ...
        *((_QWORD *)Objecta + 15) = DesktopHeap;
        if ( *((_QWORD *)Objecta + 15) )
        {
          *((_DWORD *)Objecta + 34) = DesktopHeapSize;
          v18 = DesktopAlloc((__int64)Objecta, 0x38u);
          if ( v18 )
          {
            v19 = (_QWORD *)Win32AllocPoolZInit(248LL, 1684763477LL);
            if ( v19 )
            {
              v20 = gdwDesktopId;
              *v19 = v18;
              ...
              *((_QWORD *)Objecta + 1) = v19;
              v22 = (char *)Objecta + 168;
              *((_QWORD *)Objecta + 22) = (char *)Objecta + 168;
              *v22 = v22;
              v23 = (char *)Objecta + 312;
              ...
              ***((_QWORD ***)Objecta + 1) = (unsigned int)v21 | (((unsigned __int64)Objecta ^ gCookie) << 32);
              v24 = *((_QWORD *)Objecta + 16);
              *((_QWORD *)Objecta + 2) = v24;
              *((_QWORD *)Objecta + 3) = v24 + DesktopHeapSize;
            ...
            RtlFreeHeap(*((PVOID *)Objecta + 16), 0, v18);
          }
        }
