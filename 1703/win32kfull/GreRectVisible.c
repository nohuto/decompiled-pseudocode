/*
 * XREFs of GreRectVisible @ 0x1C00EB3C0
 * Callers:
 *     NtGdiRectVisible @ 0x1C00EB370 (NtGdiRectVisible.c)
 * Callees:
...
__int64 __fastcall GreRectVisible(HDC a1, struct _RECTL *a2)
{
  ...
  if ( (v16[24] & 1) != 0 )
  {
    ...
    if ( (*(_BYTE *)(v12[0] + 32LL) & 1) != 0 )
    {
      EXFORMOBJ::vOrder((EXFORMOBJ *)v12, &v22);
      EXFORMOBJ::bXform((EXFORMOBJ *)v12, (struct _POINTL *)&v22);
      v6 = (*((_BYTE *)v10[0] + 40) & 1) != 0 ? 8 : 0;
      v22.left += *(_DWORD *)((char *)v10[0] + v6 + 1432);
      v22.right += *(_DWORD *)((char *)v10[0] + v6 + 1432);
      v22.top += *(_DWORD *)((char *)v10[0] + v6 + 1436);
      v22.bottom += *(_DWORD *)((char *)v10[0] + v6 + 1436);
