/*
 * XREFs of ?D3DXMatrixDeterminant@@YAHPEAMPEBU_D3DMATRIX@@@Z @ 0x1C01BE9D8
 * Callers:
 *     ValidateInertiaInfo @ 0x1C020A868 (ValidateInertiaInfo.c)
 * Callees:
 *     sqrtf_0 @ 0x1C01400D4 (sqrtf_0.c)
 */
...
__int64 __fastcall D3DXMatrixDeterminant(float *a1, const struct _D3DMATRIX *a2)
{
  ...
  float v15; // [rsp+6Ch] [rbp-DCh]
  float v16; // [rsp+70h] [rbp-D8h]
  float v17; // [rsp+74h] [rbp-D4h]
