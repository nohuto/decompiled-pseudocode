/*
 * XREFs of ?bIsLinkedGlyph@RFONTOBJ@@QEAAHG@Z @ 0x1C008E610
 * Callers:
...
__int64 __fastcall RFONTOBJ::bIsLinkedGlyph(RFONTOBJ *this, unsigned __int16 a2)
{
  ...
  if ( (unsigned __int16)(a2 + 0x2000) <= 0x18FFu
    ...
    && a2 >= gqlEUDC
    && a2 <= *(&gqlEUDC + 1)
    && ((0x80000000 >> (a2 & 0x1F)) & *(_DWORD *)(qword_1C032C178 + 4 * ((unsigned __int64)a2 >> 5))) != 0 )
  {
    v4 = 1;
    goto LABEL_4;
  }
...
LABEL_4:
    if ( gbSystemDBCSFontEnabled )
    {
      if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 112LL) + 12LL) & 0x10) != 0 )
      {
        ...
        if ( *((_QWORD *)PFEOBJ::pql(&v20) + 1) )
        {
          if ( a2 >= *(_WORD *)PFEOBJ::pql(&v20) && a2 <= *((_WORD *)PFEOBJ::pql(&v20) + 1) )
          {
            v18 = *(unsigned __int16 *)PFEOBJ::pql(&v20);
            v19 = a2 - *(unsigned __int16 *)PFEOBJ::pql(&v20);
            if ( ((0x80000000 >> ((a2 - v18) % 32)) & *(_DWORD *)(*((_QWORD *)PFEOBJ::pql(&v20) + 1)
                                                                + 4LL * (int)(v19 / 32))) != 0 )
              v4 = 1;
          }
        }
  ...
  v12 = *(_DWORD *)(*(_QWORD *)this + 852LL);
  v13 = *(unsigned __int8 *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 112LL) + 32LL) + 45LL) >> 4;
  ...
  if ( v20 )
  {
    if ( *((_QWORD *)PFEOBJ::pql(&v20) + 1) )
    {
      if ( a2 >= *(_WORD *)PFEOBJ::pql(&v20) && a2 <= *((_WORD *)PFEOBJ::pql(&v20) + 1) )
      {
        v16 = *(unsigned __int16 *)PFEOBJ::pql(&v20);
        v17 = a2 - *(unsigned __int16 *)PFEOBJ::pql(&v20);
        if ( ((0x80000000 >> ((a2 - v16) % 32)) & *(_DWORD *)(*((_QWORD *)PFEOBJ::pql(&v20) + 1) + 4LL * (int)(v17 / 32))) != 0 )
        {
LABEL_15:
          v4 = 1;
          goto LABEL_8;
...
LABEL_6:
  ...
  for ( i = PFEOBJ::pGetLinkedFontList((PFEOBJ *)&v21)->Flink; i != PFEOBJ::pGetLinkedFontList((PFEOBJ *)&v21); i = i->Flink )
  {
    ...
    if ( *((_QWORD *)PFEOBJ::pql(&v20) + 1)
      && a2 >= *(_WORD *)PFEOBJ::pql(&v20)
      && a2 <= *((_WORD *)PFEOBJ::pql(&v20) + 1) )
    {
      v10 = *(unsigned __int16 *)PFEOBJ::pql(&v20);
      v11 = (v7 - *(unsigned __int16 *)PFEOBJ::pql(&v20)) / 32;
      if ( ((0x80000000 >> ((a2 - v10) % 32)) & *(_DWORD *)(*((_QWORD *)PFEOBJ::pql(&v20) + 1) + 4 * v11)) != 0 )
        goto LABEL_15;
      v7 = a2;
    }
  }
