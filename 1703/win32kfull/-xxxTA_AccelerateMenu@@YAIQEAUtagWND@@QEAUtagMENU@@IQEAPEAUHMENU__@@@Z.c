/*
 * XREFs of ?xxxTA_AccelerateMenu@@YAIQEAUtagWND@@QEAUtagMENU@@IQEAPEAUHMENU__@@@Z @ 0x1C01374F4
 * Callers:
        ...
        HMENU *const a4)
{
  ...
  xxxSendTransformableMessageTimeout((ULONG_PTR)a1, 0x116u, v12, 0LL, 0, 0, 0LL, 1, 1);
  if ( (unsigned int)v10 >= *((_DWORD *)a2 + 17)
    || (v13 = *(HMENU **)(*((_QWORD *)a2 + 12) + 152LL * (int)v10 + 16)) != 0LL
    && (v14 = *v13,
        *a4 = v14,
        _InterlockedAdd(&glSendMessage, 1u),
        xxxSendTransformableMessageTimeout((ULONG_PTR)a1, 0x117u, (unsigned __int64)v14, v10, 0, 0, 0LL, 1, 1),
        (unsigned int)v10 >= *((_DWORD *)a2 + 17))
