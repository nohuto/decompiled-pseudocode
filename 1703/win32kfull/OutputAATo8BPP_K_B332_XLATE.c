/*
 * XREFs of OutputAATo8BPP_K_B332_XLATE @ 0x1C02408C0
 * Callers:
 *     <none>
 * Callees:
    ...
    do
    {
      if ( v9[3] )
      {
        ...
        if ( v23 < v22 && v23 < v15 && v23 < v14 )
          v20 = *(_BYTE *)((((unsigned __int16)(v21 - v14) & (unsigned __int16)(v14 - v24) & 0x3000 | (v18 - v15) & (v15 - DWORD1(v24)) & 0x1C000 | (unsigned __int64)((v16 - v22) & (v22 - DWORD2(v24)) & 0xE0000)) >> 12)
                         + a9);
        *a4 = v20;
      }
      ++a4;
