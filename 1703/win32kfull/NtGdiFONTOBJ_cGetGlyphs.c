/*
 * XREFs of NtGdiFONTOBJ_cGetGlyphs @ 0x1C0292C90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CacheGlyphPath@UMPDOBJ@@QEAAPEAU_PATHOBJ@@PEAU2@@Z @ 0x1C0273928 (-CacheGlyphPath@UMPDOBJ@@QEAAPEAU_PATHOBJ@@PEAU2@@Z.c)
 */
