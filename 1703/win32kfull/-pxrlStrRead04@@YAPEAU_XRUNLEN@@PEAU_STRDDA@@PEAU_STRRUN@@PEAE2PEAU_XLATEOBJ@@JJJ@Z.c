/*
 * XREFs of ?pxrlStrRead04@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C009C690
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_27:
      ...
      while ( 1 )
      {
        v40 = (v36 & (unsigned int)dword_1C02EA128[v38]) >> dword_1C02EA108[v38];
        if ( a5 )
          LODWORD(v40) = a5->pulXlate[v40];
        if ( (dword_1C02EA5B0[v39] & v47) != 0 )
        {
          v41 = *v37;
          if ( *v37 )
          {
...
LABEL_5:
        ...
        while ( 1 )
        {
          ...
          {
            v20 = v19;
            v21 = a5->pulXlate[(unsigned __int64)(v18 & (unsigned int)dword_1C02EA128[v17]) >> LOBYTE(dword_1C02EA108[v17])];
            v22 = &v9[v15 + 2];
...
LABEL_17:
      ...
      while ( 1 )
      {
        v29 = (v28 & (unsigned int)dword_1C02EA128[v27]) >> dword_1C02EA108[v27];
        v30 = *v26++;
        if ( (_DWORD)v30 )
        {
          v14 += v30;
