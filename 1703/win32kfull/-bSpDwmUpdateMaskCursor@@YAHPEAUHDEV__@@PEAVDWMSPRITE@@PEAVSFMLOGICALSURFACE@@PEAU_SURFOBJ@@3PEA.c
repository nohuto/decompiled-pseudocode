/*
 * XREFs of ?bSpDwmUpdateMaskCursor@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAU_SURFOBJ@@3PEAU_RECTL@@PEAKPEAPEAV3@@Z @ 0x1C024D1F0
 * Callers:
        ...
        struct SFMLOGICALSURFACE **a8)
{
  ...
  int v20; // [rsp+78h] [rbp-79h] BYREF
  __int64 v21; // [rsp+7Ch] [rbp-75h]
  _BYTE v22[20]; // [rsp+84h] [rbp-6Dh]
  __int64 v23; // [rsp+98h] [rbp-59h] BYREF
  char v24; // [rsp+A0h] [rbp-51h]
  int v25; // [rsp+A4h] [rbp-4Dh]
  __int64 v26; // [rsp+A8h] [rbp-49h] BYREF
  char v27; // [rsp+B0h] [rbp-41h]
  int v28; // [rsp+B4h] [rbp-3Dh]
  struct DWMSPRITE *v29; // [rsp+B8h] [rbp-39h]
  struct SFMLOGICALSURFACE **v30; // [rsp+C0h] [rbp-31h]
  struct SFMLOGICALSURFACE *v31; // [rsp+C8h] [rbp-29h]
  HDEV v32; // [rsp+D0h] [rbp-21h]
  ...
  if ( DIB )
  {
    ...
    if ( DIB )
    {
      ...
      if ( DIB )
      {
        ...
        v14 = v29;
        *((_DWORD *)v29 + 50) = ((_DWORD)v17 != 0 ? 4 : 0) | *((_DWORD *)v29 + 50) & 0xFFFFFFFB;
        prclDest.top += v13->sizlBitmap.cy >> 1;
        v15 = SURFOBJ_TO_SURFACE_NOT_NULL(v10);
        DIB = bSpDwmUpdateSpriteShape(v32, v14, v31, v10, &prclDest, *(struct PALETTE **)(v15 + 128), a7, 0LL, v30);
      }
