/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C019924C
 * Callers:
 ...
 *     EditionFindNodeQueuedMessage @ 0x1C019AB20 (EditionFindNodeQueuedMessage.c)
 * Callees:
