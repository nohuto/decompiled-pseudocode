/*
 * XREFs of ?SpStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C0134530
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG iMode)
{
  ...
  v32 = (__int64)pxlo;
  v31 = (__int64)pca;
  v30 = (__int64)pptlHTOrg;
  v29 = (__int64)prclSrc;
  v28 = (__int64)pptlMask;
  if ( !hdev || *((struct _SURFOBJ **)hdev + 14) != a2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( NEEDDDILOCK::bRender((NEEDDDILOCK *)&v25, v26) )
        break;
LABEL_14:
      if ( v18 )
