/*
 * XREFs of ?vGradientFill16_555@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02ADE90
 * Callers:
 *     <none>
 * Callees:
 *     <none>
      ...
      if ( *((_QWORD *)v6 + 9) <= (unsigned __int64)(v7 + v21) && (int)v21 < v14 )
      {
        ...
        if ( v25 )
        {
          ...
          do
          {
            ...
            v32 = HIDWORD(v19);
            v19 += v36;
            v33 = Saturation16_5[(unsigned __int64)(v29 + ((unsigned int)v32 >> 11)) >> 16] | (unsigned __int16)(32 * v31);
            v34 = HIDWORD(v18);
            v18 += v37;
