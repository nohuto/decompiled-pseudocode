/*
 * XREFs of ?PerformInputActions@InteractiveControlDevice@@QEAAXPEAVInteractiveControlInput@@I@Z @ 0x1C0220140
 * Callers:
        ...
        unsigned int a3)
{
  ...
  {
    if ( (unsigned int)GetUserHandedness() != *((_DWORD *)this + 82) )
    {
