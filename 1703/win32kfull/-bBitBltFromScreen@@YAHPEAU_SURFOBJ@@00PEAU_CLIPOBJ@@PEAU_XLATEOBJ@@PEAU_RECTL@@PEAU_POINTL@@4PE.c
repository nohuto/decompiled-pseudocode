/*
 * XREFs of ?bBitBltFromScreen@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C02843E8
 * Callers:
        ...
        unsigned int a11)
{
  ...
  _DWORD v50[16]; // [rsp+D0h] [rbp-30h] BYREF
  _BYTE v51[64]; // [rsp+110h] [rbp+10h] BYREF
  struct _DISPSURF *v52; // [rsp+150h] [rbp+50h]
  __int64 v53; // [rsp+158h] [rbp+58h]
  __int64 v54; // [rsp+160h] [rbp+60h]
  int v55[2]; // [rsp+168h] [rbp+68h]
  _BYTE v56[56]; // [rsp+180h] [rbp+80h] BYREF
  ...
  {
    v20 = v53;
    if ( (*(_DWORD *)(*(_QWORD *)(v53 + 24) + 1840LL) & 0x8000000) == 0 )
    {
...
LABEL_39:
          ...
          if ( a11 == 52428 )
          {
            if ( (*((_DWORD *)v34 + 28) & 0x400) != 0 )
              v35 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*((_QWORD *)v52 + 7) + 2856LL);
            else
              v35 = EngCopyBits;
            v13 &= OffCopyBits(
                     (__int64 (__fastcall *)(__int64, __int64, struct _CLIPOBJ *, __int64, _DWORD *, _DWORD *))v35,
                     (int *)&gptlZero,
                     (__int64)v22,
                     *(int **)v55,
                     v53,
          ...
          else
          {
            ...
            if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v53) + 112) & 1) != 0 )
              v36 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *, POINTL *, BRUSHOBJ *, POINTL *, ROP4))(*((_QWORD *)v52 + 7) + 2848LL);
            else
              v36 = EngBitBlt;
            v13 &= OffBitBlt(
