/*
 * XREFs of ?QueueInput@InteractiveControlDevice@@QEAAXPEAU_LIST_ENTRY@@PEAVInteractiveControlInput@@@Z @ 0x1C0220540
 * Callers:
 ...
 * Callees:
 *     ?CleanQueue@InteractiveControlDevice@@QEAAXK@Z @ 0x1C021F370 (-CleanQueue@InteractiveControlDevice@@QEAAXK@Z.c)
 */
