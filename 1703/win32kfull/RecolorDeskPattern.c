/*
 * XREFs of RecolorDeskPattern @ 0x1C011C450
 * Callers:
...
__int64 RecolorDeskPattern()
{
  ...
  if ( g_hbmDesktopPattern )
  {
    ...
    {
      v3 = *(_DWORD *)(gpsi + 4964LL);
      v17 = 2;
      v18 = 2;
      v19 = BYTE2(v3);
      v4 = *(_BYTE *)(gpsi + 4964LL);
      v20 = BYTE1(v3);
      v5 = *(_DWORD *)(gpsi + 4992LL);
      v21 = v4;
      v22 = BYTE2(v5);
      v6 = *(_BYTE *)(gpsi + 4992LL);
      v23 = BYTE1(v5);
      v24 = v6;
      v13[0] = 40;
      v13[1] = 8;
    ...
    if ( CompatibleBitmapInternal )
    {
      ...
      GreSetTextColor(*(HDC *)ghdcMem2, *(_DWORD *)(gpsi + 4964LL));
      GreSetBkColor(*(HDC *)ghdcMem2, *(_DWORD *)(gpsi + 4992LL));
      NtGdiBitBltInternal(*(HDC *)ghdcMem2, 0, 0, 8, 8, *(HDC *)ghdcMem, 0, 0, 13369376, 0, 0);
      PatternBrush = GreCreatePatternBrush(v9);
      if ( PatternBrush )
      {
        v12 = *(HBRUSH *)(gpsi + 5096LL);
        if ( v12 )
        {
