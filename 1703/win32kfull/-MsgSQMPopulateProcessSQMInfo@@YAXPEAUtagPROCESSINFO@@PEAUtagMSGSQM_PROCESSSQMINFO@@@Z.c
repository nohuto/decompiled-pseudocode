/*
 * XREFs of ?MsgSQMPopulateProcessSQMInfo@@YAXPEAUtagPROCESSINFO@@PEAUtagMSGSQM_PROCESSSQMINFO@@@Z @ 0x1C01E6880
 * Callers:
...
void __fastcall MsgSQMPopulateProcessSQMInfo(struct tagPROCESSINFO *a1, WCHAR *a2)
{
  ...
  *((_DWORD *)a2 + 8) = *((_DWORD *)a1 + 206);
  *((_DWORD *)a2 + 9) = *((_DWORD *)a1 + 207);
