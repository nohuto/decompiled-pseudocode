/*
 * XREFs of ?vGetTextMetrics@@YAXAEAVRFONTOBJ@@AEAVDCOBJ@@PEAU_TMW_INTERNAL@@@Z @ 0x1C000C504
 * Callers:
...
void __fastcall vGetTextMetrics(struct RFONTOBJ *a1, struct DCOBJ *a2, struct _TMW_INTERNAL *a3)
{
  ...
  {
    vIFIMetricsToTextMetricW(a1, a2, a3, *(struct _IFIMETRICS **)(*(_QWORD *)(*(_QWORD *)a1 + 112LL) + 32LL));
  }
}
