/*
 * XREFs of ?vPatXorRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02A35A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vPatXorRow8(struct _PATBLTFRAME *a1, int a2, int a3)
{
  ...
  if ( a3 )
  {
    do
    {
      ...
      {
        v20 = v15;
        *(_DWORD *)(v10 + v6) ^= v13 & v14 & *(_DWORD *)(v15 + v9);
      }
      else
      {
        ...
        {
          v20 = v15;
          *(_DWORD *)(v10 + v6) ^= v13 & *(_DWORD *)(v15 + v9);
          LODWORD(v10) = v10 + 4;
          v15 += 4;
        }
        ...
        if ( v16 )
        {
          ...
          {
            vFetchShiftAndMerge(&v18);
          }
          else
          {
            v23 = v17 >> 2;
            vFetchAndMerge((__int64)&v18);
          }
          v14 = v24;
          v9 = v19;
          v16 = v22;
        ...
        if ( v25 )
          *(_DWORD *)(v11 + v6) ^= v14 & *(_DWORD *)(((int)v15 + 4 * (unsigned __int64)v16) % *((unsigned int *)a1 + 10)
                                                   + v9);
      }
      if ( ++v8 == *((_DWORD *)a1 + 11) )
      {
