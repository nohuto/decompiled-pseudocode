/*
 * XREFs of ?_InBoxString@@YA_JJPEAUtagWND@@I_K_J1KH@Z @ 0x1C00EA454
 * Callers:
 *     NtUserfnINCBOXSTRING @ 0x1C00EA3C0 (NtUserfnINCBOXSTRING.c)
 *     NtUserfnINLBOXSTRING @ 0x1C00EA410 (NtUserfnINLBOXSTRING.c)
 * Callees:
        ...
        int a8)
{
  ...
  v15 = *(_DWORD *)(gptiCurrent + 1284LL);
  if ( v13 || v14 )
  {
    *(_DWORD *)(gptiCurrent + 1284LL) = 2;
    if ( a3 == v12 )
  ...
  if ( v17 == xxxSendMessageFF || (char *)v17 == (char *)xxxWrapSendMessageBSM )
    return -1LL;
  *(_DWORD *)(gptiCurrent + 1284LL) = 1;
  result = v17((int)a2, a3, a4, a5, a6);
LABEL_9:
  *(_DWORD *)(gptiCurrent + 1284LL) = v15;
  return result;
}
