/*
 * XREFs of NtGdiCLIPOBJ_cEnumStart @ 0x1C0290E00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_CLIPOBJ@@@UMPDOBJ@@QEAAPEAU_CLIPOBJ@@PEAU1@@Z @ 0x1C0273808 (--$GetDDIOBJ@U_CLIPOBJ@@@UMPDOBJ@@QEAAPEAU_CLIPOBJ@@PEAU1@@Z.c)
 */
