/*
 * XREFs of MonitorAPIProcessTerminating @ 0x1C00EC060
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextElementIndex@?$CList@VCPhysicalMonitorHandle@@@@QEAAEKPEAK@Z @ 0x1C0248F78 (-GetNextElementIndex@-$CList@VCPhysicalMonitorHandle@@@@QEAAEKPEAK@Z.c)
 */
...
void __fastcall MonitorAPIProcessTerminating(void *a1)
{
  ...
  v1 = (char *)qword_1C032C900;
  CAutoMutex::CAutoMutex((CAutoMutex *)&v7, (struct CMutex *)((char *)qword_1C032C900 + 32));
  if ( *((_DWORD *)v1 + 4) )
  {
    if ( !**((_QWORD **)v1 + 1) )
    {
