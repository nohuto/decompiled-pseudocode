/*
 * XREFs of ?MungeClipData@@YAXPEAUtagWINDOWSTATION@@@Z @ 0x1C00AF478
 * Callers:
...
void __fastcall MungeClipData(struct tagWINDOWSTATION *a1)
{
    ...
    if ( !FindClipFormat(a1, 16LL, 1LL) )
    {
      ...
      if ( v12 )
      {
        ...
        if ( v13 )
        {
          ...
          {
            LOBYTE(v15) = 6;
            v17 = HMValidateHandleNoRip(v14, v15);
            if ( v17 )
  ...
  if ( !FindClipFormat(a1, 3LL, 1LL) )
  {
    ...
    if ( v6 )
    {
      v16 = 3LL;
LABEL_29:
      InternalSetClipboardData((__int64)a1, v16, (*(_QWORD *)(v6 + 8) != 0LL) + 3LL, 0, 1);
      goto LABEL_8;
    }
  }
...
LABEL_8:
  ...
  if ( (*(_DWORD *)(gpsi + 8684LL) & 1) != 0 && !FindClipFormat(a1, 9LL, 1LL) )
  {
    if ( v8 || v10 )
