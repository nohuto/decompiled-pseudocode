/*
 * XREFs of ClientDeliverUserApc @ 0x1C010A4AC
 * Callers:
...
__int64 __fastcall ClientDeliverUserApc(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  KeUserModeCallback(85LL, 0LL, 0LL, &v6, &v5);
