/*
 * XREFs of ?CreateAndLinkComponent@InteractiveControlParser@@CAJPEAU_HIDP_VALUE_CAPS@@HPEAU_INTERACTIVECTRL_CAPABILITIES@@PEAPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@@Z @ 0x1C02246C4
 * Callers:
 ...
 * Callees:
 *     ?GetComponentMultiplier@InteractiveControlParser@@SAXPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@PEAJ1@Z @ 0x1C0224B3C (-GetComponentMultiplier@InteractiveControlParser@@SAXPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@PEA.c)
 *     ?GetComponentType@InteractiveControlParser@@CA?AW4_INTERACTIVECTRL_COMPONENT_TYPE@@GG@Z @ 0x1C0224BF8 (-GetComponentType@InteractiveControlParser@@CA-AW4_INTERACTIVECTRL_COMPONENT_TYPE@@GG@Z.c)
 */
