/*
 * XREFs of ?_AdjustEdgyFrameHwndWorker@Edgy@@YAXQEAXUtagINPUTDEST@@@Z @ 0x1C01CDA3C
 * Callers:
...
const struct tagPOINTERINPUTFRAME *__fastcall Edgy::_AdjustEdgyFrameHwndWorker(PointerFrameList *a1, __int64 a2)
{
  ...
  do
  {
    ...
    {
      LODWORD(v10) = 0;
      PointerFrameList::SetPointerInfoNodeTarget(v2, 0LL, v3, (struct tagWND *)1, 0LL, v10, 1, 0, 0);
      v9 = *((_QWORD *)v2 + 12);
      if ( *(_QWORD *)(v9 + 8) == -1LL )
        EndQFrameNodeDeferment((struct tagPOINTERQFRAME *)v9, v6, v2);
