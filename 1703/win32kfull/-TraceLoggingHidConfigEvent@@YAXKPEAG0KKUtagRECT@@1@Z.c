/*
 * XREFs of ?TraceLoggingHidConfigEvent@@YAXKPEAG0KKUtagRECT@@1@Z @ 0x1C0104E60
 * Callers:
        ...
        struct tagRECT *a7)
{
  ...
  int v41; // [rsp+130h] [rbp+30h] BYREF
  ...
  if ( dword_1C0324850 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0324850, 0x800000000000uLL) )
    {
      ...
      v36 = 4;
      v39 = 4;
      TlgWrite((TraceLoggingHProvider)&dword_1C0324850, &unk_1C02EAD79, v10, v11, 0xBu, &pData);
    }
  }
}
