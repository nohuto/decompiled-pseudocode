/*
 * XREFs of ?xxxProgrammaticSemiMaximize@@YAHPEAU_MOVESIZEDATA@@PEAUtagMONITOR@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01F43E4
 * Callers:
...
__int64 __fastcall xxxProgrammaticSemiMaximize(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    {
      v5 = *(_QWORD *)a1;
      if ( (*(_BYTE *)(*(_QWORD *)a1 + 71LL) & 0x20) == 0 )
      {
LABEL_9:
        v9 = *(struct tagWND **)a1;
    ...
    v7 = *((_DWORD *)Prop + 8) & 0xFFFFFFDF | (32 * (*(_BYTE *)(*(_QWORD *)a1 + 305LL) & 1));
    *((_DWORD *)Prop + 8) = v7;
    *((_DWORD *)Prop + 8) = v7 & 0xFFFFFFBF | (32 * (*(_BYTE *)(*(_QWORD *)a1 + 305LL) & 2));
    v8 = (32 * (*(_DWORD *)(a1 + 324) & 4)) | 0x64;
    if ( (*(_DWORD *)(a1 + 324) & 0x20) == 0 )
      v8 = (32 * (*(_DWORD *)(a1 + 324) & 4)) | 0x24;
    xxxMinMaximizeEx(*(struct tagWND **)a1, 9u, v8, 0LL, (struct tagRECT *)v11);
    goto LABEL_9;
  }
  return result;
}
