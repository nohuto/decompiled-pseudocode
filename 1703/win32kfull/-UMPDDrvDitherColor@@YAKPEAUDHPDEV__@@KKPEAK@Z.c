/*
 * XREFs of ?UMPDDrvDitherColor@@YAKPEAUDHPDEV__@@KKPEAK@Z @ 0x1C0288340
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UMPDDrvDitherColor(struct DHPDEV__ *a1, unsigned int a2, unsigned int a3, unsigned int *a4)
{
  ...
  v12 = dword_1C02F36B0[v11 - 1];
LABEL_7:
  if ( !v12
    || (v19 = ((v12 * (unsigned int)*((unsigned __int16 *)a1 + 1064) + 31) >> 3) & 0x1FFFFFFC,
        v13 = v19 * (unsigned __int64)*((unsigned __int16 *)a1 + 1065),
        v13 > 0xFFFFFFFF) )
  {
LABEL_15:
