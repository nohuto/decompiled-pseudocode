/*
 * XREFs of vFillIFICharsets @ 0x1C0229E74
 * Callers:
...
LABEL_13:
    if ( v6 && *(_WORD *)v6 )
    {
      ...
      do
      {
        v16 = *(_DWORD *)((char *)&unk_1C02F4450 + v9);
      ...
      while ( v15 );
      v19 = _byteswap_ulong(*(_DWORD *)(v6 + 82));
      if ( v19 )
      {
        ...
        LODWORD(v9) = 0;
        while ( (unsigned __int16)OemCodePage != *v20 )
        {
        ...
        if ( ((unsigned int)v17 & v19) != 0 && v10 < 0x10 )
        {
          v17 = v10++;
          a3[v17] = -1;
        }
