/*
 * XREFs of GetDpiSettingWithNoDefault @ 0x1C000EF40
 * Callers:
 *     GetDpiSetting @ 0x1C000EF20 (GetDpiSetting.c)
 *     ?PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x1C01B2868 (-PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z.c)
 * Callees:
