/*
 * XREFs of SetWindowCompositionPassiveUpdateMode @ 0x1C020B31C
 * Callers:
...
__int64 __fastcall SetWindowCompositionPassiveUpdateMode(struct tagWND *a1, __int128 *a2)
{
  unsigned int v4; // ebx
  int v5; // r8d
  __int64 v6; // rdx
  ...
  {
    v5 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v12[0], 16) == v5 )
      return 0;
    v12[0] = v12[0] & 0xFFFF7FFF | (v5 << 15);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *(_QWORD *)a1, 25, a2);
    }
  }
  return v4;
}
