/*
 * XREFs of bLoadFontFile @ 0x1C0227558
 * Callers:
...
__int64 __fastcall bLoadFontFile(__int64 a1, __int64 a2, unsigned int a3, __int16 a4, ULONG FastCheckSum, PVOID *a6)
{
  ...
  ULONG v42; // [rsp+44h] [rbp-64h] BYREF
  int v43; // [rsp+48h] [rbp-60h]
  unsigned int v44; // [rsp+4Ch] [rbp-5Ch]
  unsigned int v45; // [rsp+50h] [rbp-58h]
  unsigned int v46; // [rsp+54h] [rbp-54h]
  int v47; // [rsp+58h] [rbp-50h]
  _DWORD *v48; // [rsp+60h] [rbp-48h]
  char *v49; // [rsp+68h] [rbp-40h]
...
LABEL_53:
  ...
  for ( i = 0; i < *((_DWORD *)v15 + 3); ++i )
  {
    v37 = *(_QWORD *)&v15[16 * i + 48];
    if ( *(_DWORD *)&v15[16 * i + 44] == 1 )
    {
      v38 = *(void **)(v37 + 88);
      if ( v38 )
      {
