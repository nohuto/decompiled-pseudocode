/*
 * XREFs of ?bSrcCopySRLE4D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02A8D80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSrcCopySRLE4D1(struct BLTINFO *a1)
{
  ...
  unsigned int v67; // [rsp+3Ch] [rbp-7Ch]
  ...
  for ( i = v21 <= v11; ; i = v21 <= v67 )
  {
    ...
    if ( v23 )
    {
      ...
      else
      {
        ...
        v59 = v51;
        v52 = 0x1C0000000uLL;
        v53 = byte_1C02F4118[2 * v51 + 12 + v60];
        LOBYTE(v52) = v9 & 7;
        v54 = (unsigned __int8)(7 - (v9 & 7));
        v74 = v52;
        if ( v23 >= (unsigned int)(unsigned __int8)v54 + 1 )
          v55 = ((unsigned __int8)v23 - (unsigned __int8)v54 - 1) >> 3;
        else
          v55 = 0;
        v56 = v23 + v9;
        v57 = v23 - 8 * v55;
        if ( (unsigned __int8)v54 < (int)v57 )
        {
          *(_BYTE *)(v25 + v3) = v15 | ((unsigned __int8)(v53 & EndMask[(unsigned __int8)v54 + 1]) >> (7 - v54));
          if ( (v54 & 1) == 0 )
          {
            if ( v53 >= 0 )
              v53 *= 2;
          ...
          LODWORD(v25) = v25 + 1;
          v15 = 0;
          v58 = -1 - (unsigned __int8)v54 + (unsigned int)v57;
        }
        else
        {
          v53 &= EndMask[v57];
          v15 |= (unsigned __int8)v53 >> v74;
          v58 = 0LL;
        }
        if ( v55 )
        {
          LOBYTE(v54) = v53;
          memset((void *)(v3 + (unsigned int)v25), v54, v55);
          v5 = v64;
          v15 = 0;
        }
    ...
    if ( (_DWORD)v26 == 1 )
    {
      ...
      *(_BYTE *)(v63 + v3) = v15 | *(_BYTE *)(v63 + v3) & v76;
      return 0LL;
    }
    if ( (_DWORD)v26 == 2 )
    {
...
LABEL_73:
    ...
    else
    {
      if ( v9 >= v62 )
      {
        v30 = byte_1C02F4118[(unsigned __int8)(7 - (v9 & 7))];
      }
      else
      {
        v29 = v62 - v9;
        ...
        v25 = (unsigned int)(v62 >> 3);
        LODWORD(v26) = v26 - v29;
        v30 = byte_1C02F4118[(unsigned __int8)(7 - (v62 & 7))];
        if ( (v29 & 1) != 0 )
        {
          v31 = v15 | v30;
          v30 >>= 1;
