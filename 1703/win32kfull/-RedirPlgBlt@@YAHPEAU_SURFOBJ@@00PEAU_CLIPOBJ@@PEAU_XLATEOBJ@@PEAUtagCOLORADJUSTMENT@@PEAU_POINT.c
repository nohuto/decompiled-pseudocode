/*
 * XREFs of ?RedirPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C027BC80
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG iMode)
{
          ...
          if ( v17 )
          {
            do
            {
              ...
              if ( v18 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v18 + 1808) + 624LL) )
                  {
                    ...
                    (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, POINTFIX *, RECTL *, POINTL *, ULONG))(v20 + 624))(
                      v23,
                      v22,
                      DevBitmap,
                      v32,
  ...
  v24 = EngPlgBlt(a1, a2, a3, v13, pxlo, pca, pptlBrushOrg, pptfx, prcl, pptl, iMode);
  if ( v27 )
    bMakeOpaque(v27);
  if ( v28 )
    bMakeOpaque(v28);
