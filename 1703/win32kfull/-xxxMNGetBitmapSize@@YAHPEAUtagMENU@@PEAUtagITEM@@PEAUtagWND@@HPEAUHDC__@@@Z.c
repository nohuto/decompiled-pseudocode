/*
 * XREFs of ?xxxMNGetBitmapSize@@YAHPEAUtagMENU@@PEAUtagITEM@@PEAUtagWND@@HPEAUHDC__@@@Z @ 0x1C004372C
 * Callers:
        ...
        HDC a5)
{
  ...
  v12 = *(_DWORD *)(DPIServerInfoForDpi + 60);
  v17[3] = *((_QWORD *)a2 + 8);
  LODWORD(v17[2]) = v12;
  ...
  if ( !(unsigned int)MNIsUAHMenu((__int64)a1) || !a3 )
    goto LABEL_11;
