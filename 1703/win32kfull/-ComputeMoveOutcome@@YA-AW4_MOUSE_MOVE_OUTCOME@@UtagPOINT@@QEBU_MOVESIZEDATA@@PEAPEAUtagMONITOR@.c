/*
 * XREFs of ?ComputeMoveOutcome@@YA?AW4_MOUSE_MOVE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01EFD04
 * Callers:
...
__int64 __fastcall ComputeMoveOutcome(unsigned __int64 a1, __int64 a2, struct tagMONITOR **a3, _DWORD *a4)
{
  ...
  *a4 = v11;
  ...
  else if ( v9 == *(struct tagMONITOR **)(a2 + 216) && v11 == v12 )
  {
    v14 = 1;
    if ( (*(_DWORD *)(a2 + 264) & 2) != 0
      && *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a2 + 24LL) + 328LL)
      && (unsigned int)(v11 - 1) <= 1
      && !PtInRect((_DWORD *)(a2 + 248), a1) )
    {
      return v15;
    }
    return v14;
