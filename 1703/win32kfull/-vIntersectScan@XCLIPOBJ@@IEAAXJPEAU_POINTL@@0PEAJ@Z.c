/*
 * XREFs of ?vIntersectScan@XCLIPOBJ@@IEAAXJPEAU_POINTL@@0PEAJ@Z @ 0x1C0128E68
 * Callers:
...
void __fastcall XCLIPOBJ::vIntersectScan(XCLIPOBJ *this, LONG a2, struct _POINTL *a3, struct _POINTL *a4, int *a5)
{
  LONG v5; // r11d
