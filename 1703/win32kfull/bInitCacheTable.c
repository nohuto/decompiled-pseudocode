/*
 * XREFs of bInitCacheTable @ 0x1C013BE68
 * Callers:
...
__int64 __fastcall bInitCacheTable(int a1, int a2, __int64 a3, int *a4, __int64 a5, __int64 a6, int a7)
{
  ...
  if ( (unsigned int)bMapFileRetainHandle((unsigned __int16 *)v17, (struct _FILEVIEW *)(v9 + 104), v16, a4) )
  {
    v18 = qword_1C032C4C8;
    v19 = *(_QWORD *)(qword_1C032C4C8 + 112);
    *(_QWORD *)qword_1C032C4C8 = v19;
