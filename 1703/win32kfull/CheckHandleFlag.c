/*
 * XREFs of CheckHandleFlag @ 0x1C00E5714
 * Callers:
 *     _GetUserObjectInformation @ 0x1C00DFF38 (_GetUserObjectInformation.c)
 *     OkayToCloseWindowStation @ 0x1C00E5610 (OkayToCloseWindowStation.c)
 *     OkayToCloseDesktop @ 0x1C00E5690 (OkayToCloseDesktop.c)
 * Callees:
