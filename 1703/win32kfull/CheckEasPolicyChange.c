/*
 * XREFs of CheckEasPolicyChange @ 0x1C01B28E8
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C03388C8 != KeyInformation[0] )
  {
    qword_1C03388C8 = KeyInformation[0];
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C03388C0 != KeyInformation[0] )
  {
    qword_1C03388C0 = KeyInformation[0];
    return 1;
  }
  return v0;
}
