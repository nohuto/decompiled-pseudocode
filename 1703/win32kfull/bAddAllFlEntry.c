/*
 * XREFs of bAddAllFlEntry @ 0x1C0009970
 * Callers:
 ...
 *     bNotIsKeySymbolicLink @ 0x1C00090C8 (bNotIsKeySymbolicLink.c)
 *     GetUserEUDCRegistryPath @ 0x1C0009160 (GetUserEUDCRegistryPath.c)
 *     vLinkEudcPFEs @ 0x1C0009AE8 (vLinkEudcPFEs.c)
 *     AddAllFlEntryWorker @ 0x1C0009C7C (AddAllFlEntryWorker.c)
