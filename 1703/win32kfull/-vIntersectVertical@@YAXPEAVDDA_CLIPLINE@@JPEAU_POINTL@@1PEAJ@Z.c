/*
 * XREFs of ?vIntersectVertical@@YAXPEAVDDA_CLIPLINE@@JPEAU_POINTL@@1PEAJ@Z @ 0x1C0128D8C
 * Callers:
 ...
 * Callees:
 *     ?yCompute@DDA_CLIPLINE@@QEAAJJ@Z @ 0x1C0129C18 (-yCompute@DDA_CLIPLINE@@QEAAJJ@Z.c)
