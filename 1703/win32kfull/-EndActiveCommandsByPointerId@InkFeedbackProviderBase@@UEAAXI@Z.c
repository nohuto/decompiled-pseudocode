/*
 * XREFs of ?EndActiveCommandsByPointerId@InkFeedbackProviderBase@@UEAAXI@Z @ 0x1C021C240
 * Callers:
 *     <none>
 * Callees:
  ...
  while ( v4 != v2 )
  {
    ...
    if ( *((_DWORD *)v6 + 5) == a2 )
    {
      if ( hProvider > 4u )
      {
        ...
        v14 = &v11;
        v15 = 4;
        TlgCreateSz(&pDesc, "Terminating active command by pointer id");
