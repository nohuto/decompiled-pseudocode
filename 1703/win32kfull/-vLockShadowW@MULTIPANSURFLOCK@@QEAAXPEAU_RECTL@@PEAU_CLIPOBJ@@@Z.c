/*
 * XREFs of ?vLockShadowW@MULTIPANSURFLOCK@@QEAAXPEAU_RECTL@@PEAU_CLIPOBJ@@@Z @ 0x1C0276830
 * Callers:
 ...
 *     ?ShadowUnLockWait@@YAXPEAU_PANDEV@@@Z @ 0x1C0275F44 (-ShadowUnLockWait@@YAXPEAU_PANDEV@@@Z.c)
 */
...
void __fastcall MULTIPANSURFLOCK::vLockShadowW(MULTIPANSURFLOCK *this, struct _RECTL *a2, struct _CLIPOBJ *a3)
{
  ...
  if ( !ERECTL::bEmpty((ERECTL *)&v48) )
  {
    ...
    if ( !v14 )
      v15 = *((_QWORD *)this + 5);
    v16 = (unsigned int)v48 / *(_DWORD *)(v15 + 768);
    v17 = v14;
    v18 = v16;
    if ( !v14 )
      v17 = *((_QWORD *)this + 5);
    v19 = DWORD2(v48) / *(_DWORD *)(v17 + 768);
    v20 = v14;
    v21 = v19;
    if ( !v14 )
      v20 = *((_QWORD *)this + 5);
    v22 = DWORD1(v48) / *(_DWORD *)(v20 + 772);
    if ( !v14 )
      v14 = *((_QWORD *)this + 5);
    v23 = HIDWORD(v48) / *(_DWORD *)(v14 + 772);
    *((_BYTE *)this + 49) = 1;
    v24 = v23;
...
LABEL_25:
    ...
    if ( !v31 )
      v31 = *((_QWORD *)this + 5);
    KeWaitForSingleObject((PVOID)(*(_QWORD *)(v31 + 784) + 32LL), UserRequest, 0, 0, 0LL);
    v32 = v49;
    v33 = v27;
    v34 = v50;
    v35 = v29;
...
LABEL_36:
    ...
    if ( !v44 )
      v44 = *((_QWORD *)this + 5);
    KeReleaseMutex((PRKMUTEX)(*(_QWORD *)(v44 + 784) + 32LL), 0);
  }
}
