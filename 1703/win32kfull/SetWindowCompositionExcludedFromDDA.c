/*
 * XREFs of SetWindowCompositionExcludedFromDDA @ 0x1C020B070
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludedFromDDA(struct tagWND *a1, __int128 *a2)
{
  ...
  {
    v5 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v12[0], 15) == v5 )
      return 0;
    v12[0] = (v5 << 14) | v12[0] & 0xFFFFBFFF;
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *(_QWORD *)a1, 24, a2);
    }
  }
  return v4;
}
