/*
 * XREFs of ?bRedo@UNDOW32THREADPIDLOCKS@@QEAAHXZ @ 0x1C00A74C0
 * Callers:
...
LABEL_2:
    if ( !*((_DWORD *)this + 5) )
      return v2;
    v9 = *(_QWORD *)(*this[1] + 512);
    goto LABEL_16;
  }
  if ( !*((_DWORD *)this + 5) )
  {
    if ( (unsigned int)SURFACE::Map(*(_QWORD *)(**this + 512), 0LL, **this) == 2 )
    {
      *(_DWORD *)(**this + 44) |= 1u;
      v2 = 0;
    }
  ...
  if ( v7 >= v6 )
  {
    if ( (unsigned int)SURFACE::Map(*(_QWORD *)(v4 + 512), 0LL, v4) == 2 )
    {
      *(_DWORD *)(**this + 44) |= 1u;
      v2 = 0;
    }
...
LABEL_18:
  ...
  if ( (unsigned int)SURFACE::Map(*(_QWORD *)(*v5 + 512), 0LL, 0LL) == 2 )
  {
    *(_DWORD *)(*this[1] + 44) |= 1u;
    v2 = 0;
  }
