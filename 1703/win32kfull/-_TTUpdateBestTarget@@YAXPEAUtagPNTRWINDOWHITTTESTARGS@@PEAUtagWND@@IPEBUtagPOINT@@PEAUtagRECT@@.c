/*
 * XREFs of ?_TTUpdateBestTarget@@YAXPEAUtagPNTRWINDOWHITTTESTARGS@@PEAUtagWND@@IPEBUtagPOINT@@PEAUtagRECT@@HU4@K@Z @ 0x1C01CFC6C
 * Callers:
        ...
        __int16 a8)
{
  ...
  *(struct tagRECT *)((char *)a1 + 68) = *v9;
  ...
  if ( a8 == 3 )
    ...
    *((_DWORD *)a1 + 44) &= ~2u;
  if ( !IsCompositionInputWindow(a2) )
    IntersectRect(&v10->left, &v10->left, &a7->left);
  if ( *((_DWORD *)a1 + 21) )
  {
