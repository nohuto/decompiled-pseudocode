/*
 * XREFs of ?CommitRimCompleteFrame@@YAPEAUtagPOINTERINPUTFRAME@@PEAX@Z @ 0x1C0198BC0
 * Callers:
...
struct tagPOINTERINPUTFRAME *__fastcall CommitRimCompleteFrame(unsigned int *a1, __int64 a2, __int64 a3)
{
  ...
  v30 = 0LL;
  LOBYTE(a3) = a1[12] == 0;
  if ( (int)RawInputManagerDeviceObjectResolveHandle(*((_QWORD *)a1 + 4), 3LL, a3, &v30) >= 0 )
  {
    v4 = v30 == -64 ? 0LL : *(_QWORD *)(v30 + 64);
    RawInputManagerDeviceObjectDereference();
    v5 = HMValidateHandleNoSecure(v4, 19);
    EtwTraceBeginPointerFrameCommit(0LL, a1[6]);
    v6 = Win32AllocPoolZInit(112LL, 1718645589LL);
    if ( v6 )
    {
      ...
      *(_QWORD *)(v6 + 96) = v7;
      if ( v7 )
      {
        v9 = 216LL * a1[6];
        if ( v9 <= 0xFFFFFFFF )
          *(_QWORD *)(v6 + 88) = Win32AllocPoolZInit((unsigned int)v9, 1701868373LL);
        if ( *(_QWORD *)(v6 + 88) )
        {
          ...
          if ( a1[6] )
          {
            ...
            do
            {
              ...
              LODWORD(v13) = *v10;
              v10 += 42;
              *(_DWORD *)(v14 + *(_QWORD *)(v6 + 88) + 44) = v13;
              v15 = (_OWORD *)(v14 + *(_QWORD *)(v6 + 88));
              v15[3] = *v12;
              v15[4] = v12[1];
              v15[5] = v12[2];
              v15[6] = v12[3];
              ...
              *(_QWORD *)(v14 + *(_QWORD *)(v6 + 88) + 72) = v4;
            }
            while ( v11 < a1[6] );
          }
          v17 = dword_1C032C390 == -1;
          v18 = dword_1C032C390 + 1;
          *(_DWORD *)(v6 + 32) = dword_1C032C390;
          if ( v17 )
            v18 = 1;
          v19 = 0LL;
          dword_1C032C390 = v18;
          ...
          *(_DWORD *)(v6 + 48) = a1[7];
          ...
          while ( 1 )
          {
            ...
            {
              v23 = *(_DWORD *)(v6 + 32);
              for ( i = *(_QWORD *)(v6 + 80); i; i = *(_QWORD *)(i + 24) )
                *(_DWORD *)i = v23;
              v29[0] = v6 + 104;
              v29[1] = *(_QWORD *)(v5 + 472);
              ...
              *(_QWORD *)(v6 + 24) = v6 + 16;
              *(_QWORD *)(v6 + 16) = v6 + 16;
              return (struct tagPOINTERINPUTFRAME *)v6;
            }
          ...
          Win32FreePool(*(_QWORD *)(v6 + 88));
        }
        Win32FreePool(*(_QWORD *)(v6 + 96));
      }
      Win32FreePool(v6);
    }
  }
