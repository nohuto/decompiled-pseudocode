/*
 * XREFs of ?xxxSendMenuDrawItemMessage@@YAXPEAUHDC__@@IPEAUtagMENU@@PEAUtagITEM@@HHPEAUtagWND@@@Z @ 0x1C000DEB4
 * Callers:
 ...
 * Callees:
 *     MNInitUAHMenuItem @ 0x1C000E024 (MNInitUAHMenuItem.c)
        ...
        struct tagWND *a7)
{
  ...
  if ( v14 && ((*(_DWORD *)a4 & 0x100) != 0 || *((_QWORD *)a4 + 13) == -1LL) )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = &v19;
    ...
    ++*(_DWORD *)(v14 + 8);
    xxxSendMessage(*((_QWORD *)a3 + 11), 43LL, 0LL, v21);
