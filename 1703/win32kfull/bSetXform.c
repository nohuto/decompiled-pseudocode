/*
 * XREFs of bSetXform @ 0x1C0230C60
 * Callers:
  ...
  else
  {
    ...
    *(_DWORD *)(*(_QWORD *)(a1 + 176) + 104LL) = v25;
    ...
    else
    {
      ...
      if ( v28 * (v24 + 1) <= 0x8000 )
      {
        v29 = (unsigned int)(v28 * *(_DWORD *)(*(_QWORD *)(a1 + 176) + 104LL));
        v30 = 4718592LL * (*(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 308LL) << 16);
      }
      else
      {
        v29 = (unsigned int)(v24 * v28);
        v30 = 72LL * (*(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 308LL) << 16);
      }
      v31 = CompDiv(v29, v30);
      ...
      if ( (_DWORD)v37 != *(_DWORD *)(a1 + 44) )
      {
        ...
        {
          v38 = (unsigned int)(v37 * *(_DWORD *)(*(_QWORD *)(a1 + 176) + 104LL));
          v39 = 4718592LL * (*(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 308LL) << 16);
        }
        else
        {
          v38 = (unsigned int)(v24 * v37);
          v39 = 72LL * (*(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 308LL) << 16);
        }
        v36 = CompDiv(v38, v39);
      }
