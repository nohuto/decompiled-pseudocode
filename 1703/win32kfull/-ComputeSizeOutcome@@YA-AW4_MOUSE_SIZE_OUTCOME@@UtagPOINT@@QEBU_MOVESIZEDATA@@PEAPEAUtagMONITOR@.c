/*
 * XREFs of ?ComputeSizeOutcome@@YA?AW4_MOUSE_SIZE_OUTCOME@@UtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01EFE0C
 * Callers:
...
__int64 __fastcall ComputeSizeOutcome(struct tagPOINT a1, __int64 a2, _QWORD *a3, _DWORD *a4)
{
  ...
  *a4 = v9;
  if ( v7 )
  {
    ...
    else if ( v8 == *(struct tagMONITOR **)(a2 + 216) && v9 == v11 )
    {
      return 2LL;
    }
    else if ( v8 == *(struct tagMONITOR **)(a2 + 216) && v9 == v11 )
