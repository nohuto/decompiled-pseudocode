/*
 * XREFs of HT_HalftoneBitmap @ 0x1C0032F6C
 * Callers:
 *     EngHTBlt @ 0x1C0030E00 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C0033204 (SanityCheckDimension.c)
 *     AAHalftoneBitmap @ 0x1C0033238 (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x1C0034290 (pDCIAdjClr.c)
 *     CheckABInfo @ 0x1C023C788 (CheckABInfo.c)
 */
