/*
 * XREFs of ?bInitCache@RFONTOBJ@@QEAAHK@Z @ 0x1C008C714
 * Callers:
...
__int64 __fastcall RFONTOBJ::bInitCache(RFONTOBJ *this, int a2)
{
  ...
  unsigned int v9; // esi
  __int64 v10; // r8
  unsigned __int16 v12; // [rsp+40h] [rbp-78h] BYREF
  unsigned int v13; // [rsp+48h] [rbp-70h] BYREF
  __int64 v14; // [rsp+50h] [rbp-68h] BYREF
  _GLYPHDATA v15; // [rsp+60h] [rbp-58h] BYREF
  ...
  *(_DWORD *)(*(_QWORD *)this + 68LL) = a2;
  ...
  if ( v7 > 0x10000 && *(_DWORD *)(v8 + 72) )
    *(_DWORD *)(v8 + 68) |= 1u;
  v12 = *(_WORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 112LL) + 32LL) + 118LL);
  RFONTOBJ::vXlatGlyphArray(this, &v12, 1, &v13, 2u, 0);
  v9 = v13;
  *(_DWORD *)(*(_QWORD *)this + 720LL) &= ~0x40u;
  ...
  if ( (unsigned int)PDEVOBJ::QueryFontData(
                       ...
                       *(struct DHPDEV__ **)(v10 + 104),
                       (struct _FONTOBJ *)v10,
                       (unsigned int)(*(_DWORD *)(v10 + 72) == 2) + 1,
                       v9,
                       &v15,
                       0LL,
                       0) == -1 )
    return 0;
  *(_DWORD *)(*(_QWORD *)this + 464LL) = v15.fxD;
