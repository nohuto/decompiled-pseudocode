/*
 * XREFs of ?DwmMovePointer@@YAXPEAU_SURFOBJ@@JJPEAU_RECTL@@K@Z @ 0x1C00A0C2C
 * Callers:
...
LABEL_28:
  ...
  {
    v27 = (__int64 *)(hdev + 888);
    v28 = *((_QWORD *)hdev + 444);
    v29 = (__int64 **)*((_QWORD *)hdev + 445);
    if ( *(HDEV *)(v28 + 8) != hdev + 888 || *v29 != v27 )
      __fastfail(3u);
    *v29 = (__int64 *)v28;
    *(_QWORD *)(v28 + 8) = v29;
    v30 = *(_QWORD *)v9 + 120LL;
    ...
    *(_QWORD *)(v30 + 8) = v27;
    v32 = *(_QWORD *)v9;
    v40.x = v7 + *((_DWORD *)hdev + 650) - *(_DWORD *)(v32 + 152);
    v40.y = v6 + *((_DWORD *)hdev + 651) - *(_DWORD *)(v32 + 156);
    v33 = *(HSPRITE *)(v32 + 136);
    GreUpdateSprite(a1->hdev, 0LL, v33, 0LL, &v40, 0LL, 0LL, 0LL, 0, 0LL, 0x40200000u, 0LL, 0LL, 1, 0);
    v41 = 0LL;
