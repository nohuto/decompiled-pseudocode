/*
 * XREFs of CreateFontFromWinIni @ 0x1C000C5F8
 * Callers:
...
__int64 __fastcall CreateFontFromWinIni(__int64 a1, _DWORD *a2, unsigned int a3)
{
  ...
  _DWORD v12[48]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  if ( !a2 )
  {
    ...
    if ( !LOWORD(v12[7]) )
    {
      *(_OWORD *)&v12[7] = xmmword_1C02EDE38;
      LOWORD(v12[13]) = 0;
  ...
  FontIndirectW = GreCreateFontIndirectW(v4);
  v8 = FontIndirectW;
  if ( FontIndirectW )
  {
    GreExtGetObjectW(FontIndirectW);
    if ( v12[24] == *v4 )
    {
      LOBYTE(v9) = 10;
