/*
 * XREFs of ?vProfileDriver@PDEVOBJ@@QEAAXXZ @ 0x1C00318B4
 * Callers:
 *     PDEVOBJ_vProfileDriverWrap @ 0x1C011CD10 (PDEVOBJ_vProfileDriverWrap.c)
 * Callees:
    ...
    *(_DWORD *)(v2 + 2456) = 0;
    ...
    if ( SURFMEM::bCreateDIB((SURFMEM *)&v29, (struct _DEVBITMAPINFO *)v33, 0LL, 0LL, 0, 0LL, 0LL, 0, 1, 0, 0)
      && (unsigned int)EXLATEOBJ::bInitXlateObj(
                         ...
                         0,
                         0)
      && (unsigned int)EXLATEOBJ::bInitXlateObj(&v20, 0LL, 0LL, v4, gppalRGB, ppalDefault, ppalDefault, 0, 0, 0, 0)
      && (unsigned int)EXLATEOBJ::bInitXlateObj(&v19, 0LL, 0LL, gppalRGB, v4, ppalDefault, ppalDefault, 0, 0, 0, 0) )
    {
      v5 = *(_QWORD *)this;
      v26 = v21;
      v27 = v20;
    ...
    if ( CompatibleSurface )
    {
      ...
      if ( v12 )
      {
        ...
        v23 = 0LL;
        v22 = 0LL;
        if ( (unsigned int)EXLATEOBJ::bInitXlateObj(&v24, 0LL, 0LL, v4, v4, ppalDefault, ppalDefault, 0, 0, 0, 0) )
        {
