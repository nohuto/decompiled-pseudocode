/*
 * XREFs of PlaySoundPostMessage @ 0x1C0370070
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1C00DA5D4 (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C00D2960 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 *     I_PlaySoundkPostMessage @ 0x1C00DA654 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C00DA6A0 (PlaySndClient_midl_user_allocate.c)
 */
