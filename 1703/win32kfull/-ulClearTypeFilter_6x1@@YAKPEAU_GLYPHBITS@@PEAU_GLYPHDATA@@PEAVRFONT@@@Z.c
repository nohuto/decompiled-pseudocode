/*
 * XREFs of ?ulClearTypeFilter_6x1@@YAKPEAU_GLYPHBITS@@PEAU_GLYPHDATA@@PEAVRFONT@@@Z @ 0x1C00D8480
 * Callers:
 ...
 * Callees:
 *     ?SelectStorageTable@RFONTOBJ@@SAPEBEPEAVRFONT@@PEBE1@Z @ 0x1C00D8708 (-SelectStorageTable@RFONTOBJ@@SAPEBEPEAVRFONT@@PEBE1@Z.c)
 */
