/*
 * XREFs of ?psSetupDstSurface@@YAPEAVSURFACE@@PEAV1@PEAU_RECTL@@AEAVSURFMEM@@HH@Z @ 0x1C00ABA84
 * Callers:
    ...
    *(_QWORD *)&v23.right = __PAIR64__(v8, v6);
    if ( a5 )
    {
      ...
      if ( v15 )
        ...
        v16 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v11 + 2856);
      v17 = 0LL;
      if ( *(_QWORD *)a3 )
        v17 = *(_QWORD *)a3 + 24LL;
      DIB = ((__int64 (__fastcall *)(__int64, unsigned __int64, _QWORD, XLATEOBJ *const, struct _RECTL *, _DWORD *))v16)(
              v17,
