/*
 * XREFs of xxxGetInputEvent @ 0x1C004C770
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  {
    v7 = (unsigned int)(*(_DWORD *)(**(_QWORD **)(gptiCurrent + 416LL) + 16LL) | *(_DWORD *)(gptiCurrent + 600LL));
    if ( ((*(_WORD *)(**(_QWORD **)(gptiCurrent + 416LL) + 16LL) | *(_WORD *)(gptiCurrent + 600LL)) & 0x1000) != 0 )
