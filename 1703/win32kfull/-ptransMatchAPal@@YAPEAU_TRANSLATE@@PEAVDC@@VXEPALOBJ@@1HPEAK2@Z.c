/*
 * XREFs of ?ptransMatchAPal@@YAPEAU_TRANSLATE@@PEAVDC@@VXEPALOBJ@@1HPEAK2@Z @ 0x1C0298FA4
 * Callers:
 *     GreRealizePalette @ 0x1C0108418 (GreRealizePalette.c)
 * Callees:
 *     PALLOCMEM2 @ 0x1C002CB34 (PALLOCMEM2.c)
 *     ?ulTime@XEPALOBJ@@QEAAKXZ @ 0x1C0096770 (-ulTime@XEPALOBJ@@QEAAKXZ.c)
 *     ?ColorMatch@@YAKVXEPALOBJ@@T_PAL_ULONG@@PEAK@Z @ 0x1C0298E68 (-ColorMatch@@YAKVXEPALOBJ@@T_PAL_ULONG@@PEAK@Z.c)
 */
...
_DWORD *__fastcall ptransMatchAPal(__int64 a1, __int64 a2, __int64 a3, int a4, _DWORD *a5, _DWORD *a6)
{
  ...
  if ( result )
  {
    ...
    {
      v35 = v21;
      v37 = *(_DWORD *)(*(_QWORD *)(a3 + 120) + 4LL * v21);
...
LABEL_23:
          ...
          v27 = *(_QWORD *)(v9 + 120);
          while ( ((unsigned __int8)v22 & *(_BYTE *)(v27 + 4 * v26 + 3)) != 0 )
          {
          ...
          v24 = v26;
          ++v32;
          *(_DWORD *)(v27 + 4 * v26) = v37;
        }
      }
      else if ( (v37 & 0x2000000) == 0 )
      {
        v25 = *(_QWORD *)(v9 + 120);
        v38 = *(_DWORD *)(v25 + 4LL * v23);
        HIBYTE(v38) |= 0x30u;
        *(_DWORD *)(v25 + 4LL * v23) = v38;
      }
LABEL_27:
      *((_BYTE *)v14 + v35 + 4) = v24;
      v21 = i + 1;
