/*
 * XREFs of xxxCallIAMGetArrangementRectangleHandler @ 0x1C01B5A6C
 * Callers:
...
__int64 __fastcall xxxCallIAMGetArrangementRectangleHandler(__int64 a1, __int64 a2, _QWORD *a3, _QWORD *a4)
{
  ...
  *(_QWORD *)((char *)v14 + 12) = a2;
  ...
  HIDWORD(v14[1]) = *(_DWORD *)(gptiCurrent + 1100LL);
  v9 = *(_BYTE *)(*(_QWORD *)(gptiCurrent + 384LL) + 196LL);
  v10 = (4 * (v9 & 1)) | 1;
  if ( (v9 & 0x10) == 0 )
    v10 = 4 * (v9 & 1);
  v11 = v10 | 2;
  if ( (v9 & 4) == 0 )
    v11 = v10;
  DWORD1(v14[1]) = v11;
  result = xxxCallIAMWindowManagementHandler((struct _LARGE_STRING *)v14);
  if ( (_DWORD)result )
  {
    v13 = v14[3];
    *(_OWORD *)a3 = v14[2];
