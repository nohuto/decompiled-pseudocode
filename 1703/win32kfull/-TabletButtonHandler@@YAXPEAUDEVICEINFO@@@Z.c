/*
 * XREFs of ?TabletButtonHandler@@YAXPEAUDEVICEINFO@@@Z @ 0x1C019D750
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v5 )
    {
      Usages = HidP_GetUsages(
                 ...
                 *(PCHAR *)(*((_QWORD *)a1 + 57) + 24LL),
                 ReportLength);
      if ( dword_1C0329038 != 10 )
      {
        if ( Usages >= 0 && (v12 = 0LL, UsageLength[0]) )
        {
          while ( v5[v12] - 1 != dword_1C0329038 )
          {
