/*
 * XREFs of CheckVertTopology @ 0x1C02CDF84
 * Callers:
...
LABEL_4:
  ...
  if ( a1 > dword_1C0338B18 )
  {
    if ( dword_1C0338B18 >= State[0] )
    {
      if ( dword_1C0338B18 > State[0] || dword_1C0338B1C > dword_1C0338B14 )
        return (unsigned int)AddVertOff(a3);
      return v3;
    }
    goto LABEL_4;
  ...
  v7 = dword_1C0338B1C < dword_1C0338B14;
  if ( dword_1C0338B1C > dword_1C0338B14 )
  {
    if ( a2 < dword_1C0338B1C )
      return (unsigned int)AddVertOff(a3);
