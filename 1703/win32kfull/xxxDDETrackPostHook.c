/*
 * XREFs of xxxDDETrackPostHook @ 0x1C01E5BD0
 * Callers:
...
__int64 __fastcall xxxDDETrackPostHook(unsigned int *a1, struct tagWND *a2, __int64 a3, void **a4, int a5)
{
  ...
  if ( v14 )
  {
    ...
    if ( DdeConv )
    {
      if ( a5
        ...
        && (*(_DWORD *)(*(_QWORD *)(v16 + 16) + 568LL) & 0x40000) == 0 )
      {
        return 0;
      }
      ...
      *((_QWORD *)DdeConv + 9) = 0LL;
      ...
      LOBYTE(v19) = *(_BYTE *)(v19 + gSharedInfo[1] + 25);
  ...
  if ( v13 == 1 && (*(_DWORD *)(gptiCurrent + 440LL) & 1) == 0 )
  {
    v22 = 0x8000LL;
