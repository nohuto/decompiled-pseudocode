/*
 * XREFs of ?AdjustLegacyDeviceFlags@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C00B0F38
 * Callers:
...
void __fastcall AdjustLegacyDeviceFlags(struct tagPROCESSINFO *a1)
{
  ...
  if ( v4 )
  {
    ...
    *(_DWORD *)(v1 + 100) = v6;
    ...
    if ( gpqForeground )
    {
      v7 = *(_QWORD *)(gpqForeground + 72LL);
      if ( v7 )
        v8 = *(_QWORD *)(v7 + 16);
      else
        v8 = *(_QWORD *)(gpqForeground + 56LL);
      if ( v8 && (unsigned int)HasHidTable(v8) && *(_QWORD *)(*(_QWORD *)(v8 + 376) + 776LL) == v1 )
  ...
  else
  {
    ...
    *(_DWORD *)(v1 + 100) &= 0xFFFFFFF3;
    if ( gpqForeground )
    {
      v10 = *(_QWORD *)(gpqForeground + 72LL);
      v11 = v10 ? *(_QWORD *)(v10 + 16) : *(_QWORD *)(gpqForeground + 56LL);
      if ( v11 && (unsigned int)HasHidTable(v11) && *(_QWORD *)(*(_QWORD *)(v11 + 376) + 776LL) == v1 )
        UpdateRawMouseMode(gpqForeground);
    }
