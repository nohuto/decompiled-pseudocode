/*
 * XREFs of ?bShadowAlphaCursor@@YAHPEAU_SURFOBJ@@00PEAU_XLATEOBJ@@1PEAU_RECTL@@H@Z @ 0x1C00DDF10
 * Callers:
        ...
        int a7)
{
  ...
  XLATEOBJ *v26; // [rsp+80h] [rbp-61h]
  BLENDOBJ pBlendObj; // [rsp+88h] [rbp-59h] BYREF
...
LABEL_7:
  if ( (unsigned int)bBlurCursorShadow(a1) && (unsigned int)bBlurCursorShadow(a1) )
  {
    ...
    else
    {
      ...
      if ( a3 )
      {
        EngBitBlt(a1, a3, 0LL, 0LL, v25, &prclDest, &gptlZero, 0LL, 0LL, 0LL, 0xEEEEu);
      }
      else
      {
        pptlSrc.x = 0;
        pptlSrc.y = v13;
        EngBitBlt(a1, psoSrc, 0LL, 0LL, v26, &prclDest, &pptlSrc, 0LL, 0LL, 0LL, 0xEEEEu);
      }
    }
    return 1;
  }
