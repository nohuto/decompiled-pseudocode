/*
 * XREFs of InitializeMediaChange @ 0x1C01185C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InitializeMediaChange(HANDLE Handle)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    qword_1C032EE08 = (__int64)&gCDROMNotifyList;
    gCDROMNotifyList.Flink = &gCDROMNotifyList;
    qword_1C032EDF8 = (__int64)&gMediaChangeList;
    ...
    WPP_MAIN_CB.Queue.ListEntry.Flink = (struct _LIST_ENTRY *)Object;
    if ( v2 >= 0 )
    {
