/*
 * XREFs of ?Disconnect@CUserPlaySound@@AEAAJXZ @ 0x1C00DA4B4
 * Callers:
 *     NtUserDoSoundDisconnect @ 0x1C0008270 (NtUserDoSoundDisconnect.c)
 *     NtUserDoSoundConnect @ 0x1C011AF50 (NtUserDoSoundConnect.c)
 * Callees:
