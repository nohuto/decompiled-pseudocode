/*
 * XREFs of ?vWidenSetupForFrameRgn@EPATHOBJ@@QEAAXAEAVXDCOBJ@@JJPEAVEXFORMOBJ@@PEAU_LINEATTRS@@@Z @ 0x1C0123794
 * Callers:
        ...
        struct _LINEATTRS *a6)
{
  ...
  *(_DWORD *)(v16 + 32) = *(_DWORD *)(v14 + 368);
  ...
  {
    *v17 = v11 * *v17;
    *(float *)(*(_QWORD *)v15 + 4LL) = v11 * *(float *)(*(_QWORD *)v15 + 4LL);
  }
  else
  {
    v17[2] = v11 * v17[2];
    *(float *)(*(_QWORD *)v15 + 12LL) = v11 * *(float *)(*(_QWORD *)v15 + 12LL);
  }
