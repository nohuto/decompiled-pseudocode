/*
 * XREFs of ?MarkRecentlyDownedContactsAsNonResting@@YAXPEAUtagTPSTATE@@@Z @ 0x1C01AB8E4
 * Callers:
...
void __fastcall MarkRecentlyDownedContactsAsNonResting(struct tagTPSTATE *a1)
{
  ...
  do
  {
    if ( (*v3 & 1) != 0
      && (*v3 & 0x80u) != 0
      && (unsigned __int64)(*(_QWORD *)&KeQueryPerformanceCounter(0LL) - *((_QWORD *)v3 - 26)) < 300LL
                                                                                               * gliQpcFreq
                                                                                               / 1000 )
    {
