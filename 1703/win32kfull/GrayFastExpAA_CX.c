/*
 * XREFs of GrayFastExpAA_CX @ 0x1C0245940
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      switch ( v14 )
      {
        case 2:
          v28 = 3 * v9;
          *a3 = (v28 + (unsigned int)v13 + 2) >> 2;
          a3 = (_WORD *)((char *)a3 + a5);
          v25 = ((unsigned int)v11 + v28 + 2) >> 2;
          goto LABEL_16;
        case 3:
          v26 = 2 * v9;
          *a3 = (v13 + v9 + 2 * (v26 + (unsigned int)v13 + 2)) >> 3;
...
LABEL_16:
        ...
        case 4:
          v21 = 2 * v9;
          *a3 = (v13 + v9 + 2 * (v21 + (unsigned int)v13 + 2)) >> 3;
          v22 = (_WORD *)((char *)a3 + a5);
          *v22 = (v13 + 4 * v9 + 8 + v11 + 2 * (v13 + 4 * (unsigned int)v9)) >> 4;
          v23 = (_WORD *)((char *)v22 + a5);
          *v23 = (v11 + 4 * v9 + 8 + v13 + 2 * (v11 + 4 * (unsigned int)v9)) >> 4;
        ...
        case 5:
          v15 = 19 * v9;
          v16 = 25 * v9;
          *a3 = (v15 + 13 * (unsigned int)v13 + 16) >> 5;
          v17 = (_WORD *)((char *)a3 + a5);
          *v17 = (v16 + v11 + 2 * (v13 + 2 * ((unsigned int)v13 + 4))) >> 5;
          v18 = (_WORD *)((char *)v17 + a5);
          *v18 = (v13 + v11 + 2 * (v13 + v11 + 13 * (unsigned int)v9 + 8)) >> 5;
          v19 = (_WORD *)((char *)v18 + a5);
          *v19 = (v13 + v16 + 2 * (v11 + 2 * ((unsigned int)v11 + 4))) >> 5;
