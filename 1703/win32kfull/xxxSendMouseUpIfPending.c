/*
 * XREFs of xxxSendMouseUpIfPending @ 0x1C01B19D8
 * Callers:
...
__int64 __fastcall xxxSendMouseUpIfPending(int *a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // ebx
  __int64 result; // rax
  ...
  if ( *a1 )
  {
    *a1 = 0;
    ...
    QueuePTPMouseEvent(0LL, *(struct tagPOINT *)gptCursorAsync, v4, a2);
