/*
 * XREFs of AddRemovePointerDeviceSystemMetricKey @ 0x1C00FEB60
 * Callers:
 *     InitializePointerDevicesPresenceState @ 0x1C00FE8D0 (InitializePointerDevicesPresenceState.c)
 *     ForceUpdatePointerDeviceSystemMetricKeys @ 0x1C00FE98C (ForceUpdatePointerDeviceSystemMetricKeys.c)
