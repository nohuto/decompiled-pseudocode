/*
 * XREFs of ?AllocatePool@?$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@SAPEAXW4_POOL_TYPE@@_KIPEAI@Z @ 0x1C01E8A90
 * Callers:
 *     Win32UAFMAllocPagedLookasideListImpl @ 0x1C01E8F30 (Win32UAFMAllocPagedLookasideListImpl.c)
 *     Win32UAFMAllocPoolImpl @ 0x1C01E8FB0 (Win32UAFMAllocPoolImpl.c)
 * Callees:
