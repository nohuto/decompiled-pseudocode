/*
 * XREFs of ?CreatePhysicalMonitor@CMonitorAPI@@QEAAJAEAU_LUID@@KPEAPEAX@Z @ 0x1C0247E90
 * Callers:
 *     CreatePhysicalMonitorWrap @ 0x1C0249120 (CreatePhysicalMonitorWrap.c)
 * Callees:
...
__int64 __fastcall CMonitorAPI::CreatePhysicalMonitor(CMonitorAPI *this, struct _LUID *a2, unsigned int a3, void **a4)
{
  ...
  v14 = this;
  v4 = qword_1C032C900;
  CAutoMutex::CAutoMutex((CAutoMutex *)v13, (struct CMutex *)qword_1C032C900);
  v12 = 0LL;
  LODWORD(v14) = 0;
