/*
 * XREFs of ?pvFillOpaqTable@@YAPEAXKKKPEAVSURFACE@@@Z @ 0x1C00FA78C
 * Callers:
...
int *__fastcall pvFillOpaqTable(int a1, int a2, int a3, struct SURFACE *a4)
{
  ...
  if ( *(_QWORD *)a4 != qword_1C032CA88 || a3 != dword_1C032CA90 || a2 != dword_1C032CA94 )
  {
    qword_1C032CA88 = *(_QWORD *)a4;
    v8 = *((_QWORD *)a4 + 16);
    dword_1C032CA94 = a2;
    dword_1C032CA90 = a3;
    if ( !v8 )
    ...
    if ( a1 == 2 )
    {
      LOWORD(dword_1C03303C0) = a3;
      v31 = (_WORD *)&dword_1C03303C0 + 1;
      do
      {
      ...
      while ( v31 < word_1C03303DE );
      *v31 = a2;
    }
    else
    {
      dword_1C03303C0 = a3;
      v29 = (unsigned int *)&unk_1C03303C4;
      do
      {
        v28 = (unsigned int)(v33 + v28);
        v27 += v26;
      ...
      while ( v29 < &dword_1C03303FC );
      *v29 = a2;
    }
  }
  return &dword_1C03303C0;
}
