/*
 * XREFs of ?vPatCpyRect1_6x6@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x1C02A1960
 * Callers:
...
void __fastcall vPatCpyRect1_6x6(struct _PATBLTFRAME *a1, int a2)
{
  ...
  char v72; // [rsp+2Ch] [rbp-75h]
  int v73; // [rsp+30h] [rbp-71h]
  int v74; // [rsp+34h] [rbp-6Dh]
  int v75; // [rsp+38h] [rbp-69h]
  int v76; // [rsp+3Ch] [rbp-65h]
  unsigned int Size; // [rsp+40h] [rbp-61h]
  int Size_4; // [rsp+44h] [rbp-5Dh]
  int v79; // [rsp+48h] [rbp-59h]
  int v80; // [rsp+4Ch] [rbp-55h]
  int v81; // [rsp+50h] [rbp-51h]
  int v82; // [rsp+54h] [rbp-4Dh]
  _BYTE *v84; // [rsp+60h] [rbp-41h]
  char v85; // [rsp+68h] [rbp-39h]
  int v86; // [rsp+6Ch] [rbp-35h]
  int v87; // [rsp+70h] [rbp-31h]
  int *v88; // [rsp+78h] [rbp-29h]
  int *v89; // [rsp+80h] [rbp-21h]
  __int64 v90; // [rsp+88h] [rbp-19h]
  char *v92; // [rsp+98h] [rbp-9h]
  _BYTE *v93; // [rsp+A0h] [rbp-1h]
  __int64 v94; // [rsp+A8h] [rbp+7h]
  _BYTE Src[12]; // [rsp+B0h] [rbp+Fh] BYREF
  int v96; // [rsp+BCh] [rbp+1Bh]
  ...
  do
  {
    ...
    v74 = v9;
    v80 = ~v9;
    v89 = (int *)(*(_QWORD *)v2 + *((_DWORD *)v2 + 4) * v3[1] + 4 * ((__int64)*v3 >> 5));
    v11 = (v5 >> 5) - ((v4 + 31) >> 5);
    if ( v11 == -1 )
      goto LABEL_12;
    if ( v11 )
...
LABEL_13:
    ...
    if ( v19 >= 6 || (v18 = v3[3] - v6, v19) )
    {
      ...
      do
      {
        ...
        v27 = *v14 >> 2;
        if ( v15 )
          v28 = ((unsigned __int8)(v27 << v85) | (v27 >> v15)) & 0x3F;
        else
          v28 = v27;
        if ( v12 == 9 )
        {
