/*
 * XREFs of HT_CreateStandardMonoPattern @ 0x1C00F4124
 * Callers:
...
__int64 __fastcall HT_CreateStandardMonoPattern(__int64 a1, __int16 *a2)
{
  ...
  if ( v2 > 0x76u )
    return 4294967269LL;
  v21 = 0;
  v5 = pDCIAdjClr(a1, 0LL, 0LL, 0, 0, 0, &v22);
  v6 = v5;
  if ( v5 )
  {
    if ( v2 >= 0x12u )
    {
      v10 = *(unsigned __int16 *)(v5 + 166);
      v12 = *(_WORD *)(v5 + 170);
      BYTE2(v22) = *((_BYTE *)a2 + 2);
      v11 = BYTE2(v22);
      a2[4] = v10;
      a2[5] = v12;
      v13 = ComputeBytesPerScanLine(1LL, v11, v10);
      v16 = *((_QWORD *)a2 + 2);
      a2[3] = v13;
      if ( !v16 )
      {
      ...
      BYTE1(v22) = v15;
      HIBYTE(v22) = 0;
      HalftoneBrush = HT_CreateHalftoneBrush(v4, 0, (unsigned int)v19, v22, v16);
    }
    else
    {
