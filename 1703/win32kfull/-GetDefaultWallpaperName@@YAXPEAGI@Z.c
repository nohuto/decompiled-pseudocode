/*
 * XREFs of ?GetDefaultWallpaperName@@YAXPEAGI@Z @ 0x1C01ED720
 * Callers:
...
LABEL_15:
  ...
  *(_WORD *)v9 = 0;
LABEL_20:
  if ( *(unsigned __int8 *)(gpsi + 8682LL) * (unsigned int)*(unsigned __int8 *)(gpsi + 8683LL) > 4 )
  {
    v10 = 0;
    if ( (unsigned __int64)(unsigned int)v3 - 1 > 0x7FFFFFFE )
      v10 = -1073741811;
    if ( v10 < 0 )
      goto LABEL_29;
    v11 = (unsigned int)v3;
