/*
 * XREFs of UpdateCursorSizes @ 0x1C010FF70
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x1C013C680 (__security_check_cookie.c)
 *     ?UnlockDpiCursors@@YAXK@Z @ 0x1C0195CFC (-UnlockDpiCursors@@YAXK@Z.c)
 */
