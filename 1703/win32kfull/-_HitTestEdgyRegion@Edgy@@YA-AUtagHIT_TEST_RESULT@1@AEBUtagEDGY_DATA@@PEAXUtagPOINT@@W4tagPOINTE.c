/*
 * XREFs of ?_HitTestEdgyRegion@Edgy@@YA?AUtagHIT_TEST_RESULT@1@AEBUtagEDGY_DATA@@PEAXUtagPOINT@@W4tagPOINTER_DEVICE_TYPE@@H@Z @ 0x1C01CE328
 * Callers:
 ...
 *     ?_GetRectForLocation@Edgy@@YA?AUtagRECT@@AEBU2@W4tagEDGY_LOCATION@@K@Z @ 0x1C01CE2B4 (-_GetRectForLocation@Edgy@@YA-AUtagRECT@@AEBU2@W4tagEDGY_LOCATION@@K@Z.c)
 */
  ...
  *((_DWORD *)a1 + 4) = 0;
  if ( (unsigned int)GetPointerDeviceRects(a3, &v22, 0LL) )
  {
    ...
    if ( *a2 )
    {
      ...
      {
        v13 = 32LL * v11;
        if ( *(struct _LIST_ENTRY **)(v13 + v12) == a3 )
        {
