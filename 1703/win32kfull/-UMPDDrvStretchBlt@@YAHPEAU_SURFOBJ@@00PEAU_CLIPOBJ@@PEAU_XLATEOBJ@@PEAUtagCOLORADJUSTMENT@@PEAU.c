/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C0096790
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  _QWORD Src[16]; // [rsp+130h] [rbp+20h] BYREF
...
LABEL_3:
    ...
    if ( !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 64), (struct _SURFOBJ **)&Src[3], v13)
      ...
      || !(unsigned int)UMPDOBJ::ThunkDDIOBJ(v16, (UMPDOBJ *)((char *)v16 + 112), (void **)&Src[6], 0x18u)
      || !(unsigned int)UMPDOBJ::pxlo(v16, (struct _XLATEOBJ **)&Src[7])
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&Src[8], 0x18u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&Src[9], 8u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&Src[10], 0x10u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&Src[11], 0x10u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (void **)&Src[12], 8u)
      || (LODWORD(Size) = 4, UMPDOBJ::Thunk(v16, Src, 0x80u, &v22, Size) == -1)
      || (v17 = 1, !v22) )
    {
      v17 = 0;
    }
