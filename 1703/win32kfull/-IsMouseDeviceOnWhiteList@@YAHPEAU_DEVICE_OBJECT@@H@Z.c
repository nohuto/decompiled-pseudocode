/*
 * XREFs of ?IsMouseDeviceOnWhiteList@@YAHPEAU_DEVICE_OBJECT@@H@Z @ 0x1C019BA58
 * Callers:
 *     IsLegacyTouchPadDevice @ 0x1C011BD90 (IsLegacyTouchPadDevice.c)
 * Callees:
 *     ?IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z @ 0x1C0013DC0 (-IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z.c)
 *     GetPointerDeviceId @ 0x1C0013E80 (GetPointerDeviceId.c)
