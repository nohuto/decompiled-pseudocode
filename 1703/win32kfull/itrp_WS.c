...
__int64 __fastcall itrp_WS(__int64 a1)
{
    ...
    && (v2 = qword_1C032C9E8, (unsigned __int64)((qword_1C032C9E8 - *(_QWORD *)qword_1C032CA00) >> 2) >= 2) )
  {
    ...
    v4 = *(_QWORD *)(qword_1C032CA00 + 344);
    v5 = *(int *)(v2 - 8);
    if ( (int)v5 < *(unsigned __int16 *)(v4 + 18) && (int)v5 >= 0 )
    {
      v6 = *(_QWORD *)(qword_1C032CA00 + 8);
      if ( (qword_1C032CA00 ^ v4 ^ v6 ^ MEMORY[0xFFFFF78000000330]) == *(_QWORD *)(qword_1C032CA00 + 352) )
      {
        *(_DWORD *)(v6 + 4 * v5) = v3;
        return a1;
      }
