/*
 * XREFs of ?BuildComponentInformation@InteractiveControlParser@@CAJPEAU_HIDP_PREPARSED_DATA@@GPEAU_HIDP_LINK_COLLECTION_NODE@@PEAVInteractiveControlDevice@@@Z @ 0x1C02240CC
 * Callers:
 ...
 *     ?CreateAndLinkComponent@InteractiveControlParser@@CAJPEAU_HIDP_VALUE_CAPS@@HPEAU_INTERACTIVECTRL_CAPABILITIES@@PEAPEAUtagINTERACTIVECTRL_COMPONENT_ENTRY@@@Z @ 0x1C02246C4 (-CreateAndLinkComponent@InteractiveControlParser@@CAJPEAU_HIDP_VALUE_CAPS@@HPEAU_INTERACTIVECTRL.c)
        ...
        struct InteractiveControlDevice *a4)
{
  ...
  USHORT v19; // [rsp+48h] [rbp-51h] BYREF
  struct tagINTERACTIVECTRL_COMPONENT_ENTRY *v20[2]; // [rsp+50h] [rbp-49h] BYREF
...
LABEL_33:
    ...
    {
      if ( HidP_GetSpecificValueCaps(HidP_Feature, 1u, 0, 0x48u, &v21, &v19, PreparsedData) >= 0 )
      {
        ...
        *v13 = v21.ReportID;
        v14 = (SimpleHapticsController *)*((_QWORD *)a4 + 47);
        if ( v14 )
      ...
      if ( ValueCapsLength[0] )
      {
        do
        {
          v11 = InteractiveControlParser::CreateAndLinkComponent(&ValueCaps[v4], 0, v5, v20);
          if ( v11 < 0 )
            goto LABEL_28;
          if ( v20[0] && ValueCaps[v4].LinkCollection == v21.LinkCollection )
            *((_DWORD *)v20[0] + 31) = 1;
        }
  ...
  if ( (!SpecificButtonCaps || SpecificButtonCaps == -1072627705) && ButtonCapsLength[0] )
  {
    ...
    if ( v9 )
    {
      ...
      if ( v11 >= 0 && ButtonCapsLength[0] )
      {
        do
        {
          v11 = InteractiveControlParser::CreateAndLinkComponent((struct _HIDP_VALUE_CAPS *)&v9[v4], 1, v5, v20);
          if ( v11 < 0 )
            break;
          ++v4;
        }
