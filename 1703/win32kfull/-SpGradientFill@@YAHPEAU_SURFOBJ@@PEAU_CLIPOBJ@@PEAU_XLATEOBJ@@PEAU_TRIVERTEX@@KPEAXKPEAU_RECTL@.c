/*
 * XREFs of ?SpGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1C0131660
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  struct _RECTL *v22; // [rsp+88h] [rbp-78h]
  void *v23; // [rsp+90h] [rbp-70h]
  struct _TRIVERTEX *v24; // [rsp+98h] [rbp-68h]
  struct _XLATEOBJ *v25; // [rsp+A0h] [rbp-60h]
...
LABEL_31:
    ...
    if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v11) + 112) & 0x20000) == 0 )
      goto LABEL_31;
    v14 = (BOOL (__stdcall *)(SURFOBJ *, CLIPOBJ *, XLATEOBJ *, TRIVERTEX *, ULONG, PVOID, ULONG, RECTL *, POINTL *, ULONG))*((_QWORD *)v11->hdev + 173);
LABEL_9:
    v10 &= OffGradientFill(v14, &v20, v11, v19, v25, v24, a5, v23, a7, v22, v21, a10);
LABEL_10:
    if ( v12 )
