/*
 * XREFs of itrp_SetRoundValues @ 0x1C02DA6B8
 * Callers:
 *     itrp_S45ROUND @ 0x1C02D8090 (itrp_S45ROUND.c)
 *     itrp_SROUND @ 0x1C02DA0A0 (itrp_SROUND.c)
 * Callees:
 *     <none>
 */
...
__int16 __fastcall itrp_SetRoundValues(char a1, int a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( v5 )
    {
      if ( v5 == 64 )
      {
        *(_WORD *)(qword_1C032CA00 + 142) = 128;
        goto LABEL_9;
      }
      v4 = 999;
    }
    *(_WORD *)(qword_1C032CA00 + 142) = v4;
LABEL_9:
    *(_DWORD *)(v2 + 136) = ~(*(__int16 *)(v2 + 142) - 1);
    goto LABEL_18;
  }
  *(_WORD *)(qword_1C032CA00 + 140) = 11591;
  if ( (a1 & 0xC0) == 0 )
  {
    v7 = 5795;
LABEL_16:
