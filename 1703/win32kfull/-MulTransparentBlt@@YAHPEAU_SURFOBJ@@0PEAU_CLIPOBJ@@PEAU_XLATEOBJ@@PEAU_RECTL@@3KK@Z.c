/*
 * XREFs of ?MulTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KK@Z @ 0x1C0283D60
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ulReserved)
{
  ...
  RECTL *prclSrc; // [rsp+108h] [rbp+8h]
  _BYTE v52[64]; // [rsp+110h] [rbp+10h] BYREF
  struct _DISPSURF *v53; // [rsp+150h] [rbp+50h]
  int v54[2]; // [rsp+158h] [rbp+58h]
  struct _CLIPOBJ *v55; // [rsp+160h] [rbp+60h]
  int v56[2]; // [rsp+168h] [rbp+68h]
  _BYTE v57[56]; // [rsp+180h] [rbp+80h] BYREF
  __int64 v58; // [rsp+1B8h] [rbp+B8h]
  char v59; // [rsp+1C0h] [rbp+C0h]
  int v60; // [rsp+1C4h] [rbp+C4h]
  ...
  v63 = *a6;
  if ( v13->iType != 1 || !v14 || (*(_DWORD *)(v14 + 32) & 0x20000) == 0 )
  {
LABEL_8:
    v38 = 1;
...
LABEL_51:
      ...
      if ( !v19 )
      {
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)v54) + 112) & 0x8000) != 0 )
          v36 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, RECTL *, ULONG, ULONG))(*((_QWORD *)v53 + 7) + 3296LL);
        else
