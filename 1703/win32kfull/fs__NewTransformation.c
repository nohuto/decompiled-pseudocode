/*
 * XREFs of fs__NewTransformation @ 0x1C02BCA4C
 * Callers:
 *     bSetXform @ 0x1C0230C60 (bSetXform.c)
 *     bChangeXform @ 0x1C0231E50 (bChangeXform.c)
 * Callees:
 *     fs_SetUpKey @ 0x1C02BC1D0 (fs_SetUpKey.c)
 *     sbit_NewTransform @ 0x1C02C4CC8 (sbit_NewTransform.c)
 *     fsg_CopyFontProgramResults @ 0x1C02C6BC4 (fsg_CopyFontProgramResults.c)
 *     fsg_InitInterpreterTrans @ 0x1C02C7CB4 (fsg_InitInterpreterTrans.c)
 *     fsg_QueryPPEMXY @ 0x1C02C8420 (fsg_QueryPPEMXY.c)
