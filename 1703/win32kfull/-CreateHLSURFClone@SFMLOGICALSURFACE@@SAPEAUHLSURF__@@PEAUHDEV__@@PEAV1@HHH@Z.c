/*
 * XREFs of ?CreateHLSURFClone@SFMLOGICALSURFACE@@SAPEAUHLSURF__@@PEAUHDEV__@@PEAV1@HHH@Z @ 0x1C00A046C
 * Callers:
 ...
 *     SFMLOGICALSURFACE_CreateHLSURFCloneWrap @ 0x1C00A0460 (SFMLOGICALSURFACE_CreateHLSURFCloneWrap.c)
 * Callees:
  ...
  if ( v23 && v21 && v19 )
  {
                         ...
                         *((_DWORD *)a2 + 74)) )
    {
      ...
      *(_DWORD *)(v12 + 64) = *((_DWORD *)a2 + 16);
      if ( HmgInsertObjectHelper::Insert((HmgInsertObjectHelper *)&v30, (struct OBJECT *)v12, 0, 1, 18) )
      {
        v6 = *(HLSURF *)v12;
        v13 = (v9 & 0x10 | 0x40u) >> 4;
