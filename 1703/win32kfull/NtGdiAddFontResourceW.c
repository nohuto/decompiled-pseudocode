/*
 * XREFs of NtGdiAddFontResourceW @ 0x1C00EAB10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tagDESIGNVECTOR *a6)
{
  ...
  int v12; // r15d
  __int64 v13; // rcx
  size_t v15; // [rsp+30h] [rbp-188h]
  _BYTE v17[4]; // [rsp+80h] [rbp-138h] BYREF
  int v18; // [rsp+84h] [rbp-134h]
  _BYTE v19[160]; // [rsp+D0h] [rbp-E8h] BYREF
  ...
  if ( (int)UmfdHostLifeTimeManager::WaitForSessionRasterizerInitialization() < 0
    || a4 == 0x80000000 && PsGetCurrentProcess(v13) != gpepCSRSS )
  {
    return 0LL;
  }
  if ( a2 > 1 )
  ...
  if ( v11 && a6 )
  {
    if ( (unsigned int)ProbeAndReadDesignVector(v17, a6) )
    {
      if ( v18 )
      {
  ...
  {
    LODWORD(v15) = v12;
    v11 = GreAddFontResourceWInternal(v10, a2, a3, a4, a5, v9, v15);
  }
  if ( v10 )
  {
