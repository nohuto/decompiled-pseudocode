/*
 * XREFs of ?bExtraRectsToPath@ESTROBJ@@QEAAHAEAVEPATHOBJ@@@Z @ 0x1C02999E8
 * Callers:
 ...
 *     ?bLinkedGlyphs@ESTROBJ@@QEAAHXZ @ 0x1C0195824 (-bLinkedGlyphs@ESTROBJ@@QEAAHXZ.c)
...
LABEL_31:
      ...
      while ( 1 )
      {
        ...
        v45 = 0;
        v37 = *(_DWORD *)(v36 + 16);
        bFToL(v35 * (float)v37, &v45, 0);
        v66 = 0;
        v38 = v60[1];
        bFToL(v38 * (float)v37, &v66, v39);
        ...
        {
          LODWORD(v44) = v48;
          if ( !(unsigned int)bAddPgmToPath(a2, v57 + v63 + v45, v56 + v65 + v66, v47, v46, v58, v44) )
            break;
        }
        if ( (*((_DWORD *)this + 16) & 0x80u) != 0 )
        {
          LODWORD(v44) = v51;
          if ( !(unsigned int)bAddPgmToPath(a2, v50 + v63 + v45, v49 + v65 + v66, v47, v46, v52, v44) )
            break;
        }
        v17 = v54 + 24;
        ++v53;
