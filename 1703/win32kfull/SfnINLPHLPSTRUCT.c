/*
 * XREFs of SfnINLPHLPSTRUCT @ 0x1C01FACB0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v10 = 0LL;
  result = AllocCallbackMessage(88, 1u, *(unsigned __int16 *)a4, v34, 1, 0x200uLL);
  v12 = result;
  v25 = result;
  if ( result )
  {
    ...
    *((_QWORD *)v12 + 2) = 0LL;
    v18 = KeUserModeCallback(14LL, v12, *(unsigned int *)v12, &v26, v24);
