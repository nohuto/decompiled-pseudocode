/*
 * XREFs of fs__Contour @ 0x1C02BC2C8
 * Callers:
 *     bGetGlyphOutline @ 0x1C022C864 (bGetGlyphOutline.c)
 *     fs_NewContourGridFit @ 0x1C022D404 (fs_NewContourGridFit.c)
 * Callees:
 *     fs_SetUpKey @ 0x1C02BC1D0 (fs_SetUpKey.c)
 *     CompDiv @ 0x1C02BD158 (CompDiv.c)
 *     InvokeGlobalGSScale @ 0x1C02BDD44 (InvokeGlobalGSScale.c)
 *     scl_CalcDevAdvanceWidth @ 0x1C02BE248 (scl_CalcDevAdvanceWidth.c)
 *     scl_CalcDevHorMetrics @ 0x1C02BE2A4 (scl_CalcDevHorMetrics.c)
 ...
 *     fsg_QueryTwilightElement @ 0x1C02C84B8 (fsg_QueryTwilightElement.c)
 *     fsg_QueryTwilightElementSubPixel @ 0x1C02C8524 (fsg_QueryTwilightElementSubPixel.c)
 *     fsg_RunPreProgram @ 0x1C02C8584 (fsg_RunPreProgram.c)
 *     fsg_UpdatePrivateSpaceAddresses @ 0x1C02C8904 (fsg_UpdatePrivateSpaceAddresses.c)
...
__int64 __fastcall fs__Contour(__int64 a1, __int64 a2, int a3)
{
  ...
  __int64 v48; // [rsp+D0h] [rbp+67h] BYREF
  int v49; // [rsp+E0h] [rbp+77h]
  int v50; // [rsp+E8h] [rbp+7Fh] BYREF
  int v51; // [rsp+ECh] [rbp+83h]
  ...
  {
    *(_DWORD *)(v9 + 956) = 1;
    result = sbit_GetDevAdvanceWidth(v9 + 964, v9, &v48);
    if ( (_DWORD)result )
      return result;
    result = sbit_GetDevAdvanceHeight(v9 + 964, v9, &v50);
    if ( (_DWORD)result )
      return result;
    v21 = v51;
    v22 = v50;
...
LABEL_50:
    fsg_GetContourData(
      ...
      *(_WORD *)(v9 + 1076) & 0x10,
      ...
      a2 + 118);
    v36 = *(_QWORD *)(v9 + 448);
    scl_CalcDevAdvanceWidth(v36, &v48);
    v37 = *(_WORD *)(*(_QWORD *)(v36 + 64) + 2LL * (*(__int16 *)(v36 + 80) - 1));
    v38 = v37 + 4;
    v37 += 3;
    v22 = *(_DWORD *)(*(_QWORD *)v36 + 4LL * v37) - *(_DWORD *)(*(_QWORD *)v36 + 4LL * v38);
    v21 = *(_DWORD *)(*(_QWORD *)(v36 + 8) + 4LL * v37) - *(_DWORD *)(*(_QWORD *)(v36 + 8) + 4LL * v38);
LABEL_51:
    v39 = (_DWORD)v48 << 10;
    v40 = HIDWORD(v48) << 10;
    v41 = v22 << 10;
    v42 = v21 << 10;
    *(_DWORD *)(a2 + 72) = (_DWORD)v48 << 10;
    *(_DWORD *)(a2 + 76) = v40;
    *(_DWORD *)(a2 + 204) = v41;
    *(_DWORD *)(a2 + 208) = v42;
    if ( (*(_BYTE *)(v9 + 1076) & 1) != 0 )
    {
      *(_DWORD *)(a2 + 72) = (v39 + 3) / 6;
      *(_DWORD *)(a2 + 204) = (v41 + 3) / 6;
      if ( (*(_BYTE *)(v9 + 1076) & 0x10) != 0 )
      {
        *(_DWORD *)(a2 + 76) = (v40 + 2) / 5;
        *(_DWORD *)(a2 + 208) = (v42 + 2) / 5;
      }
    }
...
LABEL_44:
    ...
    if ( v31 && (*(_BYTE *)(v9 + 1076) & 2) != 0 )
    {
      ...
      v35 = *(_WORD *)(*(_QWORD *)(v32 + 64) + 2LL * (*(__int16 *)(v32 + 80) - 1));
      *(_DWORD *)(*(_QWORD *)v32 + 4LL * (unsigned __int16)(v35 + 2)) = 6 * v26
                                                                      + *(_DWORD *)(*(_QWORD *)v32
                                                                                  + 4LL * (unsigned __int16)(v35 + 1));
    }
    goto LABEL_50;
  }
  if ( *(_DWORD *)(v9 + 844) )
  {
    result = sbit_CalcDevHorMetrics((int)v9 + 964, v9, (unsigned int)&v48, (unsigned int)&v45, (__int64)&v50);
    if ( (_DWORD)result )
      return result;
  }
  else
  {
    scl_CalcDevHorMetrics(*(_QWORD *)(v9 + 448), &v48, &v45, &v50);
  }
  v27 = *(_WORD *)(v9 + 384);
  v26 = v48;
  if ( v27 && (_DWORD)v48 )
