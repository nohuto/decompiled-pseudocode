/*
 * XREFs of ?MulFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C0282070
 * Callers:
 *     <none>
 * Callees:
        ...
        FLONG flOptions)
{
  ...
  struct _RECTFX prectfx; // [rsp+140h] [rbp+40h] BYREF
  struct _RECTL v26; // [rsp+150h] [rbp+50h] BYREF
  ...
  if ( v23[0] )
  {
    ...
    for ( i = MSURF::bFindSurface((MSURF *)v18, a1, a3, &v26); i; i = MSURF::bNextSurface((MSURF *)v18) )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v20) + 112) & 0x40) != 0 )
        v16 = *(BOOL (__stdcall **)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, BRUSHOBJ *, POINTL *, MIX, FLONG))(*((_QWORD *)v19 + 7) + 2824LL);
      else
        v16 = EngFillPath;
