/*
 * XREFs of vInitFontsDirectoryNameInformation @ 0x1C0119660
 * Callers:
 *     <none>
 * Callees:
 *     ?QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z @ 0x1C0028274 (-QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z.c)
...
int vInitFontsDirectoryNameInformation()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (int)v0 >= 0 )
  {
    ...
    v4 = (unsigned __int16 *)PALLOCMEM2(0x208uLL, 1986422343LL, 1);
    gpwszFontsDirectory = v4;
    if ( v4 )
    {
      if ( (unsigned int)bAppendSysDirectory(v4, &word_1C02E2588) )
      {
        v5 = -1LL;
        do
          ++v5;
