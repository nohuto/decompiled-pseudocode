/*
 * XREFs of ?CreateUsermodeParameters@QueryTrueTypeOutlineRequest@@UEAAJPEAVUmfdTls@@PEAPEAX@Z @ 0x1C012E380
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( !v10 )
    return 3221225495LL;
  *((_QWORD *)this + 10) = (char *)v10 + v9;
  v11 = (char *)v10 + v9 + v8;
  *((_QWORD *)this + 11) = v11;
  *((_QWORD *)this + 12) = (unsigned __int64)&v11[v6] & -(__int64)(*((_QWORD *)this + 8) != 0LL);
  *v10 = *((_QWORD *)this + 3);
  v12 = *((_QWORD *)this + 10);
  v13 = *((_QWORD *)this + 4);
  ...
  *(_QWORD *)(v12 + 24) = **(_QWORD **)(v13 + 24);
  ...
  v10[1] = *((_QWORD *)this + 10);
  *((_DWORD *)v10 + 4) = *((_DWORD *)this + 10);
  *((_DWORD *)v10 + 5) = *((_DWORD *)this + 11);
  if ( *((_QWORD *)this + 6) )
    v10[3] = *((_QWORD *)this + 11);
  v10[5] = *((_QWORD *)this + 12);
  *((_DWORD *)v10 + 8) = *((_DWORD *)this + 14);
  *a3 = v10;
  return 0LL;
}
