/*
 * XREFs of ?pxrlStrRead32@@YAPEAU_XRUNLEN@@PEAU_STRDDA@@PEAU_STRRUN@@PEAE2PEAU_XLATEOBJ@@JJJ@Z @ 0x1C029ED90
 * Callers:
 *     <none>
 * Callees:
        ...
        int a8)
{
  ...
  unsigned __int8 *v40; // [rsp+78h] [rbp+20h]
