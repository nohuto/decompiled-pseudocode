/*
 * XREFs of xxxDispatchMessage @ 0x1C00CC438
 * Callers:
...
__int64 __fastcall xxxDispatchMessage(_QWORD *a1)
{
  ...
  __int64 v11; // rax
  char v12; // r8
  __int64 (__fastcall *v13)(__int64 *, unsigned int, __int64, __int64, unsigned __int64, __int64); // rax
...
LABEL_32:
    ...
    if ( (v12 & 4) != 0 )
    {
      ...
      if ( (unsigned int)i < 0x400 )
        v13 = (__int64 (__fastcall *)(__int64 *, unsigned int, __int64, __int64, unsigned __int64, __int64))gapfnScSendMessage[(unsigned __int8)MessageTable[i]];
      else
        v13 = SfnDWORD;
...
LABEL_56:
        v10 = v19;
        if ( *((_DWORD *)a1 + 2) == 15 && HMValidateHandleNoSecure(*a1, 1) && (*(_BYTE *)(v6 + 58) & 0x40) != 0 )
        {
    ...
    v19 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64, _QWORD, unsigned __int64, _QWORD, int, _QWORD))gapfnScSendMessage[(unsigned __int8)MessageTable[(unsigned __int16)v17]])(
            v6,
            v17,
            v20,
            a1[3],
