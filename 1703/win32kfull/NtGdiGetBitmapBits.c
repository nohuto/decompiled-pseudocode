/*
 * XREFs of NtGdiGetBitmapBits @ 0x1C00271B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetBitmapBits(__int64 a1, ULONG a2, volatile void *a3)
{
  unsigned int v6; // edi
  HANDLE v7; // rbx
  ...
  v7 = 0LL;
  v10 = 0;
  BitmapBits = GreGetBitmapBits(a1, 0, 0LL, &v10);
  if ( a2 > BitmapBits )
    a2 = BitmapBits;
  if ( a3 )
  {
  ...
  if ( v6 )
    v6 = GreGetBitmapBits(a1, a2, (void *)a3, &v10);
  if ( v7 )
