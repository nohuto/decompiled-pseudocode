/*
 * XREFs of GreSaveDCInternal @ 0x1C013EF34
 * Callers:
 *     NtGdiSaveDC @ 0x1C007DF30 (NtGdiSaveDC.c)
...
__int64 __fastcall GreSaveDCInternal(HDC a1, int a2)
{
  ...
  DC *v19; // rcx
  __int64 v20; // rdx
  DC *v22[2]; // [rsp+30h] [rbp-39h] BYREF
  _QWORD v23[2]; // [rsp+40h] [rbp-29h] BYREF
  int v24; // [rsp+50h] [rbp-19h]
  unsigned int v25; // [rsp+58h] [rbp-11h] BYREF
  int v26; // [rsp+5Ch] [rbp-Dh]
  __int64 v27; // [rsp+60h] [rbp-9h]
  void (__fastcall *v28)(__int64, _QWORD); // [rsp+68h] [rbp-1h]
  unsigned int v29; // [rsp+70h] [rbp+7h] BYREF
  int v30; // [rsp+74h] [rbp+Bh]
  __int64 v31; // [rsp+78h] [rbp+Fh]
  void (__fastcall *v32)(__int64, _QWORD); // [rsp+80h] [rbp+17h]
  __int64 v33; // [rsp+E0h] [rbp+77h]
  ...
  if ( !a2 )
  {
    if ( (*(_DWORD *)(HmgPentryFromPobj(v22[0]) + 8) & 0xFFFFFFFE) != 0 )
    {
      v3 = v22[0];
      goto LABEL_5;
    }
