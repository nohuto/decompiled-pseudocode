/*
 * XREFs of ?UpdateDesktopThresholdsWorker@@YAXPEAUtagMONITOR_MARGIN@@W4eTHRESHOLD_MARGIN_DIRECTION@@PEAK@Z @ 0x1C00BB41C
 * Callers:
 *     UpdateDesktopThresholds @ 0x1C00BB290 (UpdateDesktopThresholds.c)
 * Callees:
 *     ?GetCoordFromRect@@YAXPEAUtagMONITOR_MARGIN@@PEAUtagRECT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C00BB510 (-GetCoordFromRect@@YAXPEAUtagMONITOR_MARGIN@@PEAUtagRECT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z.c)
 */
...
__int64 __fastcall UpdateDesktopThresholdsWorker(__int64 a1, int a2, _DWORD *a3)
{
  ...
  for ( i = *(_QWORD *)(gpDispInfo + 96LL); i; i = *(_QWORD *)(i + 56) )
  {
    ...
    if ( (*(_DWORD *)(result + 24) & 1) != 0 )
    {
      ...
      *(_BYTE *)(v5 + i + 444) = 0;
      *(_BYTE *)(v5 + i + 448) = 0;
      result = GetCoordFromRect(&v21, *(_QWORD *)(i + 40) + 28LL, (unsigned int)v5, v7);
      if ( (_DWORD)v8 )
      {
        v11 = v23;
        v12 = 0LL;
