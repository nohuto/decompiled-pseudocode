/*
 * XREFs of ?bWiden@EPATHOBJ@@QEAAHAEAV1@PEAU_XFORMOBJ@@PEAU_LINEATTRS@@@Z @ 0x1C01238A8
 * Callers:
 ...
 * Callees:
 *     ?vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z @ 0x1C011F5A0 (-vMakeItWide@WIDENER@@QEAAXAEAVEPATHOBJ@@@Z.c)
