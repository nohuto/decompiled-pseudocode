/*
 * XREFs of ?vSrcTranCopyS8D16New@@YAXPEAEJJ0JJJJKKPEAVSURFACE@@P6AX000JPEAPEAG@Z0@Z @ 0x1C0251F68
 * Callers:
 ...
 *     ulBlendPixelCT @ 0x1C0251C34 (ulBlendPixelCT.c)
 *     ?vCopyAlphaBuffer16bpp@@YAXPEAE00JPEAPEAG@Z @ 0x1C0251D9C (-vCopyAlphaBuffer16bpp@@YAXPEAE00JPEAPEAG@Z.c)
 */
      ...
      if ( *v20 )
      {
        ...
        else
        {
          if ( (_DWORD)v23 == 114 )
            ...
            v25 = ulBlendPixelCT((__int64)v28, v24, (unsigned __int8 *)&off_1C0324100[v23]);
          *(_WORD *)v21 = v25;
        }
      }
      --v22;
