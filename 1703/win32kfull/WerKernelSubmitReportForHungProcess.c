/*
 * XREFs of WerKernelSubmitReportForHungProcess @ 0x1C023C17C
 * Callers:
 *     ?WerSubmitReportWorker@@YAXPEAX@Z @ 0x1C020A260 (-WerSubmitReportWorker@@YAXPEAX@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C013C680 (__security_check_cookie.c)
 *     memset @ 0x1C0140500 (memset.c)
 *     WerStartSystemErrorHandler @ 0x1C023C4AC (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C023C5BC (WerWaitForSystemErrorHandler.c)
