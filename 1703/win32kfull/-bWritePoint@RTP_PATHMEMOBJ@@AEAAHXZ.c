/*
 * XREFs of ?bWritePoint@RTP_PATHMEMOBJ@@AEAAHXZ @ 0x1C029CF38
 * Callers:
 *     ?bDiagonalizeSubPath@RTP_PATHMEMOBJ@@AEAAHXZ @ 0x1C029CB5C (-bDiagonalizeSubPath@RTP_PATHMEMOBJ@@AEAAHXZ.c)
 * Callees:
 *     <none>
 */
