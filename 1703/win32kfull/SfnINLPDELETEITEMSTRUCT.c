/*
 * XREFs of SfnINLPDELETEITEMSTRUCT @ 0x1C0135BF0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  __int64 v19; // rcx
  __int64 v20; // rcx
  __int128 v22; // [rsp+50h] [rbp-C8h]
  __int64 v23; // [rsp+60h] [rbp-B8h]
  _QWORD v24[4]; // [rsp+80h] [rbp-98h] BYREF
  _QWORD v25[10]; // [rsp+A0h] [rbp-78h] BYREF
  int v26; // [rsp+128h] [rbp+10h] BYREF
  ...
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 80LL) = v15;
  ...
  v16 = KeUserModeCallback(11LL, v25, 72LL, &a5, &v26);
