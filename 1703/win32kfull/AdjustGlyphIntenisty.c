/*
 * XREFs of AdjustGlyphIntenisty @ 0x1C025216C
 * Callers:
 ...
 *     ?ScaleUpAlpha@@YAEEM@Z @ 0x1C0251BF4 (-ScaleUpAlpha@@YAEEM@Z.c)
 *     CalcActualGlyphIntensity @ 0x1C02522B0 (CalcActualGlyphIntensity.c)
 */
    ...
    if ( v6 > v5 )
    {
      ...
      if ( v3 )
      {
        ...
        do
        {
          if ( *v11 )
          {
            *(_DWORD *)v18 = *(_DWORD *)(v13 + 4LL * (unsigned __int8)*v11 + 3030560);
            v14 = v19[v18[1] - 1 + v18[2] + v18[0]];
            ScaleUpAlpha(v18[0], v14);
            ScaleUpAlpha(v18[1], v14);
            v15 = ScaleUpAlpha(v18[2], v14);
            *v11 = *(_BYTE *)((unsigned int)v15 + 7 * (v17 + 7 * v16) + v13 + 3055056);
          }
          ++v11;
          --v12;
        }
