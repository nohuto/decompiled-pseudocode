/*
 * XREFs of ?TryGlyphSetHasSameContent@QueryFontTreeRequest@@CA_NPEAX0I@Z @ 0x1C00D59D0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
bool __fastcall QueryFontTreeRequest::TryGlyphSetHasSameContent(char *Source2, char *Source1, unsigned int a3)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    {
      v7 = &Source1[16 * *((unsigned int *)Source1 + 3) + 16];
      return RtlCompareMemory(v7, &Source2[16 * *((unsigned int *)Source1 + 3) + 16], v6 - v7) == v6 - v7;
    }
