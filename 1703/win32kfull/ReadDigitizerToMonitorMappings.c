/*
 * XREFs of ReadDigitizerToMonitorMappings @ 0x1C01A7560
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall ReadDigitizerToMonitorMappings(const UNICODE_STRING *a1, __int64 a2)
{
  int result; // eax
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( result >= 0 )
  {
    v5 = (struct _KEY_VALUE_PARTIAL_INFORMATION *)Win32AllocPool(524LL, 2020635477LL);
    v7 = v5;
    if ( v5 )
    {
      ReadSingleDigitizerToMonitorMappings(a1, KeyHandle, 0xAu, v6, v5, v9, (unsigned __int16 *)(a2 + 1136));
      ReadSingleDigitizerToMonitorMappings(a1, KeyHandle, 0x14u, v8, v7, v10, (unsigned __int16 *)(a2 + 880));
      Win32FreePool(v7);
    }
