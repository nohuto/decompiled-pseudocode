/*
 * XREFs of PhysicalToLogicalInPlacePointWithParent @ 0x1C01C0630
 * Callers:
...
__int64 __fastcall PhysicalToLogicalInPlacePointWithParent(__int64 a1, int *a2, int *a3)
{
  __int64 result; // rax
  __int64 v6; // rdi
  float *v7; // rdx
  ...
  if ( result )
  {
    ...
    if ( (_DWORD)result )
    {
      ...
      if ( v7 )
      {
        ...
        result = (unsigned int)(int)(float)((float)(v12 - v7[13]) * v9);
        a2[1] = result;
      }
    }
  }
