/*
 * XREFs of ?wil_details_FeaturePropertyCache_ReportUsageToService@@YAXPEATwil_details_FeaturePropertyCache@@IPEBUFEATURE_LOGGED_TRAITS@@HW4wil_ReportingKind@@_K@Z @ 0x1C00DA6BC
 * Callers:
 *     InitRotationManager @ 0x1C00DA080 (InitRotationManager.c)
 *     ??0InkProcessor@@AEAA@XZ @ 0x1C00DA384 (--0InkProcessor@@AEAA@XZ.c)
 *     xxxDoHotKeyStuff @ 0x1C00EF9D0 (xxxDoHotKeyStuff.c)
 *     DCompSessionInitialize @ 0x1C0388B80 (DCompSessionInitialize.c)
 * Callees:
