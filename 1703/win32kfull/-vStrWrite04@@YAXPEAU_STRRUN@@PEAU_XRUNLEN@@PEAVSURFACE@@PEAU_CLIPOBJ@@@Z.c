/*
 * XREFs of ?vStrWrite04@@YAXPEAU_STRRUN@@PEAU_XRUNLEN@@PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C029F4E0
 * Callers:
 *     <none>
 * Callees:
            ...
            do
            {
              ...
              if ( v48 < v50 )
              {
                ...
                do
                {
                  ...
                  {
                    v58 = v59 & ~dword_1C02EA128[v56] | dword_1C02EA128[v56] & (*v57 << dword_1C02EA108[v56]);
                    v59 = v58;
                  }
                  ++v56;
                  ++v57;
      ...
      for ( i = v8; v5 != (LONG *)a2; v67 = v5 )
      {
        ...
        if ( *v5 < v10 )
        {
          ...
          if ( (unsigned __int64)v11 < *((_QWORD *)a3 + 9) + (unsigned __int64)*((unsigned int *)a3 + 16) )
          {
            ...
            do
            {
              v18 = dword_1C02EA128[v15];
              ++v13;
              v19 = *v16;
              ++v9;
              v20 = dword_1C02EA108[v15];
              ++v16;
              ++v15;
          ...
          *v12 = v14;
          ...
          if ( v21 > 1 )
          {
            ...
            {
              v28 = 1;
              v29 = dword_1C02EA150[v26] & ~dword_1C02EA150[v27];
              do
              {
                v30 = v29 & *v11;
                ++v28;
            ...
            else
            {
              ...
              {
                v31 = 1;
                v32 = ~dword_1C02EA150[(unsigned int)v26];
                v33 = *v11 & dword_1C02EA150[(unsigned int)v26];
                do
                {
                  ++v31;
                  v11 = (int *)((char *)v11 + *((int *)a3 + 22));
