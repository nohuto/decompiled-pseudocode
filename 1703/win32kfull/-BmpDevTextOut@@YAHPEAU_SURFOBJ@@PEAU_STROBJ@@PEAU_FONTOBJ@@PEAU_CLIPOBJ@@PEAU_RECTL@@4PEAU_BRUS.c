/*
 * XREFs of ?BmpDevTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x1C0279E40
 * Callers:
 *     <none>
 * Callees:
            ...
            if ( (*(_DWORD *)(v18 + 1840) & 0x8000000) != 0 && (*(_DWORD *)(v18 + 2144) & 0x9000) == 0x9000 )
            {
              if ( *(_QWORD *)(*(_QWORD *)(v18 + 1808) + 248LL) )
              {
                MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                  ...
                  (struct PDEVOBJ *)&v21,
                  a1);
                (*(void (__fastcall **)(struct _SURFOBJ *, STROBJ *, FONTOBJ *, CLIPOBJ *, RECTL *, RECTL *, BRUSHOBJ *, BRUSHOBJ *, POINTL *, MIX))(*(_QWORD *)(v19 + 1808) + 248LL))(
                  a1,
                  pstro,
                  pfo,
                  pco,
