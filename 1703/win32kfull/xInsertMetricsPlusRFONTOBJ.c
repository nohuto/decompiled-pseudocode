/*
 * XREFs of xInsertMetricsPlusRFONTOBJ @ 0x1C00EA768
 * Callers:
...
__int64 __fastcall xInsertMetricsPlusRFONTOBJ(RFONTOBJ *this, struct _GLYPHDATA **a2, unsigned __int16 a3)
{
  ...
  struct _GLYPHBITS *v12; // rax
  struct _GLYPHDATA *v13; // rcx
  struct _GLYPHBITS *v14; // r13
  ...
  if ( *(_DWORD *)(*(_QWORD *)this + 72LL) != 2 )
  {
    ...
    v12 = (struct _GLYPHBITS *)RFONTOBJ::pgbCheckGlyphCache(this, (unsigned int)v11);
    v13 = &v22;
    v14 = v12;
