/*
 * XREFs of xxxFrostCrashedWindow @ 0x1C01D3340
 * Callers:
  ...
  if ( (unsigned int)_ShouldFrostCrashedWindow((struct tagWND *)a1) )
  {
    ...
    if ( v15 )
    {
      if ( v16 )
      {
        ...
        {
          if ( GetProp(v17, *(_WORD *)(gpsi + 1362LL), 1) )
          {
            v19 = v28;
            if ( v28 )
            {
              ...
              if ( v20 )
              {
                if ( !(unsigned int)IsWindowBeingDestroyed(v20) && GetProp(v21, *(_WORD *)(gpsi + 1362LL), 1) )
                  return v19;
              }
            }
          }
