/*
 * XREFs of SetManifestWinVer @ 0x1C00E12B0
 * Callers:
 *     <none>
 * Callees:
 *     SbGetProcessSwitchContext @ 0x1C00E136C (SbGetProcessSwitchContext.c)
 *     SbGetContextDetailsByGuid @ 0x1C00E13C4 (SbGetContextDetailsByGuid.c)
 */
