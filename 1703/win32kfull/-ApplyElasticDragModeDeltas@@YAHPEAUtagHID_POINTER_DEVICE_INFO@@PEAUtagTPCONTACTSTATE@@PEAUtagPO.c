/*
 * XREFs of ?ApplyElasticDragModeDeltas@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@PEAUtagTPCONTACTSTATE@@PEAUtagPOINTER_INFO@@PEAUtagPOINT@@@Z @ 0x1C01AA12C
 * Callers:
        ...
        struct tagPOINT *a4)
{
  ...
  v10 = *((_DWORD *)a1 + 53) - gTPThresholds[6];
  if ( (int)v4 >= v10 )
  {
    v11 = *((_DWORD *)a2 + 30);
  ...
  v15 = *((_DWORD *)a1 + 54) - gTPThresholds[7];
  if ( (int)v13 >= v15 )
  {
    v16 = *((_DWORD *)a2 + 30);
