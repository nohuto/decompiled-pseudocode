/*
 * XREFs of ?ulAnimatePalette@XEPALOBJ@@QEAAKKKPEBUtagPALETTEENTRY@@@Z @ 0x1C02991C8
 * Callers:
        ...
        const struct tagPALETTEENTRY *a4)
{
  ...
  if ( a3 )
  {
    ...
    if ( v15 )
    {
      ...
      GreAcquireSemaphore(*(_QWORD *)(v31 + 40));
      EtwTraceGreLockAcquireSemaphoreExclusive(L"po.hsemDevLock()", *(_QWORD *)(v31 + 40), 11LL);
      v25 = v31;
      if ( (*(_DWORD *)(v31 + 2188) & 0x100) != 0 && (*(_DWORD *)(v31 + 32) & 0x400) == 0 )
      {
        v26 = *(void (__fastcall **)(_QWORD, __int64 *, _QWORD, _QWORD, _DWORD))(v31 + 1784);
        if ( v26 )
        {
          v26(*(_QWORD *)(*(_QWORD *)(v31 + 16) + 1816LL), &v28, 0LL, 0LL, *(_DWORD *)(v28 + 28));
          v25 = v31;
        }
        else
        {
      ...
      EtwTraceGreLockReleaseSemaphore(L"po.hsemDevLock()", *(_QWORD *)(v25 + 40));
      GreReleaseSemaphoreInternal(*(_QWORD *)(v31 + 40));
      SEMOBJ::vUnlock((SEMOBJ *)&v29);
