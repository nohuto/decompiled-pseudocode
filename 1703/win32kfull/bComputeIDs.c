/*
 * XREFs of bComputeIDs @ 0x1C02262C4
 * Callers:
 *     bVerifyTTF @ 0x1C0228EE8 (bVerifyTTF.c)
 * Callees:
 *     bCvtUnToMac @ 0x1C02271CC (bCvtUnToMac.c)
 *     bVerifyMsftHighByteTable @ 0x1C02289F0 (bVerifyMsftHighByteTable.c)
 *     bVerifyMsftTable @ 0x1C0228BE8 (bVerifyMsftTable.c)
 *     bVerifyMsftTableGeneral @ 0x1C0228DC4 (bVerifyMsftTableGeneral.c)
 *     vDetectOldBiDiFonts @ 0x1C0229E20 (vDetectOldBiDiFonts.c)
 */
