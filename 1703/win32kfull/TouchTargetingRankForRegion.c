/*
 * XREFs of TouchTargetingRankForRegion @ 0x1C023B6B8
 * Callers:
...
__int64 __fastcall TouchTargetingRankForRegion(__int64 a1, __int128 *a2, int *a3, _QWORD *a4, unsigned int a5)
{
      ...
      if ( (unsigned int)GreGetRegionData(a1, v11, v12) )
      {
        ...
        if ( v14 > 0 )
        {
          ...
          do
          {
            ...
            v21 = *a2;
            v22 = v17;
            v18 = TouchTargetingRankForRect((int *)&v22, (int *)&v21, a3, 0LL, v20, a5);
            if ( v18 < v9 )
            {
              v9 = v18;
              *a4 = *(_QWORD *)v20;
