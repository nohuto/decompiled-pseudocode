/*
 * XREFs of NtGdiEngAlphaBlend @ 0x1C0290F40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z @ 0x1C0290348 (--$GetDDIOBJ@U_BLENDOBJ@@@UMPDOBJ@@QEAAPEAU_BLENDOBJ@@PEAU1@@Z.c)
 */
        ...
        __int64 a7)
{
  ...
  if ( v12 )
  {
    UMPDSURFOBJ::UMPDSURFOBJ((UMPDSURFOBJ *)&psoDest, a1, v12);
