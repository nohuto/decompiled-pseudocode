/*
 * XREFs of ?xxxDoTPShellProcessing@@YAXPEBUtagPOINTERINPUTFRAME@@PEAUtagTPSTATE@@PEAUtagHID_POINTER_DEVICE_INFO@@PEAXKPEAH@Z @ 0x1C01AEDF0
 * Callers:
        ...
        int *a6)
{
  ...
  _QWORD *v27; // rax
  _QWORD *QuadPart; // rcx
  struct tagPOINTERINFONODE *v29; // rax
  ...
  if ( !a2[239].QuadPart )
  {
    v29 = FindOrAssignPrimary(a1, (struct tagTPSTATE *)a2, (struct tagHID_POINTER_DEVICE_INFO *)v23.QuadPart);
    v7 = v29;
    if ( !v29 )
      return;
    if ( (a2[240].LowPart & 0x400) != 0 )
      *((_DWORD *)v29 + 17) |= 0x2000u;
    goto LABEL_30;
  }
  v24 = 0;
  if ( *((_DWORD *)a1 + 10) )
  ...
  *QuadPart = &gFrameTPListHead;
  QuadPart[1] = v27;
  *v27 = QuadPart;
  qword_1C0334518 = (__int64)QuadPart;
  a2[239].QuadPart = 0LL;
  xxxGeneratePointerInputMessages(a4);
  if ( HMValidateHandleNoSecure((unsigned __int64)a4, 19) )
LABEL_30:
    GestureContactProcessing(a1, v7, (unsigned __int64)a2, a3, v8, 1, a5, a6);
}
