/*
 * XREFs of ?vOrAlignedGrayGlyphEven@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x1C00D9560
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vOrAlignedGrayGlyphEven(struct _GLYPHBITS *a1, unsigned int a2, unsigned __int8 *a3, unsigned int a4)
{
  ...
  if ( a3 < v6 )
  {
    ...
    do
    {
      ...
      if ( v10 )
      {
        if ( v10 >= 0x20 && (v5 > &aj[v10 - 1] || &v5[v10 - 1] < aj) )
        {
          do
          {
            v13 += 32LL;
            *v12 = _mm_or_si128(_mm_loadu_si128(v12), _mm_loadu_si128(v11));
            ...
            v11 += 2;
            v12[1] = _mm_or_si128(_mm_loadu_si128(v12 + 1), v14);
            v12 += 2;
          }
          while ( v13 < (v10 & 0xFFFFFFE0) );
        }
        if ( v13 < v10 )
        {
