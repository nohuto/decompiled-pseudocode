/*
 * XREFs of SfnINOUTLPSCROLLINFO @ 0x1C00F0A40
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(19LL, v34, 72LL, &v29, v28);
  ...
  *(_QWORD *)(v21 + 80) = v32;
  ...
  {
    v25 = *(_QWORD *)(v29 + 16);
    if ( v25 + 28 < v25 || v25 + 28 > W32UserProbeAddress )
