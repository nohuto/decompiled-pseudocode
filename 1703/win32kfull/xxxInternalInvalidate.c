/*
 * XREFs of xxxInternalInvalidate @ 0x1C0065820
 * Callers:
...
void __fastcall xxxInternalInvalidate(struct tagWND *a1, HRGN a2, __int64 a3)
{
  unsigned int v3; // esi
  unsigned int v4; // ebx
  ...
  if ( (v4 & 9) == 0 || (v4 & 1) == 0 || (unsigned int)IntersectWithParents(v6, &v13, a3) )
  {
    if ( (v4 & 0x1001) == 0x1001 && *(_QWORD *)(gpDispInfo + 24LL) )
    {
      *(_QWORD *)&v14.left = 0LL;
