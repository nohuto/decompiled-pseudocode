/*
 * XREFs of ?bPreComputeFast@PRECOMPUTE@@QEAAHAEAVEPATHOBJ@@0PEAU_RECTL@@K@Z @ 0x1C02AB644
 * Callers:
        ...
        char a5)
{
  ...
  struct EPATHOBJ *v30; // [rsp+30h] [rbp-D0h]
  __int128 v31; // [rsp+38h] [rbp-C8h]
  _QWORD v32[6]; // [rsp+48h] [rbp-B8h] BYREF
  _QWORD v33[6]; // [rsp+78h] [rbp-88h] BYREF
  ...
  if ( v6 > 0x14 )
  {
    ...
    if ( UIntMult(0x30u, v6, &puResult) < 0 )
      return 0LL;
    v29 = PALLOCMEM2(puResult, 1734632775LL, 0);
    v9 = v29;
    if ( !v29 )
      return 0LL;
    puResult = 1;
...
LABEL_44:
    ...
    if ( v13 )
    {
      ...
      if ( !(unsigned int)PRECOMPUTE::bAddPreComputedFastFillRects((PRECOMPUTE *)v33, v30, &v37, v13) )
        v8 = 1;
    }
LABEL_53:
    v9 = v29;
