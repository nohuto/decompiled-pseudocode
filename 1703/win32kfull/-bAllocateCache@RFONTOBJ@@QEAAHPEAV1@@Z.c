/*
 * XREFs of ?bAllocateCache@RFONTOBJ@@QEAAHPEAV1@@Z @ 0x1C008D508
 * Callers:
...
__int64 __fastcall RFONTOBJ::bAllocateCache(RFONTOBJ *this, struct RFONTOBJ *a2)
{
  ...
  if ( v8 > 0xFFFFFFFF )
    return 0LL;
  v9 = 8LL * *v7;
  if ( v9 > 0xFFFFFFFF || (unsigned int)v8 >= 0xFFFFFFF0 || (int)v9 + (int)v8 + 16 < (unsigned int)(v8 + 16) )
    return 0LL;
  v10 = (v9 + v8 + 16 + 7) & 0xFFFFFFF8;
  v39 = v10;
  ...
  v12 = (char *)PALLOCMEM2(v11, 1667326791LL, 0);
  v36 = v12;
  v13 = *(_QWORD *)this;
  if ( !v12 )
  {
