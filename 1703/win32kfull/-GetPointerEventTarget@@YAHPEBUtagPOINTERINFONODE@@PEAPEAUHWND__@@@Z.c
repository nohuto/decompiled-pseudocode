/*
 * XREFs of ?GetPointerEventTarget@@YAHPEBUtagPOINTERINFONODE@@PEAPEAUHWND__@@@Z @ 0x1C01C6074
 * Callers:
...
__int64 __fastcall GetPointerEventTarget(PointerList **a1, HWND *a2)
{
  ...
  PointerList::GetPointerCapture(a1[2], (*(_DWORD *)(ThreadWin32Thread + 1096) >> 13) & 1, (int)&v7, 0LL, v6);
  if ( v7 )
    *a2 = *v7;
  else
    *a2 = (HWND)a1[10];
