/*
 * XREFs of ?TraceLoggingIntObjUsageSummaryEvent@@YAXPEAUtagINTOBJTELEMETRYSTATE@@GGU_GUID@@1_K@Z @ 0x1C0196788
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  __int16 v80; // [rsp+278h] [rbp+178h] BYREF
  __int16 v81; // [rsp+280h] [rbp+180h] BYREF
  ...
  if ( dword_1C0324850 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0324850, 0x800000000000uLL) )
    {
      ...
      v15 = dword_1C0338994;
      v54 = &v15;
      v10 = (unsigned int)qword_1C03389A8 / 0x3E8;
      v17 = dword_1C033899C;
      v18 = (unsigned int)qword_1C03389D8 / 0x3E8;
      v28 = v6;
      v29 = 16LL;
      v33 = 16LL;
      v37 = 4LL;
      ...
      v77 = 4LL;
      v79 = 8LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0324850, &unk_1C02EAB0A, (LPCGUID)0x10624DD3, v6, 0x1Cu, &pData);
    }
  }
}
