/*
 * XREFs of ?TraceLoggingRimHidDeviceRemovedEvent@@YAXGIIKKHPEAU_UNICODE_STRING@@0HHIIIKK@Z @ 0x1C01975D0
 * Callers:
        ...
        char a15)
{
  ...
  if ( dword_1C0324850 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0324850, 0x800000000000uLL) )
    {
      ...
      v50 = 4LL;
      v52 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0324850, &unk_1C02EAED5, v15, v16, 0x13u, &pData);
    }
  }
}
