/*
 * XREFs of ?_PopulatePropertyUsageValues@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@PEAIIGGPEAU_HIDP_VALUE_CAPS@@IPEAUtagPOINTER_DEVICE_PROPERTY@@PEAU_HIDP_PREPARSED_DATA@@@Z @ 0x1C001CCEC
 * Callers:
...
LABEL_11:
        ...
        *(_DWORD *)((char *)v17 + v18 + 8) = 0;
        if ( ((*((_DWORD *)a1 + 185) - 1) & 0xFFFFFFFD) != 0 )
          goto LABEL_18;
      }
      else
      {
