/*
 * XREFs of ?IsCompositeAppOrSelfDisabled@CoreWindowProp@@SAHPEAUtagWND@@@Z @ 0x1C0062750
 * Callers:
...
LABEL_7:
  ...
  if ( (*((_BYTE *)CompositionInputWindowUIOwner + 307) & 2) != 0
    && (unsigned int)CWindowProp::GetProp<CoreWindowProp>(CompositionInputWindowUIOwner, &v12)
    && *(_DWORD *)(v12 + 20) )
  {
