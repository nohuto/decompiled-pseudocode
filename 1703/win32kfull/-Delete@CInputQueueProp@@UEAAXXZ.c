/*
 * XREFs of ?Delete@CInputQueueProp@@UEAAXXZ @ 0x1C001AF40
 * Callers:
 *     <none>
 * Callees:
 *     ?Reset@?$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z @ 0x1C001B074 (-Reset@-$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z.c)
