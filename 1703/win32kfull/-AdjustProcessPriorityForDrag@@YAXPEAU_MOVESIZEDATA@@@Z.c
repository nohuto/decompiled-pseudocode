/*
 * XREFs of ?AdjustProcessPriorityForDrag@@YAXPEAU_MOVESIZEDATA@@@Z @ 0x1C01EFAF4
 * Callers:
 *     xxxMoveSize @ 0x1C01F8110 (xxxMoveSize.c)
 * Callees:
 *     SetForegroundPriority @ 0x1C00B5AE0 (SetForegroundPriority.c)
 *     ?IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z @ 0x1C01F09D8 (-IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z.c)
 */
...
void __fastcall AdjustProcessPriorityForDrag(struct tagWND **a1)
{
  ...
  if ( (v3 & 0x100000) != 0 )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v4 + 376) + 768LL) & 0x30000) == 0
      && (*(_DWORD *)(*(_QWORD *)(gptiForeground + 376LL) + 768LL) & 0x30000) != 0 )
    {
      v5 = 1;
LABEL_8:
