/*
 * XREFs of SfnINOUTLPSIZE @ 0x1C01FBB70
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  _QWORD v28[10]; // [rsp+68h] [rbp-80h] BYREF
  _QWORD v29[3]; // [rsp+B8h] [rbp-30h] BYREF
  ...
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 80LL) = v17;
  ...
  v18 = KeUserModeCallback(130LL, v28, 48LL, &a5, &v30);
  ...
  *(_QWORD *)(v21 + 80) = v27;
  ...
  if ( (!a8 || (*(_DWORD *)(a8 + 84) & 5) == 0) && (a7 & 2) == 0 )
  {
    ...
    if ( v24 + 1 < v24 || (unsigned __int64)(v24 + 1) > W32UserProbeAddress )
      v24 = (_QWORD *)W32UserProbeAddress;
    *a4 = *v24;
  }
  return v23;
}
