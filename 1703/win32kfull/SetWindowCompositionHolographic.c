/*
 * XREFs of SetWindowCompositionHolographic @ 0x1C020B120
 * Callers:
...
__int64 __fastcall SetWindowCompositionHolographic(struct tagWND *a1, __int128 *a2)
{
  unsigned int v4; // ebx
  int v5; // edi
  __int64 v6; // rdx
  ...
  {
    if ( -__CFSHR__(v12[0], 14) == v5 )
      return 0;
    v12[0] = (v5 << 13) | v12[0] & 0xFFFFDFFF;
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *(_QWORD *)a1, 23, a2);
    }
  }
  return v4;
}
