/*
 * XREFs of ?SetPointerInfoNodeTarget@PointerFrameList@@YAXPEBUtagPOINTERINPUTFRAME@@KPEAUtagWND@@HPEBUtagPOINT@@HHHH@Z @ 0x1C019A094
 * Callers:
 ...
 * Callees:
 *     ?SetPointerInfoNodeTargetInt@@YAXPEAUtagPOINTERINFONODE@@PEAUtagWND@@HPEBUtagPOINT@@HHHH@Z @ 0x1C019A17C (-SetPointerInfoNodeTargetInt@@YAXPEAUtagPOINTERINFONODE@@PEAUtagWND@@HPEBUtagPOINT@@HHHH@Z.c)
