/*
 * XREFs of ?UnlinkAndDestroyComponent@CoreWindowProp@@IEAAXPEAUComponent@1@0@Z @ 0x1C000380C
 * Callers:
        ...
        struct CoreWindowProp::Component *a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( a3 )
      ...
      *((_QWORD *)this + 4) = v3;
    if ( (unsigned int)CWindowProp::GetProp<CoreWindowProp>(*((_QWORD *)a2 + 1), &v6) )
      *(_QWORD *)(v6 + 24) = 0LL;
    *((_QWORD *)a2 + 1) = 0LL;
    --*((_DWORD *)this + 10);
    Win32FreePool(a2);
