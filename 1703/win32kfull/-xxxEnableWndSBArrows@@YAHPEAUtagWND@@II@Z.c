/*
 * XREFs of ?xxxEnableWndSBArrows@@YAHPEAUtagWND@@II@Z @ 0x1C00D708C
 * Callers:
    ...
    if ( a2 && a2 != 3
      || (a3 ? (*inited |= a3) : (*inited &= 0xFFFFFFFC),
       ...
       && ((((unsigned __int8)v9 ^ *(_BYTE *)inited) & 1) == 0
        || (xxxWindowEvent(0x800Au, (__int64 *)a1, -6, 1, 1), inited == *((int **)a1 + 24)))
       && ((((unsigned __int8)v9 ^ *(_BYTE *)inited) & 2) == 0
        || (xxxWindowEvent(0x800Au, (__int64 *)a1, -6, 5, 1), inited == *((int **)a1 + 24)))) )
    {
