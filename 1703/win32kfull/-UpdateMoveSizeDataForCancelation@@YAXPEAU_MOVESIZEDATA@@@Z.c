/*
 * XREFs of ?UpdateMoveSizeDataForCancelation@@YAXPEAU_MOVESIZEDATA@@@Z @ 0x1C01F1700
 * Callers:
...
void __fastcall UpdateMoveSizeDataForCancelation(struct _MOVESIZEDATA *a1)
{
  ...
  *(_OWORD *)((char *)a1 + 8) = *(_OWORD *)((char *)a1 + 120);
  v2 = *((_QWORD *)a1 + 25);
  v3 = *((_DWORD *)a1 + 45);
  *((_QWORD *)a1 + 24) = v2;
  if ( ((v3 ^ (v3 >> 5)) & 0x300) != 0 || *((_DWORD *)a1 + 56) != *((_DWORD *)a1 + 52) )
    v4 = 0x80000;
  else
    v4 = 0;
  *((_QWORD *)a1 + 27) = v2;
  *((_DWORD *)a1 + 56) = *((_DWORD *)a1 + 52);
  ...
  v6 = *((_DWORD *)a1 + 66);
  *((_DWORD *)a1 + 45) = (((unsigned __int16)v5 ^ (unsigned __int16)(v5 >> 5)) & 0x200 ^ v5) & 0xFFEFFFFF;
  *((_DWORD *)a1 + 66) = v6 ^ ((unsigned __int8)v6 ^ (unsigned __int8)(2 * v6)) & 2;
}
