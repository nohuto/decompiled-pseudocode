/*
 * XREFs of ?MakeITable@@YAHPEAEPEAURGBX@@H@Z @ 0x1C00D32D4
 * Callers:
 ...
 *     ?MakeITable256@@YAHPEAE@Z @ 0x1C027AA08 (-MakeITable256@@YAHPEAE@Z.c)
 *     ?MakeITableMono@@YAHPEAE@Z @ 0x1C027AA5C (-MakeITableMono@@YAHPEAE@Z.c)
