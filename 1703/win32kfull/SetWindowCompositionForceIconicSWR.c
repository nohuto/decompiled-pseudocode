/*
 * XREFs of SetWindowCompositionForceIconicSWR @ 0x1C0114428
 * Callers:
...
__int64 __fastcall SetWindowCompositionForceIconicSWR(struct tagWND *a1, __int128 *a2)
{
  ...
  if ( (unsigned int)GetWindowCompositionInfo((__int64)a1, (__int64)v12) )
  {
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *(_QWORD *)a1, 7, a2);
    }
  }
  return v4;
}
