/*
 * XREFs of GetInertiaRegionInVirtualizedScreen @ 0x1C020A690
 * Callers:
 ...
 * Callees:
 *     D3DXVec4Transform @ 0x1C01BF7E4 (D3DXVec4Transform.c)
 */
...
__int64 __fastcall GetInertiaRegionInVirtualizedScreen(__int64 a1, int *a2)
{
  ...
  if ( (v2 & 4) != 0 )
    ...
    v6 = (int *)(*(_QWORD *)(gpKernelHandleTable + 16LL * (unsigned __int16)*(_DWORD *)(a1 + 120)) + 128LL);
  *a2 = *v6;
  a2[1] = v6[1];
  a2[2] = v6[2];
  a2[3] = v6[1];
