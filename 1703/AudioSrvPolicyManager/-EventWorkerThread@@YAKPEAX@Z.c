/*
 * XREFs of ?EventWorkerThread@@YAKPEAX@Z @ 0x180003EC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EventWorkerThread(PVOID Parameter)
{
  ...
  if ( v1 )
  {
    ...
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_d1d10f4d9ad336f5fb5da7b06d958b8d_Traceguids);
        v2 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
      if ( v2 != &WPP_GLOBAL_Control && (*((_DWORD *)v2 + 7) & 0x40000000) != 0 && *((_BYTE *)v2 + 25) >= 2u )
        WPP_SF_D((TRACEHANDLE)v2[2], 0xBu, &WPP_d1d10f4d9ad336f5fb5da7b06d958b8d_Traceguids, v1);
    }
    AudPolicyLogError("EventWorkerThread", 116, v1);
    return v1;
  }
  else
  {
