/*
 * XREFs of ?SetupProcessTerminationWatcher@CProcess@@IEAAJXZ @ 0x18000F0D8
 * Callers:
...
__int64 __fastcall CProcess::SetupProcessTerminationWatcher(CProcess *this)
{
  ...
  *((_QWORD *)this + 51) = v3;
  ...
  if ( v2 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x33u, &WPP_17d50ef9044b326f9caf58457a9d5dd6_Traceguids, v2);
    }
    AudPolicyLogError("CProcess::SetupProcessTerminationWatcher", 3544, v2);
  }
