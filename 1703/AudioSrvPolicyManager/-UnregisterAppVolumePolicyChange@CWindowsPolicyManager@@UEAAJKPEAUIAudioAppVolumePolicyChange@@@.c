/*
 * XREFs of ?UnregisterAppVolumePolicyChange@CWindowsPolicyManager@@UEAAJKPEAUIAudioAppVolumePolicyChange@@@Z @ 0x180005670
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioAppVolumePolicyChange *a3)
{
  ...
  if ( Application >= 0 )
    Application = CApplication::UnregisterAppVolumePolicyChange(v11, a3);
  if ( v10 )
