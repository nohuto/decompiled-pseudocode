/*
 * XREFs of ?InitAccessibilityAudioSettings@CWindowsPolicyManager@@IEAAJK@Z @ 0x180005160
 * Callers:
...
__int64 __fastcall CWindowsPolicyManager::InitAccessibilityAudioSettings(CWindowsPolicyManager *this, DWORD a2)
{
  unsigned int v3; // ebx
  LSTATUS v4; // edi
  int v5; // edx
