/*
 * XREFs of ?ApplySessionMuteChanges@CApplicationManager@@QEAAJPEAU_SESSIONMUTECHANGES@@@Z @ 0x1800129A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _SESSIONMUTECHANGES *a2)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Du, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids);
    v4 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  v5 = *((_DWORD *)a2 + 1);
  if ( v4 != &WPP_GLOBAL_Control && (*((_DWORD *)v4 + 7) & 0x40000000) != 0 && *((_BYTE *)v4 + 25) >= 4u )
  {
    WPP_SF_D((TRACEHANDLE)v4[2], 0x2Eu, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids, v5);
    v4 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  ...
  v8 = *(_DWORD *)a2;
  if ( v4 != &WPP_GLOBAL_Control && (*((_DWORD *)v4 + 7) & 0x40000000) != 0 && *((_BYTE *)v4 + 25) >= 4u )
    WPP_SF_D((TRACEHANDLE)v4[2], 0x2Fu, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids, v8);
