/*
 * XREFs of ?TsSessionIdScreenReaderStateChanged@@YAJKKHMPEAH@Z @ 0x18001B22C
 * Callers:
 ...
 *     ?AddHead@?$CAtlList@KV?$CElementTraits@K@ATL@@@ATL@@QEAAPEAU__POSITION@@K@Z @ 0x18001C5EC (-AddHead@-$CAtlList@KV-$CElementTraits@K@ATL@@@ATL@@QEAAPEAU__POSITION@@K@Z.c)
 *     ConvertDbToEngineVolume @ 0x18001D13C (ConvertDbToEngineVolume.c)
 */

__int64 __fastcall TsSessionIdScreenReaderStateChanged(DWORD SessionId, unsigned int a2, int a3, float a4, int *a5)
{
  float v5; // xmm8_4
  int v9; // edi
  ...
  v11 = a5;
  *a5 = 0;
  v12 = TsSessionFromSessionId(SessionId, 1, 0LL, v23);
  if ( v12 )
  {
...
LABEL_9:
  ...
  if ( !i )
  {
    try
    {
      ATL::CAtlList<unsigned long,ATL::CElementTraits<unsigned long>>::AddHead((char *)v23[0] + 176, a2);
    }
