/*
 * XREFs of ?Init@CDuckingNotification@@QEAAJKPEBG_K@Z @ 0x180006E94
 * Callers:
...
LABEL_11:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Du, &WPP_f0c26e893d54393037413041046a80ee_Traceguids, v6);
    }
    AudPolicyLogError("CDuckingNotification::Init", 524, v6);
    return v6;
  }
  if ( !a3 )
    return v6;
