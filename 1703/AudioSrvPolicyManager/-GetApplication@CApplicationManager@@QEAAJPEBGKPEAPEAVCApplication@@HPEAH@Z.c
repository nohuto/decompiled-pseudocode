/*
 * XREFs of ?GetApplication@CApplicationManager@@QEAAJPEBGKPEAPEAVCApplication@@HPEAH@Z @ 0x1800122B4
 * Callers:
...
LABEL_34:
      ...
      && *((_DWORD *)v12 + 43) == a3 )
    {
      ...
      {
        WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids, v8);
      }
      v11 = 0;
      goto LABEL_34;
    }
...
LABEL_27:
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x25u, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids, v8);
  }
  v12 = v22;
LABEL_35:
  *v16 = v12;
...
LABEL_36:
  ...
  if ( v11 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x26u, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids, v11);
    }
    AudPolicyLogError("CApplicationManager::GetApplication", 1480, v11);
  }
  if ( v31 )
