/*
 * XREFs of ?GrowBuffer@?$CAtlArray@PEAVCActiveAudioSession@@V?$CElementTraits@PEAVCActiveAudioSession@@@ATL@@@ATL@@AEAA_N_K@Z @ 0x18000989C
 * Callers:
...
char __fastcall ATL::CAtlArray<CActiveAudioSession *,ATL::CElementTraits<CActiveAudioSession *>>::GrowBuffer(
        __int64 a1,
        size_t a2)
{
