/*
 * XREFs of ?HasBackgroundAudioTask@CApplication@@QEAAHXZ @ 0x18000C9DC
 * Callers:
...
__int64 __fastcall CApplication::HasBackgroundAudioTask(CApplication *this)
{
  ...
  if ( v2 )
  {
    while ( 1 )
    {
      ...
      v2 = (_QWORD *)*v2;
      if ( !*(_DWORD *)(v4 + 416)
        && (*(_QWORD *)&GUID_00000000_0000_0000_0000_000000000000.Data1 != *(_QWORD *)(v4 + 488)
         || *(_QWORD *)GUID_00000000_0000_0000_0000_000000000000.Data4 != *(_QWORD *)(v4 + 496)) )
      {
        break;
      }
      if ( !v2 )
