/*
 * XREFs of ?OnHostedAppStateChanged@CApplicationManager@@QEAAJPEAVHostedAppStateChangedContext@@@Z @ 0x180013AD0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( Application < 0 )
  {
    ...
    AudPolicyLogError("CApplicationManager::OnHostedAppStateChanged", 2614, Application);
  }
  else if ( v5 )
  {
