/*
 * XREFs of ?Initialize@CWindowsPolicyManager@@IEAAJXZ @ 0x180004370
 * Callers:
...
__int64 __fastcall CWindowsPolicyManager::Initialize(struct CStreamClassPolicyManager **this)
{
  ...
  if ( Instance >= 0 )
  {
    ...
    if ( !g_WorkerEventPort )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, &WPP_d1d10f4d9ad336f5fb5da7b06d958b8d_Traceguids, Instance);
      }
    }
    if ( Instance >= 0 )
    {
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_D(
            *((_QWORD *)WPP_GLOBAL_Control + 2),
            0xDu,
            &WPP_d1d10f4d9ad336f5fb5da7b06d958b8d_Traceguids,
            Instance);
        }
      }
      if ( Instance >= 0 )
