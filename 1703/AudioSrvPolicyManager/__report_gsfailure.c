/*
 * XREFs of __report_gsfailure @ 0x180020AD0
 * Callers:
 ...
 *     capture_previous_context @ 0x180020BA4 (capture_previous_context.c)
 */
...
void __cdecl __noreturn _report_gsfailure(uintptr_t StackCookie)
{
  ...
  qword_180031570 = retaddr;
  ContextRecord.Rcx = v2;
  dword_180031560 = -1073740791;
  dword_180031564 = 1;
  dword_180031578 = 1;
  unk_180031580 = 2LL;
