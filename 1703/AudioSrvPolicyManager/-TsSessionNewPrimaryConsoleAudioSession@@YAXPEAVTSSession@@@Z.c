/*
 * XREFs of ?TsSessionNewPrimaryConsoleAudioSession@@YAXPEAVTSSession@@@Z @ 0x1800199CC
 * Callers:
    ...
    if ( v1 != (int *)a1 )
    {
      ...
      *((_DWORD *)a1 + 92) = 1;
      if ( g_MaxSessions <= 1 )
      {
        ...
        {
          v6 = *(_DWORD *)a1;
          WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, &WPP_8c6176e2ee2e3d308447856c4f339b3c_Traceguids, v5, v6);
        }
        ...
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x10u, &WPP_8c6176e2ee2e3d308447856c4f339b3c_Traceguids);
        }
      }
    }
  }
