/*
 * XREFs of ?MakeAndInitialize@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@CAJPEBG$$QEAV?$unique_any_t@V?$mutex_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@@3@PEAPEAV123@@Z @ 0x180003770
 * Callers:
 ...
 * Callees:
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x18000138C (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
 ...
 *     ?_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ @ 0x1800028E8 (-_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ.c)
        ...
        unsigned __int64 *a3)
{
  ...
  *(_OWORD *)hObject = 0LL;
  ...
  do
  {
    if ( v12 == -2147483386 )
      break;
    v15 = *(unsigned __int16 *)((char *)v14 + v13);
    if ( !v15 )
      break;
    *v14++ = v15;
    --v12;
  ...
  if ( v12 )
    v16 = v14;
  *v16 = 0;
  StringCchCatW(v34, v12, (char *)L"_p0");
  v17 = 1;
  v18 = v9 >> 33;
  v19 = v11 & 0x7FFFFFFF;
  if ( v19 )
...
LABEL_21:
  ...
  {
    wil::details::in1diag3::Return_Hr_NoOriginate(retaddr, (void *)0x13D, (__int64)"wil", (const char *)v10);
    v24 = hObject[1];
    v25 = hObject[0];
  }
  if ( v24 && !CloseHandle(v24) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x875, v27, v28);
    __debugbreak();
  }
  if ( v25 && !CloseHandle(v25) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x875, v29, v30);
    JUMPOUT(0x180003A29LL);
  }
  if ( v9 )
  {
    v31 = GetProcessHeap();
