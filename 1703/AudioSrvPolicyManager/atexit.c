 ...
 *     _dynamic_initializer_for__TsSessionList__ @ 0x1800011B0 (_dynamic_initializer_for__TsSessionList__.c)
 *     ATL::_dynamic_initializer_for__g_strheap__ @ 0x1800011C0 (ATL--_dynamic_initializer_for__g_strheap__.c)
 *     ATL::_dynamic_initializer_for__g_strmgr__ @ 0x180001200 (ATL--_dynamic_initializer_for__g_strmgr__.c)
