/*
 * XREFs of ??1CDuckingManager@@UEAA@XZ @ 0x180006104
 * Callers:
  ...
  *((_QWORD *)this + 3) = &CDuckingManager::`vftable'{for `IAudioDuckingManager'};
  ...
  if ( *((_QWORD *)this + 10) )
  {
    ...
    do
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
      {
        ...
        WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, &WPP_f0c26e893d54393037413041046a80ee_Traceguids, v7);
      }
      if ( v5 >= *((_QWORD *)this + 10) )
        ATL::AtlThrowImpl(-2147024809);
      operator delete(*(void **)(*v4 + 8 * v5), 0x10uLL);
      ATL::CAtlArray<CActiveAudioSession *,ATL::CElementTraits<CActiveAudioSession *>>::RemoveAt((char *)this + 72, v5);
      v5 = ++v3;
    }
  ...
  while ( *((_QWORD *)this + 33) )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
    {
      ...
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, &WPP_f0c26e893d54393037413041046a80ee_Traceguids, v9);
    }
    if ( v8 )
    {
      if ( *v8 )
