/*
 * XREFs of ?GetProcessModuleNameAndAppId@@YAJPEAXPEAPEAG1@Z @ 0x180010C18
 * Callers:
...
LABEL_19:
    v14 = _AllocStringWorker<CTCoAllocPolicy>(
            ProcessHandle,
            *((__int64 *)&v3 + 1),
            (const unsigned __int16 *)&word_180027B04,
            0LL,
...
LABEL_24:
  ...
  if ( v10 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids, v10);
    }
    AudPolicyLogError("GetProcessModuleNameAndAppId", 347, v10);
  }
