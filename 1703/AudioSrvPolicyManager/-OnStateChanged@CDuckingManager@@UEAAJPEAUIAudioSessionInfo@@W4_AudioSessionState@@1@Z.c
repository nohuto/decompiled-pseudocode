/*
 * XREFs of ?OnStateChanged@CDuckingManager@@UEAAJPEAUIAudioSessionInfo@@W4_AudioSessionState@@1@Z @ 0x1800067B0
 * Callers:
 ...
 *     WPP_SF_dddS @ 0x180005E14 (WPP_SF_dddS.c)
 ...
 *     ?GrowBuffer@?$CAtlArray@PEAVCActiveAudioSession@@V?$CElementTraits@PEAVCActiveAudioSession@@@ATL@@@ATL@@AEAA_N_K@Z @ 0x18000989C (-GrowBuffer@-$CAtlArray@PEAVCActiveAudioSession@@V-$CElementTraits@PEAVCActiveAudioSession@@@ATL.c)
...
LABEL_66:
      ...
      if ( i >= *((_QWORD *)v6 + 8) )
        ATL::AtlThrowImpl(-2147024809);
      operator delete(*(void **)(*v32 + 8 * i), 0x10uLL);
