/*
 * XREFs of ?OnScreenReaderStateChanged@CApplicationManager@@QEAAJPEAUScreenReaderStateChangedContext@@@Z @ 0x180013EA0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_D @ 0x180003BD8 (WPP_SF_D.c)
 *     ?Lock@CCritSecLock@ATL@@QEAAXXZ @ 0x18000A394 (-Lock@CCritSecLock@ATL@@QEAAXXZ.c)
 *     WPP_SF_Sddd @ 0x180010714 (WPP_SF_Sddd.c)
        ...
        struct ScreenReaderStateChangedContext *a2)
{
  ...
  *((_DWORD *)a2 + 3) = v6;
  ...
  if ( v8 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x36u, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids, v8);
    }
    AudPolicyLogError("CApplicationManager::OnScreenReaderStateChanged", 2746, v9);
  }
  else
  {
    v10 = *((_DWORD *)a2 + 2) == 0;
    v11 = *(_DWORD *)(*(_QWORD *)a2 + 468LL) != v10;
    *(_DWORD *)(*(_QWORD *)a2 + 468LL) = v10;
    if ( v15 || v11 )
