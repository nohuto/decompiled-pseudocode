/*
 * XREFs of ?ProcessPendingSoundLevelNotification@CApplication@@IEAAXXZ @ 0x18000B3D8
 * Callers:
 ...
 *     ?SoundLevelChangeCompletionCallback@CApplication@@KAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x18000BCD0 (-SoundLevelChangeCompletionCallback@CApplication@@KAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIME.c)
 * Callees:
...
void __fastcall CApplication::ProcessPendingSoundLevelNotification(CApplication *this)
{
  ...
  if ( !*((_DWORD *)this + 70) )
  {
    *((_DWORD *)this + 70) = 1;
    ...
    {
      v3 = *((_DWORD *)this + 71);
      if ( v3 == *((_DWORD *)this + 72) && !*((_DWORD *)this + 143) )
        break;
      *((_DWORD *)this + 72) = v3;
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, &WPP_17d50ef9044b326f9caf58457a9d5dd6_Traceguids, v3);
        v5 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
      ...
      while ( v6 )
      {
        ...
        if ( (*(_BYTE *)(v7 + 440) & 1) != 0 && !*(_DWORD *)(v7 + 416) )
        {
          ...
          if ( Microsoft_Windows_AudioEnableBits < 0 )
            Template_zq((__int64)v5, v4, *((const wchar_t **)this + 3), v3);
