/*
 * XREFs of ?Release@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAXXZ @ 0x180003528
 * Callers:
 *     wil::details::_dynamic_atexit_destructor_for__g_processLocalData__ @ 0x180022DF0 (wil--details--_dynamic_atexit_destructor_for__g_processLocalData__.c)
 * Callees:
...
void __fastcall wil::details_abi::ProcessLocalStorageData<wil::details_abi::ProcessLocalData>::Release(_QWORD *lpMem)
{
  ...
  if ( (*(_DWORD *)lpMem)-- == 1 )
  {
    ...
    if ( hMutex )
    {
      ...
      if ( !ReleaseMutex(v11) )
      {
        wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x87B, v13, v14);
        __debugbreak();
      }
      SetLastError(v12);
    }
  ...
  if ( v15 )
  {
    if ( !ReleaseMutex(v15) )
    {
      wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x87B, v18, v19);
      __debugbreak();
    }
  }
}
