/*
 * XREFs of ?RegisterTrackStateNotificationClient@CApplicationManager@@QEAAJPEAVCProcess@@W4__MIDL___MIDL_itf_audiosrv_0000_0000_0002@@@Z @ 0x1800112CC
 * Callers:
...
__int64 __fastcall CApplicationManager::RegisterTrackStateNotificationClient(__int64 a1, struct CProcess *a2, int a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_719a5be54ec33420ebdafeb185f33b54_Traceguids, v6);
    }
    AudPolicyLogError("CApplicationManager::RegisterTrackStateNotificationClient", 674, v6);
  }
  else
  {
