/*
 * XREFs of ?RemoveSession@CProcess@@QEAAJPEAUIAudioSessionInfo@@@Z @ 0x18000E1D0
 * Callers:
  ...
  if ( i )
  {
    ...
    catch ( ATL::CAtlException *v11 )
    {
      ...
      if ( v14 < 0 )
      {
        ...
        {
          WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_17d50ef9044b326f9caf58457a9d5dd6_Traceguids, v14);
        }
        AudPolicyLogError("CProcess::RemoveSession", 2846, v14);
      }
    }
  }
  if ( v13 )
