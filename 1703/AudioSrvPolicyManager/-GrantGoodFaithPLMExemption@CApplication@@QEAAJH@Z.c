/*
 * XREFs of ?GrantGoodFaithPLMExemption@CApplication@@QEAAJH@Z @ 0x18000B9B0
 * Callers:
...
__int64 __fastcall CApplication::GrantGoodFaithPLMExemption(const wchar_t **this)
{
  ...
  if ( *((_DWORD *)this + 98) )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, &WPP_17d50ef9044b326f9caf58457a9d5dd6_Traceguids, this[3]);
      v3 = (_UNKNOWN **)WPP_GLOBAL_Control;
    }
    started = -2147024809;
  }
  else
  {
    ...
    *((_DWORD *)this + 137) = 1;
    ...
    {
      *((_DWORD *)this + 98) = 1;
      CApplicationManager::ApplyPBMPolicy(g_ApplicationManager, (struct CApplication *)this, 0xA3u);
      goto LABEL_17;
    }
    v3 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  if ( v3 != &WPP_GLOBAL_Control && (*((_DWORD *)v3 + 7) & 0x40000000) != 0 && *((_BYTE *)v3 + 25) >= 2u )
    WPP_SF_D((TRACEHANDLE)v3[2], 0x12u, &WPP_17d50ef9044b326f9caf58457a9d5dd6_Traceguids, started);
  AudPolicyLogError("CApplication::GrantGoodFaithPLMExemption", 1262, started);
LABEL_17:
  if ( v7 )
