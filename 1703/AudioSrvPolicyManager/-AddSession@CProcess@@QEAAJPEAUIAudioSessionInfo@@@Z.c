/*
 * XREFs of ?AddSession@CProcess@@QEAAJPEAUIAudioSessionInfo@@@Z @ 0x18000E0F8
 * Callers:
...
__int64 __fastcall CProcess::AddSession(CProcess *this, struct IAudioSessionInfo *a2)
{
  ...
  catch ( ATL::CAtlException *v8 )
  {
    ...
    if ( v11 < 0 )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x27u, &WPP_17d50ef9044b326f9caf58457a9d5dd6_Traceguids, v11);
      }
      AudPolicyLogError("CProcess::AddSession", 2818, v11);
    }
  }
  if ( v10 )
