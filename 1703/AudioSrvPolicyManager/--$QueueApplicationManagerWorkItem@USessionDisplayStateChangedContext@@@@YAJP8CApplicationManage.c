/*
 * XREFs of ??$QueueApplicationManagerWorkItem@USessionDisplayStateChangedContext@@@@YAJP8CApplicationManager@@EAAJPEAUSessionDisplayStateChangedContext@@@Z0@Z @ 0x18001CA00
 * Callers:
...
__int64 __fastcall QueueApplicationManagerWorkItem<SessionDisplayStateChangedContext>(__int64 a1, __int64 a2)
{
  ...
  if ( v5 )
  {
    ...
    v5[1] = CApplicationManager::OnTsSessionDisplayStateChanged;
    v5[2] = a2;
