/*
 * XREFs of ?NotifyUnfilteredClientsAutoUnduck@CDuckingManager@@AEAAJPEBG@Z @ 0x180007D68
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( v4 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x30u, &WPP_f0c26e893d54393037413041046a80ee_Traceguids, a2);
    }
    v5 = -1LL;
    do
      ++v5;
