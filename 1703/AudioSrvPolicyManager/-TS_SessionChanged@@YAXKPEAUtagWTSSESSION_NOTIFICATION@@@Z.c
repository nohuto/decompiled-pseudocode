/*
 * XREFs of ?TS_SessionChanged@@YAXKPEAUtagWTSSESSION_NOTIFICATION@@@Z @ 0x18001BCB0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_D @ 0x180003BD8 (WPP_SF_D.c)
 *     WPP_SF_sd @ 0x18001857C (WPP_SF_sd.c)
...
LABEL_38:
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        ...
        WPP_SF_sd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Bu, a1, v6, a2->dwSessionId);
      }
...
LABEL_26:
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        ...
        WPP_SF_sd(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Au, a1, v5, a2->dwSessionId);
      }
...
LABEL_35:
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Du, &WPP_8c6176e2ee2e3d308447856c4f339b3c_Traceguids, dwSessionId);
  }
