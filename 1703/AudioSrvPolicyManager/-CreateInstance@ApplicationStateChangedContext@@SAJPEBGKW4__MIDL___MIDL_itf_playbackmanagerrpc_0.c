/*
 * XREFs of ?CreateInstance@ApplicationStateChangedContext@@SAJPEBGKW4__MIDL___MIDL_itf_playbackmanagerrpc_0000_0000_0002@@PEAPEAU1@@Z @ 0x18001E7D0
 * Callers:
        ...
        _QWORD *a4)
{
  ...
  if ( v13 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, &WPP_ad7b8a207b4c33c21ba4cfb512d2eba6_Traceguids, v13);
    }
    AudPolicyLogError("ApplicationStateChangedContext::CreateInstance", 1040, v13);
  }
