/*
 * XREFs of dllmain_crt_process_attach @ 0x180020710
 * Callers:
 ...
 *     __scrt_dllmain_before_initialize_c @ 0x180020D58 (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_crt @ 0x180020E54 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x180020F80 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18002101C (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180021224 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180021240 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18002125C (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18002126C (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x1800213B4 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x180021600 (_initterm_0.c)
 *     _initterm_e_0 @ 0x180021606 (_initterm_e_0.c)
