/*
 * XREFs of ?UpdateStreamCountAndProcessCategory@CProcess@@IEAAXPEBGKHHPEAHPEAW4_APPLICATION_CATEGORY@@@Z @ 0x18000E5F4
 * Callers:
 ...
 *     WPP_SF_dSS @ 0x18000A5E0 (WPP_SF_dSS.c)
  ...
  if ( (int)CProcess::GetActiveStreamCountStatsForEndpoint(this, a2, a5, (unsigned int **)&pftDueTime) >= 0 )
  {
    *(_DWORD *)(*(_QWORD *)&pftDueTime + 4 * v8) += v11;
    ...
    if ( a4 )
    {
      if ( v13 == 1 )
      {
        v14 = (struct _TP_TIMER *)*((_QWORD *)this + 69);
        if ( v14 )
        {
        ...
        if ( !*((_QWORD *)this + 68) )
          NtAcquireProcessActivityReference((char *)this + 544, *((_QWORD *)this + 20), 0LL);
        if ( v18 )
    ...
    {
      if ( !*((_QWORD *)this + 69) )
        *((_QWORD *)this + 69) = CreateThreadpoolTimer(
                                   lambda_5ce815ae0cdec547ed542fdaed3a7314_::_lambda_invoker_cdecl_,
                                   this,
                                   0LL);
      v15 = (struct _TP_TIMER *)*((_QWORD *)this + 69);
      if ( v15 )
      {
