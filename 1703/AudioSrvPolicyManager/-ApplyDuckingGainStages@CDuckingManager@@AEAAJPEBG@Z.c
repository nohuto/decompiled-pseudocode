/*
 * XREFs of ?ApplyDuckingGainStages@CDuckingManager@@AEAAJPEBG@Z @ 0x18000874C
 * Callers:
...
__int64 __fastcall CDuckingManager::ApplyDuckingGainStages(CDuckingManager *this, const unsigned __int16 *a2)
{
  ...
  {
LABEL_30:
    AudPolicyLogError("CDuckingManager::ApplyDuckingGainStages", 1512, DuckableSessionsList);
    goto LABEL_31;
  }
  while ( v19 )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      ...
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x36u, &WPP_f0c26e893d54393037413041046a80ee_Traceguids, v5);
    }
    v22 = 0LL;
...
LABEL_20:
      ...
      if ( v16 )
      {
        DuckableSessionsList = (*(__int64 (__fastcall **)(__int64, volatile signed __int32 *, __int128 *))(*(_QWORD *)v22 + 40LL))(
                                 v22,
                                 v16,
                                 &DuckingPolicyGuid);
