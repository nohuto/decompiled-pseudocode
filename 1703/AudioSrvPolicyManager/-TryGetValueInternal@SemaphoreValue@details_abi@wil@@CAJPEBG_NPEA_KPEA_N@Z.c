/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x180002A68
 * Callers:
...
LABEL_20:
  ...
  if ( v19 >= 0 )
  {
    if ( !CloseHandle(v18) )
    {
      wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x875, v22, v23);
      __debugbreak();
    }
  ...
  if ( !CloseHandle(v18) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x875, v20, v21);
    __debugbreak();
  }
LABEL_21:
  if ( v11 && !CloseHandle(v11) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x875, v24, v25);
    JUMPOUT(0x180002C88LL);
  }
  return LastError;
}
