/*
 * XREFs of ?Initialize@CStreamStartedWorkItem@@QEAAJPEAUIAudioStreamInfo@@@Z @ 0x18001D23C
 * Callers:
...
__int64 __fastcall CStreamStartedWorkItem::Initialize(CStreamStartedWorkItem *this, struct IAudioStreamInfo *a2)
{
  ...
  *((_QWORD *)this + 1) = a2;
        ...
        ProcessFromSessionInfo < 0) )
  {
    ...
    AudPolicyLogError("CStreamStartedWorkItem::Initialize", 96, ProcessFromSessionInfo);
  }
