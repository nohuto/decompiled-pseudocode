/*
 * XREFs of ?ProcessPendingPLMExemptionChange@CApplication@@IEAAXXZ @ 0x18000B58C
 * Callers:
    ...
    *((_DWORD *)this + 84) = 1;
    while ( *((_DWORD *)this + 85) )
    {
      ...
      *((_DWORD *)this + 85) = 0;
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x10u, &WPP_17d50ef9044b326f9caf58457a9d5dd6_Traceguids, v3);
      }
