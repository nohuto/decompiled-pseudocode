/*
 * XREFs of RtlUpcaseUnicodeToMultiByteN @ 0x18007E130
 * Callers:
...
LABEL_100:
  ...
  if ( v6 )
  {
    ...
    do
    {
      ...
      v37 = *UnicodeString++;
      v38 = *(_WORD *)(v34 + 2 * v37);
      if ( word_180159D80[HIBYTE(v38)] )
        v39 = *(_WORD *)(qword_180159FA0
                       + 2 * ((unsigned __int8)v38 + (unsigned __int64)(unsigned __int16)word_180159D80[HIBYTE(v38)]));
      else
