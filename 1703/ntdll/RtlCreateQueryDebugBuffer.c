/*
 * XREFs of RtlCreateQueryDebugBuffer @ 0x180056140
 * Callers:
...
_QWORD *__fastcall RtlCreateQueryDebugBuffer(unsigned int a1)
{
  ...
  if ( v2 <= 0xFFFFFFFF && is_mul_ok(v2, 2uLL) )
  {
    v13 = 2 * v2;
    v12 = 2 * v2;
    if ( (int)ZwCreateSection(&v8, 983071LL, 0LL, &v12, 4, 0x4000000, ((v2 * (unsigned __int128)2uLL) >> 64) & v7) >= 0
      && (int)ZwMapViewOfSection(v8, -1LL, &v11, 0LL, 0LL, 0LL, &v13, 2, 0, 4) >= 0 )
    {
      v14 = v11;
      v9 = 208LL;
