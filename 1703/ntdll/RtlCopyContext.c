...
__int64 __fastcall RtlCopyContext(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  v6 = 0;
  v7 = 0LL;
  result = sub_180068D44(a2, 0LL);
  if ( (int)result >= 0 )
  {
    v19 = (_DWORD *)sub_180068DB0(a1, a2);
    v10 = (int *)sub_180068DB0(a3, v9);
    v12 = *v11;
    v13 = *v10;
    result = sub_180068D44(a2 | *v10 | *v11, 0LL);
    if ( (int)result >= 0 )
    {
      v14 = a2 & v13;
        ...
        if ( (int)result >= 0 )
        {
          ...
          else
          {
            ...
            *v19 |= v12;
            ...
            if ( (v18 & 2) == 0 )
              return v16;
            result = sub_180068FF8(v17, v6, v6, v7, v7);
            v16 = result;
            if ( (int)result >= 0 )
              return v16;
          }
