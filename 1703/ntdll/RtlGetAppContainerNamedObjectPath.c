...
__int64 __fastcall RtlGetAppContainerNamedObjectPath(__int64 a1, __int64 a2, char a3, __int64 a4)
{
  __int64 v4; // rbx
  char v8; // r13
  unsigned int v9; // esi
...
LABEL_7:
  v13 = 0;
  result = ZwQueryInformationToken(v4, 29LL, &v13);
  if ( (int)result < 0 )
    return result;
  if ( !v13 )
  {
...
LABEL_11:
  if ( a3 )
  {
    ...
    if ( v10 )
    {
      result = ZwQueryInformationToken(-4LL, 42LL, &v14);
      if ( (int)result < 0 )
        return result;
      if ( v14 )
      {
        result = ZwQueryInformationToken(v4, 42LL, &v15);
        if ( (int)result < 0 )
          return result;
        if ( !(_DWORD)v15 )
          return 3221225659LL;
        result = ZwQueryInformationToken(-4LL, 1LL, &v16);
        if ( (int)result < 0 )
          return result;
        result = ZwQueryInformationToken(v4, 1LL, &v17);
        if ( (int)result < 0 )
          return result;
  ...
  if ( !v8 )
    v12 = v9;
  return sub_180057C00(v4, a2, v12, a4);
}
