/*
 * XREFs of sub_180007C18 @ 0x180007C18
 * Callers:
...
__int64 __fastcall sub_180007C18(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4, _DWORD *a5, __int64 a6)
{
  int v7; // eax
  int v8; // ecx
  __int64 v9; // r15
  ...
  v7 = qword_18015BFE8 ^ *(_DWORD *)(a2 + 40) ^ ((unsigned int)a2 >> 12);
  v32 = v7;
  if ( a3 == a2 )
  {
    v8 = 0;
  ...
  else
  {
    v24 = a3 - HIWORD(v7) - a2;
    v25 = *(_QWORD *)(a1
                    + 8LL * (unsigned __int8)byte_1801196F0[((unsigned __int64)(unsigned __int16)v7 + 15) >> 4]
                    + 192);
    if ( *(_DWORD *)(v25 + 72) )
    {
      v26 = (v24 * (unsigned __int64)*(unsigned int *)(v25 + 72)) >> *(_BYTE *)(v25 + 76);
      v27 = v24 - v26 * (unsigned __int16)v7;
    }
    else
    {
      v29 = *(_BYTE *)(v25 + 76);
  ...
  v30 = 2LL * *(unsigned __int16 *)(a2 + 34);
  v31 = a2 + 48;
  while ( 2 )
  {
    v10 = v30 - 1;
...
LABEL_23:
  ...
  v23 = sub_18008BE6C(a2, v15, v18, a6);
  *a4 = v23;
