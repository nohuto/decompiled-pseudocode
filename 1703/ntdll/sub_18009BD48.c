...
__int64 __fastcall sub_18009BD48(
        __int64 a1,
        unsigned __int16 *a2,
        unsigned __int16 **a3,
        unsigned int a4,
        ...
        int a6)
{
  ...
  v10 = a2 + 1;
  v11 = 0;
  while ( (unsigned int)sub_1800995EC(v9, 8) )
    v9 = *v10++;
  v12 = a5;
  if ( v9 == 45 )
  {
...
LABEL_14:
  if ( v6 )
    goto LABEL_20;
  if ( !(unsigned int)sub_18009D788(v9) )
  {
    if ( ((*v10 - 88) & 0xFFDF) != 0 )
    {
      v6 = 8;
    ...
    v6 = 16;
LABEL_20:
    if ( v6 == 16 && !(unsigned int)sub_18009D788(v9) && ((*v10 - 88) & 0xFFDF) == 0 )
    {
      v9 = v10[1];
      v10 += 2;
    }
