/*
 * XREFs of RtlQueryActivationContextApplicationSettings @ 0x180080700
 * Callers:
 *     <none>
 * Callees:
        ...
        PSIZE_T RequiredLength)
{
  ...
  if ( !Buffer && BufferLength )
    return -1073741811;
  v9 = sub_1800183AC(1, (__int64)ActivationContext, 0LL, (const char **)&v19);
  if ( v9 >= 0 )
  {
    v9 = sub_18003FB50(v19, 0LL, 0xAu, &DestinationString, &v22);
    if ( v9 >= 0 )
    {
      v11 = v22;
      ...
      if ( v22 >= 0x2C && **(_DWORD **)&DestinationString.Length == 1682469715 )
      {
        ...
        LODWORD(v21[0]) = 112;
        v9 = sub_18003FCD8(v12, v11, &DestinationString, (unsigned int *)v21, &v18, &v22);
        if ( v9 >= 0 )
        {
          if ( HIDWORD(v21[0]) != 1 )
            return -1072365565;
