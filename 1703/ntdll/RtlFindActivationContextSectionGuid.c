        ...
        PACTCTX_SECTION_KEYED_DATA ReturnedData)
{
  ...
  v17 = 0;
  v19 = 0LL;
  result = sub_18003FF6C(Flags, (_DWORD)ExtensionGuid, SectionId, (_DWORD)GuidToFind, (__int64)ReturnedData);
  if ( result >= 0 )
  {
    v20[1] = 0;
    v23 = 0;
...
LABEL_25:
        ...
        if ( *v18 != 1682469703 )
          goto LABEL_25;
        result = sub_18003D8E0(v18, GuidToFind, ReturnedData);
        if ( result >= 0 )
          break;
      ...
      if ( !ReturnedData )
        return 0;
      result = sub_180084014(Flags, ReturnedData, v14, v20, v13, v13[8], v13[9], v12);
      if ( result >= 0 )
        return 0;
    }
  }
