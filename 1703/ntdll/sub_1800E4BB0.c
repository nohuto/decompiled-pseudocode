/*
 * XREFs of sub_1800E4BB0 @ 0x1800E4BB0
 * Callers:
...
__int64 __fastcall sub_1800E4BB0(unsigned __int16 *a1, unsigned __int16 *a2)
{
  __int64 v2; // rdi
  unsigned int v3; // esi
  const void *v7; // rdx
  ...
  if ( NlsMbCodePageTag )
  {
    if ( v16 == 92 )
    {
      for ( i = 0; i < v13; i += (word_180159D80[*(unsigned __int8 *)(i + v14)] != 0) + 1 )
        ;
      if ( i != v13 )
        v18 = 92;
    }
    if ( v17 == 92 )
    {
      for ( j = 0; j < v13; j += (word_180159D80[*(unsigned __int8 *)(j + v15)] != 0) + 1 )
        ;
      if ( j != v13 )
        v19 = 92;
    }
