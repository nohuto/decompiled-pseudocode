...
double __cdecl atan2(double Y, double X)
{
  ...
  if ( (*(_QWORD *)&X & 0x7FFFFFFFFFFFFFFFuLL) > 0x7FF0000000000000LL )
  {
    v12 = LODWORD(X);
LABEL_3:
    sub_18009DD10((unsigned int)"atan2", 16, v12, 1, 0, 33, *(__int64 *)&X, *(__int64 *)&Y, 2);
    return Y;
  }
  v13 = 0LL;
...
LABEL_8:
    ...
    {
      if ( v10 )
        v14 = *(double *)&qword_180155A50;
      else
        v14 = *(double *)&qword_180155A48;
LABEL_31:
      if ( !v11 )
      {
LABEL_33:
...
LABEL_32:
    ...
    else
    {
      ...
      v30 = qword_1801179F0[v29];
      v31 = qword_180117260[v29];
    ...
    if ( v26 )
    {
      v31 = *(double *)&qword_180155A68 - v31;
      v28 = *(double *)&qword_180155A70 - v28;
    }
    if ( v10 )
    {
      v31 = *(double *)&qword_180155A58 - v31;
      v28 = *(double *)&qword_180155A60 - v28;
    }
    v36 = v31 + v28;
    if ( v11 )
      return -v36;
...
LABEL_48:
    ...
    if ( v9 < -1022 )
    {
      ...
      {
        v13 = *(_QWORD *)&v23 & 0x800FFFFFFFFFFFFFuLL | ((__int64)v24 << 52);
      }
      *(_QWORD *)&v14 = COERCE_UNSIGNED_INT64(1.267650600228229e30 * v2 / v3) & 0x8000000000000000uLL | v13;
