/*
 * XREFs of sub_1800F8A60 @ 0x1800F8A60
 * Callers:
...
__int64 __fastcall sub_1800F8A60(__int64 a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  __int64 v8; // rdx
  unsigned int v9; // r8d
  bool i; // zf
  ...
  v9 = dword_180159A10;
  v12 = dword_180159A10;
  v11 = _InterlockedCompareExchange(&dword_180159A10, (dword_180159A10 + 1) % 0x32u, dword_180159A10);
  for ( i = v12 == v11; ; i = v11 == v13 )
  {
    ...
    if ( i )
      break;
    v9 = v11;
    v11 = _InterlockedCompareExchange(&dword_180159A10, (v11 + 1) % 0x32u, v11);
  }
  v14 = 1424LL * v9;
  i = qword_18015C418 + v14 == 0;
  v8 = qword_18015C418 + v14;
