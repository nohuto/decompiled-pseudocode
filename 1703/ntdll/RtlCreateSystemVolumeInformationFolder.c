/*
 * XREFs of RtlCreateSystemVolumeInformationFolder @ 0x18008C720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlCreateSystemVolumeInformationFolder(unsigned __int16 *a1)
{
  ...
  unsigned __int64 v19; // [rsp+B0h] [rbp+27h]
  __int64 v20; // [rsp+B8h] [rbp+2Fh]
  __int64 v21; // [rsp+F0h] [rbp+67h] BYREF
  unsigned __int64 v22; // [rsp+F8h] [rbp+6Fh] BYREF
  unsigned __int64 v23; // [rsp+100h] [rbp+77h] BYREF
