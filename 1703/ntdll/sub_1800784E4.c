/*
 * XREFs of sub_1800784E4 @ 0x1800784E4
 * Callers:
...
void __fastcall sub_1800784E4(__int64 a1, unsigned __int64 a2)
{
  ULONG_PTR v3; // rdi
  _QWORD *v4; // rsi
  _QWORD *v5; // rbx
  ...
  int v7; // eax
  _QWORD *v8; // rax
  ULONG_PTR *ExceptionInformation; // rax
  __int64 v10; // rcx
  __int64 v11; // rdx
  _QWORD *v12; // rbx
  __int64 v13; // rcx
  __int64 v14; // [rsp+0h] [rbp-99h] BYREF
      ...
      if ( v4 != (_QWORD *)(a1 + 8) )
      {
        while ( 1 )
        {
          ...
          if ( *((_DWORD *)v4 - 2) != 1953721414 )
          {
            ...
            ExceptionRecord.ExceptionInformation[3] = (ULONG_PTR)(v4 - 1);
...
LABEL_13:
    sub_180095EB0((unsigned __int64)&v14 ^ v16);
  }
}
