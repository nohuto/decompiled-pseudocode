/*
 * XREFs of sub_1800F7A9C @ 0x1800F7A9C
 * Callers:
...
unsigned __int64 __fastcall sub_1800F7A9C(__int64 a1)
{
    ...
    if ( v4 != v5 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( (*(_BYTE *)(v8 + a1) & 0xC0) != 0xC0 )
          break;
        result = sub_1800F7F4C(v7, *(unsigned int *)(v3 + 88), (unsigned int)result);
        v10 = (int)result;
        if ( !(_DWORD)result )
          break;
        v11 = *(_QWORD *)(v7 + 40);
