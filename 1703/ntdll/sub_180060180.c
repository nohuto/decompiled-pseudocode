/*
 * XREFs of sub_180060180 @ 0x180060180
 * Callers:
 ...
 *     sub_1800602E4 @ 0x1800602E4 (sub_1800602E4.c)
 *     RtlSleepConditionVariableCS @ 0x180071240 (RtlSleepConditionVariableCS.c)
 *     ZwSetEvent @ 0x1800A54C0 (ZwSetEvent.c)
 */

char __fastcall sub_180060180(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  v9 = *(_QWORD *)(a1 + 8 * v4 + 544);
  v10 = (unsigned int)v4;
  while ( !v9 || a2 == v9 )
  {
    v11 = sub_1800602E4(a1);
    if ( v11 )
      goto LABEL_4;
    if ( (*(_DWORD *)(a1 + 324) & 0x400) == 0 )
    {
      do
      {
        if ( (unsigned int)sub_18005304C(a1, 1u) != 1 )
          break;
        v11 = sub_1800602E4(a1);
      }
      while ( !v11 );
