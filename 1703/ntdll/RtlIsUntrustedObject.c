/*
 * XREFs of RtlIsUntrustedObject @ 0x1800E5310
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !Object && Handle )
  {
    ...
    if ( result < 0 )
    {
      if ( result != -1073741789 )
        return result;
      Heap = (ACL **)RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, dword_18015B268 + 1310720, LengthNeeded);
      if ( !Heap )
        return v8 - 12;
      v6 = 1;
      v8 = ZwQuerySecurityObject(Handle, 0x10u, Heap, 0x7Cu, &LengthNeeded);
      if ( v8 < 0 )
      {
LABEL_21:
