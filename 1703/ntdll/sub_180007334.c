...
__int64 __fastcall sub_180007334(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned int a4, int a5, char a6)
{
  ...
  if ( a5 )
  {
    v15 = (__int64 (__fastcall *)(__int64, __int64, _QWORD))(a1 ^ qword_18015BFA8 ^ *(_QWORD *)(a1 + 80));
    if ( v15 == sub_180020D20 )
      v16 = sub_180020D20(v14, v13, v11);
    else
      v16 = v15(v14, v13, v11);
    v17 = v16;
    if ( v16 < 0 )
  ...
  {
    v20 = (void (__fastcall *)(__int64, __int64, _QWORD))(a1 ^ qword_18015BFA8 ^ *(_QWORD *)(a1 + 88));
