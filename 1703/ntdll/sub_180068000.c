...
NTSTATUS __fastcall sub_180068000(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
  NTSTATUS result; // eax
  int v10; // esi
  int v11; // eax
  ...
  result = sub_180067F8C(a1, a3, (int)&v18, 288LL);
  if ( result >= 0 )
  {
    result = sub_180067F8C(a1, v23, (int)&v16, 80LL);
    if ( result >= 0 )
    {
      *(_QWORD *)(a2 + 16) = v19;
      *(_DWORD *)(a2 + 24) = v20;
      *(_DWORD *)(a2 + 28) = v22;
      ...
      {
        v10 = 10240;
        v11 = sub_180067F8C(a1, a4, (int)&v24, 8LL);
LABEL_7:
        if ( v11 >= 0 )
        {
          while ( 1 )
          {
            ...
            v14 = (char *)v13 == (char *)sub_180068160 ? sub_180068160(*a1) : v13(*a1, v12, &v24, 8LL, &v15);
            if ( v14 < 0 )
              break;
            if ( v15 != 8 )
            {
      ...
      return sub_180067A7C(a1, (__int64)v21, a2, 0);
    }
  }
  return result;
}
