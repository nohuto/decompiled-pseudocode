/*
 * XREFs of RtlLoadString @ 0x1800753A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    if ( v11 )
    {
      v12 = LdrResSearchResource(a1, v21, 4u, 1, (__int64)&v18, (__int64 *)&v17, a7, a8);
      if ( v12 >= 0 && v17 > 0xFFFF )
        v12 = -1073741701;
    }
    else
    {
      v12 = sub_180035838((unsigned __int64)a1, (__int64)v21, 4u, 1u, (__int64 *)&v19);
      if ( v12 < 0 )
