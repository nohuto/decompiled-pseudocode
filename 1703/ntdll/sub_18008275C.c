...
void __fastcall sub_18008275C(HANDLE ThreadHandle, _QWORD *a2)
{
  ...
  HANDLE v20; // [rsp+158h] [rbp+20h]

  memset(&v16[2], 0, 0x2EuLL);
  memset(v15, 0, sizeof(v15));
  v19 = 0;
  if ( byte_18015C3E0 && !byte_18015C728 && !NtCurrentPeb()->Ldr->ShutdownInProgress )
  {
    ...
    for ( i = (_UNKNOWN **)off_180155620; i != &off_180155620; i = (_UNKNOWN **)*i )
    {
      ...
      *(_QWORD *)&v15[32] = *(_QWORD *)(v7 + 32);
      if ( *(_UNKNOWN ***)v15 == v6 )
      {
        ...
        {
          v11 = sub_180008E00(*((_WORD *)v6 + 1), *((_WORD *)v6 + 22));
      ...
      else
      {
        ...
        *(_OWORD *)&v16[32] = *(_OWORD *)(*(_QWORD *)v15 + 32LL);
        v9 = sub_180008E00(*(unsigned __int16 *)&v16[2], *(unsigned __int16 *)&v16[44]);
        v10 = sub_180008E00(*((_WORD *)v6 + 1), *((_WORD *)v6 + 22));
        RtlApplicationVerifierStop(
          515,
