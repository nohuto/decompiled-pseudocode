...
__int64 __fastcall sub_18001AA5C(int a1, int a2, int a3, int a4, __int64 a5, _QWORD *a6, __int64 a7)
{
  int v11; // eax
  int v12; // ebx
  ...
  *a6 = 0LL;
  if ( (a3 & 0x20) != 0 )
  {
    v11 = sub_180021AE0(a1, 0, a3, (_DWORD)a6, 0LL);
    goto LABEL_4;
  }
  if ( (a3 & 0x200) != 0 )
  {
    v11 = sub_180021AE0(0, a1, a3, (_DWORD)a6, 0LL);
LABEL_4:
    v12 = v11;
    goto LABEL_5;
  }
...
LABEL_5:
  if ( v12 == -1073741515 )
  {
    v12 = sub_180039E20(a1, a2, a3, a4, a5, (__int64)a6, a7);
    if ( v12 >= 0 )
