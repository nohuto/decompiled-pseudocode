...
void __fastcall sub_180081F44(unsigned __int16 *a1, unsigned __int16 *a2, int a3, __int64 a4, char a5)
{
  int v8; // eax
  int v9; // ecx
  int v10; // eax
  ...
  if ( (dword_180158674 & 0x20) != 0 )
  {
    ...
    {
      v8 = ZwQueryInformationProcess(-1LL, 12LL, &v13, 4LL, 0LL);
      v9 = v13;
      if ( v8 < 0 )
        v9 = 5;
      v13 = v9;
...
LABEL_8:
        ...
        EtwEventWriteNoRegistration(&unk_180113E90, a4, v11, &v14);
      }
    }
  }
}
