/*
 * XREFs of RtlpGetUserOrMachineUILanguage4NLS @ 0x1800F9FF0
 * Callers:
...
__int64 __fastcall RtlpGetUserOrMachineUILanguage4NLS(int a1, void *a2, unsigned __int64 *a3, __int64 a4)
{
  ...
  LODWORD(v16) = 0;
  v11 = 7;
  v7 = sub_18006E330(0x2000000u, 0LL, (__int64)a3, a4, &CurrentUserKey);
  if ( v7 < 0 )
    goto LABEL_21;
  if ( a1 == 1 )
  {
  ...
  else
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v7 >= 0 )
    {
      ...
      v7 = sub_18006E1E4(KeyHandle, &DestinationString, &v11, 0LL, (ULONG *)&v16);
      if ( v7 >= 0 )
        goto LABEL_10;
    }
    if ( v7 == -2147483643 )
...
LABEL_15:
    ...
    v7 = sub_18006E1E4(KeyHandle, &DestinationString, &v11, a2, (ULONG *)&v16);
    if ( v7 >= 0 )
    {
      if ( v11 == 7 )
        goto LABEL_15;
