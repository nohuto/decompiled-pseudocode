...
__int64 __fastcall RtlpGetUserOrMachineUILanguage4NLS(int a1, void *a2, unsigned __int64 *a3, __int64 a4)
{
  ...
  v20 = 0;
  v11 = 7;
  v7 = sub_18006E330(0x2000000u, 0, (__int64)a3, a4, (__int64)&v13);
  if ( v7 < 0 )
    goto LABEL_21;
  if ( a1 == 1 )
  {
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      v7 = sub_18006E1E4(v12, (__int64)&DestinationString, &v11, 0LL, &v20);
      if ( v7 >= 0 )
        goto LABEL_10;
    }
    if ( v7 == -2147483643 )
...
LABEL_15:
    ...
    v7 = sub_18006E1E4(v12, (__int64)&DestinationString, &v11, a2, &v20);
    if ( v7 >= 0 )
    {
      if ( v11 == 7 )
        goto LABEL_15;
