/*
 * XREFs of sub_18006938C @ 0x18006938C
 * Callers:
 *     RtlLookupElementGenericTableFullAvl @ 0x180069170 (RtlLookupElementGenericTableFullAvl.c)
...
__int64 __fastcall sub_18006938C(__int64 a1, __int64 a2, _QWORD *a3)
{
  __int64 v6; // rbx
  unsigned int v7; // edi
  int v8; // eax
