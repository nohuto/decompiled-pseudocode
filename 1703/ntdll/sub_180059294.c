...
__int64 __fastcall sub_180059294(__int64 a1, __int64 a2, int *a3, __int64 a4, _QWORD *a5)
{
  _QWORD *Heap; // rax
  _QWORD *v9; // rbx
  int v10; // edi
  ...
  Heap = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, dword_18015B268 + 786432, 0x48uLL);
  v9 = Heap;
  if ( !Heap )
    return 3221225495LL;
