...
LABEL_48:
        v20 = ((unsigned int)(((__int64)v15 - v13) >> 3) << 6) - v36;
        if ( v20 > v14 )
          goto LABEL_35;
        v37 = a2 - v36;
        v38 = a2 - v36;
...
LABEL_23:
              ...
              if ( v25 + (int)v28 >= a2 )
              {
                LODWORD(v32) = -v25;
LABEL_34:
                v20 = ((unsigned int)(((__int64)v15 - v13) >> 3) << 6) + v32;
                v21 = v20 <= v14;
                goto LABEL_11;
              }
              v29 = a2;
...
LABEL_65:
          ...
          do
          {
            ...
            if ( v27 )
              ...
              v44 = 63 - v43;
            v20 = (((unsigned int)(((__int64)v15 - v13) >> 3) + 1) << 6) - v44;
            if ( v20 > v14 )
              goto LABEL_35;
            v45 = a2 - v44;
            if ( a2 == v44 )
