...
__int64 __fastcall sub_18005683C(__int64 a1, __int64 a2, _DWORD *a3, int *a4, __int64 a5, __int64 a6, char a7)
{
  unsigned int v8; // ebx
  __int64 v9; // r8
...
LABEL_6:
        ...
        if ( v26 + 2 >= 2 )
        {
          ...
          memmove(v17, a3 + 5, v26);
          v12 = a1;
          *(_WORD *)&v17[a3[4]] = 0;
          v11 = (unsigned __int64)&v17[v27 + 7] & 0xFFFFFFFFFFFFFFF8uLL;
          v47 = (_DWORD *)v11;
    ...
    if ( v14 == 7 )
    {
      ...
      for ( i = v18; (unsigned __int64)i < v31; v18 = i )
      {
        ...
        if ( (v35 & 0x20) != 0 )
        {
          ...
          v37 = sub_180056BE0(1LL, v18, v36, *(_QWORD *)(a2 + 24));
          *(_QWORD *)(a2 + 24) += 16LL;
        }
        else
        {
          v37 = (*(__int64 (__fastcall **)(char *, __int64, _WORD *, _QWORD, __int64, _QWORD))a2)(
                  v17,
                  1LL,
                  v18,
                  v36,
...
LABEL_13:
  ...
  if ( (v21 & 0x20) != 0 )
  {
    ...
    v23 = sub_180056BE0(v14, v18, v19, *(_QWORD *)(a2 + 24));
  }
  else
  {
