/*
 * XREFs of sub_1800AA0B0 @ 0x1800AA0B0
 * Callers:
...
__int64 __fastcall sub_1800AA0B0(_BYTE *a1, _BYTE *a2, _BYTE *a3, __int64 a4, _DWORD *a5)
{
  _BYTE *v5; // rdi
              ...
              while ( 1 )
              {
                while ( 1 )
                {
                  ...
                  while ( (unsigned __int64)v5 > v10 )
                  {
                    ...
                    v10 = (unsigned __int64)&a1[dword_180117100[v11]];
                  }
                  v13 = a3 + 1;
                  v14 = *(_WORD *)(a3 + 1);
                  v15 = v14;
                  v17 = dword_180117144[v11] & v14;
