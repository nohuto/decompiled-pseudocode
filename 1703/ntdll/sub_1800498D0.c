        ...
        _BYTE *a14)
{
  ...
  void *v26[8]; // [rsp+98h] [rbp-9h] BYREF
  ...
  *a14 = 0;
  ...
  if ( !(unsigned __int8)RtlFirstFreeAce(a12, v26) )
    return 3221225597LL;
  v19 = v26[0];
  if ( !v26[0] )
    return 3221225597LL;
  ...
  v18 = v25[0];
  v17 = *(_DWORD *)&v25[7];
  if ( !v25[0] && *(_DWORD *)&v25[7] && v19 && (unsigned __int8)sub_18004A080(a12, v19) )
  {
    *(_DWORD *)&v25[3] = v17;
    --*(_WORD *)(a12 + 4);
    v17 = 0;
...
LABEL_18:
  ...
  if ( v15 <= 0xFFFF )
  {
    ...
    else if ( !v18 )
    {
      ...
      {
        v19[1] |= 0x10u;
        if ( (unsigned __int8)sub_18004A080(a12, v19) )
        {
          v20 = *(_DWORD *)&v25[3];
          --*(_WORD *)(a12 + 4);
