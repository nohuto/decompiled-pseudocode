/*
 * XREFs of RtlUpcaseUnicodeToOemN @ 0x18007CBA0
 * Callers:
        ...
        if ( (_DWORD)v12 != 11 )
        {
          if ( (_DWORD)v12 != 12 )
          {
            if ( (_DWORD)v12 != 13 )
            {
              ...
              v29 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 14) + v10));
              if ( v29 >= 0x61u )
              {
                if ( v29 > 0x7Au )
                  v29 += *(_WORD *)(v15
              ...
              *(v13 - 14) = *(_BYTE *)(v29 + v10);
            }
            v30 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 13) + v10));
            if ( v30 >= 0x61u )
            {
              if ( v30 > 0x7Au )
                v30 += *(_WORD *)(v15
...
LABEL_24:
  ...
  if ( v6 )
  {
    ...
    do
    {
      ...
      v39 = *UnicodeString++;
      v40 = *(_WORD *)(v37 + 2 * v39);
      if ( word_180159FC0[HIBYTE(v40)] )
        v41 = *(_WORD *)(v38
                       + 2 * ((unsigned __int8)v40 + (unsigned __int64)(unsigned __int16)word_180159FC0[HIBYTE(v40)]));
      else
