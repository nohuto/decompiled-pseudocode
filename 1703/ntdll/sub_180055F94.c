/*
 * XREFs of sub_180055F94 @ 0x180055F94
 * Callers:
...
__int64 __fastcall sub_180055F94(_DWORD *a1, int a2, __int16 a3)
{
  int v4; // ebx
  int v6; // edi
  __int16 v7; // ax
  ...
  if ( !itow_s(v4, Buffer, 5uLL, 10) )
  {
    ...
    *a1 = -44;
    v6 = sub_180056454(0x40000000, a2, (unsigned int)v11, 0, 0LL, 1);
    if ( v6 >= 0 )
    {
      v7 = v9;
      if ( v10 == -4 || v9 == -4 )
      ...
      if ( v6 >= 0 && (v4 > v10 || v4 < v9) )
      {
        ...
        else
        {
          ...
          LODWORD(v11[18]) = 50331648;
          *a1 = -44;
          return (unsigned int)sub_180056454(0x40000000, a2, (unsigned int)&v11[14], 0, 0LL, 1);
        }
      }
    }
  }
