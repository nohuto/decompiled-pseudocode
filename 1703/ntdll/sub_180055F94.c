...
__int64 __fastcall sub_180055F94(_DWORD *a1, __int64 a2, __int16 a3)
{
  int v4; // ebx
  int v6; // edi
  __int16 v7; // ax
  ...
  if ( !itow_s(v4, Buffer, 5uLL, 10) )
  {
    ...
    *a1 = -44;
    v6 = sub_180056454(0x40000000LL, a2, v13, 0LL, 0LL, v9);
    if ( v6 >= 0 )
    {
      v7 = v11;
      if ( v12 == -4 || v11 == -4 )
      ...
      if ( v6 >= 0 && (v4 > v12 || v4 < v11) )
      {
        ...
        else
        {
          ...
          LODWORD(v13[18]) = 50331648;
          *a1 = -44;
          return (unsigned int)sub_180056454(0x40000000LL, a2, &v13[14], 0LL, 0LL, v10);
        }
      }
    }
  }
