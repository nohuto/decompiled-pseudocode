/*
 * XREFs of sub_18007AB6C @ 0x18007AB6C
 * Callers:
...
__int64 __fastcall sub_18007AB6C(__int64 a1, const void **a2, _QWORD *a3)
{
  SIZE_T v3; // r13
  __int64 *v4; // r14
  __int64 *v5; // rbx
  ...
  *(_DWORD *)(v17 + 16) = 0;
  v19 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 32LL);
  if ( !v19 )
    return 14;
