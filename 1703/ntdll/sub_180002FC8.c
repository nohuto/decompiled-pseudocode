/*
 * XREFs of sub_180002FC8 @ 0x180002FC8
 * Callers:
...
__int64 __fastcall sub_180002FC8(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v5; // rcx
  ...
  if ( (unsigned int)RtlGetCurrentServiceSessionId() )
    ...
    v5 = 2147353478LL;
  return ZwTraceEvent(*(unsigned __int8 *)v5, 1026LL, 40LL, v7);
}
