/*
 * XREFs of sub_1800D4DF8 @ 0x1800D4DF8
 * Callers:
 *     DbgUiConvertStateChangeStructure @ 0x1800D4DE0 (DbgUiConvertStateChangeStructure.c)
 *     DbgUiConvertStateChangeStructureEx @ 0x1800D4DF0 (DbgUiConvertStateChangeStructureEx.c)
 * Callees:
 *     ZwQueryInformationThread @ 0x1800A57A0 (ZwQueryInformationThread.c)
 */

__int64 __fastcall sub_1800D4DF8(__int64 a1, __int64 a2, char a3)
{
  _DWORD *v4; // rax
  __int16 v5; // ax
  __int16 v6; // ax
