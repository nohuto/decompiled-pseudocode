...
__int64 __fastcall sub_180038D24(__int64 a1, __int64 a2)
{
  __int64 v3; // rsi
  char v5; // r14
  int v6; // r15d
  ...
  if ( (dword_180155A10 & 9) != 0 )
    sub_1800D5274(
      ...
      "DLL name: %wZ\n",
      v3 + 72);
  if ( !RtlEqualUnicodeString((unsigned __int16 *)(v3 + 88), word_180110260, 1)
  ...
  if ( !v5 )
  {
    if ( qword_18015AEC0 )
    {
      v16 = *(_QWORD *)(v3 + 96);
      v17 = 0;
      LdrQueryImageFileKeyOption(qword_18015AEC0, v16, 4LL, &v17, 4, 0LL);
      if ( v17 )
      {
        if ( (int)RtlAcquirePrivilege(&unk_180125B74, 1LL, 0LL, &v18) >= 0 )
          v6 = 0x20000000;
      }
    }
  }
  ...
  *(_QWORD *)(a1 + 152) = 0LL;
  ...
  v10 = ZwMapViewOfSection(a2, -1LL, v3 + 48, 0LL, 0LL, 0LL, a1 + 152, 1, v6, 4);
