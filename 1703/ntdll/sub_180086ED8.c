/*
 * XREFs of sub_180086ED8 @ 0x180086ED8
 * Callers:
...
__int64 __fastcall sub_180086ED8(PVOID BaseOfImage, __int64 a2, __int64 a3)
{
  unsigned int v3; // ebx
  __int64 v5; // rdi
  int v6; // eax
  ...
  v8 = sub_180032C0C((unsigned __int64)BaseOfImage, 1, 5u, &v14, (char **)&v13);
  v9 = (USHORT *)v13;
  if ( v8 < 0 )
    v9 = 0LL;
  if ( !v9 )
