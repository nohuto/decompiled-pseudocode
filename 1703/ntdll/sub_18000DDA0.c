        ...
        unsigned __int64 a5)
{
  ...
  if ( *(_DWORD *)(a1 + 124) )
  {
    *(_DWORD *)(v10 + 8) ^= *(_DWORD *)(a1 + 136);
    if ( *(_BYTE *)(v10 + 11) != (*(_BYTE *)(v10 + 8) ^ (unsigned __int8)(*(_BYTE *)(v10 + 9) ^ *(_BYTE *)(v10 + 10))) )
      sub_1800FDA30(a1, v10);
  }
  v11 = *(unsigned __int16 *)(v10 + 8);
  v57 = (unsigned int)v11 + *(unsigned __int16 *)(a3 + 8);
  if ( v57 < v6 )
  {
    if ( *(_DWORD *)(a1 + 124) )
    {
  ...
  {
    sub_1800A4DFC(12, a1, (_DWORD)v12, v15, v14, 0LL);
    return 0;
  }
  *(_QWORD *)(a1 + 192) -= v11;
  v16 = *(__int64 **)(a1 + 312);
...
LABEL_28:
  ...
  *v52 = v13;
  *(_QWORD *)(v13 + 8) = v52;
  if ( (*(_BYTE *)(v10 + 10) & 8) != 0 && !(unsigned __int8)sub_180021DA4(a1, v10) )
  {
    LOBYTE(v43) = 1;
    sub_18001C798(a1, v10, *(unsigned __int16 *)(v10 + 8), v43);
    return 0;
  }
  v27 = *(_BYTE *)(v10 + 10);
  if ( (v27 & 4) != 0 )
    ...
    if ( v29 >= 0 )
    {
      if ( *(_DWORD *)(a1 + 124) )
      {
        ...
        if ( (v47 & *(_DWORD *)(a1 + 124)) != 0 )
          v53 = *(_DWORD *)(a1 + 136) ^ v47;
        v28 = v53;
      }
    }
    else
    {
      if ( *(_WORD *)(a3 + 8) ^ (unsigned __int16)(qword_18015BFE8 ^ a1 ^ (a3 >> 4)) )
        v46 = 0LL;
      else
        v46 = *(_QWORD *)(a3
                        - ((unsigned __int64)(*(_DWORD *)(a3 + 8) ^ (unsigned int)qword_18015BFE8 ^ (unsigned int)a1 ^ (unsigned int)(a3 >> 4)) >> 12));
      v28 = *(_WORD *)(v46 + 36);
    }
  ...
  {
    *(_BYTE *)(a3 + 11) = sub_1800F0F1C(a1, *(unsigned __int8 *)(a3 + 11), *(unsigned __int16 *)(a3 + 8), v6, 4);
  }
  v34 = v58;
  *(_WORD *)(a3 + 8) = v6;
  if ( v58 )
  {
    ...
    if ( v37 )
      ...
      v38 = a1;
    LOBYTE(v34) = v30;
    sub_18000E224(a1, v38, a3 + v35, v34, (*(_BYTE *)(a1 + 112) & 0x40) != 0, v6, v58);
  }
  else
  {
    *(_BYTE *)(a3 + 10) |= v30;
  ...
  if ( v5 <= v48 + v32 )
    goto LABEL_50;
  if ( ((v5 - v48 - v32) & 0xFFFFFFFFFFFFFFFCuLL) == 0 )
    goto LABEL_50;
  v49 = ((v5 - v48 - v32) & 0xFFFFFFFFFFFFFFFCuLL) >> 2;
  v50 = v48 + v32 + a3 + 16;
  if ( !v49 )
    goto LABEL_50;
  if ( (v50 & 4) == 0 )
