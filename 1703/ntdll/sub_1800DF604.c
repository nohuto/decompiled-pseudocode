/*
 * XREFs of sub_1800DF604 @ 0x1800DF604
 * Callers:
...
__int64 __fastcall sub_1800DF604(__int64 a1, int a2, unsigned int a3)
{
  int v4; // ecx
  __int64 v5; // rax
  unsigned int v6; // ecx
