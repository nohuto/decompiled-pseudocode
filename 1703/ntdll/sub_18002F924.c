...
__int64 __fastcall sub_18002F924(__int64 a1)
{
  ...
  if ( !a1 )
    return 0LL;
  sub_18002FBD4(&unk_18015A270, &unk_18015A220);
  RtlEnterCriticalSection(&unk_18015A220);
  v3 = dword_18015A254;
  if ( dword_18015A254 )
  {
    while ( v3 > 0 )
    {
      if ( *(_QWORD *)(qword_18015A248 + 48LL * --v3) == a1 )
      {
        v2 = *(_QWORD *)(qword_18015A248 + 48LL * v3 + 16);
        break;
      }
    }
  }
