/*
 * XREFs of RtlCreateUserStack @ 0x180085920
 * Callers:
 *     <none>
 * Callees:
        ...
        PINITIAL_TEB InitialTeb)
{
  ...
  SIZE_T MinimumStackCommit; // [rsp+40h] [rbp-68h]
  ...
  if ( result >= 0 )
  {
    ...
    if ( v22 < 0
      || (v23 = (char *)BaseAddress, v19->StackLimit = BaseAddress, v21 >= v9)
      && (BaseAddress = &v23[-v9],
          v25 = v9,
