/*
 * XREFs of sub_18006CA0C @ 0x18006CA0C
 * Callers:
...
__int64 __fastcall sub_18006CA0C(__int64 a1)
{
  int v1; // r8d
  struct _TEB *v4; // rcx
  ...
  if ( !NtCurrentTeb()->UserPrefLanguages || !*(_QWORD *)NtCurrentTeb()->UserPrefLanguages )
  {
    if ( a1 )
    {
      v1 = sub_18006DBCC(a1, 1, (unsigned int)&v26, 3, 0);
      if ( v1 >= 0 )
      {
        v4 = NtCurrentTeb();
        ...
        if ( !MuiImpersonation )
          v1 = sub_18006CFF8(8LL, &v27, a1);
        if ( v1 >= 0 )
        {
          v12 = v26;
          *(_DWORD *)(v26 + 40) |= 0x10u;
          v1 = sub_18006EA40(v12, 0LL, 4LL);
          if ( v1 >= 0 && v27 )
