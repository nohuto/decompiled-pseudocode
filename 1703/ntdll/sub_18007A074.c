/*
 * XREFs of sub_18007A074 @ 0x18007A074
 * Callers:
...
__int64 __fastcall sub_18007A074(_BYTE *a1, unsigned int a2, __int64 a3, unsigned int a4, unsigned int *a5, __int64 a6)
{
    ...
    while ( 2 )
    {
      while ( 1 )
      {
        ...
        *(_QWORD *)(v18 + 16 * v19) = v16;
        ...
        {
          v32 = 2
              * ((unsigned __int8)__ROR1__(v16[1] ^ __ROL1__(*v22 + *v16, 3), 1)
...
LABEL_38:
        ...
        if ( (unsigned __int64)v16 >= v49 )
        {
          if ( (unsigned __int64)v16 < v10 )
          {
            v11 = sub_180103834(v44, v7 - 38, v16);
            v49 = v11;
            goto LABEL_42;
          }
LABEL_80:
