/*
 * XREFs of sub_1800E9278 @ 0x1800E9278
 * Callers:
...
char __fastcall sub_1800E9278(unsigned int *a1, unsigned int a2)
{
  unsigned int v4; // eax
  int v5; // r11d
  unsigned int v6; // ecx
  ...
  if ( a1 )
  {
    if ( a2 >= 0x14 && !*((_WORD *)a1 + 3) && (a1[2] & 0xFFC0) == 0 )
    {
      if ( a1[3] )
      {
        ...
        {
          v4 = a2 - *a1;
          if ( v4 >= 4 && (int)sub_180058198((unsigned int *)((char *)a1 + *a1), v4, &v20) >= 0 )
          {
            v6 = a1[3];
            v7 = 4LL * v6;
                    ...
                    if ( v6 )
                    {
                      while ( 1 )
                      {
                        ...
                        if ( a2 < (unsigned int)v17
                          ...
                          || (int)sub_180058198((unsigned int *)((char *)a1 + v17), a2 - (unsigned int)v17, &v20) < 0 )
                        {
                          break;
                        }
                        if ( ++v16 >= a1[3] )
