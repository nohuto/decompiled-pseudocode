/*
 * XREFs of sub_1800F6ECC @ 0x1800F6ECC
 * Callers:
 ...
 *     sub_1800F6DD8 @ 0x1800F6DD8 (sub_1800F6DD8.c)
 */

char __fastcall sub_1800F6ECC(unsigned __int16 *a1, unsigned __int16 *a2, char a3, __int64 a4)
{
  ...
  if ( sub_1800F6DD8((unsigned __int16 *)v56) )
  {
    v8 = a1;
    v10 = 0;
LABEL_17:
