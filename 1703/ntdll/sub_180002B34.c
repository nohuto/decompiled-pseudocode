/*
 * XREFs of sub_180002B34 @ 0x180002B34
 * Callers:
 ...
 *     sub_1800F81B4 @ 0x1800F81B4 (sub_1800F81B4.c)
 */

__int64 __fastcall sub_180002B34(__int64 a1, unsigned __int16 *a2, int a3, _BYTE *a4)
{
...
LABEL_48:
            if ( (v11 & 0x80) != 0 )
            {
              sub_1800F81B4(a1, (_DWORD)v5, (unsigned int)&v28, (unsigned int)&v24, (__int64)&v20, (__int64)&v29);
              v14 = v20;
              if ( !v20 || v20 == 63 )
              {
                v26 = v24;
                ...
                if ( ((v29 - 64) & 0xBF) != 0 || v12 != 0xC0 )
                  goto LABEL_95;
                v17 = sub_1800F7F4C(a1, v24, (unsigned int)v7);
                goto LABEL_88;
              }
              v12 = v29;
              if ( (v29 & 0xBF) != 0 )
              {
                ...
                if ( ((((v21 | v22) - 64) & 0xBF) == 0 || v22 == 64 && (!v21 || v21 == 63))
                  && (unsigned int)sub_1800F7F4C(a1, v26, (unsigned int)v7) )
                {
                  goto LABEL_89;
                }
                ...
                {
LABEL_69:
                  v17 = sub_1800F80DC(a1, (unsigned int)&v27, (unsigned int)&v25, v26, v7);
                  goto LABEL_88;
                }
                v17 = sub_1800F8098(a1, &v25, v26, (unsigned int)v7);
LABEL_88:
                if ( v17 )
                  goto LABEL_89;
                goto LABEL_95;
              ...
              if ( v29 == 64 )
              {
                if ( (unsigned int)sub_1800F7F4C(a1, v24, (unsigned int)v7) )
                  goto LABEL_89;
                v18 = v26;
              }
              if ( v14 <= v13 )
...
LABEL_98:
              ...
              {
LABEL_79:
                v19 = sub_1800F80DC(a1, (unsigned int)&v27, (unsigned int)&v25, v18, v7);
                goto LABEL_83;
              }
              v19 = sub_1800F8098(a1, &v25, v18, (unsigned int)v7);
LABEL_83:
              if ( v19 )
                goto LABEL_89;
              goto LABEL_84;
...
LABEL_93:
          ...
          if ( v11 != 127 )
          {
            switch ( v11 )
            {
              ...
              case 0xC0u:
                sub_1800F81B4(a1, (_DWORD)v5, (unsigned int)&v28, (unsigned int)&v24, (__int64)&v20, (__int64)&v29);
                if ( (v20 | v29) == 0x80 && (unsigned int)sub_1800F7F4C(a1, v24, (unsigned int)v7) )
                  goto LABEL_89;
                goto LABEL_93;
              case 0xFFu:
                if ( (_DWORD)v7 || a3 > 1 )
...
LABEL_97:
      ...
      if ( a3 > 1 )
      {
        if ( (unsigned __int8)sub_1800F7674((unsigned int)v7, v5[1]) )
          goto LABEL_89;
        a3 = v30;
      }
