/*
 * XREFs of sub_180102330 @ 0x180102330
 * Callers:
        ...
        __int64 a8)
{
  ...
  for ( i = a2; ; v10 = i < *(_QWORD *)(a2 + 72) )
  {
    ...
    *a6 = i;
    if ( *((_DWORD *)BaseAddress + 31) != (_DWORD)v8 )
    {
      *(_DWORD *)(i + 8) ^= *((_DWORD *)BaseAddress + 34);
      if ( *(_BYTE *)(i + 11) != (*(_BYTE *)(i + 8) ^ (unsigned __int8)(*(_BYTE *)(i + 9) ^ *(_BYTE *)(i + 10))) )
      {
        sub_1800FDA30((__int64)BaseAddress, i);
        v8 = 0LL;
      }
    }
    ...
    if ( (v17 & 1) != 0 )
    {
      ...
      if ( a7 )
      {
        v20 = (v17 & 2) != 0 ? *(_WORD *)(sub_1800774AC(i) + 2) : *(unsigned __int8 *)(i + 11);
        if ( v20 )
        {
          if ( (v20 & 0x8000u) == 0 )
          {
            if ( (v20 & 0x800) == 0 && v20 < *((_WORD *)BaseAddress + 112) )
      ...
      if ( (*(_BYTE *)(i + 10) & 4) != 0 )
      {
        v22 = sub_18006128C((__int64)BaseAddress, i);
        v8 = 0LL;
        if ( !v22 )
        {
          v23 = *((_DWORD *)BaseAddress + 31) == 0;
          goto LABEL_118;
        }
      }
    }
    ...
    {
      if ( ((v17 >> 2) & ((BaseAddress[14] & 0x40) != 0)) != 0 )
      {
        v24 = v18 - 32;
        if ( (v17 & 2) != 0 && v24 > 4 )
          v24 = v18 - 36;
        if ( (v17 & 8) != 0 )
        {
          ...
          if ( *v25 == v29 && (_QWORD *)v28 == v26 )
          {
            ...
            if ( v30 )
            {
              ...
              v33 = *(_DWORD *)(v30 + 8) - 1;
LABEL_35:
              sub_18002F7E0((__int64)BaseAddress, v30, 1, (__int64 *)(i + 16), v33, *(unsigned __int16 *)(i + 8));
              v8 = 0LL;
            }
            *v25 = v27;
            *(_QWORD *)(v27 + 8) = v25;
            if ( (*(_BYTE *)(i + 10) & 8) != 0 )
            {
              v34 = sub_180021DA4(BaseAddress, i);
              v8 = 0LL;
              if ( !v34 )
              {
                sub_18001C798(BaseAddress, i, *(unsigned __int16 *)(i + 8), 1);
                goto LABEL_39;
              }
            }
            v35 = *(unsigned __int16 *)(i + 8);
            v36 = (_QWORD **)(BaseAddress + 42);
            *(_BYTE *)(i + 10) = (_BYTE)v8;
            *(_BYTE *)(i + 15) = (_BYTE)v8;
            ...
            {
              v37 = (_QWORD *)sub_18000E6BC((__int64)BaseAddress, (unsigned int)v35);
              v8 = 0LL;
            }
            if ( v36 != v37 )
            {
            ...
            {
              sub_1800A4DFC(12, 0LL, (__int64)v37, 0LL, *v41, (__int64)v8);
              v8 = 0LL;
            }
            BaseAddress[24] += *(unsigned __int16 *)(i + 8);
            v42 = BaseAddress[39];
            if ( v42 )
            {
              ...
              v45 = *(_DWORD *)(v42 + 8) - 1;
LABEL_64:
              sub_18000E614((__int64)BaseAddress, v42, 1, i + 16, v45, *(unsigned __int16 *)(i + 8));
              v8 = 0LL;
            }
            if ( *((_DWORD *)BaseAddress + 31) != (_DWORD)v8 )
            {
          ...
          {
            sub_1800A4DFC(12, (__int64)BaseAddress, i + 16, v29, v28, (__int64)v8);
LABEL_39:
            v8 = 0LL;
          }
          v9 = a4;
    ...
    v48 = *(_BYTE *)(i + 14);
    if ( v48 )
      v49 = (_QWORD *)((i & 0xFFFFFFFFFFFF0000uLL) - ((unsigned __int64)v48 << 16) + 0x10000);
    else
      v49 = BaseAddress;
    if ( v49 != (_QWORD *)a2 )
    {
