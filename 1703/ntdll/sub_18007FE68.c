...
__int64 sub_18007FE68()
{
  ...
  if ( (unsigned __int16)(*(_WORD *)(v17 + 92) - 2) > 1u )
    return 0LL;
  if ( (int)ZwOpenKey(&v14, 3LL, &unk_1801107B0) < 0
    || (v4 = ZwQueryValueKey(v14, &unk_180111388, 2LL, v30, 80, &v16), ZwClose(v14), v4 < 0)
    || v31 != 4
    || v32 != 4
    || !v33 )
  {
    v10 = 0LL;
    v1 = 0;
    if ( (int)ZwOpenKey(&v10, 131097LL, &unk_1801555E0) >= 0 )
    {
    ...
    if ( (int)ZwOpenKey(&v9, 1LL, &unk_180110780) >= 0 )
    {
    ...
    if ( (int)RtlFormatCurrentUserKeyPath(&UnicodeString) >= 0 )
    {
      ...
      if ( v2 <= 0xFFFE )
      {
        ...
        Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18015B268 + 1572864, (unsigned __int16)v2);
        if ( Heap )
        {
      ...
      {
LABEL_27:
        if ( (int)LdrLoadDll(0LL, 0LL, (__int64)&unk_180111368, &v15) >= 0 )
        {
          v7 = v15;
          if ( (int)LdrGetProcedureAddressForCaller(v15, &qword_180111398, 0, &v11, 0, retaddr) >= 0 && v11 )
          {
            qword_18015AF80 = __ROR8__(v11 ^ MEMORY[0x7FFE0330], MEMORY[0x7FFE0330] & 0x3F);
            qword_18015C3C8 = v7;
          }
          else
          {
