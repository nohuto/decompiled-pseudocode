/*
 * XREFs of sub_180064FE0 @ 0x180064FE0
 * Callers:
 *     RtlUnicodeToUTF8N @ 0x180064CD0 (RtlUnicodeToUTF8N.c)
 * Callees:
 *     <none>
 */

__int64 __fastcall sub_180064FE0(unsigned int *a1, unsigned int a2, unsigned int *a3)
{
