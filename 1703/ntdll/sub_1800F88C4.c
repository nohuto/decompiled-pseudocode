/*
 * XREFs of sub_1800F88C4 @ 0x1800F88C4
 * Callers:
...
void __fastcall sub_1800F88C4(__int64 a1, _OWORD *a2)
{
  ...
  if ( qword_18015C418 )
  {
    v4 = dword_180159A10;
    v7 = dword_180159A10;
    v6 = _InterlockedCompareExchange(&dword_180159A10, (dword_180159A10 + 1) % 0x32u, dword_180159A10);
    for ( i = v7 == v6; ; i = v6 == v8 )
    {
      v8 = v6;
      if ( i )
        break;
      v4 = v6;
      v6 = _InterlockedCompareExchange(&dword_180159A10, (v6 + 1) % 0x32u, v6);
    }
    v9 = 1424LL * v4;
    i = qword_18015C418 + v9 == 0;
    v10 = qword_18015C418 + v9;
