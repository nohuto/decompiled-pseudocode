/*
 * XREFs of CsrClientCallServer @ 0x18000AFE0
 * Callers:
 *     sub_18000AEF4 @ 0x18000AEF4 (sub_18000AEF4.c)
 * Callees:
 *     ZwRequestWaitReplyPort @ 0x1800A5740 (ZwRequestWaitReplyPort.c)
  ...
  *(_DWORD *)a1 = (a4 | (a4 << 16)) + 4194328;
  ...
  else
  {
    if ( byte_18015BA58 )
    {
      ...
      {
        v9 = qword_18015BA80;
        *(_QWORD *)(a1 + 40) = qword_18015BA80 + a2;
        v10 = *(_DWORD *)(a2 + 16);
        *(_QWORD *)(a2 + 24) = 0LL;
        v11 = (_QWORD **)(a2 + 32);
        while ( v10 )
      ...
      v13 = ZwRequestWaitReplyPort(qword_18015BA88, a1, a1);
      if ( a2 )
      {
        v14 = qword_18015BA80;
        v15 = (__int64 *)(a2 + 32);
        *(_QWORD *)(a1 + 40) -= qword_18015BA80;
    ...
    else
    {
      *(struct _CLIENT_ID *)(a1 + 8) = NtCurrentTeb()->ClientId;
      v13 = ((__int64 (__fastcall *)(__int64, __int64))qword_18015BA50)(a1, a1);
    }
    if ( v13 < 0 )
      *(_DWORD *)(a1 + 52) = v13;
