...
unsigned __int64 sub_180089C50()
{
  USHORT v0; // r15
  ULONG v1; // r13d
  ...
  v3 = v1 & 0xF;
  RtlAcquireSRWLockExclusive(*(volatile signed __int64 **)(qword_18015C3F0 + 8 * v3));
  v4 = qword_18015C440;
...
LABEL_6:
    if ( Heap )
    {
      ...
      *(_QWORD *)v8 = Heap;
      ...
      RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_18015C3F0 + 8 * v3));
      return Heap;
    }
    else
    {
