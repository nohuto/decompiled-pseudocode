/*
 * XREFs of sub_18007BB68 @ 0x18007BB68
 * Callers:
...
_QWORD *__fastcall sub_18007BB68(__int64 a1, _QWORD **a2)
{
  _QWORD *v4; // rdi
  _QWORD *v5; // rbp
  __int64 v6; // rcx
      ...
      else
      {
        ...
        if ( v18 )
        {
          ...
          *v31 = *v32;
          ...
          --*(_DWORD *)(v22 + 24);
          result = (_QWORD *)RtlFreeHeap(qword_18015B328, 0, (unsigned __int64)v21);
        }
        else
        {
          *v21 = v21;
  ...
  for ( j = *v23; ; j = *v24 )
  {
    if ( j[1] == a1 )
    {
      *v24 = (_QWORD *)*j;
      ...
      --*(_DWORD *)(a1 + 24);
      result = (_QWORD *)RtlFreeHeap(qword_18015B328, 0, (unsigned __int64)(j - 2));
    }
    else
    {
      v24 = (_QWORD **)j;
...
LABEL_50:
        --*(_DWORD *)(a1 + 24);
        result = (_QWORD *)RtlFreeHeap(qword_18015B328, 0, (unsigned __int64)v30);
      }
      else
      {
LABEL_66:
