/*
 * XREFs of sub_1800ED3D0 @ 0x1800ED3D0
 * Callers:
...
bool __fastcall sub_1800ED3D0(const WCHAR *a1, _QWORD *a2, PVOID *a3)
{
  _QWORD *v4; // r13
  bool v5; // r14
  ...
  *a3 = 0LL;
  if ( RtlDosPathNameToRelativeNtPathName_U(a1, &NtFileName, 0LL, &RelativeName) )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    v11 = ZwOpenFile(&FileHandle, 0x100001u, &ObjectAttributes, &IoStatusBlock, 5u, 0x21u);
