/*
 * XREFs of sub_18006BCFC @ 0x18006BCFC
 * Callers:
 *     sub_18006BBAC @ 0x18006BBAC (sub_18006BBAC.c)
 * Callees:
 *     sub_18006BE6C @ 0x18006BE6C (sub_18006BE6C.c)
 *     memset @ 0x1800ABDC0 (memset.c)
 */

__int64 __fastcall sub_18006BCFC(__int64 a1, unsigned __int16 *a2, unsigned __int64 a3, _DWORD *a4)
{
  char v4; // ch
  char v7; // si^1
