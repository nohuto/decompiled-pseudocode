...
__int64 sub_18003C49C()
{
  ...
  v23 = 0LL;
  LdrGetDllHandleByName(&unk_1801108D0, 0LL, &v23);
  v0 = sub_180032C0C(v23, 1, 0xDu, &v22, &v24);
  v1 = v24;
  if ( v0 < 0 )
    v1 = 0LL;
  v24 = v1;
    ...
    do
    {
      ...
      if ( !strnicmp(v8, "EXT-", 4uLL) )
      {
        ...
        if ( v9 > UnicodeString.MaximumLength )
        {
          ...
          UnicodeString.Buffer = (wchar_t *)sub_180043FE0(v9);
        ...
        if ( v12 && !(unsigned int)RtlCompareUnicodeStrings(L"KERNEL32.DLL", 0xCuLL, v20, (unsigned __int64)v11 >> 1, 1) )
        {
          v14 = sub_18003A2D4(v23, v6 + 32LL * v5);
          Buffer = UnicodeString.Buffer;
          v3 = v14;
          if ( v14 < 0 )
            break;
