        ...
        int *a8)
{
  ...
  _BYTE v17[528]; // [rsp+30h] [rbp-258h] BYREF
...
LABEL_17:
  ...
  result = sub_1800E2D04(a2, v14, v16, 2LL);
  if ( (int)result >= 0 )
  {
    if ( (unsigned __int64)v16[0] + 3 > 0x104 )
      return (unsigned int)-1073741701;
    result = sub_1800E2D04(a2, v14, v17, 2 * (unsigned int)v16[0] + 2);
    v10 = result;
    if ( (int)result >= 0 )
    {
