/*
 * XREFs of sub_1800A28A4 @ 0x1800A28A4
 * Callers:
...
__int64 __fastcall sub_1800A28A4(__int64 a1, unsigned __int8 *a2, _DWORD *a3)
{
  int v3; // r13d
  ...
  while ( 2 )
  {
    if ( (off_180155000[v9] & 8) != 0 )
    {
      --v10;
      while ( 1 )
      {
        v58 = ++v10;
        v11 = sub_1800A287C(v6);
        if ( v11 == -1 )
          break;
        v6 = a1;
        if ( (off_180155000[(unsigned __int8)v11] & 8) == 0 )
        {
          sub_18009FCF4(v11, a1);
          v3 = 0;
          goto LABEL_12;
        }
      }
              ...
              if ( v63 )
              {
                if ( !v29 )
                {
                  while ( 1 )
                  {
                    ...
                    {
                      if ( (off_180155000[(unsigned __int8)v5] & 4) == 0 )
                        goto LABEL_134;
                      if ( v30 == 111 )
                      {
                        if ( v5 >= 56 )
                    ...
                    {
                      v39 = off_180155000[(unsigned __int8)v5];
                      if ( (v39 & 0x80u) == 0 )
                      {
LABEL_134:
                        v58 = --v10;
              ...
              else
              {
                if ( !v29 )
                {
                  while ( 1 )
                  {
                    ...
                    {
                      v45 = off_180155000[(unsigned __int8)v5];
                      if ( (v45 & 0x80u) == 0 )
                      {
LABEL_154:
                        v58 = --v10;
...
LABEL_169:
        ...
        if ( v30 == 123 )
        {
          v52 = sub_1800A272C(v51, &v73, &v59, &v58, (_WORD **)&v70, v13, v27, v26, &v65);
          v4 = v73;
        }
        else
        {
          v52 = sub_1800A2584(v51, 0LL, &v59, &v58, (_WORD **)&v70, v13, v27, v26, &v65);
        }
        v5 = v59;
        if ( v52 )
          goto LABEL_190;
...
LABEL_97:
  ...
  else
  {
    ...
    while ( (off_180155000[(unsigned __int8)v5] & 8) != 0 );
    v58 = v10;
    v59 = v5;
  }
  if ( v5 != -1 )
