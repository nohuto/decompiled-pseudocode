/*
 * XREFs of RtlpMergeSecurityAttributeInformation @ 0x180088080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlpMergeSecurityAttributeInformation(
        unsigned __int16 *a1,
        __int64 a2,
        unsigned __int64 *a3,
        char a4)
...
LABEL_27:
  ...
  Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18015B268 + 1310720, v11);
  if ( !Heap )
  {
    v8 = -1073741801;
    goto LABEL_76;
...
LABEL_11:
    if ( a2 )
    {
      if ( v5 )
      {
        ...
        {
          if ( *v15 == 18 && (v15[1] & 0x10) == 0 && !(unsigned __int8)sub_1800E8CE4(v15, Heap, 0LL, v27) )
          {
    ...
    if ( a1 )
    {
      ...
      {
        if ( *j == 18 && (j[1] & 0x10) != 0 && !(unsigned __int8)sub_1800E8CE4(j, Heap, 0LL, v27) )
        {
          if ( a2 )
            v26 = sub_1800E8CE4(j, a2, 1LL, v27);
          else
            v26 = 0;
          if ( v26 && v27[0] )
          {
            *(_WORD *)(Heap + 2) += *((_WORD *)j + 1);
...
LABEL_10:
  ...
  while ( 1 )
  {
    if ( *(_BYTE *)v13 != 18 || (*((_BYTE *)v13 + 1) & 0x10) != 0 || (unsigned __int8)sub_1800E8CE4(v13, Heap, 0LL, v27) )
      goto LABEL_49;
    if ( !a2 || a4 )
    {
      v25 = 0;
    ...
    {
      LOBYTE(v24) = 1;
      v25 = sub_1800E8CE4(v13, a2, v24, v27);
    }
    if ( v25 && v27[0] )
    {
      *(_WORD *)(Heap + 2) += v13[1];
