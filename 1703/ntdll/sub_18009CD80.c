/*
 * XREFs of sub_18009CD80 @ 0x18009CD80
 * Callers:
 ...
 *     sub_18009FB48 @ 0x18009FB48 (sub_18009FB48.c)
 *     sub_18009FC7C @ 0x18009FC7C (sub_18009FC7C.c)
 */

__int64 __fastcall sub_18009CD80(__int64 a1, char *a2, __int64 a3, unsigned int *a4)
{
  int *v5; // r11
  __int64 v6; // r10
  int v7; // edi
  ...
  _BYTE v62[4]; // [rsp+58h] [rbp-A8h] BYREF
  unsigned __int16 v63; // [rsp+5Ch] [rbp-A4h] BYREF
  ...
  _WORD v70[64]; // [rsp+80h] [rbp-80h] BYREF
    ...
    if ( v12 )
    {
      ...
      do
      {
        ...
        if ( (unsigned __int16)(v12 - 32) > 0x58u )
          ...
          v16 = byte_180118FC0[v12 - 32] & 0xF;
        v17 = byte_180118FC0[8 * v16 + v67] >> 4;
        v67 = v17;
        if ( !v17 )
          goto LABEL_163;
        v18 = v17 - 1;
              ...
              if ( v12 > 0x69u )
              {
                switch ( v12 )
                {
                  case 'n':
                    ...
                    v59 = (unsigned int *)(v5 + 2);
                    if ( !(unsigned int)sub_18009FB48((unsigned int)v12 - 110, v9) )
                      goto LABEL_186;
                    if ( (v7 & 0x20) != 0 )
                      *v43 = v13;
                    else
...
LABEL_123:
                              v45 = v58 - v14 - v44;
                              if ( (v7 & 0xC) == 0 )
                                sub_18009D6AC(32LL, v45, v61, &v57);
                              sub_18009D700(v64, v44, v61, &v57);
                              v46 = v61;
                              if ( (v7 & 0xC) == 8 )
                                sub_18009D6AC(48LL, v45, v61, &v57);
                              if ( v60 || (int)v14 <= 0 )
                              {
                                sub_18009D700(v15, (unsigned int)v14, v46, &v57);
LABEL_137:
                                v13 = v57;
                              }
                              else
                              {
                                ...
                                {
                                  --v48;
                                  v49 = sub_18009FC7C(&v63, v47, dword_180155E94);
                                  v50 = v49;
                                  if ( v49 == 2 )
                                    --v48;
                                  if ( v49 <= 0 )
                                    break;
                                  sub_18009D660(v63, v61, &v57);
                                  v47 += v50;
                                  if ( v48 <= 0 )
                                  {
                                    v46 = v61;
                              ...
                              if ( v13 >= 0 && (v7 & 4) != 0 )
                              {
                                sub_18009D6AC(32LL, v45, v46, &v57);
                                v13 = v57;
                              }
                              a2 = v68;
                              v10 = v56;
...
LABEL_52:
                    ...
                    if ( (v7 & 0x20) != 0 )
                    {
                      v62[0] = v29;
                      v62[1] = 0;
                      if ( (int)sub_18009FC7C(v70, v62, dword_180155E94) < 0 )
                        v65 = 1;
                    }
                    else
                    {
