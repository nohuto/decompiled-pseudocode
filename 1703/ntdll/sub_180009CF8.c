...
__int64 __fastcall sub_180009CF8(__int64 a1, __int64 a2, _DWORD *a3)
{
  int v6; // eax
  __int64 result; // rax
  ...
  RtlRbRemoveNode(a1 + 8, a3 + 2);
  v6 = sub_180009D5C(a3, a2, &v8, &v9);
  result = v8 - (unsigned int)(unsigned __int16)((unsigned __int16)a3 ^ qword_18015BFA8 ^ *a3) + v6;
  *(_QWORD *)(a1 + 48) -= result;
  return result;
}
