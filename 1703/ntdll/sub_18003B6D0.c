/*
 * XREFs of sub_18003B6D0 @ 0x18003B6D0
 * Callers:
...
__int64 __fastcall sub_18003B6D0(
        char *a1,
        unsigned __int16 *a2,
        __int64 a3,
        _WORD *a4,
        ...
        v15 = v14 > 0x7Au
            ? (unsigned __int16)(v14
                               + *(_WORD *)(v10
                                          + 2
                                          * ((v14 & 0xF)
                                           + (unsigned __int64)*(unsigned __int16 *)(v10
                                                                                   + 2LL
