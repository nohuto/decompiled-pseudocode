...
__int64 __fastcall sub_180004ED8(int a1, int a2, int a3, __int64 a4, __int64 *a5, int a6)
{
  ...
  v10 = 0LL;
  v14 = sub_18003AB88(a1, a2, (unsigned int)&v15, a6, (__int64)a5);
  v11 = v14;
  if ( v14 >= 0 )
  {
    if ( byte_18015BF54 )
      ...
      v12 = 0LL;
    v10 = sub_180004F9C(a1, v15, a2, (_DWORD)a5, v12, (__int64)&v14);
    sub_18003015C(v15);
    v11 = v14;
  }
  if ( v11 >= 0
    || (v10 = sub_1800845DC(a1, v15, a2, a3, a4, (__int64)a5, v11)) != 0
