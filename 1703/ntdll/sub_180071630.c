/*
 * XREFs of sub_180071630 @ 0x180071630
 * Callers:
...
unsigned __int64 __fastcall sub_180071630(volatile signed __int64 *a1, unsigned __int64 a2, int a3)
{
...
LABEL_9:
  ...
  if ( v20 )
  {
    do
    {
      ...
      {
        if ( !*((_QWORD *)v20 + 5) || (result = sub_18007177C(), !(_BYTE)result) )
        {
