...
NTSTATUS __cdecl RtlAcquirePrivilege(PULONG Privilege, ULONG NumPriv, ULONG Flags, PVOID *ReturnedState)
{
  ...
  if ( (Flags & 2) == 0 )
    v7 = Flags;
  Heap = (char *)RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, dword_18015B268 + 1310720, 12 * (NumPriv - 1 + 90LL));
  v9 = Heap;
  if ( !Heap )
    return -1073741801;
  *(_QWORD *)Heap = 0LL;
  ...
  *((_DWORD *)Heap + 8) = 0;
  ...
  {
    v11 = sub_18007F8E0(0x28u, (PHANDLE)Heap);
    if ( v11 >= 0 )
    {
LABEL_9:
      if ( *(_QWORD *)v9 )
