...
__int64 __fastcall sub_18003B41C(_QWORD *a1, int a2, __int64 a3, _WORD *a4, unsigned __int64 a5, unsigned __int64 *a6)
{
  __int64 v9; // r12
...
LABEL_5:
    if ( v12 == 3 )
    {
      Environment = *(void **)&dword_18015BAC0[v9 - 2];
    }
    else
    {
      Environment = (void *)qword_18015BF20;
      if ( !qword_18015BF20 )
