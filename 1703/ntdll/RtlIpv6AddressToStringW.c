...
PWSTR __stdcall RtlIpv6AddressToStringW(const struct in6_addr *Addr, PWSTR S)
{
  ...
  if ( !*(_DWORD *)Addr->u.Byte && !Addr->u.Word[2] && !Addr->u.Word[3] && Addr->u.Word[6] )
  {
    ...
    if ( Addr->u.Word[4] == 0xFFFF && !Addr->u.Word[5] )
    {
      ...
      v24 = Addr->u.Byte[14];
      v21 = Addr->u.Byte[13];
      v19 = swprintf_s(S, 0x2EuLL, L"::ffff:0:%u.%u.%u.%u", Addr->u.Byte[12], v21, v24, v27);
      return &v5[v19];
    }
  }
  v7 = 0;
  ...
  do
  {
    if ( v4 >= v13 || v15 > v4 )
    {
      ...
      v16 = swprintf_s(v5, v3 - v5, L"%x", (unsigned __int16)__ROR2__(Addr->u.Word[v4], 8));
    }
    else
    {
  ...
  if ( v2 < 8 )
  {
    ...
    v25 = Addr->u.Byte[14];
    v22 = Addr->u.Byte[13];
    v5 += swprintf_s(v5, v3 - v5, L":%u.%u.%u.%u", Addr->u.Byte[12], v22, v25, v28);
  }
  return v5;
}
