/*
 * XREFs of sub_180084014 @ 0x180084014
 * Callers:
...
__int64 __fastcall sub_180084014(
        char a1,
        __int64 a2,
        ...
        int a8)
{
  ...
  *(_QWORD *)(a2 + 40) = v12;
  ...
  if ( (a1 & 4) == 0 )
    return 0LL;
  result = sub_1800183AC(0, (__int64)a3, a4, (const char **)&v21);
  if ( (int)result >= 0 )
  {
    v14 = v21;
    if ( !v21 )
    ...
    *(_QWORD *)(a2 + 72) = &v21[*(unsigned int *)&v21[24 * *(unsigned int *)(a2 + 64)
    ...
    result = sub_18003FB50(v14, 0LL, 1u, v20, &v21);
    if ( (int)result >= 0 )
    {
      v15 = v20[0];
