...
__int64 __fastcall sub_1800953D0(__int64 a1, _QWORD **a2)
{
  char *v5; // rdi
  _QWORD *v6; // rax
  __int16 v7; // ax
  ...
  switch ( *(_DWORD *)a1 )
  {
    case 2:
      ...
      *((_DWORD *)a2 + 4) = v14 + 1;
      ...
      return 0LL;
    case 3:
      v12 = RtlCommitDebugInfo_0(*a2, 0x20u);
      if ( v12 )
      {
        v13 = a2[3];
        if ( !v13[10] )
        ...
        ++*((_DWORD *)a2[3] + 9);
        *((_WORD *)v12 + 4) = 2;
        *((_QWORD *)v12 + 3) = *(_QWORD *)(a1 + 16);
        *(_QWORD *)v12 = *(_QWORD *)(a1 + 24);
        *((_QWORD *)v12 + 2) = *(_QWORD *)(a1 + 32);
        return 0LL;
      }
      break;
    case 4:
      if ( *(_DWORD *)(a1 + 32) != 2 )
        return 0LL;
      v10 = RtlCommitDebugInfo_0(*a2, 0x20u);
      if ( v10 )
      {
        v11 = a2[3];
        if ( !v11[10] )
    ...
    default:
      if ( *(_DWORD *)a1 != 5 || ((*a2)[8] & 0x10) == 0 )
        return 0LL;
      v5 = RtlCommitDebugInfo_0(*a2, 0x20u);
      if ( v5 )
      {
        v6 = a2[3];
        if ( !v6[10] )
