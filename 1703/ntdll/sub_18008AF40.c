/*
 * XREFs of sub_18008AF40 @ 0x18008AF40
 * Callers:
 *     <none>
 * Callees:
 *     sub_18008B464 @ 0x18008B464 (sub_18008B464.c)
 */

__int64 __fastcall sub_18008AF40(_BYTE *a1, int a2, unsigned __int8 *a3, int a4, int a5, _DWORD *a6, __int64 a7)
{
...
LABEL_72:
    ...
    if ( !(unsigned int)sub_18008B464(v9, v7) )
    {
      v13 = v10 + 0x10000;
...
LABEL_54:
          ...
          v36 = *(_WORD *)(v9 + 2 * ((unsigned __int64)v18 >> 22) + 1056);
          if ( v36 <= 0 )
          {
            v18 <<= 10;
            v15 -= 10LL;
            ...
            {
              --v15;
              v40 = (unsigned __int64)v18 >> 31;
              v18 *= 2;
              v36 = *(_WORD *)(v9 + 2LL * (__int16)(v40 - v36) + 3104);
            }
            while ( v36 <= 0 );
          }
          else
...
LABEL_58:
        ...
        v25 = v35 + 3;
        v26 = (1LL << v34) + ((unsigned __int64)v18 >> (31 - (unsigned __int8)v34) >> 1);
        v18 <<= v34;
        v15 -= v34;
        if ( v15 < 0 )
        {
