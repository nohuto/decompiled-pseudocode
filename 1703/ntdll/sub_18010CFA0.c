...
__int64 __fastcall sub_18010CFA0(_QWORD *a1, __int64 a2)
{
  unsigned int v4; // esi
  __int64 Heap; // rax
  unsigned int *v7; // rdi
  ...
  if ( !a1[1] )
  {
    Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18015C4D8 + 786432, 4096LL);
    a1[1] = Heap;
    if ( !Heap )
    {
...
LABEL_31:
    ...
    *(_DWORD *)(a2 + 32) = v7[10];
    ...
    if ( *((_BYTE *)v7 + 68) <= 0x1Cu )
    {
      memmove((void *)(a2 + 564), (char *)v7 + 70, *((char *)v7 + 68));
