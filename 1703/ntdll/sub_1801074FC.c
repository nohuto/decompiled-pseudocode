/*
 * XREFs of sub_1801074FC @ 0x1801074FC
 * Callers:
 ...
 *     ZwQueryObject @ 0x1800A5500 (ZwQueryObject.c)
 *     ZwDuplicateObject @ 0x1800A5A80 (ZwDuplicateObject.c)
 *     _guard_dispatch_icall_nop @ 0x1800A8C20 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1800ABDC0 (memset.c)
 */

__int64 __fastcall sub_1801074FC(
        __int64 a1,
        unsigned int *a2,
        unsigned int a3,
        char a4,
...
LABEL_19:
    ...
    if ( (a4 & 0x20) != 0 )
    {
      v15 = (const wchar_t **)&off_1801112B0;
      ...
      v16 = 3LL * v7;
      if ( ((int (__fastcall *)(__int64, _BYTE *, __int64, int *, _QWORD, _DWORD, int))*(&off_1801112B0 + v16 + 1))(
             v18,
             v25,
             64LL,
             &v17,
