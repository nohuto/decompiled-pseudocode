        ...
        PTP_CALLBACK_ENVIRON CallbackEnviron)
{
  ...
  {
    sub_1801058B8(WorkReturn, Callback);
    return -1073741811;
  }
  else
  {
    *v7 = 0LL;
    Heap = (_TP_WORK *)RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, (dword_18015C000 + 0x200000) | 8, 0xF0uLL);
    v10 = Heap;
    BaseAddress = Heap;
    if ( Heap )
    {
      *((_QWORD *)Heap + 22) = retaddr;
      v11 = sub_1800179EC(
              ...
              Flags,
              (__int64)&off_1801101D0,
              (__int64)&off_180110250);
      v13 = v11;
      if ( v11 >= 0 )
      {
