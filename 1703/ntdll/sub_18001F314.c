...
__int64 __fastcall sub_18001F314(__int64 a1, unsigned int a2, __int64 a3)
{
...
LABEL_12:
  ...
  else
  {
    ...
    v25 = sub_18000A020((volatile signed __int64 *)a1, 0);
    v26 = v25;
    if ( !v25 )
      return 0LL;
    sub_18000A1D0(v25, 0);
...
LABEL_33:
  LOBYTE(v14) = 1;
LABEL_26:
  RtlRbInsertNodeEx(a1 + 120, v20, v14, v15);
  v3 = a2;
