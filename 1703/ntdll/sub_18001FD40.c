...
__int64 __fastcall sub_18001FD40(_QWORD *a1, __int64 a2, __int64 a3, unsigned int a4, unsigned int a5)
{
  __int64 v5; // rbp
  int v9; // r13d
  ...
  while ( 1 )
  {
    while ( !*(_QWORD *)(a3 + 8) )
    {
      ...
      v18 = (_QWORD *)(a2 + 24);
      if ( (_QWORD *)*v18 == v18
        || ((RtlAcquireSRWLockExclusive(a2 + 16), (_QWORD *)*v18 == v18)
          ? (v10 = 0LL)
          : (v10 = (PSLIST_ENTRY)sub_1800217D0(a2, *v18, 2LL)),
            RtlReleaseSRWLockExclusive(a2 + 16),
            !v10) )
      {
        v10 = sub_18000EF18((unsigned __int64)a1, a2, a5);
        if ( !v10 )
        {
          v16 = 0LL;
          goto LABEL_14;
      ...
      if ( *(_QWORD *)(a3 + 8) && LOWORD(v10[2].Next) == WORD1(v10[2].Next) )
        v10[1].Next = 0LL;
      else
    ...
    if ( v12 != a3 + 24 )
    {
      while ( 2 )
      {
        LOWORD(v13) = *(_WORD *)(v12 + 32);
        v9 = 0;
        while ( (_WORD)v13 != 1 || v11 != 1 )
        {
          v14 = v13 - 1;
          v13 = (unsigned __int16)_InterlockedCompareExchange16((volatile signed __int16 *)(v12 + 32), v13 - 1, v13);
          v15 = v14 + 1;
          if ( v13 == v15 )
          {
            if ( !*(_WORD *)(v12 + 32) )
              sub_1800217D0(a3, v12, 1LL);
            goto LABEL_9;
          }
          if ( v13 < v15 )
            v9 = 1;
...
LABEL_9:
  ...
  v16 = sub_18001FFBC(a1, a3, v12, a4);
  if ( !v16 )
    sub_18001E250(a1, v12, 0LL, a5);
LABEL_14:
  if ( v9 )
    sub_180080558(a1, a2);
  if ( v10 )
