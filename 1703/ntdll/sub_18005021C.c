...
__int64 __fastcall sub_18005021C(PUNICODE_STRING ValueName, unsigned __int32 a2, volatile signed __int32 *a3)
{
  HANDLE v6; // rbx
  ...
  if ( !byte_18015B26C )
  {
    ...
    if ( !KeyHandle )
    {
      if ( ZwOpenKey(&Handle, 1u, (POBJECT_ATTRIBUTES)&stru_1801103C0) < 0 )
      {
LABEL_7:
        v7 = a2;
        goto LABEL_8;
