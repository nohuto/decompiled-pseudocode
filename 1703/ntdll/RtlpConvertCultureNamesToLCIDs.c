/*
 * XREFs of RtlpConvertCultureNamesToLCIDs @ 0x1800ECBD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlpConvertCultureNamesToLCIDs(wchar_t *SourceString, unsigned __int64 *a2)
{
  ...
  v5 = 0LL;
  v6 = 0;
  if ( !a2 || !SourceString || *a2 || (int)sub_18006C8FC(SourceString, (__int64)a2, &v19) < 0 )
    return 3221225485LL;
  v7 = 2 * v19;
  while ( *v4 && v7 )
  {
    ...
    if ( !RtlCultureNameToLCID(&DestinationString.Length, &v21[v6]) )
      goto LABEL_16;
    v9 = 0;
    if ( v6 )
    {
