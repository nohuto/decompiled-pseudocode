...
__int64 __fastcall sub_180085EDC(__int64 (__fastcall *a1)(_BYTE *, __int64))
{
  ...
  v7 = v9;
  v6[1] = 520;
  if ( !*((_QWORD *)&xmmword_18015C030 + 1) )
  {
LABEL_11:
    LdrAddDllDirectory(v6, v8);
    return 0LL;
  }
  v3 = v1 + xmmword_18015C030 + 2;
  v5.m128i_i64[1] = RtlAllocateHeap(
                      (__int64)NtCurrentPeb()->ProcessHeap,
                      0,
                      v1 + (unsigned int)(unsigned __int16)xmmword_18015C030 + 2LL);
  if ( v5.m128i_i64[1] )
  {
    v5.m128i_i16[0] = 0;
    v5.m128i_i16[1] = v3;
    RtlAppendUnicodeStringToString((unsigned __int16 *)&v5, (__int16 *)&xmmword_18015C030);
    RtlAppendUnicodeStringToString((unsigned __int16 *)&v5, v6);
    RtlAppendUnicodeToString((unsigned __int16 *)&v5, ";");
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, *((unsigned __int64 *)&xmmword_18015C030 + 1));
    xmmword_18015C030 = (__int128)v5;
    *((_QWORD *)&xmmword_18015C020 + 1) = _mm_srli_si128(v5, 8).m128i_u64[0];
    sub_1800DFF68();
    goto LABEL_11;
  }
  v4 = dword_180155A10;
