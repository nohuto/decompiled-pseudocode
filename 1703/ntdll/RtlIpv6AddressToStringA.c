/*
 * XREFs of RtlIpv6AddressToStringA @ 0x18007BF90
 * Callers:
...
PSTR __stdcall RtlIpv6AddressToStringA(const struct in6_addr *Addr, PSTR S)
{
  ...
  do
  {
    if ( v4 >= v13 || v15 > v4 )
    {
      ...
      v16 = sprintf_s(v5, v3 - v5, "%x", (unsigned __int16)__ROR2__(Addr->u.Word[v4], 8));
    }
    else
    {
  ...
  while ( v4 < v2 );
  if ( v2 < 8 )
    v5 += sprintf_s(v5, v3 - v5, ":%u.%u.%u.%u", Addr->u.Byte[12], Addr->u.Byte[13], Addr->u.Byte[14], Addr->u.Byte[15]);
  return v5;
}
