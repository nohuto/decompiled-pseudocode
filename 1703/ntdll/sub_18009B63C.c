/*
 * XREFs of sub_18009B63C @ 0x18009B63C
 * Callers:
...
__m128 __fastcall sub_18009B63C(double a1, double a2, int a3)
{
  int v3; // eax
  double v4; // xmm3_8
  __int128 v5; // xmm6
  ...
  *(double *)&v7 = ((v6 * 0.0002240444485370221 - 0.02293450800575656) * v6 + 0.3723791597597922)
  ...
  if ( v3 )
  {
    ...
    if ( a3 )
    {
      ...
      *(double *)result.m128_u64 = (v8 + v8) / (v8 - 1.0) - 1.0;
    }
    else
    {
      result = (__m128)0x3FF0000000000000uLL;
      *(double *)result.m128_u64 = 1.0 - (v8 + v8) / (v8 + 1.0);
    }
