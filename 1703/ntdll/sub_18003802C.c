...
__int64 __fastcall sub_18003802C(__int64 a1, unsigned int *a2, unsigned __int64 a3, unsigned int a4, char a5)
{
  unsigned int *v7; // rax
  __int64 result; // rax
  unsigned int *v9; // r8
  ...
  if ( !a5 )
  {
    result = sub_18002FC7C(a1, a2, (unsigned __int64 *)&v11, 0LL);
    if ( (int)result < 0 )
      return result;
    v7 = v11;
  }
