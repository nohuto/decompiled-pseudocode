...
__int64 __fastcall RtlCreateTagHeap(void *Src, int a2, __int64 a3, _WORD *a4)
{
  ...
  if ( !qword_18015C468 )
  {
    qword_18015C468 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 672LL);
    if ( !qword_18015C468 )
      return 0LL;
  }
...
LABEL_13:
    ...
    if ( !v9 || (v14 = sub_1800EFE3C(Src), (v15 = v14) == 0) )
    {
LABEL_44:
      v7 = v8 << 18;
      goto LABEL_45;
    ...
    {
      if ( v11 )
        sub_1800456F0((_WORD *)(v14 + 20), 0x2EuLL, v11);
      v15 += 72LL;
    }
...
LABEL_37:
    ...
    while ( *v10 )
    {
      ...
      if ( v17 )
      {
        sub_1800456F0((_WORD *)(v15 + 20), 2 * v22, v17);
        v19 += v18;
      }
