...
__int64 __fastcall sub_1800FD028(__int64 a1)
{
  ...
  int v29; // edi
  __int64 v30; // rsi
  unsigned __int16 v31; // [rsp+28h] [rbp-E0h]
  __int16 v32; // [rsp+2Ch] [rbp-DCh] BYREF
  __int64 v33; // [rsp+30h] [rbp-D8h] BYREF
  unsigned __int16 *v34; // [rsp+38h] [rbp-D0h]
  __int64 v35; // [rsp+40h] [rbp-C8h] BYREF
  unsigned __int16 *v36; // [rsp+48h] [rbp-C0h]
  __int64 v37; // [rsp+50h] [rbp-B8h] BYREF
  wchar_t *v38; // [rsp+58h] [rbp-B0h]
  int v39; // [rsp+60h] [rbp-A8h] BYREF
  unsigned __int16 v40; // [rsp+64h] [rbp-A4h]
  int v41; // [rsp+66h] [rbp-A2h]
  __int64 v42; // [rsp+6Ch] [rbp-9Ch]
  __int64 v43; // [rsp+74h] [rbp-94h]
  _BYTE v44[176]; // [rsp+88h] [rbp-80h] BYREF
  ...
  {
    LOWORD(v33) = -1;
    v12 = (unsigned __int16 *)sub_180045488(v11, 0x55u);
    v34 = v12;
    v5 = (unsigned __int64)v12;
    if ( !v12 )
      return 3221225495LL;
    v36 = v12;
    LODWORD(v35) = 11141120;
    if ( RtlLCIDToCultureName(v31, (__int64)&v35) )
    {
      v13 = sub_1800FB4E4(a1, v36, 1, (__int16 *)&v33);
      v14 = -1;
      if ( v13 >= 0 )
        v14 = v33;
      v41 = v14;
      ...
      v42 = 0LL;
      v43 = 0LL;
      sub_18006E760(a1, (__int64)&v39, v36);
      if ( (int)sub_1800FB3F8((__int64 *)(a1 + 24), (__int64)&v39, 0LL) >= 0 )
      {
...
LABEL_16:
    if ( v3 != -1 )
    {
      v38 = (wchar_t *)v44;
      WORD1(v37) = 170;
      if ( (int)RtlpGetNameFromLangInfoNode(a1, 28LL * v3 + *(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL), (__int64)&v37) >= 0 )
      {
        if ( (int)sub_180046D4C((_QWORD *)a1, v38) >= 0 )
        {
          v4 = 1;
        }
        else
