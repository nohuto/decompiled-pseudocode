...
__int64 __fastcall sub_180029050(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, char a5)
{
  ...
  unsigned __int64 v58; // [rsp+50h] [rbp-18h]
  ...
  if ( v21 )
  {
    ...
    for ( i = 0; ; i = v66 )
    {
      ...
      *(_BYTE *)(v26 + 6) = BYTE6(v55);
      if ( v31 )
      {
        ...
        {
          sub_180009CF8(v18, a2, (_DWORD *)v34);
          v30 = a2 + 48;
          v26 = v58;
          v32 = v61;
          v18 = a1;
      ...
      if ( v36 < v30 + 16 * (unsigned __int64)*(unsigned __int16 *)(a2 + 32) )
      {
        ...
        {
          sub_180009CF8(v18, a2, (_DWORD *)v36);
          v30 = a2 + 48;
          v32 = v61;
          v29 = i;
          v33 = WORD1(v37) + v66;
      ...
      *(_DWORD *)(v26 + 8) = (unsigned __int8)(v10 ^ v26 ^ ((unsigned int)(v26 - a2) >> 12)) | 0x200;
      ...
      sub_180007334(v50, a2, v49, v52, 0, a5);
      if ( (a5 & 1) == 0 )
        RtlAcquireSRWLockExclusive((volatile signed __int64 *)a1);
      v29 = v66;
      *(_DWORD *)(v26 + 8) &= ~0x200u;
    ...
    *(_WORD *)v26 = v10 ^ v26 ^ (((v40 + (v26 & 0xFFF) + 4095) >> 12)
    ...
    if ( v46 )
    {
      while ( 1 )
      {
        if ( ((unsigned int)v10 ^ (unsigned int)v26 ^ *(_DWORD *)v26) < (*(_DWORD *)(v46 - 8) ^ (unsigned int)v10 ^ ((_DWORD)v46 - 8)) )
        {
          v47 = *(_QWORD *)v46;
          if ( (*(_BYTE *)(a1 + 16) & 1) != 0 )
          {
...
LABEL_36:
    ...
    RtlRbInsertNodeEx(a1 + 8, v46, v44, v26 + 8);
  }
  return a4;
}
