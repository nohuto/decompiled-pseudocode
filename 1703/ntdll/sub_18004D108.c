...
unsigned __int64 __fastcall sub_18004D108(_DWORD *a1, unsigned int a2, wchar_t *a3, char a4)
{
  __int16 v4; // r14
  __int64 v5; // rbx
  bool v6; // r13
  ...
  Src = 0LL;
  v5 = 112LL;
  v6 = (((unsigned __int64)xmmword_18016B360 >> 60) & 3) == 1;
  Size = 0LL;
  v34 = 0LL;
  v7 = 0LL;
  v30 = 0LL;
      ...
      if ( *v11 )
      {
        switch ( *v11 )
        {
          case 1:
            goto LABEL_67;
          case 2:
            v5 += (unsigned __int16)xmmword_18015C030;
            if ( v6 )
              v31 = &xmmword_18015C030;
            break;
          case 3:
            ...
            if ( v29 == -1073741789 )
            {
              Heap = (void *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18015B268 + 1572864, 2 * v30);
              v34 = Heap;
              if ( !Heap )
              {
              ...
              v25 = RtlQueryEnvironmentVariable(0LL, L"PATH", 4uLL, (__int64)Heap, v30, &v30);
              v7 = Size;
              v9 = v25;
              v29 = v25;
            }
...
LABEL_70:
      ...
      else if ( (_WORD)xmmword_18015BF60 )
      {
        Length = (unsigned __int16)xmmword_18015BF60;
        goto LABEL_69;
      }
      ++v10;
      ++v11;
  ...
  {
    v12 = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, v5);
    v8 = v12;
    if ( v12 )
    {
      *(_DWORD *)(v12 + 96) = v5;
          ...
          if ( *v20 )
          {
            switch ( *v20 )
            {
              case 1:
                goto LABEL_51;
              case 2:
                memmove(v13, *((const void **)&xmmword_18015C030 + 1), (unsigned __int16)xmmword_18015C030);
                v13 += (unsigned __int64)(unsigned __int16)xmmword_18015C030 >> 1;
                goto LABEL_33;
              case 3:
                if ( !v19 )
                  goto LABEL_34;
                memmove(v13, v34, 2 * v19);
                v13 += v19 + 1;
                v14 = v31;
                goto LABEL_53;
              case 4:
...
LABEL_51:
          ...
          {
            if ( !(_WORD)xmmword_18015BF60 )
              goto LABEL_34;
            memmove(v13, *((const void **)&xmmword_18015BF60 + 1), (unsigned __int16)xmmword_18015BF60);
            v23 = (unsigned __int16)xmmword_18015BF60;
          }
          v13 += (v23 >> 1) + 1;
LABEL_53:
          *(v13 - 1) = 59;
