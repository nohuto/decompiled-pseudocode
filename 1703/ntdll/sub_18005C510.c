/*
 * XREFs of sub_18005C510 @ 0x18005C510
 * Callers:
...
__int64 __fastcall sub_18005C510(__int64 a1, int a2, _QWORD *a3, _DWORD *a4, int a5)
{
  __int64 v9; // rsi
  __int64 v10; // rcx
  __int64 v11; // rdi
  ...
  if ( (*(_BYTE *)v10 & 1) != 0 )
  {
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v17 = 2147353476LL;
    sub_1800E2008(&v18, *(unsigned __int8 *)v17);
  }
  if ( !a1 || !a3 || !a4 )
    return 3221225485LL;
  v12 = a5;
  ...
  *a3 = 0LL;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (*(_BYTE *)v9 & 1) != 0 )
    {
      ...
      sub_1800E2008(&v20, *(unsigned __int8 *)v11);
    }
    return v16;
  }
  return result;
