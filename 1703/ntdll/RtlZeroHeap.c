/*
 * XREFs of RtlZeroHeap @ 0x1800F1D20
 * Callers:
...
NTSTATUS __cdecl RtlZeroHeap(PVOID HeapHandle, ULONG Flags)
{
  ...
  if ( (v5 & 0x61000000) != 0 && (v5 & 0x10000000) == 0 )
    return sub_1801021F4(HeapHandle);
  if ( (v5 & 1) == 0 )
  {
...
LABEL_17:
      ...
      if ( (v10 & 8) == 0 )
      {
        v29 = 16LL * *(unsigned __int16 *)(v9 + 8) - 32;
        v30 = (_DWORD *)(v9 + 32);
      ...
      if ( *v13 == v15 && v14 == v9 + 16 )
      {
        *((_QWORD *)HeapHandle + 24) -= *(unsigned __int16 *)(v9 + 8);
        ...
        if ( v16 )
        {
          ...
          sub_18002F7E0((__int64)HeapHandle, v16, 1, (__int64 *)(v9 + 16), v17, *(unsigned __int16 *)(v9 + 8));
        }
        *v13 = v12;
        *(_QWORD *)(v12 + 8) = v13;
        if ( (*(_BYTE *)(v9 + 10) & 8) == 0 || sub_180021DA4(HeapHandle, v9) )
        {
          ...
          *(_BYTE *)(v9 + 15) = 0;
          ...
          if ( *((_QWORD *)HeapHandle + 39) )
            v21 = (_QWORD *)sub_18000E6BC((__int64)HeapHandle, (unsigned int)v19);
          else
            v21 = *v20;
          while ( v20 != v21 )
          {
          ...
          {
            sub_1800A4DFC(12, 0LL, (__int64)v21, 0LL, *v25, 0LL);
          }
          *((_QWORD *)HeapHandle + 24) += *(unsigned __int16 *)(v11 + 8);
          ...
          if ( v26 )
          {
            ...
            sub_18000E614((__int64)HeapHandle, v26, 1, v11 + 16, v27, *(unsigned __int16 *)(v11 + 8));
          }
          if ( *((_DWORD *)HeapHandle + 31) )
          {
        ...
        {
          sub_18001C798(HeapHandle, v9, *(unsigned __int16 *)(v9 + 8), 1);
        }
      }
      else
      {
        sub_1800A4DFC(12, (__int64)HeapHandle, v9 + 16, v15, v14, 0LL);
      }
      v3 = 0LL;
LABEL_56:
      v8 = v38;
