...
double __cdecl log(double X)
{
  ...
  if ( (*(_QWORD *)&X & 0x7FF0000000000000LL) == 0x7FF0000000000000LL )
  {
    if ( (*(_QWORD *)&X & 0xFFFFFFFFFFFFFLL) != 0 )
    {
      ...
      v4 = v3;
LABEL_4:
      sub_18009DD10((unsigned int)&unk_1801186D8, 26, v4, 1, v12, 33, v13, 0LL, 1);
      return X;
    }
    if ( X >= 0.0 )
      return X;
LABEL_7:
  ...
  {
    X = 0.0;
    sub_18009DD10((unsigned int)&unk_1801186D8, 26, 0, 2, 4, 34, v2, 0LL, 1);
    return X;
  }
  v5 = 0;
  if ( X < 0.0 )
