/*
 * XREFs of sub_180040E28 @ 0x180040E28
 * Callers:
...
__int64 __fastcall sub_180040E28(__int64 a1, __int64 a2, _DWORD *a3, _DWORD *a4, unsigned __int8 a5, char a6, int *a7)
{
  _UNKNOWN **v7; // rax
  unsigned int v8; // ebx
  _DWORD *v10; // r14
  ...
  do
  {
    ...
    if ( *(_WORD *)(v23 + 6LL * v17) == 2 )
    {
      ...
      if ( (int)sub_18007FDBC(*(_QWORD *)(v11 + 24), 2LL, v25, v26) >= 0 )
      {
        v19 = a2;
        if ( (a5 & 0x80u) != 0 )
        {
