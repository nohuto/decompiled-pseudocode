        ...
        SECURITY_INFORMATION RequiredInformation)
{
  ...
  if ( (_DWORD)v7 )
  {
    if ( !(unsigned __int8)sub_18007B82C(v7, SecurityDescriptorLength, 12LL, &v21) )
      return 0;
  ...
  if ( (_DWORD)v11 )
  {
    if ( !(unsigned __int8)sub_18007B82C(v11, SecurityDescriptorLength, v8, &v21) )
      return 0;
  ...
  if ( (v6 & 4) == 0
    ...
    || (unsigned __int8)sub_18007B82C(v14, SecurityDescriptorLength, 8LL, &v21)
    ...
    && RtlValidAcl(v16) )
  {
    ...
    if ( !(_DWORD)v18 )
      return 1;
    if ( (unsigned __int8)sub_18007B82C(v18, SecurityDescriptorLength, 8LL, &v21) )
    {
