...
__int64 __fastcall sub_180106D98(__int64 a1, int a2, int a3)
{
  __int64 result; // rax
  int v7; // ebx
...
LABEL_9:
    ...
    v17 = 0;
    sub_1801074FC(a2, Heap, v10 >> 2, a3, (__int64)sub_1801074A0, (__int64)&v17);
    v16 = v17;
...
LABEL_14:
    ...
    v13 = 0;
    v14 = 0LL;
    sub_1801074FC(a2, Heap, v10 >> 2, a3, (__int64)sub_180107270, (__int64)&v12);
