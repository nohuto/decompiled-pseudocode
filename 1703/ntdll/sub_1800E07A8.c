/*
 * XREFs of sub_1800E07A8 @ 0x1800E07A8
 * Callers:
...
__int64 __fastcall sub_1800E07A8(_DWORD *a1, unsigned int *a2, _DWORD *a3, size_t a4, size_t *a5)
{
  size_t *v5; // rdi
  unsigned int v6; // ebx
  ...
  sub_18007ED38(&v29, (int *)&v30, a3, a4, v5, 0x68uLL, a1, v28, 2u, &v31, &a5);
  if ( v29 == 2 )
    return v30;
  v12 = v31;
  v13 = a2[1];
