/*
 * XREFs of sub_180069F00 @ 0x180069F00
 * Callers:
...
char __fastcall sub_180069F00(unsigned __int16 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v9 = &a1[(int)a2];
  if ( (_BYTE)a3 )
    v10 = &a1[(int)sub_1800F6A70(a1, a2, a3, a4)];
  else
    v10 = a1 - 1;
  if ( v10 != v9 && (int)a2 > 0 )
  {
...
LABEL_12:
    ...
    else
    {
      while ( 1 )
      {
        ...
        else if ( v5 && (v8 == 45 && v11 == v4 + 1 || !(unsigned __int8)sub_18008AB28(v8)) || v8 < 0x20u )
        {
          return 0;
        }
        if ( ++v11 == v9 )
