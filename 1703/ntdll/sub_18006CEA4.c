...
__int64 __fastcall sub_18006CEA4(_QWORD *a1)
{
  _DWORD *v1; // rbx
  PVOID Heap; // rax
  void *v4; // rsi
...
LABEL_18:
  ...
  if ( ZwGetMUIRegistryInfo(0, &DataSize, v4) < 0
    || (int)sub_18006E8F4(v4, DataSize, &BaseAddress) < 0
    || (v1 = BaseAddress, v5 = sub_18006E66C(BaseAddress), v5 < 0) )
  {
    RtlFreeHeap(NtCurrentPeb()->ProcessHeap, 0, v4);
    goto LABEL_20;
  }
  if ( *((_QWORD *)v1 + 5) && (int)sub_18006E330(0x2000000u, &CurrentUserKey) >= 0 )
  {
