/*
 * XREFs of RtlEnumerateEntryHashTable @ 0x180073D80
 * Callers:
 *     RtlWeaklyEnumerateEntryHashTable @ 0x1800F1580 (RtlWeaklyEnumerateEntryHashTable.c)
 * Callees:
        ...
        PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR Enumerator)
{
  ...
  if ( BucketIndex < HashTable->TableSize )
  {
    while ( 2 )
    {
      ...
      {
        result = (PRTL_DYNAMIC_HASH_TABLE_ENTRY)sub_180073E34(v4, BucketIndex);
        ChainHead = result;
      }
