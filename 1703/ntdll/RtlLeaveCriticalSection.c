/*
 * XREFs of RtlLeaveCriticalSection @ 0x18002F090
 * Callers:
 ...
 *     RtlReleasePebLock @ 0x18007E490 (RtlReleasePebLock.c)
 ...
 *     RtlTraceDatabaseUnlock @ 0x1800F9C70 (RtlTraceDatabaseUnlock.c)
