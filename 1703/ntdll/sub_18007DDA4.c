/*
 * XREFs of sub_18007DDA4 @ 0x18007DDA4
 * Callers:
...
void (__stdcall *__fastcall sub_18007DDA4(unsigned __int64 a1))(PEXCEPTION_RECORD ExceptionRecord)
{
  int v1; // ecx
  int v2; // ecx
  int v3; // ecx
  ...
  if ( a1 <= 5 )
  {
    ...
    v2 = v1 - 1;
    if ( !v2 )
      return (void (__stdcall *)(PEXCEPTION_RECORD))sub_1800AA000;
    v3 = v2 - 1;
    if ( !v3 )
      return (void (__stdcall *)(PEXCEPTION_RECORD))sub_180034E60;
    v4 = v3 - 1;
    if ( !v4 )
