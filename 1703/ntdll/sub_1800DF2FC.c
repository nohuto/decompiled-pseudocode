...
NTSTATUS __fastcall sub_1800DF2FC(__int64 a1, int a2, __int64 a3, __int64 a4, __int64 a5, int a6, int a7)
{
  __int64 v7; // rcx
  ...
  if ( RtlGetCurrentServiceSessionId() )
    ...
    v7 = 2147353486LL;
  return ZwTraceEvent((HANDLE)*(unsigned __int8 *)v7, 0x20402u, 0x2Cu, Fields);
}
