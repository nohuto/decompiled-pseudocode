/*
 * XREFs of sub_1800E0520 @ 0x1800E0520
 * Callers:
...
__int64 __fastcall sub_1800E0520(_DWORD *a1, unsigned int a2, char *a3, size_t a4, size_t *a5)
{
  size_t *v5; // r14
  unsigned int v6; // ebx
  __int64 v10; // rax
  ...
  if ( a2 < v12 )
  {
    ...
    sub_18007ED38(&v23, (int *)&v22, a3, a4, v5, 0x68uLL, a1, v21, 1u, &v24, &a5);
    if ( v23 == 2 )
    {
      return v22;
    }
