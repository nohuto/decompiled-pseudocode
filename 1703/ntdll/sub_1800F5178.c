...
__int64 __fastcall sub_1800F5178(unsigned int *a1, unsigned __int64 a2, char a3, char a4, __int64 a5)
{
  __int64 v8; // rcx
  char *v9; // r8
  __int64 v10; // rcx
                ...
                if ( (((_BYTE)v11 + (_BYTE)a1) & 1) == 0 )
                {
                  ...
                  if ( (int)v13 + 2 <= v14 && (int)v13 + 2 >= (unsigned int)v13 )
                  {
                    ...
                    if ( v15 + (unsigned int)v13 + 2 <= v14 && !*(_WORD *)&v12[2 * v15 + 2 + 2 * (unsigned int)v13] )
                      return sub_180045634(a4, &v12[2 * (unsigned int)(v13 + 1)], v15, a5);
                  }
                }
              }
            }
