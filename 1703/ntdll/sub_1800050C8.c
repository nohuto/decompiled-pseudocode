/*
 * XREFs of sub_1800050C8 @ 0x1800050C8
 * Callers:
...
__int64 __fastcall sub_1800050C8(_UNICODE_STRING *a1, unsigned __int16 *a2, _DWORD *a3)
{
  __int64 v5; // rdx
  NTSTATUS v6; // ebx
  ...
  *(_QWORD *)&LocalName.Length = 0LL;
  ...
  if ( v6 >= 0 )
  {
    if ( LocalName.Buffer && (LOBYTE(v5) = 1, (unsigned __int8)sub_18003D528(&LocalName, v5)) )
    {
      p_LocalName = &LocalName;
    }
    else
    {
      if ( !RealName.Buffer || (LOBYTE(v5) = 1, !(unsigned __int8)sub_18003D528(&RealName, v5)) )
      {
LABEL_7:
        v6 = 0;
        goto LABEL_8;
