...
__int64 __fastcall sub_1800050C8(__int64 a1, unsigned __int16 *a2, _DWORD *a3)
{
  __int64 v5; // rdx
  int v6; // ebx
  ...
  *(_QWORD *)&v17.Length = 0LL;
  ...
  if ( v6 >= 0 )
  {
    if ( v17.Buffer && (LOBYTE(v5) = 1, (unsigned __int8)sub_18003D528(&v17, v5)) )
    {
      p_UnicodeString = &v17;
    }
    else
    {
      if ( !UnicodeString.Buffer || (LOBYTE(v5) = 1, !(unsigned __int8)sub_18003D528(&UnicodeString, v5)) )
      {
LABEL_7:
        v6 = 0;
        goto LABEL_8;
