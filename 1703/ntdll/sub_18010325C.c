/*
 * XREFs of sub_18010325C @ 0x18010325C
 * Callers:
 *     sub_180004860 @ 0x180004860 (sub_180004860.c)
 * Callees:
 *     memset @ 0x1800ABDC0 (memset.c)
 *     sub_180103834 @ 0x180103834 (sub_180103834.c)
 */

__int64 __fastcall sub_18010325C(
        unsigned __int64 a1,
        unsigned int a2,
        __int64 a3,
        unsigned int a4,
...
LABEL_6:
  ...
  if ( v19 < v21 )
  {
    ...
    {
      LOWORD(v23) = v23 + 1;
      v25 = (unsigned __int16)word_180123AB0[v19[2] + 512] ^ (unsigned __int16)word_180123AB0[*v19] ^ (unsigned __int64)(unsigned __int16)word_180123AB0[v19[1] + 256];
