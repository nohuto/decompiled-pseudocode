/*
 * XREFs of sub_18010D960 @ 0x18010D960
 * Callers:
...
_BOOL8 __fastcall sub_18010D960(__int64 a1, __int16 a2, wchar_t *a3)
{
  int v3; // edi
  ...
  if ( (unsigned __int8)a2 > 8u )
  {
    if ( (unsigned __int8)a2 != 9 )
    {
      ...
      if ( v3 != 256 )
        goto LABEL_67;
      v13 = sub_18010B820(a3, 0x103uLL, L"%s\\", a1);
LABEL_65:
      v9 = v13;
LABEL_66:
      if ( v9 >= 0 )
...
LABEL_63:
  ...
  if ( (unsigned __int8)a2 == 8 )
  {
    if ( ((v3 - 256) & 0xFFFFFBFF) != 0 )
    {
      ...
      if ( !Heap || !(unsigned int)sub_18010DDF0(a1, Heap) )
        goto LABEL_67;
      v13 = sub_18010B820(a3, 0x103uLL, L"Global\\%s%s%s", v8, L"wip", L".owner");
      goto LABEL_65;
    }
    v14 = L"wip";
    goto LABEL_63;
  ...
  if ( (unsigned __int8)a2 == 1 )
  {
    ...
    if ( !v16 || !(unsigned int)sub_18010DDF0(a1, v16) )
      goto LABEL_67;
    v13 = sub_18010B820(a3, 0x103uLL, L"Global\\%s/base%s", v8, L".owner");
    goto LABEL_65;
  }
...
LABEL_22:
    v15 = L"%s\\*\\%s";
LABEL_64:
    v13 = sub_18010B820(a3, 0x103uLL, v15, a1, v14);
    goto LABEL_65;
  }
...
LABEL_15:
      v12 = L"%s\\%s*%s";
LABEL_16:
      v13 = sub_18010B820(a3, 0x103uLL, v12, a1, v11, v20);
      goto LABEL_65;
    }
  }
LABEL_67:
  switch ( v3 )
  {
    ...
    case 512:
      if ( !v7 )
        break;
      v18 = sub_18010B820(a3, 0x103uLL, L"%s%s", a1, v7);
      goto LABEL_72;
    case 1280:
LABEL_70:
      if ( v6 )
      {
        v18 = sub_18010B820(a3, 0x103uLL, L"%s\\%s", a1, v6);
LABEL_72:
        v9 = v18;
      }
      break;
