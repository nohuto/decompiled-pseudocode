/*
 * XREFs of sub_18005E120 @ 0x18005E120
 * Callers:
 *     EtwEventWriteEx @ 0x18005E0A0 (EtwEventWriteEx.c)
 *     EtwEventWrite @ 0x18005E0F0 (EtwEventWrite.c)
 *     sub_18005F868 @ 0x18005F868 (sub_18005F868.c)
 *     EtwEventWriteFull @ 0x180060390 (EtwEventWriteFull.c)
 * Callees:
...
__int64 __fastcall sub_18005E120(
        __int64 a1,
        __int128 *a2,
        __int64 a3,
        int a4,
        ...
        __int64 a9)
{
  ...
  if ( *(_BYTE *)((a1 & 0xFFFFFFFFFFFFLL) + 0xF4) )
  {
    ...
    {
      v9 = 1;
      v14 = sub_18005E3C8(v15, v12, a5, HIDWORD(v11), 0, (__int64)a6, (__int64)a7, a8, a9, (__int64)v37);
      if ( v14 )
      {
LABEL_28:
        sub_18005E37C(v14, v37, v13, v11);
        return v14;
      }
      v16 = *((_QWORD *)&v29 + 1);
      v13 = a9;
