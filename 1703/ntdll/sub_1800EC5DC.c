/*
 * XREFs of sub_1800EC5DC @ 0x1800EC5DC
 * Callers:
...
__int64 __fastcall sub_1800EC5DC(__int64 a1, const WCHAR *a2)
{
  __int64 result; // rax
  __int64 v5; // r9
  __int64 v6; // rcx
  ...
  if ( !a1 || !a2 || !*a2 )
    return 3221225485LL;
  result = sub_180044C70(a1, a2, 1, &v12);
  if ( (int)result < 0 )
    return result;
  v6 = *(_QWORD *)(a1 + 24);
  ...
  for ( i = &a2[v8 + 1]; i; i += v10 + 1 )
  {
    if ( !*i )
      break;
    LOBYTE(v5) = 1;
    result = sub_1800FAF00(a1, v7, i, v5, v13);
    if ( (int)result < 0 )
      return result;
    v7 = v13;
    v10 = -1LL;
  ...
  if ( (unsigned int)v11 >= 0x105 )
    return 3221225507LL;
  result = sub_1800ED010(a1, (_DWORD)v7, 0, (_DWORD)i, 261 - (int)v11);
  if ( (int)result >= 0 )
    return 0LL;
  return result;
}
