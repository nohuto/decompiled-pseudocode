/*
 * XREFs of sub_18007B4A8 @ 0x18007B4A8
 * Callers:
...
__int64 __fastcall sub_18007B4A8(_OWORD *a1, unsigned __int16 a2, __int64 a3, UNICODE_STRING *a4, __int64 a5)
{
        ...
        if ( ActivationContextSectionString >= 0 )
        {
          if ( HIDWORD(v26[0]) == 1 )
          {
            ...
            if ( ActivationContextSectionString >= 0 )
            {
              ...
              {
                v15 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64 *))qword_18015BF38)(v11, a2, &v20);
