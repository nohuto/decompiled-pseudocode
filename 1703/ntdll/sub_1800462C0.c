/*
 * XREFs of sub_1800462C0 @ 0x1800462C0
 * Callers:
...
__int64 __fastcall sub_1800462C0(unsigned __int16 *a1)
{
  int v2; // r15d
  int v3; // r14d
  __int64 v4; // rbp
  ...
  v2 = 0;
  v3 = *(unsigned __int16 *)(qword_18015C278 + 10) - 1;
  if ( v3 < 0 )
    return 0xFFFFFFFFLL;
  while ( 1 )
  {
    v4 = (v3 + v2) / 2;
    LOWORD(v5) = 0;
    v6 = *(_QWORD *)(qword_18015C278 + 40)
       + 2LL
       + 2LL * *(unsigned __int16 *)(*(_QWORD *)(qword_18015C278 + 32) + 8 * v4);
    if ( a1 )
    {
      v7 = -1LL;
      do
