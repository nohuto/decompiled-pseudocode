...
NTSTATUS __fastcall sub_1800686F4(__int64 a1, void *a2, int a3, HANDLE *a4)
{
  void *v4; // rax
  __int64 v5; // rsi
  __int64 v10; // rcx
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  if ( v4 )
  {
    ...
    result = ZwOpenProcess(&Handle, 0x1FFFFFu, &ObjectAttributes, &v23);
    if ( result < 0 )
      return result;
    v10 = (__int64)Handle;
  }
  ...
  if ( a2 )
  {
    ...
    v16 = ZwOpenProcess(&ProcessHandle, 0x1FFFFFu, &ObjectAttributes, &ClientId);
    v10 = (__int64)Handle;
    v17 = v16;
    if ( v16 < 0 )
    {
