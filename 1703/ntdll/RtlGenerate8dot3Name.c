/*
 * XREFs of RtlGenerate8dot3Name @ 0x1800F4800
 * Callers:
 *     <none>
 * Callees:
 ...
 *     sub_1800F4780 @ 0x1800F4780 (sub_1800F4780.c)
 */
        ...
        PUNICODE_STRING Name8dot3)
{
  ...
  if ( !Context->NameLength )
  {
    ...
    while ( 1 )
    {
      v11 = sub_1800F469C(&Name->Length, &v47, v5, AllowExtendedCharacters);
      if ( !v11 )
        break;
      v5 = 0;
      if ( v11 == 46 )
    ...
    while ( 1 )
    {
      v15 = sub_1800F469C(&Name->Length, &v47, 1, AllowExtendedCharacters);
      v16 = v15;
    ...
    else
    {
      ...
      {
        v25 = sub_1800F469C(&Name->Length, &v48, 1, AllowExtendedCharacters);
        v26 = v25;
        if ( !v25 )
          break;
        ...
        if ( v9 )
        {
          if ( v25 <= 0x7Fu || (v27 = v25, v28 = 2, !*(_BYTE *)(qword_180159F80 + 2 * v27 + 1)) )
            v28 = 1;
          v24 += v28;
          if ( v24 > 4 )
          {
LABEL_41:
  ...
  *((_WORD *)v50 + 8 - v37) = 126;
  ...
  {
    memmove(v6->Buffer, Context->NameBuffer, 2LL * Context->NameLength);
  ...
  if ( v9 )
  {
    ...
    for ( i = 0; v43 < Context->NameLength; ++v43 )
    {
      if ( Context->NameBuffer[v43] <= 0x7Fu
        || (v45 = 2, !*(_BYTE *)(qword_180159F80 + 2LL * Context->NameBuffer[v43] + 1)) )
      {
        v45 = 1;
      }
      i += v45;
