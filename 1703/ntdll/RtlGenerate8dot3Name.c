...
__int64 __fastcall RtlGenerate8dot3Name(unsigned __int16 *a1, char a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  if ( !*(_BYTE *)(a3 + 3) )
  {
    ...
    while ( 1 )
    {
      v11 = sub_1800F469C(a1, &v47, v5, a2);
      if ( !v11 )
        break;
      v5 = 0;
      if ( v11 == 46 )
...
LABEL_41:
  ...
  *((_WORD *)v50 + 8 - v37) = 126;
  ...
  {
    memmove(*((void **)v6 + 1), (const void *)(a3 + 4), 2LL * *(unsigned __int8 *)(a3 + 3));
  ...
  if ( v9 )
  {
    ...
    for ( i = 0; v43 < *(unsigned __int8 *)(a3 + 3); ++v43 )
    {
      if ( *(_WORD *)(a3 + 2LL * v43 + 4) <= 0x7Fu
        || (v45 = 2, !*(_BYTE *)(qword_180159F80 + 2LL * *(unsigned __int16 *)(a3 + 2LL * v43 + 4) + 1)) )
      {
        v45 = 1;
      }
      i += v45;
