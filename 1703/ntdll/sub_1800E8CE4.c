/*
 * XREFs of sub_1800E8CE4 @ 0x1800E8CE4
 * Callers:
...
char __fastcall sub_1800E8CE4(__int64 a1, __int64 a2, char a3, _BYTE *a4)
{
  char v4; // si
  char v7; // r12
  unsigned int v9; // edx
  ...
  *a4 = 0;
  ...
  if ( v10 - 8 < *v11 )
    return 1;
  v13 = v12 - *v11;
  if ( v13 < 4 || (int)sub_180058198((unsigned int *)((char *)v11 + *v11), v13, v25) < 0 )
    return 1;
  v14 = a2 + 8;
  v15 = 0;
  Size = v25[0];
  ...
  while ( 1 )
  {
    ...
    {
      v20 = v19 - *v18;
      if ( v20 >= 4 && (int)sub_180058198((unsigned int *)((char *)v18 + *v18), v20, v25) >= 0 )
      {
