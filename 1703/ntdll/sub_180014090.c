...
__int64 __fastcall sub_180014090(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 *v5; // rbx
  __int64 v7; // rdi
  __int64 v8; // r8
  ...
  result = sub_180016D48(a1, v5, 0LL);
  if ( (_DWORD)result )
  {
    ...
    *(_QWORD *)(a1 + 88) = v5[10];
    *(_QWORD *)(a1 + 96) = v5[11];
    ((void (__fastcall *)(__int64, __int64, __int64 *))v5[10])(a1, v5[11], v5);
