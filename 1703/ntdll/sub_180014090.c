...
__int64 __fastcall sub_180014090(PTP_CALLBACK_INSTANCE Instance, __int64 a2)
{
  __int64 *v3; // rbx
  __int64 v5; // rdi
  __int64 v6; // r8
  ...
  if ( (_DWORD)result )
  {
    ...
    *((_QWORD *)Instance + 12) = v3[11];
    ((void (__fastcall *)(PTP_CALLBACK_INSTANCE, __int64, __int64 *))v3[10])(Instance, v3[11], v3);
    if ( RtlGetCurrentServiceSessionId() )
