/*
 * XREFs of sub_180100060 @ 0x180100060
 * Callers:
...
ULONG sub_180100060()
{
  ...
  v0 = (const char *)&dword_1801150C2;
  if ( NtCurrentPeb()->Ldr )
    DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
  else
    DbgPrint("HEAP: ");
  DbgPrint("Heap error detected at %p (heap handle %p)\n", (const void *)qword_1801586C8, (const void *)qword_1801586C0);
  if ( dword_1801586B8 > 7 )
  {
    switch ( dword_1801586B8 )
    {
      case 8:
  ...
  else if ( dword_1801586B8 == 7 )
  {
    v0 = "heap_failure_buffer_underrun";
  }
  else if ( dword_1801586B8 )
  {
    switch ( dword_1801586B8 )
    {
      case 1:
  ...
  if ( qword_1801586E0 )
  {
    if ( NtCurrentPeb()->Ldr )
      ...
      DbgPrint("HEAP: ");
    DbgPrint("Parameter3: %p\n", (const void *)qword_1801586E0);
  }
  if ( qword_1801586E8 || qword_1801586F0 )
  {
    if ( NtCurrentPeb()->Ldr )
      DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
    else
    ...
    DbgPrint(
      ...
      (const void *)qword_1801586E8,
      (const void *)qword_1801586F0);
  }
  if ( NtCurrentPeb()->Ldr )
    DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
  else
