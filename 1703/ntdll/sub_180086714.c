...
__int64 __fastcall sub_180086714(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v8; // eax
  __int64 v9; // rcx
  ...
  if ( (*(_BYTE *)(a3 + 22) & 1) == 0 )
  {
    v8 = sub_180032C0C(a1, 1, 5u, &v15, v14);
    v9 = v14[0];
    if ( v8 < 0 )
      v9 = 0LL;
    if ( !v9 || !v15 )
  ...
  v12 = sub_180032C0C(a1, 1, 0xEu, &v15, v14);
  v13 = v14[0];
  if ( v12 < 0 )
    v13 = 0LL;
  if ( !v13 || v15 < 0x48 || (*(_BYTE *)(v13 + 16) & 1) == 0 )
  {
    sub_1800869C8(a4, *(_QWORD *)(a3 + 48), a1, a2);
    v10 = sub_1800867F4(a1);
  }
  else
  {
LABEL_7:
