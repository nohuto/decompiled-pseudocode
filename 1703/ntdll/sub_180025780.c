...
__int64 __fastcall sub_180025780(__int64 a1, unsigned __int64 a2, int a3, __int64 *a4, PSLIST_HEADER ListHead)
{
  ...
  __int64 *v71; // r8
  volatile signed __int64 *v72; // rbp
  int v73; // r9d
  ...
  unsigned int v116[18]; // [rsp+70h] [rbp-48h] BYREF
  volatile signed __int64 *v118; // [rsp+C0h] [rbp+8h]
  unsigned int v119; // [rsp+C0h] [rbp+8h]
  int v121; // [rsp+D0h] [rbp+18h]
  int v122; // [rsp+D0h] [rbp+18h]
  BOOL ListHeada; // [rsp+E0h] [rbp+28h]
  union _SLIST_HEADER *ListHeadb; // [rsp+E0h] [rbp+28h]
  ...
  if ( ListHead )
  {
    if ( !(_WORD)v6 )
    {
      if ( (unsigned int)sub_1800588D4(&qword_180159600, v6 >> 16, 1LL) )
      {
        v29 = sub_180008F9C(v10, v6, v14, (__int64)&v107);
        goto LABEL_29;
      }
      v12 = (unsigned __int64)byte_1801196F0;
    }
...
LABEL_37:
  if ( (v14 & 0x1000000) == 0 )
  {
    if ( *(_DWORD *)(v10 + 32) )
    {
      if ( (v13 || (v13 = sub_18001F5E8(v10, v6, v14, a4)) != 0) && (*(_BYTE *)(v13 + 2) & 0xF) != 0 )
      {
        if ( (dword_180158684 & 2) != 0 )
        {
          if ( (_WORD)v6 || (v102 = sub_1800588D4(&qword_180159600, v6 >> 16, 1LL), v101 = v6, !v102) )
            v101 = v6 + 16;
        }
        else
        {
  ...
  if ( (*(_DWORD *)(v10 + 20) & 0x10000000) != 0 && sub_180023990(v10, v6, v14) == -1 )
    goto LABEL_213;
  if ( !(_WORD)v6 && (unsigned int)sub_1800588D4(&qword_180159600, v6 >> 16, 1LL) )
  {
    if ( !sub_180009038(v10, v6, v14) )
      v15 = 0;
    v5 = v15;
    if ( (unsigned int)RtlGetCurrentServiceSessionId() )
      v94 = (__int64)NtCurrentPeb()->HotpatchInformation + 550;
    else
      v94 = 2147353472LL;
    if ( *(_BYTE *)v94 && (NtCurrentPeb()->TracingFlags & 1) != 0 && v15 )
      goto LABEL_184;
    return v5;
  }
  if ( (dword_180158684 & 1) != 0 )
...
LABEL_112:
                ...
                {
                  v71 = (__int64 *)(v10 + 288);
                  v72 = *(volatile signed __int64 **)(v10
                                                    + 288
                                                    + 8LL
                                                    * (unsigned __int8)byte_1801196F0[((unsigned __int64)(unsigned __int16)v108
                                                                                     + 15) >> 4]
                                                    + 192);
                  if ( *((_WORD *)v32 + 16) != *((_WORD *)v32 + 17) )
                  {
                    RtlAcquireSRWLockExclusive(v72 + 2);
                    sub_18007DC74(v32, v72);
                    if ( *((_WORD *)v32 + 16) == *((_WORD *)v32 + 17) )
                      v32[2] = 0LL;
                    else
                      v32 = sub_1800217D0((__int64)v72, v32, 0);
                    RtlReleaseSRWLockExclusive(v72 + 2);
                    v71 = (__int64 *)(v10 + 288);
                  }
                  if ( v32 )
                  {
                    _InterlockedDecrement64(v72 + 8);
                    v73 = 2 * (v105 & 1);
                    v106 = v73;
                    _InterlockedExchangeAdd64(v72 + 7, -*((__int16 *)v32 + 17));
                    _BitScanForward(&v74, *((unsigned __int8 *)v32 + 45) << *((_BYTE *)v32 + 44));
                    ListHeadb = (union _SLIST_HEADER *)&v71[2 * v74 - 14];
                    ...
                    else
                    {
                      ...
                      if ( *((unsigned __int8 *)v32 + 45) > 1u )
                      {
                          ...
                          if ( v110 )
                          {
                            if ( v5 )
                            {
                              ...
                              if ( v79 == sub_180020B20 )
                                ...
                                v79(v81, v82, v80);
                              sub_18001E4DC((__int64)v32, v119, v121);
                              v75 += v110;
                            }
                            else
                            {
                              if ( !v76 )
                                RtlAcquireSRWLockShared((volatile signed __int64 *)(v10 + 336));
                              v5 = 2;
                            }
                          }
                        }
                        ...
                        if ( v5 && !v106 )
                          RtlReleaseSRWLockShared(v10 + 336);
                      }
            ...
            do
            {
              while ( 1 )
              {
                ...
                if ( (v62 & 1) != 0 )
                  break;
                v109 = v62;
                v118 = (volatile signed __int64 *)(v62 + 16);
                RtlAcquireSRWLockExclusive(v62 + 16);
                v62 = v32[2];
                if ( v109 == v62 )
                {
                  v34 = v109;
...
LABEL_73:
            v5 = 1;
            if ( v34 )
              RtlReleaseSRWLockExclusive((volatile signed __int64 *)(v34 + 16));
            goto LABEL_75;
          }
          v54 = (int)v43 < 0;
          v55 = v43 == -2;
                                                      ...
                                                      + 0x2D) )
          {
            ...
            do
            {
              ...
              if ( v113 >= 2 )
              {
                ...
                else
                {
                  LODWORD(v43) = v59;
                  if ( (v105 & 1) == 0 )
                    RtlAcquireSRWLockShared((volatile signed __int64 *)(v58 + 48));
                  v57 = 2;
                  if ( !v56 )
                    RtlAcquireSRWLockExclusive(v32 + 3);
                }
              }
              else
              {
            ...
            {
              if ( !ListHeada )
                RtlReleaseSRWLockExclusive(v32 + 3);
              if ( (v105 & 1) == 0 )
    ...
    else
    {
      ...
      if ( v5 )
      {
        if ( v116[0] <= 0x3FF0 )
        {
          v83 = (unsigned __int8)byte_1801196F0[(unsigned __int64)(v116[0] + 15) >> 4];
...
LABEL_75:
    ...
    if ( HotpatchInformation && *HotpatchInformation )
      v50 = (__int64)NtCurrentPeb()->HotpatchInformation + 550;
    else
      v50 = 2147353472LL;
  ...
  v5 = 1;
  if ( (unsigned int)RtlGetCurrentServiceSessionId() )
    v96 = (__int64)NtCurrentPeb()->HotpatchInformation + 550;
  else
    v96 = 2147353472LL;
