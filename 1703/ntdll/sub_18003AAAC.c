...
struct _PEB *__fastcall sub_18003AAAC(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  __int64 v8; // rdi
  __int64 v9; // rcx
  __int64 v10; // rbx
...
LABEL_19:
        ...
        sub_1800846A8(a1, a2, a4, (unsigned int)&v25, (__int64)&v24);
        v14 = v25;
        if ( !v25 )
        {
        ...
        if ( result )
        {
          ...
          *(_WORD *)(&result->3 + 3) = 5334;
          sub_1800D5F44(v15, (char *)&result->ProcessParameters + 4, v16, &v23);
          v19 = v16 - v23;
          v20 = v23 + v18 + 36;
          sub_1800D5F44(a3 + 72, v20, v19, &v23);
          v21 = v19 - v23;
          v22 = v23 + v20;
          sub_1800D5EE4(&DestinationString, v22, v21, &v23);
          sub_1800D5EE4(&v27, v22 + v23, v21 - v23, &v23);
          if ( (unsigned int)RtlGetCurrentServiceSessionId() )
