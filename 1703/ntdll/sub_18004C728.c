...
__int64 __fastcall sub_18004C728(unsigned __int16 *a1, unsigned __int16 *a2, char a3, _QWORD *a4)
{
  int v8; // r14d
  ...
  *a4 = 0LL;
  v8 = sub_18003C6D0((__int64)a1, (__int64)a2);
  RtlAcquireSRWLockExclusive(&qword_18015C040);
  v9 = 0LL;
  if ( (a3 & 0x20) == 0 )
    v9 = a2;
  v10 = sub_18003888C(a1, v9, a3, a4, v8);
