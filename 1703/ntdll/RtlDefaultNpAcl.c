...
LABEL_5:
          ...
          *Acl = v8;
          if ( v8 )
          {
            ...
            v9 = *Acl;
            v21 = 18;
            sub_180044698(v9, 2u, 0, 0x10000000, Sid, 0);
            RtlInitializeSid(Sid, &IdentifierAuthority, 2u);
            v10 = *Acl;
            v21 = 32;
            v22 = 544;
            sub_180044698(v10, 2u, 0, 0x10000000, Sid, 0);
            if ( v2 )
              sub_180044698(*Acl, 2u, 0, 0x10000000, *(unsigned __int8 **)v2, 0);
            if ( AppContainerSidParent )
              sub_180044698(*Acl, 2u, 0, 0x10000000, (unsigned __int8 *)AppContainerSidParent, 0);
            sub_180044698(*Acl, 2u, 0, 0x10000000, *(unsigned __int8 **)Heap, 0);
            RtlInitializeSid(Sid, &v15, 1u);
            v11 = *Acl;
            v21 = 0;
            sub_180044698(v11, 2u, 0, 0x80000000, Sid, 0);
            RtlInitializeSid(Sid, &IdentifierAuthority, 1u);
            v12 = *Acl;
            v21 = 7;
            sub_180044698(v12, 2u, 0, 0x80000000, Sid, 0);
