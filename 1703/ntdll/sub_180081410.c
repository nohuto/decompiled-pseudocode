/*
 * XREFs of sub_180081410 @ 0x180081410
 * Callers:
...
char __fastcall sub_180081410(__int64 a1, unsigned __int8 *a2, char a3, int *a4)
{
  char v4; // bl
  ...
  if ( a2 )
  {
    ...
    v9 = ZwQueryInformationToken(v20[0], 1LL, &v25);
    *a4 = v9;
    if ( v9 >= 0 )
    {
      ...
      InformationToken = ZwQueryInformationToken(v20[0], 2LL, 0LL);
      *a4 = InformationToken;
      if ( (int)(InformationToken + 0x80000000) < 0 || InformationToken == -1073741789 )
      {
        ...
        if ( Heap )
        {
          *a4 = ZwQueryInformationToken(v20[0], 2LL, Heap);
          if ( a3 )
            ZwClose(v20[0]);
          if ( *a4 >= 0 )
          {
