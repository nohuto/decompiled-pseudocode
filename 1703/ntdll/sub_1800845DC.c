/*
 * XREFs of sub_1800845DC @ 0x1800845DC
 * Callers:
...
__int64 __fastcall sub_1800845DC(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        ...
        NTSTATUS Status)
{
  ...
  v10 = 0LL;
  sub_1800846A8(a1, a3, a6, (unsigned int)&v21, (__int64)&v20);
  v12 = dword_180155A10;
  v13 = (const char *)v20;
  v14 = v21;
  ...
  {
    v15 = *(_QWORD *)(a2 + 48);
    if ( (dword_180158674 & 0x10) == 0 && (*(_BYTE *)(a2 + 104) & 1) == 0 )
    {
      v16 = 0;
      goto LABEL_7;
    }
