/*
 * XREFs of sub_1800FA81C @ 0x1800FA81C
 * Callers:
...
__int64 __fastcall sub_1800FA81C(__int64 *a1, __int16 *a2)
{
  unsigned int v2; // ebx
  __int64 v5; // r8
  __int16 v6; // r11
...
LABEL_9:
    if ( (unsigned __int16)v8 >= *(_WORD *)(v5 + 6) )
    {
      ...
      v12 = *a1;
      if ( (unsigned int)v11 >= *(unsigned __int16 *)(v5 + 6) )
        v12 = sub_1800FBC0C(v5, v11, v5, v9);
      if ( !v12 )
