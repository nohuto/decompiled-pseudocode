/*
 * XREFs of UsbhEnumerate2 @ 0x1C005031C
 * Callers:
...
__int64 __fastcall UsbhEnumerate2(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( !v10 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005D908[2 * v24];
LABEL_19:
    if ( v20 )
      return v20(a1, a4, a5);
    return v5;
  ...
  if ( !v11 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005D508[2 * v23];
    goto LABEL_19;
  }
  v12 = v11 - 2;
  if ( !v12 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C00608D8[2 * v22];
    goto LABEL_19;
  }
  v13 = v12 - 4;
  if ( !v13 )
  ...
  if ( !v14 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005DB08[2 * v21];
    goto LABEL_19;
  }
  v15 = v14 - 65520;
  if ( !v15 )
  {
    ...
    v20 = (unsigned int (__fastcall *)(__int64, __int64, __int64))qword_1C005D708[2 * v19];
    goto LABEL_19;
  }
  v16 = v15 - 0x10000;
  if ( !v16 )
