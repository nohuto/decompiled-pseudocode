/*
 * XREFs of UsbhBuildClassCompatibleID @ 0x1C001CAB0
 * Callers:
...
__int64 __fastcall UsbhBuildClassCompatibleID(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  unsigned __int16 v88; // [rsp+B8h] [rbp+20h]

  v4 = a2;
  v5 = PdoExt(a2);
  v6 = 0LL;
  LODWORD(v7) = 0;
  v8 = *((unsigned __int8 *)v5 + 2414);
  v9 = *((unsigned __int8 *)v5 + 2413);
  v84 = v8;
  v88 = *((unsigned __int8 *)v5 + 2415);
  v83 = v9;
  Log(a1, 4096, 1684228420, v9, v8);
  if ( (v5[700] & 0x20) != 0 )
  {
    v40 = *((_QWORD *)v5 + 353);
    v41 = -1LL;
    if ( *(_BYTE *)(v40 + 12) )
    {
      ...
      if ( *v42 )
      {
        ...
        *((_WORD *)v47 + 12) = aUsbMsCompN[12];
        ...
        v50 = (_BYTE *)(*((_QWORD *)v5 + 353) + 12LL);
        if ( *((_QWORD *)v5 + 353) != -12LL )
        {
          v51 = -1LL;
          do
            v45 = v50[++v51] == 0;
  ...
  if ( *(_BYTE *)(v10 + 26) )
  {
    ...
    if ( v67 )
    {
      ...
      *((_WORD *)v68 + 12) = aUsbMsCompN[12];
      ...
      v71 = (_BYTE *)(*((_QWORD *)v5 + 313) + 26LL);
      if ( *((_QWORD *)v5 + 313) != -26LL )
      {
        v72 = -1LL;
        do
          v45 = v71[++v72] == 0;
  ...
  if ( v12 )
  {
    ...
    *(_OWORD *)v14 = *(_OWORD *)L"USB\\Class_nn";
    for ( *((_QWORD *)v14 + 2) = *(_QWORD *)L"s_nn"; *(_WORD *)v14 != 110; v14 += 2 )
      ;
    v4 = a2;
    *(_WORD *)v14 = (unsigned __int8)Nibble[v9 >> 4];
    *((_WORD *)v14 + 1) = (unsigned __int8)Nibble[v9 & 0xF];
  }
  else
  {
    v11 = 0;
  ...
  if ( v16 )
  {
    ...
    *(_OWORD *)v18 = *(_OWORD *)L"&SubClass_nn";
    for ( *((_QWORD *)v18 + 2) = *(_QWORD *)L"s_nn"; *(_WORD *)v18 != 110; v18 += 2 )
      ;
    *(_WORD *)v18 = (unsigned __int8)Nibble[v8 >> 4];
    *((_WORD *)v18 + 1) = (unsigned __int8)Nibble[v8 & 0xF];
  }
  else
  {
    v15 = 0;
  ...
  if ( v24 )
  {
    ...
    *(_OWORD *)v26 = *(_OWORD *)L"USB\\Class_nn";
    for ( *((_QWORD *)v26 + 2) = *(_QWORD *)L"s_nn"; *(_WORD *)v26 != 110; v26 += 2 )
      ;
    *(_WORD *)v26 = (unsigned __int8)Nibble[v9 >> 4];
    *((_WORD *)v26 + 1) = (unsigned __int8)Nibble[v9 & 0xF];
  }
  else
  {
    v23 = 0;
  ...
  if ( v28 )
  {
    ...
    *(_OWORD *)v30 = *(_OWORD *)L"&SubClass_nn";
    for ( *((_QWORD *)v30 + 2) = *(_QWORD *)L"s_nn"; *(_WORD *)v30 != 110; v30 += 2 )
      ;
    *(_WORD *)v30 = (unsigned __int8)Nibble[v8 >> 4];
    *((_WORD *)v30 + 1) = (unsigned __int8)Nibble[v8 & 0xF];
  }
  else
  {
    v27 = 0;
  ...
  if ( v32 )
  {
    ...
    *(_OWORD *)v34 = *(_OWORD *)L"USB\\Class_nn";
    for ( *((_QWORD *)v34 + 2) = *(_QWORD *)L"s_nn"; *(_WORD *)v34 != 110; v34 += 2 )
      ;
    *(_WORD *)v34 = (unsigned __int8)Nibble[v9 >> 4];
    *((_WORD *)v34 + 1) = (unsigned __int8)Nibble[v9 & 0xF];
  }
  else
  {
    v31 = 0;
