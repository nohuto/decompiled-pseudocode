/*
 * XREFs of UsbhPdoQueryWmiDataBlock @ 0x1C004E560
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
      ...
      if ( (v12[353] & 0x24) != 0 )
        goto LABEL_5;
      v16 = UsbhRefPdoDeviceHandle(*((_QWORD *)v12 + 147), (__int64)DeviceObject, (__int64)Irp, 0x4844646Eu);
      v17 = v16;
      if ( v16 )
      {
...
LABEL_13:
    ...
    else
    {
      ...
      v20 = UsbhRefPdoDeviceHandle(*((_QWORD *)v12 + 147), (__int64)DeviceObject, (__int64)Irp, 0x48447066u);
      v17 = v20;
      if ( v20 )
      {
