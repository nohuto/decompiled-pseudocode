/*
 * XREFs of UsbhValidateMsOs20DescriptorSet @ 0x1C0054394
 * Callers:
 ...
 *     UsbhGetNextMsOs20Descriptor @ 0x1C003FAE8 (UsbhGetNextMsOs20Descriptor.c)
 */
...
char __fastcall UsbhValidateMsOs20DescriptorSet(__int64 a1, __int64 a2, unsigned int *a3)
{
  ...
  v8 = 1;
  v9 = *((_WORD *)v5 + 1402);
  v10 = (unsigned __int16 *)*((_QWORD *)v5 + 352);
  if ( v9 != v6 )
  {
    v11 = 1447907120;
    v17 = v6;
