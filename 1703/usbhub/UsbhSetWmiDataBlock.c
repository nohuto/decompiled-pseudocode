/*
 * XREFs of UsbhSetWmiDataBlock @ 0x1C004EA50
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall UsbhSetWmiDataBlock(struct _DEVICE_OBJECT *a1, IRP *a2, int a3, int a4, unsigned int a5, _BYTE *a6)
{
  char v10; // r9
  __int64 v11; // r10
  int v12; // r11d
  ...
  if ( !v13 )
  {
    ...
    if ( !a4 && *(_DWORD *)(v11 + 3280) != 6 )
    {
      if ( *a6 == v10 )
      {
        UsbhSshEnableDisable((__int64)a1, 5);
        v18 = 0;
      }
      else
      {
        UsbhSshEnableDisable((__int64)a1, 4);
        v18 = 1;
      }
      UsbhSetHubSelectiveSuspend((__int64)a1, v18);
      goto LABEL_12;
    }
LABEL_20:
    v14 = -1073741808;
    return WmiCompleteRequest(a1, a2, v14, 0, 0);
  }
  if ( v13 == 1 )
  {
    if ( *(&WPP_MAIN_CB.AlignmentRequirement + 1) == 3 )
    {
      Log((__int64)a1, v12, 2003659059, (__int64)a6, a5);
      if ( !a5 )
      {
LABEL_7:
        v14 = -1073741789;
      ...
      if ( *v15 )
        ...
        *(_DWORD *)(v16 + 2560) &= ~0x1000000u;
      Data = *v15 != 0;
      v17 = (PDEVICE_OBJECT *)FdoExt((__int64)a1);
