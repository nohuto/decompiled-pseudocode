/*
 * XREFs of Usbh_FDO_WaitPnpStart @ 0x1C001B980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Usbh_FDO_WaitPnpStart(__int64 a1, int a2)
{
  ...
  if ( (v14 & 0xC0000000) == 0xC0000000
    || ((v4[640] & 1) == 0 || v9
      ? (UsbhSetFdoPnpState(*(_QWORD *)(a1 + 8), 5LL, (unsigned int)v3), v17 = 0LL)
      : (UsbhSetFdoPnpState(*(_QWORD *)(a1 + 8), 6LL, (unsigned int)v3), v17 = 1LL),
