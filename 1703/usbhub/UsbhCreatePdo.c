/*
 * XREFs of UsbhCreatePdo @ 0x1C001FDA0
 * Callers:
...
LABEL_14:
  ...
  *((_DWORD *)DeviceExtension + 535) = v38.MaximumLength;
  ...
  v19 = UsbhBuildDeviceID(a1, 0LL, (__int64)(DeviceExtension + 2072));
  v10 = v19;
  v20 = a1;
  ...
  v21 = UsbhBuildHardwareID(a1, 0LL, (__int64)(DeviceExtension + 2088));
  v10 = v21;
  v20 = a1;
  ...
  v22 = UsbhBuildCompatibleID(a1, 0LL, (__int64)(DeviceExtension + 2104));
  v10 = v22;
...
LABEL_26:
    v20 = a1;
LABEL_27:
    Log(v20, 256, v32, (__int64)DeviceObject, v10);
    goto LABEL_28;
  }
  ...
  *(_DWORD *)(v24 + 72) = 1231318117;
  Log(a1, 0x2000, v26, (__int64)(DeviceExtension + 1616), (__int64)UsbhSS_WakeIrpRetryTimer);
  ...
  *(_QWORD *)(DeviceExtension + 900) = -1LL;
  ...
  if ( (v29 & 0xC0000000) != 0xC0000000 )
  {
    ...
    *((_DWORD *)DeviceExtension + 678) = 0;
    ...
    UsbhSetPortData(a1, (__int64)DeviceObject, (__int64)&v35);
    UsbhGetLocationIdString(a1, (__int64)DeviceObject, v30, (__int64)(DeviceExtension + 2216));
    DWORD1(v35) = 0;
