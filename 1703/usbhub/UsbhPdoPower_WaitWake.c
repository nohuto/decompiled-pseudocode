/*
 * XREFs of UsbhPdoPower_WaitWake @ 0x1C0020DF0
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    if ( (v4[353] & 0x100) != 0 )
    {
      if ( !v5 )
      {
        ...
        Log(*((_QWORD *)v4 + 147), 16, 2004306249, 0LL, (__int64)BugCheckParameter4);
        IoCsqInsertIrp((PIO_CSQ)(v4 + 568), BugCheckParameter4, 0LL);
        return 259LL;
      }
      v6 = -2147483631;
    }
