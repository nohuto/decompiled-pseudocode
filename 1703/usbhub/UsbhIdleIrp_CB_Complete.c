/*
 * XREFs of UsbhIdleIrp_CB_Complete @ 0x1C0056C5C
 * Callers:
...
__int64 __fastcall UsbhIdleIrp_CB_Complete(ULONG_PTR a1, __int64 a2, __int64 a3, int a4, int a5, KIRQL a6)
{
  __int64 v10; // r9
  _DWORD *v11; // r14
  __int64 v12; // rcx
  ...
  if ( a4 == 1 )
  {
    ...
    UsbhSetIdleIrpState((unsigned int)(a4 - 1), a2, 1, 4, a6);
    v13 = 2147483665LL;
  }
  else
  {
