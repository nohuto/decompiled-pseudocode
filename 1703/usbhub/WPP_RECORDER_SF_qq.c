/*
 * XREFs of WPP_RECORDER_SF_qq @ 0x1C004FDCC
 * Callers:
...
__int64 WPP_RECORDER_SF_qq(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_caf772459f30358e042199e29acd7158_Traceguids,
      11LL,
      (__int64 *)va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 11;
  return WppAutoLogTrace(a1, 0LL, 1LL, &WPP_caf772459f30358e042199e29acd7158_Traceguids, v7, (__int64 *)va);
}
