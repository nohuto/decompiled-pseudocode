/*
 * XREFs of Usbh_PdoSurpriseRemove_PdoEvent @ 0x1C0045170
 * Callers:
...
void __fastcall Usbh_PdoSurpriseRemove_PdoEvent(__int64 a1, struct _DEVICE_OBJECT *a2, __int64 a3)
{
  ...
  if ( v11[281] != 3 )
  {
    ...
    if ( UsbhFindListPdo(v17, (__int64)a2, (_QWORD *)v18 + 601)
      || (v19 = *((_QWORD *)v6 + 147), v20 = FdoExt(v19), UsbhFindListPdo(v19, (__int64)a2, (_QWORD *)v20 + 603)) )
    {
      v21 = *((_QWORD *)v6 + 147);
      v22 = FdoExt(v21);
      if ( UsbhFindListPdo(v21, (__int64)a2, (_QWORD *)v22 + 603) )
      {
        ...
        v24 = 4;
LABEL_17:
        SET_PDO_HWPNPSTATE((__int64)a2, v24, v23);
        *(_DWORD *)(a3 + 136) = 0;
        WPP_MAIN_CB.Dpc.DeferredRoutine = 0LL;
        *(_DWORD *)(a3 + 88) = 1734964085;
        KeReleaseSpinLock((PKSPIN_LOCK)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels, *(_BYTE *)(a3 + 132));
      ...
      v25 = v6 + 328;
      v26 = *((_QWORD *)v6 + 164);
      v27 = (_QWORD *)*((_QWORD *)v6 + 165);
      if ( *(_DWORD **)(v26 + 8) != v6 + 328 || (_QWORD *)*v27 != v25 )
        __fastfail(3u);
      *v27 = v26;
      *(_QWORD *)(v26 + 8) = v27;
      *v25 = 0LL;
  ...
  *(_DWORD *)(a3 + 88) = 1734964085;
  ...
  if ( PdoExt((__int64)a2)[197] != v9 )
  {
    ...
    UsbhSyncResumeDeviceInternal(*((_QWORD *)v6 + 147), a3, a2);
  ...
  if ( PortData )
  {
    ...
    UsbhPCE_SoftDisconnect(a1, *((_WORD *)v6 + 710), a3);
    KeSetEvent(v32, 0, 0);
  }
}
