/*
 * XREFs of UsbhGetSerialNumber @ 0x1C0022228
 * Callers:
...
__int64 __fastcall UsbhGetSerialNumber(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( v10 )
  {
    ...
    else
    {
      ...
      UsbhException(a1, *((unsigned __int16 *)v6 + 710), v14, (int)v10, v13, v11, v21, usbfile_idstring_c, v22, v23);
    }
