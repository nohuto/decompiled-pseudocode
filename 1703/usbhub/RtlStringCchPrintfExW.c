/*
 * XREFs of RtlStringCchPrintfExW @ 0x1C0026728
 * Callers:
 *     UsbhBusIfLocationGetLocationStrings @ 0x1C0026690 (UsbhBusIfLocationGetLocationStrings.c)
 * Callees:
 *     RtlStringVPrintfWorkerW @ 0x1C0026840 (RtlStringVPrintfWorkerW.c)
        ...
        ...)
{
  ...
  else
  {
    ...
    if ( (dwFlags & 0x100) != 0 )
    {
      v12 = (const wchar_t *)&unk_1C005E930;
      if ( pszFormat )
        v12 = pszFormat;
    }
    else
