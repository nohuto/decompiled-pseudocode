/*
 * XREFs of ?_SetTime@CAnimationClock@@AEAAJW4DWMPANIMATION_CLOCK_TIME@@PEBT_LARGE_INTEGER@@@Z @ 0x1800036A0
 * Callers:
 ...
 * Callees:
 *     ?_SetState@CAnimationClock@@AEAAJW4AnimationClockState@@@Z @ 0x18000383C (-_SetState@CAnimationClock@@AEAAJW4AnimationClockState@@@Z.c)
 *     ?_SetTimeToNextFrame@CAnimationClock@@AEAAJPEBT_LARGE_INTEGER@@PEAT2@@Z @ 0x180003C28 (-_SetTimeToNextFrame@CAnimationClock@@AEAAJPEBT_LARGE_INTEGER@@PEAT2@@Z.c)
    ...
    if ( ((a1[10].LowPart - 1) & 0xFFFFFFFD) == 0 )
    {
      ...
      if ( Frame >= 0 )
      {
        ...
        if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
          ((void (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))Template_ji)(
            v8,
