/*
 * XREFs of ?_AddWindow@CDesktopThumbnailBase@@IEAAJPEAVCTopLevelWindow@@@Z @ 0x18009E31C
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)&v16 = a2;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0xB5u);
    goto LABEL_11;
  }
...
LABEL_11:
  ...
  v8 = v17;
  VisualCollection::InsertRelative((CDesktopThumbnailBase *)((char *)this + 32), v17, 0LL, 0, 1);
LABEL_13:
  if ( v8 )
