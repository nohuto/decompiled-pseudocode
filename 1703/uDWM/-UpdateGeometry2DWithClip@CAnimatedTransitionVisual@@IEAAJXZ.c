/*
 * XREFs of ?UpdateGeometry2DWithClip@CAnimatedTransitionVisual@@IEAAJXZ @ 0x18008FD54
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::UpdateGeometry2DWithClip(CAnimatedTransitionVisual *this)
{
  ...
  v4 = _mm_cvtsi32_si128(*((_DWORD *)this + 206));
  v18 = 0LL;
  v19 = 0LL;
  rc.left = 0;
  rc.top = 0;
  ...
  v5 = RoundToNearestInt((float)(_mm_cvtepi32_ps(v3).m128_f32[0] + *((float *)this + 188)) - _mm_cvtepi32_ps(v4).m128_f32[0]);
  v6 = RoundToNearestInt((float)((float)*((int *)this + 215) + *((float *)this + 189)) - (float)*((int *)this + 207));
  OffsetRect(&rc, v5, v6);
  ...
  {
    v9 = (char *)this + 8;
    v10 = CRenderDataVisual::AddInstruction((CAnimatedTransitionVisual *)((char *)this + 8), v18);
    v8 = v10;
    if ( v10 >= 0 )
    {
