/*
 * XREFs of ?_initimpl@CImmersiveOrPrimaryMonitor@@CAJPEAUHMONITOR__@@QEAUSCALINGINFO@@@Z @ 0x180013D54
 * Callers:
 ...
 *     ?ResultFromKnownLastError@@YAJXZ @ 0x1800A0CA0 (-ResultFromKnownLastError@@YAJXZ.c)
