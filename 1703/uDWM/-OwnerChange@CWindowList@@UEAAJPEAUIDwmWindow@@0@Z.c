/*
 * XREFs of ?OwnerChange@CWindowList@@UEAAJPEAUIDwmWindow@@0@Z @ 0x1800308A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  {
LABEL_18:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xABFu);
    goto LABEL_7;
  }
  if ( v7 )
  {
    ...
    v17 = 2763;
LABEL_20:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, v17);
  }
LABEL_7:
