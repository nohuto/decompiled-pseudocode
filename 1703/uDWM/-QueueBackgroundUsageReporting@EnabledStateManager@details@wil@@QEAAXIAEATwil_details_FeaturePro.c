/*
 * XREFs of ?QueueBackgroundUsageReporting@EnabledStateManager@details@wil@@QEAAXIAEATwil_details_FeaturePropertyCache@@@Z @ 0x180046314
 * Callers:
        ...
        union wil_details_FeaturePropertyCache *a3)
{
  ...
  if ( *pv && !wil::ProcessShutdownInProgress((wil *)pv) )
  {
    ...
    v8 = a2;
    v9 = a3;
    wil::details_abi::heap_buffer::push_back((wil::details_abi::heap_buffer *)(pv + 40), &v8, v6);
    if ( !pv[24] )
    {
      if ( !*((_QWORD *)pv + 2) )
      {
