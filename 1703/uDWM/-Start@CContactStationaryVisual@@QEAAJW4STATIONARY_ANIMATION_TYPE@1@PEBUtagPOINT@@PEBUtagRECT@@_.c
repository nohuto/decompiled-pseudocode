/*
 * XREFs of ?Start@CContactStationaryVisual@@QEAAJW4STATIONARY_ANIMATION_TYPE@1@PEBUtagPOINT@@PEBUtagRECT@@_N@Z @ 0x18008B72C
 * Callers:
...
LABEL_28:
      v16 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024882, v45);
      goto LABEL_61;
    }
  }
  else
...
LABEL_61:
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v27, 0x7Du);
  }
LABEL_60:
  if ( v16 < 0 )
    goto LABEL_61;
