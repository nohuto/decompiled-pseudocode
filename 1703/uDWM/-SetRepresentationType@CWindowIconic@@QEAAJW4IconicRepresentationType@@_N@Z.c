/*
 * XREFs of ?SetRepresentationType@CWindowIconic@@QEAAJW4IconicRepresentationType@@_N@Z @ 0x18003D654
 * Callers:
 ...
 *     ??0?$CTimeline@I@@QEAA@NIIW4InterpolationMode@@@Z @ 0x180085F10 (--0-$CTimeline@I@@QEAA@NIIW4InterpolationMode@@@Z.c)
 */
  ...
  if ( a2 != v3 )
  {
    if ( a2 == 1 )
    {
      ...
      *(_QWORD *)(a1 + 64) = v9;
      ...
      {
        v4 = -2147024882;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x2C1u);
        return v4;
      }
...
LABEL_26:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, CentralImage, v12);
  }
  return v4;
}
