/*
 * XREFs of ?_IsEligibleForLivePreview@CLivePreview@@AEAA_NPEBVCWindowData@@@Z @ 0x180076240
 * Callers:
  ...
  if ( (*((_BYTE *)a2 + 594) & 0x20) == 0 )
  {
    if ( *((_QWORD *)a2 + 50) )
    {
      ...
      if ( (v4 & 1) != 0 && (*((_BYTE *)a2 + 596) & 1) == 0 && (v4 & 4) == 0 && (*((_DWORD *)a2 + 25) & 0x20000000) == 0 )
      {
        ...
        {
          v5 = (HWND)*((_QWORD *)a2 + 5);
          if ( v5 != GetDesktopWindow() && v5 != *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 74) )
          {
            CTopLevelWindow::GetLivePreviewWindowRect(*((CTopLevelWindow **)a2 + 50), &rcSrc1, 1);
            v6 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 356);
            v7 = _mm_srli_si128(*(__m128i *)((char *)CDesktopManager::s_pDesktopManagerInstance + 356), 8).m128i_u64[0];
            rcSrc2.left = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 356);
