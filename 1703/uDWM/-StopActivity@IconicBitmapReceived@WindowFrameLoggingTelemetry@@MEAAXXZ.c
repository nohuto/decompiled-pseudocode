/*
 * XREFs of ?StopActivity@IconicBitmapReceived@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x18007B0D0
 * Callers:
 *     <none>
 * Callees:
        ...
        WindowFrameLoggingTelemetry::IconicBitmapReceived *this)
{
  ...
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v7 + 24) & 0x200000000000LL) == *(_QWORD *)(v7 + 24) )
    {
      ...
      TlgWrite(v19, &unk_1800AF29C, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v20 + 3) & 0x200000000000LL) == *((_QWORD *)v20 + 3) )
    {
      ...
      v60 = 4;
      v59 = &v23;
      TlgWrite(v20, &unk_1800AF3A8, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v55);
    }
  }
  if ( *((_DWORD *)this + 8) )
    wil::details::ThreadFailureCallbackHolder::StopWatching((WindowFrameLoggingTelemetry::IconicBitmapReceived *)((char *)this + 8));
}
