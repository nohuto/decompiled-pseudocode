/*
 * XREFs of ??1CAnimationComponent@@UEAA@XZ @ 0x18000AB28
 * Callers:
 ...
 *     ?_LogEvent@CAnimationComponent@@IEAAXW4AnimationComponentEvent@1@@Z @ 0x18000AAEC (-_LogEvent@CAnimationComponent@@IEAAXW4AnimationComponentEvent@1@@Z.c)
  ...
  *(_QWORD *)this = &CAnimationComponent::`vftable';
  ...
  if ( (unsigned __int64)v2 - 1 <= 0xFFFFFFFFFFFFFFFDuLL )
  {
            ...
            0) )
    {
      ...
      WindowDataByHwnd = CWindowList::FindWindowDataByHwnd(*((CWindowList **)v3 + 51), v4);
      if ( WindowDataByHwnd )
