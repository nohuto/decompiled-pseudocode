/*
 * XREFs of ?RegisterIconicRepresentation@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCImmersiveWindowIconic@@HW4DEVICE_SCALE_FACTOR@@_NPEAW4IconicRepresentationType@@3@Z @ 0x18007BA38
 * Callers:
...
LABEL_6:
    v14 = v13;
LABEL_20:
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, v21);
