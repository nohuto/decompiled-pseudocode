/*
 * XREFs of ?NcAdornmentInfoQuery@CTopLevelWindow@@QEAAJPEAUNCADORNMENT_INFO@@@Z @ 0x18000B8B0
 * Callers:
...
__int64 __fastcall CTopLevelWindow::NcAdornmentInfoQuery(CTopLevelWindow *this, struct NCADORNMENT_INFO *a2)
{
  ...
  if ( v5 )
  {
    ...
    v4 = 0;
    v10 = 2 * (*((_BYTE *)this + 240) & 8 | 0x136LL);
    v11 = *(RECT *)(*((_QWORD *)this + 90) + 48LL);
    rcSrc2 = v11;
    rcSrc2.left = *(_DWORD *)((char *)this + v10) + _mm_cvtsi128_si32((__m128i)v11);
    rcSrc2.right = v11.right - *(_DWORD *)((char *)this + v10 + 4);
    rcSrc2.top = *(_DWORD *)((char *)this + v10 + 8) + v11.top;
    rcSrc2.bottom = v11.bottom - *(_DWORD *)((char *)this + v10 + 12);
