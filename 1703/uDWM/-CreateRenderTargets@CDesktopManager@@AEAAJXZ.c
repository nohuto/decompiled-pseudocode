/*
 * XREFs of ?CreateRenderTargets@CDesktopManager@@AEAAJXZ @ 0x1800229D0
 * Callers:
...
__int64 __fastcall CDesktopManager::CreateRenderTargets(CDesktopManager *this)
{
  ...
  if ( *((_QWORD *)this + 9) )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x3E6u);
    }
    else
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, DcompTargetsForNewGroup, 0x3EAu);
      }
      else if ( v14 )
      {
        v7 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD *))(*(_QWORD *)v20 + 432LL))(v20, v12, v14, v3);
        v8 = FailFastIfAccessDenied(v7);
        v2 = v8;
        if ( v8 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x401u);
        }
        else
        {
          ...
          if ( v9 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x403u);
          }
          else
          {
            v10 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance + 21)
                                                    + 24LL))(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 21));
            v2 = v10;
            if ( v10 < 0 )
              MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x405u);
            else
