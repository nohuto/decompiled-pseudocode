/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x180070E5C
 * Callers:
...
LABEL_17:
  ...
  if ( v17 )
    v19 = v17;
  Semaphore = (wil::details *)CreateSemaphoreExW(0LL, v17, v19, Name, 0, 0x1F0003u);
  if ( Semaphore )
  {
...
LABEL_39:
  ...
  if ( (_DWORD)v16 )
    v18 = v16;
  v33 = (wil::details *)CreateSemaphoreExW(0LL, v16, v18, Name, 0, 0x1F0003u);
  if ( v33 )
  {
    wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void wil::details::CloseHandle(void *),wistd::integral_constant<unsigned __int64,0>,void *,0,std::nullptr_t>>::reset(
      this + 1,
