/*
 * XREFs of ?_WindowEnumCallback@CVirtualDesktopSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x18009C1C0
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( (unsigned int)(v9 - 75) <= 1 )
      {
        ...
        if ( v8 )
        {
          while ( 1 )
          {
            ...
            if ( v14 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v14, 0x12AEu);
              goto LABEL_20;
            }
            ...
            *(_DWORD *)(v17 + 68) = 2;
            ...
            if ( v20 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v20, 0x12B5u);
              goto LABEL_17;
            }
          ...
          MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v18, 0x12B4u);
LABEL_17:
          if ( v19 )
            CBaseObject::Release(v19);
        }
    ...
    {
      v7 = -2147019873;
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, -2147019873, 0x1295u);
    }
  }
LABEL_20:
  *a4 = v7;
