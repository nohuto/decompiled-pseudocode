/*
 * XREFs of ?SetVisual@CDesktopThumbnailCVIVisual@@QEAAJPEAVCDesktopThumbnailCVI@@AEBUtagRECT@@@Z @ 0x18009DCEC
 * Callers:
        ...
        const struct tagRECT *a3)
{
  ...
  if ( v7 >= 0 )
  {
    v9 = CResource::Create(0x19u, *(_QWORD *)(*(_QWORD *)&this[1].left + 16LL), &v17);
    v8 = v9;
    if ( v9 >= 0 )
    {
