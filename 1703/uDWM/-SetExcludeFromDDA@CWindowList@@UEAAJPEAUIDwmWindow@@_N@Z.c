/*
 * XREFs of ?SetExcludeFromDDA@CWindowList@@UEAAJPEAUIDwmWindow@@_N@Z @ 0x180032D50
 * Callers:
...
__int64 __fastcall CWindowList::SetExcludeFromDDA(CWindowList *this, struct IDwmWindow *a2, unsigned __int8 a3)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, 0x775u);
  }
  else if ( v11 )
  {
    ...
    if ( v8 )
    {
      ...
      v7 = v9;
      if ( v9 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x779u);
    }
  }
