/*
 * XREFs of ?_SlideWindowHorizontally@CSlide@@IEAAJPEAVCWindowData@@AEBUtagRECT@@_NPEBU3@PEAPEAVCAnimationComponent@@@Z @ 0x1800014C8
 * Callers:
        ...
        struct CAnimationComponent **a6)
{
  ...
  tagRECT rc; // [rsp+60h] [rbp-19h] BYREF
  tagRECT v33; // [rsp+70h] [rbp-9h] BYREF
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v13, 0x11Cu);
    v15 = v30;
    goto LABEL_16;
  }
  v15 = v30;
