/*
 * XREFs of ?_UpdateResourcesForMonitorHelper@CLivePreview@@AEAAJPEBVCTopLevelWindow@@PEAULivePreviewResource@@@Z @ 0x1800773B8
 * Callers:
 ...
 *     ?CreateRoundRectRgnCoerceInvalid@@YAPEAUHRGN__@@HHHHHH@Z @ 0x18007509C (-CreateRoundRectRgnCoerceInvalid@@YAPEAUHRGN__@@HHHHHH@Z.c)
        ...
        struct LivePreviewResource *a3)
{
  ...
  if ( v6 && *(_BYTE *)(*((_QWORD *)a2 + 90) + 594LL) < 0x80u )
