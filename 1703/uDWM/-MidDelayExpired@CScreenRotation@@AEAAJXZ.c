/*
 * XREFs of ?MidDelayExpired@CScreenRotation@@AEAAJXZ @ 0x1800945A0
 * Callers:
    ...
    if ( v3 >= 0 )
    {
      ...
      *(_DWORD *)(v7 + 740) = 2;
      ...
      if ( v9 >= (unsigned int)v8 )
      {
        if ( v10 > v20 )
        {
          v11 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v18, 8u, 1, &v22);
          v3 = v11;
          if ( v11 < 0 )
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0xB5u);
      }
      if ( v3 >= 0 )
      {
        v12 = *((_QWORD *)this + 40);
        *(_DWORD *)(v12 + 736) = 76;
        *(_DWORD *)(v12 + 740) = 3;
        started = CAnimationEngine::ScheduleStartAnimation(v4, 76, (__int64)&v18, (unsigned int *)this + 90);
        v3 = started;
        if ( started >= 0 )
        {
