/*
 * XREFs of ?_WindowEnumCallback@CCrossFade@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x18009B590
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v9 != 18 )
  {
    switch ( *(_DWORD *)(a2 + 600) & 0xFFF )
    {
      ...
      case 61:
        ...
        if ( v15 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v15, 0x685u);
          goto LABEL_16;
        }
LABEL_9:
...
LABEL_22:
  ...
  if ( v17 >= 0 )
    goto LABEL_9;
  MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v17, 0x67Du);
LABEL_16:
  if ( v19 )
