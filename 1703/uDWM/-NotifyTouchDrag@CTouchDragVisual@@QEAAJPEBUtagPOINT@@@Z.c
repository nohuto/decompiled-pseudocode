/*
 * XREFs of ?NotifyTouchDrag@CTouchDragVisual@@QEAAJPEBUtagPOINT@@@Z @ 0x18004B4EC
 * Callers:
...
__int64 __fastcall CTouchDragVisual::NotifyTouchDrag(CTouchDragVisual *this, const struct tagPOINT *a2)
{
  ...
  if ( v7 )
  {
    v36 = *((_QWORD *)this + 40);
    v37 = v8 - *(_DWORD *)v36;
    if ( *((float *)this + 76) <= (float)((float)((float)((float)(*(float *)(v36 + 8) - (float)a2->y)
    ...
    {
      v38 = (CContactManager *)*((_QWORD *)this + 56);
      if ( v38 )
      {
  ...
  if ( v9 )
  {
    ...
    *((float *)&v41 + 3) = FLOAT_0_5;
    ...
    if ( *((_BYTE *)this + 440) && v7 )
    {
      v13 = (_DWORD *)((char *)this + 320);
      v14 = *((_QWORD *)this + 40);
      *(_OWORD *)v14 = v41;
      *(_QWORD *)(v14 + 16) = v42;
      *(_DWORD *)(v14 + 24) = v43;
    ...
    {
      v13 = (_DWORD *)((char *)this + 320);
      DynArray<TOUCH_DRAG_POINT,0>::InsertAt((char *)this + 320, &v41);
      ++v7;
    }
    *((_BYTE *)this + 440) = 0;
    if ( v7 > 1 )
    {
      ...
      if ( v7 > 2 )
      {
        ...
        *((_QWORD *)this + 51) = _mm_unpacklo_ps(v17, v18).m128_u64[0];
        *((float *)this + 104) = v21 - _mm_shuffle_ps(v25, v25, 255).m128_f32[0];
        CTouchDragVisualHelper::Normalize((CTouchDragVisual *)((char *)this + 408));
        if ( (float)((float)((float)((float)((float)(v20 * *((float *)this + 103))
                                           + (float)(v19 * *((float *)this + 102)))
                                   + (float)(v22 * *((float *)this + 104)))
                           / v23)
                   / v23) > 0.059999999 )
          goto LABEL_16;
        v24 = v7 == 2;
...
LABEL_20:
        ...
        else
        {
          ...
          while ( v27 < 2 );
          CTouchDragVisualHelper::SmoothTouchDragPath(v13, (__int64)this + 352);
        }
        goto LABEL_7;
      }
LABEL_16:
