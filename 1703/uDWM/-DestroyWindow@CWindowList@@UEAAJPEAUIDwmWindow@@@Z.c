/*
 * XREFs of ?DestroyWindow@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18002F380
 * Callers:
...
LABEL_3:
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x580u);
  if ( v5 < 0 )
  {
LABEL_21:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x5FFu);
    goto LABEL_6;
  }
  if ( v4 )
  {
