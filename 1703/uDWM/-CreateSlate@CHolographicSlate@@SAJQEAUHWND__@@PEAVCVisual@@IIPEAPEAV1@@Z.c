/*
 * XREFs of ?CreateSlate@CHolographicSlate@@SAJQEAUHWND__@@PEAVCVisual@@IIPEAPEAV1@@Z @ 0x1800795FC
 * Callers:
        ...
        struct CHolographicSlate **a5)
{
  ...
  if ( a5 )
  {
    ...
    if ( v11 )
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x21u);
      }
      if ( v11 )
    ...
    {
      v9 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024882, 0x1Fu);
    }
  }
  else
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x1Bu);
  }
  return v9;
}
