/*
 * XREFs of ?_WindowEnumCallback@CAppSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x18009AF60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CAppSwitch@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x1800963A0 (-GetPVLTarget@CAppSwitch@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
LABEL_81:
    ...
    case 0x2Bu:
      ...
      if ( v14 < 0 )
      {
        v27 = 2501;
LABEL_14:
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v14, v27);
        goto LABEL_80;
      }
      goto LABEL_62;
  }
