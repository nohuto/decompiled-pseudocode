/*
 * XREFs of ?ReleaseDesktopRenderTarget@CDesktopManager@@AEAAJXZ @ 0x180078DD4
 * Callers:
...
__int64 __fastcall CDesktopManager::ReleaseDesktopRenderTarget(CDesktopManager *this)
{
  ...
  if ( *((_QWORD *)this + 8) )
  {
    CWindowList::SetRenderTargetForDesktops(*((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 51), 0LL);
    ...
    if ( v3 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v3, 0x45Cu);
      return v1;
    }
