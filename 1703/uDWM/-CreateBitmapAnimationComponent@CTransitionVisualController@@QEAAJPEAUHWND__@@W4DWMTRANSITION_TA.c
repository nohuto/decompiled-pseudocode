/*
 * XREFs of ?CreateBitmapAnimationComponent@CTransitionVisualController@@QEAAJPEAUHWND__@@W4DWMTRANSITION_TARGET@@HPEAVCStoryboard@@PEAPEAVCAnimationComponent@@@Z @ 0x180092038
 * Callers:
    ...
    if ( v13 )
    {
      ...
      if ( v15 >= 0 )
      {
        ...
        CAnimatedTransitionVisual::SetBitmap(
          (CBaseObject **)v19,
          *(struct CResource ***)(*((_QWORD *)a1 + 19) + v16 + 48));
      ...
      {
        MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v15, 0x6AEu);
      }
      if ( v19 )
