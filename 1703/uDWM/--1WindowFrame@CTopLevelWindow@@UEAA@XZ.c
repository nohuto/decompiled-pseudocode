/*
 * XREFs of ??1WindowFrame@CTopLevelWindow@@UEAA@XZ @ 0x180042E74
 * Callers:
 ...
 *     ??1DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x180043140 (--1DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ.c)
 */
