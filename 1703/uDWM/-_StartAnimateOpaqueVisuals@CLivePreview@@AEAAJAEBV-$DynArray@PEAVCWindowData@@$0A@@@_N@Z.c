/*
 * XREFs of ?_StartAnimateOpaqueVisuals@CLivePreview@@AEAAJAEBV?$DynArray@PEAVCWindowData@@$0A@@@_N@Z @ 0x180076A3C
 * Callers:
 ...
 *     ?_ContainsWindow@CLivePreview@@AEAA_NAEBV?$DynArray@PEAVCWindowData@@$0A@@@PEAUHWND__@@@Z @ 0x180075F54 (-_ContainsWindow@CLivePreview@@AEAA_NAEBV-$DynArray@PEAVCWindowData@@$0A@@@PEAUHWND__@@@Z.c)
    ...
    do
    {
      if ( !a3 || (this = (CLivePreview *)*((_QWORD *)v7 + 42), *(_DWORD *)((char *)this + v11 + 40)) )
      {
        ...
        else if ( !*(_DWORD *)(v11 + v13 + 40) )
        {
          ...
          if ( v16 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0x209u);
            goto LABEL_24;
          }
