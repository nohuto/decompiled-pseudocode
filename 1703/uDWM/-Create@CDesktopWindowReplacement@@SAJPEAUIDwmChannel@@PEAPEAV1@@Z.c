/*
 * XREFs of ?Create@CDesktopWindowReplacement@@SAJPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x180042C6C
 * Callers:
...
__int64 __fastcall CDesktopWindowReplacement::Create(struct IDwmChannel *a1, struct CDesktopWindowReplacement **a2)
{
  ...
  if ( !a2 )
  {
    v7 = -2147024809;
LABEL_13:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x38Du);
    return v7;
  }
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x38Du);
  }
  else
  {
    *a2 = v5;
