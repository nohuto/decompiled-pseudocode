/*
 * XREFs of ?Initialize@CTransitionVisual@CAnimationEngine@@QEAAJXZ @ 0x1800131B0
 * Callers:
...
__int64 __fastcall CAnimationEngine::CTransitionVisual::Initialize(CAnimationEngine::CTransitionVisual *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( v6 == WPF::ProcessHeapImpl::Alloc )
      ...
      v7 = (_QWORD *)v6(WPF::g_pProcessHeap, 24uLL);
    if ( v7 )
    {
      *v7 = 0LL;
      v7[1] = 0LL;
  ...
  v1 = -2147024882;
  MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x602u);
  do
  {
    if ( *v2 )
    {
