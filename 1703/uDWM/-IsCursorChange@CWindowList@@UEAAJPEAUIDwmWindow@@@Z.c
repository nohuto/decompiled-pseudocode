/*
 * XREFs of ?IsCursorChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18003E8C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::IsCursorChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, 0x16DFu);
  }
  else
  {
    v6 = v10;
    if ( v10 )
    {
      ...
      *((_BYTE *)v6 + 596) &= ~2u;
      *((_BYTE *)v6 + 596) |= 2 * (v7 & 1);
      v8 = (CVisual *)*((_QWORD *)v6 + 50);
      if ( v8 )
        CVisual::SetIsCursor(v8, (*((_BYTE *)v6 + 596) & 2) != 0);
    }
  }
