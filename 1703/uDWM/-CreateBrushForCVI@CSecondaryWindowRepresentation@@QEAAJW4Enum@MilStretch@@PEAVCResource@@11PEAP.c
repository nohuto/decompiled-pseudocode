/*
 * XREFs of ?CreateBrushForCVI@CSecondaryWindowRepresentation@@QEAAJW4Enum@MilStretch@@PEAVCResource@@11PEAPEAV4@@Z @ 0x180039820
 * Callers:
        ...
        CBaseObject **a6)
{
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x45Du);
LABEL_12:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x48Eu);
LABEL_13:
  if ( v15 )
