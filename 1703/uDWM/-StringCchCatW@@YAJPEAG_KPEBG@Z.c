/*
 * XREFs of ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1800191BC
 * Callers:
 *     ?BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z @ 0x180089088 (-BuildFeedbackString@CContactManager@@IEAAJKPEAGI@Z.c)
 * Callees:
