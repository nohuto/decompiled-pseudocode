/*
 * XREFs of ?QueueDestroySprite@CWindowList@@QEAAJPEAVCWindowData@@@Z @ 0x1800351A0
 * Callers:
...
__int64 __fastcall CWindowList::QueueDestroySprite(CWindowList *this, struct CWindowData *a2)
{
  ...
  if ( v5 >= *((_DWORD *)this + 68) )
    return (unsigned int)DynArray<CWindowData *,0>::AddMultipleAndSet((__int64)v4, &v8, 0);
  return v2;
}
