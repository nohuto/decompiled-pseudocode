/*
 * XREFs of ?OnWindowSizeChange@CWindowPropertyTracker@@QEAAJPEBVCStoryboard@@PEBVCWindowData@@UtagSIZE@@@Z @ 0x18009C774
 * Callers:
        ...
        struct tagSIZE a4)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0x25u);
  }
