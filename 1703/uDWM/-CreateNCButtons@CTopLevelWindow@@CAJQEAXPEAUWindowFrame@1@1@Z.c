/*
 * XREFs of ?CreateNCButtons@CTopLevelWindow@@CAJQEAXPEAUWindowFrame@1@1@Z @ 0x1800455A0
 * Callers:
        ...
        struct CTopLevelWindow::WindowFrame *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( ThemeMargins < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, ThemeMargins, 0x38Cu);
      return v4;
    }
    if ( *(_DWORD *)(v20 + 24) )
    {
...
LABEL_31:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v21, 0x38Bu);
  return v4;
}
