/*
 * XREFs of ?OnTransitionWindow@CAppArrangementDelayed@@UEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@@Z @ 0x180097410
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (a3 & 0x20000000) != 0 && (a3 & 0xFFFu) - 38 <= 1 )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      *(struct tagRECT *)(v8 + 872) = *v7;
      ...
      {
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, DesktopThumbnail, 0xED4u);
      }
      if ( v11 )
    ...
    {
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v5, 0xED1u);
      v6 = v12;
    }
    if ( v6 )
