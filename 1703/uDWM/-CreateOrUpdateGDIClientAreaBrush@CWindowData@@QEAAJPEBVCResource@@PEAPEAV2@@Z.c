/*
 * XREFs of ?CreateOrUpdateGDIClientAreaBrush@CWindowData@@QEAAJPEBVCResource@@PEAPEAV2@@Z @ 0x1800829C4
 * Callers:
        ...
        struct CResource **a3)
{
  ...
  if ( *((_QWORD *)this + 48) )
  {
    ...
    if ( !v21 || (_InterlockedIncrement((volatile signed __int32 *)v21 + 2), (v6 = v33) == 0LL) )
    {
      ...
      if ( v27 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v27, 0x1857u);
LABEL_37:
        v6 = v33;
        goto LABEL_38;
      }
    ...
    if ( v28 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v28, 0x186Au);
LABEL_38:
      if ( v6 )
    ...
    if ( v31 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v31, 0x1880u);
      goto LABEL_38;
    }
  }
  if ( *a3 )
