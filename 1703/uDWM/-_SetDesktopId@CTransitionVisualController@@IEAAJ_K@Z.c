/*
 * XREFs of ?_SetDesktopId@CTransitionVisualController@@IEAAJ_K@Z @ 0x180007948
 * Callers:
...
LABEL_14:
    ...
    v2 = -2003304443;
LABEL_15:
    MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v7, v8);
    return v2;
  }
