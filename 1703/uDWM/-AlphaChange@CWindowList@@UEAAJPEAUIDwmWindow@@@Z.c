/*
 * XREFs of ?AlphaChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180030D70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OnAlphaChange@CLivePreview@@QEAAXPEBVCWindowData@@E@Z @ 0x1800381C4 (-OnAlphaChange@CLivePreview@@QEAAXPEBVCWindowData@@E@Z.c)
...
__int64 __fastcall CWindowList::AlphaChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, SyncedWindowData, 0xFDAu);
  }
  else
  {
    v6 = v13;
    if ( v13 )
    {
      *((_BYTE *)v6 + 352) = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 152LL))(a2);
      ...
      if ( *((_DWORD *)v6 + 116) )
      {
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0xFEEu);
      }
      else
      {
LABEL_8:
