/*
 * XREFs of ?UpdateSceneImpl@CDesktopManager@@AEAAJPEAVCVisual@@@Z @ 0x180022880
 * Callers:
  ...
  else
  {
    if ( (*((_BYTE *)a2 + 80) & 1) != 0 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v9 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x1ADu);
          goto LABEL_4;
        }
      }
      *((_DWORD *)a2 + 20) &= ~1u;
...
LABEL_4:
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v3, 0x4D9u);
  }
  else
  {
    for ( i = *((_QWORD *)v2 + 51);
      ...
      if ( *((_DWORD *)v2 + 130) )
      {
        if ( !*((_BYTE *)v2 + 18) )
        {
          *((_BYTE *)v2 + 18) = 1;
          ...
          v3 = v10;
          if ( v10 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x4EAu);
        }
      }
    }
  }
