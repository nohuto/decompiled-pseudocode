/*
 * XREFs of ?_Update3DResources@CAnimatedTransitionVisual@@IEAAJXZ @ 0x180090274
 * Callers:
 ...
 *     ?PerspectiveProjection@Matrix4x4F@D2D1@@SA?AV12@M@Z @ 0x18008F4AC (-PerspectiveProjection@Matrix4x4F@D2D1@@SA-AV12@M@Z.c)
 *     ?SetProduct@Matrix4x4F@D2D1@@QEAAXAEBV12@0@Z @ 0x18008F8A4 (-SetProduct@Matrix4x4F@D2D1@@QEAAXAEBV12@0@Z.c)
 */
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( v16 >= 0 )
    {
      ...
      if ( v17 >= 0 )
      {
        ...
        v12 = v18;
        if ( v18 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v18, 0x769u);
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v17, 0x765u);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0x75Du);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0x751u);
  }
  return v12;
}
