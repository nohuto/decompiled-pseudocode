/*
 * XREFs of ?PostStartAnimations@CDesktopManager@@QEAAJXZ @ 0x180022830
 * Callers:
...
__int64 __fastcall CDesktopManager::PostStartAnimations(CDesktopManager *this)
{
  ...
  *((_BYTE *)this + 18) = 0;
  SetLastError(0);
  if ( !PostThreadMessageW(*((_DWORD *)this + 144), 0x400u, 0LL, 0LL) )
  {
    ...
    v2 = LastError;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, LastError, 0x4FAu);
  }
  return v2;
}
