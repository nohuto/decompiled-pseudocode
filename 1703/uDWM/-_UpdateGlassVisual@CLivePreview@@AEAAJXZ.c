/*
 * XREFs of ?_UpdateGlassVisual@CLivePreview@@AEAAJXZ @ 0x18006E8CC
 * Callers:
    ...
    do
    {
      ...
      if ( (*(_BYTE *)(v10 + 594) & 0x40) == 0 )
      {
        ...
        else if ( !*(_QWORD *)(v9 + v8 + 16) )
        {
          ...
          if ( v12 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x63Cu);
            return v4;
          }
          v13 = v18;
          ...
          if ( inserted < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, inserted, 0x63Du);
            return v4;
          }
