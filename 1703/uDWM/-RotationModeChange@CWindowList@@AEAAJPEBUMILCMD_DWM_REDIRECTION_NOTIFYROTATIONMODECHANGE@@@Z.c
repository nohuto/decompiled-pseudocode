/*
 * XREFs of ?RotationModeChange@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_NOTIFYROTATIONMODECHANGE@@@Z @ 0x1800850C4
 * Callers:
  ...
  if ( *((_DWORD *)a2 + 1) )
  {
          ...
          v5 >= 0) )
    {
      ...
      if ( v7 >= 0 )
      {
        ...
        v4 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0x15E9u);
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x15E7u);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x15DEu);
    }
  }
  else
  {
