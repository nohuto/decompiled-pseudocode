/*
 * XREFs of ?CloneVisualTree@CClientArea@@UEAAJPEAPEAVCVisual@@_N11@Z @ 0x18001A010
 * Callers:
...
__int64 __fastcall CClientArea::CloneVisualTree(CClientArea *this, struct CVisual **a2, bool a3, bool a4, bool a5)
{
  ...
  if ( v5 )
  {
    ...
    if ( v11 )
    {
      ...
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x84u);
      }
      else
      {
        v13 = *((_QWORD *)this + 2);
        ...
        if ( v14 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x88u);
        }
        else
        {
          *a2 = v17;
          ...
          v6 = v15;
          if ( v15 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x93u);
        }
      }
    }
  }
