/*
 * XREFs of ?_RegisterIconicRepresentation@CIconicBitmapRegistry@@AEAAJPEAVCWindowData@@PEAUHWND__@@_N2222PEAW4IconicRepresentationType@@@Z @ 0x18003E638
 * Callers:
        ...
        enum IconicRepresentationType *a9)
{
  ...
  *(_DWORD *)a9 = v12;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0xB2u);
  }
  return v9;
}
