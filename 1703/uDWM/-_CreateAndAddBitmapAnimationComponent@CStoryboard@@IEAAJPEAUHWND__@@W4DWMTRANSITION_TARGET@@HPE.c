/*
 * XREFs of ?_CreateAndAddBitmapAnimationComponent@CStoryboard@@IEAAJPEAUHWND__@@W4DWMTRANSITION_TARGET@@HPEAPEAVCAnimationComponent@@@Z @ 0x180097FE8
 * Callers:
        ...
        volatile signed __int32 **a5)
{
  ...
  if ( BitmapAnimationComponent >= 0 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v9, 0x14F0u);
      goto LABEL_8;
    }
    *a5 = v8;
    if ( !v8 )
