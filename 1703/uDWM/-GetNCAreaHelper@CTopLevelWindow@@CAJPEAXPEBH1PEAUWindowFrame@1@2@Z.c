/*
 * XREFs of ?GetNCAreaHelper@CTopLevelWindow@@CAJPEAXPEBH1PEAUWindowFrame@1@2@Z @ 0x180044A50
 * Callers:
 ...
 *     ?SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z @ 0x180045230 (-SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z.c)
        ...
        struct CTopLevelWindow::WindowFrame *a5)
{
  ...
  v42 = a1;
  v8 = a1;
  if ( (dword_1800C11C0 & 1) == 0 )
  {
    dword_1800C115C = -2147023728;
    dword_1800C11C0 |= 1u;
  }
  ...
  if ( ThemeMargins < 0 )
  {
    iPropId = 967;
LABEL_61:
    MilInstrumentationCheckHR(0x14u, &dword_1800C115C, 1u, ThemeMargins, iPropId);
    return v10;
  }
...
LABEL_27:
  ...
  ThemeMargins = CTopLevelWindow::CreateBitmapsFromAtlasImageStrip(v8, v30, 2u, &pMargins, &v35);
  v10 = ThemeMargins;
