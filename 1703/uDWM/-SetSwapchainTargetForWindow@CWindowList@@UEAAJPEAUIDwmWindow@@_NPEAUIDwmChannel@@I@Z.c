/*
 * XREFs of ?SetSwapchainTargetForWindow@CWindowList@@UEAAJPEAUIDwmWindow@@_NPEAUIDwmChannel@@I@Z @ 0x1800855A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  ...
  SyncedWindowData = (*(__int64 (__fastcall **)(struct IDwmChannel *, _QWORD, struct IDwmChannel *, unsigned int *))(*(_QWORD *)a4 + 104LL))(
                       a4,
                       a5,
                       v10,
                       &v18);
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v15, 0x11CEu);
    v9 = v19;
    goto LABEL_14;
  }
  v9 = v19;
  SyncedWindowData = CTopLevelWindow::SetSwapchainTarget(*((CTopLevelWindow **)v14 + 50), a5, a3, v19);
  v12 = SyncedWindowData;
  if ( SyncedWindowData < 0 )
  {
    v17 = 4559;
...
LABEL_14:
  if ( v18 )
    (*(void (__fastcall **)(struct IDwmChannel *))(*(_QWORD *)v10 + 128LL))(v10);
  if ( v9 )
