/*
 * XREFs of ?HrCheckPixelRect@CBitmap@@IEAAJPEBUWICRect@@PEAUtagRECT@@@Z @ 0x1800A2C34
 * Callers:
...
__int64 __fastcall CBitmap::HrCheckPixelRect(CBitmap *this, const struct WICRect *a2, struct tagRECT *a3)
{
  ...
  if ( rcSrc1.left < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x28Eu);
    return v5;
  }
  Width = a2->Width;
  v11 = -1;
  ...
  if ( (v5 & 0x80000000) != 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x28Fu);
    return v5;
  }
  v12 = left + v11;
  v13 = -1;
  ...
  if ( v12 < left )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x290u);
    return v5;
  }
  v14 = -1;
  v15 = -1;
  ...
  if ( v13 > 0x7FFFFFFF )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x291u);
    return v5;
  }
  v16 = -1;
  if ( Y >= 0 )
  ...
  if ( Y < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x293u);
    return v5;
  }
  Height = a2->Height;
  v18 = -1;
  ...
  if ( (v5 & 0x80000000) != 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x294u);
    return v5;
  }
  v19 = v16 + v18;
  if ( v19 >= v16 )
  ...
  if ( v19 < v16 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x295u);
    return v5;
  }
  if ( v6 <= 0x7FFFFFFF )
    v14 = v6;
  ...
  if ( v6 > 0x7FFFFFFF )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x296u);
    return v5;
  }
