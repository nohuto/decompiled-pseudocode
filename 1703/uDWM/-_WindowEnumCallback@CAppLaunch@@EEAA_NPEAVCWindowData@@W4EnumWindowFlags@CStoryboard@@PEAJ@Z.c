/*
 * XREFs of ?_WindowEnumCallback@CAppLaunch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x18009AD30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetPVLTarget@CAppLaunch@@UEAAHW4DWMTRANSITION_TARGET@@@Z @ 0x180096360 (-GetPVLTarget@CAppLaunch@@UEAAHW4DWMTRANSITION_TARGET@@@Z.c)
...
LABEL_7:
    ...
    v11 = v12;
    if ( v12 < 0 )
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v12, 0x909u);
    goto LABEL_28;
  }
  ...
  if ( *(_BYTE *)(a1 + 168) )
  {
    ...
    v11 = v15;
    if ( v15 < 0 )
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v15, 0x913u);
    goto LABEL_13;
  }
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v17, 0x919u);
LABEL_13:
    v8 = v23;
    goto LABEL_26;
  }
