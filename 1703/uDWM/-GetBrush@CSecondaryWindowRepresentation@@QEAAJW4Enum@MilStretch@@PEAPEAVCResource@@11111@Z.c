/*
 * XREFs of ?GetBrush@CSecondaryWindowRepresentation@@QEAAJW4Enum@MilStretch@@PEAPEAVCResource@@11111@Z @ 0x1800399AC
 * Callers:
        ...
        CBaseObject **a8)
{
  ...
  if ( a3 )
  {
    ...
    if ( !v45 )
    {
      v13 = CResource::Create(0x1Au, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v45);
      v14 = v13;
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x3A3u);
        goto LABEL_66;
      }
    }
  }
  if ( a4 )
  {
    ...
    if ( !v46 )
    {
      v16 = CResource::Create(0x1Au, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v46);
      v14 = v16;
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x3ADu);
        goto LABEL_66;
      }
    }
  }
  if ( a6 )
  {
    ...
    if ( !v47 )
    {
      v18 = CResource::Create(0x20u, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v47);
      v14 = v18;
      if ( v18 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v18, 0x3C1u);
        goto LABEL_66;
      }
    }
  }
  ...
  if ( v19 )
  {
    ...
    if ( Brush >= 0 )
      goto LABEL_39;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, Brush, 0x3C8u);
    goto LABEL_64;
  }
  if ( a7 && (v20 = *a7) != 0LL )
  {
  ...
  else
  {
    ...
    if ( v21 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v21, 0x3D2u);
      goto LABEL_66;
    }
  }
  v49 = 0;
...
LABEL_34:
  ...
  if ( v32 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v32, 0x408u);
    goto LABEL_66;
  }
...
LABEL_39:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v34, 0x40Au);
LABEL_64:
  if ( v50 )
