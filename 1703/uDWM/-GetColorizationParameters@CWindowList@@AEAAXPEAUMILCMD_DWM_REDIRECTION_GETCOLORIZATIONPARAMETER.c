/*
 * XREFs of ?GetColorizationParameters@CWindowList@@AEAAXPEAUMILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS@@@Z @ 0x1800333FC
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS *a2)
{
  ...
  v3 = *(__m128i *)((char *)CDesktopManager::s_pDesktopManagerInstance + 452);
  v4 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 119);
