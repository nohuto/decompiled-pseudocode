/*
 * XREFs of ?UpdateInfoIfTaskbar@CImmersiveState@@AEAA_NPEBVCWindowData@@@Z @ 0x18000A594
 * Callers:
 ...
 *     wcscmp_0 @ 0x18004DEA2 (wcscmp_0.c)
 */
...
LABEL_9:
        ...
        if ( GetMonitorInfoW(v6, &mi) )
        {
          ...
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v18 < (unsigned int)v17 ? 0x80070216 : 0, 0xB5u);
          }
