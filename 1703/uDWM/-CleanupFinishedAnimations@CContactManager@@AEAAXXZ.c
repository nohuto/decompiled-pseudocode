/*
 * XREFs of ?CleanupFinishedAnimations@CContactManager@@AEAAXXZ @ 0x180070700
 * Callers:
 ...
 *     ?IsOKToCleanup@CFlickVisual@@UEAA_NXZ @ 0x1800899A0 (-IsOKToCleanup@CFlickVisual@@UEAA_NXZ.c)
 ...
 *     ?IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ @ 0x18008B700 (-IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ.c)
...
LABEL_17:
  ...
  if ( v14 >= 0 )
  {
    ...
    while ( 1 )
    {
      v17 = *(__int64 **)(*v15 + v16 + 8);
      if ( !v17 )
        goto LABEL_23;
      if ( CTouchPressHoldVisual::IsOKToCleanup(*(CTouchPressHoldVisual **)(*v15 + v16 + 8)) )
        break;
LABEL_24:
      v16 -= 16LL;
      if ( --v14 < 0 )
