/*
 * XREFs of ?UpdateDestinationRect@CThumbnailVisual@@QEAAJXZ @ 0x180038664
 * Callers:
  ...
  if ( *((_QWORD *)this + 50) && *((_QWORD *)this + 51) )
  {
    ...
    *((_QWORD *)&v60 + 1) = __PAIR64__(v10, v9);
    ...
    if ( IsImmersiveIconic )
    {
      ...
      if ( v34 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v34, 0x3F4u);
        return v2;
      }
      v35 = *((_QWORD *)this + 47);
      v36 = 0;
      ...
      v47 = *((_QWORD *)this + 50);
      v66 = (float)v45 + v43;
      v48 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *))(**(_QWORD **)(v47 + 16) + 304LL))(
              *(_QWORD *)(v47 + 16),
              *(unsigned int *)(v47 + 24),
              &v63);
      v2 = v48;
      if ( v48 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v48, 0x3FEu);
        return v2;
      }
    }
    else
    {
      ...
      v65 = (float)v9 + 0.0;
      v66 = (float)v10 + 0.0;
      v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *))(**(_QWORD **)(v11 + 16) + 304LL))(
              *(_QWORD *)(v11 + 16),
              *(unsigned int *)(v11 + 24),
              &v63);
      v2 = v12;
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x40Bu);
        return v2;
      }
    }
    v13 = *((_QWORD *)this + 58);
    ...
    else
    {
      if ( v13 )
      {
        v52 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 34);
        ...
        v55 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 35);
...
LABEL_17:
        ...
        *(double *)&v62[2] = v21;
        ...
        {
          v22 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, int *))(**(_QWORD **)(*((_QWORD *)this + 51) + 16LL) + 312LL))(
          ...
          if ( v22 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v22, 0x42Du);
            return v2;
          }
          v23 = *(_OWORD *)v62;
          *((_BYTE *)this + 474) = 1;
...
LABEL_20:
        ...
        if ( (unsigned __int8)CThumbnailVisual::_HasBorder(this) && *((_QWORD *)this + 53) )
        {
          ...
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, RectangleGeometry, 0x443u);
            return v2;
          }
          v57 = *((_DWORD *)this + 30);
          v58 = *((_DWORD *)this + 31);
        ...
        *(__m128i *)((char *)this + 532) = v6;
        ...
        if ( *v24 )
        {
          ...
          v2 = v25;
          if ( v25 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v25, 0x45Cu);
        }
        return v2;
      }
      v15 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 34);
      if ( v9 < v15 )
        v15 = v9;
      v16 = _mm_cvtsi32_si128(v15);
      v17 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 35);
