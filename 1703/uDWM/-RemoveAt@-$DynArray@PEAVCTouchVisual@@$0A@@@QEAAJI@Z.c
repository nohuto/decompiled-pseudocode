/*
 * XREFs of ?RemoveAt@?$DynArray@PEAVCTouchVisual@@$0A@@@QEAAJI@Z @ 0x18008B13C
 * Callers:
 ...
 *     ??1CImmersiveIconicBitmapRegistry@@UEAA@XZ @ 0x18007B4D4 (--1CImmersiveIconicBitmapRegistry@@UEAA@XZ.c)
