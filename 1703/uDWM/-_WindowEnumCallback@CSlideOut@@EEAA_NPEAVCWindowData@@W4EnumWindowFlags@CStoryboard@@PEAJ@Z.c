/*
 * XREFs of ?_WindowEnumCallback@CSlideOut@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800016D0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (v10 & 0xFFF) != 0 )
  {
    if ( (*(_DWORD *)(a2 + 600) & 0xFFF) == 8 )
    {
      ...
      *(_DWORD *)(a2 + 600) |= 0x200000u;
      ...
      v4 = v33;
      if ( v33 < 0 )
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v33, 0x3BBu);
      else
        *(_BYTE *)(*((_QWORD *)v35 + 5) + 976LL) = 1;
      goto LABEL_21;
    }
      ...
      *(_DWORD *)(a2 + 600) |= 0x200000u;
      ...
      if ( v32 >= 0 )
        *(_DWORD *)(a2 + 600) = v10;
        ...
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v32, 0x3C6u);
      goto LABEL_28;
    }
    if ( (*(_DWORD *)(a2 + 600) & 0xFFF) != 0x18 && (*(_DWORD *)(a2 + 600) & 0xFFF) != 0x2A )
    {
      if ( (*(_DWORD *)(a2 + 600) & 0xFFF) == 0x45 )
      {
        ...
        v4 = v23;
        if ( v23 < 0 )
          MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v23, 0x3D4u);
        goto LABEL_21;
      }
      if ( (*(_DWORD *)(a2 + 600) & 0xFFF) == 0x46 )
      {
        ...
        v4 = v22;
        if ( v22 < 0 )
          MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v22, 0x3CFu);
        goto LABEL_21;
      }
...
LABEL_26:
    ...
    if ( CWindowPropertyTracker::IsWindowTrackedAndCloakChanged(
           ...
           *(HWND *)(a2 + 40),
           1)
      || ((v24 = *(_DWORD *)(a2 + 600) & 0xFFF, v24 == 42) || v24 == 87)
      && !CTransitionVisualController::HasVisibleStyle(*(HWND *)(a2 + 40)) )
    {
      ...
      if ( WindowDataByHwnd )
      {
        *((_DWORD *)WindowDataByHwnd + 150) = *(_DWORD *)(a2 + 600) & 0xEBFFF000 | 0x1400002A;
        ...
        {
          v27 = (*(__int64 (__fastcall **)(CSlide *, _QWORD))(*(_QWORD *)a1 + 88LL))(a1, *(unsigned int *)(a2 + 600));
          v28 = CStoryboard::_CreateAndAddNullComponentWithWindow(a1, (struct CWindowData *)a2, v27, &v35);
          v4 = v28;
          if ( v28 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v28, 0x377u);
LABEL_21:
            if ( v35 )
          ...
          if ( v29 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v29, 0x378u);
LABEL_51:
            v5 = v36;
            goto LABEL_21;
          }
        ...
        else
        {
          ...
          if ( v30 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v30, 0x380u);
            goto LABEL_21;
          }
          ...
          if ( v31 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v31, 0x381u);
            goto LABEL_51;
          }
          v5 = v36;
...
LABEL_9:
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v12, 0x38Bu);
          goto LABEL_21;
        }
        v13 = v35;
        CAnimatedTransitionVisual::SetBeginAlpha(*((CAnimatedTransitionVisual **)v35 + 5), 1.0);
        *(_BYTE *)(*((_QWORD *)v13 + 5) + 969LL) = 1;
        if ( (*(_DWORD *)(a2 + 600) & 0xFFF) == 0x18 )
          *(_BYTE *)(*((_QWORD *)v13 + 5) + 976LL) = 1;
      }
      if ( v35 && *((_DWORD *)v35 + 17) != 2 )
        *((_DWORD *)v35 + 17) = 3;
      if ( v5 && *((_DWORD *)v5 + 17) != 2 )
        *((_DWORD *)v5 + 17) = 3;
      v14 = (*(__int64 (__fastcall **)(CSlide *, _QWORD))(*(_QWORD *)a1 + 88LL))(a1, *(_DWORD *)(a2 + 600) & 0xFFF);
      v15 = CStoryboard::_CreateAndAddBlurBehindComponent(a1, (struct CWindowData *)a2, v14, &v37);
      v4 = v15;
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v15, 0x3A1u);
        v6 = v37;
      }
      else
      {
  ...
  else if ( v10 < 0 )
  {
    ...
    v4 = v34;
    if ( v34 < 0 )
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v34, 0x3DDu);
  }
LABEL_28:
  result = 1;
  *v7 = v4;
