/*
 * XREFs of ?ShouldShowTransition@CWindowArrangementTransition@@AEAA_NPEAVCWindowData@@@Z @ 0x180088390
 * Callers:
        ...
        struct CWindowData *a2)
{
  ...
  if ( (*((_BYTE *)a2 + 592) & 1) == 0 )
    return 0;
  v5 = (CLivePreview *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 54);
