/*
 * XREFs of ?GetEffectiveGlassColorizationParameters@CDesktopManager@@QEAAXMU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@_NPEAVCGlassColorizationParameters@@@Z @ 0x18006FEF0
 * Callers:
        ...
        _OWORD *a5)
{
  ...
  v5 = (__int64)a5;
  *a5 = *(_OWORD *)(a1 + 452);
  *(_QWORD *)(v5 + 16) = *(_QWORD *)(a1 + 468);
  *(_DWORD *)(v5 + 24) = *(_DWORD *)(a1 + 476);
  v7 = *(_DWORD *)(a1 + 416);
  if ( !a4 && *(_BYTE *)(a1 + 24) )
    a3 |= 4u;
  if ( *(_BYTE *)(a1 + 480) )
