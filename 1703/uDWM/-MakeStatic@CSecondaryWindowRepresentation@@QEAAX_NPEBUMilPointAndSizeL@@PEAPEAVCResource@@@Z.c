/*
 * XREFs of ?MakeStatic@CSecondaryWindowRepresentation@@QEAAX_NPEBUMilPointAndSizeL@@PEAPEAVCResource@@@Z @ 0x18007F584
 * Callers:
  ...
  if ( v4 )
  {
      ...
      && (int)CWindowSnapshot::GetCVI(v9, (const struct tagRECT *)(v4 + 48), &v15, (float *)this + 126) >= 0 )
    {
      ...
      *a4 = v15;
      ...
      (*(void (__fastcall **)(_QWORD, _QWORD, struct tagRECT *))(**((_QWORD **)v14 + 2) + 1008LL))(
        *((_QWORD *)v14 + 2),
        *((unsigned int *)v14 + 6),
        &v16);
