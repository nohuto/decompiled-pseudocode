/*
 * XREFs of ?_EnumerateWindows@CStoryboard@@IEAAJW4EnumWindowFlags@1@@Z @ 0x180005AD0
 * Callers:
...
__int64 __fastcall CStoryboard::_EnumerateWindows(struct _GUID *a1, unsigned int a2)
{
  ...
  {
    v13 = -2147467259;
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, -2147467259, 0x1454u);
  }
