/*
 * XREFs of ?EnsureThumbnailVisual@CDCompVirtualDesktopThumbnailData@@UEAAJXZ @ 0x180083400
 * Callers:
...
__int64 __fastcall CDCompVirtualDesktopThumbnailData::EnsureThumbnailVisual(CDCompVirtualDesktopThumbnailData *this)
{
  ...
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0x1DA3u);
    return v3;
  }
  if ( *((_QWORD *)this + 13) )
    return v3;
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v5, 0x1DABu);
    goto LABEL_22;
  }
  v6 = v19;
  *((_QWORD *)v19 + 35) = this;
  *((_QWORD *)v6 + 34) = *(_QWORD *)(*((_QWORD *)this + 2) + 120LL);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0x1DADu);
    goto LABEL_23;
  }
    ...
    *((_QWORD *)v10 + 3) = v6;
    ...
    if ( v13 >= 0 )
    {
      ...
      *((_BYTE *)v14 + 337) = 1;
      ...
      if ( v16 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0x1DB9u);
LABEL_22:
        v6 = v19;
        goto LABEL_23;
      }
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x1DB4u);
    }
    v4 = v20;
    goto LABEL_22;
  }
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v8, 0x1DB0u);
LABEL_23:
  if ( v6 )
