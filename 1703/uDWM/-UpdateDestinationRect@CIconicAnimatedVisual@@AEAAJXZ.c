/*
 * XREFs of ?UpdateDestinationRect@CIconicAnimatedVisual@@AEAAJXZ @ 0x1800A0408
 * Callers:
          ...
          *(float *)&v32[3] = (float)v20 + v18;
          ...
          if ( v22 >= 0 )
          {
            ...
            *(double *)&v33[1] = (double)v27;
            ...
            v5 = v30;
            if ( v30 < 0 )
              MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v30, 0xABu);
          }
          else
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v22, 0xA3u);
          }
        }
      }
    }
