/*
 * XREFs of ?CloneVisualTree@CVisual@@UEAAJPEAPEAV1@_N11@Z @ 0x180023E90
 * Callers:
...
__int64 __fastcall CVisual::CloneVisualTree(CVisual *this, struct CVisual **a2)
{
  ...
  else
  {
    ...
    if ( v26 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v26, 0x629u);
      v2 = v31;
LABEL_53:
      if ( v2 )
...
LABEL_4:
  ...
  while ( 1 )
  {
    ...
    if ( (*((_BYTE *)v20 + 84) & 8) == 0 )
    {
      ...
      if ( v30 )
      {
        inserted = VisualCollection::InsertRelative((CBaseObject *)((char *)v2 + 32), v30, 0LL, 0, 1);
        v4 = inserted;
        if ( inserted < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, inserted, 0x644u);
          goto LABEL_53;
        }
        v23 = v30;
        v9 = CCanvasVisual::CloneVisualTree;
        ...
        if ( v30 )
        {
          if ( _InterlockedExchangeAdd((volatile signed __int32 *)v30 + 2, 0xFFFFFFFF) == 1 && v23 )
            (**(void (__fastcall ***)(struct CVisual *, __int64, __int64 (__fastcall *)(CCanvasVisual *, struct CVisual **, bool, bool, bool), __int64 (__fastcall *)(CClientArea *, struct CVisual **, bool, bool, bool)))v23)(
              v23,
              1LL,
  ...
  if ( *((_DWORD *)this + 28) != *((_DWORD *)v2 + 28) || *((_DWORD *)this + 29) != *((_DWORD *)v2 + 29) )
  {
    *((_QWORD *)v2 + 14) = *((_QWORD *)this + 14);
    ...
    if ( v24 == CVisual::SetDirtyFlags )
      ...
      ((void (__fastcall *)(CBaseObject *, __int64, __int64 (__fastcall *)(CCanvasVisual *, struct CVisual **, bool, bool, bool), __int64 (__fastcall *)(CClientArea *, struct CVisual **, bool, bool, bool)))v24)(
        v2,
        8LL,
        CCanvasVisual::CloneVisualTree,
        CClientArea::CloneVisualTree);
