/*
 * XREFs of ?Initialize@CDirectTouchVisual@@MEAAJPEAUIDwmChannel@@@Z @ 0x180040FB0
 * Callers:
...
__int64 __fastcall CDirectTouchVisual::Initialize(CDirectTouchVisual *this, struct IDwmChannel *a2)
{
  ...
  else
  {
    if ( *(_BYTE *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 18) + 324LL) )
    {
      ...
      BitmapFromAtlas = CTopLevelWindow::CreateBitmapFromAtlas(Theme, 7, 0LL, (struct CBitmapSource **)this + 52);
      v5 = BitmapFromAtlas;
    ...
    else
    {
      ...
      v7 = CTopLevelWindow::CreateBitmapFromAtlas(v6, 2, 0LL, (struct CBitmapSource **)this + 52);
      v5 = v7;
      if ( v7 < 0 )
      {
    ...
    v8 = (struct CVisual **)((char *)this + 408);
    v9 = *(_QWORD *)(*((_QWORD *)this + 52) + 24LL);
    *((_DWORD *)this + 86) = 0;
    *((_QWORD *)this + 40) = v9;
    *((_BYTE *)this + 400) = 0;
    *((_DWORD *)this + 87) = 1065353216;
    *((_DWORD *)this + 88) = 1065353216;
    *((_DWORD *)this + 89) = 1068708659;
    *((_DWORD *)this + 90) = 1067030938;
    *((_DWORD *)this + 85) = 1033476506;
    *((_DWORD *)this + 91) = 1028443341;
    *((_DWORD *)this + 82) = 1040522936;
    *((_DWORD *)this + 83) = 1061481551;
    *((_DWORD *)this + 84) = 1047285445;
    v10 = CImage::Create(a2, (struct CImage **)this + 51);
    v5 = v10;
    if ( v10 < 0 )
    {
    ...
    else
    {
      ...
      {
        CVisual::SetSize((struct tagSIZE *)*v8, (const struct tagSIZE *)this + 40);
        *((_QWORD *)this + 47) = 0LL;
        *((_QWORD *)this + 48) = 0LL;
        *((_QWORD *)this + 49) = 0LL;
        *((_BYTE *)this + 280) = 0;
