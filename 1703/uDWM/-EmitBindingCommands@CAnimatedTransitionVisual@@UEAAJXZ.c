/*
 * XREFs of ?EmitBindingCommands@CAnimatedTransitionVisual@@UEAAJXZ @ 0x180006D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAnimatedTransitionVisual::EmitBindingCommands(CAnimatedTransitionVisual *this)
{
  ...
  else
  {
    ...
    {
      HIDWORD(v25) = 0;
      v20 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 85) + 16LL) + 1136LL))(
    ...
    {
      HIDWORD(v25) = 0;
      v22 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 87) + 16LL) + 1144LL))(
