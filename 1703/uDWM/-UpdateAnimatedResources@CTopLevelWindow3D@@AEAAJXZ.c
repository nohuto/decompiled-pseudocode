/*
 * XREFs of ?UpdateAnimatedResources@CTopLevelWindow3D@@AEAAJXZ @ 0x18002D8C0
 * Callers:
...
__int64 __fastcall CTopLevelWindow3D::UpdateAnimatedResources(CTopLevelWindow3D *this)
{
  ...
  if ( v16 )
    v8 = *(double *)(v16 + 48);
  if ( (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)((float)*((double *)this + 23) - v8)) & _xmm) > 0.0000011920929 )
  {
    v17 = *(_QWORD *)this;
    *((double *)this + 23) = v8;
  ...
  LODWORD(v88) = *((_DWORD *)this + 114) ^ _xmm;
  ...
  v38 = v35 * (float)(v33 + v33);
  v39 = v32 * (float)(v33 + v33);
  v40 = v35 * (float)(v34 + v34);
  v41 = v32 * (float)(v34 + v34);
  v42 = v33 * (float)(v33 + v33);
  LODWORD(v67) = 0;
  v43 = v32 * (float)(v32 + v32);
  v44 = v34 * (float)(v34 + v34);
  *(_DWORD *)&v71[4] = 0;
  v45 = v34 * v36;
  *((float *)&v66 + 1) = v39 - v40;
  *(float *)&v70 = v39 + v40;
  *((float *)&v65 + 1) = (float)(1.0 - v44) - v42;
  v69 = COERCE_UNSIGNED_INT(v45 + v37);
  *((float *)&v70 + 1) = v45 - v37;
  *(float *)&v66 = v41 + v38;
  *((float *)&v67 + 1) = v41 - v38;
  v68 = (float)(1.0 - v43) - v42;
  *(_OWORD *)&v71[8] = _xmm;
  *(float *)v71 = (float)(1.0 - v43) - v44;
  D2DMatrixMultiply(
    (struct D2DMatrix *)&v81,
    (const struct D2DMatrix *)&v81,
    (const struct D2DMatrix *)((char *)&v65 + 4));
  v46 = *((float *)this + 114) - *((float *)this + 117);
  v47 = *((float *)this + 115) - *((float *)this + 118);
  *(_QWORD *)v71 = 1065353216LL;
  v70 = 0LL;
  *(float *)&v71[8] = v46;
  v48 = *((float *)this + 116) - *((float *)this + 119);
  *(float *)&v71[12] = v47;
  v69 = 0LL;
  v67 = 0LL;
  v66 = 0LL;
  ...
  *(_DWORD *)&v71[20] = 1065353216;
  ...
  D2DMatrixMultiply(
    ...
    (const struct D2DMatrix *)&v81,
    (const struct D2DMatrix *)((char *)&v65 + 4));
  v49 = (_DWORD *)*((_QWORD *)this + 42);
  v50 = v49[22];
  v51 = v49[20] - v49[23];
  v78 = v49[24];
  v80 = v49[21] - v49[25];
  v52 = v50 + *((_DWORD *)this + 77);
  v77 = v50;
  v79 = v51;
  v53 = (float)v52;
  v54 = 0;
  v55 = v51 - v50;
  v56 = (float)(v78 + *((_DWORD *)this + 78));
  if ( v55 < 0 )
    v55 = 0;
  if ( v80 - v78 >= 0 )
    v54 = v80 - v78;
  ...
  *(_DWORD *)&v71[20] = 1065353216;
  ...
  D2DMatrixMultiply(
    ...
    (const struct D2DMatrix *)&v81,
    (const struct D2DMatrix *)((char *)&v65 + 4));
  v58 = v57 * *((float *)this + 117);
  *(_QWORD *)v71 = 1065353216LL;
  v60 = v59 * *((float *)this + 118);
  v70 = 0LL;
  v61 = v6 + *((float *)this + 119);
  v69 = 0LL;
  v67 = 0LL;
  *(float *)&v71[16] = v61;
  v66 = 0LL;
  ...
  *(float *)&v71[12] = (float)(v56 + v76) + v60;
  ...
  v92[0] = v81;
  v92[1] = *(float *)&v82;
  result = (*(__int64 (__fastcall **)(_QWORD, _QWORD, double *))(**(_QWORD **)(v62 + 16) + 1152LL))(
             *(_QWORD *)(v62 + 16),
             *(unsigned int *)(v62 + 24),
             v92);
  v64 = result;
  if ( (int)result < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, result, 0x2E1u);
    return v64;
  }
  return result;
}
