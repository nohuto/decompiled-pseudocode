/*
 * XREFs of ?_AddImmersiveBackground@CLivePreview@@AEAAJAEAV?$DynArray@UtagRECT@@$0A@@@@Z @ 0x18006ED38
 * Callers:
 ...
 *     ?_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ @ 0x1800768F4 (-_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ.c)
...
__int64 __fastcall CLivePreview::_AddImmersiveBackground(__int64 a1, __int64 a2)
{
  ...
  struct CAccent *v27; // [rsp+48h] [rbp-41h] BYREF
...
LABEL_11:
    ...
    if ( v15 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v15, 0x442u);
      v3 = v26;
      goto LABEL_33;
    }
    v3 = v26;
    ...
    if ( v17 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v17, 0x44Au);
      goto LABEL_33;
    }
    v18 = v24;
    v19 = (_QWORD *)(a1 + 432);
    ...
    *(struct tagRECT *)&v30.m256i_u64[1] = v31;
    ...
    if ( v21 >= (unsigned int)v20 )
    {
      ...
      {
        v22 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v19, 0x20u, 1, &v30);
        if ( v22 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v22, 0xC0u);
      }
      else
      {
        *(__m256i *)(*v19 + 32 * v20) = v30;
        *(_DWORD *)(a1 + 456) = v18;
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v21 < (unsigned int)v20 ? 0x80070216 : 0, 0xB5u);
    }
LABEL_25:
    v7 = *(_QWORD *)(a1 + 552);
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x43Cu);
  v2 = v27;
LABEL_33:
  if ( (v5 & 0x80000000) == 0 )
  {
