/*
 * XREFs of ?UpdateBackgroundWithClip@CAnimatedTransitionVisual@@IEAAJXZ @ 0x180007384
 * Callers:
...
__int64 __fastcall CAnimatedTransitionVisual::UpdateBackgroundWithClip(CAnimatedTransitionVisual *this)
{
  ...
  v1 = *(struct tagRECT *)((char *)this + 856);
  v2 = *((_DWORD *)this + 211);
  v3 = (const RECT *)((char *)this + 840);
  v4 = (struct CResource **)((char *)this + 712);
  v5 = *((_DWORD *)this + 213);
  ...
  else
  {
    ...
    {
      v16 = CRenderDataVisual::AddInstruction((CAnimatedTransitionVisual *)((char *)this + 8), v25);
      v12 = v16;
      if ( v16 < 0 )
      {
      ...
      {
        v17 = RoundToNearestInt(*((float *)this + 189));
        v18 = RoundToNearestInt(*((float *)this + 188));
