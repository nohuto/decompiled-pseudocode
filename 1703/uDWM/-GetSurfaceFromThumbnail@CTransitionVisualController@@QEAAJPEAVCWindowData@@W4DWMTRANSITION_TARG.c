/*
 * XREFs of ?GetSurfaceFromThumbnail@CTransitionVisualController@@QEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@PEBUtagRECT@@_NPEAPEAVCResource@@4PEAUMilPoint3F@@@Z @ 0x1800080FC
 * Callers:
        ...
        float *a8)
{
  ...
  *(_QWORD *)&v29 = a4;
  ...
  if ( v21 >= 0 )
  {
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v22, 0x9AEu);
      goto LABEL_26;
    }
    if ( *a7 )
...
LABEL_25:
  ...
  MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2u, v21, 0x990u);
  v8 = v25;
LABEL_26:
  if ( v20 )
