/*
 * XREFs of DwmpCalculateColorizationColor @ 0x180016A70
 * Callers:
...
__int64 __fastcall DwmpCalculateColorizationColor(int *a1, int *a2)
{
  ...
  v8 = (float)*((unsigned __int8 *)a1 + 1) / 255.0;
  v9 = (float)((float)((float)((float)(v8 * 0.71520001) + (float)(v6 * 0.21259999)) + (float)(v7 * 0.0722)) * v4) * v5;
