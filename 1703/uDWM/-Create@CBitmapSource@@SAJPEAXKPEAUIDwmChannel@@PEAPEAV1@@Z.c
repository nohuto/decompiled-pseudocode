/*
 * XREFs of ?Create@CBitmapSource@@SAJPEAXKPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x180044480
 * Callers:
...
__int64 __fastcall CBitmapSource::Create(void *a1, unsigned int a2, struct IDwmChannel *a3, struct CBitmapSource **a4)
{
  ...
  v6 = CCompressedSourceBitmap::Create(
         *((struct IWICImagingFactory **)CDesktopManager::s_pDesktopManagerInstance + 28),
         a1,
         a2,
         96.0,
         96.0,
...
LABEL_20:
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x76u);
  }
  else
  {
