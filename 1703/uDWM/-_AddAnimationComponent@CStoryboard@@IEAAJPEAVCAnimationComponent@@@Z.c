/*
 * XREFs of ?_AddAnimationComponent@CStoryboard@@IEAAJPEAVCAnimationComponent@@@Z @ 0x1800057BC
 * Callers:
...
__int64 __fastcall CStoryboard::_AddAnimationComponent(CStoryboard *this, struct CAnimationComponent *a2)
{
  ...
  {
    v9 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 88, 8LL, 1LL, &v10);
    v6 = v9;
    if ( v9 < 0 )
  ...
  {
    *(_QWORD *)(*((_QWORD *)this + 11) + 8 * v3) = v10;
    *((_DWORD *)this + 28) = v4;
  }
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v6, 0x1546u);
LABEL_15:
    CStoryboard::_RemoveAnimationComponent(this, v10);
    return (unsigned int)v6;
  }
  v7 = CTransitionVisualController::AddAnimationComponent(
         *((CTransitionVisualController **)CDesktopManager::s_pDesktopManagerInstance + 23),
         v10);
  v6 = v7;
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1u, v7, 0x1547u);
    goto LABEL_15;
  }
  return (unsigned int)v6;
}
