/*
 * XREFs of ?SetVisual@CAnimatedTransitionVisual@@QEAAJPEAVCVisual@@_NPEBUtagRECT@@@Z @ 0x1800378B0
 * Callers:
        ...
        const struct tagRECT *a4)
{
  ...
  else
  {
    ...
    if ( a4 )
    {
      ...
      v11 = _mm_cvtsi32_si128(*((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 89));
      v12 = _mm_cvtsi32_si128(*((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 91));
      v13 = _mm_cvtsi32_si128(*((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 90));
      v14 = _mm_cvtsi32_si128(*((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 92));
      v15 = 0;
    ...
    *(_QWORD *)&v35.right = 0LL;
    ...
    if ( v25 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v25, 0x2FAu);
    }
    else if ( a3
           && (v28 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)this[73] + 2) + 1000LL))(
                       *((_QWORD *)this[73] + 2),
                       *((unsigned int *)this[73] + 6)),
               v9 = v28,
               v28 < 0) )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v28, 0x301u);
    }
    else
    {
