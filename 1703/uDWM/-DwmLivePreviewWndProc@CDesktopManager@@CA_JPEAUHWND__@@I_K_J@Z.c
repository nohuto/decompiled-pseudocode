/*
 * XREFs of ?DwmLivePreviewWndProc@CDesktopManager@@CA_JPEAUHWND__@@I_K_J@Z @ 0x1800784F0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( Msg == 71 )
    {
      if ( (*(_BYTE *)(lParam + 32) & 0x40) != 0 )
      {
        ...
        else
        {
          ...
          if ( v13 >= 0 )
            v13 = -2003304445;
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x7DDu);
        }
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
        v9 = v13 < 0;
LABEL_26:
    ...
    if ( Msg != 257 )
    {
      if ( Msg == 1028 )
      {
        ...
        if ( !SetWindowPos(wParam, 0LL, 0, 0, 0, 0, lParam != 0 ? 67 : 83) )
        {
          ...
          if ( v12 >= 0 )
            v12 = -2003304445;
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v12, 0x7C7u);
          v9 = wParam == hWnd;
        }
        v10 = 0;
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
...
LABEL_27:
  CLivePreview::Activate(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 54), 0, 0LL, 0LL, 1, 0, 0, 0LL);
LABEL_28:
  if ( v10 )
    goto LABEL_29;
LABEL_30:
