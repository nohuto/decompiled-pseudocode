/*
 * XREFs of ?ImmediateDestroyWindow@CWindowList@@AEAAXPEAVCWindowData@@@Z @ 0x18003461C
 * Callers:
 ...
 *     ?_ClearBitmap@CImmersiveIconicBitmapRegistry@@AEAAXPEAUHWND__@@@Z @ 0x180016074 (-_ClearBitmap@CImmersiveIconicBitmapRegistry@@AEAAXPEAUHWND__@@@Z.c)
...
void __fastcall CWindowList::ImmediateDestroyWindow(CWindowList *this, struct CWindowData *a2)
{
  ...
  CBaseObject *v28; // rcx
  __int64 v29; // rbx
  CImmersiveIconicBitmapRegistry::CImmersiveIconicResource *v30; // rsi
  ...
  while ( *((_DWORD *)a2 + 116) )
  {
    v35 = (struct CSecondaryWindowRepresentation **)*((_QWORD *)a2 + 55);
    v36 = *v35;
  ...
  if ( *((_QWORD *)a2 + 53) )
  {
    ...
    {
      v37 = *(CWindowData **)(*((_QWORD *)a2 + 69) + 8LL * i);
      if ( (*((_DWORD *)v37 + 25) & 0x20000000) == 0 )
        CWindowData::ClearSnapshot(v37, 0, 0, 0);
    }
  }
  ...
  CLivePreview::OnWindowShowHide(*((CLivePreview **)CDesktopManager::s_pDesktopManagerInstance + 54), a2, 0LL, 1);
...
LABEL_15:
  ...
  for ( j = 0; j < *((_DWORD *)v11 + 174); ++j )
  {
    v42 = *(_QWORD *)(*((_QWORD *)v11 + 84) + 8LL * j);
    (*(void (__fastcall **)(__int64, struct CWindowData *))(*(_QWORD *)v42 + 176LL))(v42, a2);
  }
  ...
  {
    v29 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 27);
    IconicResourceNoRef = CImmersiveIconicBitmapRegistry::_GetIconicResourceNoRef(
                            (CImmersiveIconicBitmapRegistry *)v29,
                            *((HWND *)a2 + 5));
    v30 = IconicResourceNoRef;
    DynArray<CImmersiveIconicBitmapRegistry::CImmersiveIconicResource *,0>::Remove(
      (__int64 *)(v29 + 16),
      (__int64 *)&IconicResourceNoRef);
    if ( v30 )
      CImmersiveIconicBitmapRegistry::CImmersiveIconicResource::`scalar deleting destructor'(v30, v31);
    CImmersiveIconicBitmapRegistry::_ClearBitmap((CImmersiveIconicBitmapRegistry *)v29, *((HWND *)a2 + 5));
    for ( k = 0; k < *(_DWORD *)(v29 + 72); ++k )
    {
      v46 = *(_QWORD *)(*(_QWORD *)(v29 + 48) + 8LL * k);
      v47 = *(_QWORD *)(v46 + 296);
      if ( v47 )
        v48 = *(_QWORD *)(v47 + 40);
      else
  ...
  else
  {
    ...
    *((_BYTE *)a2 + 594) &= 0xF1u;
    ...
    CIconicBitmapRegistry::ClearBitmap(v17, (CWindowIconic **)a2);
  }
  v18 = (CBaseObject *)*((_QWORD *)a2 + 46);
  if ( v18 )
  {
