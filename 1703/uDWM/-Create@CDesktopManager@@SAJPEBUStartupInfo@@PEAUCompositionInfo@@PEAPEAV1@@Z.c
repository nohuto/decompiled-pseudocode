/*
 * XREFs of ?Create@CDesktopManager@@SAJPEBUStartupInfo@@PEAUCompositionInfo@@PEAPEAV1@@Z @ 0x18004A1F8
 * Callers:
        ...
        struct CDesktopManager **a3)
{
  ...
  if ( v6 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800AB3E4, 1u, v7, 0x4B6u);
    }
    else
    {
      g_pdmInstance = v6;
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR(0x14u, &dword_1800AB3E4, 1u, -2147024882, 0x4B2u);
  }
