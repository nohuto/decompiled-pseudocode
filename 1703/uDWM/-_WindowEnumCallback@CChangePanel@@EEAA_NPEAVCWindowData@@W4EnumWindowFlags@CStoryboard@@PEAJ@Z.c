/*
 * XREFs of ?_WindowEnumCallback@CChangePanel@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x18009B500
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CChangePanel::_WindowEnumCallback(CFade *a1, struct CWindowData *a2, char a3, int *a4)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    if ( (*((_DWORD *)a2 + 150) & 0xFFF) == 0x28 )
    {
      ...
      v4 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v7, 0x638u);
    }
    else if ( (*((_DWORD *)a2 + 150) & 0xFFF) == 0x29 )
    {
      ...
      v4 = v6;
      if ( v6 < 0 )
        MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v6, 0x634u);
    }
  }
  *a4 = v4;
  return 1;
