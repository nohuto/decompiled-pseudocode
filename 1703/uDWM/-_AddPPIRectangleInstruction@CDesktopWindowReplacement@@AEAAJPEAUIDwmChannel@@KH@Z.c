/*
 * XREFs of ?_AddPPIRectangleInstruction@CDesktopWindowReplacement@@AEAAJPEAUIDwmChannel@@KH@Z @ 0x18007901C
 * Callers:
  ...
  if ( SystemMetrics )
  {
    ...
    *((float *)&v13 + 3) = *((float *)&v13 + 1) + 4.0;
    ...
    if ( v7 >= 0 )
    {
      ...
      *((_OWORD *)v8 + 1) = v12;
      v9 = CRenderDataVisual::AddInstruction(this, v8);
      v6 = v9;
      if ( v9 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0x70u);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x6Du);
    }
    if ( v8 )
