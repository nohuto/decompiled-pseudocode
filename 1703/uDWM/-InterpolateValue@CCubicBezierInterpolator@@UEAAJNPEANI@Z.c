/*
 * XREFs of ?InterpolateValue@CCubicBezierInterpolator@@UEAAJNPEANI@Z @ 0x180093D60
 * Callers:
 *     <none>
 * Callees:
 *     ?GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z @ 0x180093AC0 (-GetFinalValue@CCubicBezierInterpolator@@UEAAJPEANI@Z.c)
 */
    ...
    if ( a4 )
    {
      ...
      do
      {
        a3[v16] = v14 * *(double *)(v16 * 8 + *((_QWORD *)this + 3))
                + (float)(1.0 - v14) * *(double *)(v16 * 8 + *((_QWORD *)this + 2));
        ++v16;
        --v15;
      }
      while ( v15 );
