/*
 * XREFs of ?QueryThumbnailType@CWindowList@@AEAAJKPEAUMILCMD_DWM_REDIRECTION_QUERYTHUMBNAILTYPE@@@Z @ 0x18008483C
 * Callers:
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( v11 >= 0 )
        *((_DWORD *)a3 + 3) = CSecondaryWindowRepresentation::GetThumbnailType((__int64)v13);
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, 0xD62u);
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v9, 0xD61u);
    }
  }
  else
  {
