/*
 * XREFs of ?OnMagnifierCreate@CMagnifierControl@@AEAAJPEAUHWND__@@H@Z @ 0x18007DE9C
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierCreate(struct IDwmChannel **this, HWND a2, int a3)
{
  ...
  if ( (dword_1800C4708 & 1) == 0 )
  {
    dword_1800C4604 = -2147023728;
    dword_1800C4708 |= 1u;
  }
  v19 = 0LL;
  ...
  {
    v8 = -2147024809;
    MilInstrumentationCheckHR(0x14u, &dword_1800C4604, 1LL, -2147024809, 0x1FEu);
    return v8;
  }
...
LABEL_6:
    v9 = IsMagnifier;
LABEL_19:
    MilInstrumentationCheckHR(0x14u, &dword_1800C4604, 1LL, v9, v17);
    goto LABEL_20;
  }
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR(0x14u, &dword_1800C4604, 1LL, -2147024882, 0x1F8u);
