/*
 * XREFs of ?LivePreviewBitmapReceived@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEBUtagPOINT@@PEBX_KK@Z @ 0x18007A23C
 * Callers:
        ...
        char a9)
{
  ...
  CBaseObject *v34; // [rsp+40h] [rbp-48h] BYREF
  struct tagRECT v35; // [rsp+48h] [rbp-40h] BYREF
  DWORD v36; // [rsp+98h] [rbp+10h] BYREF
  ...
  {
    if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
      Template_qp(v17, (__int64)&UdwmManageIconicThumbnail_Info, 1, *((_QWORD *)a2 + 5));
    v33 = 663;
LABEL_47:
    v18 = -2147024809;
    MilInstrumentationCheckHR(0x14u, (const int *const)"W", 1LL, -2147024809, v33);
    return v18;
  }
  v25 = *((_QWORD *)v13 + 12);
  if ( v25 && *(struct CWindowData **)(v25 + 72) == a2 )
  {
    ...
    if ( v26 >= 0 )
    {
      if ( *((_BYTE *)v13 + 89) )
      {
        ...
        v18 = v27;
        if ( v27 < 0 )
          MilInstrumentationCheckHR(0x14u, (const int *const)"W", 1LL, v27, 0x2A8u);
      }
      v28 = a6;
      v29 = *((_BYTE *)v13 + 88);
      v9 = v34;
      ...
      *((struct tagPOINT *)v13 + 13) = *v28;
      ...
      if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
        Template_qp(v31, (__int64)&UdwmManageIconicThumbnail_Info, 0, *((_QWORD *)a2 + 5));
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, (const int *const)"W", 1LL, v26, 0x2A3u);
      v9 = v34;
    }
  }
  else
