/*
 * XREFs of ?Start@CFlickVisual@@QEAAJPEBUtagPOINT@@W4FLICK_TYPE@@I@Z @ 0x18008DE0C
 * Callers:
...
LABEL_40:
    ...
    if ( BitmapFromAtlas >= 0 )
    {
      ...
      *(_DWORD *)(a1 + 316) = top + *(_DWORD *)(a1 + 340) + v26;
      CContactManager::PostFlickFeedbackUpdate(*((_QWORD *)v27 + 18), v29, v28, (_QWORD *)(a1 + 312), 1u);
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x42u);
  }
  if ( v12 < 0 )
    goto LABEL_40;
  return (unsigned int)v12;
