/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x180078754
 * Callers:
...
__int64 __fastcall CDesktopManager::EnableInputHooksHelper(char a1, char a2, const unsigned __int16 *a3, HWND *a4)
{
  ...
  if ( !a1 )
  {
    ...
    v15 = (HWND)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 75);
    if ( v15 )
    {
      if ( IsWindow(v15) )
        CDesktopManager::SetForegroundWindowAsync(*a4, *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 75), v16);
      *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 75) = 0LL;
    }
...
LABEL_18:
  ...
  {
    v19 = *(_OWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 356);
    v8 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 364);
    v9 = v19;
  }
  ...
  if ( WindowInBand )
  {
    *a4 = WindowInBand;
    ...
    if ( a2 )
      return v4;
    *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 75) = ForegroundWindow;
    ...
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800B0840, 2LL, v13, 0x96Eu);
    }
    goto LABEL_18;
  }
  v4 = -2147024890;
  MilInstrumentationCheckHR(0x14u, &dword_1800B0840, 2LL, -2147024890, 0x95Du);
LABEL_19:
  if ( a1 )
