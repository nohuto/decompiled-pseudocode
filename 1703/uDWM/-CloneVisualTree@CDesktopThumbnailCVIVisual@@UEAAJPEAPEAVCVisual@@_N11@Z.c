/*
 * XREFs of ?CloneVisualTree@CDesktopThumbnailCVIVisual@@UEAAJPEAPEAVCVisual@@_N11@Z @ 0x18009CFE0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool a5)
{
  ...
  if ( v10 >= 0 )
  {
    ...
    if ( v13 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v13, 0x20Bu);
      goto LABEL_13;
    }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0x204u);
  }
  v12 = v19;
LABEL_13:
  if ( v12 )
