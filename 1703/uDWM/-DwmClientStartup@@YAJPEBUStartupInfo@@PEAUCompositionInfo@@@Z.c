/*
 * XREFs of ?DwmClientStartup@@YAJPEBUStartupInfo@@PEAUCompositionInfo@@@Z @ 0x18004A180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DwmClientStartup(const struct StartupInfo *a1, struct CompositionInfo *a2)
{
  ...
  if ( (dword_1800C11B0 & 1) == 0 )
  {
    dword_1800C1148 = -2147024846;
    dword_1800C11B0 |= 1u;
    dword_1800C114C = -2003302655;
  }
  ...
  v6 = v5;
  if ( v5 < 0 )
    MilInstrumentationCheckHR(0x14u, &dword_1800C1148, 2u, v5, 0x4Bu);
