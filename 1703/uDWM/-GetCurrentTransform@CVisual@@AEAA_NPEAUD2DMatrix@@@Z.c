/*
 * XREFs of ?GetCurrentTransform@CVisual@@AEAA_NPEAUD2DMatrix@@@Z @ 0x18000C648
 * Callers:
...
char __fastcall CVisual::GetCurrentTransform(CVisual *this, struct D2DMatrix *a2)
{
  ...
  v8 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)((float)*((double *)this + 21) - 1.0)) & _xmm);
  if ( v8 > 0.0000011920929
    || (v9 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)((float)*((double *)this + 22) - 1.0)) & _xmm),
        v9 > 0.0000011920929) )
  {
    v5 = 1;
    v4 = 1;
  }
  v10 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)*((double *)this + 20)) & _xmm);
  ...
  {
    v12 = *((double *)this + 18);
    v13 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)v12) & _xmm);
    if ( v13 > 0.0000011920929
      || (v14 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)*((double *)this + 19)) & _xmm), v14 > 0.0000011920929) )
    {
      *(_QWORD *)&v15 = *((_QWORD *)this + 19) ^ _xmm;
      v33 = 0;
      v31 = 0;
      v30 = 0;
      v29 = 0;
    ...
    if ( v6 )
    {
      D2DMatrixRotationZ((struct D2DMatrix *)&v22, *((double *)this + 20) * 0.01745329238474369);
      D2DMatrixMultiply(a2, a2, (const struct D2DMatrix *)&v22);
    }
    if ( v7 )
    {
