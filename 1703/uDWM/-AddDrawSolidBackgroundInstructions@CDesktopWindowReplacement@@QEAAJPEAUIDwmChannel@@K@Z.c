/*
 * XREFs of ?AddDrawSolidBackgroundInstructions@CDesktopWindowReplacement@@QEAAJPEAUIDwmChannel@@K@Z @ 0x180015634
 * Callers:
  ...
  if ( v7 )
  {
    ...
    if ( v8 )
    {
      ...
      else
      {
        ...
        {
          v13 = CRenderDataVisual::AddInstruction(this, v20);
          v10 = v13;
          if ( v13 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x49u);
          }
