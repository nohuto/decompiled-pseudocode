/*
 * XREFs of ?SetSolidFill@CRectangleInstruction@@QEAAJAEBU_D3DCOLORVALUE@@N@Z @ 0x1800158B8
 * Callers:
        ...
        double a3)
{
  ...
  v4 = (char *)this + 16;
  if ( *((_QWORD *)this + 2) || (v6 = CResource::Create(33LL, *((_QWORD *)this + 5)), v7 = v6, v6 >= 0) )
  {
    v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, const struct _D3DCOLORVALUE *, _DWORD, _DWORD, _DWORD))(**(_QWORD **)(*(_QWORD *)v4 + 16LL) + 1176LL))(
