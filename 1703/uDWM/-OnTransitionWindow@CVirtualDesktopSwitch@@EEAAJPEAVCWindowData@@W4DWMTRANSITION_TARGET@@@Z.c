/*
 * XREFs of ?OnTransitionWindow@CVirtualDesktopSwitch@@EEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@@Z @ 0x180097570
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( DesktopThumbnail >= 0 )
    {
      ...
      if ( *(_DWORD *)(a1 + 176) )
      {
        ...
        while ( 1 )
        {
          ...
          if ( v3 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v3, 0x124Cu);
            goto LABEL_26;
          }
          v18 = 0LL;
          if ( ++v8 >= *(_DWORD *)(a1 + 176) )
...
LABEL_26:
  ...
  if ( v3 >= 0 )
    v3 = -2003304445;
  MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v3, 0x1243u);
LABEL_28:
  if ( v18 )
