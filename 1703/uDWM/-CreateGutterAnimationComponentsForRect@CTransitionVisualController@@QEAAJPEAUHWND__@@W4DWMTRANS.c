/*
 * XREFs of ?CreateGutterAnimationComponentsForRect@CTransitionVisualController@@QEAAJPEAUHWND__@@W4DWMTRANSITION_TARGET@@HPEBUtagRECT@@2PEAVCStoryboard@@PEAPEAVCAnimationComponent@@4@Z @ 0x180092B24
 * Callers:
        ...
        volatile signed __int32 **a9)
{
  ...
  if ( v13 )
  {
            ...
            (const struct CTransitionVisualController::FakeGutterInfo *)&v52) )
    {
      ...
      if ( v31 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &CTransitionVisualController::MILINSTRUMENTATIONHRESULTLIST, 2LL, v31, 0x653u);
LABEL_17:
        v10 = v36;
        goto LABEL_21;
      }
