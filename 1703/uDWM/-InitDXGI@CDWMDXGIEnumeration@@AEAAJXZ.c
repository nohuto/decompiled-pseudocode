/*
 * XREFs of ?InitDXGI@CDWMDXGIEnumeration@@AEAAJXZ @ 0x18000ECD0
 * Callers:
...
LABEL_50:
    v16 = v3;
LABEL_53:
    MilInstrumentationCheckHR(0x14u, &dword_1800AB370, 1u, v16, v17);
LABEL_34:
    if ( ppFactory )
  ...
  while ( (*(unsigned int (__fastcall **)(void *, _QWORD, __int64 *))(*(_QWORD *)ppFactory + 96LL))(ppFactory, v2, &v21) != -2005270526 )
  {
    ...
    {
      v9 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 56, 8LL, 1LL, v22);
      v4 = v9;
      if ( v9 < 0 )
