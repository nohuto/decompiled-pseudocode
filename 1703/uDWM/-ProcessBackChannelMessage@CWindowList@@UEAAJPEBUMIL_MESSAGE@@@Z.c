/*
 * XREFs of ?ProcessBackChannelMessage@CWindowList@@UEAAJPEBUMIL_MESSAGE@@@Z @ 0x1800326C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ProcessBackChannelMessage(CWindowList *this, const struct MIL_MESSAGE *a2)
{
  ...
  {
    v3 = *((_DWORD *)a2 + 2);
    v4 = (unsigned int *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 54);
    if ( v3 == v4[144] )
    {
...
LABEL_18:
      ...
      if ( !GetSystemMetrics(8193) && (Microsoft_Windows_Dwm_UdwmEnableBits & 4) != 0 )
        Template_q(v7, &PerfTrack_UdwmLivePreviewAnimation_FirstFrameFinished_Info, v4[74]);
      v4[145] = -1;
    }
  }
  else
  {
    ...
    {
      v2 = -2147418113;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147418113, 0x3D5u);
      return v2;
    }
