/*
 * XREFs of ?SetIconicData@CIconicAnimatedVisual@@QEAAJPEAVCWindowData@@PEBUtagRECT@@PEAU?$TMILFlagsEnum@W4FlagsEnum@SWRUsage@@@@@Z @ 0x1800A019C
 * Callers:
  ...
  if ( a3 )
  {
    *v8 = *a3;
    if ( *(int *)a3 < 0 && (*a4 & 0x2000) == 0 )
    {
      *(_OWORD *)(a1 + 368) = *a3;
      v9 = -*(_DWORD *)a3;
      *(_DWORD *)(a1 + 360) += *(_DWORD *)a3;
      v10 = *(_DWORD *)v8 + v9;
      if ( v10 >= *(_DWORD *)(a1 + 360) )
        v10 = *(_DWORD *)(a1 + 360);
      *(_DWORD *)v8 = v10;
    }
  }
