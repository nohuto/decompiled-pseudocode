/*
 * XREFs of ?_CollectExcludedImmersiveWindows@CLivePreview@@AEAAJAEAV?$DynArray@PEAVCWindowData@@$0A@@@@Z @ 0x180075A48
 * Callers:
  ...
  if ( WindowListForDesktop->Flink != WindowListForDesktop )
  {
    while ( 2 )
    {
      ...
      if ( !(unsigned int)CLivePreview::_GetCoverageStateOfWindow(a1, v16) )
      {
        ...
        if ( v14 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v14, 0x2C5u);
          return v5;
        }
      }
LABEL_11:
