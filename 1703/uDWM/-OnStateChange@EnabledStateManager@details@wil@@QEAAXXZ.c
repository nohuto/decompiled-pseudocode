/*
 * XREFs of ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x180080DF8
 * Callers:
 ...
 *     _lambda_42ed7cb8e6cd03c5242b9a63c40e80d6_::_lambda_invoker_cdecl_ @ 0x18007FFF0 (_lambda_42ed7cb8e6cd03c5242b9a63c40e80d6_--_lambda_invoker_cdecl_.c)
 * Callees:
...
void __fastcall wil::details::EnabledStateManager::OnStateChange(RTL_SRWLOCK *this)
{
  ...
  if ( LOBYTE(this->Ptr) )
  {
    ...
    Ptr = (union wil_details_FeaturePropertyCache **)this[9].Ptr;
    v4 = (union wil_details_FeaturePropertyCache **)((char *)Ptr
                                                   + (((char *)this[10].Ptr - (char *)Ptr) & 0xFFFFFFFFFFFFFFF0uLL));
    while ( Ptr != v4 )
    {
