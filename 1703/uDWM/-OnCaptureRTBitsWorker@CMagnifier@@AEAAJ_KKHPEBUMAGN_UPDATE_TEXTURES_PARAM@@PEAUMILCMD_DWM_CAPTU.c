/*
 * XREFs of ?OnCaptureRTBitsWorker@CMagnifier@@AEAAJ_KKHPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY@@@Z @ 0x18007D188
 * Callers:
        ...
        struct MILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY *a6)
{
  ...
  if ( *((_DWORD *)this + 44) )
  {
    ...
    if ( a4 )
      v7 |= 2u;
    v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, __int64, int, _DWORD, const struct MAGN_UPDATE_TEXTURES_PARAM *, char *))(**((_QWORD **)this + 2) + 752LL))(
           *((_QWORD *)this + 2),
    ...
    {
      MilInstrumentationCheckHR(0x14u, &dword_1800B08F8, 8LL, v8, 0x1FFu);
    }
  }
  else
  {
