/*
 * XREFs of ?GetStartTilesScaleFactor@@YAXAEBU_DPI_INFORMATION@@PEAI@Z @ 0x180013E40
 * Callers:
 ...
 *     _AreStartTilesTooBigAtScaleFactor @ 0x180013F8C (_AreStartTilesTooBigAtScaleFactor.c)
 *     _DisableIndependentStartTiles @ 0x180014014 (_DisableIndependentStartTiles.c)
 */
