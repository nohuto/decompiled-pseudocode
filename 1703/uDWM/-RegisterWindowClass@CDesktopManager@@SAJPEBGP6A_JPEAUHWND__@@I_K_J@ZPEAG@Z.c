/*
 * XREFs of ?RegisterWindowClass@CDesktopManager@@SAJPEBGP6A_JPEAUHWND__@@I_K_J@ZPEAG@Z @ 0x18004051C
 * Callers:
        ...
        unsigned __int16 *a3)
{
  ...
  if ( (dword_1800C11AC & 1) == 0 )
  {
    dword_1800C10A0 = -2147023486;
    dword_1800C11AC |= 1u;
  }
  v4 = 0;
  WndClass.style = 0;
  ...
  *a3 = v6;
  if ( !v6 )
  {
    ...
    if ( v5 >= 0 )
      v5 = -2003304445;
    MilInstrumentationCheckHR(0x14u, &dword_1800C10A0, 1u, v5, 0x636u);
  }
  if ( v5 != -2147023486 )
