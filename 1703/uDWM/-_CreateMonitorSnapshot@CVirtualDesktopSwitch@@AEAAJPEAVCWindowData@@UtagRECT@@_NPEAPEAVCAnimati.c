/*
 * XREFs of ?_CreateMonitorSnapshot@CVirtualDesktopSwitch@@AEAAJPEAVCWindowData@@UtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x1800985F8
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  int v19; // eax
  struct CAnimatedTransitionVisual *v22; // [rsp+38h] [rbp-28h] BYREF
  ...
  {
    v11 = -2147467259;
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, -2147467259, 0x1269u);
    return v11;
  }
  ...
  {
    v11 = -2147024882;
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, -2147024882, 0x1271u);
    return v11;
  }
  ...
  if ( v14 >= 0 )
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v16, 0x1274u);
      goto LABEL_22;
    }
    ...
    if ( a4
      && (v18 = *(CAnimatedTransitionVisual **)(v5 + 40),
          *(_BYTE *)(v5 + 67) = 1,
          ...
          v19 < 0) )
    {
      MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v19, 0x127Fu);
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v14, 0x1273u);
  }
  v15 = v22;
LABEL_22:
