/*
 * XREFs of ??1CCachedVisualImageBrushResource@@MEAA@XZ @ 0x18003C154
 * Callers:
        ...
        __int64 a3)
{
  ...
  *(_QWORD *)this = &CCachedVisualImageBrushResource::`vftable';
  ...
  v6[0] = 0LL;
  v6[1] = 0LL;
  (*(void (__fastcall **)(__int64, _QWORD, __int64, _QWORD *, _QWORD *, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD, _DWORD))(*(_QWORD *)v4 + 1192LL))(
    v4,
    *((unsigned int *)this + 6),
    a3,
    v6,
