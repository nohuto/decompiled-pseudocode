/*
 * XREFs of ?_WindowEnumCallback@CGrowPanel@@MEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x18009B920
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CGrowPanel::_WindowEnumCallback(__int64 a1, __int64 a2, char a3, int *a4)
{
  ...
  if ( (*(_DWORD *)(a2 + 600) & 0xFFF) == 0x28 )
  {
    ...
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v19, 0x574u);
LABEL_8:
    v4 = (struct tagPOINT **)v27;
LABEL_29:
    if ( v4 )
  ...
  if ( *(_BYTE *)(a1 + 128) )
  {
    ...
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v10, 0x555u);
    goto LABEL_8;
  }
  v17 = CSlide::_SlideWindow((CSlide *)a1, (struct CWindowData *)a2, 0.0, 0LL);
  v8 = v17;
  if ( v17 < 0 )
    MilInstrumentationCheckHR(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v17, 0x56Cu);
LABEL_31:
  result = 1;
  *a4 = v8;
  return result;
