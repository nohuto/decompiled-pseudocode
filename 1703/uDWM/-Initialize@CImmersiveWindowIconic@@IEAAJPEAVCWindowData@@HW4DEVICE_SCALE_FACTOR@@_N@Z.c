/*
 * XREFs of ?Initialize@CImmersiveWindowIconic@@IEAAJPEAVCWindowData@@HW4DEVICE_SCALE_FACTOR@@_N@Z @ 0x18007C6F0
 * Callers:
      ...
      *(_BYTE *)(*((_QWORD *)this + 35) + 594LL) |= 1u;
      if ( a3 )
      {
        ...
        *((_DWORD *)this + 78) = v18;
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v24, 0x60u);
          return v13;
        }
      }
      ...
      if ( IconW >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          ...
          v13 = v27;
          if ( v27 < 0 )
            MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v27, 0x67u);
        }
        else
        {
