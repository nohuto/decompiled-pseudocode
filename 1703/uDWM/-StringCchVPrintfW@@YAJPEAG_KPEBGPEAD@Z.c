/*
 * XREFs of ?StringCchVPrintfW@@YAJPEAG_KPEBGPEAD@Z @ 0x180072404
 * Callers:
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x180071AF4 (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
 ...
 * Callees:
 *     StringVPrintfWorkerW @ 0x180018C9C (StringVPrintfWorkerW.c)
 */
