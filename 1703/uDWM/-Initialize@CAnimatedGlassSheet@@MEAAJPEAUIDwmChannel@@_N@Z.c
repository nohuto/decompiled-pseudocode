/*
 * XREFs of ?Initialize@CAnimatedGlassSheet@@MEAAJPEAUIDwmChannel@@_N@Z @ 0x180086BB0
 * Callers:
 ...
 *     ?GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z @ 0x180080828 (-GetWindowFramePart@CTopLevelWindow@@CAPEAVCBitmapSource@@PEAUWindowFrame@1@I@Z.c)
 */
  ...
  if ( v5 >= 0 )
  {
    ...
    do
    {
      ...
      if ( WindowFramePart )
      {
        ...
        *(_DWORD *)v10 = (int)((double)*(int *)v10 * *(double *)(v12 + 392));
        *(_DWORD *)(v10 + 4) = (int)(v13 * *(double *)(v12 + 400));
      }
      else
      {
        *(_QWORD *)v10 = 0LL;
    ...
    *((_DWORD *)this + 117) = v17;
    ...
    v43[8] = -v15;
    v43[9] = -v16;
    *(double *)v18.m128i_i64 = _mm_cvtepi32_pd(v18).m128d_f64[0] * *(double *)(v19 + 392);
    v49 = -v15;
    v57 = -v17;
    v62 = 0x7FFFFFFF;
    v63 = -v17;
    ...
    while ( 1 )
    {
      ...
      if ( v25 < 0 )
        break;
      CAtlasedRectsVisual::InsertAtlasImageAtIndex(this, *v21, *((_DWORD *)this + 66));
