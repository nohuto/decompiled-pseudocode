/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x18007A630
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  {
    v13 = *((_QWORD *)wil::details::static_lazy<WindowFrameLogging>::get(
                        v4,
      ...
      && (*(_QWORD *)(v13 + 24) & 0x200000000000LL) == *(_QWORD *)(v13 + 24) )
    {
      ...
      v57 = 4LL;
      TlgCreateSz(&v58, v21);
      TlgWrite(v22, &unk_1800AF174, (LPCGUID)(a1[6] + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
