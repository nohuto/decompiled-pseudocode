/*
 * XREFs of ?CalculateOutsideMargins@CTopLevelWindow@@SAXPEAVCWindowData@@IPEAU_MARGINS@@@Z @ 0x1800802B4
 * Callers:
...
void __fastcall CTopLevelWindow::CalculateOutsideMargins(struct CWindowData *this, char a2, struct _MARGINS *a3)
{
  ...
  *(_QWORD *)&a3->cyTopHeight = 0LL;
  if ( CTopLevelWindow::HasRenderedBorder(a2)
    ...
    && *((_DWORD *)this + 17) >= dword_1800C0E2C
    && *((_DWORD *)this + 18) >= dword_1800C0E30
    && *((_DWORD *)this + 19) >= dword_1800C0E34
    && (*((_DWORD *)this + 26) & 0x800000) == 0
    && (int)CWindowData::GetSystemMetrics(this, 0x5Cu) > 0 )
  {
