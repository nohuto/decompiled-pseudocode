/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x180083060
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, SyncedWindowData, 0xE73u);
    goto LABEL_35;
  }
  v13 = v31;
  if ( !v31 )
  ...
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, 0xE7Du);
    goto LABEL_35;
  }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, DesktopThumbnail, 0xE81u);
LABEL_27:
    v16 = v28;
    goto LABEL_28;
  }
  ...
  *((_QWORD *)v28 + 34) = *((_QWORD *)v13 + 15);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, updated, 0xE82u);
    goto LABEL_28;
  }
  v34 = *a4;
      ...
      if ( v22 >= 0 )
      {
        ...
        *((_BYTE *)v24 + 337) = 0;
        ...
        if ( v25 >= 0 )
        {
          ...
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v26, 0xEA3u);
        }
        else
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v25, 0xEA0u);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v22, 0xE9Au);
        v11 = (volatile signed __int32 *)v29;
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, PerMonitorDesktopThumbnail, 0xE83u);
  }
LABEL_28:
  if ( v16 )
