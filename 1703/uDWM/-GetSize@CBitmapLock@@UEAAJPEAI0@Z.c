/*
 * XREFs of ?GetSize@CBitmapLock@@UEAAJPEAI0@Z @ 0x1800A31A0
 * Callers:
 *     ?GetSize@CBitmapLock@@W7EAAJPEAI0@Z @ 0x18004E360 (-GetSize@CBitmapLock@@W7EAAJPEAI0@Z.c)
 * Callees:
...
LABEL_5:
    v7 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, -2147024809, v9);
    goto LABEL_12;
  }
  if ( !a3 )
  {
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v7, 0x7Du);
  }
LABEL_12:
