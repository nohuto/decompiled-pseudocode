/*
 * XREFs of ?RegisterSharedVirtualDesktopVisual@CWindowList@@UEAAJPEAUHWND__@@T_LARGE_INTEGER@@PEAX@Z @ 0x180084910
 * Callers:
...
LABEL_38:
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v11, v27);
    goto LABEL_39;
  }
  v12 = v30;
  if ( !v30 )
...
LABEL_37:
  ...
  *((_DWORD *)v14 + 28) = 2;
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v16, 0xC4Eu);
    v8 = v29;
    goto LABEL_39;
  }
  v8 = v29;
  ...
  *((_QWORD *)v14 + 12) = v29;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0LL, v10, 0xB5u);
  }
  if ( v10 < 0 )
  {
    v27 = 3154;
