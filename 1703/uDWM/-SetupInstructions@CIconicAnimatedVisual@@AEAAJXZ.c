/*
 * XREFs of ?SetupInstructions@CIconicAnimatedVisual@@AEAAJXZ @ 0x1800A0264
 * Callers:
 ...
 *     ?GetPillarBoxColor@CImmersiveState@@SAXPEAU_D3DCOLORVALUE@@@Z @ 0x18009FE44 (-GetPillarBoxColor@CImmersiveState@@SAXPEAU_D3DCOLORVALUE@@@Z.c)
 */
...
__int64 __fastcall CIconicAnimatedVisual::SetupInstructions(CIconicAnimatedVisual *this)
{
  ...
  *((_D3DCOLORVALUE *)v3 + 1) = *(_D3DCOLORVALUE *)&v16.r;
  v10 = CRenderDataVisual::AddInstruction(this, v3);
  v9 = v10;
  if ( v10 >= 0 )
  {
LABEL_6:
    v11 = CDrawGeometryInstruction::Create(*((struct CResource **)this + 38), *((struct CResource **)this + 43), &v14);
    v9 = v11;
    if ( v11 >= 0 )
    {
      v12 = CRenderDataVisual::AddInstruction(this, v14);
      v9 = v12;
      if ( v12 < 0 )
