 ...
 *     _get_startup_file_mode @ 0x14001D628 (_get_startup_file_mode.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x14001D630 (-__scrt_initialize_type_info@@YAXXZ.c)
 ...
 *     _RTC_Initialize @ 0x14001D898 (_RTC_Initialize.c)
 *     __p__commode @ 0x14001DB9A (__p__commode.c)
 *     _configthreadlocale @ 0x14001DBBE (_configthreadlocale.c)
 *     _o__configure_wide_argv_0 @ 0x14001DBC4 (_o__configure_wide_argv_0.c)
 *     _o__initialize_wide_environment_0 @ 0x14001DBE2 (_o__initialize_wide_environment_0.c)
 *     _set_app_type @ 0x14001DC02 (_set_app_type.c)
 *     _o__set_fmode_0 @ 0x14001DC08 (_o__set_fmode_0.c)
 */
