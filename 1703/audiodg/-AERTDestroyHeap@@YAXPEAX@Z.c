/*
 * XREFs of ?AERTDestroyHeap@@YAXPEAX@Z @ 0x140045F88
 * Callers:
...
void __fastcall AERTDestroyHeap(void *a1, void *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Eu, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids, a1);
  }
  if ( a1 )
  {
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x20u, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
  }
}
