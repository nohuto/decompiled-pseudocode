/*
 * XREFs of ??1CSpatialCrossProcessBaseEndpoint@@UEAA@XZ @ 0x140057DE4
 * Callers:
 *     ??1CSpatialCrossProcessClientEndpoint@@UEAA@XZ @ 0x140057F88 (--1CSpatialCrossProcessClientEndpoint@@UEAA@XZ.c)
 *     _CSpatialCrossProcessClientEndpoint::_CSpatialCrossProcessClientEndpoint_::_1_::dtor$0 @ 0x140058012 (_CSpatialCrossProcessClientEndpoint--_CSpatialCrossProcessClientEndpoint_--_1_--dtor$0.c)
 *     ??1CSpatialCrossProcessServerEndpoint@@UEAA@XZ @ 0x14005806C (--1CSpatialCrossProcessServerEndpoint@@UEAA@XZ.c)
 *     _CSpatialCrossProcessServerEndpoint::_CSpatialCrossProcessServerEndpoint_::_1_::dtor$0 @ 0x1400581EF (_CSpatialCrossProcessServerEndpoint--_CSpatialCrossProcessServerEndpoint_--_1_--dtor$0.c)
        ...
        CSpatialCrossProcessBaseEndpoint *this)
{
  ...
  *((_QWORD *)this + 3) = &CSpatialCrossProcessBaseEndpoint::`vftable'{for `ISpatialAudioCrossProcessResourceControl'};
  ...
  UnmapMemory<CSpatialCrossProcessBaseEndpoint::ControlData>((LPCVOID *)this + 110, 0x31Eu);
