/*
 * XREFs of ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x140046974
 * Callers:
 *     ??1HandleSendReceiveServer@@UEAA@XZ @ 0x140018320 (--1HandleSendReceiveServer@@UEAA@XZ.c)
 * Callees:
