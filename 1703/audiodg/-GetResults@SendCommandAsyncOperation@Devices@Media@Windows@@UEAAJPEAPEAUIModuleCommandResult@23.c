/*
 * XREFs of ?GetResults@SendCommandAsyncOperation@Devices@Media@Windows@@UEAAJPEAPEAUIModuleCommandResult@234@@Z @ 0x14004BEA0
 * Callers:
 *     <none>
 * Callees:
      ...
      switch ( v10 )
      {
        case 1:
          if ( *((_QWORD *)this + 17) )
          {
            ...
            Status = 0;
            *a2 = (struct Windows::Media::Devices::IModuleCommandResult *)*((_QWORD *)this + 17);
            return (unsigned int)Status;
          }
          break;
        case 0:
