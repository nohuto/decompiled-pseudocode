/*
 * XREFs of ?RemoveHead@?$CAtlList@PEAVCProcessNode@@V?$CElementTraits@PEAVCProcessNode@@@ATL@@@ATL@@QEAAPEAVCProcessNode@@XZ @ 0x140030FFC
 * Callers:
...
__int64 __fastcall ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::RemoveHead(__int64 a1)
{
  ...
  *(_QWORD *)a1 = *v1;
  if ( v2 )
    ...
    *(_QWORD *)(a1 + 8) = 0LL;
  ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::FreeNode(a1);
  return v3;
}
