/*
 * XREFs of ?ReleaseOutputDataPointer@CCrossProcessServerOutputEndpoint@@UEAAXPEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x14001C4E0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (v8 & 1) != 0 )
    {
      ...
      if ( CCrossProcessBaseEndpoint::IsValidOffset(v3, v9, v6) )
      {
        ...
        if ( u32BufferFlags )
        {
          ...
          v18 = *(_DWORD *)(v16 + 140) + v9 % *((unsigned int *)this - 76);
          ...
          if ( v8 )
          {
            if ( v8 == 1 )
            {
              ...
              if ( v18 + v12 > v11 )
              {
                ...
                {
                  memcpy_0((void *)(*((_QWORD *)this - 47) + v18), *((const void **)this - 42), v13);
                  memcpy_0(
                    (void *)(*((_QWORD *)this - 47) + *(unsigned int *)(*((_QWORD *)this - 46) + 140LL)),
                    (const void *)(v13 + *((_QWORD *)this - 42)),
                    v12 - v13);
                }
              ...
              {
                if ( u32BufferFlags != BUFFER_SILENT )
                  memcpy_0((void *)(*((_QWORD *)this - 47) + v18), *((const void **)this - 42), v12);
