/*
 * XREFs of ?LogPulseEndpoint@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI_N@Z @ 0x14005A14C
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1400850A0 > 5 )
  {
    ...
    v4 = (_BYTE)a3 != 0;
    v10 = &v4;
    TlgWrite((TraceLoggingHProvider)&dword_1400850A0, &unk_14006FBCE, a3, a4, 5u, &pData);
  }
}
