/*
 * XREFs of ?GetMeterChannelCount@CSystemAudioDeviceOffloadGraph@@UEAAJPEAI@Z @ 0x14003E160
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a2)
{
  ...
  if ( v4 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffloadGraph::GetMeterChannelCount", 0x1BEu, v4);
  }
  EtwEventActivityIdControl(4LL, &v6);
