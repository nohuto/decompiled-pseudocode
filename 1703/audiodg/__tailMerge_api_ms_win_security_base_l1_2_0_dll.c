/*
 * XREFs of __tailMerge_api_ms_win_security_base_l1_2_0_dll @ 0x14001DE3A
 * Callers:
 *     __imp_load_MakeAbsoluteSD @ 0x14001DE2E (__imp_load_MakeAbsoluteSD.c)
 *     __imp_load_GetTokenInformation @ 0x14001E23E (__imp_load_GetTokenInformation.c)
 * Callees:
