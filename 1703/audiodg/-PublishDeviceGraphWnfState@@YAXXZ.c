/*
 * XREFs of ?PublishDeviceGraphWnfState@@YAXXZ @ 0x1400141C0
 * Callers:
 ...
 *     AudioDGGetDeviceGraphWnfStateName @ 0x1400428A0 (AudioDGGetDeviceGraphWnfStateName.c)
 ...
 *     ?FreeNode@?$CAtlList@PEAVCVirtualProtectedOutput@@V?$CElementTraits@PEAVCVirtualProtectedOutput@@@ATL@@@ATL@@AEAAXPEAVCNode@12@@Z @ 0x140039168 (-FreeNode@-$CAtlList@PEAVCVirtualProtectedOutput@@V-$CElementTraits@PEAVCVirtualProtectedOutput@.c)
      ...
      if ( v29 )
      {
        do
        {
          ...
          *v31 = v60;
          ...
          if ( !v32 )
            ATL::CAtlMap<unsigned long,CpuManager::HandleRegistrations::ListValue,ATL::CElementTraits<unsigned long>,ATL::CElementTraits<CpuManager::HandleRegistrations::ListValue>>::FreePlexes(&v49);
        }
        while ( v29 );
        j = v51;
        v8 = v49;
