/*
 * XREFs of ?QueryInterface@SendCommandAsyncOperation@Devices@Media@Windows@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001FAB0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
