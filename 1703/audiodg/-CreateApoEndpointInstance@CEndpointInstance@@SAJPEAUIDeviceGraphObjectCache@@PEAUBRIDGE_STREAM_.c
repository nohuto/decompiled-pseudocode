/*
 * XREFs of ?CreateApoEndpointInstance@CEndpointInstance@@SAJPEAUIDeviceGraphObjectCache@@PEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@PEAUIAudioMediaType@@IPEAPEAV1@@Z @ 0x140041CE8
 * Callers:
        ...
        struct CEndpointInstance **a6)
{
  ...
  *a6 = 0LL;
  ...
  AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateApoEndpointInstance", 0x29Au, v7);
LABEL_10:
  if ( v12 )
