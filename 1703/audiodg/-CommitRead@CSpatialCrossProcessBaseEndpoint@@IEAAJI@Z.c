/*
 * XREFs of ?CommitRead@CSpatialCrossProcessBaseEndpoint@@IEAAJI@Z @ 0x14005B6EC
 * Callers:
...
__int64 __fastcall CSpatialCrossProcessBaseEndpoint::CommitRead(volatile signed __int32 **this, unsigned int a2)
{
  ...
  if ( a2 > 1 )
  {
    v3 = -2147024809;
LABEL_10:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::CommitRead", 979, v3);
    return v3;
  }
