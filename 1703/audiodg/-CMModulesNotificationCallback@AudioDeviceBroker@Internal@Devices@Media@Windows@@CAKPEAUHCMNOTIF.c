/*
 * XREFs of ?CMModulesNotificationCallback@AudioDeviceBroker@Internal@Devices@Media@Windows@@CAKPEAUHCMNOTIFICATION__@@PEAXW4_CM_NOTIFY_ACTION@@PEAU_CM_NOTIFY_EVENT_DATA@@K@Z @ 0x14004A280
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  if ( a2 && *(_QWORD *)(a2 + 96) == a1 && a3 > 0 )
  {
    if ( a3 <= 2 )
    {
      v11 = (RTL_SRWLOCK *)(a2 + 144);
      AcquireSRWLockExclusive((PSRWLOCK)(a2 + 144));
      v12 = *(char **)(a2 + 88);
    ...
    else if ( a3 == 6 )
    {
      ...
      if ( a5 >= 0x24 && *(_DWORD *)a4 == 1 && *(_DWORD *)(a4 + 28) )
      {
        ...
        {
          v8 = *(_QWORD *)(a4 + 32) - *(_QWORD *)(a2 + 104);
          if ( !v8 )
            v8 = *(_QWORD *)(a4 + 40) - *(_QWORD *)(a2 + 112);
          if ( !v8 )
          {
            v17 = 0LL;
                  ...
                  if ( (*(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v9 + 248LL))(v9, &v14) >= 0
                    && (*(int (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(a2 + 192) + 104LL))(
                         *(_QWORD *)(a2 + 192),
                         v14) >= 0 )
                  {
                    wil::details::SetEvent(*(wil::details **)(a2 + 176), v10);
                  }
                }
              }
            }
