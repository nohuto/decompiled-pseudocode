/*
 * XREFs of ?Cleanup@CAudioDeviceGraph@@AEAAXXZ @ 0x140010AA0
 * Callers:
...
void __fastcall CAudioDeviceGraph::Cleanup(CAudioDeviceGraph *this)
{
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control )
  {
    ...
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 59LL, &WPP_4aa9f3a5c249328694bb02b83da61cfa_Traceguids, this);
      v2 = WPP_GLOBAL_Control;
    }
    if ( v2 != &WPP_GLOBAL_Control && (*((_DWORD *)v2 + 7) & 0x20000) != 0 && *((_BYTE *)v2 + 25) >= 4u )
      WPP_SF_(v2[2], 60LL, &WPP_4aa9f3a5c249328694bb02b83da61cfa_Traceguids);
  }
  ...
  *((_QWORD *)this + 11) = 0LL;
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 61LL, &WPP_4aa9f3a5c249328694bb02b83da61cfa_Traceguids);
  }
}
