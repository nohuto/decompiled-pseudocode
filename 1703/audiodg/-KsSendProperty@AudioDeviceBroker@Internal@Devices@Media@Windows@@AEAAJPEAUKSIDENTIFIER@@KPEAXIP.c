/*
 * XREFs of ?KsSendProperty@AudioDeviceBroker@Internal@Devices@Media@Windows@@AEAAJPEAUKSIDENTIFIER@@KPEAXIPEAK@Z @ 0x14002F724
 * Callers:
        ...
        unsigned int *lpBytesReturned)
{
  ...
  else
  {
    ...
    else if ( !DeviceIoControl(this[11].Ptr, 0x2F0003u, a2, a3, a4, nOutBufferSize, lpBytesReturned, 0LL) )
    {
      if ( GetLastError() )
      {
