/*
 * XREFs of ?AERTCreateHeap@@YAPEAX_K00@Z @ 0x14001B79C
 * Callers:
 *     ?AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z @ 0x14001B740 (-AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z.c)
 * Callees:
 *     WPP_SF_PPPL @ 0x140046608 (WPP_SF_PPPL.c)
...
void *__fastcall AERTCreateHeap()
{
  ...
  AEWMILOG_MEMORY(v7, v4, 4u, 3u, v11, v1, v0, v2, v9, v10, v6);
  return v11;
}
