/*
 * XREFs of ?LogTelemetry@CCrossProcessEndpointGlitchValues@CCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x1400551A0
 * Callers:
 *     <none>
 * Callees:
        ...
        CCrossProcessEndpointTraceLogger::CCrossProcessEndpointGlitchValues *this)
{
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v4 > 3u )
      {
        if ( TlgKeywordOn(v4, 2uLL) )
        {
          ...
          v34 = 4LL;
          v36 = 4LL;
          TlgWrite(v5, &unk_14006F710, v6, v7, 0xDu, &pData);
        }
      }
    }
    else if ( *(_DWORD *)v4 > 3u && TlgKeywordOn(v4, 0x400000000002uLL) )
    {
      ...
      v34 = 4LL;
      v36 = 4LL;
      TlgWrite(v8, &unk_14006F5DC, v9, v10, 0xDu, &pData);
    }
  }
}
