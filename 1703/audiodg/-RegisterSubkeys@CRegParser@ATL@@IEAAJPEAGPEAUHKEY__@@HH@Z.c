/*
 * XREFs of ?RegisterSubkeys@CRegParser@ATL@@IEAAJPEAGPEAUHKEY__@@HH@Z @ 0x140052BB4
 * Callers:
 ...
 *     ?CanForceRemoveKey@CRegParser@ATL@@IEAAHPEBG@Z @ 0x140051384 (-CanForceRemoveKey@CRegParser@ATL@@IEAAHPEBG@Z.c)
 *     ?Close@CRegKey@ATL@@QEAAJXZ @ 0x14005148C (-Close@CRegKey@ATL@@QEAAJXZ.c)
 ...
 *     ?DeleteSubKey@CRegKey@ATL@@QEAAJPEBG@Z @ 0x140051F20 (-DeleteSubKey@CRegKey@ATL@@QEAAJPEBG@Z.c)
 *     ?HasSubKeys@CRegParser@ATL@@IEAAHPEAUHKEY__@@@Z @ 0x140052014 (-HasSubKeys@CRegParser@ATL@@IEAAHPEAUHKEY__@@@Z.c)
 ...
 *     ?StrChrW@CRegParser@ATL@@KAPEAGPEAGG@Z @ 0x1400533CC (-StrChrW@CRegParser@ATL@@KAPEAGPEAGG@Z.c)
 */
