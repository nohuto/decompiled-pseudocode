/*
 * XREFs of ?RemoveAll@?$CSimpleMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAVCSystemAudioDeviceBase@@V?$CSimpleMapEqualHelper@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAVCSystemAudioDeviceBase@@@2@@ATL@@QEAAXXZ @ 0x14001C8D8
 * Callers:
 *     _dynamic_atexit_destructor_for__SadMap__ @ 0x140022200 (_dynamic_atexit_destructor_for__SadMap__.c)
 * Callees:
...
void ATL::CSimpleMap<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,CSystemAudioDeviceBase *,ATL::CSimpleMapEqualHelper<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,CSystemAudioDeviceBase *>>::RemoveAll()
{
  ...
  v0 = (char *)qword_140086290;
  if ( qword_140086290 )
  {
    for ( i = 0; i < (int)qword_1400862A0; ++i )
    {
  ...
  if ( qword_140086298 )
  {
    free(qword_140086298);
    qword_140086298 = 0LL;
  }
  LODWORD(qword_1400862A0) = 0;
}
