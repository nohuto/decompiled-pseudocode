/*
 * XREFs of ?GetFrameFormat@CSpatialCrossProcessBaseEndpoint@@UEAAJPEAPEAUtWAVEFORMATEX@@@Z @ 0x14005BB10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  v2 = CloneWaveFormat((const struct tWAVEFORMATEX *)(*((_QWORD *)this + 110) + 524LL), a2);
  if ( v2 < 0 )
    goto LABEL_6;
  return (unsigned int)v2;
}
