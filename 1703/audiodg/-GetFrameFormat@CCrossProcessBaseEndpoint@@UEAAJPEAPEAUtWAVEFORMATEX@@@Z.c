/*
 * XREFs of ?GetFrameFormat@CCrossProcessBaseEndpoint@@UEAAJPEAPEAUtWAVEFORMATEX@@@Z @ 0x1400191D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a2)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 17LL, &WPP_16533aa73b2d367cdf7d3dcf93dce015_Traceguids, v7);
  }
  AudCPTraceLoggingErrorHelper("CCrossProcessBaseEndpoint::GetFrameFormat", 0x1E2u, v7);
  return v7;
}
