/*
 * XREFs of ?GetPositionForOffload@CSystemAudioDeviceSharedBase@@UEAAJPEA_K0@Z @ 0x14003B1E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x14003AAA8 (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
        ...
        unsigned __int64 *a3)
{
  ...
  {
    WPP_SF_ii(*((_QWORD *)WPP_GLOBAL_Control + 2), 20LL, &WPP_d7c84bfd30153aba078899c41fbb18ca_Traceguids, *a2, *a3);
  }
  if ( v10 )
