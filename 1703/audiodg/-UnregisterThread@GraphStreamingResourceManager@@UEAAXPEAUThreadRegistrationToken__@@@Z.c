/*
 * XREFs of ?UnregisterThread@GraphStreamingResourceManager@@UEAAXPEAUThreadRegistrationToken__@@@Z @ 0x1400044D0
 * Callers:
 *     <none>
 * Callees:
 *     ?FinalUnregisterForThread@GraphStreamingResourceManager@@EEAAXPEAU_t@HandleRegistrations@1@@Z @ 0x1400042F0 (-FinalUnregisterForThread@GraphStreamingResourceManager@@EEAAXPEAU_t@HandleRegistrations@1@@Z.c)
        ...
        struct ThreadRegistrationToken__ *a2)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)a2 + 2, 0xFFFFFFFF) == 1 )
  {
    ...
    v7 = (unsigned int)(*((_DWORD *)a2 + 10) % *((_DWORD *)this + 36));
    v8 = *((_QWORD *)this + 16);
    v9 = *(_QWORD *)(v8 + 8 * v7);
    if ( a2 == (struct ThreadRegistrationToken__ *)v9 )
      goto LABEL_6;
    for ( i = *(_QWORD *)(v9 + 32); (struct ThreadRegistrationToken__ *)i != a2; i = *(_QWORD *)(i + 32) )
      v9 = i;
    if ( !v9 )
LABEL_6:
