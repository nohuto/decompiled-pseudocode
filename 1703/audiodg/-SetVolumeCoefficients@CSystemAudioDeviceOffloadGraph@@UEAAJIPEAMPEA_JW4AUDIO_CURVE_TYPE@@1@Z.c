/*
 * XREFs of ?SetVolumeCoefficients@CSystemAudioDeviceOffloadGraph@@UEAAJIPEAMPEA_JW4AUDIO_CURVE_TYPE@@1@Z @ 0x14003EB20
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a6)
{
  ...
  if ( v9 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceOffloadGraph::SetVolumeCoefficients", 0xE0u, v9);
  }
  EtwEventActivityIdControl(4LL, &v11);
