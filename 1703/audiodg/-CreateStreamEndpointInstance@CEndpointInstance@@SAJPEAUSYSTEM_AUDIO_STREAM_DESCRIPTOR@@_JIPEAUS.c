/*
 * XREFs of ?CreateStreamEndpointInstance@CEndpointInstance@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@_JIPEAUSYSTEM_AUDIO_STREAM@@PEAPEAV1@@Z @ 0x14001A060
 * Callers:
        ...
        struct CEndpointInstance **a5)
{
  ...
  __int64 v19; // r8
  __int64 (__fastcall *v20)(CCrossProcessServerOutputEndpoint *, struct tWAVEFORMATEX *, unsigned int, unsigned int, unsigned __int16 *, char *, _QWORD *, unsigned int, unsigned __int64 *, unsigned __int64 *); // rax
  int v21; // eax
  GUID v22; // xmm0
  struct CEndpointInstance *v23; // rax
  struct CEndpointInstance *v24; // rdi
  void *v25; // rcx
  _QWORD *v27; // rcx
  ...
  v28 = 0LL;
  v33 = 0LL;
  v8 = (struct tWAVEFORMATEX *)*((_QWORD *)a1 + 10);
  v9 = *(_DWORD *)a1 != 0;
  ...
  {
    WPP_SF_DDD(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_c59da3fdbfb03c8b2196f1e98cb9dccc_Traceguids, v14);
  }
  ...
  if ( (*((_DWORD *)a1 + 22) & 0x40000) != 0 )
  {
    ...
    if ( started < 0 )
    {
      ...
      AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateStreamEndpointInstance", 0x15Bu, started);
      goto LABEL_49;
    }
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x20000) != 0
  ...
  else
  {
    ...
    if ( started >= 0 )
    {
      ...
      if ( started >= 0 )
      {
        ...
        v20 = *(__int64 (__fastcall **)(CCrossProcessServerOutputEndpoint *, struct tWAVEFORMATEX *, unsigned int, unsigned int, unsigned __int16 *, char *, _QWORD *, unsigned int, unsigned __int64 *, unsigned __int64 *))(*(_QWORD *)v28 + 24LL);
...
LABEL_23:
          ...
          *((_DWORD *)a4 + 4) = v16 * v8->nBlockAlign;
          v23 = (struct CEndpointInstance *)operator new(0x20uLL);
          v24 = v23;
          v33 = v23;
          if ( v23 )
          {
            *(_QWORD *)v23 = 0LL;
            *((_QWORD *)v23 + 3) = 0LL;
            if ( *(__int64 (__fastcall ****)(_QWORD, GUID *, CCrossProcessServerOutputEndpoint **))v23 != v7 )
            {
...
LABEL_50:
  if ( v27 != &WPP_GLOBAL_Control && (*((_DWORD *)v27 + 7) & 0x20000) != 0 && *((_BYTE *)v27 + 25) >= 2u )
    WPP_SF_D(v27[2], 14LL, &WPP_c59da3fdbfb03c8b2196f1e98cb9dccc_Traceguids, (unsigned int)started);
  AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateStreamEndpointInstance", 0x1B6u, started);
  if ( v18 )
