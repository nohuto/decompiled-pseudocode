/*
 * XREFs of ?QueryInterface@SendCommandAsyncOperation@Devices@Media@Windows@@WFA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001F8E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
