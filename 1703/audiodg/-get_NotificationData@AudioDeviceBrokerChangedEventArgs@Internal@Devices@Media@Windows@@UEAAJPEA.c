/*
 * XREFs of ?get_NotificationData@AudioDeviceBrokerChangedEventArgs@Internal@Devices@Media@Windows@@UEAAJPEAPEAUIBuffer@Streams@Storage@5@@Z @ 0x14004F670
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Storage::Streams::IBuffer **a2)
{
  ...
  if ( a2 )
  {
    v4 = (struct Windows::Storage::Streams::IBuffer **)((char *)this + 56);
    Microsoft::WRL::ComPtr<Windows::Foundation::IAsyncOperationCompletedHandler<Windows::Media::Devices::ModuleCommandResult *>>::InternalAddRef((__int64 *)this + 7);
    *a2 = *v4;
  }
  else
  {
