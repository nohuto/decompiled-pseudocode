/*
 * XREFs of ?PreProcessBuffer@CRegParser@ATL@@QEAAJPEAGPEAPEAG@Z @ 0x140052314
 * Callers:
 ...
 *     ??0CParseBuffer@CRegParser@ATL@@QEAA@H@Z @ 0x140050084 (--0CParseBuffer@CRegParser@ATL@@QEAA@H@Z.c)
  ...
  if ( *a2 )
  {
    while ( 1 )
    {
      ...
      *(_QWORD *)this = v9;
      ...
      v13 = _o_wcsncpy_s(v24, 32LL, *(_QWORD *)this, (int)v12);
      ATL::AtlCrtErrorCheck(v13);
      v14 = ATL::CRegObject::StrFromMap(*((ATL::CRegObject **)this + 1), v24);
      if ( !v14 )
      {
LABEL_24:
        v6 = -2147352567;
