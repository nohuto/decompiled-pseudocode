/*
 * XREFs of ??1CSystemAudioDeviceBase@@UEAA@XZ @ 0x140003B50
 * Callers:
 *     ??1CSystemAudioDeviceSharedBase@@UEAA@XZ @ 0x140005700 (--1CSystemAudioDeviceSharedBase@@UEAA@XZ.c)
 *     _CSystemAudioDeviceSharedBase::_CSystemAudioDeviceSharedBase_::_1_::dtor$0 @ 0x140020A90 (_CSystemAudioDeviceSharedBase--_CSystemAudioDeviceSharedBase_--_1_--dtor$0.c)
 *     ??1CSystemAudioDeviceExclusive@@UEAA@XZ @ 0x14003991C (--1CSystemAudioDeviceExclusive@@UEAA@XZ.c)
 *     _CSystemAudioDeviceExclusive::_CSystemAudioDeviceExclusive_::_1_::dtor$1 @ 0x140039A1B (_CSystemAudioDeviceExclusive--_CSystemAudioDeviceExclusive_--_1_--dtor$1.c)
 ...
 *     _CSystemAudioDeviceOffload::_CSystemAudioDeviceOffload_::_1_::dtor$1 @ 0x14003C329 (_CSystemAudioDeviceOffload--_CSystemAudioDeviceOffload_--_1_--dtor$1.c)
 * Callees:
...
void __fastcall CSystemAudioDeviceBase::~CSystemAudioDeviceBase(CSystemAudioDeviceBase *this)
{
  ...
  *((_QWORD *)this + 3) = &CSystemAudioDeviceSharedBase::`vftable'{for `ISubmix'};
  ...
  ATL::CAtlList<CStreamInstance *,ATL::CElementTraits<CStreamInstance *>>::RemoveAll((char *)this + 136);
  ATL::CAtlList<CStreamInstance *,ATL::CElementTraits<CStreamInstance *>>::RemoveAll((char *)this + 88);
  ATL::CAtlList<CStreamInstance *,ATL::CElementTraits<CStreamInstance *>>::RemoveAll((char *)this + 40);
}
