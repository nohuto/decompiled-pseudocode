/*
 * XREFs of ?LogFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@JPEBG_NPEAG_KPEAD6PEAUFailureInfo@2@@Z @ 0x1400334FC
 * Callers:
 ...
 * Callees:
 *     ?RecordFailFast@details@wil@@YAHJ@Z @ 0x14001BD40 (-RecordFailFast@details@wil@@YAHJ@Z.c)
 ...
 *     ?RecordException@details@wil@@YAHJ@Z @ 0x1400339E4 (-RecordException@details@wil@@YAHJ@Z.c)
 *     ?RecordLog@details@wil@@YAHJ@Z @ 0x1400339FC (-RecordLog@details@wil@@YAHJ@Z.c)
 *     ?RecordReturn@details@wil@@YAHJ@Z @ 0x140033A14 (-RecordReturn@details@wil@@YAHJ@Z.c)
        ...
        unsigned __int64 a15)
{
  ...
  void (__fastcall *v28)(unsigned __int64, WCHAR *, __int64); // rax
...
LABEL_11:
  ...
  *(_QWORD *)(a15 + 120) = ModuleName;
  ...
  if ( wil::g_fResultOutputDebugString )
    goto LABEL_33;
  v28 = (void (__fastcall *)(unsigned __int64, WCHAR *, __int64))g_pfnResultLoggingCallback;
