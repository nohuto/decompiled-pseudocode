/*
 * XREFs of ?Serialize@CDisplayNode@@QEAAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@AEAPEAEAEAI@Z @ 0x1400436E0
 * Callers:
 ...
 *     ?GetDisplayName@CDisplayNode@@QEAAPEBDXZ @ 0x140042CE8 (-GetDisplayName@CDisplayNode@@QEAAPEBDXZ.c)
  ...
  *a4 += v10 + 1;
  ...
  else
  {
    *a4 += 4;
    ...
    {
      Next = ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::GetNext(v15, &i);
      v17 = *(_QWORD *)(a2 + 16);
      v18 = 0;
      v8 = -2147023728;
      v19 = *Next;
