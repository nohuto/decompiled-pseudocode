/*
 * XREFs of ??$ApplyVolumeRampDown_Internal@P6AMPEAE@ZP6AX0M@Z@@YAXPEAEIIIP6AM0@ZP6AX0M@Z@Z @ 0x140056AF8
 * Callers:
...
void __fastcall ApplyVolumeRampDown_Internal<float (*)(unsigned char *),void (*)(unsigned char *,float)>(
        __int64 a1,
        unsigned int a2,
        unsigned int a3,
        unsigned int a4,
        ...
        void (__fastcall *a6)(__int64))
{
  ...
  unsigned int i; // edi
  __int64 v13; // r15
  float v14; // [rsp+20h] [rbp-78h] BYREF
  ...
  v19 = 0;
  v20 = 0;
  if ( (int)CFadeWindowLUT::Initialize((CFadeWindowLUT *)&v16, a2, a2, 0) < 0 )
  {
    for ( i = 0; i < a2; ++i )
    {
      if ( (_DWORD)v7 )
