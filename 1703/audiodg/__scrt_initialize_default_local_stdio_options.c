/*
 * XREFs of __scrt_initialize_default_local_stdio_options @ 0x14001D640
 * Callers:
 *     pre_c_initialization @ 0x14001CBC0 (pre_c_initialization.c)
 *     post_pgo_initialization @ 0x14001CC70 (post_pgo_initialization.c)
 * Callees:
 *     __local_stdio_printf_options @ 0x14001CB90 (__local_stdio_printf_options.c)
 *     __local_stdio_scanf_options @ 0x14001CB98 (__local_stdio_scanf_options.c)
 */
