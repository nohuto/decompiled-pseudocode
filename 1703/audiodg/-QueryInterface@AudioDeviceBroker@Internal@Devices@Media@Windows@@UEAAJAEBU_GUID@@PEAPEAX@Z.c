/*
 * XREFs of ?QueryInterface@AudioDeviceBroker@Internal@Devices@Media@Windows@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x14002F830
 * Callers:
 *     ?QueryInterface@?$RuntimeClass@U?$InterfaceList@UIAudioDeviceBroker@Internal@Devices@Media@Windows@@U?$InterfaceList@VFtmBase@WRL@Microsoft@@VNil@Details@23@@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$00@34@$00$00$0A@@Details@WRL@Microsoft@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001FA50 (-QueryInterface@-$RuntimeClass@U-$InterfaceList@UIAudioDeviceBroker@Internal@Devices@Media@Windo.c)
 *     ?QueryInterface@AudioDeviceBroker@Internal@Devices@Media@Windows@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x14001FA60 (-QueryInterface@AudioDeviceBroker@Internal@Devices@Media@Windows@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
        ...
        void **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( (unsigned int)InlineIsEqualGUID(v6, &GUID_57334b0d_4eb7_46ad_b19d_e41a029e3674) )
  {
    *v7 = v8;
    CanCastTo = 0;
LABEL_6:
