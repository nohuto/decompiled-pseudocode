/*
 * XREFs of _dynamic_initializer_for__g_CrossProcessTelemetryProviderRegistration__ @ 0x140001240
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_CrossProcessTelemetryProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_140085020, a2, a3);
