/*
 * XREFs of ?IsLeftFormatSupported@CProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x14000DFB0
 * Callers:
...
LABEL_26:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_a00fb4be71793c9c12457d7c93fa59d1_Traceguids, v10);
    }
