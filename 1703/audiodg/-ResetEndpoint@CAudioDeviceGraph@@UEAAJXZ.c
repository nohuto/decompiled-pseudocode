/*
 * XREFs of ?ResetEndpoint@CAudioDeviceGraph@@UEAAJXZ @ 0x140041830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioDeviceGraph::ResetEndpoint(CAudioDeviceGraph *this)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v5 >= 0 )
    {
      ...
      if ( v3 >= 0 )
      {
        ...
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x24u, (__int64)&WPP_4aa9f3a5c249328694bb02b83da61cfa_Traceguids);
        }
      }
    }
    else
  ...
  else
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      v7 = 34;
LABEL_8:
      WPP_SF_D(v6[2], v7, (__int64)&WPP_4aa9f3a5c249328694bb02b83da61cfa_Traceguids, v5);
    }
  }
LABEL_19:
  ...
  if ( v3 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::ResetEndpoint", 0x281u, v3);
  }
  if ( v9 )
