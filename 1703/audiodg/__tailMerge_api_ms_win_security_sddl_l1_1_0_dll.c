/*
 * XREFs of __tailMerge_api_ms_win_security_sddl_l1_1_0_dll @ 0x14001DF44
 * Callers:
 *     __imp_load_ConvertStringSecurityDescriptorToSecurityDescriptorW @ 0x14001DF38 (__imp_load_ConvertStringSecurityDescriptorToSecurityDescriptorW.c)
 * Callees:
