/*
 * XREFs of ?LogEmptyBufferCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI@Z @ 0x140059CD4
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_1400850A0 > 5 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1400850A0, &unk_14006FC13, a3, a4, 4u, &v4);
  }
}
