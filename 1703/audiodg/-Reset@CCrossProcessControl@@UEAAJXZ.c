/*
 * XREFs of ?Reset@CCrossProcessControl@@UEAAJXZ @ 0x1400548C0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_D @ 0x14001B708 (WPP_SF_D.c)
 *     ?AEWMILOG_CONTROL@@YAXKPEAXEE_K@Z @ 0x1400539B0 (-AEWMILOG_CONTROL@@YAXKPEAXEE_K@Z.c)
 *     ?DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ @ 0x140053B08 (-DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ.c)
...
__int64 __fastcall CCrossProcessControl::Reset(CCrossProcessControl *this)
{
  ...
  if ( v2 < 0 )
  {
    ...
    AudCPTraceLoggingErrorHelper("CCrossProcessControl::Reset", 0x586u, v2);
  }
