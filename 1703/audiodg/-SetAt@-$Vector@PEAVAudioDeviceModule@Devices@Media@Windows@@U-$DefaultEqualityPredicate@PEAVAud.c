/*
 * XREFs of ?SetAt@?$Vector@PEAVAudioDeviceModule@Devices@Media@Windows@@U?$DefaultEqualityPredicate@PEAVAudioDeviceModule@Devices@Media@Windows@@@Internal@Collections@Foundation@4@U?$DefaultLifetimeTraits@PEAVAudioDeviceModule@Devices@Media@Windows@@@6784@U?$DefaultVectorOptions@PEAVAudioDeviceModule@Devices@Media@Windows@@@6784@@Internal@Collections@Foundation@Windows@@UEAAJIPEAUIAudioDeviceModule@Devices@Media@5@@Z @ 0x14004ED60
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  {
    XWinRT::SerializingLockPolicy::Write(&v12, a1 + 72, &Destination);
    v5 = Destination;
    if ( (int)Destination >= 0 )
    {
    ...
    {
      if ( *(_DWORD *)v12 == 1 )
        *(_DWORD *)(v12 + 8) += 0x10000000;
      else
        ReleaseSRWLockExclusive((PSRWLOCK)(v12 + 8));
    }
  }
