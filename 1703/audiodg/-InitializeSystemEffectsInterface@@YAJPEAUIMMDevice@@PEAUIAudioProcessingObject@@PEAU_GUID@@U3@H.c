/*
 * XREFs of ?InitializeSystemEffectsInterface@@YAJPEAUIMMDevice@@PEAUIAudioProcessingObject@@PEAU_GUID@@U3@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x1400143E0
 * Callers:
        ...
        struct _GUID *a4)
{
  ...
  _BYTE v20[56]; // [rsp+C0h] [rbp-40h] BYREF
  ...
  *a4 = *v9;
  ...
  else
  {
    if ( !v17[0] )
      goto LABEL_10;
    memset(&v20[4], 0, 0x34uLL);
    *(_OWORD *)v20 = *(_OWORD *)&v19.APOInit.cbSize;
    *(_DWORD *)&v20[16] = *(_DWORD *)&v19.APOInit.clsid.Data4[4];
    *(_DWORD *)v20 = 56;
    *(_QWORD *)&v20[24] = v19.pAPOEndpointProperties;
    *(_QWORD *)&v20[32] = v19.pAPOSystemEffectsProperties;
    *(_QWORD *)&v20[40] = v19.pReserved;
    *(_QWORD *)&v20[48] = v19.pDeviceCollection;
