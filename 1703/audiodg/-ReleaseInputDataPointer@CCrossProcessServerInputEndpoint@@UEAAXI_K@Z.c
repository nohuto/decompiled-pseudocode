/*
 * XREFs of ?ReleaseInputDataPointer@CCrossProcessServerInputEndpoint@@UEAAXI_K@Z @ 0x140018C70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 a3)
{
  ...
  if ( (_DWORD)v4 && ((*(_DWORD *)(*((_QWORD *)this - 47) + 156LL) & 1) != 0 || (*((_BYTE *)this - 280) & 1) != 0) )
  {
    ...
    if ( v6 < 0 )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 37LL, &WPP_16533aa73b2d367cdf7d3dcf93dce015_Traceguids, 0LL);
      }
