/*
 * XREFs of ?LogTelemetry@CSpatialCPEndpointErrorEventValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005A5A0
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialCrossProcessEndpointTraceLogger::CSpatialCPEndpointErrorEventValues *this)
{
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v4 > 3u )
      {
        if ( TlgKeywordOn(v4, 0x200000000000uLL) )
        {
          ...
          v24 = 4LL;
          v26 = 4LL;
          TlgWrite(v5, &unk_14006FA59, v6, v7, 8u, &pData);
        }
      }
    }
    else if ( *(_DWORD *)v4 > 3u && TlgKeywordOn(v4, 0x400000000000uLL) )
    {
      ...
      v24 = 4LL;
      v26 = 4LL;
      TlgWrite(v8, &unk_14006F873, v9, v10, 8u, &pData);
    }
  }
}
