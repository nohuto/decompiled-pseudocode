/*
 * XREFs of ?CreateFormatConverterPipeInstance@CPipeInstance@@SAJPEAUIDeviceGraphObjectCache@@PEBUFORMAT_CONVERTER_PIPE_DESCRIPTOR@@PEAPEAV1@@Z @ 0x14003F364
 * Callers:
        ...
        struct CPipeInstance **a3)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x10u, (__int64)&WPP_1bb1b06919453819a20d8123e6c4939d_Traceguids);
  }
  *a3 = 0LL;
  try
  {
    ...
    v14 = (CPipeInstance *)operator new(0x130uLL);
    v45 = v14;
    if ( v14 )
    ...
    do
      ++v19;
    while ( v18[v19] );
    v20 = _AllocStringWorker<CTCoAllocPolicy>(v16, v15, v18, v19, v24, (wchar_t **)v17 + 23);
    v21 = v20;
    if ( v20 < 0 )
    {
      v31 = v20;
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, (__int64)&WPP_1bb1b06919453819a20d8123e6c4939d_Traceguids, v21);
    v22 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  if ( v21 < 0 )
  {
    if ( v22 != &WPP_GLOBAL_Control && (*((_DWORD *)v22 + 7) & 0x20000) != 0 && *((_BYTE *)v22 + 25) >= 2u )
      WPP_SF_D((__int64)v22[2], 0x12u, (__int64)&WPP_1bb1b06919453819a20d8123e6c4939d_Traceguids, v21);
    AudDGTraceLoggingErrorHelper("CPipeInstance::CreateFormatConverterPipeInstance", 0x221u, v21);
  }
  ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::RemoveAll((__int64)&v37);
