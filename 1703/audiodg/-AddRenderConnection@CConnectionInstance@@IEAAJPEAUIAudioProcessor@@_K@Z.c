/*
 * XREFs of ?AddRenderConnection@CConnectionInstance@@IEAAJPEAUIAudioProcessor@@_K@Z @ 0x140011070
 * Callers:
        ...
        __int64 a3)
{
  ...
  __int64 v14; // rcx
  void (*v15)(void); // rax
  CCrossProcessBaseServerEndpoint *v17; // rcx
  CCrossProcessBaseServerEndpoint *v18; // rcx
  CCrossProcessBaseServerEndpoint *v19; // [rsp+70h] [rbp+8h] BYREF
...
LABEL_8:
    ...
    {
      v6 = (****(__int64 (__fastcall *****)(_QWORD, GUID *, CCrossProcessBaseServerEndpoint **))(v8 + 32))(
             **(_QWORD **)(v8 + 32),
             &GUID_30a99515_1527_4451_af9f_00c5f0234daf,
             &v19);
      if ( v6 < 0 )
        goto LABEL_38;
      v6 = (*(__int64 (__fastcall **)(struct IAudioProcessor *, __int64, _QWORD, CCrossProcessBaseServerEndpoint *))(*(_QWORD *)a2 + 128LL))(
             a2,
             a3,
             *((_QWORD *)this + 1),
             v19);
  ...
  if ( v13 != 2 )
  {
    if ( v13 == 3 || v13 == 1 )
    {
      v6 = (****(__int64 (__fastcall *****)(_QWORD, GUID *, CCrossProcessBaseServerEndpoint **))(v12 + 32))(
             **(_QWORD **)(v12 + 32),
             &GUID_30a99515_1527_4451_af9f_00c5f0234daf,
             &v19);
      if ( v6 < 0 )
        goto LABEL_38;
      v6 = (*(__int64 (__fastcall **)(struct IAudioProcessor *, __int64, _QWORD, CCrossProcessBaseServerEndpoint *))(*(_QWORD *)a2 + 120LL))(
             a2,
             a3,
             *((_QWORD *)this + 1),
             v19);
...
LABEL_18:
  if ( v19 )
    (*(void (__fastcall **)(CCrossProcessBaseServerEndpoint *))(*(_QWORD *)v19 + 16LL))(v19);
  if ( v7 )
