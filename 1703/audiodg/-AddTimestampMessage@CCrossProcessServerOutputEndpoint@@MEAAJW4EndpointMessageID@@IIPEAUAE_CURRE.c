/*
 * XREFs of ?AddTimestampMessage@CCrossProcessServerOutputEndpoint@@MEAAJW4EndpointMessageID@@IIPEAUAE_CURRENT_POSITION@@W4APO_BUFFER_FLAGS@@W4AddTimestampMessageOptions@1@@Z @ 0x14001BEA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CanCoalesceTimestampMessages@CCrossProcessServerOutputEndpoint@@IEAAHIW4EndpointMessageID@@IPEAUAE_CURRENT_POSITION@@W4APO_BUFFER_FLAGS@@@Z @ 0x14002FAC4 (-CanCoalesceTimestampMessages@CCrossProcessServerOutputEndpoint@@IEAAHIW4EndpointMessageID@@IPEA.c)
...
LABEL_7:
  ...
  if ( v12 == (_DWORD)v11 )
  {
    AEWMILOG_DROP(v10 + 1, (void *)a1, v13, v10, v11);
    v7 = -2005139385;
    goto LABEL_7;
  }
  v15 = v12;
  if ( a7 == 1 && v13 > 5 )
  {
    v16 = (unsigned int)v11 > v10 ? v10 + v13 - v11 : v10 - (unsigned int)v11;
    if ( v16 >= 5 )
    {
      v17 = v10 - 1;
      if ( !v10 )
  ...
  if ( v9 )
  {
    ...
    *(_QWORD *)(v24 + *(_QWORD *)(a1 + 112) + 32) += *(_QWORD *)(a5 + 16);
  }
  else
  {
    *(_DWORD *)(v24 + v23) = a2;
    *(_DWORD *)(v24 + *(_QWORD *)(a1 + 112) + 4) = a3;
    *(_DWORD *)(v24 + *(_QWORD *)(a1 + 112) + 56) = a4;
    *(_DWORD *)(v24 + *(_QWORD *)(a1 + 112) + 8) = a6;
    v25 = *(_QWORD *)(a1 + 112);
    *(_OWORD *)(v24 + v25 + 16) = *(_OWORD *)a5;
    *(_OWORD *)(v24 + v25 + 32) = *(_OWORD *)(a5 + 16);
    *(_QWORD *)(v24 + v25 + 48) = *(_QWORD *)(a5 + 32);
    *(_QWORD *)(v24 + *(_QWORD *)(a1 + 112) + 40) = v22;
  }
  if ( _InterlockedExchange((volatile __int32 *)(a1 + 144), 0) == 1 )
    *(_DWORD *)(v24 + *(_QWORD *)(a1 + 112) + 52) = 1;
  _InterlockedExchange((volatile __int32 *)(*(_QWORD *)(a1 + 64) + 4LL), v15);
  v28 = *(int *)(v24 + *(_QWORD *)(a1 + 112) + 52);
  AEWMILOG_TIMESTAMP(v28, (void *)a1, v13, 2u, v28, *(_QWORD *)(a5 + 16), v22, *(_QWORD *)a5, *(_QWORD *)(a5 + 8));
  if ( (Microsoft_Windows_AudioEnableBits & 0x400) != 0 )
    Template_pqqqx(
      *(_DWORD *)(v24 + *(_QWORD *)(a1 + 112) + 56),
      *(_QWORD *)(a1 + 112),
      a1,
      v11,
      v10,
      *(_DWORD *)(v24 + *(_QWORD *)(a1 + 112) + 56),
      *(_QWORD *)(v24 + *(_QWORD *)(a1 + 112) + 40));
  return v7;
}
