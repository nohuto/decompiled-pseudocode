/*
 * XREFs of ?IsOutputFormatSupported@CAPOWrapperSrv@@UEAAJPEAUIAudioMediaType@@0PEAPEAU2@@Z @ 0x1400154E0
 * Callers:
        ...
        struct IAudioMediaType **a4)
{
  ...
  if ( !v4 )
    return 2147500033LL;
  v5 = *(__int64 (__fastcall **)(CSystemEffectWrapper *__hidden, struct IAudioMediaType *, struct IAudioMediaType *, struct IAudioMediaType **))(*(_QWORD *)v4 + 64LL);
  if ( v5 == CSystemEffectWrapper::IsOutputFormatSupported )
    return CSystemEffectWrapper::IsOutputFormatSupported(v4, a2, a3, a4);
  else
