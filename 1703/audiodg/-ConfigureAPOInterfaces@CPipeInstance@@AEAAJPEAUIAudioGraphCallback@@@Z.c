/*
 * XREFs of ?ConfigureAPOInterfaces@CPipeInstance@@AEAAJPEAUIAudioGraphCallback@@@Z @ 0x1400095E0
 * Callers:
 ...
 * Callees:
 *     ?InitializeAPOs@CSystemAudioDeviceBase@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x140003A20 (-InitializeAPOs@CSystemAudioDeviceBase@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z.c)
...
LABEL_33:
        ...
        {
          WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 64LL, &WPP_1bb1b06919453819a20d8123e6c4939d_Traceguids, v17);
        }
        AudDGTraceLoggingErrorHelper("CPipeInstance::ConfigureAPOInterfaces", 0x10D4u, v17);
        return v17;
      }
      memset(v8, 0, 8 * v2);
      v9 = *((_QWORD *)this + 3);
