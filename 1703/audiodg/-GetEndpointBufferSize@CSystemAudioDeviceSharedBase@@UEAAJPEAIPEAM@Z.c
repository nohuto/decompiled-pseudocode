/*
 * XREFs of ?GetEndpointBufferSize@CSystemAudioDeviceSharedBase@@UEAAJPEAIPEAM@Z @ 0x14003AC70
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x12u, (__int64)&WPP_d7c84bfd30153aba078899c41fbb18ca_Traceguids, *a2);
  }
  if ( v10 )
