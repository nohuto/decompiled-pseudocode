/*
 * XREFs of ?InitializeAPOs@CSystemAudioDeviceBase@@UEAAJ_KIPEAPEAUIAudioProcessingObject@@@Z @ 0x140003A20
 * Callers:
        ...
        struct IAudioProcessingObject **a4)
{
  ...
  v5 = *(__int64 (__fastcall **)(CSystemAudioDeviceSharedBase *__hidden, unsigned __int64, unsigned int, struct IAudioProcessingObject **))(*(_QWORD *)v4 + 200LL);
