/*
 * XREFs of ?LogAsarUsageReporting@CSpatialCrossProcessEndpointTraceLogger@@QEAAXII@Z @ 0x140059AF0
 * Callers:
        ...
        const GUID *a4)
{
  ...
  unsigned int *v16; // [rsp+80h] [rbp+17h]
  ...
  if ( (unsigned int)dword_1400850A0 > 5 )
  {
    ...
    v15 = 4LL;
    v17 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1400850A0, &unk_14006FE1E, a3, a4, 5u, &pData);
    a2 = v9;
    v4 = v10;
  }
  LOBYTE(cData) = 1;
