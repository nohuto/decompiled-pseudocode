/*
 * XREFs of ?InitializeSecurity@CAudioDGModule@@AEAAJKKK@Z @ 0x140002DF4
 * Callers:
...
__int64 __fastcall CAudioDGModule::InitializeSecurity(CAudioDGModule *this)
{
         ...
         &SecurityDescriptorSize) )
  {
           ...
           &dwPrimaryGroupSize) )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_23720d765f8d3da2cbc3c5fdd3fad56c_Traceguids, 12320LL);
      }
      ...
      WPP_SF_D(v13[2], v14, &WPP_23720d765f8d3da2cbc3c5fdd3fad56c_Traceguids, (unsigned int)v7);
      goto LABEL_33;
    }
  }
  LastError = GetLastError();
...
LABEL_33:
  ...
  if ( v7 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAudioDGModule::InitializeSecurity", 0x302u, v7);
  }
