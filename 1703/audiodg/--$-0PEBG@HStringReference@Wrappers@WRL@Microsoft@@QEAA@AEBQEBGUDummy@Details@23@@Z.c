/*
 * XREFs of ??$?0PEBG@HStringReference@Wrappers@WRL@Microsoft@@QEAA@AEBQEBGUDummy@Details@23@@Z @ 0x140047D0C
 * Callers:
        ...
        const WCHAR **a2)
{
  ...
  {
    RaiseException(v5 < (unsigned int)v3 ? 0x80070216 : 0, 1u, 0, 0LL);
    __debugbreak();
  }
