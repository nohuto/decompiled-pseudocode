/*
 * XREFs of ?SetObjectUsageCounts@CSpatialCrossProcessBaseEndpoint@@UEAAJII@Z @ 0x14005CD60
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a4)
{
  ...
  if ( !v8 )
    goto LABEL_5;
  if ( a2 + v5 > *(_DWORD *)(v8 + 516) )
  {
    v7 = -2005139346;
LABEL_5:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::SetObjectUsageCounts", 1028, v7);
    return v7;
  }
  _InterlockedExchange64((volatile __int64 *)(v8 + 56), __SPAIR64__(v5, a2));
