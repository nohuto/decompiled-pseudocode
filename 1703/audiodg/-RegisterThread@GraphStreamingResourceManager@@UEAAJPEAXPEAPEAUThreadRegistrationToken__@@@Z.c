/*
 * XREFs of ?RegisterThread@GraphStreamingResourceManager@@UEAAJPEAXPEAPEAUThreadRegistrationToken__@@@Z @ 0x140004590
 * Callers:
 *     <none>
 * Callees:
 *     ?InitialRegisterForThread@GraphStreamingResourceManager@@EEAAJPEAXPEAU_t@HandleRegistrations@1@@Z @ 0x140004350 (-InitialRegisterForThread@GraphStreamingResourceManager@@EEAAJPEAXPEAU_t@HandleRegistrations@1@@.c)
        ...
        struct ThreadRegistrationToken__ **a3)
{
  ...
  v7 = (_QWORD *)((char *)v5 + 128);
  if ( *((_DWORD *)v5 + 36) == 17 )
    v8 = ThreadId % 0x11;
  else
    v8 = ThreadId % *((_DWORD *)v5 + 36);
  if ( *v7 )
  {
    v16 = *(_QWORD *)(*v7 + 8 * v8);
    if ( v16 )
    {
      while ( *(_DWORD *)(v16 + 40) != ThreadId || *(_DWORD *)v16 != ThreadId )
      {
        v16 = *(_QWORD *)(v16 + 32);
        if ( !v16 )
          goto LABEL_4;
...
LABEL_4:
  ...
  {
LABEL_8:
    *v3 = (struct ThreadRegistrationToken__ *)v16;
    v13 = 0;
    goto LABEL_9;
  }
LABEL_22:
