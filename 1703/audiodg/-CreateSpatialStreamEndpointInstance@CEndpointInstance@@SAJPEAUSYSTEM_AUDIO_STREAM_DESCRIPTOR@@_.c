/*
 * XREFs of ?CreateSpatialStreamEndpointInstance@CEndpointInstance@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@_JIPEAUSYSTEM_AUDIO_STREAM@@PEAPEAV1@@Z @ 0x140041E28
 * Callers:
        ...
        struct CEndpointInstance **a5)
{
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    WPP_SF_DDD(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      0xFu,
      (__int64)&WPP_c59da3fdbfb03c8b2196f1e98cb9dccc_Traceguids,
      v10);
    v13 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  v14 = *((_QWORD *)a1 + 2);
  if ( (*((_DWORD *)a1 + 22) & 0x40000) != 0 )
  {
    ...
    if ( started < 0 )
    {
      ...
      AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateSpatialStreamEndpointInstance", 0x220u, started);
      v8 = v26[0];
      goto LABEL_30;
    }
    v13 = (_UNKNOWN **)WPP_GLOBAL_Control;
  ...
  *(_OWORD *)v26 = *((_OWORD *)a1 + 3);
  ...
  if ( started >= 0 )
  {
    ...
    {
      v30 = 144;
      v31 = *(_OWORD *)((char *)a1 + 136);
      v32 = *(_OWORD *)((char *)a1 + 152);
      v33 = *(_OWORD *)((char *)a1 + 168);
      v34 = *((_QWORD *)a1 + 23);
      v35 = 0;
      v36 = *((_QWORD *)a1 + 4);
...
LABEL_31:
  if ( v13 != &WPP_GLOBAL_Control && (*((_DWORD *)v13 + 7) & 0x20000) != 0 && *((_BYTE *)v13 + 25) >= 2u )
    WPP_SF_D((__int64)v13[2], 0x12u, (__int64)&WPP_c59da3fdbfb03c8b2196f1e98cb9dccc_Traceguids, started);
  AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateSpatialStreamEndpointInstance", 0x263u, started);
  if ( v8 )
