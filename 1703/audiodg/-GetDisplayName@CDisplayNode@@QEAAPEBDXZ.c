/*
 * XREFs of ?GetDisplayName@CDisplayNode@@QEAAPEBDXZ @ 0x140042CE8
 * Callers:
...
const char *__fastcall CDisplayNode::GetDisplayName(CDisplayNode *this)
{
  ...
  if ( !v23 )
    return "AGC";
  v24 = *(_QWORD *)(v6 + 8) - *(_QWORD *)&GUID_62dc1a93_ae24_464c_a43e_452f824c4250.Data1;
  if ( !v24 )
    v24 = *(_QWORD *)(v6 + 16) - *(_QWORD *)GUID_62dc1a93_ae24_464c_a43e_452f824c4250.Data4;
  if ( !v24 )
    return "Wmalfx";
  v25 = *(_QWORD *)(v6 + 8) - *(_QWORD *)&GUID_637c490d_eee3_4c0a_973f_371958802da2.Data1;
  if ( !v25 )
    v25 = *(_QWORD *)(v6 + 16) - *(_QWORD *)GUID_637c490d_eee3_4c0a_973f_371958802da2.Data4;
  if ( !v25 )
    return "Wmagfx";
  v26 = *(_QWORD *)(v6 + 8) - *(_QWORD *)&GUID_122595e5_20a2_47d3_8604_4a613ff6cca7.Data1;
  if ( !v26 )
    v26 = *(_QWORD *)(v6 + 16) - *(_QWORD *)GUID_122595e5_20a2_47d3_8604_4a613ff6cca7.Data4;
  if ( !v26 )
    return "Spatializer";
  v27 = *(_QWORD *)(v6 + 8) - *(_QWORD *)&GUID_4be8a061_c73b_4f23_8114_317aae3e8698.Data1;
  if ( !v27 )
    v27 = *(_QWORD *)(v6 + 16) - *(_QWORD *)GUID_4be8a061_c73b_4f23_8114_317aae3e8698.Data4;
  if ( !v27 )
    return "VSS";
  if ( *(_DWORD *)(v6 + 4) )
  {
