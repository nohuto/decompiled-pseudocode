/*
 * XREFs of ?GetPingPongReadIndex@CSpatialCrossProcessBaseEndpoint@@IEAAJPEAI@Z @ 0x14005C084
 * Callers:
...
LABEL_4:
  ...
  else
  {
    ...
    {
      v7 = State;
      v6 = `PingPongState::LockForRead'::`2'::nextState[State];
...
LABEL_6:
  ...
  if ( v8 == 2 )
  {
    _InterlockedIncrement((volatile signed __int32 *)(*((_QWORD *)this + 110) + 68LL));
    v9 = -2005139358;
LABEL_13:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetPingPongReadIndex", 674, v9);
    return v9;
  }
  *a2 = v8;
  return 0LL;
