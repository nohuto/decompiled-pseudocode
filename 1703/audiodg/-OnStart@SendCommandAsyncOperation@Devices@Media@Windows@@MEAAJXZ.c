/*
 * XREFs of ?OnStart@SendCommandAsyncOperation@Devices@Media@Windows@@MEAAJXZ @ 0x14004D670
 * Callers:
 *     <none>
 * Callees:
        ...
        Windows::Media::Devices::SendCommandAsyncOperation *this)
{
  ...
  v12 = 0LL;
  v13 = 0LL;
  Microsoft::WRL::ComPtr<ISpatialAudioResourceTaskCompletion>::operator=(&v13, *(_QWORD *)(v1 + 88));
  v3 = v13;
  if ( v13 )
  {
