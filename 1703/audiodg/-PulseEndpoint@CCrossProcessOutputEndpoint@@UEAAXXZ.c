/*
 * XREFs of ?PulseEndpoint@CCrossProcessOutputEndpoint@@UEAAXXZ @ 0x14001C7F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CCrossProcessOutputEndpoint::PulseEndpoint(CCrossProcessOutputEndpoint *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_20d3274620d73806a0357e3cc92dc3ef_Traceguids);
  }
