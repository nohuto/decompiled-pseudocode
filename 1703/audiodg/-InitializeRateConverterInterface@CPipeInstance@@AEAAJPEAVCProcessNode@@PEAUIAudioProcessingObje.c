/*
 * XREFs of ?InitializeRateConverterInterface@CPipeInstance@@AEAAJPEAVCProcessNode@@PEAUIAudioProcessingObject@@@Z @ 0x14000A270
 * Callers:
...
LABEL_16:
  ...
  AudDGTraceLoggingErrorHelper("CPipeInstance::InitializeRateConverterInterface", 0xD59u, v6);
LABEL_3:
  if ( v22 )
  {
