/*
 * XREFs of ?AERTUnlockMemory@@YAJPEAX_K@Z @ 0x1400193F4
 * Callers:
...
__int64 __fastcall AERTUnlockMemory(void *lpAddress, SIZE_T dwSize)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 42LL, &WPP_3e42f0fdf336358029d789576155ad31_Traceguids, lpAddress);
  }
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 43LL, &WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
LABEL_8:
    v5 = WPP_GLOBAL_Control;
  }
  if ( v5 != &WPP_GLOBAL_Control && (*((_DWORD *)v5 + 7) & 0x40000) != 0 && *((_BYTE *)v5 + 25) >= 4u )
    WPP_SF_(v5[2], 44LL, &WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
  return v4;
}
