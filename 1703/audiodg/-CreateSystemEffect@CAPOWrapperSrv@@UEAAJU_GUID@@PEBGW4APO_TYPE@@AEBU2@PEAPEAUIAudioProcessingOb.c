/*
 * XREFs of ?CreateSystemEffect@CAPOWrapperSrv@@UEAAJU_GUID@@PEBGW4APO_TYPE@@AEBU2@PEAPEAUIAudioProcessingObject@@@Z @ 0x140015520
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a6)
{
  ...
  struct _EXCEPTION_POINTERS v42; // [rsp+60h] [rbp-A0h] BYREF
  struct _GUID *v43; // [rsp+70h] [rbp-90h]
  ...
  *a6 = 0LL;
  v8 = 0LL;
  v47 = 0LL;
  if ( InitOnceExecuteOnce(&gRTHeapInitOnce, AERTMemoryInitOnce, 0LL, (LPVOID *)&v42.ContextRecord) )
    ContextRecord = v42.ContextRecord;
  else
    ContextRecord = 0LL;
...
LABEL_63:
  ...
  *(struct _GUID *)&v10[10].lpVtbl = *a5;
  ...
  {
    v17 = (const struct _GUID *)CoTaskMemAlloc(2 * v16);
    v12 = v17;
...
LABEL_22:
  LODWORD(v42.ExceptionRecord) = ExceptionRecord;
  if ( ExceptionRecord >= 0 )
  {
    v27 = APOCatchCoCreateInstance(v43, v13 + 1, v11, v12, p_lpVtbl, &v42);
    ExceptionRecord = v27;
    if ( v27 < 0 )
    {
      v48 = *(_OWORD *)&v13[10].lpVtbl;
      APOTrackAndLogException(v28, v13[12].lpVtbl, LODWORD(v13[13].lpVtbl), &v48, "CSystemEffectWrapper::Init", 81, v27);
    }
    else
    {
      ExceptionRecord = (int)v42.ExceptionRecord;
    }
    if ( ExceptionRecord >= 0 )
...
LABEL_27:
  ...
  if ( ExceptionRecord >= 0 )
  {
    ...
    v32 = v30 == CSystemEffectWrapper::QueryInterface
        ...
        : ((__int64 (__fastcall *)(CSystemEffectWrapper *, GUID *, void **, const struct _GUID *))v30)(
            v8,
      ...
      if ( v41 != v33 )
      {
        ...
        if ( v33 )
        {
          ...
          if ( v35 == CSystemEffectWrapper::QueryInterface )
            CSystemEffectWrapper::QueryInterface(v33, &GUID_5fa00f27_add6_499a_8a9d_6b98521fa75b, &v41);
          else
            v35(v33, &GUID_5fa00f27_add6_499a_8a9d_6b98521fa75b, &v41);
        }
        if ( v34 )
...
LABEL_64:
  if ( (unsigned int)hProvider > 2 )
  {
    ...
    HIDWORD(v42.ExceptionRecord) = 63;
    v53 = (char *)&v42.ExceptionRecord + 4;
    v54 = 4LL;
    v55 = &v40;
    v56 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_14006F553, v38, v39, 5u, &pData);
    ExceptionRecord = v40;
  }
LABEL_39:
  if ( v8 )
