/*
 * XREFs of _CPipeInstance::CreateStreamPipeInstance_::_1_::dtor$16 @ 0x140021880
 * Callers:
 *     <none>
 * Callees:
...
{
  Windows::Media::Devices::SendCommandAsyncOperation::OnCancel(*(Windows::Media::Devices::SendCommandAsyncOperation **)(a2 + 408));
}
