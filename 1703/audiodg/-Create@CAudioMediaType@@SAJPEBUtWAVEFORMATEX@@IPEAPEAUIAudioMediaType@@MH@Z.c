/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x14000E610
 * Callers:
 ...
 * Callees:
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x14001B4B4 (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
...
LABEL_41:
      ...
      *a3 = (struct IAudioMediaType *)v9;
      v29 = *(unsigned int (__fastcall **)(CAudioMediaType *__hidden))(*v9 + 8LL);
