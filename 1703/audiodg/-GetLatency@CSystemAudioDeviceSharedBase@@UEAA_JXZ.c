/*
 * XREFs of ?GetLatency@CSystemAudioDeviceSharedBase@@UEAA_JXZ @ 0x140004D10
 * Callers:
...
__int64 __fastcall CSystemAudioDeviceSharedBase::GetLatency(CSystemAudioDeviceSharedBase *this)
{
  ...
  __int64 v4; // rdi
  __int64 (__fastcall *v5)(CAudioDeviceGraph *__hidden, unsigned __int64, __int64 *); // rax
  int Latency; // eax
  ...
  v4 = 0LL;
  v8 = 0LL;
  v5 = *(__int64 (__fastcall **)(CAudioDeviceGraph *__hidden, unsigned __int64, __int64 *))(*(_QWORD *)v2 + 64LL);
