/*
 * XREFs of ?GetLatency@CAudioDeviceGraph@@UEAAJ_KPEA_J@Z @ 0x14000FB60
 * Callers:
 ...
 *     ??1CCritSecLock@ATL@@QEAA@XZ @ 0x1400303EC (--1CCritSecLock@ATL@@QEAA@XZ.c)
...
__int64 __fastcall CAudioDeviceGraph::GetLatency(CAudioDeviceGraph *this, _QWORD *a2, __int64 *a3)
{
  ...
  __int64 (__fastcall *v13)(CProcessNode *__hidden, __int64 *); // rax
...
LABEL_26:
  ...
  do
  {
    ...
    while ( v10 )
    {
      ...
      v10 = (_QWORD *)*v10;
      v13 = *(__int64 (__fastcall **)(CProcessNode *__hidden, __int64 *))(*(_QWORD *)v12 + 56LL);
      if ( v13 == CAPOProcessNode::GetLatency )
      {
        v14 = *(CProcessNode **)(*((_QWORD *)v12 + 4) + 40LL);
        v13 = *(__int64 (__fastcall **)(CProcessNode *__hidden, __int64 *))(*(_QWORD *)v14 + 32LL);
      }
      else
      {
        v14 = v12;
        ...
        if ( *((_DWORD *)v12 + 10) == 2 )
        {
          ...
          if ( *(_DWORD *)(v23 + 4) )
          {
            ...
            if ( v31 )
            {
              ...
              byte_140086168 = 1;
              TraceLoggingRegisterEx(qword_140086170, v26, v27);
              dword_14008616C = 1;
            ...
            if ( *(_DWORD *)v28 > 2u )
            {
              ...
              v32 = v16;
              v56 = 4LL;
              TlgWrite(v28, &unk_14006F405, v24, v25, 4u, &pData);
            }
          }
        }
      }
        ...
        if ( *((_DWORD *)v12 + 10) == 2 )
        {
          ...
          if ( *(_DWORD *)(v17 + 4) )
          {
            ...
            if ( fPending )
            {
              ...
              qword_140086160 = (__int64)qword_140086170;
              byte_140086168 = 1;
              TraceLoggingRegisterEx(qword_140086170, v21, v22);
              dword_14008616C = 1;
              (*(void (__fastcall **)(__int64 *))(qword_140086158 + 8))(&qword_140086158);
              InitOnceComplete(&`AudioDgTelemetryProvider::Instance'::`2'::wrapper, 0, &qword_140086158);
            }
            ...
            if ( *(_DWORD *)v19 > 4u )
            {
              ...
              v40[0] = ((unsigned int)&unk_14006F3D4 - (unsigned int)&TraceLoggingMetadata) | 0xB000000;
              v20 = *(_QWORD *)(v19 + 32);
              v41 = 0LL;
              v43 = *v42;
              v45 = &unk_14006F3DF;
...
LABEL_16:
  ...
  if ( v4 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::GetLatency", 0x2C8u, v4);
  }
