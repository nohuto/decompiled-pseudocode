/*
 * XREFs of _CPipeInstance::CreateSubmixPipeInstance_::_1_::dtor$11 @ 0x140021A12
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CPipeInstance::CreateSubmixPipeInstance_::_1_::dtor_11(__int64 a1, __int64 a2)
{
