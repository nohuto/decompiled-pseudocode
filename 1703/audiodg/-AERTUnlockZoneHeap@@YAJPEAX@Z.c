/*
 * XREFs of ?AERTUnlockZoneHeap@@YAJPEAX@Z @ 0x14004630C
 * Callers:
...
__int64 __fastcall AERTUnlockZoneHeap(void *a1, void *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x38u, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids, a1);
  }
  if ( a1 )
  {
    ...
    if ( (v4 & 0xC0000000) == 0xC0000000 )
    {
      ...
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x39u, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
      }
    }
  }
  else
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Au, (__int64)&WPP_3e42f0fdf336358029d789576155ad31_Traceguids);
  }
