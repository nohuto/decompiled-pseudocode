/*
 * XREFs of ?DdiRecommendFunctionalVidPn@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDFUNCTIONALVIDPN@@@Z @ 0x1C01778B4
 * Callers:
...
LABEL_14:
  ...
  v18 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RECOMMENDFUNCTIONALVIDPN *))(*((_QWORD *)this + 2) + 480LL))(
  ...
  v25[5] = a2->NumberOfVidPnTargets;
  if ( a2->NumberOfVidPnTargets )
    v26 = *a2->pVidPnTargetPrioritizationVector;
  else
    v26 = 0LL;
  v25[6] = v26;
  v25[7] = a2->hRecommendedFunctionalVidPn;
  WdLogEvent5_WdEvent(v25);
  if ( (_DWORD)v18 != -1073741801
    && (_DWORD)v18 != -1071774941
    && (_DWORD)v18 != -1071774920
    && (_DWORD)v18 != -1071774664
    && (_DWORD)v18 )
  {
