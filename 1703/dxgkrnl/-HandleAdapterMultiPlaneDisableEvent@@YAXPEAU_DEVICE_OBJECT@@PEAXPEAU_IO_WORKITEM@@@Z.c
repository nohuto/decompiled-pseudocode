/*
 * XREFs of ?HandleAdapterMultiPlaneDisableEvent@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C016E0C0
 * Callers:
...
void __fastcall HandleAdapterMultiPlaneDisableEvent(PVOID IoObject, unsigned int *Context, PIO_WORKITEM IoWorkItem)
{
  ...
  v5 = (_QWORD *)WdLogNewEntry5_WdEvent(IoObject);
  v5[3] = *(_QWORD *)Context;
  v5[4] = Context[2];
  v5[5] = Context[3];
  ...
  if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
  {
    v9 = Context[3];
    v8 = Context[2];
    Template_pqq(v6, &MultiPlaneOverlayDisable, v7, *(_QWORD *)Context, v8, v9);
  }
  memset(v10, 0, 0x20uLL);
  LODWORD(v10[0]) = 14;
  v10[2] = 1LL;
  SMgrGdiCallout(v10, 0LL, 0LL, 0LL, 0LL, 0LL);
