/*
 * XREFs of ?_GetColorPrimariesType@DXGMONITOR@@AEAA?AW4ColorPrimaryType@1@XZ @ 0x1C01061AC
 * Callers:
 *     ?_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ @ 0x1C010612C (-_UpdateHDRParamsIfRequired@DXGMONITOR@@AEAAXXZ.c)
 * Callees:
 *     ?_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z @ 0x1C0106428 (-_GetColorGamutTriangleArea@DXGMONITOR@@AEAANNNNNNN@Z.c)
 *     ?_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z @ 0x1C0106498 (-_GetDeltaBetweenPoints@DXGMONITOR@@AEAANNNNN@Z.c)
 */
...
__int64 __fastcall DXGMONITOR::_GetColorPrimariesType(_DWORD *a1)
{
  ...
  if ( !v5 )
    return 0LL;
  v6 = (DXGMONITOR *)(unsigned int)a1[144];
  if ( !(_DWORD)v6 )
    return 0LL;
