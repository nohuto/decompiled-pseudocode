/*
 * XREFs of ?_MigrateSimulatedMonitor@MONITOR_MGR@@QEAAJIW4_DMM_VIDPN_MONITOR_TYPE@@PEAVDXGMONITOR@@PEAPEAV3@@Z @ 0x1C01E2F28
 * Callers:
        ...
        struct DXGMONITOR **a5)
{
  ...
  else
  {
    if ( v17 == (_DWORD)v5 )
    {
      v18 = WdLogNewEntry5_WdDmmEvent(v11, v10, v13, v14);
      *(_QWORD *)(v18 + 24) = v7;
      *(_QWORD *)(v18 + 32) = v5;
    ...
    {
      v19 = WdLogNewEntry5_WdDmmEvent(v11, v10, v13, v14);
      *(_QWORD *)(v19 + 24) = v7;
      *(_QWORD *)(v19 + 32) = v5;
