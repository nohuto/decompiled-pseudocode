/*
 * XREFs of DpiFdoHandleSurpriseRemoval @ 0x1C01C4780
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DpiFdoHandleSurpriseRemoval(struct _DEVICE_OBJECT *a1, IRP *a2)
{
  ...
  if ( (_DWORD)v6 != 6 )
  {
    ...
    {
      IsDevicePresent = DpiFdoIsDevicePresent(DeviceExtension, &v26);
...
LABEL_18:
    ...
    {
      KeEnterCriticalRegion();
      ExAcquireResourceExclusiveLite((PERESOURCE)(v7 + 3600), 1u);
      ...
      *(_DWORD *)(DeviceExtension + 236) = 6;
      ExReleaseResourceLite((PERESOURCE)(v7 + 3600));
      ...
      if ( *(_BYTE *)(v7 + 480) )
      {
        if ( *(_DWORD *)(v7 + 3784) != 3 )
        {
          ...
          if ( v6 )
          {
            ...
            DXGGLOBAL::NotifyAdapterRemoval(Global, v20, v21, v22);
            *(_DWORD *)(v7 + 3784) = 3;
          }
        }
      }
