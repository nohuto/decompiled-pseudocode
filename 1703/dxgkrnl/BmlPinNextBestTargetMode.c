/*
 * XREFs of BmlPinNextBestTargetMode @ 0x1C00F24D8
 * Callers:
...
__int64 __fastcall BmlPinNextBestTargetMode(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
LABEL_31:
    v32 = WdLogNewEntry5_WdError(v12, a2);
    *(_QWORD *)(v32 + 24) = v11;
...
LABEL_47:
  ...
  if ( *(_WORD *)(a1 + v8 + 68) )
  {
    if ( !*((_QWORD *)v16 + 18) )
    {
      v35 = WdLogNewEntry5_WdAssertion(v21, v18, v19, v20);
  ...
  if ( *(_WORD *)(a1 + v8 + 70) )
  {
    if ( *((_QWORD *)v16 + 18) )
    {
      v34 = WdLogNewEntry5_WdAssertion(v21, v18, v19, v20);
...
LABEL_13:
    ...
    while ( 1 )
    {
      ...
      if ( v48 == -1 )
      {
        v36 = WdLogNewEntry5_WdAssertion(v21, v18, v19, v20);
        WdLogEvent5_WdAssertion(v36);
      }
      ++*(_WORD *)(a1 + v8 + 68);
      LOBYTE(v20) = 1;
      LODWORD(v23) = VIDPN_MGR::PinVidPnTargetMode(v46, v16, (unsigned int)v22, v20);
      if ( (int)v23 >= 0 )
      {
...
LABEL_46:
  ...
  if ( !*((_QWORD *)v16 + 18) )
  {
    v33 = WdLogNewEntry5_WdAssertion(v21, v18, v19, v20);
