/*
 * XREFs of DpiMiracastTearDownAssociation @ 0x1C003F900
 * Callers:
...
void __fastcall DpiMiracastTearDownAssociation(char *P, int a2, int a3, unsigned int a4, char a5)
{
  ...
  if ( v9 )
  {
    ...
    *((_DWORD *)P + 104) = a3;
    ...
    if ( !P[590] && (Microsoft_Windows_DxgKrnlEnableBits & 0x800000) != 0 )
      Template_qqz(
        v13,
    ...
    *((_QWORD *)P + 80) = MEMORY[0xFFFFF78000000014];
    ...
    if ( !a5 )
    {
      *((_QWORD *)P + 11) = 0LL;
      ...
      if ( *(_BYTE *)(v11 + 483) )
        _InterlockedDecrement((volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v11 + 24) + 64LL) + 3888LL));
