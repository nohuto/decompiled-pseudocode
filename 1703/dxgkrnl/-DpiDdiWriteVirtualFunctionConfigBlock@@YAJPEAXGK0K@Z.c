/*
 * XREFs of ?DpiDdiWriteVirtualFunctionConfigBlock@@YAJPEAXGK0K@Z @ 0x1C0041D40
 * Callers:
 *     <none>
 * Callees:
 *     DxgkDdiWriteVirtualFunctionConfigBlock @ 0x1C0033FF8 (DxgkDdiWriteVirtualFunctionConfigBlock.c)
...
__int64 __fastcall DpiDdiWriteVirtualFunctionConfigBlock(_QWORD *a1, unsigned __int16 a2, ULONG a3, void *a4, ULONG a5)
{
  unsigned int v8; // ebx
  ...
  if ( v12 >= 0 )
  {
    v8 = DxgkDdiWriteVirtualFunctionConfigBlock(*(_QWORD *)(v11 + 3704), a2, a3, a4, a5);
    v12 = v8;
  }
