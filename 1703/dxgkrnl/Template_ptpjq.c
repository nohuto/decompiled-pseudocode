/*
 * XREFs of Template_ptpjq @ 0x1C00438E0
 * Callers:
...
NTSTATUS Template_ptpjq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v10 = 16LL;
  v12 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventOPMGetInformation, 0LL, 5u, &UserData);
}
