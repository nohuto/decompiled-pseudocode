/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_HOST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C002B8C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a5)
{
  ...
  VgpuDebugPrint("DXG_HOST_GLOBAL_VMBUS::VmBusChannelProcessPacket %p\n", a2);
  ...
  if ( a4 >= 0x10 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *PoolWithTag = 0LL;
      ...
      VgpuDebugPrint("DXG_HOST_GLOBAL_VMBUS::VmBusChannelProcessPacketQueueWorkItem %p\n", a2);
      v15[6] = 0LL;
      *((_DWORD *)v15 + 21) = a5;
      v15[4] = a1;
      *((_DWORD *)v15 + 20) = a4;
