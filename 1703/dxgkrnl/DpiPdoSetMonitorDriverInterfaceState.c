/*
 * XREFs of DpiPdoSetMonitorDriverInterfaceState @ 0x1C01CEE34
 * Callers:
...
__int64 __fastcall DpiPdoSetMonitorDriverInterfaceState(PVOID Object, char a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *((_BYTE *)PoolWithTag + 24) = a2;
    ...
    v8 = (_QWORD *)qword_1C006FD48;
    if ( *(__int64 **)qword_1C006FD48 != &qword_1C006FD40 )
      __fastfail(3u);
    *PoolWithTag = &qword_1C006FD40;
    PoolWithTag[1] = v8;
    *v8 = PoolWithTag;
    qword_1C006FD48 = (__int64)PoolWithTag;
    if ( !byte_1C006FD00 )
    {
