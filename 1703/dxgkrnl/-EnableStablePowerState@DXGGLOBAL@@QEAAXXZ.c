/*
 * XREFs of ?EnableStablePowerState@DXGGLOBAL@@QEAAXXZ @ 0x1C01956AC
 * Callers:
...
void __fastcall DXGGLOBAL::EnableStablePowerState(DXGGLOBAL *this, __int64 a2, __int64 a3, __int64 a4)
{
  _QWORD **v4; // rsi
  __int64 v5; // rdx
  __int64 v6; // r8
  ...
  while ( v8 != v4 && v8 )
  {
    ...
    if ( (_BYTE)v10 )
    {
      ...
      if ( (int)COREADAPTERACCESS::AcquireExclusive(&v13, 1u) >= 0 )
        DXGADAPTER::EnableStablePowerState((ADAPTER_RENDER **)v9);
