/*
 * XREFs of Template_pqdqqpp @ 0x1C003C758
 * Callers:
...
NTSTATUS Template_pqdqqpp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v14 = 8LL;
  v16 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndirectSwapChainCreate, 0LL, 7u, &UserData);
}
