/*
 * XREFs of ?DdiSetGpuPartitionCount@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETGPUPARTITIONCOUNT@@@Z @ 0x1C0028F30
 * Callers:
...
LABEL_11:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETGPUPARTITIONCOUNT *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                              + 40LL))(
