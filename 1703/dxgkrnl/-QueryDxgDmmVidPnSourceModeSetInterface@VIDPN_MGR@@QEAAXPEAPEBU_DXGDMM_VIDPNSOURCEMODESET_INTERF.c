/*
 * XREFs of ?QueryDxgDmmVidPnSourceModeSetInterface@VIDPN_MGR@@QEAAXPEAPEBU_DXGDMM_VIDPNSOURCEMODESET_INTERFACE@@@Z @ 0x1C00E4A48
 * Callers:
        ...
        __int64 a4)
{
  ...
  *a2 = (const struct _DXGDMM_VIDPNSOURCEMODESET_INTERFACE *)*((_QWORD *)this + 54);
}
