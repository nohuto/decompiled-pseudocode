/*
 * XREFs of ?Serialize@DMMVIDPNSOURCEMODESET@@QEBAJPEAV?$AutoBuffer@U_DMM_VIDPNSOURCEMODESET_SERIALIZATION@@@DMM@@@Z @ 0x1C01DD9AC
 * Callers:
...
__int64 __fastcall DMMVIDPNSOURCEMODESET::Serialize(DMMVIDPNSOURCEMODESET *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      v19 = *(_BYTE **)(a2 + 32);
      *v19 = *((_BYTE *)this + 64);
      v20 = (DMMVIDPNSOURCEMODESET *)*((_QWORD *)this + 6);
      if ( v20 != (DMMVIDPNSOURCEMODESET *)((char *)this + 48) )
      {
        for ( i = (DMMVIDPNSOURCEMODESET *)((char *)v20 - 8); i; i = DMMVIDPNSOURCEMODESET::GetNextMode(
                                                                       this,
                                                                       i,
                                                                       v22,
                                                                       v23) )
          DMMVIDPNSOURCEMODE::Serialize(
            i,
            (struct _D3DKMDT_VIDPN_SOURCE_MODE *const)(*(_QWORD *)(a2 + 32) + 4LL + 40LL * v18++),
            v14,
            v15);
      }
      if ( v18 != **(_BYTE **)(a2 + 32) )
