/*
 * XREFs of ?GetDataBlock@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAA_NIPEAPEAU_EDID_V1_CEA_861_DATA_HEADER@@@Z @ 0x1C0045F84
 * Callers:
 ...
 *     ?GetHDRData@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAA_NPEAU_EDID_V1_CEA_861_HDR_DESC@@@Z @ 0x1C0046028 (-GetHDRData@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAA_NPEAU_EDID_V1_CEA_861_HDR_DESC@@@Z.c)
...
bool __fastcall MonDescParser::EDID_PARSER_CEA_861_EXT::GetDataBlock(
  ...
  *a3 = 0LL;
  ...
  if ( v5 > 4 )
  {
    while ( v6 < 0x80 )
    {
      ...
      {
        result = 1;
        *a3 = (struct _EDID_V1_CEA_861_DATA_HEADER *)(v3 + v6);
        return result;
      }
      ++v4;
      v6 += (*(_BYTE *)(v6 + v3) & 0x1F) + 1;
      if ( v6 >= v5 )
        return 0;
    }
  }
