/*
 * XREFs of ?TdrAllowToDebugEngineTimeout@@YA_NPEAU_VIDSCH_NODE@@@Z @ 0x1C01917A0
 * Callers:
 *     <none>
 * Callees:
 *     ?TdrValidateDebugMode@@YAXXZ @ 0x1C00363D8 (-TdrValidateDebugMode@@YAXXZ.c)
 */
...
bool __fastcall TdrAllowToDebugEngineTimeout(struct _VIDSCH_NODE *a1)
{
  ...
  if ( (byte_1C006FEF4 || (unsigned __int8)WdQueryDebugFlag(0LL)) && !g_TdrDebugMode )
  {
    DbgPrintEx(
      0x65u,
      0,
