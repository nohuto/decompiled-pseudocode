/*
 * XREFs of ?_SaveAdvancedColorEnabledToMonitorStore@DXGMONITOR@@AEAAJXZ @ 0x1C01E6064
 * Callers:
...
__int64 __fastcall DXGMONITOR::_SaveAdvancedColorEnabledToMonitorStore(
        DXGMONITOR *this,
        __int64 a2,
        __int64 a3,
        __int64 a4)
