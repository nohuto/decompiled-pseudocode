/*
 * XREFs of ?SetModeBehavior@DXGADAPTER@@AEAAXEE@Z @ 0x1C010DD28
 * Callers:
...
void __fastcall DXGADAPTER::SetModeBehavior(DXGADAPTER *this, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)&v12.Request.0 = 0LL;
  ...
  if ( (_BYTE)a3 )
  {
    ...
    *(_DWORD *)&v11.Length = 6422624;
    v15[5] = *(_OWORD *)L"dows\\DWM";
    *(_DWORD *)&v10.Length = 1310738;
    v10.Buffer = (wchar_t *)&v13;
    if ( ReadRegistryDwordKeyValue(&v11, &v10, &v9) >= 0 )
    {
      LOBYTE(v3) = v9 != 0;
  ...
  {
    v12.Request.Value |= 1u;
  }
  v6 = (int)DXGADAPTER::DdiControlModeBehavior(this, &v12, a3);
