/*
 * XREFs of DxgkGetMemoryBudgetTarget @ 0x1C0121330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetMemoryBudgetTarget(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(a1, &EventProfilerEnter, a3, 2144);
  if ( CheckTokenForResourceManagerAccess() )
  {
    ...
    if ( *v8 >= 0x10u )
    {
      ...
      if ( HIDWORD(v44) )
      {
        ...
        *(_QWORD *)(v39 + 24) = -1073741811LL;
        ...
        if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
          Template_q(v40, &EventProfilerExit, v41, 2144);
        return 3221225485LL;
      }
      else
      {
        ...
        *v33 = v28;
        ...
        if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
          Template_q(v34, &EventProfilerExit, v35, 2144);
        return 0LL;
      }
    }
    else
    {
      ...
      *(_QWORD *)(v10 + 24) = 3986LL;
      WdLogEvent5_WdWarning(v10);
      if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
        Template_q(v11, &EventProfilerExit, v12, 2144);
      return 3221225485LL;
    }
  }
  else
  {
    ...
    *(_QWORD *)(v36 + 32) = -1073741790LL;
    ...
    if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q(qword_1C006E790, &EventProfilerExit, v38, 2144);
    return 3221225506LL;
  }
}
