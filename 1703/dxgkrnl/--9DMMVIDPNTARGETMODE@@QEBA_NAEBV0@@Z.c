/*
 * XREFs of ??9DMMVIDPNTARGETMODE@@QEBA_NAEBV0@@Z @ 0x1C000D04C
 * Callers:
...
_BOOL8 __fastcall DMMVIDPNTARGETMODE::operator!=(__int64 a1, __int64 a2)
{
  __int64 v3; // r9
  _BOOL8 result; // rax
  int v5; // edx
    ...
    && *(_QWORD *)(a1 + 112) == *(_QWORD *)(((a2 + 72) & -(__int64)(a2 != 0)) + 0x28) )
  {
      ...
      && (((unsigned __int16)v6 ^ (unsigned __int16)v5) & 0x1F8) == 0 )
    {
      v7 = *(_DWORD *)(a1 + 128);
      v8 = *(_DWORD *)(a2 + 128);
      if ( (((unsigned __int8)v7 ^ *(_BYTE *)(a2 + 128)) & 3) == 0
        && (((unsigned __int8)v7 ^ (unsigned __int8)v8) & 0xFC) == 0
        && (((unsigned __int16)v7 ^ (unsigned __int16)v8) & 0x3F00) == 0
        && ((v7 ^ v8) & 0xFC000) == 0
        && ((v7 ^ v8) & 0x3F00000) == 0
        && ((v7 ^ v8) & 0xFC000000) == 0 )
      {
