/*
 * XREFs of ?PinVidPnTargetMode@VIDPN_MGR@@QEBAJQEAVDMMVIDPNTARGETMODESET@@I_N@Z @ 0x1C00E4108
 * Callers:
        ...
        __int64 a4)
{
  ...
  else
  {
    ...
    LOBYTE(v17) = v5;
    v53 = -1;
    v18 = VIDPN_MGR::FormalizeVidPnChange(this, Container & -(__int64)(Container != -88), 5LL, v17, &v53);
    v23 = v18;
    if ( v18 < 0 )
    {
      if ( v18 == -1071774970 )
