/*
 * XREFs of ?ScheduleAdapterActivityCheck@DXGADAPTER@@QEAAXXZ @ 0x1C00068F4
 * Callers:
...
void __fastcall DXGADAPTER::ScheduleAdapterActivityCheck(KSPIN_LOCK *this)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v7, this + 348, 0);
  ...
  *(_QWORD *)(this[335] + 392) = MEMORY[0xFFFFF78000000320];
  *(_QWORD *)(this[335] + 392) += this[328];
  v4 = (KSPIN_LOCK *)(this[335] + 400);
  if ( !*v4 )
  {
    v5 = (KSPIN_LOCK **)(this + 346);
    v2 = this[346];
    if ( *(KSPIN_LOCK **)(v2 + 8) != this + 346 )
      __fastfail(3u);
    *v4 = v2;
    v4[1] = (KSPIN_LOCK)v5;
    *(_QWORD *)(v2 + 8) = v4;
  ...
  if ( !*((_BYTE *)this + 2756) )
  {
    ...
    LOBYTE(v2) = 1;
    *((_BYTE *)this + 2756) = 1;
    (*(void (__fastcall **)(_QWORD, KSPIN_LOCK))(*(_QWORD *)(*(_QWORD *)(v6 + 408) + 8LL) + 760LL))(
      *(_QWORD *)(v6 + 416),
      v2);
  }
  if ( v10 )
