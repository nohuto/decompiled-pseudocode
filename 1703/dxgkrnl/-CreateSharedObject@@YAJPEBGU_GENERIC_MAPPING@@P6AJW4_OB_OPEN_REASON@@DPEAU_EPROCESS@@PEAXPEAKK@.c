/*
 * XREFs of ?CreateSharedObject@@YAJPEBGU_GENERIC_MAPPING@@P6AJW4_OB_OPEN_REASON@@DPEAU_EPROCESS@@PEAXPEAKK@ZP6AX34_K7@ZP6AX4@ZPEAPEAU_OBJECT_TYPE@@W4_POOL_TYPE@@@Z @ 0x1C0120FB4
 * Callers:
        ...
        enum _POOL_TYPE a7)
{
  ...
  *(_QWORD *)((char *)v13 + 4) = 0x10000000000LL;
  BYTE2(v13[0]) = (a3 != 0LL ? 0x10 : 0) | BYTE2(v13[0]) & 0x8D | (a3 != 0LL ? 12 : 14) & 0x8F | 1;
  v13[5] = 0LL;
  v13[6] = 0LL;
  memset(&v13[10], 0, 32);
