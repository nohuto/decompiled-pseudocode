/*
 * XREFs of ?UpdateScaleFactorForOverride@@YAXPEAU_DPI_INFORMATION@@HPEBU_DPI_SCALE_FACTOR_COLLECTION@@@Z @ 0x1C003C1A4
 * Callers:
...
{
  const struct _DPI_SCALE_FACTOR_COLLECTION *v5; // [rsp+20h] [rbp-8h]
