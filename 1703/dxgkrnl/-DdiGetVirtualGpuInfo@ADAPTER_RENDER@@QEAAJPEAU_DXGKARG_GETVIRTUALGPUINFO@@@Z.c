/*
 * XREFs of ?DdiGetVirtualGpuInfo@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z @ 0x1C0027DD4
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiGetVirtualGpuInfo(ADAPTER_RENDER *this, struct _DXGKARG_GETVIRTUALGPUINFO *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  __int64 v6; // r8
...
LABEL_11:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETVIRTUALGPUINFO *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                           + 72LL))(
  ...
  if ( (_DWORD)v16 != -1073741823 && (_DWORD)v16 != -1073741811 )
  {
    v24 = (int)v16 < 0;
    if ( !(_DWORD)v16 )
      goto LABEL_23;
