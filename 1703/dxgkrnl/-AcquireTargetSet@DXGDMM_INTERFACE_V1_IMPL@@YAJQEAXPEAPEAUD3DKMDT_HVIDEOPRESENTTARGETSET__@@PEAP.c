/*
 * XREFs of ?AcquireTargetSet@DXGDMM_INTERFACE_V1_IMPL@@YAJQEAXPEAPEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEAPEBU_DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE@@@Z @ 0x1C01D7870
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 && a3 )
  {
    ...
    *a3 = 0LL;
    if ( this )
    {
      ...
      {
        v17 = *(_QWORD *)(v16 + 88);
        v19 = *(struct D3DKMDT_HVIDEOPRESENTTARGETSET__ **)(v17 + 408);
        _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(v17 + 80) + 72LL));
        v9 = *(_QWORD *)(v17 + 80) & -(__int64)(*(_QWORD *)(v17 + 80) != -112LL);
        *a2 = v9;
        *a3 = v19;
        goto LABEL_15;
      }
