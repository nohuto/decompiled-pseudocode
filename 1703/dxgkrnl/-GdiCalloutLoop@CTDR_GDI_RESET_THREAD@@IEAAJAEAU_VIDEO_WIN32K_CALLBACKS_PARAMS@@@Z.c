/*
 * XREFs of ?GdiCalloutLoop@CTDR_GDI_RESET_THREAD@@IEAAJAEAU_VIDEO_WIN32K_CALLBACKS_PARAMS@@@Z @ 0x1C019148C
 * Callers:
        ...
        struct _VIDEO_WIN32K_CALLBACKS_PARAMS *a2)
{
  ...
  DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v10, v4, v5, v7);
