/*
 * XREFs of DpiEnterSystemDisplay @ 0x1C000FB10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_61:
    ...
    {
      v18 = v19;
      if ( !v19 && qword_1C006FC08 && v5 == *(_QWORD *)(qword_1C006FC08 + 64) )
        *(_DWORD *)(a2 + 16) = 1;
      else
        *(_DWORD *)(a2 + 16) = 5;
LABEL_60:
