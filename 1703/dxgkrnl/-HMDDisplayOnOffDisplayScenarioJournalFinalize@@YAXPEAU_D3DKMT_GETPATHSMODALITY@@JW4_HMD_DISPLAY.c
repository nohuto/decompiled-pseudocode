/*
 * XREFs of ?HMDDisplayOnOffDisplayScenarioJournalFinalize@@YAXPEAU_D3DKMT_GETPATHSMODALITY@@JW4_HMD_DISPLAY_ON_OFF_FAILURE_STAGE@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00A69EC
 * Callers:
