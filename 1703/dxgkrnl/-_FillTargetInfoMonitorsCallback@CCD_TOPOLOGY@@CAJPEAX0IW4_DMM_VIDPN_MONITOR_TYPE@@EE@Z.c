/*
 * XREFs of ?_FillTargetInfoMonitorsCallback@CCD_TOPOLOGY@@CAJPEAX0IW4_DMM_VIDPN_MONITOR_TYPE@@EE@Z @ 0x1C00EA1E0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a6)
{
  ...
  const struct _D3DKMT_PATHMODALITY_DESCRIPTOR *v14; // rdx
  __int64 v16; // rax
  ...
  for ( i = 0; ; ++i )
  {
    ...
    if ( *((_DWORD *)PathDescriptor + 7) == a3
      && *((_DWORD *)PathDescriptor + 4) == *(_DWORD *)(a1 + 268)
      && *((_DWORD *)PathDescriptor + 5) == *(_DWORD *)(a1 + 272) )
    {
      if ( a5 )
