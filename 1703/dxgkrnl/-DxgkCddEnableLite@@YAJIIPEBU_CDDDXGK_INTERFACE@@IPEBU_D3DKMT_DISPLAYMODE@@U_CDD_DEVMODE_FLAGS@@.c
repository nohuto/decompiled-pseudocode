/*
 * XREFs of ?DxgkCddEnableLite@@YAJIIPEBU_CDDDXGK_INTERFACE@@IPEBU_D3DKMT_DISPLAYMODE@@U_CDD_DEVMODE_FLAGS@@E@Z @ 0x1C0182720
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkCddEnableLite(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (qword_1C006E790 & 2) != 0 )
  {
    ...
    {
      Template_q(qword_1C006E790, &EventProfilerEnter, a3, 3040);
      v3 = qword_1C006E790;
    }
