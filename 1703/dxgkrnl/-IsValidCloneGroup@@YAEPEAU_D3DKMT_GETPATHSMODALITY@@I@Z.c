/*
 * XREFs of ?IsValidCloneGroup@@YAEPEAU_D3DKMT_GETPATHSMODALITY@@I@Z @ 0x1C01AAD30
 * Callers:
 ...
 * Callees:
 *     ?IsVirtualModeSupported@@YAEAEAU_D3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C01AAE04 (-IsVirtualModeSupported@@YAEAEAU_D3DKMT_PATHMODALITY_DESCRIPTOR@@@Z.c)
 */
...
char __fastcall IsValidCloneGroup(struct _D3DKMT_GETPATHSMODALITY *a1, unsigned int a2)
{
  ...
  v3 = 1;
  v4 = (char *)a1 + 264 * a2;
  v5 = IsVirtualModeSupported((struct _D3DKMT_PATHMODALITY_DESCRIPTOR *)(v4 + 48));
  v7 = v6 + 1;
  v8 = 0;
  for ( i = v5; v7 < *((unsigned __int16 *)a1 + 10); ++v7 )
  {
    v10 = (char *)a1 + 264 * v7;
    if ( *((_DWORD *)v4 + 70) == *((_DWORD *)v10 + 70) )
    {
