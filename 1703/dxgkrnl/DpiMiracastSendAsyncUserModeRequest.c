/*
 * XREFs of DpiMiracastSendAsyncUserModeRequest @ 0x1C01C7F78
 * Callers:
        ...
        IRP **a11)
{
  ...
  if ( v22 < 0x40 )
  {
    v23 = WdLogNewEntry5_WdError(v21, a2);
    *(_QWORD *)(v23 + 24) = v19;
...
LABEL_36:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400000) != 0 )
  {
    ...
    LODWORD(v36) = Size;
    LODWORD(v35) = 0;
    Template_pdqqq(v17, &EventLeaveMiracastSendUserModeRequest, v18, a1[12], v35, v36, v37, v38);
  }
