/*
 * XREFs of DpiSuspendAdapterDpc @ 0x1C003D3F0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  v5[4] = *((int *)DeferredContext + 986);
  v5[5] = *((int *)DeferredContext + 987);
  WdLogEvent5_WdTrace(v5);
  if ( *((_DWORD *)DeferredContext + 986) != 4 && *((_DWORD *)DeferredContext + 987) == 1 )
