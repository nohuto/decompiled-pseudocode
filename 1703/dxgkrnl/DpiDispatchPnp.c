/*
 * XREFs of DpiDispatchPnp @ 0x1C00A9AE0
 * Callers:
 *     <none>
 * Callees:
 *     DpiGdoDispatchGdiPnp @ 0x1C0003778 (DpiGdoDispatchGdiPnp.c)
...
__int64 __fastcall DpiDispatchPnp(__int64 a1, IRP *a2)
{
  ...
  v7 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v5 + 64), a2, File, 1u, 0x20u);
  v12 = v7;
  if ( v7 < 0 )
  {
