/*
 * XREFs of ?DdiPresentDisplayOnly@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_PRESENT_DISPLAYONLY@@@Z @ 0x1C0177398
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q((__int64)this, &EventProfilerEnter, a3, 5048);
...
LABEL_14:
  ...
  v17 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_PRESENT_DISPLAYONLY *))(*((_QWORD *)this + 2) + 704LL))(
  ...
  v25[3] = v17;
  v25[4] = a2->VidPnSourceId;
  v25[5] = a2->pSource;
  v25[6] = a2->NumMoves;
  NumDirtyRects = a2->NumDirtyRects;
  v25[7] = NumDirtyRects;
  if ( (_DWORD)v17 != -1073741801 && (_DWORD)v17 && (_DWORD)v17 != 259 )
  {
    v28 = WdLogNewEntry5_WdError(NumDirtyRects, v26);
    *(_QWORD *)(v28 + 24) = v17;
    WdLogEvent5_WdError(v28);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v29, &EventProfilerExit, v30, 5048);
