/*
 * XREFs of ?CapturePresentMultiPlaneOverlayArgs@@YAJPEBUD3DKMT_PRESENT_MULTIPLANE_OVERLAY@@PEAU1@PEAPEAUD3DKMT_MULTIPLANE_OVERLAY@@PEAPEAUtagRECT@@@Z @ 0x1C01B78D8
 * Callers:
        ...
        struct tagRECT **a4)
{
  ...
  _QWORD *v26; // rbx
  __int64 v27; // rcx
  _BYTE v28[280]; // [rsp+40h] [rbp-148h] BYREF
  unsigned int v29; // [rsp+158h] [rbp-30h]
