/*
 * XREFs of ?CalculateScaling@@YA_NW4DISPLAYCONFIG_SCALING@@PEBU_D3DKMDT_2DREGION@@1PEAU_RECTL@@@Z @ 0x1C00031EC
 * Callers:
...
LABEL_7:
      ...
      v16 = WdLogNewEntry5_WdAssertion(a1, v18, a3, 0LL);
      *(_QWORD *)(v16 + 24) = 209LL;
      goto LABEL_11;
    case 3:
LABEL_22:
  ...
  if ( (_DWORD)a1 != 5 )
  {
    v16 = WdLogNewEntry5_WdAssertion(a1, a2, a3, 0LL);
    *(_QWORD *)(v16 + 24) = v4;
LABEL_11:
