/*
 * XREFs of ?ProcessMiracastAPIChunk@@YAJPEAU_MIRACAST_DEVICE_CONTEXT@@PEAU_FDO_CONTEXT@@PEAKPEAUD3DKMT_MIRACAST_CHUNK_DATA@@2@Z @ 0x1C003E02C
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  else
  {
    ...
    else
    {
      ...
      {
        v15 = WdLogNewEntry5_WdError(v13, a2);
        *(_QWORD *)(v15 + 32) = v14;
        *(_QWORD *)(v15 + 24) = v6;
