/*
 * XREFs of ?EDID_V1_GetMonitorModes@@YAJW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@KPEBEPEAKPEAU_VideoModeDescriptor@@2@Z @ 0x1C000F52C
 * Callers:
...
int __fastcall EDID_V1_GetMonitorModes(
        __int64 a1,
        unsigned int a2,
        unsigned __int8 *a3,
        unsigned __int16 *a4,
        ...
        _DWORD *a6)
{
  ...
  MonDescParser **v11; // [rsp+28h] [rbp-31h] BYREF
  ...
  if ( result >= 0 )
  {
    v15 = *a4;
    v10 = 0;
    v11 = (MonDescParser **)v13;
    v12 = v8;
    result = MonDescParser::EDID_MODES::ObtainSupportedModes(&v11, &v15, &v10, a5);
    v9 = a6;
    *(_DWORD *)a4 = v15;
    if ( v9 )
      *v9 = v10;
