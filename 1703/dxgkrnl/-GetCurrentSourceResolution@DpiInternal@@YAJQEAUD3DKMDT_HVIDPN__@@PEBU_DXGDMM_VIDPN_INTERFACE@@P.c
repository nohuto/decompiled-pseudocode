/*
 * XREFs of ?GetCurrentSourceResolution@DpiInternal@@YAJQEAUD3DKMDT_HVIDPN__@@PEBU_DXGDMM_VIDPN_INTERFACE@@PEBU_D3DKMDT_VIDPN_PRESENT_PATH@@PEAU_D3DKMDT_2DREGION@@@Z @ 0x1C00AB694
 * Callers:
        ...
        const struct _D3DKMDT_VIDPN_PRESENT_PATH *a4)
{
  ...
  DXGDMM::AutoRelease<_D3DKMDT_VIDPN_PRESENT_PATH const *,long (*)(D3DKMDT_HVIDPNTOPOLOGY__ *,_D3DKMDT_VIDPN_PRESENT_PATH const *),D3DKMDT_HVIDPNTOPOLOGY__ *>::Own(
    ...
    *((_QWORD *)a2 + 2),
    (__int64)this);
  v30 = 0LL;
  v13 = (*(__int64 (__fastcall **)(__int64, __int64 *))(v24 + 24))(v31, &v30);
  v12 = v13;
  if ( v13 >= 0 )
  {
    v18 = *(_DWORD *)(v30 + 4);
...
LABEL_7:
      ...
      v23 = WdLogNewEntry5_WdAssertion(v15, v30, v16, v17);
      *(_QWORD *)(v23 + 24) = v30;
      WdLogEvent5_WdAssertion(v23);
    }
    else
    {
      v22 = WdLogNewEntry5_WdError(v15, v30);
