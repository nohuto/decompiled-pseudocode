/*
 * XREFs of DpiRequestIoPowerState @ 0x1C0102874
 * Callers:
 ...
 * Callees:
 *     ?DpiInsertEntryToPowerActionQueue@@YAXPEAU_FDO_CONTEXT@@PEAU_DPI_POWER_ACTION@@@Z @ 0x1C000F6E4 (-DpiInsertEntryToPowerActionQueue@@YAXPEAU_FDO_CONTEXT@@PEAU_DPI_POWER_ACTION@@@Z.c)
...
__int64 __fastcall DpiRequestIoPowerState(__int64 a1, LONG a2, __int64 a3, int a4)
{
  ...
  _InterlockedIncrement((volatile signed __int32 *)(v4 + 4080));
  DpiInsertEntryToPowerActionQueue((KSPIN_LOCK *)v4, (struct _DPI_POWER_ACTION *)v12);
  KeSetEvent((PRKEVENT)(v4 + 3736), 0, 0);
  if ( a2 == 7 )
  {
    v9 = KeWaitForSingleObject(*(PVOID *)(v4 + 3728), Executive, 0, 0, 0LL);
    ObfDereferenceObject(*(PVOID *)(v4 + 3728));
  }
  else
  {
    v9 = KeWaitForSingleObject(&v12[2], Executive, 0, 0, 0LL);
  }
  _InterlockedDecrement((volatile signed __int32 *)(v4 + 4080));
  if ( v9 )
  {
