/*
 * XREFs of ?DdiValidateUpdateAllocationProperty@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_VALIDATEUPDATEALLOCPROPERTY@@@Z @ 0x1C0179F1C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q((__int64)this, &EventProfilerEnter, a3, 5073);
...
LABEL_14:
  ...
  v17 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_VALIDATEUPDATEALLOCPROPERTY *))(*((_QWORD *)this + 2)
                                                                                           + 960LL))(
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v25, &EventProfilerExit, v26, 5073);
