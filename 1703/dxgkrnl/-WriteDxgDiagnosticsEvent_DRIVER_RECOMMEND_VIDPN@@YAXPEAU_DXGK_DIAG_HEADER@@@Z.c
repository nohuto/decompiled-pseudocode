/*
 * XREFs of ?WriteDxgDiagnosticsEvent_DRIVER_RECOMMEND_VIDPN@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C003709C
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_DRIVER_RECOMMEND_VIDPN(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  EVENT_DATA_DESCRIPTOR v109; // [rsp+338h] [rbp+230h] BYREF
  void *v110; // [rsp+358h] [rbp+250h]
  __int64 v111; // [rsp+360h] [rbp+258h]
  int *v112; // [rsp+368h] [rbp+260h]
  __int64 v113; // [rsp+370h] [rbp+268h]
  int *v114; // [rsp+378h] [rbp+270h]
  __int64 v115; // [rsp+380h] [rbp+278h]
  int *v116; // [rsp+388h] [rbp+280h]
  __int64 v117; // [rsp+390h] [rbp+288h]
  int *v118; // [rsp+398h] [rbp+290h]
  __int64 v119; // [rsp+3A0h] [rbp+298h]
  const GUID *v120; // [rsp+3A8h] [rbp+2A0h]
  __int64 v121; // [rsp+3B0h] [rbp+2A8h]
  int *v122; // [rsp+3B8h] [rbp+2B0h]
  __int64 v123; // [rsp+3C0h] [rbp+2B8h]
  unsigned __int16 *v124; // [rsp+3C8h] [rbp+2C0h]
  __int64 v125; // [rsp+3D0h] [rbp+2C8h]
  int *v126; // [rsp+3D8h] [rbp+2D0h]
  int v127; // [rsp+3E0h] [rbp+2D8h]
  int v128; // [rsp+3E4h] [rbp+2DCh]
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000100uLL) )
  {
    if ( *(_DWORD *)(v1 + 52) )
    {
      if ( hProvider > 4u )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000100uLL) )
        {
          ...
          v106 = v3;
          v108 = v4;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C004EC11, 0LL, v2, 0x2Bu, &pData);
        }
      }
    }
    else if ( hProvider > 4u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000100uLL) )
    {
      ...
      v126 = v7;
      v128 = v8;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C004EBA0, 0LL, v6, 0xBu, &v109);
    }
  }
}
