/*
 * XREFs of ?DisableStablePowerState@DXGADAPTER@@QEAAXXZ @ 0x1C016DC1C
 * Callers:
 ...
 *     ?DisableStablePState@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C00389C4 (-DisableStablePState@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
 */
...
void __fastcall DXGADAPTER::DisableStablePowerState(DXGADAPTER *this)
{
  ...
  if ( *((_BYTE *)this + 2759) )
  {
    ...
    v6 = (ADAPTER_RENDER *)*((_QWORD *)this + 286);
    if ( v6 )
