/*
 * XREFs of ?ProcessHasVidPnSourceOwner@ADAPTER_DISPLAY@@QEBAEPEBVDXGPROCESS@@W4_D3DKMT_VIDPNSOURCEOWNER_TYPE@@W4DXGDEVICECLIENT_TYPE@@@Z @ 0x1C0172590
 * Callers:
...
char __fastcall ADAPTER_DISPLAY::ProcessHasVidPnSourceOwner(__int64 a1, __int64 a2)
{
  ...
  {
    v12 = 3208LL * v10;
    v13 = *(_QWORD *)(v12 + v11 + 688);
    if ( v13 )
    {
      if ( a2 == *(_QWORD *)(v13 + 40) && !*(_DWORD *)(v13 + 328) && *(_DWORD *)(v12 + v11 + 696) == 3 )
        break;
    }
    if ( ++v10 >= v9 )
      return 0;
