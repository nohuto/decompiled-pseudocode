/*
 * XREFs of ?SetCopyProtectionScheme@DMMVIDPNPRESENTPATH@@QEAAJW4_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_TYPE@@@Z @ 0x1C000977C
 * Callers:
...
__int64 __fastcall DMMVIDPNPRESENTPATH::SetCopyProtectionScheme(DMMVIDPNPRESENTPATH *this, __int64 a2)
{
  ...
  else if ( DMMVIDPNPRESENTPATH::IsCopyProtectionSchemeSupported(this, (unsigned int)a2) )
  {
    *((_DWORD *)this + 43) = v2;
    return 0LL;
  }
