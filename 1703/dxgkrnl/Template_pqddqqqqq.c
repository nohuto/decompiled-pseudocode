/*
 * XREFs of Template_pqddqqqqq @ 0x1C003C4F0
 * Callers:
...
NTSTATUS Template_pqddqqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v18 = 4LL;
  v20 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, a2, 0LL, 9u, &UserData);
}
