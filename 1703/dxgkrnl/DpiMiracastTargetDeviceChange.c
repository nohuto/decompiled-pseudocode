/*
 * XREFs of DpiMiracastTargetDeviceChange @ 0x1C003F4D0
 * Callers:
 *     <none>
 * Callees:
        ...
        *((_QWORD *)Context + 11) = 0LL;
        ...
        if ( v16 )
        {
          ...
          *((_QWORD *)Context + 11) = KeGetCurrentThread();
          ...
          v25 = *(_QWORD **)Context;
          v26 = (PVOID *)*((_QWORD *)Context + 1);
          if ( *(char **)(*(_QWORD *)Context + 8LL) != Context || *v26 != Context )
            __fastfail(3u);
          *v26 = v25;
          v25[1] = v26;
          v27 = (char **)qword_1C006FD78;
          if ( *(__int64 **)qword_1C006FD78 != &qword_1C006FD70 )
            __fastfail(3u);
          *(_QWORD *)Context = &qword_1C006FD70;
          *((_QWORD *)Context + 1) = v27;
          *v27 = Context;
          qword_1C006FD78 = (__int64)Context;
