/*
 * XREFs of ??_EDMMVIDPNTARGET@@UEAAPEAXI@Z @ 0x1C0007CB0
 * Callers:
 *     ??_EDMMVIDPNTARGET@@WCA@EAAPEAXI@Z @ 0x1C0015A90 (--_EDMMVIDPNTARGET@@WCA@EAAPEAXI@Z.c)
 *     ??_EDMMVIDPNTARGET@@WDA@EAAPEAXI@Z @ 0x1C0015AA0 (--_EDMMVIDPNTARGET@@WDA@EAAPEAXI@Z.c)
 *     ??_EDMMVIDPNTARGET@@WFA@EAAPEAXI@Z @ 0x1C0015AB0 (--_EDMMVIDPNTARGET@@WFA@EAAPEAXI@Z.c)
 * Callees:
...
DMMVIDPNTARGET *__fastcall DMMVIDPNTARGET::`vector deleting destructor'(DMMVIDPNTARGET *this, __int64 a2)
{
  char v2; // di
  __int64 v4; // rax
  __int64 v5; // rcx
  ...
  *((_QWORD *)this + 13) = 0LL;
  *((_QWORD *)this + 10) = &DoublyLinkedListElement::`vftable';
