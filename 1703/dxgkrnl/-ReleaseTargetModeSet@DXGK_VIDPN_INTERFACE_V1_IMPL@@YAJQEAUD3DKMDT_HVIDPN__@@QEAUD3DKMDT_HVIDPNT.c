/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C009B440
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)(v6 + 32) = this;
  ...
  if ( *(DXGK_VIDPN_INTERFACE_V1_IMPL **)(v15 + 72) == v12 )
  {
    ...
    if ( *((_DWORD *)v13 + 24) == 1
      && DoublyLinkedList<DMMVIDPNTARGETMODESET>::ContainsByReference(*(_QWORD *)(v14 + 120), (__int64)v13) )
    {
      v37 = v13 + 2;
      v7 = *((_QWORD *)v13 + 1);
...
LABEL_20:
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q((__int64)v16, &EventProfilerExit, v9, 7049);
  return v11;
}
