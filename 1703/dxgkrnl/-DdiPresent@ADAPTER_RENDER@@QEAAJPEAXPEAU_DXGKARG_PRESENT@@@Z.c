/*
 * XREFs of ?DdiPresent@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_PRESENT@@@Z @ 0x1C016C16C
 * Callers:
...
LABEL_14:
  ...
  v19 = (*(int (__fastcall **)(void *, struct _DXGKARG_PRESENT *))(*((_QWORD *)this + 2) + 608LL))(a2, a3);
  if ( v35[0] )
  ...
  if ( (_DWORD)v19 != -1073741816
    ...
    && (_DWORD)v19 )
  {
    v30 = WdLogNewEntry5_WdError(DmaSize, v28);
    *(_QWORD *)(v30 + 24) = v19;
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v31, &EventProfilerExit, v32, 5031);
