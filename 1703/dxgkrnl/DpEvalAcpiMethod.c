/*
 * XREFs of DpEvalAcpiMethod @ 0x1C01C14A0
 * Callers:
        ...
        ULONG OutputBufferLength)
{
  ...
  ULONG InputBufferLength; // [rsp+E8h] [rbp+20h]
  ...
  *(_QWORD *)&DestinationString.Length = 0LL;
  ...
  if ( KeGetCurrentIrql() )
  {
    ...
    {
      v15 = (_QWORD *)WdLogNewEntry5_WdCriticalError(0LL, a2, a3);
      v15[3] = 275LL;
      v15[4] = 21LL;
      v15[5] = -1073741811LL;
  ...
  if ( !*(_BYTE *)(v14 + 1141) )
  {
    ...
    v16 = WdLogNewEntry5_WdWarning(0LL, a2, a3, a4);
  ...
  if ( v17 == 543451477 )
  {
    v21 = *(_QWORD *)(a1 + 64);
    *a3 = 1130980673;
    AcpiChildName = (const char *)DpiAcpiGetAcpiChildName(v21, a2);
    if ( !AcpiChildName )
      goto LABEL_43;
...
LABEL_3:
      LODWORD(v10) = v12;
LABEL_4:
      v13 = WdLogNewEntry5_WdError(v7, a2);
      *(_QWORD *)(v13 + 24) = v12;
...
LABEL_19:
  if ( (_DWORD)a2 != -1 )
  {
    v30 = (struct _KMUTANT *)(v14 + 3248);
    KeWaitForSingleObject((PVOID)(v14 + 3248), Executive, 0, 0, 0LL);
...
LABEL_43:
  ...
  if ( (_DWORD)v10 == 259 )
  {
    ...
    if ( v26 )
    {
      v27 = WdLogNewEntry5_WdError(v7, a2);
      *(_QWORD *)(v27 + 24) = v10;
LABEL_46:
  ...
  if ( (int)v10 < 0 )
  {
    v28 = WdLogNewEntry5_WdWarning(v7, a2, v24, v25);
