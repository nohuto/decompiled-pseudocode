/*
 * XREFs of ?DdiSetTargetGamma@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETGAMMA@@@Z @ 0x1C01792A0
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q((__int64)this, &EventProfilerEnter, a3, 5077);
...
LABEL_14:
  ...
  v17 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETGAMMA *))(*((_QWORD *)this + 2) + 1048LL))(
  ...
  *(_QWORD *)(v24 + 24) = v17;
  *(_QWORD *)(v24 + 32) = a2->TargetId;
  WdLogEvent5_WdEvent(v24);
  if ( (_DWORD)v17 != -1073741801 && (_DWORD)v17 != -1071774904 && (_DWORD)v17 )
  {
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v28, &EventProfilerExit, v29, 5077);
