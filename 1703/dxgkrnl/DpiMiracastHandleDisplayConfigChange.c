/*
 * XREFs of DpiMiracastHandleDisplayConfigChange @ 0x1C003E370
 * Callers:
    ...
    if ( v5 )
    {
      if ( *(_DWORD *)(v5 + 16) == 1953656900 && *(_DWORD *)(v5 + 20) == 2 )
      {
        ...
        if ( v9 )
        {
          if ( !*(_DWORD *)(v9 + 680) )
            *(_DWORD *)(v9 + 680) = a2;
          *(_DWORD *)(*(_QWORD *)(v5 + 3072) + 684LL) = a2;
          *(_DWORD *)(*(_QWORD *)(v5 + 3072) + 688LL) = a3;
          *(_DWORD *)(*(_QWORD *)(v5 + 3072) + 692LL) = a4;
          *(_DWORD *)(*(_QWORD *)(v5 + 3072) + 696LL) = a5;
        }
