/*
 * XREFs of Template_qqqddddddddddddqqqqq @ 0x1C00350F8
 * Callers:
...
NTSTATUS __fastcall Template_qqqddddddddddddqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a23)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v60 = 4LL;
  v62 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventCheckMultiPlaneOverlaySupportPlane, 0LL, 0x14u, &UserData);
}
