/*
 * XREFs of ?GetNumPaths@DXGK_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEA_K@Z @ 0x1C01DB550
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)(v6 + 32) = a2;
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v13 )
    {
      *(_QWORD *)a2 = *(_QWORD *)(v13 + 40);
    }
    else
    {
      v15 = WdLogNewEntry5_WdError(v11, v14);
      *(_QWORD *)(v15 + 24) = this;
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v11, &EventProfilerExit, v12, 7031);
  return v9;
}
