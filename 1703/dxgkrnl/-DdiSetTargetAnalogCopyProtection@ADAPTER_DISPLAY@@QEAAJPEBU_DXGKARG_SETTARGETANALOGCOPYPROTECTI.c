/*
 * XREFs of ?DdiSetTargetAnalogCopyProtection@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETANALOGCOPYPROTECTION@@@Z @ 0x1C0178E00
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q((__int64)this, &EventProfilerEnter, a3, 5079);
...
LABEL_14:
  ...
  v17 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETANALOGCOPYPROTECTION *))(*((_QWORD *)this + 2)
                                                                                             + 1064LL))(
  ...
  *(_QWORD *)(v24 + 32) = a2->TargetId;
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v28, &EventProfilerExit, v29, 5079);
