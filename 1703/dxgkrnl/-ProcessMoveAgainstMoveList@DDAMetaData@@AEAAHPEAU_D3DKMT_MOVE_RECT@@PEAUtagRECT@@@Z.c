/*
 * XREFs of ?ProcessMoveAgainstMoveList@DDAMetaData@@AEAAHPEAU_D3DKMT_MOVE_RECT@@PEAUtagRECT@@@Z @ 0x1C01B2A58
 * Callers:
        ...
        struct tagRECT *a3)
{
  ...
  __int64 v27; // rdx
  __int64 v28; // rcx
  struct _D3DKMT_PRESENT_RGNS v29; // [rsp+20h] [rbp-48h] BYREF
  ...
  if ( *((_DWORD *)this + 11) )
  {
    ...
    while ( 1 )
    {
      ...
      v29.DirtyRectCount = *(_DWORD *)v6;
      LODWORD(v29.pDirtyRects) = v9;
      v10 = v8 + *(_DWORD *)(v6 + 20) - *(_DWORD *)(v6 + 12);
      *(&v29.DirtyRectCount + 1) = v8;
      HIDWORD(v29.pDirtyRects) = v10;
      v11 = RectsOverlap(p_DestRect, v6 + 8, 0LL);
      v14 = RectsOverlap(v12, &v29, v13);
    ...
    v29.pDirtyRects = p_DestRect;
    v24 = *v23;
    v25 = 3LL * (unsigned int)--*((_DWORD *)this + 11);
    v26 = *(_OWORD *)(v24 + 24LL * *((unsigned int *)this + 11));
    *(_QWORD *)&v29.MoveRectCount = 0LL;
    v29.pMoveRects = 0LL;
    *(_OWORD *)v6 = v26;
    *(_QWORD *)(v6 + 16) = *(_QWORD *)(v24 + 8 * v25 + 16);
    v29.DirtyRectCount = 1;
    if ( !(unsigned int)DDAMetaData::ProcessNewDirtyRects(this, &v29) )
    {
      v19 = WdLogNewEntry5_WdError(v28, v27);
      *(_QWORD *)(v19 + 24) = 905LL;
      goto LABEL_11;
    }
    return 1LL;
