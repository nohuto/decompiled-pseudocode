/*
 * XREFs of DpiValidateSpbResource @ 0x1C01CD6A0
 * Callers:
 *     DpCloseSpbResource @ 0x1C01CCD60 (DpCloseSpbResource.c)
 *     DpReadSpbResource @ 0x1C01CD0D0 (DpReadSpbResource.c)
 *     DpSpbResourceIoControl @ 0x1C01CD230 (DpSpbResourceIoControl.c)
 *     DpWriteSpbResource @ 0x1C01CD3D0 (DpWriteSpbResource.c)
 * Callees:
 *     <none>
 */
