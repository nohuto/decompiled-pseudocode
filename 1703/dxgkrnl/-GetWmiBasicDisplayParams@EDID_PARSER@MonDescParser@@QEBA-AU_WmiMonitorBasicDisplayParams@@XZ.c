/*
 * XREFs of ?GetWmiBasicDisplayParams@EDID_PARSER@MonDescParser@@QEBA?AU_WmiMonitorBasicDisplayParams@@XZ @ 0x1C0046230
 * Callers:
        ...
        struct _WmiMonitorBasicDisplayParams *__return_ptr retstr)
{
  ...
  retstr->SupportedDisplayFeatures.StandbySupported = v2 >= 0x80u;
