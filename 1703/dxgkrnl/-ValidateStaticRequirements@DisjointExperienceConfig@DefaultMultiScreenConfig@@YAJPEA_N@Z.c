/*
 * XREFs of ?ValidateStaticRequirements@DisjointExperienceConfig@DefaultMultiScreenConfig@@YAJPEA_N@Z @ 0x1C003A270
 * Callers:
        ...
        bool *a2)
{
  ...
  *(_BYTE *)this = 0;
  ...
  if ( SoCName >= 0 )
  {
    v5 = (((unsigned __int64)(unsigned int)(v15 * v14) >> 20) + 256) >> 10;
    v12[0] = 0;
    ...
    {
      SoCName = DefaultMultiScreenConfig::DisjointExperienceConfig::RegQuerySoCName(String1, v6, v12, v7);
      if ( SoCName >= 0 )
      {
        v8 = (int)v12[0];
        v9 = &off_1C0048950;
