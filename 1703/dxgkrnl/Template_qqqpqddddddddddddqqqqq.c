/*
 * XREFs of Template_qqqpqddddddddddddqqqqq @ 0x1C003BE80
 * Callers:
...
NTSTATUS __fastcall Template_qqqpqddddddddddddqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a25)
{
  ...
  int v70; // [rsp+1E8h] [rbp+E8h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v67 = 4LL;
  v69 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &FlipMultiPlaneOverlay, 0LL, 0x16u, &UserData);
}
