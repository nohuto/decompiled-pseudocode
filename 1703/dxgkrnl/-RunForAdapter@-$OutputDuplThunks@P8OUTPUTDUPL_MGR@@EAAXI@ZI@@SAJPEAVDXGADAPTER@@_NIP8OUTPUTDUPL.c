/*
 * XREFs of ?RunForAdapter@?$OutputDuplThunks@P8OUTPUTDUPL_MGR@@EAAXI@ZI@@SAJPEAVDXGADAPTER@@_NIP8OUTPUTDUPL_MGR@@EAAXI@ZIP6AJPEAV3@2I@Z@Z @ 0x1C009D910
 * Callers:
 *     DxgkDesktopSwitch @ 0x1C009D8E0 (DxgkDesktopSwitch.c)
 * Callees:
        ...
        __int64 (__fastcall *a6)(struct OUTPUTDUPL_MGR *, void (__fastcall *)(OUTPUTDUPL_MGR *__hidden this, unsigned int), _QWORD))
{
  ...
  if ( a1 )
  {
    ...
    {
      v23 = WdLogNewEntry5_WdWarning(v11, v10, v12, v13);
      *(_QWORD *)(v23 + 24) = a1;
      *(_QWORD *)(v23 + 32) = v6;
