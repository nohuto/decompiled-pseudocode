/*
 * XREFs of ?AddVirtualGpu@DXGPROCESS@@QEAAXPEAU_LIST_ENTRY@@@Z @ 0x1C002616C
 * Callers:
...
void __fastcall DXGPROCESS::AddVirtualGpu(DXGPROCESS *this, struct _LIST_ENTRY *a2)
{
  ...
  *((_QWORD *)v3 + 1) = KeGetCurrentThread();
  if ( !a2->Flink )
  {
    v5 = (struct _LIST_ENTRY *)*((_QWORD *)this + 43);
    if ( v5->Flink != (struct _LIST_ENTRY *)((char *)this + 336) )
      __fastfail(3u);
    a2->Flink = (struct _LIST_ENTRY *)((char *)this + 336);
    a2->Blink = v5;
    v5->Flink = a2;
    *((_QWORD *)this + 43) = a2;
  }
