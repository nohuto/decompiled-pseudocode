/*
 * XREFs of ?TdrGatherPowerTriage@@YA?AU_DPI_DBG_POWER_ACTIVITY@@XZ @ 0x1C003632C
 * Callers:
...
__int64 TdrGatherPowerTriage()
{
  ...
  v1 = 0;
  v2 = 0;
  v3 = (_QWORD *)((char *)Global + 440);
  v4 = (_QWORD *)*((_QWORD *)Global + 55);
  while ( v4 != v3 && v4 )
  {
    v5 = v4;
    v4 = (_QWORD *)*v4;
    v6 = v5[24];
    if ( v6 && *(_DWORD *)(*(_QWORD *)(v6 + 64) + 4080LL) )
    {
      if ( (v1 & 1) != 0 || (v7 = 0, v5[287]) )
        v7 = 1;
      v8 = v7 | v1 & 0xFE;
      if ( (v8 & 2) != 0 || (v9 = 0, *((_DWORD *)v5 + 973)) )
        v9 = 2;
      v1 = v9 | v8 & 0xFD;
      LOBYTE(v11) = v1;
    }
