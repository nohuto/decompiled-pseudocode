/*
 * XREFs of ?InitializeSubmitData@CVidSchSubmitData@@QEAAXXZ @ 0x1C0004B20
 * Callers:
  ...
  if ( v4 )
  {
    ...
    *(_BYTE *)(v9 + 348) = IsDxgmms2;
    if ( IsDxgmms2 )
    {
      *(_DWORD *)(v9 + 436) = v10;
      *(_DWORD *)(v9 + 440) = v3;
      *(_DWORD *)(v9 + 444) = v10 * (48 * v3 + ((8 * v3 + 167) & 0xFFFFFFF8)) + 16;
      v11 = v10 * (48 * v3 + ((8 * v3 + 167) & 0xFFFFFFF8)) + 448;
      *(_DWORD *)(v9 + 416) = v11;
      *(_DWORD *)(v9 + 420) = 8 * v3 + v11;
    }
  }
}
