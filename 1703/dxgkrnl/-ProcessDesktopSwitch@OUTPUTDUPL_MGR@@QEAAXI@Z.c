/*
 * XREFs of ?ProcessDesktopSwitch@OUTPUTDUPL_MGR@@QEAAXI@Z @ 0x1C00DE0B0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall OUTPUTDUPL_MGR::ProcessDesktopSwitch(OUTPUTDUPL_CONTEXT **this, __int64 a2)
{
