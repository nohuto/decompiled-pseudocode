/*
 * XREFs of Template_xqqqqqqqq @ 0x1C004175C
 * Callers:
...
NTSTATUS Template_xqqqqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v18 = 4LL;
  v20 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventMiracastInterrupt, 0LL, 9u, &UserData);
}
