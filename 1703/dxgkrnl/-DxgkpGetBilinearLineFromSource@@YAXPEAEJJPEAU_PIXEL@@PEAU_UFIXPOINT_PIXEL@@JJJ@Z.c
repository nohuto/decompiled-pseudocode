/*
 * XREFs of ?DxgkpGetBilinearLineFromSource@@YAXPEAEJJPEAU_PIXEL@@PEAU_UFIXPOINT_PIXEL@@JJJ@Z @ 0x1C011D1F0
 * Callers:
    ...
    if ( a7 < a8 )
    {
      do
      {
        if ( v15 && v15 < a3 )
        {
          ...
          v21 = v20 * v13[3];
          v22 = (unsigned __int16)v17 * v13[-v12 + 3];
          if ( a4 )
          {
            *((_BYTE *)a4 + 3) = (unsigned int)(v22 + 0x8000 + v21) >> 16;
            *((_BYTE *)a4 + 2) = (v18 * v19[2] + 0x8000 + v20 * (unsigned int)v13[2]) >> 16;
            *((_BYTE *)a4 + 1) = (v18 * v19[1] + 0x8000 + v20 * (unsigned int)v13[1]) >> 16;
            v33 = *v19;
            v10 = a6;
          ...
          *((_DWORD *)v16 + 3) = v22 + v21;
          *((_DWORD *)v16 + 2) = v18 * v19[2] + v20 * v13[2];
          *((_DWORD *)v16 + 1) = v18 * v19[1] + v20 * v13[1];
          v23 = *v19;
          v10 = a6;
...
LABEL_13:
    ...
    if ( v15 )
    {
      ...
      v29 = v28 * v13[3];
      v30 = (unsigned __int16)v25 * v13[-v12 + 3];
      if ( a4 )
      {
        *((_BYTE *)a4 + 3) = (unsigned int)(v30 + 0x8000 + v29) >> 16;
        *((_BYTE *)a4 + 2) = (v26 * v27[2] + 0x8000 + v28 * (unsigned int)v13[2]) >> 16;
        *((_BYTE *)a4 + 1) = (v26 * v27[1] + 0x8000 + v28 * (unsigned int)v13[1]) >> 16;
        *(_BYTE *)a4 = (v26 * *v27 + v28 * (unsigned int)*v13 + 0x8000) >> 16;
      }
      else
      {
        *((_DWORD *)v16 + 3) = v30 + v29;
        *((_DWORD *)v16 + 2) = v26 * v27[2] + v28 * v13[2];
        *((_DWORD *)v16 + 1) = v26 * v27[1] + v28 * v13[1];
