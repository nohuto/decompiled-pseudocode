/*
 * XREFs of ?AddPathDescriptor@CCD_TOPOLOGY@@QEAAJAEBU_LUID@@IIEW4_D3DKMDT_VIDEO_OUTPUT_TECHNOLOGY@@1PEAPEAU_D3DKMT_PATHMODALITY_DESCRIPTOR@@E@Z @ 0x1C00EA3F8
 * Callers:
        ...
        unsigned __int8 a9)
{
  ...
  *(_DWORD *)(v16 + 28) = a4;
  ...
  v17 = v20[1];
  *(_OWORD *)(v16 + 192) = v20[0];
  v18 = *(_QWORD *)&v20[2];
  *(_OWORD *)(v16 + 208) = v17;
  *(_QWORD *)(v16 + 224) = v18;
  *(_DWORD *)(v16 + 192) = *((_DWORD *)this + 22);
  ...
  if ( a8 )
    *a8 = (struct _D3DKMT_PATHMODALITY_DESCRIPTOR *)v16;
  return 0LL;
}
