/*
 * XREFs of ?TdrCollectDbgInfoStage2@@YAXPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C0192440
 * Callers:
  ...
  if ( *((_QWORD *)a1 + 355) )
  {
    ...
    if ( v3 )
    {
      if ( v2 != 6 )
      {
        ...
        v13 = (char *)CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 357), 7, 0x804u);
        v14 = v13;
        if ( v13 )
        {
        ...
        v21 = (unsigned int *)*((_QWORD *)a1 + 357);
        CTDR_DUMP_BUFFER::ShrinkLastSegment((CTDR_DUMP_BUFFER *)v21);
        *((_QWORD *)a1 + 356) = v21[6];
        *((_DWORD *)a1 + 36) = 7;
        TdrUpdateDbgReport(a1, 1);
      }
      v22 = (CTDR_DUMP_BUFFER *)*((_QWORD *)a1 + 357);
      if ( v22 )
