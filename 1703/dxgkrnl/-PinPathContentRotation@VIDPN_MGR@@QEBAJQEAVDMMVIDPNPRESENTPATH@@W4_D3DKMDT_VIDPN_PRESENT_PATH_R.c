/*
 * XREFs of ?PinPathContentRotation@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C01D2F08
 * Callers:
...
LABEL_35:
  ...
  *(_QWORD *)&v61.IsVidPnSupported = 0LL;
  ...
  if ( (int)v14 >= 0 )
  {
    if ( !IsVidPnSupported )
      goto LABEL_35;
    v55 = VIDPN_MGR::_EnumVidPnCofuncModality((__int64)this, v24, 9LL, v60);
    v14 = v55;
    if ( v55 >= 0 )
    {
      LODWORD(v14) = 0;
