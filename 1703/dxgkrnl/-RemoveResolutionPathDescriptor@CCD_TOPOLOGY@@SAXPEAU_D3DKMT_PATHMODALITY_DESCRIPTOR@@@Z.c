/*
 * XREFs of ?RemoveResolutionPathDescriptor@CCD_TOPOLOGY@@SAXPEAU_D3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C00AE798
 * Callers:
...
void __fastcall CCD_TOPOLOGY::RemoveResolutionPathDescriptor(struct _D3DKMT_PATHMODALITY_DESCRIPTOR *a1)
{
  __int128 v2; // xmm1
  __int128 v3; // xmm0
  __int128 v4; // xmm0
