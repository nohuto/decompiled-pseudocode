/*
 * XREFs of ?_GetNextBestSecondaryTarget@BTL_TOPOLOGY_CONSTRUCTOR@@CAPEBVDMMVIDEOPRESENTTARGET@@AEBV2@AEBVDMMVIDEOPRESENTTARGETSET@@@Z @ 0x1C01E16E8
 * Callers:
        ...
        __int64 a4)
{
  ...
  const struct DMMVIDEOPRESENTTARGETSET *v13; // rbx
  ...
  while ( 1 )
  {
    NextTarget = DMMVIDEOPRESENTTARGETSET::GetNextTarget(this, v8, a3, a4);
    v11 = NextTarget;
    if ( !NextTarget )
      break;
    if ( !*((_BYTE *)NextTarget + 404)
      && !BTL_TOPOLOGY_CONSTRUCTOR::_IsBetterSecondaryTarget(v9, NextTarget, a1)
  ...
  v12 = 0LL;
  v13 = (const struct DMMVIDEOPRESENTTARGETSET *)*((_QWORD *)this + 3);
  if ( v13 != (const struct DMMVIDEOPRESENTTARGETSET *)((char *)this + 24) )
  {
    for ( i = (const struct DMMVIDEOPRESENTTARGETSET *)((char *)v13 - 8);
          i;
          i = DMMVIDEOPRESENTTARGETSET::GetNextTarget(this, i, a3, a4) )
    {
      if ( !*((_BYTE *)i + 404)
        && BTL_TOPOLOGY_CONSTRUCTOR::_IsBetterSecondaryTarget(v9, i, v12)
