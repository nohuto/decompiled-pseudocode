/*
 * XREFs of ??1DMMVIDPN@@UEAA@XZ @ 0x1C00DE5D8
 * Callers:
...
void __fastcall DMMVIDPN::~DMMVIDPN(DMMVIDPN *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *((_QWORD *)this + 9) = &DMMVIDPN::`vftable'{for `FallibleConstruction'};
  if ( v4 )
  {
    ...
    {
      v21 = WdLogNewEntry5_WdAssertion(CurrentThread, a2, a3, a4);
      WdLogEvent5_WdAssertion(v21);
    }
    v7 = Set<DMMVIDPN>::FindByValue(v4 + 96, (__int64)this);
    if ( DoublyLinkedList<DMMVIDPN>::ContainsByReference(v4 + 104, v7) )
    {
      v9 = (_QWORD *)(v12 + 8);
      v10 = *(_QWORD *)(v12 + 8);
      v8 = *(_QWORD **)(v12 + 16);
      if ( *(_QWORD *)(v10 + 8) != v12 + 8 || (_QWORD *)*v8 != v9 )
        __fastfail(3u);
      *v8 = v10;
      *(_QWORD *)(v10 + 8) = v8;
      *v9 = 0LL;
