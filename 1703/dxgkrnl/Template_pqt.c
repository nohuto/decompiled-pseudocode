/*
 * XREFs of Template_pqt @ 0x1C0024E8C
 * Callers:
...
NTSTATUS Template_pqt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &SetVidPnSourceVisibility, 0LL, 3u, &UserData);
}
