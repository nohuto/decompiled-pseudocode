/*
 * XREFs of Template_ppxppttqddddddddq @ 0x1C0038EF8
 * Callers:
...
NTSTATUS Template_ppxppttqddddddddq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v49; // [rsp+1C8h] [rbp+C8h] BYREF
  va_list va4; // [rsp+1C8h] [rbp+C8h]
  __int64 v51; // [rsp+1D0h] [rbp+D0h] BYREF
