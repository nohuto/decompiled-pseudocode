/*
 * XREFs of ?PinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C00F2800
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a5)
{
  ...
  __int64 v74; // r9
  __int64 v75; // rax
  enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION v76; // [rsp+24h] [rbp-2Ch]
...
LABEL_27:
  ...
  v43 = VIDPN_MGR::_EnumVidPnCofuncModality(v26, v28, 9LL, v77);
  v5 = v43;
  if ( v43 >= 0 )
    goto LABEL_27;
...
LABEL_55:
  if ( v76 == D3DKMDT_VPPR_UNPINNED )
    v72 = DMMVIDPNPRESENTPATH::UnpinContentRotation(v18);
  else
    v72 = DMMVIDPNPRESENTPATH::PinContentRotation(v18, v76);
  if ( v72 < 0 )
  {
...
LABEL_30:
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v39, &EventProfilerExit, v40, 6028);
