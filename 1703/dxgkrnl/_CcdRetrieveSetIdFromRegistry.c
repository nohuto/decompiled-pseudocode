/*
 * XREFs of _CcdRetrieveSetIdFromRegistry @ 0x1C00AFB48
 * Callers:
...
__int64 __fastcall CcdRetrieveSetIdFromRegistry(HANDLE KeyHandle, const WCHAR *a2, CCD_SET_STRING_ID *a3)
{
  ...
  v7 = CcdRetrieveValueFromRegistry(KeyHandle, &DestinationString, &P, v6);
  v10 = (unsigned int *)P;
  v11 = v7;
  if ( v7 < 0 )
    goto LABEL_11;
  ...
  v12 = *((_DWORD *)P + 2) & 0xFFFFFFFE;
  if ( (*((_DWORD *)P + 2) & 0xFFFFFFFE) != 0 )
  {
    do
    {
      if ( *(_WORD *)((char *)P + v12 + 10) )
        break;
  ...
  DestinationString.Buffer = (wchar_t *)((char *)P + 12);
