/*
 * XREFs of DpiMiracastCbSendUserModeMessage @ 0x1C01C6FF0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  if ( P && P[4] == 1953656900 && P[5] == 14 && *((_QWORD *)P + 54) )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400000) != 0 )
    {
      v26 = 0;
      Sizec = Size;
      Template_xqqppq((__int64)P, &EventEnterDxgkCbSendUserModeMessage, a3, *((_QWORD *)P + 12), Sizec, a4, a6, a7, v26);
    }
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400000) != 0 )
    {
      ...
      LODWORD(v25) = a4;
      LODWORD(Sizeb) = v9;
      Template_xqqppq(v15, &EventLeaveDxgkCbSendUserModeMessage, v16, *((_QWORD *)P + 12), Sizeb, v25, a6, a7, v27);
    }
