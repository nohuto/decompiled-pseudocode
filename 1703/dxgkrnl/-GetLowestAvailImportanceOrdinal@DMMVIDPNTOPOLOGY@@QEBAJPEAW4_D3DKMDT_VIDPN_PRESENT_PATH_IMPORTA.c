/*
 * XREFs of ?GetLowestAvailImportanceOrdinal@DMMVIDPNTOPOLOGY@@QEBAJPEAW4_D3DKMDT_VIDPN_PRESENT_PATH_IMPORTANCE@@@Z @ 0x1C00E12A8
 * Callers:
        ...
        __int64 a4)
{
  ...
  *a2 = D3DKMDT_VPPI_UNINITIALIZED;
  ...
  while ( ((unsigned int)v6 & (unsigned int)v8) != 0 );
  if ( v7 > 32 )
  {
