/*
 * XREFs of DxgkOpmTranslateHandle @ 0x1C0174D6C
 * Callers:
...
__int64 __fastcall DxgkOpmTranslateHandle(DXGADAPTER ***this, _QWORD *a2, void **a3, __int64 a4)
{
  __int64 v7; // rax
  __int64 v8; // rax
  __int64 v9; // rdx
  ...
  if ( v14 )
  {
    ...
    return ADAPTER_DISPLAY::OpmTranslateHandle(this[285], a2, a3);
  }
  else
  {
