/*
 * XREFs of Template_pqqqqqqqqppp @ 0x1C0025E5C
 * Callers:
 *     TraceDxgkContext @ 0x1C0025F90 (TraceDxgkContext.c)
...
NTSTATUS Template_pqqqqqqqqppp(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
