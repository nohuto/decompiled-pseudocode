/*
 * XREFs of DpiFdoHandleQueryDeviceRelations @ 0x1C0116260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiFdoHandleQueryDeviceRelations(__int64 a1, IRP *a2)
{
  ...
  __int64 *v22; // rcx
  __int64 v23; // rdx
  _QWORD v24[8]; // [rsp+20h] [rbp-88h] BYREF
  ...
  else
  {
    if ( Length )
      goto LABEL_25;
    _m_prefetchw((const void *)(v7 + 3452));
    v10 = _InterlockedOr((volatile signed __int32 *)(v7 + 3452), 1u);
    if ( (v10 & 2) == 0 )
    {
      ...
      if ( (v10 & 1) == 0 && *(_DWORD *)(v7 + 236) == 2 && *(_DWORD *)(v7 + 3784) != 1 && *(_DWORD *)(v7 + 284) == 1 )
    ...
    KeEnterCriticalRegion();
    ExAcquireResourceSharedLite((PERESOURCE)(v7 + 3144), 1u);
    ...
    if ( PoolWithTag )
    {
      ...
      *v16 = v6 + *(_DWORD *)(v7 + 3472);
      if ( v6 )
        memmove(v16 + 2, Information + 2, 8LL * v6);
      v17 = *(__int64 **)(v7 + 3456);
      for ( i = 0; i < *(_DWORD *)(v7 + 3472); v17 = (__int64 *)*v17 )
      {
        if ( *v17 == *(_QWORD *)(v7 + 3456) )
          break;
    ...
    _InterlockedAnd((volatile signed __int32 *)(v7 + 3452), 0xFFFFFFFE);
    ExReleaseResourceLite((PERESOURCE)(v7 + 3144));
    KeLeaveCriticalRegion();
  }
  if ( PowerRelations < 0 )
  {
