/*
 * XREFs of ?CallCheckMultiPlaneOverlaySupport2DDI@DXGDEVICE@@QEAAJIPEAPEAU_D3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE3@@PEAPEAXPEAHPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO@@@Z @ 0x1C0185738
 * Callers:
        ...
        struct D3DKMT_CHECK_MULTIPLANE_OVERLAY_SUPPORT_RETURN_INFO *a6)
{
  ...
  *a5 = 0;
  ...
  {
    PoolWithTag = (DXGK_MULTIPLANE_OVERLAY_PLANE_WITH_SOURCE *)v21;
    v20 = (void **)v21;
  }
  else
  {
...
LABEL_7:
    ...
    PoolWithTag = (DXGK_MULTIPLANE_OVERLAY_PLANE_WITH_SOURCE *)ExAllocatePoolWithTag(
                                                                 ...
                                                                 0x4B677844u);
    v20 = &PoolWithTag->hAllocation;
  }
  v22 = v9;
  if ( !PoolWithTag )
    goto LABEL_7;
  memset(PoolWithTag, 0, 112 * v9);
  PoolWithTag = (DXGK_MULTIPLANE_OVERLAY_PLANE_WITH_SOURCE *)v20;
  if ( !v20 )
    goto LABEL_7;
  if ( (_DWORD)v9 )
  {
    ...
    do
    {
      ...
      *((_DWORD *)v13 + 1) ^= (*((_DWORD *)v13 + 1) ^ a3[3]->LayerIndex) & 1;
      *((_DWORD *)v13 + 1) ^= (*((_DWORD *)v13 + 1) ^ a3[3]->LayerIndex) & 2;
      *((_DWORD *)v13 + 15) ^= (*((_DWORD *)v13 + 15) ^ LODWORD(a3[3][1].pPlaneAttributes)) & 1;
  ...
  *(_QWORD *)&v19.Supported = 0LL;
  v16 = *((_QWORD *)v8 + 225);
  v19.pPlanes = PoolWithTag;
  v17 = ADAPTER_DISPLAY::DdiCheckMultiPlaneOverlaySupport2(*(ADAPTER_DISPLAY **)(v16 + 2280), &v19, (__int64)a3);
  if ( v17 >= 0 )
  {
    *a5 = v19.Supported;
  ...
  v11 = v17;
LABEL_18:
  PagedPoolArray<_VIDMM_MULTI_ALLOC *,16>::~PagedPoolArray<_VIDMM_MULTI_ALLOC *,16>((PVOID *)&v20);
  return v11;
}
