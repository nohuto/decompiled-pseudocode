/*
 * XREFs of ?ProcessFirstFrameTimer@DXGADAPTER@@QEAAXXZ @ 0x1C0021F28
 * Callers:
 *     ?DxgkpFirstFrameTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C00252E0 (-DxgkpFirstFrameTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::ProcessFirstFrameTimer(KSPIN_LOCK *this)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 479, &LockHandle);
  v2 = 0;
  for ( *((_BYTE *)this + 3840) = 0; v2 < *((_DWORD *)this + 910); ++v2 )
  {
    v3 = 248LL * v2;
    v4 = this[454];
    if ( *(_BYTE *)(v4 + v3 + 240) )
