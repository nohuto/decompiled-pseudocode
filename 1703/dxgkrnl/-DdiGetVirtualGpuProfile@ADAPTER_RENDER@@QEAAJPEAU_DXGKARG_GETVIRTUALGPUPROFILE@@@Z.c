/*
 * XREFs of ?DdiGetVirtualGpuProfile@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETVIRTUALGPUPROFILE@@@Z @ 0x1C0027FD8
 * Callers:
...
LABEL_11:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETVIRTUALGPUPROFILE *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                              + 56LL))(
