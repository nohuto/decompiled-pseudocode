/*
 * XREFs of ?DdiSetPointerShape@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPOINTERSHAPE@@@Z @ 0x1C00E5A14
 * Callers:
...
LABEL_12:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPOINTERSHAPE *))(*((_QWORD *)this + 2) + 424LL))(
  ...
  {
    v27 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v19, v15, v17);
    v27[3] = 275LL;
    v27[4] = 16LL;
    v27[5] = this;
    v27[6] = CurrentIrql;
  ...
  {
    v29 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v19, v15, v17);
    v29[3] = 275LL;
    v29[4] = 25LL;
    v30 = *(int *)(v10 + 136);
    v29[7] = 0LL;
  ...
  v20[3] = v16;
  v21 = *(_QWORD *)(*((_QWORD *)this + 2) + 240LL);
  v20[4] = v21;
  v20[5] = a2->Flags.Value;
  v20[6] = a2->Width;
  Height = a2->Height;
  v20[7] = Height;
  if ( (_DWORD)v16 != -1073741801 && (_DWORD)v16 != -1073741637 && (_DWORD)v16 )
  {
    v31 = WdLogNewEntry5_WdError(Height, v21);
    *(_QWORD *)(v31 + 24) = v16;
    WdLogEvent5_WdError(v31);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v23, &EventProfilerExit, v24, 5018);
