/*
 * XREFs of Template_pqqxxx @ 0x1C00235D0
 * Callers:
...
NTSTATUS Template_pqqxxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 8LL;
  v14 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventCalibrateGpuClock, 0LL, 6u, &UserData);
}
