/*
 * XREFs of DxgkGetContextInProcessSchedulingPriority @ 0x1C018B6A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  if ( v20 >= 0 )
  {
    HIDWORD(v29) = _guard_dispatch_icall_fptr();
    if ( (unsigned __int64)v3 >= MmUserProbeAddress )
    ...
    *v3 = v29;
    ...
    DXGCONTEXTBYHANDLE::~DXGCONTEXTBYHANDLE((DXGCONTEXTBYHANDLE *)v27);
    if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q(v23, &EventProfilerExit, v24, 2085);
    return 0LL;
  }
  else
  {
    ...
    DXGCONTEXTBYHANDLE::~DXGCONTEXTBYHANDLE((DXGCONTEXTBYHANDLE *)v27);
    if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q(v21, &EventProfilerExit, v22, 2085);
