/*
 * XREFs of ?_IsModeInPixelRateRange@DXGMONITOR@@AEAAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@W4_DMM_MODE_PRUNING_ALGORITHM@@PEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C01E8B2C
 * Callers:
...
__int64 __fastcall DXGMONITOR::_IsModeInPixelRateRange(__int64 a1, __int64 a2, __int64 a3, char *a4, _DWORD *a5)
{
  unsigned int v6; // ebp
  __int64 v9; // rax
  __int64 v10; // rax
...
LABEL_14:
  ...
  v16 = SupportedPixelRate(a2, (__int64)v14, v6, (__int64)a4);
  *a4 = v16;
  if ( v16 )
    return 0LL;
  if ( *v14 == 2 )
