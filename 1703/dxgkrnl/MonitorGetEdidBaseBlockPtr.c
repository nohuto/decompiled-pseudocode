/*
 * XREFs of MonitorGetEdidBaseBlockPtr @ 0x1C00AB5C0
 * Callers:
...
const void *__fastcall MonitorGetEdidBaseBlockPtr(DXGADAPTER *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)(v6 + 32) = this;
  ...
  v11 = *(MONITOR_MGR **)(*((_QWORD *)this + 285) + 96LL);
  if ( !v11 )
  {
    v23 = WdLogNewEntry5_WdError(0LL, v7);
    *(_QWORD *)(v23 + 24) = this;
    WdLogEvent5_WdError(v23);
    return 0LL;
  }
  v30 = 0LL;
  if ( (int)MONITOR_MGR::_GetMonitorInstance(v11, v4, 0, &v30) < 0 )
    return 0LL;
  v16 = v30;
  if ( !v30 )
  {
