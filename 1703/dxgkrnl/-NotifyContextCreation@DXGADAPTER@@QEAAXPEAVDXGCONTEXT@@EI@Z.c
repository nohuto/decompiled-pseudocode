/*
 * XREFs of ?NotifyContextCreation@DXGADAPTER@@QEAAXPEAVDXGCONTEXT@@EI@Z @ 0x1C00069D0
 * Callers:
...
void __fastcall DXGADAPTER::NotifyContextCreation(DXGADAPTER *this, struct DXGCONTEXT *a2, char a3, int a4)
{
  ...
  if ( *((_DWORD *)a2 + 36) != 2 )
  {
    ...
    {
      v10 = *((_QWORD *)this + 290) + 520LL * i;
      if ( !*(_DWORD *)(v10 + 208)
        && (a4 == *(_DWORD *)(v10 + 212) && *((_DWORD *)a2 + 86) == *(unsigned __int16 *)(v10 + 6)
         || *(_BYTE *)(v10 + 358)) )
      {
        ...
        if ( a3 )
        {
          if ( ++*(_DWORD *)(v10 + 416) == 1 )
          {
            v11 = *(_DWORD *)(v10 + 4);
            *(_DWORD *)(v10 + 384) = 0;
            DXGADAPTER::SetPowerComponentLatencyCB(this, v11, **((_QWORD **)this + 326));
            if ( *(int *)(v10 + 388) > 0 )
            {
              v12 = MEMORY[0xFFFFF78000000320];
              *(_QWORD *)(v10 + 392) = MEMORY[0xFFFFF78000000320];
              *(_QWORD *)(v10 + 392) = v12 + *(_QWORD *)(*((_QWORD *)this + 326) + 8LL);
              v13 = (_QWORD *)(v10 + 400);
              if ( !*v13 )
              {
                v14 = (_QWORD *)((char *)this + 2768);
                v15 = *((_QWORD *)this + 346);
                if ( *(DXGADAPTER **)(v15 + 8) != (DXGADAPTER *)((char *)this + 2768) )
                  __fastfail(3u);
                *v13 = v15;
                v13[1] = v14;
                *(_QWORD *)(v15 + 8) = v13;
              ...
              if ( !*((_BYTE *)this + 2756) )
              {
                v16 = *((_QWORD *)this + 286);
                *((_BYTE *)this + 2756) = 1;
                v17 = *(_QWORD *)(*(_QWORD *)(v16 + 408) + 8LL);
                v18 = *(void (__fastcall **)(_QWORD, __int64))(v17 + 760);
                LOBYTE(v17) = 1;
                v18(*(_QWORD *)(v16 + 416), v17);
              }
            }
          }
        }
        else if ( (*(_DWORD *)(v10 + 416))-- == 1 )
        {
          v20 = *(_DWORD *)(v10 + 4);
          *(_DWORD *)(v10 + 384) = 2;
          DXGADAPTER::SetPowerComponentLatencyCB(this, v20, *(_QWORD *)(*((_QWORD *)this + 326) + 32LL));
          v21 = (_QWORD *)(v10 + 400);
          if ( *v21 )
          {
            v22 = *v21;
    ...
    if ( a3 )
      v9 = _InterlockedIncrement((volatile signed __int32 *)this + 619);
    else
      v9 = _InterlockedExchangeAdd((volatile signed __int32 *)this + 619, 0xFFFFFFFF);
    if ( v9 == 1 )
    {
      if ( *((_QWORD *)this + 291) )
