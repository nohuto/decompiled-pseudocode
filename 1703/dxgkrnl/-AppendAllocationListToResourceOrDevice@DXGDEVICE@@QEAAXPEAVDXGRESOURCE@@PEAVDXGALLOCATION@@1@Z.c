/*
 * XREFs of ?AppendAllocationListToResourceOrDevice@DXGDEVICE@@QEAAXPEAVDXGRESOURCE@@PEAVDXGALLOCATION@@1@Z @ 0x1C00C1A04
 * Callers:
        ...
        struct DXGALLOCATION *a4)
{
  ...
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v10, this + 20, (__int64)a3, (__int64)a4);
  if ( a2 )
  {
    v9 = *((_QWORD *)a2 + 3);
    if ( v9 )
