/*
 * XREFs of ?LogPermissionChange@DMMVIDPNTOPOLOGY@@UEAAXEW4ActionPermission_T@ProtectableFromChange@@_KE@Z @ 0x1C00E0890
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_7:
  ...
  if ( (_DWORD)a3 != 2 )
  {
    v11 = WdLogNewEntry5_WdError((unsigned int)(a3 - 1), a2);
    *(_QWORD *)(v11 + 24) = v6;
...
LABEL_14:
  ...
  *(_QWORD *)(v13 + 24) = a1 - 56;
  ...
  {
    v16 = WdLogNewEntry5_WdAssertion(a1 - 56, v12, v14, v15);
    WdLogEvent5_WdAssertion(v16);
  }
  result = *(_QWORD **)(a1 + 88);
  *(_QWORD *)(v13 + 32) = result[v8];
  return result;
}
