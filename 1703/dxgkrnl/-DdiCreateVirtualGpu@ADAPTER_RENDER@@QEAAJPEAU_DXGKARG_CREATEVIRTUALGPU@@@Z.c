/*
 * XREFs of ?DdiCreateVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEVIRTUALGPU@@@Z @ 0x1C0027268
 * Callers:
...
LABEL_11:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                          + 64LL))(
