/*
 * XREFs of DpiVerifyResources @ 0x1C01C6BC8
 * Callers:
 *     DpMapMemory @ 0x1C01C1CB0 (DpMapMemory.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00152E0 (_guard_dispatch_icall_nop.c)
 *     DpiDecodeResourceDescriptorLength @ 0x1C011BF64 (DpiDecodeResourceDescriptorLength.c)
 */

__int64 __fastcall DpiVerifyResources(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5, _DWORD *a6, _QWORD *a7)
{
  __int64 v7; // r13
  unsigned int v8; // esi
  __int64 v9; // rdi
...
LABEL_2:
  ...
  if ( *(_QWORD *)a2 == 786432LL || v15 == 655360 || v15 == 944 || v15 == 960 )
  {
    ...
    {
      v8 = -1073741811;
      v29 = WdLogNewEntry5_WdError(786432LL, a2);
  ...
  do
  {
    ...
    while ( 1 )
    {
      ...
      if ( (_BYTE)a4 == 1 )
        break;
      if ( !(_BYTE)a4 && ((*(_BYTE *)a1 - 3) & 0xFB) == 0 )
      {
        v9 = *(_QWORD *)(a1 + 4);
        v22 = DpiDecodeResourceDescriptorLength((unsigned __int8 *)a1, a2, a3, a4);
        a2 = v35;
        LOBYTE(a3) = 1;
        LOBYTE(a4) = v37;
        v10 = v9 + v22;
  ...
  if ( (__int64 *)*v23 != v23 )
  {
    ...
    *a6 = v27;
    if ( v23[4] == *v12
      && *((_DWORD *)v23 + 10) == v11
      && *((_BYTE *)v23 + 45) == a5
      && (!a5 || v23[6] == PsGetCurrentProcess(v27)) )
    {
      v28 = v23[8];
      ++*((_DWORD *)v23 + 6);
      *a7 = v28;
