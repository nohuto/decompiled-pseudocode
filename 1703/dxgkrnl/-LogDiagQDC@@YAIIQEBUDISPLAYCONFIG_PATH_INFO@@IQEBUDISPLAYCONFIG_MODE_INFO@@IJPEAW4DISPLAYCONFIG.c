/*
 * XREFs of ?LogDiagQDC@@YAIIQEBUDISPLAYCONFIG_PATH_INFO@@IQEBUDISPLAYCONFIG_MODE_INFO@@IJPEAW4DISPLAYCONFIG_TOPOLOGY_ID@@_K@Z @ 0x1C00A97C4
 * Callers:
        ...
        unsigned __int64 a8)
{
  ...
  if ( v13 )
  {
    ...
    *((_QWORD *)v15 + 3) = 0LL;
    ...
    if ( a7 )
      v15[17] = *(_DWORD *)a7;
    *((_QWORD *)v15 + 10) = a8;
    v15[12] = (a7 != 0LL ? 4 : 0) | (a4 == 0LL ? 2 : 0) | (a2 == 0LL);
    if ( a2 )
  ...
  else
  {
    ...
    *(_QWORD *)(v20 + 24) = v12;
    ...
    DxgkLogCodePointPacket(0xAu, a5, a6, 0, 0LL);
    return 0xFFFFFFFFLL;
  }
}
