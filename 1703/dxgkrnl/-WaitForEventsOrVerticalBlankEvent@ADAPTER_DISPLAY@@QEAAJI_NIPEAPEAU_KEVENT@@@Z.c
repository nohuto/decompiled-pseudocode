/*
 * XREFs of ?WaitForEventsOrVerticalBlankEvent@ADAPTER_DISPLAY@@QEAAJI_NIPEAPEAU_KEVENT@@@Z @ 0x1C016C830
 * Callers:
        ...
        PVOID *Object)
{
  ...
  {
    v14 = (__int64)this[14] + 872;
    Timeout.QuadPart = -800000LL;
    *Object = (PVOID)(v14 + 3208 * v8);
    if ( a3 )
      v15 = UserRequest;
    else
      v15 = Executive;
