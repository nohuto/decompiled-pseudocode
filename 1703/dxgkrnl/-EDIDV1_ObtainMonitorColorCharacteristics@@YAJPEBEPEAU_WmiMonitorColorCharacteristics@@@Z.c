/*
 * XREFs of ?EDIDV1_ObtainMonitorColorCharacteristics@@YAJPEBEPEAU_WmiMonitorColorCharacteristics@@@Z @ 0x1C0045EAC
 * Callers:
 ...
 *     ?GetWmiColorCharacteristics@EDID_PARSER@MonDescParser@@QEBAJAEAU_WmiMonitorColorCharacteristics@@@Z @ 0x1C00462C8 (-GetWmiColorCharacteristics@EDID_PARSER@MonDescParser@@QEBAJAEAU_WmiMonitorColorCharacteristics@.c)
 */
