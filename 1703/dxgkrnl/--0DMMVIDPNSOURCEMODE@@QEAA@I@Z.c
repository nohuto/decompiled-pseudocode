/*
 * XREFs of ??0DMMVIDPNSOURCEMODE@@QEAA@I@Z @ 0x1C0021200
 * Callers:
...
DMMVIDPNSOURCEMODE *__fastcall DMMVIDPNSOURCEMODE::DMMVIDPNSOURCEMODE(
        DMMVIDPNSOURCEMODE *this,
        __int64 a2,
        __int64 a3,
        __int64 a4)
{
  IndexedSetElement<unsigned int>::IndexedSetElement<unsigned int>((__int64)this, a2, a3, a4);
  *((_QWORD *)this + 5) = 0LL;
