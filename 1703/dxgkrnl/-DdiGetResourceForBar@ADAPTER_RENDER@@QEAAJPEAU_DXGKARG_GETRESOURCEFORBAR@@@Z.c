/*
 * XREFs of ?DdiGetResourceForBar@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETRESOURCEFORBAR@@@Z @ 0x1C0027A10
 * Callers:
...
LABEL_11:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETRESOURCEFORBAR *))(*(_QWORD *)(*((_QWORD *)this + 2) + 920LL)
                                                                           + 104LL))(
