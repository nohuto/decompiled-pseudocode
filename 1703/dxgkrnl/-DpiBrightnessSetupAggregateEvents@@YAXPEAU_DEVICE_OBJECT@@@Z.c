/*
 * XREFs of ?DpiBrightnessSetupAggregateEvents@@YAXPEAU_DEVICE_OBJECT@@@Z @ 0x1C01C99D0
 * Callers:
...
void __fastcall DpiBrightnessSetupAggregateEvents(struct _DEVICE_OBJECT *a1)
{
  ...
  memset(DeviceExtension + 513, 0, 0x48uLL);
  v3 = 3LL;
  DeviceExtension[515] = &WNF_SEB_SYSTEM_AC;
  DeviceExtension[518] = &WNF_SEB_FULL_SCREEN_VIDEO_PLAYBACK;
  DeviceExtension[521] = &WNF_SEB_FULL_SCREEN_HDR_VIDEO_PLAYBACK;
  v4 = DeviceExtension + 514;
  do
  {
