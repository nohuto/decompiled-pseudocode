/*
 * XREFs of ?NotifyPrimaryMonitorPowerChange@DXGADAPTER@@QEAAXE@Z @ 0x1C0021B2C
 * Callers:
 *     ?PowerSettingCallback@DXGADAPTER@@SAJPEBU_GUID@@PEAXK1@Z @ 0x1C016E540 (-PowerSettingCallback@DXGADAPTER@@SAJPEBU_GUID@@PEAXK1@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::NotifyPrimaryMonitorPowerChange(KSPIN_LOCK *this, char a2)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v12, this + 348, 1);
  ...
  *((_BYTE *)this + 2762) = a2;
  ...
  if ( !a2 )
    v7 = (char *)(this + 320);
  this[326] = (KSPIN_LOCK)v7;
  DXGADAPTER::UpdateLatencyTolerances((DXGADAPTER *)this);
  if ( this[291] )
  {
    v8 = (DXGADAPTER *)this[355];
    while ( v8 != (DXGADAPTER *)(this + 355) )
    {
      v9 = (char *)v8 - 424;
      v10 = *((int *)v8 - 10);
      v8 = *(DXGADAPTER **)v8;
      v11 = *(_QWORD *)(this[326] + 16 * v10);
      if ( v11 != *((_QWORD *)v9 + 46) )
