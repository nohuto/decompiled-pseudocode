/*
 * XREFs of ?GetDetTimParser@EDID_PARSER@MonDescParser@@QEAA_NHAEAVEDID_PARSER_DETAILED_TIMING@2@_N@Z @ 0x1C00047C4
 * Callers:
        ...
        struct MonDescParser::EDID_PARSER_DETAILED_TIMING *a3)
{
  ...
  if ( !(unsigned __int8)MonDescParser::EDID_PARSER::Is18ByteDetTim(this, a2) )
    return 0;
  result = 1;
  *v5 = *v4 + 18 * (v3 + 3);
  return result;
