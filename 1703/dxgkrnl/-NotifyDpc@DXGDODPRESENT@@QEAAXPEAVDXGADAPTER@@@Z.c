/*
 * XREFs of ?NotifyDpc@DXGDODPRESENT@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C003B484
 * Callers:
 ...
 *     ?UpdateVsyncCount@BLTQUEUE@@QEAAIPEAT_LARGE_INTEGER@@@Z @ 0x1C003B9E4 (-UpdateVsyncCount@BLTQUEUE@@QEAAIPEAT_LARGE_INTEGER@@@Z.c)
 */
...
void __fastcall DXGDODPRESENT::NotifyDpc(DXGDODPRESENT *this, ADAPTER_DISPLAY **a2)
{
        ...
        v2 = (unsigned int)(v2 + 1) )
  {
    ...
    {
      updated = BLTQUEUE::UpdateVsyncCount((BLTQUEUE *)(*((_QWORD *)this + 1) + 2704LL * (unsigned int)v2), 0LL);
      ADAPTER_DISPLAY::SignalVerticalBlankEvent(a2[285], (struct DXGADAPTER *)a2, v2, updated);
    }
    if ( (i & 3) != 0 )
    {
      v7.VidPnSourceId = v2;
