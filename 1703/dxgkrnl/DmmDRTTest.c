/*
 * XREFs of DmmDRTTest @ 0x1C01D4B8C
 * Callers:
...
LABEL_5:
  ...
  if ( v17 )
  {
    ...
    if ( v19 )
    {
      ...
      EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>((__int64)&v31, *(_QWORD *)(v17 + 88), v14, v15);
      ...
      {
        v28 = WdLogNewEntry5_WdDmmEvent(v24, v23, v25, v26);
        *(_QWORD *)(v28 + 24) = this;
      ...
      DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v31 + 40), v23, v25, v26);
