/*
 * XREFs of DpSpbResourceIoControl @ 0x1C01CD230
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _IO_STATUS_BLOCK *IoStatusBlock)
{
  ...
  NTSTATUS v20; // eax
  __int64 v21; // rax
  struct _EX_RUNDOWN_REF *v22; // [rsp+50h] [rbp-38h] BYREF
...
LABEL_4:
  ...
  result = DpiValidateSpbResource(a1, a2, (unsigned int)&DpSpbResourceIoControl, 0, (__int64)&v22);
  if ( (int)result >= 0 )
  {
    Ptr = a8;
    v16 = v22;
    ...
    LODWORD(v19) = ZwDeviceIoControlFile(
                     v22[5].Ptr,
                     Ptr,
                     0LL,
                     0LL,
    ...
    if ( (_DWORD)v19 == 259 )
    {
      if ( !v9 )
        goto LABEL_21;
      v20 = KeWaitForSingleObject(v16[8].Ptr, Executive, 0, 0, 0LL);
      v19 = v20;
      if ( v20 )
      {
...
LABEL_20:
      ...
      LODWORD(v19) = IoStatusBlock->Status;
    }
    if ( (int)v19 < 0 )
    {
      v21 = WdLogNewEntry5_WdError(v18, v17);
      *(_QWORD *)(v21 + 24) = (int)v19;
      goto LABEL_20;
    }
LABEL_21:
