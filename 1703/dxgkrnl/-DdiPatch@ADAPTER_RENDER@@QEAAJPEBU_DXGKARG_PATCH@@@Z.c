/*
 * XREFs of ?DdiPatch@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_PATCH@@@Z @ 0x1C0176EE8
 * Callers:
 *     ?ADAPTER_RENDER_DdiPatch@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_PATCH@@@Z @ 0x1C0034310 (-ADAPTER_RENDER_DdiPatch@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_PATCH@@@Z.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::DdiPatch(ADAPTER_RENDER *this, const struct _DXGKARG_PATCH *a2, __int64 a3)
{
  ...
  __int64 v44; // rcx
  __int64 v45; // r8
  _BYTE v47[8]; // [rsp+20h] [rbp-68h] BYREF
...
LABEL_14:
  ...
  if ( (_DWORD)v19 )
  {
    v43 = WdLogNewEntry5_WdError(Value, v41);
    *(_QWORD *)(v43 + 24) = v19;
    WdLogEvent5_WdError(v43);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v44, &EventProfilerExit, v45, 5008);
