/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_MGR@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0003288
 * Callers:
 ...
 *     _TlgCreateSz @ 0x1C00382B8 (_TlgCreateSz.c)
 */
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000020uLL) )
  {
    if ( *(_DWORD *)(v1 + 48) == 1 || *(_DWORD *)(v1 + 48) == 7 )
    {
      if ( hProvider > 4u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000020uLL) )
      {
        ...
        v53 = 2LL;
        v54 = (int *)v13;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C004F8CD, 0LL, v17, 0x11u, &pData);
      }
    }
    else if ( *(_DWORD *)(v1 + 48) == 14 )
    {
      if ( hProvider > 4u && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000020uLL) )
      {
        ...
        *(_QWORD *)&v45.Size = 4LL;
        ...
        v62 = v6;
        v64 = v7;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C004F743, 0LL, v5, 0x15u, &pData);
      }
    }
    else if ( hProvider > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000020uLL) )
      {
        ...
        *(_QWORD *)&v42.Size = 4LL;
        ...
        v45.Ptr = v3;
        v45.Reserved = v4;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C004F9A7, 0LL, v2, 0xCu, &pData);
      }
    }
  }
}
