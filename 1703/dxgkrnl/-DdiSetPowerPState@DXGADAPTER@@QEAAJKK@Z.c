/*
 * XREFs of ?DdiSetPowerPState@DXGADAPTER@@QEAAJKK@Z @ 0x1C0178A34
 * Callers:
...
__int64 __fastcall DXGADAPTER::DdiSetPowerPState(DXGADAPTER *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  __int64 v21; // rcx
  __int64 v22; // rax
  _BYTE v24[8]; // [rsp+20h] [rbp-78h] BYREF
...
LABEL_11:
  ...
  v15 = (*((int (__fastcall **)(_QWORD, _QWORD, _QWORD))this + 95))(*((_QWORD *)this + 30), v5, v4);
  if ( v24[0] )
  ...
  {
    v22 = WdLogNewEntry5_WdError(v17, v14);
    *(_QWORD *)(v22 + 24) = v15;
