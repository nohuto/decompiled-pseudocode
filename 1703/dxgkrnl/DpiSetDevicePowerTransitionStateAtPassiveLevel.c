/*
 * XREFs of DpiSetDevicePowerTransitionStateAtPassiveLevel @ 0x1C003D338
 * Callers:
...
void __fastcall DpiSetDevicePowerTransitionStateAtPassiveLevel(__int64 a1, int a2, char a3)
{
  ...
  if ( (_DWORD)v3 != 5 || *(_DWORD *)(a1 + 3944) == 4 )
  {
  ...
  if ( a3 && !*(_DWORD *)(a1 + 3948) )
  {
    ...
    DxgkReportDevicePoweredOn(*(_QWORD *)(a1 + 3704));
  }
