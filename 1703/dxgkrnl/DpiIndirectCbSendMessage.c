/*
 * XREFs of DpiIndirectCbSendMessage @ 0x1C01CB9E0
 * Callers:
 *     <none>
 * Callees:
 *     ?DpiIndirectOpenDevice@@YAJPEAU_DEVICE_OBJECT@@PEAPEAU_FILE_OBJECT@@PEAPEAU1@@Z @ 0x1C01CB398 (-DpiIndirectOpenDevice@@YAJPEAU_DEVICE_OBJECT@@PEAPEAU_FILE_OBJECT@@PEAPEAU1@@Z.c)
