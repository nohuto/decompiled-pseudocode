/*
 * XREFs of DmmSetTargetForcableState @ 0x1C01D6ADC
 * Callers:
...
__int64 __fastcall DmmSetTargetForcableState(DXGADAPTER *a1, __int64 a2, char a3)
{
  __int64 v3; // rsi
  __int64 v6; // rax
  __int64 v8; // rdx
...
LABEL_3:
  ...
  if ( v14 )
  {
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>((__int64)&v26, *(_QWORD *)(v13 + 88), v10, v11);
    ...
    DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v26 + 40), v18, v20, v21);
    return v24;
  }
  else
  {
