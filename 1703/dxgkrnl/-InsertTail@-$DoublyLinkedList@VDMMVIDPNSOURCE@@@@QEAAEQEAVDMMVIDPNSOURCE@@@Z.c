/*
 * XREFs of ?InsertTail@?$DoublyLinkedList@VDMMVIDPNSOURCE@@@@QEAAEQEAVDMMVIDPNSOURCE@@@Z @ 0x1C0002B8C
 * Callers:
...
char __fastcall DoublyLinkedList<DMMVIDPNSOURCE>::InsertTail(_QWORD *a1, _QWORD *a2)
{
  _QWORD *v2; // r8
  _QWORD *v3; // r8
  _QWORD *v4; // rax
