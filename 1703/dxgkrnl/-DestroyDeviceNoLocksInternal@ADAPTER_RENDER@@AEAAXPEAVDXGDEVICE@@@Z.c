/*
 * XREFs of ?DestroyDeviceNoLocksInternal@ADAPTER_RENDER@@AEAAXPEAVDXGDEVICE@@@Z @ 0x1C00CF8A8
 * Callers:
...
void __fastcall ADAPTER_RENDER::DestroyDeviceNoLocksInternal(ADAPTER_RENDER *this, struct DXGDEVICE *a2)
{
  ...
  PERESOURCE *v10; // [rsp+40h] [rbp-9h] BYREF
  ...
  if ( *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL) + 176LL) != 4 )
    ADAPTER_RENDER::DestroyDevice((DXGADAPTER **)this, a2, &v10);
