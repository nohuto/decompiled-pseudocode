/*
 * XREFs of DpiGdoDispatchCreate @ 0x1C00A9DD0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DpiGdoDispatchCreate(__int64 a1, IRP *a2)
{
  ...
  else if ( *(_BYTE *)(v3 + 1139) && *(_BYTE *)(v3 + 480) )
  {
    v6 = dword_1C006FCB0 != 4 ? 0xC0000001 : 0;
  }
  else
  {
    KeEnterCriticalRegion();
    v4 = (struct _ERESOURCE *)(v3 + 3600);
    ExAcquireResourceExclusiveLite((PERESOURCE)(v3 + 3600), 1u);
    v5 = *(_DWORD *)(v3 + 236);
