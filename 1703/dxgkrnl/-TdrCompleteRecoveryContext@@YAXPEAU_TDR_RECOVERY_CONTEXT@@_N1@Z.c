/*
 * XREFs of ?TdrCompleteRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@_N1@Z @ 0x1C0192660
 * Callers:
...
void __fastcall TdrCompleteRecoveryContext(struct _TDR_RECOVERY_CONTEXT *a1, char a2, bool a3)
{
  ...
  if ( a1 )
  {
    v4 = *((_QWORD *)a1 + 6);
    if ( v4 )
      (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 4) + 2288LL) + 408LL)
                                                          + 8LL)
                                              + 384LL))(
        v4,
        0LL);
    if ( *((_DWORD *)a1 + 4) != 6 )
    {
      v7 = 5LL * (((unsigned __int8)_InterlockedExchangeAdd(dword_1C0070114, 1u) + 1) & 0x3F);
