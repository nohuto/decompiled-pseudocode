/*
 * XREFs of ?StartLinkTrainingTimer@DMMVIDEOPRESENTTARGET@@QEAAXE@Z @ 0x1C01DCDF0
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( !v5 && *(_DWORD *)(*((_QWORD *)this + 64) + 168LL) != 2 )
  {
    v7 = WdLogNewEntry5_WdAssertion(v6, a2, a3, a4);
    WdLogEvent5_WdAssertion(v7);
  }
  v8 = _InterlockedExchange((volatile __int32 *)(*((_QWORD *)this + 64) + 168LL), v5 != 0 ? 1 : 3);
  v9 = WdLogNewEntry5_WdDmmEvent(v6, a2, a3, a4);
  *(_QWORD *)(v9 + 24) = v5;
  *(_QWORD *)(v9 + 32) = v8;
  WdLogEvent5_WdDmmEvent(v9);
  v10 = *((_QWORD *)this + 64);
  v11 = *(_QWORD *)(*(_QWORD *)v10 + 2280LL);
  v12 = *(_DWORD *)(v11 + 324);
  if ( !v5 )
