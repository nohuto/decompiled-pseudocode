/*
 * XREFs of ?CommitTo@CDS_JOURNAL@@QEBAJPEAVCCD_TOPOLOGY@@_NPEAG@Z @ 0x1C00ADD74
 * Callers:
...
__int64 __fastcall CDS_JOURNAL::CommitTo(CDS_JOURNAL *this, struct CCD_TOPOLOGY *a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  __int64 v12; // r8
  __int64 v13; // r9
  const struct CDS_JOURNAL::_ENTRY *v14; // r15
  ...
  __int64 v26; // rax
  __int16 v27; // si
  const struct CDS_JOURNAL::_ENTRY *v28; // r9
  __int16 v29; // r10
  bool IsUnextend; // al
  int v31; // r10d
  const struct CDS_JOURNAL::_ENTRY **v32; // r9
  ...
  v14 = *v4;
  v15 = 0;
  while ( v14 != (const struct CDS_JOURNAL::_ENTRY *)v4 )
  {
    if ( CDS_JOURNAL::_IsUnextend(v14) )
    {
      v24 = CDS_JOURNAL::_CommitEntry(v22, a2);
      v9 = v24;
      if ( v24 < 0 )
      {
LABEL_18:
        v25 = (_QWORD *)WdLogNewEntry5_WdError(v20, v19);
        v25[3] = v9;
        v25[4] = v25;
        v25[5] = a2;
        v25[6] = *((_QWORD *)a2 + 8);
    ...
    v14 = *(const struct CDS_JOURNAL::_ENTRY **)v14;
  }
  for ( i = *v4; i != (const struct CDS_JOURNAL::_ENTRY *)v4; i = *(const struct CDS_JOURNAL::_ENTRY **)i )
  {
    if ( !CDS_JOURNAL::_IsUnextend(i) )
    {
      ...
      if ( v18 == -1073741789 )
      {
        ...
        v28 = *v4;
        v29 = 0;
        while ( v28 != (const struct CDS_JOURNAL::_ENTRY *)v4 )
        {
          IsUnextend = CDS_JOURNAL::_IsUnextend(v28);
          v28 = *v32;
        ...
        if ( a4 )
          *a4 = v33;
        v34 = (_QWORD *)WdLogNewEntry5_WdWarning(v20, v19, v21, v28);
        v34[3] = a2;
        v34[4] = *((_QWORD *)a2 + 8);
        v35 = *((_QWORD *)a2 + 8);
        if ( v35 )
