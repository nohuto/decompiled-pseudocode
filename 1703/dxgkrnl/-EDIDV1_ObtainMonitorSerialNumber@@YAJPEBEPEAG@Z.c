/*
 * XREFs of ?EDIDV1_ObtainMonitorSerialNumber@@YAJPEBEPEAG@Z @ 0x1C000F2BC
 * Callers:
...
__int64 __fastcall EDIDV1_ObtainMonitorSerialNumber(unsigned __int8 *a1, unsigned __int16 *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    for ( i = 0; i < 4; i = v4 + 1 )
    {
      if ( (unsigned __int8)MonDescParser::EDID_PARSER::Is18ByteDispDesc((MonDescParser::EDID_PARSER *)v14, i)
