/*
 * XREFs of DpiFdoHandleFilterResources @ 0x1C01169A0
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x1C00153C0 (memmove.c)
 *     memset @ 0x1C0015700 (memset.c)
 *     DpiDisableInterruptResources @ 0x1C01C64A8 (DpiDisableInterruptResources.c)
 */
...
__int64 __fastcall DpiFdoHandleFilterResources(__int64 a1, IRP *a2)
{
  ...
  if ( (int)Status >= 0 )
  {
    ...
    if ( *(_BYTE *)(v2 + 1140) != 1 )
    {
      v20 = WdLogNewEntry5_WdEvent(v7);
      *(_QWORD *)(v20 + 24) = a1;
      WdLogEvent5_WdEvent(v20);
      goto LABEL_3;
    }
    v11 = *Information + 96 * Information[7];
    if ( v11 < *Information )
      goto LABEL_15;
