/*
 * XREFs of TraceLoggingWriteMiracastStartSessionEntry @ 0x1C0043650
 * Callers:
...
void TraceLoggingWriteMiracastStartSessionEntry()
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C006E810, 0x400000000000uLL) )
    {
      v4 = 0;
      v2 = v0;
      v3 = 16;
      TlgWrite((TraceLoggingHProvider)&dword_1C006E810, &unk_1C0051BB4, v0, v0, 3u, &pData);
    }
  }
}
