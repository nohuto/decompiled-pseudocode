/*
 * XREFs of ?QueryMonitorId@CCD_SET_STRING_ID@@QEBAJIPEAU_STRING@@@Z @ 0x1C00B0F50
 * Callers:
 ...
 * Callees:
 *     ?_GetDescriptorLength@CCD_SET_STRING_ID@@AEBAGI@Z @ 0x1C00B0FBC (-_GetDescriptorLength@CCD_SET_STRING_ID@@AEBAGI@Z.c)
 */
