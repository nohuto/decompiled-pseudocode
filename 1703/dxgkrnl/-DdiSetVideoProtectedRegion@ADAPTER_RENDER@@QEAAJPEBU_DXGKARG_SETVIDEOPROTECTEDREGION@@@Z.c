/*
 * XREFs of ?DdiSetVideoProtectedRegion@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETVIDEOPROTECTEDREGION@@@Z @ 0x1C0179838
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetVideoProtectedRegion@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETVIDEOPROTECTEDREGION@@@Z @ 0x1C0034370 (-ADAPTER_RENDER_DdiSetVideoProtectedRegion@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETVIDEOPROTECTE.c)
 * Callees:
...
LABEL_14:
  ...
  v17 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETVIDEOPROTECTEDREGION *))(*((_QWORD *)this + 2) + 888LL))(
  ...
  {
    v24 = WdLogNewEntry5_WdError(v19, v16);
    *(_QWORD *)(v24 + 24) = v17;
