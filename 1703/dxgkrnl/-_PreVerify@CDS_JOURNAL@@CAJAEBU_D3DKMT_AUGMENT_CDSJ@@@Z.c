/*
 * XREFs of ?_PreVerify@CDS_JOURNAL@@CAJAEBU_D3DKMT_AUGMENT_CDSJ@@@Z @ 0x1C00A4E5C
 * Callers:
...
__int64 __fastcall CDS_JOURNAL::_PreVerify(const struct _D3DKMT_AUGMENT_CDSJ *a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v5; // rbx
  __int64 v6; // rdx
  unsigned int v7; // ecx
