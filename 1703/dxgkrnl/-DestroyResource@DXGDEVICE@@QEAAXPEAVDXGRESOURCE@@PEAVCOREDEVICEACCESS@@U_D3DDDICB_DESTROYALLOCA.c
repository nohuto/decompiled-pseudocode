/*
 * XREFs of ?DestroyResource@DXGDEVICE@@QEAAXPEAVDXGRESOURCE@@PEAVCOREDEVICEACCESS@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@@Z @ 0x1C00C74C0
 * Callers:
        ...
        struct _D3DDDICB_DESTROYALLOCATION2FLAGS a4)
{
  ...
  DXGRESOURCE::~DXGRESOURCE((DXGRESOURCE *)a2, v12, v13, v14);
