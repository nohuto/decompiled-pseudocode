/*
 * XREFs of TraceLoggingWriteMiracastSessionStop @ 0x1C004315C
 * Callers:
...
void __fastcall TraceLoggingWriteMiracastSessionStop(__int64 a1, int a2, int a3)
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C006E810, 0x800000000002uLL) )
    {
      v22 = *(_DWORD *)(v5 + 788);
      v50 = v5 + 112;
      v52 = &v22;
      ...
      v109 = 4LL;
      v110 = &v45;
      v46 = dword_1C006FD98 - *(_DWORD *)(v15 + 672);
      v112 = &v46;
      v47 = *(_DWORD *)(v15 + 676);
      v114 = &v47;
      v116 = &v48;
      ...
      v48 = a3;
      v117 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C006E810, &unk_1C005160F, v21, v20, 0x28u, &pData);
    }
  }
}
