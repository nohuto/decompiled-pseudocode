/*
 * XREFs of ?CreateProtectedOutputIndirectDisplay@@YAJPEAU_FDO_CONTEXT@@0W4_DXGKMDT_OPM_VIDEO_OUTPUT_SEMANTICS@@IPEAPEAX2@Z @ 0x1C00436DC
 * Callers:
...
LABEL_5:
  ...
  RedirectionInfo = v17;
  if ( v17 < 0
    || (RedirectionInfo = (int)DxgkOpmGetRedirectionInfo(*((_QWORD *)a2 + 463), (unsigned int)v10, &v27, v28),
...
LABEL_4:
  ...
  if ( v22 < 0 )
    goto LABEL_4;
  DxgkAcquireAdapterOpmI2CSync(*((_QWORD *)a1 + 463));
  DxgkAcquireAdapterDdiSync(*((_QWORD *)a1 + 463), 1LL);
  v23 = *((_DWORD *)a1 + 716);
  if ( v23 == 2 )
  {
    v24 = (*((__int64 (__fastcall **)(_QWORD, _QWORD, __int64, _BYTE *, _DWORD, void **))a1 + 373))(
            *((_QWORD *)a1 + 6),
            a3,
            v27,
            v28,
  ...
  else
  {
    ...
    v24 = (*((__int64 (__fastcall **)(_QWORD, _QWORD, __int64, _BYTE *, __int64, int, void **))a1 + 372))(
            *((_QWORD *)a1 + 6),
            a3,
            v27,
            v28,
...
LABEL_16:
  ...
  {
    LODWORD(RedirectionInfo) = DxgkOpmCreateHandle(*((DXGADAPTER **)a1 + 463), v26, a5);
    if ( (int)RedirectionInfo < 0 )
      (*((void (__fastcall **)(_QWORD, void *))a1 + 371))(*((_QWORD *)a1 + 6), v26);
    else
      *a6 = v26;
  }
  DxgkReleaseAdapterDdiSync(*((_QWORD *)a1 + 463));
  DxgkReleaseAdapterOpmI2CSync(*((_QWORD *)a1 + 463));
