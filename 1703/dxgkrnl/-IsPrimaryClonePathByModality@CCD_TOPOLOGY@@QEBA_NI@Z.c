/*
 * XREFs of ?IsPrimaryClonePathByModality@CCD_TOPOLOGY@@QEBA_NI@Z @ 0x1C000BA78
 * Callers:
...
bool __fastcall CCD_TOPOLOGY::IsPrimaryClonePathByModality(CCD_TOPOLOGY *this, unsigned int a2)
{
  __int64 v2; // r8
  unsigned int v3; // r9d
  int v4; // r10d
  ...
  v4 = *(_DWORD *)(264LL * a2 + v2 + 280);
  v5 = 0;
  if ( *(_WORD *)(v2 + 20) )
  {
    for ( i = (_DWORD *)(v2 + 280); *i != v4; i += 66 )
    {
      if ( ++v5 >= v3 )
        return 0;
    }
