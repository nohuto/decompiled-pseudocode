/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C01787D4
 * Callers:
...
LABEL_14:
  ...
  v25[3] = v17;
  v26 = *(_QWORD *)(*((_QWORD *)this + 2) + 240LL);
  v25[4] = v26;
  v25[5] = a2->FirstEntry;
  v25[6] = a2->NumEntries;
  ...
  if ( (_DWORD)v17 )
  {
    v28 = WdLogNewEntry5_WdError(VidPnSourceId, v26);
    *(_QWORD *)(v28 + 24) = v17;
    WdLogEvent5_WdError(v28);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v29, &EventProfilerExit, v30, 5017);
