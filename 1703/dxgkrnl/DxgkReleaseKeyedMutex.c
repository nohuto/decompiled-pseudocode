/*
 * XREFs of DxgkReleaseKeyedMutex @ 0x1C01A7B50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkReleaseKeyedMutex(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  unsigned int v29[4]; // [rsp+30h] [rbp-28h]
  unsigned __int64 v30; // [rsp+40h] [rbp-18h]
  DXGKEYEDMUTEX *v31; // [rsp+68h] [rbp+10h] BYREF
  struct DXGKEYEDMUTEX *v32; // [rsp+70h] [rbp+18h] BYREF
...
LABEL_6:
    if ( !v10 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      Template_q((__int64)v9, &EventProfilerExit, v8, 2055);
    return 3221225485LL;
  }
  ...
  *(_OWORD *)v29 = *(_OWORD *)v3;
  ...
  DXGKEYEDMUTEXBYHANDLE::DXGKEYEDMUTEXBYHANDLE((DXGKEYEDMUTEXBYHANDLE *)&v31, v29[0], Current, &v32);
  v17 = v32;
  if ( !v32 )
  {
    ...
    *(_QWORD *)(v18 + 32) = -1073741811LL;
    ...
    v9 = v31;
    if ( v31 )
      DXGKEYEDMUTEX::ReleaseReference(v31, v19, v8, v20);
    v10 = (qword_1C006E790 & 2) == 0;
    goto LABEL_6;
  }
  v21 = DXGKEYEDMUTEX::ReleaseSync(v32, v12, *(__int64 *)&v29[2], v30, 0LL, 0);
  v26 = v21;
  if ( v21 < 0 )
  {
  ...
  v28 = v31;
  if ( v31 )
    DXGKEYEDMUTEX::ReleaseReference(v31, v22, v24, v25);
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q((__int64)v28, &EventProfilerExit, v24, 2055);
