/*
 * XREFs of ?DxgkCddUpdatePresentRects@@YAJPEAVADAPTER_DISPLAY@@IPEAPEBUtagRECT@@PEAI@Z @ 0x1C00A1234
 * Callers:
  ...
  if ( CddInterface )
  {
    ...
    if ( v13 )
    {
      if ( v13 != -1 )
      {
        ...
        if ( (((unsigned int)ADAPTER_DISPLAY::GetCurrentOrientation(this, (unsigned int)v6, 1LL) - 2) & 0xFFFFFFFD) == 0 )
        {
          right = v15.right;
          v15.right = v15.bottom;
          v15.bottom = right;
        }
        CurrentOrientation = (unsigned int)ADAPTER_DISPLAY::GetCurrentOrientation(this, (unsigned int)v6, 0LL);
        DxgkpConvertRects(
          *((_DWORD *)v10 + 802 * v6 + 161),
          *((_DWORD *)v10 + 802 * v6 + 162),
          CurrentOrientation,
          &v15,
          v13,
          v14,
