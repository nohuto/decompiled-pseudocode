/*
 * XREFs of ?EnableFormattingBuffer@DXGGLOBAL@@QEAAXH@Z @ 0x1C01955B8
 * Callers:
...
void __fastcall DXGGLOBAL::EnableFormattingBuffer(DXGGLOBAL *this, unsigned int a2, __int64 a3, __int64 a4)
{
  _QWORD **v5; // rsi
  __int64 v6; // rdx
  __int64 v7; // r8
  ...
  while ( v9 != v5 && v9 )
  {
    ...
    if ( v10[286] )
    {
      ...
      if ( (_BYTE)v11 )
      {
        ...
        if ( *((_DWORD *)v10 + 44) == 1 )
          ADAPTER_RENDER::EnableFormattingBuffer((ADAPTER_RENDER *)v10[286], a2, v7, v8);
        if ( v16 )
