/*
 * XREFs of ?ReleaseReference@DXGPAGINGQUEUE@@QEAAXXZ @ 0x1C00134E0
 * Callers:
...
void __fastcall DXGPAGINGQUEUE::ReleaseReference(DXGPAGINGQUEUE *this, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v5; // rbx
  __int64 v6; // rax
  __int64 v7; // rbx
  ...
  v5 = _InterlockedDecrement64((volatile signed __int64 *)this + 6);
  if ( v5 < 0 )
  {
  ...
  if ( !v5 )
  {
    ...
    if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 16LL) + 176LL) != 4 )
      DXGDEVICE::DestroyPagingQueue((DXGDEVICE *)v7, this, (struct COREDEVICEACCESS *)v14);
