/*
 * XREFs of ?DdiQueryDependentEngineGroup@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYDEPENDENTENGINEGROUP@@@Z @ 0x1C00241B0
 * Callers:
 *     ?ADAPTER_RENDER_DdiQueryDependentEngineGroup@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYDEPENDENTENGINEGROUP@@@Z @ 0x1C0034330 (-ADAPTER_RENDER_DdiQueryDependentEngineGroup@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYDEPENDENT.c)
 * Callees:
...
LABEL_14:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYDEPENDENTENGINEGROUP *))(*((_QWORD *)this + 2) + 680LL))(
  ...
  v21[3] = v16;
  v21[4] = a2->NodeOrdinal;
  v21[5] = a2->EngineOrdinal;
  DependentNodeOrdinalMask = a2->DependentNodeOrdinalMask;
  v21[6] = DependentNodeOrdinalMask;
  if ( (_DWORD)v16 )
  {
    v24 = WdLogNewEntry5_WdError(DependentNodeOrdinalMask, v22);
    *(_QWORD *)(v24 + 24) = v16;
    WdLogEvent5_WdError(v24);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v25, &EventProfilerExit, v26, 5049);
