/*
 * XREFs of ?VmBusSetContextSchedulingPriority@@YAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0032D00
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall VmBusSetContextSchedulingPriority(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  int v2; // eax
  struct VMBPACKETCOMPLETION__ *v3; // rcx
  int v5; // [rsp+30h] [rbp+8h] BYREF

  v2 = DxgkSetContextSchedulingPriority(*((_QWORD *)a1 + 9) + 16LL);
