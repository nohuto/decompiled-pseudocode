/*
 * XREFs of DpiMiracastChunkInfoCallbackDpc @ 0x1C003E1B0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel(&qword_1C006FD58, &LockHandle);
  ...
  if ( v5 )
  {
    ...
    DpSynchronizeExecution(v5, (KSYNCHRONIZE_ROUTINE *)DpiMiracastMoveChunkList, v7, *(_DWORD *)(v6 + 3716), &v9);
  }
