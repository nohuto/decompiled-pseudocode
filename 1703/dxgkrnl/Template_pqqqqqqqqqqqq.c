/*
 * XREFs of Template_pqqqqqqqqqqqq @ 0x1C00230D8
 * Callers:
...
NTSTATUS Template_pqqqqqqqqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v26 = 4LL;
  v28 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventSetDisplayMode, 0LL, 0xDu, &UserData);
}
