/*
 * XREFs of ?DdiQueryEngineStatus@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_QUERYENGINESTATUS@@@Z @ 0x1C0024400
 * Callers:
 *     ?ADAPTER_RENDER_DdiQueryEngineStatus@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYENGINESTATUS@@@Z @ 0x1C0034340 (-ADAPTER_RENDER_DdiQueryEngineStatus@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_QUERYENGINESTATUS@@@Z.c)
 * Callees:
...
LABEL_14:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYENGINESTATUS *))(*((_QWORD *)this + 2) + 688LL))(
  ...
  if ( (_DWORD)v16 )
  {
    v24 = WdLogNewEntry5_WdError(Value, v22);
    *(_QWORD *)(v24 + 24) = v16;
    WdLogEvent5_WdError(v24);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v25, &EventProfilerExit, v26, 5050);
