/*
 * XREFs of DmmIsVidPnTargetConnectedToSource @ 0x1C01D6588
 * Callers:
...
__int64 __fastcall DmmIsVidPnTargetConnectedToSource(DXGADAPTER *a1, __int64 a2, unsigned int a3, bool *a4)
{
  unsigned int v4; // ebx
  int v7; // r15d
  __int64 v9; // rax
...
LABEL_5:
  ...
  if ( v18 )
  {
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>((__int64)v28, v18, v14, v15);
    v20 = *(_QWORD *)(v18 + 88);
    v29 = 0LL;
    if ( v20 )
    {
    ...
    auto_rc<DMMVIDPN const>::reset(&v29, v21);
    if ( v29 )
    {
      *a4 = (unsigned int)DMMVIDPNTOPOLOGY::GetPathSourceFromTarget((DMMVIDPNTOPOLOGY *)(v29 + 96), a3, v23, v24) == v7;
    ...
    DXGFASTMUTEX::Release(*(struct _KTHREAD ***)(v28[0] + 40LL), v25, v26, v27);
    return v4;
  }
  else
  {
