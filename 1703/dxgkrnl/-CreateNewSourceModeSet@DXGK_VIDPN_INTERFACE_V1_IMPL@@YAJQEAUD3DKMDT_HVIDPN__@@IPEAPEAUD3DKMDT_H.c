/*
 * XREFs of ?CreateNewSourceModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_DXGK_VIDPNSOURCEMODESET_INTERFACE@@@Z @ 0x1C00F2DA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?QueryDxgMiniportVidPnSourceModeSetInterface@VIDPN_MGR@@QEAAXPEAPEBU_DXGK_VIDPNSOURCEMODESET_INTERFACE@@@Z @ 0x1C00E4B4C (-QueryDxgMiniportVidPnSourceModeSetInterface@VIDPN_MGR@@QEAAXPEAPEBU_DXGK_VIDPNSOURCEMODESET_INT.c)
 */
        ...
        struct _DXGK_VIDPNSOURCEMODESET_INTERFACE **a4)
{
  ...
  struct DMMVIDPNSOURCEMODESET *v38; // [rsp+60h] [rbp+18h] BYREF
  struct _DXGK_VIDPNSOURCEMODESET_INTERFACE *v39; // [rsp+68h] [rbp+20h] BYREF
    ...
    *a4 = 0LL;
    ...
    if ( v11 )
    {
      VIDPN_MGR::QueryDxgMiniportVidPnSourceModeSetInterface(
        *(VIDPN_MGR **)(v11 + 48),
        (const struct _DXGK_VIDPNSOURCEMODESET_INTERFACE **)&v39,
        v14,
        v15);
      v17 = (DMMVIDPNSOURCE *)IndexedSet<DMMVIDEOPRESENTTARGET>::FindById(*(_QWORD *)(v16 + 304), v6);
      v22 = v17;
      if ( v17 )
      {
        v37 = 0LL;
        v38 = 0LL;
        v23 = DMMVIDPNSOURCE::CreateNewCofuncModeSet(v17, &v38, v20, v21);
        v7 = v23;
        if ( v23 < 0 )
        {
  ...
  if ( (qword_1C006E790 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    Template_q(v30, &EventProfilerExit, v31, 7045);
