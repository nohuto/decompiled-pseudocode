/*
 * XREFs of ?DdiWriteVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C0029B20
 * Callers:
...
LABEL_11:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK *))(*(_QWORD *)(*((_QWORD *)this + 2) + 920LL)
                                                                                         + 56LL))(
  ...
  if ( (_DWORD)v16 != -1073741811 )
  {
    ...
    if ( !(_DWORD)v16 )
      goto LABEL_22;
    v23 = WdLogNewEntry5_WdError(v17, v15);
    *(_QWORD *)(v23 + 24) = v16;
...
LABEL_22:
  if ( v22 )
  {
    v24 = WdLogNewEntry5_WdError(v17, v15);
    *(_QWORD *)(v24 + 24) = v16;
