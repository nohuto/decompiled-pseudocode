/*
 * XREFs of ?FillFunctionalizePacket@CCD_TOPOLOGY@@QEAAXPEAU_DXGK_DIAG_CCD_FUNCTIONALIZE_PACKET3@@I@Z @ 0x1C00EE024
 * Callers:
  ...
  *((_DWORD *)a2 + 12) = *(unsigned __int16 *)(*((_QWORD *)this + 8) + 20LL);
  ...
  if ( *(_WORD *)(v7 + 20) )
  {
    do
    {
      ...
      *(_DWORD *)((char *)a2 + v9 + 108) = *(_DWORD *)(v8 + v7 + 244);
      *(_DWORD *)((char *)a2 + v9 + 112) = *(_DWORD *)(v8 + v7 + 300);
      *(_DWORD *)((char *)a2 + v9 + 116) = *(_DWORD *)(v8 + v7 + 304);
      v7 = *((_QWORD *)this + 8);
    }
