/*
 * XREFs of ?Serialize@DMMVIDPNSOURCEMODE@@QEBAXQEAU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C0007480
 * Callers:
        ...
        __int64 a4)
{
  ...
  else
  {
    ...
    {
LABEL_2:
      a2->Format.Graphics = *DMMVIDPNSOURCEMODE::GetGraphicsInfo(this, (__int64)a2, a3, a4);
      return;
    }
    v6 = WdLogNewEntry5_WdError(this, a2);
    *(_QWORD *)(v6 + 24) = this;
    *(_QWORD *)(v6 + 32) = *((int *)this + 18);
