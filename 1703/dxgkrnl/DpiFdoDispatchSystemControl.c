/*
 * XREFs of DpiFdoDispatchSystemControl @ 0x1C01C3BA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DpiFdoDispatchSystemControl(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  if ( DeviceExtension[3528] == 1 )
  {
    v3 = WmiSystemControl((PWMILIB_CONTEXT)(DeviceExtension + 3536), DeviceObject, Irp, &IrpDisposition);
    if ( IrpDisposition )
    {
