/*
 * XREFs of ?DdiPowerRuntimeSetDeviceHandle@DXGADAPTER@@QEAAJXZ @ 0x1C01771C4
 * Callers:
...
LABEL_13:
  ...
  v14 = (*((int (__fastcall **)(_QWORD, _QWORD))this + 91))(*((_QWORD *)this + 30), *((_QWORD *)this + 291));
  if ( v22[0] )
  ...
  if ( (_DWORD)v14 )
  {
    v21 = WdLogNewEntry5_WdError(v16, v13);
    *(_QWORD *)(v21 + 24) = v14;
