/*
 * XREFs of ?GetCurrentTvStandard@@YAIPEAVDXGADAPTER@@I@Z @ 0x1C01A8664
 * Callers:
...
__int64 __fastcall GetCurrentTvStandard(struct DXGADAPTER *a1, __int64 a2)
{
  unsigned int v2; // edx
  unsigned int v3; // eax
  ...
  v7 = 0;
  DmmGetClientVidPnTargetModeInfo(a1, a2, &v7, v5, &v6, 0LL, 0LL, 0LL);
  v2 = 16;
  if ( v7 > 16 )
  {
    if ( v7 <= 21 )
