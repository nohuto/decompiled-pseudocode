/*
 * XREFs of Template_pqp @ 0x1C003C82C
 * Callers:
...
NTSTATUS Template_pqp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndirectSwapChainSurfaceList, 0LL, 3u, &UserData);
}
