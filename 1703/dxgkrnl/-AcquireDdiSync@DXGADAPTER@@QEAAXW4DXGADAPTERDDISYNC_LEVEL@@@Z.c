/*
 * XREFs of ?AcquireDdiSync@DXGADAPTER@@QEAAXW4DXGADAPTERDDISYNC_LEVEL@@@Z @ 0x1C00063B0
 * Callers:
...
char __fastcall DXGADAPTER::AcquireDdiSync(__int64 a1, int a2)
{
  ...
  if ( !v2
    || !*(_QWORD *)(v2 + 416)
    || (LOBYTE(CurrentThread) = (*(__int64 (**)(void))(*(_QWORD *)(*(_QWORD *)(v2 + 408) + 8LL) + 72LL))(),
        !(_BYTE)CurrentThread)
    && (CurrentThread = KeGetCurrentThread(), *(struct _KTHREAD **)(a1 + 2296) != CurrentThread) )
  {
    if ( !KeReadStateEvent((PRKEVENT)(a1 + 208)) )
    {
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        Template_q(v6, &EventBlockThread, v7, 73LL);
