/*
 * XREFs of ?Serialize@DMMVIDPNTARGETMODE@@QEBAXQEAU_D3DKMDT_VIDPN_TARGET_MODE@@PEAT_D3DKMDT_WIRE_FORMAT_AND_PREFERENCE@@PEAW4D3DDDI_COLOR_SPACE_TYPE@@@Z @ 0x1C000CF5C
 * Callers:
...
void __fastcall DMMVIDPNTARGETMODE::Serialize(
        ...
        enum D3DDDI_COLOR_SPACE_TYPE *a4)
{
  a2->Id = *((_DWORD *)this + 6);
  ...
  if ( a4 )
    *a4 = *((enum D3DDDI_COLOR_SPACE_TYPE *)this + 34);
}
