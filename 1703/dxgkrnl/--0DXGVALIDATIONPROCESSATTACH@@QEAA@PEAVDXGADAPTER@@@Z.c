/*
 * XREFs of ??0DXGVALIDATIONPROCESSATTACH@@QEAA@PEAVDXGADAPTER@@@Z @ 0x1C0005450
 * Callers:
    ...
    if ( *((_DWORD *)Global + 277) )
    {
      ...
      if ( (v6 & 0x20) == 0 && (v6 & 4) == 0 )
      {
        ...
        if ( Current )
        {
          ...
          {
            v8 = *((_DWORD *)Global + 277);
            if ( v8 == 2 || v8 == 1 && *((_BYTE *)Current + 493) )
            {
              v9 = DXGGLOBAL::GetGlobal();
              SessionData = DXGGLOBAL::GetSessionData(v9);
              if ( SessionData )
              {
                v11 = (struct _KPROCESS *)*((_QWORD *)SessionData + 2325);
                if ( v11 )
                {
                  KeStackAttachProcess(v11, (PRKAPC_STATE)((char *)this + 8));
                  *(_BYTE *)this = 1;
                }
              }
            }
