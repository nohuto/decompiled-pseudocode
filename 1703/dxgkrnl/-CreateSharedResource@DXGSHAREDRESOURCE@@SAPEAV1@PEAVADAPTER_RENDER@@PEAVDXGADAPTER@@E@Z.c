/*
 * XREFs of ?CreateSharedResource@DXGSHAREDRESOURCE@@SAPEAV1@PEAVADAPTER_RENDER@@PEAVDXGADAPTER@@E@Z @ 0x1C00FEAB0
 * Callers:
 ...
 *     ??0DXGSHAREDRESOURCE@@IEAA@PEAVADAPTER_RENDER@@PEAVDXGADAPTER@@@Z @ 0x1C00FEB58 (--0DXGSHAREDRESOURCE@@IEAA@PEAVADAPTER_RENDER@@PEAVDXGADAPTER@@@Z.c)
 */
        ...
        char a3)
{
  ...
  if ( v11 > 1 )
  {
    v12 = (KSPIN_LOCK *)operator new(0x18uLL, (__int64)a2, 1, (POOL_TYPE)512);
  ...
  if ( a3 )
  {
    v13 = (DXGSHAREDRESOURCE *)operator new(0xD8uLL, 0x4B677844u, PagedPool);
    v9 = v13;
    if ( v13 )
    {
