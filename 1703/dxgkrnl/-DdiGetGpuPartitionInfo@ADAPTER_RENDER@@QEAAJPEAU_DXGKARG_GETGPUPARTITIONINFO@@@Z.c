/*
 * XREFs of ?DdiGetGpuPartitionInfo@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETGPUPARTITIONINFO@@@Z @ 0x1C002780C
 * Callers:
...
LABEL_11:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETGPUPARTITIONINFO *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                             + 32LL))(
  ...
  if ( (_DWORD)v16 != -1073741811 && (_DWORD)v16 != -1073741789 )
  {
    v24 = (int)v16 < 0;
    if ( !(_DWORD)v16 )
      goto LABEL_23;
