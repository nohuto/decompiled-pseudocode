/*
 * XREFs of DpReadDeviceSpace @ 0x1C0012B20
 * Callers:
...
LABEL_17:
    ...
    if ( (*(_DWORD *)(a1 + 3788) & 4) == 0 )
    {
      v13 = -1071774661LL;
      goto LABEL_17;
    }
    v15 = *(__int64 (__fastcall **)(_QWORD, void *, _QWORD, _QWORD))(a1 + 2800);
    if ( v15 )
    {
      BusDataByOffset = v15(*(_QWORD *)(a1 + 2776), a3, Offset, Length);
      goto LABEL_12;
    }
LABEL_23:
    v6 = -1073741823;
    v16 = WdLogNewEntry5_WdWarning(a1, a2, v8, 0x80000000LL);
