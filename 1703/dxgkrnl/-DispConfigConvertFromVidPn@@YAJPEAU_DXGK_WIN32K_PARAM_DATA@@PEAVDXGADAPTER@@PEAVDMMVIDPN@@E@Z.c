/*
 * XREFs of ?DispConfigConvertFromVidPn@@YAJPEAU_DXGK_WIN32K_PARAM_DATA@@PEAVDXGADAPTER@@PEAVDMMVIDPN@@E@Z @ 0x1C01A8D84
 * Callers:
...
LABEL_13:
  ...
  v22 = CCD_BTL::ConvertVidPnToPathsModality(v21, a3, (struct _D3DKMT_GETPATHSMODALITY **)&P);
  if ( v22 >= 0 )
  {
    v22 = ConvertPathModalityToDisplayConfig(
            (struct _D3DKMT_GETPATHSMODALITY *)P,
            0LL,
            0LL,
            0LL,
            0,
            0,
            (struct _QDC_CONTEXT *)v25);
    if ( P )
