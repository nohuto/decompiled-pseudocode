/*
 * XREFs of ?AddToMoveList@DDAMetaData@@AEAAHPEAU_D3DKMT_MOVE_RECT@@@Z @ 0x1C01B1994
 * Callers:
...
__int64 __fastcall DDAMetaData::AddToMoveList(DDAMetaData *this, struct _D3DKMT_MOVE_RECT *a2)
{
  ...
  else
  {
    ...
    if ( !Buffer )
    {
      v8 = WdLogNewEntry5_WdError(v7, 0LL);
      *(_QWORD *)(v8 + 24) = v5;
LABEL_9:
