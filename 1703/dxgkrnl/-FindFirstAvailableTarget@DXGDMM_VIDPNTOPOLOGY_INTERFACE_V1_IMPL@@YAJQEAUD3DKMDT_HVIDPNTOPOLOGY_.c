/*
 * XREFs of ?FindFirstAvailableTarget@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNTOPOLOGY__@@IW4_D3DKMDT_VIDEO_PRESENT_TARGET_SUBSET_TYPE@@PEAI@Z @ 0x1C01D8230
 * Callers:
 *     <none>
 * Callees:
        ...
        _DWORD *a4)
{
  ...
  if ( a4 )
  {
    *a4 = -1;
    ...
    {
      v11 = (_QWORD *)WdLogNewEntry5_WdError(a1, 0xFFFFFFFFLL);
      v11[3] = 0LL;
      v11[4] = a4;
      v11[5] = v6;
      v11[6] = v7;
  ...
  {
    v8 = (_QWORD *)WdLogNewEntry5_WdError(a1, a2);
    v8[3] = 0LL;
    v8[4] = v6;
    v8[5] = v7;
