/*
 * XREFs of DxgkHandleThermalCoolingDrtEscape @ 0x1C01CA778
 * Callers:
...
__int64 __fastcall DxgkHandleThermalCoolingDrtEscape(__int64 a1, __int64 a2)
{
  ...
  {
    *(_DWORD *)(a2 + 16) = 0;
    LOBYTE(v3) = *(_QWORD *)(*(_QWORD *)(v2 + 4560) + 48LL) != 0LL;
    *(_DWORD *)(a2 + 16) = v3;
    *(_DWORD *)(a2 + 16) = v3 & 0xFFFFFFFD | (*(_QWORD *)(*(_QWORD *)(v2 + 4560) + 56LL) != 0LL ? 2 : 0);
  }
  return 0LL;
}
