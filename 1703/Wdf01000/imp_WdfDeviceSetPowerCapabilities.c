/*
 * XREFs of imp_WdfDeviceSetPowerCapabilities @ 0x1C0038AF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z @ 0x1C0023184 (-SetPowerCaps@FxPkgPnp@@QEAAXPEAU_WDF_DEVICE_POWER_CAPABILITIES@@@Z.c)
