/*
 * XREFs of ?_Create@FxMemoryObject@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@W4_POOL_TYPE@@K_KPEAPEAV1@@Z @ 0x1C0016928
 * Callers:
        ...
        FxMemoryObject **Object)
{
  ...
  if ( v14 )
  {
    ...
    *((_WORD *)v14 + 5) = ((v6 + 15) & 0xFFF0) + 128;
    v14[7] = 0LL;
    *((_BYTE *)v14 + 48) = 1;
    FxObject::Construct((FxObject *)v14, 0LL);
    v14[14] = v6;
