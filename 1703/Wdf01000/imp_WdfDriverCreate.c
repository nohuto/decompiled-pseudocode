/*
 * XREFs of imp_WdfDriverCreate @ 0x1C0019790
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFDRIVER__ **Driver)
{
  ...
  if ( (int)result >= 0 )
  {
    result = FxValidateUnicodeString((_FX_DRIVER_GLOBALS *)DriverName, RegistryPath);
    if ( (int)result >= 0 )
    {
      ...
      {
        WPP_IFR_SF_((_FX_DRIVER_GLOBALS *)DriverName, 2u, 0x11u, 0xDu, WPP_FxDriverApi_cpp_Traceguids);
        return 3221225485LL;
      }
      ...
      if ( (int)result >= 0 )
      {
        ...
        if ( (int)FxCalculateObjectTotalSize2((_FX_DRIVER_GLOBALS *)DriverName, 0x168u, 0, ContextSizeOverride, &Size) < 0 )
          goto LABEL_62;
        if ( DriverName[264] )
          Caller = retaddr;
        else
          ...
          && (FxDriver::FxDriver(v20, DriverObject, DriverConfig, (_FX_DRIVER_GLOBALS *)DriverName), (v22 = v21) != 0LL) )
        {
          ...
          if ( v23 >= 0 )
          {
            v23 = FxObject::Commit(v22, (_FX_DRIVER_GLOBALS *)DriverAttributes, (void **)&hDriver, 0LL, 1u);
            if ( v23 >= 0 )
            {
              v24 = hDriver;
              *((_QWORD *)DriverName + 54) = hDriver;
              *((_QWORD *)DriverName + 9) = v22;
              *((_DWORD *)DriverName + 110) |= DriverConfig->DriverInitFlags;
              DriverName[480] = (DriverConfig->DriverInitFlags & 3) == 0 || DriverConfig->EvtDriverUnload != 0LL;
              if ( Driver )
                *Driver = v24;
                ...
                *(_QWORD *)&imageName.m_UnicodeString.Length = 0LL;
                  ...
                  && (Tlgg_TelemetryProviderProv.KeywordAll & 0x200000000000LL) == Tlgg_TelemetryProviderProv.KeywordAll )
                {
                  ...
                  *(_QWORD *)&_TlgData[2].Size = 16LL;
                  ...
                  TlgCreateWsz(&_TlgData[5], L"01.021.0");
                  v29 = *((_QWORD *)DriverName + 37);
                  Tag = *(_DWORD *)(v29 + 16);
                  _TlgData[6].Ptr = (unsigned __int64)&Tag;
                  *(_QWORD *)&_TlgData[6].Size = 4LL;
                  v30 = *(_DWORD *)(v29 + 20);
                  v31 = (const _TlgProvider_t *)*((unsigned int *)DriverName + 110);
                  LODWORD(Size) = v30;
