/*
 * XREFs of ?GetNextDevice@FxChildList@@QEAAJPEAPEAUWDFDEVICE__@@PEAU_WDF_CHILD_LIST_ITERATOR@@PEAU_WDF_CHILD_RETRIEVE_INFO@@@Z @ 0x1C002DA0C
 * Callers:
...
LABEL_5:
    ...
    else
    {
      while ( 1 )
      {
        if ( (Flags = Iterator->Flags, v14 = v10, (Flags & 1) != 0) && LODWORD(v10->Release) == 2
          ...
          || (Flags & 4) != 0 && LODWORD(v10->Release) == 1 )
        {
          ...
          if ( !EvtChildListIdentificationDescriptionCompare )
            break;
          v25 = (unsigned __int64)this ^ 0xFFFFFFFFFFFFFFF8uLL;
          if ( !this->m_ObjectSize )
            v25 = 0LL;
          if ( EvtChildListIdentificationDescriptionCompare(
                 (WDFCHILDLIST__ *)v25,
      ...
      if ( SelfDestruct )
      {
        v17 = *((_WORD *)SelfDestruct + 5);
        v18 = WdfChildListRetrieveDeviceSuccess;
        v19 = (WDFDEVICE__ *)((unsigned __int64)SelfDestruct ^ 0xFFFFFFFFFFFFFFF8uLL);
        if ( !v17 )
          v19 = 0LL;
        *Device = v19;
      }
      ...
      if ( Info )
      {
        ...
        if ( IdentificationDescription )
          FxChildList::CopyId(
            ...
            (_WDF_CHILD_IDENTIFICATION_DESCRIPTION_HEADER *)v14->AddRefOverride);
        AddressDescription = Info->AddressDescription;
        if ( AddressDescription )
          FxChildList::CopyAddress(
            this,
            AddressDescription,
            (_WDF_CHILD_ADDRESS_DESCRIPTION_HEADER *)v14->ReleaseOverride);
        Info->Status = v18;
      }
      v8 = 0;
    }
