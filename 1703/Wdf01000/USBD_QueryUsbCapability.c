/*
 * XREFs of USBD_QueryUsbCapability @ 0x1C00A26C0
 * Callers:
 *     ?QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z @ 0x1C0092B58 (-QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x1C003E280 (__security_check_cookie.c)
 *     memset @ 0x1C0040480 (memset.c)
 *     USBDInternal_BuildandSendIoctlSynchronously @ 0x1C00A1DC4 (USBDInternal_BuildandSendIoctlSynchronously.c)
 */
        ...
        unsigned int *ResultLength)
{
  ...
  if ( KeGetCurrentIrql() )
  {
    if ( BYTE4(WPP_GLOBAL_WDF_Control.DeviceQueue.DeviceListHead.Blink) )
