/*
 * XREFs of ?PowerPolicyGetDeviceDeepestDeviceWakeState@FxPkgPnp@@IEAA?AW4_DEVICE_POWER_STATE@@W4_SYSTEM_POWER_STATE@@@Z @ 0x1C00246A0
 * Callers:
  ...
  if ( _FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(this->m_Globals, SystemState, 0xBu) )
  {
    ...
    else
    {
      *(__m128i *)v12 = _mm_load_si128((const __m128i *)&_xmm);
      v13 = 4;
      v14 = 4;
      v10 = *(unsigned __int8 *)(v5 - 1 + v4 + 1004);
      if ( (unsigned int)v10 >= 6 )
      {
        id = 0;
LABEL_13:
        WPP_IFR_SF_LL(v6, *(_BYTE *)(v4 + 1009), v3, v4, v11, *(unsigned __int8 *)(v4 + 1009), id);
        return id;
      }
      id = v12[v10];
    }
