/*
 * XREFs of ?PowerPolCancelingWakeForSystemSleepWakeCanceled@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C009E320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::PowerPolCancelingWakeForSystemSleepWakeCanceled(FxPkgPnp *This)
{
  ...
  v1 = FxPkgPnp::PowerPolicySendDevicePowerRequest(This, (POWER_STATE)1, NoRetry);
  v2 = 1433;
  if ( v1 < 0 )
    return 1404;
  return v2;
