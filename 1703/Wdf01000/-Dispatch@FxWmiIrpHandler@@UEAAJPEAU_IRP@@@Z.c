/*
 * XREFs of ?Dispatch@FxWmiIrpHandler@@UEAAJPEAU_IRP@@@Z @ 0x1C0033060
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindProviderLocked@FxWmiIrpHandler@@IEAAPEAVFxWmiProvider@@PEAU_GUID@@@Z @ 0x1C0033278 (-FindProviderLocked@FxWmiIrpHandler@@IEAAPEAVFxWmiProvider@@PEAU_GUID@@@Z.c)
...
__int64 __fastcall FxWmiIrpHandler::Dispatch(FxWmiIrpHandler *this, _IRP *Irp, __int64 a3)
{
  ...
  if ( v12->FxVerboseOn )
  {
    ...
    if ( !m_ObjectSize )
      _a1 = 0LL;
    WPP_IFR_SF_qqcq(v12, 5u, 0xDu, 0xEu, WPP_FxWmiIrpHandler_cpp_Traceguids, _a1, _a2, _a3, Irp);
  }
  if ( _a3 != 11 && _a3 > 9u
