/*
 * XREFs of ?CompleteInternal@FxRequest@@AEAAJJ@Z @ 0x1C0009E80
 * Callers:
 ...
 *     ?CompleteWithPriority@FxRequest@@QEAAJJD@Z @ 0x1C00786B8 (-CompleteWithPriority@FxRequest@@QEAAJJD@Z.c)
 * Callees:
 ...
 *     ?IsDebug@FxObject@@IEAAEXZ @ 0x1C000B5E0 (-IsDebug@FxObject@@IEAAEXZ.c)
        ...
        unsigned __int16 a4)
{
  ...
  _IRP *v85; // rsi
  FxRequestTimer *v86; // rcx
  FxRequest *v87; // rcx
  _SLIST_ENTRY *v88; // rsi
  const void *_a1; // rcx
  _FX_DRIVER_GLOBALS *v90; // rcx
  const void *v91; // rdx
  _FX_DRIVER_GLOBALS *v92; // rcx
  const void *v93; // rdx
  _FX_DRIVER_GLOBALS *v94; // rcx
  const void *v95; // rdx
  ...
  FxRequestContext *v130; // rcx
  _LIST_ENTRY *v131; // rcx
  _SINGLE_LIST_ENTRY *v132; // rax
  void (__fastcall *v133)(_SLIST_ENTRY *); // rax
  ...
  FxTagTracker *v140; // rcx
  FxCallbackLock *v141; // rcx
  FxVerifierLock *Next; // rcx
  const _GUID *traceGuid; // [rsp+20h] [rbp-98h]
  const _GUID *traceGuida; // [rsp+20h] [rbp-98h]
  _LIST_ENTRY *v145; // [rsp+58h] [rbp-60h]
  FxIrp irp; // [rsp+60h] [rbp-58h] BYREF
  ULONG_PTR retaddr; // [rsp+B8h] [rbp+0h]
  FxRequestCompletionState v148; // [rsp+C0h] [rbp+8h]
  unsigned __int8 v149; // [rsp+C0h] [rbp+8h]
  unsigned int v150; // [rsp+C8h] [rbp+10h]
  unsigned __int8 PreviousIrql; // [rsp+D0h] [rbp+18h] BYREF
  unsigned __int8 v152; // [rsp+D8h] [rbp+20h] BYREF

  v150 = (unsigned int)Status;
  ...
  if ( !this->m_Reserved && !this->m_IrpAllocation )
  {
    ...
    if ( this->m_ObjectState == 1 )
    {
      ...
      if ( (this->m_ObjectFlags & 0x200) != 0 )
      {
        ...
        if ( v90->FxVerboseOn )
        {
          v91 = (const void *)((unsigned __int64)this ^ 0xFFFFFFFFFFFFFFF8uLL);
          if ( !this->m_ObjectSize )
            v91 = 0LL;
          WPP_IFR_SF_qqLL(v90, 5u, 0x14u, 0xAu, WPP_FxObject_hpp_Traceguids, this, v91, this->m_ObjectState, 3u);
        }
      ...
      if ( (m_ObjectFlags & 0x20) == 0 && ((m_ObjectFlags & 0x10) == 0 || !v15) )
      {
        if ( (m_ObjectFlags & 0x200) != 0 )
        {
          ...
          if ( v92->FxVerboseOn )
          {
            v93 = (const void *)((unsigned __int64)this ^ 0xFFFFFFFFFFFFFFF8uLL);
            if ( !this->m_ObjectSize )
              v93 = 0LL;
            WPP_IFR_SF_qqLL(v92, 5u, 0x14u, 0xAu, WPP_FxObject_hpp_Traceguids, this, v93, 3u, 4u);
          }
          if ( SLOBYTE(this->m_ObjectFlags) < 0 )
          ...
          else
          {
            if ( (v18 & 0x200) != 0 )
            {
              ...
              if ( v94->FxVerboseOn )
              {
                ...
                if ( !this->m_ObjectSize )
                  v95 = 0LL;
                WPP_IFR_SF_qqLL(v94, 5u, 0x14u, 0xAu, WPP_FxObject_hpp_Traceguids, this, v95, this->m_ObjectState, 2u);
              }
              if ( SLOBYTE(this->m_ObjectFlags) < 0 )
...
LABEL_30:
    ...
    while ( 1 )
    {
      ...
      {
        m_CompletionState = v148;
        v9 = 0LL;
        v5 = v150;
        break;
      }
      Flink = p_m_ChildListHead->Flink;
      v97 = p_m_ChildListHead->Flink->Flink;
      if ( p_m_ChildListHead->Flink->Blink != p_m_ChildListHead || v97->Blink != Flink )
        __fastfail(3u);
      p_m_ChildListHead->Flink = v97;
      p_Blink = (FxObject *)&Flink[-5].Blink;
      v97->Blink = p_m_ChildListHead;
      Flink->Blink = Flink;
      Flink->Flink = Flink;
      v99 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&Flink[-1]);
      m_ObjectState = p_Blink->m_ObjectState;
      v101 = v99;
      p_Blink->m_ParentObject = 0LL;
      v102 = m_ObjectState - 2;
      if ( !v102 )
        goto LABEL_248;
      v103 = v102 - 2;
      if ( !v103 )
...
LABEL_245:
        KeReleaseSpinLock(&p_Blink->m_SpinLock.m_Lock, v101);
      }
      else
      {
LABEL_248:
        FxObject::DeletedAndDisposedWorkerLocked(p_Blink, v99, 1u);
      }
    }
  }
  if ( this->m_IrpReferenceCount )
  {
    ...
    if ( (this->m_RequestBaseFlags & 1) != 0 || (this->m_RequestBaseStaticFlags & 1) != 0 )
      v106 = this->m_SystemBuffer.GetHandle(&this->m_SystemBuffer);
    else
      v106 = (WDFMEMORY__ *)v9;
    v107 = (unsigned __int64)this ^ 0xFFFFFFFFFFFFFFF8uLL;
    v108 = (const void *)((unsigned __int64)this ^ 0xFFFFFFFFFFFFFFF8uLL);
    if ( !this->m_ObjectSize )
      v108 = 0LL;
    WPP_IFR_SF_qqDqq(
      m_Globals,
    ...
    if ( (this->m_RequestBaseFlags & 1) != 0 || (this->m_RequestBaseStaticFlags & 1) != 0 )
    {
      v109 = this->m_SystemBuffer.GetBufferSize(&this->m_SystemBuffer);
      v110 = this->m_SystemBuffer.GetMdl(&this->m_SystemBuffer);
      v111 = (const void *)this->m_SystemBuffer.GetBuffer(&this->m_SystemBuffer);
      v112 = this->m_SystemBuffer.GetHandle(&this->m_SystemBuffer);
      WPP_IFR_SF_qqqi(m_Globals, v113, v114, 0x15u, traceGuida, v112, v111, v110, v109);
    }
    if ( (this->m_RequestBaseFlags & 2) != 0 || (this->m_RequestBaseStaticFlags & 2) != 0 )
    {
      v115 = this->m_OutputBuffer.GetBufferSize(&this->m_OutputBuffer);
      v116 = this->m_OutputBuffer.GetMdl(&this->m_OutputBuffer);
      v117 = (const void *)this->m_OutputBuffer.GetBuffer(&this->m_OutputBuffer);
      v118 = this->m_OutputBuffer.GetHandle(&this->m_OutputBuffer);
      WPP_IFR_SF_qqqi(m_Globals, v119, v120, 0x16u, traceGuida, v118, v117, v116, v115);
    }
    if ( !this->m_ObjectSize )
      v107 = 0LL;
    FxVerifierBugCheckWorker(m_Globals, WDF_VERIFIER_FATAL_ERROR, v107, this->m_IrpReferenceCount);
  }
  irp.m_Irp = _a2;
  ...
  if ( (m_CompletionState & 0x80u) == 0 )
  {
    ...
    if ( SLOBYTE(m_IoQueue->m_ObjectFlags) < 0
      && (v122 = *(FxVerifierLock **)&m_IoQueue[-1].m_PowerIdle.m_DbgFlagIsInitialized) != 0LL )
    {
      FxVerifierLock::Lock(v122, &PreviousIrql, v23);
    }
    else
    {
    ...
    if ( m_IoQueue->m_Dispatching )
    {
      ...
      {
        FxVerifierLock::Unlock(v123, PreviousIrql, v26);
      }
      else
      {
  ...
  {
    v124 = KeAcquireSpinLockRaiseToDpc(&this->m_SpinLock.m_Lock);
    v125 = this->m_ParentObject;
    v126 = v124;
    if ( v125 )
    {
      if ( FxObject::RemoveChildObjectInternal(v125, this) == -1073741738 )
      {
        FxObject::SetObjectStateLocked(this, FxObjectStateWaitingForParentDeleteAndDisposed);
        KeReleaseSpinLock(&this->m_SpinLock.m_Lock, v126);
        goto LABEL_56;
      }
      this->m_ParentObject = 0LL;
    }
  ...
  if ( (this->m_ObjectFlags & 0x200) != 0 )
  {
    ...
    if ( v127->FxVerboseOn )
    {
      v128 = (const void *)((unsigned __int64)this ^ 0xFFFFFFFFFFFFFFF8uLL);
      if ( !this->m_ObjectSize )
        v128 = 0LL;
      WPP_IFR_SF_qqLL(v127, 5u, 0x14u, 0xAu, WPP_FxObject_hpp_Traceguids, this, v128, this->m_ObjectState, 0xAu);
    }
    if ( SLOBYTE(this->m_ObjectFlags) < 0 )
  ...
  if ( (char *)Release == (char *)FxRequest::Release )
  {
    ...
    if ( SLOBYTE(this->m_ObjectFlags) < 0 )
    {
      v129 = this[-1].m_OwnerListEntry2.Blink;
      if ( v129 )
        FxTagTracker::UpdateTagHistory(
          (FxTagTracker *)v129,
          0LL,
...
LABEL_97:
    ...
    if ( (v37 & 0x80u) != 0 )
    {
      v24 = this[-1].m_OwnerListEntry2.Blink;
      v145 = v24;
      if ( v24 )
        FxTagTracker::CheckForAbandondedTags((FxTagTracker *)v24);
    }
    else
    {
      v145 = 0LL;
    ...
    if ( v24 )
    {
      ...
      FxTagTracker::`scalar deleting destructor'((FxTagTracker *)v24, (unsigned int)FxVerifyLeakDetection);
    }
    ...
    if ( (char *)SelfDestruct == (char *)FxRequestFromLookaside::SelfDestruct )
    {
      ...
      if ( v49 )
      {
        ...
        v130 = this->m_RequestContext;
        if ( v130 )
          ((void (__fastcall *)(FxRequestContext *, __int64))v130->~FxRequestContext)(v130, 1LL);
      }
      ...
      if ( SLOBYTE(this->m_ObjectFlags) < 0 )
      {
        v131 = this[-1].m_ForwardProgressList.Flink;
        if ( v131 )
        {
          FxVerifierLock::`scalar deleting destructor'((FxVerifierLock *)v131, (unsigned int)v45);
      ...
      {
        v132 = FxObject::_CleanupPointer(this->m_Globals, this);
        ExFreePoolWithTag(v132->Next, 0);
        goto LABEL_97;
      }
      if ( SLOBYTE(this->m_ObjectFlags) < 0 )
      ...
      if ( !v53 || *(_WORD *)(v53 + 8) != 4354 || !*(_BYTE *)(v53 + 1667) )
      {
        ...
        {
          v133 = *(void (__fastcall **)(_SLIST_ENTRY *))&v48[2].m_NPLock.m_DbgFlagIsInitialized;
          ++LODWORD(v48[2].m_ChildEntry.Blink);
          v133(m_InternalContext);
        }
        else
        {
      ...
      v88 = (_SLIST_ENTRY *)v52[-1].m_InternalContext;
      if ( ExQueryDepthSList((PSLIST_HEADER)&v48[2].m_SpinLock) >= LOWORD(v48[2].m_ParentObject) )
      {
        (*(void (__fastcall **)(_SLIST_ENTRY *))&v48[2].m_NPLock.m_DbgFlagIsInitialized)(v88);
        goto LABEL_97;
      }
      ExpInterlockedPushEntrySList((PSLIST_HEADER)&v48[2].m_SpinLock, v88);
      m_CanComplete = v149;
LABEL_53:
        ...
        if ( m_CanComplete )
        {
          if ( v35 == 1 )
          {
            if ( this->m_Completed )
            {
              ...
              if ( v136 == 1 )
              {
                FxNonPagedObject::Lock(v137, &v152);
                --v137->m_TwoPhaseCompletions;
                --v137->m_DriverIoCount;
                if ( v137->m_Dispatching )
                  FxNonPagedObject::Unlock(v137, v152);
                else
                  FxIoQueue::DispatchEvents(v137, v152, 0LL);
              }
            }
          }
        }
    ...
    if ( (char *)v74 == (char *)FxRegKey::`scalar deleting destructor' )
    {
      ...
      v76 = *(void **)&this->m_NPLock.m_DbgFlagIsInitialized;
...
LABEL_150:
    ...
    else
    {
      if ( (char *)v74 == (char *)FxRequest::`scalar deleting destructor' )
      {
        ...
        v84 = this->m_RequestContext;
        v85 = this->m_Irp.m_Irp;
        if ( v84 )
        {
          if ( v85 )
            v84->ReleaseAndRestore(v84, this);
          v134 = this->m_RequestContext;
          if ( v134 )
            ((void (__fastcall *)(FxRequestContext *, __int64))v134->~FxRequestContext)(v134, 1LL);
        }
        if ( v85 && this->m_IrpAllocation == 1 )
          IoFreeIrp(this->m_Irp.m_Irp);
        v86 = this->m_Timer;
        if ( v86 )
          FxRequestTimer::`scalar deleting destructor'(v86, (unsigned int)v73);
        this->__vftable = (FxRequest_vtbl *)FxNonPagedObject::`vftable';
        if ( SLOBYTE(this->m_ObjectFlags) < 0 )
        {
...
LABEL_319:
  ...
  Release(this, 0LL, 1246, "minkernel\\wdf\\framework\\shared\\object\\fxobjectstatemachine.cpp");
LABEL_56:
  if ( m_DeviceBase )
  {
    ...
    if ( SLOBYTE(m_DeviceBase->m_ObjectFlags) < 0 )
    {
      v140 = (FxTagTracker *)m_DeviceBase[-1].m_ChildEntry.Blink;
      if ( v140 )
        FxTagTracker::UpdateTagHistory(
          v140,
          &irp,
...
LABEL_358:
      ...
      if ( v80 )
      {
        ...
        v141 = (FxCallbackLock *)m_DeviceBase[1].m_ChildListHead.Blink;
        if ( v141 )
          ((void (__fastcall *)(FxCallbackLock *, __int64))v141->~FxCallbackLock)(v141, 1LL);
      }
