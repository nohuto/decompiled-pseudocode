/*
 * XREFs of ?Initialize@FxPkgPnp@@UEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C00266D0
 * Callers:
...
int __fastcall FxPkgPnp::Initialize(FxPkgPnp *this, WDFDEVICE_INIT *DeviceInit)
{
  ...
  KIRQL v58; // [rsp+A0h] [rbp+8h]
  FxVerifierLock *v59; // [rsp+A8h] [rbp+10h] BYREF
  FxVerifierLock *VerifierLock; // [rsp+B0h] [rbp+18h] BYREF
  FxDeviceBase *v61; // [rsp+B8h] [rbp+20h]
    ...
    if ( m_Resources->m_ObjectSize )
    {
      if ( !m_DeviceBase
        && (m_Resources->m_ParentObject
         || (m_DeviceBase = (FxDeviceBase *)m_Resources->m_Globals->Driver, m_DeviceBase == (FxDeviceBase *)m_Resources))
        || (v61 = m_DeviceBase) == 0LL )
      {
LABEL_33:
        v27 = m_Resources->m_Globals;
        m_Resources->m_ObjectFlags |= 8u;
        if ( v27->FxVerifierOn )
          FxObject::Vf_VerifyLeakDetectionConsiderObject(m_Resources, v18);
        v28 = this->m_Resources;
        v29 = _InterlockedIncrement(&v28->m_Refcnt);
        if ( SLOBYTE(v28->m_ObjectFlags) < 0 )
        {
          v51 = *(FxTagTracker **)&v28[-1].m_NPLock.m_DbgFlagIsInitialized;
          if ( v51 )
          ...
          if ( v35 )
          {
            ...
            *(_DWORD *)&v35->m_ObjectFlags = 0x10000;
            ...
            if ( SLOBYTE(v35->m_ObjectFlags) < 0 )
            {
              ...
              {
                v59 = 0LL;
                FxVerifierLock::CreateAndInitialize(&v59, v52, v35);
                v35[-1].m_NPLock.m_Lock = (unsigned __int64)v59;
              }
            }
            v35->m_Count = 0;
...
LABEL_58:
              ...
              if ( v35->m_ObjectState == 1 )
              {
                ...
                else
                {
                  ...
                  KeReleaseSpinLock(&v35->m_SpinLock.m_Lock, v58);
                  if ( v45 >= 0 )
                    goto LABEL_58;
                }
              }
...
LABEL_97:
      ...
      v21 = KeAcquireSpinLockRaiseToDpc(&m_Resources->m_SpinLock.m_Lock);
      v22 = v21;
      LOBYTE(v59) = v21;
      if ( m_Resources->m_ObjectState == 1 )
      {
        if ( m_Resources->m_ParentObject )
        {
          KeReleaseSpinLock(&m_Resources->m_SpinLock.m_Lock, v21);
          v26 = -1071644147;
        }
        else
        {
          ...
          else
          {
            ...
            KeReleaseSpinLock(&m_DeviceBase->m_SpinLock.m_Lock, v57);
            v26 = -1073741738;
          }
          KeReleaseSpinLock(&m_Resources->m_SpinLock.m_Lock, (KIRQL)v59);
          if ( v26 >= 0 )
          {
            p_FxPoolFrameworks = &m_Globals->FxPoolFrameworks;
            goto LABEL_33;
      ...
      {
        FxObject::TraceDroppedEvent(m_Resources, FxObjectDroppedEventAssignParentObject);
