/*
 * XREFs of imp_WdfDeviceIndicateWakeStatus @ 0x1C0078350
 * Callers:
 *     <none>
 * Callees:
        ...
        int WaitWakeStatus)
{
  ...
  {
    WPP_IFR_SF_qd(m_Globals, 2u, 0x12u, 0x11u, WPP_FxDeviceApiKm_cpp_Traceguids, Device, WaitWakeStatus);
    return 3221225485LL;
  }
  else
  {
    ...
    if ( m_PkgPnp->m_SharedPower.m_WaitWakeOwner )
    {
      ...
      {
        WPP_IFR_SF_q(m_Globals, 2u, 0x12u, 0x12u, WPP_FxDeviceApiKm_cpp_Traceguids, Device);
