/*
 * XREFs of ?TransferCompleted@FxDmaPacketTransaction@@UEAAJXZ @ 0x1C003DB40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxDmaPacketTransaction::TransferCompleted(FxDmaPacketTransaction *this, __int64 a2, unsigned int a3)
{
  ...
  v18 = this->m_AdapterInfo->AdapterObject;
...
LABEL_5:
  ...
  if ( !*p_m_ObjectSize )
    v10 = 0LL;
  WPP_IFR_SF_qd(m_Globals, 2u, 0xFu, 0x20u, WPP_FxDmaTransactionPacket_cpp_Traceguids, v10, id);
