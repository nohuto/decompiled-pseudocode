/*
 * XREFs of ?AddRefOverride@FxRequest@@UEAAKGPEAXJPEBD@Z @ 0x1C007C3A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxRequest::AddRefOverride(FxRequest *this, __int64 Offset, void *Tag, int Line, const char *File)
{
  if ( !(_WORD)Offset )
