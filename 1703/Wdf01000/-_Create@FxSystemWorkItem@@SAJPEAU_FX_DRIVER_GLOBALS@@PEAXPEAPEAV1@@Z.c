/*
 * XREFs of ?_Create@FxSystemWorkItem@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAXPEAPEAV1@@Z @ 0x1C00367F0
 * Callers:
        ...
        FxSystemWorkItem **pObject)
{
  ...
  if ( v9 )
  {
    ...
    {
      memset(v9, 0, 0x30uLL);
      LODWORD(v11->m_ChildListHead.Flink) = 1146058822;
      v11 = (FxSystemWorkItem *)((char *)v11 + 48);
    }
    if ( v11 )
    {
      ...
      *(_DWORD *)&v11->m_ObjectFlags = 0x10000;
      ...
      if ( SLOBYTE(v11->m_ObjectFlags) < 0 )
      {
        ...
        if ( v16->FxVerifierLock )
        {
          ...
          *(_QWORD *)&v11[-1].m_WorkItemRunningCount = VerifierLock;
        }
      }
