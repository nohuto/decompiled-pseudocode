/*
 * XREFs of ?Vf_VerifyForwardRequestToParent@FxIoQueue@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAV1@PEAVFxRequest@@@Z @ 0x1C00D50E0
 * Callers:
...
LABEL_3:
    ...
    if ( !m_ObjectSize )
      _a1 = 0LL;
    WPP_IFR_SF_qd(FxDriverGlobals, 2u, 0xDu, v10, WPP_FxIoQueue_cpp_Traceguids, _a1, -1073741808);
LABEL_31:
  ...
  if ( IsDriverOwned >= 0 )
  {
    if ( DestQueue == this )
    {
      ...
      if ( !v14 )
        v15 = 0LL;
      WPP_IFR_SF_qd(FxDriverGlobals, 2u, 0xDu, 0x21u, WPP_FxIoQueue_cpp_Traceguids, v15, -1073741808);
      goto LABEL_31;
    }
    ...
    if ( v22 && !*(_BYTE *)(v22 + 1667) )
    {
      ...
      if ( !v23 )
        v24 = 0LL;
      WPP_IFR_SF_qd(FxDriverGlobals, 2u, 0xDu, 0x24u, WPP_FxIoQueue_cpp_Traceguids, v24, -1073741808);
      goto LABEL_31;
    }
  }
  return (unsigned int)IsDriverOwned;
