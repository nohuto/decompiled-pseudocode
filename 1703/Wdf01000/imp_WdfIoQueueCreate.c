/*
 * XREFs of imp_WdfIoQueueCreate @ 0x1C0037D20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
        v20 = FxPkgIo::CreateQueue(
                ...
                Config,
                QueueAttributes,
                *(_QWORD *)&DriverGlobals[-7].DriverName[16],
                &pQueue);
        if ( v20 >= 0 )
        {
          v21 = pQueue;
          if ( Config->DefaultQueue
            && (v22 = FxPkgIo::InitializeDefaultQueue(m_PkgIo, (unsigned __int64)pDevice, pQueue), v22 < 0) )
          {
