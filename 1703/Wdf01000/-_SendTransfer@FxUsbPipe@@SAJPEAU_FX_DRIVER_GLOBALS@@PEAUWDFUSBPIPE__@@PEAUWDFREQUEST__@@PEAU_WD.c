/*
 * XREFs of ?_SendTransfer@FxUsbPipe@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAUWDFUSBPIPE__@@PEAUWDFREQUEST__@@PEAU_WDF_REQUEST_SEND_OPTIONS@@PEAU_WDF_MEMORY_DESCRIPTOR@@PEAKK@Z @ 0x1C008DD20
 * Callers:
    ...
    if ( v11 >= 0 )
    {
        ...
        || (v11 = FxRequestBuffer::ValidateMemoryDescriptor(&buf, m_Globals, MemoryDescriptor, 0), v11 >= 0) )
      {
        ...
        if ( v11 >= 0 )
        {
          ...
          v11 = FxIoTarget::SubmitSync(pUsbPipe, (FxRequest *)v18.m_TrueRequest, RequestOptions, 0LL);
          if ( BytesTransferred )
