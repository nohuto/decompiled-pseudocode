/*
 * XREFs of ?EventQueueWorker@FxEventQueue@@IEAAXXZ @ 0x1C0067264
 * Callers:
 *     ?_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z @ 0x1C00A0860 (-_WorkerThreadRoutine@FxThreadedEventQueue@@KAXPEAX@Z.c)
 * Callees:
