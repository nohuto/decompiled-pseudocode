/*
 * XREFs of ?_PnpQueryId@FxPkgPdo@@CAJPEAVFxPkgPnp@@PEAVFxIrp@@@Z @ 0x1C002F7F0
 * Callers:
 *     <none>
 * Callees:
 *     ?FxCalculateTotalMultiSzStringSize@@YA_KPEBG@Z @ 0x1C002F9EC (-FxCalculateTotalMultiSzStringSize@@YA_KPEBG@Z.c)
