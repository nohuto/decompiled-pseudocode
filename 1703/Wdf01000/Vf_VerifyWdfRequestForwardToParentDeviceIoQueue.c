/*
 * XREFs of Vf_VerifyWdfRequestForwardToParentDeviceIoQueue @ 0x1C00D3D10
 * Callers:
        ...
        FxRequest *request)
{
    ...
    || !_FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(fxDriverGlobals, (unsigned int)request, 0xBu) )
  {
    ...
    if ( !request->m_ObjectSize )
      v8 = 0LL;
    WPP_IFR_SF_qd(fxDriverGlobals, 2u, 0x10u, 0x48u, WPP_FxRequestApi_cpp_Traceguids, v8, -1073741808);
    goto LABEL_14;
  }
