/*
 * XREFs of ?ConnectInternal@FxInterrupt@@QEAAJXZ @ 0x1C0018034
 * Callers:
...
__int64 __fastcall FxInterrupt::ConnectInternal(FxInterrupt *this)
{
  ...
  connectParams.Version = FxLibraryGlobals.ProcessorGroupSupport != 0 ? 4 : 1;
  ...
  return (*(__int64 (__fastcall **)(_IO_CONNECT_INTERRUPT_PARAMETERS *))(v3 + 1120))(&connectParams);
}
