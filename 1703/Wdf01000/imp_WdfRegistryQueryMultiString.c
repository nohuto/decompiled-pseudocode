/*
 * XREFs of imp_WdfRegistryQueryMultiString @ 0x1C0018BD0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFCOLLECTION__ *Collection)
{
  ...
  while ( 1 )
  {
    ...
    if ( v20 )
    {
      ...
      if ( v13 >= 0 )
      {
        v13 = FxObject::Commit((FxObject *)v20, (_FX_DRIVER_GLOBALS *)Attributes, &dummy, 0LL, 1u);
        if ( v13 >= 0 )
        {
          if ( !FxCollectionInternal::Add(&pCollection->FxCollectionInternal, pCollection->m_Globals, (FxObject *)v20) )
          {
            v13 = -1073741670;
            WPP_IFR_SF_qid(
              m_Globals,
