/*
 * XREFs of ?Invoke@FxPowerStateCallback@@QEAAXW4_WDF_DEVICE_POWER_STATE@@W4_WDF_STATE_NOTIFICATION_TYPE@@PEAUWDFDEVICE__@@PEBU_WDF_DEVICE_POWER_NOTIFICATION_DATA@@@Z @ 0x1C00985C4
 * Callers:
        ...
        const _WDF_DEVICE_POWER_NOTIFICATION_DATA *NotificationData)
{
  ...
  if ( v6 )
  {
    if ( (Type & *((_DWORD *)&this[-7] + 4 * v5 - 300)) != 0 )
