/*
 * XREFs of ?PowerPolicyDisarmWakeFromSx@FxPkgPnp@@AEAAXXZ @ 0x1C009F6CC
 * Callers:
 ...
 *     ?IndicateWakeStatus@FxChildList@@QEAAXJ@Z @ 0x1C0071198 (-IndicateWakeStatus@FxChildList@@QEAAXJ@Z.c)
 */
