/*
 * XREFs of imp_WdfInterruptCreate @ 0x1C00188E0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFINTERRUPT__ **Interrupt)
{
  ...
  if ( _FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(m_Globals, v8, 0xDu) )
    ...
    v14 = _FX_DRIVER_GLOBALS::IsVersionGreaterThanOrEqualTo(m_Globals, v11, 0xBu) != 0 ? 96 : 56;
...
LABEL_24:
  ...
  result = FxInterrupt::_CreateAndInit(m_Globals, v20, (FxDevice *)pParent, Attributes, Configuration, &pFxInterrupt);
  if ( result >= 0 )
  {
