/*
 * XREFs of ?ValidateInterruptResourceCm@FxPkgPnp@@QEAAJPEAU_CM_PARTIAL_RESOURCE_DESCRIPTOR@@0PEAU_WDF_INTERRUPT_CONFIG@@@Z @ 0x1C00980F0
 * Callers:
        ...
        _WDF_INTERRUPT_CONFIG *Configuration)
{
  ...
  _CM_PARTIAL_RESOURCE_DESCRIPTOR *v14; // rax
  ...
  __int64 _a2; // [rsp+30h] [rbp-48h]
  _CM_PARTIAL_RESOURCE_DESCRIPTOR *v45; // [rsp+80h] [rbp+8h] BYREF
  _CM_PARTIAL_RESOURCE_DESCRIPTOR *v46; // [rsp+88h] [rbp+10h] BYREF
  _WDF_INTERRUPT_CONFIG *v47; // [rsp+98h] [rbp+20h]

  v47 = Configuration;
  m_Globals = this->m_Globals;
  v46 = CmIntResourceRaw;
  v45 = CmIntResource;
  v8 = FxPkgPnp::ValidateCmResource(this, &v46, &v45);
  if ( v8 < 0 )
...
LABEL_6:
  ...
  while ( 1 )
  {
    ...
    if ( v18 )
    {
      ...
      if ( !v22 )
        v23 = 0LL;
      WPP_IFR_SF_qd(m_Globals, 2u, 0xCu, 0x28u, WPP_PnpStateMachine_cpp_Traceguids, v23, -1073741811);
      goto LABEL_7;
    }
LABEL_30:
    Flink = Flink->Flink;
  ...
  if ( p_Blink[34] && v47->PassiveHandling )
  {
  ...
  if ( *((_BYTE *)p_Blink + 258) && v47->CanWakeDevice )
  {
    ...
    v36 = 42;
LABEL_38:
    WPP_IFR_SF_qqq(m_Globals, 4u, 0xCu, v36, WPP_PnpStateMachine_cpp_Traceguids, CmIntResource, v35, v33);
  ...
  if ( (v14->Flags & 2) == 0 )
  {
    ...
    if ( !v28 )
      v29 = 0LL;
    WPP_IFR_SF_qqq(m_Globals, 4u, 0xCu, 0x2Bu, WPP_PnpStateMachine_cpp_Traceguids, CmIntResource, v29, _a3);
    v9 = v46;
    goto LABEL_29;
  }
...
LABEL_29:
  ...
  if ( !v41 )
    v42 = 0LL;
  WPP_IFR_SF_qid(m_Globals, 2u, 0xCu, 0x2Cu, WPP_PnpStateMachine_cpp_Traceguids, CmIntResource, v42, -1073741811);
LABEL_7:
