/*
 * XREFs of ?ConfigureConstraints@FxDeviceBase@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C0021038
 * Callers:
 ...
 *     ??0FxCallbackMutexLock@@QEAA@PEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C001D620 (--0FxCallbackMutexLock@@QEAA@PEAU_FX_DRIVER_GLOBALS@@@Z.c)
 */
...
LABEL_10:
  ...
  else
  {
    ...
    if ( !(_WORD)m_ObjectSize )
      v11 = 0LL;
    WPP_IFR_SF_qd(*p_m_Globals, 2u, 0x14u, 0xAu, WPP_FxDeviceBase_cpp_Traceguids, v11, -1073741670);
  }
  return v7;
}
