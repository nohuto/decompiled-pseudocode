/*
 * XREFs of ?SleepStudyEvaluateParticipation@FxPkgPnp@@QEAAXXZ @ 0x1C002418C
 * Callers:
 ...
 *     ?SleepStudyEvaluateDripsConstraint@FxPkgPnp@@QEAAXE@Z @ 0x1C009D5C8 (-SleepStudyEvaluateDripsConstraint@FxPkgPnp@@QEAAXE@Z.c)
...
LABEL_5:
  ...
  if ( PoolWithTag )
  {
    ...
    if ( _a2 < 0 )
    {
      ...
      if ( !v10 )
        v11 = 0LL;
      WPP_IFR_SF_qd(this->m_Globals, 2u, 0xCu, 0x12u, WPP_FxPkgPnpKM_cpp_Traceguids, v11, _a2);
    }
    else
    {
