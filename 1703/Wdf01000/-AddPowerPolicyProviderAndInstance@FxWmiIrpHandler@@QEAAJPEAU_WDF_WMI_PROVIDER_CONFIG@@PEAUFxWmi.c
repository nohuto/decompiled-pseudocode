/*
 * XREFs of ?AddPowerPolicyProviderAndInstance@FxWmiIrpHandler@@QEAAJPEAU_WDF_WMI_PROVIDER_CONFIG@@PEAUFxWmiInstanceInternalCallbacks@@PEAPEAVFxWmiInstanceInternal@@@Z @ 0x1C00332E8
 * Callers:
...
LABEL_32:
  ...
  Blink = v12->m_ListEntry.Blink;
  if ( Flink->Blink != &v12->m_ListEntry || Blink->Flink != p_m_ListEntry )
    __fastfail(3u);
  Blink->Flink = Flink;
  Flink->Blink = Blink;
