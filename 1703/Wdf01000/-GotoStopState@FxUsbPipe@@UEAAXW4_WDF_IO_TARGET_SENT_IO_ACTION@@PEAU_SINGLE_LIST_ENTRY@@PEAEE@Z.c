/*
 * XREFs of ?GotoStopState@FxUsbPipe@@UEAAXW4_WDF_IO_TARGET_SENT_IO_ACTION@@PEAU_SINGLE_LIST_ENTRY@@PEAEE@Z @ 0x1C008D6B0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int8 LockSelf)
{
  ...
  _WDF_IO_TARGET_SENT_IO_ACTION flags; // ebp
