/*
 * XREFs of ?Release@FxMemoryObject@@UEAAKPEAXJPEBD@Z @ 0x1C0011BE0
 * Callers:
 *     ?Release@FxMemoryObject@@WGI@EAAKPEAXJPEBD@Z @ 0x1C0040580 (-Release@FxMemoryObject@@WGI@EAAKPEAXJPEBD@Z.c)
 * Callees:
...
__int64 __fastcall FxMemoryObject::Release(
        FxMemoryObject *this,
        ...
        const char *File)
{
  ...
  FxObject::ProcessDestroy(this, Tag, Line);
  return 0LL;
}
