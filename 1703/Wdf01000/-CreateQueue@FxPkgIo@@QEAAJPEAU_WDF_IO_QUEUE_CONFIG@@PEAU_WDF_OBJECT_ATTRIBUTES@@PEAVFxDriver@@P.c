/*
 * XREFs of ?CreateQueue@FxPkgIo@@QEAAJPEAU_WDF_IO_QUEUE_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@PEAPEAVFxIoQueue@@@Z @ 0x1C0022700
 * Callers:
        ...
        FxObject **ppQueue)
{
  ...
  if ( QueueAttributes && (ParentObject = QueueAttributes->ParentObject) != 0LL )
  {
    ...
    v45 = FxDeviceBase::_SearchForDevice((unsigned __int64)pParent, 0LL);
    v46 = v45;
    if ( !v45 )
    {
    ...
    if ( v45 != m_DeviceBase )
    {
      ...
      v29 = m_ObjectSize == 0;
      v60 = v46->m_ObjectSize;
      if ( v29 )
        _a3 = 0LL;
      _a2 = (const void *)((unsigned __int64)v46 ^ 0xFFFFFFFFFFFFFFF8uLL);
      if ( !v60 )
        _a2 = 0LL;
      WPP_IFR_SF_qqqd(
        m_Globals,
...
LABEL_88:
  ...
  if ( v18 )
  {
    ...
    *(_QWORD *)&v19[1].FxNonPagedObject::FxObject::m_Type = v19;
    if ( QueueAttributes )
    {
      v49 = QueueAttributes->ContextTypeInfo;
      if ( v49 )
      {
        ContextSize = QueueAttributes->ContextSizeOverride;
        if ( !ContextSize )
          ContextSize = v49->ContextSize;
  ...
  if ( !v20 )
    goto LABEL_122;
  _a1 = FxIoQueue::Initialize(v20, Config, QueueAttributes, v73, PreviousIrql);
  v25 = _a1;
  if ( _a1 < 0 )
  {
...
LABEL_100:
  ...
  {
    v50 = KeAcquireSpinLockRaiseToDpc(&v11->m_SpinLock.m_Lock);
    v11->m_ObjectFlags |= 0x11u;
    KeReleaseSpinLock(&v11->m_SpinLock.m_Lock, v50);
  ...
  else if ( QueueAttributes && (p_m_ExecutionLevel = (_FX_DRIVER_GLOBALS *)QueueAttributes->ParentObject) != 0LL )
  {
...
LABEL_35:
  ...
  if ( v35 )
    ...
    v37 = 0;
  if ( SLOBYTE(this->m_ObjectFlags) < 0 && (v65 = (FxVerifierLock *)this[-1].m_DispatchTable[27]) != 0LL )
  {
  ...
  for ( i = this->m_IoQueueListHead.Blink; i != p_m_IoQueueListHead; i = i->Blink )
  {
    if ( LODWORD(i[1].Flink) == 1 )
    {
      v54 = i[-34].Flink;
      if ( v54 )
        LOBYTE(v54) = v54[5].Blink;
      if ( (_BYTE)v54 == v37 || (char)v54 < v37 )
        break;
    }
  }
  v41 = i->Flink;
  ...
  if ( SLOBYTE(this->m_ObjectFlags) < 0 && (v66 = (FxVerifierLock *)this[-1].m_DispatchTable[27]) != 0LL )
