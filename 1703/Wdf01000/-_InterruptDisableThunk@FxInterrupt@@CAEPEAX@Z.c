/*
 * XREFs of ?_InterruptDisableThunk@FxInterrupt@@CAEPEAX@Z @ 0x1C0014590
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall FxInterrupt::_InterruptDisableThunk(_DWORD *SyncContext, _FX_DRIVER_GLOBALS *a2)
{
  ...
  if ( *(_BYTE *)(*(_QWORD *)SyncContext + 258LL) )
  {
    ...
    if ( !*(_WORD *)(v2 + 10) )
      v13 = 0LL;
    v8 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(v2 + 320))(v13, v12);
  ...
  else
  {
    ...
    if ( !*(_WORD *)(v2 + 10) )
      v7 = 0LL;
    v8 = (*(__int64 (__fastcall **)(unsigned __int64, unsigned __int64))(v2 + 320))(v7, v6);
  }
  result = 1;
  SyncContext[2] = v8;
  return result;
