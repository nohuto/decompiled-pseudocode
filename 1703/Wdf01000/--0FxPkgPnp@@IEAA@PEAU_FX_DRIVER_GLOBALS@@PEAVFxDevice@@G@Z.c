/*
 * XREFs of ??0FxPkgPnp@@IEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxDevice@@G@Z @ 0x1C0027720
 * Callers:
  ...
  *(_DWORD *)&this->m_ObjectFlags = 0x10000;
  ...
  if ( SLOBYTE(this->m_ObjectFlags) < 0 )
  {
    ...
    if ( v10->FxVerifierLock )
    {
      ...
      this[-1].m_DeviceSurpriseRemoval.__vftable = (FxPnpDeviceSurpriseRemoval_vtbl *)VerifierLock;
    }
  }
