/*
 * XREFs of ??0FxPowerPolicyOwnerSettings@@QEAA@PEAVFxPkgPnp@@@Z @ 0x1C00369C0
 * Callers:
        ...
        FxPkgPnp *PkgPnp)
{
  ...
  this->m_PowerIdleMachine.m_D0NotificationEvent.m_Event.m_DbgFlagIsInitialized = 0;
  KeInitializeEvent(&this->m_PowerIdleMachine.m_D0NotificationEvent.m_Event.m_Event, SynchronizationEvent, 0);
