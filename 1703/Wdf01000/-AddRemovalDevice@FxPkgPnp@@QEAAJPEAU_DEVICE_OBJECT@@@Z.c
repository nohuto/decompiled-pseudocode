/*
 * XREFs of ?AddRemovalDevice@FxPkgPnp@@QEAAJPEAU_DEVICE_OBJECT@@@Z @ 0x1C009A6E0
 * Callers:
 ...
 *     ?Add@FxTransactionedList@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAUFxTransactionedEntry@@@Z @ 0x1C002CA1C (-Add@FxTransactionedList@@QEAAJPEAU_FX_DRIVER_GLOBALS@@PEAUFxTransactionedEntry@@@Z.c)
...
LABEL_10:
    ...
    else
    {
      ...
      if ( !m_ObjectSize )
        v12 = 0LL;
      WPP_IFR_SF_qd(this->m_Globals, 2u, 0xCu, 0x46u, WPP_FxPkgPnp_cpp_Traceguids, v12, -1073741670);
    }
  ...
  if ( !v16 )
    return 3221225626LL;
  v17 = FxTransactionedList::Add(this->m_RemovalDeviceList, this->m_Globals, (FxTransactionedEntry *)(v16 + 104));
  if ( v17 < 0 )
