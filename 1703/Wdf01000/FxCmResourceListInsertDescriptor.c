/*
 * XREFs of FxCmResourceListInsertDescriptor @ 0x1C0082C0C
 * Callers:
 *     imp_WdfCmResourceListAppendDescriptor @ 0x1C0082EF0 (imp_WdfCmResourceListAppendDescriptor.c)
 *     imp_WdfCmResourceListInsertDescriptor @ 0x1C0082F00 (imp_WdfCmResourceListInsertDescriptor.c)
 * Callees:
