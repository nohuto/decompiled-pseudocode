/*
 * XREFs of ?PutScatterGatherList@FxDmaScatterGatherTransaction@@AEAAXPEAU_SCATTER_GATHER_LIST@@@Z @ 0x1C006D034
 * Callers:
 *     ?ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z @ 0x1C006D0A0 (-ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z.c)
 *     ?TransferCompleted@FxDmaScatterGatherTransaction@@UEAAJXZ @ 0x1C006D360 (-TransferCompleted@FxDmaScatterGatherTransaction@@UEAAJXZ.c)
 * Callees:
 *     <none>
 */
