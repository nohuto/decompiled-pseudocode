/*
 * XREFs of FxRegisterBugCheckCallback @ 0x1C001AFA0
 * Callers:
 *     FxInitialize @ 0x1C0019B00 (FxInitialize.c)
 * Callees:
 *     ?Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C001B088 (-Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z.c)
