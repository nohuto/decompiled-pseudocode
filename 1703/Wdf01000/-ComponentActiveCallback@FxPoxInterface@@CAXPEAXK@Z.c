/*
 * XREFs of ?ComponentActiveCallback@FxPoxInterface@@CAXPEAXK@Z @ 0x1C0015160
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxPoxInterface::ComponentActiveCallback(FxPoxInterface *Context, unsigned int Component)
{
  ...
  if ( PowerFrameworkSettings && PowerFrameworkSettings->ComponentActiveConditionCallback )
  {
    ...
    if ( v13->FxVerboseOn )
    {
      ...
      if ( !v16 )
        v17 = 0LL;
      WPP_IFR_SF_qq(v13, 5u, 0xCu, 0xDu, WPP_PoxInterfaceKm_cpp_Traceguids, v17, m_DeviceObject);
    }
