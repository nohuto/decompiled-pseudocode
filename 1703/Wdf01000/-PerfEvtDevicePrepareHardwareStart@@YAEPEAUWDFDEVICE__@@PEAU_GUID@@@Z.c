/*
 * XREFs of ?PerfEvtDevicePrepareHardwareStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x1C00757D4
 * Callers:
...
bool __fastcall PerfEvtDevicePrepareHardwareStart(unsigned __int64 Handle, _GUID *pActivityId)
{
