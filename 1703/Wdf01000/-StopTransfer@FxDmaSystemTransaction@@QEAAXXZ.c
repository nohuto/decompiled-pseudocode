/*
 * XREFs of ?StopTransfer@FxDmaSystemTransaction@@QEAAXXZ @ 0x1C006DAF0
 * Callers:
 ...
 *     ?CancelMappedTransfer@FxDmaSystemTransaction@@IEAAEXZ @ 0x1C006D838 (-CancelMappedTransfer@FxDmaSystemTransaction@@IEAAEXZ.c)
