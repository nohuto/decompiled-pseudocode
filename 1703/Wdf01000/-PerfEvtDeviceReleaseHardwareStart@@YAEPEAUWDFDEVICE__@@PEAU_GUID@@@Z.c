/*
 * XREFs of ?PerfEvtDeviceReleaseHardwareStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x1C0075874
 * Callers:
...
bool __fastcall PerfEvtDeviceReleaseHardwareStart(unsigned __int64 Handle, _GUID *pActivityId)
{
