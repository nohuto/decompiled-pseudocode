/*
 * XREFs of ?Clone@FxDeviceDescriptionEntry@@QEAAPEAU1@PEAU_LIST_ENTRY@@@Z @ 0x1C0070C04
 * Callers:
...
{
  FxDeviceDescriptionEntry *v4; // rax
  __int64 v5; // rax
  __int64 v6; // rbx
  int v8; // eax
  ...
  v4 = (FxDeviceDescriptionEntry *)FxDeviceDescriptionEntry::operator new(
