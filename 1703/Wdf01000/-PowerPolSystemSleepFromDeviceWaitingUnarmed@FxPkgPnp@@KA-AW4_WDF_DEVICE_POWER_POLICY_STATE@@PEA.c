/*
 * XREFs of ?PowerPolSystemSleepFromDeviceWaitingUnarmed@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C0012900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::PowerPolSystemSleepFromDeviceWaitingUnarmed(FxPkgPnp *This)
{
  ...
  if ( !FxPkgPnp::PowerPolicyIsWakeEnabled(This) )
    return 1324LL;
  result = 1293LL;
  if ( ((*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v1 + 1240) + 184LL) + 8LL) >> 8) & 0xFu) > *(unsigned __int8 *)(v1 + 1009) )
    return 1324LL;
  return result;
}
