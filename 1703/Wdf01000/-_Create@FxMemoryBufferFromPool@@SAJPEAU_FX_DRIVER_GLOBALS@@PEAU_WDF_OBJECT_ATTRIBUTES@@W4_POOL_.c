/*
 * XREFs of ?_Create@FxMemoryBufferFromPool@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@W4_POOL_TYPE@@K_KPEAPEAVFxMemoryObject@@@Z @ 0x1C0015CEC
 * Callers:
...
LABEL_6:
      ...
      v14->IFxMemory::__vftable = (IFxMemory_vtbl *)(&FxObject::`vftable'.Public + 1);
      goto LABEL_7;
    }
  }
  else if ( v13 )
