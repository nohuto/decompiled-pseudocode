/*
 * XREFs of USBD_CreateHandle @ 0x1C00A2114
 * Callers:
 ...
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C00A1B30 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
...
LABEL_59:
  ...
  if ( USBDHandle )
  {
    ...
    *((_DWORD *)v12 + 43) = 1;
    ...
    {
      v14 = BYTE4(WPP_GLOBAL_WDF_Control.DeviceQueue.DeviceListHead.Blink) == 0;
      *((_DWORD *)v12 + 42) = 1536;
      if ( !v14 )
        DbgPrintEx(
          0x4Du,
