/*
 * XREFs of ?AssignResources@FxInterrupt@@QEAAXPEAU_CM_PARTIAL_RESOURCE_DESCRIPTOR@@0@Z @ 0x1C0018674
 * Callers:
        ...
        _CM_PARTIAL_RESOURCE_DESCRIPTOR *CmDescTrans)
{
  ...
  if ( v6 != Latched || (v7 = v9 == 0, v10 = 1, !v7) )
    v10 = 0;
  this->m_IsEdgeTriggeredNonMsiInterrupt = v10;
  if ( this->m_InterruptInfo.MessageSignaled && CmDescRaw->u.MessageInterrupt.Raw.MessageCount > 1u )
  {
    v11 = 8LL;
  ...
  else
  {
    ...
    if ( this->m_InterruptInfo.MessageSignaled )
    {
      v11 = 4LL;
    }
    else
