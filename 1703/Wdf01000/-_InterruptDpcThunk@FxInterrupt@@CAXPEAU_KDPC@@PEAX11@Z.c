/*
 * XREFs of ?_InterruptDpcThunk@FxInterrupt@@CAXPEAU_KDPC@@PEAX11@Z @ 0x1C00049E0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *SystemArgument2)
{
  ...
  else
  {
    ...
    if ( v8 )
    {
      ...
      v14 = *(_WORD *)(v12 + 10);
      v15 = v12 ^ 0xFFFFFFFFFFFFFFF8uLL;
      if ( !v14 )
        v15 = 0LL;
      if ( !*(_WORD *)(DeferredContext + 10) )
        v13 = 0LL;
      (*(void (__fastcall **)(unsigned __int64, unsigned __int64))(DeferredContext + 336))(v13, v15);
