/*
 * XREFs of Template_pp @ 0x1C0075A80
 * Callers:
 *     ?PerfEvtDeviceD0EntryStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x1C0075694 (-PerfEvtDeviceD0EntryStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z.c)
 ...
 *     ?PerfEvtDeviceReleaseHardwareStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z @ 0x1C0075874 (-PerfEvtDeviceReleaseHardwareStart@@YAEPEAUWDFDEVICE__@@PEAU_GUID@@@Z.c)
        ...
        const void *RegHandle)
{
  ...
  return EtwWrite((REGHANDLE)WPP_GLOBAL_WDF_Control.Queue.ListEntry.Flink, Activity, _Arg0, 2u, EventData);
}
