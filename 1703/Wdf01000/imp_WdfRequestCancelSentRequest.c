/*
 * XREFs of imp_WdfRequestCancelSentRequest @ 0x1C0032CC0
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall imp_WdfRequestCancelSentRequest(_WDF_DRIVER_GLOBALS *DriverGlobals, WDFREQUEST__ *Request)
{
  FxRequest *v3; // rcx
