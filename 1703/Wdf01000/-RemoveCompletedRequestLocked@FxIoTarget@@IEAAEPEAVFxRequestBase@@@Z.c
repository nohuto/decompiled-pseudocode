/*
 * XREFs of ?RemoveCompletedRequestLocked@FxIoTarget@@IEAAEPEAVFxRequestBase@@@Z @ 0x1C0010000
 * Callers:
...
unsigned __int8 __fastcall FxIoTarget::RemoveCompletedRequestLocked(FxIoTarget *this, FxRequestBase *Request)
{
  ...
  $4F60D2EEAF443BADC51864A01D9AEC36 *v6; // rax
  _IRP *Irp; // rcx
  ...
  if ( ($4F60D2EEAF443BADC51864A01D9AEC36 *)Flink->Blink != &Request->120
    || *($4F60D2EEAF443BADC51864A01D9AEC36 **)&Irp->Type != v6 )
  {
    __fastfail(3u);
  }
