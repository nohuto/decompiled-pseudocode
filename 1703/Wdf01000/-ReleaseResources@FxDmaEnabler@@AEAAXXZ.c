/*
 * XREFs of ?ReleaseResources@FxDmaEnabler@@AEAAXXZ @ 0x1C006A40C
 * Callers:
 ...
 *     ?Dispose@FxDmaEnabler@@UEAAEXZ @ 0x1C006A2F0 (-Dispose@FxDmaEnabler@@UEAAEXZ.c)
 * Callees:
 *     ?FreeResources@FxDmaEnabler@@AEAAXPEAU_FxDmaDescription@@@Z @ 0x1C006A32C (-FreeResources@FxDmaEnabler@@AEAAXPEAU_FxDmaDescription@@@Z.c)
 */
