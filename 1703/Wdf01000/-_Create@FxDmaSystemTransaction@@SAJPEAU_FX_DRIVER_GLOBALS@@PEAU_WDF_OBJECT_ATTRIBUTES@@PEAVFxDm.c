/*
 * XREFs of ?_Create@FxDmaSystemTransaction@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDmaEnabler@@PEAPEAUWDFDMATRANSACTION__@@@Z @ 0x1C006DBB0
 * Callers:
        ...
        WDFDMATRANSACTION__ **Transaction)
{
  ...
  $1E5498178E6BFFD2FD5346FC9D35457C *v11; // rax
