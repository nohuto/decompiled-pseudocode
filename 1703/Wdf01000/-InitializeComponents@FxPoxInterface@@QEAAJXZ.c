/*
 * XREFs of ?InitializeComponents@FxPoxInterface@@QEAAJXZ @ 0x1C002DDF8
 * Callers:
...
__int64 __fastcall FxPoxInterface::InitializeComponents(FxPoxInterface *this)
{
    ...
    || (_a3 = FxPoxInterface::CreateDevicePowerRequirementMachine(this), _a3 >= 0) )
  {
    ...
    if ( _a3 < 0 )
    {
      ...
      if ( !m_ObjectSize )
        _a1 = 0LL;
      WPP_IFR_SF_qid(m_Globals, 2u, 0xCu, 0xDu, WPP_PoxInterface_cpp_Traceguids, _a1, _a2, _a3);
    }
    else
    {
      ...
      if ( _a3 < 0 )
      {
        ...
        v18 = v16->m_Globals;
        m_DeviceObject = (__int64)v17->m_DeviceObject.m_DeviceObject;
        v20 = v17->m_ObjectSize;
        v21 = (const void *)((unsigned __int64)v17 ^ 0xFFFFFFFFFFFFFFF8uLL);
        if ( !v20 )
          v21 = 0LL;
        WPP_IFR_SF_qid(v18, 2u, 0xCu, 0xEu, WPP_PoxInterface_cpp_Traceguids, v21, m_DeviceObject, _a3);
