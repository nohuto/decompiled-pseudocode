/*
 * XREFs of ?HandleQueryCapabilities@FxPkgPdo@@AEAAXPEAU_DEVICE_CAPABILITIES@@0@Z @ 0x1C002B780
 * Callers:
        ...
        _DEVICE_CAPABILITIES *ParentCaps)
{
  ...
  if ( SLOBYTE(this->m_ObjectFlags) < 0 && (v28 = this[-1].m_ContainerID) != 0LL )
    FxVerifierLock::Unlock((FxVerifierLock *)v28, v12, v13);
  else
