/*
 * XREFs of ?Start@FxIoTarget@@UEAAJXZ @ 0x1C00883C0
 * Callers:
 *     ?Start@FxUsbDevice@@MEAAJXZ @ 0x1C0090AF0 (-Start@FxUsbDevice@@MEAAJXZ.c)
 * Callees:
 *     WPP_IFR_SF_qd @ 0x1C0017050 (WPP_IFR_SF_qd.c)
 *     ?SubmitPendedRequests@FxIoTarget@@IEAAXPEAU_LIST_ENTRY@@@Z @ 0x1C0066FFC (-SubmitPendedRequests@FxIoTarget@@IEAAXPEAU_LIST_ENTRY@@@Z.c)
 */
