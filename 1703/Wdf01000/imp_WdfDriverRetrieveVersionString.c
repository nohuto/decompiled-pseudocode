/*
 * XREFs of imp_WdfDriverRetrieveVersionString @ 0x1C007A7F0
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFSTRING__ *String)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    v6 = pString;
    v7 = L"Kernel Mode Driver Framework (verifier on) version 01.021.0";
    if ( !m_Globals->FxVerifierOn )
      v7 = L"Kernel Mode Driver Framework version 01.021.0";
