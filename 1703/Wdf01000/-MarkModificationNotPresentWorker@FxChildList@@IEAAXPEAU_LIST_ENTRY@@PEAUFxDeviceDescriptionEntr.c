/*
 * XREFs of ?MarkModificationNotPresentWorker@FxChildList@@IEAAXPEAU_LIST_ENTRY@@PEAUFxDeviceDescriptionEntry@@@Z @ 0x1C0071384
 * Callers:
        ...
        FxDeviceDescriptionEntry *ModificationEntry)
{
  ...
  if ( v5 )
  {
    if ( v5 == 3 )
    {
      ...
      if ( Flink->Blink != &ModificationEntry->m_ModificationLink || Blink->Flink != p_m_ModificationLink )
        __fastfail(3u);
      Blink->Flink = Flink;
      Flink->Blink = Blink;
  ...
  else
  {
    ...
    v11 = ModificationEntry->m_ModificationLink.Blink;
    if ( v10->Blink != &ModificationEntry->m_ModificationLink || v11->Flink != v9 )
      __fastfail(3u);
    v11->Flink = v10;
    v10->Blink = v11;
    ModificationEntry->m_ModificationLink.Blink = &ModificationEntry->m_ModificationLink;
