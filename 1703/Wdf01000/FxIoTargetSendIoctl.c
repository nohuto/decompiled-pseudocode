/*
 * XREFs of FxIoTargetSendIoctl @ 0x1C00287A0
 * Callers:
 *     imp_WdfIoTargetSendIoctlSynchronously @ 0x1C0028740 (imp_WdfIoTargetSendIoctlSynchronously.c)
 *     imp_WdfIoTargetSendInternalIoctlSynchronously @ 0x1C0087140 (imp_WdfIoTargetSendInternalIoctlSynchronously.c)
 * Callees:
...
LABEL_81:
  ...
  else
  {
    ...
    v21 = FxIoTarget::SubmitSync(pTarget, p_ParentObject, v16, 0LL);
