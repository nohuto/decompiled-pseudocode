/*
 * XREFs of ?Send2FingerTap@CPTPEngine@@AEAAXPEAUPTPInput@@K@Z @ 0x1C0137BC8
 * Callers:
...
void __fastcall CPTPEngine::Send2FingerTap(CPTPEngine *this, struct PTPInput *a2, unsigned int a3)
{
  ...
  *((_QWORD *)this + 397) = *(_QWORD *)a2;
  CBasePTPEngine::SendMouseOutput(this, 3LL, *(_QWORD *)((char *)a2 + 28), a3);
  CBasePTPEngine::SendMouseOutput(this, 4LL, *(_QWORD *)((char *)a2 + 28), *((unsigned int *)a2 + 6));
  LODWORD(v5) = 2;
  v8 = v6;
  v7 = v5;
