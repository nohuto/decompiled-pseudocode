/*
 * XREFs of Template_xqxq @ 0x1C00FD5C8
 * Callers:
 *     EtwPhysicalSurfCreateEvent @ 0x1C0081DA0 (EtwPhysicalSurfCreateEvent.c)
 * Callees:
 *     __security_check_cookie @ 0x1C009D0D0 (__security_check_cookie.c)
 */

NTSTATUS Template_xqxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v9, va3);
  v10 = 4LL;
  return EtwWrite(Microsoft_Windows_Win32kHandle, &PhysicalSurfCreateEvent, &W32kControlGuid, 4u, &UserData);
}
