/*
 * XREFs of ?EmitAddExpressionResources@CKeyframeAnimationMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0020420
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  for ( ; *((_DWORD *)this + 45) < *((_DWORD *)this + 44); *((_DWORD *)this + 45) += v6 )
  {
    ...
    v6 = (v5 - 16) >> 2;
    if ( (unsigned int)(*((_DWORD *)this + 44) - *((_DWORD *)this + 45)) < v6 )
      LODWORD(v6) = *((_DWORD *)this + 44) - *((_DWORD *)this + 45);
    ...
    *((_DWORD *)v7 + 2) = *((_DWORD *)this + 6);
    ...
    {
      v10 = v8 + *((_DWORD *)this + 45);
      ++v8;
      *v9 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 21) + 8 * v10) + 24LL);
    }
  }
  return *((_DWORD *)this + 45) == *((_DWORD *)this + 44);
}
