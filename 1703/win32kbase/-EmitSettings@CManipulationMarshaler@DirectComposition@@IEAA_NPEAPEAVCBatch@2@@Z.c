/*
 * XREFs of ?EmitSettings@CManipulationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0142F28
 * Callers:
  ...
  if ( (*((_DWORD *)this + 4) & 0x20) != 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x28uLL, &v7) )
    {
      ...
      *v5 = 227;
      v5[1] = *((_DWORD *)this + 6);
      v5[2] = *((_DWORD *)this + 20);
      v5[3] = *((_BYTE *)this + 84) & 1;
      v5[4] = (*((unsigned __int8 *)this + 84) >> 1) & 1;
      v5[5] = (*((unsigned __int8 *)this + 84) >> 2) & 1;
      v5[6] = (*((unsigned __int8 *)this + 84) >> 3) & 1;
      v5[7] = (*((unsigned __int8 *)this + 84) >> 4) & 1;
      v5[8] = (*((unsigned __int8 *)this + 84) >> 5) & 1;
      *((_DWORD *)this + 4) &= ~0x20u;
    }
    else
    {
