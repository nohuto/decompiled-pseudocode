/*
 * XREFs of ?ReferenceSystemResource@CConnection@DirectComposition@@QEAAXVResourceHandle@@@Z @ 0x1C00149CC
 * Callers:
...
__int64 __fastcall DirectComposition::CConnection::ReferenceSystemResource(__int64 a1, int a2)
{
  ...
  if ( a2 && v6 < v5[19] )
    v7 = *(DirectComposition::CResourceMarshaler **)(v6 * v5[20] + v5[16]);
  else
    v7 = 0LL;
