/*
 * XREFs of ?EnsureAlpcCallbackRegistered@ServerPorts@CoreMessagingK@@CAJXZ @ 0x1C006A01C
 * Callers:
...
__int64 CoreMessagingK::ServerPorts::EnsureAlpcCallbackRegistered(void)
{
  ...
  *(_OWORD *)&v2.SecurityDescriptor = 0LL;
  v0 = ExCreateCallback((PCALLBACK_OBJECT *)&CoreMessagingK::ServerPorts::s_CallbackObject, &v2, 1u, 0);
  if ( v0 >= 0 )
  {
