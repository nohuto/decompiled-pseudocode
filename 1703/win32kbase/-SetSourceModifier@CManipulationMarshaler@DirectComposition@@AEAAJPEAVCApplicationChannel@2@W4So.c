/*
 * XREFs of ?SetSourceModifier@CManipulationMarshaler@DirectComposition@@AEAAJPEAVCApplicationChannel@2@W4SourceModifierIndex@@PEAVCConditionalExpressionMarshaler@2@PEA_N@Z @ 0x1C0143508
 * Callers:
  ...
  if ( a4 == v10 )
  {
    if ( v9 && !v10 )
    {
      DirectComposition::CApplicationChannel::ReleaseWeakReference(
        a2,
        *(struct DirectComposition::CWeakReferenceBase **)(a1 + 8LL * a3 + 40));
      *(_QWORD *)(a1 + 8 * v5 + 40) = 0LL;
    }
  }
  else
  {
