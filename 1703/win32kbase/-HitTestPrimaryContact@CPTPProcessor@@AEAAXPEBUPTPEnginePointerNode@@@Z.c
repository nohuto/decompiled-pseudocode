/*
 * XREFs of ?HitTestPrimaryContact@CPTPProcessor@@AEAAXPEBUPTPEnginePointerNode@@@Z @ 0x1C012B34C
 * Callers:
...
void __fastcall CPTPProcessor::HitTestPrimaryContact(CPTPProcessor *this, const struct PTPEnginePointerNode *a2)
{
  ...
  CHitTestState::Set((CPTPProcessor *)((char *)this + 528), (const struct CInputDest *)v26, v21 != 0, v22[0]);
  *((_QWORD *)this + 92) = *((_QWORD *)a2 + 10);
  *((_QWORD *)this + 93) = *((_QWORD *)a2 + 4);
