/*
 * XREFs of ?SetReferenceProperty@CCompositionPointLightMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01499E0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  ...
  if ( this == (DirectComposition::CCompositionPointLightMarshaler *)-88LL
    || a4
