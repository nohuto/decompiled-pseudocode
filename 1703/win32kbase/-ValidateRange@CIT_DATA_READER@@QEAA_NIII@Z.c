/*
 * XREFs of ?ValidateRange@CIT_DATA_READER@@QEAA_NIII@Z @ 0x1C0156598
 * Callers:
 ...
 *     ?ValidateString@CIT_DATA_READER@@QEAA_NPEAPEBGII@Z @ 0x1C01565C8 (-ValidateString@CIT_DATA_READER@@QEAA_NPEAPEBGII@Z.c)
 * Callees:
 *     <none>
 */
