/*
 * XREFs of ?EmitAddConditionAnimationResources@CConditionalExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0148A50
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 29) < *((_DWORD *)this + 28); *((_DWORD *)this + 29) += 2 * v6 )
  {
    ...
    *((_DWORD *)v7 + 2) = *((_DWORD *)this + 6);
    for ( *((_DWORD *)v7 + 3) = v6;
          v8 < v6;
          *(v9 - 1) = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 13)
                                            + 8LL * (unsigned int)(v10 + *((_DWORD *)this + 29) + 1))
                                + 24LL) )
    {
      v10 = 2 * v8++;
      *v9 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 13) + 8LL * (unsigned int)(v10 + *((_DWORD *)this + 29))) + 24LL);
      v9 += 2;
    }
  }
  return *((_DWORD *)this + 29) == *((_DWORD *)this + 28);
