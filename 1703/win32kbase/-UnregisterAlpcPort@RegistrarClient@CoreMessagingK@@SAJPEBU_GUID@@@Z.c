/*
 * XREFs of ?UnregisterAlpcPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@@Z @ 0x1C00696EC
 * Callers:
...
__int64 __fastcall CoreMessagingK::RegistrarClient::UnregisterAlpcPort(const struct _GUID *a1)
{
  ...
  char v10[16]; // [rsp+50h] [rbp-19h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+60h] [rbp-9h] BYREF
  const struct _GUID *v12; // [rsp+80h] [rbp+17h]
  ...
  *(struct _GUID *)v10 = v1;
  v3 = CoreUICallSend((struct IMessageCallSendHost *)&v9, 14, (unsigned __int8 *)&byte_1C0161961, (char)v10);
  if ( v3 < 0 )
  {
  ...
  if ( dword_1C0186C30 > 5u )
  {
    ...
    v12 = a1;
    v13 = 16;
    TlgWrite((TraceLoggingHProvider)&dword_1C0186C30, &unk_1C016BE6B, 0LL, v5, 4u, &pData);
  }
  return v6;
}
