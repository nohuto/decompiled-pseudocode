/*
 * XREFs of ?CitpUpdateBootStats@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C00854DC
 * Callers:
...
LABEL_14:
  if ( (int)CitpUpdateActiveBootId(v2, 1u, &v24, &v23, v22) >= 0 )
  {
    v13 = v23;
    if ( v23 )
    {
      ...
      if ( v24 )
      {
        if ( v24 != v13 )
        {
          ...
          CitpStatIncrement((unsigned __int16 *)a1 + 323, v20);
          CitpStatIncrement((unsigned __int16 *)a1 + 427, v21);
