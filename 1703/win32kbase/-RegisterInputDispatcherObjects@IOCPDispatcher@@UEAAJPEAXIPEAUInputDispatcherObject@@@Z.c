/*
 * XREFs of ?RegisterInputDispatcherObjects@IOCPDispatcher@@UEAAJPEAXIPEAUInputDispatcherObject@@@Z @ 0x1C004CA90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct InputDispatcherObject *a4)
{
  ...
  if ( a3 )
  {
    ...
    while ( 1 )
    {
      ...
      v17 = v11;
      v12 = 5 * v11;
      v13 = IOCPDispatcher::SetupIOCPForDispatcherHandle((__int64)this, 0LL, v10, 0, (__int64)&v16);
      if ( !v13 )
        break;
