/*
 * XREFs of ?SetResourceDeletedNotificationTag@CApplicationChannel@DirectComposition@@QEAAJI_K@Z @ 0x1C001AC04
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( v6 >= 0 && v5[5] == 1 && (*(unsigned __int8 (__fastcall **)(_DWORD *))(*(_QWORD *)v5 + 48LL))(v5) )
    (*(void (__fastcall **)(_DWORD *, char *))(*(_QWORD *)v5 + 40LL))(v5, (char *)this + 488);
