/*
 * XREFs of NtDCompositionSubmitDWMBatch @ 0x1C001D8B0
 * Callers:
 *     <none>
 * Callees:
        ...
        *((_QWORD *)BatchFragment + 8) = 0LL;
              ...
              (_DWORD)v25) )
        {
          ...
          *((_QWORD *)BatchFragment + 3) = *(_QWORD *)BatchFragment;
          ...
          KeSetEvent(*(PRKEVENT *)(v27[5].Region + 8), 1, 0);
        }
        else
        {
        ...
        if ( *(_QWORD *)(v6 + 376) )
        {
          ExReleaseResourceLite(*(PERESOURCE *)(v6 + 384));
          KeLeaveCriticalRegion();
        }
