/*
 * XREFs of ?Create@CSharedWriteRemotingRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C014FDBC
 * Callers:
 *     CreateSharedWriteRemotingRenderTargetMarshaler @ 0x1C014FF60 (CreateSharedWriteRemotingRenderTargetMarshaler.c)
 * Callees:
