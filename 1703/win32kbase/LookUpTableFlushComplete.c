/*
 * XREFs of LookUpTableFlushComplete @ 0x1C01BD3B4
 * Callers:
 *     TlgAggregateInternalProviderCallback @ 0x1C01BD090 (TlgAggregateInternalProviderCallback.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C0156C74 (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C01BE204 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 344) )
    {
      if ( dword_1C0186C70 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0186C70, 0x400000000000uLL) )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C0186C70, &unk_1C016C072, 0LL, v6, 0xBu, &pData);
      }
