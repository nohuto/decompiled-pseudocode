/*
 * XREFs of ?EmitAppendSurfaceResources@CPrimitiveGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0024DD0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  for ( ; *((_DWORD *)this + 21) < *((_DWORD *)this + 20); *((_DWORD *)this + 21) += v5 )
  {
    ...
    v5 = (v4 - 16) >> 2;
    if ( (unsigned int)(*((_DWORD *)this + 20) - *((_DWORD *)this + 21)) < v5 )
      LODWORD(v5) = *((_DWORD *)this + 20) - *((_DWORD *)this + 21);
