/*
 * XREFs of ?wil_details_ModifyFeatureData@@YAHPEATwil_details_FeaturePropertyCache@@P6AH0PEAX@Z1@Z @ 0x1C00D5CC4
 * Callers:
        ...
        void *a3)
{
  ...
  while ( 1 )
  {
    LODWORD(v7) = Feature_BrokeredDisplays_RotMgr__private_propertyCache;
    v5 = Feature_BrokeredDisplays_RotMgr__private_propertyCache;
    if ( !a2(&v7, a3) )
      break;
    if ( v5 == _InterlockedCompareExchange(
                 (volatile signed __int32 *)&Feature_BrokeredDisplays_RotMgr__private_propertyCache,
                 (signed __int32)v7,
                 v5) )
      return 1LL;
  }
