/*
 * XREFs of GetMonitorPhysicalDimensions @ 0x1C0062D40
 * Callers:
 ...
 * Callees:
 *     GetRegEDID @ 0x1C0060AD0 (GetRegEDID.c)
...
LABEL_15:
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(v13 + 20LL * v12) & 3) != 3
      || (int)((__int64 (__fastcall *)(__int64, _QWORD, PVOID *, struct _DEVICE_OBJECT **))qword_1C018BB90)(
                v13 + 4 * (5LL * v12 + 2),
