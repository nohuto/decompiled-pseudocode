/*
 * XREFs of ?CitpDPDataSave@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0085230
 * Callers:
...
NTSTATUS __fastcall CitpDPDataSave(struct _CIT_IMPACT_CONTEXT *a1)
{
  ...
  *((_DWORD *)a1 + 216) = ((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24)
                        - *((_DWORD *)a1 + 234);
  *((_QWORD *)a1 + 109) = v4;
  *((_DWORD *)a1 + 215) = v3;
  if ( !v1 )
  ...
  result = ZwSetValueKey(v1, &DestinationString, 0, 3u, Data, 0x58u);
  if ( result >= 0 )
    return 0;
  return result;
}
