/*
 * XREFs of RIMComputeSpecificHighMetricValue @ 0x1C008A0DC
 * Callers:
 ...
 * Callees:
 *     RIMComputePower @ 0x1C008A1A8 (RIMComputePower.c)
 */
...
__int64 __fastcall RIMComputeSpecificHighMetricValue(int a1, __int64 a2)
{
  ...
  if ( (unsigned int)v6 < 5 )
  {
    ...
    if ( (unsigned int)(v7 - 1) <= 1 )
    {
      ...
      if ( v3 < 0xB )
      {
        v9 = RIMComputePower(word_1C0164878[2 * v3 + 1]);
        if ( v11 >= 0 )
        {
          v4 = v10 * v9 * v8;
        }
