/*
 * XREFs of RIMPopulatePointerDevice @ 0x1C01068DC
 * Callers:
...
__int64 __fastcall RIMPopulatePointerDevice(__int64 a1, __int64 a2, struct _HIDP_PREPARSED_DATA *a3, __int16 *a4)
{
  ...
  if ( !v13 )
    return 0LL;
  v38 = rimHidP_GetSpecificValueCaps(HidP_Input, 0, *(_WORD *)(a2 + 708), 0, v13, &v46, v5);
  v14 = v38;
  if ( v38 >= 0 )
  {
    v15 = 0;
    ...
    if ( v46 )
    {
      do
      {
        ...
        {
          v19 = 60LL * v16;
          *(_WORD *)(v19 + a2 + 328) = v13[v15].UsagePage;
          *(_WORD *)(v19 + a2 + 340) = v13[v15].Range.UsageMin;
          *(_DWORD *)(v19 + a2 + 332) = v13[v15].ReportID;
          *(_WORD *)(v19 + a2 + 338) = v13[v15].LinkUsagePage;
          *(_DWORD *)(v19 + a2 + 344) = v13[v15].HasNull;
          *(_DWORD *)(60 * (v16 + 6LL) + a2) = v13[v15].LogicalMin;
          *(_DWORD *)(v19 + a2 + 364) = v13[v15].LogicalMax;
          *(_DWORD *)(v19 + a2 + 368) = v13[v15].PhysicalMin;
          *(_DWORD *)(v19 + a2 + 372) = v13[v15].PhysicalMax;
          *(_WORD *)(v19 + a2 + 384) = v13[v15].BitSize;
          if ( (*(_DWORD *)(a2 + 260) & 0x10000) != 0 )
          {
