/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C014F840
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C014FA40 (CreateSharedReadScalarMarshaler.c)
 * Callees:
