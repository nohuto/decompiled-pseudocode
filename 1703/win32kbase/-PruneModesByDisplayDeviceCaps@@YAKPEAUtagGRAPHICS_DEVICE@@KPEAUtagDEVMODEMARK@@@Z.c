/*
 * XREFs of ?PruneModesByDisplayDeviceCaps@@YAKPEAUtagGRAPHICS_DEVICE@@KPEAUtagDEVMODEMARK@@@Z @ 0x1C00605BC
 * Callers:
 ...
 *     ?PruneMode@@YAHPEAU_devicemodeW@@PEAUtagModeCap@@HPEAU_FREQUENCY_RAGE@@K@Z @ 0x1C00608AC (-PruneMode@@YAHPEAU_devicemodeW@@PEAUtagModeCap@@HPEAU_FREQUENCY_RAGE@@K@Z.c)
  ...
  *((_DWORD *)a1 + 40) = v3 & 0xF7FFFFFF;
  ...
  if ( v8 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( (int)((__int64 (__fastcall *)(__int64, _QWORD, PVOID *, struct _DEVICE_OBJECT **))qword_1C018BB90)(
                    v15 + 8 + 4 * v16,
...
LABEL_23:
          for ( i = 0; ; i = v32 )
          {
            ...
            while ( 1 )
            {
              ...
              if ( !v61 || v29->dmSize + v29->dmDriverExtra != 244 )
                goto LABEL_51;
