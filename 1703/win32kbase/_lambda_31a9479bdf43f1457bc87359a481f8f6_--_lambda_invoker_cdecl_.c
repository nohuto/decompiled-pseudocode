/*
 * XREFs of _lambda_31a9479bdf43f1457bc87359a481f8f6_::_lambda_invoker_cdecl_ @ 0x1C012ACF0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (*((_DWORD *)a1 + 50) & 0x80u) != 0 )
  {
    ...
    if ( *(_DWORD *)(v2 + 24) == 7 )
    {
      ...
      PTPEngineTraceProducer::TraceEnvironment(
        *(PTPEngineTraceProducer **)(v3 + 800),
        (const struct PTPEnvironment *)(*(_QWORD *)(v3 + 800) + 40LL));
    }
  }
  return 1;
}
