/*
 * XREFs of RIMIDEGetTimeStampDelta @ 0x1C010A454
 * Callers:
 ...
 *     RIMIDEGetQpcBasedTouchStackTime @ 0x1C010A3D4 (RIMIDEGetQpcBasedTouchStackTime.c)
 *     RIMIDEValidateInjectionQpcCount @ 0x1C010B72C (RIMIDEValidateInjectionQpcCount.c)
 *     RIMIDEValidateInjectionTime @ 0x1C010B7E0 (RIMIDEValidateInjectionTime.c)
 */
