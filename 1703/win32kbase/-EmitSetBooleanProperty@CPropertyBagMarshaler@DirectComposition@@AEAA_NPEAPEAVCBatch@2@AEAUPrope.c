/*
 * XREFs of ?EmitSetBooleanProperty@CPropertyBagMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@AEAUPropertyUpdate@@@Z @ 0x1C0143B7C
 * Callers:
...
char __fastcall DirectComposition::CPropertyBagMarshaler::EmitSetBooleanProperty(
        ...
        struct PropertyUpdate *a3)
{
  ...
  *((_DWORD *)v6 + 5) = *(unsigned __int8 *)(v8 + 12);
  return v5;
}
