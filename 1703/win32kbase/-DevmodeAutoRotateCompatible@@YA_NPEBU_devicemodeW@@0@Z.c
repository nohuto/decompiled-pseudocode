/*
 * XREFs of ?DevmodeAutoRotateCompatible@@YA_NPEBU_devicemodeW@@0@Z @ 0x1C00F4A9C
 * Callers:
...
char __fastcall DevmodeAutoRotateCompatible(const struct _devicemodeW *dmPanningWidth, const struct _devicemodeW *a2)
{
  ...
  {
    if ( v4->dmPelsWidth == a2->dmPelsHeight )
    {
      dmPelsWidth = a2->dmPelsWidth;
      goto LABEL_7;
    }
LABEL_8:
    v6 = WdLogNewEntry5_WdEvent(dmPanningWidth, a2);
    *(_QWORD *)(v6 + 24) = v2;
    WdLogEvent5_WdEvent(v6);
    return 0;
  }
  if ( v4->dmPelsWidth != a2->dmPelsWidth )
    goto LABEL_8;
  dmPelsWidth = a2->dmPelsHeight;
LABEL_7:
  if ( v4->dmPelsHeight != dmPelsWidth )
    goto LABEL_8;
  v2 = 4;
