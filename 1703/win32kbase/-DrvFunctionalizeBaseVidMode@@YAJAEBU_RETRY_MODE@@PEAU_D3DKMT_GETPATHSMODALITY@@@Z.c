/*
 * XREFs of ?DrvFunctionalizeBaseVidMode@@YAJAEBU_RETRY_MODE@@PEAU_D3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00F6D30
 * Callers:
...
__int64 __fastcall DrvFunctionalizeBaseVidMode(const struct _RETRY_MODE *a1, struct _D3DKMT_GETPATHSMODALITY *a2)
{
  ...
  return ((__int64 (__fastcall *)(__int64, struct _D3DKMT_GETPATHSMODALITY *))qword_1C018B9C0)(v11, a2);
}
