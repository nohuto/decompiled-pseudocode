/*
 * XREFs of ?BeginTrack@CReferenceCountedType@CReferenceTracker@NSInstrumentation@@QEAAPEAXPEAX@Z @ 0x1C00FDE9C
 * Callers:
 ...
 *     ?Create@CPlatformSignal@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00FEF40 (-Create@CPlatformSignal@NSInstrumentation@@SAPEAV12@XZ.c)
 */
