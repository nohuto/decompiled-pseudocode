/*
 * XREFs of PowerIsDisplayIdleExpired @ 0x1C0047D70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z @ 0x1C0049600 (-IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z.c)
 *     PowerIsDisplayBurstActive @ 0x1C00D7200 (PowerIsDisplayBurstActive.c)
...
_BOOL8 __fastcall PowerIsDisplayIdleExpired(int a1, int *a2)
{
  ...
  if ( CInputGlobals::GetGlobalTickCount(gpInputGlobals, 0LL) < (unsigned __int64)qword_1C018C218 )
  {
