/*
 * XREFs of rimUpdatePointerDeviceFrameScanTime @ 0x1C0113FA0
 * Callers:
 ...
 *     rimSimulatedPointerDeviceScanTime @ 0x1C0113EB4 (rimSimulatedPointerDeviceScanTime.c)
 */
