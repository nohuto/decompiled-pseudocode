/*
 * XREFs of ?_UploadTelemetryData@DeadzonePalmTelemetry@@AEAAXH@Z @ 0x1C01174FC
 * Callers:
 *     ?ClearSession@DeadzonePalmTelemetry@@QEAAXXZ @ 0x1C0116D90 (-ClearSession@DeadzonePalmTelemetry@@QEAAXXZ.c)
 *     ?UpdateTelemetryBuffer@DeadzonePalmTelemetry@@QEAAXKKH@Z @ 0x1C0116ED0 (-UpdateTelemetryBuffer@DeadzonePalmTelemetry@@QEAAXKKH@Z.c)
 * Callees:
    ...
    *((_DWORD *)this + 1) = v6;
    if ( v6 )
    {
      ...
      do
      {
        ...
        {
          if ( dword_1C01867A0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01867A0, 0x400000000000uLL) )
          {
            TlgCreateSz(&pDesc, v2);
            TlgWrite((TraceLoggingHProvider)&dword_1C01867A0, &unk_1C016A70B, 0LL, v15, 3u, &pData);
          }
          v8 = 0LL;
          pcchLength = 0LL;
          v4 = 1;
      ...
      if ( v8 )
      {
        ...
        {
          TlgCreateSz(&v23, v2);
          TlgWrite((TraceLoggingHProvider)&dword_1C01867A0, &unk_1C016A70B, 0LL, v17, 3u, &v22);
        }
        v4 = 1;
      }
      if ( v4 )
