/*
 * XREFs of EtwTraceFocusedProcessChange @ 0x1C008A610
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall EtwTraceFocusedProcessChange(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_QWORD *)&WPP_MAIN_CB.ActiveThreadCount & 0x8000000000020000uLL) != 0 )
  {
    ...
    if ( (unsigned __int8)(byte_1C0186D98 - 1) > 2u && (qword_1C0186D80 & 0x8000000000020000uLL) != 0 )
    {
      result = 0;
      if ( (qword_1C0186D88 & 0x8000000000020000uLL) == qword_1C0186D88 )
      {
        v5 = 0;
        if ( a1 )
