/*
 * XREFs of ?MonitorInterfaceCallbackInternal@CMonitorPDO@@AEAAJPEBU_DEVICE_INTERFACE_CHANGE_NOTIFICATION@@@Z @ 0x1C00E8804
 * Callers:
 *     ?MonitorInterfaceCallback@CMonitorPDO@@CAJPEAX0@Z @ 0x1C00E87F0 (-MonitorInterfaceCallback@CMonitorPDO@@CAJPEAX0@Z.c)
 * Callees:
