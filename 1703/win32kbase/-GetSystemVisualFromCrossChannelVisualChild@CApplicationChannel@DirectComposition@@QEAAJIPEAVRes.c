/*
 * XREFs of ?GetSystemVisualFromCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAJIPEAVResourceHandle@@@Z @ 0x1C0019F68
 * Callers:
        ...
        struct ResourceHandle *a3)
{
  ...
  if ( v7 )
  {
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD *, __int64))(*v7 + 120LL))(v7, 31LL)
      && (v8 = (int *)v7[20]) != 0LL
      && (*(unsigned __int8 (__fastcall **)(int *))(*(_QWORD *)v8 + 216LL))(v8) )
    {
