/*
 * XREFs of ?xxxMKMoveAccelCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C0119610
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    {
      v2 = (unsigned __int8)byte_1C018AC82;
      giMouseMoveTable = 1;
      gtmridMKMoveCursor = ApiSetEditionSetAccessibilityTimer(gtmridMKMoveCursor, 50LL, xxxMKMoveConstCursorTimer);
    }
    else
    {
      v2 = byte_1C018AC01[giMouseMoveTable++];
    }
    if ( !v2 )
      return;
    goto LABEL_10;
  }
  v2 = 4 * (unsigned __int8)byte_1C018AC82;
LABEL_10:
  if ( (_DWORD)gdwInAtomicOperation && (gdwExtraInstrumentations & 1) != 0 )
    KeBugCheckEx(0x160u, (unsigned int)gdwInAtomicOperation, 0LL, 0LL, 0LL);
  UserSessionSwitchLeaveCrit();
  v3 = (unsigned int)(v2 * gMKDeltaY);
  v4 = (unsigned int)(v2 * gMKDeltaX);
  if ( (gdwMitConfig & 1) != 0 )
    MouseMove(v4, v3);
  else
    ApiSetEditionMouseMove(v4, v3);
