/*
 * XREFs of HmgReferenceCheckLock @ 0x1C0084130
 * Callers:
 *     <none>
 * Callees:
...
{
  GdiHandleEntryDirectory **v2; // r14
  __int16 v4; // edi^2
  __int64 v5; // rsi
  unsigned int v6; // ebp
  __int64 v7; // rbx
  ...
  v7 = 0LL;
  v8 = GdiHandleManager::DecodeIndex((GdiHandleEntryDirectory **)gpHandleManager, v6);
  Entry = GdiHandleEntryDirectory::GetEntry((GdiHandleEntryDirectory *)v5, v8, 0);
  if ( Entry )
  {
    if ( *((_BYTE *)Entry + 14) == a2 && *((_WORD *)Entry + 6) == v4 )
    {
      v10 = GdiHandleManager::DecodeIndex(v2, v6);
      v11 = *(_DWORD *)(v5 + 2056);
      v12 = v10;
      if ( v10 < v11 + ((*(unsigned __int16 *)(v5 + 2) + 0xFFFF) << 16) )
      {
        if ( v10 >= v11 )
        {
          v13 = ((v10 - v11) >> 16) + 1;
