/*
 * XREFs of ?OnDelete@ServerPortInfo@CoreMessagingK@@SAXPEAUObjectImpl@2@@Z @ 0x1C0069A20
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CoreMessagingK::ServerPortInfo::OnDelete(struct CoreMessagingK::ObjectImpl *a1)
{
  ...
  if ( dword_1C0186C30 > 5u )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C0186C30, &unk_1C016BFEC, 0LL, v3, 5u, &pData);
  }
