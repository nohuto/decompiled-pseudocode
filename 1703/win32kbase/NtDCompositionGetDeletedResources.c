/*
 * XREFs of NtDCompositionGetDeletedResources @ 0x1C0080190
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( v10 )
      {
        ...
        do
        {
          v14 = *((unsigned int *)v9 + 134);
          v15 = v12 - v14;
          if ( v10 < v15 )
            v15 = v10;
          v16 = v15;
          memmove(v13, (const void *)(*((_QWORD *)v9 + 62) + v14 * *((_QWORD *)v9 + 66)), v15 * *((_QWORD *)v9 + 66));
          v12 = *((_QWORD *)v9 + 65);
          *((_DWORD *)v9 + 134) = (unsigned int)(v16 + *((_DWORD *)v9 + 134)) % v12;
          *((_DWORD *)v9 + 135) -= v16;
          v13 += 8 * v16;
          v10 -= v16;
        }
