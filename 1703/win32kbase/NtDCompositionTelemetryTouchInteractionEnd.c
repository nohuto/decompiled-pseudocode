/*
 * XREFs of NtDCompositionTelemetryTouchInteractionEnd @ 0x1C0005130
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionTelemetryTouchInteractionEnd(unsigned int a1, __int64 *a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( v2 >= 0 )
    {
      ...
      {
        *((_QWORD *)v4 + 2) = v8;
        v5 = (struct DirectComposition::CApplicationChannel **)*((_QWORD *)v3 + 74);
        if ( *v5 != (struct DirectComposition::CApplicationChannel *)((char *)v3 + 584) )
          __fastfail(3u);
        *(_QWORD *)v4 = (char *)v3 + 584;
        *((_QWORD *)v4 + 1) = v5;
        *v5 = v4;
        *((_QWORD *)v3 + 74) = v4;
      }
