/*
 * XREFs of Template_xdx @ 0x1C00DE098
 * Callers:
...
NTSTATUS Template_xdx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 8LL;
  return EtwWrite(Microsoft_Windows_Win32kHandle, &InsertPowerRequestToQueue, &W32kControlGuid, 3u, &UserData);
}
