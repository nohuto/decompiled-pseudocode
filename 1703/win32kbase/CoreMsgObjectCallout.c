/*
 * XREFs of CoreMsgObjectCallout @ 0x1C006C0A4
 * Callers:
...
__int64 __fastcall CoreMsgObjectCallout(unsigned int a1, _QWORD *a2, __int64 a3, const GUID *a4)
{
  ...
  if ( dword_1C0186C30 > 5u )
  {
    ...
    v16 = a1;
    v19 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0186C30, &unk_1C016BB07, 0LL, a4, 3u, &pData);
  }
...
LABEL_9:
  ...
  if ( dword_1C0186C30 > 5u )
  {
    ...
    v18 = &v16;
    v19 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0186C30, &unk_1C016BAD6, 0LL, v6, 3u, &pData);
  }
  if ( v15[0] )
