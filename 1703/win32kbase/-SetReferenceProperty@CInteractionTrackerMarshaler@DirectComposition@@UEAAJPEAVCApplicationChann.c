/*
 * XREFs of ?SetReferenceProperty@CInteractionTrackerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C0146930
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  if ( v9 )
  {
    ...
    if ( v10 )
    {
      ...
      DirectComposition::CApplicationChannel::ReleaseResource(a2, this[v16 + 25]);
      this[v16 + 25] = a4;
      if ( a4 )
