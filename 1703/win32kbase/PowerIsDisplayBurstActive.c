/*
 * XREFs of PowerIsDisplayBurstActive @ 0x1C00D7200
 * Callers:
 *     PowerIsDisplayIdleExpired @ 0x1C0047D70 (PowerIsDisplayIdleExpired.c)
 * Callees:
 *     <none>
 */
...
_BOOL8 __fastcall PowerIsDisplayBurstActive(int *a1)
{
  ...
  v3 = *((_QWORD *)&v2 + 1) - qword_1C018C230;
  v4 = *((_QWORD *)&v2 + 1) - qword_1C018C228;
  v5 = *((_QWORD *)&v2 + 1) - qword_1C018C220;
