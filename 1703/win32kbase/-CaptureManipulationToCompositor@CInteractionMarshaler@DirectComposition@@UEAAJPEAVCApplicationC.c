/*
 * XREFs of ?CaptureManipulationToCompositor@CInteractionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@II_K@Z @ 0x1C01440C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a5)
{
  ...
  *(_QWORD *)&v9 = __PAIR64__(a4, a3);
  if ( *((_DWORD *)this + 56) != *((_DWORD *)this + 57)
    || (v6 = CDynamicArray<InjectManipulationArgs *,2003858261>::Grow((__int64)this + 216), v6 >= 0) )
  {
