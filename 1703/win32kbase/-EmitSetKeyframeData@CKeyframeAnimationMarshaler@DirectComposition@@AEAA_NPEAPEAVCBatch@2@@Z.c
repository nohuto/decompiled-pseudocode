/*
 * XREFs of ?EmitSetKeyframeData@CKeyframeAnimationMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0020474
 * Callers:
  ...
  if ( (*((_DWORD *)this + 4) & 0x400) == 0 && *((_QWORD *)this + 13) && *((_QWORD *)this + 15) )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x48uLL, &v10) )
    {
      ...
      *v6 = 237;
      ...
      v6[7] = *((_DWORD *)this + 47);
      v6[8] = *((_DWORD *)this + 49);
      v6[16] = *((_DWORD *)this + 51);
      v6[9] = *((_DWORD *)this + 52);
      v6[10] = *((_DWORD *)this + 53);
      v7 = *((_QWORD *)this + 32);
      if ( v7 )
