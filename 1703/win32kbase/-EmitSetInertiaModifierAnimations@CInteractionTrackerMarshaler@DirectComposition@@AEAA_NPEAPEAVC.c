/*
 * XREFs of ?EmitSetInertiaModifierAnimations@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0145504
 * Callers:
...
LABEL_9:
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, v7, &v10) )
  {
    ...
    *((_DWORD *)this + 5) = *(_DWORD *)v3;
    if ( *v3 )
      memmove((char *)this + 24, (const void *)*(v3 - 3), *v3);
