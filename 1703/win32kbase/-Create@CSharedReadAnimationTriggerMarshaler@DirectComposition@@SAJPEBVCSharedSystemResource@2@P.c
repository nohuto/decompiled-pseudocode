/*
 * XREFs of ?Create@CSharedReadAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C014FADC
 * Callers:
 *     CreateSharedReadAnimationTriggerMarshaler @ 0x1C014FBB0 (CreateSharedReadAnimationTriggerMarshaler.c)
 * Callees:
