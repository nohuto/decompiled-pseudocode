/*
 * XREFs of ?EnumDevices@CBaseInput@@QEBAXPEAXP6A_NQEAUDEVICEINFO@@0@Z@Z @ 0x1C004F85C
 * Callers:
 ...
 *     ?EnvironmentChanged@CPTPProcessor@@SAXXZ @ 0x1C007D510 (-EnvironmentChanged@CPTPProcessor@@SAXXZ.c)
 * Callees:
...
void __fastcall CBaseInput::EnumDevices(
        ...
        bool (*a3)(struct DEVICEINFO *const, void *))
{
  ...
  CInpLockExclusiveIfNeeded::CInpLockExclusiveIfNeeded((CInpLockExclusiveIfNeeded *)&v6, a2);
