/*
 * XREFs of ?RevalidateFrameProcessing@CTouchProcessor@@AEAAHPEAUtagTHREADINFO@@HPEBUCPointerInfoNode@@H@Z @ 0x1C0125DA0
 * Callers:
        ...
        int a5)
{
  ...
  if ( a3 && (*((_DWORD *)a2 + 274) & 0x2000) == 0 || !(unsigned int)CPointerInfoNode::IsValid(a4) )
    return 0LL;
