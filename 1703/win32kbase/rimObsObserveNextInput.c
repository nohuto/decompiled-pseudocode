/*
 * XREFs of rimObsObserveNextInput @ 0x1C0115C04
 * Callers:
 *     NtRIMObserveNextInput @ 0x1C00FFB50 (NtRIMObserveNextInput.c)
 *     RIMObserveNextInput @ 0x1C0102640 (RIMObserveNextInput.c)
 * Callees:
