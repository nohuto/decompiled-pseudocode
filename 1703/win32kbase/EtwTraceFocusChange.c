/*
 * XREFs of EtwTraceFocusChange @ 0x1C008A500
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall EtwTraceFocusChange(PETHREAD *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (*(_QWORD *)&WPP_MAIN_CB.ActiveThreadCount & 0x8000000000002000uLL) != 0
    && (unsigned __int8)(byte_1C0186D98 - 1) > 2u
    && (qword_1C0186D80 & 0x8000000000002000uLL) != 0
    && (qword_1C0186D88 & 0x8000000000002000uLL) == qword_1C0186D88 )
  {
    v4 = 0;
