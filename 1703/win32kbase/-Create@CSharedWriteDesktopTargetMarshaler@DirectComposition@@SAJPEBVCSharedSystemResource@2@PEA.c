/*
 * XREFs of ?Create@CSharedWriteDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0089308
 * Callers:
 *     CreateSharedWriteDesktopTargetMarshaler @ 0x1C00892D0 (CreateSharedWriteDesktopTargetMarshaler.c)
 * Callees:
