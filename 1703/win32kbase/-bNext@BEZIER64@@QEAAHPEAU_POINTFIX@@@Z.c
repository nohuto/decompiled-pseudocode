/*
 * XREFs of ?bNext@BEZIER64@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C00EE750
 * Callers:
 *     ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C0023920 (-pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z.c)
 * Callees:
 *     ?vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1C0024410 (-vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z.c)
 *     ?bIntersect@@YAHPEAU_RECTFX@@0@Z @ 0x1C00EE71C (-bIntersect@@YAHPEAU_RECTFX@@0@Z.c)
 *     ?vError@HFDBASIS64@@QEAAXPEA_J@Z @ 0x1C00EEBD8 (-vError@HFDBASIS64@@QEAAXPEA_J@Z.c)
 *     ?vInit@HFDBASIS64@@QEAAXJJJJ@Z @ 0x1C00EED68 (-vInit@HFDBASIS64@@QEAAXJJJJ@Z.c)
 *     ?vParentError@HFDBASIS64@@QEAAXPEA_J@Z @ 0x1C00EEE08 (-vParentError@HFDBASIS64@@QEAAXPEA_J@Z.c)
 *     ?vUntransform@HFDBASIS64@@QEAAXPEAJ@Z @ 0x1C00EEE88 (-vUntransform@HFDBASIS64@@QEAAXPEAJ@Z.c)
 */
