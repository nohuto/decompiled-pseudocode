/*
 * XREFs of ?EmitAddTimeEvents@CAnimationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0026538
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  for ( ; *((_DWORD *)this + 61) < *((_DWORD *)this + 60); *((_DWORD *)this + 61) += v6 )
  {
    ...
    v6 = (v5 - 12) >> 4;
    if ( (unsigned int)(*((_DWORD *)this + 60) - *((_DWORD *)this + 61)) < v6 )
      LODWORD(v6) = *((_DWORD *)this + 60) - *((_DWORD *)this + 61);
