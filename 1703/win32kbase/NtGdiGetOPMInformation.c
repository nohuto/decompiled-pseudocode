/*
 * XREFs of NtGdiGetOPMInformation @ 0x1C00EE520
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_GET_INFO_PARAMETERS_ @ 0x1C00ECDF8 (SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_GET_INFO_PARAMETERS_.c)
...
__int64 __fastcall NtGdiGetOPMInformation(__int64 a1, _OWORD *a2, _OWORD *a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( Information >= 0 )
    {
      ...
      if ( Information >= 0 )
        Information = SafelyCopyKernelModeDataToUserModeData__DXGKMDT_OPM_REQUESTED_INFORMATION_(a3, xmmword_1C0190BB0);
    }
