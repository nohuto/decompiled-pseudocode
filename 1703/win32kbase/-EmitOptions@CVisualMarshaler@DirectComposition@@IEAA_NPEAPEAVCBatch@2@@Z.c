/*
 * XREFs of ?EmitOptions@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00164FC
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x18uLL, &v5) )
  {
    ...
    *((_DWORD *)v4 + 3) = (*((unsigned __int8 *)this + 232) >> 4) & 1;
    *((_DWORD *)v4 + 4) = (*((unsigned __int8 *)this + 232) >> 3) & 1;
    *((_DWORD *)v4 + 5) = (*((unsigned __int8 *)this + 232) >> 5) & 1;
