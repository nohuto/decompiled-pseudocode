/*
 * XREFs of ?OpenSwapChainHandles@CCompositionSurface@@QEBAJ_KPEAUCSM_SWAPCHAIN_HANDLE_INFO@@@Z @ 0x1C0011898
 * Callers:
        ...
        struct CSM_SWAPCHAIN_HANDLE_INFO *a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (*(unsigned int (__fastcall **)(struct CCompositionBuffer *))(*(_QWORD *)v6 + 8LL))(v6) == 2 )
      return (*(__int64 (__fastcall **)(struct CCompositionBuffer *, struct CSM_SWAPCHAIN_HANDLE_INFO *))(*(_QWORD *)v5 + 64LL))(
               v5,
               a3);
    else
      return 3221225485LL;
