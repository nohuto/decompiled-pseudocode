/*
 * XREFs of rimObsCopyMessage @ 0x1C01157C0
 * Callers:
...
__int64 __fastcall rimObsCopyMessage(__int64 a1, __int64 a2, void **a3)
{
  ...
  if ( v7 >= v5 )
  {
    if ( v6 )
    {
      ...
      memset(a3, 0, v9);
      v10 = a3 + 6;
      if ( a3 + 6 > (void **)W32UserProbeAddress || v10 <= a3 )
      ...
      *((_OWORD *)a3 + 2) = *(_OWORD *)(a1 + 32);
      ...
      {
        v11 = a3 + 5;
        v12 = (CTouchProcessor *)(a3 + 5);
        if ( a3 + 5 >= (void **)W32UserProbeAddress )
          v12 = W32UserProbeAddress;
        *(_QWORD *)v12 = v10;
        v13 = *(_QWORD *)(a1 + 24);
        v14 = *(const void **)(a1 + 40);
        v15 = *v11;
        v16 = (unsigned __int64)*v11 + v13;
        if ( v16 > (unsigned __int64)W32UserProbeAddress || v16 <= (unsigned __int64)v15 )
          *(_BYTE *)W32UserProbeAddress = 0;
        memmove(v15, v14, v13);
      }
    }
