/*
 * XREFs of ?EmitSetQuaternionProperty@CPropertyBagMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@AEAUPropertyUpdate@@@Z @ 0x1C0143CB4
 * Callers:
...
char __fastcall DirectComposition::CPropertyBagMarshaler::EmitSetQuaternionProperty(
