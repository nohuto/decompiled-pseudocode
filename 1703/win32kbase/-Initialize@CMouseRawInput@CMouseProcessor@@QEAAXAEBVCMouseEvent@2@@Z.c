/*
 * XREFs of ?Initialize@CMouseRawInput@CMouseProcessor@@QEAAXAEBVCMouseEvent@2@@Z @ 0x1C00450E8
 * Callers:
        ...
        const struct CMouseProcessor::CMouseEvent *a2)
{
  ...
  *((_QWORD *)this + 3) = 0LL;
  LODWORD(v4) = 0;
  *((_OWORD *)this + 2) = v4;
  v3 = (*(unsigned __int8 *)(*(_QWORD *)a2 + 88LL) >> 4) & 1;
  *((_BYTE *)this + 53) = (*(_BYTE *)(*(_QWORD *)a2 + 88LL) & 0x10) != 0;
  if ( !(_BYTE)v3 )
  {
