/*
 * XREFs of ?CommitMousePosAndMoveCursor@CMouseProcessor@@AEAAXPEAVMouseInputDataEx@1@UtagPOINT@@@Z @ 0x1C0046F54
 * Callers:
        ...
        struct tagPOINT a3)
{
  ...
  {
    LODWORD(v11) = 0;
    v9 = ApiSetEditionCommitMousePosAndMove((unsigned int)&v10, 0, 0, (unsigned int)&v11, 0, 0LL, 0, 1, 1);
  }
  else
  {
    v5 = *((_DWORD *)a2 + 14);
    ...
    *(_DWORD *)((char *)&v11 + 2) = *(_DWORD *)((char *)a2 + 2);
    ...
    v9 = ApiSetEditionCommitMousePosAndMove(
           ...
           *((_QWORD *)a2 + 6),
           ...
           ((unsigned __int8)~(_BYTE)v5 >> 1) & 1,
           (v5 & 0x2000) == 0);
  }
  *((_DWORD *)a2 + 16) = v9;
  if ( (v9 & 1) != 0 )
    *((_OWORD *)this + 157) = *(_OWORD *)((char *)a2 + 40);
}
