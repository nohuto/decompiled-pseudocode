/*
 * XREFs of ?CitpSavedDataCompress@@YAJPEBXIPEAPEAXPEAI@Z @ 0x1C01552AC
 * Callers:
...
LABEL_3:
  ...
  if ( v14 )
  {
    WorkSpace = (void *)Win32AllocPool(v14, 0x49637355u);
    if ( !WorkSpace )
    {
      v13 = 3221225626LL;
      v12 = 5705;
  ...
  v16 = (UCHAR *)Win32AllocPool((unsigned int)(CompressedBufferSize + 8), 0x49637355u);
  if ( v16 )
  {
  ...
  {
    v11 = -1073741670;
    CitpLogFailureWorker(3221225626LL, v15, 5719);
  }
  if ( WorkSpace )
    Win32FreePool((__int64)WorkSpace);
  return v11;
}
