/*
 * XREFs of ?BindAnimation@CApplicationChannel@DirectComposition@@IEAAJPEAVCResourceMarshaler@2@IPEAVCBaseAnimation@2@@Z @ 0x1C001A680
 * Callers:
 ...
 *     ?FindAnimationBindings@CResourceMarshaler@DirectComposition@@QEAAXIPEAPEAVCAnimationBinding@2@00@Z @ 0x1C001E224 (-FindAnimationBindings@CResourceMarshaler@DirectComposition@@QEAAXIPEAPEAVCAnimationBinding@2@00.c)
        ...
        struct DirectComposition::CBaseAnimation *a4)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v12 + 120LL))(v12, 93LL) )
  {
    ...
    if ( v4 && *(_DWORD *)(v4 + 156) )
    {
      ...
      if ( v29
        ...
        && (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v21 + 120LL))(v21, 94LL) )
      {
        v23 = v20[10];
      }
      else
      ...
      if ( v20 && (*(unsigned __int8 (__fastcall **)(_DWORD *, __int64))(*(_QWORD *)v20 + 120LL))(v20, 93LL) )
      {
        v22 = v20 - 4;
  ...
  {
LABEL_13:
    v17 = (struct DirectComposition::CAnimationBinding *)*((_QWORD *)this + 46);
    if ( v17 )
    {
      *((_QWORD *)this + 46) = 0LL;
      v26 = v17;
    ...
    {
      v18 = v26;
      v13 = (DirectComposition::CApplicationChannel *)*((_QWORD *)this + 57);
      *(_QWORD *)v26 = v13;
      *((_QWORD *)this + 57) = v18;
    }
LABEL_17:
...
LABEL_43:
  ...
  if ( *((_QWORD *)this + 58) )
    DirectComposition::CApplicationChannel::RemoveFromBatchList(
      v13,
      v16,
      (struct DirectComposition::CAnimationBinding ***)this + 58);
