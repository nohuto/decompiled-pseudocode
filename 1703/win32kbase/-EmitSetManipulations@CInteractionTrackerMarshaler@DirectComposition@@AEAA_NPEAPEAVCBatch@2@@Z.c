/*
 * XREFs of ?EmitSetManipulations@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01455DC
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  v2 = 1;
  v3 = 1;
  if ( (*((_DWORD *)this + 4) & 0x800) != 0 || *((_DWORD *)this + 76) )
  {
    for ( ; *((_DWORD *)this + 77) < *((_DWORD *)this + 76); *((_DWORD *)this + 77) += v8 )
    {
      v7 = (void *)(4096LL - *((_QWORD *)(*a2)[15] + 5));
      v14 = v7;
      ...
      if ( (unsigned int)(*((_DWORD *)this + 76) - *((_DWORD *)this + 77)) < v8 )
        LODWORD(v8) = *((_DWORD *)this + 76) - *((_DWORD *)this + 77);
      ...
      *((_DWORD *)v9 + 2) = *((_DWORD *)this + 6);
      ...
      {
        *v11 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 37) + 16LL * (v10 + *((_DWORD *)this + 77))) + 24LL);
        v12 = *(_QWORD *)(*((_QWORD *)this + 37) + 16LL * (v10 + *((_DWORD *)this + 77)) + 8);
        if ( v12 )
          v11[1] = *(_DWORD *)(v12 + 24);
        else
          v11[1] = 0;
  ...
  if ( *((_DWORD *)this + 77) != *((_DWORD *)this + 76) || !v3 )
    return 0;
  return v2;
}
