/*
 * XREFs of ?GetInformation@COPMProtectedOutput@@QEAAJQEAU_DXGKMDT_OPM_GET_INFO_PARAMETERS@@PEAU_DXGKMDT_OPM_REQUESTED_INFORMATION@@@Z @ 0x1C00EDA04
 * Callers:
        ...
        struct _DXGKMDT_OPM_REQUESTED_INFORMATION *a3)
{
  ...
  else
  {
    ...
    InputBuffer[1] = &unk_1C018FBA0;
    v5 = CallMonitor(v6, 0x232497u, InputBuffer, 0x10u, &unk_1C0190BB0, 0x1000u);
  }
  if ( *v3 )
