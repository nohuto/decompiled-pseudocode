/*
 * XREFs of ?DestroyHandle@CConnection@DirectComposition@@SAJPEAUHDCOMPOSITIONCONNECTION__@@@Z @ 0x1C0092294
 * Callers:
 *     ??_GCProcessData@DirectComposition@@AEAAPEAXI@Z @ 0x1C00547AC (--_GCProcessData@DirectComposition@@AEAAPEAXI@Z.c)
 *     NtDCompositionCreateConnection @ 0x1C0091A70 (NtDCompositionCreateConnection.c)
 *     NtDCompositionDestroyConnection @ 0x1C013EDB0 (NtDCompositionDestroyConnection.c)
 * Callees:
