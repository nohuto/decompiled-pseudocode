/*
 * XREFs of NtDCompositionSynchronize @ 0x1C007EAC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Synchronize@CSynchronizationManager@DirectComposition@@SAJPEAVCBatch@2@@Z @ 0x1C0027400 (-Synchronize@CSynchronizationManager@DirectComposition@@SAJPEAVCBatch@2@@Z.c)
...
__int64 __fastcall NtDCompositionSynchronize(unsigned int a1, _QWORD *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    v4 = DirectComposition::CSynchronizationManager::Synchronize(*((struct DirectComposition::CBatch **)v5 + 23));
    if ( v4 >= 0 )
    {
      v3 = *(_QWORD *)(*((_QWORD *)v5 + 23) + 40LL);
      v8 = v3;
    }
