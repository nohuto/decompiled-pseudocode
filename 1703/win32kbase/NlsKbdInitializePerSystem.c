/*
 * XREFs of NlsKbdInitializePerSystem @ 0x1C008ECE0
 * Callers:
 *     <none>
 * Callees:
 *     ?NlsSetKeyStateToggle@@YAXE@Z @ 0x1C008EEA4 (-NlsSetKeyStateToggle@@YAXE@Z.c)
...
void NlsKbdInitializePerSystem()
{
  ...
  if ( gKeyboardInfo == 7 && byte_1C0189499 == 3 )
