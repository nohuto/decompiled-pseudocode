/*
 * XREFs of ?TPAAPShouldAllowNow@CPTPEngine@@AEAAHPEAUPTPInput@@KHH@Z @ 0x1C01383B0
 * Callers:
...
LABEL_3:
  ...
  if ( !v9 && (v7 & 0x6C) != 0 )
  {
    ...
    if ( v17 == 32 )
    {
      v18 = *((_DWORD *)this + v13 + 119);
    }
    else
    {
      v19 = v13;
      v18 = *((_DWORD *)this + v13 + 108);
      if ( v17 == 64 )
        v18 = *((_DWORD *)this + v19 + 127);
    }
    v11 = *((_QWORD *)a2 + 1);
    v12 = *((_QWORD *)a2 + 2);
    if ( v11 > 0 )
