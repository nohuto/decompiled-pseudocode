/*
 * XREFs of ?GetUserModeViewAtOffset@CBatchSharedMemoryPool@DirectComposition@@QEAAJ_KPEAPEAX@Z @ 0x1C0014568
 * Callers:
        ...
        void **a3)
{
  ...
  v8 = 0LL;
  v7 = 0LL;
  result = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64 *, _QWORD, __int64, __int64 *, __int64 *, int, int, int))MmMapViewOfSection)(
             *((_QWORD *)this + 3),
