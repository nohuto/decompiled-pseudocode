/*
 * XREFs of ?EmitAppendColorResources@CPrimitiveGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0024C40
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  for ( ; *((_DWORD *)this + 25) < *((_DWORD *)this + 24); *((_DWORD *)this + 25) += v6 )
  {
    ...
    v6 = (v5 - 16) >> 2;
    if ( (unsigned int)(*((_DWORD *)this + 24) - *((_DWORD *)this + 25)) < v6 )
      LODWORD(v6) = *((_DWORD *)this + 24) - *((_DWORD *)this + 25);
