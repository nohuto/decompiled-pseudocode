/*
 * XREFs of ?EmitSetBindingBroken@CBaseExpressionMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C001F6F4
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  v3 = 1;
  if ( (*((_DWORD *)this + 4) & 0x100) == 0 && (*((_BYTE *)this + 84) & 2) != 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x10uLL, &v6) )
    {
      ...
      *((_DWORD *)v5 + 3) = (*((unsigned __int8 *)this + 84) >> 2) & 1;
