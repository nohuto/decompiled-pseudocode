/*
 * XREFs of ?TokenThread@CTokenManager@@SAJPEAXPEAUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x1C007D7A8
 * Callers:
 ...
 *     ?ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z @ 0x1C007E054 (-ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z.c)
