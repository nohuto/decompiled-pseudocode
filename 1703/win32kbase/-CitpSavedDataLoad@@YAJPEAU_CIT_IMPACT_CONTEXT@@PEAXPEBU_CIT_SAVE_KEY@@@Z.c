/*
 * XREFs of ?CitpSavedDataLoad@@YAJPEAU_CIT_IMPACT_CONTEXT@@PEAXPEBU_CIT_SAVE_KEY@@@Z @ 0x1C01554E4
 * Callers:
...
__int64 __fastcall CitpSavedDataLoad(struct _CIT_IMPACT_CONTEXT *a1, void *a2, const struct _CIT_SAVE_KEY *a3)
{
  ...
  *(_QWORD *)v20 = 0LL;
  ...
  v10 = (const char *)((unsigned int)dword_1C018E880 / 0x3E8);
  if ( v28 != __PAIR64__(*(unsigned int *)((char *)&qword_1C018E8BA + 2), (unsigned int)v10) )
  {
    v7 = -1073741637;
    v15 = 5884;
LABEL_15:
