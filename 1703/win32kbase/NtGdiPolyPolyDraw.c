/*
 * XREFs of NtGdiPolyPolyDraw @ 0x1C00962E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
    ...
    if ( v10 )
    {
      v11 = &v28;
      v25 = &v28;
      v12 = (unsigned __int64)a3 + 4 * v5;
      if ( v12 < (unsigned __int64)a3 || v12 > (unsigned __int64)W32UserProbeAddress )
      ...
      if ( v11 )
      {
        v15 = 8LL * v13;
        v16 = Src;
        if ( (char *)Src + v15 < Src || (char *)Src + v15 > (char *)W32UserProbeAddress )
          *(_BYTE *)W32UserProbeAddress = 0;
        memmove(v11, v16, v15);
      }
      else
