/*
 * XREFs of ?SetResourceAnimationProperty@CApplicationChannel@DirectComposition@@QEAAJIII@Z @ 0x1C001ACB8
 * Callers:
        ...
        int a4)
{
  ...
  {
    _mm_lfence();
    v10 = *(_QWORD *)(v5 * *((_QWORD *)this + 12) + *((_QWORD *)this + 8));
  }
  else
  {
    v10 = 0LL;
  ...
  if ( v6 )
  {
    ...
    if ( a2 && v12 < *((_QWORD *)this + 11) )
    {
      _mm_lfence();
      v4 = *(struct DirectComposition::CResourceMarshaler **)(v12 * *((_QWORD *)this + 12) + *((_QWORD *)this + 8));
    }
    if ( !v4 )
      v11 = -1073741790;
  }
  if ( v11 >= 0 )
  {
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, _QWORD, _QWORD))(v13 + 192))(
            v4,
            a3,
            v14) )
      v11 = -1073741811;
