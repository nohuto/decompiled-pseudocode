/*
 * XREFs of ?SetReferenceArrayProperty@CConditionalExpressionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C0148DB0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  if ( v9 >= 0 )
  {
    ...
    if ( v9 >= 0 )
    {
      if ( *((_QWORD *)this + 13) || *((_DWORD *)this + 28) )
        v9 = -1073741811;
      if ( v9 >= 0 )
      {
        *((_DWORD *)this + 28) = a5;
