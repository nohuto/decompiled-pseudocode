/*
 * XREFs of ?ConvertHandleAndVerifyLoc@@YAPEAXPEAX@Z @ 0x1C0079CD0
 * Callers:
  ...
  if ( Handle )
  {
    ...
    if ( v4 >= 0 && ObQueryNameString(Object, &ObjectNameInfo, 0x218u, &ReturnLength) >= 0 )
    {
      ...
      *(_DWORD *)&Destination.Length = 34078720;
      ...
      {
        if ( (*((_DWORD *)gptiCurrent + 110) & 0x100) == 0 )
        {
LABEL_7:
          v5 = L"\\system32\\";
          goto LABEL_8;
        }
        ProcessMachine = PsWow64GetProcessMachine(**((_QWORD **)gptiCurrent + 47));
