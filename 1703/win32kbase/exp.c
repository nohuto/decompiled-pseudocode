...
double __cdecl exp(double X)
{
  ...
  double v9; // [rsp+68h] [rbp+10h]
  double v10; // [rsp+70h] [rbp+18h]
  ...
  *(double *)&v11 = X;
  ...
  {
    splitexp(0, v6, v1, v2, *(__int64 *)&DOUBLE_5_689487495325456eN11, (__int64)&v8);
    if ( (unsigned int)(v8 + 1022) > 0x7FD )
    {
      v11 = (v8 - v8 / 2 + 1023LL) << 52;
      return (v9 + v10) * COERCE_DOUBLE((v8 / 2 + 1023LL) << 52) * *(double *)&v11;
    }
    else
    {
      v11 = (v8 + 1023LL) << 52;
      return (v9 + v10) * *(double *)&v11;
    }
  }
  else
  {
