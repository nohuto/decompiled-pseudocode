/*
 * XREFs of ?SetReferenceArrayProperty@CTransform3DGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C0147810
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  if ( v6 >= 0 )
  {
    ...
    {
      if ( *((_QWORD *)this + 7) )
        (*(void (__fastcall **)(DirectComposition::CTransform3DGroupMarshaler *, struct DirectComposition::CApplicationChannel *))(*(_QWORD *)this + 112LL))(
          this,
          a2);
      *((_QWORD *)this + 7) = a4;
      v11 = 0LL;
      ...
      *a6 = 1;
      if ( *((_DWORD *)this + 16) )
      {
        do
        {
          DirectComposition::CResourceMarshaler::AddRef(*(DirectComposition::CResourceMarshaler **)(*((_QWORD *)this + 7)
                                                                                                  + 8 * v11));
