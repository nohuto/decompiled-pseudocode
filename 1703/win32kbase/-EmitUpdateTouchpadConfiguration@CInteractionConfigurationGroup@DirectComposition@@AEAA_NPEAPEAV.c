/*
 * XREFs of ?EmitUpdateTouchpadConfiguration@CInteractionConfigurationGroup@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C000F958
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  while ( (*((_DWORD *)this + 3) & 8) != 0 || *((_DWORD *)this + 14) < *((_DWORD *)this + 12) )
  {
    ...
    v6 = (v5 - 24) / 0xC;
    if ( (unsigned int)(*((_DWORD *)this + 12) - *((_DWORD *)this + 14)) < v6 )
      LODWORD(v6) = *((_DWORD *)this + 12) - *((_DWORD *)this + 14);
