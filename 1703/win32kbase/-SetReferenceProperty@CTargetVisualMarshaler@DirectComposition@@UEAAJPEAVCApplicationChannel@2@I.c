/*
 * XREFs of ?SetReferenceProperty@CTargetVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C000C3D0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  if ( a3 == 13 )
  {
    ...
    if ( (*((unsigned __int8 (__fastcall **)(DirectComposition::CTargetVisualMarshaler **, __int64))*a4 + 15))(a4, 31LL) )
    {
      v5 = a4;
      return DirectComposition::CTargetVisualMarshaler::UpdateRootVisual(this, a2, v5, a5);
    }
