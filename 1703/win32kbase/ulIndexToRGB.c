/*
 * XREFs of ulIndexToRGB @ 0x1C00591F0
 * Callers:
 *     GreGetNearestColor @ 0x1C0058F50 (GreGetNearestColor.c)
 *     ulColorRefToRGB @ 0x1C0098640 (ulColorRefToRGB.c)
 * Callees:
 *     ?vUnlock@SEMOBJ@@QEAAXXZ @ 0x1C0037A88 (-vUnlock@SEMOBJ@@QEAAXXZ.c)
 *     EngAcquireSemaphore @ 0x1C0037BB0 (EngAcquireSemaphore.c)
 *     ?ulIndexToRGB@XEPALOBJ@@QEAAKK@Z @ 0x1C005A0F0 (-ulIndexToRGB@XEPALOBJ@@QEAAKK@Z.c)
 */
