/*
 * XREFs of ?CheckInputSinkTypes@CInteractionMarshaler@DirectComposition@@AEAAJXZ @ 0x1C000F2FC
 * Callers:
 ...
 *     ?SetDefaultConfiguration@CInteractionMarshaler@DirectComposition@@UEAAJXZ @ 0x1C000EDC0 (-SetDefaultConfiguration@CInteractionMarshaler@DirectComposition@@UEAAJXZ.c)
 * Callees:
