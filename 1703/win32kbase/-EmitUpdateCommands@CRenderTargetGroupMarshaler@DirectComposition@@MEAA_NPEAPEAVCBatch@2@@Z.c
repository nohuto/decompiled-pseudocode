/*
 * XREFs of ?EmitUpdateCommands@CRenderTargetGroupMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00896D0
 * Callers:
 *     <none>
 * Callees:
  ...
  for ( ; *((_DWORD *)this + 13) < *((_DWORD *)this + 12); *((_DWORD *)this + 13) += v5 )
  {
    ...
    *((_DWORD *)v6 + 3) = 4 * v5;
    ...
    if ( (_DWORD)v5 )
    {
      ...
      {
        v10 = v7++;
        *v8++ = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 5) + 8 * v10) + 24LL);
        --v9;
      }
      while ( v9 );
    }
