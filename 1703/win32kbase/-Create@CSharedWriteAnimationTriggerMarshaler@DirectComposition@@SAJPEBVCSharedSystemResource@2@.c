/*
 * XREFs of ?Create@CSharedWriteAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0004978
 * Callers:
 *     CreateSharedWriteAnimationTriggerMarshaler @ 0x1C0004940 (CreateSharedWriteAnimationTriggerMarshaler.c)
 * Callees:
