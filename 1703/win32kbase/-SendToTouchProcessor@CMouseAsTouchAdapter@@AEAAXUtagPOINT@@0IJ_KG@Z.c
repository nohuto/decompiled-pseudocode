/*
 * XREFs of ?SendToTouchProcessor@CMouseAsTouchAdapter@@AEAAXUtagPOINT@@0IJ_KG@Z @ 0x1C0132A14
 * Callers:
        ...
        unsigned __int16 a7)
{
  ...
  HIDWORD(v14[3]) = a4;
  v14[12] = a6;
  CTouchProcessor::ProcessMouseInput((CTouchProcessor *)(unsigned int)(a2.y - v11), v12, (struct RIMCOMPLETEFRAME *)v13);
}
