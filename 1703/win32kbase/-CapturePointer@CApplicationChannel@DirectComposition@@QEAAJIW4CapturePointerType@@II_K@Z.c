/*
 * XREFs of ?CapturePointer@CApplicationChannel@DirectComposition@@QEAAJIW4CapturePointerType@@II_K@Z @ 0x1C0140818
 * Callers:
 ...
 *     ?OwnsPointerId@CInputManager@@SA_NII@Z @ 0x1C01505D4 (-OwnsPointerId@CInputManager@@SA_NII@Z.c)
 */
        ...
        __int64 a6)
{
  ...
  if ( !CInputManager::OwnsPointerId(*(_DWORD *)(a1 + 712), a4) )
    return (unsigned int)-1073741790;
  v11 = (unsigned int)(a2 - 1);
  if ( a2 && v11 < *(_QWORD *)(a1 + 88) )
  {
    _mm_lfence();
    v12 = *(struct DirectComposition::CResourceMarshaler **)(v11 * *(_QWORD *)(a1 + 96) + *(_QWORD *)(a1 + 64));
  }
  else
  {
    v12 = 0LL;
