/*
 * XREFs of rimPopulateContactFrameData @ 0x1C01135C0
 * Callers:
        ...
        _QWORD *a13)
{
  ...
  v17 = *(_DWORD *)(v13 + 1412);
  v18 = a7 + 2328;
  v24 = *(struct _HIDP_PREPARSED_DATA **)(*(_QWORD *)(a2 + 456) + 16LL);
  *a8 = 0;
  *a9 = 0;
  *a10 = 0;
  *a11 = 0;
  ...
  if ( PointerDeviceUsages >= 0 )
  {
    if ( !*a8 )
    {
      ...
      *(_DWORD *)(a7 + 2320) ^= (*(_DWORD *)(a7 + 2320) ^ ~(*(_DWORD *)(a7 + 2404) >> 22)) & 4;
      rimTransformGeometry(v13, -__CFSHR__(*(_DWORD *)(a2 + 184), 25), v22, v18, (__int64)a13, (__int64)a12);
    }
  }
  else
  {
