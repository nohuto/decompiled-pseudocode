/*
 * XREFs of ?HandleCapture_BreakHasMouseOwner@CMouseProcessor@@AEAA?AVCInputDest@@AEBV2@AEBVCButtonEvent@1@@Z @ 0x1C00462F8
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  v5 = (volatile __int32 *)(a1 + 2544);
  CInputDest::CInputDest(a2, (const struct CInputDest *)(a1 + 2544));
