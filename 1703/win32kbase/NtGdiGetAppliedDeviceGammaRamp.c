/*
 * XREFs of NtGdiGetAppliedDeviceGammaRamp @ 0x1C00FAAF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetAppliedDeviceGammaRamp(HDC a1, unsigned __int64 a2)
{
...
LABEL_3:
  ...
  if ( v4 )
  {
    ...
    v17 = (CTouchProcessor *)v2;
    if ( v2 >= (unsigned __int64)W32UserProbeAddress )
      v17 = W32UserProbeAddress;
    *(_BYTE *)v17 = *(_BYTE *)v17;
    *((_BYTE *)v17 + 1535) = *((_BYTE *)v17 + 1535);
    v18 = v7;
    do
    {
      *(_OWORD *)v2 = *v18;
