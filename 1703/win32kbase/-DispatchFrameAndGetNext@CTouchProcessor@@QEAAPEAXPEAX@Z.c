/*
 * XREFs of ?DispatchFrameAndGetNext@CTouchProcessor@@QEAAPEAXPEAX@Z @ 0x1C011DD00
 * Callers:
 *     <none>
 * Callees:
...
char *__fastcall CTouchProcessor::DispatchFrameAndGetNext(CTouchProcessor *this, void *a2)
{
  ...
  v5 = 0LL;
  if ( v4 && v4 != (CTouchProcessor *)((char *)this + 256) )
    v5 = (char *)v4 - 8;
  CTouchProcessor::DoContactVisualizationAndGenerateMessages(
    ...
    *((void **)a2 + 8),
    -__CFSHR__(*(_DWORD *)(*((_QWORD *)a2 + 14) + 260LL), 6),
    -__CFSHR__(*(_DWORD *)(*((_QWORD *)a2 + 14) + 260LL), 7),
    0);
  if ( !v9 )
  {
    v6 = (PERESOURCE *)v8;
