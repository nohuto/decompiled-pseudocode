/*
 * XREFs of EngAllocUserMemEx @ 0x1C007DBBC
 * Callers:
 ...
 *     EngAllocUserMem @ 0x1C007DAA0 (EngAllocUserMem.c)
 * Callees:
...
__int64 __fastcall EngAllocUserMemEx(ULONG_PTR a1, int a2, PVOID *a3)
{
  ...
  *a3 = 0LL;
  ...
  CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v6, v5, v8);
  ...
  if ( CurrentProcessWin32Process )
  {
    ...
    LOBYTE(NewElement) = 0;
    Buffer[2] = v7;
    PUSHLOCKEX::PUSHLOCKEX((PUSHLOCKEX *)&v15, (struct _EX_PUSH_LOCK *)(CurrentProcessWin32Process + 80));
    if ( !RtlInsertElementGenericTableAvl((PRTL_AVL_TABLE)(v10 + 88), Buffer, 0x18u, (PBOOLEAN)&NewElement)
      || !(_BYTE)NewElement )
    {
