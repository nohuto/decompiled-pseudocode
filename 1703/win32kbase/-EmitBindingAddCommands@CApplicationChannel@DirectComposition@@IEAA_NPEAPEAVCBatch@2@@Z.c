/*
 * XREFs of ?EmitBindingAddCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C001C228
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( *((_QWORD *)this + 57) )
  {
    do
    {
      ...
      *(_QWORD *)(v5 + 12) = 0LL;
      *((_DWORD *)v5 + 1) = 166;
      *((_DWORD *)v5 + 2) = *(_DWORD *)((***(__int64 (__fastcall ****)(_QWORD))(*((_QWORD *)this + 57) + 24LL))(*(_QWORD *)(*((_QWORD *)this + 57) + 24LL))
                                      + 24);
      *((_DWORD *)v5 + 3) = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 57) + 16LL) + 24LL);
      *((_DWORD *)v5 + 4) = *(_DWORD *)(*((_QWORD *)this + 57) + 12LL);
      *(_DWORD *)(*((_QWORD *)this + 57) + 8LL) = *(_DWORD *)(*((_QWORD *)this + 57) + 8LL) & 0xFFFFFFFC | 1;
