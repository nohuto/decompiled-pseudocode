/*
 * XREFs of ?_CreateCompositionInputSink@@YAJPEBUCOMPOSITION_INPUT_SINK@@HPEAPEAX@Z @ 0x1C000C7B4
 * Callers:
 *     NtCreateCompositionInputSink @ 0x1C000BD50 (NtCreateCompositionInputSink.c)
 *     NtCreateImplicitCompositionInputSink @ 0x1C000C080 (NtCreateImplicitCompositionInputSink.c)
 * Callees:
