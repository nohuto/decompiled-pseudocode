/*
 * XREFs of WPP_RECORDER_SF_Dd @ 0x1C01035FC
 * Callers:
...
__int64 WPP_RECORDER_SF_Dd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      43LL,
      &WPP_e5398ad4ff56352cfa5f0c085337fff4_Traceguids,
      15LL,
      (__int64 *)va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 15;
  return WppAutoLogTrace(a1, 2LL, 17LL, &WPP_e5398ad4ff56352cfa5f0c085337fff4_Traceguids, v7, (__int64 *)va, 4LL, va1);
}
