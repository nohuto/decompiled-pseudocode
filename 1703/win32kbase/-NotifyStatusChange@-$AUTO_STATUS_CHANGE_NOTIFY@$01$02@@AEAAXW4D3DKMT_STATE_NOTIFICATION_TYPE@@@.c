/*
 * XREFs of ?NotifyStatusChange@?$AUTO_STATUS_CHANGE_NOTIFY@$01$02@@AEAAXW4D3DKMT_STATE_NOTIFICATION_TYPE@@@Z @ 0x1C008D4B4
 * Callers:
...
__int64 __fastcall AUTO_STATUS_CHANGE_NOTIFY<2,3>::NotifyStatusChange(__int64 *a1, int a2)
{
  ...
  v7 = *a1;
  v6 = a2;
  result = ((__int64 (__fastcall *)(int *))qword_1C018BB68)(&v6);
  if ( (int)result < 0 )
  {
