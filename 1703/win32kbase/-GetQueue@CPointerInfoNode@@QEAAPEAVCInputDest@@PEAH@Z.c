/*
 * XREFs of ?GetQueue@CPointerInfoNode@@QEAAPEAVCInputDest@@PEAH@Z @ 0x1C0122124
 * Callers:
...
LABEL_8:
    ...
    if ( !v20 )
    {
      ...
      v7 = *(struct _ERESOURCE **)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels + 200LL);
      *(_QWORD *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels + 232LL) = 0LL;
      ...
      CInpLockGuard::LockExclusive((PERESOURCE *)(v6 + 200));
