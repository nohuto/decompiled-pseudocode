/*
 * XREFs of ?EndQFrameNodeDeferment@CTouchProcessor@@AEAAXPEAUCPointerQFrame@@PEAUCPointerInfoNode@@PEAUCPointerInputFrame@@_K@Z @ 0x1C011E2A0
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  *((_QWORD *)a2 + 1) = a5;
  ...
  CInputDest::CInputDest(
    (CInputDest *)v12,
    *((struct tagWND *const *)gpKernelHandleTable + 2 * (unsigned __int16)*((_DWORD *)a3 + 68)));
  if ( HIDWORD(v13) )
  {
    v11[0] = v12[0];
    v11[1] = v12[1];
