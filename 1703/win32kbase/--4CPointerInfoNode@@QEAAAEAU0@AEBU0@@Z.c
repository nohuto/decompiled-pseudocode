/*
 * XREFs of ??4CPointerInfoNode@@QEAAAEAU0@AEBU0@@Z @ 0x1C011A604
 * Callers:
...
__int64 __fastcall CPointerInfoNode::operator=(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 4) = v40;
  v41 = v40 ^ (*(_DWORD *)(a2 + 4) ^ v40) & 0x100;
  *(_DWORD *)(a1 + 4) = v41;
  v42 = v41 ^ (*(_DWORD *)(a2 + 4) ^ v41) & 0x200;
  *(_DWORD *)(a1 + 4) = v42;
  v43 = v42 ^ (*(_DWORD *)(a2 + 4) ^ v42) & 0x400;
  *(_DWORD *)(a1 + 4) = v43;
  v44 = v43 ^ (*(_DWORD *)(a2 + 4) ^ v43) & 0x800;
  *(_DWORD *)(a1 + 4) = v44;
  *(_DWORD *)(a1 + 4) = v44 ^ (*(_DWORD *)(a2 + 4) ^ v44) & 0x1000;
  ...
  *(_DWORD *)(a1 + 404) = *(_DWORD *)(a2 + 404);
  CInputDest::operator=(a1 + 408, a2 + 408);
  return a1;
}
