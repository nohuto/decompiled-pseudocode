/*
 * XREFs of ?EnableDxgkrnlIndependentFlipMode@CFlipExBuffer@@IEAAJIIIPEAH@Z @ 0x1C0151A8C
 * Callers:
        ...
        int *a5)
{
  ...
  if ( *((_DWORD *)this + 60) )
  {
    v10 = *((_QWORD *)this + 28);
    Handle = 0LL;
    v9 = CBufferRealization::OpenDxSurfaceHandle((CBufferRealization *)(v10 - 8), 0, 1, &Handle);
    if ( v9 >= 0 )
    {
      v11 = *((_QWORD *)this + 2);
      v13 = *((_QWORD *)this + 1);
