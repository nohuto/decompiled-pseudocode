/*
 * XREFs of efSin @ 0x1C008C380
 * Callers:
 *     efCos @ 0x1C008C360 (efCos.c)
 ...
 *     eFraction @ 0x1C008DBB8 (eFraction.c)
 */
...
__int64 __fastcall efSin(int a1)
{
  ...
  if ( ((v10 >> 5) & 1) != 0 )
  {
    ...
    v7.m128_f32[0] = (float)(v7.m128_f32[0] - gaefSin[v5 - 1]) * v3;
  ...
  else
  {
    ...
    v8.m128_f32[0] = (float)((float)(v8.m128_f32[0] - gaefSin[v10 & 0x1F]) * v3) + gaefSin[v10 & 0x1F];
  }
  if ( v1 )
