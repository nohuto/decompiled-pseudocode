/*
 * XREFs of Template_qqxx @ 0x1C00DDAC0
 * Callers:
 *     EtwGdiSysMemToken @ 0x1C008E300 (EtwGdiSysMemToken.c)
 *     EtwTraceTokenIndependentFlipSkipCompleteEvent @ 0x1C00DA740 (EtwTraceTokenIndependentFlipSkipCompleteEvent.c)
 * Callees:
