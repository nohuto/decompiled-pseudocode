/*
 * XREFs of ?CompleteAddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIIVResourceHandle@@HI0@Z @ 0x1C0019AFC
 * Callers:
...
LABEL_8:
  if ( a4 )
  {
    ...
    {
      _mm_lfence();
      v24 = *(DirectComposition::CResourceMarshaler **)(v23 * *((_QWORD *)a1 + 12) + *((_QWORD *)a1 + 8));
    }
    if ( v24 )
    {
