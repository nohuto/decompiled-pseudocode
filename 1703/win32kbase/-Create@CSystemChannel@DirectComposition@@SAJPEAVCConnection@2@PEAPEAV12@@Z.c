/*
 * XREFs of ?Create@CSystemChannel@DirectComposition@@SAJPEAVCConnection@2@PEAPEAV12@@Z @ 0x1C0082154
 * Callers:
        ...
        struct DirectComposition::CSystemChannel **a2)
{
  ...
  v4 = (DirectComposition::CApplicationChannel *)Win32AllocPoolZInit(0x330uLL, 1668498244LL);
  v5 = v4;
  if ( v4 )
  {
