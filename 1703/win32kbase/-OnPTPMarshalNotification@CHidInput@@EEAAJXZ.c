/*
 * XREFs of ?OnPTPMarshalNotification@CHidInput@@EEAAJXZ @ 0x1C012C6D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHidInput::OnPTPMarshalNotification(CHidInput *this)
{
  ...
  v3[0] = 0LL;
  v3[1] = 0LL;
  v1 = *((_DWORD *)this + 172) != 0 ? 17256 : 872;
  HIDWORD(v4) = *((_DWORD *)this + 170);
  if ( (*((_WORD *)this + 334) & 0x1800) == 0x800 )
    WORD2(v3[0]) = 1024;
  else
    WORD2(v3[0]) = 2048;
  HIWORD(v3[0]) = *((_WORD *)this + 332);
