/*
 * XREFs of ?SetIntegerProperty@CTableTransferEffectMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C0148560
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  switch ( a3 )
  {
    case 4:
      *a5 = v5 != (*((_BYTE *)this + 152) & 1);
      v6 = *((_BYTE *)this + 152) & 0xFE;
      goto LABEL_11;
    case 5:
      *a5 = v5 != ((*((_BYTE *)this + 152) & 2) != 0);
      v6 = *((_BYTE *)this + 152) & 0xFD;
      v5 *= 2;
      goto LABEL_11;
    case 6:
      *a5 = v5 != ((*((_BYTE *)this + 152) & 4) != 0);
      v6 = *((_BYTE *)this + 152) & 0xFB;
      v5 *= 4;
      goto LABEL_11;
    case 7:
      *a5 = v5 != ((*((_BYTE *)this + 152) & 8) != 0);
      v6 = *((_BYTE *)this + 152) & 0xF7;
      v5 *= 8;
      goto LABEL_11;
    case 8:
      *a5 = v5 != ((*((_BYTE *)this + 152) & 0x10) != 0);
      v6 = *((_BYTE *)this + 152) & 0xEF;
      v5 *= 16;
LABEL_11:
      *((_BYTE *)this + 152) = v5 | v6;
      return 0LL;
  }
