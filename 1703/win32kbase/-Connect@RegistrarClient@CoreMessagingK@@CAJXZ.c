/*
 * XREFs of ?Connect@RegistrarClient@CoreMessagingK@@CAJXZ @ 0x1C006A39C
 * Callers:
...
__int64 CoreMessagingK::RegistrarClient::Connect(void)
{
  ...
  _BYTE v26[32]; // [rsp+1D8h] [rbp+D8h] BYREF
  ...
  *((_QWORD *)&v6 + 1) = L"\\BaseNamedObjects\\CoreMessagingRegistrar";
  ...
  if ( dword_1C0186C30 > 5u )
  {
    ...
    v23 = &v5;
    v24 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C0186C30, &unk_1C016BD55, 0LL, v2, 3u, &pData);
  }
