/*
 * XREFs of ?bXform@EXFORMOBJ@@QEAAHPEAU_VECTORL@@PEAU_VECTORFX@@_K@Z @ 0x1C0096A90
 * Callers:
 *     ?bOldPenNominal@DC@@QEAAHAEAVEXFORMOBJ@@J@Z @ 0x1C00967B0 (-bOldPenNominal@DC@@QEAAHAEAVEXFORMOBJ@@J@Z.c)
 * Callees:
...
__int64 __fastcall EXFORMOBJ::bXform(EXFORMOBJ *this, struct _VECTORL *a2, struct _VECTORFX *a3, __int64 a4)
{
  ...
  if ( (*(_DWORD *)(v4 + 32) & 2) != 0 )
  {
    ...
    else
    {
      ...
      {
        v7 = *((_DWORD *)a2 + 1);
        if ( (unsigned int)(*(_DWORD *)a2 + 134217726) > 0xFFFFFFC || (unsigned int)(v7 + 134217726) > 0xFFFFFFC )
          break;
