/*
 * XREFs of ??0PDEVOBJ@@QEAA@PEAUHDEV__@@K@Z @ 0x1C00E936C
 * Callers:
...
PDEVOBJ *__fastcall PDEVOBJ::PDEVOBJ(PDEVOBJ *this, char *a2)
{
  ...
  __int64 v44; // rcx
  __int64 v45; // rcx
  _BYTE v47[80]; // [rsp+20h] [rbp-68h] BYREF
  char *v48; // [rsp+90h] [rbp+8h] BYREF

  *(_QWORD *)this = 0LL;
  v48 = a2;
  if ( a2 && (*((_DWORD *)a2 + 8) & 1) != 0 )
  {
    DEVLOCKOBJ::DEVLOCKOBJ((DEVLOCKOBJ *)v47, (struct PDEVOBJ *)&v48);
...
LABEL_40:
    v41 = *(struct _ERESOURCE **)(*(_QWORD *)this + 40LL);
    if ( v41 )
      GreDeleteSemaphore(v41);
    v42 = *(_QWORD *)(*(_QWORD *)this + 2608LL);
    if ( v42 )
      Win32FreePool(v42);
    v43 = *(_QWORD *)(*(_QWORD *)this + 1704LL);
    if ( v43 )
    {
      Win32FreePool(v43);
      *(_QWORD *)(*(_QWORD *)this + 1704LL) = 0LL;
    }
    v44 = *(_QWORD *)(*(_QWORD *)this + 1712LL);
    if ( v44 )
    {
      Win32FreePool(v44);
      *(_QWORD *)(*(_QWORD *)this + 1712LL) = 0LL;
    }
    v45 = *(_QWORD *)(*(_QWORD *)this + 1720LL);
    if ( v45 )
    {
      Win32FreePool(v45);
