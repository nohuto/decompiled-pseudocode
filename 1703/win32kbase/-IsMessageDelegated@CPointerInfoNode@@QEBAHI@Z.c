/*
 * XREFs of ?IsMessageDelegated@CPointerInfoNode@@QEBAHI@Z @ 0x1C0122ABC
 * Callers:
 ...
 * Callees:
 *     ?IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z @ 0x1C0122A98 (-IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z.c)
 */
