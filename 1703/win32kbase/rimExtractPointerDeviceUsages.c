/*
 * XREFs of rimExtractPointerDeviceUsages @ 0x1C011294C
 * Callers:
 ...
 *     RIMEnsureUsageWithinLogicalBoundary @ 0x1C0110CFC (RIMEnsureUsageWithinLogicalBoundary.c)
 ...
 *     rimExtractGeometryPoints @ 0x1C01124C0 (rimExtractGeometryPoints.c)
...
LABEL_21:
  ...
  if ( (*(_DWORD *)(a1 + 260) & 0x800) != 0 && *(_WORD *)v11 == 1 && (unsigned __int16)(v21 - 48) <= 1u )
  {
