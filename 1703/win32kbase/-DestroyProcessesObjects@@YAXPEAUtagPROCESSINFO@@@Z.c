/*
 * XREFs of ?DestroyProcessesObjects@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C0040840
 * Callers:
 ...
 *     FixupGlobalCursor @ 0x1C008D650 (FixupGlobalCursor.c)
 */
...
void __fastcall DestroyProcessesObjects(struct tagPROCESSINFO *a1)
{
  ...
  if ( qword_1C018DCD0 )
  {
    ...
    if ( (unsigned int)GreGetObjectOwner(qword_1C018DCC8, 1LL) == (CurrentProcessId & 0xFFFFFFFC) )
      StopFade();
  }
  ...
  while ( v4 );
  v6 = (char *)qword_1C0189E38;
  v7 = gpKernelHandleTable;
  v8 = (char *)qword_1C0189E38 + 32 * (unsigned int)giheLast;
  if ( qword_1C0189E38 <= v8 )
  {
    do
    {
      v9 = v6[24];
      if ( v9 && (*((_BYTE *)&unk_1C015ED5C + 24 * v9) & 2) != 0 && (struct tagPROCESSINFO *)v7[1] == a1 )
      {
        if ( v2 && v9 == 3 )
