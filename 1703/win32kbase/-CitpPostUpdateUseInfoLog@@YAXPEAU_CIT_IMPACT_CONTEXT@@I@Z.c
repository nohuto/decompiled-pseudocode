/*
 * XREFs of ?CitpPostUpdateUseInfoLog@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z @ 0x1C0084864
 * Callers:
...
void __fastcall CitpPostUpdateUseInfoLog(struct _CIT_IMPACT_CONTEXT *a1, int a2)
{
  ...
  int v133; // [rsp+3C0h] [rbp+2B8h] BYREF
  ...
  if ( *((_WORD *)a1 + 324) )
  {
    ...
    if ( dword_1C0186860 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0186860, 0x800000000800uLL) )
    {
      ...
      v130 = 8LL;
      v132 = 2LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0186860, &unk_1C016AC14, 0LL, v3, 0x2Bu, &pData);
    }
