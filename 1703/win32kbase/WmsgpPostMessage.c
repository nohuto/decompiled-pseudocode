/*
 * XREFs of WmsgpPostMessage @ 0x1C01BD11C
 * Callers:
 *     PostWinlogonMessage @ 0x1C00669C0 (PostWinlogonMessage.c)
 * Callees:
 *     ClientI_WMsgkSendMessage @ 0x1C0066A30 (ClientI_WMsgkSendMessage.c)
 *     WMsg_midl_user_allocate @ 0x1C0066A70 (WMsg_midl_user_allocate.c)
 *     WMsg_midl_user_free @ 0x1C013E1E0 (WMsg_midl_user_free.c)
 */
