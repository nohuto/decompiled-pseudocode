/*
 * XREFs of Template_pppqqqqpppqqqq @ 0x1C00DC17C
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x1C0091780 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1C00FCFA0 (EtwWindowRendering.c)
 * Callees:
...
NTSTATUS Template_pppqqqqpppqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  __int64 v31; // [rsp+158h] [rbp+58h] BYREF
  va_list va; // [rsp+158h] [rbp+58h]
  __int64 v33; // [rsp+160h] [rbp+60h] BYREF
