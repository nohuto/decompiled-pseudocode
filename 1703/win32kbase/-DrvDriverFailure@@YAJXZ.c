/*
 * XREFs of ?DrvDriverFailure@@YAJXZ @ 0x1C00E620C
 * Callers:
 *     ?UserInitialize@@YAJXZ @ 0x1C0074A90 (-UserInitialize@@YAJXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C009D0D0 (__security_check_cookie.c)
 *     memset @ 0x1C00A2500 (memset.c)
 *     ??4tagKERNELDISPLAYINFO@@QEAAAEAU0@AEBU0@@Z @ 0x1C00E6044 (--4tagKERNELDISPLAYINFO@@QEAAAEAU0@AEBU0@@Z.c)
...
__int64 DrvDriverFailure(void)
{
  ...
  _QWORD v13[40]; // [rsp+90h] [rbp-70h] BYREF
