/*
 * XREFs of FastGetProfileValue @ 0x1C00735B0
 * Callers:
        ...
        int a7)
{
  ...
  for ( i = OpenCacheKeyEx(Source, a2, 0x20019u, &v17); ; i = OpenCacheKeyEx(Source, v18, 0x20019u, &v17) )
  {
    v12 = i;
    if ( !i )
    {
...
LABEL_12:
    ...
    {
      Length = Size + 12;
      v13 = (ULONG *)Win32AllocPoolWithQuota((unsigned int)(Size + 12), 0x72707355u);
      if ( !v13 )
        goto LABEL_12;
    }
    else
