/*
 * XREFs of ?DrvUpdateDpiInfoOnOptimizedModeChange@@YAJPEAU_MDEV@@PEAE@Z @ 0x1C00F7C00
 * Callers:
...
__int64 __fastcall DrvUpdateDpiInfoOnOptimizedModeChange(struct _MDEV *a1, unsigned __int8 *a2)
{
  ...
  __int64 v18; // r8
  _QWORD *v19; // rax
  _OWORD Buf1[6]; // [rsp+30h] [rbp-98h] BYREF
  ...
  *a2 = 0;
  if ( a1 )
  {
    for ( i = 0LL; (unsigned int)i < *((_DWORD *)a1 + 5); i = (unsigned int)(i + 1) )
    {
      ...
      Buf1[4] = v13;
      Buf1[5] = v14;
      v15 = ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64, __int64))qword_1C018BC78)(
              v9,
              v10,
              0xFFFFFFFFLL,
              v6 + 2152,
