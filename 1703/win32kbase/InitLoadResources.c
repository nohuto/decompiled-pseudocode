/*
 * XREFs of InitLoadResources @ 0x1C00743E0
 * Callers:
 ...
 *     SetDpiDepSysMet @ 0x1C0074720 (SetDpiDepSysMet.c)
 */

unsigned __int64 __fastcall InitLoadResources(int a1)
{
  ...
  *((_DWORD *)gpsi + 516) = 2;
  *((_DWORD *)gpsi + 477) = 3;
  result = (unsigned __int64)gpsi;
  *((_DWORD *)gpsi + 478) = 3;
  if ( !a1 && (!gbRemoteSession || gbFirstInteractiveSession) )
  {
    v11 = *(_QWORD *)(*((_QWORD *)gpDispInfo + 11) + 40LL);
    ...
    *((_DWORD *)gpsi + 1337) = *(_DWORD *)(v11 + 56) / 2;
    v12 = *(_QWORD *)(*((_QWORD *)gpDispInfo + 11) + 40LL);
    ...
    *((_DWORD *)gpsi + 1339) = *(_DWORD *)(v12 + 72) / 2;
    v13 = *(_QWORD *)(*((_QWORD *)gpDispInfo + 11) + 40LL);
