/*
 * XREFs of ?LogDeviceRemovedEvent@CHidInput@@AEAAXGIIKKHPEAU_UNICODE_STRING@@0@Z @ 0x1C004E8FC
 * Callers:
        ...
        struct _UNICODE_STRING *a9)
{
  ...
  if ( dword_1C0186860 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0186860, 0x800000000000uLL) )
    {
      ...
      v29 = 2LL;
      v31[1] = 0;
      TlgWrite((TraceLoggingHProvider)&dword_1C0186860, &unk_1C016A843, 0LL, v9, 0xCu, &pData);
    }
  }
}
