/*
 * XREFs of ?SetResourceReferenceArrayProperty@CApplicationChannel@DirectComposition@@QEAAJIIPEBI_K@Z @ 0x1C001ADD8
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( a2 && v7 < *((_QWORD *)this + 11) )
  {
    _mm_lfence();
    v11 = *(struct DirectComposition::CResourceMarshaler **)(v7 * *((_QWORD *)this + 12) + *((_QWORD *)this + 8));
  }
  else
  {
    v11 = 0LL;
  ...
  if ( a5 )
  {
    ...
    do
    {
      ...
      v15 = a4[v14];
      v16 = v15 - 1;
      if ( v15 && v16 < *((_QWORD *)this + 11) )
        v17 = *(_QWORD *)(v16 * *((_QWORD *)this + 12) + *((_QWORD *)this + 8));
      else
        v17 = 0LL;
      *(_QWORD *)(v5 + 8 * v14) = v17;
      if ( !v17 )
  ...
  if ( v13 >= 0 )
  {
    v13 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, _QWORD, __int64, unsigned __int64, char *))(*(_QWORD *)v11 + 176LL))(
            v11,
            this,
            a3,
            v5,
