/*
 * XREFs of ?wil_details_RecordUsageInPropertyCache@@YA?AUwil_details_RecordUsageResult@@PEATwil_details_FeaturePropertyCache@@W4wil_details_ServiceReportingKind@@II@Z @ 0x1C00D5D3C
 * Callers:
...
LABEL_18:
      ...
      {
        v10 = (union wil_details_FeaturePropertyCache *)(unsigned int)(a3 - 320);
        if ( (_DWORD)v10 == ((Feature_BrokeredDisplays_RotMgr__private_propertyCache >> 7) & 0x3F) )
        {
          if ( (Feature_BrokeredDisplays_RotMgr__private_propertyCache & 0x40) != 0 )
          {
            v7[4] = 1;
            return v7;
          }
