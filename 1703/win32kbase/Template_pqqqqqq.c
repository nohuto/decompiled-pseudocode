/*
 * XREFs of Template_pqqqqqq @ 0x1C00FD054
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C007C9A0 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C0083F00 (EtwDevLockEndTightUpdate.c)
 * Callees:
