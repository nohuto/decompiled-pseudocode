/*
 * XREFs of RIMGetPhysicalSizeFromMonitor @ 0x1C0107F30
 * Callers:
...
__int64 __fastcall RIMGetPhysicalSizeFromMonitor(__int64 a1)
{
  ...
  v2 = 0;
  v8 = 0;
  v3 = *((_QWORD *)gpDispInfo + 11);
  v9 = 0;
  MonitorPhysicalDimensions = GetMonitorPhysicalDimensions(*(_QWORD *)(v3 + 120), &v8, &v9, 0LL);
