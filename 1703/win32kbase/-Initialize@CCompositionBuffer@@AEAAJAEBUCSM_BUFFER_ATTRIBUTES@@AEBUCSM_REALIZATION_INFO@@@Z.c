/*
 * XREFs of ?Initialize@CCompositionBuffer@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@@Z @ 0x1C0151758
 * Callers:
        ...
        const struct CSM_REALIZATION_INFO *a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *((_OWORD *)this + 9) = *((_OWORD *)a2 + 6);
    ...
    {
      v8 = v11;
      v6 = (*((__int64 (__fastcall **)(struct CRegion **, struct CBufferRealization *))*this + 23))(this, v11);
      if ( v6 < 0 )
      {
        if ( v8 )
