/*
 * XREFs of ?DoTPDiscreteButtonProcessing@CPTPEngine@@AEAAHPEAUPTPInput@@PEAH1@Z @ 0x1C0134558
 * Callers:
...
LABEL_8:
  v5 = 1;
  *((_DWORD *)this + 805) = *((_DWORD *)this + 805) & 0xFFFFFFFD | (2 * v12);
  if ( v9 )
  {
...
LABEL_22:
  v20 = 1;
  *((_DWORD *)this + 805) = (4 * v14) | *((_DWORD *)this + 805) & 0xFFFFFFFB;
  if ( v13 )
    CPTPEngine::TPAAPSetCurtainState(this, 0);
  *a4 = 1;
LABEL_26:
  ...
  if ( v5 )
  {
        ...
        if ( (v23 & 0x40000) != 0 )
        {
          ...
          *((_DWORD *)this + 805) = v24;
          if ( (v24 & 0x10) == 0 )
          {
            ...
            CBasePTPEngine::SendMouseOutput(this, 3LL, *(_QWORD *)((char *)a2 + 28), *((unsigned int *)a2 + 6));
            *((_DWORD *)this + 805) |= 0x10u;
          }
        }
        else
        {
          ...
          *((_DWORD *)this + 805) = v25;
          if ( (v25 & 8) == 0 )
          {
            ...
            CBasePTPEngine::SendMouseOutput(this, 1LL, *(_QWORD *)((char *)a2 + 28), *((unsigned int *)a2 + 6));
            *((_DWORD *)this + 805) |= 8u;
          }
        }
      }
    ...
    else
    {
      ...
      else
      {
        ...
        {
          *((_QWORD *)this + 397) = *(_QWORD *)a2;
          CBasePTPEngine::SendMouseOutput(this, 2LL, *(_QWORD *)((char *)a2 + 28), *((unsigned int *)a2 + 6));
          *((_DWORD *)this + 805) &= ~8u;
        }
        *((_DWORD *)this + 805) &= ~0x20u;
      }
    }
  }
  if ( v20 )
