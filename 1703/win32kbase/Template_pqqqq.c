/*
 * XREFs of Template_pqqqq @ 0x1C00DC4D4
 * Callers:
 *     EtwDirtyRectUpdate @ 0x1C007C930 (EtwDirtyRectUpdate.c)
 *     EtwTraceTimerProc @ 0x1C007D260 (EtwTraceTimerProc.c)
 *     EtwTraceInternalSetTimer @ 0x1C007E6C0 (EtwTraceInternalSetTimer.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C00FCCA0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C00FCCE0 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C00FCEE0 (EtwTranslationUpdate.c)
 * Callees:
