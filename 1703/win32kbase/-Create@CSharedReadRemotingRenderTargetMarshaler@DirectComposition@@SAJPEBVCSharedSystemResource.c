/*
 * XREFs of ?Create@CSharedReadRemotingRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C014FD0C
 * Callers:
 *     CreateSharedReadRemotingRenderTargetMarshaler @ 0x1C014FF20 (CreateSharedReadRemotingRenderTargetMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadRemotingRenderTargetMarshaler **a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CSharedReadRemotingRenderTargetMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 240LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
