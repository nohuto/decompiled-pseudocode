/*
 * XREFs of OpenCacheKeyEx @ 0x1C0044A10
 * Callers:
 ...
 *     FastWriteProfileStringW @ 0x1C0091D10 (FastWriteProfileStringW.c)
...
void *__fastcall OpenCacheKeyEx(PCUNICODE_STRING Source, unsigned int a2, ACCESS_MASK a3, int *a4)
{
  ...
  PCUNICODE_STRING v23; // [rsp+58h] [rbp-A8h]
...
LABEL_7:
      *(_DWORD *)&Destination.Length = 0x2000000;
      ...
      {
        if ( *off_1C015F810[dword_1C015F480[4 * v5]] == 77 )
        {
          RtlAppendUnicodeToString(&Destination, L"\\Registry\\Machine\\");
        }
        else
        ...
        else if ( (v10 & 8) != 0 )
        {
          ...
          RtlStringCchPrintfW(pszDest, 0x20uLL, L"%ld\\", (unsigned int)gSessionId);
      ...
      v10 &= v11;
      RtlAppendUnicodeToString(&Destination, off_1C015F810[dword_1C015F480[4 * v5]] + 1);
      RtlAppendUnicodeToString(&Destination, (&off_1C015F488)[2 * v5]);
