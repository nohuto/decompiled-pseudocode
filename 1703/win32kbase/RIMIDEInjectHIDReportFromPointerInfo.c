/*
 * XREFs of RIMIDEInjectHIDReportFromPointerInfo @ 0x1C010A90C
 * Callers:
 ...
 *     RIMIDEFillContactUsageValues @ 0x1C010A284 (RIMIDEFillContactUsageValues.c)
...
__int64 __fastcall RIMIDEInjectHIDReportFromPointerInfo(char *a1, unsigned int *a2, unsigned int a3)
{
  ...
  if ( (unsigned int)BuildValueDeviceUsages(*a2, &v42, &v43) )
  {
    ...
    if ( !v6 )
    {
      if ( *a2 == 2 )
        v8 = v43 - 2;
      v7 = Win32AllocPoolZInit(12LL * (unsigned int)v9, 1785620818LL);
      v6 = 0;
      if ( !v7 )
      {
        v6 = 1;
