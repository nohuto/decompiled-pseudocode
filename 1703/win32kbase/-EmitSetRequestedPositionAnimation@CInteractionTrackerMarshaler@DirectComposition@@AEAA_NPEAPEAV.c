/*
 * XREFs of ?EmitSetRequestedPositionAnimation@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0145B3C
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v8) )
  {
    ...
    *((_DWORD *)v3 + 3) = 0;
    *((_DWORD *)v3 + 2) = v4;
    *((_DWORD *)v3 + 4) = (*((_BYTE *)this + 364) & 1) == 0;
