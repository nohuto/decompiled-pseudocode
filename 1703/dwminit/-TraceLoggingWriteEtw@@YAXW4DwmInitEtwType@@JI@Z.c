/*
 * XREFs of ?TraceLoggingWriteEtw@@YAXW4DwmInitEtwType@@JI@Z @ 0x180001518
 * Callers:
...
TLG_STATUS __fastcall TraceLoggingWriteEtw(int a1, int a2, const GUID *a3)
{
  ...
  if ( hProvider > 4u )
  {
    ...
    v17 = 2LL;
    v19 = 2LL;
    return TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18000991C, a3, (LPCGUID)4, 9u, &pData);
  }
  return result;
}
