/*
 * XREFs of ?CleanupOldDwmProcess@@YAJXZ @ 0x180002734
 * Callers:
 ...
 *     ?GetPrimaryDisplayDeviceInfo@@YA_NPEAU_DISPLAY_DEVICEW@@@Z @ 0x180002394 (-GetPrimaryDisplayDeviceInfo@@YA_NPEAU_DISPLAY_DEVICEW@@@Z.c)
