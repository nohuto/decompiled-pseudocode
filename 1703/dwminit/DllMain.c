...
BOOL __stdcall DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved)
{
  ...
  WCHAR ValueName[40]; // [rsp+108h] [rbp+0h] BYREF
  ...
  if ( fdwReason )
  {
    if ( fdwReason == 1 )
    {
      ...
      v8 = (GUID)*((_OWORD *)off_18000C008 - 1);
      qword_18000C028 = 0LL;
      qword_18000C030 = 0LL;
      hKey_8 = v8;
      if ( !EventRegister(&hKey_8, TlgEnableCallback, &hProvider, &RegHandle) )
        EventSetInformation(RegHandle, 2LL, off_18000C008, *(unsigned __int16 *)off_18000C008);
      if ( hProvider > 5u
        ...
        && (qword_18000C018 & 0x400000000000LL) == qword_18000C018 )
      {
        ...
        v23 = 2LL;
        v25 = 2LL;
        TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1800096E9, v9, v10, 6u, Data);
      }
      if ( byte_18000C050 )
      {
        if ( qword_18000C048 )
