/*
 * XREFs of ?RegGetHKLMDword@@YA_NQEBG0PEAK@Z @ 0x180003FE4
 * Callers:
 *     BreakForInstrumentation @ 0x180003EE8 (BreakForInstrumentation.c)
 * Callees:
 *     ?RegGetDword@@YA_NQEAUHKEY__@@QEBGPEAK@Z @ 0x180003F7C (-RegGetDword@@YA_NQEAUHKEY__@@QEBGPEAK@Z.c)
 */
