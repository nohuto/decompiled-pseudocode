/*
 * XREFs of ?ConnectWithNameNative@CPortClient@@AEAAJPEBG0@Z @ 0x180005180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPortClient::ConnectWithNameNative(HANDLE *this, const unsigned __int16 *a2, char *a3)
{
  ...
  *(_WORD *)&SecurityQos.ContextTrackingMode = 257;
  ...
  if ( !this[9] && *((_DWORD *)this + 15) )
  {
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR(1u, &CPortClient::MILINSTRUMENTATIONHRESULTLIST, 8LL, -2147024882, 0x102u);
      return v4;
    }
    *v9 = 48;
    *((_DWORD *)this[9] + 4) = 0;
