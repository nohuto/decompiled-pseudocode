/*
 * XREFs of ?AssertW@@YAXPEBG000K@Z @ 0x180004100
 * Callers:
 ...
 * Callees:
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x180004098 (-IsKernelDebuggerPresent@@YAHXZ.c)
 */
        ...
        unsigned int a5)
{
  ...
  v20 = a4;
  v5 = (const char *)&unk_180009388;
  v7 = (const char *)&unk_180009388;
  if ( a3 )
    v7 = ", ";
  v8 = (const wchar_t *)&unk_180008AF8;
  if ( a3 )
  {
    v8 = a3;
    v5 = "Function: ";
  }
  v9 = (const wchar_t *)&unk_180008AF8;
  v10 = (const wchar_t *)&unk_180008AF8;
  if ( a2 )
    v9 = a2;
  if ( a1 )
    v10 = a1;
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( !a1 || (v16 = L"\n***  ", !a2) )
        v16 = (const wchar_t *)&unk_180008AF8;
      DbgPrintEx(
        0x65u,
        0,
