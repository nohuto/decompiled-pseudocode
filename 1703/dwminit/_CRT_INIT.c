/*
 * XREFs of _CRT_INIT @ 0x180006BC4
 * Callers:
 *     __DllMainCRTStartup @ 0x180006E40 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x180007092 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800070F0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x180007240 (_initterm_0.c)
