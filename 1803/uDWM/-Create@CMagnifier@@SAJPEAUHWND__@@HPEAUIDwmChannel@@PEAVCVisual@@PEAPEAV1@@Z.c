/*
 * XREFs of ?Create@CMagnifier@@SAJPEAUHWND__@@HPEAUIDwmChannel@@PEAVCVisual@@PEAPEAV1@@Z @ 0x180078E40
 * Callers:
 ...
 *     ??0CMagnifier@@AEAA@PEAUHWND__@@HPEAUIDwmChannel@@PEAVCVisual@@@Z @ 0x180078CE4 (--0CMagnifier@@AEAA@PEAUHWND__@@HPEAUIDwmChannel@@PEAVCVisual@@@Z.c)
