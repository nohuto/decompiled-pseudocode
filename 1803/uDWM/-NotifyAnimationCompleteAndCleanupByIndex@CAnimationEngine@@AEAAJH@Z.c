/*
 * XREFs of ?NotifyAnimationCompleteAndCleanupByIndex@CAnimationEngine@@AEAAJH@Z @ 0x18000DF08
 * Callers:
...
__int64 __fastcall CAnimationEngine::NotifyAnimationCompleteAndCleanupByIndex(CAnimationEngine *this, unsigned int a2)
{
  ...
  *((_BYTE *)this + 112) = 1;
  ...
  if ( (unsigned int)v3 >= v12 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x589u);
  }
  else
  {
    v13 = v12 - 1;
