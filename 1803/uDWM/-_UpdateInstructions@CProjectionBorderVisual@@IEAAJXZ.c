/*
 * XREFs of ?_UpdateInstructions@CProjectionBorderVisual@@IEAAJXZ @ 0x18007FA40
 * Callers:
...
__int64 __fastcall CProjectionBorderVisual::_UpdateInstructions(CProjectionBorderVisual *this)
{
  ...
  if ( v2 >= 0 )
  {
    if ( *((_BYTE *)this + 296) )
    {
      ...
      *(struct _D3DCOLORVALUE *)&v10.r = (struct _D3DCOLORVALUE)xmmword_1800B9C88;
      if ( !v5 )
      {
        if ( !*((_DWORD *)this + 75) )
          v4 = 4;
      ...
      if ( v6 >= 0 )
      {
        InflateRect(
          &rc,
          -(int)((double)v4 * *((double *)CDesktopManager::s_pDesktopManagerInstance + 55)),
          -(int)((double)v4 * *((double *)CDesktopManager::s_pDesktopManagerInstance + 55)));
