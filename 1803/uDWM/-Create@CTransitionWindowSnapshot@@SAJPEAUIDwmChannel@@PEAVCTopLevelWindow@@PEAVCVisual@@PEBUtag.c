/*
 * XREFs of ?Create@CTransitionWindowSnapshot@@SAJPEAUIDwmChannel@@PEAVCTopLevelWindow@@PEAVCVisual@@PEBUtagRECT@@PEAPEAV1@@Z @ 0x1800046AC
 * Callers:
        ...
        struct CTransitionWindowSnapshot **a5)
{
  ...
  if ( dword_1800C9DB0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800C9DB0);
    if ( dword_1800C9DB0 == -1 )
    {
      dword_1800C9D54 = -2147023434;
      Init_thread_footer(&dword_1800C9DB0);
    }
  }
  *a5 = 0LL;
  ...
  if ( v10 )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C9D54, 1u, v12, 0x30u);
    }
    else
    {
  ...
  {
    v13 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800C9D54, 1u, -2147024882, 0x22u);
  }
  return v13;
}
