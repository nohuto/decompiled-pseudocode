/*
 * XREFs of ?_SetProjectionBorderForWindow@CProjectionBorderManager@@AEAAJPEAUHWND__@@_N@Z @ 0x18007EF80
 * Callers:
  ...
  if ( SyncedWindowDataByHwnd >= 0 )
  {
    ...
    if ( v12 && *((_QWORD *)v12 + 49) )
    {
      if ( a3 )
      {
        ...
        if ( !v8 )
        {
          CWindowList::ShowProjectionBorder(*((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 56), v12, 1);
          v8 = *((_DWORD *)v7 + 104);
        }
        *((_DWORD *)v7 + 104) = v8 + 1;
      }
      ...
      {
        CWindowList::ShowProjectionBorder(*((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 56), v7, 0);
      }
    }
    v6 = 0;
  }
