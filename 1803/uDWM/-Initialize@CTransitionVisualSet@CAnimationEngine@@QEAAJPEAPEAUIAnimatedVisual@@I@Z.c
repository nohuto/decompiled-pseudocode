/*
 * XREFs of ?Initialize@CTransitionVisualSet@CAnimationEngine@@QEAAJPEAPEAUIAnimatedVisual@@I@Z @ 0x18000F3CC
 * Callers:
    ...
    if ( a3 )
    {
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v10 * 8 + *((_QWORD *)this + 3)) = v12;
        ...
        if ( v15 < 0 )
          break;
        v16 = (**(__int64 (__fastcall ***)(struct IAnimatedVisual *, _QWORD))a2[v10])(a2[v10], *(unsigned int *)this);
        v6 = v16;
        if ( v16 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x647u);
          goto LABEL_13;
        }
        ++v9;
        ++v10;
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x646u);
LABEL_13:
      if ( v6 < 0 )
        goto LABEL_22;
    }
