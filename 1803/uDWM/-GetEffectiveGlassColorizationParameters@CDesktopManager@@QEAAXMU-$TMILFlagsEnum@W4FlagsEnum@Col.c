/*
 * XREFs of ?GetEffectiveGlassColorizationParameters@CDesktopManager@@QEAAXMU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@_NPEAVCGlassColorizationParameters@@@Z @ 0x18006C534
 * Callers:
        ...
        _OWORD *a5)
{
  ...
  v5 = (__int64)a5;
  *a5 = *(_OWORD *)(a1 + 492);
  *(_QWORD *)(v5 + 16) = *(_QWORD *)(a1 + 508);
  *(_DWORD *)(v5 + 24) = *(_DWORD *)(a1 + 516);
  v7 = *(_DWORD *)(a1 + 456);
  if ( !a4 && *(_BYTE *)(a1 + 25) )
    a3 |= 4u;
  if ( *(_BYTE *)(a1 + 520) )
