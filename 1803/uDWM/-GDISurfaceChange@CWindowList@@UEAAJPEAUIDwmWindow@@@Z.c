/*
 * XREFs of ?GDISurfaceChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180029BD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v37, 0x6E2u);
  v9 = v7;
  if ( v7 < 0 )
  {
LABEL_56:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x11C3u);
    goto LABEL_29;
  }
  if ( !v6 )
    goto LABEL_29;
  ...
  if ( v10 )
  {
    ...
    if ( v32 )
    {
      ...
      if ( v33 )
      {
        if ( *(_QWORD *)(v33 + 376) == v32 )
        {
          updated = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(v32 + 16) + 920LL))(
                      *(_QWORD *)(v32 + 16),
                      *(unsigned int *)(v32 + 24));
          v9 = updated;
          if ( updated < 0 )
...
LABEL_66:
  ...
  v12 = (volatile signed __int32 *)*((_QWORD *)v6 + 47);
  if ( v12 )
  {
  ...
  if ( v47 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x11DDu);
    goto LABEL_29;
  }
LABEL_19:
  v20 = *((_QWORD *)v6 + 49);
  ...
  *((_BYTE *)v6 + 595) |= 2 * (v23 & 1);
  if ( *((_DWORD *)v6 + 116) )
  {
    ...
    v39 = 0LL;
    v41 = 0;
    if ( (int)DynArrayImpl<0>::AddMultipleAndSet((__int64)&v39, 8, v27, v26) >= 0 )
    {
      v28 = v41;
      v29 = 0;
      if ( v41 )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v31, 0x1C2Eu);
      }
    }
LABEL_37:
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x11E8u);
    goto LABEL_29;
  }
