/*
 * XREFs of ?StartAnimation@CLoginTransition@@QEAAJHPEAVCVisual@@0_K@Z @ 0x180006204
 * Callers:
...
LABEL_61:
    ...
    *((_QWORD *)this + 5) = a4;
    ...
    v18 = *(struct tagRECT *)((char *)CDesktopManager::s_pDesktopManagerInstance + 420);
    v57 = v18;
    rc = v18;
    OffsetRect(&rc, -32000, -32000);
    v19 = CAnimatedTransitionVisual::SetVisual(*v12, a3, 1, &rc);
    started = v19;
    if ( v19 < 0 )
    {
      v45 = 87;
    ...
    started = CAnimatedTransitionVisual::SetVisual(*v14, a4, 0, &rc);
    if ( started < 0 )
    {
      v45 = 88;
      goto LABEL_58;
    }
    v20 = CAnimatedTransitionVisual::ProcessSnapshotOnVisual(*v12, a3, &rc);
    started = v20;
    if ( v20 < 0 )
    {
      v45 = 91;
    ...
    if ( v25 >= 0 )
      v21 = v25;
    v51[0] = v21;
    v27 = *(void (__fastcall **)(__int64 *, _DWORD *))(v26 + 80);
    if ( v24 >= 0 )
      v23 = v24;
    v51[1] = v23;
    v27(v22, v51);
    ...
    (*(void (__fastcall **)(__int64, unsigned __int64 *))(*(_QWORD *)v28 + 80LL))(v28, &v49);
    v29 = *v12;
    *((_DWORD *)v29 + 184) = a2;
    *((_DWORD *)v29 + 185) = 2;
    v30 = *v14;
    ...
    *(struct tagRECT *)((char *)v31 + 872) = v18;
    CVisual::SetDirtyFlags((CAnimatedTransitionVisual *)((char *)v31 + 8), 0x1000u);
    v32 = *v14;
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            v56 = *v12;
            v39 = DynArrayImpl<0>::AddMultipleAndSet(&v53, 8LL, 1LL, &v56);
            started = v39;
            if ( v39 < 0 )
            ...
            else
            {
              ...
              {
                v42 = DynArrayImpl<0>::AddMultipleAndSet(&v53, 8LL, 1LL, &v52);
                started = v42;
                if ( v42 < 0 )
              ...
              if ( started >= 0 )
              {
                ...
                {
                  started = CAnimationEngine::ScheduleStartAnimation(v47, a2);
                  if ( started >= 0 )
                  {
