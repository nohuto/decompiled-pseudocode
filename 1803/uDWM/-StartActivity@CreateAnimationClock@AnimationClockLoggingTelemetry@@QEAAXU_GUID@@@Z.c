/*
 * XREFs of ?StartActivity@CreateAnimationClock@AnimationClockLoggingTelemetry@@QEAAXU_GUID@@@Z @ 0x180038464
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  if ( *(_DWORD *)v6 > 4u )
  {
    ...
    TlgWrite(v6, &unk_1800B83F9, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v7, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
