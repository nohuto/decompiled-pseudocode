/*
 * XREFs of ?GetClonePrimaryDisplaysNoRef@CDWMDisplaySet@@QEBAJPEAV?$DynArray@PEAVCDWMDisplay@@$0A@@@@Z @ 0x180033F20
 * Callers:
  ...
  if ( *(_DWORD *)(a1 + 64) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *(_BYTE *)(v11 + 221) )
      {
        ...
        {
          v9 = DynArrayImpl<0>::AddMultipleAndSet(a2, 8, 1, &v11);
          v2 = v9;
          if ( v9 < 0 )
