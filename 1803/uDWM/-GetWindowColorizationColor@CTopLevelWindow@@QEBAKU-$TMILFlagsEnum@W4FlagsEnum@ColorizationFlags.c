/*
 * XREFs of ?GetWindowColorizationColor@CTopLevelWindow@@QEBAKU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@@Z @ 0x18001B868
 * Callers:
...
__int64 __fastcall CTopLevelWindow::GetWindowColorizationColor(__int64 a1, unsigned int a2)
{
  ...
  v5 = CTopLevelWindow::s_ChooseWindowFrameFromStyle(
         *(_DWORD *)(a1 + 584),
         1,
         (*(_BYTE *)(*(_QWORD *)(a1 + 720) + 595LL) & 0x10) != 0);
  if ( (a2 & 1) == 0 && (a2 & 2) == 0 )
  {
    if ( (*(_BYTE *)(a1 + 584) & 0x40) != 0 || (*(_BYTE *)(*(_QWORD *)(a1 + 720) + 595LL) & 0x10) != 0 )
      a2 |= 1u;
    else
      a2 |= 2u;
  }
