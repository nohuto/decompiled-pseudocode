/*
 * XREFs of ??1HolographicDriverDetectedWatcher@Mirage@Windows@@QEAA@XZ @ 0x18006FAA0
 * Callers:
        ...
        void *a2)
{
  ...
  if ( *((_QWORD *)this + 5) )
  {
    ...
    if ( v4 )
    {
      wil::details::in1diag3::_FailFast_Win32(retaddr, (void *)0x78, v5, (const char *)v4, v11);
      __debugbreak();
    }
    *((_QWORD *)this + 5) = 0LL;
  }
  ...
  if ( v6 )
  {
    AcquireSRWLockExclusive((PSRWLOCK)(v6 + 144));
    SRWLock = (PSRWLOCK)(v6 + 144);
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v6 + 140), 0xFFFFFFFF) == 1 )
    {
