/*
 * XREFs of ?Create@CAccentAcrylicBlurBehind@@SAJPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x18003B45C
 * Callers:
...
LABEL_13:
  ...
  v4 = (CAccentAcrylicBlurBehind *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap
                                                                                              + 16LL))(
                                     WPF::g_pProcessHeap,
                                     376LL);
  v5 = v4;
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x69u);
  }
  else
  {
    *a2 = v6;
