/*
 * XREFs of ?IsInfinite@?$TMilRect@HUtagRECT@@U_CMILSurfaceRect_@RectUniqueness@@@@QEBA_NXZ @ 0x18006F5B8
 * Callers:
...
{
  return *a1 <= TMilRect<int,tagRECT,RectUniqueness::_CMILSurfaceRect_>::sc_rcInfinite && a1[2] >= dword_1800C9688
      || a1[1] <= dword_1800C9684 && a1[3] >= dword_1800C968C;
}
