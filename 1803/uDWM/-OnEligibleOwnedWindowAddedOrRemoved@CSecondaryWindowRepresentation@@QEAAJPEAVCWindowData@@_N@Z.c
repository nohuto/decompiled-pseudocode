/*
 * XREFs of ?OnEligibleOwnedWindowAddedOrRemoved@CSecondaryWindowRepresentation@@QEAAJPEAVCWindowData@@_N@Z @ 0x18002E8D8
 * Callers:
...
LABEL_9:
  ...
  if ( v11 + 1 >= v11 )
  {
    ...
    {
      v13 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 128, 8, 1, &v15);
      v3 = v13;
      if ( v13 < 0 )
