/*
 * XREFs of ?ShouldCloneWindow@CTransitionVisualController@@SA_NPEAUHWND__@@@Z @ 0x18000B220
 * Callers:
  ...
  if ( GetClassNameW(hWnd, ClassName, 260) )
  {
    ...
    do
    {
      ...
      if ( CAnimationScheduler::IsWindowCurrentlyAnimating(
             *((CAnimationScheduler **)v3 + 28),
             0LL,
             *((_DWORD *)&off_1800AE710 + 4 * v5 + 2),
             0) )
      {
        v12 = ClassName;
        v13 = (char *)(&off_1800AE710)[2 * v5] - (char *)ClassName;
        while ( 1 )
        {
          v14 = *v12;
