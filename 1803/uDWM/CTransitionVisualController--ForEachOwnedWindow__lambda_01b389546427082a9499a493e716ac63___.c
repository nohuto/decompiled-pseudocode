/*
 * XREFs of CTransitionVisualController::ForEachOwnedWindow__lambda_01b389546427082a9499a493e716ac63___ @ 0x180042170
 * Callers:
  ...
  if ( !a3 || (*(_DWORD *)(a1 + 600) & 0x10000000) != 0 )
  {
    ...
    if ( !v6 || (*(_BYTE *)(v6 + 240) & 0x30) == 0 )
    {
      for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 576); i = (unsigned int)(i + 1) )
      {
        ...
        {
          v3 = lambda_01b389546427082a9499a493e716ac63_::operator()(a2, *(_QWORD *)(*(_QWORD *)(a1 + 552) + 8 * i));
          if ( v3 >= 0 )
