/*
 * XREFs of ?Create@CVirtualDesktopThumbnail@@SAJPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x1800836A0
 * Callers:
...
__int64 __fastcall CVirtualDesktopThumbnail::Create(struct IDwmChannel *a1, struct CVirtualDesktopThumbnail **a2)
{
  ...
  if ( !a2 )
  {
    v4 = -2147024809;
LABEL_3:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x103u);
    return v4;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x103u);
  }
  if ( v6 )
