/*
 * XREFs of ?v_ShouldIncludeInSnapshot@CVirtualDesktopThumbnail@@MEAA_NPEAVCWindowData@@@Z @ 0x1800A4EC0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CWindowData *a2)
{
  ...
  {
    v7 = (struct CWindowData *)*((_QWORD *)v6 + 68);
    if ( v7 && (*((_DWORD *)v7 + 25) & 0x10000000) != 0 )
    {
      v6 = (struct CWindowData *)*((_QWORD *)v6 + 68);
      v11 = v7;
    }
    else
    {
  ...
  if ( (unsigned int)DynArray<HMONITOR__ *,0>::Find(*((_QWORD *)this + 35) + 128LL, &v11)
    || !(unsigned int)DynArray<HMONITOR__ *,0>::Find(v10 + 160, &v11) && *((char *)a2 + 595) >= 0 )
  {
    return 1;
  }
  return v5;
