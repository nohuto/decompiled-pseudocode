/*
 * XREFs of ?StopActivity@StopWindowCapture@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x18007D030
 * Callers:
 *     <none>
 * Callees:
        ...
        WindowFrameLoggingTelemetry::StopWindowCapture *this)
{
  ...
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v7 + 24) & 0x200000000000LL) == *(_QWORD *)(v7 + 24) )
    {
      ...
      TlgWrite(v19, &unk_1800B793B, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v20 + 3) & 0x200000000000LL) == *((_QWORD *)v20 + 3) )
    {
      ...
      v33 = 4;
      v32 = &v23;
      TlgWrite(v20, &unk_1800B7A44, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v28);
    }
  }
  if ( *((_DWORD *)this + 8) )
