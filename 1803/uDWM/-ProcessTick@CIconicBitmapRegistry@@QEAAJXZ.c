/*
 * XREFs of ?ProcessTick@CIconicBitmapRegistry@@QEAAJXZ @ 0x18007760C
 * Callers:
...
__int64 __fastcall CIconicBitmapRegistry::ProcessTick(CIconicBitmapRegistry *this)
{
  ...
  for ( i = *((double *)CDesktopManager::s_pDesktopManagerInstance + 35); v1 < *((_DWORD *)this + 18); ++v1 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x373u);
    }
  }
  ...
  if ( v8 >= 0 )
    *((_BYTE *)CDesktopManager::s_pDesktopManagerInstance + 23) = *((_DWORD *)this + 18) != 0;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x379u);
  return v9;
}
