/*
 * XREFs of ?_SetupWindowPreview@CLivePreview@@AEAAJPEAVCWindowData@@PEAUHWND__@@_NW4Enum@LivePreviewWindowState@@PEAVCVisual@@2@Z @ 0x180072800
 * Callers:
  ...
  if ( LivePreviewVisual >= 0 )
  {
    ...
    *(_QWORD *)&v27 = a3;
    ...
    if ( (int)v15 + 1 >= (unsigned int)v15 )
    {
      ...
      {
        v18 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 336, 48, 1, &v25);
        v7 = v18;
        if ( v18 < 0 )
