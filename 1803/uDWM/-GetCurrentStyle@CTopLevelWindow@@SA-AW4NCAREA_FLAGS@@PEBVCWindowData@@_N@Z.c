/*
 * XREFs of ?GetCurrentStyle@CTopLevelWindow@@SA?AW4NCAREA_FLAGS@@PEBVCWindowData@@_N@Z @ 0x180019220
 * Callers:
...
LABEL_31:
  ...
  if ( *((_BYTE *)CDesktopManager::s_pDesktopManagerInstance + 27) && (*(_DWORD *)(a1 + 100) & 0x1000000) != 0 )
    return 2097153;
  return v2;
}
