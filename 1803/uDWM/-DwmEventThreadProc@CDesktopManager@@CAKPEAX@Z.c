/*
 * XREFs of ?DwmEventThreadProc@CDesktopManager@@CAKPEAX@Z @ 0x18003C5B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AbandonActiveAnimations@CDesktopManager@@AEAAXXZ @ 0x180074B80 (-AbandonActiveAnimations@CDesktopManager@@AEAAXXZ.c)
 *     ?Cleanup@CWaitForService@@QEAAXXZ @ 0x180074C70 (-Cleanup@CWaitForService@@QEAAXXZ.c)
 *     ?EnableLivePreviewInputHooks@CDesktopManager@@SAJ_N0@Z @ 0x1800751B8 (-EnableLivePreviewInputHooks@CDesktopManager@@SAJ_N0@Z.c)
 *     ?WaitFor@CWaitForService@@QEAA_NPEBG@Z @ 0x18007593C (-WaitFor@CWaitForService@@QEAA_NPEBG@Z.c)
...
__int64 __fastcall CDesktopManager::DwmEventThreadProc(PVOID Parameter)
{
  ...
  *(_WORD *)&v53[4] = 0;
  ...
  v53[1] = 0;
  v53[3] = 0;
  *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 154) = GetCurrentThreadId();
  SetLastError(0);
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x7DBu);
    goto LABEL_129;
  }
  ...
  v4 = v10;
  if ( v10 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x7E2u);
  v9 = v4;
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x7E3u);
    goto LABEL_129;
  }
...
LABEL_91:
  ...
  while ( 1 )
  {
    ...
    if ( CDesktopManager::s_pDesktopManagerInstance )
    {
      ...
      v13 = !v17 || (CDesktopManager::s_fTimelineDirty || *((_DWORD *)v15 + 140)) && !*((_BYTE *)v15 + 19);
      v18 = hObject == 0LL;
      *((_BYTE *)v15 + 18) = v13;
      v53[1] = !v18 && v13 | *((_BYTE *)CDesktopManager::s_pDesktopManagerInstance + 23);
    ...
    if ( CDesktopManager::s_pDesktopManagerInstance )
    {
      ...
      if ( QueryPerformanceCounter(&PerformanceCount) )
      {
        ...
        if ( v27 )
        {
          ...
          v42 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v61, 8, v27, v28);
          v9 = v42;
          if ( v42 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v42, 0xC0u);
          if ( v9 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x6E9u);
            goto LABEL_118;
          }
          v27 = HIDWORD(v64);
LABEL_45:
          if ( v27 )
          {
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v32, 0x6EDu);
LABEL_118:
            DynArrayImpl<0>::~DynArrayImpl<0>((__int64)&v61);
LABEL_53:
            if ( v9 >= 0 )
              goto LABEL_54;
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x704u);
            goto LABEL_58;
          }
LABEL_50:
          if ( v61 != v62 )
        ...
        if ( v43 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v43, 0x6F3u);
          goto LABEL_53;
        }
LABEL_54:
        v33 = *((_QWORD *)v26 + 24);
...
LABEL_60:
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x86Bu);
      goto LABEL_126;
    }
LABEL_61:
    if ( Msg.message == 18 )
    ...
    if ( !v18 )
    {
      ...
      if ( CDesktopManager::s_pDesktopManagerInstance )
      {
        updated = CWindowList::UpdateScene(*((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 56));
        v9 = updated;
        if ( updated < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x87Du);
...
LABEL_129:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003302654, 0x8B0u);
  return 2291664642LL;
}
