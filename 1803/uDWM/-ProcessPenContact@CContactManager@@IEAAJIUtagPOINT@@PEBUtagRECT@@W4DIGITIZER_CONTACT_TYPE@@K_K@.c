/*
 * XREFs of ?ProcessPenContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x18008BFA8
 * Callers:
 ...
 *     ?LoadPenResources@CContactManager@@AEAAXXZ @ 0x18008A1B8 (-LoadPenResources@CContactManager@@AEAAXXZ.c)
    ...
    if ( started >= 0 )
    {
      ...
      if ( (int)v21 + 1 < (unsigned int)v21 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(
          ...
          0LL,
          0LL,
          (int)v21 + 1 < (unsigned int)v21 ? 0x80070216 : 0,
          0xB5u);
        goto LABEL_26;
      }
      ...
      started = DynArrayImpl<0>::AddMultipleAndSet(a1 + 88, 40, 1, v27);
      if ( started >= 0 )
        goto LABEL_26;
      v26 = 192;
    }
