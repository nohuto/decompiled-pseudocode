/*
 * XREFs of ?_CreateMonitorSnapshot@CVirtualDesktopSwitch@@AEAAJPEAVCWindowData@@UtagRECT@@_NPEAPEAVCAnimationComponent@@@Z @ 0x18009DCD0
 * Callers:
        ...
        struct CAnimationComponent **a5)
{
  ...
  if ( v14 >= 0 )
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v16, 0x1274u);
      goto LABEL_22;
    }
    ...
    if ( a4
      && (v18 = *(CAnimatedTransitionVisual **)(v5 + 40),
          *(_BYTE *)(v5 + 67) = 1,
          ...
          v19 < 0) )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v19, 0x127Fu);
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v14, 0x1273u);
  }
  v15 = v22;
LABEL_22:
