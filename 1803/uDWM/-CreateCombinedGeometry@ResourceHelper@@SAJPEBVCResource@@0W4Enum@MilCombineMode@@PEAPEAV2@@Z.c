/*
 * XREFs of ?CreateCombinedGeometry@ResourceHelper@@SAJPEBVCResource@@0W4Enum@MilCombineMode@@PEAPEAV2@@Z @ 0x18007FB80
 * Callers:
...
__int64 __fastcall ResourceHelper::CreateCombinedGeometry(__int64 a1, __int64 a2, __int64 a3, CBaseObject **a4)
{
  ...
  {
    v8 = CResource::Create(8u, *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 4), &v14);
    v9 = v8;
    if ( v8 < 0 )
    {
  ...
  v12 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64, int))(**((_QWORD **)v14 + 2) + 1176LL))(
          *((_QWORD *)v14 + 2),
          *((unsigned int *)v14 + 6),
          1LL,
          v10,
