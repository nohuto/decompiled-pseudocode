/*
 * XREFs of ?UpdateAcrylicBlurBehind@CAccentAcrylicBlurBehind@@QEAAJAEBUACCENT_POLICY@@@Z @ 0x180047EEC
 * Callers:
        ...
        const struct ACCENT_POLICY *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x69Cu);
  }
  else
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x69Fu);
    }
    else
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x6A2u);
      }
      else
      {
        v8 = 0;
        ...
        if ( v10 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x6A8u);
        }
        else
        {
          ...
          if ( v11 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x6A9u);
          }
          else
          {
            v12 = *((_QWORD *)this + 35);
            v19 = v8;
            v20 = v9;
            v13 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v12 + 80LL))(v12, &v19);
            v5 = v13;
            if ( v13 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x6ABu);
            }
            else
            {
              v14 = *(_QWORD *)this;
              v19 = v8;
              v20 = v9;
              v15 = (*(__int64 (__fastcall **)(CAccentAcrylicBlurBehind *, int *))(v14 + 80))(this, &v19);
              v5 = v15;
              if ( v15 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x6ACu);
              }
              else
              {
                ...
                v5 = v16;
                if ( v16 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x6AEu);
              }
            }
          }
        }
