/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x18006CEFC
 * Callers:
 *     ?GetShared@?$ProcessLocalStorage@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAPEAUProcessLocalData@23@XZ @ 0x18006D98C (-GetShared@-$ProcessLocalStorage@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAAPEAUPr.c)
 * Callees:
        ...
        void **a2)
{
  ...
  *a2 = 0LL;
  ...
  wil::mutex_t<wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void wil::details::CloseHandle(void *),wistd::integral_constant<unsigned __int64,0>,void *,0,std::nullptr_t>>,wil::err_returncode_policy>::acquire(
    ...
    &v18);
  v17 = 0LL;
  Pointer = wil::details_abi::SemaphoreValue::TryGetPointer(Name, &v17, v9, v10);
  v8 = Pointer;
  if ( Pointer >= 0 )
  {
    v13 = v17;
    ...
    else
    {
      ...
      if ( v15 < 0 )
      {
        wil::details::in1diag3::Return_Hr(retaddr, (void *)0x129, (__int64)"wil", (const char *)(unsigned int)v15);
        goto LABEL_8;
      }
    }
    v8 = 0;
LABEL_8:
  ...
  wil::details::in1diag3::Return_Hr(retaddr, (void *)0x121, (__int64)"wil", (const char *)(unsigned int)Pointer);
LABEL_9:
  if ( v18 )
