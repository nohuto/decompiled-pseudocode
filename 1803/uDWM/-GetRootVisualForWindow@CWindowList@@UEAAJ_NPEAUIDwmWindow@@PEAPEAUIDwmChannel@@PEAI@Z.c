/*
 * XREFs of ?GetRootVisualForWindow@CWindowList@@UEAAJ_NPEAUIDwmWindow@@PEAPEAUIDwmChannel@@PEAI@Z @ 0x180084B20
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a5)
{
  ...
  *v9 = 0;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x12D6u);
  }
