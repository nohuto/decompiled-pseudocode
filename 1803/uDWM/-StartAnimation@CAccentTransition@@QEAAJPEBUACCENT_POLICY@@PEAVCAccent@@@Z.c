/*
 * XREFs of ?StartAnimation@CAccentTransition@@QEAAJPEBUACCENT_POLICY@@PEAVCAccent@@@Z @ 0x1800A2ED8
 * Callers:
    ...
    if ( started >= 0 )
    {
      ...
      if ( v6 )
      {
        if ( *((_DWORD *)a2 + 3) == 5 )
        {
          ...
          v16 = *(_BYTE *)(*((_QWORD *)this + 3) + 608LL);
          rc = si128;
          v17 = (int)(*((double *)CDesktopManager::s_pDesktopManagerInstance + 55) * 81.0);
          if ( !v16 )
            v17 = -v17;
          OffsetRect(&rc, v17, 0);
        ...
        v20 = v6;
        v18 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v22, 8, 1, &v20);
        started = v18;
        if ( v18 < 0 )
