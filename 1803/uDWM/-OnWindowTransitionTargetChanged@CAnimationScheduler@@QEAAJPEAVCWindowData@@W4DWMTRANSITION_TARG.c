/*
 * XREFs of ?OnWindowTransitionTargetChanged@CAnimationScheduler@@QEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@AEBUtagRECT@@2222@Z @ 0x18000C160
 * Callers:
        ...
        RECT *a8)
{
  ...
  v12 = a3 | *(_DWORD *)(a2 + 600) & 0x2000000;
  ...
  *(_DWORD *)(a2 + 600) = v12;
  ...
  for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 40); i = (unsigned int)(i + 1) )
  {
    ...
    if ( !v16[6] )
      (*(void (__fastcall **)(_DWORD *, __int64, _QWORD))(*(_QWORD *)v16 + 80LL))(v16, a2, a3);
  }
  return 0LL;
}
