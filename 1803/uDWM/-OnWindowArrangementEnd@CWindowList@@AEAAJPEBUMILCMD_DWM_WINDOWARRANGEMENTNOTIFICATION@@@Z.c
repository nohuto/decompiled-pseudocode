/*
 * XREFs of ?OnWindowArrangementEnd@CWindowList@@AEAAJPEBUMILCMD_DWM_WINDOWARRANGEMENTNOTIFICATION@@@Z @ 0x1800854A0
 * Callers:
        ...
        const struct MILCMD_DWM_WINDOWARRANGEMENTNOTIFICATION *a2)
{
  ...
  if ( v3 >= 0 )
  {
    ...
    v5 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x182Cu);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v3, 0x182Bu);
  }
