/*
 * XREFs of ?StartActivity@BeginAnimationClock@AnimationClockLoggingTelemetry@@QEAAXU_GUID@@J@Z @ 0x1800387A4
 * Callers:
        ...
        int a3)
{
  ...
  if ( *(_DWORD *)v8 > 4u )
  {
    ...
    TlgWrite(v8, &unk_1800B84B8, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), v9, 5u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
