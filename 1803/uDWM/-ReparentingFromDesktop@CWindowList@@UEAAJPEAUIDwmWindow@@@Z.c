/*
 * XREFs of ?ReparentingFromDesktop@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180028A60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x6E2u);
  if ( v5 < 0 )
  {
LABEL_14:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0xBE2u);
    goto LABEL_6;
  }
  if ( v4 )
  {
