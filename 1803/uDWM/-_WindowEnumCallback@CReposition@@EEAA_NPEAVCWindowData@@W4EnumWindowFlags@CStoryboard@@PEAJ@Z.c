/*
 * XREFs of ?_WindowEnumCallback@CReposition@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800A15B0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CReposition::_WindowEnumCallback(CSlide *a1, struct CWindowData *a2, char a3, int *a4)
{
  ...
  v6 = 0LL;
  v10 = 0LL;
  if ( (a3 & 1) != 0 && (*((_DWORD *)a2 + 150) & 0xFFF) == 0x2C )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v8, 0x743u);
      v6 = v10;
    }
  }
  *a4 = v5;
