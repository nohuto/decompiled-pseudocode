/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x18006D5BC
 * Callers:
    ...
    if ( pszDest )
    {
      ...
      *pszDest = 0;
      if ( !v7 || !wil::details::g_resultMessageCallbackSet || (v7(a3, pszDest, a2, a4), !*pszDest) )
      {
        ...
        {
          v13 = wil::details::LogStringPrintf(pszDest, v10, L"%hs!%p: ", v12, v11);
        }
