/*
 * XREFs of ?_StageCloneRelative@CTransitionVisualController@@IEAAJPEAVCTopLevelWindow@@PEAVCVisual@@_N1222PEA_N@Z @ 0x1800094AC
 * Callers:
 ...
 *     _lambda_01b389546427082a9499a493e716ac63_::operator() @ 0x180042230 (_lambda_01b389546427082a9499a493e716ac63_--operator().c)
 * Callees:
        ...
        bool *a9)
{
  ...
  CVisual *v30; // [rsp+30h] [rbp-20h] BYREF
  ...
  *(_QWORD *)&v13 = a2;
  ...
  v15 = CTopLevelWindow::CloneVisualTreeForLivePreview(a2, 0, (bool)a3, a4, &v30);
  v10 = v15;
  if ( v15 < 0 )
  {
...
LABEL_10:
  ...
  {
    v19 = *(_QWORD *)(v13 + 720);
    if ( !v19 || (*(_DWORD *)(v19 + 600) & 0x20000000) == 0 )
  ...
  *(_WORD *)((char *)&v32 + 1) = 257;
  ...
  {
    v26 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 24, 24LL, 1LL, &v31);
    v10 = v26;
    if ( v26 < 0 )
