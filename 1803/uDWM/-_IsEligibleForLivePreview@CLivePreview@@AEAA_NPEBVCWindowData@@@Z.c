/*
 * XREFs of ?_IsEligibleForLivePreview@CLivePreview@@AEAA_NPEBVCWindowData@@@Z @ 0x1800722BC
 * Callers:
...
char __fastcall CLivePreview::_IsEligibleForLivePreview(CLivePreview *this, const struct CWindowData *a2)
{
  ...
  if ( (*((_BYTE *)a2 + 594) & 0x20) == 0 )
  {
    ...
    {
      v4 = *((_BYTE *)a2 + 592);
      if ( (v4 & 1) != 0 && *((char *)a2 + 595) >= 0 && (v4 & 4) == 0 && (*((_DWORD *)a2 + 25) & 0x20000000) == 0 )
      {
        if ( *((_QWORD *)a2 + 5) )
        {
          v5 = (HWND)*((_QWORD *)a2 + 5);
          if ( v5 != GetDesktopWindow() && v5 != *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 79) )
          {
            CTopLevelWindow::GetLivePreviewWindowRect(*((CTopLevelWindow **)a2 + 49), &rcSrc1, 1);
