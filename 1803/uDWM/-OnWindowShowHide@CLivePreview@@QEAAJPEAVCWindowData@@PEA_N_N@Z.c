/*
 * XREFs of ?OnWindowShowHide@CLivePreview@@QEAAJPEAVCWindowData@@PEA_N_N@Z @ 0x18002DD94
 * Callers:
...
__int64 __fastcall CLivePreview::OnWindowShowHide(CLivePreview *this, struct CWindowData *a2, bool *a3, char a4)
{
  ...
  struct CVisual *v69; // [rsp+38h] [rbp-C8h] BYREF
  ...
  if ( a4 || !CLivePreview::_IsEligibleForLivePreview(this, a2) )
  {
    ...
    if ( (int)v42 >= 0 )
    {
      ...
      if ( v49 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v49, 0x73Du);
        return v5;
      }
      ...
      if ( v51 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v51, 0x740u);
        return v5;
      }
    }
LABEL_60:
    ...
    if ( (int)v45 >= 0 )
    {
      ...
      if ( v52 )
      {
        ...
        if ( v53 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v53, 0x74Cu);
          return v5;
        }
        v47 = *v46;
      ...
      if ( v54 )
      {
        ...
        if ( v55 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v55, 0x752u);
          return v5;
        }
      ...
      if ( v58 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v58, 0x75Bu);
        return v5;
      }
      v68 = 1;
    }
LABEL_88:
  ...
  else
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x77Du);
      return v5;
    }
    ...
    if ( IsTrulyMaximized )
    {
      ...
      if ( v6 > 0 )
      {
        ...
        if ( v19 )
        {
          ...
          if ( v20 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x78Au);
            return v5;
          }
          v17 = *((_QWORD *)this + 38);
        ...
        if ( v22 )
        {
          ...
          if ( v23 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x790u);
            return v5;
          }
          v17 = *((_QWORD *)this + 38);
        ...
        *(_BYTE *)(*(_QWORD *)(v17 + 8 * v18) + 594LL) |= 0x80u;
...
LABEL_30:
    ...
    if ( v27 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x79Du);
      return v5;
    }
    v10 = 1;
    v30 = *((_BYTE *)a2 + 594);
      ...
      *((_BYTE *)a2 + 594) = v31;
      ...
      if ( (v33 & 0x40) == 0 || v33 >= 0 )
      {
        if ( v33 >= 0 )
        {
          ...
          if ( v34 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0x7B3u);
            return v5;
          }
          v35 = (struct CVisual **)v69;
          v36 = CVisual::RenderRecursive(v69);
          v5 = v36;
          if ( v36 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v36, 0x7B4u);
            return v5;
          }
          ...
          if ( inserted < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0x7B5u);
            return v5;
          }
        ...
        if ( (v33 & 0x40) == 0 )
        {
          ...
          if ( v38 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v38, 0x7BDu);
            return v5;
          }
          v39 = (struct CVisual **)v69;
          v40 = CVisual::RenderRecursive(v69);
          v5 = v40;
          if ( v40 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v40, 0x7BEu);
            return v5;
          }
          ...
          if ( v41 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v41, 0x7BFu);
            return v5;
          }
...
LABEL_100:
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x7D3u);
      return v5;
    }
  }
LABEL_101:
