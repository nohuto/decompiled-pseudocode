/*
 * XREFs of ??0CAnalogCompositorManager@@AEAA@XZ @ 0x1800316A0
 * Callers:
...
CAnalogCompositorManager *__fastcall CAnalogCompositorManager::CAnalogCompositorManager(CAnalogCompositorManager *this)
{
  ...
  if ( (*(int (__fastcall **)(_QWORD, const wchar_t *, CAnalogCompositorManager **))(**((_QWORD **)CDesktopManager::s_pDesktopManagerInstance
    ...
    || !(_DWORD)v7 )
  {
    v1 = Windows::Mirage::HolographicDriverDetectedWatcher::RegisterForCMNotifications((Windows::Mirage::HolographicDriverDetectedWatcher *)qword_1800CA008);
    if ( v1 < 0 )
    {
  ...
  return (CAnalogCompositorManager *)&qword_1800CA000;
}
