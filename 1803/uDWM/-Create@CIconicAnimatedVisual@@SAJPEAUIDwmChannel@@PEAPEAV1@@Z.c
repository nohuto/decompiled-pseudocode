/*
 * XREFs of ?Create@CIconicAnimatedVisual@@SAJPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x180096BE8
 * Callers:
...
__int64 __fastcall CIconicAnimatedVisual::Create(struct IDwmChannel *a1, struct CIconicAnimatedVisual **a2)
{
  ...
  if ( !a2 )
  {
    v4 = -2147024809;
LABEL_3:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x19u);
    return v4;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x19u);
  }
  if ( v6 )
