/*
 * XREFs of ?OnMagnifierApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEBX_N@Z @ 0x180079C18
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierApiMessage(__int64 a1, int a2, __int64 a3)
{
  ...
  v3 = 0;
  v7 = 0;
  if ( dword_1800CCD1C > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800CCD1C);
    if ( dword_1800CCD1C == -1 )
    {
      dword_1800CCC88 = -2147023728;
      Init_thread_footer(&dword_1800CCD1C);
    }
  }
  ...
  if ( a2 <= 1073741928 )
  {
    if ( a2 != 1073741928 )
    {
      ...
      if ( v8 )
      {
        ...
        if ( v9 )
        {
          ...
          if ( v10 )
          {
            ...
            if ( v11 )
            {
              if ( v11 == 1 )
              {
                ...
                if ( v13 >= 0 )
                {
                  ...
                  v7 = v14;
                  if ( v14 < 0 )
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v14, 0xF9u);
                }
                else
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v13, 0xF5u);
                }
              }
            }
            else
            {
              ...
              if ( v16 >= 0 )
              {
                ...
                v7 = v17;
                if ( v17 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v17, 0xEBu);
              }
              else
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v16, 0xE7u);
              }
            }
          }
          else
          {
            ...
            if ( v19 >= 0 )
            {
              ...
              v7 = v20;
              if ( v20 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v20, 0xDDu);
            }
            else
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v19, 0xDBu);
            }
          }
        }
        else
        {
          ...
          v7 = v21;
          if ( v21 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v21, 0xD1u);
        }
      }
      else
      {
        ...
        v7 = v22;
        if ( v22 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v22, 0xC9u);
      }
      goto LABEL_50;
    }
    ...
    if ( v23 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v23, 0x10Fu);
      goto LABEL_50;
    }
    goto LABEL_48;
  }
  ...
  if ( !v24 )
  {
    ...
    if ( v36 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v36, 0x11Bu);
      goto LABEL_50;
    }
    goto LABEL_48;
  }
  ...
  if ( v25 )
  {
    ...
    if ( v26 )
    {
      ...
      if ( v27 )
      {
        ...
        if ( v28 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v28, 0x13Au);
          goto LABEL_50;
        }
      }
      else
      {
        ...
        if ( v29 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v29, 0x130u);
          goto LABEL_50;
        }
      }
LABEL_48:
      ...
      v7 = v37;
      if ( v37 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v37, 0x142u);
      goto LABEL_50;
    }
    v30 = *(_QWORD *)(a3 + 4);
    v39 = 0LL;
    ...
    if ( v31 >= 0 )
    {
      ...
      v7 = v32;
      if ( v32 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v32, 0x128u);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v31, 0x126u);
    }
  }
  else
  {
    ...
    if ( v34 >= 0 )
    {
      ...
      v7 = v35;
      if ( v35 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v35, 0x107u);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC88, 1LL, v34, 0x103u);
    }
  }
LABEL_50:
  if ( v7 != -2147023728 )
