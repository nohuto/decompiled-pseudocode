/*
 * XREFs of ?Initialize@CCubicBezierInterpolator@@IEAAJNPEANI@Z @ 0x180098794
 * Callers:
...
LABEL_11:
  ...
  *((_QWORD *)this + 3) = v13;
  ...
  v14 = (_DWORD *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                    WPF::g_pProcessHeap,
                    800LL);
  *((_QWORD *)this + 8) = v14;
  if ( !v14 )
