/*
 * XREFs of ?ForceIconicRepresentationChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180002700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ForceIconicRepresentationChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0x121Fu);
  }
  else
  {
    v6 = v11;
    if ( v11 )
    {
      ...
      if ( (*((_BYTE *)v6 + 593) & 1) != v7 )
      {
        *((_BYTE *)v6 + 593) ^= (v7 ^ *((_BYTE *)v6 + 593)) & 1;
        ...
        v5 = v9;
        if ( v9 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x122Du);
      }
    }
  }
