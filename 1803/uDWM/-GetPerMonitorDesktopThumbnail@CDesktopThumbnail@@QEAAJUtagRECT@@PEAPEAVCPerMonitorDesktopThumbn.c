/*
 * XREFs of ?GetPerMonitorDesktopThumbnail@CDesktopThumbnail@@QEAAJUtagRECT@@PEAPEAVCPerMonitorDesktopThumbnail@@@Z @ 0x1800A3C88
 * Callers:
      ...
      if ( v12 )
      {
        ...
        *((_QWORD *)v18 + 8) = v7;
        ...
        if ( v13 + 1 >= v13 )
        {
          ...
          {
            v15 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 280, 8, 1, &v18);
            v6 = v15;
            if ( v15 < 0 )
