/*
 * XREFs of ?CloakChange@CWindowList@@UEAAJPEAUIDwmWindow@@0_N@Z @ 0x18002A750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::CloakChange(CWindowList *this, struct IDwmWindow *a2, struct IDwmWindow *a3, bool a4)
{
  ...
  if ( !v27 )
    goto LABEL_9;
  v26 = 0;
  v11 = (CAnimationScheduler *)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 28);
    ...
    if ( a4 )
    {
      ...
      else
      {
        ...
        else
        {
          ...
          {
            v9 = 0;
            v18 = *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 59);
            ...
            if ( (_BYTE)v17 )
            {
              ...
              if ( v23 )
                v22 = *(_QWORD *)(v23 + 40);
              v24 = CLivePreview::Activate(v18, v17, v21, v22, *(_DWORD *)(v18 + 560), *(_DWORD *)(v18 + 296), 0, 0LL);
              v9 = v24;
              if ( v24 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x3F7u);
            }
            if ( v9 < 0 )
            {
              v25 = 4935;
