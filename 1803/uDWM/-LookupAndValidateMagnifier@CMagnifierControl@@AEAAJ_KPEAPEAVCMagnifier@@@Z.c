/*
 * XREFs of ?LookupAndValidateMagnifier@CMagnifierControl@@AEAAJ_KPEAPEAVCMagnifier@@@Z @ 0x180079B54
 * Callers:
        ...
        struct CMagnifier **a3)
{
  ...
  v4 = 0;
  if ( dword_1800CCD24 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800CCD24);
    if ( dword_1800CCD24 == -1 )
    {
      dword_1800CCC80 = -2147023728;
      Init_thread_footer(&dword_1800CCD24);
    }
  }
  ...
  {
    v4 = -2147023728;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CCC80, 1LL, -2147023728, 0x1DCu);
  }
  return v4;
}
