/*
 * XREFs of ?wil_details_ModifyFeatureData@@YAHPEATwil_details_FeaturePropertyCache@@P6AH0PEAX@Z1@Z @ 0x1800354C0
 * Callers:
 ...
 *     ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x18006E1F8 (-OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ.c)
