/*
 * XREFs of ?_CreateAndAddBitmapAnimationComponent@CStoryboard@@IEAAJPEAUHWND__@@W4DWMTRANSITION_TARGET@@HPEAPEAVCAnimationComponent@@@Z @ 0x18009D6C4
 * Callers:
        ...
        volatile signed __int32 **a5)
{
  ...
  if ( BitmapAnimationComponent >= 0 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v9, 0x152Du);
      goto LABEL_8;
    }
    *a5 = v8;
    if ( !v8 )
