/*
 * XREFs of ?CreateFromValueInternal@SemaphoreValue@details_abi@wil@@AEAAJPEBG_N_K@Z @ 0x18006D104
 * Callers:
 ...
 * Callees:
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x180033B80 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
        ...
        unsigned __int64 a4)
{
  ...
  else
  {
    ...
    if ( LastError < 0 )
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x84, (__int64)"wil", (const char *)(unsigned int)LastError);
      return v34;
    }
  }
  v21 = 260LL;
  ...
  else
  {
    ...
    if ( v35 < 0 )
    {
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0x88, (__int64)"wil", (const char *)(unsigned int)v35);
      return v36;
    }
  }
  return 0LL;
