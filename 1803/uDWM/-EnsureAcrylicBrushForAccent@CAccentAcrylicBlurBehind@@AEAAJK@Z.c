/*
 * XREFs of ?EnsureAcrylicBrushForAccent@CAccentAcrylicBlurBehind@@AEAAJK@Z @ 0x180047CC8
 * Callers:
...
__int64 __fastcall CAccentAcrylicBlurBehind::EnsureAcrylicBrushForAccent(CAccentAcrylicBlurBehind *this, int a2)
{
  ...
  if ( *((_DWORD *)this + 92) != a2 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ActivationFactory, 0x6FCu);
    }
    else
    {
      v7 = v16;
      ...
      v8 = (**v7)(v7, &GUID_e4e9ec98_6f5f_40b8_8738_b934e188548f, &v17);
      v4 = v8;
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x700u);
      }
      else
      {
        v21 = 0LL;
        ...
        else
        {
          ...
          *(_WORD *)((char *)&v19 + 1) = a2;
          ...
          if ( v11 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x70Fu);
          }
          else
          {
            ...
            if ( v12 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x713u);
            }
            else
            {
              v23 = 0LL;
              ...
              if ( v13 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x717u);
              }
              else
              {
                ...
                v4 = v14;
                if ( v14 < 0 )
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x71Au);
                else
                  *((_DWORD *)this + 92) = a2;
              }
              v23 = 0LL;
