/*
 * XREFs of ?EnableInputHooksHelper@CDesktopManager@@SAJ_N0PEBGPEAPEAUHWND__@@@Z @ 0x180074F14
 * Callers:
...
__int64 __fastcall CDesktopManager::EnableInputHooksHelper(char a1, char a2, const unsigned __int16 *a3, HWND *a4)
{
  ...
  if ( !a1 )
  {
    ...
    v15 = (HWND)*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 80);
    if ( v15 )
    {
      if ( IsWindow(v15) )
        CDesktopManager::SetForegroundWindowAsync(*a4, *((HWND *)CDesktopManager::s_pDesktopManagerInstance + 80), v16);
...
LABEL_18:
  ...
  if ( WindowInBand )
  {
    *a4 = WindowInBand;
    ...
    if ( a2 )
      return v4;
    *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 80) = ForegroundWindow;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9B80, 2LL, v13, 0xA6Cu);
    }
    goto LABEL_18;
  }
  v4 = -2147024890;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9B80, 2LL, -2147024890, 0xA5Bu);
LABEL_19:
  if ( a1 )
