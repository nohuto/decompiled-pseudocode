/*
 * XREFs of ?Initialize@CTopLevelWindow@@MEAAJPEAUIDwmChannel@@_N@Z @ 0x18001F370
 * Callers:
  ...
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if ( v13 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0xA8u);
        }
        else
        {
          ...
          if ( v15 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0xA9u);
          }
          else
          {
            ...
            if ( inserted < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, inserted, 0xABu);
            }
            else
            {
              ...
              else
              {
                ...
                if ( v18 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0xADu);
                }
                else
                {
                  v19 = *v10;
                  ...
                  *(_QWORD *)&v22.cyTopHeight = 0LL;
                  CVisual::SetInsetFromParent((CVisual *)v19, &v22);
                  CVisual::SetInsetFromParent((CVisual *)*v14, &v22);
