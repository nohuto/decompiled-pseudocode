/*
 * XREFs of ?_AddRectInstruction@CProjectionBorderVisual@@IEAAJAEBUtagRECT@@AEBU_D3DCOLORVALUE@@@Z @ 0x18007F938
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a3)
{
  ...
  __int128 v13; // xmm1
  int v14; // eax
  struct CSolidRectangleInstruction *v15; // [rsp+30h] [rbp-28h] BYREF
  ...
  *(float *)v5.m128i_i32 = (float)a2->bottom;
  ...
  if ( v9 >= 0 )
  {
    ...
    *((_OWORD *)v10 + 1) = v13;
    ...
    v11 = v14;
    if ( v14 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x3Cu);
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x39u);
  }
  if ( v10 )
