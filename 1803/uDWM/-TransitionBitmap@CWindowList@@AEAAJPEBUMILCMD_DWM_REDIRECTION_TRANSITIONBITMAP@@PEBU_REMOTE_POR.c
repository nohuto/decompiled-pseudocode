/*
 * XREFs of ?TransitionBitmap@CWindowList@@AEAAJPEBUMILCMD_DWM_REDIRECTION_TRANSITIONBITMAP@@PEBU_REMOTE_PORT_VIEW@@@Z @ 0x1800862DC
 * Callers:
      ...
      if ( v8 > 0 )
      {
        if ( a3->ViewSize )
        {
          if ( a3->ViewBase )
          {
            ...
            v6 = v9;
            if ( v9 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0xF92u);
          }
        }
      }
    }
