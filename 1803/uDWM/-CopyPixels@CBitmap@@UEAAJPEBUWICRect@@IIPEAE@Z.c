/*
 * XREFs of ?CopyPixels@CBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x1800A9F10
 * Callers:
 *     ?CopyPixels@CBitmap@@WBI@EAAJPEBUWICRect@@IIPEAE@Z @ 0x18004B470 (-CopyPixels@CBitmap@@WBI@EAAJPEBUWICRect@@IIPEAE@Z.c)
 * Callees:
...
LABEL_5:
  ...
  if ( v15 >= 0 )
  {
    ...
    if ( v15 >= 0 )
    {
      ...
      if ( v15 >= 0 )
      {
        v15 = (*(__int64 (__fastcall **)(__int64, int *, unsigned int *))(*(_QWORD *)v20 + 32LL))(v20, &v21, &v19);
        v9 = v15;
        if ( v15 >= 0 )
        {
          v15 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v20 + 40LL))(v20, &v22);
          v9 = v15;
          if ( v15 >= 0 )
          {
            v15 = (*(__int64 (__fastcall **)(__int64, unsigned int *, unsigned __int8 **))(*(_QWORD *)v20 + 48LL))(
                    v20,
                    &v18,
                    &Src);
            v9 = v15;
  ...
  v10 = v15;
LABEL_31:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, v17);
LABEL_32:
  if ( v20 )
