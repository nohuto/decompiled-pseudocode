/*
 * XREFs of ?StopActivity@GetCommitHandle@AnimationClockLoggingTelemetry@@MEAAXXZ @ 0x1800A7F70
 * Callers:
 *     <none>
 * Callees:
        ...
        AnimationClockLoggingTelemetry::GetCommitHandle *this)
{
  ...
  EVENT_DATA_DESCRIPTOR v65; // [rsp+188h] [rbp+80h] BYREF
  ...
  if ( v4 )
  {
    if ( *(_DWORD *)v6[1] > 4u )
    {
      ...
      v62 = 4;
      TlgCreateSz(&v64, v19);
      TlgWrite(v20, &unk_1800B8703, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    v21 = (const struct _TlgProvider_t *)v6[1];
    if ( *(_DWORD *)v21 > 4u )
    {
      v22 = *(_DWORD *)(*((_QWORD *)this + 6) + 76LL);
      v68 = 0;
      v66 = &v25;
      v25 = v22;
      v67 = 4;
      ...
      v70 = 4;
      v69 = &v24;
      TlgWrite(v21, &unk_1800B882D, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v65);
    }
  }
  if ( *((_DWORD *)this + 8) )
