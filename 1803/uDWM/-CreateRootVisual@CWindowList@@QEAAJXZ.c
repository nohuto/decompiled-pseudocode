/*
 * XREFs of ?CreateRootVisual@CWindowList@@QEAAJXZ @ 0x18003E138
 * Callers:
...
__int64 __fastcall CWindowList::CreateRootVisual(struct CVisual **this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0x590u);
  }
  else
  {
    v4 = *v1;
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x593u);
    }
    else
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x596u);
      }
      else
      {
        ...
        v3 = v7;
        if ( v7 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x598u);
      }
    }
  }
  return v3;
