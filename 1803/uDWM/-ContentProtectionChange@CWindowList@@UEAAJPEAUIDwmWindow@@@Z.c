/*
 * XREFs of ?ContentProtectionChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180083230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ContentProtectionChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  if ( SyncedWindowData >= 0 )
  {
    ...
    if ( v10 )
    {
      ...
      if ( ((*((_BYTE *)v6 + 595) & 0x20) != 0) != v7 )
      {
        *((_BYTE *)v6 + 595) ^= (*((_BYTE *)v6 + 595) ^ (32 * v7)) & 0x20;
        v8 = CWindowData::NotifyRepresentationChanged(v6);
        v5 = v8;
        if ( v8 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x11B5u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x11ABu);
  }
