/*
 * XREFs of ??1WindowFrame@CTopLevelWindow@@UEAA@XZ @ 0x18003FE50
 * Callers:
 ...
 *     ??1DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ @ 0x18004011C (--1DPIImages@WindowFrame@CTopLevelWindow@@QEAA@XZ.c)
 */
