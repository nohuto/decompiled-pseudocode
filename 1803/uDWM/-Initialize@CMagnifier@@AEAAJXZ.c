/*
 * XREFs of ?Initialize@CMagnifier@@AEAAJXZ @ 0x180078F14
 * Callers:
...
__int64 __fastcall CMagnifier::Initialize(CMagnifier *this)
{
  ...
  if ( v3 >= 0 )
  {
    ...
    if ( v5 )
      ...
      v6 = 0LL;
    v7 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64))(**(_QWORD **)(*(_QWORD *)v1 + 16LL) + 736LL))(
    ...
    if ( v7 >= 0 )
    {
      ...
      v13[1] = _xmm;
      v13[2] = 0LL;
      v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _OWORD *))(**(_QWORD **)(v8 + 16) + 1168LL))(
              *(_QWORD *)(v8 + 16),
              *(unsigned int *)(v8 + 24),
              v13);
      v4 = v10;
      if ( v10 >= 0 )
      {
        v11 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**(_QWORD **)(*(_QWORD *)v1 + 16LL) + 784LL))(
                *(_QWORD *)(*(_QWORD *)v1 + 16LL),
                *(unsigned int *)(*(_QWORD *)v1 + 24LL),
