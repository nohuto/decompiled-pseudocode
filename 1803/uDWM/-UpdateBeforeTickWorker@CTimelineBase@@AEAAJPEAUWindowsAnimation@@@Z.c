/*
 * XREFs of ?UpdateBeforeTickWorker@CTimelineBase@@AEAAJPEAUWindowsAnimation@@@Z @ 0x180013B24
 * Callers:
...
__int64 __fastcall CTimelineBase::UpdateBeforeTickWorker(CTimelineBase *this, struct WindowsAnimation *a2)
{
  ...
  if ( v10 )
  {
    ...
    if ( !v11 )
    {
      ...
      v7 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v17 + 32LL))(v17);
      v6 = v7;
      if ( v7 < 0 )
      {
        v16 = 192;
...
LABEL_10:
  ...
  {
LABEL_11:
    v7 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v12 + 24LL))(v12, *v2, v17);
    v6 = v7;
    if ( v7 >= 0 )
      goto LABEL_12;
    v16 = 229;
