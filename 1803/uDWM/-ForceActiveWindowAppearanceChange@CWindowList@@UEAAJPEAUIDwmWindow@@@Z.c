/*
 * XREFs of ?ForceActiveWindowAppearanceChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18003E280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ForceActiveWindowAppearanceChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0x127Au);
  }
  else
  {
    v6 = v9;
