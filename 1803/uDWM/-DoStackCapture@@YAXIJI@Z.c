/*
 * XREFs of ?DoStackCapture@@YAXIJI@Z @ 0x1800A87E4
 * Callers:
 *     ?DoStackCapture@@YAXJI@Z @ 0x18004B1A8 (-DoStackCapture@@YAXJI@Z.c)
...
void __fastcall DoStackCapture(int a1, int a2, int a3)
{
  ...
  if ( !_InterlockedCompareExchange(&dword_1800CA2E0, 1, 0) )
  {
