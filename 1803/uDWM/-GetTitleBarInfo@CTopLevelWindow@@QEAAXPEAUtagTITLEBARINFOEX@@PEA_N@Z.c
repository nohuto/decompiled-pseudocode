/*
 * XREFs of ?GetTitleBarInfo@CTopLevelWindow@@QEAAXPEAUtagTITLEBARINFOEX@@PEA_N@Z @ 0x1800040DC
 * Callers:
    ...
    *(_QWORD *)&a2->rgstate[4] = 0LL;
    ...
    if ( (*(_DWORD *)(*((_QWORD *)this + 90) + 100LL) & 0xC00000) == 0xC00000 )
    {
      ...
      if ( (v9 & 0x10000) != 0 )
      {
        v10 = *((_QWORD *)this + 65);
        if ( (v9 & 0x20000) != 0 )
          a2->rcTitleBar.right = v8 - *(_DWORD *)(v10 + 120);
        else
      ...
      for ( i = 2; i <= 5; ++i )
      {
        ...
        v15 = *((_DWORD *)this + 146);
        if ( (v15 & dword_1800B3F30[2 * v14]) != 0 )
        {
          if ( (v15 & dword_1800B3F30[2 * v14 + 1]) != 0 )
          {
