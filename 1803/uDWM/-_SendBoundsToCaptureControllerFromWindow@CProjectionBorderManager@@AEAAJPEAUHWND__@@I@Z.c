/*
 * XREFs of ?_SendBoundsToCaptureControllerFromWindow@CProjectionBorderManager@@AEAAJPEAUHWND__@@I@Z @ 0x18007ECE0
 * Callers:
...
LABEL_12:
    ...
    if ( v15 )
    {
      ...
      if ( v10 )
      {
        ...
        SyncedWindowDataByHwnd = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)this + 54) + 1264LL))(
                                   *((_QWORD *)this + 54),
                                   a3);
        v7 = SyncedWindowDataByHwnd;
        if ( SyncedWindowDataByHwnd < 0 )
