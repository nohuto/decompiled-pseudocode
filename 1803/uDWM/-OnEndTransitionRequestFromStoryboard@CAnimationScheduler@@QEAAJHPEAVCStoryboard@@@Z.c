/*
 * XREFs of ?OnEndTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEAVCStoryboard@@@Z @ 0x18000BBB8
 * Callers:
        ...
        struct CStoryboard *a3)
{
  ...
  if ( (int)v9 >= 0 )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9F5C, 1u, v11, 0x132u);
    }
    else
    {
      ...
      if ( v13 )
      {
        ...
        v8 = CAnimationClockCoordinator::OnEndAnimationClock(
               *((CAnimationClockCoordinator **)CDesktopManager::s_pDesktopManagerInstance + 23),
               &v15);
        if ( v8 == -2147019873 )
        {
          v15 = v12;
          v8 = CAnimationScheduler::_ScheduleStoryboardsForAnimationClock(this, &v15);
        }
      }
      if ( v8 >= 0 )
        goto LABEL_15;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9F5C, 1u, v8, 0x135u);
    }
LABEL_20:
