/*
 * XREFs of ?DesktopThumbnailChange@CWindowList@@UEAAJPEAUIDwmWindow@@UtagRECT@@1EK@Z @ 0x180083ED0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a6)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0xFA9u);
    goto LABEL_35;
  }
  v12 = v32;
  if ( !v32 )
  ...
  {
    v9 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024809, 0xFB3u);
    goto LABEL_35;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, DesktopThumbnail, 0xFB7u);
LABEL_27:
    v15 = v29;
    goto LABEL_28;
  }
  ...
  *((_QWORD *)v29 + 34) = *((_QWORD *)v12 + 15);
  ...
  if ( updated < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, updated, 0xFB8u);
    goto LABEL_28;
  }
  v35 = *a4;
      ...
      if ( v23 >= 0 )
      {
        ...
        *((_BYTE *)v25 + 337) = 0;
        ...
        if ( v26 >= 0 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v27, 0xFD9u);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, 0xFD6u);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v23, 0xFD0u);
        v10 = (volatile signed __int32 *)v30;
      }
    }
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, PerMonitorDesktopThumbnail, 0xFB9u);
  }
LABEL_28:
  if ( v15 )
