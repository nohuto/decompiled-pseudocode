/*
 * XREFs of ?UpdateTransition@CPressTapVisual@@MEAAJXZ @ 0x180092E50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CPressTapVisual::UpdateTransition(CPressTapVisual *this)
{
  ...
  if ( v1 < v3 )
  {
    ...
    CVisual::SetSize(*((struct tagSIZE **)this + 43), &v23);
