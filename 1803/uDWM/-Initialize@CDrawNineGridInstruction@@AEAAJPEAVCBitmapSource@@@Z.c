/*
 * XREFs of ?Initialize@CDrawNineGridInstruction@@AEAAJPEAVCBitmapSource@@@Z @ 0x180030E3C
 * Callers:
 ...
 *     ?GetNineGridLayout@CDrawNineGridInstruction@@SAXU_MARGINS@@AEBUMilPointAndSizeL@@PEAUNineGridLayout@@@Z @ 0x1800310A4 (-GetNineGridLayout@CDrawNineGridInstruction@@SAXU_MARGINS@@AEBUMilPointAndSizeL@@PEAUNineGridLay.c)
...
__int64 __fastcall CDrawNineGridInstruction::Initialize(struct _MARGINS *this, struct CBitmapSource *a2)
{
  ...
  for ( i = this + 3; ; i = (struct _MARGINS *)((char *)i + 8) )
  {
    ...
    *((float *)&v20 + 1) = (float)v10;
    v21 = (float)v19;
    v22 = (float)v12;
    v17 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, struct _MARGINS *, __int64 *, _DWORD, _DWORD, _DWORD, int, _DWORD, _DWORD, _DWORD, int, _DWORD, int, int, _DWORD))(**(_QWORD **)(v15 + 16) + 1208LL))(
            *(_QWORD *)(v15 + 16),
            *(unsigned int *)(v15 + 24),
            *(_QWORD *)(v15 + 16),
            &v23,
