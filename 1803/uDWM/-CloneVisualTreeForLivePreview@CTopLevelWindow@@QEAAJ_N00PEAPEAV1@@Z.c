/*
 * XREFs of ?CloneVisualTreeForLivePreview@CTopLevelWindow@@QEAAJ_N00PEAPEAV1@@Z @ 0x18001FB40
 * Callers:
        ...
        struct CTopLevelWindow **a5)
{
    ...
    if ( *(_QWORD *)v14 )
    {
      ...
      *(_BYTE *)(v15 + 84) |= v9;
      if ( !a2 )
      {
        ...
        if ( v18 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x14D2u);
          goto LABEL_26;
        }
      }
    }
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x14E3u);
  }
  else
  {
    v19 = *((_QWORD *)this + 35);
...
LABEL_26:
  wil::ActivityBase<WindowFrameLogging,1,0,5,_TlgReflectorTag_Param0IsProviderType>::Stop(v27, (unsigned int)v18);
  WindowFrameLoggingTelemetry::CloneWindow::~CloneWindow((WindowFrameLoggingTelemetry::CloneWindow *)v27);
