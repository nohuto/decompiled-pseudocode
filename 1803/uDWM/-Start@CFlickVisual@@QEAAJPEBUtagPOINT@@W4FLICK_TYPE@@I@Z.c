/*
 * XREFs of ?Start@CFlickVisual@@QEAAJPEBUtagPOINT@@W4FLICK_TYPE@@I@Z @ 0x180091E4C
 * Callers:
...
__int64 __fastcall CFlickVisual::Start(__int64 a1, POINT *a2, int a3, int a4)
{
  ...
  *(_DWORD *)(a1 + 296) = a4;
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0d(a1, &UdwmFlickVisual_Start, a3);
  v7 = *(_QWORD *)(a1 + 352);
  if ( v7 )
  {
    v8 = (*(_DWORD *)(v7 + 8))-- == 1;
...
LABEL_40:
    ...
    BitmapFromAtlas = CTopLevelWindow::CreateBitmapFromAtlas(Theme, v15, 0LL, (struct CBitmapSource **)(a1 + 320));
    v12 = BitmapFromAtlas;
    if ( BitmapFromAtlas >= 0 )
    {
      ...
      *(_QWORD *)(a1 + 336) = *((_QWORD *)*v17 + 3);
      ...
      CVisual::SetSize(*(struct tagSIZE **)(a1 + 328), (const struct tagSIZE *)(a1 + 336));
      ...
      *(_DWORD *)(a1 + 316) = top + *(_DWORD *)(a1 + 340) + v26;
      CContactManager::PostFlickFeedbackUpdate(*((_QWORD *)v27 + 22), v29, v28, (_QWORD *)(a1 + 312), 1u);
    }
    else
    {
