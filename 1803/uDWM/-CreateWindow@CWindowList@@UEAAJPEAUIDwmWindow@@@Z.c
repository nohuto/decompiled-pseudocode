/*
 * XREFs of ?CreateWindow@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180083B70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x1800A8A34 (-IsKernelDebuggerPresent@@YAHXZ.c)
 */
...
LABEL_15:
  ...
  {
    v3 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x64Eu);
  }
