/*
 * XREFs of ?StopActivity@StartWindowCapture@WindowFrameLoggingTelemetry@@MEAAXXZ @ 0x18007CB50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?zInternalStop@?$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x18007F5FC (-zInternalStop@-$ActivityBase@VWindowFrameLogging@@$00$0CAAAAAAAAAAA@$04U_TlgReflectorTag_Param0.c)
 */
        ...
        WindowFrameLoggingTelemetry::StartWindowCapture *this)
{
  ...
  if ( v4 )
  {
      ...
      && (*(_QWORD *)(v7 + 24) & 0x200000000000LL) == *(_QWORD *)(v7 + 24) )
    {
      ...
      TlgWrite(v19, &unk_1800B7E4B, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v20 + 3) & 0x200000000000LL) == *((_QWORD *)v20 + 3) )
    {
      ...
      v33 = 4;
      v32 = &v23;
      TlgWrite(v20, &unk_1800B7F55, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v28);
    }
  }
  if ( *((_DWORD *)this + 8) )
