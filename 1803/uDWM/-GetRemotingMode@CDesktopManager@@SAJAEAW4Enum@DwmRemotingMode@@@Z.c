/*
 * XREFs of ?GetRemotingMode@CDesktopManager@@SAJAEAW4Enum@DwmRemotingMode@@@Z @ 0x180032628
 * Callers:
...
__int64 __fastcall CDesktopManager::GetRemotingMode(enum DwmRemotingMode::Enum *a1)
{
  ...
  *(_DWORD *)a1 = 0;
  if ( GetSystemMetrics(4096) )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0xE0u);
    }
    else
    {
      v6 = (**v4)(v4, 2LL, &v8);
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0xE1u);
      }
      else if ( v7 )
      {
        *(_DWORD *)a1 = 3;
