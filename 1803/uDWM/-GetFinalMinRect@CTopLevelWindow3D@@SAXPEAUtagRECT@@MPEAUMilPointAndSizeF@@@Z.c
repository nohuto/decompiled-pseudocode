/*
 * XREFs of ?GetFinalMinRect@CTopLevelWindow3D@@SAXPEAUtagRECT@@MPEAUMilPointAndSizeF@@@Z @ 0x1800380E4
 * Callers:
...
void __fastcall CTopLevelWindow3D::GetFinalMinRect(struct tagRECT *a1, float a2, struct MilPointAndSizeF *a3)
{
  ...
  if ( a1->right - a1->left >= 0 )
    v4 = a1->right - a1->left;
  v6 = (float)v4 * *((float *)CDesktopManager::s_pDesktopManagerInstance + 169);
  *((float *)a3 + 2) = v6;
  v7 = v6 * a2;
  v8 = (float)(v6 * *((float *)v3 + 170)) + _mm_cvtepi32_ps(v5).m128_f32[0];
  top = (float)a1->top;
  *((float *)a3 + 3) = v7;
  *(float *)a3 = v8;
  *((float *)a3 + 1) = top - v7;
