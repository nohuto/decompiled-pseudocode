/*
 * XREFs of ?BitmapReceived@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_KK@Z @ 0x18007700C
 * Callers:
        ...
        char a8)
{
    ...
    && v14 )
  {
    if ( CIconicBitmapRegistry::CanAcceptBitmap((CIconicBitmapRegistry *)this, a2) )
    {
      if ( (unsigned int)DwmGetIdealIconicThumbnailSize(1, &dwProcessId) )
      {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9B98, 1LL, v24, 0x24Fu);
        }
        if ( v25 )
      ...
      else
      {
        ...
        v11 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9B98, 1LL, -2147467259, 0x23Eu);
      }
    }
  ...
  else
  {
    ...
    v11 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9B98, 1LL, -2147024809, 0x22Eu);
  }
  return v11;
}
