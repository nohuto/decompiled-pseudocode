/*
 * XREFs of ?_SetTimeToNextFrame@CAnimationClock@@AEAAJPEBT_LARGE_INTEGER@@PEAT2@@Z @ 0x18000CB18
 * Callers:
 ...
 * Callees:
 *     ?ResultFromKnownLastError@@YAJXZ @ 0x1800A7E0C (-ResultFromKnownLastError@@YAJXZ.c)
 */
