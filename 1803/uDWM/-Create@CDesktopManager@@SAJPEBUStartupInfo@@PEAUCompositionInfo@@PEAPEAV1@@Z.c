/*
 * XREFs of ?Create@CDesktopManager@@SAJPEBUStartupInfo@@PEAUCompositionInfo@@PEAPEAV1@@Z @ 0x18003C418
 * Callers:
        ...
        struct CDesktopManager **a3)
{
  ...
  if ( v6 )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B38E0, 1u, v7, 0x5C9u);
    }
    else
    {
      g_pdmInstance = v6;
  ...
  {
    v8 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B38E0, 1u, -2147024882, 0x5C5u);
  }
