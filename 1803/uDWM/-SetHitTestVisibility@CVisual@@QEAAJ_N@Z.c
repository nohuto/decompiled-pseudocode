/*
 * XREFs of ?SetHitTestVisibility@CVisual@@QEAAJ_N@Z @ 0x18000463C
 * Callers:
...
__int64 __fastcall CVisual::SetHitTestVisibility(CVisual *this)
{
  ...
  if ( v3 )
  {
    if ( v1 )
      ...
      v4 = 0LL;
    v5 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v3 + 416LL))(v3, v4, 1LL);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x4C6u);
  }
  return v2;
}
