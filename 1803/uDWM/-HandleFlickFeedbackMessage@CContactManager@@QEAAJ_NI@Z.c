/*
 * XREFs of ?HandleFlickFeedbackMessage@CContactManager@@QEAAJ_NI@Z @ 0x180089BE8
 * Callers:
 ...
 *     ?Initialize@CTrackingTooltip@@QEAAJPEBUtagPOINT@@PEAG@Z @ 0x180091B70 (-Initialize@CTrackingTooltip@@QEAAJPEBUtagPOINT@@PEAG@Z.c)
 *     ?Update@CTrackingTooltip@@QEAAXPEBUtagPOINT@@PEAG@Z @ 0x180091BDC (-Update@CTrackingTooltip@@QEAAXPEBUtagPOINT@@PEAG@Z.c)
 */
  ...
  if ( v3 )
  {
    ...
    if ( (int)v6 >= 0 )
    {
      ...
      if ( a2 )
      {
        ...
        v5 = CContactManager::LoadFeedbackString(v14, ModuleHandleW, dword_1800B9E60[v12], &v28);
        if ( !v5 )
        {
          v27 = 1772;
LABEL_12:
        ...
        *(_QWORD *)(*((_QWORD *)this + 23) + 8 * v9 + 16) = v16;
        ...
        v4 = CTrackingTooltip::Initialize(v18, (const struct tagPOINT *)(v17 + 8 + 8 * v9), v5);
        if ( v4 < 0 )
        {
          v19 = *((_QWORD *)this + 23);
