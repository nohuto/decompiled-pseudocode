/*
 * XREFs of ?CreateLiveDesktopVisual@CScreenRotation@@AEAAJXZ @ 0x18009906C
 * Callers:
...
__int64 __fastcall CScreenRotation::CreateLiveDesktopVisual(CScreenRotation *this)
{
  ...
  RootVisualForDesktop = CWindowList::GetRootVisualForDesktop(
                           *((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 56),
                           v15);
  v4 = *((_QWORD *)this + 2);
  v16.left = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 101);
  v5 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 103);
  v16.right = v5 + v16.left;
  v16.top = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 102);
  v6 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 104);
  ...
  if ( v8 >= 0 )
  {
    ...
    {
      v11 = v14;
      (*((void (__fastcall **)(struct CResource **, struct CResource **))(*v2)[1] + 10))(*v2 + 1, &v14);
      (*v2)[119] = v11;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x237u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x235u);
  }
  if ( v9 < 0 )
