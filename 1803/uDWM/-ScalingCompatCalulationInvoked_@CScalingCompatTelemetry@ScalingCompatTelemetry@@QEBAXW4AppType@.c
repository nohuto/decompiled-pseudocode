/*
 * XREFs of ?ScalingCompatCalulationInvoked_@CScalingCompatTelemetry@ScalingCompatTelemetry@@QEBAXW4AppType@2@II@Z @ 0x1800AADA8
 * Callers:
        ...
        int a4)
{
  ...
  v5 = wil::details::static_lazy<ScalingCompatLogging>::get(
         a1,
         (void (__cdecl *)())lambda_830a858705f438bc5eb56dc5316ebd68_::_lambda_invoker_cdecl_);
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
    ...
    v13 = 4LL;
    v15 = 4LL;
    LODWORD(v5) = TlgWrite(v6, &unk_1800B8F83, 0LL, 0LL, 5u, &pData);
  }
  return (int)v5;
}
