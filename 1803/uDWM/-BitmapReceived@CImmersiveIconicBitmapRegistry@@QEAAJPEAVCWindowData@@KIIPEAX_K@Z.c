/*
 * XREFs of ?BitmapReceived@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_K@Z @ 0x1800778B8
 * Callers:
        ...
        unsigned __int64 a7)
{
    ...
    && v12 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9B98, 1LL, v16, 0x173u);
    }
    if ( v17 )
  ...
  else
  {
    ...
    v18 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9B98, 1LL, -2147024809, 0x16Fu);
  }
  return v18;
}
