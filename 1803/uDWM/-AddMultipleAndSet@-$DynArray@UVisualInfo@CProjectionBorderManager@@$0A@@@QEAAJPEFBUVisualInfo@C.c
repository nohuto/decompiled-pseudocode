/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@UVisualInfo@CProjectionBorderManager@@$0A@@@QEAAJPEFBUVisualInfo@CProjectionBorderManager@@I@Z @ 0x18007B0C0
 * Callers:
...
__int64 __fastcall DynArray<CProjectionBorderManager::VisualInfo,0>::AddMultipleAndSet(__int64 a1, __int64 a2)
{
  ...
  if ( (int)v2 + 1 >= (unsigned int)v2 )
  {
    if ( v4 > *(_DWORD *)(a1 + 20) )
    {
      v7 = DynArrayImpl<0>::AddMultipleAndSet(a1, 56, 1, a2);
      v5 = v7;
      if ( v7 < 0 )
