/*
 * XREFs of ?GetTitleBarInfo@CWindowList@@AEAAJPEAUMILCMD_DWM_REDIRECTION_GETTITLEBARINFO@@@Z @ 0x1800025FC
 * Callers:
...
__int64 __fastcall CWindowList::GetTitleBarInfo(CWindowList *this, struct MILCMD_DWM_REDIRECTION_GETTITLEBARINFO *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowDataByHwnd, 0x14AFu);
  }
