/*
 * XREFs of ?Create@CAccentBlurBehind@@SAJPEAUIDwmChannel@@PEAPEAV1@@Z @ 0x180080000
 * Callers:
...
__int64 __fastcall CAccentBlurBehind::Create(struct IDwmChannel *a1, struct CAccentBlurBehind **a2)
{
  ...
  if ( !a2 )
  {
    v4 = -2147024809;
LABEL_3:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x3Bu);
    return v4;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x3Bu);
  }
  if ( v6 )
