/*
 * XREFs of ?OnAnimationClockChanged@CAnimationScheduler@@UEAAXU_GUID@@W4AnimationClockState@@@Z @ 0x18000B790
 * Callers:
...
__int64 __fastcall CAnimationScheduler::OnAnimationClockChanged(__int64 a1, struct _GUID *a2, int a3)
{
  ...
  if ( v7 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( v9 )
      {
        ...
        if ( v10 )
        {
          ...
          else
          {
            for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 32); i = (unsigned int)(i + 1) )
            {
              ...
              v25 = *(_OWORD *)(v14 + 48);
              v15 = v25 - *(_QWORD *)&a2->Data1;
              if ( (_QWORD)v25 == *(_QWORD *)&a2->Data1 )
                v15 = *((_QWORD *)&v25 + 1) - *(_QWORD *)a2->Data4;
              if ( !v15 )
                CAnimationScheduler::OnAnimationComplete((CAnimationScheduler *)(a1 - 8), *(_DWORD *)(v14 + 72));
            }
          }
        }
        else
        {
          for ( j = 0LL; (unsigned int)j < *(_DWORD *)(a1 + 32); j = (unsigned int)(j + 1) )
          {
            ...
            v26 = *(_OWORD *)(v17 + 48);
            v18 = v26 - *(_QWORD *)&a2->Data1;
            if ( (_QWORD)v26 == *(_QWORD *)&a2->Data1 )
              v18 = *((_QWORD *)&v26 + 1) - *(_QWORD *)a2->Data4;
      ...
      {
        v23 = *a2;
        CAnimationScheduler::_ScheduleStoryboardsForAnimationClock((CAnimationScheduler *)(a1 - 8), &v23);
      }
    }
    else
    {
      for ( k = 0LL; (unsigned int)k < *(_DWORD *)(a1 + 32); k = (unsigned int)(k + 1) )
      {
        ...
        v27 = *(_OWORD *)(v20 + 48);
        v21 = v27 - *(_QWORD *)&a2->Data1;
        if ( (_QWORD)v27 == *(_QWORD *)&a2->Data1 )
          v21 = *((_QWORD *)&v27 + 1) - *(_QWORD *)a2->Data4;
        if ( !v21
          && !*(_DWORD *)(v20 + 24)
  ...
  {
    v24 = *a2;
    CAnimationScheduler::_SetStoryboardTriggerForAnimationClock((CAnimationScheduler *)(a1 - 8), &v24);
  }
