/*
 * XREFs of ?SetSize@CHolographicSlate@@QEAAJII@Z @ 0x180076DCC
 * Callers:
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( v8 >= 0 )
      {
        ...
        *((_DWORD *)this + 15) = a3 + *((_DWORD *)this + 13);
        (*(void (__fastcall **)(_QWORD))(**((_QWORD **)v9 + 25) + 24LL))(*((_QWORD *)v9 + 25));
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x8Fu);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x8Eu);
    }
  }
  return v3;
}
