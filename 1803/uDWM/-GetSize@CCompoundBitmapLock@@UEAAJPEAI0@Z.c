/*
 * XREFs of ?GetSize@CCompoundBitmapLock@@UEAAJPEAI0@Z @ 0x1800AA840
 * Callers:
 *     ?GetSize@CCompoundBitmapLock@@W7EAAJPEAI0@Z @ 0x18004B620 (-GetSize@CCompoundBitmapLock@@W7EAAJPEAI0@Z.c)
 * Callees:
 *     <none>
 */
