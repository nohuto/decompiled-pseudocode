/*
 * XREFs of ?_RegisterIconicRepresentation@CImmersiveIconicBitmapRegistry@@AEAAJPEAVCImmersiveIconicResource@1@PEAUHWND__@@HW4DEVICE_SCALE_FACTOR@@_NPEAW4IconicRepresentationType@@4@Z @ 0x180078124
 * Callers:
        ...
        enum IconicRepresentationType *a8)
{
  ...
  *(_DWORD *)a7 = v11;
  ...
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0qp((__int64)a7, &UdwmSelectIconicRepresentation_Info, v19, a3);
  return 0LL;
}
