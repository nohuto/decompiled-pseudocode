/*
 * XREFs of ?StartDisplayCapture@CProjectionBorderManager@@UEAAJPEAUHMONITOR__@@PEAXAEBUDWM_CAPTURE_TOKEN@@@Z @ 0x18007C3A0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct DWM_CAPTURE_TOKEN *a4)
{
  ...
  if ( DesktopRootVisual >= 0 )
  {
    ...
    if ( DesktopRootVisual >= 0 )
    {
      DesktopRootVisual = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(**((_QWORD **)this + 54) + 1240LL))(
                            *((_QWORD *)this + 54),
                            v15,
                            v16);
      v10 = DesktopRootVisual;
