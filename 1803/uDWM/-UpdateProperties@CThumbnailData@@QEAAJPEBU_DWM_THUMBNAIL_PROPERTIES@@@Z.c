/*
 * XREFs of ?UpdateProperties@CThumbnailData@@QEAAJPEBU_DWM_THUMBNAIL_PROPERTIES@@@Z @ 0x18003689C
 * Callers:
...
__int64 __fastcall CThumbnailData::UpdateProperties(CThumbnailData *this, const struct _DWM_THUMBNAIL_PROPERTIES *a2)
{
  ...
  v17 = (CSecondaryWindowRepresentation **)*((_QWORD *)this + 11);
  if ( v17 )
  {
    updated = CThumbnailVisual::UpdateProperties(v17, v12);
    v3 = updated;
    if ( updated < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x1E7Au);
  }
  return v3;
}
