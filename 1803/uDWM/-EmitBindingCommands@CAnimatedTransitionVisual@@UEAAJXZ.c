/*
 * XREFs of ?EmitBindingCommands@CAnimatedTransitionVisual@@UEAAJXZ @ 0x1800934D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAnimatedTransitionVisual::EmitBindingCommands(CAnimatedTransitionVisual *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x775u);
    return v4;
  }
  v5 = 0;
  v26 = 0LL;
  ...
  {
    v6 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 86) + 16LL) + 1144LL))(
           *(_QWORD *)(*((_QWORD *)this + 86) + 16LL),
           *(unsigned int *)(*((_QWORD *)this + 86) + 24LL));
    v4 = v6;
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x786u);
      return v4;
    }
    v5 = 1;
  ...
  {
    HIDWORD(v25) = 0;
    v7 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 85) + 16LL) + 1152LL))(
           *(_QWORD *)(*((_QWORD *)this + 85) + 16LL),
           *(unsigned int *)(*((_QWORD *)this + 85) + 24LL));
    v4 = v7;
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x793u);
      return v4;
    }
    v8 = v5++;
  ...
  {
    HIDWORD(v25) = 0;
    v9 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 87) + 16LL) + 1160LL))(
           *(_QWORD *)(*((_QWORD *)this + 87) + 16LL),
           *(unsigned int *)(*((_QWORD *)this + 87) + 24LL));
    v4 = v9;
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x79Fu);
      return v4;
    }
    v10 = v5++;
    ...
    if ( v13 >= 0 )
    {
      ...
      if ( v14 >= 0 )
      {
        ...
        if ( v15 >= 0 )
        {
                ...
                if ( v19 >= 0 )
                {
                  ...
                  if ( v20 >= 0 )
                  {
                    ...
                    if ( v21 >= 0 )
                    {
                      ...
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0x7BDu);
                      }
                    }
                    else
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x7BCu);
                    }
                  }
                  else
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v20, 0x7BBu);
                  }
                }
                else
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0x7BAu);
                }
              }
              else
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x7B9u);
              }
            }
            else
            {
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0x7B7u);
          }
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x7B5u);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x7B1u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x7ADu);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x7A7u);
  }
  return v4;
}
