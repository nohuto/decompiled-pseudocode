/*
 * XREFs of ?EnsureNoiseSurfaceBrush@CAccentAcrylicBlurBehind@@AEAAJXZ @ 0x1800475AC
 * Callers:
...
__int64 __fastcall CAccentAcrylicBlurBehind::EnsureNoiseSurfaceBrush(CAccentAcrylicBlurBehind *this)
{
  ...
  if ( !*((_QWORD *)this + 40) )
  {
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x738u);
      Microsoft::WRL::ComPtr<IWICBitmapDecoder>::InternalRelease(&v44);
    ...
    else
    {
      ...
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x739u);
      }
      else
      {
        v45 = 0LL;
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x73Cu);
        }
        else
        {
          v13 = v45;
          ...
          if ( v14 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x73Fu);
          }
          else
          {
            v46 = 0LL;
            ...
            if ( v15 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x742u);
            }
            else
            {
              ...
              if ( v16 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x743u);
              }
              else
              {
                v48 = 0LL;
                ...
                if ( v17 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x746u);
                }
                else
                {
                  v55 = 0;
                  ...
                  if ( v18 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x74Bu);
                  }
                  else
                  {
                    ...
                    if ( v20 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x74Fu);
                    }
                    else
                    {
                      ...
                      if ( v21 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x751u);
                      }
                      else
                      {
                        v64 = v55;
                        ...
                        if ( v22 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x753u);
                        }
                        else
                        {
                          v52 = 0LL;
                          ...
                          if ( v23 < 0 )
                          {
                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x756u);
                          }
                          else
                          {
                            v24 = v52;
                            ...
                            if ( v27 < 0 )
                            {
                              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v27, 0x759u);
                            }
                            else
                            {
                              v28 = v51;
                              ...
                              if ( v31 < 0 )
                              {
                                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v31, 0x75Fu);
                              }
                              else
                              {
                                v54 = 0LL;
                                ...
                                if ( v32 < 0 )
                                {
                                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v32, 0x762u);
                                }
                                else
                                {
                                  v33 = v54;
                                  ...
                                  if ( v34 < 0 )
                                  {
                                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v34, 0x767u);
                                  }
                                  else
                                  {
                                    v57 = 0LL;
                                    ...
                                    if ( v35 < 0 )
                                    {
                                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v35, 0x76Bu);
                                    }
                                    else
                                    {
                                      v66 = 0;
                                      ...
                                      if ( v36 < 0 )
                                      {
                                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v36, 0x780u);
                                      }
                                      else
                                      {
                                        v59 = 0LL;
                                        ...
                                        if ( v37 < 0 )
                                        {
                                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v37, 0x783u);
                                        }
                                        else
                                        {
                                          v60 = 0LL;
                                          ...
                                          if ( v38 < 0 )
                                          {
                                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v38, 0x787u);
                                          }
                                          else
                                          {
                                            v39 = v59;
                                            ...
                                            if ( v40 < 0 )
                                            {
                                              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v40, 0x78Bu);
                                            }
                                            else
                                            {
                                              ...
                                              if ( v41 < 0 )
                                              {
                                                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v41, 0x78Cu);
                                              }
                                              else
                                              {
                                                ...
                                                v3 = v42;
                                                if ( v42 < 0 )
                                                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v42, 0x78Fu);
                                              }
                                            }
                                            Microsoft::WRL::ComPtr<IWICBitmapDecoder>::InternalRelease(&v58);
                                          }
