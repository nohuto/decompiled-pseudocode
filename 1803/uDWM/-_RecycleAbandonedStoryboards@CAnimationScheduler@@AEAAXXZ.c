/*
 * XREFs of ?_RecycleAbandonedStoryboards@CAnimationScheduler@@AEAAXXZ @ 0x18000B5EC
 * Callers:
...
void __fastcall CAnimationScheduler::_RecycleAbandonedStoryboards(CAnimationScheduler *this, __int64 a2)
{
  ...
  while ( (unsigned int)v2 < *((_DWORD *)this + 10) )
  {
    ...
    if ( v5[6] == 4 )
    {
      ...
      (*(void (__fastcall **)(_DWORD *, __int64, __int64, __int64))(*(_QWORD *)v5 + 56LL))(v5, a2, v4, v7);
    }
    else
    {
