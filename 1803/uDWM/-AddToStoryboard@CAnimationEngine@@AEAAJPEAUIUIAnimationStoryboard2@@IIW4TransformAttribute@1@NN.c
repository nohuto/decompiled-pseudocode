/*
 * XREFs of ?AddToStoryboard@CAnimationEngine@@AEAAJPEAUIUIAnimationStoryboard2@@IIW4TransformAttribute@1@NNPEAN2IPEAUTA_TIMINGFUNCTION@@W4TransformMode@@22I@Z @ 0x18000E0D4
 * Callers:
...
LABEL_9:
  ...
  else
  {
    ...
    v25 = a7;
    v22 = CAnimationEngine::CreateAnimationTransition(
