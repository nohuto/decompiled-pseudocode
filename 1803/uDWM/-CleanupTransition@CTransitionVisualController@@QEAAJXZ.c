/*
 * XREFs of ?CleanupTransition@CTransitionVisualController@@QEAAJXZ @ 0x1800092C8
 * Callers:
...
__int64 __fastcall CTransitionVisualController::CleanupTransition(CTransitionVisualController *this)
{
  ...
  if ( v3 )
  {
    v14 = (struct CVisual *)*((_QWORD *)this + 2);
    if ( v14 )
    {
      if ( *((_DWORD *)this + 34) )
      {
      ...
      VisualCollection::Remove((VisualCollection *)(v3 + 32), v14);
      v15 = (CBaseObject *)*((_QWORD *)this + 2);
      if ( v15 )
      {
    ...
    v16 = (unsigned int)(*((_DWORD *)this + 12) - 1);
    if ( (int)v16 >= 0 )
    {
      v33 = 24LL * (int)v16;
      do
      {
        ...
        if ( *(_BYTE *)(v34 + v33 + 16) )
        {
          CTransitionVisualController::_CleanupHighZOrderClone(this, (struct CTopLevelWindow **)(v34 + 24 * v16));
          DynArray<CTransitionVisualController::TlwPair,0>::RemoveAt((__int64 *)this + 3, v16);
        }
        v33 -= 24LL;
