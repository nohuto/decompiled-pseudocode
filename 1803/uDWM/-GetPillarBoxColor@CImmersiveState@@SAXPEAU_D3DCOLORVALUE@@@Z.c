/*
 * XREFs of ?GetPillarBoxColor@CImmersiveState@@SAXPEAU_D3DCOLORVALUE@@@Z @ 0x1800A6434
 * Callers:
...
void __fastcall CImmersiveState::GetPillarBoxColor(struct _D3DCOLORVALUE *a1)
{
  ...
  a1->a = 1.0;
  a1->r = v3;
  a1->g = GammaLUT_sRGB_to_scRGB[BYTE1(StaticImmersiveColorPrivForHighContrastState)] / 255.0;
