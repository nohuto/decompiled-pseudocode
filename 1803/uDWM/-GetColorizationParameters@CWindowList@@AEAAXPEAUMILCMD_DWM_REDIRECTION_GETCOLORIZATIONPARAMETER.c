/*
 * XREFs of ?GetColorizationParameters@CWindowList@@AEAAXPEAUMILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS@@@Z @ 0x180084884
 * Callers:
        ...
        struct MILCMD_DWM_REDIRECTION_GETCOLORIZATIONPARAMETERS *a2)
{
  ...
  v4 = *((_DWORD *)CDesktopManager::s_pDesktopManagerInstance + 129);
  v7 = *(_QWORD *)((char *)CDesktopManager::s_pDesktopManagerInstance + 508);
