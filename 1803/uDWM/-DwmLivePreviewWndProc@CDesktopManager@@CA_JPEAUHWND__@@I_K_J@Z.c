/*
 * XREFs of ?DwmLivePreviewWndProc@CDesktopManager@@CA_JPEAUHWND__@@I_K_J@Z @ 0x180074CB0
 * Callers:
 *     <none>
 * Callees:
...
LRESULT __fastcall CDesktopManager::DwmLivePreviewWndProc(HWND hWnd, UINT Msg, HWND wParam, LPARAM lParam)
{
  ...
  if ( Msg == 6 )
  {
    ...
    {
      v9 = 1;
      *((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 80) = 0LL;
      goto LABEL_26;
    }
    goto LABEL_29;
  }
    ...
    if ( Msg == 71 )
    {
      if ( (*(_BYTE *)(lParam + 32) & 0x40) != 0 )
      {
        ...
        else
        {
          ...
          if ( v13 >= 0 )
            v13 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x8F0u);
        }
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
        v9 = v13 < 0;
LABEL_26:
    ...
    if ( Msg != 257 )
    {
      if ( Msg == 1028 )
      {
        ...
        if ( !SetWindowPos(wParam, 0LL, 0, 0, 0, 0, lParam != 0 ? 67 : 83) )
        {
          ...
          if ( v12 >= 0 )
            v12 = -2003304445;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x8DAu);
          v9 = wParam == hWnd;
        }
        v10 = 0;
        EnterCriticalSection(&CDesktopManager::s_csDwmInstance);
...
LABEL_27:
  CLivePreview::Activate(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 59), 0, 0LL, 0LL, 1, 0, 0, 0LL);
LABEL_28:
  if ( v10 )
    goto LABEL_29;
LABEL_30:
