/*
 * XREFs of ?OnAnimationComplete@CScreenRotation@@UEAAJI@Z @ 0x180099490
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( *((_BYTE *)this + 49) )
  {
    ...
    v4 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x142u);
  }
  else
  {
    ...
    v4 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x146u);
  }
LABEL_22:
