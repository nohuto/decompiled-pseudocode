/*
 * XREFs of ?CreateDesktopAnimationComponent@CTransitionVisualController@@QEAAJPEAVCWindowData@@HAEBUtagRECT@@_N2PEAVCStoryboard@@PEAPEAVCAnimationComponent@@@Z @ 0x180096F58
 * Callers:
        ...
        struct CAnimationComponent **a8)
{
  ...
  int v40; // edx
  int v41; // ebx
  struct CAnimatedTransitionVisual *v42; // r14
  int v43; // edx
  int v44; // ecx
  __int128 v45; // xmm0
  unsigned int v47; // [rsp+20h] [rbp-E0h]
  unsigned __int64 v49; // [rsp+50h] [rbp-B0h]
  struct CAnimatedTransitionVisual *v50; // [rsp+58h] [rbp-A8h] BYREF
  struct CVisual *v51; // [rsp+60h] [rbp-A0h] BYREF
...
LABEL_25:
    ...
    *((_QWORD *)v42 + 119) = v49;
    if ( v55 )
    {
      *(_OWORD *)((char *)v42 + 888) = *(_OWORD *)((char *)a2 + 604);
      *(_OWORD *)((char *)v42 + 824) = *(_OWORD *)((char *)a2 + 604);
      CVisual::SetDirtyFlags((struct CAnimatedTransitionVisual *)((char *)v42 + 8), 4096);
      *(_OWORD *)((char *)v42 + 904) = *(_OWORD *)((char *)a2 + 636);
      CVisual::SetDirtyFlags((struct CAnimatedTransitionVisual *)((char *)v42 + 8), 4096);
      *((_BYTE *)v42 + 986) = 1;
    }
    if ( !IsRectEmpty((const RECT *)((char *)a2 + 668)) )
    {
      v45 = *(_OWORD *)((char *)a2 + 668);
      *(_DWORD *)(v21 + 68) = 2;
      *(_OWORD *)(v21 + 104) = v45;
    }
