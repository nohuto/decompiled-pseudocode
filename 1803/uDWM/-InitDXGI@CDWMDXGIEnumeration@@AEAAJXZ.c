/*
 * XREFs of ?InitDXGI@CDWMDXGIEnumeration@@AEAAJXZ @ 0x180034300
 * Callers:
...
LABEL_50:
    v16 = v3;
LABEL_53:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B3788, 1u, v16, v17);
LABEL_34:
    if ( ppFactory )
  ...
  while ( (*(unsigned int (__fastcall **)(void *, _QWORD, __int64 *))(*(_QWORD *)ppFactory + 96LL))(ppFactory, v2, &v21) != -2005270526 )
  {
    ...
    {
      v9 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 56, 8, 1, v22);
      v4 = v9;
      if ( v9 < 0 )
