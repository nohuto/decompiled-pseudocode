/*
 * XREFs of ?CleanupFinishedAnimations@CContactManager@@AEAAXXZ @ 0x18008987C
 * Callers:
 ...
 *     ?IsOKToCleanup@CFlickVisual@@UEAA_NXZ @ 0x18008A0C0 (-IsOKToCleanup@CFlickVisual@@UEAA_NXZ.c)
 ...
 *     ?IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ @ 0x18008D990 (-IsOKToCleanup@CContactStationaryVisual@@UEAA_NXZ.c)
...
LABEL_9:
  ...
  if ( v8 >= 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v11 )
        goto LABEL_15;
      if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v11 + 192LL))(v11) )
        break;
LABEL_16:
      v10 -= 8LL;
      if ( --v8 < 0 )
