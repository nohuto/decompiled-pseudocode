/*
 * XREFs of ?RemoveSecondaryWindowRepresentation@CWindowData@@QEAAXPEAVCSecondaryWindowRepresentation@@@Z @ 0x1800156C8
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (CWindowData *)v6 != this )
  {
    ...
    DynArray<CSecondaryWindowRepresentation *,0>::Remove((char *)this + 440, &v7);
  }
  LOBYTE(a4) = 1;
