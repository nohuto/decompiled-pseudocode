/*
 * XREFs of ?OnCaptureRTBitsWorker@CMagnifier@@AEAAJ_KKHPEBUMAGN_UPDATE_TEXTURES_PARAM@@PEAUMILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY@@@Z @ 0x18007908C
 * Callers:
        ...
        struct MILCMD_DWM_CAPTURE_METARENDERTARGET_BITSREPLY *a6)
{
  ...
  if ( *((_DWORD *)this + 44) )
  {
    ...
    if ( !a4 )
      v10 = a3 & 1;
    v11 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD, __int64, int, _DWORD, const struct MAGN_UPDATE_TEXTURES_PARAM *, char *))(*(_QWORD *)v9 + 768LL))(
            v9,
            *(unsigned int *)(v8 + 24),
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800B9BA0, 8LL, v11, 0x21Cu);
    }
  }
  else
  {
