/*
 * XREFs of ?_CollectWindows@CLivePreview@@AEAAJXZ @ 0x180071538
 * Callers:
...
LABEL_61:
      ...
      *(_OWORD *)&v40.m256i_u64[1] = 0LL;
      ...
      if ( v30 >= (unsigned int)v28 )
      {
        ...
        {
          v32 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 304, 40, 1, &v40);
          v2 = v32;
          if ( v32 < 0 )
      ...
      if ( v2 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x153u);
        goto LABEL_74;
      }
      v8 = v39;
LABEL_71:
...
LABEL_51:
                ...
                if ( v25 >= v6 )
                {
                  if ( v9 > v5 )
                  {
                    v27 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v36[1], 8, 1, v36);
                    if ( v27 < 0 )
    ...
    {
      v16 = 0;
      v17 = (const wchar_t **)&off_1800B09B0;
...
LABEL_21:
    ...
    {
LABEL_29:
      v15 = (v18 << 6) | *(_BYTE *)(Blink + 594) & 0xBF;
      *(_BYTE *)(Blink + 594) = v15;
      goto LABEL_30;
    }
LABEL_28:
...
LABEL_74:
  DynArrayImpl<0>::~DynArrayImpl<0>((__int64)&v36[1]);
