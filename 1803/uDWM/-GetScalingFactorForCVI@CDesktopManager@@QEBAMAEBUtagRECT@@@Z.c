/*
 * XREFs of ?GetScalingFactorForCVI@CDesktopManager@@QEBAMAEBUtagRECT@@@Z @ 0x180024C5C
 * Callers:
 ...
 *     ?_IsSameAsTargetCachedCVI@CDesktopManager@@CA_NHH@Z @ 0x180031750 (-_IsSameAsTargetCachedCVI@CDesktopManager@@CA_NHH@Z.c)
