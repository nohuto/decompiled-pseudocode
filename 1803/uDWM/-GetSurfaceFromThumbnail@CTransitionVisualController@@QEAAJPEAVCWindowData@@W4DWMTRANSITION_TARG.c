/*
 * XREFs of ?GetSurfaceFromThumbnail@CTransitionVisualController@@QEAAJPEAVCWindowData@@W4DWMTRANSITION_TARGET@@PEBUtagRECT@@_NPEAPEAVCResource@@4PEAUMilPoint3F@@@Z @ 0x180007A0C
 * Callers:
        ...
        float *a8)
{
  ...
  *(_QWORD *)&v29 = a4;
  ...
  if ( (LODWORD(v10) & 0x4000000) != 0 )
    (*(void (__fastcall **)(_QWORD, _QWORD))(**((_QWORD **)v26 + 2) + 1016LL))(
      *((_QWORD *)v26 + 2),
      *((unsigned int *)v26 + 6));
  ...
  if ( v21 >= 0 )
  {
    ...
    v30 = _xmm;
    v29 = _xmm;
    v22 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int128 *, __int128 *, _DWORD, _DWORD, _DWORD, int, int, _DWORD, _DWORD, int, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)v25 + 2) + 1208LL))(
            *((_QWORD *)v25 + 2),
            *((unsigned int *)v25 + 6),
            *((_QWORD *)v25 + 2),
            &v30,
