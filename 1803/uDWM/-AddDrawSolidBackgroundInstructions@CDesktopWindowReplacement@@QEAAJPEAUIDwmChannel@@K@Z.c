/*
 * XREFs of ?AddDrawSolidBackgroundInstructions@CDesktopWindowReplacement@@QEAAJPEAUIDwmChannel@@K@Z @ 0x1800311D0
 * Callers:
        ...
        int a3)
{
  ...
  struct CRectangleInstruction *v12; // rbx
  CRectangleInstruction *v13; // rcx
  unsigned int v14; // r8d
  int v15; // r9d
  __int64 v17; // rdx
  __int64 v18; // rdx
  struct CRectangleInstruction *v19; // [rsp+20h] [rbp-50h] BYREF
