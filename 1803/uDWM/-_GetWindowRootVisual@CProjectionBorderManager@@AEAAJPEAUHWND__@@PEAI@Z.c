/*
 * XREFs of ?_GetWindowRootVisual@CProjectionBorderManager@@AEAAJPEAUHWND__@@PEAI@Z @ 0x18007E8D8
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  *a3 = 0;
  v11 = 0LL;
  SyncedWindowDataByHwnd = CWindowList::GetSyncedWindowDataByHwnd(*((CWindowList **)v5 + 56), a2, &v11);
