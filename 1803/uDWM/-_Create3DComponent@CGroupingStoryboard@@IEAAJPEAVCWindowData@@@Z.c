/*
 * XREFs of ?_Create3DComponent@CGroupingStoryboard@@IEAAJPEAVCWindowData@@@Z @ 0x18009D328
 * Callers:
        ...
        __int64 a3)
{
  ...
  int v19; // eax
  struct CAnimationComponent *v20; // rbx
  __int64 v21; // rcx
  unsigned int v23; // [rsp+20h] [rbp-49h]
  struct CAnimationComponent *v24; // [rsp+50h] [rbp-19h] BYREF
...
LABEL_7:
    ...
    {
      v19 = (*(__int64 (__fastcall **)(CGroupingStoryboard *, _QWORD))(*(_QWORD *)this + 88LL))(
              this,
              *((unsigned int *)a2 + 150));
      v11 = CStoryboard::_CreateAndAddAnimationComponentControlReuse(this, a2, 0, v19, 0LL, 0LL, 0xFFFFFFFF, v6, &v24);
      v6 = v11;
      if ( v11 < 0 )
      {
        v23 = 2170;
    ...
    else
    {
      ...
      *(_QWORD *)&rc.right = 0LL;
      ...
      {
        v12 = -*((_DWORD *)a2 + 155);
        v13 = -HIDWORD(*(_QWORD *)((char *)a2 + 620));
...
LABEL_20:
      ...
      v18 = *(struct tagRECT *)((char *)a2 + 620);
    }
    v28 = v18;
    goto LABEL_29;
  }
