/*
 * XREFs of ?Initialize@CTextTetherVisual@@MEAAJPEAUIDwmChannel@@@Z @ 0x18008E380
 * Callers:
...
__int64 __fastcall CTextTetherVisual::Initialize(struct CBitmapSource **this, struct IDwmChannel *a2)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      v9 = (struct CVisual ***)(this + 50);
      v24 = (struct tagSIZE)*((_QWORD *)*v6 + 3);
      v10 = CImage::Create(a2, this + 50);
      v5 = v10;
      if ( v10 >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          CVisual::SetInterpolationMode((CVisual *)*v9, 6);
          v13 = CImage::SetBitmapSource((CImage *)*v9, *v6);
          v5 = v13;
          if ( v13 >= 0 )
          {
            CVisual::SetSize((struct tagSIZE *)*v9, &v24);
            CVisual::MoveToFront((CVisual *)*v9, 0);
            v14 = (struct tagSIZE **)(this + 51);
            v15 = (void *)CDesktopManager::GetTheme(1);
            v16 = CTopLevelWindow::CreateBitmapFromAtlas(v15, 4, 0LL, this + 51);
            v5 = v16;
            if ( v16 >= 0 )
            {
              v17 = this + 52;
              ...
              if ( v18 >= 0 )
              {
                v19 = VisualCollection::InsertRelative(v11, (struct CVisual **)*v17, 0LL, 0, 1);
                v5 = v19;
                if ( v19 >= 0 )
                {
                  ...
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0x4Cu);
                  }
                }
                else
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0x48u);
                }
              }
              else
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x47u);
              }
            }
            else
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0x45u);
            }
          }
          else
          {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x3Du);
      }
    }
    else
    {
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x36u);
  }
  return v5;
}
