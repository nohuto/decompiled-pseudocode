/*
 * XREFs of ?_WindowEnumCallback@CVirtualDesktopSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800A26F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall CVirtualDesktopSwitch::_WindowEnumCallback(__int64 a1, struct CWindowData *a2, char a3, int *a4)
{
  ...
  __int64 v19; // rcx
  int v20; // eax
  struct CAnimationComponent *v21; // rdi
  __int64 v22; // rcx
  unsigned int v23; // eax
  struct CAnimationComponent *v25; // [rsp+38h] [rbp-39h] BYREF
