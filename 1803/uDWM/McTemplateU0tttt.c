/*
 * XREFs of McTemplateU0tttt @ 0x1800A2A68
 * Callers:
...
__int64 __fastcall McTemplateU0tttt(__int64 a1, __int64 a2, int a3, int a4, char a5, char a6)
{
  ...
  return McGenEventWriteUM(
           ...
           &UdwmSystemAnimation_DelayedArrangementStart,
           5LL,
           (__int64)v7);
}
