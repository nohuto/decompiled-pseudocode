/*
 * XREFs of ?SmoothTouchDragPath@CTouchDragVisualHelper@@SAXPEBV?$DynArray@UTOUCH_DRAG_POINT@@$0A@@@PEAV2@@Z @ 0x18008ECD8
 * Callers:
 ...
 *     ?GetMidPoint@CTouchDragVisualHelper@@CA?AUTOUCH_DRAG_POINT@@PEBU2@0@Z @ 0x18008EBA0 (-GetMidPoint@CTouchDragVisualHelper@@CA-AUTOUCH_DRAG_POINT@@PEBU2@0@Z.c)
      ...
      do
      {
        ...
        *((float *)&v70 + 1) = (float)(*((float *)&v66 + 1) * v59) + (float)(v57 + v54);
        ...
        if ( v61 >= (unsigned int)v60 )
        {
          if ( v6 > *(_DWORD *)(a2 + 20) )
          {
            v63 = DynArrayImpl<0>::AddMultipleAndSet(a2, 28, 1, &v69);
            if ( v63 < 0 )
