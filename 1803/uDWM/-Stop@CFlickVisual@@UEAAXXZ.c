/*
 * XREFs of ?Stop@CFlickVisual@@UEAAXXZ @ 0x1800922A0
 * Callers:
 ...
 *     ?UpdateTransition@CFlickVisual@@MEAAJXZ @ 0x180092350 (-UpdateTransition@CFlickVisual@@MEAAJXZ.c)
 * Callees:
...
void __fastcall CFlickVisual::Stop(CFlickVisual *this)
{
  ...
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0d(v2, &UdwmFlickVisual_End, *((_DWORD *)this + 75));
}
