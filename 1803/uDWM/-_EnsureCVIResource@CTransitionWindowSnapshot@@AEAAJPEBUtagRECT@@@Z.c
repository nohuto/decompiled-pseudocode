/*
 * XREFs of ?_EnsureCVIResource@CTransitionWindowSnapshot@@AEAAJPEBUtagRECT@@@Z @ 0x180031840
 * Callers:
...
LABEL_33:
  ...
  v13 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, float *, double *, _DWORD, _DWORD, _DWORD, _DWORD))(**((_QWORD **)*v7 + 2) + 1008LL))(
          *((_QWORD *)*v7 + 2),
          *((unsigned int *)*v7 + 6),
          v29,
          &v27,
  ...
  v19 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, double *))(**((_QWORD **)*v7 + 2) + 1024LL))(
          *((_QWORD *)*v7 + 2),
          *((unsigned int *)*v7 + 6),
          &v27);
  v11 = v19;
