/*
 * XREFs of CTransitionVisualController::ForEachOwnedWindow__lambda_4ad19751f65124ce209d5138e63b7715___ @ 0x1800422CC
 * Callers:
        ...
        if ( (*(_DWORD *)(v7 + 600) & 0xFFF) == 0xFFF )
        {
          ...
          if ( *(_QWORD *)(v7 + 392) )
          {
            if ( CTransitionVisualController::ShouldCloneWindow(*(HWND *)(v7 + 40)) )
              v3 = CVisual::RenderRecursive(*(CVisual **)(v7 + 392));
            a2 = v9;
          }
          if ( v3 >= 0 )
