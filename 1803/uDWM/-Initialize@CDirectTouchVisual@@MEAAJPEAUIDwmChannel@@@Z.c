/*
 * XREFs of ?Initialize@CDirectTouchVisual@@MEAAJPEAUIDwmChannel@@@Z @ 0x18003D6F0
 * Callers:
...
__int64 __fastcall CDirectTouchVisual::Initialize(struct tagSIZE *this, struct IDwmChannel *a2)
{
  ...
  else
  {
    ...
    if ( *(_BYTE *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 22) + 324LL) )
    {
    ...
    else
    {
      ...
      {
        CVisual::SetSize((struct tagSIZE *)*v9, this + 40);
        this[47] = 0LL;
        this[48] = 0LL;
        this[49] = 0LL;
        LOBYTE(this[35].cx) = 0;
