/*
 * XREFs of ?SetPassiveUpdateMode@CWindowList@@UEAAJPEAUIDwmWindow@@_N@Z @ 0x18002B980
 * Callers:
...
__int64 __fastcall CWindowList::SetPassiveUpdateMode(CWindowList *this, struct IDwmWindow *a2, unsigned __int8 a3)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0x8E2u);
  }
  else if ( v13 )
  {
    v8 = *((_QWORD *)v13 + 49);
    if ( v8 )
    {
      ...
      if ( a3 != ((*(_BYTE *)(v8 + 241) & 0x10) != 0) )
      {
        ...
        *(_BYTE *)(v8 + 241) = (16 * a3) | *(_BYTE *)(v8 + 241) & 0xEF;
        ...
        v12 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD))(**(_QWORD **)(v10 + 16) + 496LL))(
                *(_QWORD *)(v10 + 16),
                v11,
                a3);
        v7 = v12;
        if ( v12 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x135u);
      }
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x8E6u);
    }
  }
