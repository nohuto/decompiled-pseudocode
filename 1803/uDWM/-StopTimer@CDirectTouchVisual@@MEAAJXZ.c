/*
 * XREFs of ?StopTimer@CDirectTouchVisual@@MEAAJXZ @ 0x18003D4D0
 * Callers:
 ...
 *     ?Stop@CDirectTouchVisual@@UEAAXXZ @ 0x18006C230 (-Stop@CDirectTouchVisual@@UEAAXXZ.c)
 ...
 * Callees:
 *     ?StopDownTimeline@CDirectTouchVisual@@IEAAXXZ @ 0x18003D4A0 (-StopDownTimeline@CDirectTouchVisual@@IEAAXXZ.c)
