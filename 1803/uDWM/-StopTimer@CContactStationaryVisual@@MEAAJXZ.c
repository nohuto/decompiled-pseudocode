/*
 * XREFs of ?StopTimer@CContactStationaryVisual@@MEAAJXZ @ 0x18008DE70
 * Callers:
 ...
 *     ?Stop@CContactStationaryVisual@@UEAAXXZ @ 0x18008DE50 (-Stop@CContactStationaryVisual@@UEAAXXZ.c)
