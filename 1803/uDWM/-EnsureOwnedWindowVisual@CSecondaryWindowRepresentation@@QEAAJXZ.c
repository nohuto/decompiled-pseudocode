/*
 * XREFs of ?EnsureOwnedWindowVisual@CSecondaryWindowRepresentation@@QEAAJXZ @ 0x18002F0C4
 * Callers:
  ...
  if ( !*((_QWORD *)this + 6) )
  {
    ...
    else
    {
      ...
      else
      {
        v6 = (volatile signed __int32 *)v9;
        v2 = (volatile signed __int32 *)v10;
        inserted = VisualCollection::InsertRelative((CBaseObject *)((char *)v9 + 32), (struct CVisual **)v10, 0LL, 0, 1);
        v1 = inserted;
        if ( inserted < 0 )
        {
