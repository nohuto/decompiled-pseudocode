/*
 * XREFs of ?_AddImmersiveBackground@CLivePreview@@AEAAJAEAV?$DynArray@UtagRECT@@$0A@@@@Z @ 0x180070C04
 * Callers:
 ...
 *     ?_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ @ 0x1800729FC (-_ShouldAddImmersiveChrome@CLivePreview@@AEAA_NXZ.c)
...
LABEL_11:
    ...
    *(struct tagRECT *)&v30.m256i_u64[1] = v31;
    ...
    if ( v21 >= (unsigned int)v20 )
    {
      ...
      {
        v22 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v19, 32, 1, &v30);
        if ( v22 < 0 )
