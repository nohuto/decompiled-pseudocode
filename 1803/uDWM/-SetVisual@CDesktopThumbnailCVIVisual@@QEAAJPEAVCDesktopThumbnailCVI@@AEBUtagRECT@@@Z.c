/*
 * XREFs of ?SetVisual@CDesktopThumbnailCVIVisual@@QEAAJPEAVCDesktopThumbnailCVI@@AEBUtagRECT@@@Z @ 0x1800A427C
 * Callers:
        ...
        const struct tagRECT *a3)
{
  ...
  struct CRenderDataInstruction *v15; // [rsp+38h] [rbp-8h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+68h] [rbp+28h]
  struct CResource *v17; // [rsp+70h] [rbp+30h] BYREF
