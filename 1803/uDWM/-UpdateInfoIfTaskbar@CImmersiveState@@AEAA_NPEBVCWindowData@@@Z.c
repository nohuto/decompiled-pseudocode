/*
 * XREFs of ?UpdateInfoIfTaskbar@CImmersiveState@@AEAA_NPEBVCWindowData@@@Z @ 0x18000736C
 * Callers:
 ...
 *     wcscmp_0 @ 0x18004B372 (wcscmp_0.c)
 */
        ...
        if ( GetMonitorInfoW(v6, &mi) )
        {
          ...
          if ( (int)v16 + 1 < (unsigned int)v16 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(
              ...
              0LL,
              0,
              (int)v16 + 1 < (unsigned int)v16 ? 0x80070216 : 0,
              0xB5u);
          }
