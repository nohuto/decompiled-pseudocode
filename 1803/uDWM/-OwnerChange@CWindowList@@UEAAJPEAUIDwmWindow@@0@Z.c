/*
 * XREFs of ?OwnerChange@CWindowList@@UEAAJPEAUIDwmWindow@@0@Z @ 0x1800290F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  ...
  {
LABEL_33:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xBFAu);
    goto LABEL_7;
  }
  if ( v7 )
  {
    ...
    if ( a3 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SyncedWindowData, 0xC02u);
        goto LABEL_7;
      }
      v12 = v23;
    }
    ...
    if ( (CWindowData *)v13 != v12 )
    {
      ...
      *((_QWORD *)v7 + 68) = 0LL;
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0xC29u);
      }
      else
      {
LABEL_17:
...
LABEL_18:
        *((_QWORD *)v15 + 68) = v12;
        if ( v12 && v12 != v23 )
        {
          ...
          if ( v16 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0xC36u);
          }
          else
          {
            ...
            v10 = v17;
            if ( v17 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0xC3Bu);
          }
        }
      }
    }
    if ( v10 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0xC06u);
  }
LABEL_7:
