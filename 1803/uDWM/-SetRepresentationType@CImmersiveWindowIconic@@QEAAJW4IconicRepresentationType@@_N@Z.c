/*
 * XREFs of ?SetRepresentationType@CImmersiveWindowIconic@@QEAAJW4IconicRepresentationType@@_N@Z @ 0x180078AB8
 * Callers:
  ...
  *((_DWORD *)a1 + 76) = a2;
  ...
  if ( v6 != v3 )
  {
    if ( a3 )
    {
      ...
      v4 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0xFBu);
    }
  }
  return v4;
}
