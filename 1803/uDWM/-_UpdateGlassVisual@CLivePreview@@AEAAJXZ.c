/*
 * XREFs of ?_UpdateGlassVisual@CLivePreview@@AEAAJXZ @ 0x180072F3C
 * Callers:
    ...
    do
    {
      ...
      if ( (*(_BYTE *)(v10 + 594) & 0x40) == 0 )
      {
        ...
        else if ( !*(_QWORD *)(v9 + v8 + 16) )
        {
          ...
          if ( v12 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x638u);
            return v4;
          }
          v13 = v18;
          ...
          if ( inserted < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0x639u);
            return v4;
          }
