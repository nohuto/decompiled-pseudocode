/*
 * XREFs of ?RegisterIconicAnimatedVisual@CImmersiveIconicBitmapRegistry@@QEAAJPEAVCIconicAnimatedVisual@@@Z @ 0x180077C30
 * Callers:
        ...
        struct CIconicAnimatedVisual *a2)
{
  ...
  if ( v2 + 1 >= v2 )
  {
    ...
    {
      v5 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 48, 8, 1, &v7);
      v4 = v5;
      if ( v5 >= 0 )
      {
LABEL_9:
  ...
  if ( v4 >= 0 )
    goto LABEL_9;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v4, 0x229u);
  return (unsigned int)v4;
}
