/*
 * XREFs of ?FallBackToBDD@@YA_NXZ @ 0x180002490
 * Callers:
...
bool FallBackToBDD(void)
{
  ...
  if ( LibraryW )
  {
    ...
    if ( ProcAddress )
    {
      ...
      {
        ++dword_18000E7A4;
        v6 = (_unnamed_type_gDwmInitTelemetryAggregator_ *)(unsigned int)(dword_18000E7B0 + 1);
        dword_18000E7B0 = (int)v6;
        if ( (int)v6 > 10 )
        {
          ...
          && (qword_18000E018 & 0x400000000000LL) == qword_18000E018 )
        {
          ...
          v23 = 16LL;
          v25 = 2LL;
          TlgWrite(v6, &unk_18000AB55, (LPCGUID)0x400000000000LL, v4, 8u, &pData);
          v5 = v8;
        }
