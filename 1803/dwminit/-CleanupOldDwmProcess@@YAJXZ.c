/*
 * XREFs of ?CleanupOldDwmProcess@@YAJXZ @ 0x18000272C
 * Callers:
 ...
 *     ?ShouldRestartSession@@YA_NU_FILETIME@@@Z @ 0x180002668 (-ShouldRestartSession@@YA_NU_FILETIME@@@Z.c)
...
__int64 CleanupOldDwmProcess(void)
{
  ...
  ExitTime = 0LL;
  restarted = 1;
  v1 = WaitForDwmExit(&ExitCode[1], &ExitTime);
  ExitCode[0] = v1;
  if ( v1 < 0 )
  {
    DoStackCapture(v1, 0x438u);
  }
  else
  {
    ...
    if ( v4 )
    {
      ...
      v7 = StringCchPrintfW(Buffer, 11LL, L"0x%08x", ExitCode[1]);
      v8 = Buffer;
      if ( v7 < 0 )
        v8 = 0LL;
      Strings[0] = v8;
    ...
    if ( (unsigned int)dword_18000E000 > 5
      && (qword_18000E010 & 0x400000000000LL) != 0
      && (qword_18000E018 & 0x400000000000LL) == qword_18000E018 )
    {
      ...
      v30 = 2LL;
      v32 = 2LL;
      TlgWrite(v3, &unk_18000AA09, v5, v6, 8u, &pData);
    }
    v11 = LOWORD(ExitCode[1]) | 0x80070000;
    if ( (int)ExitCode[1] <= 0 )
      v11 = ExitCode[1];
  ...
  if ( restarted )
  {
      ...
      && (qword_18000E018 & 0x400000000000LL) == qword_18000E018 )
    {
      ...
      v30 = 2LL;
      v32 = 2LL;
      TlgWrite(v13, &unk_18000ACC4, v14, v15, 8u, &pData);
    }
    _unnamed_type_gDwmInitTelemetryAggregator_::ReportAggregatedValues(v13, v12, (__int64)v14, v15);
    TraceLoggingWriteEtw((const struct _TlgProvider_t *)3, ExitCode[0], (const GUID *)(unsigned int)gDwmNumRetriesSoFar);
  }
  return ExitCode[0];
}
