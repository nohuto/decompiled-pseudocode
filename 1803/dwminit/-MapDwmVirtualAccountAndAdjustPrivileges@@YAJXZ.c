/*
 * XREFs of ?MapDwmVirtualAccountAndAdjustPrivileges@@YAJXZ @ 0x180001AC8
 * Callers:
 ...
 *     ?LsaCollisionResult@@YA_NW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z @ 0x180001920 (-LsaCollisionResult@@YA_NW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z.c)
...
LABEL_4:
  ...
  v3 = v1;
LABEL_18:
  MilInstrumentationCheckHR_MaybeFailFast(4u, &dword_180009D48, 1u, v3, SubAuthority2);
LABEL_19:
  if ( v7 )
    RtlFreeSid(v7);
  if ( v8 )
