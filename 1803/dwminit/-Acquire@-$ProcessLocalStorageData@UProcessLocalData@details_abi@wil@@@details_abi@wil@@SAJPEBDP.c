/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x180006828
 * Callers:
 *     ?GetThreadLocalDataCache@details_abi@wil@@YAPEAUThreadLocalData@12@_N@Z @ 0x180006490 (-GetThreadLocalDataCache@details_abi@wil@@YAPEAUThreadLocalData@12@_N@Z.c)
 * Callees:
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x180001210 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
 *     ?GetLastErrorFailHr@details@wil@@YAJXZ @ 0x180005720 (-GetLastErrorFailHr@details@wil@@YAJXZ.c)
...
LABEL_12:
  ...
  {
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x61, v19, (const char *)(unsigned int)ValueInternal);
  }
  ...
  {
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x6A, v19, (const char *)(unsigned int)LastErrorFailHr);
  }
  if ( LastErrorFailHr >= 0 )
  {
    if ( v16 )
    ...
    {
      v22 = wil::details_abi::ProcessLocalStorageData<wil::details_abi::ProcessLocalData>::MakeAndInitialize(Name);
      LastErrorFailHr = v22;
      if ( v22 < 0 )
      {
        wil::details::in1diag3::Return_Hr(retaddr, (void *)0x129, v23, (const char *)(unsigned int)v22);
        goto LABEL_23;
      }
    }
    LastErrorFailHr = 0;
LABEL_23:
  ...
  wil::details::in1diag3::Return_Hr(retaddr, (void *)0x121, v19, (const char *)(unsigned int)LastErrorFailHr);
LABEL_24:
  if ( v15 && !ReleaseMutex(v15) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x883, v20, v21);
    JUMPOUT(0x180006A42LL);
  }
LABEL_3:
  if ( v7 && !CloseHandle(v7) )
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x879, v9, v10);
    __debugbreak();
  }
