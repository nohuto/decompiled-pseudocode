/*
 * XREFs of ?AddSidMappingToLsa@@YAJPEAU_UNICODE_STRING@@0PEAXPEAW4_LSA_SID_NAME_MAPPING_OPERATION_ERROR@@@Z @ 0x1800019DC
 * Callers:
        ...
        enum _LSA_SID_NAME_MAPPING_OPERATION_ERROR *a4)
{
  ...
  {
    v9 = v11 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(4u, &dword_180009D40, 2u, v11 | 0x10000000, 0x1DFu);
  }
  v12 = Buffer;
  if ( Buffer )
  {
