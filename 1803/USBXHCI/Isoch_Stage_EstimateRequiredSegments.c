/*
 * XREFs of Isoch_Stage_EstimateRequiredSegments @ 0x1C0028398
 * Callers:
...
__int64 __fastcall Isoch_Stage_EstimateRequiredSegments(__int64 a1, __int64 a2)
{
  ...
  v10 = v6 + 1;
  v11 = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)a2 + 48LL) + 2LL);
  if ( (v11 <= 0x38 || v11 > 0x3A) && *(_DWORD *)(*(_QWORD *)(a2 + 64) + 40LL) < *(_DWORD *)(a2 + 52) )
    v10 += 2;
  v12 = *(_DWORD *)(a1 + 196);
