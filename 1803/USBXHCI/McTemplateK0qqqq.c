/*
 * XREFs of McTemplateK0qqqq @ 0x1C003DF80
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqq(__int64 a1, __int64 a2, const GUID *a3, int a4, char a5, char a6, char a7)
{
  ...
  v15 = &a7;
  v16 = 4LL;
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_SENDING_TRUSTLET_REQUEST_V1, a3, 5u, &v8);
}
