/*
 * XREFs of McTemplateK0pjqq @ 0x1C000D120
 * Callers:
...
NTSTATUS McTemplateK0pjqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 4LL;
  v12 = 4LL;
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_CONTROLLER_QUERY_USB_CAPABILITY, 0LL, 5u, &v4);
}
