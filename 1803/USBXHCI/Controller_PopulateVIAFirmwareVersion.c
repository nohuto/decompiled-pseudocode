/*
 * XREFs of Controller_PopulateVIAFirmwareVersion @ 0x1C00551F8
 * Callers:
...
void __fastcall Controller_PopulateVIAFirmwareVersion(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 *a4)
{
  ...
  if ( *(_WORD *)(a3 + 2) == 13362 )
  {
    ...
    {
      WPP_RECORDER_SF_d(a1, 2u, 4u, 0xE9u, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids, v14);
    }
  }
  else if ( *(_WORD *)(a3 + 2) == 13443 || *(unsigned __int16 *)(a3 + 2) == 37377 )
  {
    ...
    if ( v9 == 4 )
    {
      WPP_RECORDER_SF_d(a1, 4u, 4u, 0xECu, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids, v17[0]);
      *a4 = v17[0];
    }
    else
    {
      WPP_RECORDER_SF_d(a1, 2u, 4u, 0xEBu, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids, v9);
    }
  }
}
