/*
 * XREFs of Crashdump_UsbDevice_SendAddressDeviceCommand @ 0x1C003BCD0
 * Callers:
...
__int64 __fastcall Crashdump_UsbDevice_SendAddressDeviceCommand(__int64 *a1)
{
  ...
  v3 = *(_QWORD *)(v2 + 472);
  *(_DWORD *)(v3 + 4) |= 3u;
  v4 = v3 + ((*(_DWORD *)(*(_QWORD *)a1[1] + 104LL) & 4) != 0 ? 128LL : 64LL);
  ...
  *(_BYTE *)(v5 + v3 + 38) = v7;
  v8 = a1[15];
  *(_DWORD *)(v4 + 4) ^= (*(_DWORD *)(v8 + 52) ^ *(_DWORD *)(v4 + 4)) & 0x38;
  *(_WORD *)(v4 + 6) = *(_WORD *)(v8 + 54);
  *(_DWORD *)(v4 + 4) ^= (*(_DWORD *)(v8 + 52) ^ *(_DWORD *)(v4 + 4)) & 6;
  if ( *(_BYTE *)(v8 + 128) )
    v9 = *(_QWORD *)(v8 + 136);
  else
  ...
  *(_QWORD *)(v4 + 8) = v9 | 1;
  v10 = a1[2];
  v16 = 0LL;
  HIDWORD(v16) = (*((unsigned __int8 *)a1 + 56) << 24) | 0x2C00;
  v15 = *(_QWORD *)(v2 + 464);
