/*
 * XREFs of WPP_RECORDER_SF_ddddxdLL @ 0x1C0018118
 * Callers:
...
__int64 WPP_RECORDER_SF_ddddxdLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      43LL,
      &WPP_e3ff60b53c4034148ad8b37c0aef3b5d_Traceguids,
      42LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 42;
  return WppAutoLogTrace(a1, 4LL, 9LL, &WPP_e3ff60b53c4034148ad8b37c0aef3b5d_Traceguids, v7, (__int64 *)va);
}
