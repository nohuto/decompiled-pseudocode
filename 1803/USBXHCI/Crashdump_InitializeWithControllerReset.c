/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x1C0037D08
 * Callers:
 ...
 *     Crashdump_Register_StartController @ 0x1C0039228 (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x1C0039390 (Crashdump_Register_UpdateDeviceSlotInfo.c)
 ...
 *     Crashdump_UsbDevice_GetPortType @ 0x1C003B68C (Crashdump_UsbDevice_GetPortType.c)
 *     Crashdump_UsbDevice_ReConfigureOnControllerReset @ 0x1C003B8E0 (Crashdump_UsbDevice_ReConfigureOnControllerReset.c)
 *     Crashdump_UsbDevice_ResetPort @ 0x1C003BB0C (Crashdump_UsbDevice_ResetPort.c)
 *     Crashdump_UsbDevice_SetPortPower @ 0x1C003C094 (Crashdump_UsbDevice_SetPortPower.c)
 */
