/*
 * XREFs of Controller_PopulateHardwareVerifierFlags @ 0x1C0054898
 * Callers:
...
__int64 __fastcall Controller_PopulateHardwareVerifierFlags(__int64 a1)
{
  ...
  *(_DWORD *)&DestinationString.Length = 3407872;
  ...
  v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, void *, __int64, _QWORD, __int64 *))(WdfFunctions_01023
                                                                                                  + 1832))(
         WdfDriverGlobals,
         0LL,
         &g_HwVerifierKeyName,
  ...
  else
  {
    if ( v6 != 2 )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2u, 4u, 0xCCu, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids);
      goto LABEL_51;
    }
...
LABEL_15:
    LODWORD(v15) = v5;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 72), 2u, 4u, v8, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids, v15);
    goto LABEL_51;
  }
  v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, struct _UNICODE_STRING *, __int64, _QWORD, __int64 *))(WdfFunctions_01023 + 1832))(
         WdfDriverGlobals,
         v18,
         &DestinationString,
         131097LL,
  ...
  if ( v5 >= 0 )
  {
    v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *, __int64, _QWORD, __int64 *))(WdfFunctions_01023 + 1832))(
           WdfDriverGlobals,
           v17,
           v4,
           131097LL,
    ...
    v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *, __int64, __int64 *, _QWORD, _QWORD))(WdfFunctions_01023 + 1880))(
           WdfDriverGlobals,
           v16,
...
LABEL_22:
  if ( v5 == -1073741772 )
  {
    ...
    else
    {
      if ( v10 != 2 )
      {
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2u, 4u, 0xCEu, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids);
        *(_QWORD *)(a1 + 376) = 0LL;
        goto LABEL_55;
      }
