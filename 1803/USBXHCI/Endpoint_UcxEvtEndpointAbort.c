/*
 * XREFs of Endpoint_UcxEvtEndpointAbort @ 0x1C0014CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Endpoint_UcxEvtEndpointAbort(__int64 a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)(v3 + 37) )
  {
    ...
    *(_DWORD *)(v6 + 16) = v7;
    ...
    for ( i = 1; i <= *(_DWORD *)(v6 + 8); ++i )
      result = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64 (__fastcall *)(), __int64))(WdfFunctions_01023 + 3344))(
                 WdfDriverGlobals,
  ...
  else
  {
    ...
    WPP_RECORDER_SF_ddq(
      ...
      *(_DWORD *)(v3 + 144),
      a2);
    return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64 (__fastcall *)(), __int64))(WdfFunctions_01023 + 3344))(
             WdfDriverGlobals,
