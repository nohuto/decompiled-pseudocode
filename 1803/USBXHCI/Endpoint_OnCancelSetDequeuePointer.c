/*
 * XREFs of Endpoint_OnCancelSetDequeuePointer @ 0x1C0012588
 * Callers:
 ...
 *     Endpoint_IsTransferRingEmpty @ 0x1C0012044 (Endpoint_IsTransferRingEmpty.c)
...
__int64 __fastcall Endpoint_OnCancelSetDequeuePointer(__int64 a1, unsigned int a2)
{
  ...
  *(_DWORD *)(v7 + 84) = 0;
  *(_QWORD *)(v7 + 88) = 0LL;
  WPP_RECORDER_SF_dddx(*(_QWORD *)(a1 + 80), v11, HIBYTE(*(_DWORD *)(v7 + 36)), v9);
