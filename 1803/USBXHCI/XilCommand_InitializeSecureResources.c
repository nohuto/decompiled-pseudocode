/*
 * XREFs of XilCommand_InitializeSecureResources @ 0x1C0005DA4
 * Callers:
...
__int64 __fastcall XilCommand_InitializeSecureResources(__int64 a1)
{
  ...
  if ( v4 >= 0 )
  {
    ...
    {
      LOBYTE(v5) = 2;
      WPP_RECORDER_SF_d(*(_QWORD *)(v2 + 72), v5, 7, 16, (__int64)&WPP_ea9f9fbd518637d468c1fcdb19474ea1_Traceguids, v7);
