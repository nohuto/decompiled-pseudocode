/*
 * XREFs of XilDeviceSlot_FreeSecureResources @ 0x1C000F40C
 * Callers:
...
void __fastcall XilDeviceSlot_FreeSecureResources(_QWORD *a1)
{
  __int64 v2; // rsi
  __int64 v3; // rdi
  int v4; // eax
  ...
  v7 = 0LL;
  v8[3] = *a1;
  v4 = SecureChannel_SendRequestSynchronously(v3, (unsigned int)v8, 40, (unsigned int)&v7, 8);
  if ( v4 >= 0 )
  {
    if ( (int)v7 < 0 )
    {
