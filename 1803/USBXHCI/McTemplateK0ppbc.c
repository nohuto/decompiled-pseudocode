/*
 * XREFs of McTemplateK0ppbc @ 0x1C003696C
 * Callers:
...
NTSTATUS McTemplateK0ppbc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 16LL;
  v12 = 1LL;
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_COMMAND_WAITLISTED, 0LL, 5u, &v4);
}
