/*
 * XREFs of Wmi_CreateControllerCapabilities @ 0x1C0036F04
 * Callers:
...
void __fastcall Wmi_CreateControllerCapabilities(__int64 *a1)
{
  ...
  if ( !a1[2] )
  {
    ...
    *((_DWORD *)a1 + 2) = ExtendedCapabilityTotalSize + 184;
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(*a1 + 72), 2u, 0xFu, 0xBu, (__int64)&WPP_b4c507127e483090dbbd6266bf29dfd9_Traceguids);
      *((_DWORD *)a1 + 2) = 0;
    }
  }
}
