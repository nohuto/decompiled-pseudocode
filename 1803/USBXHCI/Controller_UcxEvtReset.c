/*
 * XREFs of Controller_UcxEvtReset @ 0x1C000AFD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_UcxEvtReset(__int64 a1)
{
  ...
  if ( Controller_IsControllerAccessible(v2) )
    ...
    WPP_RECORDER_SF_(*(_QWORD *)(v2 + 72), 2u, 4u, 0xB2u, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids);
  v7 = 1;
  v6 = 12LL;
  return ((__int64 (__fastcall *)(_QWORD, __int64, __int64 *))qword_1C004C858)(
