/*
 * XREFs of McTemplateK0pppnnn @ 0x1C0036AAC
 * Callers:
 *     Etw_EndpointCreate @ 0x1C003645C (Etw_EndpointCreate.c)
 *     Etw_EndpointDelete @ 0x1C00364B8 (Etw_EndpointDelete.c)
...
NTSTATUS McTemplateK0pppnnn(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, __int64 a4, char a5, ...)
{
  ...
  v16 = 6LL;
  v18 = 8LL;
  return McGenEventWriteKM(a1, a2, a3, 7u, &v6);
}
