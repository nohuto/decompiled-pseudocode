/*
 * XREFs of Endpoint_SM_UpdateTransferRingDequeuePointers @ 0x1C0013C98
 * Callers:
 *     ESM_UpdatingTransferRingDequeuePointers @ 0x1C003D9A0 (ESM_UpdatingTransferRingDequeuePointers.c)
 * Callees:
