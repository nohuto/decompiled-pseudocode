/*
 * XREFs of Controller_WdfEvtDeviceArmWakeFromS0 @ 0x1C000B9D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceArmWakeFromS0(__int64 a1)
{
  ...
  if ( *(_BYTE *)(v3 + 441) && KeGetCurrentIrql() )
    Debug_FreAssertMsg(
      ...
      2551LL);
  v4 = *(_QWORD *)(v3 + 152);
  WPP_RECORDER_SF_q(*(_QWORD *)(v3 + 72), 4u, 4u, 0x55u, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids, a1);
  *(_BYTE *)(v3 + 396) = 1;
  if ( *(_DWORD *)(v4 + 16) )
  {
    do
    {
      ...
      DynamicLock_Acquire(*(_QWORD *)(*(_QWORD *)(v4 + 48) + v5 + 16));
      ...
      DynamicLock_Release(*(_QWORD *)(*(_QWORD *)(v4 + 48) + v5 + 16));
      ++v2;
    }
