/*
 * XREFs of Controller_TelemetryAddControllerData @ 0x1C00560E0
 * Callers:
 ...
 *     XilDeviceSlot_GetNumberOfDeviceSlots @ 0x1C000F51C (XilDeviceSlot_GetNumberOfDeviceSlots.c)
...
char __fastcall Controller_TelemetryAddControllerData(_QWORD *a1, __int64 *a2)
{
  ...
  if ( !a1
    || (LODWORD(UsbDeviceHandleArray) = TelemetryData_InsertTriageDataBlock(a2, a1, 0x2D0u),
