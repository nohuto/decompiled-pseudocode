/*
 * XREFs of TR_Create @ 0x1C005BBAC
 * Callers:
 ...
 * Callees:
 *     XilUsbDevice_IsSecureUsbDevice @ 0x1C0002544 (XilUsbDevice_IsSecureUsbDevice.c)
 *     _guard_dispatch_icall_nop @ 0x1C00029C0 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C0002D40 (memset.c)
 *     Controller_IsSecureDevice @ 0x1C0008AAC (Controller_IsSecureDevice.c)
 *     Endpoint_IsProxyEndpoint @ 0x1C0012034 (Endpoint_IsProxyEndpoint.c)
...
LABEL_11:
    ...
    if ( v21 )
      v23 = 2;
    LODWORD(v42[3]) = v23;
    v24 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD *, _QWORD *, __int64 *))(WdfFunctions_01023
                                                                                                 + 1216))(
            WdfDriverGlobals,
            v22,
            v45,
...
LABEL_17:
    ...
    *(_QWORD *)(v29 + 224) = v29 + 224;
    if ( *(_BYTE *)(v29 + 280) )
    {
      ...
      LODWORD(v42[0]) = 56;
      v42[3] = 0x100000001LL;
      SecureObject = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD *, _QWORD *, __int64))(WdfFunctions_01023
                                                                                                 + 3032))(
                       WdfDriverGlobals,
                       v43,
                       v42,
...
LABEL_28:
    ...
    v34 = v15[22];
    if ( v34
      && (SecureObject = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64 (__fastcall *)(), __int64))(WdfFunctions_01023 + 1328))(
                           WdfDriverGlobals,
                           v46,
                           v34,
                           v29),
