/*
 * XREFs of Bulk_ProcessTransferEventWithED0 @ 0x1C002CD8C
 * Callers:
 ...
 *     Bulk_Stage_CalculateBytesTransferred @ 0x1C002DD38 (Bulk_Stage_CalculateBytesTransferred.c)
...
char __fastcall Bulk_ProcessTransferEventWithED0(__int64 a1, __int64 a2, char a3)
{
  ...
  v6 = 0;
  LODWORD(v24) = HIBYTE(*(_DWORD *)(a1 + 8));
