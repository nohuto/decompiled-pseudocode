/*
 * XREFs of Crashdump_UsbDevice_SendResetDeviceCommand @ 0x1C003BFB8
 * Callers:
 *     Crashdump_UsbDevice_ReConfigureOnPortReset @ 0x1C003BA20 (Crashdump_UsbDevice_ReConfigureOnPortReset.c)
 * Callees:
