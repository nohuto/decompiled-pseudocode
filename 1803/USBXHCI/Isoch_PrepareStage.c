/*
 * XREFs of Isoch_PrepareStage @ 0x1C0026610
 * Callers:
 *     Isoch_MappingLoop @ 0x1C00264C4 (Isoch_MappingLoop.c)
 * Callees:
 *     StageQueue_Release @ 0x1C001F820 (StageQueue_Release.c)
 *     TR_AcquireSegments @ 0x1C001FC78 (TR_AcquireSegments.c)
 *     TR_EnsureInputBufferForTrbs @ 0x1C0020700 (TR_EnsureInputBufferForTrbs.c)
 *     TR_ReleaseSegments @ 0x1C0021108 (TR_ReleaseSegments.c)
 *     Isoch_Stage_AcquireMdl @ 0x1C0027E70 (Isoch_Stage_AcquireMdl.c)
...
__int64 __fastcall Isoch_PrepareStage(__int64 a1)
{
  ...
  *((_DWORD *)v1 + 10) = v4;
  ...
  if ( (v7 <= 0x38 || v7 > 0x3A) && (int)Isoch_Stage_AcquireMdl(v1, 0x800000000000000LL, v5, v9) < 0
