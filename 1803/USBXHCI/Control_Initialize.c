/*
 * XREFs of Control_Initialize @ 0x1C005C0E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Control_Initialize(__int64 a1)
{
  ...
  *(_BYTE *)(a1 + 320) = v2;
  ...
  LODWORD(v13[0]) = 56;
  v13[3] = 0x100000001LL;
  v3 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD *, _QWORD *, __int64))(WdfFunctions_01023 + 2544))(
         WdfDriverGlobals,
         v14,
         v13,
         a1 + 336);
...
LABEL_9:
  ...
  LODWORD(v13[0]) = 56;
  v13[3] = 0x100000001LL;
  v4 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64 *, _QWORD *, __int64))(WdfFunctions_01023 + 888))(
         WdfDriverGlobals,
         &v10,
         v13,
         a1 + 328);
