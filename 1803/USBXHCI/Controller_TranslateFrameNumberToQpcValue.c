/*
 * XREFs of Controller_TranslateFrameNumberToQpcValue @ 0x1C000A56C
 * Callers:
 ...
 *     Controller_GetQpcValueForFrameMicroFrameBoundary @ 0x1C0008004 (Controller_GetQpcValueForFrameMicroFrameBoundary.c)
