/*
 * XREFs of Wmi_Create @ 0x1C005C7E8
 * Callers:
...
__int64 __fastcall Wmi_Create(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  *(GUID *)&v12[1] = GUID_USBXHCI_GET_CONTROLLER_CAPABILITIES;
  ...
  BYTE1(v11[3]) = 1;
  v6 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD *, _QWORD *, __int64 *))(WdfFunctions_01023 + 2984))(
         WdfDriverGlobals,
         a1,
         v11,
         v10,
  ...
  if ( v6 < 0 )
    WPP_RECORDER_SF_d(
      *(_QWORD *)(a2 + 72),
      ...
      0xFu,
      0xAu,
      (__int64)&WPP_b4c507127e483090dbbd6266bf29dfd9_Traceguids,
      v6);
