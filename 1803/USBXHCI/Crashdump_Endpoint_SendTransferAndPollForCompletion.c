/*
 * XREFs of Crashdump_Endpoint_SendTransferAndPollForCompletion @ 0x1C003A8E4
 * Callers:
 *     Crashdump_Endpoint_SendBulkTransfer @ 0x1C003A408 (Crashdump_Endpoint_SendBulkTransfer.c)
