/*
 * XREFs of Bulk_CompleteTransfers @ 0x1C002B38C
 * Callers:
  ...
  *(_BYTE *)(a1 + 104) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 96));
  while ( 1 )
  {
    ...
    *((_BYTE *)v6 + 134) = *((_BYTE *)v6 + 130);
    ...
    {
      v12 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64 **))(WdfFunctions_01023 + 2048))(
              WdfDriverGlobals,
              v6[3]);
      if ( v12 >= 0 )
      {
  ...
  while ( 1 )
  {
    ...
    *((_DWORD *)v24 + 28) = *((_DWORD *)v24 + 27);
    ...
    v32 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64 **))(WdfFunctions_01023 + 2264))(
            WdfDriverGlobals,
            v24[3]);
    v33 = *(_QWORD *)(a1 + 48);
