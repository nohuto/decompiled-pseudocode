/*
 * XREFs of Interrupter_PrepareInterrupter @ 0x1C0059BF0
 * Callers:
 ...
 *     Interrupter_DetermineSegmentSizeAndCount @ 0x1C0059014 (Interrupter_DetermineSegmentSizeAndCount.c)
 */
...
__int64 __fastcall Interrupter_PrepareInterrupter(__int64 a1, unsigned __int8 a2)
{
  ...
  *(_QWORD *)(a1 + 152) = v11;
  if ( !v11 )
  {
    ...
    v13 = 27;
LABEL_15:
    WPP_RECORDER_SF_(v12, 2u, 9u, v13, (__int64)&WPP_e3ff60b53c4034148ad8b37c0aef3b5d_Traceguids);
    result = 3221225626LL;
    if ( v6 )
    {
      v22 = *(_DWORD **)(a1 + 152);
      ...
      while ( 1 )
      {
        ...
        if ( *(char **)v2 == v2 )
          break;
        if ( *((char **)v23 + 1) != v2 || (v24 = *(_QWORD *)v23, *(char **)(*(_QWORD *)v23 + 8LL) != v23) )
          __fastfail(3u);
        *(_QWORD *)v2 = v24;
        *(_QWORD *)(v24 + 8) = v2;
...
LABEL_12:
  ...
  *(_DWORD *)(v18 + v17 + 40) = 0;
  ...
  {
    v26 = (struct _DEVICE_OBJECT *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, __int64, __int64))(WdfFunctions_01023 + 248))(
                                     WdfDriverGlobals,
                                     **(_QWORD **)(a1 + 8),
                                     v19,
                                     v21);
