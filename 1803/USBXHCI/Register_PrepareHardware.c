/*
 * XREFs of Register_PrepareHardware @ 0x1C005ABEC
 * Callers:
...
__int64 __fastcall Register_PrepareHardware(__int64 a1, __int64 a2)
{
  ...
  for ( i = 0;
        ...
        ++i )
  {
    v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01023 + 2440))(
           WdfDriverGlobals,
           a2,
           i);
    if ( *(_BYTE *)v5 == 3 )
  ...
  {
    v8 = -1073741670;
    WPP_RECORDER_SF_(*(_QWORD *)(v9 + 72), 2u, 6u, 0x10u, (__int64)&WPP_aa9a6dc92bdc315c6241291f5ec849eb_Traceguids);
    goto LABEL_23;
  }
