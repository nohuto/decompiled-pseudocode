/*
 * XREFs of XilCoreCommonBuffer_AllocateBuffers @ 0x1C003ED48
 * Callers:
 ...
 *     XilCoreCommonBuffer_PreAllocateBuffers @ 0x1C003F2AC (XilCoreCommonBuffer_PreAllocateBuffers.c)
 * Callees:
...
void __fastcall XilCoreCommonBuffer_AllocateBuffers(__int64 **a1, __int64 a2, int a3)
{
  ...
  if ( v7 )
  {
    ...
    for ( i = v10; ; v10 = i )
    {
      v11 = **a1;
      v12 = *((_BYTE *)*a1 + 80)
          ? SecureDmaEnabler_AllocateCommonBufferPage(*(_QWORD *)(v11 + 104), v10, &v31, &v32)
          : DmaEnabler_AllocateCommonBufferPage(*(__int64 **)(v11 + 96), v10, &v31, &v32);
      if ( v12 < 0 )
        break;
      v13 = v31;
      if ( (v31[1] & 0xFFF) != 0 )
      {
        ...
        if ( *((_BYTE *)*a1 + 80) )
          ...
          (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01023 + 1664))(WdfDriverGlobals, v13[2]);
      }
      else
      {
        v15 = a1 + 2;
