/*
 * XREFs of Controller_D0EntryRestoreState @ 0x1C0007284
 * Callers:
...
__int64 __fastcall Controller_D0EntryRestoreState(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 441) && KeGetCurrentIrql() )
    Debug_FreAssertMsg(
      ...
      3430LL);
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4u, 4u, 0x68u, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids);
  ...
  if ( (Ulong & 1) == 0 )
  {
    v8 = 105;
LABEL_8:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2u, 4u, v8, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids);
    goto LABEL_21;
  }
  if ( (Ulong & 0x100) != 0 )
  {
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4u, 4u, 0x6Cu, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids);
  ...
  while ( 1 )
  {
    ...
    if ( (v14 & 0x200) == 0 )
    {
      ...
      LOBYTE(v19) = 4;
      WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v19, v20, 110, v26, (v18 - UnbiasedInterruptTime) / 0xA);
      v21 = 0;
      goto LABEL_22;
    }
    if ( !v11 )
    {
      ...
      LOBYTE(v16) = 2;
      WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v16, v17, 111, v26, (v15 - UnbiasedInterruptTime) / 0x2710);
      goto LABEL_21;
    }
  ...
  LOBYTE(v23) = 2;
  WPP_RECORDER_SF_I(*(_QWORD *)(a1 + 72), v23, v24, 109, v26, (v22 - UnbiasedInterruptTime) / 0x2710);
