/*
 * XREFs of ESM_AddEvent @ 0x1C003C210
 * Callers:
 *     DeviceSlot_ControllerResetPreReset @ 0x1C000EED0 (DeviceSlot_ControllerResetPreReset.c)
 *     Endpoint_ClearStallTransferCompletion @ 0x1C0010BD0 (Endpoint_ClearStallTransferCompletion.c)
 ...
 *     Control_EP_ProcessExpectedEventTRBs @ 0x1C0021950 (Control_EP_ProcessExpectedEventTRBs.c)
 *     Control_EP_StopMapping @ 0x1C0021B40 (Control_EP_StopMapping.c)
 ...
 *     Isoch_EP_ProcessExpectedEventTRBs @ 0x1C0025AB0 (Isoch_EP_ProcessExpectedEventTRBs.c)
 ...
 *     Bulk_EP_ProcessExpectedEventTRBs @ 0x1C002BBE0 (Bulk_EP_ProcessExpectedEventTRBs.c)
...
LABEL_7:
  ...
  else
  {
    ...
    *((_BYTE *)Context + 949) = (*((_BYTE *)Context + 949) + 1) & 0xF;
    ...
    {
      v5 = WdfFunctions_01023;
      v6 = Context[120];
      *((_BYTE *)Context + 848) = 1;
      v7 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, KSPIN_LOCK))(v5 + 1632))(WdfDriverGlobals, v6);
      (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, const char *, __int64, const char *))(WdfFunctions_01023
                                                                                                + 1640))(
        WdfDriverGlobals,
        v7,
        "State Machine Tag",
