/*
 * XREFs of McTemplateK0pqqh @ 0x1C000D3D8
 * Callers:
...
NTSTATUS McTemplateK0pqqh(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  va_copy(v11, va3);
  v12 = 2LL;
  return McGenEventWriteKM(a1, a2, 0LL, 5u, &v4);
}
