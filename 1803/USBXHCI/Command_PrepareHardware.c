/*
 * XREFs of Command_PrepareHardware @ 0x1C00522A0
 * Callers:
 ...
 *     XilCommand_GetLinkTrbPointer @ 0x1C0005D64 (XilCommand_GetLinkTrbPointer.c)
 *     XilCommand_GetMaxTrbIndex @ 0x1C0005D84 (XilCommand_GetMaxTrbIndex.c)
