/*
 * XREFs of WPP_RECORDER_SF_DDqDDD @ 0x1C002AA6C
 * Callers:
 *     Isoch_Stage_EstimateRequiredSegments @ 0x1C0028398 (Isoch_Stage_EstimateRequiredSegments.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_DDqDDD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x2000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      0LL);
  LOWORD(v7) = 46;
  return WppAutoLogTrace(a1, 5LL, 14LL, &WPP_f9020e9f93d73638c8a5c21896bb3fa5_Traceguids, v7, (__int64 *)va);
}
