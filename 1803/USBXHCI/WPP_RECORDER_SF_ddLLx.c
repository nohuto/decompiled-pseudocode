/*
 * XREFs of WPP_RECORDER_SF_ddLLx @ 0x1C0015F54
 * Callers:
...
__int64 WPP_RECORDER_SF_ddLLx(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      43LL,
      &WPP_d84a1c460e69300738f36914e2bb57da_Traceguids,
      76LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 76;
  return WppAutoLogTrace(a1, 4LL, 13LL, &WPP_d84a1c460e69300738f36914e2bb57da_Traceguids, v7, (__int64 *)va);
}
