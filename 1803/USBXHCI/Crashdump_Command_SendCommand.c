/*
 * XREFs of Crashdump_Command_SendCommand @ 0x1C0039DD8
 * Callers:
 *     Crashdump_Command_TestCommandRingOperation @ 0x1C003A110 (Crashdump_Command_TestCommandRingOperation.c)
 *     Crashdump_Endpoint_SetDequeuePointer @ 0x1C003AA0C (Crashdump_Endpoint_SetDequeuePointer.c)
 *     Crashdump_Endpoint_StopEndpoint @ 0x1C003AAD4 (Crashdump_Endpoint_StopEndpoint.c)
 ...
 *     Crashdump_UsbDevice_SendEnableSlotCommand @ 0x1C003BF14 (Crashdump_UsbDevice_SendEnableSlotCommand.c)
 *     Crashdump_UsbDevice_SendResetDeviceCommand @ 0x1C003BFB8 (Crashdump_UsbDevice_SendResetDeviceCommand.c)
 * Callees:
