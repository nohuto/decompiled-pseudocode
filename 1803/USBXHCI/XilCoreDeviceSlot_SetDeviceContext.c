/*
 * XREFs of XilCoreDeviceSlot_SetDeviceContext @ 0x1C003F978
 * Callers:
 ...
 *     XilCoreUsbDevice_GetDeviceContextBufferSize @ 0x1C003FC40 (XilCoreUsbDevice_GetDeviceContextBufferSize.c)
        ...
        __int64 DeviceContextBufferLA)
{
  ...
  else
  {
    ...
    *(_QWORD *)(v15 + 8 * v5) = DeviceContextBufferLA;
    WPP_RECORDER_SF_qdx(*(_QWORD *)(a1[1] + 72LL), 0LL, v17, v18, v20);
  }
  return v9;
}
