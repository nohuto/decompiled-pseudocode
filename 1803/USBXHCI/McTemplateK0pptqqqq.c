/*
 * XREFs of McTemplateK0pptqqqq @ 0x1C000D2A0
 * Callers:
...
NTSTATUS McTemplateK0pptqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_STOP_TRACKING_FOR_TIME_SYNC, 0LL, 8u, &v4);
}
