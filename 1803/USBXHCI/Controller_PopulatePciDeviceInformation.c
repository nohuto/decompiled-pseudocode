/*
 * XREFs of Controller_PopulatePciDeviceInformation @ 0x1C0054FA4
 * Callers:
        ...
        __int64 a8)
{
  ...
  v11 = a3;
  v16 = a3;
  WPP_RECORDER_SF_ddL(a1, 4u, 4u, 0x80u, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids, a2, v16, v18);
  LODWORD(v19) = *((unsigned __int8 *)a6 + 8);
  LODWORD(v17) = a6[1];
  LODWORD(v15) = *a6;
  WPP_RECORDER_SF_ddL(a1, 4u, 4u, 0x81u, (__int64)&WPP_7140d4b18c8734a335f2373eb7eb1be4_Traceguids, v15, v17, v19);
  v12 = *a6;
  if ( *a6 == 4358 )
  {
