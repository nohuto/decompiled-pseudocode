/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x1C0037F24
 * Callers:
 *     Crashdump_Initialize @ 0x1C00377F0 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_EventRing_PrepareForHibernate @ 0x1C0039B58 (Crashdump_EventRing_PrepareForHibernate.c)
...
__int64 __fastcall Crashdump_InitializeWithoutControllerReset(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, *(PVOID *)Address, 0x88uLL, 0x43434858u);
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 77), 0x2D0uLL, 0x43434858u);
