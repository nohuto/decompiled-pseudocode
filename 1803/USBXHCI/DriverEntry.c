/*
 * XREFs of DriverEntry @ 0x1C00577D0
 * Callers:
 ...
 *     McGenEventRegister @ 0x1C000FE70 (McGenEventRegister.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)(WPP_MAIN_CB.DeviceQueue.Lock + 24) = 0;
  ...
  dword_1C004C218 = WPP_MAIN_CB.Queue.Wcb.WaitQueueEntry.SortKey;
  qword_1C004C21C = (__int64)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine;
  dword_1C004C224 = *((_DWORD *)&WPP_MAIN_CB.Queue.Wcb.1 + 5);
  dword_1C004C228 = (int)WPP_MAIN_CB.Queue.Wcb.DeviceContext;
  qword_1C004C240 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01023 + 3448))(WdfDriverGlobals);
