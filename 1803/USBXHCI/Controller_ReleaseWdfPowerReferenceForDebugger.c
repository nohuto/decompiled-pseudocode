/*
 * XREFs of Controller_ReleaseWdfPowerReferenceForDebugger @ 0x1C00093D0
 * Callers:
...
__int64 __fastcall Controller_ReleaseWdfPowerReferenceForDebugger(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 440) )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, void (__fastcall *)(_QWORD *), __int64, const char *))(WdfFunctions_01023 + 3512))(
      WdfDriverGlobals,
      *(_QWORD *)a1,
    ...
    *(_BYTE *)(a1 + 440) = 0;
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc & 8) != 0 )
      return McTemplateK0pt(v3, v2, v4, a1, 0);
  }
  return result;
}
