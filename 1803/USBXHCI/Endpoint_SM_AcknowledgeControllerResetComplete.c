/*
 * XREFs of Endpoint_SM_AcknowledgeControllerResetComplete @ 0x1C0013650
 * Callers:
 *     ESM_AcknowledgingControllerResetCompleteInDisabled @ 0x1C003CFA0 (ESM_AcknowledgingControllerResetCompleteInDisabled.c)
 * Callees:
 *     <none>
 */
