/*
 * XREFs of WerKernelCreateReport @ 0x1C0040150
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C005DB50 (TelemetryData_SubmitReport.c)
 * Callees:
 *     CheckSpaceAvailable @ 0x1C003FF6C (CheckSpaceAvailable.c)
 *     WerpCreateRegistryKey @ 0x1C0040BF8 (WerpCreateRegistryKey.c)
 */
