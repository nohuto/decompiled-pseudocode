/*
 * XREFs of UsbDevice_UcxEvtDeviceAdd @ 0x1C005C510
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Etw_DeviceCreate @ 0x1C00361D8 (Etw_DeviceCreate.c)
 */
...
__int64 __fastcall UsbDevice_UcxEvtDeviceAdd(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  LODWORD(v17[0]) = 104;
  ((void (__fastcall *)(_QWORD, __int64, _QWORD *))qword_1C004C880)(*(_QWORD *)&WPP_MAIN_CB.DeviceQueue.32, v15, v17);
  memset(v16, 0, 0x38uLL);
  LODWORD(v16[0]) = 56;
  v16[3] = 0x100000001LL;
  v16[6] = off_1C004B2F0;
  v16[1] = UsbDevice_EvtUsbDeviceCleanupCallback;
  v6 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64 *, _QWORD *, __int64 *))qword_1C004C878)(
