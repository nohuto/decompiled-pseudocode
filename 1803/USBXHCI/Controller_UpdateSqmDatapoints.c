/*
 * XREFs of Controller_UpdateSqmDatapoints @ 0x1C00568CC
 * Callers:
...
LABEL_11:
  ...
  v4 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, struct _UNICODE_STRING *, int *))(WdfFunctions_01023
                                                                                                + 1920))(
         WdfDriverGlobals,
         v12,
         &DestinationString,
  ...
  if ( v4 >= 0 )
    v5 += v11;
  v11 = v5;
  v6 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, struct _UNICODE_STRING *))(WdfFunctions_01023 + 1968))(
         WdfDriverGlobals,
         v12,
         &DestinationString);
  if ( v6 < 0 )
  ...
  v7 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, struct _UNICODE_STRING *, int *))(WdfFunctions_01023
                                                                                                + 1920))(
         WdfDriverGlobals,
         v12,
         &DestinationString,
