/*
 * XREFs of McTemplateK0ptqqp @ 0x1C000D57C
 * Callers:
...
NTSTATUS McTemplateK0ptqqp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 8LL;
  return McGenEventWriteKM(a1, &USBXHCI_ETW_EVENT_START_TRACKING_FOR_TIME_SYNC, 0LL, 6u, &v4);
}
