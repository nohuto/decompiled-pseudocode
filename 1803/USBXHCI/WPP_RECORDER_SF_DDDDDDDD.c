/*
 * XREFs of WPP_RECORDER_SF_DDDDDDDD @ 0x1C001F320
 * Callers:
...
__int64 WPP_RECORDER_SF_DDDDDDDD(__int64 a1, _DWORD a2, _DWORD a3, unsigned __int16 a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x400) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.Dpc.DeferredContext)(
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 2LL, 11LL, &WPP_62692f86e29e3be0ae2694370e9ff5b6_Traceguids, v8, (__int64 *)va);
}
