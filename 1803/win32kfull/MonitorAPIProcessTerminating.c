/*
 * XREFs of MonitorAPIProcessTerminating @ 0x1C00F02F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextElementIndex@?$CList@VCPhysicalMonitorHandle@@@@QEAAEKPEAK@Z @ 0x1C023E8AC (-GetNextElementIndex@-$CList@VCPhysicalMonitorHandle@@@@QEAAEKPEAK@Z.c)
 */
...
void __fastcall MonitorAPIProcessTerminating(void *a1)
{
  ...
  v1 = (char *)qword_1C03270B8;
  CAutoMutex::CAutoMutex((CAutoMutex *)&v7, (struct CMutex *)((char *)qword_1C03270B8 + 32));
  if ( *((_DWORD *)v1 + 4) )
  {
    if ( !**((_QWORD **)v1 + 1) )
    {
