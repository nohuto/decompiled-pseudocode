/*
 * XREFs of ?SpAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x1C00B24B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _BLENDOBJ *pBlendObj)
{
  ...
  __int64 v25; // rdx
  __int64 v26; // rdx
  struct _SURFOBJ *v27; // [rsp+50h] [rbp-B0h] BYREF
  ...
  __int64 *v34[114]; // [rsp+90h] [rbp-70h] BYREF
  ...
  {
    ENUMUNDERLAYS::ENUMUNDERLAYS((ENUMUNDERLAYS *)v34, a1, a3, prclDest);
    while ( 1 )
    {
      if ( !(unsigned int)ENUMUNDERLAYS::bEnum(v34, &v27, &v30, &v29) )
        return v8;
      v10 = v27;
      v11 = 0LL;
      v28 = 0LL;
...
LABEL_15:
    ...
    if ( v10->iType == 1 )
    {
      if ( (unsigned int)bAllowShareAccess(v10) )
      {
        if ( W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v16)
          ...
          && (*(_DWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v20) + 280) + 20LL) & 0x10000) != 0 )
        {
      ...
      {
        v23 = W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v17);
        if ( v23
    ...
    {
      v14 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, RECTL *, BLENDOBJ *))*((_QWORD *)v10->hdev + 169);
LABEL_14:
      v8 &= OffAlphaBlend(
              (int)v14,
              (int)&v30,
