/*
 * XREFs of InitializeClientPfnArrays @ 0x1C010E26C
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C010E180 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( PsGetCurrentProcess(a1, a2) == gpepCSRSS )
  {
    ...
    *(_QWORD *)(gpsi + 856LL) = *(_QWORD *)(a3 + 80);
    gpfnwp = *(_QWORD *)(gpsi + 640LL);
    qword_1C0325F48 = *(_QWORD *)(gpsi + 616LL);
    qword_1C0325F50 = *(_QWORD *)(gpsi + 696LL);
    qword_1C0325F58 = *(_QWORD *)(gpsi + 680LL);
    qword_1C0325F68 = *(_QWORD *)(gpsi + 648LL);
    qword_1C0325FD0 = *(_QWORD *)(gpsi + 664LL);
    qword_1C0325FE8 = *(_QWORD *)(gpsi + 592LL);
    qword_1C0325F70 = *(_QWORD *)(gpsi + 688LL);
    qword_1C0325F78 = *(_QWORD *)(gpsi + 656LL);
    qword_1C0325FC8 = 1LL;
    qword_1C0325FD8 = 3LL;
    qword_1C0325FE0 = 2LL;
    qword_1C0325FF0 = 5LL;
