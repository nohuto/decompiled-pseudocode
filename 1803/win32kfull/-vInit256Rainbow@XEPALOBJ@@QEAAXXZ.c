/*
 * XREFs of ?vInit256Rainbow@XEPALOBJ@@QEAAXXZ @ 0x1C0017B88
 * Callers:
 ...
 * Callees:
 *     ?vInit256Default@XEPALOBJ@@QEAAXXZ @ 0x1C0017B2C (-vInit256Default@XEPALOBJ@@QEAAXXZ.c)
...
void __fastcall XEPALOBJ::vInit256Rainbow(XEPALOBJ *this)
{
  ...
  if ( gpRGBXlate )
    goto LABEL_5;
  v8 = (unsigned __int8 *)PALLOCMEM2(0x8000uLL);
  v9 = *(_QWORD *)this;
  if ( v8 )
  {
