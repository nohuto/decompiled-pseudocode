/*
 * XREFs of ?vGetInfo@RFONTOBJ@@QEBAXPEAU_FONTINFO@@@Z @ 0x1C02784FC
 * Callers:
...
void __fastcall RFONTOBJ::vGetInfo(RFONTOBJ *this, struct _FONTINFO *a2)
{
  ...
  *(_QWORD *)&a2->cjMaxGlyph4 = 0LL;
  ...
  {
    case 1:
      a2->cjMaxGlyph1 = *(_DWORD *)(v2 + 624);
      break;
    case 4:
      a2->cjMaxGlyph4 = *(_DWORD *)(v2 + 624);
      break;
    case 8:
      a2->cjMaxGlyph8 = *(_DWORD *)(v2 + 624);
      break;
    case 0x20:
      a2->cjMaxGlyph32 = *(_DWORD *)(v2 + 624);
      break;
  }
  if ( *(_DWORD *)(v2 + 76) )
    a2->flCaps |= 1u;
  if ( (*(_DWORD *)(v2 + 460) & 0x8000) != 0 )
    a2->flCaps |= 2u;
}
