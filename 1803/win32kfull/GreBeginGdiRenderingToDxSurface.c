/*
 * XREFs of GreBeginGdiRenderingToDxSurface @ 0x1C00A5DBC
 * Callers:
 *     NtGdiBeginGdiRendering @ 0x1C00A2910 (NtGdiBeginGdiRendering.c)
 * Callees:
 *     ?bReset@DC@@QEAAHXZ @ 0x1C008ACD4 (-bReset@DC@@QEAAHXZ.c)
