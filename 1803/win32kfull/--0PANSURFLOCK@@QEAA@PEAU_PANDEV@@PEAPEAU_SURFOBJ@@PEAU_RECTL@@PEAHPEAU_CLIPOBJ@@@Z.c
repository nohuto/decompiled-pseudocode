/*
 * XREFs of ??0PANSURFLOCK@@QEAA@PEAU_PANDEV@@PEAPEAU_SURFOBJ@@PEAU_RECTL@@PEAHPEAU_CLIPOBJ@@@Z @ 0x1C0264ED0
 * Callers:
 ...
 * Callees:
 *     ?vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ @ 0x1C0267070 (-vLockBmpAndPrepareForPunt@PANSURFLOCK@@QEAAXXZ.c)
