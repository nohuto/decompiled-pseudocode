/*
 * XREFs of ?_InertiaRegionIntersectsTopEdge@Edgy@@YAHPEBUINERTIA_INFO_INTERNAL@@PEBUtagRECT@@@Z @ 0x1C01BEB00
 * Callers:
 ...
 *     GetInertiaRegionInVirtualizedScreen @ 0x1C01FDB00 (GetInertiaRegionInVirtualizedScreen.c)
 */
