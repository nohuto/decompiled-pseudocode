/*
 * XREFs of ?UpdateWaveformInfoList@SimpleHapticsController@@IEAAJGG@Z @ 0x1C0215CE4
 * Callers:
...
LABEL_5:
    if ( (unsigned int)dword_1C031C790 > 4 )
    {
      ...
      v11 = 2LL;
      v13 = 2LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E412E, a3, v4, 5u, &pData);
    }
    return 3221226021LL;
  }
}
