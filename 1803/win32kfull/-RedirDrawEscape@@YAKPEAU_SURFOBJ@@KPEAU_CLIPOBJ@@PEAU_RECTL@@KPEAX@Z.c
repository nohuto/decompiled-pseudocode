/*
 * XREFs of ?RedirDrawEscape@@YAKPEAU_SURFOBJ@@KPEAU_CLIPOBJ@@PEAU_RECTL@@KPEAX@Z @ 0x1C026BD80
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a6)
{
  ...
  struct SURFACE *v18; // [rsp+48h] [rbp-80h] BYREF
        ...
        if ( (*(_DWORD *)(v10 + 40) & 0x20000) != 0 )
        {
          ...
          if ( v11 )
          {
            ...
            do
            {
              ...
              if ( v14 )
              {
                if ( (*(_DWORD *)(v14 + 1816) & 0x8000000) != 0 && (*(_DWORD *)(v14 + 2120) & 0x8000) != 0 )
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v14 + 1784) + 264LL) )
                  {
                    MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                      (MARK_ACCDRV_NOTIFICATION *)&v17,
                      (struct PDEVOBJ *)&HDEV,
                      a1);
                    (*(void (__fastcall **)(struct _SURFOBJ *, _QWORD, struct _CLIPOBJ *, struct _RECTL *, unsigned int, void *))(*(_QWORD *)(v15 + 1784) + 264LL))(
                      a1,
                      a2,
                      a3,
                      a4,
