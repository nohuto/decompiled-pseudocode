/*
 * XREFs of fsg_InitializeGlyphData @ 0x1C02BDBD0
 * Callers:
...
__int64 __fastcall fsg_InitializeGlyphData(__int64 a1, __int64 a2, __int16 a3, unsigned __int16 a4)
{
  ...
  *(_WORD *)(a1 + 60) = a3;
  *(_OWORD *)(a1 + 96) = xmmword_1C02EC820;
  *(_WORD *)a1 = 17479;
  *(_OWORD *)(a1 + 112) = xmmword_1C02EC830;
  ...
  *(_QWORD *)(a1 + 176) = v5;
  *(_WORD *)(v5 + 80) = 0;
  *(_OWORD *)(a1 + 184) = xmmword_1C02EC820;
  *(_DWORD *)(a1 + 220) = 1;
  *(_OWORD *)(a1 + 200) = xmmword_1C02EC830;
