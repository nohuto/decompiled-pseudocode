/*
 * XREFs of ?PanEnablePDEV@@YAPEAUDHPDEV__@@PEAU_devicemodeW@@PEAGKPEAPEAUHSURF__@@KPEAKKPEAUtagDEVINFO@@PEAUHDEV__@@1PEAX@Z @ 0x1C02655D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bCreateSemaphores@@YAHPEAU_PANDEV@@@Z @ 0x1C0266AA4 (-bCreateSemaphores@@YAHPEAU_PANDEV@@@Z.c)
 *     ?vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z @ 0x1C0266E7C (-vDeleteSemaphores@@YAXPEAU_PANDEV@@@Z.c)
 */
...
LABEL_15:
  ...
  *((_DWORD *)v15 + 11) = *(_DWORD *)a8;
  ...
  {
    *((_QWORD *)v15 + 203) = v38;
    *((_QWORD *)a9 + 331) = PanCloseProcess;
  }
  v39 = *((_QWORD *)a9 + 330);
  if ( v39 )
  {
    *((_QWORD *)v15 + 204) = v39;
    *((_QWORD *)a9 + 330) = PanAddD3DDirtyRgn;
  }
  a6[4] = *((_DWORD *)v15 + 2);
  a6[5] = *((_DWORD *)v15 + 3);
