/*
 * XREFs of ?DT_InitDrawTextInfo@@YAHPEAUHDC__@@PEAUtagRECT@@IPEAUDRAWTEXTDATA@@PEAUtagDRAWTEXTPARAMS@@@Z @ 0x1C022C114
 * Callers:
  ...
  if ( (_DWORD)result )
  {
    ...
    *((_DWORD *)a4 + 4) = 8 * v15;
    if ( gptiCurrent == gptiRit )
      ...
      v20 = *(_DWORD *)(PsGetCurrentProcessWin32Process(gptiRit) + 752) & 4;
    *((_DWORD *)a4 + 15) = v20;
    if ( !v20 )
