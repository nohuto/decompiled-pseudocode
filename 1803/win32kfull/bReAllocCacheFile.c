/*
 * XREFs of bReAllocCacheFile @ 0x1C0259EF0
 * Callers:
...
__int64 __fastcall bReAllocCacheFile(unsigned int a1)
{
  ...
  v2 = 0;
  v3 = (int *)a1;
  if ( (*(_DWORD *)(qword_1C0326C58 + 16) & 4) != 0 )
    return 0LL;
  v5 = (unsigned __int16 *)(unsigned int)(*(_DWORD *)(qword_1C0326C58 + 32) - *(_DWORD *)(qword_1C0326C58 + 40));
  v6 = *(_DWORD *)(*(_QWORD *)qword_1C0326C58 + 24LL);
  v7 = (((_DWORD)v5 + (_DWORD)v3 + 7) & 0xFFFFFFF8) + 0x2000;
  v8 = *(_DWORD *)(qword_1C0326C58 + 24) - *(_QWORD *)qword_1C0326C58;
  v9 = v7 + v6;
  ...
  if ( (unsigned int)bMapFileRetainHandle(v5, (struct _FILEVIEW *)(v1 + 48), v9, v3) )
  {
    v12 = qword_1C0326C58;
    v2 = 1;
    v13 = *(_QWORD *)(qword_1C0326C58 + 56);
    *(_QWORD *)qword_1C0326C58 = v13;
    *(_DWORD *)(v13 + 24) = v9;
  ...
  {
    v17 = (unsigned int)bMapFileRetainHandle(v10, (struct _FILEVIEW *)(qword_1C0326C58 + 48), v6, v11);
    v18 = qword_1C0326C58;
    if ( v17 )
    {
      v19 = *(_QWORD *)(qword_1C0326C58 + 56);
      *(_DWORD *)(qword_1C0326C58 + 16) |= 6u;
      *(_QWORD *)v18 = v19;
      *(_DWORD *)(v18 + 20) = 1;
    }
    else
    {
      *(_DWORD *)(qword_1C0326C58 + 16) |= 1u;
    }
  }
  return v2;
}
