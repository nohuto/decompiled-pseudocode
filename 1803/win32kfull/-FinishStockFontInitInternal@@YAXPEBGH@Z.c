/*
 * XREFs of ?FinishStockFontInitInternal@@YAXPEBGH@Z @ 0x1C00558B0
 * Callers:
 ...
 *     bDeleteFont @ 0x1C0055D00 (bDeleteFont.c)
...
void __fastcall FinishStockFontInitInternal(const unsigned __int16 *a1, int a2)
{
  ...
  do
  {
    ...
    while ( 1 )
    {
      ...
      *v17 = 0;
      if ( v8 < 0 || (int)StringCchCatW(v11, v16, v6) < 0 )
        goto LABEL_35;
      LOBYTE(v19) = 10;
      v20 = v13[*v10];
