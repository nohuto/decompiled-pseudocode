/*
 * XREFs of CalcWindowFullScreen @ 0x1C007290C
 * Callers:
 ...
 *     CalcWindowsFullScreen @ 0x1C0104460 (CalcWindowsFullScreen.c)
 * Callees:
...
__int64 __fastcall CalcWindowFullScreen(struct tagWND *a1)
{
  ...
  if ( v3 == v5 && (*(_BYTE *)(*((_QWORD *)a1 + 5) + 31LL) & 0x10) != 0 )
  {
