/*
 * XREFs of ?vFillGRectDIB4@@YAXPEAVSURFACE@@PEAU_GRADIENTRECTDATA@@@Z @ 0x1C02A1A50
 * Callers:
 *     <none>
 * Callees:
      ...
      do
      {
        ...
        if ( v23 < v49 )
        {
          ...
          do
          {
            ...
            v28 = *v24;
            v29 = v10[Xlate555[((unsigned __int64)DefaultSaturationTable[v27 + BYTE6(v22)] >> 3) | (4
                                                                                                  * (DefaultSaturationTable[v27 + BYTE6(v20)] & 0xF8 | (32 * (DefaultSaturationTable[v27 + BYTE6(v19)] & 0xF8u))))]];
            if ( (v23 & 1) != 0 )
            {
              ++v24;
              v30 = v29 | v28 & 0xF0;
