/*
 * XREFs of sfac_GetLongGlyphIDs @ 0x1C02BF930
 * Callers:
        ...
        _DWORD *a9)
{
  ...
  if ( a8 )
  {
    ...
    if ( a5 )
    {
      for ( i = a9; ; ++i )
      {
        v20 = *(_DWORD *)((char *)i + a8 - (_QWORD)a9);
        if ( (unsigned int)(v20 + a7) > 0xFFFF )
          break;
        v21 = InvokeGlyphMappingF(v12, a2, (unsigned __int16)a7 + (unsigned __int16)v20, a3);
        *i = v21;
