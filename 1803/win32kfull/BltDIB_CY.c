/*
 * XREFs of BltDIB_CY @ 0x1C0117710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BltDIB_CY(__int128 *a1)
{
  ...
  void (__fastcall *v28)(unsigned int *); // [rsp+110h] [rbp+10h]
  void (__fastcall *v29)(unsigned int *, __int64, __int64, __int64, __int64, __int64, __int64, int, __int64); // [rsp+160h] [rbp+60h]
  ...
  *((_QWORD *)v1 + 10) = v11;
  ...
  while ( v16 )
  {
    ...
    if ( (v24 & 4) != 0 )
    {
      ...
      while ( (unsigned __int64)v21 < v48 );
    }
    v18 = v23;
    if ( (v23 & 0x80u) != 0 )
    {
