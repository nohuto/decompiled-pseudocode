/*
 * XREFs of ?MulStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C02746E0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v24[0] )
    {
      ...
      for ( i = MSURF::bFindSurface((MSURF *)v25, a1, a3, &v33); i; i = MSURF::bNextSurface((MSURF *)v25) )
      {
        ...
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v27) + 112) & 0x80u) == 0 )
          ...
          v19 = *(BOOL (__stdcall **)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, LINEATTRS *, BRUSHOBJ *, POINTL *, MIX, FLONG))(*((_QWORD *)v26 + 7) + 2808LL);
