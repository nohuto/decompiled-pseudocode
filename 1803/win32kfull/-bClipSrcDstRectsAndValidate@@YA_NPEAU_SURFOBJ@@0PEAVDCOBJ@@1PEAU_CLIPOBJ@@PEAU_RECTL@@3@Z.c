/*
 * XREFs of ?bClipSrcDstRectsAndValidate@@YA_NPEAU_SURFOBJ@@0PEAVDCOBJ@@1PEAU_CLIPOBJ@@PEAU_RECTL@@3@Z @ 0x1C011A5A4
 * Callers:
 ...
 *     ?vGetSurfaceBoundsRect@@YAXPEAU_SURFOBJ@@PEAU_RECTL@@@Z @ 0x1C011A708 (-vGetSurfaceBoundsRect@@YAXPEAU_SURFOBJ@@PEAU_RECTL@@@Z.c)
        ...
        struct _RECTL *a7)
{
  ...
  {
    v16 = 1.0 / *(float *)(v10 + 536);
    v17[0] = 1.0 / *(float *)(v10 + 532);
    v17[1] = v16;
  ...
  if ( bClipSrcDstRects(&v19, &v18, (struct tagRECT *)&v21, (struct tagRECT *)&v20) )
  {
