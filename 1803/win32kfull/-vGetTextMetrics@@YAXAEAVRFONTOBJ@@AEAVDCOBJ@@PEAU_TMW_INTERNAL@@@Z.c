/*
 * XREFs of ?vGetTextMetrics@@YAXAEAVRFONTOBJ@@AEAVDCOBJ@@PEAU_TMW_INTERNAL@@@Z @ 0x1C00FAE24
 * Callers:
...
void __fastcall vGetTextMetrics(struct RFONTOBJ *a1, struct DCOBJ *a2, struct _TMW_INTERNAL *a3)
{
  ...
  else
  {
    vIFIMetricsToTextMetricW(
      ...
      *(struct _IFIMETRICS **)(*(_QWORD *)(*(_QWORD *)a1 + 104LL) + 32LL));
  }
}
