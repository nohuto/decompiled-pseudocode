/*
 * XREFs of ReadPointerDeviceSettings @ 0x1C0069000
 * Callers:
...
__int64 __fastcall ReadPointerDeviceSettings(int a1, __int64 a2, unsigned __int16 *a3, unsigned int a4)
{
  ...
  if ( !(_DWORD)v6 )
  {
    ...
    v19 = off_1C031C060;
    GetLocalMachineRegistryDWORDValues(v6, L"\\Software\\Microsoft\\Wisp\\Touch", off_1C031C060);
  ...
  if ( v8 )
  {
    ...
    if ( v45 == 2 )
    {
      if ( !gPredictionMonitor && (int)CreatePredictionSettings(off_1C031C020, a2, a3, a4) >= 0 )
      {
...
LABEL_79:
        v46 = off_1C031C020;
        GetPredictionSettings(off_1C031C020, (const wchar_t *)a2, a3);
        v47 = *((_DWORD *)v46 + 3);
        if ( v47 == -1 )
        {
          v47 = *((_DWORD *)v46 + 2);
    ...
    && OpenDeviceCfgKey(0x60u, L"\\Software\\Microsoft\\Wisp\\Pen\\SysEventParameters", 0x20019u, &Handle, 0) >= 0 )
  {
    v50 = v37;
    v51 = 7LL;
    v52 = (_DWORD *)((char *)v37 + 12);
    v53 = Handle;
    do
    {
      if ( (int)ReadPointerDeviceCfgDWORDSetting(v53, v50) < 0 )
        *v52 = -1;
      v50 = (struct tagDEVICECONFIG_SETTING *)((char *)v50 + 16);
      v52 += 4;
      --v51;
    }
    while ( v51 );
