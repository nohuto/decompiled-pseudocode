/*
 * XREFs of vSrcAlphaCopyS8D32 @ 0x1C00AC3F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    if ( v12 )
    {
      do
      {
        ...
        if ( *result )
        {
          ...
          {
            _mm_lfence();
            *v13 = alAlpha_255[BYTE2(off_1C031C100[v14])] | ((alAlpha_255[BYTE1(off_1C031C100[v14])] | (alAlpha_255[LOBYTE(off_1C031C100[v14])] << 8)) << 8);
          }
        }
        ++result;
        ++v13;
