/*
 * XREFs of itrp_SPVTL @ 0x1C02CF8E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_36:
          if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, qword_1C0327148) )
          {
            ...
            if ( v17 < 1 || v17 > v14 || (int)v6 < v16 + *(__int16 *)(*(_QWORD *)(v15 + 64) + 2LL * (v17 - 1)) )
            {
              ...
              {
                v18 = dword_1C0327158;
                LOWORD(dword_1C0327158) = -HIWORD(dword_1C0327158);
                HIWORD(dword_1C0327158) = v18;
              }
              itrp_ComputeAndCheck_PF_Proj();
              dword_1C03271AC = 1;
              dword_1C03271B0 = 1;
              v19 = *(_WORD *)(qword_1C0327180 + 452);
              if ( (v19 & 1) == 0 )
                goto LABEL_54;
              if ( (v19 & 4) != 0 )
              {
...
LABEL_50:
              if ( v21 )
              {
                ...
                if ( (*(_BYTE *)(qword_1C0327180 + 120) & 4) != 0 || *(_BYTE *)(qword_1C0327180 + 333) )
                {
                  v22 = 8LL;
LABEL_56:
                  *(_DWORD *)(qword_1C0327180 + 128) = itrp_RoundFunctionId[v22
