/*
 * XREFs of ?GreGetDIBitsInternalWorker@@YAHKAEAVDCOBJ@@AEAVPDEVOBJ@@AEAVSURFREF@@AEAVXEPALOBJ@@PEAUHDC__@@PEAUHBITMAP__@@IIPEAEPEAUtagBITMAPINFO@@III@Z @ 0x1C00A6594
 * Callers:
 ...
 *     ?bIdenticalFormat@@YAHVXEPALOBJ@@H@Z @ 0x1C00A2874 (-bIdenticalFormat@@YAHVXEPALOBJ@@H@Z.c)
 ...
 *     ?vFill_triples@XEPALOBJ@@QEAAXPEAUtagRGBTRIPLE@@KK@Z @ 0x1C028B398 (-vFill_triples@XEPALOBJ@@QEAAXPEAUtagRGBTRIPLE@@KK@Z.c)
...
LABEL_121:
          ...
          else
          {
            ...
            v55 = *(struct PDEVOBJ **)(*(_QWORD *)v87 + 1800LL);
            v87 = v55;
            if ( v17 )
      ...
      else
      {
        ...
        else
        {
          ...
          if ( PALMEMOBJ::bCreatePalette((PALMEMOBJ *)&v70, v41, v22, 0LL, 0x7C00u, 0x3E0u, 0x1Fu, 0x200u, 1) )
          {
            v31 = v70;
            v67 = v70;
            if ( *(_DWORD *)(*(_QWORD *)v82 + 96LL) == LODWORD(v86[0]) && LODWORD(v86[0]) == 3 )
            {
              v56 = 0;
              v57 = pxlo;
              if ( v22 )
...
LABEL_77:
                ...
                *(_QWORD *)&prclDest.left = 0LL;
                ...
                v36 = *(_QWORD *)v82;
                v77 = *(_DWORD *)(*(_QWORD *)v82 + 56LL);
                v78 = *(_DWORD *)(v36 + 60) + HIDWORD(v76);
                ERECTL::operator*=(&prclDest.left, (int *)&v76);
