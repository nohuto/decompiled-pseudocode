/*
 * XREFs of ?TryResurrectHff@UmfdHostLifeTimeManager@@CA_N_KPEAVPFF@@@Z @ 0x1C0290084
 * Callers:
  ...
  if ( v15 )
  {
    ...
    if ( (_DWORD)v3 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( !*(_QWORD *)(v10 + 16) && !(unsigned int)EngMapFontFileFDInternal((struct _FILEVIEW *)v10, &v17, &v15, 0) )
          break;
        ++v6;
