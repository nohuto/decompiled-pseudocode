/*
 * XREFs of ?GreRectBlt@@YAHAEAVDCOBJ@@PEAVERECTL@@@Z @ 0x1C00F7358
 * Callers:
...
__int64 __fastcall GreRectBlt(struct DCOBJ *a1, struct ERECTL *a2)
{
  ...
  v22 = 0LL;
  v23 = 0LL;
  DEVLOCKBLTOBJ::bLock((DEVLOCKBLTOBJ *)v16, a1);
  v7 = 1;
  if ( !(unsigned int)XDCOBJ::bFullScreen(a1) )
  {
    if ( (v19 & 1) != 0 )
    {
      ...
      v10 = *(_QWORD *)(v8 + 80);
      v11 = *(_DWORD *)(v10 + 8);
      if ( (v11 & 1) != 0 || (*(_DWORD *)(v8 + 324) & 1) != 0 )
      {
        *(_DWORD *)(v10 + 8) = v11 & 0xFFFFFFFE;
        *(_DWORD *)(*(_QWORD *)a1 + 324LL) &= ~1u;
        EBRUSHOBJ::vInitBrush(v29, *(_QWORD *)a1, *(_QWORD *)(*(_QWORD *)a1 + 144LL), v26, v25, v27, 1);
      }
      if ( (*(_DWORD *)(v29 + 120) & 0x100) == 0 )
      {
        v8 = *(_QWORD *)a1;
        v31 = *(_QWORD *)(*(_QWORD *)a1 + 1584LL);
        if ( (*(_DWORD *)(v29 + 120) & 0x8000) != 0 && *(_BYTE *)(*(_QWORD *)(v8 + 80) + 73LL) == 1 )
        {
          v12 = 43520;
          goto LABEL_13;
        }
