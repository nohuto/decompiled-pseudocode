/*
 * XREFs of ?PaintWatermark@@YAXPEAUHDC__@@PEBUtagRECT@@@Z @ 0x1C01D614C
 * Callers:
...
void __fastcall PaintWatermark(HDC a1, const struct tagRECT *a2)
{
  ...
  __int64 v14; // r8
  __int64 v15; // r9
  struct tagSIZE v16; // [rsp+90h] [rbp+18h] BYREF
  ...
  if ( gbGreTextReady && *(_DWORD *)(gpsi + 2164LL) )
  {
    ...
    if ( (unsigned int)GreGetTextExtentW(a1, gwszSafeModeStr, gSafeModeStrLen, &v16, 1) )
    {
      GreExtTextOutWInternal(a1, a2->left, a2->top, 0, 0LL, gwszSafeModeStr, gSafeModeStrLen, 0LL, 0LL, 0);
      GreExtTextOutWInternal(a1, a2->right - v16.cx, a2->top, 0, 0LL, gwszSafeModeStr, gSafeModeStrLen, 0LL, 0LL, 0);
