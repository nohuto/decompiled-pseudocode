/*
 * XREFs of ?AllocatePriority@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAXW4_POOL_TYPE@@_KIW4_EX_POOL_PRIORITY@@@Z @ 0x1C02ADF7C
 * Callers:
 *     Win32AllocPoolWithPriorityImpl @ 0x1C01D3D90 (Win32AllocPoolWithPriorityImpl.c)
