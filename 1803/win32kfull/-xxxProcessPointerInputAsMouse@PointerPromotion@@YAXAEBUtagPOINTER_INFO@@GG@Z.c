/*
 * XREFs of ?xxxProcessPointerInputAsMouse@PointerPromotion@@YAXAEBUtagPOINTER_INFO@@GG@Z @ 0x1C01CDC04
 * Callers:
 *     EditionProcessPointerInputAsMouse @ 0x1C01CE190 (EditionProcessPointerInputAsMouse.c)
 * Callees:
 *     ?CancelAutoPromotion@@YAXXZ @ 0x1C01CCCF0 (-CancelAutoPromotion@@YAXXZ.c)
 *     ?CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z @ 0x1C01CCDE4 (-CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z.c)
 *     ?CreateMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagPOINTER_INFO@@GG@Z @ 0x1C01CCE84 (-CreateMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEBUtagPOINTER_INFO@@GG@Z.c)
 ...
 *     ?QueueMousePromotionEntry@@YAXAEAUtagMOUSE_PROMOTION_QUEUE@@PEAUtagMOUSE_PROMOTION_ENTRY@@@Z @ 0x1C01CD6B4 (-QueueMousePromotionEntry@@YAXAEAUtagMOUSE_PROMOTION_QUEUE@@PEAUtagMOUSE_PROMOTION_ENTRY@@@Z.c)
        ...
        __int16 a3)
{
  ...
  *(__m128i *)v21 = v3;
  ...
  if ( (v21[6] & 0x8000) != 0 )
  {
    v12 = dword_1C0326C48 & 0xFFFFFFF7;
    dword_1C0326C48 &= ~8u;
  }
  v13 = v21[2];
  if ( v21[2] != word_1C0326B40[0] || (a3 & 0x10) != 0 )
  {
    if ( (v12 & 2) != 0 )
    {
      CancelAutoPromotion();
    ...
    dword_1C0326C48 = v12 & 0xFFFFFFF7;
  ...
  qword_1C0326C38 = v22.m128i_i64[1];
  dword_1C0326B44 = v9;
  if ( MousePromotionEntry )
  {
    v15 = dword_1C0326C48;
    if ( (dword_1C0326C48 & 2) != 0 )
    {
      if ( (dword_1C0326C48 & 4) != 0 )
      {
      ...
      QueueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0326BC0, MousePromotionEntry);
      if ( (*((_DWORD *)MousePromotionEntry + 5) & 0x40000) != 0 )
        dword_1C0326C48 &= 0xFFFFFFE9;
      goto LABEL_31;
    }
    QueueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&unk_1C0326B50, MousePromotionEntry);
  }
  if ( v14 || MousePromotionEntry )
  {
    if ( (dword_1C0326C48 & 8) != 0 )
    {
      v16 = DetectPromotionType(0LL, qword_1C0326B58);
      if ( v16 == 0x10000000 )
        goto LABEL_31;
      v18 = v16;
      v19 = v9;
