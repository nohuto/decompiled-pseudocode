/*
 * XREFs of ?MulCreateDeviceBitmap@@YAPEAUHBITMAP__@@PEAUDHPDEV__@@UtagSIZE@@K@Z @ 0x1C02723D0
 * Callers:
 *     <none>
 * Callees:
...
HBITMAP __fastcall MulCreateDeviceBitmap(struct DHPDEV__ *a1, SIZEL sizl, ULONG iFormat)
{
  ...
  if ( *(_QWORD *)a1 )
  {
    do
    {
      v9 = v3[6];
      v18 = v9;
      if ( (v9[227] & 0x8000000) != 0 && v9[345] )
      {
        v10 = (HSURF)((__int64 (__fastcall *)(__int64, SIZEL, _QWORD))v9[345])(v9[224], v7, iFormat);
        v11 = v10;
