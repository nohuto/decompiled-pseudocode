/*
 * XREFs of NtGdiFillRgn @ 0x1C011C820
 * Callers:
 ...
 *     ?bSyncBrushObj@@YAHPEAVBRUSH@@@Z @ 0x1C011CD74 (-bSyncBrushObj@@YAHPEAVBRUSH@@@Z.c)
...
LABEL_32:
          ...
          *((_QWORD *)v9 + 190) = v8;
          ...
          v44.left += *((_DWORD *)v25[0] + 2 * v11 + 356);
          v44.right += *((_DWORD *)v25[0] + 2 * v11 + 356);
          v44.top += *((_DWORD *)v25[0] + 2 * v11 + 357);
          v44.bottom += *((_DWORD *)v25[0] + 2 * v11 + 357);
...
LABEL_31:
            ...
            if ( (*((_DWORD *)v16 + 10) & 0x100) == 0 )
            {
              ...
              XDCOBJ::vAccumulateTight((struct _RECTL **)v25, v15, &rclBounds);
            }
          }
          if ( v16 )
          {
            ...
            if ( (*((_DWORD *)v16 + 10) & 0x100) == 0 )
            {
              ...
              ++*(_DWORD *)(v10 + 92);
              EngPaint((SURFOBJ *)(v10 + 24), &pco, &pbo, (POINTL *)v25[0] + 198, mix);
              v4 = 1;
            }
