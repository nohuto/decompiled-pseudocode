/*
 * XREFs of ?HapticsDeviceNotify@SimpleHapticsController@@KAJPEAU_PLUGPLAY_NOTIFY_HDR@@PEAX@Z @ 0x1C02140A0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v10 )
    {
      ...
      if ( !v14 )
      {
        if ( (unsigned int)dword_1C031C790 > 4 )
        {
          ...
          v22 = 83;
          TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E42F8, a3, a4, 3u, &pData);
        }
        ...
        if ( v15 < 0 )
        {
          if ( (unsigned int)dword_1C031C790 > 2 )
          {
            ...
            v22 = 17;
            v25 = 4;
            TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E4170, v16, v17, 4u, &pData);
          }
          DbgPrintEx(
            0x4Du,
            0,
