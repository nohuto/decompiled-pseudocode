/*
 * XREFs of vShiftOutlineInfo @ 0x1C0224288
 * Callers:
...
char *__fastcall vShiftOutlineInfo(__int64 a1, int a2, unsigned int *a3, unsigned int a4)
{
  ...
  {
    v9(a3 + 2, &v17, 0LL);
    v9(a3 + 3, (unsigned int *)&v18, v10);
    result = (char *)*a3;
    v12 = a3 + 4;
    v13 = (unsigned int *)&result[(_QWORD)a3];
    if ( (char *)(a3 + 4) < &result[(_QWORD)a3] )
    {
      do
      {
        v14 = *((_WORD *)v12 + 1);
