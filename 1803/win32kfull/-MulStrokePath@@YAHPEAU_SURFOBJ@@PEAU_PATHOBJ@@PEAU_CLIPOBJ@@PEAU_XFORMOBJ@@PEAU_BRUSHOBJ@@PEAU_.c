/*
 * XREFs of ?MulStrokePath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@PEAU_LINEATTRS@@K@Z @ 0x1C02749C0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v21[0] )
  {
    ...
    for ( i = MSURF::bFindSurface((MSURF *)v22, a1, a3, &v30); i; i = MSURF::bNextSurface((MSURF *)v22) )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v24) + 112) & 0x20) != 0 )
        v17 = *(BOOL (__stdcall **)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, POINTL *, LINEATTRS *, MIX))(*((_QWORD *)v23 + 7) + 2792LL);
      else
        v17 = EngStrokePath;
      v11 &= OffStrokePath(
