/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C0198574
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1C0198690 (EditionFindNodeQueuedMessage.c)
 * Callees:
