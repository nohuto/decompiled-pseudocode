/*
 * XREFs of ?MulUpdateColors@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@@Z @ 0x1C027552C
 * Callers:
    ...
    do
    {
        ...
        && bIntersect(&v18, (const struct _RECTL *)((char *)v8 + 28), (struct _RECTL *)v17) )
      {
        ...
        if ( v13 )
          ...
          v14 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v9 + 2832);
        v7 &= OffCopyBits((int)v14, (int)v8 + 72, v12, (int)v8 + 72, v12, a2, (__int64)a3, (__int64)v17, (__int64)&v16);
      }
      v8 = (__int64 *)*v8;
    }
    while ( v8 );
