/*
 * XREFs of _InitThreadCoreMessagingIocp @ 0x1C00FF320
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  v10 = 0LL;
  v12 = 0LL;
  if ( (int)ZwAllocateReserveObject(gptiCurrent + 1440LL, &v8, 1LL) < 0 )
  {
    UserSetLastError(14LL, v4);
    *(_QWORD *)(gptiCurrent + 1440LL) = 0LL;
  }
  else
  {
    v2 = *(_QWORD *)(gptiCurrent + 1416LL);
    if ( v2 )
    {
      v7[0] = gptiCurrent + 1448LL;
      v7[1] = a1;
      HMAssignmentLock(v7);
    }
  }
