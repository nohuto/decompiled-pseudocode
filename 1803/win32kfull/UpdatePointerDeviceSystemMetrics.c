/*
 * XREFs of UpdatePointerDeviceSystemMetrics @ 0x1C01B7A80
 * Callers:
 ...
 *     ??0CInpLockSharedIfNeeded@@QEAA@AEAUCInpPushLock@@@Z @ 0x1C01022B8 (--0CInpLockSharedIfNeeded@@QEAA@AEAUCInpPushLock@@@Z.c)
 *     ?GetPointerDeviceType@@YAXAEAKPEAUtagHID_POINTER_DEVICE_INFO@@@Z @ 0x1C01B56BC (-GetPointerDeviceType@@YAXAEAKPEAUtagHID_POINTER_DEVICE_INFO@@@Z.c)
 */
...
int __fastcall UpdatePointerDeviceSystemMetrics(struct tagHID_POINTER_DEVICE_INFO *a1)
{
  ...
  else
  {
    ...
    {
      if ( (*((_DWORD *)i + 50) & 0x80u) != 0 && (*((_DWORD *)i + 46) & 0x200) == 0 )
      {
        v9 = *((_QWORD *)i + 60);
        if ( *(_DWORD *)(v9 + 24) != 7 )
        {
