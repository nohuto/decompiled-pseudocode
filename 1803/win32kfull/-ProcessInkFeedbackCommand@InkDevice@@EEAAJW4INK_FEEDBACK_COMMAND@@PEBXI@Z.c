/*
 * XREFs of ?ProcessInkFeedbackCommand@InkDevice@@EEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C020FA50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsSuperWetInkStartDataSupported@@YA_NW4InkFeedbackCapabilities@@PEBUIFC_SUPERWET_INK_START_DATA@@@Z @ 0x1C020DBC0 (-IsSuperWetInkStartDataSupported@@YA_NW4InkFeedbackCapabilities@@PEBUIFC_SUPERWET_INK_START_DATA.c)
...
__int64 __fastcall InkDevice::ProcessInkFeedbackCommand(__int64 a1, int a2, __int64 a3, const GUID *a4)
{
  ...
  if ( *(_BYTE *)(a1 - 20) )
  {
    if ( a2 == 1 )
    {
      if ( (_DWORD)a4 == 64 )
      {
        v21 = (const GUID *)(unsigned int)pRelatedActivityId;
        if ( (unsigned int)pRelatedActivityId > 4 )
        {
          ...
          v52 = -__CFSHR__(v23, 3);
          v112 = 4LL;
          TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3F4D, v24, v25, 0x1Bu, &v63);
          v21 = (const GUID *)(unsigned int)pRelatedActivityId;
        }
        v26 = *(_DWORD *)(a1 + 40);
        if ( v26 < *(_DWORD *)(a1 + 108) )
        {
          if ( InkFeedbackProviderBase::FindActiveCommandByTargetPointerId(a1, 1, *(_DWORD *)a3) )
          {
            ...
            if ( (unsigned int)v28 > 2 )
            {
              ...
              v132 = a3;
              v133 = 4LL;
              TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3C2C, v27, v28, 5u, &v127);
            }
          }
          else
          {
            v29 = InkDevice::ValidatePointer((InkDevice *)(a1 - 32), (unsigned int)v27);
            v6 = v29;
            if ( v29 >= 0 )
            {
              if ( IsSuperWetInkStartDataSupported(*(_DWORD *)(a1 + 116), a3) )
              {
                v34 = (_QWORD *)Win32AllocPoolZInit(32LL, 1349217865LL);
                v37 = v34;
                if ( v34 )
                {
                  v34[2] = 0LL;
                  ...
                  *((_DWORD *)v37 + 5) = *(_DWORD *)a3;
                  ...
                  if ( v6 < 0 )
                    ...
                    InkFeedbackProviderBase::AddActiveCommand(
                      ...
                      (struct InkFeedbackProviderBase::ActiveCommand *)v37);
                }
                else
                {
                  v6 = -1073741801;
                  if ( (unsigned int)pRelatedActivityId > 2 )
                  {
                    ...
                    v181 = &v58;
                    v182 = 4LL;
                    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E36AF, v35, v36, 3u, &v180);
                  }
                }
              }
              else
              {
                ...
                if ( (unsigned int)pRelatedActivityId > 2 )
                {
                  ...
                  v168 = 4LL;
                  v170 = 65LL;
                  TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3E0E, v32, v33, 4u, &v166);
                }
              }
            }
            else if ( (unsigned int)pRelatedActivityId > 2 )
            {
              ...
              v163 = 4LL;
              v165 = 23LL;
              TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3E0E, v30, v31, 4u, &v161);
            }
          }
        }
        else
        {
          ...
          if ( (unsigned int)v21 > 2 )
          {
            ...
            v54 = v26;
            v126 = 4LL;
            TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3F05, (LPCGUID)a3, v21, 5u, &v120);
          }
        }
      }
      else
      {
        ...
        if ( (unsigned int)pRelatedActivityId > 2 )
        {
          ...
          v178 = &v48;
          v179 = 4LL;
          TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E36AF, (LPCGUID)a3, a4, 3u, &v177);
        }
      }
    }
    else if ( a2 == 2 )
    {
      if ( (_DWORD)a4 == 4 )
      {
        if ( (unsigned int)pRelatedActivityId > 4 )
        {
          ...
          v150 = &v60;
          TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3C69, v12, v13, 7u, &v144);
        }
        ...
        if ( ActiveCommandByTargetPointerId )
        {
          ...
          if ( (unsigned int)IsProcessDwm(**(_QWORD **)(ThreadWin32Thread + 416))
            || (v18 = InkDevice::ValidatePointer((InkDevice *)(a1 - 32), *(_DWORD *)a3), v6 = v18, v18 >= 0) )
          {
          ...
          else if ( (unsigned int)pRelatedActivityId > 2 )
          {
            ...
            v156 = 4;
            v159 = 23;
            TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3E0E, v19, v20, 4u, &v154);
          }
        }
        else
        {
          ...
          if ( (unsigned int)v16 > 2 )
          {
            ...
            v118 = a3;
            v119 = 4LL;
            TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3C2C, v15, v16, 5u, &v113);
          }
        }
      }
      else
      {
        ...
        if ( (unsigned int)pRelatedActivityId > 2 )
        {
          ...
          v175 = &v44;
          v176 = 4LL;
          TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E36AF, (LPCGUID)a3, a4, 3u, &v174);
        }
      }
    }
    else
    {
      ...
      if ( (unsigned int)pRelatedActivityId > 2 )
      {
        ...
        v140 = &v59;
        v142 = &v39;
        TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3EA7, v9, v10, 7u, &v134);
      }
    }
  }
  else
  {
    ...
    if ( (unsigned int)pRelatedActivityId > 2 )
    {
      ...
      v172 = &v42;
      v173 = 4LL;
      TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E36AF, (LPCGUID)a3, a4, 3u, &pData);
    }
  }
