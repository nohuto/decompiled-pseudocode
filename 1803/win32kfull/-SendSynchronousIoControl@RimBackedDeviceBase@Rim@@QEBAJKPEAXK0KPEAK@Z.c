/*
 * XREFs of ?SendSynchronousIoControl@RimBackedDeviceBase@Rim@@QEBAJKPEAXK0KPEAK@Z @ 0x1C01F9AC4
 * Callers:
 ...
 * Callees:
 *     ??1DeviceObjectPointer@Io@@QEAA@XZ @ 0x1C01F9758 (--1DeviceObjectPointer@Io@@QEAA@XZ.c)
 ...
 *     SendSynchronousIoControl @ 0x1C01F9BC8 (SendSynchronousIoControl.c)
 */
        ...
        unsigned int *a7)
{
  ...
  if ( !v7
    || (v10 = Io::DeviceObjectPointer::GetByObjectName(
                (struct _UNICODE_STRING *)((*((_QWORD *)this + 2) + 288LL) & -(__int64)(*((_QWORD *)this + 2) != 0LL)),
                *((_QWORD *)this + 2) + 288LL,
                a3,
                (void **)&v12),
        v10 >= 0) )
