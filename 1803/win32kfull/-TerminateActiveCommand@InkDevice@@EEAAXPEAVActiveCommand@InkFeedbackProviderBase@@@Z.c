/*
 * XREFs of ?TerminateActiveCommand@InkDevice@@EEAAXPEAVActiveCommand@InkFeedbackProviderBase@@@Z @ 0x1C02103C0
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a3)
{
  ...
  else if ( (unsigned int)pRelatedActivityId > 2 )
  {
    ...
    v8 = 18LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3E0E, a3, 0LL, 4u, &v4);
  }
}
