/*
 * XREFs of ?RedirDrawStream@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@KPEAXPEAU_DSSTATE@@@Z @ 0x1C026BF10
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (*(_DWORD *)(v13 + 40) & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(v13 + 1792); i; i = *(struct _DISPSURF **)i )
          {
            ...
            if ( v15 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v15 + 1784) + 784LL) )
                {
