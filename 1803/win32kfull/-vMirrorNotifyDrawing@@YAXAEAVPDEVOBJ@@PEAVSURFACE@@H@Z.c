/*
 * XREFs of ?vMirrorNotifyDrawing@@YAXAEAVPDEVOBJ@@PEAVSURFACE@@H@Z @ 0x1C026B560
 * Callers:
...
void __fastcall vMirrorNotifyDrawing(struct PDEVOBJ *a1, struct SURFACE *a2, int a3)
{
  ...
  {
    for ( i = **(struct _DISPSURF ***)(v3 + 1792); i; i = *(struct _DISPSURF **)i )
    {
      v7 = *((_QWORD *)i + 6);
      if ( v7 )
      {
        if ( (*(_DWORD *)(v7 + 1816) & 0x8000000) != 0 )
        {
          v8 = *(_DWORD *)(v7 + 2120);
          if ( (v8 & 0x1000) != 0 )
          {
            ...
            if ( (v8 & 0x8000) != 0 )
            {
              if ( *(_QWORD *)(v9 + 760) )
              {
                ...
                (*(void (__fastcall **)(struct _SURFOBJ *, __int64, __int64))(*(_QWORD *)(v7 + 1784) + 760LL))(
                  DevBitmap,
                  7LL,
                  v5);
              }
