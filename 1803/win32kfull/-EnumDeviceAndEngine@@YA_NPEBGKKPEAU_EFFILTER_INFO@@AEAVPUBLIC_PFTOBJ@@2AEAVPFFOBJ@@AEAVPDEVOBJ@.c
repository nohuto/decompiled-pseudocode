/*
 * XREFs of ?EnumDeviceAndEngine@@YA_NPEBGKKPEAU_EFFILTER_INFO@@AEAVPUBLIC_PFTOBJ@@2AEAVPFFOBJ@@AEAVPDEVOBJ@@PEAVDCOBJ@@PEAKPEAX@Z @ 0x1C02886EC
 * Callers:
      ...
      if ( FHOBJ::bValid((FHOBJ *)v36) )
      {
        ...
        if ( FHOBJ::bValid((FHOBJ *)v37) )
        {
          ...
          else
          {
            ...
            if ( !v33[0] )
              goto LABEL_16;
            if ( (*(_DWORD *)(*(_QWORD *)a8 + 2176LL) & 0x2000) != 0 )
            {
