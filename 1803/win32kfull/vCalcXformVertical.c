/*
 * XREFs of vCalcXformVertical @ 0x1C02240F8
 * Callers:
...
__int64 __fastcall vCalcXformVertical(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 340) = 0LL;
  *(_DWORD *)(a1 + 348) = 0;
  FixMul(*(unsigned int *)(a1 + 92), (unsigned int)(v4 << 16));
  fixed = FixMul(*(unsigned int *)(a1 + 80), v3);
  *(_DWORD *)(a1 + 392) = fixed + v6;
  FixMul(*(unsigned int *)(a1 + 96), v7);
  result = FixMul(*(unsigned int *)(a1 + 84), v3);
