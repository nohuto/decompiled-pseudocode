/*
 * XREFs of ?GetDeviceSupportedWaveforms@InteractiveControlManager@@QEAAJKPEAPEAU_WAVEFORM_INFO@@PEAJ@Z @ 0x1C020C004
 * Callers:
        ...
        GUID *a4)
{
  ...
  if ( dword_1C031C7D0 > 4u )
  {
    ...
    v16 = a2;
    v22 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C7D0, &unk_1C02E3826, (LPCGUID)4, a4, 4u, &pData);
  }
  v10 = 0;
...
LABEL_8:
  ...
  if ( dword_1C031C7D0 > 4u )
  {
    ...
    v19 = 60;
    v22 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C7D0, &unk_1C02E3860, (LPCGUID)4, a4, 4u, &pData);
  }
  return v15;
}
