/*
 * XREFs of ?MNInitDrawItemStruct@@YAXPEAUHDC__@@IAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@HHPEAUtagDRAWITEMSTRUCT@@@Z @ 0x1C0010894
 * Callers:
...
__int64 __fastcall MNInitDrawItemStruct(__int64 a1, int a2, __int64 ***a3, __int64 *a4, int a5, int a6, __int64 a7)
{
  ...
  *(_DWORD *)(a7 + 16) = v11 | v12 | (v13 != 0) | v15 | v14 | (8 * (*(_DWORD *)((**a3)[5] + 40) & 0x10)) | (*(_DWORD *)(*a4 + 4) >> 2) & 0x40 | ~((unsigned __int16)*(_DWORD *)((**a3)[5] + 40) << 6) & 0x100;
