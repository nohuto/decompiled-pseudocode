/*
 * XREFs of ?MulGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1C0273560
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ulMode)
{
  ...
  for ( i = MSURF::bFindSurface((MSURF *)v33, a1, a2, a8); i; i = MSURF::bNextSurface((MSURF *)v33) )
  {
    ...
    if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v35) + 112) & 0x20000) != 0 )
      v28 = *(BOOL (__stdcall **)(SURFOBJ *, CLIPOBJ *, XLATEOBJ *, TRIVERTEX *, ULONG, PVOID, ULONG, RECTL *, POINTL *, ULONG))(*(_QWORD *)(v34 + 56) + 3224LL);
    else
      v28 = EngGradientFill;
    v15 &= OffGradientFill(
