/*
 * XREFs of ?ppfeGetPFEFromUFIInternal@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z @ 0x1C0119AA8
 * Callers:
 ...
 *     ?ppfeGetPFEFromUFI@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z @ 0x1C024810C (-ppfeGetPFEFromUFI@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z.c)
 * Callees:
 ...
 *     ?SameProccess@PFEOBJ@@QEAAHXZ @ 0x1C0119BA4 (-SameProccess@PFEOBJ@@QEAAHXZ.c)
 */
