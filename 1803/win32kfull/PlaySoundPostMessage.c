/*
 * XREFs of PlaySoundPostMessage @ 0x1C0367008
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1C00E4AF4 (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C00D54B0 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 *     I_PlaySoundkPostMessage @ 0x1C00E4B74 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C00E4BC0 (PlaySndClient_midl_user_allocate.c)
 */
