/*
 * XREFs of NtUserGetProcessUIContextInformation @ 0x1C00E4450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetProcessUIContextInformation(HANDLE Handle, _QWORD *a2)
{
  ...
  {
    v11 = *(_DWORD *)(CurrentProcessWin32Process + 812);
    LODWORD(v17) = (v11 >> 4) & 3;
    HIDWORD(v17) = (v11 & 0x40) != 0;
    if ( (v11 & 0x100) != 0 )
      HIDWORD(v17) = ((v11 & 0x40) != 0) | 2;
