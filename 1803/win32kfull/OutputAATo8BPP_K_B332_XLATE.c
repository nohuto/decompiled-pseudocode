/*
 * XREFs of OutputAATo8BPP_K_B332_XLATE @ 0x1C0232F20
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v9[3] )
      {
        ...
        if ( v21 < v14 )
        {
          ...
          if ( v21 < v22 )
          {
            v23 = *a6;
            if ( v21 < v23 )
              v15 = *(_BYTE *)((((v18 - v22) & (v22 - DWORD1(v24)) & 0x1C000 | (v16 - v14) & (v14 - DWORD2(v24)) & 0xE0000 | (unsigned __int64)((unsigned __int16)(v23 - v24) & (unsigned __int16)(v20 - v23) & 0x3000)) >> 12)
                             + a9);
          }
        }
        *a4 = v15;
