/*
 * XREFs of xxxEnableWindowGDIScaledDpiMessageX @ 0x1C01B0180
 * Callers:
 *     NtUserEnableWindowGDIScaledDpiMessage @ 0x1C01ED5A0 (NtUserEnableWindowGDIScaledDpiMessage.c)
 * Callees:
...
__int64 __fastcall xxxEnableWindowGDIScaledDpiMessageX(__int64 a1, __int64 a2)
{
  ...
  if ( W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), a2) )
  {
    ...
    {
      if ( (*(_DWORD *)(**(_QWORD **)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v6) + 448) + 8LL)
                      + 52LL) & 1) != 0 )
      {
        v7 = *(_QWORD *)(a1 + 40);
