/*
 * XREFs of ?TraceLoggingRimHidDeviceRemovedEvent@@YAXGIIKKHPEAU_UNICODE_STRING@@0HHIIIKK@Z @ 0x1C0199A3C
 * Callers:
        ...
        char a15)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v50 = 4LL;
      v52 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E2231, v15, v16, 0x13u, &pData);
    }
  }
}
