/*
 * XREFs of itrp_ROTATE @ 0x1C02CD720
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall itrp_ROTATE(__int64 a1)
{
  ...
  if ( (qword_1C0327180 ^ *(_QWORD *)qword_1C0327180 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0327180 + 424)) == *(_QWORD *)(qword_1C0327180 + 432)
    && (v2 = qword_1C0327168, (unsigned __int64)((qword_1C0327168 - *(_QWORD *)qword_1C0327180) >> 2) >= 3) )
  {
    v3 = *(_DWORD *)(qword_1C0327168 - 8);
    *(_DWORD *)(qword_1C0327168 - 8) = *(_DWORD *)(qword_1C0327168 - 4);
