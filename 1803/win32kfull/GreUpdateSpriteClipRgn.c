/*
 * XREFs of GreUpdateSpriteClipRgn @ 0x1C00C4F48
 * Callers:
...
LABEL_16:
    ...
    CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)v14, (struct _EX_PUSH_LOCK *)(v12 + 88));
    v8 = *(_QWORD *)(v7 + 168);
    CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)v13, (struct _EX_PUSH_LOCK *)(v8 + 256));
    if ( v18[0] && (unsigned int)UserGetWindowRect(*(_QWORD *)(v7 + 40), (__int64)v17) )
    {
      if ( !*(_QWORD *)(v8 + 88) )
      {
      ...
      if ( RGNOBJ::bOffset((RGNOBJ *)&v10, &v11) )
      {
        if ( (*(_DWORD *)(v7 + 164) & 0x20) != 0 )
          RGNOBJ::vScale(&v10, *(_QWORD *)(v7 + 156));
        *(_QWORD *)(v8 + 88) = v10;
        goto LABEL_12;
      }
