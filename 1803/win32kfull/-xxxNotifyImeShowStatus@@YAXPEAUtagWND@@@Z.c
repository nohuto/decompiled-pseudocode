/*
 * XREFs of ?xxxNotifyImeShowStatus@@YAXPEAUtagWND@@@Z @ 0x1C01AC7CC
 * Callers:
 *     xxxSetIMEShowStatus @ 0x1C0112334 (xxxSetIMEShowStatus.c)
 *     xxxBroadcastImeShowStatusChange @ 0x1C01ACE90 (xxxBroadcastImeShowStatusChange.c)
 * Callees:
...
void __fastcall xxxNotifyImeShowStatus(struct tagWND *a1)
{
  ...
  if ( (*gpsi & 4) != 0 && *(char *)(*((_QWORD *)a1 + 5) + 20LL) >= 0 )
  {
    ...
    if ( v4 )
    {
      v5 = *((_QWORD *)a1 + 2);
      if ( v5 != gptiCurrent )
        KeAttachProcess(**(PRKPROCESS **)(v5 + 416));
      v6 = *v4;
      v7 = v6;
      ...
      if ( v9 || (v9 = *(struct tagWND **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 424LL) + 112LL)) != 0LL )
      {
        v2 = 1;
