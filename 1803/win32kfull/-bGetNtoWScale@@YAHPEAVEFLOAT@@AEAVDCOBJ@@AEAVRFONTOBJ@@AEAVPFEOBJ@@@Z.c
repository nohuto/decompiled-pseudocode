/*
 * XREFs of ?bGetNtoWScale@@YAHPEAVEFLOAT@@AEAVDCOBJ@@AEAVRFONTOBJ@@AEAVPFEOBJ@@@Z @ 0x1C0119570
 * Callers:
...
__int64 __fastcall bGetNtoWScale(struct EFLOAT *a1, struct DCOBJ *a2, struct RFONTOBJ *a3, struct PFEOBJ *a4)
{
  ...
  v8 = *(_DWORD *)(*(_QWORD *)a3 + 124LL);
  v9 = *(_DWORD *)(*(_QWORD *)a3 + 120LL);
  v10 = *(_DWORD *)(*(_QWORD *)a3 + 128LL);
  *(_DWORD *)v18[0] = v9;
  *((_DWORD *)v18[0] + 1) = v8;
  *((_DWORD *)v18[0] + 2) = v10;
  *((_DWORD *)v18[0] + 3) = v9;
