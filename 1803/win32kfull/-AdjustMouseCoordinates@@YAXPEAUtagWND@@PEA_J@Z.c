/*
 * XREFs of ?AdjustMouseCoordinates@@YAXPEAUtagWND@@PEA_J@Z @ 0x1C01E2934
 * Callers:
...
void __fastcall AdjustMouseCoordinates(struct tagWND *a1, __int64 *a2)
{
  ...
  if ( *((_QWORD *)a1 + 25)
    ...
    && (W32GetCurrentThreadDpiAwarenessContext((__int64)a1, (__int64)a2) & 0xF) == 2
    && *(_DWORD *)(gptiCurrent + 748LL) == *(_DWORD *)(gptiCurrent + 760LL)
    && *(_DWORD *)(gptiCurrent + 752LL) == *(_DWORD *)(gptiCurrent + 764LL) )
  {
    v4 = *(__int16 *)a2;
    v5 = *((__int16 *)a2 + 1);
