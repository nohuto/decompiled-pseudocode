/*
 * XREFs of RecreateRedirectionBitmap @ 0x1C00E8330
 * Callers:
...
__int64 __fastcall RecreateRedirectionBitmap(struct tagWND *a1, LONG a2, int a3, int a4, int a5, HSURF *a6)
{
  ...
  *(_QWORD *)&v33.left = v14;
  ...
  {
    DeleteOrSetRedirectionBitmap((__int64)a1, v17, 1);
    v18 = -1073741801;
  }
  if ( v18 < 0 )
  {
LABEL_27:
  ...
  if ( v17 && !v9 )
  {
    if ( v13 )
    {
      GreExtGetObjectW((HBRUSH)v13, 32LL, (char *)&v32);
      v28 = 1;
    }
    GreExtGetObjectW((HBRUSH)v17, 32LL, (char *)&v31);
  }
