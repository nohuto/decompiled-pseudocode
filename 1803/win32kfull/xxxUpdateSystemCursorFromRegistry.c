/*
 * XREFs of xxxUpdateSystemCursorFromRegistry @ 0x1C006AF34
 * Callers:
...
__int64 __fastcall xxxUpdateSystemCursorFromRegistry(__int64 a1, unsigned int a2)
{
  ...
  FastGetProfileStringFromIDW(a1, 1LL, WORD1(gasyscur[2 * (int)a2]), &pwsz, SourceString, 260, 0);
  v3 = 576;
  if ( SourceString[0] )
  {
    v4 = 4LL;
