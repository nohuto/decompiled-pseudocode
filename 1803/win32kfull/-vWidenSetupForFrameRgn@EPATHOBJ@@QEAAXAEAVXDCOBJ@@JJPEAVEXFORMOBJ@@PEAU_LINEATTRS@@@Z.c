/*
 * XREFs of ?vWidenSetupForFrameRgn@EPATHOBJ@@QEAAXAEAVXDCOBJ@@JJPEAVEXFORMOBJ@@PEAU_LINEATTRS@@@Z @ 0x1C011D05C
 * Callers:
        ...
        struct _LINEATTRS *a6)
{
  ...
  v16 = a5;
  v17 = *(_QWORD *)a5;
  *(_OWORD *)v17 = *(_OWORD *)(*(_QWORD *)a2 + 328LL);
  *(_OWORD *)(v17 + 16) = *(_OWORD *)(v15 + 344);
  *(_DWORD *)(v17 + 32) = *(_DWORD *)(v15 + 360);
  v18 = *(float **)v16;
  if ( v14 < v13 )
  {
    *v18 = v12 * *v18;
