/*
 * XREFs of DwmAsyncRegisterSharedThumbnailVisual @ 0x1C000743C
 * Callers:
 *     DwmAsyncRegisterSharedThumbnailVisualApiExt @ 0x1C0007400 (DwmAsyncRegisterSharedThumbnailVisualApiExt.c)
 * Callees:
