/*
 * XREFs of ?vSetNotionalToDevice@RFONTOBJ@@QEAAXAEAVEXFORMOBJ@@@Z @ 0x1C0086B98
 * Callers:
...
void __fastcall RFONTOBJ::vSetNotionalToDevice(RFONTOBJ *this, struct EXFORMOBJ *a2)
{
  ...
  v4 = *(_DWORD *)(*(_QWORD *)this + 356LL);
  v5 = *(_DWORD *)(*(_QWORD *)this + 352LL);
  v6 = *(_DWORD *)(*(_QWORD *)this + 360LL);
  **(_DWORD **)a2 = *(_DWORD *)(*(_QWORD *)this + 348LL);
