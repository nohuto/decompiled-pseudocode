/*
 * XREFs of ?vSrcCopyS16D8@@YAXPEAUBLTINFO@@@Z @ 0x1C02981A0
 * Callers:
 *     <none>
 * Callees:
...
{
  unsigned __int8 (__fastcall *v1)(struct _XLATEOBJ *, unsigned __int8 *, unsigned int); // r12
  unsigned int v2; // ebp
  ...
  if ( Xlate555 )
  {
    ...
    if ( (v11 & 0x200000) != 0 )
    {
      v1 = (unsigned __int8 (__fastcall *)(struct _XLATEOBJ *, unsigned __int8 *, unsigned int))XLATEOBJ_RGB16_555ToPalSurf;
    }
    else if ( (v11 & 0x400000) != 0 )
    {
      v1 = (unsigned __int8 (__fastcall *)(struct _XLATEOBJ *, unsigned __int8 *, unsigned int))XLATEOBJ_RGB16_565ToPalSurf;
    }
    while ( 1 )
    {
      v12 = v4;
