/*
 * XREFs of _SetDisplayMapping @ 0x1C01B81C8
 * Callers:
...
__int64 __fastcall SetDisplayMapping(__int64 a1, __int64 a2)
{
  ...
  v5 = *(_QWORD *)(a1 + 16);
  RIMEndAllActiveContacts(*(_QWORD *)(*(_QWORD *)(v5 + 32) + 416LL), a1, 0LL);
  v6 = *(_QWORD *)(a2 + 240);
  v9[0] = 840;
  if ( (unsigned int)DrvGetHdevName(v6, SourceString) )
  {
    ...
    if ( (int)DrvEnumDisplayDevices(&DestinationString, 0LL, 0LL, v9, 1, 0) >= 0
      && RtlStringCchCopyW((NTSTRSAFE_PWSTR)(v5 + 868), 0x80uLL, (NTSTRSAFE_PCWSTR)&v9[82]) >= 0 )
    {
