/*
 * XREFs of ?UMPDDrvTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KI@Z @ 0x1C027C7C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    if ( !(unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 64), (struct _SURFOBJ **)&v34[3], v12)
      ...
      || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v14, v34, 0x50u, &v20, Size) == -1)
      || (v17 = 1, !v20) )
    {
      v17 = 0;
    }
