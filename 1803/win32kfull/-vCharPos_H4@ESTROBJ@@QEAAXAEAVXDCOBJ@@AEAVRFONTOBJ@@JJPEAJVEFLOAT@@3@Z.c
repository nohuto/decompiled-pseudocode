/*
 * XREFs of ?vCharPos_H4@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJPEAJVEFLOAT@@3@Z @ 0x1C028D0D8
 * Callers:
        ...
        float a8)
{
  ...
  signed int v41; // [rsp+48h] [rbp-28h]
  int v42; // [rsp+4Ch] [rbp-24h]
  int v43; // [rsp+50h] [rbp-20h]
  BOOL v44; // [rsp+54h] [rbp-1Ch]
  BOOL v45; // [rsp+58h] [rbp-18h]
  ...
  if ( (_DWORD)result )
  {
    ...
    v37 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)a2 + 80LL) + 352LL) & 0x40;
    if ( !v37 )
