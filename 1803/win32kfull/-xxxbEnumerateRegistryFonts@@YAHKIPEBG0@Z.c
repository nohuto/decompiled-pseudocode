/*
 * XREFs of ?xxxbEnumerateRegistryFonts@@YAHKIPEBG0@Z @ 0x1C004EF98
 * Callers:
        ...
        const unsigned __int16 *a4)
{
  ...
  if ( (_DWORD)a2 == 56 )
  {
    ProfileUserName = CreateProfileUserName(v20, a2, a3, a4);
    if ( !ProfileUserName )
      return 0LL;
  }
  v8 = (void *)OpenCacheKeyEx(ProfileUserName, v4, 131097LL, 0LL);
  if ( ProfileUserName )
