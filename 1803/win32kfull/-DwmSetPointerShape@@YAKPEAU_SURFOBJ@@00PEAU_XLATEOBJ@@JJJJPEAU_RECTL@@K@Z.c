/*
 * XREFs of ?DwmSetPointerShape@@YAKPEAU_SURFOBJ@@00PEAU_XLATEOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x1C0136AF0
 * Callers:
      ...
      if ( v18 )
      {
        ...
        if ( v19 != v18 )
        {
          do
          {
            ...
            if ( v36 )
            {
              CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)v35, (struct DWMSPRITE *)((char *)v36 + 88));
