/*
 * XREFs of ?SPISetIconMetrics@@YAHPEAU_UNICODE_STRING@@PEAUtagICONMETRICSW@@H@Z @ 0x1C01A3F40
 * Callers:
 ...
 *     ?RescaleIconMetrics@@YAXPEAUtagICONMETRICSW@@@Z @ 0x1C01A3B88 (-RescaleIconMetrics@@YAXPEAUtagICONMETRICSW@@@Z.c)
