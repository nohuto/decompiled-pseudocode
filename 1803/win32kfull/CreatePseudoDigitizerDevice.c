/*
 * XREFs of CreatePseudoDigitizerDevice @ 0x1C01A9F40
 * Callers:
 *     _InitializeTouchInjectionWorker @ 0x1C01A9298 (_InitializeTouchInjectionWorker.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0139660 (__security_check_cookie.c)
 *     memset @ 0x1C013D6C0 (memset.c)
 *     ?_UpdateReportDescriptor@@YAXUtagRECT@@KK@Z @ 0x1C01A9E38 (-_UpdateReportDescriptor@@YAXUtagRECT@@KK@Z.c)
 */
...
struct DEVICEINFO *__fastcall CreatePseudoDigitizerDevice(int a1, int a2, __int64 a3)
{
  ...
  if ( (int)CHidInput::GetKernelHandleToRimObj(gpHidInput, (void **)(a3 + 88)) >= 0 )
  {
    ...
    *(_QWORD *)((char *)&v15[14] + 4) = *(_QWORD *)(PsGetCurrentProcessWin32Process(v10) + 872);
