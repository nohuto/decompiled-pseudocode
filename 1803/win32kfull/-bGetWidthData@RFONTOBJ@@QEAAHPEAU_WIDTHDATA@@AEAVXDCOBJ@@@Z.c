/*
 * XREFs of ?bGetWidthData@RFONTOBJ@@QEAAHPEAU_WIDTHDATA@@AEAVXDCOBJ@@@Z @ 0x1C00849D8
 * Callers:
...
__int64 __fastcall RFONTOBJ::bGetWidthData(RFONTOBJ *this, struct _WIDTHDATA *a2, struct XDCOBJ *a3)
{
  ...
  LODWORD(v7) = 0;
  fxD = 0;
  v9 = *(_DWORD *)(*(_QWORD *)this + 456LL);
  v13 = *(_QWORD *)(*(_QWORD *)this + 104LL);
  v10 = 16 * *(_DWORD *)(*(_QWORD *)this + 336LL);
  v11 = 16 * *(_DWORD *)(*(_QWORD *)this + 296LL);
  v12 = *(_QWORD *)(v13 + 32);
  ...
  if ( (unsigned __int8)v13 <= 8u && (v14 = 323, _bittest(&v14, v13)) )
  {
    if ( (*(_DWORD *)(v12 + 48) & 0x10000000) != 0 )
    {
      ...
      while ( (unsigned int)RFONTOBJ::bGetGlyphMetrics(this, 1u, &v18, &v19, a3, 0LL)
           && v18.hg != *(_DWORD *)(*(_QWORD *)this + 448LL) )
      {
        v7 = (unsigned int)(v7 + 1);
        v19 = word_1C02EB958[v7];
        if ( !v19 )
        {
          LODWORD(v17) = 0;
...
LABEL_3:
    if ( ((v10 | v11 | v9 | (unsigned int)v7) & 0xFFFF0000) == 0 )
    {
      ...
      *(_WORD *)a2 = 16 * RFONTOBJ::lOverhang(this);
      v15 = *(_BYTE **)(*(_QWORD *)(*(_QWORD *)this + 104LL) + 32LL);
      *((_BYTE *)a2 + 8) = v15[108];
      *((_BYTE *)a2 + 9) = v15[109];
      *((_BYTE *)a2 + 11) = v15[110];
      *((_BYTE *)a2 + 10) = v15[111];
