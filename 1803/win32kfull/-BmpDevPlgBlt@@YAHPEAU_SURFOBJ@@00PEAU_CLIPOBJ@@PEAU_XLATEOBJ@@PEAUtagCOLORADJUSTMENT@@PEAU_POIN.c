/*
 * XREFs of ?BmpDevPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C026A170
 * Callers:
 *     <none>
 * Callees:
          ...
          do
          {
            ...
            if ( v20 )
            {
              if ( (*(_DWORD *)(v20 + 1816) & 0x8000000) != 0 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v20 + 1784) + 624LL) )
                  {
