/*
 * XREFs of ?xxxUserReinitializeAutoRotation@CLegacyRotationMgr@@UEAAXXZ @ 0x1C00BDA50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CLegacyRotationMgr::xxxUserReinitializeAutoRotation(CLegacyRotationMgr *this)
{
  ...
  dword_1C03227A8 = CLegacyRotationMgr::QueryAutoRotationRegistrySetting(
                      this,
                      L"Enable",
                      1u,
  ...
  if ( (unsigned int)hProvider > 5 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x400000000001uLL) )
  {
    ...
    v14 = &v10;
    v15 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E2FE5, v3, v4, 4u, &pData);
  }
  dword_1C03227D8 = CLegacyRotationMgr::QueryAutoRotationRegistrySetting(
                      v2,
                      L"SlateEnable",
                      1u,
                      L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\CurrentVersion\\AutoRotation");
  AutoRotationRegistrySetting = CLegacyRotationMgr::QueryAutoRotationRegistrySetting(
                                  ...
                                  0,
                                  L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\CurrentVersion\\AutoRotation");
  dword_1C03227AC = AutoRotationRegistrySetting == 1;
  ...
  if ( v9 > 3 )
    v9 = 0;
  dword_1C03227A4 = v9;
  dword_1C03227B8 = IsNativeOrientationPortrait();
  dword_1C03227BC = 0;
