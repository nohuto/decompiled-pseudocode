/*
 * XREFs of cParseFontResources @ 0x1C00BC6A4
 * Callers:
 ...
 * Callees:
 *     pvFindResource @ 0x1C00EC520 (pvFindResource.c)
 */
...
__int64 __fastcall cParseFontResources(__int64 a1, _QWORD *a2, _QWORD *a3, PVOID *a4)
{
  ...
  __int64 *v15; // rcx
  char v16[8]; // [rsp+48h] [rbp-60h] BYREF
    ...
    if ( v11 )
    {
      ...
      for ( i = 0; ; ++i )
      {
        ...
        Resource = pvFindResource(
                     (unsigned int)*(_QWORD *)(a1 + 16) + 1,
                     (unsigned int)*(_QWORD *)(a1 + 16) + *(_DWORD *)(a1 + 24),
                     *v12,
                     8,
                     (__int64)v16);
        v15 = v18;
