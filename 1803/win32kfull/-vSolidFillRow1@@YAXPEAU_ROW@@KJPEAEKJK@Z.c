/*
 * XREFs of ?vSolidFillRow1@@YAXPEAU_ROW@@KJPEAEKJK@Z @ 0x1C00EFE90
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        char a7)
{
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      v18 = ~*((_DWORD *)&aulMsk + v17);
      v19 = v18 & *((_DWORD *)&aulMsk + v15);
      if ( (_DWORD)v14 != (_DWORD)v16 )
      {
        v19 = *((_DWORD *)&aulMsk + v15);
        if ( !(_DWORD)v15 )
          goto LABEL_5;
      }
      *(_DWORD *)&v10[4 * v14] = a5 & v19 | *(_DWORD *)&v10[4 * v14] & ~v19;
      if ( (_DWORD)v14 != (_DWORD)v16 )
        break;
LABEL_13:
