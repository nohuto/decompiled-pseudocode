/*
 * XREFs of NtUserLogicalToPhysicalPoint @ 0x1C00F6010
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserLogicalToPhysicalPoint(__int64 a1, __int64 *a2)
{
  ...
  if ( v9 )
  {
    ...
    v17 = *v10;
    if ( (*(_BYTE *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), (__int64)v5) + 472) + 224LL) & 1) != 0
      || (v13 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v11) + 472),
