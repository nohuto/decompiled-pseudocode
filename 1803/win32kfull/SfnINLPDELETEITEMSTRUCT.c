/*
 * XREFs of SfnINLPDELETEITEMSTRUCT @ 0x1C01DAD40
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  __int64 *v24; // rcx
  __int64 result; // rax
  __int128 v26; // [rsp+40h] [rbp-E8h]
  __int64 v27; // [rsp+50h] [rbp-D8h]
  __int64 v28; // [rsp+60h] [rbp-C8h] BYREF
  volatile signed __int32 *v29; // [rsp+68h] [rbp-C0h]
  __int64 v30; // [rsp+70h] [rbp-B8h]
  __int64 v31; // [rsp+78h] [rbp-B0h]
  _QWORD v32[17]; // [rsp+A0h] [rbp-88h] BYREF
  char v33; // [rsp+130h] [rbp+8h] BYREF
  char v34; // [rsp+138h] [rbp+10h] BYREF
  int v35; // [rsp+140h] [rbp+18h] BYREF
  unsigned __int64 v36; // [rsp+148h] [rbp+20h] BYREF
