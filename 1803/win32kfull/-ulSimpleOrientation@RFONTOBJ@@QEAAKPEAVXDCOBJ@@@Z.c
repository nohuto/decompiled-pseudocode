/*
 * XREFs of ?ulSimpleOrientation@RFONTOBJ@@QEAAKPEAVXDCOBJ@@@Z @ 0x1C00851D0
 * Callers:
...
__int64 __fastcall RFONTOBJ::ulSimpleOrientation(RFONTOBJ *this, struct XDCOBJ *a2)
{
  ...
  v2 = 0;
  v3 = (*(float *)(*(_QWORD *)this + 384LL) > 0.0) - (*(float *)(*(_QWORD *)this + 384LL) < 0.0);
  v4 = (__PAIR64__(*(float *)(*(_QWORD *)this + 388LL) > 0.0, *(_DWORD *)(*(_QWORD *)this + 388LL))
