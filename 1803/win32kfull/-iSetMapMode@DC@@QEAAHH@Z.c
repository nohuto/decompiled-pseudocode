/*
 * XREFs of ?iSetMapMode@DC@@QEAAHH@Z @ 0x1C008AD3C
 * Callers:
 ...
 *     ?vComputePageXform@DC@@QEAAXXZ @ 0x1C011D4EC (-vComputePageXform@DC@@QEAAXXZ.c)
...
__int64 __fastcall DC::iSetMapMode(DC *this, int a2)
{
  ...
  if ( a2 == 1 )
  {
    ...
    *(_DWORD *)(*((_QWORD *)this + 10) + 292LL) = ef16;
    v7 = *((_QWORD *)this + 10);
    *((_DWORD *)this + 109) = ef16;
    *(_DWORD *)(v7 + 296) = ef16;
    *((_DWORD *)this + 110) = ef16;
    *((_DWORD *)this + 82) = ef16;
    v8 = *((_QWORD *)this + 10);
    *((_DWORD *)this + 85) = ef16;
    *((_DWORD *)this + 90) = 11;
    *(_OWORD *)(v8 + 184) = *(_OWORD *)((char *)this + 328);
    *(_OWORD *)(v8 + 200) = *(_OWORD *)((char *)this + 344);
    *(_DWORD *)(v8 + 216) = *((_DWORD *)this + 90);
  ...
  if ( !v10 )
  {
    ...
    *(_DWORD *)(*((_QWORD *)this + 10) + 344LL) = v11[536];
    *(_DWORD *)(*((_QWORD *)this + 10) + 348LL) = -v11[537];
    switch ( a2 )
    {
      case 2:
        *(_DWORD *)(*((_QWORD *)this + 10) + 328LL) = (v11[534] + 50) / 0x64u;
        v19 = (v11[535] + 50) / 0x64u;
        break;
      case 3:
        *(_DWORD *)(*((_QWORD *)this + 10) + 328LL) = (v11[534] + 5) / 0xAu;
        v19 = (v11[535] + 5) / 0xAu;
        break;
      case 4:
        *(_DWORD *)(*((_QWORD *)this + 10) + 328LL) = (v11[534] + 127) / 0xFEu;
        v12 = (v11[535] + 127) / 0xFEu;
LABEL_20:
...
LABEL_23:
        ...
        goto LABEL_7;
      case 5:
        *(_DWORD *)(*((_QWORD *)this + 10) + 328LL) = EngMulDiv(v11[534], 10, 254);
        v12 = EngMulDiv(v11[535], 10, 254);
        goto LABEL_20;
      case 6:
        *(_DWORD *)(*((_QWORD *)this + 10) + 328LL) = EngMulDiv(v11[534], 144, 2540);
        *(_DWORD *)(*((_QWORD *)this + 10) + 332LL) = EngMulDiv(v11[535], 144, 2540);
        if ( *((float *)this + 113) == 0.0 )
        {
          DC::vComputePageXform(this);
          v13 = *((_DWORD *)this + 110);
          *((_DWORD *)this + 113) = *((_DWORD *)this + 109);
          *((_DWORD *)this + 114) = v13;
        }
        ...
        *(_DWORD *)(v15 + 296) = v16;
        v17 = *((_QWORD *)this + 10);
        *((_DWORD *)this + 82) = *((_DWORD *)this + 113);
        *((_DWORD *)this + 85) = *((_DWORD *)this + 114);
        *((_DWORD *)this + 90) = 9;
        v18 = *(_OWORD *)((char *)this + 328);
        *((_DWORD *)this + 110) = v16;
        *(_OWORD *)(v17 + 184) = v18;
        *(_OWORD *)(v17 + 200) = *(_OWORD *)((char *)this + 344);
        *(_DWORD *)(v17 + 216) = *((_DWORD *)this + 90);
        *(_DWORD *)(*((_QWORD *)this + 10) + 352LL) |= 0x22D0u;
        *(_DWORD *)(*((_QWORD *)this + 10) + 352LL) &= 0xFFFFE2FF;
        goto LABEL_23;
      case 7:
        *(_DWORD *)(*((_QWORD *)this + 10) + 328LL) = (v11[534] + 50) / 0x64u;
        *(_DWORD *)(*((_QWORD *)this + 10) + 332LL) = (v11[535] + 50) / 0x64u;
        *(_DWORD *)(*((_QWORD *)this + 10) + 352LL) &= 0xFFFFF7BF;
        *(_DWORD *)(*((_QWORD *)this + 10) + 352LL) |= 0x400u;
        goto LABEL_22;
      default:
