/*
 * XREFs of ?BmpDevNineGrid@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAUNINEGRID@@PEAU_BLENDOBJ@@PEAX@Z @ 0x1C0269F40
 * Callers:
 *     <none>
 * Callees:
        ...
        void *a9)
{
  ...
  if ( a1 )
  {
    v13 = EngNineGrid(a1, (__int64)a2, (__int64)a3, (__int64)a4, (__int64)a5, (__int64)a6, (__int64)a7, (int *)a8);
    HDEV = UserGetHDEV();
    if ( HDEV )
    {
      if ( (*(_DWORD *)(HDEV + 40) & 0x20000000) != 0 )
      {
        for ( i = **(struct _DISPSURF ***)(HDEV + 1792); i; i = *(struct _DISPSURF **)i )
        {
          v16 = *((_QWORD *)i + 6);
          v23 = v16;
          if ( v16 )
          {
            if ( (*(_DWORD *)(v16 + 1816) & 0x8000000) != 0 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v16 + 1784) + 792LL) )
                {
