/*
 * XREFs of GreGetCharSet @ 0x1C008138C
 * Callers:
 *     NtGdiGetCharSet @ 0x1C00811D0 (NtGdiGetCharSet.c)
...
__int64 __fastcall GreGetCharSet(HDC a1)
{
  ...
  _QWORD *v8; // [rsp+40h] [rbp-10h] BYREF
  ...
  if ( (*(_DWORD *)(v8[10] + 8LL) & 0x10) != 0 )
  {
    ...
    LFONTOBJ::LFONTOBJ((LFONTOBJ *)&v6, *(struct HLFONT__ **)(v1[10] + 176LL), (struct PDEVOBJ *)&v11);
    v5 = v6;
    if ( v6 )
    {
