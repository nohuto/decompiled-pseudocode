/*
 * XREFs of EngStretchBltROP @ 0x1C009FBB0
 * Callers:
...
LABEL_30:
  ...
  v20 = v18 & 2;
  if ( v20 )
    v21 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, RECTL *, RECTL *, POINTL *, ULONG))(v19 + 2840);
  else
    v21 = EngStretchBlt;
  v22 = 0LL;
  if ( v20 && (*(_DWORD *)(v19 + 40) & 0x20000) == 0 )
  {
    if ( iMode == 4 && (*(_BYTE *)(v19 + 1816) & 0x10) == 0 )
      v21 = EngStretchBlt;
