/*
 * XREFs of GreSetBoundsRect @ 0x1C00F3CFC
 * Callers:
...
__int64 __fastcall GreSetBoundsRect(HDC a1, struct _POINTL *a2, __int16 a3)
{
  ...
  v5 = 0;
  MDCOBJ::MDCOBJ((MDCOBJ *)v37, a1);
  if ( !v37[0] )
    return v5;
  v6 = 0;
  if ( a3 < 0 )
  {
    v7 = (struct tagRECT *)(v37[0] + 1472LL);
    v8 = 32;
  }
  else if ( (a3 & 0x4000) != 0 )
  {
    v7 = (struct tagRECT *)(v37[0] + 1488LL);
    v8 = 64;
  }
  else
  {
    v7 = (struct tagRECT *)(v37[0] + 1504LL);
    v8 = 128;
  }
  v9 = IsRectEmptyInl(v7);
  v5 = v11 | (v12 != 0 ? 4 : 8) | (v9 ? 1 : 3);
  if ( (a3 & 1) != 0 )
  {
    v7->top = 0x7FFFFFFF;
    v7->left = 0x7FFFFFFF;
