/*
 * XREFs of ?DoHideInkCursorStop@HideInkCursorProvider@@AEAAJPEBUIFC_HIDE_INK_CURSOR_STOP_DATA@@@Z @ 0x1C020D960
 * Callers:
 ...
 *     ?TerminateActiveCommand@HideInkCursorProvider@@UEAAXPEAVActiveCommand@InkFeedbackProviderBase@@@Z @ 0x1C020E610 (-TerminateActiveCommand@HideInkCursorProvider@@UEAAXPEAVActiveCommand@InkFeedbackProviderBase@@@.c)
 * Callees:
        ...
        const struct IFC_HIDE_INK_CURSOR_STOP_DATA *a2)
{
  ...
  if ( (unsigned int)pRelatedActivityId > 4 )
  {
    ...
    v19 = v6;
    v20 = 4LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3BB8, v7, v6, 7u, &pData);
  }
  return 0LL;
}
