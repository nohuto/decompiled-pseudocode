/*
 * XREFs of ?ExtractReportUsages@@YAJW4_HIDP_REPORT_TYPE@@PEAU_HIDP_PREPARSED_DATA@@PEBUUsageValueInfo@@IPEBXKPEAUUsageValue@@@Z @ 0x1C0204794
 * Callers:
...
LABEL_5:
  ...
  if ( (unsigned int)pRelatedActivityId > 2 )
  {
    ...
    v18 = &v16;
    v19 = 4;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E36AF, v13, v14, 3u, &pData);
  }
  return v8;
}
