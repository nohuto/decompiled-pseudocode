/*
 * XREFs of _ChangeWindowMessageFilterEx @ 0x1C0061E4C
 * Callers:
 ...
 *     ?AddMessageToFilter@@YAHPEAPEAPEAXIPEAH@Z @ 0x1C0062224 (-AddMessageToFilter@@YAHPEAPEAPEAXIPEAH@Z.c)
 *     ?IsMessageAlwaysAllowedAcrossIL@@YAHI@Z @ 0x1C0062410 (-IsMessageAlwaysAllowedAcrossIL@@YAHI@Z.c)
 *     ?RemoveMessageFromFilter@@YAHPEAPEAPEAXIPEAH@Z @ 0x1C0062E40 (-RemoveMessageFromFilter@@YAHPEAPEAPEAXIPEAH@Z.c)
  ...
  if ( gbEnforceUIPI )
  {
    ...
    if ( a3 )
    {
      ...
      else
      {
        ...
        if ( v4 )
        {
          if ( (unsigned int)IsMessageAllowedByFilterEx(*((void *const **)v10 + 105), a2, 0LL, 0LL)
      ...
      if ( v14 != v19[0] )
      {
        v17 = (struct tagVWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 416LL) + 848LL);
        if ( v19[0] )
