/*
 * XREFs of _GetTouchValidationStatus @ 0x1C01AA538
 * Callers:
...
__int64 __fastcall GetTouchValidationStatus(__int64 a1)
{
  ...
  while ( 1 )
  {
    if ( *((_BYTE *)DeviceList + 48) != 2 )
      goto LABEL_14;
    if ( (*((_DWORD *)DeviceList + 46) & 0x1000) != 0 )
      goto LABEL_14;
    v6 = *((_QWORD *)DeviceList + 58);
    if ( *(_WORD *)(v6 + 42) != 13 || *(_WORD *)(v6 + 40) != 4 )
      goto LABEL_14;
    if ( (*(_DWORD *)(*((_QWORD *)DeviceList + 60) + 276LL) & 0x400) != 0 )
      break;
    v1 = 2;
LABEL_14:
