/*
 * XREFs of ?AdjustProcessPriorityForDrag@@YAXPEAU_MOVESIZEDATA@@@Z @ 0x1C01C0140
 * Callers:
 *     xxxMoveSize @ 0x1C01C7C58 (xxxMoveSize.c)
 * Callees:
 *     SetForegroundPriority @ 0x1C005FD30 (SetForegroundPriority.c)
 *     ?IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z @ 0x1C01C0F20 (-IsDraggingForegroundModernApp@@YAHPEAUtagWND@@@Z.c)
 */
...
void __fastcall AdjustProcessPriorityForDrag(struct _MOVESIZEDATA *a1)
{
  ...
  if ( (v3 & 0x100000) != 0 )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v4 + 416) + 812LL) & 0x30000) == 0
      && (*(_DWORD *)(*(_QWORD *)(gptiForeground + 416LL) + 812LL) & 0x30000) != 0 )
    {
      v5 = 1;
LABEL_8:
