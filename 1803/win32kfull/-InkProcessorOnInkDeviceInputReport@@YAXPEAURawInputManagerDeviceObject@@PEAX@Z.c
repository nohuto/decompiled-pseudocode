/*
 * XREFs of ?InkProcessorOnInkDeviceInputReport@@YAXPEAURawInputManagerDeviceObject@@PEAX@Z @ 0x1C01D41EC
 * Callers:
        ...
        const GUID *a4)
{
  ...
  else if ( (unsigned int)pRelatedActivityId > 2 )
  {
    ...
    v7 = 4;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E36AF, a3, a4, 3u, &v5);
  }
}
