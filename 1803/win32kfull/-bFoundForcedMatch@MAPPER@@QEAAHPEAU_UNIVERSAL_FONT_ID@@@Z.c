/*
 * XREFs of ?bFoundForcedMatch@MAPPER@@QEAAHPEAU_UNIVERSAL_FONT_ID@@@Z @ 0x1C0119970
 * Callers:
    ...
    else
    {
      ...
      else
      {
        if ( (unsigned int)SafeDivide<unsigned long,unsigned long,unsigned long>(
                             ...
                             *((_DWORD *)this + 61),
                             (int *)&v30)
          || (unsigned int)SafeDivide<long,long,long>(100 * v26, v27, &v32)
          || (unsigned int)SafeDivide<long,long,long>(v32, *((_DWORD *)this + 49), (int *)&v31) )
        {
          return v2;
        }
