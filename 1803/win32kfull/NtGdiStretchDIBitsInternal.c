/*
 * XREFs of NtGdiStretchDIBitsInternal @ 0x1C00A0450
 * Callers:
 *     <none>
 * Callees:
...
LABEL_31:
  ...
  {
    v16 = (_DWORD *)AllocThreadBufferWithTag((unsigned int)Size, 1886221383LL, 0LL);
    if ( v16 )
    {
      ...
      if ( *v16 >= 0x28u
        && (unsigned int)Size >= *v16
        && (_DWORD)Size == (unsigned int)GreGetBitmapSizeInternal(v16, a12) )
      {
        v21 = a15;
        if ( (_DWORD)a15 )
        {
...
LABEL_24:
  if ( v17 )
  {
    v17 = GreStretchDIBitsInternal(a1, a5, a6, a7, a8, a9, v19, (__int64)v16, a12, a13, v20, v21, a16);
    if ( v18 )
