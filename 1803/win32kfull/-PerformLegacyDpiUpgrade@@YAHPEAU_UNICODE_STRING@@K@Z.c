/*
 * XREFs of ?PerformLegacyDpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x1C004E970
 * Callers:
 *     xxxUpdatePerUserSystemParameters @ 0x1C0050D10 (xxxUpdatePerUserSystemParameters.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0139660 (__security_check_cookie.c)
 *     ?PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x1C01A24E0 (-PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z.c)
 */
...
__int64 __fastcall PerformLegacyDpiUpgrade(struct _UNICODE_STRING *a1, unsigned int a2)
{
  ...
  v11 = 0LL;
  v12 = 0;
  FastGetProfileDword(a1, 4LL, L"Win8DpiScaling", 0xFFFFLL, (char *)&v11 + 4);
  FastGetProfileDword(a1, 4LL, L"DpiScalingVer", 0LL, &v9);
  LODWORD(v11) = v9;
  if ( v9 == 4096 )
  {
    if ( HIDWORD(v11) )
