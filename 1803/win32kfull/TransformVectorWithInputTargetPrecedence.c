/*
 * XREFs of TransformVectorWithInputTargetPrecedence @ 0x1C00F94D4
 * Callers:
 ...
 *     EditionGetLogicalPointForMouseCaptureButtonEvent @ 0x1C00F9460 (EditionGetLogicalPointForMouseCaptureButtonEvent.c)
 * Callees:
