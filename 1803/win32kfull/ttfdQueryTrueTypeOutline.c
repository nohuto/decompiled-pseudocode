/*
 * XREFs of ttfdQueryTrueTypeOutline @ 0x1C021E074
 * Callers:
        ...
        _WORD *a6)
{
  ...
  if ( (a3 & 2) != 0 )
  {
    ...
    if ( !QuadTrueTypeOutline || QuadTrueTypeOutline == -1 )
    {
      return QuadTrueTypeOutline;
    }
    else
    {
      v13 = (unsigned int *)EngAllocMem(0, QuadTrueTypeOutline, 0x64667454u);
      v14 = v13;
      if ( v13 )
      {
