/*
 * XREFs of xxxSendMinRectMessages @ 0x1C0102848
 * Callers:
...
__int64 __fastcall xxxSendMinRectMessages(HWND *a1, __int64 a2)
{
  unsigned int v2; // esi
  HWND v4; // rbp
  _QWORD *v5; // r14
  ...
  _QWORD v17[3]; // [rsp+68h] [rbp-40h] BYREF
  ...
  if ( ((*(_DWORD *)(gptiCurrent + 672LL) | *(_DWORD *)(*v5 + 16LL)) & 0x800) != 0 )
  {
    xxxCallHook(5, (unsigned __int64)v4, a2, 10);
    v5 = *(_QWORD **)(gptiCurrent + 456LL);
    v2 = 1;
  }
  if ( v5[30] )
  {
    PushW32ThreadLock(*(_QWORD *)(gptiCurrent + 448LL), v17, UserDereferenceObject);
    v6 = *(void **)(gptiCurrent + 448LL);
    if ( v6 )
...
LABEL_19:
      if ( !v8 )
      {
        PopAndFreeW32ThreadLock((__int64)v17, (__int64)v9);
        return v2;
      }
