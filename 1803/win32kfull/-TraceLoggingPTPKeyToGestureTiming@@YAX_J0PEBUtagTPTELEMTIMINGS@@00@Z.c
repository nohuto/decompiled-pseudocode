/*
 * XREFs of ?TraceLoggingPTPKeyToGestureTiming@@YAX_J0PEBUtagTPTELEMTIMINGS@@00@Z @ 0x1C01992AC
 * Callers:
        ...
        LPCGUID pActivityId)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000000uLL) )
    {
      ...
      v52 = &v23;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E2737, pActivityId, v6, 0xCu, &pData);
    }
  }
}
