/*
 * XREFs of ??0RESETFCOBJ@@QEAA@AEAVDCOBJ@@AEAVRFONTOBJ@@PEAU_MAT2@@HK@Z @ 0x1C0077664
 * Callers:
  ...
  *((_DWORD *)this + 1) = v6;
  ...
  if ( !*((_DWORD *)this + 1) )
  {
    ...
    *((float *)v24[0] + 3) = eM22;
    ...
    EXFORMOBJ::EXFORMOBJ((EXFORMOBJ *)v23, (struct MATRIX *)v29, 8u);
    EXFORMOBJ::EXFORMOBJ((EXFORMOBJ *)v25, (struct MATRIX *)v30, 8u);
    if ( a5 )
    {
      v17 = *(_QWORD *)a3;
      v22 = 0LL;
      v26 = *(PFEOBJ **)(*(_QWORD *)(v17 + 104) + 32LL);
