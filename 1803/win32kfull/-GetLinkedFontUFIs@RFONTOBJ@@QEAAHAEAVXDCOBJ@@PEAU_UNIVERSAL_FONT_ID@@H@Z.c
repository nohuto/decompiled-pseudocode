/*
 * XREFs of ?GetLinkedFontUFIs@RFONTOBJ@@QEAAHAEAVXDCOBJ@@PEAU_UNIVERSAL_FONT_ID@@H@Z @ 0x1C01280D0
 * Callers:
        ...
        int a4)
{
  ...
  {
    if ( !*(_QWORD *)(v7 + 704) && !(unsigned int)RFONTOBJ::bInitSystemTT(this, a2) )
      return 0LL;
    *(_DWORD *)(*(_QWORD *)this + 696LL) |= 0x100u;
    v7 = *(_QWORD *)this;
  }
  v8 = *(_QWORD *)(v7 + 704);
  if ( v8 )
