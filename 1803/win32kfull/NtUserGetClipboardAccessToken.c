/*
 * XREFs of NtUserGetClipboardAccessToken @ 0x1C01EDE40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetClipboardAccessToken(_QWORD *a1, ACCESS_MASK a2)
{
  ...
  Handle = 0LL;
  EnterCrit(0LL, 1LL);
  if ( gbEnforceUIPI && (unsigned int)*(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 872LL) < 0x2000
    || (v10 = *(void **)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 448LL) + 40LL) + 128LL)) == 0LL )
  {
