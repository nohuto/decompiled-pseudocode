/*
 * XREFs of ?InProcessDeviceTypeRequestTable@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z @ 0x1C005A118
 * Callers:
  ...
  if ( result )
  {
    if ( v5 != result )
    {
      ...
      if ( *(struct tagPROCESS_HID_REQUEST **)(*(_QWORD *)result + 8LL) != result
        || (v10 = (struct tagPROCESS_HID_REQUEST **)*((_QWORD *)result + 1), *v10 != result) )
      {
        __fastfail(3u);
      }
