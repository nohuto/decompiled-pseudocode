/*
 * XREFs of ?AddSelfAndOwnees@@YAPEAUtagSMWP@@PEAU1@PEAUtagWND@@11HI@Z @ 0x1C006F958
 * Callers:
        ...
        unsigned int a6)
{
  ...
  while ( 1 )
  {
    OwnedWindow = NextOwnedWindow(v8, v6, *((_QWORD *)v6 + 10));
    ...
    if ( !v18 )
    {
      if ( v11 )
      {
        if ( v11 != (struct tagWND *)1 )
        {
          ...
          {
            OwnedWindow = *(_QWORD *)(OwnedWindow + 64);
            if ( !OwnedWindow )
              goto LABEL_23;
          }
        }
...
LABEL_10:
  ...
  v12 = _DeferWindowPos((__int64)v10, a2, 0LL, 0, 0, 0, 0, a6 | 0x13, 0);
  v13 = v12;
  if ( !v12 )
    return 0LL;
  v14 = *(_DWORD *)(v12 + 28) - 1;
