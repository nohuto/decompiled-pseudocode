/*
 * XREFs of _RegisterUserApiHook @ 0x1C00D6CA4
 * Callers:
...
__int64 __fastcall RegisterUserApiHook(__int64 a1, __int64 a2, __int64 a3, unsigned int *a4)
{
  unsigned int *v6; // rbx
  __int64 v8; // rcx
  __int64 v9; // rcx
  ...
  if ( gihmodUserApiHook >= 0
    ...
    || (v9 = *(unsigned int *)(PsGetCurrentProcessWin32Process(v8) + 772), (_DWORD)v9 != luidSystem[0])
  ...
  if ( v13 < MmUserProbeAddress && (unsigned __int16)v11 <= HIWORD(v25) )
  {
    if ( (v11 & 1) != 0 )
    {
LABEL_15:
...
LABEL_34:
  ...
  if ( v21 != -1 )
  {
    ...
    gppiUserApiHook = PsGetCurrentProcessWin32Process(v23);
    *gpsi |= 0x10u;
    return 1LL;
  }
  UserSetLastError(126LL, v22);
