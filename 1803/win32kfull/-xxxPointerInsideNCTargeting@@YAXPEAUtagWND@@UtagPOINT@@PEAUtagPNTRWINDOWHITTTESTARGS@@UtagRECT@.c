/*
 * XREFs of ?xxxPointerInsideNCTargeting@@YAXPEAUtagWND@@UtagPOINT@@PEAUtagPNTRWINDOWHITTTESTARGS@@UtagRECT@@K@Z @ 0x1C01CA07C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  unsigned __int64 v38; // [rsp+98h] [rbp-41h]
  __int64 v39; // [rsp+A0h] [rbp-39h]
  struct tagRECT v40; // [rsp+A8h] [rbp-31h] BYREF
  ...
  *(_DWORD *)&v32[2] = v7[29];
  ...
  v16 = 0x7FFFFFFF;
  v17 = 0x7FFFFFFF;
  v39 = 1000LL * v8 / *(int *)(v15 + 184);
  v38 = v39 + 0x80000000LL;
  if ( (unsigned __int64)(v39 + 0x80000000LL) <= 0xFFFFFFFF )
    v17 = v39;
  ...
  else if ( v38 <= 0xFFFFFFFF )
  {
    v16 = v39;
  }
  v20 = v37;
  v21 = (v8 << 16) + 3;
  _TTCheckNCTarget(&v37, a1, a3, a4, v32, &v33, &v40, v21);
  v22 = v35;
  _TTCheckNCTarget(&v35, a1, a3, v36, v32, &v33, &v40, v21);
  v23 = *((_QWORD *)a1 + 5);
  v34[0].x = *(_DWORD *)(v23 + 112);
  *(struct tagPOINT *)&v34[0].y = *(struct tagPOINT *)(v23 + 92);
  v34[1].y = *(_DWORD *)(v23 + 116) - 1;
  v35 = *(struct tagRECT *)&v34[0].x;
  if ( (unsigned int)_TTCheckNCTarget(&v35, a1, a3, v36, v32, &v33, &v40, v21) )
  {
  ...
  if ( v32[0] < 0xFFDu )
  {
    ...
    *(_DWORD *)&v32[2] = 0;
    ...
    if ( *(_DWORD *)&v32[2] <= 0x11u )
    {
      ...
      {
        v35 = *v36;
        _TTUpdateBestTarget(a3, a1, v32[0], &v33, &v40, 0, &v35, v21);
        *((_DWORD *)a3 + 8) = v30;
      }
    }
  }
