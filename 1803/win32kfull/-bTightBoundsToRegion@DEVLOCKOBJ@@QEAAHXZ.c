/*
 * XREFs of ?bTightBoundsToRegion@DEVLOCKOBJ@@QEAAHXZ @ 0x1C013933C
 * Callers:
        ...
        if ( *(_DWORD *)(v1 + 496) )
        {
          ...
          if ( !ERECTL::bEmpty((ERECTL *)&v13) )
          {
            ...
            if ( v10 )
            {
              ...
              v6 = (_DWORD *)(*((_QWORD *)this + 4) + 1488LL);
              *v6 = 0;
              v6[1] = 0;
              v6[2] = 0;
              v6[3] = 0;
              if ( v5 )
              {
                ...
                v7 = *(_QWORD *)(*((_QWORD *)this + 4) + 1576LL);
                v9 = v7;
                if ( v12[0]
                  && v7
                  && RGNOBJ::bMerge((RGNOBJ *)v12, (struct RGNOBJ *)&v9, (struct RGNOBJ *)&v10, BYTE2(gafjRgnOp)) )
                {
                  ...
                  v3 = 1;
                  *(_QWORD *)(*((_QWORD *)this + 4) + 1576LL) = v9;
                }
                RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v12);
              }
              else
              {
                *(_QWORD *)(*((_QWORD *)this + 4) + 1576LL) = v10;
                v10 = 0LL;
                v3 = 1;
              }
            }
