/*
 * XREFs of ?FreeAll@CLeakTrackingAllocator@NSInstrumentation@@QEAAXXZ @ 0x1C02AE1B4
 * Callers:
 *     UninitializeWin32PoolTracking @ 0x1C0106060 (UninitializeWin32PoolTracking.c)
 * Callees:
