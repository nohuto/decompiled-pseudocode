/*
 * XREFs of xxxPointerWindowHitTest @ 0x1C01CC520
 * Callers:
 ...
 *     ?TTSqm@@YAXUtagPOINT@@PEBUtagTOUCHTARGETINGCONTACT@@@Z @ 0x1C01C94FC (-TTSqm@@YAXUtagPOINT@@PEBUtagTOUCHTARGETINGCONTACT@@@Z.c)
    ...
    if ( v14 )
    {
      ...
      if ( v16 )
      {
        ...
        *(_QWORD *)&v39.left = v22;
        ...
        xxxWindowHitTestWithTargeting((__int64)a2, a6, v16, &v31, 0);
        if ( *(_DWORD *)(v16 + 180) )
        {
