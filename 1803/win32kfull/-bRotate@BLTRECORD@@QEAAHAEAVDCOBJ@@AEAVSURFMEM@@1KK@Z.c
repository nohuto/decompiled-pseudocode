/*
 * XREFs of ?bRotate@BLTRECORD@@QEAAHAEAVDCOBJ@@AEAVSURFMEM@@1KK@Z @ 0x1C025C970
 * Callers:
        ...
        ULONG iMode)
{
  ...
  if ( (a5 & 0x10000) == 0 || (result = BLTRECORD::bRotate((BLTRECORD *)this, a4, iMode), (_DWORD)result) )
  {
    ...
    if ( *(_QWORD *)a3 )
    {
      ...
      this[11].left += *(_DWORD *)(*(_QWORD *)a2 + 8 * v17 + 1424);
      this[11].right += *(_DWORD *)(v16 + 8 * v17 + 1424);
      this[11].top += *(_DWORD *)(v16 + 8 * v17 + 1428);
      this[11].bottom += *(_DWORD *)(v16 + 8 * v17 + 1428);
      if ( EngPlgBlt(
             ...
             iMode) )
      {
        ...
        *(_QWORD *)&this[4].right = *(_QWORD *)a3;
        this[11].left = -*(_DWORD *)(*(_QWORD *)a2 + 8LL * (*(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1) + 1424);
        v18 = HIDWORD(v22[0]);
        this[11].top = -*(_DWORD *)(*(_QWORD *)a2 + 8LL * (*(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1) + 1428);
        this[11].right = v18 - *(_DWORD *)(*(_QWORD *)a2 + 8LL * (*(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1) + 1424);
        this[11].bottom = LODWORD(v22[1])
                        - *(_DWORD *)(*(_QWORD *)a2 + 8LL * (*(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1) + 1428);
      }
    }
    return v6;
  }
