/*
 * XREFs of NtGdiBRUSHOBJ_pvAllocRbrush @ 0x1C0282600
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?BRUSHOBJ_pvAllocRbrushUMPD@@YAPEAXPEAU_BRUSHOBJ@@K@Z @ 0x1C023A46C (-BRUSHOBJ_pvAllocRbrushUMPD@@YAPEAXPEAU_BRUSHOBJ@@K@Z.c)
 */
...
PVOID __fastcall NtGdiBRUSHOBJ_pvAllocRbrush(__int64 a1, __int64 a2)
{
  ...
  {
    result = BRUSHOBJ_pvAllocRbrushUMPD(v7, v3);
  }
  else
  {
    result = 0LL;
