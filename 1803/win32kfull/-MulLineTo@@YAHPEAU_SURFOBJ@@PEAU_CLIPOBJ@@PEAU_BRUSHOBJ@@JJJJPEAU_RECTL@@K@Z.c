/*
 * XREFs of ?MulLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x1C02738A0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v20[0] )
  {
    for ( i = MSURF::bFindSurface((MSURF *)v21, a1, a2, a8); i; i = MSURF::bNextSurface((MSURF *)v21) )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 112) & 0x100) != 0 )
        v17 = *(BOOL (__stdcall **)(SURFOBJ *, CLIPOBJ *, BRUSHOBJ *, LONG, LONG, LONG, LONG, RECTL *, MIX))(*((_QWORD *)v22 + 7) + 2928LL);
      else
        v17 = EngLineTo;
      v13 &= OffLineTo(
