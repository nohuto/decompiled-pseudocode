/*
 * XREFs of ?pSpConvertSpriteFromMeta@@YAPEAVSPRITE@@PEAUHDEV__@@0PEAU_METASPRITE@@@Z @ 0x1C024FEE0
 * Callers:
...
struct SPRITE *__fastcall pSpConvertSpriteFromMeta(HDEV a1, _QWORD *a2, struct _METASPRITE *a3)
{
  ...
  if ( *(_QWORD *)a3 )
  {
    ...
    if ( v8 )
    {
      ...
      do
      {
        if ( *(_QWORD *)v11 && v10 < *(_DWORD *)(**(_QWORD **)(*(_QWORD *)v11 + 16LL) + 2100LL) )
        {
          v9 = *(int **)v11;
          v10 = *(_DWORD *)(**(_QWORD **)(*(_QWORD *)v11 + 16LL) + 2100LL);
        }
        v11 += 8;
        --v12;
      }
      ...
      if ( v9 )
      {
        ...
        if ( Sprite )
        {
          ...
          *((_QWORD *)v9 + 24) = 0LL;
          v15 = *v14;
          v21.x = v9[28] + *(_DWORD *)(*v14 + 2576);
          v21.y = v9[29] + *(_DWORD *)(v15 + 2580);
          ...
          if ( v7 )
          {
            ...
            if ( (*v9 & 0x40) != 0 )
            {
              pSpHintSpriteShape(v7, *((HBITMAP *)v9 + 30), 0);
              v16 = *v9;
            }
            if ( (v16 & 0x100) != 0 )
            {
