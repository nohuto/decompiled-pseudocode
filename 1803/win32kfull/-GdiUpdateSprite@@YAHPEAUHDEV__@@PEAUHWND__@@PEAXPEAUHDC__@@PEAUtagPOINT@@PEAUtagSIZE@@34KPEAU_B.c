/*
 * XREFs of ?GdiUpdateSprite@@YAHPEAUHDEV__@@PEAUHWND__@@PEAXPEAUHDC__@@PEAUtagPOINT@@PEAUtagSIZE@@34KPEAU_BLENDFUNCTION@@KPEAUtagRECT@@@Z @ 0x1C024AF80
 * Callers:
        ...
        struct tagRECT *a12)
{
  ...
  v17 = v27;
  v18 = (const struct _SPRITESTATE *)(v27 + 20);
  if ( *((_DWORD *)v27 + 35) )
  {
    ...
    if ( MetaSprite )
    {
      ...
      if ( v19 )
      {
        do
        {
          ...
          {
            v22 = &v28;
            v28.x = a5->x - *(_DWORD *)(v23 + 2576);
            v28.y = a5->y - *(_DWORD *)(v23 + 2580);
          }
          updated &= bSpUpdateSprite(
                       *((struct SPRITE **)MetaSprite + v21 + 3),
                       v33,
                       v22,
                       v32,
                       v31,
