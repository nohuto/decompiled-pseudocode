/*
 * XREFs of ?CreateAndSendSuperWetInkPayloadForCommand@InkDevice@@EEAAJW4INK_FEEDBACK_COMMAND@@PEBXIM@Z @ 0x1C020E890
 * Callers:
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( v9 >= 0 )
      {
        if ( (unsigned int)pRelatedActivityId > 4 )
        {
          ...
          v35 = 2LL;
          v37 = 72LL;
          TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3E40, v14, v15, 9u, &v24);
        }
      }
