/*
 * XREFs of NtUserEnableMouseInputForCursorSuppression @ 0x1C0008340
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    ...
    v9 = 2LL;
    *(_DWORD *)(CurrentProcessWin32Process + 812) &= ~0x40000u;
LABEL_13:
...
LABEL_8:
  if ( !a1 )
  {
    v10 = PsGetCurrentProcessWin32Process(v6);
    v9 = 1LL;
    *(_DWORD *)(v10 + 812) |= 0x40000u;
    goto LABEL_13;
  }
LABEL_9:
  v5 = 1LL;
