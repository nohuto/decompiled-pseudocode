/*
 * XREFs of ?ulSimulateSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1C0276AC0
 * Callers:
...
__int64 __fastcall ulSimulateSaveScreenBits(struct _SURFOBJ *a1, int a2, SURFOBJ *a3, struct _RECTL *a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( a2 == 1 )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE(a1) + 112) & 0x400) != 0 )
        (*((void (__fastcall **)(struct _SURFOBJ *, SURFOBJ *, _QWORD, _QWORD, struct _RECTL *, _DWORD *))hdev + 354))(
          a1,
          a3,
          0LL,
          0LL,
  ...
  else
  {
    v8 = a4->right - a4->left;
    v9 = a4->bottom - a4->top;
    v10 = (__int64 (__fastcall *)(DHPDEV, unsigned __int64, _QWORD))*((_QWORD *)hdev + 345);
    if ( !v10
    ...
    if ( v12 )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE(v12) + 112) & 0x400) != 0 )
        (*((void (__fastcall **)(__int64, struct _SURFOBJ *, _QWORD, _QWORD, _DWORD *, struct _RECTL *))hdev + 354))(
          v13,
          a1,
          0LL,
          0LL,
