/*
 * XREFs of Win32UAFMAllocPoolWithQuotaImpl @ 0x1C01D3EE0
 * Callers:
 *     <none>
 * Callees:
 *     ?AllocateQuota@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAXW4_POOL_TYPE@@_KI@Z @ 0x1C0196AC8 (-AllocateQuota@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAXW4_POOL_TYPE@@_KI@Z.c)
 *     ?AdjustSize@?$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@CA_K_K@Z @ 0x1C01D365C (-AdjustSize@-$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@CA_K_K@Z.c)
...
__int64 __fastcall Win32UAFMAllocPoolWithQuotaImpl(__int64 a1, __int64 a2, unsigned int a3, _DWORD *a4)
{
  __int64 v5; // rbx
