/*
 * XREFs of SimBitBlt @ 0x1C0243FDC
 * Callers:
        ...
        DEVLOCKBLTOBJ *a12)
{
  ...
  *(_QWORD *)&v78.left = 0LL;
  ...
  v78.right = right;
  v78.bottom = bottom;
  if ( *(_DWORD *)(v15 + 96) == *(_DWORD *)(v19 + 2100) )
  {
    v67 = 0LL;
    v39 = EngCopyBits;
    v68 = 0;
...
LABEL_71:
      ...
      if ( (*(_DWORD *)(v41 + 112) & 0x400) != 0 )
        v43 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v40 + 2832);
      else
        v43 = EngCopyBits;
      v44 = 0LL;
      if ( v67 )
    ...
    if ( v58 )
    {
      ...
      if ( (*(_DWORD *)(v15 + 112) & 0x400) != 0 )
        v47 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v19 + 2832);
      else
        v47 = EngCopyBits;
      if ( v46 )
        v48 = v46 + 24;
      ...
      ++*(_DWORD *)(v15 + 92);
      if ( (*(_DWORD *)(v15 + 112) & 0x400) != 0 )
        v39 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v19 + 2832);
      if ( v58 )
        v18 = v58 + 24;
