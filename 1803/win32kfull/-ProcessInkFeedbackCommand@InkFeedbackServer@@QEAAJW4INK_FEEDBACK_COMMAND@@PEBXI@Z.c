/*
 * XREFs of ?ProcessInkFeedbackCommand@InkFeedbackServer@@QEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C020E34C
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)pRelatedActivityId > 4 )
  {
    ...
    v10[0] = a2;
    v20 = 1;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3AEB, a3, a4, 5u, &pData);
  }
  ...
  if ( (unsigned int)pRelatedActivityId > 2 )
  {
    ...
    v19 = v10;
    v20 = 1;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3AB0, a3, a4, 5u, &pData);
  }
  return 3221225473LL;
}
