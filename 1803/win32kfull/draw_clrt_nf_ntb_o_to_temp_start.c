/*
 * XREFs of draw_clrt_nf_ntb_o_to_temp_start @ 0x1C00AB890
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    do
    {
      ...
      do
      {
        ...
        if ( v19 )
        {
          v20 = v19;
          v21 = *result;
          v22 = LOBYTE(v16[v20]) + LOBYTE(v16[v21]);
          v23 = BYTE1(v16[v20]) + BYTE1(v16[v21]);
          v24 = BYTE2(v16[v20]) + BYTE2(v16[v21]);
          if ( v22 > 6 )
            v22 = 6;
          if ( v23 > 6 )
            v23 = 6;
          if ( v24 > 6 )
            v24 = 6;
          v19 = gajStorage1[49 * v22 + 7 * v23 + v24];
LABEL_8:
          *result = v19;
        }
        ++result;
