/*
 * XREFs of ?HandleIntObjUsageTelemetry@@YAXPEAURawInputManagerDeviceObject@@PEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYPE@@@Z @ 0x1C0212CA0
 * Callers:
 ...
 *     ?ProcessGetAppSessionGuid@@YA?AU_GUID@@PEAUtagPROCESSINFO@@@Z @ 0x1C0212FE4 (-ProcessGetAppSessionGuid@@YA-AU_GUID@@PEAUtagPROCESSINFO@@@Z.c)
 *     ?UpdateIntObjUsage@@YAXPEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYPE@@_K@Z @ 0x1C0213040 (-UpdateIntObjUsage@@YAXPEAUtagWND@@UtagINTERACTIVECTRL_INFO@@IW4tagINTERACTIVECTRL_PROMOTION_TYP.c)
 */
...
__int64 __fastcall HandleIntObjUsageTelemetry(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, unsigned int a5)
{
  ...
  *(_QWORD *)v27.Data4 = 0LL;
  if ( gptiForeground && (v12 = *(struct tagPROCESSINFO **)(gptiForeground + 416LL)) != 0LL )
  {
  ...
  if ( a2 && (v14 = *(struct tagPROCESSINFO **)(*(_QWORD *)(a2 + 16) + 416LL)) != 0LL )
  {
...
LABEL_16:
    ...
    if ( memcmp(&gIntObjTelemetryState, Buf2, 0x60uLL) )
    {
      ...
      {
        v18 = (dword_1C032FC4C & 2) != 0 ? (struct tagINTOBJTELEMETRYSTATE *)0x30 : 0LL;
