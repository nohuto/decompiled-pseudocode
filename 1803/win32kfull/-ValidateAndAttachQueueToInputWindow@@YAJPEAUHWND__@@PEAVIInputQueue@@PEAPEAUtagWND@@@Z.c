/*
 * XREFs of ?ValidateAndAttachQueueToInputWindow@@YAJPEAUHWND__@@PEAVIInputQueue@@PEAPEAUtagWND@@@Z @ 0x1C0011694
 * Callers:
 *     UserValidateAndAttachQueueToInputWindowApiExt @ 0x1C0011680 (UserValidateAndAttachQueueToInputWindowApiExt.c)
 * Callees:
...
__int64 __fastcall ValidateAndAttachQueueToInputWindow(HWND a1, struct IInputQueue *a2, struct tagWND **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 && (v9 = *(_QWORD *)(v7 + 40), v8 = (*(_WORD *)(v9 + 42) & 0x3FFFu) - 669, (v8 & 0xFFFFFFFD) != 0) )
  {
    ...
    if ( CurrentProcessWin32Process == (_QWORD *)v14[52]
      || (unsigned int)IsProcessDwm(*CurrentProcessWin32Process)
      || v14[172] == GetAncestor(v12, 1LL)
      && (v18 = v14[173]) != 0
      && v15 == *(_QWORD **)(*(_QWORD *)(v18 + 16) + 416LL)
      || (RtlInitUnicodeString(&DestinationString, L"shellExperience"), (*((_DWORD *)v15 + 203) & 0x30) == 0x10)
      && (int)RtlCapabilityCheck(0LL, &DestinationString, &v20) >= 0
      && v20
      && v14[172] == GetAncestor(v12, 1LL) )
    {
