/*
 * XREFs of xxxCallJournalRecordHook @ 0x1C01B0924
 * Callers:
...
__int16 __fastcall xxxCallJournalRecordHook(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned int)(v11 - 512) > 0xE )
  {
    if ( (unsigned int)(v11 - 256) <= 9 )
    {
      ...
      v6 = *(_BYTE *)(a1 + 42);
      if ( v5 != 231 || v6 )
        HIDWORD(v11) = (unsigned __int8)v5 | (unsigned __int16)(v6 << 8);
      else
        HIDWORD(v11) = (*(unsigned __int16 *)(gptiCurrent + 866LL) << 16) | 0xE7;
      v7 = *(_DWORD *)(a1 + 40);
      LODWORD(v12) = v6;
      if ( (v7 & 0x1000000) != 0 )
