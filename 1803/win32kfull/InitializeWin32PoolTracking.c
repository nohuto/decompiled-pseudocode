/*
 * XREFs of InitializeWin32PoolTracking @ 0x1C01126C0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsWin32kRefreshed@@YA_NXZ @ 0x1C01D3748 (-IsWin32kRefreshed@@YA_NXZ.c)
 *     ?LoadWin32PoolTrackingSettings@@YAXXZ @ 0x1C01D3940 (-LoadWin32PoolTrackingSettings@@YAXXZ.c)
 *     ?StopWin32PoolTracking@@YAXXZ @ 0x1C01D3ACC (-StopWin32PoolTracking@@YAXXZ.c)
 */
...
__int64 InitializeWin32PoolTracking()
{
  ...
  {
    gpLeakTrackingAllocator = &unk_1C032AD60;
    return 0LL;
  }
}
