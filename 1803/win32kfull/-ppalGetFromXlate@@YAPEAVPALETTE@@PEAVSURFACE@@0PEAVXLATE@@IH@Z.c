/*
 * XREFs of ?ppalGetFromXlate@@YAPEAVPALETTE@@PEAVSURFACE@@0PEAVXLATE@@IH@Z @ 0x1C00CF544
 * Callers:
...
struct PALETTE *__fastcall ppalGetFromXlate(struct SURFACE *a1, struct SURFACE *a2, struct XLATE *a3, int a4, int a5)
{
  ...
  {
    v7 = *((_QWORD *)a1 + 6);
    if ( v7 && (*(_DWORD *)(v7 + 2164) & 0x100) != 0 )
    {
      v8 = *((_DWORD *)a1 + 24) == *(_DWORD *)(v7 + 2100);
      goto LABEL_15;
    }
  }
  else
  {
    ...
    if ( v7 && (*(_DWORD *)(v7 + 2164) & 0x100) == 0 )
    {
      v8 = *((_DWORD *)a2 + 24) == *(_DWORD *)(v7 + 2100);
LABEL_15:
      if ( v8 )
      {
        v5 = *(_QWORD *)(v7 + 1800);
