/*
 * XREFs of xxxRemoveQueueCompletion @ 0x1C000DE4C
 * Callers:
 ...
 *     _RemoveQueueCompletion @ 0x1C013B320 (_RemoveQueueCompletion.c)
 * Callees:
...
__int64 xxxRemoveQueueCompletion()
{
  ...
  v0 = 0;
  v6 = 0LL;
  v1 = ZwRemoveIoCompletionEx(*(_QWORD *)(gptiCurrent + 1408LL), v4, 1LL, &v5, &v6, 0);
