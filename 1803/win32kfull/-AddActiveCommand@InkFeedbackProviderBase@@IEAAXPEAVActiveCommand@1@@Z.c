/*
 * XREFs of ?AddActiveCommand@InkFeedbackProviderBase@@IEAAXPEAVActiveCommand@1@@Z @ 0x1C020D770
 * Callers:
        ...
        struct InkFeedbackProviderBase::ActiveCommand *a2)
{
  ...
  *((_QWORD *)v3 + 1) = a2;
  if ( (unsigned int)pRelatedActivityId > 4 )
  {
    ...
    v25 = v9;
    v26 = 4LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3CD7, v10, (LPCGUID)v7, 9u, &pData);
  }
}
