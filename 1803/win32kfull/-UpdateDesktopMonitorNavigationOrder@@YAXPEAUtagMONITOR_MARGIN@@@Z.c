/*
 * XREFs of ?UpdateDesktopMonitorNavigationOrder@@YAXPEAUtagMONITOR_MARGIN@@@Z @ 0x1C0065424
 * Callers:
...
void __fastcall UpdateDesktopMonitorNavigationOrder(struct tagMONITOR_MARGIN *Base)
{
  ...
  *(_QWORD *)(gpDispInfo + 144LL) = gpDispInfo + 144LL;
  ...
  do
  {
    ...
    v8 = (_QWORD *)(v7 + 568);
    MonitorWorkRectForDpi = (__m128i *)GetMonitorWorkRectForDpi(&v14, v7, 0x60u);
