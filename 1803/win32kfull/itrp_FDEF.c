/*
 * XREFs of itrp_FDEF @ 0x1C02C75E0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int64 __fastcall itrp_FDEF(unsigned __int64 a1)
{
  ...
  if ( (qword_1C0327180 ^ *(_QWORD *)qword_1C0327180 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0327180 + 424)) != *(_QWORD *)(qword_1C0327180 + 432)
    || (v3 = qword_1C0327168, !((qword_1C0327168 - *(_QWORD *)qword_1C0327180) >> 2)) )
  {
  ...
  qword_1C0327168 -= 4LL;
  v4 = *(int *)(v3 - 4);
  if ( (int)v4 >= *(unsigned __int16 *)(*(_QWORD *)(qword_1C0327180 + 344) + 20LL) || (int)v4 < 0 )
  {
    dword_1C03271D0 = 4372;
    return qword_1C03271D8;
  }
  v5 = *(_BYTE *)(qword_1C0327180 + 333);
  if ( v5 < 2u )
  {
    v6 = *(_QWORD *)(qword_1C0327180 + 160);
    v7 = a1;
    *(_WORD *)(v6 + 8 * v4 + 6) = v5;
    *(_DWORD *)(v6 + 8 * v4) = a1 - *(_DWORD *)(v1 + 16LL * v5 + 200);
    if ( (unsigned int)(v4 - 64) <= 2
      && a1 >= qword_1C03271E0
      && a1 + 4 <= qword_1C03271D8
      && a1 + 4 >= a1
      && *(_DWORD *)a1 == 1480791728 )
    {
      *(_WORD *)(qword_1C0327180 + 454) |= 0x100u;
    }
    if ( ((int)v4 <= 2 || (_DWORD)v4 == 4 || (unsigned int)(v4 - 7) <= 1) && a1 >= qword_1C03271E0 )
    {
      if ( a1 + 5 <= qword_1C03271D8 && a1 + 5 >= a1 )
      {
      ...
      if ( a1 + 6 <= qword_1C03271D8 && a1 + 6 >= a1 )
      {
        ...
        if ( !v9 )
LABEL_27:
          *(_WORD *)(qword_1C0327180 + 454) |= 0x200u;
      }
    }
    if ( !(_DWORD)v4 )
    {
      if ( a1 < qword_1C03271E0 )
        goto LABEL_78;
      if ( a1 + 7 > qword_1C03271D8 || a1 + 7 < a1 )
        goto LABEL_45;
...
LABEL_45:
        ...
        {
          v12 = a1 + 1;
          if ( a1 + 1 <= qword_1C03271D8 && v12 >= a1 && *(_BYTE *)a1 == 75 )
          {
            if ( a1 + 9 <= qword_1C03271D8 && a1 + 9 >= a1 )
            {
            ...
            if ( a1 + 13 <= qword_1C03271D8 && a1 + 13 >= a1 )
            {
              ...
              {
LABEL_60:
                v15 = *(_WORD *)(qword_1C0327180 + 456);
                if ( v15 < 4u )
                {
                  *(_WORD *)(qword_1C0327180 + 2LL * v15 + 458) = v4;
                  ++*(_WORD *)(qword_1C0327180 + 456);
                }
              }
            }
          }
          ...
          if ( a1 >= qword_1C03271E0 )
          {
            ...
            if ( v12 <= qword_1C03271D8 && v12 >= a1 )
            {
              ...
              while ( *(_BYTE *)a1 != v18 )
              {
                ...
                if ( v12 >= result )
                  goto LABEL_72;
                v20 = itrp_SkipPushData(v12, v16, v12);
                v16 = qword_1C03271E0;
                a1 = v20;
                if ( v20 >= qword_1C03271E0 )
                {
                  v12 = v20 + 1;
                  result = qword_1C03271D8;
                  if ( v12 <= qword_1C03271D8 && v12 >= a1 )
