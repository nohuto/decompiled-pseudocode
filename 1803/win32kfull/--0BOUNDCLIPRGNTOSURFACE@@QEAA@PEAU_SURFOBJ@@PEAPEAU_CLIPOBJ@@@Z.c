/*
 * XREFs of ??0BOUNDCLIPRGNTOSURFACE@@QEAA@PEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C00E3384
 * Callers:
 ...
 *     ?bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z @ 0x1C00A526C (-bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z.c)
  ...
  if ( a3 )
  {
    if ( *a3 )
    {
      ...
      *(_QWORD *)&v12.left = 0LL;
      ...
      if ( !ERECTL::bContain((ERECTL *)&v12, &v9) )
      {
