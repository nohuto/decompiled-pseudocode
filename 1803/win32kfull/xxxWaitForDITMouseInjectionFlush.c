/*
 * XREFs of xxxWaitForDITMouseInjectionFlush @ 0x1C006009C
 * Callers:
...
__int64 xxxWaitForDITMouseInjectionFlush()
{
  ...
  if ( v0 )
  {
    v5 = *(_QWORD *)(gptiCurrent + 440LL);
    *(_DWORD *)(gptiCurrent + 1200LL) |= 0x400000u;
    v6 = *(_WORD *)(v5 + 10);
    Object[0] = gpkeDITMouseInjectionResponseEvent;
    Object[1] = *(PVOID *)(gptiCurrent + 1400LL);
    ...
    *(_WORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 10LL) = v6;
    *(_DWORD *)(gptiCurrent + 1200LL) &= ~0x400000u;
  }
