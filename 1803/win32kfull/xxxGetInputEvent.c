/*
 * XREFs of xxxGetInputEvent @ 0x1C003B780
 * Callers:
...
__int64 __fastcall xxxGetInputEvent(unsigned int a1)
{
  ...
  if ( ((unsigned __int16)(v5 | *(_WORD *)(v3 + 4)) & v1) != 0
    || (v6 = *(_DWORD *)(gptiCurrent + 1200LL), (v6 & 0x400) != 0 || (v2 & 8) != 0) && (v6 & 0x200) != 0
    || (v7 = *(_QWORD *)(gptiCurrent + 424LL), *(_QWORD *)(v7 + 64) == gptiCurrent)
...
LABEL_17:
  ...
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 472LL) + 8LL) = 0LL;
  if ( (*(_DWORD *)(gptiCurrent + 480LL) & 0x400) != 0 && (int)CheckProcessForeground(gptiCurrent) < 0 )
    return 0LL;
LABEL_23:
  v14 = *(_QWORD *)(gptiCurrent + 712LL);
  if ( v14 && ((v1 & 7) == 7 || (v1 & 6) != 0 && *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 104LL)) )
  {
