/*
 * XREFs of xxxPerformTargetingWithinPwnd @ 0x1C01CBF48
 * Callers:
 *     PerformTargetingWithinPwnd @ 0x1C01CB840 (PerformTargetingWithinPwnd.c)
 * Callees:
...
__int64 __fastcall xxxPerformTargetingWithinPwnd(__int64 *BugCheckParameter2, __int64 a2, _DWORD *a3)
{
  ...
  *a3 = 0;
  a3[1] = 0;
  result = RealGetProp(BugCheckParameter2[15], (unsigned __int16)gatomPtrTargetFlags, 1LL);
  if ( (result & 0xFFFD) != 0 )
  {
