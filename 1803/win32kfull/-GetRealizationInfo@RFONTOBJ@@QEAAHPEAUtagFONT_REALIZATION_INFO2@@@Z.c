/*
 * XREFs of ?GetRealizationInfo@RFONTOBJ@@QEAAHPEAUtagFONT_REALIZATION_INFO2@@@Z @ 0x1C00875CC
 * Callers:
...
__int64 __fastcall RFONTOBJ::GetRealizationInfo(RFONTOBJ *this, struct tagFONT_REALIZATION_INFO2 *a2)
{
  ...
  v6 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 104LL) + 32LL) + 48LL);
  if ( (v6 & 2) != 0 )
    v7 = 1;
  else
    v7 = ((v6 & 4) == 0) | 2;
  ...
  *((_BYTE *)a2 + 5) = ((*(_DWORD *)(*(_QWORD *)this + 12LL) & 0x40000000) != 0) + 1;
  ...
  {
    v10 = *(_DWORD **)this;
    v11 = *(_WORD *)(*(_QWORD *)(*(_QWORD *)this + 104LL) + 8LL);
    v12 = v11 - 1;
    if ( v11 != 1 )
    {
      v18 = (__int64 *)(*((_QWORD *)v10 + 14) + 224LL + 8LL * v12);
      do
      {
        v19 = *v18--;
        v20 = *(_DWORD *)(v19 + 12);
    ...
    v13 = v10[3];
    v14 = (v13 >> 13) & 1 | 2;
    *((_DWORD *)a2 + 4) = *(_DWORD *)(*((_QWORD *)v10 + 14) + 36LL);
    *((_WORD *)a2 + 10) = v11 - 1;
    if ( (v13 & 0x4000) == 0 )
      v14 = (v13 >> 13) & 1;
    *((_WORD *)a2 + 11) = v14;
    if ( v8 != 24 )
    {
      if ( IsVariableFont(*(struct _IFIMETRICS **)(*(_QWORD *)(*(_QWORD *)this + 104LL) + 32LL)) )
      {
        ...
        v25 = v16;
        v26 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 104LL) + 32LL)
            + *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 104LL) + 32LL) + 208LL);
        v17[25] = *(_DWORD *)(v26 + 4);
