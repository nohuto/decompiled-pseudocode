/*
 * XREFs of ?bSpDwmUpdateSurface@@YAHPEAUHWND__@@I_KAEAVXDCOBJ@@PEAUHSURF__@@MHHAEAVERECTL@@PEAVREGION@@@Z @ 0x1C0057248
 * Callers:
        ...
        if ( v22 >= 0 )
        {
          ...
          if ( v28 )
          {
            if ( *(_DWORD *)(v28 + 96) == 6 )
            {
              ...
              if ( v40 && v43[0] && **(_QWORD **)(*(_QWORD *)a4 + 504LL) == *(_QWORD *)v29 )
              {
                v59 = 0LL;
                v32 = 0LL;
                v60 = 0;
                ...
                else if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)a4 + 504LL) + 112LL) & 0x400) != 0 )
                {
                  v33 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)v30 + 354);
                }
                else
                {
                  v33 = EngCopyBits;
                }
                if ( !v32 || !(unsigned int)ERECTL::bEmpty((ERECTL *)v57) )
                {
                  if ( v45 )
                    v34 = v45 + 24;
                  else
