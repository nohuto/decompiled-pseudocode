/*
 * XREFs of ?xxxExecute@@YAKPEAKPEA_JPEAUtagDDECONV@@@Z @ 0x1C01CFA6C
 * Callers:
...
__int64 __fastcall xxxExecute(unsigned int *a1, void **a2, struct tagDDECONV *a3)
{
  ...
  v4 = 2048;
  v13 = 2048;
  if ( (*(_BYTE *)(*(_QWORD *)(v3 + 40) + 18LL) & 8) == 0 )
  {
  ...
  if ( v8 == 2 )
  {
    ...
    *a2 = v10;
    if ( v10 )
    {
      *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 5) + 16LL) + 480LL) |= 0x20u;
      *(_DWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 6) + 16LL) + 480LL) |= 0x20u;
    }
    else
    {
      return 3;
