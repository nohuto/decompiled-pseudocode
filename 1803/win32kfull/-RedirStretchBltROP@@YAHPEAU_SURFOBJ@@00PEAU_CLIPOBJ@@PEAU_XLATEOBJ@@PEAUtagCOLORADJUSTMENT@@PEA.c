/*
 * XREFs of ?RedirStretchBltROP@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54KPEAU_BRUSHOBJ@@K@Z @ 0x1C026CDE0
 * Callers:
 *     <none>
 * Callees:
        ...
        DWORD rop4)
{
  ...
  struct SURFACE *v28; // [rsp+78h] [rbp-61h] BYREF
          ...
          if ( v18 )
          {
            do
            {
              ...
              if ( v19 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v19 + 1784) + 616LL) )
                  {
  ...
  v25 = EngStretchBltROP(a1, a2, a3, v15, pxlo, pca, pptlHTOrg, prclDest, prclSrc, pptlMask, iMode, pbo, rop4);
  if ( v28 )
    bMakeOpaque(v28);
  if ( v29 )
    bMakeOpaque(v29);
