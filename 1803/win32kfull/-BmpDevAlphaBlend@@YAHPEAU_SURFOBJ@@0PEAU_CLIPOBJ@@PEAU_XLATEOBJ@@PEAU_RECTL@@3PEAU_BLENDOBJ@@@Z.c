/*
 * XREFs of ?BmpDevAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x1C0269260
 * Callers:
 *     <none>
 * Callees:
          ...
          do
          {
            ...
            if ( v16 )
            {
              if ( (*(_DWORD *)(v16 + 1816) & 0x8000000) != 0 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v16 + 1784) + 632LL) )
                  {
