/*
 * XREFs of NtGdiEngStretchBltROP @ 0x1C011DC30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?PROBEDISPATBRUSH@@YAHPEAU_BRUSHOBJ@@@Z @ 0x1C0282110 (-PROBEDISPATBRUSH@@YAHPEAU_BRUSHOBJ@@@Z.c)
 */
...
LABEL_17:
        ...
        pbo = (BRUSHOBJ *)UMPDOBJ::GetDDIOBJ<_BRUSHOBJ>(v16, v35);
        if ( !pbo )
