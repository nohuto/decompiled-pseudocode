/*
 * XREFs of SetWindowCompositionPassiveUpdateMode @ 0x1C01FA608
 * Callers:
...
__int64 __fastcall SetWindowCompositionPassiveUpdateMode(__int64 *a1, __int128 *a2)
{
  ...
  {
    v5 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v11[0], 16) == v5 )
      return 0;
    v11[0] = v11[0] & 0xFFFF7FFF | (v5 << 15);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v9, *a1, 25, a2);
    }
  }
  return v4;
}
