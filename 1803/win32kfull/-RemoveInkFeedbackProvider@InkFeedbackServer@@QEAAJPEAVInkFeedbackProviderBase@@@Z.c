/*
 * XREFs of ?RemoveInkFeedbackProvider@InkFeedbackServer@@QEAAJPEAVInkFeedbackProviderBase@@@Z @ 0x1C00E4CC8
 * Callers:
        ...
        struct InkFeedbackProviderBase *a2)
{
  ...
  *v2 = 0LL;
  if ( (unsigned int)pRelatedActivityId > 4 )
  {
    ...
    v17 = &v10;
    v18 = 8LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3B26, v8, v7, 6u, &pData);
  }
  return 0LL;
}
