/*
 * XREFs of ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C0069A50
 * Callers:
...
_BOOL8 __fastcall GetFlickMap(struct tagFLICK_MAP *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v19[12] = (char *)a1 + 96;
  v19[14] = (char *)a1 + 112;
  if ( (unsigned int)RIMIsDefaultUILanguageRTL(a1, a2, a3, a4) != dword_1C031C02C )
  {
    v15 = xmmword_1C031CC88;
    xmmword_1C031CC88 = xmmword_1C031CC28;
    dword_1C031C02C = dword_1C031C02C == 0;
    xmmword_1C031CC28 = v15;
  }
...
LABEL_2:
    ...
    *(_OWORD *)a1 = xmmword_1C031CC28;
    *((_OWORD *)a1 + 1) = xmmword_1C031CC40;
    *((_OWORD *)a1 + 2) = xmmword_1C031CC58;
    *((_OWORD *)a1 + 3) = xmmword_1C031CC70;
    *((_OWORD *)a1 + 4) = xmmword_1C031CC88;
    *((_OWORD *)a1 + 5) = xmmword_1C031CCA0;
    *((_OWORD *)a1 + 6) = xmmword_1C031CCB8;
    *((_OWORD *)a1 + 7) = xmmword_1C031CCD0;
  }
