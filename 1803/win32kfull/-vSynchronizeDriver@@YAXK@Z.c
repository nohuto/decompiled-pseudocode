/*
 * XREFs of ?vSynchronizeDriver@@YAXK@Z @ 0x1C00A645C
 * Callers:
 *     GreFlush @ 0x1C00A60A0 (GreFlush.c)
 *     ?GreSynchronizeTimer@@YAXPEAXI_K_J@Z @ 0x1C026E380 (-GreSynchronizeTimer@@YAXPEAXI_K_J@Z.c)
 * Callees:
 *     <none>
 */
...
LABEL_17:
    ...
    if ( (a1 & *(_DWORD *)(v6 + 2120)) == 0 || (*(_DWORD *)(v6 + 40) & 0x400) != 0 )
    {
LABEL_15:
      if ( !PDEVOBJ::bAllowShareAccess((PDEVOBJ *)&v6) )
      {
...
LABEL_14:
        PDEVOBJ::vSync(
          (PDEVOBJ *)&v6,
          (struct _SURFOBJ *)((*(_QWORD *)(v6 + 2544) + 24LL) & -(__int64)(*(_QWORD *)(v6 + 2544) != 0LL)),
          0LL,
          v5);
        goto LABEL_15;
      }
