/*
 * XREFs of ?DoSuperWetInkStop@InkDevice@@AEAAJPEBUIFC_SUPERWET_INK_STOP_DATA@@@Z @ 0x1C020EE78
 * Callers:
...
__int64 __fastcall InkDevice::DoSuperWetInkStop(InkDevice *this, const struct IFC_SUPERWET_INK_STOP_DATA *a2)
{
  ...
  if ( v4 >= 0 )
  {
    if ( (unsigned int)pRelatedActivityId > 4 )
    {
      ...
      v21 = a2;
      v22 = 4LL;
      TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3C69, v8, v9, 7u, &v13);
    }
  }
  else if ( (unsigned int)pRelatedActivityId > 2 )
  {
    ...
    v24 = &v11;
    v25 = 4LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E36AF, v5, 0LL, 3u, &pData);
  }
  return v6;
}
