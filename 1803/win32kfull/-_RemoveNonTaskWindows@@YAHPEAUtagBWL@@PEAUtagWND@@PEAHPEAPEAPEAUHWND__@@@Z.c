/*
 * XREFs of ?_RemoveNonTaskWindows@@YAHPEAUtagBWL@@PEAUtagWND@@PEAHPEAPEAPEAUHWND__@@@Z @ 0x1C01BB7F4
 * Callers:
...
__int64 __fastcall _RemoveNonTaskWindows(struct tagBWL *a1, struct tagWND *a2, unsigned int *a3, HWND **a4)
{
  ...
  *a3 = -1;
  ...
  {
    LOBYTE(a2) = 1;
    v10 = (struct tagWND *)HMValidateHandleNoSecure(*v5, (__int64)a2);
    v11 = v10;
      ...
      if ( (*(_BYTE *)(*((_QWORD *)v11 + 5) + 26LL) & 4) == 0 )
      {
        do
        {
          ...
          if ( !v13 )
            break;
          v14 = v12;
          v12 = (struct tagWND *)*((_QWORD *)v12 + 12);
          v15 = *(_QWORD *)(v13 + 40);
          if ( *(char *)(v15 + 24) < 0 )
          {
            if ( (*(_BYTE *)(*((_QWORD *)v14 + 5) + 26LL) & 1) == 0 || *((_QWORD *)v12 + 12) )
              v12 = 0LL;
            else
              v12 = v11;
            break;
