/*
 * XREFs of ?bCleanupPFT@PUBLIC_PFTOBJ@@QEAAXW4eCleanupMode@1@PEAK@Z @ 0x1C003ECAC
 * Callers:
 *     vCleanupPrivateFonts @ 0x1C00C8D40 (vCleanupPrivateFonts.c)
...
int __fastcall PUBLIC_PFTOBJ::bCleanupPFT(PFTOBJ *a1, int a2, _DWORD *a3)
{
  ...
  struct PFF *i; // rcx
  __int64 v11; // rcx
  _QWORD v13[30]; // [rsp+28h] [rbp-E0h] BYREF
  _DWORD v14[16]; // [rsp+118h] [rbp+10h] BYREF
