/*
 * XREFs of xxxPointerCallHook @ 0x1C01B89EC
 * Callers:
 ...
 *     ?RemoveThreadPointerHookData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@@Z @ 0x1C01B9B78 (-RemoveThreadPointerHookData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@@Z.c)
 */
...
LABEL_10:
  ...
  {
    case 3:
      ThreadPointerHookData = MakeThreadPointerHookData((struct tagTHREADINPUTPOINTERLIST *)(gptiCurrent + 1072LL), *v9);
...
LABEL_22:
  ...
  if ( ThreadPointerHookData )
  {
    ...
    RemoveThreadPointerHookData((struct tagTHREADINPUTPOINTERLIST *)(gptiCurrent + 1072LL));
  }
  return v19;
}
