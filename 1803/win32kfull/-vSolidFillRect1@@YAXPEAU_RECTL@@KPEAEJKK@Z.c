/*
 * XREFs of ?vSolidFillRect1@@YAXPEAU_RECTL@@KPEAEJKK@Z @ 0x1C0092090
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vSolidFillRect1(struct _RECTL *a1, int a2, unsigned __int8 *a3, int a4, unsigned int a5, char a6)
{
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      v40 = v17;
      v19 = *((_DWORD *)&aulMsk + ((v15 << v6) & 0x1F));
      v20 = *((_DWORD *)&aulMsk + (((unsigned __int8)(v15 << v6) + (unsigned __int8)(v16 << v6)) & 0x1F));
      if ( (_DWORD)v18 == v17 )
      {
        v30 = ~v20 & v19;
        v31 = ~v30;
