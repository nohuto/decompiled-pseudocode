/*
 * XREFs of GreDrvDisconnect @ 0x1C01382DC
 * Callers:
...
__int64 __fastcall GreDrvDisconnect(__int64 a1)
{
  ...
  do
  {
    ...
    if ( *((_QWORD *)v3 + 2) && *((_DWORD *)v3 + 6) == 1 && *(_QWORD *)(*((_QWORD *)v3 + 112) + 624LL) )
    {
      ...
      v6 = 0LL;
      for ( i = gppdevList; v2 >= 0 && i && *((struct _LDEV **)i + 223) == v3; i = *(struct PDEV **)i )
      {
        v19 = i;
        ...
        if ( v19 && (*((_DWORD *)v19 + 10) & 1) != 0 )
        {
          ...
          PDEVOBJ::vSync(
            (PDEVOBJ *)&v19,
            (struct _SURFOBJ *)((*((_QWORD *)v19 + 318) + 24LL) & -(__int64)(*((_QWORD *)v19 + 318) != 0LL)),
            0LL,
            0);
          if ( !v4 )
          {
