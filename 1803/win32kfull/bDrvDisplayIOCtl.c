/*
 * XREFs of bDrvDisplayIOCtl @ 0x1C028E744
 * Callers:
...
__int64 __fastcall bDrvDisplayIOCtl(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( a1 && (v5 = 1, (*(_DWORD *)(a1 + 40) & 1) != 0) )
  {
    ...
    PDEVOBJ::vSync((PDEVOBJ *)&v11, (struct _SURFOBJ *)((v11[318] + 24LL) & -(__int64)(v11[318] != 0LL)), 0LL, 0);
    v6 = v11;
    v7 = (__int64 (__fastcall *)(__int64, _QWORD))v11[419];
    if ( v7 )
    {
      v8 = v7(a2, a3);
      v6 = v11;
