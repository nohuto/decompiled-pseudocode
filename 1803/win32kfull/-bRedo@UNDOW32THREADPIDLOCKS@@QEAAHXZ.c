/*
 * XREFs of ?bRedo@UNDOW32THREADPIDLOCKS@@QEAAHXZ @ 0x1C00E18D4
 * Callers:
...
LABEL_2:
    if ( !*((_DWORD *)this + 5) )
      return v2;
    v9 = *(_QWORD *)(*this[1] + 504);
    goto LABEL_16;
  }
  v4 = **this;
  if ( !*((_DWORD *)this + 5) )
  {
    if ( (unsigned int)SURFACE::Map(*(_QWORD *)(v4 + 504), 0LL) == 2 )
    {
      *(_DWORD *)(**this + 44) |= 1u;
      v2 = 0;
    }
...
LABEL_18:
  ...
  if ( (unsigned int)SURFACE::Map(*(_QWORD *)(*v5 + 504), 0LL) == 2 )
  {
    *(_DWORD *)(*this[1] + 44) |= 1u;
    v2 = 0;
  }
