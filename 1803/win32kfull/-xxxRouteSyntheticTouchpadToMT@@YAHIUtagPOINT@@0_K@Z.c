/*
 * XREFs of ?xxxRouteSyntheticTouchpadToMT@@YAHIUtagPOINT@@0_K@Z @ 0x1C01FD7CC
 * Callers:
 *     EditionHandleMitSignal @ 0x1C00EE260 (EditionHandleMitSignal.c)
        ...
        unsigned __int64 a4)
{
  ...
  memset(&v16[49], 0, 177);
  gInertiaMTInfo &= ~1u;
  v8 = ((__int64 (__fastcall *)(_QWORD, _QWORD))PsGetCurrentProcess)(a1, a2);
