/*
 * XREFs of ?BmpDevGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1C0269B80
 * Callers:
 *     <none>
 * Callees:
        ...
        for ( i = **(_QWORD ***)(HDEV + 1792); i; i = (_QWORD *)*i )
        {
          ...
          if ( v17 )
          {
            if ( (*(_DWORD *)(v17 + 1816) & 0x8000000) != 0 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v17 + 1784) + 608LL) )
                {
                  MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                    (MARK_ACCDRV_NOTIFICATION *)&v22,
                    (struct PDEVOBJ *)&v21,
                    a1);
                  (*(void (__fastcall **)(struct _SURFOBJ *, CLIPOBJ *, XLATEOBJ *, TRIVERTEX *, ULONG, PVOID, ULONG, RECTL *, POINTL *, ULONG))(*(_QWORD *)(v19 + 1784) + 608LL))(
                    a1,
                    pco,
                    pxlo,
                    pVertex,
