/*
 * XREFs of MagContextThreadCallout @ 0x1C019B120
 * Callers:
 *     xxxSetThreadDesktop @ 0x1C000EEA8 (xxxSetThreadDesktop.c)
 *     MagContextDestroy @ 0x1C01139B0 (MagContextDestroy.c)
...
void __fastcall MagContextThreadCallout(_QWORD *a1, __int64 a2, _QWORD *a3, int a4)
{
  ...
  if ( (a3 || (ThreadContext = MagpFindThreadContext(a1, a2)) != 0LL) && a4 == 1 )
  {
    ...
    while ( v6 != ThreadContext + 5 )
    {
      ...
      v9 = v6;
      v6 = v7;
      if ( (_QWORD *)v7[1] != v8 || (v10 = (_QWORD *)v8[1], (_QWORD *)*v10 != v8) )
        __fastfail(3u);
      *v10 = v7;
      v7[1] = v10;
      v11 = v8[3];
      if ( v11 == -1 )
      {
        ...
        {
          v16 = (void *)ReferenceDwmApiPort(**(_QWORD **)(v15 + 8), a2, a3);
        ...
        {
          v18 = (void *)ReferenceDwmApiPort(**(_QWORD **)(v17 + 8), a2, a3);
      ...
      else
      {
        ...
        if ( (v12 & 0x20) == 0 )
        {
          v13 = (void *)ReferenceDwmApiPort(v12, a2, **(_QWORD **)(*(_QWORD *)(ThreadContext[2] + 448LL) + 8LL));
