/*
 * XREFs of GreSaveDCInternal @ 0x1C013BC08
 * Callers:
 *     NtGdiSaveDC @ 0x1C0078AA0 (NtGdiSaveDC.c)
    ...
    *((_QWORD *)v18[0] + 15) = *(_QWORD *)v19[0];
    ...
    if ( v22 )
    {
      if ( (unsigned int)GreSetDCOwnerEx(*(_QWORD *)v19[0], 2147483666LL, 0LL, 1LL) )
      {
        ...
        v13 = *(_QWORD *)(v19[0] + 504LL);
        if ( v13 )
        {
          v14 = *(_DWORD *)(v13 + 112);
          if ( (v14 & 0x800) != 0 )
          {
            INC_SHARE_REF_CNT(*(_QWORD *)(v19[0] + 504LL));
          }
          else if ( v14 >= 0 )
          {
            INC_SHARE_REF_CNT(*(_QWORD *)(v19[0] + 504LL));
