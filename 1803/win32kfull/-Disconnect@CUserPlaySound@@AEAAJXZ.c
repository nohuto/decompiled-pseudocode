/*
 * XREFs of ?Disconnect@CUserPlaySound@@AEAAJXZ @ 0x1C00E49D4
 * Callers:
 *     NtUserDoSoundConnect @ 0x1C0112080 (NtUserDoSoundConnect.c)
 *     NtUserDoSoundDisconnect @ 0x1C0113D40 (NtUserDoSoundDisconnect.c)
 * Callees:
