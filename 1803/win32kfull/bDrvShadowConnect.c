/*
 * XREFs of bDrvShadowConnect @ 0x1C028EAC4
 * Callers:
...
__int64 __fastcall bDrvShadowConnect(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( a1 && (*(_DWORD *)(a1 + 40) & 1) != 0 )
  {
    ...
    PDEVOBJ::vSync((PDEVOBJ *)&v13, (struct _SURFOBJ *)((v13[318] + 24LL) & -(__int64)(v13[318] != 0LL)), 0LL, 0);
    v5 = v13;
    v6 = (__int64 (__fastcall *)(__int64, _QWORD))v13[415];
    if ( v6 )
    {
      v7 = v6(a2, a3);
      v5 = v13;
    ...
    {
      v10 = (void (__fastcall *)(_QWORD, __int64 *, _QWORD, _QWORD, _DWORD))v5[357];
      if ( v10 )
      {
        v10(v5[224], &v14, 0LL, 0LL, *(_DWORD *)(v9 + 28));
        v5 = v13;
      }
      else
      {
