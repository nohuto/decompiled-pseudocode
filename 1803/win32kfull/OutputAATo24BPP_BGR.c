/*
 * XREFs of OutputAATo24BPP_BGR @ 0x1C0114B80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
unsigned __int8 *__fastcall OutputAATo24BPP_BGR(_DWORD *a1, __int64 a2, unsigned __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( (*a1 & 0x80u) != 0 )
  {
    if ( (unsigned __int64)result < a3 )
    {
      ...
      do
      {
        if ( result[3] )
        {
          *(v9 - 2) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)result[2] + 512));
          *(v9 - 1) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)result[1] + 256));
  ...
  else if ( (unsigned __int64)result < a3 )
  {
    ...
    {
      v7 += 3LL;
      *(_BYTE *)(v7 - 5) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)result[2] + 512));
      *(_BYTE *)(v7 - 4) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)result[1] + 256));
      v8 = *result;
      result += 4;
