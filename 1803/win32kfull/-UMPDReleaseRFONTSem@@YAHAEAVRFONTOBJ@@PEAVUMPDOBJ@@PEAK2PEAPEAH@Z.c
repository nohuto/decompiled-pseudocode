/*
 * XREFs of ?UMPDReleaseRFONTSem@@YAHAEAVRFONTOBJ@@PEAVUMPDOBJ@@PEAK2PEAPEAH@Z @ 0x1C01202A0
 * Callers:
...
LABEL_7:
  ...
  v13 = *(_QWORD *)(*(_QWORD *)a1 + 704LL);
  if ( v13 && *(_QWORD *)(v13 + 496) && (unsigned int)GreIsSemaphoreOwnedByCurrentThread() )
  {
    EtwTraceGreLockReleaseSemaphore(
      L"rfo.prfnt->prfntSystemTT->hsemCache",
      *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 704LL) + 496LL));
    GreReleaseSemaphoreInternal(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 704LL) + 496LL));
    if ( v11 )
      *((_DWORD *)a2 + 103) |= 0x20u;
    else
      *v7 |= 0x20u;
  }
  v14 = *(_QWORD *)(*(_QWORD *)a1 + 712LL);
  if ( v14 && *(_QWORD *)(v14 + 496) && (unsigned int)GreIsSemaphoreOwnedByCurrentThread() )
  {
    EtwTraceGreLockReleaseSemaphore(
      L"rfo.prfnt->prfntSysEUDC->hsemCache",
      *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 712LL) + 496LL));
    GreReleaseSemaphoreInternal(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 712LL) + 496LL));
    if ( v11 )
      *((_DWORD *)a2 + 103) |= 0x40u;
    else
      *v7 |= 0x40u;
  ...
  if ( v15 && *(_QWORD *)(v15 + 496) && (unsigned int)GreIsSemaphoreOwnedByCurrentThread() )
  {
    EtwTraceGreLockReleaseSemaphore(
      L"rfo.prfnt->prfntDefEUDC->hsemCache",
      *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 720LL) + 496LL));
    GreReleaseSemaphoreInternal(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 720LL) + 496LL));
    if ( v11 )
      *((_DWORD *)a2 + 103) |= 0x80u;
    else
      *v7 |= 0x80u;
  }
  v16 = *(unsigned int *)(*(_QWORD *)a1 + 824LL);
  if ( (_DWORD)v16 )
  {
    if ( v11 )
    {
    ...
    if ( v18 )
    {
      ...
      do
      {
        v23 = *(_QWORD *)(v22 + *(_QWORD *)(*(_QWORD *)a1 + 728LL));
        if ( v23 && *(_QWORD *)(v23 + 496) && (unsigned int)GreIsSemaphoreOwnedByCurrentThread() )
        {
          EtwTraceGreLockReleaseSemaphore(
            L"rfo.prfnt->paprfntFaceName[ii]->hsemCache",
            *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 728LL) + v22) + 496LL));
          GreReleaseSemaphoreInternal(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 728LL) + v22) + 496LL));
          if ( v11 )
          {
  ...
  {
LABEL_23:
    *v7 |= *(_DWORD *)(*(_QWORD *)a1 + 696LL) << 16;
    *(_DWORD *)(*(_QWORD *)a1 + 696LL) |= 0x200u;
  }
...
LABEL_14:
  if ( *(_QWORD *)(*(_QWORD *)a1 + 496LL) && (unsigned int)GreIsSemaphoreOwnedByCurrentThread() )
  {
    EtwTraceGreLockReleaseSemaphore(L"rfo.prfnt->hsemCache", *(_QWORD *)(*(_QWORD *)a1 + 496LL));
    GreReleaseSemaphoreInternal(*(_QWORD *)(*(_QWORD *)a1 + 496LL));
    if ( v11 )
      *((_DWORD *)a2 + 103) |= 0x10u;
    else
      *v7 |= 0x10u;
