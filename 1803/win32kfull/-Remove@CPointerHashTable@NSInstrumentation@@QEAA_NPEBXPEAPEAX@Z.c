/*
 * XREFs of ?Remove@CPointerHashTable@NSInstrumentation@@QEAA_NPEBXPEAPEAX@Z @ 0x1C007E07C
 * Callers:
 ...
 *     ?_RemoveAllocationFromLookup@UmfdAllocation@@CAXPEAX00@Z @ 0x1C0104DA0 (-_RemoveAllocationFromLookup@UmfdAllocation@@CAXPEAX00@Z.c)
