/*
 * XREFs of InputAABFDATAToAA24 @ 0x1C00D5310
 * Callers:
 *     <none>
 * Callees:
    ...
    else if ( v7 == 4 )
    {
      do
      {
        ...
        *v6++ = (unsigned __int16)(*(_WORD *)(v16
                                 ...
                                 + *(_WORD *)(v16
                                            + 4LL
                                            * ((unsigned int)(unsigned __int8)(BYTE2(v24) & ((unsigned __int8)(v20 >> v25) << SBYTE5(v24)))
                                             + 512))
                                 + *(_WORD *)(v16
                                            + 4LL
                                            * ((unsigned int)(unsigned __int8)(BYTE3(v24) & ((unsigned __int8)(v20 >> SBYTE1(v25)) << SBYTE6(v24)))
                                             + 256))) >> 8;
      }
      while ( v6 < v17 );
      v4 = a1;
    ...
    else
    {
      do
      {
        ...
        *v6++ = (unsigned __int16)(*(_WORD *)(v16
                                 ...
                                 + *(_WORD *)(v16
                                            + 4LL
                                            * ((unsigned int)(unsigned __int8)(BYTE2(v24) & ((unsigned __int8)(v21 >> v25) << SBYTE5(v24)))
                                             + 512))
                                 + *(_WORD *)(v16
                                            + 4LL
                                            * ((unsigned int)(unsigned __int8)(BYTE3(v24) & ((unsigned __int8)(v21 >> SBYTE1(v25)) << SBYTE6(v24)))
                                             + 256))) >> 8;
      }
      while ( v6 < v17 );
      v4 = a1;
