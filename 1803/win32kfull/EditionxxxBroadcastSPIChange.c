/*
 * XREFs of EditionxxxBroadcastSPIChange @ 0x1C01A4EC0
 * Callers:
...
__int64 __fastcall EditionxxxBroadcastSPIChange(__int64 a1, __int64 a2)
{
  ...
  v6 = &v7;
  v5[1] = 100;
  return xxxBroadcastMessageEx(0LL, 26LL, (HWND)v2, (struct _LARGE_STRING *)v4, 6u, (union tagBROADCASTMSG *)v5, 1, 0);
}
