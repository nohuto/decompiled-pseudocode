/*
 * XREFs of ?InitializeContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x1C01B56E4
 * Callers:
 ...
 *     ?vInit@tagRlsFilter@Prediction@@QEAAXVCFixPred@2@000@Z @ 0x1C01B732C (-vInit@tagRlsFilter@Prediction@@QEAAXVCFixPred@2@000@Z.c)
 */
        ...
        struct tagPOINT *a6)
{
  ...
  *((_DWORD *)a4 + 502) = 3;
  ...
  v21 = 0LL;
  v20 = 0LL;
  Prediction::tagRlsFilter::Filter((__int64 *)a4, &v23, (__int64)&v20, (__int64)&v21, &v22);
  v21 = 0LL;
  v20 = 0LL;
  Prediction::tagRlsFilter::Filter((__int64 *)a4 + 54, &v23, (__int64)&v20, (__int64)&v21, &v22);
  v21 = 0LL;
  v20 = 0LL;
  Prediction::tagRlsFilter::Filter((__int64 *)a4 + 108, &v23, (__int64)&v20, (__int64)&v21, &v22);
  v21 = 0LL;
  v20 = 0LL;
  Prediction::tagRlsFilter::Filter((__int64 *)a4 + 162, &v23, (__int64)&v20, (__int64)&v21, &v22);
  *a5 = a2;
  *a6 = a3;
}
