/*
 * XREFs of ?vInit@RFONTOBJ@@QEAAXAEAVXDCOBJ@@PEAVPFE@@PEAU_EUDCLOGFONT@@H@Z @ 0x1C000363C
 * Callers:
...
void __fastcall RFONTOBJ::vInit(RFONTOBJ *this, struct XDCOBJ *a2, struct PFE *a3, struct _EUDCLOGFONT *a4)
{
  ...
  _FD_XFORM v39; // [rsp+B0h] [rbp-50h] BYREF
  ...
  if ( (*(_DWORD *)(v14 + 48) & 0x3000010) != 0 )
  {
    ...
    if ( PFEOBJ::bSetFontXform(v21, v34, &v40.elfEnumLogfontEx.elfLogFont, &v39, 0, v29, &v30, (struct IFIOBJ *)v35, 1) )
    {
      ...
      if ( (unsigned int)RFONTOBJ::bFindRFONT(
                           ...
                           v32,
                           v31,
                           *(_DWORD *)(*(_QWORD *)(v25 + 80) + 68LL),
                           0,
                           2u) )
      {
        GreAcquireSemaphore(*(_QWORD *)(*(_QWORD *)this + 496LL));
        *(_DWORD *)(*(_QWORD *)v22 + 260LL) &= ~1u;
      }
      else
      {
                             ...
                             2u) )
        {
          v27 = *(_QWORD *)this;
          v36 = 1;
          GreAcquireSemaphore(*(_QWORD *)(v27 + 496));
          *(_DWORD *)(*(_QWORD *)v22 + 260LL) &= ~1u;
          goto LABEL_22;
        }
        *(_QWORD *)this = 0LL;
