/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0DJAAA@$0DJA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C013C7EC
 * Callers:
 ...
 * Callees:
 *     _lambda_7576a37b34930bf652a299bd9c3af6f1_::operator() @ 0x1C013C298 (_lambda_7576a37b34930bf652a299bd9c3af6f1_--operator().c)
 */
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<233472,912>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = PoolWithTag;
  if ( !PoolWithTag )
    return 0;
  *PoolWithTag = 0LL;
  v10 = lambda_7576a37b34930bf652a299bd9c3af6f1_::operator()(v9, 0xE4u);
  if ( !v10 )
    return 0;
