/*
 * XREFs of _RegisterErrorReportingDialog @ 0x1C01BFD60
 * Callers:
 *     NtUserRegisterErrorReportingDialog @ 0x1C01F3F70 (NtUserRegisterErrorReportingDialog.c)
 * Callees:
 *     IsWindowBeingDestroyed @ 0x1C00C476C (IsWindowBeingDestroyed.c)
 *     ?SendAsyncSGHOSTINFO@@YAHQEAU_GHOSTINFO@@@Z @ 0x1C00E6D98 (-SendAsyncSGHOSTINFO@@YAHQEAU_GHOSTINFO@@@Z.c)
 */
...
__int64 __fastcall RegisterErrorReportingDialog(__int64 a1)
{
  ...
  if ( !(unsigned int)IsWindowBeingDestroyed(a1) )
  {
    ...
    v6 = 4;
    v8 = v4;
    LODWORD(v3) = SendAsyncSGHOSTINFO((struct _GHOSTINFO *const)&v6, v1, v3);
  }
