/*
 * XREFs of ?bCalulateColorGradient@@YAHPEAU_TRIVERTEX@@00PEAU_TRIANGLEDATA@@@Z @ 0x1C01249C4
 * Callers:
 ...
 * Callees:
 *     ?bDoGradient@@YAHPEA_J00JJJPEAU_GRADSTRUCT@@@Z @ 0x1C0124B6C (-bDoGradient@@YAHPEA_J00JJJPEAU_GRADSTRUCT@@@Z.c)
 */
        ...
        struct _TRIANGLEDATA *a4)
{
  ...
  *((_DWORD *)a4 + 34) = x;
  ...
  v17 = 0x1000000000000LL % v15;
  v18 = (__int64 *)((char *)a4 + 16);
  v24 = 0x1000000000000LL / v15;
  *((_DWORD *)a4 + 35) = a1->y;
  Red = a3->Red;
  v20 = a2->Red;
  v21 = a1->Red;
  v25 = v17;
  bDoGradient(v18, (__int64 *)a4 + 6, v16, v21, v20, Red, (struct _GRADSTRUCT *)v23);
  bDoGradient(
    (__int64 *)a4 + 3,
    (__int64 *)a4 + 7,
    (__int64 *)a4 + 11,
