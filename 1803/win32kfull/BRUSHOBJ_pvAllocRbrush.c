/*
 * XREFs of BRUSHOBJ_pvAllocRbrush @ 0x1C023A690
 * Callers:
 *     VerifierBRUSHOBJ_pvAllocRbrush @ 0x1C026DDD0 (VerifierBRUSHOBJ_pvAllocRbrush.c)
 *     ?MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z @ 0x1C0273A80 (-MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z.c)
 * Callees:
