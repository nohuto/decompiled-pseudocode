/*
 * XREFs of ?bSpDwmUpdateCursor@@YAHPEAUHSPRITE__@@PEAU_SURFOBJ@@1PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_BLENDFUNCTION@@@Z @ 0x1C0137094
 * Callers:
        ...
        struct _BLENDFUNCTION *a6)
{
  ...
  if ( v17 )
  {
    ...
    if ( v9 )
    {
      ...
      if ( v15 )
        v7 = *(_QWORD *)(v15 + 8);
      bSpDwmNotifyDirty(*(_QWORD *)v10, v14, (int)v17, v7);
      PUSHLOCKEX::~PUSHLOCKEX((PUSHLOCKEX *)v20);
    }
