/*
 * XREFs of ?SelectStorageTable@RFONTOBJ@@SAPEBEPEAVRFONT@@PEBE1@Z @ 0x1C007F598
 * Callers:
        ...
        const unsigned __int8 *a3)
{
  ...
  v4 = &gajStorageTable;
  v6 = 1;
  if ( (v3 & 1) == 0 || *((_DWORD *)a1 + 78) )
    v6 = 0;
  v7 = *(_QWORD *)(*((_QWORD *)a1 + 13) + 32LL);
  if ( (*(_DWORD *)(v7 + 48) & 0x401000) != 0
    && v6
    && *(_WORD *)(v7 + 46) <= 0x190u
    && (!_wcsicmp((const wchar_t *)(v7 + *(int *)(v7 + 8)), L"Courier New")
     || !_wcsicmp(
           (const wchar_t *)(*(_QWORD *)(*((_QWORD *)a1 + 13) + 32LL)
                           + *(int *)(*(_QWORD *)(*((_QWORD *)a1 + 13) + 32LL) + 8LL)),
           L"Rod")
     || !_wcsicmp(
           (const wchar_t *)(*(_QWORD *)(*((_QWORD *)a1 + 13) + 32LL)
                           + *(int *)(*(_QWORD *)(*((_QWORD *)a1 + 13) + 32LL) + 8LL)),
