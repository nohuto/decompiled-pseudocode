/*
 * XREFs of ?vForceClientRgnUpdate@@YAXXZ @ 0x1C0257BD8
 * Callers:
    ...
    for ( i = *((_QWORD *)v0 + 3); i; i = *(_QWORD *)(i + 160) )
    {
      ...
      if ( (v3 & 0x40000000) != 0 )
      {
        ...
        *(_DWORD *)(i + 184) = v4;
        ...
        if ( v5 )
        {
          ClientRgn = UserGetClientRgn(v5, (__int64)&v25, v4 & 0x20);
        }
        else
        {
          v25 = *(_OWORD *)((char *)v0 + 52);
          ClientRgn = (HRGN)GreCreateRectRgnIndirect(&v25, 0x3FFFFFFFLL, v4);
        }
        v7 = ClientRgn;
        if ( !ClientRgn )
          break;
