/*
 * XREFs of GetMonitorTransform @ 0x1C0073680
 * Callers:
...
__int64 __fastcall GetMonitorTransform(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !v6 )
    return 0LL;
  v7 = *(_QWORD *)(*(_QWORD *)(a2 + 16) + 448LL);
  if ( !v7 )
    return 0LL;
  if ( (*(_DWORD *)(**(_QWORD **)(v7 + 8) + 52LL) & 1) == 0 )
    return 0LL;
  v8 = *(_OWORD *)GetMonitorRectForDpi(v14, a1, v6);
  v9 = *(_QWORD *)(a1 + 40);
  v14[0] = v8;
  v10 = v8;
  if ( *(_WORD *)(v9 + 64) == v6
    && !(unsigned int)IsChildWindowDpiBoundary((struct tagWND *)a2)
    && *(_QWORD *)(*(_QWORD *)(a1 + 40) + 28LL) == (_QWORD)v8 )
  {
    return 0LL;
  }
  v12 = (float)v6;
  ...
  *(float *)(a3 + 52) = (float)*(int *)(*(_QWORD *)(a1 + 40) + 32LL)
                      - (float)((float)((float)*(unsigned __int16 *)(*(_QWORD *)(a1 + 40) + 64LL) * (float)SDWORD1(v8))
                              / v12);
  return result;
}
