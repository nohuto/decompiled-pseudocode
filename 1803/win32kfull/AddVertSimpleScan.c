/*
 * XREFs of AddVertSimpleScan @ 0x1C02C2850
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall AddVertSimpleScan(int a1, int a2)
{
  ...
  v5 = *(__int16 **)(qword_1C032FEC8 + 8 * v3);
  *(_QWORD *)(qword_1C032FEC8 + 8 * v3) = v5 + 1;
  if ( (unsigned __int64)(v5 + 1) > *(_QWORD *)(qword_1C032FED0 + 8 * v3) )
    return 4866LL;
