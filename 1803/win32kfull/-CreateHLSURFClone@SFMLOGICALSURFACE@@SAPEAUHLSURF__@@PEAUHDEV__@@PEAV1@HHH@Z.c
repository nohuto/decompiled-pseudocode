/*
 * XREFs of ?CreateHLSURFClone@SFMLOGICALSURFACE@@SAPEAUHLSURF__@@PEAUHDEV__@@PEAV1@HHH@Z @ 0x1C00C6194
 * Callers:
 ...
 *     SFMLOGICALSURFACE_CreateHLSURFCloneWrap @ 0x1C010F9A0 (SFMLOGICALSURFACE_CreateHLSURFCloneWrap.c)
 * Callees:
 ...
 *     ?Initialize@SFMLOGICALSURFACE@@QEAAHPEAUHWND__@@IIU_LUID@@W4_HLSURF_DISPOSITION@@@Z @ 0x1C00C79B0 (-Initialize@SFMLOGICALSURFACE@@QEAAHPEAUHWND__@@IIU_LUID@@W4_HLSURF_DISPOSITION@@@Z.c)
  ...
  if ( v23 && v21 && v19 )
  {
                         ...
                         *((_DWORD *)a2 + 72)) )
    {
      ...
      *(_DWORD *)(v12 + 240) = *((_DWORD *)a2 + 60);
      ...
      {
        bhLSurfDestroyLogicalSurfaceObject((__int64 *)v12, 0, 0);
      }
      if ( v30 )
