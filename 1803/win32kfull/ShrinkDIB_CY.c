/*
 * XREFs of ShrinkDIB_CY @ 0x1C02396D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ShrinkDIB_CY(__int64 a1)
{
  ...
  *((_QWORD *)v4 + 10) = v16;
  ...
  if ( *(_WORD *)(v94 + 14) )
  {
    ...
    while ( v27 < v18 + 256 );
    FixupScan = GetFixupScan((unsigned int *)v86, v108);
    v30 = &v22[v20];
  ...
  if ( v35 )
  {
    ...
    {
      v77 = v35 - 1;
      v36 = GetFixupScan((unsigned int *)v86, v108);
      v80 = (unsigned __int64)&v23[v20];
      v37 = *v79++;
      if ( (v37 & 0x4000) != 0 )
      {
        v38 = v37 & 0x3FFF;
        v39 = -v38;
        v40 = v18;
        v41 = *(_DWORD *)(v81 + 4) + ((v37 >> 15) & 1) - v38;
        v42 = v38 - (*(_DWORD *)(v81 + 4) + ((v37 >> 15) & 1));
        do
        {
          v39 += v38;
          v42 += v41;
        ...
        if ( v43 <= 0 )
        {
          ...
          {
            v52 = *(_WORD *)v36;
            v53 = *(unsigned __int8 *)(v36 + 2);
            v36 += 3LL;
            v75 = v52;
            *(_DWORD *)((char *)v48 + v51 - 4) += v18[v53];
            *(_DWORD *)((char *)v48 + v51) += v18[HIBYTE(v52)];
            *(_DWORD *)((char *)v48 + v51 + 4) += v18[(unsigned __int8)v52];
            v54 = (6 * v48[1] - *(_DWORD *)((char *)v48 + v51 + 4) - *(_DWORD *)((char *)v48 + v50 + 4)) >> 15;
            if ( ((6 * v48[1] - *(_DWORD *)((char *)v48 + v51 + 4) - *(_DWORD *)((char *)v48 + v50 + 4)) & 0x7F800000) != 0 )
              LOBYTE(v54) = ~HIBYTE(v54);
            *(v49 - 2) = v54;
            v55 = (6 * *v48 - *(_DWORD *)((char *)v48 + v50) - *(_DWORD *)((char *)v48 + v51)) >> 15;
            if ( ((6 * *v48 - *(_DWORD *)((char *)v48 + v50) - *(_DWORD *)((char *)v48 + v51)) & 0x7F800000) != 0 )
              LOBYTE(v55) = ~HIBYTE(v55);
            *(v49 - 1) = v55;
            v56 = (6 * *(v48 - 1) - *(_DWORD *)((char *)v48 + v51 - 4) - *(_DWORD *)((char *)v48 + v50 - 4)) >> 15;
            if ( ((6 * *(v48 - 1) - *(_DWORD *)((char *)v48 + v51 - 4) - *(_DWORD *)((char *)v48 + v50 - 4)) & 0x7F800000) != 0 )
              LOBYTE(v56) = ~HIBYTE(v56);
            *v49 = v56;
            v49 += 3;
            *(_DWORD *)((char *)v48 + v50 - 4) = v18[(unsigned __int8)v53 + 256];
            *(_DWORD *)((char *)v48 + v50) = v18[HIBYTE(v75) + 256];
            *(_DWORD *)((char *)v48 + v50 + 4) = v18[(unsigned __int8)v75 + 256];
            v48 += 3;
          }
          while ( (unsigned __int64)v48 + v51 - 4 < v80 );
          v92(v93, v78, v113, v114, v115);
          v57 = v86[0];
          v20 = v85;
          if ( SLOBYTE(v86[0]) < 0 )
          {
        ...
        else
        {
          ...
          while ( (unsigned __int64)(v45 - 1) < v80 );
          if ( v76 )
          {
            memmove(v22, v23, v20);
            v76 = 0;
      ...
      {
        v61 = v23 + 8;
        v62 = (unsigned __int8 *)(v36 + 1);
        v63 = v81 + (((unsigned __int64)(unsigned __int16)v37 >> 5) & 0x400);
        do
        {
  ...
  if ( v87 != v95 )
  {
    ...
    do
    {
      ...
      if ( ((5 * *(_DWORD *)((char *)v66 + (_QWORD)v67 + 4) - v66[1]) & 0x7F800000) != 0 )
        LOBYTE(v69) = ~HIBYTE(v69);
      *(v68 - 2) = v69;
      v70 = (5 * *(_DWORD *)&v67[(_QWORD)v66] - *v66) >> 15;
      if ( ((5 * *(_DWORD *)&v67[(_QWORD)v66] - *v66) & 0x7F800000) != 0 )
