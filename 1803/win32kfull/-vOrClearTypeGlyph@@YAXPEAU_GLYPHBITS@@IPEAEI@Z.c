/*
 * XREFs of ?vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x1C0244874
 * Callers:
 *     draw_clrt_f_ntb_o_to_temp_start @ 0x1C0244F20 (draw_clrt_f_ntb_o_to_temp_start.c)
 * Callees:
 *     <none>
 */
      ...
      if ( v9 )
      {
        ...
        do
        {
          ...
          if ( *v10 )
          {
            if ( v12 )
            {
              v13 = LOBYTE(v11[*v10]) + LOBYTE(v11[v12]);
              v14 = BYTE1(v11[*v10]) + BYTE1(v11[v12]);
              v15 = BYTE2(v11[*v10]) + BYTE2(v11[v12]);
              if ( v13 > 6 )
                v13 = 6;
              if ( v14 > 6 )
                v14 = 6;
