/*
 * XREFs of ?MoveRect@@YAHPEAU_MOVESIZEDATA@@KW4_MOVERECT_STYLE@@@Z @ 0x1C01C1160
 * Callers:
...
LABEL_12:
  ...
  v21 = *(_QWORD *)(v17 + 168);
  v18 = TransformRegionBetweenCoordinateSpaces(v15, v16, &v21);
  v19 = GreRectInRegion(v21, v3);
  if ( v18 )
    GreDeleteObject(v21);
  return v19;
}
