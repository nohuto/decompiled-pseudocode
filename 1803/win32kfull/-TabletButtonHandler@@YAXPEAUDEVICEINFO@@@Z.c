/*
 * XREFs of ?TabletButtonHandler@@YAXPEAUDEVICEINFO@@@Z @ 0x1C01A6650
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v5 )
    {
      Usages = HidP_GetUsages(
                 ...
                 *(PCHAR *)(*((_QWORD *)a1 + 58) + 24LL),
                 ReportLength);
      if ( dword_1C03200AC != 10 )
      {
        if ( Usages >= 0 && (v12 = 0LL, UsageLength[0]) )
        {
          while ( v5[v12] - 1 != dword_1C03200AC )
          {
...
LABEL_17:
      ...
      if ( (unsigned int)(*(_DWORD *)v9 + 2147483636) <= 1 )
      {
        ...
        v11 = 0;
LABEL_25:
        gtmridTabletButtonTimer = SetRITTimer(gtmridTabletButtonTimer, v10, (int)xxxTabletButtonTimerCallback, v11);
        goto LABEL_34;
      }
