/*
 * XREFs of ?GetPointerInfoByPointerId@Pointer@@YAJIPEAPEBUtagPOINTER_INFO@@@Z @ 0x1C01F996C
 * Callers:
...
__int64 __fastcall Pointer::GetPointerInfoByPointerId(Pointer *this, _QWORD *a2, const struct tagPOINTER_INFO **a3)
{
  ...
  *a2 = 0LL;
  v3 = (__int16)this;
  ThreadWin32Thread = (struct _LIST_ENTRY *)W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), (__int64)a2);
  ThreadPointerData = GetThreadPointerData(ThreadWin32Thread + 67, v3, &v9, 0LL);
