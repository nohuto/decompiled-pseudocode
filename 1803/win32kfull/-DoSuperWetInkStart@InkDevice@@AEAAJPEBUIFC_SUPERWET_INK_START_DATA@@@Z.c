/*
 * XREFs of ?DoSuperWetInkStart@InkDevice@@AEAAJPEBUIFC_SUPERWET_INK_START_DATA@@@Z @ 0x1C020EB2C
 * Callers:
...
__int64 __fastcall InkDevice::DoSuperWetInkStart(InkDevice *this, const struct IFC_SUPERWET_INK_START_DATA *a2)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      if ( (unsigned int)pRelatedActivityId > 4 )
      {
        ...
        v76 = &v21;
        v21 = -__CFSHR__(v12, 3);
        TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3F4D, v14, v13, 0x1Bu, &v28);
      }
    }
  ...
  else if ( (unsigned int)pRelatedActivityId > 2 )
  {
    ...
    v27 = 46LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_1C02E3E0E, v6, (LPCGUID)4, 4u, &pData);
  }
  return v7;
}
