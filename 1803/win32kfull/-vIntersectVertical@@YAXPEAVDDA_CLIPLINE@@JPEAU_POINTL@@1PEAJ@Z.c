/*
 * XREFs of ?vIntersectVertical@@YAXPEAVDDA_CLIPLINE@@JPEAU_POINTL@@1PEAJ@Z @ 0x1C029EBF8
 * Callers:
 ...
 *     ?yCompute@DDA_CLIPLINE@@QEAAJJ@Z @ 0x1C029EFE4 (-yCompute@DDA_CLIPLINE@@QEAAJJ@Z.c)
 */
