/*
 * XREFs of ?bUnloadAllButPermanentFonts@PFTOBJ@@QEAAHH@Z @ 0x1C00C8B3C
 * Callers:
 ...
 *     ?vKill@PFFOBJ@@QEAAXXZ @ 0x1C0080F4C (-vKill@PFFOBJ@@QEAAXXZ.c)
        ...
        i = *(_QWORD *)this + 8LL * *(unsigned int *)(*(_QWORD *)this + 24LL) + 40 )
  {
    ...
    if ( *v7 )
    {
      do
      {
        ...
        *((_QWORD *)v8 + 1) = v16;
        if ( !v16 )
          *((_DWORD *)v8 + 10) = bKillPFFOBJ((PFFOBJ *)v23, (struct PFFCLEANUP *)(v8 + 16));
        v8 += 48;
        v17 = v10;
      }
      while ( v10 );
