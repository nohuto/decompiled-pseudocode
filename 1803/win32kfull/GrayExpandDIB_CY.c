/*
 * XREFs of GrayExpandDIB_CY @ 0x1C0237770
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall GrayExpandDIB_CY(_OWORD *a1)
{
  ...
  unsigned __int64 v76; // [rsp+A8h] [rbp-60h]
  ...
  void (__fastcall *v86)(int *); // [rsp+188h] [rbp+80h]
  ...
  void (__fastcall *v89)(__int64, __int64, const void *, __int64, int); // [rsp+1E8h] [rbp+E0h]
  ...
  *((_QWORD *)v2 + 10) = v10;
  ...
  v74.m256i_i64[1] = v17 + v74.m256i_i64[0];
  v19 = v17 + v74.m256i_i64[0] + v17;
  v20 = (const void *)(v19 + v17);
  v74.m256i_i64[2] = v19;
  v21 = (char *)(v19 + v17 + v17);
  v74.m256i_i64[3] = v19 + v17;
  v75 = (__int64)v21;
  v22 = v19 + v17 + v83;
  ...
  if ( (*(_BYTE *)(v91 + 8) & 1) != 0 )
  {
    v24 = GetFixupScan((unsigned int *)v81, v104);
  ...
  if ( v27 + v28 )
  {
    do
    {
      ...
      if ( v32 <= 0 )
      {
        v36 = GetFixupScan((unsigned int *)v81, v104);
        v35 = &v16[Size];
      ...
      else
      {
        ...
        do
        {
          v38 = (6 * (unsigned __int8)v33[v37] - (unsigned __int8)*v33 - *v16) >> 2;
          if ( ((6 * (unsigned __int8)v33[v37] - (unsigned __int8)*v33 - *v16) & 0x3FC00) != 0 )
    ...
    do
    {
      ...
      if ( (*v40 & 0x8000u) != 0LL )
      {
        ...
        *(_OWORD *)v74.m256i_i8 = *(_OWORD *)&v74.m256i_u64[1];
        ...
        v74.m256i_i64[3] = v75;
        v75 = (__int64)v16;
        v47 = GetFixupScan((unsigned int *)v81, v104);
        ...
        {
          v48 = v74.m256i_i64[3] - (_QWORD)v45;
          do
          {
            v49 = (6 * (unsigned __int8)v46[v48] - (unsigned __int8)*v46 - *v16) >> 2;
            if ( ((6 * (unsigned __int8)v46[v48] - (unsigned __int8)*v46 - *v16) & 0x3FC00) != 0 )
      ...
      if ( (_WORD)v42 )
      {
        ...
        v58 = (unsigned __int8 *)v74.m256i_i64[1];
        do
        {
          v59 = *(_DWORD *)(v15 + 4LL * v16[(_QWORD)v58 - v74.m256i_i64[1]])
              + *(_DWORD *)(v15 + 4LL * ((unsigned int)v58[v74.m256i_i64[0] - v74.m256i_i64[1]] + 256))
              + *(_DWORD *)(v15 + 4LL * ((unsigned int)v58[v19 - v74.m256i_i64[1]] + 768));
          v60 = *v58++;
          *v51 = (*(_DWORD *)(v15 + 4LL * (unsigned int)(v60 + 512)) + v59) >> 5;
          v51 = (_WORD *)((char *)v51 + v111);
        }
        while ( v51 != v110 );
        v41 = v74.m256i_i64[1];
      }
      else if ( WORD1(v73) )
      {
        ...
        v62 = (unsigned __int8 *)v74.m256i_i64[0];
        do
        {
          v63 = *(_DWORD *)(v15 + 4LL * ((unsigned int)v62[v41 - v74.m256i_i64[0]] + 512))
              + *(_DWORD *)(v15 + 4LL * ((unsigned int)v62[v19 - v74.m256i_i64[0]] + 768));
          v64 = *v62++;
          *v51 = (*(_DWORD *)(v15 + 4LL * (unsigned int)(v64 + 256)) + v63) >> 5;
          v51 = (_WORD *)((char *)v51 + v111);
        }
        while ( v51 != v110 );
      }
      else if ( WORD2(v73) )
      {
        ...
        do
        {
          v66 = (unsigned int)v53[v41 - v19] + 512;
          v67 = (unsigned int)*v53++ + 768;
          *v51 = (*(_DWORD *)(v15 + 4 * v67) + *(_DWORD *)(v15 + 4 * v66)) >> 5;
          v51 = (_WORD *)((char *)v51 + v111);
        }
        while ( v51 != v110 );
      }
      else
      {
        ...
        {
          v68 = *v53++;
          *v51 = *(int *)(v15 + 4LL * (unsigned int)(v68 + 768)) >> 5;
          v51 = (_WORD *)((char *)v51 + v111);
        }
        while ( v51 != v110 );
      }
