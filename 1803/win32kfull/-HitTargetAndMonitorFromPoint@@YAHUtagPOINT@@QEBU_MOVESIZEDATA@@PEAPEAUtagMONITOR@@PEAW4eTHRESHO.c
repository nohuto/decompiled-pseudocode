/*
 * XREFs of ?HitTargetAndMonitorFromPoint@@YAHUtagPOINT@@QEBU_MOVESIZEDATA@@PEAPEAUtagMONITOR@@PEAW4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01C0CAC
 * Callers:
 ...
 *     ?PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C01C13A4 (-PtInRectSpace@@YAHPEBUtagRECT@@UtagPOINT@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z.c)
 */
        ...
        enum eTHRESHOLD_MARGIN_DIRECTION *a4)
{
  ...
  v8 = (unsigned int)v6;
  v9 = *((_BYTE *)v21[0] + 4 * v6 + 537);
  v10 = *((_BYTE *)v21[0] + 4 * v6 + 538);
  v11 = *((_BYTE *)v21[0] + 4 * v8 + 539);
  if ( v7 )
  {
    if ( !v9 )
      v9 = gWinArrGlobal[dword_1C02DE5B4[4 * (unsigned int)v8]];
    if ( !v10 )
      v10 = gWinArrGlobal[dword_1C02DE5B8[4 * v8]];
    if ( !v11 )
      v11 = gWinArrGlobal[dword_1C02DE5BC[4 * v8]];
  }
  v12 = v22;
