/*
 * XREFs of ?RedirTextOut@@YAHPEAU_SURFOBJ@@PEAU_STROBJ@@PEAU_FONTOBJ@@PEAU_CLIPOBJ@@PEAU_RECTL@@4PEAU_BRUSHOBJ@@5PEAU_POINTL@@K@Z @ 0x1C026D480
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (*(_DWORD *)(v17 + 40) & 0x20000) != 0 )
        {
          for ( i = **(_QWORD ***)(v17 + 1792); i; i = (_QWORD *)*i )
          {
            ...
            if ( v19 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v19 + 1784) + 248LL) )
                {
                  MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                    (MARK_ACCDRV_NOTIFICATION *)&v23,
                    (struct PDEVOBJ *)&HDEV,
                    a1);
                  (*(void (__fastcall **)(struct _SURFOBJ *, STROBJ *, FONTOBJ *, CLIPOBJ *, RECTL *, RECTL *, BRUSHOBJ *, BRUSHOBJ *, POINTL *, MIX))(*(_QWORD *)(v20 + 1784) + 248LL))(
                    a1,
                    pstro,
                    pfo,
                    pco,
