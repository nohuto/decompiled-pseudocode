/*
 * XREFs of ?GenerateCtrlInputMessages@InteractiveControlInput@@IEAAJPEAUtagWND@@I@Z @ 0x1C0212AC4
 * Callers:
...
LABEL_11:
      if ( !_PostTransformableMessageExtended((__int64)a2, v8, v9, v7, (struct tagINPUT_MESSAGE_SOURCE *)&v11, 1) )
