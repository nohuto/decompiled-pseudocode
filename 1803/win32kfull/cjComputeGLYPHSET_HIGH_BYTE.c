/*
 * XREFs of cjComputeGLYPHSET_HIGH_BYTE @ 0x1C021AEC4
 * Callers:
...
__int64 __fastcall cjComputeGLYPHSET_HIGH_BYTE(_WORD *a1, ULONG **a2, __int64 a3)
{
  ...
  do
  {
    v9 = __ROR2__(*v6, 8);
    if ( v9 )
      v7 += (unsigned __int16)__ROR2__(*(_WORD *)((char *)v3 + v9 + 2), 8);
    ++v6;
    --v8;
  }
  while ( v8 );
  ...
  do
  {
    ...
    {
      v14 = __ROR2__(
              *(_WORD *)((char *)&v3[v12 - (unsigned __int16)__ROR2__(*v3, 8) + 3] + (unsigned __int16)__ROR2__(v3[3], 8)),
              8);
      v15 = v14;
      if ( v14 )
      {
