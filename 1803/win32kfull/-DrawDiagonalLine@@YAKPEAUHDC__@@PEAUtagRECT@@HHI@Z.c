/*
 * XREFs of ?DrawDiagonalLine@@YAKPEAUHDC__@@PEAUtagRECT@@HHI@Z @ 0x1C022B550
 * Callers:
 *     ?DrawDiagonal@@YAHPEAUHDC__@@PEAUtagRECT@@PEAUHBRUSH__@@2I@Z @ 0x1C022B490 (-DrawDiagonal@@YAHPEAUHDC__@@PEAUtagRECT@@PEAUHBRUSH__@@2I@Z.c)
 *     ?FillTriangle@@YAHPEAUHDC__@@PEAUtagRECT@@PEAUHBRUSH__@@I@Z @ 0x1C022B7BC (-FillTriangle@@YAHPEAUHDC__@@PEAUtagRECT@@PEAUHBRUSH__@@I@Z.c)
 * Callees:
...
LABEL_28:
        if ( v8 )
          GrePolyPatBlt(v24, 15728673, (struct _POLYPATBLT *)v37, v8);
...
LABEL_24:
      ...
      *(_DWORD *)v19 -= v17;
      if ( v25 == 8 )
      {
        GrePolyPatBlt(v24, 15728673, (struct _POLYPATBLT *)v37, 8);
        v8 = 0;
        v25 = 0LL;
      }
      v10 = v36.m128i_i32[0];
