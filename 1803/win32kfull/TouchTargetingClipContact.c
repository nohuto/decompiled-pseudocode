/*
 * XREFs of TouchTargetingClipContact @ 0x1C022CFF0
 * Callers:
 ...
 *     ?_TTClip@@YAXPEAUtagTOUCHTARGETINGCONTACT@@JW4tagCLIP_SIDE@@@Z @ 0x1C022C99C (-_TTClip@@YAXPEAUtagTOUCHTARGETINGCONTACT@@JW4tagCLIP_SIDE@@@Z.c)
 */
