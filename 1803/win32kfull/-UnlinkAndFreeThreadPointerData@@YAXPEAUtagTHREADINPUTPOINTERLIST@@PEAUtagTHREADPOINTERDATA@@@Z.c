/*
 * XREFs of ?UnlinkAndFreeThreadPointerData@@YAXPEAUtagTHREADINPUTPOINTERLIST@@PEAUtagTHREADPOINTERDATA@@@Z @ 0x1C01B9BCC
 * Callers:
 *     xxxCleanupThreadPointerInputInfo @ 0x1C00E6660 (xxxCleanupThreadPointerInputInfo.c)
 *     EditionUnlinkAndFreeThreadPointerData @ 0x1C01BA790 (EditionUnlinkAndFreeThreadPointerData.c)
 * Callees:
 *     <none>
 */
