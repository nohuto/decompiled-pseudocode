/*
 * XREFs of ?TraceLoggingPTPSettingsConfigEvent@@YAXPEAUtagTPSETTINGS@@KHPEAG1HHUtagRECT@@2@Z @ 0x1C0199488
 * Callers:
        ...
        struct tagRECT *a9)
{
  ...
  int v55; // [rsp+1C0h] [rbp+C0h] BYREF
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000000uLL) )
    {
      ...
      v52 = 4LL;
      v54 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E2AB3, v13, v14, 0x13u, &pData);
    }
  }
}
