/*
 * XREFs of ?AcquireDeviceBackgroundAccess@InteractiveControlManager@@QEAAJKIIPEAUtagWND@@@Z @ 0x1C010398C
 * Callers:
        ...
        struct tagWND *a5)
{
  ...
  if ( dword_1C031C7D0 > 4u )
  {
    ...
    v15[0] = a5;
    v30 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C7D0, &unk_1C02E3899, (LPCGUID)a3, a4, 7u, &pData);
    a4 = (const GUID *)v33;
    a3 = v32;
  }
  ...
  if ( dword_1C031C7D0 > 4u )
  {
    ...
    v18 = 62;
    v21 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C7D0, &unk_1C02E3860, (LPCGUID)a3, a4, 4u, &pData);
  }
  return v13;
}
