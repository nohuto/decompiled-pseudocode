/*
 * XREFs of ?DrawGrip@@YAHPEAUHDC__@@PEAUtagRECT@@I@Z @ 0x1C01054B4
 * Callers:
...
__int64 __fastcall DrawGrip(HDC a1, struct tagRECT *a2, __int16 a3)
{
  ...
  v22[0] = left;
  v23 = v14;
  GrePolyPatBlt(a1, 15728673, (struct _POLYPATBLT *)v22, 1);
  v17 = GreSetTextColor(a1, v15);
  v18 = a3 & 0x10;
  v19 = L"x";
  if ( !v18 )
    v19 = L"o";
  GreExtTextOutWInternal(a1, v12, v13, 0, 0LL, v19, 1, 0LL, 0LL, 0);
  GreSetTextColor(a1, v16);
  v20 = L"y";
  if ( !v18 )
    v20 = L"p";
  GreExtTextOutWInternal(a1, v12, v13, 0, 0LL, v20, 1, 0LL, 0LL, 0);
