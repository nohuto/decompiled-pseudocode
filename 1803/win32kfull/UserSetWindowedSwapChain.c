/*
 * XREFs of UserSetWindowedSwapChain @ 0x1C0132514
 * Callers:
 *     UserSetWindowedSwapChainApiExt @ 0x1C0132500 (UserSetWindowedSwapChainApiExt.c)
 * Callees:
...
__int64 __fastcall UserSetWindowedSwapChain(__int64 a1, int a2, __int64 a3)
{
  ...
  void *v17; // rbp
  void *v19; // [rsp+20h] [rbp-28h] BYREF
  CSwapChainProp *v20; // [rsp+68h] [rbp+20h] BYREF
  ...
  LOBYTE(v14) = 1;
  v15 = v13;
  if ( (int)DxgkReferenceCompositionObjectForRead(a3, 1LL, v14, &v19) < 0 )
    goto LABEL_14;
