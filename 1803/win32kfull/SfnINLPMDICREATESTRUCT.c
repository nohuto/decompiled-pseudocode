/*
 * XREFs of SfnINLPMDICREATESTRUCT @ 0x1C01DBCF0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a7)
{
  ...
  int v56[5]; // [rsp+4Ch] [rbp-37Ch] BYREF
  __int128 v57; // [rsp+60h] [rbp-368h]
  __int64 v58; // [rsp+70h] [rbp-358h]
  unsigned int v59; // [rsp+78h] [rbp-350h]
  __int64 v60; // [rsp+88h] [rbp-340h]
  __int64 v61; // [rsp+90h] [rbp-338h]
  unsigned __int64 v62; // [rsp+98h] [rbp-330h] BYREF
  ULONG_PTR RegionSize; // [rsp+A0h] [rbp-328h] BYREF
  __int64 v64; // [rsp+A8h] [rbp-320h] BYREF
  volatile signed __int32 *v65; // [rsp+B0h] [rbp-318h]
  __int64 v66; // [rsp+B8h] [rbp-310h]
  __int64 v67; // [rsp+C0h] [rbp-308h]
  _QWORD v68[4]; // [rsp+E0h] [rbp-2E8h] BYREF
  ...
  if ( v52 + v53 >= v52 )
  {
    if ( v9 )
    {
      result = AllocCallbackMessage(144, v9, v16, v70, 1, 0x200uLL);
      v11 = result;
      v54 = result;
      if ( !result )
        return result;
...
LABEL_59:
          ...
          *((_QWORD *)v11 + 2) = 0LL;
          v42 = KeUserModeCallback(15LL, v11, *(unsigned int *)v11, &v62, v56);
...
LABEL_77:
  if ( v11 != (unsigned __int8 *)v69 && v11 != v70 )
  {
    ...
    PopAndFreeAlwaysW32ThreadLock((__int64)v68);
  }
