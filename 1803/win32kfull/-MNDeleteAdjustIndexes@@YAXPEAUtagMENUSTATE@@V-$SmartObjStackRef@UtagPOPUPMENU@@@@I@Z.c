/*
 * XREFs of ?MNDeleteAdjustIndexes@@YAXPEAUtagMENUSTATE@@V?$SmartObjStackRef@UtagPOPUPMENU@@@@I@Z @ 0x1C02059AC
 * Callers:
 ...
 *     ?NNDeleteAdjustIndex@@YAXPEAII@Z @ 0x1C0205A34 (-NNDeleteAdjustIndex@@YAXPEAII@Z.c)
 */
