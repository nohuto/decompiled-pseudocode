/*
 * XREFs of ?Initialize@SimpleHapticsController@@QEAAJPEAU_UNICODE_STRING@@@Z @ 0x1C02143C8
 * Callers:
...
__int64 __fastcall SimpleHapticsController::Initialize(SimpleHapticsController *this, struct _UNICODE_STRING *a2)
{
  ...
  if ( (unsigned int)dword_1C031C790 > 4 )
  {
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E42F8, v4, v5, 3u, &pData);
  }
  if ( !a2 )
  {
...
LABEL_6:
      ...
      else
      {
        if ( (unsigned int)dword_1C031C790 > 2 )
        {
          ...
          v28 = 17LL;
          v30 = 4LL;
          TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E4170, v13, v14, 4u, &pData);
...
LABEL_30:
  if ( (unsigned int)dword_1C031C790 > 4 )
  {
    ...
    v30 = 4LL;
    v32 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E42B1, v4, v5, 5u, &pData);
  }
