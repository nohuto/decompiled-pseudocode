/*
 * XREFs of ?RedirStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C026CB70
 * Callers:
 *     <none>
 * Callees:
          ...
          if ( v16 )
          {
            do
            {
              ...
              if ( v17 )
              {
                ...
                {
                  if ( *(_QWORD *)(*(_QWORD *)(v17 + 1784) + 224LL) )
                  {
