/*
 * XREFs of ?xxxCreateDesktopEx2@@YAJPEAUtagWINDOWSTATION@@PEAU_ACCESS_STATE@@DPEAU_UNICODE_STRING@@KPEAPEAX@Z @ 0x1C0107340
 * Callers:
 ...
 *     GetDesktopHeapSize @ 0x1C01077E0 (GetDesktopHeapSize.c)
        ...
        *((_QWORD *)Objecta + 15) = DesktopHeap;
        if ( *((_QWORD *)Objecta + 15) )
        {
          *((_DWORD *)Objecta + 34) = DesktopHeapSize;
          ...
          if ( v19 )
          {
            v20 = (_QWORD *)Win32AllocPoolZInit(256LL, 1684763477LL);
            if ( v20 )
            {
              v21 = gdwDesktopId;
              *v20 = v19;
