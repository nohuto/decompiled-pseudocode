/*
 * XREFs of ??_GCPhysicalMonitorHandle@@UEAAPEAXI@Z @ 0x1C023D540
 * Callers:
 *     <none>
 * Callees:
 *     ?Destroy@CPhysicalMonitorHandle@@UEAAJXZ @ 0x1C023E5A0 (-Destroy@CPhysicalMonitorHandle@@UEAAJXZ.c)
 */
