/*
 * XREFs of STROBJ_bGetAdvanceWidths @ 0x1C028D6C0
 * Callers:
 *     NtGdiSTROBJ_bGetAdvanceWidths @ 0x1C02857B0 (NtGdiSTROBJ_bGetAdvanceWidths.c)
 * Callees:
 *     ?STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z @ 0x1C028BC10 (-STROBJ_bGetAdvanceWidthsLinked@@YAHPEAVESTROBJ@@KKPEAU_POINTQF@@@Z.c)
 */
...
BOOL __stdcall STROBJ_bGetAdvanceWidths(STROBJ *pso, ULONG iFirst, ULONG c, POINTQF *pptqD)
{
  ...
  v9 = v8 + 24LL * c;
  if ( *(_DWORD *)(**(_QWORD **)&pso[1].ulCharInc + 628LL) )
  {
    while ( v8 < v9 )
    {
