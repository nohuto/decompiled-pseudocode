/*
 * XREFs of CheckEasPolicyChange @ 0x1C01A2560
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C032FBA8 != KeyInformation[0] )
  {
    qword_1C032FBA8 = KeyInformation[0];
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C032FBA0 != KeyInformation[0] )
  {
    qword_1C032FBA0 = KeyInformation[0];
    return 1;
  }
  return v0;
}
