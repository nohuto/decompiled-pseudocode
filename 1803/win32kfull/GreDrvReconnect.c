/*
 * XREFs of GreDrvReconnect @ 0x1C028E1BC
 * Callers:
...
__int64 __fastcall GreDrvReconnect(__int64 a1)
{
  ...
  do
  {
    ...
    if ( *((_QWORD *)v4 + 2) && *((_DWORD *)v4 + 6) == 1 && *(_QWORD *)(*((_QWORD *)v4 + 112) + 632LL) )
    {
      ...
      for ( i = gppdevList; v3 >= 0 && i && *((struct _LDEV **)i + 223) == v4; i = *(struct PDEV **)i )
      {
        v13 = i;
        if ( (*((_DWORD *)i + 10) & 1) != 0 )
        {
          ...
          PDEVOBJ::vSync(
            (PDEVOBJ *)&v13,
            (struct _SURFOBJ *)((*((_QWORD *)v13 + 318) + 24LL) & -(__int64)(*((_QWORD *)v13 + 318) != 0LL)),
            0LL,
            0);
          if ( !v5 )
          {
          ...
          {
            v8 = (void (__fastcall *)(_QWORD, __int64 *, _QWORD, _QWORD, _DWORD))*((_QWORD *)v13 + 357);
            if ( v8 )
              v8(*((_QWORD *)v13 + 224), &v14, 0LL, 0LL, *(_DWORD *)(v7 + 28));
          }
      ...
      if ( !v5 && v3 >= 0 )
      {
        SEMOBJEX::SEMOBJEX((SEMOBJEX *)v11, ghsemSprite, 5, ghsemHT, 6u, ghsemDriverMgmt, 0xCu, 0LL, 0, 0LL, 0, 0LL, 0);
        v2 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)v4 + 112) + 632LL))(
               *(_QWORD *)(a1 + 24),
               *(_QWORD *)(a1 + 16));
        if ( v2 )
