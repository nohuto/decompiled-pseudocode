/*
 * XREFs of ?vCharPos_G3@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJJJJPEAJ2@Z @ 0x1C028C730
 * Callers:
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a3 + 628LL) )
  {
    ...
    else
    {
      ...
      *v21 = 0;
      ...
      if ( v22 )
      {
        v23 = *(_QWORD *)a3;
        v72 = 0;
        bFToL((float)v22 * *(float *)(v23 + 432), &v72, 0);
        *((_DWORD *)this + 29) = v72;
      }
      if ( bCalcBreakExtra(*(_DWORD *)(*(_QWORD *)a3 + 432LL), a7, a8, v21) )
      {
        v24 = *(_QWORD *)a3;
        vGenWidths(
          &v59,
    ...
    *(_QWORD *)&v67[1] = 0x8000000080000000uLL;
    ...
    if ( (unsigned int)RFONTOBJ::bGetGlyphMetricsPlus(a3, v33, v26, v28, &v72, a2, this) )
    {
      ...
      if ( (*(_DWORD *)(*(_QWORD *)a3 + 260LL) & 0x10) == 0 || (LOBYTE(v72) = 1, (v34 & 0x1400) != 0) )
        LOBYTE(v72) = 0;
      v35 = 0;
      if ( *(_DWORD *)this )
      {
