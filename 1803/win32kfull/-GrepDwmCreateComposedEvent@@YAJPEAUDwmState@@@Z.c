/*
 * XREFs of ?GrepDwmCreateComposedEvent@@YAJPEAUDwmState@@@Z @ 0x1C00B74D0
 * Callers:
 ...
 *     ?RtlStringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C00B7784 (-RtlStringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
 */
