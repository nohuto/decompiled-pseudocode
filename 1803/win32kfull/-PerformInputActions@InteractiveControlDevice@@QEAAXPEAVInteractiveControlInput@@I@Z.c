/*
 * XREFs of ?PerformInputActions@InteractiveControlDevice@@QEAAXPEAVInteractiveControlInput@@I@Z @ 0x1C0211CF8
 * Callers:
  ...
  if ( *((_QWORD *)this + 43) != -1LL )
  {
    ...
    if ( (a3 & 0x400) != 0 || (a3 & 0x1000) != 0 )
    {
      ...
      if ( v14 )
      {
        v15 = *((_QWORD *)this + 43);
        if ( v15 != -1 )
          RIMUpdatePointerDeviceDeadzoneOrigin(v14 + 80, v15, *((_QWORD *)a2 + 8));
      }
      if ( (a3 & 0x400) != 0 )
        goto LABEL_20;
    }
...
LABEL_20:
      ...
      if ( v16 )
      {
        ...
        if ( v17 != -1 )
        {
          ...
          RIMActivatePointerDeviceDeadzone(v16 + 80, v17, v3);
        }
      }
    }
  }
