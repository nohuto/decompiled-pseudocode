/*
 * XREFs of ?Dump@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAU_DUMP_CONTEXT@2@@Z @ 0x1C02AE038
 * Callers:
        ...
        struct NSInstrumentation::_DUMP_CONTEXT *a2)
{
  ...
  if ( v2 )
  {
    ...
    if ( v4 )
    {
      ...
      if ( !v6 )
      {
        v7 = *((_QWORD *)gpLeakTrackingAllocator + 7);
        if ( v7 )
  ...
  {
    v3 = (NSInstrumentation::CPrioritizedWriterLock *)*((_QWORD *)gpLeakTrackingAllocator + 8);
    if ( v3 )
