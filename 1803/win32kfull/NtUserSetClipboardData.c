/*
 * XREFs of NtUserSetClipboardData @ 0x1C00B5F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetClipboardData(unsigned int a1, __int64 a2, _QWORD *a3)
{
  ...
  {
    v8 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 760LL) + 24LL) & 4;
    v7 = 0;
  }
  else
  {
  ...
  if ( !v8
    && (!*(_DWORD *)(PsGetCurrentProcessWin32Process(gptiCurrent) + 876)
     || ((v14 = gptiCurrent, v15 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 448LL) + 40LL), gpqForeground)
