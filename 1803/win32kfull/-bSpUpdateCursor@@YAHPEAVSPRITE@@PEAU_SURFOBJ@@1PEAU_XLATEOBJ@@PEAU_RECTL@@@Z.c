/*
 * XREFs of ?bSpUpdateCursor@@YAHPEAVSPRITE@@PEAU_SURFOBJ@@1PEAU_XLATEOBJ@@PEAU_RECTL@@@Z @ 0x1C024E528
 * Callers:
...
LABEL_8:
    ...
    *((_QWORD *)a1 + 15) = v12;
    ...
    if ( v19 )
    {
      bSpCreateShape(a1, &gptlZero, v19, v20, a5, *(struct PALETTE **)(v11 + 1800), 0, 0, 0LL);
