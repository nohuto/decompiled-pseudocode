/*
 * XREFs of ?bLoadDeviceFontTable@PFFMEMOBJ@@QEAAHPEAVPDEVOBJ@@@Z @ 0x1C02898D4
 * Callers:
...
LABEL_22:
  ...
  {
LABEL_36:
    if ( v11 && *(_QWORD *)(*(_QWORD *)a2 + 3016LL) )
      PDEVOBJ::Free(a2, v11, v15);
  }
LABEL_30:
  if ( v10 && *(_QWORD *)(*(_QWORD *)a2 + 3016LL) )
