/*
 * XREFs of ?xxxSendMousePromotion@@YAXAEBUtagMOUSE_PROMOTION_ENTRY@@H@Z @ 0x1C01CDF18
 * Callers:
...
void __fastcall xxxSendMousePromotion(const struct tagMOUSE_PROMOTION_ENTRY *a1, int a2)
{
  ...
  *((_QWORD *)&v28 + 1) = v2;
  ...
  if ( (_DWORD)v8 != (_DWORD)v7 )
    DWORD1(v28) = 0xFFFF * (v5 - (int)v7) / ((int)v8 - (int)v7) + 1;
  v9 = HIDWORD(v7);
  if ( HIDWORD(v8) != (_DWORD)v9 )
    DWORD2(v28) = (int)(0xFFFF * (v2 - v9)) / (HIDWORD(v8) - (int)v9) + 1;
  ...
  if ( v13 == 3 )
  {
    ...
    HIDWORD(v28) = v15;
    if ( (v16 & 0x40) != 0 )
      HIDWORD(v28) = v15 | 0x80;
  }
  else if ( v13 == 2 )
  {
    v17 = *((unsigned __int16 *)a1 + 20);
    WORD1(v27) |= 0x10u;
    HIDWORD(v28) = v12 | v17 | 0x80;
  }
  v18 = *((_DWORD *)a1 + 11);
  v19 = 0;
  v20 = 0;
