/*
 * XREFs of DxgkEngDetectGDIPath @ 0x1C0243480
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?OverlapCheck@@YAHPEAUHDEV__@@PEAUHRGN__@@@Z @ 0x1C0242614 (-OverlapCheck@@YAHPEAUHDEV__@@PEAUHRGN__@@@Z.c)
 *     ?StateFlags@PDEVOBJ@@QEBAKXZ @ 0x1C02426D0 (-StateFlags@PDEVOBJ@@QEBAKXZ.c)
 */
...
__int64 __fastcall DxgkEngDetectGDIPath(__int64 a1, HDEV a2, HWND a3, HRGN a4)
{
  ...
  else
  {
      ...
      for ( i = (HDEV)hdevEnumerate(0LL); i; i = (HDEV)hdevEnumerate(i) )
      {
        ...
        if ( *((HDEV *)i + 3) == a2 )
        {
          ...
          if ( (v11 & 0x400) == 0 && (v11 & 0x20000) == 0 && !v9 )
          {
            ...
            {
              if ( *(_QWORD *)(*((_QWORD *)i + 321) + 240LL) == a1 && *((_DWORD *)i + 538) > 8u )
    ...
    else if ( *(_QWORD *)(*((_QWORD *)a2 + 321) + 240LL) == a1 && *((_DWORD *)a2 + 538) > 8u )
    {
