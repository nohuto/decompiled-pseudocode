/*
 * XREFs of ?MulSaveScreenBits@@YA_KPEAU_SURFOBJ@@K_KPEAU_RECTL@@@Z @ 0x1C0273BC0
 * Callers:
  ...
  if ( a2 )
  {
    ...
    do
    {
      ...
      if ( v23 )
      {
        ...
        if ( v19 != 2
          || (v13 = *(unsigned __int64 (**)(struct _SURFOBJ *, unsigned int, unsigned __int64, struct _RECTL *))(v12 + 3000)) == 0LL )
        {
    ...
    if ( v5 )
    {
      while ( 1 )
      {
        if ( bIntersect(a4, (const struct _RECTL *)((char *)v7 + 28), &v24) )
        {
          ...
          if ( *(_QWORD *)(v7[6] + 3000) )
            v9 = *(unsigned __int64 (**)(struct _SURFOBJ *, unsigned int, unsigned __int64, struct _RECTL *))(v7[6] + 3000);
          v18 = v9;
