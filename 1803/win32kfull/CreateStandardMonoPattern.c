/*
 * XREFs of CreateStandardMonoPattern @ 0x1C012A568
 * Callers:
 *     GetCachedSMP @ 0x1C00D362C (GetCachedSMP.c)
 *     FindCachedSMP @ 0x1C00D37FC (FindCachedSMP.c)
 * Callees:
...
LABEL_37:
    ...
    if ( v5 != 1 )
    {
      ...
      if ( (unsigned __int16)(((v37 * (unsigned int)v40 + 5) / 0xA - v36 + 50) / 0x64) < (unsigned __int16)v17 )
        v24 = ((v37 * (unsigned int)v40 + 5) / 0xA - v36 + 50) / 0x64;
      if ( v24 )
        v25 = v24;
      memset(&Src[v35 * (((unsigned __int16)v17 - v25) >> 1)], 255, v25 * v35);
    }
    goto LABEL_37;
  }
