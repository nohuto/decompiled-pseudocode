/*
 * XREFs of SetAppCompatFlags @ 0x1C00C1A00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  else
  {
    ...
    ProbeForRead((volatile void *)(unsigned int)v24, 0x470uLL, 4u);
    v25 = *(_QWORD *)(v24 + 480);
  }
  a1[80] = v25;
