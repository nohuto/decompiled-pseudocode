/*
 * XREFs of ?DetermineMessageCreationFlags@InteractiveControlDevice@@QEAAIPEAVInteractiveControlInput@@0@Z @ 0x1C0211508
 * Callers:
        ...
        struct InteractiveControlInput *a3)
{
  ...
  if ( a2 )
  {
    ...
    if ( *((_DWORD *)a3 + 14) != *((_DWORD *)a2 + 14)
      ...
      || (((unsigned __int8)v11 ^ (unsigned __int8)v9) & 2) != 0 )
    {
      v12 = v9 & 2;
      if ( (v12 != 0) == ((v11 >> 1) & 1) )
      {
