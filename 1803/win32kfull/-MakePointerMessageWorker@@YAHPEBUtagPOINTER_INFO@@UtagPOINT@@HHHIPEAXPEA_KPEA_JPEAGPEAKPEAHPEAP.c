/*
 * XREFs of ?MakePointerMessageWorker@@YAHPEBUtagPOINTER_INFO@@UtagPOINT@@HHHIPEAXPEA_KPEA_JPEAGPEAKPEAHPEAPEAUHWND__@@@Z @ 0x1C01B96C8
 * Callers:
    ...
    if ( a6 != 587 )
    {
      ...
      if ( a6 > 0x240 )
      {
        if ( a6 <= 0x243 )
        {
          v22 = a3;
LABEL_17:
          v23 = v19 | (unsigned __int64)(unsigned int)(v22 << 16);
LABEL_18:
          *a8 = v23;
