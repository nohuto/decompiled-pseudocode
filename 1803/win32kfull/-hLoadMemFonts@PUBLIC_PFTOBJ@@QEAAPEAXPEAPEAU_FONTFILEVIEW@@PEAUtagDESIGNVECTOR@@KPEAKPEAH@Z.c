/*
 * XREFs of ?hLoadMemFonts@PUBLIC_PFTOBJ@@QEAAPEAXPEAPEAU_FONTFILEVIEW@@PEAUtagDESIGNVECTOR@@KPEAKPEAH@Z @ 0x1C023F958
 * Callers:
        ...
        int *a6)
{
  ...
  unsigned int v21; // [rsp+84h] [rbp-7Ch]
  unsigned __int64 v22; // [rsp+88h] [rbp-78h] BYREF
  HDEV v23; // [rsp+90h] [rbp-70h] BYREF
  _QWORD v24[3]; // [rsp+98h] [rbp-68h] BYREF
  void *v25; // [rsp+B0h] [rbp-50h] BYREF
  HDEV v26; // [rsp+B8h] [rbp-48h] BYREF
  _BYTE v27[8]; // [rsp+C0h] [rbp-40h] BYREF
  int *v28; // [rsp+C8h] [rbp-38h]
  struct PFF **v29; // [rsp+D0h] [rbp-30h] BYREF
  ...
  {
    vLoadFontFileView(0LL, 0, v6, 1LL, &v25, &v20, a3, a4, &v22, (struct PDEV **)&v23, (struct _FNTCHECKSUM *)v27);
    v26 = v23;
    if ( v22 )
    {
