/*
 * XREFs of EngStretchBlt @ 0x1C00A2F70
 * Callers:
...
LABEL_12:
            ...
            if ( (*(_DWORD *)(v17 + 112) & 0x400) != 0 )
              (*(void (__fastcall **)(SURFOBJ *, SURFOBJ *, _QWORD, XLATEOBJ *const, RECTL *, POINTL *))(v18 + 2832))(
                psoDest,
                v32,
                0LL,
                xloIdent,
            ...
            while ( (unsigned int)v35 < v29->cjBits )
            {
              if ( pvBits[v35] != v36[v35] )
              {
                ...
                if ( v37 == 1 )
                {
                  __debugbreak();
                  if ( (*(_DWORD *)(v17 + 112) & 0x400) != 0 )
                    v38 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(v18 + 2832);
                  else
                    v38 = EngCopyBits;
