/*
 * XREFs of ?TryResurrectPffApcRoutine@UmfdHostLifeTimeManager@@CAXPEAX00@Z @ 0x1C02901F0
 * Callers:
 ...
 *     ?HFFToPPFF@PFTOBJ@@QEAAPEAVPFF@@_K@Z @ 0x1C023F0FC (-HFFToPPFF@PFTOBJ@@QEAAPEAVPFF@@_K@Z.c)
...
void __fastcall UmfdHostLifeTimeManager::TryResurrectPffApcRoutine(void *a1, _BYTE *a2, struct PFF *a3)
{
  ...
  if ( a2 )
  {
    ...
    {
      if ( *((struct PDEV **)a3 + 11) == qword_1C032FD38
        && a2[12]
        && a2[13] != 1
