/*
 * XREFs of ?UpdateAutoRotationRegistrySetting@CLegacyRotationMgr@@AEAAJKPEBGK0@Z @ 0x1C00BE0DC
 * Callers:
 *     ?AutoRotationUpdateRegistry@CLegacyRotationMgr@@UEAAXXZ @ 0x1C00BDC50 (-AutoRotationUpdateRegistry@CLegacyRotationMgr@@UEAAXXZ.c)
