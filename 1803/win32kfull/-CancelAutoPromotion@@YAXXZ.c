/*
 * XREFs of ?CancelAutoPromotion@@YAXXZ @ 0x1C01CCCF0
 * Callers:
...
void CancelAutoPromotion(void)
{
  ...
  if ( (unsigned int)FindMousePromotionInContactRange(
                       (const struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0326BC0,
                       dword_1C0326B44,
                       &v3,
                       &v2) )
  {
    ...
    ExtractRangeFromQueue(
      (struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0326BC0,
  ...
  else
  {
    ...
    if ( v0 )
    {
      *(_OWORD *)v0 = xmmword_1C0326BD0;
      *(_OWORD *)(v0 + 16) = xmmword_1C0326BE0;
      *(_OWORD *)(v0 + 32) = xmmword_1C0326BF0;
      *(_DWORD *)(v0 + 20) = 303104;
