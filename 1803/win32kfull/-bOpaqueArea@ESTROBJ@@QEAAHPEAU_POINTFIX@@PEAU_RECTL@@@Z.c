/*
 * XREFs of ?bOpaqueArea@ESTROBJ@@QEAAHPEAU_POINTFIX@@PEAU_RECTL@@@Z @ 0x1C0094290
 * Callers:
...
__int64 __fastcall ESTROBJ::bOpaqueArea(ESTROBJ *this, struct _POINTFIX *a2, struct _RECTL *a3)
{
  ...
  if ( (*((_DWORD *)this + 1) & 2) != 0 )
  {
    ...
    a3->right = v7;
    v8 = *((_QWORD *)this + 7);
    if ( (*(_DWORD *)(*(_QWORD *)v8 + 12LL) & 0x2000) != 0 && (*(_DWORD *)(*(_QWORD *)v8 + 460LL) & 6) != 0 )
    {
      a3->right = v7 + 1;
      *((_DWORD *)this + 1) &= ~0x10u;
    }
  ...
  if ( (unsigned int)EFLOAT::bIsZero(v12) && (unsigned int)EFLOAT::bIsZero((EFLOAT *)v13) )
  {
    ...
    if ( *(float *)v14 >= 0.0 )
    {
      a3->left = v21 + (*((int *)this + 24) >> 4);
      v22 = ((*((_DWORD *)this + 26) + 15) >> 4) + v21;
    }
    else
    {
      a3->left = v21 - ((*((_DWORD *)this + 26) + 15) >> 4);
      v22 = v21 - (*((int *)this + 24) >> 4);
    }
    a3->right = v22;
    v23 = (*((_DWORD *)this + 19) + 8) >> 4;
    if ( *(float *)(v13 + 4) >= 0.0 )
    {
      a3->top = v23 + (*((int *)this + 27) >> 4);
      v24 = ((*((_DWORD *)this + 25) + 15) >> 4) + v23;
    }
    else
    {
      a3->top = v23 - ((*((_DWORD *)this + 25) + 15) >> 4);
      v24 = v23 - (*((int *)this + 27) >> 4);
    }
    a3->bottom = v24;
    ++a3->right;
    return 0LL;
  ...
  {
    v17 = (*((_DWORD *)this + 18) + 8) >> 4;
    if ( *(float *)v13 >= 0.0 )
    {
      a3->left = v17 + (*((int *)this + 27) >> 4);
      v18 = ((*((_DWORD *)this + 25) + 15) >> 4) + v17;
    }
    else
    {
      a3->left = v17 - ((*((_DWORD *)this + 25) + 15) >> 4);
      v18 = v17 - (*((int *)this + 27) >> 4);
    }
    a3->right = v18;
    v19 = (*((_DWORD *)this + 19) + 8) >> 4;
    if ( *(float *)v12 >= 0.0 )
    {
      a3->top = v19 + (*((int *)this + 24) >> 4);
      v20 = ((*((_DWORD *)this + 26) + 15) >> 4) + v19;
    }
    else
    {
      a3->top = v19 - ((*((_DWORD *)this + 26) + 15) >> 4);
      v20 = v19 - (*((int *)this + 24) >> 4);
    }
    a3->bottom = v20 + 1;
    return 0LL;
  }
