/*
 * XREFs of NtGdiCLIPOBJ_cEnumStart @ 0x1C0282820
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??$GetDDIOBJ@U_CLIPOBJ@@@UMPDOBJ@@QEAAPEAU_CLIPOBJ@@PEAU1@@Z @ 0x1C026409C (--$GetDDIOBJ@U_CLIPOBJ@@@UMPDOBJ@@QEAAPEAU_CLIPOBJ@@PEAU1@@Z.c)
 */
...
LABEL_7:
  ...
  v12 = XCLIPOBJ::cEnumStart(v13, v8, a3, a4, a5);
LABEL_8:
  if ( v11 )
    --*((_DWORD *)v11 + 105);
  return v12;
