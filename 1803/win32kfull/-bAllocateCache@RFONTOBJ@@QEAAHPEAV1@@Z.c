/*
 * XREFs of ?bAllocateCache@RFONTOBJ@@QEAAHPEAV1@@Z @ 0x1C00855A0
 * Callers:
...
__int64 __fastcall RFONTOBJ::bAllocateCache(RFONTOBJ *this, struct RFONTOBJ *a2)
{
  ...
  v3 = 0LL;
  v4 = 0LL;
  v6 = 2 * *(_DWORD *)(*(_QWORD *)this + 624LL);
  v41 = *(_DWORD *)(*(_QWORD *)this + 68LL) & 2;
  if ( v41 )
  {
    v4 = *(_QWORD *)(v2 + 464);
    v7 = *(_DWORD *)(v4 + 12);
  ...
  v42 = v11;
  v12 = v11 + (*(_DWORD *)(v2 + 628) != 0 ? 768 : 2048);
  if ( v12 + 8 > 0xC00 )
  {
  ...
  *(_QWORD *)(v2 + 528) = v21;
  *v21 = 0LL;
  v22 = *(_QWORD *)(v2 + 528) + 16LL;
  v23 = v39 + v12;
  *(_QWORD *)(v2 + 520) = v23;
  *(_QWORD *)(v2 + 512) = v23;
  *(_QWORD *)(v2 + 504) = v22;
  v24 = *(_QWORD *)this;
  v25 = *(_DWORD *)(*(_QWORD *)this + 72LL);
  if ( !v25 || (*(_DWORD *)(*(_QWORD *)this + 68LL) & 1) != 0 )
    goto LABEL_24;
  if ( v25 != 2 )
  {
    v26 = *(_DWORD *)(v2 + 624);
...
LABEL_23:
  *(_DWORD *)(v2 + 544) = v27;
  *(_DWORD *)(v2 + 540) = v6;
  *(_DWORD *)(v2 + 548) = ((unsigned int)(v43 + 1023) >> 10 << 16) / *(_DWORD *)(v2 + 544);
  v24 = *(_QWORD *)this;
LABEL_24:
  v28 = **(_DWORD **)(v24 + 472);
  if ( v28 > 0xC8 )
  {
    ...
    *(_DWORD *)(v2 + 596) = v36;
    if ( (v36 & 0xF000) != 0 )
    {
      v37 = (unsigned int)acBits[((__int64)v36 >> 12) & 0xF] + 12;
    }
    else if ( (v36 & 0xF00) != 0 )
    {
      v37 = (unsigned int)acBits[((__int64)v36 >> 8) & 0xF] + 8;
    }
    else if ( (v36 & 0xF0) != 0 )
    {
      v37 = (unsigned int)acBits[((__int64)v36 >> 4) & 0xF] + 4;
    }
    else
    {
      v37 = acBits[v36 & 0xF];
    ...
    *(_DWORD *)(v2 + 604) = v37;
    *(_DWORD *)(v2 + 600) = *((_DWORD *)&aiStart + v37);
  }
  else
  {
    *(_DWORD *)(v2 + 596) = 0;
