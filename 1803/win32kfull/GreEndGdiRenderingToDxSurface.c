/*
 * XREFs of GreEndGdiRenderingToDxSurface @ 0x1C00A5F68
 * Callers:
 *     NtGdiEndGdiRendering @ 0x1C00A5770 (NtGdiEndGdiRendering.c)
 * Callees:
      ...
      if ( (unsigned int)GreGetObjectOwner(a1, 5LL) )
      {
        ...
        if ( v12 || *(_QWORD *)(v10 + 224) )
        {
          ...
          *(_WORD *)(v10 + 102) |= 0x200u;
          if ( v12 )
          {
            v13 = *(__int64 (__fastcall **)(__int64, _QWORD, __int64, __int64))(v11 + 3480);
            v9 = 0;
            if ( v13 )
