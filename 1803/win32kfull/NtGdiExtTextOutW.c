/*
 * XREFs of NtGdiExtTextOutW @ 0x1C009CFE0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a9)
{
  ...
  __int64 *v28; // [rsp+98h] [rbp-150h]
  unsigned int v29; // [rsp+B8h] [rbp-130h]
  struct tagRECT v30; // [rsp+C8h] [rbp-120h] BYREF
  __int64 v31; // [rsp+E0h] [rbp-108h] BYREF

  v10 = (struct tagRECT *)a5;
  v11 = a6;
  v12 = Src;
  if ( a7 > 0xFFFF )
    return 0LL;
...
LABEL_16:
    if ( v12 )
    {
      ...
      v19 = a6;
      v20 = (int *)v17;
      v17 = (__int64 *)((char *)v17 + (v29 & 0xFFFFFFF8));
    }
    else
    {
      v20 = (int *)Src;
