/*
 * XREFs of NtUserUpdateDefaultDesktopThumbnail @ 0x1C01F6CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserUpdateDefaultDesktopThumbnail(__int64 a1, __int64 a2, __int64 a3, char a4, int a5)
{
  ...
  if ( !v11 || (unsigned int)IsTopLevelWindow(v11) && (unsigned int)IsWindowDesktopComposed(v11) )
  {
    v9 = grpdeskIODefault;
    v10 = gptiCurrent;
    if ( *(_QWORD *)(gptiCurrent + 448LL) == grpdeskIODefault && (!v11 || *(_QWORD *)(v11 + 24) == grpdeskIODefault) )
    {
      v13 = (void *)ReferenceDwmApiPort(gptiCurrent, grpdeskIODefault, v7);
