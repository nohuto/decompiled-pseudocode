/*
 * XREFs of xxxMNButtonUp @ 0x1C01E58A4
 * Callers:
...
LABEL_12:
          ...
          if ( *(_DWORD *)(*(_QWORD *)*a1 + 80LL) != -1 )
          {
            ...
            if ( *(_DWORD *)(*(_QWORD *)*a1 + 80LL) < (unsigned int)result )
            {
              ...
              v9 = (_QWORD *)(*(_QWORD *)(result + 88) + 96LL * *(int *)(*(_QWORD *)*a1 + 80LL));
              if ( (*(_DWORD *)*v9 & 0x800) == 0 )
              {
                result = *(unsigned int *)(*v9 + 4LL);
                if ( (result & 3) == 0 && !v9[2] )
                  return xxxMNDismissWithNotify(a2, (__int64)a1, (__int64)v9, *(_DWORD *)(*(_QWORD *)*a1 + 80LL), a4);
              }
            }
          }
          goto LABEL_10;
