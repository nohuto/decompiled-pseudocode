/*
 * XREFs of GrePolyDraw @ 0x1C026F8F8
 * Callers:
 *     NtGdiPolyDraw @ 0x1C027FF00 (NtGdiPolyDraw.c)
 * Callees:
...
__int64 __fastcall GrePolyDraw(HDC a1, struct _POINTL *a2, char *a3, unsigned int a4)
{
  ...
  PATHOBJ v24[88]; // [rsp+80h] [rbp-308h] BYREF
...
LABEL_44:
  ...
  PATHSTACKOBJ::PATHSTACKOBJ((PATHSTACKOBJ *)v24, (DC **)v20, 1);
  if ( !*(_QWORD *)&v24[1] )
  {
    v12 = 8;
LABEL_11:
    EngSetLastError(v12);
LABEL_43:
    XEPATHOBJ::~XEPATHOBJ((XEPATHOBJ *)v24);
    v11 = 0;
    goto LABEL_44;
  }
  v13 = &a3[v4];
...
LABEL_38:
        v16 = a3 - v21;
        if ( !EPATHOBJ::bPolyLineTo((EPATHOBJ *)v24, (struct EXFORMOBJ *)&v22, a2, (_DWORD)a3 - (_DWORD)v21) )
          goto LABEL_43;
        a2 += v16;
        if ( (*(a3 - 1) & 1) != 0 )
...
LABEL_18:
        ...
        if ( !EPATHOBJ::bPolyBezierTo((EPATHOBJ *)v24, (struct EXFORMOBJ *)&v22, a2, v15) )
          goto LABEL_43;
        a2 += v15;
        if ( (*(a3 - 1) & 1) != 0 )
          EPATHOBJ::bCloseFigure((EPATHOBJ *)v24);
        break;
      case 6:
        if ( !EPATHOBJ::bMoveTo((EPATHOBJ *)v24, (struct EXFORMOBJ *)&v22, a2) )
          goto LABEL_43;
        ++a2;
        break;
      default:
  ...
  Current = EPATHOBJ::ptfxGetCurrent((EPATHOBJ *)v24, &v23);
  v18 = v20[0];
  *(_DWORD *)(*(_QWORD *)&v20[0][10] + 8LL) &= 0xFFFFFCFF;
  *(_DWORD *)(*(_QWORD *)&v18[10] + 76LL) = a2[-1].x;
  *(_DWORD *)(*(_QWORD *)&v18[10] + 80LL) = a2[-1].y;
  *(_DWORD *)(*(_QWORD *)&v18[10] + 84LL) = *(_DWORD *)Current.x;
  *(_DWORD *)(*(_QWORD *)&v18[10] + 88LL) = *(_DWORD *)(*(_QWORD *)&Current + 4LL);
  if ( (v20[0][32].x & 1) != 0 || (unsigned int)EPATHOBJ::bStrokeAndOrFill(v24, v20, (LINEATTRS *)&v20[0][27], &v22, 1u) )
    v8 = 1;
  XEPATHOBJ::~XEPATHOBJ((XEPATHOBJ *)v24);
  DCOBJ::~DCOBJ((DCOBJ *)v20);
  return v8;
