/*
 * XREFs of RegisterModernAppThreadForRawKeyboard @ 0x1C01A3200
 * Callers:
...
__int64 __fastcall RegisterModernAppThreadForRawKeyboard(__int64 a1)
{
  ...
  {
    v5 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 416) + 824LL) + 100LL);
    if ( (v5 & 0x800) != 0 )
    {
      *(_DWORD *)(a1 + 1200) = v1 | 0x200000;
      return 1LL;
    }
    if ( (v5 & 0x10) != 0 )
    {
