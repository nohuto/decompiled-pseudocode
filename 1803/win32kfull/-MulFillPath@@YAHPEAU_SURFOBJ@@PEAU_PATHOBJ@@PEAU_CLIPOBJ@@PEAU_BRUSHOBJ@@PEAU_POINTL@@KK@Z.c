/*
 * XREFs of ?MulFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@PEAU_POINTL@@KK@Z @ 0x1C0273360
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v18[0] )
  {
    ...
    for ( i = MSURF::bFindSurface((MSURF *)v19, a1, a3, &v27); i; i = MSURF::bNextSurface((MSURF *)v19) )
    {
      ...
      if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v21) + 112) & 0x40) != 0 )
        v16 = *(BOOL (__stdcall **)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, BRUSHOBJ *, POINTL *, MIX, FLONG))(*((_QWORD *)v20 + 7) + 2800LL);
      else
        v16 = EngFillPath;
