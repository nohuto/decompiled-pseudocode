/*
 * XREFs of DCEHitTestWindow @ 0x1C01AE940
 * Callers:
 ...
 *     ?DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z @ 0x1C01ADAE0 (-DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z.c)
 *     BuildVertexList @ 0x1C01AE528 (BuildVertexList.c)
 *     DCEInverseTransform @ 0x1C01AEA1C (DCEInverseTransform.c)
 */
