/*
 * XREFs of ?GetETMFontManagement@@YAHAEAVRFONTOBJ@@VPDEVOBJ@@PEAU_SURFOBJ@@PEAU_FONTOBJ@@KKPEAXK4@Z @ 0x1C0119CDC
 * Callers:
        ...
        void *a7)
{
  ...
  {
    v19 = UMPDReleaseRFONTSem(a1, 0LL, &v21, &v20, &v22);
    v9 = v23;
    v14 = v19;
    v10 = v21;
    v11 = v20;
  ...
  v16 = *(_QWORD *)a1;
  if ( a2 != qword_1C032FD38 || v16 && *(_DWORD *)(*(_QWORD *)(v16 + 24) + 8LL) == 3 )
  {
    v23 = *(void **)(v16 + 112);
