/*
 * XREFs of itrp_SH_Common @ 0x1C02CF5E8
 * Callers:
...
_QWORD *__fastcall itrp_SH_Common(_DWORD *a1, _DWORD *a2, int *a3, char a4)
{
  ...
  if ( (a4 & 1) != 0 )
  {
    v7 = HIDWORD(qword_1C0327190);
    v8 = (_QWORD *)LocalGS;
  }
  else
  {
    v7 = dword_1C0327198;
    v8 = (_QWORD *)qword_1C0327148;
  }
  v9 = InvokeProject(
         dword_1C03271B0,
  ...
  *a1 = 0;
  if ( v12 )
  {
    ...
    if ( HIWORD(dword_1C032715C) )
      *a2 = ((unsigned __int64)(v11 * SHIWORD(dword_1C032715C)) >> 32 << 18)
          + ((((unsigned int)(v11 * SHIWORD(dword_1C032715C)) >> 13) + 1) >> 1);
  }
  else
  {
    if ( v13 )
    ...
    if ( HIWORD(dword_1C032715C) )
      *a2 = CompDiv(word_1C03271A8, v11 * SHIWORD(dword_1C032715C));
  }
  result = v8;
  *a3 = v7;
  return result;
