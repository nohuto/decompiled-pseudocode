/*
 * XREFs of ?ChangeWindowTreeProtection@@YAHPEAUtagWND@@H@Z @ 0x1C0202ECC
 * Callers:
 ...
 *     ?Add@?$CDynamicArray@PEAUtagWND@@$0HHHAHDFF@@@QEAAJAEBQEAUtagWND@@@Z @ 0x1C0202E90 (-Add@-$CDynamicArray@PEAUtagWND@@$0HHHAHDFF@@@QEAAJAEBQEAUtagWND@@@Z.c)
...
__int64 __fastcall ChangeWindowTreeProtection(struct tagWND *a1, int a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( (int)CDynamicArray<tagWND *,2003858261>::Add((__int64)&v19, &v22) >= 0 )
    {
      ...
      v8 = 0LL;
      v9 = *(_QWORD *)(v7 + 416);
      if ( a1 == *(struct tagWND **)(v7 + 1376) )
      {
        v10 = *(_QWORD *)(v7 + 1384);
        if ( v10 )
          v8 = *(_QWORD *)(*(_QWORD *)(v10 + 16) + 416LL);
      }
      for ( i = (unsigned __int64 *)((char *)v5 + 32); *i != 1; ++i )
      {
        ...
        {
          v13 = *(_QWORD *)(*(_QWORD *)(v12 + 16) + 416LL);
          if ( a2 )
          {
            if ( v13 != v9 && v13 != v8 )
              goto LABEL_25;
