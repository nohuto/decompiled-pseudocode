/*
 * XREFs of ?_OnInput@Edgy@@YA?AUtagSTATE_TRANSITION_DATA@1@AEAUtagEDGY_DATA@@PEAX@Z @ 0x1C01BEE28
 * Callers:
 *     ?ProcessInput@Edgy@@YAHPEAXPEAPEAX@Z @ 0x1C01BE05C (-ProcessInput@Edgy@@YAHPEAXPEAPEAX@Z.c)
 * Callees:
...
__int64 __fastcall Edgy::_OnInput(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  ArcData = Edgy::_GetArcData(v16, a2, a3);
  v6 = *(int *)(a2 + 16);
  v7 = 4LL;
  v8 = dword_1C02E6110[v6];
  v9 = *((_OWORD *)ArcData + 1);
  v14[0] = *(_OWORD *)ArcData;
  v10 = *((_OWORD *)ArcData + 2);
  v14[1] = v9;
  *(_QWORD *)&v9 = ArcData[6];
  v14[2] = v10;
  v15 = v9;
  v11 = dword_1C02E6110[(int)v6 + 1];
  if ( v8 < v11 )
  {
    v12 = (_DWORD *)((char *)&unk_1C02E5F9C + 16 * v8);
