/*
 * XREFs of ?bIsLinkedGlyph@RFONTOBJ@@QEAAHG@Z @ 0x1C0086598
 * Callers:
...
__int64 __fastcall RFONTOBJ::bIsLinkedGlyph(RFONTOBJ *this, unsigned __int16 a2)
{
  ...
  if ( (unsigned __int16)(a2 + 0x2000) <= 0x18FFu
    ...
    && a2 >= gqlEUDC
    && a2 <= *(&gqlEUDC + 1)
    && ((0x80000000 >> (a2 & 0x1F)) & *(_DWORD *)(qword_1C0326928 + 4 * ((unsigned __int64)a2 >> 5))) != 0 )
  {
    v4 = 1;
    goto LABEL_4;
  }
...
LABEL_4:
    ...
    {
      if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 104LL) + 12LL) & 0x10) != 0 )
      {
  ...
  v12 = *(_DWORD *)(*(_QWORD *)this + 828LL);
  v13 = *(unsigned __int8 *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 104LL) + 32LL) + 45LL) >> 4;
