/*
 * XREFs of NtGdiSwapBuffers @ 0x1C028AA70
 * Callers:
 *     <none>
 * Callees:
...
_BOOL8 __fastcall NtGdiSwapBuffers(HDC a1)
{
  ...
  _BYTE v12[72]; // [rsp+48h] [rbp-9h] BYREF
  struct EWNDOBJ *v13; // [rsp+90h] [rbp+3Fh]

  MDCOBJ::MDCOBJ((MDCOBJ *)v10, a1);
  v1 = v10[0];
  if ( !v10[0] || !*(_QWORD *)(v10[0] + 504LL) )
  {
    EngSetLastError(6u);
    v2 = 0;
    goto LABEL_20;
  ...
  if ( (v12[24] & 1) != 0 )
  {
    if ( v13 )
    {
      if ( ERECTL::bEmpty((struct EWNDOBJ *)((char *)v13 + 4)) )
        goto LABEL_18;
      ++*(_DWORD *)(*(_QWORD *)(v10[0] + 504LL) + 92LL);
      v3 = v13;
      v4 = *(_QWORD *)(v10[0] + 48LL);
      v5 = (*(_QWORD *)(v10[0] + 504LL) + 24LL) & -(__int64)(*(_QWORD *)(v10[0] + 504LL) != 0LL);
      v6 = v5;
      if ( (*(_DWORD *)(v4 + 40) & 0x20000) != 0 )
      {
        v11 = *(struct _RECTL *)(v10[0] + 1440LL);
        DeviceHdev = hdevFindDeviceHdev((_QWORD *)v4, &v11, v13);
        v6 = v5;
        if ( DeviceHdev )
        {
          if ( *(_QWORD *)(v10[0] + 504LL) == *(_QWORD *)(v4 + 2544) )
          {
            v6 = *(_QWORD *)(DeviceHdev + 2544);
            if ( v6 )
              v6 += 24LL;
          }
          v4 = DeviceHdev;
      ...
      v8 = *(unsigned int (__fastcall **)(__int64, struct EWNDOBJ *))(v4 + 3128);
      if ( v8 )
      {
        if ( v8(v6, v3) )
          goto LABEL_18;
