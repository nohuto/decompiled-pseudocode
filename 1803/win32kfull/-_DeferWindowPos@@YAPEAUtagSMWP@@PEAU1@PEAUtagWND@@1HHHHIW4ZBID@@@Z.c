/*
 * XREFs of ?_DeferWindowPos@@YAPEAUtagSMWP@@PEAU1@PEAUtagWND@@1HHHHIW4ZBID@@@Z @ 0x1C0034F94
 * Callers:
...
__int64 __fastcall _DeferWindowPos(__int64 a1, _QWORD *a2, __int64 *a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  ...
  if ( v11 + 1 > (int)v14 )
  {
    if ( (int)v14 + 4 < (unsigned int)v14
      || (v20 = v14 + 4, (unsigned int)(v14 + 4) > 0xC30C30)
      || ((v21 = *(_QWORD *)(a1 + 40), v22 = 168LL * (unsigned int)(v14 + 4), v23 = 168 * v14, (void *const)a1 == gSMWP)
  ...
  *(_DWORD *)(v15 + 144) = 0;
  ...
  if ( (a8 & 3) != 3 || (v18 = *(_DWORD *)(v15 + 156), (a8 & 4) == 0) && a3 == (__int64 *)-1LL )
  {
    *(_QWORD *)(v15 + 128) = *(_QWORD *)(a2[5] + 256LL);
    v18 = v17 | 0x20;
    *(_DWORD *)(v15 + 156) = v17 | 0x20;
  }
  *(_DWORD *)(v15 + 152) = a9;
  result = a1;
  *(_DWORD *)(v15 + 156) = v18 & 0xFFFFFFE0;
  return result;
}
