/*
 * XREFs of ?vIFIMetricsToETM@@YAXPEAU_EXTTEXTMETRIC@@AEAVRFONTOBJ@@AEAVDCOBJ@@PEAU_IFIMETRICS@@@Z @ 0x1C01189E0
 * Callers:
        ...
        struct _IFIMETRICS *a4)
{
  ...
  v9 = v23[0];
  *(_WORD *)a1 = 52;
  v10 = (*(_DWORD *)(*(_QWORD *)a2 + 308LL) + 8) >> 4;
  if ( (*(_DWORD *)(v9 + 48) & 0x3000010) != 0 )
  {
    v11 = *(_DWORD *)(*(_QWORD *)a2 + 368LL);
    if ( v11 == 0x80000000 )
    {
