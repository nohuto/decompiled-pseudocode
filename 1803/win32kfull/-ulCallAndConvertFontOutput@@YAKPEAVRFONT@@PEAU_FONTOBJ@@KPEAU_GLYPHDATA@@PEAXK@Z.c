/*
 * XREFs of ?ulCallAndConvertFontOutput@@YAKPEAVRFONT@@PEAU_FONTOBJ@@KPEAU_GLYPHDATA@@PEAXK@Z @ 0x1C0080754
 * Callers:
        ...
        unsigned int a6)
{
  ...
  v21[0] = *((_QWORD *)a1 + 14);
  v20 = v7;
  v12 = *(__int64 (__fastcall **)(__int64, struct _FONTOBJ *, __int64, _QWORD, struct _GLYPHDATA *, struct _GLYPHBITS *, unsigned int))(*(_QWORD *)(v21[0] + 88LL) + 2904LL);
  if ( gpepCSRSS )
  {
    ATTACHOBJ::ATTACHOBJ(&ApcState, (struct PFFOBJ *)v21);
    v6 = v12(v20, a2, 1LL, a3, a4, a5, a6);
