/*
 * XREFs of ?vPatCpyRect1_8x8@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x1C0294870
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall vPatCpyRect1_8x8(struct _PATBLTFRAME *a1, int a2)
{
  ...
  {
    v4 = 0;
    v5 = *((_DWORD *)&aulMsk + (v3->left & 0x1F));
    v6 = ~v5;
    if ( *((_DWORD *)&aulMsk + (v3->right & 0x1F)) != -1 )
      v4 = *((_DWORD *)&aulMsk + (v3->right & 0x1F));
    ...
    if ( !v17 )
    {
      if ( *((_DWORD *)&aulMsk + (v3->left & 0x1F)) != -1 && v4 )
      {
        v7 = 8;
        goto LABEL_17;
      }
