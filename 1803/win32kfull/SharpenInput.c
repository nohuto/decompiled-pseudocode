/*
 * XREFs of SharpenInput @ 0x1C01158D0
 * Callers:
    ...
    *(_BYTE *)(v10 + 2) = *(_BYTE *)(v10 - 1);
    if ( a4 < v10 )
    {
      ...
      do
      {
        ...
        if ( ((12 * (unsigned __int8)v13[v15 - 2] - *(v12 - 2) - *(v14 - 2) - *(v11 - 6) - *v11) & 0x7F800) != 0 )
          LOBYTE(v16) = ~HIBYTE(v16);
        *(v13 - 2) = v16;
        v17 = (12 * *(v11 - 2) - *(v12 - 1) - *(v14 - 1) - *(v11 - 5) - v11[1]) >> 3;
        if ( ((12 * *(v11 - 2) - *(v12 - 1) - *(v14 - 1) - *(v11 - 5) - v11[1]) & 0x7F800) != 0 )
          LOBYTE(v17) = ~HIBYTE(v17);
        *(v13 - 1) = v17;
        v18 = (12 * *(v11 - 1) - *(v11 - 4) - v11[2] - *v14 - *v12) >> 3;
        if ( ((12 * *(v11 - 1) - *(v11 - 4) - v11[2] - *v14 - *v12) & 0x7F800) != 0 )
