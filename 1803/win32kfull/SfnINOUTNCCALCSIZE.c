/*
 * XREFs of SfnINOUTNCCALCSIZE @ 0x1C00DD740
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  __int128 v38; // xmm0
  __int64 v39; // rax
  _DWORD v41[8]; // [rsp+30h] [rbp-1B8h] BYREF
  unsigned __int64 v42[3]; // [rsp+50h] [rbp-198h] BYREF
  __int64 v43; // [rsp+68h] [rbp-180h]
  __int64 v44; // [rsp+70h] [rbp-178h] BYREF
  volatile signed __int32 *v45; // [rsp+78h] [rbp-170h]
  __int64 v46; // [rsp+80h] [rbp-168h]
  __int128 v47; // [rsp+88h] [rbp-160h]
  __int64 v48; // [rsp+98h] [rbp-150h]
  __int64 v49; // [rsp+A0h] [rbp-148h]
  __int64 v50; // [rsp+A8h] [rbp-140h]
  __int128 v51; // [rsp+D0h] [rbp-118h]
  volatile void *Address; // [rsp+E0h] [rbp-108h]
  __int128 v53; // [rsp+E8h] [rbp-100h]
  __int128 *v54; // [rsp+F8h] [rbp-F0h]
  ...
  *(_QWORD *)(*(_QWORD *)(v13 + 472) + 80LL) = v28;
  ...
  v29 = KeUserModeCallback(21LL, v55, v16, v42, v41);
  ...
  *(_QWORD *)(v33 + 80) = v26;
  if ( v29 < 0 || v41[0] != 24 )
    return 0LL;
  v34 = (__int64 *)v42[0];
  if ( v42[0] + 8 < v42[0] || v42[0] + 8 > MmUserProbeAddress )
  ...
  {
    v36 = v42[0];
    if ( v42[0] + 24 < v42[0] || v42[0] + 24 > MmUserProbeAddress )
