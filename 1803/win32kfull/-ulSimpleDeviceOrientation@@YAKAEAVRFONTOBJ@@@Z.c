/*
 * XREFs of ?ulSimpleDeviceOrientation@@YAKAEAVRFONTOBJ@@@Z @ 0x1C010C814
 * Callers:
...
__int64 __fastcall ulSimpleDeviceOrientation(struct RFONTOBJ *a1)
{
  ...
  v1 = (*(float *)(*(_QWORD *)a1 + 384LL) > 0.0) - (*(float *)(*(_QWORD *)a1 + 384LL) < 0.0);
  v2 = (__PAIR64__(*(float *)(*(_QWORD *)a1 + 388LL) > 0.0, *(_DWORD *)(*(_QWORD *)a1 + 388LL))
