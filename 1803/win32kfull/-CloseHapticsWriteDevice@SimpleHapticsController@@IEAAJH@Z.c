/*
 * XREFs of ?CloseHapticsWriteDevice@SimpleHapticsController@@IEAAJH@Z @ 0x1C0213DCC
 * Callers:
  ...
  if ( v5 )
  {
    ...
    if ( v6 < 0 )
    {
      if ( (unsigned int)dword_1C031C790 > 2 )
      {
        ...
        v14 = v6;
        v21 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E4170, v7, v8, 4u, &pData);
      }
      DbgPrintEx(
        0x4Du,
        0,
    ...
    if ( v9 < 0 )
    {
      if ( (unsigned int)dword_1C031C790 > 2 )
      {
        ...
        v18 = 17;
        v21 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E4170, v10, v11, 4u, &pData);
      }
      DbgPrintEx(
        0x4Du,
        0,
