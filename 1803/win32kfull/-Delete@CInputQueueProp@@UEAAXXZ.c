/*
 * XREFs of ?Delete@CInputQueueProp@@UEAAXXZ @ 0x1C00353F0
 * Callers:
 *     <none>
 * Callees:
 *     ?Reset@?$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z @ 0x1C00F4E1C (-Reset@-$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z.c)
