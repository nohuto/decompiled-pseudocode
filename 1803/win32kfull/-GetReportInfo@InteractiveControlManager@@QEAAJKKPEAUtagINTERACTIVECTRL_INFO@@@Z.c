/*
 * XREFs of ?GetReportInfo@InteractiveControlManager@@QEAAJKKPEAUtagINTERACTIVECTRL_INFO@@@Z @ 0x1C020C598
 * Callers:
        ...
        struct tagINTERACTIVECTRL_INFO *a4)
{
  ...
  if ( dword_1C031C7D0 > 4u )
  {
    ...
    v17 = (int)a3;
    v28 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C7D0, &unk_1C02E3A30, a3, (LPCGUID)a4, 5u, &pData);
  }
  ...
  if ( Device >= 0 )
  {
    if ( (unsigned int)InteractiveControlDevice::GetInputReport(v19, v5, &v20) )
    {
      ...
      *((_DWORD *)a4 + 6) = *((_DWORD *)v12 + 19);
      ...
      if ( v14 )
      {
        if ( PsGetCurrentProcessWin32Process(v13) == *(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) )
        {
  ...
  else if ( dword_1C031C7D0 > 2u )
  {
    ...
    v24 = 17LL;
    v26 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C7D0, &unk_1C02E3990, v9, v10, 4u, &pData);
  }
  if ( dword_1C031C7D0 > 4u )
  {
    v24 = 46LL;
    ...
    v25 = &v16;
    v26 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C7D0, &unk_1C02E3860, v9, v10, 4u, &pData);
  }
  return v16;
}
