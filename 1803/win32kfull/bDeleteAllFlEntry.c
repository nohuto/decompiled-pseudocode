/*
 * XREFs of bDeleteAllFlEntry @ 0x1C00C8494
 * Callers:
    ...
    if ( off_1C031C820 != (_UNKNOWN *)&off_1C031C820 )
    {
      ...
      do
      {
        ...
        do
        {
          ...
          {
            if ( (_QWORD *)v9[1] != v10 || (v12 = (_QWORD *)v10[1], (_QWORD *)*v12 != v10) )
              __fastfail(3u);
            *v12 = v9;
            v9[1] = v12;
            v13 = v22;
...
LABEL_15:
    ...
    while ( v16 != &v21 )
    {
      ...
      v18 = v16;
      v16 = v17;
      if ( (_QWORD *)v17[1] != v18 || (v19 = (_QWORD *)v18[1], (_QWORD *)*v19 != v18) )
        __fastfail(3u);
      *v19 = v17;
      v17[1] = v19;
