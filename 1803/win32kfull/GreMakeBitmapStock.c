/*
 * XREFs of GreMakeBitmapStock @ 0x1C00ACF2C
 * Callers:
 *     NtGdiSetBitmapAttributes @ 0x1C00AD050 (NtGdiSetBitmapAttributes.c)
 * Callees:
...
__int64 __fastcall GreMakeBitmapStock(__int64 a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    if ( (!(unsigned int)SURFACE::bDIBSection(v4) || !*(_WORD *)(v6 + 100) && *(_DWORD *)(v6 + 216))
      && (a1 & 0x800000) == 0
      && !*((_DWORD *)v5 + 42) )
    {
      if ( (*((_DWORD *)v5 + 28) & 0x80000800) != 0 || SURFACE::GetFirstLSurf((SURFACE *)v6) )
      {
        if ( !*((_DWORD *)v5 + 42) )
        {
          v8 = *((_DWORD *)v5 + 28);
