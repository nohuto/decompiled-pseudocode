/*
 * XREFs of ?UMPDDrvPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C027AE20
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  struct _POINTFIX *v42; // [rsp+118h] [rbp+8h]
...
LABEL_8:
    ...
    if ( !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 64), (struct _SURFOBJ **)&v45[3], v13)
      ...
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v45[10], 0x18u)
      ...
      || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v16, v45, 0x70u, &v22, Size) == -1)
      || (v19 = 1, !v22) )
    {
      v19 = 0;
    }
