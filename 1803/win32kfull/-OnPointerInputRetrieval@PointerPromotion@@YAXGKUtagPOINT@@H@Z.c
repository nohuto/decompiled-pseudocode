/*
 * XREFs of ?OnPointerInputRetrieval@PointerPromotion@@YAXGKUtagPOINT@@H@Z @ 0x1C01CD1B8
 * Callers:
 *     PointerPromotionOnPointerInputRetrieval @ 0x1C01CE1E0 (PointerPromotionOnPointerInputRetrieval.c)
 * Callees:
  ...
  if ( CacheById )
  {
    ...
    if ( MousePromotionEntry )
    {
      *((_QWORD *)MousePromotionEntry + 1) = v9;
      if ( !v10 && word_1C0326C20 == v8 )
      {
        v12 = v15[0] + 1;
        if ( (unsigned int)v12 < 5 )
        {
          v13 = (unsigned int)(5 - v12);
          v14 = (struct tagMOUSE_PROMOTION_QUEUE *)((char *)&unk_1C0326B50 + 24 * v12);
          do
          {
