/*
 * XREFs of ?CreateUsermodeParameters@LoadFontFileRequest@@UEAAJPEAVUmfdTls@@PEAPEAX@Z @ 0x1C00BE4A0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( v8 + 7 < v8 )
    return 3221225495LL;
  v10 = ((v8 + 7) & 0xFFFFFFF8) + 208;
  v11 = v10 < 0xD0 ? 0LL : UmfdTls::CommitUMBuffer(a2, v10, 0);
  if ( !v11 )
    return 3221225495LL;
