/*
 * XREFs of NtUserDisableThreadIme @ 0x1C0105F90
 * Callers:
 *     <none>
 * Callees:
    ...
    for ( i = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 320LL); i; i = *(_QWORD *)(i + 656) )
    {
      *(_DWORD *)(i + 480) |= 0x2000000u;
      if ( i != gptiCurrent )
      {
        v9 = *(__int64 **)(i + 768);
        if ( v9 )
          PostEventMessageEx((struct tagTHREADINFO *)i, *(_QWORD *)(i + 424), 8u, 0LL, 0, *v9, 0LL, 0LL);
      }
    }
LABEL_11:
    v5 = *(_QWORD *)(gptiCurrent + 768LL);
    if ( v5 )
      xxxDestroyWindow(v5);
LABEL_13:
    v6 = 1LL;
  ...
  if ( v5 && *(_QWORD *)(v5 + 416) == *(_QWORD *)(gptiCurrent + 416LL) )
  {
    *(_DWORD *)(v5 + 480) |= 0x2000000u;
    v10 = *(__int64 **)(v5 + 768);
    if ( v10 )
      PostEventMessageEx((struct tagTHREADINFO *)v5, *(_QWORD *)(v5 + 424), 8u, 0LL, 0, *v10, 0LL, 0LL);
    goto LABEL_13;
  }
LABEL_3:
