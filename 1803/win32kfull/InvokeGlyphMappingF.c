/*
 * XREFs of InvokeGlyphMappingF @ 0x1C02BEC78
 * Callers:
 *     sfac_GetGlyphIndex @ 0x1C02BF75C (sfac_GetGlyphIndex.c)
 *     sfac_GetLongGlyphIDs @ 0x1C02BF930 (sfac_GetLongGlyphIDs.c)
 *     sfac_GetMultiGlyphIDs @ 0x1C02BFA58 (sfac_GetMultiGlyphIDs.c)
 * Callees:
 *     sfac_ComputeIndex2 @ 0x1C02BEF1C (sfac_ComputeIndex2.c)
 *     sfac_ComputeIndex4 @ 0x1C02BEFBC (sfac_ComputeIndex4.c)
 */
