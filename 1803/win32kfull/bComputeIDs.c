/*
 * XREFs of bComputeIDs @ 0x1C0218070
 * Callers:
 *     bVerifyTTF @ 0x1C021ACCC (bVerifyTTF.c)
 * Callees:
 *     bCvtUnToMac @ 0x1C0218F9C (bCvtUnToMac.c)
 ...
 *     vDetectOldBiDiFonts @ 0x1C021BBE0 (vDetectOldBiDiFonts.c)
 */
        ...
        __int64 a8)
{
  ...
  *v16 = 0;
  ...
  v39 = v20;
  if ( __ROR2__(*v10, 8) || v14 > 0x1Eu || (unsigned __int64)v17 >= v20 )
    return 0LL;
  v21 = a6;
  do
  {
...
LABEL_17:
        ...
        if ( (unsigned int)(unsigned __int16)v24 - 2 > 3 )
          v28 = bVerifyMsftTable((_DWORD)v26, (_DWORD)v21, (_DWORD)v16, a8, v24, (__int64)&v41, v9, v25, (__int64)v10);
        else
...
LABEL_48:
      if ( v17 >= v18 )
        return 1LL;
      while ( __ROR2__(*v17, 8) != *v42 || __ROR2__(v17[1], 8) != *v43 )
      {
        v17 += 4;
        if ( v17 >= v18 )
          return 1LL;
