/*
 * XREFs of ?bGetNtoD@@YAHPEAU_FD_XFORM@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@QEAU_POINTL@@@Z @ 0x1C00CD0D4
 * Callers:
        ...
        struct _POINTL *const a5)
{
  ...
  if ( !a5->x || (v9 = *(_DWORD *)(*(_QWORD *)a3 + 48LL), (v9 & 0x3000010) != 0) )
  {
    ...
    {
      if ( !EXFORMOBJ::bMultiply((EXFORMOBJ *)&v28, (struct MATRIX *)v32, (struct MATRIX *)(v10 + 328), 0) )
        return v5;
  ...
  if ( (v9 & 0x200000) != 0 )
  {
    ...
    {
      EXFORMOBJ::vQuickInit((EXFORMOBJ *)&v30, a4, 516);
      v17 = (*v30 > 0.0) - (*v30 < 0.0);
