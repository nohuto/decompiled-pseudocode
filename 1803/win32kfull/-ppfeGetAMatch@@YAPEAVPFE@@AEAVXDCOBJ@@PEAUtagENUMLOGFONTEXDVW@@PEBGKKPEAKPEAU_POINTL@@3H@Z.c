/*
 * XREFs of ?ppfeGetAMatch@@YAPEAVPFE@@AEAVXDCOBJ@@PEAUtagENUMLOGFONTEXDVW@@PEBGKKPEAKPEAU_POINTL@@3H@Z @ 0x1C003F3CC
 * Callers:
        ...
        int a9)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)a1 + 260LL) & 4) != 0 )
  {
    v19 = *(struct PFT **)(*(_QWORD *)a1 + 264LL);
