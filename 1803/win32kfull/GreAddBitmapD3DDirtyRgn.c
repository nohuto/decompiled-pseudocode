/*
 * XREFs of GreAddBitmapD3DDirtyRgn @ 0x1C023C0C4
 * Callers:
...
struct DwmState *__fastcall GreAddBitmapD3DDirtyRgn(HWND a1, unsigned int a2, struct _RECTL *a3)
{
  ...
  if ( g_pDwmState )
  {
    ...
    if ( v14 )
    {
      CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)v15, (struct DWMSPRITE *)((char *)v14 + 88));
      v11 = *((_QWORD *)v10 + 21);
      CAutoPushLockEx::CAutoPushLockEx((CAutoPushLockEx *)&v14, (struct _EX_PUSH_LOCK *)(v11 + 256));
      ...
      if ( v8 )
      {
        ...
        if ( v13 )
          v3 = *(_QWORD *)(v13 + 8);
        bSpDwmNotifyDirty(*(_QWORD *)v10, (struct SFMLOGICALSURFACE *)v11, v9, v3);
      }
