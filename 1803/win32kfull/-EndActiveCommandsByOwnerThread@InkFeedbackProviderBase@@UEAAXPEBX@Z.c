/*
 * XREFs of ?EndActiveCommandsByOwnerThread@InkFeedbackProviderBase@@UEAAXPEBX@Z @ 0x1C00E4960
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall InkFeedbackProviderBase::EndActiveCommandsByOwnerThread(InkFeedbackProviderBase *this, const void *a2)
{
  ...
  const GUID *v28; // [rsp+B8h] [rbp+27h]
  ...
  while ( v4 != v2 )
  {
    ...
    if ( *((const void **)v6 + 3) == a2 )
    {
      if ( (unsigned int)pRelatedActivityId > 4 )
      {
        ...
        v20 = 0;
        v15 = &v12;
        v18 = "Terminating active command by owner thread";
        v16 = 4;
        v19 = 43;
