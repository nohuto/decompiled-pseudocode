/*
 * XREFs of UninitializeTelemetryAssertsKM @ 0x1C010F640
 * Callers:
 *     UninitializeWin32kFullTelemetryAsserts @ 0x1C010F510 (UninitializeWin32kFullTelemetryAsserts.c)
 * Callees:
...
NTSTATUS UninitializeTelemetryAssertsKM()
{
  ...
  if ( result )
  {
    ...
    EtwUnregister(qword_1C0366070);
    qword_1C0366070 = 0LL;
    dword_1C0366050 = 0;
    EtwUnregister(qword_1C03660B0);
    qword_1C03660B0 = 0LL;
    dword_1C0366090 = 0;
    result = EtwUnregister(qword_1C0366030);
    qword_1C0366030 = 0LL;
    dword_1C0366010 = 0;
  }
  return result;
