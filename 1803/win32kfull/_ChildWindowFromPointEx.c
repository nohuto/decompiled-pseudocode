/*
 * XREFs of _ChildWindowFromPointEx @ 0x1C012D97C
 * Callers:
 *     NtUserChildWindowFromPointEx @ 0x1C012D910 (NtUserChildWindowFromPointEx.c)
...
_QWORD *__fastcall ChildWindowFromPointEx(__int64 a1, __int64 a2, char a3)
{
  __int64 v5; // rdx
  __int64 v6; // rdx
  __int64 v7; // rcx
  ...
  if ( a1 )
  {
    v5 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), a2) + 472);
    if ( (*(_BYTE *)(v5 + 224) & 1) == 0 )
    {
      v7 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread(), v5) + 472);
  ...
  while ( 1 )
  {
    ...
    if ( (a3 & 1) != 0
      && ((*(_BYTE *)(v16[5] + 31LL) & 0x10) == 0
       || (unsigned int)IsWindowDesktopComposed(v16) && (unsigned int)GetWindowCloakState(v16))
      || (a3 & 2) != 0 && (*(_BYTE *)(v16[5] + 31LL) & 8) != 0
      || (a3 & 4) != 0 && (*(_BYTE *)(v16[5] + 24LL) & 0x20) != 0
      || !PtInRect((_DWORD *)(v16[5] + 88LL), v22) )
    {
      goto LABEL_18;
    }
    v20 = *(_QWORD *)(v19 + 168);
...
LABEL_18:
  ...
  if ( (*(_BYTE *)(v16[5] + 26LL) & 8) != 0
    && (*(_DWORD *)(*(_QWORD *)(a1 + 40) + 232LL) & 0x20) == 0
    && !LayerHitTest((__int64)v16, v18) )
  {
    goto LABEL_18;
  }
  return v16;
