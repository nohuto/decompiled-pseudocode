/*
 * XREFs of SfnTOUCHHITTESTING @ 0x1C01DFF40
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v12 = 0LL;
  result = AllocCallbackMessage(88, 1u, 48LL, v43, 1, 0x200uLL);
  v15 = result;
  v32 = result;
  if ( result )
  {
    ...
    *((_DWORD *)v15 + 12) = v8;
    *((_QWORD *)v15 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v15, a4, 0x30u, (void **)v15 + 8) < 0 )
      goto LABEL_26;
    *((_QWORD *)v15 + 9) = a5;
    *((_QWORD *)v15 + 10) = a6;
    ...
    *((_QWORD *)v15 + 2) = 0LL;
    v21 = KeUserModeCallback(115LL, v15, *(unsigned int *)v15, &v35, v31);
