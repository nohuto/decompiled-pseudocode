/*
 * XREFs of ?OnPointerMessagePosted@InkFeedbackServer@@QEAAXI_K@Z @ 0x1C020DC70
 * Callers:
 ...
 *     ?GetPointerInfoByPointerMsgId@Pointer@@YAJ_KPEAPEBUtagPOINTER_INFO@@@Z @ 0x1C01F99CC (-GetPointerInfoByPointerMsgId@Pointer@@YAJ_KPEAPEBUtagPOINTER_INFO@@@Z.c)
 */
