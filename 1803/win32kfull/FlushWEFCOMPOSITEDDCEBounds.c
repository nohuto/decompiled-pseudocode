/*
 * XREFs of FlushWEFCOMPOSITEDDCEBounds @ 0x1C01B1700
 * Callers:
 *     InvalidateWEFCOMPOSITEDDCEs @ 0x1C01B1810 (InvalidateWEFCOMPOSITEDDCEs.c)
 * Callees:
...
__int64 __fastcall FlushWEFCOMPOSITEDDCEBounds(__int64 a1)
{
  ...
  if ( (_DWORD)result )
  {
    Prop = RealGetProp(*(_QWORD *)(*(_QWORD *)(a1 + 32) + 120LL), (unsigned __int16)atomLayer, 1LL);
