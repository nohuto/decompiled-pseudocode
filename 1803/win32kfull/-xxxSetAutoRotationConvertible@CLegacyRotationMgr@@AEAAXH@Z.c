/*
 * XREFs of ?xxxSetAutoRotationConvertible@CLegacyRotationMgr@@AEAAXH@Z @ 0x1C00BDE48
 * Callers:
...
void __fastcall CLegacyRotationMgr::xxxSetAutoRotationConvertible(CLegacyRotationMgr *this, int a2)
{
  ...
  if ( (unsigned int)hProvider > 5 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x200000000001uLL) )
  {
    ...
    v7 = 4;
    v10 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E3078, v4, v2, 4u, &pData);
    LODWORD(v2) = v12;
  }
  if ( dword_1C03227B4 && !(_DWORD)v2 && !dword_1C03227B0 )
  {
    CLegacyRotationMgr::xxxRestoreSlateAutorotationPreferences(this);
    LODWORD(v2) = v12;
  }
  dword_1C03227B4 = (int)v2;
}
