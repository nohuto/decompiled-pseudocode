/*
 * XREFs of NtGdiFrameRgn @ 0x1C01182C0
 * Callers:
        ...
        *(_QWORD *)&v40[0].ulReserved = &v66;
        ...
        if ( (unsigned int)EPATHOBJ::bComputeWidenedBounds((EPATHOBJ *)v58, (struct EPATHOBJ *)v56, v40, &v44) )
        {
          if ( (unsigned int)EPATHOBJ::bWiden((EPATHOBJ *)v58, (struct EPATHOBJ *)v56, v40, &v44) )
          {
            ...
            if ( (unsigned int)XDCOBJ::bFullScreen((XDCOBJ *)v36) || !*(_QWORD *)(v14 + 504) )
              goto LABEL_35;
            ...
            *((_QWORD *)v16 + 190) = v15;
            ...
            if ( ((__int64)v44.pstyle & 1) != 0 )
            {
              if ( (unsigned int)DC::bTightenRao(v36[0]) )
              {
                ...
                v60.left += *((_DWORD *)v36[0] + 2 * v19 + 356);
                v60.right += *((_DWORD *)v36[0] + 2 * v19 + 356);
                v60.top += *((_DWORD *)v36[0] + 2 * v19 + 357);
                v60.bottom += *((_DWORD *)v36[0] + 2 * v19 + 357);
                GreScaleValuesInternal((struct XDCOBJ *)v36, &v60.left, 4u);
                ...
                else
                {
                  ...
                  if ( v42[0] )
                  {
                    if ( (*((_DWORD *)v36[0] + 9) & 0xE0) != 0 && (*((_DWORD *)v42[0] + 10) & 0x100) == 0 )
                    {
                      ...
                      XDCOBJ::vAccumulateTight((struct _RECTL **)v36, v23, &rclBounds);
                    }
                    bSyncBrushObj(v24);
                    ...
                    else
                    {
                      ...
                      ++*(_DWORD *)(v18 + 92);
                      EngPaint((SURFOBJ *)(v18 + 24), &pco, &pbo, (POINTL *)v36[0] + 198, mix);
                      v28 = v36[0];
                      v8 = 1;
                      *((_DWORD *)v36[0] + 9) |= 0x10u;
                      *((_QWORD *)v28 + 190) = 0LL;
