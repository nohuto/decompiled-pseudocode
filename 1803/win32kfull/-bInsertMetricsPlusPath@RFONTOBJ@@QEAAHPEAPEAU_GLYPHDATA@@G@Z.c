/*
 * XREFs of ?bInsertMetricsPlusPath@RFONTOBJ@@QEAAHPEAPEAU_GLYPHDATA@@G@Z @ 0x1C0127EC4
 * Callers:
...
__int64 __fastcall RFONTOBJ::bInsertMetricsPlusPath(RFONTOBJ *this, struct _GLYPHDATA **a2, __int16 a3)
{
    ...
    || (result = RFONTOBJ::bAllocateCache(this, (struct RFONTOBJ *)a2), (_DWORD)result) )
  {
    ...
    {
      v8 = *(_QWORD *)this;
      v18 = *(_QWORD *)(*(_QWORD *)this + 112LL);
      v9 = &v21;
      if ( !*(_DWORD *)(v8 + 628) )
        v9 = *(struct _GLYPHDATA **)(v3 + 504);
      if ( (unsigned int)PFFOBJ::QueryFontData(
                           (PFFOBJ *)&v18,
                           *(struct DHPDEV__ **)(v8 + 96),
                           (struct _FONTOBJ *)v8,
                           2u,
                           v5,
                           v9,
