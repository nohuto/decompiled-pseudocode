/*
 * XREFs of ?DdcciGetTimingReport@CMonitorAPI@@QEAAJPEAXPEAU_MC_TIMING_REPORT@@@Z @ 0x1C023E028
 * Callers:
 *     NtGdiDDCCIGetTimingReport @ 0x1C023EB20 (NtGdiDDCCIGetTimingReport.c)
 * Callees:
