/*
 * XREFs of ?SpNotifyLSurface@@YAJPEAUHDEV__@@PEAUHLSURF__@@HKPEAU_CD_HLSURF_CREATIONCONTEXT@@@Z @ 0x1C007D8B8
 * Callers:
...
__int64 __fastcall SpNotifyLSurface(_QWORD *a1, HLSURF a2, int a3, int a4, struct _CD_HLSURF_CREATIONCONTEXT *a5)
{
  ...
  if ( (unsigned int)bNeedRenderHint((struct PDEVOBJ *)&v14) )
  {
    *(_QWORD *)&v13[0] = a2;
    ...
    v10 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64, _OWORD *))a1[428])(
            a1[224],
