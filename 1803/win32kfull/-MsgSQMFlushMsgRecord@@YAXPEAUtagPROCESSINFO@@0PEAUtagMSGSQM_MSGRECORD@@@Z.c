/*
 * XREFs of ?MsgSQMFlushMsgRecord@@YAXPEAUtagPROCESSINFO@@0PEAUtagMSGSQM_MSGRECORD@@@Z @ 0x1C01D0FB0
 * Callers:
 *     xxxInterSendMsgEx @ 0x1C0044BF0 (xxxInterSendMsgEx.c)
 *     MSGSQMAddMessage @ 0x1C0062398 (MSGSQMAddMessage.c)
 *     ?MsgSQMFreeMsgList@@YAXPEAUtagPROCESSINFO@@0PEAPEAUtagMSGSQM_MSGRECORD@@@Z @ 0x1C01D10BC (-MsgSQMFreeMsgList@@YAXPEAUtagPROCESSINFO@@0PEAPEAUtagMSGSQM_MSGRECORD@@@Z.c)
 * Callees:
        ...
        struct tagMSGSQM_MSGRECORD *a3)
{
  ...
  v3 = (const struct tagMSGSQM_PROCESSSQMINFO *)*((_QWORD *)a1 + 107);
  v5 = (const struct tagMSGSQM_PROCESSSQMINFO *)*((_QWORD *)a2 + 107);
  v6 = 0;
  if ( v3 || v5 )
  {
    v7 = *((_DWORD *)a3 + 6);
