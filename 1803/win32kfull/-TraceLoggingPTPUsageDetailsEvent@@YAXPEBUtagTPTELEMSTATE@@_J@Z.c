/*
 * XREFs of ?TraceLoggingPTPUsageDetailsEvent@@YAXPEBUtagTPTELEMSTATE@@_J@Z @ 0x1C0199694
 * Callers:
...
void __fastcall TraceLoggingPTPUsageDetailsEvent(const struct tagTPTELEMSTATE *a1)
{
  ...
  if ( (unsigned int)hProvider > 5 )
  {
    ...
    {
      v4 = 1000LL * *(_QWORD *)(v2 + 96);
      v20 = 4LL;
      v22 = 4LL;
      v24 = 4LL;
      v8 = v4 / v3;
      v19 = &v8;
      v5 = 1000LL * *(_QWORD *)(v2 + 104);
      v26 = 4LL;
      v28 = 4LL;
      v9 = v5 / v3;
      v21 = &v9;
      v6 = 1000LL * *(_QWORD *)(v2 + 112);
      v30 = 4LL;
      v32 = 4LL;
      v10 = v6 / v3;
      v23 = &v10;
      ...
      v17 = *(_DWORD *)(v2 + 140);
      v37 = &v17;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C02E27FC, v1, (LPCGUID)v2, 0xCu, &pData);
    }
  }
}
