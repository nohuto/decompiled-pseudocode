/*
 * XREFs of NtGdiWidenPath @ 0x1C027E230
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vReComputeBounds@EPATHOBJ@@QEAAXXZ @ 0x1C029DD74 (-vReComputeBounds@EPATHOBJ@@QEAAXXZ.c)
 */
...
LABEL_5:
  ...
  v2 = 1;
  v3 = (struct _LINEATTRS *)((char *)v6[0] + 216);
  if ( (*((_DWORD *)v6[0] + 54) & 1) != 0 )
  {
LABEL_11:
...
LABEL_14:
  ...
  if ( (*(_DWORD *)(*((_QWORD *)v6[0] + 19) + 40LL) & 0x800) != 0 )
  {
    v3 = (struct _LINEATTRS *)&unk_1C0321BF0;
    goto LABEL_11;
  }
  v4 = 1003;
LABEL_15:
