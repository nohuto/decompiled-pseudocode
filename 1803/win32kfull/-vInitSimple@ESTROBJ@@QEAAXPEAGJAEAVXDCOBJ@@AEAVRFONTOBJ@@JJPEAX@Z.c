/*
 * XREFs of ?vInitSimple@ESTROBJ@@QEAAXPEAGJAEAVXDCOBJ@@AEAVRFONTOBJ@@JJPEAX@Z @ 0x1C028D504
 * Callers:
        ...
        struct RFONTOBJ *a5)
{
  ...
  *((_QWORD *)this + 5) = a2;
  ...
  if ( v9 )
  {
    *((_DWORD *)this + 58) |= 1u;
    *((_QWORD *)this + 8) = v9;
    *((_DWORD *)this + 1) = *(_DWORD *)(*(_QWORD *)v7 + 260LL) & 0x71 | 2;
    if ( (unsigned int)RFONTOBJ::bGetGlyphMetricsPlus(v7, (struct RFONTOBJ *)1, v9, a2, &v18, a4, this) )
    {
      ...
      v10->ptl.x = 0;
      v10->ptl.y = *(_DWORD *)(*(_QWORD *)v7 + 332LL);
      v12 = (*((_DWORD *)this + 58) & 0x1400) == 0;
      v13 = *(_DWORD *)(*(_QWORD *)v7 + 296LL);
      *((_DWORD *)this + 2) = v13;
      if ( v12 && v13 )
      {
        *((_DWORD *)this + 3) = 0;
      ...
      {
        *((_DWORD *)this + 2) = 0;
        v10->ptl.y = *((_DWORD *)ESTROBJ::GetLinkedRfontOnIndex(this, 0, v7) + 83);
      ...
      *((_DWORD *)this + 4) = 0;
      *((_DWORD *)this + 5) = v14;
      *((_DWORD *)this + 6) = *(_DWORD *)(*(_QWORD *)v7 + 336LL);
