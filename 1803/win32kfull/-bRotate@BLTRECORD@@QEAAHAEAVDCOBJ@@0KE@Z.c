/*
 * XREFs of ?bRotate@BLTRECORD@@QEAAHAEAVDCOBJ@@0KE@Z @ 0x1C025C294
 * Callers:
 ...
 *     ?vOrder@BLTRECORD@@QEAAXPEAVERECTL@@@Z @ 0x1C026076C (-vOrder@BLTRECORD@@QEAAXPEAVERECTL@@@Z.c)
 */
        ...
        unsigned __int8 a5)
{
  ...
  __m128i v67[4]; // [rsp+A4h] [rbp-5Ch] BYREF
  ...
  if ( (a4 & 0xD4) != 0 )
  {
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)a2 + 80LL) + 312LL) & 1) != 0 && BLTRECORD::pSurfMskOut((BLTRECORD *)this) )
    {
      v21 = this[23].x - v15->x;
      v22 = this[10];
      v23 = this[24].x;
      ...
      || !*((_WORD *)XDCOBJ::pSurfaceEff(a3) + 50) )
    {
      ...
      {
        if ( *(_QWORD *)(v35 + 504) && *(_QWORD *)(v34 + 504) )
        {
          ...
          v56 = this + 15;
          this[15].x += 16 * *(_DWORD *)(v39 + 8 * v42 + 1424);
          this[15].y += 16 * *(_DWORD *)(v39 + 8 * v42 + 1428);
          this[16].x += 16 * *(_DWORD *)(v39 + 8 * v42 + 1424);
          this[16].y += 16 * *(_DWORD *)(v39 + 8 * v42 + 1428);
          this[17].x += 16 * *(_DWORD *)(v39 + 8 * v42 + 1424);
          this[17].y += 16 * *(_DWORD *)(v39 + 8 * v42 + 1428);
          this[18].x += 16 * *(_DWORD *)(v39 + 8 * v42 + 1424);
          this[18].y += 16 * *(_DWORD *)(v39 + 8 * v42 + 1428);
          v43 = *(_QWORD *)a3;
          v44 = *(_DWORD *)(*(_QWORD *)a3 + 40LL) & 1LL;
          v15->x += *(_DWORD *)(*(_QWORD *)a3 + 8 * v44 + 1424);
          v15[1].x += *(_DWORD *)(v43 + 8 * v44 + 1424);
          v15->y += *(_DWORD *)(v43 + 8 * v44 + 1428);
          v15[1].y += *(_DWORD *)(v43 + 8 * v44 + 1428);
          v45 = *(_QWORD *)a2;
          v46 = *(_DWORD *)(*(_QWORD *)a2 + 40LL) & 1LL;
          v62 += *(_DWORD *)(*(_QWORD *)a2 + 8 * v46 + 1424);
          v64 = *(_DWORD *)(v45 + 8 * v46 + 1424) + v41;
          v63 += *(_DWORD *)(v45 + 8 * v46 + 1428);
          v65 = *(_DWORD *)(v45 + 8 * v46 + 1428) + v40;
          ...
          if ( !ERECTL::bEmpty((ERECTL *)v67) )
          {
            ...
            {
              v61 = v67[0];
              XDCOBJ::vAccumulateTight((struct _RECTL **)a2, v48, &v61);
            }
            BLTRECORD::vMirror((BLTRECORD *)this, this + 15);
            ++*(_DWORD *)(*(_QWORD *)&this[8] + 92LL);
            v50 = 0LL;
            v51 = *(_QWORD *)a2;
            if ( *(__int16 *)(*(_QWORD *)a2 + 186LL) >= 0 )
              v50 = *(_QWORD *)a2 + 184LL;
            if ( this[27].x != 52428 )
            {
            ...
            if ( (*(_DWORD *)(*(_QWORD *)&v53 + 112LL) & 4) != 0 )
              return (unsigned int)(*(__int64 (__fastcall **)(__int64, __int64, char *, _BYTE *, _QWORD, __int64, __int64, struct _POINTFIX *, struct _POINTFIX *, struct _POINTFIX *, _DWORD))(v49 + 3240))(
