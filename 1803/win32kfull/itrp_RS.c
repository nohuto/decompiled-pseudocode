...
__int64 __fastcall itrp_RS(__int64 a1)
{
  ...
  v3 = *(_QWORD *)(qword_1C0327180 + 344);
  v4 = *v2;
  if ( (int)v4 >= *(unsigned __int16 *)(v3 + 18)
    || (int)v4 < 0
    || (v5 = *(_QWORD *)(qword_1C0327180 + 8),
        (qword_1C0327180 ^ v3 ^ v5 ^ MEMORY[0xFFFFF78000000330]) != *(_QWORD *)(qword_1C0327180 + 352)) )
  {
    dword_1C03271D0 = 4377;
    return qword_1C03271D8;
  }
  if ( (_DWORD)v4 == 8
    && (*(_BYTE *)(qword_1C0327180 + 452) & 1) != 0
    && (*(_BYTE *)(qword_1C0327180 + 120) & 4) == 0
    && (v6 = *(_WORD *)(qword_1C0327180 + 454), (v6 & 0x400) != 0) )
  {
    *(_WORD *)(qword_1C0327180 + 454) = v6 | 8;
    *(_DWORD *)qword_1C0327168 = 0;
  }
  else
  {
    *v2 = *(_DWORD *)(v5 + 4 * v4);
