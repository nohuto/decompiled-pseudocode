/*
 * XREFs of ?SetDevicePropertyData@SimpleHapticsController@@QEAAJPEBU_DEVPROPKEY@@KKKKPEAX@Z @ 0x1C0215B0C
 * Callers:
        ...
        PVOID Data)
{
  ...
  if ( (unsigned int)dword_1C031C790 > 4 )
  {
    ...
    v14 = 51;
    v17 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E4216, a3, a4, 4u, &pData);
  }
  v8 = *((_QWORD *)this + 7);
  if ( v8 )
  {
    ...
    if ( result < 0 )
    {
      if ( (unsigned int)dword_1C031C790 > 2 )
      {
        ...
        v14 = 17;
        v17 = 4;
        TlgWrite((TraceLoggingHProvider)&dword_1C031C790, &unk_1C02E4170, a3, a4, 4u, &pData);
        result = v10;
      }
      DbgPrintEx(
        0x4Du,
