/*
 * XREFs of _DelegateCapturePointers @ 0x1C01B88B4
 * Callers:
 *     EditionDelegateCapturePointers @ 0x1C01B84D0 (EditionDelegateCapturePointers.c)
      ...
      if ( *(_DWORD *)(v5 + 180) )
      {
        ...
        if ( v8 )
          ...
          CTouchProcessor::SetPointerInfoNodeFlagFromEdition(
            ...
            *(_WORD *)(v5 - 4),
            0x200000u);
        DelegateDiscardMessages(*(struct tagQ **)(v7 + 424), v8, (struct tagDELEGATEPOINTERMAP *)(a2 + 192 * v2));
      }
