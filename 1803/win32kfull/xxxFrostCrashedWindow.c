/*
 * XREFs of xxxFrostCrashedWindow @ 0x1C01BFDB4
 * Callers:
  ...
  if ( (unsigned int)_ShouldFrostCrashedWindow((struct tagWND *)a1) )
  {
    ...
    if ( v15 )
    {
      if ( v16 )
      {
        ...
        {
          if ( RealGetProp(*(_QWORD *)(v17 + 120), *(unsigned __int16 *)(gpsi + 1378LL), 1LL) )
          {
            v19 = v28;
            if ( v28 )
            {
              ...
              if ( v20 )
              {
                if ( !(unsigned int)IsWindowBeingDestroyed(v20)
                  && RealGetProp(*(_QWORD *)(v21 + 120), *(unsigned __int16 *)(gpsi + 1378LL), 1LL) )
                {
                  return v19;
                }
              }
