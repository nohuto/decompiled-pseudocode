/*
 * XREFs of ?ProcessDownOnly@@YAXPEAUtagMOUSE_PROMOTION_CACHE@@PEAUtagMOUSE_PROMOTION_ENTRY@@HH@Z @ 0x1C01CD30C
 * Callers:
  ...
  if ( v8 )
  {
    ...
    *(_QWORD *)v8 = 0LL;
    ...
    AppendMousePromotionQueue(
      ...
      (struct tagMOUSE_PROMOTION_ENTRY *)v8);
    word_1C0326C20 = *(_WORD *)a1;
    dword_1C0326C24 = *((_DWORD *)a2 + 8);
