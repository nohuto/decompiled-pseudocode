/*
 * XREFs of ?MulStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C0273E60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_81:
        if ( !v38 )
        {
          ...
          if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)v80) + 112) & 2) != 0 )
            v50 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, RECTL *, RECTL *, POINTL *, ULONG))(*((_QWORD *)v79 + 7) + 2840LL);
          else
            v50 = EngStretchBlt;
          v51 = v87;
          if ( v87->iType == 1 && *(_QWORD *)(v62 + 48) != *(_QWORD *)(v64 + 48) )
            v50 = EngStretchBlt;
          v52 = iMode;
          if ( iMode == 4 && (*(_BYTE *)(*(_QWORD *)(v64 + 48) + 1816LL) & 0x10) == 0 )
            v50 = EngStretchBlt;
          v53 = v88;
