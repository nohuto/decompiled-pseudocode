/*
 * XREFs of ?vPFFC_Delete@PFFOBJ@@QEAAXPEAVPFFCLEANUP@@@Z @ 0x1C0081004
 * Callers:
...
void __fastcall PFFOBJ::vPFFC_Delete(PFFOBJ *this, struct PFFCLEANUP *a2)
{
  ...
  v2 = *(_QWORD *)this;
  v3 = 0LL;
  for ( i = *(_QWORD *)(*(_QWORD *)this + 224LL); (unsigned int)v3 < *(_DWORD *)(v2 + 208); v3 = (unsigned int)(v3 + 1) )
  {
    v17 = *(_QWORD *)(v2 + 8 * v3 + 224);
    if ( v17 )
    {
