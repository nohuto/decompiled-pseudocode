/*
 * XREFs of EngDrawStream @ 0x1C00A8590
 * Callers:
 ...
 * Callees:
 *     ?bRedirHooked@SURFACE@@QEAAHXZ @ 0x1C00AB5EC (-bRedirHooked@SURFACE@@QEAAHXZ.c)
        ...
        _QWORD *a9)
{
  ...
  __int64 v23; // rax
  __int64 (__fastcall *v24)(int, int, int, int, __int64, __int64, __int64, __int64); // r10
  __int64 (__fastcall *v25)(int, int, int, int, __int64, __int64, __int64, __int64); // r8
...
LABEL_23:
    ...
    v24 = EngNineGrid;
    if ( *(_QWORD *)(v23 + 3408) )
      v24 = *(__int64 (__fastcall **)(int, int, int, int, __int64, __int64, __int64, __int64))(v23 + 3408);
    if ( (!*(_QWORD *)(a1 + 16) || (*(_DWORD *)(v14 + 2120) & 0x400) == 0)
