/*
 * XREFs of ?bDelete@COLORTRANSFORMOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C02644F4
 * Callers:
 *     XDCOBJ_vCleanupColorTransformWrap @ 0x1C00DFEA0 (XDCOBJ_vCleanupColorTransformWrap.c)
 ...
 *     ?bRemoveColorTransform@XDCOBJ@@QEAAHPEAX@Z @ 0x1C026462C (-bRemoveColorTransform@XDCOBJ@@QEAAHPEAX@Z.c)
 */
      ...
      if ( v10 )
      {
        ...
        if ( v11 )
        {
          ...
          else
          {
            ...
            v12 = *(unsigned int (__fastcall **)(_QWORD, __int64))(v11 + 3200);
            if ( v12 )
            {
              if ( v12(*(_QWORD *)(v11 + 1792), v10) || (*(_DWORD *)(v11 + 40) & 0x8000) != 0 )
