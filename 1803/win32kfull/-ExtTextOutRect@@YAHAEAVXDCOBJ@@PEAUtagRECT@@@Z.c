/*
 * XREFs of ?ExtTextOutRect@@YAHAEAVXDCOBJ@@PEAUtagRECT@@@Z @ 0x1C009D650
 * Callers:
...
__int64 __fastcall ExtTextOutRect(struct XDCOBJ *a1, struct tagRECT *a2)
{
  ...
  if ( !*(_QWORD *)a1 || (*(_DWORD *)(v3 + 36) & 0x10000) != 0 )
    return 0;
  v5 = 1;
  v39 = *(_DWORD *)(*(_QWORD *)(v3 + 80) + 68LL);
  v40 = *(_DWORD *)(*(_QWORD *)(v3 + 80) + 312LL) & 1;
  EXFORMOBJ::vInit((EXFORMOBJ *)&v38, a1, 0x204u, 0x80000000);
  v6 = *(_DWORD *)(v38 + 32);
  if ( (v6 & 1) == 0 )
  ...
  *(__int64 *)((char *)v42.m128i_i64 + 4) = __PAIR64__(right, top);
  ...
  if ( (int)top > bottom )
  {
    ...
    top = (unsigned int)bottom;
    v42.m128i_i32[3] = v36;
    bottom = v36;
  }
  if ( left == right || (_DWORD)top == bottom )
    return v5;
  v11 = *(_QWORD *)a1;
  ...
  if ( (v12 & 0xE0) != 0 )
  {
    ...
    if ( (v12 & 0x20) != 0 )
    {
      ERECTL::operator|=(v11 + 1472, &v42, top);
      v13 = *(_QWORD *)a1;
    }
    v11 = v13;
    if ( (*(_DWORD *)(v13 + 36) & 0x80u) != 0 )
    {
      ERECTL::operator|=(v13 + 1504, &v42, top);
      v11 = *(_QWORD *)a1;
    }
  }
  v14 = *(_QWORD *)(v11 + 504);
    ...
    && (unsigned __int64)(v17 + v42.m128i_i32[2] + 0x80000000LL) <= 0xFFFFFFFF )
  {
      ...
      && (unsigned __int64)(v18 + v42.m128i_i32[3] + 0x80000000LL) <= 0xFFFFFFFF )
    {
      ...
      v42.m128i_i32[0] = v19;
      v20 = 0LL;
      v21 = *(_DWORD *)(v15 + 8 * v16 + 1424) + v42.m128i_i32[2];
      v22 = 0;
      v23 = *(_DWORD *)(v15 + 8 * v16 + 1428) + v42.m128i_i32[1];
      *(__int64 *)((char *)v42.m128i_i64 + 4) = __PAIR64__(v21, v23);
      v24 = v42.m128i_i32[3] + *(_DWORD *)(v15 + 8 * v16 + 1428);
      v42.m128i_i32[3] = v24;
      if ( (int)v19 >= *(_DWORD *)(v15 + 1408) && v21 <= *(_DWORD *)(v15 + 1416) && v23 >= *(_DWORD *)(v15 + 1412) )
        v22 = v24 <= *(_DWORD *)(v15 + 1420);
      v25 = *(_DWORD *)(v15 + 528);
      if ( (v25 & 1) != 0 && (v25 & 2) == 0 )
      {
        v37 = &v42;
      ...
      else
      {
        ...
        XCLIPOBJ::vSetup((XCLIPOBJ *)(v15 + 2160), v26, (struct ERECTL *)&v42, 2);
        v42 = *(__m128i *)(v15 + 2164);
        v27 = v42;
      ...
      v30 = *(_QWORD *)a1 + 2000LL;
      v31 = (struct ECLIPOBJ *)*(unsigned int *)(v29 + 8);
      if ( (((unsigned __int8)v31 | *(_BYTE *)(*(_QWORD *)a1 + 324LL)) & 8) != 0 )
      {
        *(_DWORD *)(v29 + 8) = (unsigned int)v31 & 0xFFFFFFF7;
        *(_DWORD *)(*(_QWORD *)a1 + 324LL) &= ~8u;
      ...
      {
        v41 = v27;
        XDCOBJ::vAccumulateTight((struct _RECTL **)a1, v31, &v41);
      }
      ++*(_DWORD *)(v14 + 92);
      v32 = *(_QWORD *)a1 + 1584LL;
      if ( (*(_DWORD *)(v14 + 112) & 1) != 0 )
        return (unsigned int)(*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, __int64, _QWORD, __m128i *, _QWORD, _QWORD, __int64, __int64, int))(*(_QWORD *)(v14 + 48) + 2824LL))(
                               v14 + 24,
                               0LL,
                               0LL,
                               v20,
