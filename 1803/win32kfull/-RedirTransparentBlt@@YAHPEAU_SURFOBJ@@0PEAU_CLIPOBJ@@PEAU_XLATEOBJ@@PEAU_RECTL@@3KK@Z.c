/*
 * XREFs of ?RedirTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KK@Z @ 0x1C026D6A0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ulReserved)
{
  ...
  struct SURFACE *v23; // [rsp+68h] [rbp-49h] BYREF
  ...
  if ( a1 )
  {
    if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(a1) + 112) & 0x800) != 0 )
    {
      ...
      if ( HDEV )
      {
        ...
        {
          for ( i = **(struct _DISPSURF ***)(v12 + 1792); i; i = *(struct _DISPSURF **)i )
          {
            v14 = *((_QWORD *)i + 6);
            HDEV = v14;
            if ( v14 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v14 + 1784) + 656LL) )
                {
