/*
 * XREFs of ?StartComposition@CDwmAppHost@@AEAAJXZ @ 0x140002050
 * Callers:
...
__int64 __fastcall CDwmAppHost::StartComposition(CDwmAppHost *this)
{
  ...
  v9 = &qword_14000E908;
  v2 = DwmInitializeEngine(&v9, &qword_14000E8F8);
  if ( v2 < 0 )
  {
  ...
  else
  {
    ...
    v2 = DwmClientStartup(&v9, &qword_14000E8F8);
    if ( v2 < 0 )
    {
