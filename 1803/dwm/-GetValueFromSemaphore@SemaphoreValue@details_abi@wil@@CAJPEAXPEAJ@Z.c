/*
 * XREFs of ?GetValueFromSemaphore@SemaphoreValue@details_abi@wil@@CAJPEAXPEAJ@Z @ 0x1400052E0
 * Callers:
...
__int64 __fastcall wil::details_abi::SemaphoreValue::GetValueFromSemaphore(HANDLE hHandle, int *a2)
{
  ...
  {
    v7 = 148LL;
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)v7, (unsigned int)"wil", v6);
  }
  if ( !v4 || v4 == 258 )
  {
    PreviousCount = 0;
