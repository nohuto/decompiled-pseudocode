/*
 * XREFs of ?MilInstrumentationBreak@@YAXK_N@Z @ 0x14000838C
 * Callers:
 ...
 * Callees:
 *     ?IsKernelDebuggerEnabled@@YAHXZ @ 0x1400082E0 (-IsKernelDebuggerEnabled@@YAHXZ.c)
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x140008328 (-IsKernelDebuggerPresent@@YAHXZ.c)
 *     ?RegGetHKLMDword@@YA_NQEBG0PEAK@Z @ 0x14000866C (-RegGetHKLMDword@@YA_NQEBG0PEAK@Z.c)
 */
