/*
 * XREFs of ?IsHiDefRemoteAppSession@CDynamicSettingsManager@@AEAAJPEA_N@Z @ 0x1400017D0
 * Callers:
...
_BOOL8 __fastcall CDynamicSettingsManager::IsHiDefRemoteAppSession(CDynamicSettingsManager *this, bool *a2)
{
  ...
  *a2 = 0;
  if ( !(unsigned __int8)IsWinStationQueryInformationWPresent() )
    return 0LL;
  v4 = (*(__int64 (__fastcall **)(__int64 *, __int64))(qword_14000E908 + 56))(&qword_14000E908, 32LL);
  if ( !v4 )
  {
