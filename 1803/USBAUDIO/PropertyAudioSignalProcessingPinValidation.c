/*
 * XREFs of PropertyAudioSignalProcessingPinValidation @ 0x1C001C498
 * Callers:
 *     PropertyAudioSignalProcessingBasicSupport @ 0x1C001C540 (PropertyAudioSignalProcessingBasicSupport.c)
