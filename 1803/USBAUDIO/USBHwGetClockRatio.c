/*
 * XREFs of USBHwGetClockRatio @ 0x1C0002D9C
 * Callers:
...
__int64 __fastcall USBHwGetClockRatio(__int64 a1, _OWORD *a2, _QWORD *a3)
{
  ...
  *(_BYTE *)(v3 + 12) = 1;
    ...
    if ( !*(_DWORD *)(v3 + 40) )
    {
      ...
      if ( v18 > 0x7A120 )
      {
        ...
        if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
          WPP_RECORDER_SF_did((__int64)WPP_GLOBAL_Control->DeviceExtension, v19, v20, 0x1Du, v23);
      }
  ...
  else
  {
    ...
    v13 = v24[0];
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
      WPP_RECORDER_SF_did((__int64)WPP_GLOBAL_Control->DeviceExtension, v10, v11, 0x1Cu, v23);
    v9 = KeAcquireSpinLockRaiseToDpc(v8);
    if ( v7 >= 0 )
    {
      *(_DWORD *)(v3 + 24) = v12;
