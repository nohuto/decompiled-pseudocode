            ...
            if ( (*v12 & 0xFu) >= 2 )
            {
              ...
              if ( i != v15 )
              {
                ...
                if ( i[32] )
                {
                  ...
                  if ( v19 != (__int64 *)(i + 80) )
                  {
                    if ( (_QWORD *)v19[1] != v18 || (v20 = *v19, *(__int64 **)(*v19 + 8) != v19) )
                      __fastfail(3u);
                    *v18 = v20;
                    *(_QWORD *)(v20 + 8) = v18;
