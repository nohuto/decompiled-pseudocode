/*
 * XREFs of FilterCreateFilterPropertySets @ 0x1C00181C4
 * Callers:
...
__int64 __fastcall FilterCreateFilterPropertySets(__int64 a1, _DWORD *a2, _QWORD *a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    PoolWithTag = ExAllocatePoolWithTag((POOL_TYPE)512, 40 * v7, 0x41627845u);
    *a3 = PoolWithTag;
    if ( PoolWithTag )
    {
