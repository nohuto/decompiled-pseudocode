/*
 * XREFs of USBDeviceStop @ 0x1C001F9B0
 * Callers:
 *     USBDeviceSurpriseRemove @ 0x1C001FA80 (USBDeviceSurpriseRemove.c)
 * Callees:
 ...
 *     USBHwStopAllMIDIPipes @ 0x1C0021180 (USBHwStopAllMIDIPipes.c)
 */
