/*
 * XREFs of IncrementActivePinCount @ 0x1C0018EB0
 * Callers:
...
__int64 __fastcall IncrementActivePinCount(PKSPIN Pin, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)(v7 + 520) != 1 )
  {
    ...
    KeWaitForSingleObject((PVOID)(v7 + 536), Executive, 0, 0, 0LL);
    KsAcquireControl(ParentFilter);
  }
  v8 = 0;
  if ( _InterlockedIncrement((volatile signed __int32 *)(v7 + 692)) == 1 )
  {
    v10 = *(void **)(v7 + 504);
    if ( v10 )
      PoSetPowerRequest(v10, PowerRequestSystemRequired);
    *(_QWORD *)(v7 + 512) = PoRegisterDeviceForIdleDetection(
                              *(PDEVICE_OBJECT *)(v6 + 32),
                              0,
                              0,
                              (DEVICE_POWER_STATE)*(_DWORD *)(v7 + 524));
    return 0;
  }
  return (unsigned int)v8;
}
