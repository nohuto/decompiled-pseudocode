/*
 * XREFs of USBDeviceStart @ 0x1C001F2A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RegistryReadPnPKeyValue @ 0x1C001E7C0 (RegistryReadPnPKeyValue.c)
 *     USBHwGetDescriptor @ 0x1C0020184 (USBHwGetDescriptor.c)
 *     USBHwGetAudioConfigurationDescriptor @ 0x1C0020254 (USBHwGetAudioConfigurationDescriptor.c)
...
__int64 __fastcall USBDeviceStart(__int64 a1)
{
  ...
  if ( Irp )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      v9 = (__int64)&v8->Tail.Overlay.CurrentStackLocation[-1];
      *(_QWORD *)(v9 + 56) = USBD_SyncCompletionRoutine;
      *(_QWORD *)(v9 + 64) = &Event;
      *(_BYTE *)(v9 + 3) = -32;
      v10 = (__int64)&v8->Tail.Overlay.CurrentStackLocation[-1];
      *(_QWORD *)(v10 + 32) = 0LL;
      *(_WORD *)v10 = 2075;
      *(_QWORD *)(v10 + 24) = PoolWithTag;
      *(_QWORD *)(v10 + 8) = &USB_BUS_INTERFACE_USBDI_GUID;
      *(_DWORD *)(v10 + 16) = 65608;
