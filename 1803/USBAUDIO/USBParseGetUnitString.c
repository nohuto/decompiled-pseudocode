/*
 * XREFs of USBParseGetUnitString @ 0x1C0022420
 * Callers:
 ...
 *     USBParseMIDIElement @ 0x1C0023400 (USBParseMIDIElement.c)
 * Callees:
 *     memmove @ 0x1C000A240 (memmove.c)
 *     USBHwAllocateAndBag @ 0x1C001FC9C (USBHwAllocateAndBag.c)
 *     USBHwSyncGetStringDescriptor @ 0x1C00211F0 (USBHwSyncGetStringDescriptor.c)
 */
  ...
  *a3 = 0LL;
  ...
  if ( v10 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        v13 = *(void **)(a1 + 8);
        v18 = ExAllocatePoolWithTag(PagedPool, (unsigned int)*v12 + 2, 0x41627845u);
        v14 = v18;
        if ( v18 )
