/*
 * XREFs of USBHwGetSetProperty @ 0x1C001FE40
 * Callers:
 *     USBHwGetSetByte @ 0x1C001FF90 (USBHwGetSetByte.c)
 *     USBHwGetSetShort @ 0x1C0020050 (USBHwGetSetShort.c)
 *     USBHwGetSetMemory @ 0x1C0020110 (USBHwGetSetMemory.c)
 *     USBCntrlGetSetGEQ @ 0x1C00245C0 (USBCntrlGetSetGEQ.c)
 *     USBCntrlGetSetProcessingUnitValue @ 0x1C0024770 (USBCntrlGetSetProcessingUnitValue.c)
 *     USBCntrlMuxSource @ 0x1C0024820 (USBCntrlMuxSource.c)
 *     USBCntrlGetSetMixerLevels @ 0x1C00248D0 (USBCntrlGetSetMixerLevels.c)
