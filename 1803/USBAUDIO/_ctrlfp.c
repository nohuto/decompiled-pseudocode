/*
 * XREFs of _ctrlfp @ 0x1C00094E4
 * Callers:
 *     _call_matherr @ 0x1C0008DC8 (_call_matherr.c)
 *     _handle_error @ 0x1C0008EF4 (_handle_error.c)
 * Callees:
 *     _set_fpsr @ 0x1C00095C0 (_set_fpsr.c)
...
__int64 __fastcall ctrlfp(int a1, int a2)
{
  ...
  if ( byte_1C00104D0 && (((unsigned __int8)(a2 & a1) | fpsr & ((unsigned __int8)~(_BYTE)a2 | 0x7F)) & 0x40) != 0 )
    set_fpsr(v5);
  else
