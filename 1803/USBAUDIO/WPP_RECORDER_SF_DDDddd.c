/*
 * XREFs of WPP_RECORDER_SF_DDDddd @ 0x1C0002FA8
 * Callers:
 *     USBType1AsyncEndpointPollCallback @ 0x1C0003790 (USBType1AsyncEndpointPollCallback.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_DDDddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 4) != 0 )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_3782699cdfb7314fc0fa753a1da472e6_Traceguids,
      13LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 13;
  return WppAutoLogTrace(a1, 0LL, 3LL, &WPP_3782699cdfb7314fc0fa753a1da472e6_Traceguids, v7, (__int64 *)va);
}
