/*
 * XREFs of ??$GetActivationFactory@UIPinnedWebsitesStatics@Taskbar@Internal@Windows@@@wil@@YA?AV?$com_ptr_t@UIPinnedWebsitesStatics@Taskbar@Internal@Windows@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x180090E4C
 * Callers:
...
const WCHAR *__fastcall wil::GetActivationFactory<Windows::Internal::Taskbar::IPinnedWebsitesStatics>(const WCHAR *a1)
{
  __int64 v2; // rdi
  __int64 v3; // rcx
  ...
  v6[3] = a1;
  v6[0] = L"Windows.Internal.Taskbar.PinnedWebsites";
  *(_QWORD *)a1 = 0LL;
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  ActivationFactory = RoGetActivationFactory(*(_QWORD *)(v2 + 24), &GUID_8e03a134_f922_409b_9207_c625d92ae82e, a1);
