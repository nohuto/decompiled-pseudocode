/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x1800036CC
 * Callers:
 ...
 * Callees:
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x180001830 (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
...
LABEL_20:
  ...
  wil::details::in1diag3::Return_Hr(retaddr, (void *)0xD6, (__int64)"wil", (const char *)(unsigned int)v18);
  if ( !CloseHandle(v17) )
  {
...
LABEL_21:
  ...
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x879, v23, v24);
    JUMPOUT(0x1800038F5LL);
  }
  return LastError;
}
