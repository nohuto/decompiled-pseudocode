/*
 * XREFs of ?s_AttachAndRecoverTask@ComTaskPool@Internal@Windows@@CAXPEAUTaskData@123@@Z @ 0x1800061A8
 * Callers:
 *     ?s_TPWake@CDelayedTask@ComTaskPool@Internal@Windows@@CAXPEAXE@Z @ 0x180004C40 (-s_TPWake@CDelayedTask@ComTaskPool@Internal@Windows@@CAXPEAXE@Z.c)
 *     ?s_CheckForDeadlockTimerCallback@CThread@ComTaskPool@Internal@Windows@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x1800052C0 (-s_CheckForDeadlockTimerCallback@CThread@ComTaskPool@Internal@Windows@@CAXPEAU_TP_CALLBACK_INSTA.c)
        ...
        struct Windows::Internal::ComTaskPool::TaskData *a1)
{
              ...
              *((_QWORD *)a1 + 2)) < 0 )
  {
    ...
    if ( qword_18017C170 )
      *(_QWORD *)(qword_18017C170 + 24) = a1;
    else
      Windows::Internal::ComTaskPool::s_taskFloodingList = a1;
    qword_18017C170 = (__int64)a1;
