/*
 * XREFs of ??$TargetedContentTilesExtracted@IPEB_W@LayoutResolver@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAX$$QEAI$$QEAPEB_W@Z @ 0x18009BB60
 * Callers:
        ...
        const WCHAR **a3)
{
  ...
  if ( *(_DWORD *)v6 > 5u )
  {
    ...
    v15 = 2 * v9 + 2;
    v16 = 0;
    LODWORD(v6) = TlgWrite(v6, &unk_180158B51, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &pData);
  }
  return (int)v6;
}
