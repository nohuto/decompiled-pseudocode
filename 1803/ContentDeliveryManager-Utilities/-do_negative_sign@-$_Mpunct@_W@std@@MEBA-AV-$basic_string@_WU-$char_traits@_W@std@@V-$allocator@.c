/*
 * XREFs of ?do_negative_sign@?$_Mpunct@_W@std@@MEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@XZ @ 0x1800B7F80
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::_Mpunct<wchar_t>::do_negative_sign(__int64 a1, _QWORD *a2)
{
