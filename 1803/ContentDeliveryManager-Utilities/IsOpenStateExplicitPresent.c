/*
 * XREFs of IsOpenStateExplicitPresent @ 0x1800C1A58
 * Callers:
 *     ?GetSoftLandingFolderForUser@@YAJPEAXPEA_W_K@Z @ 0x18009F740 (-GetSoftLandingFolderForUser@@YAJPEAXPEA_W_K@Z.c)
 * Callees:
 *     ApiSetQueryApiSetPresence_0 @ 0x1800C1AB0 (ApiSetQueryApiSetPresence_0.c)
 */
...
char IsOpenStateExplicitPresent()
{
  ...
  if ( dword_18017BC14 == 1 )
    return 1;
  if ( dword_18017BC14 == 2 )
    return 0;
  v1 = 0;
  if ( (int)ApiSetQueryApiSetPresence_0(L"HJ", &v1) < 0 )
    return 0;
  result = v1;
  dword_18017BC14 = 2 - (v1 != 0);
  return result;
}
