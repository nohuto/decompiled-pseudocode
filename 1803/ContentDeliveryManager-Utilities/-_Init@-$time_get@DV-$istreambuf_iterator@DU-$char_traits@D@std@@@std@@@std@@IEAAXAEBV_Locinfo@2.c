/*
 * XREFs of ?_Init@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@IEAAXAEBV_Locinfo@2@@Z @ 0x1800BCE28
 * Callers:
 *     ?_Getcat@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800BB628 (-_Getcat@-$time_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@SA_KPEAPEBVfacet@.c)
