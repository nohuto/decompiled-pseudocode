/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_CortanaOnSpotlight@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18007BF50
 * Callers:
 *     ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_CortanaOnSpotlight@@@wil@@SA_NXZ @ 0x18007BE60 (-IsEnabled@-$Feature@U__WilFeatureTraits_Feature_CortanaOnSpotlight@@@wil@@SA_NXZ.c)
 * Callees:
...
__int64 wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetCachedFeatureEnabledState()
{
  ...
  int v11; // r9d
  signed __int32 v13; // [rsp+78h] [rbp+48h] BYREF
  unsigned int v14; // [rsp+80h] [rbp+50h] BYREF
  int v15; // [rsp+88h] [rbp+58h]
  __int16 v16; // [rsp+8Ch] [rbp+5Ch]
  ...
  {
    v2 = ((__int64 (__fastcall *)(__int64, _QWORD))g_wil_details_internalGetFeatureEnabledState)(11545976LL, 0LL);
  }
  else
  {
    ...
    if ( (unsigned int)wil_HasFeatureTestState(11545976, (enum wil_FeatureEnabledState *)&v14) )
    {
      v3 = v14;
      goto LABEL_11;
    }
    v2 = ((__int64 (__fastcall *)(__int64, _QWORD))g_wil_details_apiGetFeatureEnabledState)(11545976LL, 0LL);
  }
  v3 = v2;
LABEL_11:
  v1 = 2;
  ...
  wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
    ...
    0);
  if ( !g_wil_details_testStates || !(unsigned int)wil_HasFeatureTestState(11545976, 0LL) )
  {
    if ( v0 )
    {
      do
        v11 = `wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetFeaturePropertyCache'::`2'::data;
      while ( (((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetFeaturePropertyCache'::`2'::data >> 4) & 3) != (unsigned __int8)v5
           && v11 != _InterlockedCompareExchange(
                       &`wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetFeaturePropertyCache'::`2'::data,
                       ((unsigned __int8)`wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetFeaturePropertyCache'::`2'::data ^ (unsigned __int8)(16 * v5)) & 0x30 ^ `wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetFeaturePropertyCache'::`2'::data,
                       `wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetFeaturePropertyCache'::`2'::data) );
    }
    else
    {
      ...
      do
      {
        v13 = `wil::Feature<__WilFeatureTraits_Feature_CortanaOnSpotlight>::GetFeaturePropertyCache'::`2'::data;
