/*
 * XREFs of ?CreatePackagedUnifiedTileIdentifier@Actions@CreativeFramework@@YA?AV?$com_ptr_t@UIUnifiedTileIdentifier@UnifiedTile@Shell@WindowsInternal@@Uerr_exception_policy@wil@@@wil@@PEB_W0@Z @ 0x18007F464
 * Callers:
        ...
        const WCHAR *a3)
{
  ...
  *a1 = 0LL;
  ...
  if ( v8 <= 0xFFFFFFFF )
    v10 = v8;
  v11 = v8 > 0xFFFFFFFF ? (Microsoft::WRL::Details *)0x80070216LL : 0LL;
  if ( v8 > 0xFFFFFFFF )
  {
LABEL_20:
    Microsoft::WRL::Details::RaiseException(v11);
    __debugbreak();
  }
  v12 = v10 + 1;
  if ( v10 + 1 >= v10 )
  ...
  if ( v12 < v10 )
  {
    Microsoft::WRL::Details::RaiseException(v12 < v10 ? (Microsoft::WRL::Details *)0x80070216LL : 0);
    __debugbreak();
  }
  v13 = v9 - 1;
  if ( v10 < v9 )
  ...
  *a1 = 0LL;
  ...
  v16 = (*(__int64 (__fastcall **)(__int64, HSTRING, __int64 *))(*(_QWORD *)v7 + 48LL))(v7, string, a1);
  v17 = retaddr;
  if ( v16 < 0 )
  {
LABEL_23:
