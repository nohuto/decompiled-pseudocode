/*
 * XREFs of ?do_get_time@?$time_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@0AEAVios_base@2@AEAHPEAUtm@@@Z @ 0x1800A0DD0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  *a6 |= v15;
          ...
          0LL) == 58) )
  {
    ...
    v19 = *v16 | std::time_get<unsigned short,std::istreambuf_iterator<unsigned short>>::_Getint(
                   a1,
                   (_DWORD)a3,
                   a4,
                   0,
