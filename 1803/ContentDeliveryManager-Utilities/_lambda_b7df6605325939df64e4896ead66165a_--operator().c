/*
 * XREFs of _lambda_b7df6605325939df64e4896ead66165a_::operator() @ 0x180053174
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_b7df6605325939df64e4896ead66165a____Windows::Internal::CNoResult_::Run @ 0x180055C90 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_b7df6605325939d.c)
 * Callees:
 ...
 *     ?Destroy@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@IEAAXXZ @ 0x1800546D8 (-Destroy@-$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0E.c)
...
__int64 __fastcall lambda_b7df6605325939df64e4896ead66165a_::operator()(__int64 a1)
{
  ...
  v34 = 0LL;
  v35 = 0LL;
  v20[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionInvokedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionInvokedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionInvokedActivity *)v20,
    v7,
    v5,
    v3);
  if ( v13 >= 8 )
  ...
  try
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 72LL) + 8LL))(*(_QWORD *)(*(_QWORD *)a1 + 72LL));
  }
  catch ( ... )
  {
