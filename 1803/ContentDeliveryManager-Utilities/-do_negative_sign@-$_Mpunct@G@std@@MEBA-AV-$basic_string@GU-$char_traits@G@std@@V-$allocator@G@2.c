/*
 * XREFs of ?do_negative_sign@?$_Mpunct@G@std@@MEBA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@XZ @ 0x1800B7F30
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall std::_Mpunct<unsigned short>::do_negative_sign(__int64 a1, _QWORD *a2)
{
