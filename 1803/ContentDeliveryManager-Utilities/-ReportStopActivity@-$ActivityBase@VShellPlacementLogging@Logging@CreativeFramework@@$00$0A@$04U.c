/*
 * XREFs of ?ReportStopActivity@?$ActivityBase@VShellPlacementLogging@Logging@CreativeFramework@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@AEAAXJ@Z @ 0x1800353B0
 * Callers:
  ...
  if ( a2 < 0 )
  {
    ...
    if ( v6 )
    {
        ...
        && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
      {
        ...
        v72 = 2 * v11 + 2;
        v73 = 0;
        TlgWrite(v8, &unk_1801557BC, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x10u, &pData);
      }
    }
           ...
           && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
    {
      ...
      v83 = 2 * v28 + 2;
      v84 = 0;
      TlgWrite(v8, &unk_180155B95, (LPCGUID)(v26 + 8), 0LL, 6u, &v74);
    }
  }
