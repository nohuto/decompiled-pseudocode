/*
 * XREFs of ?GetWeakReference@?$RuntimeClassImpl@U?$RuntimeClassFlags@$00@WRL@Microsoft@@$00$00$0A@U?$IIterator@PEAVTargetedContentTriggerInternal@Internal@TargetedContent@Services@Windows@@@Collections@Foundation@Windows@@VFtmBase@23@@Details@WRL@Microsoft@@UEAAJPEAPEAUIWeakReference@@@Z @ 0x18001BF00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IUnknown *a2)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    *(_DWORD *)(WeakReference + 16) = v5;
    ...
    v13 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 48), v11, v5);
    for ( i = v5 == v13; ; i = v13 == v14 )
    {
      ...
      v13 = _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 48), v11, v13);
    }
