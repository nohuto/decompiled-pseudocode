 ...
 * Callees:
 *     _Stopfx @ 0x1800AB7C4 (_Stopfx.c)
 *     _Stoflt @ 0x1800AB8F8 (_Stoflt.c)
 *     _Stoxflt @ 0x1800ABB90 (_Stoxflt.c)
 *     _Dscale @ 0x1800ACAA8 (_Dscale.c)
 *     _Xp_addx @ 0x1800AD088 (_Xp_addx.c)
 *     _Xp_mulx @ 0x1800AD370 (_Xp_mulx.c)
 *     _Xp_setn @ 0x1800AD478 (_Xp_setn.c)
