/*
 * XREFs of ?GetFeatureIdAndReportingIdForTrigger@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@AEAIAEAG@Z @ 0x18006AB48
 * Callers:
        ...
        unsigned __int16 *a4)
{
  ...
  try
  {
    ...
    string[0] = 0LL;
    v8 = (*(__int64 (__fastcall **)(Windows::Services::TargetedContent::Internal *, HSTRING *))(*(_QWORD *)this + 64LL))(
           this,
           string);
    if ( v8 < 0 )
    {
