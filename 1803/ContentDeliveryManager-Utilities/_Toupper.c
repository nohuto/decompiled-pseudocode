/*
 * XREFs of _Toupper @ 0x1800AE168
 * Callers:
 *     ?do_toupper@?$ctype@D@std@@MEBADD@Z @ 0x1800AB500 (-do_toupper@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_toupper@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x1800AB510 (-do_toupper@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
