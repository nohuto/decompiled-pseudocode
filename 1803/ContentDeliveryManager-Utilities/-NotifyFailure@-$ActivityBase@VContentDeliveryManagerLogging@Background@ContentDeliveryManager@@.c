/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0CAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180045480
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v5 + 3) & 0x200000000000LL) == *((_QWORD *)v5 + 3) )
    {
      ...
      v88 = 2 * v9 + 2;
      v89 = 0;
      TlgWrite(v6, &unk_180157175, (LPCGUID)(a1[6] + 8LL), 0LL, 0x10u, &pData);
    }
  }
         ...
         && (*((_QWORD *)v5 + 3) & 0x200000000000LL) == *((_QWORD *)v5 + 3) )
  {
    ...
    v95 = v26 + 1;
    v96 = 0;
    TlgWrite(v6, &unk_1801552FC, (LPCGUID)(a1[6] + 8LL), 0LL, 0x13u, &pData);
  }
