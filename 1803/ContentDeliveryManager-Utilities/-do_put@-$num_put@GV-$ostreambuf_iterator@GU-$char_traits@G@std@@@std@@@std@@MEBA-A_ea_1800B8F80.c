/*
 * XREFs of ?do_put@?$num_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@AEAVios_base@2@G_N@Z @ 0x1800B8F80
 * Callers:
 *     <none>
 * Callees:
        ...
        char a6)
{
  ...
  if ( (*(_DWORD *)(a4 + 24) & 0x4000) != 0 )
  {
    ...
    v10 = std::use_facet<std::numpunct<unsigned short>>((__int64 *)v25);
    if ( v9 )
    {
