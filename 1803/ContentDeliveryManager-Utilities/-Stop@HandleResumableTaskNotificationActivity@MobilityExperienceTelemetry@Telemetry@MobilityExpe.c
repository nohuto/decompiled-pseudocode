/*
 * XREFs of ?Stop@HandleResumableTaskNotificationActivity@MobilityExperienceTelemetry@Telemetry@MobilityExperience@@QEAAXPEBD@Z @ 0x180049E10
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v6 )
  {
      ...
      && (*((_QWORD *)v8 + 3) & 0x800000000000LL) == *((_QWORD *)v8 + 3) )
    {
      ...
      v78 = a2;
      v79 = v11 + 1;
      TlgWrite(v9, &unk_180156635, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x11u, &pData);
    }
  }
  else
  {
      ...
      && (*((_QWORD *)v28 + 3) & 0x800000000000LL) == *((_QWORD *)v28 + 3) )
    {
      ...
      if ( !a2 )
        a2 = (const char *)&word_1800F144C;
      v86 = a2;
      TlgWrite(v29, &unk_18015652F, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 5u, &v81);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
