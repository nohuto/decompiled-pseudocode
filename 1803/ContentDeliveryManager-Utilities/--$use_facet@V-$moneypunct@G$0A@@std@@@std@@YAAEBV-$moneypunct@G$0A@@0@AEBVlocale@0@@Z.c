/*
 * XREFs of ??$use_facet@V?$moneypunct@G$0A@@std@@@std@@YAAEBV?$moneypunct@G$0A@@0@AEBVlocale@0@@Z @ 0x1800AF588
 * Callers:
 ...
 *     ?_Getcat@?$moneypunct@G$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800B14BC (-_Getcat@-$moneypunct@G$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 *     _CxxThrowException_0 @ 0x1800C10B3 (_CxxThrowException_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800C1AD0 (_guard_dispatch_icall_nop.c)
 */

// Hidden C++ exception states: #wind=1
struct std::_Facet_base *__fastcall std::use_facet<std::moneypunct<unsigned short,0>>(__int64 *a1)
{
  __int64 v2; // rsi
  ...
  v2 = std::_Facetptr<std::moneypunct<unsigned short,0>>::_Psave;
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::moneypunct<unsigned short,0>>::_Psave;
  v3 = std::moneypunct<unsigned short,0>::id;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::moneypunct<unsigned short,0>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::moneypunct<unsigned short,0>>::_Psave = (__int64)v11;
