/*
 * XREFs of ?EnumerateTriggersWithStateInContainer@Internal@TargetedContent@Services@Windows@@YAXV?$shared_ptr@VISettingsContainer@CommonHelper@CreativeFramework@@@std@@W4TargetedContentTriggerState@1234@V?$function@$$A6A_NAEAVPropertySetHelper@Triggers@CreativeFramework@@@Z@6@@Z @ 0x18006CEDC
 * Callers:
        ...
        __int64 a3)
{
  ...
  __int64 v10; // rcx
  _QWORD v12[2]; // [rsp+30h] [rbp-21h] BYREF
  __int128 v13; // [rsp+40h] [rbp-11h]
  __int64 v14; // [rsp+50h] [rbp-1h]
  __int64 *v15; // [rsp+58h] [rbp+7h]
  __int64 v16; // [rsp+60h] [rbp+Fh] BYREF
  _BYTE v17[24]; // [rsp+70h] [rbp+1Fh] BYREF
  char *v18; // [rsp+88h] [rbp+37h]
