/*
 * XREFs of ??$TriggerUnregisterCompleted@AEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAPEB_WAEAE@TriggerManagerUnregisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEAPEB_W00000AEAEPEBD@Z @ 0x18006418C
 * Callers:
        ...
        const unsigned __int16 *a8)
{
  ...
  if ( *(_DWORD *)v12 > 5u )
  {
      ...
      && (*((_QWORD *)v13 + 3) & 0x200000000000LL) == *((_QWORD *)v13 + 3) )
    {
      ...
      v50 = v16 + 1;
      v49 = v24;
      LODWORD(v12) = TlgWrite(v13, &unk_1801574A4, 0LL, 0LL, 0xAu, &pData);
    }
  }
  return (int)v12;
}
