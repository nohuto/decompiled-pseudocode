/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x18000A10C
 * Callers:
 *     ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x18000A5A4 (-Record@UsageIndexes@details_abi@wil@@QEAAXXZ.c)
 * Callees:
 ...
 *     _alloca_probe @ 0x1800C1AF0 (_alloca_probe.c)
 */
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  _WORD v58[2048]; // [rsp+190h] [rbp+90h] BYREF
