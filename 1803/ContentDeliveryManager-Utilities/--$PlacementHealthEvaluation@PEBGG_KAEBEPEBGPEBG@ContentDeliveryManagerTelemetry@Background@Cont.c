/*
 * XREFs of ??$PlacementHealthEvaluation@PEBGG_KAEBEPEBGPEBG@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEBG$$QEAG$$QEA_KAEBE00PEBD@Z @ 0x180039F2C
 * Callers:
        ...
        const unsigned __int16 *a7)
{
  ...
  if ( *(_DWORD *)v10 > 5u )
  {
    ...
    v37 = v17 + 1;
    v36 = v18;
    LODWORD(v10) = TlgWrite(v11, &unk_1801559F3, 0LL, 0LL, 9u, &pData);
  }
  return (int)v10;
}
