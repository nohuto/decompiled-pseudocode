/*
 * XREFs of ?wil_details_SetEnabledAndHasNotificationStateCallback@@YAHPEATwil_details_FeaturePropertyCache@@PEAX@Z @ 0x1800079C4
 * Callers:
 ...
 *     ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x18000BCB4 (-OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ.c)
