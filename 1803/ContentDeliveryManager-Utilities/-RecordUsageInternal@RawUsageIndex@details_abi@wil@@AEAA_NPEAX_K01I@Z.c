/*
 * XREFs of ?RecordUsageInternal@RawUsageIndex@details_abi@wil@@AEAA_NPEAX_K01I@Z @ 0x180009AE4
 * Callers:
 ...
 * Callees:
 *     ?Write@UsageIndexProperty@details_abi@wil@@QEBA_NAEAPEAEPEAE@Z @ 0x1800092C0 (-Write@UsageIndexProperty@details_abi@wil@@QEBA_NAEAPEAEPEAE@Z.c)
        ...
        unsigned int a6)
{
  ...
  unsigned __int16 v40; // [rsp+40h] [rbp-41h] BYREF
  char v41; // [rsp+42h] [rbp-3Fh]
  unsigned int Source; // [rsp+44h] [rbp-3Dh] BYREF
  unsigned __int16 v43; // [rsp+48h] [rbp-39h]
  void *Buf2[2]; // [rsp+50h] [rbp-31h]
  __int16 v45; // [rsp+60h] [rbp-21h] BYREF
  __int16 v46; // [rsp+64h] [rbp-1Dh] BYREF
  __int16 v47; // [rsp+68h] [rbp-19h] BYREF
  char v48; // [rsp+6Ah] [rbp-17h]
  unsigned int v49; // [rsp+6Ch] [rbp-15h]
  __int16 v50; // [rsp+70h] [rbp-11h]
  __int64 v51; // [rsp+78h] [rbp-9h]
  void *v52; // [rsp+80h] [rbp-1h]
  __int16 v53; // [rsp+88h] [rbp+7h] BYREF
  char v54; // [rsp+8Ah] [rbp+9h]
  int v55; // [rsp+8Ch] [rbp+Bh]
  __int16 v56; // [rsp+90h] [rbp+Fh]
  __int128 v57; // [rsp+98h] [rbp+17h]
  __int16 v58; // [rsp+D8h] [rbp+57h] BYREF
  ...
  *(_OWORD *)Buf2 = 0LL;
  ...
  while ( 1 )
  {
    ...
    v17 = Size == v43 ? memcmp_0(Buf1, Buf2[1], Size) : Size - v43;
    if ( v17 < 0 )
      break;
    if ( !v17 )
    {
    ...
    if ( Source )
    {
      do
      {
        v24 = !wil::details_abi::UsageIndexProperty::Read(
                 (wil::details_abi::UsageIndexProperty *)&v53,
                 &InsertionPointOrIncrement,
