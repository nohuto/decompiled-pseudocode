/*
 * XREFs of ?GetFileTimeFromString@StringUtils@CommonHelper@CreativeFramework@@YA?AU_FILETIME@@PEB_W_N@Z @ 0x18009FD08
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  LOWORD(v10) = 90;
  v6 = std::wstring::find((char *)v21, (unsigned __int16 *)&v10, 0LL, 1uLL) == -1;
  if ( v21[3] >= (void *)8 )
