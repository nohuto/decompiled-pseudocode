/*
 * XREFs of ?do_put@?$money_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@_NAEAVios_base@2@GO@Z @ 0x1800B8210
 * Callers:
 *     <none>
 * Callees:
        ...
        double a7)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    v15 = std::use_facet<std::ctype<unsigned short>>(&v22[1]);
    v22[1] = v15;
    if ( v13 )
    {
    ...
    (*(void (__fastcall **)(_QWORD, char *, char *, void **))(*(_QWORD *)v22[1] + 88LL))(
      ...
      &Buffer[v12],
      v19);
    std::wstring::append((_WORD **)v25, i, v18);
    v24[3] = (void *)7;
    v24[2] = 0LL;
    LOWORD(v24[0]) = 0;
