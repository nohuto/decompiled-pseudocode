/*
 * XREFs of ?GetIids@LaunchManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x1800105C0
 * Callers:
 *     ?GetIids@LaunchManager@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x1800243E0 (-GetIids@LaunchManager@ContentManagement@@WDA@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
