/*
 * XREFs of ?Stop@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x180079498
 * Callers:
...
int __fastcall wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,_TlgReflectorTag_Param0IsProviderType>::Stop(
        CDMUtilsUnlockTelemetry::ExtendedExecutionRequested *this)
{
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  {
    LODWORD(v6) = wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,_TlgReflectorTag_Param0IsProviderType>::ReportStopActivity(this);
  }
  if ( *((_DWORD *)this + 8) )
  {
