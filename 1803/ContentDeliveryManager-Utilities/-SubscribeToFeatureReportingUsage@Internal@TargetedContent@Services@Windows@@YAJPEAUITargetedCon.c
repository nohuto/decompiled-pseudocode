/*
 * XREFs of ?SubscribeToFeatureReportingUsage@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x18006AD90
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  try
  {
    ...
    if ( StagingConfig < 0 )
    {
      wil::details::in1diag3::_Throw_NtStatus(retaddr, (void *)0x1FE, v5, (const char *)(unsigned int)StagingConfig);
    }
    else
    {
...
LABEL_33:
          wil::details::in1diag3::_Throw_NtStatus(v22, (void *)0x20B, v21, (const char *)(unsigned int)v20);
          JUMPOUT(0x18006B022LL);
        }
LABEL_32:
