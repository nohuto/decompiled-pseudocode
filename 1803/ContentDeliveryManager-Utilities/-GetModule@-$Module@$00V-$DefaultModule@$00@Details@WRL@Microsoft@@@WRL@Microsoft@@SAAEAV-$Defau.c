/*
 * XREFs of ?GetModule@?$Module@$00V?$DefaultModule@$00@Details@WRL@Microsoft@@@WRL@Microsoft@@SAAEAV?$DefaultModule@$00@Details@23@XZ @ 0x1800262F0
 * Callers:
 *     DllCanUnloadNow @ 0x180026050 (DllCanUnloadNow.c)
 *     DllGetClassObject @ 0x180026090 (DllGetClassObject.c)
 *     DllGetActivationFactory @ 0x180026160 (DllGetActivationFactory.c)
 * Callees:
