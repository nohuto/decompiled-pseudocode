/*
 * XREFs of ?to_bytes@?$wstring_convert@V?$codecvt_utf8@G$0BAPPPP@$0A@@std@@GV?$allocator@G@2@V?$allocator@D@2@@std@@QEAA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@PEBG0@Z @ 0x18004E310
 * Callers:
 ...
 *     ??0range_error@std@@QEAA@PEBD@Z @ 0x180049138 (--0range_error@std@@QEAA@PEBD@Z.c)
 *     ??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAA@$$QEAV01@@Z @ 0x18004E260 (--0-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@std@@QEAA@$$QEAV01@@Z.c)
 *     ?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QEAAAEAV12@PEBD_K@Z @ 0x18004EA00 (-append@-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@std@@QEAAAEAV12@PEBD_K@Z.c)
        ...
        char *a4)
{
  ...
  unsigned __int64 v14; // [rsp+58h] [rbp-61h] BYREF
  ...
  std::string::append((size_t *)v20, 8uLL, 0);
  *(_QWORD *)(a1 + 96) = 0LL;
  v8 = v13;
  if ( v13 == a4 )
  {
LABEL_19:
  ...
  while ( 1 )
  {
    ...
    if ( v22 >= 0x10 )
      v9 = (void **)v20[0];
    v10 = (*(__int64 (__fastcall **)(_QWORD, __int64, char *, char *, char **, void **, char *, unsigned __int64 *))(**(_QWORD **)(a1 + 8) + 56LL))(
            *(_QWORD *)(a1 + 8),
            a1 + 88,
            v8,
            a4,
...
LABEL_29:
    ...
    while ( v8 != a4 )
    {
      std::string::append((size_t *)Src, 1uLL, *v8);
      v8 = v13 + 2;
      v13 += 2;
    }
LABEL_18:
  ...
  {
    std::string::append(Src, v9, v14 - (_QWORD)v9);
LABEL_17:
    v8 = v13;
    goto LABEL_18;
  }
