/*
 * XREFs of ?ResultFromCaughtExceptionInternal@details@wil@@YAJPEAG_KPEA_N@Z @ 0x1800027E0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  exception *v40; // [rsp+60h] [rbp-18h] BYREF
  ...
  if ( !g_pfnResultFromCaughtException_WinRt )
  {
    if ( !wil::g_pfnResultFromCaughtException )
    {
      ...
      catch ( const std::bad_alloc *v39 )
      {
        ...
        if ( v21 )
        {
          v22 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)v20 + 11) + 8LL))(*((_QWORD *)v20 + 11));
    ...
    catch ( const std::bad_alloc *v38 )
    {
      ...
      if ( v11 )
      {
        v12 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)v10 + 10) + 8LL))(*((_QWORD *)v10 + 10));
