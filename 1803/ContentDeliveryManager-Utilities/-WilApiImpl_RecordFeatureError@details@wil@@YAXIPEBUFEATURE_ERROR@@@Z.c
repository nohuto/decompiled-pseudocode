/*
 * XREFs of ?WilApiImpl_RecordFeatureError@details@wil@@YAXIPEBUFEATURE_ERROR@@@Z @ 0x18000B5E0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct FEATURE_ERROR *a3)
{
  ...
  if ( wil::details::g_featureStateManager )
  {
    ...
    if ( wil::details::FeatureStateManager::EnsureStateData((RTL_SRWLOCK *)&wil::details::g_featureStateManager)
      && wil::details_abi::FeatureStateData::RecordFeatureError(qword_18017A178, v4, a2)
