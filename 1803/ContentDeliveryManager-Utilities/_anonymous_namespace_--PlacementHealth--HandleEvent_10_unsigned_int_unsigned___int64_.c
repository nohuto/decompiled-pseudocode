/*
 * XREFs of _anonymous_namespace_::PlacementHealth::HandleEvent_10_unsigned_int_unsigned___int64_ @ 0x18003A46C
 * Callers:
 ...
 *     _anonymous_namespace_::StartsWith @ 0x18002E018 (_anonymous_namespace_--StartsWith.c)
