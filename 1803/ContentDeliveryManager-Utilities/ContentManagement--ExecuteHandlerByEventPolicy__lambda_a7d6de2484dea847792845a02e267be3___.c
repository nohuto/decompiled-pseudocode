/*
 * XREFs of ContentManagement::ExecuteHandlerByEventPolicy__lambda_a7d6de2484dea847792845a02e267be3___ @ 0x18003AC20
 * Callers:
...
__int64 __fastcall ContentManagement::ExecuteHandlerByEventPolicy__lambda_a7d6de2484dea847792845a02e267be3___(
        void *Src,
        __int64 a2,
        HSTRING a3,
        unsigned int a4,
...
LABEL_19:
  v19 = lambda_a7d6de2484dea847792845a02e267be3_::operator()(a6, a4);
  v20 = v19;
  if ( v19 < 0 )
  {
  ...
  if ( (_BYTE)v30 )
  {
    v22 = lambda_a7d6de2484dea847792845a02e267be3_::operator()(a6, 0xCu);
    if ( v22 < 0 )
    {
      v23 = 308LL;
LABEL_28:
