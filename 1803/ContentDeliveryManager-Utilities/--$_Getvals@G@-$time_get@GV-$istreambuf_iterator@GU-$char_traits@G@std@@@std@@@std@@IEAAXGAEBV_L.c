/*
 * XREFs of ??$_Getvals@G@?$time_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@IEAAXGAEBV_Locinfo@1@@Z @ 0x1800AE5E8
 * Callers:
 ...
 *     ??4?$_Yarn@D@std@@QEAAAEAV01@PEBD@Z @ 0x18004E15C (--4-$_Yarn@D@std@@QEAAAEAV01@PEBD@Z.c)
