/*
 * XREFs of ?GenerateStoreId@StoreHelpers@CreativeFramework@@YAJPEAUHSTRING__@@0PEAPEAU3@@Z @ 0x18000CF80
 * Callers:
  ...
  *newString = 0LL;
  if ( !WindowsIsStringEmpty(string2) )
  {
    ...
    v10 = WindowsCreateStringReference(
            &CreativeFramework::StoreHelpers::c_storeIdSeparator,
            1u,
            &hstringHeader,
            &string);
    if ( v10 < 0 )
