/*
 * XREFs of ??$use_facet@V?$collate@D@std@@@std@@YAAEBV?$collate@D@0@AEBVlocale@0@@Z @ 0x1800BA5B0
 * Callers:
...
struct std::_Facet_base *__fastcall std::use_facet<std::collate<char>>(__int64 *a1)
{
  __int64 v2; // rsi
  ...
  v2 = std::_Facetptr<std::collate<char>>::_Psave;
  v11 = (struct std::_Facet_base *)std::_Facetptr<std::collate<char>>::_Psave;
  v3 = std::collate<char>::id;
  ...
  if ( !v5 )
  {
    ...
    if ( !v5 )
    {
      ...
      {
        if ( std::collate<char>::_Getcat(&v11, a1) == -1 )
        {
          bad_cast::bad_cast((bad_cast *)pExceptionObject, "bad cast");
          throw (bad_cast *)pExceptionObject;
        }
        v5 = v11;
        std::_Facetptr<std::collate<char>>::_Psave = (__int64)v11;
