    ...
    do
    {
      ...
      else
      {
        if ( *(_QWORD *)(v10 + 24) >= 8uLL )
          v10 = *(_QWORD *)v10;
        v22 = (const WCHAR *)v10;
        v14 = Microsoft::WRL::Wrappers::HStringReference::HStringReference((__int64)v25, &v22);
        v15 = (*(__int64 (__fastcall **)(__int64, _QWORD, _QWORD, _QWORD))(*(_QWORD *)v23 + 48LL))(
                v23,
                *(_QWORD *)(v14 + 24),
                *(_QWORD *)v11,
                *(_QWORD *)(v11 + 8));
