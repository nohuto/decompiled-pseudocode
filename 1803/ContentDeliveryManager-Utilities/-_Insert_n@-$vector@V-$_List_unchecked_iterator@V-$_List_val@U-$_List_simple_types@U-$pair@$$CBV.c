  ...
  if ( a4 )
  {
    ...
    if ( (a1[2] - v10) >> 3 >= a4 )
    {
      ...
      if ( (v10 - (__int64)a3) >> 3 >= a4 )
      {
        ...
        for ( a1[1] = std::_Uninit_move<std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0> *,std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0> *,std::_Wrap_alloc<std::allocator<std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0>>>,std::_List_unchecked_const_iterator<std::_List_val<std::_List_simple_types<std::wstring>>,std::_Iterator_base0>>(
                        v10 - v21 * 8,
                        v10,
                        a1[1]); v24 != v6; v24[v21] = *v24 )
          --v24;
        v25 = &v6[v21];
        while ( v6 != v25 )
          *v6++ = v20;
      ...
      else
      {
        ...
        v22 = a1[1];
        a1[1] = v21 * 8 + v22;
        v23 = (v22 - (unsigned __int64)v6 + 7) >> 3;
        if ( (unsigned __int64)v6 > v22 )
          v23 = 0LL;
        if ( v23 )
          memset64(v6, (unsigned __int64)v20, v23);
      }
    }
    else
    {
      ...
      v14 = 0x1FFFFFFFFFFFFFFFLL - (v13 >> 1);
      v15 = 0LL;
      if ( v14 >= v13 )
        v15 = v13 + (v13 >> 1);
      if ( v15 >= v12 )
      ...
      if ( v12 )
      {
        if ( v12 > 0x1FFFFFFFFFFFFFFFLL || (v16 = (char *)operator new(8 * v12), (v27 = v16) == 0LL) )
          std::_Xbad_alloc();
      }
      v17 = ((__int64)v6 - *a1) >> 3;
      try
