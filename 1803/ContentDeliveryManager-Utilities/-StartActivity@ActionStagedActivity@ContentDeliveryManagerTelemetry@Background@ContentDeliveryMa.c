/*
 * XREFs of ?StartActivity@ActionStagedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBG00@Z @ 0x1800516E0
 * Callers:
        ...
        const unsigned __int16 *a4)
{
  ...
  if ( *(_DWORD *)v9 > 5u && (*((_QWORD *)v9 + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v8 == *((_QWORD *)v9 + 3) )
    {
      ...
      TlgWrite(v9, &unk_180156A4F, (LPCGUID)(v16 + 8), v17, 6u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
