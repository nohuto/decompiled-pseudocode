/*
 * XREFs of ?do_put@?$money_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@_NAEAVios_base@2@DAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@@Z @ 0x1800BF320
 * Callers:
 *     <none>
 * Callees:
        ...
        char *a7)
{
  ...
  *(_QWORD *)&v25 = v11;
  ...
  if ( !v28 )
    std::string::append((size_t *)v27, 1uLL, v30[0]);
  v26[3] = (void *)15;
  v26[2] = 0LL;
  LOBYTE(v26[0]) = 0;
  std::string::assign(v26, v27, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
  v25 = *a3;
  std::money_put<char,std::ostreambuf_iterator<char>>::_Putmfld(a1, a2, &v25, a4, a5, a6, v14, (size_t *)v26, v30[0]);
  if ( v29 >= 0x10 )
