/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$0A@$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180075A20
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u )
  {
    ...
    v77 = v8 + 1;
    v78 = 0;
    TlgWrite(v4, &unk_180157FE7, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 0x13u, &pData);
  }
