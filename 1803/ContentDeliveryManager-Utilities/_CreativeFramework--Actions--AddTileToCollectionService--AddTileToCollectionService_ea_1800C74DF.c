/*
 * XREFs of _CreativeFramework::Actions::AddTileToCollectionService::AddTileToCollectionService_::_1_::dtor$12 @ 0x1800C74DF
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CreativeFramework::Actions::AddTileToCollectionService::AddTileToCollectionService_::_1_::dtor_12(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
