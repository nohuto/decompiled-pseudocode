/*
 * XREFs of ??$GetActivationFactory@UILauncherStatics@System@Windows@@@wil@@YA?AV?$com_ptr_t@UILauncherStatics@System@Windows@@Uerr_exception_policy@wil@@@0@PEBG@Z @ 0x18004F18C
 * Callers:
...
const WCHAR *__fastcall wil::GetActivationFactory<Windows::System::ILauncherStatics>(const WCHAR *a1)
{
  ...
  v6[2] = a1;
  v6[0] = L"Windows.System.Launcher";
  *(_QWORD *)a1 = 0LL;
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  ActivationFactory = RoGetActivationFactory(*(_QWORD *)(v2 + 24), &GUID_277151c3_9e3e_42f6_91a4_5dfdeb232451, a1);
