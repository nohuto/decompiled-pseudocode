/*
 * XREFs of ?_Getmfld@?$money_get@_WV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@AEAV?$istreambuf_iterator@_WU?$char_traits@_W@std@@@2@0_NAEAVios_base@2@PEA_W@Z @ 0x1800B29AC
 * Callers:
...
size_t *__fastcall std::money_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getmfld(
        __int64 a1,
        size_t *a2,
        __int64 *a3,
        __int64 *a4,
        ...
        __int16 *a7)
{
  ...
  *(_BYTE *)v8 = 0;
  ...
  v17 = v14 | 0x81;
  v18 = std::use_facet<std::ctype<wchar_t>>((__int64 *)&v95);
  v95 = v18;
  if ( v16 )
  {
        ...
        if ( !std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
        {
          ...
          do
          {
            ...
            std::string::append(
              v8,
              1uLL,
              `std::money_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getmfld'::`2'::_Src[v58]);
            std::istreambuf_iterator<unsigned short>::_Inc(a3);
          }
          while ( !std::istreambuf_iterator<wchar_t>::equal(a3, a4) );
          v17 = v98;
          ...
          && *(_WORD *)std::istreambuf_iterator<unsigned short>::operator*(a3) == v50 )
        {
          ...
          while ( !std::istreambuf_iterator<wchar_t>::equal(a3, a4) )
          {
            ...
            std::string::append(
              v8,
              1uLL,
              `std::money_get<wchar_t,std::istreambuf_iterator<wchar_t>>::_Getmfld'::`2'::_Src[v62]);
            ++v26;
            std::istreambuf_iterator<unsigned short>::_Inc(a3);
          }
          v63 = v91;
