/*
 * XREFs of ?Stop@TriggerManagerRegisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAX_NPEBD@Z @ 0x18005D63C
 * Callers:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v8 )
  {
    ...
    if ( *(_DWORD *)v10 > 5u )
    {
      ...
      v91 = a3;
      v92 = v13 + 1;
      TlgWrite(v10, &unk_180157A51, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x15u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v31 > 5u )
    {
      ...
      if ( !a3 )
        a3 = (const char *)&word_1800F144C;
      v101 = a3;
      TlgWrite(v31, &unk_1801578AA, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 6u, &v94);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
