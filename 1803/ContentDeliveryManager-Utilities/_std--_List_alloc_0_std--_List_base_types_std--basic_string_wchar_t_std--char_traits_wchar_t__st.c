/*
 * XREFs of _std::_List_alloc_0_std::_List_base_types_std::basic_string_wchar_t_std::char_traits_wchar_t__std::allocator_wchar_t____std::allocator_std::basic_string_wchar_t_std::char_traits_wchar_t__std::allocator_wchar_t_________::_Buynode0_::_1_::catch$0 @ 0x1800C7A01
 * Callers:
 *     <none>
 * Callees:
