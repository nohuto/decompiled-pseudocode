/*
 * XREFs of ?Invoke@AppUninstallService@Actions@CreativeFramework@@UEAAXXZ @ 0x18007DA30
 * Callers:
 *     <none>
 * Callees:
        ...
        CreativeFramework::Actions::AppUninstallService *this)
{
  ...
  v6 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v4 + 104LL))(v4, *(_QWORD *)(v5 + 24));
  v7 = retaddr;
  if ( v6 < 0 )
  {
LABEL_11:
