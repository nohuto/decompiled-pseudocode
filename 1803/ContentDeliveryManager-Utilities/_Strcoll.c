/*
 * XREFs of _Strcoll @ 0x1800C0078
 * Callers:
 *     ?do_compare@?$collate@D@std@@MEBAHPEBD000@Z @ 0x1800BDE20 (-do_compare@-$collate@D@std@@MEBAHPEBD000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800AD6F8 (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800AD6FC (_GetLocaleHandleById.c)
 *     __crtCompareStringA_Stub @ 0x1800AD770 (__crtCompareStringA_Stub.c)
