/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180054830
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<ContentDeliveryManager::Background::ContentDeliveryManagerLogging,1,70368744177664,5,_TlgReflectorTag_Param0IsProviderType>::NotifyFailure(
        _QWORD *a1,
        int *a2)
{
  BOOL v4; // ebx
  ...
  if ( v4 )
  {
      ...
      && (*((_QWORD *)v5 + 3) & 0x600000000000LL) == *((_QWORD *)v5 + 3) )
    {
      ...
      v88 = 2 * v9 + 2;
      v89 = 0;
      TlgWrite(v6, &unk_180156DC3, (LPCGUID)(a1[6] + 8LL), 0LL, 0x10u, &pData);
    }
  }
         ...
         && (*((_QWORD *)v5 + 3) & 0x400000000000LL) == *((_QWORD *)v5 + 3) )
  {
    ...
    v95 = v26 + 1;
    v96 = 0;
    TlgWrite(v6, &unk_180158C3B, (LPCGUID)(a1[6] + 8LL), 0LL, 0x13u, &pData);
  }
