/*
 * XREFs of ?PinPackagedAppToTaskbar@Actions@CreativeFramework@@YAXPEB_W0_N@Z @ 0x180089A04
 * Callers:
 ...
 *     ?PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z @ 0x18008987C (-PinApp@Actions@CreativeFramework@@YAXPEB_W_N01@Z.c)
