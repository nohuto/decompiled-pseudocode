/*
 * XREFs of ?CreateTriggerRegistrationFromSetting@Internal@TargetedContent@Services@Windows@@YAJAEAVPropertySetHelper@Triggers@CreativeFramework@@PEAPEAUITargetedContentTriggerInternal@1234@@Z @ 0x18006E108
 * Callers:
 *     _lambda_4d8c3aefd165ae46a39c8fe585e6dd35_::operator() @ 0x18006FF10 (_lambda_4d8c3aefd165ae46a39c8fe585e6dd35_--operator().c)
 *     std::_Func_impl_std::_Callable_obj__lambda_79bb12814c008e0bafb08f37b083ea74__0__std::allocator_std::_Func_class_bool_CreativeFramework::Triggers::PropertySetHelper_&___ptr64_std::_Nil_std::_Nil_std::_Nil_std::_Nil_std::_Nil_std::_Nil____bool_CreativeFramework::Triggers::PropertySetHelper_&___ptr64_std::_Nil_std::_Nil_std::_Nil_std::_Nil_std::_Nil_std::_Nil_::_Do_call @ 0x180072D90 (std--_Func_impl_std--_Callable_obj__lambda_79bb12814c008e0bafb08f37b083ea74__0__std_ea_180072D90.c)
 * Callees:
 ...
 *     ?ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA?AW4TargetedContentKnownTrigger@1234@PEB_W@Z @ 0x180069158 (-ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA-AW4TargetedContentKnownTri.c)
 ...
 *     ?Lookup@?$PropertySetHelperBase@$1?RuntimeClass_Windows_Foundation_Collections_PropertySet@@3QB_WB@Triggers@CreativeFramework@@QEBAJPEB_WPEAPEAUIPropertyValue@Foundation@Windows@@@Z @ 0x18007190C (-Lookup@-$PropertySetHelperBase@$1-RuntimeClass_Windows_Foundation_Collections_PropertySet@@3QB_.c)
        ...
        struct Windows::Services::TargetedContent::Internal::ITargetedContentTriggerInternal **a3)
{
  ...
  const char *v77; // r9
  __int64 result; // rax
  HSTRING v79; // [rsp+40h] [rbp-88h] BYREF
  HSTRING string; // [rsp+48h] [rbp-80h] BYREF
  HSTRING v81; // [rsp+50h] [rbp-78h] BYREF
  HSTRING v82; // [rsp+58h] [rbp-70h] BYREF
  HSTRING v83; // [rsp+60h] [rbp-68h] BYREF
  HSTRING v84; // [rsp+68h] [rbp-60h] BYREF
  HSTRING v85; // [rsp+70h] [rbp-58h] BYREF
  struct CreativeFramework::Triggers::PropertySetHelper *v86; // [rsp+78h] [rbp-50h] BYREF
  __int64 v87; // [rsp+80h] [rbp-48h] BYREF
  _QWORD v88[8]; // [rsp+88h] [rbp-40h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+C8h] [rbp+0h]
  __int64 v90; // [rsp+D8h] [rbp+10h] BYREF
  unsigned int v91; // [rsp+E0h] [rbp+18h] BYREF
  unsigned int v92; // [rsp+E8h] [rbp+20h] BYREF
        ...
        if ( v11 )
        {
          ...
          if ( v16 )
          {
            ...
            if ( v20 >= 0 )
            {
              ...
              v24 = v86;
              if ( !v23
                || (v25 = (*(__int64 (__fastcall **)(struct CreativeFramework::Triggers::PropertySetHelper *, HSTRING))(*(_QWORD *)v86 + 72LL))(
                            v86,
                            v79),
                    v26 = retaddr,
                    v25 >= 0) )
                          ...
                          v34 >= 0) )
                    {
                            ...
                            v37 >= 0) )
                      {
                        ...
                        if ( !Windows::Services::TargetedContent::Internal::GetStringValue(
                                ...
                                (const wchar_t *)&v79,
                                v39)
                          || (v40 = (*(__int64 (__fastcall **)(struct CreativeFramework::Triggers::PropertySetHelper *, HSTRING))(*(_QWORD *)v24 + 280LL))(
                                      v24,
                                      v79),
                              v41 = retaddr,
                              v40 >= 0) )
...
LABEL_21:
                          ...
                          if ( (_BYTE)v90 )
                          {
                            ...
                            v49 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v90 + 104LL))(v90, &v87);
                            v3 = v49;
                            if ( v49 < 0 )
                            {
                              wil::details::in1diag3::Return_Hr(
...
LABEL_43:
                                          ...
                                          if ( (_BYTE)v90 )
                                          {
                                            ...
                                            v69 = (*(__int64 (__fastcall **)(__int64, _QWORD *))(*(_QWORD *)v90 + 128LL))(
                                                    v90,
                                                    v88);
                                            v3 = v69;
                                            if ( v69 < 0 )
...
LABEL_57:
                                              ...
                                              if ( v3 >= 0 )
                                              {
                                                v72 = (*(__int64 (__fastcall **)(struct CreativeFramework::Triggers::PropertySetHelper *))(*(_QWORD *)v24 + 296LL))(v24);
                                                v74 = retaddr;
                                                if ( v72 >= 0 )
                                                {
