/*
 * XREFs of ??0?$_Tree@V?$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@$0A@@std@@@std@@QEAA@AEBV01@AEBV?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@1@@Z @ 0x180076B2C
 * Callers:
        ...
        __int64 *a1)
{
  ...
  *a1 = v2;
  ...
  {
    LOBYTE(v3) = (_BYTE)a1;
    *(_QWORD *)(v2 + 8) = std::_Tree<std::_Tmap_traits<unsigned short const *,_WNF_STATE_NAME const *,CreativeFramework::Triggers::less,std::allocator<std::pair<unsigned short const * const,_WNF_STATE_NAME const *>>,0>>::_Copy_nodes<std::integral_constant<bool,0>>(
                            a1,
                            *(_QWORD *)(qword_18017C110 + 8),
                            v2,
                            v3,
                            -2LL);
    a1[1] = qword_18017C118;
    v4 = (_QWORD *)*a1;
    v5 = *(__int64 ***)(*a1 + 8);
    if ( *((_BYTE *)v5 + 25) )
    {
    ...
    else
    {
      ...
      *v4 = v5;
      v7 = *(_QWORD *)(*a1 + 8);
      for ( j = *(_QWORD *)(v7 + 16); !*(_BYTE *)(j + 25); j = *(_QWORD *)(j + 16) )
        v7 = j;
      *(_QWORD *)(*a1 + 16) = v7;
    }
  }
