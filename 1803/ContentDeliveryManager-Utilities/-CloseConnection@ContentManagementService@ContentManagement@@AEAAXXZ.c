/*
 * XREFs of ?CloseConnection@ContentManagementService@ContentManagement@@AEAAXXZ @ 0x180030C58
 * Callers:
 *     ??_GContentManagementService@ContentManagement@@UEAAPEAXI@Z @ 0x180025530 (--_GContentManagementService@ContentManagement@@UEAAPEAXI@Z.c)
