 ...
 *     ?MakePublishSystemStateService@Actions@CreativeFramework@@YA?AV?$shared_ptr@VIActionService@Actions@CreativeFramework@@@std@@AEBUActionContext@12@AEBV?$map@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@U?$less@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@2@V?$allocator@U?$pair@$$CBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@V12@@std@@@2@@4@@Z @ 0x18008EAC0 (-MakePublishSystemStateService@Actions@CreativeFramework@@YA-AV-$shared_ptr@VIActionService@Acti.c)
...
_QWORD *__fastcall CreativeFramework::Actions::GetOptionalParameter<std::wstring>(_QWORD *a1, _QWORD *a2, char *a3)
{
  unsigned __int64 v6; // r8
  void **v7; // rdx
  char v8; // di
  __int64 v10; // [rsp+20h] [rbp-50h] BYREF
  void *v11[2]; // [rsp+28h] [rbp-48h] BYREF
  __int64 v12; // [rsp+38h] [rbp-38h]
  unsigned __int64 v13; // [rsp+40h] [rbp-30h]
  void *v14[3]; // [rsp+48h] [rbp-28h] BYREF
  ...
  else
  {
    ...
    v14[2] = 0LL;
    LOWORD(v14[0]) = 0;
    std::wstring::assign(v14, (void **)(v10 + 64), 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    v7 = v14;
    v8 = 5;
  }
  a1[3] = 7LL;
