/*
 * XREFs of _lambda_31043bab68d029d4b2dc53516d0f9a2d_::operator() @ 0x1800108B0
 * Callers:
...
__int64 __fastcall lambda_31043bab68d029d4b2dc53516d0f9a2d_::operator()(__int64 a1)
{
  int v2; // ebx
  int v3; // eax
  PCWSTR v4; // rcx
