/*
 * XREFs of _LXp_addh @ 0x1800AD810
 * Callers:
 *     _LXp_addx @ 0x1800ADB60 (_LXp_addx.c)
 *     _LXp_mulh @ 0x1800ADBF4 (_LXp_mulh.c)
 * Callees:
 *     _LDscale @ 0x1800AD808 (_LDscale.c)
 *     _Feraise @ 0x1800BFA9C (_Feraise.c)
 *     _LDtest @ 0x1800C002C (_LDtest.c)
 *     _LDint @ 0x1800C0034 (_LDint.c)
 *     _LDunscale @ 0x1800C003C (_LDunscale.c)
 */
...
long double *__fastcall LXp_addh(long double *a1, int a2, double a3)
{
  ...
  __int64 v30; // rax
  int v31; // ebx
  long double v33[2]; // [rsp+20h] [rbp-28h] BYREF
      ...
      if ( v14 > -26 || v36 == 0.0 )
      {
        if ( v14 < 26 || v36 == 0.0 )
        {
          ...
          if ( v8 - 26 < (int)v22 )
          {
            ...
            LDint(&v36, v22);
            LDscale((unsigned __int16 *)&v36, v34);
            v23 = a1[v3] - v36;
            a1[v3] = v23;
            if ( v23 == 0.0 )
            {
