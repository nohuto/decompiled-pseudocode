...
_QWORD *__fastcall Windows::Services::TargetedContent::Internal::ResolvePredicateHandler(_QWORD *a1, __int64 a2)
{
  ...
  int v20[4]; // [rsp+28h] [rbp-48h] BYREF
  __int64 v21; // [rsp+38h] [rbp-38h]
  _QWORD *v22; // [rsp+40h] [rbp-30h]
  _QWORD v23[3]; // [rsp+48h] [rbp-28h] BYREF
...
LABEL_12:
  ...
  if ( !a1[3] )
  {
    ...
    if ( v9 < 0 )
    {
      ...
      JUMPOUT(0x18006A221LL);
    }
    v10 = &unk_18017A440;
    while ( *(_DWORD *)v10 != v20[0] )
    {
      v10 += 5;
      v11 = &unk_18017A4E0;
      if ( v10 == (_QWORD *)&unk_18017A4E0 )
      {
