/*
 * XREFs of ??$use_facet@V?$messages@D@std@@@std@@YAAEBV?$messages@D@0@AEBVlocale@0@@Z @ 0x1800BA6E8
 * Callers:
 ...
 *     ?_Getcat@?$messages@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800BB21C (-_Getcat@-$messages@D@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
