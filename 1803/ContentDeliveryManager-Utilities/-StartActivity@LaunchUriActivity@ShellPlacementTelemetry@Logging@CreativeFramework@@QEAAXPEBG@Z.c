/*
 * XREFs of ?StartActivity@LaunchUriActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEBG@Z @ 0x18002B2A4
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  const unsigned __int16 *v19; // [rsp+70h] [rbp-38h]
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)v7 > 5u && (*((_QWORD *)v7 + 2) & 0x200000000000LL) != 0 )
  {
    ...
    if ( v8 == *((_QWORD *)v7 + 3) )
    {
      ...
      TlgWrite(v9, &unk_180155C00, (LPCGUID)(v11 + 8), v12, 4u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
