/*
 * XREFs of ??4?$_Yarn@D@std@@QEAAAEAV01@PEBD@Z @ 0x18004E15C
 * Callers:
 ...
 *     ??0_Locimp@locale@std@@AEAA@AEBV012@@Z @ 0x1800A4FA8 (--0_Locimp@locale@std@@AEAA@AEBV012@@Z.c)
 *     ?_Init@locale@std@@CAPEAV_Locimp@12@_N@Z @ 0x1800A50C8 (-_Init@locale@std@@CAPEAV_Locimp@12@_N@Z.c)
 *     ?_Locinfo_ctor@_Locinfo@std@@SAXPEAV12@PEBD@Z @ 0x1800A51FC (-_Locinfo_ctor@_Locinfo@std@@SAXPEAV12@PEBD@Z.c)
