/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x1800171D4
 * Callers:
...
LABEL_21:
  ...
  {
    wil::details::in1diag3::_FailFast_GetLastError(retaddr, (void *)0x879, v30, v31);
    JUMPOUT(0x180017545LL);
  }
