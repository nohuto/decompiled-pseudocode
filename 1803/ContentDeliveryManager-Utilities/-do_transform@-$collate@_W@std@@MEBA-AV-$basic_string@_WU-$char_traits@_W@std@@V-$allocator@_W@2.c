/*
 * XREFs of ?do_transform@?$collate@_W@std@@MEBA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@2@PEB_W0@Z @ 0x1800B9E60
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_WORD *)a2 = 0;
  ...
  if ( v8 )
  {
    ...
    do
    {
      if ( v8 > v9 )
      {
        std::wstring::append((_WORD **)a2, v8 - v9, 0);
      }
      else
      {
        *(_QWORD *)(a2 + 16) = v8;
  ...
  if ( v8 > *(_QWORD *)(a2 + 16) )
  {
    std::wstring::append((_WORD **)a2, v8 - *(_QWORD *)(a2 + 16), 0);
  }
  else
  {
    *(_QWORD *)(a2 + 16) = v8;
