/*
 * XREFs of ?ShouldUseInternal@Policy@CreativeFramework@@YA_NXZ @ 0x18009801C
 * Callers:
 *     ?SetLayoutType@Settings@TargetedContentLayoutHelpers@CreativeFramework@@YAXPEAUHSTRING__@@PEB_W0@Z @ 0x180098150 (-SetLayoutType@Settings@TargetedContentLayoutHelpers@CreativeFramework@@YAXPEAUHSTRING__@@PEB_W0.c)
...
char __fastcall CreativeFramework::Policy::ShouldUseInternal(CreativeFramework::Policy *this)
{
  ...
  AcquireSRWLockShared(&stru_18017C148);
  v1 = 0;
  if ( !byte_18017C0B4 )
  {
    ReleaseSRWLockShared(&stru_18017C148);
    AcquireSRWLockExclusive(&stru_18017C148);
    if ( byte_18017C0B4 )
    {
      v1 = byte_18017C0B5;
LABEL_10:
      ReleaseSRWLockExclusive(&stru_18017C148);
      return v1;
    }
