/*
 * XREFs of ??$GetActivationFactory@UIPackagedUnifiedTileIdentifierFactory@UnifiedTile@Shell@WindowsInternal@@@wil@@YA?AV?$com_ptr_t@UIPackagedUnifiedTileIdentifierFactory@UnifiedTile@Shell@WindowsInternal@@Uerr_exception_policy@wil@@@0@PEB_W@Z @ 0x180082B38
 * Callers:
        ...
        const WCHAR *a1)
{
  ...
  v6[3] = a1;
  v6[0] = L"WindowsInternal.Shell.UnifiedTile.PackagedUnifiedTileIdentifier";
  *(_QWORD *)a1 = 0LL;
  ...
  *(_QWORD *)a1 = 0LL;
  ...
  ActivationFactory = RoGetActivationFactory(*(_QWORD *)(v2 + 24), &GUID_ec3e7864_aaab_4367_9c63_94d289545500, a1);
