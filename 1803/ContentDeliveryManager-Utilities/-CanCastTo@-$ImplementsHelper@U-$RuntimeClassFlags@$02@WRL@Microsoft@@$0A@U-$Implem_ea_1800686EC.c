...
LABEL_17:
  if ( (_DWORD)result == -2147467262 )
  {
    ...
    if ( *a2 == 56
      ...
      || (v6 = a1 + 168, *a2 == -1413416441)
      && a2[1] == *(_DWORD *)&GUID_abc0fa07_4be9_5015_9c6f_b095fd555828.Data2
      && a2[2] == *(_DWORD *)GUID_abc0fa07_4be9_5015_9c6f_b095fd555828.Data4
      && a2[3] == *(_DWORD *)&GUID_abc0fa07_4be9_5015_9c6f_b095fd555828.Data4[4] )
    {
      *a3 = v6;
      return 0LL;
    }
