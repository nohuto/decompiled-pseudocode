/*
 * XREFs of ?do_put@?$time_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AEAVios_base@2@DPEBUtm@@DD@Z @ 0x1800BF770
 * Callers:
 *     <none>
 * Callees:
        ...
        char a8)
{
  ...
  for ( i = 16LL; ; i *= 2LL )
  {
    std::string::append((size_t *)Buffer, i, 0);
    v12 = (char *)Buffer;
    if ( v21 >= 0x10 )
      v12 = Buffer[0];
