/*
 * XREFs of ?StartActivity@ActionInvokedActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBG00@Z @ 0x180050B80
 * Callers:
 ...
 *     ?zInternalStart@?$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDeliveryManager@@$00$0EAAAAAAAAAAA@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXXZ @ 0x1800547B8 (-zInternalStart@-$ActivityBase@VContentDeliveryManagerLogging@Background@ContentDel_ea_1800547B8.c)
        ...
        const unsigned __int16 *a4)
{
  ...
  if ( *(_DWORD *)v9 > 5u && (*((_QWORD *)v9 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( v8 == *((_QWORD *)v9 + 3) )
    {
      ...
      TlgWrite(v9, &unk_180156BBF, (LPCGUID)(v16 + 8), v17, 6u, &pData);
    }
  }
  if ( !*((_DWORD *)this + 8) )
  {
