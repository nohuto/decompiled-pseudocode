        ...
        __int64 a1)
{
  ...
  if ( *(_QWORD *)(a1 + 24) && _InterlockedIncrement((volatile signed __int32 *)(a1 + 16)) == 1 )
  {
    ...
    if ( (**(int (__fastcall ***)(__int64, GUID *, __int64 *))a1)(a1, &GUID_abc0fa07_4be9_5015_9c6f_b095fd555828, &v13) >= 0 )
    {
      v12 = -2;
