        ...
        void **a2)
{
  ...
  if ( v7 )
  {
    ...
    (*(void (__fastcall **)(PVOID, GUID *, PVOID *))(*(_QWORD *)v7 + 24LL))(
      v7,
      &GUID_29e58130_84a5_5b2a_9d6f_ce027279f40c,
      &v12);
    ...
    {
      v13 = 0LL;
      if ( (int)RoGetAgileReference(0LL, &GUID_29e58130_84a5_5b2a_9d6f_ce027279f40c, v12, &v13) < 0 )
      {
        v9 = v13;
      }
      else
  ...
  *a2 = 0LL;
  ...
  {
    v10 = CMarshaledInterface::_Unmarshal((CMarshaledInterface *)&v14, &GUID_29e58130_84a5_5b2a_9d6f_ce027279f40c, a2);
    Ptr = v14;
  }
  else
  {
