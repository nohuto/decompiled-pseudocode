        ...
        __int64 a5)
{
  ...
  if ( (unsigned __int8)std::less<std::wstring>::operator()((__int64)a1, a4, (_QWORD *)(a3 + 32)) )
  {
    ...
    if ( (unsigned __int8)std::less<std::wstring>::operator()(v14, *v13 + 4, a4) )
    {
      if ( *(_BYTE *)(v21[2] + 25) )
        std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_at<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
          a1,
  ...
  if ( !(unsigned __int8)std::less<std::wstring>::operator()(v12, (_QWORD *)(a3 + 32), a4) )
    goto LABEL_33;
  v16 = (__int64 *)a3;
  v21 = (__int64 *)a3;
  v17 = (__int64 *)a3;
  if ( !*(_BYTE *)(a3 + 25) )
  {
    ...
    {
      for ( i = *v16; !*(_BYTE *)(i + 25); i = *(_QWORD *)i )
        v16 = (__int64 *)i;
    }
    v17 = v16;
    v21 = v16;
  ...
  if ( v17 == *a1 )
    goto LABEL_29;
  if ( !(unsigned __int8)std::less<std::wstring>::operator()(i, a4, v17 + 4) )
  {
LABEL_33:
