/*
 * XREFs of ??$WaitForCompletion@UIAsyncActionCompletedHandler@Foundation@Windows@@UIAsyncAction@23@@@YAJPEAUIAsyncAction@Foundation@Windows@@W4tagCOWAIT_FLAGS@@PEAX@Z @ 0x180018EEC
 * Callers:
 *     ?EnableContextualSuggestions@ContentManagement@@YAJE@Z @ 0x18000D170 (-EnableContextualSuggestions@ContentManagement@@YAJE@Z.c)
 * Callees:
 *     ??0FtmBase@WRL@Microsoft@@QEAA@XZ @ 0x180004064 (--0FtmBase@WRL@Microsoft@@QEAA@XZ.c)
 *     ?SHProcessMessagesUntilEventsEx@@YAKPEAUHWND__@@PEAPEAXKKKK@Z @ 0x180006D18 (-SHProcessMessagesUntilEventsEx@@YAKPEAUHWND__@@PEAPEAXKKKK@Z.c)
        ...
        char *a3)
{
  ...
  DWORD v11; // r9d
  int v12; // eax
  int (__fastcall **v13)(__int64, GUID *, __int64); // rbx
  __int64 v14; // rax
  __int64 v15; // rcx
  char *v16; // rcx
  ...
  int (__fastcall ***v24)(__int64, GUID *, __int64); // [rsp+98h] [rbp+40h]
  ...
  if ( v4 )
  {
    ...
    *((_QWORD *)v5 + 7) = Event;
    ...
    if ( v6 >= 0 )
    {
      v6 = ((__int64 (__fastcall *)(int (__fastcall ***)(__int64, GUID *, __int64), char *))(*a1)[6])(a1, v23);
      v22 = v6;
      if ( v6 >= 0 )
      {
        v20[0] = *((void **)v23 + 7);
        ...
        if ( v6 >= 0 && *((_DWORD *)v23 + 12) != 1 )
        {
          ...
          if ( (*v13)((__int64)a1, &GUID_00000036_0000_0000_c000_000000000046, v14) >= 0 )
