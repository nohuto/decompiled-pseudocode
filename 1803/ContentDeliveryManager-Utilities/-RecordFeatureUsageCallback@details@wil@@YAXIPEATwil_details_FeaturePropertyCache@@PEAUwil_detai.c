/*
 * XREFs of ?RecordFeatureUsageCallback@details@wil@@YAXIPEATwil_details_FeaturePropertyCache@@PEAUwil_details_RecordUsageResult@@@Z @ 0x18000C250
 * Callers:
 *     <none>
 * Callees:
        ...
        struct wil_details_RecordUsageResult *a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( !*((_DWORD *)a3 + 4) && wil::details::g_enabledStateManager )
    {
      ...
      if ( !*((_QWORD *)&xmmword_18017C210 + 1) )
      {
        *((_QWORD *)&xmmword_18017C210 + 1) = 0LL;
