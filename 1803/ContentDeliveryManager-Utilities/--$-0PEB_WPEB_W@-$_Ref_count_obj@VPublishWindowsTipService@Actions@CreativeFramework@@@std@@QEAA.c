/*
 * XREFs of ??$?0PEB_WPEB_W@?$_Ref_count_obj@VPublishWindowsTipService@Actions@CreativeFramework@@@std@@QEAA@$$QEAPEB_W0@Z @ 0x18008E854
 * Callers:
        ...
        char **a3)
{
  ...
  *(_WORD *)(v5 + 40) = 0;
  ...
  std::wstring::assign((_QWORD *)(v5 + 40), v6, v9);
  v11 = *(_QWORD *)(v5 + 24);
  if ( v11 - 1 > 0xFF )
  {
