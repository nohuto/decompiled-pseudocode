/*
 * XREFs of ?GetLocalTilePropertiesForApp@ContentManagementService@ContentManagement@@AEAAJPEAUHSTRING__@@PEAPEAUICDSLocalTileProperties@CDSProperties@WindowsInternal@@@Z @ 0x180031A18
 * Callers:
 *     ?SetWasAppUnpinnedFromTaskBar@ContentManagementService@ContentManagement@@UEAAJPEAUHSTRING__@@E@Z @ 0x180031EE0 (-SetWasAppUnpinnedFromTaskBar@ContentManagementService@ContentManagement@@UEAAJPEAUHSTRING__@@E@.c)
 *     ?GetWasAppUnpinnedFromTaskBar@ContentManagementService@ContentManagement@@UEAAJPEAUHSTRING__@@PEAE@Z @ 0x180031F80 (-GetWasAppUnpinnedFromTaskBar@ContentManagementService@ContentManagement@@UEAAJPEAUHSTRING__@@PE.c)
 * Callees:
        ...
        struct WindowsInternal::CDSProperties::ICDSLocalTileProperties **a3)
{
  ...
  int v27; // eax
  __int64 v28; // rdx
  __int64 (__fastcall ***v29)(_QWORD, GUID *, struct WindowsInternal::CDSProperties::ICDSLocalTileProperties **); // rcx
  _QWORD *v30; // rcx
  __int64 v31; // rcx
  _QWORD *v33; // [rsp+38h] [rbp-39h] BYREF
  __int64 v34; // [rsp+40h] [rbp-31h] BYREF
  HSTRING v35; // [rsp+48h] [rbp-29h] BYREF
  __int64 (__fastcall ***v36)(_QWORD, GUID *, struct WindowsInternal::CDSProperties::ICDSLocalTileProperties **); // [rsp+50h] [rbp-21h] BYREF
...
LABEL_53:
      ...
      if ( v27 >= 0 )
      {
        v27 = (**v36)(v36, &GUID_1feb7eca_a3a7_4f99_967c_c6ef0f2386c2, a3);
        v13 = v27;
        if ( v27 >= 0 )
        {
          v13 = 0;
LABEL_50:
          ...
          {
            v36 = 0LL;
            ((void (__fastcall *)(__int64 (__fastcall ***)(_QWORD, GUID *, struct WindowsInternal::CDSProperties::ICDSLocalTileProperties **)))(*v29)[2])(v29);
          }
          goto LABEL_52;
        }
        v28 = 931LL;
