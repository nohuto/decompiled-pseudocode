/*
 * XREFs of _LDtento @ 0x1800AE018
 * Callers:
 *     _Stoldx @ 0x1800A5CDC (_Stoldx.c)
 * Callees:
 *     _LXp_getw @ 0x1800AD0F8 (_LXp_getw.c)
 *     _Xp_movx @ 0x1800ADBD0 (_Xp_movx.c)
 *     _LXp_mulx @ 0x1800ADDE0 (_LXp_mulx.c)
