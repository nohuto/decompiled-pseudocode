/*
 * XREFs of _lambda_745238b28a452f34781447bba762a765_::operator() @ 0x180053624
 * Callers:
 *     Windows::Internal::COperationLambda0_Windows::Internal::CCallAsyncLambda__lambda_745238b28a452f34781447bba762a765____Windows::Internal::CNoResult_::Run @ 0x180055C60 (Windows--Internal--COperationLambda0_Windows--Internal--CCallAsyncLambda__lambda_745238b28a452f3.c)
 * Callees:
...
__int64 __fastcall lambda_745238b28a452f34781447bba762a765_::operator()(__int64 a1)
{
  __int64 v2; // rax
  ...
  v34 = 0LL;
  v35 = 0LL;
  v20[0] = &ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionRevertedActivity::`vftable';
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionRevertedActivity::StartActivity(
    (ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::ActionRevertedActivity *)v20,
    v7,
    v5,
    v3);
  if ( v13 >= 8 )
  ...
  try
  {
    (*(void (__fastcall **)(_QWORD))(**(_QWORD **)(*(_QWORD *)a1 + 72LL) + 16LL))(*(_QWORD *)(*(_QWORD *)a1 + 72LL));
  }
  catch ( ... )
  {
