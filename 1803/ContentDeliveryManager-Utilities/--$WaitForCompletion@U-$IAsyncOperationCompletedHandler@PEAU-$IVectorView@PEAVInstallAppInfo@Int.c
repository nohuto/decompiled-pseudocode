        ...
        __int64 a3)
{
  ...
  __int64 v8; // rax
  char v9; // bl
  int (__fastcall **v10)(__int64, GUID *, __int64 *); // rbx
  __int64 *v11; // rax
  ...
  if ( v4 )
  {
    ...
    *((_QWORD *)v4 + 7) = Event;
    ...
    if ( v7 >= 0 )
    {
      v20 = ((__int64 (__fastcall *)(int (__fastcall ***)(__int64, GUID *, __int64 *), HANDLE *))(*a1)[6])(a1, v22);
      if ( v20 >= 0 )
      {
        pHandles[0] = v22[7];
        pHandles[1] = 0LL;
        ...
        if ( v9 )
        {
          ...
          if ( (*v10)((__int64)a1, &GUID_00000036_0000_0000_c000_000000000046, v11) >= 0 )
        ...
        if ( v20 >= 0 && *((_DWORD *)v22 + 12) != 1 )
        {
          if ( v19
            || (v12 = *a1,
                ...
                (*v12)((__int64)a1, &GUID_00000036_0000_0000_c000_000000000046, v13) >= 0) )
          {
