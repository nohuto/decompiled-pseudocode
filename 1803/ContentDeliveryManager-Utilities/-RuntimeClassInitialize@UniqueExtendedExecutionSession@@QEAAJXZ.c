/*
 * XREFs of ?RuntimeClassInitialize@UniqueExtendedExecutionSession@@QEAAJXZ @ 0x1800783A8
 * Callers:
 ...
 *     ?Stop@?$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x180079498 (-Stop@-$ActivityBase@VCDMUtilsUnlockLogging@@$00$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@.c)
...
__int64 __fastcall UniqueExtendedExecutionSession::RuntimeClassInitialize(UniqueExtendedExecutionSession *this)
{
  ...
  HSTRING_HEADER v32; // [rsp+98h] [rbp-70h] BYREF
  HSTRING v33; // [rsp+B0h] [rbp-58h] BYREF
  _QWORD v34[4]; // [rsp+B8h] [rbp-50h] BYREF
  int v35; // [rsp+D8h] [rbp-30h]
  int *v36; // [rsp+E0h] [rbp-28h]
  int *v37; // [rsp+E8h] [rbp-20h]
  int v38; // [rsp+F0h] [rbp-18h] BYREF
  char v39; // [rsp+F4h] [rbp-14h]
  int v40; // [rsp+118h] [rbp+10h] BYREF
  const char *v41; // [rsp+120h] [rbp+18h]
  __int64 v42; // [rsp+128h] [rbp+20h]
  char v43; // [rsp+130h] [rbp+28h]
  __int64 v44; // [rsp+138h] [rbp+30h]
  _BYTE v45[144]; // [rsp+140h] [rbp+38h] BYREF
  __int64 v46; // [rsp+1D0h] [rbp+C8h]
  __int64 v47; // [rsp+1D8h] [rbp+D0h]
  __int64 v48; // [rsp+1E0h] [rbp+D8h]
  __int64 v49; // [rsp+1E8h] [rbp+E0h]
  ...
  v43 = 0;
  v40 = 0;
  v41 = "ExtendedExecutionRequested";
  v42 = 0LL;
  v44 = 1LL;
  v46 = 0LL;
  ...
  v48 = 0LL;
  v49 = 0LL;
  v34[0] = &CDMUtilsUnlockTelemetry::ExtendedExecutionRequested::`vftable';
  CDMUtilsUnlockTelemetry::ExtendedExecutionRequested::StartActivity((CDMUtilsUnlockTelemetry::ExtendedExecutionRequested *)v34);
  string = 0LL;
  ...
  *v3 = 0LL;
  ...
  if ( v5 >= 0 )
  {
    ...
    {
      v5 = (**(__int64 (__fastcall ***)(__int64, GUID *, char *))v24)(
             v24,
...
LABEL_16:
  ...
  v9 = *v3;
  v33 = 0LL;
  v10 = WindowsCreateStringReference(L"UnlockActionHelper", 0x12u, &v32, &v33);
  if ( v10 < 0 )
  {
    Microsoft::WRL::Details::RaiseException((Microsoft::WRL::Details *)(unsigned int)v10);
    goto LABEL_40;
  }
  v8 = (*(__int64 (__fastcall **)(__int64, HSTRING))(*(_QWORD *)v9 + 72LL))(v9, v33);
  v5 = v8;
  v33 = 0LL;
  if ( v8 < 0 )
  {
  ...
  *(_QWORD *)&v26 = UniqueExtendedExecutionSession::OnSessionRevoked;
  DWORD2(v26) = 0;
  *(_QWORD *)v27 = this;
  *(_OWORD *)&v27[8] = v26;
  v11 = 0LL;
  ...
  if ( v12 )
  {
    ...
    *((_OWORD *)v12 + 1) = *(_OWORD *)v27;
    *((_QWORD *)v12 + 4) = *(_QWORD *)&v27[16];
    *(_QWORD *)v12 = off_1800DA530;
    v13 = v12;
    v11 = v12;
  }
  *(_QWORD *)&v26 = v11;
  ...
  if ( v14 >= 0 )
  {
    v15 = *v3;
    v25 = 0LL;
    v16 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v15 + 112LL))(v15, &v25);
    v5 = v16;
    if ( v16 < 0 )
    {
    ...
    v19 = v25;
    v20 = wil::details::WaitForCompletion<Windows::Foundation::IAsyncOperation<enum Windows::ApplicationModel::ExtendedExecution::ExtendedExecutionResult> *>(v25);
    if ( v20 >= 0 )
      v20 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v19 + 64LL))(v19, &v23);
    v21 = retaddr;
    if ( v20 >= 0 )
    {
      if ( !(_DWORD)v23 )
      {
        wil::ActivityBase<CDMUtilsUnlockLogging,1,0,5,_TlgReflectorTag_Param0IsProviderType>::Stop((CDMUtilsUnlockTelemetry::ExtendedExecutionRequested *)v34);
        v5 = 0;
LABEL_33:
        if ( v25 )
...
LABEL_37:
  CDMUtilsUnlockTelemetry::ExtendedExecutionRequested::~ExtendedExecutionRequested((CDMUtilsUnlockTelemetry::ExtendedExecutionRequested *)v34);
