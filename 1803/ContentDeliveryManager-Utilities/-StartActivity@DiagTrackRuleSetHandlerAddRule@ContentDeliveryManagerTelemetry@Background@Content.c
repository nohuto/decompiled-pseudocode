/*
 * XREFs of ?StartActivity@DiagTrackRuleSetHandlerAddRule@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEB_WIPEBD@Z @ 0x180073888
 * Callers:
        ...
        const char *a4)
{
  ...
  *v7 = 1;
  ...
  if ( *(_DWORD *)v12 > 5u )
  {
    ...
    TlgWrite(v12, &unk_18015870D, (LPCGUID)(v16 + 8), v17, 6u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
