/*
 * XREFs of ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEA_N@Z @ 0x1800AA8E0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a7)
{
  ...
  if ( (*(_DWORD *)(a5 + 24) & 0x4000) != 0 )
  {
    ...
    std::string::append((size_t *)v28, v30, 0LL, 0xFFFFFFFFFFFFFFFFuLL);
    if ( v31 >= 0x10 )
      operator delete(v30[0]);
    std::string::append((size_t *)v28, 1uLL, 0);
