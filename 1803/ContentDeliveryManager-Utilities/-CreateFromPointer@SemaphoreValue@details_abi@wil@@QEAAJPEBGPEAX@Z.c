/*
 * XREFs of ?CreateFromPointer@SemaphoreValue@details_abi@wil@@QEAAJPEBGPEAX@Z @ 0x180003430
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  *v10 = 0;
  ...
  wil::details::in1diag3::Return_Hr(retaddr, (void *)v16, (__int64)"wil", (const char *)(unsigned int)v14);
  return v15;
}
