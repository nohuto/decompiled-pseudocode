/*
 * XREFs of ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_UTMIntegrationWithTargetedContentApi@@@wil@@SA_NXZ @ 0x180032840
 * Callers:
 *     <none>
 * Callees:
...
char wil::Feature<__WilFeatureTraits_Feature_UTMIntegrationWithTargetedContentApi>::IsEnabled()
{
