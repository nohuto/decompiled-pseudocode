/*
 * XREFs of ?UnsubscribeFromFeatureReportingUsage@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x18006B030
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?wil_LoadStagingConfig@@YAJPEAPEAUwil_StagingConfig@@W4wil_FeatureStore@@H@Z @ 0x180068D90 (-wil_LoadStagingConfig@@YAJPEAPEAUwil_StagingConfig@@W4wil_FeatureStore@@H@Z.c)
 *     ?wil_SaveStagingConfig@@YAJPEAUwil_StagingConfig@@H@Z @ 0x180068E18 (-wil_SaveStagingConfig@@YAJPEAUwil_StagingConfig@@H@Z.c)
 ...
 *     ?GetFeatureIdAndReportingIdForTrigger@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@AEAIAEAG@Z @ 0x18006AB48 (-GetFeatureIdAndReportingIdForTrigger@Internal@TargetedContent@Services@Windows@@YAJPEAUITargete.c)
        ...
        __int64 a2)
{
  ...
  try
  {
    ...
    if ( StagingConfig < 0 )
    {
      wil::details::in1diag3::_Throw_NtStatus(retaddr, (void *)0x213, v5, (const char *)(unsigned int)StagingConfig);
    }
    else
    {
      ...
      if ( FeatureIdAndReportingIdForTrigger >= 0 )
      {
        ...
        {
          *((_QWORD *)v12 + 8) -= 16LL * (v17 - (unsigned __int16)v15);
          *((_DWORD *)v12 + 4) = 1;
          *(_WORD *)(v13 + 6) = v15;
        }
...
LABEL_33:
        wil::details::in1diag3::_Throw_NtStatus(v21, (void *)0x220, v20, (const char *)(unsigned int)v19);
        JUMPOUT(0x18006B26FLL);
      }
    }
