/*
 * XREFs of ?_Init@locale@std@@CAPEAV_Locimp@12@_N@Z @ 0x1800A50C8
 * Callers:
 ...
 *     ?_New_Locimp@_Locimp@locale@std@@CAPEAV123@_N@Z @ 0x1800A52C0 (-_New_Locimp@_Locimp@locale@std@@CAPEAV123@_N@Z.c)
...
struct std::locale::_Locimp *__fastcall std::locale::_Init(char a1)
{
  ...
  v2 = (struct std::locale::_Locimp *)qword_18017B390;
  if ( !qword_18017B390 )
  {
    ...
    *((_DWORD *)v2 + 8) = 63;
    ...
    qword_18017B3E0 = (__int64)std::locale::_Locimp::_Clocptr;
  }
  if ( a1 )
    (*(void (__fastcall **)(struct std::locale::_Locimp *))(*(_QWORD *)v2 + 8LL))(v2);
