        ...
        void **a3)
{
  ...
  DWORD v9; // r9d
  int v10; // eax
  int (__fastcall **v11)(__int64, GUID *, __int64 *); // rbx
  __int64 *v12; // rax
  __int64 v13; // rcx
  void **v14; // rcx
  ...
  int (__fastcall ***v22)(__int64, GUID *, __int64 *); // [rsp+98h] [rbp+40h]
  ...
  if ( v4 )
  {
    ...
    *((_QWORD *)v4 + 7) = Event;
    ...
    if ( v5 >= 0 )
    {
      v5 = ((__int64 (__fastcall *)(int (__fastcall ***)(__int64, GUID *, __int64 *), void **))(*a1)[6])(a1, v21);
      v20 = v5;
      if ( v5 >= 0 )
      {
        v18[0] = v21[7];
        ...
        if ( v5 >= 0 && *((_DWORD *)v21 + 12) != 1 )
        {
          ...
          if ( (*v11)((__int64)a1, &GUID_00000036_0000_0000_c000_000000000046, v12) >= 0 )
