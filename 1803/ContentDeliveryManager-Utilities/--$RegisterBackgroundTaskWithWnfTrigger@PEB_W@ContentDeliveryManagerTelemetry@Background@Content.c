/*
 * XREFs of ??$RegisterBackgroundTaskWithWnfTrigger@PEB_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAPEB_WPEBD@Z @ 0x1800A3650
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( *(_DWORD *)v4 > 5u )
  {
      ...
      && (*((_QWORD *)v5 + 3) & 0x200000000000LL) == *((_QWORD *)v5 + 3) )
    {
      ...
      v14 = v7 + 1;
      v13 = a2;
      LODWORD(v4) = TlgWrite(v5, &unk_180158F54, 0LL, 0LL, 4u, &pData);
    }
  }
  return (int)v4;
}
