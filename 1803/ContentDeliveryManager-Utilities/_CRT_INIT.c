/*
 * XREFs of _CRT_INIT @ 0x1800C0534
 * Callers:
 *     __DllMainCRTStartup @ 0x1800C07B0 (__DllMainCRTStartup.c)
 * Callees:
 *     _amsg_exit_0 @ 0x1800C11F3 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800C1250 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1800C13A5 (_initterm_0.c)
