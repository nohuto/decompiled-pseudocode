/*
 * XREFs of ??_ESubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@UEAAPEAXI@Z @ 0x180048320
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  *((_QWORD *)this + 12) = 0LL;
  ...
  v10 = *((_QWORD *)this + 8);
  if ( v10 < 0 )
    Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,IWnfNameResolver>::Release((volatile signed __int32 *)(2 * v10));
  v11 = *((_QWORD *)this + 6);
  if ( v11 )
  {
    *((_QWORD *)this + 6) = 0LL;
