/*
 * XREFs of ?StartActivity@TriggerManagerUnregisterActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEBD@Z @ 0x18005DF58
 * Callers:
        ...
        const char *a2)
{
  ...
  *(_DWORD *)v4 = 1;
  ...
  if ( *(_DWORD *)v7 > 5u )
  {
    ...
    TlgWrite(v7, &unk_180157F43, (LPCGUID)(v10 + 8), v11, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
    v12 = (char *)this + 8;
