/*
 * XREFs of __report_gsfailure @ 0x140001450
 * Callers:
 *     __security_check_cookie @ 0x140001430 (__security_check_cookie.c)
 * Callees:
 *     NtTerminateProcess_0 @ 0x140001668 (NtTerminateProcess_0.c)
 *     RtlCaptureContext_0 @ 0x14000166E (RtlCaptureContext_0.c)
 *     RtlLookupFunctionEntry_0 @ 0x140001674 (RtlLookupFunctionEntry_0.c)
 *     RtlVirtualUnwind_0 @ 0x14000167A (RtlVirtualUnwind_0.c)
 *     RtlUnhandledExceptionFilter_0 @ 0x140001680 (RtlUnhandledExceptionFilter_0.c)
 */
