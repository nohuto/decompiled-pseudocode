/*
 * XREFs of ?UpdateOnManipulationThread@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadArgs@@PEAUIManipulationTelemetryData@@@Z @ 0x180199FC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _anonymous_namespace_::StoreIfChanged_float_ @ 0x180198E54 (_anonymous_namespace_--StoreIfChanged_float_.c)
 *     _anonymous_namespace_::StoreIfChanged_D2DVector3_ @ 0x180198E68 (_anonymous_namespace_--StoreIfChanged_D2DVector3_.c)
 *     ?_ResetManipulationThreadDataIfNecessary@CManipulation@@AEAAXW4InteractionState@@@Z @ 0x18019A608 (-_ResetManipulationThreadDataIfNecessary@CManipulation@@AEAAXW4InteractionState@@@Z.c)
  ...
  *(_DWORD *)(v10 + 28) = *((_DWORD *)a2 + 7);
    ...
    || ((*((_BYTE *)a2 + 16) ^ *(_BYTE *)(v25 + 188)) & 2) != 0 )
  {
    ...
    *(_DWORD *)(v25 + 172) = *((_DWORD *)a2 + 23);
    ...
    if ( v26 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0x7Au);
    }
    else if ( a3 )
    {
