/*
 * XREFs of ?GetTransformedOutput@CInteractionContextWrapper@@UEAAJAEBVCMILMatrix@@PEAUInteractionOutput@@@Z @ 0x1801D7450
 * Callers:
 *     <none>
 * Callees:
    ...
    *((_DWORD *)a3 + 14) = *((_DWORD *)v3 + 14);
    if ( dword_1802D3FE0 > 4u )
    {
      if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 2uLL) )
      {
        ...
        v35 = v11;
        v37 = v11;
        TlgWrite(v10, &unk_1802AAB52, 0LL, 0LL, 0xDu, &pData);
        return v13;
      }
    }
  }
