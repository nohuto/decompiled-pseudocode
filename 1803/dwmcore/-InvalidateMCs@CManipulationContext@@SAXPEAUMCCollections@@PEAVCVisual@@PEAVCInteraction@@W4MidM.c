/*
 * XREFs of ?InvalidateMCs@CManipulationContext@@SAXPEAUMCCollections@@PEAVCVisual@@PEAVCInteraction@@W4MidManipulationUpdateType@@PEAI@Z @ 0x1801DAAAC
 * Callers:
 ...
 *     ?GetMCRoot@CManipulationContext@@CAPEAVCInteraction@@PEBV2@@Z @ 0x1801DA808 (-GetMCRoot@CManipulationContext@@CAPEAVCInteraction@@PEBV2@@Z.c)
...
LABEL_6:
  ...
  else if ( a2 )
  {
    ...
    if ( !ManipulationContext )
      goto LABEL_34;
    if ( (*((_BYTE *)ManipulationContext + 184) & 2) != 0 && a2[10] )
    {
