/*
 * XREFs of ?InitializeForFormatConversion@CScanPipeline@@QEAAJAEBUPixelFormatInfo@@0IE@Z @ 0x180202A2C
 * Callers:
 ...
 *     ?ResetPipeline@CScanPipeline@@MEAAXXZ @ 0x180202920 (-ResetPipeline@CScanPipeline@@MEAAXXZ.c)
...
LABEL_14:
    ...
    if ( Buffers < 0 )
    {
      v15 = 97;
LABEL_22:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Buffers, v15);
  ...
  v10 = v13;
  if ( v13 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x95u);
  if ( v10 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x64u);
  return (unsigned int)v10;
}
