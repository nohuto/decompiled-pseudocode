/*
 * XREFs of ??0CLinearGradientBrush@@QEAA@PEAVCComposition@@@Z @ 0x1800118AC
 * Callers:
 ...
 * Callees:
 *     ??0CGradientBrush@@IEAA@PEAVCComposition@@@Z @ 0x18001238C (--0CGradientBrush@@IEAA@PEAVCComposition@@@Z.c)
 */
