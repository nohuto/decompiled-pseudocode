/*
 * XREFs of ?TargetFrameInput@CManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x1801D0B38
 * Callers:
 ...
 *     ?TargetBufferedFrames@CManipulationManager@@AEAAXIPEAXK@Z @ 0x1801D0A80 (-TargetBufferedFrames@CManipulationManager@@AEAAXIPEAXK@Z.c)
    ...
    if ( (*((_BYTE *)a2 + 40) & 2) == 0 || *(_QWORD *)((char *)a2 + v6 + 120) == -1LL )
    {
      ...
      *(_QWORD *)((char *)a2 + v6 + 120) = v9;
      if ( v9 != (void *)-1LL )
      {
        *((_BYTE *)a2 + 40) |= 1u;
        if ( (*((_BYTE *)a2 + 40) & 2) == 0 )
          CManipulationManager::TargetBufferedFrames(this, *((_DWORD *)v7 + 25), v9, i);
      }
