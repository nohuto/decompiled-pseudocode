/*
 * XREFs of ??_ECInteractionTrackerPositionAnimation@@UEAAPEAXI@Z @ 0x1801BF1B0
 * Callers:
 *     <none>
 * Callees:
...
CWeakReferenceBase **__fastcall CInteractionTrackerPositionAnimation::`vector deleting destructor'(
