/*
 * XREFs of ?PrepareToPushSourceBitsToVidMem@CHwBitmapColorSource@@AEAAJPEAVIBitmapSource@@IPEAV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVIBitmapLock@@@Z @ 0x1801F0160
 * Callers:
        ...
        else
        {
          ...
          else
          {
            ...
            if ( v19 >= 0 )
            {
              ...
              {
                v14 = -2003292288;
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292288, 0xD93u);
              }
              else
              {
                v22 = v26;
...
LABEL_33:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, v24);
LABEL_34:
        v11 = 0LL;
        goto LABEL_35;
      }
    ...
    {
      v14 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0xD4Du);
      goto LABEL_35;
    }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, v25);
LABEL_35:
