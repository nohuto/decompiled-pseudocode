/*
 * XREFs of ?HrFindInterface@CHwDisplayRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800471B0
 * Callers:
 ...
 *     ?HrFindInterface@CHwStereoFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801F14F0 (-HrFindInterface@CHwStereoFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
        ...
        void **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( !v4 )
  {
    v5 = (char *)(((unsigned __int64)this + 56) & -(__int64)(this != (CHwDisplayRenderTarget *)160));
LABEL_14:
    *a3 = v5;
    return v3;
  }
