/*
 * XREFs of ?EnsureCount@CMILResourceCache@@IEAAJI@Z @ 0x18001DC7C
 * Callers:
...
__int64 __fastcall CMILResourceCache::EnsureCount(CMILResourceCache *this, unsigned int a2)
{
  ...
  {
    v5 = a2 - *((_DWORD *)this + 8);
    if ( a2 <= *((_DWORD *)this + 7) || (v8 = DynArrayImpl<0>::Grow((int)this + 8, 8, v5, 1, 0LL), v2 = v8, v8 >= 0) )
    {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x339u);
    }
  }
