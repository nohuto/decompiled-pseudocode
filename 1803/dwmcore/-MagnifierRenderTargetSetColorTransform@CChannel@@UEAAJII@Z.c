/*
 * XREFs of ?MagnifierRenderTargetSetColorTransform@CChannel@@UEAAJII@Z @ 0x1801448B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MagnifierRenderTargetSetColorTransform(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
