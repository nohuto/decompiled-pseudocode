/*
 * XREFs of ?OpenShared@CHwDeviceBitmapColorSource@@SAJPEAVCD3DDeviceLevel1@@PEAVIBitmapSource@@IVDisplayId@@PEAX_NIPEAPEAV1@@Z @ 0x1801F478C
 * Callers:
...
__int64 __fastcall CHwDeviceBitmapColorSource::OpenShared(
        ...
        unsigned int a3,
        unsigned int a4,
        struct D3D11_SUBRESOURCE_DATA *a5,
        bool a6,
        unsigned int a7,
        CHwDeviceBitmapColorSource **a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x22Eu);
  }
  else
  {
    v15 = *((_DWORD *)v18 + 32);
    ...
    v14 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x243u);
  }
  if ( v13 )
