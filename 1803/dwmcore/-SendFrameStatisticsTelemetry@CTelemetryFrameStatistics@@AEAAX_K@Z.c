/*
 * XREFs of ?SendFrameStatisticsTelemetry@CTelemetryFrameStatistics@@AEAAX_K@Z @ 0x1800CFAE0
 * Callers:
 ...
 * Callees:
 *     GetProcessAndSessionId @ 0x1800CFD20 (GetProcessAndSessionId.c)
...
void __fastcall CTelemetryFrameStatistics::SendFrameStatisticsTelemetry(CTelemetryFrameStatistics *this, __int64 a2)
{
  ...
  if ( *((_DWORD *)this + 8) )
  {
    ...
    if ( dword_1802D3FA0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FA0, 0x400000000000uLL) )
    {
      ...
      v49 = 4;
      v21 = v12 / v6;
      TlgWrite((TraceLoggingHProvider)&dword_1802D3FA0, &unk_1802A714B, 0LL, 0LL, 0xBu, &pData);
    }
