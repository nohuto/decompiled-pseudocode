/*
 * XREFs of ?WilApiImpl_GetFeatureVariant@details@wil@@YAIIW4FEATURE_CHANGE_TIME@@PEAIPEAH@Z @ 0x1800BB230
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  v10 = 0LL;
  v11 = 0LL;
  v6 = ((__int64 (__fastcall *)(__int64 *, _QWORD, _DWORD *, _QWORD))wil::details::IsFeatureConfigured)(
         &v9,
         (unsigned int)this,
         a3,
         (a2 >> 7) & 1);
