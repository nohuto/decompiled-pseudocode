/*
 * XREFs of ?RenderLayer@CHDRToSDRToneMapLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x18017445C
 * Callers:
        ...
        double a4)
{
  ...
  float v20; // [rsp+58h] [rbp-1h] BYREF
  ...
  v25 = 0LL;
  v26 = *((_QWORD *)this + 3);
  CScopedClipStack::GetTopGpuClipInScope((__int64 *)a2 + 126, 1, (__int64)&v20);
  ...
  *(float *)&a4 = (float)(int)v23;
  ...
  v9 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v8 + 240LL))(v8, &v19);
  v10 = v9;
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x5Bu);
  }
  else
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x62u);
    }
    else
    {
      v17 = 1;
      v15 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD, char, __int64 *, _DWORD *))(*(_QWORD *)v18 + 256LL))(
              v18,
              v12,
              v13,
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x6Au);
      }
      else
      {
