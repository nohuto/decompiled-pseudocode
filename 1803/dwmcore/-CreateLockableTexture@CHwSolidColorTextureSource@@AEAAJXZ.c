/*
 * XREFs of ?CreateLockableTexture@CHwSolidColorTextureSource@@AEAAJXZ @ 0x1801EA0BC
 * Callers:
...
__int64 __fastcall CHwSolidColorTextureSource::CreateLockableTexture(CHwSolidColorTextureSource *this)
{
  ...
  if ( LockableTexture < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, LockableTexture, 0xE6u);
  else
    *((struct CD3DLockableTexture **)this + 14) = v7[0];
  return v5;
}
