/*
 * XREFs of ?SendRequestDisposeProxy@dataproviderBamoPeerImpl@BamoImpl@@UEAAXI@Z @ 0x180154930
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dataproviderBamoPeerImpl::SendRequestDisposeProxy(BamoImpl::dataproviderBamoPeerImpl *this)
{
  __int64 v1; // r8
  __int64 v2; // r10
  int v3; // eax
  ...
  v3 = CoreUICallSend(v2, v5, 2LL, 6LL, 6, &unk_180277D35);
  if ( v3 < 0 )
  {
