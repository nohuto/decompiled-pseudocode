/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@UClippingScopeState@CScopedClipStack@@$0A@@@QEAAJPEFBUClippingScopeState@CScopedClipStack@@I@Z @ 0x1800BDCA0
 * Callers:
...
__int64 __fastcall DynArray<CScopedClipStack::ClippingScopeState,0>::AddMultipleAndSet(__int64 a1, _OWORD *a2)
{
  ...
  {
    v8 = DynArrayImpl<0>::AddMultipleAndSet(a1, 0x50u, 1, a2);
    v5 = v8;
    if ( v8 < 0 )
