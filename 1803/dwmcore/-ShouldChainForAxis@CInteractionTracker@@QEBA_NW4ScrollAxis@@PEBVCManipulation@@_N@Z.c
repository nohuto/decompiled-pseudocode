/*
 * XREFs of ?ShouldChainForAxis@CInteractionTracker@@QEBA_NW4ScrollAxis@@PEBVCManipulation@@_N@Z @ 0x180196AF0
 * Callers:
 ...
 *     _lambda_a40a05a87e17fe03a586ba80cec243fd_::operator() @ 0x180193454 (_lambda_a40a05a87e17fe03a586ba80cec243fd_--operator().c)
 */
...
char __fastcall CInteractionTracker::ShouldChainForAxis(__int64 a1, int a2, __int64 a3, unsigned __int8 a4)
{
  ...
  if ( v14 == 1 )
  {
    ...
    if ( v15 )
    {
      v16 = v31;
LABEL_14:
      if ( lambda_a40a05a87e17fe03a586ba80cec243fd_::operator()((__int64)v18, v16) )
        return 1;
    }
  }
  return v4;
