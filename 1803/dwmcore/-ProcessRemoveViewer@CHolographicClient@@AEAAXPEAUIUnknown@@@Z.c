/*
 * XREFs of ?ProcessRemoveViewer@CHolographicClient@@AEAAXPEAUIUnknown@@@Z @ 0x1801FFFD4
 * Callers:
...
void __fastcall CHolographicClient::ProcessRemoveViewer(CHolographicClient *this, struct IUnknown *a2)
{
  ...
  if ( ((__int64 (__fastcall *)(struct IUnknown *, GUID *, __int64 *))lpVtbl->QueryInterface)(
         ...
         &v4) >= 0 )
  {
    (*(void (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 3) + 176LL))(*((_QWORD *)this + 3), v4);
    if ( (unsigned int)DynArray<CBaseExpression *,1>::Remove((char *)this + 136, &v4) )
