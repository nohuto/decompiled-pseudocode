/*
 * XREFs of ?GetProperty@CCompositionSkyBoxBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180186100
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CExpressionValue *a3)
{
  ...
  v8[0] = 2LL;
  v8[1] = &CCompositionSkyBoxBrush::k_rgAnimDef;
  v5 = 0;
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x4Du);
  }
  return v5;
}
