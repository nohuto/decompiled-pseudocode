/*
 * XREFs of ?FindBufferedOutputPointer@CInteractionContextWrapper@@AEBAPEAVCBufferedOutputPointer@@I@Z @ 0x1801D7038
 * Callers:
 ...
 *     ?DepartBufferedOutputPointer@CInteractionContextWrapper@@UEAA_NI@Z @ 0x1801D6FC0 (-DepartBufferedOutputPointer@CInteractionContextWrapper@@UEAA_NI@Z.c)
 *     ?HasBufferedOutput@CInteractionContextWrapper@@UEBA_NI@Z @ 0x1801D7620 (-HasBufferedOutput@CInteractionContextWrapper@@UEBA_NI@Z.c)
 * Callees:
 *     <none>
 */
