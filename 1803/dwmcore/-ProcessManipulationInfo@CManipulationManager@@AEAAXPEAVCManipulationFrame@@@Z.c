/*
 * XREFs of ?ProcessManipulationInfo@CManipulationManager@@AEAAXPEAVCManipulationFrame@@@Z @ 0x1801CFA98
 * Callers:
...
void __fastcall CManipulationManager::ProcessManipulationInfo(CManipulationManager *this, LARGE_INTEGER *a2)
{
  ...
  if ( dword_1802D3FE0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 2uLL) )
  {
    ...
    v25 = cData;
    v27 = v8;
    TlgWrite((TraceLoggingHProvider)&dword_1802D3FE0, &unk_1802A9D4D, 0LL, 0LL, cData, &pData);
  }
