/*
 * XREFs of ?ProcessHandledInteractions@CInteractionProcessor@@QEAAJPEAUIManipulationResource@@_K_NW4InertiaFrameType@@PEAUIManipulationTelemetryData@@PEAW4PointerResult@@@Z @ 0x1801D5208
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  bool v11; // r15
  char v12; // cl
  CNaturalAnimationScalarForceAdapater *v13; // rbx
  bool v14; // r9
  bool v15; // r9
  bool v16; // r8
  __int64 v17; // rax
  ...
  __int64 v20; // rax
  __int64 v21; // rax
  CNaturalAnimationScalarForceAdapater *v23; // [rsp+30h] [rbp-B1h] BYREF
    ...
    || *(_DWORD *)(a1 + 788) == 6 )
  {
    ...
    if ( (v12 & 0x10) == 0 )
    {
      *(_BYTE *)(a1 + 808) = (16 * a4) | v12 & 0xEF;
      ...
      {
        v23 = 0LL;
        Microsoft::WRL::ComPtr<IInteractionContextWrapper>::InternalRelease(&v23);
        ...
        if ( v23 )
        {
          ...
          if ( a4 )
          {
            if ( ((*(_BYTE *)(a1 + 808) & 0x20) != 0 || *(_DWORD *)(a1 + 788) == 6)
              && (*(unsigned __int8 (__fastcall **)(CNaturalAnimationScalarForceAdapater *))(*(_QWORD *)v13 + 88LL))(v13) )
            {
              if ( (*(unsigned __int8 (__fastcall **)(CNaturalAnimationScalarForceAdapater *, _QWORD))(*(_QWORD *)v13 + 96LL))(
                     v13,
                     0LL) )
              {
                if ( (*(unsigned int (__fastcall **)(CNaturalAnimationScalarForceAdapater *, _QWORD, __int64, __int64, _OWORD *))(*(_QWORD *)v13 + 120LL))(
                       v13,
                       *(_QWORD *)(a1 + 832),
                       v24,
                       a1 + 1180,
                ...
                (*(void (__fastcall **)(CNaturalAnimationScalarForceAdapater *))(*(_QWORD *)v13 + 128LL))(v13);
              }
              (*(void (__fastcall **)(CNaturalAnimationScalarForceAdapater *, _QWORD))(*(_QWORD *)v13 + 80LL))(v13, 0LL);
            }
            v7 = (*(__int64 (__fastcall **)(CNaturalAnimationScalarForceAdapater *, __int64, _OWORD *))(*(_QWORD *)v13 + 56LL))(
                   v13,
                   a1 + 1180,
                   v28);
            if ( v7 < 0 )
          ...
          else
          {
            ...
            v17 = (*(__int64 (__fastcall **)(CNaturalAnimationScalarForceAdapater *, _BYTE *))(*(_QWORD *)v13 + 40LL))(
                    v13,
                    v31);
            v16 = 0;
            v28[0] = *(_OWORD *)v17;
