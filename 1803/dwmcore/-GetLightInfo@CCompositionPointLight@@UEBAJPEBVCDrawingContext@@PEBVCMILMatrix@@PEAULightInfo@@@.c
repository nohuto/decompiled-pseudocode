/*
 * XREFs of ?GetLightInfo@CCompositionPointLight@@UEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAULightInfo@@@Z @ 0x1801851D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct LightInfo *a4)
{
  ...
  *(_DWORD *)a4 = 2;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x6Fu);
  }
  else
  {
