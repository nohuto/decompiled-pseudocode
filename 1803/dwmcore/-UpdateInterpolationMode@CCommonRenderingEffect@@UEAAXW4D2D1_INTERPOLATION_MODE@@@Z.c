/*
 * XREFs of ?UpdateInterpolationMode@CCommonRenderingEffect@@UEAAXW4D2D1_INTERPOLATION_MODE@@@Z @ 0x180006080
 * Callers:
...
void __fastcall CCommonRenderingEffect::UpdateInterpolationMode(CCommonRenderingEffect *this, __int64 a2)
{
  char v2; // al
  __int64 v3; // r8
  _BYTE *v4; // r8
  ...
  v2 = InterpolationMode::FromD2D1InterpolationMode((unsigned int)a2, a2, this);
  v4 = (_BYTE *)(v3 + 64);
  v5 = 2LL;
  do
  {
