/*
 * XREFs of McTemplateU0ppffffdd @ 0x180182AD0
 * Callers:
...
ULONG McTemplateU0ppffffdd(__int64 a1, __int64 a2, ...)
{
  struct _EVENT_DATA_DESCRIPTOR v3; // [rsp+20h] [rbp-79h] BYREF
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_CVI_UPDATE, 9u, &v3);
}
