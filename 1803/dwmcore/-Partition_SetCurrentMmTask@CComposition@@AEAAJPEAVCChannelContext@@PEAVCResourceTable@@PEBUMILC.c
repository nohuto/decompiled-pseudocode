/*
 * XREFs of ?Partition_SetCurrentMmTask@CComposition@@AEAAJPEAVCChannelContext@@PEAVCResourceTable@@PEBUMILCMD_PARTITION_SETCURRENTMMTASK@@@Z @ 0x18002E094
 * Callers:
        ...
        const struct MILCMD_PARTITION_SETCURRENTMMTASK *a4)
{
  ...
  v15[8] = v11;
  v12 = CMmcssTask::Set(this + 20, (const struct DWM_MMTASK *)v15, 1);
  v13 = v12;
  if ( v12 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x518u);
  else
