/*
 * XREFs of PubSebRegisterRpc @ 0x1800CA238
 * Callers:
 ...
 * Callees:
 *     ?Add@?$CSimpleMap@PEAU_SEB_RPC_PUBLISH_DATA@@PEAXV?$CSimpleMapEqualHelper@PEAU_SEB_RPC_PUBLISH_DATA@@PEAX@ATL@@@ATL@@QEAAHAEBQEAU_SEB_RPC_PUBLISH_DATA@@AEBQEAX@Z @ 0x1800CA370 (-Add@-$CSimpleMap@PEAU_SEB_RPC_PUBLISH_DATA@@PEAXV-$CSimpleMapEqualHelper@PEAU_SEB_RPC_PUBLISH_D.c)
...
LABEL_15:
  ...
  *Heap = 0LL;
  ...
  v10 = v6;
  v11 = Heap;
  RtlAcquireSRWLockExclusive(&unk_1802D68A8);
  v8 = 0;
  if ( !(unsigned int)ATL::CSimpleMap<_SEB_RPC_PUBLISH_DATA *,void *,ATL::CSimpleMapEqualHelper<_SEB_RPC_PUBLISH_DATA *,void *>>::Add(
                        ...
                        &v10) )
    v8 = 1359;
  RtlReleaseSRWLockExclusive(&unk_1802D68A8);
  RpcBindingHandle = v8;
  if ( v8 )
    RpcBindingHandle = (unsigned int)NdrClientCall3(
                                       (MIDL_STUBLESS_PROXY_INFO *)&CSystemEventBrokerPublisher_ProxyInfo,
