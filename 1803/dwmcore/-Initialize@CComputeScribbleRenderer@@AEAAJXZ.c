/*
 * XREFs of ?Initialize@CComputeScribbleRenderer@@AEAAJXZ @ 0x180218C10
 * Callers:
...
__int64 __fastcall CComputeScribbleRenderer::Initialize(CComputeScribbleRenderer *this)
{
  ...
  v2 = *(__int64 **)(*(_QWORD *)((*(__int64 (__fastcall **)(_QWORD))(**(_QWORD **)this + 112LL))(*(_QWORD *)this) + 16)
                   + 80LL);
  v3 = *(CSwapChainBase **)(*(_QWORD *)this + 248LL);
  v4 = *((_DWORD *)v3 + 40);
  *((_DWORD *)this + 4) = v4;
  v5 = v4;
  v7 = v4;
...
LABEL_19:
  ...
  D3D12Resources = CAsyncTask<CD3DDeviceLevel1::D3D12Resources>::WaitForResult(v2[90], &v33);
  v16 = D3D12Resources;
  if ( D3D12Resources < 0 )
  {
    v20 = 1345LL;
...
LABEL_27:
  ...
  v25 = *(_QWORD *)this;
  v31 = 1;
  v26 = CComputeScribbleRenderer::CScheduler::Create(*(const struct CDisplay **)(v25 + 240), lpVtbl, &v30);
  if ( v31 )
  {
    v27 = *v29;
    *v29 = v30;
