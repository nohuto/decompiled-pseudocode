/*
 * XREFs of ?QueryInterface@CCompositionSurfaceBitmap@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180047720
 * Callers:
 ...
 *     ?QueryInterface@CCompositionSurfaceBitmap@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DD6A0 (-QueryInterface@CCompositionSurfaceBitmap@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CCompositionSurfaceBitmap@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DD6B0 (-QueryInterface@CCompositionSurfaceBitmap@@WEA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CCompositionSurfaceBitmap@@WFA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DD6C0 (-QueryInterface@CCompositionSurfaceBitmap@@WFA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?HrFindInterface@CCompositionSurfaceBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800479B0 (-HrFindInterface@CCompositionSurfaceBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
