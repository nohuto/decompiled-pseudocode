/*
 * XREFs of ?GetPropertyValue@DataSourceProxy@@QEAAJPEAVCDataSourceReader@@IPEAVCExpressionValue@@@Z @ 0x18016B520
 * Callers:
        ...
        struct CExpressionValue *a4)
{
  ...
  if ( DataSourceProxy::DoesReaderHaveAccess(this, a2) )
    return DataSourcePropertySet::GetPropertyValue((DataSourceProxy *)((char *)this + 56), a3, a4);
