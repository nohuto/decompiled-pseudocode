/*
 * XREFs of ?SetMatrix3x2Value@DataSourceProxy@@MEAAJIAEBUD2D_MATRIX_3X2_F@@@Z @ 0x18016B990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DataSourceProxy::SetMatrix3x2Value(DataSourceProxy *this, int a2, const struct D2D_MATRIX_3X2_F *a3)
{
  ...
  v5 = DataSourcePropertySet::SetProperty<D2D_MATRIX_3X2_F>((_QWORD *)this + 7, a2, (__int64)a3);
