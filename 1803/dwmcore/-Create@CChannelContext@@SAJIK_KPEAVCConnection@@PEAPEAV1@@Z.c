/*
 * XREFs of ?Create@CChannelContext@@SAJIK_KPEAVCConnection@@PEAPEAV1@@Z @ 0x180020E94
 * Callers:
 ...
 *     ??0CChannelContext@@IEAA@IKPEAVCProcessAttribution@@PEAVCConnection@@@Z @ 0x180021044 (--0CChannelContext@@IEAA@IKPEAVCProcessAttribution@@PEAVCConnection@@@Z.c)
 ...
 *     ??0CResourceTable@@QEAA@IPEAVCProcessAttribution@@@Z @ 0x18002D1D0 (--0CResourceTable@@QEAA@IPEAVCProcessAttribution@@@Z.c)
        ...
        struct CChannelContext **a5)
{
  ...
  v7 = 0;
  v16[0] = 0LL;
  ProcessAttribution = CProcessAttributionManager::GetProcessAttribution(qword_1802D60A0, a2, a3, v16);
