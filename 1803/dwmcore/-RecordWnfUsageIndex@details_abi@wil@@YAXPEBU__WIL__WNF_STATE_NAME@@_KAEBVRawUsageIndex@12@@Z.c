/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x1800BBEE4
 * Callers:
 ...
 *     ??0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z @ 0x180058588 (--0RawUsageIndex@details_abi@wil@@QEAA@GGW4CountSize@12@G0@Z.c)
 ...
 *     _alloca_probe @ 0x1800DD350 (_alloca_probe.c)
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  int updated; // eax
  const struct __WIL__WNF_TYPE_ID *v18; // r9
  ...
  __int64 (__fastcall **v33)(); // [rsp+B0h] [rbp-50h] BYREF
  __int128 v34; // [rsp+B8h] [rbp-48h]
  _BYTE *v35; // [rsp+C8h] [rbp-38h]
  __int64 (__fastcall ***v36)(); // [rsp+118h] [rbp+18h]
  char v37[4096]; // [rsp+120h] [rbp+20h] BYREF
  ...
  while ( 1 )
  {
    wil::details_abi::RawUsageIndex::RawUsageIndex(
      ...
      *(_BYTE *)(a3 + 8));
    v21 = 4096;
    v10 = wil_details_NtQueryWnfStateData(v7, v8, v9, &v22, v37, &v21);
    ...
    wil::details_abi::RawUsageIndex::SetBuffer((wil::details_abi::RawUsageIndex *)v27, v37, v12, (const char *)0x1000);
    if ( v32 )
      break;
    v23 = 0LL;
    *(_QWORD *)&v25 = &v23;
    *((_QWORD *)&v25 + 1) = &v24;
    ...
    v34 = v25;
    v35 = v27;
    v15 = wil::details_abi::RawUsageIndex::Iterate(a3, (__int64)&v33);
    if ( v31 )
    {
      updated = wil_details_NtUpdateWnfStateData(v7, v28, (int)v29 - (int)v28, v16, v19, v22, 1u);
      ...
      if ( updated )
        wil_details_NtUpdateWnfStateData(v7, v28, v29 - (_DWORD)v28, v18, v20, 0, 0);
    }
    v7 = (const struct __WIL__WNF_STATE_NAME *)((char *)v7 + 8);
    v24 = v23;
LABEL_7:
    if ( v30 )
      wil::details::FreeProcessHeap(v30, v14);
    if ( v15 || v7 >= v5 || v4 >= 0x32 )
      return;
  }
  if ( v30 )
    wil::details::FreeProcessHeap(v30, v13);
}
