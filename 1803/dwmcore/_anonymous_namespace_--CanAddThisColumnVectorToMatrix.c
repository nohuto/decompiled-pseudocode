/*
 * XREFs of _anonymous_namespace_::CanAddThisColumnVectorToMatrix @ 0x1801D34AC
 * Callers:
 ...
 *     ?D3DXVectorAreCloseToZero@@YAHAEBUD2DVector3@@@Z @ 0x180207DCC (-D3DXVectorAreCloseToZero@@YAHAEBUD2DVector3@@@Z.c)
 */
