/*
 * XREFs of ?OnZeroReferenceCount@BamoPrincipalImpl@BamoImpl@Microsoft@@EEAAXXZ @ 0x180168CA0
 * Callers:
 *     <none>
 * Callees:
        ...
        Microsoft::BamoImpl::BamoPrincipalImpl *this)
{
  ...
  v1 = *((_QWORD *)this + 2);
  v3 = *(struct Microsoft::BamoImpl::BamoConnectionImpl **)(v1 + 24);
  if ( *((_QWORD *)v3 + 5) )
    Microsoft::BamoImpl::BamoConnectionImpl::RemovePrincipal(
      *(Microsoft::BamoImpl::BamoConnectionImpl **)(v1 + 24),
      *((_DWORD *)this + 6));
  ...
  Microsoft::BamoImpl::DropAndReacquireLock::DropAndReacquireLock((Microsoft::BamoImpl::DropAndReacquireLock *)&v14, v3);
