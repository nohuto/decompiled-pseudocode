/*
 * XREFs of ?OnSetPropertyValueError@BamoDataSourceProxy@@UEAAJI@Z @ 0x18016B680
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataSourceProxy::OnSetPropertyValueError(BamoDataSourceProxy *this, unsigned int a2)
{
  ...
  v4 = BamoImpl::BamoDataSourceProxyImpl::OnSetPropertyValueError((BamoDataSourceProxy *)((char *)this + 8), a2);
  if ( v6 )
