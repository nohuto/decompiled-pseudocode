/*
 * XREFs of ?FindSlotForData@CSparseStorage@@AEAAAEAVDataInfo@1@II@Z @ 0x1800384C8
 * Callers:
...
LABEL_13:
  ...
  v15 = (unsigned int)v8;
  v16 = v14 + v5 + 28;
  v17 = (char *)HeapReAlloc(WPF::g_processHeap, 0, v3, v16);
  if ( v17 )
  {
    *this = v17;
  }
  ...
  memset_0(&v17[v15], 0, v16 - v15);
  *(_DWORD *)*this = v16;
  result = (struct CSparseStorage::DataInfo *)&(*this)[v14];
