/*
 * XREFs of ?RecordIndependentFlipInfo@CCompositionSurfaceInfo@@QEAAJ_KI_N1IIPEA_N@Z @ 0x1801ACEA8
 * Callers:
        ...
        bool *a8)
{
  ...
  {
    v11 = v14 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14 | 0x10000000, 0x10Fu);
  }
  return v11;
}
