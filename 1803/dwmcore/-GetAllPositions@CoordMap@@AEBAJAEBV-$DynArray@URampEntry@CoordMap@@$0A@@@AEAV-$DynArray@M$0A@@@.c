/*
 * XREFs of ?GetAllPositions@CoordMap@@AEBAJAEBV?$DynArray@URampEntry@CoordMap@@$0A@@@AEAV?$DynArray@M$0A@@@MMM@Z @ 0x18000427C
 * Callers:
    ...
    for ( i = 1; i < *(_DWORD *)(a2 + 24); ++i )
    {
      ...
      if ( v13 < *v17 )
      {
                                                                               ...
                                                                               + 4LL * (unsigned int)(v21 - 1)))) & _xmm) )
        {
          ...
          if ( v22 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x10Du);
            return v19;
          }
          v15 = 0;
        }
        if ( !v15 && v17[1] != v17[2] && *(_DWORD *)(a3 + 24) > 1u )
        {
          ...
          if ( v23 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x116u);
            return v19;
          }
          v15 = 1;
        }
