/*
 * XREFs of ?ReportUsageToService@?$Feature@U__WilFeatureTraits_Feature_ForceNRE@@@wil@@CAX_NW4ReportingKind@2@_K@Z @ 0x1800BACC4
 * Callers:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_ForceNRE>::ReportUsageToService(
        __int64 a1,
        unsigned int a2,
        __int64 a3)
{
