/*
 * XREFs of ??_EDataProviderRegistrarConnection@@UEAAPEAXI@Z @ 0x1801530E0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a2)
{
  ...
  *(_QWORD *)this = &DataProviderRegistrarConnection::`vftable';
  Microsoft::BamoImpl::BamoConnectionImpl::~BamoConnectionImpl((DataProviderRegistrarConnection *)((char *)this + 8));
  if ( (a2 & 1) != 0 )
  {
    if ( (a2 & 4) != 0 )
