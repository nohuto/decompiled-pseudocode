/*
 * XREFs of ?UpdateFrameStatistics@CHolographicExclusiveView@@QEAAXPEBUDXGI_FRAME_STATISTICS@@@Z @ 0x1801FA3F0
 * Callers:
        ...
        const struct DXGI_FRAME_STATISTICS *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6 | 0x10000000, 0x203u);
  }
  else
  {
