/*
 * XREFs of ?Thunk_SetVector4Value_27@?$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016CC20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDataSourceProxy_Receive<BamoImpl::BamoDataSourceProxyImpl>::Thunk_SetVector4Value_27(
