/*
 * XREFs of ?TrimToStartAt@CTrimPathOperation@@AEAAXAEBUSegment@Path@@M@Z @ 0x18020C610
 * Callers:
 ...
 *     ?ShouldSplitCurrentSegment@CTrimPathOperation@@AEBA_NXZ @ 0x18020C0E0 (-ShouldSplitCurrentSegment@CTrimPathOperation@@AEBA_NXZ.c)
