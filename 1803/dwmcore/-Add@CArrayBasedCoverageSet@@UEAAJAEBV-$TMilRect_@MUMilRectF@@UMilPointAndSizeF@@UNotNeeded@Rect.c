/*
 * XREFs of ?Add@CArrayBasedCoverageSet@@UEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@HPEBVCMILMatrix@@@Z @ 0x180064C60
 * Callers:
...
__int64 __fastcall CArrayBasedCoverageSet::Add(__int64 a1, float *a2, int a3, CMILMatrix *a4)
{
  ...
  float v16; // [rsp+38h] [rbp-19h] BYREF
  float v17; // [rsp+3Ch] [rbp-15h]
  float v18; // [rsp+40h] [rbp-11h]
  float v19; // [rsp+44h] [rbp-Dh]
  int v20; // [rsp+48h] [rbp-9h]
  float v21; // [rsp+4Ch] [rbp-5h]
  float v22; // [rsp+50h] [rbp-1h]
  float v23; // [rsp+54h] [rbp+3h]
  float v24; // [rsp+58h] [rbp+7h]
  ...
  v19 = v8;
  v13 = DynArray<CZOrderedRect,0>::AddMultipleAndSet(a1 + 24, &v16);
  v14 = v13;
  if ( v13 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x3Eu);
  return v14;
}
