/*
 * XREFs of ?Initialize@CTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z @ 0x180029D40
 * Callers:
 ...
 *     ?Initialize@CDesktopTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z @ 0x18013FFC0 (-Initialize@CDesktopTreeData@@MEAAXPEAVCVisualTree@@PEAVCVisual@@@Z.c)
 * Callees:
 *     ?Initialize@CVisualOcclusionInfo@@MEAAXXZ @ 0x180029330 (-Initialize@CVisualOcclusionInfo@@MEAAXXZ.c)
...
void __fastcall CTreeData::Initialize(CTreeData *this, struct CVisualTree *a2, struct CVisual *a3)
{
  ...
  void (__fastcall *v5)(CVisualTreeData *); // rax
  void (*v6)(void); // rax
  ...
  *((_BYTE *)this + 212) = 0;
  ...
  v5 = *(void (__fastcall **)(CVisualTreeData *))(*(_QWORD *)this + 32LL);
