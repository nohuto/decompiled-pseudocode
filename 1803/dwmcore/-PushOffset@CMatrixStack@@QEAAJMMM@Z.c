/*
 * XREFs of ?PushOffset@CMatrixStack@@QEAAJMMM@Z @ 0x1801C8644
 * Callers:
 ...
 *     ?PrependTranslate@CMILMatrix@@QEAAXMMM@Z @ 0x18013EE28 (-PrependTranslate@CMILMatrix@@QEAAXMMM@Z.c)
 */
...
__int64 __fastcall CMatrixStack::PushOffset(CMatrixStack *this, float a2, float a3, float a4)
{
  ...
  if ( *(_DWORD *)this )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x6Eu);
    }
    else
    {
      ...
      v6 = v10;
      if ( v10 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x77u);
    }
  }
  else
  {
    ...
    v6 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x66u);
  }
  return v6;
}
