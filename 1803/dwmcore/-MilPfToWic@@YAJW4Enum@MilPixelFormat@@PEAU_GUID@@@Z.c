/*
 * XREFs of ?MilPfToWic@@YAJW4Enum@MilPixelFormat@@PEAU_GUID@@@Z @ 0x1801F65D4
 * Callers:
 *     ?GetPixelFormat@CBitmapColorKey@@UEAAJPEAU_GUID@@@Z @ 0x1801F5BB0 (-GetPixelFormat@CBitmapColorKey@@UEAAJPEAU_GUID@@@Z.c)
 *     ?GetPixelFormat@CBitmap@@UEAAJPEAU_GUID@@@Z @ 0x180200ED0 (-GetPixelFormat@CBitmap@@UEAAJPEAU_GUID@@@Z.c)
