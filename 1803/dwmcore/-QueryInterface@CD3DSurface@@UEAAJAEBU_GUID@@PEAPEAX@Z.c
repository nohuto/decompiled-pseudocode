/*
 * XREFs of ?QueryInterface@CD3DSurface@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801E4C50
 * Callers:
 *     ?QueryInterface@CD3DSurface@@WGA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DDEB0 (-QueryInterface@CD3DSurface@@WGA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1800DD420 (_guard_dispatch_icall_nop.c)
 *     ?QueryInterface@CD3DResource@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801E4390 (-QueryInterface@CD3DResource@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
 */
