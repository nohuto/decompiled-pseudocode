/*
 * XREFs of ??$emplace_back@I@?$vector@IV?$allocator@I@std@@@std@@QEAAX$$QEAI@Z @ 0x18021FC04
 * Callers:
...
__int64 __fastcall std::vector<unsigned int>::emplace_back<unsigned int>(const void **a1, _DWORD *a2)
{
  char *v2; // r14
  __int64 result; // rax
  __int64 v6; // r14
