/*
 * XREFs of ?GetTightBounds@CRectanglesShape@@UEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@@Z @ 0x180064200
 * Callers:
...
__int64 __fastcall CRectanglesShape::GetTightBounds(__int64 a1, __int64 a2, CMILMatrix *a3)
{
  int v3; // r9d
  CMILMatrix *v4; // r11
  __int64 v5; // rbx
