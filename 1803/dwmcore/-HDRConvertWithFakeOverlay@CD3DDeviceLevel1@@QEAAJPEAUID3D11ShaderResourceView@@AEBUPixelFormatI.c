/*
 * XREFs of ?HDRConvertWithFakeOverlay@CD3DDeviceLevel1@@QEAAJPEAUID3D11ShaderResourceView@@AEBUPixelFormatInfo@@0IIAEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@W4DXGI_MODE_ROTATION@@12PEAUID3D11RenderTargetView@@IIW4DXGI_COLOR_SPACE_TYPE@@M_NPEAUtagRECT@@@Z @ 0x1801E087C
 * Callers:
        ...
        __int64 a17)
{
  ...
  *(_QWORD *)&v33 = 2LL;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CompositingPixelShaderNoRef, 0xBB8u);
  }
  else
  {
    v24 = this[146];
    ...
    *((float *)&v40 + 1) = (float)a13;
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0xBBEu);
    }
    else
    {
      v27 = this[146];
