/*
 * XREFs of ?Lerp@CExpressionValueStack@@QEAAJXZ @ 0x1801B89C4
 * Callers:
...
LABEL_20:
  ...
  v3 = *((_QWORD *)this + 3);
  v4 = *(_DWORD *)(v3 + 80LL * (v1 - 3) + 72);
  v5 = *(float *)(v3 + 80LL * (v1 - 1));
  if ( *(_DWORD *)(v3 + 80LL * (v1 - 1) + 72) != 18 || (v6 = 0, v4 != *(_DWORD *)(v3 + 80LL * (v1 - 2) + 72)) )
  {
    v50 = 3066;
    goto LABEL_20;
  }
  switch ( v4 )
  {
    ...
    case 52:
      ...
      *(float *)(v3 + 80LL * (v1 - 3) + 8) = (float)(v43 * v42) + v55;
      break;
    case 69:
      ...
      *((float *)&v52 + 3) = (float)((float)(_mm_shuffle_ps(v34, v34, 255).m128_f32[0] - v35.m128_f32[0]) * v36)
                           + v35.m128_f32[0];
      *(_OWORD *)(v3 + 80LL * (v1 - 3)) = v52;
      break;
    case 104:
      v27 = *(__m128 *)(v3 + 80LL * (v1 - 3));
      v28 = *(__m128 *)(v3 + 80LL * (v1 - 2));
      v29 = v28;
      v56 = *(_QWORD *)(v3 + 80LL * (v1 - 3) + 16);
      *(_QWORD *)v61 = *(_QWORD *)(v3 + 80LL * (v1 - 2) + 16);
      v30 = fmaxf(0.0, fminf(v5, 1.0));
      ...
      *(_QWORD *)(v3 + 80LL * (v1 - 3) + 16) = _mm_unpacklo_ps(v32, v33).m128_u64[0];
      break;
    case 265:
      v7 = *(__m128 *)(v3 + 80LL * (v1 - 3));
      v8 = *(__m128 *)(v3 + 80LL * (v1 - 2));
      v9 = *(__m128 *)(v3 + 80LL * (v1 - 3) + 16);
      v10 = *(__m128 *)(v3 + 80LL * (v1 - 2) + 16);
      v11 = *(__m128 *)(v3 + 80LL * (v1 - 2) + 32);
      v12 = *(__m128 *)(v3 + 80LL * (v1 - 3) + 32);
      v13 = *(__m128 *)(v3 + 80LL * (v1 - 3) + 48);
      v14 = *(__m128 *)(v3 + 80LL * (v1 - 2) + 48);
      v15 = fmaxf(0.0, fminf(v5, 1.0));
