/*
 * XREFs of ?CopyTexture@CD3DDeviceLevel1@@QEAAJPEAUID3D11Texture2D@@IAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAVIBitmapDest@@@Z @ 0x18000D180
 * Callers:
...
__int64 __fastcall CD3DDeviceLevel1::CopyTexture(__int64 a1, struct IUnknown *a2, __int64 a3, int *a4, __int64 a5)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v11, 0xCABu);
    goto LABEL_12;
  }
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v14, 0xCC5u);
    goto LABEL_12;
  }
  v32 = v52;
  v33 = 0LL;
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v15, 0xCE2u);
  }
  else
  {
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v18, 0xCFDu);
    }
    else
    {
...
LABEL_7:
        ...
        if ( v20 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v20, 0xD10u);
        }
        else
        {
          ...
          if ( v21 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v21, 0xD11u);
          }
          else
          {
            ...
            v12 = v22;
            if ( v22 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v22, 0xD24u);
          }
        }
        goto LABEL_11;
      }
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v25, 0xD0Bu);
    }
  }
LABEL_11:
  (*(void (__fastcall **)(_QWORD, __int64, _QWORD))(**(_QWORD **)(a1 + 656) + 120LL))(*(_QWORD *)(a1 + 656), v26, 0LL);
LABEL_12:
  v23 = CD3DDeviceLevel1::TranslateDXGIorD3DErrorInContext(a1, v12, 0LL);
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v27);
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v29);
  Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v28);
  Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease(&v26);
