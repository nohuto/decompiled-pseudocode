/*
 * XREFs of ?RemoveAllLights@CVisual@@QEAAXXZ @ 0x18004E184
 * Callers:
...
void __fastcall CVisual::RemoveAllLights(CVisual *this)
{
  ...
  if ( (_DWORD)v4 )
  {
    ...
    do
    {
      v10 = CPtrArrayBase::operator[]((char *)this + 280, v8);
      (*(void (__fastcall **)(__int64, CVisual *))(*(_QWORD *)v10 + 208LL))(v10, this);
      ++v8;
      --v9;
    }
    while ( v9 );
    CPtrArrayBase::Clear((CVisual *)((char *)this + 280));
  }
