/*
 * XREFs of ?SetProperty@CSurfaceBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A5C10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSurfaceBrush::SetProperty(CResource *a1, int a2, int a3, struct _D3DCOLORVALUE *a4)
{
  ...
  v10[0] = 2LL;
  v10[1] = &CSurfaceBrush::k_rgAnimDef;
