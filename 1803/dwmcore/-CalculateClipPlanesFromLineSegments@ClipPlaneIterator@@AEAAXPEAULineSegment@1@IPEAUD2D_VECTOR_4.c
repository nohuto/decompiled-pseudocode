/*
 * XREFs of ?CalculateClipPlanesFromLineSegments@ClipPlaneIterator@@AEAAXPEAULineSegment@1@IPEAUD2D_VECTOR_4F@@@Z @ 0x18017326C
 * Callers:
        ...
        struct D2D_VECTOR_4F *a4)
{
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      v23 = v10 - v20;
      if ( (float)((float)(v23 * v19) + (float)(v21 * v22)) <= 0.0 )
        v24 = FLOAT_1_0;
      else
        v24 = FLOAT_N1_0;
