/*
 * XREFs of ?DrawRectangle@CDrawingContext@@UEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCLegacyMilBrush@@PEAV?$TValueResource@UMilRectF@@UMILCMD_RECTRESOURCE@@$0HF@@@@Z @ 0x18006E170
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  int v11; // eax
  __m128i v13; // [rsp+30h] [rbp-98h] BYREF
  ...
  if ( a4 )
  {
    if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)a4 + 48LL))(a4, 117LL) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x3B7u);
      return v10;
    }
  ...
  if ( !(unsigned __int8)IsRectEmptyOrInvalid(&v13) )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x3C3u);
