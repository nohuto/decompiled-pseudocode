/*
 * XREFs of McTemplateU0dtxxxx @ 0x1801496B8
 * Callers:
...
ULONG __fastcall McTemplateU0dtxxxx(__int64 a1, __int64 a2, int a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v20 = &a8;
  v21 = 8LL;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_PROGRESS_BASED_PPM_HINT, 7u, &v9);
}
