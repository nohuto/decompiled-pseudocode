/*
 * XREFs of ?SetAdvancedDirectFlipState@CDxHandleAdvancedDirectFlipBitmapRealization@@UEAAJPEAVIRenderTargetBitmap@@PEAVIRenderTargetDisplay@@PEAVCRegionWrapper@@@Z @ 0x180214910
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CRegionWrapper *a4)
{
  ...
  *((_QWORD *)this + 1) = a2;
  ...
  v11 = v10;
  if ( v10 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0xCCu);
  else
    *((_BYTE *)this + 32) = 1;
  return v11;
}
