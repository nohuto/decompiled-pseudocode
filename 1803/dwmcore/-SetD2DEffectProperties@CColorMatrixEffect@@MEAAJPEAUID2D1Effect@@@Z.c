/*
 * XREFs of ?SetD2DEffectProperties@CColorMatrixEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1801B1830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorMatrixEffect::SetD2DEffectProperties(CColorMatrixEffect *this, struct ID2D1Effect *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x43u);
  }
  else
  {
    ...
    if ( v6 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x48u);
    }
    else
    {
