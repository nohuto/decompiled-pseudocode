/*
 * XREFs of ?InsertHW@CDrawListEntryBuilder@@AEAAJUPrimitiveGeometryDesc@@PEBUPrimitiveVertexAttributesDesc@@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x1800AF0D0
 * Callers:
 ...
 *     ?EstimatedArea@CDrawListEntryBuilder@@CAMAEBUD2D_RECT_F@@PEBUD2D_MATRIX_3X2_F@@@Z @ 0x1800C2148 (-EstimatedArea@CDrawListEntryBuilder@@CAMAEBUD2D_RECT_F@@PEBUD2D_MATRIX_3X2_F@@@Z.c)
 */
...
__int64 __fastcall CDrawListEntryBuilder::InsertHW(__int64 a1, __int64 a2, __int64 a3, D2DMatrixHelper *a4)
{
    ...
    && CDrawListEntryBuilder::EstimatedArea((const struct D2D_RECT_F *)a2, (const struct D2D_MATRIX_3X2_F *)a4) > (float)(int)CCommonRegistryData::m_dwMegaRectSize )
  {
    if ( (v14 = *(CCpuClip **)(a1 + 16), !*(_QWORD *)v14) && !*((_QWORD *)v14 + 2)
      || CCpuClip::IsAxisAlignedRectangle(v14) && (!a4 || D2DMatrixHelper::Is2DAxisAlignedPreserving(a4, v18)) )
    {
      if ( *(_DWORD *)(a1 + 2376) )
      {
