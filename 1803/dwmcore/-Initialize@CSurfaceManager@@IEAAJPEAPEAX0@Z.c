/*
 * XREFs of ?Initialize@CSurfaceManager@@IEAAJPEAPEAX0@Z @ 0x18001FFD0
 * Callers:
...
__int64 __fastcall CSurfaceManager::Initialize(CSurfaceManager *this, void **a2, void **a3)
{
  ...
  qword_1802D6440 = this;
  qword_1802D6760 = this;
  SetLastError(0);
...
LABEL_15:
    v13 = v10;
LABEL_19:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, dwNumberOfBytesToMap);
    return (unsigned int)v10;
  }
  SetLastError(0);
  v8 = MapViewOfFile(*((HANDLE *)this + 64), 4u, 0, 0, *((_QWORD *)this + 66));
  if ( !v8 )
  {
    v14 = GetLastError();
    v10 = v14;
