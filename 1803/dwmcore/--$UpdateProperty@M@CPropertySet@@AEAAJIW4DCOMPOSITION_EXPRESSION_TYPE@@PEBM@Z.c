/*
 * XREFs of ??$UpdateProperty@M@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBM@Z @ 0x180038D8C
 * Callers:
...
__int64 __fastcall CPropertySet::UpdateProperty<float>(__int64 a1)
{
  ...
  if ( (unsigned __int8)PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::IsValidPropertyId(a1 + 80)
    && *(_DWORD *)(*v1 + 8 * v4) == v2 )
  {
    *(_DWORD *)((*(_DWORD *)(*v1 + 8 * v4 + 4) & 0x1FFFFFFF) + v1[4]) = *(_DWORD *)v3;
    v6 = CPropertySet::PropertyUpdated<float>(v5, v4, 1u, v3);
    v7 = v6;
    if ( v6 < 0 )
