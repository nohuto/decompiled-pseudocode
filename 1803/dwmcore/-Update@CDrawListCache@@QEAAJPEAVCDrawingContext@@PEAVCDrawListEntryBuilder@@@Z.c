/*
 * XREFs of ?Update@CDrawListCache@@QEAAJPEAVCDrawingContext@@PEAVCDrawListEntryBuilder@@@Z @ 0x18009BE84
 * Callers:
        ...
        struct CDrawListEntryBuilder *a3)
{
  ...
  v5 = CDrawListCache::Update(
         ...
         *((_DWORD *)a3 + 26) != 0);
  if ( v5 >= 0 && *((char *)this + 96) < 0 )
  {
    v8 = 0;
    CMatrixStack::Top((struct CDrawingContext *)((char *)a2 + 480), (struct CMILMatrix *)v7);
    CMILMatrix::Get2DScaleDimensions((CMILMatrix *)v7, (float *)this + 15, (float *)this + 16);
  }
