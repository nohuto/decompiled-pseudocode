/*
 * XREFs of ?GetShaderLinkingBody@CommonRenderingShaderBody@@YA?AUShaderLinkingBody@@W4Enum@1@W4D3DShaderProfileVersion@@@Z @ 0x1800C5F64
 * Callers:
 ...
 * Callees:
 *     GetInputs @ 0x1800C5FF8 (GetInputs.c)
 */
