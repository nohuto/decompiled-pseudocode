        ...
        _QWORD **a4)
{
  ...
  v7 = **(_QWORD **)(a1 + 8);
  v8 = *(__int64 **)(v7 + 8);
  v9 = std::_List_alloc<std::_List_base_types<std::pair<IRenderTarget * const,Microsoft::WRL::ComPtr<CRenderTargetImageSource>>>>::_Buynode0(
         a1,
         v7,
         v8);
  *(_QWORD *)(v9 + 16) = **a4;
