/*
 * XREFs of ?Construct@AdapterInfo@CSurfaceManager@@QEAAXPEAVCDXGIAdapterLimited@@PEAVCD3DDeviceManager@@@Z @ 0x180020744
 * Callers:
  ...
  *(struct _LUID *)this = v3;
  if ( (int)CD3DDeviceManager::GetExistingDevice(a3, v3, &v6) >= 0 )
  {
    ...
    *((_QWORD *)this + 1) = CD3DDeviceLevel1::OpenRenderFence(v6);
    if ( v5 )
      CMILPoolResource::Release((CD3DDeviceLevel1 *)((char *)v5 + 472));
  }
}
