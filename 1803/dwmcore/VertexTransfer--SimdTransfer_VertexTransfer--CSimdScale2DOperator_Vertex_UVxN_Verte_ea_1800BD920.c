/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____1_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1800BD920
 * Callers:
        ...
        unsigned int *a2)
{
  ...
  if ( v5 )
  {
    do
    {
      ...
      if ( (_mm_movemask_ps(_mm_cmpeq_ps(v20, *(__m128 *)&DirectX::g_XMZero)) & 3) != 3 )
      {
      ...
      *v18 = _mm_shuffle_ps(
      ...
      result = (__m128 *)(_mm_movemask_ps(_mm_cmpeq_ps(v33, *(__m128 *)&DirectX::g_XMZero)) & 3);
      if ( (_BYTE)result != 3 )
      {
