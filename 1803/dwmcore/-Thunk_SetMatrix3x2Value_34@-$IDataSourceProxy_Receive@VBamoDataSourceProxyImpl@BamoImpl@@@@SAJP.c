/*
 * XREFs of ?Thunk_SetMatrix3x2Value_34@?$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016CA50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDataSourceProxy_Receive<BamoImpl::BamoDataSourceProxyImpl>::Thunk_SetMatrix3x2Value_34(
        __int64 a1,
        unsigned int **a2)
{
  int *v3; // rsi
  ...
  v5 = (*(__int64 (__fastcall **)(__int64, _QWORD, int *))(*(_QWORD *)(a1 - 16) + 120LL))(a1 - 16, v4, v3);
  v6 = v9;
  v7 = v5;
  if ( v9 )
  {
