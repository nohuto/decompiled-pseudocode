/*
 * XREFs of ?Create@CFilterEffectLayer@@SAJPEAVIRenderTarget@@AEBUMilPointAndSizeL@@PEAVCFilterEffect@@PEBVCVisual@@AEBUMilPointAndSizeF@@PEAPEAV1@@Z @ 0x180175B7C
 * Callers:
        ...
        struct CFilterEffectLayer **a6)
{
  ...
  struct _LUID v29; // [rsp+70h] [rbp-19h] BYREF
  ...
  *a6 = 0LL;
  ...
  if ( v16 )
    v14 = 1;
  HIDWORD(v27) = v14;
  v18 = (*(__int64 (__fastcall **)(struct IRenderTarget *, struct _LUID *, int *))(v17 + 136))(a1, &v29, &v25);
  v19 = v18;
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x24u);
  }
  else
  {
    if ( (int)CFilterEffect::ContainEffectInChainInputs(a3, 57LL) < 0
      && (int)CFilterEffect::ContainEffectInChainInputs(a3, 129LL) < 0 )
    {
      v15 = 0;
    }
    v31 = 46;
    v30 = "DWM Scratch Rendertarget (filter effect layer)";
    v20 = (*(__int64 (__fastcall **)(struct IRenderTarget *))(*(_QWORD *)a1 + 160LL))(a1);
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, RenderTargetBitmap, 0x35u);
      v6 = v26;
    }
    else
    {
      ...
      *a6 = v23;
      ...
      {
        v19 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x3Bu);
      }
    }
  }
