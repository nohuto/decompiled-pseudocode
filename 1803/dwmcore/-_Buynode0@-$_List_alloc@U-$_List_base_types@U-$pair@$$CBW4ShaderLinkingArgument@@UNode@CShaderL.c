        ...
        _QWORD *a3)
{
  ...
  result = (_QWORD *)std::_Allocate<std::_Default_allocate_traits<1>>(1uLL, 0x28uLL);
  if ( !a2 )
  {
    a2 = result;
    a3 = result;
