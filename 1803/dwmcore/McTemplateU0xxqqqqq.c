/*
 * XREFs of McTemplateU0xxqqqqq @ 0x1801AD4A4
 * Callers:
...
ULONG McTemplateU0xxqqqqq(__int64 a1, __int64 a2, ...)
{
  struct _EVENT_DATA_DESCRIPTOR v3; // [rsp+20h] [rbp-61h] BYREF
