/*
 * XREFs of ?SignalSEB@CHwndRenderTarget@@AEAAX_NI@Z @ 0x18013BD28
 * Callers:
...
void __fastcall CHwndRenderTarget::SignalSEB(CHwndRenderTarget *this, char a2, unsigned int a3)
{
  ...
  updated = 0;
  v5 = (struct _SEB_RPC_PUBLISH_DATA *)*((_QWORD *)this + 109);
  v7 = a3 > 0xC8;
  if ( v5 && *((_BYTE *)this + 856) != v7 )
    PubSebiUpdateLevelEventRpc(v5, a3 > 0xC8);
  v9 = (struct _SEB_RPC_PUBLISH_DATA *)*((_QWORD *)this + 108);
  if ( v9 )
  {
    if ( *((_BYTE *)this + 855) == a2 )
      goto LABEL_8;
