/*
 * XREFs of ?SetD2DEffectProperties@CLinearTransferEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1801B3830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLinearTransferEffect::SetD2DEffectProperties(CLinearTransferEffect *this, struct ID2D1Effect *a2)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x38u);
      }
      else
      {
        ...
        if ( v8 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x3Du);
        }
        else
        {
          ...
          if ( v9 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x42u);
          }
          else
          {
            ...
            if ( v10 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x47u);
            }
            else
            {
              ...
              if ( v11 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x4Cu);
              }
              else
              {
                ...
                if ( v12 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x51u);
                }
                else
                {
                  ...
                  else
                  {
                    ...
                    if ( v14 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x5Bu);
                    }
                    else
                    {
                      ...
                      if ( v15 < 0 )
                      {
                        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v15, 0x60u);
                      }
                      else
                      {
                        ...
                        if ( v16 < 0 )
                        {
                          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x65u);
                        }
                        else
                        {
                          ...
                          v5 = v17;
                          if ( v17 < 0 )
                            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x6Au);
                        }
                      }
                    }
                  }
