/*
 * XREFs of ?SetAdvancedDirectFlipState@CCompositionSurfaceInfo@@QEAAJPEAVIRenderTargetDisplay@@PEAVCRegionWrapper@@@Z @ 0x1801ACFE0
 * Callers:
        ...
        struct CRegionWrapper *a3)
{
         ...
         &v15) >= 0 )
  {
    ...
    if ( !*((_QWORD *)this + 16) )
    {
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0xAAu);
        goto LABEL_10;
      }
      v9 = (*(__int64 (__fastcall **)(unsigned __int64, __int64))(*(_QWORD *)a2 + 400LL))(a2, v14[0]);
      if ( !v9 )
      {
        ...
        if ( v11 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0xB4u);
          goto LABEL_10;
        }
      }
    }
    ...
    v6 = v12;
    if ( v12 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0xBAu);
  }
LABEL_10:
  if ( v15 )
    (*(void (__fastcall **)(__int64))(*(_QWORD *)v15 + 16LL))(v15);
  ReleaseInterfaceNoNULL<IWICBitmap>(v14[0]);
  return v6;
}
