/*
 * XREFs of ?GetCache@CHwBitmapCache@@SAJPEAVCD3DDeviceLevel1@@PEAVIBitmapSource@@_NPEAPEAV1@@Z @ 0x1800CBF30
 * Callers:
...
LABEL_28:
  ...
  if ( v13 )
  {
    ...
    {
      if ( v8 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x2F5u);
      goto LABEL_14;
    }
    if ( v8 >= 0 )
    {
