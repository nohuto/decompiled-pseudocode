/*
 * XREFs of ?RemoveUnbackedSurfaces@COverlayContext@@CAXAEAV?$DynArray@PEAVOverlayPlaneInfo@COverlayContext@@$0A@@@@Z @ 0x1800C8F00
 * Callers:
...
void __fastcall COverlayContext::RemoveUnbackedSurfaces(__int64 a1)
{
  ...
  for ( i = 0LL; (unsigned int)i < v1; i = (unsigned int)(i + 1) )
  {
    ...
    if ( *(_BYTE *)(v4 + 177) && *(_BYTE *)(v4 + 181) )
    {
      ...
      {
LABEL_10:
        DynArray<CTelemetryTouchLatencyAnalysis::TouchUpdateInfo *,0>::RemoveAt(a1, (unsigned int)i);
        LODWORD(i) = i - 1;
      }
    }
    v1 = *(_DWORD *)(a1 + 24);
