/*
 * XREFs of ??0CMILBrushBitmap@@IEAA@PEAVCMILFactory@@@Z @ 0x18001DAD4
 * Callers:
 *     ?UpdateRenderTargetState@CDrawingContext@@AEAAJXZ @ 0x180067410 (-UpdateRenderTargetState@CDrawingContext@@AEAAJXZ.c)
 *     ??0CTileLegacyMilBrush@@IEAA@PEAVCComposition@@@Z @ 0x1800B82B0 (--0CTileLegacyMilBrush@@IEAA@PEAVCComposition@@@Z.c)
