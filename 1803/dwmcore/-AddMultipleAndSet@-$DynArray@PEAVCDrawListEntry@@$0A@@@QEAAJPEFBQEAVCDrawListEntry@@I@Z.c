/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@PEAVCDrawListEntry@@$0A@@@QEAAJPEFBQEAVCDrawListEntry@@I@Z @ 0x1800BCD5C
 * Callers:
...
__int64 __fastcall DynArray<CDrawListEntry *,0>::AddMultipleAndSet(__int64 a1, _QWORD *a2)
{
  unsigned int v2; // eax
  unsigned int v3; // r8d
  unsigned int v4; // ebx
  ...
  {
    v6 = DynArrayImpl<0>::AddMultipleAndSet(a1, 8u, 1, a2);
    v4 = v6;
    if ( v6 < 0 )
