/*
 * XREFs of ?ProcessSetScale@CComponentTransform3D@@QEAAJPEAVCResourceTable@@PEBUMILCMD_COMPONENTTRANSFORM3D_SETSCALE@@@Z @ 0x18002BA04
 * Callers:
        ...
        const struct MILCMD_COMPONENTTRANSFORM3D_SETSCALE *a3)
{
  ...
  return CResource::SetPropertyImpl(
           this,
           (const struct AnimationHelper::AnimatedProperty *)&CComponentTransform3D::sc_Scale,
           v5);
}
