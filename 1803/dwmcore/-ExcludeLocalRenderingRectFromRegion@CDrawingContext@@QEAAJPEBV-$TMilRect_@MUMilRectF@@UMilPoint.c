/*
 * XREFs of ?ExcludeLocalRenderingRectFromRegion@CDrawingContext@@QEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCMILMatrix@@PEAUHRGN__@@@Z @ 0x180160F94
 * Callers:
      ...
      if ( *((_DWORD *)qword_1802D6428 + 18) )
      {
        ...
        if ( RectRgn )
        {
          ...
          if ( !CombineRgn(a4, a4, RectRgn, 4) )
          {
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x1E4Fu);
          }
        ...
        else
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x1E4Au);
        }
      }
    }
  }
