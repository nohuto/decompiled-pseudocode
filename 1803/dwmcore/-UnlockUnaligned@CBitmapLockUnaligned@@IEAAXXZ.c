/*
 * XREFs of ?UnlockUnaligned@CBitmapLockUnaligned@@IEAAXXZ @ 0x180201A94
 * Callers:
 *     ??1CBitmapLockUnaligned@@UEAA@XZ @ 0x180201714 (--1CBitmapLockUnaligned@@UEAA@XZ.c)
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x18007312C (--3@YAXPEAX@Z.c)
 *     ?WriteUnalignedScanline@@YAXPEAEPEBEII@Z @ 0x180201B24 (-WriteUnalignedScanline@@YAXPEAEPEBEII@Z.c)
 */
