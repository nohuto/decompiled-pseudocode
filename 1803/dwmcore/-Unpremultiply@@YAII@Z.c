/*
 * XREFs of ?Unpremultiply@@YAII@Z @ 0x18020509C
 * Callers:
 *     ?AlphaDivide_32bppPARGB@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x180203C70 (-AlphaDivide_32bppPARGB@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z.c)
 * Callees:
 *     <none>
 */
