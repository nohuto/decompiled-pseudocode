/*
 * XREFs of ?SetScalarProperty@CNaturalAnimation@@AEAAJIM@Z @ 0x18019D498
 * Callers:
...
LABEL_19:
  ...
  v3 = -2147024809;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x3E4u);
  return v3;
}
