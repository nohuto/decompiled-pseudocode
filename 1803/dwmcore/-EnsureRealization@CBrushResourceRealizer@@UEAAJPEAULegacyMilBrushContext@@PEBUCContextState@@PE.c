/*
 * XREFs of ?EnsureRealization@CBrushResourceRealizer@@UEAAJPEAULegacyMilBrushContext@@PEBUCContextState@@PEBUPixelFormatInfo@@@Z @ 0x1801C22C0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct PixelFormatInfo *a4)
{
  ...
  *(_OWORD *)((char *)a2 + 120) = _xmm;
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, BrushRealizationNoRef, 0x92u);
  }
  else
  {
