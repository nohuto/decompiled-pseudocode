/*
 * XREFs of ?Scribble@CSuperWetInkScribble@@UEAAJPEAUID3D12GraphicsCommandList@@PEAUID3D12Resource@@PEAW4D3D12_RESOURCE_STATES@@PEAUComputeScribbleLatencyData@@PEAUtagRECT@@@Z @ 0x18017CB20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSuperWetInkScribble::Scribble(
        ...
        struct tagRECT *a6)
{
  ...
  v10 = CSuperWetInkScribble::ConsumeTipPoints(this);
  if ( v10 < 0 )
  {
    v11 = 48LL;
LABEL_3:
