/*
 * XREFs of ?GetDestLightsArray@CLightStack@@AEBAJPEAVCVisual@@PEBVCVisualTree@@_N2AEAV?$DynArrayIANoCtor@PEAVCCompositionLight@@$02$0A@@@PEA_N@Z @ 0x18013FD94
 * Callers:
...
LABEL_36:
    ...
    if ( !a5 )
    {
      if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v20 + 48LL))(v20, 28LL) )
      {
LABEL_34:
        if ( v7 )
          *v7 = 0;
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v20 + 200LL))(v20)
      && (*(unsigned __int8 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v26 + 192LL))(v26, a3, a2) )
    {
