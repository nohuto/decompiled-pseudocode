/*
 * XREFs of ?Iterate@RawUsageIndex@details_abi@wil@@QEBA_NV?$function@$$A6A_NPEAX_K01I@Z@wistd@@@Z @ 0x180057D08
 * Callers:
            ...
            *(unsigned __int8 **)(a1 + 32)) )
  {
    ...
    if ( v13 )
    {
                ...
                *(unsigned __int8 **)(a1 + 32)) )
      {
        ...
        if ( !v6 )
          __fastfail(7u);
        if ( !(*(unsigned __int8 (__fastcall **)(__int64, __int64 *, __int64 *, __int64 *, __int64 *, int *))(*(_QWORD *)v6 + 16LL))(
                v6,
                &v10,
                &v9,
                &v8,
