/*
 * XREFs of ?SetProperty@CCompositionAmbientLight@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180183370
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionAmbientLight::SetProperty(CResource *a1, int a2, int a3, struct _D3DCOLORVALUE *a4)
{
  ...
  v10[0] = 2LL;
  v10[1] = &CCompositionAmbientLight::k_rgAnimDef;
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v8 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x6Bu);
  }
  else
  {
    v8 = -2147024809;
