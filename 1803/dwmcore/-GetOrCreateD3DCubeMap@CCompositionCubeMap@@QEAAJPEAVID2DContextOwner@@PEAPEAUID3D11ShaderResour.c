/*
 * XREFs of ?GetOrCreateD3DCubeMap@CCompositionCubeMap@@QEAAJPEAVID2DContextOwner@@PEAPEAUID3D11ShaderResourceView@@@Z @ 0x180183778
 * Callers:
        ...
        struct ID3D11ShaderResourceView **a3)
{
  ...
  CD3DDeviceLevel1 *v20; // [rsp+38h] [rbp-71h] BYREF
  ...
  *a3 = 0LL;
  ...
  if ( ExistingDevice < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ExistingDevice, 0x124u);
    goto LABEL_12;
  }
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, CurrentRenderingRealization, 0x127u);
    goto LABEL_17;
  }
  ...
  *(_QWORD *)&v22 = "DWM Composition Cube Map";
  ...
  if ( Texture < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Texture, 0x150u);
    goto LABEL_17;
  }
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x158u);
    goto LABEL_17;
  }
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x15Au);
LABEL_17:
