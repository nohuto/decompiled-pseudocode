/*
 * XREFs of ?GetNotifiedWorldUpVector@CVisual@@QEBA?AUVector3@Numerics@Foundation@Windows@@XZ @ 0x1801A79B0
 * Callers:
...
__int64 __fastcall CVisual::GetNotifiedWorldUpVector(__int64 a1, __int64 a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 216);
  if ( (*(_DWORD *)(v2 + 4) & 0x200) != 0 )
  {
    for ( i = v2 + 12; (*(_DWORD *)i & 0x7F000000) != 0x17000000; i += (*(_DWORD *)i & 0xFFFFFF) + 4LL )
      ;
