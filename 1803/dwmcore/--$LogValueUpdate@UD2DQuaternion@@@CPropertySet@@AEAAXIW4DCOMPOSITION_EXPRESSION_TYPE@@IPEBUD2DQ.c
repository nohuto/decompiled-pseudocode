/*
 * XREFs of ??$LogValueUpdate@UD2DQuaternion@@@CPropertySet@@AEAAXIW4DCOMPOSITION_EXPRESSION_TYPE@@IPEBUD2DQuaternion@@@Z @ 0x1801A2930
 * Callers:
        ...
        unsigned __int8 *a5)
{
  ...
  const void *retaddr; // [rsp+1C8h] [rbp+C8h]
