/*
 * XREFs of ?SetTimespanProperty@CNaturalAnimation@@AEAAJIAEBUTimeSpan@@@Z @ 0x18019D6AC
 * Callers:
...
__int64 __fastcall CNaturalAnimation::SetTimespanProperty(CNaturalAnimation *this, int a2, const struct TimeSpan *a3)
{
  ...
  {
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x438u);
  }
  return v4;
}
