/*
 * XREFs of ??0CDrawingContext@@AEAA@PEAVCComposition@@@Z @ 0x18006E7D0
 * Callers:
...
CDrawingContext *__fastcall CDrawingContext::CDrawingContext(CDrawingContext *this, struct CComposition *a2)
{
  ...
  *((_QWORD *)this + 831) = (char *)this + 6648;
  wil::Feature<__WilFeatureTraits_Feature_ProjectedShadow>::ReportUsageToService((char *)this + 6648, v6);
  result = this;
  *((_BYTE *)this + 6832) = 0;
  return result;
}
