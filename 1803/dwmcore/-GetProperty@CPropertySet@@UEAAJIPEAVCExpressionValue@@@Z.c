/*
 * XREFs of ?GetProperty@CPropertySet@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180039CA0
 * Callers:
...
__int64 __fastcall CPropertySet::GetProperty(CPropertySet *this, unsigned int a2, struct CExpressionValue *a3)
{
  ...
  if ( v5 != 18 )
  {
    switch ( v5 )
    {
      ...
      case 52:
        v17 = *((_QWORD *)this + 14);
        v18 = *(_DWORD *)(v4 + 8 * v3 + 4) & 0x1FFFFFFF;
        *((_DWORD *)a3 + 18) = 52;
        *(_QWORD *)a3 = *(_QWORD *)(v18 + v17);
        *((_DWORD *)a3 + 2) = *(_DWORD *)(v18 + v17 + 8);
        result = 0LL;
        *((_BYTE *)a3 + 76) = 1;
        return result;
      case 69:
