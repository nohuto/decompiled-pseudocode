/*
 * XREFs of ?Thunk_SetQuaternionValue_27@?$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016CB50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDataSourceProxy_Receive<BamoImpl::BamoDataSourceProxyImpl>::Thunk_SetQuaternionValue_27(
