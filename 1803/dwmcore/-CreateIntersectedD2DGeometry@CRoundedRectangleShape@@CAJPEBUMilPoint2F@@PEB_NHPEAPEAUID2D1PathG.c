/*
 * XREFs of ?CreateIntersectedD2DGeometry@CRoundedRectangleShape@@CAJPEBUMilPoint2F@@PEB_NHPEAPEAUID2D1PathGeometry@@@Z @ 0x18020CF3C
 * Callers:
        ...
        struct ID2D1PathGeometry **a4)
{
  ...
  for ( i = 1; v7 > 0; ++a2 )
  {
    if ( *a2 )
    {
      v11 = CRoundedRectangleShape::IntersectGeometryBuilder(a1, &dword_1802AEA40[7 * v5], a4, i);
      v4 = v11;
      if ( v11 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x13Fu);
        return v4;
      }
      i = 0;
      --v7;
