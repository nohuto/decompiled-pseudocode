/*
 * XREFs of ?ProcessSetStrokeBrush@CSpriteVectorShape@@QEAAJPEAVCResourceTable@@PEBUMILCMD_SPRITEVECTORSHAPE_SETSTROKEBRUSH@@@Z @ 0x1801A5014
 * Callers:
...
LABEL_9:
    ...
    {
      v4 = -2003303421;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003303421, 0x7Eu);
      return v4;
    }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x81u);
  }
  return v4;
}
