/*
 * XREFs of ?Create@CWarpLockSubresource@@SAJPEAVCD3DVidMemOnlyTexture@@PEAPEAV1@@Z @ 0x1801EDFB0
 * Callers:
...
__int64 __fastcall CWarpLockSubresource::Create(struct CD3DVidMemOnlyTexture *this, struct CWarpLockSubresource **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v6 )
  {
    ...
    if ( DXGIResource < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1802ADFF8, 1u, DXGIResource, 0x25u);
    }
    else
    {
      ...
      v8 = v9;
      if ( v9 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1802ADFF8, 1u, v9, 0x2Du);
    }
    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)&v11);
  }
  else
