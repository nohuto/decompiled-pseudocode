/*
 * XREFs of ??2CRemoteAppRenderTarget@@KAPEAX_K@Z @ 0x18016DD58
 * Callers:
...
void *__fastcall CRemoteAppRenderTarget::operator new()
{
  void *result; // rax
  const void *retaddr; // [rsp+28h] [rbp+0h]

  result = WPF::ProcessHeapImpl::AllocClear(0x138uLL);
  if ( !result )
