/*
 * XREFs of ?CopyLeftToRightBuffer@CHwStereoFullScreenRenderTarget@@UEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x1801F0FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHwStereoFullScreenRenderTarget::CopyLeftToRightBuffer(struct tagPOINT a1, float *a2, float *a3)
{
  ...
  p_rect = 0LL;
  nCount = 0;
  if ( (int)CHwDisplayRenderTarget::ValidateDeviceAndSwapChain((CHwDisplayRenderTarget *)(*(_QWORD *)&a1 - 600LL)) < 0
    || !CHwDisplayRenderTarget::RectToSurfaceRect(v3, a2, &rect.left) )
  {
    return (unsigned int)v4;
  }
  if ( !CHwDisplayRenderTarget::RectToSurfaceRect(v3, v42, &v44.left) )
  {
    p_rect = (char *)&rect;
    nCount = 1;
    goto LABEL_28;
  ...
  if ( v41 )
  {
    ...
    if ( v18 != 1 )
    {
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x124u);
        v6 = v40;
        goto LABEL_38;
      }
      v6 = v40;
...
LABEL_28:
    ...
    if ( nCount )
    {
      ...
      do
      {
        v27 = *(struct CD3DSurface **)(*(_QWORD *)&v25 + 32LL);
        v28 = v24 - 1;
        v29 = *(struct CD3DSurface **)(*(_QWORD *)&v25 + 16LL);
        v30 = *(CD3DDeviceLevel1 **)(*(_QWORD *)&v25 - 376LL);
  ...
  v36 = 283;
LABEL_16:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, v36);
LABEL_38:
  if ( v7 )
    DeleteObject(v7);
  if ( v5 )
