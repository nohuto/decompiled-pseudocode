/*
 * XREFs of ?ProcessSetVisual@CProjectedShadowCaster@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROJECTEDSHADOWCASTER_SETVISUAL@@@Z @ 0x1801A093C
 * Callers:
 ...
 *     ?SetProjectedShadowCaster@CVisual@@QEAAXPEAVCProjectedShadowCaster@@@Z @ 0x1801A0E64 (-SetProjectedShadowCaster@CVisual@@QEAAXPEAVCProjectedShadowCaster@@@Z.c)
 */
        ...
        const struct MILCMD_PROJECTEDSHADOWCASTER_SETVISUAL *a3)
{
  ...
  if ( !v5 || (Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, v5, 0x97u)) != 0LL )
  {
    if ( Resource != this[7] )
    {
      ...
      else
      {
        ...
        v9 = this[7];
        if ( v9 )
          CVisual::SetProjectedShadowCaster(v9, 0LL);
        if ( Resource )
          CVisual::SetProjectedShadowCaster(Resource, (struct CProjectedShadowCaster *)this);
        v10 = *this;
        this[7] = Resource;
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003303421, 0xEAu);
  }
  return v4;
}
