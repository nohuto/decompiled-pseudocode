/*
 * XREFs of ?HrMilPfToPixelFormatInfo@@YAJW4Enum@MilPixelFormat@@PEAUPixelFormatInfo@@@Z @ 0x1800B8B18
 * Callers:
...
LABEL_6:
  *a2 = v4;
  ...
  {
    v2 = -2003292288;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292288, 0x33Du);
    return v2;
  }
  v5 = 1;
  if ( a1 > 21 )
...
LABEL_45:
    v2 = -2003292344;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292344, 0x351u);
    return v2;
  }
LABEL_17:
  a2[2] = v5 == 2;
