/*
 * XREFs of ?QueueBackgroundSRUMUsageReporting@FeatureStateManager@details@wil@@QEAAXIGI@Z @ 0x180142704
 * Callers:
 *     ?QueueBackgroundSRUMUsageReporting@details@wil@@YAXIII@Z @ 0x1801427E0 (-QueueBackgroundSRUMUsageReporting@details@wil@@YAXIII@Z.c)
 * Callees:
