/*
 * XREFs of ?HrFindInterface@CMILBrushSolid@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18020F7A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
      *a3 = (void *)(((unsigned __int64)this + 48) & -(__int64)(this != 0LL));
  }
  else
  {
    v3 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0xA6u);
  }
  return v3;
}
