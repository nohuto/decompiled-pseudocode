/*
 * XREFs of ?BuildD2DColorPropertiesList@CPrimitiveGroup@@AEAAJPEAVID2DContextOwner@@PEAVID2DContext@@IPEAPEAUID2D1PrivateCompositorPrimitiveProperties@@@Z @ 0x18019E56C
 * Callers:
        ...
        struct ID2D1PrivateCompositorPrimitiveProperties **a5)
{
  ...
  if ( a4 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x447u);
  }
LABEL_10:
