/*
 * XREFs of ?IsEmpty@?$TMilRect@HUtagRECT@@U_CMilRectL_@RectUniqueness@@@@QEBA_NXZ @ 0x1800292D8
 * Callers:
 *     ?OnChanged@CRgnGeometry@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x18002ABC0 (-OnChanged@CRgnGeometry@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
