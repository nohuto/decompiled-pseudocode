/*
 * XREFs of ?ReportInertiaStart@CInteraction@@QEAAJW4InputType@@MM@Z @ 0x18019267C
 * Callers:
 ...
 *     _anonymous_namespace_::InputTypeToInertiaSourceType @ 0x1801920A4 (_anonymous_namespace_--InputTypeToInertiaSourceType.c)
 */
