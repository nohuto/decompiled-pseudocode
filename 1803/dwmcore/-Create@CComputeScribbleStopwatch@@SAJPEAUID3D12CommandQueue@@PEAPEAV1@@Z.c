/*
 * XREFs of ?Create@CComputeScribbleStopwatch@@SAJPEAUID3D12CommandQueue@@PEAPEAV1@@Z @ 0x18021E9E4
 * Callers:
        ...
        struct CComputeScribbleStopwatch **a2)
{
  ...
  v4 = (__int64 *)HeapAlloc(WPF::g_processHeap, 0, 0x48uLL);
  v5 = v4;
  if ( v4 )
  {
    *v4 = 0LL;
...
LABEL_10:
  if ( v5 )
  {
    wil::com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>::~com_ptr_t<IRenderTargetBitmap,wil::err_returncode_policy>(v5 + 5);
    v10 = v5[4];
    if ( v10 )
