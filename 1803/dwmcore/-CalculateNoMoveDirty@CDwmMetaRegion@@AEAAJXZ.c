/*
 * XREFs of ?CalculateNoMoveDirty@CDwmMetaRegion@@AEAAJXZ @ 0x18017887C
 * Callers:
...
__int64 __fastcall CDwmMetaRegion::CalculateNoMoveDirty(CDwmMetaRegion *this)
{
  ...
  if ( *((_BYTE *)this + 40) )
  {
      ...
      if ( CombineRgn(RectRgn, RectRgn, *((HRGN *)this + 3), 2) )
      {
        ...
        if ( v13 )
        {
          ...
          else
          {
            ...
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v1, 0x1CCu);
          }
          if ( v13 )
            DeleteObject(v13);
        }
        else
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v1, 0x1C7u);
        }
      }
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v1, 0x1C3u);
      }
    ...
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v1, 0x1BFu);
    }
  }
