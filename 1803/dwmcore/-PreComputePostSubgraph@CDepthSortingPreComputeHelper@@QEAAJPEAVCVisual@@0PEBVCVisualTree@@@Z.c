/*
 * XREFs of ?PreComputePostSubgraph@CDepthSortingPreComputeHelper@@QEAAJPEAVCVisual@@0PEBVCVisualTree@@@Z @ 0x1802123E0
 * Callers:
        ...
        const struct CVisualTree *a4)
{
  ...
  if ( !a3 || *((_DWORD *)a3 + 25) != 3 )
    return 0LL;
  v12 = 0;
  WorldTransform = CVisual::GetWorldTransform(a2, a4, 1, (__int64)v11, 0LL, 0LL);
  if ( WorldTransform >= 0 )
  {
