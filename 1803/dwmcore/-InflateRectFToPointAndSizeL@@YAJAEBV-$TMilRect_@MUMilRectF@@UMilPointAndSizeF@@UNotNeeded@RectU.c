/*
 * XREFs of ?InflateRectFToPointAndSizeL@@YAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEAUMilPointAndSizeL@@@Z @ 0x1800C314C
 * Callers:
...
__int64 __fastcall InflateRectFToPointAndSizeL(float *a1, __int64 a2, __int64 a3, double a4)
{
  ...
  {
    v4 = -2003304438;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003304438, 0x101u);
  }
  return v4;
}
