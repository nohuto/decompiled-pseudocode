/*
 * XREFs of ?VerifyInfo@DCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@SA_NPEBX_K@Z @ 0x1800CFF50
 * Callers:
  ...
  if ( a2 >= 0x30 && *a1 == 4096 )
  {
    ...
    if ( v2 <= a2 && (_WORD *)((char *)a1 + a2) >= a1 )
    {
      ...
      if ( !v3 || (v3 & 3) == 0 && (unsigned __int64)v3 + 16 <= v2 )
      {
        ...
        if ( !v4
          || (v4 & 1) == 0
          && v4 + 2 * (unsigned __int64)((unsigned int)(unsigned __int16)a1[18] + 1) <= v2
          && !*(_WORD *)((char *)&a1[(unsigned __int16)a1[18]] + v4) )
        {
          v5 = a1[19];
          if ( !v5
            || (v5 & 1) == 0
            && v5 + 2 * (unsigned __int64)((unsigned int)(unsigned __int16)a1[20] + 1) <= v2
