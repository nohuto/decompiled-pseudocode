/*
 * XREFs of ?DoesIntermediateContributeToSubgraph@CBrushRenderingGraph@@AEBA_NII@Z @ 0x18008DB28
 * Callers:
    ...
    if ( v8 )
    {
      ...
      do
      {
        if ( *((_BYTE *)v9 + 4) )
        {
          ...
          if ( (_DWORD)v10 == a3 )
            return 1;
          if ( CRenderingTechniqueFragment::IsNoOp(*(CRenderingTechniqueFragment **)(*(_QWORD *)(*((_QWORD *)v5 + 18)
                                                                                               + 8 * v10)
                                                                                   + 16LL)) )
