/*
 * XREFs of ?TransferVertices2DH_UV2@@YAXAEBVCDrawListPrimitive@@AEBVCMILMatrix@@MAEBV?$StridedSpan@U?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@@Z @ 0x18017E3FC
 * Callers:
...
_QWORD *__fastcall TransferVertices2DH_UV2(__int64 a1, CMILMatrix *a2, float a3)
{
  ...
  result = (_QWORD *)*(unsigned int *)(a1 + 12);
  v4 = 0;
  v5 = *(_QWORD *)(a1 + 24);
  v8 = 8 * (_DWORD)result + 16;
  if ( *(_DWORD *)(a1 + 8) )
  {
    *(float *)&v17[3] = FLOAT_1_0;
    do
    {
      ...
      v17[2] = v9[2];
      v17[1] = v10;
      CMILMatrix::Transform(a2, (const struct MilPoint4F *)v17, (struct MilPoint4F *)v18, 1u);
      v11 = v18[1];
      *v12 = v18[0];
      v12[2] = v18[3];
      v12[1] = v11;
