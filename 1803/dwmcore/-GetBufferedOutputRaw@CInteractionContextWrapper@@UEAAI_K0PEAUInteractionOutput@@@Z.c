/*
 * XREFs of ?GetBufferedOutputRaw@CInteractionContextWrapper@@UEAAI_K0PEAUInteractionOutput@@@Z @ 0x1801D7090
 * Callers:
 *     <none>
 * Callees:
 *     _anonymous_namespace_::ResetInteractionOutput @ 0x1800254B8 (_anonymous_namespace_--ResetInteractionOutput.c)
