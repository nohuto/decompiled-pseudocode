/*
 * XREFs of ?MeshGeometry2DSetConstantOpacity@CChannel@@UEAAJIH@Z @ 0x180144C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::MeshGeometry2DSetConstantOpacity(CChannel *this, int a2, int a3)
{
  unsigned int v6; // ebx
