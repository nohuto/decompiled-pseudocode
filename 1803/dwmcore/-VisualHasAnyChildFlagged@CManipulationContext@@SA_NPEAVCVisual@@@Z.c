/*
 * XREFs of ?VisualHasAnyChildFlagged@CManipulationContext@@SA_NPEAVCVisual@@@Z @ 0x1801DCB2C
 * Callers:
 ...
 *     ?GetCount@?$CPtrArray@VCVisual@@@@QEBA_KXZ @ 0x1800DAA80 (-GetCount@-$CPtrArray@VCVisual@@@@QEBA_KXZ.c)
 */
