/*
 * XREFs of ?Push@CMatrixStack@@QEAAJPEBVCMILMatrix@@_N@Z @ 0x1800BE8E8
 * Callers:
...
__int64 __fastcall CMatrixStack::Push(CMatrixStack *this, const struct CMILMatrix *a2, char a3)
{
  ...
  if ( *(_DWORD *)this && a3 )
  {
    v11 = 0;
    v13 = 0;
    v4 = CWatermarkStack<CMILMatrix,8,2,8>::Top((__int64)this, (__int64)v10);
    v6 = v4;
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x3Du);
    }
    else
    {
      CMILMatrix::Multiply(v5, (const struct CMILMatrix *)v10, (struct CMILMatrix *)v12);
      v7 = CWatermarkStack<CMILMatrix,8,2,8>::Push((unsigned int *)this, (__int64)v12);
      v6 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x45u);
    }
  }
  else
  {
    v9 = CWatermarkStack<CMILMatrix,8,2,8>::Push((unsigned int *)this, (__int64)a2);
    v6 = v9;
    if ( v9 < 0 )
