/*
 * XREFs of ?CreateSurfaceAndContext@CViewportAlignedIntermediateRealizer@@AEAAJPEBVCMILMatrix@@000IIPEAPEAVIRenderTargetBitmap@@PEAPEAVCDrawingContext@@@Z @ 0x1801C43D4
 * Callers:
        ...
        struct CDrawingContext **a9)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SurfaceAndContext, 0x3B3u);
  }
  else
  {
    v19 = *((_DWORD *)a2 + 16);
    ...
    v13 = v16;
    if ( v16 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x3D0u);
  }
  return v13;
}
