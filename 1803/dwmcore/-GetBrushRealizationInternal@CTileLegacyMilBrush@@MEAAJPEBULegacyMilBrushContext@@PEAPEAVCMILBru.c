/*
 * XREFs of ?GetBrushRealizationInternal@CTileLegacyMilBrush@@MEAAJPEBULegacyMilBrushContext@@PEAPEAVCMILBrush@@@Z @ 0x1801A6270
 * Callers:
 ...
 *     ?SetBitmapToXSpaceTransform@CMILBrushBitmap@@QEAAXPEBVCMILMatrix@@W4XSpaceDefinition@@@Z @ 0x18020F56C (-SetBitmapToXSpaceTransform@CMILBrushBitmap@@QEAAXPEBVCMILMatrix@@W4XSpaceDefinition@@@Z.c)
        ...
        struct CMILBrush **a3)
{
  ...
  unsigned int v30; // [rsp+A0h] [rbp-70h] BYREF
  ...
  unsigned int v39; // [rsp+CCh] [rbp-44h] BYREF
  int v40; // [rsp+D0h] [rbp-40h] BYREF
  int v41[2]; // [rsp+D8h] [rbp-38h] BYREF
  int v42[2]; // [rsp+E0h] [rbp-30h] BYREF
  _QWORD v43[2]; // [rsp+E8h] [rbp-28h] BYREF
  _QWORD v44[2]; // [rsp+F8h] [rbp-18h] BYREF
  ...
  struct D2D_RECT_F v54; // [rsp+250h] [rbp+140h] BYREF
  ...
  v54.top = 0.0;
  v54.left = 0.0;
  v43[0] = 0x3F8000003F800000LL;
  v43[1] = 0x3F8000003F800000LL;
  v6 = *(_QWORD *)this;
  *(_QWORD *)v42 = 0LL;
  *(_QWORD *)v41 = 0LL;
  v44[0] = 0LL;
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x7Fu);
  }
  else
  {
    if ( !v28 )
...
LABEL_36:
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, TilePropertyCurrentValues, 0x95u);
    }
    else
    {
      v11 = (*(__int64 (__fastcall **)(CTileLegacyMilBrush *, float *, float *))(*(_QWORD *)this + 224LL))(
              this,
              &v33,
              &v32);
      v9 = v11;
      ...
      else
      {
        ...
        if ( v29 == 1 )
        {
          v13 = (*(__int64 (__fastcall **)(CTileLegacyMilBrush *, const struct LegacyMilBrushContext *, struct D2D_RECT_F *))(*(_QWORD *)this + 232LL))(
                  this,
                  a2,
                  &v54);
          v9 = v13;
        ...
        if ( v26 )
          goto LABEL_36;
        v14 = (*(__int64 (__fastcall **)(CTileLegacyMilBrush *, const struct LegacyMilBrushContext *, __int64 *, __int64 *, __int64 *, int, int *, int *))(*(_QWORD *)this + 240LL))(
                this,
                a2,
                v48,
                v46,
        ...
        if ( v14 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0xD7u);
        }
        else
        {
          if ( v26 )
          ...
          if ( v38 )
          {
            ...
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, IntermediateBaseTile, 0xEDu);
              goto LABEL_35;
            }
          }
          else
          {
            v16 = (*(__int64 (__fastcall **)(CTileLegacyMilBrush *, const struct LegacyMilBrushContext *, char *, __int64 *, __int64 *, __int64 *, int, __int64 *, _BYTE *, int *, unsigned int *))(*(_QWORD *)this + 256LL))(
                    this,
                    a2,
                    (char *)a2 + 4,
                    v48,
            ...
            if ( v16 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x101u);
              goto LABEL_35;
            }
          }
          if ( v26 )
          ...
          *((_QWORD *)this + 38) = v17;
          ...
          v19 = v30;
          v20 = *((_DWORD *)this + 56) + 1;
          if ( *((_DWORD *)this + 56) == -1 )
            v20 = 1;
          *((_DWORD *)this + 56) = v20;
          CMILBrushBitmap::SetBitmapToXSpaceTransform((char *)this + 112, v50, v19);
          v22 = CMILBrushBitmap::SetWrapMode(v21, 0LL);
          v9 = v22;
          if ( v22 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x11Cu);
          }
          else
          {
            v23 = CMILBrushBitmap::SetSourceModifications((char *)this + 112, v39, v43, v44);
            v9 = v23;
            if ( v23 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0x120u);
            }
            else
            {
              *((_DWORD *)this + 93) = v40;
...
LABEL_35:
  if ( v26 )
    goto LABEL_36;
LABEL_37:
  ReleaseInterfaceNoNULL<IBitmapSource>(v31);
  return v9;
}
