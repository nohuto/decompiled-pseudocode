/*
 * XREFs of ?CanUseCVI@CHwndBitmap@@AEBA_NPEAVCDrawingContext@@@Z @ 0x1800B5B2C
 * Callers:
 *     ?ShouldUseDrawListRenderPath@CHwndBitmap@@UEBA_NPEAVCDrawingContext@@@Z @ 0x1800B5A60 (-ShouldUseDrawListRenderPath@CHwndBitmap@@UEBA_NPEAVCDrawingContext@@@Z.c)
