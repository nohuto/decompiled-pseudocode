/*
 * XREFs of ?ProcessUpdateFlags@CInteraction@@QEAAJPEAVCResourceTable@@PEBUMILCMD_INTERACTION_UPDATEFLAGS@@@Z @ 0x180028A08
 * Callers:
        ...
        const struct MILCMD_INTERACTION_UPDATEFLAGS *a3)
{
  ...
  *((_BYTE *)this + 184) = v3;
  ...
  v5 = v4 ^ (v4 ^ (2 * v4)) & 4;
  *((_BYTE *)this + 184) = v5;
  *((_BYTE *)this + 184) = v5 & 0xEF | (*((_DWORD *)a3 + 4) != 0 ? 0x10 : 0);
