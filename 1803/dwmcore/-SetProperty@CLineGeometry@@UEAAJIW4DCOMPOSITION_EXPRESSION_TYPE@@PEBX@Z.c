/*
 * XREFs of ?SetProperty@CLineGeometry@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180198DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLineGeometry::SetProperty(CResource *a1, int a2, int a3, struct _D3DCOLORVALUE *a4)
{
  ...
  v13[0] = 2LL;
  v13[1] = &CLineGeometry::k_rgAnimDef;
