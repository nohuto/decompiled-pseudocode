/*
 * XREFs of ?GetBitmapSource@CCachedVisualImage@@UEAAJPEAPEAVIBitmapSource@@PEBUBitmapSourceInfo@@@Z @ 0x1800B4480
 * Callers:
        ...
        const struct BitmapSourceInfo *a3)
{
  ...
  *a2 = 0LL;
  ...
  if ( !a3 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277214, 1u, CurrentDisplaySet, 0x594u);
      v3 = v21;
    }
    else
    {
      ...
      {
        v4 = v19;
        DisplayId = (unsigned int *)CDisplay::GetDisplayId(v19, &v19);
LABEL_4:
        v10 = CCachedVisualImage::EnsureRenderTargetBitmapInfo((__int64)this - 8, v8, *DisplayId, &v18);
        v11 = v10;
        if ( v10 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277214, 1u, v10, 0x59Cu);
        }
        else if ( v18
               && (v12 = (*(__int64 (__fastcall **)(__int64, struct IBitmapSource **, const struct BitmapSourceInfo *))(*(_QWORD *)(*(_QWORD *)(v18 + 8) + 16LL) + 64LL))(
                   ...
                   v12 < 0) )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277214, 1u, v12, 0x5A3u);
        }
        else
        {
          v13 = v20;
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277214, 1u, PrimaryDisplay, 0x596u);
      v4 = v19;
    }
LABEL_8:
    if ( v4 )
  ...
  if ( BitmapSourceForBounds < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277214, 1u, BitmapSourceForBounds, 0x587u);
LABEL_12:
