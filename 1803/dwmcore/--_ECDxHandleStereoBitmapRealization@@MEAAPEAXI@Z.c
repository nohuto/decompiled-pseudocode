/*
 * XREFs of ??_ECDxHandleStereoBitmapRealization@@MEAAPEAXI@Z @ 0x180214AF0
 * Callers:
 *     ??_ECDxHandleStereoBitmapRealization@@OFI@EAAPEAXI@Z @ 0x1800DE8E0 (--_ECDxHandleStereoBitmapRealization@@OFI@EAAPEAXI@Z.c)
 * Callees:
