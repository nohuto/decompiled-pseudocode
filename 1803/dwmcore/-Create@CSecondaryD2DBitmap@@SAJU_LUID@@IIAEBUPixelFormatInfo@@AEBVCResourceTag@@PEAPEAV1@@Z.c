/*
 * XREFs of ?Create@CSecondaryD2DBitmap@@SAJU_LUID@@IIAEBUPixelFormatInfo@@AEBVCResourceTag@@PEAPEAV1@@Z @ 0x180083270
 * Callers:
        ...
        struct CSecondaryD2DBitmap **a6)
{
  ...
  v9 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x37u);
  return v9;
}
