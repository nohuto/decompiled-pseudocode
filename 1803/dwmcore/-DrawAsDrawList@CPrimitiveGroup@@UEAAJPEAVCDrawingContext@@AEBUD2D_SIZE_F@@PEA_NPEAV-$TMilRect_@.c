/*
 * XREFs of ?DrawAsDrawList@CPrimitiveGroup@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCDrawListCache@@@Z @ 0x1800973C0
 * Callers:
...
__int64 __fastcall CPrimitiveGroup::DrawAsDrawList(
        ...
        __int64 a6)
{
  return CPrimitiveGroup::DrawWorker(a1, a4, a5, a6);
}
