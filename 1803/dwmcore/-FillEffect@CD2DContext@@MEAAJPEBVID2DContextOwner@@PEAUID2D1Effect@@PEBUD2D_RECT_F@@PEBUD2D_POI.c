/*
 * XREFs of ?FillEffect@CD2DContext@@MEAAJPEBVID2DContextOwner@@PEAUID2D1Effect@@PEBUD2D_RECT_F@@PEBUD2D_POINT_2F@@W4D2D1_INTERPOLATION_MODE@@W4D2D1_COMPOSITE_MODE@@@Z @ 0x180095DB0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum D2D1_COMPOSITE_MODE a7)
{
  ...
  (*(void (__fastcall **)(ID2D1DeviceContext *, _BYTE *))(*(_QWORD *)this[22] + 240LL))(this[22], v15);
  v11 = 0LL;
  if ( a5 )
  {
  ...
  ID2D1DeviceContext::DrawImage(this[22], a3, v11, a4, a6, a7);
  return 0LL;
}
