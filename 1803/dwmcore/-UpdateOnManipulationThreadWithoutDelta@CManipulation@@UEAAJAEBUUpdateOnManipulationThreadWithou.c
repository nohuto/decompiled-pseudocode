/*
 * XREFs of ?UpdateOnManipulationThreadWithoutDelta@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadWithoutDeltaArgs@@@Z @ 0x18019A280
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_DWORD *)(v6 + 52) = 1065353216;
    ...
    || ((*(_BYTE *)(v7 + 16) ^ *(_BYTE *)(v6 + 188)) & 2) != 0 )
  {
    ...
    *(_BYTE *)(v6 + 188) ^= (*(_BYTE *)(v7 + 16) ^ *(_BYTE *)(v6 + 188)) & 2;
    ...
    v3 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xABu);
  }
  return v3;
}
