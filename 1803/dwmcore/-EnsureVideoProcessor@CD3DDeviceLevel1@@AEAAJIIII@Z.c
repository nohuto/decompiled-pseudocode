/*
 * XREFs of ?EnsureVideoProcessor@CD3DDeviceLevel1@@AEAAJIIII@Z @ 0x1801DFD68
 * Callers:
        ...
        unsigned int a5)
{
    ...
    || a5 < *((_DWORD *)this + 177) )
  {
    ...
    {
      if ( *((_QWORD *)this + 84)
        || (v12 = (***((__int64 (__fastcall ****)(_QWORD, GUID *))this + 82))(
                    *((_QWORD *)this + 82),
            ...
            v12 >= 0) )
      {
        ...
        if ( v23 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v23, 0xA09u);
        }
        else
        {
          v24 = *v5;
          ...
          if ( v26 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0xA0Du);
          }
          else
          {
            *((_DWORD *)this + 176) = v33;
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x9F2u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x9EDu);
    }
    if ( v9 < 0 )
    {
      v27 = *v5;
