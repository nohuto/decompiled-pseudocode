/*
 * XREFs of ?IntersectGeometryWithSafeBounds@CD2DContext@@MEAAJPEAUID2D1Geometry@@0PEBUD2D_MATRIX_3X2_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAU2@@Z @ 0x1801E3A50
 * Callers:
 *     <none>
 * Callees:
      ...
      else
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if ( v12 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x709u);
              goto LABEL_32;
            }
            ...
            else
            {
              ...
              v19 = *((float *)&v34 + 1);
              if ( (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(*((float *)&v34 + 1)) & _xmm) < 8388608.0 )
                v19 = (float)(int)ceilf_0(*((float *)&v34 + 1));
              if ( a5 )
              {
              ...
              *((float *)&v34 + 1) = v19 + 1.0;
              ...
              (*(void (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v26 + 40LL))(v26, v34, 0LL);
              (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v26 + 64LL))(v26, 1LL);
