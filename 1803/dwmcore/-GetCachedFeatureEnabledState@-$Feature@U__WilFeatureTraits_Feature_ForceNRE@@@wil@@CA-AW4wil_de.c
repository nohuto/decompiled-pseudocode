/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_ForceNRE@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800BA5D0
 * Callers:
        ...
        enum FEATURE_CHANGE_TIME a3)
{
    ...
    || (`wil::Feature<__WilFeatureTraits_Feature_ForceNRE>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
  {
    ...
    if ( !v8 || (v4 = 2, v8 != 2) )
      v4 = 1;
    v9 = (`wil::Feature<__WilFeatureTraits_Feature_ForceNRE>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
    if ( v3 )
      v4 = v3;
    else
      v9 = v6;
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      0LL);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(12756137LL, 0LL, v13) )
    {
      if ( v3 )
      {
        v11 = v7;
