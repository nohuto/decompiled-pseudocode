/*
 * XREFs of ?SetProperty@CRectangleGeometry@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A36A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRectangleGeometry::SetProperty(CResource *a1, int a2, int a3, struct _D3DCOLORVALUE *a4)
{
  ...
  v13[0] = 15LL;
  v13[1] = &CRectangleGeometry::k_rgAnimDef;
  ...
  if ( AnimatablePropertyInfo )
  {
    ...
    v10 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x92u);
  }
  else
  {
    ...
    v10 = v11;
    if ( v11 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x96u);
  }
  return v10;
}
