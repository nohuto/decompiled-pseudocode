/*
 * XREFs of ?NotifyUpdateRails@CManipulationManager@@QEAAJPEAVCInteraction@@_NW4RailsAxis@@@Z @ 0x18002633C
 * Callers:
...
__int64 __fastcall CManipulationManager::NotifyUpdateRails(__int64 a1, __int64 a2, char a3, int a4)
{
  ...
  if ( v8 )
  {
    *(_DWORD *)v8 = 9;
    ...
    Microsoft::WRL::ComPtr<CInteraction>::operator=(v8 + 16, a2);
    *(_BYTE *)(v8 + 64) &= ~2u;
    *(_BYTE *)(v8 + 64) |= 2 * a3;
    *(_DWORD *)(v8 + 44) = a4;
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x1F2u);
  ...
  {
    v13 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x1E3u);
  }
  return v13;
}
