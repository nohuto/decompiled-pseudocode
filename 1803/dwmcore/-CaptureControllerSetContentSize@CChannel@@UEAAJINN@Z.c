/*
 * XREFs of ?CaptureControllerSetContentSize@CChannel@@UEAAJINN@Z @ 0x180143D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::CaptureControllerSetContentSize(CChannel *this, int a2, double a3, double a4)
{
  float v6; // xmm0_4
  float v7; // xmm1_4
  unsigned int v8; // ebx
