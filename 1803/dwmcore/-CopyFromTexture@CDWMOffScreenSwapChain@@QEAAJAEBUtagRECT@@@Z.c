/*
 * XREFs of ?CopyFromTexture@CDWMOffScreenSwapChain@@QEAAJAEBUtagRECT@@@Z @ 0x1800D8FFC
 * Callers:
...
__int64 __fastcall CDWMOffScreenSwapChain::CopyFromTexture(CDWMOffScreenSwapChain *this, const struct tagRECT *a2)
{
  ...
  if ( *((_QWORD *)this + 56) )
  {
    ...
    *((_DWORD *)this + 124) = 0;
    *((_DWORD *)this + 126) = 0;
    v9 = (CD3DDeviceLevel1 *)*((_QWORD *)this + 54);
    *((_DWORD *)this + 123) = 3;
    ...
    *(_QWORD *)&v13 = "DWM Offscreen SwapChain Readback";
    ...
    v15[1] = v10;
    v18 = v13;
    v15[0] = *((_OWORD *)this + 29);
    v16 = *((_QWORD *)this + 62);
    Texture = CD3DDeviceLevel1::CreateTexture(v9, (const struct DWM_TEXTURE2D_DESC *)v15, 0LL, v5);
    v2 = Texture;
    if ( Texture >= 0 )
    {
LABEL_3:
      (*(void (__fastcall **)(_QWORD, struct ID3D11Texture2D *, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 54) + 656LL)
                                                                       + 376LL))(
        *(_QWORD *)(*((_QWORD *)this + 54) + 656LL),
        *v5,
        *((_QWORD *)this + 53));
      v6 = CD3DDeviceLevel1::Map(*((CD3DDeviceLevel1 **)this + 54), (struct ID3D11Resource *)*v5, 0LL, 1LL, v12, &v14);
      v2 = v6;
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x196u);
      }
      else
      {
        ...
        CD3DDeviceLevel1::Unmap(*((CD3DDeviceLevel1 **)this + 54), (struct ID3D11Resource *)*v5);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Texture, 0x18Cu);
    }
  }
  return v2;
}
