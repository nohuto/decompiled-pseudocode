/*
 * XREFs of ?GetActiveManipulationDelta@InteractionSourceManager@@QEBAMW4ScrollAxis@@@Z @ 0x1801C9B70
 * Callers:
...
__m128 __fastcall InteractionSourceManager::GetActiveManipulationDelta(InteractionSourceManager *a1)
{
  ...
  if ( v3 )
  {
    ...
    if ( v4 )
    {
      ...
      (*(void (__fastcall **)(struct CManipulation *, __int64, _DWORD *))(*(_QWORD *)ActiveManipulation + 96LL))(
        ActiveManipulation,
        3LL,
        v11);
      v2 = (__m128)v11[0];
    ...
    (*(void (__fastcall **)(struct CManipulation *, __int64, _DWORD *))(*(_QWORD *)v6 + 96LL))(v6, 1LL, v11);
    v7 = (__m128)v11[1];
  }
  else
  {
    ...
    (*(void (__fastcall **)(struct CManipulation *, __int64, _DWORD *))(*(_QWORD *)v8 + 96LL))(v8, 1LL, v11);
    v7 = (__m128)v11[0];
  }
