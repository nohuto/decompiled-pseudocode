/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_DepthSorting@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800BA6A4
 * Callers:
        ...
        enum FEATURE_CHANGE_TIME a3)
{
  ...
  {
    FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0xD2D9A0, a2, a3);
    ...
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      0LL);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(13818272LL, 0LL, v13) )
    {
      if ( v3 )
      {
        v11 = v7;
