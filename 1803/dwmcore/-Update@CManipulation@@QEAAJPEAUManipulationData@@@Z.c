/*
 * XREFs of ?Update@CManipulation@@QEAAJPEAUManipulationData@@@Z @ 0x180199B2C
 * Callers:
...
__int64 __fastcall CManipulation::Update(CManipulation *this, struct ManipulationData *a2)
{
  ...
  v2 = (_OWORD *)((char *)this + 256);
  v3 = (__m128)*((unsigned int *)a2 + 3);
  v4 = (float *)((char *)this + 268);
  ...
  v3.m128_f32[0] = v3.m128_f32[0] + *((float *)this + 67);
  v7.m128_f32[0] = v7.m128_f32[0] + *((float *)this + 68);
  v5.m128_f32[0] = v5.m128_f32[0] * *((float *)this + 73);
  v11 = *((_DWORD *)this + 103);
  v9.m128_f32[0] = v9.m128_f32[0] * *((float *)this + 74);
  v33 = *((float *)a2 + 5) + *((float *)this + 69);
  v12 = (char *)this + 384;
  v31 = *((float *)a2 + 11) * *v8;
  *v2 = *(_OWORD *)a2;
  v2[1] = *((_OWORD *)a2 + 1);
  ...
  *(_QWORD *)v6 = _mm_unpacklo_ps(v5, v9).m128_u64[0];
  ...
  if ( dword_1802D3FE0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 2uLL) )
  {
    ...
    v30 = (v20 >> 1) & 1;
    v94 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_1802D3FE0, &unk_1802A8762, 0LL, 0LL, 0x20u, &pData);
  }
  v21 = *((_DWORD *)this + 103);
  if ( v21 == v11 )
  {
