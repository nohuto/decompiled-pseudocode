/*
 * XREFs of ?ProcessInput@CGestureTargetingManager@@SAJPEBUIManipulationContext@@AEBUtagPOINTER_INFO@@@Z @ 0x1801DD490
 * Callers:
  ...
  else
  {
    ...
    if ( v10 )
    {
      while ( v9 >= 0 )
      {
        ...
        v15 = (*(__int64 (__fastcall **)(const struct IManipulationContext *, __int64, _QWORD))(v14 + 56))(a1, v10, v13);
...
LABEL_10:
      ...
      v21 = (*(__int64 (__fastcall **)(const struct IManipulationContext *, __int64 *, _QWORD))(v20 + 56))(a1, v16, v19);
