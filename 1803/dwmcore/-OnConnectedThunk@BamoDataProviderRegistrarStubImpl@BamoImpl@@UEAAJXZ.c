/*
 * XREFs of ?OnConnectedThunk@BamoDataProviderRegistrarStubImpl@BamoImpl@@UEAAJXZ @ 0x180168930
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoImpl::BamoDataProviderRegistrarStubImpl *this)
{
  ...
  Microsoft::BamoImpl::DropAndReacquireLock::DropAndReacquireLock(
    ...
    *(struct Microsoft::BamoImpl::BamoConnectionImpl **)(*(_QWORD *)(*((_QWORD *)this + 5) + 24LL) + 24LL));
  v3 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)(v2 - 16) + 56LL))(v2 - 16, (char *)this - 16);
  v4 = v7;
  v5 = v3;
  if ( v7 )
  {
