/*
 * XREFs of McTemplateU0zxqqqqhhhqqntqqqqqqqqqqqqqqqqqq @ 0x1801503C0
 * Callers:
        ...
        char a34)
{
  __int64 v34; // rax
  int v35; // ecx
  struct _EVENT_DATA_DESCRIPTOR v37; // [rsp+20h] [rbp-E0h] BYREF
  const wchar_t *v38; // [rsp+30h] [rbp-D0h]
  ...
  v99 = &a34;
  v100 = 4LL;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, a2, 0x20u, &v37);
}
