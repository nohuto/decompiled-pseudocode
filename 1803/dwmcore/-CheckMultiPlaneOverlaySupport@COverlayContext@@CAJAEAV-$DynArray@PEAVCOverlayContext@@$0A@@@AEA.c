/*
 * XREFs of ?CheckMultiPlaneOverlaySupport@COverlayContext@@CAJAEAV?$DynArray@PEAVCOverlayContext@@$0A@@@AEAV?$DynArray@UReservedPlaneInfo@COverlayContext@@$0A@@@AEAV?$DynArray@PEAVOverlayPlaneInfo@COverlayContext@@$0A@@@PEA_N@Z @ 0x180164AC8
 * Callers:
...
__int64 __fastcall COverlayContext::CheckMultiPlaneOverlaySupport(unsigned int *a1, __int64 a2, __int64 a3, _BYTE *a4)
{
  ...
  _QWORD v66[2]; // [rsp+E8h] [rbp-40h] BYREF
  ...
  *v76 = 0;
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x9EAu);
    goto LABEL_63;
  }
  v13 = 0;
  v63 = 0;
  if ( v5[6] )
  {
    while ( 2 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, ContextCandidates, 0x9F8u);
LABEL_53:
        DynArrayImpl<0>::~DynArrayImpl<0>((__int64)v66);
        goto LABEL_59;
      }
      v57 = v69;
      ...
      else
      {
        v16 = 0;
        v57 = 0;
        v59 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v5 + 8 * v14) + 312LL);
      }
      v17 = 0;
      while ( 1 )
      {
        v53 = v17;
        if ( v17 >= *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v5 + 8 * v14) + 312LL) )
          break;
        v60 = v17 + v16;
        v18 = &v12[144 * v56 + 144 * v17 + 144 * v16];
        memset_0(v18, 0, 0x90uLL);
        v19 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v5 + 8 * v14) + 16LL);
        v20 = (*(__int64 (__fastcall **)(__int64, CD3DSurface **))(*(_QWORD *)v19 + 536LL))(v19, &v64);
        v6 = v20;
        if ( v20 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0xA1Au);
          goto LABEL_53;
        }
        ...
        v22 = DXGIResource;
        if ( DXGIResource < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DXGIResource, 0xA1Cu);
        TranslateDXGIorD3DErrorInContext(v22, 14, &v61);
        v6 = v61;
        if ( v61 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v61, 0xA22u);
LABEL_49:
          DynArrayImpl<0>::~DynArrayImpl<0>((__int64)v66);
          v12 = lpMem;
          goto LABEL_59;
        ...
        *((_DWORD *)v18 + 7) = 0;
        v23 = 120LL * v53;
        v24 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v5 + 8 * v14) + 288LL);
        ...
        *((_DWORD *)v18 + 4) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v5 + 8 * v14) + 96LL);
        ReleaseInterface<CD3DSurface>((__int64 *)&v64);
        v12 = lpMem;
        v17 = v53 + 1;
        v16 = v57;
      }
      ...
      if ( *((_DWORD *)v74 + 6) )
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, DXGIResourceAndSubResourceIndex, 0xA3Au);
        goto LABEL_49;
      }
LABEL_26:
      v34 = v69;
...
LABEL_31:
        ...
        if ( (int)COverlayContext::GetSingleDXGIResourceAndSubResourceIndex(
                    *(struct CCompositionSurfaceInfo **)(*(_QWORD *)(v66[0] + 8LL * i) + 24LL),
                    (struct IDXGIResource **)v41 + 1,
                    (unsigned int *)v41 + 7) < 0 )
          goto LABEL_49;
        v42 = v66[0];
        v43 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v66[0] + 8LL * i) + 24LL) + 40LL);
        *((_DWORD *)v41 + 7) = 0;
        *(_QWORD *)(v41 + 20) = v43;
        v44 = *(_QWORD *)(v42 + 8LL * i);
        v34 = v69;
      ...
      v56 += *((_DWORD *)v26 + 6) + v34 + *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v5 + 8 * v14) + 312LL);
      DynArrayImpl<0>::~DynArrayImpl<0>((__int64)v66);
      v12 = lpMem;
      v13 = v63 + 1;
      v63 = v13;
  ...
  if ( v47 >= 0 )
  {
    if ( v73 )
    {
      for ( j = 0LL; (unsigned int)j < v5[6]; *(_BYTE *)(v49 + 1200) = 1 )
      {
...
LABEL_57:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v47, 0xA9Au);
LABEL_59:
  if ( v4 )
  {
    v50 = v72;
    ...
    do
    {
      ReleaseInterfaceNoNULL<IWICBitmap>(*v51);
      v51 += 18;
      --v50;
    }
    while ( v50 );
