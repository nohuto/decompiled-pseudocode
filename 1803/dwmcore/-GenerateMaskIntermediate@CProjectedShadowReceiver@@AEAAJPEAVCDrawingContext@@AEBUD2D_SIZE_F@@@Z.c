/*
 * XREFs of ?GenerateMaskIntermediate@CProjectedShadowReceiver@@AEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@@Z @ 0x1801A143C
 * Callers:
...
LABEL_11:
  ...
  if ( v11 < 0 )
    ...
    Microsoft::WRL::ComPtr<IImageSource>::operator=<CRenderTargetImageSource>(this + 13, &v15);
LABEL_13:
  Microsoft::WRL::ComPtr<CRenderTargetImageSource>::InternalRelease(&v15);
  Microsoft::WRL::ComPtr<ID3D11Device5>::InternalRelease((__int64 *)&v16);
