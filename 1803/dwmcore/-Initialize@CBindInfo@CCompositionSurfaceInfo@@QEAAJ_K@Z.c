/*
 * XREFs of ?Initialize@CBindInfo@CCompositionSurfaceInfo@@QEAAJ_K@Z @ 0x180082AC4
 * Callers:
...
__int64 __fastcall CCompositionSurfaceInfo::CBindInfo::Initialize(CCompositionSurfaceInfo::CBindInfo *this, __int64 a2)
{
  ...
  {
    v3 = v4 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277338, 3u, v4 | 0x10000000, 0x3CDu);
    goto LABEL_9;
  }
  v5 = v11[0];
  *((_QWORD *)this + 1) = v10;
  *((_DWORD *)this + 4) = v5;
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      ...
      {
        v3 = -2147024809;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277338, 3u, -2147024809, 0x3EFu);
        goto LABEL_13;
      }
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277338, 3u, v7, v9);
LABEL_9:
    if ( (v3 & 0x80000000) == 0 )
      return v3;
LABEL_13:
