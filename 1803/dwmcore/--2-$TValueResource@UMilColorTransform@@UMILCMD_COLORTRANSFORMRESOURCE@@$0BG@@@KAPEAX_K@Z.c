/*
 * XREFs of ??2?$TValueResource@UMilColorTransform@@UMILCMD_COLORTRANSFORMRESOURCE@@$0BG@@@KAPEAX_K@Z @ 0x18016DA08
 * Callers:
...
LPVOID TValueResource<MilColorTransform,MILCMD_COLORTRANSFORMRESOURCE,22>::operator new()
{
  LPVOID result; // rax
