/*
 * XREFs of ?SetOutputType@CKeyframeAnimation@@MEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18003E9C0
 * Callers:
...
__int64 __fastcall CKeyframeAnimation::SetOutputType(__int64 a1, int a2)
{
  ...
  if ( (unsigned int)v2 <= 0x3C && (v3 = 0x1C00020001000081LL, _bittest64(&v3, v2)) )
  {
    *(_DWORD *)(a1 + 144) = a2;
    return 0;
  }
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003303421, 0xB7u);
  }
  return v4;
}
