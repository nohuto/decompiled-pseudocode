/*
 * XREFs of ?Vector2Transform@CExpressionValueStack@@QEAAJXZ @ 0x1801BC0C8
 * Callers:
 ...
 *     ?D3DXVec2Transform@@YAPEAUD2DVector2@@PEAU1@PEBU1@PEBUD2DQuaternion@@@Z @ 0x180207000 (-D3DXVec2Transform@@YAPEAUD2DVector2@@PEAU1@PEBU1@PEBUD2DQuaternion@@@Z.c)
 */
...
__int64 __fastcall CExpressionValueStack::Vector2Transform(CExpressionValueStack *this)
{
  ...
  __int128 v16; // [rsp+30h] [rbp-9h] BYREF
  float v17[20]; // [rsp+40h] [rbp+7h]
  __int64 v18; // [rsp+A0h] [rbp+67h] BYREF
  __int64 v19; // [rsp+A8h] [rbp+6Fh] BYREF
