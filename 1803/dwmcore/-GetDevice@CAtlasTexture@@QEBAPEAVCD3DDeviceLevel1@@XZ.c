/*
 * XREFs of ?GetDevice@CAtlasTexture@@QEBAPEAVCD3DDeviceLevel1@@XZ @ 0x180013298
 * Callers:
...
{
  return *(struct CD3DDeviceLevel1 **)(*(_QWORD *)((*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 1) + 112LL))(*((_QWORD *)this + 1))
                                                 + 16)
                                     + 80LL);
}
