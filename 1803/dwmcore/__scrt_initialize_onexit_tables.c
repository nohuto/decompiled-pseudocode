/*
 * XREFs of __scrt_initialize_onexit_tables @ 0x1800DAE90
 * Callers:
 ...
 *     _initialize_onexit_table @ 0x1800DB74C (_initialize_onexit_table.c)
 */
...
char __fastcall _scrt_initialize_onexit_tables(unsigned int a1)
{
  ...
  if ( !byte_1802D5D18 )
  {
    ...
    if ( !(unsigned int)_scrt_is_ucrt_dll_in_use() || a1 )
    {
      ...
      *((_QWORD *)&v4 + 1) = v3;
      Table._end = v3;
      *(_OWORD *)&stru_1802D5D00._first = v4;
      stru_1802D5D00._end = v3;
    }
    else if ( initialize_onexit_table(&Table) || initialize_onexit_table(&stru_1802D5D00) )
    {
      return 0;
    }
    byte_1802D5D18 = 1;
