/*
 * XREFs of ?GetBits@CHwDisplayRenderTarget@@UEAAJAEBUMilRectF@@PEAVIBitmapDest@@HH@Z @ 0x180046F00
 * Callers:
 *     ?GetBits@CHwDisplayRenderTarget@@WNI@EAAJAEBUMilRectF@@PEAVIBitmapDest@@HH@Z @ 0x1800DE270 (-GetBits@CHwDisplayRenderTarget@@WNI@EAAJAEBUMilRectF@@PEAVIBitmapDest@@HH@Z.c)
 * Callees:
  ...
  *(float *)&v13 = *(float *)&v13 + 6291456.25;
  ...
  if ( (*((unsigned __int8 (__fastcall **)(CD3DDeviceLevel1 **))*this + 4))(this) )
  {
    ...
    if ( (**(int (__fastcall ***)(struct IBitmapDest *, GUID *, __int64 *))a3)(
           ...
           &v23) < 0 )
    {
      (*((void (__fastcall **)(CD3DDeviceLevel1 **, _DWORD *))*this + 37))(this, v27);
...
LABEL_23:
    ...
    if ( v25 == *((_QWORD *)this[28] + 91) && v22 == *((_DWORD *)this + 29) )
    {
      v19 = LODWORD(v21);
      if ( v21 != 0.0 )
      {
      ...
      LOBYTE(v18) = 1;
      Bits = (*((__int64 (__fastcall **)(CD3DDeviceLevel1 **, __int64, __int64, struct CD3DSurface **))*this + 34))(
               this,
               v19,
               v18,
               &v24);
      ...
      {
        Bits = CD3DDeviceLevel1::CopyPixelsToSlicerBitmap(this[28], v24, a4, a5);
        v5 = Bits;
        if ( Bits >= 0 )
          goto LABEL_5;
        v20 = 354;
