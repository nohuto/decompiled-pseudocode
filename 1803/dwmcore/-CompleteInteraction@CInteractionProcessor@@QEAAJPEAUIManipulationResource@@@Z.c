/*
 * XREFs of ?CompleteInteraction@CInteractionProcessor@@QEAAJPEAUIManipulationResource@@@Z @ 0x1801D37AC
 * Callers:
 *     ?CompleteInteraction@CInteraction@@UEAAJXZ @ 0x180191BE0 (-CompleteInteraction@CInteraction@@UEAAJXZ.c)
 *     ?CompleteInteraction@CInteractionRoot@@UEAAJXZ @ 0x1801DA4D0 (-CompleteInteraction@CInteractionRoot@@UEAAJXZ.c)
 * Callees:
