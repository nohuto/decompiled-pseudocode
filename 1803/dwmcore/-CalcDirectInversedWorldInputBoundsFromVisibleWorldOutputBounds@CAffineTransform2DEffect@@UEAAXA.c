/*
 * XREFs of ?CalcDirectInversedWorldInputBoundsFromVisibleWorldOutputBounds@CAffineTransform2DEffect@@UEAAXAEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@1PEAV3@2@Z @ 0x1801B07F0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int128 *a6)
{
  ...
  *((float *)&v30 + 1) = a2[1];
  v13 = *((_DWORD *)a2 + 5);
  *(float *)&v30 = v7;
  *((_QWORD *)&v30 + 1) = __PAIR64__(v13, *((_DWORD *)a2 + 4));
  v31 = v8;
  v32 = v10;
  v28 = v8 ^ _xmm;
  v29 = v10 ^ _xmm;
  ...
  *(_QWORD *)&v33.m[2][0] = v16;
  ...
  if ( result
    && (*a6 = *a3,
        v27 = *a3,
        (result = CFilterEffect::InvertTransformToCalc2DBounds((__int64)a2, (__int64)&v27, &v30)) != 0) )
  {
