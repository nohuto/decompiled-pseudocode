/*
 * XREFs of ?HrInit@CBitmapLockUnaligned@@QEAAJPEAVCBitmap@@IIAEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@II@Z @ 0x180201794
 * Callers:
 ...
 *     ?ReadUnalignedScanline@@YAXPEAEPEBEII@Z @ 0x180201A08 (-ReadUnalignedScanline@@YAXPEAEPEBEII@Z.c)
 */
        ...
        unsigned int a11)
{
  ...
  *((_DWORD *)this + 32) = a9;
  ...
  if ( PixelFormatSize && v16 <= 0x7FFFFFF8u / PixelFormatSize )
  {
    ...
    if ( v19 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0xA3u);
  }
  else
  {
    v17 = 0;
    v19 = -2147024362;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0x98u);
    v18 = 0LL;
    v27 = 0LL;
  }
  v21 = v14 * v17;
  ...
  if ( v25 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v25, 0xD0u);
LABEL_22:
    operator delete(v18);
  }
