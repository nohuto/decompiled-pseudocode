/*
 * XREFs of ?Create@CD3DSurface@@SAJPEAVCD3DResourceManager@@AEBVDWM_TEXTURE2D_DESC@@PEAUD3D11_SUBRESOURCE_DATA@@PEAPEAV1@@Z @ 0x1800C8854
 * Callers:
        ...
        struct CD3DSurface **a4)
{
  ...
  *a4 = 0LL;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, v6, 0x69u);
  }
  else
  {
    ...
    v7 = ViewOfTexture;
    if ( ViewOfTexture < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180240F20, 9u, ViewOfTexture, 0x6Fu);
  }
  ReleaseInterfaceNoNULL<IWICBitmap>((__int64)v10);
  return v7;
}
