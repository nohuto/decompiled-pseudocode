/*
 * XREFs of ??$AddOrUpdateProperty@UD2DVector4@@@CPropertySet@@AEAAJPEBUMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DVector4@@@Z @ 0x1801A2670
 * Callers:
...
LABEL_11:
  ...
  else
  {
    ...
    updated = CPropertySet::UpdateProperty<D2DQuaternion>(v8, v6);
    v4 = updated;
    if ( updated < 0 )
    {
      v10 = 329;
