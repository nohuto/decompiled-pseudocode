/*
 * XREFs of ?_Tidy@?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@AEAAXXZ @ 0x18018B70C
 * Callers:
...
void __fastcall std::vector<CContent::LayoutData>::_Tidy(__int64 a1)
{
  ...
  if ( v2 )
  {
    std::_Deallocate(v2, (*(_QWORD *)(a1 + 16) - (_QWORD)v2) / 40LL, 0x28uLL);
    *(_QWORD *)a1 = 0LL;
    *(_QWORD *)(a1 + 8) = 0LL;
    *(_QWORD *)(a1 + 16) = 0LL;
  }
