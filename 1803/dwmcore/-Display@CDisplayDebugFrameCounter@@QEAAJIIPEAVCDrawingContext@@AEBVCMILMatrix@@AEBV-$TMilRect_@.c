/*
 * XREFs of ?Display@CDisplayDebugFrameCounter@@QEAAJIIPEAVCDrawingContext@@AEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4DebugFrameCounterPosition@1@PEAV4@@Z @ 0x180150DB8
 * Callers:
        ...
        _OWORD *a8)
{
  ...
  *(_OWORD *)v32 = v16;
  if ( !CMILMatrix::IsIdentity<0>((__int64)v27) )
    CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)v27, v17, (float *)v32);
  if ( a7 == 1 )
  {
    v25[0] = _xmm;
    LOWORD(v26) = 32085;
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x40u);
  }
  else
  {
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x43u);
    }
    else
    {
      ...
      if ( v21 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v21, 0x47u);
      }
      else
      {
        ...
        if ( v22 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v22, 0x49u);
        }
        else if ( v11 )
        {
          *(_OWORD *)v32 = *(_OWORD *)v31;
          CMILMatrix::Transform2DBoundsHelper<0>(v11, (__int64)v32, (float *)v31);
        }
      }
