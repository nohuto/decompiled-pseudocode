/*
 * XREFs of ??$GetGradientColorData@VCLinearGradientLegacyMilBrush@@@CGradientLegacyMilBrush@@KAJPEAVCLinearGradientLegacyMilBrush@@PEAVCGradientColorData@@@Z @ 0x1801B2F0C
 * Callers:
        ...
        CGradientColorData *a2)
{
  ...
  *((_DWORD *)a2 + 14) = 0;
  ...
  if ( Opacity < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Opacity, 0xC9u);
  }
  else
  {
    ...
    if ( (unsigned int)(*((_QWORD *)&v7 + 1) >> 4) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0xD8u);
    }
    else
    {
LABEL_5:
