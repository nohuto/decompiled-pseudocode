/*
 * XREFs of ?CreateSecondaryD2DBitmap@CD2DContext@@MEAAJPEAUID3D11Texture2D@@AEBUD3D11_TEXTURE2D_DESC@@AEBUD2D1_BITMAP_PROPERTIES1@@W4DXGI_COLOR_SPACE_TYPE@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x180096AF0
 * Callers:
        ...
        struct CSecondaryD2DBitmap **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x6D3u);
  }
  else
  {
    ...
    v12 = Internal;
    if ( Internal < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Internal, 0x6E0u);
  }
