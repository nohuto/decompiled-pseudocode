/*
 * XREFs of ?CalcLocalToDeviceMatrix@CCompositionLight@@IEBAJPEBVCDrawingContext@@PEBVCMILMatrix@@PEAVCVisual@@PEAV3@3@Z @ 0x180184978
 * Callers:
        ...
        struct CMILMatrix *a6)
{
  ...
  v6 = (const struct CVisualTree *)*((_QWORD *)a2 + 816);
  v24 = 0;
  WorldTransform = CVisual::GetWorldTransform(a4, v6, 3, (__int64)&v20, 0LL, 0LL);
  v9 = WorldTransform;
  if ( WorldTransform < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, WorldTransform, 0xABu);
  }
  else
  {
    v15 = v20;
