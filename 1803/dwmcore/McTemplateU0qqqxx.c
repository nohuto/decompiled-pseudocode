/*
 * XREFs of McTemplateU0qqqxx @ 0x18017CC48
 * Callers:
...
ULONG __fastcall McTemplateU0qqqxx(__int64 a1, __int64 a2, int a3, int a4, char a5, char a6, char a7)
{
  ...
  v18 = 8LL;
  v17 = &a7;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_COMPUTESCRIBBLE_DRAWINFO, 6u, &v8);
}
