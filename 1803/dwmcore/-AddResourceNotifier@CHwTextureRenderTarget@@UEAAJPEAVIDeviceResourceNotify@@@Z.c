/*
 * XREFs of ?AddResourceNotifier@CHwTextureRenderTarget@@UEAAJPEAVIDeviceResourceNotify@@@Z @ 0x1800782E0
 * Callers:
        ...
        struct IDeviceResourceNotify *a2)
{
  ...
  if ( v2 )
  {
    ...
    {
      v7 = DynArrayImpl<0>::AddMultipleAndSet(v2 + 72, 8LL, 1LL, &v8);
      v5 = v7;
      if ( v7 < 0 )
  ...
  {
    v5 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292412, 0x34Au);
  }
