/*
 * XREFs of ?Max@CExpressionValueStack@@QEAAJXZ @ 0x1801BA37C
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Max(CExpressionValueStack *this)
{
  ...
  if ( v1 >= 2 )
  {
    ...
    if ( v6 == *(_DWORD *)(v3 + 8 * v5 + 72) )
    {
      ...
      {
        case 18:
          v14 = fmaxf(*(float *)(v3 + 8 * v4), *(float *)(v3 + 8 * v5));
          *(_DWORD *)(v3 + 8 * v4 + 72) = 18;
          *(float *)(v3 + 8 * v4) = v14;
          break;
        case 35:
          v12 = fmaxf(*(float *)(v3 + 8 * v4), *(float *)(v3 + 8 * v5));
          v13 = fmaxf(*(float *)(v3 + 8 * v4 + 4), *(float *)(v3 + 8 * v5 + 4));
        ...
        case 52:
          ...
          v19 = *(_QWORD *)(v3 + 8 * v5);
          v9.m128_f32[0] = fmaxf(*(float *)&v17, *(float *)&v19);
          v10.m128_f32[0] = fmaxf(*((float *)&v17 + 1), *((float *)&v19 + 1));
          v11 = fmaxf(*(float *)(v3 + 8 * v4 + 8), *(float *)(v3 + 8 * v5 + 8));
