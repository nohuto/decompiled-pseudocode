/*
 * XREFs of ??$emplace_back@AEBQEAUObserver@CProcessAttributionManager@@@?$vector@PEAUObserver@CProcessAttributionManager@@V?$allocator@PEAUObserver@CProcessAttributionManager@@@std@@@std@@QEAAXAEBQEAUObserver@CProcessAttributionManager@@@Z @ 0x1800C8000
 * Callers:
...
__int64 __fastcall std::vector<CProcessAttributionManager::Observer *>::emplace_back<CProcessAttributionManager::Observer * const &>(
        __int64 a1,
        __int64 *a2)
{
  __int64 *v2; // rax
  ...
  if ( v2 == v4 )
  {
    ...
    v10 = (_QWORD *)std::_Allocate<std::_Default_allocate_traits<1>>(v9, 8uLL);
    v10[v6] = *a2;
    memmove(v10, *(const void **)a1, *(_QWORD *)(a1 + 8) - *(_QWORD *)a1);
    return std::vector<CVectorShape *>::_Change_array(a1, (__int64)v10, v6 + 1, v9);
  }
  else
  {
    result = *a2;
