/*
 * XREFs of ?ApplyTextureToLocalTransform@CWindowNode@@AEAAJPEAVIImageSource@@PEAVCMILMatrix@@@Z @ 0x180017568
 * Callers:
        ...
        struct CMILMatrix *a3)
{
  ...
  *((_DWORD *)a3 + 16) = v9;
  ...
  if ( a2 == (struct IImageSource *)((*((_QWORD *)this + 108) + 64LL) & -(__int64)(*((_QWORD *)this + 108) != 0LL)) )
  {
    CMILMatrix::Translate(
      a3,
      (float)(*((_DWORD *)this + 168) - *((_DWORD *)this + 172)),
      (float)(*((_DWORD *)this + 169) - *((_DWORD *)this + 173)));
    v13 = *(_QWORD *)(*((_QWORD *)this + 108) + 96LL);
    if ( !v13 || *(_DWORD *)(v13 + 168) == 1 )
    {
      if ( *((_BYTE *)this + 920) )
        CMILMatrix::Translate(
          a3,
          (float)((float)(*((_DWORD *)this + 170) - *((_DWORD *)this + 172))
                - (float)(*((_DWORD *)this + 168) - *((_DWORD *)this + 172)))
        - (float)(v25 - v23),
          0.0);
    }
    else
    {
      ...
      if ( *((_DWORD *)this + 170) - *((_DWORD *)this + 168) >= 0 )
        v14 = *((_DWORD *)this + 170) - *((_DWORD *)this + 168);
      v16 = (float)v14;
      v17 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)((float)v14 - v15)) & _xmm);
      if ( v17 > 0.00390625 )
        goto LABEL_12;
      v18 = 0;
      if ( *((_DWORD *)this + 171) - *((_DWORD *)this + 169) >= 0 )
        v18 = *((_DWORD *)this + 171) - *((_DWORD *)this + 169);
...
LABEL_12:
        ...
        {
          if ( *((_DWORD *)this + 171) - *((_DWORD *)this + 169) >= 0 )
            v6 = *((_DWORD *)this + 171) - *((_DWORD *)this + 169);
          v21[2] = _xmm;
          v22 = 32085;
          v21[1] = _xmm;
          v21[3] = _xmm;
