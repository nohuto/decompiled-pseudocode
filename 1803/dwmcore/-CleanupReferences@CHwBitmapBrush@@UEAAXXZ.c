/*
 * XREFs of ?CleanupReferences@CHwBitmapBrush@@UEAAXXZ @ 0x1801F49C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CHwBitmapBrush::CleanupReferences(CHwBitmapBrush *this)
{
  ...
  if ( *((_QWORD *)this + 4) )
  {
    v3 = *((_QWORD *)this + 1);
    v5 = 0LL;
    if ( (int)CD2DContext::GetCachedEffectNoRef(v3, 0, &v5) >= 0 )
      (*(void (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v5 + 112LL))(v5, 0LL, 0LL, 1LL);
    if ( (int)CD2DContext::GetCachedEffectNoRef(*((_QWORD *)this + 1), 3u, &v5) >= 0 )
      (*(void (__fastcall **)(__int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v5 + 112LL))(v5, 0LL, 0LL, 1LL);
    v4 = *((_QWORD *)this + 4);
    if ( v4 )
    {
