/*
 * XREFs of ?InternalAddRef@?$ComPtr@VCInteraction@@@WRL@Microsoft@@IEBAXXZ @ 0x180026454
 * Callers:
 ...
 * Callees:
 *     ?AddRef@Dwm3DRECompositorThunk@@UEAAKXZ @ 0x180028200 (-AddRef@Dwm3DRECompositorThunk@@UEAAKXZ.c)
 */

void __fastcall Microsoft::WRL::ComPtr<CInteraction>::InternalAddRef(Dwm3DRECompositorThunk **a1)
{
  Dwm3DRECompositorThunk *v1; // rcx
  void (*v2)(void); // rax
  ...
  {
    v2 = **(void (***)(void))v1;
    if ( (char *)v2 == (char *)Dwm3DRECompositorThunk::AddRef )
      Dwm3DRECompositorThunk::AddRef(v1);
    else
      v2();
  }
}
