/*
 * XREFs of ?UnlockDrawlistEntryRange@CCallbackRendererManager@@QEAAXPEAUID2D1PrivateCompositorRenderer@@II@Z @ 0x18013F854
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( (*((_DWORD *)this + 26))-- == 1 )
  {
    ...
    if ( v11 <= *((_DWORD *)this + 6) )
      v11 = *((_DWORD *)this + 6);
    v13 = *((_DWORD *)this + 14) - *((_DWORD *)this + 29);
    *((_DWORD *)this + 28) = v11;
    v14 = *((_DWORD *)this + 30);
    *((_DWORD *)this + 29) = v12;
    v15 = *((_DWORD *)this + 22);
