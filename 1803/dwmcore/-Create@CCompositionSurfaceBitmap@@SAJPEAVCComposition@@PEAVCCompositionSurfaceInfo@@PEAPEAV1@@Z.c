/*
 * XREFs of ?Create@CCompositionSurfaceBitmap@@SAJPEAVCComposition@@PEAVCCompositionSurfaceInfo@@PEAPEAV1@@Z @ 0x180186C58
 * Callers:
        ...
        struct CCompositionSurfaceBitmap **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 )
  {
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x24u);
