/*
 * XREFs of ?AddMultipleAndSet@?$DynArray@UDesktopPlaneInfo@COverlayContext@@$0A@@@QEAAJPEFBUDesktopPlaneInfo@COverlayContext@@I@Z @ 0x18016389C
 * Callers:
...
__int64 __fastcall DynArray<COverlayContext::DesktopPlaneInfo,0>::AddMultipleAndSet(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  unsigned int v4; // r8d
  unsigned int v5; // ebx
  ...
  {
    v7 = DynArrayImpl<0>::AddMultipleAndSet(a1, 0x78u, 1, a2);
    v5 = v7;
    if ( v7 < 0 )
