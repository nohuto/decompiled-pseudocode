/*
 * XREFs of ?OnAddDataSourceError@BamoDataProviderProxy@@UEAAJI@Z @ 0x180169850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataProviderProxy::OnAddDataSourceError(BamoDataProviderProxy *this, unsigned int a2)
{
  ...
  v4 = BamoImpl::BamoDataProviderProxyImpl::OnAddDataSourceError((BamoDataProviderProxy *)((char *)this + 8), a2);
  if ( v6 )
