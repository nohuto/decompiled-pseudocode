/*
 * XREFs of ?CalculateInertiaValueWorker@CInteractionTrackerPositionAnimation@@MEAAJPEAVCExpressionValueStack@@_KMPEAM@Z @ 0x1801BF380
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AdvanceInertiaToTime@CPositionMotion@@QEAAMPEAVCExpressionValueStack@@_KMMMMMM@Z @ 0x1801C51B4 (-AdvanceInertiaToTime@CPositionMotion@@QEAAMPEAVCExpressionValueStack@@_KMMMMMM@Z.c)
 */
        ...
        float *a5)
{
  ...
  *v6 = v18;
  ...
  if ( dword_1802D3FE0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 2uLL) )
  {
    ...
    v35 = v21;
    v38 = v21;
    TlgWrite((TraceLoggingHProvider)&dword_1802D3FE0, &unk_1802A96C8, 0LL, 0LL, 7u, &pData);
  }
  return 0LL;
}
