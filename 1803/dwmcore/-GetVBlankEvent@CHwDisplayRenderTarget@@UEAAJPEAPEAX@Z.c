/*
 * XREFs of ?GetVBlankEvent@CHwDisplayRenderTarget@@UEAAJPEAPEAX@Z @ 0x180046730
 * Callers:
 ...
 *     ?GetVBlankEvent@CDWMSwapChain@@UEAAJPEAPEAX@Z @ 0x18007CF40 (-GetVBlankEvent@CDWMSwapChain@@UEAAJPEAPEAX@Z.c)
...
__int64 __fastcall CHwDisplayRenderTarget::GetVBlankEvent(CHwDisplayRenderTarget *this, void **a2)
{
  ...
  {
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18023A090, 1u, v6, 0x290u);
    return v9;
  }
  ...
  v9 = VBlankEvent;
  if ( VBlankEvent < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_18023A090, 1u, VBlankEvent, 0x292u);
  return v9;
}
