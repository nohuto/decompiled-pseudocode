/*
 * XREFs of ?ApplyState@CD2DLayer@@UEAAJPEAVCDrawingContext@@@Z @ 0x180024DA0
 * Callers:
...
__int64 __fastcall CD2DLayer::ApplyState(CD2DLayer *this, struct CDrawingContext *a2)
{
  ...
  void (__usercall *v8)(CD2DContext *__hidden@<rcx>, const struct ID2DContextOwner *@<rdx>, const struct D2D_RECT_F *@<r8>, struct ID2D1Geometry *@<r9>, struct D2D_MATRIX_3X2_F *, float, enum D2D1_ANTIALIAS_MODE, enum D2D1_LAYER_OPTIONS1, enum D2D1_PRIMITIVE_BLEND); // rax
  ...
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
    McTemplateU0qqqq(
      ...
      (int)*((float *)this + 4),
      (int)*((float *)this + 5));
  v5 = (CD2DContext *)*((_QWORD *)a2 + 48);
  v6 = (const struct ID2DContextOwner *)(((unsigned __int64)a2 + 8) & -(__int64)(a2 != 0LL));
  v7 = (struct ID2D1Geometry *)*((_QWORD *)this + 3);
  v14 = *((_DWORD *)this + 18);
  v13 = *((_DWORD *)this + 17);
  v12 = *((_DWORD *)this + 16);
  v11 = *((float *)this + 15);
  v8 = *(void (__usercall **)(CD2DContext *__hidden@<rcx>, const struct ID2DContextOwner *@<rdx>, const struct D2D_RECT_F *@<r8>, struct ID2D1Geometry *@<r9>, struct D2D_MATRIX_3X2_F *, float, enum D2D1_ANTIALIAS_MODE, enum D2D1_LAYER_OPTIONS1, enum D2D1_PRIMITIVE_BLEND))(*(_QWORD *)v5 + 56LL);
  v10 = (struct D2D_MATRIX_3X2_F *)(((unsigned __int64)this + 32) & -(__int64)(*((_BYTE *)this + 56) != 0));
  if ( v8 == CD2DContext::PushLayer )
    CD2DContext::PushLayer(v5, v6, v2, v7, v10, v11, v12, v13, v14);
  else
    ((void (__fastcall *)(CD2DContext *, const struct ID2DContextOwner *, const struct D2D_RECT_F *, struct ID2D1Geometry *, struct D2D_MATRIX_3X2_F *, _DWORD, enum D2D1_ANTIALIAS_MODE, enum D2D1_LAYER_OPTIONS1, enum D2D1_PRIMITIVE_BLEND))v8)(
      v5,
      v6,
      v2,
      v7,
