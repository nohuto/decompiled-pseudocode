/*
 * XREFs of ?HrFindInterface@CHwStereoFullScreenRenderTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801F14F0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  if ( a3 )
  {
    ...
    {
      *a3 = (void *)(((unsigned __int64)this + 440) & -(__int64)(this != (CHwStereoFullScreenRenderTarget *)160));
      return 0LL;
    }
  }
  return result;
