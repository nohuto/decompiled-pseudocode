/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DQuaternion@@@Z @ 0x1801A24D8
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this) )
  {
    ...
    v3 = CoreUICallSend(v8, v11, 2LL, 12LL, 5, &unk_180239CFC);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x1A3u);
  }
