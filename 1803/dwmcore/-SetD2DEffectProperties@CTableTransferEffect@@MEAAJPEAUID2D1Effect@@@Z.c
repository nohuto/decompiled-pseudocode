/*
 * XREFs of ?SetD2DEffectProperties@CTableTransferEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1801A5F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTableTransferEffect::SetD2DEffectProperties(CTableTransferEffect *this, struct ID2D1Effect *a2)
{
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x3Au);
  }
  else
  {
    ...
    else
    {
      ...
      else
      {
        ...
        else
        {
          ...
          if ( v9 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x51u);
          }
          else
          {
            ...
            else
            {
              ...
              if ( v11 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x5Bu);
              }
              else
              {
                ...
                if ( v12 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x60u);
                }
                else
                {
                  ...
                  v5 = v13;
                  if ( v13 < 0 )
                    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x65u);
                }
              }
            }
          }
