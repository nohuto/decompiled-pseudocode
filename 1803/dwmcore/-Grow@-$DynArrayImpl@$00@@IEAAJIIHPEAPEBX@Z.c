/*
 * XREFs of ?Grow@?$DynArrayImpl@$00@@IEAAJIIHPEAPEBX@Z @ 0x1800CCF9C
 * Callers:
...
__int64 __fastcall DynArrayImpl<1>::Grow(__int64 a1, unsigned int a2, int a3, int a4, unsigned __int64 *a5)
{
  ...
  if ( v5 + a3 < v5 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0xE7u);
    return v11;
  }
  v12 = *(_DWORD *)(a1 + 20);
  if ( v10 > v12 )
  {
    ...
    if ( v13 > 0xFFFFFFFF )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0xF0u);
      return v11;
    }
    if ( a4 )
      goto LABEL_36;
...
LABEL_36:
    ...
    else
    {
      ...
      if ( *(_QWORD *)a1 == *(_QWORD *)(a1 + 8) )
      {
        ...
        if ( (v11 & 0x80000000) != 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x111u);
          return v11;
        }
        v22 = *(_DWORD *)(a1 + 24);
        if ( v22 )
      ...
      else
      {
        ...
        {
          v11 = -2147024882;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x12Au);
          return v11;
        }
        v11 = 0;
        if ( v24 != *(char **)a1 )
        {
          ...
          {
            v25 = *a5;
            if ( *a5 >= *(_QWORD *)a1 && v25 < *(_QWORD *)a1 + (unsigned __int64)(a2 * *(_DWORD *)(a1 + 20)) )
              *a5 = (unsigned __int64)&v24[v25 - *(_QWORD *)a1];
          }
        }
      }
