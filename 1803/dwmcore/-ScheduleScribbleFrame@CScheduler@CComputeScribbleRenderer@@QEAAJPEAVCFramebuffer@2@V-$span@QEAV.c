/*
 * XREFs of ?ScheduleScribbleFrame@CScheduler@CComputeScribbleRenderer@@QEAAJPEAVCFramebuffer@2@V?$span@QEAVCComputeScribble@@$0?0@gsl@@_KI@Z @ 0x18021E2F8
 * Callers:
        ...
        int a5)
{
  ...
  if ( !WaitForSingleObject(this[6].Ptr, 0) )
  {
    v9 = -2147467259;
    v10 = 167LL;
LABEL_3:
  ...
  v15 = *a3;
  CComputeScribbleRenderer::CScheduler::GetWakeupTimeBeforeVBlank((__int64)this, &v15, &v20, v14);
  v12 = v20;
  v13 = a5;
  while ( v12 > *(float *)&this[5].Ptr )
  {
    v12 = v12 - *(float *)&this[5].Ptr;
    --v13;
  }
