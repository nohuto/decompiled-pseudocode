/*
 * XREFs of ?ProcessExclusiveSurfaceUpdate@CHolographicExclusiveView@@AEAA_NIPEAUEXCLUSIVE_SURFACE_UPDATE@@@Z @ 0x1801FA050
 * Callers:
        ...
        struct EXCLUSIVE_SURFACE_UPDATE *a3)
{
  ...
  if ( AnalogExclusiveSurfaceUpdates >= 0 )
  {
    if ( v14 )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x1D0u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, AnalogExclusiveSurfaceUpdates | 0x10000000, 0x1C6u);
  }
  return v3;
}
