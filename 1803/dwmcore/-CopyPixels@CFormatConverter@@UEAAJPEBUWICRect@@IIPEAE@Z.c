/*
 * XREFs of ?CopyPixels@CFormatConverter@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x180201E50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_45:
  ...
  v12 = HrCheckBufferSize(*((_DWORD *)this + 17), a3, a2, a4);
  v10 = v12;
  if ( v12 < 0 )
  {
    v27 = 249;
LABEL_44:
  ...
  Y = a2->Y;
  X = a2->X;
  if ( (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v13 + 56LL))(v13) - 2 <= 1 )
  {
  ...
  if ( v32 )
  {
    v36[0] = 0LL;
    v28 = 0;
    v12 = (*(__int64 (__fastcall **)(__int64, unsigned int *, unsigned __int8 **))(*(_QWORD *)v32 + 48LL))(
            v32,
            &v28,
            v36);
    v10 = v12;
    ...
    {
      v12 = (*(__int64 (__fastcall **)(__int64, unsigned int *, unsigned int *))(*(_QWORD *)v32 + 32LL))(v32, v31, &v34);
      v10 = v12;
      if ( v12 < 0 )
      {
        v27 = 292;
      ...
      {
        v12 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v32 + 40LL))(v32, &v33);
        v10 = v12;
        if ( v12 < 0 )
        {
          v27 = 298;
  ...
  *(struct WICRect *)v36 = *a2;
  ...
  while ( Y < v25 )
  {
    v12 = (*(__int64 (__fastcall **)(_QWORD, unsigned __int8 **, _QWORD, _QWORD, _QWORD))(**((_QWORD **)this + 6) + 48LL))(
            *((_QWORD *)this + 6),
            v36,
...
LABEL_46:
  ReleaseInterfaceNoNULL<IWICBitmap>(v32);
  if ( v10 < 0 )
