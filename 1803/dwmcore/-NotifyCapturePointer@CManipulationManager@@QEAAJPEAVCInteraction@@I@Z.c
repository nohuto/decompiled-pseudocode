/*
 * XREFs of ?NotifyCapturePointer@CManipulationManager@@QEAAJPEAVCInteraction@@I@Z @ 0x1801CEC60
 * Callers:
        ...
        int a3)
{
  ...
  if ( v8 )
  {
    *(_DWORD *)v8 = 5;
    ...
    Microsoft::WRL::ComPtr<CInteraction>::operator=((Dwm3DRECompositorThunk **)(v8 + 16), a2);
    *(_DWORD *)(v8 + 28) = 0;
    *(_QWORD *)(v8 + 32) = 0LL;
    *(_DWORD *)(v8 + 24) = a3;
  ...
  {
    v9 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x14Au);
  }
  return v9;
}
