/*
 * XREFs of ?InferVisualToTextureTransform@CLinearGradientBrush@@AEBAJAEAY02$$CBUD2D_POINT_2F@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x180011930
 * Callers:
 ...
 * Callees:
 *     ?InferAffineMatrix@CMILMatrix@@QEAAXAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBUMilPoint2F@@@Z @ 0x18000F2E4 (-InferAffineMatrix@CMILMatrix@@QEAAXAEBV-$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@Re.c)
...
__int64 __fastcall CLinearGradientBrush::InferVisualToTextureTransform(__int64 a1, float *a2, __int64 a3)
{
  ...
  *(_QWORD *)&v6->m[2][0] = v5;
  ...
  {
    v7 = -2003304441;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, (const int *const)"\a", 1u, -2003304441, 0x135u);
  }
  return v7;
}
