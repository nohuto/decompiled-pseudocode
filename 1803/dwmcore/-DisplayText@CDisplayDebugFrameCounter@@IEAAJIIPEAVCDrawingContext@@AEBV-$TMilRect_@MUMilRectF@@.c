/*
 * XREFs of ?DisplayText@CDisplayDebugFrameCounter@@IEAAJIIPEAVCDrawingContext@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4DebugFrameCounterPosition@1@PEAV3@@Z @ 0x1801510AC
 * Callers:
        ...
        __int64 a7)
{
  ...
  *(struct _D3DCOLORVALUE *)&v10.r = (struct _D3DCOLORVALUE)_xmm;
  ...
  if ( v15 )
  {
    ...
    if ( Factory < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Factory, 0x9Cu);
      return v17;
    }
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0xABu);
      return v17;
    }
  ...
  *(struct _D3DCOLORVALUE *)&v24.r = *(struct _D3DCOLORVALUE *)&v10.r;
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0xC3u);
  }
  else
  {
    *(struct _D3DCOLORVALUE *)&v24.r = (struct _D3DCOLORVALUE)_xmm;
