/*
 * XREFs of ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800C06DC
 * Callers:
...
char __fastcall CCommonRegistryData::IsShaderLinkingBlacklistedGpu(int a1, unsigned __int16 a2)
{
  ...
  else
  {
    ...
    CCommonRegistryData::m_rgwShaderLinkingBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_1802773D4;
    v6 = 0;
  }
  if ( !v6 )
    return 0;
