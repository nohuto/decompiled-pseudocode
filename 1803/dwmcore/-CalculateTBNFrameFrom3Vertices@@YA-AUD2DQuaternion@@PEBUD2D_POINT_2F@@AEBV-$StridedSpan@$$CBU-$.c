/*
 * XREFs of ?CalculateTBNFrameFrom3Vertices@@YA?AUD2DQuaternion@@PEBUD2D_POINT_2F@@AEBV?$StridedSpan@$$CBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@AEBVCMILMatrix@@2@Z @ 0x18000E340
 * Callers:
 ...
 *     CalculateTBNFrame @ 0x18000E6F8 (CalculateTBNFrame.c)
        ...
        float *a5)
{
  ...
  float v19; // xmm1_4
  float v20; // xmm0_4
  float v22; // [rsp+38h] [rbp-D0h]
  _QWORD v23[3]; // [rsp+40h] [rbp-C8h] BYREF
  _QWORD v24[3]; // [rsp+58h] [rbp-B0h] BYREF
  float v25; // [rsp+70h] [rbp-98h] BYREF
  float v26; // [rsp+74h] [rbp-94h]
  float v27; // [rsp+78h] [rbp-90h]
  float v28; // [rsp+80h] [rbp-88h] BYREF
  float v29; // [rsp+84h] [rbp-84h]
  float v30; // [rsp+88h] [rbp-80h]
  float v31; // [rsp+90h] [rbp-78h] BYREF
  float v32; // [rsp+94h] [rbp-74h]
  ...
  v23[1] = v9 + v5 + 16;
  v23[0] = v5 + 16;
  v23[2] = 2 * (int)v9 + v5 + 16;
  CalculateTBNFrame((unsigned int)v24, (unsigned int)v23, (unsigned int)&v25, (unsigned int)&v31, (__int64)&v28);
  v10 = (float)((float)(*a4 * v31) + (float)(a4[4] * v32)) + (float)(a4[8] * v33);
  v11 = (float)((float)(a4[1] * v31) + (float)(a4[5] * v32)) + (float)(a4[9] * v33);
  v12 = (float)((float)(a4[2] * v31) + (float)(a4[6] * v32)) + (float)(a4[10] * v33);
  v22 = (float)((float)(*a4 * v28) + (float)(a4[4] * v29)) + (float)(a4[8] * v30);
  v13 = (float)((float)(a4[5] * v29) + (float)(a4[1] * v28)) + (float)(a4[9] * v30);
  v14 = (float)((float)(a4[6] * v29) + (float)(a4[2] * v28)) + (float)(a4[10] * v30);
  v15 = (float)((float)(a5[4] * 0.0) + (float)(*a5 * 0.0)) + a5[8];
  v16 = (float)((float)(a5[5] * 0.0) + (float)(a5[1] * 0.0)) + a5[9];
  v17 = (float)((float)(a5[6] * 0.0) + (float)(a5[2] * 0.0)) + a5[10];
  v18 = sqrtf_0((float)((float)(v11 * v11) + (float)(v10 * v10)) + (float)(v12 * v12));
  v33 = v12 * (float)(1.0 / v18);
  v31 = v10 * (float)(1.0 / v18);
  v32 = v11 * (float)(1.0 / v18);
  v19 = 1.0 / sqrtf_0((float)((float)(v13 * v13) + (float)(v22 * v22)) + (float)(v14 * v14));
  v28 = v22 * v19;
  v29 = v13 * v19;
  v30 = v14 * v19;
  v20 = sqrtf_0((float)((float)(v16 * v16) + (float)(v15 * v15)) + (float)(v17 * v17));
  v25 = v15 * (float)(1.0 / v20);
  v26 = v16 * (float)(1.0 / v20);
  v27 = v17 * (float)(1.0 / v20);
  EncodeTBNFrameToQuaternion(a1, &v31, &v28, &v25);
  return a1;
}
