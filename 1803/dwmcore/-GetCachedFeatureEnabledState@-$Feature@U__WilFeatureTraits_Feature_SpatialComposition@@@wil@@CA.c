/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_SpatialComposition@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800BA830
 * Callers:
        ...
        enum FEATURE_CHANGE_TIME a3)
{
  ...
  {
    FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0xDDF778, a2, a3);
    ...
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      &`wil::Feature<__WilFeatureTraits_Feature_SpatialComposition>::GetFeaturePropertyCache'::`2'::data,
      0LL);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(14546808LL, 0LL, v13) )
    {
      if ( v3 )
      {
        v11 = v7;
