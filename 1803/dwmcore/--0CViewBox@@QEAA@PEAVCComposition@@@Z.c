/*
 * XREFs of ??0CViewBox@@QEAA@PEAVCComposition@@@Z @ 0x18016D8DC
 * Callers:
 ...
 * Callees:
 *     ??0CComponentTransform2D@@QEAA@PEAVCComposition@@@Z @ 0x1800970C8 (--0CComponentTransform2D@@QEAA@PEAVCComposition@@@Z.c)
 */
