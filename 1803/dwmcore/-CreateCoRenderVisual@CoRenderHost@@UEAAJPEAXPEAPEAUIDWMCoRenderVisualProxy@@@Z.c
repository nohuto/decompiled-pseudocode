/*
 * XREFs of ?CreateCoRenderVisual@CoRenderHost@@UEAAJPEAXPEAPEAUIDWMCoRenderVisualProxy@@@Z @ 0x180148500
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDWMCoRenderVisualProxy **a3)
{
  ...
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x166u);
  else
    *a3 = v7;
  return v5;
}
