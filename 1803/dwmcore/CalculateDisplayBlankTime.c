/*
 * XREFs of CalculateDisplayBlankTime @ 0x18021D30C
 * Callers:
...
LABEL_18:
  if ( v10 )
  {
    std::_Deallocate(v10, (v21 - (__int64)v10) >> 6, 0x40uLL);
    v21 = 0LL;
    *(_OWORD *)v20 = 0LL;
  }
  if ( pathArray[0] )
    std::_Deallocate((char *)pathArray[0], (signed __int64)(v23 - (unsigned __int64)pathArray[0]) / 72, 0x48uLL);
  return v12;
}
