/*
 * XREFs of ??$FillSingleTexelGradientSpan@I@CGradientTextureGenerator@@CAXPEAPEAUMILGradientStop@@0PEBU1@W4Enum@MilColorInterpolationMode@@HMMPEAI@Z @ 0x180220480
 * Callers:
 ...
 *     ?AddWeightedStopPairContribution@CGradientTextureGenerator@@CAXPEBUMILGradientStop@@0MMMPEAU_D3DCOLORVALUE@@@Z @ 0x180220A00 (-AddWeightedStopPairContribution@CGradientTextureGenerator@@CAXPEBUMILGradientStop@@0MMMPEAU_D3D.c)
 *     ?MoveToNextStopPair@CGradientTextureGenerator@@CAHPEAPEAUMILGradientStop@@0PEBU2@@Z @ 0x18022139C (-MoveToNextStopPair@CGradientTextureGenerator@@CAHPEAPEAUMILGradientStop@@0PEBU2@@Z.c)
 */
