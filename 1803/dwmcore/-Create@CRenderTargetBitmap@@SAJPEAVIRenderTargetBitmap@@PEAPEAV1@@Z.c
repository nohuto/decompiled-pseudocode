/*
 * XREFs of ?Create@CRenderTargetBitmap@@SAJPEAVIRenderTargetBitmap@@PEAPEAV1@@Z @ 0x1800C65E0
 * Callers:
 ...
 *     ??0CRenderTargetBitmap@@IEAA@_N@Z @ 0x18008A55C (--0CRenderTargetBitmap@@IEAA@_N@Z.c)
        ...
        struct CRenderTargetBitmap **a2)
{
  ...
  v4 = (*a1)[17]((struct IRenderTargetBitmap *)a1, (GUID *)&v10, 0LL);
  v5 = v4;
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x16u);
  }
  else
  {
