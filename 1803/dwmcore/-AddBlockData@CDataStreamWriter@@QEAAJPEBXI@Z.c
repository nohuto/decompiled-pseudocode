/*
 * XREFs of ?AddBlockData@CDataStreamWriter@@QEAAJPEBXI@Z @ 0x180087C98
 * Callers:
 ...
 *     ?GetWritePointer@CDataStreamBlock@@UEAAPEAEXZ @ 0x180088420 (-GetWritePointer@CDataStreamBlock@@UEAAPEAEXZ.c)
