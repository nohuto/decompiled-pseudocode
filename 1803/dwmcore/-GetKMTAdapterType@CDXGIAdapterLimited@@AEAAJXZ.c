/*
 * XREFs of ?GetKMTAdapterType@CDXGIAdapterLimited@@AEAAJXZ @ 0x1800CB028
 * Callers:
...
LABEL_13:
  ...
  v8 = (unsigned int)v13 | 0xF00000000LL;
  v9 = &v11;
  LODWORD(v10) = 4;
  ...
  {
    v4 = v5 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5 | 0x10000000, 0xEDu);
  }
  else
  {
    *((_DWORD *)this + 90) = v11;
