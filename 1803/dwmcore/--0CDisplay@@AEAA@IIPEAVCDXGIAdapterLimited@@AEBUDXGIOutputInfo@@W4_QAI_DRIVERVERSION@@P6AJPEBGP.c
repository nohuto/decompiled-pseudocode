/*
 * XREFs of ??0CDisplay@@AEAA@IIPEAVCDXGIAdapterLimited@@AEBUDXGIOutputInfo@@W4_QAI_DRIVERVERSION@@P6AJPEBGPEAUDXGI_MODE_DESC@@@Z@Z @ 0x1800B78AC
 * Callers:
...
__int64 __fastcall CDisplay::CDisplay(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6, __int64 a7)
{
  ...
  bool v25; // zf
  __int64 result; // rax
  _BYTE v27[176]; // [rsp+30h] [rbp-91h] BYREF
  ...
  *(_BYTE *)(a1 + 232) = v9 != 0;
  if ( v9 )
    *(_QWORD *)(a1 + 240) = a7;
  *(_QWORD *)(a1 + 248) = *(_QWORD *)(a4 + 336);
  *(_DWORD *)(a1 + 256) = *(_DWORD *)(a5 + 120);
  *(_DWORD *)(a1 + 64) = *(_DWORD *)(a5 + 124);
  *(_DWORD *)(a1 + 264) = *(_DWORD *)(a5 + 128);
  *(_DWORD *)(a1 + 260) = *(_DWORD *)(a5 + 104);
  *(_QWORD *)(a1 + 16) = *(_QWORD *)(a5 + 104);
  *(_QWORD *)(a1 + 152) = 0LL;
  *(_QWORD *)(a1 + 24) = a4;
  (**(void (__fastcall ***)(__int64))a4)(a4);
  SetInterface<IRenderTargetBitmap,IRenderTargetBitmap>((_QWORD *)(a1 + 32), *(_QWORD *)a5);
  v10 = *(_QWORD *)(a5 + 8);
  *(_QWORD *)(a1 + 40) = v10;
  if ( v10 )
  ...
  v11 = (_WORD *)(a1 + 160);
  v12 = 32LL;
  *(_BYTE *)(a1 + 324) = (*(_DWORD *)(a5 + 200) & 4) != 0;
  *(_BYTE *)(a1 + 325) = (*(_DWORD *)(a5 + 200) & 8) != 0;
  do
  {
  ...
  *(_DWORD *)(a1 + 272) = *(_DWORD *)(a4 + 296);
  *(_DWORD *)(a1 + 276) = *(_DWORD *)(a4 + 300);
  *(_DWORD *)(a1 + 280) = *(_DWORD *)(a5 + 140);
  *(_DWORD *)(a1 + 284) = *(_DWORD *)(a5 + 144);
  DefaultSRGBFormat = CDisplay::GetDefaultSRGBFormat();
  v16 = *(_QWORD *)(a1 + 40);
  *(_DWORD *)(a1 + 296) = DefaultSRGBFormat;
  *(_DWORD *)(a1 + 308) = 0;
  *(_DWORD *)(a1 + 288) = *(_DWORD *)(a5 + 152);
  *(_DWORD *)(a1 + 292) = *(_DWORD *)(a5 + 156);
  *(_DWORD *)(a1 + 312) = *(_DWORD *)(a5 + 160);
  *(_DWORD *)(a1 + 300) = *(_DWORD *)(a5 + 164);
  *(_DWORD *)(a1 + 304) = 0;
  v17 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v16 + 24LL))(v16);
  v18 = *(_QWORD *)(a1 + 40);
  *(_BYTE *)(a1 + 328) = v17 != 0;
  (*(void (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v18 + 32LL))(v18, v27);
  v19 = 0;
  v20 = v27[88] & 1;
  *(_QWORD *)(a1 + 88) = 0LL;
  *(_BYTE *)(a1 + 329) = v20;
  ...
  *(_OWORD *)(a1 + 104) = *(_OWORD *)(a5 + 168);
  ...
  if ( *(_DWORD *)(a1 + 132) - *(_DWORD *)(a1 + 124) >= 0 )
    v24 = *(_DWORD *)(a1 + 132) - *(_DWORD *)(a1 + 124);
  if ( v24 != v23 )
LABEL_21:
    *(_BYTE *)(a1 + 326) = 1;
  *(_DWORD *)(a1 + 268) = a6;
  *(_BYTE *)(a1 + 316) = (*(_DWORD *)(a5 + 200) & 0x10) != 0;
  v25 = (*(unsigned int (__fastcall **)(_QWORD))(**(_QWORD **)(a1 + 40) + 80LL))(*(_QWORD *)(a1 + 40)) == 0;
  result = a1;
  *(_BYTE *)(a1 + 317) = !v25;
  return result;
}
