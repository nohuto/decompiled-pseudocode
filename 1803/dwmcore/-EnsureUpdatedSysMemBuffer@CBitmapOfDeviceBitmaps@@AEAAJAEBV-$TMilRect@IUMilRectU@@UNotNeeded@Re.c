/*
 * XREFs of ?EnsureUpdatedSysMemBuffer@CBitmapOfDeviceBitmaps@@AEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801E8D7C
 * Callers:
...
LABEL_38:
    ...
    if ( !TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::IsEmpty(&v32) )
    {
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x58Cu);
        v2 = v37;
        goto LABEL_45;
      }
      v2 = v37;
      ...
      if ( v20 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x58Fu);
        goto LABEL_45;
      }
      v22 = 0;
      v23 = 0;
      if ( *(_QWORD *)(v8 + 40) )
      {
        ...
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x59Bu);
          goto LABEL_45;
        }
        v25 = *(_QWORD *)(v8 + 48);
        v22 = *(_DWORD *)(v25 + 8);
      ...
      if ( v26 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v26, 0x5A8u);
        goto LABEL_45;
      }
      if ( v31 )
        goto LABEL_34;
...
LABEL_45:
  ReleaseInterfaceNoNULL<IWICBitmap>(v38);
