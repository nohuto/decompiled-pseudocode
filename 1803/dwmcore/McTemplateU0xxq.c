/*
 * XREFs of McTemplateU0xxq @ 0x18015DBF4
 * Callers:
...
ULONG McTemplateU0xxq(__int64 a1, const EVENT_DESCRIPTOR *a2, ...)
{
  ...
  va_copy(v8, va2);
  v9 = 4LL;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, a2, 4u, &v3);
}
