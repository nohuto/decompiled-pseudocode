/*
 * XREFs of ?DwmHolographicDisplayAdd_@CompositorTracing@@QEAAXI@Z @ 0x1801F8244
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicDisplayAdd_(CompositorTracing *this, int a2)
{
  ...
  if ( *(_DWORD *)v2 > 4u )
  {
    if ( TlgKeywordOn(v2, 0x400000000000uLL) )
    {
      ...
      v5 = &v8;
      v6 = 4;
      TlgWrite(v3, &unk_1802ABBA3, 0LL, 0LL, 3u, &pData);
    }
  }
}
