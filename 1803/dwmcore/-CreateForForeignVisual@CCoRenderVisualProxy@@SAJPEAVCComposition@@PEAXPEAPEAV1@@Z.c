/*
 * XREFs of ?CreateForForeignVisual@CCoRenderVisualProxy@@SAJPEAVCComposition@@PEAXPEAPEAV1@@Z @ 0x18014B29C
 * Callers:
        ...
        struct CCoRenderVisualProxy **a3)
{
  ...
  v6 = (CCoRenderVisualProxy *)CPlaneCaptureRenderTarget::operator new((unsigned __int64)a1);
  v7 = v6;
  if ( v6 )
  {
    *((_DWORD *)v6 + 4) = 0;
