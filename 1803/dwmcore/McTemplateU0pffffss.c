/*
 * XREFs of McTemplateU0pffffss @ 0x1801A92E0
 * Callers:
        ...
        const char *a9)
{
  ...
  const char *v13; // rcx
  int v14; // eax
  struct _EVENT_DATA_DESCRIPTOR v16; // [rsp+20h] [rbp-61h] BYREF
  __int64 *v17; // [rsp+30h] [rbp-51h]
  __int64 v18; // [rsp+38h] [rbp-49h]
  float *v19; // [rsp+40h] [rbp-41h]
  ...
  char *v25; // [rsp+70h] [rbp-11h]
  __int64 v26; // [rsp+78h] [rbp-9h]
  const char *v27; // [rsp+80h] [rbp-1h]
  int v28; // [rsp+88h] [rbp+7h]
  int v29; // [rsp+8Ch] [rbp+Bh]
  const char *v30; // [rsp+90h] [rbp+Fh]
  int v31; // [rsp+98h] [rbp+17h]
  int v32; // [rsp+9Ch] [rbp+1Bh]
  __int64 v33; // [rsp+D0h] [rbp+4Fh] BYREF
  float v34; // [rsp+D8h] [rbp+57h] BYREF
  ...
  if ( !a9 )
    v13 = "NULL";
  v30 = v13;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_ETWGUID_VISUAL_RENDERCONTENT, 8u, &v16);
}
