/*
 * XREFs of ?ProcessAppend@CTransform3DGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_TRANSFORM3DGROUP@@PEBXI@Z @ 0x1801AA988
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v11 = CResource::UnmarshalResourceArray(&v25, &a5, _mm_cvtsi128_si32(v8), 0x8Fu, v21, &v24, &Src, (__int64)a2, 0);
  v12 = Src;
  v6 = v11;
  v13 = v24;
  if ( v11 < 0 )
  ...
  if ( v16 >= v14 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v6 >= 0 )
      {
        v17 = *((unsigned int *)this + 44);
        if ( (_DWORD)v17 )
        {
          memcpy_0(v7, *((const void **)this + 23), 8LL * (unsigned int)v17);
          v17 = *((unsigned int *)this + 44);
        }
