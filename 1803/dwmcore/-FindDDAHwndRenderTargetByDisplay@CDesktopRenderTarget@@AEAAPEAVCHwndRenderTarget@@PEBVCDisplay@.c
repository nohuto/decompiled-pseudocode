/*
 * XREFs of ?FindDDAHwndRenderTargetByDisplay@CDesktopRenderTarget@@AEAAPEAVCHwndRenderTarget@@PEBVCDisplay@@@Z @ 0x1801579F4
 * Callers:
        ...
        const struct CDisplay *a2)
{
  ...
  if ( *((_DWORD *)this + 50) )
  {
    while ( 1 )
    {
      ...
      if ( v6[21] == a2 )
      {
        if ( (*((unsigned __int8 (__fastcall **)(const struct CDisplay **))*v6 + 27))(v6) )
          break;
      }
