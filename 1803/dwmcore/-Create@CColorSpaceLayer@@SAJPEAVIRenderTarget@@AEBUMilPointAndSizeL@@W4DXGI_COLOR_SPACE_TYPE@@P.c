/*
 * XREFs of ?Create@CColorSpaceLayer@@SAJPEAVIRenderTarget@@AEBUMilPointAndSizeL@@W4DXGI_COLOR_SPACE_TYPE@@PEAPEAV1@@Z @ 0x180174718
 * Callers:
        ...
        struct CColorSpaceLayer **a4)
{
  ...
  struct _LUID v22; // [rsp+B8h] [rbp+48h] BYREF
  ...
  *a4 = 0LL;
  ...
  HIDWORD(v17) = a3;
  v20 = 0LL;
  v9 = (*(__int64 (__fastcall **)(struct IRenderTarget *, struct _LUID *, int *))(v6 + 136))(a1, &v22, &v21);
  v10 = v9;
  if ( v9 < 0 )
  {
  ...
  else
  {
    ...
    v11 = (*(__int64 (__fastcall **)(struct IRenderTarget *))(*(_QWORD *)a1 + 160LL))(a1);
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, RenderTargetBitmap, 0x27u);
      v5 = v20;
    }
    else
    {
      ...
      *a4 = v14;
      ...
      {
        v10 = -2147024882;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x2Bu);
      }
    }
  }
