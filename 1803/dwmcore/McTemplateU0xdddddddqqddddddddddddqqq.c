/*
 * XREFs of McTemplateU0xdddddddqqddddddddddddqqq @ 0x180167C34
 * Callers:
...
ULONG __fastcall McTemplateU0xdddddddqqddddddddddddqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a27)
{
  struct _EVENT_DATA_DESCRIPTOR v28; // [rsp+20h] [rbp-E0h] BYREF
  ...
  __int64 v79; // [rsp+1F0h] [rbp+F0h] BYREF
  int v80; // [rsp+1F8h] [rbp+F8h] BYREF
  ...
  return McGenEventWriteUM(
           ...
           &EVTDESC_DISPLAYSURFACE_CANDIDATEATTRIBUTES,
           0x1Au,
           &v28);
}
