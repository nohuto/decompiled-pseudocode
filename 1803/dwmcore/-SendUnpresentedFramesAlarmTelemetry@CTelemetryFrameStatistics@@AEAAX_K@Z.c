/*
 * XREFs of ?SendUnpresentedFramesAlarmTelemetry@CTelemetryFrameStatistics@@AEAAX_K@Z @ 0x1800CFA14
 * Callers:
        ...
        __int64 a2)
{
  ...
  if ( dword_1802D3FA0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FA0, 0x400000000000uLL) )
  {
    ...
    v7 = 4;
    v10 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_1802D3FA0, &unk_1802A7103, 0LL, 0LL, 4u, &pData);
  }
  *((_QWORD *)this + 1) = a2;
  *((_DWORD *)this + 6) = 0;
}
