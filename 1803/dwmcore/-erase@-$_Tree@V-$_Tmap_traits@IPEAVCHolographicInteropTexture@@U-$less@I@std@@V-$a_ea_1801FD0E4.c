...
char **__fastcall std::_Tree<std::_Tmap_traits<unsigned int,CHolographicInteropTexture *,std::less<unsigned int>,std::allocator<std::pair<unsigned int const,CHolographicInteropTexture *>>,0>>::erase(
        _QWORD *a1,
        char **a2,
        __int64 a3)
{
...
LABEL_62:
  ...
  std::_Deallocate(v7, 1uLL, 0x30uLL);
  v22 = a1[1];
  if ( v22 )
    a1[1] = v22 - 1;
  result = a2;
