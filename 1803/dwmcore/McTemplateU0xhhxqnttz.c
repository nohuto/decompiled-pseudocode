/*
 * XREFs of McTemplateU0xhhxqnttz @ 0x18014F82C
 * Callers:
...
ULONG __fastcall McTemplateU0xhhxqnttz(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int16 a4,
        ...
        const wchar_t *a12)
{
  ...
  const wchar_t *v33; // [rsp+B0h] [rbp-9h]
  int v34; // [rsp+B8h] [rbp-1h]
  int v35; // [rsp+BCh] [rbp+3h]
  __int64 v36; // [rsp+F0h] [rbp+37h] BYREF
  __int16 v37; // [rsp+F8h] [rbp+3Fh] BYREF
