/*
 * XREFs of ?FillTexture@CHwSolidColorTextureSource@@AEAAJXZ @ 0x1801EA1AC
 * Callers:
...
__int64 __fastcall CHwSolidColorTextureSource::FillTexture(CHwSolidColorTextureSource *this)
{
  ...
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v2, 0xAEu);
    pData = v8;
  }
  else
  {
  ...
  if ( v3 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x103u);
  }
  else
  {
