/*
 * XREFs of ?UnTransformOutput@CInteractionContextTransformHelper@@QEAAXAEBUInteractionOutput@@K_NPEAU2@@Z @ 0x18020EA68
 * Callers:
        ...
        struct InteractionOutput *a5)
{
  ...
  *((_DWORD *)a5 + 14) = *((_DWORD *)a2 + 14);
  if ( !D2D1::Matrix3x2F::IsIdentity(this) )
  {
    ...
    if ( v11 != 5 )
    {
      v12 = (float)((float)(v8[10] * v9->m128_f32[1]) + (float)(v8[11] * v9->m128_f32[3])) + v9[1].m128_f32[1];
