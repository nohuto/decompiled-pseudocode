/*
 * XREFs of ?HrInitDataFromIBitmapSource@CBitmap@@IEAAJPEAVIBitmapSource@@PEAUWICRect@@@Z @ 0x180200FA4
 * Callers:
...
__int64 __fastcall CBitmap::HrInitDataFromIBitmapSource(CBitmap *this, struct IBitmapSource *a2, struct WICRect *a3)
{
  ...
  v9 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x355u);
  if ( a3 )
  {
    *v5 = a3->Width;
    *v3 = a3->Height;
  ...
  *((_DWORD *)this + 48) = *(_DWORD *)(v10 + 8);
  if ( v9 >= 0 )
  {
    ...
    if ( PixelFormatSize )
    {
      ...
      {
        v9 = -2147024362;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0x36Fu);
      }
      if ( v9 >= 0 )
      {
        ...
        if ( v12 && *v5 <= 0x7FFFFFF8u / v12 )
        {
          ...
          {
            v9 = -2147024362;
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0x382u);
          }
          if ( v9 >= 0 )
          {
            v13 = *(_QWORD *)a2;
            ...
            v9 = v14;
            if ( v14 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x38Cu);
            v15 = v18[0];
            *((float *)this + 44) = v17;
            *((float *)this + 45) = v15;
          }
        ...
        {
          v9 = -2147024362;
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024362, 0x37Cu);
        }
      }
    }
    else
    {
      v9 = -2003292409;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003292409, 0x36Bu);
    }
  }
