/*
 * XREFs of ?GetSingleContributorToRealizationAreaNoRef@CBitmapOfDeviceBitmaps@@QEAA_NAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVCHwDeviceBitmapColorSource@@@Z @ 0x1801E9340
 * Callers:
...
char __fastcall CBitmapOfDeviceBitmaps::GetSingleContributorToRealizationAreaNoRef(__int64 a1, RECT *a2, _QWORD *a3)
{
  ...
  {
    v10 = *(_QWORD *)(a1 + 312);
    if ( TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::IsEmpty((_DWORD *)(v9 + v10 + 24)) )
      goto LABEL_13;
