/*
 * XREFs of ?Initialize@CMesh2DEffect@@UEAAJPEAUID2D1EffectContext@@PEAUID2D1TransformGraph@@@Z @ 0x1802220B0
 * Callers:
 *     <none>
 * Callees:
          ...
          else
          {
            ...
            else
            {
              ...
              else
              {
                ...
                if ( v7 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x9Au);
                  goto LABEL_22;
                }
