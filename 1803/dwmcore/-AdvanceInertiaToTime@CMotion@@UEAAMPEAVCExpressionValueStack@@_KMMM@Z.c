/*
 * XREFs of ?AdvanceInertiaToTime@CMotion@@UEAAMPEAVCExpressionValueStack@@_KMMM@Z @ 0x1801C4850
 * Callers:
        ...
        float a6)
{
  ...
  *((float *)this + 9) = a5;
  ...
  if ( dword_1802D3FE0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 2uLL) )
  {
    ...
    v33 = v19;
    v36 = v19;
    TlgWrite((TraceLoggingHProvider)&dword_1802D3FE0, &unk_1802A97E9, 0LL, 0LL, 7u, &pData);
  }
  return v21;
}
