/*
 * XREFs of ?IsAncestorInSameSpace@CVisualTree@@QEBA_NPEBVCVisual@@0@Z @ 0x18000B704
 * Callers:
 ...
 * Callees:
 *     ?IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z @ 0x18000B3C4 (-IsPreserve3D@CVisual@@QEBA_NPEBV1@@Z.c)
 */
