/*
 * XREFs of ?GetProperty@CRectangleGeometry@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1801A35E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRectangleGeometry::GetProperty(CRectangleGeometry *this, int a2, struct CExpressionValue *a3)
{
  ...
  v10[0] = 15LL;
  v10[1] = &CRectangleGeometry::k_rgAnimDef;
  v5 = 0;
  ...
  else
  {
    ...
    v5 = Property;
    if ( Property < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Property, 0x71u);
  }
  return v5;
}
