/*
 * XREFs of ??1?$unique_ptr@VCDrawListBrush@@U?$default_delete@VCDrawListBrush@@@std@@@std@@QEAA@XZ @ 0x18008F7E0
 * Callers:
...
{
  if ( *a1 )
    std::default_delete<CDrawListBrush>::operator()((__int64)a1, *a1);
}
