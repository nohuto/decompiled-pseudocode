/*
 * XREFs of ?TryGetPointer@SemaphoreValue@details_abi@wil@@SAJPEBGPEAPEAX@Z @ 0x1800BC554
 * Callers:
        ...
        bool *a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v7 < 0 )
  {
    wil::details::in1diag3::Return_Hr(retaddr, (void *)0x6A, (unsigned int)"wil", (const char *)(unsigned int)v7, v9);
