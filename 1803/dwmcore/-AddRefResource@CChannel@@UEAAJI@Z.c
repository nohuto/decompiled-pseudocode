/*
 * XREFs of ?AddRefResource@CChannel@@UEAAJI@Z @ 0x180087300
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::AddRefResource(CChannel *this, int a2)
{
  ...
  if ( a2 )
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x2A2u);
  }
  else
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x29Fu);
  }
