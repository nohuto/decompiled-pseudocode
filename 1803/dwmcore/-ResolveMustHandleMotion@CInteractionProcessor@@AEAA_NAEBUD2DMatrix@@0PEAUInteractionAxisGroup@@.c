/*
 * XREFs of ?ResolveMustHandleMotion@CInteractionProcessor@@AEAA_NAEBUD2DMatrix@@0PEAUInteractionAxisGroup@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x1801D5C28
 * Callers:
...
LABEL_12:
  if ( dword_1802D3FE0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 2uLL) )
  {
    ...
    v60 = v18;
    v62 = v18;
    TlgWrite((TraceLoggingHProvider)&dword_1802D3FE0, &unk_1802AA716, 0LL, 0LL, 0x11u, &pData);
  }
  return v10;
}
