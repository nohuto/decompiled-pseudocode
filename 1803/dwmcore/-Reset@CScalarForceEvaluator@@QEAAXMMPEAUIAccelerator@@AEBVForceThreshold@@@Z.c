/*
 * XREFs of ?Reset@CScalarForceEvaluator@@QEAAXMMPEAUIAccelerator@@AEBVForceThreshold@@@Z @ 0x1801CC3CC
 * Callers:
 ...
 *     ?Update@CExpressionForce@@UEAAMMPEAVCExpressionValueStack@@_K@Z @ 0x1801CB930 (-Update@CExpressionForce@@UEAAMMPEAVCExpressionValueStack@@_K@Z.c)
 ...
 *     ?GetMinAcceleration@ForceThreshold@@QEBAMXZ @ 0x1801CD020 (-GetMinAcceleration@ForceThreshold@@QEBAMXZ.c)
 *     ?GetMinVelocity@ForceThreshold@@QEBAMXZ @ 0x1801CD098 (-GetMinVelocity@ForceThreshold@@QEBAMXZ.c)
 */
