/*
 * XREFs of ?OnRemoveDataSourceError@BamoDataProviderProxy@@UEAAJI@Z @ 0x180169B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataProviderProxy::OnRemoveDataSourceError(BamoDataProviderProxy *this, unsigned int a2)
{
  ...
  v4 = BamoImpl::BamoDataProviderProxyImpl::OnRemoveDataSourceError((BamoDataProviderProxy *)((char *)this + 8), a2);
  if ( v6 )
