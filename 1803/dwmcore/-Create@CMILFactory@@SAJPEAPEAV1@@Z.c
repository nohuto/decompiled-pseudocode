/*
 * XREFs of ?Create@CMILFactory@@SAJPEAPEAV1@@Z @ 0x1800C95B8
 * Callers:
...
__int64 __fastcall CMILFactory::Create(struct CMILFactory **a1)
{
  ...
  *((_QWORD *)v3 + 7) = 0LL;
  ...
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x62u);
  if ( v5 == -2147467259 )
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x68u);
  }
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0x2Au);
