/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x180219830
 * Callers:
        ...
        float *a4)
{
  ...
  if ( a3 && a4 )
  {
    CalculateTBNFrameFrom3Vertices((struct D2DQuaternion *)&v40, v12, (__int64 *)v13, a3, a4);
    v16 = v40;
    v13 = a1 + 8;
  }
  v17 = 0;
