/*
 * XREFs of ?GetBounds@CHwDisplayRenderTarget@@UEAAXPEAUMilRectF@@@Z @ 0x180047090
 * Callers:
 *     ?GetBounds@CHwDisplayRenderTarget@@WNI@EAAXPEAUMilRectF@@@Z @ 0x1800DE280 (-GetBounds@CHwDisplayRenderTarget@@WNI@EAAXPEAUMilRectF@@@Z.c)
 * Callees:
