/*
 * XREFs of ?InitializeProxyThunk@BamoDataProviderRegistrarStubImpl@BamoImpl@@UEAAJXZ @ 0x1801688C0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoImpl::BamoDataProviderRegistrarStubImpl *this)
{
  ...
  v3 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)(v2 - 16) + 48LL))(v2 - 16, (char *)this - 16);
  v4 = v7;
  v5 = v3;
  if ( v7 )
  {
