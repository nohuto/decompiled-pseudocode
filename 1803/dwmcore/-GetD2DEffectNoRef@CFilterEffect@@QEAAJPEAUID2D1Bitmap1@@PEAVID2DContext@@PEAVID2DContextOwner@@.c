/*
 * XREFs of ?GetD2DEffectNoRef@CFilterEffect@@QEAAJPEAUID2D1Bitmap1@@PEAVID2DContext@@PEAVID2DContextOwner@@PEAPEAUID2D1Effect@@@Z @ 0x18018E298
 * Callers:
        ...
        struct ID2D1Effect **a5)
{
  ...
  struct CD2DEffect *v28; // [rsp+80h] [rbp+8h] BYREF
  struct ID2D1Bitmap1 *v29; // [rsp+88h] [rbp+10h]
  struct ID2DContext *v30; // [rsp+90h] [rbp+18h]
  struct ID2DContextOwner *v31; // [rsp+98h] [rbp+20h]
  ...
  *((_DWORD *)this + 8) = v8 ^ ((unsigned __int8)v8 ^ (unsigned __int8)(v8 + 2)) & 6;
  ...
  {
    v9 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467259, 0x1Du);
LABEL_27:
    *a5 = 0LL;
    goto LABEL_28;
  }
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x20u);
  }
  else
  {
    v11 = v28;
    (*(void (__fastcall **)(_QWORD))(**((_QWORD **)v28 + 13) + 8LL))(*((_QWORD *)v28 + 13));
    v5 = (ID2D1Effect *)*((_QWORD *)v11 + 13);
    v12 = (*(__int64 (__fastcall **)(CFilterEffect *, ID2D1Effect *))(*(_QWORD *)this + 176LL))(this, v5);
    v9 = v12;
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0x22u);
    }
    else
    {
      v13 = *((_DWORD *)this + 38);
      if ( v13 )
      {
        if ( v13 > 0 )
        {
          ...
          {
            v16 = *((_QWORD *)this + 17);
            v26 = *(struct ID2D1Effect **)(*((_QWORD *)this + 18) + 8 * i);
            v17 = *((_QWORD *)v26 + 3);
            v18 = *(unsigned int *)(v16 + 4 * i);
            LODWORD(v28) = *(_DWORD *)(v16 + 4 * i);
            if ( v17 )
            {
              v19 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v17 + 48LL))(v17, 55LL);
              v20 = v26;
              v21 = (CFilterEffect *)*((_QWORD *)v26 + 3);
              if ( v19 )
              {
                v26 = 0LL;
                D2DEffectNoRef = CFilterEffect::GetD2DEffectNoRef(v21, v29, v30, v31, &v26);
                v9 = D2DEffectNoRef;
                if ( D2DEffectNoRef < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, D2DEffectNoRef, 0x3Bu);
                  goto LABEL_26;
                }
                ID2D1Effect::SetInputEffect(v5, (unsigned int)v28, v26);
              }
              else
              {
                if ( !(*(unsigned __int8 (__fastcall **)(CFilterEffect *, __int64))(*(_QWORD *)v21 + 48LL))(v21, 37LL) )
                {
                  v9 = -2147467263;
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467263, 0x52u);
                  goto LABEL_27;
                }
                InputEffectForAtlasedSurface = CFilterEffect::GetInputEffectForAtlasedSurface(
                                                 ...
                                                 v30,
                                                 v31,
                                                 (const struct tagRECT *)((char *)v20 + 4),
                                                 *((struct CCompositionSurfaceBitmap **)v20 + 3),
                                                 &v25);
                v9 = InputEffectForAtlasedSurface;
                if ( InputEffectForAtlasedSurface < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, InputEffectForAtlasedSurface, 0x49u);
                  goto LABEL_26;
                }
                ID2D1Effect::SetInputEffect(v5, (unsigned int)v28, v25);
                ReleaseInterface<IRenderTargetBitmap>((__int64 *)&v25);
              }
            }
            else
            {
