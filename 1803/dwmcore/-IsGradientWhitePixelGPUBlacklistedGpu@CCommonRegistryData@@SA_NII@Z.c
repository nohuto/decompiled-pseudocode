/*
 * XREFs of ?IsGradientWhitePixelGPUBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800C0774
 * Callers:
...
char __fastcall CCommonRegistryData::IsGradientWhitePixelGPUBlacklistedGpu(int a1, unsigned __int16 a2)
{
  ...
  {
    v2 = (struct CCommonRegistryData::GpuId *)&unk_1802773D4;
    CCommonRegistryData::m_countWhitePixelBlacklistedGpuIds = 0;
    CCommonRegistryData::m_whitePixelBlacklistedGpuIds = (const struct CCommonRegistryData::GpuId *const)&unk_1802773D4;
    v6 = 0;
  }
  if ( !v6 )
    return 0;
