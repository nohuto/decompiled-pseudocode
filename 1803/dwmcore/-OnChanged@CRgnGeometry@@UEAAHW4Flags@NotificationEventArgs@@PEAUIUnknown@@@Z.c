/*
 * XREFs of ?OnChanged@CRgnGeometry@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x18002ABC0
 * Callers:
...
__int64 __fastcall CRgnGeometry::OnChanged(__int64 a1)
{
  ...
  *(_BYTE *)(a1 + 152) = 1;
  if ( v2 )
  {
    while ( TMilRect<int,tagRECT,RectUniqueness::_CMilRectL_>::IsEmpty((_DWORD *)(*(_QWORD *)(v3 + 144) + 16LL * v1)) )
    {
      v1 = v4 + 1;
      if ( v1 >= v5 )
        return 1LL;
