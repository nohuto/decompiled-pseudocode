/*
 * XREFs of McTemplateU0qQR0qQR2qQR4qQR6qQR8 @ 0x180148198
 * Callers:
        ...
        __int64 a12)
{
  ...
  int v39; // [rsp+100h] [rbp+37h] BYREF
  ...
  v30 = 4LL;
  v35 = 4LL;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_PROCESS_ATTRIBUTION, 0xBu, &v13);
}
