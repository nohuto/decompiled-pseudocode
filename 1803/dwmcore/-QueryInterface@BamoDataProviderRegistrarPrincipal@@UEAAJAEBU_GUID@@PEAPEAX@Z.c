/*
 * XREFs of ?QueryInterface@BamoDataProviderRegistrarPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180168EB0
 * Callers:
 *     ?QueryInterface@BamoDataProviderRegistrarPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DD5A0 (-QueryInterface@BamoDataProviderRegistrarPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
