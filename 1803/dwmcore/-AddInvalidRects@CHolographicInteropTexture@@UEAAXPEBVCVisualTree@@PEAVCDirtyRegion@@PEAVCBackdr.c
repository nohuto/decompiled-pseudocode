/*
 * XREFs of ?AddInvalidRects@CHolographicInteropTexture@@UEAAXPEBVCVisualTree@@PEAVCDirtyRegion@@PEAVCBackdropRegion@@@Z @ 0x1801FA9D0
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      if ( v8 )
      {
        ...
        do
        {
          ...
          CDirtyRegion::Add(a3, 0LL, 0LL, (float *)&v10);
          v5 += 16LL;
          --v9;
        }
        while ( v9 );
