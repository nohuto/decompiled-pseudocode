/*
 * XREFs of ?MaterializeBamoDataSourceProxy@dataproviderBamoPeerImpl@BamoImpl@@QEAAJI@Z @ 0x180153B50
 * Callers:
 *     ?Thunk_MaterializeBamoDataSourceProxy_5@?$IBamoPeer_dataprovider_Receive@VdataproviderBamoPeerImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180154CB0 (-Thunk_MaterializeBamoDataSourceProxy_5@-$IBamoPeer_dataprovider_Receive@VdataproviderBamoPeerIm.c)
 * Callees:
...
__int64 __fastcall BamoImpl::dataproviderBamoPeerImpl::MaterializeBamoDataSourceProxy(
