/*
 * XREFs of ?Realize@CViewportAlignedIntermediateRealizer@@QEAAJPEAPEAVIRenderTargetBitmap@@PEAPEAVCDrawingContext@@PEAVCMILMatrix@@PEAH@Z @ 0x1801C4524
 * Callers:
         ...
         v15[0])) )
  {
    ...
    if ( !*a5 )
    {
      ...
      if ( !*a5 )
      {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, SurfaceAndContext, 0xCFu);
          ReleaseInterface<IRenderTargetBitmap>((__int64 *)a2);
