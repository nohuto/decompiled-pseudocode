/*
 * XREFs of ?TryEnqueueSuperWetScribble@CWetInkManager@@AEAAJPEAVCGenericInk@@PEAUIDCompositionDirectInkWetStrokePartner@@PEAVIRenderTargetDisplay@@AEBUDCompWetInkStrokeRenderState@@PEA_N@Z @ 0x180171848
 * Callers:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  if ( !v11 || *(_QWORD *)(*(_QWORD *)this + 384LL) - *((_QWORD *)a2 + 8) > 5uLL )
    return 0LL;
  v13 = (*(__int64 (__fastcall **)(struct IRenderTargetDisplay *, bool **))(*(_QWORD *)a4 + 544LL))(a4, &a6);
  v14 = v13;
  if ( v13 < 0 )
  {
...
LABEL_23:
            ...
            a5) )
    {
      if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
        McTemplateU0d(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_COMPUTESCRIBBLE_INCOMPATIBLE, 3);
      v17 = 0;
      goto LABEL_23;
    }
    v19 = *((_DWORD *)a2 + 52);
    ...
    if ( v20 >= 0 )
    {
      v20 = (*(__int64 (__fastcall **)(struct IRenderTargetDisplay *, CMILRefCountBase *))(*(_QWORD *)a4 + 552LL))(
              a4,
              v25);
      v17 = v20;
      if ( v20 >= 0 )
