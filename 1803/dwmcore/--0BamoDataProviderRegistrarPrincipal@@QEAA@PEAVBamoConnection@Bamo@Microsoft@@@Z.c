/*
 * XREFs of ??0BamoDataProviderRegistrarPrincipal@@QEAA@PEAVBamoConnection@Bamo@Microsoft@@@Z @ 0x1800C4CC4
 * Callers:
        ...
        struct Microsoft::Bamo::BamoConnection *a2)
{
  ...
  *((_DWORD *)this + 6) = 1;
  v4 = *(_QWORD *)((*(__int64 (__fastcall **)(struct Microsoft::Bamo::BamoConnection *))(*(_QWORD *)a2 + 40LL))(a2) + 64);
  *((_QWORD *)v2 + 2) = v4;
  if ( v4 )
