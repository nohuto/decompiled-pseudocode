/*
 * XREFs of ?OnManipulationChanged@InteractionSourceManager@@QEAAXW4Flags@NotificationEventArgs@@PEAVCManipulation@@@Z @ 0x1801CA3D8
 * Callers:
 ...
 *     ?IsManipulationActive@InteractionSourceManager@@AEAA_NPEBVCManipulation@@@Z @ 0x1801CA034 (-IsManipulationActive@InteractionSourceManager@@AEAA_NPEBVCManipulation@@@Z.c)
...
void __fastcall InteractionSourceManager::OnManipulationChanged(__int64 a1, int a2, struct CManipulation *a3)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      ...
      {
        if ( v7 == 1
          && CInteractionTracker::AreInteractionAnimationsAlive(*(CInteractionTracker **)(*(_QWORD *)(a1 + 8) + 8LL)) )
        {
          if ( InteractionSourceManager::IsManipulationActive((InteractionSourceManager *)a1, v8) )
            *(_BYTE *)(*(_QWORD *)(*(_QWORD *)a1 + 240LL) + 424LL) |= 4u;
        }
      }
      else
      {
        ...
        std::_Hash<std::_Umap_traits<wil::com_ptr_t<CManipulation,wil::err_returncode_policy>,std::unique_ptr<CChainingHelper>,std::_Uhash_compare<wil::com_ptr_t<CManipulation,wil::err_returncode_policy>,std::hash<wil::com_ptr_t<CManipulation,wil::err_returncode_policy>>,std::equal_to<wil::com_ptr_t<CManipulation,wil::err_returncode_policy>>>,std::allocator<std::pair<wil::com_ptr_t<CManipulation,wil::err_returncode_policy> const,std::unique_ptr<CChainingHelper>>>,0>>::lower_bound(
          ...
          v15,
          &v17);
        if ( v15[0] == *(_QWORD *)(a1 + 24) )
          ModuleFailFastForHRESULT(-2147483637, retaddr);
        v10 = *(_BYTE **)(v15[0] + 24LL);
        v11 = 0;
        v12 = v10;
        do
        {
    ...
    else if ( !*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 8) + 8LL) + 152LL) )
    {
  ...
  else
  {
    if ( !InteractionSourceManager::IsManipulationActive((InteractionSourceManager *)a1, a3) )
      InteractionSourceManager::AddActiveManipulation((InteractionSourceManager *)a1, a3);
    *(_BYTE *)(a1 + 120) = 1;
  }
}
