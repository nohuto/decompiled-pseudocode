/*
 * XREFs of ?SetProperty@CViewBox@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801A6E50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CViewBox::SetProperty(CResource *a1, int a2, int a3, struct _D3DCOLORVALUE *a4)
{
  ...
  {
    v8 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x2Du);
  }
  return v8;
}
