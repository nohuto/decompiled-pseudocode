/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD2DInk@@VCInk@@VID2DContext@@@@QEAAJPEAVID2DContext@@PEAPEAVCD2DInk@@@Z @ 0x180190EF0
 * Callers:
        ...
        struct CD2DInk **a3)
{
  ...
  __int64 v6; // r9
  __int64 v9; // r8
  struct CD2DInk *v10; // rax
  int DefaultDevice; // eax
  int v12; // eax
  struct CD2DInk *v13; // r10
  ...
  struct CD2DInk *v23; // [rsp+60h] [rbp+30h] BYREF
...
LABEL_7:
  ...
  {
LABEL_10:
    v12 = CInk::CreateResource(*((CInk **)a1 + 1), a2, &v23);
    v3 = v12;
    if ( v12 < 0 )
    {
      v22 = 83;
...
LABEL_33:
  if ( v3 < 0 )
  {
    *a3 = 0LL;
    ...
    {
      if ( v23 )
        CD2DResource::RemoveResourceNotifier((struct CD2DInk *)((char *)v23 + 16), a1);
    }
  }
  ReleaseInterfaceNoNULL<IWICBitmap>((__int64)v23);
  if ( v4 )
