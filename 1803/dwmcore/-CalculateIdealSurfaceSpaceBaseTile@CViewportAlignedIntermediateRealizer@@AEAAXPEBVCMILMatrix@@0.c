/*
 * XREFs of ?CalculateIdealSurfaceSpaceBaseTile@CViewportAlignedIntermediateRealizer@@AEAAXPEBVCMILMatrix@@000PEAHPEAUMilRectF@@2@Z @ 0x1801C3E2C
 * Callers:
        ...
        struct MilRectF *a8)
{
  ...
  float v18; // xmm1_4
  float v19; // xmm2_4
  __m128 v20[4]; // [rsp+20h] [rbp-79h] BYREF
  ...
  {
    v21 = 0;
    if ( !CMILMatrix::SetToInverse(v20, a5) )
      goto LABEL_21;
    CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)v20, v14, (float *)&v22);
    v15 = *(float *)&v23;
  ...
  {
    v21 = 0;
    if ( !CMILMatrix::SetToInverse(v20, a3) )
    {
LABEL_21:
      *a6 = 1;
      return;
    }
    CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)v20, (__int64)&v23, (float *)&v23);
  }
  if ( a2 )
    CMILMatrix::Transform2DBoundsHelper<0>(a2, (__int64)this + 24, (float *)&v22);
  else
    v22 = *(_OWORD *)((char *)this + 24);
  CMILMatrix::Transform2DBoundsHelper<0>(a4, (__int64)&v22, (float *)a7);
  CMILMatrix::Transform2DBoundsHelper<0>(a4, (__int64)&v23, (float *)a8);
