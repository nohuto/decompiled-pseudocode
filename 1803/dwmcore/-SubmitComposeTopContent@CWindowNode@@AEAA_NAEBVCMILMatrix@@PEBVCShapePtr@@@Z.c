/*
 * XREFs of ?SubmitComposeTopContent@CWindowNode@@AEAA_NAEBVCMILMatrix@@PEBVCShapePtr@@@Z @ 0x1801AA2DC
 * Callers:
  ...
  if ( !*((_BYTE *)this + 915) )
  {
    ...
    if ( v11 )
    {
      if ( *(_QWORD *)a3 && v7 )
      {
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v12, 0xD9Eu);
        }
        else
        {
          v3 = 1;
