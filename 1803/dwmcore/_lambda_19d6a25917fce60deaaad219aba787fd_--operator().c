/*
 * XREFs of _lambda_19d6a25917fce60deaaad219aba787fd_::operator() @ 0x1801CC5D8
 * Callers:
 *     ?ChangeBasis@CVector3ForceEvaluator@@QEAAXAEBUD2DMatrix@@@Z @ 0x1801CC6CC (-ChangeBasis@CVector3ForceEvaluator@@QEAAXAEBUD2DMatrix@@@Z.c)
 * Callees:
