/*
 * XREFs of ?AlphaMultiply_64bppABGRFloat@@YAXPEBUPipelineParams@@PEBUScanOpParams@@@Z @ 0x1802042F0
 * Callers:
 *     <none>
 * Callees:
 *     ??BCFloat16@@QEAAMXZ @ 0x1801F54F8 (--BCFloat16@@QEAAMXZ.c)
 */
...
void __fastcall AlphaMultiply_64bppABGRFloat(const struct PipelineParams *a1, const struct ScanOpParams *a2)
{
  ...
  if ( v2 )
  {
    ...
    do
    {
      ...
      if ( v4 != CFloat16::operator float((unsigned __int16 *)&word_1802D53E0) )
      {
        v5 = CFloat16::operator float(v3);
        if ( v5 != CFloat16::operator float(word_1802D9E38) )
        {
          v60 = (float)*v6;
