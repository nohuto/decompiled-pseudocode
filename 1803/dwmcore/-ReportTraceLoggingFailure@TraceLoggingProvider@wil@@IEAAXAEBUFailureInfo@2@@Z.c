/*
 * XREFs of ?ReportTraceLoggingFailure@TraceLoggingProvider@wil@@IEAAXAEBUFailureInfo@2@@Z @ 0x1801D9758
 * Callers:
 *     ?OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z @ 0x1801D95A0 (-OnErrorReported@TraceLoggingProvider@wil@@MEAAX_NAEBUFailureInfo@2@@Z.c)
 * Callees:
        ...
        const struct wil::FailureInfo *a2)
{
  ...
  if ( **((_DWORD **)this + 1) > 5u )
  {
    ...
    v62 = 4;
    TlgCreateSz(&v64, v22);
    TlgWrite(v23, &unk_1802AB5C5, 0LL, 0LL, 0x13u, &pData);
  }
}
