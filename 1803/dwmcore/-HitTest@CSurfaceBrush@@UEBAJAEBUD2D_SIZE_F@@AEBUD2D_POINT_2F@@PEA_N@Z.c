/*
 * XREFs of ?HitTest@CSurfaceBrush@@UEBAJAEBUD2D_SIZE_F@@AEBUD2D_POINT_2F@@PEA_N@Z @ 0x180099BF0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a4)
{
  ...
  *a4 = 0;
  v7 = *((_QWORD *)this + 11);
  if ( v7
    && !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v7 + 48LL))(v7, 15LL)
    && a2->width > 0.0
    && a2->height > 0.0
    && !(*(unsigned __int8 (__fastcall **)(CSurfaceBrush *))(*(_QWORD *)this + 192LL))(this) )
  {
    ...
    if ( v16 )
    {
      ...
      v18 = v15;
      if ( v12 )
        std::default_delete<CShape>::operator()((__int64)&v18, v12);
    }
    if ( v11 )
    {
      ...
      v4 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v13, 0x154u);
    }
    if ( v18 )
      std::default_delete<CShape>::operator()((__int64)v10, v18);
  }
  return v4;
}
