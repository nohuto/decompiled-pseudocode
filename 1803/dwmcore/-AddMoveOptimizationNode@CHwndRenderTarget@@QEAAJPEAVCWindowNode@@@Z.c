/*
 * XREFs of ?AddMoveOptimizationNode@CHwndRenderTarget@@QEAAJPEAVCWindowNode@@@Z @ 0x180158438
 * Callers:
...
__int64 __fastcall CHwndRenderTarget::AddMoveOptimizationNode(CHwndRenderTarget *this, struct CWindowNode *a2)
{
  ...
  v2 = (char *)this + 696;
  v3 = 0;
  v4 = *((unsigned int *)this + 180);
  v5 = 0;
  v6 = *((_QWORD *)this + 87);
  if ( (_DWORD)v4 )
  {
    v8 = (struct CWindowNode **)*((_QWORD *)this + 87);
    do
    {
      if ( a2 == *v8 )
        break;
  ...
  if ( v5 >= *((_DWORD *)this + 180) )
  {
    ...
    if ( v3 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x15Cu);
    else
