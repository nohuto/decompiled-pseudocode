/*
 * XREFs of ?SampleExpressionsAndStartingValue@CKeyframeAnimation@@IEAAJPEAVCExpressionValueStack@@@Z @ 0x18003D1D0
 * Callers:
        ...
        struct CExpressionValueStack *a2)
{
  ...
  if ( (*((_BYTE *)this + 508) & 8) == 0 )
  {
    ...
    if ( *((_QWORD *)this + 40) )
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x89Du);
        return v5;
      }
    }
    *((_BYTE *)this + 508) |= 8u;
