/*
 * XREFs of ?IsHDRContent@CCompositionSurfaceBitmap@@UEBA_NXZ @ 0x1800072D0
 * Callers:
 ...
 *     ?IsHDRContent@CCompositionSurfaceBitmap@@W7EBA_NXZ @ 0x1800DD650 (-IsHDRContent@CCompositionSurfaceBitmap@@W7EBA_NXZ.c)
 * Callees:
