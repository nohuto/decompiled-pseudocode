/*
 * XREFs of ?PostSubgraph@CShapeBoundingContext@@QEAAJPEA_N@Z @ 0x180210744
 * Callers:
 ...
 *     ?ConvertInnerToOuterBounds@CVectorShape@@QEAAXAEBUD2D_MATRIX_3X2_F@@@Z @ 0x1801A6A48 (-ConvertInnerToOuterBounds@CVectorShape@@QEAAXAEBUD2D_MATRIX_3X2_F@@@Z.c)
 */
  ...
  if ( !v4 )
  {
    ...
    if ( *((_BYTE *)this + 72) )
    {
      ...
      if ( v6 )
      {
        ...
        v8 = *v6;
        v11.m128i_i64[0] = v7;
        (*(void (__fastcall **)(__int64 *, __m128i *, struct D2D_MATRIX_3X2_F *))(v8 + 176))(v6, &v11, &v12);
