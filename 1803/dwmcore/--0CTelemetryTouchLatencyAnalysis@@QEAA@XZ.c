/*
 * XREFs of ??0CTelemetryTouchLatencyAnalysis@@QEAA@XZ @ 0x1800CE30C
 * Callers:
        ...
        CTelemetryTouchLatencyAnalysis *this)
{
  ...
  _BYTE v18[120]; // [rsp+110h] [rbp+8h] BYREF
  ...
  _BYTE v31[120]; // [rsp+1D8h] [rbp+D0h] BYREF
  ...
  `vector constructor iterator'(
    (CTelemetryTouchLatencyAnalysis *)((char *)this + 8),
    248LL,
    10LL,
    (__int64 (__fastcall *)(CInputSinkStruct::InputQueueInfo *__hidden))CTelemetryTouchLatencyAnalysis::TouchScenarioInfo::TouchScenarioInfo);
  ...
  *((_QWORD *)this + 394) = 0LL;
  ...
  v17 = 0LL;
  `vector constructor iterator'(
    (CInputSinkStruct::InputQueueInfo *)v18,
    24LL,
    5LL,
  ...
  v35 = 0LL;
  v36 = 0;
  CTelemetryTouchLatencyAnalysis::InteractionSummaryInfo::operator=((__int64)this + 2488, (__int64)v6);
