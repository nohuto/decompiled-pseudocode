/*
 * XREFs of ?invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z @ 0x180098470
 * Callers:
        ...
        struct Windows::Foundation::Numerics::float4x4 *a3)
{
  ...
  else
  {
    ...
    a2->m128_i32[1] = COERCE_UNSIGNED_INT(
                      ...
                      * (float)(1.0 / v19)) ^ _xmm;
    a2[1].m128_f32[1] = (float)((float)((float)(v9 * v35) - (float)(v12 * v47)) + (float)(v13 * v48))
                      * (float)(1.0 / v19);
    a2[2].m128_i32[1] = COERCE_UNSIGNED_INT(
                          (float)((float)((float)(v10 * v35) - (float)(v12 * v46)) + (float)(v14 * v48))
                        * (float)(1.0 / v19)) ^ _xmm;
    v21 = (float)(v8 * v36) - (float)(v7 * v37);
    a2[3].m128_f32[1] = (float)((float)((float)(v11 * v35) - (float)(v13 * v46)) + (float)(v14 * v47))
                      * (float)(1.0 / v19);
    v22 = (float)(v8 * v39) - (float)(v40 * v37);
    v23 = (float)(v7 * v39) - (float)(v40 * v36);
    v24 = (float)(v8 * v41) - (float)(v38 * v37);
    v25 = (float)(v40 * v41) - (float)(v38 * v39);
    v26 = (float)(v7 * v41) - (float)(v38 * v36);
    a2->m128_f32[2] = (float)((float)((float)(v21 * v46) - (float)(v22 * v47)) + (float)(v23 * v48)) * v20;
    a2[3].m128_i32[2] = COERCE_UNSIGNED_INT((float)((float)((float)(v23 * v35) - (float)(v26 * v46)) + (float)(v25 * v47)) * v20) ^ _xmm;
    a2[2].m128_f32[2] = (float)((float)((float)(v22 * v35) - (float)(v24 * v46)) + (float)(v25 * v48)) * v20;
    a2[1].m128_i32[2] = COERCE_UNSIGNED_INT((float)((float)((float)(v21 * v35) - (float)(v24 * v47)) + (float)(v26 * v48)) * v20) ^ _xmm;
    v27 = (float)(v42 * v36) - (float)(v43 * v37);
    v28 = (float)(v42 * v39) - (float)(v44 * v37);
    v29 = (float)(v43 * v39) - (float)(v44 * v36);
    v30 = (float)(v42 * v41) - (float)(v45 * v37);
    v31 = (float)(v43 * v41) - (float)(v45 * v36);
    v32 = (float)(v44 * v41) - (float)(v45 * v39);
    result = 1;
    a2->m128_i32[3] = COERCE_UNSIGNED_INT((float)((float)((float)(v27 * v46) - (float)(v28 * v47)) + (float)(v29 * v48)) * v20) ^ _xmm;
    a2[2].m128_i32[3] = COERCE_UNSIGNED_INT((float)((float)((float)(v28 * v35) - (float)(v30 * v46)) + (float)(v32 * v48)) * v20) ^ _xmm;
    a2[1].m128_f32[3] = (float)((float)((float)(v27 * v35) - (float)(v30 * v47)) + (float)(v31 * v48)) * v20;
    a2[3].m128_f32[3] = (float)((float)((float)(v29 * v35) - (float)(v31 * v46)) + (float)(v32 * v47)) * v20;
  }
  return result;
}
