/*
 * XREFs of McTemplateU0xxxxxqhqqxqntt @ 0x180150090
 * Callers:
...
ULONG McTemplateU0xxxxxqhqqxqntt(
        ...
        ...)
{
  struct _EVENT_DATA_DESCRIPTOR v13; // [rsp+20h] [rbp-E0h] BYREF
  ...
  __int64 v43; // [rsp+148h] [rbp+48h] BYREF
  ...
  va_list va1; // [rsp+1A8h] [rbp+A8h]
  va_list va2; // [rsp+1B0h] [rbp+B0h] BYREF
  ...
  v39 = 4LL;
  v41 = 4LL;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, a2, 0xFu, &v13);
}
