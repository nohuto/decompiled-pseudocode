/*
 * XREFs of ?GetAdvancedDirectFlipRestoreBuffer@CDWMSwapChain@@UEAAJ_NPEAPEAUID3D11Texture2D@@@Z @ 0x1801EA650
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
  ...
  v9 = (*(__int64 (__fastcall **)(CDWMSwapChain *, __int64))(*(_QWORD *)this + 336LL))(this, v7);
