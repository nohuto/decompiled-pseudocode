/*
 * XREFs of ?HrFindInterface@CTransformingGeometrySink@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18020AE10
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    v4 = -2147467262;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147467262, 0x7Cu);
  }
  else
  {
