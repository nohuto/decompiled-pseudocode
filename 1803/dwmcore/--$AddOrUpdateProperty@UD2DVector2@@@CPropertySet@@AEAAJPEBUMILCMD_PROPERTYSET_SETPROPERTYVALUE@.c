/*
 * XREFs of ??$AddOrUpdateProperty@UD2DVector2@@@CPropertySet@@AEAAJPEBUMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DVector2@@@Z @ 0x1800390B0
 * Callers:
...
__int64 __fastcall CPropertySet::AddOrUpdateProperty<D2DVector2>(CResource *a1, _DWORD *a2, unsigned __int8 *a3)
{
  int updated; // eax
  unsigned int v4; // ebx
  int v5; // r9d
  ...
  if ( a2[5] )
  {
    updated = CPropertySet::AddProperty<D2DVector2>(a1, a2[2], a2[3], a2[4], a3);
    v4 = updated;
    if ( updated < 0 )
    {
      v10 = 318;
...
LABEL_11:
  ...
  else
  {
    ...
    updated = CPropertySet::UpdateProperty<D2DVector2>(v8);
    v4 = updated;
    if ( updated < 0 )
    {
      v10 = 329;
