/*
 * XREFs of ?GetSampledConditionAnimation@CConditionalExpression@@QEBAXPEAPEAVCBaseExpression@@@Z @ 0x180187A7C
 * Callers:
        ...
        struct CBaseExpression **a2)
{
  ...
  if ( v3 >= 0 )
  {
    v4 = (char *)(16LL * (unsigned int)v3 + *((_QWORD *)this + 37) + 8LL);
LABEL_4:
    Microsoft::WRL::ComPtr<CBaseExpression>::operator=(&v6, v4);
    goto LABEL_5;
  }
  v4 = (char *)this + 328;
  if ( *((_QWORD *)this + 41) )
