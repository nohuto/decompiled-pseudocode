/*
 * XREFs of ?UnRotateBits@@YAJPEAVIBitmapDest@@W4DXGI_MODE_ROTATION@@0HH@Z @ 0x180172C7C
 * Callers:
        ...
        int a5)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x38u);
    goto LABEL_36;
  }
...
LABEL_9:
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0x58u);
    goto LABEL_36;
  }
  ...
  {
    v10 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x63u);
    goto LABEL_36;
  }
  ...
  if ( v17 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v17, 0x69u);
    goto LABEL_36;
  }
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v18, 0x6Au);
    goto LABEL_36;
  }
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x6Fu);
    goto LABEL_36;
  }
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x70u);
    goto LABEL_36;
  }
  v21 = v45;
  v22 = 0;
...
LABEL_36:
  ...
  ReleaseInterfaceNoNULL<IWICBitmap>(v31);
  return v10;
}
