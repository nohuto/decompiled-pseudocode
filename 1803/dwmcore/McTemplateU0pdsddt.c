/*
 * XREFs of McTemplateU0pdsddt @ 0x1801552E0
 * Callers:
...
ULONG __fastcall McTemplateU0pdsddt(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  __int64 v9; // rax
  int v10; // eax
  struct _EVENT_DATA_DESCRIPTOR v12; // [rsp+20h] [rbp-49h] BYREF
  ...
  __int64 v26; // [rsp+C0h] [rbp+57h] BYREF
  ...
  v24 = &a8;
  v25 = 4LL;
  return McGenEventWriteUM(Microsoft_Windows_Dwm_Core_Provider_Context, &EVTDESC_EFFECT_COMPILE_Info, 7u, &v12);
}
