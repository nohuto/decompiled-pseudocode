/*
 * XREFs of ?SetProperty@CLinearGradientBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180198AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CLinearGradientBrush::SetProperty(CResource *a1, int a2, int a3, struct _D3DCOLORVALUE *a4)
{
  ...
  v10[0] = 2LL;
  v10[1] = &CLinearGradientBrush::k_rgAnimDef;
  ...
  {
    v8 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x4Au);
  }
  return v8;
}
