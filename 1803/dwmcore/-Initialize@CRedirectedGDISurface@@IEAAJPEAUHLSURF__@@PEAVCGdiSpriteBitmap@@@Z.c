/*
 * XREFs of ?Initialize@CRedirectedGDISurface@@IEAAJPEAUHLSURF__@@PEAVCGdiSpriteBitmap@@@Z @ 0x18001F8AC
 * Callers:
  ...
  if ( inserted )
  {
    ...
    *((_BYTE *)this + 40) = 1;
    ...
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, LastError, 0x4Cu);
    }
  }
  else
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x48u);
  }
  TranslateDXGIorD3DErrorInContext(v5, 11LL, &NewElement);
  return NewElement;
}
