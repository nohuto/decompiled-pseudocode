/*
 * XREFs of ?RegisterForSignaling@CGdiSpriteBitmap@@IEAAJXZ @ 0x180093DCC
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::RegisterForSignaling(CGdiSpriteBitmap *this)
{
  ...
  else
  {
    if ( *((_QWORD *)this + 38) )
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277284, 1u, v9, 0x35Au);
        goto LABEL_7;
      }
      v4 = 1;
    }
    else
    {
      ...
      if ( v6 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277284, 1u, v6, 0x352u);
        goto LABEL_7;
      }
    }
    *((_BYTE *)this + 116) |= 8u;
