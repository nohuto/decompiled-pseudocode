/*
 * XREFs of ?EnsureBlackColorBrush@CProjectedShadowCaster@@AEAAJXZ @ 0x18019FC04
 * Callers:
...
__int64 __fastcall CProjectedShadowCaster::EnsureBlackColorBrush(CProjectedShadowCaster *this)
{
  ...
  if ( !*((_QWORD *)this + 18) )
  {
    ...
    if ( *v2 )
    {
      ...
      v1 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x2DDu);
    }
    else
    {
      v1 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024882, 0x2D5u);
    }
  }
  return v1;
}
