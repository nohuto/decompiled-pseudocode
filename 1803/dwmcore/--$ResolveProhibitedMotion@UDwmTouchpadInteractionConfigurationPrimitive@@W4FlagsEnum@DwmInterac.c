/*
 * XREFs of ??$ResolveProhibitedMotion@UDwmTouchpadInteractionConfigurationPrimitive@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@CInteractionProcessor@@AEAA_NAEBV?$DynArray@UDwmTouchpadInteractionConfigurationPrimitive@@$0A@@@PEAUInteractionAxis@@PEAW4InteractionState@@@Z @ 0x1801D21B0
 * Callers:
 ...
 *     _anonymous_namespace_::AxisContainsInteraction @ 0x1801D26F0 (_anonymous_namespace_--AxisContainsInteraction.c)
    ...
    if ( v13 >= *(_DWORD *)(*a2 + 4 * v12) && v13 <= *(_DWORD *)(v11 + 4 * v12 + 4) )
    {
      ...
      *(_DWORD *)(v17 + 8) = v16;
      ...
      if ( dword_1802D3FE0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 2uLL) )
      {
        ...
        v95 = 4LL;
        v97 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1802D3FE0, &unk_1802A9E4F, 0LL, 0LL, 0x1Cu, &pData);
        v9 = v23;
      }
    }
    v23 = ++v9;
