/*
 * XREFs of ?GetBrushRealizationInternal@CSolidColorLegacyMilBrush@@UEAAJPEBULegacyMilBrushContext@@PEAPEAVCMILBrush@@@Z @ 0x1801B6C90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CMILBrush **a3)
{
  ...
  if ( RealizedColor < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, RealizedColor, 0x3Fu);
  }
  else
  {
    v7 = *((_QWORD *)this + 18);
