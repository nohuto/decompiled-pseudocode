/*
 * XREFs of ?DrawBitmapAsCommandList@CD2DContext@@AEAAJPEBVID2DContextOwner@@PEAUID2D1Bitmap@@PEBUD2D_RECT_F@@2MW4D2D1_ANTIALIAS_MODE@@W4D2D1_INTERPOLATION_MODE@@W4D2D1_PRIMITIVE_BLEND@@@Z @ 0x1801E21E4
 * Callers:
        ...
        enum D2D1_INTERPOLATION_MODE a8)
{
  ...
  else
  {
    ...
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0xB8u);
      v12 = v34;
    }
    else
    {
      ...
      MILMatrix3x2::InferAffineMatrix((__int64)&v42, &v44, v48);
      ...
      *v27 = v17;
      ...
      else
      {
        ...
        v32 = ((__int64 (__fastcall *)(CD2DContext *, const struct ID2DContextOwner *, __int64))v31[17])(this, a2, v35);
        v23 = v32;
        if ( v32 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v32, 0xF4u);
      }
    }
  }
