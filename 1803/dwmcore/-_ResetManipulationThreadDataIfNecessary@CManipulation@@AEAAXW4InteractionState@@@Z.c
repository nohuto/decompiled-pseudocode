/*
 * XREFs of ?_ResetManipulationThreadDataIfNecessary@CManipulation@@AEAAXW4InteractionState@@@Z @ 0x18019A608
 * Callers:
 ...
 * Callees:
 *     ?Reset@ManipulationData@@QEAAXXZ @ 0x180195458 (-Reset@ManipulationData@@QEAAXXZ.c)
