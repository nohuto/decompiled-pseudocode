/*
 * XREFs of ?GetLogicalBackBuffer@CHwStereoFullScreenRenderTarget@@UEAAJPEAPEAVCD3DSurface@@@Z @ 0x1801F1480
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CD3DSurface **a2)
{
  ...
  if ( CHwDisplayRenderTarget::IsValid((CHwStereoFullScreenRenderTarget *)((char *)this - 216)) )
  {
    v5 = (struct CD3DSurface *)*((_QWORD *)this - 2);
    *a2 = v5;
    if ( v5 )
