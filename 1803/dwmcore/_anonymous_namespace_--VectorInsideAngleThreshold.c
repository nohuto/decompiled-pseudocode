/*
 * XREFs of _anonymous_namespace_::VectorInsideAngleThreshold @ 0x1801D680C
 * Callers:
 ...
 * Callees:
 *     ?D3DXVector3Angle@@YAMAEBUD2DVector3@@0@Z @ 0x180207CFC (-D3DXVector3Angle@@YAMAEBUD2DVector3@@0@Z.c)
 */
