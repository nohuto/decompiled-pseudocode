/*
 * XREFs of ?GetLength@CPathLengthOperation@@QEAAMPEBVCPathData@@@Z @ 0x18020B674
 * Callers:
 ...
 *     ?SumPointDistances@CPathLengthOperation@@AEBAMI@Z @ 0x18020C164 (-SumPointDistances@CPathLengthOperation@@AEBAMI@Z.c)
 */
