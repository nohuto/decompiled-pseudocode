/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD2DEffect@@VCFilterEffect@@VID2DContext@@@@QEAAJPEAVID2DContext@@PEAPEAVCD2DEffect@@@Z @ 0x18018DCE4
 * Callers:
        ...
        struct CD2DEffect **a3)
{
  ...
  struct CD2DEffect *v23; // [rsp+60h] [rbp+30h] BYREF
...
LABEL_7:
  ...
  {
LABEL_10:
    v12 = CFilterEffect::CreateResource(*((CFilterEffect **)a1 + 1), a2, &v23);
    v3 = v12;
    if ( v12 < 0 )
    {
      v22 = 83;
