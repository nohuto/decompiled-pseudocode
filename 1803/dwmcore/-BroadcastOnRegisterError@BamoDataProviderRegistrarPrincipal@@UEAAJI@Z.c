/*
 * XREFs of ?BroadcastOnRegisterError@BamoDataProviderRegistrarPrincipal@@UEAAJI@Z @ 0x180168640
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a2)
{
  ...
  v4 = BamoImpl::BamoDataProviderRegistrarPrincipalImpl::BroadcastOnRegisterError(
