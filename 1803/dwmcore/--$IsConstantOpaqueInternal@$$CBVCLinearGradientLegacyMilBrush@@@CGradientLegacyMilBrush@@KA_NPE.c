/*
 * XREFs of ??$IsConstantOpaqueInternal@$$CBVCLinearGradientLegacyMilBrush@@@CGradientLegacyMilBrush@@KA_NPEBVCLinearGradientLegacyMilBrush@@@Z @ 0x18016D014
 * Callers:
 *     ?IsConstantOpaque@CLinearGradientLegacyMilBrush@@UEBA_NXZ @ 0x18016F290 (-IsConstantOpaque@CLinearGradientLegacyMilBrush@@UEBA_NXZ.c)
 * Callees:
...
char __fastcall CGradientLegacyMilBrush::IsConstantOpaqueInternal<CLinearGradientLegacyMilBrush const>(__int64 a1)
{
  ...
  if ( Opacity < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Opacity, 0x84u);
  }
  else if ( v9 >= 1.0 )
  {
    v5 = 0;
