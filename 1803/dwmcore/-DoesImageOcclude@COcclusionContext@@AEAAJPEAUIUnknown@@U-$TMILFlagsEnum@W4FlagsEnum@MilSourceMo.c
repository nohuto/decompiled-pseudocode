/*
 * XREFs of ?DoesImageOcclude@COcclusionContext@@AEAAJPEAUIUnknown@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@PEA_N@Z @ 0x1800A9204
 * Callers:
        ...
        _BYTE *a4)
{
  ...
  *a4 = 0;
  ...
  ReleaseInterfaceNoNULL<IImageSource>(v6);
  return 0LL;
}
