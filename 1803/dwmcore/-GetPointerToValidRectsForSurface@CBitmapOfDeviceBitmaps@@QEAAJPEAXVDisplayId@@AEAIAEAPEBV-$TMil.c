/*
 * XREFs of ?GetPointerToValidRectsForSurface@CBitmapOfDeviceBitmaps@@QEAAJPEAXVDisplayId@@AEAIAEAPEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801E9124
 * Callers:
...
LABEL_5:
  ...
  if ( PointerToValidRects < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, PointerToValidRects, 0x45Bu);
  return v10;
}
