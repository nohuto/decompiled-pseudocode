/*
 * XREFs of ?GetDeviceTexture@CDeviceTextureImageSource@@UEAAJAEBURenderTargetInfo@@PEAPEAVIDeviceTexture@@@Z @ 0x180216770
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IDeviceTexture **a3)
{
                                                                                      ...
                                                                                      || v9 == DisplayId::All) )
  {
      ...
      || *((_BYTE *)a2 + 16) )
    {
      ...
      {
        v3 = -2003304307;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003304307, 0x7Bu);
      }
    }
    else
    {
      v3 = -2147024891;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024891, 0x76u);
    }
  }
  else
  {
    v3 = -2003304287;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003304287, 0x71u);
  }
  return v3;
}
