/*
 * XREFs of ?DrawBspPolygonList@CDrawingContext@@QEAAJPEAVCVisual@@0@Z @ 0x18015EF00
 * Callers:
...
LABEL_19:
  ...
  if ( D2DFactoryNoRef >= 0 )
  {
    ...
    if ( v16 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v16, 0x9C7u);
      goto LABEL_27;
    }
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v19, 0x9CBu);
      goto LABEL_27;
    }
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v20, 0x9CDu);
      goto LABEL_27;
    }
    v21 = *(_OWORD *)(v12 + 160);
    v22 = *(_OWORD *)(v12 + 144);
    ...
    v32[3] = v23;
    v32[2] = 0LL;
    v24 = CMatrixStack::Push((CDrawingContext *)((char *)this + 480), (const struct CMILMatrix *)v32, 1);
    v4 = v24;
    if ( v24 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, 0x9DFu);
      v7 = 0;
      goto LABEL_28;
    }
    ...
    if ( v25 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v25, 0x9E2u);
      goto LABEL_28;
    }
    if ( *v17 )
      --*v17;
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, D2DFactoryNoRef, 0x9C6u);
LABEL_27:
  v7 = 0;
LABEL_28:
  ReleaseInterface<IBitmapLock>((__int64 *)&v28);
