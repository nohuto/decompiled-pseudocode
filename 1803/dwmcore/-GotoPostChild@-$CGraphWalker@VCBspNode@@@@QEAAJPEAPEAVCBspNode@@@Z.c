/*
 * XREFs of ?GotoPostChild@?$CGraphWalker@VCBspNode@@@@QEAAJPEAPEAVCBspNode@@@Z @ 0x180212D90
 * Callers:
...
__int64 __fastcall CGraphWalker<CBspNode>::GotoPostChild(__int64 a1, _QWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v6 )
  {
    v10 = *(_QWORD *)(a1 + 16);
    v11 = *(_DWORD *)(a1 + 24);
    v7 = CWatermarkStack<CGraphWalker<CVectorShape>::CFrame,64,2,10>::Push(a1 + 32, &v10);
    v3 = v7;
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x175u);
    }
    else
    {
      v8 = *(_QWORD *)(a1 + 8);
