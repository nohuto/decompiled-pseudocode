/*
 * XREFs of ?CheckSingleBitmapLuidAndDisplayId@CRenderTargetBitmap@@IEBAJU_LUID@@VDisplayId@@@Z @ 0x18008A8BC
 * Callers:
...
__int64 __fastcall CRenderTargetBitmap::CheckSingleBitmapLuidAndDisplayId(__int64 a1, __int64 a2, int a3)
{
  ...
  v10 = 0;
  v5 = a2;
  v6 = (*(__int64 (__fastcall **)(__int64, __int64 *, int *))(*(_QWORD *)v3 + 136LL))(v3, &v12, &v10);
  v7 = v6;
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6, 0x1B1u);
  }
  else
  {
    v8 = v10;
    if ( v10 == DisplayId::All )
      v8 = DisplayId::None;
    v10 = v8;
    if ( __PAIR64__(HIDWORD(v11), v5) != v12 || v8 != a3 && v8 != DisplayId::None && a3 != DisplayId::All )
    {
      v7 = -2003304287;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003304287, 0x1BDu);
    }
  }
  return v7;
}
