/*
 * XREFs of ?GetD3D12DeviceNoRef@CD3DDeviceLevel1@@QEAAJPEAPEAUID3D12Device@@@Z @ 0x1801E0288
 * Callers:
...
LABEL_3:
  ...
  D3D12Resources = CAsyncTask<CD3DDeviceLevel1::D3D12Resources>::WaitForResult(*((_QWORD *)this + 90), &v8);
  if ( D3D12Resources < 0 )
  {
    v5 = 1312LL;
    goto LABEL_3;
