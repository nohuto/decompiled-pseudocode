/*
 * XREFs of ?ProcessUpdate@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMILCMD_MAGNIFIERRENDERTARGET@@@Z @ 0x18015AD44
 * Callers:
        ...
        const struct MILCMD_MAGNIFIERRENDERTARGET *a3)
{
  ...
  if ( *((_DWORD *)this + 100) <= 6u )
  {
    ...
    if ( updated < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, updated, 0x31u);
    }
    else
    {
  ...
  {
    v6 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x2Eu);
  }
  return v6;
}
