/*
 * XREFs of ?CalculateValue@CNaturalAnimation@@AEAAXPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x18019BA88
 * Callers:
 ...
 *     ?PeekStackValue@CNaturalAnimation@@AEAA?ATInternalValue@1@PEAVCExpressionValueStack@@@Z @ 0x18019CDA0 (-PeekStackValue@CNaturalAnimation@@AEAA-ATInternalValue@1@PEAVCExpressionValueStack@@@Z.c)
    ...
    if ( v8 == 18 || v8 == 35 || v8 == 52 )
    {
      ...
      *a4 = v14;
      ...
      if ( (*(_DWORD *)(*((_QWORD *)this + 35) + 4LL) & 0x40000000) != 0 )
      {
        ...
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 4uLL) )
          {
            ...
            v56 = a4;
            v57 = 1;
            TlgWrite((TraceLoggingHProvider)&dword_1802D3FE0, &unk_1802A8B13, 0LL, 0LL, 0xBu, &pData);
          }
        }
      }
    }
