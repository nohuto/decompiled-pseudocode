/*
 * XREFs of ?AppendHWGeometry@GeometrySink@CDrawListEntryBuilder@@QEAAJPEBVCShape@@AEBUContentInfo@Mesh@@W4D2D1_ANTIALIAS_MODE@@W4D2D1_EDGE_FLAGS@@AEBUD2D_RECT_F@@_N5@Z @ 0x18017A804
 * Callers:
...
LABEL_7:
  ...
  v14 = *(_DWORD *)(a1 + 32);
  if ( v14 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v14, 0xB2u);
LABEL_8:
