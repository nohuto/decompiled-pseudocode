/*
 * XREFs of ?GetContextCandidates@COverlayContext@@CAJPEAV1@AEAV?$DynArray@PEAVOverlayPlaneInfo@COverlayContext@@$0A@@@1@Z @ 0x180166058
 * Callers:
...
__int64 __fastcall COverlayContext::GetContextCandidates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)(a2 + 24) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v3, 0x144Du);
  }
  return (unsigned int)v3;
}
