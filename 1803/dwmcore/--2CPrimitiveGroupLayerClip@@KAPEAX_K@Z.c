/*
 * XREFs of ??2CPrimitiveGroupLayerClip@@KAPEAX_K@Z @ 0x18016DEC0
 * Callers:
...
void *__fastcall CPrimitiveGroupLayerClip::operator new()
{
  void *result; // rax
  const void *retaddr; // [rsp+28h] [rbp+0h]

  result = WPF::ProcessHeapImpl::AllocClear(0x2B0uLL);
  if ( !result )
