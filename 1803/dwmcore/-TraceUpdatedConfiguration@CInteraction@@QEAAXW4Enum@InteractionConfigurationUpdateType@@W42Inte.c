/*
 * XREFs of ?TraceUpdatedConfiguration@CInteraction@@QEAAXW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@IPEBX@Z @ 0x180028378
 * Callers:
  ...
  if ( v5 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( v7 )
      {
        ...
        if ( v8 )
        {
          if ( v8 == 1 && (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
