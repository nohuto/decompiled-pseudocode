/*
 * XREFs of ?ExcludeFromVisibleRegion@CMoveRenderPassInfo@@QEAAJAEAV?$CRectF@UDeviceHPC@CoordinateSpace@@@@@Z @ 0x1801778B0
 * Callers:
...
LABEL_37:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v24, v31);
LABEL_38:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v5, 0xC4u);
  return (unsigned int)v5;
}
