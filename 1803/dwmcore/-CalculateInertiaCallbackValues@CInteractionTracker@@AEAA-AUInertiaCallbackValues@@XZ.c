/*
 * XREFs of ?CalculateInertiaCallbackValues@CInteractionTracker@@AEAA?AUInertiaCallbackValues@@XZ @ 0x180193AFC
 * Callers:
...
__int64 __fastcall CInteractionTracker::CalculateInertiaCallbackValues(CScrollAnimation **a1, __int64 a2)
{
  ...
  {
    v2.m128_f32[0] = CScrollAnimation::GetInertiaStartVelocity(*(CScrollAnimation **)(v6 + 488));
    v8 = v2;
    v2.m128_f32[0] = CScrollAnimation::GetInertiaStartVelocity(a1[62]);
    v9 = a1[60];
    ...
    *(_DWORD *)(a2 + 12) = v2.m128_i32[0];
    ...
    v11 = v2;
    v2.m128_f32[0] = CScrollAnimation::GetNaturalEndpoint(a1[62]);
    v12 = a1[60];
    ...
    *(_DWORD *)(a2 + 28) = v2.m128_i32[0];
    ...
    v14 = v2;
    v2.m128_f32[0] = CScrollAnimation::GetModifiedRestingValue(a1[62]);
    v15 = a1[60];
    ...
    *(float *)(a2 + 48) = ModifiedRestingValue;
    if ( CScrollAnimation::CanDetermineModifiedRestingValue(v17) )
      CanDetermineModifiedRestingValue = CScrollAnimation::CanDetermineModifiedRestingValue(a1[62]);
    v18 = a1[60];
