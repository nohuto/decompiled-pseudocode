/*
 * XREFs of ?IsEligibleForOverlays@COverlayContext@@AEAA_NAEBVOverlayPlaneInfo@1@@Z @ 0x180166910
 * Callers:
 ...
 *     ?IsSufficientIntervalForStats@OverlayPlaneInfo@COverlayContext@@QEBA_N_KPEAM@Z @ 0x180167138 (-IsSufficientIntervalForStats@OverlayPlaneInfo@COverlayContext@@QEBA_N_KPEAM@Z.c)
 *     ?IsSufficientPresentCountForEligibility@OverlayPlaneInfo@COverlayContext@@QEBA_NIM@Z @ 0x1801671E4 (-IsSufficientPresentCountForEligibility@OverlayPlaneInfo@COverlayContext@@QEBA_NIM@Z.c)
 */
        ...
        const struct COverlayContext::OverlayPlaneInfo *a2)
{
  ...
  if ( COverlayContext::IsRevokable(this, a2) )
  {
    ...
    v5 = *(_QWORD *)(*((_QWORD *)this + 151) + 496LL);
