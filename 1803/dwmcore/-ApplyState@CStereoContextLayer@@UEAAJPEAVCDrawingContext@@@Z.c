/*
 * XREFs of ?ApplyState@CStereoContextLayer@@UEAAJPEAVCDrawingContext@@@Z @ 0x1801740E0
 * Callers:
...
__int64 __fastcall CStereoContextLayer::ApplyState(CStereoContextLayer *this, struct CDrawingContext *a2)
{
  ...
  *((_DWORD *)a2 + 1694) = 0;
  if ( *((_DWORD *)this + 2) != *((_DWORD *)a2 + 101) )
  {
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x2Au);
    }
    else
    {
      ...
      if ( v8 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0x2Cu);
      }
      else
      {
        (*(void (__fastcall **)(struct IRenderTarget *))(*(_QWORD *)v6 + 176LL))(v6);
