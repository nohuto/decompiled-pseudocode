/*
 * XREFs of ?GetProperty@CEllipseGeometry@@UEAAJIPEAVCExpressionValue@@@Z @ 0x18018B760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CEllipseGeometry::GetProperty(CEllipseGeometry *this, int a2, struct CExpressionValue *a3)
{
  ...
  v10[0] = 2LL;
  v10[1] = &CEllipseGeometry::k_rgAnimDef;
  v5 = 0;
  ...
  else
  {
    ...
    v5 = Property;
    if ( Property < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Property, 0x3Fu);
  }
  return v5;
}
