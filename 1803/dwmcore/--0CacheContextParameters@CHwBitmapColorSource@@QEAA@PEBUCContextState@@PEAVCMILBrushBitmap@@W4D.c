/*
 * XREFs of ??0CacheContextParameters@CHwBitmapColorSource@@QEAA@PEBUCContextState@@PEAVCMILBrushBitmap@@W4DXGI_FORMAT@@_NW4ColorSpace@@VDisplayId@@@Z @ 0x1801EE190
 * Callers:
        ...
        int a7)
{
  ...
  *(_DWORD *)(a1 + 40) = a3[50];
  ...
  if ( ((unsigned __int64)(a3 + 55) & -(__int64)((a3[64] & 2) != 0)) != 0 )
  {
    ...
    *(_OWORD *)(a1 + 64) = *(_OWORD *)(((unsigned __int64)(a3 + 55) & -(__int64)(v8 != 0)) + 0x10);
    *(_DWORD *)(a1 + 80) = *(_DWORD *)(((unsigned __int64)(a3 + 55) & -(__int64)(v8 != 0)) + 0x20);
  }
  *(_BYTE *)(a1 + 44) = v7;
  return a1;
}
