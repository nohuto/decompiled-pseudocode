/*
 * XREFs of ?IsMonitorSpecificContent@CCachedVisualImage@@UEBA_NXZ @ 0x18001C420
 * Callers:
 *     ?IsMonitorSpecificContent@CHwndBitmap@@UEBA_NXZ @ 0x180190980 (-IsMonitorSpecificContent@CHwndBitmap@@UEBA_NXZ.c)
 * Callees:
