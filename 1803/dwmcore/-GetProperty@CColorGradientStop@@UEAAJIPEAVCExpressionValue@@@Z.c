/*
 * XREFs of ?GetProperty@CColorGradientStop@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180183100
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorGradientStop::GetProperty(CColorGradientStop *this, int a2, struct CExpressionValue *a3)
{
  ...
  v8[0] = 2LL;
  v8[1] = &CColorGradientStop::k_rgAnimDef;
  v5 = 0;
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x31u);
  }
  return v5;
}
