/*
 * XREFs of ?FillGradientTexture@CHwLinearGradientColorSource@@AEAAJAEBVCGradientColorData@@W4Enum@MilGradientWrapMode@@W43MilColorInterpolationMode@@@Z @ 0x1801F7314
 * Callers:
...
__int64 __fastcall CHwLinearGradientColorSource::FillGradientTexture(__int64 a1, __int64 a2, int a3, int a4)
{
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v8, 0xFDu);
  }
  else
  {
    if ( v12 >= 4 * *(_DWORD *)(a1 + 116) )
    {
      ...
      v9 = Gradient;
      if ( Gradient < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, Gradient, 0x10Fu);
    }
    else
    {
      v9 = -2003304446;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2003304446, 0x103u);
    }
