/*
 * XREFs of ??$SetProperty@UD2DVector2@@@DataSourcePropertySet@@QEAAJIPEBUD2DVector2@@W4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x18016A7C0
 * Callers:
...
__int64 __fastcall DataSourcePropertySet::SetProperty<D2DVector2>(_QWORD *a1, int a2, _QWORD *a3)
{
  __int64 v5; // rdi
  _QWORD *v6; // rax
  __int64 v7; // r10
...
LABEL_6:
  if ( v7 == v9 )
  {
    v10 = PropertySetStorage<DynArrayNoZero,PropertySetUserModeAllocator>::AddProperty<D2DVector2>(
            (__int64)(a1 + 8),
            35,
            a3,
            &v19);
  ...
  else
  {
    ...
    *(_QWORD *)((*(_DWORD *)(v14 + 8 * v13 + 4) & 0x1FFFFFFF) + a1[12]) = *a3;
  }
  return 0LL;
}
