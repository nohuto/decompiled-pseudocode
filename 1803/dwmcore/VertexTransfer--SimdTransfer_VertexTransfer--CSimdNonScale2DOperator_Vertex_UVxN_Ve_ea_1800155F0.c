/*
 * XREFs of VertexTransfer::SimdTransfer_VertexTransfer::CSimdNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____2_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1800155F0
 * Callers:
        ...
        float *a4)
{
  ...
  if ( v17 )
  {
    ...
    do
    {
      v22 = (__m128 *)(*(_QWORD *)v5 + (int)(v16 * *(_DWORD *)(v5 + 8)));
      v23 = *v22;
      v24 = (__m128 *)(*(_QWORD *)v5 + (int)(*(_DWORD *)(v5 + 8) * (v16 + 1)));
      v25 = (v16 + 1) * *(_DWORD *)(a1 + 64);
      v26 = *(_QWORD *)(a1 + 56) + (int)(v16 * *(_DWORD *)(a1 + 64));
      v27 = (__m128 *)(*(_QWORD *)(a1 + 56) + (int)v25);
      ...
      *v27 = v39;
      ...
      if ( a3 )
      {
        v39.m128_f32[0] = DirectX::g_XMZero;
        v43 = _mm_shuffle_ps(
                _mm_add_ps(
      ...
      {
        v43 = _mm_shuffle_ps(v42, *(__m128 *)&DirectX::g_XMZero, 228);
        v44 = (__m128)_mm_unpackhi_pd((__m128d)v42, *(__m128d *)&DirectX::g_XMZero);
      }
      *(__m128 *)(v26 + 16) = v43;
      *(_OWORD *)(v26 + 32) = v15;
      v27[1] = v44;
