/*
 * XREFs of ?OnChanged@CWindowNode@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x180092DA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0?$DynArrayIA@V?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@$03$0A@@@QEAA@XZ @ 0x18013F108 (--0-$DynArrayIA@V-$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@$03$0A.c)
...
__int64 __fastcall CWindowNode::OnChanged(__int64 a1, int a2, int (__fastcall ***a3)(void *, GUID *, __int64 *))
{
  ...
  tagPOINT v67; // [rsp+40h] [rbp-C8h] BYREF
  ...
  if ( !v70
    || !CRenderTargetManager::IsOverlayOrDirectFlipAssigned(
          *(CRenderTargetManager **)(*(_QWORD *)(a1 + 16) + 72LL),
          ...
          (struct ISwapChainContent *)((*(_QWORD *)(a1 + 864) + 56LL) & -(__int64)(*(_QWORD *)(a1 + 864) != 0LL))) )
  {
    if ( (**a3)(a3, &GUID_c155b649_2c5b_416a_b836_bbda56b2ec26, &v68) < 0 )
      goto LABEL_3;
    v81 = 0LL;
    v82 = 0LL;
    *(_QWORD *)v83 = 0LL;
    ...
    {
      if ( *(_BYTE *)(a1 + 920) )
        v16 = (float)(*(_DWORD *)(a1 + 680) - *(_DWORD *)(a1 + 672)) - (float)(v78 - v76);
    }
    else if ( (float)(v78 - v76) > 0.0 && (float)(v79 - v77) > 0.0 )
    {
      v24 = 0;
      if ( *(_DWORD *)(a1 + 680) - *(_DWORD *)(a1 + 672) >= 0 )
        v24 = *(_DWORD *)(a1 + 680) - *(_DWORD *)(a1 + 672);
      v25 = _mm_cvtsi32_si128(v24);
      v26 = 0;
      if ( *(_DWORD *)(a1 + 684) - *(_DWORD *)(a1 + 676) >= 0 )
        v26 = *(_DWORD *)(a1 + 684) - *(_DWORD *)(a1 + 676);
      v14 = _mm_cvtepi32_ps(v25).m128_f32[0] / (float)(v78 - v76);
      v15 = (float)v26 / (float)(v79 - v77);
    }
    if ( (_DWORD)v81 )
    {
      if ( CCompositionSurfaceBitmap::IsOpaque((CCompositionSurfaceBitmap *)(*(_QWORD *)(a1 + 864) + 64LL)) )
      {
        v5 = 1;
        DxClipShape = (CShapePtr *)CWindowNode::GetDxClipShape(a1, &rc);
        if ( CShapePtr::IsAxisAlignedRectangle(DxClipShape) && !*(_BYTE *)(a1 + 924) )
        {
          v28 = 0;
          if ( qword_1802D6428 )
          {
...
LABEL_47:
    ...
    if ( (v5 & 1) != 0 )
      CShapePtr::Release((CRectanglesShape **)&rc);
    if ( !v21 )
    {
LABEL_63:
      v53 = v86;
      if ( v86 && (*(_BYTE *)(a1 + 88) & 4) == 0 )
      {
        for ( i = 0; i <= v86; ++i )
        {
          ...
          v62 = (float)(*(_DWORD *)(a1 + 676) - *(_DWORD *)(a1 + 644));
          v63 = (float)(*(_DWORD *)(a1 + 672) - *(_DWORD *)(a1 + 640));
          v77 = v59 + v62;
          v76 = v58 + v63;
          v78 = v60 + v63;
          v79 = v61 + v62;
      ...
      ReleaseInterfaceNoNULL<IWICBitmap>(v68);
      DynArrayImpl<0>::~DynArrayImpl<0>((__int64)v85);
      goto LABEL_3;
    }
    v33 = v83[1];
    v34 = v83[2];
...
LABEL_62:
    ...
    {
      CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)v72);
      CMILMatrix::Transform((CMILMatrix *)v72, (const struct MilPoint2F *)&v65, (struct MilPoint2F *)&v65, 1u);
      v44 = v79;
      v43 = v78;
      v42 = v77;
      v41 = v76;
    ...
    v45 = *(_DWORD *)(a1 + 672) - *(_DWORD *)(a1 + 688);
    v46 = *(_DWORD *)(a1 + 676) - *(_DWORD *)(a1 + 692);
    v47 = v41 + 6291456.25;
  ...
  if ( *(_DWORD *)(v10 + 48) )
  {
    do
    {
      ...
      if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v11 + 48LL))(v11, 76LL) )
      {
        ...
        if ( *(_QWORD *)(*(_QWORD *)(v12 + 168) + 152LL) != *(_QWORD *)(v12 + 168) )
          *(_BYTE *)(v12 + 161) = 1;
      }
      ++v9;
    }
