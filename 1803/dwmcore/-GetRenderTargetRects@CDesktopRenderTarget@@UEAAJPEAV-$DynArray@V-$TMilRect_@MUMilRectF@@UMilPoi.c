/*
 * XREFs of ?GetRenderTargetRects@CDesktopRenderTarget@@UEAAJPEAV?$DynArray@V?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@$0A@@@@Z @ 0x180157C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDesktopRenderTarget::GetRenderTargetRects(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(a1 + 32) )
  {
    while ( 1 )
    {
      v6 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 8) + 8 * v3) + 168LL);
      if ( *(_QWORD *)(v6 + 152) == v6 )
      {
        v7 = *(_OWORD *)(v6 + 120);
        v8 = 0LL;
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x5F5u);
  }
  return v2;
}
