/*
 * XREFs of ?SetOpacityMultiplier@CProjectedShadowCaster@@AEAAXM@Z @ 0x1801A0E04
 * Callers:
...
void __fastcall CProjectedShadowCaster::SetOpacityMultiplier(CProjectedShadowCaster *this, float a2)
{
  if ( *((float *)this + 22) != a2 )
  {
    *((float *)this + 22) = a2;
