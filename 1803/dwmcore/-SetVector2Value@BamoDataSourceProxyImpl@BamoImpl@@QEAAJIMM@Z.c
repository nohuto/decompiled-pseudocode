/*
 * XREFs of ?SetVector2Value@BamoDataSourceProxyImpl@BamoImpl@@QEAAJIMM@Z @ 0x18016C790
 * Callers:
 *     ?Thunk_SetVector2Value_16@?$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18016CBC0 (-Thunk_SetVector2Value_16@-$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEA.c)
 * Callees:
        ...
        float a4)
{
  ...
  v6 = (*(__int64 (__fastcall **)(char *, _QWORD))(*((_QWORD *)this - 2) + 80LL))((char *)this - 16, a2);
  v7 = v10;
  v8 = v6;
  if ( v10 )
  {
