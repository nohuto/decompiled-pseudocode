/*
 * XREFs of ?SetProperty@CColorBrush@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x18009ADB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorBrush::SetProperty(CResource *a1, __int64 a2, __int64 a3, struct _D3DCOLORVALUE *a4)
{
  ...
  {
    v8 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x3Eu);
  }
  return v8;
}
