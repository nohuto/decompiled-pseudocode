/*
 * XREFs of ?_Buynode0@?$_List_alloc@U?$_List_base_types@U?$pair@QEAVCVisual@@UShadowIntermediates@CDropShadow@@@std@@V?$allocator@U?$pair@QEAVCVisual@@UShadowIntermediates@CDropShadow@@@std@@@2@@std@@@std@@QEAAPEAU?$_List_node@U?$pair@QEAVCVisual@@UShadowIntermediates@CDropShadow@@@std@@PEAX@2@PEAU32@0@Z @ 0x18018AD6C
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  result = (_QWORD *)std::_Allocate<std::_Default_allocate_traits<1>>(1uLL, 0x40uLL);
  if ( !a2 )
  {
    a2 = result;
    a3 = result;
