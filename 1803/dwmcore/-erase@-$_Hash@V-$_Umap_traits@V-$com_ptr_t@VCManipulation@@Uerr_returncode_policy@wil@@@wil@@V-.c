        ...
        __int64 a3)
{
  ...
  v11 = *(_QWORD *)(a3 + 16);
  v5 = std::_Hash_bytes((const unsigned __int8 *)&v11, 8uLL);
  v7 = a1[3];
  v8 = 2 * (a1[6] & v5);
