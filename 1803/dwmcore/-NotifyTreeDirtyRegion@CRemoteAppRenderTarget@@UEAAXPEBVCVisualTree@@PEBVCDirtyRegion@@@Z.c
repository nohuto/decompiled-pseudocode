/*
 * XREFs of ?NotifyTreeDirtyRegion@CRemoteAppRenderTarget@@UEAAXPEBVCVisualTree@@PEBVCDirtyRegion@@@Z @ 0x18015C930
 * Callers:
 *     <none>
 * Callees:
...
{
  ReplaceInterface<CRegionWrapper,CRegionWrapper>((__int64 *)this + 15, (__int64 (__fastcall ***)(_QWORD))a3);
