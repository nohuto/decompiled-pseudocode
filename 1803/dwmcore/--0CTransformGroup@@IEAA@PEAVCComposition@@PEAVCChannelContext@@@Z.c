/*
 * XREFs of ??0CTransformGroup@@IEAA@PEAVCComposition@@PEAVCChannelContext@@@Z @ 0x1800194DC
 * Callers:
 ...
 * Callees:
 *     ??0CCyclicResourceListEntry@@IEAA@PEAVCResourceTable@@@Z @ 0x1800198F0 (--0CCyclicResourceListEntry@@IEAA@PEAVCResourceTable@@@Z.c)
 */
        ...
        struct CResourceTable **a3)
{
  ...
  *(_QWORD *)this = &CTransform::`vftable';
  CCyclicResourceListEntry::CCyclicResourceListEntry((CTransformGroup *)((char *)this + 152), a3[3]);
