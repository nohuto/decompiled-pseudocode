/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_ProjectedShadow@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x1800BA4FC
 * Callers:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_ProjectedShadow>::GetCachedFeatureEnabledState(
        __int64 a1,
        unsigned int a2,
        enum FEATURE_CHANGE_TIME a3)
{
  ...
  v3 = `wil::Feature<__WilFeatureTraits_Feature_ProjectedShadow>::GetFeaturePropertyCache'::`2'::data & 3;
  v4 = v3;
  ...
  {
    FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState((wil::details *)0xA45513, a2, a3);
    v6 = ((unsigned int)FeatureEnabledState >> 6) & 1;
    v7 = ((FeatureEnabledState & 0x80u) != 0) + 1;
    v8 = FeatureEnabledState & 0xFFFFFF3F;
    if ( !v8 || (v4 = 2, v8 != 2) )
      v4 = 1;
    v9 = (`wil::Feature<__WilFeatureTraits_Feature_ProjectedShadow>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
    if ( v3 )
      v4 = v3;
    else
      v9 = v6;
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      0LL);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(10769683LL, 0LL, v13) )
    {
      if ( v3 )
      {
        v11 = v7;
