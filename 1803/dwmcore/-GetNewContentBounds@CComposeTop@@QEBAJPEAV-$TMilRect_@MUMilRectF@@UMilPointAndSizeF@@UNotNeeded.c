/*
 * XREFs of ?GetNewContentBounds@CComposeTop@@QEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801ADAA4
 * Callers:
...
__int64 __fastcall CComposeTop::GetNewContentBounds(__int64 a1, _DWORD *a2)
{
  ...
  *a2 = 0;
  ...
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v4, 0x5Eu);
  return v5;
}
