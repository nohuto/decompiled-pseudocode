/*
 * XREFs of ?FindTreeNoLock@CMonitorTreeAssociation@@QEAAJPEAUHMONITOR__@@PEAPEAVCVisualTree@@@Z @ 0x180034DBC
 * Callers:
        ...
        struct CVisualTree **a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    v5 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_180277D74, 1u, -2003292412, 0x92u);
  }
  return v5;
}
