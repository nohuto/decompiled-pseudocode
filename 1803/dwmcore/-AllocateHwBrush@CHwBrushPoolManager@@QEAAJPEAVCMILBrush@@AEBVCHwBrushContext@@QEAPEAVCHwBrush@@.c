/*
 * XREFs of ?AllocateHwBrush@CHwBrushPoolManager@@QEAAJPEAVCMILBrush@@AEBVCHwBrushContext@@QEAPEAVCHwBrush@@@Z @ 0x1801F6B30
 * Callers:
 ...
 *     ?Remove@CHwBrushPoolManager@@AEAAXPEAVCHwCacheablePoolBrush@@@Z @ 0x1801F6C54 (-Remove@CHwBrushPoolManager@@AEAAXPEAVCHwCacheablePoolBrush@@@Z.c)
 */
        ...
        struct CHwBrush **const a4)
{
  ...
  do
  {
    ...
    if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v9 + 32LL))(v9) )
    {
      ...
      if ( v10 >= 0 )
        goto LABEL_7;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v10, 0x1BBu);
    }
    if ( v8 < 0 )
    {
...
LABEL_7:
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v11, 0x1D8u);
  }
