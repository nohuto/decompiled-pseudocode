/*
 * XREFs of ?GetProperty@CInteractionTracker@@MEAAJIPEAVCExpressionValue@@@Z @ 0x180194540
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v16 )
    {
      ...
      if ( !v17 )
      {
        if ( CInteractionTracker::AreInteractionAnimationsAlive(this) )
          NaturalEndpoint = CScrollAnimation::GetNaturalEndpoint(*(CScrollAnimation **)(v26 + 480));
        else
...
LABEL_20:
    ...
    else
    {
      if ( CInteractionTracker::AreInteractionAnimationsAlive(this) )
      {
        LODWORD(v31) = CScrollAnimation::GetNaturalEndpoint(*(CScrollAnimation **)(v27 + 488));
        v28 = CScrollAnimation::GetNaturalEndpoint(*((CScrollAnimation **)this + 62));
        v25 = v32;
        *((float *)&v31 + 1) = v28;
        v29 = v31;
      }
...
LABEL_29:
    v4 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x463u);
    return v4;
  }
  v14 = *((_DWORD *)this + 17);
LABEL_18:
