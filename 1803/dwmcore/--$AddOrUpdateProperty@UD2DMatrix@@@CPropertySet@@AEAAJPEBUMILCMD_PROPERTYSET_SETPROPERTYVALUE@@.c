/*
 * XREFs of ??$AddOrUpdateProperty@UD2DMatrix@@@CPropertySet@@AEAAJPEBUMILCMD_PROPERTYSET_SETPROPERTYVALUE@@PEBUD2DMatrix@@@Z @ 0x180038E10
 * Callers:
...
__int64 __fastcall CPropertySet::AddOrUpdateProperty<D2DMatrix>(CResource *a1, _DWORD *a2, unsigned __int8 *a3)
{
  int updated; // eax
  unsigned int v4; // ebx
  int v5; // r9d
  ...
  if ( a2[5] )
  {
    updated = CPropertySet::AddProperty<D2DMatrix>(a1, a2[2], a2[3], a2[4], a3);
    v4 = updated;
    if ( updated < 0 )
    {
      v10 = 318;
...
LABEL_11:
  ...
  else
  {
    ...
    updated = CPropertySet::UpdateProperty<D2DMatrix>(v8);
    v4 = updated;
    if ( updated < 0 )
    {
      v10 = 329;
