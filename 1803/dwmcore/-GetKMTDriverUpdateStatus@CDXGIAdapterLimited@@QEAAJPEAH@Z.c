/*
 * XREFs of ?GetKMTDriverUpdateStatus@CDXGIAdapterLimited@@QEAAJPEAH@Z @ 0x1800CB564
 * Callers:
...
LABEL_13:
  ...
  {
    v5 = v6 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v6 | 0x10000000, 0x14Fu);
  }
  else
  {
    *a2 = v12;
...
LABEL_5:
  ...
  ReleaseInterfaceNoNULL<IWICBitmap>(v13);
  if ( v5 == -805305674 )
