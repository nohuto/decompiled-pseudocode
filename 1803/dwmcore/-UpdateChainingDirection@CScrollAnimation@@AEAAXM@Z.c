/*
 * XREFs of ?UpdateChainingDirection@CScrollAnimation@@AEAAXM@Z @ 0x1801BE8F8
 * Callers:
  ...
  if ( (v2 & 1) != 0 )
  {
    ...
    *((_BYTE *)this + 404) = v7;
    if ( (v7 & 1) == 0 )
    {
      ...
      if ( v8 )
        v5 = *(_QWORD *)(v8 + 8);
      ActiveChainingHelper = InteractionSourceManager::TryGetActiveChainingHelper((InteractionSourceManager *)(v5 + 352));
      v10 = 3LL * *((int *)this + 73);
      *((_BYTE *)ActiveChainingHelper + 4 * v10) |= 4u;
      *((_DWORD *)ActiveChainingHelper + v10 + 2) = -805306369;
