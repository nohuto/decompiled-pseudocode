/*
 * XREFs of ?UnboundedValueAtTime@CScaleMotion@@AEBAMM@Z @ 0x1801C57F4
 * Callers:
 *     ?AdvanceInertiaToTimeDefault@CScaleMotion@@MEAAMXZ @ 0x1801C5620 (-AdvanceInertiaToTimeDefault@CScaleMotion@@MEAAMXZ.c)
