/*
 * XREFs of ?UpdateGradientStrip@CAtlasTexture@@QEAAXPEBVCAtlasEntry@@V?$span@$$CBE$0?0@gsl@@@Z @ 0x180013378
 * Callers:
...
__int64 __fastcall CAtlasTexture::UpdateGradientStrip(CAtlasTexture *a1, __int64 a2, __int64 *a3)
{
  ...
  Microsoft::WRL::ComPtr<CD3DTexture>::InternalRelease(&v15);
  (*(void (__fastcall **)(_QWORD *, __int64 *))(**((_QWORD **)a1 + 1) + 240LL))(*((_QWORD **)a1 + 1), &v15);
  ...
  CD3DDeviceLevel1::UpdateSubresource(
    ...
    *(struct ID3D11Resource **)(v9 + 120),
    ...
    v13,
    1);
  return Microsoft::WRL::ComPtr<CD3DTexture>::InternalRelease(&v15);
}
