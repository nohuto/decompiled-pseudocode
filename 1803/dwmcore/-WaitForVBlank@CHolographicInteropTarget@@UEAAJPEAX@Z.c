/*
 * XREFs of ?WaitForVBlank@CHolographicInteropTarget@@UEAAJPEAX@Z @ 0x1801FE720
 * Callers:
 *     <none>
 * Callees:
 *     ?WaitForVBlank@CHolographicManager@@QEAAJXZ @ 0x1801F946C (-WaitForVBlank@CHolographicManager@@QEAAJXZ.c)
 */
