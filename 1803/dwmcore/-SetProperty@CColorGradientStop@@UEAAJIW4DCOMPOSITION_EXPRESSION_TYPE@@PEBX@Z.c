/*
 * XREFs of ?SetProperty@CColorGradientStop@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x180183180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorGradientStop::SetProperty(CResource *a1, int a2, int a3, struct _D3DCOLORVALUE *a4)
{
  ...
  v10[0] = 2LL;
  v10[1] = &CColorGradientStop::k_rgAnimDef;
