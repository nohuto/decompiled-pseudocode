/*
 * XREFs of ?HrCreateBitmapFromMemoryEx@@YAJIIAEBUPixelFormatInfo@@IIPEAEPEAUIUnknown@@PEAPEAVIBitmapSource@@@Z @ 0x180020A04
 * Callers:
 ...
 *     ??0CClientMemoryBitmap@@QEAA@XZ @ 0x180020C08 (--0CClientMemoryBitmap@@QEAA@XZ.c)
