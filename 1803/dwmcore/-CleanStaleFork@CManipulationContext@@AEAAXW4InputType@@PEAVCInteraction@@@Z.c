/*
 * XREFs of ?CleanStaleFork@CManipulationContext@@AEAAXW4InputType@@PEAVCInteraction@@@Z @ 0x1801DA1F8
 * Callers:
  ...
  if ( a3 )
  {
    ...
    do
    {
      ...
      if ( dword_1802D3FE0 > 4u && TlgKeywordOn((TraceLoggingHProvider)&dword_1802D3FE0, 2uLL) )
      {
        ...
        v24 = 0;
        v22 = &v3[4 * v7 + 240];
        TlgWrite((TraceLoggingHProvider)&dword_1802D3FE0, &unk_1802AB79E, 0LL, 0LL, 6u, &pData);
      }
