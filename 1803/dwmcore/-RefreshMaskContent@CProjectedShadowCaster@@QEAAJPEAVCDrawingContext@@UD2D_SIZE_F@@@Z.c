/*
 * XREFs of ?RefreshMaskContent@CProjectedShadowCaster@@QEAAJPEAVCDrawingContext@@UD2D_SIZE_F@@@Z @ 0x1801A0A10
 * Callers:
        ...
        struct D2D_SIZE_F a3)
{
  ...
  if ( v4 )
  {
    ...
    v7 = (*(__int64 (__fastcall **)(_QWORD, struct CDrawingContext *, struct D2D_SIZE_F *))(**((_QWORD **)this + 14)
                                                                                          + 288LL))(
           *((_QWORD *)this + 14),
           a2,
           &v13);
    ...
    if ( v7 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x2F5u);
      return v5;
    }
  }
  v8 = *((_QWORD *)this + 15);
  if ( v8 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v9, 0x2FEu);
    }
           ...
           || (v10 = COERCE_DOUBLE(COERCE_UNSIGNED_INT64((float)(v13.height - (float)(v16 - v14.height))) & _xmm),
               v10 > 0.015625) )
    {
      Microsoft::WRL::ComPtr<IImageSource>::InternalRelease((CRenderTargetImageSource **)this + 15);
