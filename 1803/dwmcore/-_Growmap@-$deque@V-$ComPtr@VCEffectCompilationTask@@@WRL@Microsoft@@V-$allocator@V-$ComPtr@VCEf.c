/*
 * XREFs of ?_Growmap@?$deque@V?$ComPtr@VCEffectCompilationTask@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@VCEffectCompilationTask@@@WRL@Microsoft@@@std@@@std@@IEAAX_K@Z @ 0x18003558C
 * Callers:
...
void __fastcall std::deque<Microsoft::WRL::ComPtr<CEffectCompilationTask>>::_Growmap(_QWORD *a1)
{
  ...
  v5 = a1[3] >> 1;
  v6 = (char *)std::_Allocate<std::_Default_allocate_traits<1>>(v3, 8LL);
  v7 = 8 * v5;
  v8 = 8LL * a1[2] - 8 * v5;
