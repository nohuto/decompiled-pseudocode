/*
 * XREFs of ?CreateFullRectD2DGeometry@CRoundedRectangleShape@@CAJPEBUMilPoint2F@@PEAPEAUID2D1PathGeometry@@@Z @ 0x18020CDB0
 * Callers:
        ...
        struct ID2D1PathGeometry **a2)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, v7, 0x112u);
  }
  else
  {
    ...
    if ( D2DFactoryNoRef < 0 )
    {
      v9 = 282;
LABEL_9:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, D2DFactoryNoRef, v9);
    }
  }
