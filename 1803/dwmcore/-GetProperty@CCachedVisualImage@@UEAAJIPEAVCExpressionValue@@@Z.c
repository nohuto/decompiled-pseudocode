/*
 * XREFs of ?GetProperty@CCachedVisualImage@@UEAAJIPEAVCExpressionValue@@@Z @ 0x180182440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCachedVisualImage::GetProperty(CCachedVisualImage *this, int a2, struct CExpressionValue *a3)
{
  ...
  v8[0] = 4LL;
  v8[1] = &CCachedVisualImage::k_rgAnimDef;
  v5 = 0;
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0, -2147024809, 0x65Du);
  }
  return v5;
}
