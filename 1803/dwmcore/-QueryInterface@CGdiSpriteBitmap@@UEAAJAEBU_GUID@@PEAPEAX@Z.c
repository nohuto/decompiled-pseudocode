/*
 * XREFs of ?QueryInterface@CGdiSpriteBitmap@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180093A70
 * Callers:
 ...
 *     ?QueryInterface@CGdiSpriteBitmap@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DDC00 (-QueryInterface@CGdiSpriteBitmap@@WDI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     ?HrFindInterface@CGdiSpriteBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180093B00 (-HrFindInterface@CGdiSpriteBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
