/*
 * XREFs of ??$emplace_back@AEBV?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@@?$vector@V?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAAXAEBV?$com_ptr_t@VCManipulation@@Uerr_returncode_policy@wil@@@wil@@@Z @ 0x1801C94FC
 * Callers:
...
__int64 __fastcall std::vector<wil::com_ptr_t<CManipulation,wil::err_returncode_policy>>::emplace_back<wil::com_ptr_t<CManipulation,wil::err_returncode_policy> const &>(
        __int64 **a1,
        _QWORD *a2)
{
  __int64 *v2; // rax
  ...
  {
    return wil::com_ptr_t<IDXGIAdapter,wil::err_returncode_policy>::com_ptr_t<IDXGIAdapter,wil::err_returncode_policy>(
             a1[1]++,
             *a2);
  }
}
