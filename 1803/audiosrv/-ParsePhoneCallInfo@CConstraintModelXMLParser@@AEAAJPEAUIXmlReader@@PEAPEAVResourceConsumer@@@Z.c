/*
 * XREFs of ?ParsePhoneCallInfo@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEAPEAVResourceConsumer@@@Z @ 0x1801152F4
 * Callers:
  ...
  if ( EndElement >= 0 )
  {
    ...
    if ( EndElement >= 0 )
    {
      ...
      if ( EndElement >= 0 )
      {
        ...
        {
          *((_DWORD *)v8 + 2) = 0;
          *(_QWORD *)v8 = &KeywordDetectorResourceConsumer::`vftable';
          *((_DWORD *)v8 + 4) = v6;
        }
        *a3 = v8;
        if ( !v8 )
