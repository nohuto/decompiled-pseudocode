/*
 * XREFs of ?Init@AudioEffectsWatcher@@QEAAJPEBGKH@Z @ 0x1800A76E8
 * Callers:
...
__int64 __fastcall AudioEffectsWatcher::Init(char *pv, const unsigned __int16 *a2, int a3, int a4)
{
  ...
  CEndpointCharacteristics *v20; // [rsp+48h] [rbp-39h] BYREF
  ...
  do
    ++v11;
  while ( a2[v11] );
  PropertyStoreProperty = _AllocStringWorker<CTCoAllocPolicy>(v9, v8, a2, v11, v19, (unsigned __int16 **)pv + 3);
  ...
  *((_DWORD *)pv + 9) = a4;
         ...
         0LL) )
  {
    ...
    {
LABEL_9:
      PropertyStoreProperty = v14 | 0x10000000;
      goto LABEL_21;
    }
    *(_QWORD *)(pv + 92) = v24;
    pv[88] = 1;
    PropertyStoreProperty = (*(__int64 (__fastcall **)(CEndpointCharacteristicsCache *, const unsigned __int16 *, _QWORD, CEndpointCharacteristics **))(*(_QWORD *)g_pEndpointCharacteristicsCache + 24LL))(
    ...
    if ( (unsigned int)CEndpointCharacteristics::EndpointConnectorSupportsProcessingModes(v20, 0) )
    {
      ...
      *((_QWORD *)pv + 26) = ThreadpoolWait;
      ...
      if ( PropertyStoreProperty < 0 )
        goto LABEL_21;
      pv[64] = 1;
      PropertyStoreProperty = CPolicyConfig::GetPropertyStoreProperty(*v10, 1, &PKEY_AudioEndpoint_Disable_SysFx, &pvar);
      if ( PropertyStoreProperty < 0 )
        goto LABEL_21;
      lVal = 0;
      if ( pvar.vt == 19 )
    ...
    {
      v14 = RtlPublishWnfStateData(*(_QWORD *)(pv + 92), 0LL, &unk_18014B198, 16LL, 0LL);
      if ( v14 < 0 )
        goto LABEL_9;
    }
