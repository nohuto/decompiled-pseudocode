/*
 * XREFs of ?ToString@CAppAudioSessionId@@QEBAJAEAV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@Z @ 0x180009C70
 * Callers:
...
LABEL_10:
  ...
  catch ( ATL::CAtlException *v19 )
  {
    ...
    v5 = *v12;
    if ( v20 < 0 )
      AudSrvTraceLoggingErrorHelper("CAppAudioSessionId::ToString", 0x200u, v20);
  }
  return v5;
}
