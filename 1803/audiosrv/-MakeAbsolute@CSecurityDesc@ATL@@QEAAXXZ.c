/*
 * XREFs of ?MakeAbsolute@CSecurityDesc@ATL@@QEAAXXZ @ 0x180040E88
 * Callers:
 ...
 *     ?GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z @ 0x180040DC0 (-GetControl@CSecurityDesc@ATL@@QEBA_NPEAG@Z.c)
...
void __fastcall ATL::CSecurityDesc::MakeAbsolute(PSECURITY_DESCRIPTOR *this)
{
  ...
  void (__fastcall *v12)(ATL::CSecurityDesc *); // rax
  int Error; // ebx
  ...
  if ( this[1] )
  {
    ...
    if ( (v16 & 0x8000u) != 0 )
    {
      ...
      v12 = (void (__fastcall *)(ATL::CSecurityDesc *))*((_QWORD *)*this + 1);
      if ( v12 == ATL::CSecurityDesc::Clear )
        ATL::CSecurityDesc::Clear((ATL::CSecurityDesc *)this);
      else
        v12((ATL::CSecurityDesc *)this);
      this[1] = v3;
    }
  }
}
