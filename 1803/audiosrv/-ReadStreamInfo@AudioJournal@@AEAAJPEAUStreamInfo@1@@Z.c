/*
 * XREFs of ?ReadStreamInfo@AudioJournal@@AEAAJPEAUStreamInfo@1@@Z @ 0x180049C88
 * Callers:
...
__int64 __fastcall AudioJournal::ReadStreamInfo(AudioJournal *this, struct AudioJournal::StreamInfo *pvData)
{
  ...
  Size = 0;
  pcbData = 0;
  if ( pvData == (AudioJournal *)((char *)this + 232) )
  {
    v3 = L"Render";
    v4 = 600;
  }
  else if ( pvData == (AudioJournal *)((char *)this + 832) )
  {
    v3 = L"Capture";
    v4 = 400;
  }
  ...
  {
    if ( pvData != (AudioJournal *)((char *)this + 1232) )
    {
      v6 = -2147024809;
      v14 = 411LL;
      goto LABEL_25;
