/*
 * XREFs of ?SetApplicationDefaultEndpoint@CPolicyConfig@@UEAAJKW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@PEBG@Z @ 0x1800BD440
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    ...
    Instance = (*(__int64 (__fastcall **)(LPVOID, struct IUnknown *, _QWORD, _QWORD))(*(_QWORD *)ppv[0] + 88LL))(
                 ppv[0],
                 v16,
                 (unsigned int)v5,
                 v6);
...
LABEL_15:
  ...
  Instance = -2147024809;
LABEL_16:
  AudSrvTraceLoggingErrorHelper("CPolicyConfig::SetApplicationDefaultEndpoint", 4326, Instance);
  v8 = v16;
  v9 = v17;
LABEL_17:
  if ( v9 )
