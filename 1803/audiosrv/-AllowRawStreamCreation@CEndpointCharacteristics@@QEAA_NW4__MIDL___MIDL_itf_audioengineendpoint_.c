/*
 * XREFs of ?AllowRawStreamCreation@CEndpointCharacteristics@@QEAA_NW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x1800E9D14
 * Callers:
...
char __fastcall CEndpointCharacteristics::AllowRawStreamCreation(CEndpointCharacteristics *this, int a2)
{
  __int64 v2; // rbx
