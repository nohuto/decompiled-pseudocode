/*
 * XREFs of ?QueryInterface@CaptureMonitor@CMonitorManager@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800E1140
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x59u, (__int64)&WPP_1a258077347a3434ed979dcee8522c59_Traceguids, v7);
  }
