/*
 * XREFs of _dynamic_initializer_for__g_SpatialAudioTraceLoggingProviderRegistration__ @ 0x180001300
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_SpatialAudioTraceLoggingProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1801883B0, a2, a3);
