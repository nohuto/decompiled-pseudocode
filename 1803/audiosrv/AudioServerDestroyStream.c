/*
 * XREFs of AudioServerDestroyStream @ 0x180043620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerDestroyStream(CVADServer *this, unsigned __int64 a2)
{
  ...
  *(GUID *)&pftDueTime[0].dwLowDateTime = v4;
  ...
  v9 = *(__int64 (__fastcall **)(CVADServer *__hidden, unsigned __int64))(*(_QWORD *)this + 104LL);
  ...
  v11 = v10;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerDestroyStream", 0xD42u, v10);
  if ( pv[0] )
  {
