/*
 * XREFs of McTemplateU0zqttq @ 0x1800021FC
 * Callers:
...
__int64 __fastcall McTemplateU0zqttq(__int64 a1, __int64 a2, const wchar_t *a3, int a4, char a5, char a6, char a7)
{
  __int64 v7; // rax
  int v8; // ecx
  ...
  v21 = 4LL;
  v20 = &a7;
  return McGenEventWriteUM(&AUDIO_EVENT_PROVIDER_Context, a2, 6LL, v10);
}
