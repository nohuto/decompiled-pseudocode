/*
 * XREFs of ??1?$unique_ptr@VCVpoContextProxy@@U?$default_delete@VCVpoContextProxy@@@std@@@std@@QEAA@XZ @ 0x1800C0500
 * Callers:
 *     AudioServerGetEndpointVpoContext$dtor$4 @ 0x1800C44F9 (AudioServerGetEndpointVpoContext$dtor$4.c)
 *     AudioServerGetStreamVpoContext$dtor$6 @ 0x1800C5356 (AudioServerGetStreamVpoContext$dtor$6.c)
 * Callees:
