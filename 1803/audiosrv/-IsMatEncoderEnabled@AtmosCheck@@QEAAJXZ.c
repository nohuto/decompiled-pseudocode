/*
 * XREFs of ?IsMatEncoderEnabled@AtmosCheck@@QEAAJXZ @ 0x18004F844
 * Callers:
 ...
 *     ?IsTechnologyLicenseAcquired@CSpatialAudioDolbyAtmosMAT@@UEBA_NXZ @ 0x1800FF1C0 (-IsTechnologyLicenseAcquired@CSpatialAudioDolbyAtmosMAT@@UEBA_NXZ.c)
 * Callees:
 *     <none>
 */
