/*
 * XREFs of ?InitializeSystemEffectsInterfaceOOP@CAPOWrapperClient@@UEAAJPEAUIMMDevice@@PEAU_GUID@@U3@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x18002D4B0
 * Callers:
        ...
        struct IAudioSystemEffects2 **a7)
{
  ...
  __int64 v15; // rcx
  int v17; // [rsp+50h] [rbp-81h] BYREF
  int v18; // [rsp+54h] [rbp-7Dh] BYREF
  LPVOID pv; // [rsp+58h] [rbp-79h] BYREF
  __int128 v20; // [rsp+60h] [rbp-71h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+70h] [rbp-61h] BYREF
  const char *v22; // [rsp+90h] [rbp-41h]
  ...
  if ( a2 && *((_QWORD *)this + 6) )
  {
    v17 = ((__int64 (__fastcall *)(struct IMMDevice *, LPVOID *, struct IMMDevice *))a2->lpVtbl->GetId)(a2, &pv, a2);
    v13 = v17;
    if ( v17 < 0 )
      goto LABEL_10;
    v14 = *(__int64 (__fastcall **)(__int64, LPVOID, struct _GUID *, __int128 *, int, enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001, bool, char *))(**((_QWORD **)this + 6) + 32LL);
    v15 = *((_QWORD *)this + 6);
    v20 = (__int128)*a4;
    v17 = v14(v15, pv, a3, &v20, a5, a6, a7 != 0LL, (char *)this + 64);
    v13 = v17;
    if ( v17 < 0 )
      goto LABEL_10;
    if ( a7 )
...
LABEL_10:
      if ( (unsigned int)dword_1801884D0 > 2 )
      {
        ...
        v25 = 4LL;
        v27 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1801884D0, &unk_1801494DA, v11, v12, 5u, &pData);
        v13 = v17;
      }
    }
    v7 = pv;
