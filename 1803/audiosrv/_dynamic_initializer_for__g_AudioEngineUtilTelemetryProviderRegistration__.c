/*
 * XREFs of _dynamic_initializer_for__g_AudioEngineUtilTelemetryProviderRegistration__ @ 0x180001320
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall dynamic_initializer_for__g_AudioEngineUtilTelemetryProviderRegistration__(
        ...
        void *a3)
{
  TraceLoggingRegisterEx((TraceLoggingHProvider)&dword_1801884D0, a2, a3);
