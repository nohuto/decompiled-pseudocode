/*
 * XREFs of ??_GCResourcePriorityTracker@@QEAAPEAXI@Z @ 0x18009954C
 * Callers:
 *     ??1?$CAutoPtr@VCResourcePriorityTracker@@@ATL@@QEAA@XZ @ 0x1800998D8 (--1-$CAutoPtr@VCResourcePriorityTracker@@@ATL@@QEAA@XZ.c)
 * Callees:
