/*
 * XREFs of ?GetPropertyIndexForMetadataFormatID@SpatialAudioDevicePropertyReader@@AEAAJAEBU_GUID@@PEAGPEAI@Z @ 0x1801013C0
 * Callers:
 ...
 *     ?IsSpatialAudioStreamAvailable@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEBUtagPROPVARIANT@@@Z @ 0x180102110 (-IsSpatialAudioStreamAvailable@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEBUtagPROPVARI.c)
 * Callees:
        ...
        while ( 1 )
        {
          ...
          if ( (_WORD)pvar != 65 || (_DWORD)v20 != 18 )
          {
            ...
            if ( (unsigned int)dword_1801883B0 > 2 )
            {
              ...
              v30 = &v17;
              v31 = 4LL;
              TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_18014946E, v13, v14, 5u, &pData);
            }
            goto LABEL_18;
          }
