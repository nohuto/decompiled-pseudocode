/*
 * XREFs of ?OnEndpointDeviceStateChanged@PhoneCallAudio@@UEAAXPEAUIEndpointDevice@@@Z @ 0x1800FACC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PhoneCallAudio::OnEndpointDeviceStateChanged(PhoneCallAudio *this, struct IEndpointDevice *a2)
{
