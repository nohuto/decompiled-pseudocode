/*
 * XREFs of ?RuntimeClassInitialize@CSaDeviceProxy@@QEAAJPEBUSaDeviceParams@@PEAVCEndpointCharacteristics@@PEAUIDeviceGraphObjectsStore@@W4_AUDCLNT_SHAREMODE@@KAEAUSaDeviceResourceParams@@@Z @ 0x18001F420
 * Callers:
 ...
 *     WPP_SF_Sddd @ 0x1800CBAE8 (WPP_SF_Sddd.c)
 */
        ...
        struct SaDeviceResourceParams *a7)
{
  ...
  struct _GUID v55; // [rsp+90h] [rbp-21h] BYREF
  struct _GUID v56; // [rsp+A0h] [rbp-11h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+F8h] [rbp+47h]
  struct IAudioDeviceGraph *v58; // [rsp+100h] [rbp+4Fh] BYREF
  LPMALLOC v59; // [rsp+108h] [rbp+57h] BYREF
  struct CEndpointCharacteristics *v60; // [rsp+110h] [rbp+5Fh]
  ...
  *(_QWORD *)&v12 = operator new(0x68uLL, (const struct std::nothrow_t *)&std::nothrow);
  v13 = v12;
  if ( (_QWORD)v12 )
  {
  ...
  *(_QWORD *)&v55.Data1 = v13;
  v15 = (const WCHAR *)a2->lpVtbl;
  v16 = -1LL;
  do
    ++v16;
  while ( v15[v16] );
...
LABEL_71:
            ...
            v19 = 0;
            v26 = v59;
            memcpy_0(*(void **)(v13 + 16), v59[2].lpVtbl, Release_low + 18);
          }
          v31 = v26[3].lpVtbl;
          if ( !v31 )
          {
LABEL_38:
          ...
          *(_QWORD *)(v13 + 24) = v33;
          ...
          {
            v34 = 0LL;
            if ( CoGetMalloc(1u, &v59) >= 0 )
            {
              v34 = ((__int64 (__fastcall *)(LPMALLOC, LPVOID))v59->lpVtbl->GetSize)(v59, v33);
              ((void (__fastcall *)(LPMALLOC))v59->lpVtbl->Release)(v59);
            }
...
LABEL_39:
  ...
  else
  {
    v58 = 0LL;
    v35 = *((_QWORD *)this + 6);
    v55 = *(struct _GUID *)(v35 + 80);
    *(_OWORD *)ppMalloc = *(_OWORD *)(v35 + 64);
    v56 = *(struct _GUID *)(v35 + 48);
    v36 = a5;
    v37 = CreateSaDevice(
            v60,
            a5,
            ...
            *(_QWORD *)(v35 + 32),
            *(_QWORD *)(v35 + 40),
            *(const struct tWAVEFORMATEX **)(v35 + 16),
    ...
    else
    {
      ...
      if ( v38 != v58 )
      {
        if ( v58 )
        {
          (*(void (__fastcall **)(struct IAudioDeviceGraph *))(*(_QWORD *)v58 + 8LL))(v58);
          v38 = (struct IAudioDeviceGraph *)*((_QWORD *)this + 10);
        }
        *((_QWORD *)this + 10) = v39;
        if ( v38 )
      ...
      if ( v40 )
      {
        ...
        v60 = (struct CEndpointCharacteristics *)&v41[5];
        v19 = 0;
        v41[5].lpVtbl = 0LL;
        v41[6].lpVtbl = 0LL;
      ...
      *((_QWORD *)this + 7) = v41;
      if ( v41 )
      {
        *((_BYTE *)this + 73) = v36 == AUDCLNT_SHAREMODE_EXCLUSIVE;
    ...
    {
      v58 = 0LL;
      (*(void (__fastcall **)(struct IAudioDeviceGraph *))(*(_QWORD *)v47 + 16LL))(v47);
    }
  }
  if ( pv )
    CoTaskMemFree(pv);
