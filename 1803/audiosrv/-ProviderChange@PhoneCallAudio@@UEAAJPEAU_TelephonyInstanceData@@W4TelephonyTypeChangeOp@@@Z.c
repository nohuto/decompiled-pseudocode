/*
 * XREFs of ?ProviderChange@PhoneCallAudio@@UEAAJPEAU_TelephonyInstanceData@@W4TelephonyTypeChangeOp@@@Z @ 0x1800FAE40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PhoneCallAudio::ProviderChange(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    v6 = PhoneCallAudio::DoEnableCellularProviderChange(a1 - 8, a2, a3);
    if ( v6 >= 0 )
LABEL_10:
