/*
 * XREFs of _lambda_041b38cc9b1c9530af273109c15771c6_::operator() @ 0x1800635C8
 * Callers:
 ...
 *     WPP_SF_S_guid_ @ 0x1800ADF88 (WPP_SF_S_guid_.c)
 *     WPP_SF_Sg @ 0x1800AE08C (WPP_SF_Sg.c)
 */

// Hidden C++ exception states: #wind=1
__int64 __fastcall lambda_041b38cc9b1c9530af273109c15771c6_::operator()(CAudioSession **a1, __int64 a2, int a3)
{
  GUID **v4; // rax
  GUID *v5; // rdx
  ...
  Memory = 0LL;
  ATL::CCritSecLock::CCritSecLock((ATL::CCritSecLock *)&v33, (struct _RTL_CRITICAL_SECTION *)((char *)*a1 + 808));
  v6 = *((_DWORD *)*a1 + 240);
  v7 = 4LL * v6;
  ...
  if ( !*(_BYTE *)a1[2] )
  {
    ...
    v28[0] = v6;
    LOBYTE(v18) = v31;
    (*(void (__fastcall **)(CAudioSession *, _QWORD, __int64))(v16 + 456))(v15, *(unsigned int *)v17, v18);
  }
