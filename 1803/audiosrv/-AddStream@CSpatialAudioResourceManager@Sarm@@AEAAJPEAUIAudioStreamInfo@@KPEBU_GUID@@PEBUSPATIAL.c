/*
 * XREFs of ?AddStream@CSpatialAudioResourceManager@Sarm@@AEAAJPEAUIAudioStreamInfo@@KPEBU_GUID@@PEBUSPATIAL_STREAM_PROPERTIES@@PEAVCEndpointResourcePool@2@@Z @ 0x1800F2598
 * Callers:
...
LABEL_3:
  ...
  v14 = v16;
  v11 = Sarm::CStreamResource::Initialize((Sarm::CStreamResource *)v10, a2, a3, a4, v16, a5, a6);
  if ( v11 < 0 )
  {
    v12 = 109LL;
    goto LABEL_3;
