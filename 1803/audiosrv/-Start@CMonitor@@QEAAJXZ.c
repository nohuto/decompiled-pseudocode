/*
 * XREFs of ?Start@CMonitor@@QEAAJXZ @ 0x1800E52AC
 * Callers:
 ...
 *     ?AddHead@?$CAtlList@PEAUSampleDataBlock@CMonitor@@V?$CElementTraits@PEAUSampleDataBlock@CMonitor@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAUSampleDataBlock@CMonitor@@@Z @ 0x1800E2420 (-AddHead@-$CAtlList@PEAUSampleDataBlock@CMonitor@@V-$CElementTraits@PEAUSampleDataBlock@CMonitor.c)
 *     ?AllocateBytes@?$CHeapPtrBase@EVCCRTAllocator@ATL@@@ATL@@QEAA_N_K@Z @ 0x1800E2480 (-AllocateBytes@-$CHeapPtrBase@EVCCRTAllocator@ATL@@@ATL@@QEAA_N_K@Z.c)
...
__int64 __fastcall CMonitor::Start(CMonitor *this)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x35u, (__int64)&WPP_298f35db72853edc559b812a776cab31_Traceguids, v1);
    v3 = WPP_GLOBAL_Control;
  }
  v4 = *((_DWORD *)v1 + 14);
  if ( ((v4 - 2) & 0xFFFFFFFD) != 0 )
  {
    if ( v3 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)v3 + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)v3 + 2), 0x3Au, (__int64)&WPP_298f35db72853edc559b812a776cab31_Traceguids, v4);
    }
LABEL_92:
    if ( v25 )
    ...
    && ((unsigned __int8)v35 & 0xFD) == 0 )
  {
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x36u, (__int64)&WPP_298f35db72853edc559b812a776cab31_Traceguids);
    }
  }
  else
  {
      ...
      *((_DWORD *)v1 + 114) = GetTickCount();
      ...
      if ( v2 >= 0 )
      {
        ...
        if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x39u, (__int64)&WPP_298f35db72853edc559b812a776cab31_Traceguids);
        }
        *((_DWORD *)v1 + 14) = 3;
...
LABEL_89:
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x37u, (__int64)&WPP_298f35db72853edc559b812a776cab31_Traceguids);
    }
    if ( v36 )
      (*((void (__fastcall **)(void **))*v36 + 2))(v36);
    if ( v37 )
