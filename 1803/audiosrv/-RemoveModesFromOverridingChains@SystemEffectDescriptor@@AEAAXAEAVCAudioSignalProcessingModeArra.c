/*
 * XREFs of ?RemoveModesFromOverridingChains@SystemEffectDescriptor@@AEAAXAEAVCAudioSignalProcessingModeArray@@@Z @ 0x1800530E8
 * Callers:
        ...
        struct CAudioSignalProcessingModeArray *a2)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 10); ++i )
  {
    ...
    {
      v7 = *(_QWORD *)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[]((__int64)this + 32, i);
      v8 = ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator[]((__int64)a2, j);
