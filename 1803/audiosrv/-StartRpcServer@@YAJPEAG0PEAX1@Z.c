/*
 * XREFs of ?StartRpcServer@@YAJPEAG0PEAX1@Z @ 0x18005CAF8
 * Callers:
...
__int64 __fastcall StartRpcServer(unsigned __int16 *a1, unsigned __int16 *a2, void *a3, void *a4)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 22LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids, a2);
  }
  if ( !ServerEndpointIsStarted(a2) )
  {
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 23LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids, v8);
    }
LABEL_6:
    if ( v7 )
      return v7;
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 24LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids);
    goto LABEL_6;
  }
LABEL_7:
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 25LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids, v9);
  }
  return v7;
}
