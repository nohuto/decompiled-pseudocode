/*
 * XREFs of ?LaunchAndWaitForADGStartup@CAudioDGProcess@@AEAAJ_N@Z @ 0x18002B1A0
 * Callers:
...
__int64 __fastcall CAudioDGProcess::LaunchAndWaitForADGStartup(CAudioDGProcess *this, bool a2)
{
  ...
  v14 = v5 / 1000.0;
  if ( (unsigned int)dword_1801884D0 > 4 && TlgKeywordOn((TraceLoggingHProvider)&dword_1801884D0, 0x200000000000uLL) )
  {
    v18 = 0;
    v21 = 0;
    v24 = 0;
    ...
    v29 = (int)v8;
    v32 = 8;
    TlgWrite(v6, &unk_180149545, v7, v8, 8u, &pData);
  }
  result = v11;
  if ( v13 < 0 )
