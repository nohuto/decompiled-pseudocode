/*
 * XREFs of ?EndpointRequiresAC97VistaShim@@YAHPEAUIMMDevice@@@Z @ 0x1800C0970
 * Callers:
...
_BOOL8 __fastcall EndpointRequiresAC97VistaShim(struct IMMDevice *a1)
{
      ...
      if ( v3 >= 0 )
      {
        ...
        if ( v3 >= 0 )
        {
          ...
          if ( v3 >= 0 )
          {
            ...
            if ( v11 != v16 )
            {
              ATL::AtlComQIPtrAssign(&v11, v16, &GUID_78b60045_08a6_4ac3_8ac7_d3307c2d2e63);
              v4 = v11;
            }
            if ( v4 )
            {
  ...
  if ( v3 < 0 )
    AudSrvTraceLoggingErrorHelper("EndpointRequiresAC97VistaShim", 5315, v3);
  if ( v13 )
