/*
 * XREFs of ?CheckConnectorSupportForPeriodicity@@YAJPEAUIMMDevice@@W4AUDIO_DIRECTION@@PEAUAUDIO_ENDPOINT_SHARED_CREATE_PARAMS_FOR_KS_ENDPOINTS@@I_JPEAI@Z @ 0x1800E9E9C
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  __int16 v17; // [rsp+48h] [rbp-18h] BYREF
  ...
  v8 = (**(__int64 (__fastcall ***)(__int64, GUID *, _QWORD *))v21)(
         v21,
  ...
  v8 = (*(__int64 (__fastcall **)(_QWORD, int *))(*(_QWORD *)v16[0] + 40LL))(v16[0], &v20);
  if ( v8 < 0 )
    goto LABEL_32;
  if ( !v20 )
  {
...
LABEL_31:
  ...
  v8 = (*(__int64 (__fastcall **)(_QWORD, int *))(*(_QWORD *)v16[0] + 32LL))(v16[0], &v22);
  if ( v8 < 0 )
    goto LABEL_32;
  if ( !v22 )
  {
  ...
  v15 = 0LL;
  v21 = 0LL;
  v8 = (**(__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *))v16[0])(
         v16[0],
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( v8 >= 0 )
      {
        v8 = (*(__int64 (__fastcall **)(_QWORD, unsigned __int64, _QWORD))(*(_QWORD *)v16[0] + 24LL))(v16[0], a5, 0LL);
