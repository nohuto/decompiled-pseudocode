/*
 * XREFs of _CDeviceGraphObjectsStore::GetAllStreamGroups_::_1_::catch$20 @ 0x1800CCB6D
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphObjectsStore::GetAllStreamGroups_::_1_::catch_20(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
