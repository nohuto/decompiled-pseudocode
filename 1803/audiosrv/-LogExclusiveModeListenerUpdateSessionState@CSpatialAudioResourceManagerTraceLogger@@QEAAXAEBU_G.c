/*
 * XREFs of ?LogExclusiveModeListenerUpdateSessionState@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@HH@Z @ 0x1800F865C
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_180188330 > 5 )
  {
    ...
    v8 = 4LL;
    v10 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_1801482C2, a3, a4, 5u, &v4);
  }
}
