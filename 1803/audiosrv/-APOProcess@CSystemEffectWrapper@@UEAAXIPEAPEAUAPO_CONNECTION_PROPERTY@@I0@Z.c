/*
 * XREFs of ?APOProcess@CSystemEffectWrapper@@UEAAXIPEAPEAUAPO_CONNECTION_PROPERTY@@I0@Z @ 0x180109030
 * Callers:
 *     <none>
 * Callees:
...
{
  (*(void (__fastcall **)(_QWORD, __int64, struct APO_CONNECTION_PROPERTY **))(**((_QWORD **)this + 14) + 24LL))(
    *((_QWORD *)this + 14),
    a2,
    a3);
}
