        ...
        _BYTE *a4)
{
  ...
  *a4 = 0;
  v8 = 0LL;
  v9 = 0LL;
  XWinRT::SerializingLockPolicy::Read(&v16, a1 + 104, &v17);
  v11 = v17;
  if ( v17 >= 0 )
  {
    if ( *(_DWORD *)(a1 + 80) )
