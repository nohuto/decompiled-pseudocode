/*
 * XREFs of AudioServerGetStreamLatency @ 0x1800C49F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetStreamLatency(char *a1, __int64 a2, __int64 a3)
{
  ...
  v9 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*(_QWORD *)a1 + 136LL))(a1, a2, a3);
  v10 = v9;
  if ( v9 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetStreamLatency", 3829, v9);
