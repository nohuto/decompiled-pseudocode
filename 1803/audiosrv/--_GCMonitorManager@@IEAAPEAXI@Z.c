/*
 * XREFs of ??_GCMonitorManager@@IEAAPEAXI@Z @ 0x1800DE1B8
 * Callers:
 *     ?Release@CMonitorManager@@UEAAKXZ @ 0x1800E14A0 (-Release@CMonitorManager@@UEAAKXZ.c)
 * Callees:
 ...
 *     ?RemoveAll@?$CAtlList@V?$CAutoPtr@UDeviceStateChangedContext@CMonitorManager@@@ATL@@V?$CAutoPtrElementTraits@UDeviceStateChangedContext@CMonitorManager@@@2@@ATL@@QEAAXXZ @ 0x1800DDCAC (-RemoveAll@-$CAtlList@V-$CAutoPtr@UDeviceStateChangedContext@CMonitorManager@@@ATL@@V-$CAutoPtrE.c)
 */
