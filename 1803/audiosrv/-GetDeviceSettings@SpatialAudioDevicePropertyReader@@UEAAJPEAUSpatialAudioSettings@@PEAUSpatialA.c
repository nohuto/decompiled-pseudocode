/*
 * XREFs of ?GetDeviceSettings@SpatialAudioDevicePropertyReader@@UEAAJPEAUSpatialAudioSettings@@PEAUSpatialAudioEncoderDescriptor@@I@Z @ 0x18004C580
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( !*((_DWORD *)this + 128) )
  {
    ...
    if ( (unsigned int)dword_1801883B0 > 2 )
    {
      ...
      v22 = v16;
      v23 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_18014946E, v10, v11, 5u, &pData);
    }
    return v14;
  }
  if ( !a2 )
