/*
 * XREFs of ?HandleAccessChangeNotification@@YAJPEBG0@Z @ 0x1800B4EA8
 * Callers:
...
LABEL_9:
    v9 = 0LL;
  (*(void (__fastcall **)(struct IAudioPolicyManager *, const unsigned __int16 *, HLOCAL, const unsigned __int16 *))(*(_QWORD *)g_PolicyManager + 48LL))(
    g_PolicyManager,
    a2,
    v9,
    a1);
