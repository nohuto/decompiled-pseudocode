/*
 * XREFs of ?CreateMetadataDictionary@SpatialAudioDevicePropertyReader@@UEAAJAEBU_GUID@@PEAPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x1801006A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ISpatialAudioMetadataDictionaryData **a3)
{
  ...
  if ( a3 )
  {
      ...
      if ( PropertyIndexForMetadataFormatID >= 0 )
      {
        if ( (_WORD)pvar == 65 )
        {
          ...
          if ( PropertyIndexForMetadataFormatID >= 0 )
          {
            ...
            v21 = PropertyIndexForMetadataFormatID;
            if ( PropertyIndexForMetadataFormatID < 0 && (unsigned int)dword_1801883B0 > 2 )
            {
        ...
        else
        {
          ...
          if ( (unsigned int)dword_1801883B0 > 2 )
          {
            ...
            v36 = (int *)&v21;
            v37 = 4LL;
            TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_18014946E, v12, v13, 5u, &pData);
          }
        }
      }
      else if ( (unsigned int)dword_1801883B0 > 2 )
    ...
    else if ( (unsigned int)dword_1801883B0 > 2 )
    {
      ...
      v36 = &v22;
      v37 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_1801494A8, v10, v11, 5u, &pData);
    }
  }
  else
  {
    ...
    if ( (unsigned int)dword_1801883B0 > 2 )
    {
      ...
      *(_DWORD *)v23 = -2147024809;
      v36 = (int *)v23;
      v37 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_18014946E, v7, v8, 5u, &pData);
    }
  }
