/*
 * XREFs of _lambda_1a19eda420d26f754031790a40bd90be_::operator() @ 0x1800CF4B4
 * Callers:
 *     wil::details::lambda_call__lambda_1a19eda420d26f754031790a40bd90be___::_lambda_call__lambda_1a19eda420d26f754031790a40bd90be___ @ 0x1800CF434 (wil--details--lambda_call__lambda_1a19eda420d26f754031790a40bd90be___--_lambda_call__lambda_1a19.c)
...
void __fastcall lambda_1a19eda420d26f754031790a40bd90be_::operator()(__int64 *a1)
{
  ...
  {
    v4 = 0LL;
    wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>::attach(&v4, *(_QWORD *)(v2 + 64));
    v3 = 0LL;
