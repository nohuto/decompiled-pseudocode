/*
 * XREFs of ?Shutdown@CMonitorManager@@QEAAXXZ @ 0x1800E1BA8
 * Callers:
...
void __fastcall CMonitorManager::Shutdown(CMonitorManager *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x12u, (__int64)&WPP_1a258077347a3434ed979dcee8522c59_Traceguids);
  }
