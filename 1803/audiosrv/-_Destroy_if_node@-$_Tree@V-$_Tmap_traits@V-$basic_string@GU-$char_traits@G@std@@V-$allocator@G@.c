        ...
        __int64 a2)
{
  ...
  v4 = *(_QWORD *)(a2 + 56);
  if ( v4 >= 8 )
    std::_Deallocate(*(_QWORD **)(a2 + 32), v4 + 1, 2uLL);
  *(_QWORD *)(a2 + 48) = 0LL;
  *(_QWORD *)(a2 + 56) = 7LL;
  *(_WORD *)(a2 + 32) = 0;
  std::_Deallocate((_QWORD *)a2, 1uLL, 0x48uLL);
}
