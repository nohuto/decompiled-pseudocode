/*
 * XREFs of ?AddMetadataFormat@SpatialAudioDevicePropertyWriter@@UEAAJPEAUISpatialAudioMetadataDictionaryData@@@Z @ 0x1800FF2A0
 * Callers:
 *     <none>
 * Callees:
            ...
            if ( v28 >= 0 )
            {
                  ...
                  *(_QWORD *)&v31[3] = v31[0];
                  ...
                  if ( v28 >= 0 )
                  {
                    ...
                    *(_OWORD *)&v31[3] = (unsigned __int16)(v20 + 1);
                    ...
                    v8 = v28;
                    if ( v28 < 0 && (unsigned int)dword_1801883B0 > 2 )
                    {
                      v38 = 52LL;
              ...
              else
              {
                ...
                if ( (unsigned int)dword_1801883B0 > 2 )
                {
                  ...
                  v41 = &v28;
                  v42 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_18014946E, v18, v19, 5u, &pData);
                }
              }
            }
            else if ( (unsigned int)dword_1801883B0 > 2 )
