/*
 * XREFs of std::basic_string_unsigned_short_std::char_traits_unsigned_short__std::allocator_unsigned_short___::_Reallocate_for__lambda_05cef1f6fdf474c9f3ed207deba0f73b__unsigned_short_const_____ptr64_ @ 0x18009714C
 * Callers:
        ...
        const void *a4)
{
  ...
  *(_QWORD *)(a1 + 16) = a2;
  ...
  v12[a2] = 0;
  if ( v8 >= 8 )
    std::_Deallocate(*(_QWORD **)a1, v8 + 1, 2uLL);
  result = a1;
  *(_QWORD *)a1 = v12;
  return result;
}
