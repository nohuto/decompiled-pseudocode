/*
 * XREFs of _CVolumeStrip::RuntimeClassInitialize_::_1_::dtor$3 @ 0x18006697C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CVolumeStrip::RuntimeClassInitialize_::_1_::dtor_3(__int64 a1, __int64 a2)
{
