/*
 * XREFs of ?CalculateDynamicObjectGrantCount@CStreamResource@Sarm@@QEBAIII@Z @ 0x1800F6A54
 * Callers:
        ...
        const GUID *a3)
{
  ...
  if ( (unsigned int)dword_180188330 > 5 )
  {
    ...
    v38 = 1;
    v41 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180147FB1, a3, (LPCGUID)v4, 0xCu, &pData);
    LODWORD(v4) = v10;
  }
