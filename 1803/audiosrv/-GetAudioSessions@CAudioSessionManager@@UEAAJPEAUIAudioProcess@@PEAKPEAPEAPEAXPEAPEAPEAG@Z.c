/*
 * XREFs of ?GetAudioSessions@CAudioSessionManager@@UEAAJPEAUIAudioProcess@@PEAKPEAPEAPEAXPEAPEAPEAG@Z @ 0x1800B2300
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_Ddq @ 0x1800B47D4 (WPP_SF_Ddq.c)
        ...
        unsigned __int16 ***a5)
{
  ...
  const unsigned __int16 **v42; // [rsp+88h] [rbp-78h]
  ...
  *v38 = 0;
  ...
  StartPosition = ATL::CAtlMap<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,enum RmResourceType,ATL::CElementTraits<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>>,ATL::CElementTraits<enum RmResourceType>>::GetStartPosition(v14);
  if ( !StartPosition )
  {
LABEL_23:
    if ( v34 )
  ...
  while ( 1 )
  {
    ...
    if ( v22 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)v22 + 25) >= 4u )
    {
      WPP_SF_qS(*((_QWORD *)v22 + 2), 0x2Du, (__int64)&WPP_bc4145dd143a32c0713a8429d6f998aa_Traceguids, v21, 0LL);
    }
...
LABEL_70:
  ...
  *v31 = (unsigned __int16 **)v9;
  ...
  if ( v13 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSessionManager::GetAudioSessions", 1468, v13);
  if ( v41 )
