 ...
 *     ??0?$IIterable@PEAUHSTRING__@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x18010EF2C (--0-$IIterable@PEAUHSTRING__@@@Collections@Foundation@Windows@@QEAA@XZ.c)
 *     ??0?$IVectorView@PEAUHSTRING__@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x18010EF98 (--0-$IVectorView@PEAUHSTRING__@@@Collections@Foundation@Windows@@QEAA@XZ.c)
 */
        ...
        _DWORD *a2)
{
  ...
  Windows::Foundation::Collections::IVectorView<HSTRING__ *>::IVectorView<HSTRING__ *>((IUnknown *)a1);
  Windows::Foundation::Collections::IIterable<HSTRING__ *>::IIterable<HSTRING__ *>((IUnknown *)(a1 + 16));
