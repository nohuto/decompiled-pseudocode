/*
 * XREFs of ??$MakeAndInitialize@VSpatialAudioDevicePropertyReader@@V1@AEAPEBGAEAPEAUIPropertyStore@@@Details@WRL@Microsoft@@YAJPEAPEAVSpatialAudioDevicePropertyReader@@AEAPEBGAEAPEAUIPropertyStore@@@Z @ 0x18004C094
 * Callers:
        ...
        struct IPropertyStore **a3)
{
  ...
  *a1 = 0LL;
  ...
  if ( v6 )
  {
    ...
    Microsoft::WRL::ComPtr<ISpatialAudioDevicePropertyReader>::InternalRelease((__int64 *)&v10);
  }
  else
  {
