/*
 * XREFs of Pdcv2ActivationClientRenewActivation @ 0x18010BC88
 * Callers:
 ...
 *     PdcpResizeDiagnosticContext @ 0x18010BC50 (PdcpResizeDiagnosticContext.c)
 *     Pdcv2pValidateActivationParameters @ 0x18010C10C (Pdcv2pValidateActivationParameters.c)
 *     PdcPortSendMessageSynchronously @ 0x18010C29C (PdcPortSendMessageSynchronously.c)
 *     Pdcv2EventWrite_ACTIVATION_CLIENT_RENEW_ACTIVATION @ 0x18010CF00 (Pdcv2EventWrite_ACTIVATION_CLIENT_RENEW_ACTIVATION.c)
 */
...
__int64 __fastcall Pdcv2ActivationClientRenewActivation(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  _WORD v24[130]; // [rsp+A4h] [rbp-64h] BYREF
  unsigned int v25[116]; // [rsp+1A8h] [rbp+A0h] BYREF
