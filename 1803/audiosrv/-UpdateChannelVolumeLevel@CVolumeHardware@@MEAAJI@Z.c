/*
 * XREFs of ?UpdateChannelVolumeLevel@CVolumeHardware@@MEAAJI@Z @ 0x1800A48C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVolumeHardware::UpdateChannelVolumeLevel(CVolumeHardware *this, unsigned int a2)
{
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    WPP_SF_dg(*(_QWORD *)(v5 + 16), 39LL, &WPP_a94e90b6b9c23070a932b4669a952a77_Traceguids, (unsigned int)v2, DB);
  }
  if ( v2 >= *((_QWORD *)this + 12) )
    ATL::AtlThrowImpl(-2147024809);
  CVolumeUnit::GetDB((CVolumeUnit *)(*((_QWORD *)this + 11) + 56 * v2));
