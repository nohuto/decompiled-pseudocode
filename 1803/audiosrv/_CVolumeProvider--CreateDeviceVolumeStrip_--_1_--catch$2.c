/*
 * XREFs of _CVolumeProvider::CreateDeviceVolumeStrip_::_1_::catch$2 @ 0x18006B247
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CVolumeProvider::CreateDeviceVolumeStrip_::_1_::catch_2(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
