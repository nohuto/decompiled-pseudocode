/*
 * XREFs of ?SetDisplayName@CAudioSession@@UEAAJPEBGPEBU_GUID@@_N@Z @ 0x1800ACFE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::SetDisplayName(CAudioSession *this, char *a2, const struct _GUID *a3, char a4)
{
    ...
    && (a4 || !*((_BYTE *)v7 + 300)) )
  {
    ...
    try
    {
      ...
      ATL::CSimpleStringT<unsigned short,0>::SetString(v9, a2, (unsigned int)v10);
    }
