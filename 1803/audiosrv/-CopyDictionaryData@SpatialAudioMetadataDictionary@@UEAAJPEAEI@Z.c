/*
 * XREFs of ?CopyDictionaryData@SpatialAudioMetadataDictionary@@UEAAJPEAEI@Z @ 0x180106710
 * Callers:
 *     ?CopyDictionaryData@SpatialAudioMetadataDictionary@@W7EAAJPEAEI@Z @ 0x1800662C0 (-CopyDictionaryData@SpatialAudioMetadataDictionary@@W7EAAJPEAEI@Z.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  else
  {
    if ( (unsigned int)dword_1801883B0 > 2 )
    {
      ...
      v12 = -2147024809;
      v19 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_18014946E, v8, v9, 5u, &pData);
    }
