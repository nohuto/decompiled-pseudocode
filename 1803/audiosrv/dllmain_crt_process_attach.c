/*
 * XREFs of dllmain_crt_process_attach @ 0x1800605B0
 * Callers:
 ...
 *     __scrt_is_nonwritable_in_current_image @ 0x180060E20 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x180060EBC (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180061408 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180061424 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x180061440 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x180061450 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18006159C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800617E6 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800617EC (_initterm_e_0.c)
