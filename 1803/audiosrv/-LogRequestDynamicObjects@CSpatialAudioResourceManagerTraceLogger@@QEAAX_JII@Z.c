/*
 * XREFs of ?LogRequestDynamicObjects@CSpatialAudioResourceManagerTraceLogger@@QEAAX_JII@Z @ 0x1800F5DE4
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_180188330 > 4 )
  {
    ...
    v8 = 4LL;
    v10 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180147AF5, a3, a4, 5u, &v4);
  }
}
