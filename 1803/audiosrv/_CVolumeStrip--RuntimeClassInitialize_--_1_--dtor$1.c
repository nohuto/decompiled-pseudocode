/*
 * XREFs of _CVolumeStrip::RuntimeClassInitialize_::_1_::dtor$1 @ 0x180066964
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CVolumeStrip::RuntimeClassInitialize_::_1_::dtor_1(__int64 a1, __int64 a2)
{
