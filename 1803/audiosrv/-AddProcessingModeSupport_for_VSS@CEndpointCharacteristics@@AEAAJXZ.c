/*
 * XREFs of ?AddProcessingModeSupport_for_VSS@CEndpointCharacteristics@@AEAAJXZ @ 0x180051EB4
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::AddProcessingModeSupport_for_VSS(CEndpointCharacteristics *this)
{
  ...
  char *SupportedConnectorModesInternal; // [rsp+68h] [rbp-A0h]
  ...
  *(_QWORD *)v26.Data4 = this;
  if ( (unsigned int)CEndpointCharacteristics::EndpointConnectorSupportsProcessingModes(this, eHostProcessConnector) )
  {
    ...
    v7 = v27;
    v8 = v26;
    v9 = SupportedConnectorModesInternal;
    do
    {
      v10 = **v6;
      v26 = v10;
      ...
      if ( v19 != -1
        || (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::Find(&v20, &v26) != -1 )
      {
        v22[0] = off_18012BDC8;
    ...
    *(struct _GUID *)&v22[1] = v8;
    ...
    v26 = GUID_c18e2f7e_933d_4965_b7d1_1eef228d2af3;
    if ( CEndpointCharacteristics::IsAPOModeSupported(this, &v26, eHostProcessConnector)
      || (v24 = 0LL,
          v26 = GUID_c18e2f7e_933d_4965_b7d1_1eef228d2af3,
          DefaultEffectChainClsids = SystemEffectDescriptor::CreateOverridingChain(
