/*
 * XREFs of ?CanCastTo@?$ImplementsHelper@U?$RuntimeClassFlags@$02@WRL@Microsoft@@$00UIAudioResourceManager@@UIWeakReferenceSource@@UIAudioResourceControl@@@Details@WRL@Microsoft@@IEAAJAEBU_GUID@@PEAPEAXPEA_N@Z @ 0x18005BCD0
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  if ( InlineIsEqualGUID(a2, &GUID_c403eb63_756b_4b57_969b_a7b925d03d0f) )
  {
    *v3 = v4;
    return 0LL;
  }
