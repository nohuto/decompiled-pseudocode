/*
 * XREFs of ?RuntimeClassInitialize@CBaseStreamGroupProxy@@QEAAJPEBUStreamGroupParams@@K@Z @ 0x180095F50
 * Callers:
 ...
 *     ??0CResourcePriorityTracker@@QEAA@K@Z @ 0x1800995A8 (--0CResourcePriorityTracker@@QEAA@K@Z.c)
        ...
        unsigned int a3)
{
  ...
  do
    ++v7;
  while ( v6[v7] );
  v9 = _AllocStringWorker<CTCoAllocPolicy>((__int64)this, (__int64)a2, v6, v7, v16, (unsigned __int16 **)this + 6);
  if ( v9 < 0 )
  {
    v10 = 223LL;
LABEL_5:
  ...
  v9 = CTCoAllocPolicy::Alloc(v8, 1u, v12 + 18, (void **)this + 5);
  if ( v9 < 0 )
  {
    v10 = 226LL;
    goto LABEL_5;
