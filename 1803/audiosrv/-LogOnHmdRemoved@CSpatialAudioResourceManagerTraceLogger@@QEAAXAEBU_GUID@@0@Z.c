/*
 * XREFs of ?LogOnHmdRemoved@CSpatialAudioResourceManagerTraceLogger@@QEAAXAEBU_GUID@@0@Z @ 0x1800F8770
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_180188330 > 4 )
  {
    ...
    v10 = 0;
    v9 = 16;
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180148274, a3, a4, 4u, &v4);
  }
}
