/*
 * XREFs of ?GetOffloadMixFormat@@YAJPEBGPEAPEAUtWAVEFORMATEX@@@Z @ 0x18009D308
 * Callers:
...
LABEL_8:
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      if ( v6 >= 0 )
      {
        v6 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, struct tWAVEFORMATEX **))(*(_QWORD *)v9 + 32LL))(
               v9,
               v8,
               0LL,
               a2);
...
LABEL_9:
  AudSrvTraceLoggingErrorHelper("GetOffloadMixFormat", 1135, v6);
  v4 = v8;
  v5 = v9;
LABEL_10:
  if ( v5 )
