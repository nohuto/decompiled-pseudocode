/*
 * XREFs of ?LogSubscribe@CSpatialAudioResourceManagerTraceLogger@@QEAAXK_NI@Z @ 0x1800F5F04
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_180188330 > 5 )
  {
    ...
    v10 = 4LL;
    v12 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180147B6F, a3, a4, 5u, &pData);
  }
}
