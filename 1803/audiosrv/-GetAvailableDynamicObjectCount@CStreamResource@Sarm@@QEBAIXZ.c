/*
 * XREFs of ?GetAvailableDynamicObjectCount@CStreamResource@Sarm@@QEBAIXZ @ 0x1800F6D50
 * Callers:
...
__int64 __fastcall Sarm::CStreamResource::GetAvailableDynamicObjectCount(Sarm::CEndpointResourcePool **this)
{
  ...
  if ( (unsigned int)dword_180188330 > 5 )
  {
    ...
    v11 = 16;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180147DEF, v2, v3, 5u, &pData);
  }
  return v5[0];
}
