/*
 * XREFs of ?Invoke@CAudioStreamStateChanged@@UEAAJV?$CComPtr@UISessionInternalEvents@@@ATL@@@Z @ 0x180032280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioStreamStateChanged::Invoke(__int64 a1, volatile signed __int32 **a2)
{
  ...
  if ( v3 )
    ...
    v4 = 0LL;
  result = (*(__int64 (__fastcall **)(volatile signed __int32 *, _QWORD, _QWORD, _QWORD, __int64))(*(_QWORD *)*a2 + 80LL))(
             *a2,
             *(_QWORD *)(a1 + 8),
             *(unsigned int *)(a1 + 16),
             *(unsigned int *)(a1 + 20),
