/*
 * XREFs of ?GetDevicePipeFormat@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@P6AJPEAV1@0@ZPEAPEAUtWAVEFORMATEX@@@Z @ 0x180039570
 * Callers:
        ...
        struct tWAVEFORMATEX **a5)
{
  ...
  *a5 = 0LL;
  ...
  while ( 1 )
  {
    v10 = qword_180189130[2 * v9] - v27;
    if ( !v10 )
      v10 = qword_180189130[2 * v9 + 1] - *((_QWORD *)&v27 + 1);
    if ( !v10 )
      break;
    if ( ++v9 >= 8 )
    {
...
LABEL_26:
  ...
  if ( refreshed < 0 && (unsigned int)hProvider > 3 && TlgKeywordOn((TraceLoggingHProvider)&hProvider, 4uLL) )
  {
    ...
    v36 = &v26;
    v37 = v21;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18014791D, v22, v23, 5u, &pData);
  }
  if ( v8 )
