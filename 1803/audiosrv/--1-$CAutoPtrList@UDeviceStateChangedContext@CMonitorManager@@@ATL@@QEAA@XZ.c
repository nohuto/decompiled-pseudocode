/*
 * XREFs of ??1?$CAutoPtrList@UDeviceStateChangedContext@CMonitorManager@@@ATL@@QEAA@XZ @ 0x1800DDBD8
 * Callers:
 *     _CMonitorManager::CMonitorManager_::_1_::dtor$5 @ 0x180069AC8 (_CMonitorManager--CMonitorManager_--_1_--dtor$5.c)
 * Callees:
 *     <none>
 */
