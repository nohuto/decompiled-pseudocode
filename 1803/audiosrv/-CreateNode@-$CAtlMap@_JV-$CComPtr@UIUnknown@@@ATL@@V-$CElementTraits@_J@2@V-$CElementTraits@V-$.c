/*
 * XREFs of ?CreateNode@?$CAtlMap@_JV?$CComPtr@UIUnknown@@@ATL@@V?$CElementTraits@_J@2@V?$CElementTraits@V?$CComPtr@UIUnknown@@@ATL@@@2@@ATL@@AEAAPEAVCNode@12@_JII@Z @ 0x1800FC194
 * Callers:
...
__int64 __fastcall ATL::CAtlMap<__int64,ATL::CComPtr<IUnknown>,ATL::CElementTraits<__int64>,ATL::CElementTraits<ATL::CComPtr<IUnknown>>>::CreateNode(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        unsigned int a4)
{
  ...
  return ATL::CAtlMap<__int64,ATL::CComPtr<IUnknown>,ATL::CElementTraits<__int64>,ATL::CElementTraits<ATL::CComPtr<IUnknown>>>::NewNode(
           a1,
           a2,
           a3,
           a4);
