        ...
        _QWORD *a3)
{
  ...
  v22 = a3;
  std::_Tree_unchecked_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,ENDPOINT_REF_DATA>>>,std::_Iterator_base0>::operator++((__int64 *)&v22);
  v6 = a3[2];
  v7 = (__int64)v22;
  if ( *(_BYTE *)(*a3 + 25LL) )
    goto LABEL_5;
...
LABEL_53:
  ...
  v19 = a3[7];
  if ( v19 >= 8 )
    std::_Deallocate((_QWORD *)a3[4], v19 + 1, 2uLL);
  a3[6] = 0LL;
  a3[7] = 7LL;
  *((_WORD *)a3 + 16) = 0;
