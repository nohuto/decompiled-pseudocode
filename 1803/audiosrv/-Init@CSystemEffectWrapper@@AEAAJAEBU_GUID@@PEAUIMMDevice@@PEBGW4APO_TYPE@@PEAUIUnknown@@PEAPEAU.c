/*
 * XREFs of ?Init@CSystemEffectWrapper@@AEAAJAEBU_GUID@@PEAUIMMDevice@@PEBGW4APO_TYPE@@PEAUIUnknown@@PEAPEAU5@@Z @ 0x180109924
 * Callers:
 ...
 *     ?APOCatchCoCreateInstance@@YAJAEBU_GUID@@PEAUIUnknown@@K0PEAPEAXPEAJ@Z @ 0x180108FD4 (-APOCatchCoCreateInstance@@YAJAEBU_GUID@@PEAUIUnknown@@K0PEAPEAXPEAJ@Z.c)
        ...
        _QWORD *a7)
{
  ...
  v7 = *a2;
  v8 = (const WCHAR **)(a1 + 104);
  *(_DWORD *)(a1 + 112) = a5;
  *(_QWORD *)(a1 + 120) = 0LL;
  *(struct _GUID *)(a1 + 88) = v7;
  if ( a3 )
  {
    v12 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)a3 + 40LL))(a3, a1 + 104);
  }
  else
  {
    v15 = -1LL;
    do
      ++v15;
    while ( a4[v15] );
    v12 = _AllocStringWorker<CTCoAllocPolicy>(a1, (__int64)a2, a4, v15, (__int64)v22, (unsigned __int16 **)(a1 + 104));
  }
  a5 = v12;
  v16 = v12;
  if ( v12 >= 0 )
