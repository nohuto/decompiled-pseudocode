/*
 * XREFs of ?SetChannelVolume@CServerAudioSessionControl@@UEAAJIMPEBU_GUID@@PEAH@Z @ 0x1800AF5A0
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a5)
{
  ...
  if ( ValidateAudioLevel(a3) )
    return (*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, const struct _GUID *, int *, double))(**((_QWORD **)this + 9) + 352LL))(
             *((_QWORD *)this + 9),
             a2,
             v8,
             a4,
