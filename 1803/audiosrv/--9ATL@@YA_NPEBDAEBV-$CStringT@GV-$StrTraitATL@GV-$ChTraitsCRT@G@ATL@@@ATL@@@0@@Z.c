/*
 * XREFs of ??9ATL@@YA_NPEBDAEBV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@0@@Z @ 0x1800B6C48
 * Callers:
...
char __fastcall ATL::operator!=(unsigned __int16 *a1, __int64 *a2)
{
  ...
  v6 = a1;
  v2 = a2;
  Manager = (ATL::CAtlStringMgr *)ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::GetManager(a2);
