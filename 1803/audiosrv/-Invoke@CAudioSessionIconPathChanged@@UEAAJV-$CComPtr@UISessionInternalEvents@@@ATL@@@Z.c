/*
 * XREFs of ?Invoke@CAudioSessionIconPathChanged@@UEAAJV?$CComPtr@UISessionInternalEvents@@@ATL@@@Z @ 0x1800AAB40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSessionIconPathChanged::Invoke(_QWORD *a1, CAudioSessionManager **a2)
{
  ...
  v3 = (*(__int64 (__fastcall **)(CAudioSessionManager *, _QWORD, _QWORD, _QWORD))(*(_QWORD *)*a2 + 32LL))(
         *a2,
         a1[1],
         a1[2],
         a1[3]);
