/*
 * XREFs of ?ScheduleMonitorRestartTimer@CMonitorManager@@AEAAXXZ @ 0x1800E1A48
 * Callers:
...
void __fastcall CMonitorManager::ScheduleMonitorRestartTimer(CMonitorManager *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Eu, (__int64)&WPP_1a258077347a3434ed979dcee8522c59_Traceguids);
    v2 = WPP_GLOBAL_Control;
  }
  if ( *((_QWORD *)this + 39) && *((_DWORD *)this + 14) == 1 )
  {
    if ( v2 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)v2 + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)v2 + 2), 0x2Fu, (__int64)&WPP_1a258077347a3434ed979dcee8522c59_Traceguids);
      v2 = WPP_GLOBAL_Control;
    }
    v3 = *((_QWORD *)this + 38);
    v4 = *((_QWORD *)this + 40);
    ...
    {
      v7 = *(_DWORD *)(v4 + 4 * v3);
      WPP_SF_qd(*((_QWORD *)v2 + 2), 0x30u, (__int64)&WPP_1a258077347a3434ed979dcee8522c59_Traceguids, this, v7);
    }
