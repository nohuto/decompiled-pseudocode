/*
 * XREFs of ?NotifyClientOfDisconnection@CAudioSession@@QEAAJW4AudioSessionDisconnectReason@@@Z @ 0x1800AB4F8
 * Callers:
        ...
        enum AudioSessionDisconnectReason a2)
{
  ...
  if ( v7 )
  {
    ...
    *((_DWORD *)v7 + 12) = a2;
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 46LL, &WPP_b198ffa89b193e32b53cc51510916f29_Traceguids, v8);
    }
  ...
  if ( MediaEvent < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSession::NotifyClientOfDisconnection", 2572, MediaEvent);
