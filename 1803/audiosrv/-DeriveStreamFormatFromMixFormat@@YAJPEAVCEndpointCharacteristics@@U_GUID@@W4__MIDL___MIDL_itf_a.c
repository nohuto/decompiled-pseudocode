/*
 * XREFs of ?DeriveStreamFormatFromMixFormat@@YAJPEAVCEndpointCharacteristics@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUIAudioMediaType@@PEAPEAU4@@Z @ 0x1800BB2E0
 * Callers:
...
LABEL_36:
  AudSrvTraceLoggingErrorHelper("DeriveStreamFormatFromMixFormat", 1426, v11);
  v12 = v21;
LABEL_37:
  if ( v12 )
