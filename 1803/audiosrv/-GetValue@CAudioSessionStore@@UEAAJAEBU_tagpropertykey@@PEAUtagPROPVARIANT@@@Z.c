/*
 * XREFs of ?GetValue@CAudioSessionStore@@UEAAJAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x180041EC0
 * Callers:
...
LABEL_3:
  ...
  if ( v6 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSessionStore::GetValue", 0x14A0u, v6);
