/*
 * XREFs of s_mmeNotifyDeviceRemoved @ 0x1800DC7A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?MmeOnDeviceRemoved@@YAJPEBG@Z @ 0x1800DC494 (-MmeOnDeviceRemoved@@YAJPEBG@Z.c)
 */
...
__int64 __fastcall s_mmeNotifyDeviceRemoved(__int64 a1, const unsigned __int16 *a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v5[1], v6, (struct _TP_TIMER *)L"s_mmeNotifyDeviceRemoved");
