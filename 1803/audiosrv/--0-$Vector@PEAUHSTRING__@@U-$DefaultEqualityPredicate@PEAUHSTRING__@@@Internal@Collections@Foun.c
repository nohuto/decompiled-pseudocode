/*
 * XREFs of ??0?$Vector@PEAUHSTRING__@@U?$DefaultEqualityPredicate@PEAUHSTRING__@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAUHSTRING__@@@3456@U?$VectorOptions@PEAUHSTRING__@@$0A@$00$0A@@3456@@Internal@Collections@Foundation@Windows@@QEAA@AEBU?$DefaultEqualityPredicate@PEAUHSTRING__@@@1234@Upermission@01234@@Z @ 0x18010F170
 * Callers:
 ...
 *     ??0?$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@QEAA@XZ @ 0x18010EF74 (--0-$IVector@PEAUHSTRING__@@@Collections@Foundation@Windows@@QEAA@XZ.c)
 */
        ...
        __int64 a1)
{
  ...
  Windows::Foundation::Collections::IVector<HSTRING__ *>::IVector<HSTRING__ *>((IUnknown *)a1);
