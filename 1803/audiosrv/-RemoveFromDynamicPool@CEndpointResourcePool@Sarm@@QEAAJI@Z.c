/*
 * XREFs of ?RemoveFromDynamicPool@CEndpointResourcePool@Sarm@@QEAAJI@Z @ 0x1800F68D0
 * Callers:
        ...
        unsigned int Data1)
{
  ...
  if ( (unsigned int)dword_180188330 > 4 )
  {
    ...
    v11 = this;
    v24 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180147D42, v4, &pRelatedActivityId, 8u, &pData);
