/*
 * XREFs of ?CompleteRevocation@CStreamResource@Sarm@@QEAAXXZ @ 0x1800F6BCC
 * Callers:
...
void __fastcall Sarm::CStreamResource::CompleteRevocation(Sarm::CStreamResource *this)
{
  ...
  if ( v3 )
  {
    if ( (unsigned int)dword_180188330 > 4 )
    {
      ...
      v24 = 4;
      v27 = 8;
      TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_1801480DA, (LPCGUID)4, v2, 9u, &pData);
      v3 = *((_DWORD *)this + 21);
    }
