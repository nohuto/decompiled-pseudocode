/*
 * XREFs of ?GetSpatialAudioPolicyFlags@SpatialAudioDevicePropertyReader@@UEAAJPEAW4SpatialAudioPolicyFlags@@@Z @ 0x180101820
 * Callers:
 *     <none>
 * Callees:
        ...
        enum SpatialAudioPolicyFlags *a2)
{
  ...
  if ( *((_DWORD *)this + 128) )
  {
    ...
    {
      v14 = 61LL;
      v13 = "SpatialAudioDevicePropertyReader::GetSpatialAudioPolicyFlags";
      v11[0] = 753;
      v15 = v11;
      v16 = 4LL;
      v10 = -2147024809;
