/*
 * XREFs of _lambda_7f4a656a268d6d0b9fd67fb138151b91_::operator() @ 0x180064978
 * Callers:
...
__int64 __fastcall lambda_7f4a656a268d6d0b9fd67fb138151b91_::operator()(int *a1)
{
  __int64 v1; // r11
  __int64 v3; // rdi
  __int64 v4; // rdx
  ...
  if ( *(_DWORD *)(v3 + 4 * v1 + 40) )
  {
    ...
    else
    {
      ...
      if ( v11 != -1
        && (unsigned int)ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::RemoveAt(v12 + v3 + 64, v11) )
      {
        if ( !(unsigned int)ATL::CSimpleMap<_GUID,_GUID,ATL::CSimpleMapEqualHelper<_GUID,_GUID>>::Add(
                              *((_QWORD *)a1 + 3) + 8 * (3LL * *a1 + 175),
                              v13,
  ...
  *(_DWORD *)(v3 + 4 * v1 + 40) = 1;
  ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::RemoveAll(*((_QWORD *)a1 + 3) + 16 * (*a1 + 4LL));
  if ( !(unsigned int)ATL::CSimpleMap<_GUID,_GUID,ATL::CSimpleMapEqualHelper<_GUID,_GUID>>::Add(
                        *((_QWORD *)a1 + 3) + 8 * (3LL * *a1 + 175),
                        v4,
