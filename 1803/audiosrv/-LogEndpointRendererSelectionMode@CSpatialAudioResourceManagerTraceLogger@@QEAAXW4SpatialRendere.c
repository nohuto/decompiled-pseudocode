/*
 * XREFs of ?LogEndpointRendererSelectionMode@CSpatialAudioResourceManagerTraceLogger@@QEAAXW4SpatialRendererSelectionMode@@PEBG@Z @ 0x1800F8560
 * Callers:
        ...
        const WCHAR *a3)
{
  ...
  if ( (unsigned int)dword_180188330 > 5 )
  {
    ...
    v11 = 0;
    TlgCreateWsz(&v12, a3);
    return TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180148177, v3, v4, cData, &pData);
  }
  return result;
}
