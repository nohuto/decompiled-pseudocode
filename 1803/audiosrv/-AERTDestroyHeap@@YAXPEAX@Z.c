/*
 * XREFs of ?AERTDestroyHeap@@YAXPEAX@Z @ 0x18010B53C
 * Callers:
...
void __fastcall AERTDestroyHeap(void *a1, void *a2)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Eu, (__int64)&WPP_14502ebd56cd3c22b5b969b047a5e1b2_Traceguids, a1);
  }
  if ( a1 )
  {
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x20u, (__int64)&WPP_14502ebd56cd3c22b5b969b047a5e1b2_Traceguids);
  }
}
