/*
 * XREFs of ?ClearApplicationDefaultEndpoint@CPolicyConfig@@UEAAJKW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0002@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@@Z @ 0x1800B88F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  if ( a4 <= 1 )
  {
    ...
    ATL::CAtlMap<unsigned long,ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,ATL::CElementTraits<unsigned long>,ATL::CElementTraits<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>>>::RemoveKey(
      (char *)this + 72 * v5 + v10,
      a2);
    v11 = (*(__int64 (__fastcall **)(LPVOID, _QWORD, _QWORD, const WCHAR *, unsigned int))(*(_QWORD *)ppv + 96LL))(
            ppv,
            a4,
            (unsigned int)v5,
            &word_180133238,
...
LABEL_9:
  ...
  v9 = -2147024809;
LABEL_10:
  AudSrvTraceLoggingErrorHelper("CPolicyConfig::ClearApplicationDefaultEndpoint", 4380, v9);
  v8 = ppv;
LABEL_11:
  if ( v8 )
