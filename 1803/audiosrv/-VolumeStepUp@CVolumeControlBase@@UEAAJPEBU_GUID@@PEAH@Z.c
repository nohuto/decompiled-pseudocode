/*
 * XREFs of ?VolumeStepUp@CVolumeControlBase@@UEAAJPEBU_GUID@@PEAH@Z @ 0x1800A4DF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVolumeControlBase::VolumeStepUp(CVolumeControlBase *this, const struct _GUID *a2, int *a3)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, (__int64)&WPP_a94e90b6b9c23070a932b4669a952a77_Traceguids);
  }
