/*
 * XREFs of ?ForEachEntry@?$CLockedList@VCAudioSessionNotificationProcess@@$00$0A@@@QEAAJAEAVCListWorker@1@@Z @ 0x180017010
 * Callers:
        ...
        void (__fastcall ***a2)(_QWORD, __int64 *))
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    try
    {
      v8 = ATL::CAtlArray<CAudioSession *,ATL::CElementTraits<CAudioSession *>>::operator[](&v3[1], i);
  ...
  for ( j = 0; j < v4; ++j )
  {
    try
    {
      v15 = *(_QWORD *)ATL::CAtlArray<CAudioSession *,ATL::CElementTraits<CAudioSession *>>::operator[](Block, j);
