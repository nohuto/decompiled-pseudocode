/*
 * XREFs of AudioSessionManagerDeleteVolumeDuckNotification @ 0x1800B4180
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionManagerDeleteVolumeDuckNotification(__int64 a1, __int64 a2)
{
  ...
  unsigned int Pid; // [rsp+80h] [rbp+18h] BYREF
...
LABEL_7:
  if ( v3 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionManagerDeleteVolumeDuckNotification", 2405, v3);
LABEL_9:
