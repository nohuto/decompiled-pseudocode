        ...
        __int64 a9)
{
  ...
  *(_QWORD *)&v30.Data1 = v13;
  ...
  if ( v14 )
  {
    v16 = v9;
    v17 = 16 * v9;
    ATL::CSimpleArray<_GUID,ATL::CSimpleArrayEqualHelper<_GUID>>::operator=((__int64)&v27, (__int64)this + v17 + 64);
