/*
 * XREFs of ?SetVolumeOnKsTopology@@YAJAEBU_GUID@@KPEAUIKsControl@@PEAUKSPROPERTY_STEPPING_LONG@@M@Z @ 0x18011C22C
 * Callers:
 *     ?SetCellularVolume@TelephonyController@@UEAAJM@Z @ 0x18011C1F0 (-SetCellularVolume@TelephonyController@@UEAAJM@Z.c)
 * Callees:
