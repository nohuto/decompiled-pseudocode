/*
 * XREFs of Create_SpatialAudioDevicePropertyReader @ 0x18004BFE0
 * Callers:
...
__int64 __fastcall Create_SpatialAudioDevicePropertyReader(__int64 a1, __int64 a2, _QWORD *a3, const GUID *a4)
{
  ...
  {
    *a3 = 0LL;
    Microsoft::WRL::ComPtr<ISpatialAudioDevicePropertyReader>::InternalRelease(v13);
    LODWORD(v11) = Microsoft::WRL::Details::MakeAndInitialize<SpatialAudioDevicePropertyReader,SpatialAudioDevicePropertyReader,unsigned short const * &,IPropertyStore * &>(
                     v13,
                     &v11,
                     &v12);
    v7 = v11;
    ...
    {
      v8 = **(__int64 (__fastcall ***)(__int64, GUID *, _QWORD *))v13[0];
      if ( (char *)v8 == (char *)Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,ISpatialAudioDevicePropertyReader,Microsoft::WRL::FtmBase>::QueryInterface )
        Interface = Microsoft::WRL::Details::RuntimeClassImpl<Microsoft::WRL::RuntimeClassFlags<2>,1,0,0,ISpatialAudioDevicePropertyReader,Microsoft::WRL::FtmBase>::QueryInterface(
                      v13[0],
                      &GUID_dfe7590f_ea77_4947_ace8_25b8f512a67d,
                      a3);
      else
        Interface = v8(v13[0], &GUID_dfe7590f_ea77_4947_ace8_25b8f512a67d, a3);
      v7 = Interface;
    }
  }
  else
