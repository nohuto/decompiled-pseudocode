/*
 * XREFs of ?OnDeviceAdded@CExclusiveModeListener@@EEAAJPEBG@Z @ 0x1800F8860
 * Callers:
 *     ?OnDeviceStateChanged@CExclusiveModeListener@@EEAAJPEBGK@Z @ 0x1800F89B0 (-OnDeviceStateChanged@CExclusiveModeListener@@EEAAJPEBGK@Z.c)
 * Callees:
...
LABEL_12:
  ...
  if ( !v13 )
  {
    v10 = CExclusiveModeListener::SetDeviceRendererSelectionMode(retaddr, v14, *((unsigned int *)this + 36));
    v7 = retaddr;
    if ( v10 < 0 )
    {
      v9 = 474LL;
