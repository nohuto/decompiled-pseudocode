...
__int64 *__fastcall std::_Uninitialized_move_al_unchecked<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy> *,wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy> *,std::allocator<wil::com_ptr_t<IProcessSubmixProxy,wil::err_returncode_policy>>>(
        __int64 *a1,
        __int64 *a2,
        __int64 *a3)
{
