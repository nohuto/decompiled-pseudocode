/*
 * XREFs of asm_GetApplicationSubmixContext @ 0x1800D78F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall asm_GetApplicationSubmixContext(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v5[1], v6, (struct _TP_TIMER *)L"asm_GetApplicationSubmixContext");
  v14 = 0LL;
  ...
  {
    v11 = 0LL;
    v7 = (*(__int64 (__fastcall **)(CProcessSubmixManager *, __int64, __int64, __int64 *))(*(_QWORD *)g_ProcessSubmixManager
                                                                                         + 32LL))(
