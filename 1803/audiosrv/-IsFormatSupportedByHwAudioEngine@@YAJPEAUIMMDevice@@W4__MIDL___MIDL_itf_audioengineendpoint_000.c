/*
 * XREFs of ?IsFormatSupportedByHwAudioEngine@@YAJPEAUIMMDevice@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@PEAPEAU3@@Z @ 0x1800C18E4
 * Callers:
...
LABEL_26:
  ...
  if ( v7 )
    CoTaskMemFree(v7);
  if ( KSFormatFromWFXFormat < 0 )
    AudSrvTraceLoggingErrorHelper("IsFormatSupportedByHwAudioEngine", 404, KSFormatFromWFXFormat);
  if ( v21 )
