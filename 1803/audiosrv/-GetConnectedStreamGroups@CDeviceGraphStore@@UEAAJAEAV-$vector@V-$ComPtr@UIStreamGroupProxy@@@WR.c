/*
 * XREFs of ?GetConnectedStreamGroups@CDeviceGraphStore@@UEAAJAEAV?$vector@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@V?$allocator@V?$ComPtr@UIStreamGroupProxy@@@WRL@Microsoft@@@std@@@std@@@Z @ 0x1800CCF90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDeviceGraphStore::GetConnectedStreamGroups(__int64 a1, __int64 a2)
{
  ...
  try
  {
    ...
    while ( v12 != v13 )
    {
      v14 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)*v12 + 136LL))(*v12, a2);
      v15 = v14;
      if ( v14 < 0 )
      {
