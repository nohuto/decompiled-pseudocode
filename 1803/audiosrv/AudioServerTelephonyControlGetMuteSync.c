/*
 * XREFs of AudioServerTelephonyControlGetMuteSync @ 0x1800C60E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlGetMuteSync(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  ...
  {
    v8 = ((__int64 (__fastcall *)(struct IUnknown *, __int64, _QWORD, __int64))v11->lpVtbl[1].Release)(v11, a2, a3, a4);
    v4 = v11;
    v9 = v8;
  }
  else
