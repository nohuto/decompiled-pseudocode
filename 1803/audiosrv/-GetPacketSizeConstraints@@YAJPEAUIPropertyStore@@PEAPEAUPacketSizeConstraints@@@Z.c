/*
 * XREFs of ?GetPacketSizeConstraints@@YAJPEAUIPropertyStore@@PEAPEAUPacketSizeConstraints@@@Z @ 0x1800EB654
 * Callers:
...
__int64 __fastcall GetPacketSizeConstraints(struct IPropertyStore *a1, LPVOID **a2)
{
  ...
  Size = 0LL;
  Src = 0LL;
  if ( dword_18018B3A4 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_18018B3A4);
    if ( dword_18018B3A4 == -1 )
    {
      xmmword_18018B2E8 = DEVPKEY_KsAudio_PacketSize_Constraints2;
      dword_18018B2F8 = 2;
      xmmword_18018B2FC = DEVPKEY_KsAudio_PacketSize_Constraints;
      dword_18018B30C = 2;
      Init_thread_footer(&dword_18018B3A4);
    }
  }
  v6 = &xmmword_18018B2E8;
  while ( 1 )
  {
    v21 = 0LL;
