/*
 * XREFs of ?RuntimeClassInitialize@CSharedStreamGroupProxy@@QEAAJPEBUStreamGroupParams@@PEAUSTREAM_GROUP_DESCRIPTOR@@K@Z @ 0x18001DC70
 * Callers:
 ...
 *     ?_Buyheadnode@?$_Tree_comp_alloc@V?$_Tmap_traits@KKU?$less@K@std@@V?$allocator@U?$pair@$$CBKK@std@@@2@$0A@@std@@@std@@QEAAPEAU?$_Tree_node@U?$pair@$$CBKK@std@@PEAX@2@XZ @ 0x18001FB60 (-_Buyheadnode@-$_Tree_comp_alloc@V-$_Tmap_traits@KKU-$less@K@std@@V-$allocator@U-$pair@$$CBKK@st.c)
        ...
        int a4)
{
  ...
  struct _RTL_CRITICAL_SECTION *v45; // [rsp+48h] [rbp-28h] BYREF
  ...
  v11 = ((__int64 (__fastcall *)(IUnknown *, struct STREAM_GROUP_DESCRIPTOR *))pProxy->lpVtbl[2].Release)(pProxy, a3);
  v9 = v11;
  if ( v11 < 0 )
  {
    wil::details::in1diag3::Return_Hr(
...
LABEL_35:
  ...
  if ( (int)Microsoft::WRL::AsWeak<IStreamGroupProxy>(ppMalloc[0], v38) < 0
    || (LODWORD(p_DebugInfo) = 0,
        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)this + 55),
        ...
        v39 >= 0) )
  {
    ...
    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease((__int64 *)ppMalloc);
    goto LABEL_35;
  }
  wil::details::in1diag3::Return_Hr(
    retaddr,
