/*
 * XREFs of ?InitializeAPORemote@CAPOWrapperSrv@@UEAAJPEBGPEAU_GUID@@U2@HHHPEAU__MIDL___MIDL_itf_audioenginepolicy_0000_0010_0002@@@Z @ 0x180108740
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
        if ( (unsigned int)dword_1801884D0 > 2 )
        {
          ...
          v33 = 4;
          v36 = 4;
          TlgWrite((TraceLoggingHProvider)&dword_1801884D0, &unk_1801494DA, v13, v14, 5u, &pData);
          v12 = v20;
        }
        goto LABEL_28;
      }
