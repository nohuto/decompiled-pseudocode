/*
 * XREFs of AudioServerStopStream @ 0x180043420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerStopStream(__int64 a1, __int64 a2)
{
  ...
  *(GUID *)&pftDueTime[0].dwLowDateTime = v4;
  ...
  v9 = *(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)a1 + 72LL);
  if ( v9 == CVADServer::StopStream )
    v10 = CVADServer::StopStream(a1, a2, 2LL);
  else
    v10 = v9(a1, a2, 2LL);
  v11 = v10;
  *(_DWORD *)(a1 + 272) = 0;
  if ( v10 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerStopStream", 0xCFEu, v10);
  if ( pv[0] )
  {
