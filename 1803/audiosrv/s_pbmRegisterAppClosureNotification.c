/*
 * XREFs of s_pbmRegisterAppClosureNotification @ 0x1800DD530
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmRegisterAppClosureNotification(__int64 a1)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v2[1], v3, (struct _TP_TIMER *)L"s_pbmRegisterAppClosureNotification");
  v4 = 0;
