/*
 * XREFs of Pdcv2EventWrite_ACTIVATION_CLIENT_DEACTIVATE @ 0x180047D98
 * Callers:
...
void __fastcall Pdcv2EventWrite_ACTIVATION_CLIENT_DEACTIVATE(__int64 a1, _DWORD *a2, int a3)
{
  ...
  if ( (Microsoft_Windows_PDCEnableBits & 0x200000) != 0 )
  {
    ...
    v15 = v4;
    v10 = v16;
    McTemplateU0qqzr1qzr3qqxqpqqzr11q(v13, (_DWORD)a2, v17, v15, (__int64)v9, v14, (__int64)v8, v3, v16, v7, a3, a1);
  }
  else
  {
    v10 = v16;
  }
  if ( v7 >= 0x3E8 && dword_180188510 > 5u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_180188510, 0x400000000000uLL) )
    {
      ...
      v39 = 4LL;
      TlgCreateWsz(&v40, v5);
      TlgWrite((TraceLoggingHProvider)&dword_180188510, &unk_180149676, v11, v12, 0xCu, &pData);
    }
  }
}
