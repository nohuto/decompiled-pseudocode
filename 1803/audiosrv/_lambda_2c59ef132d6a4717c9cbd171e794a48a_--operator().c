/*
 * XREFs of _lambda_2c59ef132d6a4717c9cbd171e794a48a_::operator() @ 0x1800C0598
 * Callers:
...
__int64 __fastcall lambda_2c59ef132d6a4717c9cbd171e794a48a_::operator()(_QWORD *a1, _QWORD *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // rcx
  __int64 **v6; // rsi
  ...
  v7 = **v6;
  v8 = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)*a2 + 32LL))(*a2);
