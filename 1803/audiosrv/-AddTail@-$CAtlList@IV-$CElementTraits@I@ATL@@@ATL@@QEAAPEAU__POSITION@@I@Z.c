/*
 * XREFs of ?AddTail@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z @ 0x18011A288
 * Callers:
 *     ?Initialize@TelephonyController@@IEAAJXZ @ 0x18011AE04 (-Initialize@TelephonyController@@IEAAJXZ.c)
 * Callees:
 *     ?NewNode@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z @ 0x18011B8D0 (-NewNode@-$CAtlList@IV-$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z.c)
 */
