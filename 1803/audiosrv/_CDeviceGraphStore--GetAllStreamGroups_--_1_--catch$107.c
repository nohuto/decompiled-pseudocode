/*
 * XREFs of _CDeviceGraphStore::GetAllStreamGroups_::_1_::catch$107 @ 0x1800CCD6B
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetAllStreamGroups_::_1_::catch_107(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
