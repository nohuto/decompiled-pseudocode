/*
 * XREFs of AudioServerSetStreamSampleRate @ 0x1800C5D20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerSetStreamSampleRate(char *a1, __int64 a2)
{
  ...
  _BYTE v11[16]; // [rsp+60h] [rbp-48h] BYREF
  ...
  v7 = (*(__int64 (__fastcall **)(char *, __int64))(*(_QWORD *)a1 + 144LL))(a1, a2);
  v8 = v7;
  if ( v7 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerSetStreamSampleRate", 3895, v7);
