/*
 * XREFs of ?FindVolumeControlForEndpoint@CVolumeHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18004D88C
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_a94e90b6b9c23070a932b4669a952a77_Traceguids, this);
    v6 = v17;
  }
  if ( a2 )
  {
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control )
    {
      ...
      if ( v8 != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)v8 + 25) >= 4u )
      {
        WPP_SF_q(*((_QWORD *)v8 + 2), 35LL, &WPP_a94e90b6b9c23070a932b4669a952a77_Traceguids, this);
      }
    }
    v9 = v17;
    if ( v17 != a2 )
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 36LL, &WPP_a94e90b6b9c23070a932b4669a952a77_Traceguids, this);
    }
