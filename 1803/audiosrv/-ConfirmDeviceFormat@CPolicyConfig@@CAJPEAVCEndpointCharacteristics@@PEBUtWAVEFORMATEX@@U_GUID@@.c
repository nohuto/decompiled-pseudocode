/*
 * XREFs of ?ConfirmDeviceFormat@CPolicyConfig@@CAJPEAVCEndpointCharacteristics@@PEBUtWAVEFORMATEX@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@H@Z @ 0x1800B8B74
 * Callers:
...
LABEL_14:
  operator delete(v8);
  if ( (int)CanRenderFormat < 0 )
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::ConfirmDeviceFormat", 2421, (int)CanRenderFormat);
  if ( v9 )
