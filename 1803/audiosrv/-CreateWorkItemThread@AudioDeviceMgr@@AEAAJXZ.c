/*
 * XREFs of ?CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ @ 0x180056310
 * Callers:
...
__int64 __fastcall AudioDeviceMgr::CreateWorkItemThread(AudioDeviceMgr *this)
{
  ...
  v1 = 0;
  if ( ((*((_QWORD *)this + 29) + 1LL) & 0xFFFFFFFFFFFFFFFEuLL) == 0 )
  {
    EventW = CreateEventW(0LL, 0, 0, 0LL);
    *((_QWORD *)this + 27) = EventW;
