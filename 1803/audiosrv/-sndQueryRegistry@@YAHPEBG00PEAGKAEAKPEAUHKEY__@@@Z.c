/*
 * XREFs of ?sndQueryRegistry@@YAHPEBG00PEAGKAEAKPEAUHKEY__@@@Z @ 0x18010DA34
 * Callers:
 ...
 *     ?StringCbCatW@@YAJPEAG_KPEBG@Z @ 0x1800C2DE4 (-StringCbCatW@@YAJPEAG_KPEBG@Z.c)
 *     ?GetSoundRegistryPath@@YAHPEAG_KPEBG22@Z @ 0x18010D65C (-GetSoundRegistryPath@@YAHPEAG_KPEBG22@Z.c)
 *     ?sndRegQueryUserValue@@YAHPEBG0KPEAG@Z @ 0x18010DBE0 (-sndRegQueryUserValue@@YAHPEBG0KPEAG@Z.c)
 *     ?sndRegQueryValue@@YAHPEAUHKEY__@@PEBG1KPEAG@Z @ 0x18010DC58 (-sndRegQueryValue@@YAHPEAUHKEY__@@PEBG1KPEAG@Z.c)
 */
