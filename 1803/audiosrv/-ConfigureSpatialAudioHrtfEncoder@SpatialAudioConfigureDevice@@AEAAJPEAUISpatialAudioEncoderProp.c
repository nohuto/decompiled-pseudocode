/*
 * XREFs of ?ConfigureSpatialAudioHrtfEncoder@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x180104178
 * Callers:
        ...
        struct ISpatialAudioEncoderProperties *a2)
{
  ...
  if ( v13[0] >= 0 )
  {
    ...
    if ( v12 >= 0 )
    {
      ...
      v6 = v12;
      if ( v12 < 0 && (unsigned int)dword_1801883B0 > 2 )
      {
        v18 = 0;
        v21 = 0;
        v24 = 0;
