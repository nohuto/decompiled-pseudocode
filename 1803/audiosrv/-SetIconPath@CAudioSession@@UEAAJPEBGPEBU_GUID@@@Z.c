/*
 * XREFs of ?SetIconPath@CAudioSession@@UEAAJPEBGPEBU_GUID@@@Z @ 0x1800AD2E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::SetIconPath(unsigned __int16 **this, char *a2, const struct _GUID *a3)
{
                       ...
                       (__int64)a2) )
  {
    ...
    try
    {
      ...
      ATL::CSimpleStringT<unsigned short,0>::SetString(v7, a2, (unsigned int)v8);
    }
    ...
    if ( v6 < 0 )
    {
      AudSrvTraceLoggingErrorHelper("CAudioSession::SetIconPath", 383, v6);
    }
    else
    {
