/*
 * XREFs of ?LogTelemetry@CSarmErrorEventValues@CSpatialAudioResourceManagerTraceLogger@@UEAAXXZ @ 0x1800F5FA0
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialAudioResourceManagerTraceLogger::CSarmErrorEventValues *this)
{
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v5 > 3u )
      {
        if ( TlgKeywordOn(v5, 0x400000000000uLL) )
        {
          ...
          v22 = 4LL;
          v24 = 4LL;
          TlgWrite(v7, &unk_180147B9E, v6, (LPCGUID)v7, 7u, &pData);
        }
      }
    }
    else if ( *(_DWORD *)v5 > 3u && TlgKeywordOn(v5, 0x400000000000uLL) )
    {
      ...
      v22 = 4LL;
      v24 = 4LL;
      TlgWrite(v9, &unk_180147C33, v8, (LPCGUID)v9, 7u, &pData);
    }
  }
}
