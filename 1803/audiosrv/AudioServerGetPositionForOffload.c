/*
 * XREFs of AudioServerGetPositionForOffload @ 0x1800C4600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetPositionForOffload(char *a1, __int64 a2, __int64 a3)
{
  __int64 v6; // rcx
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v7[1], v8, (struct _TP_TIMER *)L"AudioServerGetPositionForOffload");
  v9 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*(_QWORD *)a1 + 120LL))(a1, a2, a3);
  v10 = v9;
  if ( v9 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetPositionForOffload", 3760, v9);
