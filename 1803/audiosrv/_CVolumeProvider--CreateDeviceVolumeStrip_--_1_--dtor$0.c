/*
 * XREFs of _CVolumeProvider::CreateDeviceVolumeStrip_::_1_::dtor$0 @ 0x18006B22F
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CVolumeProvider::CreateDeviceVolumeStrip_::_1_::dtor_0(__int64 a1, __int64 a2)
{
