/*
 * XREFs of ?GetState@CServerAudioSessionControl@@UEAAJPEAW4_AudioSessionState@@@Z @ 0x180004D20
 * Callers:
...
__int64 __fastcall CServerAudioSessionControl::GetState(CServerAudioSessionControl *this, enum _AudioSessionState *a2)
{
  ...
  v3 = *(__int64 (__fastcall **)(CAudioSession *__hidden, enum _AudioSessionState *))(*(_QWORD *)v2 + 104LL);
