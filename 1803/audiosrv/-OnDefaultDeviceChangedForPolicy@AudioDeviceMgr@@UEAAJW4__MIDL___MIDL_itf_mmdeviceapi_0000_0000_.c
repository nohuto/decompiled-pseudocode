/*
 * XREFs of ?OnDefaultDeviceChangedForPolicy@AudioDeviceMgr@@UEAAJW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@PEBG@Z @ 0x180116D10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioDeviceMgr::OnDefaultDeviceChangedForPolicy(__int64 a1, int a2, int a3, unsigned __int64 a4)
{
  unsigned int v5; // ebx
  _QWORD *v9; // rdi
  int v10; // eax
  ...
  if ( v9 )
  {
    *v9 = &WorkItemBase::`vftable';
    ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>(
      v9 + 1,
      a4);
    *((_DWORD *)v9 + 4) = a3;
    *v9 = &DefaultDeviceChangedWorkItem::`vftable';
    *((_DWORD *)v9 + 5) = a2;
  }
  else
  {
