/*
 * XREFs of AudioSessionSetVolume @ 0x1800B0AB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionSetVolume(__int64 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v7[1], v8, (struct _TP_TIMER *)L"AudioSessionSetVolume");
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(*(_QWORD *)v4 + 296LL))(v4, v9, a3, a4);
  v11 = v10;
  if ( v10 >= 0 )
    v11 = 0;
  else
