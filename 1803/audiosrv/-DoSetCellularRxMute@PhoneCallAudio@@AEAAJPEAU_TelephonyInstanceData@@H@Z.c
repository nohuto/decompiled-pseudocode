/*
 * XREFs of ?DoSetCellularRxMute@PhoneCallAudio@@AEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x1800FA168
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( v7 )
  {
    v8 = (*(__int64 (__fastcall **)(__int64, struct _TelephonyInstanceData *, _QWORD))(*(_QWORD *)v7 + 40LL))(
           v7,
           a2,
           a3);
    if ( v8 < 0 )
