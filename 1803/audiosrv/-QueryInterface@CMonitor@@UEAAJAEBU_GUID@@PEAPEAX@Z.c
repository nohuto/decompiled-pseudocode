/*
 * XREFs of ?QueryInterface@CMonitor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800E4FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMonitor::QueryInterface(CMonitor *this, const struct _GUID *a2, CMonitor **a3)
{
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x3Fu, (__int64)&WPP_298f35db72853edc559b812a776cab31_Traceguids, v6);
  }
