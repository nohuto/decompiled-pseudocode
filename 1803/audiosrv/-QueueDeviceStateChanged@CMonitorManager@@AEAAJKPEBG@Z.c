/*
 * XREFs of ?QueueDeviceStateChanged@CMonitorManager@@AEAAJKPEBG@Z @ 0x1800E1204
 * Callers:
 *     ?OnDeviceAdded@CMonitorManager@@EEAAJPEBG@Z @ 0x1800E03B0 (-OnDeviceAdded@CMonitorManager@@EEAAJPEBG@Z.c)
 *     ?OnDeviceRemoved@CMonitorManager@@EEAAJPEBG@Z @ 0x1800E0700 (-OnDeviceRemoved@CMonitorManager@@EEAAJPEBG@Z.c)
...
__int64 __fastcall CMonitorManager::QueueDeviceStateChanged(char *pv, int a2, char *a3)
{
  ...
  if ( v6 )
  {
    ATL::CSimpleStringT<unsigned short,0>::CSimpleStringT<unsigned short,0>(v6, (ATL::CAtlStringMgr *)&ATL::g_strmgr);
    *((_DWORD *)v7 + 2) = a2;
    *((_QWORD *)v7 + 2) = 0LL;
  }
  else
  ...
  try
  {
    ...
    ATL::CSimpleStringT<unsigned short,0>::SetString((const void **)v7, a3, (unsigned int)v9);
  }
