/*
 * XREFs of ?ProcessDynamicObjectCountChange@CStreamResource@Sarm@@QEAAJIIAEA_J@Z @ 0x1800F7498
 * Callers:
  ...
  if ( v8 >= 0 )
  {
    ...
    *((_DWORD *)this + 18) = v13;
    ...
    if ( (unsigned int)dword_180188330 > 5 )
    {
      ...
      v38 = 4;
      v41 = 1;
      TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180147E31, v17, v18, 7u, &pData);
    }
