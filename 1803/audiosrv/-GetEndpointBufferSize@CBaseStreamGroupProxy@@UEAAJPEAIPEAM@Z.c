/*
 * XREFs of ?GetEndpointBufferSize@CBaseStreamGroupProxy@@UEAAJPEAIPEAM@Z @ 0x1800C9530
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( v3 )
  {
    ...
    Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(&v8);
    if ( v4 < 0 )
      AudSrvTraceLoggingErrorHelper("CBaseStreamGroupProxy::GetEndpointBufferSize", 773, v4);
  }
