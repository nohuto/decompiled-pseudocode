/*
 * XREFs of ?DeleteAudioSessionClientNotification@CAudioSessionManager@@UEAAJPEAUIAudioProcess@@@Z @ 0x1800B1CB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioProcess *a2)
{
  ...
  v5 = v4;
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSessionManager::DeleteAudioSessionClientNotification", 719, v4);
  return v5;
}
