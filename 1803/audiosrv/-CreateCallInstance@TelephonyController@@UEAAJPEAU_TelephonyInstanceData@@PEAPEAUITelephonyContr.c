/*
 * XREFs of ?CreateCallInstance@TelephonyController@@UEAAJPEAU_TelephonyInstanceData@@PEAPEAUITelephonyControllerCallInstance@@@Z @ 0x18011A380
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ITelephonyControllerCallInstance **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      if ( v6 >= 0 )
      {
        v6 = (*(__int64 (__fastcall **)(CAudioResourceManager *, _QWORD *))(*(_QWORD *)g_AudioResourceManager + 72LL))(
               g_AudioResourceManager,
               v10);
        if ( v6 >= 0 )
        {
          v6 = (*(__int64 (__fastcall **)(CAudioResourceManager *, _QWORD, _BYTE *, _QWORD, int, _DWORD))(*(_QWORD *)g_AudioResourceManager + 64LL))(
                 g_AudioResourceManager,
                 0LL,
                 v11,
                 v12,
          ...
          if ( v6 >= 0 )
          {
            v6 = (*(__int64 (__fastcall **)(CAudioResourceManager *, _QWORD, _BYTE *, _QWORD, int, int))(*(_QWORD *)g_AudioResourceManager + 64LL))(
                   g_AudioResourceManager,
                   0LL,
                   v13,
                   v14,
