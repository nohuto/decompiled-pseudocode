/*
 * XREFs of _lambda_759c10d6a679fdab43c4d5c1468c56ec_::operator() @ 0x1800E936C
 * Callers:
...
bool __fastcall lambda_759c10d6a679fdab43c4d5c1468c56ec_::operator()(__int64 a1, __int64 a2, DWORD a3, WORD a4)
{
  ...
  *(_DWORD *)&v13.nBlockAlign = 2097160;
  v13.cbSize = 0;
  CAudioMediaType::Create(&v12, 0x12u, &v9, 0.0, 0);
  CAudioMediaType::Create(&v13, 0x12u, &v10, 0.0, 0);
  v6 = v9;
  v7 = v10;
  if ( v9 )
  {
