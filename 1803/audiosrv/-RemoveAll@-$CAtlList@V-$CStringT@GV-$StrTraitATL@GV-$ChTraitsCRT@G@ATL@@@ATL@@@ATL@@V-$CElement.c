/*
 * XREFs of ?RemoveAll@?$CAtlList@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@@ATL@@QEAAXXZ @ 0x1800370DC
 * Callers:
 ...
 *     ?RemoveAll@?$CAtlList@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@@ATL@@QEAAXXZ @ 0x1800370DC (-RemoveAll@-$CAtlList@V-$CStringT@GV-$StrTraitATL@GV-$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@V-$CElement.c)
 * Callees:
        ...
        __int64 a1)
{
  ...
  if ( *(_QWORD *)(a1 + 16) )
  {
    do
    {
      ...
      *(_QWORD *)a1 = *v3;
      ATL::CStringData::Release((ATL::CStringData *)(v3[2] - 24LL));
      *v3 = *(_QWORD *)(a1 + 32);
      v4 = (*(_QWORD *)(a1 + 16))-- == 1LL;
      v5 = *(_QWORD *)(a1 + 16);
      *(_QWORD *)(a1 + 32) = v3;
