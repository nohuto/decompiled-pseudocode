/*
 * XREFs of ?ReacquirePhoneCallResource@CConstraintModelResourceManager@@UEAAJHPEA_K@Z @ 0x1800D9DF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_dID @ 0x1800DB150 (WPP_SF_dID.c)
        ...
        unsigned __int64 *a3)
{
  ...
  _QWORD *v60; // [rsp+5C0h] [rbp+4C0h] BYREF
...
LABEL_9:
      ...
      ATL::CAtlList<IAudioStreamVolumeCallback *,ATL::CElementTraits<IAudioStreamVolumeCallback *>>::RemoveAll((__int64)&v54);
    }
    else
    {
