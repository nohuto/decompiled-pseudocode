/*
 * XREFs of ??$MakeAndInitialize@VCDeviceGraphManager@@UIDeviceGraphManager@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIDeviceGraphManager@@@Z @ 0x18005E11C
 * Callers:
...
__int64 Microsoft::WRL::Details::MakeAndInitialize<CDeviceGraphManager,IDeviceGraphManager,>()
{
  ...
  g_DeviceGraphManager = 0LL;
  v2 = v1;
  if ( InlineIsEqualGUID(&GUID_d45427ee_ae5c_446a_80fa_b53b205ebdc0, &GUID_00000000_0000_0000_c000_000000000046)
