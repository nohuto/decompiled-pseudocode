/*
 * XREFs of ?DeviceRemovalEvent@CAudioSrv@@UEAAJV?$CHeapPtr@U_DEV_BROADCAST_DEVICEINTERFACE_W@@VCCRTAllocator@ATL@@@ATL@@@Z @ 0x18009D190
 * Callers:
 *     <none>
 * Callees:
 *     ?MME_AudioInterfaceRemove@@YAJPEBG@Z @ 0x1800DC2B4 (-MME_AudioInterfaceRemove@@YAJPEBG@Z.c)
