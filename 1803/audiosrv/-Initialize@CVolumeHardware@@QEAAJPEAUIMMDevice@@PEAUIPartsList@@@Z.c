/*
 * XREFs of ?Initialize@CVolumeHardware@@QEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18004D7BC
 * Callers:
...
__int64 __fastcall CVolumeHardware::Initialize(CVolumeHardware *this, struct IMMDevice *a2, struct IPartsList *a3)
{
  ...
  else
  {
    ...
    if ( VolumeControlForEndpoint >= 0 )
    {
      ...
      {
        WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 37LL, &WPP_a94e90b6b9c23070a932b4669a952a77_Traceguids, this);
      }
    }
  }
  if ( VolumeControlForEndpoint < 0 )
