/*
 * XREFs of ?Initialize@_RecurringTask@@QEAAJV?$function@$$A6AXXZ@std@@PEAVCSerialWorkQueue@@@Z @ 0x18002AACC
 * Callers:
...
__int64 __fastcall _RecurringTask::Initialize(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(a1 + 24) = a3;
  v5 = std::make_shared<std::function<void (void)>,std::function<void (void)> &>(&v11);
  std::shared_ptr<std::function<void (void)>>::operator=(a1 + 8, v5);
  if ( v12 )
    std::_Ref_count_base::_Decref(v12);
  v9 = *(_QWORD *)(a1 + 8) == 0LL ? 0x8007000E : 0;
