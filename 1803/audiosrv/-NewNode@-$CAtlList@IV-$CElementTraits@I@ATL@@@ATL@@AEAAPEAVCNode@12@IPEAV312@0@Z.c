/*
 * XREFs of ?NewNode@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@AEAAPEAVCNode@12@IPEAV312@0@Z @ 0x18011B8D0
 * Callers:
 *     ?AddTail@?$CAtlList@IV?$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z @ 0x18011A288 (-AddTail@-$CAtlList@IV-$CElementTraits@I@ATL@@@ATL@@QEAAPEAU__POSITION@@I@Z.c)
 * Callees:
