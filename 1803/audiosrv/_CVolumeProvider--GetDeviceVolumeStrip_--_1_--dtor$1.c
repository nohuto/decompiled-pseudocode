/*
 * XREFs of _CVolumeProvider::GetDeviceVolumeStrip_::_1_::dtor$1 @ 0x180066CEC
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CVolumeProvider::GetDeviceVolumeStrip_::_1_::dtor_1(__int64 a1, __int64 a2)
{
