/*
 * XREFs of ?NonDelegatingQueryInterface@PhoneTopology@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180119600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PhoneTopology::NonDelegatingQueryInterface(PhoneTopology *this, const struct _GUID *a2, void **a3)
{
  unsigned int v3; // ebx
  __int64 v4; // rax
  char *v5; // rcx
