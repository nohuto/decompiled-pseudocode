/*
 * XREFs of ??1CVADServer@@QEAA@XZ @ 0x180096DC4
 * Callers:
 *     _ATL::CComObject_CVADServer_::CreateInstance_::_1_::dtor$1 @ 0x18006A4F8 (_ATL--CComObject_CVADServer_--CreateInstance_--_1_--dtor$1.c)
 * Callees:
...
void __fastcall CVADServer::~CVADServer(CVADServer *this)
{
  ...
  wil::com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>::~com_ptr_t<Windows::Graphics::Holographic::IHolographicDisplay,wil::err_returncode_policy>((__int64 *)this + 55);
  v4 = (std::_Ref_count_base *)*((_QWORD *)this + 54);
  if ( v4 )
