/*
 * XREFs of ?GetAppSubmixClientContext@CProcessSubmixManager@@UEAAJKW4ProcessSubmixCapture@@PEAUIAudioProcess@@PEAPEAVCAppSubmixClient@@@Z @ 0x1800D6820
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a5)
{
  ...
  try
  {
    result = CProcessSubmixManager::GetAppSubmixClientContextHelper(a1, a2, a3, &word_180133238, a4, a5);
  }
  catch ( ... )
  {
