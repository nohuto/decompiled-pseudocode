/*
 * XREFs of ?IsProcessAllowed@@YAHKPEBG@Z @ 0x1800160A0
 * Callers:
...
__int64 __fastcall IsProcessAllowed(DWORD dwProcessId, const unsigned __int16 *a2)
{
  ...
  if ( v7 )
  {
    ...
    if ( v8 < 0 )
    {
      AudSrvTraceLoggingErrorHelper("IsProcessAllowed", 0x226u, v8);
      goto LABEL_16;
    }
  }
  v5 = 1;
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      if ( pSessionId && v6 && pSessionId != v6 )
      {
        ...
        {
          WPP_SF_dd(*((_QWORD *)WPP_GLOBAL_Control + 2), 10LL, &WPP_88b76fc63f1b3689695f31bb524eee45_Traceguids);
        }
      }
      else
      {
  ...
  if ( v5 )
  {
    ...
    if ( v9 )
    {
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 11LL, &WPP_88b76fc63f1b3689695f31bb524eee45_Traceguids, v9);
      }
    }
  }
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("IsProcessAllowed", 0x278u, v8);
  if ( v12 )
