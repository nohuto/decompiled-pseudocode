/*
 * XREFs of ?DeriveConnectorFormatFromStreamFormat@@YAJPEAVCEndpointCharacteristics@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUtWAVEFORMATEX@@U_GUID@@33HPEAPEAU3@@Z @ 0x1800B9B3C
 * Callers:
...
// Hidden C++ exception states: #wind=103
        ...
        struct tWAVEFORMATEX **a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( (int)CloneWaveFormat(Src, &v42) < 0 )
    goto LABEL_80;
  v40 = *a4;
  MixFormat = CEndpointCharacteristics::GetMixFormat(v11, a2, &v40, v13, &v43);
  v12 = v43;
  if ( MixFormat < 0 )
    goto LABEL_80;
  v40 = *a5;
  ...
  {
    v40 = *a6;
    GetDeviceDefaults(v11, a2, &v40, a8, 0LL, 0LL, 0LL);
    goto LABEL_80;
  }
  if ( !a7 )
    goto LABEL_80;
  pv = 0LL;
  v40 = *a6;
  v16 = DeriveConnectorFormatWithHighestBitDepthFromStreamFormat(v11, a2, Src, &v40, (struct tWAVEFORMATEX **)&pv);
  v17 = pv;
  if ( v16 >= 0 )
  {
    Srca[0] = 0LL;
    ...
    v40 = *a5;
    v20 = v38;
    if ( (int)DeriveMixFormatFromDevicePipeFormat(this, &v40, a2, (struct IAudioMediaType *)v38, &v41, 0LL) < 0 )
    {
      if ( v41 )
...
LABEL_79:
  ...
  Srca[0] = 0LL;
  v40 = *a6;
  GetDeviceDefaults(v11, a2, &v40, Srca, 0LL, 0LL, 0LL);
  v25 = Srca[0];
...
LABEL_78:
  ...
  v40 = *a6;
  if ( (int)ConnectorSupportsFormat(v11, (unsigned int)a2, v27, &v40) < 0 )
  {
LABEL_77:
    CoTaskMemFree(v27);
    v38 = 0LL;
...
LABEL_68:
  ...
  v29 = v41;
  if ( (int)DeriveDevicePipeFormatFromConnectorFormat(v11, v28, a2, v41, &v44) < 0 )
  {
    if ( v44 )
  ...
  v45 = *a5;
  v30 = v44;
  if ( (int)DeriveMixFormatFromDevicePipeFormat(this, &v45, a2, v44, (struct IAudioMediaType **)&v40, 0LL) < 0 )
  {
    if ( *(_QWORD *)&v40.Data1 )
