/*
 * XREFs of ?RemoveAt@?$CAtlArray@PEAVCAudioSessionManager@@V?$CElementTraits@PEAVCAudioSessionManager@@@ATL@@@ATL@@QEAAX_K0@Z @ 0x180098038
 * Callers:
...
unsigned __int64 __fastcall ATL::CAtlArray<CAudioSessionManager *,ATL::CElementTraits<CAudioSessionManager *>>::RemoveAt(
        _QWORD *a1,
        unsigned __int64 a2)
{
  ...
  if ( v4 != v2 )
  {
    ...
    if ( v5 )
    {
      if ( !v7 || !v6 )
      {
        *(_DWORD *)_o__errno(v5, a2, v4, v7) = 22;
