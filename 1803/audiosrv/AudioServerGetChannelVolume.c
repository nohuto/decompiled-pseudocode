/*
 * XREFs of AudioServerGetChannelVolume @ 0x1800C3450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetChannelVolume(char *a1, unsigned int a2, __int64 a3)
{
  ...
  v9 = (*(__int64 (__fastcall **)(char *, _QWORD, __int64))(*(_QWORD *)a1 + 200LL))(a1, a2, a3);
  v10 = v9;
  if ( v9 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetChannelVolume", 3560, v9);
