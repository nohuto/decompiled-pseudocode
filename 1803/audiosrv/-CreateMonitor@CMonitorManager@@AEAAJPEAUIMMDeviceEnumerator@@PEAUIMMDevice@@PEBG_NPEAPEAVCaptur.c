/*
 * XREFs of ?CreateMonitor@CMonitorManager@@AEAAJPEAUIMMDeviceEnumerator@@PEAUIMMDevice@@PEBG_NPEAPEAVCaptureMonitor@1@@Z @ 0x1800DE4BC
 * Callers:
        ...
        struct CMonitorManager::CaptureMonitor **a6)
{
  ...
  v11 = a6;
  *a6 = 0LL;
  v12 = ((__int64 (__fastcall *)(struct IMMDeviceEnumerator *, const unsigned __int16 *, struct IMMDevice **))a2->lpVtbl->GetDevice)(
          a2,
          a4,
          &v20);
  v13 = v12;
...
LABEL_24:
  ...
  try
  {
    ...
    if ( v15 )
      v9 = CMonitorManager::CaptureMonitor::CaptureMonitor(v15, this, (const unsigned __int16 *)pv, a4, a5);
    else
      v9 = 0LL;
    v19 = v9;
  }
...
LABEL_25:
  ...
  else
  {
    ...
    if ( (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x800000) == 0 || *((_BYTE *)WPP_GLOBAL_Control + 25) < 2u )
      goto LABEL_28;
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x4Du, (__int64)&WPP_1a258077347a3434ed979dcee8522c59_Traceguids);
  }
LABEL_27:
  v14 = WPP_GLOBAL_Control;
LABEL_28:
  if ( v14 != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)v14 + 25) >= 2u )
  {
    WPP_SF_d(*((_QWORD *)v14 + 2), 0x4Fu, (__int64)&WPP_1a258077347a3434ed979dcee8522c59_Traceguids, v13);
  }
LABEL_32:
  if ( v9 )
