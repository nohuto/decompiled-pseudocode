/*
 * XREFs of ?IsExclusiveModeDisabled@@YAHPEAUIMMDevice@@@Z @ 0x1800030F8
 * Callers:
...
__int64 __fastcall IsExclusiveModeDisabled(struct IMMDevice *a1)
{
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 62LL, &WPP_88b76fc63f1b3689695f31bb524eee45_Traceguids, v1);
  }
  return v1;
}
