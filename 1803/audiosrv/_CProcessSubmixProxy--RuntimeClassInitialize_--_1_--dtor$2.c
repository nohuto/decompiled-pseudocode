/*
 * XREFs of _CProcessSubmixProxy::RuntimeClassInitialize_::_1_::dtor$2 @ 0x18006925C
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CProcessSubmixProxy::RuntimeClassInitialize_::_1_::dtor_2(__int64 a1, __int64 a2)
{
