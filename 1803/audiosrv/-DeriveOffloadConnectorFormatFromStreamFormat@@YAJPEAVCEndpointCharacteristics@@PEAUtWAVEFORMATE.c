/*
 * XREFs of ?DeriveOffloadConnectorFormatFromStreamFormat@@YAJPEAVCEndpointCharacteristics@@PEAUtWAVEFORMATEX@@U_GUID@@22PEAPEAU2@@Z @ 0x1800BB044
 * Callers:
        ...
        struct tWAVEFORMATEX **a6)
{
  ...
  v10 = a6;
  *a6 = 0LL;
  v11 = (struct tWAVEFORMATEX **)*((_QWORD *)this + 2);
  a6 = v11;
  ...
  if ( v16 )
  {
    if ( (*(int (__fastcall **)(struct tWAVEFORMATEX **, struct _GUID **))&(*v11)[2].nSamplesPerSec)(v11, &a5) < 0
      || (int)CEndpointCharacteristics::GetOffloadDeviceFormat(this, &Srca) < 0 )
    {
      goto LABEL_19;
    }
...
LABEL_14:
  ...
  {
    v22 = *a4;
    if ( IsOffloadConnectorFormatSupportedForMixFormat(this, &v22, v15, v9, v9) >= 0 )
    {
      v22 = *a4;
      if ( !(unsigned int)IsStreamFormatSupportedForMixFormat(this, &v22, eOffloadConnector, v9, v13, 0LL) )
