/*
 * XREFs of ?InitializeMonitorRestartTimer@CMonitorManager@@AEAAJK_KPEBK@Z @ 0x180059750
 * Callers:
        ...
        const unsigned int *a4)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 51LL, &WPP_1a258077347a3434ed979dcee8522c59_Traceguids, pv);
  }
  v10 = 0;
  ...
  *((_QWORD *)pv + 37) = ThreadpoolTimer;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 52LL, &WPP_1a258077347a3434ed979dcee8522c59_Traceguids, v5);
  }
  if ( v10 )
