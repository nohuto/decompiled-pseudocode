/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x18004FD74
 * Callers:
...
__int64 __fastcall wil::Feature<__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed>::GetCachedFeatureEnabledState(
        __int64 a1,
        int a2,
        __int64 a3)
{
  ...
  v3 = `wil::Feature<__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed>::GetFeaturePropertyCache'::`2'::data & 3;
  v4 = v3;
  if ( (`wil::Feature<__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed>::GetFeaturePropertyCache'::`2'::data & 3) == 0
    || (`wil::Feature<__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed>::GetFeaturePropertyCache'::`2'::data & 0x30) == 0 )
  {
    FeatureEnabledState = wil::details::WilApi_GetFeatureEnabledState(0x9C34DBuLL, a2, a3);
    v6 = ((unsigned int)FeatureEnabledState >> 6) & 1;
    v7 = ((FeatureEnabledState & 0x80u) != 0) + 1;
    v8 = FeatureEnabledState & 0xFFFFFF3F;
    if ( !v8 || (v4 = 2, v8 != 2) )
      v4 = 1;
    v9 = (`wil::Feature<__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
    if ( v3 )
      v4 = v3;
    else
      v9 = v6;
    wil::details::EnabledStateManager::SubscribeFeaturePropertyCacheToEnabledStateChanges(
      ...
      (__int64)&`wil::Feature<__WilFeatureTraits_Feature_EnableAtmosSpeakersTechAllowed>::GetFeaturePropertyCache'::`2'::data,
      0);
    if ( !g_wil_details_testStates || !(unsigned int)wil_details_HasTestState(10237147LL, 0LL, v13) )
    {
      if ( v3 )
      {
        v11 = v7;
