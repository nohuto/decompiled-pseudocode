/*
 * XREFs of _CAudioSession::RegisterOwnerProcess_::_1_::catch$5 @ 0x1800AC852
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CAudioSession::RegisterOwnerProcess_::_1_::catch_5(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
