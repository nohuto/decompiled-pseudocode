/*
 * XREFs of ?RuntimeClassInitialize@CExclusiveModeListener@@QEAAJXZ @ 0x1800F9204
 * Callers:
...
LABEL_3:
  ...
  Instance = RoGetActivationFactory(v35, &GUID_e464b452_7eb3_434b_95d6_1339477e80c7, this + 7);
  if ( Instance < 0 )
  {
    v4 = 43LL;
    goto LABEL_3;
  ...
  v7 = *v5;
  v8 = (struct Windows::Graphics::Holographic::Internal::IHolographicDisplayWatcher **)(this + 8);
  v9 = this[8];
  this[8] = 0LL;
  if ( v9 )
    (*(void (__fastcall **)(LPVOID))(*(_QWORD *)v9 + 16LL))(v9);
  Instance = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)v7 + 48LL))(v7, (char *)this + 64);
  if ( Instance < 0 )
  {
    v4 = 44LL;
    goto LABEL_3;
  ...
  if ( v12 )
  {
    ...
    *(_QWORD *)&v31 = v13;
    ...
    if ( (*(int (__fastcall **)(__int64, struct Windows::Graphics::Holographic::IHolographicDisplay **))(*(_QWORD *)v16 + 64LL))(
           ...
           &v30) >= 0
      && v30
      && (v17 = CExclusiveModeListener::OnHmdAdded((__int64 ***)this, *v8, v30), Instance = v17, v17 < 0) )
    {
