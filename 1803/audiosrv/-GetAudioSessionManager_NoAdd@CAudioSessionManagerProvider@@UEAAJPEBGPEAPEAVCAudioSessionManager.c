/*
 * XREFs of ?GetAudioSessionManager_NoAdd@CAudioSessionManagerProvider@@UEAAJPEBGPEAPEAVCAudioSessionManager@@@Z @ 0x1800B4B90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CAudioSessionManager **a3)
{
  ...
  if ( !a2 || !a3 )
  {
    v3 = -2147024809;
LABEL_27:
    AudSrvTraceLoggingErrorHelper("CAudioSessionManagerProvider::GetAudioSessionManager_NoAdd", 494, v3);
  ...
  *a3 = 0LL;
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, (__int64)&WPP_aeba30c7500c361d0468064516c9e613_Traceguids, a2);
  }
  v12 = 0;
  ...
  if ( *((_QWORD *)this + 14) )
  {
    ...
    *a3 = v9;
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_aeba30c7500c361d0468064516c9e613_Traceguids, v9);
    }
  }
LABEL_12:
  if ( *a3 )
