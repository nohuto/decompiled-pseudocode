/*
 * XREFs of ?LogVolumePolicyChange@CSpatialAudioResourceManagerTraceLogger@@QEAAXKPEBG@Z @ 0x1800F6274
 * Callers:
        ...
        const unsigned __int16 *a3)
{
  ...
  if ( (unsigned int)dword_180188330 > 5 )
  {
    ...
    v10 = 0;
    TlgCreateWsz(&v11, a3);
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180147B39, v3, v4, cData, &pData);
  }
}
