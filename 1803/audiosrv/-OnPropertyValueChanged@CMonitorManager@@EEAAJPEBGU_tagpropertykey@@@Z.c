/*
 * XREFs of ?OnPropertyValueChanged@CMonitorManager@@EEAAJPEBGU_tagpropertykey@@@Z @ 0x180017270
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_S_guid_D @ 0x1800E1F7C (WPP_SF_S_guid_D.c)
 */
...
LABEL_39:
    if ( v17 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)v17 + 25) >= 2u )
    {
      WPP_SF_d(*((_QWORD *)v17 + 2), 34LL, &WPP_1a258077347a3434ed979dcee8522c59_Traceguids, v16);
    }
    goto LABEL_43;
  }
  v16 = 0;
...
LABEL_37:
  ...
  *((_QWORD *)v14 + 5) = ThreadpoolWork;
  ...
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_1a258077347a3434ed979dcee8522c59_Traceguids, v16);
    goto LABEL_37;
  }
LABEL_38:
  if ( (v16 & 0x80000000) != 0 )
