/*
 * XREFs of ??0?$CAggregateTelemetryClustered@W4SarmErrorEvent@@PEAI$0A@$0A@@@QEAA@PEAV?$CAggregateValuesClusteredBase@W4SarmErrorEvent@@PEAI@@_K11@Z @ 0x18005E810
 * Callers:
 *     ??0CSpatialAudioResourceManagerTraceLogger@@QEAA@XZ @ 0x18005E758 (--0CSpatialAudioResourceManagerTraceLogger@@QEAA@XZ.c)
 * Callees:
 *     ?Initialize@?$CAggregateValuesClusteredBase@W4SarmErrorEvent@@PEAI@@UEAAXPEB_NPEB_K1@Z @ 0x180018450 (-Initialize@-$CAggregateValuesClusteredBase@W4SarmErrorEvent@@PEAI@@UEAAXPEB_NPEB_K1@Z.c)
 *     ?Clear@?$CAggregateTelemetryClustered@W4SarmErrorEvent@@PEAI$0A@$0A@@@UEAAXXZ @ 0x18005E7D0 (-Clear@-$CAggregateTelemetryClustered@W4SarmErrorEvent@@PEAI$0A@$0A@@@UEAAXXZ.c)
