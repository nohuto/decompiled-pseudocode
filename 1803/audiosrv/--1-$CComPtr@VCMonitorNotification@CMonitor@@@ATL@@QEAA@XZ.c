/*
 * XREFs of ??1?$CComPtr@VCMonitorNotification@CMonitor@@@ATL@@QEAA@XZ @ 0x1800DE0E8
 * Callers:
 *     _CMonitor::CMonitor_::_1_::dtor$8 @ 0x1800DDEDB (_CMonitor--CMonitor_--_1_--dtor$8.c)
 *     _CMonitor::CMonitor_::_1_::dtor$16 @ 0x1800DDF73 (_CMonitor--CMonitor_--_1_--dtor$16.c)
 * Callees:
