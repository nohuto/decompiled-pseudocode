/*
 * XREFs of _lambda_a052ec7a367690e77a30e2131715db58_::operator() @ 0x1800CC488
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_a052ec7a367690e77a30e2131715db58__bool_ISaDeviceProxy_____ptr64_::_Do_call @ 0x1800CDF50 (std--_Func_impl_no_alloc__lambda_a052ec7a367690e77a30e2131715db58__bool_ISaDevicePr_ea_1800CDF50.c)
 * Callees:
 *     __security_check_cookie @ 0x1800608E0 (__security_check_cookie.c)
 *     memcmp_0 @ 0x1800657A9 (memcmp_0.c)
 *     _guard_dispatch_icall_nop @ 0x1800657D0 (_guard_dispatch_icall_nop.c)
 *     WPP_SF_qdd @ 0x1800AE380 (WPP_SF_qdd.c)
 *     WPP_SF_qDD @ 0x1800CE0C8 (WPP_SF_qDD.c)
 *     WPP_SF_qdddd @ 0x1800CE128 (WPP_SF_qdddd.c)
 *     WPP_SF_qii @ 0x1800CE1A4 (WPP_SF_qii.c)
 */

char __fastcall lambda_a052ec7a367690e77a30e2131715db58_::operator()(__int64 *a1, __int64 a2)
{
  __int64 v4; // rbx
  __int64 v5; // rax
  __int64 v6; // rdx
    ...
    else
    {
             ...
             && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        ...
        WPP_SF_qdd(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0xCu,
          (__int64)&WPP_35c1dff30a9531bf8bd5d9236476b079_Traceguids,
          a2,
          v28,
          v29);
      }
