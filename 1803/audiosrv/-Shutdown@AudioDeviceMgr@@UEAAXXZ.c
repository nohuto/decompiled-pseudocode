/*
 * XREFs of ?Shutdown@AudioDeviceMgr@@UEAAXXZ @ 0x1801173A0
 * Callers:
...
void __fastcall AudioDeviceMgr::Shutdown(AudioDeviceMgr *this)
{
  ...
  {
    SetEvent(v3);
    WaitForSingleObject(*((HANDLE *)this + 29), 0xFFFFFFFF);
  }
  v4 = *((_QWORD *)this + 5);
  if ( v4 )
  {
  ...
  ATL::CAtlList<ATL::CAutoPtr<WorkItemBase>,ATL::CAutoPtrElementTraits<WorkItemBase>>::RemoveAll((__int64 *)this + 16);
}
