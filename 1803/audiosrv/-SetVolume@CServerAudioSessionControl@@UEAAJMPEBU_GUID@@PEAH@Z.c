/*
 * XREFs of ?SetVolume@CServerAudioSessionControl@@UEAAJMPEBU_GUID@@PEAH@Z @ 0x1800AF7C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_SSg @ 0x1800B0BF8 (WPP_SF_SSg.c)
 */
        ...
        int *a4)
{
  ...
  if ( ValidateAudioLevel(a2) )
    return (*(__int64 (__fastcall **)(_QWORD, __int64, const struct _GUID *, int *))(**((_QWORD **)this + 9) + 320LL))(
             *((_QWORD *)this + 9),
             v8,
             a3,
             a4);
