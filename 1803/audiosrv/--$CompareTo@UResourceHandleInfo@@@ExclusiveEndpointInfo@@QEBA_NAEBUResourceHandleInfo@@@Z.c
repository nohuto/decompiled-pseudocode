/*
 * XREFs of ??$CompareTo@UResourceHandleInfo@@@ExclusiveEndpointInfo@@QEBA_NAEBUResourceHandleInfo@@@Z @ 0x1800D7F64
 * Callers:
 ...
 * Callees:
 *     ?SimpleWildcardStringCompare@@YAHQEBG_K01@Z @ 0x1800DAA90 (-SimpleWildcardStringCompare@@YAHQEBG_K01@Z.c)
 */
