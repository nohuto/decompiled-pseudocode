/*
 * XREFs of ?ProcessAwayModeStateChange@CAudioSrv@@AEAAKE@Z @ 0x18009D584
 * Callers:
...
__int64 __fastcall CAudioSrv::ProcessAwayModeStateChange(CAudioSrv *this, unsigned __int8 a2)
{
      ...
      for ( i = 0; i < v19; ++i )
      {
        ...
        if ( (*(int (__fastcall **)(_QWORD, _QWORD, __int64 *))(*(_QWORD *)v15[0] + 32LL))(v15[0], i, &v21) >= 0 )
        {
          ...
          else
          {
            ...
            {
              WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 35LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids, pv);
            }
            CoTaskMemFree(pv);
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 34LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids, v5);
LABEL_47:
    v4 = v15[0];
  }
LABEL_48:
