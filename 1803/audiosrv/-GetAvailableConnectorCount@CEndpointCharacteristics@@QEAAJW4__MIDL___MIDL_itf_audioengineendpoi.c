/*
 * XREFs of ?GetAvailableConnectorCount@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAI@Z @ 0x1800EAF14
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  *((_QWORD *)&v19 + 1) = 0xFC181731B718BA83uLL;
  ...
  p_pvar = &pvar;
  v18 = 1;
  v6 = (*(__int64 (__fastcall **)(_QWORD, __int128 *, PROPVARIANT *))(**((_QWORD **)this + 4) + 40LL))(
         *((_QWORD *)this + 4),
         &v21,
         &pvar);
  v7 = v6;
...
LABEL_12:
  ...
  if ( (_WORD)pvar == 19 )
  {
    ...
    *((_QWORD *)&v19 + 1) = 0x67257A6871B668BCLL;
    ...
    v6 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, unsigned int *))(**(_QWORD **)v15 + 24LL))(
           *(_QWORD *)v15,
           v13,
           v10,
           a3);
