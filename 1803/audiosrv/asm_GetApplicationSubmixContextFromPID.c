/*
 * XREFs of asm_GetApplicationSubmixContextFromPID @ 0x1800D7AE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall asm_GetApplicationSubmixContextFromPID(__int64 a1, unsigned int a2, _QWORD *a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v5[1], v6, (struct _TP_TIMER *)L"asm_GetApplicationSubmixContextFromPID");
  v14 = 0LL;
  ...
  {
    *(_QWORD *)v11 = 0LL;
    v7 = (*(__int64 (__fastcall **)(CProcessSubmixManager *, _QWORD, __int64, __int64, int *))(*(_QWORD *)g_ProcessSubmixManager
                                                                                             + 24LL))(
