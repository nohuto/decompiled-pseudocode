/*
 * XREFs of ?GetChannelVolumeLevel@CVolumeControlBase@@UEAAJIPEAM@Z @ 0x1800A1F10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVolumeControlBase::GetChannelVolumeLevel(CVolumeControlBase *this, unsigned int a2, float *a3)
{
  ...
  if ( (unsigned int)v3 >= *((_DWORD *)this + 31) )
  {
    v6 = -2147024809;
LABEL_5:
    AudSrvTraceLoggingErrorHelper("CVolumeControlBase::GetChannelVolumeLevel", 515, v6);
    goto LABEL_9;
  }
  if ( !a3 )
  {
  ...
  *a3 = CVolumeUnit::GetDB((CVolumeUnit *)(*((_QWORD *)this + 11) + 56 * v3));
  v6 = 0;
LABEL_9:
  if ( v9 )
