/*
 * XREFs of ?GetPhoneCallResourceConsumption@CConstraintModel@@QEAAJW4ConsumerState@@PEAKPEAPEAU_ResourceInfo@@@Z @ 0x180113C80
 * Callers:
        ...
        struct _ResourceInfo **a4)
{
  ...
  *a3 = 0;
  v6 = 0;
  v5 = &KeywordDetectorResourceConsumer::`vftable';
  v7 = a2;
