/*
 * XREFs of ?GetNode@?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@AEBAPEAVCNode@12@AEBQEAVResourceConsumer@@AEAI1AEAPEAV312@@Z @ 0x180098FBC
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  v7 = *(_DWORD *)(*a2 + 8LL);
  if ( v7 == 1 )
    v7 = (*(_DWORD *)(*a2 + 940LL) << 16) | (4 * *(_DWORD *)(*a2 + 960LL)) | 1;
  *a4 = v7;
  *a3 = v7 % *(_DWORD *)(a1 + 16);
  if ( *(_QWORD *)a1 )
  {
    v8 = 0LL;
    *a5 = 0LL;
    for ( i = *(__int64 **)(*(_QWORD *)a1 + 8LL * *a3); ; i = (__int64 *)i[2] )
    {
      if ( !i )
        return 0LL;
      if ( *((_DWORD *)i + 6) == *a4 )
...
LABEL_15:
    ...
    else if ( !v11 && !*(_DWORD *)(*a2 + 8LL) )
    {
      v12 = *(_DWORD *)(v10 + 16) == *(_DWORD *)(*a2 + 16LL);
LABEL_14:
      if ( v12 )
      {
LABEL_18:
