/*
 * XREFs of _CAudioSession::ParseStreamSwitchId_::_1_::dtor$2 @ 0x1800AC23A
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioSession::ParseStreamSwitchId_::_1_::dtor_2(__int64 a1, __int64 a2)
{
