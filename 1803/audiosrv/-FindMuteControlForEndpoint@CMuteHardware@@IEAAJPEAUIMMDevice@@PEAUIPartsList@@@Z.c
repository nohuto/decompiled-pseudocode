/*
 * XREFs of ?FindMuteControlForEndpoint@CMuteHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18004AF30
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_40bfd4cf2cfa346b35fe64d0f0db2afc_Traceguids, this);
    v6 = v17;
  }
  if ( a2 )
  {
      ...
      if ( v7 >= 0 )
      {
        ...
        if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control )
        {
          ...
          if ( v8 != (CAudioSessionManager *)&WPP_GLOBAL_Control
            ...
            && *((_BYTE *)v8 + 25) >= 4u )
          {
            WPP_SF_q(*((_QWORD *)v8 + 2), 16LL, &WPP_40bfd4cf2cfa346b35fe64d0f0db2afc_Traceguids, this);
          }
        }
        v9 = v17;
        if ( v17 != a2 )
          ...
          if ( v11 >= 0 )
          {
              ...
              && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
            {
              WPP_SF_q(
                *((_QWORD *)WPP_GLOBAL_Control + 2),
                17LL,
                &WPP_40bfd4cf2cfa346b35fe64d0f0db2afc_Traceguids,
                this);
            }
