/*
 * XREFs of ??$LogAecEffectPolicy@$07@@YAXAEBU_AEC_POLICY_RESULTS@@PEBGU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x1800EFC34
 * Callers:
...
void __fastcall LogAecEffectPolicy<8>(__int64 a1, const WCHAR *a2)
{
  ...
  if ( (unsigned int)hProvider > 4 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 8uLL) )
    {
      ...
      v42 = 4LL;
      v44 = 4LL;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18014774F, v6, v7, 0x13u, &pData);
    }
  }
}
