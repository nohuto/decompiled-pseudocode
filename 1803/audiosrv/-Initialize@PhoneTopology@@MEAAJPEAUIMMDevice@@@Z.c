/*
 * XREFs of ?Initialize@PhoneTopology@@MEAAJPEAUIMMDevice@@@Z @ 0x180057240
 * Callers:
...
LABEL_3:
      ...
      *((_QWORD *)pv + 5) = ThreadpoolWait;
      if ( ThreadpoolWait )
      {
        SetThreadpoolWait(ThreadpoolWait, *((HANDLE *)pv + 6), 0LL);
              ...
              if ( Instance >= 0 )
              {
                ...
                if ( Instance >= 0 )
                {
                  ...
                  if ( Instance >= 0 )
                  {
                    ...
                    {
                      Instance = TelephonyController::CreateInstance((struct ITelephonyController **)pv + 4);
                      if ( Instance >= 0 )
                      {
                        v10 = (*(__int64 (__fastcall **)(_QWORD, char *))(**((_QWORD **)pv + 4) + 56LL))(
                                *((_QWORD *)pv + 4),
                                pv + 264);
                        Instance = 0;
                        if ( v10 < 0 )
