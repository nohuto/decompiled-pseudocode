/*
 * XREFs of ?DeriveMixFormatFromDevicePipeFormat@@YAJPEAVCEndpointCharacteristics@@U_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAUIAudioMediaType@@PEAPEAU4@4@Z @ 0x1800BAB48
 * Callers:
        ...
        struct IAudioMediaType **a6)
{
  ...
  {
LABEL_64:
    AudSrvTraceLoggingErrorHelper("DeriveMixFormatFromDevicePipeFormat", 1360, ModeEffect);
    goto LABEL_65;
  }
  v13 = v27;
  if ( v27 )
