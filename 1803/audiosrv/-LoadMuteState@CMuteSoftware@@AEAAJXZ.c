/*
 * XREFs of ?LoadMuteState@CMuteSoftware@@AEAAJXZ @ 0x1800A0F60
 * Callers:
 *     ?GetLevelData@CMuteSoftware@@MEAAJXZ @ 0x1800A0D20 (-GetLevelData@CMuteSoftware@@MEAAJXZ.c)
 * Callees:
 *     ?AudSrvTraceLoggingErrorHelper@@YAXPEBDIJ@Z @ 0x18004A8B0 (-AudSrvTraceLoggingErrorHelper@@YAXPEBDIJ@Z.c)
 *     _guard_dispatch_icall_nop @ 0x1800657D0 (_guard_dispatch_icall_nop.c)
 *     WPP_SF_S @ 0x18009ECE8 (WPP_SF_S.c)
 *     WPP_SF_Sl @ 0x1800A1AB8 (WPP_SF_Sl.c)
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_S(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0x15u,
          (__int64)&WPP_40bfd4cf2cfa346b35fe64d0f0db2afc_Traceguids,
