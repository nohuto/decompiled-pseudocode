/*
 * XREFs of ?VAD_AudiosrvServiceStop@CAudioSrv@@AEAAJXZ @ 0x18009E964
 * Callers:
...
__int64 __fastcall CAudioSrv::VAD_AudiosrvServiceStop(CAudioSrv *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 39LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids);
    v2 = WPP_GLOBAL_Control;
  }
  if ( *((_DWORD *)this + 25) )
  {
    if ( v2 != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)v2 + 25) >= 4u )
    {
      WPP_SF_(*((_QWORD *)v2 + 2), 40LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids);
    }
    v3 = RpcServerUnregisterIfEx(&unk_180120950, 0LL, 1);
    if ( v3
      && WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      && (*((_BYTE *)WPP_GLOBAL_Control + 28) & 4) != 0
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 41LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids, v3);
    }
    *((_DWORD *)this + 25) = 0;
  }
  if ( g_DuckingManager )
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 42LL, &WPP_50e5db73954a39d05dfaedbce4ea5db2_Traceguids, 0LL);
  }
  return 0LL;
}
