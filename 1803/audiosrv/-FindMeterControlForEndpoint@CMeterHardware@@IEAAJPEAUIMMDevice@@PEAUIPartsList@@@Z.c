/*
 * XREFs of ?FindMeterControlForEndpoint@CMeterHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18004AC10
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_00df95541f0e32c0c29587cc00cae0f9_Traceguids, this);
    v6 = v17;
  }
  if ( a2 )
  {
      ...
      if ( v7 >= 0 )
      {
        ...
        if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control )
        {
          if ( (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x10000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
          {
            WPP_SF_qS(
              *((_QWORD *)WPP_GLOBAL_Control + 2),
              14,
              (unsigned int)&WPP_00df95541f0e32c0c29587cc00cae0f9_Traceguids,
              (_DWORD)this,
              (__int64)pv);
            v8 = WPP_GLOBAL_Control;
          }
          if ( v8 != (CAudioSessionManager *)&WPP_GLOBAL_Control
            ...
            && *((_BYTE *)v8 + 25) >= 4u )
          {
            WPP_SF_q(*((_QWORD *)v8 + 2), 15LL, &WPP_00df95541f0e32c0c29587cc00cae0f9_Traceguids, this);
          }
        }
        v9 = v17;
        if ( v17 != a2 )
          ...
          if ( v11 >= 0 )
          {
              ...
              && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
            {
              WPP_SF_q(
                *((_QWORD *)WPP_GLOBAL_Control + 2),
                16LL,
                &WPP_00df95541f0e32c0c29587cc00cae0f9_Traceguids,
                this);
            }
