/*
 * XREFs of s_setEmergencyCallbackMode @ 0x1800DDAC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_setEmergencyCallbackMode(__int64 a1, unsigned int a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v3[1], v4, (struct _TP_TIMER *)L"s_setEmergencyCallbackMode");
  v5 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, _QWORD))(*(_QWORD *)g_PolicyManager + 352LL))(
         g_PolicyManager,
         a2);
  v6 = v5;
  if ( v5 >= 0 )
