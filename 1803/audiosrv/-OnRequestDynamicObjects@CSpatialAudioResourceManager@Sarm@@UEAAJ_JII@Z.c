/*
 * XREFs of ?OnRequestDynamicObjects@CSpatialAudioResourceManager@Sarm@@UEAAJ_JII@Z @ 0x1800F38E0
 * Callers:
 ...
 *     ?WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ @ 0x1800F5014 (-WaitForWorkToComplete@CWorkFifo@@QEAA_NXZ.c)
