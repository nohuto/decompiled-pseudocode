/*
 * XREFs of ?LogStreamIdentifierExpired@CSpatialAudioResourceManagerTraceLogger@@QEAAXI_J@Z @ 0x1800F5E7C
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_180188330 > 4 )
  {
    ...
    v10 = 0;
    v9 = 8;
    TlgWrite((TraceLoggingHProvider)&dword_180188330, &unk_180147A8D, a3, a4, 4u, &v4);
  }
}
