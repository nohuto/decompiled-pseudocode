/*
 * XREFs of std::for_each_std::_Vector_iterator_std::_Vector_val_std::_Simple_types_Microsoft::WRL::ComPtr_IStreamGroupProxy_________lambda_ff03322a3f89e5994eee42624e4a348b___ @ 0x1800CF364
 * Callers:
        ...
        char a4)
{
  ...
  for ( i = a2; i != a3; ++i )
  {
    ...
    v11 = a4;
    v12 = &v10;
    (*(void (__fastcall **)(__int64, __int64 (__fastcall ***)()))(*(_QWORD *)v8 + 368LL))(v8, &v10);
  }
  *a1 = a4;
  return a1;
}
