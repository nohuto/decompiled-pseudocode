/*
 * XREFs of ?ReacquirePhoneCallResource@TelephonyControllerCallInstance@@UEAAJH@Z @ 0x18011C8B0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a2)
{
  ...
  v2 = 0;
  v3 = (char *)this + 32;
  if ( *((_QWORD *)this + 4) && a2 != *((_DWORD *)this + 15) )
  {
    wil::details::unique_storage<wil::details::resource_policy<unsigned __int64,void (*)(unsigned __int64),&void ReleaseAudioResourceHandle(unsigned __int64),wistd::integral_constant<unsigned __int64,0>,unsigned __int64,0,std::nullptr_t>>::reset(
      ...
      0LL);
    LOBYTE(v6) = a2 != 0;
    v7 = (*(__int64 (__fastcall **)(CAudioResourceManager *, __int64, char *))(*(_QWORD *)g_AudioResourceManager + 56LL))(
