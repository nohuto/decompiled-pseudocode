/*
 * XREFs of CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_1a1596b8a660531830807c55faa94ced___ @ 0x180063A9C
 * Callers:
...
__int64 __fastcall CEndpointCharacteristics::CloneDriverFormatIfMatching__lambda_1a1596b8a660531830807c55faa94ced___(
        __int64 a1,
        __int64 a2,
        unsigned int *a3,
    ...
    if ( v7 <= 0x28 )
    {
      ...
      if ( _bittest64(&v8, v7) )
      {
        ...
        if ( v7 >= (unsigned __int64)v9->cbSize + 18
          && (unsigned __int8)lambda_1a1596b8a660531830807c55faa94ced_::operator()(a2, v9) )
        {
