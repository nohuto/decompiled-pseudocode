/*
 * XREFs of _CDeviceGraphStore::GetSubmixesForPID_::_1_::catch$22 @ 0x1800CDB3D
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall CDeviceGraphStore::GetSubmixesForPID_::_1_::catch_22(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
