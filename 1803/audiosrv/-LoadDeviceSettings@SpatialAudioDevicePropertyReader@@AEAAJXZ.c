/*
 * XREFs of ?LoadDeviceSettings@SpatialAudioDevicePropertyReader@@AEAAJXZ @ 0x18004C854
 * Callers:
...
__int64 __fastcall SpatialAudioDevicePropertyReader::LoadDeviceSettings(SpatialAudioDevicePropertyReader *this)
{
  ...
  if ( v24 < 0 )
  {
    if ( (unsigned int)dword_1801883B0 > 2 )
    {
      ...
      v35 = &v24;
      v36 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_1801494A8, v3, v4, 5u, &pData);
    }
  }
  else
  {
            ...
            while ( 1 )
            {
              ...
              if ( (_WORD)pvar != 65 )
              {
                ...
                if ( (unsigned int)dword_1801883B0 > 2 )
                {
                  ...
                  v35 = &v23;
                  v36 = 4LL;
                  TlgWrite((TraceLoggingHProvider)&dword_1801883B0, &unk_18014946E, v16, v17, 5u, &pData);
                }
                goto LABEL_18;
              }
              v18 = 6LL;
