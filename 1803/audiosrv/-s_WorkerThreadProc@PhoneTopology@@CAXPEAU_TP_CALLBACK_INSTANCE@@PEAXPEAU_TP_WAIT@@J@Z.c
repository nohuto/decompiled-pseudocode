/*
 * XREFs of ?s_WorkerThreadProc@PhoneTopology@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WAIT@@J@Z @ 0x18011A0A0
 * Callers:
 *     <none>
 * Callees:
        ...
        TP_WAIT_RESULT WaitResult)
{
  ...
  if ( Context )
  {
    ...
    ATL::CComCritSecLock<ATL::CComAutoCriticalSection>::CComCritSecLock<ATL::CComAutoCriticalSection>(
      ...
      (struct _RTL_CRITICAL_SECTION *)(Context + 56));
    if ( !*((_DWORD *)Context + 46) )
      SetThreadpoolWait(Wait, *((HANDLE *)Context + 6), 0LL);
    if ( v8 )
