        ...
        unsigned __int64 *Block)
{
  ...
  try
  {
    ...
    {
      v18 = Block;
      std::wstring::_Tidy_deallocate(Block + 13);
      std::wstring::_Tidy_deallocate(v18 + 8);
