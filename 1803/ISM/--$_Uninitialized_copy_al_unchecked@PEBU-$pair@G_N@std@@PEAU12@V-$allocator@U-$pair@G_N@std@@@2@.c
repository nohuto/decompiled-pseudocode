/*
 * XREFs of ??$_Uninitialized_copy_al_unchecked@PEBU?$pair@G_N@std@@PEAU12@V?$allocator@U?$pair@G_N@std@@@2@@std@@YAPEAU?$pair@G_N@0@PEBU10@0PEAU10@AEAV?$allocator@U?$pair@G_N@std@@@0@U_General_ptr_iterator_tag@0@U_Unused_parameter@0@@Z @ 0x180036800
 * Callers:
...
_DWORD *__fastcall std::_Uninitialized_copy_al_unchecked<std::pair<unsigned short,bool> const *,std::pair<unsigned short,bool> *,std::allocator<std::pair<unsigned short,bool>>>(
        unsigned __int64 a1,
        unsigned __int64 a2,
        _DWORD *a3)
{
