/*
 * XREFs of ?OnDragManagerClientChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000E110
 * Callers:
 *     <none>
 * Callees:
        ...
        const char *a4)
{
  ...
  while ( v7 != v8 )
  {
    ...
    if ( v7 == -8
      ...
      || (unsigned int)__std_type_info_compare((*(_QWORD *)(v7 + 64) & 0xFFFFFFFFFFFFFFFCuLL) + 8, &qword_1801348A8) )
    {
      v10 = 0LL;
    }
    if ( v9 == this && v10 )
  ...
  v11 = (void (__fastcall ***)(_QWORD))(*(__int64 (__fastcall **)(char *))(*((_QWORD *)this + 1) + 48LL))((char *)this + 8);
  v12 = v11;
  if ( v11 )
    (**v11)(v11);
  if ( v12 )
  {
    ...
    (**v12)(v12);
    v18 = off_1800EB408;
    v19 = (char *)&Microsoft::WRL::ComPtr<BamoDragManagerClientProxy> `RTTI Type Descriptor' + 2;
