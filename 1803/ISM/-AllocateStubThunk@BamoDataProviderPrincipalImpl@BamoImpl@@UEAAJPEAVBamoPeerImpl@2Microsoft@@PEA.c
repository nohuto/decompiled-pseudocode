/*
 * XREFs of ?AllocateStubThunk@BamoDataProviderPrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x18008D990
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoDataProviderPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
  ...
  v7 = (*(__int64 (__fastcall **)(__int64, _QWORD, struct Microsoft::Bamo::BamoStub **))(*(_QWORD *)v6 + 48LL))(
         v6,
         *((_QWORD *)a2 + 2),
         &v12);
  if ( v7 < 0 )
