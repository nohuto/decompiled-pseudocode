/*
 * XREFs of ?RecomputeOrientationBiasPixels@DragRecognizer@@AEAAXXZ @ 0x1800DD988
 * Callers:
 *     ?SetConfigValue@DragRecognizer@@UEAA_NPEBUGestureRecognizerConfigValue@@@Z @ 0x1800DD8B0 (-SetConfigValue@DragRecognizer@@UEAA_NPEBUGestureRecognizerConfigValue@@@Z.c)
 *     ?ResetConfigValues@DragRecognizer@@UEAAXXZ @ 0x1800DD940 (-ResetConfigValues@DragRecognizer@@UEAAXXZ.c)
 * Callees:
 *     _o_tan_0 @ 0x1800E1AE6 (_o_tan_0.c)
 */
