/*
 * XREFs of ?Thunk_UpdateEnabled_8@?$IControllerNavigationManagerProxy_Receive@VBamoControllerNavigationManagerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180020350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IControllerNavigationManagerProxy_Receive<BamoImpl::BamoControllerNavigationManagerProxyImpl>::Thunk_UpdateEnabled_8(
        __int64 a1,
        _BYTE **a2)
{
  __int64 v3; // rdi
