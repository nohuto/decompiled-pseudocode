        ...
        unsigned __int64 *Block)
{
  ...
  try
  {
    ...
    if ( (unsigned __int64)v14[7] >= 8 )
      v17 = (_QWORD *)*v17;
    if ( (int)_o__wcsicmp(v17, a4) >= 0 )
    {
      v18 = Block;
      std::wstring::_Tidy_deallocate(Block + 8);
      std::wstring::_Tidy_deallocate(v18 + 4);
      operator delete(v18);
      *(_QWORD *)a2 = v14;
      *(_BYTE *)(a2 + 8) = 0;
    }
