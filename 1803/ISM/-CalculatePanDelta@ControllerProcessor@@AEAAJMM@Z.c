/*
 * XREFs of ?CalculatePanDelta@ControllerProcessor@@AEAAJMM@Z @ 0x1800345B0
 * Callers:
...
__int64 __fastcall ControllerProcessor::CalculatePanDelta(ControllerProcessor *this, float a2, float a3)
{
  ...
  if ( v6 > 0.00000011920929 || (float)COERCE_DOUBLE(COERCE_UNSIGNED_INT64(a2) & _xmm) > 0.00000011920929 )
  {
    ...
    if ( v8 == 0.0
      ...
      || *(float *)&dword_180136488 >= v10
      || v10 >= (float)(1.0 / *(float *)&dword_180136488) )
    {
    ...
    v12 = v9 + *((float *)this + 508);
    *((float *)this + 507) = v8 + *((float *)this + 507);
    *((float *)this + 508) = v12;
  }
  return 0LL;
}
