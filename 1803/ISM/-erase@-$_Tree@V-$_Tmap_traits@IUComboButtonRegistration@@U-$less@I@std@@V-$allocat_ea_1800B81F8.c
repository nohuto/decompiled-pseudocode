...
unsigned __int64 **__fastcall std::_Tree<std::_Tmap_traits<unsigned int,ComboButtonRegistration,std::less<unsigned int>,std::allocator<std::pair<unsigned int const,ComboButtonRegistration>>,0>>::erase(
        unsigned __int64 ***a1,
        unsigned __int64 **a2,
        unsigned __int64 *a3)
{
...
LABEL_80:
  ...
  *((_BYTE *)v10 + 24) = 1;
LABEL_113:
  std::vector<enum _Button>::_Tidy(a3 + 6);
  operator delete(a3);
  v37 = a1[1];
  if ( v37 )
