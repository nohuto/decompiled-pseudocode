/*
 * XREFs of _std::_Tree_comp_alloc_std::_Tmap_traits_unsigned_int_MPCProcessor::InputData_std::less_unsigned_int__std::allocator_std::pair_unsigned_int_const__MPCProcessor::InputData____0___::_Buyheadnode_::_1_::catch$9 @ 0x1800E5C84
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::_Tree_comp_alloc_std::_Tmap_traits_unsigned_int_MPCProcessor::InputData_std::less_unsigned_int__std::allocator_std::pair_unsigned_int_const__MPCProcessor::InputData____0___::_Buyheadnode_::_1_::catch_9(
        __int64 a1,
        __int64 a2)
{
