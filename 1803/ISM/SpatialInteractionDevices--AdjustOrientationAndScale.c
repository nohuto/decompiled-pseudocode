/*
 * XREFs of SpatialInteractionDevices::AdjustOrientationAndScale @ 0x18009F204
 * Callers:
...
char __fastcall SpatialInteractionDevices::AdjustOrientationAndScale(unsigned __int64 *a1)
{
  ...
  {
    v2 = (__m128)xmmword_1801357F0;
    if ( result )
    {
      v3 = _mm_add_ps((__m128)xmmword_1801357F0, (__m128)xmmword_1801357F0);
      v4 = _mm_movelh_ps((__m128)*a1, (__m128)*((unsigned int *)a1 + 2));
      v5 = _mm_mul_ps(v3, (__m128)xmmword_1801357F0);
      v6 = _mm_sub_ps(
             _mm_sub_ps(
      ...
      v7 = _mm_mul_ps(
             ...
             _mm_shuffle_ps((__m128)xmmword_1801357F0, (__m128)xmmword_1801357F0, 208));
      v8 = _mm_mul_ps(
             _mm_shuffle_ps(v3, v3, 201),
             _mm_shuffle_ps((__m128)xmmword_1801357F0, (__m128)xmmword_1801357F0, 255));
      v9 = _mm_add_ps(v8, v7);
