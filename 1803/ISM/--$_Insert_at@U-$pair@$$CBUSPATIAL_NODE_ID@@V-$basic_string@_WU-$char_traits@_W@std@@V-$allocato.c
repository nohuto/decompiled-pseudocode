    ...
    if ( v14 == (__int64 *)*v16 )
    {
      ...
      if ( v12 == v18 )
      {
        ...
        if ( !*(_BYTE *)(*(_QWORD *)v18 + 25LL) )
          *(_QWORD *)(*(_QWORD *)v18 + 8LL) = v14;
        *(_QWORD *)(v18 + 8) = *v15;
        if ( v14 == *(__int64 **)(*a1 + 8LL) )
        {
          *(_QWORD *)(*a1 + 8LL) = v18;
        }
        else
      ...
      *(_BYTE *)(v18 + 24) = 1;
      *(_BYTE *)(*(_QWORD *)(*(_QWORD *)v13 + 8LL) + 24LL) = 0;
      v20 = *(_QWORD **)(*(_QWORD *)v13 + 8LL);
      v21 = (_QWORD *)*v20;
      *v20 = *(_QWORD *)(*v20 + 16LL);
      v22 = v21[2];
      if ( !*(_BYTE *)(v22 + 25) )
