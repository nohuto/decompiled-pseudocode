/*
 * XREFs of ?EnableNavigation@ControllerNavigationManager@@AEAAXPEAVBamoControllerNavigationClientProxy@@@Z @ 0x18002F1D4
 * Callers:
        ...
        struct BamoControllerNavigationClientProxy *a2)
{
  ...
  for ( i = (_QWORD *)*v7; i != v7; i = (_QWORD *)*i )
  {
    ...
    v11 = v5;
    ControllerProcessor::NavigationEnable(v10, v4, &v11, v8, 1, 1);
  }
}
