/*
 * XREFs of ?MPCHolographicInputManager_DisplayContextChanged_@ISMTracing@@QEAAXAEB_N@Z @ 0x180051808
 * Callers:
  ...
  if ( v3 )
  {
    if ( *v3 )
    {
      ...
      if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 1) != 0 && (*(_QWORD *)(v4 + 24) & 1LL) == *(_QWORD *)(v4 + 24) )
      {
        ...
        v6 = a2;
        v7 = 1;
        TlgWrite((TraceLoggingHProvider)v4, &unk_18010E1E3, 0LL, 0LL, 3u, &pData);
      }
    }
  }
}
