/*
 * XREFs of ?MPCSixDofProcessor_HomeEventTuneablesChanged_@ISMTracing@@QEAAXMMMMMMMMMMMMMMMMMMMK@Z @ 0x18004426C
 * Callers:
        ...
        char a21)
{
    ...
    && (*((_QWORD *)v21 + 3) & 0x400000000001LL) == *((_QWORD *)v21 + 3) )
  {
    ...
    v60 = 4LL;
    v62 = 4LL;
    TlgWrite(v21, &unk_18010D4A9, 0LL, 0LL, 0x16u, &pData);
  }
}
