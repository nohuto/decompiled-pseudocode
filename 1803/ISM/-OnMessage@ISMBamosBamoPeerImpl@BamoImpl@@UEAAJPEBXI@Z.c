/*
 * XREFs of ?OnMessage@ISMBamosBamoPeerImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x18001E4A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::ISMBamosBamoPeerImpl::OnMessage(
        ...
        int a3)
{
  ...
  result = CoreUICallReceive(
             *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 56LL),
             &IBamoPeer_ISMBamos_Receive<BamoImpl::ISMBamosBamoPeerImpl>::Type,
