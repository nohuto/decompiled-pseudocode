/*
 * XREFs of ?StartActivity@CloseHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x1800BC508
 * Callers:
        ...
        __int64 a4)
{
  ...
  *v8 = 1;
  ...
  if ( *(_DWORD *)v14 > 5u )
  {
    ...
    LODWORD(Local) = TlgWrite(v14, &unk_180111E37, (LPCGUID)(v18 + 8), v19, 6u, &pData);
  }
  if ( !*(_DWORD *)(a1 + 32) )
  {
