/*
 * XREFs of ?RequestForegroundChange@MPCHolographicInputManager@@QEAAX_KIKW4InputType@@PEAUHMONITOR__@@UtagPOINT@@_N@Z @ 0x180050574
 * Callers:
        ...
        bool a8)
{
  ...
  {
    ISMTracing::Instance();
    ISMTracing::MPCHolographicInputManager_RequestForegroundChange_(
      v16,
      (unsigned __int64)a2,
      v12,
      ViewIdFromWindowId,
      ...
      if ( (HWND)v12 != a2 )
      {
        ...
        if ( a8 )
        {
          if ( ViewIdFromWindowId )
          {
            ...
            LODWORD(v17) = SetInputFocus(ProcessIdFromViewId, ThreadIdFromViewId, ViewIdFromWindowId, a2, 0, 0, 0);
          }
        }
      }
    }
  ...
  else
  {
    ...
    LODWORD(v17) = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, __int64))(**(_QWORD **)(a1 + 1944)
                                                                                              + 88LL))(
                     *(_QWORD *)(a1 + 1944),
                     ViewIdFromWindowId,
                     v8,
