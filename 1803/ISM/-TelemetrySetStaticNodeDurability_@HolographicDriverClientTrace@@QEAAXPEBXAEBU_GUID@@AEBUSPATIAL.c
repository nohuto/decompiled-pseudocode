/*
 * XREFs of ?TelemetrySetStaticNodeDurability_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_STATIC_NODE_DURABILITY@@@Z @ 0x1800BD324
 * Callers:
        ...
        int a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*((_QWORD *)v8 + 2) & 0x200000000002LL) != 0 )
  {
    ...
    if ( v7 == *((struct HolographicDriverClientTrace **)v8 + 3) )
    {
      ...
      v17 = 16LL;
      v19 = 4LL;
      LODWORD(v7) = TlgWrite(v8, &unk_180111827, 0LL, 0LL, 6u, &pData);
    }
  }
  return (int)v7;
}
