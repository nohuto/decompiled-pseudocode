/*
 * XREFs of ?ReadHapticsEngineParameters@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAXPEA_N0@Z @ 0x1800D933C
 * Callers:
        ...
        bool *a3)
{
  ...
  *a2 = 0;
  *a3 = 0;
  v6 = (*(__int64 (__fastcall **)(_QWORD, unsigned __int16 *))(**((_QWORD **)this + 2) + 32LL))(
         *((_QWORD *)this + 2),
         &v14);
  if ( v6 >= 0 )
  {
    StringRawBuffer = (WCHAR *)WindowsGetStringRawBuffer(*((HSTRING *)this + 3), 0LL);
