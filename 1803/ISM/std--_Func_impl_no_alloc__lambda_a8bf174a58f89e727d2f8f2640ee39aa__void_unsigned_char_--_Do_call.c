/*
 * XREFs of std::_Func_impl_no_alloc__lambda_a8bf174a58f89e727d2f8f2640ee39aa__void_unsigned_char_::_Do_call @ 0x1800DAB90
 * Callers:
 *     <none>
 * Callees:
        ...
        char *a2)
{
  ...
  v3 = *a2;
  if ( !*(_BYTE *)(*(_QWORD *)(a1 + 8) + 100LL) )
  {
    v4 = SpatialInteractionDevices::SetHapticsWaveForm(
           (SpatialInteractionDevices *)(*(_QWORD *)(a1 + 8) + 448LL),
           (struct SpatialInteractionDevices::HID_HANDLE *)*(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 936LL),
           v3);
    v5 = *(_QWORD *)(a1 + 8);
    v6 = v4;
