/*
 * XREFs of ?GetInteractionObject@MPCExclusiveInputTarget@@UEBAIXZ @ 0x180087C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCExclusiveInputTarget::GetInteractionObject(MPCExclusiveInputTarget *this)
{
