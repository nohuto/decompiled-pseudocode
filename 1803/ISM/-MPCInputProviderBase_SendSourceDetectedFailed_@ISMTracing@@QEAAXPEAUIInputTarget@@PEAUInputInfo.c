/*
 * XREFs of ?MPCInputProviderBase_SendSourceDetectedFailed_@ISMTracing@@QEAAXPEAUIInputTarget@@PEAUInputInfo@@I@Z @ 0x18004A214
 * Callers:
        ...
        int a4)
{
  ...
  unsigned int v8; // [rsp+38h] [rbp-79h] BYREF
  int v9; // [rsp+3Ch] [rbp-75h] BYREF
  int v10; // [rsp+40h] [rbp-71h] BYREF
  struct IInputTarget *v11; // [rsp+48h] [rbp-69h] BYREF
  EVENT_DATA_DESCRIPTOR pData; // [rsp+58h] [rbp-59h] BYREF
  struct IInputTarget **v13; // [rsp+78h] [rbp-39h]
  int v14; // [rsp+80h] [rbp-31h]
  int v15; // [rsp+84h] [rbp-2Dh]
  unsigned int *v16; // [rsp+88h] [rbp-29h]
  ...
  if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
  {
    ...
    v29 = 4;
    v32 = 4;
    TlgWrite((TraceLoggingHProvider)v6, &unk_18010D969, 0LL, 0LL, 9u, &pData);
  }
}
