/*
 * XREFs of ?RemoveDataSource@BamoDataProviderStubImpl@BamoImpl@@QEAAJPEAVBamoDataSourcePrincipal@@@Z @ 0x18008DBE4
 * Callers:
        ...
        struct BamoDataSourcePrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 24) + 24LL) + 40LL) )
  {
    ...
    {
      v9 = *((_QWORD *)this + 3);
      v12[0] = *(unsigned int *)(v2 + 36);
      v12[1] = *(unsigned int *)(v9 + 24);
      v11 = 1;
      return CoreUICallSend(*(_QWORD *)(v8 + 48), v12, 2LL, 1LL, v11, &unk_1800FE145, (_DWORD)a2);
    }
    v4 = -2018375675;
