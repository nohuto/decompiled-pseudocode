...
__int64 **__fastcall std::_Tree<std::_Tmap_traits<unsigned long,std::shared_ptr<Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice>,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,std::shared_ptr<Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice>>>,0>>::erase(
        _QWORD *a1,
        __int64 **a2,
        __int64 *a3)
{
...
LABEL_80:
  ...
  if ( v37 )
  {
    ...
    {
      (**(void (__fastcall ***)(volatile signed __int32 *, __int64 *))v37)(v37, v11);
