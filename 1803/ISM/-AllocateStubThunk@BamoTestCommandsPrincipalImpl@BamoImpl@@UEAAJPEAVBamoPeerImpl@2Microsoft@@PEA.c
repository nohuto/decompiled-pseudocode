/*
 * XREFs of ?AllocateStubThunk@BamoTestCommandsPrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x1800928A0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoTestCommandsPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
