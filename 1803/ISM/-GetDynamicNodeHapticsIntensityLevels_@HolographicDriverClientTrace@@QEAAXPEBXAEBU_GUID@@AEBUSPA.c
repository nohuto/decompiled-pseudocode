/*
 * XREFs of ?GetDynamicNodeHapticsIntensityLevels_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@H@Z @ 0x1800BD160
 * Callers:
...
void __fastcall HolographicDriverClientTrace::GetDynamicNodeHapticsIntensityLevels_(
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 2) != 0 && (*(_QWORD *)(v7 + 24) & 2LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    v14 = 16LL;
    v16 = 4LL;
    TlgWrite((TraceLoggingHProvider)v7, &unk_180110ABC, 0LL, 0LL, 6u, &pData);
  }
}
