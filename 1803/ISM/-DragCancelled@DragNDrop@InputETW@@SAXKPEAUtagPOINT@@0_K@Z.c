/*
 * XREFs of ?DragCancelled@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@0_K@Z @ 0x180063598
 * Callers:
...
void __fastcall InputETW::DragNDrop::DragCancelled(
        unsigned int a1,
        struct tagPOINT *a2,
        struct tagPOINT *a3,
        __int64 a4)
  ...
  if ( v7 )
  {
    if ( *v7 > 1u )
    {
      ...
      if ( *(_DWORD *)v8 > 5u && (*(_BYTE *)(v8 + 16) & 1) != 0 && (*(_QWORD *)(v8 + 24) & 1LL) == *(_QWORD *)(v8 + 24) )
      {
        ...
        v28 = 8;
        v31 = 8;
        TlgWrite((TraceLoggingHProvider)v8, &unk_18010EBF7, 0LL, 0LL, 8u, &pData);
      }
    }
  }
}
