/*
 * XREFs of ?SetHapticsFeedback_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXJKKGEG@Z @ 0x1800D4144
 * Callers:
        ...
        char a7)
{
  ...
  if ( *(_DWORD *)v7 > 5u && (*(_BYTE *)(v7 + 16) & 2) != 0 && (*(_QWORD *)(v7 + 24) & 2LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    v18 = 1LL;
    v20 = 2LL;
    TlgWrite((TraceLoggingHProvider)v7, &unk_1801129F7, 0LL, 0LL, 8u, &pData);
  }
}
