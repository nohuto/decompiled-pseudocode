/*
 * XREFs of ?GetInputSink@MPCSharedWorldInputTarget@@UEBAPEAXXZ @ 0x180088FA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCSharedWorldInputTarget::GetInputSink(MPCSharedWorldInputTarget *this)
{
...
LABEL_7:
    ...
    JUMPOUT(0x18008904BLL);
  }
  v4 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 56LL))(v8);
  v5 = v8;
  if ( v8 )
  {
    v8 = 0LL;
