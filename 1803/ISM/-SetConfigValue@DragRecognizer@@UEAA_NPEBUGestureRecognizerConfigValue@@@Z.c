/*
 * XREFs of ?SetConfigValue@DragRecognizer@@UEAA_NPEBUGestureRecognizerConfigValue@@@Z @ 0x1800DD8B0
 * Callers:
 *     <none>
 * Callees:
 *     ?RecomputeOrientationBiasPixels@DragRecognizer@@AEAAXXZ @ 0x1800DD988 (-RecomputeOrientationBiasPixels@DragRecognizer@@AEAAXXZ.c)
 */
