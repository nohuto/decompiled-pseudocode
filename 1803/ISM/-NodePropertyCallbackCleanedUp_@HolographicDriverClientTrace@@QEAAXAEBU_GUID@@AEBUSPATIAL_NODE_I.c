/*
 * XREFs of ?NodePropertyCallbackCleanedUp_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@@Z @ 0x1800BDCB0
 * Callers:
        ...
        const struct SPATIAL_NODE_ID *a3)
{
  ...
  if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 2) != 0 && (*(_QWORD *)(v5 + 24) & 2LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v7 = a2;
    v10 = a3;
    TlgWrite((TraceLoggingHProvider)v5, &unk_180111212, 0LL, 0LL, 4u, &pData);
  }
}
