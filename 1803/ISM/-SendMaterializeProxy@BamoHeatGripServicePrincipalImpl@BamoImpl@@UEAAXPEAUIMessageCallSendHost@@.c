/*
 * XREFs of ?SendMaterializeProxy@BamoHeatGripServicePrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x180038C30
 * Callers:
 *     <none>
 * Callees:
