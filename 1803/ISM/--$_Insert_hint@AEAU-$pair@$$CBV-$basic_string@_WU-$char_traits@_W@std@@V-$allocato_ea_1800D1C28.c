        ...
        void *Block)
{
  ...
  {
    v32 = v6;
    v19 = std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<SPATIAL_NODE_ID const,Microsoft::WRL::WeakRef>>>>::operator--(&v32);
    v20 = a4;
    if ( a4[3] >= 8uLL )
      v20 = (_QWORD *)*a4;
    v21 = *v19 + 4;
  ...
  if ( !*((_BYTE *)v6 + 25) )
  {
    ...
    {
      for ( i = *(_QWORD *)v24; !*(_BYTE *)(i + 25); i = *(_QWORD *)i )
        v24 = i;
    }
    v25 = v24;
    v32 = (__int64 *)v24;
