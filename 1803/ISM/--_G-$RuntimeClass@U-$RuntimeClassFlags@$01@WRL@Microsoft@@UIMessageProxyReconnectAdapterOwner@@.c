/*
 * XREFs of ??_G?$RuntimeClass@U?$RuntimeClassFlags@$01@WRL@Microsoft@@UIMessageProxyReconnectAdapterOwner@@UIMessageListListener@@UIViewHierarchy@@@WRL@Microsoft@@UEAAPEAXI@Z @ 0x18002D030
 * Callers:
 *     <none>
 * Callees:
