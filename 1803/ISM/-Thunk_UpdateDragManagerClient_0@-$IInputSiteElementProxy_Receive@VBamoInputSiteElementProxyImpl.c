/*
 * XREFs of ?Thunk_UpdateDragManagerClient_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000EA80
 * Callers:
 *     <none>
 * Callees:
