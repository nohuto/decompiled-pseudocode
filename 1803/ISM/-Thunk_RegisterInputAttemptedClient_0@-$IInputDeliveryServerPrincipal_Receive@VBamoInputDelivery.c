/*
 * XREFs of ?Thunk_RegisterInputAttemptedClient_0@?$IInputDeliveryServerPrincipal_Receive@VBamoInputDeliveryServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180023B60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int **a2)
{
  ...
  v13 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)(a1 - 16) + 72LL))(
          a1 - 16,
          v6,
          (v9 - 16) & -(__int64)(v9 != 0));
  v15 = retaddr;
