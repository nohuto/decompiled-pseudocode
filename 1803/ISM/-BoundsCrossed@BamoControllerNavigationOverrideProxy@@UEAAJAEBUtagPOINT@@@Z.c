/*
 * XREFs of ?BoundsCrossed@BamoControllerNavigationOverrideProxy@@UEAAJAEBUtagPOINT@@@Z @ 0x1800310A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  v14[1] = v17;
  v12 = 0;
  v6 = CoreUICallSend(v13, v14, 2LL, 7LL, v12, &unk_1800F966B, (unsigned int)&v18);
LABEL_9:
  if ( v4 )
  {
