/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerProxy@@UEAAJPEAVBamoControllerNavigationOverridePrincipal@@@Z @ 0x18001C5A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( a2 )
  {
    v9 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoControllerNavigationOverridePrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
