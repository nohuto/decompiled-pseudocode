/*
 * XREFs of _std::vector_Microsoft::WRL::ComPtr_BamoInputAttemptedDeliveryClientProxy__std::allocator_Microsoft::WRL::ComPtr_BamoInputAttemptedDeliveryClientProxy_____::emplace_back_Microsoft::WRL::ComPtr_BamoInputAttemptedDeliveryClientProxy__const_&___ptr64__::_1_::catch$103 @ 0x1800E4544
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::vector_Microsoft::WRL::ComPtr_BamoInputAttemptedDeliveryClientProxy__std::allocator_Microsoft::WRL::ComPtr_BamoInputAttemptedDeliveryClientProxy_____::emplace_back_Microsoft::WRL::ComPtr_BamoInputAttemptedDeliveryClientProxy__const_____ptr64__::_1_::catch_103(
        __int64 a1,
        _QWORD *a2)
{
