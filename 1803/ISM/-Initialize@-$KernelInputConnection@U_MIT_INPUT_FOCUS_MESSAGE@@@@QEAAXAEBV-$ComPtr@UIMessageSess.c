/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_INPUT_FOCUS_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_INPUT_FOCUS_MESSAGE@@@Z@std@@@Z @ 0x1800811BC
 * Callers:
        ...
        __int64 a4)
{
  ...
  result = MITCoreMsgKOpenConnectionTo(3LL, a1 + 3);
  if ( (int)result < 0 )
  {
