/*
 * XREFs of wil::details::_dynamic_atexit_destructor_for__g_enabledStateManager__ @ 0x1800EAB10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??_GEnabledStateManager@details@wil@@QEAAPEAXI@Z @ 0x180015F84 (--_GEnabledStateManager@details@wil@@QEAAPEAXI@Z.c)
