/*
 * XREFs of ?LogRawInputDeviceAttached@RawInputProvidersTelemetry@@SAXIGGG@Z @ 0x180074B34
 * Callers:
...
void __fastcall RawInputProvidersTelemetry::LogRawInputDeviceAttached(
        unsigned int a1,
        __int16 a2,
        __int16 a3,
        __int16 a4)
{
    ...
    && (*((_QWORD *)v5 + 3) & 0x400000000000LL) == *((_QWORD *)v5 + 3) )
  {
    ...
    v13 = 2LL;
    v15 = 2LL;
    TlgWrite(v5, &unk_18010F4B5, 0LL, 0LL, 6u, &pData);
  }
}
