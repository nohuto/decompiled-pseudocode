/*
 * XREFs of ?Thunk_StartDrag_55@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062B60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDragNDropContextualProcessorPrincipal_Receive<BamoImpl::BamoDragNDropContextualProcessorPrincipalImpl>::Thunk_StartDrag_55(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // ebp
  ...
  v14 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, int *, __int64))(*(_QWORD *)(a1 - 16) + 72LL))(
          a1 - 16,
          v7,
          v5,
          v4,
