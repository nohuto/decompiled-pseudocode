/*
 * XREFs of ?Thunk_UpdateDragSourceClient_0@?$IInputSiteElementProxy_Receive@VBamoInputSiteElementProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18000EC10
 * Callers:
 *     <none>
 * Callees:
