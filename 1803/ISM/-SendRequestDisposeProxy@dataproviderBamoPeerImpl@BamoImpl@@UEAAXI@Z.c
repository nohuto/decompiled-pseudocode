/*
 * XREFs of ?SendRequestDisposeProxy@dataproviderBamoPeerImpl@BamoImpl@@UEAAXI@Z @ 0x18008ECC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dataproviderBamoPeerImpl::SendRequestDisposeProxy(
