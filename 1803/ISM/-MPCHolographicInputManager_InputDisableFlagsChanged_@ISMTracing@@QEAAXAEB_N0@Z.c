/*
 * XREFs of ?MPCHolographicInputManager_InputDisableFlagsChanged_@ISMTracing@@QEAAXAEB_N0@Z @ 0x18005174C
 * Callers:
  ...
  if ( v5 )
  {
    if ( *v5 )
    {
      ...
      if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
      {
        ...
        v11 = a3;
        v12 = 1;
        TlgWrite((TraceLoggingHProvider)v6, &unk_18010E239, 0LL, 0LL, 4u, &pData);
      }
    }
  }
}
