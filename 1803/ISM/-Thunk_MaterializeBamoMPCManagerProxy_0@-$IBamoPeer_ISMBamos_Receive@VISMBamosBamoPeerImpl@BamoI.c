/*
 * XREFs of ?Thunk_MaterializeBamoMPCManagerProxy_0@?$IBamoPeer_ISMBamos_Receive@VISMBamosBamoPeerImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001FC70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IBamoPeer_ISMBamos_Receive<BamoImpl::ISMBamosBamoPeerImpl>::Thunk_MaterializeBamoMPCManagerProxy_0(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // ebp
  ...
  *(_QWORD *)v7 = &BamoMPCManagerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v7 + 1) = &BamoMPCManagerProxy::`vftable'{for `IMPCManagerProxy'};
  *((_DWORD *)v7 + 6) = 0;
  *((_QWORD *)v7 + 4) = 0LL;
  *((_DWORD *)v7 + 10) = 0;
  *((_WORD *)v7 + 22) = 0;
