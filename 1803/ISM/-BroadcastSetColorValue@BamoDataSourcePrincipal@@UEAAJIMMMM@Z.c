/*
 * XREFs of ?BroadcastSetColorValue@BamoDataSourcePrincipal@@UEAAJIMMMM@Z @ 0x18008C920
 * Callers:
 *     <none>
 * Callees:
        ...
        float a6)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 40LL) )
  {
    v11 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<unsigned int,float,float,float,float>(
            (int)this + 8,
            (unsigned int)BamoImpl::BamoDataSourcePrincipalImpl::CallSetColorValueOnStub,
            a2,
            v10,
            LODWORD(a4),
            LODWORD(a5),
