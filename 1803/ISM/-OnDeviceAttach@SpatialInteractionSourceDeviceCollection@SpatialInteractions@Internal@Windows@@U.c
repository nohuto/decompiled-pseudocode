/*
 * XREFs of ?OnDeviceAttach@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJKKPEAUIHidDevice@234@PEAUMPCControllerDeviceInfo@@PEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800A57B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Internal::SpatialInteractions::ISpatialInteractionSourceCollectionCallbacks *a6)
{
  ...
  *(_QWORD *)v9 = &std::_Ref_count_obj<Windows::Internal::SpatialInteractions::SpatialInteractionSourceController>::`vftable';
  ...
  v17 = (char *)(v9 + 4);
  v18 = v9;
  v11 = (*(__int64 (__fastcall **)(_DWORD *))(v10 + 80))(v9 + 4);
  v12 = v11;
  if ( v11 >= 0 )
  {
    ...
    if ( v11 >= 0 )
    {
      v11 = (*(__int64 (__fastcall **)(char *, struct MPCControllerDeviceInfo *))(*(_QWORD *)v17 + 96LL))(v17, a5);
      v12 = v11;
      if ( v11 >= 0 )
      {
