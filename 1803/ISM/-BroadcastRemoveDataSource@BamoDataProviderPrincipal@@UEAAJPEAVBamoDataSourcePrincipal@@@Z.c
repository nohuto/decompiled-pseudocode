/*
 * XREFs of ?BroadcastRemoveDataSource@BamoDataProviderPrincipal@@UEAAJPEAVBamoDataSourcePrincipal@@@Z @ 0x18008B850
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoDataSourcePrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 40LL) )
  {
    v6 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoInputSystemPrincipalImpl *>(
           (__int64)this + 8,
           (__int64 (__fastcall *)(__int64, __int64))BamoImpl::BamoDataProviderPrincipalImpl::CallRemoveDataSourceOnStub,
           (__int64)a2);
  }
  else
  {
