/*
 * XREFs of ?GetTransfromToOutputSpace@InputConfiguration@@YA?AUfloat3x2@Numerics@Foundation@Windows@@UINPUT_REGION_CONFIG@@UtagRECT@@@Z @ 0x18009ABBC
 * Callers:
 ...
 * Callees:
 *     ??DNumerics@Foundation@Windows@@YA?AUfloat3x2@012@AEBU3012@0@Z @ 0x18009A70C (--DNumerics@Foundation@Windows@@YA-AUfloat3x2@012@AEBU3012@0@Z.c)
 */
...
__int64 __fastcall InputConfiguration::GetTransfromToOutputSpace(__int64 a1, _DWORD *a2, unsigned int *a3)
{
  ...
  *(_QWORD *)((char *)&v31 + 4) = 0LL;
  ...
  v41 = (float)v19;
  v34 = _xmm;
  *(float *)v13.m128i_i32 = (float)(int)v14[15] * (float)(v8 / v10);
  *(float *)&v31 = v7 / v9;
  *((float *)&v31 + 3) = v8 / v10;
