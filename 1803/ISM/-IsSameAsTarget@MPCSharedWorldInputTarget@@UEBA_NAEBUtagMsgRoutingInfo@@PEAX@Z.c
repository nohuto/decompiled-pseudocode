/*
 * XREFs of ?IsSameAsTarget@MPCSharedWorldInputTarget@@UEBA_NAEBUtagMsgRoutingInfo@@PEAX@Z @ 0x180088D80
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall MPCSharedWorldInputTarget::IsSameAsTarget(
