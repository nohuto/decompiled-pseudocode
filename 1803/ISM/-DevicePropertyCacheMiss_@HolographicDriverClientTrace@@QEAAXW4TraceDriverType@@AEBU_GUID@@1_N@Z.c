/*
 * XREFs of ?DevicePropertyCacheMiss_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@1_N@Z @ 0x1800BE52C
 * Callers:
        ...
        unsigned __int8 a5)
{
  ...
  if ( *(_DWORD *)v9 > 4u && (*(_BYTE *)(v9 + 16) & 2) != 0 )
  {
    ...
    if ( v8 == *(struct HolographicDriverClientTrace **)(v9 + 24) )
    {
      ...
      v21 = 16LL;
      v23 = 4LL;
      LODWORD(v8) = TlgWrite((TraceLoggingHProvider)v9, &unk_18011275B, 0LL, 0LL, 6u, &pData);
    }
  }
  return (int)v8;
}
