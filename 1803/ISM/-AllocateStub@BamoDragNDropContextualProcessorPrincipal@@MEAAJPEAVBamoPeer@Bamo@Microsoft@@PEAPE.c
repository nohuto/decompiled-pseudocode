/*
 * XREFs of ?AllocateStub@BamoDragNDropContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@Bamo@Microsoft@@PEAPEAVBamoDragNDropContextualProcessorStub@@@Z @ 0x180062590
 * Callers:
 *     <none>
 * Callees:
