/*
 * XREFs of ??0InputSystem@@QEAA@PEAVBamoConnection@Bamo@Microsoft@@@Z @ 0x180022894
 * Callers:
...
InputSystem *__fastcall InputSystem::InputSystem(InputSystem *this, struct Microsoft::Bamo::BamoConnection *a2)
{
  BamoInputSystemPrincipal *v4; // rsi
  _QWORD *v5; // rbx
  _QWORD *v6; // rdi
  _QWORD *v7; // rdi
  ...
  _QWORD *v13; // rdi
  struct BamoControllerNavigationManagerPrincipal *v14; // rax
  wil::details::in1diag3 *retaddr; // [rsp+68h] [rbp+0h]
  ControllerNavigationManager *v17; // [rsp+80h] [rbp+18h]
  ...
  *v13 = &InputSiteManager::`vftable'{for `Microsoft::Bamo::BamoPrincipal'};
  ...
  v17 = (ControllerNavigationManager *)operator new(0xE8uLL);
  v14 = ControllerNavigationManager::ControllerNavigationManager(v17, a2);
  BamoInputSystemPrincipal::SetControllerNavigationManager(v4, v14);
  return this;
}
