/*
 * XREFs of ?HapticsIntensityLevelsSet_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKKE@Z @ 0x1800D3950
 * Callers:
        ...
        char a4)
{
  ...
  if ( *(_DWORD *)v4 > 4u && (*(_BYTE *)(v4 + 16) & 2) != 0 && (*(_QWORD *)(v4 + 24) & 2LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v9 = 4LL;
    v11 = 1LL;
    TlgWrite((TraceLoggingHProvider)v4, &unk_180112AE4, 0LL, 0LL, 5u, &pData);
  }
}
