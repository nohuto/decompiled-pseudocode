/*
 * XREFs of ?GetDelegateInputMode@MPCExclusiveInputTarget@@UEAAJPEAK@Z @ 0x180088280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCExclusiveInputTarget::GetDelegateInputMode(MPCExclusiveInputTarget *this, unsigned int *a2)
{
