/*
 * XREFs of ?MPCHolographicInputManager_RequestForegroundChange_@ISMTracing@@QEAAX_K0KK_N@Z @ 0x18005164C
 * Callers:
  ...
  if ( v6 )
  {
    if ( *v6 )
    {
      ...
      if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
      {
        ...
        v19 = 4;
        v22 = 1;
        TlgWrite((TraceLoggingHProvider)v7, &unk_18010E103, 0LL, 0LL, 7u, &pData);
      }
    }
  }
}
