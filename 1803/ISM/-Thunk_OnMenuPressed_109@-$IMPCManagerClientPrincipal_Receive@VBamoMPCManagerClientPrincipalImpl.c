/*
 * XREFs of ?Thunk_OnMenuPressed_109@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002A980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCManagerClientPrincipal_Receive<BamoImpl::BamoMPCManagerClientPrincipalImpl>::Thunk_OnMenuPressed_109(
        __int64 a1,
        __int64 *a2)
{
  ...
  v11 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD))(*(_QWORD *)(a1 - 16) + 80LL))(
          a1 - 16,
          v7,
          v4,
          v3);
