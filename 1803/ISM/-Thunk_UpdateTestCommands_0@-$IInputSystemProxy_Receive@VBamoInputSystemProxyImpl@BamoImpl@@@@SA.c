/*
 * XREFs of ?Thunk_UpdateTestCommands_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180020F60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int **a2)
{
  ...
  *(_QWORD *)(a1 + 80) = v8;
  ...
  if ( *(_BYTE *)(a1 + 28) )
  {
    ...
    v13 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 104LL))(a1 - 16);
    v14 = retaddr;
    if ( v13 >= 0 )
    {
      if ( v11 )
