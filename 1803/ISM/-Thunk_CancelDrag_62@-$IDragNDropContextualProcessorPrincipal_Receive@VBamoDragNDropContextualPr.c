/*
 * XREFs of ?Thunk_CancelDrag_62@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180062D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IDragNDropContextualProcessorPrincipal_Receive<BamoImpl::BamoDragNDropContextualProcessorPrincipalImpl>::Thunk_CancelDrag_62(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // ebp
  ...
  v13 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64))(*(_QWORD *)(a1 - 16) + 80LL))(
          a1 - 16,
          v6,
          v4,
          (v9 - 16) & -(__int64)(v9 != 0));
