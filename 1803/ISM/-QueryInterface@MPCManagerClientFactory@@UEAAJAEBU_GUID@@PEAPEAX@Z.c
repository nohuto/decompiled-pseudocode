/*
 * XREFs of ?QueryInterface@MPCManagerClientFactory@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180027970
 * Callers:
 *     ?QueryInterface@MPCManagerClientFactory@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800277D0 (-QueryInterface@MPCManagerClientFactory@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
