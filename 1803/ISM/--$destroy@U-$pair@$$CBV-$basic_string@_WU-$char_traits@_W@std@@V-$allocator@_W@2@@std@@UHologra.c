        ...
        unsigned __int64 *a2)
{
  ...
  if ( !*((_BYTE *)v5 + 25) )
  {
    do
    {
      ...
      v6 = (__int64 *)*v6;
      std::wstring::_Tidy_deallocate((unsigned __int64 *)v5 + 4);
      operator delete(v5);
      v5 = v6;
    }
    while ( !*((_BYTE *)v6 + 25) );
