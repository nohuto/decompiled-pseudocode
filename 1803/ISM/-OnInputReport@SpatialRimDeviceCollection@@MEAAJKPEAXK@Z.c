/*
 * XREFs of ?OnInputReport@SpatialRimDeviceCollection@@MEAAJKPEAXK@Z @ 0x180071630
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, void *, _QWORD, unsigned __int64))(**((_QWORD **)this + 347) + 48LL))(
          *((_QWORD *)this + 347),
          a2,
          a3,
          a4,
