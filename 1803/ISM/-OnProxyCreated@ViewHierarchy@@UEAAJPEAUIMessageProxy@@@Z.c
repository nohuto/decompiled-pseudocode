/*
 * XREFs of ?OnProxyCreated@ViewHierarchy@@UEAAJPEAUIMessageProxy@@@Z @ 0x18002BA10
 * Callers:
 *     <none>
 * Callees:
...
{
  struct IMessageProxy *v4; // rcx
  __int64 v5; // rcx
  int v6; // eax
  wil::details::in1diag3 *retaddr; // [rsp+28h] [rbp+0h]

  ViewHierarchy::RemoveListListenerReference(this);
  v4 = (struct IMessageProxy *)*((_QWORD *)this + 8);
  if ( v4 != a2 )
  {
    if ( a2 )
    {
    ...
    *((_QWORD *)this + 8) = a2;
    if ( v4 )
      (*(void (__fastcall **)(struct IMessageProxy *))(*(_QWORD *)v4 + 16LL))(v4);
  }
  v5 = *((_QWORD *)this + 9);
  if ( v5 )
  {
