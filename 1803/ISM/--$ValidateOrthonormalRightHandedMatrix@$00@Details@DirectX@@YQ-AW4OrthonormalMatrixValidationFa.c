/*
 * XREFs of ??$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ?AW4OrthonormalMatrixValidationFailures@1@UXMMATRIX@1@@Z @ 0x1800CC6B8
 * Callers:
        ...
        double a4)
{
  ...
  return v14 | v21 | !v13 | ((_mm_movemask_ps(_mm_cmplt_ps((__m128)_xmm, _mm_shuffle_ps(v35, v35, 0))) & 7) != 7 ? 8 : 0);
}
