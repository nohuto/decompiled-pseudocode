        ...
        void **a1)
{
  ...
  if ( !*((_BYTE *)v3 + 25) )
  {
    do
    {
      ...
      v4 = (__int64 *)*v4;
      std::wstring::_Tidy_deallocate((unsigned __int64 *)v3 + 13);
