/*
 * XREFs of ?OnPromotedToPrimary@MPCGamepadProcessor@@MEAAXXZ @ 0x1800951C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::OnPromotedToPrimary(MPCGamepadProcessor *this)
{
  ...
  *((_QWORD *)this + 565) = *(_QWORD *)(v2 + 176);
  *((_DWORD *)this + 1132) = *(_DWORD *)(v2 + 184);
  MPCHolographicInputManager::GetInstance();
  v4 = 15LL;
  v5 = &v20;
  do
  ...
  v14 = *((_QWORD *)v3 + 2);
  v15 = *((float *)this + 1131);
  v16 = (__m128)*((unsigned int *)this + 1130);
  ...
  *(_QWORD *)((char *)this + 4532) = _mm_unpacklo_ps(v17, v19).m128_u64[0];
  *((_OWORD *)this + 285) = 0LL;
  *((_DWORD *)this + 1135) = v16.m128_i32[0];
}
