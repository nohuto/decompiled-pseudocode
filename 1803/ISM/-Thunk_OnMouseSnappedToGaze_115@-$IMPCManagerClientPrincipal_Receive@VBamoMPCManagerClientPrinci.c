/*
 * XREFs of ?Thunk_OnMouseSnappedToGaze_115@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002ABE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCManagerClientPrincipal_Receive<BamoImpl::BamoMPCManagerClientPrincipalImpl>::Thunk_OnMouseSnappedToGaze_115(
        __int64 a1,
        __int64 *a2)
{
  __int64 v3; // rbp
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)(a1 - 16) + 96LL))(a1 - 16, v6, v3);
  v11 = retaddr;
  if ( v10 < 0 )
  {
LABEL_13:
