/*
 * XREFs of ??0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ @ 0x1800A1410
 * Callers:
        ...
        SpatialInteractionDevices::HID_HANDLE *this)
{
  ...
  *((_QWORD *)this + 31) = 0LL;
  *((_QWORD *)this + 32) = 0LL;
  *((_QWORD *)this + 31) = std::_Tree_comp_alloc<std::_Tmap_traits<unsigned long,std::map<std::string,std::variant<unsigned long,bool,float>>,std::less<unsigned long>,std::allocator<std::pair<unsigned long const,std::map<std::string,std::variant<unsigned long,bool,float>>>>,0>>::_Buyheadnode();
  *((_DWORD *)this + 66) = 0;
  *((_QWORD *)this + 34) = 0LL;
  *((_BYTE *)this + 296) = 0;
  return this;
