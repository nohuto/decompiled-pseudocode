/*
 * XREFs of ?DragInProgressLegacy@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@0_K1@Z @ 0x1800B174C
 * Callers:
...
void InputETW::DragNDrop::DragInProgressLegacy(
        unsigned int a1,
        struct tagPOINT *a2,
        struct tagPOINT *a3,
        __int64 a4,
        ...)
{
  ...
  if ( *(_DWORD *)v7 > 5u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    if ( *(_DWORD *)v8 > 5u && (*(_BYTE *)(v8 + 16) & 1) != 0 && (*(_QWORD *)(v8 + 24) & 1LL) == *(_QWORD *)(v8 + 24) )
    {
      ...
      v26 = 8LL;
      v28 = 8LL;
      TlgWrite((TraceLoggingHProvider)v8, &unk_18011077B, 0LL, 0LL, 9u, &pData);
    }
  }
}
