/*
 * XREFs of ?TryUpdatePose@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAA_N_JPEAUISpatialGraphNodeReference@Holographic@34@AEBUMatrix4x4@Numerics@Foundation@4@2@Z @ 0x1800D7234
 * Callers:
        ...
        const struct Windows::Foundation::Numerics::Matrix4x4 *a5)
{
  ...
  v9 = (RTL_SRWLOCK *)(((unsigned __int64)this + 1104) & -(__int64)(TryAcquireSRWLockShared((PSRWLOCK)this + 138) != 0));
  if ( v9 )
  {
    memset_0((char *)this + 288, 0, 0x40uLL);
    memset_0((char *)this + 412, 0, 0x20uLL);
    v11 = *((_QWORD *)this + 108);
    v10 = 1;
    if ( v11 )
    {
      ...
      if ( v12 >= 0 )
      {
        ...
        *((_BYTE *)this + 408) = v15;
        if ( v15 )
        {
          ...
          *(__m128 *)((char *)this + 392) = DirectX::XMQuaternionRotationMatrix(
