...
LABEL_113:
  v37 = a3[5];
  if ( v37 )
    (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v37 + 8LL))(v37, 1LL);
  operator delete(a3);
  v38 = a1[1];
  if ( v38 )
    a1[1] = v38 - 1;
