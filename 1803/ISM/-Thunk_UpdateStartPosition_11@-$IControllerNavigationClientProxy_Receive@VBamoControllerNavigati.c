/*
 * XREFs of ?Thunk_UpdateStartPosition_11@?$IControllerNavigationClientProxy_Receive@VBamoControllerNavigationClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180031B20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IControllerNavigationClientProxy_Receive<BamoImpl::BamoControllerNavigationClientProxyImpl>::Thunk_UpdateStartPosition_11(
        __int64 a1,
        _QWORD **a2)
{
  __int64 v3; // rdi
