/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x1800049CC
 * Callers:
 *     ?GetThreadLocalDataCache@details_abi@wil@@YAPEAUThreadLocalData@12@_N@Z @ 0x180003A4C (-GetThreadLocalDataCache@details_abi@wil@@YAPEAUThreadLocalData@12@_N@Z.c)
 * Callees:
      ...
      *(_OWORD *)hObject = 0LL;
      ...
      if ( v22 >= 0 )
      {
        ...
        *((_QWORD *)v21 + 2) = v26;
        ...
        hHandle = 0LL;
        *((_QWORD *)v21 + 3) = v27;
        memset_0(v21 + 16, 0, 0x58uLL);
        v21[16] = 88;
        *((_DWORD *)v21 + 9) = 1;
        memset_0(v21 + 20, 0, 0x50uLL);
        v8 = 0;
        *a2 = v21;
      }
      else
