/*
 * XREFs of _std::_List_alloc_std::_List_base_types_std::pair_unsigned_long_const__DragNDropProcessor::MessageInfo__std::allocator_std::pair_unsigned_long_const__DragNDropProcessor::MessageInfo_______::_Buynode0_::_1_::catch$8 @ 0x1800E6EC4
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall __noreturn std::_List_alloc_std::_List_base_types_std::pair_unsigned_long_const__DragNDropProcessor::MessageInfo__std::allocator_std::pair_unsigned_long_const__DragNDropProcessor::MessageInfo_______::_Buynode0_::_1_::catch_8(
        __int64 a1,
        __int64 a2)
{
