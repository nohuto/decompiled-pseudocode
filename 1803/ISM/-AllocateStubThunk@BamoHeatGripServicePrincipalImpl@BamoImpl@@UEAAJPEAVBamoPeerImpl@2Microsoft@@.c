/*
 * XREFs of ?AllocateStubThunk@BamoHeatGripServicePrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x180038D60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoHeatGripServicePrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
