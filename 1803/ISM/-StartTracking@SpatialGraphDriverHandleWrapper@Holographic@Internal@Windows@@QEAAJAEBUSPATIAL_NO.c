/*
 * XREFs of ?StartTracking@SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@QEAAJAEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@@Z @ 0x1800C70E0
 * Callers:
  ...
  try
  {
    ...
    if ( v22 == *(_QWORD *)(a1 + 208) )
    {
      ...
      *((_QWORD *)&v23 + 1) = &v22;
      ...
      v32 = v23;
      v33 = &v31;
      std::function<void (void)>::swap(&v31, v34);
      if ( v33 )
      {
        v8 = &v31;
        LOBYTE(v8) = v33 != &v31;
