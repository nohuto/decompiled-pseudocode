/*
 * XREFs of ?InitializeConstants@MPCMouseProcessor@@EEAAXXZ @ 0x180096E30
 * Callers:
...
void __fastcall MPCMouseProcessor::InitializeConstants(MPCMouseProcessor *this)
{
  ...
  if ( !std::_Execute_once(
          ...
          (int (*)(void *, void *, void **))std::_Callback_once<std::tuple<_lambda_0fe84b0df1de98c8718b27672fc0a862_ &&,std::exception_ptr &>,std::integer_sequence<unsigned __int64,0>,1>,
          v3) )
  {
