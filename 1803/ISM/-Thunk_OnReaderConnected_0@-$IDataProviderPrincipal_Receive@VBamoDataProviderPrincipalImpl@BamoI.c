/*
 * XREFs of ?Thunk_OnReaderConnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18008F8C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 **a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)(a1 - 16) + 80LL))(a1 - 16, v6, v3);
  v11 = retaddr;
  if ( v10 < 0 )
  {
LABEL_13:
