/*
 * XREFs of ?GetModuleInformation@details@wil@@YA_NPEAXPEAIPEAD_K@Z @ 0x18000209C
 * Callers:
 *     ?GetCurrentModuleName@details@wil@@YAPEBDXZ @ 0x1800021D0 (-GetCurrentModuleName@details@wil@@YAPEBDXZ.c)
 * Callees:
