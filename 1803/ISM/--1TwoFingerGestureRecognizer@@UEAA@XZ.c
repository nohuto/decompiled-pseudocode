/*
 * XREFs of ??1TwoFingerGestureRecognizer@@UEAA@XZ @ 0x1800DAFD8
 * Callers:
 *     _GestureSession::GestureSession_::_1_::dtor$4 @ 0x1800EA833 (_GestureSession--GestureSession_--_1_--dtor$4.c)
 * Callees:
 *     <none>
 */
