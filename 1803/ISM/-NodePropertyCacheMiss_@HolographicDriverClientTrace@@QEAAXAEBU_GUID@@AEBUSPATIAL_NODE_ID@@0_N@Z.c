/*
 * XREFs of ?NodePropertyCacheMiss_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0_N@Z @ 0x1800BE644
 * Callers:
        ...
        bool a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*(_BYTE *)(v8 + 16) & 2) != 0 && (*(_QWORD *)(v8 + 24) & 2LL) == *(_QWORD *)(v8 + 24) )
  {
    ...
    v16 = 16LL;
    v18 = 4LL;
    TlgWrite((TraceLoggingHProvider)v8, &unk_180111258, 0LL, 0LL, 6u, &pData);
  }
}
