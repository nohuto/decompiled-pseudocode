/*
 * XREFs of ??$MakeAndInitialize@VMessageProxyReconnectAdapter@@V1@AEBU_GUID@@AEAY0CL@$$CBGPEAVViewHierarchy@@@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@VMessageProxyReconnectAdapter@@@WRL@Microsoft@@@012@AEBU_GUID@@AEAY0CL@$$CBG$$QEAPEAVViewHierarchy@@@Z @ 0x18002D124
 * Callers:
 ...
 * Callees:
 *     ??0MessageProxyReconnectAdapter@@QEAA@XZ @ 0x18002D7C8 (--0MessageProxyReconnectAdapter@@QEAA@XZ.c)
