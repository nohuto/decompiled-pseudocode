/*
 * XREFs of ?Thunk_OnGamepadExclusivityExited_104@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002AE20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCManagerClientPrincipal_Receive<BamoImpl::BamoMPCManagerClientPrincipalImpl>::Thunk_OnGamepadExclusivityExited_104(
        __int64 a1)
{
  int v2; // ecx
  _QWORD *i; // rbx
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(a1 - 16) + 112LL))(a1 - 16, v4);
  v9 = retaddr;
  if ( v8 < 0 )
  {
LABEL_13:
