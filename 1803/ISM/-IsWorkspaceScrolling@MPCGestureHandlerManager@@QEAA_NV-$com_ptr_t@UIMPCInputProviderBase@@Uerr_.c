/*
 * XREFs of ?IsWorkspaceScrolling@MPCGestureHandlerManager@@QEAA_NV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x180054D70
 * Callers:
...
bool __fastcall MPCGestureHandlerManager::IsWorkspaceScrolling(__int64 a1, unsigned __int64 *a2)
{
  int v3; // r10d
  __int64 *v4; // rax
  __int64 *v5; // rcx
