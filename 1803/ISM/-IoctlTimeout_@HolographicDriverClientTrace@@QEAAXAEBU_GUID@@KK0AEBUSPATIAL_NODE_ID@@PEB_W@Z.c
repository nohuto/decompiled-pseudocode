/*
 * XREFs of ?IoctlTimeout_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@KK0AEBUSPATIAL_NODE_ID@@PEB_W@Z @ 0x1800BC7EC
 * Callers:
        ...
        const wchar_t *a7)
{
    ...
    && (*((_QWORD *)v9 + 3) & 0x200000000000LL) == *((_QWORD *)v9 + 3) )
  {
    ...
    v24 = v10;
    v25 = 2 * v11 + 2;
    TlgWrite(v9, &unk_1801114C0, 0LL, 0LL, 8u, &pData);
  }
}
