/*
 * XREFs of _lambda_3596711b79d73f9b4e9b30522d843cd5_::_lambda_invoker_cdecl_ @ 0x18006A5E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall lambda_3596711b79d73f9b4e9b30522d843cd5_::_lambda_invoker_cdecl_(_BYTE *a1, HKEY a2)
{
  LSTATUS v3; // eax
  __int64 v4; // rcx
  char v5; // al
