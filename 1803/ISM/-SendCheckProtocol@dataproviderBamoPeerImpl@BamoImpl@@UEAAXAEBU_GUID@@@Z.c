/*
 * XREFs of ?SendCheckProtocol@dataproviderBamoPeerImpl@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x18008EDC0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dataproviderBamoPeerImpl::SendCheckProtocol(
        ...
        const struct _GUID *a2)
{
  ...
  v6 = 0;
  v8 = v2;
  v5 = CoreUICallSend(v4, v7, 2LL, 6LL, v6, &unk_1800FE16E, (unsigned int)&v8);
  if ( v5 < 0 )
  {
