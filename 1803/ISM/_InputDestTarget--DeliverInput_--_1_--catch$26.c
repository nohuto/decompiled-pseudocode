/*
 * XREFs of _InputDestTarget::DeliverInput_::_1_::catch$26 @ 0x1800E7E57
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall InputDestTarget::DeliverInput_::_1_::catch_26(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
