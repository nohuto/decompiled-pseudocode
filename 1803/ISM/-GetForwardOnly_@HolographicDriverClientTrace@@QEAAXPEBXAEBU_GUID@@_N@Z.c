/*
 * XREFs of ?GetForwardOnly_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@_N@Z @ 0x1800BD400
 * Callers:
        ...
        char a4)
{
  ...
  if ( *(_DWORD *)v5 > 4u && (*(_BYTE *)(v5 + 16) & 2) != 0 && (*(_QWORD *)(v5 + 24) & 2LL) == *(_QWORD *)(v5 + 24) )
  {
    ...
    v10 = 16LL;
    v12 = 1LL;
    TlgWrite((TraceLoggingHProvider)v5, &unk_180111B7C, 0LL, 0LL, 5u, &pData);
  }
}
