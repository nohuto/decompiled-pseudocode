/*
 * XREFs of wil::details::_dynamic_atexit_destructor_for__g_featureStateManager__ @ 0x1800EAAB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    if ( qword_180134620 )
      wil::details_abi::ProcessLocalStorageData<wil::details_abi::FeatureStateData>::Release((char *)qword_180134620);
  }
  else
  {
