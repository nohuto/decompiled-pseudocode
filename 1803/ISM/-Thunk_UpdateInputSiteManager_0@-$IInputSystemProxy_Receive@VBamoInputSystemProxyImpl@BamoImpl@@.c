/*
 * XREFs of ?Thunk_UpdateInputSiteManager_0@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180020C40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IInputSystemProxy_Receive<BamoImpl::BamoInputSystemProxyImpl>::Thunk_UpdateInputSiteManager_0(
        __int64 a1,
        unsigned int **a2)
{
  __int64 v3; // r8
  ...
  *(_QWORD *)(a1 + 64) = v8;
  ...
  if ( *(_BYTE *)(a1 + 28) )
  {
    ...
    v13 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 88LL))(a1 - 16);
    v14 = retaddr;
    if ( v13 >= 0 )
    {
      if ( v11 )
