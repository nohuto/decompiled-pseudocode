/*
 * XREFs of ?InitializeHapticsEngine_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAX_N_JE00@Z @ 0x1800D3D2C
 * Callers:
        ...
        bool a6)
{
  ...
  if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 2) != 0 && (*(_QWORD *)(v6 + 24) & 2LL) == *(_QWORD *)(v6 + 24) )
  {
    ...
    v15 = 1LL;
    v17 = 1LL;
    TlgWrite((TraceLoggingHProvider)v6, &unk_180112A51, 0LL, 0LL, 7u, &pData);
  }
}
