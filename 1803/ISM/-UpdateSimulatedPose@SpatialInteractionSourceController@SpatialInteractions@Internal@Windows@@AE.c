/*
 * XREFs of ?UpdateSimulatedPose@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@AEAAX_JAEBUPoseData@SpatialInteractionDevices@@PEAUISpatialGraphNodeReference@Holographic@34@AEBUMatrix4x4@Numerics@Foundation@4@3@Z @ 0x1800D7430
 * Callers:
        ...
        const struct Windows::Foundation::Numerics::Matrix4x4 *a6)
{
  ...
  else
  {
    ...
    v44[0] = a2;
    v45 = 3;
    v46 = (__m128)xmmword_180135840;
    v47 = (__m128)xmmword_180135850;
    v48 = xmmword_180135860;
  }
