/*
 * XREFs of ?Thunk_ResendGamepadIsSupportedForProcess_0@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180053FA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCManagerPrincipal_Receive<BamoImpl::BamoMPCManagerPrincipalImpl>::Thunk_ResendGamepadIsSupportedForProcess_0(
        __int64 a1,
        unsigned int **a2)
{
  ...
  v10 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)(a1 - 16) + 88LL))(a1 - 16, v6, v3);
  v11 = retaddr;
  if ( v10 < 0 )
  {
LABEL_13:
