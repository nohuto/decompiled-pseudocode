/*
 * XREFs of ?invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z @ 0x180051AD0
 * Callers:
        ...
        struct Windows::Foundation::Numerics::float4x4 *a3)
{
  ...
  if ( v20 >= 0.00000011920929 )
  {
    ...
    *((float *)a2 + 13) = (float)((float)((float)(v11 * v35) - (float)(v13 * v46)) + (float)(v14 * v47))
    ...
    v27 = (float)(v40 * v41) - (float)(v38 * v39);
    v28 = (float)(v7 * v41) - (float)(v38 * v36);
    *((float *)a2 + 2) = (float)((float)((float)(v23 * v46) - (float)(v24 * v47)) + (float)(v25 * v48)) * v22;
    *((_DWORD *)a2 + 14) = COERCE_UNSIGNED_INT((float)((float)((float)(v25 * v35) - (float)(v28 * v46))
                                                     + (float)(v27 * v47)) * v22) ^ _xmm;
    *((float *)a2 + 10) = (float)((float)((float)(v24 * v35) - (float)(v26 * v46)) + (float)(v27 * v48)) * v22;
    *((_DWORD *)a2 + 6) = COERCE_UNSIGNED_INT((float)((float)((float)(v23 * v35) - (float)(v26 * v47))
                                                    + (float)(v28 * v48)) * v22) ^ _xmm;
