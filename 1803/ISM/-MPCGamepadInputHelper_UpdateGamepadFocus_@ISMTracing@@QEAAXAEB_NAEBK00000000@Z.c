/*
 * XREFs of ?MPCGamepadInputHelper_UpdateGamepadFocus_@ISMTracing@@QEAAXAEB_NAEBK00000000@Z @ 0x180058244
 * Callers:
        ...
        const bool *a11)
{
  ...
  if ( *(_DWORD *)v14 > 4u && (*(_BYTE *)(v14 + 16) & 1) != 0 && (*(_QWORD *)(v14 + 24) & 1LL) == *(_QWORD *)(v14 + 24) )
  {
    ...
    v33 = 1LL;
    v35 = 1LL;
    TlgWrite((TraceLoggingHProvider)v14, &unk_18010E3D9, 0LL, 0LL, 0xCu, &pData);
  }
}
