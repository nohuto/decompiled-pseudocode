/*
 * XREFs of ?SpatialInputControllerCollection_Initialized_@RawInputProvidersTracing@@QEAAX_N@Z @ 0x18006E710
 * Callers:
        ...
        char a2)
{
  ...
  if ( *(_DWORD *)v2 > 4u && (*(_BYTE *)(v2 + 16) & 2) != 0 && (*(_QWORD *)(v2 + 24) & 2LL) == *(_QWORD *)(v2 + 24) )
  {
    ...
    v4 = &v7;
    v5 = 1;
    TlgWrite((TraceLoggingHProvider)v2, &unk_18010F46A, 0LL, 0LL, 3u, &pData);
  }
}
