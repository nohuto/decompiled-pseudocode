/*
 * XREFs of ?BoundsCrossed@BamoControllerNavigationClientProxy@@UEAAJAEBUtagPOINT@@@Z @ 0x180031280
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct tagPOINT *a2)
{
  ...
  struct IMessageCallSendHost *v13; // [rsp+40h] [rbp-48h] BYREF
  _QWORD v14[8]; // [rsp+48h] [rbp-40h] BYREF
...
LABEL_5:
  ...
  v9 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(
         (BamoControllerNavigationClientProxy *)((char *)this + 8),
         &v13,
         &v16,
         &v17);
  v6 = v9;
  ...
  v14[1] = v17;
  v12 = 0;
  v6 = CoreUICallSend(v13, v14, 2LL, 3LL, v12, &unk_1800F966B, (unsigned int)&v18);
LABEL_9:
  if ( v4 )
  {
