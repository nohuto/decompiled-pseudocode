/*
 * XREFs of ??$GetConstant@M@MPCConstantManager@@QEAAMPEAUIMPCInputProviderBase@@AEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z @ 0x180041468
 * Callers:
...
float __fastcall MPCConstantManager::GetConstant<float>(
        MPCConstantManager *a1,
        ...
        __int64 a3)
{
  ...
  __int64 pExceptionObject; // [rsp+28h] [rbp-38h] BYREF
  __int64 v12; // [rsp+30h] [rbp-30h]
  __int64 v13; // [rsp+38h] [rbp-28h]
  struct _GUID v14; // [rsp+40h] [rbp-20h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+78h] [rbp+18h]

  MPCConstantManager::GetIds(a1, a2, &v14, &v10);
  if ( !(unsigned __int8)MPCConstantManager::CheckGenericConstantExistence(a1, &v14, a3) )
  {
  ...
  if ( (unsigned __int8)MPCConstantManager::CheckDeviceConstantExistence((int)a1) )
  {
    v6 = std::map<unsigned long,std::map<std::string,std::variant<unsigned long,bool,float>>>::operator[]((int)a1);
    v7 = (_BYTE *)std::map<std::string,std::variant<unsigned long,bool,float>>::operator[](v6);
    if ( v7[4] != 2 )
    {
  ...
  {
    v8 = std::map<_GUID,std::map<std::string,std::variant<unsigned long,bool,float>>>::operator[]((char *)a1 + 16, &v14);
    v7 = (_BYTE *)std::map<std::string,std::variant<unsigned long,bool,float>>::operator[](v8);
    if ( v7[4] != 2 )
    {
      pExceptionObject = 0LL;
      v12 = 0LL;
