/*
 * XREFs of ?RegisterInputSiteElement@BamoInputSiteManagerProxy@@UEAAJPEAVBamoInputSiteElementPrincipal@@@Z @ 0x18001D550
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( a2 )
  {
    v10 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoInputSiteElementPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
  ...
  v11 = Microsoft::BamoImpl::BamoProxyImpl::PrepareForRemoteCall(
          (BamoInputSiteManagerProxy *)((char *)this + 8),
          &v19,
          (unsigned int *)&v17,
          &v18);
  v6 = v11;
