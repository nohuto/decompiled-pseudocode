/*
 * XREFs of ?NodePropertyRequestAdded_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0@Z @ 0x1800BDD58
 * Callers:
        ...
        const struct _GUID *a4)
{
  ...
  if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 2) != 0 && (*(_QWORD *)(v7 + 24) & 2LL) == *(_QWORD *)(v7 + 24) )
  {
    ...
    v13 = a4;
    v14 = 16LL;
    TlgWrite((TraceLoggingHProvider)v7, &unk_180110A62, 0LL, 0LL, 5u, &pData);
  }
}
