/*
 * XREFs of _Windows::Internal::SpatialInteractions::AverageHapticsFilter::EnsurePresent_::_1_::catch$22 @ 0x1800EA5CF
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall Windows::Internal::SpatialInteractions::AverageHapticsFilter::EnsurePresent_::_1_::catch_22(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
