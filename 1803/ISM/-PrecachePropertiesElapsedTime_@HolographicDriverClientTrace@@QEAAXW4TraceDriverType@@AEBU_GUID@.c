/*
 * XREFs of ?PrecachePropertiesElapsedTime_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@_K@Z @ 0x1800BE350
 * Callers:
  ...
  if ( v24 < 0xBB8 )
  {
    ...
    if ( *(_DWORD *)v9 > 4u && (*(_BYTE *)(v9 + 16) & 2) != 0 )
    {
      ...
      if ( v5 == *(struct HolographicDriverClientTrace **)(v9 + 24) )
      {
        ...
        v19 = 16LL;
        v21 = 8LL;
        LODWORD(v5) = TlgWrite((TraceLoggingHProvider)v9, &unk_180110F02, 0LL, 0LL, 5u, &pData);
      }
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v6 > 4u && (*((_QWORD *)v6 + 2) & 0x200000000000LL) != 0 )
    {
      ...
      if ( v5 == *((struct HolographicDriverClientTrace **)v6 + 3) )
      {
        ...
        v13 = 3000LL;
        v23 = 8LL;
        LODWORD(v5) = TlgWrite(v6, &unk_180111570, 0LL, 0LL, 6u, &pData);
      }
    }
  }
  return (int)v5;
