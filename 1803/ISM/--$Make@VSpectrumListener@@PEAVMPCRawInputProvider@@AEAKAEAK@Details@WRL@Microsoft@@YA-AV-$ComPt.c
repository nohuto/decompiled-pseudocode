/*
 * XREFs of ??$Make@VSpectrumListener@@PEAVMPCRawInputProvider@@AEAKAEAK@Details@WRL@Microsoft@@YA?AV?$ComPtr@VSpectrumListener@@@12@$$QEAPEAVMPCRawInputProvider@@AEAK1@Z @ 0x18005EBA0
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  *a1 = 0LL;
  v8 = (SpectrumListener *)operator new(0x58uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v8 )
  {
