/*
 * XREFs of ?DevicePropertyRequestAdded_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@1@Z @ 0x1800BD8A4
 * Callers:
...
int __fastcall HolographicDriverClientTrace::DevicePropertyRequestAdded_(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*(_BYTE *)(v8 + 16) & 2) != 0 )
  {
    ...
    if ( v7 == *(struct HolographicDriverClientTrace **)(v8 + 24) )
    {
      ...
      v18 = a4;
      v19 = 16LL;
      LODWORD(v7) = TlgWrite((TraceLoggingHProvider)v8, &unk_18011134A, 0LL, 0LL, 5u, &pData);
    }
  }
  return (int)v7;
}
