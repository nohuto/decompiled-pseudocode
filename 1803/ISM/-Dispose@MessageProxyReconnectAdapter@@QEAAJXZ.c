/*
 * XREFs of ?Dispose@MessageProxyReconnectAdapter@@QEAAJXZ @ 0x18002D914
 * Callers:
 *     ?UnInitialize@InputServiceProxy@@UEAAJXZ @ 0x180025C60 (-UnInitialize@InputServiceProxy@@UEAAJXZ.c)
 * Callees:
