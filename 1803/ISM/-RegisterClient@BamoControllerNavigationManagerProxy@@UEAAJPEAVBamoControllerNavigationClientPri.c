/*
 * XREFs of ?RegisterClient@BamoControllerNavigationManagerProxy@@UEAAJPEAVBamoControllerNavigationClientPrincipal@@@Z @ 0x18001C410
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( a2 )
  {
    v10 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoControllerNavigationClientPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
