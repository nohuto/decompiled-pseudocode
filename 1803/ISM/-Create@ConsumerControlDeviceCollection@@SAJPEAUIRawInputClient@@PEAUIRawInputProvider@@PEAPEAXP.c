/*
 * XREFs of ?Create@ConsumerControlDeviceCollection@@SAJPEAUIRawInputClient@@PEAUIRawInputProvider@@PEAPEAXPEAPEAV1@@Z @ 0x1800731A8
 * Callers:
        ...
        struct ConsumerControlDeviceCollection **a4)
{
  ...
  if ( a1 && a3 && a4 )
  {
    ...
    if ( v11 )
    {
      ...
      v12 = v11 + 690;
      *(_QWORD *)v11 = &ConsumerControlDeviceCollection::`vftable';
      v11[2226] = 0;
    ...
    if ( v11 )
    {
      ...
      if ( v14 < 0 )
        ...
        *a4 = (struct ConsumerControlDeviceCollection *)v11;
    }
    else
    {
