/*
 * XREFs of _lambda_b4e39e6c596c6c16e4eb60f4733859c1_::_lambda_invoker_cdecl_ @ 0x180086D30
 * Callers:
 *     <none>
 * Callees:
...
{
  if ( *(_BYTE *)(a1 + 816) != (*(_BYTE *)(a1 + 808) != 0) || *(_DWORD *)(a1 + 820) != *(_DWORD *)(a1 + 812) )
  {
    *(_BYTE *)(a1 + 816) = *(_BYTE *)(a1 + 808) != 0;
    *(_DWORD *)(a1 + 820) = *(_DWORD *)(a1 + 812);
