/*
 * XREFs of ??1?$map@IV?$function@$$A6AX_N@Z@std@@U?$less@I@2@V?$allocator@U?$pair@$$CBIV?$function@$$A6AX_N@Z@std@@@std@@@2@@std@@QEAA@XZ @ 0x1800078F0
 * Callers:
 *     _MPC3DStateHelper::MPC3DStateHelper_::_1_::dtor$2 @ 0x1800E359F (_MPC3DStateHelper--MPC3DStateHelper_--_1_--dtor$2.c)
 *     _MPC3DStateHelper::MPC3DStateHelper_::_1_::dtor$3 @ 0x1800E35AF (_MPC3DStateHelper--MPC3DStateHelper_--_1_--dtor$3.c)
 * Callees:
