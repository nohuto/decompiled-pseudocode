/*
 * XREFs of ?GetInputDeliveryServer@BamoInputSystemProxy@@UEAAPEAVBamoInputDeliveryServerProxy@@XZ @ 0x18000DB80
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSystemProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 136) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x18000DBD1LL);
  }
  return (struct BamoInputDeliveryServerProxy *)*((_QWORD *)this + 8);
}
