/*
 * XREFs of ?GetRestrictToProcessId@BamoDataSourcePrincipal@@UEAAIXZ @ 0x18008CCE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataSourcePrincipal::GetRestrictToProcessId(BamoDataSourcePrincipal *this)
{
  __int64 v2; // rbx
  __int64 v3; // rdi
  unsigned int v4; // edi
