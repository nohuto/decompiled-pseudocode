/*
 * XREFs of ?ShouldRedirectToManipulationThread@MPCSharedWorldInputTarget@@UEBA_NXZ @ 0x180088EF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall MPCSharedWorldInputTarget::ShouldRedirectToManipulationThread(MPCSharedWorldInputTarget *this)
{
