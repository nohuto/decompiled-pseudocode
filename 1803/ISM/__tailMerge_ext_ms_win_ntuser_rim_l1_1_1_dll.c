/*
 * XREFs of __tailMerge_ext_ms_win_ntuser_rim_l1_1_1_dll @ 0x1800E2FF9
 * Callers:
 *     __imp_load_InitializePointerDeviceInjectionEx @ 0x1800E2FED (__imp_load_InitializePointerDeviceInjectionEx.c)
 * Callees:
