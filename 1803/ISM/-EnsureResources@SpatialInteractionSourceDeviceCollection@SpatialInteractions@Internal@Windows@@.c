/*
 * XREFs of ?EnsureResources@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAJAEBVSyncLockCriticalSection@Details@Wrappers@WRL@Microsoft@@@Z @ 0x1800A8A90
 * Callers:
        ...
        const struct Microsoft::WRL::Wrappers::Details::SyncLockCriticalSection *a2)
{
  ...
  v2 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 344);
  EnterCriticalSection((LPCRITICAL_SECTION)((char *)this + 344));
  v4 = (__int64 *)((char *)this + 384);
  if ( !*((_QWORD *)this + 48) )
  {
    string = 0LL;
    ...
    ActivationFactory = RoGetActivationFactory(v7, &GUID_47a611d4_a9df_4edc_855d_f4d339d967ac, (char *)this + 384);
...
LABEL_13:
  ...
  if ( !*((_QWORD *)this + 49) )
  {
    ...
    ActivationFactory = RoGetActivationFactory(v14, &GUID_cb374983_e7b0_4841_8355_3ae5b536e9a4, (char *)this + 392);
    v9 = ActivationFactory;
    if ( ActivationFactory < 0 )
    {
      v10 = 1188LL;
  ...
  v16 = (**v22)(v22, &GUID_a96534fe_8251_42e7_8755_e3eb989e56e9, (char *)this + 400);
  v9 = v16;
  if ( v16 >= 0 )
  {
    v20 = v22;
