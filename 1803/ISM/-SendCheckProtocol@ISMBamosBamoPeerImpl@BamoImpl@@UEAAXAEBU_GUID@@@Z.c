/*
 * XREFs of ?SendCheckProtocol@ISMBamosBamoPeerImpl@BamoImpl@@UEAAXAEBU_GUID@@@Z @ 0x18001E710
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::ISMBamosBamoPeerImpl::SendCheckProtocol(
        ...
        const struct _GUID *a2)
{
  ...
  v6 = 0;
  v8 = v2;
  v5 = CoreUICallSend(v4, v7, 2LL, 26LL, v6, &unk_1800F96A2, (unsigned int)&v8);
  if ( v5 < 0 )
  {
