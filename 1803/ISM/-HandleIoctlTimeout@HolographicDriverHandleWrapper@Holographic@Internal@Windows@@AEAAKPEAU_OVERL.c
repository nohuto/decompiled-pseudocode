/*
 * XREFs of ?HandleIoctlTimeout@HolographicDriverHandleWrapper@Holographic@Internal@Windows@@AEAAKPEAU_OVERLAPPED@@KKPEBXKPEAK@Z @ 0x1800C0B6C
 * Callers:
...
LABEL_13:
  ...
  if ( !GetOverlappedResultEx(*((HANDLE *)this + 16), a2, lpNumberOfBytesTransferred, 0xFFFFFFFF, 0) )
    return GetLastError();
  return v8;
}
