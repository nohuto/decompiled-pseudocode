/*
 * XREFs of ?DeleteStaticNodes_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@W4SPATIAL_GRAPH_DELETE_STATIC_NODE_OPERATION@@KPEBUSPATIAL_NODE_ID@@@Z @ 0x1800BD22C
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( *(_DWORD *)v9 > 4u && (*(_BYTE *)(v9 + 16) & 2) != 0 )
  {
    ...
    if ( v8 == *(struct HolographicDriverClientTrace **)(v9 + 24) )
    {
      ...
      v23 = 16 * a5;
      v24 = 0;
      LODWORD(v8) = TlgWrite((TraceLoggingHProvider)v9, &unk_180111C3D, 0LL, 0LL, 7u, &pData);
    }
  }
  return (int)v8;
}
