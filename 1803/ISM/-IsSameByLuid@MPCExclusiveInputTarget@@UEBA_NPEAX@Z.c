/*
 * XREFs of ?IsSameByLuid@MPCExclusiveInputTarget@@UEBA_NPEAX@Z @ 0x180087AF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall MPCExclusiveInputTarget::IsSameByLuid(MPCExclusiveInputTarget *this, void *a2)
{
...
LABEL_7:
  ...
  if ( v4 < 0 )
    goto LABEL_7;
  v6 = (*(__int64 (__fastcall **)(__int64, void *))(*(_QWORD *)v10 + 40LL))(v10, a2);
  v7 = v10;
  if ( v10 )
  {
    v10 = 0LL;
