/*
 * XREFs of ??1?$_Tree@V?$_Tmap_traits@USPATIAL_NODE_ID@@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@USpatialNodeIdLess@Holographic@Internal@Windows@@V?$allocator@U?$pair@$$CBUSPATIAL_NODE_ID@@V?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@@std@@@3@$0A@@std@@@std@@QEAA@XZ @ 0x18009CF1C
 * Callers:
        ...
        void **a1)
{
  ...
  if ( !*((_BYTE *)v3 + 25) )
  {
    do
    {
      ...
      v4 = (__int64 *)*v4;
      std::wstring::_Tidy_deallocate((unsigned __int64 *)v3 + 6);
      operator delete(v3);
      v3 = v4;
    }
    while ( !*((_BYTE *)v4 + 25) );
