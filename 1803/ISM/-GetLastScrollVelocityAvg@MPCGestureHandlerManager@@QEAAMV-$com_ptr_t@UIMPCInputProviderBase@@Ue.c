/*
 * XREFs of ?GetLastScrollVelocityAvg@MPCGestureHandlerManager@@QEAAMV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x180054EE4
 * Callers:
...
LABEL_11:
  ...
  {
    *(_QWORD *)&v10 = *(unsigned int *)(*(_QWORD *)std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::operator[](v3)
                                      + 972LL);
    if ( *a2 )
      (*(void (__fastcall **)(unsigned __int64))(*(_QWORD *)*a2 + 16LL))(*a2);
    return v10;
