/*
 * XREFs of ?PredictFromPoses@ComputeVelocityFallbackPosePredictionModel@Holographic@Internal@Windows@@UEAAJPEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@_K_J0@Z @ 0x1800BA590
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  v47 = v26;
  v50 = xmmword_180101F18;
  v49 = xmmword_180101F08;
  do
  {
    *((_DWORD *)&v52[-1] + v21) = 0;
    *((_DWORD *)v52 + v21++ + 2) = 0;
  ...
  if ( (float)((double)((int)a4 - v53[0]) / (double)(int)qword_1801366F8) <= 0.0 )
  {
  ...
  else
  {
    ...
    v30 = (double)(*(_DWORD *)v12 - *(_DWORD *)a2) / (double)(int)qword_1801366F8;
