/*
 * XREFs of ?TrackingStateChanged_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@W4SPATIAL_TRACKING_STATE@@2@Z @ 0x1800BCB58
 * Callers:
...
int __fastcall HolographicDriverClientTrace::TrackingStateChanged_(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  if ( *(_DWORD *)v9 > 4u && (*(_BYTE *)(v9 + 16) & 2) != 0 )
  {
    ...
    if ( v8 == *(struct HolographicDriverClientTrace **)(v9 + 24) )
    {
      ...
      v26 = 0;
      v28 = 8LL;
      LODWORD(v8) = TlgWrite((TraceLoggingHProvider)v9, &unk_180110C68, 0LL, 0LL, 7u, &pData);
    }
  }
  return (int)v8;
}
