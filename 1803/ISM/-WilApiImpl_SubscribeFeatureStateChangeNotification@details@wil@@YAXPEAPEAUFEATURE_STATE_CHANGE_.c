/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x180012A00
 * Callers:
 *     <none>
 * Callees:
  ...
  *this = 0LL;
  if ( a3 != (void (*)(void *))-1LL )
  {
    if ( !wil::details::g_featureStateManager )
      return;
    AcquireSRWLockExclusive(&stru_180134630);
  ...
  {
    AcquireSRWLockExclusive(&stru_180134630);
    if ( !*((_QWORD *)&xmmword_180134660 + 1) )
    {
      v7 = qword_180134628;
      if ( qword_180134628 )
      {
        *((_QWORD *)&xmmword_180134660 + 1) = 0LL;
        AcquireSRWLockExclusive(qword_180134628);
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&v7[25],
          (struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ **)&xmmword_180134660 + 1,
    ...
    wil::details_abi::SubscriptionList::SubscribeUnderLock(
      (wil::details_abi::SubscriptionList *)&stru_1801346B8,
      this,
      (void (*)(void *))a2,
      0LL);
    if ( *this )
...
LABEL_11:
    ReleaseSRWLockExclusive(&stru_180134630);
  }
}
