/*
 * XREFs of ??_GDragNDropProcessorLegacy@@EEAAPEAXI@Z @ 0x1800B1D3C
 * Callers:
 *     ??_EDragNDropProcessorLegacy@@G7EAAPEAXI@Z @ 0x1800B2E00 (--_EDragNDropProcessorLegacy@@G7EAAPEAXI@Z.c)
 * Callees:
