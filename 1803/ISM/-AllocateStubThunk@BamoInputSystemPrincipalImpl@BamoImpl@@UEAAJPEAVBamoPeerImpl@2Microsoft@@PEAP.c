/*
 * XREFs of ?AllocateStubThunk@BamoInputSystemPrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x180021F90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSystemPrincipalImpl::AllocateStubThunk(
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoInputSystemPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
