/*
 * XREFs of ?DevicePropertyRequestFailed_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@1J@Z @ 0x1800BD9A8
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v9 > 4u && (*(_BYTE *)(v9 + 16) & 2) != 0 )
  {
    ...
    if ( v8 == *(struct HolographicDriverClientTrace **)(v9 + 24) )
    {
      ...
      v20 = 16LL;
      v22 = 4LL;
      LODWORD(v8) = TlgWrite((TraceLoggingHProvider)v9, &unk_180112673, 0LL, 0LL, 6u, &pData);
    }
  }
  return (int)v8;
}
