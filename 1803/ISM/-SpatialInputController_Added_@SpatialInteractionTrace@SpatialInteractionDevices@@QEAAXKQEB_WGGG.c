/*
 * XREFs of ?SpatialInputController_Added_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKQEB_WGGG@Z @ 0x1800A4724
 * Callers:
        ...
        char a6)
{
    ...
    && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v19 = &a6;
    v20 = 2LL;
    TlgWrite(v7, &unk_18010FBE6, 0LL, 0LL, 7u, &pData);
  }
}
