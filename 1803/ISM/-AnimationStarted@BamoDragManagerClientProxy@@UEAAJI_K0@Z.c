/*
 * XREFs of ?AnimationStarted@BamoDragManagerClientProxy@@UEAAJI_K0@Z @ 0x18001CE50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  v15[1] = v13;
  v12 = 4;
  v6 = CoreUICallSend(v14, v15, 2LL, 9LL, v12, &unk_1800F9692, a2);
LABEL_9:
  if ( v4 )
  {
