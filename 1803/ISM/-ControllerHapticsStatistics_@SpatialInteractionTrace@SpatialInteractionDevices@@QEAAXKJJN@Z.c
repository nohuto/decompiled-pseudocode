/*
 * XREFs of ?ControllerHapticsStatistics_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXKJJN@Z @ 0x1800D3EEC
 * Callers:
        ...
        double a5)
{
    ...
    && (*((_QWORD *)v5 + 3) & 0x400000000000LL) == *((_QWORD *)v5 + 3) )
  {
    ...
    v12 = 4LL;
    v14 = 8LL;
    TlgWrite(v5, &unk_180112B70, 0LL, 0LL, 6u, &pData);
  }
}
