/*
 * XREFs of ?OnDisconnectedThunk@BamoDataProviderStubImpl@BamoImpl@@UEAAJXZ @ 0x18008DCE0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !*(_DWORD *)(v3 + 140) )
  {
    ...
    if ( *(_DWORD *)(v3 + 136) != GetCurrentThreadId() )
    {
      wil::details::in1diag3::_FailFast_Unexpected(
        ...
        v5);
      JUMPOUT(0x18008DDA8LL);
    }
    *(_DWORD *)(v3 + 136) = 0;
    LeaveCriticalSection((LPCRITICAL_SECTION)(v3 + 96));
  }
  v6 = (*(__int64 (__fastcall **)(__int64, char *))(*(_QWORD *)(v2 - 16) + 72LL))(v2 - 16, (char *)this - 16);
  if ( v4 )
  {
