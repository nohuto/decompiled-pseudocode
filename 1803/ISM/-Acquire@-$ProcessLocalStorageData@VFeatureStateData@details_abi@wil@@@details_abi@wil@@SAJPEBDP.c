/*
 * XREFs of ?Acquire@?$ProcessLocalStorageData@VFeatureStateData@details_abi@wil@@@details_abi@wil@@SAJPEBDPEAPEAV123@@Z @ 0x1800159D8
 * Callers:
 ...
 *     ?GetLastErrorFailHr@details@wil@@YAJXZ @ 0x1800022F0 (-GetLastErrorFailHr@details@wil@@YAJXZ.c)
 ...
 *     ??0UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x180011A98 (--0UsageIndexes@details_abi@wil@@QEAA@XZ.c)
...
LABEL_20:
    ...
    *a2 = 0LL;
    ...
    v20 = HeapAlloc(ProcessHeap, 8u, 0x130uLL);
    v21 = v20;
    if ( v20 )
    {
      *(_OWORD *)hObject = 0LL;
      ...
      if ( v22 >= 0 )
      {
        ...
        *(_DWORD *)v21 = 1;
        ...
        v7 = 0LL;
        v21[3] = hObject[1];
        memset_0(v21 + 4, 0, 0x110uLL);
        v21[4] = 0LL;
        wil::details_abi::UsageIndexes::UsageIndexes((wil::details_abi::UsageIndexes *)(v21 + 5));
        InitializeCriticalSectionEx((LPCRITICAL_SECTION)(v21 + 29), 0, 0);
        v21[34] = 0LL;
        v21[35] = 0LL;
        v21[36] = 0LL;
        v21[37] = 0LL;
      ...
      {
        wil::details::in1diag3::Return_Hr(retaddr, (void *)0x140, (__int64)"wil", (const char *)(unsigned int)v22);
