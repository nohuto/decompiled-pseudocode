/*
 * XREFs of ?InputReportIgnored_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXKPEB_W@Z @ 0x1800A4CE0
 * Callers:
        ...
        const wchar_t *a3)
{
  ...
  v12 = a2;
  v4 = *((_QWORD *)SpatialInteractionDevices::SpatialInteractionTraceContinuous::Instance() + 1);
  if ( *(_DWORD *)v4 > 5u && (*(_BYTE *)(v4 + 16) & 2) != 0 && (*(_QWORD *)(v4 + 24) & 2LL) == *(_QWORD *)(v4 + 24) )
  {
    ...
    v9 = a3;
    v10 = 2 * v5 + 2;
    TlgWrite((TraceLoggingHProvider)v4, &unk_18010EFF2, 0LL, 0LL, 4u, &pData);
  }
}
