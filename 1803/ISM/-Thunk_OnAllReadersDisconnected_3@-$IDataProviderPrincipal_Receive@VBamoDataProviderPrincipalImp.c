/*
 * XREFs of ?Thunk_OnAllReadersDisconnected_3@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18008F9E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a1)
{
  ...
  v8 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(a1 - 16) + 88LL))(a1 - 16, v4);
  v9 = retaddr;
  if ( v8 < 0 )
  {
LABEL_13:
