/*
 * XREFs of ?RemoveDisplay@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAJPEAUIHolographicDisplay@Holographic@Graphics@4@@Z @ 0x1800A8114
 * Callers:
  ...
  if ( (__int64)&v7[-v8] >> 3 )
  {
    do
    {
        ...
        && v18[1] == v19[1] )
      {
        ...
        v10 = (char *)(*((_QWORD *)this + 40) + 8 * v6 + 8);
        if ( v10 != v9 )
        {
          do
          {
