/*
 * XREFs of ?DragEnded@DragNDrop@InputETW@@SAXKPEAUtagPOINT@@0_K@Z @ 0x180063454
 * Callers:
...
void __fastcall InputETW::DragNDrop::DragEnded(unsigned int a1, struct tagPOINT *a2, struct tagPOINT *a3, __int64 a4)
{
  __int64 v5; // rsi
  _DWORD *v7; // r9
  __int64 v8; // rcx
  ...
  if ( v7 )
  {
    if ( *v7 > 1u )
    {
      ...
      if ( *(_DWORD *)v8 > 5u && (*(_BYTE *)(v8 + 16) & 1) != 0 && (*(_QWORD *)(v8 + 24) & 1LL) == *(_QWORD *)(v8 + 24) )
      {
        ...
        v28 = 8;
        v31 = 8;
        TlgWrite((TraceLoggingHProvider)v8, &unk_18010EC6E, 0LL, 0LL, 8u, &pData);
      }
    }
  }
}
