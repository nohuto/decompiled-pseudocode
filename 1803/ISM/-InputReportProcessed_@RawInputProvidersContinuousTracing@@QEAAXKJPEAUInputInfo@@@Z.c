/*
 * XREFs of ?InputReportProcessed_@RawInputProvidersContinuousTracing@@QEAAXKJPEAUInputInfo@@@Z @ 0x18006F7D8
 * Callers:
        ...
        struct InputInfo *a4)
{
  ...
  if ( a3 >= 0 )
  {
    ...
    if ( *(_DWORD *)v6 > 5u && (*(_BYTE *)(v6 + 16) & 2) != 0 && (*(_QWORD *)(v6 + 24) & 2LL) == *(_QWORD *)(v6 + 24) )
    {
      ...
      v45 = 1LL;
      v47 = 4LL;
      TlgWrite((TraceLoggingHProvider)v6, &unk_18010EEB5, 0LL, 0LL, 0x15u, &v9);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v5 > 2u && (*(_BYTE *)(v5 + 16) & 2) != 0 && (*(_QWORD *)(v5 + 24) & 2LL) == *(_QWORD *)(v5 + 24) )
    {
      ...
      v50 = 4LL;
      v52 = 4LL;
      TlgWrite((TraceLoggingHProvider)v5, &unk_18010EE7C, 0LL, 0LL, 4u, &pData);
    }
  }
}
