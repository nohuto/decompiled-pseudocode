/*
 * XREFs of ?SetTimeoutMicroseconds@SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@UEAAJ_J@Z @ 0x1800D4D90
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a2)
{
  ...
  v4 = 1000000 * PerformanceCount.QuadPart / qword_1801366F8;
  v5 = a2 - v4;
  if ( a2 <= v4 )
    v5 = 1LL;
  v6 = 10 * v5;
