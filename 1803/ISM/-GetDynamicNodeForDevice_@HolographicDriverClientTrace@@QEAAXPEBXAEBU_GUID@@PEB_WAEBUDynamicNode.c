/*
 * XREFs of ?GetDynamicNodeForDevice_@HolographicDriverClientTrace@@QEAAXPEBXAEBU_GUID@@PEB_WAEBUDynamicNodeInfo@Holographic@Internal@Windows@@@Z @ 0x1800BCDD0
 * Callers:
        ...
        const struct Windows::Internal::Holographic::DynamicNodeInfo *a5)
{
    ...
    && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v20 = &v9;
    v21 = 4LL;
    TlgWrite(v7, &unk_180111F48, 0LL, 0LL, 7u, &pData);
  }
}
