/*
 * XREFs of ?SendInputModalityEvent@InputServiceProxy@@UEAAJUInputModalityInfo@@@Z @ 0x180025F10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InputServiceProxy::SendInputModalityEvent(__int64 a1, __int64 *a2)
{
  ...
  if ( v2 )
  {
    ...
    v4 = *v2;
    *(_QWORD *)v7 = v3;
    v5 = (*(__int64 (__fastcall **)(__int64 *, int *))(v4 + 280))(v2, v7);
    if ( v5 < 0 )
    {
