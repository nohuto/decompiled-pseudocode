/*
 * XREFs of ?FindRemoteEndpoint@RawButtonProcessor@@AEAAXXZ @ 0x1800B6A30
 * Callers:
 *     ?Create@RawButtonProcessor@@SAJPEAPEAV1@@Z @ 0x1800B673C (-Create@RawButtonProcessor@@SAJPEAPEAV1@@Z.c)
 *     ?OnFocusRequest@RawButtonProcessor@@UEAAJPEAUDeviceInfo@@PEAUInputContext@@PEAUContextualProcessorInitialState@@@Z @ 0x1800B68F0 (-OnFocusRequest@RawButtonProcessor@@UEAAJPEAUDeviceInfo@@PEAUInputContext@@PEAUContextualProcess.c)
 * Callees:
