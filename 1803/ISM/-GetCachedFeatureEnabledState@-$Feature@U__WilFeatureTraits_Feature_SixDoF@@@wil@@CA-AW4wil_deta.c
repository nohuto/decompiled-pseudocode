/*
 * XREFs of ?GetCachedFeatureEnabledState@?$Feature@U__WilFeatureTraits_Feature_SixDoF@@@wil@@CA?AW4wil_details_CachedFeatureEnabledState@@_N@Z @ 0x180041298
 * Callers:
...
__int64 wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetCachedFeatureEnabledState()
{
  ...
  else
  {
    ...
    if ( (unsigned int)wil_HasFeatureTestState(11272875, (enum wil_FeatureEnabledState *)&v16) )
    {
      v3 = v16;
      goto LABEL_11;
    }
...
LABEL_11:
  ...
  if ( v6 )
    ...
    v7 = 1;
  v8 = ((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetFeaturePropertyCache'::`2'::data >> 2) & 1;
  v1 = v7 + 1;
  if ( v0 )
    v1 = v0;
  else
...
LABEL_25:
    if ( v0 )
    {
      ...
      while ( (((unsigned int)`wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetFeaturePropertyCache'::`2'::data >> 4) & 3) != (unsigned __int8)v5
           && v13 != _InterlockedCompareExchange(
                       &`wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetFeaturePropertyCache'::`2'::data,
                       ((unsigned __int8)`wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetFeaturePropertyCache'::`2'::data ^ (unsigned __int8)(16 * v5)) & 0x30 ^ `wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetFeaturePropertyCache'::`2'::data,
                       `wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetFeaturePropertyCache'::`2'::data) );
    }
    else
    {
      ...
      do
      {
        v15 = `wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetFeaturePropertyCache'::`2'::data;
        v12 = `wil::Feature<__WilFeatureTraits_Feature_SixDoF>::GetFeaturePropertyCache'::`2'::data;
      }
