/*
 * XREFs of ?SetOnlyMixedWorldRouting@BamoMPCManagerProxy@@UEAAJ_N@Z @ 0x180028D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoMPCManagerProxy::SetOnlyMixedWorldRouting(BamoMPCManagerProxy *this, unsigned __int8 a2)
{
  __int64 v4; // rbx
  __int64 v5; // rdi
  unsigned int v6; // edi
...
LABEL_5:
  ...
  v13[1] = v16;
  v12 = 1;
  v6 = CoreUICallSend(v17, v13, 2LL, 23LL, v12, &unk_1800F9668, a2);
LABEL_9:
  if ( v4 )
  {
