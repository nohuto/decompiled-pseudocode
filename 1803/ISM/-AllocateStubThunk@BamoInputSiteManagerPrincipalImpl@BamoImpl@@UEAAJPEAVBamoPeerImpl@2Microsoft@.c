/*
 * XREFs of ?AllocateStubThunk@BamoInputSiteManagerPrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x18000B6D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoInputSiteManagerPrincipalImpl::AllocateStubThunk(
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoInputSiteManagerPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
