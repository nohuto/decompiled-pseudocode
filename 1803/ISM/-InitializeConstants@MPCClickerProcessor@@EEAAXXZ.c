/*
 * XREFs of ?InitializeConstants@MPCClickerProcessor@@EEAAXXZ @ 0x1800482C0
 * Callers:
...
void __fastcall MPCClickerProcessor::InitializeConstants(MPCClickerProcessor *this)
{
  ...
  if ( !std::_Execute_once(
          ...
          (int (*)(void *, void *, void **))std::_Callback_once<std::tuple<_lambda_5a74ae54013b7a0b63e4e3845ba7868b_ &&,std::exception_ptr &>,std::integer_sequence<unsigned __int64,0>,1>,
          v3) )
  {
