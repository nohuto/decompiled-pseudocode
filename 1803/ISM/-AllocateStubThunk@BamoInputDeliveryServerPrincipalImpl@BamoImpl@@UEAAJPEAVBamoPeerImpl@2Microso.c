/*
 * XREFs of ?AllocateStubThunk@BamoInputDeliveryServerPrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x180023460
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoInputDeliveryServerPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
