/*
 * XREFs of ?SendDisposeProxy@dataproviderBamoPeerImpl@BamoImpl@@UEAAXI@Z @ 0x18008ED40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dataproviderBamoPeerImpl::SendDisposeProxy(BamoImpl::dataproviderBamoPeerImpl *this, int a2)
{
  __int64 v2; // r8
  __int64 v3; // r10
  int v4; // eax
