/*
 * XREFs of ?GetDelegateSourceProcessId@MPCExclusiveInputTarget@@UEAAJPEAK@Z @ 0x1800881D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCExclusiveInputTarget::GetDelegateSourceProcessId(MPCExclusiveInputTarget *this, unsigned int *a2)
{
