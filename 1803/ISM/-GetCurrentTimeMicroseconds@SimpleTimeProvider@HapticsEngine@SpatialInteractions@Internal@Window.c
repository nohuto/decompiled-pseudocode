/*
 * XREFs of ?GetCurrentTimeMicroseconds@SimpleTimeProvider@HapticsEngine@SpatialInteractions@Internal@Windows@@UEAAJPEA_J@Z @ 0x1800D4CD0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        __int64 *a2)
{
  ...
  *a2 = 1000000 * PerformanceCount.QuadPart / qword_1801366F8;
  return 0LL;
}
