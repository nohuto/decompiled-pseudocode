/*
 * XREFs of ?OnMessage@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x180062690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDragNDropContextualProcessorPrincipalImpl::OnMessage(
        ...
        int a3)
{
  ...
  result = CoreUICallReceive(
             *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 56LL),
             &IDragNDropContextualProcessorPrincipal_Receive<BamoImpl::BamoDragNDropContextualProcessorPrincipalImpl>::Type,
