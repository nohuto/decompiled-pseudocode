/*
 * XREFs of ?ResetAndInitializeInteractionContext@MessageInfo@DragNDropProcessor@@QEAAJXZ @ 0x180063940
 * Callers:
 *     ?OnPointerInfoFrame@MessageInfo@DragNDropProcessor@@UEAAJKPEAUtagPOINTER_INFO_UNION@@@Z @ 0x180063A30 (-OnPointerInfoFrame@MessageInfo@DragNDropProcessor@@UEAAJKPEAUtagPOINTER_INFO_UNION@@@Z.c)
