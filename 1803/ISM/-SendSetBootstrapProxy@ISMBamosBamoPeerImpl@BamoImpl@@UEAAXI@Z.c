/*
 * XREFs of ?SendSetBootstrapProxy@ISMBamosBamoPeerImpl@BamoImpl@@UEAAXI@Z @ 0x18001E510
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::ISMBamosBamoPeerImpl::SendSetBootstrapProxy(BamoImpl::ISMBamosBamoPeerImpl *this, int a2)
{
  __int64 v2; // r8
  __int64 v3; // r10
  int v4; // eax
