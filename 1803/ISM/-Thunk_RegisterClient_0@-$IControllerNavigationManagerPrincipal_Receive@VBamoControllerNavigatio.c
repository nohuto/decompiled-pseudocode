/*
 * XREFs of ?Thunk_RegisterClient_0@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800302F0
 * Callers:
 *     <none>
 * Callees:
