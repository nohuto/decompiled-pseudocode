/*
 * XREFs of ?UnregisterSpatialEventHandlers@MPCSpatialGestureRecognizerHandler@@AEAAXXZ @ 0x18005B6F8
 * Callers:
 *     ??1MPCSpatialGestureRecognizerHandler@@UEAA@XZ @ 0x18005AF84 (--1MPCSpatialGestureRecognizerHandler@@UEAA@XZ.c)
 * Callees:
