/*
 * XREFs of ?SetHeatGripService@BamoInputSystemPrincipal@@UEAAXPEAVBamoHeatGripServicePrincipal@@@Z @ 0x1800216F0
 * Callers:
        ...
        struct BamoHeatGripServicePrincipal *a2)
{
  ...
  *((_QWORD *)v6 + 7) = a2;
  ...
  v8 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoInputSystemPrincipalImpl *>(
         v6,
         BamoImpl::BamoInputSystemPrincipalImpl::UpdateHeatGripServiceRemoteCacheStatic,
         v6);
  if ( v8 < 0 )
  {
