/*
 * XREFs of ?DriverCompatibilityDetermined_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@UHOLOGRAPHIC_DEVICE_SUPPORTED_DDI_LEVELS@@1_N@Z @ 0x1800BD624
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v7 > 4u && (*((_QWORD *)v7 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( v6 == *((struct HolographicDriverClientTrace **)v7 + 3) )
    {
      ...
      v24 = 4LL;
      v26 = 1LL;
      LODWORD(v6) = TlgWrite(v7, &unk_18011188F, 0LL, 0LL, 8u, &pData);
    }
  }
  return (int)v6;
}
