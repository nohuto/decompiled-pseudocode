/*
 * XREFs of ?OnInteractiveIntentGesture@MPCManagerClientPrincipal@@UEAAJPEAVBamoMPCManagerClientStub@@AEBULegacyDeviceInfo@@I@Z @ 0x18002A260
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  *((_QWORD *)v5 + 10) = v13;
  ...
  result = 0LL;
  if ( v18 )
    return (*(__int64 (__fastcall **)(__int64, _BYTE *, _QWORD))(*(_QWORD *)v18 + 24LL))(v18, v20, a4);
  return result;
}
