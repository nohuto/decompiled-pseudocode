/*
 * XREFs of ?RuntimeClassInitialize@SpatialRimDevice@SpatialInteractions@Internal@Windows@@QEAAJPEAVHIDDevice@@PEAX@Z @ 0x18007558C
 * Callers:
        ...
        void *a3)
{
  ...
  HANDLE v26; // rbx
  HANDLE v27; // rax
  DWORD dwDesiredAccess; // [rsp+28h] [rbp-39h]
  ...
  *((_DWORD *)this + 12) = *((_DWORD *)a2 + 10);
  ...
  {
    HIDCapabilities = HIDDevice::GetHIDCapabilities(a2, &v37);
    v4 = v37;
  }
...
LABEL_22:
  ...
  if ( !DuplicateHandle(v22, a3, CurrentProcess, (LPHANDLE)this + 19, 0, 0, 2u) )
  {
    v24 = 72LL;
  ...
  if ( !DuplicateHandle(v27, v25, v26, (LPHANDLE)this + 21, 0, 0, 2u) )
  {
    v24 = 73LL;
    return wil::details::in1diag3::Return_GetLastError(
             retaddr,
