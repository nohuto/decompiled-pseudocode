/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VRawInputProvidersTracing@@$00$0EAAAAAAAAAAA@$03U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180071BE0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<RawInputProvidersTracing,1,70368744177664,4,_TlgReflectorTag_Param0IsProviderType>::NotifyFailure(
        __int64 a1,
        int *a2)
{
  int v3; // edx
