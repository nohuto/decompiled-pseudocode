...
void __fastcall __noreturn std::_Hash_std::_Umap_traits_unsigned_long_unsigned___int64_std::_Uhash_compare_unsigned_long_std::hash_unsigned_long__std::equal_to_unsigned_long____std::allocator_std::pair_unsigned_long_const__unsigned___int64____0___::_Insert_std::pair_unsigned_long_const__unsigned___int64______ptr64_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_unsigned_long_const__unsigned___int64__________::_1_::catch_114(
        __int64 a1,
        __int64 a2)
{
  _QWORD *iter; // rax
