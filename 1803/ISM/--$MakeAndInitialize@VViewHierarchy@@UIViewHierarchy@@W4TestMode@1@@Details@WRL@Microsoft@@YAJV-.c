/*
 * XREFs of ??$MakeAndInitialize@VViewHierarchy@@UIViewHierarchy@@W4TestMode@1@@Details@WRL@Microsoft@@YAJV?$ComPtrRef@V?$ComPtr@UIViewHierarchy@@@WRL@Microsoft@@@012@$$QEAW4TestMode@ViewHierarchy@@@Z @ 0x18002D058
 * Callers:
 *     ?GetViewHierarchy@ISMStatics@@SAPEAUIViewHierarchy@@XZ @ 0x1800190B8 (-GetViewHierarchy@ISMStatics@@SAPEAUIViewHierarchy@@XZ.c)
 * Callees:
 *     ??0ViewHierarchy@@AEAA@XZ @ 0x18002B654 (--0ViewHierarchy@@AEAA@XZ.c)
        ...
        unsigned int *a2)
{
  ...
  *a1 = 0LL;
  v5 = (ViewHierarchy *)operator new(0xC8uLL, (const struct std::nothrow_t *)&std::nothrow);
  if ( v5 )
  {
