/*
 * XREFs of ?AllocateStubThunk@BamoMPCManagerPrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x1800545B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoMPCManagerPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
