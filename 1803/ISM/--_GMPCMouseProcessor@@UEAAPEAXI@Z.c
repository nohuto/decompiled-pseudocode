/*
 * XREFs of ??_GMPCMouseProcessor@@UEAAPEAXI@Z @ 0x18009695C
 * Callers:
 *     ??_EMPCMouseProcessor@@WBA@EAAPEAXI@Z @ 0x18009A690 (--_EMPCMouseProcessor@@WBA@EAAPEAXI@Z.c)
 * Callees:
