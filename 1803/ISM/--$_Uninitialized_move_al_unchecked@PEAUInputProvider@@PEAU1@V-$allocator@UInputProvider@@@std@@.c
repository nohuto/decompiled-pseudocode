/*
 * XREFs of ??$_Uninitialized_move_al_unchecked@PEAUInputProvider@@PEAU1@V?$allocator@UInputProvider@@@std@@@std@@YAPEAUInputProvider@@PEAU1@00AEAV?$allocator@UInputProvider@@@0@U_General_ptr_iterator_tag@0@U_Unused_parameter@0@@Z @ 0x18001A510
 * Callers:
        ...
        _OWORD *a3)
{
  ...
  {
    std::_Destroy_range<std::allocator<InputProvider>>(v7, v6);
    throw;
  }
  return a3;
}
