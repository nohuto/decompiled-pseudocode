/*
 * XREFs of ?HitTestForPoint@DWMInputRouter@@UEAA?AUHitTestResult@@UtagPOINT@@PEAUHMONITOR__@@@Z @ 0x18007FD30
 * Callers:
 *     <none>
 * Callees:
...
__int64 DWMInputRouter::HitTestForPoint(__int64 a1, __int64 a2, __int64 a3, ...)
{
  __int64 v3; // rdi
  int v7; // eax
  __int64 v8; // r8
  ...
  va_list va1; // [rsp+1D8h] [rbp+D0h] BYREF
