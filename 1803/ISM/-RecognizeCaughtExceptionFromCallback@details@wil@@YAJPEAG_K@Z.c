/*
 * XREFs of ?RecognizeCaughtExceptionFromCallback@details@wil@@YAJPEAG_K@Z @ 0x1800028C8
 * Callers:
 *     _wil::details::ResultFromCaughtExceptionInternal_::_1_::catch$2 @ 0x1800E333C (_wil--details--ResultFromCaughtExceptionInternal_--_1_--catch$2.c)
 * Callees:
