/*
 * XREFs of ?OnInteractiveIntentGesture@BamoMPCManagerClientProxy@@UEAAJAEBULegacyDeviceInfo@@I@Z @ 0x180028720
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct LegacyDeviceInfo *a2)
{
  ...
  struct IMessageCallSendHost *v27; // [rsp+40h] [rbp-C0h] BYREF
  _QWORD v28[3]; // [rsp+48h] [rbp-B8h] BYREF
  _BYTE v29[992]; // [rsp+60h] [rbp-A0h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+468h] [rbp+368h]
  unsigned int v31; // [rsp+470h] [rbp+370h] BYREF
  unsigned int v32; // [rsp+488h] [rbp+388h] BYREF
...
LABEL_5:
  ...
  *((_QWORD *)v11 + 10) = v19;
  ...
  v28[1] = v32;
  v26 = 0;
  v6 = CoreUICallSend(v27, v28, 2LL, 24LL, v26, &unk_1800F96CD, (unsigned int)v29);
LABEL_11:
  if ( v4 )
  {
