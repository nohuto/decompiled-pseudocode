/*
 * XREFs of ?BroadcastSetMatrix3x2Value@BamoDataSourcePrincipal@@UEAAJIAEBUD2D_MATRIX_3X2_F@@@Z @ 0x18008CA60
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct D2D_MATRIX_3X2_F *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 40LL) )
  {
    for ( i = *((_QWORD *)this + 5); i; i = *(_QWORD *)(i + 48) )
    {
      if ( *(_BYTE *)(i + 32) )
      {
        v10 = BamoImpl::BamoDataSourceStubImpl::SetMatrix3x2Value((BamoImpl::BamoDataSourceStubImpl *)i, a2, a3);
