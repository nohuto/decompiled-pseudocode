/*
 * XREFs of ?SetInputDeliveryServer@BamoInputSystemPrincipal@@UEAAXPEAVBamoInputDeliveryServerPrincipal@@@Z @ 0x180021820
 * Callers:
        ...
        struct BamoInputDeliveryServerPrincipal *a2)
{
  ...
  *((_QWORD *)v6 + 8) = a2;
  ...
  v8 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoInputSystemPrincipalImpl *>(
         v6,
         BamoImpl::BamoInputSystemPrincipalImpl::UpdateInputDeliveryServerRemoteCacheStatic,
         v6);
  if ( v8 < 0 )
  {
