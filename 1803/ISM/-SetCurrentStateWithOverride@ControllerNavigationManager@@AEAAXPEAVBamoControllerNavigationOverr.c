/*
 * XREFs of ?SetCurrentStateWithOverride@ControllerNavigationManager@@AEAAXPEAVBamoControllerNavigationOverrideProxy@@@Z @ 0x18002F618
 * Callers:
        ...
        struct BamoControllerNavigationOverrideProxy *a2)
{
  ...
  if ( v4 && (*(unsigned __int8 (__fastcall **)(__int64))(*((_QWORD *)v4 + 1) + 32LL))((__int64)v4 + 8) )
  {
    ...
    {
      if ( (int)ControllerProcessor::UpdateNavigationState(i[3], 1LL, 0LL, 0LL) < 0 )
      {
