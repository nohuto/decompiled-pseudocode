/*
 * XREFs of ?Thunk_MaterializeBamoDragManagerClientProxy_0@?$IBamoPeer_ISMBamos_Receive@VISMBamosBamoPeerImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001F2A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IBamoPeer_ISMBamos_Receive<BamoImpl::ISMBamosBamoPeerImpl>::Thunk_MaterializeBamoDragManagerClientProxy_0(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // esi
