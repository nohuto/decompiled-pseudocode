/*
 * XREFs of ?StartActivity@FinalizeControllerInitialization@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXK@Z @ 0x1800A337C
 * Callers:
        ...
        int a2)
{
  ...
  *(_DWORD *)v3 = 1;
    ...
    && (*((_QWORD *)v7 + 3) & 0x400000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    TlgWrite(v7, &unk_18011061D, (LPCGUID)(v9 + 8), v10, 4u, &pData);
  }
  if ( !*((_DWORD *)this + 8) )
  {
