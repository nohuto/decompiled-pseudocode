/*
 * XREFs of ??$_Create@UISpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@@?$Singleton@VSpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@V1234@@WRL@Microsoft@@CAJPEAPEAUISpatialGraphNodeReferenceFactory@Holographic@Internal@Windows@@W4Behavior@012@@Z @ 0x1800CDCC0
 * Callers:
 ...
 *     ??$AsWeak@UIInspectable@@@WRL@Microsoft@@YAJPEAUIInspectable@@PEAVWeakRef@01@@Z @ 0x1800CE96C (--$AsWeak@UIInspectable@@@WRL@Microsoft@@YAJPEAUIInspectable@@PEAVWeakRef@01@@Z.c)
        ...
        _QWORD *a1)
{
  ...
  int (__fastcall ***v17)(_QWORD, GUID *, __int64 *); // [rsp+90h] [rbp+40h] BYREF
  __int64 v18; // [rsp+A0h] [rbp+50h] BYREF
  RTL_SRWLOCK *v19; // [rsp+A8h] [rbp+58h]
  ...
  *a1 = 0LL;
  ...
  v4 = (__int64 (__fastcall ***)(_QWORD, GUID *, _QWORD *))v17;
  if ( v3 >= 0 )
  {
    if ( v17 )
    {
LABEL_47:
    ...
    v19 = &Microsoft::WRL::Singleton<Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory,Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory>::s_lockSingleton;
    v5 = v17;
    if ( v17 )
    {
      v17 = 0LL;
...
LABEL_46:
         ...
         + 1) )
    {
      while ( 1 )
      {
        ...
        {
          v16 = Microsoft::WRL::Singleton<Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory,Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory>::m_wpDestructorFinishedEvent;
          break;
        }
      }
    }
    if ( (_QWORD)v16 )
    {
      WaitForSingleObject(*(HANDLE *)(v16 + 8), 0xFFFFFFFF);
    ...
    v3 = Microsoft::WRL::Details::MakeAndInitialize<Microsoft::WRL::Singleton<Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory,Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory>,IInspectable,>(&v17);
...
LABEL_42:
    ...
    else
    {
      ...
      v3 = Microsoft::WRL::AsWeak<IInspectable>(
             ...
             &Microsoft::WRL::Singleton<Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory,Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory>::s_wpSingleton);
      v18 = 0LL;
      if ( (**v17)(v17, &GUID_9082dcb1_33fd_45f0_93e1_9152c2118ee8, &v18) >= 0 )
      {
        v10 = v18;
        v11 = *(volatile signed __int32 **)(v18 + 16);
        if ( v11 )
        {
        ...
        *(_QWORD *)&Microsoft::WRL::Singleton<Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory,Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory>::m_wpDestructorFinishedEvent = v12;
        v14 = (volatile signed __int32 *)*((_QWORD *)&Microsoft::WRL::Singleton<Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory,Windows::Internal::Holographic::SpatialGraphNodeReferenceFactory>::m_wpDestructorFinishedEvent
                                         + 1);
