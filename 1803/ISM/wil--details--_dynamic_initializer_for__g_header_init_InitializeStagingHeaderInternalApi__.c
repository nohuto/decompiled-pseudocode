/*
 * XREFs of wil::details::_dynamic_initializer_for__g_header_init_InitializeStagingHeaderInternalApi__ @ 0x180001430
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void (__fastcall *wil::details::_dynamic_initializer_for__g_header_init_InitializeStagingHeaderInternalApi__())(struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *this, struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *)
{
  ...
  g_wil_details_queueBackgroundSRUMUsageReporting = (void (*)(unsigned int, unsigned int, unsigned int))wil::details::QueueBackgroundSRUMUsageReporting;
