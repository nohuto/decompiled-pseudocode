/*
 * XREFs of ?StartActivity@TelemetryCloseHolographicDevice@HolographicDriverClientTrace@@QEAAXPEB_WW4TraceDriverType@@AEBU_GUID@@@Z @ 0x1800BBED0
 * Callers:
...
int __fastcall HolographicDriverClientTrace::TelemetryCloseHolographicDevice::StartActivity(
        __int64 a1,
        const WCHAR *a2,
        int a3,
        __int64 a4)
  ...
  *(_DWORD *)v8 = 1;
  ...
  if ( *(_DWORD *)v13 > 5u && (*((_QWORD *)v13 + 2) & 0x400000000000LL) != 0 )
  {
    ...
    if ( Local == *((struct HolographicDriverClientTrace **)v13 + 3) )
    {
      ...
      LODWORD(Local) = TlgWrite(v13, &unk_180110CBE, (LPCGUID)(v17 + 8), v18, 6u, &pData);
    }
  }
  if ( !*(_DWORD *)(a1 + 32) )
  {
