/*
 * XREFs of _anonymous_namespace_::MakePoseValid @ 0x18009B50C
 * Callers:
...
__int64 __fastcall anonymous_namespace_::MakePoseValid(__int64 a1)
{
  ...
  if ( !*(_BYTE *)(a1 + 28) )
  {
    *(_DWORD *)a1 = dword_180136950;
    *(_DWORD *)(a1 + 4) = dword_180136954;
    *(_DWORD *)(a1 + 8) = dword_180136958;
    *(_BYTE *)(a1 + 28) = 1;
  }
  if ( *(_BYTE *)(a1 + 29) )
  {
  ...
  {
    *(_DWORD *)(a1 + 12) = dword_1801357E0;
    *(_DWORD *)(a1 + 16) = dword_1801357E4;
    *(_DWORD *)(a1 + 20) = dword_1801357E8;
    *(_DWORD *)(a1 + 24) = dword_1801357EC;
    *(_BYTE *)(a1 + 29) = 1;
  }
  return result;
}
