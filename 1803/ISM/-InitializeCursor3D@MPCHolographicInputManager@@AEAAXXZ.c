/*
 * XREFs of ?InitializeCursor3D@MPCHolographicInputManager@@AEAAXXZ @ 0x18004FDAC
 * Callers:
...
void __fastcall MPCHolographicInputManager::InitializeCursor3D(MPCHolographicInputManager *this)
{
  ...
  v11[2] = 984;
  v11[1] = 514;
  v2 = (*(__int64 (__fastcall **)(_QWORD, _QWORD *))(**((_QWORD **)this + 243) + 72LL))(*((_QWORD *)this + 243), v10);
  if ( v2 < 0 )
  {
  ...
  v3 = (*(__int64 (__fastcall **)(_QWORD, _DWORD *, _QWORD, __int64 (__fastcall ****)(_QWORD, GUID *, char *)))(*(_QWORD *)v10[0] + 24LL))(
         v10[0],
         v11,
         0LL,
         &v9);
  ...
  v6 = (**v4)(v4, &GUID_a906d320_9167_4955_a961_8a982929b899, (char *)this + 1992);
  if ( v6 < 0 )
  {
    wil::details::in1diag3::FailFast_Hr(
      retaddr,
