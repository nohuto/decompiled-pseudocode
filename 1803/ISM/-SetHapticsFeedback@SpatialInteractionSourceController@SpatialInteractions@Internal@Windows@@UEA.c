/*
 * XREFs of ?SetHapticsFeedback@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJGEG@Z @ 0x1800D8A10
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int16 a4)
{
  ...
  v24 = -2LL;
  v18 = 0;
  v5 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 944);
...
LABEL_22:
  ...
  if ( v33 )
  {
    _InterlockedIncrement((volatile signed __int32 *)this + 251);
    _InterlockedExchangeAdd((volatile signed __int32 *)this + 252, v33);
  }
  else
  {
    _InterlockedIncrement((volatile signed __int32 *)this + 250);
  }
  v9 = (Windows::Internal::SpatialInteractions::HapticsEngine **)((char *)this + 984);
  v10 = (Windows::Internal::SpatialInteractions::HapticsEngine *)*((_QWORD *)this + 123);
  if ( !v10 )
  {
    v16 = 0;
    v30 = 0;
