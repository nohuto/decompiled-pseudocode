/*
 * XREFs of ?Initialize@?$KernelInputConnection@UtagQMSGINPUTREPORT@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBUtagQMSGINPUTREPORT@@@Z@std@@@Z @ 0x1800248DC
 * Callers:
        ...
        __int64 a4)
{
  ...
  result = MITCoreMsgKOpenConnectionTo(2LL, a1 + 3);
  if ( (int)result < 0 )
  {
