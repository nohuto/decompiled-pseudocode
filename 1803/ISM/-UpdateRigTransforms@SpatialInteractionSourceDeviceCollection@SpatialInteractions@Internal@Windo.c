/*
 * XREFs of ?UpdateRigTransforms@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAXPEAUIPerceptionTimestamp@Perception@4@PEA_J@Z @ 0x1800A8760
 * Callers:
 ...
 *     GetHeadToPose @ 0x1800A83D0 (GetHeadToPose.c)
 *     GetRigToHead @ 0x1800A85E4 (GetRigToHead.c)
        ...
        LARGE_INTEGER *a3)
{
  ...
  *(_OWORD *)&v19.m256i_u64[2] = _xmm;
  v10 = 0LL;
  v11 = 0LL;
  v12 = (struct _RTL_CRITICAL_SECTION *)((char *)this + 344);
  ...
  v19 = v16;
  *(__m128 *)((char *)this + 164) = DirectX::XMMatrixMultiply(*(double *)&v6, (__m128 *)&v17);
  *(_OWORD *)((char *)this + 180) = v7;
  *(_OWORD *)((char *)this + 196) = v8;
  *(_OWORD *)((char *)this + 212) = v9;
  *(_OWORD *)((char *)this + 228) = v6;
  *(_OWORD *)((char *)this + 244) = v7;
  *(_OWORD *)((char *)this + 260) = v8;
  *(_OWORD *)((char *)this + 276) = v9;
  if ( v11 )
