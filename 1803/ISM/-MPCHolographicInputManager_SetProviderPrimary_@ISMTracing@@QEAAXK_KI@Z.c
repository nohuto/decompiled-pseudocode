/*
 * XREFs of ?MPCHolographicInputManager_SetProviderPrimary_@ISMTracing@@QEAAXK_KI@Z @ 0x1800514E8
 * Callers:
  ...
  if ( v5 )
  {
    if ( *v5 )
    {
      ...
      if ( *(_DWORD *)v6 > 4u && (*(_BYTE *)(v6 + 16) & 1) != 0 && (*(_QWORD *)(v6 + 24) & 1LL) == *(_QWORD *)(v6 + 24) )
      {
        ...
        v20 = 2 * v13 + 2;
        v21 = 0;
        TlgWrite((TraceLoggingHProvider)v6, &unk_18010E180, 0LL, 0LL, 5u, &pData);
      }
    }
  }
}
