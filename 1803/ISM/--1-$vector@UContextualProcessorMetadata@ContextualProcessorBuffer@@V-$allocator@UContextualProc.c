/*
 * XREFs of ??1?$vector@UContextualProcessorMetadata@ContextualProcessorBuffer@@V?$allocator@UContextualProcessorMetadata@ContextualProcessorBuffer@@@std@@@std@@QEAA@XZ @ 0x1800B0FEC
 * Callers:
        ...
        __int64 a1)
{
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    {
      if ( (unsigned __int64)(24 * v7) < 0x1000 )
      {
LABEL_15:
        operator delete(v2);
        *(_QWORD *)a1 = 0LL;
      ...
      {
        v8 = *(v2 - 1);
        if ( v8 < (unsigned __int64)v2 && (unsigned __int64)v2 - v8 - 8 <= 0x1F )
        {
          v2 = (__int64 *)*(v2 - 1);
          goto LABEL_15;
        }
    ...
    std::vector<ContextualProcessorBuffer::InputSample>::_Change_array(v10, v9, v11, v12);
  }
}
