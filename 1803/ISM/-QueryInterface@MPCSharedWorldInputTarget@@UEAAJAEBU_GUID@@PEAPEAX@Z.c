/*
 * XREFs of ?QueryInterface@MPCSharedWorldInputTarget@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800888C0
 * Callers:
 *     ?QueryInterface@MPCSharedWorldInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180089730 (-QueryInterface@MPCSharedWorldInputTarget@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCSharedWorldInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180089740 (-QueryInterface@MPCSharedWorldInputTarget@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@MPCSharedWorldInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180089760 (-QueryInterface@MPCSharedWorldInputTarget@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
