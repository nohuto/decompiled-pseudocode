/*
 * XREFs of ?SetControllerNavigationManager@BamoInputSystemPrincipal@@UEAAXPEAVBamoControllerNavigationManagerPrincipal@@@Z @ 0x180021A80
 * Callers:
        ...
        struct BamoControllerNavigationManagerPrincipal *a2)
{
  ...
  *((_QWORD *)v6 + 10) = a2;
  ...
  v8 = Microsoft::BamoImpl::BamoPrincipalImpl::EnumerateStubs<BamoImpl::BamoInputSystemPrincipalImpl *>(
         v6,
         BamoImpl::BamoInputSystemPrincipalImpl::UpdateControllerNavigationManagerRemoteCacheStatic,
         v6);
  if ( v8 < 0 )
  {
