/*
 * XREFs of ?AllocateStubThunk@BamoMPCManagerClientPrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x18002B460
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoMPCManagerClientPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
