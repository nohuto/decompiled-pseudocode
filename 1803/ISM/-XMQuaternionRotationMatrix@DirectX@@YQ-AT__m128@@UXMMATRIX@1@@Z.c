/*
 * XREFs of ?XMQuaternionRotationMatrix@DirectX@@YQ?AT__m128@@UXMMATRIX@1@@Z @ 0x1800D304C
 * Callers:
...
__m128 __fastcall DirectX::XMQuaternionRotationMatrix(double a1, double a2, double a3)
{
  ...
  v4 = _mm_shuffle_ps(*(__m128 *)&a1, *(__m128 *)&a1, 0);
  v5 = *(__m128 *)&a1;
  v6 = _mm_shuffle_ps(*(__m128 *)&a3, *(__m128 *)&a3, 170);
  v7 = _mm_cmple_ps(v6, (__m128)DirectX::g_XMZero);
  v8 = _mm_cmple_ps(_mm_add_ps(v3, v4), (__m128)DirectX::g_XMZero);
  v9 = _mm_cmple_ps(_mm_sub_ps(v3, v4), (__m128)DirectX::g_XMZero);
  v10 = _mm_add_ps(
          _mm_mul_ps((__m128)`DirectX::XMQuaternionRotationMatrix'::`2'::XMMPMP, v3),
          _mm_mul_ps((__m128)`DirectX::XMQuaternionRotationMatrix'::`2'::XMPMMP, v4));
  v11 = _mm_shuffle_ps(*(__m128 *)&a2, *(__m128 *)&a3, 64);
  v12 = _mm_add_ps(_mm_shuffle_ps(v5, *(__m128 *)&a2, 105), _mm_shuffle_ps(v11, v11, 120));
  v13 = _mm_shuffle_ps(*(__m128 *)&a2, v5, 106);
  v14 = _mm_add_ps(
