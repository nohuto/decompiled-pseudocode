/*
 * XREFs of ?NodePropertyRequestFailed_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0J@Z @ 0x1800BDE1C
 * Callers:
        ...
        char a5)
{
  ...
  if ( *(_DWORD *)v8 > 4u && (*(_BYTE *)(v8 + 16) & 2) != 0 && (*(_QWORD *)(v8 + 24) & 2LL) == *(_QWORD *)(v8 + 24) )
  {
    ...
    v15 = 16LL;
    v17 = 4LL;
    TlgWrite((TraceLoggingHProvider)v8, &unk_1801120B1, 0LL, 0LL, 6u, &pData);
  }
}
