/*
 * XREFs of ??$GetPropertyValue@_K@@YAJPEAUIPropertySet@Collections@Foundation@Windows@@PEBGPEA_K@Z @ 0x18007A684
 * Callers:
...
__int64 __fastcall GetPropertyValue<unsigned __int64>(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 v5; // rbx
  int v6; // edi
  __int64 v7; // rdi
...
LABEL_2:
      ...
      if ( v6 >= 0 )
        v6 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v15 + 112LL))(v15, a3);
    }
  }
LABEL_10:
  v10 = v15;
