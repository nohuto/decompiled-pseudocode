/*
 * XREFs of ?GetErrorStatuses_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@QEB_WAEBUHOLOGRAPHIC_DEVICE_ERROR_STATUSES@@@Z @ 0x1800BD74C
 * Callers:
  ...
  if ( *a4 < 0xFFFFu )
  {
    ...
    if ( *(_DWORD *)v8 > 4u && (*((_QWORD *)v8 + 2) & 0x400000000000LL) != 0 )
    {
      ...
      if ( v4 == *((struct HolographicDriverClientTrace **)v8 + 3) )
      {
        ...
        v23 = 16 * v11 + 4;
        v24 = 0;
        LODWORD(v4) = TlgWrite(v8, &unk_180111BC6, 0LL, 0LL, 6u, &pData);
      }
    }
  }
  return (int)v4;
