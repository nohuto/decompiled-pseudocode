/*
 * XREFs of ?GetInteractionObject@MPCSharedWorldInputTarget@@UEBAIXZ @ 0x180089050
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCSharedWorldInputTarget::GetInteractionObject(MPCSharedWorldInputTarget *this)
{
...
LABEL_7:
    ...
    JUMPOUT(0x1800890F9LL);
  }
  v4 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 64LL))(v8);
  v5 = v8;
  if ( v8 )
  {
    v8 = 0LL;
