/*
 * XREFs of ?OnKeyPress@KeyboardProcessorTelemetry@@QEAAX_N@Z @ 0x180069EBC
 * Callers:
...
void __fastcall KeyboardProcessorTelemetry::OnKeyPress(KeyboardProcessorTelemetry *this)
{
  ...
  if ( (unsigned int)hProvider > 5
    && (qword_180134050 & 0x200000000000LL) != 0
    && (qword_180134058 & 0x200000000000LL) == qword_180134058 )
  {
    v2 = *(_DWORD *)this;
    v4 = &v2;
    v6 = 0;
    v5 = 4;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18010ECE1, 0LL, 0LL, 3u, &v3);
  }
  *(_DWORD *)this = 0;
}
