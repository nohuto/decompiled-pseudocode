/*
 * XREFs of ?SendDisposeProxy@ISMBamosBamoPeerImpl@BamoImpl@@UEAAXI@Z @ 0x18001E690
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::ISMBamosBamoPeerImpl::SendDisposeProxy(BamoImpl::ISMBamosBamoPeerImpl *this, int a2)
{
  __int64 v2; // r8
  __int64 v3; // r10
  int v4; // eax
