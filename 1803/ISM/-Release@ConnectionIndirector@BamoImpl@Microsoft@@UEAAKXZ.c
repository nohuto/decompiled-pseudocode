/*
 * XREFs of ?Release@ConnectionIndirector@BamoImpl@Microsoft@@UEAAKXZ @ 0x18000AC40
 * Callers:
 *     ?Release@ConnectionIndirector@BamoImpl@Microsoft@@WBA@EAAKXZ @ 0x180021100 (-Release@ConnectionIndirector@BamoImpl@Microsoft@@WBA@EAAKXZ.c)
 * Callees:
