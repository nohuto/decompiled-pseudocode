/*
 * XREFs of ?Stop@?$ActivityBase@VHolographicDriverClientTrace@@$0A@$0A@$04U_TlgReflectorTag_Param0IsProviderType@@@wil@@QEAAXJ@Z @ 0x1800CA4AC
 * Callers:
  ...
  *(_DWORD *)(v2 + 72) = v5;
  ...
  if ( v5 )
  {
    ...
    if ( *(_DWORD *)v7 > 5u )
    {
      ...
      p_SRWLock = &SRWLock;
      v21 = 4;
      LODWORD(v6) = TlgWrite(v7, &unk_180111A19, (LPCGUID)(*(_QWORD *)(a1 + 48) + 8LL), 0LL, 4u, &pData);
    }
  }
  else
  {
