/*
 * XREFs of ?Unregister@BamoDataProviderRegistrarProxy@@UEAAJPEAVBamoDataProviderPrincipal@@@Z @ 0x18008BF60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( a2 )
  {
    v9 = (Microsoft::BamoImpl::BamoPrincipalImpl *)(*(__int64 (__fastcall **)(struct BamoDataProviderPrincipal *))(*(_QWORD *)a2 + 32LL))(a2);
  ...
  v14[1] = v17;
  v13 = 1;
  v6 = CoreUICallSend(v18, v14, 2LL, 2LL, v13, &unk_1800FE145, (_DWORD)a2);
LABEL_11:
  if ( v5 )
  {
