/*
 * XREFs of ?BroadcastSetBooleanValue@BamoDataSourcePrincipal@@UEAAJI_N@Z @ 0x18008C170
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetBooleanValue@BamoDataSourceStubImpl@BamoImpl@@QEAAJI_N@Z @ 0x18008E244 (-SetBooleanValue@BamoDataSourceStubImpl@BamoImpl@@QEAAJI_N@Z.c)
 */
        ...
        bool a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 24LL) + 40LL) )
  {
    for ( i = *((_QWORD *)this + 5); i; i = *(_QWORD *)(i + 48) )
    {
      if ( *(_BYTE *)(i + 32) )
      {
        v10 = BamoImpl::BamoDataSourceStubImpl::SetBooleanValue((BamoImpl::BamoDataSourceStubImpl *)i, a2, a3);
