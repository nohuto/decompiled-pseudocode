/*
 * XREFs of ?Thunk_UpdateRunState_0@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180066E80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  v6 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(a1 - 16) + 88LL))(a1 - 16);
  v7 = retaddr;
  if ( v6 < 0 )
    goto LABEL_10;
  if ( v4 )
