/*
 * XREFs of ?GetThreadId@MPCSharedWorldInputTarget@@UEAAJPEAK@Z @ 0x180089310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCSharedWorldInputTarget::GetThreadId(MPCSharedWorldInputTarget *this, unsigned int *a2)
{
...
LABEL_7:
  ...
  if ( v4 < 0 )
    goto LABEL_7;
  v6 = (*(__int64 (__fastcall **)(__int64, unsigned int *))(*(_QWORD *)v10 + 40LL))(v10, a2);
  v7 = v10;
  if ( v10 )
  {
    v10 = 0LL;
