/*
 * XREFs of ?PropertyCache_SetValue_@HolographicDriverClientTrace@@QEAAXW4TraceDriverType@@AEBU_GUID@@1PEBX_K@Z @ 0x1800BDEEC
 * Callers:
 ...
 *     ?LogValueChanged@PropertyCache@Holographic@Internal@Windows@@MEAAXAEBU_GUID@@AEBV?$vector@EV?$allocator@E@std@@@std@@@Z @ 0x1800C11E0 (-LogValueChanged@PropertyCache@Holographic@Internal@Windows@@MEAAXAEBU_GUID@@AEBV-$vector@EV-$al.c)
 * Callees:
        ...
        char a6)
{
  ...
  if ( *(_DWORD *)v10 > 4u && (*(_BYTE *)(v10 + 16) & 2) != 0 )
  {
    ...
    if ( v9 == *(struct HolographicDriverClientTrace **)(v10 + 24) )
    {
      ...
      v21 = 16LL;
      v23 = 8LL;
      LODWORD(v9) = TlgWrite((TraceLoggingHProvider)v10, &unk_180111D58, 0LL, 0LL, 6u, &pData);
    }
  }
  return (int)v9;
}
