/*
 * XREFs of ??0V2DevicePropertyRequest@Holographic@Internal@Windows@@QEAA@AEAVHolographicDriverHandleWrapper@123@KIAEBU_GUID@@P6AJPEBX_K@Z$$QEAV?$function@$$A6AXAEAVV2DevicePropertyRequest@Holographic@Internal@Windows@@J@Z@std@@@Z @ 0x1800C1FB4
 * Callers:
        ...
        __int64 a7)
{
  ...
  *(_QWORD *)(a1 + 64) = 24LL;
  *(_QWORD *)(a1 + 72) = a1 + 144;
  std::vector<unsigned char>::vector<unsigned char>(a1 + 80, 12LL);
  *(_DWORD *)(a1 + 104) = 0;
  *(_QWORD *)(a1 + 112) = a6;
  *(_DWORD *)(a1 + 120) = 0;
