/*
 * XREFs of ?StopActivity@DeviceRemoved@SpatialInteractionTrace@SpatialInteractionDevices@@MEAAXXZ @ 0x1800A3530
 * Callers:
 *     <none>
 * Callees:
  ...
  **((_DWORD **)this + 6) = 2;
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)v6 > 4u )
    {
      ...
      v83 = v9 + 1;
      v84 = 0;
      TlgWrite(v6, &unk_18010FC93, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 0x13u, &pData);
    }
  }
  else
  {
    ...
    if ( *(_DWORD *)v26 > 4u )
    {
      ...
      v34 = CurrentThreadId;
      v88 = &v34;
      TlgWrite(v26, &unk_18010FC55, (LPCGUID)(*((_QWORD *)this + 6) + 8LL), 0LL, 4u, &v85);
    }
  }
  if ( *((_DWORD *)this + 8) )
  {
