/*
 * XREFs of _dynamic_atexit_destructor_for__ISMStatics::s_inputSystemBamoConnection__ @ 0x1800EABA0
 * Callers:
 *     <none>
 * Callees:
...
void dynamic_atexit_destructor_for__ISMStatics::s_inputSystemBamoConnection__()
{
  ...
  if ( ISMStatics::s_inputSystemBamoConnection )
  {
    ...
    v1 = (void (__fastcall ***)(_QWORD))(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v0 + 40LL))(v0);
    (**v1)(v1);
  }
}
