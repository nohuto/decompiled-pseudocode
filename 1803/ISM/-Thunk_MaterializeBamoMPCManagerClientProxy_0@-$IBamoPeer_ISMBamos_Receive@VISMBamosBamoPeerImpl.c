/*
 * XREFs of ?Thunk_MaterializeBamoMPCManagerClientProxy_0@?$IBamoPeer_ISMBamos_Receive@VISMBamosBamoPeerImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18001FDE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IBamoPeer_ISMBamos_Receive<BamoImpl::ISMBamosBamoPeerImpl>::Thunk_MaterializeBamoMPCManagerClientProxy_0(
        __int64 a1,
        unsigned int **a2)
{
  unsigned int v3; // ebp
  ...
  *(_QWORD *)v7 = &BamoMPCManagerClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  *((_QWORD *)v7 + 1) = &BamoMPCManagerClientProxy::`vftable'{for `IMPCManagerClientProxy'};
  *((_DWORD *)v7 + 6) = 0;
  *((_QWORD *)v7 + 4) = 0LL;
  *((_DWORD *)v7 + 10) = 0;
  *((_WORD *)v7 + 22) = 0;
  *((_QWORD *)v7 + 2) = &BamoImpl::BamoInputSiteManagerProxyImpl::`vftable';
  if ( v5 )
  {
