/*
 * XREFs of ?DeleteWorkItemsForSourceDevice@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAXPEBVSpatialInteractionSourceDevice@234@@Z @ 0x1800A67D4
 * Callers:
        ...
        const struct Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice *a2)
{
  ...
  v2 = this + 12;
  p_LockCount = &this[13].LockCount;
  EnterCriticalSection(this + 12);
  v5 = *((_QWORD *)p_LockCount + 3);
  v6 = *(_QWORD *****)p_LockCount;
  while ( v5 != *((_QWORD *)p_LockCount + 3) + *((_QWORD *)p_LockCount + 4) )
  {
    if ( v6 )
      v7 = *v6;
    else
    ...
    if ( *(const struct Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice **)*v8 == a2
      && *(_BYTE *)(*v8 + 80LL) )
    {
      v10 = 0LL;
      if ( v6 && *v6 )
      ...
      if ( v10 && *v10 )
        *(_QWORD *)&v15 = **v10;
      v16 = v5;
      ((void (__fastcall *)(LONG *, _QWORD *, __int128 *, __int128 *))std::deque<std::shared_ptr<Windows::Internal::SpatialInteractions::SpatialInteractionSourceDeviceCollection::AsynchronousWorkItem>>::erase)(
        p_LockCount,
        v17,
        &v15,
        &v13);
