/*
 * XREFs of ?SendAckProxyReference@dataproviderBamoPeerImpl@BamoImpl@@UEAAXI_N@Z @ 0x18008EC40
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall BamoImpl::dataproviderBamoPeerImpl::SendAckProxyReference(
        ...
        int a2)
{
  ...
  v5 = 5;
  v4 = CoreUICallSend(v3, v6, 2LL, 6LL, v5, &unk_1800FE148, a2);
  if ( v4 < 0 )
  {
