/*
 * XREFs of ?SetBooleanValue@BamoDataSourceStub@@UEAAJI_N@Z @ 0x18008CF40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoDataSourceStub::SetBooleanValue(BamoDataSourceStub *this, unsigned int a2, bool a3)
{
  ...
  v8 = BamoImpl::BamoDataSourceStubImpl::SetBooleanValue((BamoDataSourceStub *)((char *)this + 8), a2, a3);
  if ( v6 )
  {
