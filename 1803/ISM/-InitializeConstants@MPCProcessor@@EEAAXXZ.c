/*
 * XREFs of ?InitializeConstants@MPCProcessor@@EEAAXXZ @ 0x180045730
 * Callers:
...
void __fastcall MPCProcessor::InitializeConstants(MPCProcessor *this)
{
  ...
  if ( !std::_Execute_once(
          ...
          (int (*)(void *, void *, void **))std::_Callback_once<std::tuple<_lambda_301fd7a8fc024bbcef569520ec2ad4e1_ &&,std::exception_ptr &>,std::integer_sequence<unsigned __int64,0>,1>,
          v3) )
  {
