/*
 * XREFs of ?RuntimeClassInitialize@InputServiceProxy@@QEAAJPEAUIInputServiceProxyOwner@@@Z @ 0x180025A1C
 * Callers:
        ...
        struct IInputServiceProxyOwner *a2)
{
  ...
  int v12; // esi
  MessageProxyReconnectAdapter *v13; // rbx
  ...
  *((_QWORD *)this + 5) = 0LL;
  ...
  v13 = MessageProxyReconnectAdapter::MessageProxyReconnectAdapter(v11);
  *(_QWORD *)ReturnLength = v13;
  v17 = 0LL;
  v12 = MessageProxyReconnectAdapter::RuntimeClassInitialize(
          v13,
  ...
  {
    if ( v13 )
      (*(void (__fastcall **)(MessageProxyReconnectAdapter *))(*(_QWORD *)v13 + 8LL))(v13);
    *((_QWORD *)this + 5) = v13;
    if ( v13 )
      (*(void (__fastcall **)(MessageProxyReconnectAdapter *))(*(_QWORD *)v13 + 16LL))(v13);
    v12 = 0;
  }
  else if ( v13 )
  {
