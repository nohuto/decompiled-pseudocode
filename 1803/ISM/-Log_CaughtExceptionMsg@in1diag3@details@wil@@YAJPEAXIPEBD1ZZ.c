/*
 * XREFs of ?Log_CaughtExceptionMsg@in1diag3@details@wil@@YAJPEAXIPEBD1ZZ @ 0x18002D598
 * Callers:
 *     _ViewHierarchy::GetAllAncestors_::_1_::catch$100 @ 0x1800E4782 (_ViewHierarchy--GetAllAncestors_--_1_--catch$100.c)
 * Callees:
