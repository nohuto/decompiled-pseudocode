/*
 * XREFs of ?Thunk_UpdateVertex1_85@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180066BC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IEdgyControllerClientProxy_Receive<BamoImpl::BamoEdgyControllerClientProxyImpl>::Thunk_UpdateVertex1_85(
        __int64 a1,
        _QWORD **a2)
{
  __int64 v3; // rdi
