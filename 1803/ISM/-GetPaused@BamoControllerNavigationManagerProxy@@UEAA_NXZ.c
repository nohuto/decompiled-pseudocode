/*
 * XREFs of ?GetPaused@BamoControllerNavigationManagerProxy@@UEAA_NXZ @ 0x18001C370
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall BamoControllerNavigationManagerProxy::GetPaused(BamoControllerNavigationManagerProxy *this)
{
  __int64 v2; // rbx
  __int64 v3; // rdi
  char v4; // di
