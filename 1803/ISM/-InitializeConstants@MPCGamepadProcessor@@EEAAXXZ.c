/*
 * XREFs of ?InitializeConstants@MPCGamepadProcessor@@EEAAXXZ @ 0x1800935D0
 * Callers:
...
void __fastcall MPCGamepadProcessor::InitializeConstants(MPCGamepadProcessor *this)
{
  ...
  if ( !std::_Execute_once(
          ...
          (int (*)(void *, void *, void **))std::_Callback_once<std::tuple<_lambda_172571034a44f8156ea06ee89e7e6c96_ &&,std::exception_ptr &>,std::integer_sequence<unsigned __int64,0>,1>,
          v3) )
  {
