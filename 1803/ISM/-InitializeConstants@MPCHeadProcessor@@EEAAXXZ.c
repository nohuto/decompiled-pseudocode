/*
 * XREFs of ?InitializeConstants@MPCHeadProcessor@@EEAAXXZ @ 0x180047D30
 * Callers:
...
void __fastcall MPCHeadProcessor::InitializeConstants(MPCHeadProcessor *this)
{
  ...
  if ( !std::_Execute_once(
          ...
          (int (*)(void *, void *, void **))std::_Callback_once<std::tuple<_lambda_286394bed54c76db5c0d94726973c3a4_ &&,std::exception_ptr &>,std::integer_sequence<unsigned __int64,0>,1>,
          v3) )
  {
