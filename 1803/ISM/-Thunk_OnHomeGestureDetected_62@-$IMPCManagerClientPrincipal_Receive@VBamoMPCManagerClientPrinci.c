/*
 * XREFs of ?Thunk_OnHomeGestureDetected_62@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18002AF40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCManagerClientPrincipal_Receive<BamoImpl::BamoMPCManagerClientPrincipalImpl>::Thunk_OnHomeGestureDetected_62(
        __int64 a1,
        unsigned int **a2)
{
  ...
  v11 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD))(*(_QWORD *)(a1 - 16) + 120LL))(
          a1 - 16,
          v7,
          v4,
          v3);
