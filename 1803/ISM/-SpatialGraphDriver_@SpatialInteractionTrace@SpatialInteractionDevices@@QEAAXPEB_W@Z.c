/*
 * XREFs of ?SpatialGraphDriver_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXPEB_W@Z @ 0x1800A4544
 * Callers:
        ...
        const wchar_t *a2)
{
  ...
  if ( *(_DWORD *)v3 > 4u && (*(_BYTE *)(v3 + 16) & 2) != 0 && (*(_QWORD *)(v3 + 24) & 2LL) == *(_QWORD *)(v3 + 24) )
  {
    ...
    v6 = a2;
    v7 = 2 * v4 + 2;
    TlgWrite((TraceLoggingHProvider)v3, &unk_1801101AD, 0LL, 0LL, 3u, &pData);
  }
}
