/*
 * XREFs of ??$_Callback_once@V?$tuple@$$QEAV_lambda_fdfea97a1e4915bc7c15af4fd38df93b_@@$$QEAPEAVWGIRawInputProvider@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@$00@2@$01@std@@YAHPEAX0PEAPEAX@Z @ 0x180077C70
 * Callers:
 *     <none>
 * Callees:
 *     ??0exception@std@@QEAA@XZ @ 0x180001A18 (--0exception@std@@QEAA@XZ.c)
