/*
 * XREFs of ?ReportFailure@details@wil@@YAXPEAXIPEBD110W4FailureType@2@JPEBGW4ReportFailureOptions@12@@Z @ 0x180002DA0
 * Callers:
 ...
 *     ?ReportFailure_CaughtExceptionCommon@details@wil@@YAJPEAXIPEBD110W4FailureType@2@PEAG_KW4SupportedExceptions@2@@Z @ 0x18000970C (-ReportFailure_CaughtExceptionCommon@details@wil@@YAJPEAXIPEBD110W4FailureType@2@PEAG_KW4Support.c)
 ...
 *     ?ReportFailure_Win32@details@wil@@YAJPEAXIPEBD110W4FailureType@2@K@Z @ 0x180044DB4 (-ReportFailure_Win32@details@wil@@YAJPEAXIPEBD110W4FailureType@2@K@Z.c)
 * Callees:
        ...
        char a10)
{
  ...
  wil::details::LogFailure(a1, a2, a3, a4, a5, a6, a7, a8, a9, v10, (wil *)v15, v11, v14, v12, (unsigned __int64)v13);
  if ( (a10 & 2) == 0 )
  {
    if ( a7 == 3 )
      goto LABEL_16;
