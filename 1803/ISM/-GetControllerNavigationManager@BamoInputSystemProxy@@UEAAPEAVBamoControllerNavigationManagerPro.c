/*
 * XREFs of ?GetControllerNavigationManager@BamoInputSystemProxy@@UEAAPEAVBamoControllerNavigationManagerProxy@@XZ @ 0x18001D7C0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSystemProxy *this)
{
  ...
  return (struct BamoControllerNavigationManagerProxy *)*((_QWORD *)this + 10);
}
