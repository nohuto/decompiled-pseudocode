/*
 * XREFs of ?AllocateStubThunk@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@UEAAJPEAVBamoPeerImpl@2Microsoft@@PEAPEAVBamoStub@Bamo@4@@Z @ 0x180030A30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::Bamo::BamoStub **a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(BamoImpl::BamoControllerNavigationManagerPrincipalImpl *))(*(_QWORD *)this + 48LL))(this);
