/*
 * XREFs of ?GetEnabled@BamoControllerNavigationManagerPrincipal@@UEAA_NXZ @ 0x18002FEA0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall BamoControllerNavigationManagerPrincipal::GetEnabled(BamoControllerNavigationManagerPrincipal *this)
{
  __int64 v2; // rbx
  __int64 v3; // rdi
  char v4; // di
