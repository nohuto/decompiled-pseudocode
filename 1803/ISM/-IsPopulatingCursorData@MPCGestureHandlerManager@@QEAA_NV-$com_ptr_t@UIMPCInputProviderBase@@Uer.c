/*
 * XREFs of ?IsPopulatingCursorData@MPCGestureHandlerManager@@QEAA_NV?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x1800555C8
 * Callers:
...
LABEL_11:
  ...
  {
    v10 = *(_QWORD *)(*(_QWORD *)std::map<wil::com_ptr_t<IMPCInputProviderBase,wil::err_exception_policy>,wil::com_ptr_t<MPCGestureHandler,wil::err_exception_policy>>::operator[](v3)
                    + 920LL);
    v11 = *(_BYTE *)(v10 + 172) && *(_DWORD *)(v10 + 168);
    if ( *a2 )
      (*(void (__fastcall **)(unsigned __int64))(*(_QWORD *)*a2 + 16LL))(*a2);
    return v11;
  }
