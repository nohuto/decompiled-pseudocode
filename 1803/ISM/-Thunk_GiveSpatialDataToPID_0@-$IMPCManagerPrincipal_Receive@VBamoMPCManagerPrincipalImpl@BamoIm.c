/*
 * XREFs of ?Thunk_GiveSpatialDataToPID_0@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180053D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IMPCManagerPrincipal_Receive<BamoImpl::BamoMPCManagerPrincipalImpl>::Thunk_GiveSpatialDataToPID_0(
        __int64 a1,
        unsigned int **a2)
{
