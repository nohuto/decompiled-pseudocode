/*
 * XREFs of ?MPCInputRouter_UpdateFocusedInputTarget_@ISMTracing@@QEAAXPEAUIInputTarget@@_NPEAUIMPCInputPostProcessor@@@Z @ 0x180083D34
 * Callers:
  ...
  if ( v6 )
  {
    if ( *v6 )
    {
      ...
      if ( *(_DWORD *)v7 > 4u && (*(_BYTE *)(v7 + 16) & 1) != 0 && (*(_QWORD *)(v7 + 24) & 1LL) == *(_QWORD *)(v7 + 24) )
      {
        ...
        v37 = &v18;
        v38 = 4LL;
        TlgWrite((TraceLoggingHProvider)v7, &unk_18010F7D3, 0LL, 0LL, 9u, &pData);
      }
    }
  }
}
