/*
 * XREFs of ?EnsureDisplayWatcher@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAJAEBVSyncLockCriticalSection@Details@Wrappers@WRL@Microsoft@@@Z @ 0x1800A6E64
 * Callers:
...
LABEL_3:
  ...
  if ( !*((_QWORD *)this + 39) )
  {
    v6 = (__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *))*((_QWORD *)this + 49);
    if ( !v6 )
    {
      v3 = -2147418113;
      v4 = 654LL;
