/*
 * XREFs of ?VmBusSendGetDeviceState@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGDEVICE@@PEAU_D3DKMT_GETDEVICESTATE@@@Z @ 0x1C018313C
 * Callers:
        ...
        struct _D3DKMT_GETDEVICESTATE *a4)
{
  ...
  *(_QWORD *)&v10 = *((_QWORD *)&a4->PresentQueueState + 5);
  ...
  v19[0] = 64;
  v27 = v10;
  v13 = VmBusSendSyncMessage(v9, (struct DXGKVMB_COMMAND_BASE *)&v20, 0x50u, v28, v19, v18);
  if ( v13 < 0 )
    goto LABEL_4;
  v13 = -1073741823;
  if ( v19[0] < 0x40 )
