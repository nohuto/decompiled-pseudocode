/*
 * XREFs of ?Discard@CFlipToken@@UEAAXXZ @ 0x1C000EB30
 * Callers:
...
void __fastcall CFlipToken::Discard(CFlipToken *this)
{
  ...
  CompositionSurfaceObject *v12; // rcx
  __int64 v13; // rax
  ...
  *((_DWORD *)this + 6) = 6;
  ...
  v7(v1, v4, v8, *((_QWORD *)this + 12), 6, v6, v5, v14, v3);
  if ( *((_BYTE *)this + 557) )
  {
  ...
  v9 = (*(__int64 (__fastcall **)(CFlipToken *))(*(_QWORD *)this + 136LL))(this);
  if ( !*((_BYTE *)this + 48) )
  {
    v10 = *((_QWORD *)this + 12);
    if ( v10 > 1 )
  ...
  *((_QWORD *)this + 12) = 0LL;
  ...
  {
    v11 = *((_QWORD *)this + 5);
    v12 = (CompositionSurfaceObject *)*((_QWORD *)this + 4);
    *((_BYTE *)this + 89) = 1;
    CompositionSurfaceObject::SignalPresentLimitSemaphore(v12, v11);
  }
}
