/*
 * XREFs of ?SuspendResumeEscapeAllDevices@DXGPROCESS@@QEAAXPEBVDXGADAPTER@@_N1@Z @ 0x1C01B7E4C
 * Callers:
        ...
        char a4)
{
  ...
  while ( 1 )
  {
    ...
    if ( *(const struct DXGADAPTER **)(*((_QWORD *)Current + 2) + 16LL) == a2 )
    {
      ...
      v16 = *(_QWORD *)(v15 + 8);
      LOBYTE(v15) = a3;
      (*(void (__fastcall **)(_QWORD, __int64, __int64))(v16 + 1112))(*((_QWORD *)v13 + 76), v15, v14);
      if ( v18[0] )
