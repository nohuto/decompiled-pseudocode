/*
 * XREFs of DpiFdoDetectPostDevice @ 0x1C01F2824
 * Callers:
 ...
 *     DpiDecodeResourceDescriptorLength @ 0x1C01FCFEC (DpiDecodeResourceDescriptorLength.c)
 */
...
__int64 __fastcall DpiFdoDetectPostDevice(__int64 a1, _BYTE *a2)
{
  ...
  const void *v30; // [rsp+50h] [rbp-B0h]
  ...
  v4 = a1;
  v5 = 0;
  v6 = (const void *)(v2 + 544);
  v30 = (const void *)(v2 + 544);
...
LABEL_28:
  ...
  LODWORD(v14) = IofCallDriver(*(PDEVICE_OBJECT *)(v2 + 152), v11);
  if ( (_DWORD)v14 == 259 )
  {
        ...
        if ( v22[1] )
        {
          while ( 1 )
          {
            ...
            if ( ((*((_BYTE *)v23 + 8) - 3) & 0xFB) == 0
              && *(_QWORD *)(v23 + 3) <= v46
              && *(_QWORD *)(v23 + 3) + DpiDecodeResourceDescriptorLength(v23 + 2) >= v28 )
            {
              break;
            }
...
LABEL_26:
  ...
  else if ( (_DWORD)v14 != -1073741637 )
  {
    v18 = WdLogNewEntry5_WdError(v16);
    *(_QWORD *)(v18 + 24) = *(_QWORD *)(v2 + 152);
    *(_QWORD *)(v18 + 32) = (int)v14;
    goto LABEL_11;
  }
  return 0LL;
}
