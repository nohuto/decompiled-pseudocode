/*
 * XREFs of ?PollDisplayChildrenAll@DXGGLOBAL@@QEAAJPEBU_D3DKMT_POLLDISPLAYCHILDREN@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C019FE84
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a4)
{
  ...
  char v95; // [rsp+158h] [rbp+58h] BYREF
  unsigned int v96; // [rsp+198h] [rbp+98h]
  _BYTE *v97; // [rsp+1A0h] [rbp+A0h] BYREF
...
LABEL_21:
  ...
  else
  {
    if ( 0xFFFFFFFFFFFFFFFFuLL / v5 < 8 )
      goto LABEL_27;
    v15 = 8LL * v5;
    v16 = (char *)ExAllocatePoolWithTag(PagedPool, v15, 0x4B677844u);
  }
  v94 = v16;
  v6 = v16;
  v96 = v5;
  ...
  if ( v94 && v17 && v88 && P && v19 )
  {
    ...
    while ( v23 != v22 && v23 )
    {
      ...
      if ( (_BYTE)v26 )
      {
        ...
        if ( v25[307] )
        {
          LODWORD(v29) = COREADAPTERACCESS::AcquireExclusive(&v100);
          if ( (int)v29 >= 0 )
          {
            v30 = (void *)v25[24];
            *(_QWORD *)&v81[8 * v9] = v30;
...
LABEL_72:
              v76 = v29;
              v42 = v81;
              ObfDereferenceObject(*(PVOID *)&v81[8 * v9]);
              *(_QWORD *)&v42[8 * v9] = 0LL;
              if ( v28 )
              {
    ...
    if ( (*((_DWORD *)a2 + 1) & 4) != 0 && (_DWORD)v9 )
    {
      ...
      while ( v63 != v22 && v63 )
      {
        ...
        if ( (_BYTE)v65 )
        {
          ...
          if ( (int)COREADAPTERACCESS::AcquireExclusive(&v103) >= 0 )
          {
...
LABEL_113:
  ...
  PagedPoolZeroedArray<_D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES3,3>::~PagedPoolZeroedArray<_D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES3,3>((PVOID *)&v91);
  PagedPoolZeroedArray<_D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES3,3>::~PagedPoolZeroedArray<_D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES3,3>((PVOID *)&v94);
  if ( P != v107 && P )
