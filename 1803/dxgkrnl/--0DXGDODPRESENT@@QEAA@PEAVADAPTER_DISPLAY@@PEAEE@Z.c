/*
 * XREFs of ??0DXGDODPRESENT@@QEAA@PEAVADAPTER_DISPLAY@@PEAEE@Z @ 0x1C01D4234
 * Callers:
        ...
        char a4)
{
  ...
  *((_QWORD *)this + 1) = a3;
  if ( *(_DWORD *)this )
  {
    do
    {
      BLTQUEUE::BLTQUEUE(a3, this, v4, (struct _KEVENT *)(3760LL * v4 + *((_QWORD *)a2 + 14) + 912LL), a4);
      ++v4;
      a3 = (BLTQUEUE *)((char *)a3 + 2704);
    }
