/*
 * XREFs of ?WriteDxgDiagnosticsEvent_ADAPTER_START@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C003197C
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_ADAPTER_START(struct _DXGK_DIAG_HEADER *a1)
{
    ...
    && TlgKeywordOn((TraceLoggingHProvider)&hProvider, v2) )
  {
    ...
    v14 = 2;
    v16 = a1;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C00582B9, 0LL, v3, 5u, &pData);
  }
    ...
    && hProvider > 4u )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, v4) )
    {
      ...
      v23 = 4;
      v26 = 4;
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0058258, 0LL, v5, 8u, &pData);
    }
  }
}
