/*
 * XREFs of ?ConvertVidPnPathToPathDescription@@YAJPEAXPEAUD3DKMDT_HVIDPN__@@QEBU_DXGDMM_VIDPN_INTERFACE@@QEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_NPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C0191274
 * Callers:
        ...
        struct D3DKMT_PATHMODALITY_DESCRIPTOR *a9)
{
  ...
  v18 = (int)DxgkQueryMonitorTypeLockHeld(a1, a7, 0LL, 0LL, 0LL, (__int64)&v60, (__int64)&v50) >= 0
     && ((_BYTE)v60 || (_BYTE)v50);
  v19 = a9;
  v20 = v52;
  *((_BYTE *)a9 + 129) = v18;
