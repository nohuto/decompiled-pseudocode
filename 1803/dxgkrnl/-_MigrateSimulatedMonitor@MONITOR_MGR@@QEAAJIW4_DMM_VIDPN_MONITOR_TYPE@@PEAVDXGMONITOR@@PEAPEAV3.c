/*
 * XREFs of ?_MigrateSimulatedMonitor@MONITOR_MGR@@QEAAJIW4_DMM_VIDPN_MONITOR_TYPE@@PEAVDXGMONITOR@@PEAPEAV3@@Z @ 0x1C022C910
 * Callers:
        ...
        struct DXGMONITOR **a5)
{
  ...
  v21 = 0LL;
  MonitorInstance = MONITOR_MGR::_GetMonitorInstance(a1, v7, 0, &v21);
