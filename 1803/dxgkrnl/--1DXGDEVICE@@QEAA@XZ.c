/*
 * XREFs of ??1DXGDEVICE@@QEAA@XZ @ 0x1C00F107C
 * Callers:
...
void __fastcall DXGDEVICE::~DXGDEVICE(DXGDEVICE *this)
{
  ...
  v3 = (void **)((char *)this + 1112);
  v4 = 16LL;
  v5 = (_DWORD *)((char *)this + 1240);
  do
  {
    if ( *(v5 - 112) )
  ...
  while ( v4 );
  if ( (*((_BYTE *)this + 1709) & 2) != 0 )
  {
    v9 = *((_QWORD *)this + 43);
    if ( v9 )
    {
      v23 = 22;
      DXG_HOST_GLOBAL_VMBUS::VmBusSendSetGuestData(v9, 1, v2, (struct _MDL *)&v23);
    }
    v10 = *((_QWORD *)this + 5);
    v11 = *(_BYTE *)(v10 + 323);
    if ( (v11 & 8) != 0 )
