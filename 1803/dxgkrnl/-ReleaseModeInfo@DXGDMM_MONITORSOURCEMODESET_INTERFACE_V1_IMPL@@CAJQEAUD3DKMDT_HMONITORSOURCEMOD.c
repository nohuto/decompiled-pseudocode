/*
 * XREFs of ?ReleaseModeInfo@DXGDMM_MONITORSOURCEMODESET_INTERFACE_V1_IMPL@@CAJQEAUD3DKMDT_HMONITORSOURCEMODESET__@@QEBU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C0231910
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  struct DXGMONITOR *v23; // [rsp+48h] [rbp+10h] BYREF

  v22 = 0LL;
  v21 = 6001;
  if ( (qword_1C0079010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)a1, &EventProfilerEnter, a3, 6001);
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v21, 6001);
  if ( !a2 )
  {
