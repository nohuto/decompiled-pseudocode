/*
 * XREFs of ?GetUserRegistryPath@DXGSESSIONDATA@@QEAAPEAU_UNICODE_STRING@@G@Z @ 0x1C0001BFC
 * Callers:
...
struct _UNICODE_STRING *__fastcall DXGSESSIONDATA::GetUserRegistryPath(DXGSESSIONDATA *this, unsigned __int16 a2)
{
  ...
  if ( !*((_QWORD *)this + 2334) && a2 )
  {
    *((_WORD *)this + 9332) = 0;
    v5 = 2 * ((unsigned __int64)a2 >> 1);
    if ( !is_mul_ok((unsigned __int64)a2 >> 1, 2uLL) )
      v5 = -1LL;
    *((_QWORD *)this + 2334) = operator new[](v5, 0x4B677844u, PagedPool);
    *((_WORD *)this + 9333) = a2;
  }
  return (struct _UNICODE_STRING *)((char *)this + 18664);
}
