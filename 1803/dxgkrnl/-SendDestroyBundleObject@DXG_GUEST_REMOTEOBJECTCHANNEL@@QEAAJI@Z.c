/*
 * XREFs of ?SendDestroyBundleObject@DXG_GUEST_REMOTEOBJECTCHANNEL@@QEAAJI@Z @ 0x1C01BDD74
 * Callers:
...
LABEL_7:
  ...
  v19 = 1869901170LL;
  v10 = *((_QWORD *)this + 1);
  HIDWORD(v21) = -1073741823;
  LODWORD(v22) = 3;
  HIDWORD(v19) = -1073741823;
  LODWORD(v20) = 4;
  HIDWORD(v22) = v2;
  v11 = (*(__int64 (__fastcall **)(__int64, __int64 *, __int64, __int64 *, unsigned int *))(*(_QWORD *)v10 + 32LL))(
          v10,
          &v21,
          16LL,
          &v19,
