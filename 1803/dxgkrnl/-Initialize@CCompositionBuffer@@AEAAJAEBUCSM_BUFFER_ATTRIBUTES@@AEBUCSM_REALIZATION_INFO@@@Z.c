/*
 * XREFs of ?Initialize@CCompositionBuffer@@AEAAJAEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@@Z @ 0x1C004CC08
 * Callers:
        ...
        const struct CSM_REALIZATION_INFO *a3)
{
  ...
  v7 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)Global + 219) + 8LL))((char *)this + 248);
  if ( v7 >= 0 )
  {
    v8 = *(_OWORD *)a2;
    DWORD1(v11[0]) = 0;
    ...
    *((_QWORD *)this + 20) = *((_QWORD *)a2 + 14);
    ...
    {
      v9 = v12;
      v7 = (*(__int64 (__fastcall **)(CCompositionBuffer *, struct CBufferRealization *))(*(_QWORD *)this + 192LL))(
             this,
             v12);
      if ( v7 < 0 )
      {
