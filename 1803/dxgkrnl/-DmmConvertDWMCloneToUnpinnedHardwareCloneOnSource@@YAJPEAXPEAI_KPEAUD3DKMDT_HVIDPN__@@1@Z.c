/*
 * XREFs of ?DmmConvertDWMCloneToUnpinnedHardwareCloneOnSource@@YAJPEAXPEAI_KPEAUD3DKMDT_HVIDPN__@@1@Z @ 0x1C0212078
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  v12 = *(VIDPN_MGR **)(*((_QWORD *)a1 + 307) + 88LL);
...
LABEL_37:
  ...
  if ( a3 )
  {
    while ( 1 )
    {
      ...
      v25 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v18, v19, 0LL, &v44);
      v27 = v44;
      if ( v25 < 0 || v44 == -1 )
      {
