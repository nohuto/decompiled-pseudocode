/*
 * XREFs of DxgkPresentMultiPlaneOverlay @ 0x1C01DB5A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPresentMultiPlaneOverlay(struct D3DKMT_PRESENT_MULTIPLANE_OVERLAY *a1)
{
  ...
  struct D3DKMT_MULTIPLANE_OVERLAY *v73; // [rsp+88h] [rbp-80h] BYREF
  ...
  D3DKMT_PRESENT_MULTIPLANE_OVERLAY v86; // [rsp+198h] [rbp+90h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v78, 2092);
  ...
  v73 = 0LL;
  v74 = 0LL;
  v69 = CapturePresentMultiPlaneOverlayArgs(a1, &v86, &v73, &v74);
  if ( v69 >= 0 )
  {
...
LABEL_59:
  ...
  if ( (qword_1C0079010 & 2) != 0 )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0qqqqqqq(&DxgkControlGuid_Context, v65, v67, *v80, v80[66], v80[67], v80[68], v80[69], v80[70], *v81);
