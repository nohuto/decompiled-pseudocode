/*
 * XREFs of McTemplateK0ppqxqxqqqqqqqqqccccqqqqqQR23qqp @ 0x1C001B05C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0ppqxqxqqqqqqqqqccccqqqqqQR23qqp(
        __int64 a1,
        ...
        char a31)
{
  ...
  v89 = &a31;
  v90 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 0x1Du, &v33);
}
