/*
 * XREFs of DpiGetAdapterDebugData @ 0x1C003987C
 * Callers:
...
__int64 __fastcall DpiGetAdapterDebugData(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 8) = *(_DWORD *)(v2 + 3496);
  *(_DWORD *)(a2 + 12) = *(_DWORD *)(v2 + 3472);
  *(_BYTE *)(a2 + 16) = *(_BYTE *)(v2 + 1140);
  *(_BYTE *)(a2 + 17) = *(_QWORD *)(v2 + 680) != 0LL;
  *(_BYTE *)(a2 + 18) = *(_BYTE *)(v2 + 1141);
  *(_BYTE *)(a2 + 19) = *(_DWORD *)(v2 + 1224) == 3;
