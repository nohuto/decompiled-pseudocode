/*
 * XREFs of ??1?$PagedPoolZeroedArray@PEAVDXGALLOCATION@@$0CA@@@QEAA@XZ @ 0x1C0099C98
 * Callers:
...
void __fastcall PagedPoolZeroedArray<DXGALLOCATION *,32>::~PagedPoolZeroedArray<DXGALLOCATION *,32>(PVOID *a1)
{
  if ( *a1 != a1 + 1 )
  {
    if ( *a1 )
