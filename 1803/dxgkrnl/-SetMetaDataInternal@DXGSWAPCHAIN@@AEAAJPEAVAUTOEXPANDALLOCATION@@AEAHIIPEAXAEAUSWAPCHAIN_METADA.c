/*
 * XREFs of ?SetMetaDataInternal@DXGSWAPCHAIN@@AEAAJPEAVAUTOEXPANDALLOCATION@@AEAHIIPEAXAEAUSWAPCHAIN_METADATA_ETW_INFO@1@D@Z @ 0x1C01DFADC
 * Callers:
...
LABEL_11:
  ...
  Buffer = (char *)AUTOEXPANDALLOCATION::GetBuffer((const void **)a2, v17, *a3);
  v26 = Buffer;
  if ( !Buffer )
  {
