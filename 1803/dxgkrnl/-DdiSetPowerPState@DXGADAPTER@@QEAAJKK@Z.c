/*
 * XREFs of ?DdiSetPowerPState@DXGADAPTER@@QEAAJKK@Z @ 0x1C0161FE0
 * Callers:
...
__int64 __fastcall DXGADAPTER::DdiSetPowerPState(DXGADAPTER *this, unsigned int a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v24, 5125);
...
LABEL_15:
  ...
  v14 = (*((int (__fastcall **)(_QWORD, _QWORD, _QWORD))this + 95))(*((_QWORD *)this + 30), a2, v3);
  if ( v26[0] )
