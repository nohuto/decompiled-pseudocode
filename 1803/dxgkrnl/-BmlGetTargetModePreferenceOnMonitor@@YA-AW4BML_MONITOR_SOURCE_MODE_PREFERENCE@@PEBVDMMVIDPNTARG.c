/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1C00B7AB0
 * Callers:
 ...
 *     MonitorGetNextMonitorSourceMode @ 0x1C00B7C40 (MonitorGetNextMonitorSourceMode.c)
 ...
 *     BmlIsEDIDCapableOutputTechonology @ 0x1C00DB144 (BmlIsEDIDCapableOutputTechonology.c)
 */
