/*
 * XREFs of ?_GetMonitorEldInformation@DXGMONITOR@@QEAAJPEAU_MONITOR_PACKED_ELD_INFORMATION@@@Z @ 0x1C0235CEC
 * Callers:
...
LABEL_20:
    ...
    if ( !v27 )
      break;
    MonitorCCDMonitorID = DXGMONITOR::_GetMonitorCCDMonitorID((const UNICODE_STRING *)this, 0, v5, v27);
