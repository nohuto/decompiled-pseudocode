/*
 * XREFs of ?_LoadTopologyDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@PEAX@Z @ 0x1C00DDF90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCD_RECENT_TOPOLOGY_RETRIEVER::_LoadTopologyDescriptorCallback(void **this, _WORD *a2)
{
  void **SetId; // rax
  __int64 v5; // rcx
  __int64 v6; // r8
