/*
 * XREFs of McTemplateK0ppqqppqi @ 0x1C001BBBC
 * Callers:
...
NTSTATUS McTemplateK0ppqqppqi(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v19 = 4LL;
  v21 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, 4LL, 9u, &v5);
}
