/*
 * XREFs of ?DestroyVirtualGpu@DXGVIRTUALGPUMANAGER_PARAV@@UEAAJPEAUDXGK_VIRTUAL_GPU@@@Z @ 0x1C0178CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DXGVIRTUALGPUMANAGER_PARAV::DestroyVirtualGpu(struct _KTHREAD **this, struct DXGK_VIRTUAL_GPU *a2)
{
  ...
  --*((_DWORD *)this + 4);
  v6 = (struct DXGK_VIRTUAL_GPU **)*((_QWORD *)a2 + 12);
  if ( v6[1] != (struct DXGK_VIRTUAL_GPU *)((char *)a2 + 96)
    || (v7 = (struct DXGK_VIRTUAL_GPU **)*((_QWORD *)a2 + 13), *v7 != (struct DXGK_VIRTUAL_GPU *)((char *)a2 + 96)) )
  {
    __fastfail(3u);
  }
