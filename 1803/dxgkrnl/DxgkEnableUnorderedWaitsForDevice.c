/*
 * XREFs of DxgkEnableUnorderedWaitsForDevice @ 0x1C009A640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkEnableUnorderedWaitsForDevice(unsigned int a1, char a2)
{
  ...
  if ( (unsigned int)v11 < *(_DWORD *)(v7 + 248)
    && (v12 = *(_QWORD *)(v7 + 232),
        ...
        (((unsigned int)v3 >> 25) & 0x60) == (*(_BYTE *)(v12 + 16 * v11 + 8) & 0x60))
    && (v13 & 0x2000) == 0
    && (v13 & 0x1F) == 3 )
  {
...
LABEL_17:
  ...
  if ( !ExAcquireResourceExclusiveLite(*(PERESOURCE *)(v14 + 104), 0) )
  {
    ...
    v30 = DXGADAPTER::TryWakeUpFromD3State(*(DXGADAPTER **)(*(_QWORD *)(v14 + 16) + 16LL));
  ...
  {
    *(_BYTE *)(v14 + 1707) = a2;
    if ( !a2 && *(_QWORD *)(v14 + 616) )
      (*(void (**)(void))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 520LL) + 8LL) + 864LL))();
    v22 = 0;
  }
  else
  {
