/*
 * XREFs of ?ResizeUserModeBuffers@DXGCONTEXT@@QEAAJPEAVVIDMM_DMA_POOL@@_KII@Z @ 0x1C0099EB8
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( RegionSize )
  {
    ...
    else
    {
      ...
      if ( DXGVALIDATION::IsValidationEnabledForAdapterInCallerContext((struct DXGGLOBAL *)((char *)Global + 1188), v16) )
      {
...
LABEL_22:
  ...
  if ( DXGVALIDATION::IsValidationEnabledForAdapterInCallerContext((struct DXGGLOBAL *)((char *)v38 + 1188), v37) )
  {
