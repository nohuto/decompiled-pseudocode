/*
 * XREFs of ?CopyPresentArgs@DXGPRESENT@@QEAAJPEAVDXGCONTEXT@@PEAU_D3DKMT_PRESENT@@@Z @ 0x1C00CAB90
 * Callers:
 ...
 *     ?TranslateAndCopyDWMMoveRegionToDDAMoveRegions@@YAXKPEBU_D3DKMT_MOVE_RECT@@PEAU1@@Z @ 0x1C01B4B70 (-TranslateAndCopyDWMMoveRegionToDDAMoveRegions@@YAXKPEBU_D3DKMT_MOVE_RECT@@PEAU1@@Z.c)
 */
...
__int64 __fastcall DXGPRESENT::CopyPresentArgs(DXGPRESENT *this, struct DXGCONTEXT *a2, struct _D3DKMT_PRESENT *a3)
{
  ...
  if ( a3->pSrcSubRects )
  {
    ...
    if ( v12 < 0 )
    {
      v29 = (_QWORD *)WdLogNewEntry5_WdError(pPresentRegions);
      v29[3] = v12;
      v29[4] = a2;
      v29[5] = a3->SubRectCnt;
      v29[6] = 16LL;
    ...
    if ( !SourcePoint )
    {
      v32 = (_QWORD *)WdLogNewEntry5_WdLowResource(pPresentRegions);
      v32[3] = -1073741801LL;
      v32[4] = a2;
      v32[5] = a3->SubRectCnt;
LABEL_56:
  ...
  else
  {
    ...
    if ( 24 * v18 > 0xFFFFFFFF )
    {
      ...
      *(_QWORD *)(v40 + 24) = 10534LL;
      WdLogEvent5_WdWarning(v40);
      return 3221225621LL;
    }
    else
    {
      if ( (unsigned int)v16 + v19 >= v19 )
      {
        if ( (_DWORD)v16 + v19 )
        {
