/*
 * XREFs of ?GetModeCounts@EDID_MODES@MonDescParser@@QEAAJPEAG00PEAPEBU__EDID_V1_MONDESC_EXTRA_STANDARD_TIMINGS@@00@Z @ 0x1C0018F10
 * Callers:
 ...
 * Callees:
 *     ?Is18ByteDetTim@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x1C00030A4 (-Is18ByteDetTim@EDID_PARSER@MonDescParser@@QEBA_NH@Z.c)
 *     ?Is18ByteDispDesc@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x1C000315C (-Is18ByteDispDesc@EDID_PARSER@MonDescParser@@QEBA_NH@Z.c)
 *     ?IsUnused@EDID_PARSER_STANDARD_TIMING@MonDescParser@@QEBA_NXZ @ 0x1C00194D4 (-IsUnused@EDID_PARSER_STANDARD_TIMING@MonDescParser@@QEBA_NXZ.c)
 *     ?DenseOnesBitCount@MonDescParser@@YAEE@Z @ 0x1C00199BC (-DenseOnesBitCount@MonDescParser@@YAEE@Z.c)
...
LABEL_20:
  if ( a6 )
  {
    for ( k = 0; k < 4; k = v33 + 1 )
    {
      if ( MonDescParser::EDID_PARSER::Is18ByteDetTim((MonDescParser::EDID_PARSER *)v7, k) )
        ++v34;
    }
    *v35 = v34;
  }
