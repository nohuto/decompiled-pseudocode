/*
 * XREFs of ?SetProcessSchedulingPriorityClass@DXGPROCESS@@QEAAJW4_D3DKMT_SCHEDULINGPRIORITYCLASS@@_N@Z @ 0x1C01B7A30
 * Callers:
  ...
  if ( (int)result >= 0 )
  {
    ...
    *((_QWORD *)this + 22) = KeGetCurrentThread();
    ...
    while ( 1 )
    {
      ...
      if ( (int)COREADAPTERACCESS::AcquireShared((COREADAPTERACCESS *)v16) >= 0 && (*((_BYTE *)v10 + 1709) & 1) == 0 )
      {
        LOBYTE(v12) = a3;
