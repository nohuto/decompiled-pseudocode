/*
 * XREFs of ?DmmDisablePathsFromVidPnSource@@YAJPEAVDXGDEVICE@@I@Z @ 0x1C010F350
 * Callers:
...
__int64 __fastcall DmmDisablePathsFromVidPnSource(struct DXGDEVICE *a1, unsigned int a2)
{
  ...
  *(_QWORD *)(v9 + 32) = v7;
  ...
  if ( (*(_DWORD *)(v2 + 300) & 0x100) != 0
    || (v10 = ADAPTER_DISPLAY::SetVidPnSourceVisibility(v6, v4, 0, 0x40u, 0), v12 = v10, v10 >= 0) )
  {
