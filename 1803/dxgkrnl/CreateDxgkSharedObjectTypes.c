/*
 * XREFs of CreateDxgkSharedObjectTypes @ 0x1C01A9F78
 * Callers:
 *     ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C019ECB4 (-Initialize@DXGGLOBAL@@QEAAJXZ.c)
 * Callees:
 *     ?GenericMapping@DxgkCompositionObject@@SA?AU_GENERIC_MAPPING@@XZ @ 0x1C004724C (-GenericMapping@DxgkCompositionObject@@SA-AU_GENERIC_MAPPING@@XZ.c)
...
__int64 CreateDxgkSharedObjectTypes()
{
  ...
  if ( g_pDxgkSharedAllocationObjectType
    || (v1 = (struct _GENERIC_MAPPING)xmmword_1C005E538,
        ...
        (int)result >= 0) )
  {
    ...
    {
      v1 = (struct _GENERIC_MAPPING)xmmword_1C005E528;
      result = CreateSharedObject(
    ...
    if ( (int)result >= 0 )
    {
      ...
      {
        v1 = (struct _GENERIC_MAPPING)xmmword_1C005E518;
        result = CreateSharedObject(
          ...
          if ( (int)result >= 0 )
          {
            ...
            if ( (int)result >= 0 )
            {
              ...
              if ( (int)result >= 0 )
              {
                ...
                {
                  v1 = (struct _GENERIC_MAPPING)xmmword_1C005E508;
                  result = CreateSharedObject(
