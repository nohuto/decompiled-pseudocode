/*
 * XREFs of ??$_ForEachSetSubkey@VTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@@CCD_STORE@@CAJPEAGP6AJPEAVTOPOLOGY_SET_DESCRIPTOR@0@PEAX@Z2@Z @ 0x1C00B02E8
 * Callers:
 *     ?_ProcessConnectedSetDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVCONNECTED_SET_DESCRIPTOR@CCD_STORE@@PEAX@Z @ 0x1C009DFB0 (-_ProcessConnectedSetDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVCONNECTED_SET_DESC.c)
 * Callees:
        ...
        CCD_RECENT_TOPOLOGY_RETRIEVER *a3)
{
  ...
  _QWORD *v26; // rax
  _QWORD *v27; // rax
  struct _UNICODE_STRING v28; // [rsp+38h] [rbp-29h] BYREF
  ...
  else
  {
    for ( i = 0; ; ++i )
    {
      ...
      if ( SubkeyInfoFromRegistry < 0 )
        break;
      v13 = v32;
      v28.Length = *((_WORD *)v32 + 6);
      v28.MaximumLength = *((_WORD *)v32 + 6);
      v28.Buffer = (wchar_t *)((char *)v32 + 16);
      if ( v28.Length != *((_DWORD *)v32 + 3) )
      {
        v24 = WdLogNewEntry5_WdAssertion(v28.Length);
        WdLogEvent5_WdAssertion(v24);
      }
      TopologySetIdDescriptorCallback = CcdOpenRegistrySubkey_0(&Handle, 0xF003Fu, KeyHandle, &v28, 0LL);
      operator delete[](v13);
