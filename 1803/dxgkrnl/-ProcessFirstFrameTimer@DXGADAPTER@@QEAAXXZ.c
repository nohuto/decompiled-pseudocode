/*
 * XREFs of ?ProcessFirstFrameTimer@DXGADAPTER@@QEAAXXZ @ 0x1C0026444
 * Callers:
 *     ?DxgkpFirstFrameTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C002BBF0 (-DxgkpFirstFrameTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::ProcessFirstFrameTimer(KSPIN_LOCK *this)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 501, &LockHandle);
  v2 = 0;
  for ( *((_BYTE *)this + 4016) = 0; v2 < *((_DWORD *)this + 954); ++v2 )
  {
    v3 = 248LL * v2;
    v4 = this[476];
    if ( *(_BYTE *)(v4 + v3 + 240) )
