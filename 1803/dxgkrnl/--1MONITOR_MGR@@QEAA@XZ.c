/*
 * XREFs of ??1MONITOR_MGR@@QEAA@XZ @ 0x1C022A20C
 * Callers:
 *     ??_GMONITOR_MGR@@QEAAPEAXI@Z @ 0x1C0046DD4 (--_GMONITOR_MGR@@QEAAPEAXI@Z.c)
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x1C0005B04 (--3@YAXPEAX@Z.c)
 *     ?_ReleaseMonitorPendingEvent@MONITOR_MGR@@SAXPEAU_MONITOR_PENDING_EVENT@@@Z @ 0x1C000B2A8 (-_ReleaseMonitorPendingEvent@MONITOR_MGR@@SAXPEAU_MONITOR_PENDING_EVENT@@@Z.c)
...
void __fastcall MONITOR_MGR::~MONITOR_MGR(MONITOR_MGR *this)
{
  ...
  *(_QWORD *)(WdLogNewEntry5_WdTrace(v3, v2, v4, v5) + 24) = this;
  while ( 1 )
  {
    ...
    if ( *v6 == v6 )
      break;
    if ( (_QWORD **)v8[1] != v6 || (v9 = (_QWORD *)*v8, *(_QWORD **)(*v8 + 8LL) != v8) )
      __fastfail(3u);
    *v6 = v9;
    v10 = v8 - 2;
    v9[1] = v6;
