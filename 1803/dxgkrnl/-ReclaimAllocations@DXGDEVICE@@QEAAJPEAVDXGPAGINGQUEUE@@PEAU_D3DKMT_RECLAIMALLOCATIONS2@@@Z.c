/*
 * XREFs of ?ReclaimAllocations@DXGDEVICE@@QEAAJPEAVDXGPAGINGQUEUE@@PEAU_D3DKMT_RECLAIMALLOCATIONS2@@@Z @ 0x1C00EAA80
 * Callers:
...
__int64 __fastcall DXGDEVICE::ReclaimAllocations(DXGDEVICE *this, BOOL *a2, struct _D3DKMT_RECLAIMALLOCATIONS2 *a3)
{
  ...
  __int64 v82; // rbx
  _QWORD *v83; // rax
  struct _EX_RUNDOWN_REF *v84; // [rsp+30h] [rbp-88h] BYREF
  struct _EX_RUNDOWN_REF *v85; // [rsp+38h] [rbp-80h] BYREF
  ...
  {
LABEL_10:
    DXGALLOCATIONREFERENCE::~DXGALLOCATIONREFERENCE(&v84);
    return 0LL;
  }
...
LABEL_97:
        ...
        if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v7) + 223) )
        {
...
LABEL_120:
    ...
    else if ( HandleList )
    {
      for ( j = 0; j < a3->NumAllocations; ++j )
      {
        ...
        if ( *((_DWORD *)DXGGLOBAL::GetGlobal(v37) + 223) )
        {
...
LABEL_74:
        ...
        v56 = (struct _VIDMM_MULTI_ALLOC *)v84[3].Count;
        if ( !v56 )
        {
