/*
 * XREFs of ?NotifySharedPowerGraphicsFStateTransition@DXGGLOBAL@@QEAAXQEAXKIE@Z @ 0x1C0032810
 * Callers:
        ...
        char a5)
{
  ...
  {
    KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 159, &LockHandle);
  }
  else if ( (struct _KTHREAD *)this[161] != KeGetCurrentThread() )
  {
    DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(this + 160));
    v9 = 1;
  }
  for ( i = this[163]; (KSPIN_LOCK *)i != this + 163 && i; i = *(_QWORD *)i )
  {
  ...
  {
    ExReleasePushLockSharedEx(this + 160, 0LL);
