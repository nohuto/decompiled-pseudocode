/*
 * XREFs of ?DdiGetScanLine@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_GETSCANLINE@@@Z @ 0x1C010C4B0
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DdiGetScanLine(ADAPTER_DISPLAY *this, struct _DXGKARG_GETSCANLINE *a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 5036);
...
LABEL_15:
  ...
  v17 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETSCANLINE *))(*((_QWORD *)this + 2) + 544LL))(
  ...
  if ( (_DWORD)v17 )
  {
    v27 = WdLogNewEntry5_WdError(ScanLine);
    *(_QWORD *)(v27 + 24) = v17;
