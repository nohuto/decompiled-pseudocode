/*
 * XREFs of McTemplateK0ptqppq @ 0x1C00420EC
 * Callers:
...
NTSTATUS McTemplateK0ptqppq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventOpmCreateProtectedOutput, a3, 7u, &v4);
}
