/*
 * XREFs of ?InFrame@CCompositionToken@@UEAAJPEAVCCompositionFrame@@PEA_N@Z @ 0x1C000E480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionToken::InFrame(CCompositionToken *this, struct CCompositionFrame *a2, bool *a3)
{
  ...
  if ( *((_DWORD *)this + 6) == 2 )
  {
    v7 = *(unsigned int (__fastcall **)(__int64, _QWORD))(*((_QWORD *)DXGGLOBAL::GetGlobal() + 219) + 40LL);
