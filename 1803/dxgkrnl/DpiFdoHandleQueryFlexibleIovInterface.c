/*
 * XREFs of DpiFdoHandleQueryFlexibleIovInterface @ 0x1C02020B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiGetPartitionedInterfaceContextPointer @ 0x1C0202CC8 (DpiGetPartitionedInterfaceContextPointer.c)
 */
  ...
  if ( Object )
  {
    if ( v8 == 1 )
    {
      if ( v9 >= 0x78u )
      {
        ...
        if ( *(_BYTE *)(v5 + 5056) )
        {
          memmove(a4, &unk_1C0079850, 0x78uLL);
