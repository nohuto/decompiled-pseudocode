/*
 * XREFs of ?RemoveAllPathsFromSource@DMMVIDPNTOPOLOGY@@QEAAJI@Z @ 0x1C021EFE8
 * Callers:
...
__int64 __fastcall DMMVIDPNTOPOLOGY::RemoveAllPathsFromSource(DMMVIDPNTOPOLOGY *this, unsigned int a2)
{
  ...
  if ( DMMVIDPNTOPOLOGY::IsSourceInTopology(this, a2) )
  {
    ...
    for ( i = 0; ; i = 1 )
    {
      v11 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(this, v2, 0LL, &v28);
      v16 = v11;
      if ( v11 == -1071774919 )
        break;
      if ( v11 < 0 )
      ...
      v19 = DMMVIDPNTOPOLOGY::RemovePath(this, v2, v17, 0LL);
      v16 = v19;
      if ( v19 < 0 )
      {
        if ( v19 != -1073741790 )
