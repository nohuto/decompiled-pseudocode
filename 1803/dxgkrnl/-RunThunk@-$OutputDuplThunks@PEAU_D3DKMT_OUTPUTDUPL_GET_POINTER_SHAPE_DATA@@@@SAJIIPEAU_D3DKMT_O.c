/*
 * XREFs of ?RunThunk@?$OutputDuplThunks@PEAU_D3DKMT_OUTPUTDUPL_GET_POINTER_SHAPE_DATA@@@@SAJIIPEAU_D3DKMT_OUTPUTDUPL_GET_POINTER_SHAPE_DATA@@P6AJPEAVOUTPUTDUPL_MGR@@0@Z@Z @ 0x1C01CC308
 * Callers:
        ...
        __int64 (__fastcall *a4)(struct OUTPUTDUPL_MGR *, __int64))
{
  ...
  if ( Current )
  {
    v13 = (*(__int64 (__fastcall **)(_QWORD))(*((_QWORD *)Current + 13) + 224LL))(0LL);
    v14 = &v20;
    v20 = 0LL;
    if ( v13 )
      v14 = 0LL;
