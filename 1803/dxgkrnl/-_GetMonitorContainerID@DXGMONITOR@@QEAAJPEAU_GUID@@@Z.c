/*
 * XREFs of ?_GetMonitorContainerID@DXGMONITOR@@QEAAJPEAU_GUID@@@Z @ 0x1C023A050
 * Callers:
 *     MonitorGetContainerIDFromDescriptor @ 0x1C022DE68 (MonitorGetContainerIDFromDescriptor.c)
 * Callees:
 *     ??_U@YAPEAX_KIW4_POOL_TYPE@@@Z @ 0x1C0015040 (--_U@YAPEAX_KIW4_POOL_TYPE@@@Z.c)
 *     ??_V@YAXPEAX@Z @ 0x1C0015080 (--_V@YAXPEAX@Z.c)
 *     ?EDID_V1_GetContainerID@@YAJKPEBEPEAU_GUID@@@Z @ 0x1C0047C78 (-EDID_V1_GetContainerID@@YAJKPEBEPEAU_GUID@@@Z.c)
 *     ?DisplayID_GetContainerID@@YAJPEAUDisplayIDObj@@PEAU_GUID@@@Z @ 0x1C0047F90 (-DisplayID_GetContainerID@@YAJPEAUDisplayIDObj@@PEAU_GUID@@@Z.c)
