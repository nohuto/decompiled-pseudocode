/*
 * XREFs of DpiMiracastChunkInfoCallbackDpc @ 0x1C003CE20
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel(&qword_1C007AB30, &LockHandle);
  ...
  if ( v5 )
  {
    ...
    DpSynchronizeExecution(v5, (KSYNCHRONIZE_ROUTINE *)DpiMiracastMoveChunkList, v7, *(_DWORD *)(v6 + 3740), &v9);
  }
