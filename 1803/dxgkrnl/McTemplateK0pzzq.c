/*
 * XREFs of McTemplateK0pzzq @ 0x1C002CFC0
 * Callers:
...
NTSTATUS McTemplateK0pzzq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v20 = 0;
  v22 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, v8, 5u, &v12);
}
