/*
 * XREFs of McTemplateK0pqqpqq @ 0x1C0038064
 * Callers:
...
NTSTATUS McTemplateK0pqqpqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndirectSwapChainUnOrderedPresent, a3, 7u, &v4);
}
