/*
 * XREFs of ?DxgkReferenceAllocationList@@YAJPEAIPEAU_D3DDDI_ALLOCATIONLIST@@PEAPEAVDXGALLOCATION@@PEAVDXGDEVICE@@@Z @ 0x1C0096138
 * Callers:
        ...
        struct DXGDEVICE *a4)
{
  ...
  DXGHANDLETABLELOCKSHARED::DXGHANDLETABLELOCKSHARED((DXGHANDLETABLELOCKSHARED *)v22, (struct _KTHREAD **)Current);
  v10 = *a1;
  v21 = *a1;
  v11 = 0;
  for ( i = 0; i < v10; ++i )
