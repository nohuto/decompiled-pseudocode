/*
 * XREFs of BmlPinNextBestTargetMode @ 0x1C00C3244
 * Callers:
...
__int64 __fastcall BmlPinNextBestTargetMode(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  DMMVIDPNTARGETMODESET *v47; // [rsp+50h] [rbp-58h] BYREF
...
LABEL_49:
  ...
  if ( *((DMMVIDPNTARGETMODESET **)v16 + 6) == (DMMVIDPNTARGETMODESET *)((char *)v16 + 48) )
  {
