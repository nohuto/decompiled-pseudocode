/*
 * XREFs of DpiLdaStartAdapterInChain @ 0x1C0209958
 * Callers:
  ...
  if ( (_DWORD)a1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)(*(_DWORD *)(v16 + 236) - 1) > 1 )
        goto LABEL_3;
      if ( (_BYTE)a2 || *(_DWORD *)(v6 + 1108) != *(_DWORD *)(v16 + 1108) )
        LOBYTE(a2) = 1;
...
LABEL_15:
  ...
  if ( (unsigned int)a1 > 1 )
  {
    do
    {
      v18 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v6 + 2592) + 8LL * v17) + 64LL);
      if ( *(_DWORD *)(v18 + 236) == 1 )
      {
