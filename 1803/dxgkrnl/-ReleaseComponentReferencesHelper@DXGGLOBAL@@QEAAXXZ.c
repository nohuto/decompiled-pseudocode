/*
 * XREFs of ?ReleaseComponentReferencesHelper@DXGGLOBAL@@QEAAXXZ @ 0x1C01A0860
 * Callers:
 *     ?CsExitInitiatedReleaseComponentReferencesPassiveLevel@@YAXPEAX@Z @ 0x1C019D4B0 (-CsExitInitiatedReleaseComponentReferencesPassiveLevel@@YAXPEAX@Z.c)
  ...
  while ( v5 != (volatile signed __int32 *)v1 && v5 )
  {
    ...
    if ( *((_DWORD *)v6 + 794) )
    {
      ...
      if ( (_BYTE)v7 )
      {
        ...
        {
          for ( i = 0; i < *((_DWORD *)v6 + 660); ++i )
          {
            if ( !*(_DWORD *)(520LL * i + *((_QWORD *)v6 + 312) + 208) )
              DXGADAPTER::SetPowerComponentIdleCBInternal((DXGADAPTER *)v6, i, 0);
          }
          _InterlockedDecrement(v6 + 794);
        }
