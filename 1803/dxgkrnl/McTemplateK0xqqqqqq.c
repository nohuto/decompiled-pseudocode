/*
 * XREFs of McTemplateK0xqqqqqq @ 0x1C00402D4
 * Callers:
 *     ?DpiMiracastCbReportChunkInfo@@YAJPEAXPEAUDXGK_MIRACAST_CHUNK_INFO@@0I@Z @ 0x1C003CAD0 (-DpiMiracastCbReportChunkInfo@@YAJPEAXPEAUDXGK_MIRACAST_CHUNK_INFO@@0I@Z.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C000ACD4 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C001AFD0 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0xqqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventDxgkMiracastCbReportChunkInfo, a3, 8u, &v4);
}
