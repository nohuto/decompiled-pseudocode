/*
 * XREFs of ?DdiDestroyVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_DESTROYVIRTUALGPU@@@Z @ 0x1C01756E4
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v27, 5102);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_DESTROYVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                           + 88LL))(
