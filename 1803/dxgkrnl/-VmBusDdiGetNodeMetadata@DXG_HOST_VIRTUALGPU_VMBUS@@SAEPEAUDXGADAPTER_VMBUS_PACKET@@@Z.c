/*
 * XREFs of ?VmBusDdiGetNodeMetadata@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C017E4C0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall DXG_HOST_VIRTUALGPU_VMBUS::VmBusDdiGetNodeMetadata(struct DXGADAPTER_VMBUS_PACKET *a1)
{
  ...
  if ( v15[4] >= 0 )
  {
    ...
    v6 = WORD1(v5);
    if ( *(int *)(v3 + 2104) < 0x2000 )
      v7 = 1LL;
    else
      v7 = *(unsigned int *)(v3 + 248);
    if ( (unsigned int)v6 < (unsigned int)v7 )
    {
      v9 = (unsigned __int16 *)(*(_QWORD *)(v3 + 2360) + 352 * v6);
