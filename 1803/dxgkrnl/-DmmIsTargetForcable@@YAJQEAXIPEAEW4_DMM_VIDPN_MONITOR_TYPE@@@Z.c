/*
 * XREFs of ?DmmIsTargetForcable@@YAJQEAXIPEAEW4_DMM_VIDPN_MONITOR_TYPE@@@Z @ 0x1C00BA5C4
 * Callers:
...
__int64 __fastcall DmmIsTargetForcable(DXGADAPTER *a1, unsigned int a2, bool *a3, int a4)
{
  __int64 v4; // rbp
  __int64 v8; // rcx
  __int64 v9; // rdi
...
LABEL_15:
  ...
  if ( v10 )
  {
    ...
    {
      if ( a4 == 5 )
        IsTargetForcable = *((_QWORD *)v12 + 13) == 0LL;
      else
