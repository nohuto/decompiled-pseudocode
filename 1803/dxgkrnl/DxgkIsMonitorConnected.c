/*
 * XREFs of DxgkIsMonitorConnected @ 0x1C0167570
 * Callers:
...
__int64 __fastcall DxgkIsMonitorConnected(struct _LUID a1, unsigned int a2, char a3, char a4, bool *a5)
{
  ...
  char v35[8]; // [rsp+48h] [rbp-21h] BYREF
  char v36[32]; // [rsp+50h] [rbp-19h] BYREF
  char v37[40]; // [rsp+70h] [rbp+7h] BYREF
  ...
  *a5 = 0;
  ...
  if ( *((_QWORD *)v15 + 307) )
  {
    ...
    if ( v21 >= 0 )
    {
      ...
      v34 = 0LL;
      LOBYTE(v29) = a3;
      MonitorHandle = MonitorGetMonitorHandle(v15, (unsigned int)v7, v29, DxgkIsMonitorConnected, &v34);
      UsageClass = MonitorHandle;
      if ( MonitorHandle >= 0 )
      {
        v31 = v34;
        LODWORD(a5) = 0;
        UsageClass = (int)MonitorGetUsageClass((struct HDXGMONITOR__ *)v34, &a5);
