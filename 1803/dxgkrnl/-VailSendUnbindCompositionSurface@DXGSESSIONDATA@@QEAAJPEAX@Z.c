/*
 * XREFs of ?VailSendUnbindCompositionSurface@DXGSESSIONDATA@@QEAAJPEAX@Z @ 0x1C01E8788
 * Callers:
...
__int64 __fastcall DXGSESSIONDATA::VailSendUnbindCompositionSurface(DXGVAILGUESTOBJECT **this, void *a2)
{
  ...
  if ( ExAcquireRundownProtection((PEX_RUNDOWN_REF)this[2342] + 7) )
  {
    if ( ExAcquireRundownProtection((PEX_RUNDOWN_REF)(*((_QWORD *)this[2342] + 8) + 48LL)) )
    {
      ...
      DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v20);
      v11 = DXG_GUEST_COMPOSITIONOBJECTCHANNEL::SendUnbindCompositionSurface(
