/*
 * XREFs of ?LoadTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEAVCCD_TOPOLOGY@@@Z @ 0x1C00B1CC8
 * Callers:
...
__int64 __fastcall CCD_STORE::TOPOLOGY_SET_DESCRIPTOR::LoadTopology(void **this, struct CCD_TOPOLOGY *a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v49 != v53 )
    {
      ...
      if ( Handle )
        ZwClose(Handle);
      v20 = CcdOpenRegistrySubkey((int)&Handle, 131097, (int)v54[8], &pszDest, 0LL);
      v13 = v20;
      if ( v20 < 0 )
      {
    ...
    RegistryValues = CcdReadRegistryValues(Handle, 0LL, &unk_1C0079690, 8u, (__int64)v22);
    v13 = RegistryValues;
    if ( RegistryValues < 0 )
      goto LABEL_66;
    *((_QWORD *)v22 + 13) = *((_QWORD *)v22 + 12);
    v25 = CcdReadRegistryValues(Handle, 0LL, &unk_1C00794D0, 2u, (__int64)&v46);
    v13 = v25;
    if ( v25 == -1073741772 )
    {
      LODWORD(v46) = 0;
