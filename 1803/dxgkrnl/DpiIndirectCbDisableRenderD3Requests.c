/*
 * XREFs of DpiIndirectCbDisableRenderD3Requests @ 0x1C0206710
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiIndirectCbDisableRenderD3Requests(PDEVICE_OBJECT DeviceObject, int a2, __int64 a3)
{
  ...
  if ( DeviceObject )
  {
    ...
    if ( DeviceExtension )
    {
      if ( DeviceExtension[4] == 1953656900 && DeviceExtension[5] == 2 && *((_BYTE *)DeviceExtension + 1143) )
      {
...
LABEL_18:
        ...
        *(_QWORD *)((char *)v9 + 20) = a3;
        v15 = (_QWORD *)qword_1C007ACE8;
        if ( *(void ***)qword_1C007ACE8 != &qword_1C007ACE0 )
          __fastfail(3u);
        *v9 = &qword_1C007ACE0;
        v9[1] = v15;
        *v15 = v9;
        qword_1C007ACE8 = (__int64)v9;
        v9 = 0LL;
        v11 = 0;
        goto LABEL_18;
      }
