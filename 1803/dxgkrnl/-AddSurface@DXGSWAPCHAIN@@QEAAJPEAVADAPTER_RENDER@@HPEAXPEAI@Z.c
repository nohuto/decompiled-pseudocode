/*
 * XREFs of ?AddSurface@DXGSWAPCHAIN@@QEAAJPEAVADAPTER_RENDER@@HPEAXPEAI@Z @ 0x1C01DDC6C
 * Callers:
 ...
 *     ?FindEmptySlot@DXGSWAPCHAIN@@AEAAPEAUSWAPCHAIN_SURF_INFO@1@XZ @ 0x1C01DE424 (-FindEmptySlot@DXGSWAPCHAIN@@AEAAPEAUSWAPCHAIN_SURF_INFO@1@XZ.c)
...
__int64 __fastcall DXGSWAPCHAIN::AddSurface(const void **this, DXGADAPTER **a2, int a3, void *a4, unsigned int *a5)
{
  ...
  struct _D3DKMT_CREATESYNCHRONIZATIONOBJECT2 v34; // [rsp+40h] [rbp-88h] BYREF
  struct DXGSYNCOBJECT *v35; // [rsp+D0h] [rbp+8h] BYREF
  ...
  v34.Info.Flags.Value |= 1u;
  v34.Info.Type = D3DDDI_FENCE;
  v23 = CreateSynchronizationObjectInternal(0LL, 1, a2, &v34, &v35, 0LL, 0LL);
  v25 = v23;
  if ( v23 < 0 )
  {
...
LABEL_16:
  ...
  *((_DWORD *)EmptySlot + 7) = v34.Info.SharedHandle;
  v28 = operator new[](0x10uLL, 0x4B677844u, PagedPool);
  v30 = v28;
  if ( v28 )
  {
    v28[1] = 0LL;
    *v28 = 0LL;
    AUTOEXPANDALLOCATION::GetBuffer((const void **)v28, 0, 0);
  }
  else
  {
    v30 = 0LL;
