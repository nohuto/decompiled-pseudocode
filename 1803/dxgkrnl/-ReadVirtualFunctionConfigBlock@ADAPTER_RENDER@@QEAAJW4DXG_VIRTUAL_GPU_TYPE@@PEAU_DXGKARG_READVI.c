/*
 * XREFs of ?ReadVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C0174030
 * Callers:
 *     DxgkDdiReadVirtualFunctionConfigBlock @ 0x1C0174F74 (DxgkDdiReadVirtualFunctionConfigBlock.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::ReadVirtualFunctionConfigBlock(__int64 a1, int a2, __int64 a3)
{
  ...
  {
    v9 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, __int64))(*(_QWORD *)VirtualGpuByIndex + 72LL))(
           VirtualGpuByIndex,
           a3);
  }
  else
