/*
 * XREFs of ?DisplayOnlyPresent@DXGCONTEXT@@QEAAJPEAU_D3DKMT_PRESENT@@PEAVDXGALLOCATION@@IPEAU_DXGKARG_PRESENT@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C01D85A0
 * Callers:
  ...
  *(_QWORD *)&v29.right = 0LL;
  if ( v6 )
  {
    ...
    v18 = ADAPTER_RENDER::DdiDescribeAllocation(
            *(ADAPTER_RENDER **)(*(_QWORD *)(*(_QWORD *)(v16 + 16) + 16LL) + 2464LL),
            &v27,
            v17);
    v20 = v18;
    if ( v18 < 0 )
...
LABEL_19:
  ...
  if ( v23 >= 0 && (a2->Flags.Value & 4) != 0 )
  {
    ...
    {
      ADAPTER_DISPLAY::DisableOverlayPlanes(*(ADAPTER_DISPLAY **)(v25 + 2456), a4);
      v24 = *((_QWORD *)this + 2);
    }
