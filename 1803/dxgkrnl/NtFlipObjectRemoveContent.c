/*
 * XREFs of NtFlipObjectRemoveContent @ 0x1C004F640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtFlipObjectRemoveContent(FlipManagerObject *a1, unsigned __int64 *a2)
{
  ...
  if ( a1 && a2 )
  {
    ...
    {
      v4 = v7;
      v5 = FlipManagerObject::RemoveContent((struct _LIST_ENTRY *)v7, v3);
    }
    if ( v4 )
