/*
 * XREFs of DpiDxgkDdiAddDevice @ 0x1C020A004
 * Callers:
...
__int64 __fastcall DpiDxgkDdiAddDevice(__int64 a1, __int64 a2, __int64 *a3)
{
  ...
  {
    v15 = 0;
    McTemplateK0ppq(a1, &EventEnterDdiAddDevice, (__int64)a3, a2, 0LL, v15);
  }
  ...
  if ( bTracingEnabled )
  {
    ...
    {
      LODWORD(v14) = v6;
      McTemplateK0ppq(*a3, &EventExitDdiAddDevice, v9, a2, *a3, v14);
    }
  }
