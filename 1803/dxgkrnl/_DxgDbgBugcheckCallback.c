/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C0030030
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C007BCE8 )
    {
      v4 = (unsigned int)(dword_1C007BCE0 - 1);
      if ( dword_1C007BCE0 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C007BCE8) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C007BCD0;
      ReasonSpecificData[4] = qword_1C007BCE8;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C007BCD0;
      if ( v5 )
      {
