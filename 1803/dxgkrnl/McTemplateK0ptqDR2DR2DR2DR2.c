/*
 * XREFs of McTemplateK0ptqDR2DR2DR2DR2 @ 0x1C00341B8
 * Callers:
...
NTSTATUS McTemplateK0ptqDR2DR2DR2DR2(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  __int64 v29; // [rsp+100h] [rbp+67h]
  __int64 v30; // [rsp+108h] [rbp+6Fh]
  ...
  v8 = 4LL;
  v10 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventBlitRect, a3, 8u, &v4);
}
