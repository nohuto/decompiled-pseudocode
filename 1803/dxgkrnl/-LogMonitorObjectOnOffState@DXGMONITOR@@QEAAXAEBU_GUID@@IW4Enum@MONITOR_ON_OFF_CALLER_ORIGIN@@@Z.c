/*
 * XREFs of ?LogMonitorObjectOnOffState@DXGMONITOR@@QEAAXAEBU_GUID@@IW4Enum@MONITOR_ON_OFF_CALLER_ORIGIN@@@Z @ 0x1C0235518
 * Callers:
...
void __fastcall DXGMONITOR::LogMonitorObjectOnOffState(char *a1, __int64 a2, int a3, char a4)
{
  ...
  if ( a4 != 1 || v6 != *a1 )
  {
    ...
    if ( dword_1C0079B70 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0079B70, 0x400000000010uLL) )
    {
      v13 = 1;
      v19 = &v13;
      v14 = dword_1C007BE40++;
      ...
      v36 = 1LL;
      v38 = 1LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0079B70, &unk_1C00598D6, v9, v9, 0xCu, &pData);
    }
    if ( a4 == 1 )
    {
      *((_QWORD *)a1 + 1) = v8;
