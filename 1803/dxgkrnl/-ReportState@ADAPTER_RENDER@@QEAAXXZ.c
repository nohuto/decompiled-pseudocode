/*
 * XREFs of ?ReportState@ADAPTER_RENDER@@QEAAXXZ @ 0x1C015B94C
 * Callers:
 *     ?ReportState@DXGADAPTER@@QEAAXXZ @ 0x1C014EE2C (-ReportState@DXGADAPTER@@QEAAXXZ.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C001C5F0 (_guard_dispatch_icall_nop.c)
 *     ?ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ @ 0x1C0189CE0 (-ClearStateReportingFlags@DXGDEVICE@@QEAAXXZ.c)
...
void __fastcall ADAPTER_RENDER::ReportState(ADAPTER_RENDER *this)
{
  ...
  if ( !*(_BYTE *)(*((_QWORD *)this + 2) + 185LL) )
  {
    ...
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(*((_QWORD *)this + 65) + 8LL) + 56LL))(*((_QWORD *)this + 66));
  }
}
