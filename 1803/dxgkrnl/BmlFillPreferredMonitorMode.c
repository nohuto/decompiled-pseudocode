/*
 * XREFs of BmlFillPreferredMonitorMode @ 0x1C00B78E4
 * Callers:
...
__int64 __fastcall BmlFillPreferredMonitorMode(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    v9 = *(struct HDXGMONITOR__ **)(a3 + 104);
    if ( !v9 )
      break;
      ...
      while ( 1 )
      {
        ...
        if ( NextMonitorSourceMode == 1075708748 )
        {
          ...
          if ( (unsigned __int8)BmlIsLowResAnalogTvOutput(a3) )
          {
            ...
            if ( v6 < 0x300 )
              v6 = 768;
            v20 = BmlCompareModeExtents(&qword_1C0056DE0, &v24);
            v21 = v24;
            if ( v20 == 1 )
              v21 = 0x30000000400LL;
            v24 = v21;
