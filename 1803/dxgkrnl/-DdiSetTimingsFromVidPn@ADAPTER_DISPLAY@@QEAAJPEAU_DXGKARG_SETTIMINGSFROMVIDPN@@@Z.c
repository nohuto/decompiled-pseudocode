/*
 * XREFs of ?DdiSetTimingsFromVidPn@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_SETTIMINGSFROMVIDPN@@@Z @ 0x1C0162E58
 * Callers:
        ...
        struct _DXGKARG_SETTIMINGSFROMVIDPN *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 5076);
...
LABEL_15:
  ...
  v15 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETTIMINGSFROMVIDPN *))(*((_QWORD *)this + 2) + 1048LL))(
  ...
  v20 = v34 * KeQueryTimeIncrement();
  v21 = a2->pResultsFlags->0;
  v22 = *(_QWORD *)(*((_QWORD *)this + 2) + 268LL);
  memset(&v35[1], 0, 36);
  HIDWORD(v35[6]) = a2->PathCount;
  ...
  {
    LODWORD(v35[6]) = 87;
    HIDWORD(v35[7]) = (v20 - v7) / 0x2710uLL;
  }
