/*
 * XREFs of ?ProcessPresent@OUTPUTDUPL_CONTEXT@@QEAAJPEAVDXGCONTEXT@@PEBU_D3DKMT_OUTPUTDUPLPRESENT@@PEAVAUTOEXPANDALLOCATION@@PEAPEAV2@@Z @ 0x1C01D2F14
 * Callers:
        ...
        struct DXGCONTEXT **a5)
{
  ...
  if ( *((_DWORD *)this + 80) )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(this, a2, a3, a4) + 24) = 1911LL;
    return 0LL;
  }
  v10 = (DXGDXGIKEYEDMUTEX *)*((_QWORD *)this + *((unsigned int *)this + 11) + 6);
  v11 = (struct DXGDEVICE *)*((_QWORD *)v10 + 1);
  if ( v11 )
  {
    if ( v11 != a2[2] )
    {
