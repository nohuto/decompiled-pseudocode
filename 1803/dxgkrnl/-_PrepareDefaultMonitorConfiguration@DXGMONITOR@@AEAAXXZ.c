/*
 * XREFs of ?_PrepareDefaultMonitorConfiguration@DXGMONITOR@@AEAAXXZ @ 0x1C02325B4
 * Callers:
...
void __fastcall DXGMONITOR::_PrepareDefaultMonitorConfiguration(DXGMONITOR *this)
{
  ...
  {
    v4 = (int *)((char *)this + 456);
    v5 = (unsigned int *)((char *)this + 448);
