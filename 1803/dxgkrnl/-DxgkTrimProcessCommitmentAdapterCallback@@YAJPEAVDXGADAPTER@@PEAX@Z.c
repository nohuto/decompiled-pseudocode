/*
 * XREFs of ?DxgkTrimProcessCommitmentAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C01B6930
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2[3] < a2[2] )
  {
    ...
    if ( *((_DWORD *)a1 + 44) == 1 )
    {
      ...
      *(_QWORD *)(v7 + 8) = 0LL;
      ...
      if ( (*(unsigned int (__fastcall **)(_QWORD, _QWORD, _QWORD *, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 308) + 544LL)
                                                                                        + 8LL)
                                                                            + 1128LL))(
             *(_QWORD *)(*((_QWORD *)a1 + 308) + 552LL),
             *a2,
             v17,
             *((unsigned int *)a2 + 2)) == -1071775484 )
      {
        ...
        {
          v24 = 0LL;
          (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD *, _QWORD, _QWORD, __int64 *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 308) + 544LL)
                                                                                                  + 8LL)
                                                                                      + 1120LL))(
            *(_QWORD *)(*((_QWORD *)a1 + 308) + 552LL),
            *a2,
