/*
 * XREFs of ?ReleaseSourceModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNSOURCEMODESET__@@@Z @ 0x1C00C7220
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNSOURCEMODESET__ *const a3)
{
  ...
  __int64 v9; // rax
  __int64 v10; // rcx
  struct DMMVIDPNSOURCEMODESET *v11; // r14
  __int64 v12; // rsi
  __int64 v13; // rcx
  __int64 v14; // rcx
  __int64 v15; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v27, 6035);
