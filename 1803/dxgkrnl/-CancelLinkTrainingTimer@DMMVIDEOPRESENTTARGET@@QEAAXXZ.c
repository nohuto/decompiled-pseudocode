/*
 * XREFs of ?CancelLinkTrainingTimer@DMMVIDEOPRESENTTARGET@@QEAAXXZ @ 0x1C022168C
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( ((_InterlockedExchange((volatile __int32 *)(v4 + 168), 5) - 2) & 0xFFFFFFFD) != 0 )
  {
    v7 = *((_QWORD *)this + 64);
    v8 = _InterlockedCompareExchange((volatile signed __int32 *)(v7 + 168), 0, 5);
    if ( v8 != 5 )
