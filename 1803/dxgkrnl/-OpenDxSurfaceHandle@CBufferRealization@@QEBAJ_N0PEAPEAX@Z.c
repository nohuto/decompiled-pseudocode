/*
 * XREFs of ?OpenDxSurfaceHandle@CBufferRealization@@QEBAJ_N0PEAPEAX@Z @ 0x1C000A5A0
 * Callers:
        ...
        void **a4)
{
  ...
  *a4 = 0LL;
  ...
  v7 = a3 << 9;
  v8 = a2;
  if ( a3 || (Global = DXGGLOBAL::GetGlobal(), (*(unsigned int (**)(void))(*((_QWORD *)Global + 219) + 224LL))()) )
    AccessMode = 0;
