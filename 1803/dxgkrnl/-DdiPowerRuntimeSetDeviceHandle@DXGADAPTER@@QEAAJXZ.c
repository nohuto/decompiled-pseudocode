/*
 * XREFs of ?DdiPowerRuntimeSetDeviceHandle@DXGADAPTER@@QEAAJXZ @ 0x1C01603D4
 * Callers:
...
__int64 __fastcall DXGADAPTER::DdiPowerRuntimeSetDeviceHandle(DXGADAPTER *this, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v22, 5127);
...
LABEL_17:
  ...
  v13 = (*((int (__fastcall **)(_QWORD, _QWORD))this + 91))(*((_QWORD *)this + 30), *((_QWORD *)this + 313));
  if ( v24[0] )
