/*
 * XREFs of ?VmBusSendQueryEtwSession@DXG_GUEST_GLOBAL_VMBUS@@QEAA?AU_GUID@@XZ @ 0x1C01843E8
 * Callers:
        ...
        struct _GUID *__return_ptr retstr)
{
  ...
  v10 = 60;
  v6 = 16;
  if ( VmBusSendSyncMessage(v2, (struct DXGKVMB_COMMAND_BASE *)&v7, 0x18u, &v11, &v6, v5) < 0 || v6 < 0x10 )
