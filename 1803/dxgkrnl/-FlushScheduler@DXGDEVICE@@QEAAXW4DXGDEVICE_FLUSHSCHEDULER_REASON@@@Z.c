/*
 * XREFs of ?FlushScheduler@DXGDEVICE@@QEAAXW4DXGDEVICE_FLUSHSCHEDULER_REASON@@@Z @ 0x1C00F263C
 * Callers:
...
void __fastcall DXGDEVICE::FlushScheduler(_QWORD *a1, unsigned int a2)
{
  ...
  if ( !*(_BYTE *)(v4 + 185) )
  {
    ...
    if ( (*(int (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)(*(_QWORD *)(a1[2] + 520LL) + 8LL) + 136LL))(a1[77], v13) >= 0 )
    {
LABEL_5:
      a1[27] = 0LL;
    ...
    *(_QWORD *)(v12 + 24) = 5478LL;
LABEL_19:
    WdLogEvent5_WdAssertion(v12);
    goto LABEL_5;
  }
  DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendFlushDevice(v4 + 4080, a1, a2);
}
