/*
 * XREFs of ?DmmGetMacrovisonSupportFromClientVidPnSource@@YAJQEAXIPEAU_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_SUPPORT@@@Z @ 0x1C0212BF4
 * Callers:
        ...
        struct _D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_SUPPORT *a3)
{
  ...
  DMMVIDPNTOPOLOGY *v36; // [rsp+28h] [rbp-18h]
...
LABEL_5:
  ...
  if ( v10 )
  {
    ...
    if ( v35 )
    {
      ...
      v19 = 0LL;
      v20 = *(_QWORD *)(v10 + 80);
      v21 = (DMMVIDPNTOPOLOGY *)(v35 + 96);
      v36 = (DMMVIDPNTOPOLOGY *)(v35 + 96);
      while ( 1 )
      {
        v41 = -1;
        ...
        Path = DMMVIDPNTOPOLOGY::FindPath(v21, a2, v41);
        if ( !Path )
        {
