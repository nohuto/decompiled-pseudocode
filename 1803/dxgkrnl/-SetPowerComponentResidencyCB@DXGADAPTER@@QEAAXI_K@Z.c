/*
 * XREFs of ?SetPowerComponentResidencyCB@DXGADAPTER@@QEAAXI_K@Z @ 0x1C0027278
 * Callers:
...
void __fastcall DXGADAPTER::SetPowerComponentResidencyCB(DXGADAPTER *this, int a2, __int64 a3)
{
  ...
  if ( *((_BYTE *)this + 2937) )
  {
    ...
    *(_QWORD *)(520LL * v5 + *((_QWORD *)this + 312) + 376) = a3;
    PoFxSetComponentResidency(*((_QWORD *)this + 313), v5, a3);
  }
}
