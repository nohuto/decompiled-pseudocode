/*
 * XREFs of DpiPdoAddPdo @ 0x1C020B454
 * Callers:
...
LABEL_28:
    ...
    *(_QWORD *)(v7 + 3488) = DeviceExtension;
    ...
    if ( a3 != D3DKMDT_VOT_UNINITIALIZED )
    {
      v42 = DmmSetTemporaryVideoOutputTechnology(*(void *const *)(v7 + 3728), *((_DWORD *)DeviceExtension + 126), a3);
      v20 = v42;
      if ( v42 >= 0 )
        goto LABEL_40;
  ...
  if ( (int)v20 < 0 && v58 == 1 )
  {
    if ( v59 == 1 )
    {
      ...
      if ( *(PVOID *)(*(_QWORD *)DeviceExtension + 8LL) != DeviceExtension
        || (v51 = (PVOID *)*((_QWORD *)DeviceExtension + 1), *v51 != DeviceExtension) )
      {
        __fastfail(3u);
      }
      *v51 = v50;
