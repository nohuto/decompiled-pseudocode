/*
 * XREFs of ?DdiVirtualGpuDriverEscape@ADAPTER_RENDER@@QEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C0178228
 * Callers:
 *     ?VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C017A280 (-VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v27, 5105);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGK_VIRTUALGPUDRIVERESCAPE *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                             + 112LL))(
