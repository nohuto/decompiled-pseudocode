/*
 * XREFs of McTemplateK0qqqpqddddddddddddqqqqqq @ 0x1C0037400
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqpqddddddddddddqqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a26)
{
  ...
  v72 = 4LL;
  v74 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &FlipMultiPlaneOverlay, a3, 0x18u, &v28);
}
