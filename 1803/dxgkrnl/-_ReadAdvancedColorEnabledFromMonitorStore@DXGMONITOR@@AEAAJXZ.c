/*
 * XREFs of ?_ReadAdvancedColorEnabledFromMonitorStore@DXGMONITOR@@AEAAJXZ @ 0x1C0232ABC
 * Callers:
...
__int64 __fastcall DXGMONITOR::_ReadAdvancedColorEnabledFromMonitorStore(DXGMONITOR *this)
{
  __int64 result; // rax
  __int64 v3; // rdi
  __int64 v4; // rcx
  ...
  *((_DWORD *)this + 10) &= ~0x800u;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (int)v3 >= 0 )
    {
      if ( v11 == 4 && v12 == 4 )
      {
        *((_DWORD *)this + 10) = *((_DWORD *)this + 10) & 0xFFFFF7FF | (v13 != 0 ? 0x800 : 0);
        return 0LL;
      }
