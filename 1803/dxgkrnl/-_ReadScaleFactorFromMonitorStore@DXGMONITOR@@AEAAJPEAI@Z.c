/*
 * XREFs of ?_ReadScaleFactorFromMonitorStore@DXGMONITOR@@AEAAJPEAI@Z @ 0x1C0233078
 * Callers:
...
__int64 __fastcall DXGMONITOR::_ReadScaleFactorFromMonitorStore(UNICODE_STRING *this, unsigned int *a2)
{
  __int64 result; // rax
  __int64 v5; // rdi
  __int64 v6; // rdx
