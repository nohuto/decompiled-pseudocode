/*
 * XREFs of ?DdiCreateVirtualGpu@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEVIRTUALGPU@@@Z @ 0x1C0175480
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v23, 5100);
...
LABEL_15:
  ...
  v13 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEVIRTUALGPU *))(*(_QWORD *)(*((_QWORD *)this + 2) + 936LL)
                                                                          + 64LL))(
