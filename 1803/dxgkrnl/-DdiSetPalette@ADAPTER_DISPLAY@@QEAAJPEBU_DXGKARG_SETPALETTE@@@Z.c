/*
 * XREFs of ?DdiSetPalette@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPALETTE@@@Z @ 0x1C0161D58
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v28, 5017);
...
LABEL_15:
  ...
  if ( (_DWORD)v14 )
  {
    v24 = WdLogNewEntry5_WdError(VidPnSourceId);
    *(_QWORD *)(v24 + 24) = v14;
