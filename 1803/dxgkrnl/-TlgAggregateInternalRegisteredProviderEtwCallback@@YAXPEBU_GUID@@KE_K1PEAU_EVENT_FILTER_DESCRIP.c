/*
 * XREFs of ?TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C009CDD0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C001C5F0 (_guard_dispatch_icall_nop.c)
 *     LookUpTableFlushComplete @ 0x1C023CE20 (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1C023D014 (LookUpTableFlushPartial.c)
 */
