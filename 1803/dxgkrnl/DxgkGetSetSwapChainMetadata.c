/*
 * XREFs of DxgkGetSetSwapChainMetadata @ 0x1C01E1290
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkGetSetSwapChainMetadata(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  struct _D3DKMT_GETSETSWAPCHAINMETADATA Handle; // [rsp+40h] [rbp-38h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v18, 2121);
  ...
  if ( !v14 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q(v13, &EventProfilerExit, v12, v18);
