/*
 * XREFs of ?GetAllocationPriority@DXGDEVICE@@QEAAJPEBU_D3DKMT_GETALLOCATIONPRIORITY@@E@Z @ 0x1C016AD88
 * Callers:
...
LABEL_27:
        ...
        (*(void (__fastcall **)(_QWORD, ULONG_PTR, UINT *))(*(_QWORD *)(v23[68] + 8LL) + 1152LL))(v23[69], Count, &v30);
