/*
 * XREFs of ?DdiUpdateActiveVidPnPresentPath@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH@@@Z @ 0x1C00E1180
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v26, 5012);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH *))(*((_QWORD *)this + 2)
                                                                                            + 520LL))(
  ...
  *(_QWORD *)(v20 + 32) = a2;
  ...
  if ( (_DWORD)v14 != -1073741801 && (_DWORD)v14 != -1071774906 && (_DWORD)v14 != -1071774904 && (_DWORD)v14 )
  {
