/*
 * XREFs of ?DdiValidateUpdateAllocationProperty@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_VALIDATEUPDATEALLOCPROPERTY@@@Z @ 0x1C01642F0
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v23, 5073);
...
LABEL_15:
  ...
  v13 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_VALIDATEUPDATEALLOCPROPERTY *))(*((_QWORD *)this + 2)
                                                                                           + 960LL))(
