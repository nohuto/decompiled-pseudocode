/*
 * XREFs of ?DpiBrightnessIfSetState@@YAJPEAXPEAU_DXGK_BRIGHTNESS_STATE@@@Z @ 0x1C02015D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightnessIfSetState(_QWORD *a1, struct _DXGK_BRIGHTNESS_STATE *a2)
{
  ...
  if ( *(_QWORD *)(v3 + 64) )
  {
    ...
    if ( v8 >= 0 )
    {
      v8 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGK_BRIGHTNESS_STATE *))(v3 + 64))(*(_QWORD *)(v3 + 8), a2);
