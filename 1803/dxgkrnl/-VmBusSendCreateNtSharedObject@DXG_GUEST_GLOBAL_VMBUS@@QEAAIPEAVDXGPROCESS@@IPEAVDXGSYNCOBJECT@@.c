/*
 * XREFs of ?VmBusSendCreateNtSharedObject@DXG_GUEST_GLOBAL_VMBUS@@QEAAIPEAVDXGPROCESS@@IPEAVDXGSYNCOBJECT@@PEAVDXGDEVICESYNCOBJECT@@PEAVDXGRESOURCE@@@Z @ 0x1C0182344
 * Callers:
        ...
        struct DXGRESOURCE *a6)
{
  ...
  v24 = HostHandle;
  v19 = 8;
  v15 = VmBusSendSyncMessage(v13, (struct DXGKVMB_COMMAND_BASE *)&v20, 0x20u, &v25, &v19, v18);
  if ( v15 >= 0 )
  {
    v15 = -1073741823;
    if ( v19 >= 4 )
