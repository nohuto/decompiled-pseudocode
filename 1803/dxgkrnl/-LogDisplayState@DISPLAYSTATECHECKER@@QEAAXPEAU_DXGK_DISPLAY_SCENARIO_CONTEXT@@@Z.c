/*
 * XREFs of ?LogDisplayState@DISPLAYSTATECHECKER@@QEAAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01EAE80
 * Callers:
 ...
 *     _TlgCreateSz @ 0x1C0038A08 (_TlgCreateSz.c)
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a2)
{
  ...
  if ( v2 )
    v3 = v2;
  v6 = (struct DXGGLOBAL *)((char *)DXGGLOBAL::GetGlobal((__int64)this) + 1800);
  ...
  if ( dword_1C0079090 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0079090, 0x400000000400uLL) )
  {
    v13 = *((_DWORD *)this + 117);
    v74 = &v24;
    v22 = *((_BYTE *)this + 468);
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C0079090, &unk_1C0058F4A, (LPCGUID)((char *)a2 + 8), v14, 7u, &pData);
  }
  ...
  if ( !v15 )
  {
    ...
    do
    {
      ...
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0079090, 0x400000000400uLL) )
        {
          ...
          TlgWrite((TraceLoggingHProvider)&dword_1C0079090, &unk_1C0058E39, (LPCGUID)((char *)a2 + 8), v20, 0x13u, &v39);
          LOBYTE(v16) = v22;
        }
      }
