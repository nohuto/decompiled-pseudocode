/*
 * XREFs of ?RemoveIndependentFlipSkipTokenFromList@CTokenManager@@IEAAXU_LUID@@IPEAPEAVCToken@@@Z @ 0x1C0017690
 * Callers:
        ...
        struct CToken **a4)
{
  ...
  *a4 = 0LL;
  ...
  while ( v5 != v4 )
  {
    ...
    if ( *(_QWORD *)(*((_QWORD *)v5 + 3) + 16LL) == __PAIR64__(HighPart, LowPart)
