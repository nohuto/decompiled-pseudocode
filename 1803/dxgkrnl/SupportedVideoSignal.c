/*
 * XREFs of SupportedVideoSignal @ 0x1C023C5A0
 * Callers:
...
char __fastcall SupportedVideoSignal(_DWORD *a1, unsigned int *a2, int a3)
{
  ...
  else
  {
    ...
    if ( (int)((unsigned int)v11 / HIDWORD(v11) - a2[1] / a2[2]) < 0 )
      return 0;
    v18 = v17 - 61;
    ...
    if ( (int)(v19 - a2[5] / a2[6]) < 0 && (int)(v17 - 60) < 0 )
      return 0;
    if ( (int)(v19 - a2[7] / a2[8]) > 0 && v18 > 0 )
      return 0;
  }
  return 1;
}
