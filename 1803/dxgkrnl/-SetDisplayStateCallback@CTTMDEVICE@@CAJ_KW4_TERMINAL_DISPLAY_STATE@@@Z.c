/*
 * XREFs of ?SetDisplayStateCallback@CTTMDEVICE@@CAJ_KW4_TERMINAL_DISPLAY_STATE@@@Z @ 0x1C01D0820
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTTMDEVICE::SetDisplayStateCallback(__int64 a1, int a2)
{
  ...
  __int64 v15; // rax
  int *v16; // r8
  struct _DXGK_DISPLAY_SCENARIO_CONTEXT *v17; // rax
  int v18; // eax
  ...
  *(_QWORD *)(a1 + 896) = 0LL;
  ...
  if ( (int)v2 <= 1 )
  {
    ...
    v17 = (struct _DXGK_DISPLAY_SCENARIO_CONTEXT *)v31;
    LODWORD(v31[3]) = 54;
    LOBYTE(v31[6]) = -1;
    v29 = 4;
    goto LABEL_19;
  ...
  if ( (_DWORD)v2 == 2 )
  {
    v18 = DpiBrightnessNotifyMonitorDimming(v9, (unsigned int)v11, 1u);
    goto LABEL_20;
  }
  if ( (_DWORD)v2 != 3 )
  {
LABEL_24:
  ...
  v17 = (struct _DXGK_DISPLAY_SCENARIO_CONTEXT *)v30;
  LODWORD(v30[3]) = 55;
  LOBYTE(v30[6]) = -1;
  v28 = 1;
LABEL_19:
  v18 = DxgkPowerOnOffMonitor((_DWORD)v9, v10, (_DWORD)v16, 0, v17);
LABEL_20:
  v21 = v18;
  if ( v18 >= 0 )
    goto LABEL_26;
