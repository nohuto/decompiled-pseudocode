/*
 * XREFs of ?InsertDirectFlipAllocationToList@DXGDEVICE@@AEAAEIPEAVDXGALLOCATION@@@Z @ 0x1C010B1C8
 * Callers:
        ...
        struct DXGALLOCATION *a3)
{
  ...
  if ( (*((_DWORD *)a3 + 18) & 0x7FE) != 0 )
  {
    ...
    *(_QWORD *)(v18 + 24) = 8563LL;
    WdLogEvent5_WdAssertion(v18);
  }
  v7 = *((_DWORD *)this + v3 + 310);
  v8 = v3;
  v9 = 0;
  v10 = v7;
  if ( v7 == *((_DWORD *)this + v8 + 326) )
  {
    v11 = v7;
    if ( v7 )
    {
    ...
    if ( (_DWORD)v11 )
    {
      memmove(v15, this[v8 + 139], 8 * v11);
      operator delete[](this[v8 + 139]);
    }
    this[v8 + 139] = (struct _KTHREAD *)v15;
    v10 = v7;
    *((_DWORD *)this + v8 + 310) = v7;
  }
  v16 = 0;
  if ( (_DWORD)v10 )
  {
  ...
  if ( v16 != (_DWORD)v10 )
  {
    if ( *((_QWORD *)this[v8 + 139] + v16) )
    {
      ...
      *(_QWORD *)(v21 + 24) = 8624LL;
      WdLogEvent5_WdAssertion(v21);
    }
    if ( *((_DWORD *)this + v8 + 310) < *((_DWORD *)this + v8 + 326) )
    {
      v22 = WdLogNewEntry5_WdAssertion(v10);
      *(_QWORD *)(v22 + 24) = 8625LL;
      WdLogEvent5_WdAssertion(v22);
    }
    v9 = 1;
    *((_QWORD *)this[v8 + 139] + v16) = a3;
    ++*((_DWORD *)this + v8 + 326);
