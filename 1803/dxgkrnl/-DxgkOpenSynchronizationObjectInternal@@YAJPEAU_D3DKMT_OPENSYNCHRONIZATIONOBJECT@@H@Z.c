/*
 * XREFs of ?DxgkOpenSynchronizationObjectInternal@@YAJPEAU_D3DKMT_OPENSYNCHRONIZATIONOBJECT@@H@Z @ 0x1C00CFDF0
 * Callers:
 *     ?DxgkCddOpenSynchronizationObject@@YAJPEAU_D3DKMT_OPENSYNCHRONIZATIONOBJECT@@@Z @ 0x1C00CFDD0 (-DxgkCddOpenSynchronizationObject@@YAJPEAU_D3DKMT_OPENSYNCHRONIZATIONOBJECT@@@Z.c)
 *     DxgkOpenSynchronizationObject @ 0x1C01C2CF0 (DxgkOpenSynchronizationObject.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  __int64 v39; // rcx
  __int64 v40; // r8
  struct DXGADAPTERSYNCOBJECT *v41; // [rsp+38h] [rbp-50h] BYREF
  PERESOURCE *v42; // [rsp+40h] [rbp-48h] BYREF
  char v43; // [rsp+48h] [rbp-40h]
  int v44; // [rsp+50h] [rbp-38h] BYREF
  __int64 v45; // [rsp+58h] [rbp-30h]
  unsigned int v46; // [rsp+A0h] [rbp+18h] BYREF
  struct DXGSYNCOBJECT *v47; // [rsp+A8h] [rbp+20h] BYREF

  v45 = 0LL;
  v44 = 2050;
  if ( (qword_1C0079010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)a1, &EventProfilerEnter, a3, 2050);
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v44, 2050);
  ...
  if ( v8 )
  {
    ...
    v28 = DXGGLOBAL::OpenSyncObject(v25, hSharedHandle, &v47, &v46, &v41);
    if ( v43 )
    {
      v43 = 0;
