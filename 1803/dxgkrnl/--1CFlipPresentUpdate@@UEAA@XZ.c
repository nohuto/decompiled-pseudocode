/*
 * XREFs of ??1CFlipPresentUpdate@@UEAA@XZ @ 0x1C0052400
 * Callers:
 *     ??_GCFlipPresentUpdate@@UEAAPEAXI@Z @ 0x1C004FD00 (--_GCFlipPresentUpdate@@UEAAPEAXI@Z.c)
 * Callees:
 *     ?Release@CFlipPropertySetBase@@QEAAKXZ @ 0x1C004E14C (-Release@CFlipPropertySetBase@@QEAAKXZ.c)
 *     ??1CFlipTokenOperation@@MEAA@XZ @ 0x1C0050E24 (--1CFlipTokenOperation@@MEAA@XZ.c)
 */
...
void __fastcall CFlipPresentUpdate::~CFlipPresentUpdate(CFlipPresentUpdate *this)
{
  ...
  *((_QWORD *)this + 2) = &CFlipQueuedObject::`vftable';
