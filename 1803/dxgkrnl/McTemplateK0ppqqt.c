/*
 * XREFs of McTemplateK0ppqqt @ 0x1C0028294
 * Callers:
...
NTSTATUS McTemplateK0ppqqt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &DestroyDisplayedAllocation, a3, 6u, &v4);
}
