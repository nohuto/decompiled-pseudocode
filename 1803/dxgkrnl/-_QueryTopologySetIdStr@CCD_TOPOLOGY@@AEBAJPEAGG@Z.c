/*
 * XREFs of ?_QueryTopologySetIdStr@CCD_TOPOLOGY@@AEBAJPEAGG@Z @ 0x1C00B3B40
 * Callers:
...
__int64 __fastcall CCD_TOPOLOGY::_QueryTopologySetIdStr(CCD_TOPOLOGY *this, unsigned __int16 *a2, unsigned __int16 a3)
{
  ...
  {
    v10 = 272LL * v6;
    if ( DxgkIsTargetNonStandard((const struct _LUID *)(v10 + v3 + 64), *(_DWORD *)(v10 + v3 + 76)) )
    {
    ...
    if ( v6 + 1 < *(unsigned __int16 *)(*((_QWORD *)this + 8) + 20LL) )
    {
      while ( 1 )
      {
        if ( CCD_TOPOLOGY::IsSameCloneGroup(this, v6, v14, 0) )
        {
          v21 = *((_QWORD *)this + 8);
          v22 = 272LL * v39;
          v23 = *(_DWORD *)(v10 + v21 + 64);
          v41 = v22;
          if ( *(_DWORD *)(v21 + v22 + 64) == v23
            && *(_DWORD *)(v21 + v22 + 68) == *(_DWORD *)(v10 + v21 + 68)
            && *(_DWORD *)(v21 + v22 + 76) == *(_DWORD *)(v10 + v21 + 76) )
          {
