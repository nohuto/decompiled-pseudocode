/*
 * XREFs of ?_SaveUsageOverridesToMonitorStore@DXGMONITOR@@AEAAJW4_D3DKMT_DISPLAY_TARGET_USAGE@@@Z @ 0x1C0233ED4
 * Callers:
...
__int64 __fastcall DXGMONITOR::_SaveUsageOverridesToMonitorStore(UNICODE_STRING *a1, int a2)
{
  __int64 result; // rax
  NTSTATUS v5; // eax
  __int64 v6; // rcx
