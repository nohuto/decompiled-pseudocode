/*
 * XREFs of ?VmBusSendQueryAdapterInfo@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAU_D3DKMT_QUERYADAPTERINFO@@I@Z @ 0x1C0183EBC
 * Callers:
    ...
    if ( PoolWithTag )
    {
      ...
      *(_QWORD *)PoolWithTag = 0LL;
      ...
      v17 = VmBusSendSyncMessage(
              ...
              &v19,
              v18);
      if ( v17 >= 0 && v19 < a3->PrivateDriverDataSize )
        v17 = -1073741823;
