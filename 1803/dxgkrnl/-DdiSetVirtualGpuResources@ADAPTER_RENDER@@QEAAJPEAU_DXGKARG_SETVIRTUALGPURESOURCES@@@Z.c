/*
 * XREFs of ?DdiSetVirtualGpuResources@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_SETVIRTUALGPURESOURCES@@@Z @ 0x1C0177D48
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (qword_1C0079010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, a3, 5101);
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v23, 5101);
...
LABEL_15:
  ...
  v13 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_SETVIRTUALGPURESOURCES *))(*(_QWORD *)(*((_QWORD *)this + 2)
                                                                                            + 936LL)
                                                                                + 80LL))(
  ...
  if ( (_DWORD)v13 != -1073741823 && (_DWORD)v13 != -1073741811 && (_DWORD)v13 )
  {
