/*
 * XREFs of ?VmBusSendDdiGetNodeMetadata@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIPEAU_DXGK_NODEMETADATA@@@Z @ 0x1C018274C
 * Callers:
        ...
        struct _DXGK_NODEMETADATA *a3)
{
  ...
  v18 = 44;
  v14 = 80;
  v6 = VmBusSendSyncMessage(v3, (struct DXGKVMB_COMMAND_BASE *)&v15, 0x20u, v20, &v14, v13);
