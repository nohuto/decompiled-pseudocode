/*
 * XREFs of McTemplateK0qiii @ 0x1C00372CC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qiii(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 8LL;
  v15 = &a7;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventBltQueueUpdateVSyncState, a3, 5u, &v8);
}
