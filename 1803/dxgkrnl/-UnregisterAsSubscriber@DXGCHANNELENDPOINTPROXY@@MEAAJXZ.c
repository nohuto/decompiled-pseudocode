/*
 * XREFs of ?UnregisterAsSubscriber@DXGCHANNELENDPOINTPROXY@@MEAAJXZ @ 0x1C01E57F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DXGCHANNELENDPOINTPROXY::UnregisterAsSubscriber(DXGCHANNELENDPOINTPROXY *this)
{
  ...
  v1 = *((_QWORD *)this + 15);
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v7, (struct DXGFASTMUTEX *const)(v1 + 56), 1);
