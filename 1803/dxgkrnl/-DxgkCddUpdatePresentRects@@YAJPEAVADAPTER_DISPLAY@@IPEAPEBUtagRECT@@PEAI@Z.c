/*
 * XREFs of ?DxgkCddUpdatePresentRects@@YAJPEAVADAPTER_DISPLAY@@IPEAPEBUtagRECT@@PEAI@Z @ 0x1C01715F0
 * Callers:
...
__int64 __fastcall DxgkCddUpdatePresentRects(DXGADAPTER **this, unsigned int a2, struct tagRECT **a3, unsigned int *a4)
{
  ...
  if ( CddInterface )
  {
    ...
    if ( v13 )
    {
      ...
      {
        v9 = this[14];
        v15 = *ADAPTER_DISPLAY::GetDwmClipBox(this, v6);
        ...
        DxgkpConvertRects(
          *((_DWORD *)v9 + 940 * v6 + 161),
          *((_DWORD *)v9 + 940 * v6 + 162),
          CurrentOrientation,
          &v15,
          v13,
          v14,
