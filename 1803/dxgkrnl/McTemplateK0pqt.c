/*
 * XREFs of McTemplateK0pqt @ 0x1C002B670
 * Callers:
...
NTSTATUS McTemplateK0pqt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v7, va1);
  va_copy(v9, va2);
  return McGenEventWriteKM(&DxgkControlGuid_Context, &SetVidPnSourceVisibility, a3, 4u, &v4);
}
