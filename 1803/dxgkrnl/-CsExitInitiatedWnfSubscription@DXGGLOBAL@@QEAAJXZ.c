/*
 * XREFs of ?CsExitInitiatedWnfSubscription@DXGGLOBAL@@QEAAJXZ @ 0x1C019D8D8
 * Callers:
...
__int64 __fastcall DXGGLOBAL::CsExitInitiatedWnfSubscription(DXGGLOBAL *this)
{
  ...
  v1 = ExSubscribeWnfStateChange((char *)this + 1392, &v8, 1LL, 0LL, CsExitInitiatedWnfCallback, this);
  v5 = v1;
  if ( v1 < 0 )
  {
