/*
 * XREFs of ?ProxyFromSubscriberTag@DXGVMBUSCHANNEL@@AEAAJIPEAPEAVDXGCHANNELENDPOINTPROXY@@@Z @ 0x1C01E553C
 * Callers:
        ...
        struct DXGCHANNELENDPOINTPROXY **a3)
{
  ...
  v6 = -1073741275;
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v10, (DXGVMBUSCHANNEL *)((char *)this + 56), 1);
