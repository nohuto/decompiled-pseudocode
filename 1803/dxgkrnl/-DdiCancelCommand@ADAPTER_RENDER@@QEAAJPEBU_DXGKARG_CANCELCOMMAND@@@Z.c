/*
 * XREFs of ?DdiCancelCommand@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_CANCELCOMMAND@@@Z @ 0x1C015CD24
 * Callers:
 *     ?ADAPTER_RENDER_DdiCancelCommand@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_CANCELCOMMAND@@@Z @ 0x1C002E1B0 (-ADAPTER_RENDER_DdiCancelCommand@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_CANCELCOMMAND@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v28, 5052);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_CANCELCOMMAND *))(*((_QWORD *)this + 2) + 736LL))(
