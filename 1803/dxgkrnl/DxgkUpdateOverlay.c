/*
 * XREFs of DxgkUpdateOverlay @ 0x1C01AE3F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkUpdateOverlay(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v25; // rcx
  __int64 v26; // rax
  int v27; // [rsp+20h] [rbp-D8h] BYREF
  __int64 v28; // [rsp+28h] [rbp-D0h]
  _QWORD v29[2]; // [rsp+30h] [rbp-C8h] BYREF
  _BYTE v30[16]; // [rsp+40h] [rbp-B8h] BYREF
  _D3DKMT_UPDATEOVERLAY v31; // [rsp+50h] [rbp-A8h] BYREF
  _BYTE v32[24]; // [rsp+90h] [rbp-68h] BYREF
  DXGADAPTER *v33[10]; // [rsp+A8h] [rbp-50h] BYREF
  struct DXGDEVICE *v34; // [rsp+108h] [rbp+10h] BYREF
  DXGDEVICE *v35; // [rsp+110h] [rbp+18h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v27, 2023);
...
LABEL_6:
  ...
  v31 = *v3;
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)&v34, v31.hDevice, (struct _KTHREAD **)Current, &v35);
  v14 = (struct ADAPTER_RENDER **)v35;
  if ( !v35 )
  {
    v15 = WdLogNewEntry5_WdError(v13);
    *(_QWORD *)(v15 + 24) = v31.hDevice;
    updated = -1073741811;
...
LABEL_14:
  ...
  v19 = (v31.hOverlay >> 6) & 0xFFFFFF;
  if ( (unsigned int)v19 < *((_DWORD *)Current + 62)
    && (v18 = *((_QWORD *)Current + 29),
        v16 = *(unsigned int *)(v18 + 16 * v19 + 8),
        v17 = (v31.hOverlay >> 25) & 0x60,
        ((v31.hOverlay >> 25) & 0x60) == (*(_BYTE *)(v18 + 16 * v19 + 8) & 0x60))
    && (v16 & 0x2000) == 0
    && (v16 & 0x1F) != 0
    && (*(_BYTE *)(v18 + 16 * (((unsigned __int64)v31.hOverlay >> 6) & 0xFFFFFF) + 8) & 0x1F) == 6 )
  {
    v20 = *(struct DXGOVERLAY **)(v18 + 16 * (((unsigned __int64)v31.hOverlay >> 6) & 0xFFFFFF));
  }
  else
  {
    v20 = 0LL;
...
LABEL_27:
  ...
  if ( v22 >= 0 )
  {
    ...
    updated = DXGOVERLAY::UpdateOverlay((struct _EX_RUNDOWN_REF *)v20, &v31);
