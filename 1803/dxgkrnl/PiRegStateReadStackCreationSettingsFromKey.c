/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C01EC410
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C01EC858 (SeUtilSecurityInfoFromSecurityDescriptor.c)
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C01ECB1C (CmRegUtilUcValueGetFullBuffer.c)
