/*
 * XREFs of ?WriteDxgDiagnosticsEvent_SDC@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C00083BC
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_SDC(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( *((_BYTE *)DXGGLOBAL::GetGlobal() + 1696) )
  {
      ...
      && TlgKeywordOn(v6, v7) )
    {
      ...
      v15 = 2;
      v17 = a1;
      TlgWrite(v9, &unk_1C0058A91, 0LL, v8, 5u, &pData);
    }
  }
  else if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000001uLL) && hProvider > 4u )
  {
    if ( TlgKeywordOn(v2, v3) )
    {
      ...
      v15 = 2;
      v17 = a1;
      TlgWrite(v5, &unk_1C0058A6F, 0LL, v4, 5u, &pData);
    }
  }
}
