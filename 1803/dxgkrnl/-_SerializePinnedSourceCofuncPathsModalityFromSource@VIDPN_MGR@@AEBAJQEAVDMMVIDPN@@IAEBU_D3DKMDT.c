/*
 * XREFs of ?_SerializePinnedSourceCofuncPathsModalityFromSource@VIDPN_MGR@@AEBAJQEAVDMMVIDPN@@IAEBU_D3DKMDT_VIDPN_SOURCE_MODE@@QEAV?$AutoBuffer@U_DMM_COFUNCPATHSMODALITY_SERIALIZATION@@@DMM@@@Z @ 0x1C0218754
 * Callers:
        ...
        __int64 a5)
{
  ...
  __int64 v32; // rax
  __int64 v33; // rax
  struct DMMVIDPNSOURCEMODESET *v34; // [rsp+48h] [rbp+10h] BYREF
...
LABEL_13:
  auto_rc<DMMVIDPNTARGETMODESET>::reset((__int64 *)&v34, v18);
  v20 = v34;
  v21 = VIDPN_MGR::PinVidPnSourceMode(this, v34, a4);
  v26 = v21;
  if ( v21 < 0 )
  {
