/*
 * XREFs of ?PinPathContentRotation@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C0216224
 * Callers:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a3)
{
  ...
  v21 = *(_DWORD *)(v15 + 24);
  v16 = VIDPN_MGR::FormalizeVidPnChange(this, (struct D3DKMDT_HVIDPN__ *)(v14 & -(__int64)(v14 != -88)), 9, 1, &v20);
  v10 = v16;
  if ( v16 < 0 )
  {
    if ( v16 == -1071774970 )
