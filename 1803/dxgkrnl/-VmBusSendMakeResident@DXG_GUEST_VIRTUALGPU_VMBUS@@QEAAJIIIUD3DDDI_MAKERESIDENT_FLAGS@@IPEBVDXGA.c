/*
 * XREFs of ?VmBusSendMakeResident@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIIUD3DDDI_MAKERESIDENT_FLAGS@@IPEBVDXGALLOCATIONREFERENCE@@PEA_K2@Z @ 0x1C01837E8
 * Callers:
  ...
  else
  {
    ...
    if ( v12 )
    {
      ...
      *((_DWORD *)v12 + 9) = a6;
      ...
      v26 = 24;
      v22 = VmBusSendSyncMessage(*v27, v14, 4 * a6 + 44, v28, &v26, v25);
      if ( v22 < 0 )
        goto LABEL_14;
      v22 = -1073741823;
      if ( v26 < 0x18 )
