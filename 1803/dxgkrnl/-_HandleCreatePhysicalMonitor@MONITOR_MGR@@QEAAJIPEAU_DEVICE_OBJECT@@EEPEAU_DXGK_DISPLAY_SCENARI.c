/*
 * XREFs of ?_HandleCreatePhysicalMonitor@MONITOR_MGR@@QEAAJIPEAU_DEVICE_OBJECT@@EEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C022B610
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a6)
{
  ...
  v9 = a6;
  MONITOR_MGR::_IssueMonitorEvent(this, a2, 0LL, 0LL, 1, a6);
  v42 = 0LL;
...
LABEL_39:
  ...
  if ( v35 >= 0 )
  {
    ...
    {
      MONITOR_MGR::_InsertMonitorToList((MONITOR_MGR *)this, v36);
    }
    if ( !MONITOR_MGR::_DelayNotifyClient )
    {
      if ( v16 )
        v12 = v16;
      return MONITOR_MGR::_HandleCreateMonitorStep2((MONITOR_MGR *)this, a2, v12, v36, v9);
    }
    if ( *((_QWORD *)v36 + 60) )
    {
  ...
  if ( v16 )
    MONITOR_MGR::_HandleCreateMonitorStep2((MONITOR_MGR *)this, a2, v16, 0LL, v9);
  if ( v12 )
