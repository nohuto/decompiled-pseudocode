/*
 * XREFs of ?AcquireSourceModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_DXGK_VIDPNSOURCEMODESET_INTERFACE@@@Z @ 0x1C00BB020
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNSOURCEMODESET__ **a4)
{
  ...
  struct D3DKMDT_HVIDPNSOURCEMODESET__ *v34; // [rsp+60h] [rbp+8h]
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v32, 7043);
  ...
  *a4 = 0LL;
  ...
  if ( !DMMVIDPNTOPOLOGY::IsSourceInTopology((DMMVIDPNTOPOLOGY *)(v15 + 96), v5) )
  {
  ...
  v34 = *(struct D3DKMDT_HVIDPNSOURCEMODESET__ **)(*(_QWORD *)(v17 + 48) + 384LL);
  v19 = IndexedSet<DMMVIDPNSOURCE>::FindById(*(_QWORD *)(v17 + 304), v5);
  v21 = v19;
  if ( !v19 )
  {
