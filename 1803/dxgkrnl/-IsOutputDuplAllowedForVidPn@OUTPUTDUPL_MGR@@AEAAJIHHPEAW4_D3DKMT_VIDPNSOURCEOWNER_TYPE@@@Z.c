/*
 * XREFs of ?IsOutputDuplAllowedForVidPn@OUTPUTDUPL_MGR@@AEAAJIHHPEAW4_D3DKMT_VIDPNSOURCEOWNER_TYPE@@@Z @ 0x1C01C9FC4
 * Callers:
        ...
        enum _D3DKMT_VIDPNSOURCEOWNER_TYPE *a5)
{
  ...
  {
    v7 = a2;
    v8 = *(_DWORD *)(3760LL * a2 + *(_QWORD *)(v6 + 112) + 700);
    ...
    *a5 = VidPnSourceOwnerType;
    if ( a4 )
      return VidPnSourceOwnerType != D3DKMT_VIDPNSOURCEOWNER_SHARED ? 0xC01E0343 : 0;
    if ( VidPnSourceOwnerType != D3DKMT_VIDPNSOURCEOWNER_SHARED && (v8 & 1) == 0 )
    {
