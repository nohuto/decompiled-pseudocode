/*
 * XREFs of ?RebuildMonitorModeListCacheHelper@@YAJPEAVDXGADAPTER@@IPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C022A3A8
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a3)
{
  ...
  v15 = 0LL;
  v6 = a2;
  MonitorInstance = MONITOR_MGR::_GetMonitorInstance(*(struct _FAST_MUTEX **)(v3 + 96), a2, 0, &v15);
  ...
  if ( MonitorInstance >= 0 )
  {
    ...
    v13 = (struct _ERESOURCE *)((char *)v9 + 296);
    LODWORD(v9) = updated;
