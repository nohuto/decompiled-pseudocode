/*
 * XREFs of ?OpenSectionAndEvents@CTokenManager@@UEAAJPEAPEAXPEA_K00@Z @ 0x1C004AA90
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall CTokenManager::OpenSectionAndEvents(PVOID *this, void **a2, unsigned __int64 *a3, void **a4, void **a5)
{
  int result; // eax
