/*
 * XREFs of McTemplateK0qPR0qqPR3XR3 @ 0x1C0033178
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qPR0qqPR3XR3(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        __int64 a9)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventSignalSynchronizationObjectFromGpu, a3, 7u, &v10);
}
