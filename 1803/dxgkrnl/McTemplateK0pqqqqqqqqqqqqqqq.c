/*
 * XREFs of McTemplateK0pqqqqqqqqqqqqqqq @ 0x1C00453FC
 * Callers:
...
NTSTATUS McTemplateK0pqqqqqqqqqqqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v34 = 4LL;
  v36 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &SetTimingsFromVidPn, a3, 0x11u, &v4);
}
