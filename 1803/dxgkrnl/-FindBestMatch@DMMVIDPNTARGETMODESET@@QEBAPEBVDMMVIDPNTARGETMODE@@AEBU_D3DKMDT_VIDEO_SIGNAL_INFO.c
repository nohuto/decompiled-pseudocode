/*
 * XREFs of ?FindBestMatch@DMMVIDPNTARGETMODESET@@QEBAPEBVDMMVIDPNTARGETMODE@@AEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@@Z @ 0x1C0044864
 * Callers:
        ...
        const struct _D3DKMDT_VIDEO_SIGNAL_INFO *a2)
{
  ...
  const struct DMMVIDPNSOURCEMODE *v4; // rdi
  int v7; // r10d
