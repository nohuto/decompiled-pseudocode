/*
 * XREFs of ?MiracastProcessPendingDPCChunks@@YAEPEAX@Z @ 0x1C003CBC0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall MiracastProcessPendingDPCChunks(_WORD *a1)
{
  ...
  *((_DWORD *)a1 + 5) = 0;
  ...
  else
  {
    ...
    v7 = *(struct MIRACAST_CHUNK_LIST **)(v3 + 3128);
    if ( *((_DWORD *)v7 + 4) != v1 )
    {
    ...
    v8 = *(struct MIRACAST_CHUNK_LIST **)(v3 + 3136);
    if ( *((_DWORD *)v8 + 4) != v1 )
    {
      MIRACAST_CHUNK_LIST::AddChunkListToTail(*(MIRACAST_CHUNK_LIST **)(v3 + 3120), v8);
      v3 = *(_QWORD *)v2;
    }
    result = 1;
    *((_DWORD *)v2 + 5) = *(_DWORD *)(*(_QWORD *)(v3 + 3120) + 16LL);
  }
  return result;
}
