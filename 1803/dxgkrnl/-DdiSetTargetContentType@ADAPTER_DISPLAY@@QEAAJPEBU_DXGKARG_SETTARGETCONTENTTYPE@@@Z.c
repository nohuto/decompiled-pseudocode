/*
 * XREFs of ?DdiSetTargetContentType@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETTARGETCONTENTTYPE@@@Z @ 0x1C0162958
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v26, 5078);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETTARGETCONTENTTYPE *))(*((_QWORD *)this + 2) + 1064LL))(
