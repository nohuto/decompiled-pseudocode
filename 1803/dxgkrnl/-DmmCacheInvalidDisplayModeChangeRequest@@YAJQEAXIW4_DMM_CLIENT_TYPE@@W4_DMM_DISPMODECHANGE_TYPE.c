/*
 * XREFs of ?DmmCacheInvalidDisplayModeChangeRequest@@YAJQEAXIW4_DMM_CLIENT_TYPE@@W4_DMM_DISPMODECHANGE_TYPE@@JQEBE@Z @ 0x1C0211EE8
 * Callers:
...
__int64 __fastcall DmmCacheInvalidDisplayModeChangeRequest(DXGADAPTER *a1, int a2, __int64 a3, __int64 a4, int a5)
{
  __int64 v7; // r9
