/*
 * XREFs of DpiFilterOutVgaResources @ 0x1C01FD65C
 * Callers:
...
__int64 __fastcall DpiFilterOutVgaResources(__int64 a1, _DWORD *a2, _QWORD *a3, char a4)
{
  ...
  v19 = (unsigned int)(v32 - 60);
  PoolWithTagPriority = ExAllocatePoolWithTagPriority(PagedPool, v19, 0x74727044u, HighPoolPriority);
