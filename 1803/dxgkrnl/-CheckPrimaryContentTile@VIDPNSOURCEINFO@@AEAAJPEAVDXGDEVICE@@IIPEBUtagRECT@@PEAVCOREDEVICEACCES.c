/*
 * XREFs of ?CheckPrimaryContentTile@VIDPNSOURCEINFO@@AEAAJPEAVDXGDEVICE@@IIPEBUtagRECT@@PEAVCOREDEVICEACCESS@@PEAI3@Z @ 0x1C01EA524
 * Callers:
...
int __fastcall VIDPNSOURCEINFO::CheckPrimaryContentTile(
...
LABEL_13:
    ...
    *a8 = v16;
    ...
    DXGDEVICE::Unlock((DXGDEVICE *)a2, &v23, 0LL);
    return v13;
  }
  return result;
}
