/*
 * XREFs of ?CreateDevice@ADAPTER_RENDER@@QEAAJPEAPEAVDXGDEVICE@@U_D3DKMT_CREATEDEVICEFLAGS@@W4DXGDEVICECLIENT_TYPE@@PEAVDXGADAPTER@@EEPEAUDXGK_VIRTUAL_GPU_PARAV@@PEAPEAUDXG_SET_GUEST_DATA@@@Z @ 0x1C00A5C30
 * Callers:
 ...
 *     ??_GDXGDEVICE@@QEAAPEAXI@Z @ 0x1C0023B18 (--_GDXGDEVICE@@QEAAPEAXI@Z.c)
        ...
        __int64 a9)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(a1[2]) )
  {
    ...
    *(_QWORD *)(v28 + 24) = 1673LL;
    WdLogEvent5_WdAssertion(v28);
  }
  if ( a5 && (!DXGADAPTER::IsCoreResourceSharedOwner(a5) || !*((_QWORD *)a5 + 307)) )
  {
    v29 = WdLogNewEntry5_WdAssertion(v13);
    *(_QWORD *)(v29 + 24) = 1676LL;
    WdLogEvent5_WdAssertion(v29);
  }
  if ( !a2 )
  {
    v30 = WdLogNewEntry5_WdAssertion(v13);
    *(_QWORD *)(v30 + 24) = 1677LL;
  ...
  if ( !Current )
  {
    ...
    *(_QWORD *)(v31 + 24) = 1683LL;
    WdLogEvent5_WdAssertion(v31);
  }
  *a2 = 0LL;
  _InterlockedIncrement64((volatile signed __int64 *)a1[2] + 3);
  PoolWithQuotaTag = ExAllocatePoolWithQuotaTag((POOL_TYPE)9, 0x6E0uLL, 0x4B677844u);
  if ( PoolWithQuotaTag )
...
LABEL_25:
  ...
  *v22 = (DXGADAPTER *)v18;
  ...
  if ( *(struct DXGPROCESS **)(v26 + 8) != (struct DXGPROCESS *)((char *)Current + 272) )
    __fastfail(3u);
  *v25 = v26;
  *(_QWORD *)(v18 + 32) = v24;
  *(_QWORD *)(v26 + 8) = v25;
