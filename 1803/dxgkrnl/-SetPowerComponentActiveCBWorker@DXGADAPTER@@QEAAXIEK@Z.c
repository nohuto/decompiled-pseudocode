/*
 * XREFs of ?SetPowerComponentActiveCBWorker@DXGADAPTER@@QEAAXIEK@Z @ 0x1C0026A20
 * Callers:
 ...
 *     ?RecordActivity@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C0033900 (-RecordActivity@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
        ...
        unsigned int a4)
{
  ...
  if ( *((_QWORD *)this + 313) )
  {
    ...
    if ( v10 )
    {
      ...
      if ( *((_DWORD *)this + 896) )
      {
        KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 501, &LockHandle);
        *(_BYTE *)(*(_QWORD *)(v9 + 512) + 240LL) = 1;
        if ( !*((_BYTE *)this + 4016) )
        {
          ...
          *((_QWORD *)this + 484) = -1LL;
          KeSetTimer((PKTIMER)((char *)this + 3880), (LARGE_INTEGER)-120000LL, (PKDPC)((char *)this + 3944));
        }
    ...
    if ( (int)++*(_DWORD *)(v9 + 352) <= 1 )
    {
      ...
      {
        KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)this + 379, &v23);
        v14 = (_QWORD *)(v9 + 440);
        v15 = *(_QWORD *)(v9 + 440);
        if ( v15 )
        {
          ...
          *(_QWORD *)(v15 + 8) = v16;
          *v14 = 0LL;
          if ( *((DXGADAPTER **)this + 373) == (DXGADAPTER *)((char *)this + 2984) )
          {
            KeCancelTimer((PKTIMER)((char *)this + 3048));
            *((_BYTE *)this + 2933) = 0;
          }
    ...
    if ( v11 )
    {
      ...
      PoFxActivateComponent(*((_QWORD *)this + 313), (unsigned int)v5, v21);
      if ( v12 )
      {
        if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
