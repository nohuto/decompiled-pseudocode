/*
 * XREFs of McTemplateK0qqqiiqttddtqq @ 0x1C0035CA8
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqiiqttddtqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a16)
{
  ...
  v41 = 4LL;
  v43 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &Dxgk_Diag_OutputDupl_Get_Frame_Data, a3, 0xEu, &v17);
}
