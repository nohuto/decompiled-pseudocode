/*
 * XREFs of ?DmmRemovePathsFromVidPnSource@@YAJPEAVDXGDEVICE@@IE@Z @ 0x1C0214AB0
 * Callers:
...
__int64 __fastcall DmmRemovePathsFromVidPnSource(struct DXGDEVICE *a1, unsigned int a2, char a3)
{
  ...
  _DWORD v82[60]; // [rsp+C0h] [rbp-40h] BYREF
  ...
  v76 = *(ADAPTER_DISPLAY **)(v3 + 2456);
  v77 = (VIDPN_MGR *)*((_QWORD *)v76 + 11);
  v8 = (const struct DMMVIDPN **)v77;
  ...
  *(_QWORD *)(v10 + 32) = v8;
  ...
  if ( a3 )
  {
    ADAPTER_DISPLAY::GetPrimaryPath(*(ADAPTER_DISPLAY **)(v3 + 2456), &v74, &v72, (enum _DXGK_PRIMARY_TARGET_TYPE *)v79);
    v14 = v72;
    if ( v74 != (_DWORD)v5 )
      v14 = -1;
    v72 = v14;
  ...
  {
    v71 = -1;
    v18 = DMMVIDPNTOPOLOGY::EnumPathTargetsFromSource(v75, v5, i, (unsigned int *)&v71);
    v20 = v18;
    if ( v18 < 0 )
    {
      if ( v18 == -1071774919 )
    ...
    if ( v71 == v15 )
    {
      ...
      if ( v30 == D3DKMDT_VPPS_UNPINNED )
      {
        ...
        *(_QWORD *)(v31 + 24) = 13714LL;
        WdLogEvent5_WdAssertion(v31);
        v30 = v71;
      }
      if ( ((v30 - 1) & 0xFFFFFFFD) != 0 && (*((_DWORD *)Path + 30) & 4) != 0 )
      {
        if ( (int)DMMVIDPNPRESENTPATH::UnpinContentScaling(Path, v24, v26, v27) < 0 )
        {
...
LABEL_39:
    ...
    v49 = v76;
    v58 = ADAPTER_DISPLAY::DestroyCddAllocations(v76, v41, v5);
    v60 = v58;
    if ( v58 < 0 )
    {
...
LABEL_43:
  ...
  if ( v62 )
  {
    (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(v62 + 520) + 8LL) + 888LL))(
      *(_QWORD *)(v62 + 528),
      (unsigned int)v5);
  }
  else
