/*
 * XREFs of McTemplateK0pqxqqipqx @ 0x1C00371B4
 * Callers:
...
NTSTATUS McTemplateK0pqxqqipqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v26 = 4LL;
  v28 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventVSyncDPC, 0LL, 0xAu, &v10);
}
