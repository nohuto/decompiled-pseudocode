/*
 * XREFs of McTemplateK0pqdqpp @ 0x1C0037DB0
 * Callers:
...
NTSTATUS McTemplateK0pqdqpp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndirectSwapChainOpen, a3, 7u, &v4);
}
