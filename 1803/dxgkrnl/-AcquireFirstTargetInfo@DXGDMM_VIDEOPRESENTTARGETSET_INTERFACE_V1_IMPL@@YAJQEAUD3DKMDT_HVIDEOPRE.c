/*
 * XREFs of ?AcquireFirstTargetInfo@DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEAPEBU_D3DKMDT_VIDEO_PRESENT_TARGET@@@Z @ 0x1C0218F30
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDEO_PRESENT_TARGET **a3)
{
  ...
  __int64 v6; // rax
  unsigned int v7; // ebx
  DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE_V1_IMPL *v8; // rdi
  __int64 v9; // rax
  int v10; // eax
  __int64 v11; // rdx
  __int64 v12; // rcx
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v23, 6045);
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v8 )
    {
      ...
      v10 = DMMVIDEOPRESENTTARGETSET::AcquireDdiEnumeratorCachedTargetInfo<KM_STL::mem_fun_t<DMMVIDEOPRESENTTARGET *,DMMVIDEOPRESENTTARGETSET>>(
              v8,
              &v25,
              &v27);
      v7 = v10;
