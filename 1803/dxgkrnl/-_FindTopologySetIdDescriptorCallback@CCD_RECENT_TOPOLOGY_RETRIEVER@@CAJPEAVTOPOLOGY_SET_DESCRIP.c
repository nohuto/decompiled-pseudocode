/*
 * XREFs of ?_FindTopologySetIdDescriptorCallback@CCD_RECENT_TOPOLOGY_RETRIEVER@@CAJPEAVTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@PEAX@Z @ 0x1C00B0500
 * Callers:
 ...
 *     ?IsSimilarTopology@CCD_SET_STRING_ID@@QEBA_NAEBV1@@Z @ 0x1C022983C (-IsSimilarTopology@CCD_SET_STRING_ID@@QEBA_NAEBV1@@Z.c)
 */
...
LABEL_37:
  ...
  v10 = (void **)*((_QWORD *)a2 + 22);
  SetIdFromRegistry = CcdLazyRetrieveSetIdFromRegistry(v10[12], L"SetId", (CCD_SET_STRING_ID *)v10);
  ...
  if ( !CCD_SET_STRING_ID::IsSubsetOf(v8, (const struct CCD_SET_STRING_ID *)v10) )
    return 0LL;
...
LABEL_15:
  ...
  {
    RecentTopologySetId = CCD_STORE::CONNECTED_SET_DESCRIPTOR::GetRecentTopologySetId(*((_QWORD *)a2 + 22), 0xFu);
  ...
  if ( ((unsigned int)v42 & *((_DWORD *)a2 + 2)) == 0 )
    return 0LL;
  RecentTopologySetId = CCD_STORE::CONNECTED_SET_DESCRIPTOR::GetRecentTopologySetId(*((_QWORD *)a2 + 22), v42);
  if ( !RecentTopologySetId )
  {
    v36 = (_QWORD *)WdLogNewEntry5_WdError(v25);
    v36[3] = v42;
