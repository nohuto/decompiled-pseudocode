/*
 * XREFs of ?DdiSetContextSchedulingProperties@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C0161B00
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetContextSchedulingProperties@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES@@@Z @ 0x1C002E3F0 (-ADAPTER_RENDER_DdiSetContextSchedulingProperties@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETCONTEX.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  int v12; // ebp
  __int64 v13; // rcx
  __int64 (__fastcall *v14)(_QWORD, const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *); // rax
  int v15; // edi
  __int64 v16; // rcx
  _QWORD *v17; // rax
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v25, 5117);
...
LABEL_15:
  ...
  v13 = *((_QWORD *)this + 2);
  v14 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETCONTEXTSCHEDULINGPROPERTIES *))(v13 + 1176);
  if ( v14 )
