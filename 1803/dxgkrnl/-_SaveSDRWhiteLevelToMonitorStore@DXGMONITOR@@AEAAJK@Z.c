/*
 * XREFs of ?_SaveSDRWhiteLevelToMonitorStore@DXGMONITOR@@AEAAJK@Z @ 0x1C0233D9C
 * Callers:
...
__int64 __fastcall DXGMONITOR::_SaveSDRWhiteLevelToMonitorStore(UNICODE_STRING *this, int a2)
{
  __int64 result; // rax
  __int64 v4; // rbx
  __int64 v5; // rcx
