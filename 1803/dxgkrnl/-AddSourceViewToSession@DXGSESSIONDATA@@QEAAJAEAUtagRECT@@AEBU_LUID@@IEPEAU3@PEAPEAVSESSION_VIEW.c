/*
 * XREFs of ?AddSourceViewToSession@DXGSESSIONDATA@@QEAAJAEAUtagRECT@@AEBU_LUID@@IEPEAU3@PEAPEAVSESSION_VIEW@@@Z @ 0x1C00A268C
 * Callers:
 *     DxgkCreateSessionViewForCurrentSession @ 0x1C00DE334 (DxgkCreateSessionViewForCurrentSession.c)
 * Callees:
 *     ??_U@YAPEAX_KIW4_POOL_TYPE@@@Z @ 0x1C0015040 (--_U@YAPEAX_KIW4_POOL_TYPE@@@Z.c)
 *     ?IsEqualRect@@YAEAEBUtagRECT@@0@Z @ 0x1C0036430 (-IsEqualRect@@YAEAEBUtagRECT@@0@Z.c)
 ...
 *     ?AddDisplaySource@SESSION_VIEW@@QEAAJPEAVDISPLAY_SOURCE@@E@Z @ 0x1C00AA474 (-AddDisplaySource@SESSION_VIEW@@QEAAJPEAVDISPLAY_SOURCE@@E@Z.c)
 */
...
LABEL_17:
  ...
  v15 = (char *)this + 18560;
  for ( i = (char *)*((_QWORD *)this + 2320); i != v15; i = *v30 )
  {
