/*
 * XREFs of ?DpiIndirectGetMiniport@@YAJAEBUDXGK_MINIPORT_FILTER@@AEAVAUTO_REMOVE_LOCK@@AEAVAUTO_PNPPOWER_LOCK@@PEAPEAU_FDO_CONTEXT@@@Z @ 0x1C0205FB0
 * Callers:
        ...
        struct _FDO_CONTEXT **a4)
{
  ...
  v7 = qword_1C007A778;
  v14 = 0;
  if ( (__int64 *)qword_1C007A778 == &qword_1C007A778 )
    goto LABEL_33;
  do
  {
...
LABEL_27:
  ...
  while ( (__int64 *)v7 != &qword_1C007A778 );
  v5 = v15;
