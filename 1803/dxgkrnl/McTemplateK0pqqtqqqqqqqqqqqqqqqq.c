/*
 * XREFs of McTemplateK0pqqtqqqqqqqqqqqqqqqq @ 0x1C002856C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0pqqtqqqqqqqqqqqqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a23)
{
  ...
  v62 = 4LL;
  v64 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &DisplayConfigPlaneChange, a3, 0x15u, &v24);
}
