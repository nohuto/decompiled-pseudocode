/*
 * XREFs of ?DdiRenderGdi@ADAPTER_RENDER@@QEAAJPEAXPEAU_DXGKARG_RENDERGDI@@@Z @ 0x1C0146970
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiRenderGdi(ADAPTER_RENDER *this, void *a2, struct _DXGKARG_RENDERGDI *a3)
{
  ...
  _BYTE v34[24]; // [rsp+30h] [rbp-98h] BYREF
  _BYTE v35[8]; // [rsp+48h] [rbp-80h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v32, 5066);
...
LABEL_15:
  ...
  v18 = (*(int (__fastcall **)(void *, struct _DXGKARG_RENDERGDI *))(*((_QWORD *)this + 2) + 800LL))(a2, a3);
  if ( v35[0] )
  ...
  if ( (unsigned int)(v18 + 1073741816) > 0xF
    || (pAllocationList = 32801LL, !_bittest((const int *)&pAllocationList, v18 + 1073741816)) )
  {
    if ( (_DWORD)v18 != -1073741592 && (_DWORD)v18 != -1071775743 && (_DWORD)v18 != -1071775232 && (_DWORD)v18 )
    {
