/*
 * XREFs of ?VailSendDestroyBundleObject@DXGSESSIONDATA@@QEAAJI@Z @ 0x1C01E8278
 * Callers:
...
__int64 __fastcall DXGSESSIONDATA::VailSendDestroyBundleObject(DXGVAILGUESTOBJECT **this, unsigned int a2)
{
