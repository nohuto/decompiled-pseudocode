/*
 * XREFs of DpiMitigatedRangeUpdate @ 0x1C01EFAF8
 * Callers:
...
__int64 __fastcall DpiMitigatedRangeUpdate(__int64 a1, CSHORT a2)
{
  ...
  v2 = *(_QWORD *)(a1 + 64);
  ExAcquirePushLockExclusiveEx(v2 + 5224, 0LL);
  v5 = *(void **)(v2 + 5168);
  if ( v5 )
  {
    v6 = IoCsqRemoveNextIrp((PIO_CSQ)(v2 + 5064), v5);
    if ( v6 )
    {
      KeClearEvent((PRKEVENT)(v2 + 5232));
      v6->AssociatedIrp.MasterIrp->Type = a2;
      v6->IoStatus.Status = 0;
      v6->IoStatus.Information = 2LL;
      IofCompleteRequest(v6, 1);
      KeWaitForSingleObject((PVOID)(v2 + 5232), Executive, 0, 0, 0LL);
    }
  }
  else
  {
  ...
  return ExReleasePushLockExclusiveEx(v2 + 5224, 0LL);
}
