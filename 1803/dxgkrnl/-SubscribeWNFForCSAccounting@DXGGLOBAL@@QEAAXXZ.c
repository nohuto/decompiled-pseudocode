/*
 * XREFs of ?SubscribeWNFForCSAccounting@DXGGLOBAL@@QEAAXXZ @ 0x1C01A1600
 * Callers:
...
void __fastcall DXGGLOBAL::SubscribeWNFForCSAccounting(PVOID *this)
{
  ...
  v3 = ExSubscribeWnfStateChange(this + 197, &v15, 1LL, 0LL, AccountingforCSCallBackFn, 0LL);
  v7 = v3;
  if ( v3 >= 0 )
  {
    v9 = PoRegisterPowerSettingCallback(
           ...
           (PPOWER_SETTING_CALLBACK)LowPowerEpochCallBackFn,
           0LL,
           this + 198);
    v13 = v9;
    if ( v9 >= 0 )
