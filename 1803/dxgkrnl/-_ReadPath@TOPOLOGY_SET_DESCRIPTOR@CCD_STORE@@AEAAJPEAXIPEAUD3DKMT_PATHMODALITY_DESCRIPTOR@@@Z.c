/*
 * XREFs of ?_ReadPath@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@AEAAJPEAXIPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C00B19E0
 * Callers:
        ...
        struct D3DKMT_PATHMODALITY_DESCRIPTOR *a4)
{
  ...
  {
    v10 = CcdReadRegistryValues(a2, &pszDest, &unk_1C00791F0, 0xDu, (__int64)a4);
    v13 = *(unsigned int *)a4;
    *(_QWORD *)a4 = v13;
    v9 = v10;
    if ( v10 < 0 )
    ...
    else
    {
      if ( (v13 & 0x100) != 0 )
      {
        v14 = CcdReadRegistryValues(a2, &pszDest, &unk_1C0079540, 6u, (__int64)a4);
        v9 = v14;
        if ( v14 < 0 )
        {
          ...
          RegistryValues = CcdReadRegistryValues(a2, 0LL, &unk_1C0079690, 8u, (__int64)a4);
          v28 = RegistryValues;
          if ( RegistryValues < 0 )
          {
      ...
      if ( (v13 & 0x800000) != 0 )
      {
        v18 = CcdReadRegistryValues(a2, &pszDest, &unk_1C00790D0, 5u, (__int64)a4);
        v9 = v18;
        if ( v18 < 0 )
        {
