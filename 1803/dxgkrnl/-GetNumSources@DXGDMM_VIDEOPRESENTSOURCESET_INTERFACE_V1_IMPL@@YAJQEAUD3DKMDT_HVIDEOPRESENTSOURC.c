/*
 * XREFs of ?GetNumSources@DXGDMM_VIDEOPRESENTSOURCESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTSOURCESET__@@PEA_K@Z @ 0x1C021AC60
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  {
    *(_QWORD *)a2 = 0LL;
    if ( !this || (v8 = this, *((_DWORD *)this + 26) != 1833172993) )
      v8 = 0LL;
    if ( v8 )
    {
