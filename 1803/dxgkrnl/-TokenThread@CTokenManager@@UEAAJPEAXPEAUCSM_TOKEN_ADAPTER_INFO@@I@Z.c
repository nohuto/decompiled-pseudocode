/*
 * XREFs of ?TokenThread@CTokenManager@@UEAAJPEAXPEAUCSM_TOKEN_ADAPTER_INFO@@I@Z @ 0x1C0010C70
 * Callers:
 *     <none>
 * Callees:
 *     ?ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z @ 0x1C000BD84 (-ValidateUserEvent@CTokenManager@@CAJPEAXPEAPEAX@Z.c)
        ...
        unsigned int a4)
{
  ...
  if ( v7 >= 0 )
  {
    ...
    v7 = (*(__int64 (__fastcall **)(HANDLE *))(*((_QWORD *)Global + 219) + 128LL))(&Handle);
    if ( v7 >= 0 )
