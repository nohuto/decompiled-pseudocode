/*
 * XREFs of McTemplateK0pqCR1qqtqqqqqqx @ 0x1C003A2EC
 * Callers:
...
NTSTATUS McTemplateK0pqCR1qqtqqqqqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v29 = 4LL;
  v31 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventDpiReportAdapter, a3, 0xEu, &v4);
}
