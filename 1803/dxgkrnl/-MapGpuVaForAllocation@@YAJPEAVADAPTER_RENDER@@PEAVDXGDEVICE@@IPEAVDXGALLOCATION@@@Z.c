/*
 * XREFs of ?MapGpuVaForAllocation@@YAJPEAVADAPTER_RENDER@@PEAVDXGDEVICE@@IPEAVDXGALLOCATION@@@Z @ 0x1C01B1E10
 * Callers:
        ...
        struct DXGALLOCATION *a4)
{
  ...
  v8 = *((_QWORD *)a4 + 3);
  v20[7] = 1LL;
  v20[2] = *(_QWORD *)(v7 + 2320);
  v9 = *(_QWORD *)(v7 + 2328);
  v10 = *((_QWORD *)a1 + 69);
  v20[3] = v9;
  v11 = (*(__int64 (__fastcall **)(__int64, __int64, __int64, _QWORD *, char, int))(*(_QWORD *)(*((_QWORD *)a1 + 68)
                                                                                              + 8LL)
                                                                                  + 792LL))(
          v10,
          v18,
  ...
  if ( v11 >= 0 )
  {
    ...
    {
      LODWORD(v15) = 0;
      (*(void (__fastcall **)(_QWORD, __int64 *, _QWORD *, __int64))(*(_QWORD *)(*((_QWORD *)a1 + 68) + 8LL) + 984LL))(
        *((_QWORD *)a1 + 69),
        &v19,
        &v20[12],
        1LL);
