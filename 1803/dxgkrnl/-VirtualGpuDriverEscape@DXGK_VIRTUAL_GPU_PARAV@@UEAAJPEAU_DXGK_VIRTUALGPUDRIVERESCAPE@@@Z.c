/*
 * XREFs of ?VirtualGpuDriverEscape@DXGK_VIRTUAL_GPU_PARAV@@UEAAJPEAU_DXGK_VIRTUALGPUDRIVERESCAPE@@@Z @ 0x1C0179410
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)v10 )
  {
    ...
    if ( (_DWORD)v11 )
    {
      ...
      else
      {
        ...
        *((_BYTE *)this + 124) = 1;
        *(_OWORD *)(*(_QWORD *)(v17 + 456) + 192LL) = *(_OWORD *)((char *)a2->pInputBuffer + 12);
      }
    }
    else
    {
