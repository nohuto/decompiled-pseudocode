/*
 * XREFs of ?ReleaseTargetSet@DXGDMM_INTERFACE_V1_IMPL@@YAJQEAXQEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@@Z @ 0x1C021C0D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDEOPRESENTTARGETSET__ *const a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v15, 6051);
  if ( !this )
  {
