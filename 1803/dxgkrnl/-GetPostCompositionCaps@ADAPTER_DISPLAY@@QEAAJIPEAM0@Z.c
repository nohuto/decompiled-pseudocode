/*
 * XREFs of ?GetPostCompositionCaps@ADAPTER_DISPLAY@@QEAAJIPEAM0@Z @ 0x1C00E1718
 * Callers:
        ...
        float *a4)
{
  ...
  else
  {
    ...
    *a3 = 1.0;
    *a4 = 1.0;
    v9 = *(ADAPTER_RENDER **)(*((_QWORD *)this + 2) + 2464LL);
    if ( v9 )
    {
      if ( ADAPTER_RENDER::IsMultiPlaneOverlaySupported(v9) )
      {
        v12 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 2464LL) + 16LL);
        if ( *(_QWORD *)(v12 + 1120) )
        {
          if ( *(_BYTE *)(v12 + 2410) && ADAPTER_DISPLAY::IsVidPnSourceActive(this, v7) )
          {
