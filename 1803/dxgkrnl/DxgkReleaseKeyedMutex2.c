/*
 * XREFs of DxgkReleaseKeyedMutex2 @ 0x1C01C2F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkReleaseKeyedMutex2(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  unsigned int v26[4]; // [rsp+40h] [rbp-38h]
  void *v27[2]; // [rsp+50h] [rbp-28h]
  unsigned int v28[4]; // [rsp+60h] [rbp-18h]
  DXGKEYEDMUTEX *v29; // [rsp+88h] [rbp+10h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v24, 2069);
...
LABEL_6:
  ...
  *(_OWORD *)v27 = *(_OWORD *)(v3 + 16);
  *(_QWORD *)v28 = *(_QWORD *)(v3 + 32);
  v12 = v26[0];
  DXGKEYEDMUTEXBYHANDLE::DXGKEYEDMUTEXBYHANDLE((DXGKEYEDMUTEXBYHANDLE *)&v29, v26[0], Current, &v30);
  v16 = v30;
  if ( !v30 )
  {
    ...
    *(_QWORD *)(v17 + 32) = -1073741811LL;
    ...
    if ( v29 )
      DXGKEYEDMUTEX::ReleaseReference(v29);
    goto LABEL_6;
  }
  v18 = DXGKEYEDMUTEX::ReleaseSync(v30, v12, *(__int64 *)&v26[2], (struct _LIST_ENTRY *)v27[0], (char *)v27[1], v28[0]);
  v20 = v18;
  if ( v18 < 0 )
  {
