/*
 * XREFs of ?SetPowerComponentIdleCB@DXGADAPTER@@QEAAXI@Z @ 0x1C0026DB8
 * Callers:
...
void __fastcall DXGADAPTER::SetPowerComponentIdleCB(DXGADAPTER *this, int a2)
{
  ...
  v3 = (unsigned __int16)a2 + *((unsigned __int16 *)this + HIWORD(a2) + 1256);
  if ( v3 >= *((_DWORD *)this + 660) )
  {
  ...
  if ( *((_BYTE *)this + 2937) )
  {
    _InterlockedDecrement((volatile signed __int32 *)(520LL * v3 + *((_QWORD *)this + 312) + 348));
