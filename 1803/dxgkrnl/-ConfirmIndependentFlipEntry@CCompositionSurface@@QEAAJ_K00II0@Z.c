/*
 * XREFs of ?ConfirmIndependentFlipEntry@CCompositionSurface@@QEAAJ_K00II0@Z @ 0x1C0017D94
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  if ( Buffer >= 0 )
    (*(void (__fastcall **)(struct CCompositionBuffer *, __int64, __int64, _QWORD, unsigned int, unsigned __int64))(*(_QWORD *)v11 + 184LL))(
      v11,
      a3,
      v9,
      a5,
