/*
 * XREFs of McTemplateK0pqqqqjzqqx @ 0x1C0027950
 * Callers:
...
NTSTATUS McTemplateK0pqqqqjzqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v28 = 8LL;
  va_copy(v27, va7);
  return McGenEventWriteKM(&DxgkControlGuid_Context, &Dxgk_PowerComponent, 0LL, 0xBu, &v7);
}
