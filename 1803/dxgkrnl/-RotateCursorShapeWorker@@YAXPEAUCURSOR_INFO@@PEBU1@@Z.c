/*
 * XREFs of ?RotateCursorShapeWorker@@YAXPEAUCURSOR_INFO@@PEBU1@@Z @ 0x1C01AF794
 * Callers:
 ...
 * Callees:
 *     ?GetRotatedPoint@@YAXIIPEAI0W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@II@Z @ 0x1C01AF49C (-GetRotatedPoint@@YAXIIPEAI0W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@II@Z.c)
 */
    ...
    if ( i )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          GetRotatedPoint(v7, v3, &v18, &v17, v14, v15, v16);
          v13 = (_BYTE *)(*((_QWORD *)a1 + 3) + *((_DWORD *)a1 + 5) * v17 + ((unsigned __int64)v18 >> 3));
