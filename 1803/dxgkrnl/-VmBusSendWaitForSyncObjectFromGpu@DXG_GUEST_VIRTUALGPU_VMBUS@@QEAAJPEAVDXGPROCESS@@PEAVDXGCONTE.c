/*
 * XREFs of ?VmBusSendWaitForSyncObjectFromGpu@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGCONTEXT@@PEBIPEAPEAVDXGSYNCOBJECT@@PEAPEAVDXGDEVICESYNCOBJECT@@PEB_K_KI@Z @ 0x1C0186178
 * Callers:
        ...
        unsigned int a9)
{
  ...
  else
  {
    ...
    if ( v14 )
    {
      ...
      *((_DWORD *)v16 + 2) = DXGPROCESS::GetHostProcess((DXGPROCESS *)a2);
      *((_DWORD *)v16 + 7) = v9;
