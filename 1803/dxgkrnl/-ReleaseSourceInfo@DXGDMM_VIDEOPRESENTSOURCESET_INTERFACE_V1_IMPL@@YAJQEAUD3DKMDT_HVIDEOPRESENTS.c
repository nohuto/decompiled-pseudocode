/*
 * XREFs of ?ReleaseSourceInfo@DXGDMM_VIDEOPRESENTSOURCESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTSOURCESET__@@QEBU_D3DKMDT_VIDEO_PRESENT_SOURCE@@@Z @ 0x1C021BDA0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDEO_PRESENT_SOURCE *const a3)
{
  ...
  __int64 v6; // rax
  unsigned int v7; // ebx
  DMMVIDEOPRESENTSOURCESET *v8; // rcx
  __int64 v9; // rax
  __int64 v10; // rcx
  __int64 v11; // r8
  ...
  if ( (qword_1C0079010 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
    McTemplateK0q((__int64)this, &EventProfilerEnter, (__int64)a3, 6043);
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v13, 6043);
  if ( a2 )
  {
