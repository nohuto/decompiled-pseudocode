/*
 * XREFs of ?WriteDxgDiagnosticsEvent_DISPLAYCHANGE_ORIGIN@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C00086FC
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_DISPLAYCHANGE_ORIGIN(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&hProvider, 4u, 0x200000000004uLL) && hProvider > 4u )
  {
    if ( TlgKeywordOn(v1, 0x200000000004uLL) )
    {
      v7 = 4LL;
      v6 = &unk_1C00561D0;
      v8 = v11;
      ...
      v10 = v3;
      v11[1] = (_DWORD)v2;
      TlgWrite(v4, &unk_1C00589F8, 0LL, v2, 5u, &pData);
    }
  }
}
