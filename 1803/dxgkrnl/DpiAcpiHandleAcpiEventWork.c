/*
 * XREFs of DpiAcpiHandleAcpiEventWork @ 0x1C0207830
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DpiAcpiHandleAcpiEventWork(PVOID IoObject, PVOID Context, PIO_WORKITEM IoWorkItem)
{
  ...
  while ( 1 )
  {
    ...
    if ( (__int64 *)qword_1C007A920 == &qword_1C007A920 )
    {
      v4 = 0LL;
      ::IoWorkItem = 0LL;
    }
    ...
    {
      if ( *(__int64 **)(qword_1C007A920 + 8) != &qword_1C007A920
        || (v5 = *(_QWORD *)qword_1C007A920, *(_QWORD *)(*(_QWORD *)qword_1C007A920 + 8LL) != qword_1C007A920) )
      {
        __fastfail(3u);
      }
      qword_1C007A920 = *(_QWORD *)qword_1C007A920;
      *(_QWORD *)(v5 + 8) = &qword_1C007A920;
    }
    qword_1C007A918 = 0LL;
