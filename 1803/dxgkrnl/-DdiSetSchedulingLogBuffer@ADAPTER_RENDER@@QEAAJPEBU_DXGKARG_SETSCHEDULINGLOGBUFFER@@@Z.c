/*
 * XREFs of ?DdiSetSchedulingLogBuffer@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETSCHEDULINGLOGBUFFER@@@Z @ 0x1C0162218
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetSchedulingLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETSCHEDULINGLOGBUFFER@@@Z @ 0x1C002E410 (-ADAPTER_RENDER_DdiSetSchedulingLogBuffer@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETSCHEDULINGLOGB.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  int v15; // ebp
  __int64 v16; // rcx
  __int64 (__fastcall *v17)(_QWORD, const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *); // rax
  int v18; // edi
  __int64 v19; // rcx
  _QWORD *v20; // rax
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v28, 5114);
...
LABEL_15:
  ...
  v16 = *((_QWORD *)this + 2);
  v17 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETSCHEDULINGLOGBUFFER *))(v16 + 1152);
  if ( v17 )
