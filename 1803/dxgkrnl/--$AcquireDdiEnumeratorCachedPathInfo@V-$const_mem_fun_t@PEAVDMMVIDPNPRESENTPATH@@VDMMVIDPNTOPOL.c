/*
 * XREFs of ??$AcquireDdiEnumeratorCachedPathInfo@V?$const_mem_fun_t@PEAVDMMVIDPNPRESENTPATH@@VDMMVIDPNTOPOLOGY@@@KM_STL@@@DMMVIDPNTOPOLOGY@@QEAAJV?$const_mem_fun_t@PEAVDMMVIDPNPRESENTPATH@@VDMMVIDPNTOPOLOGY@@@KM_STL@@PEAPEBU_D3DKMDT_VIDPN_PRESENT_PATH@@H@Z @ 0x1C00BB8A0
 * Callers:
      ...
      if ( v14 )
      {
        ...
        *((_DWORD *)v14 + 7) = *(_DWORD *)(v9 + 112);
        ...
        if ( (unsigned int)(v16 - 254) <= 1
          || !v16
          || (v24 = DMMVIDPNPRESENTPATH::IsPathSupportVirtualMode((DMMVIDPNPRESENTPATH *)v9) == 0, v17 = 1, v24) )
        {
          v17 = *(_DWORD *)(v9 + 116);
        }
        *((_DWORD *)v14 + 9) = v17;
