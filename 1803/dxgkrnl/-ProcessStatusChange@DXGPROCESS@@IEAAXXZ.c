/*
 * XREFs of ?ProcessStatusChange@DXGPROCESS@@IEAAXXZ @ 0x1C00F7D3C
 * Callers:
 *     ?DxgkpProcessStatusChangeWork@@YAXPEAX@Z @ 0x1C00DDA00 (-DxgkpProcessStatusChangeWork@@YAXPEAX@Z.c)
 * Callees:
