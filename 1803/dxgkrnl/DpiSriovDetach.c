/*
 * XREFs of DpiSriovDetach @ 0x1C01FBD00
 * Callers:
  ...
  if ( *(_BYTE *)(v7 + v3 + 28) || *(_QWORD *)(v7 + v3) )
  {
    ...
    if ( v17 >= 0 )
    {
      ...
      *(_BYTE *)(v7 + v3 + 28) = 0;
      if ( v9 )
      {
        v10 = IoCsqRemoveNextIrp((PIO_CSQ)(v3 + 5064), v9);
        *(_QWORD *)(v7 + v3) = 0LL;
        if ( v10 )
        {
      ...
      if ( v11 )
      {
        v12 = IoCsqRemoveNextIrp((PIO_CSQ)(v3 + 5064), v11);
        *(_QWORD *)(v7 + v3 + 8) = 0LL;
        if ( v12 )
        {
      ...
      if ( v13 )
      {
        v14 = IoCsqRemoveNextIrp((PIO_CSQ)(v3 + 5064), v13);
        *(_QWORD *)(v7 + v3 + 16) = 0LL;
        if ( v14 )
        {
