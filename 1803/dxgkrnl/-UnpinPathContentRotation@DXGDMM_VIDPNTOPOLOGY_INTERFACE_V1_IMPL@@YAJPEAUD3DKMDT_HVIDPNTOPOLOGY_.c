/*
 * XREFs of ?UnpinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_N@Z @ 0x1C021CA20
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v28, 6029);
  ...
  if ( v8 )
  {
    ...
    if ( Path )
    {
      if ( (int)DMMVIDPNPRESENTPATH::UnpinContentRotation(Path, v13, v15, v16) < 0 )
      {
