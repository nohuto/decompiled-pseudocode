/*
 * XREFs of ?UnRegisterTtmDevice@CTTMDEVICE@@AEAAXE@Z @ 0x1C01D0C44
 * Callers:
...
void __fastcall CTTMDEVICE::UnRegisterTtmDevice(CTTMDEVICE *this, char a2)
{
  ...
  *((_QWORD *)this + 7) = p_Event;
  v19 = *((_QWORD *)this + 4);
  v25 = 0;
  CPROCESSATTACHHELPER::Attach(&ApcState, *(PRKPROCESS *)(v19 + 18592));
  *((_QWORD *)this + 4) = 0LL;
