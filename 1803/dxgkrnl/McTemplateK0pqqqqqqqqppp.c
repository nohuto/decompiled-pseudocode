/*
 * XREFs of McTemplateK0pqqqqqqqqppp @ 0x1C002CB50
 * Callers:
 *     TraceDxgkContext @ 0x1C002CC80 (TraceDxgkContext.c)
...
NTSTATUS McTemplateK0pqqqqqqqqppp(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
