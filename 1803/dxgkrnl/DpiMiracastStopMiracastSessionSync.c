/*
 * XREFs of DpiMiracastStopMiracastSessionSync @ 0x1C003DBB0
 * Callers:
...
LABEL_49:
  ...
  *((_QWORD *)P + 11) = KeGetCurrentThread();
  ...
  if ( v19 <= 8 && (v20 = 374, _bittest(&v20, v19))
    || v19 - 133 <= 0xB && (LODWORD(v14) = 2065, _bittest((const int *)&v14, v19 - 133)) )
  {
...
LABEL_43:
  ...
  *((_QWORD *)P + 11) = 0LL;
  ...
  if ( *(_BYTE *)(v12 + 483) )
    _InterlockedDecrement((volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v12 + 24) + 64LL) + 3912LL));
