/*
 * XREFs of ?DmmGetClientVidPnTargetModeInfo@@YAJQEAXIPEAW4_D3DKMDT_VIDEO_SIGNAL_STANDARD@@PEAIPEAEPEAW4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@PEAU_D3DKMDT_2DREGION@@PEAU_D3DDDI_RATIONAL@@@Z @ 0x1C0212860
 * Callers:
        ...
        struct _D3DDDI_RATIONAL *a8)
{
  ...
  __int64 v35; // rax
  __int64 v36; // rax
  enum _D3DKMDT_VIDEO_SIGNAL_STANDARD *v37; // rcx
...
LABEL_15:
  ...
  if ( v20 )
  {
    ...
    if ( a5 )
    {
      v28 = IndexedSet<DMMVIDPNTARGET>::FindById(*((_QWORD *)a5 + 39), v9);
      if ( v28 )
      {
        if ( DMMVIDPNTOPOLOGY::IsTargetInTopology((DMMVIDPNTOPOLOGY *)(v29 + 96), v26) )
        {
          ...
          v35 = *(_QWORD *)(v34 + 144);
          a7 = (struct _D3DKMDT_2DREGION *)v34;
          if ( !v35 )
          {
          ...
          DmmCalculatePresentationVSync(
            (const struct _D3DKMDT_VIDEO_SIGNAL_INFO *)(v35 + 72),
          ...
          if ( a4 )
            *a4 = DmmMapVSyncFromRationalToInteger(
                    ...
                    (enum _D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING)((int)(*(_DWORD *)(*(_QWORD *)(v34 + 144) + 120LL) << 29) >> 29),
                    0LL);
          if ( v11 )
            *v11 = (unsigned int)(((int)(*(_DWORD *)(*(_QWORD *)(v34 + 144) + 120LL) << 29) >> 29) - 2) <= 1;
          if ( v12 )
            *v12 = (int)(*(_DWORD *)(*(_QWORD *)(v34 + 144) + 120LL) << 29) >> 29;
          if ( v13 )
            *v13 = *(struct _D3DKMDT_2DREGION *)(*(_QWORD *)(v34 + 144) + 84LL);
          if ( v14 )
            *v14 = *(struct _D3DDDI_RATIONAL *)(*(_QWORD *)(v34 + 144) + 92LL);
