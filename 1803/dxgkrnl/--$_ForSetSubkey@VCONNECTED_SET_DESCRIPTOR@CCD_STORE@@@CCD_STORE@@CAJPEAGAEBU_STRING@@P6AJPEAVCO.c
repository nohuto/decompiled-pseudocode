/*
 * XREFs of ??$_ForSetSubkey@VCONNECTED_SET_DESCRIPTOR@CCD_STORE@@@CCD_STORE@@CAJPEAGAEBU_STRING@@P6AJPEAVCONNECTED_SET_DESCRIPTOR@0@PEAX@Z3_N@Z @ 0x1C009DAA8
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)&v28.Length = 0LL;
  ...
  if ( v10 < 0 )
    goto LABEL_9;
  v25 = 2;
  v9 = (int)CcdOpenRegistrySubkey_0((int)&Handle, 983103, (int)v27, (int)&v28, &v25);
