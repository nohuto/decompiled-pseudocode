/*
 * XREFs of BmlDoesTargetModeObeyConstraint @ 0x1C00C1A98
 * Callers:
...
bool __fastcall BmlDoesTargetModeObeyConstraint(__int64 a1, unsigned __int16 a2, __int64 a3)
{
  ...
  int v13; // ecx
  int v14; // ecx
  _D3DDDI_RATIONAL v15; // rax
  int v16; // ecx
  struct _D3DDDI_RATIONAL v17; // [rsp+20h] [rbp-18h] BYREF
  _D3DDDI_RATIONAL v18; // [rsp+40h] [rbp+8h] BYREF

  v4 = 104LL * a2;
  v6 = *(__int64 **)(a1 + v4 + 16);
  if ( (!BmlAreRawModesEnabled(a1) || (*(_BYTE *)v6 & 0x87) == 0) && (*(_DWORD *)(v8 + 8) & 4) == 0 )
  {
    LOBYTE(v7) = v9;
  ...
  if ( (v10 & 4) != 0 && (((unsigned __int8)*(_DWORD *)(a3 + 120) ^ *((_BYTE *)v6 + 80)) & 7) != 0
    || (v10 & 1) != 0 && (v6[1] & 1) != 0 && (unsigned int)BmlCompareModeExtents((int *)(a3 + 84), (_DWORD *)v6 + 11) )
  {
    return 0;
  }
