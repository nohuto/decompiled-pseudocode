/*
 * XREFs of DxgkGetAllMonitorDevicesFromSessionView @ 0x1C009FEC4
 * Callers:
        ...
        __int64 a5)
{
  ...
  v6 = a2;
  v9 = 0;
  v11 = (DXGSESSIONMGR *)*((_QWORD *)DXGGLOBAL::GetGlobal((__int64)a1) + 74);
  if ( v11 )
  {
  ...
  v20 = *((_DWORD *)PrimaryDisplaySource + 4) == (_DWORD)v6
     && *a1 == *(_QWORD *)(*(_QWORD *)(*((_QWORD *)PrimaryDisplaySource + 1) + 16LL) + 268LL);
  *a3 = v20;
...
LABEL_15:
  ...
  if ( v29 < 0 )
  {
    ...
    v32[3] = *(int *)(*(_QWORD *)(*((_QWORD *)PrimaryDisplaySource + 1) + 16LL) + 272LL);
    v32[4] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)PrimaryDisplaySource + 1) + 16LL) + 268LL);
    v32[5] = v31;
LABEL_27:
...
LABEL_22:
  ...
  if ( IsMonitorConnected >= 0 )
  {
    v32 = (_QWORD *)WdLogNewEntry5_WdEvent();
    v32[3] = v40;
    v32[4] = *(int *)(*(_QWORD *)(*((_QWORD *)PrimaryDisplaySource + 1) + 16LL) + 272LL);
    v32[5] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)PrimaryDisplaySource + 1) + 16LL) + 268LL);
    v32[6] = v25;
    goto LABEL_27;
  }
...
LABEL_23:
  v26[3] = v27;
  v26[4] = *(int *)(*(_QWORD *)(*((_QWORD *)PrimaryDisplaySource + 1) + 16LL) + 272LL);
  v26[5] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)PrimaryDisplaySource + 1) + 16LL) + 268LL);
  v26[6] = v25;
