/*
 * XREFs of ?SubmitBltForRegions@OUTPUTDUPL_CONTEXT@@AEAAJPEAU_OUTPUTDUPL_UPDATE_INFO@@IIPEAU_D3DKMT_PRESENT_RGNS@@@Z @ 0x1C01D3D8C
 * Callers:
        ...
        struct _D3DKMT_PRESENT_RGNS *a5)
{
  ...
  if ( MoveRectCount )
  {
    ...
    Buffer = (struct tagRECT *)AUTOEXPANDALLOCATION::GetBuffer(*((const void ***)a2 + 4), v13 + 16 * MoveRectCount, 0);
    pDirtyRects = Buffer;
    if ( !Buffer )
    {
