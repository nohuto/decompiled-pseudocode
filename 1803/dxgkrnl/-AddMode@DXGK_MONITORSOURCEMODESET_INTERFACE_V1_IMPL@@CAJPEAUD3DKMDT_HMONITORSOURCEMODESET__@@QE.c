/*
 * XREFs of ?AddMode@DXGK_MONITORSOURCEMODESET_INTERFACE_V1_IMPL@@CAJPEAUD3DKMDT_HMONITORSOURCEMODESET__@@QEAU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C0230690
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v26, 7021);
  ...
  *(_QWORD *)(v9 + 32) = a1;
  if ( a2 )
  {
    ...
    else
    {
      ...
      inserted = DXGMONITOR::_InsertMonitorSourceMode(v17, a2);
