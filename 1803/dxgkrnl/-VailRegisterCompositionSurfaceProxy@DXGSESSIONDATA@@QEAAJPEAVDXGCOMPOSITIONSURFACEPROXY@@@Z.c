/*
 * XREFs of ?VailRegisterCompositionSurfaceProxy@DXGSESSIONDATA@@QEAAJPEAVDXGCOMPOSITIONSURFACEPROXY@@@Z @ 0x1C01E79E4
 * Callers:
        ...
        struct DXGCOMPOSITIONSURFACEPROXY *a2)
{
  ...
  __int64 v8; // rcx
  __int64 v9; // r8
  struct DXGCOMPOSITIONSURFACEPROXY *v10; // rdx
  int v11; // eax
  __int64 v12; // rdx
  __int64 v13; // rcx
  __int64 v14; // r8
  ...
  {
    LODWORD(v15) = -2147483611;
    v18 = WdLogNewEntry5_WdWarning(v5, v4, v6);
    *(_QWORD *)(v18 + 24) = 1LL;
