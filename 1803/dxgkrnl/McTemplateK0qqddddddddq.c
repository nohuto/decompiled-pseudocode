/*
 * XREFs of McTemplateK0qqddddddddq @ 0x1C002FB60
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqddddddddq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a14)
{
  ...
  v35 = 4LL;
  v37 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventCheckMultiPlaneOverlaySupportPostComposition, a3, 0xCu, &v15);
}
