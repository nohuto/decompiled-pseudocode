/*
 * XREFs of McTemplateK0ppqQR2QR2QR2QR2QR2QR2QR2 @ 0x1C0030FEC
 * Callers:
...
NTSTATUS McTemplateK0ppqQR2QR2QR2QR2QR2QR2QR2(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v8 = 8LL;
  v10 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPatchLocationList, a3, 0xBu, &v4);
}
