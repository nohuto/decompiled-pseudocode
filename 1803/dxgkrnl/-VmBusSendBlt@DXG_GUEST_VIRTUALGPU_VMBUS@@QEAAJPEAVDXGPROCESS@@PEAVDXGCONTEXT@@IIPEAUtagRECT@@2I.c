/*
 * XREFs of ?VmBusSendBlt@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJPEAVDXGPROCESS@@PEAVDXGCONTEXT@@IIPEAUtagRECT@@2IPEBU4@IPEAE@Z @ 0x1C0181650
 * Callers:
...
LABEL_3:
  ...
  if ( v16 )
  {
    ...
    *((_DWORD *)v16 + 19) = Size;
    ...
    v21 = VmBusSendSyncMessageStatusReturn(*this, v19, v13 + Size + 80, v18);
    v23 = v21;
    if ( v21 < 0 )
    {
