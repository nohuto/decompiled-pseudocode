/*
 * XREFs of DxgkAcquireKeyedMutex @ 0x1C01C1B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkAcquireKeyedMutex(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  unsigned int v20[4]; // [rsp+50h] [rbp-28h]
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v18, 2054);
