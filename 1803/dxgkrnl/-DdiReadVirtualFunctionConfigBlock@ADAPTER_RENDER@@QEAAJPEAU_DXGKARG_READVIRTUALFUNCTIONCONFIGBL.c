/*
 * XREFs of ?DdiReadVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C0177370
 * Callers:
 *     ?ReadVirtualFunctionConfigBlock@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C017A1F0 (-ReadVirtualFunctionConfigBlock@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_READVIRTUALFUNCTIONCONF.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v27, 5089);
...
LABEL_15:
  ...
  v13 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_READVIRTUALFUNCTIONCONFIGBLOCK *))(*(_QWORD *)(*((_QWORD *)this + 2) + 920LL)
                                                                                        + 48LL))(
