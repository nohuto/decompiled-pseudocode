/*
 * XREFs of ?NotifyTokenCompleted@CCompositionSurface@@IEAAJAEBVCFlipToken@@@Z @ 0x1C00123A4
 * Callers:
...
LABEL_10:
        ...
        *v9 = *v8;
        ...
        v9[3] = v21;
        *((_DWORD *)v9 + 16) = v22;
        return (*(__int64 (__fastcall **)(_QWORD, struct CCompositionBuffer *, unsigned __int64, _BYTE *))(**((_QWORD **)this + 13) + 32LL))(
                 *((_QWORD *)this + 13),
                 v19,
                 v17,
                 v25);
...
LABEL_9:
      ...
      LOBYTE(v6) = 1;
      result = (*(__int64 (__fastcall **)(_QWORD, __int64))(**((_QWORD **)this + 13) + 24LL))(
                 *((_QWORD *)this + 13),
                 v6);
      if ( result >= 0 )
      {
