/*
 * XREFs of ?RegQueryControllerInstallKey@DisjointExperienceConfig@DefaultMultiScreenConfig@@YAJPEAGKPEAK@Z @ 0x1C0034FFC
 * Callers:
 ...
 *     KappxParsePackageFullNameFromToken @ 0x1C01ECDE0 (KappxParsePackageFullNameFromToken.c)
 */
        ...
        unsigned int *a4)
{
  ...
  unsigned __int16 v37[264]; // [rsp+100h] [rbp+0h] BYREF
