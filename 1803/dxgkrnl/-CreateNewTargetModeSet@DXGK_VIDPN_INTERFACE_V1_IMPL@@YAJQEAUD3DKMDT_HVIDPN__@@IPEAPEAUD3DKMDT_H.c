/*
 * XREFs of ?CreateNewTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGK_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C00D7710
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  struct DMMVIDPNTARGETMODESET *v33; // [rsp+70h] [rbp+40h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 7050);
  ...
  if ( a3 && a4 )
  {
    ...
    *a4 = 0LL;
    ...
    if ( v14 )
    {
      ...
      v16 = (DMMVIDPNTARGET *)IndexedSet<DMMVIDPNTARGET>::FindById(*(_QWORD *)(v14 + 312), v6);
      v18 = v16;
      if ( v16 )
      {
        v32 = 0LL;
        v33 = 0LL;
        v19 = DMMVIDPNTARGET::CreateNewCofuncModeSet(v16, &v33);
        v7 = v19;
        if ( v19 < 0 )
        {
