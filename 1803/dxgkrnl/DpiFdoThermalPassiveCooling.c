/*
 * XREFs of DpiFdoThermalPassiveCooling @ 0x1C0202B70
 * Callers:
...
void __fastcall DpiFdoThermalPassiveCooling(__int64 a1, unsigned int a2)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    else
    {
      ...
      (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(v2 + 4728) + 56LL))(
        *(_QWORD *)(*(_QWORD *)(v2 + 4728) + 16LL),
        a2);
      DpiReleaseCoreSyncAccessSafe(a1, 0);
    }
    *(_DWORD *)(*(_QWORD *)(v2 + 4728) + 4LL) = a2;
    if ( *(_BYTE *)(v2 + 483) )
