/*
 * XREFs of ?WriteVirtualFunctionConfigBlock@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_WRITEVIRTUALFUNCTIONCONFIGBLOCK@@@Z @ 0x1C01745E8
 * Callers:
 *     DxgkDdiWriteVirtualFunctionConfigBlock @ 0x1C017534C (DxgkDdiWriteVirtualFunctionConfigBlock.c)
 * Callees:
...
__int64 __fastcall ADAPTER_RENDER::WriteVirtualFunctionConfigBlock(__int64 a1, int a2, __int64 a3)
{
  __int64 v6; // rdx
  ...
  if ( v7 && (VirtualGpuByIndex = DXGVIRTUALGPUMANAGER::GetVirtualGpuByIndex(v7, *(_DWORD *)(a3 + 8))) != 0LL )
  {
    v9 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, __int64))(*(_QWORD *)VirtualGpuByIndex + 64LL))(
           VirtualGpuByIndex,
           a3);
  }
  else
  {
    ...
    *(_QWORD *)(v10 + 24) = *(unsigned int *)(a3 + 8);
