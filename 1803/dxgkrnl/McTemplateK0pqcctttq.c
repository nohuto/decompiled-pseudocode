/*
 * XREFs of McTemplateK0pqcctttq @ 0x1C0028344
 * Callers:
...
NTSTATUS McTemplateK0pqcctttq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventInvalidateModeCache, a3, 9u, &v4);
}
