/*
 * XREFs of ?GetMonitorDescriptorSet@DXGK_MONITOR_INTERFACE_V1_IMPL@@KAJQEAXIPEAPEAUD3DKMDT_HMONITORDESCRIPTORSET__@@PEAPEBU_DXGK_MONITORDESCRIPTORSET_INTERFACE@@@Z @ 0x1C0230BB0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGK_MONITORDESCRIPTORSET_INTERFACE **a4)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v32, 7055);
  ...
  if ( *((_QWORD *)v17 + 307) )
  {
    ...
    else if ( MonitorHandle >= 0 )
    {
      ...
      *a4 = &DXGK_MONITORDESCRIPTORSET_INTERFACE_V1_IMPL::DxgMonitorDescriptorSetInterfaceV1;
      MonitorReleaseMonitorHandle(v17, v7, DXGK_MONITOR_INTERFACE_V1_IMPL::GetMonitorDescriptorSet, v25);
      LODWORD(v7) = 0;
    }
    else
    {
