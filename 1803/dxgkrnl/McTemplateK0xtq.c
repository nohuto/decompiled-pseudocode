/*
 * XREFs of McTemplateK0xtq @ 0x1C0041580
 * Callers:
...
NTSTATUS McTemplateK0xtq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v7, va1);
  va_copy(v9, va2);
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventIndirectDisableRenderD3, a3, 4u, &v4);
}
