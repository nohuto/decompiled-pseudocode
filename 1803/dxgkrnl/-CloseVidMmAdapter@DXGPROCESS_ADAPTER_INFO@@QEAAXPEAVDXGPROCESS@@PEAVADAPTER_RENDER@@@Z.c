/*
 * XREFs of ?CloseVidMmAdapter@DXGPROCESS_ADAPTER_INFO@@QEAAXPEAVDXGPROCESS@@PEAVADAPTER_RENDER@@@Z @ 0x1C00A0590
 * Callers:
        ...
        struct ADAPTER_RENDER *a3)
{
  if ( *((_BYTE *)this + 72) )
  {
    (*(void (__fastcall **)(_QWORD, struct DXGPROCESS *))(*(_QWORD *)(*((_QWORD *)a3 + 68) + 8LL) + 1192LL))(
      *((_QWORD *)a3 + 69),
      a2);
    *((_BYTE *)this + 72) = 0;
  }
