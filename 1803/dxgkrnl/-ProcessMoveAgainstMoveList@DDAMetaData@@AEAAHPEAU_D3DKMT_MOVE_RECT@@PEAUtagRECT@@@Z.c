/*
 * XREFs of ?ProcessMoveAgainstMoveList@DDAMetaData@@AEAAHPEAU_D3DKMT_MOVE_RECT@@PEAUtagRECT@@@Z @ 0x1C01D2A50
 * Callers:
 ...
 *     ?RectsOverlap@@YA?AW4RECT_OVERLAP@@PEAUtagRECT@@00@Z @ 0x1C01D38D8 (-RectsOverlap@@YA-AW4RECT_OVERLAP@@PEAUtagRECT@@00@Z.c)
 */
        ...
        struct tagRECT *a3)
{
  ...
  __int64 v22; // rax
  __int64 v23; // rcx
  struct _D3DKMT_PRESENT_RGNS v24; // [rsp+20h] [rbp-48h] BYREF
  ...
  if ( *((_DWORD *)this + 11) )
  {
    ...
    while ( 1 )
    {
      ...
      v24.DirtyRectCount = *(_DWORD *)v6;
      LODWORD(v24.pDirtyRects) = v9;
      v10 = v8 + *(_DWORD *)(v6 + 20) - *(_DWORD *)(v6 + 12);
      *(&v24.DirtyRectCount + 1) = v8;
      HIDWORD(v24.pDirtyRects) = v10;
