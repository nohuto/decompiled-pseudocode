/*
 * XREFs of ?CreateSharedResourceNtObject@@YAJDW4_HMGRENTRY_TYPE@@IPEAXPEAU_OBJECT_ATTRIBUTES@@DPEAPEAX@Z @ 0x1C00D58A8
 * Callers:
 ...
 * Callees:
 *     ?AddNtSharedAllocObject@ADAPTER_RENDER@@QEAAXPEAU_LIST_ENTRY@@@Z @ 0x1C0002468 (-AddNtSharedAllocObject@ADAPTER_RENDER@@QEAAXPEAU_LIST_ENTRY@@@Z.c)
        ...
        _QWORD *a7)
{
  ...
  struct DXGRESOURCE *v46; // [rsp+60h] [rbp-20h] BYREF
  ...
  if ( !a4 )
  {
    ...
    if ( (unsigned int)v14 < *((_DWORD *)v13 + 62)
      ...
      && (v16 & 0x1F) == 4 )
    {
      v17 = (struct DXGRESOURCE *)*((_QWORD *)v15 + 2 * (unsigned int)v14);
    }
    else
    {
      v17 = 0LL;
    ...
    DXGRESOURCEREFERENCE::MoveAssign(&v44, &v46);
...
LABEL_16:
  ...
  else
  {
    ...
    for ( i = *(_QWORD **)(a4 + 128); i != (_QWORD *)(a4 + 128); i = (_QWORD *)*i )
    {
      if ( (*((_DWORD *)i - 11) & 0x4000) != 0 )
        (*(void (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a4 + 72) + 544LL) + 8LL) + 1144LL))(
          *(i - 5),
          1LL);
    }
