/*
 * XREFs of OutputDuplPresent @ 0x1C01CD6F8
 * Callers:
...
LABEL_36:
    ...
    if ( !v37 )
      DXGADAPTER_REFERENCE::Assign(&v37, *(struct DXGADAPTER **)(*((_QWORD *)v47 + 2) + 1688LL));
