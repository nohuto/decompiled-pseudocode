/*
 * XREFs of ?DdiCloseAllocation@ADAPTER_RENDER@@QEAAJPEAXPEBU_DXGKARG_CLOSEALLOCATION@@@Z @ 0x1C00A3570
 * Callers:
        ...
        const struct _DXGKARG_CLOSEALLOCATION *a3)
{
  ...
  __int64 v27; // rcx
  __int64 v28; // r8
  int v30; // [rsp+20h] [rbp-A8h] BYREF
  __int64 v31; // [rsp+28h] [rbp-A0h]
  _BYTE v32[24]; // [rsp+30h] [rbp-98h] BYREF
  _BYTE v33[8]; // [rsp+48h] [rbp-80h] BYREF
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5029);
...
LABEL_15:
  ...
  v16 = (*(int (__fastcall **)(void *, const struct _DXGKARG_CLOSEALLOCATION *))(*((_QWORD *)this + 2) + 592LL))(a2, a3);
  if ( v33[0] )
  ...
  v24[3] = v16;
  v24[4] = a2;
  v24[5] = a3->NumAllocations;
  pOpenHandleList = a3->pOpenHandleList;
  v24[6] = *pOpenHandleList;
  if ( (_DWORD)v16 )
  {
    v26 = WdLogNewEntry5_WdError(pOpenHandleList);
    *(_QWORD *)(v26 + 24) = v16;
