/*
 * XREFs of ?FinalizeTopologyOnAdapter@CCD_TOPOLOGY@@AEAAJPEAVDXGPROCESS@@K@Z @ 0x1C00B534C
 * Callers:
        ...
        unsigned int a3)
{
  ...
  while ( 1 )
  {
    if ( v3 )
    {
      DxgkDestroyCddDeviceAndContextForCurrentSession(
        (struct _LUID *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 316 * v6),
        (struct DXGDEVICE *)v3);
    ...
    if ( CddDeviceAndContextForCurrentSession < 0 )
    {
      ...
      v29[3] = *(int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 316 * v6 + 4);
      v29[4] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 316 * v6);
      v29[5] = v9;
    ...
    v32 = v37;
    v10 = (ADAPTER_DISPLAY **)*((_QWORD *)v37 + 211);
    if ( !v10 )
      break;
    ...
    v12 = (int)COREDEVICEACCESS::AcquireExclusive((__int64)v34);
    if ( !DXGDEVICE::IsExecutionStateErrorState((DXGDEVICE *)v3) )
    {
      if ( (int)v12 < 0 )
      {
        v24 = (_QWORD *)WdLogNewEntry5_WdError(v13);
        v24[3] = *(int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 316 * v6 + 4);
        v24[4] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 316 * v6);
        v24[5] = *((_QWORD *)this + 8);
        v24[6] = v12;
        ...
        if ( *((_DWORD *)v14 + 20) )
        {
          ...
          do
          {
            ...
            if ( ((1 << v15) & *(_DWORD *)(v17 + v20 + 80)) != 0 )
            {
              v39 = 79 * v6;
              v19 = v14;
              v23 = *(_DWORD *)(272LL * *(unsigned int *)(v20 + 4 * (v15 + 79 * v6) + 8) + v18 + 240);
              if ( v23 < 0 )
              {
                v16 = 0;
                *(_DWORD *)(v20 + 4 * (v15 + v39) + 156) = v23;
                *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + v17 + 152) |= 1 << v15;
                v25 = ADAPTER_DISPLAY::PurgeCopyProtectionOnVidPnSource(v10[307], v15);
                v12 = v25;
                if ( v25 < 0 )
                {
                  ...
                  v27[5] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 316 * v6);
                  v27[6] = v12;
  ...
  v28[3] = v3;
  v28[4] = *(int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 316 * v6 + 4);
  v28[5] = *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + 8) + 40LL) + 316 * v6);
  v28[6] = -1073741811LL;
