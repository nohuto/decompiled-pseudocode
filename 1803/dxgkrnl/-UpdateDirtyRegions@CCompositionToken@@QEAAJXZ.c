/*
 * XREFs of ?UpdateDirtyRegions@CCompositionToken@@QEAAJXZ @ 0x1C000E0E8
 * Callers:
...
__int64 __fastcall CCompositionToken::UpdateDirtyRegions(CCompositionToken *this)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 20); ++i )
  {
    ...
    {
      v7 = v4[2];
      updated = CPushLock::AcquireLockExclusive((CPushLock *)(v6 + 40));
      if ( updated >= 0 )
      {
        updated = CCompositionSurface::UpdateBufferDirtyRegion(v6 + 24, v7, v5);
