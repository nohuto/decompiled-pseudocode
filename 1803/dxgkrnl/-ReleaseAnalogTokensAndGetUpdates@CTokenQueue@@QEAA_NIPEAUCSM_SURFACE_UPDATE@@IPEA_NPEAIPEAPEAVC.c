/*
 * XREFs of ?ReleaseAnalogTokensAndGetUpdates@CTokenQueue@@QEAA_NIPEAUCSM_SURFACE_UPDATE@@IPEA_NPEAIPEAPEAVCToken@@@Z @ 0x1C004AD34
 * Callers:
        ...
        struct CToken **a7)
{
  ...
  *a6 = 0;
  ...
  v29[0] = v29;
  *v8 = 0;
  if ( *(CTokenQueue **)v12 != this || (v13 = (CTokenQueue **)*((_QWORD *)v12 + 1), *v13 != v12) )
    __fastfail(3u);
  *((_QWORD *)this + 1) = v13;
  *v13 = this;
  if ( v12 == this )
  ...
  while ( 1 )
  {
    ...
    if ( (*(int (__fastcall **)(_QWORD *, __int64, bool **))(*((_QWORD *)v12 - 1) + 168LL))((_QWORD *)v12 - 1, a2, &a5) < 0 )
    {
LABEL_10:
...
LABEL_11:
    v12 = (CTokenQueue *)*((_QWORD *)this + 1);
    if ( *(CTokenQueue **)v12 != this || (v16 = (CTokenQueue **)*((_QWORD *)v12 + 1), *v16 != v12) )
      __fastfail(3u);
    *((_QWORD *)this + 1) = v16;
    *v16 = this;
    if ( v12 == this )
...
LABEL_21:
  if ( v7 )
  {
    ...
    v19 = 0;
    v20 = *(_QWORD *)v29[0];
    if ( *(_QWORD **)(v29[0] + 8LL) != v29 || *(_QWORD *)(v20 + 8) != v29[0] )
      __fastfail(3u);
    v29[0] = *(_QWORD *)v29[0];
    *(_QWORD *)(v20 + 8) = v29;
    if ( v18 != v29 )
      ...
      do
      {
        ...
        else
        {
          *((_DWORD *)a3 + 7) = (*(__int64 (__fastcall **)(const struct CToken *))(*(_QWORD *)v22 + 112LL))(v22);
          ...
          (*(void (__fastcall **)(CompositionSurfaceObject *, _QWORD))(*((_QWORD *)Global + 219) + 56LL))(v23, v24);
          *v21 = v22;
        }
        v18 = (_QWORD *)v29[0];
        if ( *(_QWORD **)(v29[0] + 8LL) != v29
          || (v27 = *(_QWORD *)v29[0], *(_QWORD *)(*(_QWORD *)v29[0] + 8LL) != v29[0]) )
        {
          __fastfail(3u);
        }
        v29[0] = *(_QWORD *)v29[0];
