/*
 * XREFs of ?CreateKeyedMutex@DXGGLOBAL@@QEAAJ_KPEAPEAVDXGKEYEDMUTEX@@PEAIPEAXIU_D3DKMT_CREATEKEYEDMUTEX2_FLAGS@@@Z @ 0x1C01C0140
 * Callers:
        ...
        struct _D3DKMT_CREATEKEYEDMUTEX2_FLAGS a7)
{
  ...
  if ( !a3 )
  {
    ...
    *(_QWORD *)(v11 + 24) = 4048LL;
    WdLogEvent5_WdAssertion(v11);
  }
  if ( !a4 )
  {
    v12 = WdLogNewEntry5_WdAssertion(this);
    *(_QWORD *)(v12 + 24) = 4049LL;
