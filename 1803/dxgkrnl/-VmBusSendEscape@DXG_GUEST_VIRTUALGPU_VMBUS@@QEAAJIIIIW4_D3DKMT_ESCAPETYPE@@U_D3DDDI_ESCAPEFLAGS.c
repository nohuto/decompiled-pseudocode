/*
 * XREFs of ?VmBusSendEscape@DXG_GUEST_VIRTUALGPU_VMBUS@@QEAAJIIIIW4_D3DKMT_ESCAPETYPE@@U_D3DDDI_ESCAPEFLAGS@@IPEAE@Z @ 0x1C0182CFC
 * Callers:
        ...
        unsigned __int8 *Src)
{
  ...
  *(_QWORD *)&v17->0 = 0LL;
  ...
  if ( (_DWORD)v9 )
  {
    v25 = VmBusSendSyncMessage(v22, (struct DXGKVMB_COMMAND_BASE *)v19, v16, &v19[12], (unsigned int *)&Size, v28);
    if ( v25 < 0 )
    {
LABEL_14:
  ...
  {
    v25 = VmBusSendSyncMessage(v22, (struct DXGKVMB_COMMAND_BASE *)v19, v16, 0LL, 0LL, v28);
  }
  if ( v25 < 0 )
    goto LABEL_14;
LABEL_15:
