/*
 * XREFs of ?_GetMonitorInformationForTargets@MONITOR_MGR@@QEAAJP6AJPEAX0IW4_DMM_VIDPN_MONITOR_TYPE@@EE@Z0I@Z @ 0x1C00BA928
 * Callers:
 ...
 *     ?_DRTGetTargetInformation@MONITOR_MGR@@QEAAJPEAU_D3DKMT_DRT_MONITOR@@@Z @ 0x1C022AD90 (-_DRTGetTargetInformation@MONITOR_MGR@@QEAAJPEAU_D3DKMT_DRT_MONITOR@@@Z.c)
 * Callees:
        ...
        int a4)
{
  ...
  do
  {
    LODWORD(v8) = DmmGetNextVideoPresentTarget(*(void *const *)(*((_QWORD *)this + 1) + 16LL), v7, &v24);
    if ( (int)v8 < 0 )
      break;
    v9 = *((_QWORD *)this + 1);
    v10 = 0;
    LOBYTE(v26) = 0;
    v11 = 0;
    IsTargetForcable = DmmIsTargetForcable(*(DXGADAPTER **)(v9 + 16), v24, (bool *)&v26, 0);
    ...
    v25 = 0LL;
    MonitorInstance = MONITOR_MGR::_GetMonitorInstance((struct _FAST_MUTEX *)this, v24, 0, &v25);
    ...
    v10 = *((_DWORD *)v8 + 108);
    MonitorInstance = MONITOR_MGR::_GetMonitorInstance((struct _FAST_MUTEX *)this, v24, 1, &v25);
    LODWORD(v8) = MonitorInstance;
    if ( MonitorInstance < 0 )
    {
LABEL_7:
