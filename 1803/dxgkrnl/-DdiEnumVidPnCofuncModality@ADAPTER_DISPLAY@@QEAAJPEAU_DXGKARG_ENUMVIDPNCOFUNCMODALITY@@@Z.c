/*
 * XREFs of ?DdiEnumVidPnCofuncModality@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_ENUMVIDPNCOFUNCMODALITY@@@Z @ 0x1C00E08DC
 * Callers:
        ...
        struct _DXGKARG_ENUMVIDPNCOFUNCMODALITY *a2)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 5026);
...
LABEL_15:
  ...
  v16 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_ENUMVIDPNCOFUNCMODALITY *))(*((_QWORD *)this + 2) + 488LL))(
