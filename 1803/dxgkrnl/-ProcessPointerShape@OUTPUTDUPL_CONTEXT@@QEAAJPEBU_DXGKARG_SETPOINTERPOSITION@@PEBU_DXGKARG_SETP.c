/*
 * XREFs of ?ProcessPointerShape@OUTPUTDUPL_CONTEXT@@QEAAJPEBU_DXGKARG_SETPOINTERPOSITION@@PEBU_DXGKARG_SETPOINTERSHAPE@@@Z @ 0x1C01D2E40
 * Callers:
        ...
        __int64 a4)
{
  ...
  const struct _DXGKARG_SETPOINTERSHAPE *v14; // [rsp+38h] [rbp-20h]
