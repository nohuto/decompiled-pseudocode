/*
 * XREFs of ?OpenEdidRegistryForTarget@EDIDCACHE@@AEAAJIKAEAPEAXPEAK@Z @ 0x1C01A8E44
 * Callers:
 ...
 *     ?RtlUnicodeStringPrintf@@YAJPEAU_UNICODE_STRING@@PEBGZZ @ 0x1C0033294 (-RtlUnicodeStringPrintf@@YAJPEAU_UNICODE_STRING@@PEBGZZ.c)
        ...
        unsigned int *a5)
{
  ...
  *(_DWORD *)&v21.Length = 10879140;
  v23[2] = v9;
  *(_DWORD *)&v20.Length = 1179648;
