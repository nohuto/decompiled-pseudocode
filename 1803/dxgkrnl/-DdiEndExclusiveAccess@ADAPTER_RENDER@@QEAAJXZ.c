/*
 * XREFs of ?DdiEndExclusiveAccess@ADAPTER_RENDER@@QEAAJXZ @ 0x1C015F480
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiEndExclusiveAccess(ADAPTER_RENDER *this, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v25, 5131);
  v4 = *((_QWORD *)this + 2);
  LODWORD(v5) = 0;
  if ( *(_QWORD *)(v4 + 1216) )
  {
...
LABEL_16:
    ...
    v14 = *((_QWORD *)this + 2);
    v24 = 0;
    v5 = (*(int (__fastcall **)(_QWORD, int *))(v14 + 1216))(*(_QWORD *)(v14 + 240), &v24);
    if ( v27[0] )
