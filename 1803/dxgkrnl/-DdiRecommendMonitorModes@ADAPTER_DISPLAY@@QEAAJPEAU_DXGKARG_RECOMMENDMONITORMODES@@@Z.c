/*
 * XREFs of ?DdiRecommendMonitorModes@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_RECOMMENDMONITORMODES@@@Z @ 0x1C0161128
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v28, 5037);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_RECOMMENDMONITORMODES *))(*((_QWORD *)this + 2) + 528LL))(
  ...
  v22[6] = a2->hMonitorSourceModeSet;
  pMonitorSourceModeSetInterface = a2->pMonitorSourceModeSetInterface;
  v22[7] = pMonitorSourceModeSetInterface;
  if ( (_DWORD)v14 != -1073741801 && (_DWORD)v14 )
  {
    v24 = WdLogNewEntry5_WdError(pMonitorSourceModeSetInterface);
    *(_QWORD *)(v24 + 24) = v14;
