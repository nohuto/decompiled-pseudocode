/*
 * XREFs of ?SendEnqueueFlipExToken@DXGCOMPOSITIONSURFACEPROXY@@QEAAJPEAU_D3DKMT_FLIPMODEL_REMOTEPRESENTHISTORYTOKEN@@@Z @ 0x1C01BEB34
 * Callers:
...
__int64 __fastcall DXGCOMPOSITIONSURFACEPROXY::SendEnqueueFlipExToken(
...
LABEL_15:
    ...
    {
      v17 = DXGSESSIONDATA::VailSendEnqueueFlipExToken(SessionDataForSpecifiedSession, a2);
      v3 = v17;
      if ( v17 < 0 )
        goto LABEL_15;
    }
