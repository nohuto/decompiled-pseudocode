/*
 * XREFs of ?DdiCheckMultiPlaneOverlaySupport@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT@@@Z @ 0x1C015D4C8
 * Callers:
 *     ?ADAPTER_DISPLAY_DdiCheckMultiPlaneOverlaySupport@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT@@@Z @ 0x1C002E090 (-ADAPTER_DISPLAY_DdiCheckMultiPlaneOverlaySupport@@YAJPEAVADAPTER_DISPLAY@@PEAU_DXGKARG_CHECKMUL.c)
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v26, 5055);
...
LABEL_15:
  ...
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CHECKMULTIPLANEOVERLAYSUPPORT *))(*((_QWORD *)this + 2) + 776LL))(
  ...
  v20 = (_QWORD *)WdLogNewEntry5_WdEvent(v15, v13);
  v20[3] = v14;
  v20[4] = a2->PlaneCount;
  v20[5] = a2->Supported;
