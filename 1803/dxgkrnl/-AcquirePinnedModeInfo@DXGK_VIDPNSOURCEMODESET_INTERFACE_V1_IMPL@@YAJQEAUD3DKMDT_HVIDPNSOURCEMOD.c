/*
 * XREFs of ?AcquirePinnedModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C00BE340
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE **a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 7003);
  ...
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v14 )
    {
      ...
      v15 = DMMVIDPNSOURCEMODESET::AcquireDdiEnumeratorCachedModeInfo<KM_STL::mem_fun_t<DMMVIDPNSOURCEMODE *,DMMVIDPNSOURCEMODESET>>(
              v14,
              (__int64)&v33,
              &v35);
      v4 = v15;
