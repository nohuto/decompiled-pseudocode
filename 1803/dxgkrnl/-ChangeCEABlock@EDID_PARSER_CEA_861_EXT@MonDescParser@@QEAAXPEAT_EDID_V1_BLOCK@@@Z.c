/*
 * XREFs of ?ChangeCEABlock@EDID_PARSER_CEA_861_EXT@MonDescParser@@QEAAXPEAT_EDID_V1_BLOCK@@@Z @ 0x1C0048428
 * Callers:
 ...
 *     ?EDID_V1_CeaExt_IsAudioSupported@@YAEPEBE@Z @ 0x1C004776C (-EDID_V1_CeaExt_IsAudioSupported@@YAEPEBE@Z.c)
        ...
        union _EDID_V1_BLOCK *a2)
{
  ...
  *(_QWORD *)this = a2;
  v3 = *((_BYTE *)a2 + 2);
  for ( i = 4; (!v3 || i < v3) && i < 0x80; i += (*((_BYTE *)a2 + i) & 0x1F) + 1 )
    ++v2;
  *((_DWORD *)this + 2) = v2;
}
