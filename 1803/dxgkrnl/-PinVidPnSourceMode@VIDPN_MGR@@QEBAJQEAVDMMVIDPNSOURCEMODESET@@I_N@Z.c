/*
 * XREFs of ?PinVidPnSourceMode@VIDPN_MGR@@QEBAJQEAVDMMVIDPNSOURCEMODESET@@I_N@Z @ 0x1C00B9854
 * Callers:
        ...
        char a4)
{
  ...
  else
  {
    ...
    LOBYTE(v15) = a4;
    v43 = -1;
    v16 = VIDPN_MGR::FormalizeVidPnChange(this, Container & -(__int64)(Container != -88), 3LL, v15, &v42);
    v20 = v16;
    if ( v16 < 0 )
    {
      if ( v16 == -1071774970 )
