/*
 * XREFs of ?SignalVSyncEvent@BLTQUEUE@@AEAAXXZ @ 0x1C01D6D9C
 * Callers:
  ...
  *((_QWORD *)this + 36) = PerformanceFrequency.QuadPart * v4 * (unsigned int)v5 / v3;
  if ( !v8 )
  {
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0qqqq((unsigned int)v5, &EventDWMVsyncSignal, v4, *((_DWORD *)this + 58), v5, 0, 0);
    if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0qiii(v6, v7, v4, 0, *((_QWORD *)this + 35), *((_QWORD *)this + 34), *((_QWORD *)this + 36));
  }
  if ( *((_DWORD *)this + 59) )
...
LABEL_14:
    if ( (*((_DWORD *)this + 212) & 2) != 0 )
      KeSetTimerEx((PKTIMER)((char *)this + 472), (LARGE_INTEGER)(-10000000LL * (unsigned int)dword_1C007BD34), 0, 0LL);
  }
  v8 = bTracingEnabled == 0;
  *((_DWORD *)this + 59) = 0;
  if ( !v8 )
