/*
 * XREFs of ?DdiControlDiagnosticReporting@DXGADAPTER@@QEAAJPEAU_DXGKARG_CONTROLDIAGNOSTICREPORTING@@@Z @ 0x1C015DAC4
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v31, 5129);
...
LABEL_15:
  ...
  v17 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_CONTROLDIAGNOSTICREPORTING *))this + 154))(
          *((_QWORD *)this + 30),
          a2);
  if ( v34[0] )
