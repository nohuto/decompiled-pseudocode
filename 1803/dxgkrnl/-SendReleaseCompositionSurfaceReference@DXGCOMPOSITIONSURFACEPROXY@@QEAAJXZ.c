/*
 * XREFs of ?SendReleaseCompositionSurfaceReference@DXGCOMPOSITIONSURFACEPROXY@@QEAAJXZ @ 0x1C01BEE74
 * Callers:
...
__int64 __fastcall DXGCOMPOSITIONSURFACEPROXY::SendReleaseCompositionSurfaceReference(void **this, __int64 a2)
{
  __int64 v3; // rdi
  __int64 v4; // rcx
...
LABEL_15:
    ...
    {
      v17 = DXGSESSIONDATA::VailSendReleaseCompositionSurfaceReference(SessionDataForSpecifiedSession, this[2]);
      v3 = v17;
      if ( v17 < 0 )
        goto LABEL_15;
    }
