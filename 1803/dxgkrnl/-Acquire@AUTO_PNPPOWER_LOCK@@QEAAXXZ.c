/*
 * XREFs of ?Acquire@AUTO_PNPPOWER_LOCK@@QEAAXXZ @ 0x1C000B790
 * Callers:
    ...
    if ( !*((_BYTE *)this + 8) )
    {
      if ( v2 )
      {
        ...
        if ( !*(_BYTE *)(*(_QWORD *)this + 483LL) )
          goto LABEL_7;
        _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v3 + 24) + 64LL) + 3912LL));
      }
      else
      {
        KeEnterCriticalRegion();
...
LABEL_8:
    ...
    if ( v2 )
    {
      ...
      if ( *(_BYTE *)(*(_QWORD *)this + 483LL) )
      {
        _InterlockedIncrement((volatile signed __int32 *)(*(_QWORD *)(*(_QWORD *)(v4 + 24) + 64LL) + 3912LL));
LABEL_15:
        v4 = *(_QWORD *)this;
      }
    }
