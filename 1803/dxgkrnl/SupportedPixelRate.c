/*
 * XREFs of SupportedPixelRate @ 0x1C023C430
 * Callers:
...
char __fastcall SupportedPixelRate(__int64 a1, __int64 a2, int a3)
{
  ...
  else
  {
    ...
    v13 = v12 * v9;
    v14 = HIDWORD(v12);
    if ( (int)(v13 / HIDWORD(v12) - *(_DWORD *)(a2 + 20) / *(_DWORD *)(a2 + 24)) < 0 )
    {
      LODWORD(v14) = HIDWORD(v12);
      if ( v10 - 60 < 0 )
        return 0;
    }
    if ( (int)(v13 / (unsigned int)v14 - *(_DWORD *)(a2 + 28) / *(_DWORD *)(a2 + 32)) > 0 && v11 > 0 )
      return 0;
  }
  return 1;
}
