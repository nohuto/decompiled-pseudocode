/*
 * XREFs of McTemplateK0ppqpttq @ 0x1C002F9E0
 * Callers:
 *     TraceDxgkDevice @ 0x1C002FF40 (TraceDxgkDevice.c)
...
NTSTATUS McTemplateK0ppqpttq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 8u, &v4);
}
