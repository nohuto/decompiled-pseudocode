/*
 * XREFs of ?PinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C00C2BA0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a5)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v41, 6028);
        ...
        else
        {
          ...
          if ( v21 < 0 )
          {
            ...
            if ( v17 == D3DKMDT_VPPR_UNPINNED )
              v37 = DMMVIDPNPRESENTPATH::UnpinContentRotation(v16, v33, v34, v35);
            else
              v37 = DMMVIDPNPRESENTPATH::PinContentRotation(v16, v17);
            if ( v37 < 0 )
            {
