/*
 * XREFs of McTemplateK0pqqqqq @ 0x1C002C450
 * Callers:
...
NTSTATUS McTemplateK0pqqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventCddStandardAllocationShadowSurface, a3, 7u, &v4);
}
