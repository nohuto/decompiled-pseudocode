/*
 * XREFs of ?ReleaseSharedVidPnSourceOwner@ADAPTER_DISPLAY@@AEAAEPEAVDXGDEVICE@@I@Z @ 0x1C01565C4
 * Callers:
        ...
        unsigned int a3)
{
  ...
  *(_QWORD *)(v15 + 32) = v4;
  ...
  if ( *((_QWORD *)a2 + 211) == *(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL) && DXGDEVICE::IsVidPnSourcePrimaryValid(a2, v4) )
  {
