/*
 * XREFs of ?RegisterTtmDevice@CTTMDEVICE@@AEAAJPEAVDXGSESSIONDATA@@@Z @ 0x1C01D009C
 * Callers:
...
__int64 __fastcall CTTMDEVICE::RegisterTtmDevice(CTTMDEVICE *this, struct DXGSESSIONDATA *a2)
{
  ...
  if ( *(struct _KTHREAD **)(*((_QWORD *)DXGGLOBAL::GetGlobal(v4) + 74) + 160LL) != KeGetCurrentThread() )
  {
  ...
  *((_QWORD *)this + 112) = 0LL;
  ...
  else
  {
    ...
    *((_DWORD *)this + 2 * (unsigned int)(v12 % 32) + 158) = MEMORY[0xFFFFF78000000008] / 0x2710uLL;
    ...
    if ( v15 >= 0 )
    {
      v18 = (struct DXGSESSIONDATA **)*((_QWORD *)a2 + 2323);
      v19 = (CTTMDEVICE *)((char *)this + 16);
      if ( *v18 != (struct DXGSESSIONDATA *)((char *)a2 + 18576) )
        __fastfail(3u);
      *(_QWORD *)v19 = (char *)a2 + 18576;
      *((_QWORD *)this + 3) = v18;
      *v18 = v19;
      *((_QWORD *)a2 + 2323) = v19;
      *((_QWORD *)this + 4) = a2;
