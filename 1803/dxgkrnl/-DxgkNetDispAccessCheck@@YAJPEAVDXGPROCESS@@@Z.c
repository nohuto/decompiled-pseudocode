/*
 * XREFs of ?DxgkNetDispAccessCheck@@YAJPEAVDXGPROCESS@@@Z @ 0x1C002B6F4
 * Callers:
...
__int64 __fastcall DxgkNetDispAccessCheck(struct DXGPROCESS *a1)
{
  ...
  Acl = 0;
  if ( !a1
    || (!g_OSTestSigningEnabled || (unsigned int)PsGetCurrentProcessSessionId(a1))
    && (*(unsigned int (__fastcall **)(_QWORD))(*((_QWORD *)a1 + 13) + 224LL))(0LL) )
  {
    v3 = 0LL;
