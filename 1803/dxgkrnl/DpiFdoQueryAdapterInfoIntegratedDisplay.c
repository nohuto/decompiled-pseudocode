/*
 * XREFs of DpiFdoQueryAdapterInfoIntegratedDisplay @ 0x1C01F8334
 * Callers:
...
LABEL_3:
  ...
  *(_WORD *)(a2 + 94) = v10;
  ...
  if ( v11 != v3 )
  {
    ...
    *(_QWORD *)(v12 + 24) = *(unsigned __int16 *)(a2 + 92) - v11;
...
LABEL_11:
    ...
    else
    {
      ...
      *(_DWORD *)(*(_QWORD *)(a2 + 96) + 64LL) = v16[16];
      v26 = *(_QWORD *)(a2 + 96);
      ...
      *(_DWORD *)(v26 + 116) = v16[29];
      do
      {
        *(_BYTE *)(*(_QWORD *)(a2 + 96) + v15 + 120) = *((_BYTE *)v16 + v15 + 120);
        ++v15;
      }
      while ( v15 < 4 );
      memmove(*(void **)(a2 + 104), v16 + 31, *(unsigned __int16 *)(a2 + 94));
    }
