/*
 * XREFs of ?CreatePagingQueue@DXGDEVICE@@QEAAJIW4D3DDDI_PAGINGQUEUE_PRIORITY@@PEAPEAVDXGPAGINGQUEUE@@@Z @ 0x1C00F2914
 * Callers:
        ...
        struct DXGPAGINGQUEUE **a4)
{
  ...
  if ( !*((_DWORD *)this + 18) && !ExIsResourceAcquiredExclusiveLite(*((PERESOURCE *)this + 13)) )
  {
    ...
    *(_QWORD *)(v20 + 24) = 7467LL;
    WdLogEvent5_WdAssertion(v20);
  }
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(*(DXGADAPTER **)(*((_QWORD *)this + 2) + 16LL)) )
  {
    v21 = WdLogNewEntry5_WdAssertion(v9);
    *(_QWORD *)(v21 + 24) = 7468LL;
    WdLogEvent5_WdAssertion(v21);
  }
  if ( !a4 )
  {
    v22 = WdLogNewEntry5_WdAssertion(v9);
    *(_QWORD *)(v22 + 24) = 7469LL;
    WdLogEvent5_WdAssertion(v22);
  }
  PoolWithQuotaTag = ExAllocatePoolWithQuotaTag((POOL_TYPE)9, 0x48uLL, 0x4B677844u);
  if ( PoolWithQuotaTag )
  {
    v12 = 0LL;
    ...
    *((_DWORD *)PoolWithQuotaTag + 7) = 0;
    ...
    PoolWithQuotaTag[7] = 1LL;
    *((_BYTE *)PoolWithQuotaTag + 64) = 0;
  }
