/*
 * XREFs of McTemplateK0ptpjq @ 0x1C0041D84
 * Callers:
...
NTSTATUS McTemplateK0ptpjq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 16LL;
  v14 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventOPMGetInformation, a3, 6u, &v4);
}
