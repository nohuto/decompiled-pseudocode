/*
 * XREFs of ?CreateAllocationObjects@DXGDEVICE@@QEAAJIPEAPEAVDXGALLOCATION@@PEAVDXGRESOURCE@@0@Z @ 0x1C00EEF60
 * Callers:
 ...
 *     ??0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z @ 0x1C0145890 (--0DXGALLOCATION@@QEAA@PEAVDXGDEVICE@@@Z.c)
 */
  ...
  *a5 = 0LL;
  ...
  if ( a2 - 1 >= 0 )
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)(v18 + 16) = HMGRTABLE::AllocHandle((unsigned int *)(v19 + 232), v18, 5, 0, 0);
