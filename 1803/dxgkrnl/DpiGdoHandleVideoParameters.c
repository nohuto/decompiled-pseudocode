/*
 * XREFs of DpiGdoHandleVideoParameters @ 0x1C020E7B8
 * Callers:
 *     DpiGdoDispatchIoctl @ 0x1C020E760 (DpiGdoDispatchIoctl.c)
 * Callees:
...
__int64 __fastcall DpiGdoHandleVideoParameters(__int64 a1, __int64 a2)
{
  ...
  else
  {
    v5 = DxgkHandleVideoParameters(
           *(DXGADAPTER ****)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 64) + 32LL) + 64LL) + 3728LL),
