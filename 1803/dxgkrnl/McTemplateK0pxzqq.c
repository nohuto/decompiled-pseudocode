/*
 * XREFs of McTemplateK0pxzqq @ 0x1C003FEB8
 * Callers:
...
NTSTATUS McTemplateK0pxzqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v19 = 4LL;
  va_copy(v18, va3);
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, (__int64)a2, 6u, &v8);
}
