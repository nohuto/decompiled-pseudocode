/*
 * XREFs of ?DmmIsVidPnTargetConnectedToSource@@YAJQEAXIIPEA_N@Z @ 0x1C0214100
 * Callers:
...
LABEL_5:
  ...
  if ( v15 )
  {
    ...
    if ( v23 )
    {
      *a4 = (unsigned int)DMMVIDPNTOPOLOGY::GetPathSourceFromTarget((DMMVIDPNTOPOLOGY *)(v23 + 96), a3) == a2;
    }
    else
    {
      v4 = -1071774884;
