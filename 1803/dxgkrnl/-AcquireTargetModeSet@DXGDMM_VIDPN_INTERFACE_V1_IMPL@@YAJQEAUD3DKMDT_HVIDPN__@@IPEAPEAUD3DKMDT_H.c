/*
 * XREFs of ?AcquireTargetModeSet@DXGDMM_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@IPEAPEAUD3DKMDT_HVIDPNTARGETMODESET__@@PEAPEBU_DXGDMM_VIDPNTARGETMODESET_INTERFACE@@@Z @ 0x1C00C6C30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct D3DKMDT_HVIDPNTARGETMODESET__ **a4)
{
  ...
  struct D3DKMDT_HVIDPNTARGETMODESET__ *v32; // [rsp+60h] [rbp+18h]
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v30, 6036);
  if ( !a3 || !a4 )
  {
  ...
  *a4 = 0LL;
  ...
  if ( !DMMVIDPNTOPOLOGY::IsTargetInTopology((DMMVIDPNTOPOLOGY *)(v10 + 96), v5) )
  {
  ...
  v32 = *(struct D3DKMDT_HVIDPNTARGETMODESET__ **)(v15 + 448);
  v16 = IndexedSet<DMMVIDPNTARGET>::FindById(*(_QWORD *)(v12 + 312), v13);
  v18 = v16;
  if ( !v16 )
  {
