/*
 * XREFs of ?TraceLogDpiInfo@@YAXPEAU_DPI_INFORMATION@@PEBGAEBU_LUID@@II@Z @ 0x1C00C52FC
 * Callers:
        ...
        unsigned int a5)
{
  ...
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)&dword_1C0079090, 0x200000000001uLL) )
    {
      v7 = *((_DWORD *)a1 + 23);
      v9 = *((_DWORD *)a1 + 2);
      v32 = &v9;
      ...
      TlgWrite((TraceLoggingHProvider)&dword_1C0079090, &unk_1C0058B90, 0LL, v8, 0x1Au, &pData);
    }
  }
}
