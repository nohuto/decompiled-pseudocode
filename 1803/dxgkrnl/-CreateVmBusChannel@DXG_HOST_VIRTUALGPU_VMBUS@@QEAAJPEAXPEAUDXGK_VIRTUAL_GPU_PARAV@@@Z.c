/*
 * XREFs of ?CreateVmBusChannel@DXG_HOST_VIRTUALGPU_VMBUS@@QEAAJPEAXPEAUDXGK_VIRTUAL_GPU_PARAV@@@Z @ 0x1C017AC6C
 * Callers:
        ...
        struct DXGK_VIRTUAL_GPU_PARAV *a3)
{
  ...
  __int64 v10; // rdi
  __int64 v11; // rax
  struct _GUID v13; // [rsp+60h] [rbp-49h] BYREF
  struct _UNICODE_STRING v14; // [rsp+70h] [rbp-39h] BYREF
  _DWORD v15[2]; // [rsp+80h] [rbp-29h] BYREF
  __int64 (__fastcall *v16)(struct VMBCHANNEL__ *); // [rsp+88h] [rbp-21h]
  void (__fastcall *v17)(struct VMBCHANNEL__ *); // [rsp+90h] [rbp-19h]
  void (__fastcall *v18)(struct VMBCHANNEL__ *); // [rsp+98h] [rbp-11h]
  void (__fastcall *v19)(struct VMBCHANNEL__ *); // [rsp+A0h] [rbp-9h]
  void (__fastcall *v20)(struct VMBCHANNEL__ *); // [rsp+A8h] [rbp-1h]
  struct _GUID v21; // [rsp+B0h] [rbp+7h] BYREF
  _OWORD v22[2]; // [rsp+C0h] [rbp+17h] BYREF
