/*
 * XREFs of ?DdiRestartFromTimeout@ADAPTER_RENDER@@QEAAJXZ @ 0x1C0161630
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiRestartFromTimeout(ADAPTER_RENDER *this, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE_PushProfilerEntry((__int64)&v25, 5021);
...
LABEL_15:
  ...
  *(_QWORD *)(v19 + 24) = v13;
  *(_QWORD *)(v19 + 32) = *(_QWORD *)(*((_QWORD *)this + 2) + 240LL);
