/*
 * XREFs of ?SetGivenPathDataFromActivePath@CCD_TOPOLOGY@@QEAAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@PEBV1@@Z @ 0x1C0225904
 * Callers:
        ...
        const struct CCD_TOPOLOGY *a3)
{
  ...
  if ( *(_WORD *)(v8 + 20) )
  {
    ...
    {
      v11 = *(_DWORD *)(v9 + v8 + 144);
      if ( v11 <= *(_DWORD *)(v9 + v8 + 92) )
      {
