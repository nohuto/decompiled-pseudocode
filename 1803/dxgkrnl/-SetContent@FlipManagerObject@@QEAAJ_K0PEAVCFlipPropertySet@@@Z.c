/*
 * XREFs of ?SetContent@FlipManagerObject@@QEAAJ_K0PEAVCFlipPropertySet@@@Z @ 0x1C004E274
 * Callers:
        ...
        struct CFlipPropertySet *a4)
{
  ...
  v8 = CPushLock::AcquireLockExclusive((FlipManagerObject *)((char *)this + 32));
  if ( v8 >= 0 )
  {
    v8 = CFlipManager::SetContent((FlipManagerObject *)((char *)this + 24), a2, a3, a4);
