/*
 * XREFs of ?NotifyTokenInFrame@CCompositionSurface@@IEAAJAEBVCToken@@PEA_N@Z @ 0x1C0017D0C
 * Callers:
        ...
        bool *a3)
{
  ...
  *a3 = 0;
  ...
  {
    v7 = v14;
    Buffer = (*(__int64 (__fastcall **)(struct CCompositionBuffer *, __int64, bool *))(*(_QWORD *)v14 + 112LL))(
               v14,
               v6,
               a3);
    if ( Buffer >= 0 && *a3 )
    {
      ...
      while ( v8 != (CCompositionSurface *)((char *)this + 72) )
      {
