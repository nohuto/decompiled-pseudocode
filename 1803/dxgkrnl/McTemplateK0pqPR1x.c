/*
 * XREFs of McTemplateK0pqPR1x @ 0x1C0034B44
 * Callers:
...
NTSTATUS McTemplateK0pqPR1x(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v11 = 8LL;
  v13 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventWaitForSynchronizationObject2, a3, 5u, &v5);
}
