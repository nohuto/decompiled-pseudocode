/*
 * XREFs of ?RemoveListObjectFromSharedPowerList@DXGGLOBAL@@QEAAXPEAVDXGSHAREDPOWERREGISTRATIONOBJECT@@@Z @ 0x1C0032C7C
 * Callers:
        ...
        struct DXGSHAREDPOWERREGISTRATIONOBJECT ***a2)
{
  ...
  KeAcquireInStackQueuedSpinLock(this + 159, &LockHandle);
  v3 = *a2;
