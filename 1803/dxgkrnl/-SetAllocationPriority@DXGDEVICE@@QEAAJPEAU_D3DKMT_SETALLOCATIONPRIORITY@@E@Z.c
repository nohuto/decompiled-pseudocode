/*
 * XREFs of ?SetAllocationPriority@DXGDEVICE@@QEAAJPEAU_D3DKMT_SETALLOCATIONPRIORITY@@E@Z @ 0x1C016B6A4
 * Callers:
...
__int64 __fastcall DXGDEVICE::SetAllocationPriority(DXGDEVICE *this, struct _D3DKMT_SETALLOCATIONPRIORITY *a2)
{
  ...
  struct _EX_RUNDOWN_REF *v30; // [rsp+58h] [rbp+10h] BYREF
    ...
    else
    {
      ...
      if ( v30 )
      {
        if ( (DXGDEVICE *)v30[1].Count == this )
        {
          ...
          v13 = *pPriorities;
          DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v29, (struct DXGFASTMUTEX *const)&v30[10], 0);
    ...
    if ( a2->AllocationCount )
    {
      for ( j = 0LL; ; j = (unsigned int)(j + 1) )
      {
        if ( (unsigned int)j >= a2->AllocationCount )
          return 0LL;
        v19 = &a2->phAllocationList[j];
        if ( (unsigned __int64)v19 >= MmUserProbeAddress )
          v19 = (const D3DKMT_HANDLE *)MmUserProbeAddress;
        v20 = *v19;
