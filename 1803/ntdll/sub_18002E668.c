/*
 * XREFs of sub_18002E668 @ 0x18002E668
 * Callers:
...
__int64 __fastcall sub_18002E668(
        unsigned __int8 *a1,
        unsigned __int8 *a2,
        unsigned __int8 *a3,
        unsigned __int8 *a4,
        ...
        _DWORD *a8)
{
  ...
  {
    v44 = v8 + 8;
    for ( k = 0; k < *((unsigned __int16 *)v8 + 2); v44 += *((unsigned __int16 *)v44 + 1) )
    {
      v46 = v16;
      if ( *v44 == 20 )
      {
        v68 = v16;
        v69 = v16 + *((unsigned __int16 *)v44 + 1);
        v70 = -1;
        if ( v69 >= v16 )
          v70 = v16 + *((unsigned __int16 *)v44 + 1);
        v16 = v70;
  ...
  {
    v47 = a6 + 8;
    for ( m = 0; m < *((unsigned __int16 *)a6 + 2); v47 += *((unsigned __int16 *)v47 + 1) )
    {
      v49 = v16;
      if ( *v47 == 21 )
      {
        v71 = v16;
        v72 = v16 + *((unsigned __int16 *)v47 + 1);
        v73 = -1;
        if ( v72 >= v16 )
          v73 = v16 + *((unsigned __int16 *)v47 + 1);
        v16 = v73;
  ...
  {
    v50 = v81 + 8;
    for ( n = 0; n < *((unsigned __int16 *)v81 + 2); v50 += *((unsigned __int16 *)v50 + 1) )
    {
      v52 = v16;
      if ( *v50 == 18 )
      {
        v74 = v16;
        v75 = v16 + *((unsigned __int16 *)v50 + 1);
        v76 = -1;
        if ( v75 >= v16 )
          v76 = v16 + *((unsigned __int16 *)v50 + 1);
        v16 = v76;
  ...
  {
    v53 = v82 + 8;
    for ( ii = 0; ii < *((unsigned __int16 *)v82 + 2); v53 += *((unsigned __int16 *)v53 + 1) )
    {
      v55 = v16;
      if ( *v53 == 19 )
      {
        v77 = v16;
        v78 = v16 + *((unsigned __int16 *)v53 + 1);
        v79 = -1;
        if ( v78 >= v16 )
          v79 = v16 + *((unsigned __int16 *)v53 + 1);
        v16 = v79;
  ...
  {
    v24 = v15 & 0xFFFFFFFC;
    Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18015C294 + 1310720, v24);
    v11 = Heap;
    if ( !Heap )
    {
      Acl = -1073741801;
    ...
    if ( Acl >= 0 )
    {
      if ( (unsigned __int8)RtlFirstFreeAce(v11, &v80) )
      {
        if ( a1 && (v40 = (unsigned __int16 *)(a1 + 8), v41 = 0, *((_WORD *)a1 + 2)) )
        {
          v26 = (char *)v80;
          do
          {
            v42 = *(_BYTE *)v40;
            if ( *(_BYTE *)v40 >= 2u && (v42 <= 3u || v42 > 6u && (v42 <= 8u || (unsigned __int8)(v42 - 13) <= 3u)) )
            {
              memmove(v26, v40, v40[1]);
              ++*(_WORD *)(v11 + 4);
              v43 = v40[1];
              v26 += v43;
            }
            ...
            ++v41;
            v40 = (unsigned __int16 *)((char *)v40 + (unsigned __int16)v43);
          }
