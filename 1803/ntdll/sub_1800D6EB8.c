...
__int64 __fastcall sub_1800D6EB8(__int64 a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( (int)sub_1800D7B88(&EventHandle) < 0 )
  {
    EventHandle = 0LL;
  }
  else
  ...
  v8 = sub_1800D7BF4(&CrashReportSharedMem, &BaseAddress);
  if ( v8 >= 0 )
  {
    *(_QWORD *)&Flags[2 * v7] = CrashReportSharedMem;
    ...
    v10 = sub_180048C9C((void *)0xFFFFFFFFFFFFFFFFLL);
    ProcessId = v10;
    ...
    *v14 = *v5;
    ...
    if ( v8 >= 0 )
    {
      if ( !Handle || (v8 = sub_1800D7E44(0LL, EventHandle, Handle, v25, v4, &Handle), v8 >= 0) )
        v8 = 0;
    }
  }
  if ( BaseAddress )
