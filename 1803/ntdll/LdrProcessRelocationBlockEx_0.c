/*
 * XREFs of LdrProcessRelocationBlockEx_0 @ 0x180082738
 * Callers:
 *     sub_180082648 @ 0x180082648 (sub_180082648.c)
 *     LdrProcessRelocationBlock @ 0x1800DD700 (LdrProcessRelocationBlock.c)
 *     LdrProcessRelocationBlockEx @ 0x1800DD730 (LdrProcessRelocationBlockEx.c)
 * Callees:
 *     sub_1800DD738 @ 0x1800DD738 (sub_1800DD738.c)
...
LABEL_10:
  ...
  if ( v7 == 448 )
  {
    v17 = sub_1800DD738(v5, VA, Diff);
    goto LABEL_24;
  }
  if ( v7 == 450 || v7 == 452 )
  {
    v17 = sub_1800DD808(v5, VA, Diff);
LABEL_24:
    v10 = v17;
    goto LABEL_10;
  }
