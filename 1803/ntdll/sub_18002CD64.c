...
__int64 __fastcall sub_18002CD64(__int64 a1, __int128 *a2, char a3, HANDLE *a4, PVOID *a5, ULONG_PTR *a6)
{
  PVOID *v9; // r15
  ...
  if ( a1 )
  {
    if ( a2 )
    {
      ...
      if ( a5 )
      {
        ...
        {
          v12 = sub_18003C228(2, *((_QWORD *)a2 + 1), (unsigned int)BaseAddress, 0, (__int64)&RelativeName);
          if ( v12 < 0 )
            goto LABEL_25;
          v13 = BaseAddress[1];
...
LABEL_10:
            ...
            *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
            ...
            if ( v12 >= 0 )
            {
              v12 = ZwCreateSection(&SectionHandle, 0xF0005u, 0LL, 0LL, v11, 0x8000000u, FileHandle);
              if ( v12 >= 0 )
              {
