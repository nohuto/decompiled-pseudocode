/*
 * XREFs of RtlpConvertAbsoluteToRelativeSecurityAttribute @ 0x1800E2FC0
 * Callers:
...
LABEL_78:
    ...
    if ( v11 >= 0x14 )
    {
      v10 = sub_1800437B0(*(_WORD **)a1, 0xFFFFuLL, &v49);
      if ( (v10 & 0x80000000) == 0 )
      {
        v14 = v49 + 2;
        v48 = v49 + 2;
                ...
                if ( *(_WORD *)(a1 + 8) )
                {
                  ...
                  switch ( v37 )
                  {
                    case 3u:
                      ...
                      {
                        a2[i + 4] = v38;
                        v10 = sub_1800437B0(*(_WORD **)(*(_QWORD *)(a1 + 24) + 8LL * i), 0xFFFFuLL, &v49);
                        if ( (v10 & 0x80000000) != 0 )
                          break;
                        v45 = v49 + 2;
...
LABEL_44:
          ...
          while ( 1 )
          {
            v10 = sub_1800437B0(*(_WORD **)(*(_QWORD *)(a1 + 24) + 8LL * v24), 0xFFFFuLL, &v49);
            if ( (v10 & 0x80000000) != 0 )
              break;
            if ( (int)v49 + 2 < (unsigned int)v49 )
              return (unsigned int)-1073741675;
