        ...
        *BaseModule = 0LL;
        ...
        while ( v16 )
        {
                 ...
                 && (v18 = v16 - 1, v19 = 6 * v18, (v20 = (const wchar_t *)v10[6 * v18 + 1]) != 0LL) )
          {
            ...
            {
              v10 = qword_18015B288;
              v7 = (PVOID)*((_QWORD *)qword_18015B288 + v19);
              v9 = dword_18015B290;
              break;
            }
            v9 = dword_18015B290;
            ...
            while ( v12 )
            {
              ...
              if ( (PVOID)v10[6 * v13] == v7 )
              {
                if ( v10[6 * v13 + 1] )
                {
                  ...
                  v10 = qword_18015B288;
                  *((_QWORD *)qword_18015B288 + 6 * v13 + 1) = 0LL;
                  v12 = v25;
                  v9 = dword_18015B290;
                }
                ...
                if ( (unsigned __int64)&v14[-1].InlineStorageMapEntries[31] + 7 <= 0xFFFFFFFFFFFFFFFDuLL )
                {
                  ...
                  v10 = qword_18015B288;
                  *((_QWORD *)qword_18015B288 + 6 * v13 + 5) = 0LL;
                  v9 = dword_18015B290;
                }
                if ( v12 != v9 )
                {
                ...
                {
                  Heap = RtlReAllocateHeap(NtCurrentPeb()->ProcessHeap, 0, qword_18015B288, 48 * v15);
                  v10 = Heap;
                  if ( !Heap )
                  {
                    v8 = -1073741801;
