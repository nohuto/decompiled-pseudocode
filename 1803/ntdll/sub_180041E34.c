...
__int64 __fastcall sub_180041E34(unsigned __int16 *a1, int a2, unsigned __int64 *a3)
{
  int v5; // ebx
  __int64 v7; // rdx
  __int64 v8; // rcx
  ...
  *a3 = 0LL;
  ...
  v14 = v15;
  v15[0] = 0;
  v5 = sub_18003B92C(a1, (unsigned __int16 *)&v13, 0, &v11);
  if ( v5 >= 0 )
  {
    v5 = sub_180041F10((unsigned int)&v13, a2, (_DWORD)a3, (unsigned int)v12, v11);
  ...
  if ( v15 != v14 )
    RtlDeleteBoundaryDescriptor((__int64)v14);
