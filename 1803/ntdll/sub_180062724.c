/*
 * XREFs of sub_180062724 @ 0x180062724
 * Callers:
...
__int64 __fastcall sub_180062724(__int64 a1, signed __int64 a2, __int64 a3)
{
    ...
    if ( _bittest64((const signed __int64 *)a1, (unsigned __int64)a2 >> 30) )
    {
      if ( _bittest64(*(const signed __int64 **)(a1 + 8), (unsigned __int64)a2 >> 15) )
      {
        ...
        else if ( v8 <= 0 )
        {
          ...
          v15 = (a2 % 0x8000) & 0x1F;
          v16 = *(_DWORD *)v14 & dword_180119840[v15];
...
LABEL_22:
        ...
        {
          v12 = sub_1800E5EB0(v28, v6, 0x40000000LL);
        }
