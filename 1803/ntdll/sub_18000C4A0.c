...
__int64 __fastcall sub_18000C4A0(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  __int128 v96; // [rsp+B8h] [rbp-5A0h] BYREF
  ...
  if ( (unsigned __int8)sub_18000F2CC(&v79, &v81) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v10 >= v81 )
        return v8;
      v31 = (unsigned int *)sub_18000D2E0(v108, &v96);
      v104 = v31;
      if ( !v31 )
        return v8;
      VirtualMemory = 0;
...
LABEL_5:
      v14 = (_DWORD)v108 - DWORD2(v96) - *v31;
      v15 = *(_BYTE *)(v36 + 3);
      if ( (v15 & 0xF) == 0 )
      {
        v10 = v107;
...
LABEL_12:
      ...
      if ( (unsigned __int8)(v20 + 62) > 1u && (v20 != -13 || k[1] != 0xC3) )
      {
        ...
        else
        {
          ...
          {
            v68 = (_DWORD *)sub_18000B108((__int64)v31, v32, (__int64)&k[v44]);
            if ( !v68 || v45 == *v68 )
            {
              v10 = v107;
              v34 = v87;
