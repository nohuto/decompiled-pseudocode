/*
 * XREFs of sub_18002B540 @ 0x18002B540
 * Callers:
...
NTSTATUS __fastcall sub_18002B540(__int64 a1)
{
  __int64 v1; // rsi
  ULONG_PTR *v2; // rdi
  NTSTATUS v4; // eax
  ...
  v1 = *(_QWORD *)(a1 + 56);
  v2 = (ULONG_PTR *)(a1 + 112);
  v4 = sub_18001014C(*(_QWORD *)(v1 + 48), 1, 0xCu, (DWORD *)(a1 + 112), (char **)&v22);
  v5 = v22;
  if ( v4 < 0 )
    v5 = 0LL;
