...
LABEL_7:
    ...
    {
      v16 = sub_180039360(&SourceString, (__int64)&v17, (__int64)&v18);
      v11 = v16;
      if ( v16 < 0 || v16 == 259 )
        goto LABEL_20;
      v12 = v17;
  ...
  if ( v13 >= 0 )
  {
    ...
    if ( qword_18016F380 )
    {
      if ( (byte_18016F36C & 1) == 0 )
      {
        ...
        {
          sub_18000EF10((unsigned __int64)v14, (__int64 *)&SourceString);
        }
        else
        {
          SourceString = (STRING)xmmword_18016F4E0;
        }
...
LABEL_20:
  if ( v18 )
    RtlFreeHeap(qword_18015C288, 0LL, v18);
