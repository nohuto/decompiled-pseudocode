 ...
 * Callers:
 *     sub_18009161C @ 0x18009161C (sub_18009161C.c)
 * Callees:
...
unsigned __int64 __fastcall sub_180091404(__int64 a1, unsigned __int8 *a2, unsigned __int8 **a3, int a4, int a5)
{
  int v5; // r14d
...
LABEL_24:
  ...
  while ( 1 )
  {
    if ( (sub_1800913FC()[(unsigned __int8)v8] & 4) != 0 )
    {
      v14 = (char)v8 - 48;
    }
    else
    {
      if ( (sub_1800913FC()[(unsigned __int8)v8] & 0x103) == 0 )
        break;
      v15 = (char)v8 - 32;
...
LABEL_41:
    ...
    {
      v16 = v14;
      if ( v14 <= 0xFFFFFFFFFFFFFFFFuLL % v5 )
        goto LABEL_41;
    }
    v12 |= 4u;
    if ( !a3 )
