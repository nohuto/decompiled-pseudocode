/*
 * XREFs of sub_1800733EC @ 0x1800733EC
 * Callers:
...
__int64 __fastcall sub_1800733EC(__int64 a1, __int64 a2, __int16 a3)
{
  int v3; // r9d
  int v4; // r10d
  int v7; // eax
...
LABEL_31:
    ...
    *(_QWORD *)(a2 + 16) = MEMORY[0x7FFE0014];
    ...
    {
      v13 = sub_180002CBC(a1, (_OWORD *)a2, &v17, &v16);
      v4 = v16;
      v3 = v13;
    }
    else
    {
      ...
      v3 = ZwWriteFile(*(_QWORD *)(a1 + 144), 0LL, 0LL, 0LL, v15, a2, v10, a1 + 360, 0LL);
      if ( v3 >= 0 )
      {
        *(_QWORD *)(a1 + 360) += v10;
        v4 = v16;
