/*
 * XREFs of RtlGetProductInfo @ 0x18007FB70
 * Callers:
 *     <none>
 * Callees:
 *     sub_18007FCA8 @ 0x18007FCA8 (sub_18007FCA8.c)
        ...
        PDWORD ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  v7 = Data_8;
  v17 = xmmword_18011A460;
  if ( (int)sub_18007FCA8(&Data_8, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1801108B0, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1801108A0, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
