/*
 * XREFs of sub_180097DA0 @ 0x180097DA0
 * Callers:
...
__int64 __fastcall sub_180097DA0(__int64 *a1, unsigned __int8 *a2, _BYTE **a3)
{
  __int64 result; // rax
  int v4; // r12d
  unsigned int *v5; // rsi
  ...
  _BYTE *v78; // [rsp+A0h] [rbp+7h] BYREF
    ...
    while ( 1 )
    {
      ...
      if ( (off_180156000[v10] & 8) != 0 )
      {
        ...
        while ( 1 )
        {
          v66 = ++v11;
          v64 = v11;
          v12 = sub_180097D78((__int64)v7);
          if ( v12 == -1 )
            break;
          if ( (off_180156000[(unsigned __int8)v12] & 8) == 0 )
          {
            sub_180095014(v12, v7);
            goto LABEL_12;
          }
        }
        do
...
LABEL_31:
      ...
      if ( v31 != 110 )
      {
        ...
        else
        {
          ...
          while ( v8 != -1 && (off_180156000[(unsigned __int8)v8] & 8) != 0 );
          v31 = (int)v75;
          v66 = v11;
          v65 = v8;
        }
...
LABEL_181:
            ...
            if ( v31 == 123 )
            {
              v57 = sub_180097BEC(v56, &v81, &v65, &v64, (__int64)&v78, v14, a1, v33, &v72);
              v6 = v81;
            }
            else
            {
              v57 = sub_180097A38(v56, 0LL, &v65, &v64, (__int64)&v78, v14, a1, v33, &v72);
            }
            v8 = v65;
            if ( !v57 )
            {
            ...
            if ( v70 )
            {
              if ( !v30 )
              {
                while ( 1 )
                {
                  ...
                  {
                    if ( (off_180156000[(unsigned __int8)v8] & 4) == 0 )
                      goto LABEL_144;
                    if ( v31 == 111 )
                    {
                      if ( v8 >= 56 )
                  ...
                  {
                    v43 = off_180156000[(unsigned __int8)v8];
                    if ( (v43 & 0x80u) == 0 )
                    {
LABEL_144:
                      v66 = --v11;
            ...
            else
            {
              if ( !v30 )
              {
                while ( 1 )
                {
                  ...
                  {
                    v50 = off_180156000[(unsigned __int8)v8];
                    if ( (v50 & 0x80u) == 0 )
                    {
LABEL_166:
                      v66 = --v11;
