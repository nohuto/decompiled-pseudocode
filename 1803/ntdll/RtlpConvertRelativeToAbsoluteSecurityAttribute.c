/*
 * XREFs of RtlpConvertRelativeToAbsoluteSecurityAttribute @ 0x1800E33C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a4)
{
  ...
  if ( v9 < 4 )
    return (unsigned int)-1073741705;
  v8 = sub_1800437B0((unsigned int *)((char *)a1 + *a1), v9, v99);
  if ( (v8 & 0x80000000) != 0 )
    return v8;
  v10 = LODWORD(v99[0]) + 2;
  ...
  if ( (_DWORD)v17 )
  {
    do
    {
      ...
      if ( (unsigned int)v5 < (unsigned int)v42 || (unsigned int)(v5 - v42) < 2 )
        return (unsigned int)-1073741705;
      v8 = sub_1800437B0((unsigned int *)((char *)a1 + v42), (unsigned int)(v5 - v42), v99);
      if ( (v8 & 0x80000000) != 0 )
        return v8;
      v44 = LODWORD(v99[0]) + 2;
      if ( (unsigned int)(LODWORD(v99[0]) + 2) < LODWORD(v99[0]) )
        ...
        if ( v80 >= v59 )
        {
          ...
          *((_QWORD *)a3 + 3) = v60;
          ...
          if ( v77 )
          {
            ...
            {
              v85 = v82;
              v8 = sub_1800437B0((unsigned int *)((char *)a1 + a1[v82 + 4]), v84, v99);
              if ( (v8 & 0x80000000) != 0 )
                break;
              v87 = LODWORD(v99[0]) + 2;
              if ( (unsigned int)(LODWORD(v99[0]) + 2) < LODWORD(v99[0]) )
