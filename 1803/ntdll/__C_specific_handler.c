/*
 * XREFs of __C_specific_handler @ 0x18008B560
 * Callers:
 ...
 *     nullsub_1 @ 0x180091380 (nullsub_1.c)
 *     sub_180091384 @ 0x180091384 (sub_180091384.c)
 */
  ...
  else
  {
    ...
    while ( ScopeIndex < *HandlerData )
    {
        ...
        && HandlerData[4 * ScopeIndex + 4] )
      {
        ...
        {
LABEL_10:
          sub_180091350(ImageBase + HandlerData[4 * ScopeIndex + 4], EstablisherFrame, 1LL);
          RtlUnwindEx(
            EstablisherFrame,
