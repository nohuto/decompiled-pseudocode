/*
 * XREFs of sub_18003F2EC @ 0x18003F2EC
 * Callers:
...
__int64 __fastcall sub_18003F2EC(int a1, __int64 a2, __int64 a3, __int64 a4, _DWORD *a5)
{
  unsigned int v5; // ebx
  const char *v7; // r8
...
LABEL_15:
      v5 = -1073741811;
      v8 = -1073741811;
      DbgPrintEx(51, 0, (int)v7, "RtlpFindActivationContextSection_CheckParameters", v8);
    }
  }
  return v5;
}
