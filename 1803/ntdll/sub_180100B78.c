...
BOOLEAN __fastcall sub_180100B78(PRTL_CRITICAL_SECTION *HeapHandle, int a2, char *a3, ULONG a4, ULONG UserFlagsSet)
{
  BOOLEAN v9; // di
  char v10; // r14
  ULONG v12; // esi
  ...
  if ( (*((_DWORD *)HeapHandle + 29) & 0x1000000) != 0 )
    return ((__int64 (__fastcall *)(PRTL_CRITICAL_SECTION *))qword_180156470)(HeapHandle);
  if ( ((UserFlagsSet | a4) & 0xFFFFF1FF) != 0 )
    return 0;
  if ( sub_18001FC58(HeapHandle, "RtlSetUserFlagsHeap") )
  {
    ...
    if ( sub_180072588((unsigned __int64)HeapHandle, v13, "RtlSetUserFlagsHeap") )
    {
