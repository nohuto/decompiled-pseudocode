...
NTSTATUS __cdecl RtlQueryProcessDebugInformation(HANDLE UniqueProcessId, ULONG Flags, PRTL_DEBUG_INFORMATION Buffer)
{
  ...
  {
    if ( (Flags & 0x41) == 0 || (LODWORD(v3) = sub_180077744(v4, Flags, Buffer), !(_DWORD)v3) )
    {
      if ( (Flags & 2) == 0 || (LODWORD(v3) = RtlQueryProcessBackTraceInformation(Buffer), !(_DWORD)v3) )
      {
        if ( (Flags & 0x20) == 0 || (LODWORD(v3) = RtlQueryProcessLockInformation(Buffer), !(_DWORD)v3) )
        {
          ...
          {
            if ( (Flags & 0x80u) == 0 || (LODWORD(v3) = sub_1800D56BC(Buffer), !(_DWORD)v3) )
            {
              if ( (Flags & 0xC00) != 0 )
                LODWORD(v3) = sub_1800D31B0(Buffer, Flags);
            }
          }
        }
      }
  ...
  v14 = v22;
  v24 = 0LL;
  result = sub_180077F84(Buffer, UniqueProcessId, v22, &v24);
  if ( result >= 0 )
  {
    v15 = v24;
    ...
    LODWORD(v3) = sub_1800FF1D0(TargetProcessHandle, &v30);
    v12 = v15;
    if ( (int)v3 >= 0 )
    {
      LODWORD(v3) = sub_1800060E8(v15, 0LL, 6, 0, 0LL, 0LL, Options, v25, Buffer->ViewBaseTarget, &Handle, 0LL);
      if ( (int)v3 >= 0 )
      {
        v17 = Handle;
      ...
      {
        if ( !v14 )
          LODWORD(v3) = sub_1800D2FD8(Buffer);
        if ( (int)v3 < 0 )
          return (int)v3;
      }
      ...
      if ( (Flags & 0x40) != 0 && !Buffer->Modules )
        LODWORD(v3) = -1073741558;
      if ( (int)v3 >= 0 )
        LODWORD(v3) = sub_1800D35E8(Buffer, Flags, &Buffer[1], Buffer->OffsetFree - 208);
      return (int)v3;
    }
LABEL_25:
    ZwClose(v12);
