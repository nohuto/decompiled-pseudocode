/*
 * XREFs of sub_18004A8A8 @ 0x18004A8A8
 * Callers:
 *     RtlWakeAddressSingle @ 0x180049D80 (RtlWakeAddressSingle.c)
 *     sub_18004A688 @ 0x18004A688 (sub_18004A688.c)
 *     RtlWakeAddressAll @ 0x18004A840 (RtlWakeAddressAll.c)
 ...
 *     RtlWakeAddressAllNoFence @ 0x1800F7F80 (RtlWakeAddressAllNoFence.c)
 *     RtlWakeAddressSingleNoFence @ 0x1800F7F90 (RtlWakeAddressSingleNoFence.c)
 * Callees:
 *     sub_18004ADC0 @ 0x18004ADC0 (sub_18004ADC0.c)
 *     ZwAlertThreadByThreadId @ 0x18009B890 (ZwAlertThreadByThreadId.c)
 */

int __fastcall sub_18004A8A8(unsigned __int64 a1, char a2)
{
  bool v2; // bp
  __int64 v3; // rdi
  __int64 v6; // r10
