/*
 * XREFs of sub_1800FBBF8 @ 0x1800FBBF8
 * Callers:
 *     sub_1800FB5E4 @ 0x1800FB5E4 (sub_1800FB5E4.c)
 * Callees:
 *     sub_18007A6F8 @ 0x18007A6F8 (sub_18007A6F8.c)
 */

__int64 __fastcall sub_1800FBBF8(__int64 a1, int a2)
{
  int v4; // edi
  char v5; // r15
  _WORD *v6; // rbx
...
LABEL_12:
    ...
    v11 = *v8;
    v14 = -1;
    if ( (int)sub_18007A6F8(v10, v9, v11, &v14) < 0 )
      goto LABEL_12;
    v12 = v14;
