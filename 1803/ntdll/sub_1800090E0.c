/*
 * XREFs of sub_1800090E0 @ 0x1800090E0
 * Callers:
        ...
        ...)
{
  ...
  else
  {
    ...
    {
      v17[0] = 0LL;
      v13 = sub_1800091F4(a1, a2, v17, v12, va);
      v14 = v17[0];
      v9 = v13;
      v11 = a2 - v17[0];
      v17[0] = a2 - v17[0];
...
LABEL_11:
    ...
    if ( (a5 & 0x1C00) != 0 && a2 )
    {
      sub_1800CA474(a1, 2 * a2, a3, &v16, v17, a5);
      v10 = v16;
      v11 = v17[0];
    }
