/*
 * XREFs of RtlWow64GetCurrentCpuArea @ 0x180069D60
 * Callers:
 *     RtlWow64GetCurrentMachine @ 0x180069D20 (RtlWow64GetCurrentMachine.c)
 * Callees:
 *     RtlWow64GetCpuAreaInfo @ 0x180069DE0 (RtlWow64GetCpuAreaInfo.c)
 */
