/*
 * XREFs of sub_1800D12F0 @ 0x1800D12F0
 * Callers:
 ...
 *     ZwResumeProcess @ 0x18009D910 (ZwResumeProcess.c)
...
__int64 __fastcall sub_1800D12F0(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 8) & 8) == 0 )
    v3 = *(_DWORD *)(a1 + 8) & 2;
  v4 = RtlCloneUserProcess(v3 | 1u, 0, 0, 0, v7);
  VirtualMemory = v4;
  if ( !v4 )
  {
    v5 = v8;
