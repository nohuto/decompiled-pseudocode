/*
 * XREFs of RtlpConvertLCIDsToCultureNames @ 0x1800E8E80
 * Callers:
...
__int64 __fastcall RtlpConvertLCIDsToCultureNames(__int16 *SourceString, _QWORD *a2)
{
  PCWSTR v3; // rsi
  ...
  v15 = 0;
  v3 = (PCWSTR)SourceString;
  v4 = 0;
  v5 = 0;
  if ( !a2 || !SourceString || *a2 || (int)sub_1800310D8(SourceString, (__int64)a2, &v14) < 0 )
    return 3221225485LL;
  v6 = 2 * v14;
...
LABEL_16:
    ...
    if ( (int)sub_1800E81C8(&DestinationString, &v19[v4]) < 0 )
      goto LABEL_20;
    v10 = v19[v4];
    String.Buffer = (PWCH)&v20;
