...
NTSTATUS __fastcall sub_1800FB0E8(_WORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
    ...
    if ( v13
      ...
      && ZwQueryValueKey(
           *(HANDLE *)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x28),
           ...
           (PULONG)(v4 + 4)) >= 0 )
    {
      v17 = sub_1800FB548(a1, v4 + 256, v14, v4 + 944);
  ...
  *(_DWORD *)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 4) = 170;
  if ( (int)sub_18006F7EC(v19, (PUNICODE_STRING)(v4 + 48), (_DWORD *)(v4 + 16), (void *)(v4 + 80), (ULONG *)(v4 + 4)) >= 0
    && *(_DWORD *)(((unsigned __int64)InstallUILanguageId & 0xFFFFFFFFFFFFFFE0uLL) + 0x10) == 1
    && (!(_DWORD)v8
