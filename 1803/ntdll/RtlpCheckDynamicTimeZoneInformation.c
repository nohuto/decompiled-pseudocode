/*
 * XREFs of RtlpCheckDynamicTimeZoneInformation @ 0x18000A0D0
 * Callers:
 *     <none>
 * Callees:
 *     sub_18000A260 @ 0x18000A260 (sub_18000A260.c)
...
char __fastcall RtlpCheckDynamicTimeZoneInformation(_OWORD *Buf2, unsigned __int16 a2)
{
  ...
  v4 = 0;
  if ( (int)sub_18000A310((char *)Buf2 + 172, &Handle) >= 0 )
  {
    if ( (int)sub_18000A514(v26, Handle, a2) >= 0 )
    {
      v5 = Buf2[1];
      Buf1 = *Buf2;
      v6 = *((_QWORD *)Buf2 + 20);
