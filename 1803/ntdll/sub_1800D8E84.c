/*
 * XREFs of sub_1800D8E84 @ 0x1800D8E84
 * Callers:
...
__int64 __fastcall sub_1800D8E84(__int64 a1, int a2, unsigned int a3)
{
  int v4; // eax
  int v5; // ecx
  int v6; // ecx
