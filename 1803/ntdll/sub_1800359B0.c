/*
 * XREFs of sub_1800359B0 @ 0x1800359B0
 * Callers:
...
__int64 __fastcall sub_1800359B0(__int64 a1, __int64 a2, _DWORD *a3, unsigned int *a4, char a5, char a6, int *a7)
{
  _UNKNOWN **v7; // rax
  unsigned int v8; // ebx
  unsigned int *v9; // r14
  ...
  do
  {
    ...
    if ( *(_WORD *)(v23 + 6LL * v17) == 2 )
    {
      ...
      if ( (int)sub_18007A6F8(*(_QWORD *)(v12 + 24), 2LL, v25, v26) >= 0 )
      {
        v19 = a2;
        if ( a5 < 0 )
        {
