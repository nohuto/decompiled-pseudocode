...
_DWORD *__fastcall sub_180033B60(unsigned __int64 a1, __int64 a2, char a3, char a4)
{
  __int64 v4; // rsi
  _DWORD *result; // rax
  int v8; // eax
  ...
  if ( a4 )
  {
    result = sub_1800107D4(a1, 0, 0LL, 8);
    v10 = result;
  ...
  v13[2] = 0LL;
  v13[0] = L"MUI";
  v8 = sub_180032DB4(a1, (__int64)v13, 3u, 0x30u, (__int64 *)&v12);
  if ( v8 < 0 )
    goto LABEL_14;
  v8 = sub_180010CB4(a1, v12, (unsigned __int64 *)&v10, &v11);
  if ( v8 < 0 )
    goto LABEL_14;
  v9 = v10;
  if ( *v10 != -20054323 )
...
LABEL_14:
  ...
  if ( a3 )
  {
    if ( v9 )
      v4 = (__int64)v9;
    sub_18002B698(a1, 0LL, 0LL, v4, 0, 2, v8, 0LL);
  }
  return v9;
}
