...
NTSTATUS __fastcall sub_1800DDC78(char *FileHandle, _QWORD *a2)
{
  __int64 v4; // rsi
  __int64 v5; // rcx
  __int64 v6; // rbx
  ...
  if ( (*(_BYTE *)v5 & 1) != 0 )
  {
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v7 = 2147353476LL;
    sub_1800DBCC0((unsigned __int16 *)&v10, *(unsigned __int8 *)v7);
  }
  ...
  if ( (*(_BYTE *)v4 & 1) != 0 )
  {
    ...
    sub_1800DBCC0((unsigned __int16 *)&v12, *(unsigned __int8 *)v6);
  }
  return v9;
}
