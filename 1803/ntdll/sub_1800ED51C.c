/*
 * XREFs of sub_1800ED51C @ 0x1800ED51C
 * Callers:
...
__int64 __fastcall sub_1800ED51C(__int64 a1, __int64 a2, _QWORD *a3)
{
  char v3; // r15
  _QWORD *v7; // rcx
  __int16 v8; // r14
  ...
  int v68; // [rsp+38h] [rbp-18h]
  int v69; // [rsp+48h] [rbp-8h]
  int v70; // [rsp+48h] [rbp-8h]
  int v71; // [rsp+48h] [rbp-8h]
  int v72; // [rsp+48h] [rbp-8h]
  int v73; // [rsp+48h] [rbp-8h]
  int v74; // [rsp+48h] [rbp-8h]
  int v75; // [rsp+48h] [rbp-8h]
  unsigned int v76; // [rsp+80h] [rbp+30h] BYREF

  v3 = (char)a3;
  if ( (*(_DWORD *)(a1 + 116) & 0x1000000) != 0 )
    return ((__int64 (*)(void))qword_180156438)();
  if ( (((*(_DWORD *)(a1 + 112) & 0x61000000) != 0) & !_bittest((const signed __int32 *)(a1 + 112), 0x1Cu)) != 0
    && !(unsigned __int8)sub_180101048(a1) )
  {
    v76 = -1073741811;
    goto LABEL_192;
  }
...
LABEL_91:
      ...
      *(_QWORD *)a2 = v34 + 16;
      if ( *(_BYTE *)(a1 + 386) == 2 )
        ...
        v35 = 0LL;
      if ( !v35 || !(unsigned __int8)sub_180102BEC(a1, a2, a3, 2LL) )
      {
...
LABEL_166:
          ...
          if ( (v59 & 2) != 0 )
          {
            v60 = sub_1800EC980(a1, v12);
            *(_QWORD *)(a2 + 24) = *(_QWORD *)(v60 + 8);
        ...
        if ( v39 != 1 )
        {
          ...
          else if ( (v39 & 0x3F) == 0x3F )
          {
            ...
            {
              if ( (unsigned __int16)qword_18015D458 ^ (unsigned __int16)(a1 ^ *(_WORD *)(v12 + 8) ^ (v12 >> 4)) )
                v44 = 0LL;
              else
                v44 = *(_QWORD *)(v12
                                - ((unsigned __int64)((unsigned int)qword_18015D458 ^ (unsigned int)a1 ^ *(_DWORD *)(v12 + 8) ^ (unsigned int)(v12 >> 4)) >> 12));
              v45 = *(_WORD *)(v44 + 36);
            }
...
LABEL_29:
      if ( *(_BYTE *)(a1 + 386) == 2 )
        ...
        v15 = 0LL;
      if ( v15 && (unsigned __int8)sub_180102BEC(a1, a2, a3, 2LL) && (*(_WORD *)(a2 + 18) & 0x2000) == 0 )
        goto LABEL_192;
      v16 = *(_QWORD **)a2;
      if ( (*(_BYTE *)(a2 + 18) & 1) != 0 )
      {
...
LABEL_61:
        if ( *(_QWORD *)(v17 + 56) + v17 + 64 >= *(_QWORD *)(v21 + 72) )
        {
          v14 = *(_QWORD *)(v21 + 24);
          if ( v14 == a1 + 288 )
            goto LABEL_64;
