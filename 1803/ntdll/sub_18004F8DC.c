/*
 * XREFs of sub_18004F8DC @ 0x18004F8DC
 * Callers:
...
char __fastcall sub_18004F8DC(_WORD *a1, __int64 a2, __int64 a3, __int64 a4, unsigned int a5, int a6)
{
  char v6; // bl
  __int64 v7; // r11
  __int64 v8; // r10
  ...
  if ( !v15 || v15 == 2 )
  {
    if ( v7 )
    {
      v16 = sub_1800E7810(a1, v8, v7, &v27);
      LODWORD(v7) = a4;
      if ( v16 >= 0 )
      {
        v17 = 0;
...
LABEL_8:
            ...
            if ( (unsigned __int8)sub_18004F8DC(
