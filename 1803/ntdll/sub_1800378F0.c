/*
 * XREFs of sub_1800378F0 @ 0x1800378F0
 * Callers:
...
__int64 __fastcall sub_1800378F0(unsigned __int16 *a1)
{
  int v2; // ebp
  int v3; // r14d
  __int64 v4; // r15
  ...
  v2 = 0;
  v3 = *(unsigned __int16 *)(qword_18015D2B8 + 10) - 1;
  if ( v3 < 0 )
    return 0xFFFFFFFFLL;
  while ( 1 )
  {
    v4 = (v3 + v2) / 2;
    v5 = *(_QWORD *)(qword_18015D2B8 + 40)
       + 2LL
       + 2LL * *(unsigned __int16 *)(*(_QWORD *)(qword_18015D2B8 + 32) + 8 * v4);
    LOWORD(v6) = 0;
    if ( a1 )
    {
      v7 = -1LL;
