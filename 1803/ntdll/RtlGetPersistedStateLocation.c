        ...
        unsigned int *a7)
{
  ...
  __int64 v23; // r8
  __int64 v24; // [rsp+30h] [rbp-41h] BYREF
  ...
  if ( a4 > 1 )
    return 3221225713LL;
  v28 = 48;
  p_DestinationString = (UNICODE_STRING *)((char *)&unk_1801107C0 + 16 * (int)a4);
  v29 = 0LL;
  v31 = 64;
  v32 = 0LL;
  v11 = ZwOpenKey(&v24, 131097LL, &v28);
  v12 = v11;
  if ( v11 != -1073741772 )
  {
    if ( v11 < 0 )
    ...
    v31 = 64;
    v32 = 0LL;
    v12 = ZwOpenKey(&v25, 131097LL, &v28);
    if ( v12 != -1073741772 )
      goto LABEL_19;
  }
  if ( !a3 )
...
LABEL_19:
    ...
    if ( a6 + 16 >= a6 )
    {
      ...
      v12 = ZwQueryValueKey(v25, &DestinationString, 2LL, Heap, v20, &v33);
      if ( v12 < 0 )
      {
        if ( v12 != -2147483643 )
          goto LABEL_12;
