...
__int64 __fastcall sub_18010C2E8(
      ...
      if ( v11 <= 0xFFFFFFFF )
      {
        ...
        if ( (unsigned int)(v12 + 1144) >= 0x478 )
        {
          ...
          *((_OWORD *)v14 + 6) = v29;
          ...
          if ( v23 )
          {
            v10 = ZwDuplicateObject(ProcessHandle, v23, SourceProcessHandle, (PHANDLE)&v41[109], 0, 0, 2u);
            if ( v10 < 0 )
              goto LABEL_50;
          }
          if ( v45 )
          {
            v10 = ZwDuplicateObject(ProcessHandle, v45, SourceProcessHandle, (PHANDLE)&v41[112], 0, 0, 2u);
            if ( v10 < 0 )
              goto LABEL_50;
          }
          if ( v47 )
          ...
          v31 = 0LL;
          v10 = ZwWriteVirtualMemory(SourceProcessHandle, BaseAddressa, v41, v9, 0LL);
          if ( v10 < 0 )
            goto LABEL_50;
          if ( v46 )
          {
