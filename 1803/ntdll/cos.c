  ...
  if ( (*(_QWORD *)&X & 0x7FFFFFFFFFFFFFFFuLL) > 0x3FE921FB54442D18LL )
  {
    if ( (*(_QWORD *)&X & 0x7FF0000000000000LL) == 0x7FF0000000000000LL )
    {
      ...
      if ( (*(_QWORD *)&X & 0xFFFFFFFFFFFFFLL) != 0 )
        sub_180092F8C((unsigned int)"cos", 18, LODWORD(X), 1, 0, 33, *(__int64 *)&v1, 0LL, 1);
      else
        sub_180092F8C((unsigned int)"cos", 18, 0, 1, 8, 33, *(__int64 *)&v1, 0LL, 1);
      return result;
    }
    if ( v3 != *(_QWORD *)&X )
      v1 = -X;
    if ( v1 >= 500000.0 )
    {
      sub_1800930B4(0x7FF0000000000000LL, &v22, &v23, &v20);
      v15 = v20;
      v16 = v22;
      v17 = v23;
    }
