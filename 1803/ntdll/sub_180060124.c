/*
 * XREFs of sub_180060124 @ 0x180060124
 * Callers:
...
__int64 __fastcall sub_180060124(__int64 a1)
{
  int v2; // ebx
  __int64 v4; // rdx
  ...
  {
    sub_180060204(sub_180060AF0, 1LL, 1LL);
    if ( *(_DWORD *)a1 == 0x80000000 )
      goto LABEL_3;
    v7 = 0LL;
    v8 = 0LL;
    v9 = 0;
    v2 = sub_180060204(sub_1800ECCC0, &v7, 3LL);
    if ( v2 >= 0 )
    {
      memset(v6, 0, 0xA8uLL);
      v4 = *(_QWORD *)(a1 + 16);
...
LABEL_3:
        v2 = sub_180060204(sub_180060B10, a1, 3LL);
    }
    sub_180060204(sub_180060AF0, 0LL, 1LL);
  }
  else
  {
