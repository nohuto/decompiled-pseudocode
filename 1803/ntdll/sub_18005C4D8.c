        ...
        unsigned __int64 a8)
{
  ...
  if ( v13 + 80 >= a7 )
  {
    if ( v13 + 80 < v9 )
    {
      v27[0] = (v13 - a7 + 4111) & 0xFFFFFFFFFFFFF000uLL;
      v24 = sub_18002AE30(a1, 1);
      if ( (int)ZwAllocateVirtualMemory(-1LL, &a7, 0LL, v27, 4096, v24) >= 0 )
      {
...
LABEL_3:
  ...
  *(_BYTE *)(v13 + 14) = v19;
  sub_18002AA88(a1, a2, v12 - 48, (unsigned int)((_DWORD)v15 << 12), v13, v27);
  if ( *(_DWORD *)(a1 + 124) )
  {
