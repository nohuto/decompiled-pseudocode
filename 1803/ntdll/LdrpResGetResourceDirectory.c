/*
 * XREFs of LdrpResGetResourceDirectory @ 0x180051CC0
 * Callers:
        ...
        PIMAGE_NT_HEADERS *a5)
{
  ...
  if ( (*(_BYTE *)v10 & 1) != 0 )
  {
    ...
    sub_1800DBCC0(&v29, *(unsigned __int8 *)v25);
  }
  else
  {
    v11 = 2147353476LL;
    ...
    else
    {
      ...
      if ( v17 )
      {
        ...
        else
        {
          v19 = v49;
          v20 = a2;
          v21 = (unsigned int *)sub_180053E18(BaseOfImage, a2, (_DWORD)OutHeaders, 0, v17, v49 != 0);
          if ( !v21 )
          {
            v26 = -1073741701;
            goto LABEL_42;
...
LABEL_42:
    ...
    if ( (*(_BYTE *)v9 & 1) != 0 )
    {
      ...
      sub_1800DBCC0(&v31, *(unsigned __int8 *)v11);
    }
    return v26;
  }
  return result;
