/*
 * XREFs of sub_180093AB0 @ 0x180093AB0
 * Callers:
 ...
 *     sub_180094094 @ 0x180094094 (sub_180094094.c)
 */

__int64 __fastcall sub_180093AB0(_DWORD *a1, _QWORD *a2, char a3, __int16 a4, _DWORD *a5, _DWORD *a6, int a7)
{
  DWORD v7; // esi
  int v11; // eax
  int v12; // edx
