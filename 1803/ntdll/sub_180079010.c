...
__int64 __fastcall sub_180079010(_DWORD *a1, __int64 a2, __int64 a3, unsigned __int64 a4, unsigned __int64 *a5)
{
  ...
  if ( a5 )
    *a5 = 0LL;
  v9 = 64LL;
  sub_180079324(&v22, &v23, a3);
  if ( v22 == 2 )
    return (unsigned int)v23;
  result = sub_1800793D0(v21, (_DWORD)a5, v10, (unsigned int)&a5, (_DWORD)v5, 64);
  if ( (int)result >= 0 )
  {
