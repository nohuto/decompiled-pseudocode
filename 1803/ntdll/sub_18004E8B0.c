/*
 * XREFs of sub_18004E8B0 @ 0x18004E8B0
 * Callers:
...
__int64 __fastcall sub_18004E8B0(__int64 a1, unsigned int a2, unsigned __int16 *a3, _QWORD *a4)
{
  __int64 v4; // rbp
...
LABEL_20:
  ...
  *(_WORD *)(Heap + 10) = *a3 + 2;
  memmove((void *)(Heap + 32), *((const void **)a3 + 1), *a3);
