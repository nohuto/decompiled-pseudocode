/*
 * XREFs of sub_180005CCC @ 0x180005CCC
 * Callers:
...
char __fastcall sub_180005CCC(__int64 a1, __int64 a2, _QWORD *a3, _DWORD *a4, _BYTE *a5)
{
  __int16 v5; // r10
  char v6; // di
  __int64 v8; // rax
  ...
  if ( *(_DWORD *)a2 == 3 )
  {
    ...
    {
      if ( *(__int16 *)(a2 + 78) < 0 && qword_18015A418 )
        v8 = *(_QWORD *)(qword_18015A418 + 88);
      else
        v8 = *(_QWORD *)(a1 + 88);
      *a3 = v8;
      *(_QWORD *)(a2 + 24) = v8;
