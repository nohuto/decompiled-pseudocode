...
NTSTATUS __fastcall sub_180077C20(__int64 *a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
  NTSTATUS result; // eax
  int v10; // esi
  __int64 v11; // rdx
  ...
  result = sub_180077D2C(a1, a3, v14, 288LL);
  if ( result >= 0 )
  {
    result = sub_180077D2C(a1, v19, v12, 80LL);
    if ( result >= 0 )
    {
      *(_QWORD *)(a2 + 16) = v15;
      *(_DWORD *)(a2 + 24) = v16;
      *(_DWORD *)(a2 + 28) = v18;
      ...
      if ( (a5 & 2) != 0 )
      {
        ...
        do
        {
          if ( (int)sub_180077D2C(a1, v11, &v20, 8LL) < 0 )
            break;
          v11 = v20;
          if ( v20 == a4 )
            break;
      ...
      return sub_180077824(a1, (__int64)v17, a2, 0);
    }
  }
  return result;
}
