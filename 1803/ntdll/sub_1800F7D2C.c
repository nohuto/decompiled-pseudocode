/*
 * XREFs of sub_1800F7D2C @ 0x1800F7D2C
 * Callers:
...
char __fastcall sub_1800F7D2C(__int64 a1, unsigned int a2, const void *a3, _QWORD *a4)
{
  __int64 v4; // rsi
  __int64 v9; // rax
  _QWORD *v10; // rcx
  ...
  if ( a2 > 0x100 )
    return 0;
  if ( !(unsigned __int8)sub_1800F7ED0(a1, a2, a3, v18) )
  {
    v10 = *(_QWORD **)(a1 + 16);
    v11 = 8 * v4 + 56;
    if ( v11 > v10[5] - v10[6] )
