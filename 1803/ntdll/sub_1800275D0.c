...
__int64 __fastcall sub_1800275D0(__int64 a1, __int64 a2, unsigned int a3, unsigned int a4, __int64 a5, char *a6)
{
  __int64 v6; // r12
  __int64 v8; // r10
  __int64 v9; // rdx
  ...
  __int64 result; // rax
  _RTL_SRWLOCK **v29; // rdi
  _RTL_SRWLOCK *v30; // rcx
  _RTL_SRWLOCK **v31; // rdi
  ...
  else
  {
    ...
    *(_DWORD *)(v14 + 8) += a3 - 1;
    ...
    if ( v12 != a3 - 1 && _InterlockedExchangeAdd((volatile signed __int32 *)(v14 + 8), 0xFFFFFFFF) == 1 )
      RtlFreeHeap(NtCurrentPeb()->ProcessHeap, dword_18015D050 + 3145728, *(PVOID *)v14);
    if ( v13 )
    {
      v37 = (__int64)(v59 - 2);
      v38 = &v56 + 4;
