/*
 * XREFs of sub_1800FC960 @ 0x1800FC960
 * Callers:
...
ULONG __fastcall sub_1800FC960(int a1, int a2)
{
  ...
  v8 = 0;
  v7 = 4;
  return EtwEventWrite(qword_18015D2D8, &stru_180123FB0, 2u, (PEVENT_DATA_DESCRIPTOR)&v3);
}
