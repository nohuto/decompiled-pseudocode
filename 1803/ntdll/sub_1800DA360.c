/*
 * XREFs of sub_1800DA360 @ 0x1800DA360
 * Callers:
...
__int64 __fastcall sub_1800DA360(__int64 a1, __int64 a2, __int64 a3)
{
  int ValueKey; // eax
  unsigned int v5; // ebx
  const char *v6; // r8
...
LABEL_6:
      DbgPrintEx(51, 0, (int)v6, &v11, ValueKey, v10);
      goto LABEL_22;
    }
    v10 = &v12;
...
LABEL_11:
    ...
    if ( Size > *(unsigned __int16 *)(a3 + 2) )
    {
      ...
      *(_WORD *)(a3 + 2) = Size;
      v8 = sub_18003B5E0((unsigned __int16)v7);
      *(_QWORD *)(a3 + 8) = v8;
      if ( !v8 )
      {
        v5 = -1073741801;
