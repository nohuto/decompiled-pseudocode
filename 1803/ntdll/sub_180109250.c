...
__int64 __fastcall sub_180109250(PRTL_SPLAY_LINKS *a1, unsigned __int64 a2, void *a3)
{
...
LABEL_13:
    ...
    v7 = sub_18005756C(a3, (__int64)&v8->LeftChild, (PPEB_LDR_DATA)v8[3].LeftChild);
    if ( v7 >= 0 )
