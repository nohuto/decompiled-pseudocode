/*
 * XREFs of sub_1800E91E0 @ 0x1800E91E0
 * Callers:
...
__int64 __fastcall sub_1800E91E0(
        __int64 a1,
        __int64 a2,
        _QWORD *a3,
        WCHAR *a4,
  ...
  while ( v12 < 4 )
  {
    ...
    if ( ((*(_WORD *)(a2 + 8) >> (2 * v12)) & 3) == 1 )
    {
      if ( (*(_BYTE *)a2 & 4) != 0 )
        goto LABEL_25;
      String.Buffer = a4;
      if ( (int)sub_180076B04(2 * (unsigned int)(unsigned __int16)a5, (__int16 *)&String.MaximumLength) < 0
    ...
    {
      if ( (int)sub_1800F9414(v11, v14, (unsigned int)&v18, (_DWORD)a4, a5, (__int64)&v17) < 0 || (v17 & 0x1000) != 0 )
        goto LABEL_25;
      if ( a3 )
        *a3 = *(_QWORD *)(*(_QWORD *)(a1 + 24) + 16LL) + 28LL * (__int16)v14;
    }
    else if ( ((*(_WORD *)(a2 + 8) >> (2 * v12)) & 3) == 3
           && ((*(_BYTE *)a2 & 4) != 0 || (int)sub_1800F9748(v11, v14, a4, a5) < 0 || (*(_WORD *)a2 & 0x1000) != 0) )
    {
      goto LABEL_25;
    }
    v13 = 1;
