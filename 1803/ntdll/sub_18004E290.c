...
__int64 __fastcall sub_18004E290(__int64 a1, unsigned int *a2, unsigned int a3, __int64 a4, __int64 a5)
{
  __int64 v5; // r14
  NTSTATUS v8; // ebx
  PWCH Buffer; // r13
...
LABEL_23:
      ...
      if ( v28 >= 0 )
      {
        v29 = sub_18004E8B0(a1, (unsigned int)v5, &v42, &FileHandle);
        v8 = v29;
        if ( v29 >= 0 )
          v8 = 0;
        else
...
LABEL_19:
    ...
    v22 = sub_18004E8B0(a1, (unsigned int)v5, v34, &FileHandle);
    v8 = v22;
    if ( v22 < 0 )
...
LABEL_22:
  ...
  BoundaryDescriptor = (POBJECT_BOUNDARY_DESCRIPTOR)sub_18003B5E0(v25);
  if ( BoundaryDescriptor )
  {
    v26 = (void **)&v36;
    v34 = &v36;
