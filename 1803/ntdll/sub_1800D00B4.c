...
__int64 __fastcall sub_1800D00B4(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v4; // edi
  WCHAR *v5; // rbx
  __int64 v6; // rax
  ...
  SourceString[0] = 0;
  if ( (int)sub_18004AEE4(a2, a3, (__int64)L"VerifierActivationFilter", 1u, (__int64)SourceString, 512, v12, 0LL) < 0 )
  {
    return 1;
  }
  else
