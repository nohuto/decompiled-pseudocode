/*
 * XREFs of sub_1800FDA58 @ 0x1800FDA58
 * Callers:
...
void sub_1800FDA58()
{
  ...
  ULONGLONG v23; // [rsp+80h] [rbp+18h] BYREF
  ...
  if ( !qword_18015D818 )
  {
    ...
    if ( (int)RtlCreateMemoryZone(&v22, (v8 + 4143) & 0xFFFFFFFFFFFFF000uLL, 0) >= 0 )
    {
      ...
      *((_DWORD *)&v13[2].HeaderX64 + 2) = v5;
      while ( 1 )
      {
        RtlInitializeSListHead_0(v14);
        v14[1].Alignment = v3;
        v14[1].Region = (ULONGLONG)v13;
        if ( v3 == v4 )
          break;
        v3 *= 2LL;
        v14 += 2;
      ...
      if ( (int)RtlAllocateMemoryBlockLookaside(v13, 6432LL, &v24) >= 0 )
      {
        ...
        *v20 = v13;
        if ( !_InterlockedCompareExchange64(&qword_18015D818, (signed __int64)v20, 0LL) )
          return;
