/*
 * XREFs of sub_18002AEE0 @ 0x18002AEE0
 * Callers:
...
__int64 __fastcall sub_18002AEE0(__int64 a1, unsigned __int64 a2, __int64 a3, int a4, unsigned int a5)
{
  __int64 result; // rax
  unsigned int v9; // ebx
  ...
  if ( KiUserInvertedFunctionTable[0] == dword_18016F4D4 )
  {
    byte_18016F4DC = 1;
  }
  else
  {
    ...
    if ( KiUserInvertedFunctionTable[0] != 1 )
    {
      ...
      {
        v10 = (unsigned __int64 *)&unk_18016F500;
        do
        {
          if ( a2 < *v10 )
            break;
