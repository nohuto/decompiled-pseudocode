/*
 * XREFs of sub_180083BF0 @ 0x180083BF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180083BF0(_BYTE *a1, int a2, unsigned __int8 *a3, int a4, int a5, _DWORD *a6, __int64 a7)
{
...
LABEL_3:
  ...
  if ( (unsigned int)sub_180084110(v9, v7) )
    return 3221226050LL;
  v13 = 16LL;
...
LABEL_55:
    ...
    {
      v40 = *(_WORD *)(v9 + 2 * ((unsigned __int64)v18 >> 22) + 1056) & 0xF;
      v18 <<= v40;
      v13 -= v40;
    }
    v22 = (v39 >> 4) - 256;
