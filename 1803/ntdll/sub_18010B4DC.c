/*
 * XREFs of sub_18010B4DC @ 0x18010B4DC
 * Callers:
 ...
 *     ZwQueryObject @ 0x18009ACC0 (ZwQueryObject.c)
 *     ZwDuplicateObject @ 0x18009B240 (ZwDuplicateObject.c)
 *     _guard_dispatch_icall_nop @ 0x18009E4A0 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1800A16C0 (memset.c)
 */

__int64 __fastcall sub_18010B4DC(
        __int64 a1,
        unsigned int *a2,
        unsigned int a3,
        char a4,
...
LABEL_19:
    ...
    if ( (a4 & 0x20) != 0 )
    {
      v15 = (const wchar_t **)&off_180111120;
      ...
      v16 = 3LL * v7;
      if ( ((int (__fastcall *)(__int64, _BYTE *, __int64, int *, _QWORD, _DWORD, int))*(&off_180111120 + v16 + 1))(
             v18,
             v25,
             64LL,
             &v17,
