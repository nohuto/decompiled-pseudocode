...
HANDLE __fastcall sub_18010B4DC(
...
LABEL_19:
    ...
    if ( (a4 & 0x20) != 0 )
    {
      v16 = (const wchar_t **)&off_180111120;
      ...
      v17 = 3LL * v7;
      if ( ((int (__fastcall *)(HANDLE, _BYTE *, __int64, int *))*(&off_180111120 + v17 + 1))(
             TargetHandle,
             v26,
             64LL,
             &v18) < 0
