...
LABEL_72:
    ...
    Heap = RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, dword_18015C294 + 1310720, v13);
    if ( !Heap )
    {
      v10 = -1073741801;
LABEL_73:
    ...
    *(_BYTE *)Heap = 2;
    if ( a1 )
    {
      ...
      {
        if ( *v15 == 18 && (v15[1] & 0x10) == 0 && !sub_1800E3AAC((__int64)v15, Heap, 0, v29) )
        {
          if ( !a2 || a4 )
            v17 = 0;
          else
          ...
          if ( v17 && v29[0] )
          {
            *(_WORD *)(Heap + 2) += *((_WORD *)v15 + 1);
            if ( *(unsigned __int16 *)(Heap + 2) > v30 )
              goto LABEL_71;
...
LABEL_71:
    ...
    if ( a2 )
    {
      if ( v5 )
      {
        ...
        {
          if ( *v18 == 18 && (v18[1] & 0x10) == 0 && !sub_1800E3AAC((__int64)v18, Heap, 0, v29) )
          {
    ...
    if ( a1 )
    {
      ...
      if ( (_WORD)v20 )
      {
        do
        {
          if ( *v22 == 18 && (v22[1] & 0x10) != 0 && !sub_1800E3AAC((__int64)v22, Heap, 0, v29) )
          {
            if ( a2 )
