...
__int64 __fastcall sub_18005F208(unsigned int *a1, size_t a2, unsigned __int64 a3, unsigned int a4, int *a5)
{
  ...
  if ( v6 > 0x20000 )
  {
    if ( v6 > a1[32] )
    {
      if ( v6 > a1[62] )
      {
        v11 = (void *)sub_180081CA0(a1, v7, v6, a4);
        goto LABEL_5;
      }
      v13 = (__int64)(a1 + 58);
    }
  ...
  {
    v11 = sub_180020E70((__int64)(a1 + 98), a2, a3, a4);
  }
LABEL_5:
  v10 = (__int64)v11;
LABEL_6:
