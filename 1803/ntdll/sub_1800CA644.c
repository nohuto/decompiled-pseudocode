/*
 * XREFs of sub_1800CA644 @ 0x1800CA644
 * Callers:
...
char sub_1800CA644()
{
  ...
  if ( *(_BYTE *)v1 && (NtCurrentPeb()->TracingFlags & 4) != 0 )
  {
    ...
    if ( (*v5 & 0x20) != 0 )
    {
      LOBYTE(v4) = -1;
      LOBYTE(v3) = -1;
      sub_1800CBAB0(5248, -1, v3, v4, 0LL, 0LL);
    }
  }
  v6 = RtlTryEnterCriticalSection((__int64)&off_1801565B0);
  ...
  else
  {
    ...
    if ( *(_BYTE *)v0 && (NtCurrentPeb()->TracingFlags & 4) != 0 )
    {
      ...
      if ( (*(_BYTE *)v2 & 0x20) != 0 )
      {
        LOBYTE(v12) = -1;
        LOBYTE(v11) = -1;
        sub_1800CBAB0(5250, -1, v11, v12, 0LL, 0LL);
      }
    }
    return 0;
  }
