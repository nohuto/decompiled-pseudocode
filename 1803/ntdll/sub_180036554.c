/*
 * XREFs of sub_180036554 @ 0x180036554
 * Callers:
...
__int64 __fastcall sub_180036554(__int64 a1, __int64 a2, const WCHAR *a3, _WORD *a4)
{
  __int16 v8; // dx
  DWORD v9; // esi
  int v10; // eax
  ...
  if ( a1 && a2 && a3 && a4 )
  {
    *a4 = -1;
    ...
    if ( *a3 )
    {
      v8 = sub_1800366B4(*(_QWORD *)(a1 + 32), a3, 0LL, &Lcid);
      if ( v8 < 0 )
        goto LABEL_23;
      v10 = 0;
    }
