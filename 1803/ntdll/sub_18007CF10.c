...
__int64 sub_18007CF10()
{
  ...
  {
    v1 = DWORD1(v12);
    qword_18015D468 = *(_QWORD *)((char *)&v12 + 4);
    v2 = 1049601;
    if ( BYTE4(v12) > 0x14u || !_bittest(&v2, BYTE4(v12)) )
      LOBYTE(qword_18015D468) = 0;
    if ( BYTE1(qword_18015D468) > 0x14u || (v1 = BYTE1(qword_18015D468), !_bittest(&v2, BYTE1(qword_18015D468))) )
      BYTE1(qword_18015D468) = 0;
    LOBYTE(v1) = BYTE2(qword_18015D468);
    if ( BYTE2(qword_18015D468) > 0x14u || (v3 = 1082401, !_bittest(&v3, v1)) )
