/*
 * XREFs of RtlActivateActivationContextEx @ 0x18004DFF0
 * Callers:
 *     RtlActivateActivationContext @ 0x18004DFA0 (RtlActivateActivationContext.c)
 * Callees:
        ...
        PULONG_PTR Cookie)
{
  ...
  if ( Cookie )
    *Cookie = 0LL;
  v6 = (_ACTIVATION_CONTEXT *)&unk_180110418;
  ...
  result = sub_18004E114(Flags, ActivationContextStackPointer, &v14);
  if ( result >= 0 )
  {
    v9 = v14;
    v14->Flags = 40;
