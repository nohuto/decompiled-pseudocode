/*
 * XREFs of sub_1800FEB48 @ 0x1800FEB48
 * Callers:
...
ULONG sub_1800FEB48()
{
  ...
  if ( NtCurrentPeb()->Ldr )
    ...
    DbgPrint("HEAP: ");
  DbgPrint("Heap error detected at %p (heap handle %p)\n", (const void *)qword_1801597C8, (const void *)qword_1801597C0);
  if ( dword_1801597B8 > 8 )
  {
    switch ( dword_1801597B8 )
    {
      case 9:
  ...
  else if ( dword_1801597B8 == 8 )
  {
    v0 = "heap_failure_block_not_busy";
  }
  else if ( dword_1801597B8 )
  {
    switch ( dword_1801597B8 )
    {
      case 1:
  ...
  if ( qword_1801597E0 )
  {
    if ( NtCurrentPeb()->Ldr )
      ...
      DbgPrint("HEAP: ");
    DbgPrint("Parameter3: %p\n", (const void *)qword_1801597E0);
  }
  if ( qword_1801597E8 || qword_1801597F0 )
  {
    if ( NtCurrentPeb()->Ldr )
      DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
    else
    ...
    DbgPrint(
      ...
      (const void *)qword_1801597E8,
      (const void *)qword_1801597F0);
  }
  if ( NtCurrentPeb()->Ldr )
    DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
  else
