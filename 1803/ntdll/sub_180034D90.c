...
LABEL_11:
  ...
  {
    LOBYTE(v16) = 1;
    v17 = sub_1800352EC(v9, DestinationString.Buffer, v16, &v22);
  }
  else
  {
    if ( (int)sub_180030E7C((_QWORD *)v9, DestinationString.Buffer) >= 0 )
      return v7;
    v17 = sub_180030CC8(v9, DestinationString.Buffer);
  }
  if ( v17 < 0 )
    *a5 = 1;
  return v7;
