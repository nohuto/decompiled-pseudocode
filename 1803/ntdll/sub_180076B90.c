/*
 * XREFs of sub_180076B90 @ 0x180076B90
 * Callers:
...
__int64 __fastcall sub_180076B90(const void **a1, unsigned int a2, unsigned __int64 *a3)
{
  __int64 v4; // rsi
  __int64 result; // rax
  int v7; // r15d
