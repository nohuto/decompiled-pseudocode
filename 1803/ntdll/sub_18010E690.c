...
NTSTATUS __fastcall sub_18010E690(__int64 a1, _DWORD *a2)
{
  NTSTATUS result; // eax
  NTSTATUS v5; // ebx
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( result >= 0 )
  {
    ...
    v8 = 1;
    v9 = a1;
    v5 = ZwDeviceIoControlFile(FileHandle, 0LL, 0LL, 0LL, &v12, 0x220004u, InputBuffer, 0x20u, OutputBuffer, 0x10u);
    ZwClose(FileHandle);
    if ( v5 >= 0 )
    {
      if ( v14 <= 0xFFFFFFFF )
