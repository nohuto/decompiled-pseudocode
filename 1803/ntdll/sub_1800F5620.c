/*
 * XREFs of sub_1800F5620 @ 0x1800F5620
 * Callers:
...
unsigned __int64 __fastcall sub_1800F5620(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( v4 != (unsigned __int16 *)v5 )
    {
      ...
      while ( 1 )
      {
        result = sub_1800F5370(a1, &v18);
        v8 = *(_QWORD *)(v7 + 32);
        v9 = *(_QWORD *)(v7 + 40);
        a1 = ((unsigned __int64)*(unsigned __int8 *)(((__int64)(int)result >> 7) + v8) << 7) + v9;
        v10 = *(_BYTE *)((result & 0x7F) + a1 - 128);
        v11 = v10 & 0x3F;
        if ( (v10 & 0x3F) == v6 )
          goto LABEL_17;
        if ( (v10 & 0xC0) != 0xC0 )
          break;
        result = sub_1800F5AD0(v7, *(unsigned int *)(v3 + 88), (unsigned int)result);
        if ( !(_DWORD)result )
          break;
        v5 = *(_QWORD *)(v3 + 40) - 2LL;
        *(_DWORD *)(v3 + 88) = result;
