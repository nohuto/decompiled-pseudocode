...
struct _PEB *__fastcall sub_180061148(__int64 a1)
{
  unsigned int v2; // ecx
  __int64 v3; // rdx
  __int64 v4; // r12
  ...
  unsigned __int64 v56; // [rsp+40h] [rbp-58h] BYREF
  unsigned __int64 v57[10]; // [rsp+48h] [rbp-50h] BYREF
  unsigned int v58; // [rsp+A0h] [rbp+8h]
  union _SLIST_HEADER *v59; // [rsp+A0h] [rbp+8h]
  unsigned int v60; // [rsp+A8h] [rbp+10h]
  __int64 v61; // [rsp+A8h] [rbp+10h]
  unsigned int v62; // [rsp+B0h] [rbp+18h]
  char v63; // [rsp+B8h] [rbp+20h] BYREF
      ...
      if ( (_WORD)v17 + (_WORD)v23 + 1 == *((_WORD *)v15 + 20) )
      {
              ...
              (unsigned int)Alignment_low >= *((_DWORD *)&(*v24)[2].HeaderX64 + 1)) )
        {
          ...
          if ( v28 )
          {
            ...
            {
              v31 = **(union _SLIST_HEADER ***)v28;
              *(_QWORD *)v28 = 0LL;
LABEL_83:
              v32 = (struct _SLIST_ENTRY *)(v28 + 12);
LABEL_53:
              ...
              while ( 1 )
              {
                ...
                if ( v29 == _InterlockedCompareExchange(v28 + 11, v29 | 2, v29) )
                {
                  ...
                  while ( 1 )
                  {
                    ...
                    if ( Alignment_low )
                    {
                                              ...
                                              Alignment_low) )
                      {
                        ...
                        if ( _InterlockedAnd((volatile signed __int32 *)(Alignment_low + 44), 0xFFFFFFFD) != 2 )
                          goto LABEL_54;
                        v31 = **(union _SLIST_HEADER ***)Alignment_low;
                        *(_QWORD *)Alignment_low = 0LL;
                        v32 = (struct _SLIST_ENTRY *)(Alignment_low + 48);
                        goto LABEL_53;
                      }
                    }
                    ...
                    {
                      v31 = (union _SLIST_HEADER *)(*(_QWORD *)(*(_QWORD *)(**(_QWORD **)v28 + 24LL)
...
LABEL_54:
          ...
          if ( (*((_BYTE *)v15 + 38) & 3) != 0 )
          {
            v57[0] = (*((_QWORD *)v15 + 1) + 4151LL) & 0xFFFFFFFFFFFFF000uLL;
            v44 = sub_180102758(v15, Alignment_low, v24, v25);
            v45 = *(_QWORD *)(v35 + 24);
            v56 = 16 * v44 * (unsigned __int64)*((unsigned __int16 *)v15 + 20);
            v46 = sub_18002AE30(v45, 1);
            ZwProtectVirtualMemory(-1LL, v57, &v56, v46, &v63);
          }
          *(_DWORD *)(*((_QWORD *)v15 + 1) + 20LL) = 0;
          ...
          do
          {
            v37 = *(_QWORD *)(v34 + 160);
            LODWORD(v55) = v37 + v36;
            HIDWORD(v55) = HIDWORD(v37) - 1;
          }
          while ( v37 != _InterlockedCompareExchange64((volatile signed __int64 *)(v34 + 160), v55, v37) );
          *((_QWORD *)v15 + 1) = 0LL;
          ...
          {
            v47 = **(union _SLIST_HEADER ***)v15;
            *(_QWORD *)v15 = 0LL;
LABEL_84:
            v48 = (struct _SLIST_ENTRY *)(v15 + 12);
LABEL_85:
      ...
      while ( 1 )
      {
        ...
        if ( v53 )
        {
                                   ...
                                   (signed __int64)v53) )
          {
            ...
            {
              v47 = (union _SLIST_HEADER *)**v53;
              *v53 = 0LL;
              v48 = (struct _SLIST_ENTRY *)(v53 + 6);
              goto LABEL_85;
            }
LABEL_32:
            v5 = v58;
...
LABEL_8:
        ...
        {
          v47 = (union _SLIST_HEADER *)(*(_QWORD *)(*(_QWORD *)(**(_QWORD **)v15 + 24LL)
  ...
  do
  {
    ...
    if ( result )
    {
      do
      {
        ...
        v39 = 1LL << LOBYTE(v38->ImageBaseAddress);
        if ( v39 > 0xF0000 )
          v39 = 983040LL;
        v40 = v39 + WORD1(v38->ImageBaseAddress);
        v4 += v40;
        sub_180061A7C(*(_QWORD *)(a1 + 24), v38);
        ++v9;
        result = (struct _PEB *)RtlGetCurrentServiceSessionId();
        if ( (_DWORD)result )
        {
          result = NtCurrentPeb();
          v41 = (__int64)result->HotpatchInformation + 550;
        }
        else
        {
          v41 = 2147353472LL;
        ...
        if ( *(_BYTE *)v41 )
        {
          ...
          if ( (result->TracingFlags & 1) != 0 )
          {
            ...
            result = (struct _PEB *)sub_1800FE7E4(*(_QWORD *)(a1 + 24), v38, v40, 0LL);
          }
        }
      }
      while ( v11 );
      ...
      v8 = v61;
      if ( v9 )
        _InterlockedExchangeAdd((volatile signed __int32 *)&v59[1], -v9);
    }
    v7 += 3;
    --v8;
    v59 = v7;
