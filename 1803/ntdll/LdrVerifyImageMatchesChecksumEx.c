...
NTSTATUS __cdecl LdrVerifyImageMatchesChecksumEx(HANDLE ImageFileHandle, PLDR_VERIFY_IMAGE_INFO VerifyInfo)
{
  ...
  if ( (VerifyInfo->Flags & 2) == 0 )
    p_SectionInfo = (LDR_SECTION_INFO *)&unk_180116108;
  ...
  if ( result >= 0 )
  {
    ...
    else
    {
      ...
      if ( v8 < 0 )
        goto LABEL_28;
      if ( !(unsigned __int8)sub_1800EE06C(BaseAddress, ViewSize) )
        v8 = -1073741279;
      v9 = v17[0];
      if ( v8 < 0 )
        goto LABEL_28;
    ...
    if ( (VerifyInfo->Flags & 5) != 0 )
    {
      ...
      if ( v8 >= 0 )
      {
        ...
        {
          v10 = sub_18001014C((unsigned __int64)BaseAddress, v14, 1u, (DWORD *)&LastRvaSection, (char **)v17);
          v11 = v17[0];
          if ( v10 < 0 )
            v11 = 0LL;
          v17[0] = v11;
...
LABEL_29:
    if ( v8 < 0 || p_SectionInfo == (LDR_SECTION_INFO *)&unk_180116108 )
    {
