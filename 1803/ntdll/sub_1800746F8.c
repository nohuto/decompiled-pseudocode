/*
 * XREFs of sub_1800746F8 @ 0x1800746F8
 * Callers:
...
__int64 __fastcall sub_1800746F8(__int64 a1, unsigned int a2)
{
  __int64 v3; // rbp
  int v4; // edi
  __int64 v5; // r15
  ...
  v4 = qword_18015A580[0];
  if ( LODWORD(qword_18015A580[0]) <= 1 )
  {
    return (unsigned int)-1073741823;
  }
  else
  {
    ...
    else
    {
      ...
      v6 = v5;
      v7 = sub_18007488C(a1, 192 * v5, &v13);
      if ( v7 >= 0 )
      {
        v8 = v13;
        if ( (_DWORD)v5 )
