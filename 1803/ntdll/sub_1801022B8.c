...
__int64 __fastcall sub_1801022B8(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 result; // rax
  _BYTE v5[32]; // [rsp+30h] [rbp-38h] BYREF

  if ( (unsigned int)dword_180156650 > 5 )
    return sub_1800886A4((__int64)&dword_180156650, byte_180123C0B, a3, a4, 2, (__int64)v5);
  return result;
}
