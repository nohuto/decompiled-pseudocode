/*
 * XREFs of sub_1800C9228 @ 0x1800C9228
 * Callers:
 *     DbgUiConvertStateChangeStructure @ 0x1800C9210 (DbgUiConvertStateChangeStructure.c)
 *     DbgUiConvertStateChangeStructureEx @ 0x1800C9220 (DbgUiConvertStateChangeStructureEx.c)
 * Callees:
 *     ZwQueryInformationThread @ 0x18009AF60 (ZwQueryInformationThread.c)
 */

__int64 __fastcall sub_1800C9228(__int64 a1, __int64 a2, char a3)
{
  _DWORD *v4; // rax
  __int16 v5; // r8
  __int16 v6; // ax
