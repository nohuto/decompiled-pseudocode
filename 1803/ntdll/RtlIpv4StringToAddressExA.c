/*
 * XREFs of RtlIpv4StringToAddressExA @ 0x18007AB40
 * Callers:
 *     <none>
 * Callees:
 *     RtlIpv4StringToAddressA @ 0x18007ABD0 (RtlIpv4StringToAddressA.c)
 *     __isascii @ 0x18008B740 (__isascii.c)
 *     isdigit @ 0x18008B880 (isdigit.c)
 *     islower @ 0x18008B8E0 (islower.c)
 *     isxdigit @ 0x18008B9D0 (isxdigit.c)
 */
