...
unsigned __int64 __fastcall sub_18001A8A0(__int64 a1, unsigned __int64 a2, int a3)
{
  ...
  if ( (byte_18015D028 & 2) == 0 )
    return sub_180019140(a1, a2, a3, 0);
  if ( BYTE1(xmmword_18015A790) >= 2u )
    v7 = 2;
  else
    v7 = BYTE1(xmmword_18015A790);
  if ( *(_DWORD *)(a1 + 16) != -571548178 || a1 == *((_QWORD *)&unk_1801608C0 + 2 * v7) )
    goto LABEL_26;
  v21[0] = 0LL;
  v21[1] = 0LL;
...
LABEL_35:
    ...
    v16 = sub_180061D14(&qword_18015AA20, v21, v15);
    if ( v16 )
    {
