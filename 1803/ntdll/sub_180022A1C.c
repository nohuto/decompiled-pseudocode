...
__int64 __fastcall sub_180022A1C(_QWORD *a1, int a2, __int64 a3, _WORD *a4, unsigned __int64 a5, unsigned __int64 *a6)
{
  char *v9; // r15
  int v10; // r12d
  char *v11; // rbx
  ...
  if ( (unsigned __int64)(a3 - 1) <= 0x13 )
  {
    ...
    v11 = v9 - 48;
    v12 = 0;
    while ( v11 < &v9[16 * v10 - 48] )
    {
      if ( !(unsigned int)RtlCompareUnicodeStrings(*(_QWORD *)v11, a3, a2, a3, 1) )
      {
        v13 = (const void *)(*(_QWORD *)v11 + 2 * (a3 + 1));
        v14 = ((__int64)(*((_QWORD *)v11 + 1) - (_QWORD)v13) >> 1) - 1;
        if ( a4 )
        {
          if ( v14 < a5 )
          {
    ...
    {
      Environment = (void *)qword_18015CF80;
      if ( !qword_18015CF80 )
