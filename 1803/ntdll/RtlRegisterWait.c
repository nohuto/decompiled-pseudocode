/*
 * XREFs of RtlRegisterWait @ 0x180058640
 * Callers:
 *     <none>
 * Callees:
      ...
      *((_QWORD *)Heap + 6) = 0LL;
      ...
      if ( v8 >= 0 )
      {
        ...
        *((_DWORD *)v10 + 22) = 0;
        ...
        CallbackEnviron.FinalizationCallback = (PTP_SIMPLE_CALLBACK)sub_1800575F0;
        v8 = TpAllocWait(v11, sub_180076EF0, v10, &CallbackEnviron);
        v15 = v8;
        if ( v8 >= 0 )
        {
