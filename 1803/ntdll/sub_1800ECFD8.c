/*
 * XREFs of sub_1800ECFD8 @ 0x1800ECFD8
 * Callers:
 *     sub_180060B10 @ 0x180060B10 (sub_180060B10.c)
 *     sub_1800ECCC0 @ 0x1800ECCC0 (sub_1800ECCC0.c)
 * Callees:
 *     sub_180102720 @ 0x180102720 (sub_180102720.c)
 */

__int64 __fastcall sub_1800ECFD8(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  _QWORD *v4; // r8
