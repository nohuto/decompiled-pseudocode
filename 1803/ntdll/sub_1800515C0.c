        ...
        unsigned int *a9)
{
  ...
  if ( (*(_BYTE *)v11 & 1) != 0 )
  {
    ...
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v42 = 2147353476LL;
    sub_1800DBCC0(&v70, *(unsigned __int8 *)v42);
  }
  else
  {
    v12 = 2147353476LL;
  ...
  if ( (v10 & 0x10) == 0 )
  {
    ...
    if ( a5 >= 1 && a5 <= 3 )
    {
      if ( a5 == 3 )
        ...
        v36 = 0;
      if ( ((*v57 - 16LL) & 0xFFFFFFFFFFFFFFF7uLL) != 0 && !v48
        || (~(_BYTE)v10 & 8) == 0
        || (v36 & 0xF3FF) != 0
        || v36 == 3072 )
      {
        ...
        if ( RCConfig >= 0 )
        {
          v15 = v13 | sub_180033ADC(DllHandle, v57, v38, v10);
        }
        else
        {
...
LABEL_39:
  ...
  else
  {
    ...
    v15 = v34;
    v18 = DllHandle;
    result = sub_180053480((_DWORD)DllHandle, v56, v46, v34, (__int64)v75);
    ...
    if ( v58 && (~v15 & 0x40000) != 0 )
    {
      ...
      if ( v59 && v20 )
      {
        if ( v65 )
          ...
          LODWORD(v43) = v66;
        MappingSize = sub_180069E8C((_DWORD)ResourceDllBase, *v59, v43, *((_DWORD *)v57 + 6), 1);
        v47 = MappingSize;
        if ( MappingSize < 0 )
        {
          *v59 = 0LL;
...
LABEL_37:
      ...
      if ( v50 || v49 || (int)sub_180054094(DllHandle) < 0 )
      {
        if ( (v15 & 0x40000) != 0 )
        {
          v17 = 0;
...
LABEL_40:
  ...
  if ( (*(_BYTE *)v30 & 1) != 0 )
  {
    ...
    sub_1800DBCC0(&v73, *(unsigned __int8 *)v12);
  }
