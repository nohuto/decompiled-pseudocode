/*
 * XREFs of sub_1800F87CC @ 0x1800F87CC
 * Callers:
...
__int64 __fastcall sub_1800F87CC(__int64 *a1, __int16 *a2)
{
  unsigned int v2; // ebx
  __int64 v5; // r8
  __int16 v6; // r11
  ...
  while ( 1 )
  {
    ...
    if ( v10[1] >> 14 == (unsigned __int8)v7 && *v10 == v6 )
      break;
    if ( ++v9 >= v8 )
      goto LABEL_9;
  }
...
LABEL_9:
  ...
  v12 = 0;
  while ( ((v10[1] >> (2 * v12)) & 3) == (((unsigned __int16)a2[1] >> (2 * v12)) & 3) && v10[v12 + 3] == a2[v12 + 3] )
  {
    if ( ++v12 >= 3 )
      return v2;
  }
