...
__int64 __fastcall sub_180100000(_DWORD *Src, int a2, unsigned __int64 a3)
{
    ...
    else
    {
      ...
      if ( Src[31] )
      {
        ...
        *(_DWORD *)(v18 + 8) = v14;
        ...
        {
          sub_1800FC010((__int64)Src, v18);
          v13 = unk_18015A7E8;
        }
      }
      if ( (*(_BYTE *)(v18 + 10) & 2) != 0 )
        v15 = *(_WORD *)(sub_180063B6C(v18) + 2);
      else
      ...
      if ( !v15 || v15 != v13 || *((_WORD *)Src + 104) != word_18015A7EA )
        goto LABEL_33;
      if ( NtCurrentPeb()->Ldr )
        DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
      else
        DbgPrint("HEAP: ");
      v16 = sub_1800EC9CC((__int64)Src, v20);
      DbgPrint("About to free block at %p with tag %ws\n", a3, v16);
    }
    sub_1801011EC(v12, v11);
LABEL_33:
