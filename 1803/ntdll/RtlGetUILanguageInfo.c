...
LABEL_32:
      ...
      *(_DWORD *)&String.Length = 11141120;
      ...
      if ( (int)sub_1800E81C8(&DestinationString, &Lcid) < 0 || !RtlLCIDToCultureName(Lcid, &String) )
      {
        v13 = v31;
        v14 = -1073741811;
        goto LABEL_53;
      ...
      v13 = v31;
      v17 = sub_1800362CC((__int64)v31, Lcid, 1, &v27);
    }
    else
    {
      ...
      v17 = sub_1800352EC((__int64)v13, v8, 1, &v27);
    }
    v14 = v17;
    if ( v17 < 0 )
    {
        ...
        while ( !(_BYTE)v22 )
        {
          if ( v23 )
          {
            ...
            if ( RtlUnicodeStringToInteger(&DestinationString, 0x10u, &Lcid) < 0 )
              break;
            LOBYTE(v24) = 1;
            v25 = sub_1800F8FB0((_DWORD)v13, (unsigned int)&v39, (unsigned __int16)Lcid, v24, (__int64)&v39);
          }
          else
          {
            LOBYTE(v18) = 1;
      ...
      *NumberOfFallbackLanguages = v9;
      if ( (_BYTE)v22 )
        *NumberOfFallbackLanguages = 2;
        ...
        v14 = sub_1800F92E8(v33, (_DWORD)v13, (unsigned int)&v39, (_DWORD)NumberOfFallbackLanguages, (__int64)v7);
LABEL_54:
      if ( BaseAddress )
      {
