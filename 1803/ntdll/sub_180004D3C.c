/*
 * XREFs of sub_180004D3C @ 0x180004D3C
 * Callers:
...
char *__fastcall sub_180004D3C(__int64 a1, int a2, unsigned int a3, __int64 a4, unsigned int a5)
{
  ...
  *((_QWORD *)Heap + 67) = v13;
  if ( v13 )
  {
    if ( a4 )
    {
      if ( (unsigned int)sub_180003CC0((__int64)Heap, v10, a4, v5) )
        goto LABEL_44;
      v23 = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, 8u, 12 * (unsigned int)v10);
      *((_QWORD *)Heap + 64) = v23;
      if ( !v23 )
        goto LABEL_44;
    }
      ...
      if ( a3 )
      {
        ...
        do
        {
          *(_WORD *)(v15 + *((_QWORD *)Heap + 67)) = 0;
          v15 += 4LL;
          *(_WORD *)(v15 + *((_QWORD *)Heap + 67) - 2) = v14++;
        }
        while ( v14 < a3 );
      }
    }
    ...
    *((_DWORD *)Heap + 52) = v17;
    if ( RtlCreateUnicodeString((PUNICODE_STRING)(Heap + 152), *(PCWSTR *)(a1 + 152))
      && !(unsigned int)sub_180005150(a1, *(unsigned int *)(a1 + 96), &v30) )
    {
