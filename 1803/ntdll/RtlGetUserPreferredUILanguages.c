/*
 * XREFs of RtlGetUserPreferredUILanguages @ 0x180079D40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlGetUserPreferredUILanguages(int a1, const WCHAR *a2, _DWORD *a3, _DWORD *a4, unsigned int *a5)
{
  ...
  unsigned __int64 v39; // [rsp+70h] [rbp-9h] BYREF
...
LABEL_44:
  ...
  if ( (int)result >= 0 )
  {
    if ( a2 && (int)sub_1800352EC((__int64)v42, a2, 1, &v35) < 0 )
    {
      SystemPreferredUILanguages = -1073741772;
      goto LABEL_44;
    }
    sub_18003185C(v11 & 1, (__int64)v42);
    ...
    if ( (v11 & 0x800) != 0 )
    {
      if ( !v16
        || ((*a5 = v37,
             SystemPreferredUILanguages = sub_1800359B0(v16, (__int64)v18, v6, a5, v11, v12, &v36),
...
LABEL_40:
    ...
    v20 = sub_180032B9C(&v38, (__int64)v42, 0x19u, 0);
    ...
    if ( (v11 & 0x8080) != 0 )
    {
      if ( v20 >= 0 )
      {
        if ( !v38 )
          goto LABEL_33;
        SystemPreferredUILanguages = sub_18003545C(
                                       v11 | 0x30u,
                                       (__int64)v18,
                                       (__int64)&v38,
                                       0LL,
        ...
        if ( SystemPreferredUILanguages >= 0 )
        {
          v22 = v38;
          *a5 = v37;
          v23 = sub_1800359B0(v22, (__int64)v18, v6, a5, v11, v12, &v36);
    ...
    else if ( v20 >= 0 )
    {
      if ( !v38 )
        goto LABEL_33;
      SystemPreferredUILanguages = sub_18003545C(v11 | 0x20u, (__int64)v18, (__int64)&v38, 0LL, 0LL, v44, 0LL, v43, 0);
      if ( SystemPreferredUILanguages >= 0 )
      {
        SystemPreferredUILanguages = sub_180032B9C((__int64 *)&v39, (__int64)v18, 0x19u, 0);
        if ( SystemPreferredUILanguages >= 0 )
        {
          v22 = v38;
          if ( !v39 )
...
LABEL_29:
            ...
            if ( v35 != -1 )
            {
              ...
              if ( v24 )
              {
                ...
                if ( *(_BYTE *)(v39 + 8) )
                  ...
                  LODWORD(v25) = v43;
                sub_1800E78E0((unsigned int)&v39, (_DWORD)v24, (_DWORD)v18, v25, v33);
              }
            }
          }
          else
                ...
                if ( *(_WORD *)(v28 + 6LL * v26) == 2 )
                {
                  ...
                  if ( (*v29 & 6) != 0 )
                  {
                    if ( *(_BYTE *)(v39 + 8) )
                      ...
                      LODWORD(v30) = v27;
                    v31 = sub_1800E78E0((unsigned int)&v39, (_DWORD)v29, (_DWORD)v18, v30, v33);
                    v26 = v46;
          ...
          v32 = sub_1800359B0(v39, (__int64)v18, v6, v5, v11, v12, &v36);
LABEL_92:
