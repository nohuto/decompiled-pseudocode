...
LABEL_44:
  ...
  if ( result >= 0 )
  {
    if ( LocaleName && (int)sub_1800352EC((__int64)v42, LocaleName, 1, &v35) < 0 )
    {
      SystemPreferredUILanguages = -1073741772;
      goto LABEL_44;
    }
    ...
    if ( (v11 & 0x800) != 0 )
    {
      if ( !v16
        || ((*ReturnLength = v37,
             SystemPreferredUILanguages = sub_1800359B0(
                                            v16,
                                            (__int64)v18,
                                            v6,
                                            ReturnLength,
...
LABEL_40:
    ...
    v20 = sub_180032B9C((__int64 *)&BaseAddress, (__int64)v42, 0x19u, 0);
    ...
    if ( (v11 & 0x8080) != 0 )
    {
      if ( v20 >= 0 )
      {
        ...
        if ( SystemPreferredUILanguages >= 0 )
        {
          v22 = BaseAddress;
          *ReturnLength = v37;
          v23 = sub_1800359B0((__int64)v22, (__int64)v18, v6, ReturnLength, v11, v12, (int *)&NumberOfLanguagesa);
...
LABEL_29:
          ...
          v32 = sub_1800359B0((__int64)v39, (__int64)v18, v6, v5, v11, v12, (int *)&NumberOfLanguagesa);
LABEL_92:
