/*
 * XREFs of sub_180073CD4 @ 0x180073CD4
 * Callers:
...
__int64 __fastcall sub_180073CD4(_QWORD *a1)
{
  int v2; // ebx
  struct _PEB *v3; // rax
  _WORD *v4; // rdx
  ...
  {
    v3 = NtCurrentPeb();
    if ( a1 != (_QWORD *)qword_18015BF88 || !v3->ActivationContextData )
    {
      v4 = (_WORD *)a1[10];
      if ( a1 == (_QWORD *)qword_18015BF88
        && *v4 == 92
        && v4[1] == 63
        && v4[2] == 63
        && v4[3] == 92
      ...
      v5 = ((__int64 (__fastcall *)(_QWORD, _WORD *, __int64 *))qword_18015CFA0)(a1[6], v4, &v9);
      v2 = v5;
