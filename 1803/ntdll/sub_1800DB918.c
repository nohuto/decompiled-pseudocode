/*
 * XREFs of sub_1800DB918 @ 0x1800DB918
 * Callers:
...
char __fastcall sub_1800DB918(unsigned int a1, unsigned __int64 a2, _QWORD *a3, _QWORD *a4)
{
  ...
  if ( !a3 )
    return 0;
  if ( a1 >= dword_18015B2A0 )
    return 0;
  _mm_lfence();
  v7 = (unsigned __int64)a1 << 6;
  v8 = *(_QWORD *)((char *)BaseAddress + v7 + 32);
  v9 = *(_QWORD *)((char *)BaseAddress + v7 + 48);
