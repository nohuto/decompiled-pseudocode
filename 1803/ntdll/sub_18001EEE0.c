/*
 * XREFs of sub_18001EEE0 @ 0x18001EEE0
 * Callers:
...
__int64 __fastcall sub_18001EEE0(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
...
LABEL_16:
    if ( v12 == (_DWORD)v11 )
      goto LABEL_20;
    if ( (_DWORD)v11 == _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 8), v12, v11) )
      break;
    v7 = 0;
  }
  if ( !(_BYTE)a3 )
