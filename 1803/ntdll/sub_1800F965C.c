/*
 * XREFs of sub_1800F965C @ 0x1800F965C
 * Callers:
 ...
 * Callees:
 *     sub_1800F952C @ 0x1800F952C (sub_1800F952C.c)
 *     sub_1800FA0C8 @ 0x1800FA0C8 (sub_1800FA0C8.c)
 */

__int64 __fastcall sub_1800F965C(__int64 *a1, __int64 a2, __int16 *a3)
{
  __int64 v6; // rbx
  __int16 v7; // ax
  __int16 v8; // r8
  ...
  if ( v7 < 0 )
  {
    ...
    if ( *(_WORD *)(v6 + 6) >= v9 )
    {
      ...
      if ( (unsigned int)v10 >= v9 )
        v6 = sub_1800FA0C8(v6, v10, (unsigned __int16)v7);
      if ( !v6 )
        return 3221225495LL;
      *a1 = v6;
    }
