...
__int64 __fastcall sub_1800DE990(PCWSTR DosFileName)
{
  __int64 v2; // r14
  __int64 v3; // rcx
  __int64 v4; // rsi
  ...
  if ( (*(_BYTE *)v3 & 1) != 0 )
  {
    ...
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v5 = 2147353476LL;
    sub_1800DBCC0((unsigned __int16 *)&v10, *(unsigned __int8 *)v5);
  }
  else
  {
    v4 = 2147353476LL;
  ...
  if ( (*(_BYTE *)v2 & 1) != 0 )
  {
    ...
    sub_1800DBCC0((unsigned __int16 *)&v12, *(unsigned __int8 *)v4);
  }
