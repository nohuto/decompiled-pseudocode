/*
 * XREFs of sub_180001F34 @ 0x180001F34
 * Callers:
 *     RtlIsNormalizedString @ 0x180001EB0 (RtlIsNormalizedString.c)
 * Callees:
 *     sub_1800F5214 @ 0x1800F5214 (sub_1800F5214.c)
 ...
 *     sub_1800F5D68 @ 0x1800F5D68 (sub_1800F5D68.c)
 */

__int64 __fastcall sub_180001F34(__int64 a1, unsigned __int16 *a2, int a3, _BYTE *a4)
{
...
LABEL_48:
            if ( (v16 & 0x80) != 0 )
            {
              sub_1800F5D68(a1, (_DWORD)v5, (unsigned int)&v33, (unsigned int)&v29, (__int64)&v25, (__int64)&v34);
              v19 = v25;
              if ( !v25 || v25 == 63 )
              {
                v31 = v29;
                ...
                if ( ((v34 - 64) & 0xBF) != 0 || v17 != 0xC0 )
                  goto LABEL_95;
                v22 = sub_1800F5AD0(a1, v29, (unsigned int)v7);
                goto LABEL_88;
              }
              v17 = v34;
              if ( (v34 & 0xBF) != 0 )
              {
                ...
                if ( ((((v26 | v27) - 64) & 0xBF) == 0 || v27 == 64 && (!v26 || v26 == 63))
                  && (unsigned int)sub_1800F5AD0(a1, v31, (unsigned int)v7) )
                {
                  goto LABEL_89;
                }
                ...
                {
LABEL_69:
                  v22 = sub_1800F5C7C(a1, (unsigned int)&v32, (unsigned int)&v30, v31, v7);
                  goto LABEL_88;
                }
                v22 = sub_1800F5C38(a1, &v30, v31, (unsigned int)v7);
LABEL_88:
                if ( v22 )
                  goto LABEL_89;
                goto LABEL_95;
              ...
              if ( v34 == 64 )
              {
                if ( (unsigned int)sub_1800F5AD0(a1, v29, (unsigned int)v7) )
                  goto LABEL_89;
                v23 = v31;
              }
              if ( v19 <= v18 )
...
LABEL_98:
              ...
              {
LABEL_79:
                v24 = sub_1800F5C7C(a1, (unsigned int)&v32, (unsigned int)&v30, v23, v7);
                goto LABEL_83;
              }
              v24 = sub_1800F5C38(a1, &v30, v23, (unsigned int)v7);
LABEL_83:
              if ( v24 )
                goto LABEL_89;
              goto LABEL_84;
...
LABEL_93:
          ...
          if ( v16 != 127 )
          {
            switch ( v16 )
            {
              ...
              case 0xC0u:
                sub_1800F5D68(a1, (_DWORD)v5, (unsigned int)&v33, (unsigned int)&v29, (__int64)&v25, (__int64)&v34);
                if ( (v25 | v34) == 0x80 && (unsigned int)sub_1800F5AD0(a1, v29, (unsigned int)v7) )
                  goto LABEL_89;
                goto LABEL_93;
              case 0xFFu:
                if ( (_DWORD)v7 || a3 > 1 )
...
LABEL_97:
      ...
      if ( a3 > 1 )
      {
        if ( (unsigned __int8)sub_1800F5214((unsigned int)v7, v5[1]) )
          goto LABEL_89;
        a3 = v35;
      }
