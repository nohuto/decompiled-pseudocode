...
__int64 __fastcall sub_1800ED18C(int a1, unsigned int a2)
{
  struct _PEB *v2; // r15
  __int64 v4; // r14
  __int64 v5; // rbp
    ...
    do
    {
      ...
      if ( *(_DWORD *)(v6 + 16) == -571548178 )
      {
        if ( (*(_BYTE *)(v6 + 20) & 1) == 0 )
        {
          ...
          RtlReleaseSRWLockExclusive((volatile signed __int64 *)(v6 + 360));
          sub_180048F40(v6, a1);
        }
      }
  ...
  if ( a1 )
  {
    ...
    qword_18015D860 = -1LL;
    qword_18015AAD0 = (__int64)UniqueThread;
    dword_18015AAC8 = -2;
    dword_18015AACC = 1;
    qword_18015AAD8 = 0LL;
    qword_18015D858 = 1LL;
  ...
  return RtlLeaveCriticalSection((__int64)&unk_18015AAC0);
}
