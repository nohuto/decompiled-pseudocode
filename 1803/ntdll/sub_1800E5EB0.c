/*
 * XREFs of sub_1800E5EB0 @ 0x1800E5EB0
 * Callers:
...
__int64 __fastcall sub_1800E5EB0(_QWORD *a1, unsigned __int64 a2)
{
  __int64 v2; // r8
  unsigned int *v3; // r9
  __int64 v4; // r10
...
LABEL_13:
    if ( v4 )
    {
      if ( v7 )
        LODWORD(v9) = v3[1];
      v14 = -1;
      v10 = !_BitScanForward64(&v9, (unsigned int)v9 | ~dword_180119840[v4]);
      if ( !v10 )
        v14 = v9;
      v7 += (unsigned int)v14;
    }
