/*
 * XREFs of sub_180103534 @ 0x180103534
 * Callers:
...
__int64 __fastcall sub_180103534(
        unsigned __int64 a1,
        unsigned int a2,
        _BYTE *a3,
        unsigned int a4,
        ...
        unsigned __int8 *a6)
{
  ...
  _BYTE *v60; // [rsp+48h] [rbp-70h]
  unsigned __int8 *v61; // [rsp+50h] [rbp-68h]
  _BYTE *v62; // [rsp+58h] [rbp-60h]
...
LABEL_5:
    ...
    do
    {
      v23 = (unsigned __int16)word_1801302D0[*v21] ^ (unsigned __int16)word_1801306D0[v21[2]] ^ (unsigned __int64)(unsigned __int16)word_1801304D0[v21[1]];
      v24 = *(_QWORD *)&a6[8 * v23];
      *(_QWORD *)&a6[8 * v23] = v21++;
...
LABEL_87:
          ...
          *v11 = 2 * v17 + 1;
          ...
          if ( &v13[4 * ((unsigned __int64)(sub_180064DE8((_QWORD *)a6 + 163840) + v57 + 31) >> 5) + 258 + v58] >= v62 )
            return 3221225507LL;
          v11 = (int *)(a6 + 1342240);
          v7 = v59;
          v13 = sub_180064B00((__int64)(a6 + 1310720), a6 + 1342240, (unsigned __int64)v15, (__int64)v13, v55);
          v60 = v13;
          v56 = v55 == 0;
          v8 = a2;
          if ( !v56 )
...
LABEL_65:
      ...
      if ( v31 == 3 && v43 > 0x1000 )
        break;
      if ( v43 < 0x100 )
        v45 = byte_180119CE0[v43];
      else
        v45 = (unsigned int)byte_180119CE0[v43 >> 8] + 8;
      v57 += v45;
      v46 = v15 + 1;
      v47 = v43 - (1LL << v45);
      v48 = 16 * v45;
