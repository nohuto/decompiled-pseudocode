 ...
 * Callers:
 *     RtlGetLengthWithoutLastFullDosOrNtPathElement @ 0x18006CAE0 (RtlGetLengthWithoutLastFullDosOrNtPathElement.c)
 * Callees:
 *     sub_18006CBE8 @ 0x18006CBE8 (sub_18006CBE8.c)
 */

__int64 __fastcall sub_18006CAEC(__int64 a1, __int64 a2, unsigned __int16 *a3, int *a4)
{
  __int64 result; // rax
  int v7; // ebx
  __int64 v8; // rdx
  ...
  if ( !v7 )
    return result;
  result = sub_18006CBE8(a1, a3, &v13, &v14);
  if ( (int)result < 0 )
    return result;
