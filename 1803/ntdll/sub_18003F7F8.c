...
__int64 sub_18003F7F8()
{
  ...
  v23 = 0LL;
  LdrGetDllHandleByName(&unk_180110020, 0LL, &v23);
  v0 = sub_18001014C((unsigned __int64)v23, 1, 0xDu, &v22, &v24);
  v1 = v24;
  if ( v0 < 0 )
    v1 = 0LL;
  v24 = v1;
    ...
    do
    {
      ...
      if ( !strnicmp(v8, "EXT-", 4uLL) )
      {
        ...
        if ( v9 > UnicodeString.MaximumLength )
        {
          ...
          UnicodeString.Buffer = (wchar_t *)sub_18003B5E0(v9);
        ...
        {
          v14 = sub_180023294(v23, v6 + 32LL * v5);
          Buffer = UnicodeString.Buffer;
          v3 = v14;
          if ( v14 < 0 )
            break;
