/*
 * XREFs of tan @ 0x180090650
 * Callers:
 *     <none>
 * Callees:
 *     sub_180090918 @ 0x180090918 (sub_180090918.c)
...
double __cdecl tan(double X)
{
  ...
  if ( (v1 & 0xFFFFFFFFFFFFFLL) != 0 )
    sub_180092F8C((unsigned int)"tan", 32, v1, 1, 0, 33, *(__int64 *)&v3, 0LL, 1);
  else
    sub_180092F8C((unsigned int)"tan", 32, 0, 1, 8, 33, *(__int64 *)&v3, 0LL, 1);
  return X;
}
