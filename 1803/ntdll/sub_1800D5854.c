/*
 * XREFs of sub_1800D5854 @ 0x1800D5854
 * Callers:
...
__int64 __fastcall sub_1800D5854(__int64 a1)
{
  __int64 result; // rax
  __int64 *v3; // rbx
  __int64 v4; // rax
  ...
  __int64 v20; // [rsp+168h] [rbp+20h]

  if ( !byte_18016F298 )
    return 3221225506LL;
  memset(v17, 0, 0xC0uLL);
  v17[7] = a1;
  result = sub_18002B540((__int64)v17);
  if ( (int)result >= 0 )
  {
    v3 = (__int64 *)v17[13];
    if ( v17[13] )
