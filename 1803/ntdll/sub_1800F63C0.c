...
void __fastcall sub_1800F63C0(__int64 a1, _OWORD *a2)
{
  ...
  if ( qword_18015D448 )
  {
    v4 = dword_18015AA58;
    v7 = dword_18015AA58;
    v6 = _InterlockedCompareExchange(&dword_18015AA58, (dword_18015AA58 + 1) % 0x32u, dword_18015AA58);
    for ( i = v7 == v6; ; i = v6 == v8 )
    {
      v8 = v6;
      if ( i )
        break;
      v4 = v6;
      v6 = _InterlockedCompareExchange(&dword_18015AA58, (v6 + 1) % 0x32u, v6);
    }
    v9 = 1424LL * v4;
    i = qword_18015D448 + v9 == 0;
    v10 = qword_18015D448 + v9;
