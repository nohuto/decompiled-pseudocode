...
__int64 __fastcall sub_18009038C(
        __int64 a1,
        unsigned __int8 *a2,
        unsigned __int8 **a3,
        unsigned int a4,
        ...
        int a6)
{
  ...
  v11 = a2 + 1;
  v12 = 0;
  while ( (*(_BYTE *)(sub_1800913FC() + 2 * v10) & 8) != 0 )
    v10 = *v11++;
  v13 = a5;
  if ( (_BYTE)v10 == 45 )
  {
...
LABEL_29:
  ...
  while ( 1 )
  {
    if ( (*(_BYTE *)(sub_1800913FC() + 2LL * (unsigned __int8)v10) & 4) != 0 )
    {
      v15 = (char)v10 - 48;
    }
    else
    {
      if ( (*(_WORD *)(sub_1800913FC() + 2LL * (unsigned __int8)v10) & 0x103) == 0 )
        break;
      v16 = (char)v10 - 32;
