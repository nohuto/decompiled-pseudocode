/*
 * XREFs of sub_180048564 @ 0x180048564
 * Callers:
...
__int64 __fastcall sub_180048564(
        __int64 a1,
        __int64 a2,
        ...
        signed __int32 *a5)
{
  ...
  if ( !a1 || *(_DWORD *)(a1 + 72) )
  {
    sub_1801086C8(a1, a2, (unsigned int)a2, a4);
    return 3221225485LL;
  }
  v8 = *(_QWORD *)(a1 + 184);
  if ( v8 )
  ...
  if ( !v9 )
    return 3221225485LL;
  if ( (volatile signed __int32 *)qword_18015D3A8 == v9 )
    return 3221225659LL;
  ...
  do
  {
    LODWORD(v16) = v12 ^ (unsigned __int16)(v12 ^ (v12 + 1));
    v13 = v12;
