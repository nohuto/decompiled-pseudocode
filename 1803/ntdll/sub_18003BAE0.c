...
__int64 __fastcall sub_18003BAE0(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _BYTE *a5)
{
  struct _PEB *v5; // r13
  _BYTE *v7; // r12
  __int64 v9; // rbp
  ...
  *a5 = 0;
  ...
  v12 = sub_18003BCF0((_DWORD)ApiSetMap, v9, a1 != 0 ? a1 + 88 : 0, (unsigned int)&v22, (__int64)v20);
  v13 = v20[0];
  v14 = v12;
  v15 = v22;
  if ( v12 >= 0 && (_BYTE)v22 )
