/*
 * XREFs of sub_180055C44 @ 0x180055C44
 * Callers:
...
LABEL_10:
  ...
  while ( 1 )
  {
    ...
    if ( (v6[3] & 1) == 0 )
    {
      ...
      {
        v12 = 0;
        v13 = sub_180054D18(v7, (__int64)&v13, &v12);
        v2 = v13;
        if ( (v13 & 0x80000000) != 0 )
          goto LABEL_18;
        goto LABEL_16;
...
LABEL_16:
  ...
  v13 = -1073741502;
LABEL_18:
  result = (__int64 *)qword_18015C370;
