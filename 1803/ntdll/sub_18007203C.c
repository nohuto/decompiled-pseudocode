...
__int64 __fastcall sub_18007203C(__int64 a1, unsigned __int64 a2, unsigned __int64 *a3, __int64 a4, int a5)
{
  ...
  v7 = (unsigned int)a4;
  _BitScanReverse64(&v8, (unsigned __int64)a3);
  LODWORD(v8) = v8 - v5;
  ...
  if ( a5 )
  {
    v16 = ((__int64 (__fastcall *)(__int64, unsigned __int64, _QWORD))(a1 ^ qword_18015A440 ^ *(_QWORD *)(a1 + 88)))(
            v13,
            v10,
            v11);
    if ( v16 < 0 )
