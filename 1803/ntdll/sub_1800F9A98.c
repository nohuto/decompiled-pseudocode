...
__int64 __fastcall sub_1800F9A98(__int64 a1)
{
  ...
  if ( (int)sub_1800F81DC(L"WindowsExcludedProcs", (__int64)&v37, (unsigned int *)&Size, (unsigned __int64 *)&Src) >= 0 )
  {
    v29 = 1;
    if ( Src )
  ...
  if ( (int)sub_1800F81DC(L"Kernel-MUI-Number-Allowed", (__int64)&v37, (unsigned int *)&Size, (unsigned __int64 *)&Src) >= 0 )
  {
    v30 = *(_DWORD *)Src;
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (unsigned __int64)Src);
    Src = 0LL;
  }
  if ( (int)sub_1800F81DC(
...
LABEL_67:
    ...
    if ( (int)sub_1800F81DC(L"Kernel-MUI-Language-SKU", (__int64)&v37, (unsigned int *)&Size, (unsigned __int64 *)&Src) >= 0 )
    {
      v19 = Size;
      v28 = Size + 4;
      if ( (_DWORD)Size == -4 )
