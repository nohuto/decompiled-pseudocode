/*
 * XREFs of sub_1800F9A98 @ 0x1800F9A98
 * Callers:
 ...
 *     wcspbrk @ 0x180090E50 (wcspbrk.c)
 *     memmove @ 0x1800A1380 (memmove.c)
 *     sub_1800F81DC @ 0x1800F81DC (sub_1800F81DC.c)
 */

__int64 __fastcall sub_1800F9A98(__int64 a1)
{
  int v1; // r14d
  PVOID v3; // r13
  PVOID Heap; // r12
  ...
  if ( (int)sub_1800F81DC(L"WindowsExcludedProcs", &Type, (PULONG)&Size, &BaseAddress) >= 0 )
  {
    v29 = 1;
    if ( BaseAddress )
  ...
  if ( (int)sub_1800F81DC(L"Kernel-MUI-Number-Allowed", &Type, (PULONG)&Size, &BaseAddress) >= 0 )
  {
    v30 = *(_DWORD *)BaseAddress;
    RtlFreeHeap(NtCurrentPeb()->ProcessHeap, 0, BaseAddress);
    BaseAddress = 0LL;
  }
  if ( (int)sub_1800F81DC(L"Kernel-MUI-Language-Allowed", &Type, (PULONG)&Size, &BaseAddress) < 0 )
  {
LABEL_27:
    if ( (int)sub_1800F81DC(L"Kernel-MUI-Language-Disallowed", &Type, (PULONG)&Size, &BaseAddress) >= 0 )
    {
      v13 = Size;
      v27 = Size + 4;
      if ( (_DWORD)Size == -4 )
...
LABEL_67:
    ...
    if ( (int)sub_1800F81DC(L"Kernel-MUI-Language-SKU", &Type, (PULONG)&Size, &BaseAddress) >= 0 )
    {
      v19 = Size;
      v28 = Size + 4;
      if ( (_DWORD)Size == -4 )
