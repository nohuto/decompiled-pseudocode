/*
 * XREFs of sub_18009EB90 @ 0x18009EB90
 * Callers:
...
__int64 __fastcall sub_18009EB90(__int64 a1, __int64 a2)
{
  __int64 v2; // rax
  int v3; // r8d
  __int64 result; // rax
  ...
  if ( (*((_QWORD *)&xmmword_18016F370 + 1) & 0x1000LL) == 0 && (*(_DWORD *)(a1 + 48) & 0xFFFFFFBF) == 0x10000F )
  {
