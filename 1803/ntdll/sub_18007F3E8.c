/*
 * XREFs of sub_18007F3E8 @ 0x18007F3E8
 * Callers:
 *     RtlAddSIDToBoundaryDescriptor @ 0x18007F3E0 (RtlAddSIDToBoundaryDescriptor.c)
 *     RtlAddIntegrityLabelToBoundaryDescriptor @ 0x1800E4970 (RtlAddIntegrityLabelToBoundaryDescriptor.c)
 * Callees:
...
__int64 __fastcall sub_18007F3E8(__int64 a1, unsigned __int8 *a2, char a3)
{
  _DWORD *v6; // rsi
  unsigned int v7; // edi
  unsigned int v8; // ecx
