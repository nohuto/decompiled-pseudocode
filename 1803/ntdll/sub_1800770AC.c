...
__int64 __fastcall sub_1800770AC(__int128 *a1, unsigned __int16 a2, __int64 a3, UNICODE_STRING *a4, __int64 a5)
{
        ...
        if ( ActivationContextSectionString >= 0 )
        {
          if ( HIDWORD(v26[0]) == 1 )
          {
            ...
            if ( ActivationContextSectionString >= 0 )
            {
              ...
              {
                v15 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64 *))qword_18015CF98)(v11, a2, &v20);
