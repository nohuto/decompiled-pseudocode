/*
 * XREFs of RtlEnterCriticalSection @ 0x18001EE90
 * Callers:
 ...
 *     RtlAcquirePebLock @ 0x18007B480 (RtlAcquirePebLock.c)
 ...
 *     RtlTraceDatabaseLock @ 0x1800F7C10 (RtlTraceDatabaseLock.c)
