/*
 * XREFs of RtlValidRelativeSecurityDescriptor @ 0x180076560
 * Callers:
 *     <none>
 * Callees:
        ...
        SECURITY_INFORMATION RequiredInformation)
{
  ...
  if ( (_DWORD)v6 )
  {
    if ( !(unsigned __int8)sub_1800766BC(v6, SecurityDescriptorLength, 12LL, &v20) )
      return 0;
  ...
  if ( (_DWORD)v10 )
  {
    if ( !(unsigned __int8)sub_1800766BC(v10, SecurityDescriptorLength, v7, &v20) )
      return 0;
  ...
  if ( (*((_BYTE *)SecurityDescriptorInput + 2) & 4) == 0
    ...
    || (unsigned __int8)sub_1800766BC(v13, SecurityDescriptorLength, 8LL, &v20)
    ...
    && RtlValidAcl(v15) )
  {
    ...
    if ( !(_DWORD)v17 )
      return 1;
    if ( (unsigned __int8)sub_1800766BC(v17, SecurityDescriptorLength, 8LL, &v20) )
    {
