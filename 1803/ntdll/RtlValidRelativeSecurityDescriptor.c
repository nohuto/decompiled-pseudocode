...
char __fastcall RtlValidRelativeSecurityDescriptor(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( (_DWORD)v6 )
  {
    if ( !(unsigned __int8)sub_1800766BC(v6, a2, 12LL, &v20) )
      return 0;
    if ( *(_BYTE *)(a1 + v8) != 1 )
      return 0;
    v9 = *(_BYTE *)(a1 + v8 + 1);
  ...
  if ( (_DWORD)v10 )
  {
    if ( !(unsigned __int8)sub_1800766BC(v10, v4, v7, &v20) )
      return 0;
    if ( *(_BYTE *)(a1 + v11) != 1 )
      return 0;
    v12 = *(_BYTE *)(a1 + v11 + 1);
  ...
  if ( (*(_BYTE *)(a1 + 2) & 4) == 0
    ...
    || (unsigned __int8)sub_1800766BC(v13, v4, 8LL, &v20)
    ...
    && RtlValidAcl(v15) )
  {
    ...
    if ( !(_DWORD)v17 )
      return 1;
    if ( (unsigned __int8)sub_1800766BC(v17, v4, 8LL, &v20) )
    {
      v19 = a1 + v18;
