/*
 * XREFs of LdrResGetRCConfig @ 0x1800539B0
 * Callers:
 ...
 *     sub_180053F4C @ 0x180053F4C (sub_180053F4C.c)
...
__int64 __fastcall LdrResGetRCConfig(void *a1, __int64 a2, _QWORD *a3, int a4, char a5)
{
  ...
  if ( (*(_BYTE *)v9 & 1) != 0 )
  {
    ...
    if ( RtlGetCurrentServiceSessionId() )
      ...
      v39 = 2147353476LL;
    sub_1800DBCC0(&v46, *(unsigned __int8 *)v39);
  }
  else
  {
    v10 = 2147353476LL;
...
LABEL_16:
    ...
    v16 = sub_1800515C0(DllHandle, v43, (v7 != 0 ? 8240 : 4144) | 0x200000u, (__int64)v50, 3, &v41, v45, 0LL, 0LL);
    if ( v16 < 0 )
    {
      if ( v16 != -1073741701 )
        v16 = -1073741686;
...
LABEL_22:
        if ( a5 )
        {
          ...
          if ( v17 )
            v18 = (__int64)v17;
          sub_18002B698(v15, 0LL, 0LL, v18, 0, 2, v13, 0LL);
        }
        goto LABEL_10;
      }
      v13 = -1073020925;
      ...
      if ( (_DWORD)v36 )
      {
        if ( !(unsigned __int8)sub_180053F4C(v36, 7LL, v41) )
          goto LABEL_21;
      }
      if ( !(unsigned __int8)sub_180053F4C(v17[4] & 0xFFFFFFCF, 3LL, v17) )
        goto LABEL_21;
      if ( !(unsigned __int8)sub_180053F4C(*(_DWORD *)(v37 + 16) & 0xFFFFFFFC, 48LL, v37) )
        goto LABEL_21;
      if ( (v17[4] & 1) != 0 )
      {
        if ( !(unsigned __int8)sub_180053F4C((unsigned int)v17[6], 3LL, v17) )
          goto LABEL_21;
        v38 = (unsigned int)v17[5];
        if ( (_DWORD)v38 )
        {
          if ( !(unsigned __int8)sub_180053F4C(v38, 256LL, v17) )
            goto LABEL_21;
        }
      }
    }
  ...
  v12 = sub_1800107D4((unsigned __int64)DllHandle, 0, 0LL, 8);
  v41 = v12;
  if ( v12 != (_DWORD *)-1LL )
  {
    if ( v12 )
...
LABEL_10:
  ...
  if ( (*(_BYTE *)v8 & 1) != 0 )
  {
    ...
    sub_1800DBCC0(&v48, *(unsigned __int8 *)v10);
  }
  return v13;
}
