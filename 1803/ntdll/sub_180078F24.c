/*
 * XREFs of sub_180078F24 @ 0x180078F24
 * Callers:
...
__int64 __fastcall sub_180078F24(__int64 a1, __int64 a2, _DWORD *a3)
{
  unsigned int v3; // ebx
  __int64 v6; // rax
  unsigned int v7; // r8d
  ...
  {
    DbgPrintEx(51, 0, (int)"SXS: %s() found activation context data at %p with wrong format\n", "RtlpQueryRunLevel", a2);
    return (unsigned int)-1072365565;
  }
  *a3 = 0;
