  ...
  *(_QWORD *)&v19.Length = 0LL;
  ...
  if ( Heap )
  {
    ...
    *(_DWORD *)(Heap + 44) = *(_DWORD *)(a2 + 36);
    sub_1800CB704(a2, (_WORD *)(Heap + 48), 0x214u, (int *)&v21);
    RtlGetCurrentServiceSessionId();
    ZwTraceEvent();
    RtlFreeHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, Heap);
    if ( (a1 & 0x100) != 0 && (int)sub_1800CC418(*(_QWORD *)(a2 + 16), 4LL, &UnicodeString) >= 0 )
    {
      v6 = sub_1800CC418(*(_QWORD *)(a2 + 16), 1LL, &v18);
      v7 = *(_QWORD *)(a2 + 16);
      v22 = v6;
      v8 = sub_1800CC418(v7, 0LL, &v20);
      v9 = sub_1800CC418(*(_QWORD *)(a2 + 16), 5LL, &v19);
      ...
      if ( v10 )
      {
        ...
        *(_DWORD *)(v10 + 32) = a1;
        *(_WORD *)(v10 + 6) = 5333;
        sub_1800CB704((__int64)&UnicodeString, (_WORD *)(v10 + 36), 0xC78u, (int *)&v21);
        v13 = 3192 - v21;
        v14 = (_WORD *)(v12 + 2 * ((unsigned __int64)v21 >> 1));
        sub_1800CB704((__int64)&v18, v14, 3192 - v21, (int *)&v21);
        v15 = v13 - v21;
        v16 = &v14[(unsigned __int64)v21 >> 1];
        sub_1800CB704((__int64)&v20, v16, v15, (int *)&v21);
        sub_1800CB704((__int64)&v19, &v16[(unsigned __int64)v21 >> 1], v15 - v21, (int *)&v21);
        RtlGetCurrentServiceSessionId();
        ZwTraceEvent();
