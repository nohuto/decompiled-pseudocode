...
int __fastcall sub_1800F8548(__int64 a1, void *a2)
{
  __int64 v4; // r14
  wchar_t *Heap; // rax
  int v6; // ecx
  ...
  LODWORD(Heap) = sub_18006F7EC(a2, &DestinationString, &v18, 0LL, (ULONG *)&v17);
  if ( (_DWORD)Heap != -1073741772 )
  {
    ...
    if ( (_DWORD)v17 )
    {
      if ( (_DWORD)Heap == -2147483643 )
      {
        ...
        if ( v8 )
        {
          if ( !(unsigned int)sub_18006F7EC(a2, &DestinationString, &v18, v8, (ULONG *)&v17) && (v18 == 1 || v18 == 7) )
          {
            v9 = 0;
