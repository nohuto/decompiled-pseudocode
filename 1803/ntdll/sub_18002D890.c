/*
 * XREFs of sub_18002D890 @ 0x18002D890
 * Callers:
...
__int64 __fastcall sub_18002D890(__int64 a1, __int64 a2)
{
  _WORD *v4; // rcx
  __int64 v5; // rbx
...
LABEL_6:
  if ( v5 == -1 )
    v9 = (char *)&unk_1801101C0;
  else
    v9 = (char *)&unk_1801101C0 + 32 * v5;
  v10 = *(_DWORD **)(a2 + 24);
  v11 = 0LL;
  if ( !*v10 )
    return 1LL;
          ...
          do
          {
            ...
            if ( !v17 )
            {
              ...
              if ( !*(_QWORD *)(v18 + v12 + 80) && *(_DWORD *)(v18 + v12 + 88) == 2 )
                *(_QWORD *)(v18 + v12 + 80) = sub_180109668(*(_QWORD *)(v18 + v12 + 72));
      ...
      if ( (unsigned int)v14 >= v19 )
      {
        ...
        if ( v19 )
        {
          ...
          if ( !*(_QWORD *)(v23 + 80) && *(_DWORD *)(v23 + 88) == 2 )
            *(_QWORD *)(v23 + 80) = sub_180109668(*(_QWORD *)(v23 + 72));
