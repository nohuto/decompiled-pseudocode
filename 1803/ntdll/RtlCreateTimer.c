  ...
  *Handle = 0LL;
  ...
  else
  {
    ...
    if ( Heap )
    {
      ...
      *((_QWORD *)Heap + 8) = 0LL;
      *((_DWORD *)Heap + 23) = 0;
      v10 = sub_180058EC0((PHANDLE)Heap + 2);
      v19 = v10;
      if ( v10 < 0 )
        goto LABEL_16;
      v12[4] = Function;
      ...
      *((_BYTE *)v12 + 88) = Period != 0;
      ...
      CallbackEnviron.FinalizationCallback = (PTP_SIMPLE_CALLBACK)sub_1800569D0;
      v10 = TpAllocTimer(v13, sub_180075FE0, v12, &CallbackEnviron);
      v19 = v10;
      if ( v10 < 0 )
        goto LABEL_16;
