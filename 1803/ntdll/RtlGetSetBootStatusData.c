...
__int64 __fastcall RtlGetSetBootStatusData(int a1, char a2, int a3, _BYTE *a4, int a5, _DWORD *a6)
{
  ...
  v6 = a4;
  if ( a2 )
    return sub_1800E70A4(a1, 1, a3, (_DWORD)a4, a5, (__int64)a6);
  if ( a3 == 15 )
    return 3221225485LL;
  result = sub_1800E70A4(a1, 1, 15, (unsigned int)v15, 1, 0LL);
  if ( (int)result >= 0 )
  {
    result = sub_1800E70A4(a1, 1, a3, (unsigned int)v17, 136, 0LL);
    if ( (int)result >= 0 )
    {
      result = sub_1800E70A4(a1, 0, a3, (_DWORD)v6, a5, (__int64)v16);
      if ( (int)result >= 0 )
      {
        v10 = v16[0];
        if ( a6 )
        ...
        return sub_1800E70A4(a1, 0, 15, (unsigned int)v15, 1, 0LL);
      }
    }
  }
  return result;
