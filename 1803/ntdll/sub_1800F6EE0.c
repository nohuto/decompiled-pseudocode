/*
 * XREFs of sub_1800F6EE0 @ 0x1800F6EE0
 * Callers:
...
__int64 __fastcall sub_1800F6EE0(__int64 a1, unsigned __int16 a2)
{
  __int64 result; // rax
  unsigned int i; // ebx
  PSLIST_ENTRY v6; // rax
  ...
  result = sub_1800F6C6C(a1, (8LL * a2 + 31) & 0xFFFFFFFFFFFFFFF0uLL);
  if ( result )
  {
