/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1402A6B7C
 * Callers:
 *     SmKmKeyGenStart @ 0x14079DBA8 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x1402A6C30 (RtlUnicodeStringValidateSrcWorker.c)
 */
