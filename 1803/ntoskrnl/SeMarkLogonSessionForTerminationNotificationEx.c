/*
 * XREFs of SeMarkLogonSessionForTerminationNotificationEx @ 0x140584290
 * Callers:
 *     SeMarkLogonSessionForTerminationNotification @ 0x140584270 (SeMarkLogonSessionForTerminationNotification.c)
 * Callees:
