/*
 * XREFs of BcpDisplayProgress @ 0x1402C6B94
 * Callers:
 ...
 *     BcpCursorLessThan @ 0x1402C64D0 (BcpCursorLessThan.c)
...
__int64 __fastcall BcpDisplayProgress(unsigned int a1, int a2, unsigned int a3)
{
  ...
  if ( !v5 )
    v6 = &stru_1403D0FD0;
  BcpDisplayCriticalString((__int16 *)v6, dword_14039B810[18 * a2 + 2], a3, a2);
  LODWORD(v20) = 0x80000;
  v21 = &v25;
  BcpConvertProgressToString(a1, (__int64)&v20);
  BcpDisplayCriticalString((__int16 *)&v20, dword_14039B810[2 * v7 + 2], v8, a2);
  v10 = &stru_1403D0FC0;
  if ( a1 != 1 )
    v10 = &stru_1403D0FE0;
  BcpDisplayCriticalString((__int16 *)v10, dword_14039B810[2 * v7 + 2], v9, a2);
  v11 = BcpCursor;
  v12 = dword_1403CADF8;
  v20 = BcpCursor;
  LODWORD(v21) = dword_1403CADF8;
  if ( BcpCursorLessThan(&v20) )
  {
    v13 = v20;
    v14 = HIDWORD(v20);
    v24 = v20;
    v15 = *(_DWORD *)(*(_QWORD *)(qword_1403D1060 + 24) + 40LL);
    if ( BcpTextBoxLeftEdgeOverride )
      v16 = *(_DWORD *)BcpTextBoxLeftEdgeOverride;
    else
      v16 = dword_14039B810[2 * v7 + 4] + dword_14039B810[2 * v7 + 8];
    if ( BcpTextBoxRightEdgeOverride )
      v17 = *(_DWORD *)BcpTextBoxRightEdgeOverride;
    else
      v17 = dword_14039B810[2 * v7 + 4] + dword_14039B810[2 * v7 + 6] + dword_14039B810[2 * v7 + 8];
    while ( BcpCursorLessThan(&v24) )
    {
      if ( (int)BgpDisplayCharacterEx(0x20u, (__int64 *)qword_1403D1060, v13, v14, v15, v15, &v22, &v23, v19) < 0 )
        return 0LL;
      v13 += v22;
      LODWORD(v24) = v13;
      if ( v13 > v17 )
  ...
  if ( (dword_14039D7F0 & 0x1000000) == 0 )
  {
    BcpProgressEnd = v11;
    dword_14039D6F8 = v12;
  }
