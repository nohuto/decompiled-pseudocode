/*
 * XREFs of CcApplyLowIoPriorityToThread @ 0x140042A4C
 * Callers:
        ...
        if ( v15->LockState.0 )
        {
          if ( v15 )
          {
            ...
            if ( (__int64)v15->LockState.LockState < 0 )
              KiAbEntryRemoveFromTree(&v7->LockEntries[v14]);
            v27 = 0;
...
LABEL_25:
  ...
  else
  {
    ...
    {
      LOBYTE(v18) = 1;
      PsBoostThreadIo(CurrentThread, v18);
        ...
        if ( v25->LockState.0 )
        {
          if ( v25 )
          {
            ...
            if ( (__int64)v25->LockState.LockState < 0 )
              KiAbEntryRemoveFromTree(&v7->LockEntries[v24]);
            v28 = 0;
...
LABEL_46:
  ...
  KiAbThreadRemoveBoosts(v7, v6, v17);
