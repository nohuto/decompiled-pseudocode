/*
 * XREFs of PiCMGetDeviceIdList @ 0x140575248
 * Callers:
 ...
 *     PiCMConvertDeviceListFilters @ 0x14057558C (PiCMConvertDeviceListFilters.c)
...
LABEL_22:
  ...
  if ( (Microsoft_Windows_Kernel_PnPEnableBits & 0x2000000) != 0 )
    McTemplateK0q(v11, &KMPnPEvt_CfgMgr_DeviceList_Stop, v13, v12);
