/*
 * XREFs of VslCreateSecureImageSection @ 0x14015C8E0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a6)
{
  ...
  if ( a1 > 0x1FA )
    return 3221225485LL;
  result = VslpLockPagesForTransfer((unsigned int)v10, a2, a1 << 12, 0, 0);
  if ( (int)result >= 0 )
  {
    v12 = v10[0];
    v13 = v10[7];
    ...
    v16 = a5;
    v15 = v7;
    v9 = VslpEnterIumSecureMode(2u, 24LL, 0, (__int64)v11);
