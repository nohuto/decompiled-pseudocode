/*
 * XREFs of MiPickClusterForMappedFileFault @ 0x140056310
 * Callers:
...
LABEL_46:
  ...
  if ( !a3 && (v14 & 0x20000000) != 0 )
  {
    ...
    v17 = 0LL;
    v16 = a4;
    v32 = v20 & (dword_1403CC3EC - 1);
    if ( v18 > v12 + 8 * (((unsigned int)(dword_1403CC3EC - v32) >> 12) - 1LL) )
      v18 = v12 + 8 * (((unsigned int)(dword_1403CC3EC - v32) >> 12) - 1LL);
  }
  else
  {
    v20 = 0;
  ...
  else
  {
    ...
    {
      v33 = (v20 >> 12) & ((unsigned int)(dword_1403CC3EC - 1) >> 12);
      if ( v24 < v12 - 8 * v33 )
        v25 = v12 - 8 * v33;
    }
  }
