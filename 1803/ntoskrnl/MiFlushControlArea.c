/*
 * XREFs of MiFlushControlArea @ 0x14024F320
 * Callers:
...
__int64 __fastcall MiFlushControlArea(char *P, unsigned __int8 a2, __int64 **a3, struct _FILE_OBJECT **a4)
{
  ...
  int v20[4]; // [rsp+48h] [rbp-21h] BYREF
  ...
  *a3 = 0LL;
  ...
  else
  {
    ...
    v13 = MiFlushSectionInternal(0LL, 0LL, (__int64 *)P + 16, 0LL, 0LL, 2, v20);
...
LABEL_20:
    ...
    v18 = *(_QWORD *)(qword_1403CBD88 + 8LL * (*((_WORD *)P + 30) & 0x3FF));
  ExReleaseSpinLockExclusiveFromDpcLevel(v7);
  __writecr8(v28);
  if ( v27 )
    FsRtlReleaseFileForCcFlush(v8);
