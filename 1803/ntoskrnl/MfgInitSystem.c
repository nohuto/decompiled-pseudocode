/*
 * XREFs of MfgInitSystem @ 0x1408C9EE8
 * Callers:
...
__int64 __fastcall MfgInitSystem(__int64 a1)
{
  ...
  LODWORD(qword_1403A1C68) = *(_DWORD *)(v2 + 2488);
  PoolWithTag = ExAllocatePoolWithTag(PagedPool, WORD1(qword_1403A1C68), 0x5067664Du);
  qword_1403A1C70 = PoolWithTag;
  if ( PoolWithTag )
  {
    inited = RtlStringCbCopyW((NTSTRSAFE_PWSTR)PoolWithTag, WORD1(qword_1403A1C68), *(NTSTRSAFE_PCWSTR *)(v2 + 2496));
    if ( inited < 0 )
      goto LABEL_22;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&qword_1403A1C68;
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    inited = ZwSetValueKey(KeyHandle, &ValueName, 0, 1u, qword_1403A1C70, WORD1(qword_1403A1C68));
    if ( inited < 0 )
      goto LABEL_22;
