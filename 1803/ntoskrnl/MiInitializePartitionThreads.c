/*
 * XREFs of MiInitializePartitionThreads @ 0x14074D720
 * Callers:
...
__int64 __fastcall MiInitializePartitionThreads(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( !(_DWORD)v6 )
    {
      ...
      *(_QWORD *)(a1 + 6368) = ZeroThreadContext;
  ...
  if ( !(_DWORD)v6 )
  {
    MiDeleteZeroThreadContext(*(_QWORD *)(a1 + 6368));
    ExFreePoolWithTag(*(PVOID *)(a1 + 6368), 0);
    *(_QWORD *)(a1 + 6368) = 0LL;
  }
