/*
 * XREFs of MiAllocateContiguousMemory @ 0x1400BE350
 * Callers:
 *     MmAllocateContiguousNodeMemory @ 0x1400BE2B0 (MmAllocateContiguousNodeMemory.c)
 *     MmAllocateContiguousMemory @ 0x140254910 (MmAllocateContiguousMemory.c)
 * Callees:
        ...
        int a6)
{
  ...
  if ( a6 == 0x80000000 )
    ...
    v17 = a6;
  v37 = v17;
  v18 = (unsigned __int16 *)((char *)qword_1403CB6A0 + 2 * v17 * (unsigned __int16)KeNumberNodes);
  if ( a6 == 0x80000000 )
...
LABEL_18:
    v38 = 135266304;
    v22 = (unsigned __int16 *)((char *)qword_1403CB6A0 + 2 * v37 * (unsigned __int16)KeNumberNodes);
...
LABEL_19:
      ...
      v25 = v24;
      if ( v24 && !(unsigned int)ExInsertPoolTag(1416523587, v24, v9, v35, 2 * v10 + 1) )
      {
        v32 = (v11 << 12) + 4096;
        if ( !v10 )
          v32 = v11 << 12;
      ...
      MiFreeContiguousPages(&MiSystemPartition, v33, v11);
    }
    return 0LL;
  }
  while ( 1 )
  {
    ContiguousMemoryInPool = MiFindContiguousMemoryInPool(v8, v13, v7, v9, *v18);
    v14 = 0LL;
  ...
  if ( !(unsigned int)ExInsertPoolTag(1953394499, ContiguousMemoryInPool, v9, 512, 0) )
  {
    MiFreePoolPages(v21);
    return 0LL;
  }
