/*
 * XREFs of IopInitializeSystemDrivers @ 0x1408B5994
 * Callers:
 ...
 *     ExIsManufacturingModeEnabled @ 0x1406339D0 (ExIsManufacturingModeEnabled.c)
...
__int64 IopInitializeSystemDrivers()
{
  ...
  SystemDriverList = (void **)CmGetSystemDriverList((unsigned __int64)qword_1403A1C70 & -(__int64)(IsManufacturingModeEnabled != 0));
  v2 = SystemDriverList;
  if ( SystemDriverList )
  {
    v3 = SystemDriverList;
