/*
 * XREFs of VrpIoctlDeviceDispatch @ 0x140707A60
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( (unsigned int)VRegEnabledInJob(&v23) && !VrpAllowContainerNesting )
  {
    ...
    if ( stru_1403970D0.LevelPlus1 > 2 )
    {
      ...
      v23 = v5;
      v28 = 4;
      TlgWrite(&stru_1403970D0, &unk_140308CE3, &pActivityId, 0LL, 3u, &Object);
    }
    goto LABEL_29;
  }
  EtwActivityIdControl(1u, &ActivityId);
  LevelPlus1 = stru_1403970D0.LevelPlus1;
  if ( stru_1403970D0.LevelPlus1 > 4 )
  {
    v29 = 0;
    v27 = &v23;
    v23 = v5;
    v28 = 4;
    TlgWrite(&stru_1403970D0, &unk_140308D6E, &pActivityId, &ActivityId, 3u, &Object);
    LevelPlus1 = stru_1403970D0.LevelPlus1;
  }
  v10 = v5 - 2228228;
  if ( !v10 )
...
LABEL_28:
  ...
  if ( LevelPlus1 > 2 )
  {
    ...
    v27 = &v23;
    v28 = 4;
    TlgWrite(&stru_1403970D0, &unk_140308D42, &pActivityId, 0LL, 3u, &Object);
  }
  v6 = -1073741808;
LABEL_29:
  *(_DWORD *)(a2 + 48) = v6;
  ...
  if ( stru_1403970D0.LevelPlus1 > 4 )
  {
    ...
    v23 = v6;
    v28 = 4;
    TlgWrite(&stru_1403970D0, &unk_140308D93, &pActivityId, 0LL, 3u, &Object);
  }
  return v6;
}
