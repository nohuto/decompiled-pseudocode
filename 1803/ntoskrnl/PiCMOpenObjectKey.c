/*
 * XREFs of PiCMOpenObjectKey @ 0x14050C084
 * Callers:
...
__int64 __fastcall PiCMOpenObjectKey(_DWORD *a1, unsigned int a2, __int64 a3, unsigned int a4, int a5, _DWORD *a6)
{
...
LABEL_14:
  if ( Object >= 0 )
  {
    Object = PnpOpenObjectRegKey(*(__int64 *)&PiPnpRtlCtx, v22, v10, v23, 0, (__int64)&Handle, 0LL, 0);
