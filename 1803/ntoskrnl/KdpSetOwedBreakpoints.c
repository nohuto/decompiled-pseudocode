/*
 * XREFs of KdpSetOwedBreakpoints @ 0x140806ED4
 * Callers:
...
void __fastcall KdpSetOwedBreakpoints(__int64 a1)
{
  ...
  if ( KdpOweBreakpoint )
  {
    ...
    while ( 1 )
    {
      ...
      v1 += 5;
      if ( (__int64)v1 >= (__int64)&unk_1403B5E48 )
        return;
    }
    v8 = KdEnterDebugger(0LL);
    KdpOweBreakpoint = 0;
    v9 = (unsigned __int8 *)&unk_1403B5965;
    do
    {
    ...
    while ( (__int64)v9 < (__int64)byte_1403B5E65 );
    KdExitDebugger(v8);
  }
}
