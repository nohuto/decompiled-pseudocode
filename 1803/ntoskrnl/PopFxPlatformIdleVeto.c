/*
 * XREFs of PopFxPlatformIdleVeto @ 0x140275AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopFxPlatformIdleVeto(__int64 a1, int a2, int a3, char a4)
{
  NTSTATUS v8; // ebx
  ...
  if ( *(_QWORD *)(a1 + 152) )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v14[1] = a3;
      v15 = a4;
      v8 = v10(v11, &GUID_PLATFORM_IDLE_VETO, v14, 12LL, 0LL, 0LL, &v13);
