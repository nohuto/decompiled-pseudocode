/*
 * XREFs of MiFindLargeNodePage @ 0x140254588
 * Callers:
...
unsigned __int64 __fastcall MiFindLargeNodePage(__int64 a1, unsigned int a2, int *a3, int a4, char a5)
{
  ...
  if ( a2 >= (unsigned __int16)KeNumberNodes )
  {
    ...
    v9 = (unsigned __int16 *)((char *)qword_1403CB6A0 + 2 * a2 * (unsigned __int16)KeNumberNodes);
  ...
  {
    v12 = (a4 & 0x4000) != 0
        ? MiGetFreeZeroLargePage(a1, *a3, v11, a2, 0, 4)
