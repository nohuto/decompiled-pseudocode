/*
 * XREFs of ViThunkRecoverPristines @ 0x14082428C
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x140823A70 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x140824660 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x1408246D0 (ViThunkReplaceSpecialPristine.c)
 */
