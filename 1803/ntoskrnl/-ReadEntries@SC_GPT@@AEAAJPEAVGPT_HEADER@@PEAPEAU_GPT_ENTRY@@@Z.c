/*
 * XREFs of ?ReadEntries@SC_GPT@@AEAAJPEAVGPT_HEADER@@PEAPEAU_GPT_ENTRY@@@Z @ 0x1402C87E8
 * Callers:
...
__int64 __fastcall SC_GPT::ReadEntries(SC_GPT *this, struct GPT_HEADER *a2, struct _GPT_ENTRY **a3)
{
  ...
  *a3 = 0LL;
  v8 = (struct _GPT_ENTRY *)SC_ENV::Allocate(~(*(_DWORD *)(v3 + 164) - 1) & (unsigned int)(*(_DWORD *)(v3 + 164) + v6 - 1));
  v9 = v8;
  if ( v8 )
  {
