/*
 * XREFs of PopTraceThermalZonePassiveHistogram @ 0x14014DB20
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x14014DC9C (PopDiagSnapPassiveHistogram.c)
  ...
  if ( v4 )
  {
    ...
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)DeviceAttachmentBaseRefWithTag )
      {
        ...
        v14 = 84;
        v17 = 21;
        LOBYTE(DeviceAttachmentBaseRefWithTag) = TlgWrite(&pCallbackContext, &unk_14030B4CC, 0LL, 0LL, 7u, &pData);
      }
    }
  }
  if ( v3 )
