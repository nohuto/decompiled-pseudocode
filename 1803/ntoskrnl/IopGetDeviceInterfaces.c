/*
 * XREFs of IopGetDeviceInterfaces @ 0x1404901A0
 * Callers:
...
LABEL_75:
  ...
  v34 = PiPnpRtlApplyMandatoryFilters(PiPnpRtlCtx, (int)v19, 3, (int)v48, (BOOLEAN)&v56, (__int64)&cchDest_4);
...
LABEL_11:
  if ( String1 )
  {
    ObjectProperty = PnpUnicodeStringToWstr(&v51, 0LL, String1);
    if ( ObjectProperty < 0 )
      goto LABEL_29;
  }
...
LABEL_35:
  if ( Handle )
    ZwClose(Handle);
  PnpUnicodeStringToWstrFree(v51, v6);
  if ( v8 )
