/*
 * XREFs of WheapPfaMemoryCheck @ 0x1407CBB04
 * Callers:
 ...
 *     WheapSqmIncrementDword @ 0x1402C0450 (WheapSqmIncrementDword.c)
  ...
  if ( !WheapPolicyMemPfaDisable && (*(_BYTE *)a2 & 2) != 0 )
  {
    ...
    if ( !(unsigned int)MmGetPageBadStatus(&v17) )
    {
      ...
      if ( v5 >= WheapPolicyMemPfaPageCount )
      {
        ...
        if ( *(_QWORD **)(*PoolWithTag + 8LL) != PoolWithTag || (v10 = (PVOID *)PoolWithTag[1], *v10 != PoolWithTag) )
          __fastfail(3u);
        *v10 = v9;
        v9[1] = v10;
