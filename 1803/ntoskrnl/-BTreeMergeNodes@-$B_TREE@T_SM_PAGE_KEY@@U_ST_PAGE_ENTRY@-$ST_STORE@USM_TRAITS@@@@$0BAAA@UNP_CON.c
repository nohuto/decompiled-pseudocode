/*
 * XREFs of ?BTreeMergeNodes@?$B_TREE@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@U?$B_TREE_KEY_COMPARATOR@T_SM_PAGE_KEY@@@@@@SAXPEAU1@PEAUSEARCH_RESULT@1@PEAUNODE@?$B_TREE_HEADER@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@@@@Z @ 0x14014C33C
 * Callers:
        ...
        unsigned __int64 a3)
{
  ...
  if ( (_BYTE)v13 )
  {
    ...
    if ( v15 == -1 )
      *(_QWORD *)(v11 + 8) = v16;
    v17 = (void *)(v11 + 16 + 8 * v12);
    v18 = 8LL * (unsigned __int16)*(_DWORD *)v6;
  }
  else
  {
    v22 = 2 * v12;
