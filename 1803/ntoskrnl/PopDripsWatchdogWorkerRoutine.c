/*
 * XREFs of PopDripsWatchdogWorkerRoutine @ 0x14076E360
 * Callers:
 *     <none>
 * Callees:
    ...
    *(_QWORD *)(a1 + 64) = v4;
    ...
    if ( v8 >= (unsigned int)(10000000 * PopDripsWatchdogTimeout) )
    {
      ...
      if ( !v12 )
      {
        ...
        if ( !v18 || (unk_1403AA2B4 & 0x40000000) != 0 || (v19 = *(_DWORD *)(a1 + 16), dword_1403AA2A4 >= v19) )
          v20 = 0;
        else
          v20 = PopBatteryCapacityToRate(v19 - dword_1403AA2A4, v18);
        HIDWORD(v28) = v20;
      }
    ...
    else
    {
      ...
      *(_DWORD *)(a1 + 400) = v10 + 1;
      ...
      ExReleaseResourceLite(&stru_1403D1AD8);
      KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
      if ( v7 || qword_1403CDA18 )
        PopDirectedDripsNotify(2, 0LL);
      else
