/*
 * XREFs of RtlScrubMemory @ 0x14028F74C
 * Callers:
 ...
 *     RtlpGenericRandomPatternWorker @ 0x14028FDE0 (RtlpGenericRandomPatternWorker.c)
 *     RtlpGenericStrideWorker @ 0x1402900F8 (RtlpGenericStrideWorker.c)
 */
