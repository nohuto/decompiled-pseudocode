/*
 * XREFs of ViDeadlockRemoveMemoryRangeResources @ 0x1402AAF78
 * Callers:
 *     VfDeadlockDeleteMemoryRange @ 0x140828548 (VfDeadlockDeleteMemoryRange.c)
 * Callees:
 *     ViDeadlockDetectionTryConvertSharedToExclusive @ 0x1402AAF48 (ViDeadlockDetectionTryConvertSharedToExclusive.c)
 ...
 *     ViDeadlockDatabaseHashIndex @ 0x140829954 (ViDeadlockDatabaseHashIndex.c)
  ...
  if ( *v9 != v9 && (unsigned int)VfUtilAddressRangeFit((char *)ViDeadlockGlobals + 16 * v8 + 32, a1, v4) )
  {
    while ( v10 != v9 )
    {
      ...
      if ( v12 >= a3 && v12 < a4 )
      {
        ...
        ViDeadlockRemoveResource((ULONG_PTR)v11);
        *v11 = v6;
        v6 = v11;
      }
    }
