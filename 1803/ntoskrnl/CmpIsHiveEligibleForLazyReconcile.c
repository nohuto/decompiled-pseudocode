/*
 * XREFs of CmpIsHiveEligibleForLazyReconcile @ 0x14049A5D8
 * Callers:
...
bool __fastcall CmpIsHiveEligibleForLazyReconcile(unsigned int *a1)
{
  ...
  return UnbiasedInterruptTime >= *(_QWORD *)(v9 + 4184) + 10000000 * (unsigned __int64)(unsigned int)dword_140396510;
}
