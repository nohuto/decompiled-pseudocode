/*
 * XREFs of McTemplateK0xxxqq @ 0x140225E88
 * Callers:
 *     FsRtlHeatLogIo @ 0x140716750 (FsRtlHeatLogIo.c)
 * Callees:
 *     McGenEventWriteKM @ 0x14014761C (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x140187410 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0xxxqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v12 = 4LL;
  v14 = 4LL;
  return McGenEventWriteKM(MS_StorageTiering_Provider_Context, a2, a3, 6u, &v4);
}
