/*
 * XREFs of MiComputeTrimAmount @ 0x1402595A0
 * Callers:
...
unsigned __int64 __fastcall MiComputeTrimAmount(__int64 a1, __int64 a2)
{
  ...
  if ( v3 == v4 )
    return 0LL;
  v6 = *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * *(unsigned __int16 *)(a2 + 174)) + 7040LL);
  v7 = 3;
...
LABEL_17:
  ...
  if ( v9 <= v5 )
    v5 = v9;
  result = v5;
  v24 = *(_QWORD *)(qword_1403CBD88 + 8LL * *(unsigned __int16 *)(a2 + 174));
  ++*(_DWORD *)(*(_QWORD *)(v24 + 6768) + 4LL * (*(_BYTE *)a1 & 0x7F) + 2552);
  return result;
}
