/*
 * XREFs of ?SmStCompareRegionDataCallback@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU_SMKM_STORE_HELPER@@PEAXK@Z @ 0x140099680
 * Callers:
        ...
        struct _MDL *a4)
{
  ...
  else
  {
    ...
    {
      v9 = SMKM_STORE<SM_TRAITS>::SmStMapVirtualRegion(v6, v8, 0, (__int64)a4, 0);
      if ( v9 <= 3 )
      {
LABEL_35:
        v13 = -1073741670;
...
LABEL_14:
        ...
        if ( v5 )
        {
          ...
          if ( v5 != v9 )
          {
            if ( (*(_BYTE *)(v6 + 6021) & 4) != 0 )
            {
              SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(v6, v7, (__int64)a3, (__int64)a4, v23, 0);
LABEL_18:
              a3 = v28;
              goto LABEL_19;
            }
            v15 = *(_QWORD *)(v6 + 6216);
            a4 = (struct _MDL *)(*(_QWORD *)(v15 + 8 * v7) & 0xFFFFFFFFFFFFFFF8uLL);
            v16 = *(_QWORD *)(v15 + 8 * v7) & 0xFFFFFFFFFFFFFFFEuLL;
            *(_QWORD *)(v15 + 8 * v7) = v16;
            if ( (v16 & 3) == 0 )
            {
              SmFpFree(v6 + 6592, 5, (__int64)KeGetCurrentThread(), a4);
              goto LABEL_18;
            }
          }
        }
LABEL_19:
        ...
        if ( (*(_BYTE *)(v6 + 6021) & 4) != 0 )
        {
          v5 = SMKM_STORE<SM_TRAITS>::SmStMapVirtualRegion(v6, v7, 0, (__int64)a4, 0);
        }
        else
        {
          v17 = *a3;
          v18 = *(_QWORD *)(v6 + 6216);
          v29 = v18;
          v19 = *(_QWORD *)(v18 + 8 * v7) & 0xFFFFFFFFFFFFFFF8uLL;
          if ( (*(_QWORD *)(v18 + 8 * v7) & 3) != 0 )
          {
            v5 = *(_QWORD *)(v19 + 24);
            goto LABEL_43;
          }
          v5 = SmFpAllocate((PEX_SPIN_LOCK)(v6 + 6592), 5, (__int64)KeGetCurrentThread(), v19, 0);
          if ( v5 )
          {
            v17 = v7;
            v18 = v29;
...
LABEL_10:
        ...
        if ( (unsigned int)SMKM_STORE<SM_TRAITS>::SmStCheckResident(Buf2, *((unsigned __int16 *)v10 + 2)) == 1 )
        {
          if ( !memcmp(Buf1, Buf2, *((unsigned __int16 *)v10 + 2)) )
            *((_BYTE *)v10 + 7) = ((char *)v28 - (char *)(v10 + 2)) >> 3;
          if ( *((_BYTE *)v10 + 7) != 16 )
            goto LABEL_14;
        }
        a3 = v28 + 2;
...
LABEL_25:
    if ( (*(_BYTE *)(v6 + 6021) & 4) != 0 && v9 > 3 )
      SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(v6, *(_DWORD *)a2, (__int64)a3, (__int64)a4, v23, 0);
    if ( v5 != v9 && v5 > 3 )
    {
      if ( (*(_BYTE *)(v6 + 6021) & 4) != 0 )
      {
      ...
      {
        v20 = *(_QWORD *)(v6 + 6216);
        v21 = (struct _MDL *)(*(_QWORD *)(v20 + 8LL * (unsigned int)v7) & 0xFFFFFFFFFFFFFFF8uLL);
        v22 = *(_QWORD *)(v20 + 8LL * (unsigned int)v7) & 0xFFFFFFFFFFFFFFFEuLL;
        *(_QWORD *)(v20 + 8LL * (unsigned int)v7) = v22;
        if ( (v22 & 3) == 0 )
          SmFpFree(v6 + 6592, 5, (__int64)KeGetCurrentThread(), v21);
      }
    }
