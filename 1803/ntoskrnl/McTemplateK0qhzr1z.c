/*
 * XREFs of McTemplateK0qhzr1z @ 0x14023DAEC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qhzr1z(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        const wchar_t *a7)
{
  ...
  if ( !a7 )
    v7 = L"NULL";
  v19 = v7;
  return McGenEventWriteKM(MS_KernelPnP_Provider_Context, &KMPnPEvt_DeviceAdd_Start, 0LL, 5u, &v11);
}
