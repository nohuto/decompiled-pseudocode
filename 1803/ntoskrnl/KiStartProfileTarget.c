/*
 * XREFs of KiStartProfileTarget @ 0x1402463C0
 * Callers:
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)Argument + 2, 0xFFFFFFFF) == 1 )
  {
    ...
    else
    {
      ...
      *(_BYTE *)(v2 + 242) = 1;
      ...
      {
        v8 = (_QWORD *)qword_1403B4728;
        if ( *(__int64 **)qword_1403B4728 != &KiProfileListHead )
          __fastfail(3u);
        *v5 = &KiProfileListHead;
        *(_QWORD *)(v2 + 16) = v8;
        *v8 = v5;
        qword_1403B4728 = v2 + 8;
      }
...
LABEL_14:
      ...
      KeOrAffinityEx(v11, (unsigned __int16 *)(v2 + 72), v11);
