/*
 * XREFs of RtlExtractBitMapEx @ 0x140287B60
 * Callers:
...
char __fastcall RtlExtractBitMapEx(_QWORD *a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( v4 )
  {
    ...
    if ( (a3 & 7) != 0 )
    {
      ...
      {
        if ( v4 > 64 - v15 )
          v21 = ((*v16 & (unsigned __int64)~(v17 - 1)) >> v15) | ((v16[1] & ((1LL << ((unsigned __int8)v4
                                                                                    + (unsigned __int8)v15
                                                                                    - 64))
                                                                           - 1)) << (64 - (unsigned __int8)v15));
        else
          v21 = (*v16 & (unsigned __int64)(((1LL << v4) - 1) << v15)) >> v15;
        v7 = v21 | ~((1LL << v4) - 1) & *v14;
        *v14 = v7;
      }
    }
