/*
 * XREFs of WheaWmiDispatch @ 0x140185610
 * Callers:
 *     <none>
 * Callees:
 *     WheapWmiRegisterInfo @ 0x14018566C (WheapWmiRegisterInfo.c)
 *     WheapWmiExecuteMethod @ 0x1402BFF60 (WheapWmiExecuteMethod.c)
 *     WheapWmiGetAllData @ 0x1402C0180 (WheapWmiGetAllData.c)
 *     WheapWmiGetSingleInstance @ 0x1402C01E4 (WheapWmiGetSingleInstance.c)
 */
