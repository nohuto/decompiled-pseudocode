/*
 * XREFs of PopProcessWakeSourceWork @ 0x140762264
 * Callers:
...
LABEL_20:
  ...
  *((_WORD *)v16 + 13) = *(_WORD *)(v5 + 40);
  RtlCopyUnicodeString((PUNICODE_STRING)(v16 + 6), (PCUNICODE_STRING)(v5 + 40));
  PopWakeSourceGetDeviceProperty(v16 + 10, 9LL, v3);
  PopWakeSourceGetDeviceProperty(v16 + 14, 0LL, v3);
  v11 = 0;
LABEL_26:
  *a2 = v16;
  *a3 = v4;
