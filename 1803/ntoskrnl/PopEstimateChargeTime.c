/*
 * XREFs of PopEstimateChargeTime @ 0x1407644D4
 * Callers:
...
unsigned __int64 PopEstimateChargeTime()
{
  ...
  {
    for ( i = qword_1403AA290; (__int64 *)i != &qword_1403AA290; i = *(_QWORD *)i )
    {
      v7 = *(_DWORD *)(i + 64);
      if ( v7 != -1 )
      {
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    v32 = 8;
    v35 = 4;
    TlgWrite(&pCallbackContext, &unk_14030AD5F, 0LL, 0LL, 8u, &pData);
  }
  return v0;
}
