/*
 * XREFs of NormBuffer__LastStartBasePair @ 0x14028DFA4
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x140789780 (Normalization__GetSecondDecomposedCharPlane0.c)
 */
