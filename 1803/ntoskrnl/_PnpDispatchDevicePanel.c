/*
 * XREFs of _PnpDispatchDevicePanel @ 0x140637000
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _CmGetDevicePanelMappedProperty @ 0x1407ECC28 (_CmGetDevicePanelMappedProperty.c)
 *     _CmGetDevicePanelMappedPropertyKeys @ 0x1407ECD44 (_CmGetDevicePanelMappedPropertyKeys.c)
 *     _CmGetDevicePanelMappedPropertyLocales @ 0x1407ECDD8 (_CmGetDevicePanelMappedPropertyLocales.c)
 *     _CmOpenDevicePanelRegKey @ 0x1407ECF30 (_CmOpenDevicePanelRegKey.c)
 *     _CmSetDevicePanelMappedProperty @ 0x1407ED64C (_CmSetDevicePanelMappedProperty.c)
 */
