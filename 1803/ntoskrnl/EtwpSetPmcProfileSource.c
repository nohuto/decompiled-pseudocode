/*
 * XREFs of EtwpSetPmcProfileSource @ 0x1407A8D78
 * Callers:
...
__int64 __fastcall EtwpSetPmcProfileSource(_DWORD *a1, unsigned int a2)
{
  ...
  else
  {
    if ( qword_1403A20B8 )
    {
      ExFreePoolWithTag(qword_1403A20B8, 0);
      qword_1403A20B8 = 0LL;
      EtwpPmcProfile = 0;
    }
    v6 = v3;
    qword_1403A20B8 = ExAllocatePoolWithTag(NonPagedPoolNx, 248 * v3, 0x58777445u);
    v7 = qword_1403A20B8;
    if ( qword_1403A20B8 )
    {
      EtwpPmcProfile = v3;
