/*
 * XREFs of EtwTraceAppStateChange @ 0x140510E74
 * Callers:
...
void __fastcall EtwTraceAppStateChange(__int64 BugCheckParameter1, __int64 a2)
{
  ...
  if ( TraceLoggingProviderEnabled(&stru_1403977E0, 0, 0x600000000001uLL) )
  {
    ...
    if ( TraceLoggingProviderEnabled(&stru_1403977E0, 0, 0x400000000000uLL) )
    {
      ...
      EtwpQueryTokenPackageInfo((__int64)v17, (__int64)v43, &v18);
      ...
      if ( v16 )
      {
        ...
        {
          EtwpQueryProcessCommandLine(BugCheckParameter1, (__int64)&v20);
        }
