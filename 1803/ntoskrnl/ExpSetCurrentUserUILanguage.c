/*
 * XREFs of ExpSetCurrentUserUILanguage @ 0x14060E6CC
 * Callers:
 *     NtSetDefaultUILanguage @ 0x14060E6A8 (NtSetDefaultUILanguage.c)
 * Callees:
...
NTSTATUS __fastcall ExpSetCurrentUserUILanguage(PCWSTR SourceString, unsigned __int16 a2)
{
  ...
  v2 = (unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL;
  v3 = a2;
  memset((void *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 448), 0, 0xAAuLL);
  v5 = v3;
  *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30) = 0LL;
  *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x88) = 0LL;
  *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20) = 0LL;
  *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40) = 0LL;
  v6 = 1;
  *(_BYTE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 2) = 1;
  v7 = 0;
  v8 = 0;
  *(_BYTE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 1) = 0;
  result = OpenGlobalizationUserSettingsKey(
             v9,
             3u,
             v10,
             v11,
             (PHANDLE)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 144));
  if ( result < 0 )
    return result;
  ...
  *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x48) = 48;
  *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x50) = *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL)
                                                                                   + 0x90);
  *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x60) = 1600;
  *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x58) = ((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL)
                                                                       + 120;
  *(_OWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x68) = 0LL;
  if ( (_WORD)v3 )
  {
    Key = ExpValidateLocale(v3);
    *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 4) = Key;
    if ( Key < 0 )
      goto LABEL_25;
    ...
    *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 4) = Key;
    if ( Key < 0 )
      goto LABEL_25;
    *(_BYTE *)v2 = 1;
    *(_WORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xD0) = 0;
    v34 = (_WORD *)(v2 + 206);
    do
    {
      v35 = v5 & 0xF;
    ...
    while ( v36 >= v2 + 192 );
    Key = ZwSetValueKey(
            *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30),
  ...
  *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 4) = Key;
  if ( Key >= 0 )
  {
    *(_BYTE *)v2 = 1;
    ...
    if ( ZwQueryValueKey(
           *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30),
           ...
           0x100u,
           (PULONG)(v2 + 8)) >= 0
      && *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC8) > 4u
      && *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC4) == 1 )
    {
      ...
      if ( RtlUnicodeStringToInteger((PCUNICODE_STRING)(v2 + 16), 0x10u, (PULONG)(v2 + 152)) >= 0
        && (int)DownLevelLangIDToLanguageName(
                  *(_WORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x98),
                  ...
                  0) > 1 )
      {
        ...
        do
          ++v23;
        while ( *(_WORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x1C0 + 2 * v23) );
        ZwSetValueKey(
          *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30),
          (PUNICODE_STRING)(v2 + 16),
          0,
      ...
      RtlInitUnicodeString((PUNICODE_STRING)(v2 + 16), L"MultiUILanguageId");
      ZwDeleteValueKey(*(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30), (PUNICODE_STRING)(v2 + 16));
      v8 = 1;
      *(_BYTE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 1) = 1;
    }
    ...
    if ( ZwQueryValueKey(
           *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30),
           ...
           (PULONG)(v2 + 8)) >= 0 )
    {
      v24 = *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC8);
      if ( v24 >= 4 && *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC4) == 7 )
      {
        RtlInitUnicodeString((PUNICODE_STRING)(v2 + 16), L"PreferredUILanguages");
        if ( ZwSetValueKey(
               *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30),
               ...
               v24) >= 0 )
        {
          v8 = 1;
          *(_BYTE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 1) = 1;
          v25 = *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC8);
          if ( v25 + 12 < 0x100 )
          {
            *(_WORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xCA + 2 * ((unsigned __int64)v25 >> 1)) = 0;
            RtlInitUnicodeString((PUNICODE_STRING)(v2 + 16), L"PreferredUILanguagesPending");
            ZwDeleteValueKey(
              *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30),
              (PUNICODE_STRING)(v2 + 16));
            ...
            *(_OWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x68) = 0LL;
            if ( ZwOpenKey((PHANDLE)(v2 + 136), 0x40000000u, (POBJECT_ATTRIBUTES)(v2 + 72)) >= 0
              && ZwQueryValueKey(
                   *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x88),
                   (PUNICODE_STRING)(v2 + 160),
                   KeyValuePartialInformation,
                   (PVOID)(v2 + 640),
                   0x210u,
                   (PULONG)(v2 + 8)) >= 0
              && *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x284) == 7 )
            {
              ...
              *(_OWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x68) = 0LL;
              ...
              {
                if ( ZwSetValueKey(
                       *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x38),
                       (PUNICODE_STRING)(v2 + 160),
                       0,
                       7u,
                       (PVOID)(v2 + 652),
                       *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x288)) >= 0 )
                  ZwDeleteValueKey(
                    *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x88),
                    (PUNICODE_STRING)(v2 + 160));
                ZwClose(*(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x38));
              }
            }
          }
        }
    ...
    *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x48) = 48;
    *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x50) = 0LL;
    *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x60) = 1600;
    *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x58) = ((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL)
                                                                         + 120;
    *(_OWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x68) = 0LL;
    ...
    {
      v26 = *(void **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20);
      if ( v26 )
      {
      ...
      if ( ZwOpenKey((PHANDLE)(v2 + 64), 0x40000000u, (POBJECT_ATTRIBUTES)(v2 + 72)) >= 0 )
      {
        ...
        do
        {
          ...
          v29 = ZwEnumerateValueKey(
                  *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40),
                  v28,
      ...
      else
      {
        ...
        do
        {
          ...
          *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 4) = Key;
          if ( Key >= 0 )
          {
            v30 = *(unsigned int *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x290);
            if ( v30 + 24 <= 0x210
              && (v31 = *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x288),
                  v32 = *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x28C),
                  (unsigned int)(v31 + v32) <= 0x210)
              && *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x284) == 7
              && *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x290) < 0xAAu )
            {
              ...
              v33 = *(void **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40);
              if ( !v33 )
              {
                RtlInitUnicodeString((PUNICODE_STRING)(v2 + 120), L"MachineLanguageConfiguration");
                *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x48) = 48;
                ...
                *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 4) = Key;
                if ( Key < 0 )
                  goto LABEL_23;
                *(_BYTE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 2) = 0;
                v33 = *(void **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40);
                v32 = *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x28C);
                v31 = *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x288);
              }
        ...
        ZwClose(*(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x38));
LABEL_23:
        v6 = *(_BYTE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 2);
        v8 = *(_BYTE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 1);
      }
      goto LABEL_24;
    }
    RtlInitUnicodeString((PUNICODE_STRING)(v2 + 16), L"PreferredUILanguages");
    if ( ZwQueryValueKey(
           *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x38),
           ...
           (PULONG)(v2 + 8)) >= 0
      && *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC8) >= 4u
      && *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC4) == 7 )
    {
      goto LABEL_12;
    }
    *(_WORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x28) = 0;
    *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC8) = 0;
    InstallUILanguage = NtQueryInstallUILanguage((LANGID *)(v2 + 40));
    if ( InstallUILanguage >= 0 )
    {
      v15 = DownLevelLangIDToLanguageName(
              *(_WORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x28),
              (unsigned __int16 *)(v2 + 204),
              128,
              0);
      *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC8) = v15;
      if ( !v15 )
      {
        InstallUILanguage = -1073741823;
        goto LABEL_65;
      }
      *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0xC8) = 2 * v15;
    }
    if ( InstallUILanguage >= 0 )
    {
LABEL_12:
      if ( !*(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20) )
      {
        RtlInitUnicodeString((PUNICODE_STRING)(v2 + 120), L"Control Panel\\Desktop\\MuiCached");
        *(_DWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x48) = 48;
        *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x50) = *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL)
...
LABEL_24:
      ...
      RtlInitUnicodeString((PUNICODE_STRING)(v2 + 16), L"MachinePreferredUILanguages");
      if ( ZwSetValueKey(
             *(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20),
             (PUNICODE_STRING)(v2 + 16),
             0,
             7u,
             (PVOID)(v2 + 204),
...
LABEL_65:
    ...
    v27 = *(void **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20);
    if ( v27 )
...
LABEL_25:
  if ( v7 )
    ZwClose(*(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x30));
  v19 = *(void **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x88);
  if ( v19 )
  {
    if ( ZwEnumerateValueKey(v19, 0, KeyValueBasicInformation, 0LL, 0, (PULONG)(v2 + 8)) == -2147483622 )
      ZwDeleteKey(*(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x88));
    ZwClose(*(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x88));
  }
  if ( *(_QWORD *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20) )
  {
    v20 = *(void **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40);
    if ( !v20 || v6 && ZwEnumerateValueKey(v20, 0, KeyValueBasicInformation, 0LL, 0, (PULONG)(v2 + 8)) == -2147483622 )
    {
      v21 = *(void **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40);
      if ( v21 )
        ZwDeleteKey(v21);
      if ( ZwEnumerateValueKey(
        ...
        ZwDeleteKey(*(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20));
    }
    ZwClose(*(HANDLE *)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x20));
  }
  v22 = *(void **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x40);
  if ( v22 )
    ZwClose(v22);
  CloseGlobalizationUserSettingsKey(*(char **)(((unsigned __int64)&v39 & 0xFFFFFFFFFFFFFFE0uLL) + 0x90));
  if ( v8 == 1 )
  {
