/*
 * XREFs of KiInitializeIdleThread @ 0x14047B1C0
 * Callers:
...
unsigned __int64 __fastcall KiInitializeIdleThread(unsigned __int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_BYTE *)(a1 + 195) = 127;
  ...
  {
    qword_140466E50 = (__int64)&qword_140466E48;
    qword_140466E48 = (__int64)&qword_140466E48;
  }
  ...
  *(_QWORD *)(a1 + 1848) = 0LL;
  v8 = (_QWORD *)(a1 + 1704);
  v9 = (_QWORD *)qword_140466E50;
  if ( *(__int64 **)qword_140466E50 != &qword_140466E48 )
    __fastfail(3u);
  *v8 = &qword_140466E48;
  v8[1] = v9;
  *v9 = v8;
  qword_140466E50 = (__int64)v8;
