/*
 * XREFs of PfPrefetchRequestVerify @ 0x140492B24
 * Callers:
 *     PfpPrefetchRequest @ 0x14049284C (PfpPrefetchRequest.c)
 * Callees:
 *     PfPrefetchRequestVerifyRanges @ 0x140492A40 (PfPrefetchRequestVerifyRanges.c)
 *     PfPrefetchRequestVerifyPath @ 0x140492D88 (PfPrefetchRequestVerifyPath.c)
