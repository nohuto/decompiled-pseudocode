/*
 * XREFs of TtmiSessionDeviceListWorker @ 0x140770C10
 * Callers:
...
void __fastcall TtmiSessionDeviceListWorker(__int64 a1)
{
  ...
  __int64 v7; // r9
  int v8; // eax
  void (__fastcall *v9)(void *); // rbp
  _QWORD *v10; // rdx
  void **v11; // rax
  _BYTE v12[48]; // [rsp+30h] [rbp-38h] BYREF
...
LABEL_14:
    ...
    if ( (v8 & 4) != 0 )
    {
      ...
      if ( v9 )
      {
        ...
        TtmpStartCallout((unsigned int)v12, a1, (_DWORD)i, 2, (__int64)v9, 0);
        v9(i[3]);
        TtmpStopCallout(v12, 0LL);
      }
      v10 = *i;
      v11 = (void **)i[1];
      i = v11;
