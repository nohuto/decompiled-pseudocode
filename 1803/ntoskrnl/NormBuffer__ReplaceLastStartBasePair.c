/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x14028E19C
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x1407897FC (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
