/*
 * XREFs of CcInsertIntoCleanSharedCacheMapList @ 0x1400B7344
 * Callers:
...
_QWORD *__fastcall CcInsertIntoCleanSharedCacheMapList(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 152) & 0x3000000) != 0 )
  {
    v5 = (_QWORD *)(a1 + 120);
    v6 = *(_QWORD *)(a1 + 120);
    if ( *(_QWORD *)(v6 + 8) != a1 + 120 || (v7 = *(_QWORD **)(a1 + 128), (_QWORD *)*v7 != v5) )
      __fastfail(3u);
    *v7 = v6;
    *(_QWORD *)(v6 + 8) = v7;
    v8 = *(_QWORD **)(v4 + 8);
  ...
  v10 = *(_QWORD *)(a1 + 136);
  if ( *(_QWORD *)(v10 + 8) != a1 + 136 || (v11 = *(_QWORD **)(a1 + 144), (_QWORD *)*v11 != result) )
    __fastfail(3u);
  *v11 = v10;
  *(_QWORD *)(v10 + 8) = v11;
  v12 = *(_QWORD **)(v3 + 8);
