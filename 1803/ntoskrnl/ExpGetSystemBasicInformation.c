/*
 * XREFs of ExpGetSystemBasicInformation @ 0x1400B27A8
 * Callers:
...
__int64 __fastcall ExpGetSystemBasicInformation(__int64 a1)
{
  ...
  *(_BYTE *)(a1 + 56) = (0x101010101010101LL
  ...
  v7[3] = v10;
  v11 = -1;
  if ( *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * v6) + 6848LL) <= 0xFFFFFFFFuLL )
    v11 = *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * v6) + 6848LL);
  v7[4] = v11;
  if ( *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * v6) + 6856LL) <= 0xFFFFFFFFuLL )
    v9 = *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * v6) + 6856LL);
  v7[5] = v9;
  return v8;
}
