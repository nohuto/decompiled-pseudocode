/*
 * XREFs of PpmInstallNewIdleStates @ 0x1401805B0
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x140180590 (PpmIdleInstallDefaultStates.c)
 * Callees:
 ...
 *     PpmDeepestHardwareIdleState @ 0x140180ADC (PpmDeepestHardwareIdleState.c)
...
LABEL_4:
  ...
  if ( (_DWORD)v6 )
  {
    ...
    v13 = (v12 + 8 * *(_DWORD *)(a2 + 112) + 7) & 0xFFFFFFF8;
    v39 = (v13 + 7 + 24 * v7) & 0xFFFFFFF8;
    v14 = (((v39 + 1000 * v6 + 47) & 0xFFFFFFF8) + 4 * v6 + 15) & 0xFFFFFFF8;
    if ( PpmIdleVetoList )
      v14 += (*(_DWORD *)PpmIdleVetoList * (_DWORD)v6) << 6;
    Size = v14;
    ...
    if ( PoolWithTag )
    {
      ...
      *((_QWORD *)v16 + 9) = 1310740LL;
      ...
      v19 = (char *)v16 + ((((v39 + 1000 * (_DWORD)v6 + 47) & 0xFFFFFFF8) + 4 * (_DWORD)v6 + 15) & 0xFFFFFFF8);
      ...
      do
      {
        ...
        *((_QWORD *)v22 + 5) = v22 + 40;
        if ( v24 )
        {
          *((_DWORD *)v22 + 15) = *v24;
          *((_QWORD *)v22 + 8) = v19;
          v19 += 64 * (unsigned __int64)(unsigned int)*v24;
        }
      ...
      *(_QWORD *)(v44 + 8) = v25;
      ...
      ((void (__fastcall *)(__int64, _DWORD *))off_140398788[0])(v30, v45);
