/*
 * XREFs of VfFaultsSetParameters @ 0x140824F38
 * Callers:
 *     NtSetSystemInformation @ 0x14048D108 (NtSetSystemInformation.c)
 * Callees:
 *     PsSetCreateProcessNotifyRoutine @ 0x140628400 (PsSetCreateProcessNotifyRoutine.c)
 *     ViFaultsAddAllApps @ 0x1408250D4 (ViFaultsAddAllApps.c)
 *     ViFaultsAddAllTags @ 0x140825188 (ViFaultsAddAllTags.c)
