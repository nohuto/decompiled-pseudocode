/*
 * XREFs of SymCryptParallelHashSetNextWork @ 0x1401A5058
 * Callers:
...
LABEL_8:
          ...
          *((_BYTE *)a2 + 8) = 0;
          break;
        case 3:
          v7 = ((__int64 (__fastcall *)(__int64 *, unsigned int *, unsigned int **, char *))a1[3])(a1, v2, a2, &v17);
LABEL_26:
          if ( v7 )
            return v17;
          break;
    ...
    if ( v6[2] != 1 )
    {
      v7 = ((__int64 (__fastcall *)(__int64 *, unsigned int *, unsigned int **, char *))a1[2])(a1, v2, a2, &v17);
      goto LABEL_26;
    }
    *((_QWORD *)v2 + 2) += *((_QWORD *)v6 + 3);
    ...
    if ( v11 )
    {
      v12 = v2 + 8;
      v13 = *((_QWORD *)v6 + 3);
      v14 = *(unsigned int *)(v4 + 40) - v11;
      if ( v14 >= v13 )
        v14 = *((_QWORD *)v6 + 3);
      else
        LODWORD(v13) = *(_DWORD *)(v4 + 40) - v11;
      memmove((char *)v12 + v11, *((const void **)v6 + 2), v14);
      *v2 += v13;
      if ( *v2 == *(_DWORD *)(v4 + 40) )
      {
        a2[4] = v12;
