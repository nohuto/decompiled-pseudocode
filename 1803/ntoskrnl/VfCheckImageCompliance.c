/*
 * XREFs of VfCheckImageCompliance @ 0x140814F64
 * Callers:
          ...
          if ( (*(_DWORD *)(v5 + 36) & 0xA0000000) == 0xA0000000 )
          {
            *(_QWORD *)Str1 = *(_QWORD *)v5;
            ...
            if ( stricmp(Str1, "INIT") || (VfOptionFlags & 0x100) != 0 )
            {
              ...
              _InterlockedIncrement(&dword_1403AD1FC);
            }
          }
          if ( v2 )
          {
              ...
              && (*(_DWORD *)(v5 + 36) & 0x20000000) != 0 )
            {
              *(_QWORD *)Str1 = *(_QWORD *)v5;
              ...
              ViCiPreprocessOptions(
                ...
                v6,
                Str1);
              VfReportIssueWithOptions(0xC4u, 0x2005uLL, a1 + 88, (ULONG_PTR)v6, (__int64)Str1, byte_14039D044);
              if ( (MmVerifierData & 0x1000) != 0 )
                ViTargetIncrementCounter(*(_QWORD *)(a1 + 56), 284LL);
              _InterlockedIncrement(&dword_1403AD204);
            }
          }
          ...
          if ( !SectionAlignment || (SectionAlignment & 0xFFF) != 0 )
          {
            *(_QWORD *)Str1 = *(_QWORD *)v5;
            ...
            ViCiPreprocessOptions(
              ...
              v5,
              Str1);
            VfReportIssueWithOptions(0xC4u, 0x2004uLL, a1 + 88, v5, (__int64)Str1, byte_14039D040);
            if ( (MmVerifierData & 0x1000) != 0 )
              ViTargetIncrementCounter(*(_QWORD *)(a1 + 56), 280LL);
            _InterlockedIncrement(&dword_1403AD200);
          }
          v5 += 40LL;
          ++v7;
        }
