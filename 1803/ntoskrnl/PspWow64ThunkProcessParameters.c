/*
 * XREFs of PspWow64ThunkProcessParameters @ 0x1400CA090
 * Callers:
 *     PspWow64SetupUserProcessAddressSpace @ 0x140069FC4 (PspWow64SetupUserProcessAddressSpace.c)
 * Callees:
  ...
  if ( result >= 0 )
  {
    ...
    *v26 = v7;
    ...
    if ( *((_WORD *)a2 + 112) && *((_QWORD *)a2 + 29) )
    {
      ...
      {
        v16 = v12 - v15;
        memmove(v11, v13, v14 + 4);
        v17 = (_DWORD *)(v14 + *((_QWORD *)a2 + 29) + 4LL);
        v22 = v17;
        v18 = &v11[v14 + 4];
        v21 = v18;
        while ( 1 )
