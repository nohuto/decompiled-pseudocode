/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x140282BF4
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x1401820D0 (PoFxPlatformRequestHandler.c)
 * Callees:
 ...
 *     PopFxAcpiValidateParameters @ 0x14028321C (PopFxAcpiValidateParameters.c)
  ...
  if ( (unsigned __int8)PopFxAcpiValidateParameters() )
  {
    ...
    switch ( *(_DWORD *)a1 )
    {
      ...
      default:
        ...
        v4 = PopFxAcpiUnregisterDevice(v6, *(_QWORD *)(a1 + 16));
        break;
    }
    v1 = 1;
    goto LABEL_15;
