/*
 * XREFs of RtlpNameprepAsciiWorker @ 0x140787E68
 * Callers:
 *     RtlIdnToAscii @ 0x140787AF0 (RtlIdnToAscii.c)
 *     RtlIdnToNameprepUnicode @ 0x140787B20 (RtlIdnToNameprepUnicode.c)
 * Callees:
 ...
 *     FindEmailAt @ 0x14028D9B4 (FindEmailAt.c)
...
LABEL_47:
              if ( v6 > 0 )
              {
                ...
                {
                  v24 = a2[v8 - 1];
                  if ( v24 != 46 && v24 != 12290 && v24 != 0xFF0E && v24 != 0xFF61 )
                    goto LABEL_28;
                }
                if ( !v23 )
                  goto LABEL_28;
