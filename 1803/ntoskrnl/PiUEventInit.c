/*
 * XREFs of PiUEventInit @ 0x1408BC494
 * Callers:
...
__int64 __fastcall PiUEventInit(int a1)
{
  ...
  if ( !a1 )
  {
    ...
    do
    {
      *(_QWORD *)((char *)&unk_1403C7688 + v3) = (char *)&PiUEventDevInterfaceClientList + v3;
      *(_QWORD *)((char *)&PiUEventDevInterfaceClientList + v3) = (char *)&PiUEventDevInterfaceClientList + v3;
      *(_QWORD *)((char *)&unk_1403C7768 + v3) = (char *)&PiUEventDevInstanceClientList + v3;
      *(_QWORD *)((char *)&PiUEventDevInstanceClientList + v3) = (char *)&PiUEventDevInstanceClientList + v3;
      *(_QWORD *)((char *)&unk_1403C7848 + v3) = (char *)&PiUEventDevInstancePropertyClientList + v3;
      ...
      *(_QWORD *)((char *)&unk_1403C7928 + v3) = (char *)&PiUEventDevHandleClientList + v3;
      v3 += 16LL;
      *v4 = v4;
      --v2;
    }
    while ( v2 );
    qword_1403C7A08 = (__int64)&PiUEventUsermodeEventQueue;
    PiUEventUsermodeEventQueue = &PiUEventUsermodeEventQueue;
    qword_1403C7A68 = (__int64)&PiUEventBroadcastEventQueue;
