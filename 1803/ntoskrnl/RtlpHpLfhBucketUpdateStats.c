/*
 * XREFs of RtlpHpLfhBucketUpdateStats @ 0x14029A1F0
 * Callers:
 ...
 *     RtlpLfhBucketUsageUpdate @ 0x14029D300 (RtlpLfhBucketUsageUpdate.c)
 */
...
_BOOL8 __fastcall RtlpHpLfhBucketUpdateStats(__int64 a1, int a2, int a3)
{
  ...
  if ( (*(_QWORD *)(a1 + 8 * v6 + 224) & 1) != 0 )
  {
    ...
    {
      v8 = v7 >> 16;
      if ( (v8 & 0x1F) > 0x10 || (unsigned __int16)v8 > 0xFF00u || (*(_DWORD *)(a1 + 88) & 1) != 0 )
