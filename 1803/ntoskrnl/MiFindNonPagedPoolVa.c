/*
 * XREFs of MiFindNonPagedPoolVa @ 0x1400D7730
 * Callers:
...
unsigned __int64 __fastcall MiFindNonPagedPoolVa(unsigned int a1, unsigned __int64 a2, unsigned int a3, _DWORD *a4)
{
  unsigned int v5; // edi
  ...
  v5 = a3;
  v13 = 0;
  v8 = (unsigned __int16 *)((char *)qword_1403CB6A0 + 2 * a3 * (unsigned __int16)KeNumberNodes);
  v9 = &v8[(unsigned __int16)KeNumberNodes];
  while ( 1 )
  {
    if ( *(_QWORD *)(1984LL * v5 + qword_1403CDF50 + 1808) || !(_DWORD)InitializationPhase )
    {
      if ( (a1 & 0x200) != 0 )
      {
        ...
        {
          *a4 = 0;
          return qword_1403CB6A8[25 * v5 + 20].Alignment + (v10 << 12);
        }
      }
