/*
 * XREFs of SepNormalAccessCheckEx @ 0x140149AA0
 * Callers:
...
LABEL_38:
              ...
              {
                v35 = v23 + 2;
                SepMatchCapability(a2, v60, v26 + 8, *((_DWORD *)v26 + 1), (_BYTE *)v23 + 22, v23 + 2);
                goto LABEL_37;
              }
              v15 = a8;
            }
...
LABEL_14:
            v32 = a2;
LABEL_15:
            if ( SepSidInToken(v32, 0LL, v31, 0, v24, a12, a15) )
              AuthzBasepAddAccessTypeList(v19, v15, 0, v25, *((_DWORD *)v26 + 1), 0);
            goto LABEL_17;
          }
          if ( *v26 != 9 )
            goto LABEL_17;
        ...
        switch ( v29 )
        {
          case 5:
            v37 = *((_DWORD *)v26 + 2);
            v38 = v37 & 1;
            v39 = (unsigned __int64)(v26 + 12) & -(__int64)((v37 & 1) != 0);
            if ( v39 )
            {
              if ( a10
                && SepSidInToken(a2, 0LL, &v26[16 * v38 + ((8LL * (v37 & 2)) | 0xC)], 0, a11, a12, a15)
                && (unsigned __int8)AuthzBasepObjectInTypeList(v39, v19, v15, &v62) )
              {
                AuthzBasepAddAccessTypeList(v19, v15, v62, v25, *((_DWORD *)v26 + 1), 0);
              }
              goto LABEL_38;
            }
            v24 = a11;
            v31 = &v26[16 * v38 + ((8LL * (v37 & 2)) | 0xC)];
            goto LABEL_14;
          case 4:
            if ( !SepSidInToken(a2, 0LL, &v26[4 * (unsigned __int8)v26[13] + 20], 0, v24, a12, a15) )
              break;
            v32 = a3;
            v31 = v26 + 12;
            goto LABEL_15;
          case 1:
LABEL_58:
            if ( SepSidInToken(a2, 0LL, v26 + 8, 1, v24, a12, 0) && (*(_DWORD *)(v19 + 24) & *((_DWORD *)v26 + 1)) != 0 )
            {
              AuthzBasepSetAccessReasons(
                *(_DWORD *)(v19 + 24) & *((_DWORD *)v26 + 1),
                0x20000,
                v25,
                *(_QWORD *)(v19 + 40),
                0);
          ...
          case 6:
            if ( !SepSidInToken(
                    ...
                    0) )
              break;
            v40 = (unsigned __int64)(v26 + 12) & -(__int64)((*((_DWORD *)v26 + 2) & 1) != 0);
            if ( v40 && a10 )
            {
              if ( !(unsigned __int8)AuthzBasepObjectInTypeList(v40, v19, v15, &v62) )
                break;
              v41 = (*(_DWORD *)(v19 + 48LL * v62 + 24) & *((_DWORD *)v26 + 1)) == 0;
            }
            else
            {
              v41 = (*((_DWORD *)v26 + 1) & *(_DWORD *)(v19 + 24)) == 0;
            }
            if ( !v41 )
              goto LABEL_20;
            break;
          case 9:
            ...
            if ( *((unsigned __int16 *)v26 + 1) - v42 == 8 )
              goto LABEL_38;
            if ( a5 && !*a6 )
            ...
            if ( v43 )
              ...
              v47 = 0LL;
            v48 = *((unsigned __int16 *)v26 + 1) - v42 - 8;
            v49 = v42;
            v24 = a11;
          ...
          default:
            if ( a13 && v29 == 10 && KeGetCurrentIrql() < 2u )
            {
              ...
              if ( *((unsigned __int16 *)v26 + 1) - v50 == 8 )
                goto LABEL_38;
              if ( a5 && !*a6 )
                AuthzBasepInitializeResourceClaimsFromSacl(a5, a6);
              v51 = *(_QWORD **)(a2 + 1096);
              ...
              v54 = v51 ? v51[74] : 0LL;
              v55 = v51 ? v51[72] : 0LL;
              v56 = *((unsigned __int16 *)v26 + 1) - v50 - 8;
              v57 = v50;
              v24 = a11;
              AuthzBasepEvaluateAceCondition(
                a2,
