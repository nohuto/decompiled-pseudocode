/*
 * XREFs of SePrivilegePolicyCheck @ 0x14005E5C8
 * Callers:
...
__int64 __fastcall SePrivilegePolicyCheck(int *a1, _DWORD *a2, __int64 *a3, int a4, __int64 a5, char a6)
{
  ...
  if ( (*a1 & 0x1000000) != 0 )
  {
    ...
    if ( !(unsigned __int8)SepPrivilegeCheck(v9, (unsigned int)&v22, 1, 1, a6) )
      return 3221225569LL;
    *a1 &= ~0x1000000u;
    v8 = v13;
    *a2 |= 0x1000000u;
  ...
  if ( (unsigned __int8)SepPrivilegeCheck(v9, (unsigned int)&v22, v13, v13, a6) )
  {
    *a1 &= ~0x80000u;
    v8 += v13;
    *a2 |= 0x80000u;
