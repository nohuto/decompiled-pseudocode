/*
 * XREFs of PopEtInit @ 0x1408C3458
 * Callers:
 ...
 *     PopEtInitializeBuiltinAppId @ 0x14064E350 (PopEtInitializeBuiltinAppId.c)
  ...
  if ( PopEnergyEstimationEnabled )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *((_QWORD *)PsIdleProcess + 232) = v3;
      ...
      v5 = (__int64)(v2 + 76);
      *(_QWORD *)(*(_QWORD *)(v4 + 1856) + 448LL) = v6;
      PopEtInitializeBuiltinAppId(v5, (__int64)L"System");
      v7 = PsInitialSystemProcess[2].ActiveProcessors.Bitmap[15];
      if ( v7 )
        *(_QWORD *)(v7 + 448) = v5;
      for ( i = 0LL; ; i = v10 )
      {
