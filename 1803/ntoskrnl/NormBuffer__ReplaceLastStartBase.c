/*
 * XREFs of NormBuffer__ReplaceLastStartBase @ 0x14028E128
 * Callers:
 ...
 *     Normalization__GetSecondAndThirdDecomposedCharPlane0 @ 0x1407896B4 (Normalization__GetSecondAndThirdDecomposedCharPlane0.c)
 */
