/*
 * XREFs of sub_1407BE900 @ 0x1407BE900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1407BE900(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // eax
          ...
          *(_QWORD *)&v20 = 0LL;
          ...
          if ( !updated )
          {
            if ( (_DWORD)v12 )
            {
              ...
              if ( v14 <= v11 )
                updated = ExpLicUpdateChecksum((__int64)qword_140863E00, v12, &v18);
            }
          }
          if ( updated )
          {
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_1405F3CBC(a1, a2, a3, a4, 4);
  }
  else
  {
    v16 = -1073741772;
