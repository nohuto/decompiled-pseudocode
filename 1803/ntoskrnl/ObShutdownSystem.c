/*
 * XREFs of ObShutdownSystem @ 0x14075870C
 * Callers:
        ...
        if ( (unsigned int)v9 < 0x25 )
        {
          ...
          while ( 1 )
          {
            ...
            else
            {
              ...
              *(v13 - 21) &= ~0x10u;
              ExReleasePushLockEx((ULONG_PTR)(v13 - 32), 0LL, v20, v21);
              ...
              else
              {
                *(_QWORD *)v12 = *(_QWORD *)v22;
                ...
                {
                  LOBYTE(v25) = 0;
                  v27->TypeInfo.SecurityProcedure(
                    v13,
