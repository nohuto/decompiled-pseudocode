/*
 * XREFs of RtlMarkExceptionHandlingPages @ 0x1405F96FC
 * Callers:
 *     MiCaptureImageExceptionValues @ 0x1405F9650 (MiCaptureImageExceptionValues.c)
 * Callees:
 *     RtlSetBits @ 0x14000A290 (RtlSetBits.c)
 *     RtlpSearchFunctionTable @ 0x140161170 (RtlpSearchFunctionTable.c)
...
LABEL_5:
        ...
        for ( i = v11[2]; (i & 1) != 0; i = *(_DWORD *)(v23 + 8) )
        {
          ...
          if ( v23 < a1 || v23 > v6 - 12 )
            return 3221225727LL;
          v24 = 1;
          if ( (unsigned __int64)(((_WORD)v23 - (_WORD)a1) & 0xFFF) + 12 > 0x1000 )
            v24 = 2;
          RtlSetBits(BitMapHeader, (v23 - a1) >> 12, v24);
        }
        v13 = 0;
        while ( 1 )
        {
