/*
 * XREFs of RtlCheckTokenCapability @ 0x140287190
 * Callers:
...
NTSTATUS __cdecl RtlCheckTokenCapability(HANDLE TokenHandle, PSID CapabilitySidToCheck, PBOOLEAN HasCapability)
{
  ...
  struct _SECURITY_SUBJECT_CONTEXT v18; // [rsp+C0h] [rbp-40h] BYREF
...
LABEL_10:
    ...
    v17 = &v25;
    v18.ProcessAuditId = KeGetCurrentThread()->ApcState.Process[1].Header.WaitListHead.Flink;
    v6 = ObReferenceObjectByHandle(TokenHandlea, 8u, (POBJECT_TYPE)SeTokenObjectType, 0, &Object, 0LL);
    v18.PrimaryToken = Object;
    if ( v6 >= 0 )
    {
      ...
      if ( !v7 )
        v6 = -1073741790;
      ObfDereferenceObjectWithTag(v18.PrimaryToken, 0x746C6644u);
      if ( v6 >= 0 )
      {
        if ( !v8 && v13 == 65537 )
          *HasCapability = 1;
