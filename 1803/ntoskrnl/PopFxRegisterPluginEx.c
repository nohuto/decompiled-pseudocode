/*
 * XREFs of PopFxRegisterPluginEx @ 0x140275E7C
 * Callers:
 *     PoFxRegisterPluginEx @ 0x140274AF0 (PoFxRegisterPluginEx.c)
 *     PoFxRegisterPlugin @ 0x14075F4B0 (PoFxRegisterPlugin.c)
 * Callees:
...
LABEL_11:
  ...
  v11 = (a2 & 1) != 0 ? 4 : 1;
  v12 = v11;
  v25 = (56 * v11 + 128 + 7LL) & 0xFFFFFFFFFFFFFFF8uLL;
  PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, 176LL * v11 + v25, 0x4D584650u);
  v14 = PoolWithTag;
  if ( PoolWithTag )
  {
    memset(PoolWithTag, 0, 176LL * v11 + v25);
    v15 = v11;
    v16 = &v14[v25];
    v17 = &v14[v25];
    v18 = (__int64)&v14[v25 + 24];
    do
    {
      *(_QWORD *)(v18 - 8) = 0LL;
      *(_BYTE *)(v18 - 8) = 8;
    ...
    if ( EmergencyWorkerThread >= 0 )
    {
      ...
      *v23 = v14;
      ...
      if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&PopFxPluginLock, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
        ExfTryToWakePushLock((volatile signed __int64 *)&PopFxPluginLock, v24, v21, v22);
