/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x140738A04
 * Callers:
...
char PnpTraceDeviceRemovalForResetComplete()
{
  ...
  LOBYTE(v0) = TraceLoggingProviderEnabled(&stru_140397160, 0, 0x400000000000uLL);
  if ( (_BYTE)v0 )
  {
    v0 = *(_QWORD *)(v1 + 184);
    if ( v0 )
    ...
    {
      LOBYTE(v0) = TlgKeywordOn(&stru_140397160, 0x400000000000uLL);
      if ( (_BYTE)v0 )
      {
        v6 = *(_DWORD *)(v2 + 300);
        v7 = *(_DWORD *)(v3 + 164);
        ...
        v31 = 2LL;
        v33[1] = v4;
        LOBYTE(v0) = TlgWrite(&stru_140397160, &unk_1403097AA, 0LL, 0LL, 0xDu, &pData);
      }
    }
  }
  return v0;
