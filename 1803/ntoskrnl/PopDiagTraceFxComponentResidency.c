/*
 * XREFs of PopDiagTraceFxComponentResidency @ 0x14027C4C4
 * Callers:
 *     PoFxSetComponentResidency @ 0x140274B60 (PoFxSetComponentResidency.c)
 * Callees:
...
void __fastcall PopDiagTraceFxComponentResidency(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( EtwEventEnabled(PopDiagHandle, &POP_ETW_EVENT_COMPONENT_RESIDENCY) )
    {
      ...
      v10 = 8;
      v7 = 4;
      EtwWriteEx(v3, &POP_ETW_EVENT_COMPONENT_RESIDENCY, 0LL, 1u, 0LL, 0LL, 3u, &UserData);
    }
  }
}
