/*
 * XREFs of WmipAddDataSource @ 0x1405FE7D0
 * Callers:
...
LABEL_9:
    ...
    if ( v16 )
    {
      while ( 1 )
      {
        ...
        if ( *v16 == v16 )
          break;
        if ( (_QWORD **)v24[1] != v16 || (v34 = (_QWORD *)*v24, *(_QWORD **)(*v24 + 8LL) != v24) )
          __fastfail(3u);
        *v16 = v34;
        v34[1] = v16;
        ...
        while ( 1 )
        {
          ...
          if ( (_QWORD *)*v35 == v35 )
            break;
          if ( (_QWORD *)v36[1] != v35 || (v37 = *v36, *(_QWORD **)(*v36 + 8LL) != v36) )
            __fastfail(3u);
          *v35 = v37;
          *(_QWORD *)(v37 + 8) = v35;
      ...
      while ( 1 )
      {
        ...
        if ( *v25 == v25 )
          break;
        if ( (_QWORD **)v26[1] != v25 || (v38 = (_QWORD *)*v26, *(_QWORD **)(*v26 + 8LL) != v26) )
          __fastfail(3u);
        *v25 = v38;
        v38[1] = v25;
