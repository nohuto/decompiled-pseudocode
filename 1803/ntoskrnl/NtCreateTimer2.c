/*
 * XREFs of NtCreateTimer2 @ 0x14052E740
 * Callers:
 *     NtCreateIRTimer @ 0x140614678 (NtCreateIRTimer.c)
 * Callees:
 *     ExpExTimerAttributesAreValid @ 0x140086000 (ExpExTimerAttributesAreValid.c)
