/*
 * XREFs of MiPageFileNoFreeSpace @ 0x14025FBA0
 * Callers:
  ...
  if ( v7 == 1 )
  {
    ...
    *a2 = 2575857425LL;
    ...
    if ( (*(_BYTE *)(a1 + 204) & 0x10) == 0 )
    {
      ...
      if ( v11 > (*((_QWORD *)&v9 + 1) & 0xFFFFFFFFFFFFFFF8uLL) && v10 < *(_QWORD *)(v2 + 6152) )
      {
        MiCauseOverCommitPopup(v2);
LABEL_22:
        *(_QWORD *)&v9 = *(_QWORD *)(v2 + 7528);
        if ( (unsigned __int64)v9 < *(_QWORD *)(v2 + 6152) )
          *(_QWORD *)&v9 = MiIssuePageExtendRequest(v2, v4, 6LL, 0);
        return v9;
      }
      if ( *(_QWORD *)(v2 + 7536) >= 0x1000uLL )
      {
        v12 = *(_DWORD *)(v2 + 6872);
        v13 = 0;
        if ( v12 )
