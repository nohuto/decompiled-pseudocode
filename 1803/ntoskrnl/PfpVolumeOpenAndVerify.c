/*
 * XREFs of PfpVolumeOpenAndVerify @ 0x140492250
 * Callers:
 *     PfpPrefetchRequestPerform @ 0x140491840 (PfpPrefetchRequestPerform.c)
 * Callees:
 *     PfVolumeSupportedForPrefetch @ 0x140005F48 (PfVolumeSupportedForPrefetch.c)
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( (DevicePowerState & 0xC0000000) != 0xC0000000 )
    {
      if ( DevicePowerState == 259 )
        KeBugCheckEx(0x191u, 0x1330uLL, 0LL, 0LL, 0LL);
...
LABEL_6:
        ...
        if ( (DevicePowerState & 0xC0000000) == 0xC0000000 )
          goto LABEL_15;
        if ( DevicePowerState == 259 )
          KeBugCheckEx(0x191u, 0x1379uLL, 0LL, 0LL, 0LL);
