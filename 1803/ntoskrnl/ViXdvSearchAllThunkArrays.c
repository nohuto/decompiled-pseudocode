/*
 * XREFs of ViXdvSearchAllThunkArrays @ 0x1408164F4
 * Callers:
 *     ViXdvBindXdvDDIWrappers @ 0x1408160E4 (ViXdvBindXdvDDIWrappers.c)
 * Callees:
 *     ViXdvSearchAndReplaceThunkArray @ 0x140816560 (ViXdvSearchAndReplaceThunkArray.c)
 *     ViXdvSearchAndReplaceThunkArrayOrderDependent @ 0x1408165AC (ViXdvSearchAndReplaceThunkArrayOrderDependent.c)
 */
