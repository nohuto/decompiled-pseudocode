/*
 * XREFs of RtlpQueryTimeZoneInformationWorker @ 0x140588E84
 * Callers:
 *     EtwpAddLogHeader @ 0x14058896C (EtwpAddLogHeader.c)
 *     ExpRefreshTimeZoneInformation @ 0x14062FA98 (ExpRefreshTimeZoneInformation.c)
 *     RtlQueryDynamicTimeZoneInformation @ 0x1407866F0 (RtlQueryDynamicTimeZoneInformation.c)
 *     RtlQueryTimeZoneInformation @ 0x140786840 (RtlQueryTimeZoneInformation.c)
 * Callees:
...
__int64 __fastcall RtlpQueryTimeZoneInformationWorker(char *a1, size_t Size)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    *((_DWORD *)a1 + 38) = -16;
    ...
    RegistryValues = RtlpQueryRegistryValues(0x40000000LL, (const WCHAR *)Handle, (__int64)v14, 0LL);
