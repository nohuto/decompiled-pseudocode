/*
 * XREFs of PopDiagTraceCsEnterReason @ 0x1407666E4
 * Callers:
...
char PopDiagTraceCsEnterReason()
{
  ...
  if ( PopDiagHandleRegistered )
  {
    ...
    if ( result )
    {
      *(_QWORD *)&UserData.Size = 4LL;
      ...
      v28 = &v13;
      v29 = 4LL;
      result = EtwWrite(v6, &POP_ETW_EVENT_CS_ENTER_REASON, 0LL, 6u, &UserData);
      v3 = v9;
      v1 = v10;
      v2 = v11;
      v4 = v12;
  ...
  if ( pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v40 = 4LL;
      v42 = 4LL;
      return TlgWrite(&pCallbackContext, &unk_14030B8F0, 0LL, 0LL, 8u, &pData);
    }
  }
  return result;
}
