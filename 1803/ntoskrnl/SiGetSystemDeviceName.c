/*
 * XREFs of SiGetSystemDeviceName @ 0x1405695B4
 * Callers:
 *     SyspartDirectGetSystemPartition @ 0x140569590 (SyspartDirectGetSystemPartition.c)
 *     SyspartDirectGetSystemDisk @ 0x1405F26F0 (SyspartDirectGetSystemDisk.c)
 *     SyspartGetFirmwarePartition @ 0x14060A358 (SyspartGetFirmwarePartition.c)
 *     SyspartDirectGetFirmwareSystemPartition @ 0x140614320 (SyspartDirectGetFirmwareSystemPartition.c)
