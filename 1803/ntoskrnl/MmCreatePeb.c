/*
 * XREFs of MmCreatePeb @ 0x1404E97D4
 * Callers:
...
__int64 __fastcall MmCreatePeb(_KPROCESS *a1, char *a2, _QWORD *a3, _QWORD *a4)
{
  ...
  _BYTE v63[48]; // [rsp+158h] [rbp-70h] BYREF
  ...
  *((_WORD *)a4 + 4) = v6;
  ...
  v43 = NtGlobalFlag;
  v46 = qword_1403CB658;
  v48 = (unsigned int)dword_14044B18C;
  v49 = qword_14044B1A0;
  v50 = qword_14044B198;
  v51 = *a2;
  v52 = a2[3];
  ...
  {
    v24 = _InterlockedExchangeAdd(&dword_1403CB654, 1u) + 1;
    do
    {
      v25 = v24 & 0x3F;
      v26 = 1LL << v25;
  ...
  *(_QWORD *)(v10 + 192) = qword_1403CB658;
  *(_QWORD *)(v10 + 792) = (unsigned int)dword_14044B18C;
  *(_QWORD *)(v10 + 240) = v47;
  *(_QWORD *)(v10 + 216) = qword_14044B1A0;
  *(_QWORD *)(v10 + 224) = qword_14044B198;
  *(_DWORD *)(v10 + 236) = 265;
