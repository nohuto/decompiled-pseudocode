/*
 * XREFs of PiValidatePowerRelations @ 0x1406039F4
 * Callers:
...
__int64 *__fastcall PiValidatePowerRelations(__int64 a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( *v2 == (__int64 ***)v2 )
      break;
    if ( v3[1] != (__int64 **)v2 || (v12 = *v3, (*v3)[1] != (__int64 *)v3) )
      __fastfail(3u);
    *v2 = (__int64 ***)v12;
    v12[1] = (__int64 *)v2;
    v13 = v17;
  ...
  do
  {
    ...
    while ( 1 )
    {
      ...
      if ( *v6 == (__int64 ***)v6 )
        break;
      if ( v7[1] != (__int64 **)v6 || (v14 = *v7, (*v7)[1] != (__int64 *)v7) )
        __fastfail(3u);
      *v6 = (__int64 ***)v14;
      v14[1] = (__int64 *)v6;
      v15 = v17;
...
LABEL_16:
    if ( result == (__int64 *)&v16 )
      break;
    if ( (__int64 **)result[1] != &v16 || (v9 = (__int64 *)*result, *(__int64 **)(*result + 8) != result) )
      __fastfail(3u);
    v16 = (__int64 *)*result;
    v9[1] = (__int64)&v16;
    v10 = result[2] + 32;
