/*
 * XREFs of WmiQueryTraceInformation @ 0x14060CC60
 * Callers:
  ...
  if ( TraceInformationClass > TraceHandleByNameClass )
  {
    ...
    if ( v16 )
    {
      ...
      if ( !v18 )
      {
        ...
        *((_OWORD *)TraceInformation + 1) = *(_OWORD *)off_1407FC1B0;
        *((_OWORD *)TraceInformation + 2) = *(_OWORD *)&off_1407FC1C0;
        *((_OWORD *)TraceInformation + 3) = *(_OWORD *)&off_1407FC1D0;
        *((_OWORD *)TraceInformation + 4) = *(_OWORD *)off_1407FC1E0;
        *((_OWORD *)TraceInformation + 5) = *(_OWORD *)&off_1407FC1F0;
        *((_OWORD *)TraceInformation + 6) = *(_OWORD *)off_1407FC200;
...
LABEL_23:
    ...
    {
      v44 += *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v47 + 139) + 4112LL) + ((unsigned __int64)i << 6) + 8)
                       + 8LL * v53);
      v56 = v44;
    }
