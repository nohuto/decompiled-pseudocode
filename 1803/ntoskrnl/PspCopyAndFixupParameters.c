/*
 * XREFs of PspCopyAndFixupParameters @ 0x1404EA450
 * Callers:
...
__int64 __fastcall PspCopyAndFixupParameters(ULONG_PTR a1, void **a2, __int64 a3)
{
  ...
  {
    v9 = ObDuplicateObject(a1, *((void **)v4 + 2), Process, &v30, 0, 0, 6, PreviousMode);
  ...
  if ( a2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *v24 )
      {
        ...
        {
          result = ObDuplicateObject(a1, v25, Process, &v30, 0, 0, 6, PreviousMode);
          v26 = v30;
          v21 = v4 + 8;
        }
        if ( (int)result < 0 )
