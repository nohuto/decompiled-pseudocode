/*
 * XREFs of PfGenerateTrace @ 0x1405EC870
 * Callers:
...
__int64 __fastcall PfGenerateTrace(__int64 a1, int a2)
{
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&PfTGlobals, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)&PfTGlobals, v10, v11, v12);
  ...
  else
  {
    v8 = -1073741177;
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&PfTGlobals, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)&PfTGlobals, v5, v6, v7);
    KeAbPostRelease((ULONG_PTR)&PfTGlobals);
    KeLeaveCriticalRegion();
  }
  return v8;
