/*
 * XREFs of sub_1407D2744 @ 0x1407D2744
 * Callers:
...
__int64 __fastcall sub_1407D2744(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  int v4; // edi
  unsigned int v7; // r8d
...
LABEL_26:
    ...
    v16 = KeWaitForSingleObject(&Mutex, UserRequest, 1, 0, &Timeout);
    if ( v16 >= 0 && v16 != 192 && v16 != 258 )
    {
      if ( stru_14039E160.Header.SignalState || !dword_140861124 )
      {
        v17 = MEMORY[0xFFFFF78000000320];
        TimeIncrement = KeQueryTimeIncrement();
        dword_140861124 = 1;
        qword_140861130 = v17 * TimeIncrement / 10000;
