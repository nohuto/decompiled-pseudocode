/*
 * XREFs of PspWriteTebImpersonationInfo @ 0x14059AE50
 * Callers:
...
__int64 __fastcall PspWriteTebImpersonationInfo(__int64 a1, __int64 a2)
{
  ...
  _BYTE v18[48]; // [rsp+40h] [rbp-58h] BYREF
  ...
  if ( v4 && (*(_DWORD *)(a1 + 116) & 0x400) == 0 )
  {
    ...
    if ( a1 == a2 || ExAcquireRundownProtection((PEX_RUNDOWN_REF)(a1 + 1720)) )
    {
      do
      {
        v6 = *(_DWORD *)(a1 + 1744) & 8;
      ...
      if ( a1 != a2 )
        ExReleaseRundownProtection((PEX_RUNDOWN_REF)(a1 + 1720));
    }
    if ( v13 )
