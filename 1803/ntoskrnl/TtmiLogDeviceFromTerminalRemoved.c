/*
 * XREFs of TtmiLogDeviceFromTerminalRemoved @ 0x140775954
 * Callers:
...
char __fastcall TtmiLogDeviceFromTerminalRemoved(int a1, int a2, __int64 a3, int a4)
{
  ...
  {
    LOBYTE(v4) = TlgKeywordOn(&stru_140861840, 1uLL);
    if ( (_BYTE)v4 )
    {
      ...
      v27 = 8;
      v30 = 4;
      LOBYTE(v4) = TlgWrite(&stru_140861840, &unk_14030CE8A, 0LL, 0LL, 7u, &pData);
    }
  }
  return (char)v4;
}
