/*
 * XREFs of ObInitSystem @ 0x1408A15F4
 * Callers:
 ...
 *     ObpInitInfoBlockOffsets @ 0x14089ECB0 (ObpInitInfoBlockOffsets.c)
...
char ObInitSystem()
{
  ...
  if ( !(_DWORD)InitializationPhase )
  {
    ...
    while ( v3 );
    ObpDefaultObject = 0;
    qword_1403AC670 = (__int64)&qword_1403AC668;
    qword_1403AC668 = (__int64)&qword_1403AC668;
    byte_1403AC662 = 6;
    dword_1403AC664 = 1;
    ...
    qword_1403AC698 = (__int64)ObpProcessRemoveObjectDpcWorker;
    ...
    qword_14044CBA8 = (__int64)MmBadPointer;
