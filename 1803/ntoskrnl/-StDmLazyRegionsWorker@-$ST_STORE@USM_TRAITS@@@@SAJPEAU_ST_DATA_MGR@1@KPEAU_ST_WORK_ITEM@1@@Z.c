/*
 * XREFs of ?StDmLazyRegionsWorker@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@KPEAU_ST_WORK_ITEM@1@@Z @ 0x1402A52E8
 * Callers:
...
LABEL_29:
        ...
        {
          v16 = SMKM_STORE<SM_TRAITS>::SmStReleaseVirtualRegion(*(_QWORD *)(a1 + 800), v13, v8 | 2u, v14);
        }
        else
        {
          v17 = *(_QWORD *)(v14 + 6216);
