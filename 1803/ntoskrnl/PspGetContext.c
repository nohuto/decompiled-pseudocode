/*
 * XREFs of PspGetContext @ 0x1405B8B34
 * Callers:
...
int __fastcall PspGetContext(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (v3 & 0x100040) == 0x100040 )
  {
    if ( (*(_BYTE *)(a1 + 368) & 1) != 0 )
    {
      ...
      v13 = (_DWORD *)(a3 + v10 + 720);
      v14 = MEMORY[0xFFFFF780000003D8] & 0xFFFFFFFFFFFFFFFCuLL;
      if ( v12 )
        KiCopyXStateArea((__int64)v13, v14, v12);
      else
        RtlXSave(v13, v14, 0LL);
    }
