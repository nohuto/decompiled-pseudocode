...
LABEL_9:
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)&PoolWithTag[1].Next + 1) = v12;
    ...
    v32 = (struct _SLIST_ENTRY **)*((_QWORD *)&a7->Next + 1);
    if ( *v32 != a7 )
      __fastfail(3u);
    PoolWithTag->Next = a7;
...
LABEL_10:
  ...
  else
  {
    ...
    while ( a7->Next != v53 )
    {
      v23 = (struct _SLIST_ENTRY *)*((_QWORD *)&a7->Next + 1);
      v49 = v23;
      ...
      *v24 = a7;
      v44 = (struct _SLIST_ENTRY *)*((_QWORD *)&v23[1].Next + 1);
      v25 = v44;
      v19[4] = v23[2].Next;
