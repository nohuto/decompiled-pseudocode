/*
 * XREFs of SeSecureBootRegisterPolicy @ 0x1408C6C78
 * Callers:
 ...
 *     SepSecureBootBuildRules @ 0x1408E1458 (SepSecureBootBuildRules.c)
...
__int64 __fastcall SeSecureBootRegisterPolicy(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  qword_1403D1670 = *(_QWORD *)(BugCheckParameter2 + 16);
...
LABEL_23:
  ...
  if ( v6[18] || v6[19] )
  {
    qword_1403EC8E8 = (__int64)v10 + v10[13] + 60;
...
LABEL_27:
      if ( qword_1403E98E8 )
      {
        ExFreePoolWithTag(qword_1403E98E8, 0);
        qword_1403E98E8 = 0LL;
      }
