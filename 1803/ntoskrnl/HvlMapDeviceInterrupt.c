/*
 * XREFs of HvlMapDeviceInterrupt @ 0x140229C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HvlMapDeviceInterrupt(__int64 a1, _OWORD *a2, __int64 *a3, _OWORD *a4)
{
  ...
  _BYTE v24[288]; // [rsp+1C0h] [rbp+C0h] BYREF
  ...
  while ( 1 )
  {
    ...
    v11 = (_QWORD *)HvlpAcquireHypercallPage(v18, 1, (__int64)v24, 144LL);
    memset(v11, 0, 0x48uLL);
    *(_OWORD *)(v11 + 5) = *a2;
    *(_OWORD *)(v11 + 7) = a2[1];
    if ( a3 )
    {
      if ( (unsigned int)HvlpAffinityToHvProcessorSet(v22, v11 + 8, (v18[0].LowPart & 2) != 0 ? 64 : 4016) == -1 )
      {
        ...
        *(_OWORD *)(v11 + 5) = *a2;
        *(_OWORD *)(v11 + 7) = a2[1];
        HvlpAffinityToHvProcessorSet(v22, v11 + 8, 4016LL);
      }
      *((_DWORD *)v11 + 15) |= 2u;
    }
    else
