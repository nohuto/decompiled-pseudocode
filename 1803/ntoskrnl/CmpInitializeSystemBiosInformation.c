/*
 * XREFs of CmpInitializeSystemBiosInformation @ 0x1408DD818
 * Callers:
...
void __fastcall CmpInitializeSystemBiosInformation(__int64 a1)
{
  ...
  v2 = *(unsigned __int16 *)(v1 + 2400);
  v3 = *(unsigned __int16 *)(v1 + 2416);
  v4 = *(unsigned __int16 *)(v1 + 2432);
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + v3 + v2 + 8, 0x20204D43u);
  v7 = PoolWithTag;
  if ( PoolWithTag )
  {
    v8 = *(const void **)(v1 + 2408);
    v13 = 0;
    CmpBuildRegMultiSz((__int64)PoolWithTag, v6, &v13, v8, v2);
    CmpBuildRegMultiSz((__int64)v7, v9, &v13, *(const void **)(v1 + 2424), v3);
    CmpBuildRegMultiSz((__int64)v7, v10, &v13, *(const void **)(v1 + 2440), v4);
    v11 = v13;
    *(_WORD *)&v7[v13] = 0;
