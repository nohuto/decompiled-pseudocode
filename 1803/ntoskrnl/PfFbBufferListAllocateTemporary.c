/*
 * XREFs of PfFbBufferListAllocateTemporary @ 0x14007A354
 * Callers:
 *     PfpEventHandleOutOfBuffers @ 0x14007A330 (PfpEventHandleOutOfBuffers.c)
 *     PfpSectInfoHandleOutOfBuffers @ 0x140614640 (PfpSectInfoHandleOutOfBuffers.c)
 * Callees:
