/*
 * XREFs of McTemplateK0pz @ 0x14023DA3C
 * Callers:
...
NTSTATUS McTemplateK0pz(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  if ( !v15 )
    v3 = L"NULL";
  v10 = v3;
  return McGenEventWriteKM(MS_KernelPnP_Provider_Context, &KMPnPEvt_ProcessNewDevice_InstancePath, 0LL, 3u, &v7);
}
