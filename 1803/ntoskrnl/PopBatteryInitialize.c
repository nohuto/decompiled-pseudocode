/*
 * XREFs of PopBatteryInitialize @ 0x140763C80
 * Callers:
...
NTSTATUS __fastcall PopBatteryInitialize(__int64 a1)
{
  ...
  *(_QWORD *)v18 = *(unsigned int *)(a1 + 108);
  ...
  if ( result >= 0 )
  {
    ...
    *(_DWORD *)(a1 + 104) = 3;
    v8 = (_QWORD *)(a1 + 64);
    v9 = (_QWORD *)qword_1403AA298;
    if ( *(__int64 **)qword_1403AA298 != &qword_1403AA290 )
      __fastfail(3u);
    v8[1] = qword_1403AA298;
    *v8 = &qword_1403AA290;
    *v9 = v8;
    ++dword_1403AA274;
    ++dword_1403AA2D8;
    result = 0;
    qword_1403AA298 = (__int64)v8;
    byte_1403AA278 = 1;
  }
  return result;
}
