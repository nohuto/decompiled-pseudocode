/*
 * XREFs of SepMaximumAccessCheckEx @ 0x140149980
 * Callers:
    ...
    do
    {
      ...
      if ( *v23 )
      {
        if ( v25 == 5 )
        {
          ...
          {
            if ( !a9
              || !SepSidInToken(a1, 0LL, &v23[16 * v35 + ((8LL * (v34 & 2)) | 0xC)], 0, v15, a12, a15)
          ...
          v37 = &v23[16 * v35 + ((8LL * (v34 & 2)) | 0xC)];
LABEL_30:
          v26 = SepSidInToken(a1, 0LL, v37, 0, v15, a12, a15);
          goto LABEL_8;
        }
        if ( v25 != 4 )
        {
...
LABEL_10:
          ...
          if ( v25 != 9 )
          {
            ...
            if ( ((v60 + 1) & 0xFFFFFFFD) != 0 )
              goto LABEL_12;
LABEL_90:
            if ( !SepSidInToken(a1, 0LL, v23 + 8, 1, v15, a12, 0) )
              goto LABEL_12;
            goto LABEL_91;
          }
...
LABEL_25:
        ...
        v38 = a12;
        if ( !SepSidInToken(a1, 0LL, &v23[4 * (unsigned __int8)v23[13] + 20], 0, v15, a12, a15) )
          goto LABEL_12;
        v26 = SepSidInToken(v59, 0LL, v23 + 12, 0, 0, v38, a15);
      }
      else
      {
        if ( !v19 && !v15 )
...
LABEL_24:
        ...
        v26 = SepSidInToken(a1, 0LL, v23 + 8, 0, v15, a12, a15);
      }
LABEL_8:
      if ( v26 )
      {
