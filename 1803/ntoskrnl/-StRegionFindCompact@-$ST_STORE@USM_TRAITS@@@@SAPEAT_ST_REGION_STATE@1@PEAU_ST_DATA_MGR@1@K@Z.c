/*
 * XREFs of ?StRegionFindCompact@?$ST_STORE@USM_TRAITS@@@@SAPEAT_ST_REGION_STATE@1@PEAU_ST_DATA_MGR@1@K@Z @ 0x140097DDC
 * Callers:
...
LABEL_28:
    while ( 1 )
    {
      NextForwardRunClearCapped = RtlFindNextForwardRunClearCapped(a1 + 1072, v17, 0xFFFFFFFFLL, &v23);
      ...
      if ( v23 < NextForwardRunClearCapped + v23 )
      {
        ...
        {
          if ( (v20 & 0x40000) == 0
            || !(unsigned int)SMKM_STORE<SM_TRAITS>::SmStIsRegionBusy(*(_QWORD *)(a1 + 800), v17, v5, v10) )
          {
...
LABEL_18:
  ...
  do
  {
    ...
    if ( (v11 & 0x40000) == 0
      || !(unsigned int)SMKM_STORE<SM_TRAITS>::SmStIsRegionBusy(*(_QWORD *)(a1 + 800), v4, v5, v10) )
    {
      v12 = *v10;
