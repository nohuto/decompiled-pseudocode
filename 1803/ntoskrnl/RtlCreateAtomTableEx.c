/*
 * XREFs of RtlCreateAtomTableEx @ 0x1400ADD30
 * Callers:
 *     RtlCreateAtomTable @ 0x1405531D0 (RtlCreateAtomTable.c)
 * Callees:
 *     memset @ 0x1401BCC40 (memset.c)
 *     RtlpFreeAtom @ 0x1404EAF6C (RtlpFreeAtom.c)
 *     RtlpAllocateAtom @ 0x1404EAF9C (RtlpAllocateAtom.c)
 *     RtlpInitializeLockAtomTable @ 0x1405531EC (RtlpInitializeLockAtomTable.c)
