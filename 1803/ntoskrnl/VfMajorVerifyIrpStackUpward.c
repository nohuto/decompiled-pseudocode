/*
 * XREFs of VfMajorVerifyIrpStackUpward @ 0x140823040
 * Callers:
        ...
        int a5))(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD)
{
  ...
  if ( *a2 > 0x1Bu )
    ...
    v10 = v5;
  v11 = (void (__fastcall *)(__int64, unsigned __int8 *, _QWORD, __int64, int, int))*((_QWORD *)&unk_140842E98 + 12 * v10);
  if ( v11 )
    v11(a1, a2, *(_QWORD *)(a3 + 8), a3, a4, a5);
  result = qword_140843918;
  if ( qword_140843918 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _DWORD))qword_140843918(
                                                                                     a1,
                                                                                     a2,
                                                                                     *(_QWORD *)(a3 + 8),
                                                                                     a3,
