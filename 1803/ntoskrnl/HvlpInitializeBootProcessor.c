/*
 * XREFs of HvlpInitializeBootProcessor @ 0x140227A0C
 * Callers:
...
__int64 __fastcall HvlpInitializeBootProcessor(__int64 a1)
{
  ...
  if ( HvlHypervisorConnected )
  {
    ...
    v11 = 0LL;
    v9 = 0LL;
    if ( (HvlpFlags & 0x100000) != 0 && (HvlpFlags & 2) == 0 )
    {
      v4 = ((__int64 (__fastcall *)(__int64, __int64, __int64 *, __int64))qword_1403987F8)(a1, 1LL, &v10, 4LL);
      if ( !v4 )
        return 3221225626LL;
    ...
    {
      v6 = ((__int64 (__fastcall *)(__int64, __int64, __int64 *))qword_1403987F8)(a1, 1LL, &v11);
      if ( v6 )
    ...
    if ( (HvlpRootFlags & 0x10) != 0 )
    {
      ...
      if ( (int)HvlpMapStatisticsPage(2LL, v8, &v9) >= 0 )
        v1 = ((__int64 (__fastcall *)(__int64, __int64, __int64))qword_140398800)(v9, 1LL, 4LL);
