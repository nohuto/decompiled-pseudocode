/*
 * XREFs of PfpVolumePrefetchMetadata @ 0x140491BC8
 * Callers:
 ...
 *     PfpFileSetupObjectAttributes @ 0x1404A1460 (PfpFileSetupObjectAttributes.c)
...
__int64 __fastcall PfpVolumePrefetchMetadata(_QWORD *a1, unsigned int a2)
{
  ...
  int v33; // r10d
  __int64 v34; // r11
  SIZE_T v35; // [rsp+48h] [rbp-C0h]
  __int64 v36; // [rsp+60h] [rbp-A8h]
  int v37; // [rsp+68h] [rbp-A0h]
  ULONG_PTR v38[2]; // [rsp+70h] [rbp-98h] BYREF
  char v39; // [rsp+80h] [rbp-88h] BYREF
  _BYTE v40[120]; // [rsp+90h] [rbp-78h] BYREF
  ...
  if ( (*(_DWORD *)(v7 + 8 * v4 + 12) & 0xFFFFFFFE) != 0 )
  {
    do
    {
      ...
      if ( PfpCheckPrefetchAbort(a1)
        || (*(_DWORD *)(*a1 + 80LL) & 4) != 0
        && (unsigned __int64)(a1[6] + a1[7] + PfpGetPageListCount(a1 + 11, 0LL, v32)) < 0x80 )
      {
LABEL_40:
        v18 = -1073741248;
        goto LABEL_15;
      ...
      LODWORD(v35) = 0;
      v18 = IopXxxControlFile(*(HANDLE *)((v34 << 6) + a1[2]), (__int64)v38, 590112, Src, 8 * v33 + 16, 0LL, v35, 0);
      if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
        PfpUpdateRepurposedByPrefetch(a1 + 6, Src[1]);
      if ( v18 < 0 )
        goto LABEL_15;
      if ( v18 == 259 )
        KeBugCheckEx(0x191u, 0x15E5uLL, 0LL, 0LL, 0LL);
    }
    while ( (unsigned int)v10 < *(_DWORD *)(v7 + 8 * v4 + 12) >> 1 );
    if ( v3 )
    {
      ...
      if ( *(_DWORD *)(v3 + 16) )
      {
        while ( 1 )
        {
          ...
          if ( PfpCheckPrefetchAbort(a1)
            || (*(_DWORD *)(*a1 + 80LL) & 4) != 0
            && (unsigned __int64)(a1[6] + a1[7] + PfpGetPageListCount(a1 + 11, 0LL, v41)) < 0x80 )
          {
            goto LABEL_40;
          }
          LODWORD(v35) = 0;
          v18 = IopXxxControlFile(*(HANDLE *)((v36 << 6) + a1[2]), (__int64)v38, 590112, Src, 8 * v31 + 16, 0LL, v35, 0);
          if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
            PfpUpdateRepurposedByPrefetch(a1 + 6, Src[1]);
          if ( v18 < 0 )
            goto LABEL_15;
          if ( v18 == 259 )
            KeBugCheckEx(0x191u, 0x164AuLL, 0LL, 0LL, 0LL);
          if ( v23 >= *(_DWORD *)(v3 + 16) )
            break;
          v22 = v44;
        }
  ...
  if ( (*(_DWORD *)(v7 + 8 * v4 + 12) & 0xFFFFFFFE) != 0 )
  {
    do
    {
      ...
      if ( (*v17 & 2) != 0 )
      {
        PfpFileSetupObjectAttributes((_DWORD)a1, (_DWORD)v17, a2, (unsigned int)&v39, (__int64)v40, (__int64)&v43);
