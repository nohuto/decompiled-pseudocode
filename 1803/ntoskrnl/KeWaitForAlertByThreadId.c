/*
 * XREFs of KeWaitForAlertByThreadId @ 0x140088D40
 * Callers:
 *     PsDispatchIumService @ 0x14015CBE4 (PsDispatchIumService.c)
 *     NtWaitForAlertByThreadId @ 0x14052EE70 (NtWaitForAlertByThreadId.c)
 * Callees:
...
__int64 __fastcall KeWaitForAlertByThreadId(unsigned __int8 a1, _QWORD *a2, void *a3)
{
  ...
  if ( !a2 || *a2 )
  {
    ...
    while ( 1 )
    {
      ...
      result = KiCommitThreadWait(v8, &CurrentThread->320, v10, v9);
