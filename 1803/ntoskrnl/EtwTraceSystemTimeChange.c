/*
 * XREFs of EtwTraceSystemTimeChange @ 0x1404765F8
 * Callers:
...
char __fastcall EtwTraceSystemTimeChange(__int64 *a1, _QWORD *a2, int a3)
{
  ...
  {
    LOBYTE(v3) = TlgKeywordOn(&stru_1403977A0, 0x400000000000uLL);
    if ( (_BYTE)v3 )
    {
      v7 = *a1;
      v22 = 0;
      ...
      v24 = 8;
      v27 = 4;
      LOBYTE(v3) = TlgWrite(&stru_1403977A0, &unk_14030E614, 0LL, 0LL, 5u, &pData);
    }
  }
