/*
 * XREFs of AuthzBasepCompareUnicodeStringOperands @ 0x140044640
 * Callers:
 ...
 *     AuthzBasepGetOperandStringCaseForEvaluation @ 0x1400447E8 (AuthzBasepGetOperandStringCaseForEvaluation.c)
 *     AuthzBasepEqualUnicodeStringCaseSensitive @ 0x1400C7664 (AuthzBasepEqualUnicodeStringCaseSensitive.c)
 *     AuthzBasepCompareUnicodeStringCaseSensitive @ 0x1402C4048 (AuthzBasepCompareUnicodeStringCaseSensitive.c)
