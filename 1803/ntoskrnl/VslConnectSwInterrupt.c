/*
 * XREFs of VslConnectSwInterrupt @ 0x1408B7998
 * Callers:
 *     PipInitializeCoreDriversAndElam @ 0x1408B556C (PipInitializeCoreDriversAndElam.c)
 *     KiConnectSwInterrupt @ 0x1408E0110 (KiConnectSwInterrupt.c)
 * Callees:
 *     KeInitializeEnumerationContext @ 0x140033F90 (KeInitializeEnumerationContext.c)
