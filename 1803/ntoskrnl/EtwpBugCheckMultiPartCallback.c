  ...
  if ( v7 )
  {
    ...
    if ( *(_DWORD *)(v7 + 8) <= *v17 )
      *(_DWORD *)(v4[1] + 48) = v17[2];
      ...
      v17[12] = v17[1];
    *((_DWORD *)ReasonSpecificData + 10) = *(_DWORD *)(v4[1] + 48);
    if ( *((_DWORD *)ReasonSpecificData + 2) )
      ReasonSpecificData[4] = v4[1];
    v18 = *(_QWORD *)(v4[1] + 56);
    v14 = v18 == v16 + 96;
    v15 = v18 - 56;
    goto LABEL_26;
      ...
      && (*(_DWORD *)(v10 + 316) & 1) == 0 )
    {
      ...
      else
      {
        ...
        *((_DWORD *)ReasonSpecificData + 10) = v11;
        if ( !*((_DWORD *)ReasonSpecificData + 2) )
          goto LABEL_19;
        if ( v11 <= *((_DWORD *)ReasonSpecificData + 3) )
        {
          v12 = *ReasonSpecificData;
          *(_DWORD *)v12 = 32223201;
          ...
          *(_OWORD *)(v12 + 32) = *(_OWORD *)(v10 + 320);
          ...
          ReasonSpecificData[4] = *ReasonSpecificData;
          *((_DWORD *)ReasonSpecificData + 10) = v11;
          *((_DWORD *)ReasonSpecificData + 2) = v11;
LABEL_19:
          v13 = *(_QWORD *)(v10 + 96);
          v14 = v13 == v10 + 96;
          v15 = v13 - 56;
...
LABEL_30:
  v19 = *((_DWORD *)ReasonSpecificData + 14);
  if ( (unsigned int)*(unsigned __int16 *)v4 >= *(_DWORD *)(EtwpHostSiloState + 16) )
  {
    *((_DWORD *)ReasonSpecificData + 14) = v19 & 0xFFFFFFFE;
    v4[1] = 0LL;
    *((_BYTE *)v4 + 2) = 0;
    *(_WORD *)v4 = 0;
  }
  ...
  {
    *((_DWORD *)ReasonSpecificData + 14) = v19 | 1;
  }
}
