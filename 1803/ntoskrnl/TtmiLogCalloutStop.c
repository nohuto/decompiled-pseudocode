/*
 * XREFs of TtmiLogCalloutStop @ 0x140774C7C
 * Callers:
...
char __fastcall TtmiLogCalloutStop(int a1, int a2, __int64 a3, int a4, int a5, unsigned __int64 a6)
{
  ...
  if ( a6 > 0x1312D00 )
  {
    ...
    {
      LOBYTE(v6) = TlgKeywordOn(&stru_140861840, 0x400000000001uLL);
      if ( (_BYTE)v6 )
      {
        ...
        v49[2] = 4LL;
        v49[4] = 8LL;
        LOBYTE(v6) = TlgWrite(&stru_140861840, &unk_14030D98D, 0LL, 0LL, 0xAu, &v37);
      }
    }
  }
  else if ( stru_140861840.LevelPlus1 > 5 )
  {
    LOBYTE(v6) = TlgKeywordOn(&stru_140861840, 1uLL);
    if ( (_BYTE)v6 )
    {
      ...
      v36[2] = 4LL;
      v36[4] = 8LL;
      LOBYTE(v6) = TlgWrite(&stru_140861840, &unk_14030DAD4, 0LL, 0LL, 0xAu, &pData);
    }
  }
  return (char)v6;
}
