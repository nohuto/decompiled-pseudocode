/*
 * XREFs of MiCoalescePlaceholderAllocations @ 0x14074D2C8
 * Callers:
...
__int64 __fastcall MiCoalescePlaceholderAllocations(__int64 a1, _QWORD *a2, unsigned __int64 a3, char a4)
{
  char v4; // di
  ...
  if ( v7 >= 2 )
  {
    Address = MiLocateAddress((unsigned __int64)a2);
    v9 = Address;
    if ( (_QWORD *)((*(unsigned int *)(Address + 24) | ((unsigned __int64)*(unsigned __int8 *)(Address + 32) << 32)) << 12) == a2 )
    {
      i = Address;
      v11 = 0;
      while ( 1 )
      {
        ...
        if ( (unsigned int)++v11 >= v7 )
        {
          ...
          *(_BYTE *)(v9 + 33) = a3 >> 44;
          ...
          while ( v19 );
          MiUnlockVad((__int64)CurrentThread, v9, v29, v30);
          return 0;
        }
      }
    }
  ...
  v13 = -1073741800;
LABEL_39:
  MiUnlockVadRange(a1, (__int64)a2, v7, 1);
