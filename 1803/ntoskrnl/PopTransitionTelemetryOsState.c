/*
 * XREFs of PopTransitionTelemetryOsState @ 0x140624944
 * Callers:
...
__int64 __fastcall PopTransitionTelemetryOsState(int a1, int a2)
{
  ...
  v4 = 0;
  if ( !TraceLoggingProviderEnabled(&pCallbackContext, 0, 0x800000000000uLL) || !byte_1403A960C )
    return v4;
  switch ( a1 )
  {
    case 2:
      if ( a2 == 2 )
      {
        if ( (unsigned int)dword_1403998B4 < MEMORY[0xFFFFF7800000037C] )
        {
          if ( !dword_1403998B0 )
            dword_1403998B0 = TelemetryCoverageStringHashInternal(off_1403998A8, &v32);
          v6 = &off_1403998A8;
          goto LABEL_66;
        }
      }
      else if ( (unsigned int)dword_1403998CC < MEMORY[0xFFFFF7800000037C] )
      {
        if ( !dword_1403998C8 )
          dword_1403998C8 = TelemetryCoverageStringHashInternal(off_1403998C0, &v33);
        v6 = &off_1403998C0;
        goto LABEL_66;
      }
      break;
    case 3:
      ...
      {
        case 3:
          if ( (unsigned int)dword_140399884 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140399880 )
              dword_140399880 = TelemetryCoverageStringHashInternal(off_140399878, &v37);
            v6 = &off_140399878;
            goto LABEL_66;
          }
          break;
        case 4:
          if ( (unsigned int)dword_14039989C < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140399898 )
              dword_140399898 = TelemetryCoverageStringHashInternal(off_140399890, &v36);
            v6 = &off_140399890;
            goto LABEL_66;
          }
          break;
        case 5:
          if ( (unsigned int)dword_140399854 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140399850 )
              dword_140399850 = TelemetryCoverageStringHashInternal(off_140399848, &v35);
            v6 = &off_140399848;
            goto LABEL_66;
          }
          break;
        case 6:
          if ( (unsigned int)dword_14039986C < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140399868 )
              dword_140399868 = TelemetryCoverageStringHashInternal(off_140399860, &v40);
            v6 = &off_140399860;
            goto LABEL_66;
          }
          break;
        default:
          if ( a2 == 8 && (unsigned int)dword_140399824 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140399820 )
              dword_140399820 = TelemetryCoverageStringHashInternal(off_140399818, &v39);
            v6 = &off_140399818;
            goto LABEL_66;
          }
          break;
    ...
    case 4:
      ...
      {
        case 3:
          if ( (unsigned int)dword_14039983C < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140399838 )
              dword_140399838 = TelemetryCoverageStringHashInternal(off_140399830, &v38);
            v6 = &off_140399830;
            goto LABEL_66;
          }
          break;
        case 4:
          if ( (unsigned int)dword_1403997F4 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_1403997F0 )
              dword_1403997F0 = TelemetryCoverageStringHashInternal(off_1403997E8, &v19);
            v6 = &off_1403997E8;
            goto LABEL_66;
          }
          break;
        case 5:
          if ( (unsigned int)dword_14039980C < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140399808 )
              dword_140399808 = TelemetryCoverageStringHashInternal(off_140399800, &v20);
            v6 = &off_140399800;
            goto LABEL_66;
          }
          break;
        case 6:
          if ( (unsigned int)dword_1403997C4 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_1403997C0 )
              dword_1403997C0 = TelemetryCoverageStringHashInternal(off_1403997B8, &v21);
            v6 = &off_1403997B8;
            goto LABEL_66;
          }
          break;
        default:
          if ( a2 == 8 && (unsigned int)dword_1403997DC < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_1403997D8 )
              dword_1403997D8 = TelemetryCoverageStringHashInternal(off_1403997D0, &v22);
            v6 = &off_1403997D0;
LABEL_66:
  ...
  v4 = dword_1403A9608;
  if ( a1 != 5 || dword_1403A95D0 == 1 || (unsigned int)(dword_1403A95D0 - 4) <= 1 )
  {
    v8 = (KiQueryUnbiasedInterruptTime() - qword_1403A95E8) / 0x2710uLL;
    v9 = v8 - qword_1403A95F8;
    v10 = (MEMORY[0xFFFFF78000000008] - qword_1403A95E0) / 0x2710uLL;
    qword_1403A95F8 = v8;
    v11 = v10 - qword_1403A95F0;
    v33 = v10 - qword_1403A95F0;
    v12 = v10 - qword_1403A95F0;
    qword_1403A95F0 = v10;
    if ( v9 <= v11 )
      v12 = v9;
    v32 = v12;
    v21 = v7 + dword_1403A9600;
    dword_1403A9600 += v7;
    v19 = dword_1403A95D0;
    v20 = dword_1403A95D4;
    if ( a1 != 5 )
