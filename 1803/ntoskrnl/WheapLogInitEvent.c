/*
 * XREFs of WheapLogInitEvent @ 0x14064E1A4
 * Callers:
...
void WheapLogInitEvent()
{
  ...
  v8 = 1064 * dword_1403D17CC;
  PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)(1064 * dword_1403D17CC), 0x61656857u);
  if ( PoolWithTag )
  {
    v1 = (__int64 *)qword_1403D17D0;
    for ( i = 0; v1 != &qword_1403D17D0; v1 = (__int64 *)*v1 )
    {
      v3 = 8LL;
      v4 = v1;
    ...
    UserData.Ptr = (ULONGLONG)&dword_1403D17CC;
