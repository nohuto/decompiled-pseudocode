/*
 * XREFs of KiFloatingErrorFault @ 0x1401B8900
 * Callers:
 *     KiFloatingErrorFaultShadow @ 0x1402CF880 (KiFloatingErrorFaultShadow.c)
 * Callees:
...
void __fastcall __noreturn KiFloatingErrorFault(__int64 a1, unsigned __int64 Object)
{
  ...
  if ( (v16 & 1) != 0 )
  {
    ...
    v4 = *(_QWORD *)&CurrentThread->Process[2].Spare2[7];
