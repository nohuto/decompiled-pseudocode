/*
 * XREFs of WdipSemGetGuidKey @ 0x1407A1E48
 * Callers:
...
__int64 __fastcall WdipSemGetGuidKey(__int64 a1, unsigned int *a2)
{
  ...
  if ( a1 && a2 )
  {
    ...
    v4 = *(_DWORD *)a1
       + ((320411091 * *(unsigned __int16 *)(a1 + 6) + 1) & 0xFFFF0000 | ((-393795277
                                                                         * (unsigned int)*(unsigned __int16 *)(a1 + 6)
                                                                         + 12345) >> 16))
       + ((320411091 * *(unsigned __int16 *)(a1 + 4) + 1) & 0xFFFF0000 | ((-393795277
    ...
    {
      v6 = *v5++;
      v4 += (320411091 * v6 + 1) & 0xFFFF0000 | ((unsigned int)(-393795277 * v6 + 12345) >> 16);
      --v3;
    }
    while ( v3 );
