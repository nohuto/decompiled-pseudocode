/*
 * XREFs of CmpDoFileRead @ 0x140006B1C
 * Callers:
 *     CmpFileRead @ 0x140496AB0 (CmpFileRead.c)
 * Callees:
...
LABEL_12:
  ...
  while ( 1 )
  {
    ...
    if ( IoStatusBlock.Information != Length )
    {
      ...
      CmRegistryIODebug = 1;
      dword_140862880 = Information - Length;
      result = 3221225489LL;
      qword_140862878 = (__int64)FileHandle;
      return result;
    }
LABEL_11:
    v7 = v19;
