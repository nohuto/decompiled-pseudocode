/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x14078689C
 * Callers:
 *     ExpRefreshTimeZoneInformation @ 0x14062FA98 (ExpRefreshTimeZoneInformation.c)
 *     RtlSetDynamicTimeZoneInformation @ 0x140786860 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x140786880 (RtlSetTimeZoneInformation.c)
