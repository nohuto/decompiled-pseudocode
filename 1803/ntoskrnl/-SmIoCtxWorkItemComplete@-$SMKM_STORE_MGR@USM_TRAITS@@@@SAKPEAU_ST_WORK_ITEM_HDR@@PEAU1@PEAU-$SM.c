/*
 * XREFs of ?SmIoCtxWorkItemComplete@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAKPEAU_ST_WORK_ITEM_HDR@@PEAU1@PEAU?$SMKM_STORE@USM_TRAITS@@@@J@Z @ 0x14008FE10
 * Callers:
...
LABEL_8:
  if ( v12 )
  {
    ...
    if ( (xmmword_1404660F0 & 2) != 0 )
      SmFpFree(&dword_140465FC0, 5LL, v4, v12, BugCheckOnFailure, Priority);
  }
  if ( v8 )
