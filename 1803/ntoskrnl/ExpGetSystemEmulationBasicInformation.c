/*
 * XREFs of ExpGetSystemEmulationBasicInformation @ 0x1400B2608
 * Callers:
...
__int64 __fastcall ExpGetSystemEmulationBasicInformation(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 40) = v2 - 1;
  ...
  v10[3] = v12;
  v13 = -1;
  if ( *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * v8) + 6848LL) <= 0xFFFFFFFFuLL )
    v13 = *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * v8) + 6848LL);
  v10[4] = v13;
  if ( *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * v8) + 6856LL) <= 0xFFFFFFFFuLL )
    v11 = *(_QWORD *)(*(_QWORD *)(qword_1403CBD88 + 8LL * v8) + 6856LL);
  v10[5] = v11;
  return v9;
}
