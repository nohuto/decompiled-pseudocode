/*
 * XREFs of KeFoldProcessStatisticsThread @ 0x14006FA98
 * Callers:
 *     PspThreadDelete @ 0x140511DD0 (PspThreadDelete.c)
 * Callees:
 *     RtlTimelineBitmapMerge @ 0x14006FBB4 (RtlTimelineBitmapMerge.c)
 */
...
signed __int64 __fastcall KeFoldProcessStatisticsThread(__int64 a1)
{
  ...
  *(_QWORD *)(v1 + 600) += *(unsigned int *)(a1 + 340);
  ...
  if ( v3 )
  {
    RtlTimelineBitmapMerge(*(_QWORD *)(v1 + 1856) + 272LL, v3 + 192);
    v6 = v5 - (_QWORD)v4;
    v7 = 4LL;
    do
    {
