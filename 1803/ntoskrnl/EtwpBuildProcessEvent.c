/*
 * XREFs of EtwpBuildProcessEvent @ 0x1404F8968
 * Callers:
        ...
        _QWORD *TokenInformation)
{
  ...
  *(_QWORD *)(a4 + 24) = v17;
  ...
  if ( v18 && ((v39 = *(_WORD *)(v18 + 8), v39 == 332) || v39 == 452) )
  {
    *v15 = 2;
    v19 = 6;
  }
  ...
  *(_QWORD *)(a6 + 16) = v23;
  *(_DWORD *)(a6 + 28) = 0;
  v25 = (char *)&Process[1].ActiveProcessors.Bitmap[12];
  Length = -1LL;
  *(_DWORD *)(a6 + 24) = v24;
  do
    ++Length;
  ...
  if ( (_DWORD)Length == 14 )
  {
    v36 = (const UNICODE_STRING *)Process[1].ActiveProcessors.Bitmap[15];
    if ( v36 )
    {
      if ( v36->Length && RtlUnicodeStringToAnsiString(DestinationString, v36, 1u) >= 0 )
      {
        ...
        LODWORD(Length) = (_DWORD)Buffer - v38 + Length;
      }
    }
  }
  *(_DWORD *)(a6 + 40) = Length;
  ...
  *a10 = 0;
  if ( Process[1].ActiveProcessors.Bitmap[1] )
  {
    if ( a3 )
    {
      EtwpQueryProcessCommandLine((__int64)Process, (__int64)a10);
      v27 = *a10;
      if ( *a10 )
      {
        v16 = 5;
