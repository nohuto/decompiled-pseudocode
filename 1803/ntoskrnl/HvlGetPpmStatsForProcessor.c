/*
 * XREFs of HvlGetPpmStatsForProcessor @ 0x140157930
 * Callers:
...
__int64 __fastcall HvlGetPpmStatsForProcessor(struct _KPRCB *a1, _QWORD *a2, _QWORD *a3)
{
  ...
  {
    v6 = HIDWORD(xmmword_1403E5A30);
    StatisticsPage = a1->StatisticsPage;
    do
    {
      v8 = StatisticsPage[v6];
      *a3 = a1->StatisticsPage[(unsigned int)xmmword_1403E5A40];
    }
    while ( v8 != StatisticsPage[v6] );
    v9 = DWORD1(xmmword_1403E5A40);
  ...
  {
    ReferenceTime = HvlGetReferenceTime();
    v13 = (unsigned int)xmmword_1403E5A40;
    *a2 = ReferenceTime - a1->StatisticsPage[DWORD1(xmmword_1403E5A30)];
