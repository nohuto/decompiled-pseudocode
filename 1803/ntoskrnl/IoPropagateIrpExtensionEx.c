/*
 * XREFs of IoPropagateIrpExtensionEx @ 0x1400A9EB0
 * Callers:
 *     IoPropagateIrpExtension @ 0x1400A9E90 (IoPropagateIrpExtension.c)
 * Callees:
...
__int64 __fastcall IoPropagateIrpExtensionEx(__int64 a1, __int64 a2, __int64 a3, char a4)
{
  ...
  {
    if ( (a4 & 1) != 0 )
      *((_DWORD *)IopAllocateIrpExtension(a2, 2) + 1) = v4;
    return 0LL;
  }
  if ( (a4 & 2) != 0 && *(char *)(a1 + 71) >= 0 && (*(_BYTE *)(v4 + 2) & 1) != 0 )
  {
    ...
    if ( !IrpExtension )
      return 3221225626LL;
    *(_OWORD *)(IrpExtension + 12) = *(_OWORD *)(v4 + 24);
  }
  if ( (a4 & 1) != 0 )
  {
    v9 = *(_QWORD *)(a1 + 200);
    if ( *(char *)(a1 + 71) < 0 || v9 && (*(_BYTE *)(v9 + 2) & 4) != 0 )
      *((_DWORD *)IopAllocateIrpExtension(a2, 2) + 1) = *(_DWORD *)(v4 + 4);
  }
  if ( (a4 & 4) != 0 )
  {
    v10 = *(_QWORD *)(a1 + 200);
...
LABEL_14:
  ...
  if ( a3 % v11 )
    return 3221225485LL;
  v21 = IopAllocateIrpExtension(a2, 7);
  if ( v21 )
  {
    *(_OWORD *)(v21 + 20) = *(_OWORD *)(v4 + 40);
    *((_QWORD *)v21 + 5) += a3 / v11;
    return 0LL;
  }
  return 3221225626LL;
