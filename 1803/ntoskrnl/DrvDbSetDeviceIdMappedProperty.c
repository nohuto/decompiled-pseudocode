/*
 * XREFs of DrvDbSetDeviceIdMappedProperty @ 0x1407F2DB4
 * Callers:
        ...
        int a7)
{
  ...
  v20 = 5 * v15;
  v21 = &(&off_1402F4170)[5 * v15];
  if ( !v21 )
    return (unsigned int)-1073741802;
  v22 = a5;
  if ( a5 != *((_DWORD *)v21 + 2) && a5 )
    return (unsigned int)-1073741811;
  if ( a3 || (v23 = DrvDbOpenObjectRegKey(a1, 0LL, 5u, a2, 3, 0, &Handle, 0LL), v8 = Handle, v14 = v23, v23 >= 0) )
  {
    if ( *(_DWORD *)(a4 + 16) != 3 )
      goto LABEL_34;
...
LABEL_34:
      if ( a3 )
        v8 = a3;
      v26 = DrvDbSetRegValueMappedProperty(v20, v8, v21, v22, a6, a7);
    }
    else
    {
      if ( v22 == 8210 )
