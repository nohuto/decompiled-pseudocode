/*
 * XREFs of EtwpTraceMessageVa @ 0x140061BC0
 * Callers:
 *     NtTraceEvent @ 0x1400611F0 (NtTraceEvent.c)
 *     WmiTraceMessage @ 0x1400CF420 (WmiTraceMessage.c)
 *     WmiTraceMessageVa @ 0x1402ADD70 (WmiTraceMessageVa.c)
 * Callees:
        ...
        unsigned __int8 a6)
{
  ...
  _BYTE v54[88]; // [rsp+B0h] [rbp-58h] BYREF
...
LABEL_14:
  ...
  v30 = EtwpReserveTraceBuffer(v48, v29, (unsigned int)v54, (unsigned int)v50, 0);
  v31 = 0;
  v32 = *(volatile signed __int32 **)(v48 + 280);
  if ( v32 )
  {
...
LABEL_81:
  ...
  EtwpReleaseTraceBuffer(v54, v37, v39);
