/*
 * XREFs of ExpWatchLicenseInfoWork @ 0x1407BC8A0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall ExpWatchLicenseInfoWork(__int64 a1)
{
  ...
  unsigned int v32; // [rsp+C8h] [rbp+Fh]
  ...
  if ( !ExpSetupModeDetected )
  {
    ...
    v28 = 576;
    NtClose(v3);
    v4 = CmOpenKey((HANDLE *)a1, 131103, (__int64)&v25, 0, 0LL);
    if ( v4 < 0 )
    ...
    v6 = 2 * v32 + 56;
    if ( v6 < v32 || v6 < 2 * (unsigned __int64)(v32 + 16) )
      v2 = 1;
    ...
    if ( v11 < (unsigned __int64)v32 + v9 )
    {
LABEL_19:
      v2 = 1;
      v12 = v11;
    ...
    for ( i = 0; ; i = v15 )
    {
      ...
      if ( v20 >= 0 )
      {
        ...
        v28 = 576;
        v29 = 0LL;
        v18 = CmOpenKey(&KeyHandle, 131103, (__int64)&v25, 0, 0LL);
        if ( v18 < 0 )
