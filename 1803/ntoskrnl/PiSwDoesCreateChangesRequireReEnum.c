/*
 * XREFs of PiSwDoesCreateChangesRequireReEnum @ 0x140735320
 * Callers:
...
char __fastcall PiSwDoesCreateChangesRequireReEnum(__int64 a1, __int64 a2)
{
  ...
  if ( v13 != v14 && (!v13 || !v14 || !(unsigned __int8)PnpCompareMultiSz(v13, v14)) )
    return 1;
  v15 = *(const WCHAR **)(a1 + 32);
  v16 = *(const WCHAR **)(a2 + 48);
  if ( v15 != v16 && (!v15 || !v16 || !(unsigned __int8)PnpCompareMultiSz(v15, v16)) )
    return 1;
  return v5;
}
