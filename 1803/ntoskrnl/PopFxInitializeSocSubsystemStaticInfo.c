/*
 * XREFs of PopFxInitializeSocSubsystemStaticInfo @ 0x14075F7F0
 * Callers:
...
LABEL_29:
    ...
    v6 = (int)(344 * v4 + 24);
    PoolWithTag = (unsigned int *)ExAllocatePoolWithTag(PagedPool, v6, 0x4D584650u);
    v5 = PoolWithTag;
    if ( PoolWithTag )
    {
...
LABEL_18:
      ...
      if ( v3 )
        goto LABEL_29;
      v20 = (unsigned int **)qword_1403AB4D8;
      if ( *(__int64 **)qword_1403AB4D8 != &SocSubsystemsList )
        __fastfail(3u);
      *(_QWORD *)v5 = &SocSubsystemsList;
      *((_QWORD *)v5 + 1) = v20;
      *v20 = v5;
      qword_1403AB4D8 = (__int64)v5;
    }
    else
    {
