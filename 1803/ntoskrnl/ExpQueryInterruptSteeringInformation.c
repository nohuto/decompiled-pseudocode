/*
 * XREFs of ExpQueryInterruptSteeringInformation @ 0x14065179C
 * Callers:
 *     ExpQuerySystemInformation @ 0x1405AE850 (ExpQuerySystemInformation.c)
 * Callees:
 *     KeIntSteerIsSteeringEnabled @ 0x1400D2ED8 (KeIntSteerIsSteeringEnabled.c)
 *     KeIntSteerGetSteeringMode @ 0x1401696B8 (KeIntSteerGetSteeringMode.c)
 */
