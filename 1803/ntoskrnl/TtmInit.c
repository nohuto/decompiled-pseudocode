...
LABEL_11:
    v3 = ObCreateObjectTypeEx(&UnicodeString, v8, 0LL, (__int16 *)0x80, &TtmpQueueObjectType);
    if ( v3 < 0 )
...
LABEL_20:
  ...
  return TraceLoggingRegisterEx(&stru_140861840, (TLG_PENABLECALLBACK)TtmpTraceLoggingCallback, 0LL);
}
