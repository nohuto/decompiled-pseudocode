/*
 * XREFs of KiIntSteerCalculateDistribution @ 0x140034EA0
 * Callers:
 ...
 *     KiIntSteerComputeCpuSet @ 0x140249F98 (KiIntSteerComputeCpuSet.c)
 */
...
__int64 __fastcall KiIntSteerCalculateDistribution(unsigned __int16 *a1, unsigned int a2)
{
  ...
  for ( Base = (__int64)&Base;
        ;
        *((_DWORD *)&Base + v14) = KiProcessorNumberToIndexMappingTable[64 * (unsigned __int16)v11
                                                                      + (unsigned __int8)v13] )
  {
...
LABEL_7:
  ...
  v18 = alloca(v17);
  v19 = (ULONG_PTR *)KiIntTrackRootList;
  v20 = alloca(v17);
  v21 = 0;
  for ( i = (unsigned int)(KiIntTrackRootCount - 1); v19 != &KiIntTrackRootList; v19 = (ULONG_PTR *)*v19 )
  {
    if ( v19[24] )
    {
      v30 = v21++;
      *(&Base + v30) = (__int64)v19;
    }
    else
    {
      *(&Base + i) = (__int64)v19;
  ...
  if ( KiIntTrackRootCount )
  {
    ...
    {
      v25 = *(&Base + v9);
      if ( *(_BYTE *)(v25 + 132) && (!*(_QWORD *)(v25 + 136) || (int)KiIntSteerComputeCpuSet(*(&Base + v9)) < 0) )
      {
        if ( *(_QWORD *)(v25 + 192)
