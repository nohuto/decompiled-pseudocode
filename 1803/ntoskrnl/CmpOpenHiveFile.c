/*
 * XREFs of CmpOpenHiveFile @ 0x14049E1B8
 * Callers:
 ...
 *     SeTokenImpersonationLevel @ 0x1405DFF60 (SeTokenImpersonationLevel.c)
...
LABEL_62:
    ...
    if ( Status >= 0 )
    {
      ...
      if ( !v38 )
      {
        ...
        if ( v47 )
        {
          Status = CmpQueryFileSecurityDescriptor(FileHandle, v47);
          if ( Status < 0 )
          {
LABEL_41:
            v27 = FileHandle;
