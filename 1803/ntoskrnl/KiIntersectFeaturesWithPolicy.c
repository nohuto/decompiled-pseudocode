/*
 * XREFs of KiIntersectFeaturesWithPolicy @ 0x14047C8A4
 * Callers:
 ...
 *     KiIsXSaveFeatureAllowed @ 0x14047C9E8 (KiIsXSaveFeatureAllowed.c)
 *     KiLoadPolicyFromImage @ 0x14047CA7C (KiLoadPolicyFromImage.c)
 */
