/*
 * XREFs of EtwpEnableKernelTrace @ 0x14057BB2C
 * Callers:
...
LABEL_57:
  ...
  {
    v14 = v27[0] | 0x2000000;
    qword_140396390 = (__int64)EtwpTraceFileIo;
    v13 = *(_DWORD *)a2;
    v27[0] |= 0x2000000u;
  }
  if ( (v13 & 0x4000000) != 0 )
  {
    v14 |= 0x4000000u;
    qword_140396388 = (__int64)EtwpTraceFileIo;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x200) != 0 )
  {
    v14 |= 0x200u;
    qword_140396380 = (__int64)EtwpTraceFileName;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x100) != 0 )
  {
    ...
    qword_140396370 = (__int64)EtwpTraceRedirectedIo;
    v13 = *(_DWORD *)a2;
    v27[0] = v14;
  }
  if ( (v13 & 0x400) != 0 )
  {
    v14 |= 0x400u;
    qword_1403CADB8 = (__int64)EtwpTraceIoInit;
    v27[0] = v14;
  }
  v15 = *((_DWORD *)a2 + 4);
  v16 = v27[4];
  ...
  {
    v16 = v27[4] | 1;
    qword_1403CADC0 = (__int64)EtwpTraceOpticalIo;
    v15 = *((_DWORD *)a2 + 4);
    v27[4] |= 1u;
  }
  if ( (v15 & 2) != 0 )
  {
    v16 |= 2u;
    qword_1403CADC8 = (__int64)EtwpTraceOpticalIoInit;
    v27[4] = v16;
  }
  ...
  {
    v16 |= 0x400000u;
    qword_140396350 = (__int64)EtwpTraceFltIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x80000) != 0 )
  {
    v16 |= 0x80000u;
    qword_140396358 = (__int64)EtwpTraceFltIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x100000) != 0 )
  {
    v16 |= 0x100000u;
    qword_140396360 = (__int64)EtwpTraceFltTimedIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x200000) != 0 )
  {
    v16 |= 0x200000u;
    qword_140396368 = (__int64)EtwpTraceFltTimedIo;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x1000000) != 0 )
  {
    v16 |= 0x1000000u;
    qword_14039C760 = (__int64)EtwpTraceWdf;
    v17 = *((_DWORD *)a2 + 4);
    v27[4] = v16;
  }
  if ( (v17 & 0x2000000) != 0 )
  {
    v16 |= 0x2000000u;
    qword_14039C768 = (__int64)EtwpTraceWdf;
    v27[4] = v16;
  }
  if ( (*((_DWORD *)a2 + 2) & 0x8000000) != 0 )
  {
    v27[2] |= 0x8000000u;
    qword_14039C770 = (__int64)EtwpSystemTraceWdf;
  }
  v18 = *(_DWORD *)a2;
...
LABEL_50:
    ...
    if ( (v19 & 0x400) != 0 )
    {
      for ( i = 0; i < EtwpPmcProfile; ++i )
        KeStartProfile((ULONG_PTR)qword_1403A20B8 + 248 * i);
      v27[1] = v10 | 0x400;
    }
