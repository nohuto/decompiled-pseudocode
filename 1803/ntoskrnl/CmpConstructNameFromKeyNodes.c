/*
 * XREFs of CmpConstructNameFromKeyNodes @ 0x1404ABDD0
 * Callers:
...
__int64 __fastcall CmpConstructNameFromKeyNodes(__int64 a1, _QWORD *a2)
{
  ...
  _mm_lfence();
  if ( v3 >= 2 )
    v4 = *(_QWORD *)(*(_QWORD *)(a1 + 24) + 8LL * (v3 - 2));
  else
    v4 = *(_QWORD *)(a1 + 8LL * v3 + 8);
  v5 = *(_WORD *)(v4 + 58);
  v6 = 0;
  v7 = 0LL;
  if ( v5 >= 2 && v5 != 1 )
        ...
        else
        {
          ...
          if ( v17 )
          {
            ...
            if ( v31 )
            {
              do
              {
                CmpSetKcbAtLayerHeight(v37, v32, *(_QWORD *)(v31 + 16));
                v31 = *(_QWORD *)(v33 + 24);
                v32 = v34 - 1;
              }
              while ( v31 );
          ...
          {
            memmove((void *)(*((_QWORD *)v11 + 1) + 2LL * v18), v20, 2LL * v15);
          }
          else
          {
            v21 = 2LL * v18;
            if ( v20 == (const void *)1 )
            {
              ...
              if ( (*(_DWORD *)v35 & 1) != 0 )
                CmpCopyCompressedName(v36, 2 * v15, (unsigned __int8 *)(v35 + 26), v15);
              else
                memmove(v36, (const void *)(v35 + 26), 2LL * v15);
            }
            else
            {
              ...
              {
                memmove((void *)(v21 + *((_QWORD *)v11 + 1)), (const void *)(v22 + 76), 2LL * v15);
              }
