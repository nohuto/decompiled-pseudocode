/*
 * XREFs of sub_1407D4598 @ 0x1407D4598
 * Callers:
...
__int64 __fastcall sub_1407D4598(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  int v4; // ebx
  unsigned int v7; // r8d
...
LABEL_26:
    ...
    if ( v16 >= 0 && v16 != 192 )
    {
      ...
      do
      {
        v18 = KeWaitForSingleObject(&Mutex, UserRequest, 1, 1u, &Interval);
        v17 = v18;
      }
      while ( v18 == 257 );
    ...
    *(_DWORD *)a4 = 0;
    ...
    if ( v34 + 4 < v34 )
      return v7;
    if ( (unsigned __int64)(v34 + 12) <= v31 + (unsigned __int64)*(unsigned int *)(a4 + 4) )
    {
      *(_DWORD *)v34 = 8;
      *(_QWORD *)v9 = v41;
      ++*(_DWORD *)a4;
