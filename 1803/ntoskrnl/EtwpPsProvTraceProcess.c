/*
 * XREFs of EtwpPsProvTraceProcess @ 0x1404F7F94
 * Callers:
...
int __fastcall EtwpPsProvTraceProcess(PEPROCESS Process, __int64 a2, unsigned int *a3, __int64 a4, __int16 a5)
{
  ...
  __int64 v22; // rcx
  int v23; // ecx
  $F12672F908DF45F4CF0245344C922020 *p_SecureState; // rax
  ...
  char v43[24]; // [rsp+98h] [rbp-70h] BYREF
  ...
  $F12672F908DF45F4CF0245344C922020 *v76; // [rsp+1C8h] [rbp+C0h]
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  if ( ((a5 - 769) & 0xFFFD) != 0 )
  {
    if ( a5 == 770 )
    {
      ...
      PsQueryStatisticsProcess(Process, v43);
      v55 = 8LL;
