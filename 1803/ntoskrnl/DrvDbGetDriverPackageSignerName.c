/*
 * XREFs of DrvDbGetDriverPackageSignerName @ 0x1407F2304
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( (*v8)[4] == 7 )
    {
      v11 = *(_QWORD *)v10 - *(_QWORD *)&DEVPKEY_DriverPackage_SignerName;
      if ( *(_QWORD *)v10 == *(_QWORD *)&DEVPKEY_DriverPackage_SignerName )
        v11 = *((_QWORD *)v10 + 1) + 0x4524B8338B5D1E6CLL;
      if ( !v11 )
        break;
    }
