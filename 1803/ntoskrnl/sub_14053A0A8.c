/*
 * XREFs of sub_14053A0A8 @ 0x14053A0A8
 * Callers:
...
__int64 __fastcall sub_14053A0A8(
        int a1,
        _BYTE *a2,
        char *a3,
        unsigned int a4,
        ...
        _BYTE *a9)
{
  ...
  v18 = *a5;
  if ( a1 )
    sub_1400019B0((__int64)&v19, a2, a3, a4, v18, a6, a9);
  else
    sub_14009BD60((__int64)&v19, a2, a3, a4, v18, a6, a9);
  return 0LL;
}
