/*
 * XREFs of PoStoreRequester @ 0x140075BAC
 * Callers:
 ...
 *     RtlStringCbCopyUnicodeString @ 0x140076F88 (RtlStringCbCopyUnicodeString.c)
...
__int64 __fastcall PoStoreRequester(__int64 a1, __int64 a2, unsigned __int64 *a3, char a4)
{
  ...
  if ( *(_DWORD *)a1 )
  {
    ...
    v11 = *(unsigned __int16 **)(*(_QWORD *)(a1 + 8) + 1128LL);
    v12 = *v11;
    v13 = (char *)*((_QWORD *)v11 + 1);
    ResultLength = *v11;
    if ( a4 )
    {
      for ( i = &v13[2 * (v12 >> 1)]; i != v13 && *(_WORD *)i != 92; i -= 2 )
        ;
      if ( i != v13 )
      {
        v17 = i + 2;
        v12 = (unsigned int)((_DWORD)v13 - (_DWORD)v17 + v12);
        v13 = v17;
        ResultLength = v12;
      }
    }
  ...
  else
  {
    ...
    if ( v18 )
    {
      ...
      if ( DeviceAttachmentBaseRefWithTag )
      {
        ...
        DeviceNode = (char *)v20->DeviceObjectExtension->DeviceNode;
        if ( DeviceNode )
        {
          v8 = (const UNICODE_STRING *)(DeviceNode + 40);
          v26 = *((unsigned __int16 *)DeviceNode + 20) + 2;
          v6 = v26 + v24 + 40;
          ResultLength = v26;
          if ( v10 && v4 >= v6 )
          {
            v10 = 1;
            RtlStringCbCopyUnicodeString((NTSTRSAFE_PWSTR)v9, v26, v8);
            *(_QWORD *)(a2 + 24) = &v9[-a2];
          }
          else
          {
