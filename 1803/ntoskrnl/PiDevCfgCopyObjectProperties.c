/*
 * XREFs of PiDevCfgCopyObjectProperties @ 0x1405DAF28
 * Callers:
        ...
        int a11)
{
  ...
  if ( !a4 )
  {
    ObjectProperty = PnpOpenObjectRegKey(a1, a2, a3, 33554433, 0, (__int64)&Handle, 0LL, 0);
    if ( ObjectProperty < 0 )
      goto LABEL_8;
    v11 = v35;
  }
  if ( a8
    || (ObjectProperty = PnpOpenObjectRegKey(v11, a6, a7, 33554433, 0, (__int64)&v33, 0LL, 0), ObjectProperty >= 0) )
  {
    if ( a3 )
    {
      v20 = (int)Handle;
