    ...
    if ( NumOfElements >= 2 )
    {
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          v18 = &v7[v17];
          if ( ((int (__fastcall *)(void *, char *, char *))PtFuncCompare)(Context, v7, &v7[v17]) > 0 )
          {
            v19 = SizeOfElements;
            v20 = &v7[v17];
            if ( v7 != v18 )
          ...
          if ( ((int (__fastcall *)(void *, char *, char *, rsize_t))PtFuncCompare)(Context, v7, v8, v19) > 0 )
          {
            v22 = SizeOfElements;
            v23 = v8;
            if ( v7 != v8 )
          ...
          if ( ((int (__fastcall *)(void *, char *, char *))PtFuncCompare)(Context, &v7[v17], v8) > 0 )
          {
            v26 = SizeOfElements;
            v27 = v8;
            if ( v18 != v8 )
            ...
            if ( (unsigned __int64)v18 > v30 )
            {
              while ( 1 )
              {
                ...
                if ( v30 >= (unsigned __int64)v18 )
                  break;
                if ( ((int (__fastcall *)(void *, unsigned __int64, char *))PtFuncCompare)(Context, v30, v18) > 0 )
                {
                  if ( (unsigned __int64)v18 > v30 )
                    goto LABEL_39;
                  goto LABEL_37;
...
LABEL_37:
            ...
            while ( v30 <= (unsigned __int64)v8
                 && ((int (__fastcall *)(void *, unsigned __int64, char *))PtFuncCompare)(Context, v30, v18) <= 0 );
            do
            {
LABEL_39:
              v32 = v31;
            ...
            while ( v31 > v18 && ((int (__fastcall *)(void *, char *, char *))PtFuncCompare)(Context, v31, v18) > 0 );
          ...
          if ( v18 < v32 )
          {
            while ( 1 )
            {
              ...
              if ( v32 <= v18 )
                break;
              if ( ((unsigned int (__fastcall *)(void *, char *, char *))PtFuncCompare)(Context, v32, v18) )
              {
                if ( v18 >= v32 )
                  break;
                v7 = v39;
          ...
          do
            v32 -= SizeOfElements;
          while ( v32 > v39 && !((unsigned int (__fastcall *)(void *, char *, char *))PtFuncCompare)(Context, v32, v18) );
LABEL_57:
          v9 = v38;
