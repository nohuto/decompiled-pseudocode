/*
 * XREFs of ViAllocateMapRegistersFromFile @ 0x14081A2E8
 * Callers:
 ...
 *     ViTagBuffer @ 0x14081C118 (ViTagBuffer.c)
 */
...
__int64 __fastcall ViAllocateMapRegistersFromFile(__int64 a1, ULONG_PTR a2, unsigned int a3, char a4, _DWORD *a5)
{
      ...
      do
      {
        ...
        if ( *v14 && v17 >= v9 && v17 < (unsigned __int64)v16 )
        {
          ViHalPreprocessOptions(
            ...
            (const void *)v9,
            v16);
          VfReportIssueWithOptions(0xE6u, 0x1DuLL, v9, (ULONG_PTR)v16, *v14, byte_14039D0A4);
        }
        v14 += 4;
      }
      while ( v14 < v15 );
  ...
  if ( (_DWORD)v12 )
  {
    ...
    ViHalPreprocessOptions(byte_14039D0AC, "Map registers needed: %x available: %x", 0x10000000, 2);
    VfReportIssueWithOptions(0xE6u, 0LL, 2uLL, (unsigned int)v12, v11, byte_14039D0AC);
  }
  else
  {
LABEL_16:
