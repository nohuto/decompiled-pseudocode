/*
 * XREFs of RtlpCreateSplitBlock @ 0x14028A28C
 * Callers:
...
LABEL_20:
      ...
      *(_BYTE *)(a3 + 15) = 0;
      if ( a5 )
      {
        *(_BYTE *)(a3 + 10) &= 0xF0u;
        ...
        {
          RtlpLogHeapFailure(13, 0, (_DWORD)Entry, 0, *v45);
        }
      ...
      else
      {
        *(_BYTE *)(a3 + 10) = 0;
        ...
        {
          RtlpLogHeapFailure(13, 0, (_DWORD)v27, 0, *v31);
        }
        *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
        v33 = *(__int64 **)(a1 + 312);
        if ( v33 )
    ...
    RtlpLogHeapFailure(13, a1, v12 + 16, v16, *v14);
    if ( v7 )
      return 0;
    v7 = 1;
  }
  ...
  *(_BYTE *)(a3 + 15) = 0;
  if ( !a5 )
  {
    *(_BYTE *)(a3 + 10) = 0;
    ...
    {
      RtlpLogHeapFailure(13, 0, (_DWORD)v50, 0, *v54);
    }
    *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
    v33 = *(__int64 **)(a1 + 312);
    if ( v33 )
...
LABEL_54:
  ...
  *(_BYTE *)(a3 + 10) &= 0xF0u;
  ...
  {
    RtlpLogHeapFailure(13, 0, (_DWORD)v60, 0, *v64);
  }
  *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(a3 + 8);
  v66 = *(__int64 **)(a1 + 312);
  if ( v66 )
