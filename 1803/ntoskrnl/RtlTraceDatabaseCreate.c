/*
 * XREFs of RtlTraceDatabaseCreate @ 0x14028E960
 * Callers:
 *     <none>
 * Callees:
        ...
        RTL_TRACE_HASH_FUNCTION HashFunction)
{
  ...
  if ( Buckets > 0x100000 )
    return 0LL;
  v10 = RtlpTraceDatabaseAllocate((8LL * Buckets + 4368) & 0xFFFFFFFFFFFFF000uLL);
  v11 = v10;
  if ( !v10 )
    return 0LL;
  *(_QWORD *)(v10 + 16) = 0LL;
