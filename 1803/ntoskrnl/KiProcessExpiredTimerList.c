/*
 * XREFs of KiProcessExpiredTimerList @ 0x140108660
 * Callers:
...
int __fastcall KiProcessExpiredTimerList(__int64 a1, int *a2, __int64 a3, unsigned int a4)
{
  ...
  LARGE_INTEGER v40[4]; // [rsp+88h] [rbp-60h] BYREF
  ...
  do
  {
    ...
    if ( v10 )
    {
      ...
      if ( v9 )
      {
        ...
        v36[0] = v37;
        v36[1] = 32LL;
        LODWORD(v7) = EtwTraceKernelEvent((int)v36, 1, 0x40020000u, 3921, 1538);
      }
      if ( v11 )
      {
        if ( *(_QWORD *)(a1 + 11528) )
          KiProcessThreadWaitList(a1, 1u, 0);
        if ( v29 )
        ...
        *(_BYTE *)(a1 + 11882) = 0;
        ...
        if ( v29 )
          LODWORD(v7) = EtwTraceTimedEvent(3909, 0x20000080u, (__int64)&BugCheckParameter2, 8, 4196866, (__int64)v40);
      }
      a3 = v33;
    }
  }
    ...
    do
    {
      ...
      do
      {
        if ( *((_BYTE *)v21 + 17) < 5u )
        {
          ...
          {
            do
              KeYieldProcessorEx(&BugCheckParameter3_4);
            while ( (*v23 & 0x80u) != 0 );
          }
          if ( *((_BYTE *)v21 + 17) == 4 )
          {
      ...
      *(_WORD *)(v20 + 566) = 1;
      ...
      {
        LOBYTE(a2) = 1;
        EtwTraceReadyThread(v20, a2, 0LL);
      }
      LODWORD(v7) = KiReadyThread(a1, v20, a3);
    }
    while ( v18 );
  }
  return v7;
