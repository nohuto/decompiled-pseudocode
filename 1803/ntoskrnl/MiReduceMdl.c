/*
 * XREFs of MiReduceMdl @ 0x14004826C
 * Callers:
...
__int64 __fastcall MiReduceMdl(__int64 a1)
{
  ...
  v8 = a1 + 8 * v7;
  if ( *(_QWORD *)(v8 + 40) == qword_1403CC418 )
  {
    *(_WORD *)(a1 + 8) -= 8;
    v11 = *(_DWORD *)(a1 + 40);
    v12 = *(_WORD *)(a1 + 8);
    ...
    *(_DWORD *)(a1 + 40) = v13;
    ...
    if ( v14 != v1 )
    {
      ...
      if ( v15 )
      {
        ...
        *(_DWORD *)(a1 + 40) = v13 - ((_DWORD)v15 << 12);
      }
    }
    v7 += -1 - v15;
  }
  *(_WORD *)(a1 + 10) |= 0x4000u;
  if ( v7 )
  {
    while ( *(_QWORD *)v1 != qword_1403CC418 )
    {
      ++v2;
      v1 += 8;
      if ( v2 >= v7 )
