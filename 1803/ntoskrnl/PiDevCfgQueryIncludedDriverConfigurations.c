/*
 * XREFs of PiDevCfgQueryIncludedDriverConfigurations @ 0x1405DA154
 * Callers:
        ...
        while ( *v8 )
        {
          ...
          if ( v10 )
          {
            *v10 = 0;
            ...
            v12 = *v8;
            v8 = v10 + 1;
            v13 = v12 < asc_1406584F0[0];
            if ( v12 == asc_1406584F0[0] && (v14 = v9[1], v13 = v14 < asc_1406584F0[1], v14 == asc_1406584F0[1]) )
              v15 = 0;
            else
              v15 = v13 ? -1 : 1;
            ...
            if ( v16 )
            {
              *v16 = 0;
              v8 = v16 + 1;
              v17 = v16[1] - asc_1406584F0[0];
              if ( !v17 )
                v17 = v16[2] - asc_1406584F0[1];
              if ( v17 )
              {
                v8 = v16 + 1;
                v18 = 0;
              ...
              do
              {
                ...
                {
                  v25 = v23;
                  if ( !v24 || !wcsicmp((const wchar_t *)v23[6], v24) )
                    break;
                }
                v38 = 0LL;
                v25 = 0LL;
