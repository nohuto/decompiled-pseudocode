/*
 * XREFs of MiLockMemoryLists @ 0x140156F50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiLockMemoryLists(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    *v2 = 0LL;
    v2[1] = a1 + 4064;
    KxAcquireQueuedSpinLock((__int64)v2, (volatile __int64 *)(a1 + 4064));
    LODWORD(v8) = 1;
    v9 = (__int64 *)(a1 + 2112);
    v10 = 2LL;
    v11 = 8LL;
    ...
    {
      v12 = 0;
      for ( i = *v9; v12 < dword_1403CB6DC; ++v12 )
      {
    ...
    v18[1] = a1 + 7456;
    *v18 = 0LL;
    KxAcquireQueuedSpinLock((__int64)v18, (volatile __int64 *)(a1 + 7456));
    v19 = (unsigned int)(v8 + 1);
    v20 = (volatile __int64 *)(a1 + 3424);
    v21 = 16LL;
    do
    {
      v22 = &v2[3 * v19];
    ...
    if ( KeNumberNodes )
    {
      v24 = (volatile __int64 *)(*(_QWORD *)(a1 + 16) + 1928LL);
      do
      {
        v25 = &v2[3 * v19];
        v25[1] = v24;
    ...
    v26[1] = a1 + 7520;
    *v26 = 0LL;
    return KxAcquireQueuedSpinLock((__int64)v26, (volatile __int64 *)(a1 + 7520));
  }
  else
  {
    v5 = dword_1403CB6DC;
    v6 = (unsigned __int16)KeNumberNodes;
    result = (unsigned int)(unsigned __int16)KeNumberNodes + 2 * dword_1403CB6DC + 27;
    if ( (_DWORD)result )
    {
      do
      {
