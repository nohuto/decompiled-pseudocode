/*
 * XREFs of PfpCopyEvent @ 0x1405293C0
 * Callers:
...
__int64 __fastcall PfpCopyEvent(_QWORD *Src)
{
  ...
  if ( (*Src & 0x1F000LL) == 0xA000 )
  {
    ...
    if ( v8 )
    {
      v9 = ((qword_1403CD1D8 + 47) & 0xFFFFFFFFFFFFFFF8uLL)
         + 40LL * (*(unsigned __int16 *)(v8 + 10) - (unsigned int)*(unsigned __int16 *)(qword_1403CD1D8 + 36));
      if ( (*(_BYTE *)(v9 + 8) & 4) != 0
  ...
  else
  {
    v11 = qword_1403CD1B0;
    v12 = (*Src >> 2) & 0x3FFLL;
    if ( (unsigned int)(v12 + *(_DWORD *)(qword_1403CD1B0 + 16)) > *(_DWORD *)(qword_1403CD1B0 + 20) )
    {
      while ( (unsigned int)PfTReplaceCurrentBuffer(&unk_1403CD198, v11) != -1073741823 )
      {
        v11 = qword_1403CD1B0;
        if ( (unsigned int)(v12 + *(_DWORD *)(qword_1403CD1B0 + 16)) <= *(_DWORD *)(qword_1403CD1B0 + 20) )
          goto LABEL_10;
