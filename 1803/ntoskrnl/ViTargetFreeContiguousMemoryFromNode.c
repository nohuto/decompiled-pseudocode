/*
 * XREFs of ViTargetFreeContiguousMemoryFromNode @ 0x1408222D8
 * Callers:
 *     ViTargetFreeContiguousMemory @ 0x140822230 (ViTargetFreeContiguousMemory.c)
 *     ViTargetFreeContiguousMemoryCallback @ 0x1408222B0 (ViTargetFreeContiguousMemoryCallback.c)
 * Callees:
 *     VfUtilFreePoolDispatchLevel @ 0x1402A9880 (VfUtilFreePoolDispatchLevel.c)
 */
