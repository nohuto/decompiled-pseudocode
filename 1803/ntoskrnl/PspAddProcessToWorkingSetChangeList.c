/*
 * XREFs of PspAddProcessToWorkingSetChangeList @ 0x14077B3B8
 * Callers:
 *     NtSetInformationJobObject @ 0x140532FE4 (NtSetInformationJobObject.c)
 *     PspSetJobLimitsProcessCallback @ 0x14077BFD0 (PspSetJobLimitsProcessCallback.c)
 * Callees:
      ...
      if ( (_BYTE)PoolWithTag )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          *(_QWORD *)(PoolWithTag + 24) = *(_QWORD *)(v3 + 792);
          v4 = (__int64 *)qword_14039D568;
          if ( *(__int64 **)qword_14039D568 != &PspWorkingSetChangeHead )
            __fastfail(3u);
          *(_QWORD *)PoolWithTag = &PspWorkingSetChangeHead;
          *(_QWORD *)(PoolWithTag + 8) = v4;
          *v4 = PoolWithTag;
          qword_14039D568 = PoolWithTag;
        }
        else
        {
