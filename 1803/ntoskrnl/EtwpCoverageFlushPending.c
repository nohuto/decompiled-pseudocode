/*
 * XREFs of EtwpCoverageFlushPending @ 0x140583420
 * Callers:
...
int *__fastcall EtwpCoverageFlushPending(int **a1)
{
  ...
  if ( *((_DWORD *)a1 + 16) )
  {
    ...
    v9 = *((_WORD *)a1 + 32);
    if ( stru_140397820.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&stru_140397820, 0x400000000000uLL) )
      {
        v5 = *a1;
        v6 = *((_QWORD *)v3 + 4);
        v10 = **a1;
        ...
        v28 = 2;
        v30 = v6;
        TlgWrite(&stru_140397820, &unk_14030E3B4, 0LL, 0LL, 8u, &pData);
      }
    }
