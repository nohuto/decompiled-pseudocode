/*
 * XREFs of WdipSemLoadScenarioTable @ 0x140639AE4
 * Callers:
 ...
 *     WdipSemUpdateProviderEntriesForScenario @ 0x14063A5C8 (WdipSemUpdateProviderEntriesForScenario.c)
 ...
 *     WdipSemAddScenarioToTable @ 0x14063A914 (WdipSemAddScenarioToTable.c)
...
LABEL_16:
        if ( (int)WdipSemOpenRegistryKey(L"Instrumentation") >= 0 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( (unsigned int)dword_1403A2980 >= 0x40 )
              break;
            v10 = dword_1403A4E00;
