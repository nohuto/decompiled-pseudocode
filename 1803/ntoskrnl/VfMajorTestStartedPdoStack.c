/*
 * XREFs of VfMajorTestStartedPdoStack @ 0x140822E74
 * Callers:
...
__int64 (__fastcall *__fastcall VfMajorTestStartedPdoStack(__int64 a1))(_QWORD)
{
  ...
  if ( (_DWORD)result && VfVerifyMode > 2 )
  {
    for ( i = 0; i <= 0x1B; ++i )
    {
      v4 = (void (__fastcall *)(__int64))*((_QWORD *)&unk_140842ED0 + 12 * i);
      if ( v4 )
        v4(a1);
    }
    result = qword_140843950;
    if ( qword_140843950 )
      return (__int64 (__fastcall *)(_QWORD))qword_140843950(a1);
  }
  return result;
}
