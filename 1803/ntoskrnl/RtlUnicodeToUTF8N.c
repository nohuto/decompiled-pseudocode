/*
 * XREFs of RtlUnicodeToUTF8N @ 0x140577C50
 * Callers:
 ...
 *     RtlUnicodeToCustomCPN @ 0x1407824F0 (RtlUnicodeToCustomCPN.c)
 * Callees:
 *     CountUnicodeToUTF8 @ 0x1400C8398 (CountUnicodeToUTF8.c)
 */
...
LABEL_8:
    ...
    *v10++ = v7;
    ...
    if ( v15 > 0xD )
    {
      if ( v16 < v15 )
        v15 = v11 - v10;
      for ( i = &UnicodeStringSource[v15 - 5]; ; --i )
      {
LABEL_30:
        while ( 2 )
        {
