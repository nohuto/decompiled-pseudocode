/*
 * XREFs of PopIsWakeTimerImmanent @ 0x140765568
 * Callers:
        ...
        unsigned __int64 **a5)
{
  ...
  *a5 = 0LL;
  ...
  v22 = 0LL;
  v12 = -1LL;
  if ( qword_1403AA120 && PopDozeDeferralMaxSeconds )
  {
    v13 = qword_1403AA120 + 10000000LL * (unsigned int)PopDozeDeferralMaxSeconds;
    v25 = v13;
    if ( a2 )
    {
