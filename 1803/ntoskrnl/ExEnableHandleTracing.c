/*
 * XREFs of ExEnableHandleTracing @ 0x1407BD2F4
 * Callers:
 ...
 *     MmGetMaximumNonPagedPoolInBytes @ 0x1400D3938 (MmGetMaximumNonPagedPoolInBytes.c)
...
LABEL_27:
  *(_BYTE *)(a1 + 44) |= 2u;
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 56), 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
    ExfTryToWakePushLock((volatile signed __int64 *)(a1 + 56), v13, v14, v15);
