/*
 * XREFs of PopMarkHiberPhase @ 0x14048636C
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_1403AA1D0, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_1403AA198, (unsigned int)dword_1403AA1A0, 0);
