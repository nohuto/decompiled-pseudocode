/*
 * XREFs of KiVerifyPdata @ 0x1408BA460
 * Callers:
...
__int64 __fastcall KiVerifyPdata(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( BugCheckParameter2 < *(&xmmword_140463020 + 1)
    || BugCheckParameter2 >= *(&xmmword_140463020 + 1) + (unsigned int)qword_140463030 )
  {
    v2 = (unsigned int *)RtlpxLookupFunctionTable(BugCheckParameter2, (unsigned __int64)v7);
  }
  else
  {
    v2 = (unsigned int *)xmmword_140463020;
    BugCheckParameter3 = qword_140463030;
  }
  result = v9;
  if ( v2 )
  {
