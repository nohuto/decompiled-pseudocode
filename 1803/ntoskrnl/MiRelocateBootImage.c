/*
 * XREFs of MiRelocateBootImage @ 0x1408ADD30
 * Callers:
        ...
        __int64 a8)
{
  ...
  if ( !(unsigned int)MI_IS_PHYSICAL_ADDRESS((unsigned __int64)a4) )
  {
    if ( (MiFlags & 0x10000) != 0 && (MiFlags & 0x8000) != 0 )
    {
      ...
      v23 = a4;
      v24 = 1LL;
      v19 = VslpEnterIumSecureMode(2u, 216LL, 0, (__int64)v21);
      if ( v19 < 0 )
  ...
  *(_DWORD *)(a2 + 64) = a6 << 12;
  ...
  while ( v17 < v18 )
  {
    MiFreeBootDriverPage(v17, a8);
    v17 += 8LL;
  }
  if ( (MiFlags & 0x10000) != 0 && (MiFlags & 0x8000) != 0 )
    VslReserveProtectedPages(0LL, (__int64)a4, a6 + a7, 2u);
  return 0;
}
