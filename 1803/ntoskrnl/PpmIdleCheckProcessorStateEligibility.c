/*
 * XREFs of PpmIdleCheckProcessorStateEligibility @ 0x1402729AC
 * Callers:
 *     PpmIdleSelectCoordinatedProcessorDependency @ 0x140272F20 (PpmIdleSelectCoordinatedProcessorDependency.c)
 * Callees:
