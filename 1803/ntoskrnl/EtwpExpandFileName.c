/*
 * XREFs of EtwpExpandFileName @ 0x1405E82A4
 * Callers:
...
__int64 __fastcall EtwpExpandFileName(char a1, UNICODE_STRING *a2, unsigned int a3, unsigned __int16 *a4)
{
  ...
  else
  {
    ...
    if ( (_WORD)v10 == Length )
    {
      v15 = *a4 + 56 + (unsigned int)CurrentServerSiloGlobals[524];
    }
    else
    {
      v15 = a2->Length - Length + 2 + (unsigned int)CurrentServerSiloGlobals[524];
  ...
  if ( PoolWithTag )
  {
    ...
    else
    {
      ...
      v22 = RtlStringCbPrintfW(v19, v17, L"%ws%ws%ws", v21[132], &a2->Buffer[v30], v20);
    }
    v23 = v22;
    if ( a3 )
    {
