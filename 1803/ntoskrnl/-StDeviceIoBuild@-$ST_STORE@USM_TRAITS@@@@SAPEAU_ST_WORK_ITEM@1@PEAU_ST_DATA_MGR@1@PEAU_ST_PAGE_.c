/*
 * XREFs of ?StDeviceIoBuild@?$ST_STORE@USM_TRAITS@@@@SAPEAU_ST_WORK_ITEM@1@PEAU_ST_DATA_MGR@1@PEAU_ST_PAGE_LOCATION@1@KPEAX@Z @ 0x1402A3CC4
 * Callers:
 ...
 *     ?StRegionReadReference@?$ST_STORE@USM_TRAITS@@@@SAKPEAU_ST_DATA_MGR@1@K@Z @ 0x1402A63E0 (-StRegionReadReference@-$ST_STORE@USM_TRAITS@@@@SAKPEAU_ST_DATA_MGR@1@K@Z.c)
 *     SmCalcIoWorkItemSize @ 0x1402A8DE0 (SmCalcIoWorkItemSize.c)
...
LABEL_9:
    ...
    *((_QWORD *)v14 + 2) = PoolWithTag;
    PoolWithTag = 0LL;
    v14[6] = *(_DWORD *)a2;
    v14[7] = (32 * v11) | v14[7] & 0x1D | *(_DWORD *)(a1 + 832) & 2;
    Reference = 0;
    goto LABEL_9;
  }
LABEL_15:
