/*
 * XREFs of RtlDecompressChunks @ 0x140781C70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
    ...
    if ( v7 > v12 || (unsigned int)v16 > (unsigned int)v8 )
      return -1073741246;
    v19 = *CompressedChunkSizes;
    --NumberOfChunks;
    CompressedBuffer += v19;
    v25 = NumberOfChunks;
    CompressedBufferSize -= v19;
    ++CompressedChunkSizes;
    LODWORD(v8) = v8 - v16;
    if ( !(_DWORD)v8 )
      return 0;
...
LABEL_26:
  ...
  {
    v20 = &v7[(unsigned int)v8 - (unsigned __int64)v13];
    v21 = (char *)&v20[CompressedBufferSize];
    v23 = v21;
    if ( v21 < (char *)v20 )
      return -1073741811;
    if ( v20 >= v7 && v21 <= (char *)v12 )
    {
