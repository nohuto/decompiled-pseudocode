/*
 * XREFs of PspAddPartitionToGlobalList @ 0x1401843E0
 * Callers:
...
__int64 __fastcall PspAddPartitionToGlobalList(__int64 a1)
{
  ...
  v4 = v2;
  v5 = a1 + 40;
  if ( *(_UNKNOWN ***)off_140397730[0] != &PspActivePartitionListHead )
    __fastfail(3u);
  *(_UNKNOWN ***)(v5 + 8) = off_140397730[0];
  *(_QWORD *)v5 = &PspActivePartitionListHead;
  *v3 = v5;
  off_140397730[0] = (_UNKNOWN **)v5;
