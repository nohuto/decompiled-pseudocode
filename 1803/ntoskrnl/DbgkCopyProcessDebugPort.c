/*
 * XREFs of DbgkCopyProcessDebugPort @ 0x1404EAE58
 * Callers:
...
LABEL_3:
  ...
  if ( (unsigned __int8)PsTestProtectedProcessIncompatibility(v11, a2, BugCheckParameter1) )
  {
    v13 = -1073740014;
  }
         ...
         || (v14 = BugCheckParameter1[133]) != 0 && ((v15 = *(_WORD *)(v14 + 8), v15 == 332) || v15 == 452) )
  {
    if ( (BugCheckParameter1[90] & 1) == 0
      || (v19 = BugCheckParameter1[90], v20 = 1LL, v13 = VslpEnterIumSecureMode(2u, 11LL, 0, (__int64)v18), v13 >= 0) )
    {
      v16 = 0;
