/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x1402C0088
 * Callers:
 *     WheapWmiExecuteMethod @ 0x1402BFF60 (WheapWmiExecuteMethod.c)
 * Callees:
 *     WheapCommitPolicy @ 0x1407CB22C (WheapCommitPolicy.c)
 *     WheapGetAllPolicyBufferSize @ 0x1407CB314 (WheapGetAllPolicyBufferSize.c)
 *     WheapGetAllPolicyValues @ 0x1407CB320 (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x1407CB364 (WheapGetPolicyValue.c)
 *     WheapSetPolicyValue @ 0x1407CB3EC (WheapSetPolicyValue.c)
 */
