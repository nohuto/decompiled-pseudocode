/*
 * XREFs of MiInsertDecayClusterTimer @ 0x1400B7F38
 * Callers:
...
unsigned __int64 __fastcall MiInsertDecayClusterTimer(__int64 a1)
{
  ...
  v1 = (a1 + 0x58000000000LL) / 48 - qword_1403CC0A0;
  ...
  *(_QWORD *)(a1 + 8) = 2 * (((unsigned int)result >> 1) | 0xFFFFFFFF00000000uLL);
  if ( v6 == 0x7FFFFFFF )
    ...
    *(_QWORD *)(48 * (qword_1403CC0A0 + v6) - 0x58000000000LL + 8) = v7 | *(_QWORD *)(48 * (qword_1403CC0A0 + v6)
                                                                                    - 0x58000000000LL
                                                                                    + 8) & 0x1FFFFFFFFLL;
