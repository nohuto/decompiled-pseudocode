/*
 * XREFs of TtmiLogTerminalOffRequest @ 0x140777D2C
 * Callers:
...
char __fastcall TtmiLogTerminalOffRequest(int a1, int a2, int a3)
{
  ...
  {
    LOBYTE(v3) = TlgKeywordOn(&stru_140861840, 1uLL);
    if ( (_BYTE)v3 )
    {
      ...
      v22 = 2;
      v25[0] = 4;
      LOBYTE(v3) = TlgWrite(&stru_140861840, &unk_14030DFD7, 0LL, 0LL, 7u, &pData);
    }
  }
  return (char)v3;
}
