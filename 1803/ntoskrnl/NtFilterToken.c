/*
 * XREFs of NtFilterToken @ 0x14057C3B8
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)v8 = *(_QWORD *)v8;
  ...
  if ( inserted >= 0 )
  {
    ...
    if ( inserted >= 0 )
    {
      ...
      {
        v12 = v25;
        inserted = ObInsertObjectEx(v25, 0LL, v28.GrantedAccess, 1, 0, 0LL, &v27);
        if ( inserted >= 0 )
        {
          SepAppendAceToTokenObjectAcl((__int64)v12, 8, SeAliasAdminsSid);
