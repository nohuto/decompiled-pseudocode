/*
 * XREFs of ?StDmPageRecordUnprotect@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@PEAU_ST_PAGE_RECORD@1@@Z @ 0x140093C04
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmPageRecordUnprotect(__int64 a1, __int64 a2)
{
  ...
  return ST_STORE<SM_TRAITS>::StLazyWorkMgrQueueWork(*(_QWORD *)(a1 + 1912), 4LL, 0x3E8u, 0x7530u);
}
