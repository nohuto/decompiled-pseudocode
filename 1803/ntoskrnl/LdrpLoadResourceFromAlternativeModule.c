/*
 * XREFs of LdrpLoadResourceFromAlternativeModule @ 0x14013D80C
 * Callers:
...
__int64 __fastcall LdrpLoadResourceFromAlternativeModule(int a1, __int64 a2, int a3, char a4, unsigned int **a5)
{
