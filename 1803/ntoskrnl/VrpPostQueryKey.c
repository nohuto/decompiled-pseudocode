/*
 * XREFs of VrpPostQueryKey @ 0x14070B0E8
 * Callers:
...
__int64 __fastcall VrpPostQueryKey(__int64 a1)
{
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( stru_1403970D0.LevelPlus1 > 5 )
  {
    ...
    v29[0] = *v10;
    v27 = 2LL;
    TlgWrite(&stru_1403970D0, &unk_140308E17, &ActivityId, 0LL, 5u, &pData);
  }
            ...
            if ( v13 >= 0 )
            {
              ...
              if ( v15 >= 0 )
              {
                *(_DWORD *)(v19 + 24) = v5;
                ...
                v29[0] = 4LL;
                v29[2] = 4LL;
                TlgWrite(&stru_1403970D0, &unk_14030906C, &ActivityId, 0LL, 6u, &pData);
              }
              else
              {
                v5 = v15;
...
LABEL_22:
  ...
  if ( v5 != -1073740541 && stru_1403970D0.LevelPlus1 > 2 )
  {
    if ( *(_QWORD *)(v2 + 24) )
    ...
    v25 = 2LL;
    v29[0] = 4LL;
    TlgWrite(&stru_1403970D0, &unk_140308DDC, &ActivityId, 0LL, 5u, &pData);
  }
LABEL_28:
