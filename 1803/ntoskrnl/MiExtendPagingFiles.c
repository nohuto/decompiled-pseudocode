/*
 * XREFs of MiExtendPagingFiles @ 0x14074EAF8
 * Callers:
...
unsigned __int64 __fastcall MiExtendPagingFiles(__int64 a1)
{
  ...
  {
    _mm_lfence();
    v6 = *(_QWORD *)(v1 + 8 * result + 6880);
    if ( *(_QWORD *)(v6 + 8) - *(_QWORD *)v6 < v3 )
      return result;
    result = MiAttemptPageFileExtension(*(_QWORD *)(v1 + 8 * result + 6880), v3);
    v7 = result;
  ...
  v11 = 0LL;
  v12 = (unsigned __int64 **)(v1 + 6880);
  v13 = *(unsigned int *)(v1 + 6872);
  do
  {
    v14 = *v12;
