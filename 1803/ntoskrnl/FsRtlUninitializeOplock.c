/*
 * XREFs of FsRtlUninitializeOplock @ 0x1400B83C0
 * Callers:
 *     <none>
 * Callees:
    ...
    *Oplock = 0LL;
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(v15 + 8) = v4;
      ...
      {
        v16 = (_QWORD *)*((_QWORD *)v13 + 3);
        *v16 = 0LL;
        v16[1] = 0LL;
        v16[2] = 0LL;
        *(_DWORD *)v16 = 1572865;
        *(_QWORD *)((char *)v16 + 4) = (*((_DWORD *)v1 + 36) >> 12) & 7;
        *((_QWORD *)v13 + 7) = 24LL;
      }
      else
      {
    ...
    while ( 1 )
    {
      ...
      {
        FsRtlpRemoveAndBreakRHIrp((__int64)v6, (__int64)v1, 1, 0, 0, 0, 0, 0);
      }
    }
    while ( 1 )
    {
    ...
    if ( *(_QWORD *)v1 )
    {
      ...
      if ( *(_DWORD *)(v9 + 24) == 590400 )
      {
        ...
        *v10 = 0LL;
        ...
        v10[2] = 0LL;
        *(_DWORD *)v10 = 1572865;
        *(_QWORD *)((char *)v10 + 4) = (*((_DWORD *)v1 + 36) >> 12) & 7;
