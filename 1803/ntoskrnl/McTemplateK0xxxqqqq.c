/*
 * XREFs of McTemplateK0xxxqqqq @ 0x140225F30
 * Callers:
 *     FsRtlHeatLogTierMove @ 0x140716830 (FsRtlHeatLogTierMove.c)
 * Callees:
 *     McGenEventWriteKM @ 0x14014761C (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x140187410 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0xxxqqqq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWriteKM(MS_StorageTiering_Provider_Context, &TieredStorage_TierMove, a3, 8u, &v4);
}
