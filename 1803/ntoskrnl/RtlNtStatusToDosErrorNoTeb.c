/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x140125E50
 * Callers:
...
ULONG __stdcall RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_1402FAA04[8 * v5] )
        {
          v8 = (unsigned __int16)word_1402FAA06[4 * v5];
          if ( byte_1402FAA05[8 * v5] == 1 )
