/*
 * XREFs of KeQueryCpuSetInformation @ 0x14064D9F0
 * Callers:
 *     ExpQuerySystemInformation @ 0x1405AE850 (ExpQuerySystemInformation.c)
 * Callees:
 *     KiGetCpuSetData @ 0x1400D2CCC (KiGetCpuSetData.c)
 *     RtlTryEndReadTickLock @ 0x140132B4C (RtlTryEndReadTickLock.c)
    ...
    *v9 = 32 * KiTotalCpuSetCount;
    ...
    while ( v13 )
    {
      ...
      *(_BYTE *)(v16 + 20) = *(_BYTE *)(CpuSetData + 6);
      ...
      if ( (KiSystemAllowedCpuSets[v11] & v20) != 0 )
      {
