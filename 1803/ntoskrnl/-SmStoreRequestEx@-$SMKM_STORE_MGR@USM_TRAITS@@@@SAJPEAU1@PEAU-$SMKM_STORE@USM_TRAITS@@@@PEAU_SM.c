/*
 * XREFs of ?SmStoreRequestEx@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAU?$SMKM_STORE@USM_TRAITS@@@@PEAU_SM_WORK_ITEM@1@PEAU_KEVENT@@PEAU_IO_STATUS_BLOCK@@@Z @ 0x1400836E8
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  *(_QWORD *)(a3 + 32) = a5;
  SMKM_STORE<SM_TRAITS>::SmStWorkItemQueue(a2, a3, 0LL);
  return 259LL;
}
