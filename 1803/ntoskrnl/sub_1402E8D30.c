/*
 * XREFs of sub_1402E8D30 @ 0x1402E8D30
 * Callers:
 *     <none>
 * Callees:
 *     KeGuardDispatchICall @ 0x1402E97D0 (KeGuardDispatchICall.c)
 *     RtlMinimalBarrier @ 0x1402E9964 (RtlMinimalBarrier.c)
 */

__int64 __fastcall sub_1402E8D30(__int64 a1)
{
  _DWORD *v2; // rcx
  _BYTE *v3; // rdx
  __int64 v4; // r14
  ...
  if ( *v2 == 44 )
  {
    ...
    do
    {
      ...
      v61 = (__int64 *)(*(_QWORD *)(a1 + 1496) + (((unsigned __int64)IdtBase >> 9) & 0x7FFFFFFFF8LL));
      v62 = *v61;
      if ( (unsigned __int8)RtlMinimalBarrier(a1 + 2248, 0LL) )
      {
        v18 = v6 + a1 + 16;
        v19 = (_QWORD *)(v4 + 1024);
        *v9 = v18;
        ...
        *(_DWORD *)(a1 + 1854) = -255817396;
        v26 = v65;
        *(_DWORD *)(a1 + 1858) = 296816456;
        *(_DWORD *)(a1 + 1862) = -1010789361;
        LODWORD(v27) = 4;
        *(_QWORD *)(v4 + 5128) = v66;
        v28 = 4LL;
        *(_QWORD *)(v4 + 5136) = v66;
        ...
        *(_DWORD *)(v4 + 5172) = KeGetPcr()->Prcb.Number;
        ...
        while ( 1 )
        {
          ...
          *v37 = v38 + v66;
          ...
          if ( (v38 & 7) == 0 )
          {
            v41 = ((__int64 (__fastcall *)(unsigned __int64, unsigned __int64, _QWORD))(a1 + 1854))(
                    v38 + v66,
...
LABEL_38:
          ...
          ((void (__fastcall *)(_QWORD *))(a1 + 1843))(v37);
          _InterlockedAnd(v34, 0xFFFFFFFD);
          v37 = (_QWORD *)(v4 + 5136);
  ...
  else if ( !*(_DWORD *)(a1 + 1936) )
  {
    *(_QWORD *)(a1 + 1960) = 257LL;
    *(_QWORD *)(a1 + 1968) = 0LL;
