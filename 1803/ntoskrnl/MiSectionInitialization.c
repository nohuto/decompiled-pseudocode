/*
 * XREFs of MiSectionInitialization @ 0x14089F4C0
 * Callers:
  ...
  *(_OWORD *)((char *)&v12[1] + 4) = MiSectionMapping;
  ...
  if ( (int)ObCreateObjectType(&v4, (__int64)v12, 0LL, (__int64)&MmSectionObjectType) >= 0 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      memset(&qword_1403CB2B0, 0, 0x110uLL);
      v1[5] = 0LL;
      dword_1403CB378 |= 0x400u;
      v8 = 0LL;
      v9 = &v5;
      qword_1403CB2B0 = (__int64)&qword_1403CB340;
      qword_1403CB340 = (__int64)v1;
      qword_1403CB358 = 1LL;
      *v1 = &qword_1403CB340;
      v7 = 48;
      v10 = 65552;
      v11 = 0LL;
      if ( (int)ObCreateObject(0, MmSectionObjectType, (int)&v7, 0, 0, 64, 64, 0, &Object) < 0 )
      {
      ...
      {
        v2 = Object;
        *((_QWORD *)Object + 5) = &qword_1403CB340;
