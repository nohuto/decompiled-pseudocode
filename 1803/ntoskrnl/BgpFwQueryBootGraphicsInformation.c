/*
 * XREFs of BgpFwQueryBootGraphicsInformation @ 0x140164E84
 * Callers:
...
__int64 __fastcall BgpFwQueryBootGraphicsInformation(int a1, __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    {
      *(_OWORD *)a2 = xmmword_14039D8D0;
      *(_OWORD *)(a2 + 16) = xmmword_14039D8E0;
      *(_OWORD *)(a2 + 32) = xmmword_14039D8F0;
      *(_OWORD *)(a2 + 48) = xmmword_14039D900;
      *(_OWORD *)(a2 + 64) = xmmword_14039D910;
      *(_OWORD *)(a2 + 80) = xmmword_14039D920;
      *(_OWORD *)(a2 + 96) = xmmword_14039D930;
      *(_OWORD *)(a2 + 112) = xmmword_14039D940;
    }
    else if ( Src || qword_14039D840 )
    {
      v8 = qword_14039D840;
      ...
      if ( v11 >= (unsigned int)v9 )
      {
        ...
        if ( PoolWithTag )
        {
          *PoolWithTag = ((unsigned int)dword_14039D7F0 >> 23) & 1;
          PoolWithTag[1] = 8;
  ...
  {
    *(_OWORD *)a2 = xmmword_14039D7D0;
    *(_OWORD *)(a2 + 16) = xmmword_14039D7E0;
    *(_DWORD *)(a2 + 20) = 0;
    v5 = *(_DWORD *)(a2 + 20);
