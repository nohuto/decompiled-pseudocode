/*
 * XREFs of McTemplateK0zzt @ 0x14023D83C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zzt(__int64 a1, __int64 a2, __int64 a3, const wchar_t *a4, const wchar_t *a5, char a6)
{
  __int64 v6; // rax
  int v7; // edx
  __int64 v8; // rcx
  ...
  v19 = 0;
  v21 = 4LL;
  return McGenEventWriteKM(MS_KernelPnP_Provider_Context, &KMPnPEvt_CfgMgr_DeviceList_Start, 0LL, 4u, &v13);
}
