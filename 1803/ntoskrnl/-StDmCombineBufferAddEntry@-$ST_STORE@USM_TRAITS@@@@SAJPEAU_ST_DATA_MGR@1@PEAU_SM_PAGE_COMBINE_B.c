/*
 * XREFs of ?StDmCombineBufferAddEntry@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_SM_PAGE_COMBINE_BUFFER@@PEAU_STDM_COMBINE_ENTRY_CACHE@1@PEAU_ST_PAGE_RECORD@1@@Z @ 0x140094388
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  _QWORD v58[3]; // [rsp+70h] [rbp+40h] BYREF
...
LABEL_17:
  v25 = (char **)(a1 + 128);
  v26 = (_DWORD **)((unsigned __int64)(v25 + 2) & -(__int64)(v25 != 0LL));
  if ( **v26 != -1 )
  {
    if ( v4 )
    {
      ...
      if ( (char *)v4 != *v25 )
      {
        ...
        if ( **v26 != -1 )
          NP_CONTEXT::NpLeafDerefInternal(
            (struct NP_CONTEXT::NP_CTX *)((unsigned __int64)(v25 + 2) & -(__int64)(v25 != 0LL)),
            v50);
      }
    }
  }
