/*
 * XREFs of SdbpCheckMatchingText @ 0x1407D5BC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SdbpCheckMatchingText(_DWORD *a1, int a2, int a3, __int64 a4, int a5, __int64 a6)
{
  ...
  *a1 = 0;
  ...
  {
    v9 = a6;
    if ( (unsigned int)SdbpCheckMatchingTextEntry(a2, a6, v16, (_DWORD)P, v12, v11, v17, (__int64)&v14, (__int64)&v13) )
    {
      v6 = 1;
      *(_DWORD *)(v9 + 80) |= v13;
      *a1 = v14;
  ...
  {
    AslLogCallPrintf(1, (unsigned int)"SdbpCheckMatchingText", 1947, (unsigned int)"Failed to read MATCHING_TEXT entry");
  }
  if ( P )
