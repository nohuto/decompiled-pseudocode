/*
 * XREFs of RtlCSparseBitmapFindBitSetCapped @ 0x14029D878
 * Callers:
 ...
 * Callees:
 *     RtlLengthCurrentClearRunForwardEx @ 0x140288818 (RtlLengthCurrentClearRunForwardEx.c)
 */
    ...
    if ( _bittest64((const signed __int64 *)a1, (unsigned __int64)a2 >> 30) )
    {
      if ( _bittest64(*(const signed __int64 **)(a1 + 8), (unsigned __int64)a2 >> 15) )
      {
        ...
        else if ( v8 <= 0 )
        {
          ...
          v15 = (a2 % 0x8000) & 0x1F;
          v16 = *(_DWORD *)v14 & dword_1402F9540[v15];
...
LABEL_25:
        ...
        {
          v12 = RtlLengthCurrentClearRunForwardEx(v28, v6);
        }
