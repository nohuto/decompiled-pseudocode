/*
 * XREFs of PpmSetProfilePolicySetting @ 0x140518648
 * Callers:
...
LABEL_57:
      ...
      while ( 1 )
      {
        v34 = PpmProfiles + 5456LL * (unsigned int)v33;
      ...
      if ( !v37 && !v13 && (v17 & *(_QWORD *)(v36 + 8)) == 0 )
        v18 = 1;
      LOBYTE(v38) = PpmInfoAdjustSetting((_DWORD)v12, (int)v34 + 2688 * (int)v6 + 40, v13, v18, v48, a5);
    ...
    else
    {
      v46 = v6;
      v47 = 2688 * v6;
      v20 = &PpmDefaultProfile[336 * v6 + 5];
      LODWORD(v45) = *((_DWORD *)v12 + 8);
      ...
      v22 = PpmInfoAdjustSetting((_DWORD)v12, 2688 * v6 + (unsigned int)&PpmDefaultProfile[5], v13, v18, v48, a5);
      v25 = v13;
      v20[v13] |= v17;
      if ( !v22 )
        goto LABEL_22;
      LOBYTE(v24) = v13;
      LOBYTE(v25) = byte_1403A6588;
