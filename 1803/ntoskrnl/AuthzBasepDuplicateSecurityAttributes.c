/*
 * XREFs of AuthzBasepDuplicateSecurityAttributes @ 0x14005C310
 * Callers:
...
LABEL_18:
  ...
  switch ( *((_WORD *)v3 + 24) )
  {
    ...
    case 3:
      ...
      while ( 1 )
      {
        SecurityAttributeValue = (char *)AuthzBasepAllocateSecurityAttributeValue(*((unsigned __int16 *)v18 + 20));
        v20 = SecurityAttributeValue;
        if ( !SecurityAttributeValue )
          goto LABEL_34;
        *((_WORD *)SecurityAttributeValue + 20) = 0;
        *((_WORD *)SecurityAttributeValue + 21) = *((_WORD *)v18 + 20);
    ...
    case 4:
      ...
      while ( 1 )
      {
        ...
        *((_WORD *)v24 + 24) = v26;
        ...
        LOBYTE(v27) = 1;
        AuthzBasepAddSecurityAttributeValueToLists(v9, v24, 0LL, v27);
        v22 = (__int64 *)*v22;
        if ( v22 == v3 + 9 )
          goto LABEL_17;
      }
  ...
  while ( 1 )
  {
    v29 = AuthzBasepAllocateSecurityAttributeValue(*((_DWORD *)v28 + 12));
    v30 = v29;
    if ( !v29 )
      break;
    v29[5] = v29 + 8;
    *((_DWORD *)v29 + 12) = *((_DWORD *)v28 + 12);
    memmove(v29 + 8, (const void *)v28[5], *((unsigned int *)v28 + 12));
    LOBYTE(v31) = 1;
    AuthzBasepAddSecurityAttributeValueToLists(v9, v30, 0LL, v31);
    v28 = (__int64 *)*v28;
    if ( v28 == v3 + 9 )
    {
LABEL_17:
