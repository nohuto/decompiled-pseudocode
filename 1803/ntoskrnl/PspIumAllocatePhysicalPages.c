/*
 * XREFs of PspIumAllocatePhysicalPages @ 0x140285238
 * Callers:
...
__int64 __fastcall PspIumAllocatePhysicalPages(int a1, ULONG_PTR a2, _QWORD *a3)
{
  ...
  {
    v9 = *(_QWORD *)(PartitionNodePagesForMdl + 48);
  }
  *a3 = v9;
LABEL_9:
