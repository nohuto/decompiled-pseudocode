        ...
        ULONG OutputBufferLength)
{
  ...
  bool v90; // bl
  struct _PROCESSOR_NUMBER v91; // ebx
...
LABEL_232:
      ...
      case 38:
        ...
        if ( v15 != 4 )
          goto LABEL_263;
        v65 = PpmClearSimulatedLoad((struct _PROCESSOR_NUMBER *)v12);
        goto LABEL_262;
      case 39:
        if ( !v12 || v17 || v15 != 24 )
          goto LABEL_68;
      ...
      case 42:
        ...
        if ( v78 )
        {
          if ( *((_BYTE *)v12 + 12) )
          {
            ZwUpdateWnfStateData((__int64)&WNF_PO_PRIMARY_DISPLAY_VISIBLE_STATE, (__int64)v12 + 4, 4LL);
            v78 = *((_BYTE *)v12 + 14);
          }
          if ( v78 )
...
LABEL_263:
          ...
          v65 = PpmClearSimulatedIdle((struct _PROCESSOR_NUMBER *)v12);
        }
        goto LABEL_262;
      case 56:
        if ( !v12 || !v17 )
...
LABEL_112:
      ...
      case 87:
        ...
        if ( v15 < 8 )
          goto LABEL_68;
        v91 = *(struct _PROCESSOR_NUMBER *)v12;
        if ( *(int *)v12 >= 43 )
          goto LABEL_68;
  ...
  if ( (unsigned int)v8 > SetPowerSettingValue || (v18 = 50462912, !_bittest(&v18, v8)) )
  {
    ...
    if ( (unsigned int)v19 > 0x3D || (v9 = 0x209E02E385CA1E1FLL, !_bittest64(&v9, v19)) )
    {
      ...
      if ( (unsigned int)v21 <= 0x3A && (v9 = 0x608801808940903LL, _bittest64(&v9, v21)) || (unsigned int)(v8 - 2) <= 1 )
      {
        ...
        if ( v101 )
        {
          if ( v103 != (AdministratorPowerPolicy|0x40) && v103 != (SystemPowerLoggingEntry|0x40) )
          {
            WakeSource = -1073741790;
            v102 = -1073741790;
            InputBuffer = (PVOID)((unsigned __int64)InputBuffer & -(__int64)(v15 != 0));
