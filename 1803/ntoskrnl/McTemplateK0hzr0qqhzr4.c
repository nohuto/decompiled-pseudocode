/*
 * XREFs of McTemplateK0hzr0qqhzr4 @ 0x14023AC40
 * Callers:
...
NTSTATUS __fastcall McTemplateK0hzr0qqhzr4(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        unsigned __int16 a4,
        ...
        __int64 a9)
{
  ...
  v21 = 2LL;
  v24 = 0;
  return McGenEventWriteKM(MS_KernelPnP_Provider_Context, &KMPnPEvt_DeviceReset_Stop, 0LL, 7u, &v10);
}
