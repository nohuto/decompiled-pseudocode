/*
 * XREFs of MiAssignTopLevelRanges @ 0x1408BB5B0
 * Callers:
 ...
 *     MiGetTopVirtualAddressMappedByPte @ 0x14017D7B4 (MiGetTopVirtualAddressMappedByPte.c)
...
__int64 MiAssignTopLevelRanges()
{
  ...
  do
  {
    if ( *((_DWORD *)v8 - 2) == 13 )
    {
      ...
      result = MiGetTopVirtualAddressMappedByPte(TopPteAddress);
    }
    else
    {
  ...
  do
  {
    ...
    v11 += 6;
    v13 *= 2LL;
    MiState[v13 + 1010] = v12;
    MiState[v13 + 1011] = *((_QWORD *)v11 - 1);
    --v9;
  }
  while ( v9 );
