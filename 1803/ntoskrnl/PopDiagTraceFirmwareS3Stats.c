/*
 * XREFs of PopDiagTraceFirmwareS3Stats @ 0x140486F80
 * Callers:
...
void PopDiagTraceFirmwareS3Stats()
{
  ...
  if ( ((unsigned int (__fastcall *)(__int64, _QWORD, _QWORD, ULONG *))off_140397D98[0])(35LL, 0LL, 0LL, &NumberOfBytes) == -1073741820 )
  {
    if ( NumberOfBytes )
    {
      ...
      if ( PoolWithTag )
      {
        if ( ((int (__fastcall *)(__int64, _QWORD, unsigned int *, ULONG *))off_140397D98[0])(
               35LL,
               NumberOfBytes,
               PoolWithTag,
               &NumberOfBytes) >= 0 )
                ...
                i = (unsigned int *)((char *)i + *((char *)i + 2)) )
          {
            ...
            else
            {
              ...
              *(_QWORD *)&UserData.Size = 4LL;
              ...
              if ( !qword_1403AA4C8 )
                qword_1403AA4C8 = NumberOfBytes_4;
            }
          }
        }
