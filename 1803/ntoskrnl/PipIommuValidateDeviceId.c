/*
 * XREFs of PipIommuValidateDeviceId @ 0x14064323C
 * Callers:
...
__int64 __fastcall PipIommuValidateDeviceId(ULONG_PTR BugCheckParameter2, unsigned int *BugCheckParameter3, __int64 a3)
{
  ...
  if ( !v6 || (v7 = *((_WORD *)BugCheckParameter3 + 5), (v7 & 0xF8) == 0) )
  {
...
LABEL_13:
  ...
  if ( v6 + ((unsigned __int8)v7 >> 3) > (unsigned __int64)BugCheckParameter3 + a3 )
  {
