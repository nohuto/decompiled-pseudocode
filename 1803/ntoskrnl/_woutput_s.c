/*
 * XREFs of _woutput_s @ 0x14018FBDC
 * Callers:
...
__int64 __fastcall woutput_s(__int64 a1, wchar_t *a2, int *a3)
{
  int *v3; // rsi
  wchar_t *v4; // r10
  int v5; // edi
  ...
  wchar_t v59[2]; // [rsp+48h] [rbp-B8h] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned __int16)(v8 - 32) > 0x58u )
      ...
      v14 = _lookuptable_s[v8 - 32] & 0xF;
    v11 = _lookuptable_s[v14 + v11 + 8 * v14] >> 4;
    v53 = v11;
    switch ( v11 )
    {
      case 8:
          ...
          if ( v8 != 83 )
          {
            if ( v8 != 88 )
            {
              if ( v8 == 90 )
              {
                ...
                v63 = v3 + 2;
                if ( v19 && (v12 = (wchar_t *)*((_QWORD *)v19 + 1)) != 0LL )
                {
                  if ( v19[1] < *v19 )
                    goto LABEL_190;
                  LODWORD(v10) = *v19;
...
LABEL_117:
                    ...
                    if ( (v5 & 0xC) == 0 && v36 > 0 )
                    {
                      v37 = 32;
                      do
                        write_char_1(v37, v35, &v55);
                      while ( v55 != -1 && v38 > 0 );
                      v6 = v56;
                      v34 = v54;
                    }
                    write_string_2(v60, v34, v35, &v55);
                    v39 = v62;
                    v40 = 0;
                    if ( (v5 & 0xC) == 8 && v36 > 0 )
                    {
                    ...
                    if ( v57 == v40 && (int)v10 > 0 )
                    {
                      ...
                      {
                        --v43;
                        v44 = safecrt_mbtowc(v59, v42, _mb_cur_max);
                        if ( v44 == 2 )
                          --v43;
                        v45 = v62;
                        if ( v44 <= 0 )
                          break;
                        write_char_1(v59[0], v62, &v55);
                        v42 += v46;
                        if ( v43 <= 0 )
                        {
                          v6 = v56;
                    ...
                    {
                      write_string_2(v12, (unsigned int)v10, v39, &v55);
                      v45 = v62;
LABEL_138:
                      v9 = v55;
                    }
