/*
 * XREFs of RawQueryFileSystemInformation @ 0x140781188
 * Callers:
 ...
 *     RawComputeFileSystemInformationChecksum @ 0x140781138 (RawComputeFileSystemInformationChecksum.c)
 */
...
__int64 __fastcall RawQueryFileSystemInformation(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  int v15; // eax
  struct _IO_STATUS_BLOCK v17; // [rsp+50h] [rbp-29h] BYREF
  ...
  if ( *(_DWORD *)(a2 + 8) >= 9u )
  {
    ...
    Status = RawPerformDevIoCtrl(v7, *(struct _DEVICE_OBJECT **)(a3 + 176), v8, v9, &v19);
    if ( Status >= 0 )
    {
      ...
      if ( HIDWORD(NumberOfBytes) >= 0x18 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          v13 = IopBuildSynchronousFsdRequest(3u, *(_QWORD *)(a3 + 176), (void *)v12, v10, 0LL, &Event, &v17, retaddr);
          if ( v13 )
          {
            v13->Tail.Overlay.CurrentStackLocation[-1].Flags |= 2u;
            Status = IofCallDriver(*(PDEVICE_OBJECT *)(a3 + 176), v13);
            if ( Status == 259 )
            {
