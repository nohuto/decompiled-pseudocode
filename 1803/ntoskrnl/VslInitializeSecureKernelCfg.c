/*
 * XREFs of VslInitializeSecureKernelCfg @ 0x14022FB28
 * Callers:
...
NTSTATUS __fastcall VslInitializeSecureKernelCfg(__int64 a1, __int64 a2)
{
  ...
  do
  {
    ...
    v2 += 4LL;
    v4 *= 2LL;
    *((_QWORD *)v3 - 1) = qword_1403CD090[v4];
    *(_QWORD *)v3 = qword_1403CD098[v4];
    v3 += 16;
  }
  while ( v2 < 8 );
  qsort(Base, 2uLL, 0x10uLL, MiKvaRangeSort);
  return VslpEnterIumSecureMode(2u, 213LL, 0, (__int64)v6);
}
