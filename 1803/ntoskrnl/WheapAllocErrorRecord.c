/*
 * XREFs of WheapAllocErrorRecord @ 0x1402BE944
 * Callers:
 *     WheapReportBootError @ 0x1402BE3CC (WheapReportBootError.c)
 *     WheaReportHwError @ 0x1402BE600 (WheaReportHwError.c)
 * Callees:
 *     WheapInitializeErrorRecordWrapper @ 0x140182188 (WheapInitializeErrorRecordWrapper.c)
 *     memset @ 0x1401BCC40 (memset.c)
 *     WheapGetPreallocatedErrorRecord @ 0x1402BED40 (WheapGetPreallocatedErrorRecord.c)
