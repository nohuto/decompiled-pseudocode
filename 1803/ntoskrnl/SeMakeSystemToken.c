/*
 * XREFs of SeMakeSystemToken @ 0x1408BCBA0
 * Callers:
...
__int64 SeMakeSystemToken()
{
  ...
  int v101; // [rsp+2B0h] [rbp+188h]
  __int64 v102; // [rsp+2B8h] [rbp+190h]
  ...
  *(_DWORD *)&TimeFields.Minute = 0;
  ...
  v95 = SeDelegateSessionUserImpersonatePrivilege;
