/*
 * XREFs of VrpPreQueryKeyName @ 0x14070C5D8
 * Callers:
...
__int64 __fastcall VrpPreQueryKeyName(__int64 a1)
{
  ...
  *(_QWORD *)ActivityId.Data4 = 0LL;
  ...
  if ( stru_1403970D0.LevelPlus1 > 2 )
  {
    ...
    v19 = v5;
    v20 = 0;
    TlgWrite(&stru_1403970D0, &unk_1403091AD, &ActivityId, 0LL, 4u, &pData);
  }
  v7 = (_WORD *)(v2 + 16);
  v13[2] = v2 + 16;
  ...
  **(_DWORD **)(a1 + 24) = v9;
  ...
  if ( stru_1403970D0.LevelPlus1 > 5 )
  {
    ...
    v21 = v13;
    v22 = 4LL;
    TlgWrite(&stru_1403970D0, &unk_140309134, &ActivityId, 0LL, 5u, &pData);
  }
  return v10;
}
