/*
 * XREFs of IoWriteCrashDump @ 0x140233E8C
 * Callers:
        ...
        char a9)
{
  ...
  if ( CapsuleTriageDumpBlockInitialized == 1 )
    return IopWriteCapsuleTriageDumpToFirmware(v12, a2, v39, v38, a5, (__int64)a6, a7);
  v43[0] = a2;
  v43[1] = v39;
  v43[2] = v38;
  v43[3] = a5;
...
LABEL_11:
    ...
    ((void (__fastcall *)(__int64, _QWORD, _QWORD))qword_1403CDE10)(1LL, 0LL, v10);
    VfDisableHalVerifier();
    LOBYTE(v16) = 1;
    v17 = ((__int64 (__fastcall *)(__int64))qword_1403CDE40)(v16);
...
LABEL_28:
      ...
      v29 = ((__int64 (__fastcall *)(__int64, __int64))qword_1403CDE18)(CrashdmpDumpBlock, a8);
      if ( v29 == -1073741267 )
      {
        if ( *(_QWORD *)(CrashdmpDumpBlock + 1328) )
        {
          *(_DWORD *)(CrashdmpDumpBlock + 1404) |= 0x400u;
          ...
          v30 = v41;
          v32 = 0LL;
          IopUpdateMinidumpContext(v12, v40, v39, v38, a5, (__int64)a6, v41);
          MmSnapTriageDumpInformation(a6, v43);
          v32 = (unsigned int)IopNumTriageDumpDataBlocks | 0x10000000000LL;
          v33 = &IopTriageDumpDataBlocks;
      ...
      if ( (DumpPolicyAttemptOffline & 1) != 0 && v29 < 0 || (DumpPolicyAttemptOffline & 2) != 0 && !v17 )
      {
        ...
        if ( ((int (__fastcall *)(_QWORD))off_1403989B8[0])(0LL) >= 0 )
        {
          if ( CrashdmpDumpBlock )
          {
