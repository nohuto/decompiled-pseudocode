/*
 * XREFs of ?BTreeSplitChild@?$B_TREE@T_SM_PAGE_KEY@@USMKM_FRONTEND_ENTRY@?$SMKM_STORE_MGR@USM_TRAITS@@@@$0BAAA@UB_TREE_DUMMY_NODE_POOL@@U?$B_TREE_KEY_COMPARATOR@T_SM_PAGE_KEY@@@@@@SAPEAUNODE@?$B_TREE_HEADER@T_SM_PAGE_KEY@@USMKM_FRONTEND_ENTRY@?$SMKM_STORE_MGR@USM_TRAITS@@@@@@PEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x1400CED20
 * Callers:
        ...
        __int64 a2)
{
  ...
  *(_QWORD *)&v20 = 0LL;
  ...
  {
    v11 = (int *)(v5 + 16 * (v8 + 1LL));
    v9 = 0LL;
    v10 = *v11;
  }
  LODWORD(v20) = v10;
  v12 = v7 + 2;
  v13 = (unsigned __int16)*(_DWORD *)v5 - v8;
  if ( HIBYTE(*(_DWORD *)v5) )
  {
    v7[1] = *(_QWORD *)(v5 + 8);
