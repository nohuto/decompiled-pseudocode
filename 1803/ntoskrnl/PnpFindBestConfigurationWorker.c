/*
 * XREFs of PnpFindBestConfigurationWorker @ 0x140615C28
 * Callers:
 *     PnpFindBestConfiguration @ 0x140615BD0 (PnpFindBestConfiguration.c)
 * Callees:
 *     IopTestConfiguration @ 0x140615D3C (IopTestConfiguration.c)
 *     PnpSelectFirstConfiguration @ 0x140615E9C (PnpSelectFirstConfiguration.c)
 *     IopAddRemoveReqDescs @ 0x1406177B0 (IopAddRemoveReqDescs.c)
 *     IopSelectNextConfiguration @ 0x14061B13C (IopSelectNextConfiguration.c)
 *     IopRetestConfiguration @ 0x140726518 (IopRetestConfiguration.c)
 *     IopSaveRestoreConfiguration @ 0x1407265D0 (IopSaveRestoreConfiguration.c)
 */
