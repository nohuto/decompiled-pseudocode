/*
 * XREFs of PnpTraceRebalanceResult @ 0x140738F94
 * Callers:
...
BOOLEAN PnpTraceRebalanceResult()
{
  ...
  result = TraceLoggingProviderEnabled(&stru_140397160, 0, 0x400000000000uLL);
  if ( result )
  {
    ...
    {
      result = TlgKeywordOn(&stru_140397160, 0x400000000000uLL);
      if ( result )
      {
        v6 = v2 - *((_QWORD *)v4 + 7);
        v9 = *v4;
        ...
        v38 = 8LL;
        v40 = 8LL;
        return TlgWrite(&stru_140397160, &unk_1403098A9, 0LL, 0LL, 0xFu, &pData);
      }
    }
  }
  return result;
