/*
 * XREFs of PfSnBuildDumpFromTrace @ 0x140528E94
 * Callers:
...
LABEL_11:
  ...
  *v4 = PoolWithTag;
  ...
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)v7 + 28) = (((_DWORD)v9 + 7) & 0xFFFFFFF8) - ((_DWORD)v7 + 16);
    v13 = 24 * *(_DWORD *)(a2 + 480);
    memmove((void *)((unsigned __int64)(v9 + 7) & 0xFFFFFFFFFFFFFFF8uLL), *(const void **)(a2 + 472), v13);
    *((_DWORD *)v8 + 25) = *(_DWORD *)(a2 + 480);
    v14 = (((_DWORD)v9 + 7) & 0xFFFFFFF8) - (_DWORD)v8 + v13;
    *((_DWORD *)v8 + 2) = v14;
    if ( (unsigned __int8)PfVerifyTraceBuffer(v8, v14, &v18) )
      return 0;
    v7 = (char *)*v4;
    v15 = -1073741823;
  }
