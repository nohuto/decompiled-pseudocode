/*
 * XREFs of EtwpUpdatePmcCounters @ 0x1407AC11C
 * Callers:
...
__int64 __fastcall EtwpUpdatePmcCounters(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( *(_QWORD *)(a1 + 1000) || (result = EtwpAllocatePmcData(a1), !(_DWORD)result) )
  {
    ...
    else
    {
      ...
      for ( j = 0; j < v6; ++j )
      {
        v10 = ((__int64 (__fastcall *)(_QWORD, __int64, _QWORD, __int64))off_1403988B0[0])(
                j,
                v8,
                a3,
                v8 + 8 * (j + 6LL));
      ...
      if ( v10 )
      {
        ...
        {
          ((void (__fastcall *)(_QWORD))off_1403988C0[0])(*(_QWORD *)(v8 + 8 * k + 48));
