/*
 * XREFs of McTemplateK0jzt @ 0x14023D670
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jzt(__int64 a1, __int64 a2, __int64 a3, __int64 a4, const wchar_t *a5, char a6)
{
  ...
  v16 = &a6;
  v17 = 4LL;
  return McGenEventWriteKM(MS_KernelPnP_Provider_Context, &KMPnPEvt_CfgMgr_DeviceInterfaceList_Start, 0LL, 4u, &v10);
}
