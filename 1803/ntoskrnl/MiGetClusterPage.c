/*
 * XREFs of MiGetClusterPage @ 0x1402698A0
 * Callers:
...
__int64 __fastcall MiGetClusterPage(__int64 a1, unsigned __int64 a2, __int64 a3, unsigned int a4, int a5, _BYTE *a6)
{
  ...
  *a6 = 0;
  ...
  MiInitializePageColorBase((__int64)&Process[1].IdealNode[12], (*(_DWORD *)(a1 + 48) >> 8) & 0x3F, (__int64)&v45);
  v51 = 0LL;
  v52 = 0LL;
  v11 = v47 >> byte_1403CB699;
  ...
  {
    v12 = *((unsigned __int16 *)&Process[1].SecureState.Flags + 3);
    v13 = ((v39[0] >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
  }
  v38 = *(_QWORD *)(qword_1403CBD88 + 8 * v12);
  v19 = 0LL;
  *(_BYTE *)(1984LL * v11 + *(_QWORD *)(v38 + 16) + 851) = 1;
  do
  {
  ...
  do
  {
    ...
    if ( a5 )
    {
      if ( (unsigned int)IS_PTE_NOT_DEMAND_ZERO(v25, v21, v25, v13) )
        break;
      v26 = ((v27 >> 5) & 0x1F) == a5;
    }
    else
  ...
  if ( v24 == 16 )
  {
    if ( MiComputeZeroClusterMaximum((__int64)&v48, a1) != 16 )
      return 0LL;
    v29 = _InterlockedExchangeAdd(v45, 1u);
    result = MiGet64KPage(v38, v11, a4, v37 | (unsigned int)(unsigned __int16)(v29 & v46));
    if ( result )
      return result;
  }
  else
...
LABEL_33:
  ...
  PageChain = MiGetPageChain(v38, (__int64)&Process[1].IdealNode[12], v11, a4, 258, v33, &v44);
  if ( !PageChain )
    return 0LL;
  if ( v24 == 16 )
