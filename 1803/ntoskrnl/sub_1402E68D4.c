/*
 * XREFs of sub_1402E68D4 @ 0x1402E68D4
 * Callers:
...
__int64 __fastcall sub_1402E68D4(
        __int64 a1,
        unsigned int *a2,
        unsigned int a3,
        __int64 a4,
        ...
        unsigned int *a8)
{
  ...
  __int64 v117; // r8
  int v118; // edx
  unsigned int v119; // [rsp+20h] [rbp-98h]
  int v120; // [rsp+24h] [rbp-94h]
  unsigned __int64 v121; // [rsp+28h] [rbp-90h]
  unsigned __int64 v122; // [rsp+30h] [rbp-88h]
  __int64 v123; // [rsp+30h] [rbp-88h]
  char v124; // [rsp+38h] [rbp-80h]
  unsigned int v125; // [rsp+3Ch] [rbp-7Ch]
  int *v126; // [rsp+40h] [rbp-78h]
  unsigned int *v127; // [rsp+48h] [rbp-70h]
  __int64 v128; // [rsp+50h] [rbp-68h]
  char *v129; // [rsp+58h] [rbp-60h]
  unsigned int *v130; // [rsp+60h] [rbp-58h]
  int v132; // [rsp+C0h] [rbp+8h]
  ...
  v12 = *((unsigned int *)v8 + 417);
  v13 = 3LL;
  v14 = 4 * v10;
  v15 = 4 * v10 + v12 + 48;
  if ( v15 <= *((_DWORD *)v8 + 557) )
  {
    v16 = (__int64)v8;
    *((_DWORD *)v8 + 417) = v15;
  }
  ...
  {
    v16 = sub_1402E732C(v8, v15, *((unsigned int *)v8 + 495));
    if ( !v16 )
      return 3221225626LL;
    v17 = *((_DWORD *)v8 + 522);
    if ( (v17 & 4) == 0 )
    {
      v18 = *((_DWORD *)v8 + 417);
      v19 = *((_QWORD *)v8 + 205);
      v20 = (v17 & 0x20000000) != 0 ? *((_DWORD *)v8 + 495) : 0;
      if ( v18 >= 8 )
      {
      ...
      *(_DWORD *)(v16 + 1980) = v20;
      ...
      {
        v23 = 0;
        if ( (*(_DWORD *)(v16 + 2088) & 0x10000000) == 0 )
          v23 = v20;
        if ( v23 )
  ...
  *(_DWORD *)(v16 + 1736) += v9;
  ...
  for ( i = (unsigned int)v9 >> 7; i; --i )
  {
    ...
    while ( v34 );
    v37 = __ROL8__(*(_QWORD *)(v16 + 1720) ^ ((char *)v29 - (char *)a2), 17) ^ *(_QWORD *)(v16 + 1720) ^ ((char *)v29 - (char *)a2);
...
LABEL_49:
  (*(void (__fastcall **)(_QWORD))(v16 + 400))(*(_QWORD *)(v16 + 1336));
...
LABEL_126:
    ...
    if ( *(_BYTE *)(v95 - 6) != 76
      ...
      || *(_BYTE *)(v95 - 3) != 0x98
      || *(_BYTE *)(v95 - 2) != 0xC3
      || (v96 = *(_BYTE *)(v95 - 1), v96 != -112) && v96 != -15 )
    {
      v92 = 1;
LABEL_125:
      if ( v92 )
    ...
    if ( (v124 & 8) != 0 )
    {
      if ( (((v95 & 0xFFF) + v94 + 4095) & 0xFFFFFFFFFFFFF000uLL) != 0x1000 || (v95 & 0xFFFFFFFFFFFFF000uLL) != v121 )
      {
        if ( (_DWORD)v94 && (*(_DWORD *)(v16 + 2092) & 0x40) != 0 )
        {
          ...
          while ( 2 )
          {
            ...
            while ( 1 )
            {
              v102 = (*(__int64 (__fastcall **)(unsigned __int64, __int64))(v16 + 1128))(v99, 1LL);
              if ( v102 != -1073741267 )
                break;
              if ( v98 > 1u )
                goto LABEL_138;
...
LABEL_141:
          if ( !*(_DWORD *)(v16 + 1936) )
          {
            *(_QWORD *)(v16 + 1944) = v16 - 0x5C5FC0A76E374B18LL;
            *(_QWORD *)(v16 + 1952) = (char *)v126 - 0x4C48B4211BBACBEBLL;
            *(_QWORD *)(v16 + 1960) = *v126;
            *(_QWORD *)(v16 + 1968) = v95;
            *(_DWORD *)(v16 + 1936) = 1;
          }
        }
        v103 = v129;
        v59 = v120;
        v121 = (v95 + v94) & 0xFFFFFFFFFFFFF000uLL;
      }
      v54 = a2;
    }
    *(_DWORD *)(v16 + 1736) += v94;
    v104 = (_QWORD *)v95;
    v105 = *(_DWORD *)(v16 + 1716);
    v106 = v95 + (unsigned int)v94;
    if ( v95 < v106 )
    {
      v107 = (const char *)v95;
      do
    ...
    if ( (unsigned int)v94 >> 7 )
    {
      do
      {
        ...
        do
        {
          v111 = v104[1] ^ __ROL8__(*v104 ^ v108, v105);
          v104 += 2;
          v108 = __ROL8__(v111, v105);
          --v110;
        }
        while ( v110 );
        v112 = (__ROL8__(*(_QWORD *)(v16 + 1720) ^ ((unsigned __int64)v104 - v95), 17) ^ *(_QWORD *)(v16 + 1720) ^ ((unsigned __int64)v104 - v95))
             * (unsigned __int128)0x7010008004002001uLL;
        v105 = (BYTE8(v112) ^ (unsigned __int8)(v112 ^ v105)) & 0x3F;
        if ( !v105 )
          LOBYTE(v105) = 1;
        --v109;
      }
    ...
    for ( ; v113; --v113 )
    {
      v115 = *(unsigned __int8 *)v104;
      v104 = (_QWORD *)((char *)v104 + 1);
      v108 = __ROL8__(v115 ^ v108, v105);
    }
...
LABEL_164:
    *v127 = v97;
    ...
    v58 = (char *)(*(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(v16 + 528))(v128, v93, v117, v87);
    v53 = v132;
    v56 = v119;
    v11 = v123;
    goto LABEL_168;
