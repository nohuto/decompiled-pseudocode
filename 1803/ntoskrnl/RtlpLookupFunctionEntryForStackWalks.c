/*
 * XREFs of RtlpLookupFunctionEntryForStackWalks @ 0x14012D2E0
 * Callers:
...
unsigned int *__fastcall RtlpLookupFunctionEntryForStackWalks(unsigned __int64 a1, __int64 a2)
{
  ...
  if ( a1 < v4 || a1 >= v4 + *(unsigned int *)(a2 + 16) )
  {
    ...
    else if ( a1 >= *(&xmmword_140463020 + 1) && a1 < *(&xmmword_140463020 + 1) + (unsigned int)qword_140463030 )
    {
      *(_OWORD *)a2 = *(_OWORD *)&xmmword_140463020;
      *(_QWORD *)(a2 + 16) = qword_140463030;
      v5 = *(_QWORD *)a2;
    }
    else
    {
