/*
 * XREFs of MiTrimAllSystemPagableMemory @ 0x14025A32C
 * Callers:
...
__int64 __fastcall MiTrimAllSystemPagableMemory(int a1, int a2)
{
  ...
  CurrentThread = 0LL;
  v13 = 0;
  if ( _InterlockedIncrement(&dword_1403CC4C8) <= 1 && KeAreInterruptsEnabled() )
  {
...
LABEL_22:
        ...
        {
          if ( a1 == 1 )
            v16 = *(ULONG_PTR **)(qword_1403CBD88 + 8LL * *(unsigned __int16 *)(SessionVm + 174));
          else
            v16 = &MiSystemPartition;
          MiPurgePartitionStandby((__int64)v16, 8LL);
        }
        goto LABEL_28;
      }
...
LABEL_28:
  _InterlockedDecrement(&dword_1403CC4C8);
  if ( v13 == 1 )
