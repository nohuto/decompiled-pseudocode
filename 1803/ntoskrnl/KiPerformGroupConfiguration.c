/*
 * XREFs of KiPerformGroupConfiguration @ 0x1408AC1C8
 * Callers:
 ...
 *     KiAssignAllNodesToGroup0 @ 0x1408AC438 (KiAssignAllNodesToGroup0.c)
 *     KiAssignAdjustableNodes @ 0x1408E012C (KiAssignAdjustableNodes.c)
 *     KiAssignFixedNodes @ 0x1408E01D4 (KiAssignFixedNodes.c)
 *     KiShuffleAssignedNodes @ 0x1408E03CC (KiShuffleAssignedNodes.c)
 */
...
__int64 __fastcall KiPerformGroupConfiguration(__int64 a1)
{
  ...
  v14 = 20LL;
  v15 = *(_DWORD **)(*(_QWORD *)(v3 + 240) + 200LL);
  if ( v15 && v6 == *v15 )
  {
    if ( v10 )
    {
