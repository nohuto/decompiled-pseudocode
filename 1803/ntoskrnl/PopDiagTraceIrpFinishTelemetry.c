/*
 * XREFs of PopDiagTraceIrpFinishTelemetry @ 0x140166428
 * Callers:
      ...
      if ( (unsigned int)(v8 / 0x2710) >= 0x1388 )
      {
        ...
        if ( pCallbackContext.LevelPlus1 > 5 )
        {
          ...
          if ( (_BYTE)UnbiasedInterruptTime )
          {
            ...
            v40 = 4LL;
            v42 = 4LL;
            LOBYTE(UnbiasedInterruptTime) = TlgWrite(&pCallbackContext, &unk_14030BF34, 0LL, 0LL, 0xAu, &pData);
          }
        }
      }
    }
  ...
  if ( !*(_BYTE *)(v4 + 184) && pCallbackContext.LevelPlus1 > 5 )
  {
    ...
    if ( (_BYTE)UnbiasedInterruptTime )
    {
      ...
      *(_QWORD *)&pDesc.Size = 1LL;
      v36 = 1LL;
      v38 = 4LL;
      LOBYTE(UnbiasedInterruptTime) = TlgWrite(&pCallbackContext, &unk_14030BFB5, 0LL, 0LL, 8u, &pData);
    }
  }
