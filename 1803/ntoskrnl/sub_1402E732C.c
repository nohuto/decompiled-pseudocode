/*
 * XREFs of sub_1402E732C @ 0x1402E732C
 * Callers:
...
__int64 __fastcall sub_1402E732C(_DWORD *a1, unsigned int a2, int a3)
{
  _DWORD *v4; // rdi
  __int64 v5; // rbx
  int v6; // r10d
  ...
  if ( a3 != 3 )
  {
    ...
    if ( v16 )
    {
      ...
      if ( v34 )
      {
        ...
        *(_QWORD *)(v34 + 1640) = v16;
        if ( (v39 & 0x10000000) == 0 )
          *(_DWORD *)(v34 + 2088) = v39 | 0x20000000;
...
LABEL_85:
  ...
  *(_QWORD *)(v108 + 24) = v102;
  ...
  if ( v104 + v106 )
  {
    ...
    v100 = *(_DWORD *)(v95 + 2088);
    *(_DWORD *)(v95 + 1668) = v87;
    *(_QWORD *)(v95 + 1640) = v68;
    *(_DWORD *)(v95 + 1980) = 3;
    if ( (v100 & 0x10000000) == 0 )
      *(_DWORD *)(v95 + 2088) = v100 | 0x20000000;
    return v95;
  }
  return 0LL;
}
