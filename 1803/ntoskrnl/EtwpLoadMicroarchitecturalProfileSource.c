/*
 * XREFs of EtwpLoadMicroarchitecturalProfileSource @ 0x1407ABBD8
 * Callers:
...
__int64 __fastcall EtwpLoadMicroarchitecturalProfileSource(const WCHAR *a1, unsigned __int16 *a2, const wchar_t *a3)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( v10 == -1 || v11 == -1 )
      return 3221225473LL;
    PoolWithTag = (wchar_t *)ExAllocatePoolWithTag(PagedPool, 2 * v7 + 178, 0x50777445u);
    v9 = PoolWithTag;
    if ( PoolWithTag )
    {
      wcsncpy_s(PoolWithTag + 89, v7, a3, v7);
      KeCopyAffinityEx((__int64)(v9 + 4), a2);
      *(_BYTE *)v9 = v10;
      *((_BYTE *)v9 + 1) = v11;
      *((_BYTE *)v9 + 176) = 1;
      *((_DWORD *)v9 + 1) = v12;
      ((void (__fastcall *)(__int64, _QWORD, wchar_t *))off_140397DA0[0])(20LL, 2 * v7 + 178, v9);
