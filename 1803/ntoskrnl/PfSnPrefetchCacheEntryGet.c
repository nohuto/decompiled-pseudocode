/*
 * XREFs of PfSnPrefetchCacheEntryGet @ 0x14048EBF8
 * Callers:
       ...
       * ((37
         * (BYTE6(v28)
          ...
          * (BYTE5(v28)
           + 37
           * (BYTE4(v28)
            + 37 * (BYTE3(v28) + 37 * (BYTE2(v28) + 37 * (BYTE1(v28) + 37 * ((unsigned __int8)v10 + 11623883)))))))
         + HIBYTE(v28)) & ((v4 >> 5) - 1));
LABEL_5:
    while ( 1 )
    {
...
LABEL_7:
    ...
    if ( !v11 )
    {
      v12 = (_QWORD *)(v9 + 16);
      v13 = *(_QWORD *)(v9 + 16);
      if ( *(_QWORD *)(v13 + 8) != v9 + 16 || (v14 = *(_QWORD **)(v9 + 24), (_QWORD *)*v14 != v12) )
        __fastfail(3u);
      *v14 = v13;
      v15 = a1 + 16;
      *(_QWORD *)(v13 + 8) = v14;
                             ...
                             * (BYTE4(v21)
                              ...
                              * (((*(_DWORD *)(v9 + 8) & (unsigned int)(-1 << (*(_DWORD *)(a1 + 4) & 0x1F))) >> 24)
                               ...
                               * ((unsigned __int8)((*(_DWORD *)(v9 + 8) & (unsigned int)(-1 << (*(_DWORD *)(a1 + 4) & 0x1F))) >> 16)
                                + 37
                                * ((unsigned __int8)((unsigned __int16)(*(_WORD *)(v9 + 8) & (-1 << (*(_DWORD *)(a1 + 4) & 0x1F))) >> 8)
                                 + 37 * ((unsigned __int8)v21 + 11623883)))))))) & ((*(_DWORD *)(a1 + 4) >> 5) - 1)));
            (*i & 1) == 0;
            i = (_QWORD *)*i )
      {
        if ( *i == v9 )
