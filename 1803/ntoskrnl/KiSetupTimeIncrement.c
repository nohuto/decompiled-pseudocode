/*
 * XREFs of KiSetupTimeIncrement @ 0x140183AA4
 * Callers:
 *     KeInitializeClock @ 0x1408C3688 (KeInitializeClock.c)
 * Callees:
 *     RtlGenerateQpcToIncrementConstants @ 0x140162A9C (RtlGenerateQpcToIncrementConstants.c)
 *     RtlpComputeFraction @ 0x140162AD0 (RtlpComputeFraction.c)
 */
