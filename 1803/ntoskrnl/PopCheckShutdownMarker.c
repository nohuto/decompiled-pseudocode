/*
 * XREFs of PopCheckShutdownMarker @ 0x1408A8FA8
 * Callers:
...
char __fastcall PopCheckShutdownMarker(int a1)
{
  ...
  v24 = 32;
  RtlGetSystemBootStatusEx((__int64)&v19, 2u, 0LL);
  v2 = 0;
  PopBsdPhysicalPowerButtonInfoAtBoot = PopBsdPhysicalPowerButtonInfo;
  xmmword_1403D1380 = xmmword_1403E9188;
  xmmword_1403D1390 = xmmword_1403E9198;
  ...
  {
    v11 = WORD2(v4);
    v13 = WORD6(xmmword_1403D1380);
    v16 = BYTE6(v4);
    v12 = v4;
    v14 = v4;
    v5 = HIBYTE(v4);
    v8 = v5 & 1;
    v15 = HIWORD(*((_QWORD *)&xmmword_1403D1380 + 1));
    v27 = &PopBsdPhysicalPowerButtonInfoAtBoot;
    v29 = &v11;
    v31 = &v12;
    v33 = &xmmword_1403D1380;
    v35 = &v13;
    v37 = &v14;
    v39 = &v15;
    v41 = &v16;
    ...
    v44 = 1LL;
    v46 = 1LL;
    TlgWrite(&pCallbackContext, &unk_14030A740, 0LL, 0LL, 0xCu, &pData);
  }
  PopBsdPowerTransitionAtBoot = PopBsdPowerTransition;
  xmmword_1403D13B0 = *(_OWORD *)&::Buffer;
