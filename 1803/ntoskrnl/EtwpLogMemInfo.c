/*
 * XREFs of EtwpLogMemInfo @ 0x1402AFB10
 * Callers:
...
void __fastcall EtwpLogMemInfo(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( a1 )
  {
    EtwpLogKernelEvent((__int64)&v9, *(_QWORD *)(a1 + 1112), *(_DWORD *)a1, 2u, 0x270u, 0x401803u);
  }
  else
  {
    if ( EtwpHostSiloState != -4480 && (*(_DWORD *)(EtwpHostSiloState + 4484) & 0x80000) != 0 )
