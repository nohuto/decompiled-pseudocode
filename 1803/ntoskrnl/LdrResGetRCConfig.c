/*
 * XREFs of LdrResGetRCConfig @ 0x140610F00
 * Callers:
 ...
 *     CheckOneBitValidFlag @ 0x14028701C (CheckOneBitValidFlag.c)
...
NTSTATUS __fastcall LdrResGetRCConfig(void *a1, ULONGLONG a2, unsigned int **a3, int a4, char a5)
{
  ...
  ULONGLONG v38; // [rsp+60h] [rbp-78h] BYREF
  void *v39; // [rsp+68h] [rbp-70h]
  _QWORD v40[2]; // [rsp+70h] [rbp-68h] BYREF
