/*
 * XREFs of ViDeadlockUpdateChildrenCount @ 0x14082A6A4
 * Callers:
 *     VfDeadlockAcquireResource @ 0x140827CF8 (VfDeadlockAcquireResource.c)
 *     ViDeadlockMergeNodes @ 0x140829D54 (ViDeadlockMergeNodes.c)
 *     ViDeadlockRemoveNode @ 0x14082A068 (ViDeadlockRemoveNode.c)
 * Callees:
 *     <none>
 */
