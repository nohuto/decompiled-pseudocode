/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x140290404
 * Callers:
...
LABEL_9:
    ...
    do
    {
      v26 = (unsigned __int16)XpressHashFunction[*v24] ^ (unsigned __int16)word_140317F80[v24[2]] ^ (unsigned __int64)(unsigned __int16)word_140317D80[v24[1]];
      v27 = *(_QWORD *)&a6[8 * v26];
      *(_QWORD *)&a6[8 * v26] = v24++;
...
LABEL_69:
      ...
      if ( v46 < 0x100 )
        ...
        v48 = (unsigned int)XpressHighBitIndexTable[v46 >> 8] + 8;
      v62 += v48;
      v49 = v18 + 1;
      v50 = v46 - (1LL << v48);
      v51 = 16 * v48;
