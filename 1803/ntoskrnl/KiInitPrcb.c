/*
 * XREFs of KiInitPrcb @ 0x140479380
 * Callers:
 ...
 *     KiInitializeDpcList @ 0x1400D2D3C (KiInitializeDpcList.c)
 *     KiIntSteerInitPrcb @ 0x1400D2D68 (KiIntSteerInitPrcb.c)
...
__int64 __fastcall KiInitPrcb(__int64 a1, int a2)
{
  ...
  *(_DWORD *)(a1 + 22752) = 1;
  ...
  if ( !a2 )
  {
    ...
    memset(&unk_1403ADBC4, 0, 0xA4uLL);
  }
