...
__int64 __fastcall LdrpGetRcConfig(PVOID BaseAddress, __int64 a2, char a3, char a4)
{
  ...
  v12[2] = 0LL;
  v12[0] = L"MUI";
  v8 = LdrpSearchResourceSection_U((_DWORD)BaseAddress, (unsigned int)v12, 3, 48, (__int64)&v11);
  if ( v8 < 0 )
    goto LABEL_12;
...
LABEL_12:
  ...
  if ( a3 )
  {
    if ( v9 )
      v4 = (int)v9;
    LdrpSetAlternateResourceModuleHandle((_DWORD)BaseAddress, 0, 0, v4, 0, 2, v8, 0LL);
  }
  return (__int64)v9;
}
