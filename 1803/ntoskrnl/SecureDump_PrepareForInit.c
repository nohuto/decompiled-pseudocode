/*
 * XREFs of SecureDump_PrepareForInit @ 0x140185164
 * Callers:
...
void __fastcall SecureDump_PrepareForInit(__int64 a1, _BYTE *a2)
{
  ...
  if ( !a2 )
    return;
  *a2 = 0;
  memset(&dword_1403CB098, 0, 0x20uLL);
      ...
      *a2 = 1;
      if ( (int)SecureDump_ReadRegistry(
        ...
        && (int)SecureDump_ReadRegistry(
                  ...
                  1,
                  (unsigned int)&qword_1403CB0B0,
                  (__int64)&dword_1403CB0AC) >= 0 )
      {
        ForceDumpDisabled = 0;
      }
      goto LABEL_7;
