/*
 * XREFs of PoEnergyContextUpdateComponentPower @ 0x140531AD4
 * Callers:
 ...
 *     RtlTimelineBitmapUpdate @ 0x14008AD0C (RtlTimelineBitmapUpdate.c)
...
void __fastcall PoEnergyContextUpdateComponentPower(_QWORD *a1, int a2, unsigned __int64 a3)
{
  __int64 v3; // rbx
