...
LABEL_10:
        LOBYTE(v14) = a4;
        StateName = ExpWnfGenerateStateName(v22, a2, a3, v14);
        if ( StateName >= 0 )
        {
          v15 = v22[0];
          *v10 = v22[0] ^ 0x41C64E6DA3BC0074LL;
          v24 = a6;
          v25 = v21;
          ...
          if ( a2 == 3 )
          {
            ...
            StateName = ExpWnfResolveScopeInstance((int)v20, (int)Process, 0, a3, 0LL);
            if ( StateName >= 0 )
            {
              StateName = ExpWnfCreateNameInstance(v20[0], v15, (unsigned int)&v24, (_DWORD)Process, (__int64)&v23);
              if ( StateName >= 0 )
