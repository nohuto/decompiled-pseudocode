/*
 * XREFs of RtlFindClearRuns @ 0x14009DD50
 * Callers:
 *     RtlFindLongestRunClear @ 0x140288020 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
        ...
        BOOLEAN LocateLongestRuns)
{
  ...
  if ( !v10 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v12 == v11 - 1 && v6 )
        v17 |= byte_1402FEA48[SizeOfBitMap & 7];
      if ( v17 )
      {
        ...
        v15 = v16 - v14 + 8;
        v26 = byte_1402FEA38[v24] | byte_1402FEA48[8 - v14] | v17;
        if ( v26 != 0xFF )
        {
          while ( v13 < v7 || v5[v13 - 1].NumberOfBits < RtlpBitsClearAnywhere[v26] )
          {
            ...
            v34 = 0;
            for ( j = byte_1402FEA38[v33]; ((unsigned __int8)j & v26) != 0; ++v34 )
              j *= 2;
            v36 = v13 + 1;
