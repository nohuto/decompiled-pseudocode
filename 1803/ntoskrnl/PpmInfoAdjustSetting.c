/*
 * XREFs of PpmInfoAdjustSetting @ 0x140519644
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x140518648 (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x140277E9C (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x1405196FC (PpmInfoWriteData.c)
 */
