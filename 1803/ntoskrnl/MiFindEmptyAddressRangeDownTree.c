/*
 * XREFs of MiFindEmptyAddressRangeDownTree @ 0x140555690
 * Callers:
 ...
 * Callees:
 *     MiHonorRangeStraddleRequirement @ 0x1400B22C0 (MiHonorRangeStraddleRequirement.c)
 */
        ...
        unsigned __int64 *a7)
{
  ...
  if ( v8 )
  {
    v38 = MiHonorRangeStraddleRequirement(v15, v7 >> 12, v8, 1);
    v11 = a6;
    v15 = ~(v13 - 1) & v38;
    v14 = v15 << 12;
  }
  ...
  if ( *v9 )
  {
    ...
    while ( 1 )
    {
      ...
      v30 = v29 & v28;
      if ( v8 )
        v30 = MiHonorRangeStraddleRequirement(v30, v21, v8, 0);
      if ( v30 <= v15 )
      {
    ...
    v36 = v29 & (v34 - v21);
    if ( v8 )
      v36 = v29 & MiHonorRangeStraddleRequirement(v36, v21, v8, 1);
    *a7 = v36 << 12;
    return 0LL;
  }
  else
