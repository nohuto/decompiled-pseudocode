/*
 * XREFs of EtwTiLogMapExecView @ 0x14057D65C
 * Callers:
...
BOOLEAN __fastcall EtwTiLogMapExecView(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  BOOLEAN result; // al
  ...
  v24 = a3;
  v23 = a2;
  result = EtwProviderEnabled(EtwThreatIntProvRegHandle, 0, 0x40uLL);
  if ( result )
  {
    v7 = (const EVENT_DESCRIPTOR *)&THREATINT_MAPVIEW_REMOTE;
    v8 = EtwThreatIntProvRegHandle;
    Process = KeGetCurrentThread()->ApcState.Process;
    if ( Process == (_KPROCESS *)a1 )
      v7 = &THREATINT_MAPVIEW_LOCAL;
    result = EtwEventEnabled(EtwThreatIntProvRegHandle, v7);
    if ( result )
    {
      if ( Process != (_KPROCESS *)a1 || (result = EtwProviderEnabled(v8, 0, 0x200uLL)) != 0 )
      {
        v10 = EtwpTiFillProcessIdentity((__int64)&UserData, (__int64)Process, &v19);
        ...
        *(&UserData.Size + 2 * v12) = 4;
        ...
        LODWORD(v22[v12 + 1]) = 8;
        v13 = EtwpTiFillProcessIdentity((__int64)(&UserData + v10 + 2), a1, &v20) + v10 + 2;
        v14 = 2LL * v13;
