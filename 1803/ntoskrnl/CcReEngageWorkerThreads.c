/*
 * XREFs of CcReEngageWorkerThreads @ 0x14014CBA0
 * Callers:
    ...
    do
    {
      ...
      *v7 = v9;
      ...
      if ( _InterlockedIncrement64((volatile signed __int64 *)(a1 + 904)) <= 1 )
        __fastfail(0xEu);
      *v8 = 0LL;
      ExQueueWorkItemToPartition((ULONG_PTR)v8, 0, 0xFFFFFFFF, *(_QWORD *)(a1 + 8));
      ++v3;
    }
    while ( v3 < a2 );
  }
    ...
    do
    {
      ...
      *v11 = v13;
      ...
      if ( _InterlockedIncrement64((volatile signed __int64 *)(a1 + 904)) <= 1 )
        __fastfail(0xEu);
      *v12 = 0LL;
      ExQueueWorkItemToPartition((ULONG_PTR)v12, 0, 0xFFFFFFFF, *(_QWORD *)(a1 + 8));
      ++v10;
    }
    while ( v10 < a3 );
  }
