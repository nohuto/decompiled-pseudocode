/*
 * XREFs of KiUpdateTimeAssist @ 0x1400A9728
 * Callers:
 *     KeResumeClockTimerFromIdle @ 0x14010DC30 (KeResumeClockTimerFromIdle.c)
 *     KeSynchronizeTimeToQpc @ 0x1401562D0 (KeSynchronizeTimeToQpc.c)
 * Callees:
 *     KiComputeNewSystemTime @ 0x1400A98F4 (KiComputeNewSystemTime.c)
...
__int64 __fastcall KiUpdateTimeAssist(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)a3 = MEMORY[0xFFFFF78000000320];
  if ( v13 <= 0 )
  {
    v14 = KeMaximumIncrement + v13;
    LODWORD(v13) = KeMaximumIncrement + v13;
    if ( v14 <= 0 )
    {
      v15 = KeNumberProcessorsGroup0[1];
      v10 = ((unsigned __int64)(((unsigned __int64)-v14
                               * (unsigned __int128)(unsigned __int64)KiMaximumIncrementReciprocal) >> 64) >> v15)
          + 2;
      LODWORD(v13) = v14
                   + (((unsigned __int64)(((unsigned __int64)-v14
                                         * (unsigned __int128)(unsigned __int64)KiMaximumIncrementReciprocal) >> 64) >> v15)
                    + 1)
                   * KeMaximumIncrement;
    }
