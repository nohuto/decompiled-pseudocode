/*
 * XREFs of BapdRecordFirmwareBootStats @ 0x140478A90
 * Callers:
...
void BapdRecordFirmwareBootStats()
{
  ...
  if ( BapdRegisterEtwProvider((const GUID *)&BOOTENV_ETW_PROVIDER, 1, &RegHandle) >= 0
    && ((unsigned int (__fastcall *)(__int64, _QWORD, _QWORD, SIZE_T *))off_140397D98[0])(
         34LL,
         0LL,
         0LL,
         &NumberOfBytes) == -1073741820 )
  {
    if ( (_DWORD)NumberOfBytes )
    {
      ...
      if ( PoolWithTag )
      {
        if ( ((int (__fastcall *)(__int64, _QWORD, _QWORD *, SIZE_T *))off_140397D98[0])(
               34LL,
               ...
               &NumberOfBytes) >= 0 )
        {
          ...
          TraceLoggingRegisterEx(&stru_140397D50, 0LL, 0LL);
          if ( stru_140397D50.LevelPlus1 > 4 )
          {
            if ( TlgKeywordOn(&stru_140397D50, 0x400000000000uLL) )
            {
              v30 = 0;
              v33 = 0;
              v36 = 0;
              ...
              v38 = 8;
              v41 = 8;
              TlgWrite(&stru_140397D50, &unk_14030F16B, 0LL, 0LL, 7u, &pData);
            }
          }
        }
