/*
 * XREFs of PfpPrefetchFilesTrickle @ 0x1404BB614
 * Callers:
        ...
        *(_QWORD *)v30[0] = v30[2];
        ...
        if ( v23 )
        {
          while ( !PfpCheckPrefetchAbort(a1)
               && (unsigned __int64)(a1[6] + a1[7] + PfpGetPageListCount(a1 + 11, 0LL, v34)) >= 0x80 )
          {
            if ( v17 + 16 > v18 )
              v19 = v18 - v17;
            else
            ...
            *(_QWORD *)(v25 + 16) |= (8 * (v34 & 7)) | (unsigned __int64)(*(_DWORD *)(*a1 + 28LL) & 7);
            v20 = MmPrefetchPagesEx(1LL, &v29, 0LL);
