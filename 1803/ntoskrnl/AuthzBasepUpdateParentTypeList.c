/*
 * XREFs of AuthzBasepUpdateParentTypeList @ 0x1402C3A78
 * Callers:
...
__int64 __fastcall AuthzBasepUpdateParentTypeList(__int64 a1, unsigned int a2, int a3, int a4, int a5)
{
  ...
  while ( 1 )
  {
    ...
    v15 = 48 * v6;
    v16 = *(_DWORD *)(48 * v6 + a1 + 24);
    if ( v10 == v16 && v11 == *(_DWORD *)(v15 + a1 + 28) && v12 == *(_DWORD *)(v15 + a1 + 32) )
      return result;
    switch ( a5 )
    {
      case 0:
        *(_DWORD *)(v15 + a1 + 24) = v10;
        v21 = (v16 & ~v10) == 0;
        v18 = v16 & ~v10;
        goto LABEL_18;
      case 1:
        v20 = ~*(_DWORD *)(v15 + a1 + 28);
        *(_DWORD *)(v15 + a1 + 28) = v11;
        v18 = v11 & v20;
        v21 = v18 == 0;
LABEL_18:
        if ( !v21 )
        {
          v19 = 0x10000;
LABEL_20:
          AuthzBasepSetAccessReasons(v18, v19, a4, *(_QWORD *)(v15 + a1 + 40), 0);
        }
        break;
      case 2:
        v17 = ~*(_DWORD *)(v15 + a1 + 32);
        *(_DWORD *)(v15 + a1 + 32) = v12;
        v18 = v12 & v17;
        if ( v18 )
        {
          v19 = 0x20000;
