/*
 * XREFs of CMFReadCompressedSegment @ 0x1407C8DAC
 * Callers:
 ...
 *     XpressDecode @ 0x1402CB094 (XpressDecode.c)
    ...
    *v12 = *v13;
    ...
    if ( v21 )
    {
      do
      {
        ...
        {
          v20 = (char *)v26;
          v22 = a4[(unsigned int)(v18 + 1) + 23] - a4[v18 + 23];
        }
        if ( v22 > v15 || !v17 )
          goto LABEL_12;
        v23 = v17;
        ...
        else if ( (unsigned int)XpressDecode((__int64)v4, (__int64)v20, v23, v23, (__int64)v16, v22) != v23 )
        {
          v9 = -1073741217;
          goto LABEL_31;
        }
