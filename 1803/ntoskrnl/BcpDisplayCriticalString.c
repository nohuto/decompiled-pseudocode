/*
 * XREFs of BcpDisplayCriticalString @ 0x1402C65C0
 * Callers:
...
__int64 __fastcall BcpDisplayCriticalString(__int16 *a1, int a2, unsigned int a3, int a4)
{
  ...
  if ( BcpTextBoxLeftEdgeOverride )
    ...
    v6 = dword_14039B810[18 * a4 + 4] + dword_14039B810[18 * a4 + 8];
  if ( BcpTextBoxRightEdgeOverride )
    v7 = *(_DWORD *)BcpTextBoxRightEdgeOverride;
  else
    v7 = dword_14039B810[18 * a4 + 4] + dword_14039B810[18 * a4 + 6] + dword_14039B810[18 * a4 + 8];
  v8 = BcpCursor;
  ...
  *(_DWORD *)(qword_1403D1060 + 8) = a2;
  ...
  if ( (*a1 & 0xFFFE) != 0 )
  {
    while ( 1 )
    {
        ...
        if ( *(_WORD *)(v19 + 2LL * v18) != 32 )
        {
          while ( 1 )
          {
            ...
            if ( v7 < v32 + v8 && v16 )
            {
              if ( v8 < v7 )
              {
                GlyphAdvanceWidth = BcpPrintSpaces(qword_1403D1060, v8, v7, v9, v31, (__int64)&v37);
                if ( GlyphAdvanceWidth < 0 )
                  goto LABEL_41;
                if ( v16 < v37 )
                  v16 = v37;
              ...
              v8 = v6;
              v24 = v16 + dword_14039B810[2 * v5 + 10];
              v16 = 0;
              v9 += v24;
              break;
            }
      ...
      v25 = v33;
      v8 = v6;
      v26 = v16 + dword_14039B810[2 * v5 + 10];
      v16 = 0;
      v9 += v26;
