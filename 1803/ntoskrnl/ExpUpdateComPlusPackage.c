/*
 * XREFs of ExpUpdateComPlusPackage @ 0x1407BC534
 * Callers:
...
__int64 __fastcall ExpUpdateComPlusPackage(int a1)
{
  ...
  Data = a1;
  v1 = ZwOpenKey(&KeyHandle, 0x40000000u, &stru_140399B80);
  if ( v1 == -1073741772 )
    v1 = ZwCreateKey(&KeyHandle, 0x40000000u, &stru_140399B80, 0, 0LL, 0, &Disposition);
  if ( v1 >= 0 )
  {
    v1 = ZwSetValueKey(KeyHandle, &stru_140397018, 0, 4u, &Data, 4u);
    ZwClose(KeyHandle);
  }
