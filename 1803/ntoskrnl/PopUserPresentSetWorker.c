/*
 * XREFs of PopUserPresentSetWorker @ 0x1406145B0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall PopUserPresentSetWorker(unsigned int a1, char a2)
{
  ...
  if ( byte_1403AAA31 )
  {
    _InterlockedExchange(&dword_1403AAA38, 1);
    KeInitializeDpc(&PopAwayModeUserPresenceDpcObject, (PKDEFERRED_ROUTINE)PopAwayModeUserPresenceDpc, &dword_1403AAA38);
  ...
  result = _InterlockedCompareExchange(&dword_1403AAA34, 0, 0);
  if ( result )
