/*
 * XREFs of RtlpCreateHashTable @ 0x140162330
 * Callers:
 *     RtlCreateHashTableEx @ 0x1401622F0 (RtlCreateHashTableEx.c)
 ...
 * Callees:
 *     RtlpInitializeSecondLevelDir @ 0x1401624AC (RtlpInitializeSecondLevelDir.c)
