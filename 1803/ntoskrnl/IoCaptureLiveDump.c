/*
 * XREFs of IoCaptureLiveDump @ 0x14071EC24
 * Callers:
...
LABEL_24:
  ...
  *((_QWORD *)v12 + 75) = v11;
  ...
  if ( stru_1403983C0.LevelPlus1 > 5 && TlgKeywordOn(&stru_1403983C0, 0x200000000000uLL) )
    TlgWrite(&stru_1403983C0, &unk_14030930D, (LPCGUID)v12 + 39, (LPCGUID)v12 + 38, 2u, &pData);
...
LABEL_28:
      ...
      if ( inited >= 0 )
      {
        ...
        else
        {
          ...
          if ( stru_1403983C0.LevelPlus1 > 5 && TlgKeywordOn(&stru_1403983C0, 0x200000000000uLL) )
          {
            ...
            v54 = &v37;
            TlgWrite(&stru_1403983C0, &unk_140309330, (LPCGUID)v12 + 39, (LPCGUID)v12 + 38, 4u, &v51);
          }
  ...
  if ( stru_1403983C0.LevelPlus1 > 5 && TlgKeywordOn(&stru_1403983C0, 0x200000000000uLL) )
  {
    ...
    TlgWrite(&stru_1403983C0, &unk_14030923D, v28, p_pActivityId, 6u, &v42);
  }
  if ( v12 )
  {
    if ( (*((_DWORD *)v12 + 10) & 8) == 0 )
