/*
 * XREFs of KeRemoveByKeyDeviceQueueIfBusy @ 0x140245B70
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      if ( Flink == p_DeviceListHead )
      {
        ...
        if ( p_DeviceListHead->Flink->Blink != p_DeviceListHead
          || (v10 = v4->DeviceListEntry.Flink, (struct _KDEVICE_QUEUE_ENTRY *)v4->DeviceListEntry.Flink->Blink != v4) )
        {
          __fastfail(3u);
        }
      ...
      else
      {
        ...
        if ( (struct _KDEVICE_QUEUE_ENTRY *)v4->DeviceListEntry.Flink->Blink != v4
          || (Blink = v4->DeviceListEntry.Blink, (struct _KDEVICE_QUEUE_ENTRY *)Blink->Flink != v4) )
        {
          __fastfail(3u);
        }
        Blink->Flink = v8;
