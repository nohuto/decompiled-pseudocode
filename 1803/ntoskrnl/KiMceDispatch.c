/*
 * XREFs of KiMceDispatch @ 0x1402E4700
 * Callers:
 *     KiMceLinkage @ 0x1402E9740 (KiMceLinkage.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall KiMceDispatch(_QWORD *a1, unsigned int a2)
{
  ...
  if ( Number == v10 )
  {
    ...
    do
    {
      ...
      {
        v15 = a1[3];
        if ( v15 <= v14 && v15 > v14 - ((-(__int64)((*(_BYTE *)(v7 + 1819) & 8) != 0) & 0xFFFFFFFFFFFFE1E0uLL) + 0x2000) )
          break;
        if ( (*(_BYTE *)(v7 + 1819) & 8) != 0 )
        {
          v16 = *(_QWORD *)(v14 + 8);
    ...
    v18 = 4;
    *(_QWORD *)(v7 + 1854) = 0xC3C3C3C3C3C3C3C3uLL;
    v19 = (_BYTE *)(v7 + 1862);
    do
    {
      *v19++ = -61;
