/*
 * XREFs of UNLOCK_ADDRESS_SPACE_UNORDERED @ 0x14003ECB0
 * Callers:
...
LABEL_17:
  ...
  KiAbThreadRemoveBoosts(CurrentThread, v2, &v15);
  v8 = CurrentThread->SpecialApcDisable++ == -1;
  if ( v8 && ($005F0E83B22994B61E86C72E0CE43C71 *)CurrentThread->ApcState.ApcListHead[0].Flink != &CurrentThread->152 )
