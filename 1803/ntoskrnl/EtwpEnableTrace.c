/*
 * XREFs of EtwpEnableTrace @ 0x14060DE44
 * Callers:
    ...
    if ( v35 )
    {
      ...
      for ( i = 0; i < 3; ++i )
      {
        if ( *(_WORD *)v18 && v18[1] )
        {
          ...
          *(_DWORD *)&v44[8 * v48 + 8] = v49;
          *(_QWORD *)&v44[8 * v48] = v46 - v39;
          memmove(v46, v18[1], v49);
          v50 = *(unsigned int *)&v44[16 * v45++ + 8];
          v46 += v50;
        }
        v18 += 2;
      }
      for ( j = 0; j < 2; ++j )
      {
        if ( *v26 && *((_WORD *)*v26 + 1) )
        {
          ...
          v52 = 2LL * v45;
          v53 = *((unsigned __int16 *)*v26 + 1);
          *(_QWORD *)&v44[8 * v52] = v46 - v39;
          v54 = 2 * v53 + 4;
          *(_DWORD *)&v44[8 * v52 + 8] = v54;
          memmove(v46, *v26, v54);
