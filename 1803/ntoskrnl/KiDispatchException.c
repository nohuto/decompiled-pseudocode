/*
 * XREFs of KiDispatchException @ 0x140130BA0
 * Callers:
 ...
 *     KdIsThisAKdTrap @ 0x140803008 (KdIsThisAKdTrap.c)
 */
...
int __fastcall KiDispatchException(PEXCEPTION_RECORD ExceptionRecord, __int64 a2, __int64 a3, char a4, char a5)
{
  ...
  unsigned int v35; // [rsp+38h] [rbp+8h] BYREF
  ...
  if ( a5 && Process[2].ActiveProcessors.Bitmap[9] )
  {
    ...
    if ( KeGetEffectiveIrql() < 2u )
    {
      ...
      {
        LODWORD(CurrentThread) = ((__int64 (__fastcall *)(PEXCEPTION_RECORD, __int64, __int64, _QWORD, char))xmmword_1403A6100)(
                                   ExceptionRecord,
                                   a2,
                                   a3,
                                   0LL,
  ...
  RtlGetExtendedContextLength(v15, &v35);
  v16 = v35 + 15LL;
  if ( v16 <= v35 )
  ...
  if ( v5 )
    memset(&v33, 0, v35);
  RtlInitializeExtendedContext(&v33, v15, &v38);
  KeContextFromKframes(a3, v41, &v33);
        ...
        || !(unsigned __int8)KdTrap(a3, (_DWORD)v23, (_DWORD)ExceptionRecord, (unsigned int)&v33, v5, 0) )
      {
        ...
        if ( !(_BYTE)CurrentThread )
        {
          ...
          *(_DWORD *)(a3 + 376) &= ~0x100u;
          ...
          {
            v24 = (v21 - *(unsigned int *)(v38 + 20)) & 0xFFFFFFFFFFFFFFC0uLL;
            v37 = v24;
          }
          ...
          *v27 = v50;
          ...
          v28 = v45;
          LOBYTE(v29) = 1;
          RtlpCopyExtendedContext(v29, v45, (unsigned int)&v51, v15, v38, 0LL);
          *(_OWORD *)v28 = v51;
          *(_QWORD *)(v28 + 16) = v52;
          _disable();
          *(_QWORD *)(a3 + 384) = v25;
