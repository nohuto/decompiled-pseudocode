/*
 * XREFs of AuthzBasepGetInternalSecurityAttributesCopyoutBufferSize @ 0x14050B740
 * Callers:
 *     AuthzBasepQueryInternalSecurityAttributesToken @ 0x1405445B0 (AuthzBasepQueryInternalSecurityAttributesToken.c)
 * Callees:
 *     AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize @ 0x14006E5F0 (AuthzBasepGetInternalSecurityAttributeValueCopyoutBufferSize.c)
 */
