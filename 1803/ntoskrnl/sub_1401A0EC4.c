/*
 * XREFs of sub_1401A0EC4 @ 0x1401A0EC4
 * Callers:
...
unsigned __int64 __fastcall sub_1401A0EC4(__int64 a1, int *a2, __int64 a3)
{
...
LABEL_45:
      ...
      if ( !(_DWORD)result )
      {
        *(_QWORD *)(*(_QWORD *)(a1 + 1416) + 24LL) = v27 ^ (unsigned __int64)(unsigned int)a2[5];
        result = *(unsigned int *)(a1 + 1936);
      }
      v36 = *((_QWORD *)a2 + 1);
      if ( !(_DWORD)result )
...
LABEL_49:
    ...
    if ( !(_DWORD)v37 )
      return result;
    sub_14019FEBC(a1, *((_QWORD *)a2 + 1), v37, (__int64)v50);
    v38 = 16;
