/*
 * XREFs of WheapWmiExecuteErrorSourceMethod @ 0x1402BFB5C
 * Callers:
 *     WheapWmiExecuteMethod @ 0x1402BFF60 (WheapWmiExecuteMethod.c)
 * Callees:
...
LABEL_28:
  ...
  else
  {
    ...
    if ( !dword_1403D17CC )
      goto LABEL_35;
    v10 = 972 * dword_1403D17CC + 12;
    if ( v10 > a2 )
      goto LABEL_37;
    *a3 = 0;
    v34 = (__int64 *)qword_1403D17D0;
    v35 = a3 + 3;
    v36 = 0;
    for ( i = 0; v34 != &qword_1403D17D0; v34 = (__int64 *)*v34 )
    {
      if ( i >= dword_1403D17CC )
        break;
      v38 = v35;
      v39 = (char *)v34 + 89;
      v40 = 7LL;
