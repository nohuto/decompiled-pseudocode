/*
 * XREFs of PopEtEnergyTrackerUpdateAggregate @ 0x14053807C
 * Callers:
 ...
 *     PopEtEnergyValuesDeltaCalculate @ 0x140538224 (PopEtEnergyValuesDeltaCalculate.c)
 */
...
__int64 __fastcall PopEtEnergyTrackerUpdateAggregate(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  bool v16; // cc
  int v17; // eax
  __int64 v18[2]; // [rsp+20h] [rbp-1F8h] BYREF
  _BYTE v19[432]; // [rsp+30h] [rbp-1E8h] BYREF

  result = PopEtEnergyValuesDeltaCalculate(a2 + 48, a3, v19, v18);
  if ( !LODWORD(v18[0]) )
  {
    PopEtAggregateGet(a1, (_OWORD *)(a2 + 16), v18);
    v9 = (_DWORD *)v18[0];
    PsAddProcessEnergyValues((_QWORD *)(v18[0] + 48), (__int64)v19);
    v10 = *(_DWORD *)(a2 + 484);
    if ( v10 >= 0 )
    {
