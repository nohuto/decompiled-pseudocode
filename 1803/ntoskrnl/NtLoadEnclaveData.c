        ...
        _DWORD *a9)
{
  ...
  _DWORD *v38; // [rsp+90h] [rbp-D8h]
  ULONG_PTR v39; // [rsp+A0h] [rbp-C8h]
...
LABEL_46:
  ...
  {
    v18 = ObpReferenceObjectByHandleWithTag(v10, 8, (__int64)PsProcessType, a4, 0x6D566D4Du, &Object, 0LL, 0LL);
    v31 = v18;
    if ( v18 < 0 )
      goto LABEL_46;
  }
...
LABEL_48:
  ...
  if ( v23 )
    MiUnlockAndDereferenceVad(v23, v13, (__int64)a3, a4);
  if ( v24 )
    KiUnstackDetachProcess((__int64)v46, 0LL);
  if ( Object && v27 != -1LL )
