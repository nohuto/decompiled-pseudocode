/*
 * XREFs of EtwpTraceSystemInitialization @ 0x1408A5194
 * Callers:
...
char EtwpTraceSystemInitialization()
{
  ...
  if ( Version >= 0 )
  {
    ...
    if ( stru_1403977A0.LevelPlus1 > 5 && TlgKeywordOn(&stru_1403977A0, 0x200000000000uLL) )
    {
      ...
      v58 = 4LL;
      v60 = 1LL;
      TlgWrite(&stru_1403977A0, &unk_14030E57E, 0LL, 0LL, 0xCu, &pData);
    }
    ...
    if ( (_BYTE)Version )
    {
      ...
      {
        LOBYTE(Version) = TlgKeywordOn(&stru_1403977A0, 0x400000000000uLL);
        if ( (_BYTE)Version )
        {
          LOBYTE(v10) = v7;
          v12 = (v24[0] >> 10) & 0xF;
          ...
          v63 = 4LL;
          v65 = 1LL;
          LOBYTE(Version) = TlgWrite(&stru_1403977A0, &unk_14030E549, 0LL, 0LL, 4u, &v61);
        }
      }
    }
