/*
 * XREFs of NtSetSystemEnvironmentValue @ 0x1407C4C08
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall NtSetSystemEnvironmentValue(PUNICODE_STRING VariableName, PUNICODE_STRING Value)
{
  ...
  {
    if ( (_BYTE)NlsMbCodePageTag )
      LODWORD(v10) = RtlxUnicodeStringToOemSize(&SourceString);
    else
      v10 = ((unsigned __int64)Length + 2) >> 1;
    v11 = v10;
    v21 = v10;
    v17.Buffer = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)v10, 0x72766E45u);
    if ( v17.Buffer )
    {
