/*
 * XREFs of PopEsUpdateState @ 0x140612084
 * Callers:
 ...
 *     PopEsSnapTelemetry @ 0x1405EE618 (PopEsSnapTelemetry.c)
...
LABEL_19:
  ...
  if ( byte_1403AAA74 && dword_1403AAA70 && PopEsBgActivityLimited )
  {
    v4 = 8;
    goto LABEL_19;
  }
