/*
 * XREFs of EtwpLocateDbgIdForRegEntry @ 0x14058CB5C
 * Callers:
 ...
 *     EtwpGetImageSize @ 0x140605F18 (EtwpGetImageSize.c)
 */

int __fastcall EtwpLocateDbgIdForRegEntry(char a1, __int64 a2, __int64 *a3, unsigned int *a4)
{
  void *v7; // rcx
...
LABEL_5:
  ...
  result = MmGetImageBase((unsigned __int64)v7, &BaseOfImage, &Size);
  if ( result >= 0 )
    goto LABEL_5;
  return result;
}
