/*
 * XREFs of RtlpFreeHeap @ 0x14028B55C
 * Callers:
...
__int64 RtlpFreeHeap(__int64 a1, int a2, __int64 a3, ...)
{
  ...
  if ( *(_BYTE *)(a3 + 15) == 4 )
  {
    ...
    *(_QWORD *)(a1 + 560) -= v36;
    ...
    {
      RtlpLogHeapFailure(13, 0, v35, v39, *v38);
    }
    if ( v5 )
    {
  ...
  if ( RegionSize < *(_QWORD *)(a1 + 176) || RegionSize + *(_QWORD *)(a1 + 192) < *(_QWORD *)(a1 + 184) )
  {
    ...
    if ( v16 )
    {
      ...
      *(_BYTE *)(v13 + 15) = 0;
      ...
      {
        RtlpLogHeapFailure(13, 0, (_DWORD)Entry, 0, *v23);
      }
...
LABEL_52:
      ...
      {
        RtlpLogHeapFailure(13, 0, (_DWORD)v31, 0, *v34);
      }
      *(_QWORD *)(a1 + 192) += *(unsigned __int16 *)(v13 + 8);
      v24 = *(__int64 ***)(a1 + 312);
      if ( !v24 )
