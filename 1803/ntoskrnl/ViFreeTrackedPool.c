/*
 * XREFs of ViFreeTrackedPool @ 0x140813698
 * Callers:
        ...
        int a4)
{
  ...
  if ( (MmVerifierData & 0x800) != 0 )
  {
    if ( (v8 & 3) != 0 || !MiIsAddressValid(*v7) )
      VerifierBugCheckIfAppropriate(0xC4u, 0x13AuLL, BugCheckParameter2, v8, (ULONG_PTR)v7);
    if ( *(_QWORD *)(v9 + 16) != 556929861LL )
      VerifierBugCheckIfAppropriate(0xC4u, 0x13BuLL, BugCheckParameter2, v9 + 16, (ULONG_PTR)v7);
    if ( ((unsigned __int8)v10 & 3) != 0 || !MiIsAddressValid((__int64)&v10[2].Region) )
      VerifierBugCheckIfAppropriate(0xC4u, 0x13CuLL, BugCheckParameter2, (ULONG_PTR)v10, v9 + 8);
    if ( v10[2].Region != 2557876544 )
      VerifierBugCheckIfAppropriate(0xC4u, 0x13DuLL, BugCheckParameter2, (ULONG_PTR)&v10[2].Region, 0x98761940uLL);
  ...
  *(_QWORD *)(v8 + 16) |= 1uLL;
  ...
  result = &dword_1403AD1A0;
  if ( !v11 )
    result = &dword_1403AD1A4;
