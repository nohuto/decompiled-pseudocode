/*
 * XREFs of RtlDecompressBufferXpressHuff @ 0x14007AF40
 * Callers:
 *     <none>
 * Callees:
 *     XpressBuildHuffmanDecodingTable @ 0x14007B460 (XpressBuildHuffmanDecodingTable.c)
 */
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          {
            v21 = *(_WORD *)(v9 + 2 * ((unsigned __int64)v18 >> 22) + 1056) & 0xF;
            v18 <<= v21;
            v13 -= v21;
          }
          v22 = (v20 >> 4) - 256;
...
LABEL_53:
    ...
    {
      v41 = *(_WORD *)(v9 + 2 * ((unsigned __int64)v18 >> 22) + 1056) & 0xF;
      v18 <<= v41;
      v13 -= v41;
    }
    v22 = (v40 >> 4) - 256;
