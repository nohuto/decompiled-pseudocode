/*
 * XREFs of PpmIdleUpdateConcurrency @ 0x1402731E0
 * Callers:
 *     PpmIdleExecuteTransition @ 0x14010BC10 (PpmIdleExecuteTransition.c)
 *     PpmIdleInstallConcurrency @ 0x140272C80 (PpmIdleInstallConcurrency.c)
 *     PpmIdleRemoveConcurrency @ 0x140272E60 (PpmIdleRemoveConcurrency.c)
 * Callees:
