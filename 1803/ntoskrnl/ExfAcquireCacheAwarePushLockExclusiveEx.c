/*
 * XREFs of ExfAcquireCacheAwarePushLockExclusiveEx @ 0x1400AB010
 * Callers:
...
unsigned __int64 *__fastcall ExfAcquireCacheAwarePushLockExclusiveEx(unsigned __int64 **a1, __int64 a2, ULONG_PTR a3)
{
