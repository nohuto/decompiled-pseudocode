/*
 * XREFs of RtlpInsertInvertedFunctionTableEntry @ 0x140160EA4
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( PsInvertedFunctionTable[0] == dword_140463014 )
  {
    byte_14046301C = 1;
  }
  else
  {
    _InterlockedIncrement(&dword_140463018);
    v9 = 1;
    if ( PsInvertedFunctionTable[0] != 1 )
    {
      if ( PsInvertedFunctionTable[0] > 1u )
      {
        v10 = (unsigned __int64 *)&unk_140463040;
        do
        {
          if ( a2 < *v10 )
            break;
