/*
 * XREFs of VrpCreateNamespaceNode @ 0x140709D4C
 * Callers:
...
LABEL_19:
  ...
  v13[30] = VrpCountPathComponents(v13);
  v13[31] = VrpCountPathComponents(v13 + 12);
  VrpGetNextToken(a2, &v34, &String1);
  if ( !String1.Length )
    goto LABEL_26;
  BestMatchNamespaceNode = VrpFindBestMatchNamespaceNode(a1, v13, &v31);
  v21 = BestMatchNamespaceNode;
  if ( !BestMatchNamespaceNode || (v22 = *(_DWORD *)(BestMatchNamespaceNode + 56), (v22 & 4) != 0) )
  {
    v10 = -1073741811;
    goto LABEL_19;
  }
  ...
  *((_DWORD *)v13 + 14) |= v22 & 2;
  ...
  v10 = VrpBuildKeyPath((PCUNICODE_STRING)(v21 + 24), &Source, (PUNICODE_STRING)(v13 + 20));
  if ( v10 < 0 )
    goto LABEL_19;
LABEL_26:
  if ( a3 )
    ObfReferenceObjectWithTag((PVOID)a3, 0x67655256u);
  v10 = 0;
  v29 = a6;
  *((_QWORD *)v13 + 2) = a3 & -(__int64)(a3 != 0);
  *v29 = v13;
  return (unsigned int)v10;
}
