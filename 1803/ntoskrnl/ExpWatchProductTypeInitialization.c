/*
 * XREFs of ExpWatchProductTypeInitialization @ 0x1408BACD4
 * Callers:
...
char __fastcall ExpWatchProductTypeInitialization(__int64 a1)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  qword_1403A1B90 = (__int64)ExpWatchProductTypeWork;
  qword_1403A1B98 = 0LL;
    ...
    if ( PoolWithTag )
    {
      ...
      else
      {
        ...
        if ( NtQueryValueKey(ExpProductTypeKey, &ValueName, KeyValuePartialInformation, v45, 0x10u, &ResultLength) != -2147483643 )
          goto LABEL_18;
        ResultLength += 16;
        qword_1403D1308 = ExAllocatePoolWithTag(PagedPool, ResultLength, 0x2079654Bu);
        if ( !qword_1403D1308 )
        ...
        if ( NtQueryValueKey(
               ...
               ResultLength,
               &ResultLength) >= 0
          || (ExFreePoolWithTag(qword_1403D1308, 0), qword_1403D1308 = 0LL, !ExpSetupModeDetected) )
        {
LABEL_18:
          v11 = -1LL;
          do
