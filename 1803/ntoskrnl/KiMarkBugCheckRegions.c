/*
 * XREFs of KiMarkBugCheckRegions @ 0x140193188
 * Callers:
...
__int64 __fastcall KiMarkBugCheckRegions(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( qword_14039D358 )
  {
    KiMismatchSummary = qword_14039D358;
    IoAddTriageDumpDataBlock((int)&KiMismatchSummary, 8);
  }
  if ( (_DWORD)a4 == 257 && dword_14039D350 )
  {
    v8 = qword_14039D340;
    v9 = 0;
    do
    ...
    while ( v9 < dword_14039D350 );
    dword_14039D350 = 4096;
  }
  v16 = &qword_14039D340;
  v17 = 2LL;
  v18 = &dword_14039D350;
...
LABEL_45:
  ...
  result = sub_1401A13EC(a1, a2, a3, a4);
  if ( qword_14044C208 )
    return IoAddTriageDumpDataBlock(qword_14044C208, 2344);
  return result;
}
