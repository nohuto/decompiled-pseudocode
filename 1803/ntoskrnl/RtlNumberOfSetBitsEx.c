    ...
    do
    {
      ...
      v4 += (unsigned int)((0x101010101010101LL
                          * ((((v14 - ((v15 >> 1) & 0x5555555555555555LL)) & 0x3333333333333333LL)
                            ...
                            + ((((v14 - ((v15 >> 1) & 0x5555555555555555LL)) & 0x3333333333333333LL)
                              + (((v14 - ((v15 >> 1) & 0x5555555555555555LL)) >> 2) & 0x3333333333333333LL)) >> 4)) & 0xF0F0F0F0F0F0F0FLL)) >> 32) >> 24;
      --v13;
    }
    while ( v13 );
  }
