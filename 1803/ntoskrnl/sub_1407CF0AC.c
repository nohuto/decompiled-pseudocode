/*
 * XREFs of sub_1407CF0AC @ 0x1407CF0AC
 * Callers:
...
__int64 __fastcall sub_1407CF0AC(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
...
LABEL_81:
        ...
        if ( qword_140861400 )
        {
          ...
          if ( !v38 )
            v46 = v39;
          v47 = qword_140861400(v8, v9, v123, v10, NumberOfBytes, v46, v37, &v125);
        }
        else
        {
          v47 = -1073741637;
