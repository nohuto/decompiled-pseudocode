/*
 * XREFs of CmpAddSubKeyToList @ 0x140513844
 * Callers:
...
char __fastcall CmpAddSubKeyToList(ULONG_PTR BugCheckParameter2, unsigned int *a2, unsigned int a3)
{
  ...
  __m128i v22; // [rsp+48h] [rbp-20h] BYREF
  char v23; // [rsp+B0h] [rbp+48h]
  ...
  v6 = 0LL;
  v22.m128i_i16[0] = 0;
  v7 = v5(BugCheckParameter2, a3, &v26);
  v8 = v7;
  if ( !v7 )
    return 0;
  v9 = 1;
  ...
  if ( (*(_BYTE *)(v7 + 2) & 0x20) != 0 )
  {
    ...
    v22.m128i_i16[0] = 2 * v10;
    v22.m128i_i16[1] = 2 * v10;
    v13 = (_WORD *)v11((unsigned __int16)(2 * v10), 0LL, 540560707LL);
    v22.m128i_i64[1] = (__int64)v13;
    v14 = v13;
    if ( !v13 )
    {
      v9 = 0;
LABEL_14:
    ...
    v23 = 1;
    CmpCopyCompressedName(v13, v12, (unsigned __int8 *)(v8 + 76), *(unsigned __int16 *)(v8 + 72));
  }
  else
  {
    v23 = 0;
...
LABEL_10:
  if ( v23 )
    (*(void (__fastcall **)(_WORD *, _QWORD))(BugCheckParameter2 + 32))(v14, (unsigned __int16)v12);
  if ( v21 )
  {
