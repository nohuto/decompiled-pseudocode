/*
 * XREFs of LocalpConvertStringSidToSid @ 0x14064184C
 * Callers:
...
LABEL_24:
    v16 = v13[1];
    if ( v16 == 58 && ((v14 - 71) & 0xFFF3) == 0 && v14 != 75 )
      goto LABEL_34;
    if ( (unsigned __int16)(v14 - 48) > 0x36u
      || (v17 = 0x7E0000007E03FFLL, !_bittest64(&v17, (unsigned __int16)(v14 - 48))) )
    {
      v4 = -1073741704;
LABEL_84:
      *a3 = v13;
    ...
    if ( v23 )
    {
      ...
      while ( 1 )
      {
        ...
        *v25 = wcstoul(v22, &EndPtr, v26);
        ...
        {
          v27 = *EndPtr;
          if ( (unsigned __int16)v27 > 0x3Bu || (v28 = 0x800320000000001LL, !_bittest64(&v28, v27)) )
          {
            if ( EndPtr[1] != 58 )
              break;
            LOWORD(v27) = v27 - 68;
