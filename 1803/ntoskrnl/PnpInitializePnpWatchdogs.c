/*
 * XREFs of PnpInitializePnpWatchdogs @ 0x1408B786C
 * Callers:
...
void PnpInitializePnpWatchdogs()
{
  ...
  if ( (int)PnpOpenCCSPnpRegKey(&Handle) >= 0 )
  {
    *(_QWORD *)PnpWatchdogBugcheckWatchWorkItem = 0LL;
    qword_1403C5BF0 = (__int64)PnpWatchdogBugcheckWatchCallback;
    qword_1403C5BF8 = (__int64)Handle;
    PnpWatchdogBugcheckConfigure(Handle);
    if ( !(_BYTE)dword_14044B190 )
    {
      *(_DWORD *)&v0.Length = 4063292;
      v0.Buffer = (wchar_t *)L"\\Registry\\Machine\\System\\Setup";
      if ( IopOpenRegistryKeyEx(&KeyHandle, 0LL, &v0, 0x20019u) >= 0 )
      {
        *(_QWORD *)PnpWatchdogSetupInProgressWorkItem = 0LL;
        qword_1403C5BB0 = (__int64)PnpWatchdogSetupInProgressCallback;
        qword_1403C5BB8 = (__int64)KeyHandle;
