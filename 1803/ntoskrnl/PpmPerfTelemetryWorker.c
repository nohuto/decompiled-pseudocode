/*
 * XREFs of PpmPerfTelemetryWorker @ 0x1405F2B50
 * Callers:
 *     <none>
 * Callees:
...
__int64 PpmPerfTelemetryWorker()
{
  ...
  v0 = &unk_14044CA40;
  v1 = v17;
  v2 = qword_14044C9D8 - qword_14044C9E0;
  qword_14044C9E0 = qword_14044C9D8;
  v3 = 9LL;
  v4 = v2 / 0x989680;
  v5 = qword_14044C9E8 - qword_14044C9F0;
  qword_14044C9F0 = qword_14044C9E8;
  do
  {
  ...
  if ( pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
  {
    ...
    v14 = 4LL;
    v16 = 36LL;
    TlgWrite(&pCallbackContext, &unk_14030A831, 0LL, 0LL, 5u, &pData);
  }
  return PopOkayToQueueNextWorkItem((__int64)&unk_1403AB368);
}
