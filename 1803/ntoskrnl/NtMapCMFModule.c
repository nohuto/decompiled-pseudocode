/*
 * XREFs of NtMapCMFModule @ 0x1405F39CC
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtMapCMFModule(int a1, unsigned int a2, int *a3, unsigned int *a4, _DWORD *a5, PVOID *a6)
{
  ...
  __int64 v37; // rcx
  __int64 v38; // rcx
  unsigned int v39; // [rsp+50h] [rbp-118h]
  ...
  unsigned int v58; // [rsp+C4h] [rbp-A4h]
...
LABEL_10:
  if ( MappedBase )
  {
    MiUnmapViewOfSection((__int64)KeGetCurrentThread()->ApcState.Process, (unsigned __int64)MappedBase, 0, 0);
    return v39;
  }
  return v11;
}
