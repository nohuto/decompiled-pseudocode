/*
 * XREFs of EtwTraceEvent @ 0x1402AD70C
 * Callers:
      ...
      if ( (v12 & 0x80u) == 0 )
      {
        if ( a5 || (v12 & 0x1000000) == 0 )
        {
          ...
          if ( v32 >= (unsigned int)v5 )
          {
            ...
            v20 = (char *)EtwpReserveTraceBuffer(v11, v13, (__int64)v44, &v43, 0);
            v21 = v20;
            v35 = v20;
            if ( v20 )
            {
            ...
            {
              ReserveTraceBufferStatus = EtwpGetReserveTraceBufferStatus((__int64)v11, v13);
            }
            goto LABEL_68;
          }
