/*
 * XREFs of MiInitializeCommitment @ 0x14017DAD8
 * Callers:
...
__int64 __fastcall MiInitializeCommitment(__int64 a1)
{
  ...
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
    *(_QWORD *)(a1 + 6192) = (-(__int64)(*(_QWORD *)(a1 + 6864) < 0x4000uLL) & 0xFFFFFFFFFFFFFC00uLL) + 1280;
  else
    *(_QWORD *)(a1 + 6192) = 0LL;
  *(_QWORD *)(a1 + 6184) = 0LL;
  v2 = *(_BYTE *)(a1 + 503);
  ...
  *(_QWORD *)(a1 + 480) = a1 + 480;
  ...
  {
    v4 = 0LL;
    v5 = (unsigned int)dword_1403CB6DC;
    do
    {
      v6 = (__int64 *)(a1 + 4136);
      v7 = 2LL;
  ...
  *(_QWORD *)(a1 + 7104) = v3;
  ...
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
  {
    qword_1403CC650 = *(_QWORD *)(a1 + 7400);
    qword_1403CC650 -= qword_1403CC658;
    result = qword_1403CC680;
    qword_1403CC650 -= qword_1403CC680;
  }
  return result;
}
