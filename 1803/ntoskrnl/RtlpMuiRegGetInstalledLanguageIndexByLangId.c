/*
 * XREFs of RtlpMuiRegGetInstalledLanguageIndexByLangId @ 0x140636454
 * Callers:
 ...
 *     RtlpMuiRegGetInstalledLanguageIndexByName @ 0x1407F732C (RtlpMuiRegGetInstalledLanguageIndexByName.c)
 */
