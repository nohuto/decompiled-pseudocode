/*
 * XREFs of IopConnectInterrupt @ 0x14060BCDC
 * Callers:
        ...
        __int64 a10)
{
  ...
  *a1 = 0LL;
  ...
  v39 = v11;
  v36 = v12;
  v13 = v11.m128i_i64[0] & qword_14044C5D8[(unsigned __int16)_mm_extract_epi16(v11, 4)];
  v14 = *(_BYTE *)(a10 + 16);
  v39.m128i_i64[0] = v13;
  v51 = v14;
  if ( !*(_DWORD *)(a10 + 8)
    && !((unsigned __int8 (__fastcall *)(_QWORD, _QWORD))off_140398860[0])(0LL, *(unsigned int *)(a10 + 64))
      ...
      *((_QWORD *)v18 + 1) = v13;
      ...
      for ( ProcNumber.Group = _mm_extract_epi16(v21, 4); v24 < (char)v16; ++v22 )
      {
        if ( _bittest64((const __int64 *)&v13, v22) )
        {
          ...
          Interrupt = (_DWORD *)KeAllocateInterrupt((union _SLIST_HEADER *)KiProcessorBlock[ProcessorIndexFromNumber]);
          v26 = Interrupt;
          if ( !Interrupt )
          {
            v27 = -1073741670;
