/*
 * XREFs of EtwpCoverageSamplerContextSwap @ 0x1402B5BC0
 * Callers:
...
void __fastcall EtwpCoverageSamplerContextSwap(_KTHREAD *a1)
{
  ...
  if ( a1 && a1 != *(_KTHREAD **)qword_1403A1CE8 && a1 != KeGetCurrentPrcb()->IdleThread )
  {
    v1 = (*(_QWORD *)(qword_1403A1CE8 + 8) >> 4) & 0x1FFLL;
    v2 = ((unsigned int)*(_QWORD *)(qword_1403A1CE8 + 8) >> 13) & 0x3FFFF;
