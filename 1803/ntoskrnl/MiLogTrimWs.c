/*
 * XREFs of MiLogTrimWs @ 0x140083F9C
 * Callers:
 ...
 *     MiFillLogProcessInfo @ 0x140084048 (MiFillLogProcessInfo.c)
...
void __fastcall MiLogTrimWs(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  if ( hProvider )
  {
    MiFillLogProcessInfo(a1, &v16, &psz);
    if ( v9->LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(v9, 1uLL) )
      {
        ...
        v49 = 4;
        v52 = 4;
        TlgWriteEx(v14, &unk_14030A292, 0LL, v13, 0LL, 0LL, 0xCu, &pData);
      }
    }
  }
}
