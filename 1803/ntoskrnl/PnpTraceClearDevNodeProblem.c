/*
 * XREFs of PnpTraceClearDevNodeProblem @ 0x1406055C8
 * Callers:
...
void __fastcall PnpTraceClearDevNodeProblem(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    if ( TlgKeywordOn(&stru_140397160, 0x800000000000uLL) )
    {
      v9 = 1LL;
      v11 = &v9;
      v13 = v16;
      ...
      v22 = 4LL;
      v24 = 4LL;
      TlgWriteAgg((__int64)&stru_140397160, (unsigned __int8 *)dword_140309B1C, 0LL, v4, 9u, &v10);
    }
  }
}
