/*
 * XREFs of AuthzBasepQueryClaimAttributesToken @ 0x140571948
 * Callers:
 ...
 *     AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x1407DF9B0 (AuthzBasepGetClaimAttributesCopyoutBufferSize.c)
 */
