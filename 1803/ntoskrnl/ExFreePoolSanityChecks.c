/*
 * XREFs of ExFreePoolSanityChecks @ 0x140837DBC
 * Callers:
 ...
 *     KevSkipVerification @ 0x1402CB040 (KevSkipVerification.c)
...
__int64 __fastcall ExFreePoolSanityChecks(ULONG_PTR a1)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    if ( !ExpSpecialAllocations || (result = MmIsSpecialPoolAddress(a1), !(_DWORD)result) )
    {
      if ( (a1 & 0xFFF) == 0 )
      {
      ...
      if ( (a1 & 0xF) != 0 )
        VerifierBugCheckIfAppropriate(0xC4u, 0x16uLL, 0x20A9uLL, a1, 0LL);
      v4 = (unsigned int *)(a1 - 16);
      v5 = *(_BYTE *)(a1 - 16 + 3);
      if ( (v5 & 3) == 0 )
      {
        VerifierBugCheckIfAppropriate(0xC4u, 0x13uLL, 0x20B3uLL, a1 - 16, *v4);
        v5 = *((_BYTE *)v4 + 3);
      }
      v6 = v5 & 3;
...
LABEL_22:
      if ( (*((_BYTE *)v4 + 3) & 2) == 0 )
        return VerifierBugCheckIfAppropriate(0xC4u, 0x14uLL, 0x20D0uLL, a1 - 16, 0LL);
    }
  }
  return result;
}
