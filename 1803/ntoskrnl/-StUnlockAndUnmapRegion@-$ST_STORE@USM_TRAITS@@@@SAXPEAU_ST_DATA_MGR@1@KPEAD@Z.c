/*
 * XREFs of ?StUnlockAndUnmapRegion@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KPEAD@Z @ 0x140097378
 * Callers:
...
void __fastcall ST_STORE<SM_TRAITS>::StUnlockAndUnmapRegion(__int64 a1, unsigned int a2, int a3)
{
  ...
  else
  {
    ...
    *(_QWORD *)(v7 + 8 * v5) = v9;
    if ( (v9 & 3) == 0 )
      SmFpFree(v3 + 6592, 5, (__int64)KeGetCurrentThread(), v10);
  }
  v6 = *(_QWORD *)(a1 + 800);
  if ( (*(_BYTE *)(v6 + 6021) & 4) != 0 )
  {
    SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(*(_QWORD *)(a1 + 800), v5, a3, v6);
  }
  else
  {
    v11 = *(_QWORD *)(v6 + 6216);
    ...
    *(_QWORD *)(v11 + 8 * v5) = v13;
    if ( (v13 & 3) == 0 )
      SmFpFree(v6 + 6592, 5, (__int64)KeGetCurrentThread(), v14);
  }
}
