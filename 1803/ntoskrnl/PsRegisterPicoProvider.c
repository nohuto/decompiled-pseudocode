/*
 * XREFs of PsRegisterPicoProvider @ 0x14077D930
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_1403A60F0 = *(_OWORD *)(a1 + 16);
  xmmword_1403A6100 = *(_OWORD *)(a1 + 32);
  xmmword_1403A6110 = *(_OWORD *)(a1 + 48);
  xmmword_1403A6120 = *(_OWORD *)(a1 + 64);
  qword_1403A6130 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_1403A6110, 8).m128i_u64[0];
