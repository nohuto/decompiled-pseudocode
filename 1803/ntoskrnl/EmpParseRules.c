/*
 * XREFs of EmpParseRules @ 0x1408AA4CC
 * Callers:
 ...
 *     EmpInfParseSearchDependencyList @ 0x1408AB2B4 (EmpInfParseSearchDependencyList.c)
 */
...
__int64 __fastcall EmpParseRules(__int64 a1)
{
  ...
  _QWORD v33[2]; // [rsp+28h] [rbp-40h] BYREF
