/*
 * XREFs of PpmCheckArmPeriod @ 0x14017FAC0
 * Callers:
...
char PpmCheckArmPeriod()
{
  ...
  if ( (unsigned int)(10000 * HIDWORD(PpmCurrentProfile[336 * dword_1403AAA2C + 7])) > (unsigned __int64)PpmCheckMinimumPeriod )
    v0 = (unsigned int)(10000 * HIDWORD(PpmCurrentProfile[336 * dword_1403AAA2C + 7]));
  if ( !PpmCheckArmed )
    goto LABEL_7;
