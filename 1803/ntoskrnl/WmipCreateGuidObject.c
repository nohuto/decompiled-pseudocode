/*
 * XREFs of WmipCreateGuidObject @ 0x140502308
 * Callers:
...
__int64 __fastcall WmipCreateGuidObject(__int64 a1, ACCESS_MASK a2, _OWORD *a3, _QWORD *a4)
{
  ...
  struct _ACCESS_STATE v25; // [rsp+A8h] [rbp-60h] BYREF
  ...
  if ( GuidSecurityDescriptor >= 0 )
  {
    ...
    *(_OWORD *)Event_8 = *(_OWORD *)a1;
    ...
    v22 = Event;
    v20 = 640;
    GuidSecurityDescriptor = SeCreateAccessState((int *)&v25, v26, a2, (GENERIC_MAPPING *)&WmipGenericMapping);
    if ( GuidSecurityDescriptor >= 0 )
    {
      v12 = *(_OWORD *)&v25.SubjectSecurityContext.ClientToken;
      v13 = *(_OWORD *)&v25.SubjectSecurityContext.PrimaryToken;
      v25.SubjectSecurityContext = WmipSystemSubjectContext;
      ...
      if ( GuidSecurityDescriptor >= 0 )
      {
        ...
        *((_DWORD *)v14 + 36) = 4096;
        *(_OWORD *)(v14 + 24) = *a3;
        GuidSecurityDescriptor = ObInsertObjectEx(v14, &v25, a2, 0, 0, 0LL, 0LL);
        if ( GuidSecurityDescriptor >= 0 )
        {
          *a4 = v14;
      ...
      *(_OWORD *)&v25.SubjectSecurityContext.ClientToken = v12;
      *(_OWORD *)&v25.SubjectSecurityContext.PrimaryToken = v13;
