/*
 * XREFs of PopRestoreHiberContext @ 0x1404734E4
 * Callers:
...
struct _KPRCB *__fastcall PopRestoreHiberContext(ULONG_PTR BugCheckParameter3)
{
  ...
  *(_QWORD *)(*(_QWORD *)(BugCheckParameter3 + 264) + ((unsigned __int64)Number << 7) + 80) = 0LL;
  if ( Number == *(_DWORD *)(BugCheckParameter3 + 192) )
  {
    ...
    v26 = __rdtsc();
    qword_1403AA660 += (((unsigned __int64)HIDWORD(v26) << 32) | (unsigned int)v26) - v23;
  }
  if ( !Number )
  {
    v5 = 0LL;
    ...
    *(_BYTE *)(BugCheckParameter3 + 4) = 1;
    ...
    if ( *(_QWORD *)(BugCheckParameter3 + 400) )
    {
      ...
      *(_QWORD *)(BugCheckParameter3 + 160) = v34;
      v34[0] = qword_1403AA198;
      v34[1] = qword_1403AA198;
      v34[2] = 0LL;
      ((void (__fastcall *)(_QWORD))off_140398938[0])(0LL);
      ...
      v29 = __rdtsc();
      v10 = v35;
      qword_1403AA640 = (((unsigned __int64)HIDWORD(v29) << 32) | (unsigned int)v29) - v35;
    ...
    IoNotifyDump(3);
    ((void (__fastcall *)(__int64))off_140398938[0])(1LL);
    ...
    if ( v11 )
    {
      ...
      do
      {
        ...
        qword_1403AA620 += *(_QWORD *)(v19 + v17 + 64);
        qword_1403AA630 += *(_QWORD *)(v19 + *(_QWORD *)(BugCheckParameter3 + 264) + 72);
        qword_1403AA658 += *(_QWORD *)(v19 + *(_QWORD *)(BugCheckParameter3 + 264) + 80);
        v17 = *(_QWORD *)(BugCheckParameter3 + 264);
    ...
    if ( v21 > v20 )
    {
      v33 = 100 * (qword_1403AA628 * v11 / (v15 + v14 + 1) - v20) / (v21 - v20);
      if ( v33 > 99 )
      {
        dword_1403AA1C4 = 99;
        goto LABEL_22;
...
LABEL_22:
    v22 = __rdtsc();
    qword_1403AA648 = (((unsigned __int64)HIDWORD(v22) << 32) | (unsigned int)v22) - v10;
    result = (struct _KPRCB *)(qword_1403AA648 - qword_1403AA640 - v4);
    qword_1403AA618 = (__int64)result;
    return result;
  }
