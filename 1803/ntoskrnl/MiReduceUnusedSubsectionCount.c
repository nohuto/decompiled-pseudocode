/*
 * XREFs of MiReduceUnusedSubsectionCount @ 0x1400E4064
 * Callers:
...
signed __int64 __fastcall MiReduceUnusedSubsectionCount(_DWORD *a1)
{
  ...
  v1 = *(_QWORD *)(qword_1403CBD88 + 8LL * (*(_WORD *)(*(_QWORD *)a1 + 60LL) & 0x3FF));
  v2 = a1[11];
  v3 = 8LL * v2;
  if ( v3 > 0xFE0 )
  {
...
LABEL_4:
  result = _InterlockedExchangeAdd64(&qword_1403CB298, -(__int64)v5);
  *(_QWORD *)(v1 + 1624) -= v5;
  return result;
}
