/*
 * XREFs of ViDeadlockRemoveThread @ 0x14082A368
 * Callers:
...
__int64 __fastcall ViDeadlockRemoveThread(ULONG_PTR a1, int a2)
{
  ...
  if ( !a2 && *(_DWORD *)(a1 + 40) )
  {
    ViDeadlockPreprocessOptions(byte_14039D130, "Terminated thread 0x%p owns lock.", 4106LL, *(_QWORD *)a1, a1, 0LL);
    VfReportIssueWithOptions(0xC4u, 0x100AuLL, *(_QWORD *)a1, a1, 0LL, byte_14039D130);
  }
  ...
  *(_QWORD *)(v4 + 8) = v5;
  ...
  if ( *(_QWORD *)(v8 + v3[2050]) != v8 + v3[2050] )
    return VfUtilAddressRangeRemove(&v3[v9], *(_QWORD *)a1, 2072LL);
  v3[v9] = 0LL;
  v3[v9 + 1] = 0LL;
  return result;
}
