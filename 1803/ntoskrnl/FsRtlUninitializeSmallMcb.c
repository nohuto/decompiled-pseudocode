/*
 * XREFs of FsRtlUninitializeSmallMcb @ 0x1402E9570
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FsRtlUninitializeSmallMcb(__int64 a1)
{
  ...
  if ( *(_QWORD *)(CompleteDev + 1696) )
    return (*(__int64 (__fastcall **)(__int64, _QWORD))(CompleteDev + 624))(CompleteDev + 1696, 0LL);
  v2 = (__int64 (__fastcall *)())CompleteDev;
  v3 = *(_QWORD *)(CompleteDev + 1640);
  v4 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, unsigned __int64))(CompleteDev + 256);
  v5 = *(unsigned int *)(CompleteDev + 1668);
  v6 = *(_QWORD *)(CompleteDev + 1648);
  ...
  v9 = (unsigned __int64 *)&loc_1402E95F6;
  do
  {
    v10 = *v9 ^ v7;
    *v9 = v10;
