/*
 * XREFs of MiProtectSystemImage @ 0x14061C574
 * Callers:
 ...
 *     MiComputeDriverProtection @ 0x14061C854 (MiComputeDriverProtection.c)
 */
...
__int64 __fastcall MiProtectSystemImage(__int64 a1)
{
  ...
  if ( !(_DWORD)result )
  {
    ...
    v8 = (v4->OptionalHeader.SizeOfImage >> 12) + ((v4->OptionalHeader.SizeOfImage & 0xFFF) != 0);
    result = v4->FileHeader.SizeOfOptionalHeader;
    v9 = (char *)&v4->OptionalHeader + result;
    ...
    if ( v4->FileHeader.NumberOfSections )
    {
      ...
      while ( 1 )
      {
        ...
        v10 = result & (unsigned __int64)&v12[SectionAlignment - 1 + v13];
        if ( !--v7 )
          goto LABEL_10;
      }
    }
...
LABEL_10:
      ...
      do
      {
        if ( v17 == 1 )
        {
          ...
          v18 = 0LL;
          v44 = 0;
          v20 = MiGetPteAddress(v16) + 8;
        }
        else
        {
          v18 = (unsigned __int64)&v1[*((unsigned int *)v9 + 3)];
        ...
        if ( v23 && v20 > v23 )
        {
          v39 = MiComputeDriverProtection(v43, v24);
        ...
        v25 = *((_DWORD *)v9 + 9) & 0xE0000000;
        if ( v5 && ((MiFlags & 0x10000) == 0 || (*((_DWORD *)v9 + 9) & 0x20000000) == 0) )
          v25 = *((_DWORD *)v9 + 9) & 0x60000000 | 0x80000000;
        if ( v25 == v45 && (v38 = v4->OptionalHeader.SectionAlignment, (unsigned int)v38 <= 0x1000) )
        {
          v36 = v38 + v44 - 1LL;
          v37 = v38 - 1;
        }
