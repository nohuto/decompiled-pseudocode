/*
 * XREFs of EtwpCCSwapTrace @ 0x140172B10
 * Callers:
    ...
    if ( v14 )
    {
      ...
      if ( v12 > 1 || v17 > 7 || v13 >= 0x20000 )
      {
        ...
        if ( v12 >= 0x1FFFF )
          v12 = 0x1FFFF;
        v21 = *(_BYTE *)(a1 + 388);
        v26 = ((unsigned __int16)v26 ^ ((unsigned __int8)v15 ^ (unsigned __int8)v26) & 0xF) & 0x3FF | (((32 * v12) | v16 & 0x1F) << 10);
        if ( v21 == 5 )
          v22 = ((unsigned __int16)v26 ^ (unsigned __int16)(16 * *(unsigned __int8 *)(a1 + 643))) & 0x3F0 ^ v26;
        else
          v22 = (16 * *(unsigned __int8 *)(a1 + 388) - 369) & 0x3F0 | v26 & 0xFFFFFC0F;
        v26 = v22;
        v20 = 8;
      }
      else
      {
        v18 = *(_BYTE *)(a1 + 388);
        Src = Src & 0x7E00 | (4 * (v15 & 0xF | (16 * (((_DWORD)v13 << 9) | v17 & 7)))) | 2;
        if ( v18 == 5 )
          v19 = ((unsigned __int16)Src ^ (unsigned __int16)(*(unsigned __int8 *)(a1 + 643) << 9)) & 0x7E00 ^ Src;
        else
          v19 = ((*(unsigned __int8 *)(a1 + 388) << 9) - 11777) & 0x7E00 | Src & 0xFFFF81FF;
        Src = v19;
        v20 = 4;
      }
    }
