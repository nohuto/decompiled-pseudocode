/*
 * XREFs of CmpCheckLexicographicalOrder @ 0x1405504B0
 * Callers:
...
__int64 __fastcall CmpCheckLexicographicalOrder(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  *(_QWORD *)&String2.Length = v6;
  v7 = (_WORD *)(*(__int64 (__fastcall **)(__int64, _QWORD, __int64 *))(v4 + 8))(v4, a2, &v20);
  v8 = v7;
  if ( !v6 || !v7 )
  {
    v17 = -1073741670;
  ...
  if ( (*(_BYTE *)(v6 + 2) & 0x20) == 0 )
  {
    ...
    if ( v10 )
    {
      v19 = (unsigned __int16)v7[36];
      String2.Length = *(_WORD *)(v6 + 72);
      String2.MaximumLength = String2.Length;
      if ( (int)((__int64 (__fastcall *)(UNICODE_STRING *, unsigned __int8 *, __int64, _QWORD, __int64))CmpCompareCompressedName)(
                  &String2,
                  v9,
                  v19,
                  0LL,
...
LABEL_14:
  ...
  if ( !v10 )
  {
    ...
    v4 = a1;
    if ( (int)CmpCompareCompressedName(&String1, v6 + 76, v13, 0LL, v20, *(_DWORD *)&String2.Length, String2.Buffer) >= 0 )
    {
      v17 = -1073741492;
      goto LABEL_15;
    }
...
LABEL_15:
  ...
  if ( v8 )
    (*(void (__fastcall **)(__int64, __int64 *))(v4 + 16))(v4, &v20);
  return v17;
}
