/*
 * XREFs of ?ReadPartitionTable@SC_MBR@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x1402C97A0
 * Callers:
 ...
 *     ?Validate@MBR_ENTRY@@QEAAEK_K@Z @ 0x1402C9B7C (-Validate@MBR_ENTRY@@QEAAEK_K@Z.c)
    ...
    do
    {
      ...
      if ( MBR_ENTRY::Validate((MBR_ENTRY *)(v10 - 4), v14, *((_QWORD *)*this + 22)) )
      {
        *(_DWORD *)&v8[144 * v5 + 48] = 0;
        v16 = (v32 + (unsigned __int64)*((unsigned int *)v10 + 1)) << *((_DWORD *)*this + 43);
