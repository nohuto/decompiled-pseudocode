/*
 * XREFs of MiFreeUltraMdlContext @ 0x14026D2CC
 * Callers:
...
PSLIST_ENTRY __fastcall MiFreeUltraMdlContext(PSLIST_ENTRY ListEntry)
{
  ...
  v5 = qword_1403CC330 + ((unsigned __int64)CurrentPrcb->ParentNode->Affinity.Reserved[0] << 9);
  for ( i = 0; i < 0x10; ++i )
  {
    LODWORD(v4) = v4 & 7;
    if ( *(unsigned __int16 *)(((unsigned __int64)(unsigned int)v4 << 6) + v5) <= (dword_1403CC328
