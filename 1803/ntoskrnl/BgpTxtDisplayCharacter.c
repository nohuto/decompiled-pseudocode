/*
 * XREFs of BgpTxtDisplayCharacter @ 0x1401736FC
 * Callers:
 ...
 *     TxtpGetCacheEntry @ 0x140173938 (TxtpGetCacheEntry.c)
...
LABEL_5:
    ...
    v26 += *(_DWORD *)a1;
    if ( (a3 & 1) != 0
      || (dword_14039D7F0 & 0x1000000) != 0
      || (v14 = BgpGxDrawRectangle(v7, (__int64)&v26, (__int64)v10), v14 >= 0) )
    {
      if ( v15 )
  ...
  v14 = BgpGxConvertRectangleEx(v7, BitsPerPixel, &v33, 0LL);
  v15 = v13;
  if ( v14 >= 0 )
  {
    if ( (int *)v7 != v16 )
