/*
 * XREFs of IoGetDmaAdapter @ 0x1406478F0
 * Callers:
        ...
        PULONG NumberOfMapRegisters)
{
  ...
  _BYTE v21[20]; // [rsp+40h] [rbp-68h] BYREF
  ...
  if ( PhysicalDeviceObject )
  {
    ...
    ((void (__fastcall *)(struct _KTHREAD *, PDEVICE_OBJECT))off_1403989E8[0])(
      KeGetCurrentThread(),
    ...
    ((void (__fastcall *)(struct _KTHREAD *, _QWORD))off_1403989E8[0])(KeGetCurrentThread(), 0LL);
  }
