/*
 * XREFs of PopTimeoutWakeTracking @ 0x140154DF4
 * Callers:
 *     PopWakeSourceTimeoutWorker @ 0x1405EDDC0 (PopWakeSourceTimeoutWorker.c)
 * Callees:
...
__int64 __fastcall PopTimeoutWakeTracking(__int64 *a1)
{
  ...
  if ( a1 == (__int64 *)PopCurrentWakeInfo )
  {
    ...
    {
      for ( i = qword_1403AAEE8; (PVOID *)i != &PopWakeSourceWorkList; i = *(_QWORD *)(i + 8) )
      {
        if ( *(__int64 **)(i + 24) == a1 )
        {
          *(_QWORD *)(i + 32) = &v6;
