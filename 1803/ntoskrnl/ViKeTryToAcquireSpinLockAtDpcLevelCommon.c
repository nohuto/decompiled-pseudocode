/*
 * XREFs of ViKeTryToAcquireSpinLockAtDpcLevelCommon @ 0x140827980
 * Callers:
 *     VerifierKeTryToAcquireSpinLockAtDpcLevel @ 0x140826E50 (VerifierKeTryToAcquireSpinLockAtDpcLevel.c)
 *     VerifierKeTryToAcquireSpinLockAtDpcLevelNoReboot @ 0x140826EB0 (VerifierKeTryToAcquireSpinLockAtDpcLevelNoReboot.c)
 * Callees:
...
__int64 __fastcall ViKeTryToAcquireSpinLockAtDpcLevelCommon(ULONG_PTR BugCheckParameter2, __int64 a2)
{
  ...
  return ((__int64 (__fastcall *)(ULONG_PTR))pXdvKeTryToAcquireSpinLockAtDpcLevel)(BugCheckParameter2);
}
