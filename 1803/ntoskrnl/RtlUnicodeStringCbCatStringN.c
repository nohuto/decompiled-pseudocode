/*
 * XREFs of RtlUnicodeStringCbCatStringN @ 0x1402C2B4C
 * Callers:
 *     AslpPathWildcardAllocMatchNode @ 0x1407DB5F8 (AslpPathWildcardAllocMatchNode.c)
 * Callees:
 *     RtlWideCharArrayCopyStringWorker_0 @ 0x1402C2C28 (RtlWideCharArrayCopyStringWorker_0.c)
 */
        ...
        size_t cbToAppend)
{
  ...
  if ( result >= 0 )
  {
    ...
    if ( cchToCopy <= 0x7FFF )
    {
      ...
      result = RtlWideCharArrayCopyStringWorker_0(&Buffer[v9], v8 - v9, &pcchNewDestLength, pszSrc, cchToCopy);
