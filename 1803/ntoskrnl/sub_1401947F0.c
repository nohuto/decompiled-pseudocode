...
LABEL_35:
  *(_QWORD *)(((unsigned __int64)v1584 & 0xFFFFFFFFFFFFFF80uLL) + 0x138) = 2424LL;
        ...
        v13 == 2424) )
  {
    ...
    *(_QWORD *)(((unsigned __int64)v1584 & 0xFFFFFFFFFFFFFF80uLL) + 0xB0) = v15;
    ...
    if ( v15 )
      goto LABEL_41;
    ++dword_14039D418;
    PoolWithTag = (struct _SLIST_ENTRY *)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_14039D430)(
  ...
  {
    PoolWithTag = (struct _SLIST_ENTRY *)ExAllocatePoolWithTag(NonPagedPoolNx, v13, 0x746E494Bu);
  }
