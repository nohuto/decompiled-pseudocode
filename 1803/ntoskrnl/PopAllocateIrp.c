/*
 * XREFs of PopAllocateIrp @ 0x1401673F8
 * Callers:
...
LABEL_21:
    ...
    *(_DWORD *)(*(_QWORD *)SpinLock + 212LL) = _InterlockedIncrement(&PopCurrentIrpSequenceID);
    ...
    v28 = (_QWORD *)qword_1403AA718;
    if ( *(__int64 **)qword_1403AA718 != &PopIrpList )
      __fastfail(3u);
    *v25 = &PopIrpList;
    v25[1] = v28;
    *v28 = v25;
    qword_1403AA718 = (__int64)v25;
