/*
 * XREFs of ViXdvDriverLoadImage @ 0x1408162A4
 * Callers:
 ...
 *     ViXdvGetFuncAddress @ 0x1408164C0 (ViXdvGetFuncAddress.c)
 */
...
char __fastcall ViXdvDriverLoadImage(__int64 a1)
{
  ...
  do
  {
    ...
    {
      v14 = (__int64 (__fastcall *)(_QWORD))ViXdvGetFuncAddress(v1, v4, (unsigned int)v9);
      ViFnXdvQueryDispatchTable = v14;
      if ( v14 )
      {
        ViXdvTipUtils = v14(4LL);
        if ( !ViXdvTipUtils )
