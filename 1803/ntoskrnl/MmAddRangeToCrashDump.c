/*
 * XREFs of MmAddRangeToCrashDump @ 0x140257390
 * Callers:
 *     MmGetDumpRange @ 0x140257488 (MmGetDumpRange.c)
 *     ExAddPrivateDataToCrashDump @ 0x1402B89AC (ExAddPrivateDataToCrashDump.c)
...
__int64 __fastcall MmAddRangeToCrashDump(
        ...
        __int64 a3)
{
  __int64 (__fastcall **v3)(_QWORD, __int64, __int64); // r11
  ...
  while ( v8 );
  return MiAddRangeToCrashDump(v3, a2, v6, (__int64)v10, 3u);
}
