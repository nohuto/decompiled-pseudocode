/*
 * XREFs of PfSnPrefetchCacheCtxStart @ 0x14064C130
 * Callers:
      ...
      do
      {
        ...
        while ( 1 )
        {
          ...
          *(_QWORD *)(v11 + 8LL * v5) = *v12;
          v13 = ((((unsigned __int64)v6 & v12[1]) >> 56)
               + 37
               * ((unsigned __int8)(((unsigned __int64)v6 & v12[1]) >> 48)
                + 37
                * (((unsigned __int16)(((unsigned __int64)v6 & v12[1]) >> 32) >> 8)
                 + 37
                 * ((unsigned __int8)(((unsigned __int64)v6 & v12[1]) >> 32)
                  + 37
                  * ((((unsigned int)v6 & (_DWORD)v12[1]) >> 24)
                   + 37
                   * ((unsigned __int8)(((unsigned int)v6 & (_DWORD)v12[1]) >> 16)
                    + 37 * (((unsigned __int16)(v6 & v12[1]) >> 8) + 37 * (((unsigned __int8)v6 & (_BYTE)v12[1]) - 53)))))))) & 0x1F;
