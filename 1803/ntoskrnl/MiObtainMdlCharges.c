/*
 * XREFs of MiObtainMdlCharges @ 0x1400B3AB8
 * Callers:
        ...
        int a7)
{
  ...
  *((_WORD *)PoolWithTag + 4) = 8 * ((((v11 << 12) + 4095) >> 12) + 6);
  ...
  v19 = v11;
  while ( !(unsigned int)MiChargeResident(a1, v11, v12) )
  {
    if ( (v7 & 4) == 0 )
    {
      if ( (__int64)(*(_QWORD *)(a1 + 7104) - v12) > 0 )
      {
        if ( v11 > *(_QWORD *)(a1 + 7104) - v12 )
          v11 = *(_QWORD *)(a1 + 7104) - v12;
      }
      else
      {
  ...
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
    _InterlockedExchangeAdd64(&qword_1403CC658, v11);
  result = v18;
