/*
 * XREFs of ?SmStEtwFillStoreStatsEvent@?$SMKM_STORE@USM_TRAITS@@@@SAKPEAU1@PEAU_SMKM_EVENT_DESCRIPTOR@@@Z @ 0x1402A8980
 * Callers:
 ...
 *     StLcBucketsCopy @ 0x1402A699C (StLcBucketsCopy.c)
 */
