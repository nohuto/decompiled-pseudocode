/*
 * XREFs of FsRtlpOplockBreakToNone @ 0x1400D21C0
 * Callers:
...
LABEL_14:
      ...
      if ( (v9 & 0x10010000) == 0 )
      {
        ...
        *a8 = 0;
        return (unsigned int)FsRtlpWaitOnIrp(a1, v10, a5, a6, a7, v23, 0, a9);
      }
      return (unsigned int)-1073739511;
    }
    if ( (a4 & 0x10010000) != 0 )
  ...
  else
  {
    ...
    for ( i = *(_QWORD **)(a1 + 40); i != (_QWORD *)(a1 + 40); i = (_QWORD *)*i )
    {
      ...
      {
        i = (_QWORD *)i[1];
        FsRtlpRemoveAndCompleteReadOnlyIrp(*i, 0LL, 0LL, a4);
      }
    }
