/*
 * XREFs of SaveNodeDistanceInformation @ 0x1408C9294
 * Callers:
...
void SaveNodeDistanceInformation()
{
  ...
  _DWORD *v75; // [rsp+58h] [rbp-59h]
  __int64 *v76; // [rsp+60h] [rbp-51h]
  __int64 v77; // [rsp+68h] [rbp-49h]
  ...
  int v83; // [rsp+CCh] [rbp+1Bh]
  int v84; // [rsp+D0h] [rbp+1Fh]
  unsigned int v85; // [rsp+D4h] [rbp+23h]
          ...
          while ( 1 )
          {
            if ( *(_WORD *)(*v57 + 146) == *(_WORD *)(*v57 + 148) )
            {
              ...
              while ( 1 )
              {
                ...
                {
                  v59 = *((_DWORD *)KeNodeDistance + v58 + v56 * (unsigned __int16)KeNumberNodes);
                  v60 = (int)(LODWORD(v10[(unsigned int)v0 * v56 + v58]) - v59);
                  if ( 100 * ((HIDWORD(v60) ^ (unsigned int)v60) - HIDWORD(v60)) / v53 > v59 )
                    break;
                }
          ...
          do
          {
            ...
            do
            {
              ...
              if ( v71 == v72 )
                ...
                *((_DWORD *)KeNodeDistance + v67) = v10[v72 + (unsigned int)v0 * v71];
