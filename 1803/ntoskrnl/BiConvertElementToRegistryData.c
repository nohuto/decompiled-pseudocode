...
LABEL_28:
  ...
  if ( !v14 )
  {
    if ( a3 != 16 )
      return (unsigned int)-1073741788;
    v11 = RtlStringFromGUIDEx((unsigned int *)a2, (__int64)&DestinationString, 1);
    if ( v11 < 0 )
      return (unsigned int)v11;
    Buffer = DestinationString.Buffer;
    v18 = DestinationString.Length + 2;
    goto LABEL_16;
  }
  v15 = v14 - 1;
  if ( v15 )
...
LABEL_47:
    ...
    if ( v28 )
    {
      while ( 1 )
      {
        v11 = RtlStringFromGUIDEx((unsigned int *)&a2[16 * v31], (__int64)&DestinationString, 1);
        if ( v11 < 0 )
          goto LABEL_61;
...
LABEL_61:
  ...
  while ( 1 )
  {
    ...
    v11 = RtlStringFromGUIDEx((unsigned int *)&a2[16 * v6], (__int64)&DestinationString, 1);
    if ( v11 < 0 )
      return (unsigned int)v11;
