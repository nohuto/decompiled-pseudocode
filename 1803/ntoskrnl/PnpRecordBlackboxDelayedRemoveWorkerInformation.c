/*
 * XREFs of PnpRecordBlackboxDelayedRemoveWorkerInformation @ 0x14073E8E8
 * Callers:
...
void __fastcall PnpRecordBlackboxDelayedRemoveWorkerInformation(_QWORD *a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *v2 = 1;
      v2[1] = 64;
      *((_BYTE *)v2 + 8) = *(_BYTE *)(a1[3] + 137LL);
      v2[3] = (v4 - *(_QWORD *)a1[3]) / 0x2710uLL;
      *((_QWORD *)v2 + 3) = a1[1];
      *((_QWORD *)v2 + 4) = a1[2];
      *((_QWORD *)v2 + 2) = *a1;
      *((_QWORD *)v2 + 5) = PnpDeviceEventThread;
      *((_QWORD *)v2 + 6) = PnpDeviceActionThread;
      *((_QWORD *)v2 + 7) = PnpDelayedRemoveWorkerThread;
    }
  }
