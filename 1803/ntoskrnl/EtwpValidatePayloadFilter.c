/*
 * XREFs of EtwpValidatePayloadFilter @ 0x1407BA5E8
 * Callers:
...
__int64 __fastcall EtwpValidatePayloadFilter(_QWORD *a1, __int64 a2, unsigned int a3)
{
  ...
  int v46; // [rsp+4h] [rbp-94h]
  int v47; // [rsp+8h] [rbp-90h]
  int v48; // [rsp+Ch] [rbp-8Ch]
  int v49; // [rsp+14h] [rbp-84h]
  unsigned int v50; // [rsp+18h] [rbp-80h]
  ...
  v33 = 0LL;
  v56 = v29;
  v55 = (_BYTE *)(a2 + (unsigned __int16)v48);
  v49 = 0;
  if ( v25 )
  {
    while ( 1 )
...
LABEL_34:
      ...
      if ( *(_WORD *)(v26 + 10) )
      {
        do
        {
          if ( (*v29 & 0xFCu) > 0x20 || (unsigned __int16)v29[1] != v45 )
            return 3221225485LL;
...
LABEL_59:
            ...
            if ( *((_QWORD *)v32 + 1) != v31 || *((_QWORD *)v32 + 2) )
              return 3221225485LL;
            v43 = v55;
            for ( i = a2 + (unsigned int)(v48 + v51); *v43; ++v43 )
            {
              if ( (unsigned __int64)v43 >= i - 1 )
                break;
            }
            if ( (unsigned __int64)(v43 + 1) > i )
              return 3221225485LL;
            v31 += (_DWORD)v43 + 1 - (_DWORD)v55;
            v55 = v43 + 1;
            goto LABEL_59;
          }
LABEL_61:
  ...
  if ( v33 != *(_QWORD *)(a2 + 8) || v45 != v9 || v46 != v22 || v23 != v24 || v59 != v27 )
    return 3221225485LL;
