/*
 * XREFs of RtlpGenericInverseCouplingWorker @ 0x14028FA18
 * Callers:
 *     RtlScrubMemory @ 0x14028F74C (RtlScrubMemory.c)
 * Callees:
 *     RtlpTestAndFillMemoryUp @ 0x1402902AC (RtlpTestAndFillMemoryUp.c)
 *     RtlpTestMemory @ 0x1402902D4 (RtlpTestMemory.c)
 */
