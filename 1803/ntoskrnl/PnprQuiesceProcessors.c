/*
 * XREFs of PnprQuiesceProcessors @ 0x140483D08
 * Callers:
...
__int64 PnprQuiesceProcessors()
{
  ...
  if ( (*(_DWORD *)(PnprContext + 64) & 0x20) != 0 && (int)off_1403987B8[0]() < 0 )
  {
  ...
  {
    ((void (__fastcall *)(_QWORD, _QWORD))off_140398768[0])(0LL, *(_QWORD *)(PnprContext + 20872));
    ...
    if ( !*(_DWORD *)(v40 + 16)
      || (v41 = PnprGetMillisecondCounter(0),
          ...
          *(_DWORD *)(PnprContext + 21004) = v41,
          v43 = ((__int64 (__fastcall *)(__int64, _QWORD))off_140398768[0])(1LL, *(_QWORD *)(v42 + 20872)),
