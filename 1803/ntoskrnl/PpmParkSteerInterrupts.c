/*
 * XREFs of PpmParkSteerInterrupts @ 0x140033FB0
 * Callers:
 *     <none>
 * Callees:
...
char PpmParkSteerInterrupts()
{
  ...
  _DWORD v29[43]; // [rsp+74h] [rbp-8Ch] BYREF
  _QWORD v30[22]; // [rsp+120h] [rbp+20h] BYREF
  _BYTE v31[176]; // [rsp+1D0h] [rbp+D0h] BYREF
  _DWORD v32[44]; // [rsp+280h] [rbp+180h] BYREF
  char v33[8]; // [rsp+330h] [rbp+230h] BYREF
  unsigned __int64 v34; // [rsp+338h] [rbp+238h]
...
LABEL_6:
  ...
  if ( !v1 )
  {
    ...
    {
      FirstSetRightAffinity = KeFindFirstSetRightAffinityEx(&KiCachedSystemAllowedCpuSet, v25, v3);
...
LABEL_16:
        ...
        else
        {
          ...
          if ( PpmParkPreferenceHandler )
            PpmParkPreferenceHandler(1LL, PpmCheckTime, v2, v30, 0LL, v32, &v28);
          v11 = 0;
          if ( (_WORD)v28 )
          {
