/*
 * XREFs of PopDiagTraceDeepSleepConstraintRundown @ 0x1400775EC
 * Callers:
...
void PopDiagTraceDeepSleepConstraintRundown()
{
  ...
  __int64 v8; // rcx
  unsigned int v9; // eax
  unsigned __int16 v10; // [rsp+40h] [rbp-E8h] BYREF
  _DWORD v11[10]; // [rsp+48h] [rbp-E0h] BYREF
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+70h] [rbp-B8h] BYREF
