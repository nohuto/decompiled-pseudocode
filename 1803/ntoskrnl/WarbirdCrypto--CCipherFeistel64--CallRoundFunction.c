/*
 * XREFs of WarbirdCrypto::CCipherFeistel64::CallRoundFunction @ 0x14009B2D0
 * Callers:
        ...
        unsigned int a4)
{
  ...
  switch ( v7[2] )
  {
    ...
    case 1:
      ...
      v66 = a3;
      v65 = a3;
      v29 = a4 - *((unsigned __int16 *)&v66 + ((v43 % 3 + (_BYTE)a2 + 1) & 3));
    ...
    case 2:
      ...
      v66 = a3;
      v65 = a3;
      return (a4 >> (v59 % 0xF + 1)) ^ (*((unsigned __int16 *)&v65 + (v6 & 3))
                                      * (a4 ^ *((unsigned __int16 *)&v66 + ((v60 % 3 + (_BYTE)a2 + 1) & 3))));
    case 3:
      v62 = v7[4];
      v63 = v7[3];
      v66 = a3;
    ...
    case 4:
      ...
      return *((unsigned __int16 *)&v65 + (v6 & 3))
           * (a4 ^ *((unsigned __int16 *)&v66 + ((v41 % 3 + (_BYTE)a2 + 1) & 3)))
           - __ROR4__(a4, v40 % 0xF + 1);
    case 5:
      v45 = v7[4];
      v46 = v7[3];
      v66 = a3;
    ...
    case 6:
      ...
      return (a4 >> (v35 % 0xF + 1))
           + *((unsigned __int16 *)&v65 + (v6 & 3))
           * __ROL4__(a4 ^ *((unsigned __int16 *)&v66 + ((v37 % 3 + (_BYTE)a2 + 1) & 3)), v36 % 7 + 1);
    case 7:
      v27 = v7[4];
      v28 = v7[5];
      v66 = a3;
...
LABEL_17:
    ...
    case 9:
      ...
      v66 = a3;
      v65 = a3;
      v33 = __ROL4__(a4 ^ *((unsigned __int16 *)&v66 + ((v39 % 3 + (_BYTE)a2 + 1) & 3)), v38 % 7 + 1);
    ...
    case 0xB:
      ...
      v66 = a3;
      v65 = a3;
      v10 = __ROL4__(a4 ^ *((unsigned __int16 *)&v66 + ((v54 % 3 + (_BYTE)a2 + 1) & 3)), v53 % 7 + 1);
    ...
    case 0xE:
      ...
      v66 = a3;
      v65 = a3;
      v33 = __ROR4__(a4 ^ *((_DWORD *)&v66 + (((unsigned __int8)(a2 >> 1) - 1) & 1)), v42 % 0x1F + 1);
      v34 = *((unsigned __int16 *)&v65 + (v6 & 3));
      return (unsigned int)(__ROR4__(a4, v32 % 0x1F + 1) + v34 * v33);
    case 0xF:
      v61 = v7[4];
