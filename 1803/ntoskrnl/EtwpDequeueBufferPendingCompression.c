/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x1402B3724
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x1402B3818 (EtwpDequeueBufferPendingCompressionFromQueue.c)
