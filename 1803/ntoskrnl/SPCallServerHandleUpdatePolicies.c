/*
 * XREFs of SPCallServerHandleUpdatePolicies @ 0x140548088
 * Callers:
...
LABEL_50:
  if ( (int)v10 < 0 )
    return (unsigned int)v10;
  v31 = ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))qword_140861458)(v29, v30, v10, v26);
  if ( v31 == 263 )
  {
    v32 = 1074058754;
  }
