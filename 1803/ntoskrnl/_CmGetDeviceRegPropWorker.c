/*
 * XREFs of _CmGetDeviceRegPropWorker @ 0x1405083FC
 * Callers:
 ...
 *     _MapCmDevicePropertyToNtProperty @ 0x14006E094 (_MapCmDevicePropertyToNtProperty.c)
 *     _MapCmDevicePropertyToRegValue @ 0x14006E0F8 (_MapCmDevicePropertyToRegValue.c)
 *     RtlStringCbCopyNExW @ 0x1400CB8B8 (RtlStringCbCopyNExW.c)
        ...
        __int16 a8)
{
  ...
  *a5 = 0;
  ...
  if ( !v14 )
  {
    v17 = CmOpenDeviceRegKey(v13, (__int64)a2, 0x10u, 0, 33554433, (char)v16, (__int64)&Handle, v16);
    v16 = 0LL;
    inited = v17;
    if ( v17 < 0 )
      goto LABEL_26;
