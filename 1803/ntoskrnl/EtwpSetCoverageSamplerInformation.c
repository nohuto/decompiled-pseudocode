/*
 * XREFs of EtwpSetCoverageSamplerInformation @ 0x1407B8BD4
 * Callers:
 ...
 *     EtwpCovSampApplyBounds @ 0x1407B32E4 (EtwpCovSampApplyBounds.c)
  ...
  if ( BYTE4(Handle[0]) )
  {
    ...
    if ( (_DWORD)v4 == 40 )
    {
      ...
      *(_QWORD *)&v52 = *((_QWORD *)v5 + 4);
      inserted = ObReferenceObjectByHandle(Handle[1], 1u, qword_1403A1CD0, AccessMode, &v47, 0LL);
      v6 = (char *)v47;
      if ( inserted >= 0 )
      {
...
LABEL_4:
  ...
  *(_QWORD *)&v51 = 0LL;
  v52 = 0LL;
  inserted = ObCreateObjectEx(0, qword_1403A1CD0, (int)&v50, AccessMode, (__int64)Object, 1208, 0, 0, &v47, 0LL);
  v6 = (char *)v47;
  if ( inserted >= 0 )
  {
      ...
      *((HANDLE *)v6 + 143) = Handle[0];
      if ( inserted >= 0 )
      {
        ...
        if ( inserted >= 0 )
        {
          ...
          inserted = ObInsertObjectEx(v6, 0LL, 1LL, 0, 0, 0LL, &v48);
          if ( inserted >= 0 )
          {
            v54 = v48;
            v53[6] = 16;
