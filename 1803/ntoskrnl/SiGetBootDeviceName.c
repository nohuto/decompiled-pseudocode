/*
 * XREFs of SiGetBootDeviceName @ 0x140569834
 * Callers:
 *     SiGetSystemPartition @ 0x1405696C0 (SiGetSystemPartition.c)
 ...
 *     SiGetBootDeviceNameFromRegistry @ 0x1405699D8 (SiGetBootDeviceNameFromRegistry.c)
