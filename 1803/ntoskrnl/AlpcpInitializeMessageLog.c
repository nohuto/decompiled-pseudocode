/*
 * XREFs of AlpcpInitializeMessageLog @ 0x14064F66C
 * Callers:
...
LABEL_11:
    ...
    if ( a1 )
    {
      ...
      do
      {
        ...
        *((_QWORD *)v13 + 7) = v13 + 48;
        *((_QWORD *)v13 + 6) = v13 + 48;
        v14 = (char **)qword_1403AD2D8;
        if ( *(__int64 **)qword_1403AD2D8 != &AlpcpFreeMessageLogListHead )
          __fastfail(3u);
        *((_QWORD *)v13 + 1) = qword_1403AD2D8;
        ++v11;
        *(_QWORD *)v13 = &AlpcpFreeMessageLogListHead;
        *v14 = v13;
        v12 = v11;
        qword_1403AD2D8 = (__int64)v13;
      }
      while ( v11 < a1 );
    }
    if ( a2 )
