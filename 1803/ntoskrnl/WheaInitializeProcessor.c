/*
 * XREFs of WheaInitializeProcessor @ 0x140487FA8
 * Callers:
...
__int64 __fastcall WheaInitializeProcessor(__int64 a1, unsigned int a2)
{
  ...
  if ( a2 )
  {
    for ( i = qword_1403D17D0; (__int64 *)i != &qword_1403D17D0; i = *(_QWORD *)i )
    {
      result = (*((__int64 (__fastcall **)(_QWORD, __int64, _QWORD))&unk_1403E9348 + 6 * *(int *)(i + 40)))(
                 a2,
                 i + 89,
                 *(_QWORD *)(i + 56));
      if ( (int)result < 0 )
  ...
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *(_DWORD *)PoolWithTag = dword_1403D17CC;
