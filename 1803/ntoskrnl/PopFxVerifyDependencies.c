/*
 * XREFs of PopFxVerifyDependencies @ 0x140760B84
 * Callers:
...
LABEL_26:
      ...
      while ( 1 )
      {
        ...
        if ( v12 == 2 )
          break;
        _mm_lfence();
        v13 = *(unsigned int **)(*(_QWORD *)(*(_QWORD *)(a2 + 712) + 8 * v11) + 176LL);
        _mm_lfence();
        if ( v12 == 1 )
        {
          a1[3 * v11] = 2;
          --v8;
          v14 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 712) + 8LL * (unsigned int)v11) + 172LL);
          if ( v14 )
          {
            v15 = a1[3 * v11 + 1];
            v16 = v14;
        ...
        else
        {
          a1[3 * v11] = 1;
          v19 = 0;
          v20 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a2 + 712) + 8LL * (unsigned int)v11) + 172LL);
          if ( v20 )
          {
            do
            {
