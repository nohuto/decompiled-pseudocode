/*
 * XREFs of TtmiLogDeviceEnumeratedTerminalEvent @ 0x140775818
 * Callers:
...
char __fastcall TtmiLogDeviceEnumeratedTerminalEvent(int a1, int a2, int a3, int a4, LPCWSTR pwsz)
{
  ...
  {
    LOBYTE(v5) = TlgKeywordOn(&stru_140861840, 1uLL);
    if ( (_BYTE)v5 )
    {
      ...
      LOBYTE(v5) = TlgWrite(&stru_140861840, &unk_14030CFBC, 0LL, 0LL, 8u, &pData);
    }
  }
  return (char)v5;
}
