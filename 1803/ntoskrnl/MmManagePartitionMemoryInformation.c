/*
 * XREFs of MmManagePartitionMemoryInformation @ 0x1405124C4
 * Callers:
 *     NtManagePartition @ 0x1405121CC (NtManagePartition.c)
 * Callees:
 *     MiQueryMemoryListInformation @ 0x1400702AC (MiQueryMemoryListInformation.c)
...
__int64 __fastcall MmManagePartitionMemoryInformation(ULONG_PTR **a1, __int64 a2)
{
  ...
  do
  {
    ...
    *(_QWORD *)(a2 + 48) = 0LL;
    if ( v16 < v15 )
    {
      v21 = (__int64 *)(v2[2] + 1984LL * v16 + 1808);
      do
      {
