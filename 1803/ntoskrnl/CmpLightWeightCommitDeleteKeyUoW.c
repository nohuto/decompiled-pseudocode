/*
 * XREFs of CmpLightWeightCommitDeleteKeyUoW @ 0x1407040FC
 * Callers:
...
void __fastcall CmpLightWeightCommitDeleteKeyUoW(__int64 a1, _QWORD *a2)
{
  ...
  v5 = *(_QWORD *)(a1 + 48);
  v6 = *(_QWORD *)(v5 + 24);
  if ( (int)CmpFreeKeyByCell(v6, *(unsigned int *)(v5 + 32), 0) < 0
    && stru_140397090.LevelPlus1 > 5
    && TlgKeywordOn(&stru_140397090, 0x200000000000uLL) )
  {
    v20 = 0;
    v18 = &v14;
    v14 = v7;
    v19 = 4;
    TlgWrite(&stru_140397090, &unk_140308AB1, 0LL, 0LL, 3u, &pData);
  }
