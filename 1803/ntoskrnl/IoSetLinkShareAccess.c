/*
 * XREFs of IoSetLinkShareAccess @ 0x140494EE0
 * Callers:
 *     IoSetShareAccess @ 0x140494560 (IoSetShareAccess.c)
 *     RawCreate @ 0x140494B70 (RawCreate.c)
 *     IoSetShareAccessEx @ 0x1405F2B10 (IoSetShareAccessEx.c)
 * Callees:
 *     <none>
 */
    ...
    *(_BYTE *)(a3 + 79) = (a2 & 4) != 0;
    ...
    if ( a5 )
    {
      if ( v10 )
      {
        ...
        *(_QWORD *)(a4 + 20) = *(unsigned __int8 *)(a3 + 78);
