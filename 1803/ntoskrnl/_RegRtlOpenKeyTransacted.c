/*
 * XREFs of _RegRtlOpenKeyTransacted @ 0x140506280
 * Callers:
...
LABEL_7:
  ...
  if ( byte_1403EFAF8 )
  {
    v14 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, HANDLE))qword_1403EFB00;
  }
  else
  {
    v14 = ZwOpenKeyTransacted;
    byte_1403EFAF8 = 1;
    qword_1403EFB00 = (__int64)ZwOpenKeyTransacted;
  }
  if ( v14 )
  {
