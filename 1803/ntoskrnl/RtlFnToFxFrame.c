/*
 * XREFs of RtlFnToFxFrame @ 0x1400BB7DC
 * Callers:
 *     RtlpWow64CtxToAmd64 @ 0x1405645B8 (RtlpWow64CtxToAmd64.c)
 * Callees:
 *     <none>
 */

bool __fastcall RtlFnToFxFrame(__int64 a1, __int64 a2)
{
  _QWORD *v2; // r11
  char v3; // r9
