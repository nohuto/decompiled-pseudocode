/*
 * XREFs of PipDmgSaveDeviceDmarPolicy @ 0x1405E4D74
 * Callers:
...
__int64 __fastcall PipDmgSaveDeviceDmarPolicy(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( v7 )
  {
    if ( stru_140397160.LevelPlus1 > 5 && TlgKeywordOn(&stru_140397160, 0x400000000000uLL) )
    {
      v15 = 0;
      v17[1] = 0;
      v20 = 0;
      ...
      v14 = 2;
      v19 = 4;
      TlgWrite(&stru_140397160, &unk_14030983D, 0LL, 0LL, 5u, &pData);
      v7 = *(_QWORD *)(a1 + 720);
    }
