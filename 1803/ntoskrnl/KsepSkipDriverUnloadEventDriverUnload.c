/*
 * XREFs of KsepSkipDriverUnloadEventDriverUnload @ 0x14024EBDC
 * Callers:
 *     KseSkipDriverUnloadCallbackHookDriverUnload @ 0x14024EA80 (KseSkipDriverUnloadCallbackHookDriverUnload.c)
 *     KseSkipDriverUnloadHookDriverUntargeted @ 0x14024EAC0 (KseSkipDriverUnloadHookDriverUntargeted.c)
 * Callees:
