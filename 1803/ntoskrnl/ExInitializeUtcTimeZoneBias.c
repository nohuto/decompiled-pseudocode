/*
 * XREFs of ExInitializeUtcTimeZoneBias @ 0x1408CA254
 * Callers:
...
__int64 __fastcall ExInitializeUtcTimeZoneBias(PLARGE_INTEGER CurrentTime)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
      v7.QuadPart = v15.QuadPart + 600000000LL * v4;
      v15 = v7;
      v8.QuadPart = SystemTime.QuadPart + 600000000LL * v3;
      SystemTime = v8;
      ...
      v22 = v12;
      v21 = v4;
      if ( QuadPart < v11.QuadPart || QuadPart >= v8.QuadPart )
      {
