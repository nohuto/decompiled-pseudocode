/*
 * XREFs of PiQueryPowerRelations @ 0x140603784
 * Callers:
  ...
  if ( !a2 )
  {
    ...
    if ( DeviceRelations >= 0 )
    {
      ...
      while ( v10 != v9 )
      {
        ...
        v21 = v10;
        v10 = (_QWORD *)v20;
        if ( *(_QWORD **)(v20 + 8) != v21 || (v22 = (_QWORD *)v21[1], (_QWORD *)*v22 != v21) )
          __fastfail(3u);
        *v22 = v20;
        *(_QWORD *)(v20 + 8) = v22;
        v23 = v21[3];
        if ( *(_QWORD **)(v23 + 8) != v21 + 3 || (v24 = (_QWORD *)v21[4], (_QWORD *)*v24 != v21 + 3) )
          __fastfail(3u);
        *v24 = v23;
        *(_QWORD *)(v23 + 8) = v24;
          ...
          if ( v25 )
          {
            ...
            if ( v30 )
            {
              ...
              if ( v29 )
                ...
                LODWORD(v32) = 0;
              IoAddTriageDumpDataBlock(v32, 728);
              if ( *(_WORD *)(v31 + 40) )
              {
