/*
 * XREFs of PopDiagTraceFxDefaultPepWorkerEnd @ 0x140079E34
 * Callers:
  ...
  if ( a4 == 2 )
  {
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v34 = &v24;
        v35 = 4LL;
        LOBYTE(v5) = TlgWriteEx(&pCallbackContext, &unk_14030B627, v13, v14, ActivityId, RelatedActivityId, v14, &pData);
      }
    }
  }
