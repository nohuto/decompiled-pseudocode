/*
 * XREFs of LookUpTableFlushComplete @ 0x14052D76C
 * Callers:
 ...
 *     UpdateInternalStatsOnFlush @ 0x14052DA78 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( stru_1403978A0.LevelPlus1 > 5 && TlgKeywordOn(&stru_1403978A0, 0x400000000000uLL) )
      {
        ...
        v32 = 4LL;
        v34 = 4LL;
        TlgWrite(&stru_1403978A0, &unk_14030F23A, 0LL, 0LL, 0xBu, &pData);
      }
