/*
 * XREFs of DrvDbGetDriverDatabaseMappedPropertyKeys @ 0x1407F1978
 * Callers:
 ...
 *     DrvDbGetCompositeMappedPropertyKeys @ 0x1407F1810 (DrvDbGetCompositeMappedPropertyKeys.c)
 */
        ...
        __int64 a6)
{
  ...
  *(_DWORD *)a6 = 0;
  v13 = 0;
  result = DrvDbGetCompositeMappedPropertyKeys(a1, (_OWORD **)&off_140397878, 5u, a4, a5, v40);
  if ( (int)result < 0 )
    return result;
  v16 = *v6;
  if ( (_DWORD)v16 )
  ...
  result = DrvDbFindDatabaseNode((__int64)v12, v9, &v42);
  if ( (int)result < 0 )
    return result;
  ...
  LOBYTE(v41) = 0;
  LODWORD(v39) = 1;
  v17 = DrvDbOpenObjectRegKey(v12, (__int64)v12[4], 1u, v9, v39, v41, &KeyHandle, 0LL);
  if ( v17 < 0 )
    goto LABEL_48;
  v18 = KeyHandle;
  v19 = &off_1402F41B0;
