        ...
        unsigned int *a5)
{
  ...
  size_t v34; // [rsp+70h] [rbp-268h] BYREF
  ...
  v32 = v12;
  Sizea = 0;
  EtwpQueryTokenPackageInfo((__int64)v12, (__int64)&v34, &Sizea);
  ...
  if ( v13 >= 0 )
  {
    ...
    v14 = v34 + v35 + *(unsigned __int16 *)v29 + (unsigned __int16)v27 + Sizea + 100;
    v15 = v14;
    v31 = v14;
    if ( v30 )
      *v30 = v14;
