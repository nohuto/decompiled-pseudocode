/*
 * XREFs of SPCallServerHandleWaitForDisplayWindow @ 0x140612428
 * Callers:
...
LABEL_19:
  ...
  if ( (v11 & 0x80000000) == 0 )
  {
    ...
    v17 = ((__int64 (__fastcall *)(UNICODE_STRING *, int *, _QWORD **, __int64, char *))qword_140861460)(
            &DestinationString,
            &v61,
            &v60,
            4LL,
    ...
    do
    {
      v18 = KeWaitForSingleObject(&stru_14039E160, UserRequest, 1, 1u, 0LL);
      v19 = v18;
    }
    while ( v18 == 257 );
    if ( v18 >= 0 && v18 != 192 )
    {
      do
      {
        v51 = KeWaitForSingleObject(&Mutex, UserRequest, 1, 1u, 0LL);
        v19 = v51;
      }
      while ( v51 == 257 );
