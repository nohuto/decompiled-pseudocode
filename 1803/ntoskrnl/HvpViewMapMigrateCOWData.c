/*
 * XREFs of HvpViewMapMigrateCOWData @ 0x140706D20
 * Callers:
...
__int64 __fastcall HvpViewMapMigrateCOWData(SIZE_T a1, _QWORD *a2, _QWORD *a3)
{
  ...
  while ( v6 < v7 )
  {
    v8 = a3[3];
    v9 = v6 + 4096;
    if ( (*((_BYTE *)a3 + ((unsigned __int64)(v6 - v8) >> 12) + 64) & 2) != 0 )
    {
      for ( i = v9 - v8; v9 < v7 && (*((_BYTE *)a3 + (i >> 12) + 64) & 2) != 0; i += 4096LL )
        v9 += 4096LL;
      result = HvpViewMapMakeViewRangeCOWByCaller(a1, (__int64)a2, v6, v9);
      if ( (int)result < 0 )
        return result;
