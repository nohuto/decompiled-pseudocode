/*
 * XREFs of PipChangeDeviceObjectFromRegistryProperties @ 0x1405CD170
 * Callers:
 ...
 *     RtlGetGroupSecurityDescriptor @ 0x140604920 (RtlGetGroupSecurityDescriptor.c)
 */
...
__int64 __fastcall PipChangeDeviceObjectFromRegistryProperties(__int64 a1, __int64 a2, ACL *a3, __int64 a4, char a5)
{
  ...
  if ( v38 )
  {
    ...
    v33 = v41;
    v35 = IopCreateDefaultDeviceSecurityDescriptor(v41, v23, v34, v48, (ACL **)&P, (__int64)&v44, &Owner);
    v12 = v44;
    v25 = v35;
    if ( !v35 )
    {
