/*
 * XREFs of HvpApplyLogEntryDataToFileBackedHive @ 0x1406F82E8
 * Callers:
  ...
  *(_DWORD *)(*(_QWORD *)(BugCheckParameter2 + 64) + 40LL) = *(_DWORD *)(a2 + 16);
  if ( *(_DWORD *)(a2 + 20) )
  {
    while ( 1 )
    {
      ...
      v13 = *(_DWORD *)(a3 + 8 * v7);
      if ( !(unsigned __int8)HvpSetRangeProtection(BugCheckParameter2, v13, *(_DWORD *)(a3 + 8 * v7 + 4), 4u) )
        return 3221225626LL;
      HvpCopyModifiedData(BugCheckParameter2, v13, a4, (unsigned int)v12);
      a4 += v12;
      v6 += v12;
