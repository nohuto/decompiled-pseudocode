/*
 * XREFs of SdbpCreateSearchPathPartsFromPath @ 0x14061F6FC
 * Callers:
...
LABEL_8:
  ...
  {
    AslLogCallPrintf(1, (unsigned int)"SdbpCreateSearchPathPartsFromPath", 1355, (unsigned int)"Invalid argument");
  }
  return 0LL;
}
