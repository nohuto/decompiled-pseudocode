/*
 * XREFs of PiControlGetPropertyData @ 0x140525790
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiControlGetPropertyData(__int64 a1, __int16 *a2, __int64 a3, char a4)
{
  ...
  if ( (unsigned __int16)(v4 - 1) > 0x18Fu || (v4 & 1) != 0 )
    return 3221225485LL;
  result = PiControlMakeUserModeCallersCopy(&v37, *((void **)a2 + 1), v4, 2u, a4, 1);
  if ( (int)result >= 0 )
  {
    PpDevNodeLockTree(0);
    v9 = (struct _DEVICE_OBJECT *)PnpDeviceObjectFromDeviceInstanceWithTag((__int64)v36, 0x43706E50u);
    PiControlFreeUserModeCallersBuffer(a4, v37);
...
LABEL_21:
              v24 = v39;
              UserModeCallersCopy = PiControlMakeUserModeCallersCopy(v12, PropertyBuffer, v5, 1u, v39, 0);
