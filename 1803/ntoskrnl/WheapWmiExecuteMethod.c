/*
 * XREFs of WheapWmiExecuteMethod @ 0x1402BFF60
 * Callers:
 *     WheaWmiDispatch @ 0x140185610 (WheaWmiDispatch.c)
 * Callees:
 *     WheapWmiExecuteErrorInjectionMethod @ 0x1402BFA7C (WheapWmiExecuteErrorInjectionMethod.c)
 *     WheapWmiExecuteErrorSourceMethod @ 0x1402BFB5C (WheapWmiExecuteErrorSourceMethod.c)
 *     WheapWmiExecutePolicyManagementMethod @ 0x1402C0088 (WheapWmiExecutePolicyManagementMethod.c)
 */
