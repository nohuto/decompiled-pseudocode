/*
 * XREFs of PsUpdateComponentPower @ 0x14008ABF0
 * Callers:
 *     PspSetProcessEnergyTrackingStateCallback @ 0x14052F720 (PspSetProcessEnergyTrackingStateCallback.c)
 *     PspApplyJobChainLimitsToProcess @ 0x1405319B4 (PspApplyJobChainLimitsToProcess.c)
 * Callees:
 *     RtlInterlockedTimelineBitmapUpdate @ 0x14008AC80 (RtlInterlockedTimelineBitmapUpdate.c)
...
void __fastcall PsUpdateComponentPower(PEPROCESS a1, int a2, unsigned __int64 a3)
{
  ...
  v3 = a1[2].ActiveProcessors.Bitmap[15];
  if ( v3 )
  {
    if ( a2 == 1 )
    {
