/*
 * XREFs of EtwpWriteAppStateChangeWithStats @ 0x14049A97C
 * Callers:
...
void EtwpWriteAppStateChangeWithStats()
{
  ...
  {
    if ( TlgKeywordOn(&stru_1403977E0, 0x200000000003uLL) )
    {
      v10 = *(_DWORD *)(v0 + 736);
      ...
      v41 = 4;
      v44 = 8;
      TlgWrite(&stru_1403977E0, &unk_14030EBA7, 0LL, 0LL, 0xCu, &pData);
    }
  }
}
