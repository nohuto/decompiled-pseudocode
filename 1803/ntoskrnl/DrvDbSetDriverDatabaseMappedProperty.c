/*
 * XREFs of DrvDbSetDriverDatabaseMappedProperty @ 0x1407F2F8C
 * Callers:
    ...
    if ( a5 == *((_DWORD *)v22 + 2) || !a5 )
    {
      ...
      if ( !a3 || v10 && ((__int64)v10[3].Buffer & 0x10) != 0 )
      {
        v40 = v10 && ((__int64)v10[3].Buffer & 0x10) != 0
            ...
            : DrvDbOpenDriverDatabaseRegKey((unsigned __int16 **)a1, a2, 2u, 0, (__int64)&Handle, 0LL);
        DatabaseNode = v40;
        if ( v40 < 0 )
          goto LABEL_122;
      }
