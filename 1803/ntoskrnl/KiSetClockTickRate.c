/*
 * XREFs of KiSetClockTickRate @ 0x140005C44
 * Callers:
...
__int64 __fastcall KiSetClockTickRate(unsigned int a1, char a2)
{
  ...
  if ( a2 )
  {
    ((void (__fastcall *)(__int64, _QWORD, unsigned int *))off_140398970[0])(1LL, a1, &v11);
    v6 = 1;
  }
  else
  {
    ((void (__fastcall *)(_QWORD, _QWORD, unsigned int *))off_140398970[0])(0LL, a1, &v11);
    v6 = 0;
  }
  LOBYTE(v5) = 1;
  ...
  if ( v11 < dword_1403B3DF4 )
    dword_1403B3DF4 = v11;
  if ( v11 > dword_1403B3DF0 )
    dword_1403B3DF0 = v11;
  if ( a1 < dword_1403B3DFC )
    dword_1403B3DFC = a1;
  if ( a1 > dword_1403B3DF8 )
    dword_1403B3DF8 = a1;
