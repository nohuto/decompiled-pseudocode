/*
 * XREFs of KiUpdateProcessorCount @ 0x14047BC08
 * Callers:
 *     KiUpdateNumberProcessorsIpi @ 0x1404849D0 (KiUpdateNumberProcessorsIpi.c)
 *     KeStartAllProcessors @ 0x1408AB748 (KeStartAllProcessors.c)
 * Callees:
 *     KeAddProcessorAffinityEx @ 0x140034480 (KeAddProcessorAffinityEx.c)
 *     KiGetCurrentGroupCount @ 0x1400D2E9C (KiGetCurrentGroupCount.c)
 */
