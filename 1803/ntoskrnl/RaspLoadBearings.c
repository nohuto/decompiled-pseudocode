/*
 * XREFs of RaspLoadBearings @ 0x140174EEC
 * Callers:
...
__int64 __fastcall RaspLoadBearings(__int64 a1, unsigned int a2, __int64 a3, int *a4)
{
  ...
  __int16 v25; // [rsp+62h] [rbp+Ah]
  __int16 v26; // [rsp+68h] [rbp+10h] BYREF
  ...
  if ( a2 >= v4 )
  {
    ...
    result = FioFwReadUshortAtOffset(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 16LL), v23 + 2 * (a2 - v4), &v26);
    if ( (int)result < 0 )
      return result;
    v15 = v26;
  }
