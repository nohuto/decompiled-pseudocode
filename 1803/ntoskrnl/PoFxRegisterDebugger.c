/*
 * XREFs of PoFxRegisterDebugger @ 0x1408CA0E4
 * Callers:
...
void PoFxRegisterDebugger()
{
  ...
  if ( ((unsigned int (__fastcall *)(__int64, _QWORD, _QWORD, SIZE_T *))off_140397D98[0])(
         33LL,
         0LL,
         0LL,
         &NumberOfBytes) == -2147483643 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      if ( ((int (__fastcall *)(__int64, _QWORD, unsigned int *, SIZE_T *))off_140397D98[0])(
             33LL,
             v0,
             v2,
             &NumberOfBytes) >= 0
...
LABEL_12:
              ...
              *(_DWORD *)(BugCheckParameter2 + 704) |= 2u;
              v8 = *(_QWORD *)(v7 + 64);
              if ( v8 )
              {
                v14 = *(_QWORD *)(v7 + 72);
