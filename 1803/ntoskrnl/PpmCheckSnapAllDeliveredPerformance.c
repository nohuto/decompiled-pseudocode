/*
 * XREFs of PpmCheckSnapAllDeliveredPerformance @ 0x140109AF0
 * Callers:
...
char PpmCheckSnapAllDeliveredPerformance()
{
  ...
  KeCopyAffinityEx((__int64)&v40, PpmCheckRegistered);
  v0 = v41[0];
  v1 = 0;
  v2 = 0;
  v31 = 0;
...
LABEL_3:
    ...
    if ( v9 )
    {
      ...
      {
        v11 = p_CurrentSnap->Time - Time;
        v12 = PerfCheck->CurrentSnap.Active - PerfCheck->LastDeliveredSnap.Active;
        v38 = v11;
        if ( v12 <= v11 )
        {
          if ( v7 )
...
LABEL_10:
          if ( v12 )
          {
            v13 = (PerfCheck->CurrentSnap.PerformanceScaledActive - PerfCheck->LastDeliveredSnap.PerformanceScaledActive)
                / v12;
            if ( __PAIR64__(
                   (PerfCheck->CurrentSnap.FrequencyScaledActive - PerfCheck->LastDeliveredSnap.FrequencyScaledActive)
                 / v12,
                   v13) != *(_QWORD *)&PerfCheck->LastDeliveredPerformance )
            {
              ...
              if ( PpmEtwRegistered
                && PpmEtwHandle
                && (EtwpLevelKeywordEnabled(*(_QWORD *)(PpmEtwHandle + 32) + 80LL, 4u, 128LL)
                 || *(_BYTE *)(v15 + 101) && EtwpLevelKeywordEnabled(*(_QWORD *)(v15 + 40) + 80LL, 4u, v14)) )
              {
                Group = v5->Group;
                v39 = PpmConvertTime(v11, PopQpcFrequency, 0xF4240uLL);
