/*
 * XREFs of PiDevCfgInitDriverDatabaseCallback @ 0x14072CBC0
 * Callers:
 *     PiDrvDbEnumNodes @ 0x14073C854 (PiDrvDbEnumNodes.c)
 * Callees:
...
LABEL_13:
          if ( MatchingFilteredDeviceList >= 0 )
          {
            if ( (_DWORD)v3 )
            {
              ...
              {
                if ( (int)CmOpenDeviceRegKey((__int64)P, (__int64)i, 0x10u, 0, 0x2000000, 0, (__int64)&v19, 0LL) >= 0 )
                {
