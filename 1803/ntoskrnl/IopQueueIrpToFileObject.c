/*
 * XREFs of IopQueueIrpToFileObject @ 0x1400A99E0
 * Callers:
...
char __fastcall IopQueueIrpToFileObject(__int64 a1, __int64 a2)
{
  ...
  else
  {
    ...
    if ( _interlockedbittestandset64(v3, 0LL) )
    {
      ...
      KxWaitForSpinLockAndAcquire(v3, v21);
    }
  }
  ...
  else
  {
    ...
    *v8 = v10;
    ...
    v15 = _InterlockedIncrement64(p_ReadTransferCount);
    if ( v15 <= 1 )
      KeBugCheckEx(0x18u, 0LL, (ULONG_PTR)(p_ReadTransferCount + 6), 0x10uLL, v15);
    ...
    *(_QWORD *)(a1 + 88) = Process;
    ...
    if ( v19 )
    {
      if ( v18->NestingLevel <= 1u )
      {
        v23 = v19[5] - 1;
        v19[5] = v23;
        if ( !v23 && !*((_BYTE *)v19 + 25) && !*((_BYTE *)v19 + 27) )
