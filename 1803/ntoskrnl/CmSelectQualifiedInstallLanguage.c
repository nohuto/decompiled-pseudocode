/*
 * XREFs of CmSelectQualifiedInstallLanguage @ 0x1408B87E4
 * Callers:
...
__int64 __fastcall CmSelectQualifiedInstallLanguage(__int64 a1, unsigned int a2, _DWORD *a3, int a4)
{
  ...
  if ( a3 )
  {
    *a3 = 0;
    ...
    if ( v11 != -1 )
    {
      v12 = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_1408F5F78)(&CmControlHive, v11, v39);
      if ( v12 )
      {
        ...
        if ( ValueByName != -1 )
        {
          v26 = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_1408F5F78)(
                  &CmControlHive,
                  ValueByName,
                  v36);
          if ( v26 )
          {
            if ( *(_DWORD *)(v26 + 12) == 7 )
            {
              ...
              if ( v27 )
              {
                ...
                ((void (__fastcall *)(ULONG_PTR *, __int64 *))qword_1408F5F80)(&CmControlHive, &v38);
              }
            }
            ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_1408F5F80)(&CmControlHive, v36);
          }
        }
        ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_1408F5F80)(&CmControlHive, v39);
      }
    }
    v14 = CmpWalkPath((__int64)&CmControlHive, a2, L"MUI\\UILanguages");
    if ( v14 == -1 )
      return v10;
    v15 = (_DWORD *)((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_1408F5F78)(&CmControlHive, v14, v41);
    v31 = v15;
    if ( !v15 )
      return v10;
    v10 &= ~2u;
LABEL_12:
    ...
    while ( 1 )
    {
      ...
      if ( v37 == -1 )
        break;
      v18 = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_1408F5F78)(&CmControlHive, v37, v35);
      v15 = v31;
      if ( v18 )
      {
        ...
        if ( v19 == -1 )
          goto LABEL_58;
        v20 = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_1408F5F78)(&CmControlHive, v19, v36);
        if ( !v20 )
          goto LABEL_58;
        if ( *(_DWORD *)(v20 + 12) == 4 )
        {
          ...
          if ( (v21 & 3) != 0 )
            v16 = (v21 & 0x10) != 0;
          ((void (__fastcall *)(ULONG_PTR *, __int64 *))qword_1408F5F80)(&CmControlHive, &v40);
        }
        ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_1408F5F80)(&CmControlHive, v36);
        if ( !v16 )
          goto LABEL_58;
...
LABEL_58:
          ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_1408F5F80)(&CmControlHive, v35);
          v15 = v31;
          v4 = v30;
          v8 = v28;
        }
...
LABEL_42:
    ...
    ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_1408F5F80)(&CmControlHive, v41);
    if ( v8 || v9 )
      v10 &= ~4u;
    if ( v29 )
    {
