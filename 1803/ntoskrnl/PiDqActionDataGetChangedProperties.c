/*
 * XREFs of PiDqActionDataGetChangedProperties @ 0x1405E8B2C
 * Callers:
        ...
        unsigned int *a10)
{
  ...
  struct _SECURITY_SUBJECT_CONTEXT *v49; // [rsp+90h] [rbp-39h]
  ...
  *(_QWORD *)v45 = a3;
  ...
  if ( *(_DWORD *)(a8 + 76) )
  {
    while ( 1 )
    {
      ...
      if ( !Handle )
      {
        v11 = PiDqOpenObjectRegKey(1, *(__int64 *)v45, a2, 1u, 0, v49, &Handle);
        if ( v11 == -1073741772 )
        {
          Handle = (HANDLE)-1LL;
          v11 = 0;
