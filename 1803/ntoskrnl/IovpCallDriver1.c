/*
 * XREFs of IovpCallDriver1 @ 0x14081C2B8
 * Callers:
 ...
 *     VfPendingStartLogging @ 0x140820D98 (VfPendingStartLogging.c)
 ...
 *     IovpSessionDataReference @ 0x14082C50C (IovpSessionDataReference.c)
