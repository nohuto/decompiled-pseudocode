/*
 * XREFs of MiMakePartitionMemoryBlock @ 0x140757804
 * Callers:
...
void __fastcall MiMakePartitionMemoryBlock(__int64 a1)
{
  ...
  _QWORD *v17; // rcx
  __int16 *v18; // rbx
  __int16 *v19[7]; // [rsp+28h] [rbp-19h] BYREF
  __int16 *v20[7]; // [rsp+60h] [rbp+1Fh] BYREF
  ...
  {
    v9 = (int)v19[4];
    if ( v19[4] <= (__int16 *)0x7FFFFFFFFFFFFFFLL )
    {
      *(_OWORD *)&v19[1] = 0LL;
      ...
      if ( PoolWithTag )
      {
        ...
        *((_QWORD *)PoolWithTag + 1) = v8;
        ...
        v19[1] = (__int16 *)MiConvertInitialMemoryBlock(a1, (__int64)v11);
        v18 = v19[1];
        ExFreePoolWithTag(v11, 0);
        if ( v18 )
          v19[2] = (__int16 *)MiCreateNodeLists(a1, (__int64)v18);
      }
