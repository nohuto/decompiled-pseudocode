/*
 * XREFs of EtwpWriteProcessStarted @ 0x140510620
 * Callers:
...
char __fastcall EtwpWriteProcessStarted(__int64 a1, int *a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  {
    LOBYTE(v4) = TlgKeywordOn(&stru_1403977E0, 3uLL);
    if ( (_BYTE)v4 )
    {
      v19 = *(_QWORD *)(a1 + 776);
      v14 = *(_DWORD *)(a1 + 736);
      ...
      v55 = 2LL;
      v57[1] = 0;
      LOBYTE(v4) = TlgWrite(&stru_1403977E0, &unk_14030E44F, 0LL, 0LL, 0x13u, &pData);
    }
  }
  return v4;
}
