/*
 * XREFs of MxSwitchDescriptors @ 0x1408E100C
 * Callers:
 *     MxGetNextPage @ 0x14089ADD4 (MxGetNextPage.c)
 * Callees:
 *     MiPageToNode @ 0x140122B50 (MiPageToNode.c)
 *     MiInitializeBootMemoryDescriptor @ 0x14089B024 (MiInitializeBootMemoryDescriptor.c)
 */
...
unsigned __int64 *__fastcall MxSwitchDescriptors(unsigned int a1)
{
  ...
  v4 = (unsigned __int64 *)&qword_1408F5570[5 * a1];
  v5 = v4[4];
  while ( 2 )
  {
    if ( !v5 )
