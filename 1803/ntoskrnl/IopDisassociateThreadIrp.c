/*
 * XREFs of IopDisassociateThreadIrp @ 0x14023240C
 * Callers:
 ...
 *     IoAllocateErrorLogEntry @ 0x140163BA0 (IoAllocateErrorLogEntry.c)
...
LABEL_2:
  ...
  *(_QWORD *)(v4 + 8) = v4;
  *(_QWORD *)v4 = v4;
  v8 = (_QWORD *)qword_1403C8408;
  if ( *(__int64 **)qword_1403C8408 != &IopDeadIrps )
    __fastfail(3u);
  *v6 = &IopDeadIrps;
  v6[1] = v8;
  *v8 = v6;
  qword_1403C8408 = (__int64)v6;
