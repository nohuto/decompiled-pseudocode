/*
 * XREFs of MiInitializeChannelRanges @ 0x1408CA1D8
 * Callers:
...
unsigned __int64 MiInitializeChannelRanges()
{
  ...
  if ( dword_14044B17C )
  {
    if ( byte_1403CC515 != 1 )
    {
      ...
      {
        v38 = 256;
        result = ((__int64 (__fastcall *)(__int64, __int64, __int64 *, char *))off_140397D98[0])(
                   31LL,
                   8LL,
                   &qword_1403CB6B8,
                   v37);
...
LABEL_16:
          ...
          else
          {
            if ( v6 > 4 )
            {
              for ( i = qword_1403CB6B8; *(_QWORD *)i != -1LL; i += 16LL )
              {
                if ( *(_WORD *)(i + 12) >= 4u )
                {
                  v8 = *(_WORD *)(i + 10);
