/*
 * XREFs of ?SmStCheckResident@?$SMKM_STORE@USM_TRAITS@@@@SA?AW4_SMST_RESIDENT_CHECK_RESULT@1@PEAXK@Z @ 0x14009990C
 * Callers:
...
__int64 __fastcall SMKM_STORE<SM_TRAITS>::SmStCheckResident(__int64 a1, unsigned int a2)
{
  ...
  v5 = 0;
  v6 = v4 >> 12;
  if ( (int)MmQueryVirtualMemory(0xFFFFFFFFFFFFFFFFuLL, 16LL * (unsigned int)v6, 0LL, 0) < 0 )
  {
    return 2;
  }
  else
