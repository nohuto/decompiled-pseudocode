/*
 * XREFs of _CmGetInstallerClassMappedPropertyFromRegValue @ 0x14056B1FC
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  *a8 = 0;
  ...
  if ( a3 || (v14 = CmOpenInstallerClassRegKey(v43, a2, (_DWORD)v16, 0, 1, 0, (__int64)&Handle, 0LL), v14 >= 0) )
  {
    v20 = *(_DWORD *)(a4 + 16);
    if ( v20 == 7 )
    {
...
LABEL_30:
      ...
      else
      {
        ...
        if ( a3 )
          v38 = (int)a3;
        LODWORD(v42) = 4;
        v40 = PnpOpenPropertiesKey(v43, v38, 0LL, 1, 0, v41, &KeyHandle);
        v14 = v40;
        if ( v40 != -1073741772 )
        {
          if ( v40 < 0 )
