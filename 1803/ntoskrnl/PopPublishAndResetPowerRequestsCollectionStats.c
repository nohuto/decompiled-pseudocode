/*
 * XREFs of PopPublishAndResetPowerRequestsCollectionStats @ 0x14076F75C
 * Callers:
 ...
 *     PoQueryStopWatchCollection @ 0x1402820D0 (PoQueryStopWatchCollection.c)
 *     PoResetStopWatchCollection @ 0x140282128 (PoResetStopWatchCollection.c)
