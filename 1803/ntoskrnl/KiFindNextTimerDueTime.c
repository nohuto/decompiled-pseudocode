/*
 * XREFs of KiFindNextTimerDueTime @ 0x14010F360
 * Callers:
...
LABEL_24:
    ...
    while ( 1 )
    {
      ...
      {
        v27 = (_QWORD *)(qword_14044D448[0] + 8 * (v25 >> 6));
        v28 = ((1LL << (v25 & 0x3F)) - 1) | ~*v27;
        if ( v28 == -1 )
        {
          while ( (unsigned __int64)++v27 <= qword_14044D448[0] + 8 * (v26 >> 6) )
          {
            v28 = ~*v27;
            if ( *v27 )
              goto LABEL_29;
...
LABEL_29:
        ...
        v29 = v28 + (((__int64)v27 - qword_14044D448[0]) >> 3 << 6);
        if ( v29 > v26 )
          goto LABEL_70;
        if ( v29 != -1LL )
          goto LABEL_31;
...
LABEL_31:
        ...
        if ( v31 < v3 )
        {
          if ( v31 < v46 )
          {
            ...
            v3 = (v31 & 0xFFFFFFFFFFFC0000uLL) + ((((_DWORD)v29 - v32) << 18) & 0x3FC0000);
            if ( v3 >= v24 )
              v3 = v24;
            goto LABEL_24;
          }
          v3 = *(_QWORD *)(v30 + KiProcessorBlock[0] + 14488);
        }
        v22 = (unsigned __int8)(v29 + 1);
        goto LABEL_24;
      }
