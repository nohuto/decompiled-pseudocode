/*
 * XREFs of KxInitializeProcessorState @ 0x14062B3F0
 * Callers:
        ...
        __int64 a13)
{
  ...
  *(_QWORD *)(a3 + 576) = v26;
  ...
  v32 = *(unsigned __int8 *)(a3 + 592) | (unsigned __int16)(*(unsigned __int8 *)(a3 + 593) << 14) | 0x3C00;
  ...
  *a1 = v33;
  v34 = __readcr3();
  a1[2] = v34 & 0xFFFFFFFFFFFFF000uLL;
  *((_WORD *)a1 + 56) = 64;
  *(_BYTE *)(v17 + 69) = -119;
  if ( VslVsmEnabled )
    *(_BYTE *)(v17 + 69) = -117;
