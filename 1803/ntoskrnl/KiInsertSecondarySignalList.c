/*
 * XREFs of KiInsertSecondarySignalList @ 0x140244DC8
 * Callers:
 *     KeDispatchSecondaryInterrupt @ 0x140244A10 (KeDispatchSecondaryInterrupt.c)
 * Callees:
...
__int64 __fastcall KiInsertSecondarySignalList(_QWORD **a1)
{
  ...
  if ( *a1 != a1 )
  {
    ...
    if ( *(__int64 **)(KiSecondarySignalList + 8) != &KiSecondarySignalList
      || *(__int64 **)qword_1403ADCE8 != &KiSecondarySignalList )
    {
      __fastfail(3u);
    }
    if ( (_QWORD **)(*a1)[1] != a1 || (_QWORD **)*a1[1] != a1 )
      __fastfail(3u);
    *(_QWORD *)qword_1403ADCE8 = a1;
    qword_1403ADCE8 = (__int64)a1[1];
