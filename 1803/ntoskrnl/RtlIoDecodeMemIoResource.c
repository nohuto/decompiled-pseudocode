/*
 * XREFs of RtlIoDecodeMemIoResource @ 0x14016F550
 * Callers:
 *     PnpFilterResourceRequirementsList @ 0x140617EE0 (PnpFilterResourceRequirementsList.c)
 *     IopGenericScoreRequirement @ 0x1406186E0 (IopGenericScoreRequirement.c)
 *     IopGenericUnpackRequirement @ 0x14061A200 (IopGenericUnpackRequirement.c)
 * Callees:
 *     <none>
 */
