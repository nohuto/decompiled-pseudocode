/*
 * XREFs of GxpReadFrameBufferPixels @ 0x1408410C4
 * Callers:
...
__int64 __fastcall GxpReadFrameBufferPixels(__int64 a1, unsigned int *a2)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( !(_BYTE)BgInternal )
    {
      ...
      v30[1] = *(_DWORD *)(a1 + 4);
      v30[3] = *(_DWORD *)(a1 + 12);
      v30[2] = xmmword_14039D790;
      v31 = *(_QWORD *)(a1 + 24);
      v13 = ((__int64 (__fastcall *)(_DWORD *, unsigned int *, __int64))qword_14039D7A0)(v30, v2, v12);
LABEL_29:
...
LABEL_27:
    ...
    {
      v16 = (char *)qword_14039D7A0 + v4 * (*v2 + v23 * v2[1]);
      if ( !v15 )
        goto LABEL_29;
      v17 = v4 * *(_DWORD *)(a1 + 4);
      v18 = v4 * v23;
