/*
 * XREFs of _winput_s @ 0x1401917BC
 * Callers:
...
LABEL_192:
    ...
    do
    {
      v85 = ++v4;
      v20 = *v4;
      if ( (v20 & 0xFF00) == 0 && (pctype[(unsigned __int8)*v4] & 4) != 0 )
      {
        ++v13;
        v14 = v20 + 2 * (5 * v14 - 24);
        continue;
...
LABEL_29:
    ...
    {
      ++v69;
      v34 = fgetwc_nolock(File);
    }
    else
    {
      v34 = whiteout(&v69, File);
    }
    v31 = v86;
    v5 = v34;
    v28 = v87;
...
LABEL_179:
          ...
          if ( v33 == 123 )
          {
            v63 = ReadStringDelimited_0(v62, &v85, (wint_t *)&v68, &v69, (void **)v83, v14, File, Src, &v78);
            v4 = v85;
          }
          else
          {
            v63 = ReadString_0(v62, 0LL, (wint_t *)&v68, &v69, (void **)v83, v14, File, Src, &v78);
          }
          LOWORD(v5) = v68;
          if ( v63 )
            goto LABEL_209;
          ...
          else
          {
            if ( !v32 )
            {
              while ( 1 )
              {
                ...
                {
                  if ( (v5 & 0xFF00) != 0 || (v57 = pctype[(unsigned __int8)v5], (v57 & 0x80u) == 0) )
                  {
LABEL_165:
                    v69 = v46 - 1;
                    if ( (_WORD)v5 != 0xFFFF )
