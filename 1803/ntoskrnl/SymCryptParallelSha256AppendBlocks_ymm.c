/*
 * XREFs of SymCryptParallelSha256AppendBlocks_ymm @ 0x1401A3CD4
 * Callers:
...
__int64 __fastcall SymCryptParallelSha256AppendBlocks_ymm(__int64 *a1, __int64 *a2, unsigned __int64 a3, __int64 _R9)
{
  ...
  __int64 v105; // r8
  __int64 result; // rax
  __m256 v357; // [rsp+28h] [rbp+0h] BYREF

  _RBP = (unsigned __int64)&v357 & 0xFFFFFFFFFFFFFFE0uLL;
  _RAX = *a1;
  ...
  else
  {
    ...
    do
    {
      ...
      __asm
      {
        ...
        vpaddd  ymm2, ymm13, ymmword ptr [r9+40h]
