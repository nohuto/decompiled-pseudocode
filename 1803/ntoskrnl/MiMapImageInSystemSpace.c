/*
 * XREFs of MiMapImageInSystemSpace @ 0x1404BD390
 * Callers:
...
__int64 __fastcall MiMapImageInSystemSpace(__int64 *a1, int a2, __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 8) = v7;
  ...
  v22 = v8 << 12;
  v13 = MiMapViewInSystemSpace((__int64)v19, (__int64)&unk_1403CB5C0, &v20, &v22, &v21, 1LL, v12);
...
LABEL_10:
  ...
  if ( (v12 & 2) != 0 )
  {
    ...
    if ( v17 >= 0 )
    {
      AnyMultiplexedVm = (char *)&v16[1].IdealNode[12];
      goto LABEL_10;
    }
