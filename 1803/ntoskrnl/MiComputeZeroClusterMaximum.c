/*
 * XREFs of MiComputeZeroClusterMaximum @ 0x14013C6C8
 * Callers:
...
unsigned __int64 __fastcall MiComputeZeroClusterMaximum(__int64 a1, __int64 a2)
{
  ...
  if ( v5 <= v7 )
    v7 = v5;
  v9 = *(_QWORD **)(qword_1403CBD88 + 8LL * *((unsigned __int16 *)&Process[1].SecureState.Flags + 3));
  if ( !(unsigned int)MiSufficientAvailablePages((__int64)v9, 0x1388uLL) )
    v7 = 1LL;
  if ( ((__int64)Process[2].Header.WaitListHead.Flink & 0x40) != 0
