/*
 * XREFs of RtlUnicodeStringCchCopyN @ 0x14023DCB4
 * Callers:
 *     PiDrvDbResolveSystemFilePath @ 0x14073DB74 (PiDrvDbResolveSystemFilePath.c)
 * Callees:
 *     RtlUnicodeStringValidateWorker_0 @ 0x14023DDBC (RtlUnicodeStringValidateWorker_0.c)
 */
        ...
        size_t cchToCopy)
{
  ...
  v4 = 0LL;
  v5 = 0LL;
  v12 = RtlUnicodeStringValidateWorker_0(DestinationString, (const size_t)SourceString, cchToCopy);
  if ( v12 >= 0 )
  {
    if ( v9 )
    {
    ...
    v12 = RtlUnicodeStringValidateWorker_0(SourceString, v8, v10);
    if ( v12 >= 0 )
    {
      if ( SourceString )
      {
