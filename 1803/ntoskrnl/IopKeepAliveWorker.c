/*
 * XREFs of IopKeepAliveWorker @ 0x140237B30
 * Callers:
 *     <none>
 * Callees:
...
__int64 IopKeepAliveWorker()
{
  ...
  v0 = KeAcquireSpinLockRaiseToDpc(&qword_1403C84F0);
  qword_1403C8520 = (__int64)KeGetCurrentThread();
LABEL_2:
  v1 = v0;
  while ( 1 )
  {
    v2 = qword_1403C84E0;
    if ( qword_1403C84E0 == &qword_1403C84E0 )
      break;
    v3 = *((_DWORD *)qword_1403C84E0 + 8);
    *((_DWORD *)qword_1403C84E0 + 8) = 0;
    if ( v3 )
    {
      ...
      if ( (v11 & 0x7FFFFFFF) == 1 )
      {
        v12 = KeAcquireSpinLockRaiseToDpc(&qword_1403C84F0);
