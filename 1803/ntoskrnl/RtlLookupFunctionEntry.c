/*
 * XREFs of RtlLookupFunctionEntry @ 0x14012EA90
 * Callers:
        ...
        PUNWIND_HISTORY_TABLE HistoryTable)
{
  ...
  {
    HistoryTable->Once = 0;
    v31 = &RtlpUnwindHistoryTable[4 * (unsigned __int8)byte_140464915];
  ...
  if ( !HistoryTable->Search )
    goto LABEL_18;
  if ( ControlPc < qword_140464918
    || ControlPc >= qword_140464920
...
LABEL_18:
    if ( ControlPc < *(&xmmword_140463020 + 1) || ControlPc >= *(&xmmword_140463020 + 1) + (unsigned int)qword_140463030 )
    {
      v16 = RtlpxLookupFunctionTable(ControlPc, &v33);
    }
    else
    {
      v16 = xmmword_140463020;
      v33 = *(_OWORD *)&xmmword_140463020;
      v34 = qword_140463030;
    }
    v17 = 0LL;
    if ( v16 )
