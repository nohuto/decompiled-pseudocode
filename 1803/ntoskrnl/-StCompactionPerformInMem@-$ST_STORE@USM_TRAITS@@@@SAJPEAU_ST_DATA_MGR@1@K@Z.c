/*
 * XREFs of ?StCompactionPerformInMem@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@K@Z @ 0x140147FEC
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StCompactionPerformInMem(__int64 a1, int a2)
{
  ...
  __int64 v17; // r8
  __int64 v18; // r9
  unsigned int v21; // [rsp+34h] [rbp-164h]
  _WORD *v22; // [rsp+38h] [rbp-160h]
  __int64 v23; // [rsp+40h] [rbp-158h] BYREF
  char v24; // [rsp+48h] [rbp-150h] BYREF
  _BYTE v25[256]; // [rsp+60h] [rbp-138h] BYREF
  ...
  v7 = ST_STORE<SM_TRAITS>::StCompactionPickPriority(a1, v25, Emptiest, &v23);
  v8 = (v23 - *(_QWORD *)(a1 + 1032)) >> 1;
  v21 = v7;
...
LABEL_28:
          ...
          else
          {
            ...
            ST_STORE<SM_TRAITS>::StReleaseRegion(a1, v5, v17, v18);
          }
          if ( v11 < 0 )
            goto LABEL_19;
          ++v13;
