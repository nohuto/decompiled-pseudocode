/*
 * XREFs of ?StCompactRegions@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEADK1KK@Z @ 0x140148240
 * Callers:
 ...
 *     ?StDmReuseCurrentRegion@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_CURRENT_REGION@1@@Z @ 0x1400CE23C (-StDmReuseCurrentRegion@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_CURRENT_REGION@1@.c)
...
LABEL_42:
      ...
      *((_QWORD *)&v49 + 1) = v16;
      ...
      {
        LeafSibling = (unsigned int *)*((_QWORD *)v17 + 1);
      }
      else
      {
...
LABEL_13:
      ...
      if ( !LeafSibling )
        goto LABEL_42;
      v20 = *LeafSibling;
      v21 = *(_DWORD *)(a1 + 464) * (*LeafSibling & *(_DWORD *)(a1 + 460));
      ...
      v31 = (~(*(_DWORD *)(*(_QWORD *)(a1 + 1016) + 8LL) - 1) & (unsigned int)(v28
      ...
      if ( v27 != v10 || v50 != v30 )
      {
        ...
        ST_STORE<SM_TRAITS>::StDmPageRecordUnprotect(a1, (__int64)v26);
        v33 = a1 + 96;
        v34 = a1 + 96;
        v35 = *(_DWORD *)(a1 + 112);
...
LABEL_65:
        ...
        if ( v50 != v48 )
        {
          ST_STORE<SM_TRAITS>::StDmpUpdateRegionState(a1, v50, -v51, 1);
          ST_STORE<SM_TRAITS>::StDmpUpdateRegionState(a1, v39, v51, 0);
        }
        v10 = v46;
        v14 = (char **)(a1 + 64);
      }
