/*
 * XREFs of ?SmFeSetEvictFailed@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAT_SM_PAGE_KEY@@KK@Z @ 0x1402A2D74
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmFeSetEvictFailed(__int64 a1, unsigned int *a2, int a3)
{
  ...
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140465B78, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
    ExfTryToWakePushLock((volatile signed __int64 *)&qword_140465B78, v10, v9, v8);
  v24[0] = 0;
  v13 = KeGetCurrentThread();
  if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)&qword_140465B78) == 1 )
  ...
  while ( 1 )
  {
    ...
    if ( (v19->AcquiredByte & 1) != 0
      ...
      && (*(_QWORD *)&v19->LockState.0 & 0x7FFFFFFFFFFFFFFCLL) == ((unsigned __int64)&qword_140465B78 & 0x7FFFFFFFFFFFFFFCLL)
...
LABEL_21:
    if ( (*((_DWORD *)&v13->0 + 1) & 0x10000) == 0 )
      KeBugCheckEx(0x162u, (ULONG_PTR)v13, (ULONG_PTR)&qword_140465B78, (unsigned int)SessionId, 0LL);
    goto LABEL_28;
  }
  ...
  v24[0] = 0;
  v24[0] = v19->BoostBitmap.AllFields & 0x1FFFF;
...
LABEL_28:
  ...
  KiAbThreadRemoveBoosts((ULONG_PTR)v13, (__int64)&qword_140465B78, (__int64)v24);
