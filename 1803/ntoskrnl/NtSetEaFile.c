/*
 * XREFs of NtSetEaFile @ 0x14071DE80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
        ...
        *(_QWORD *)(v20 + 48) = v12;
        ...
        if ( (Flags & 4) != 0 )
        {
          ...
          {
            v29 = 0;
            PoolWithQuota_0 = (struct _FILE_FULL_EA_INFORMATION *)IopVerifierExAllocatePoolWithQuota_0(v19, v4);
            Irp->AssociatedIrp.MasterIrp = (struct _IRP *)PoolWithQuota_0;
            memmove(PoolWithQuota_0, EaBuffer, v4);
            v23 = IoCheckEaBufferValidity(PoolWithQuota_0, v4, &ErrorOffset);
            v30 = v23;
            if ( v23 < 0 )
            {
              v29 = 1;
        ...
        else if ( (Flags & 0x10) != 0 )
        {
          if ( (_DWORD)v4 )
          {
            ...
            v25 = CurrentThread;
            IopProbeAndLockPages_0(Mdl, PreviousMode, 0, (__int64)DeviceObject, CurrentThread->Header.Type);
            goto LABEL_42;
          }
        }
        else
