/*
 * XREFs of ?ExtractDeviceStrings@SC_DEVICE@@AEAAJXZ @ 0x1402C9E58
 * Callers:
 ...
 *     ?ScAnsiToUnicodeString@@YAJPEADPEAU_UNICODE_STRING@@@Z @ 0x1405BEAB0 (-ScAnsiToUnicodeString@@YAJPEADPEAU_UNICODE_STRING@@@Z.c)
 */
