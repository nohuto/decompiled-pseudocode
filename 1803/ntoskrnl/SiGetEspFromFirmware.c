/*
 * XREFs of SiGetEspFromFirmware @ 0x1407E6630
 * Callers:
 ...
 *     SiGetEfiBootEntryById @ 0x1407E62AC (SiGetEfiBootEntryById.c)
    ...
    if ( v9 >= 0 )
    {
      if ( BufferLength )
      {
        ...
        while ( 1 )
        {
          ...
          v12 = (struct _BOOT_OPTIONS *)ExAllocatePoolWithTag(PagedPool, v11, 0x4B505953u);
          v5 = (int *)v12;
          if ( !v12 )
            break;
          v13 = BufferLength;
          ...
          if ( v14 != -1073741789 )
          {
            ...
            if ( !v9 )
            {
              ...
              do
              {
                ...
                if ( v22 )
                {
                  v24 = SiBootEntryGetNtFilePath((__int64)v22, (struct _FILE_PATH **)&v33);
                  v7 = (wchar_t *)v33;
