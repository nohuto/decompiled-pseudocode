/*
 * XREFs of VerifierKeReleaseInStackQueuedSpinLockCommon @ 0x140826650
 * Callers:
 *     VerifierKeReleaseInStackQueuedSpinLock @ 0x140826610 (VerifierKeReleaseInStackQueuedSpinLock.c)
 *     VerifierKeReleaseInStackQueuedSpinLockNoReboot @ 0x140826850 (VerifierKeReleaseInStackQueuedSpinLockNoReboot.c)
 * Callees:
