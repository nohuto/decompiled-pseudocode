...
__int64 __fastcall SepIsLockedDown(unsigned __int8 a1, _BYTE *a2)
{
  ...
  *a2 = 1;
  ...
  if ( v6 )
    goto LABEL_9;
  v4 = ZwQueryLicenseValue(&stru_1403999C0, &Type, &Data, 4u, &ResultDataSize);
  v2 = v4;
  if ( v4 != -1073741772 )
  {
    if ( v4 < 0 )
