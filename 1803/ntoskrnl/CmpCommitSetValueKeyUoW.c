/*
 * XREFs of CmpCommitSetValueKeyUoW @ 0x1405DF3F0
 * Callers:
  ...
  if ( HvpMarkCellDirty(v8, *(unsigned int *)(*(_QWORD *)(a1 + 48) + 32LL), 0) )
  {
    *(_DWORD *)(a1 + 72) = *(_DWORD *)(*(_QWORD *)(a1 + 48) + 32LL) >> 31;
    ...
    if ( PoolWithTag )
    {
      ...
      if ( CmpFindNameInList(v8, v4 + 36, (int)v29, 0, (__int64)&v24, (__int64)&v33) )
      {
        ...
        else
        {
          v33 = -1;
          v34 = 0;
          v22 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, int *))(v8 + 8))(v8, v21, &v33);
          if ( !v22 )
          {
            v14 = -1073741670;
LABEL_19:
