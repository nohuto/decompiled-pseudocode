/*
 * XREFs of PopFxProcessWork @ 0x140077B28
 * Callers:
...
__int64 __fastcall PopFxProcessWork(ULONG_PTR BugCheckParameter2, int *a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    if ( !*(_DWORD *)v4 )
    {
      ...
      if ( (unsigned int)v13 >= *(_DWORD *)(v12 + 708) )
        PopFxBugCheck(0x611uLL, 0LL, *(_QWORD *)(v4 + 8), *(unsigned int *)(v4 + 16));
      _mm_lfence();
      v14 = *(_QWORD *)(*(_QWORD *)(v12 + 712) + 8 * v13);
      if ( *(_DWORD *)(v14 + 152) )
        PopFxBugCheck(0x615uLL, 0LL, *(unsigned int *)(v4 + 16), 0LL);
      if ( *(int *)(v14 + 88) < 0 )
        PopFxBugCheck(0x615uLL, 0LL, *(_QWORD *)(*(_QWORD *)(v12 + 712) + 8 * v13), 1uLL);
      if ( (*(_DWORD *)(v14 + 88) & 0x3FFFFFFF) == 0 )
        PopFxBugCheck(0x615uLL, 0LL, *(_QWORD *)(*(_QWORD *)(v12 + 712) + 8 * v13), 2uLL);
      if ( *(_DWORD *)(v14 + 140) )
        PopFxBugCheck(0x615uLL, 0LL, *(_QWORD *)(*(_QWORD *)(v12 + 712) + 8 * v13), 3uLL);
      ...
      PopPepProcessEvent(*(_QWORD *)(v12 + 56), 200 * v13 + *(_QWORD *)(v12 + 56) + 184, 2, 3, RemlockSize, 0LL);
    ...
    if ( *(_DWORD *)v4 == 1 )
    {
      ...
      if ( (unsigned int)v23 >= *(_DWORD *)(v22 + 708) )
        PopFxBugCheck(0x611uLL, 0LL, *(_QWORD *)(v4 + 8), *(unsigned int *)(v4 + 16));
      _mm_lfence();
      v24 = *(_QWORD *)(*(_QWORD *)(v22 + 712) + 8 * v23);
      if ( *(_DWORD *)(v4 + 20) >= *(_DWORD *)(v24 + 156) )
        PopFxBugCheck(0x616uLL, 0LL, *(_QWORD *)(*(_QWORD *)(v22 + 712) + 8 * v23), 0LL);
      v25 = *(_DWORD *)(v4 + 20);
      if ( v25 == *(_DWORD *)(v24 + 152) )
        PopFxBugCheck(0x616uLL, 0LL, *(_QWORD *)(*(_QWORD *)(v22 + 712) + 8 * v23), 1uLL);
      if ( v25 && *(_DWORD *)(v24 + 152) )
        PopFxBugCheck(0x616uLL, 0LL, *(_QWORD *)(*(_QWORD *)(v22 + 712) + 8 * v23), 2uLL);
      ...
      *(_DWORD *)(v24 + 140) = 2;
      ...
      {
        result = PopFxAddLogEntry(v27, (unsigned int)v23, 14LL);
        v11 = 0;
      }
      goto LABEL_17;
    }
...
LABEL_36:
    ...
    else
    {
      ...
      PopPluginDevicePower(v6, 0LL, 0LL);
        ...
        *(_DWORD *)(v6 + 40) = 2;
        if ( !(unsigned __int8)PopFxScheduleDeviceIdleTimer(v6) )
        {
          ...
          if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v6 + 40), 0xFFFFFFFF) != 1 )
            PopFxAddLogEntry(*(_QWORD *)(v6 + 48), 0LL, 17LL);
        }
      }
      else
      {
...
LABEL_17:
  ...
  switch ( *(_DWORD *)v4 )
  {
    ...
    case 6:
      ...
      if ( (unsigned int)v30 >= *(_DWORD *)(v29 + 708) )
        PopFxBugCheck(0x611uLL, BugCheckParameter2, *(_QWORD *)(v4 + 8), *(unsigned int *)(v4 + 16));
      _mm_lfence();
      v31 = *(_QWORD *)(*(_QWORD *)(v29 + 712) + 8 * v30);
      v32 = *(_QWORD *)(v31 + 328);
      v33 = _InterlockedDecrement((volatile signed __int32 *)(v32 + 40));
      _InterlockedOr((volatile signed __int32 *)(v32 + 40), 0x20000000u);
      if ( (v33 & 0x8000000) == 0 )
        PopFxAddLogEntry(*(_QWORD *)(v29 + 48), v30, 20LL);
      PopDiagTraceFxPerfRequestProgress(v32, v33 & 7);
      LOBYTE(v34) = *(_BYTE *)(v4 + 20);
      return PopFxCompleteComponentPerfState(v29, *(unsigned int *)(v31 + 16), *(_QWORD *)(v31 + 328), v34);
    case 7:
