/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x14028FDE0
 * Callers:
 *     RtlScrubMemory @ 0x14028F74C (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x14028F884 (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x1402902F8 (RtlpTestMemoryRandomUp.c)
 */
