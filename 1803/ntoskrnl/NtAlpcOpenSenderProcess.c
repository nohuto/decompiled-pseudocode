...
__int64 __fastcall NtAlpcOpenSenderProcess(_QWORD *a1, void *a2, __int128 *a3, unsigned int a4, int a5, __int128 *a6)
{
  ...
  v14 = Object;
  v11 = AlpcpLookupMessage((__int64)Object, DWORD2(v41), v42, &BugCheckParameter2);
  if ( v11 < 0 )
  {
...
LABEL_13:
      ...
      v11 = PsOpenProcess((unsigned int)&v39, a5, (unsigned int)&v43, (unsigned int)&Source2 + 8, 0, PreviousMode);
