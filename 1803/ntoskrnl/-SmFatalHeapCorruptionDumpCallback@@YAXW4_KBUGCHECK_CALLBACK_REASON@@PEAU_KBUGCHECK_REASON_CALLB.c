/*
 * XREFs of ?SmFatalHeapCorruptionDumpCallback@@YAXW4_KBUGCHECK_CALLBACK_REASON@@PEAU_KBUGCHECK_REASON_CALLBACK_RECORD@@PEAXK@Z @ 0x1402A81E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  if ( v5 <= *((unsigned int *)ReasonSpecificData + 3) )
  {
    ...
    *((_OWORD *)ReasonSpecificData + 1) = xmmword_140319130;
  }
  else
  {
