/*
 * XREFs of Normalization__IsNormalized @ 0x140789898
 * Callers:
 ...
 *     Normalization__CanCombineWithStartBase @ 0x140789450 (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x14078949C (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__GetLastChar @ 0x1407895CC (Normalization__GetLastChar.c)
 */
...
LABEL_87:
    ...
    Normalization__GetLastChar(a1, v5, &v35, (unsigned int *)&v30, &v26, &v36);
    v20 = v26;
    if ( !v26 || v26 == 63 )
    {
      v32 = v30;
