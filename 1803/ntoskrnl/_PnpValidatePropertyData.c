/*
 * XREFs of _PnpValidatePropertyData @ 0x140523F3C
 * Callers:
 ...
 * Callees:
 *     _GetBaseTypeSize @ 0x1400759A0 (_GetBaseTypeSize.c)
 *     _IsFixedSizeType @ 0x140075A48 (_IsFixedSizeType.c)
...
LABEL_16:
      ...
      if ( (v10 & 0x2000) != 0 )
      {
        ...
        while ( *(_WORD *)SecurityDescriptor )
        {
          ...
          if ( v18 > v4 )
            return (unsigned int)-1073741811;
          SecurityDescriptor = (__int64 *)((char *)SecurityDescriptor + 2 * (v20 >> 1));
        }
        v12 = v18 + 2;
      }
      else
