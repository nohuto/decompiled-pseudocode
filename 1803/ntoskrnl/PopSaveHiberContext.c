/*
 * XREFs of PopSaveHiberContext @ 0x140473E20
 * Callers:
 ...
 *     PopResetRangeEnum @ 0x1400D2EAC (PopResetRangeEnum.c)
 ...
 *     HvlDisableEnlightenment @ 0x140226824 (HvlDisableEnlightenment.c)
...
LABEL_12:
    ...
    if ( !(unsigned __int8)off_140398930[0]() )
    {
      dword_1403AA248 |= 1u;
      byte_1403AA1C1 = 1;
    }
    ...
    *(_BYTE *)(BugCheckParameter3 + 2) = 1;
    if ( !v6 )
    {
      ...
      if ( (HvlpFlags & 2) != 0 )
      {
        ...
        while ( *(_DWORD *)(BugCheckParameter3 + 20) != (_DWORD)KeNumberProcessors_0 )
          _mm_pause();
        *(_QWORD *)&v48 = qword_1403E55B8;
        *((_QWORD *)&v48 + 1) = qword_1403E5558;
        *(_QWORD *)&v49 = qword_1403E5560;
        *((_QWORD *)&v49 + 1) = qword_1403E5550;
        *(_QWORD *)&v50 = qword_1403E5570;
        *((_QWORD *)&v50 + 1) = qword_1403E5568;
        if ( *(_BYTE *)(BugCheckParameter3 + 452) )
        {
          v51[0] = v48;
          v51[2] = v50;
          v51[1] = v49;
          v51[4] = xmmword_1403E55A8;
          v51[3] = xmmword_1403E5598;
        ...
        else
        {
          ...
          v52[2] = v50;
          v52[1] = v49;
          v52[4] = xmmword_1403E55A8;
          v52[3] = xmmword_1403E5598;
    ...
    {
      RtlCopyBitMap(BugCheckParameter3 + 48, BugCheckParameter3 + 32, 0);
    ...
    *(_DWORD *)(BugCheckParameter3 + 184) = 8;
    ...
    v17 = __rdtsc();
    qword_1403AA508 += (((unsigned __int64)HIDWORD(v17) << 32) | (unsigned int)v17) - v15;
    ...
    if ( v25 >= 0 )
    {
      ...
      if ( *(_BYTE *)(BugCheckParameter3 + 452) )
      {
        ...
        *(_QWORD *)(v7 + 96) = v36 + ((unsigned __int64)(4 * v35 + 4095) >> 12);
        ...
        qword_1403AA690 = *(unsigned int *)(BugCheckParameter3 + 252);
      }
      ...
      *(_QWORD *)(BugCheckParameter3 + 96) = v8;
      ...
      memset(qword_1403AA218, 0, 0x40uLL);
      v28[6] = 0;
      *(_QWORD *)v28 = v30;
      v28[2] = v29;
      *((_QWORD *)v28 + 2) = v31;
      ...
      *(_BYTE *)(BugCheckParameter3 + 4) = 1;
      ...
      if ( v37 )
      {
        do
        {
          v39 = v38++;
          v39 <<= 7;
          qword_1403AA698 += *(_QWORD *)(v39 + *(_QWORD *)(BugCheckParameter3 + 264) + 56);
          *(_QWORD *)(v39 + *(_QWORD *)(BugCheckParameter3 + 264) + 56) = 0LL;
        }
        while ( v38 < *(_DWORD *)(BugCheckParameter3 + 256) );
      }
      qword_1403AA6A8 = qword_1403AA6C8;
      qword_1403AA6B8 = (unsigned int)dword_1403AA6D0;
      qword_1403AA6C8 = 0LL;
      dword_1403AA6D0 = 0;
      ...
      *(_DWORD *)(BugCheckParameter3 + 184) = 6;
      ...
      if ( v25 >= 0 )
      {
        if ( dword_1403AA080 == dword_1403AA088 )
        {
