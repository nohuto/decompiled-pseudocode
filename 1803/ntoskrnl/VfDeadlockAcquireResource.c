/*
 * XREFs of VfDeadlockAcquireResource @ 0x140827CF8
 * Callers:
 ...
 *     VerifierKeAcquireSpinLockRaiseToDpc @ 0x140826060 (VerifierKeAcquireSpinLockRaiseToDpc.c)
 ...
 *     ViKeObjectAcquired @ 0x1408277B4 (ViKeObjectAcquired.c)
 ...
 *     ViDeadlockSimilarNode @ 0x14082A5F4 (ViDeadlockSimilarNode.c)
      ...
      if ( *v20 != (_DWORD)v5 )
      {
        if ( ((unsigned int)(v5 - 3) > 1 || (unsigned int)(v22 - 3) > 1) && (v22 != 7 || (unsigned int)(v5 - 5) > 1) )
        {
          ViDeadlockPreprocessOptions(
            ...
            (const void *)0x1008);
          VfReportIssueWithOptions(0xC4u, 0x1008uLL, a1, *v20, v5, byte_14039D140);
LABEL_36:
          v18 = v53;
          v19 = 0;
LABEL_80:
      ...
      if ( v23 )
      {
        if ( v25 > 1u )
        {
          ...
          ViDeadlockPreprocessOptions(
            ...
            (const void *)0x1000);
          VfReportIssueWithOptions(0xC4u, 0x1000uLL, a1, (ULONG_PTR)v20, v9, &dword_14039D13C);
          goto LABEL_36;
        }
        v26 = a4;
        v27 = (_QWORD *)(v23 + 8);
