/*
 * XREFs of RtlGenerate8dot3Name @ 0x1405591E0
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x140187410 (__security_check_cookie.c)
 *     memmove @ 0x1401BC900 (memmove.c)
 *     GetNextWchar @ 0x1405595AC (GetNextWchar.c)
 *     RtlComputeLfnChecksum @ 0x140559690 (RtlComputeLfnChecksum.c)
 */
        ...
        PUNICODE_STRING Name8dot3)
{
  ...
  _DWORD v53[6]; // [rsp+30h] [rbp-58h] BYREF
  ...
  if ( !Context->NameLength )
  {
    ...
    {
      LOBYTE(Name8dot3) = v6;
      NextWchar = GetNextWchar(Name, &v51, Context, Name8dot3);
      if ( !NextWchar )
        break;
      LOBYTE(Context) = 0;
      if ( NextWchar == 46 )
    ...
    while ( 1 )
    {
      LOBYTE(Name8dot3) = v6;
      LOBYTE(Context) = 1;
      v14 = GetNextWchar(Name, &v51, Context, Name8dot3);
      Context = 0LL;
      *(_QWORD *)&AllowExtendedCharacters = v14;
      if ( !v14 || v4 >= 6u || v51 >= v10 )
        break;
      if ( v8 )
      {
    ...
    else
    {
      ...
      for ( i = 1; ; i = v5->ExtensionLength )
      {
        LOBYTE(Name8dot3) = v6;
        LOBYTE(Context) = 1;
        v17 = GetNextWchar(Name, v53, Context, Name8dot3);
...
LABEL_40:
  ...
  *v26 = 126;
  ...
  {
    memmove(v25->Buffer, v5->NameBuffer, 2 * (unsigned int)NameLength);
    v27 = 2 * v5->NameLength;
  }
  v25->Length = v27;
  ...
  if ( v8 )
  {
    ...
    for ( j = 0; v46 < v45; ++v46 )
    {
      v48 = v5->NameBuffer[v46];
      if ( v48 <= 0x7Fu || (v49 = 2, !*(_BYTE *)(NlsUnicodeToMbOemData + 2LL * v48 + 1)) )
        v49 = 1;
      j += v49;
      if ( j > 7 - v19 )
        break;
