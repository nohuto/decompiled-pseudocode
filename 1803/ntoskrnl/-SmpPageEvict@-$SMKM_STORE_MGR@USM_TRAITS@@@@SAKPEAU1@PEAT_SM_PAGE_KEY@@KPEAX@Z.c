/*
 * XREFs of ?SmpPageEvict@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAKPEAU1@PEAT_SM_PAGE_KEY@@KPEAX@Z @ 0x140096C50
 * Callers:
...
__int64 SMKM_STORE_MGR<SM_TRAITS>::SmpPageEvict(__int64 a1, _DWORD *a2, unsigned int a3, ...)
{
  ...
  if ( v5 != 1024 )
  {
    ...
    v8 = xmmword_1404660F0 & 1;
    v9 = *v7;
    v10 = (__int64 *)SmFpAllocate(&dword_140465F50, v8);
    v12 = v17;
    v13 = v10;
    if ( v10 )
    {
      *v10 = 0LL;
      v10[1] = 0LL;
      *v10 = 0LL;
      v14 = (_DWORD *)SmFpAllocate(&dword_140465F50, v8);
      v4 = v14;
      if ( v14 )
      {
    ...
    if ( v13 )
      SmFpFree((__int64)&dword_140465F50, 0, (__int64)v13, (struct _MDL *)v13);
  }
