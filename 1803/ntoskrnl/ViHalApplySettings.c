/*
 * XREFs of ViHalApplySettings @ 0x14081B32C
 * Callers:
...
__int64 (__fastcall *ViHalApplySettings())(__int64 a1, __int64 a2, unsigned int a3, __int64 *a4)
{
  ...
  if ( (MmVerifierData & 0x80u) != 0 )
  {
    ...
    {
      ViVerifyDma = 1;
      if ( (unsigned int)HalPrivateDispatchTable >= 0x2F )
      {
        VfRealHalAllocateMapRegisters = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))off_1403986D0[0];
        result = VfHalAllocateMapRegisters;
        off_1403986D0[0] = (__int64 (__fastcall *)())VfHalAllocateMapRegisters;
      }
      ViDoubleBufferDma = 1;
