/*
 * XREFs of _CmSetInstallerClassMappedProperty @ 0x1407EF960
 * Callers:
 ...
 *     _CmSetInstallerClassMappedPropertyFromRegProp @ 0x1407EFC0C (_CmSetInstallerClassMappedPropertyFromRegProp.c)
...
LABEL_11:
    ...
    if ( a6 < 2 )
      v20 = CmDeleteInstallerClassMappedPropertyFromRegValue(a1, (__int64)a2, a3, a5);
    else
