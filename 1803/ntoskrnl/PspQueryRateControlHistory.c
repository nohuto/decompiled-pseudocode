  ...
  *a4 = 0;
  ...
  if ( v8 )
  {
    if ( a5 )
    {
      if ( a5 == 1 )
      {
        if ( (int)PspJobIoRateQueryHistory(a1, &BitMapHeader, &v24, &NumberToClear) < 0 )
          return;
      }
      else
      {
        KeQuerySchedulingGroupHistory(v8 + 128, &BitMapHeader, &v24, &NumberToClear);
      }
      v9 = NumberToClear;
      v10 = v24;
