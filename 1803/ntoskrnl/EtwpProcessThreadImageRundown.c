/*
 * XREFs of EtwpProcessThreadImageRundown @ 0x140629158
 * Callers:
 ...
 *     EtwpIsStackWalkingEnabled @ 0x140629B28 (EtwpIsStackWalkingEnabled.c)
 */
...
LABEL_11:
    if ( BYTE2(v23[13]) && stru_1403977A0.LevelPlus1 > 5 && TlgKeywordOn(&stru_1403977A0, 0x200000000000uLL) )
    {
      ...
      v47 = 8;
      v50 = 8;
      TlgWrite(&stru_1403977A0, &unk_14030F07A, 0LL, 0LL, 0xBu, &pData);
    }
    goto LABEL_12;
  }
  v13 = 0;
