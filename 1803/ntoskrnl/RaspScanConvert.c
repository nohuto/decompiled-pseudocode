/*
 * XREFs of RaspScanConvert @ 0x140174560
 * Callers:
 *     RaspRasterize @ 0x14017429C (RaspRasterize.c)
 * Callees:
 *     BgpFmRoundUp @ 0x140165888 (BgpFmRoundUp.c)
 ...
 *     RaspTestIntersection @ 0x1401749B0 (RaspTestIntersection.c)
        ...
        _QWORD *a8)
{
  ...
  int v65[4]; // [rsp+50h] [rbp-48h] BYREF
  ...
  if ( SegmentList >= 0 )
  {
    ...
    if ( v10 )
    {
      v32 = qword_140907410;
      v64 = qword_140907410;
      v14 = BgpGxInitializeRectangle(v65, 1, (__int64)qword_140907410, 0xC44u);
      if ( v14 < 0 )
        goto LABEL_32;
    }
    else
    {
      v31 = RaspRectangleCreate(v65, 1LL, &v66, v11);
      v32 = v66;
      v14 = v31;
      v64 = v66;
    }
...
LABEL_13:
          ...
          if ( v28 > 0 )
          {
            ...
            {
              memset(Memory, 0, v37);
              v38 = (_DWORD)v66 + -16 * (v36 & 3) - ((unsigned int)v36 >> 2 << 6);
              if ( (_DWORD)v13 )
                break;
LABEL_20:
              v41 = 0LL;
            ...
            while ( 1 )
            {
              RaspTestIntersection(v39 - 24, v38, &v59, &v60);
              v40 = v59;
              if ( v59 != 0x7FFFFFFF )
                break;
LABEL_18:
