/*
 * XREFs of DrvDbGetDriverInfFileMappedProperty @ 0x140571B6C
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  *a8 = 0;
  ...
  if ( !a3 )
  {
    v20 = 0;
    v19 = 1;
    RegValueMappedProperty = DrvDbOpenObjectRegKey(a1, 0LL, 3u, a2, v19, v20, Handle, 0LL);
    if ( RegValueMappedProperty < 0 )
      goto LABEL_11;
    a3 = Handle[0];
  }
  RegValueMappedProperty = DrvDbGetRegValueMappedProperty(v15, a3, (__int64)v16, a5, a6, a7, a8);
LABEL_11:
  if ( Handle[0] )
    ZwClose(Handle[0]);
