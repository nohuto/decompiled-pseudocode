/*
 * XREFs of KiFindRankBiasedIdleSmtSet @ 0x1402481AC
 * Callers:
...
char __fastcall KiFindRankBiasedIdleSmtSet(__int64 a1, _QWORD *a2)
{
  ...
  do
  {
    ...
    v8 = *(_QWORD *)(v7 + 24920) & ~*(_QWORD *)(v7 + 200);
    if ( (v3 & v8) == v8 )
    {
      v3 ^= v8;
    }
    else
    {
      ...
      if ( (*(_DWORD *)(KiProcessorBlock[KiProcessorNumberToIndexMappingTable[(unsigned int)(v4 + v9)]] + 236) & 0x10) != 0 )
        v2 |= v6;
    }
  }
  while ( v3 );
