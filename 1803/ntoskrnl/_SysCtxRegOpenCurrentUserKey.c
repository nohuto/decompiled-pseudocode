/*
 * XREFs of _SysCtxRegOpenCurrentUserKey @ 0x1407F0408
 * Callers:
 ...
 *     _SysCtxGetCachedContextBaseKey @ 0x14057910C (_SysCtxGetCachedContextBaseKey.c)
 */
          ...
          if ( appended >= 0 )
          {
            ...
            if ( appended >= 0 )
            {
              ...
              if ( PoolWithTag )
              {
                ...
                appended = RtlAppendUnicodeStringToString(&Destination, &stru_1402F40E8);
                if ( appended >= 0 )
                {
