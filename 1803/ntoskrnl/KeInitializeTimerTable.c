/*
 * XREFs of KeInitializeTimerTable @ 0x14062B1B4
 * Callers:
 ...
 *     KiInitializeTimer2Data @ 0x1401768F4 (KiInitializeTimer2Data.c)
...
__int64 __fastcall KeInitializeTimerTable(__int64 a1)
{
  ...
  if ( !*(_DWORD *)(a1 + 36) )
  {
    ...
    {
      KiSerializeTimerExpiration = (unsigned __int8)off_140398940[0]() != 0;
    }
  ...
  *(_DWORD *)(a1 + 11892) = MEMORY[0xFFFFF78000000320];
  ...
  if ( !*(_QWORD *)(a1 + 22888) )
    *(_WORD *)(a1 + 22834) = *(_WORD *)(a1 + 36) + 1280;
  v3 = a1 + 14472;
  v4 = 256LL;
  do
  {
