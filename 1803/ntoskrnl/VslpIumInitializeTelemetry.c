/*
 * XREFs of VslpIumInitializeTelemetry @ 0x1408C9530
 * Callers:
...
char VslpIumInitializeTelemetry()
{
  ...
  result = TraceLoggingRegisterEx(&stru_140398380, 0LL, 0LL);
  if ( (*(_DWORD *)(KeLoaderBlock_0 + 264) & 1) != 0 )
  {
    if ( stru_140398380.LevelPlus1 <= 5 )
      goto LABEL_5;
    result = TlgKeywordOn(&stru_140398380, 0x400000000000uLL);
    if ( result )
    {
      v3 = *(_QWORD *)(v2 + 240);
      v6[0] = (v1 >> 2) & 1;
      ...
      v12[0] = v4;
      v14 = 4;
      result = TlgWrite(&stru_140398380, &unk_1403091DC, 0LL, 0LL, 5u, &pData);
    }
  }
  if ( stru_140398380.LevelPlus1 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v8 = v6;
      v9 = 4;
      result = TlgWrite(&stru_140398380, &unk_140309218, 0LL, 0LL, 3u, &pData);
    }
  }
LABEL_5:
  if ( !VslVsmEnabled )
  {
    result = EtwUnregister(stru_140398380.RegHandle);
    stru_140398380.RegHandle = 0LL;
    stru_140398380.LevelPlus1 = 0;
  }
  return result;
}
