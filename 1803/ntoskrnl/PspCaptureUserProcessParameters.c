/*
 * XREFs of PspCaptureUserProcessParameters @ 0x140550820
 * Callers:
 ...
 *     PspCaptureAndValidateUnicodeString @ 0x140550DA8 (PspCaptureAndValidateUnicodeString.c)
 *     PspValidateEnvironmentBlock @ 0x140550E20 (PspValidateEnvironmentBlock.c)
...
__int64 __fastcall PspCaptureUserProcessParameters(_QWORD *a1, __int64 a2, char a3, __int64 a4)
{
  ...
  if ( (int)result < 0 )
    return result;
  v9 = (WORD1(Src[0]) + v30 + v32 + v34 + v36 + v38 + (unsigned __int64)v40 + WORD1(v28) + 1041LL) & 0xFFFFFFFFFFFFFFFEuLL;
  v27 = v9;
  v10 = -1LL;
  if ( v9 + Size >= v9 )
    v10 = v9 + Size;
