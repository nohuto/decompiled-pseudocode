/*
 * XREFs of AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x1407DF9B0
 * Callers:
 *     AuthzBasepQueryClaimAttributesToken @ 0x140571948 (AuthzBasepQueryClaimAttributesToken.c)
 * Callees:
 *     AuthzBasepGetClaimAttributeValueCopyoutBufferSize @ 0x1407DF814 (AuthzBasepGetClaimAttributeValueCopyoutBufferSize.c)
 */
