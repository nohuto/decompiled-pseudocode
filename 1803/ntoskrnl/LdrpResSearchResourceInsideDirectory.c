/*
 * XREFs of LdrpResSearchResourceInsideDirectory @ 0x1404B2318
 * Callers:
        ...
        _WORD *a13)
{
  ...
  __int64 v70; // [rsp+58h] [rbp-E0h]
  unsigned int *v71; // [rsp+60h] [rbp-D8h]
  int v72; // [rsp+68h] [rbp-D0h] BYREF
  int v73; // [rsp+6Ch] [rbp-CCh]
  unsigned __int64 v74; // [rsp+70h] [rbp-C8h]
  __int16 v75; // [rsp+78h] [rbp-C0h]
  int v76; // [rsp+7Ch] [rbp-BCh]
  int v77; // [rsp+80h] [rbp-B8h]
  unsigned __int64 v78; // [rsp+88h] [rbp-B0h]
  int v79; // [rsp+90h] [rbp-A8h]
  __int64 v80; // [rsp+98h] [rbp-A0h]
  unsigned int *v81; // [rsp+A0h] [rbp-98h]
  unsigned int *v82; // [rsp+A8h] [rbp-90h]
...
LABEL_12:
              if ( v23 )
              {
                ...
                if ( v25 )
                {
                  ...
                  if ( v27 && (a12 & 0x1000) != 0 )
                  {
                    v83 = 8LL * (unsigned int)v27;
                    v48 = (unsigned int)(8 * v27);
                    if ( v48 + v23 + 16 < v23 )
                      goto LABEL_154;
                  ...
                  if ( (v17 & 0xFFFFFFFFFFFF0000uLL) == 0 )
                  {
                    ...
                    if ( (a12 & 0x1000) != 0 )
                    {
                      v85 = 8LL * (unsigned int)v27;
                      v30 = &v28[8 * v27];
                      if ( v30 < v28 )
                        goto LABEL_154;
                      pullResult = (ULONGLONG)&v28[8 * v27];
                      v69 = v27;
...
LABEL_115:
                  ...
                  while ( !v78 || (v19 & 0x20) == 0 )
                  {
                    while ( 2 )
                    {
                      ...
                      v82 = (unsigned int *)v28;
                      v32 = (unsigned __int64)&v28[8 * v29 - 8];
                      v86 = v32;
                      while ( 1 )
                      {
                        ...
                        if ( (v29 & 1) == 0 )
                          v33 = (int)v33 - 1;
                        v81 = &v31[2 * v33];
                        result = LdrpResCompareResourceNames(a1, v31, v14, v17, a4, v81, v19, &v72, v66);
                        v66 = result;
                        if ( (int)result < 0 )
                          return result;
                        if ( !v72 )
...
LABEL_38:
                        ...
                        if ( v72 < 0 )
                        {
                          v32 = (unsigned __int64)(v81 - 2);
                          v86 = (unsigned __int64)(v81 - 2);
                          if ( v93 )
                            v29 = v85;
                          else
                            v29 = v80;
                      ...
                      if ( !v29 )
                        goto LABEL_44;
                      result = LdrpResCompareResourceNames(a1, v31, v14, v17, a4, v31, v19, &v72, v66);
                      v66 = result;
                      if ( (int)result < 0 )
                        return result;
                      if ( !v72 )
...
LABEL_45:
                  ...
                  v71 = (unsigned int *)(a4 + v36);
                  LODWORD(v17) = *(_DWORD *)v28;
...
LABEL_51:
              ...
              if ( v24 && !v37 )
              {
                ...
                if ( (a1 & 1) != 0 || v21 == 34816 )
                {
                  ...
                  v39 = v38 + v53 - a4;
                  v54 = LdrpSectionTableFromVirtualAddress((unsigned int)a1 & 0xFFFFFFFC, v14, v50, v37, v52, v91);
                  if ( !v54 )
                    goto LABEL_162;
                  if ( *v24 > *(_DWORD *)(v54 + 8) )
                  {
                    ullSubtrahenda = *(_DWORD *)(v54 + 12);
                    v56 = LdrpSectionTableFromVirtualAddress((unsigned int)a1 & 0xFFFFFFFC, a3, a5, v55, *v24, v91);
                    if ( !v56 )
                      goto LABEL_162;
                    v94 = *(_DWORD *)(v56 + 12);
                    v58 = LdrpSectionTableFromVirtualAddress((unsigned int)a1 & 0xFFFFFFFC, a3, a5, v57, v94, v91);
                    v59 = v58;
                    v40 = -1073741675;
                    if ( v58 )
                    {
                      if ( (a12 & 0x1000) != 0 )
                      {
                        ...
                        {
                          pullResult = v38 + v94 - v60;
                          v63 = 0;
                        }
                        if ( v63 < 0 )
                          return (unsigned int)-1073741701;
                        if ( v62 + *(unsigned int *)(v59 + 20) < v62 )
                          goto LABEL_154;
                        pullResult = v62 + *(unsigned int *)(v59 + 20);
                      }
                      else
                      {
                        v61 = v94;
                      }
                      v64 = v38 + *(unsigned int *)(v59 + 20) - (unsigned __int64)*(unsigned int *)(v59 + 12) + v61;
                    }
                    else
                    {
                      v64 = 0LL;
                    ...
                    if ( v79
                      && (RtlULongLongSub(*(unsigned int *)(v59 + 12), ullSubtrahenda, &pullResult) < 0
                       || RtlULongLongSub(pullResult, v64 - a4, &pullResult) < 0) )
                    {
                      return (unsigned int)-1073741701;
                    }
                    v39 += a4 + *(unsigned int *)(v59 + 12) - (unsigned __int64)ullSubtrahenda - v64;
                    v20 = v79;
                    goto LABEL_63;
                  }
                }
...
LABEL_152:
                ...
                if ( a10 )
                {
                  if ( (a12 & 0x1000) != 0 && (v23 < v65 || v23 > v14 + v65) )
                    return (unsigned int)-1073741701;
                  *a10 = v23;
                }
                return v16;
