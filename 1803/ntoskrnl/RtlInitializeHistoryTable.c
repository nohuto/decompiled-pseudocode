/*
 * XREFs of RtlInitializeHistoryTable @ 0x14089DCEC
 * Callers:
 *     MiInitSystem @ 0x14089C128 (MiInitSystem.c)
 * Callees:
 *     RtlLookupFunctionEntry @ 0x14012EA90 (RtlLookupFunctionEntry.c)
 *     RtlpFunctionAddressTableEntry @ 0x14089DDD4 (RtlpFunctionAddressTableEntry.c)
 */
...
PRUNTIME_FUNCTION RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v3 + 8] = v2;
    if ( v4 < qword_140464918 )
      qword_140464918 = v4;
    if ( v5 > qword_140464920 )
      qword_140464920 = v5;
  }
