/*
 * XREFs of HvlReadPerformanceStateCounters @ 0x14015B060
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall HvlReadPerformanceStateCounters(ULONG a1, unsigned int a2, _QWORD *a3, _QWORD *a4)
{
  ...
  else
  {
    ...
    v8 = *((unsigned int *)&xmmword_1403E5A30 + 2 * v4 + 7);
    *a3 = Prcb->StatisticsPage[*((unsigned int *)&xmmword_1403E5A30 + 2 * v4 + 6)];
