/*
 * XREFs of KxContextToKframes @ 0x140132CB0
 * Callers:
...
char __fastcall KxContextToKframes(__int64 a1, __int64 a2, __int64 a3, int a4, char a5)
{
  ...
  if ( (a4 & 0x100040) == 0x100040 && a5 == 1 )
  {
    ...
    v28 = MEMORY[0xFFFFF780000003E0] & 0xFFFFFFFFFFFFFFFCuLL;
    if ( SparePtr )
      KiCopyXStateArea(SparePtr, v28);
    else
      RtlXRestore(*(int *)(a3 + 1248) + a3 + 720, v28);
  }
