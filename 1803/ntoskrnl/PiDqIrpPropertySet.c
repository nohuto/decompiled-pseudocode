/*
 * XREFs of PiDqIrpPropertySet @ 0x1405C24A0
 * Callers:
...
__int64 __fastcall PiDqIrpPropertySet(PIRP Irp)
{
  ...
  if ( v6 < 0 )
    goto LABEL_27;
  NdrMesTypeDecode3(v20, "TP 3\a", &off_1402EDA90, &off_140396FA0, 2, &P);
  if ( !P
    || !*((_QWORD *)P + 1)
    || !*((_QWORD *)P + 3)
    || !*((_DWORD *)P + 4)
...
LABEL_44:
  ...
  if ( v4 )
  {
    ...
    {
      v6 = PiDqOpenObjectRegKey(1, *((_QWORD *)P + 1), PnpObjectType, 7u, 1, 0LL, &v19);
      if ( v6 < 0 )
        goto LABEL_27;
      goto LABEL_19;
    }
...
LABEL_19:
  v6 = PiPnpRtlBeginOperation((__int64 **)&v21);
  if ( v6 >= 0 )
  {
