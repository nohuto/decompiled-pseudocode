/*
 * XREFs of IopGetNetworkOpenInformation @ 0x1406552CC
 * Callers:
...
__int64 __fastcall IopGetNetworkOpenInformation(struct _FILE_OBJECT *Object, __int64 a2)
{
  ...
  v4 = IopQueryXxxInformation(Object, 4u, 0x28u, 0, (struct _IRP *)v7, &v6, 1);
  if ( v4 >= 0 )
  {
    v4 = IopQueryXxxInformation(Object, 5u, 0x18u, 0, (struct _IRP *)v9, &v6, 1);
    if ( v4 >= 0 )
    {
      **(_QWORD **)(a2 + 104) = v7[0];
