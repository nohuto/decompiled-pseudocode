        ...
        _QWORD *a7)
{
  ...
  __int64 v50[3]; // [rsp+B0h] [rbp-50h] BYREF
  char v51; // [rsp+CEh] [rbp-32h]
...
LABEL_13:
      ...
      v15 = ObpAssignSecurity(
              ...
              (_DWORD)v47,
              ObTypeIndexTable[(unsigned __int8)(ObHeaderCookie ^ v48 ^ v7[24])],
              v44,
              v21);
