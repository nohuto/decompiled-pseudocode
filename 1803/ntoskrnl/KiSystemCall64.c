/*
 * XREFs of KiSystemCall64 @ 0x1401BB100
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a49)
{
  ...
  v111 = v51;
  v112 = a2;
  v59 = *(_QWORD *)&KeGetCurrentThread()->Process[2].Spare2[7];
  ...
  else
  {
    if ( (a2 & 2) != 0 && (KeGetPcr()->Prcb.BpbFeatures & 4) == 0 )
    {
      ...
      v125 = 0x1401BB2E0LL;
      v124 = 0x1401BB2D7LL;
      *((_QWORD *)&v123 + 1) = 0x1401BB2CELL;
      *(_QWORD *)&v123 = 0x1401BB2C5LL;
      *((_QWORD *)&v122 + 1) = 0x1401BB2BCLL;
      *(_QWORD *)&v122 = 0x1401BB2B3LL;
      *((_QWORD *)&v121 + 1) = 0x1401BB2AALL;
      *(_QWORD *)&v121 = 0x1401BB2A1LL;
      *((_QWORD *)&v120 + 1) = 0x1401BB298LL;
      *(_QWORD *)&v120 = 0x1401BB28FLL;
      *((_QWORD *)&v119 + 1) = 0x1401BB286LL;
      *(_QWORD *)&v119 = 0x1401BB27DLL;
      *((_QWORD *)&v118 + 1) = 0x1401BB274LL;
      *(_QWORD *)&v118 = 0x1401BB26BLL;
      v117 = 0x1401BB262LL;
      v116 = 0x1401BB259LL;
      v115 = 0x1401BB250LL;
      v114 = 0x1401BB247LL;
...
LABEL_19:
  ...
  while ( v62 );
  v95 = *((unsigned int *)&xmmword_14044C8E0 + 4);
  if ( (unsigned int)v73 >= (unsigned int)v95
    || (result = (unsigned int)*(char *)(xmmword_14044C8E0 + 4 * v95 + v73), (int)result > 0) )
  {
LABEL_80:
    result = 3221225500LL;
  }
