/*
 * XREFs of VfMajorVerifyIrpStackDownward @ 0x140822F6C
 * Callers:
        ...
        __int64 a6))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  if ( *a4 > 0x1Bu )
    ...
    v11 = v6;
  v12 = (void (__fastcall *)(__int64))*((_QWORD *)&unk_140842E90 + 12 * v11);
  if ( v12 )
    v12(a1);
  result = qword_140843910;
  if ( qword_140843910 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD))qword_140843910(
                                                                                             a1,
                                                                                             a2,
                                                                                             a3,
                                                                                             a4,
