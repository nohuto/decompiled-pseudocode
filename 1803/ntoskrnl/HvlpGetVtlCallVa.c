/*
 * XREFs of HvlpGetVtlCallVa @ 0x1402CA31C
 * Callers:
...
{
  __int64 result; // rax
  __int64 (__fastcall *v1)(_QWORD, _QWORD, _QWORD); // rcx
  ...
  v1 = 0LL;
  if ( !(_WORD)result )
    v1 = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))(HvlpHypercallCodeVa + (v2 & 0xFFF));
  HvlpVsmVtlCallVa = v1;
  return result;
}
