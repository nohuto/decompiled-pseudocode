/*
 * XREFs of KeMarkHiberPhase @ 0x140484480
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( v8 )
    PoSetHiberRange(
      ...
      0x10000u,
      v8,
      (MEMORY[0xFFFFF78000000600] - MEMORY[0xFFFFF780000003E8] + 127) & 0xFFFFFFC0,
      0x7373654Bu);
  v9 = *(void **)(v1 + 23808);
  if ( v9 )
    PoSetHiberRange(0LL, 0x10000u, v9, 0x428uLL, 0x7349654Bu);
  if ( qword_1403ADB98 )
    PoSetHiberRange(0LL, 0x10000u, qword_1403ADB98, 16 * (unsigned int)(unsigned __int8)qword_1403ADB88, 0x7272744Du);
  if ( qword_1403ADBA0 )
    PoSetHiberRange(0LL, 0x10000u, qword_1403ADBA0, 0x58uLL, 0x7272744Du);
  v10 = *(_QWORD **)(v1 + 8);
  v11 = (void *)((v10[6] + 4095LL) & 0xFFFFFFFFFFFFF000uLL);
  v12 = v10[7] - (_QWORD)v11;
  PoSetHiberRange(0LL, 0x10000u, v10, 0x818uLL, 0x6874654Bu);
