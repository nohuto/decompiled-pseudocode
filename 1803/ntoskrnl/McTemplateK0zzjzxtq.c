/*
 * XREFs of McTemplateK0zzjzxtq @ 0x14023BB70
 * Callers:
 *     PiDevCfgLogDeviceMigrated @ 0x14072CE3C (PiDevCfgLogDeviceMigrated.c)
 * Callees:
 *     McGenEventWriteKM @ 0x14014761C (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x140187410 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0zzjzxtq(
        __int64 a1,
        ...
        char a10)
{
  ...
  v37 = &a10;
  v38 = 4LL;
  return McGenEventWriteKM(MS_KernelPnP_Provider_Context, a2, 0LL, 8u, &v21);
}
