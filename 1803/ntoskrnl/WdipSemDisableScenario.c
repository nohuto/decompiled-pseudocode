/*
 * XREFs of WdipSemDisableScenario @ 0x14060D4B8
 * Callers:
 ...
 *     WdipSemValidateEndEvent @ 0x14060E008 (WdipSemValidateEndEvent.c)
...
LABEL_12:
  ExReleasePushLockEx((ULONG_PTR)&WdipSemPushLock, 0LL, v11, v12);
  ...
  if ( v5 )
  {
    ...
    if ( WdipSemEnabled )
      WdipSemShutdown();
    ExReleasePushLockEx((ULONG_PTR)&WdipSemPushLock, 0LL, v15, v16);
    KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
  }
