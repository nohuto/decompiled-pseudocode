/*
 * XREFs of ndisAddWoLMagicPacket @ 0x1C0024054
 * Callers:
...
__int64 __fastcall ndisAddWoLMagicPacket(KSPIN_LOCK *MiniportAdapterHandle)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(85LL, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, MiniportAdapterHandle);
    ...
    *(_QWORD *)&Request.NdisReserved[32] = &ndisIntReqGeneric;
    ...
    if ( v6 )
    {
      if ( (unsigned __int8)byte_1C0099615 >= 2u )
        WPP_SF_d(86LL, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v6);
    }
  }
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(87LL, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, MiniportAdapterHandle, v2);
  return v2;
}
