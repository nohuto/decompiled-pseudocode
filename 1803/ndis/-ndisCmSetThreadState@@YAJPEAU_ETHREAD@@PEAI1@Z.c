/*
 * XREFs of ?ndisCmSetThreadState@@YAJPEAU_ETHREAD@@PEAI1@Z @ 0x1C0009530
 * Callers:
 *     ndisNsiSetThreadInformation @ 0x1C00AC4A0 (ndisNsiSetThreadInformation.c)
 *     NdisSetThreadObjectCompartmentId @ 0x1C00F1380 (NdisSetThreadObjectCompartmentId.c)
 *     NdisSetThreadObjectCompartmentScope @ 0x1C00F13A0 (NdisSetThreadObjectCompartmentScope.c)
 *     ndisNsiSetAllThreadInformation @ 0x1C00F1570 (ndisNsiSetAllThreadInformation.c)
 * Callees:
