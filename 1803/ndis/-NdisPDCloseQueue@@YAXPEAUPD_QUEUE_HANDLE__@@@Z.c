/*
 * XREFs of ?NdisPDCloseQueue@@YAXPEAUPD_QUEUE_HANDLE__@@@Z @ 0x1C00F7D80
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDCloseQueue(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_q(0x60u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)P);
  v4.m_State = Unlocked;
  ...
  *P = 0LL;
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_q(0x61u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)P);
}
