/*
 * XREFs of NdisIMRegisterLayeredMiniport @ 0x1C00EB5C0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE DriverHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xCu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)NdisWrapperHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xDu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)*DriverHandle, v8);
  return v8;
}
