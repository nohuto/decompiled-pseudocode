/*
 * XREFs of ndisOidPreIovVPortParameters @ 0x1C00F3EC0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovVPortParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qq(0x37u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v1, v3);
  v7 = *(_DWORD *)(v3 + 4);
  ...
  *(_DWORD *)(a1 + 40) = 0;
  if ( *(_DWORD *)(v3 + 48) >= 0x23Cu )
  {
    ...
    if ( ndisIovNicSwitchWithoutIovSupported(v1)
      || (v9 = *(_QWORD *)(v1 + 4640)) != 0 && *(_QWORD *)(v1 + 3584) && (*(_BYTE *)(v9 + 8) & 3) == 3 )
    {
      v10 = *(_DWORD *)(v3 + 4);
      if ( (v10 & 0xFFFFFFFD) != 0 )
      {
...
LABEL_46:
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qqDD(0x38u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v1, v4, v2, *(_DWORD *)(a1 + 40));
  return v2;
}
