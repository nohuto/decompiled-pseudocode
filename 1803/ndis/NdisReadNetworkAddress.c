/*
 * XREFs of NdisReadNetworkAddress @ 0x1C00CA7C0
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_HANDLE ConfigurationHandle)
{
  ...
  if ( (unsigned __int8)byte_1C009960F >= 4u )
    WPP_SF_q(0x19u, &WPP_7638764ccf46397224acdca5d7787036_Traceguids, (__int64)ConfigurationHandle);
  *Status = -1073741823;
...
LABEL_17:
  ...
  if ( (unsigned __int8)byte_1C009960F >= 4u )
    WPP_SF_q(0x1Au, &WPP_7638764ccf46397224acdca5d7787036_Traceguids, (__int64)ConfigurationHandle);
}
