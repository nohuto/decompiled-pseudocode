/*
 * XREFs of ndisReadMiniportSpecificPortAuthStates @ 0x1C00B5274
 * Callers:
...
__int64 __fastcall ndisReadMiniportSpecificPortAuthStates(_DWORD *a1, void *a2)
{
  ...
  *(_DWORD *)&v13.Length = 4456514;
  ...
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_q(0x31u, &WPP_f15752027639342d7f4a984ed5eb2bc7_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qD(0x32u, &WPP_f15752027639342d7f4a984ed5eb2bc7_Traceguids, (__int64)a1, v4);
  return v4;
}
