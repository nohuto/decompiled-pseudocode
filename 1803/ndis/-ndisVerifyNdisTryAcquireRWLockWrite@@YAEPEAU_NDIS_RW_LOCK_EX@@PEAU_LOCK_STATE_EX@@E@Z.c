/*
 * XREFs of ?ndisVerifyNdisTryAcquireRWLockWrite@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAU_LOCK_STATE_EX@@E@Z @ 0x1C007A900
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisTryAcquireRWLockWrite @ 0x1C007AB80 (NdisTryAcquireRWLockWrite.c)
 */
