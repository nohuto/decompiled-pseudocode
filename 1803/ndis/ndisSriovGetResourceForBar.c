/*
 * XREFs of ndisSriovGetResourceForBar @ 0x1C00F46B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovGetResourceForBar(void *a1, __int16 a2, __int16 a3, __int64 a4)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x6Du, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1);
  ...
  *(_DWORD *)&v12[48] = 32;
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(0x6Eu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1, SetMiniport);
  return v9;
}
