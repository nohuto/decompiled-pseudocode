/*
 * XREFs of ndisXlateAddPacketPatternToWolPatternOid @ 0x1C00E39F4
 * Callers:
  ...
  *a2 = 0;
  ...
  if ( wistd::operator==<_NDIS_PM_WOL_PATTERN,KFreePool<_NDIS_PM_WOL_PATTERN>>(&v22) )
  {
    if ( (unsigned __int8)byte_1C0099612 >= 4u )
      WPP_SF_q(0x6Du, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1);
    v6 = -1073741670;
    if ( !v5 )
      goto LABEL_34;
    goto LABEL_33;
      ...
      if ( !(unsigned int)NdisConvertNtStatusToNdisStatus(v11 + v12 < v11 ? 0xC0000095 : 0) )
      {
        if ( *(_DWORD *)(a1 + 48) >= v13 )
        {
          ...
          if ( !v6 )
          {
            ...
            if ( (unsigned __int8)byte_1C0099612 >= 4u )
              WPP_SF_q(0x6Eu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1);
            v6 = -1073741670;
            if ( v17 )
