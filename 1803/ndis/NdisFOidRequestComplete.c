/*
 * XREFs of NdisFOidRequestComplete @ 0x1C0007530
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisFOidRequestComplete(NDIS_HANDLE NdisFilterHandle, PNDIS_OID_REQUEST OidRequest, NDIS_STATUS Status)
{
  ...
  if ( v10 )
  {
    *((_QWORD *)NdisReserved + 3) = 0LL;
    ...
    if ( (unsigned __int8)byte_1C0099612 >= 4u )
      WPP_SF_qq(195LL, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, OidRequest->RequestHandle, OidRequest);
    if ( v13 )
    {
    ...
    if ( (unsigned __int8)byte_1C0099612 >= 4u )
      WPP_SF_qq(196LL, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, RequestHandle, 0LL);
    ...
    *((_DWORD *)NdisReserved + 2) = Status;
    if ( KeExpandKernelStackAndCalloutEx(ndisFOidRequestCompleteInternal, NdisFilterHandle, 0x4CCCuLL, 0, 0LL) < 0 )
    {
      ...
      *((_QWORD *)NdisFilterHandle + 19) = KeGetCurrentThread();
      v16 = v15;
      *((_DWORD *)NdisFilterHandle + 40) = 2101206;
