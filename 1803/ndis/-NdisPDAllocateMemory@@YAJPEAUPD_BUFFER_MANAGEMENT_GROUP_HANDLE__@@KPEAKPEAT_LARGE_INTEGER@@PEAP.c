/*
 * XREFs of ?NdisPDAllocateMemory@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@KPEAKPEAT_LARGE_INTEGER@@PEAPEAXPEAPEAUPD_MEMORY_HANDLE__@@@Z @ 0x1C00F7930
 * Callers:
 *     <none>
 * Callees:
        ...
        struct PD_MEMORY_HANDLE__ **a6)
{
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_qdD(0x56u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)a1, *a3, a2);
  *a6 = 0LL;
  if ( a5 )
    *a5 = 0LL;
  if ( a4 )
  ...
  {
    v14 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v12 + 32) + 5528LL) + 72LL);
    ...
    if ( v9 )
    {
      ...
      if ( v13 >= 0 )
      {
        v9[2] = v21;
        *((_DWORD *)v9 + 6) = *a3;
        v20.m_Lock = (KPushLockBase *)qword_1C00996C8;
        *((_DWORD *)v9 + 18) = a2;
