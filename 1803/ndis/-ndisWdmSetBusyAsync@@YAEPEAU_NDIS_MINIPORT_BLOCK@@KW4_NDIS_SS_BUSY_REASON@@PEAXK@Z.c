/*
 * XREFs of ?ndisWdmSetBusyAsync@@YAEPEAU_NDIS_MINIPORT_BLOCK@@KW4_NDIS_SS_BUSY_REASON@@PEAXK@Z @ 0x1C006F840
 * Callers:
  ...
  else
  {
    ...
    if ( v23 && (SelectiveSuspend->Flags.Value & 0xC0) == 0 )
    {
      ...
      if ( (unsigned __int8)byte_1C0099616 >= 4u )
        WPP_SF_qD(0x25u, &WPP_250ba6082b573e143e643b46f787ca55_Traceguids, (__int64)a1, a3);
