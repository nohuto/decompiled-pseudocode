/*
 * XREFs of ndisIfUpdateFilterIfStack @ 0x1C00202DC
 * Callers:
...
void __fastcall ndisIfUpdateFilterIfStack(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(207LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1);
...
LABEL_4:
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(208LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1);
}
