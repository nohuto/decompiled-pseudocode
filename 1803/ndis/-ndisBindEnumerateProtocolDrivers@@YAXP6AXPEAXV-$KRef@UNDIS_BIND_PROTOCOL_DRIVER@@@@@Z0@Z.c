/*
 * XREFs of ?ndisBindEnumerateProtocolDrivers@@YAXP6AXPEAXV?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@@Z0@Z @ 0x1C00BFD18
 * Callers:
 ...
 *     ?ndisVBusNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z @ 0x1C00C6100 (-ndisVBusNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z.c)
 *     ?ndisVBusDetachComplete@@YAXPEAX@Z @ 0x1C00F7150 (-ndisVBusDetachComplete@@YAXPEAX@Z.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  v8.m_State = Unlocked;
  v8.m_Lock = (KPushLockBase *)qword_1C00996D8;
  ...
  for ( i = 0LL; i < *(unsigned int *)(v4 + 44); ++i )
  {
    ...
    v4 = qword_1C00996D8;
    v8.m_State = Shared;
    if ( *(unsigned int *)(qword_1C00996D8 + 44) < i )
      goto LABEL_16;
    if ( i >= *(unsigned int *)(qword_1C00996D8 + 44) )
      __fastfail(5u);
    if ( (*(_QWORD *)(*(_QWORD *)(qword_1C00996D8 + 48) + 8 * i) != 0LL) != (v6 != 0LL) )
LABEL_16:
      i = 0LL;
    if ( v6 )
    {
