/*
 * XREFs of ndisGetPciDeviceCustomProperties @ 0x1C00C8D88
 * Callers:
...
__int64 __fastcall ndisGetPciDeviceCustomProperties(__int64 a1, _DWORD *a2)
{
  ...
  if ( (unsigned __int8)byte_1C009960E >= 4u )
    WPP_SF_q(0x24u, &WPP_664e81fe3e98381b8a075dcdfaa02fe6_Traceguids, a1);
  if ( a2 && a1 )
  {
    memset(a2, 0, 0x34uLL);
    *a2 = 3408512;
...
LABEL_10:
      ...
      IoGetDevicePropertyData(*(PDEVICE_OBJECT *)(a1 + 3856), v8, 0, 0, 4u, Data, &RequiredSize, &Type);
      goto LABEL_10;
    }
    if ( (unsigned __int8)byte_1C009960E < 4u )
      return v6;
    WPP_SF_qD(0x25u, &WPP_664e81fe3e98381b8a075dcdfaa02fe6_Traceguids, a1, DevicePropertyData);
  }
  else
  {
    v6 = -1073741811;
...
LABEL_13:
  if ( (unsigned __int8)byte_1C009960E >= 4u )
    WPP_SF_qD(0x26u, &WPP_664e81fe3e98381b8a075dcdfaa02fe6_Traceguids, a1, v6);
  return v6;
}
