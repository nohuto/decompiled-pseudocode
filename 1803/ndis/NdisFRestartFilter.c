/*
 * XREFs of NdisFRestartFilter @ 0x1C0059480
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisFRestartFilter(NDIS_HANDLE NdisFilterHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x25u, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, (__int64)NdisFilterHandle);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x26u, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, (__int64)NdisFilterHandle, v2);
  return v2;
}
