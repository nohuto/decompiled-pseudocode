/*
 * XREFs of ?NdisTraceLoggingLsoV2ConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C001ED64
 * Callers:
...
void __fastcall NdisTraceLoggingLsoV2ConfigOffloads(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v31 = 1LL;
      v33 = 1LL;
      TlgWrite(&hProvider, &unk_1C00868B9, v2, (LPCGUID)v3, 0xBu, &pData);
    }
  }
}
