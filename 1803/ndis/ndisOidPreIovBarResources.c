/*
 * XREFs of ndisOidPreIovBarResources @ 0x1C00F28F0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovBarResources(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qq(0x4Bu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v3, v1);
  if ( *(_DWORD *)(v1 + 4) != 12 )
    goto LABEL_4;
  v4 = 0;
  *(_DWORD *)(a1 + 40) = 0;
...
LABEL_23:
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x4Cu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v3, v4, v11);
  }
  return v4;
}
