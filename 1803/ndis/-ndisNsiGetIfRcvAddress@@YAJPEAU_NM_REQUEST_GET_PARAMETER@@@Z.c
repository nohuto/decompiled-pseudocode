/*
 * XREFs of ?ndisNsiGetIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C0040190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetIfRcvAddress(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(0x5Eu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1);
...
LABEL_42:
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qD(0x5Fu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1, IfRcvAddressRodInformation);
