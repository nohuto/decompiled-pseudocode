/*
 * XREFs of ndisOidPreIovEnumVPorts @ 0x1C006DE50
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumVPorts(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qq(0x35u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, a1, v1);
  *(_DWORD *)(v2 + 60) = 0;
  v9 = (_DWORD *)v7[4];
  if ( v9[1] == 12 )
  {
...
LABEL_8:
    ...
    if ( ndisIovNicSwitchWithoutIovSupported(v1)
      || (v14 = *(_QWORD *)(v1 + 4640)) != 0 && *(_QWORD *)(v1 + 3584) != v13 && (*(_BYTE *)(v14 + 8) & 3) == 3 )
    {
      v15 = *(_QWORD *)(v2 + 40);
      *(_DWORD *)(v11 + 60) = v13;
      *(_DWORD *)(v7[4] + 64) = v12;
...
LABEL_71:
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(0x36u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v1, *((_DWORD *)v7 + 10));
  return v8;
}
