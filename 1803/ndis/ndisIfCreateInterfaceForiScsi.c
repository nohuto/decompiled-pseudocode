/*
 * XREFs of ndisIfCreateInterfaceForiScsi @ 0x1C00DD388
 * Callers:
        ...
        UINT32 *a5)
{
  ...
  *(_DWORD *)&ValueName.Length = 1703960;
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qq(0xD5u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, KeyHandle, a2);
  *a5 = -1;
  QueryTable.Flags = 16;
  Context = 0LL;
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qq(0xD6u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, KeyHandle, a2);
