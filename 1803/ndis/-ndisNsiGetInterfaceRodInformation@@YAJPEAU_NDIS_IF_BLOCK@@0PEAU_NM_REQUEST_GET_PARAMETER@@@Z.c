/*
 * XREFs of ?ndisNsiGetInterfaceRodInformation@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00AE350
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  {
    WPP_SF_qqq(0x4Eu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1, a2, v5);
    v4 = v24;
    v7 = a2;
    v6 = a1;
  }
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qqqL(0x4Fu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, v6, v7, v5, v3);
  return v3;
}
