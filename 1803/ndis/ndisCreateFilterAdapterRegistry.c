/*
 * XREFs of ndisCreateFilterAdapterRegistry @ 0x1C00C8264
 * Callers:
...
__int64 __fastcall ndisCreateFilterAdapterRegistry(PCUNICODE_STRING Source, __int64 a2)
{
  ...
  *(_DWORD *)&Destination.Length = 0;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0x56u, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, Source, a2);
  v5 = *(const GUID **)(a2 + 16);
  if ( v5 )
  {
...
LABEL_11:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    ...
    WPP_SF_qqd(0x57u, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, Source, a2, Environment);
  }
  return v2;
}
