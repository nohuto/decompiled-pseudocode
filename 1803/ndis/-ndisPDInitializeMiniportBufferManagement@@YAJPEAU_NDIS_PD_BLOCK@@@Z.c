/*
 * XREFs of ?ndisPDInitializeMiniportBufferManagement@@YAJPEAU_NDIS_PD_BLOCK@@@Z @ 0x1C00FA36C
 * Callers:
 ...
 *     ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x1C00FA33C (-ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z.c)
 *     ?ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z @ 0x1C00FAA74 (-ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z.c)
 */
...
__int64 __fastcall ndisPDInitializeMiniportBufferManagement(struct _NDIS_PD_BLOCK *a1)
{
  ...
  *((_QWORD *)&v22 + 1) = Miniport;
  if ( a1->PDDomainId )
  {
    v23.m_Lock = (KPushLockBase *)qword_1C00996C8;
...
LABEL_31:
      ...
      if ( v16 >= 0 )
      {
        ...
        *((_QWORD *)v4 + 6) = p_PDBlockListLink;
        if ( (unsigned __int8)byte_1C0099624 >= 4u )
          WPP_SF_qqd(0xFu, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, a1->Miniport, v4, *((_DWORD *)v4 + 6));
        KLockHolder::~KLockHolder(&v23);
        v5 = 0;
      }
      else
  ...
  *((_QWORD *)v4 + 12) = PDBMFreeCommonBuffer;
  ...
  {
    if ( (unsigned __int8)byte_1C0099624 >= 2u )
      WPP_SF_qD(0xDu, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)a1->Miniport, v10);
    goto LABEL_40;
  }
  v23.m_Lock = (KPushLockBase *)qword_1C00996C8;
  v23.m_State = Unlocked;
  ...
  if ( !PDDomainId )
  {
    ...
    v14 = qword_1C00996C8 + 8240;
    v15 = *(__int64 ***)(qword_1C00996C8 + 8248);
    if ( *v15 != (__int64 *)(qword_1C00996C8 + 8240) )
      __fastfail(3u);
    goto LABEL_29;
  }
