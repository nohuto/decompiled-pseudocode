/*
 * XREFs of ndisBuildDeviceAcl @ 0x1C00B4BE8
 * Callers:
...
__int64 __fastcall ndisBuildDeviceAcl(ACL **a1, char a2)
{
  ...
  *(_WORD *)&IdentifierAuthority.Value[4] = 1280;
  ...
  if ( (a2 & 0x10) != 0 )
  {
    v15 = RtlLengthSid(&unk_1C0081378);
    v16 = RtlLengthSid(&unk_1C0081358) + v15;
    v17 = RtlLengthSid(&unk_1C0081338) + v16;
    v6 += v17 + 32 + RtlLengthSid(&unk_1C0081318);
  }
  v23 = a2 & 4;
  if ( (a2 & 4) != 0 )
  {
...
LABEL_14:
    v10 = a2 & 0x80;
    if ( v10 )
      v6 += RtlLengthSid(&unk_1C00812F8) + 8;
    ...
    if ( v11 )
    {
      ...
      else
      {
        ...
        if ( v22 )
        {
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0081318);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0081338);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0081358);
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C0081378);
        }
        if ( v23 )
        ...
        if ( v10 )
          RtlAddAccessAllowedAce(v12, 2u, AccessMask, &unk_1C00812F8);
        *v26 = v12;
      }
      goto LABEL_33;
    }
