/*
 * XREFs of ndisOidPreIovWriteVFConfigBlock @ 0x1C00F4300
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovWriteVFConfigBlock(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qq(0x41u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v3, v1);
  v4 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
  {
LABEL_4:
...
LABEL_15:
  ...
  {
    v10 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x42u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v3, v4, v10);
  }
  return v4;
}
