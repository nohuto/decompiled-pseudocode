/*
 * XREFs of NdisRegisterDeviceEx @ 0x1C0022B10
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisDeviceHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(107LL, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, NdisHandle);
  *pDeviceObject = 0LL;
...
LABEL_17:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(108LL, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, NdisHandle, (unsigned int)SymbolicLink);
  return SymbolicLink;
}
