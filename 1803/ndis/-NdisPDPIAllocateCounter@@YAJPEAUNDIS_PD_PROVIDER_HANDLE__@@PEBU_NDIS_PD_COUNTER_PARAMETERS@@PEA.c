/*
 * XREFs of ?NdisPDPIAllocateCounter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_COUNTER_PARAMETERS@@PEAPEAUNDIS_PD_COUNTER_HANDLE__@@@Z @ 0x1C00F8890
 * Callers:
 *     <none>
 * Callees:
...
LABEL_27:
  ...
  {
    LODWORD(v13) = v8;
    WPP_SF_qqd(0x2Bu, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, a1, *a3, v13);
  }
