/*
 * XREFs of PdcPortOpen @ 0x1C00FFD98
 * Callers:
        ...
        struct _EX_RUNDOWN_REF **a8)
{
  ...
  _QWORD v15[100]; // [rsp+C8h] [rbp-40h] BYREF

  *a8 = 0LL;
  PoolWithTag = (struct _EX_RUNDOWN_REF *)ExAllocatePoolWithTag(PagedPool, 0x6D8uLL, 0x50636450u);
  v11 = PoolWithTag;
  if ( PoolWithTag )
  {
    ...
    InputBuffer[2] = v11;
    v12 = ZwPowerInformation(PdcInvocation, InputBuffer, 0x90u, 0LL, 0);
    if ( v12 >= 0 )
    {
      *a8 = v11;
      v12 = 0;
