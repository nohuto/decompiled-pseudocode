/*
 * XREFs of ndisFNetPnPEventInternal @ 0x1C00B0F20
 * Callers:
...
void __fastcall ndisFNetPnPEventInternal(_QWORD *Parameter)
{
  ...
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qqd(0x3Bu, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, Miniport, v1, *(_DWORD *)(v3 + 8));
  v6 = *(_DWORD *)(v3 + 8);
  if ( v6 != 15 )
  {
    if ( v6 <= 17 || v6 > 21 )
...
LABEL_7:
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qq(0x3Cu, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, Miniport, v1);
  *(_DWORD *)Parameter = v4;
}
