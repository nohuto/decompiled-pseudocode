/*
 * XREFs of ndisMIsLoopbackNetBuffer @ 0x1C005604C
 * Callers:
        ...
        unsigned __int8 *LockStatea)
{
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qqq(0x3Eu, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, LockState, a2, a3);
  v10 = *(_QWORD *)(a2 + 8);
  if ( (*(_BYTE *)(v10 + 10) & 5) != 0 )
    v11 = *(char **)(v10 + 24);
  else
...
LABEL_38:
      ...
      *v12 = v5;
      ...
      {
        LODWORD(v18) = v5;
        WPP_SF_qqd(0x3Fu, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, LockState, a4, v18);
      }
      return;
    }
