/*
 * XREFs of McTemplateK0qxzzxxxxxx @ 0x1C007560C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qxzzxxxxxx(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a13)
{
  ...
  bool v20; // zf
  _EVENT_DATA_DESCRIPTOR v22; // [rsp+30h] [rbp-B1h] BYREF
  ...
  v42 = 8LL;
  v44 = 8LL;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &MiniportCsTraffic, a3, 0xBu, &v22);
}
