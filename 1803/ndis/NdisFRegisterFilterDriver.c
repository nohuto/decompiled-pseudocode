/*
 * XREFs of NdisFRegisterFilterDriver @ 0x1C00162A0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v13 == (OidRequestHandler == 0LL) )
    {
      if ( !OidRequestHandler && FilterDriverCharacteristics->CancelOidRequestHandler )
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
          WPP_SF_q(13LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, DriverObject);
      ...
      if ( MajorNdisVersion > 6u || MajorNdisVersion == 6 && FilterDriverCharacteristics->MinorNdisVersion )
      {
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(14LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, DriverObject);
          FilterDriverRegistry = -1073676283;
          if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
            McTemplateK0zq(
              v13,
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(15LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, DriverObject);
          FilterDriverRegistry = -1073676283;
          if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
            McTemplateK0zq(
              v13,
      ...
      {
        if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
          WPP_SF_q(16LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, DriverObject);
        FilterDriverRegistry = -1073676283;
        if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
          McTemplateK0zq(
            v13,
      ...
      else
      {
        ...
        {
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_d(17LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, v16);
            ...
            else
            {
              ...
              if ( *p_Bind )
              {
                *NdisFilterDriverHandle = v4;
                ...
                if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
                  WPP_SF_d(21LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, v37);
...
LABEL_97:
              ...
              if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
                WPP_SF__guid_(20LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, &Guid);
            }
...
LABEL_98:
          ...
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
            WPP_SF_q(18LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, DriverObject);
          FilterDriverRegistry = -1073741811;
          if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
            McTemplateK0zq(
              v18,
    ...
    {
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
        WPP_SF_q(12LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, DriverObject);
      FilterDriverRegistry = -1073676283;
      if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
        McTemplateK0zq(
          v13,
  ...
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_q(11LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, DriverObject);
    FilterDriverRegistry = -1073676283;
    if ( (Microsoft_Windows_NDISEnableBits & 0x40000) != 0 )
    {
      McTemplateK0zq(
...
LABEL_36:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_d(22LL, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, FilterDriverRegistry);
