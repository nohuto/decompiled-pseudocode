/*
 * XREFs of ?ndisNicQuietRequestComplete@@YAXPEAU_DEVICE_OBJECT@@ET_POWER_STATE@@PEAXPEAU_IO_STATUS_BLOCK@@@Z @ 0x1C00744F0
 * Callers:
        ...
        struct _IO_STATUS_BLOCK *a5)
{
  ...
  if ( Status >= 0 )
  {
    if ( (unsigned __int8)byte_1C0099610 >= 4u )
      WPP_SF_qZ(0x28u, &WPP_bf529ec5834d316bdbb03bafc086ab40_Traceguids, (__int64)a4, &a4->pAdapterInstanceName->Length);
  }
  else
  {
    v10 = a4->AoAc;
    ...
    if ( (unsigned __int8)byte_1C0099615 >= 2u )
      WPP_SF_dq(0x27u, &WPP_bf529ec5834d316bdbb03bafc086ab40_Traceguids, Status, a4);
  }
}
