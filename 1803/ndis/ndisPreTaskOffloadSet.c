/*
 * XREFs of ndisPreTaskOffloadSet @ 0x1C00DF200
 * Callers:
...
unsigned __int8 __fastcall ndisPreTaskOffloadSet(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0xE5u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v3);
...
LABEL_19:
  ...
  {
    v14 = v12;
    WPP_SF_qdD(0xE6u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, (__int64)v1, *v5, v14);
  }
  return v12;
}
