/*
 * XREFs of ndisPplAllocate @ 0x1C0004694
 * Callers:
 *     NdisAllocateNetBuffer @ 0x1C00045B0 (NdisAllocateNetBuffer.c)
 * Callees:
 *     ?ndisAllocateFromLookasideList@@YAPEAXPEAU_NDIS_NPAGED_LOOKASIDE_LIST@@@Z @ 0x1C00047C0 (-ndisAllocateFromLookasideList@@YAPEAXPEAU_NDIS_NPAGED_LOOKASIDE_LIST@@@Z.c)
