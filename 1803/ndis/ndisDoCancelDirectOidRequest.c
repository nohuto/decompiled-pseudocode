/*
 * XREFs of ndisDoCancelDirectOidRequest @ 0x1C0044800
 * Callers:
  ...
  if ( v3 )
  {
    while ( 1 )
    {
      ...
      if ( v8 )
      {
        ...
        {
          WPP_SF_q(0x88u, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, v5);
          v8 = *(void (__fastcall **)(_QWORD, __int64))(v7 + 312);
        }
        v8(*(_QWORD *)(v5 + 24), a3);
        if ( (unsigned __int8)byte_1C0099612 >= 4u )
          WPP_SF_q(0x89u, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, v5);
LABEL_15:
        if ( a1 )
        {
          v15 = *(_BYTE *)(a1 + 32);
            ...
            && (!*(_QWORD *)(a1 + 4480) || (unsigned __int8)ndisSetBusyAsync(a1, 1, 51, a3, 0)) )
          {
            v16 = *(_QWORD *)(a1 + 3784);
            if ( (unsigned __int8)byte_1C0099612 >= 4u )
              WPP_SF_q(0xF9u, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1);
            (*(void (__fastcall **)(_QWORD, __int64))(v16 + 256))(*(_QWORD *)(a1 + 24), a3);
            if ( (unsigned __int8)byte_1C0099612 >= 4u )
              WPP_SF_q(0xFAu, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1);
            if ( *(_QWORD *)(a1 + 4480) )
