/*
 * XREFs of ndisSetAddWakeUpPattern @ 0x1C00E2C08
 * Callers:
...
__int64 __fastcall ndisSetAddWakeUpPattern(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  {
    WPP_SF_qq(0x1Au, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2);
    v4 = a2 + 72;
  }
  *(_QWORD *)(a1 + 192) = 0LL;
  v8 = 24;
...
LABEL_10:
    *(_DWORD *)(a2 + 56) = v8;
    ...
    if ( (unsigned __int8)byte_1C0099612 >= 2u )
      WPP_SF_(0x1Cu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids);
    goto LABEL_43;
  }
...
LABEL_23:
    ...
    if ( v24 > 0xFFFF && ndisPMPatternIdExist(v16, v24) )
    {
      if ( (unsigned __int8)byte_1C0099615 >= 2u )
        WPP_SF_d(0x1Bu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v25);
    }
    else
    {
...
LABEL_43:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qdD(0x1Du, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, (unsigned __int8)*a3, v12);
  return v12;
}
