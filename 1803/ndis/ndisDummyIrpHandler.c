/*
 * XREFs of ndisDummyIrpHandler @ 0x1C00AC160
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisDummyIrpHandler(__int64 a1, _IRP *a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x1Cu, &WPP_5cfddc9aaef33c7b7f0ecdd8ea162ffb_Traceguids, a1, a2);
...
LABEL_6:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x1Du, &WPP_5cfddc9aaef33c7b7f0ecdd8ea162ffb_Traceguids, a1, a2);
  return v6;
}
