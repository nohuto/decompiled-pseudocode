/*
 * XREFs of ndisOidPreIovCreateNicSwitch @ 0x1C00F2B30
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovCreateNicSwitch(__int64 *a1)
{
  ...
  {
    WPP_SF_qqqq(0xCu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v1, a1[3], a1[1], v3);
    v5 = *a1;
  }
  if ( !v5 )
    goto LABEL_4;
  ...
  if ( *(_DWORD *)(v3 + 48) >= 0x224u )
  {
    if ( *(_DWORD *)(v3 + 52) >= 0x224u )
    {
      ...
      if ( *(_BYTE *)(v10 + 1)
        && !*(_DWORD *)(v10 + 12)
        && *(_DWORD *)(v10 + 8) == 1
        && *(_DWORD *)(v10 + 532) <= *(_DWORD *)(*(_QWORD *)(v1 + 3584) + 48LL) )
      {
...
LABEL_9:
  ...
  {
    LODWORD(v16) = v4;
    WPP_SF_qqqDD(0xDu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, *a1, a1[3], a1[1], v16, *((_DWORD *)a1 + 10));
  }
  return v4;
}
