/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C00FF22C
 * Callers:
 ...
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00CB83C (SeUtilSecurityInfoFromSecurityDescriptor.c)
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C00FF86C (CmRegUtilUcValueGetFullBuffer.c)
