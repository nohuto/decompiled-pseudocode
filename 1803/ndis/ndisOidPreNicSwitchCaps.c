/*
 * XREFs of ndisOidPreNicSwitchCaps @ 0x1C00DBEE0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreNicSwitchCaps(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqq(0x20u, &WPP_968189b415313035a5e13c3867538638_Traceguids, v1, v5, v3);
  *((_DWORD *)a1 + 10) = 0;
  v7 = *(_DWORD *)(v3 + 48);
  if ( v7 >= 0x20 )
  {
    ...
    if ( !v1 )
      goto LABEL_18;
    v4 = 1;
    v8 = *(_DWORD *)(v3 + 32) == 66094 ? *(_QWORD *)(v1 + 3576) : *(_QWORD *)(v1 + 3584);
    if ( !v8 )
    {
LABEL_6:
      v4 = 1;
...
LABEL_18:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
  {
    v14 = v2;
    LODWORD(v13) = v4;
    WPP_SF_qqDD(0x21u, &WPP_968189b415313035a5e13c3867538638_Traceguids, v1, v5, v13, v14);
  }
  return v4;
}
