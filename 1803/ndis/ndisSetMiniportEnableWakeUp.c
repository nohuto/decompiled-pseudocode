/*
 * XREFs of ndisSetMiniportEnableWakeUp @ 0x1C00E3150
 * Callers:
...
__int64 __fastcall ndisSetMiniportEnableWakeUp(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x12u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2);
  v6 = 0;
  *a3 = 1;
  if ( *(_DWORD *)(a2 + 48) >= 4u )
  {
  ...
  {
    v10 = v6;
    WPP_SF_qqd(0x13u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2, v10);
  }
  return v6;
}
