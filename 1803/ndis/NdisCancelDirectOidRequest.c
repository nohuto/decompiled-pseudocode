/*
 * XREFs of NdisCancelDirectOidRequest @ 0x1C00435A0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisCancelDirectOidRequest(NDIS_HANDLE NdisBindingHandle, PVOID RequestId)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0xC9u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, NdisBindingHandle, RequestId);
  v7 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v2 + 96));
  *(_QWORD *)(v2 + 520) = KeGetCurrentThread();
  v8 = *(_QWORD *)(v2 + 2664);
  *(_DWORD *)(v2 + 1856) = 2307470;
  if ( *(_BYTE *)v8 == 5 )
  {
    v3 = v8;
  ...
  *(_DWORD *)(v2 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0xCAu, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, NdisBindingHandle, RequestId);
}
