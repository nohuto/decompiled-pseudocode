/*
 * XREFs of NdisMWriteConfigBlock @ 0x1C00F1CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMWriteConfigBlock(_QWORD *a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x7Du, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1);
  ...
  if ( v8 && (v9 = a1[612]) != 0 && (v10 = a1[580]) != 0 && (*(_BYTE *)(v10 + 8) & 5) == 5 )
    ...
    v11 = -1073741637;
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x7Eu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1);
  return v11;
}
