/*
 * XREFs of ndisImmediateReadWritePort @ 0x1C00E63D0
 * Callers:
 *     NdisImmediateReadPortUchar @ 0x1C00E5F00 (NdisImmediateReadPortUchar.c)
 *     NdisImmediateReadPortUlong @ 0x1C00E5F20 (NdisImmediateReadPortUlong.c)
 *     NdisImmediateReadPortUshort @ 0x1C00E5F40 (NdisImmediateReadPortUshort.c)
 *     NdisImmediateWritePortUchar @ 0x1C00E5F80 (NdisImmediateWritePortUchar.c)
 *     NdisImmediateWritePortUlong @ 0x1C00E5FB0 (NdisImmediateWritePortUlong.c)
 *     NdisImmediateWritePortUshort @ 0x1C00E5FE0 (NdisImmediateWritePortUshort.c)
 * Callees:
