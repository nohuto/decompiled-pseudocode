/*
 * XREFs of ndisQuerySupportedGuidToOidList @ 0x1C00C3A64
 * Callers:
 ...
 *     ndisWmiMapOids @ 0x1C00C3EC0 (ndisWmiMapOids.c)
...
__int64 __fastcall ndisQuerySupportedGuidToOidList(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099619 >= 4u )
    WPP_SF_q(0x12u, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, v1);
  memset(v51, 0, sizeof(v51));
  *(_DWORD *)&v51[88] |= 8u;
  ...
  *(_DWORD *)&v51[48] = 0;
  ...
  {
    if ( (unsigned __int8)byte_1C0099619 >= 4u )
      WPP_SF_q(0x13u, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, v1);
  }
  else
  {
    v8 = v47 >> 2;
...
LABEL_12:
    ...
    if ( PoolWithTag )
    {
      ...
      do
      {
        ...
        {
          v41 = 28LL * (unsigned __int16)v25;
          *(_OWORD *)&v2[v41] = *(_OWORD *)v24;
          *(_QWORD *)&v2[v41 + 16] = *((_QWORD *)v24 + 2);
          *(_DWORD *)&v2[v41 + 24] = v24[6];
          if ( (*(_DWORD *)(v1 + 120) & 0x20000) != 0 )
            *(_DWORD *)&v2[v41 + 24] |= 0x10000000u;
          LOWORD(v25) = v25 + 1;
        }
        v24 += 7;
        --v26;
      ...
      *(_WORD *)(v1 + 1386) = v18;
      ...
      {
        v42 = v45;
        v39 = &v2[28 * (unsigned __int16)(v34 + 38)];
        memmove(v39, v23, 28LL * (unsigned __int16)v45);
        *(_WORD *)(v1 + 1388) = v42;
      }
      else
      {
  ...
  if ( (unsigned __int8)byte_1C0099619 >= 4u )
    WPP_SF_qD(0x14u, &WPP_52f7bea8bd1d3ca14d06195c90839a85_Traceguids, v1, v7);
  return v7;
}
