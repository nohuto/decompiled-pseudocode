/*
 * XREFs of ndisIfCreateFilterInterface @ 0x1C001CE90
 * Callers:
...
__int64 __fastcall ndisIfCreateFilterInterface(struct _NDIS_FILTER_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(201LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1);
...
LABEL_10:
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qD(202LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1, v5);
  return v5;
}
