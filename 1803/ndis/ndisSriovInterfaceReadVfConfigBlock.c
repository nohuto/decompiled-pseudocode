/*
 * XREFs of ndisSriovInterfaceReadVfConfigBlock @ 0x1C00F4D30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVfConfigBlock(void *a1, __int16 a2, int a3, void *a4, unsigned int Size)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x5Du, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(0x5Eu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
