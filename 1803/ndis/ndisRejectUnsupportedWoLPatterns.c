/*
 * XREFs of ndisRejectUnsupportedWoLPatterns @ 0x1C00E2840
 * Callers:
    ...
    if ( !ndisIsWoLPacketTypeSupported(*(_DWORD *)(i + 60), (__int64)MiniportAdapterHandle) )
    {
      ...
      if ( v5 == v4 )
      {
        if ( (unsigned __int8)byte_1C0099615 >= 2u )
          WPP_SF_d(0x7Eu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v5);
      }
      else
      {
        memset(v11, 0, sizeof(v11));
        ...
        *(_DWORD *)&v11[48] = 4;
        ...
        if ( (unsigned __int8)byte_1C0099615 >= 2u )
          WPP_SF_d(0x7Fu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, SetMiniport);
      }
      return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 3944), 0, 1, 0);
    }
  }
