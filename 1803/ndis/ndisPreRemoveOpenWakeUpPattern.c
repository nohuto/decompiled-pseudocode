/*
 * XREFs of ndisPreRemoveOpenWakeUpPattern @ 0x1C00E21A8
 * Callers:
...
unsigned __int8 __fastcall ndisPreRemoveOpenWakeUpPattern(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x21u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2);
...
LABEL_12:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqd(0x22u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2, v4);
  return v4;
}
