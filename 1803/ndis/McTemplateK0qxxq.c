/*
 * XREFs of McTemplateK0qxxq @ 0x1C007556C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qxxq(__int64 a1, __int64 a2, const GUID *a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &MiniportCsStats, a3, 5u, &v8);
}
