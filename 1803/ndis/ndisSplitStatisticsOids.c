/*
 * XREFs of ndisSplitStatisticsOids @ 0x1C00C417C
 * Callers:
...
__int64 __fastcall ndisSplitStatisticsOids(__int64 a1, int *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(0x15u, &WPP_5cfddc9aaef33c7b7f0ecdd8ea162ffb_Traceguids, v3);
  ...
  *(_QWORD *)(a1 + 24) = PoolWithTag;
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x16u, &WPP_5cfddc9aaef33c7b7f0ecdd8ea162ffb_Traceguids, v3, v7);
  return v7;
}
