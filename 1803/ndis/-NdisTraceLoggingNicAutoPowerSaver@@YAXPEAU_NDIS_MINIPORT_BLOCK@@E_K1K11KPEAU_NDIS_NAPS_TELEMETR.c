/*
 * XREFs of ?NdisTraceLoggingNicAutoPowerSaver@@YAXPEAU_NDIS_MINIPORT_BLOCK@@E_K1K11KPEAU_NDIS_NAPS_TELEMETRY_REASON_DATA@@KPEAU_NDIS_NAPS_TELEMETRY_OID_DATA@@@Z @ 0x1C0078FDC
 * Callers:
 *     ndisTraceNicAutoPowerSaver @ 0x1C0072308 (ndisTraceNicAutoPowerSaver.c)
 * Callees:
 *     _TlgWrite @ 0x1C0012C84 (_TlgWrite.c)
 *     _TlgCreateWsz @ 0x1C001422C (_TlgCreateWsz.c)
 *     _TlgKeywordOn @ 0x1C001EF44 (_TlgKeywordOn.c)
 *     __security_check_cookie @ 0x1C0025590 (__security_check_cookie.c)
 *     ?ndisConvertInterruptTimeToLocalTime@@YAX_KPEAT_LARGE_INTEGER@@@Z @ 0x1C007A4A8 (-ndisConvertInterruptTimeToLocalTime@@YAX_KPEAT_LARGE_INTEGER@@@Z.c)
 */
        ...
        struct _NDIS_NAPS_TELEMETRY_OID_DATA *a11)
{
    ...
    && a3 >= 0x927C0 )
  {
    ...
    else
    {
      ...
      v13 = IfOutUnicastPackets->TotalCsActiveTime / 0x2710;
    }
    v14.QuadPart = 0LL;
    v55 = v13;
    v52.QuadPart = 0LL;
    if ( !a2 )
    {
      ndisConvertInterruptTimeToLocalTime((unsigned __int64)IfOutUnicastPackets, &v52);
      v14 = v52;
    }
    v54 = v14;
    if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
    {
      ...
      v171 = 4LL;
      v173 = 8LL;
      TlgWrite(&hProvider, &unk_1C0085322, v17, v18, 0x39u, &pData);
    }
  }
}
