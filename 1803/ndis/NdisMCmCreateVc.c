/*
 * XREFs of NdisMCmCreateVc @ 0x1C0113850
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisVcHandle)
{
  ...
  *NdisVcHandle = 0LL;
  ...
  v13 = *((_QWORD *)MiniportAdapterHandle + 473);
  ...
  v12[13].Blink = *(_LIST_ENTRY **)(*((_QWORD *)MiniportAdapterHandle + 473) + 512LL);
  v12[14].Flink = *(_LIST_ENTRY **)(*((_QWORD *)MiniportAdapterHandle + 473) + 520LL);
  v12[14].Blink = *(_LIST_ENTRY **)(*((_QWORD *)MiniportAdapterHandle + 473) + 528LL);
  ...
  p_Blink = &v12[1].Blink;
  v20 = (*(__int64 (__fastcall **)(_QWORD, _LIST_ENTRY *, _LIST_ENTRY **))(*((_QWORD *)NdisAfHandle + 46) + 1040LL))(
  ...
  else
  {
    ...
    Flink = (unsigned __int8)v12[12].Flink[2].Flink;
    if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)NdisAfHandle + 46) + 24LL) + 56LL) < 6u )
    {
      if ( Flink < 6u )
      {
        if ( (unsigned __int8)byte_1C009961A >= 4u )
          WPP_SF_(0x1Fu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
        v12[15].Blink = 0LL;
        v12[16].Flink = 0LL;
      ...
      {
        if ( (unsigned __int8)byte_1C009961A >= 4u )
          WPP_SF_(0x1Eu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
        v12[15].Blink = 0LL;
        v12[17].Flink = 0LL;
        v12[17].Blink = 0LL;
        ...
        v23 = (_LIST_ENTRY *)ndisMCoIndicateReceiveNetBufferListsToNdisPacket;
      }
    }
    else
    {
      ...
      {
        if ( (unsigned __int8)byte_1C009961A >= 4u )
          WPP_SF_(0x1Du, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
        v23 = 0LL;
        v22 = (_LIST_ENTRY *)ndisMCoIndicateReceiveNdisPacketToNetBufferLists;
        v25 = 0LL;
        v24 = (_LIST_ENTRY *)ndisMCoSendCompleteToNetBufferLists;
        v26 = (_LIST_ENTRY *)ndisCoSendNetBufferListsToNdisPacket;
      }
      else
      {
        if ( (unsigned __int8)byte_1C009961A >= 4u )
          WPP_SF_(0x1Cu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
        v22 = 0LL;
        v23 = (_LIST_ENTRY *)ndisMCoIndicateReceiveNetBufferListsToNetBufferLists;
        v24 = 0LL;
        v25 = (_LIST_ENTRY *)ndisMCoSendNetBufferListsCompleteToNetBufferLists;
        v26 = (_LIST_ENTRY *)ndisCoSendNetBufferListsToNetBufferLists;
      }
      v12[15].Blink = v26;
      v12[16].Flink = v25;
      v12[16].Blink = 0LL;
