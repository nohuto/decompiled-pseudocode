/*
 * XREFs of ndisOidPrePMWOLPatternList @ 0x1C00E1870
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMWOLPatternList(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    WPP_SF_qqq(0x5Au, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v4, v6, v8);
    v9 = *(_QWORD *)(a1 + 24);
  }
  LOBYTE(a4) = 6;
  if ( v9
...
LABEL_31:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqqL(0x5Bu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v4, v6, v8, *(_DWORD *)(a1 + 40));
  return v7;
}
