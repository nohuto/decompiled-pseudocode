/*
 * XREFs of ?ndisCopyPeriodicReceiveNbl@@YAPEAU_NET_BUFFER_LIST@@PEAU_NDIS_MINIPORT_BLOCK@@KPEAU1@@Z @ 0x1C0068A88
 * Callers:
        ...
        struct _NET_BUFFER_LIST *a3)
{
  ...
  if ( (unsigned int)v5 <= 0x64 )
  {
    v7 = &Lookaside;
LABEL_5:
    PoolWithTagPriority = (struct _MDL *)ExAllocateFromNPagedLookasideList(v7);
    goto LABEL_8;
  }
...
LABEL_8:
  ...
  NetBufferAndNetBufferList = NdisAllocateNetBufferAndNetBufferList(PoolHandle, 0, 0, v9, 0, v5);
...
LABEL_38:
    ...
    if ( v7 )
      ExFreeToNPagedLookasideList(v7, v9);
    else
  ...
  NetBufferAndNetBufferList->MiniportReserved[1] = v7;
