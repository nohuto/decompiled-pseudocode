/*
 * XREFs of ndisMInvokeRestart @ 0x1C00B7114
 * Callers:
...
__int64 __fastcall ndisMInvokeRestart(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_q(0xE3u, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1);
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64))(v2 + 168))(*(_QWORD *)(a1 + 24), a2);
  v6 = v5;
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qD(0xE4u, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1, v5);
  return v6;
}
