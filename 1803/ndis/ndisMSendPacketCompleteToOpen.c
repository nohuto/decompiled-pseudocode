/*
 * XREFs of ndisMSendPacketCompleteToOpen @ 0x1C0057060
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketCompleteToOpen(__int64 a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qqd(0x14u, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2, a3);
  NDIS_STACK_RESERVED_FROM_PACKET(a2, &v10);
  --*(_DWORD *)&a2[-1].ProtocolReserved[4];
  *((_DWORD *)v10 + 2) = 0;
  if ( (dword_1C009AF04 & 2) != 0 )
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qq(0x15u, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2);
}
