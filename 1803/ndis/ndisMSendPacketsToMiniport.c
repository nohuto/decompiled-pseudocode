/*
 * XREFs of ndisMSendPacketsToMiniport @ 0x1C0057580
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsToMiniport(struct _NDIS_MINIPORT_BLOCK *a1, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qqd(0xCu, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2, a3);
  v18 = 0;
    ...
    do
    {
      ...
      *(_QWORD *)(v10 + 72) = Blink;
      ...
      if ( v4 )
      {
        ...
        Flink = v11->Flink;
        v21 = *(_QWORD *)v19;
        if ( Flink->Blink != v11 || (v15 = *(_LIST_ENTRY ***)(v10 + 72), *v15 != v11) )
          __fastfail(3u);
        *v15 = Flink;
  ...
  {
    LODWORD(v17) = a3;
    WPP_SF_qqd(0xDu, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2, v17);
  }
}
