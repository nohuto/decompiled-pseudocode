/*
 * XREFs of NdisCoDeleteVc @ 0x1C0112C10
 * Callers:
 *     NdisMCmDeleteVc @ 0x1C0113D70 (NdisMCmDeleteVc.c)
 * Callees:
    ...
    *((_DWORD *)NdisVcHandle + 1) |= 0x80000000;
    ...
    if ( *((_QWORD *)NdisVcHandle + 38) )
    {
        ...
        if ( v6 < 0 )
        {
          ...
          if ( (Microsoft_Windows_NDISEnableBits & 0x1000) != 0 )
            McTemplateK0qqq(
              ...
              (const GUID *)(*((_QWORD *)NdisVcHandle + 24) + 4032LL),
              v8,
              0x80Fu,
              0);
      ...
      if ( v9[1] != (char *)NdisVcHandle + 320
        || (v10 = (NDIS_HANDLE *)*((_QWORD *)NdisVcHandle + 41), *v10 != (char *)NdisVcHandle + 320) )
      {
        __fastfail(3u);
      }
      *v10 = v9;
    ...
    if ( v13[1] != (char *)NdisVcHandle + 32
      || (v14 = (NDIS_HANDLE *)*((_QWORD *)NdisVcHandle + 5), *v14 != (char *)NdisVcHandle + 32) )
    {
      __fastfail(3u);
    }
    *v14 = v13;
    ...
    if ( v15 )
    {
      ...
      if ( v16[1] != (char *)NdisVcHandle + 152
        || (v17 = (NDIS_HANDLE *)*((_QWORD *)NdisVcHandle + 20), *v17 != (char *)NdisVcHandle + 152) )
      {
        __fastfail(3u);
      }
      *v17 = v16;
