/*
 * XREFs of ndisOidPreRemoveWakeUpPattern @ 0x1C00E1A50
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRemoveWakeUpPattern(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x1Fu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v4, v1);
    v5 = *(_QWORD *)(a1 + 24);
  }
...
LABEL_21:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x20u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, *(_QWORD *)a1, *(_DWORD *)(a1 + 40));
  return v8;
}
