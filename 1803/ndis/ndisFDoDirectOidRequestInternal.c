/*
 * XREFs of ndisFDoDirectOidRequestInternal @ 0x1C0044CE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisFDoDirectOidRequestInternal(_QWORD *Parameter)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x34u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v3);
  v4 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(v1 + 144));
  v5 = *(_DWORD *)(v1 + 856);
  *(_QWORD *)(v1 + 152) = KeGetCurrentThread();
  *(_DWORD *)(v1 + 160) = 2297829;
  if ( v5 >= 0x4E20 )
  {
    if ( (unsigned __int8)byte_1C0099612 >= 2u )
    {
      v11 = v5;
      v10 = 20000;
      WPP_SF_qqDD(0x35u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v3, v10, v11);
    }
    v6 = -1073741670;
    v7 = v4;
LABEL_11:
...
LABEL_13:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x36u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v3);
  *(_DWORD *)Parameter = v6;
}
