/*
 * XREFs of ?NdisPDStartEC@@YAJPEAUPD_CLIENT_HANDLE__@@PEAPEAUPD_EC_HANDLE__@@@Z @ 0x1C00F9920
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisPDStartEC(struct PD_CLIENT_HANDLE__ *a1, struct PD_EC_HANDLE__ **a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_qq(0x5Au, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, a1, KeGetCurrentThread());
  *a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    *((_DWORD *)v5 + 8) = CurrentThreadId;
    ...
    else
    {
      ...
      v11.m_Lock = (KPushLockBase *)qword_1C00996C8;
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_qqqL(0x5Bu, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, a1, KeGetCurrentThread(), *a2, ECInstanceName);
