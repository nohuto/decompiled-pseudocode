/*
 * XREFs of ?NdisTraceLoggingVxLanHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C007A35C
 * Callers:
...
void __fastcall NdisTraceLoggingVxLanHardwareOffloads(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v27 = 2LL;
      v29 = 1LL;
      TlgWrite(&hProvider, &unk_1C008523C, (LPCGUID)1, (LPCGUID)v2, 0xAu, &pData);
    }
  }
}
