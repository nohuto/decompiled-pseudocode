/*
 * XREFs of ndisSriovInterfaceWriteVfConfigBlock @ 0x1C00F52B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceWriteVfConfigBlock(void *a1, __int16 a2, int a3, const void *a4, size_t Size)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x5Fu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(0x60u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
