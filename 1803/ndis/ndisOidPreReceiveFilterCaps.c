/*
 * XREFs of ndisOidPreReceiveFilterCaps @ 0x1C00DC390
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreReceiveFilterCaps(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqq(0xAu, &WPP_968189b415313035a5e13c3867538638_Traceguids, v1, v5, v3);
...
LABEL_22:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
  {
    v15 = v2;
    LODWORD(v14) = v4;
    WPP_SF_qqDD(0xBu, &WPP_968189b415313035a5e13c3867538638_Traceguids, v1, v5, v14, v15);
  }
  return v4;
}
