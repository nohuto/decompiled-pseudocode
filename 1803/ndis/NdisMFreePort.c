/*
 * XREFs of NdisMFreePort @ 0x1C003D570
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisMFreePort(NDIS_HANDLE NdisMiniportHandle, NDIS_PORT_NUMBER PortNumber)
{
  ...
  *((_DWORD *)NdisMiniportHandle + 464) = 0;
  ...
  if ( !v4 )
    ndisDereferenceMiniport((__int64)NdisMiniportHandle, 0x63u, v15, v16);
  if ( (unsigned __int8)byte_1C009961E >= 4u )
    WPP_SF_qdD(13LL, &WPP_0b808382ed603acc29a2d994791a3522_Traceguids, NdisMiniportHandle, PortNumber, v4);
  return v4;
}
