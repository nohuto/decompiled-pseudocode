/*
 * XREFs of ?ndisQueryOpenRSSv2Parameters@@YAHPEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_OID_REQUEST@@@Z @ 0x1C007BC7C
 * Callers:
...
__int64 __fastcall ndisQueryOpenRSSv2Parameters(struct _NDIS_OPEN_BLOCK *a1, struct _NDIS_OID_REQUEST *a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x16u, &WPP_4fecf6d36e163aabb9bd41260a763457_Traceguids, MiniportHandle, a2);
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x17u, &WPP_4fecf6d36e163aabb9bd41260a763457_Traceguids, (__int64)MiniportHandle, RSSv2ParametersHelper);
  return v8;
}
