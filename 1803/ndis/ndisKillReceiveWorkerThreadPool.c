/*
 * XREFs of ndisKillReceiveWorkerThreadPool @ 0x1C00E50B4
 * Callers:
...
void ndisKillReceiveWorkerThreadPool()
{
  ...
  if ( (unsigned __int8)byte_1C0099613 >= 4u )
    WPP_SF_(0x50u, &WPP_47403e85a6be3c322bcf4a109a5fff7e_Traceguids);
  v0 = ndisMaxNumberOfProcessors;
  for ( i = 0LL; (unsigned int)i < ndisMaxNumberOfProcessors; i = (unsigned int)(i + 1) )
  {
    if ( !*((_QWORD *)P + i) )
      break;
    v2 = (struct _WORK_QUEUE_ITEM *)((char *)WPP_MAIN_CB.Queue.Wcb.DeviceObject + 32 * (unsigned int)i);
    v2->WorkerRoutine = 0LL;
    v2->List.Flink = 0LL;
    v2->Parameter = v2;
    ndisInsertInWorkQueue((struct _KSEMAPHORE *)qword_1C0098E00 + 2 * (unsigned __int64)(unsigned int)i, v2, 0);
    v0 = ndisMaxNumberOfProcessors;
  }
  v3 = 0LL;
  if ( v0 )
  ...
  if ( (unsigned __int8)byte_1C0099613 >= 4u )
    WPP_SF_(0x51u, &WPP_47403e85a6be3c322bcf4a109a5fff7e_Traceguids);
}
