/*
 * XREFs of ?ndisBindReadFilterDriverSettingsFromV1Registry@@YA_NPEAUNDIS_BIND_FILTER_DRIVER@@AEAVKRegKey@@@Z @ 0x1C00FCCF4
 * Callers:
  ...
  *(_DWORD *)&ValueName.Length = 0;
  ...
  else if ( ResultLength != 2 )
  {
    if ( (unsigned __int8)byte_1C0099611 >= 2u )
      WPP_SF_(0xDu, &WPP_8d98bde3000d344f77c1d3be10f8ac4f_Traceguids);
    return 0;
  }
  *(_DWORD *)&ValueName.Length = 0;
  v10 = L"FilterRunType";
  ...
  else
  {
    if ( ResultLength != 2 )
    {
      if ( (unsigned __int8)byte_1C0099611 >= 2u )
      {
        WPP_SF_(0xEu, &WPP_8d98bde3000d344f77c1d3be10f8ac4f_Traceguids);
        return 0;
      }
      return 0;
    }
...
LABEL_69:
    ...
    if ( v24 >= 0 )
    {
      if ( ResultLength )
      {
        if ( ResultLength != 1 )
        {
          if ( (unsigned __int8)byte_1C0099611 < 2u )
            return 0;
          WPP_SF_(0x10u, &WPP_8d98bde3000d344f77c1d3be10f8ac4f_Traceguids);
          return 0;
        }
    ...
    if ( v6 >= 0 )
    {
      if ( ResultLength )
      {
        if ( ResultLength != 1 )
        {
          if ( (unsigned __int8)byte_1C0099611 < 2u )
            return 0;
          WPP_SF_(0x11u, &WPP_8d98bde3000d344f77c1d3be10f8ac4f_Traceguids);
          return 0;
        }
      }
      else
  ...
  if ( (unsigned __int8)byte_1C0099611 < 2u )
    return 0;
  WPP_SF_(0xFu, &WPP_8d98bde3000d344f77c1d3be10f8ac4f_Traceguids);
  return 0;
}
