/*
 * XREFs of ?NdisPDBMAddMemberToDomain@@YAJPEAUNDIS_PD_BM_DOMAIN_HANDLE__@@PEBU_NDIS_PD_BM_DOMAIN_MEMBER_PARAMETERS@@PEAPEAUNDIS_PD_BM_DOMAIN_MEMBER_HANDLE__@@@Z @ 0x1C00FB990
 * Callers:
 *     <none>
 * Callees:
        ...
        struct NDIS_PD_BM_DOMAIN_MEMBER_HANDLE__ **a3)
{
  ...
  *a3 = 0LL;
  ...
  v9 = *((_QWORD *)MiniportAdapterContext + 691);
...
LABEL_12:
  if ( !v13 )
  {
    ...
    v14 = *(_DWORD *)(v9 + 20);
    v15 = (_DEVICE_OBJECT *)*((_QWORD *)MiniportAdapterContext + 482);
