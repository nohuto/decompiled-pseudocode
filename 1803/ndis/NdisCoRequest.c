/*
 * XREFs of NdisCoRequest @ 0x1C01133F0
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a5)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqq(0x3Eu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids, NdisBindingHandle, P, a5);
...
LABEL_31:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqq(0x3Fu, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids, NdisBindingHandle, P, a5);
  return v13;
}
