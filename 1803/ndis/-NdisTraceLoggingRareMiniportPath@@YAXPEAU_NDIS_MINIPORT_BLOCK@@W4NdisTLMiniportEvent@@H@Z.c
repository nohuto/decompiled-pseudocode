/*
 * XREFs of ?NdisTraceLoggingRareMiniportPath@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4NdisTLMiniportEvent@@H@Z @ 0x1C0079CF0
 * Callers:
...
void NdisTraceLoggingRareMiniportPath()
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x400000000000uLL) )
    {
      ...
      v5 = (int)v1;
      v12 = 4LL;
      TlgWrite(&hProvider, &unk_1C0085682, v0, v1, 5u, &pData);
    }
  }
}
