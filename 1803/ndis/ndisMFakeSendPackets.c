/*
 * XREFs of ndisMFakeSendPackets @ 0x1C0060160
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMFakeSendPackets(__int64 a1, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qq(0x56u, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1, v3);
  v7 = -1073741823;
  if ( v3 )
    v7 = *(_DWORD *)(v3 + 540);
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qq(0x57u, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1, v3);
}
