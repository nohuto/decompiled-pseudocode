/*
 * XREFs of ndisWriteWmiStatusIndication @ 0x1C0018BDC
 * Callers:
...
LABEL_16:
  ndisSetupWmiNode(a1, a2, v16, (_DWORD)v6, (__int64)WnodeEventItem);
  ...
  if ( (unsigned __int8)byte_1C009961F >= 2u )
    WPP_SF_qD(55LL, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1, v25);
  if ( (Microsoft_Windows_NDISEnableBits & 0x1000) != 0 )
    McTemplateK0qqq(v18, &IoWMIWriteEventFailed, (const GUID *)(a1 + 4032), v25, 0xF12u, 0);
  if ( v19 )
