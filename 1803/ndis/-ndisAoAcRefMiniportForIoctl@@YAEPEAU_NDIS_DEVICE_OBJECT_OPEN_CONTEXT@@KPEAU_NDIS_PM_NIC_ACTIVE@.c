/*
 * XREFs of ?ndisAoAcRefMiniportForIoctl@@YAEPEAU_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@KPEAU_NDIS_PM_NIC_ACTIVE@@EW4_NDIS_MP_REFTAG@@PEAJPEAPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0023FC0
 * Callers:
...
LABEL_29:
      *a6 = v20;
      ndisDereferenceMiniport((__int64)v11, a5, v17, v18);
      v11 = 0LL;
      goto LABEL_6;
    }
    v21 = KeAcquireSpinLockRaiseToDpc(&v16->AoAc->Lock);
    if ( *((_DWORD *)a1 + 6) || !a4 )
    {
      if ( *((struct _NDIS_MINIPORT_BLOCK **)a1 + 4) != v11 )
      {
        KeReleaseSpinLock(&AoAc->Lock, v21);
        v20 = -1073741816;
        goto LABEL_29;
      }
    }
    else
    {
      ...
      *((_QWORD *)a1 + 4) = v11;
      v22 = (_LIST_ENTRY *)((char *)a1 + 8);
      Blink = AoAc->HandleList.Blink;
      if ( Blink->Flink != &AoAc->HandleList )
        __fastfail(3u);
      v22->Flink = &AoAc->HandleList;
      v22->Blink = Blink;
      Blink->Flink = v22;
      AoAc->HandleList.Blink = v22;
