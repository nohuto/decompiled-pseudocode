/*
 * XREFs of ?ReEnableTemporaryUnbind@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00BE68C
 * Callers:
      ...
      *(_DWORD *)(v6 + 32) = v12 & 0xFFFFDFFF;
      ...
      else
      {
        if ( (unsigned __int8)byte_1C0099623 >= 5u )
          WPP_SF_dd(0xEu, &WPP_a000b6aa13863dc28771f74e17683f6b_Traceguids, v12, v12 & 0xFFFFDFFF);
        *(_BYTE *)(*(_QWORD *)v6 + 5240LL) = 1;
        v13 = 1;
      }
      if ( v13 && (unsigned __int8)byte_1C0099623 >= 4u )
      {
  ...
  for ( j = 0LL; j != v7; ++j )
  {
    ...
    if ( !*(_BYTE *)(v10 + 9) && !*(_DWORD *)(v10 + 52) )
    {
      ...
      *(_DWORD *)(v10 + 32) = v11 & 0xFFFFDFFF;
      ...
      {
        if ( (unsigned __int8)byte_1C0099623 >= 5u )
          WPP_SF_dd(0xEu, &WPP_a000b6aa13863dc28771f74e17683f6b_Traceguids, v11, v11 & 0xFFFFDFFF);
