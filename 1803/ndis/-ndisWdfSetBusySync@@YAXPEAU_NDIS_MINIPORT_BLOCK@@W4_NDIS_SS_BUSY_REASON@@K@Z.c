/*
 * XREFs of ?ndisWdfSetBusySync@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_SS_BUSY_REASON@@K@Z @ 0x1C006F6C0
 * Callers:
...
void __fastcall ndisWdfSetBusySync(struct _NDIS_MINIPORT_BLOCK *a1, unsigned __int32 a2, unsigned int a3)
{
  ...
  else
  {
    ...
    if ( (unsigned __int8)byte_1C0099616 >= 4u )
      WPP_SF_qD(0x24u, &WPP_250ba6082b573e143e643b46f787ca55_Traceguids, (__int64)a1, a2);
