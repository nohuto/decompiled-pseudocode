/*
 * XREFs of NdisFreePacket @ 0x1C0015C20
 * Callers:
      ...
      || *(_DWORD *)(Flink + 48) == 1 )
    {
      ...
      if ( ExQueryDepthSList((PSLIST_HEADER)(Flink + 32)) == Pool->PktsPerBlock )
      {
        *(_QWORD *)(Flink + 16) = MEMORY[0xFFFFF78000000320];
        v6 = *(_QWORD *)Flink;
        if ( *(_QWORD *)(*(_QWORD *)Flink + 8LL) != Flink || (v7 = *(_QWORD **)(Flink + 8), *v7 != Flink) )
          __fastfail(3u);
        *v7 = v6;
        *(_QWORD *)(v6 + 8) = v7;
      ...
      {
        v9 = *(_QWORD *)Flink;
        if ( *(_QWORD *)(*(_QWORD *)Flink + 8LL) != Flink || (v10 = *(_QWORD **)(Flink + 8), *v10 != Flink) )
          __fastfail(3u);
        *v10 = v9;
        *(_QWORD *)(v9 + 8) = v10;
      ...
      if ( MEMORY[0xFFFFF78000000320] > Pool->NextScavengeTick.QuadPart )
      {
        ...
        while ( 1 )
        {
          ...
          if ( (_LIST_ENTRY *)v14->Region != p_AgingBlocks
            || (Alignment = (_LIST_ENTRY *)v14->Alignment, *(_SLIST_HEADER **)(v14->Alignment + 8) != v14) )
          {
            __fastfail(3u);
          }
