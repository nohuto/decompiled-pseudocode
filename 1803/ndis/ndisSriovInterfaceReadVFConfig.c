/*
 * XREFs of ndisSriovInterfaceReadVFConfig @ 0x1C00F4B90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVFConfig(void *a1, void *a2, __int16 a3, int a4, unsigned int Size)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x59u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(0x5Au, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
