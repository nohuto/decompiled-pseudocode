/*
 * XREFs of NdisMAllocateSharedMemory @ 0x1C00C85C0
 * Callers:
        ...
        PNDIS_PHYSICAL_ADDRESS PhysicalAddress)
{
  ...
  if ( (unsigned __int8)byte_1C009961C >= 4u )
    WPP_SF_qD(0x1Cu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)MiniportAdapterHandle, Length);
...
LABEL_14:
        ...
        if ( (unsigned __int8)byte_1C009961C >= 4u )
          WPP_SF_qLq(0x1Fu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)MiniportAdapterHandle, v12);
        return;
      }
      *(_DWORD *)(v16 + 4092) = 0;
  ...
  *VirtualAddress = 0LL;
  if ( (unsigned __int8)byte_1C009961C >= 4u )
    WPP_SF_qD(0x1Du, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)MiniportAdapterHandle, v7);
}
