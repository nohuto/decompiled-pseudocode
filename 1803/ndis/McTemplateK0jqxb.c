/*
 * XREFs of McTemplateK0jqxb @ 0x1C005E3B8
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jqxb(__int64 a1, __int64 a2, const GUID *a3, __int64 a4, char a5, char a6, __int64 a7)
{
  ...
  v14 = 8LL;
  v16 = 6LL;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &MiniportMacAddress, a3, 5u, &v8);
}
