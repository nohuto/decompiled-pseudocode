/*
 * XREFs of ndisSendPacketsWithPause @ 0x1C00582B0
 * Callers:
...
void __fastcall ndisSendPacketsWithPause(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qqd(0x30u, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2, a3);
...
LABEL_37:
  if ( (unsigned __int8)byte_1C009960A >= 4u )
  {
    ...
    WPP_SF_qqd(0x31u, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, v4, BugCheckOnFailure);
  }
}
