/*
 * XREFs of NdisSetOptionalHandlers @ 0x1C00C79F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisSetSSHandlers @ 0x1C00F5CAC (ndisSetSSHandlers.c)
 *     ?ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x1C00FA7C8 (-ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 */
...
NDIS_STATUS __stdcall NdisSetOptionalHandlers(NDIS_HANDLE NdisHandle, PNDIS_DRIVER_OPTIONAL_HANDLERS OptionalHandlers)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x6Fu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)NdisHandle);
...
LABEL_19:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x70u, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)NdisHandle, v4);
