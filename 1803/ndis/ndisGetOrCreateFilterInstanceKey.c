/*
 * XREFs of ndisGetOrCreateFilterInstanceKey @ 0x1C00E6A84
 * Callers:
        ...
        PUNICODE_STRING Destination)
{
  ...
  *(_DWORD *)&v45.Length = 262146;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x5Fu, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, a1, a3, a2);
...
LABEL_20:
        ...
        for ( i = 0; i <= 0x270F; ++i )
        {
          ...
          v21 = RegistryValues;
          if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
            WPP_SF_dd(0x60u, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, RegistryValues, v32);
          if ( v21 )
            goto LABEL_68;
...
LABEL_29:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    ...
    WPP_SF_qqqL(0x61u, &WPP_8c31e01722df3e37d3ae4568239e1c5f_Traceguids, Source, v6, v42, ResultLength);
  }
  return v7;
}
