/*
 * XREFs of ndisReadRegistry @ 0x1C011C400
 * Callers:
...
__int64 ndisReadRegistry()
{
  ...
  unsigned int *v67; // [rsp+348h] [rbp+248h]
  int v68; // [rsp+350h] [rbp+250h]
  const wchar_t *v69; // [rsp+358h] [rbp+258h]
  void *v70; // [rsp+360h] [rbp+260h]
  ...
  void **p_DeviceContext; // [rsp+390h] [rbp+290h]
  ...
  _RTL_QUERY_REGISTRY_TABLE QueryTable; // [rsp+4C0h] [rbp+3C0h] BYREF
  __int64 (__fastcall *v115)(); // [rsp+4F8h] [rbp+3F8h]
  int v116; // [rsp+500h] [rbp+400h]
  __int64 v117; // [rsp+508h] [rbp+408h]
  __int64 v118; // [rsp+510h] [rbp+410h]
  int v119; // [rsp+518h] [rbp+418h]
  void *v120; // [rsp+520h] [rbp+420h]
  int v121; // [rsp+528h] [rbp+428h]
  _BYTE v122[56]; // [rsp+530h] [rbp+430h] BYREF
  ...
  v96 = L"ImplicitPowerRefManagement";
  v97 = &ndisPowerRefManagementState;
  v99 = L"DirectedMacForNapsEnabled";
  v100 = &ndisDirectedMacForNapsState;
  v102 = L"DisableReenumerationTimeoutBugcheck";
  v103 = &ndisBugCheckOnReenumerationTimeout;
  v105 = L"RssBaseCpu";
  v106 = &ndisRssBaseCpu;
  v108 = L"MaxNumRssCpus";
  v109 = (char *)&WPP_MAIN_CB.Queue.Wcb.DeviceContext + 4;
  v111 = L"PadShortPackets";
  v112 = &ndisPadShortPackets;
  v89 = 0;
  v92 = 0;
  v95 = 1;
  v98 = 0;
  ...
  v110 = 1280;
  v113 = 0;
  ndisReadRegistryKnobs((struct _DRIVER_OBJECT *)0x3E8, (const struct NDIS_REGISTRY_KNOB *)v7, 0x24uLL);
  ...
  *(_DWORD *)VersionInformation = 284;
  ...
  {
    DeviceContext_high = 1;
    HIDWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) = 1;
  }
  if ( DeviceContext_high > ndisNumberOfActiveProcessorsAtBoot )
  {
    DeviceContext_high = ndisNumberOfActiveProcessorsAtBoot;
    HIDWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) = ndisNumberOfActiveProcessorsAtBoot;
  }
  if ( DeviceContext_high > 0x500 )
  {
    DeviceContext_high = 1280;
    HIDWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) = 1280;
  }
  v3 = ndisRssBaseCpu;
  ...
  if ( v3 + DeviceContext_high > ndisNumberOfActiveProcessorsAtBoot )
    HIDWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) = ndisNumberOfActiveProcessorsAtBoot - v3;
  result = (unsigned int)(dword_1C0098DC8 - 1);
