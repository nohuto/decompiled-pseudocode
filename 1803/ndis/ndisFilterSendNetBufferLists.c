/*
 * XREFs of ndisFilterSendNetBufferLists @ 0x1C0005860
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 )
  {
    ...
    if ( ndisIterativeDataPathDisabled || (a4 & 1) == 0 && KeGetCurrentIrql() != 2 || !*(_BYTE *)(v10 + 16) )
    {
      ndisInvokeNextSendHandler(
        ...
        a3,
        a4,
        *(struct _NDIS_OBJECT_HEADER **)(a1 + 464),
        *(void **)(a1 + 448),
        *(void (**)(void *, struct _NET_BUFFER_LIST *, unsigned int, unsigned int))(a1 + 440));
      return;
    }
    v11 = a4 | 1;
    if ( !*(_QWORD *)v10 )
