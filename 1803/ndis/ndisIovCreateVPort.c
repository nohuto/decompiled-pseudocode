/*
 * XREFs of ndisIovCreateVPort @ 0x1C00F1F88
 * Callers:
...
char __fastcall ndisIovCreateVPort(__int64 *a1)
{
  ...
  {
    WPP_SF_q(0x2Du, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v4);
    v8 = a1[4];
  }
  *(_DWORD *)(v8 + 64) = 572;
  *(_DWORD *)(a1[4] + 60) = 0;
...
LABEL_48:
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(0x2Eu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v4, *v11);
  return v7;
}
