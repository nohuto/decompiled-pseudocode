/*
 * XREFs of ndisReferenceNextUnprocessedOpenEx @ 0x1C0010370
 * Callers:
...
__int64 __fastcall ndisReferenceNextUnprocessedOpenEx(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qD(22LL, &WPP_0af21d7125ac337aa6d359ed8b88fbb1_Traceguids, a1, 1LL);
  ...
  *(_DWORD *)(a1 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qq(23LL, &WPP_0af21d7125ac337aa6d359ed8b88fbb1_Traceguids, a1, v3);
  return v3;
}
