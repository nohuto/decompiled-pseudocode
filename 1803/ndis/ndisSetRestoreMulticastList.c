/*
 * XREFs of ndisSetRestoreMulticastList @ 0x1C00DF630
 * Callers:
...
void __fastcall ndisSetRestoreMulticastList(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x78u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, a1, a2);
  v5 = v2;
  v6 = *v2;
...
LABEL_14:
        *((_DWORD *)v2 + 92) = v9 + 1;
        ...
        memmove((void *)(v2[44] + 6 * v18), (const void *)(*(_QWORD *)(v6 + 448) + 4 * (i + 2 * i + 1)), 6uLL);
LABEL_18:
        ;
      }
      v6 = *(_QWORD *)(v6 + 424);
  ...
  *(_DWORD *)(a2 + 48) = 6 * *((_DWORD *)v2 + 92);
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x79u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, a1, a2);
}
