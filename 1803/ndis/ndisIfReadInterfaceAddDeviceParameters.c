/*
 * XREFs of ndisIfReadInterfaceAddDeviceParameters @ 0x1C00B72D0
 * Callers:
...
__int64 __fastcall ndisIfReadInterfaceAddDeviceParameters(unsigned int *a1)
{
  ...
  ULONG v26; // [rsp+88h] [rbp-80h] BYREF
  ...
  unsigned int v31; // [rsp+A4h] [rbp-64h]
  wchar_t Dest[48]; // [rsp+B8h] [rbp-50h] BYREF

  v1 = 0;
  KeyHandle = 0LL;
  v3 = ndisIfOpenInterfacePersistedStorage(a1, (KRegKey *)&KeyHandle, 1u);
  if ( v3 < 0 )
  {
    v22 = KeyHandle;
LABEL_47:
...
LABEL_58:
    ...
    if ( ZwQueryValueKey(KeyHandle, &ValueName, KeyValuePartialInformation, KeyValueInformation, 0x14u, &v26) < 0 )
      goto LABEL_58;
    if ( v29 == 4 )
    {
      if ( v30 == 4 )
    ...
    *(_DWORD *)&ValueName.Length = 0;
    ...
    ValueName.MaximumLength = ValueName.Length + 2;
    if ( ZwQueryValueKey(v22, &ValueName, KeyValuePartialInformation, KeyValueInformation, 0x14u, &v26) < 0 )
      goto LABEL_58;
    if ( v29 == 4 )
    {
      if ( v30 == 4 )
    ...
    *(_DWORD *)&ValueName.Length = 0;
    ...
    {
      if ( v20 )
        ExFreePoolWithTag(*((PVOID *)a1 + 5), 0x7274534Bu);
      *((_QWORD *)a1 + 5) = v19;
      v20 = v19;
    }
    if ( !v20 )
