/*
 * XREFs of ndisOidPrePMRemoveWOLPattern @ 0x1C00E16B0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_qD @ 0x1C003A870 (WPP_SF_qD.c)
 *     WPP_SF_qq @ 0x1C003A8B8 (WPP_SF_qq.c)
 *     ndisFindPatternEntry @ 0x1C00B4348 (ndisFindPatternEntry.c)
...
char __fastcall ndisOidPrePMRemoveWOLPattern(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    WPP_SF_qq(0x58u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v8, v4);
    v9 = *(_QWORD *)(a1 + 24);
  }
  v10 = 6;
  LOBYTE(a4) = 20;
...
LABEL_8:
  ...
  *(_DWORD *)(v4 + 152) = *v17;
  if ( *(_QWORD *)(a1 + 24) && !ndisFindPatternEntry((__int64 **)(v6 + 504), v18)
    || (v19 = *(_QWORD *)(a1 + 8)) != 0
    && (*(_DWORD *)(v4 + 88) & v14) == 0
    && !ndisFindPatternEntry((__int64 **)(v19 + 864), v18) )
  {
...
LABEL_30:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x59u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, *(_QWORD *)a1, *(_DWORD *)(a1 + 40));
  return v5;
}
