/*
 * XREFs of ?ndisIfCreateCompartmentBlock@@YAJIPEAU_GUID@@PEAU_NDIS_NSI_COMPARTMENT_RW@@PEAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@@Z @ 0x1C0023A44
 * Callers:
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a4)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_dq(124LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1, a3);
  *a4 = 0LL;
