/*
 * XREFs of ndisOidPreRcvFilterEnumQueues @ 0x1C003BFF0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumQueues(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099620 >= 4u )
    WPP_SF_q(0x1Cu, &WPP_968189b415313035a5e13c3867538638_Traceguids, a1);
  v6 = *(_QWORD *)(a1 + 32);
...
LABEL_32:
  if ( (unsigned __int8)byte_1C0099620 >= 4u )
    WPP_SF_qD(0x1Du, &WPP_968189b415313035a5e13c3867538638_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v5;
}
