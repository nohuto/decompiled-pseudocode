/*
 * XREFs of ndisOidPrePMProtocolOffloadList @ 0x1C00E1460
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPrePMProtocolOffloadList(__int64 *a1)
{
  ...
  {
    WPP_SF_qqq(0x6Bu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v1, v3, v5);
    v8 = a1[3];
  }
  if ( v8
...
LABEL_32:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqqL(0x6Cu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v1, v3, v5, *((_DWORD *)a1 + 10));
  return v2;
}
