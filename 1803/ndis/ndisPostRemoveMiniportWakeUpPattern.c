/*
 * XREFs of ndisPostRemoveMiniportWakeUpPattern @ 0x1C004AEFC
 * Callers:
...
void __fastcall ndisPostRemoveMiniportWakeUpPattern(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqd(0x27u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
    v6 = 0;
...
LABEL_31:
  ...
  {
    LODWORD(v21) = a3;
    WPP_SF_qqd(0x28u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2, v21);
  }
}
