/*
 * XREFs of ?ndisQueryRSSv2ParametersHelper@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@K@Z @ 0x1C007BD14
 * Callers:
        ...
        int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x12u, &WPP_4fecf6d36e163aabb9bd41260a763457_Traceguids, a1, a2);
...
LABEL_30:
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x13u, &WPP_4fecf6d36e163aabb9bd41260a763457_Traceguids, (__int64)a1, v7);
  return v7;
}
