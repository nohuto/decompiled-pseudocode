/*
 * XREFs of ndisOidPreHDSplitCurrentConfig @ 0x1C0047060
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreHDSplitCurrentConfig(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0xD3u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v3);
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qdD(0xD4u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, *(_DWORD *)(a1 + 40), v4);
  return v4;
}
