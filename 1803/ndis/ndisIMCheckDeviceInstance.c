/*
 * XREFs of ndisIMCheckDeviceInstance @ 0x1C00E5928
 * Callers:
...
char __fastcall ndisIMCheckDeviceInstance(__int64 a1, const UNICODE_STRING *a2, wchar_t **a3)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qZ(0x28u, &WPP_f15752027639342d7f4a984ed5eb2bc7_Traceguids, a1, &a2->Length);
...
LABEL_24:
          ...
          ++*(_DWORD *)(v11 + 424);
          *(_QWORD *)(v11 + 416) = KeGetCurrentThread();
          *(_DWORD *)(v11 + 428) = 263779;
          ndisDeliverNetPnPEventSynchronously(v11, 0LL, (__int64)&v19);
          v14 = (*(_DWORD *)(v11 + 424))-- == 1;
          *(_DWORD *)(v11 + 428) = 0;
          if ( v14 )
            *(_QWORD *)(v11 + 416) = 0LL;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qZ(0x2Au, &WPP_f15752027639342d7f4a984ed5eb2bc7_Traceguids, a1, &a2->Length);
  return v6;
}
