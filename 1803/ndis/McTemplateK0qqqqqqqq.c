/*
 * XREFs of McTemplateK0qqqqqqqq @ 0x1C0069A68
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqqqqq(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        int a4,
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &RstLimitChange, a3, 9u, &v12);
}
