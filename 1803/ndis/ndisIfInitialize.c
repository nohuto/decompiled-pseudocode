/*
 * XREFs of ndisIfInitialize @ 0x1C011CAC0
 * Callers:
...
__int64 ndisIfInitialize()
{
  ...
  *(_DWORD *)&v17.Length = 655368;
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_(0x13u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids);
  ...
  qword_1C00997B8 = (__int64)&ndisIfCompartmentList;
  ndisIfCompartmentList.Flink = &ndisIfCompartmentList;
  qword_1C00998E8 = (__int64)&ndisIfTypesList;
  qword_1C0099950 = (__int64)&ndisIfNetworkList;
  ndisIfNetworkList.Flink = &ndisIfNetworkList;
  ndisIfTypesList = (struct _NDIS_IF_TYPE *)&ndisIfTypesList;
  qword_1C0099940 = (__int64)&ndisIfProviderList;
  ndisIfProviderList.Flink = &ndisIfProviderList;
  qword_1C00997A8 = (__int64)&ndisIfList;
  ndisIfList.Flink = &ndisIfList;
  qword_1C0099960 = (__int64)&ndisIfStackEntryList;
  ndisIfStackEntryList = &ndisIfStackEntryList;
  memset(&xmmword_1C0099152, 0, 0x202uLL);
  memset(&xmmword_1C0099362, 0, 0x202uLL);
  ...
  if ( !Status )
  {
    ...
    if ( Status || !ndisIsValidIfStringParts(v2, ParameterValue->ParameterData.StringData.Length) )
    {
      ...
      wmemcpy((wchar_t *)&xmmword_1C0099152, L"Software Loopback Interface", 27);
    }
    else
    {
      ndisIfLoopbackDescr.Length = v11;
      memmove(&xmmword_1C0099152, *(const void **)(v12 + 16), v11);
    }
            ...
            ParameterValue->ParameterData.StringData.Length) )
    {
      ...
      wmemcpy((wchar_t *)&xmmword_1C0099362, L"Loopback Pseudo-Interface", 25);
    }
    else
    {
      ...
      if ( (unsigned __int16)v14 >= (unsigned __int16)v13 )
        v14 = v13;
      memmove(&xmmword_1C0099362, *(const void **)(v15 + 16), v14);
    }
...
LABEL_23:
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_d(0x14u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, v0);
