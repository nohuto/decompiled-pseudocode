/*
 * XREFs of ndisBindRequest @ 0x1C0065704
 * Callers:
 *     ?ndisFBindRequest@@YAHPEAU_NDIS_FILTER_BLOCK@@PEBU_NET_PNP_EVENT_NOTIFICATION@@@Z @ 0x1C0058680 (-ndisFBindRequest@@YAHPEAU_NDIS_FILTER_BLOCK@@PEBU_NET_PNP_EVENT_NOTIFICATION@@@Z.c)
 ...
 *     ?ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z @ 0x1C00FD3A4 (-ndisGetBindLinkNameForTracing@@YAX$$TPEAUNDIS_PNPTRACE_LOCALS@@@Z.c)
 */
        ...
        ULONG_PTR BugCheckParameter3)
{
  ...
  const wchar_t *v15; // [rsp+30h] [rbp-41h]
  ...
  switch ( *(_DWORD *)(BugCheckParameter3 + 8) )
  {
    case 0x12:
      ...
      v11 = 57;
LABEL_28:
      WPP_SF_Zq(v11, &WPP_0af21d7125ac337aa6d359ed8b88fbb1_Traceguids, v15, v14);
      break;
    case 0x13:
    ...
    case 0x15:
      ...
      v9 = 60;
LABEL_23:
      WPP_SF_Zq(v9, &WPP_0af21d7125ac337aa6d359ed8b88fbb1_Traceguids, v15, v14);
LABEL_24:
      v7 = RunSynchronous;
      break;
  }
