/*
 * XREFs of ndisOidPostIovVPortParameters @ 0x1C006D740
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostIovVPortParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x39u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v3, v1);
    v4 = *(_QWORD *)(a1 + 32);
  }
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qq(0x3Au, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v3, v1);
}
