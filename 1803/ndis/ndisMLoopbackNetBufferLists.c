/*
 * XREFs of ndisMLoopbackNetBufferLists @ 0x1C005661C
 * Callers:
        ...
        __int64 *a5)
{
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qq(0x42u, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2);
  v9 = a2;
  v15 = 0;
  v10 = a2;
  v16[0] = 0;
...
LABEL_18:
  ...
  *a5 = v10;
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qq(0x43u, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2);
}
