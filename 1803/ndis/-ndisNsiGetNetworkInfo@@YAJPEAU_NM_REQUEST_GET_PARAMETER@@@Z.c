/*
 * XREFs of ?ndisNsiGetNetworkInfo@@YAJPEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00403F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetNetworkInfo(struct _NM_REQUEST_GET_PARAMETER *a1)
{
  ...
  unsigned int v21[6]; // [rsp+28h] [rbp-50h] BYREF

  v1 = 0LL;
  v3 = 0;
  v20 = 0;
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(0x70u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1);
...
LABEL_34:
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qD(0x71u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1, v3);
