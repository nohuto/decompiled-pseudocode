/*
 * XREFs of NdisCoCreateVc @ 0x1C0112220
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisVcHandle)
{
  ...
  bool v43; // al
  void (__fastcall *v44)(_QWORD *, struct _NET_BUFFER_LIST *, unsigned int, unsigned int); // rax
  void (__fastcall *v45)(_QWORD *, struct _NDIS_PACKET **, unsigned int); // rcx
  void (__fastcall *v46)(int, _QWORD *, struct _NDIS_PACKET *); // rdx
  void (__fastcall *v47)(_QWORD *, struct _NET_BUFFER_LIST *, unsigned int); // r8
  void *v48; // r9
  KIRQL NewIrql; // [rsp+20h] [rbp-58h]
  int v51; // [rsp+24h] [rbp-54h]
  LARGE_INTEGER *v52; // [rsp+28h] [rbp-50h]
  char Increment; // [rsp+80h] [rbp+8h]
  bool v54; // [rsp+88h] [rbp+10h]

  if ( (unsigned __int8)byte_1C009961A >= 4u )
    WPP_SF_(0x10u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
  ...
  *((_QWORD *)v10 + 6) = v10 + 12;
  ...
  {
    if ( (unsigned __int8)byte_1C009961A >= 4u )
      WPP_SF_(0x12u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
    v14 = (KSPIN_LOCK *)v8[9];
    *((_QWORD *)v10 + 25) = v8[25];
LABEL_27:
    v15 = v52;
  ...
  if ( (unsigned __int8)byte_1C009961A >= 4u )
    WPP_SF_(0x11u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
...
LABEL_28:
  *((_QWORD *)v10 + 26) = *(_QWORD *)(v15[473].QuadPart + 280);
  if ( LOBYTE(v15[4].LowPart) < 6u )
    v16 = 0LL;
  else
    v16 = *(_QWORD *)(v15[473].QuadPart + 536);
  *((_QWORD *)v10 + 30) = v16;
  if ( !v7 )
  {
    *((_QWORD *)v10 + 27) = *(_QWORD *)(v15[473].QuadPart + 512);
    *((_QWORD *)v10 + 28) = *(_QWORD *)(v15[473].QuadPart + 520);
    *((_QWORD *)v10 + 29) = *(_QWORD *)(v15[473].QuadPart + 528);
  }
  *((_QWORD *)v10 + 24) = v15;
  ...
  *v10 = 1;
  ...
  {
    if ( (unsigned __int8)byte_1C009961A >= 4u )
      WPP_SF_(0x13u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
...
LABEL_111:
      ...
      {
        if ( (unsigned __int8)byte_1C009961A >= 4u )
          WPP_SF_(0x15u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
        v44 = 0LL;
      ...
      {
        if ( (unsigned __int8)byte_1C009961A >= 4u )
          WPP_SF_(0x14u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
  ...
  {
    if ( (unsigned __int8)byte_1C009961A >= 4u )
      WPP_SF_(0x17u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
    *((_QWORD *)v10 + 31) = 0LL;
  ...
  {
    if ( (unsigned __int8)byte_1C009961A >= 4u )
      WPP_SF_(0x16u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
    *((_QWORD *)v10 + 31) = 0LL;
...
LABEL_120:
  *NdisVcHandle = v10;
  if ( (unsigned __int8)byte_1C009961A >= 4u )
    WPP_SF_qD(0x18u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids, (__int64)v10, v9);
  return v9;
}
