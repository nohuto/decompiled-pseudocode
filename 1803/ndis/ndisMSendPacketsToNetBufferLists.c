/*
 * XREFs of ndisMSendPacketsToNetBufferLists @ 0x1C0057850
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsToNetBufferLists(__int64 a1, struct _NDIS_PACKET **a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qqd(0x36u, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2, a3);
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qq(0x37u, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a2);
}
