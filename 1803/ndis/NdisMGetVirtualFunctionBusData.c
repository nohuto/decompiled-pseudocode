/*
 * XREFs of NdisMGetVirtualFunctionBusData @ 0x1C006BA50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMGetVirtualFunctionBusData(__int64 a1, unsigned __int16 a2, __int64 a3, unsigned int a4, int a5)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x6Fu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, a1);
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(0x70u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, a1, v9);
  return v9;
}
