/*
 * XREFs of ndisOidPreOffloadEncapsulation @ 0x1C00C73E0
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisOidPreMiniportSetEncapsulation@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z @ 0x1C002174C (-ndisOidPreMiniportSetEncapsulation@@YAEPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OID_REQUEST@@PEAH@Z.c)
...
unsigned __int8 __fastcall ndisOidPreOffloadEncapsulation(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqq(0xD7u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v4, v3);
  v5 = (_DWORD *)(a1 + 40);
...
LABEL_9:
  ...
  {
    LODWORD(v12) = v10;
    WPP_SF_qqDD(0xD8u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v4, v12, *v5);
  }
  return v10;
}
