/*
 * XREFs of NdisMRegisterDmaChannel @ 0x1C010EFB0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG MaximumLength)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x24u, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)MiniportAdapterHandle);
...
LABEL_18:
  ...
  if ( v21 < 0 )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_d(0x25u, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, v21);
...
LABEL_19:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x26u, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)MiniportAdapterHandle, v11);
  return v11;
}
