/*
 * XREFs of ndisEmptyPeriodicReceivesQueue @ 0x1C0069B48
 * Callers:
...
_NET_BUFFER_LIST *__fastcall ndisEmptyPeriodicReceivesQueue(struct _NDIS_MINIPORT_BLOCK *a1, char a2)
{
  ...
  if ( QueuedHead )
  {
    ...
    else
    {
      ...
      v11 = ndisDoPeriodicReceivesIndication(a1, QueuedHead);
      if ( v7 )
      {
        v14 = WmiGetClock(0LL, 0LL, v12, v13);
        ndisTracePeriodicReceivesEnd((__int64)a1, v14 - Clock, v11);
      }
    }
    ...
    a1->PeriodicReceiveQueue.LockDbg = 2494645;
  }
  return result;
}
