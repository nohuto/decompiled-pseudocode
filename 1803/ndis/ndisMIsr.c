...
char __fastcall ndisMIsr(__int64 a1, __int64 a2)
{
  ...
  if ( (v4 & 2) != 0 )
  {
    ndisPcwStartCycleCounter(&v6, 1);
    LOBYTE(v4) = v6.DatapathCyclesMask;
  }
  if ( (*(_DWORD *)(v2 + 120) & 1) != 0 )
  {
    (*(void (__fastcall **)(_QWORD))(*(_QWORD *)(v2 + 3784) + 128LL))(*(_QWORD *)(v2 + 24));
    v7 = 1;
    v8 = 1;
  }
  else
  ...
  if ( (v4 & 2) != 0 )
    ndisPcwEndCycleCounter(&v6, 1, 14LL);
  if ( v7 )
  {
    ...
    if ( KeInsertQueueDpc((PRKDPC)(a2 + 40), 0LL, 0LL) )
    {
      if ( (v6.DatapathCyclesMask & 0x1000) != 0 )
        ndisPcwStartCycleCounter(&v6, 12);
    }
    else
    {
