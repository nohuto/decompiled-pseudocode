/*
 * XREFs of ndisMPowerPolicy @ 0x1C0100F58
 * Callers:
...
__int64 __fastcall ndisMPowerPolicy(__int64 MiniportAdapterHandle, int a2, int a3, signed int *a4, char a5)
{
  ...
  v6 = a2;
  v7 = 0;
  v10 = (_QWORD *)MiniportAdapterHandle;
  v24 = 0LL;
  v11 = 4;
  v25 = 0LL;
  v26 = 0;
  ...
  if ( (_DWORD)v6 == 1 )
  {
    ...
    if ( !a5 )
    {
      *((_DWORD *)v10 + 31) &= ~0x800u;
      v10[578] += ndisGetTimeInterval(v10 + 577);
    }
    if ( !v22 )
      *a4 = 1;
    if ( (unsigned __int8)byte_1C0099615 < 4u )
  ...
  {
    *((_DWORD *)v10 + 31) |= 0x800u;
    v10[577] = MEMORY[0xFFFFF78000000014];
  }
  ...
  if ( (unsigned int)(*((_DWORD *)v10 + 973) - 2) > 2 )
  {
    if ( a3 == 6 )
    {
      if ( (_DWORD)v6 == 5 )
...
LABEL_118:
          ...
          *a4 = 4;
          ...
          v17 = 140;
LABEL_103:
          WPP_SF_q(v17, &WPP_42361dd9a74b3d276ab6054e0e6a2aa7_Traceguids, (__int64)v10);
          return v7;
        }
LABEL_111:
        v19 = *((_DWORD *)v10 + 31);
      ...
      v14 = *((_DWORD *)v10 + v6 + 310);
      if ( (int)v6 >= 5 && ((int)v6 > *((_DWORD *)v10 + 317) || v14 > *((_DWORD *)v10 + 318)) )
      {
        if ( (unsigned __int8)byte_1C0099615 >= 4u )
      ...
      if ( (int)v6 > *((_DWORD *)v10 + 317) || v14 > (int)MiniportAdapterHandle || !v14 )
      {
      ...
      {
        v16 = MiniportAdapterHandle - 1;
        if ( v16 )
        {
          MiniportAdapterHandle = (unsigned int)(v16 - 1);
          if ( (_DWORD)MiniportAdapterHandle )
          {
...
LABEL_95:
    ...
    *a4 = 4;
    ...
    v12 = 129;
LABEL_136:
    WPP_SF_q(v12, &WPP_42361dd9a74b3d276ab6054e0e6a2aa7_Traceguids, (__int64)v10);
    return 0LL;
  }
  if ( !a5 )
  {
