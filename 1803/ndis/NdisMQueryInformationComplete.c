/*
 * XREFs of NdisMQueryInformationComplete @ 0x1C0043890
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisMQueryInformationComplete(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x47u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, BugCheckParameter2, a2);
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(0x48u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, BugCheckParameter2);
}
