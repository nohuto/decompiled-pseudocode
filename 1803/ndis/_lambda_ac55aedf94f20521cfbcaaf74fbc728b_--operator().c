/*
 * XREFs of _lambda_ac55aedf94f20521cfbcaaf74fbc728b_::operator() @ 0x1C00FD6C8
 * Callers:
 ...
 *     ?ParseV1FilterString@BindStack@Ndis@@AEAA_NPEBGPEAU_NDIS_FILTERLIST_ITEM@@@Z @ 0x1C00FDAD8 (-ParseV1FilterString@BindStack@Ndis@@AEAA_NPEBGPEAU_NDIS_FILTERLIST_ITEM@@@Z.c)
 */
