/*
 * XREFs of ?CheckAllDriversRunning@Initmode@Ndis@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C00C1200
 * Callers:
...
char __fastcall Ndis::Initmode::CheckAllDriversRunning(Ndis::Initmode *this, struct _NDIS_MINIPORT_BLOCK *a2)
{
  ...
  for ( i = 0LL; i != v2; ++i )
  {
    if ( i >= v2 )
      __fastfail(5u);
    v4 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 632) + 8 * i) + 80LL);
    if ( (*(_DWORD *)(v4 + 40) & 0x10) == 0 && !*(_QWORD *)(v4 + 56) )
      return 0;
  }
  v5 = *((unsigned int *)this + 1259);
  for ( j = 0LL; j != v5; ++j )
  {
    if ( j >= v5 )
      __fastfail(5u);
    v7 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 630) + 8 * j) + 80LL);
