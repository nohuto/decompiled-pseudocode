/*
 * XREFs of McTemplateK0qx @ 0x1C004131C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qx(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  ...
  v12 = 0;
  v11 = 8;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &ChangeNotificationInterfaceEnum, &NDIS_PROVIDER_ID, 3u, &v6);
}
