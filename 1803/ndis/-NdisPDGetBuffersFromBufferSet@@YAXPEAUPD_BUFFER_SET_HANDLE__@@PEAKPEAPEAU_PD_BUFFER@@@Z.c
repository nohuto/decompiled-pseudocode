/*
 * XREFs of ?NdisPDGetBuffersFromBufferSet@@YAXPEAUPD_BUFFER_SET_HANDLE__@@PEAKPEAPEAU_PD_BUFFER@@@Z @ 0x1C0076650
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _PD_BUFFER **a3)
{
  ...
  *a3 = v10;
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_qD(0x52u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)a1, *a2);
}
