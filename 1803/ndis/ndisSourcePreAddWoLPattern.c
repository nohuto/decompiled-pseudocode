/*
 * XREFs of ndisSourcePreAddWoLPattern @ 0x1C00C53BC
 * Callers:
...
__int64 __fastcall ndisSourcePreAddWoLPattern(__int64 a1, __int64 a2, _QWORD *a3, _BYTE *a4)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(0x38u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, (__int64)a3);
...
LABEL_9:
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_dd(0x39u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, (unsigned __int8)*a4, v8);
  return v8;
}
