/*
 * XREFs of ?ndisPDCleanupPDBlock@@YAXPEAU_NDIS_PD_BLOCK@@@Z @ 0x1C00FA198
 * Callers:
...
void __fastcall ndisPDCleanupPDBlock(struct _NDIS_PD_BLOCK *a1)
{
  ...
  {
    v8.m_State = Unlocked;
    v8.m_Lock = (KPushLockBase *)qword_1C00996C8;
    ...
    if ( (unsigned __int8)byte_1C0099624 >= 4u )
    {
      ...
      WPP_SF_qqd(0xAu, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, a1->Miniport, PDBMDomain, v7);
    }
