/*
 * XREFs of ethAddOneOpenMulticastAddress @ 0x1C00CB454
 * Callers:
...
__int64 __fastcall ethAddOneOpenMulticastAddress(__int64 a1, char *a2, _BYTE *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(0xDu, &WPP_d36ecf7297d8317af0092cf65f1d373e_Traceguids, a1);
...
LABEL_6:
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_dd(0xEu, &WPP_d36ecf7297d8317af0092cf65f1d373e_Traceguids, (unsigned __int8)*a3, v7);
  return v7;
}
