/*
 * XREFs of ?NdisPDPIReleaseReceiveQueues@@YAXPEAUNDIS_PD_PROVIDER_HANDLE__@@@Z @ 0x1C00F9330
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDPIReleaseReceiveQueues(struct NDIS_PD_PROVIDER_HANDLE__ *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_q(0x28u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)i);
  v3.Blink = &v3;
  v3.Flink = &v3;
  v2.Blink = &v2;
  v2.Flink = &v2;
  ...
  *((_BYTE *)i + 89) = 0;
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_q(0x29u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)i);
