/*
 * XREFs of ?ndisIfSetFilterIfInfoInRegistry@@YAHPEAU_NDIS_FILTER_BLOCK@@U_GUID@@@Z @ 0x1C00B796C
 * Callers:
...
__int64 __fastcall ndisIfSetFilterIfInfoInRegistry(struct _NDIS_FILTER_BLOCK *a1, wchar_t *a2)
{
  ...
  *(_DWORD *)&Keyword.Length = 1835034;
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(0xCDu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qD(0xCEu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1, v5);
  return v5;
}
