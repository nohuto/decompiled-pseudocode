/*
 * XREFs of ndisOidPreOffloadCaps @ 0x1C00471E0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_qqDD @ 0x1C003A8FC (WPP_SF_qqDD.c)
 *     WPP_SF_qqq @ 0x1C003A95C (WPP_SF_qqq.c)
 *     ndisQueryFilterOffloadCaps @ 0x1C0047F60 (ndisQueryFilterOffloadCaps.c)
 *     ndisQueryMiniportOffloadCaps @ 0x1C0048034 (ndisQueryMiniportOffloadCaps.c)
 */
...
unsigned __int8 __fastcall ndisOidPreOffloadCaps(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqq(0xE9u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v4, v3);
  *((_DWORD *)a1 + 10) = -1073741637;
  ...
  if ( (*(_DWORD *)(v3 + 4) & 0xFFFFFFFD) == 0 )
  {
    if ( a1[2] )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v5 + 32) + 1856LL) = 2311022;
      v8 = *(_DWORD *)(v5 + 60);
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
  {
    v11 = *((_DWORD *)a1 + 10);
    LODWORD(v10) = v6;
    WPP_SF_qqDD(0xEAu, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v1, v4, v10, v11);
  }
  return v6;
}
