/*
 * XREFs of NdisDeregisterDeviceEx @ 0x1C0014730
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisDeregisterDeviceEx(NDIS_HANDLE NdisDeviceHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(109LL, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, NdisDeviceHandle);
...
LABEL_9:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(110LL, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, NdisDeviceHandle);
}
