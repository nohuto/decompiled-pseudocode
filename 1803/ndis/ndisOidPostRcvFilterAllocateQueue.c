/*
 * XREFs of ndisOidPostRcvFilterAllocateQueue @ 0x1C003B630
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostRcvFilterAllocateQueue(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x10u, &WPP_968189b415313035a5e13c3867538638_Traceguids, v3, v1);
  if ( v3 )
  {
    if ( *(_DWORD *)(a1 + 40) )
    {
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x11u, &WPP_968189b415313035a5e13c3867538638_Traceguids, v3, *(_DWORD *)(a1 + 40));
}
