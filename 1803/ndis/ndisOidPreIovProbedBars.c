/*
 * XREFs of ndisOidPreIovProbedBars @ 0x1C00F3770
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovProbedBars(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qq(0x49u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v3, v1);
  v4 = 0;
  if ( *(_DWORD *)(v1 + 4) )
  {
    v5 = -1073741637;
...
LABEL_13:
  ...
  {
    v8 = v5;
    WPP_SF_qdD(0x4Au, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, v3, v4, v8);
  }
  return v4;
}
