/*
 * XREFs of ?NdisPDFreeMemory@@YAXPEAUPD_MEMORY_HANDLE__@@@Z @ 0x1C00F8340
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDFreeMemory(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_q(0x58u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)P);
  v4.m_State = Unlocked;
  ...
  *P = 0LL;
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_q(0x59u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)P);
}
