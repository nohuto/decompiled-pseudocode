/*
 * XREFs of ndisOidPreIovAllocateVF @ 0x1C00F2800
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovAllocateVF(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qqq(0x1Du, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, *a1, a1[3], v1);
  if ( v1[1] != 12 )
    goto LABEL_14;
  VF = 0;
  *((_DWORD *)a1 + 10) = 0;
...
LABEL_16:
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
  {
    v9 = *((_DWORD *)a1 + 10);
    LODWORD(v8) = VF;
    WPP_SF_qqDD(0x1Eu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, *a1, a1[3], v8, v9);
  }
  return VF;
}
