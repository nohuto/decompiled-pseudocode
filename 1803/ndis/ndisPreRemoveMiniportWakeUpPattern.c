/*
 * XREFs of ndisPreRemoveMiniportWakeUpPattern @ 0x1C00E2030
 * Callers:
...
bool __fastcall ndisPreRemoveMiniportWakeUpPattern(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x23u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2);
...
LABEL_24:
    v4 = 1;
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x24u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, a2);
  return v4;
}
