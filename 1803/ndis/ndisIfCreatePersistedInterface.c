/*
 * XREFs of ndisIfCreatePersistedInterface @ 0x1C0042630
 * Callers:
...
__int64 __fastcall ndisIfCreatePersistedInterface(union _NET_LUID_LH *a1, enum NdisIfBlockSource a2)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(0xBAu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1);
  ...
  InterfaceFromPersistentStore = ndisIfAllocateAndVerifyNetLuidIndex(Value_high, &v13, 0, 0);
...
LABEL_18:
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qD(0xBBu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1, InterfaceFromPersistentStore);
