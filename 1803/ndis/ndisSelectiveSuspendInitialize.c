/*
 * XREFs of ndisSelectiveSuspendInitialize @ 0x1C00F5884
 * Callers:
    ...
    || (v2 = FunctionContext[473], *(_QWORD *)(v2 + 840)) && *(_QWORD *)(v2 + 848) )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *(_QWORD *)(v4 + 600) = v5;
      if ( v5 )
      {
        *v5 = xmmword_1C0088CB0;
        v5[1] = xmmword_1C0088CC0;
        v5[2] = xmmword_1C0088CD0;
        v5[3] = xmmword_1C0088CE0;
        v5[4] = xmmword_1C0088CF0;
        v5[5] = xmmword_1C0088D00;
        v5[6] = xmmword_1C0088D10;
        *((_QWORD *)v5 + 14) = 0LL;
        *(_QWORD *)(v4 + 544) = 0LL;
      ...
      else
      {
        if ( (unsigned __int8)byte_1C0099616 >= 2u )
          WPP_SF_q(0xBu, &WPP_250ba6082b573e143e643b46f787ca55_Traceguids, (__int64)FunctionContext);
        ndisSelectiveSuspendFree((__int64)FunctionContext);
      }
    }
    else if ( (unsigned __int8)byte_1C0099616 >= 2u )
    {
      WPP_SF_q(0xAu, &WPP_250ba6082b573e143e643b46f787ca55_Traceguids, (__int64)FunctionContext);
    }
  }
}
