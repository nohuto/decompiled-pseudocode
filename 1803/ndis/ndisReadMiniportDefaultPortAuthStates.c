/*
 * XREFs of ndisReadMiniportDefaultPortAuthStates @ 0x1C00B4FD0
 * Callers:
...
__int64 __fastcall ndisReadMiniportDefaultPortAuthStates(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_q(0x35u, &WPP_f15752027639342d7f4a984ed5eb2bc7_Traceguids, a1);
...
LABEL_9:
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qD(0x36u, &WPP_f15752027639342d7f4a984ed5eb2bc7_Traceguids, a1, MiniportMediaSpecificPortAuthStates);
