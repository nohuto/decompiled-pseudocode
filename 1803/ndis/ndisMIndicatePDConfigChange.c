/*
 * XREFs of ndisMIndicatePDConfigChange @ 0x1C007840C
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( PDBlock )
  {
    ...
    if ( v12 )
    {
      ...
      if ( v14 )
      {
        ...
        {
          v15->Enabled = 0;
          if ( (unsigned __int8)byte_1C0099624 >= 3u )
            WPP_SF_q(0x41u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)a1);
        }
      }
  ...
  else if ( (unsigned __int8)byte_1C0099624 >= 3u )
  {
    WPP_SF_q(0x40u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)a1);
  }
  return v5;
}
