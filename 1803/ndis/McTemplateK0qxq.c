/*
 * XREFs of McTemplateK0qxq @ 0x1C004F298
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qxq(__int64 a1, __int64 a2, const GUID *a3, int a4, char a5, char a6)
{
  ...
  v10 = &a5;
  v12 = &a6;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &QueuedReceiveEnd, a3, 4u, &v7);
}
