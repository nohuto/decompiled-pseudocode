/*
 * XREFs of ?ndisSendPmOidsForSuspend@@YAHPEAU_NDIS_MINIPORT_BLOCK@@W4_DEVICE_POWER_STATE@@@Z @ 0x1C006EEDC
 * Callers:
 ...
 *     ?ndisAoAcIsDataPathPdcActivatorPresent@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0072CF8 (-ndisAoAcIsDataPathPdcActivatorPresent@@YAEPEAU_NDIS_MINIPORT_BLOCK@@@Z.c)
...
LABEL_14:
  ...
  *(_QWORD *)((char *)v11 + 4) = 1LL;
  ...
  if ( v5 )
  {
    ...
    NdisTraceLoggingUnexpectedSelectiveSuspendError(a1, 0x3AAu, v5);
    SelectiveSuspend->LastUnexpectedFailureLine[1] = SelectiveSuspend->LastUnexpectedFailureLine[0];
    SelectiveSuspend->LastUnexpectedFailureLine[0] = 938;
    if ( (unsigned __int8)byte_1C0099616 >= 2u )
    {
      v7 = 19;
LABEL_24:
      WPP_SF_dq(v7, &WPP_250ba6082b573e143e643b46f787ca55_Traceguids, v5, a1);
    }
  }
  else
  {
    ...
    *(_QWORD *)((char *)v11 + 4) = 1LL;
    ...
    if ( v5 )
    {
      ...
      NdisTraceLoggingUnexpectedSelectiveSuspendError(a1, 0x3CBu, v5);
      v8->LastUnexpectedFailureLine[1] = v8->LastUnexpectedFailureLine[0];
      v8->LastUnexpectedFailureLine[0] = 971;
      if ( (unsigned __int8)byte_1C0099616 >= 2u )
      {
        v7 = 20;
        goto LABEL_24;
