/*
 * XREFs of ndisReleaseReadWriteLockX @ 0x1C0024FD8
 * Callers:
 *     NdisReleaseReadWriteLock @ 0x1C0024FC0 (NdisReleaseReadWriteLock.c)
 *     NdisDprReleaseReadWriteLock @ 0x1C005B1E0 (NdisDprReleaseReadWriteLock.c)
 * Callees:
 *     ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C005B044 (-ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z.c)
 */
