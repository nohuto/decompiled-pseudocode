/*
 * XREFs of ?NdisTraceLoggingStuckNbl@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C0079DB4
 * Callers:
...
LABEL_6:
    if ( hProvider.LevelPlus1 > 5 )
    {
      if ( TlgKeywordOn(&hProvider, 0x400000000000uLL) )
      {
        ...
        v24 = (_QWORD *)(v5 + 4032);
        v25 = 16LL;
        TlgWrite(&hProvider, &unk_1C0085650, v2, v3, 4u, &pData);
      }
    }
    return;
  }
  if ( v1 == 1 )
  {
    if ( *((_QWORD *)a1->Context + 2) )
    {
      if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
      {
        ...
        *(_DWORD *)&pActivityId.Data2 = 0;
        TlgWrite(&hProvider, &unk_1C00863B0, &pActivityId, v11, 8u, &pData);
      }
    }
    else if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
    {
      ...
      v23 = 4LL;
      v25 = 16LL;
      TlgWrite(&hProvider, &unk_1C0086592, v17, v18, 4u, &pData);
    }
  }
  else
  {
    ...
    if ( hProvider.LevelPlus1 > 5 && TlgKeywordOn(&hProvider, 0x400000000000uLL) )
    {
      ...
      v25 = v9;
      v27[0] = v10;
      TlgWrite(&hProvider, &unk_1C0086561, v6, v7, 5u, &pData);
    }
  }
}
