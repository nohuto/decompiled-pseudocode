/*
 * XREFs of NdisGetRssProcessorInformation @ 0x1C001F990
 * Callers:
 *     ndisGetAdapterRssInfo @ 0x1C00E848C (ndisGetAdapterRssInfo.c)
 *     ndisGetHardwareInfo @ 0x1C00E8708 (ndisGetHardwareInfo.c)
 * Callees:
 *     ndisCalculateRssProcessorCount @ 0x1C001FA9C (ndisCalculateRssProcessorCount.c)
 *     ndisPopulateRssProcessorSet @ 0x1C001FB40 (ndisPopulateRssProcessorSet.c)
 */
        ...
        PSIZE_T Size)
{
  ...
  else
  {
    ...
    RssProcessorInfo->PreferredNumaNode = *((_WORD *)v6 + 2212);
    RssProcessorInfo->RssBaseProcessor = (PROCESSOR_NUMBER)*((_DWORD *)v6 + 1103);
    RssProcessorInfo[1].Header = (NDIS_OBJECT_HEADER)*((_DWORD *)v6 + 1104);
    RssProcessorInfo[1].Flags = *((_DWORD *)v6 + 1105);
    v8 = *((_DWORD *)v6 + 1102);
    if ( !v8 )
    {
      if ( *((_DWORD *)v6 + 380) == 1 )
