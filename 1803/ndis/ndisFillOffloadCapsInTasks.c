/*
 * XREFs of ndisFillOffloadCapsInTasks @ 0x1C0044EB8
 * Callers:
...
void __fastcall ndisFillOffloadCapsInTasks(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(0xE3u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, a1);
  v8 = *(_QWORD *)(a2 + 40);
  v9 = 28;
  v10 = *(_DWORD **)(a1 + 4120);
  v11 = *(_DWORD *)(v8 + 16);
  ...
  *(_DWORD *)(a2 + 52) = v9;
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(0xE4u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, a1);
}
