/*
 * XREFs of ?ndisCleanupPDRSSObjects@@YAXPEAUNDIS_PD_ASSOCIATION@@PEAU_LIST_ENTRY@@1@Z @ 0x1C00F9D14
 * Callers:
...
void __fastcall ndisCleanupPDRSSObjects(struct NDIS_PD_ASSOCIATION *a1, struct _LIST_ENTRY *a2, struct _LIST_ENTRY *a3)
{
  ...
  v14.m_Lock = (KPushLockBase *)qword_1C00996C8;
  ...
  while ( 1 )
  {
    ...
    if ( *v6 == (_LIST_ENTRY *)v6 )
      break;
    if ( (_LIST_ENTRY **)v7->Blink != v6 || (Flink = v7->Flink, v7->Flink->Blink != v7) )
      __fastfail(3u);
    *v6 = Flink;
  ...
  while ( 1 )
  {
    ...
    if ( *v10 == (_LIST_ENTRY *)v10 )
      break;
    if ( (_LIST_ENTRY **)v11->Blink != v10 || (v12 = v11->Flink, v11->Flink->Blink != v11) )
      __fastfail(3u);
    *v10 = v12;
