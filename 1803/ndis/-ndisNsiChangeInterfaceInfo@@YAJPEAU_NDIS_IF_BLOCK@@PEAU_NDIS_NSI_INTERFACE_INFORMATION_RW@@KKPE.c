/*
 * XREFs of ?ndisNsiChangeInterfaceInfo@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_NSI_INTERFACE_INFORMATION_RW@@KKPEAK@Z @ 0x1C002040C
 * Callers:
        ...
        unsigned __int16 *a5)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qq(120LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1, a2);
...
LABEL_14:
  ...
  *(_DWORD *)&ifL2NetworkInfo->Length = v16;
  if ( !v16 )
    v9 = -1073741811;
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qqd(121LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1, a2, v9);
  return v9;
}
