/*
 * XREFs of ndisOidPreRemovePMProtocolOffload @ 0x1C00B41C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRemovePMProtocolOffload(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x69u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, v5, v1);
    v6 = *(_QWORD *)(a1 + 24);
  }
  if ( v6
  ...
  *(_DWORD *)(v1 + 56) = 0;
  ...
  if ( v12 )
  {
    if ( (v8 & *(_DWORD *)(v1 + 88)) == 0 && !ndisFindPatternEntry(v12 + 872, v11) )
      goto LABEL_30;
  }
  if ( !*(_QWORD *)a1 )
    goto LABEL_12;
...
LABEL_12:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x6Au, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, *(_QWORD *)a1, *(_DWORD *)(a1 + 40));
  return v4;
}
