/*
 * XREFs of ?ndisNsiSetInterfaceInformation@@YAJPEAU_NM_REQUEST_SET_PARAMETER@@@Z @ 0x1C0040C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetInterfaceInformation(struct _NM_REQUEST_SET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(0x54u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1);
...
LABEL_15:
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qD(0x55u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1, v5);
  return v5;
}
