/*
 * XREFs of ndisIovGetNicSwitchList @ 0x1C0013498
 * Callers:
...
__int64 __fastcall ndisIovGetNicSwitchList(__int64 a1, __int64 *a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(85LL, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, a1);
  ...
  *(_DWORD *)(a1 + 1856) = 0;
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(86LL, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, a1, v4);
  return v4;
}
