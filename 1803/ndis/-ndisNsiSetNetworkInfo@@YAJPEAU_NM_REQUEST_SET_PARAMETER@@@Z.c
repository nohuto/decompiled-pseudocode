/*
 * XREFs of ?ndisNsiSetNetworkInfo@@YAJPEAU_NM_REQUEST_SET_PARAMETER@@@Z @ 0x1C0040E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetNetworkInfo(struct _NM_REQUEST_SET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_q(0x72u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1);
...
LABEL_31:
  ...
  if ( Flink->Blink != &v8->CompartmentLink || (Blink = v8->CompartmentLink.Blink, Blink->Flink != &v8->CompartmentLink) )
    __fastfail(3u);
  --ndisIfNetworkCount;
  Blink->Flink = Flink;
  Flink->Blink = Blink;
  ...
  v15 = v8->Link.Flink;
  if ( (struct _NDIS_IF_NETWORK_BLOCK *)v8->Link.Flink->Blink != v8
...
LABEL_32:
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qD(0x73u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (__int64)a1, v1);
  return v1;
}
