/*
 * XREFs of NdisMAllocateMapRegisters @ 0x1C010E570
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)MiniportAdapterHandle + 63) = v6;
      ...
      && (v21 = 0, v6[77]) )
    {
      ...
      {
        WPP_SF_d(0x2Bu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, v22);
        v23 = v33;
      }
...
LABEL_12:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x2Cu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)MiniportAdapterHandle, v7);
  return v7;
}
