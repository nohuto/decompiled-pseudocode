/*
 * XREFs of ndisMSetNative802_11Attributes @ 0x1C00EA29C
 * Callers:
...
__int64 __fastcall ndisMSetNative802_11Attributes(__int64 a1, int a2, int a3, int a4)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x7Cu, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1);
  if ( *(_QWORD *)(a1 + 768) )
  {
  ...
  else
  {
    ...
    {
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
        WPP_SF_q(0x7Du, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1);
    }
    else
    {
      *(_QWORD *)(a1 + 768) = v8;
