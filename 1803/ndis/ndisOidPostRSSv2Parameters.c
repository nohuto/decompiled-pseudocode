/*
 * XREFs of ndisOidPostRSSv2Parameters @ 0x1C007CF60
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostRSSv2Parameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqq(0x2Cu, &WPP_4fecf6d36e163aabb9bd41260a763457_Traceguids, v1, v4, v3);
  if ( *(_DWORD *)(v3 + 4) == 1 )
  {
    if ( v1 )
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
  {
    ...
    WPP_SF_qqd(0x2Du, &WPP_4fecf6d36e163aabb9bd41260a763457_Traceguids, v1, v4, v5);
  }
}
