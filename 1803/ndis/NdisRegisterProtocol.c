/*
 * XREFs of NdisRegisterProtocol @ 0x1C00E79E0
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall NdisRegisterProtocol(int *a1, __int64 *a2, char *a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)byte_1C009960C >= 4u )
    WPP_SF_Z(0xEu, &WPP_0f5804d9ba813936e0c202df1238e587_Traceguids, (const wchar_t *)a3 + 44);
...
LABEL_8:
  *a1 = v9;
  ...
  {
    LODWORD(v22) = v9;
    WPP_SF_qZL(0xFu, &WPP_0f5804d9ba813936e0c202df1238e587_Traceguids, v8, (const wchar_t *)a3 + 44, v22);
  }
  result = v24;
  if ( v24 )
  {
