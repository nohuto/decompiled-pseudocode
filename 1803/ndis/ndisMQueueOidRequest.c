/*
 * XREFs of ndisMQueueOidRequest @ 0x1C0046118
 * Callers:
...
__int64 __fastcall ndisMQueueOidRequest(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qq(0x15u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, a1, a2);
  *v3 = 0LL;
  v3[1] = 0LL;
...
LABEL_11:
  ...
  {
    v10 = v5;
    WPP_SF_qqd(0x16u, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, a1, a2, v10);
  }
  return v5;
}
