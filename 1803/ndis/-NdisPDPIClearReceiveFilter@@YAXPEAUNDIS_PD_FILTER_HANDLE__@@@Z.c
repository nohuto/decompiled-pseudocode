/*
 * XREFs of ?NdisPDPIClearReceiveFilter@@YAXPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C00F8C90
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDPIClearReceiveFilter(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_q(0x32u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)P);
  ...
  *v7 = 0LL;
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_q(0x33u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)P);
}
