/*
 * XREFs of ?NetPacketAssignLayoutWithArray@@YAXPEAPEAUNET_PACKET_EXTENSION_PRIVATE@@KPEAK@Z @ 0x1C00FE880
 * Callers:
 *     NetPacketComputeSizeAndUpdateExtensions @ 0x1C007D5D0 (NetPacketComputeSizeAndUpdateExtensions.c)
 * Callees:
 *     <none>
 */
...
void __fastcall NetPacketAssignLayoutWithArray(struct NET_PACKET_EXTENSION_PRIVATE **a1, __int64 a2, unsigned int *a3)
{
  ...
  *a3 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( !v11 )
      break;
    v12 = ~(*((_DWORD *)v11 + 5) - 1) & (*((_DWORD *)v11 + 5) + v8 - 1);
    v8 = v12 + *((_DWORD *)v11 + 2);
    *((_QWORD *)v11 + 3) = v12;
  }
LABEL_9:
