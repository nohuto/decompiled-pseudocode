/*
 * XREFs of ?ndisNsiChangeNetworkInfo@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@PEAU_NDIS_NSI_NETWORK_RW@@KKPEAK@Z @ 0x1C003F488
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qq(0x76u, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1, a2);
  v10 = a3;
  v34 = a3;
  v11 = a4;
  v12 = -1073741811;
...
LABEL_11:
  ...
  *a5 = v16;
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qqd(119LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1, a2, v9);
  return v9;
}
