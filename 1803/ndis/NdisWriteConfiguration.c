/*
 * XREFs of NdisWriteConfiguration @ 0x1C00B7AD0
 * Callers:
        ...
        PNDIS_CONFIGURATION_PARAMETER ParameterValue)
{
  ...
  if ( (unsigned __int8)byte_1C009960F >= 4u )
    WPP_SF_q(0x15u, &WPP_7638764ccf46397224acdca5d7787036_Traceguids, (__int64)ConfigurationHandle);
  *Status = 0;
...
LABEL_18:
  if ( (unsigned __int8)byte_1C009960F >= 4u )
    WPP_SF_q(0x16u, &WPP_7638764ccf46397224acdca5d7787036_Traceguids, (__int64)ConfigurationHandle);
}
