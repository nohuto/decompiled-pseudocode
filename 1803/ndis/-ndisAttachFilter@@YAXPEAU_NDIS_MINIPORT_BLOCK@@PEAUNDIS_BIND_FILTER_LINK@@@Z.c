/*
 * XREFs of ?ndisAttachFilter@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_FILTER_LINK@@@Z @ 0x1C00C5090
 * Callers:
...
void __fastcall ndisAttachFilter(struct _NDIS_MINIPORT_BLOCK *a1, struct NDIS_BIND_FILTER_LINK *a2)
{
  ...
  if ( v7 )
  {
      ...
      && (unsigned __int8)byte_1C0099623 >= 4u )
    {
      ...
      if ( (unsigned __int8)byte_1C0099623 >= 4u )
        WPP_SF_Zq(0x21u, &WPP_bee287f1cada383e7b1ca74881464cf2_Traceguids, (const wchar_t *)v8[1], v8[0]);
    }
