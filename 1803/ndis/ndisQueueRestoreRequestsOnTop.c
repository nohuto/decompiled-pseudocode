/*
 * XREFs of ndisQueueRestoreRequestsOnTop @ 0x1C00484B0
 * Callers:
 ...
 *     ndisFQueueOidRequest @ 0x1C0044E54 (ndisFQueueOidRequest.c)
...
__int64 __fastcall ndisQueueRestoreRequestsOnTop(__int64 a1, _QWORD **a2, int a3, char a4)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x3Du, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, a1, a3);
...
LABEL_11:
  ...
  if ( v16 )
  {
    ...
    if ( v5 )
    {
      ...
      *(_DWORD *)(v5 + 160) = 2298572;
      while ( 1 )
      {
        v19 = *a2;
        if ( *a2 == a2 )
          break;
        if ( (_QWORD **)v19[1] != a2 || (v20 = (_QWORD *)*v19, *(_QWORD **)(*v19 + 8LL) != v19) )
          __fastfail(3u);
        *a2 = v20;
        v20[1] = a2;
...
LABEL_50:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqd(0x3Eu, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v9, a2, v10);
  return v10;
}
