/*
 * XREFs of ndisRegisterMiniportDriver @ 0x1C010F5AC
 * Callers:
...
__int64 __fastcall ndisRegisterMiniportDriver(struct _DRIVER_OBJECT **a1, _QWORD *a2, unsigned int a3, PVOID *a4)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xEu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)a1);
  if ( !a1 )
  {
    v4 = -1073741823;
    goto LABEL_38;
...
LABEL_38:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xFu, &WPP_35a75e136a693dcd7e4be129c414b9c6_Traceguids, (__int64)DriverObjectExtension);
  return v4;
}
