/*
 * XREFs of NdisMCoIndicateStatus @ 0x1C0113F90
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG StatusBufferSize)
{
  ...
  if ( (unsigned __int8)byte_1C009961A >= 4u )
    WPP_SF_(0x33u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
  ...
  if ( (unsigned __int8)byte_1C009961A >= 4u )
    WPP_SF_(0x34u, &WPP_4751d4e37a7b3d0bd2bb7b74b42f4c5c_Traceguids);
}
