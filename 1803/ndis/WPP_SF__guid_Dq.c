/*
 * XREFs of WPP_SF__guid_Dq @ 0x1C0076128
 * Callers:
...
void WPP_SF__guid_Dq(unsigned __int16 a1, __int64 a2, __int64 a3, int a4, ...)
{
  ...
  va_start(va, a4);
  v4 = a4;
  ndisWppFastTraceMessage(&WPP_bee287f1cada383e7b1ca74881464cf2_Traceguids, a1, a3, 16LL, &v4, 4LL, va, 8LL, 0LL);
}
