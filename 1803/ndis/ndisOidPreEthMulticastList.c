/*
 * XREFs of ndisOidPreEthMulticastList @ 0x1C00C49B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisQueryMiniportEthMulticastList @ 0x1C00DF3F4 (ndisQueryMiniportEthMulticastList.c)
...
unsigned __int8 __fastcall ndisOidPreEthMulticastList(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qqqq(0x7Au, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v5, v3, v1, a1);
  v6 = *(_DWORD *)(v1 + 4);
  if ( v6 == 2 )
  {
    if ( *(_QWORD *)a1 )
...
LABEL_10:
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
  {
    ...
    LODWORD(v11) = v4;
    WPP_SF_qqDD(0x7Bu, &WPP_92d34e42f40030fdbbeb8d75cb2f24e9_Traceguids, v5, v3, v11, v12);
  }
  return v4;
}
