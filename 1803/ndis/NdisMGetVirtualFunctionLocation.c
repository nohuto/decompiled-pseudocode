/*
 * XREFs of NdisMGetVirtualFunctionLocation @ 0x1C00F1AD0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisMGetVirtualFunctionLocation(__int64 a1, unsigned __int16 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x77u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, a1);
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0x78u, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, a1);
}
