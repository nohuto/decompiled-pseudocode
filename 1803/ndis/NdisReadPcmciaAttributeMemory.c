/*
 * XREFs of NdisReadPcmciaAttributeMemory @ 0x1C00628C0
 * Callers:
 *     <none>
 * Callees:
...
ULONG __stdcall NdisReadPcmciaAttributeMemory(NDIS_HANDLE NdisAdapterHandle, ULONG Offset, PVOID Buffer, ULONG Length)
{
  ...
  if ( (unsigned __int8)byte_1C009960E >= 4u )
    WPP_SF_q(0x1Cu, &WPP_664e81fe3e98381b8a075dcdfaa02fe6_Traceguids, (__int64)NdisAdapterHandle);
  SetBusConfigSpace = ndisGetSetBusConfigSpace((_DWORD)NdisAdapterHandle, Offset, v5, Length, 1, 1);
  v9 = SetBusConfigSpace;
  if ( (unsigned __int8)byte_1C009960E >= 4u )
    WPP_SF_qD(0x1Du, &WPP_664e81fe3e98381b8a075dcdfaa02fe6_Traceguids, (__int64)NdisAdapterHandle, SetBusConfigSpace);
  return v9;
}
