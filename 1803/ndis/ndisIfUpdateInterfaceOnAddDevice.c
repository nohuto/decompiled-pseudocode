/*
 * XREFs of ndisIfUpdateInterfaceOnAddDevice @ 0x1C001D500
 * Callers:
...
__int64 __fastcall ndisIfUpdateInterfaceOnAddDevice(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)&DestinationString.Length = 0;
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qq(182LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, a1, a2);
  if ( !*(_WORD *)(v5 + 8)
    || (RtlInitUnicodeString(&DestinationString, (PCWSTR)(v5 + 10)),
        RtlCompareUnicodeString(&DestinationString, *(PCUNICODE_STRING *)(v3 + 3880), 1u)) )
  {
    v4 = 1;
  }
  LOBYTE(a2) = 2;
  ...
  else
  {
    if ( v4 )
    {
      ...
      v11 = 512;
      if ( **(_WORD **)(v3 + 3880) <= 0x200u )
        v11 = **(_WORD **)(v3 + 3880);
      *(_WORD *)(v5 + 8) = v11;
      if ( v11 )
        memmove((void *)(v5 + 10), *(const void **)(*(_QWORD *)(v3 + 3880) + 8LL), v11);
    }
    v9 = *(struct _NDIS_REFCOUNT_BLOCK **)(v5 + 1440);
    *(_DWORD *)(v5 + 1192) = *(_DWORD *)(v3 + 4084);
    *(_QWORD *)(v5 + 1112) = 2LL;
    ...
    *(_DWORD *)(v3 + 4080) = *(_DWORD *)(v5 + 4);
    *(_QWORD *)(v3 + 4048) = *(_QWORD *)(v5 + 1312);
    *(_DWORD *)(v3 + 4088) = *(_DWORD *)(v5 + 1112);
    *(_DWORD *)(v3 + 4092) = 0;
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_qqd(183LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, v5, v3, v2);
  return v2;
}
