/*
 * XREFs of ?NdisPDPIQueueControl@@YAJPEAU_NDIS_PD_QUEUE@@W4NDIS_PD_CONTROL_TYPE@@W4NDIS_PD_QUEUE_CONTROL_CODE@@PEAXK3KPEAK@Z @ 0x1C00F90B0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a8)
{
  ...
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
    WPP_SF_qdD(0x34u, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)a1, a2, a3);
...
LABEL_27:
  ...
  if ( (v15 & 0x80000000) == 0 )
  {
    ...
    WPP_SF_qD(v18, &WPP_a3b9db0bffd8342d0da72f7b6cff8d15_Traceguids, (__int64)a1, v17);
  }
LABEL_12:
  if ( (unsigned __int8)byte_1C0099624 >= 4u )
  {
