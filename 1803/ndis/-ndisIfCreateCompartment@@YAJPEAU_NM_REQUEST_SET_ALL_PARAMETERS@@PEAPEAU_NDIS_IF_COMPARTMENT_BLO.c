/*
 * XREFs of ?ndisIfCreateCompartment@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@PEAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@@Z @ 0x1C003E5D8
 * Callers:
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a2)
{
  ...
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_(0x9Cu, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids);
  *a2 = 0LL;
...
LABEL_29:
  if ( (unsigned __int8)byte_1C009961D >= 4u )
    WPP_SF_dq(157LL, &WPP_9c0a9a3d131c324463ce0f9e1e19d9c6_Traceguids, (unsigned int)Network, *a2);
