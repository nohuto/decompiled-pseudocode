/*
 * XREFs of ndisIovCreateDefaultNicSwitch @ 0x1C00B6CD8
 * Callers:
...
__int64 __fastcall ndisIovCreateDefaultNicSwitch(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_q(0xAu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1);
...
LABEL_6:
  if ( (unsigned __int8)byte_1C0099621 >= 4u )
    WPP_SF_qD(0xBu, &WPP_63e421b5d75535977b2a1141380f2a99_Traceguids, (__int64)a1, SwitchConfiguration);
