/*
 * XREFs of ?NdisTraceLoggingChecksumHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C001E560
 * Callers:
...
void __fastcall NdisTraceLoggingChecksumHardwareOffloads(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( hProvider.LevelPlus1 > 5 )
  {
    if ( TlgKeywordOn(&hProvider, 0x200000000000uLL) )
    {
      ...
      v30 = (v10 >> 6) & 3;
      v81 = 1LL;
      TlgWrite(&hProvider, &unk_1C008610F, v2, (LPCGUID)v3, 0x19u, &pData);
    }
  }
}
