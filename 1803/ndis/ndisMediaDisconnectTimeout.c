/*
 * XREFs of ndisMediaDisconnectTimeout @ 0x1C0066380
 * Callers:
 *     <none>
 * Callees:
  ...
  *((_DWORD *)FunctionContext + 464) = 0;
  ...
  if ( (v6 & 8) != 0 )
  {
    *((_DWORD *)FunctionContext + 31) = v6 & 0xFFFFFFF7;
    ...
    {
      ndisDereferenceMiniport((__int64)FunctionContext, 0xBu, v10, v11);
    }
  }
  else
  {
    KeReleaseSpinLockFromDpcLevel(v5);
    ndisDereferenceMiniport((__int64)FunctionContext, 0xBu, v7, v8);
    if ( (unsigned __int8)byte_1C0099615 < 4u )
      return;
