/*
 * XREFs of McTemplateK0jqxjqxqq @ 0x1C0075F34
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jqxjqxqq(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a11)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &FilterChangedMediaType, a3, 9u, &v12);
}
