/*
 * XREFs of NdisMResetComplete @ 0x1C005EDD0
 * Callers:
...
void __stdcall NdisMResetComplete(NDIS_HANDLE MiniportAdapterHandle, NDIS_STATUS Status, BOOLEAN AddressingReset)
{
  ...
  if ( (unsigned __int8)byte_1C0099618 >= 4u )
    WPP_SF_q(0x4Du, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, (__int64)MiniportAdapterHandle);
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 726561;
  if ( v8 )
  {
    DbgPrintEx(
      0x78u,
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 0;
  ...
  if ( (unsigned __int8)byte_1C0099618 >= 4u )
    WPP_SF_q(0x4Eu, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, (__int64)MiniportAdapterHandle);
}
