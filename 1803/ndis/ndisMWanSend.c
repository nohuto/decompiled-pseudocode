/*
 * XREFs of ndisMWanSend @ 0x1C0057E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisMWanSend(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qq(0x1Cu, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a3);
  v9 = *(_DWORD *)(v3 + 120);
  if ( v9 < 0 )
    return 3221225473LL;
  if ( (v9 & 0x40000) == 0 )
...
LABEL_21:
  ...
  if ( (unsigned __int8)byte_1C009960A >= 4u )
    WPP_SF_qqd(0x1Du, &WPP_10c516cfdf9a37727f745c84f8b2ed3d_Traceguids, a1, a3, v12);
  return v12;
}
