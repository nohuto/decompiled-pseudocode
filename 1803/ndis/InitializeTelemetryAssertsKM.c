/*
 * XREFs of InitializeTelemetryAssertsKM @ 0x1C00149C8
 * Callers:
...
__int64 __fastcall InitializeTelemetryAssertsKM(const void **a1, ETWENABLECALLBACK *a2, void *a3)
{
  ...
  qword_1C0098D58 = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
  g_MicrosoftTelemetryAssertsTriggeredList = (__int64)&g_MicrosoftTelemetryAssertsTriggeredList;
  RegistryValues = -1073741801;
  TraceLoggingRegisterEx(&stru_1C00AB010, a2, a3);
  TraceLoggingRegisterEx(&stru_1C00AB090, v5, v6);
  TraceLoggingRegisterEx(&stru_1C00AB050, v7, v8);
