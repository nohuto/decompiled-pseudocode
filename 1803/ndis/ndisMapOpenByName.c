/*
 * XREFs of ndisMapOpenByName @ 0x1C004FF0C
 * Callers:
...
__int64 __fastcall ndisMapOpenByName(PCUNICODE_STRING SourceString, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C009960D >= 4u )
    WPP_SF_Zq(0x23u, &WPP_47403e85a6be3c322bcf4a109a5fff7e_Traceguids, &SourceString->Length, a2);
...
LABEL_17:
    ...
    if ( (unsigned __int8)byte_1C009960D >= 4u )
      WPP_SF_q(0x25u, &WPP_47403e85a6be3c322bcf4a109a5fff7e_Traceguids, v4);
    return v4;
  }
  else
  {
    if ( (unsigned __int8)byte_1C009960D >= 2u )
      WPP_SF_(0x24u, &WPP_47403e85a6be3c322bcf4a109a5fff7e_Traceguids);
    return 0LL;
  }
}
