/*
 * XREFs of NdisFreeSharedMemory @ 0x1C0012F50
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisFreeSharedMemory(NDIS_HANDLE NdisHandle, NDIS_HANDLE AllocationHandle)
{
  ...
  if ( (unsigned __int8)byte_1C009961C >= 4u )
    WPP_SF_q(23LL, &WPP_b7380f6131c0382fffce9713ea39f3ba_Traceguids, AllocationHandle);
  if ( NdisHandle )
  {
...
LABEL_17:
  if ( (unsigned __int8)byte_1C009961C >= 4u )
    WPP_SF_(24LL, &WPP_b7380f6131c0382fffce9713ea39f3ba_Traceguids);
}
