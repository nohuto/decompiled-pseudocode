/*
 * XREFs of NdisFIndicateStatus @ 0x1C0021F90
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x1C0025E40 (memmove.c)
 *     WPP_SF_qD @ 0x1C003A870 (WPP_SF_qD.c)
 *     NdisIsStatusIndicationCloneable @ 0x1C0059570 (NdisIsStatusIndicationCloneable.c)
...
void __stdcall NdisFIndicateStatus(NDIS_HANDLE NdisFilterHandle, PNDIS_STATUS_INDICATION StatusIndication)
{
  ...
  _QWORD v11[7]; // [rsp+48h] [rbp-40h] BYREF
