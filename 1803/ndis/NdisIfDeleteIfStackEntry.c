/*
 * XREFs of NdisIfDeleteIfStackEntry @ 0x1C0041460
 * Callers:
 ...
 * Callees:
 *     ?ndisIfFindStackEntry@@YAPEAU_NDIS_IF_STACK_ENTRY@@KK@Z @ 0x1C002072C (-ndisIfFindStackEntry@@YAPEAU_NDIS_IF_STACK_ENTRY@@KK@Z.c)
