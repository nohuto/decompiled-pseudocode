/*
 * XREFs of ndisMSetSriovAttributes @ 0x1C00B3A00
 * Callers:
 ...
 *     ndisIovInitVf @ 0x1C00F2378 (ndisIovInitVf.c)
 */
...
__int64 __fastcall ndisMSetSriovAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qq(0x86u, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 48);
...
LABEL_36:
  ...
  if ( !*(_BYTE *)(v7 + 1)
    || *(_WORD *)(v7 + 2) < 0xCu
    || (*(_BYTE *)(v5 + 8) & 3) == 3 && ((v8 = *(_QWORD *)(a1 + 3576)) == 0 || *(_BYTE *)(v8 + 1) < 2u)
    || (*(_BYTE *)(v7 + 8) & 3) == 3 && ((v16 = *(_QWORD *)(a1 + 3584)) == 0 || *(_BYTE *)(v16 + 1) < 2u) )
  {
    LocallyUniqueId = -1073741811;
LABEL_38:
    v17 = *(void **)(a1 + 4640);
    ...
    *(_QWORD *)(a1 + 4640) = v12;
    if ( v12 )
    {
      *(_QWORD *)v12 = 0LL;
      ...
      if ( v14 < 0xCu )
        v6 = v14;
      memmove(*(void **)(a1 + 4640), v13, v6);
      LocallyUniqueId = ZwAllocateLocallyUniqueId((PLUID)(a1 + 4908));
      if ( !LocallyUniqueId )
      {
...
LABEL_22:
  if ( (unsigned __int8)byte_1C0099614 >= 4u )
    WPP_SF_qqd(0x87u, &WPP_3541b357d8fa39ee5aefec47eeb5df8d_Traceguids, a1, a2, LocallyUniqueId);
