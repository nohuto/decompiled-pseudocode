/*
 * XREFs of ndisCreateNdisSupportedOidList @ 0x1C00C9E48
 * Callers:
...
__int64 __fastcall ndisCreateNdisSupportedOidList(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(0x13u, &WPP_5cfddc9aaef33c7b7f0ecdd8ea162ffb_Traceguids, a1);
  v3 = *(_BYTE *)(a1 + 32);
  v4 = v3 < 6u ? 45 : 81;
  if ( !*(_DWORD *)(a1 + 464) )
  {
  ...
  *(_QWORD *)(a1 + 3416) = PoolWithTag;
    ...
    *((_DWORD *)PoolWithTag + 44) = *((_DWORD *)&ndisHandledNdis5Ndis6GenOids + 44);
    if ( *(_BYTE *)(a1 + 32) >= 6u )
    {
      ...
      *v8 = ndisHandledNdis6OnlyGenOids;
      v8[1] = *(_OWORD *)(0x1C0000000LL + 1155232);
      v8[2] = *(_OWORD *)(0x1C0000000LL + 1155248);
      v8[3] = *(_OWORD *)(0x1C0000000LL + 1155264);
      v8[4] = *(_OWORD *)(0x1C0000000LL + 1155280);
      v8[5] = *(_OWORD *)(0x1C0000000LL + 1155296);
      v8[6] = *(_OWORD *)(0x1C0000000LL + 1155312);
      v8[7] = *(_OWORD *)(0x1C0000000LL + 1155328);
      v8[8] = *(_OWORD *)(0x1C0000000LL + 1155344);
    }
    if ( !*(_DWORD *)(a1 + 464) )
    {
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_qD(0x14u, &WPP_5cfddc9aaef33c7b7f0ecdd8ea162ffb_Traceguids, a1, v2);
  return v2;
}
