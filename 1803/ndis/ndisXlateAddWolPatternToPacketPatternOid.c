/*
 * XREFs of ndisXlateAddWolPatternToPacketPatternOid @ 0x1C00E3C9C
 * Callers:
 ...
 *     ??$?8U_NDIS_PM_WOL_PATTERN@@U?$KFreePool@U_NDIS_PM_WOL_PATTERN@@@@@wistd@@YA_NAEBV?$unique_ptr@U_NDIS_PM_WOL_PATTERN@@U?$KFreePool@U_NDIS_PM_WOL_PATTERN@@@@@0@$$T@Z @ 0x1C004940C (--$-8U_NDIS_PM_WOL_PATTERN@@U-$KFreePool@U_NDIS_PM_WOL_PATTERN@@@@@wistd@@YA_NAEBV-$unique_ptr@U.c)
 */
  ...
  *a2 = 0;
  ...
  if ( v6 != 1 )
  {
    if ( (unsigned __int8)byte_1C0099612 >= 4u )
      WPP_SF_qD(0x6Fu, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1, v6);
    *a2 = 1;
  ...
  if ( !wistd::operator==<_NDIS_PM_WOL_PATTERN,KFreePool<_NDIS_PM_WOL_PATTERN>>(&v18) )
  {
    ...
    *((_DWORD *)v8 + 4) = *(_DWORD *)(a1 + 48);
    ...
    if ( v10 >= v9 )
    {
      ...
      if ( (unsigned __int8)byte_1C0099612 >= 4u )
        WPP_SF_q(0x72u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1);
      *a2 = 1;
      v3 = -1073741670;
      if ( v14 )
    ...
    {
      if ( (unsigned __int8)byte_1C0099612 >= 4u )
        WPP_SF_q(0x71u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1);
      v3 = -1073741811;
      *a2 = 1;
    }
    goto LABEL_11;
  ...
  if ( (unsigned __int8)byte_1C0099612 >= 4u )
    WPP_SF_q(0x70u, &WPP_d12fdc15689b3d7ca51f3c07eaaf9a95_Traceguids, a1);
  *a2 = 1;
  v3 = -1073741670;
  if ( v8 )
LABEL_11:
