/*
 * XREFs of ndisFreePacketPool @ 0x1C0051AD8
 * Callers:
 *     NdisFreePacketPool @ 0x1C00516B0 (NdisFreePacketPool.c)
 *     ndisVerifierFreePacketPool @ 0x1C0066DF0 (ndisVerifierFreePacketPool.c)
 * Callees:
...
void __fastcall ndisFreePacketPool(struct _NDIS_PKT_POOL *a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( p_FreeBlocks->Flink == p_FreeBlocks )
      break;
    if ( *((_LIST_ENTRY **)v7 + 1) != p_FreeBlocks || (v8 = *(_LIST_ENTRY **)v7, *(char **)(*(_QWORD *)v7 + 8LL) != v7) )
      __fastfail(3u);
