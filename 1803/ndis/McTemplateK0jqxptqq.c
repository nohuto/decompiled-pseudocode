/*
 * XREFs of McTemplateK0jqxptqq @ 0x1C0043424
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jqxptqq(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a10)
{
  ...
  v23 = 4LL;
  v25 = 4LL;
  return McGenEventWriteKM(NDIS_PROVIDER_ID_Context, &DoOidRequest, a3, 8u, &v11);
}
