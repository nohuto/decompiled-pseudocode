/*
 * XREFs of ??_GCEndpointInstance@@QEAAPEAXI@Z @ 0x14002F180
 * Callers:
 ...
 *     ??1?$unique_ptr@VCEndpointInstance@@U?$default_delete@VCEndpointInstance@@@wistd@@@wistd@@QEAA@XZ @ 0x1400303DC (--1-$unique_ptr@VCEndpointInstance@@U-$default_delete@VCEndpointInstance@@@wistd@@@wistd@@QEAA@X.c)
 *     ??1CAPOEndpointProcessNode@@UEAA@XZ @ 0x14003E5EC (--1CAPOEndpointProcessNode@@UEAA@XZ.c)
 *     ??1?$CAutoPtr@VCEndpointInstance@@@ATL@@QEAA@XZ @ 0x140040670 (--1-$CAutoPtr@VCEndpointInstance@@@ATL@@QEAA@XZ.c)
 * Callees:
