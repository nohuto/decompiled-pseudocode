/*
 * XREFs of ?GetVolumeCoefficients@CSystemAudioDeviceOffloadGraph@@UEAAJIPEAM@Z @ 0x14003D180
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_15ea582e738f3272a62e13fe333fda5a_Traceguids, v6);
    }
