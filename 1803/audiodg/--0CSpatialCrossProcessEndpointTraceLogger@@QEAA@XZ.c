/*
 * XREFs of ??0CSpatialCrossProcessEndpointTraceLogger@@QEAA@XZ @ 0x1400593EC
 * Callers:
 ...
 *     ??0?$CAggregateTelemetryClustered@W4SpatialCpGlitchEvent@@PEAI$0A@$0A@@@QEAA@PEAV?$CAggregateValuesClusteredBase@W4SpatialCpGlitchEvent@@PEAI@@_K11@Z @ 0x14005930C (--0-$CAggregateTelemetryClustered@W4SpatialCpGlitchEvent@@PEAI$0A@$0A@@@QEAA@PEAV-$CAggregateVal.c)
        ...
        CSpatialCrossProcessEndpointTraceLogger *this)
{
  ...
  *((_QWORD *)this + 60) = 0LL;
  *((_QWORD *)this + 61) = 0LL;
  CAggregateTelemetryLazyUpdate<CSpatialCrossProcessEndpointTraceLogger::CSpatialAudioObjectCountValues,enum SpatialObjectCountTypes,unsigned int,1,0>::SetPeriod(
    (char *)this + 448,
    180000LL);
  return this;
}
