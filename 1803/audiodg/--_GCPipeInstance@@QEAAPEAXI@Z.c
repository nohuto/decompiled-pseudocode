/*
 * XREFs of ??_GCPipeInstance@@QEAAPEAXI@Z @ 0x14002F3F4
 * Callers:
 ...
 *     ??1?$unique_ptr@VCPipeInstance@@U?$default_delete@VCPipeInstance@@@wistd@@@wistd@@QEAA@XZ @ 0x1400301A0 (--1-$unique_ptr@VCPipeInstance@@U-$default_delete@VCPipeInstance@@@wistd@@@wistd@@QEAA@XZ.c)
 * Callees:
