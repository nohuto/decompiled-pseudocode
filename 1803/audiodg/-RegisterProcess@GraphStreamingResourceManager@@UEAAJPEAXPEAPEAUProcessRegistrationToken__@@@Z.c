/*
 * XREFs of ?RegisterProcess@GraphStreamingResourceManager@@UEAAJPEAXPEAPEAUProcessRegistrationToken__@@@Z @ 0x1400045E0
 * Callers:
 ...
 *     ?InitialRegisterForProcess@GraphStreamingResourceManager@@EEAAJPEAXPEAU_t@HandleRegistrations@1@@Z @ 0x140004360 (-InitialRegisterForProcess@GraphStreamingResourceManager@@EEAAJPEAXPEAU_t@HandleRegistrations@1@.c)
 *     ?GetNode@?$CAtlMap@KUListValue@HandleRegistrations@GraphStreamingResourceManager@@V?$CElementTraits@K@ATL@@V?$CElementTraits@UListValue@HandleRegistrations@GraphStreamingResourceManager@@@5@@ATL@@AEBAPEAVCNode@12@KAEAI0AEAPEAV312@@Z @ 0x14000797C (-GetNode@-$CAtlMap@KUListValue@HandleRegistrations@GraphStreamingResourceManager@@V-$CElementTra.c)
        ...
        struct ProcessRegistrationToken__ **a3)
{
  ...
  _QWORD v21[4]; // [rsp+58h] [rbp-70h] BYREF
  _BYTE v22[8]; // [rsp+78h] [rbp-50h] BYREF
