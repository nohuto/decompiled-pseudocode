/*
 * XREFs of ?GetLastErrorFailHr@details@wil@@YAJXZ @ 0x140031774
 * Callers:
 ...
 * Callees:
 *     ?GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z @ 0x14003170C (-GetLastErrorFail@details@wil@@YAKPEAXIPEBD110@Z.c)
 */
