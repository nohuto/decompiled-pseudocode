/*
 * XREFs of ?AddValue@CRegParser@ATL@@IEAAJAEAVCRegKey@2@PEBGPEAG@Z @ 0x14005082C
 * Callers:
 ...
 *     ??$AtlMultiplyThrow@_K@ATL@@YA_K_K0@Z @ 0x140044DA0 (--$AtlMultiplyThrow@_K@ATL@@YA_K_K0@Z.c)
 ...
 *     ?SetMultiStringValue@CRegKey@ATL@@QEAAJPEBG0@Z @ 0x140052EA4 (-SetMultiStringValue@CRegKey@ATL@@QEAAJPEBG0@Z.c)
 *     ?SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ @ 0x140052F90 (-SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ.c)
 *     ?VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z @ 0x1400533B4 (-VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z.c)
 */
