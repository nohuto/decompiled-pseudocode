/*
 * XREFs of ?IncreaseProcessWorkingSet@@YAJ_K@Z @ 0x1400455F8
 * Callers:
 ...
 *     ?AERTLockMemory@@YAJPEAX_K@Z @ 0x140045270 (-AERTLockMemory@@YAJPEAX_K@Z.c)
 *     ?AERTLockZoneHeap@@YAJPEAX@Z @ 0x1400452C8 (-AERTLockZoneHeap@@YAJPEAX@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x14001BC70 (__security_check_cookie.c)
 *     WPP_SF_D @ 0x140034C3C (WPP_SF_D.c)
 *     WPP_SF_PP @ 0x140045794 (WPP_SF_PP.c)
...
LABEL_13:
  ...
  if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x15u, (__int64)&WPP_14502ebd56cd3c22b5b969b047a5e1b2_Traceguids, v7);
  }
  return v7;
}
