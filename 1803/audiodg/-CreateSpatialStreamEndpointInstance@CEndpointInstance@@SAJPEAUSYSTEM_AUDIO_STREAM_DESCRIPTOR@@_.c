/*
 * XREFs of ?CreateSpatialStreamEndpointInstance@CEndpointInstance@@SAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@_JIPEAUSYSTEM_AUDIO_STREAM@@PEAPEAV1@@Z @ 0x1400407D0
 * Callers:
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    ...
    WPP_SF_DDD(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      0xEu,
      (__int64)&WPP_5aa50ee117a7329902bac0d78754971b_Traceguids,
      v10);
    v13 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  v14 = *((_QWORD *)a1 + 2);
...
LABEL_16:
  if ( v13 != &WPP_GLOBAL_Control && (*((_DWORD *)v13 + 7) & 0x20000) != 0 && *((_BYTE *)v13 + 25) >= 2u )
    WPP_SF_D((__int64)v13[2], 0x11u, (__int64)&WPP_5aa50ee117a7329902bac0d78754971b_Traceguids, started);
