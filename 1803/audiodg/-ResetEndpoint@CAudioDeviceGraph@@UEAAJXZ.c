/*
 * XREFs of ?ResetEndpoint@CAudioDeviceGraph@@UEAAJXZ @ 0x140040130
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *((_DWORD *)this + 64) )
  {
    ...
    if ( v7 >= 0 )
    {
      ...
      if ( v7 >= 0 )
      {
        ...
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Bu, (__int64)&WPP_3dcabf6e46fe37d8e2cf6f9c2f959793_Traceguids);
          goto LABEL_32;
        }
      }
      else
    ...
    else
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        v8 = 25;
LABEL_21:
        WPP_SF_D((__int64)v4[2], v8, (__int64)&WPP_3dcabf6e46fe37d8e2cf6f9c2f959793_Traceguids, v7);
LABEL_32:
        v4 = (_UNKNOWN **)WPP_GLOBAL_Control;
      }
    }
...
LABEL_4:
  if ( v4 != &WPP_GLOBAL_Control && (*((_DWORD *)v4 + 7) & 0x20000) != 0 && *((_BYTE *)v4 + 25) >= 2u )
    WPP_SF_D((__int64)v4[2], 0x1Cu, (__int64)&WPP_3dcabf6e46fe37d8e2cf6f9c2f959793_Traceguids, v3);
  AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::ResetEndpoint", 0x262u, v3);
LABEL_9:
  if ( v1 )
