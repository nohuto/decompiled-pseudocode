/*
 * XREFs of ?LogSetClientEvent@CSpatialCrossProcessEndpointTraceLogger@@QEAAXXZ @ 0x14005A550
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140087130 > 5 )
  {
    ...
    v5 = (char *)this + 8;
    v6 = 16;
    TlgWrite((TraceLoggingHProvider)&dword_140087130, &unk_14007089D, 0LL, a4, 3u, &pData);
  }
}
