/*
 * XREFs of ?ProcessComplete@CSpatialCrossProcessServerInputEndpoint@@UEAAJXZ @ 0x14005FA70
 * Callers:
 *     <none>
 * Callees:
        ...
        CSpatialCrossProcessServerInputEndpoint *this)
{
  ...
  if ( !*((_BYTE *)this + 56) )
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessServerInputEndpoint::ProcessComplete", 142, v1);
  return v1;
}
