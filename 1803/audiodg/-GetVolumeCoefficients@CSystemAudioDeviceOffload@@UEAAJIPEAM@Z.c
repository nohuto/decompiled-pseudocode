/*
 * XREFs of ?GetVolumeCoefficients@CSystemAudioDeviceOffload@@UEAAJIPEAM@Z @ 0x14003BF10
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, (__int64)&WPP_1c5487218bb03e28dff4809d6fd419ee_Traceguids, v6);
    }
