/*
 * XREFs of ?Log@?$LogarithmicLogger@$1?SpatialCPTraceLoggingErrorHelper@@YAXPEBDIJ@Z$0?HHIDPPJO@@@QEAAXPEBDIJ@Z @ 0x14005CBB0
 * Callers:
        ...
        int a4)
{
  ...
  if ( a4 != -2005139358 )
  {
    v5 = a4;
LABEL_9:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetPingPongReadIndex", 675, v5);
    return;
  }
  if ( ++*a1 == a1[1] )
  {
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetPingPongReadIndex", 675, -2005139358);
    a1[1] *= 2;
    return;
  }
