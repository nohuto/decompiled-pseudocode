/*
 * XREFs of ?GetPosition_Offload@CCrossProcessClientOutputEndpoint@@IEAAJPEA_K0@Z @ 0x140056400
 * Callers:
        ...
        unsigned __int64 *a3)
{
  ...
  v3 = *((_QWORD *)this + 8);
  v31 = _InterlockedCompareExchange((volatile signed __int32 *)(v3 + 156), 0, 0);
  v7 = 0;
  if ( (v31 & 4) != 0 )
  {
    v3 = 3LL;
    ...
    if ( v13 && (_DWORD)v8 == v14 )
    {
      *a2 = v34;
      ...
      v28 = *(_QWORD *)(*((_QWORD *)this + 8) + 16LL) / (unsigned __int64)*((unsigned int *)this + 20);
      v35 = v28;
      if ( v23 > v28 )
      {
        if ( (unsigned int)dword_140087020 > 5 )
        {
          v36 = this;
          v40 = &v36;
          v42 = &v34;
          ...
          v47 = 8LL;
          v49 = 8LL;
          TlgWrite((TraceLoggingHProvider)&dword_140087020, &unk_140070405, 0LL, (LPCGUID)v3, 7u, &pData);
          v28 = v35;
        }
        *a2 = v28;
      }
  ...
  if ( (unsigned int)dword_140087020 > 5 )
  {
    ...
    v57 = &v38;
    v58 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_140087020, &unk_140070473, 0LL, (LPCGUID)v3, 6u, &v50);
  }
  if ( v7 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, (__int64)&WPP_db619c76aadb3ae58938d7fbad798ece_Traceguids, v7);
    }
