/*
 * XREFs of ?StopStream@CSubmixImpl@@UEAAJ_K@Z @ 0x1400056D0
 * Callers:
 *     ?StopStream@CProcessSubmix@@UEAAJ_K@Z @ 0x140002690 (-StopStream@CProcessSubmix@@UEAAJ_K@Z.c)
 *     ?StopStream@CStreamGroup@@UEAAJ_K@Z @ 0x140034820 (-StopStream@CStreamGroup@@UEAAJ_K@Z.c)
 * Callees:
