/*
 * XREFs of ?RemovePipe@CSubmixImpl@@UEAAJPEAVCPipeInstance@@@Z @ 0x140005420
 * Callers:
...
LABEL_8:
  ...
  {
    v7 = *(int (**)(CSystemAudioDeviceSharedBase *__hidden, struct CPipeInstance *))(*(_QWORD *)v14 + 48LL);
    if ( v7 == CSystemAudioDeviceSharedBase::RemovePipe )
      v8 = CSystemAudioDeviceSharedBase::RemovePipe(v14, a2);
    else
      v8 = ((__int64 (__fastcall *)(CSystemAudioDeviceSharedBase *, struct CPipeInstance *))v7)(v14, a2);
    v6 = v8;
    if ( v8 >= 0 )
    {
      if ( v14 )
