/*
 * XREFs of ?IsLeftFormatSupported@CAPOProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x14000D7B0
 * Callers:
        ...
        struct IAudioMediaType *a4)
{
  ...
  if ( v8 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAPOProcessNode::IsLeftFormatSupported", 0x25Eu, v9);
  }
  return v9;
}
