/*
 * XREFs of ?Initialize@CSystemAudioDeviceOffloadGraph@@UEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@PEAUIAudioGraphCallback@@K@Z @ 0x14003D250
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DeviceInUse@AEError@@YA_NJ@Z @ 0x14003B7A4 (-DeviceInUse@AEError@@YA_NJ@Z.c)
        ...
        unsigned int a4)
{
  ...
  __int128 v27; // [rsp+58h] [rbp-20h] BYREF
  ...
  *((_DWORD *)this + 60) = *((_DWORD *)a2 + 34);
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, (__int64)&WPP_15ea582e738f3272a62e13fe333fda5a_Traceguids);
    v9 = a2;
  }
