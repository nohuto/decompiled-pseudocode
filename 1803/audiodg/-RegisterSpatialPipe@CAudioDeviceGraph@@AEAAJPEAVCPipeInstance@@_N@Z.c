/*
 * XREFs of ?RegisterSpatialPipe@CAudioDeviceGraph@@AEAAJPEAVCPipeInstance@@_N@Z @ 0x14000F5F0
 * Callers:
 ...
 *     ?DoSpatialAudioProcessBlockRegistration@CAudioDeviceGraph@@AEAAJPEAUISpatialAudioProcessBlockRT@@PEAUIAdaptiveSpatialAudioRenderer@@_N@Z @ 0x14003F4BC (-DoSpatialAudioProcessBlockRegistration@CAudioDeviceGraph@@AEAAJPEAUISpatialAudioProcessBlockRT@.c)
...
LABEL_27:
  ...
  v27 = (*(__int64 (__fastcall **)(_QWORD *, GUID *, _QWORD **))*v19)(
          ...
          &GUID_ff4fd0e7_dae6_4f9f_b627_53d3bfbc611a,
          &v33);
  ATL::CComPtr<IAudioEndpoint>::~CComPtr<IAudioEndpoint>(&v32);
  if ( v27 >= 0 )
  {
    v38 = 0LL;
...
LABEL_42:
  ...
  if ( v5 < 0 )
    AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::RegisterSpatialPipe", 0x743u, v5);
LABEL_46:
  if ( v37 )
