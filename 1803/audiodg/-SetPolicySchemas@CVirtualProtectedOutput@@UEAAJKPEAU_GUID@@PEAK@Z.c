/*
 * XREFs of ?SetPolicySchemas@CVirtualProtectedOutput@@UEAAJKPEAU_GUID@@PEAK@Z @ 0x14003F2D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xDu, (__int64)&WPP_7bb1644f8c8332d2a940566e3ad600c9_Traceguids, v5);
  }
