/*
 * XREFs of ?CreateApoEndpointInstance@CEndpointInstance@@SAJPEAUIDeviceGraphObjectCache@@PEAUBRIDGE_STREAM_DESCRIPTOR@@PEAUIAudioProcessingObject@@PEAUIAudioMediaType@@IPEAPEAV1@@Z @ 0x140040690
 * Callers:
        ...
        struct CEndpointInstance **a6)
{
  ...
  *a6 = 0LL;
  ...
  if ( !v8 )
  {
    v7 = -2147024882;
LABEL_8:
    AudDGTraceLoggingErrorHelper("CEndpointInstance::CreateApoEndpointInstance", 0x285u, v7);
    goto LABEL_9;
  }
  v13 = 0LL;
