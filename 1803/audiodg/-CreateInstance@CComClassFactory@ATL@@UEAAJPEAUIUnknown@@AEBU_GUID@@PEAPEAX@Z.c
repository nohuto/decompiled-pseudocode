/*
 * XREFs of ?CreateInstance@CComClassFactory@ATL@@UEAAJPEAUIUnknown@@AEBU_GUID@@PEAPEAX@Z @ 0x140015900
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?InlineIsEqualUnknown@ATL@@YAHAEBU_GUID@@@Z @ 0x140031B90 (-InlineIsEqualUnknown@ATL@@YAHAEBU_GUID@@@Z.c)
 */
  ...
  if ( a4 )
  {
    *a4 = 0LL;
    if ( !v4 || (unsigned int)ATL::InlineIsEqualUnknown(a3) )
    {
      ...
      else if ( (char *)v8 == (char *)ATL::CComCreator2<ATL::CComCreator<ATL::CComObject<CProcessSubmix>>,ATL::CComCreator<ATL::CComAggObject<CProcessSubmix>>>::CreateInstance )
      {
