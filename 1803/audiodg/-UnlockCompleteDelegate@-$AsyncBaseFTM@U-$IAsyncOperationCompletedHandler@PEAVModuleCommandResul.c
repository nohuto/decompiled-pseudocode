/*
 * XREFs of ?UnlockCompleteDelegate@?$AsyncBaseFTM@U?$IAsyncOperationCompletedHandler@PEAVModuleCommandResult@Devices@Media@Windows@@@Foundation@Windows@@$00U?$AsyncOptions@$0?0$0A@$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@WRL@Microsoft@@@Internal@Windows@@AEAAXXZ @ 0x14001D5D8
 * Callers:
        ...
        __int64 a1)
{
  ...
  {
    _InterlockedOr(v2, 0);
    return Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(a1 + 112);
  }
  return result;
}
