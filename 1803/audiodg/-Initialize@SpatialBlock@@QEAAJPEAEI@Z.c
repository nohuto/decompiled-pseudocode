/*
 * XREFs of ?Initialize@SpatialBlock@@QEAAJPEAEI@Z @ 0x14005C7AC
 * Callers:
 ...
 *     ?SetPointersFromDescriptor@SpatialBlock@@AEAAXXZ @ 0x14005D238 (-SetPointersFromDescriptor@SpatialBlock@@AEAAXXZ.c)
