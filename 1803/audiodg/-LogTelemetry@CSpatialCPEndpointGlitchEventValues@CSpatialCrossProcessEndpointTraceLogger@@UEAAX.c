/*
 * XREFs of ?LogTelemetry@CSpatialCPEndpointGlitchEventValues@CSpatialCrossProcessEndpointTraceLogger@@UEAAXXZ @ 0x14005AAA0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *((_QWORD *)this + 1) && *((_QWORD *)this + 2) && *((_QWORD *)this + 3) )
  {
    ...
    if ( **((_BYTE **)this + 1) )
    {
      if ( *(_DWORD *)v5 > 3u )
      {
        if ( TlgKeywordOn(v5, 0x200000000000uLL) )
        {
          ...
          v26 = 4LL;
          v28 = 8LL;
          TlgWrite(v6, &unk_140070604, 0LL, v7, 9u, &pData);
        }
      }
    }
    else
    {
      if ( *(_DWORD *)v5 > 3u && TlgKeywordOn(v5, 0x400000000000uLL) )
      {
        ...
        v26 = 4LL;
        v28 = 8LL;
        TlgWrite(v8, &unk_1400706AB, 0LL, v9, 9u, &pData);
      }
      *((_QWORD *)this + 8) = 0LL;
    }
  }
