/*
 * XREFs of ?GetPositionForOffload@CSystemAudioDeviceSharedBase@@UEAAJPEA_K0@Z @ 0x140039490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x140038D4C (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
        ...
        unsigned __int64 *a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceSharedBase::GetPositionForOffload", 0x199u, v7);
  }
  else if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
         && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x200) != 0
         && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_ii(*((_QWORD *)WPP_GLOBAL_Control + 2), 20LL, &WPP_303e3d63e4de38f5f581b19c1b1d6ae5_Traceguids, *a2, *a3);
  }
  if ( v10 )
