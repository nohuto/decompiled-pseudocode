/*
 * XREFs of ?InitializeSecurity@CAudioDGModule@@AEAAJKKK@Z @ 0x140014814
 * Callers:
...
__int64 __fastcall CAudioDGModule::InitializeSecurity(CAudioDGModule *this)
{
         ...
         &SecurityDescriptorSize) )
  {
           ...
           &dwPrimaryGroupSize) )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_3fe81b27291f30f1338e1fd51985555a_Traceguids, 12320LL);
      }
      ...
      WPP_SF_D(v13[2], v14, &WPP_3fe81b27291f30f1338e1fd51985555a_Traceguids, (unsigned int)v7);
      goto LABEL_31;
    }
  }
  LastError = GetLastError();
...
LABEL_31:
  ...
  if ( v7 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CAudioDGModule::InitializeSecurity", 0x313u, v7);
  }
