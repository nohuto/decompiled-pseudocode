/*
 * XREFs of ?AddHead@?$CAtlList@PEAVCStreamInstance@@V?$CElementTraits@PEAVCStreamInstance@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAVCStreamInstance@@@Z @ 0x14002FDF8
 * Callers:
 ...
 *     ?LinkToLeftDisplayNode@CDisplayNode@@QEAAJPEAV1@@Z @ 0x1400425F0 (-LinkToLeftDisplayNode@CDisplayNode@@QEAAJPEAV1@@Z.c)
