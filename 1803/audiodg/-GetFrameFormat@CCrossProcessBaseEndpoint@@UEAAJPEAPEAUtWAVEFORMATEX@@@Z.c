/*
 * XREFs of ?GetFrameFormat@CCrossProcessBaseEndpoint@@UEAAJPEAPEAUtWAVEFORMATEX@@@Z @ 0x140018250
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tWAVEFORMATEX **a2)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 17LL, &WPP_698a2f115f533c7f031ecbc2e80baf0e_Traceguids, v7);
  }
