/*
 * XREFs of ?LogGetGrantedCount@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI@Z @ 0x14005A0D0
 * Callers:
 *     ?GetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJPEAI@Z @ 0x14005C0B0 (-GetGrantedObjectCount@CSpatialCrossProcessBaseEndpoint@@UEAAJPEAI@Z.c)
 * Callees:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140087130 > 5 )
  {
    ...
    v10 = 0;
    v9 = 4;
    TlgWrite((TraceLoggingHProvider)&dword_140087130, &unk_140070B0C, 0LL, a4, 4u, &v4);
  }
}
