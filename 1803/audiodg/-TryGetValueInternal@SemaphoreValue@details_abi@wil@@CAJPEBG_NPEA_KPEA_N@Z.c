/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x140032C88
 * Callers:
        ...
        bool *a4)
{
  ...
  int v31; // eax
  void *v32; // rdx
  int v34; // [rsp+20h] [rbp-248h] BYREF
  int v35[3]; // [rsp+24h] [rbp-244h] BYREF
  ...
  *a3 = 0LL;
  ...
  if ( v14 )
  {
    v35[0] = 0;
    v34 = 0;
    ValueFromSemaphore = wil::details_abi::SemaphoreValue::GetValueFromSemaphore(v14, v35);
    ...
    v28 = OpenSemaphoreW(0x1F0003u, 0, Name);
    if ( v28 )
    {
      v31 = wil::details_abi::SemaphoreValue::GetValueFromSemaphore(v28, &v34);
      LastError = v31;
      if ( v31 >= 0 )
      {
        wil::details::CloseHandle((wil::details *)v28, v32);
        *a3 = ((__int64)v34 << 31) | v35[0];
        goto LABEL_37;
      }
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0xD6, (__int64)"wil", (const char *)(unsigned int)v31);
    }
    else
    {
    ...
    if ( v28 )
      wil::details::CloseHandle((wil::details *)v28, v16);
    v4 = LastError;
  }
