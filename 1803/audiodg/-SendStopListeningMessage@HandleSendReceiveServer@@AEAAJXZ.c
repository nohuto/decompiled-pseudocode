/*
 * XREFs of ?SendStopListeningMessage@HandleSendReceiveServer@@AEAAJXZ @ 0x140045BC0
 * Callers:
 *     ??1HandleSendReceiveServer@@UEAA@XZ @ 0x14001A340 (--1HandleSendReceiveServer@@UEAA@XZ.c)
 * Callees:
