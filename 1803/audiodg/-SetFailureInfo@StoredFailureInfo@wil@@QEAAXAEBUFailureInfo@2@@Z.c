/*
 * XREFs of ?SetFailureInfo@StoredFailureInfo@wil@@QEAAXAEBUFailureInfo@2@@Z @ 0x1400326E4
 * Callers:
 ...
 *     ?create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z @ 0x140032FF4 (-create@shared_buffer@details@wil@@QEAA_NPEBX_K@Z.c)
