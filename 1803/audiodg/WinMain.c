 ...
 *     ?AERTMemoryInitialize@@YAJ_K00@Z @ 0x14001AFBC (-AERTMemoryInitialize@@YAJ_K00@Z.c)
 *     McGenEventRegister @ 0x14001B024 (McGenEventRegister.c)
 ...
 *     WPP_SF_qd @ 0x140034CA4 (WPP_SF_qd.c)
...
int __stdcall WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nShowCmd)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 37LL, &WPP_3fe81b27291f30f1338e1fd51985555a_Traceguids, lpCmdLine);
  }
