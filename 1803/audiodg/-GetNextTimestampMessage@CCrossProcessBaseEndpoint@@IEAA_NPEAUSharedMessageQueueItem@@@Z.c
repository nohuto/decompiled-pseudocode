/*
 * XREFs of ?GetNextTimestampMessage@CCrossProcessBaseEndpoint@@IEAA_NPEAUSharedMessageQueueItem@@@Z @ 0x140053C14
 * Callers:
        ...
        struct SharedMessageQueueItem *a2)
{
  ...
  if ( (_DWORD)v5 != *(_DWORD *)(*((_QWORD *)this + 8) + 4LL) )
  {
    ...
    else
    {
      ...
      AudCPTraceLoggingErrorHelper("CCrossProcessBaseEndpoint::GetNextTimestampMessage", 0x52Du, -2147467259);
    }
  }
  return v2;
}
