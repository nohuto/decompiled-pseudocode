/*
 * XREFs of ?Reset@CCrossProcessControl@@UEAAJXZ @ 0x1400543F0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_D @ 0x140034C3C (WPP_SF_D.c)
 *     ?AEWMILOG_CONTROL@@YAXKPEAXEE_K@Z @ 0x140053490 (-AEWMILOG_CONTROL@@YAXKPEAXEE_K@Z.c)
 *     ?DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ @ 0x14005360C (-DrainAndResetQueue@CCrossProcessBaseEndpoint@@IEAAXXZ.c)
