/*
 * XREFs of ?GetLatency@CSystemAudioDeviceSharedBase@@UEAAJ_KPEA_J@Z @ 0x140039380
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  if ( v6 < 0 )
  {
    ...
    AudDGTraceLoggingErrorHelper("CSystemAudioDeviceSharedBase::GetLatency", 0x1EBu, v6);
  }
  if ( v9 )
