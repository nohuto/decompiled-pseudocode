/*
 * XREFs of ??_G?$CComObject@VCAPOWrapperSrv@@@ATL@@UEAAPEAXI@Z @ 0x1400151E0
 * Callers:
        ...
        char a2)
{
  ...
  unsigned int (__fastcall *v8)(CSystemEffectWrapper *); // rax
  ...
  *(_QWORD *)&Block->LockCount = &ATL::CComObject<CAPOWrapperSrv>::`vftable'{for `IAudioProcessingObject'};
  ...
  if ( v7 )
  {
    v8 = *(unsigned int (__fastcall **)(CSystemEffectWrapper *))(*(_QWORD *)v7 + 16LL);
