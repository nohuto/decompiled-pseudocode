/*
 * XREFs of ?Initialize@CFormatConverterPipe@@QEAAJPEAUIDeviceGraphObjectCache@@PEBUtWAVEFORMATEX@@PEBUFORMAT_CONVERTER_PIPE_DESCRIPTOR@@@Z @ 0x1400444E8
 * Callers:
...
LABEL_7:
  ...
  if ( pv )
    CoTaskMemFree(pv);
LABEL_23:
  ATL::CAutoPtr<CPipeInstance>::Free(v20);
