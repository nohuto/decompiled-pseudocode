/*
 * XREFs of ??1SendCommandAsyncOperation@Devices@Media@Windows@@UEAA@XZ @ 0x140049114
 * Callers:
 *     ??_GSendCommandAsyncOperation@Devices@Media@Windows@@UEAAPEAXI@Z @ 0x140049840 (--_GSendCommandAsyncOperation@Devices@Media@Windows@@UEAAPEAXI@Z.c)
 * Callees:
