/*
 * XREFs of ?AddToCpuManager@GraphStreamingResourceManager@@UEAAJ_J@Z @ 0x140004760
 * Callers:
 ...
 *     ?GetCpuManager@@YAJPEAPEAVCpuManager@@@Z @ 0x140035318 (-GetCpuManager@@YAJPEAPEAVCpuManager@@@Z.c)
...
__int64 __fastcall GraphStreamingResourceManager::AddToCpuManager(struct CpuManager **this, __int64 a2)
{
  ...
  if ( a2 >= (unsigned int)dword_140088158 )
    goto LABEL_2;
  v6 = this + 34;
