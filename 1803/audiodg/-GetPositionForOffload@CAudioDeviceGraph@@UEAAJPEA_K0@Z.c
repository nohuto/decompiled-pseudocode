/*
 * XREFs of ?GetPositionForOffload@CAudioDeviceGraph@@UEAAJPEA_K0@Z @ 0x14003FBB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
  if ( v8 != &WPP_GLOBAL_Control && (*((_DWORD *)v8 + 7) & 0x20000) != 0 && *((_BYTE *)v8 + 25) >= 2u )
    WPP_SF_D((__int64)v8[2], 0x14u, (__int64)&WPP_3dcabf6e46fe37d8e2cf6f9c2f959793_Traceguids, v7);
  AudDGTraceLoggingErrorHelper("CAudioDeviceGraph::GetPositionForOffload", 0x1BBu, v7);
LABEL_9:
  if ( v3 )
