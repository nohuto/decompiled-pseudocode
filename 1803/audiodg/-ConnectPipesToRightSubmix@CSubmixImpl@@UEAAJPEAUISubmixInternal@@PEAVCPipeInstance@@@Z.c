/*
 * XREFs of ?ConnectPipesToRightSubmix@CSubmixImpl@@UEAAJPEAUISubmixInternal@@PEAVCPipeInstance@@@Z @ 0x1400047E0
 * Callers:
...
{
  const struct CPipeInstance *v6; // rbx
...
LABEL_2:
  ...
  if ( v7 )
  {
    if ( v6 )
    {
      v25 = CPipeInstance::ConnectToRightPipe(v7, v6);
      v26 = v25;
      if ( v25 < 0 )
      {
        wil::details::in1diag3::Return_Hr(
      ...
      v27 = (*(__int64 (__fastcall **)(struct ISubmixInternal *, _QWORD))(*(_QWORD *)a2 + 40LL))(
              a2,
              *((_QWORD *)this + 3));
      v28 = v27;
      if ( v27 < 0 )
