/*
 * XREFs of ?LogGetPosition@CSpatialCrossProcessEndpointTraceLogger@@QEAAX_K00000@Z @ 0x14005A208
 * Callers:
        ...
        char a7)
{
  ...
  if ( (unsigned int)dword_140087130 > 5 )
  {
    ...
    v19 = 8LL;
    v21 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_140087130, &unk_1400708CC, 0LL, a4, 9u, &pData);
  }
}
