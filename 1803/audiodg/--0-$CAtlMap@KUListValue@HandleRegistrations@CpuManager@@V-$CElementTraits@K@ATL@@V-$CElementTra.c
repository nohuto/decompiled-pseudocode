/*
 * XREFs of ??0?$CAtlMap@KUListValue@HandleRegistrations@CpuManager@@V?$CElementTraits@K@ATL@@V?$CElementTraits@UListValue@HandleRegistrations@CpuManager@@@5@@ATL@@QEAA@IMMMI@Z @ 0x1400017F4
 * Callers:
 *     ??0HandleRegistrations@CpuManager@@QEAA@XZ @ 0x140001750 (--0HandleRegistrations@CpuManager@@QEAA@XZ.c)
 * Callees:
