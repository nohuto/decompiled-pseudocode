/*
 * XREFs of ?SetString@?$CSimpleStringT@G$0A@@ATL@@QEAAXPEBGH@Z @ 0x1400028E4
 * Callers:
...
__int64 __fastcall ATL::CSimpleStringT<unsigned short,0>::SetString(const void **a1, _BYTE *a2, __int64 a3)
{
  __int64 v3; // rdi
  char *v6; // r10
  ...
  if ( v7 <= v8 )
  {
    memmove_s_0(v6, 2 * v3, &v6[2 * v7], 2 * v3);
  }
  else if ( v9 )
  {
    if ( v6 )
