/*
 * XREFs of ?CreateSubmixPipeInstance@CPipeInstance@@SAJPEAUIDeviceGraphObjectCache@@PEAUSUBMIX_DESCRIPTOR@@PEAPEAV1@@Z @ 0x140006B20
 * Callers:
        ...
        struct CPipeInstance **a3)
{
  ...
  struct IDeviceGraphObjectCache *v39; // rcx
  __int64 v40; // rbx
  __int64 v41; // r14
  __int64 v42; // r15
  struct ATL::CAtlPlex *v43; // rdx
  __int64 v44; // rcx
  __int64 v45; // rax
  ...
  struct ATL::CAtlPlex *v60; // rcx
  struct ATL::CAtlPlex *v61; // rax
  __int64 v62; // r8
  struct ATL::CAtlPlex *v63; // rax
  __int64 v64; // rax
  int v65; // eax
  ...
  *(_OWORD *)v68 = 0LL;
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_0100469152753b0964101f667eb0634c_Traceguids);
  }
  *a3 = 0LL;
  try
  {
...
LABEL_53:
          if ( v32 >= 0 )
          {
            ...
            *((_DWORD *)v27 + 32) = *((_DWORD *)a2 + 16) != 0;
            ...
            v39 = (struct IDeviceGraphObjectCache *)*((_QWORD *)v27 + 29);
            if ( v39 != a1 )
            {
              if ( a1 )
              {
              ...
              if ( v39 )
                (*(void (__fastcall **)(struct IDeviceGraphObjectCache *))(*(_QWORD *)v39 + 16LL))(v39);
              *((_QWORD *)v27 + 29) = a1;
            }
            *(_QWORD *)v27 = 0LL;
            *((_DWORD *)v27 + 2) = 1;
