/*
 * XREFs of ?SetVolumeCoefficients@CSystemAudioDeviceOffloadGraph@@UEAAJIPEAMPEA_JW4AUDIO_CURVE_TYPE@@1@Z @ 0x14003D780
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a6)
{
  ...
  if ( v9 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, (__int64)&WPP_15ea582e738f3272a62e13fe333fda5a_Traceguids, v9);
    }
