/*
 * XREFs of ?FixupStreamPipe@CPipeInstance@@AEAAJXZ @ 0x14000B3B0
 * Callers:
...
__int64 __fastcall CPipeInstance::FixupStreamPipe(__int64 **this)
{
  ...
  unsigned int (__fastcall *v10)(CAudioMediaType *__hidden); // rax
  ...
  if ( *((_DWORD *)this + 28) == 2 && (unsigned __int64)this[4] > 1 )
  {
      ...
      && (*(_BYTE *)(v7 + 48) & 1) != 0 )
    {
      ...
      if ( APOProcessNode < 0 )
      {
        if ( v32 )
        {
          v10 = *(unsigned int (__fastcall **)(CAudioMediaType *__hidden))(*(_QWORD *)v32 + 16LL);
          if ( v10 == CAudioMediaType::Release )
            CAudioMediaType::Release(v32);
          else
            ((void (__fastcall *)(CAudioMediaType *, _QWORD))v10)(v32, *(_QWORD *)v32);
        }
        v11 = v33;
        goto LABEL_24;
      }
      v13 = v33;
      APOProcessNode = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, __int64, CAudioMediaType **))(**((_QWORD **)v1 + 29) + 24LL))(
                         *((_QWORD *)v1 + 29),
                         *((_QWORD *)v33 + 4) + 8LL,
...
LABEL_94:
  ...
  if ( *((_DWORD *)v1 + 28) == 5 && *((_QWORD *)v1 + 4) == 1LL )
  {
    v32 = 0LL;
    v30 = 0LL;
    v19 = *(unsigned int **)ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::GetHead((_QWORD *)v1 + 2);
    v29 = GUID_c18e2f7e_933d_4965_b7d1_1eef228d2af3;
...
LABEL_24:
    ...
    else
    {
      ...
      {
        v31 = v13;
        ATL::CAtlList<CProcessNode *,ATL::CElementTraits<CProcessNode *>>::AddTail((__int64 **)v1 + 2, (__int64 *)&v31);
      }
