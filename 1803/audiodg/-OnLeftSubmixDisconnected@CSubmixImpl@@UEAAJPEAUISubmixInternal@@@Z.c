/*
 * XREFs of ?OnLeftSubmixDisconnected@CSubmixImpl@@UEAAJPEAUISubmixInternal@@@Z @ 0x1400051F0
 * Callers:
...
LABEL_15:
    ...
    if ( v8 )
    {
      for ( i = (__int64 *)*((_QWORD *)this + 10); i && (struct ISubmixInternal **)i[2] != v8; i = (__int64 *)*i )
        ;
