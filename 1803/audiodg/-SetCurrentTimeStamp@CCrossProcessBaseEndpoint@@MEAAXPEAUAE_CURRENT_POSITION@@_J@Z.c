/*
 * XREFs of ?SetCurrentTimeStamp@CCrossProcessBaseEndpoint@@MEAAXPEAUAE_CURRENT_POSITION@@_J@Z @ 0x140017FE0
 * Callers:
        ...
        __int64 a3)
{
  ...
  *(struct AE_CURRENT_POSITION *)(v5 + *((_QWORD *)this + 8) + 24) = *a2;
  ...
  if ( (unsigned int)dword_140087020 > 5 )
  {
    ...
    v9[1] = 5;
    v11 = off_140087028;
    v9[0] = ((unsigned int)&unk_1400700A2 - (unsigned int)&TraceLoggingMetadata) | 0xB000000;
    v10 = 0LL;
    v12 = *(unsigned __int16 *)off_140087028;
    v14 = &unk_1400700AD;
    v13 = 2;
    v15 = 112;
    v16 = 1;
    EtwEventWriteTransfer(qword_140087040, v9, 0LL, 0LL, 9, &v11);
  }
}
