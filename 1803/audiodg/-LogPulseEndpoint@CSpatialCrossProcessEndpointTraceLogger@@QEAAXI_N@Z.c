/*
 * XREFs of ?LogPulseEndpoint@CSpatialCrossProcessEndpointTraceLogger@@QEAAXI_N@Z @ 0x14005A418
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140087130 > 5 )
  {
    ...
    v9 = 4LL;
    v11 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140087130, &unk_140070858, 0LL, a4, 5u, &pData);
  }
}
