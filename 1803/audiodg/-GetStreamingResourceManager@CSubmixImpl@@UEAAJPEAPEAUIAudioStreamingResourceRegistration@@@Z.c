/*
 * XREFs of ?GetStreamingResourceManager@CSubmixImpl@@UEAAJPEAPEAUIAudioStreamingResourceRegistration@@@Z @ 0x140004B50
 * Callers:
        ...
        struct IAudioStreamingResourceRegistration **a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v6 = *(int (**)(CSystemAudioDeviceSharedBase *__hidden, struct IAudioStreamingResourceRegistration **))(*(_QWORD *)v12 + 120LL);
