/*
 * XREFs of ?ActivateAPOs@CPipeInstance@@AEAAJ_K@Z @ 0x140009AE0
 * Callers:
    ...
    if ( v11 )
    {
      ...
      if ( (unsigned int)GetClassFromEndpointId(v13) != 3 )
      {
        ...
        if ( v5 >= 0 )
        {
          ...
          if ( v5 >= 0 )
            v5 = TrackSystemEffectBehavior(v37, v11, 1, 0, (__int64)ppv);
        }
      }
      if ( v37 )
...
LABEL_27:
  ...
  v23 = *(unsigned __int16 *)(v14 + 14);
  v22 = *(unsigned __int16 *)(v14 + 12);
  ...
  if ( v16 )
  {
    v17 = TrackSystemEffectBehavior(*((_QWORD *)this + 23), v16, 0, 0, (__int64)ppva);
    if ( v17 < 0 )
      wil::details::in1diag3::_Log_Hr(
        retaddr,
        (void *)0xBA3,
