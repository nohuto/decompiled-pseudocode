/*
 * XREFs of ?RetrieveNotificationDeviceId@AudioDeviceBroker@Internal@Devices@Media@Windows@@AEAAJXZ @ 0x140018D00
 * Callers:
        ...
        RTL_SRWLOCK *this)
{
  ...
  *(&v2.Alignment + 2) = 0x100000003LL;
  ...
  result = Windows::Media::Devices::Internal::AudioDeviceBroker::KsSendProperty(this, &v2, 0x18u, &this[14], 0x10u, &v3);
