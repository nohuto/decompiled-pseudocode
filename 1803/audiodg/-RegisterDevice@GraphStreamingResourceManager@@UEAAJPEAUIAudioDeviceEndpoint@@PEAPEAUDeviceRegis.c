/*
 * XREFs of ?RegisterDevice@GraphStreamingResourceManager@@UEAAJPEAUIAudioDeviceEndpoint@@PEAPEAUDeviceRegistrationToken__@@@Z @ 0x1400040C0
 * Callers:
 ...
 *     ?InitialRegisterForDevice@GraphStreamingResourceManager@@EEAAJPEAUIAudioDeviceEndpoint@@PEAURegistrationData@DeviceRegistrations@1@@Z @ 0x140003FE0 (-InitialRegisterForDevice@GraphStreamingResourceManager@@EEAAJPEAUIAudioDeviceEndpoint@@PEAURegi.c)
        ...
        struct DeviceRegistrationToken__ **a3)
{
  ...
  _QWORD v25[4]; // [rsp+78h] [rbp-70h] BYREF
  _BYTE v26[8]; // [rsp+98h] [rbp-50h] BYREF
  ATL::CAtlException *v27; // [rsp+A0h] [rbp-48h] BYREF
  int v31; // [rsp+108h] [rbp+20h] BYREF
