/*
 * XREFs of ??0?$CComObject@VCSpatialCrossProcessServerInputEndpoint@@@ATL@@QEAA@PEAX@Z @ 0x1400579DC
 * Callers:
        ...
        CSpatialCrossProcessServerInputEndpoint *a1)
{
  ...
  *((_QWORD *)a1 + 114) = &ATL::CComObject<CSpatialCrossProcessServerInputEndpoint>::`vftable'{for `IAudioCrossProcessServerEndpoint'};
  *((_QWORD *)a1 + 115) = &ATL::CComObject<CSpatialCrossProcessServerInputEndpoint>::`vftable'{for `ISpatialAudioCrossProcessServerEndpoint'};
  *((_QWORD *)a1 + 137) = &ATL::CComObject<CSpatialCrossProcessServerInputEndpoint>::`vftable';
