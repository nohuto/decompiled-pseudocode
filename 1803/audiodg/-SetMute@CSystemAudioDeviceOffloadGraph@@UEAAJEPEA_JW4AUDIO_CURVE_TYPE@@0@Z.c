/*
 * XREFs of ?SetMute@CSystemAudioDeviceOffloadGraph@@UEAAJEPEA_JW4AUDIO_CURVE_TYPE@@0@Z @ 0x14003D6A0
 * Callers:
 *     <none>
 * Callees:
        ...
        enum AUDIO_CURVE_TYPE a4)
{
  ...
  if ( v7 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xFu, (__int64)&WPP_15ea582e738f3272a62e13fe333fda5a_Traceguids, v7);
    }
