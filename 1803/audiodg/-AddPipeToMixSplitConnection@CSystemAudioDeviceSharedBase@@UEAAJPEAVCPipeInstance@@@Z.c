/*
 * XREFs of ?AddPipeToMixSplitConnection@CSystemAudioDeviceSharedBase@@UEAAJPEAVCPipeInstance@@@Z @ 0x140012770
 * Callers:
        ...
        struct CPipeInstance *a2)
{
  ...
  if ( (char *)**v5 == (char *)ATL::CComObject<CAudioDeviceGraph>::QueryInterface )
    ATL::CComObject<CAudioDeviceGraph>::QueryInterface(v5, &GUID_394afc11_8be4_4e54_b91c_8fcc82d1f0a6, &v11);
  else
    (**v5)(v5, &GUID_394afc11_8be4_4e54_b91c_8fcc82d1f0a6, &v11);
  v6 = v11;
  if ( v11 )
  {
