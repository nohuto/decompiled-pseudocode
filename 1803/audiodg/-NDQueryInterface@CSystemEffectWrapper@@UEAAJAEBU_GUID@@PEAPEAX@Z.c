/*
 * XREFs of ?NDQueryInterface@CSystemEffectWrapper@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x140013C50
 * Callers:
...
LABEL_73:
  ...
  result = CSystemEffectWrapper::QIInternal((CSystemEffectWrapper *)this, a2, this + 16);
  v3 = result;
  if ( (int)result < 0 )
    return (unsigned int)v3;
  *a3 = this + 1;
