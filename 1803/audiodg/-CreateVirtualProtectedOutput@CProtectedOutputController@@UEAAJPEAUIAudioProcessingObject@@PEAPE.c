/*
 * XREFs of ?CreateVirtualProtectedOutput@CProtectedOutputController@@UEAAJPEAUIAudioProcessingObject@@PEAPEAUIAudioVirtualProtectedOutput@@@Z @ 0x14003EC90
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioVirtualProtectedOutput **a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, (__int64)&WPP_7bb1644f8c8332d2a940566e3ad600c9_Traceguids, v5);
  }
