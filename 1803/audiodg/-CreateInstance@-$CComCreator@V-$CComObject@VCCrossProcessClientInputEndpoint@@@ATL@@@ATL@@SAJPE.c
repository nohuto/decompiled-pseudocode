/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCCrossProcessClientInputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140051520
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  CCrossProcessClientInputEndpoint *v15; // [rsp+78h] [rbp+20h]
  ...
  *a3 = 0LL;
  ...
  if ( v10 )
  {
    Microsoft::WRL::Details::SafeUnknownIncrementReference((CCrossProcessClientInputEndpoint *)((char *)v10 + 472), v9);
