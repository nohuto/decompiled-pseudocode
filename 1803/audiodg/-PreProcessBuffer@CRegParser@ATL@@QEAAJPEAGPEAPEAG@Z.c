/*
 * XREFs of ?PreProcessBuffer@CRegParser@ATL@@QEAAJPEAGPEAPEAG@Z @ 0x140051E28
 * Callers:
 ...
 *     ?StrFromMap@CRegObject@ATL@@QEAAPEBGPEAG@Z @ 0x14005300C (-StrFromMap@CRegObject@ATL@@QEAAPEBGPEAG@Z.c)
 */
