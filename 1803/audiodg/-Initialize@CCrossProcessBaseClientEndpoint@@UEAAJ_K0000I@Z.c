/*
 * XREFs of ?Initialize@CCrossProcessBaseClientEndpoint@@UEAAJ_K0000I@Z @ 0x140053D00
 * Callers:
 *     ?Initialize@CCrossProcessClientOutputEndpoint@@UEAAJ_K0000I@Z @ 0x140055820 (-Initialize@CCrossProcessClientOutputEndpoint@@UEAAJ_K0000I@Z.c)
 * Callees:
            ...
            *((_QWORD *)this - 33) = v28;
            if ( v28 )
            {
              v30 = AE_ALLOCATE_SAFEMULT(
                      v29,
                      (unsigned int)(*((_DWORD *)this - 76) * *((_DWORD *)this - 74)),
                      v28,
                      AERTZoneAllocate);
              *((_QWORD *)this - 35) = v30;
              if ( v30 )
