/*
 * XREFs of ?GetDescription@CProtectedOutputController@@UEAAJPEAKPEAU_GUID@@0PEAPEAU2@@Z @ 0x14003EE10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID **a5)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_7bb1644f8c8332d2a940566e3ad600c9_Traceguids, v5);
  }
  AudDGTraceLoggingErrorHelper("CProtectedOutputController::GetDescription", 0x89u, v5);
  return v5;
}
