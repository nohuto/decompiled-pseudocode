/*
 * XREFs of ?OnLeftSubmixConnected@CSystemAudioDeviceSharedBase@@UEAAJPEAUISubmixInternal@@@Z @ 0x1400125C0
 * Callers:
        ...
        struct ISubmixInternal *a2)
{
  ...
  *((_DWORD *)this + 10) = v3;
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 28LL, &WPP_303e3d63e4de38f5f581b19c1b1d6ae5_Traceguids, v3);
  }
  if ( v6 )
