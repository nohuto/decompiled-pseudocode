/*
 * XREFs of ?Allocate@CAtlStringMgr@ATL@@UEAAPEAUCStringData@2@HH@Z @ 0x140002C20
 * Callers:
 *     ?Fork@?$CSimpleStringT@G$0A@@ATL@@AEAAXH@Z @ 0x140002798 (-Fork@-$CSimpleStringT@G$0A@@ATL@@AEAAXH@Z.c)
 * Callees:
 *     ?Allocate@CWin32Heap@ATL@@UEAAPEAX_K@Z @ 0x140002CF0 (-Allocate@CWin32Heap@ATL@@UEAAPEAX_K@Z.c)
 *     ??$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z @ 0x140002D00 (--$AtlMultiply@_K@ATL@@YAJPEA_K_K1@Z.c)
...
struct ATL::CStringData *__fastcall ATL::CAtlStringMgr::Allocate(ATL::CAtlStringMgr *this, int a2, int a3)
{
  ...
  if ( v4 < 1 )
    return 0LL;
  v5 = (a2 + 7) & 0xFFFFFFF8;
  if ( a2 > v5 || (int)ATL::AtlMultiply<unsigned __int64>(&v10, v5, a3) < 0 || v10 > 0xFFFFFFFFFFFFFFE7uLL )
    return 0LL;
