/*
 * XREFs of ?ReleaseOutputDataPointer@CCrossProcessServerOutputEndpoint@@UEAAXPEBUAPO_CONNECTION_PROPERTY@@@Z @ 0x1400571F0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (v8 & 1) != 0 )
    {
      ...
      if ( CCrossProcessBaseEndpoint::IsValidOffset(v3, v9, v6) )
      {
        ...
        if ( u32BufferFlags )
        {
          ...
          v15 = *(_DWORD *)(v11 + 140) + v9 % *((unsigned int *)this - 76);
          v24 = *(_OWORD *)((char *)this + 88);
          v26 = *((_QWORD *)this + 15);
          v25 = v13;
          if ( v8 )
          {
            if ( v8 == 1 )
            {
              ...
              if ( v16 + v15 > v17 )
              {
                ...
                {
                  memcpy_0((void *)(*((_QWORD *)this - 47) + v15), *((const void **)this - 42), v18);
                  memcpy_0(
                    (void *)(*((_QWORD *)this - 47) + *(unsigned int *)(*((_QWORD *)this - 46) + 140LL)),
                    (const void *)(v18 + *((_QWORD *)this - 42)),
                    Size);
                  u32BufferFlags = a2->u32BufferFlags;
                  v12 = *((_DWORD *)this - 90);
                }
                ...
                *((_QWORD *)&v25 + 1) += (unsigned int)(int)((double)(int)v21 * 10000000.0 / v20 + 0.5);
                (*(void (__fastcall **)(CCrossProcessBaseEndpoint *, __int64, _QWORD, _QWORD, __int128 *, APO_BUFFER_FLAGS, _DWORD))(*(_QWORD *)v3 + 88LL))(
                  ...
                  *(unsigned int *)(v22 + 140),
                  ...
                  a2->u32BufferFlags,
                  0);
                v8 = _InterlockedExchangeAdd64((volatile signed __int64 *)(*((_QWORD *)this - 47) + 8LL), v16);
              }
              else
              {
                if ( u32BufferFlags != BUFFER_SILENT )
                  memcpy_0((void *)(*((_QWORD *)this - 47) + v15), *((const void **)this - 42), v16);
                _InterlockedExchangeAdd64((volatile signed __int64 *)(*((_QWORD *)this - 47) + 8LL), v16);
                (*(void (__fastcall **)(CCrossProcessBaseEndpoint *, __int64, _QWORD, _QWORD, __int128 *, APO_BUFFER_FLAGS, _DWORD))(*(_QWORD *)v3 + 88LL))(
                  v3,
                  1LL,
                  v15,
          ...
          else
          {
            ...
            if ( a2->u32BufferFlags )
              _InterlockedExchangeAdd64((volatile signed __int64 *)(*((_QWORD *)this - 47) + 8LL), v14);
          }
        }
      }
    }
