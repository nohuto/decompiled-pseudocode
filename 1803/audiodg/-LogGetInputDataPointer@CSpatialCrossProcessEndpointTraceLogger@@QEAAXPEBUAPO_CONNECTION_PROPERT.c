/*
 * XREFs of ?LogGetInputDataPointer@CSpatialCrossProcessEndpointTraceLogger@@QEAAXPEBUAPO_CONNECTION_PROPERTY@@_N@Z @ 0x14005A158
 * Callers:
        ...
        const GUID *a4)
{
  ...
  if ( (unsigned int)dword_140087130 > 5 )
  {
    ...
    v12 = 4LL;
    v14 = 4LL;
    TlgWrite((TraceLoggingHProvider)&dword_140087130, &unk_1400709C9, 0LL, a4, 6u, &pData);
  }
}
