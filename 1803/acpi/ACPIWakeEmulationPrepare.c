/*
 * XREFs of ACPIWakeEmulationPrepare @ 0x1C008C06C
 * Callers:
 *     ACPIDeviceInitializePowerRequest @ 0x1C001A5DC (ACPIDeviceInitializePowerRequest.c)
 * Callees:
 *     ACPICreateWakeInterruptRegistrationEntries @ 0x1C008BFC0 (ACPICreateWakeInterruptRegistrationEntries.c)
 */
