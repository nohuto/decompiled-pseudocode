/*
 * XREFs of ACPIDevicePowerDpc @ 0x1C001BBD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIDeviceRecordBlockedOnPhase3List @ 0x1C001EE30 (ACPIDeviceRecordBlockedOnPhase3List.c)
...
LABEL_22:
    if ( (__int64 *)AcpiPowerPhase0List == &AcpiPowerPhase0List )
    {
      ...
      {
        v9 = ACPIDevicePowerProcessGenericPhase(&AcpiPowerPhase2List, &AcpiDevicePowerProcessPhase2Dispatch, 6LL, 0LL);
        if ( v9 >= 0 && v9 != 259 )
