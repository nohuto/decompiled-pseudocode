/*
 * XREFs of AcpiSetupNativeMethodInterface @ 0x1C00805F4
 * Callers:
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( Status >= 0 )
  {
    ...
    if ( AttachedDeviceReference )
    {
      ...
      v3 = *(_QWORD *)(RootDeviceExtension + 720);
      ...
      *((_QWORD *)&OutputBuffer[5] + 1) = AcpiTranslatePepDeviceControlResources;
        ...
        && *((_QWORD *)&OutputBuffer[3] + 1) )
      {
        ...
        xmmword_1C0066B70 = OutputBuffer[1];
        unk_1C0066B80 = OutputBuffer[2];
        xmmword_1C0066B90 = OutputBuffer[3];
        xmmword_1C0066BA0 = OutputBuffer[4];
        xmmword_1C0066BB0 = OutputBuffer[5];
