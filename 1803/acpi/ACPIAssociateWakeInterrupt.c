/*
 * XREFs of ACPIAssociateWakeInterrupt @ 0x1C003FE88
 * Callers:
 ...
 *     ACPIDereferenceWakeInterrupt @ 0x1C00402F0 (ACPIDereferenceWakeInterrupt.c)
 *     ACPIFindWakeInterruptForVector @ 0x1C004040C (ACPIFindWakeInterruptForVector.c)
 *     OSPowerTryAcquireWakeInterruptChangeStateLock @ 0x1C0041E80 (OSPowerTryAcquireWakeInterruptChangeStateLock.c)
...
__int64 __fastcall ACPIAssociateWakeInterrupt(__int64 a1)
{
  ...
  if ( (int)ACPIFindWakeInterruptForVector(v8, v7, &v19) < 0 )
  {
    ...
    *v15 = a1;
    *(_QWORD *)(v9 + 24) = a1;
    v16 = (__int64 *)qword_1C0066938;
    if ( *(__int64 **)qword_1C0066938 != &AcpiPowerWaitWakeInterruptList )
      __fastfail(3u);
    *(_QWORD *)(v9 + 8) = qword_1C0066938;
