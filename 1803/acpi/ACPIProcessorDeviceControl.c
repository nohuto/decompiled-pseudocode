/*
 * XREFs of ACPIProcessorDeviceControl @ 0x1C00815E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIDispatchPowerIrpInvalid @ 0x1C00211A0 (ACPIDispatchPowerIrpInvalid.c)
...
LABEL_28:
  ...
  if ( *(_DWORD *)(v6 + 8) >= 0xCu )
  {
    ...
    {
      v15 = AMLIEvalNameSpaceObject(v16, v23, 0, 0LL);
      if ( v15 < 0 )
        goto LABEL_21;
      v17 = v24;
