/*
 * XREFs of WriteCookAccess @ 0x1C004DB30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall WriteCookAccess(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( !v6 )
  {
    ...
    v16 = *(_QWORD *)(a2 + 40);
    ++*(_DWORD *)(a2 + 16);
    v17 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, _QWORD, __int64, _QWORD, __int64 (__fastcall *)(__int64), __int64))(v16 + 16))(
            0LL,
            *(_QWORD *)(a2 + 32) + 120LL,
            *(_QWORD *)(a2 + 48),
            *(unsigned int *)(a2 + 56),
    ...
    if ( v17 )
    {
      ...
      v19 = v18;
LABEL_24:
      PrintDebugMessage(212, (const void *)*(unsigned __int8 *)(v7 + 12), v19, 0LL, 0LL);
...
LABEL_27:
  ...
  v21 = *(_QWORD *)(a2 + 40);
  ++*(_DWORD *)(a2 + 16);
  v22 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, _QWORD, __int64, _QWORD, __int64 (__fastcall *)(__int64), __int64))(v21 + 16))(
          1LL,
          *(_QWORD *)(a2 + 32) + 120LL,
          *(_QWORD *)(a2 + 48),
          *(unsigned int *)(a2 + 56),
