/*
 * XREFs of LoadTable @ 0x1C00510D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall LoadTable(char *Entry, __int64 a2)
{
  ...
  v4 = 0LL;
  v24 = 0LL;
  DDB = ValidateArgTypes((__int64)Entry, v3, 0, "ZZZ");
  if ( DDB )
    return DDB;
...
LABEL_9:
  ...
  {
    v16 = ValidateArgTypes((__int64)Entry, v7 + 120, 0, "Z");
    DDB = v16;
    if ( v16 )
    {
      LogError(v16);
...
LABEL_13:
  ...
  if ( v15 >= 5 )
  {
    v19 = ValidateArgTypes((__int64)Entry, v7 + 160, 0, "Z");
    DDB = v19;
    if ( v19 )
    {
      LogError(v19);
  ...
  {
    LogError(-1073741670);
    AcpiDiagTraceAmlError((__int64)Entry, -1073741670);
    v20 = 87;
LABEL_27:
...
LABEL_41:
  ...
  NameSpaceObject = GetNameSpaceObject(v18, *((_QWORD *)Entry + 10), (__int64)&v24, 0x80000000);
  DDB = NameSpaceObject;
  if ( NameSpaceObject )
  {
  ...
  {
    v22 = PushPost((int)Entry, (int)ProcessLoadTable, (__int64)PoolWithTag, a2, *(_QWORD *)(a2 + 88));
    DDB = v22;
    if ( !v22 )
    {
      DDB = LoadDDB(Entry, PoolWithTag, v24, *(_QWORD *)(a2 + 88));
