/*
 * XREFs of ACPIRegDumpAcpiTables @ 0x1C009AFBC
 * Callers:
...
NTSTATUS ACPIRegDumpAcpiTables()
{
  ULONG *v0; // rbp
  ULONG *v1; // rsi
  ULONG *v2; // rdi
  ...
  if ( v0 )
    result = ACPIRegDumpAcpiTable("DSDT", v0, v0[1], (__int64)v0);
  if ( v1 )
    result = ACPIRegDumpAcpiTable("FACS", v1, v1[1], 0LL);
  if ( v2 )
    result = ACPIRegDumpAcpiTable("FADT", v2, v2[1], (__int64)v2);
  if ( v3 )
    result = ACPIRegDumpAcpiTable("RSDT", v3, v3[1], (__int64)v3);
  ...
  while ( (__int64 *)v5 != &AcpiDynamicDataBlockTableList )
  {
    ...
    if ( *v7 == 1413763923 )
    {
      ...
      ++v6;
      result = ACPIRegDumpAcpiTable(SourceString, *(PVOID *)(v5 + 24), v7[1], (__int64)v7);
    }
    v5 = *(_QWORD *)v5;
  }
  return result;
