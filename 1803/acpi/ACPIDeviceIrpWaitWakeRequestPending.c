/*
 * XREFs of ACPIDeviceIrpWaitWakeRequestPending @ 0x1C001B8E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ACPIDeviceIrpWaitWakeRequestPending(__int64 a1, int a2, __int64 a3, _DWORD *a4)
{
  ...
  if ( a2 >= 0 )
  {
    v12 = (_QWORD *)qword_1C0067158;
    if ( *(__int64 **)qword_1C0067158 != &AcpiPowerWaitWakeList )
      __fastfail(3u);
    *(_QWORD *)a4 = &AcpiPowerWaitWakeList;
    *((_QWORD *)a4 + 1) = v12;
    *v12 = a4;
    qword_1C0067158 = (__int64)a4;
    if ( *(_BYTE *)(v6 + 68) )
    {
