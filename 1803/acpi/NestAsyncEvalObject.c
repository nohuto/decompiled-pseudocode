/*
 * XREFs of NestAsyncEvalObject @ 0x1C004EC28
 * Callers:
...
__int64 __fastcall NestAsyncEvalObject(__int64 a1, __int64 a2, unsigned int a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  {
    v12 = PushFrame(ThreadCurrentContext, 1481917262, 128LL, (__int64)ParseNestedContext, &a5);
    if ( !v12 )
    {
      v13 = a5;
      *(_QWORD *)(a5 + 32) = a1;
...
LABEL_23:
      ...
      {
        v20 = v13 + 48;
        if ( !(unsigned int)PushPost(ThreadCurrentContext, (int)ProcessEvalObj, a1, 0LL, v13 + 48) )
