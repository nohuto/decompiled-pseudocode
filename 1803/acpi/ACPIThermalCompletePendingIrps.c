/*
 * XREFs of ACPIThermalCompletePendingIrps @ 0x1C003BF8C
 * Callers:
...
char __fastcall ACPIThermalCompletePendingIrps(__int64 a1)
{
  ...
  _TIME_FIELDS TimeFields; // [rsp+98h] [rbp+17h] BYREF
  ...
  do
  {
    ...
    if ( v9 == 2703488 )
    {
      if ( !_InterlockedExchange64(v6 + 13, 0LL) )
        continue;
    ...
    *((_DWORD *)v6 + 12) = 0;
    v13 = *v7;
    if ( *(__int64 **)(*v7 + 8) != v7 || (v14 = (__int64 **)v7[1], *v14 != v7) )
      __fastfail(3u);
    *v14 = (__int64 *)v13;
    *(_QWORD *)(v13 + 8) = v14;
    v15 = (__int64 **)v24;
...
LABEL_18:
  ...
  while ( v16 != &v23 )
  {
    ...
    v19 = v16;
    v16 = v17;
    if ( (_QWORD *)v17[1] != v19 || (v20 = (_QWORD *)v19[1], (_QWORD *)*v20 != v19) )
      __fastfail(3u);
    *v20 = v17;
    v17[1] = v20;
