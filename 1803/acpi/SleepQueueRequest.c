/*
 * XREFs of SleepQueueRequest @ 0x1C004BF0C
 * Callers:
...
__int64 __fastcall SleepQueueRequest(__int64 a1, unsigned int a2)
{
  ...
  v2 = a2;
  v4 = PushFrame(a1, 1346718803, 64LL, (__int64)ProcessSleep, (__int64 *)&v15);
  if ( v4 >= 0 )
  {
    ...
    v15[6] = v8;
    v7[7] = a1;
    for ( i = (__int64 *)qword_1C0068640; i != &SleepQueue; i = (__int64 *)i[1] )
    {
      if ( v8 >= i[2] )
      {
        v10 = *i;
