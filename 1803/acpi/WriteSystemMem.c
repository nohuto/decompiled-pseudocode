/*
 * XREFs of WriteSystemMem @ 0x1C004E3B4
 * Callers:
...
void __fastcall WriteSystemMem(unsigned __int64 a1, size_t Size, __int64 a3, __int64 a4)
{
  ...
  unsigned int v6; // esi
  __int64 v9; // r14
  int (__fastcall *v10)(_QWORD, unsigned __int64, __int64 *, _QWORD, _BYTE *); // rax
  __int64 v11; // rax
  _BYTE *v12; // rcx
  ...
  {
    v10 = *(int (__fastcall **)(_QWORD, unsigned __int64, __int64 *, _QWORD, _BYTE *))(PmHalDispatchTable + 144);
    if ( v10 )
    {
      if ( a4 != v9 )
      {
...
LABEL_9:
  if ( a1 % v6 )
  {
    if ( a4 != v9 )
    {
      memmove(&Src, (const void *)a1, v6);
      v5 = Src;
    }
    Src = a3 | v5 & ~a4;
    memmove((void *)a1, &Src, v6);
    return;
  }
  v13 = v6 - 1;
  if ( !v13 )
