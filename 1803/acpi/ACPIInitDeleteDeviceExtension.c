/*
 * XREFs of ACPIInitDeleteDeviceExtension @ 0x1C0028364
 * Callers:
...
LABEL_4:
  ...
  *((_DWORD *)Entry + 212) = *(_DWORD *)(**((_QWORD **)Entry + 89) + 40LL);
  v28 = (_QWORD *)qword_1C0067188;
  if ( *(__int64 **)qword_1C0067188 != &AcpiDevicesWhichMightNeedEnumerationList )
    __fastfail(3u);
  *v27 = &AcpiDevicesWhichMightNeedEnumerationList;
  *((_QWORD *)Entry + 105) = v28;
  *v28 = v27;
  qword_1C0067188 = (__int64)(Entry + 208);
