/*
 * XREFs of UnRegisterOperationRegionHandler @ 0x1C0080FE0
 * Callers:
...
LABEL_28:
  ...
  *((_BYTE *)a2 + 40) = 1;
    ...
    && ((__int64 *)*a2 == &AcpiOpRegionHandlerList || *(_DWORD *)(*a2 + 36) != *v7) )
  {
    if ( *v7 < 0x1F )
    {
      AcpiRegisteredOpRegionMask &= ~(1 << *v7);
           ...
           || *(_DWORD *)(qword_1C0066B48 + 36) < 0x1Fu )
    {
  ...
  if ( !v8 )
  {
    if ( *v7 - 8 > 1 )
    {
      if ( a1 && (int)AMLIGetNameSpaceObject("_REG", a1, (__int64)&v15, 1u) >= 0 )
      {
        ...
        v14[2] = v9;
        WORD1(v14[5]) = 1;
        AMLIEvalNameSpaceObject(v15, 0LL, 2u, v14);
