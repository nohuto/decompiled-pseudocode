/*
 * XREFs of ACPIBusAndFilterIrpQueryPnpDeviceState @ 0x1C0075FF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     AcpiDeviceResetMarkDeviceRemoved @ 0x1C0020CBC (AcpiDeviceResetMarkDeviceRemoved.c)
...
__int64 __fastcall ACPIBusAndFilterIrpQueryPnpDeviceState(ULONG_PTR a1, __int64 a2, __int64 a3, char a4)
{
  ...
  v8 = (*(_QWORD *)(DeviceExtension + 8) & 0x8000000000000LL) == 0
    && AMLIIsNamedChildPresent(*(_QWORD **)(DeviceExtension + 712), 1096045407);
  v9 = ACPIGet(DeviceExtension, 0x4154535Fu, -1878783998, 0LL, 0, 0LL, 0LL, (__int64)&v29, 0LL);
  if ( v9 < 0 )
    goto LABEL_38;
  ...
  else
  {
    ...
    if ( (*(_DWORD *)(DeviceExtension + 952) & 0x40000) == 0
      && (!AMLIIsNamedChildPresent(*(_QWORD **)(DeviceExtension + 712), 1397310559)
       && !AMLIIsNamedChildPresent(*(_QWORD **)(DeviceExtension + 712), 861098079)
       && !AMLIIsNamedChildPresent(*(_QWORD **)(DeviceExtension + 712), 810700895)
...
LABEL_38:
  ...
  IrpText = ACPIDebugGetIrpText(v24, v6);
