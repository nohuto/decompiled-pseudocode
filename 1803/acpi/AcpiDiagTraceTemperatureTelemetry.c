/*
 * XREFs of AcpiDiagTraceTemperatureTelemetry @ 0x1C000783C
 * Callers:
...
void __fastcall AcpiDiagTraceTemperatureTelemetry(__int64 a1)
{
  ...
  if ( (int)ACPIAmliBuildObjectPathnameUnicode(*(_QWORD *)(a1 + 712), &DestinationString, 1LL) >= 0 && hProvider > 5u )
  {
    v5 = *(_DWORD *)(v1 + 328);
    v8 = &v5;
    v10 = v13;
    ...
    v15 = 2LL;
    v17[1] = 0;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C005B951, v3, v4, 7u, &pData);
  }
