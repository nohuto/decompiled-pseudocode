/*
 * XREFs of ACPIIsPowerRequestBlocked @ 0x1C001F4E0
 * Callers:
 *     ACPIDevicePowerProcessBlockedItems @ 0x1C001C0FC (ACPIDevicePowerProcessBlockedItems.c)
 *     ACPIDevicePowerProcessGenericPhase @ 0x1C001C1E0 (ACPIDevicePowerProcessGenericPhase.c)
 *     ACPIMovePowerListUnblockedItems @ 0x1C001F5DC (ACPIMovePowerListUnblockedItems.c)
 * Callees:
