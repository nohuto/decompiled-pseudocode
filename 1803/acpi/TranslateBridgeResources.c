/*
 * XREFs of TranslateBridgeResources @ 0x1C008AFC0
 * Callers:
 *     <none>
 * Callees:
 *     CmMemIoResourceUpdateType @ 0x1C003F41C (CmMemIoResourceUpdateType.c)
 *     FindTranslationRange @ 0x1C008ADC0 (FindTranslationRange.c)
 */
