/*
 * XREFs of ACPIDeviceRecordBlockedOnPhase3List @ 0x1C001EE30
 * Callers:
...
void __fastcall ACPIDeviceRecordBlockedOnPhase3List(_QWORD **a1)
{
  ...
  while ( v2 != a1 )
  {
    ...
    if ( !*(_DWORD *)(v3 + 48) )
    {
      ...
      {
        v4 = *(_QWORD *)v3;
        if ( *(_QWORD *)(*(_QWORD *)v3 + 8LL) != v3 || (v5 = *(_QWORD **)(v3 + 8), *v5 != v3) )
          __fastfail(3u);
        *v5 = v4;
        *(_QWORD *)(v4 + 8) = v5;
        v6 = (__int64 *)qword_1C00670E8;
        if ( *(__int64 **)qword_1C00670E8 != &AcpiPowerBlockedOnPhase3List )
          __fastfail(3u);
