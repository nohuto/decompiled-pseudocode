/*
 * XREFs of SmscpParseArgs @ 0x140003178
 * Callers:
 *     SmscMain @ 0x140002044 (SmscMain.c)
 * Callees:
 *     SmpGetFirstSessionId @ 0x1400033FC (SmpGetFirstSessionId.c)
 *     SmscpSetupSharedSpace @ 0x140003424 (SmscpSetupSharedSpace.c)
 *     SmscpIsDebuggerPresent @ 0x14001363C (SmscpIsDebuggerPresent.c)
 */
...
LABEL_16:
              ...
              && (SystemInformation[0] & 0x4000004) != 0 )
            {
              ...
              {
                RtlAppendUnicodeStringToString(a4, &stru_140014C20);
                v32 = SystemInformation[0];
                if ( (SystemInformation[0] & 0x20000) != 0 )
                {
                  RtlAppendUnicodeStringToString(a4, &stru_140014C10);
                  v32 = SystemInformation[0];
                }
                if ( (v32 & 0x4000000) != 0 )
