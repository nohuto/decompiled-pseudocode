/*
 * XREFs of SmpConfigureSharedSessionData @ 0x140005FBC
 * Callers:
...
NTSTATUS SmpConfigureSharedSessionData()
{
  ...
  v47 = L"Execute";
  v48 = &dword_1400219F8;
  qword_140021A18 = (__int64)&qword_140021A10;
  qword_140021A10 = (__int64)&qword_140021A10;
  v29 = 0LL;
  v30 = 0;
  v35 = 0;
  v36 = 0LL;
  ...
  v56 = 0LL;
  v57 = 0;
  qword_140021A08 = (__int64)&BaseAddress;
  BaseAddress = &BaseAddress;
  qword_140021A28 = (__int64)&qword_140021A20;
  qword_140021A20 = (__int64)&qword_140021A20;
  ...
  if ( result >= 0 )
  {
    ...
    while ( v2 != &BaseAddress )
    {
      ...
      v4 = v2;
      v2 = v3;
      if ( v3[1] != v4 || (v5 = (PVOID **)v4[1], *v5 != v4) )
        __fastfail(3u);
      *v5 = v3;
      v3[1] = v5;
      SmpDeallocSavedRegistryEntry(v4);
    }
    if ( (__int64 *)qword_140021A20 == &qword_140021A20 )
    {
      v6 = 0LL;
    }
    else
    {
      v6 = qword_140021A28;
      v18 = *(_QWORD **)(qword_140021A28 + 8);
      if ( *(__int64 **)qword_140021A28 != &qword_140021A20 || *v18 != qword_140021A28 )
        __fastfail(3u);
      qword_140021A28 = *(_QWORD *)(qword_140021A28 + 8);
      *v18 = &qword_140021A20;
    }
    SmpInitExecuteCmd = v6;
    v7 = (16LL * (unsigned int)dword_1400219F8 + 105) & 0xFFFFFFFFFFFFFFFEuLL;
    if ( v6 )
    ...
    MaximumSize.QuadPart = (unsigned int)dword_1400219FC
                         + (unsigned __int64)v8
                         + v7
                         + SmpS0InitCmd.Length
    ...
    if ( result >= 0 )
    {
      ...
      if ( result >= 0 )
      {
        ...
        *(_WORD *)v14 = 0;
        ...
        SmpCopyListToSharedSection((unsigned int)&qword_140021A10, 0, 1, 0, (__int64)&v20, (__int64)&v19);
        SmpCopyListToSharedSection((unsigned int)&SmpSubSystemsRequired, 1, 0, 1, (__int64)&v20, (__int64)&v19);
        SmpCopyListToSharedSection((unsigned int)&qword_140021A20, 0, 1, 2, (__int64)&v20, (__int64)&v19);
