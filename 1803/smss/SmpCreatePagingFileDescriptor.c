/*
 * XREFs of SmpCreatePagingFileDescriptor @ 0x1400095D8
 * Callers:
...
__int64 __fastcall SmpCreatePagingFileDescriptor(__int128 *a1)
{
  ...
  if ( v2 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v11) = 987;
  ...
  if ( v4 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v12) = 1025;
...
LABEL_16:
  ...
  *(_WORD *)(v6[3] + 8LL) = v8;
  ...
  {
    v9 = (_QWORD *)qword_140021538;
    if ( *(PVOID **)qword_140021538 != &SmpPagingFileDescriptorList )
      __fastfail(3u);
    *v6 = &SmpPagingFileDescriptorList;
    v6[1] = v9;
    *v9 = v6;
    qword_140021538 = (__int64)v6;
  }
