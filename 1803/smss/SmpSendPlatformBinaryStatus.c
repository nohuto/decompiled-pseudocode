/*
 * XREFs of SmpSendPlatformBinaryStatus @ 0x140012984
 * Callers:
...
char __fastcall SmpSendPlatformBinaryStatus(int a1, __int64 a2, __int64 a3, unsigned __int16 *a4)
{
  ...
  if ( a4 )
  {
    if ( (unsigned int)dword_140020020 > 5 )
    {
      v20 = v42;
      v29 = &v20;
      v31 = &v23;
      ...
      v34 = 2LL;
      v36[1] = 0;
      LOBYTE(Heap) = TlgWrite(v13, &unk_14001BBD7, v10, v11, 6u, &pData);
    }
  }
  else if ( (unsigned int)dword_140020020 > 5 )
  {
    v21 = v42;
    v38 = &v21;
    v40 = &v24;
    ...
    v39 = 4LL;
    v41 = 8LL;
    LOBYTE(Heap) = TlgWrite(v13, &unk_14001BBA6, v10, v11, 4u, &v37);
  }
  return (char)Heap;
}
