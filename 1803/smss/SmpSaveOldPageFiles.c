/*
 * XREFs of SmpSaveOldPageFiles @ 0x140009AF0
 * Callers:
      ...
      if ( v7 <= 0xFFFF )
      {
        ...
        if ( Destination.Buffer )
        {
          ...
          if ( v22[0] )
          {
            do
            {
              RtlAppendUnicodeStringToString(&Destination, (PCUNICODE_STRING)&v22[4 * v8++ + 2]);
          ...
          Destination.Length += 2;
          v2 = NtSetValueKey(SmpCrashDumpKey, &v17, 0, 7u, Destination.Buffer, v7);
          if ( v2 >= 0 )
