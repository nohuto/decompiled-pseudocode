/*
 * XREFs of SmpComputeDesiredPfSizeForCrashDump @ 0x14000FC10
 * Callers:
...
LABEL_18:
      ...
      {
        v0 = 0x40000000LL;
        v3 = (unsigned int)~(dword_140021268 - 1) & (((SmpHighestPhysicalAddress
                                                     / (unsigned __int64)(unsigned int)dword_140021268
                                                     + 7) >> 3)
                                                   + (unsigned int)(dword_140021268 - 1)
                                                   + 8256LL);
