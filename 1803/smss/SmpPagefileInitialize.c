/*
 * XREFs of SmpPagefileInitialize @ 0x140009E74
 * Callers:
 *     SmpAsyncMemoryConfiguration @ 0x140009D00 (SmpAsyncMemoryConfiguration.c)
 * Callees:
 *     SmpQueryFilterPagesDumpSetting @ 0x14000A040 (SmpQueryFilterPagesDumpSetting.c)
 *     SmpQueryCrashDumpType @ 0x14000A08C (SmpQueryCrashDumpType.c)
 ...
 *     SmpQueryCopyDumpSetting @ 0x14000C924 (SmpQueryCopyDumpSetting.c)
...
NTSTATUS SmpPagefileInitialize()
{
  ...
  qword_140021538 = (__int64)&SmpPagingFileDescriptorList;
  SmpPagingFileDescriptorList = &SmpPagingFileDescriptorList;
  qword_140021518 = (__int64)&SmpVolumeDescriptorList;
