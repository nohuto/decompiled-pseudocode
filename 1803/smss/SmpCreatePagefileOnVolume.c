/*
 * XREFs of SmpCreatePagefileOnVolume @ 0x140008F98
 * Callers:
 *     SmpCreatePagefileFromDescriptor @ 0x1400091C0 (SmpCreatePagefileFromDescriptor.c)
 * Callees:
...
__int64 __fastcall SmpCreatePagefileOnVolume(__int64 a1, __int64 a2, int a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v8 < 0 )
  {
    ...
    *((_DWORD *)&SmpPagefileLog + 2 * v21) = 2164;
  ...
  *(_DWORD *)(a1 + 88) = 0;
  ...
  if ( (v17 & 8) != 0 && SmpCheckHybridPriority(*(_DWORD *)(a2 + 20), &v37, 0LL) >= 0 && (v37 & 0xFFFFFFF0) == 0 )
