/*
 * XREFs of SmpUpdatePagefileUsageCallback @ 0x1400103C0
 * Callers:
 *     <none>
 * Callees:
...
char SmpUpdatePagefileUsageCallback()
{
  ...
  v0 = SmpMemorySize / (unsigned __int64)(unsigned int)dword_140021268;
    ...
    if ( (int)Heap >= 0 )
    {
      for ( i = 256LL; ; i = ReturnLength )
      {
        ...
        if ( v4 >= 0 )
        {
          ...
          v9 = v6 + v20;
          v10 = 0x400000000uLL / (unsigned int)dword_140021268 + v2;
          if ( 10 * v2 / 9 <= v10 )
            v10 = 10 * v2 / 9;
          if ( v10 > v0 )
          {
          ...
          if ( v9 > 0xFFFFFFFF )
            LODWORD(v9) = -1;
          dword_1400215B4[(unsigned int)Data % 0xF0] = v9;
          v12 = 7;
          LODWORD(Data) = Data + 1;
