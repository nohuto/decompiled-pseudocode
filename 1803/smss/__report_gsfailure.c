/*
 * XREFs of __report_gsfailure @ 0x14000C6E0
 * Callers:
 *     __security_check_cookie @ 0x14000C6C0 (__security_check_cookie.c)
 * Callees:
 *     NtTerminateProcess_0 @ 0x14000C8FE (NtTerminateProcess_0.c)
 *     RtlCaptureContext_0 @ 0x14000C90A (RtlCaptureContext_0.c)
 *     RtlLookupFunctionEntry_0 @ 0x14000C910 (RtlLookupFunctionEntry_0.c)
 *     RtlVirtualUnwind_0 @ 0x14000C916 (RtlVirtualUnwind_0.c)
 *     RtlUnhandledExceptionFilter_0 @ 0x14000C91C (RtlUnhandledExceptionFilter_0.c)
 */
