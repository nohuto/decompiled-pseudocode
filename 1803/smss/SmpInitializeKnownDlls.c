/*
 * XREFs of SmpInitializeKnownDlls @ 0x140006C40
 * Callers:
 *     SmpLoadDataFromRegistry @ 0x140007064 (SmpLoadDataFromRegistry.c)
 * Callees:
 *     SmpEventWriteULONG @ 0x140002ECC (SmpEventWriteULONG.c)
 *     SmpOpenKnownDllsHandles @ 0x140005D14 (SmpOpenKnownDllsHandles.c)
 *     SmpInitializeKnownDllsInternal @ 0x1400066C0 (SmpInitializeKnownDllsInternal.c)
 *     SmpWow64IsWowGuestMachineSupported @ 0x140006ED4 (SmpWow64IsWowGuestMachineSupported.c)
        ...
        if ( !v2 || (v5 = SmpInitializeKnownDllsInternal((__int64)v2, v1, 1, v0), v5 >= 0) )
        {
          ...
          if ( SmpExcludeKnownDllsList != &SmpExcludeKnownDllsList )
          {
            do
            {
              ...
              v14 = v11;
              v11 = v13;
              if ( v13[1] != v14 || (v15 = (PVOID **)v14[1], *v15 != v14) )
                __fastfail(3u);
              *v15 = v13;
              v13[1] = v15;
