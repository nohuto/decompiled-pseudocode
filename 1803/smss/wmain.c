...
__int64 __fastcall wmain(int a1, PCWSTR *a2, __int64 a3, unsigned int a4)
{
  ...
  if ( a1 <= 1 )
  {
    ...
    if ( v17 < 0 )
    {
      ...
      v31 = (__int64 (__fastcall *)(_QWORD))TpAllocPool;
    }
    else
    {
      ...
      else
      {
        ...
        *(_QWORD *)&xmmword_140020CC8 = v43;
        ...
        if ( v21 < 0 )
        {
          ...
          SmpInitReturnStatus = v18;
          v31 = (__int64 (__fastcall *)(_QWORD))TpAllocAlpcCompletion;
        }
        else
        {
