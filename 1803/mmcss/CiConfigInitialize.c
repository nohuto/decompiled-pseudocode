/*
 * XREFs of CiConfigInitialize @ 0x1C000C620
 * Callers:
...
__int64 CiConfigInitialize()
{
  ...
  ObjectAttributes.ObjectName = (PUNICODE_STRING)0x1C000E100LL;
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    DWORD = CiConfigReadDWORD(KeyHandle, 0x1C000E090LL, 100LL);
    if ( DWORD - 10 > 0x5A )
      v2 = 20;
    else
      v2 = 10 * (DWORD / 0xA);
    ...
    {
      v3 = CiConfigReadDWORD(KeyHandle, 0x1C000E0A0LL, 10LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          v4);
      v5 = (unsigned __int8)CiConfigReadDWORD(KeyHandle, 0x1C000E080LL, 0LL) != 0;
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          v5);
      v6 = CiConfigReadDWORD(KeyHandle, 0x1C000E0B0LL, 2LL);
      ...
      HIDWORD(WPP_MAIN_CB.Dpc.DpcData) = CiConfigReadDWORD(KeyHandle, 0x1C000E0C0LL, 1000000LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          DpcData_high);
      WPP_MAIN_CB.ActiveThreadCount = CiConfigReadDWORD(KeyHandle, 0x1C000E0D0LL, 10000LL);
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          ActiveThreadCount);
      v9 = CiConfigReadDWORD(KeyHandle, 0x1C000E0E0LL, 100000LL);
      *(&WPP_MAIN_CB.ActiveThreadCount + 1) = v9;
      ...
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_d(
          ...
          (__int64)&WPP_1d5a60252b7d3a9c2ed54ac3501c653e_Traceguids,
          v9);
      v10 = CiConfigReadDWORD(KeyHandle, 0x1C000E0F0LL, 32LL);
      ...
      ObjectAttributes.Length = 48;
      ObjectAttributes.ObjectName = (PUNICODE_STRING)0x1C000E110LL;
      ObjectAttributes.Attributes = 64;
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
