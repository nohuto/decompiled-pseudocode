/*
 * XREFs of CiDispatchCreateNotificationClient @ 0x1C0009920
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_q @ 0x1C0002174 (WPP_SF_q.c)
  ...
  *((_QWORD *)v9 + 1) = 0LL;
  ...
  if ( v7 < 0 )
  {
    if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
      WPP_SF_q((__int64)WPP_GLOBAL_Control->AttachedDevice, v11, v12, v10[1]);
