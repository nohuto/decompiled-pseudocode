/*
 * XREFs of CiSchedulerWait @ 0x1C0003944
 * Callers:
 ...
 *     CiSystemDetectIdleProcessors @ 0x1C0003B24 (CiSystemDetectIdleProcessors.c)
 */
          ...
          if ( !CiSchedulerInLazyMode )
          {
            if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
              WPP_SF_d(
                ...
                0xDu,
                (__int64)&WPP_c976057acd8135066dd3f9f7e7715f48_Traceguids,
