/*
 * XREFs of McTemplateK0pqccctq @ 0x1C0033FFC
 * Callers:
...
NTSTATUS McTemplateK0pqccctq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v17 = 4LL;
  v19 = 4LL;
  return McGenEventWriteKM(a1, &EventUnitPowerNotRequiredStart, 0LL, 8u, &v5);
}
