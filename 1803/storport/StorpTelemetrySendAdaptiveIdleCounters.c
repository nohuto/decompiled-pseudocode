/*
 * XREFs of StorpTelemetrySendAdaptiveIdleCounters @ 0x1C0001F3C
 * Callers:
...
void __fastcall StorpTelemetrySendAdaptiveIdleCounters(__int64 a1)
{
  ...
  if ( (unsigned __int8)RaidUnitCheckAndAcquirePoFx() )
  {
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1488) + 32LL) & 0x80u) != 0 )
    {
      ...
      v2 = MEMORY[0xFFFFF78000000014] - *(_QWORD *)(a1 + 2616);
      if ( v2 > 0 )
      ...
      if ( (unsigned int)dword_1C0056060 > 5 )
      {
        if ( TlgKeywordOn((TraceLoggingHProvider)v2, 0x400000000000uLL) )
        {
          ...
          v44 = 8LL;
          v46 = 8LL;
          TlgWrite((TraceLoggingHProvider)v12, &unk_1C004E50F, (LPCGUID)v6, v3, 0xFu, &pData);
        }
      }
