/*
 * XREFs of RaidAdapterSetSystemPowerCompletion @ 0x1C00105B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterSetSystemPowerCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 42LL, &WPP_39b6f691d58430155b1312f31604fba7_Traceguids, v2, a2);
  }
  v4 = *(_QWORD *)(a2 + 184);
  v5 = *(_DWORD *)(v2 + 264);
  v6 = *(int *)(v4 + 24);
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 43LL, &WPP_39b6f691d58430155b1312f31604fba7_Traceguids, v2, a2, v10);
  }
