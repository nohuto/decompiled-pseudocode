/*
 * XREFs of RaidAdapterReleaseResources @ 0x1C0064554
 * Callers:
 ...
 *     RaAdapterDeregisterFromIdleDetection @ 0x1C003496C (RaAdapterDeregisterFromIdleDetection.c)
 *     RaidFreeMappingList @ 0x1C00397D4 (RaidFreeMappingList.c)
