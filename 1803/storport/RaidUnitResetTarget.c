/*
 * XREFs of RaidUnitResetTarget @ 0x1C003D6E4
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C004265C (StorpAggregateHierarchicalResetTarget.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0056060 > 5 )
      {
        ...
        v40 = 1LL;
        v42 = 8LL;
        TlgWrite((TraceLoggingHProvider)8, &unk_1C004C24D, v18, v19, 8u, &pData);
      }
