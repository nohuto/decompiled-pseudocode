/*
 * XREFs of McTemplateK0xpccpcccccqxx @ 0x1C00402F8
 * Callers:
...
NTSTATUS McTemplateK0xpccpcccccqxx(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v28 = 8LL;
  v30 = 8LL;
  return McGenEventWriteKM(a1, a2, a3, 0xEu, &v4);
}
