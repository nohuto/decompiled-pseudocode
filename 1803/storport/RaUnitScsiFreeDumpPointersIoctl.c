/*
 * XREFs of RaUnitScsiFreeDumpPointersIoctl @ 0x1C000FDA0
 * Callers:
...
__int64 __fastcall RaUnitScsiFreeDumpPointersIoctl(__int64 a1, IRP *a2)
{
  ...
  if ( *(_BYTE *)(a1 + 1477) == 1 && v2 )
  {
    ...
    *(_QWORD *)(v7 + 168) = Srb;
    if ( BYTE2(MdlAddress[2].Process) == 1 )
    {
      ...
      *((_QWORD *)Srb + 12) = v7;
      Srb[v27 + 8] = *(_BYTE *)(a1 + 88);
      Srb[v27 + 9] = *(_BYTE *)(a1 + 89);
      Srb[v27 + 10] = *(_BYTE *)(a1 + 90);
      v29 = 1;
      v30 = Srb;
    }
    else
    ...
    *(_QWORD *)(v7 + 656) = RaidXrbSignalCompletion;
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 38LL, &WPP_b61d05cf262d3423cd62436c925d288c_Traceguids, v7, Srb);
    }
    if ( *(_BYTE *)(v2 + 4450) )
  ...
  if ( *(_WORD *)(v11 + 5154) )
  {
    v23 = *(void (__fastcall **)(_QWORD))(v11 + 5176);
    if ( v23 )
    {
      v23(*(_QWORD *)(v11 + 5160));
      v22 = *(_QWORD *)(a1 + 24);
  ...
  StorPortReleaseAdditionalCrashDumpArea(v22 + 696, &MdlAddress->Process);
