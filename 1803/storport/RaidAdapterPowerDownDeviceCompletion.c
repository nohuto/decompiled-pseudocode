/*
 * XREFs of RaidAdapterPowerDownDeviceCompletion @ 0x1C0010B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterPowerDownDeviceCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 25LL, &WPP_39b6f691d58430155b1312f31604fba7_Traceguids, v2, a2);
  }
  if ( *(_BYTE *)(a2 + 65) )
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x100000) != 0 )
      McTemplateK0qpq(v5, v4, (unsigned int)v9, *(_DWORD *)(v2 + 56), a2, *(_DWORD *)(a2 + 48));
  }
  if ( *(char *)(v2 + 109) < 0 )
  {
    v7 = *(_DWORD *)(v2 + 676);
