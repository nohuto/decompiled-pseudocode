/*
 * XREFs of McTemplateK0pqqcccqpp @ 0x1C002EFF4
 * Callers:
...
NTSTATUS McTemplateK0pqqcccqpp(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWriteKM(a1, &EventStateChangeDetected, a3, 0xAu, &v4);
}
