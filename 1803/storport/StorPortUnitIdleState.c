/*
 * XREFs of StorPortUnitIdleState @ 0x1C0036BB0
 * Callers:
            ...
            *(_BYTE *)(a1 + 153) = v14 | 8;
            if ( !(unsigned __int8)RaidAdapterPoFxActivateComponent(v13, 0LL, 0LL) )
            {
              ...
              if ( *(int *)(v15 + 268) > 1 )
              {
                *(_BYTE *)(a1 + 1656) = 1;
                *(_DWORD *)(a1 + 1660) = a3;
                ExpInterlockedPushEntrySList((PSLIST_HEADER)(v15 + 5072), (PSLIST_ENTRY)(a1 + 1680));
...
LABEL_43:
                ...
                LODWORD(v26) = a3;
                LODWORD(v25) = a2;
                LOBYTE(v24) = *(_BYTE *)(a1 + 90);
                LOBYTE(v23) = *(_BYTE *)(a1 + 89);
                LOBYTE(v22) = *(_BYTE *)(a1 + 88);
                LODWORD(v21) = *(_DWORD *)(v20 + 56);
                McTemplateK0pqcccqq(v20, v17, v16, **(_QWORD **)(a1 + 1488), v21, v22, v23, v24, v25, v26);
LABEL_44:
