/*
 * XREFs of StorPortAdapterIdleCondition @ 0x1C0036470
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall StorPortAdapterIdleCondition(__int64 a1, unsigned int a2)
{
  ...
  {
    v7 = *(_DWORD *)(a1 + 56);
    McTemplateK0pqq(a1, &EventAdapterIdleConditionStart, 0LL, **(_QWORD **)(a1 + 5088), v7, a2);
  }
  *(_DWORD *)(*(_QWORD *)(a1 + 5088) + 20LL) &= ~1u;
  ...
  if ( StorEtwLoggingEnabled )
  {
    if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x100000) != 0 )
    {
      ...
      return McTemplateK0pqq(v5, &EventAdapterIdleConditionStop, 0LL, **(_QWORD **)(a1 + 5088), v6, v8);
    }
  }
  return result;
}
