/*
 * XREFs of StorpGetExtendedTable @ 0x1C00329A4
 * Callers:
...
__int128 *__fastcall StorpGetExtendedTable(__int64 a1, __int64 *a2)
{
  ...
  if ( a2 )
  {
    if ( a1 )
    {
      ...
      v5 = *(_QWORD *)result + 4648LL;
      *(_OWORD *)v5 = StorportExtensionTable;
      *(_OWORD *)(v5 + 16) = xmmword_1C00564D0;
      *(_OWORD *)(v5 + 32) = xmmword_1C00564E0;
      *(_OWORD *)(v5 + 48) = xmmword_1C00564F0;
      *(_OWORD *)(v5 + 64) = xmmword_1C0056500;
      *(_QWORD *)(v5 + 80) = qword_1C0056510;
      *a2 = v5;
    }
    else
    {
