/*
 * XREFs of McTemplateK0pqccc @ 0x1C002EE8C
 * Callers:
...
NTSTATUS McTemplateK0pqccc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 1LL;
  return McGenEventWriteKM(a1, &EventPortResumeDevice, 0LL, 6u, &v4);
}
