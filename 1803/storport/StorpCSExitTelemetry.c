/*
 * XREFs of StorpCSExitTelemetry @ 0x1C0042A84
 * Callers:
...
void __fastcall StorpCSExitTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    v3 = *(_QWORD *)(a1 + 5344);
    if ( v3 )
      *(_QWORD *)(a1 + 5352) += (MEMORY[0xFFFFF78000000008] - v3) / 0x2710uLL;
    if ( *(_QWORD *)(a1 + 5088) )
    {
      v4 = *(_QWORD *)(a1 + 5368);
      if ( v4 )
        *(_QWORD *)(a1 + 5376) += (v2 - v4) / 0x2710uLL;
      v5 = *(_QWORD *)(a1 + 5384);
      if ( v5 )
        *(_QWORD *)(a1 + 5392) += (v2 - v5) / 0x2710uLL;
      v6 = *(const struct _TlgProvider_t **)(a1 + 5360);
      if ( v6 )
        v6 = (const struct _TlgProvider_t *)((char *)v6 - *(_QWORD *)(a1 + 5336));
      if ( (unsigned int)dword_1C0056060 > 5 && TlgKeywordOn(v6, 0x400000000000uLL) )
      {
        v25 = *(_DWORD *)(a1 + 56);
        v10 = *(_QWORD *)(v9 + 8);
        v44 = v8;
        ...
        v102 = 4LL;
        v26 = *(_DWORD *)(v10 + 12);
        v11 = (const struct _TlgProvider_t *)(v2 - *(_QWORD *)(a1 + 5336));
        v41 = *(_QWORD *)(a1 + 5352);
        v42 = *(_QWORD *)(a1 + 5392);
        v43 = *(_QWORD *)(a1 + 5376);
        v27 = *(_DWORD *)(a1 + 5420);
        ...
        v126 = 8LL;
        v128 = 4LL;
        TlgWrite(v11, &unk_1C004E0D3, v7, v8, 0x11u, &pData);
      }
    }
    ...
    for ( i = *(__int64 **)(a1 + 120); i != (__int64 *)(a1 + 120); i = (__int64 *)*i )
    {
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 6)) )
      {
        v13 = i[213];
        if ( v13 )
          i[214] += (v2 - v13) / 0x2710uLL;
        v14 = i[215];
        if ( v14 )
          i[216] += (v2 - v14) / 0x2710uLL;
        v15 = (const struct _TlgProvider_t *)i[212];
        if ( v15 )
          v15 = (const struct _TlgProvider_t *)((char *)v15 - *(_QWORD *)(a1 + 5336));
        if ( (unsigned int)dword_1C0056060 > 5 )
        {
          if ( TlgKeywordOn(v15, 0x400000000000uLL) )
          {
            ...
            v33 = v19;
            v24 = v18;
            v20 = (const struct _TlgProvider_t *)(v2 - *(_QWORD *)(a1 + 5336));
            v48 = *(_QWORD *)(a1 + 5352);
            v49 = i[214];
            v50 = i[216];
            v35 = *((_DWORD *)i + 439);
            ...
            v95 = 8LL;
            v97 = 4LL;
            TlgWrite(v20, &unk_1C004C926, (LPCGUID)1, v16, 0x17u, &v55);
          }
        }
        ExReleaseRundownProtectionCacheAware((PEX_RUNDOWN_REF_CACHE_AWARE)i[179]);
      }
      *(__int64 *)((char *)i + 1756) = 0LL;
      *(__int64 *)((char *)i + 1764) = 0LL;
    }
