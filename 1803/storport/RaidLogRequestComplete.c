/*
 * XREFs of RaidLogRequestComplete @ 0x1C003BEE4
 * Callers:
  ...
  switch ( v12 )
  {
    case 0:
      if ( v8 == 40 )
      {
        ...
        if ( SrbScsiData )
          v3 = *SrbScsiData;
        v14 = (v3 << 8) | *(unsigned __int8 *)(v13 + 3);
        v15 = v35;
      }
      else
      {
    ...
    case 23:
      ...
      else
      {
        ...
        v32 = *(unsigned __int8 *)(a3 + 4) << 8;
      }
      v22 = ((v33 | (unsigned int)v32) << 8) | 0x17000000LL;
      break;
    case 36:
      if ( v8 == 40 )
      {
        ...
        for ( j = 0; j < v23; ++j )
        {
          ...
          if ( (unsigned int)v25 >= 0x80 )
          {
            ...
            if ( (unsigned int)v25 <= (unsigned int)v26 )
            {
              ...
              {
                v9 = *(_DWORD *)((unsigned int)v25 + v13 + 12);
                v11 = 1;
              }
              if ( v11 )
                break;
        ...
        v27 = (v9 << 8) | *(unsigned __int8 *)(v13 + 3);
      }
      else
      {
    ...
    case 37:
      ...
      else
      {
        ...
        v20 = *(unsigned __int8 *)(a3 + 4) << 8;
      }
      v22 = ((v21 | (unsigned int)v20) << 8) | 0x25000000LL;
      break;
    default:
