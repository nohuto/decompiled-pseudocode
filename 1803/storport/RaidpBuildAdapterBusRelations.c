/*
 * XREFs of RaidpBuildAdapterBusRelations @ 0x1C00128E0
 * Callers:
 ...
 *     RaidUnitSetEnumerated @ 0x1C0012B2C (RaidUnitSetEnumerated.c)
...
__int64 __fastcall RaidpBuildAdapterBusRelations(__int64 a1, _QWORD *a2)
{
  ...
  {
    WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 40LL, &WPP_0e2a19f4a3e138dc01b4b18bc88c5901_Traceguids, a1);
  }
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
  {
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 41LL, &WPP_0e2a19f4a3e138dc01b4b18bc88c5901_Traceguids);
  }
  for ( i = *(_QWORD **)(a1 + 120); i != (_QWORD *)(a1 + 120); i = (_QWORD *)*i )
  {
    ...
    if ( (i[13] & 4) != 0 )
    {
      ...
      if ( v7 > (unsigned int)v3 )
      {
        ...
        if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
          WPP_SF_DD(WPP_GLOBAL_Control->AttachedDevice, 43LL, &WPP_0e2a19f4a3e138dc01b4b18bc88c5901_Traceguids, v7, v3);
        break;
      }
      v11 = v7++;
    ...
    else
    {
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        v17 = 42LL;
LABEL_36:
        WPP_SF_q(v12->AttachedDevice, v17, &WPP_0e2a19f4a3e138dc01b4b18bc88c5901_Traceguids, i - 6);
        continue;
      }
    }
  }
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
  {
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 45LL, &WPP_0e2a19f4a3e138dc01b4b18bc88c5901_Traceguids);
  }
LABEL_15:
  v13 = *(_QWORD **)(a1 + 200);
  while ( 2 )
  {
    if ( v13 != (_QWORD *)(a1 + 200) )
    {
      ...
      WPP_SF_q(v20->AttachedDevice, v21, &WPP_0e2a19f4a3e138dc01b4b18bc88c5901_Traceguids, v13 - 6);
LABEL_54:
      v13 = (_QWORD *)*v13;
      continue;
    }
  ...
  *(_QWORD *)(a1 + 4456) = v15;
  ...
  {
    WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 49LL, &WPP_0e2a19f4a3e138dc01b4b18bc88c5901_Traceguids, a1);
  }
LABEL_21:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
  {
    WPP_SF_qD(WPP_GLOBAL_Control->AttachedDevice, 50LL, &WPP_0e2a19f4a3e138dc01b4b18bc88c5901_Traceguids, a1, v4);
  }
  return v4;
}
