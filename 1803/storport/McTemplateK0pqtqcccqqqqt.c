/*
 * XREFs of McTemplateK0pqtqcccqqqqt @ 0x1C003FFE0
 * Callers:
...
NTSTATUS McTemplateK0pqtqcccqqqqt(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v26 = 4LL;
  v28 = 4LL;
  return McGenEventWriteKM(a1, &EventPassThroughProtocolCommand, a3, 0xDu, &v4);
}
