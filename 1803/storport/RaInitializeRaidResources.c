/*
 * XREFs of RaInitializeRaidResources @ 0x1C003F9FC
 * Callers:
        ...
        int a6)
{
  ...
  *((_DWORD *)&ListHead[7].HeaderX64 + 1) = a6;
  v7 = a2;
  Blink = (unsigned __int64)WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink;
  ...
  *((_DWORD *)&ListHead[7].HeaderX64 + 3) = 0;
  ...
  if ( Blink >= 0x40000000 )
  {
    ...
    if ( Blink >= 0x200000000LL )
    {
      v15 = 0x400000000LL;
      if ( Blink < 0x400000000LL )
        goto LABEL_16;
      ...
      while ( 1 )
      {
        ...
        if ( (unsigned int)v12 >= (unsigned int)Alignment_low )
          break;
        if ( v15 > 0x800000000000LL || Blink < v15 )
          goto LABEL_16;
      }
    }
LABEL_15:
...
LABEL_16:
  if ( !Blink
    || (Alignment = ListHead[5].Alignment,
        Alignment_low = *((unsigned int *)&ListHead[5].HeaderX64 + 1) * (unsigned __int64)Alignment,
        Blink /= 0x2710uLL,
        Alignment_low > Blink) )
  {
    Alignment = v12;
  ...
  if ( MaximumProcessorCount > 0x10 )
  {
    ...
    LODWORD(ListHead[4].Alignment) = v19;
    goto LABEL_31;
  }
  LODWORD(ListHead[4].Alignment) = 0;
  InitializeSListHead(ListHead);
  v19 = ListHead[4].Alignment;
LABEL_31:
  *((_DWORD *)&ListHead[4].HeaderX64 + 1) = MaximumProcessorCount;
  if ( v19 )
  {
    Pool = RaidAllocatePool(NonPagedPoolNx, 8LL * v19, 0x53526152u, a4);
