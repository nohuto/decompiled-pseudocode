/*
 * XREFs of McTemplateK0qqqqq @ 0x1C00244F4
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqq(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  v18 = &a8;
  v19 = 4LL;
  return McGenEventWriteKM(a1, &EventAdapterSystemPowerHint, 0LL, 6u, &v9);
}
