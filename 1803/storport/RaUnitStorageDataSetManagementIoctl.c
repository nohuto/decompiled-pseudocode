/*
 * XREFs of RaUnitStorageDataSetManagementIoctl @ 0x1C005EFC0
 * Callers:
...
LABEL_17:
  ...
  {
    if ( BYTE2(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink) )
    {
LABEL_41:
      v8 = 60;
  ...
  else if ( v12 > 0x8000000D && v12 <= 0x8000000F )
  {
    goto LABEL_41;
  }
  v13 = -1073741637;
LABEL_11:
  ...
  if ( !Srb
    || (ContiguousIoResources = StorAllocateContiguousIoResources(
                                  ((*(_DWORD *)(v2 + 444) + 7) & 0xFFFFFFF8) + 1088,
                                  v17,
                                  v2),
