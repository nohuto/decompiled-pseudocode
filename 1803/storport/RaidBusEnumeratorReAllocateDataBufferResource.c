/*
 * XREFs of RaidBusEnumeratorReAllocateDataBufferResource @ 0x1C002C4B4
 * Callers:
 ...
 *     RaidBusEnumeratorReleaseDataBufferResource @ 0x1C002C554 (RaidBusEnumeratorReleaseDataBufferResource.c)
 */
