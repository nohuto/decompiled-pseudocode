/*
 * XREFs of McTemplateK0zqcccjqqbx @ 0x1C004054C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqcccjqqbx(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        const wchar_t *a4,
        ...
        char a13)
{
  ...
  v36 = 0;
  v38 = 8LL;
  return McGenEventWriteKM(v14, &EventMiniportBugResetBroken, a3, 0xBu, &v16);
}
