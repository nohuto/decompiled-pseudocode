/*
 * XREFs of RaidAdapterSurpriseRemovalIrp @ 0x1C006498C
 * Callers:
  ...
  *(_DWORD *)(a1 + 88) = 5;
  ...
  if ( (unsigned int)dword_1C0056060 > 5 && TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
  {
    ...
    *(_DWORD *)&hProvider[7] = v5;
    ...
    v35 = v12;
    v38 = v14;
    TlgWrite((TraceLoggingHProvider)hProvider, &unk_1C004BE68, v15, v16, 0xAu, (EVENT_DATA_DESCRIPTOR *)&hProvider[31]);
  }
