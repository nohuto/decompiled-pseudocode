/*
 * XREFs of McTemplateK0zqqqqqqq @ 0x1C003F404
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqqqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a11)
{
  ...
  v29 = 4LL;
  v31 = 4LL;
  return McGenEventWriteKM(v12, &EventAdapterResourceListFailure, 0LL, 9u, &v14);
}
