/*
 * XREFs of RaidUnitSendSrbProtocolCommandSynchronously @ 0x1C003DCA8
 * Callers:
...
__int64 __fastcall RaidUnitSendSrbProtocolCommandSynchronously(__int64 a1, IRP *a2, char a3)
{
  ...
  if ( Options <= Length )
    Options = Length;
  Srb = RaidAllocateSrb(v12, 9u, *(_BYTE *)(v11 + 402), 0);
  v14 = 0LL;
  ...
  if ( *(_BYTE *)(v11 + 402) == 1 )
  {
    ...
    *(_DWORD *)(v15 + 40) = Blink;
    *(_BYTE *)(v19 + v15 + 8) = *(_BYTE *)(a1 + 88);
    *(_BYTE *)(v19 + v15 + 9) = *(_BYTE *)(a1 + 89);
    *(_BYTE *)(v19 + v15 + 10) = *(_BYTE *)(a1 + 90);
  }
  else
  {
    Srb[2] = 9;
    ...
    *((_QWORD *)Srb + 6) = a2;
    ...
    if ( !v21 )
      v21 = *(_DWORD *)(a1 + 1032);
    *(_DWORD *)(v15 + 20) = v21;
    *(_BYTE *)(v15 + 5) = *(_BYTE *)(a1 + 88);
    *(_BYTE *)(v15 + 6) = *(_BYTE *)(a1 + 89);
    *(_BYTE *)(v15 + 7) = *(_BYTE *)(a1 + 90);
  }
