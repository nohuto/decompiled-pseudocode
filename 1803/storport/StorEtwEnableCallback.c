/*
 * XREFs of StorEtwEnableCallback @ 0x1C0040714
 * Callers:
 ...
 *     StorEtwAdapterNeedsUpdate @ 0x1C0040674 (StorEtwAdapterNeedsUpdate.c)
      ...
      if ( v11 )
      {
        if ( (_DWORD)v12 )
        {
          ...
          do
          {
            ...
            ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(*v21++ + 256));
            --v12;
          }
          while ( v12 );
        }
