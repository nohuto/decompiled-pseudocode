/*
 * XREFs of McTemplateK0zqcccjqqb @ 0x1C0040434
 * Callers:
 *     StorEtwMiniportBugAbortBrokenEvent @ 0x1C0041374 (StorEtwMiniportBugAbortBrokenEvent.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C0005478 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C0017BC0 (__security_check_cookie.c)
 */

NTSTATUS __fastcall McTemplateK0zqcccjqqb(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        const wchar_t *a4,
        ...
        __int64 a12)
{
  ...
  v32 = 4LL;
  v35 = 0;
  return McGenEventWriteKM(v13, &EventMiniportBugAbortBroken, a3, 0xAu, &v15);
}
