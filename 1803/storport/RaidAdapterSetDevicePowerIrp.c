/*
 * XREFs of RaidAdapterSetDevicePowerIrp @ 0x1C000E2AC
 * Callers:
...
__int64 __fastcall RaidAdapterSetDevicePowerIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 17LL, &WPP_39b6f691d58430155b1312f31604fba7_Traceguids, a1, a2);
  }
  v4 = *(_DWORD *)(a1 + 268);
...
LABEL_9:
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 19LL, &WPP_39b6f691d58430155b1312f31604fba7_Traceguids, a1, a2, v6);
  }
  return v7;
}
