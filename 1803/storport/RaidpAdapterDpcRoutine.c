/*
 * XREFs of RaidpAdapterDpcRoutine @ 0x1C000AE80
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( DpcCompletionLimit )
  {
    do
    {
      ...
      if ( !p_Next )
      {
        if ( v7 )
          break;
        v10 = ExpInterlockedFlushSList((PSLIST_HEADER)(v4 + 224));
        *(_QWORD *)(v4 + 240) = v10;
        v7 = 1;
        p_Next = &v10->Next;
        if ( !v10 )
      ...
      *(_QWORD *)(v4 + 240) = *p_Next;
      ...
      {
        RaidAdapterPoFxIdleComponentFromMiniport(v4, *((unsigned int *)v11 + 187));
        *((_BYTE *)v11 + 17) &= ~1u;
      }
