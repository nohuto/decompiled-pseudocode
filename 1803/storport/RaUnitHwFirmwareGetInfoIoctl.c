/*
 * XREFs of RaUnitHwFirmwareGetInfoIoctl @ 0x1C0015698
 * Callers:
 ...
 *     RaTranslateMiniportFirmwareInfoToHwFirmwareInfo @ 0x1C00390A4 (RaTranslateMiniportFirmwareInfoToHwFirmwareInfo.c)
 */
