/*
 * XREFs of StorPortSetDeviceQueueDepth @ 0x1C0005CB0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall StorPortSetDeviceQueueDepth(__int64 a1, char a2, __int64 a3, __int64 a4, unsigned int a5)
{
  char v5; // bl
  char v6; // di
  char v7; // si
  ...
  BYTE1(v15) = a3;
  BYTE2(v15) = a4;
  Unit = RaidAdapterFindUnit(v9, v15, a3, a4);
  v11 = Unit;
