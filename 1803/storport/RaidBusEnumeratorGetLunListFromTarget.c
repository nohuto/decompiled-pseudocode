/*
 * XREFs of RaidBusEnumeratorGetLunListFromTarget @ 0x1C0013810
 * Callers:
 *     RaidBusEnumeratorGetLunList @ 0x1C00134B0 (RaidBusEnumeratorGetLunList.c)
 * Callees:
 *     RaidBusEnumeratorIssueReportLuns @ 0x1C00139F4 (RaidBusEnumeratorIssueReportLuns.c)
...
LABEL_12:
      ...
      do
      {
        ...
        if ( v15 >= 0xFFu )
        {
          if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
          {
            ...
            {
              WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 18LL, &WPP_f0a7e80c00373f324f5040e12af5bb70_Traceguids, v15);
            }
          }
        }
        else
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
    {
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
        WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 19LL, &WPP_f0a7e80c00373f324f5040e12af5bb70_Traceguids, *a1);
      if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x4000) != 0
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_f0a7e80c00373f324f5040e12af5bb70_Traceguids);
      }
    }
    for ( i = v11; i < 0xFFu; ++i )
    {
      if ( *a4 != (_BYTE)v11
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
      {
        WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 21LL, &WPP_f0a7e80c00373f324f5040e12af5bb70_Traceguids, i);
      }
      ++a4;
    }
    return 0LL;
