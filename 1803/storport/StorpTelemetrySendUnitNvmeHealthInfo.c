/*
 * XREFs of StorpTelemetrySendUnitNvmeHealthInfo @ 0x1C0046410
 * Callers:
    ...
    if ( HIDWORD(WPP_MAIN_CB.Reserved) )
    {
      ...
      if ( (unsigned int)dword_1C0056060 > 5 && TlgKeywordOn(v13, 0x800000000000uLL) )
      {
        ...
        *(_QWORD *)&hProvider.LevelPlus1 = *((_QWORD *)&WPP_MAIN_CB.Reserved + 1);
        ...
        v85 = 8LL;
        v87 = 8LL;
        TlgWrite(&hProvider, &unk_1C004D2E9, v20, v21, 0x19u, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAll);
      }
    }
    else
    {
LABEL_43:
      if ( (unsigned int)dword_1C0056060 > 5 && TlgKeywordOn((TraceLoggingHProvider)v12, 0x400000000000uLL) )
      {
        ...
        hProvider.KeywordAny = *((_QWORD *)&WPP_MAIN_CB.Reserved + 1);
        v31 = *(_BYTE *)(a1 + 1740);
        v36[0] = v35;
