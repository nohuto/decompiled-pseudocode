/*
 * XREFs of RaUnitAsyncError @ 0x1C000CED4
 * Callers:
...
LABEL_3:
  ...
  if ( *(_BYTE *)(a1 + 2624)
    || (v23 = *(_DWORD *)(a1 + 1544), ByteOffset.LowPart >= v23) && v23 && (*(_BYTE *)(v2 + 3) & 0x3F) != 0x25 )
  {
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      && (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) != 0
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    {
      WPP_SF_qdq(WPP_GLOBAL_Control->AttachedDevice, 60LL, v20, a1, ByteOffset.LowPart, v2);
    }
    *(_BYTE *)(v2 + 3) = 4;
    if ( v7 == 8 )
      *v8 = 40;
LABEL_9:
    if ( (v25 & 0x100) == 0 && !*(_BYTE *)(a1 + 436) )
    {
      *(_BYTE *)(a1 + 436) = 1;
      *(_BYTE *)(v2 + 3) |= 0x40u;
    }
  ...
  {
    WPP_SF_qdq(WPP_GLOBAL_Control->AttachedDevice, 59LL, v20, a1, ByteOffset.LowPart, v2);
  }
