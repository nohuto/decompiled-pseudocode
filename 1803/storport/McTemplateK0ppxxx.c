/*
 * XREFs of McTemplateK0ppxxx @ 0x1C0023F10
 * Callers:
...
NTSTATUS McTemplateK0ppxxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 8LL;
  return McGenEventWriteKM(a1, &EventSMROutOfOrderWrite, 0LL, 6u, &v4);
}
