/*
 * XREFs of RaGetBusInterface @ 0x1C0038F1C
 * Callers:
...
__int64 __fastcall RaGetBusInterface(struct _DEVICE_OBJECT *a1)
{
  ...
  if ( IoGetDeviceProperty(a1, DevicePropertyBusTypeGuid, 0x10u, &PropertyBuffer, &ResultLength) < 0 )
    return 0xFFFFFFFFLL;
  v2 = PropertyBuffer - *(_QWORD *)&GUID_BUS_TYPE_PCMCIA.Data1;
  if ( PropertyBuffer == *(_QWORD *)&GUID_BUS_TYPE_PCMCIA.Data1 )
    v2 = v8 - *(_QWORD *)GUID_BUS_TYPE_PCMCIA.Data4;
  if ( !v2 )
    return 1LL;
  v3 = PropertyBuffer - *(_QWORD *)&GUID_BUS_TYPE_PCI.Data1;
  if ( PropertyBuffer == *(_QWORD *)&GUID_BUS_TYPE_PCI.Data1 )
    v3 = v8 - *(_QWORD *)GUID_BUS_TYPE_PCI.Data4;
  if ( !v3 )
    return 5LL;
