/*
 * XREFs of RaDriverPnpIrp @ 0x1C0007700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaDriverPnpIrp(__int64 a1, __int64 a2)
{
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(
      ...
      20LL,
      &WPP_fca335724287372554e4fcd7cdd207c8_Traceguids,
      a1,
      a2,
...
LABEL_7:
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 21LL, &WPP_fca335724287372554e4fcd7cdd207c8_Traceguids, a1, a2, v6);
  }
  return v6;
}
