/*
 * XREFs of RaCallMiniportFindAdapter @ 0x1C002E8E0
 * Callers:
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control )
    {
      if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
        WPP_SF_(
          ...
          0xAu,
          (__int64)&WPP_5e467953a1673a6c21fa3488781658f6_Traceguids);
      if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
...
LABEL_24:
  ...
  v16 = *a1;
  if ( *(_DWORD *)(*a1 + 4896) && *(_QWORD *)(v16 + 4904) && *(_QWORD *)(v16 + 4912) )
  {
    v17 = 0;
    do
    {
      v12 = *(_QWORD *)(v16 + 4904) + 16LL * v17;
      a3 = v17;
      ...
      if ( v18 )
        PoRegisterPowerSettingCallback(
          *(PDEVICE_OBJECT *)(v16 + 8),
          ...
          (PVOID)v16,
          (PVOID *)(*(_QWORD *)(v16 + 4912) + 8LL * v17));
      v16 = *a1;
      ++v17;
    }
    while ( v17 < *(_DWORD *)(*a1 + 4896) );
  }
LABEL_42:
  v19 = *((unsigned int *)v6 + 51);
  v20 = 1000;
  if ( (unsigned int)v19 <= 0x3E8 || (LOBYTE(v12) = *((_BYTE *)v6 + 144), (unsigned __int8)(v12 - 2) <= 2u) )
  {
    v20 = *((_DWORD *)v6 + 51);
    if ( (unsigned int)v19 < 0x10 )
    {
      if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x10) != 0 )
        McTemplateK0zzqqq(v19, v12, a3, L"MaxNumberOfIO", L"MaxNumberOfIO", 16, v19, 16);
      *((_DWORD *)v6 + 51) = 16;
      v20 = 16;
    }
  }
  ...
  {
    if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x10) != 0 )
      McTemplateK0zzqqq(v19, v12, a3, L"MaxNumberOfIO", L"Dma64BitAddresses", v12, v19, 232);
    *((_DWORD *)v6 + 51) = 1000;
  }
  ...
  {
    LOBYTE(v12) = *((_BYTE *)v6 + 98);
    if ( (_BYTE)v12 != 1 )
    {
      if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x10) != 0 )
        McTemplateK0zzqqq(v21, v12, a3, L"MaxIOsPerLun", L"SrbType", v12, v21, 255);
LABEL_62:
      *((_DWORD *)v6 + 52) = v22;
      goto LABEL_63;
    }
  ...
  if ( (unsigned int)v21 >= 0x10 )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x10) != 0 )
    {
      McTemplateK0zzqqq(v21, v12, a3, L"MaxIOsPerLun", L"MaxNumberOfIO", v20, v21, v20);
      v22 = *((_DWORD *)v6 + 51);
    }
    goto LABEL_62;
  }
  if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x10) != 0 )
    McTemplateK0zzqqq(v21, v12, a3, L"MaxIOsPerLun", L"MaxIOsPerLun", 16, v21, 16);
  *((_DWORD *)v6 + 52) = 16;
  v22 = 16;
LABEL_63:
  v23 = *((_DWORD *)v6 + 53);
  if ( v23 > v22 )
  {
    if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x10) != 0 )
    {
      McTemplateK0zzqqq(v21, v12, a3, L"InitialLunQueueDepth", L"MaxIOsPerLun", v22, v23, v22);
      v22 = *((_DWORD *)v6 + 52);
    }
    *((_DWORD *)v6 + 53) = v22;
    LOBYTE(v23) = v22;
