/*
 * XREFs of McTemplateK0zqqqqx @ 0x1C003F508
 * Callers:
...
NTSTATUS __fastcall McTemplateK0zqqqqx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a8)
{
  __int64 v8; // rax
  __int64 v9; // rcx
  _LIST_ENTRY *Blink; // [rsp+30h] [rbp-61h] BYREF
  ...
  _LIST_ENTRY **p_Blink; // [rsp+A0h] [rbp+Fh]
  ...
  p_Blink = &Blink;
  v25 = 8LL;
  return McGenEventWriteKM(v9, &EventSetAdapterResourceList, 0LL, 7u, &v12);
}
