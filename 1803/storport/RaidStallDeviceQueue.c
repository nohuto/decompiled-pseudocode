/*
 * XREFs of RaidStallDeviceQueue @ 0x1C0010300
 * Callers:
...
void __fastcall RaidStallDeviceQueue(__int64 a1, unsigned int a2, unsigned int a3, __int64 a4)
{
  ...
  {
    WPP_SF_DD(WPP_GLOBAL_Control->AttachedDevice, 11LL, &WPP_5e9bb56df4023ce50654712702575466_Traceguids, a2, a3);
  }
  if ( a2 && a3 )
  {
    ...
    if ( *(int *)(a1 + 28) > 0 || *(_DWORD *)(a1 + 32) || (v10 = *(_DWORD *)(a1 + 76), v10 >= *(_DWORD *)(a1 + 4)) )
    {
      ...
      if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
        ...
        && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
      {
        WPP_SF_DD(WPP_GLOBAL_Control->AttachedDevice, 12LL, &WPP_5e9bb56df4023ce50654712702575466_Traceguids, a2, a3);
      }
    }
    else
    {
      ...
      else if ( a2 == 2 && v10 > 0 )
      {
        ...
        *(_DWORD *)(a1 + 32) = v14;
        ...
        {
          WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 13LL, &WPP_5e9bb56df4023ce50654712702575466_Traceguids, v14);
        }
      }
      ...
      if ( a2 == 1 )
      {
        if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
          ...
          && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
        {
          WPP_SF_D(WPP_GLOBAL_Control->AttachedDevice, 14LL, &WPP_5e9bb56df4023ce50654712702575466_Traceguids, a3);
        }
