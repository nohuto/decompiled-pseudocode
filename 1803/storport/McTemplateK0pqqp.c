/*
 * XREFs of McTemplateK0pqqp @ 0x1C002417C
 * Callers:
...
NTSTATUS McTemplateK0pqqp(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  va_copy(v11, va3);
  v12 = 8LL;
  return McGenEventWriteKM(a1, &EventPnpRequest, a3, 5u, &v4);
}
