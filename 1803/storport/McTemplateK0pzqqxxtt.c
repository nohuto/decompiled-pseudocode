/*
 * XREFs of McTemplateK0pzqqxxtt @ 0x1C00243EC
 * Callers:
...
NTSTATUS McTemplateK0pzqqxxtt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v22 = 4LL;
  v24 = 4LL;
  return McGenEventWriteKM((__int64)v3, &EventDpc, 0LL, 9u, &v7);
}
