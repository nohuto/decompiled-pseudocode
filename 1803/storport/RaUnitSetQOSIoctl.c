/*
 * XREFs of RaUnitSetQOSIoctl @ 0x1C003AD84
 * Callers:
 *     RaUnitDeviceControlIrp @ 0x1C0008110 (RaUnitDeviceControlIrp.c)
 * Callees:
 *     RaidCompleteRequestEx @ 0x1C000C410 (RaidCompleteRequestEx.c)
 *     RaidAdapterEnableQosWaitTimeoutCheck @ 0x1C0025FA0 (RaidAdapterEnableQosWaitTimeoutCheck.c)
  ...
  if ( v6 )
  {
    ...
    if ( v7 )
    {
      if ( v7 != 20 )
      {
        ...
        v9 = 44;
LABEL_84:
        WPP_SF_q((__int64)v8->AttachedDevice, v9, (__int64)&WPP_b61d05cf262d3423cd62436c925d288c_Traceguids, a1);
LABEL_85:
        v5 = -1073741637;
        goto LABEL_86;
      }
...
LABEL_33:
  ...
  if ( Flags != -1 && Flags != 500 * (Flags / 0x1F4) )
  {
    ...
    v17 = 50;
LABEL_78:
    WPP_SF_q((__int64)v16->AttachedDevice, v17, (__int64)&WPP_b61d05cf262d3423cd62436c925d288c_Traceguids, a1);
LABEL_79:
    v5 = -1073741811;
    goto LABEL_86;
  }
  ...
  *(_DWORD *)(a1 + 2636) = MasterIrp->ThreadListEntry.Flink;
  ...
  if ( v21 == -1 )
    ...
    v22 = v21 / 0x1F4;
  *(_DWORD *)(a1 + 2632) = v22;
  if ( *(_DWORD *)(a1 + 2648) == -1 && !*(_DWORD *)(a1 + 2636) && v22 == -1 )
  {
    RaidUnitDisableWaitCheckTimer(a1);
  }
  ...
  v23 = 10000000 * (*(_DWORD *)(a1 + 2640) + 1 + ((unsigned int)(*(_DWORD *)(a1 + 2632) + *(_DWORD *)(a1 + 2648)) >> 1));
