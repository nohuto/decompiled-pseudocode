/*
 * XREFs of PortTraceErrorDrainList @ 0x1C0048F20
 * Callers:
 *     PortTraceErrorWritePacket @ 0x1C0048FA0 (PortTraceErrorWritePacket.c)
 *     PortpErrorDrainListDpc @ 0x1C0049000 (PortpErrorDrainListDpc.c)
 * Callees:
