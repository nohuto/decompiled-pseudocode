/*
 * XREFs of RaBuildSetBootLunBufferForMiniport @ 0x1C0038CC0
 * Callers:
 *     RaidAdapterSetBootLunIoctl @ 0x1C0028B48 (RaidAdapterSetBootLunIoctl.c)
 * Callees:
 *     RaidAllocatePool @ 0x1C0007658 (RaidAllocatePool.c)
 *     memset @ 0x1C0018140 (memset.c)
 *     RaidAdapterFindUnitByIdentifier @ 0x1C0026018 (RaidAdapterFindUnitByIdentifier.c)
 */
...
__int64 __fastcall RaBuildSetBootLunBufferForMiniport(__int64 a1, __int64 a2, _QWORD *a3, _DWORD *a4)
{
  ...
  if ( Pool )
  {
    ...
    *v10 = 28;
    ...
    {
      v10[9] = 8;
      *((_BYTE *)v10 + 43) = UnitByIdentifier[90];
      *((_BYTE *)v10 + 41) = UnitByIdentifier[88];
      *((_BYTE *)v10 + 40) = 0;
      *((_BYTE *)v10 + 42) = UnitByIdentifier[89];
    }
    else
    {
      v8 = -1073741632;
