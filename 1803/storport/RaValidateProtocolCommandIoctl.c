/*
 * XREFs of RaValidateProtocolCommandIoctl @ 0x1C003936C
 * Callers:
...
LABEL_33:
                if ( !v14
                  || HIBYTE(WPP_MAIN_CB.SectorSize) == 1
                  && ((unsigned __int8)v13 == 5
                   || (unsigned __int8)v13 == 13
                   || (unsigned __int8)v13 > 0x13u && ((unsigned __int8)v13 <= 0x15u || (unsigned __int8)v13 == 128)) )
                {
                  return v3;
                }
                v3 = -1056964602;
