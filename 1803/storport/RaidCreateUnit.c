/*
 * XREFs of RaidCreateUnit @ 0x1C0014F78
 * Callers:
...
NTSTATUS __fastcall RaidCreateUnit(__int64 a1, _QWORD *a2)
{
  ...
  result = IoCreateDevice(*(PDRIVER_OBJECT *)(*(_QWORD *)(a1 + 8) + 8LL), 0xAC0u, 0LL, 0x2Du, 0x180u, 0, &DeviceObject);
  if ( result >= 0 )
  {
    ...
    *((_DWORD *)DeviceExtension + 10) = 0;
    ...
    else
    {
      RaUnitSetQueueDepth(
        ...
        *(_DWORD *)(*((_QWORD *)DeviceExtension + 3) + 516LL),
        *(_DWORD *)(*((_QWORD *)DeviceExtension + 3) + 512LL));
      v8 = *((_QWORD *)DeviceExtension + 3);
      v9 = DeviceExtension[153] & 0x7F;
      *((_QWORD *)DeviceExtension + 186) = 0LL;
      DeviceExtension[152] &= ~0x80u;
      DeviceExtension[153] = v9;
