/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C0044C24
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(const struct _TlgProvider_t *a1, __int64 a2)
{
  ...
  if ( (unsigned int)dword_1C0056060 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x800000000000uLL) )
    {
      ...
      v30 = *((_QWORD *)&WPP_MAIN_CB.Reserved + 1);
      v21 = *(_BYTE *)(a2 + 40);
      v31 = *(_QWORD *)(a2 + 96);
      v25 = *(_DWORD *)(v4 + 556);
      v26 = *(_DWORD *)(v4 + 560);
      ...
      *(_QWORD *)&hProvider.LevelPlus1 = v12 / 0x2710;
      ...
      v90 = v10;
      v92 = 0;
      TlgWrite(&hProvider, &unk_1C004D6A8, v16, v17, 0x21u, (EVENT_DATA_DESCRIPTOR *)&hProvider.KeywordAny);
    }
  }
}
