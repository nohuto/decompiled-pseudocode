/*
 * XREFs of McTemplateK0ppxqt @ 0x1C0023E64
 * Callers:
...
NTSTATUS McTemplateK0ppxqt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWriteKM(a1, &EventSMRResetWritePointer, 0LL, 6u, &v4);
}
