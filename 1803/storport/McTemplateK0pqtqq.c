/*
 * XREFs of McTemplateK0pqtqq @ 0x1C0024340
 * Callers:
...
NTSTATUS McTemplateK0pqtqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v13, va4);
  v14 = 4LL;
  return McGenEventWriteKM(a1, &EventAdapterPoFxRegistered, 0LL, 6u, &v4);
}
