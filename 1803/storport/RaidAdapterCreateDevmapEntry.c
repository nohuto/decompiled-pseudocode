/*
 * XREFs of RaidAdapterCreateDevmapEntry @ 0x1C0025A6C
 * Callers:
 ...
 *     PortMapOpenKey @ 0x1C004831C (PortMapOpenKey.c)
 */
                ...
                (__int64)&Handle) >= 0 )
    {
      ...
      if ( *(_BYTE *)(a1 + 376) )
      {
        do
        {
          if ( v2 >= 0xFF )
            break;
          v5 = (unsigned __int8)v2 < 8u ? *(_BYTE *)((unsigned __int8)v2 + a1 + 377) : -1;
