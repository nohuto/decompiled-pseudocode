/*
 * XREFs of RaidUnitCompleteResetRequest @ 0x1C003C7A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidUnitCompleteResetRequest(const struct _TlgProvider_t *a1)
{
  __int64 EnableCallback; // rdi
  __int64 v2; // r14
  IRP *RegHandle; // rsi
  __int64 v4; // rbx
  ...
  if ( (_BYTE)a1 == 40 )
  {
    v5 = *(_DWORD *)(EnableCallback + 60);
    v6 = 40;
    v7 = *(_DWORD *)(EnableCallback + 20);
  }
  else
  {
    v5 = *(_DWORD *)(EnableCallback + 16);
  ...
  LOBYTE(v8) = *(_BYTE *)(EnableCallback + 2);
  if ( (_BYTE)v8 == 40 )
    v8 = *(_DWORD *)(EnableCallback + 20);
  else
    v8 = (unsigned __int8)v8;
  if ( v8 == 16 && (unsigned int)dword_1C0056060 > 5 && TlgKeywordOn(a1, 0x400000000000uLL) )
  {
    v11 = *(_QWORD *)(v4 + 24);
    ...
    v16 = *(_BYTE *)(v4 + 89);
    v17 = *(_BYTE *)(v4 + 90);
    LOBYTE(v11) = *(_BYTE *)(EnableCallback + 3);
    v23 = 0;
    v26 = 0;
    v29 = 0;
    v32 = 0;
    ...
    v37 = (int)v10;
    v40 = (int)v10;
    TlgWrite(v12, &unk_1C004C545, v9, v10, 9u, &v20);
  }
  RaidUnitEndDeviceBusy(v4, RegHandle);
  if ( (*(_BYTE *)(v2 + 17) & 2) != 0 )
  {
  ...
  RegHandle->IoStatus.Information = v5;
  ...
  if ( (qword_1C0056210 & 0x10) != 0 )
    RaidLogRequestComplete(*(_QWORD *)(v4 + 24), (__int64)RegHandle, EnableCallback);
