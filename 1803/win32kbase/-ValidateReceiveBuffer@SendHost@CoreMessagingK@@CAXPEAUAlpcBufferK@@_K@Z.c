/*
 * XREFs of ?ValidateReceiveBuffer@SendHost@CoreMessagingK@@CAXPEAUAlpcBufferK@@_K@Z @ 0x1C01673E0
 * Callers:
...
void __fastcall CoreMessagingK::SendHost::ValidateReceiveBuffer(struct AlpcBufferK *a1, ULONG_PTR a2)
{
  ...
  if ( (unsigned __int8)*((_WORD *)a1 + 2) != 2 )
    CoreMessagingK::Runtime::BugCheck(1284, (unsigned __int8)*((_WORD *)a1 + 2), 0LL);
  if ( a2 < 0x50 )
    CoreMessagingK::Runtime::BugCheck(1285, a2, 0LL);
  v2 = *((unsigned int *)a1 + 18) + 80LL;
  if ( a2 != v2 )
    CoreMessagingK::Runtime::BugCheck(1286, a2, v2);
  v3 = 512;
  ...
  if ( a2 > v3 )
    CoreMessagingK::Runtime::BugCheck(1287, a2, v3);
  if ( *((_DWORD *)a1 + 16) != 0x10000 )
    CoreMessagingK::Runtime::BugCheck(1288, *((unsigned __int16 *)a1 + 32), *((unsigned __int16 *)a1 + 33));
}
