/*
 * XREFs of NtDCompositionCreateAndBindSharedSection @ 0x1C0011F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionCreateAndBindSharedSection(unsigned int a1, int a2, unsigned __int64 a3, _QWORD *a4)
{
  HANDLE v7; // rbx
  int v8; // edi
