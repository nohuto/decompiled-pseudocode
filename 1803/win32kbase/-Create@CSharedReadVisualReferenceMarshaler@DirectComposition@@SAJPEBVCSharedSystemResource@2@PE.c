/*
 * XREFs of ?Create@CSharedReadVisualReferenceMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015E10C
 * Callers:
 *     CreateSharedReadVisualReferenceMarshaler @ 0x1C015E2F0 (CreateSharedReadVisualReferenceMarshaler.c)
 * Callees:
