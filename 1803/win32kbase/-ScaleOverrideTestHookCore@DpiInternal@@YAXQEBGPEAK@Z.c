/*
 * XREFs of ?ScaleOverrideTestHookCore@DpiInternal@@YAXQEBGPEAK@Z @ 0x1C00D2424
 * Callers:
...
void __fastcall DpiInternal::ScaleOverrideTestHookCore(DpiInternal *this, unsigned __int16 *a2, unsigned int *a3)
{
  ...
  *(_DWORD *)a2 = 0;
  ...
  v10 = v6 & 0x7FFFFFFF;
  v11 = RtlStringCbPrintfW(v38, 0x16uLL, (size_t *)L"%d", v10);
  v16 = v11;
  if ( v11 < 0
  ...
  else
  {
    ...
    v19 = RtlQueryRegistryValues(0, L"\\Registry\\Machine\\", &QueryTable, 0LL, 0LL);
    v23 = v19;
    if ( v19 >= 0 )
    {
      if ( v25 != v26 )
