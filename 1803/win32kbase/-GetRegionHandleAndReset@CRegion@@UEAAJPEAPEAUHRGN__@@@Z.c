/*
 * XREFs of ?GetRegionHandleAndReset@CRegion@@UEAAJPEAPEAUHRGN__@@@Z @ 0x1C00443A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CRegion::GetRegionHandleAndReset(CRegion *this, HRGN *a2)
{
  ...
  struct _BASEOBJECT *v9; // [rsp+30h] [rbp+8h] BYREF
...
LABEL_6:
  ...
  if ( v6 == 1 )
  {
    v9 = (struct _BASEOBJECT *)*((_QWORD *)this + 2);
    v7 = RGNOBJ::hrgnAssociate(&v9);
    *a2 = (HRGN)v7;
    if ( !v7 )
    {
      v5 = -1073741801;
