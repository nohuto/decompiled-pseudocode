/*
 * XREFs of ?Create@CSharedWritePrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015E82C
 * Callers:
 *     CreateSharedWritePrimitiveColorMarshaler @ 0x1C015E9D0 (CreateSharedWritePrimitiveColorMarshaler.c)
 * Callees:
