/*
 * XREFs of ?FindOrAssignPrimary@CPTPEngine@@AEAAPEAUCContactState@@PEAUPTPInput@@@Z @ 0x1C0138CFC
 * Callers:
...
struct CContactState *__fastcall CPTPEngine::FindOrAssignPrimary(CPTPEngine *this, struct PTPInput *a2)
{
  ...
  {
    v6 = *((_DWORD *)this + 4);
    v7 = (_DWORD *)((char *)a2 + 64);
    do
    {
      v8 = *((_DWORD *)this + 74 * (*(v7 - 2) % v6) + 298);
      if ( (v8 & 1) != 0 && (v8 & 0x400) == 0 )
      {
        if ( (*v7 & 0x2000) != 0 )
          return (CPTPEngine *)((char *)this + 296 * (*(v7 - 2) % v6) + 1192);
        if ( !v4 )
          v4 = (_DWORD *)((char *)this + 296 * (*(v7 - 2) % v6) + 1192);
      }
      ++v5;
      v7 += 24;
    }
