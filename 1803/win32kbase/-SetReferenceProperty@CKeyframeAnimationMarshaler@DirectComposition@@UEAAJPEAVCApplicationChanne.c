/*
 * XREFs of ?SetReferenceProperty@CKeyframeAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C0008F70
 * Callers:
 *     <none>
 * Callees:
  ...
  *a5 = 0;
  switch ( a3 )
  {
    ...
    case 0x19u:
      ...
      v12 = (struct DirectComposition::CResourceMarshaler *)((*((_QWORD *)this + 37) + 16LL) & ((unsigned __int128)-(__int128)*((unsigned __int64 *)this + 37) >> 64));
      if ( a4 == v12 )
        return v5;
