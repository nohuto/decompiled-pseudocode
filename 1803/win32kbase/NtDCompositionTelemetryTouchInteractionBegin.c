/*
 * XREFs of NtDCompositionTelemetryTouchInteractionBegin @ 0x1C01439C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionTelemetryTouchInteractionBegin(unsigned int a1, unsigned __int64 a2, char *a3)
{
  int v5; // ebx
