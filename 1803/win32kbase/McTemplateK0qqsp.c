/*
 * XREFs of McTemplateK0qqsp @ 0x1C00AFB78
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqsp(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, const char *a6, char a7)
{
  const char *v7; // rcx
  __int64 v8; // rax
  int v9; // eax
  ...
  if ( !a6 )
    v7 = "NULL";
  v16 = v7;
  return McGenEventWriteKM((__int64)v7, &QueueNullPostMessage, &W32kControlGuid, 5u, &v11);
}
