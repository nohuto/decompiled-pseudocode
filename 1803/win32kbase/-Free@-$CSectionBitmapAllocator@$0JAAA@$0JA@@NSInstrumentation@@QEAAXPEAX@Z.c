/*
 * XREFs of ?Free@?$CSectionBitmapAllocator@$0JAAA@$0JA@@NSInstrumentation@@QEAAXPEAX@Z @ 0x1C005EAB4
 * Callers:
...
void __fastcall NSInstrumentation::CSectionBitmapAllocator<36864,144>::Free(__int64 *a1, void *a2)
{
  ...
  if ( a2 )
  {
    ...
    NSInstrumentation::CSectionBitmapAllocator<36864,144>::ContainsAllocation(a1, a2);
