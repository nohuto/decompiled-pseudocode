/*
 * XREFs of ?NotifyPresent@CSynchronizationManager@DirectComposition@@SAX_K_N@Z @ 0x1C00477AC
 * Callers:
 *     DCompositionNotifyPresent @ 0x1C000FDC0 (DCompositionNotifyPresent.c)
 *     DCompositionNotifyCompositionTokenPresent @ 0x1C0047790 (DCompositionNotifyCompositionTokenPresent.c)
 * Callees:
