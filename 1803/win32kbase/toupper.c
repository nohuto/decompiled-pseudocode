 ...
 * Callees:
 *     RtlUpcaseUnicodeToMultiByteN_0 @ 0x1C0075BBC (RtlUpcaseUnicodeToMultiByteN_0.c)
 *     RtlAnsiCharToUnicodeChar_0 @ 0x1C0075BC8 (RtlAnsiCharToUnicodeChar_0.c)
 */
