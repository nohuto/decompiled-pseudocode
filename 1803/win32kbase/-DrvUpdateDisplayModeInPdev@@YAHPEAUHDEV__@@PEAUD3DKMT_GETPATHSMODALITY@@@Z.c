/*
 * XREFs of ?DrvUpdateDisplayModeInPdev@@YAHPEAUHDEV__@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00D0E90
 * Callers:
 ...
 *     ?DevmodeAutoRotateCompatible@@YA_NPEBU_devicemodeW@@0@Z @ 0x1C00CC4C8 (-DevmodeAutoRotateCompatible@@YA_NPEBU_devicemodeW@@0@Z.c)
...
__int64 __fastcall DrvUpdateDisplayModeInPdev(HSEMAPHORE *a1, struct D3DKMT_GETPATHSMODALITY *a2)
{
  ...
  if ( !(unsigned int)DrvCheckGraphicsDeviceForSmoothRotation((struct tagGRAPHICS_DEVICE *)v2[321])
    || (v10 = v2[321], v12 = v10[40], (v12 & 0x4000000) != 0)
    || (v12 & 0x2000000) != 0
    || (v12 & 8) != 0 )
  {
...
LABEL_13:
    ...
    *(_QWORD *)(v11 + 24) = 26987LL;
    goto LABEL_21;
  }
  if ( !DevmodeAutoRotateCompatible(v15, (const struct _devicemodeW *)v2[323]) )
  {
...
LABEL_22:
  ...
  EtwTraceGreLockReleaseSemaphore((__int64)L"po.hsemPointer()", (int)v2[7], v24);
  v27 = (struct _ERESOURCE *)v2[7];
  if ( v27 )
  {
