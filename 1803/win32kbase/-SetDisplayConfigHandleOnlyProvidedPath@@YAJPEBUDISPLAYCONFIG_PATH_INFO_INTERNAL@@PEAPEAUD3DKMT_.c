/*
 * XREFs of ?SetDisplayConfigHandleOnlyProvidedPath@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_GETPATHSMODALITY@@PEA_NPEAW4_DXGK_DIAG_SDC_STAGE@@@Z @ 0x1C00D2AD0
 * Callers:
        ...
        enum _DXGK_DIAG_SDC_STAGE *a4)
{
  ...
  for ( i = *((unsigned __int16 *)*a2 + 10); v10 < *((unsigned __int16 *)*a2 + 10); ++v10 )
  {
      ...
      && *((_DWORD *)v12 + 19) == *((_DWORD *)a1 + 7) )
    {
      ...
      {
        v18 = WdLogNewEntry5_WdAssertion(v16, v13, v14, v15);
  ...
  if ( i < *((unsigned __int16 *)v9 + 10) && v20 == *((_QWORD *)v9 + 34 * i + 24) )
    return 0LL;
  result = 3221225485LL;
  *(_DWORD *)a4 = 33;
  return result;
