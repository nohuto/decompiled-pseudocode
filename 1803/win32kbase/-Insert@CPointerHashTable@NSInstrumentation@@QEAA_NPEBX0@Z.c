/*
 * XREFs of ?Insert@CPointerHashTable@NSInstrumentation@@QEAA_NPEBX0@Z @ 0x1C00DD2E8
 * Callers:
 ...
 * Callees:
 *     ?Wait@CPlatformSingleWatierSignal@NSInstrumentation@@QEAAXXZ @ 0x1C00DC568 (-Wait@CPlatformSingleWatierSignal@NSInstrumentation@@QEAAXXZ.c)
