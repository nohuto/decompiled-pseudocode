/*
 * XREFs of McTemplateK0xqnqNR3 @ 0x1C00DA9CC
 * Callers:
...
NTSTATUS McTemplateK0xqnqNR3(__int64 a1, const EVENT_DESCRIPTOR *a2, _DWORD a3, __int64 a4, ...)
{
  ...
  v11 = 16LL;
  v13 = 4LL;
  return McGenEventWriteKM(a1, a2, &W32kControlGuid, 6u, &v5);
}
