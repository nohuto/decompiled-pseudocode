/*
 * XREFs of ?CitpProgDataEnsure@@YAPEAU_CIT_PROG_DATA@@PEAU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z @ 0x1C016398C
 * Callers:
 ...
 *     ?CitpProgDataFind@@YAPEAU_CIT_PROG_DATA@@PEBU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z @ 0x1C0163CB8 (-CitpProgDataFind@@YAPEAU_CIT_PROG_DATA@@PEBU_CIT_IMPACT_CONTEXT@@PEBU_CIT_PROGRAM_ID@@@Z.c)
...
LABEL_3:
    ...
    if ( v7 == (struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 8) )
    {
      ...
      if ( (_QWORD *)*v10 != v9 || (v11 = (_QWORD *)v10[1], (_QWORD *)*v11 != v10) )
        __fastfail(3u);
      *((_QWORD *)a1 + 4) = v11;
    ...
    {
      if ( *((_QWORD **)v7 + 1) != v6
        || (v8 = *(_QWORD *)v7, *(struct _CIT_IMPACT_CONTEXT **)(*(_QWORD *)v7 + 8LL) != v7) )
      {
        __fastfail(3u);
      }
      *v6 = v8;
