/*
 * XREFs of GreGetBounds @ 0x1C0028E20
 * Callers:
...
LABEL_33:
  if ( !ERECTL::bEmpty((ERECTL *)&v24) && !ERECTL::bWrapped((ERECTL *)&v24) )
  {
    ...
    if ( v19 )
    {
      *((_DWORD *)v5 + 372) = 0x7FFFFFFF;
      *((_DWORD *)v5 + 373) = 0x7FFFFFFF;
      *((_DWORD *)v5 + 374) = 0x80000000;
      *((_DWORD *)v5 + 375) = 0x80000000;
    }
    else
    {
      *((_DWORD *)v5 + 368) = 0x7FFFFFFF;
      *((_DWORD *)v5 + 369) = 0x7FFFFFFF;
      *((_DWORD *)v5 + 370) = 0x80000000;
      *((_DWORD *)v5 + 371) = 0x80000000;
    }
  }
LABEL_40:
