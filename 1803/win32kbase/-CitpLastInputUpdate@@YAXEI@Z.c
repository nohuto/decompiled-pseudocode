/*
 * XREFs of ?CitpLastInputUpdate@@YAXEI@Z @ 0x1C003FAAC
 * Callers:
...
void __fastcall CitpLastInputUpdate(unsigned __int8 a1, unsigned int a2)
{
  ...
  if ( qword_1C01A16B0 )
  {
    if ( a2 < dword_1C01A16B8 )
      v2 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
    v4 = qword_1C01A16B0;
    dword_1C01A16B8 = v2;
    CIT_USER_ACTIVE_TRACKER::OnUserActiveEvent((struct _CIT_IMPACT_CONTEXT *)((char *)qword_1C01A16B0 + 212), v2);
    if ( a1 != 32 )
