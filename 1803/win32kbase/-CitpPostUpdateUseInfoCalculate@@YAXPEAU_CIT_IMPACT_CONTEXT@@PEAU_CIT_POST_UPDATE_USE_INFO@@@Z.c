/*
 * XREFs of ?CitpPostUpdateUseInfoCalculate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_POST_UPDATE_USE_INFO@@@Z @ 0x1C01624B4
 * Callers:
...
void __fastcall CitpPostUpdateUseInfoCalculate(struct _CIT_IMPACT_CONTEXT *a1, struct _CIT_POST_UPDATE_USE_INFO *a2)
{
  ...
  *((_DWORD *)a2 + 9) += ((int)v4 - dword_1C01A16D8) / 0x3E8u;
  if ( (v6 - qword_1C01A16C8 - v5) / 0x2710uLL <= 0xFFFFFFFF )
    v11 = (v6 - qword_1C01A16C8 - v5) / 0x2710uLL;
