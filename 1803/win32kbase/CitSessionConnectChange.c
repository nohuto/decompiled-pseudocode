/*
 * XREFs of CitSessionConnectChange @ 0x1C0164E50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CitSessionConnectChange(char a1, char a2)
{
  ...
  v2 = qword_1C01A16B0;
  if ( !qword_1C01A16B0 || ((*((_BYTE *)qword_1C01A16B0 + 112) & 2) != 0) == a1 )
    return;
  v5 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  if ( a1 )
    ++*((_WORD *)qword_1C01A16B0 + 57);
  else
  ...
  if ( !a2 )
  {
    if ( a1 )
    {
      if ( (unsigned int)dword_1C019EDD4 < MEMORY[0xFFFFF7800000037C] )
      {
        v6 = &off_1C019EDC8;
LABEL_12:
    ...
    else if ( (unsigned int)dword_1C019EDBC < MEMORY[0xFFFFF7800000037C] )
    {
      v6 = &off_1C019EDB0;
      goto LABEL_12;
    }
