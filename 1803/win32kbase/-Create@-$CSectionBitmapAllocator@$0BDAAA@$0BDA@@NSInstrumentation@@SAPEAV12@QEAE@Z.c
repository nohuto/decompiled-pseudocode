/*
 * XREFs of ?Create@?$CSectionBitmapAllocator@$0BDAAA@$0BDA@@NSInstrumentation@@SAPEAV12@QEAE@Z @ 0x1C0073614
 * Callers:
...
PVOID *__fastcall NSInstrumentation::CSectionBitmapAllocator<77824,304>::Create(__int64 a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)PoolWithTag + 9) = 0;
    if ( (unsigned __int8)NSInstrumentation::CSectionBitmapAllocator<77824,304>::Initialize(PoolWithTag, a1) )
      return v3;
