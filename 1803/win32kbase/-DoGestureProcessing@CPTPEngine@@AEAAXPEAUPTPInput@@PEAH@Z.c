/*
 * XREFs of ?DoGestureProcessing@CPTPEngine@@AEAAXPEAUPTPInput@@PEAH@Z @ 0x1C0136B64
 * Callers:
 *     ?RunStateMachine@CPTPEngine@@AEAAXPEAUPTPInput@@@Z @ 0x1C0139E9C (-RunStateMachine@CPTPEngine@@AEAAXPEAUPTPInput@@@Z.c)
 * Callees:
 *     ?FindOrAssignPrimary@CPTPEngine@@AEAAPEAUCContactState@@PEAUPTPInput@@@Z @ 0x1C0138CFC (-FindOrAssignPrimary@CPTPEngine@@AEAAPEAUCContactState@@PEAUPTPInput@@@Z.c)
...
LABEL_27:
    ...
    v20 = v22;
    v19 = v21;
    CBasePTPEngine::SendTelemetryOutput(this, 11LL, &v19);
    return;
  }
  if ( !v9 )
  {
    ...
    if ( v17 )
    {
      ...
      *((_DWORD *)this + 751) = v16;
      ...
      CBasePTPEngine::SendTelemetryOutput(this, 4LL, v18);
