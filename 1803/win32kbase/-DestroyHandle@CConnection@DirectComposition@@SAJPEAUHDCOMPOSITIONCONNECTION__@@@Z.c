/*
 * XREFs of ?DestroyHandle@CConnection@DirectComposition@@SAJPEAUHDCOMPOSITIONCONNECTION__@@@Z @ 0x1C0144790
 * Callers:
 ...
 *     NtDCompositionDestroyConnection @ 0x1C0143130 (NtDCompositionDestroyConnection.c)
 * Callees:
