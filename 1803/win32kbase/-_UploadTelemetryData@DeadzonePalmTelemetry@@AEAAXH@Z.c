/*
 * XREFs of ?_UploadTelemetryData@DeadzonePalmTelemetry@@AEAAXH@Z @ 0x1C010816C
 * Callers:
    ...
    *((_DWORD *)this + 1) = v6;
    if ( v6 )
    {
      ...
      do
      {
        ...
        {
          if ( dword_1C019EC00 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C019EC00, 0x400000000000uLL) )
          {
            TlgCreateSz(&pDesc, v2);
            TlgWrite((TraceLoggingHProvider)&dword_1C019EC00, &unk_1C0178BBC, 0LL, v15, 3u, &pData);
          }
          v8 = 0LL;
          pcchLength = 0LL;
          v4 = 1;
      ...
      if ( v8 )
      {
        ...
        {
          TlgCreateSz(&v23, v2);
          TlgWrite((TraceLoggingHProvider)&dword_1C019EC00, &unk_1C0178BBC, 0LL, v17, 3u, &v22);
        }
        v4 = 1;
      }
      if ( v4 )
