/*
 * XREFs of ?UpdatePointerAndDelayZoneInfo@DelayZoneTelemetry@@QEAAXW4CDelayZoneTelemetryContactArea@@UCDelayZonePanelTelemetryData@@PEBUtagPOINTER_INFO@@K@Z @ 0x1C0132D28
 * Callers:
        ...
        int a5)
{
  ...
  *((_DWORD *)a1 + 2 * v11 + 519) = GetUserHandedness(a1);
  ...
  *((_DWORD *)a1 + 2 * v11 + 527) = a4[8].x;
  ...
  else
  {
    *((_DWORD *)a1 + 12 * v10 + 516) = a2;
    ...
    {
      v12 = a3[1];
      DelayZoneTelemetry::AddInputPanelRectToList(a1, &v12);
    }
  }
}
