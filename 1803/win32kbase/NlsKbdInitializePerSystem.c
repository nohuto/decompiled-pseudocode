/*
 * XREFs of NlsKbdInitializePerSystem @ 0x1C012BE10
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     ?NlsSetKeyStateToggle@@YAXE@Z @ 0x1C012BD00 (-NlsSetKeyStateToggle@@YAXE@Z.c)
 */
...
void NlsKbdInitializePerSystem()
{
  ...
  if ( gKeyboardInfo == 7 && byte_1C019F789 == 3 )
