/*
 * XREFs of ?AllocUninitialized@BufferCache@CoreMessagingK@@CAJGPEAPEAX@Z @ 0x1C0056DA8
 * Callers:
...
LABEL_10:
  ...
  if ( (unsigned int)a1 + 512 >= 0xFFFF )
    ...
    v8 = a1 + 512;
  result = CoreMessagingK::Runtime::AllocUninitialized((unsigned int)v8 + 16, 1128418627LL, &v9);
  if ( (int)result >= 0 )
  {
