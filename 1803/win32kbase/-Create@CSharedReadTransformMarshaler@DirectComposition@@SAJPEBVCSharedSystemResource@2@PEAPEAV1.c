/*
 * XREFs of ?Create@CSharedReadTransformMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0001BD0
 * Callers:
 *     CreateSharedReadTransformMarshaler @ 0x1C0001B90 (CreateSharedReadTransformMarshaler.c)
 * Callees:
