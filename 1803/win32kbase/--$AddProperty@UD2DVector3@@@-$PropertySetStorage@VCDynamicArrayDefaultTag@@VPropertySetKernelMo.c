/*
 * XREFs of ??$AddProperty@UD2DVector3@@@?$PropertySetStorage@VCDynamicArrayDefaultTag@@VPropertySetKernelModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DVector3@@PEAI@Z @ 0x1C005DE88
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  *a4 = -1;
  ...
  if ( (int)result >= 0 )
  {
    result = CDynamicArray<unsigned char,2003858261>::Grow(a1 + 16, 12LL);
    if ( (int)result >= 0 )
    {
      *(_DWORD *)(a1 + 24) += 12;
      v10 = *(_QWORD *)(a1 + 16);
