/*
 * XREFs of EtwTraceWaitCursor @ 0x1C0068550
 * Callers:
 *     <none>
 * Callees:
 *     ?EtwpGetWaitCursorType@@YAKQEAUtagCURSOR@@@Z @ 0x1C00AB3C8 (-EtwpGetWaitCursorType@@YAKQEAUtagCURSOR@@@Z.c)
...
void EtwTraceWaitCursor()
{
    ...
    && (qword_1C019A1C8 & 0x8000000000040000uLL) == qword_1C019A1C8 )
  {
    ...
    if ( gpqCursor )
    {
      ...
      W32kEtwWaitCursorProcessId = *(_DWORD *)(*(_QWORD *)(v5 + 416) + 56LL);
    }
    else
    {
