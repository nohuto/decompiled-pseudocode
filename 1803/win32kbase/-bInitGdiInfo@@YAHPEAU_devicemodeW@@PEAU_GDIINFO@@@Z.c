/*
 * XREFs of ?bInitGdiInfo@@YAHPEAU_devicemodeW@@PEAU_GDIINFO@@@Z @ 0x1C00DBB14
 * Callers:
...
LABEL_5:
    a2->ulNumColors = -1;
    v5 = *((__int16 *)&unk_1C01821F0 + 2 * v4);
    a2->ulPanningHorzRes = v5;
    a2->ulHorzRes = v5;
    v6 = *((__int16 *)&unk_1C01821F0 + 2 * v4 + 1);
    a2->ulPanningVertRes = v6;
    a2->ulVertRes = v6;
  ...
  v4 = 0LL;
  v9 = (__int16 *)&unk_1C01821F2;
  do
  {
    if ( a1->dmPelsWidth == *(v9 - 1)
      && a1->dmPelsHeight == *v9
      && a1->dmBitsPerPel == 32
