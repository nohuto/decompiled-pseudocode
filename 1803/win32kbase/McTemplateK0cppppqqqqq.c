/*
 * XREFs of McTemplateK0cppppqqqqq @ 0x1C00ADA0C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0cppppqqqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        char a4,
        ...
        char a13)
{
  ...
  v35 = 4LL;
  v37 = 4LL;
  return McGenEventWriteKM(a1, &BeginSendMessage, &W32kControlGuid, 0xBu, &v17);
}
