/*
 * XREFs of ?Create@CSharedWriteRemotingRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015F1DC
 * Callers:
 *     CreateSharedWriteRemotingRenderTargetMarshaler @ 0x1C015F340 (CreateSharedWriteRemotingRenderTargetMarshaler.c)
 * Callees:
