/*
 * XREFs of ?EmitSetManipulations@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C014D564
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x800) != 0 || v4 )
  {
    if ( *((_DWORD *)this + 83) < v4 )
    {
      do
      {
        ...
        v9 = (unsigned int)(*((_DWORD *)this + 82) - *((_DWORD *)this + 83));
        if ( v9 >= ((unsigned __int64)v8 - 16) >> 3 )
          LODWORD(v9) = ((unsigned __int64)v8 - 16) >> 3;
        DirectComposition::CBatch::EnsureBatchBuffer(a2, (unsigned int)(8 * v9 + 16), &v17);
        v10 = (char *)v17;
        v11 = 0;
        *(_DWORD *)v17 = 8 * v9 + 16;
        v12 = v10 + 16;
        ...
        *((_DWORD *)v10 + 2) = *((_DWORD *)this + 6);
        ...
        {
          *v12 = *(_DWORD *)(*(_QWORD *)(*((_QWORD *)this + 40) + 16LL * (v11 + *((_DWORD *)this + 83))) + 24LL);
          v13 = *(_QWORD *)(*((_QWORD *)this + 40) + 16LL * (v11 + *((_DWORD *)this + 83)) + 8);
          if ( v13 )
            v14 = *(_DWORD *)(v13 + 24);
          else
            v14 = 0;
      ...
      while ( *((_DWORD *)this + 83) < *((_DWORD *)this + 82) );
    }
  }
  else if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x10uLL, &v16) )
  {
    v7 = (char *)v16;
    *(_DWORD *)v16 = 16;
    *(_QWORD *)(v7 + 4) = 0LL;
  ...
  if ( *((_DWORD *)this + 83) != *((_DWORD *)this + 82) || !v6 )
    return 0;
  return v3;
}
