/*
 * XREFs of ?HmgRemoveObjectImpl@@YAPEAXPEAUHOBJ__@@JJKEPEAK@Z @ 0x1C00764AC
 * Callers:
...
struct OBJECT *__fastcall HmgRemoveObjectImpl(struct HOBJ__ *a1, int a2, int a3, char a4, char a5, unsigned int *a6)
{
  ...
  {
    v11 = v20;
    EntryObject = GdiHandleManager::GetEntryObject((GdiHandleEntryDirectory **)gpHandleManager, *v20 & 0xFFFFFF);
    if ( (a4 & 2) == 0
