/*
 * XREFs of ?CitpProcessGetProgramId@@YAJPEAUtagPROCESSINFO@@PEAU_CIT_PROGRAM_ID@@@Z @ 0x1C0065854
 * Callers:
 ...
 *     ?CitpProgramIdCalculateHash@@YA_KPEBU_CIT_PROGRAM_ID@@@Z @ 0x1C0065B40 (-CitpProgramIdCalculateHash@@YA_KPEBU_CIT_PROGRAM_ID@@@Z.c)
 *     ?CitpStringDuplicate@@YAJPEAPEAGPEBG_K@Z @ 0x1C0065DD4 (-CitpStringDuplicate@@YAJPEAPEAGPEBG_K@Z.c)
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     _wcsupr @ 0x1C0074548 (_wcsupr.c)
...
__int64 __fastcall CitpProcessGetProgramId(PRKPROCESS *a1, struct _CIT_PROGRAM_ID *a2)
{
  ...
  if ( (*((_DWORD *)a1 + 203) & 0x30) == 0x10 )
  {
    ...
    if ( v18 < 0 )
    {
      CitpLogFailureWorker(v18, v19, 0x96Cu);
      goto LABEL_5;
    }
    v4 = (wchar_t *)Win32AllocPool(Size, 0x49637355u);
    String = v4;
    v20 = Win32AllocPool(v27, 0x49637355u);
    v5 = (void *)v20;
    v29 = v20;
    if ( v4 && v20 )
    {
...
LABEL_10:
  ...
  *((_DWORD *)v15 + 8) = (*((_DWORD *)a1 + 203) >> 4) & 3;
