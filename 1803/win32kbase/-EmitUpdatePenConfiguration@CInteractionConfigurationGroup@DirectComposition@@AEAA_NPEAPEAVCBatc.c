/*
 * XREFs of ?EmitUpdatePenConfiguration@CInteractionConfigurationGroup@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0004D38
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  for ( i = *((_DWORD *)this + 3); ; i = *((_DWORD *)this + 3) )
  {
    ...
    if ( v9 >= v10 )
      LODWORD(v9) = v10;
    DirectComposition::CBatch::EnsureBatchBuffer(a2, (unsigned int)(12 * (v9 + 2)), &v17);
    v11 = (char *)v17;
    *(_DWORD *)v17 = 12 * (v9 + 2);
    v12 = v11 + 24;
    *(_QWORD *)(v11 + 4) = 0LL;
