/*
 * XREFs of ?CompleteRemoveCrossChannelVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIVResourceHandle@@@Z @ 0x1C014619C
 * Callers:
        ...
        int a4)
{
  ...
  v13 = *(_QWORD *)v8;
  v14 = 0;
  v9 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, __int64, char *))(v13 + 256))(
         v8,
         a1,
         CrossChannelVisualChildNoRef,
         &v14);
