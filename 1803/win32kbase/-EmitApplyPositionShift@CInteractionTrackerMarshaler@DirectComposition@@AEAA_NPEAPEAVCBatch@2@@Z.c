/*
 * XREFs of ?EmitApplyPositionShift@CInteractionTrackerMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C014CE98
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  for ( ; *((_DWORD *)this + 87) < *((_DWORD *)this + 86); *((_DWORD *)this + 87) += v5 )
  {
    ...
    DirectComposition::CBatch::EnsureBatchBuffer(a2, (unsigned int)(12 * v5 + 16), &v20);
    v6 = (char *)v20;
    v7 = 0;
    *(_DWORD *)v20 = 12 * v5 + 16;
    v8 = v6 + 16;
  ...
  if ( v13 == v14 )
  {
    ...
    *((_DWORD *)this + 87) = 0;
    ...
    if ( *((_QWORD *)this + 42) )
    {
      DirectComposition::CDCompDynamicArray<PositionShift>::`scalar deleting destructor'(*((__int64 **)this + 42));
      v16 = *((_DWORD *)this + 87);
      v17 = *((_DWORD *)this + 86);
    }
    *((_QWORD *)this + 42) = 0LL;
