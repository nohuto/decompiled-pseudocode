/*
 * XREFs of NtDWMSetCursorOrientation @ 0x1C00B3330
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDWMSetCursorOrientation(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v3; // ebp
  __int64 v4; // rdi
  ...
  v22 = (PVOID)PsGetCurrentProcess(v21);
  if ( !v22 || v22 != g_pepDwm )
  {
    v25 = 5;
    goto LABEL_26;
  }
  v24 = CInputConfig::SetMouseOrientation(v23, v3);
  if ( v24 < 0 )
  {
