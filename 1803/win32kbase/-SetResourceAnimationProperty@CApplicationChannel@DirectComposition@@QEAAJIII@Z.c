/*
 * XREFs of ?SetResourceAnimationProperty@CApplicationChannel@DirectComposition@@QEAAJIII@Z @ 0x1C000B648
 * Callers:
        ...
        int a4)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, _QWORD, _QWORD))(v13 + 200))(
      ...
      v11 = -1073741811;
    if ( v11 >= 0 )
      return (unsigned int)DirectComposition::CApplicationChannel::BindAnimation(
