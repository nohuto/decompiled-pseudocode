/*
 * XREFs of ?OpenSharedHandle@CSharedWriteAnimationTriggerMarshaler@DirectComposition@@UEAAJPEAPEAX@Z @ 0x1C00140B0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall DirectComposition::CSharedWriteAnimationTriggerMarshaler::OpenSharedHandle(
