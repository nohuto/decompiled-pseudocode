/*
 * XREFs of DirectComposition::CResourceMarshaler::EmitUpdateCommand__lambda_f27f1e7718c39444876f3e254cac4d07___lambda_f91f4cf09ba95a878c6ebb7809dc9a5a___ @ 0x1C0153C10
 * Callers:
    ...
    *((_DWORD *)v13 + 3) = *a3 != 0;
    if ( (_DWORD)v12 )
    {
      ...
      do
      {
        v16 = *a3;
        *a3 = v16 + 1;
        *v14++ = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v6 + 288LL) + 8 * v16) + 24LL);
        --v15;
      }
      while ( v15 );
    }
