/*
 * XREFs of ulGetNearestIndexFromColorref @ 0x1C0071750
 * Callers:
...
unsigned int __fastcall ulGetNearestIndexFromColorref(__int64 a1, __int64 a2, tagPALETTEENTRY a3, int a4)
{
  ...
  if ( a1 && (*(_DWORD *)(a1 + 24) & 0x800) == 0 )
  {
    if ( (*(_DWORD *)&a3 & 0x1000000) == 0 )
    {
      ...
      v11.peFlags = 0;
      v5 = v11;
      return XEPALOBJ::ulGetNearestFromPalentry((XEPALOBJ *)&v9, v5, a4);
    }
    if ( a2 )
    {
  ...
  if ( (*(_DWORD *)&a3 & 0x3000000) != 0 )
  {
    ...
    {
      result = XEPALOBJ::ulGetNearestFromPalentry((XEPALOBJ *)&v10, v11, a4);
      a2 = v10;
      a1 = v9;
    }
...
LABEL_30:
    ...
    a3 = *(tagPALETTEENTRY *)(*(_QWORD *)(a2 + 112) + 4LL * result);
    v11 = a3;
    if ( a3.peFlags == 2 )
      return a3.peRed;
  }
  ...
  if ( v11 != 0xFFFFFF )
  {
    ...
    {
      v8 = ppalDefault;
      result = XEPALOBJ::ulGetNearestFromPalentry((XEPALOBJ *)&v8, v11, a4);
    }
    goto LABEL_30;
  }
  result = 19;
