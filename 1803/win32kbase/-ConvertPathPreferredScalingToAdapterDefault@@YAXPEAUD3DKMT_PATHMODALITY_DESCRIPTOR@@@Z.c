/*
 * XREFs of ?ConvertPathPreferredScalingToAdapterDefault@@YAXPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C00CC418
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( *((_DWORD *)a1 + 35) == 253 )
  {
    ...
    ((void (__fastcall *)(char *, char *))qword_1C01A1AD8)((char *)a1 + 16, (char *)a1 + 140);
  }
