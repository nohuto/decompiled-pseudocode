/*
 * XREFs of ApiSetEditionHandleAndPostKeyEvent @ 0x1C0056804
 * Callers:
        ...
        __int16 a15)
{
  ...
  InputExtensibilityCallout::CoreMsgSendMessage(gpqForeground, 4LL, &v24, 8LL, v22);
  v20 = 0;
  if ( (int)IsEditionHandleAndPostKeyEventSupported() >= 0 )
  {
    LOBYTE(v23) = a5;
    v20 = EditionHandleAndPostKeyEvent(a1, a2, a3, a4, v23, a6, a7, a8, a9, a10, a11, a12, a13, a14, a15);
  }
  if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    WPP_RECORDER_SF_(
      (__int64)WPP_GLOBAL_Control->DeviceExtension,
