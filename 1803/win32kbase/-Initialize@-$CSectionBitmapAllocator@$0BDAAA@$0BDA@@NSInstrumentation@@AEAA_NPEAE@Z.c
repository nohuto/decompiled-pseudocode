/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0BDAAA@$0BDA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C0073684
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<77824,304>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = PoolWithTag;
  if ( !PoolWithTag )
    return 0;
  *PoolWithTag = 0LL;
  v10 = lambda_ad03797ec7a38125f83dc9209b66074e_::operator()(v9, 0xF7u);
  if ( !v10 )
    return 0;
