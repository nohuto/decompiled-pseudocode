/*
 * XREFs of ?SetReferenceArrayProperty@CShapeVisualMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C0153ED0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (a4 || !a5) && a3 == 48 )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      *((_DWORD *)this + 4) |= 0x40000000u;
      ...
      {
        do
          DirectComposition::CResourceMarshaler::AddRef(*(DirectComposition::CResourceMarshaler **)(*((_QWORD *)this + 36)
                                                                                                  + 8LL * v6++));
