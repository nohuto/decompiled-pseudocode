/*
 * XREFs of ?OnSessionCreation@CConnection@DirectComposition@@SAJH@Z @ 0x1C014522C
 * Callers:
 ...
 *     ??0CConnection@DirectComposition@@AEAA@XZ @ 0x1C0143FD4 (--0CConnection@DirectComposition@@AEAA@XZ.c)
