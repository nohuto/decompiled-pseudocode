/*
 * XREFs of ?AddVisualChild@CApplicationChannel@DirectComposition@@QEAAJIIHI@Z @ 0x1C000B324
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v11 >= 0 )
  {
    ...
    if ( !v13 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v13 + 120LL))(v13, 151LL) )
      v11 = -1073741811;
    if ( v11 >= 0 )
    {
      if ( a5 )
      {
        ...
        {
          _mm_lfence();
          v5 = *(_QWORD *)(v14 * *((_QWORD *)this + 11) + *((_QWORD *)this + 7));
        }
        if ( !v5 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 120LL))(v5, 151LL) )
          v11 = -1073741811;
      }
      if ( v11 >= 0 )
      {
        v11 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, __int64, _QWORD, __int64, char *))(*(_QWORD *)v10 + 248LL))(
                v10,
                this,
                v13,
                a4,
