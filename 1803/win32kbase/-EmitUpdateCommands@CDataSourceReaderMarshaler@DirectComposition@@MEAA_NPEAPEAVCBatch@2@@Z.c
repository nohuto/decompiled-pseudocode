/*
 * XREFs of ?EmitUpdateCommands@CDataSourceReaderMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C015B1E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (*((_DWORD *)this + 4) & 0x20) != 0 )
  {
    ...
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v6) )
    {
      ...
      *(_QWORD *)(v4 + 12) = *((_QWORD *)this + 5);
      *(_QWORD *)(v4 + 20) = *((_QWORD *)this + 6);
      *((_DWORD *)this + 4) &= ~0x20u;
    }
    else
    {
