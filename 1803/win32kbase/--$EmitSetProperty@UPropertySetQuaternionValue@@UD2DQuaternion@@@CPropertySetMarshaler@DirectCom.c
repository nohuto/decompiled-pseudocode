/*
 * XREFs of ??$EmitSetProperty@UPropertySetQuaternionValue@@UD2DQuaternion@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C014B2F8
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( v10 < 0x2C && !DirectComposition::CBatch::AllocateNewFragment(a2, &v10) )
    return 0;
  DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x2CuLL, &v11);
  v8 = (char *)v11;
  *(_DWORD *)v11 = 44;
  *(_QWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 12) = 0LL;
