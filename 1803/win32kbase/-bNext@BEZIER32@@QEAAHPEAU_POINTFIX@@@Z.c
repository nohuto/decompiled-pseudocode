/*
 * XREFs of ?bNext@BEZIER32@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C0060250
 * Callers:
 *     ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C001B64C (-pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z.c)
 * Callees:
 *     ?lParentErrorDividedBy4@HFDBASIS32@@QEBAJXZ @ 0x1C0072FE4 (-lParentErrorDividedBy4@HFDBASIS32@@QEBAJXZ.c)
 */
...
__int64 __fastcall BEZIER32::bNext(BEZIER32 *this, struct _POINTFIX *a2)
{
  ...
  {
    v26 = *((_DWORD *)v3 + 1);
    v27 = (v7 + *((_DWORD *)v3 + 2)) >> 3;
    *((_DWORD *)v3 + 2) = v27;
    *((_DWORD *)v3 + 1) = (v26 - v27) >> 1;
    *((_DWORD *)v3 + 3) = v7 >> 2;
    v28 = *((_DWORD *)this + 8);
    v29 = (v28 + *((_DWORD *)this + 7)) >> 3;
    *((_DWORD *)this + 6) = (*((_DWORD *)this + 6) - v29) >> 1;
    *((_DWORD *)this + 7) = v29;
    *((_DWORD *)this + 8) = v28 >> 2;
    *(_DWORD *)this *= 2;
    v5 = *(_DWORD *)this;
  }
  for ( i = v5; (i & 1) == 0; *(_DWORD *)this = i )
  {
