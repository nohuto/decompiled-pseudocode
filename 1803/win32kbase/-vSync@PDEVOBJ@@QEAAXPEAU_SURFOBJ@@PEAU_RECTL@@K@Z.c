/*
 * XREFs of ?vSync@PDEVOBJ@@QEAAXPEAU_SURFOBJ@@PEAU_RECTL@@K@Z @ 0x1C0031ED0
 * Callers:
...
void __fastcall PDEVOBJ::vSync(PDEVOBJ *this, struct _SURFOBJ *a2, struct _RECTL *a3, unsigned int a4)
{
  ...
  if ( (*(_DWORD *)p_hsurf & 0x1000) != 0 )
  {
    ...
    {
      v6 = *(void (__fastcall **)(struct _SURFOBJ *, struct _RECTL *, _QWORD))(v5 + 1752);
      if ( v6 )
      {
        v6(a2, a3, a4);
      }
      ...
      {
        v7 = *(void (__fastcall **)(DHPDEV, struct _RECTL *))(v5 + 1744);
        if ( v7 )
          v7(a2->dhpdev, a3);
      }
    }
