/*
 * XREFs of ?Create@CSharedReadHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015F478
 * Callers:
 *     CreateSharedReadHolographicInteropTextureMarshaler @ 0x1C015F5C0 (CreateSharedReadHolographicInteropTextureMarshaler.c)
 * Callees:
