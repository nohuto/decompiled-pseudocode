/*
 * XREFs of ?Create@CSharedReadCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015717C
 * Callers:
 *     CreateSharedReadCaptureControllerMarshaler @ 0x1C01572D0 (CreateSharedReadCaptureControllerMarshaler.c)
 * Callees:
