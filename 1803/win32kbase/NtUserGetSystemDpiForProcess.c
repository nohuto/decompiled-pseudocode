/*
 * XREFs of NtUserGetSystemDpiForProcess @ 0x1C00B7550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetSystemDpiForProcess(char *Handle, __int64 a2, __int64 a3)
{
  ...
  v21 = ObReferenceObjectByHandle(Handle, 0x1000u, (POBJECT_TYPE)PsProcessType, 1, &Object, 0LL);
  v19 = (__int64 *)Object;
  if ( v21 < 0 )
  {
    UserSetLastError(87);
...
LABEL_27:
    ...
    if ( CurrentProcessWin32Process != PsGetCurrentProcessWin32Process(v25) && !v23 )
      v23 = 96;
    goto LABEL_30;
  }
  UserSetLastError(87);
