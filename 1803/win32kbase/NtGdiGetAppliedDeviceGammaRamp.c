/*
 * XREFs of NtGdiGetAppliedDeviceGammaRamp @ 0x1C00D7190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetAppliedDeviceGammaRamp(HDC a1, ULONG64 a2)
{
  ULONG64 v2; // rbx
...
LABEL_3:
  ...
  v7 = (char *)PALLOCMEM2(0x600uLL, 0x706D7447u, 0);
  if ( !v7 )
  {
    v5 = 14;
    goto LABEL_3;
  ...
  if ( v19 )
  {
    ...
    else
    {
      ...
      v9 = *(_QWORD *)(v8 + 48);
      v23 = v9;
      if ( *(_QWORD *)(v9 + 1688) || *(_QWORD *)(v9 + 1680) )
      {
