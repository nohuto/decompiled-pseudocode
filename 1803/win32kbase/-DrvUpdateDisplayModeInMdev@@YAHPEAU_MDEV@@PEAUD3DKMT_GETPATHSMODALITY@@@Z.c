/*
 * XREFs of ?DrvUpdateDisplayModeInMdev@@YAHPEAU_MDEV@@PEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00D0AA8
 * Callers:
...
LABEL_3:
  ...
  {
    v7 = WdLogNewEntry5_WdEvent(v5, v4, v6);
    *(_QWORD *)(v7 + 24) = 27068LL;
    goto LABEL_3;
  }
  if ( *((_WORD *)a2 + 10) != 1 )
  {
    v7 = WdLogNewEntry5_WdEvent(v5, v4, v6);
    *(_QWORD *)(v7 + 24) = 27073LL;
    goto LABEL_3;
  }
  v9 = *(_QWORD *)a1;
  if ( (unsigned __int8)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C01A1BD0)(
                          *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 2568LL) + 240LL),
                          *(unsigned int *)(*(_QWORD *)(*(_QWORD *)a1 + 2568LL) + 256LL)) )
  {
    v14 = *(unsigned int (__fastcall **)(_QWORD))(v9 + 2664);
    if ( v14 && v14(*(_QWORD *)(v9 + 1792)) )
    {
      ...
      EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemRFONTList", (int)ghsemRFONTList, v28);
      if ( ghsemRFONTList )
      {
        ExReleaseResourceAndLeaveCriticalRegion((PERESOURCE)ghsemRFONTList);
        PsLeavePriorityRegion(v30);
      }
      EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemPublicPFT", (int)ghsemPublicPFT, v29);
      if ( ghsemPublicPFT )
      {
        ExReleaseResourceAndLeaveCriticalRegion((PERESOURCE)ghsemPublicPFT);
        PsLeavePriorityRegion(v32);
      }
      EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemPalette", (int)ghsemPalette, v31);
      if ( ghsemPalette )
      {
        ExReleaseResourceAndLeaveCriticalRegion((PERESOURCE)ghsemPalette);
        PsLeavePriorityRegion(v34);
      }
      EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemDwmState", (int)ghsemDwmState, v33);
      if ( ghsemDwmState )
      {
      ...
      EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemHT", (int)ghsemHT, v37);
      if ( ghsemHT )
      {
        ExReleaseResourceAndLeaveCriticalRegion((PERESOURCE)ghsemHT);
        PsLeavePriorityRegion(v41);
      }
      EtwTraceGreLockReleaseSemaphore((__int64)L"ghsemSprite", (int)ghsemSprite, v40);
      if ( ghsemSprite )
      {
        ExReleaseResourceAndLeaveCriticalRegion(ghsemSprite);
        PsLeavePriorityRegion(v43);
      }
      EtwTraceGreLockReleaseSemaphore((__int64)L"poParent.hsemPointer()", *(_QWORD *)(v9 + 56), v42);
      v44 = *(struct _ERESOURCE **)(v9 + 56);
      if ( v44 )
      {
