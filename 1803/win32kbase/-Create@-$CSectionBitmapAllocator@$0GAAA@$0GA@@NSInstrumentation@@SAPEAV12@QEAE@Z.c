/*
 * XREFs of ?Create@?$CSectionBitmapAllocator@$0GAAA@$0GA@@NSInstrumentation@@SAPEAV12@QEAE@Z @ 0x1C00BE718
 * Callers:
...
PVOID *__fastcall NSInstrumentation::CSectionBitmapAllocator<24576,96>::Create(__int64 a1)
{
  ...
  *((_DWORD *)PoolWithTag + 9) = 0;
  if ( !(unsigned __int8)NSInstrumentation::CSectionBitmapAllocator<49152,192>::Initialize(PoolWithTag, a1) )
  {
