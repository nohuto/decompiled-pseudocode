/*
 * XREFs of ?CitpDPDataLoad@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0160E98
 * Callers:
...
__int64 __fastcall CitpDPDataLoad(struct _CIT_IMPACT_CONTEXT *a1)
{
  ...
  if ( v1 )
  {
    ...
    *((_DWORD *)a1 + 190) = ((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24) - v8;
    v9 = v27[1];
    *v2 = v27[0];
    v10 = v27[2];
    v2[1] = v9;
