/*
 * XREFs of WPP_RECORDER_SF_LLLD @ 0x1C00FBDD4
 * Callers:
...
__int64 WPP_RECORDER_SF_LLLD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x40000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, const ULONG_PTR *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v7) = 13;
  return WppAutoLogTrace(a1, 3LL, 19LL, &WPP_d80feb762ea23db244f84e50bb903cde_Traceguids, v7, (__int64 *)va);
}
