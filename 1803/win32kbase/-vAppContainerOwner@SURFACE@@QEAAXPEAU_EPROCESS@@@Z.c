/*
 * XREFs of ?vAppContainerOwner@SURFACE@@QEAAXPEAU_EPROCESS@@@Z @ 0x1C001CEC4
 * Callers:
 ...
 * Callees:
 *     UserIsProcessImmersiveAppContainer @ 0x1C001DBB0 (UserIsProcessImmersiveAppContainer.c)
