/*
 * XREFs of McTemplateK0pppqqqqpppqqqq @ 0x1C00AE4B8
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x1C006E240 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1C00DA490 (EtwWindowRendering.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS McTemplateK0pppqqqqpppqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v30 = 4LL;
  v32 = 4LL;
  return McGenEventWriteKM(a1, a2, &W32kControlGuid, 0xFu, &v4);
}
