/*
 * XREFs of WPP_RECORDER_SF_dDdddDdd @ 0x1C00E820C
 * Callers:
...
__int64 WPP_RECORDER_SF_dDdddDdd(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_a3c0144a064d3537df819a6648b232ca_Traceguids,
      13LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 13;
  return WppAutoLogTrace(a1, 3LL, 21LL, &WPP_a3c0144a064d3537df819a6648b232ca_Traceguids, v7, (__int64 *)va);
}
