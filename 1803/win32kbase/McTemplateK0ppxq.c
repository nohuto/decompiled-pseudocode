/*
 * XREFs of McTemplateK0ppxq @ 0x1C00AE6D4
 * Callers:
 *     EtwTraceDITResolveDCompInputHandleToHwnd @ 0x1C0012A10 (EtwTraceDITResolveDCompInputHandleToHwnd.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS McTemplateK0ppxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWriteKM(a1, &DITResolveDCompInputHandleToHwnd, &W32kControlGuid, 5u, &v4);
}
