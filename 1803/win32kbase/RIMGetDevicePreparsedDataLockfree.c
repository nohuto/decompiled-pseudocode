/*
 * XREFs of RIMGetDevicePreparsedDataLockfree @ 0x1C00E1F70
 * Callers:
 *     NtRIMGetDevicePreparsedDataLockfree @ 0x1C00DF5F0 (NtRIMGetDevicePreparsedDataLockfree.c)
...
__int64 __fastcall RIMGetDevicePreparsedDataLockfree(__int64 a1, char *a2, unsigned int *a3, int a4)
{
  int v7; // esi
  PVOID v8; // rdi
  char *v9; // rax
  ...
  v7 = RawInputManagerDeviceObjectResolveHandle(a1, 3LL, 1LL, Object);
  if ( v7 >= 0 )
  {
    v8 = Object[0];
    v9 = (char *)Object[0] + 80;
