/*
 * XREFs of ?OnPTPTimerNotification@CHidInput@@EEAAJXZ @ 0x1C0127380
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHidInput::OnPTPTimerNotification(CHidInput *this, __int64 a2, __int64 a3)
{
  ...
  v20 = (struct DEVICEINFO *)HMValidateHandleNoSecure(*((_QWORD *)this + 137), 19);
  if ( CHidInput::IsTouchpadDevice(v21, v20) )
  {
    v23 = *(_QWORD *)(v22 + 480);
    if ( v23 )
      v23 = *(_QWORD *)(v23 + 960);
    ...
    {
      LODWORD(v25) = 0;
      PTPEngineTraceProducer::OnEvent(*(PTPEngineTraceProducer **)(v23 + 648), (struct PTPEngineEvent *)&v25);
    }
  }
