/*
 * XREFs of ??$AddProperty@M@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBM@Z @ 0x1C0078290
 * Callers:
...
__int64 __fastcall DirectComposition::CPropertySetMarshaler::AddProperty<float>(__int64 a1, _DWORD *a2, _DWORD *a3)
{
  ...
  if ( (int)CDynamicArray<PropertySetStorage<CDynamicArrayDefaultTag,PropertySetKernelModeAllocator>::PropertyInfo,2003858261>::Add(
              a1 + 56,
              &v11) < 0
    || (int)CDynamicArray<unsigned char,2003858261>::Grow(v3 + 16, 4u) < 0 )
  {
    return (unsigned int)-1073741684;
  }
  else
