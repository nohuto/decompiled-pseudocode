/*
 * XREFs of NtGdiDdDDISetDisplayMode @ 0x1C00CABD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiDdDDISetDisplayMode(__int64 a1)
{
  ...
  tagObjLock *v24; // [rsp+60h] [rbp+18h] BYREF
  struct _LUID v25; // [rsp+68h] [rbp+20h] BYREF

  v3 = ((__int64 (__fastcall *)(__int64, struct _LUID *, unsigned int *))qword_1C01A18E0)(a1, &v25, &v23);
  if ( v3 >= 0 )
  {
    ...
    if ( (int)IsUserResetPointerSupported() >= 0 )
      UserResetPointer();
    DrvUpdatePDevForWDDMVidPnSource(&v25, v23);
