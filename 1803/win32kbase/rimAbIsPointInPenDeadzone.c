/*
 * XREFs of rimAbIsPointInPenDeadzone @ 0x1C00E67D8
 * Callers:
 *     rimAbIsPointerSuppressedByPointer @ 0x1C00E6BF4 (rimAbIsPointerSuppressedByPointer.c)
 *     RIMIsPointInPenDeadzone @ 0x1C00E7E00 (RIMIsPointInPenDeadzone.c)
  ...
  if ( gDeviceArbitrationType )
  {
    ...
    else if ( (unsigned int)(gDeviceArbitrationType - 2) <= 1 )
    {
      ...
      if ( RIMDeadzone::s_pRimDeadzoneInstance )
      {
        ...
        v3 = RIMDeadzone::IsInDeadzone(v10, &v12, a2, a3, UserHandedness);
      }
      qword_1C01A5F00 = 0LL;
