/*
 * XREFs of RIMCmAllocPointerDeviceContacts @ 0x1C010699C
 * Callers:
...
__int64 __fastcall RIMCmAllocPointerDeviceContacts(__int64 a1, __int64 a2)
{
  ...
  {
    MicrosoftTelemetryAssertTriggeredNoArgsKM(v4, a2);
    LODWORD(v4) = *(_DWORD *)(a1 + 680);
  }
  v9 = 10;
  if ( (unsigned int)v4 <= 0xA )
    v9 = v4;
  *(_DWORD *)(a1 + 904) = v9;
  v10 = 2760LL * *(unsigned int *)(a1 + 680);
  *(_QWORD *)(a1 + 896) = 0LL;
  v11 = Win32AllocPoolZInit(v10, v5);
  *(_QWORD *)(a1 + 872) = v11;
  if ( v11 && (v14 = Win32AllocPoolZInit(16LL * *(unsigned int *)(a1 + 904), v5), (*(_QWORD *)(a1 + 896) = v14) != 0LL) )
  {
    for ( i = 0; i < *(_DWORD *)(a1 + 904); *v17 = v17 )
    {
      v16 = i++;
      v17 = (_QWORD *)(*(_QWORD *)(a1 + 896) + 16 * v16);
      v17[1] = v17;
    }
    v18 = (_QWORD *)(a1 + 880);
    ...
    *(_QWORD *)(a1 + 880) = a1 + 880;
    ...
    if ( v20 < v19 )
    {
      ...
      while ( 1 )
      {
        v23 = (_QWORD *)(2760LL * v20 + *(_QWORD *)(a1 + 872) + 16LL);
        if ( v22 != v21 )
          __fastfail(3u);
        *v23 = v21;
        ++v20;
