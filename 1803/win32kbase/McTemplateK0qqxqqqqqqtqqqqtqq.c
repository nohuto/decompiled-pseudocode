/*
 * XREFs of McTemplateK0qqxqqqqqqtqqqqtqq @ 0x1C00AFC3C
 * Callers:
 *     EtwTraceTouchPadHWTimeStamp @ 0x1C00ACC40 (EtwTraceTouchPadHWTimeStamp.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS __fastcall McTemplateK0qqxqqqqqqtqqqqtqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a20)
{
  ...
  v53 = 4LL;
  v55 = 4LL;
  return McGenEventWriteKM(a1, &TouchPadHWTimeStamp, &W32kControlGuid, 0x12u, &v21);
}
