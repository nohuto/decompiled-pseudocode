/*
 * XREFs of ?GreValidateRgnInDCSurfBounds@@YAXPEAVDC@@PEAVSURFACE@@PEAVREGION@@W4_VALIDATE_REGION_CALLER@@@Z @ 0x1C00C4790
 * Callers:
 ...
 * Callees:
 *     ?bEqual@ERECTL@@QEBAHAEBV1@@Z @ 0x1C001E21C (-bEqual@ERECTL@@QEBAHAEBV1@@Z.c)
 *     ?vOrder@ERECTL@@QEAAXXZ @ 0x1C001E24C (-vOrder@ERECTL@@QEAAXXZ.c)
 *     ??XERECTL@@QEAAAEAV0@AEBU_RECTL@@@Z @ 0x1C001E274 (--XERECTL@@QEAAAEAV0@AEBU_RECTL@@@Z.c)
...
void __fastcall GreValidateRgnInDCSurfBounds(__int64 a1, __int64 a2, _DWORD *a3)
{
  ...
  v3 = *(_QWORD *)(a1 + 48);
  if ( !v3 || (*(_DWORD *)(v3 + 40) & 0x20000) == 0 || *(int *)(*(_QWORD *)(a1 + 504) + 112LL) >= 0 )
  {
    if ( ERECTL::bEmpty((ERECTL *)(a3 + 22))
      || (v8 = ERECTL::bEqual((ERECTL *)&rclEmpty, (const struct ERECTL *)(a3 + 22)), v9 = v5, v8) )
    {
      v9 = 1;
    }
    v10 = *(_DWORD *)(v7 + 56);
    ...
    *(_QWORD *)&v18.left = v5;
                                                ...
                                                || v16 < a3[25]) )
    {
      ...
      ERECTL::operator*=(&v18.left, a3 + 22);
      v19 = a3;
