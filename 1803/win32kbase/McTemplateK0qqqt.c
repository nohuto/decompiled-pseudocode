/*
 * XREFs of McTemplateK0qqqt @ 0x1C00AF738
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqt(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWriteKM(a1, &TouchPadCurtainSize, &W32kControlGuid, 5u, &v8);
}
