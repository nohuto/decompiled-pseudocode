/*
 * XREFs of ?CitpSetCompositionInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1C003BB74
 * Callers:
          ...
          && (unsigned int)PsGetProcessSessionId(Process) == gSessionId )
        {
          ...
          if ( ProcessWin32Process )
          {
            if ( CitpProcessEnsureContext(ProcessWin32Process) )
            {
              ...
              {
                if ( (_WORD)v14 )
                  CitpStatIncrement((unsigned __int16 *)v11 + 46, 1u);
                if ( WORD1(v14) )
                  CitpStatIncrement((unsigned __int16 *)v12 + 47, 1u);
                if ( WORD2(v14) )
                  CitpStatIncrement((unsigned __int16 *)v12 + 48, 1u);
              }
            }
          }
        }
