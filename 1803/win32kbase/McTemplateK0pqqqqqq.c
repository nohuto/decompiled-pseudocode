/*
 * XREFs of McTemplateK0pqqqqqq @ 0x1C00DA544
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C005FEF0 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C00676D0 (EtwDevLockEndTightUpdate.c)
 * Callees:
