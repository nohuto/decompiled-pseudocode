/*
 * XREFs of ?Create@CSharedReadInteractionMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0001AE8
 * Callers:
 *     CreateSharedReadInteractionMarshaler @ 0x1C0001AB0 (CreateSharedReadInteractionMarshaler.c)
 * Callees:
