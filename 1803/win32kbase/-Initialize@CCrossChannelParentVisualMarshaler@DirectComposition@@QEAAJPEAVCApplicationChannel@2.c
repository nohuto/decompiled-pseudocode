/*
 * XREFs of ?Initialize@CCrossChannelParentVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@VResourceHandle@@I@Z @ 0x1C0014120
 * Callers:
  ...
  if ( v8 >= 0 )
  {
    ...
    *(_QWORD *)(a1 + 280) = v9;
    if ( v9 )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(a1 + 280) + 12LL) = a4;
      *(_DWORD *)(*(_QWORD *)(a1 + 280) + 8LL) = a3;
    }
    else
    {
