/*
 * XREFs of ?SetDPIinSetup@@YAJPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00B2054
 * Callers:
 ...
 *     GreReinitializeStockFonts @ 0x1C00D6880 (GreReinitializeStockFonts.c)
 */
...
LABEL_4:
  ...
  CurrentDpiInfoFromHDev = DrvGetCurrentDpiInfoFromHDev(
                             *(_OWORD **)(*(_QWORD *)(gpDispInfo + 96) + 232LL),
                             (__int64)v18);
  v4 = 96 * v18[2] + 50;
  v5 = v4 / 0x64;
  if ( CurrentDpiInfoFromHDev >= 0 )
  {
      ...
      && (int)SetDpiScalingSetting(1LL, v4 / 0x64 > 0x78) >= 0 )
    {
      ...
      if ( (int)DrvSetDisplayConfig(
        ...
        && !(_BYTE)v19 )
      {
        GreReinitializeStockFonts(v5, 1LL);
        v6 = v21;
