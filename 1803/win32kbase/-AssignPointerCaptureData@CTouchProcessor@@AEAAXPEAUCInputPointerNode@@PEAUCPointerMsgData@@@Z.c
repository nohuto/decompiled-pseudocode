/*
 * XREFs of ?AssignPointerCaptureData@CTouchProcessor@@AEAAXPEAUCInputPointerNode@@PEAUCPointerMsgData@@@Z @ 0x1C010D4A8
 * Callers:
        ...
        struct CPointerMsgData *a3)
{
  ...
  if ( ((unsigned __int8)v5 & 1) == 0 )
  {
    ...
    if ( ((unsigned __int8)v5 & 2) != 0
      ...
      || (*(_DWORD *)(v6 + 36) & 1) != 0
      || (v7 = *(_WORD **)(v6 + 40)) == 0LL
      && (MicrosoftTelemetryAssertTriggeredNoArgsKM(v5, a2), (v7 = *(_WORD **)(v6 + 40)) == 0LL) )
    {
LABEL_14:
    ...
    *((_QWORD *)a3 + 5) = v7;
    if ( (*((_DWORD *)v7 + 4))++ == -1 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(v5, a2);
  }
}
