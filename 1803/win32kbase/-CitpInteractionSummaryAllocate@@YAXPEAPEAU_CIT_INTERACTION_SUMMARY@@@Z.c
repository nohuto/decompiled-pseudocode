/*
 * XREFs of ?CitpInteractionSummaryAllocate@@YAXPEAPEAU_CIT_INTERACTION_SUMMARY@@@Z @ 0x1C006AAD0
 * Callers:
...
void __fastcall CitpInteractionSummaryAllocate(struct _CIT_INTERACTION_SUMMARY **a1)
{
  ...
  v1 = dword_1C01A16AC;
  v3 = (unsigned __int16)dword_1C01A16AC;
  v4 = CitAllocZero((unsigned __int16)dword_1C01A16AC);
  if ( v4 )
  {
    v4[1] = v4;
    *v4 = v4;
  ...
  {
    CitpLogFailureWorker(-1073741670, 0LL, 0xCF3u);
  }
}
