/*
 * XREFs of SynthesizeMouseInputWithNextPreview @ 0x1C012EA60
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _MOUSE_INPUT_DATA *a6)
{
  ...
  if ( !a4 )
    MicrosoftTelemetryAssertTriggeredNoArgsKM(a1, a2);
  v10 = (CMouseProcessor *)(*(__int64 (__fastcall **)(CMouseSensor *))(*(_QWORD *)qword_1C019A5A8 + 8LL))(qword_1C019A5A8);
  if ( v10 )
  {
    *((_QWORD *)&v11 + 1) = a1;
    *(_QWORD *)&v12 = a3;
