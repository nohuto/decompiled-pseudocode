/*
 * XREFs of ??$AddProperty@U_D3DCOLORVALUE@@@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBU_D3DCOLORVALUE@@@Z @ 0x1C00783F0
 * Callers:
        ...
        _OWORD *a3)
{
  ...
  if ( (int)CDynamicArray<PropertySetStorage<CDynamicArrayDefaultTag,PropertySetKernelModeAllocator>::PropertyInfo,2003858261>::Add(
              a1 + 56,
              &v11) < 0
    || (int)CDynamicArray<unsigned char,2003858261>::Grow(v3 + 16, 0x10u) < 0 )
  {
    return (unsigned int)-1073741684;
  }
  else
