/*
 * XREFs of _handle_error @ 0x1C0079534
 * Callers:
 *     exp @ 0x1C0078D44 (exp.c)
 *     log @ 0x1C0079128 (log.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     _call_matherr @ 0x1C0079408 (_call_matherr.c)
 *     _exception_enabled @ 0x1C0079474 (_exception_enabled.c)
 *     _raise_exc @ 0x1C0079704 (_raise_exc.c)
