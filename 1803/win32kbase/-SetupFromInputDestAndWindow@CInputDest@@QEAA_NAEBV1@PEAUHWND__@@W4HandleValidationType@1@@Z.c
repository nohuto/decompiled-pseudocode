/*
 * XREFs of ?SetupFromInputDestAndWindow@CInputDest@@QEAA_NAEBV1@PEAUHWND__@@W4HandleValidationType@1@@Z @ 0x1C0109B34
 * Callers:
...
bool __fastcall CInputDest::SetupFromInputDestAndWindow(_QWORD *a1, __int64 a2, HWND a3, int a4)
{
  ...
  *((_OWORD *)a1 + 10) = *(_OWORD *)(a2 + 160);
  ...
  if ( v10 == 2 )
  {
    ...
    if ( a4 != 1 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(128LL, v8);
    v12 = 1;
  }
  else
  {
