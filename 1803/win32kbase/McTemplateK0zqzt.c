/*
 * XREFs of McTemplateK0zqzt @ 0x1C00DAB8C
 * Callers:
 *     EtwFontLoadAttemptEvent @ 0x1C00D9FC0 (EtwFontLoadAttemptEvent.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS __fastcall McTemplateK0zqzt(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const wchar_t *a4,
        ...
        char a7)
{
  ...
  v20 = v11;
  v24 = 4LL;
  return McGenEventWriteKM((__int64)v11, &FontLoadAttemptEvent, &W32kControlGuid, 5u, &v14);
}
