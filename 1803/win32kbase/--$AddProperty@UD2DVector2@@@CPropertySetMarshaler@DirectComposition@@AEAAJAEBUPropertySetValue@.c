/*
 * XREFs of ??$AddProperty@UD2DVector2@@@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBUD2DVector2@@@Z @ 0x1C00784DC
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  if ( (int)CDynamicArray<PropertySetStorage<CDynamicArrayDefaultTag,PropertySetKernelModeAllocator>::PropertyInfo,2003858261>::Add(
              a1 + 56,
              &v11) < 0
    || (int)CDynamicArray<unsigned char,2003858261>::Grow(v3 + 16, 8u) < 0 )
  {
    return (unsigned int)-1073741684;
  }
  else
