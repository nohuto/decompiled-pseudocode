/*
 * XREFs of ?ContainsAllocation@?$CSectionBitmapAllocator@$0BEAAA@$0KA@@NSInstrumentation@@QEAA_NPEBX@Z @ 0x1C005FCAC
 * Callers:
...
bool __fastcall NSInstrumentation::CSectionBitmapAllocator<81920,160>::ContainsAllocation(
        _QWORD *a1,
        unsigned __int64 a2)
{
  __int64 v2; // rbx
