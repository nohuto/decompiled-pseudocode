/*
 * XREFs of ?Create@CSharedInteractionMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0003CF8
 * Callers:
 *     CreateSharedInteractionMarshaler @ 0x1C0003CC0 (CreateSharedInteractionMarshaler.c)
 * Callees:
 *     ??0CInteractionMarshaler@DirectComposition@@QEAA@XZ @ 0x1C00041D8 (--0CInteractionMarshaler@DirectComposition@@QEAA@XZ.c)
 *     ?InitializeFromSharedResource@CSharedInteractionMarshaler@DirectComposition@@QEAAJPEBVCSharedSystemResource@2@@Z @ 0x1C000556C (-InitializeFromSharedResource@CSharedInteractionMarshaler@DirectComposition@@QEAAJPEBVCSharedSys.c)
        ...
        struct DirectComposition::CSharedInteractionMarshaler **a2)
{
  ...
  v4 = (DirectComposition::CInteractionMarshaler *)Win32AllocPoolWithQuotaZInit(0x148uLL);
  v5 = v4;
  if ( v4 )
  {
