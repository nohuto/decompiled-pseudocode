/*
 * XREFs of IsKeyboardDelegationEnabledForThread @ 0x1C0059370
 * Callers:
 *     NtUserGetAsyncKeyState @ 0x1C0059050 (NtUserGetAsyncKeyState.c)
 * Callees:
 *     ?IsDelegationEnabledForThread@InputDelegation@@YA_NPEBUtagTHREADINFO@@@Z @ 0x1C012DC00 (-IsDelegationEnabledForThread@InputDelegation@@YA_NPEBUtagTHREADINFO@@@Z.c)
 */
