/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C01681AC
 * Callers:
 ...
 *     GetImageTuple @ 0x1C0168060 (GetImageTuple.c)
 *     TakeTelemetryAssertsLock @ 0x1C0168840 (TakeTelemetryAssertsLock.c)
 */
...
LABEL_37:
  ...
  v19 = "<unknown>";
  v20 = v31;
  if ( (unsigned int)dword_1C01D6010 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01D6010, 0x400000000000uLL) )
  {
    v32 = 10;
    v33 = v14;
    v21 = "<unknown>";
    ...
    TlgWrite((TraceLoggingHProvider)&dword_1C01D6010, &unk_1C017A981, 0LL, v23, 0xBu, &pData);
  }
  if ( TraceLoggingProviderEnabled((TraceLoggingHProvider)&dword_1C01D6050, v18, 0LL) && !v17 && !KeGetCurrentIrql() )
  {
    v25 = DbgkWerCaptureLiveKernelDump(L"TELASSERT", 465LL, v14, g_ModuleName, v20, v12, v24, v24, 0);
    if ( (unsigned int)dword_1C01D6010 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C01D6010, 0x400000000000uLL) )
    {
      v40 = v14;
      v45 = v25;
      ...
      v59 = 4LL;
      v61 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C01D6010, &unk_1C017A918, 0LL, v26, cData, &v46);
    }
    if ( !v25 && !(unsigned int)TakeTelemetryAssertsLock() )
    {
