/*
 * XREFs of ??$AddProperty@UD2DMatrix@@@?$PropertySetStorage@VCDynamicArrayDefaultTag@@VPropertySetKernelModeAllocator@@@@QEAAJW4DCOMPOSITION_EXPRESSION_TYPE@@PEBUD2DMatrix@@PEAI@Z @ 0x1C005DD2C
 * Callers:
        ...
        _DWORD *a4)
{
  ...
  *a4 = -1;
  ...
  if ( (int)result >= 0 )
  {
    result = CDynamicArray<unsigned char,2003858261>::Grow(a1 + 16, 64LL);
    if ( (int)result >= 0 )
    {
      *(_DWORD *)(a1 + 24) += 64;
      v10 = *(_QWORD *)(a1 + 16);
