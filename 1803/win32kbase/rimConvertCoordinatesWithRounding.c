/*
 * XREFs of rimConvertCoordinatesWithRounding @ 0x1C00E9D84
 * Callers:
...
__int64 __fastcall rimConvertCoordinatesWithRounding(__int64 a1, __int64 a2, int a3, int a4, int a5, LONG *plResult)
{
  __int64 v6; // rdi
  int v8; // esi
  int v9; // ebp
