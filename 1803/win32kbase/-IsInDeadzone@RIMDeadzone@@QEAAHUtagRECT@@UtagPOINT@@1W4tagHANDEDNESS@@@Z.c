/*
 * XREFs of ?IsInDeadzone@RIMDeadzone@@QEAAHUtagRECT@@UtagPOINT@@1W4tagHANDEDNESS@@@Z @ 0x1C010600C
 * Callers:
...
__int64 __fastcall RIMDeadzone::IsInDeadzone(__int64 a1, _DWORD *a2, __int64 a3, __int64 a4, int a5)
{
  ...
  struct tagPOINT v24; // [rsp+80h] [rbp+48h]
  ...
  v12 = *((_DWORD *)v5 + 8);
  v13 = 0;
  v14 = (v8 / 100 - v7 / 100) * (v8 / 100 - v7 / 100) + (v27 / 100 - v28 / 100) * (v27 / 100 - v28 / 100);
  if ( v12 )
  {
    v15 = *((_QWORD *)v5 + 3);
    while ( 1 )
