/*
 * XREFs of RtlUnicodeStringCopyString @ 0x1C00E9C38
 * Callers:
 *     RIMComputePTPCurtainRegions @ 0x1C00E8C80 (RIMComputePTPCurtainRegions.c)
 * Callees:
 *     RtlUnicodeStringValidateDestWorker @ 0x1C00E9C9C (RtlUnicodeStringValidateDestWorker.c)
 *     RtlWideCharArrayCopyStringWorker @ 0x1C00E9D20 (RtlWideCharArrayCopyStringWorker.c)
 */
