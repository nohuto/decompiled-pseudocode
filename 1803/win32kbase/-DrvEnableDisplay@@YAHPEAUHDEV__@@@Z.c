/*
 * XREFs of ?DrvEnableDisplay@@YAHPEAUHDEV__@@@Z @ 0x1C00CED80
 * Callers:
...
__int64 __fastcall DrvEnableDisplay(HSEMAPHORE *a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(v5 + 24) = a1;
  ...
  if ( a1[340] )
  {
    while ( !((unsigned int (__fastcall *)(HSEMAPHORE, __int64))a1[340])(a1[224], 1LL) )
      ;
  }
  else
  {
  ...
  EtwTraceGreLockReleaseSemaphore((__int64)L"po.hsemPointer()", (int)a1[7], v12);
