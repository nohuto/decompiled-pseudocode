/*
 * XREFs of ?SatisfyNonPointerInputSinkInfoRequest@CSpatialProcessor@@IEAAXAEBU_InputHitTestResult@@@Z @ 0x1C00028A8
 * Callers:
        ...
        const struct _InputHitTestResult *a2)
{
  ...
  if ( v2 && (int)CompositionInputObject::ResolveHandle(v2, 1u, 1, (struct CompositionInputObject **)&Object) >= 0 )
  {
    ...
    if ( (gInputSinkInfoRetrieval & 1) != 0 )
      qword_1C01A2D54 = *((_QWORD *)Object + 2);
    if ( (gInputSinkInfoRetrieval & 4) != 0 )
    {
      xmmword_1C01A2D68 = *(_OWORD *)((char *)a2 + 24);
      xmmword_1C01A2D78 = *(_OWORD *)((char *)a2 + 40);
      xmmword_1C01A2D88 = *(_OWORD *)((char *)a2 + 56);
      xmmword_1C01A2D98 = *(_OWORD *)((char *)a2 + 72);
    }
    if ( (gInputSinkInfoRetrieval & 8) != 0 )
      dword_1C01A2DA8 = *((_DWORD *)a2 + 36);
    if ( (gInputSinkInfoRetrieval & 2) != 0 && dword_1C01A2D4C == 6 )
    {
      CompositionInputObject::GetWindowForInputType(Object, 5LL, &Object);
      if ( Object )
        qword_1C01A2D60 = *(_QWORD *)Object;
    }
