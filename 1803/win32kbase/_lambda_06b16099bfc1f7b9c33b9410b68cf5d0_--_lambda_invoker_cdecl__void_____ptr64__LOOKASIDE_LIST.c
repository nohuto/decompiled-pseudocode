/*
 * XREFs of _lambda_06b16099bfc1f7b9c33b9410b68cf5d0_::_lambda_invoker_cdecl__void_____ptr64__LOOKASIDE_LIST_EX_____ptr64_ @ 0x1C00408E0
 * Callers:
 *     <none>
 * Callees:
...
{
  NSInstrumentation::CTypeIsolation<180224,704>::Free(&Lookaside[-1].L.ListEntry, Buffer);
}
