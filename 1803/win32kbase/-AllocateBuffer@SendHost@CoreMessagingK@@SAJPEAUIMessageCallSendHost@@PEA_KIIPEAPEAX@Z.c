/*
 * XREFs of ?AllocateBuffer@SendHost@CoreMessagingK@@SAJPEAUIMessageCallSendHost@@PEA_KIIPEAPEAX@Z @ 0x1C0167140
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HRESULTFromNTStatus@HResultUtil@CoreMessagingK@@YAJJ@Z @ 0x1C0167498 (-HRESULTFromNTStatus@HResultUtil@CoreMessagingK@@YAJJ@Z.c)
 */
        ...
        void **a5)
{
  ...
  *a5 = 0LL;
  if ( a4 > v6 )
    CoreMessagingK::Runtime::BugCheck(1280, a4, 0LL);
  if ( a4 > 0xFFAF )
    CoreMessagingK::Runtime::BugCheck(1281, a4, 0LL);
  v8 = v6 + 80;
