/*
 * XREFs of RecalculateQueueInfo @ 0x1C005F460
 * Callers:
...
struct tagTHREADINFO *RecalculateQueueInfo()
{
  ...
  if ( *v1 != v1 )
  {
    do
    {
      *(_DWORD *)(*(v2 - 38) + 428LL) = 0;
      *(_DWORD *)(*(v2 - 38) + 432LL) = 0;
      result = (struct tagTHREADINFO *)*(v2 - 38);
    ...
    {
      result = (struct tagTHREADINFO *)*((unsigned int *)i - 62);
      if ( ((unsigned __int8)result & 1) == 0 )
      {
        ...
        if ( *(PVOID *)v4 != gpepCSRSS )
          v5 = *(_DWORD *)(v4 + 872);
        result = (struct tagTHREADINFO *)*(i - 38);
        v6 = *(_DWORD *)(v4 + 876);
