/*
 * XREFs of GrePtInRegion @ 0x1C00646D0
 * Callers:
 *     NtGdiPtInRegion @ 0x1C00D84C0 (NtGdiPtInRegion.c)
 * Callees:
 *     ?bInside@RGNOBJ@@QEAAHPEAU_POINTL@@@Z @ 0x1C0021A50 (-bInside@RGNOBJ@@QEAAHPEAU_POINTL@@@Z.c)
