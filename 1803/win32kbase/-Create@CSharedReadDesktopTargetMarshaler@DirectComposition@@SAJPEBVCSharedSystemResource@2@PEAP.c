/*
 * XREFs of ?Create@CSharedReadDesktopTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015EE4C
 * Callers:
 *     CreateSharedReadDesktopTargetMarshaler @ 0x1C015F080 (CreateSharedReadDesktopTargetMarshaler.c)
 * Callees:
