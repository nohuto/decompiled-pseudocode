/*
 * XREFs of McTemplateK0qpqxxq @ 0x1C00AEC08
 * Callers:
 ...
 *     EtwTraceDCompDeferBatchEvent @ 0x1C0047930 (EtwTraceDCompDeferBatchEvent.c)
...
NTSTATUS __fastcall McTemplateK0qpqxxq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 8LL;
  v22 = 4LL;
  return McGenEventWriteKM(a1, &DCompDeferBatchEvent, &W32kControlGuid, 7u, &v10);
}
