/*
 * XREFs of ?SetHitTestResult@CPTPProcessor@@AEAAXPEAUCPointerInputFrame@@_N@Z @ 0x1C01261EC
 * Callers:
...
void __fastcall CPTPProcessor::SetHitTestResult(CPTPProcessor *this, struct CPointerInputFrame *a2, char a3)
{
  ...
  _BYTE v42[192]; // [rsp+1B0h] [rbp+B0h] BYREF

  v3 = 0;
  v4 = (CPTPProcessor *)((char *)this + 392);
  if ( a3 )
  {
...
LABEL_7:
  ...
  if ( *(_DWORD *)v4
    && (CInputDest::TestWindowFlag((CPTPProcessor *)((char *)this + 392), 1152) || CInputDest::TestWindowFlag(v4, 896)) )
  {
