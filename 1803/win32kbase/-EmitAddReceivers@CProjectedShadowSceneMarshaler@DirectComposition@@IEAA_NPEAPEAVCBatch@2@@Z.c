/*
 * XREFs of ?EmitAddReceivers@CProjectedShadowSceneMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01518AC
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( *((_DWORD *)this + 21) < *((_DWORD *)this + 20) )
  {
    do
    {
      ...
      *((_DWORD *)this + 21) = v8 + v5;
    }
    while ( v8 + (unsigned int)v5 < *((_DWORD *)this + 20) );
  }
  return *((_DWORD *)this + 21) == *((_DWORD *)this + 20);
}
