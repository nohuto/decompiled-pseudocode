/*
 * XREFs of ApiSetEditionPointerWindowHitTest @ 0x1C013F5E8
 * Callers:
        ...
        __int64 a13)
{
  ...
  __int128 v25; // xmm0
  __int128 v26; // xmm1
  _BYTE v28[176]; // [rsp+70h] [rbp-C8h] BYREF
  ...
  {
    v17 = (_OWORD *)EditionPointerWindowHitTest(v28, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13);
    v18 = v17[1];
    *a1 = *v17;
    v19 = v17[2];
    a1[1] = v18;
