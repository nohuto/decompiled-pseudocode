/*
 * XREFs of McTemplateK0qqNR1qNR3 @ 0x1C00AED3C
 * Callers:
 *     EtwTraceTimerDelayStatistics @ 0x1C00AC8C0 (EtwTraceTimerDelayStatistics.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS __fastcall McTemplateK0qqNR1qNR3(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        __int64 a10)
{
  ...
  v21 = a10;
  v22 = a9 * a8;
  return McGenEventWriteKM(a1, &TimerDelayStatistics, &W32kControlGuid, 6u, &v11);
}
