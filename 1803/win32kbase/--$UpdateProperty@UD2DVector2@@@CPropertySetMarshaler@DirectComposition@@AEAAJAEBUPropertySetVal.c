/*
 * XREFs of ??$UpdateProperty@UD2DVector2@@@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBUD2DVector2@@@Z @ 0x1C007895C
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  {
    *(_QWORD *)((*(_DWORD *)(v5 + 8 * v3 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 72)) = *a3;
    v6 = *(_QWORD *)(a1 + 56);
