/*
 * XREFs of ?Initialize@CCompositionSpotLightMarshaler@DirectComposition@@UEAAJXZ @ 0x1C0011410
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        DirectComposition::CCompositionSpotLightMarshaler *this)
{
  ...
  *((_DWORD *)this + 43) = 1065353216;
  result = 0LL;
  *(_OWORD *)((char *)this + 136) = xmmword_1C0177B58;
  *((_BYTE *)this + 72) = 1;
  *((_DWORD *)this + 32) = 1057360530;
  *((_DWORD *)this + 33) = 1070141403;
  *(_OWORD *)((char *)this + 152) = xmmword_1C0177B58;
  return result;
}
