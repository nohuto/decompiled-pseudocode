/*
 * XREFs of ?Create@?$CTypeIsolation@$0BDAAA@$0BDA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00BE838
 * Callers:
...
_QWORD *NSInstrumentation::CTypeIsolation<77824,304>::Create()
{
  ...
  *PoolWithTag = PoolWithTag;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<77824,304>::Initialize(PoolWithTag) )
  {
    v3 = (void *)v1[2];
    if ( !v3 )
      goto LABEL_6;
