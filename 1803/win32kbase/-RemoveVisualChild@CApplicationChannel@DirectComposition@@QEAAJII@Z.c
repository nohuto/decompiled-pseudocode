/*
 * XREFs of ?RemoveVisualChild@CApplicationChannel@DirectComposition@@QEAAJII@Z @ 0x1C000B1DC
 * Callers:
        ...
        int a3)
{
  ...
  if ( v8 >= 0 )
  {
    if ( a3 )
    {
      ...
      {
        _mm_lfence();
        v3 = *(_QWORD *)(v9 * *((_QWORD *)this + 11) + *((_QWORD *)this + 7));
      }
      if ( !v3 || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v3 + 120LL))(v3, 151LL) )
        v8 = -1073741811;
    }
    if ( v8 >= 0 )
    {
      ...
      if ( v3 )
        ...
        v11 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, char *))(v10 + 264))(
                v7,
                this,
                &v13);
      v8 = v11;
