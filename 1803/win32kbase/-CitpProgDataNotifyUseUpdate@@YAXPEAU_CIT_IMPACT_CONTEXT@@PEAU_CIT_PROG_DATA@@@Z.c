/*
 * XREFs of ?CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z @ 0x1C0163DD0
 * Callers:
...
void __fastcall CitpProgDataNotifyUseUpdate(struct _CIT_IMPACT_CONTEXT *a1, struct _CIT_PROG_DATA *a2)
{
  ...
  if ( *((_BYTE *)a2 + 34) )
  {
    ...
    if ( *(struct _CIT_PROG_DATA **)(v5 + 8) != (struct _CIT_PROG_DATA *)((char *)a2 + 16)
      || (v6 = (struct _CIT_IMPACT_CONTEXT **)*((_QWORD *)a2 + 3), *v6 != v4) )
    {
      __fastfail(3u);
    }
  ...
  if ( *((_BYTE *)a2 + 35) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *(struct _CIT_PROG_DATA **)(v18 + 8) != (struct _CIT_PROG_DATA *)((char *)a2 + 16)
        || (v19 = (_QWORD *)*((_QWORD *)a2 + 3), (_QWORD *)*v19 != v17) )
      {
        __fastfail(3u);
      }
      *v19 = v18;
