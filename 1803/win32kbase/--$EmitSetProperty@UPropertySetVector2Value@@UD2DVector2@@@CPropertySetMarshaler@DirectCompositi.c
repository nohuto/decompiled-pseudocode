/*
 * XREFs of ??$EmitSetProperty@UPropertySetVector2Value@@UD2DVector2@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C00082E8
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( v10 < 0x24 && !DirectComposition::CBatch::AllocateNewFragment(a2, &v10) )
    return 0;
  DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, 0x24uLL, &v11);
  v8 = (char *)v11;
  *(_DWORD *)v11 = 36;
  *(_QWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 12) = 0LL;
  ...
  *((_DWORD *)v8 + 6) = v3;
  *(_QWORD *)(v8 + 28) = *(_QWORD *)((*(_DWORD *)(*(_QWORD *)(a1 + 56) + 8 * v4 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 72));
