/*
 * XREFs of McTemplateK0pqqxqttxx @ 0x1C00AE910
 * Callers:
 *     EtwTraceTokenStateChangedEvent @ 0x1C0010180 (EtwTraceTokenStateChangedEvent.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS McTemplateK0pqqxqttxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWriteKM(a1, &TokenStateChangedEvent, &W32kControlGuid, 0xAu, &v4);
}
