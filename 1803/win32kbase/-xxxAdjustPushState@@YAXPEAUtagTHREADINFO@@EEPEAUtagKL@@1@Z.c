/*
 * XREFs of ?xxxAdjustPushState@@YAXPEAUtagTHREADINFO@@EEPEAUtagKL@@1@Z @ 0x1C0129924
 * Callers:
 *     ?xxxAdjustPushStateForKL@@YAXPEAUtagTHREADINFO@@PEAEPEAUtagKL@@22@Z @ 0x1C0129B00 (-xxxAdjustPushStateForKL@@YAXPEAUtagTHREADINFO@@PEAEPEAUtagKL@@22@Z.c)
 * Callees:
        ...
        struct tagKL *a5)
{
  ...
  if ( a2 )
  {
    ...
    if ( ((unsigned __int8)v12 & gafRawKeyState[v11]) != 0
      ...
      || (*(_BYTE *)(*((_QWORD *)a1 + 53) + v11 + 228) & (unsigned __int8)v12) != 0 )
    {
  ...
  if ( a3 )
  {
    ...
    if ( ((unsigned __int8)v16 & gafRawKeyState[v15]) != 0
      ...
      || (*(_BYTE *)(*((_QWORD *)a1 + 53) + v15 + 228) & (unsigned __int8)v16) != 0 )
    {
