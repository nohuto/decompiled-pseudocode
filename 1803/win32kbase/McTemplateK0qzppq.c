/*
 * XREFs of McTemplateK0qzppq @ 0x1C00B00EC
 * Callers:
 *     EtwTraceAuditApiSetWindowsHookEx @ 0x1C0068D80 (EtwTraceAuditApiSetWindowsHookEx.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS __fastcall McTemplateK0qzppq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a8)
{
  ...
  v23 = 4LL;
  v22 = &a8;
  return McGenEventWriteKM((__int64)v8, &AuditApiSetWindowsHookEx, &W32kControlGuid, 6u, &v12);
}
