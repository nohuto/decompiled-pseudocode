/*
 * XREFs of ?Free@?$CSectionBitmapAllocator@$0CMAAA@$0CMA@@NSInstrumentation@@QEAAXPEAX@Z @ 0x1C005D984
 * Callers:
...
void __fastcall NSInstrumentation::CSectionBitmapAllocator<180224,704>::Free(__int64 *a1, void *a2)
{
  ...
  if ( a2 )
  {
    ...
    NSInstrumentation::CSectionBitmapAllocator<180224,704>::ContainsAllocation(a1, (unsigned __int64)a2);
