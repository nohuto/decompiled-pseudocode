/*
 * XREFs of ?_OnNewConfiguration@CInputConfig@@AEAAJPEAUCOutputConfig@@KPEAUCRegionConfig@@@Z @ 0x1C0053798
 * Callers:
 ...
 *     ?_ProcessOutputConfig@CInputConfig@@AEAAXPEAUCOutputConfig@@@Z @ 0x1C0053648 (-_ProcessOutputConfig@CInputConfig@@AEAAXPEAUCOutputConfig@@@Z.c)
 */
        ...
        struct CRegionConfig *a4)
{
  ...
  v8 = 0;
  v9 = (char *)Win32AllocPoolZInit(0xC8uLL, 0x6F436E49u);
  v10 = v9;
  if ( v9 )
  {
