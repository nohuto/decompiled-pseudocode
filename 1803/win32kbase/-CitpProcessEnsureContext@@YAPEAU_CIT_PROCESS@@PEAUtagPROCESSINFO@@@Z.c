/*
 * XREFs of ?CitpProcessEnsureContext@@YAPEAU_CIT_PROCESS@@PEAUtagPROCESSINFO@@@Z @ 0x1C003BDDC
 * Callers:
 ...
 *     ?CitpDPGetAppIndex@@YAIPEAU_CIT_PROCESS@@@Z @ 0x1C00672A8 (-CitpDPGetAppIndex@@YAIPEAU_CIT_PROCESS@@@Z.c)
 *     ?CitpUTCToMS@@YAI_KI@Z @ 0x1C006B310 (-CitpUTCToMS@@YAI_KI@Z.c)
...
struct _CIT_PROCESS *__fastcall CitpProcessEnsureContext(struct _CIT_PROCESS **a1)
{
  ...
  if ( !v4 )
  {
    ...
    CitpLogFailureWorker(-1073741670, v5, 0xF3Du);
    return 0LL;
  }
  memset(v4, 0, 0x60uLL);
