/*
 * XREFs of ?bOldPenNominal@DC@@QEAAHAEAVEXFORMOBJ@@J@Z @ 0x1C0026D08
 * Callers:
...
__int64 __fastcall DC::bOldPenNominal(DC *this, struct EXFORMOBJ *a2, int a3)
{
  ...
  if ( (*(_DWORD *)(*((_QWORD *)this + 10) + 352LL) & 0x20) != 0 )
  {
    ...
    v15 = a3;
    v14 = 0LL;
    if ( (unsigned int)EXFORMOBJ::bXform(a2, (struct _VECTORL *)&v13, (struct _VECTORFX *)&v13, 2LL) )
    {
      v5 = v13;
      if ( v13 < 0 )
        v5 = -v13;
  ...
  else
  {
    v16 = a3;
    v17 = 0;
    if ( (unsigned int)EXFORMOBJ::bXform(a2, (struct _VECTORL *)&v16, (struct _VECTORFX *)&v16, 1LL) )
