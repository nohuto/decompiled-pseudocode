/*
 * XREFs of PowerUnDimMonitor @ 0x1C00A5200
 * Callers:
...
void PowerUnDimMonitor()
{
  ...
  if ( (gbPowerHighPrecisionBrightnessSupported || dword_1C01A0370 != dword_1C01A035C) && !gProtocolType )
  {
    ...
    DrvSetMonitorBrightness(
      *(_QWORD *)(gpDispInfo + 16),
      (unsigned int)dword_1C01A0374,
      (unsigned int)dword_1C01A0378,
      0,
      &byte_1C01A0394,
      0);
    DrvUndimMonitors();
    ...
    dword_1C01A0370 = dword_1C01A0374;
  }
}
