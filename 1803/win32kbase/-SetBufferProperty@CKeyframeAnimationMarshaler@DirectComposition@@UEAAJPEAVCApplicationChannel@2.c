/*
 * XREFs of ?SetBufferProperty@CKeyframeAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C0008EB0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  if ( a3 == 23 )
  {
    if ( a5 == 8 )
    {
      this[34] = KeQueryPerformanceCounter(0LL);
      v11 = *a4;
      LOBYTE(this[36].LowPart) &= ~2u;
      this[35] = v11;
      *a6 = 1;
  ...
  if ( a3 == 32 )
  {
    ...
    {
      v12 = a5 / 0xC;
      if ( a5 == 12 * (a5 / 0xC) && !this[25].QuadPart && !this[26].LowPart )
      {
        v13 = Win32AllocPoolWithQuota(16LL * (unsigned int)v12, 1718305604LL);
        if ( !v13 )
          return (unsigned int)-1073741801;
        this[25].QuadPart = v13;
        v20 = 0;
        if ( !(_DWORD)v12 )
        {
LABEL_23:
        ...
        while ( 1 )
        {
          ...
          if ( !v18
            || (*(unsigned int (__fastcall **)(DirectComposition::CResourceMarshaler *))(*(_QWORD *)v18 + 16LL))(v18) != 131 )
          {
            break;
          }
          DirectComposition::CResourceMarshaler::AddRef(v18);
          ++v20;
          *(_QWORD *)(this[25].QuadPart + v14) = v18;
          *(_DWORD *)(this[25].QuadPart + v14 + 8) = v15[-1].HighPart;
          v19 = v15->LowPart;
          v15 = (LARGE_INTEGER *)((char *)v15 + 12);
          *(_DWORD *)(this[25].QuadPart + v14 + 12) = v19;
          v14 += 16LL;
          ++this[26].LowPart;
