/*
 * XREFs of ?vRealizeLineAttrs@DC@@QEAAXAEAVEXFORMOBJ@@@Z @ 0x1C00276C4
 * Callers:
 ...
 * Callees:
 *     ?bOldPenNominal@DC@@QEAAHAEAVEXFORMOBJ@@J@Z @ 0x1C0026D08 (-bOldPenNominal@DC@@QEAAHAEAVEXFORMOBJ@@J@Z.c)
 */
...
void __fastcall DC::vRealizeLineAttrs(DC *this, struct EXFORMOBJ *a2)
{
  ...
  *((_DWORD *)this + 55) = *(unsigned __int8 *)(v2 + 184);
  *((_DWORD *)this + 56) = *(unsigned __int8 *)(v2 + 185);
}
