/*
 * XREFs of ?SetReferenceArrayProperty@CTransformGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAPEAVCResourceMarshaler@2@_KPEA_N@Z @ 0x1C01522A0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a6)
{
  ...
  *a6 = 0;
  ...
  if ( v6 >= 0 )
  {
    ...
    {
      if ( *((_QWORD *)this + 7) )
        (*(void (__fastcall **)(DirectComposition::CTransformGroupMarshaler *, struct DirectComposition::CApplicationChannel *))(*(_QWORD *)this + 112LL))(
          this,
          a2);
      *((_QWORD *)this + 7) = a4;
      v11 = 0LL;
