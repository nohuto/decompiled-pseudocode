/*
 * XREFs of ?AcquireEntryIndex@GdiHandleManager@@QEAA_NPEAI@Z @ 0x1C002BA30
 * Callers:
 ...
 *     ?AcquireEntryIndex@GdiHandleEntryTable@@QEAA_NPEAI@Z @ 0x1C002C1AC (-AcquireEntryIndex@GdiHandleEntryTable@@QEAA_NPEAI@Z.c)
