/*
 * XREFs of ?BeginTrack@CReferenceCountedType@CReferenceTracker@NSInstrumentation@@QEAAPEAXPEAX@Z @ 0x1C00DC6A4
 * Callers:
 ...
 * Callees:
 *     ?Create@CPlatformSignal@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00DC524 (-Create@CPlatformSignal@NSInstrumentation@@SAPEAV12@XZ.c)
