/*
 * XREFs of ?IsOfType@CClipGroupMarshaler@DirectComposition@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1C0146710
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CClipGroupMarshaler::IsOfType(__int64 a1, int a2)
{
  bool v2; // al
  char v3; // cl
