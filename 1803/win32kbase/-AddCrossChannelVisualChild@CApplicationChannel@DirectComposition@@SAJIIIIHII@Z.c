/*
 * XREFs of ?AddCrossChannelVisualChild@CApplicationChannel@DirectComposition@@SAJIIIIHII@Z @ 0x1C0013D90
 * Callers:
 *     NtDCompositionAddCrossDeviceVisualChild @ 0x1C0013D60 (NtDCompositionAddCrossDeviceVisualChild.c)
 * Callees:
