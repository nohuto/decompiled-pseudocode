/*
 * XREFs of ??$EmitSetProperty@UPropertySetBooleanValue@@_N@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C014B1E8
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( v10 < 0x20 && !DirectComposition::CBatch::AllocateNewFragment(a2, &v10) )
    return 0;
  ...
  *((_DWORD *)v8 + 6) = v3;
  v8[28] = *(_BYTE *)((*(_DWORD *)(*(_QWORD *)(a1 + 56) + 8 * v4 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 72));
