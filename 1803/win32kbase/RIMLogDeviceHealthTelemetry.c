/*
 * XREFs of RIMLogDeviceHealthTelemetry @ 0x1C00E319C
 * Callers:
...
void __fastcall RIMLogDeviceHealthTelemetry(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( dword_1C019EBC0 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C019EBC0, 0x400000000000uLL) )
  {
    ...
    v8 = *(_DWORD *)(v7 + 184);
    v33 = 4LL;
    v18 = (unsigned __int16)(v8 & 0x1000) >> 12;
    v32 = &v18;
    v35 = 4LL;
    v37 = 4LL;
    v39 = 4LL;
    ...
    v20 = __CFSHR__(v8, 12);
    v36 = &v20;
    v21 = (unsigned __int8)(v8 & 0x40) >> 6;
    v38 = &v21;
    if ( __CFSHR__(v8, 12) || __CFSHR__(v8, 11) || (v9 = 1, (v8 & 0x80u) != 0) )
      v9 = 0;
    v22 = v9;
    v40 = &v22;
    v42 = v7 + 288;
    ...
    v45 = 4LL;
    v47 = 4LL;
    v23 = (v8 & 0x4000000u) >> 26;
    v49 = 4LL;
    if ( v10 < 0 && (v11 = *(_QWORD *)(v7 + 480)) != 0 )
      v12 = -__CFSHR__(*(_DWORD *)(v11 + 276), 15);
    else
      v12 = 0;
    v24 = v12;
    v51 = 4LL;
    ...
    v57 = 8LL;
    v59 = 8LL;
    TlgWrite((TraceLoggingHProvider)&dword_1C019EBC0, &unk_1C01783BD, 0LL, (LPCGUID)0xFFFFF78000000004LL, 0x13u, &pData);
  }
}
