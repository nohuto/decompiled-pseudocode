/*
 * XREFs of ?Create@CSharedWriteScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015EB3C
 * Callers:
 *     CreateSharedWriteScalarMarshaler @ 0x1C015ECC0 (CreateSharedWriteScalarMarshaler.c)
 * Callees:
