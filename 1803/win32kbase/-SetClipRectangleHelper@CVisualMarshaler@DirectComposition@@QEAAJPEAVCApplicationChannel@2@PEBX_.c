/*
 * XREFs of ?SetClipRectangleHelper@CVisualMarshaler@DirectComposition@@QEAAJPEAVCApplicationChannel@2@PEBX_KPEA_N@Z @ 0x1C000CB6C
 * Callers:
        ...
        bool *a5)
{
  ...
  v7 = 0;
  if ( !v6
    || !(*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v6 + 120LL))(v6, 115LL)
  ...
  {
    v7 = 1;
    v15 = DirectComposition::CApplicationChannel::CreateInternalResource(a2, 0x73u, &v16);
    v11 = v16;
    v13 = v15;
    if ( v15 < 0 )
      goto LABEL_7;
