/*
 * XREFs of ?Allocate@?$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@QEAAPEAXXZ @ 0x1C005E130
 * Callers:
...
__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<81920,320>::Allocate(__int64 a1)
{
  ...
  ClearBits = RtlFindClearBits(
                ...
                1u,
                *(_DWORD *)(a1 + 32) < 0xF0u ? *(_DWORD *)(a1 + 32) : 0);
  v4 = 0LL;
  v5 = ClearBits;
  if ( ClearBits != -1 && NSInstrumentation::CSectionBitmapAllocator<81920,320>::CommitSlot(a1, ClearBits) )
  {
    ...
    if ( ++*(_DWORD *)(a1 + 32) >= 0xF0u )
      *(_DWORD *)(a1 + 32) = 0;
    v4 = ((v5 / 0xC) << 12) + (*(_QWORD *)(a1 + 16) ^ *(_QWORD *)(a1 + 8)) + 320 * (v5 % 0xC);
  }
