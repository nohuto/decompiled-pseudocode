/*
 * XREFs of UserProcessTimerDelayCallout @ 0x1C00A77A8
 * Callers:
...
__int64 __fastcall UserProcessTimerDelayCallout(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  tagObjLock *v24; // [rsp+40h] [rbp+8h] BYREF
  ...
  if ( ProcessWin32Process )
    v22 = SetProcessTimerDelay(ProcessWin32Process, *(unsigned int *)(a1 + 8), *(unsigned int *)(a1 + 12));
  else
    v22 = -1073741558;
