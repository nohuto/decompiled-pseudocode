/*
 * XREFs of ?bOffset@RGNOBJ@@QEAAHPEAU_POINTL@@@Z @ 0x1C0021EC0
 * Callers:
 *     ?vOffset@EPATHOBJ@@QEAAXAEAVEPOINTL@@@Z @ 0x1C001BA80 (-vOffset@EPATHOBJ@@QEAAXAEAVEPOINTL@@@Z.c)
...
__int64 __fastcall RGNOBJ::bOffset(int **this, struct _POINTL *a2)
{
  ...
  if ( (*this)[21] != 1 )
  {
    ...
    v9 = v2[25];
    v10 = v2[23];
    if ( (int)v7 < (int)v8 && (int)v10 < (int)v9 )
    {
      if ( (unsigned __int64)(x + v7 + 0x80000000LL) > 0xFFFFFFFF
        ...
        || (v12 = y + v10, DWORD2(v18) = v11, (unsigned __int64)(v12 + 0x80000000LL) > 0xFFFFFFFF)
        || (DWORD1(v18) = v12,
