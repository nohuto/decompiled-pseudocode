/*
 * XREFs of ?DrvProcessSetDisplayConfigParameters@@YAJAEAU_D3DKMT_DISPLAY_CALLOUT_BATCH_ACTION@@IPEAUtagDESKTOP@@PEAEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00D0004
 * Callers:
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a5)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( v17 )
    {
      v9 = (struct DISPLAYCONFIG_PATH_INFO_INTERNAL *)PALLOCMEM2((unsigned int)(200 * v17), 0x73726447u, 1);
      if ( !v9 )
        return 3221225495LL;
      v17 = v32;
      v16 = v31;
