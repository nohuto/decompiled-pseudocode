/*
 * XREFs of ?SetReferenceProperty@CProjectedShadowSceneMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C0151D50
 * Callers:
 *     <none>
 * Callees:
        ...
        bool *a5)
{
  ...
  *a5 = 0;
  ...
  if ( this == (DirectComposition::CProjectedShadowSceneMarshaler *)-88LL
    || a4
