/*
 * XREFs of ?ProcessGestureFrame@CPTPEngine@@AEAAXPEAUPTPInput@@HPEAH@Z @ 0x1C01396EC
 * Callers:
 ...
 *     ?FixupGestureContact@CPTPEngine@@AEAAXPEAUPTPEnginePointerNode@@H@Z @ 0x1C0138D94 (-FixupGestureContact@CPTPEngine@@AEAAXPEAUPTPEnginePointerNode@@H@Z.c)
...
void __fastcall CPTPEngine::ProcessGestureFrame(CPTPEngine *this, struct PTPInput *a2, unsigned int a3, int *a4)
{
  ...
  unsigned int v46; // [rsp+70h] [rbp-298h]
  _BYTE v47[12]; // [rsp+74h] [rbp-294h] BYREF
  char v48; // [rsp+80h] [rbp-288h] BYREF
  ...
  *((_DWORD *)v8 + 28) = v16;
  ...
  if ( v46 )
  {
    ...
    do
    {
      v19 = (_DWORD *)((char *)v6 + 296 * (unsigned int)(*((_DWORD *)v21 + 1) % *((_DWORD *)v6 + 4)) + 1192);
  ...
  v32 = !a3
     && *((_DWORD *)v6 + 747) > 2u
     && v45 - *((_QWORD *)v6 + 400) < *((_QWORD *)v6 + 12) * (unsigned __int64)*((unsigned int *)v6 + 87) / 0x3E8;
  ...
  if ( v28 )
  {
    ...
    do
    {
      ...
      v40 = *(_DWORD *)((char *)v6 + v39 + 1192);
      v41 = v40;
      if ( (v40 & 1) != 0 && v36 && (v40 & 2) != 0 )
      {
        v41 = v40 | 0x400;
        *(_DWORD *)((char *)v6 + v39 + 1192) = v40 | 0x400;
      }
      ...
      else
      {
        ...
        v35 = 0;
        if ( !v23 )
          *(_DWORD *)((char *)v6 + v44 + 1192) &= ~0x8000u;
      }
      v28 = v46;
      ++v37;
      v38 += 96;
