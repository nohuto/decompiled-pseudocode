/*
 * XREFs of ?SetPointerInfoNodeTarget@CTouchProcessor@@AEAAXPEBUCPointerInputFrame@@KAEBVCInputDest@@HPEBUtagPOINT@@HHHH@Z @ 0x1C011D060
 * Callers:
        ...
        int a10)
{
  ...
  v13 = (*((_DWORD *)gptiCurrent + 300) >> 13) & 1;
  CTouchProcessor::SetPointerInfoNodeTargetInt((CTouchProcessor *)a8, v12, a4, a5, a6, a7, a8, v13, a10);
  if ( a9 && (unsigned int)CPointerInfoNode::GetHistoryCount(v12, v14) > 1 )
