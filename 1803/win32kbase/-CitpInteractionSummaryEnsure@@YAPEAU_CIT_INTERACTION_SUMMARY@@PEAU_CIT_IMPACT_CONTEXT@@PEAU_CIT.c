/*
 * XREFs of ?CitpInteractionSummaryEnsure@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROCESS@@G@Z @ 0x1C003BEF8
 * Callers:
 ...
 *     ?CitpSetAudioInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z @ 0x1C006A320 (-CitpSetAudioInfo@@YAJPEAT_CIT_SI_INFOFLAGS@@PEAT_CIT_SI_INFO@@@Z.c)
 ...
 *     ?CitpProcessGetAppSessionId@@YA?AU_GUID@@PEAUtagPROCESSINFO@@PEAI@Z @ 0x1C003C004 (-CitpProcessGetAppSessionId@@YA-AU_GUID@@PEAUtagPROCESSINFO@@PEAI@Z.c)
 ...
 *     ?CitpProcessEnsureProgData@@YAPEAU_CIT_PROG_DATA@@PEAUtagPROCESSINFO@@@Z @ 0x1C016387C (-CitpProcessEnsureProgData@@YAPEAU_CIT_PROG_DATA@@PEAUtagPROCESSINFO@@@Z.c)
 */
...
LABEL_4:
  ...
  if ( *v8 )
  {
    if ( ((*((unsigned __int16 *)v3 + 42) >> 2) & 0x1FFF) == dword_1C01A16AC )
      goto LABEL_6;
...
LABEL_6:
    if ( v3 )
    {
      ...
      *(struct _GUID *)((char *)v3 + 60) = *CitpProcessGetAppSessionId(&v12, a2[1], (unsigned int *)v3 + 20);
      v9 = *((_BYTE *)a2 + 91);
      if ( (v9 & 1) == 0 )
      {
        *((_BYTE *)a2 + 91) = v9 | 1;
        CitpStatIncrement((unsigned __int16 *)v3 + 43, 1);
      }
    }
    return v3;
  }
