/*
 * XREFs of ?SetVisual@CVisualReferenceControllerMarshaler@DirectComposition@@IEAAJPEAVCApplicationChannel@2@PEAVCVisualMarshaler@2@PEA_N@Z @ 0x1C0007DA4
 * Callers:
        ...
        bool *a4)
{
  ...
  else
  {
    ...
    v12 = (struct DirectComposition::CWeakReferenceBase *)*((_QWORD *)this + 5);
    if ( v12 )
