/*
 * XREFs of ?CitEtwEnableCallback@@YAXPEBU_GUID@@I_K@Z @ 0x1C0160038
 * Callers:
...
void __fastcall CitEtwEnableCallback(const struct _GUID *a1, int a2, __int64 a3)
{
  ...
  if ( (_BYTE)g_CompatImpact && !byte_1C01A1681 && a2 == 2 && a3 == 2048 && a1 )
  {
    v6 = (__int128)*a1;
    LODWORD(v6) = 0;
    ...
    if ( !v4 && qword_1C01A16B0 )
    {
      v5 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
      switch ( v3 )
      {
        case 1:
          CitpContextFlush(qword_1C01A16B0, v5);
          break;
        case 2:
          CitpSetForegroundProcess(qword_1C01A16B0, v5, 0LL, 0LL, 0LL, 0LL);
          CitpContextReinitialize(qword_1C01A16B0, v5);
          break;
        case 14:
          CitpResetTracking();
          break;
        case 15:
          CitpInteractionSummariesFlush(qword_1C01A16B0, 0);
          break;
        case 11:
          CitpPostUpdateUseInfoLoad(qword_1C01A16B0);
          break;
        case 12:
          CitpPostUpdateUseInfoLog(qword_1C01A16B0, 2u);
          break;
        case 16:
          CitpDPDataLoad(qword_1C01A16B0);
          break;
        case 17:
          CitpDPDataLog(qword_1C01A16B0);
          break;
      }
    }
  }
