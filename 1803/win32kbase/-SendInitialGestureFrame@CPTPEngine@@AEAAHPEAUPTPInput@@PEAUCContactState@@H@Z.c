/*
 * XREFs of ?SendInitialGestureFrame@CPTPEngine@@AEAAHPEAUPTPInput@@PEAUCContactState@@H@Z @ 0x1C013AFB0
 * Callers:
        ...
        int a4)
{
  ...
  char v38; // [rsp+80h] [rbp-80h] BYREF
  ...
  *((_DWORD *)v8 + 28) = v17;
  ...
  if ( v36 )
  {
    ...
    do
    {
      v28 = (CPTPEngine *)((char *)this + 296 * (*((_DWORD *)v27 - 2) % v26) + 1192);
  ...
  {
    v32 = (CPTPEngine *)((char *)this + 296 * (unsigned int)(*((_DWORD *)i + 1) % *((_DWORD *)this + 4)) + 1192);
