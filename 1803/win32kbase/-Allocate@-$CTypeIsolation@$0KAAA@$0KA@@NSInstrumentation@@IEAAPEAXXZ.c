/*
 * XREFs of ?Allocate@?$CTypeIsolation@$0KAAA@$0KA@@NSInstrumentation@@IEAAPEAXXZ @ 0x1C006219C
 * Callers:
...
__int64 __fastcall NSInstrumentation::CTypeIsolation<40960,160>::Allocate(__int64 a1)
{
  ...
  if ( v7 )
  {
    v3 = NSInstrumentation::CSectionBitmapAllocator<40960,160>::Allocate(*(_QWORD *)(v7 + 32));
    if ( v3 )
    {
      v9 = *(_QWORD *)(a1 + 16);
      KeEnterCriticalRegion();
