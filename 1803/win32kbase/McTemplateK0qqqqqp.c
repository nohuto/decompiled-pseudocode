/*
 * XREFs of McTemplateK0qqqqqp @ 0x1C00AF254
 * Callers:
 *     EtwTraceAuditApiSetWinEventHook @ 0x1C006CDD0 (EtwTraceAuditApiSetWinEventHook.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS __fastcall McTemplateK0qqqqqp(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 4LL;
  v22 = 8LL;
  return McGenEventWriteKM(a1, &AuditApiSetWinEventHook, &W32kControlGuid, 7u, &v10);
}
