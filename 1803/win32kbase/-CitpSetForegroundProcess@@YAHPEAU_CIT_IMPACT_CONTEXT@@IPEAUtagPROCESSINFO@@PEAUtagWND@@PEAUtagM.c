/*
 * XREFs of ?CitpSetForegroundProcess@@YAHPEAU_CIT_IMPACT_CONTEXT@@IPEAUtagPROCESSINFO@@PEAUtagWND@@PEAUtagMONITOR@@PEAUtagSHELL_INPUT_USAGE_DATA_INFO@@@Z @ 0x1C003FDE0
 * Callers:
 ...
 *     ?CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEAA?AU1@AEBU1@@Z @ 0x1C003FD00 (-CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEAA-AU1@AEBU1@@Z.c)
 ...
 *     ?CitpGetForegroundWindowInfo@@YAHPEAU_CIT_WINDOW_INFO@@PEAUtagPROCESSINFO@@PEAUtagWND@@@Z @ 0x1C0040864 (-CitpGetForegroundWindowInfo@@YAHPEAU_CIT_WINDOW_INFO@@PEAUtagPROCESSINFO@@PEAUtagWND@@@Z.c)
 ...
 *     ?CitpBitmapUpdateForTimeRange@@YAXPEAU_CIT_BITMAP@@IIII@Z @ 0x1C0040A90 (-CitpBitmapUpdateForTimeRange@@YAXPEAU_CIT_BITMAP@@IIII@Z.c)
 ...
 *     ?CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z @ 0x1C0163DD0 (-CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z.c)
 */
        ...
        struct tagSHELL_INPUT_USAGE_DATA_INFO *a6)
{
  ...
  unsigned int *v116; // [rsp+180h] [rbp+80h]
...
LABEL_61:
  ...
  if ( a2 - *((_DWORD *)a1 + 128) > 2 * dword_1C01A168C )
  {
    v62 = 4;
    goto LABEL_61;
  }
LABEL_4:
  if ( a2 - *((_DWORD *)a1 + 190) >= dword_1C01A16A0 )
    CitpDPDataLog(a1);
  if ( *((_QWORD *)a1 + 15) )
  {
    v14 = *((_DWORD *)a1 + 70);
    ...
    *((_DWORD *)a1 + 71) = v20;
    ...
    CIT_USER_ACTIVITY_STAT::CalculateDeltaFrom((unsigned int *)&v89, &v82, (unsigned int *)a1 + 42);
    CIT_USER_ACTIVITY_STAT::CalculateDeltaFrom((unsigned int *)&v90, &v84, (unsigned int *)a1 + 44);
    v23 = v84;
    *((_DWORD *)a1 + 142) += v84;
    v24 = *(_BYTE *)(v21 + 91);
    if ( (v24 & 0x1E) != 0 )
      ...
      if ( byte_1C01A16AB )
      {
        ...
        if ( hProvider > 5u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
          {
            ...
            v152 = v29;
            v153 = 8LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C017A00F, 0LL, v28, 0x1Cu, &pData);
          }
        }
      }
        ...
        if ( v63 )
        {
          ...
          *((_DWORD *)v63 + 20) = v67;
          ...
          if ( v69 + v66 >= v69 )
            v68 = v69 + v66;
          *((_DWORD *)v64 + 21) = v68;
          CitpProgDataNotifyUseUpdate(qword_1C01A16B0, v64);
        }
      }
      if ( (qword_1C01A1694 & 1) != 0 )
      {
        v31 = CitpInteractionSummaryEnsure(a1, (struct tagPROCESSINFO **)v21, 2);
        v32 = v31;
        if ( v31 )
        {
          v33 = *((_DWORD *)v31 + 29);
          ...
          *(_DWORD *)(v50 + 56) = v98;
          CitpBitmapUpdateForTimeRange(
            (struct _CIT_BITMAP *)(v50 + 144),
            *((_DWORD *)a1 + 34),
            a2,
            *((_DWORD *)a1 + 202),
            dword_1C01A169C);
        }
        if ( (qword_1C01A1694 & 1) != 0 && a2 - *((_DWORD *)a1 + 202) > HIDWORD(qword_1C01A1694) )
  ...
  if ( v7 )
  {
    ...
    v7 = v51;
    if ( v51 )
      v7 = v51 & -(__int64)(CitpProcessEnsureContext((struct _CIT_PROCESS **)v51) != 0LL);
  }
  *((_QWORD *)a1 + 15) = v7;
  *((_DWORD *)a1 + 34) = a2;
  *((_QWORD *)a1 + 21) = v11;
      ...
      if ( byte_1C01A16AB )
      {
        ...
        if ( hProvider > 5u )
        {
          if ( TlgKeywordOn((TraceLoggingHProvider)&hProvider, 0x800000000800uLL) )
          {
            ...
            v183 = v56;
            v184 = 8LL;
            TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C0179EE5, 0LL, v59, 0x11u, &v154);
          }
        }
      }
    }
