/*
 * XREFs of EnableFlushTimer @ 0x1C01679FC
 * Callers:
 *     InsertEventEntryInLookUpTable @ 0x1C0167C1C (InsertEventEntryInLookUpTable.c)
 *     ?TlgAggregateInternalFlushTimerCallbackKernelMode@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C0168020 (-TlgAggregateInternalFlushTimerCallbackKernelMode@@YAXPEAU_EX_TIMER@@PEAX@Z.c)
