/*
 * XREFs of ?ConfirmFrame@CConnection@DirectComposition@@QEAAXXZ @ 0x1C0046310
 * Callers:
...
void __fastcall DirectComposition::CConnection::ConfirmFrame(DirectComposition::CConnection *this)
{
  ...
  *((_DWORD *)this + 65) = 0;
  ...
  while ( 1 )
  {
    ...
    _mm_lfence();
    v8 = v10 + 1;
    v12 = *(_DWORD **)(v10 * *((_QWORD *)this + 7) + *((_QWORD *)this + 3));
    if ( !v12 )
      break;
    v13 = *(void (**)(void))(*(_QWORD *)v12 + 16LL);
    if ( (char *)v13 == (char *)DirectComposition::CApplicationChannel::ConfirmFrame )
    {
      v12[96] = v12[95];
      v12[164] = 0;
    }
