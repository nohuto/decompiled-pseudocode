/*
 * XREFs of ?PnpNotifyForRemoteSession@@YAJPEAXPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C00A26F0
 * Callers:
...
LABEL_6:
    ...
    if ( (unsigned __int16)(gProtocolType - 1) <= 0xFFFDu )
    {
      xxxUserSetDisplayConfig(0, 0, 2191, 2, (__int64)grpdeskRitInput, 0, 0LL, 0LL, 0LL, (__int64)a2);
    ...
    || (result = xxxSetCsrssThreadDesktop(grpdeskRitInput, v4), (int)result >= 0) )
  {
    ...
    xxxUserSetDisplayConfig(0, 0, 128, 1, (__int64)grpdeskRitInput, 0, 0LL, 0LL, 0LL, (__int64)a2);
    goto LABEL_6;
  }
  return result;
}
