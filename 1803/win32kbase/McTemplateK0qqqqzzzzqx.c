/*
 * XREFs of McTemplateK0qqqqzzzzqx @ 0x1C00AF584
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqqzzzzqx(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a13)
{
  ...
  v45 = v24;
  v51 = 8LL;
  return McGenEventWriteKM((__int64)v24, &ImmersiveMessageCheckDelayEvent, &W32kControlGuid, 0xBu, &v27);
}
