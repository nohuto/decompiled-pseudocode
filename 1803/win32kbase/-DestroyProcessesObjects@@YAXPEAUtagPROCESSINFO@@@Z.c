/*
 * XREFs of ?DestroyProcessesObjects@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C0035470
 * Callers:
 ...
 *     FixupGlobalCursor @ 0x1C00B0F30 (FixupGlobalCursor.c)
 */
...
void __fastcall DestroyProcessesObjects(struct tagPROCESSINFO *a1)
{
  ...
  if ( qword_1C01A2338 )
  {
    ...
    if ( (unsigned int)GreGetObjectOwner((unsigned int)qword_1C01A2330, 1) == (CurrentProcessId & 0xFFFFFFFC) )
      StopFade();
  }
  ...
  while ( v4 );
  v6 = (char *)qword_1C01A0E28;
  v7 = gpKernelHandleTable;
  v8 = (char *)qword_1C01A0E28 + 32 * (unsigned int)giheLast;
  if ( qword_1C01A0E28 <= v8 )
  {
    do
    {
      v9 = v6[24];
      if ( v9 && (*((_BYTE *)&unk_1C0172BBC + 24 * v9) & 2) != 0 && (struct tagPROCESSINFO *)v7[1] == a1 )
      {
        if ( v2 && v9 == 3 )
