/*
 * XREFs of ?CapturePointer@CApplicationChannel@DirectComposition@@QEAAJIW4CapturePointerType@@II_K@Z @ 0x1C0145F74
 * Callers:
 ...
 *     ?OwnsPointerId@CInputManager@@SA_NII@Z @ 0x1C015FB44 (-OwnsPointerId@CInputManager@@SA_NII@Z.c)
 */
        ...
        __int64 a6)
{
  ...
  if ( a3 )
  {
    if ( a3 == 1 )
    {
      v13 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64, _QWORD, _QWORD, __int64))(*(_QWORD *)v12 + 264LL))(
              v12,
              a1,
              a4,
              a5,
  ...
  v13 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, __int64, _QWORD))(*(_QWORD *)v12 + 256LL))(
          v12,
          a1,
          a4);
LABEL_13:
