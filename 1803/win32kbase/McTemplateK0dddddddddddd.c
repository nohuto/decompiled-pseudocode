/*
 * XREFs of McTemplateK0dddddddddddd @ 0x1C00AE0EC
 * Callers:
 *     EtwTraceTouchTargetingPointerEvent @ 0x1C00ACE10 (EtwTraceTouchTargetingPointerEvent.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C00AD480 (McGenEventWriteKM.c)
 */

NTSTATUS __fastcall McTemplateK0dddddddddddd(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a15)
{
  ...
  v38 = 4LL;
  v40 = 4LL;
  return McGenEventWriteKM(a1, &TouchTargetingPointerEvent, &W32kControlGuid, 0xDu, &v16);
}
