/*
 * XREFs of ?Create@CSharedReadRemotingRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015F12C
 * Callers:
 *     CreateSharedReadRemotingRenderTargetMarshaler @ 0x1C015F300 (CreateSharedReadRemotingRenderTargetMarshaler.c)
 * Callees:
