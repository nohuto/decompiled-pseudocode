/*
 * XREFs of ?EmitOptions@CVisualMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0017F80
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x1CuLL, &v5) )
  {
    ...
    *((_DWORD *)v4 + 3) = (*((unsigned __int8 *)this + 272) >> 4) & 1;
    *((_DWORD *)v4 + 4) = (*((unsigned __int8 *)this + 272) >> 3) & 1;
    *((_DWORD *)v4 + 5) = (*((unsigned __int8 *)this + 272) >> 5) & 1;
    *((_DWORD *)v4 + 6) = *((_BYTE *)this + 273) & 1;
