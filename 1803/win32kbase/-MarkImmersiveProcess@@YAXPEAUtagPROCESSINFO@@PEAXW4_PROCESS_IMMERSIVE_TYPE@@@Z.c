/*
 * XREFs of ?MarkImmersiveProcess@@YAXPEAUtagPROCESSINFO@@PEAXW4_PROCESS_IMMERSIVE_TYPE@@@Z @ 0x1C003CDEC
 * Callers:
...
__int64 __fastcall MarkImmersiveProcess(__int64 a1, __int64 a2, int a3)
{
  ...
  v5 = *(_DWORD *)(a1 + 812) ^ (*(_DWORD *)(a1 + 812) ^ (16 * a3)) & 0x30;
  *(_DWORD *)(a1 + 812) = v5;
  if ( a3 == 1 )
  {
    v8 = 0;
    ...
    else
    {
      if ( (unsigned __int8)ExQueryFastCacheDevLicense() && (unsigned __int64)BYTE2(v11) - 4 <= 1 )
        v8 = 512;
      v9 = v8 | *(_DWORD *)(a1 + 812) & 0xFFFFFDFF;
      *(_DWORD *)(a1 + 812) = v9;
    }
    v6 = v9 | 4;
  }
