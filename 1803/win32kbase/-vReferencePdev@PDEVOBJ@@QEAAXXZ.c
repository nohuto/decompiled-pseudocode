/*
 * XREFs of ?vReferencePdev@PDEVOBJ@@QEAAXXZ @ 0x1C0032010
 * Callers:
...
void __fastcall PDEVOBJ::vReferencePdev(PDEVOBJ *this, __int64 a2, int a3)
{
  ...
  if ( v6 && qword_1C019F740 )
    NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C019F740, v6, 1);
  if ( v3 )
  {
    if ( gbLockEtw )
    {
      if ( ((unsigned __int8)Microsoft_Windows_Win32kEnableBits & 0x10) != 0 )
        McTemplateK0pz(v7, (unsigned int)&LockRelease, a3, (_DWORD)v3, (__int64)L"hsem");
    }
