/*
 * XREFs of intializeGlobalRecorder @ 0x1C01247E0
 * Callers:
 *     InputInitialize @ 0x1C01315F8 (InputInitialize.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0073C90 (__security_check_cookie.c)
 *     RtlStringCchCopyA @ 0x1C01248B8 (RtlStringCchCopyA.c)
 */
...
__int64 intializeGlobalRecorder()
{
  ...
  result = imp_WppRecorderLogCreate(WPP_GLOBAL_Control, v4, &WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink);
  if ( (int)result < 0 )
