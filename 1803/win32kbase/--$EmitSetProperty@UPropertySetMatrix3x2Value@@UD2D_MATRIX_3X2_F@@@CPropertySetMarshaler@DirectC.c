/*
 * XREFs of ??$EmitSetProperty@UPropertySetMatrix3x2Value@@UD2D_MATRIX_3X2_F@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C0007FA4
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( v12 < 0x34 && !DirectComposition::CBatch::AllocateNewFragment(a2, &v12) )
    return 0;
  DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, 0x34uLL, &v13);
  v8 = (char *)v13;
  *(_DWORD *)v13 = 52;
  *(_QWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 12) = 0LL;
