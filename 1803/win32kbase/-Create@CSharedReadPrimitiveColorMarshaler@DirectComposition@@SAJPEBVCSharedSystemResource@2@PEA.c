/*
 * XREFs of ?Create@CSharedReadPrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015E77C
 * Callers:
 *     CreateSharedReadPrimitiveColorMarshaler @ 0x1C015E990 (CreateSharedReadPrimitiveColorMarshaler.c)
 * Callees:
