/*
 * XREFs of McTemplateK0pqqqq @ 0x1C00AE868
 * Callers:
 *     EtwDirtyRectUpdate @ 0x1C005FED0 (EtwDirtyRectUpdate.c)
 *     EtwTraceInternalSetTimer @ 0x1C0062AC0 (EtwTraceInternalSetTimer.c)
 *     EtwTraceTimerProc @ 0x1C00634A0 (EtwTraceTimerProc.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C00D9FF0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C00DA030 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C00DA3D0 (EtwTranslationUpdate.c)
 * Callees:
