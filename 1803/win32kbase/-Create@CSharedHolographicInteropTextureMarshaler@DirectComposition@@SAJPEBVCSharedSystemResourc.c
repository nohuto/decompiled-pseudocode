/*
 * XREFs of ?Create@CSharedHolographicInteropTextureMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015F3AC
 * Callers:
 *     CreateSharedHolographicInteropTextureMarshaler @ 0x1C015F580 (CreateSharedHolographicInteropTextureMarshaler.c)
 * Callees:
