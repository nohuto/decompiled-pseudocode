/*
 * XREFs of NtMITDisableMouseIntercept @ 0x1C00B3D80
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
  ...
  v22 = (*(__int64 (__fastcall **)(CMouseSensor *))(*(_QWORD *)qword_1C019A5A8 + 8LL))(qword_1C019A5A8);
  if ( v22 )
    LOBYTE(v22) = CMouseProcessor::MouseInterceptState::Disable(v22 + 2744);
