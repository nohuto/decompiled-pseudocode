/*
 * XREFs of rimAllocUserMemInternal @ 0x1C00E8590
 * Callers:
 *     RIMAllocUserMem @ 0x1C00E84E0 (RIMAllocUserMem.c)
  ...
  *a3 = 0LL;
  ...
  if ( v6 >= 0 )
  {
    ...
    if ( v7 )
    {
      ...
      NewElement = 0;
      Buffer[2] = v7;
      inserted = RtlInsertElementGenericTableAvl(a1 + 7, Buffer, 0x18u, &NewElement);
      ...
      if ( inserted )
        RtlDeleteElementGenericTableAvl(a1 + 7, inserted);
      v6 = -1073741801;
    }
    else
    {
