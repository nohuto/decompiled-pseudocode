/*
 * XREFs of ?Free@?$CSectionBitmapAllocator@$0KAAA@$0KA@@NSInstrumentation@@QEAAXPEAX@Z @ 0x1C0062410
 * Callers:
...
void __fastcall NSInstrumentation::CSectionBitmapAllocator<40960,160>::Free(__int64 *a1, void *a2)
{
  ...
  if ( a2 )
  {
    ...
    NSInstrumentation::CSectionBitmapAllocator<40960,160>::ContainsAllocation(a1, a2);
