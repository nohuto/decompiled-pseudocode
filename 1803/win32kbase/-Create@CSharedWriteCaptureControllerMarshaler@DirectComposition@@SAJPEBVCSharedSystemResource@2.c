/*
 * XREFs of ?Create@CSharedWriteCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C0157320
 * Callers:
 *     CreateSharedWriteCaptureControllerMarshaler @ 0x1C0157450 (CreateSharedWriteCaptureControllerMarshaler.c)
 * Callees:
