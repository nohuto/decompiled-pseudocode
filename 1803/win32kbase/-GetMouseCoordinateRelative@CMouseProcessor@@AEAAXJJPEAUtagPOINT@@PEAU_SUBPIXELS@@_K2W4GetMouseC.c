/*
 * XREFs of ?GetMouseCoordinateRelative@CMouseProcessor@@AEAAXJJPEAUtagPOINT@@PEAU_SUBPIXELS@@_K2W4GetMouseCoordinateOptions@@@Z @ 0x1C0039174
 * Callers:
...
LABEL_4:
  if ( (a8 & 4) == 0 )
  {
    ...
    v14 = _mm_srli_si128(*(__m128i *)&gpInputConfig[4].Next[3].Next, 8);
    *((_DWORD *)&gaptMouse + 2 * v12) = LOWORD(a4->x) | ((unsigned __int16)(v14.m128i_i16[0] - (_WORD)Next - 1) << 16);
    v15 = a6;
    *((_DWORD *)&gaptMouse + 2 * v12 + 1) = LOWORD(a4->y) | ((unsigned __int16)(v14.m128i_i16[2] - WORD2(Next) - 1) << 16);
    *((_DWORD *)&gaptMouse + 2 * v12 + 2) = v15;
    *((_QWORD *)&gaptMouse + v12 + 2) = a7;
    gptInd = (v11 + 1) & 0x3F;
    if ( !v18 )
    {
