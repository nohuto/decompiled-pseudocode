/*
 * XREFs of ?EmitEdgyConfiguration@CManipulationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0148E0C
 * Callers:
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (v2 & 0x200) != 0 )
  {
    if ( DirectComposition::CBatch::EnsureBatchBuffer(a2, 0x214uLL, &v10) )
    {
      v5 = (char *)v10 + 4;
      *(_DWORD *)v10 = 532;
      memset(v5, 0, 0x210uLL);
      *v5 = 262;
      v5[1] = *((_DWORD *)this + 6);
      v5[2] = *(_DWORD *)(*((_QWORD *)this + 86) + 24LL);
  ...
  *v7 = 261;
  v7[1] = *((_DWORD *)this + 6);
  *(_OWORD *)(v7 + 2) = *(_OWORD *)((char *)this + 648);
  *(_OWORD *)(v7 + 6) = *(_OWORD *)((char *)this + 664);
  *((_QWORD *)v7 + 5) = *((_QWORD *)this + 85);
  v8 = *((_QWORD *)this + 86);
  if ( v8 )
    v6 = *(_DWORD *)(v8 + 24);
  v7[5] = v6;
