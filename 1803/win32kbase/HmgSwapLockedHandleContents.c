/*
 * XREFs of HmgSwapLockedHandleContents @ 0x1C00C2FE0
 * Callers:
    ...
    if ( v27 )
    {
      if ( (unsigned int)HANDLELOCK::ShareCount((HANDLELOCK *)&v28) == a2 )
      {
        ...
        if ( *(_BYTE *)(v28 + 14) == a5 && (unsigned int)HANDLELOCK::ShareCount((HANDLELOCK *)&v26) == a4 )
        {
          ...
          if ( *(_BYTE *)(v26 + 14) == a5 )
          {
            EntryObject = GdiHandleManager::GetEntryObject((GdiHandleEntryDirectory **)gpHandleManager, v9);
            v14 = GdiHandleManager::GetEntryObject((GdiHandleEntryDirectory **)gpHandleManager, v10);
            GdiHandleManager::SetEntryObject(v15, v9, v14);
            GdiHandleManager::SetEntryObject(v16, v10, EntryObject);
            v17 = *(_QWORD *)(v11 + 16);
            *(_QWORD *)(v11 + 16) = *(_QWORD *)(v12 + 16);
            *(_QWORD *)(v12 + 16) = v17;
            v18 = GdiHandleManager::GetEntryObject((GdiHandleEntryDirectory **)gpHandleManager, v9);
            v19 = GdiHandleManager::GetEntryObject((GdiHandleEntryDirectory **)gpHandleManager, v10);
            v20 = *(_OWORD *)v18;
            v21 = *((_QWORD *)v18 + 2);
