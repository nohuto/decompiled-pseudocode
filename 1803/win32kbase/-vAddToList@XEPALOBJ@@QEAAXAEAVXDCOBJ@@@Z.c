/*
 * XREFs of ?vAddToList@XEPALOBJ@@QEAAXAEAVXDCOBJ@@@Z @ 0x1C003E398
 * Callers:
...
void __fastcall XEPALOBJ::vAddToList(XEPALOBJ *this, struct XDCOBJ *a2)
{
  ...
  else
  {
    ...
    v3 = *(_QWORD *)a2;
    *(_QWORD *)(*(_QWORD *)a2 + 1392LL) = *(_QWORD *)(*(_QWORD *)this + 40LL);
    *(_QWORD *)(*(_QWORD *)this + 40LL) = **(_QWORD **)a2;
    *(_QWORD *)(*(_QWORD *)a2 + 1400LL) = 0LL;
    v4 = *(HDC *)(*(_QWORD *)a2 + 1392LL);
    if ( v4 )
    {
      MDCOBJA::MDCOBJA((MDCOBJA *)v5, v4, v3);
      if ( v5[0] )
      {
        *(_QWORD *)(v5[0] + 1400LL) = **(_QWORD **)a2;
