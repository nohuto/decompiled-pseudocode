/*
 * XREFs of NtUserRegisterManipulationThread @ 0x1C00B8940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserRegisterManipulationThread(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( (PVOID)PsGetCurrentProcess(v10) == gpepCSRSS && v4 != (struct tagTHREADINFO *)gptiTSRequest
      || gbDITInHitTest != 1
      || v4 == gptiRit )
    {
      break;
  ...
  v21 = (PVOID)PsGetCurrentProcess(v20);
  if ( v21 && v21 == g_pepDwm )
  {
