/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0KAAA@$0KA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C0073854
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<40960,160>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = PoolWithTag;
  if ( !PoolWithTag )
    return 0;
  *PoolWithTag = 0LL;
  v10 = lambda_ad03797ec7a38125f83dc9209b66074e_::operator()(v9, 0xFAu);
  if ( !v10 )
    return 0;
