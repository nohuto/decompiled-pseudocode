/*
 * XREFs of ?InsertAt@?$CStructDynamicArray@UPointerCaptureInfo@CInputManager@@@@QEAAJAEBUPointerCaptureInfo@CInputManager@@I@Z @ 0x1C015FA54
 * Callers:
        ...
        unsigned int a3)
{
    ...
    || (v3 = CDynamicArray<InjectManipulationArgs *,2003858261>::Grow(a1), v3 >= 0) )
  {
    ...
    if ( v3 >= 0 )
    {
      v7 = Win32AllocPoolZInit(8uLL, 0x64734344u);
      if ( !v7 )
        v3 = -1073741801;
      if ( v3 < 0 )
      {
