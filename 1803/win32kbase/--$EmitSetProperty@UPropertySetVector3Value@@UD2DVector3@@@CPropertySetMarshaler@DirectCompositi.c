/*
 * XREFs of ??$EmitSetProperty@UPropertySetVector3Value@@UD2DVector3@@@CPropertySetMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@1@I@Z @ 0x1C00081E0
 * Callers:
        ...
        unsigned int a3)
{
  ...
  if ( v12 < 0x28 && !DirectComposition::CBatch::AllocateNewFragment(a2, &v12) )
    return 0;
  DirectComposition::CBatch::EnsureBatchBuffer((struct DirectComposition::CBatch **)a2, 0x28uLL, &v13);
  v8 = (char *)v13;
  *(_DWORD *)v13 = 40;
  *(_QWORD *)(v8 + 4) = 0LL;
  *(_QWORD *)(v8 + 12) = 0LL;
  ...
  *(_QWORD *)(v8 + 28) = *(_QWORD *)(v10 + v9);
  *((_DWORD *)v8 + 9) = *(_DWORD *)(v10 + v9 + 8);
