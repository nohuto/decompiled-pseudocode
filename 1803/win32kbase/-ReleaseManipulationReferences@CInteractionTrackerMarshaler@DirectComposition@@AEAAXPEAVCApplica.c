/*
 * XREFs of ?ReleaseManipulationReferences@CInteractionTrackerMarshaler@DirectComposition@@AEAAXPEAVCApplicationChannel@2@@Z @ 0x1C014DF28
 * Callers:
    ...
    if ( *((_DWORD *)this + 82) )
    {
      do
      {
        DirectComposition::CApplicationChannel::ReleaseResource(
          a2,
          *(struct DirectComposition::CResourceMarshaler **)(*((_QWORD *)this + 40) + 16LL * v5));
        DirectComposition::CApplicationChannel::ReleaseResource(
          a2,
          *(struct DirectComposition::CResourceMarshaler **)(*((_QWORD *)this + 40) + 16LL * v5++ + 8));
      }
      while ( v5 < *((_DWORD *)this + 82) );
      v4 = *((_QWORD *)this + 40);
    }
    Win32FreePool(v4);
    *((_QWORD *)this + 40) = 0LL;
