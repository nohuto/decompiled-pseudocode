/*
 * XREFs of ?MonitorInterfaceCallbackInternal@CMonitorPDO@@AEAAJPEBU_DEVICE_INTERFACE_CHANGE_NOTIFICATION@@@Z @ 0x1C00C0280
 * Callers:
 *     ?MonitorInterfaceCallback@CMonitorPDO@@CAJPEAX0@Z @ 0x1C00C0260 (-MonitorInterfaceCallback@CMonitorPDO@@CAJPEAX0@Z.c)
 * Callees:
