/*
 * XREFs of ?bPEBCacheHandle@@YAHPEAXW4_HANDLECACHETYPE@@PEAT_OBJECTATTR@@PEAU_ENTRY@@PEAVHANDLELOCK@@PEAPEAU_BASEOBJECT@@@Z @ 0x1C003D2F0
 * Callers:
...
LABEL_97:
    ...
    if ( v28 != v16 )
      v25 = 0LL;
    ++*(_BYTE *)(v25 + 13);
    v29 = v18 | (*(unsigned __int16 *)(v25 + 12) << 16);
    *(_QWORD *)v16 = v29;
