/*
 * XREFs of ?SetResourceReferenceArrayProperty@CApplicationChannel@DirectComposition@@QEAAJIIPEBI_K@Z @ 0x1C0016318
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( a5 )
  {
    ...
    if ( v13 >= 0 )
    {
      if ( (int)IsWin32AllocPoolWithQuotaImplSupported() >= 0 )
        v5 = Win32AllocPoolWithQuotaImpl(41LL, v6, 1717715780LL);
      if ( !v5 )
        v13 = -1073741801;
    }
    v14 = 0LL;
  ...
  if ( v13 >= 0 )
  {
    v13 = (*(__int64 (__fastcall **)(struct DirectComposition::CResourceMarshaler *, DirectComposition::CApplicationChannel *, _QWORD, __int64, unsigned __int64, char *))(*(_QWORD *)v11 + 184LL))(
            v11,
            this,
            a3,
            v5,
