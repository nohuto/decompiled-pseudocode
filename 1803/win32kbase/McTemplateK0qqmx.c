/*
 * XREFs of McTemplateK0qqmx @ 0x1C00AEF30
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqmx(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, __int64 a6, char a7)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(a1, &ProcessWindowInfo, &W32kControlGuid, 5u, &v8);
}
