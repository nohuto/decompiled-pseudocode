/*
 * XREFs of NtDCompositionTelemetryTouchInteractionEnd @ 0x1C0143AA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionTelemetryTouchInteractionEnd(unsigned int a1, __int64 *a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( v2 >= 0 )
    {
      v4 = (struct DirectComposition::CApplicationChannel *)Win32AllocPoolWithQuota(24LL, 0x6F744344u);
