/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0BEAAA@$0BEA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C00C0CF8
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<81920,320>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = PoolWithTag;
  if ( !PoolWithTag )
    return 0;
  *PoolWithTag = 0LL;
  v10 = lambda_7576a37b34930bf652a299bd9c3af6f1_::operator()(v9, 0xF0u);
  if ( !v10 )
    return 0;
