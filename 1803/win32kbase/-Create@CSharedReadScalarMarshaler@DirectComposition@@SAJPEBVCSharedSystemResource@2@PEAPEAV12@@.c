/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C015EA70
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C015EC70 (CreateSharedReadScalarMarshaler.c)
 * Callees:
