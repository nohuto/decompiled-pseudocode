/*
 * XREFs of NtDCompositionCreateSharedVisualHandle @ 0x1C0142FA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionCreateSharedVisualHandle(_QWORD *a1)
{
  ...
  Object = 0LL;
  Handle = 0LL;
  SharedResourceObject = CreateSharedResourceObject(0x97u, (struct DirectComposition::ResourceObject **)&Object);
