/*
 * XREFs of ScsiModeSelectRequest @ 0x1C0008EA8
 * Callers:
...
LABEL_10:
  ...
  if ( (v13 < (unsigned int)a3 ? (unsigned int)a3 - v13 : 0) >= 0xC
    && (*v14 & 0x3F) == 8
    && v14[1] == 10
    && (v15 = *(_QWORD *)(a1 + 1112), (*(_BYTE *)(v15 + 525) & 1) != 0) )
  {
    if ( v3 == 40 )
      v16 = *(_QWORD *)(a2 + 104);
    else
    ...
    v17 = 0;
    if ( *(_WORD *)(a1 + 130) > 1u || *(_BYTE *)(a1 + 129) )
      v17 = (*(_BYTE *)(v15 + 520) & 0x10) != 0;
    *(_BYTE *)(v16 + 4253) = *(_BYTE *)(v16 + 4253) & 0xFC | 1;
    ...
    if ( v17 )
    {
      ...
      *(_QWORD *)(v16 + 4224) = NVMeSetFeaturesCachePhase1Completion;
      *(_QWORD *)(v16 + 4232) = v14;
    }
    else
    {
