/*
 * XREFs of ScsiReadWriteRequest @ 0x1C00096E0
 * Callers:
...
__int64 __fastcall ScsiReadWriteRequest(__int64 a1, __int64 a2, unsigned __int8 *a3, __int64 a4, bool *a5)
{
  ...
  v12 = *(_QWORD *)(a1 + 8LL * v11 + 1224);
  v13 = *(_DWORD *)(v12 + 52);
  if ( v13
    && *(_QWORD *)(v12 + 56)
    && ((v14 = *(_WORD *)(v12 + 92), v6 != 40) ? (v15 = *(_DWORD *)(v5 + 12)) : (v15 = *(_DWORD *)(v5 + 24)),
        (v15 & 0xC0) != 0 && (v16 = *(_DWORD *)(v5 + v10)) != 0 && ((v13 - 1) & v16) == 0) )
  {
    *(_BYTE *)(v9 + 4253) = *(_BYTE *)(v9 + 4253) & 0xFC | 2;
    SrbAssignQueueId(a1, v5);
    if ( v11 < *(_DWORD *)(a1 + 156) && (v17 = *(_QWORD *)(a1 + 8LL * v11 + 1224)) != 0 )
      v18 = *(_DWORD *)(v17 + 16);
    else
      v18 = 0;
