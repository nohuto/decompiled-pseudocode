/*
 * XREFs of NVMeQueuesReInit @ 0x1C0004594
 * Callers:
...
void *__fastcall NVMeQueuesReInit(__int64 a1)
{
  ...
  *(_WORD *)(a1 + 376) = 0;
  if ( *(_WORD *)(a1 + 288) )
    v5 = *(unsigned __int16 *)(a1 + 238);
  else
    v5 = *(unsigned __int16 *)(a1 + 236);
  ...
  *(_DWORD *)(a1 + 482) = 0;
  if ( *(_WORD *)(a1 + 480) )
    v8 = *(unsigned __int16 *)(a1 + 238);
  else
    v8 = *(unsigned __int16 *)(a1 + 236);
  ...
  if ( *(_WORD *)(a1 + 236) )
  {
    do
    {
      ...
      result = (void *)*(unsigned __int16 *)(a1 + 236);
      ++v10;
    }
  ...
  if ( *(_WORD *)(a1 + 240) )
  {
    do
    {
      ...
      *(_WORD *)(v13 + 128) = 0;
      v15 = *(void **)v13;
      if ( v14 )
        v16 = *(unsigned __int16 *)(a1 + 236);
      else
        v16 = *(unsigned __int16 *)(a1 + 238);
      v17 = (unsigned int)(v16 << 6) >> 2;
      if ( v17 )
        memset(v15, 0, 4LL * v17);
      result = (void *)*(unsigned __int16 *)(a1 + 240);
      ++v12;
    }
  ...
  if ( *(_WORD *)(a1 + 170) )
  {
    ...
    {
      v24 = v23++;
      *(_QWORD *)(32 * v24 + *(_QWORD *)(a1 + 200) + 24) = 0LL;
      result = (void *)*(unsigned __int16 *)(a1 + 170);
    }
