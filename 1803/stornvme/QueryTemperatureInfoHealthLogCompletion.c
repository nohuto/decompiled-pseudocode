/*
 * XREFs of QueryTemperatureInfoHealthLogCompletion @ 0x1C000C150
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall QueryTemperatureInfoHealthLogCompletion(__int64 a1, __int64 a2)
{
  ...
  if ( *(_BYTE *)(a2 + 3) == 1 )
  {
    ...
    *(_WORD *)(v7 + 40) = v14;
    ...
    {
      v17 = 16LL * i;
      if ( *(unsigned int *)(a2 + v8) < (unsigned __int64)(v17 + 40) )
        break;
      *(_WORD *)(v17 + v7 + 52) = i;
  ...
  v19 = *(_QWORD *)(v5 + 4200);
  if ( v19 )
    result = StorPortExtendedFunction(83LL, a1, v19, *(unsigned int *)(v5 + 4240));
  *(_QWORD *)(v5 + 4200) = 0LL;
  *(_DWORD *)(v5 + 4240) = 0;
  return result;
}
