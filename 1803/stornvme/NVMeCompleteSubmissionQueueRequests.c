/*
 * XREFs of NVMeCompleteSubmissionQueueRequests @ 0x1C0005284
 * Callers:
 *     NVMeHwUnitControl @ 0x1C0001F00 (NVMeHwUnitControl.c)
...
LABEL_12:
          if ( a5 == 1 || a4 == v14 )
          {
            ...
            *(_BYTE *)(v12 + 3) = a7;
            v17 = *(void (__fastcall **)(__int64, __int64, _QWORD))(v16 + 4224);
            if ( v17 )
              v17(a1, v12, 0LL);
