/*
 * XREFs of IoQueuesCreation @ 0x1C0003F00
 * Callers:
  ...
  if ( *(_WORD *)(a1 + 242) )
  {
    ...
    while ( 1 )
    {
      ...
      *(_WORD *)(*(_QWORD *)(a1 + 688) + 4244LL) = 0;
      v8 = *(_QWORD *)(a1 + 688) + 4096LL;
      v9 = 168LL * v4;
      *(_BYTE *)v8 = 5;
      *(_QWORD *)(v8 + 24) = *(_QWORD *)(v9 + *(_QWORD *)(a1 + 560) - 160);
      *(_WORD *)(v8 + 40) = v4;
      *(_WORD *)(v8 + 42) = *(_WORD *)(a1 + 238) - 1;
      v10 = *(_DWORD *)(v8 + 44) | 1;
      *(_DWORD *)(v8 + 44) = v10;
      v11 = *(_BYTE *)(a1 + 16) ? v10 & 0xFFFFFFFD : v10 | 2;
      *(_DWORD *)(v8 + 44) = v11;
      *(_WORD *)(v8 + 46) = *(_WORD *)(v9 + *(_QWORD *)(a1 + 560) - 64);
...
LABEL_8:
    ...
    while ( 1 )
    {
      ...
      *(_BYTE *)(*(_QWORD *)(a1 + 688) + 4253LL) &= ~2u;
      *(_WORD *)(*(_QWORD *)(a1 + 688) + 4244LL) = 0;
      v16 = *(_QWORD *)(a1 + 688) + 4096LL;
      v17 = 136LL * v13;
      *(_BYTE *)v16 = 1;
      *(_QWORD *)(v16 + 24) = *(_QWORD *)(v17 + *(_QWORD *)(a1 + 552) - 128);
      *(_WORD *)(v16 + 40) = v13;
      *(_WORD *)(v16 + 42) = *(_WORD *)(a1 + 238) - 1;
      *(_DWORD *)(v16 + 44) = *(_DWORD *)(v16 + 44) & 0xFFFFFFF8 | 5;
      *(_WORD *)(v16 + 46) = *(_WORD *)(v17 + *(_QWORD *)(a1 + 552) - 86);
      ProcessCommand(a1, a1 + 600);
      LOBYTE(v18) = a2;
      WaitForCommandCompleteWithCustomTimeout(a1, a1 + 600, v18, 10000LL);
      if ( *(_BYTE *)(a1 + 603) != 1 )
        break;
      if ( ++v13 > *(_WORD *)(a1 + 240) )
        return 1;
