/*
 * XREFs of FormInquiryDeviceIdentifiersData @ 0x1C0008074
 * Callers:
 *     ScsiInquiryRequest @ 0x1C00084D0 (ScsiInquiryRequest.c)
 * Callees:
 *     GUIDToSCSINameString @ 0x1C0007FE8 (GUIDToSCSINameString.c)
    ...
    else
    {
      if ( !v26 )
      {
        ...
        *(_QWORD *)(v6 + 22) = *((_QWORD *)v2 + 7);
        if ( (unsigned int)v8 < *(_DWORD *)(a1 + 156) && (v21 = *(_QWORD *)(a1 + 8 * v9 + 1224)) != 0 )
          v22 = *(_DWORD *)(v21 + 16);
        else
          LOWORD(v22) = 0;
