/*
 * XREFs of _QueueGenericWorkItem_::_1_::catch$108 @ 0x180037900
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall QueueGenericWorkItem_::_1_::catch_108(__int64 a1, __int64 a2, __int64 a3, const char *a4)
{
