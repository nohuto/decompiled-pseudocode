/*
 * XREFs of ?UpdateStreamClassPolicyGains@CStreamClassPolicyGainsWrapper@@QEAAJKHPEAH@Z @ 0x180023278
 * Callers:
...
LABEL_24:
        ...
        {
          WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, &WPP_b0c2236d62e53008d04ecf7808c6a7c0_Traceguids, updated);
        }
        AudPolicyLogError("CStreamClassPolicyGainsWrapper::UpdateStreamClassPolicyGains", 189, updated);
