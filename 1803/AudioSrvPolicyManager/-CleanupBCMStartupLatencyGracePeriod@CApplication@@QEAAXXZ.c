/*
 * XREFs of ?CleanupBCMStartupLatencyGracePeriod@CApplication@@QEAAXXZ @ 0x180012DE8
 * Callers:
...
void __fastcall CApplication::CleanupBCMStartupLatencyGracePeriod(const wchar_t **this)
{
  ...
  if ( *((_DWORD *)this + 112) )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x20u, &WPP_16513b4b06ea364292c42252679a25cf_Traceguids, this[3]);
    }
    ...
    *((_DWORD *)this + 112) = 0;
    if ( (unsigned int)CApplication::IsRestrictedBackgroundAudioCapable((CApplication *)this) )
    {
      ...
      while ( v2 )
      {
        v3 = *((_QWORD *)v2 + 2);
        v2 = *(const wchar_t **)v2;
        if ( !*(_DWORD *)(v3 + 472) && *(_DWORD *)(v3 + 520) == 7 )
        {
          *(_QWORD *)(v3 + 520) = 0LL;
          *(_DWORD *)(v3 + 528) = 4;
        }
