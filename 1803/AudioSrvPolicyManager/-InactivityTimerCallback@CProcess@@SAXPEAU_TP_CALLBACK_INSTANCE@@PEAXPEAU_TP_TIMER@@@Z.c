/*
 * XREFs of ?InactivityTimerCallback@CProcess@@SAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x1800157E0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _TP_TIMER *a3)
{
  ...
  if ( v6 < 0 )
  {
    if ( WPP_GLOBAL_Control != (_UNKNOWN *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Eu, &WPP_16513b4b06ea364292c42252679a25cf_Traceguids, v6);
    }
    AudPolicyLogError("CProcess::InactivityTimerCallback", 3523, v6);
  }
}
