/*
 * XREFs of ?SetHasSmtcSubscription@CProcess@@UEAAXW4__MIDL___MIDL_itf_audiosrv_0000_0000_0005@@H@Z @ 0x180015290
 * Callers:
...
void __fastcall CProcess::SetHasSmtcSubscription(__int64 a1, int a2, int a3)
{
  ...
  if ( (unsigned int)v3 <= 1 )
  {
    ...
    {
      v7 = v6 + (a3 != 0 ? 1 : -1);
      *(_DWORD *)(a1 + 4 * v3 + 524) = v7;
      if ( !v7 || v7 == 1 && a3 )
        CApplication::OnSmtcSubscriptionChanged(*(CApplication **)(a1 + 264));
    }
  }
  if ( v9 )
