/*
 * XREFs of ?CreateInstance@CApplication@@SAJPEBG_KKPEAPEAV1@@Z @ 0x1800104B8
 * Callers:
        ...
        struct CApplication **a4)
{
  ...
  v9 = (CApplication *)HeapAlloc(ProcessHeap, 0, 0x270uLL);
  if ( v9 )
...
LABEL_12:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_16513b4b06ea364292c42252679a25cf_Traceguids, v11);
    }
    AudPolicyLogError("CApplication::CreateInstance", 206, v11);
