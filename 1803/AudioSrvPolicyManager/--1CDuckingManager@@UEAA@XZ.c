/*
 * XREFs of ??1CDuckingManager@@UEAA@XZ @ 0x18000BDD4
 * Callers:
  ...
  *((_QWORD *)this + 3) = &CDuckingManager::`vftable'{for `IAudioDuckingManager'};
  ...
  if ( *((_QWORD *)this + 10) )
  {
    ...
    do
    {
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
      {
        ...
        WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v7);
      }
      if ( v4 >= *((_QWORD *)this + 10) )
        ATL::AtlThrowImpl(-2147024809);
  ...
  while ( *((_QWORD *)this + 33) )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
    {
      ...
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xCu, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v9);
    }
    if ( v8 )
    {
      if ( *v8 )
