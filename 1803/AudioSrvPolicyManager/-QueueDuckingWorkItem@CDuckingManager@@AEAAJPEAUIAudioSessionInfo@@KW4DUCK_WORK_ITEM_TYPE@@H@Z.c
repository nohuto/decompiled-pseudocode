/*
 * XREFs of ?QueueDuckingWorkItem@CDuckingManager@@AEAAJPEAUIAudioSessionInfo@@KW4DUCK_WORK_ITEM_TYPE@@H@Z @ 0x18000DBEC
 * Callers:
...
LABEL_26:
  ...
  else
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x31u, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v12);
    }
    AudPolicyLogError("CDuckingManager::QueueDuckingWorkItem", 1072, v12);
  }
LABEL_27:
  if ( v12 < 0 )
    AudPolicyLogError("CDuckingManager::QueueDuckingWorkItem", 1088, v12);
