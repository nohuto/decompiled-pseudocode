/*
 * XREFs of ?PrepareWrite2@?$CSimpleStringT@G$0A@@ATL@@AEAAXH@Z @ 0x18000FB80
 * Callers:
...
__int64 __fastcall ATL::CSimpleStringT<unsigned short,0>::PrepareWrite2(__int64 *a1, signed int a2)
{
  ...
  if ( *(_DWORD *)(*a1 - 16) > a2 )
    v3 = *(_DWORD *)(result - 16);
  if ( *(int *)(result - 8) > 1 )
    return ATL::CSimpleStringT<unsigned short,0>::Fork(a1, v3);
  v5 = *(_DWORD *)(result - 12);
  if ( v5 < v3 )
  {
    if ( v5 <= 0x40000000 )
    ...
    if ( v7 >= v3 )
      v3 = v7;
    return ATL::CSimpleStringT<unsigned short,0>::Reallocate(a1, v3);
  }
  return result;
}
