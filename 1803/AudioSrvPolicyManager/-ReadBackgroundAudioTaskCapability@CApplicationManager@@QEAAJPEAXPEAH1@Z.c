/*
 * XREFs of ?ReadBackgroundAudioTaskCapability@CApplicationManager@@QEAAJPEAXPEAH1@Z @ 0x18001C3B8
 * Callers:
        ...
        int *a4)
{
  ...
  *a4 = 0;
  ...
  if ( v7 >= 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Au, &WPP_864cab9c06643a40d396dbf4a6ced3de_Traceguids, v8);
    }
  }
  CoUninitialize();
  if ( v7 < 0 )
...
LABEL_13:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Bu, &WPP_864cab9c06643a40d396dbf4a6ced3de_Traceguids, v7);
    }
    AudPolicyLogError("CApplicationManager::ReadBackgroundAudioTaskCapability", 1276, v7);
  }
