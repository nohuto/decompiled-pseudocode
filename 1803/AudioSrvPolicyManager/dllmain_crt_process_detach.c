/*
 * XREFs of dllmain_crt_process_detach @ 0x180034C5C
 * Callers:
 ...
 *     __scrt_dllmain_uninitialize_critical @ 0x180035270 (__scrt_dllmain_uninitialize_critical.c)
 *     __scrt_release_startup_lock @ 0x18003544C (__scrt_release_startup_lock.c)
 *     __scrt_uninitialize_crt @ 0x180035470 (__scrt_uninitialize_crt.c)
 *     ?__scrt_uninitialize_type_info@@YAXXZ @ 0x180035688 (-__scrt_uninitialize_type_info@@YAXXZ.c)
