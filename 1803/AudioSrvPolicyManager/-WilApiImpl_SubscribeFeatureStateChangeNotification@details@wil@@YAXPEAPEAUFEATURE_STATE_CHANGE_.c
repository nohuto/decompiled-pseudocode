/*
 * XREFs of ?WilApiImpl_SubscribeFeatureStateChangeNotification@details@wil@@YAXPEAPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@P6AXPEAX@Z1@Z @ 0x1800064C0
 * Callers:
 *     <none>
 * Callees:
  ...
  *this = 0LL;
  if ( a3 != (void (*)(void *))-1LL )
  {
    if ( !wil::details::g_featureStateManager )
      return;
    AcquireSRWLockExclusive(&stru_18004E0C0);
  ...
  {
    AcquireSRWLockExclusive(&stru_18004E0C0);
    if ( !*((_QWORD *)&xmmword_18004E0F0 + 1) )
    {
      v7 = qword_18004E0B8;
      if ( qword_18004E0B8 )
      {
        *((_QWORD *)&xmmword_18004E0F0 + 1) = 0LL;
        AcquireSRWLockExclusive(qword_18004E0B8);
        wil::details_abi::SubscriptionList::SubscribeUnderLock(
          (wil::details_abi::SubscriptionList *)&v7[25],
          (struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ **)&xmmword_18004E0F0 + 1,
    ...
    wil::details_abi::SubscriptionList::SubscribeUnderLock(
      (wil::details_abi::SubscriptionList *)&stru_18004E148,
      this,
      (void (*)(void *))a2,
      0LL);
    if ( *this )
...
LABEL_11:
    ReleaseSRWLockExclusive(&stru_18004E0C0);
  }
}
