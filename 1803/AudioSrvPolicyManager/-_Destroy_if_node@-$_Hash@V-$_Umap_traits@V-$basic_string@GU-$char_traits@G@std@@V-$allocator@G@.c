        ...
        _QWORD *a2)
{
  ...
  *(_QWORD *)(*a2 + 8LL) = a2[1];
  --*(_QWORD *)(a1 + 16);
  return std::_List_buy<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>::_Freenode(a1, a2);
}
