/*
 * XREFs of ?TS_ServiceStart@@YAXXZ @ 0x180027764
 * Callers:
...
void TS_ServiceStart(void)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x34u, &WPP_dd72bf893e0f3e44ea0346400e1f162b_Traceguids);
  }
  if ( !(unsigned __int8)WinStationQueryEnforcementCore(0LL, 0LL, 1LL, &g_MaxSessions, 4, &v1) )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
    {
      ...
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x35u, &WPP_dd72bf893e0f3e44ea0346400e1f162b_Traceguids, LastError);
    }
    g_MaxSessions = 1;
  }
