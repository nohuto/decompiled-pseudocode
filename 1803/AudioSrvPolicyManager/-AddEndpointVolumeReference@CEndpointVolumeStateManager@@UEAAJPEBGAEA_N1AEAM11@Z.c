/*
 * XREFs of ?AddEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x18002DB80
 * Callers:
 *     <none>
 * Callees:
  ...
  try
  {
    ...
    *a6 = 0;
    ...
    if ( !v13 )
    {
      ...
      v16 = (CEndpointVolumeState *)HeapAlloc(ProcessHeap, 0, 0x30uLL);
      if ( v16 )
      ...
      *v21 = v22;
      ...
      {
        if ( *((_BYTE *)v33 + 24) )
          (*(void (__fastcall **)(_QWORD, char *))(**((_QWORD **)v33 + 2) + 240LL))(
            *((_QWORD *)v33 + 2),
            (char *)v33 + 32);
        v25 = v24[2];
        if ( v25 )
