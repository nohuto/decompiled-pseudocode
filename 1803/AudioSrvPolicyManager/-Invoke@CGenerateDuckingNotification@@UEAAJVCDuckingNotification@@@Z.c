/*
 * XREFs of ?Invoke@CGenerateDuckingNotification@@UEAAJVCDuckingNotification@@@Z @ 0x18000D0E0
 * Callers:
 ...
 *     WPP_SF_x @ 0x18000BBE8 (WPP_SF_x.c)
 *     WPP_SF_xd @ 0x18000BC24 (WPP_SF_xd.c)
  ...
  if ( !*(_BYTE *)(a1 + 24) )
  {
    if ( v6 )
    {
      ...
      else
      {
        ...
        WPP_SF_xd(v19[2], 0x24u, a3, *a2, v20[4]);
        v3 = 2;
      }
      if ( (v3 & 2) != 0 && v20 )
...
LABEL_29:
  ...
  if ( *(_DWORD *)(a2[2] - 16LL) )
  {
    ...
    else
    {
      ...
      WPP_SF_xd(v10[2], 0x22u, a3, *a2, v11[4]);
      v3 = 1;
    }
    if ( (v3 & 1) != 0 && v11 )
...
LABEL_18:
  *(_QWORD *)(*(_QWORD *)(a1 + 8) + 48LL) = *a2;
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    v13 = 39;
LABEL_27:
    WPP_SF_D((TRACEHANDLE)v12[2], v13, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, *((_DWORD *)a2 + 2));
LABEL_33:
    v12 = (_UNKNOWN **)WPP_GLOBAL_Control;
  }
  if ( MediaEvent < 0 )
  {
    if ( v12 != &WPP_GLOBAL_Control && (*((_DWORD *)v12 + 7) & 0x8000000) != 0 && *((_BYTE *)v12 + 25) >= 2u )
      WPP_SF_D((TRACEHANDLE)v12[2], 0x2Au, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, MediaEvent);
    AudPolicyLogError("CGenerateDuckingNotification::Invoke", 760, MediaEvent);
  }
LABEL_40:
  v15 = a2[3];
  if ( v15 )
