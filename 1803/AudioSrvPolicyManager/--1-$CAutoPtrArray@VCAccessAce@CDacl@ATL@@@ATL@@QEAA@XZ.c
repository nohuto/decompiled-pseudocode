/*
 * XREFs of ??1?$CAutoPtrArray@VCAccessAce@CDacl@ATL@@@ATL@@QEAA@XZ @ 0x180032584
 * Callers:
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$5 @ 0x18003822D (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$5.c)
 * Callees:
