 ...
 *     ??$_Uninit_alloc_fill_n1@PEAV?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KV?$unique_ptr@UAudioStateMonitor@@U?$default_delete@UAudioStateMonitor@@@wistd@@@wistd@@@std@@@std@@@std@@@std@@_KV?$allocator@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KV?$unique_ptr@UAudioStateMonitor@@U?$default_delete@UAudioStateMonitor@@@wistd@@@wistd@@@std@@@std@@@std@@@std@@@2@@std@@YAPEAV?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KV?$unique_ptr@UAudioStateMonitor@@U?$default_delete@UAudioStateMonitor@@@wistd@@@wistd@@@std@@@std@@@std@@@0@PEAV10@_KAEBV10@AEAV?$allocator@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KV?$unique_ptr@UAudioStateMonitor@@U?$default_delete@UAudioStateMonitor@@@wistd@@@wistd@@@std@@@std@@@std@@@std@@@0@U?$integral_constant@_N$0A@@0@@Z @ 0x180018F94 (--$_Uninit_alloc_fill_n1@PEAV-$_List_unchecked_iterator@V-$_List_val@U-$_List_simple_types@U-$pa.c)
...
_QWORD *__fastcall std::vector<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<std::wstring const,std::unique_ptr<CEndpointVolumeState>>>>>>::assign(
        __int64 a1,
        unsigned __int64 a2,
        unsigned __int64 *a3)
{
        ...
        *(_QWORD *)(a1 + 16) = 0LL;
        if ( v11 )
        {
          if ( v11 > 0x1FFFFFFFFFFFFFFFLL )
            std::vector<unsigned long>::_Xlength();
          v14 = std::_Allocate<std::_Default_allocate_traits<1>>(v11);
          *(_QWORD *)a1 = v14;
          *(_QWORD *)(a1 + 8) = v14;
          *(_QWORD *)(a1 + 16) = *(_QWORD *)a1 + 8 * v11;
        }
        v15 = *(unsigned __int64 **)a1;
LABEL_33:
        result = std::_Uninit_alloc_fill_n1<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned __int64 const,wistd::unique_ptr<AudioStateMonitor,wistd::default_delete<AudioStateMonitor>>>>>> *,unsigned __int64,std::allocator<std::_List_unchecked_iterator<std::_List_val<std::_List_simple_types<std::pair<unsigned __int64 const,wistd::unique_ptr<AudioStateMonitor,wistd::default_delete<AudioStateMonitor>>>>>>>>(
                   v15,
                   v9,
                   a3);
        *(_QWORD *)(a1 + 8) = result;
    ...
    _o__invalid_parameter_noinfo_noreturn(v8, v10, a3, v7);
    __debugbreak();
  }
  v16 = 0LL;
  if ( a2 > v7 )
  {
    ...
    if ( v17 )
    {
      if ( v17 >= 2 && (v4 > a3 || &v4[v17 - 1] < a3) )
      {
        ...
        while ( v16 != v18 );
        v19 = 8 * v18;
        memset64(v4, *a3, v19 >> 3);
        v4 = (unsigned __int64 *)((char *)v4 + v19);
      }
      while ( v16 != v17 )
      {
        ++v16;
  ...
  if ( v21 )
  {
    if ( v21 >= 2 )
    {
      ...
      if ( v4 > a3 || &v4[v21 - 1] < a3 )
      {
        ...
        v4 = (unsigned __int64 *)((char *)v4 + v23);
      }
    }
    while ( v16 != v21 )
    {
