/*
 * XREFs of ?UpdateState@ApplicationSpecificEndpointInfo@@AEAAJW4__MIDL___MIDL_itf_mmdeviceapip_0000_0000_0001@@W4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0001@@PEBG@Z @ 0x1800306B4
 * Callers:
...
LABEL_11:
  ...
  {
    v13 = (unsigned __int16 **)(a1 + 152 + 8LL * (int)a2);
    v14 = *v13;
    if ( *v13 )
    {
      v15 = GetLastError();
