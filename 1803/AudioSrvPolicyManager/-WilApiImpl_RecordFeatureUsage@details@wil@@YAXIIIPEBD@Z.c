/*
 * XREFs of ?WilApiImpl_RecordFeatureUsage@details@wil@@YAXIIIPEBD@Z @ 0x180006390
 * Callers:
 *     <none>
 * Callees:
...
LABEL_16:
  ...
  if ( !v4 )
  {
    if ( !wil::details::g_processShutdownInProgress )
    {
      ...
      {
        wil::details_abi::SubscriptionList::OnSignaled((LPCRITICAL_SECTION)&qword_18004E0B8[25], qword_18004E0B8);
      }
    }
    return;
  }
