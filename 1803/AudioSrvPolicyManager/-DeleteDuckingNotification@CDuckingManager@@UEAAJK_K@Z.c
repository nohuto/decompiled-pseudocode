/*
 * XREFs of ?DeleteDuckingNotification@CDuckingManager@@UEAAJK_K@Z @ 0x18000CF30
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_D @ 0x18000818C (WPP_SF_D.c)
 *     ?AudPolicyLogError@@YAXPEBDHJ@Z @ 0x180008460 (-AudPolicyLogError@@YAXPEBDHJ@Z.c)
 *     WPP_SF_dx @ 0x18000BB98 (WPP_SF_dx.c)
...
LABEL_13:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x21u, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v8);
    }
    AudPolicyLogError("CDuckingManager::DeleteDuckingNotification", 616, v8);
    goto LABEL_18;
  }
  try
  {
