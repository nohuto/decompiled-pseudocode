/*
 * XREFs of ?TsSessionLaunchBackgroundTask@@YAJKPEBG0PEAU_GUID@@@Z @ 0x18002637C
 * Callers:
        ...
        struct _GUID *a4)
{
    ...
    if ( AppFromProcessId )
    {
      ...
      if ( v9 >= 0 )
      {
        ...
        while ( v13 )
        {
          v14 = v13[2];
          v13 = (_QWORD *)*v13;
          if ( *(_DWORD *)(v14 + 216) == a1 && !*(_DWORD *)(v14 + 472) )
          {
            *(struct _GUID *)(v14 + 560) = v12;
            break;
          }
        }
        if ( v17 )
  ...
  if ( v9 < 0 )
  {
    *a4 = GUID_00000000_0000_0000_0000_000000000000;
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Du, &WPP_dd72bf893e0f3e44ea0346400e1f162b_Traceguids, v9);
    }
  }
