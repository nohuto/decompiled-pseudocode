/*
 * XREFs of ?ReleaseEndpointVolumeReference@CEndpointVolumeStateManager@@UEAAJPEBGAEA_N1AEAM11@Z @ 0x18002DE20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?Log_IfFailedMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ @ 0x18002D840 (-Log_IfFailedMsg@in1diag3@details@wil@@YAJPEAXIPEBDJ1ZZ.c)
  ...
  *a6 = 0;
  ...
  if ( v12 )
  {
    ...
    if ( (*((_DWORD *)*v13 + 7))-- == 1 )
    {
      ...
      *a5 = **v13;
      *a7 = *((_BYTE *)v15 + 4);
      v16 = _InterlockedCompareExchange((volatile signed __int32 *)*v13 + 2, 1234, 1234) == 0;
