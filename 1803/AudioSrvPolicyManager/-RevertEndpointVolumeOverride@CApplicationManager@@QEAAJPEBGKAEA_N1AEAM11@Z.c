/*
 * XREFs of ?RevertEndpointVolumeOverride@CApplicationManager@@QEAAJPEBGKAEA_N1AEAM11@Z @ 0x18001EB00
 * Callers:
        ...
        bool *a8)
{
  ...
  {
    WPP_SF_dS(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x34u, &WPP_864cab9c06643a40d396dbf4a6ced3de_Traceguids, a3, a2);
  }
  v18 = 0LL;
  *a4 = 0;
  v11 = a5;
  ...
  *a7 = 0;
  ...
  {
    WPP_SF_dS(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x27u, &WPP_dd72bf893e0f3e44ea0346400e1f162b_Traceguids, a3, a2);
  }
  ...
  if ( v14 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, &WPP_dd72bf893e0f3e44ea0346400e1f162b_Traceguids, v14);
    }
    AudPolicyLogError("TsSessionIdReleaseEndpointVolumeReference", 2227, v14);
  }
  if ( v17 )
