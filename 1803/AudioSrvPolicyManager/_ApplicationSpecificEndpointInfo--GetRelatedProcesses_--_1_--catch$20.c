/*
 * XREFs of _ApplicationSpecificEndpointInfo::GetRelatedProcesses_::_1_::catch$20 @ 0x180037E95
 * Callers:
 *     <none>
 * Callees:
...
void *__fastcall ApplicationSpecificEndpointInfo::GetRelatedProcesses_::_1_::catch_20(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
