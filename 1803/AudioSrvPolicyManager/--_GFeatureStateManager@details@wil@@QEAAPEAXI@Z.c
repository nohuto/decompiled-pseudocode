/*
 * XREFs of ??_GFeatureStateManager@details@wil@@QEAAPEAXI@Z @ 0x180007A9C
 * Callers:
        ...
        wil::details::FeatureStateManager *this)
{
  ...
  *(_BYTE *)this = 0;
  ...
  if ( v8 && qword_18004E0B8 )
    wil::details_abi::SubscriptionList::Unsubscribe((LPCRITICAL_SECTION)&qword_18004E0B8[25], qword_18004E0B8, v8);
