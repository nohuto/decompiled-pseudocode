/*
 * XREFs of ?AddDuckingNotification@CDuckingManager@@UEAAJPEBGK_K@Z @ 0x18000CD50
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_D @ 0x18000818C (WPP_SF_D.c)
 *     ?AudPolicyLogError@@YAXPEBDHJ@Z @ 0x180008460 (-AudPolicyLogError@@YAXPEBDHJ@Z.c)
 *     WPP_SF_Sdx @ 0x18000B970 (WPP_SF_Sdx.c)
...
LABEL_16:
    if ( v11 != &WPP_GLOBAL_Control && (*((_DWORD *)v11 + 7) & 0x8000000) != 0 && *((_BYTE *)v11 + 25) >= 2u )
      WPP_SF_D((TRACEHANDLE)v11[2], 0x1Fu, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v12);
    AudPolicyLogError("CDuckingManager::AddDuckingNotification", 582, v12);
    goto LABEL_21;
  }
  try
  {
