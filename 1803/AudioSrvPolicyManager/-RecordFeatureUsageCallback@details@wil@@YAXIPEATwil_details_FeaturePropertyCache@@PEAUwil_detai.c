/*
 * XREFs of ?RecordFeatureUsageCallback@details@wil@@YAXIPEATwil_details_FeaturePropertyCache@@PEAUwil_details_RecordUsageResult@@@Z @ 0x180006D50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct wil_details_RecordUsageResult *a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( !*((_DWORD *)a3 + 4) && wil::details::g_enabledStateManager )
    {
      ...
      if ( !*((_QWORD *)&xmmword_18004F2A0 + 1) )
      {
        *((_QWORD *)&xmmword_18004F2A0 + 1) = 0LL;
