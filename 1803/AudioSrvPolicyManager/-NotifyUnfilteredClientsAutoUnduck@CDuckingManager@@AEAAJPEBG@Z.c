/*
 * XREFs of ?NotifyUnfilteredClientsAutoUnduck@CDuckingManager@@AEAAJPEBG@Z @ 0x18000DAA0
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  if ( v4 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x30u, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, a2);
    }
    v5 = -1LL;
    do
      ++v5;
