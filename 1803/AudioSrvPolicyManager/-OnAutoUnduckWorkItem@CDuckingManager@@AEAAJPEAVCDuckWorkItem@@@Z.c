/*
 * XREFs of ?OnAutoUnduckWorkItem@CDuckingManager@@AEAAJPEAVCDuckWorkItem@@@Z @ 0x18000E26C
 * Callers:
...
__int64 __fastcall CDuckingManager::OnAutoUnduckWorkItem(CDuckingManager *this, struct CDuckWorkItem *a2)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x34u, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids);
  }
  ...
  else
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      ...
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x35u, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v5);
    }
    v6 = *(__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))a2;
    v12 = 0LL;
    v4 = (**v6)(v6, &GUID_69319164_2df0_4e6b_88e7_2cd561a24381, &v12);
    if ( v4 >= 0 )
    {
      LOBYTE(v7) = 1;
      v4 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD))(*(_QWORD *)v12 + 48LL))(v12, v7, 0LL);
    }
    LeaveCriticalSection((LPCRITICAL_SECTION)((char *)g_ApplicationManager + 32));
    if ( v12 )
  ...
  if ( v4 < 0 )
    AudPolicyLogError("CDuckingManager::OnAutoUnduckWorkItem", 1410, v4);
  return (unsigned int)v4;
}
