/*
 * XREFs of dllmain_crt_process_attach @ 0x180034B40
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x180035284 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x1800353B0 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18003544C (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x180035678 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x180035694 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800356B0 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x1800356C0 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18003580C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x180035A56 (_initterm_0.c)
 *     _initterm_e_0 @ 0x180035A5C (_initterm_e_0.c)
