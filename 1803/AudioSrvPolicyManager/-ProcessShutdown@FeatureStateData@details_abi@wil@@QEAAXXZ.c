/*
 * XREFs of ?ProcessShutdown@FeatureStateData@details_abi@wil@@QEAAXXZ @ 0x180005AE8
 * Callers:
 ...
 * Callees:
 *     ?Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z @ 0x18000483C (-Swap@RawUsageIndex@details_abi@wil@@QEAAXAEAV123@@Z.c)
 ...
 *     ??1UsageIndexes@details_abi@wil@@QEAA@XZ @ 0x180005C08 (--1UsageIndexes@details_abi@wil@@QEAA@XZ.c)
 */
