/*
 * XREFs of ?StartGoodFaithPLMExemptionTimer@CApplication@@IEAAJH@Z @ 0x180011B60
 * Callers:
...
__int64 __fastcall CApplication::StartGoodFaithPLMExemptionTimer(const wchar_t **this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x13u, &WPP_16513b4b06ea364292c42252679a25cf_Traceguids, this[3]);
  }
  if ( !this[48] )
  {
    ...
    if ( v2 < 0 )
    {
      ...
      {
        WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x14u, &WPP_16513b4b06ea364292c42252679a25cf_Traceguids, v2);
      }
      AudPolicyLogError("CApplication::StartGoodFaithPLMExemptionTimer", 1311, v2);
    }
  }
  if ( v7 )
  {
