/*
 * XREFs of IsEUCountry @ 0x18002AD2C
 * Callers:
 ...
 *     ?RaiseException@Details@WRL@Microsoft@@YAXJK@Z @ 0x18002AD10 (-RaiseException@Details@WRL@Microsoft@@YAXJK@Z.c)
