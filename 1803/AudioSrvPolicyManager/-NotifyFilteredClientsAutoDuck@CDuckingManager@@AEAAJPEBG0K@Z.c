/*
 * XREFs of ?NotifyFilteredClientsAutoDuck@CDuckingManager@@AEAAJPEBG0K@Z @ 0x18000D53C
 * Callers:
        ...
        int a4)
{
  ...
  if ( v8 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Bu, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, a2);
    }
    v9 = -1LL;
    do
      ++v9;
      ...
      if ( DuckableSessionsList >= 0 )
      {
        while ( v26 )
        {
            ...
            && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
          {
            ...
            WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Cu, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v17);
          }
          DuckableSessionsList = 0;
          try
          {
    ...
    HeapFree(v19, 0, v14);
    if ( DuckableSessionsList < 0 )
      AudPolicyLogError("CDuckingManager::NotifyFilteredClientsAutoDuck", 842, DuckableSessionsList);
