/*
 * XREFs of ?UnregisterAppVolumePolicyChange@CWindowsPolicyManager@@UEAAJKPEAUIAudioAppVolumePolicyChange@@@Z @ 0x18000A140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowsPolicyManager::UnregisterAppVolumePolicyChange(
        ...
        struct IAudioAppVolumePolicyChange *a3)
{
  ...
  if ( v10 >= 0 )
    v10 = CApplication::UnregisterAppVolumePolicyChange(v8, a3);
  if ( v15 )
