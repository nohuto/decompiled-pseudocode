/*
 * XREFs of ?BeginBCMStartupLatencyGracePeriod@CApplication@@QEAAXXZ @ 0x180012C48
 * Callers:
...
void __fastcall CApplication::BeginBCMStartupLatencyGracePeriod(const wchar_t **this)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Eu, &WPP_16513b4b06ea364292c42252679a25cf_Traceguids, this[3]);
  }
  if ( this[55]
  ...
  if ( v2 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Fu, &WPP_16513b4b06ea364292c42252679a25cf_Traceguids, v2);
    }
    AudPolicyLogError("CApplication::BeginBCMStartupLatencyGracePeriod", 2256, v2);
  }
  if ( v6 )
