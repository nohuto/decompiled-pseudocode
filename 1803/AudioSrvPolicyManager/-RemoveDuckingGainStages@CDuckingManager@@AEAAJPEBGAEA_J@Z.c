/*
 * XREFs of ?RemoveDuckingGainStages@CDuckingManager@@AEAAJPEBGAEA_J@Z @ 0x18000E7F0
 * Callers:
        ...
        __int64 *a3)
{
  ...
  while ( v10 )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      ...
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x38u, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v6);
    }
    v13 = 0LL;
  ...
  if ( DuckableSessionsList < 0 )
LABEL_15:
    AudPolicyLogError("CDuckingManager::RemoveDuckingGainStages", 1646, DuckableSessionsList);
