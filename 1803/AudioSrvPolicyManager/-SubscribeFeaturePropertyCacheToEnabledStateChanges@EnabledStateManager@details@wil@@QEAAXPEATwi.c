/*
 * XREFs of ?SubscribeFeaturePropertyCacheToEnabledStateChanges@EnabledStateManager@details@wil@@QEAAXPEATwil_details_FeaturePropertyCache@@W4wil_FeatureChangeTime@@@Z @ 0x1800067BC
 * Callers:
 ...
 *     ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x1800068D4 (-OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ.c)
        ...
        int a3)
{
  ...
  *((_QWORD *)&v14 + 1) = a2;
  ...
  {
    Ptr = a1[11].Ptr;
    v9 = (char *)a1[12].Ptr - (char *)Ptr;
    if ( Ptr )
    {
      if ( (v9 & (unsigned __int64)-(__int64)(Ptr < a1[12].Ptr)) >= 0x10 )
      {
        *Ptr = v14;
LABEL_10:
      ...
      memset_0(Ptr, 0, v9 & -(__int64)(Ptr < a1[12].Ptr));
