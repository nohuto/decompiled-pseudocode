/*
 * XREFs of ?CreateFromPointer@SemaphoreValue@details_abi@wil@@QEAAJPEBGPEAX@Z @ 0x180002E48
 * Callers:
 ...
 * Callees:
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1800015FC (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
        ...
        unsigned __int64 a3)
{
  ...
  if ( v7 )
    v10 = v6;
  *v10 = 0;
  StringCchCatW(v19, v7, (char *)L"_p0");
  v11 = 1LL;
  v12 = v4 >> 31;
  v13 = v4 & 0x7FFFFFFF;
  if ( v13 )
  ...
  if ( v14 >= 0 )
  {
    StringCchCatW(v19, v15, (char *)L"h");
    if ( (_DWORD)v12 )
      v8 = v12;
    v14 = wil::semaphore_t<wil::details::unique_storage<wil::details::resource_policy<void *,void (*)(void *),&void wil::details::CloseHandle(void *),wistd::integral_constant<unsigned __int64,0>,void *,0,std::nullptr_t>>,wil::err_returncode_policy>::create(
            (char *)this + 8,
  ...
  wil::details::in1diag3::Return_Hr(retaddr, (void *)v17, (__int64)"wil", (const char *)(unsigned int)v14);
  return v16;
}
