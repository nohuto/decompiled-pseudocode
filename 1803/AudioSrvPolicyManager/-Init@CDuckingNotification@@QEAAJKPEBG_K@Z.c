/*
 * XREFs of ?Init@CDuckingNotification@@QEAAJKPEBG_K@Z @ 0x18000CB94
 * Callers:
...
LABEL_11:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Du, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v6);
    }
    AudPolicyLogError("CDuckingNotification::Init", 496, v6);
    return v6;
  }
  if ( !a3 )
    return v6;
