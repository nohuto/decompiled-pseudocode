/*
 * XREFs of ?OnAutoDuckWorkItem@CDuckingManager@@AEAAJPEAVCDuckWorkItem@@@Z @ 0x18000DEFC
 * Callers:
...
__int64 __fastcall CDuckingManager::OnAutoDuckWorkItem(CDuckingManager *this, struct CDuckWorkItem *a2)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x32u, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids);
  }
  ...
  else if ( *((_DWORD *)this + 76) )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      ...
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x33u, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, v5);
    }
    v6 = *(__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))a2;
    v7 = 0LL;
    v22 = 0LL;
    v8 = 0.0;
    v4 = (**v6)(v6, &GUID_69319164_2df0_4e6b_88e7_2cd561a24381, &v22);
    if ( v4 >= 0 )
    {
      ...
      if ( v7 )
        v4 = (*(__int64 (__fastcall **)(__int64, volatile signed __int32 *))(*(_QWORD *)v22 + 40LL))(v22, v7);
      else
        v4 = -2147024882;
      if ( (*(unsigned int (__fastcall **)(__int64))(*(_QWORD *)v22 + 24LL))(v22) )
      {
  ...
  if ( v4 < 0 )
    AudPolicyLogError("CDuckingManager::OnAutoDuckWorkItem", 1282, v4);
