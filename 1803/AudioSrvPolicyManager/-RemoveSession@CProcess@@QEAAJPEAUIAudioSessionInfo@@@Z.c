/*
 * XREFs of ?RemoveSession@CProcess@@QEAAJPEAUIAudioSessionInfo@@@Z @ 0x180014F84
 * Callers:
  ...
  if ( i )
  {
    ...
    catch ( ATL::CAtlException *v11 )
    {
      ...
      if ( v14 < 0 )
      {
        ...
        {
          WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x29u, &WPP_16513b4b06ea364292c42252679a25cf_Traceguids, v14);
        }
        AudPolicyLogError("CProcess::RemoveSession", 3063, v14);
      }
    }
  }
  if ( v13 )
