/*
 * XREFs of ?GetProcessModuleNameAndAppId@@YAJPEAXPEAPEAG1@Z @ 0x18001A4E8
 * Callers:
...
LABEL_11:
    v11 = _AllocStringWorker<CTCoAllocPolicy>(
            ...
            (__int64)a2,
            (const unsigned __int16 *)&word_18003D478,
            0LL,
...
LABEL_19:
  ...
  if ( v11 < 0 )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xAu, &WPP_864cab9c06643a40d396dbf4a6ced3de_Traceguids, v11);
    }
    AudPolicyLogError("GetProcessModuleNameAndAppId", 354, v11);
  }
