/*
 * XREFs of ?NotifyUnfilteredClientsAutoDuck@CDuckingManager@@AEAAJPEBGK@Z @ 0x18000D94C
 * Callers:
        ...
        int a3)
{
  ...
  if ( v6 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x2Fu, &WPP_32edceac6d05362bf9e379e253568d16_Traceguids, a2);
    }
    v7 = -1LL;
    do
      ++v7;
