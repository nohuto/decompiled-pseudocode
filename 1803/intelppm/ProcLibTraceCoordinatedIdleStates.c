/*
 * XREFs of ProcLibTraceCoordinatedIdleStates @ 0x1C00281B4
 * Callers:
...
void __fastcall ProcLibTraceCoordinatedIdleStates(char a1)
{
  ...
  v1 = (unsigned int *)qword_1C001AB18;
  PoolWithTag = 0LL;
  v4 = 0LL;
  if ( qword_1C001AB18 )
  {
    ...
    if ( EtwEventEnabled((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v9) )
    {
      i = 0;
      v10 = 0LL;
      if ( *v1 )
            ...
            if ( v1[v15 + 63] )
            {
              ...
              do
              {
                ...
                *(_QWORD *)&UserData.Size = 4LL;
                ...
                v42 = 0;
                v41 = v24;
                EtwWrite((REGHANDLE)WPP_MAIN_CB.Queue.ListEntry.Blink, v9, 0LL, 7u, &UserData);
                v16 = v27 + 1;
                v27 = v16;
              }
              while ( v16 < v1[v15 + 63] );
