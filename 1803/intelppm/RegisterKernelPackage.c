/*
 * XREFs of RegisterKernelPackage @ 0x1C0031490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 78) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1C001A8B8)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_1C001A608;
  ...
  while ( (__int64 *)v4 != &qword_1C001A608 );
  if ( !v5 )
  {
LABEL_8:
    ...
    *(_DWORD *)(v5 + 32) = v3;
    *(_DWORD *)(v5 + 36) = ((__int64 (__fastcall *)(_QWORD))qword_1C001A8C0)(v3);
    *(_DWORD *)(v5 + 36) += HalPrivateDispatchTable[141](v3);
    *(_QWORD *)(v5 + 24) = v5 + 16;
    *(_QWORD *)(v5 + 16) = v5 + 16;
    v8 = (__int64 *)qword_1C001A610;
    if ( *(__int64 **)qword_1C001A610 != &qword_1C001A608 )
      __fastfail(3u);
    *(_QWORD *)v5 = &qword_1C001A608;
    *(_QWORD *)(v5 + 8) = v8;
    *v8 = v5;
    qword_1C001A610 = v5;
  }
