/*
 * XREFs of PepNotifyQueryCoordinatedStates @ 0x1C00330EC
 * Callers:
...
__int64 __fastcall PepNotifyQueryCoordinatedStates(__int64 a1, PVOID **a2)
{
  ...
  v2 = (unsigned int)dword_1C001AB08;
  v4 = 0LL;
  v5 = 0LL;
  v6 = (unsigned int)(16 * dword_1C001AB08 + 4);
...
LABEL_27:
          ...
          while ( 1 )
          {
            ...
            *v5 = v30;
            v5[1] = v32;
            v5[2] = *(_DWORD *)v31;
            v9 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C001A880)(*(_QWORD *)(a1 + 1088), v5);
            if ( v9 < 0 )
              break;
