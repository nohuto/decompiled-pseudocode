/*
 * XREFs of DriverEntry @ 0x1C0037250
 * Callers:
 ...
 *     EvtDriverUnload @ 0x1C0029E50 (EvtDriverUnload.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_QWORD *)&WPP_MAIN_CB.Type = 0LL;
  ...
  {
    dword_1C001A5D4 = KeQueryActiveProcessorAffinity(&unk_1C001A638);
    KeInitializeAffinityEx(&unk_1C001A8C8);
