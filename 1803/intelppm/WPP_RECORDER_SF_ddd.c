/*
 * XREFs of WPP_RECORDER_SF_ddd @ 0x1C0008790
 * Callers:
 *     ValidateAcpiCStates @ 0x1C0021080 (ValidateAcpiCStates.c)
 *     ValidateAcpiIdleDomain @ 0x1C002AAA8 (ValidateAcpiIdleDomain.c)
 *     ValidateAcpiThrottleStates @ 0x1C002ABF4 (ValidateAcpiThrottleStates.c)
 *     ValidateCoordinatedDependencyOptionsPlatform @ 0x1C002AF08 (ValidateCoordinatedDependencyOptionsPlatform.c)
 *     ValidateCoordinatedDependencyOptionsProcessor @ 0x1C002B018 (ValidateCoordinatedDependencyOptionsProcessor.c)
...
__int64 WPP_RECORDER_SF_ddd(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 1) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 2LL, 1LL, &WPP_885f9b737e553b3972faa1b865470758_Traceguids, v8, (__int64 *)va);
}
