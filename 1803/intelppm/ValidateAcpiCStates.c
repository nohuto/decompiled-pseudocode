/*
 * XREFs of ValidateAcpiCStates @ 0x1C0021080
 * Callers:
...
LABEL_24:
          ...
          case 1:
            return (unsigned int)-1073741823;
          case 2:
            if ( !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001AD9C) )
            {
              v9 = 26;
              goto LABEL_24;
            }
            break;
          default:
            if ( !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001ADB4)
              || !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001AD84)
              || !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001AD9C) )
            {
              v9 = 27;
              goto LABEL_24;
            }
