/*
 * XREFs of ComputeProcessorEnergyMsrEx @ 0x1C00062D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    v80 = 0LL;
    v81 = 0LL;
    v74[0] = (__int64)&qword_1C001A5E8;
    v74[1] = (__int64)&qword_1C001A5E8;
    v74[2] = 0LL;
    ...
    v26 = 1000000 * a3 / (qword_1C001AD68 * (unsigned __int64)(unsigned int)dword_1C001AD60);
    if ( !v26 || !v79 )
      goto LABEL_79;
    v27 = (double)(int)v80;
    if ( v80 < 0 )
...
LABEL_52:
    if ( HIDWORD(WPP_MAIN_CB.Dpc.DpcData) )
    {
      v47 = (double)((int)v26 * (int)qword_1C001AD70);
      if ( v26 * qword_1C001AD70 < 0 )
