/*
 * XREFs of SetGV3PerfStateAndTurboHidden @ 0x1C0004210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SetGV3PerfStateAndTurboHidden(__int64 a1, __int64 a2, unsigned __int16 a3, __int64 a4, char a5)
{
  ...
  v7 = v6;
  HIDWORD(v9) = v6;
  if ( (int)((__int64 (__fastcall *)(__int64, __int64, unsigned __int64, __int64))qword_1C001A8A0)(
              a1,
              409LL,
              ...
              v9) < 0 )
  {
    ...
    ((void (__fastcall *)(_QWORD, __int64, unsigned __int64, __int64))qword_1C001A8A0)(
      v5,
      409LL,
      0xFFFFFFFEFFFF0000uLL,
      v9);
