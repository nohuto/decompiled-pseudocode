/*
 * XREFs of AcpiParseProcessorContainer @ 0x1C002EA68
 * Callers:
 *     AcpiGetCoordinatedLpiStates @ 0x1C002DF7C (AcpiGetCoordinatedLpiStates.c)
 * Callees:
 *     memset @ 0x1C0005280 (memset.c)
 *     GetDevExtByAcpiId @ 0x1C0007B64 (GetDevExtByAcpiId.c)
 *     RtlUnicodeStringCopyString @ 0x1C000ADE0 (RtlUnicodeStringCopyString.c)
