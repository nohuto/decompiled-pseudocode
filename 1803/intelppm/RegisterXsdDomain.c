/*
 * XREFs of RegisterXsdDomain @ 0x1C0020930
 * Callers:
...
char __fastcall RegisterXsdDomain(_QWORD *a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    0LL);
  v6 = qword_1C001A5F8;
  if ( (__int64 *)qword_1C001A5F8 != &qword_1C001A5F8 )
  {
    while ( *(_DWORD *)(v6 + 36) != v1[3] )
    {
      v6 = *(_QWORD *)v6;
      if ( (__int64 *)v6 == &qword_1C001A5F8 )
        goto LABEL_7;
    }
    if ( v4 != *(_BYTE *)(v6 + 48) )
    {
...
LABEL_7:
  ...
  if ( PoolWithTag )
  {
    ...
    *(_QWORD *)(v6 + 24) = v6 + 16;
    *(_QWORD *)(v6 + 16) = v6 + 16;
    v12 = (__int64 *)qword_1C001A600;
    if ( *(__int64 **)qword_1C001A600 != &qword_1C001A5F8 )
      __fastfail(3u);
    *(_QWORD *)v6 = &qword_1C001A5F8;
    *(_QWORD *)(v6 + 8) = v12;
    *v12 = v6;
    qword_1C001A600 = v6;
    *(_DWORD *)(v6 + 36) = v1[3];
