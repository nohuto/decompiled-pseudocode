/*
 * XREFs of PepParkMask @ 0x1C000E770
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  if ( !PepSkipParkNotification && dword_1C001AB00 >= (unsigned int)dword_1C001A5D4 )
  {
    memset(&PepParkLists, 0, (unsigned int)(16 * dword_1C001A5D4));
    v4 = 0;
    KeInitializeEnumerationContext(v11, &unk_1C001A8C8);
    if ( !(unsigned int)KeEnumerateNextProcessor(&v12, v11) )
    {
      ...
      if ( v4 )
      {
        ...
        v8 = v4;
        v10 = &PepParkLists;
        v7 = ((__int64 (__fastcall *)(_QWORD, unsigned int *))qword_1C001A868)(*(_QWORD *)(v6 + 1088), &v8);
        if ( v7 < 0 )
        {
          WPP_RECORDER_SF_D(
