/*
 * XREFs of CpcHighestNotifyWorker @ 0x1C002A4F0
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C002A7B0 (CpcNativeInterruptWorker.c)
 *     AcpiCppcHighestNotifyWorker @ 0x1C002D7D0 (AcpiCppcHighestNotifyWorker.c)
 * Callees:
  ...
  if ( v8 )
  {
      ...
      && (*(int (__fastcall **)(_QWORD, _QWORD))(qword_1C001AAD8 + 104))(*(_QWORD *)(qword_1C001AAD8 + 56), 0LL) >= 0 )
    {
      ...
      *(_DWORD *)(v8 + 68) = v13;
      ...
      ((void (__fastcall *)(_DWORD *))qword_1C001A7E0)(v19);
