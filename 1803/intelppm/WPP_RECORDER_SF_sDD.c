/*
 * XREFs of WPP_RECORDER_SF_sDD @ 0x1C00097C0
 * Callers:
 *     ValidatePssCore @ 0x1C0022AB8 (ValidatePssCore.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_sDD(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, const char *a6, ...)
{
  ...
  if ( !a6 )
    v6 = "NULL";
  LOWORD(v13) = 42;
  return WppAutoLogTrace(a1, 2LL, 1LL, &WPP_885f9b737e553b3972faa1b865470758_Traceguids, v13, v6);
}
