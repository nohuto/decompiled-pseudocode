/*
 * XREFs of InitAcpi1ThrottleStates @ 0x1C0021384
 * Callers:
 *     InitAcpiThrottleStates @ 0x1C00212B4 (InitAcpiThrottleStates.c)
 * Callees:
 *     memset @ 0x1C0005280 (memset.c)
 *     IsValidAcpiGenericAddress @ 0x1C0021414 (IsValidAcpiGenericAddress.c)
 */
...
__int64 __fastcall InitAcpi1ThrottleStates(__int64 a1)
{
  ...
  v1 = 0;
  if ( ((unsigned int)dword_1C001A5D4 <= 1 || (*(_DWORD *)(a1 + 264) & 0x200000) != 0)
    && (*(_DWORD *)(a1 + 264) & 0x100000) != 0
    && (v3 = a1 + 184, (unsigned __int8)IsValidAcpiGenericAddress(a1 + 184))
    && (unsigned __int8)(byte_1C001ADC6 - 1) <= 3u
    && (unsigned __int8)byte_1C001ADC6 + (unsigned int)(unsigned __int8)byte_1C001ADC7 <= 0x20 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1072), 4u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1076), 4u);
    v5 = 1 << byte_1C001ADC6;
    PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)(20 * (1 << byte_1C001ADC6) + 4), 0x72637250u);
      ...
      **(_DWORD **)(a1 + 472) = v5;
      if ( v5 > 1 )
      {
        ...
        do
        {
          ...
          *(_DWORD *)(v9 + v8 - 4) = (v10 << byte_1C001ADC7) | 0x10;
        }
        while ( v7 < v5 );
      }
