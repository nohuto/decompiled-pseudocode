/*
 * XREFs of ProcLibTraceInvalidPowerCurve @ 0x1C0037670
 * Callers:
...
BOOLEAN __fastcall ProcLibTraceInvalidPowerCurve(const struct _TlgProvider_t *a1, unsigned int a2, const void *a3)
{
  ...
  _BYTE var30[56]; // [rsp+A0h] [rbp+27h] BYREF

  v3 = a2;
  result = (unsigned __int8)a3;
  v5 = (char)a1;
  if ( a2 )
    result = (unsigned __int8)memmove(var30, a3, 4LL * a2);
  if ( (unsigned int)dword_1C0015060 > 5 )
  {
    ...
    if ( result )
    {
      ...
      v19 = 2;
      v22 = 4 * v3;
      return TlgWrite((TraceLoggingHProvider)var30, &unk_1C00111D9, v6, v7, 6u, &pData);
    }
  }
  return result;
}
