/*
 * XREFs of InitEnergyCountersMsrEx @ 0x1C0027780
 * Callers:
 ...
 *     ActivateFixedFunctionCounters @ 0x1C0006250 (ActivateFixedFunctionCounters.c)
 */
...
_DWORD *InitEnergyCountersMsrEx()
{
  ...
  if ( !v1 )
  {
    ...
    *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type |= 0x40u;
    qword_1C001AC58[0] = (__int64)SnapEnergyCounters;
    result = ComputeProcessorEnergyMsrEx;
    qword_1C001AC50[0] = (__int64)ComputeProcessorEnergyMsrEx;
  }
  return result;
}
