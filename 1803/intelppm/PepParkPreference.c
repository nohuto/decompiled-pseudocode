/*
 * XREFs of PepParkPreference @ 0x1C000E8C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  result = (unsigned int)dword_1C001AB00;
      ...
      if ( a3 > (unsigned int)result && a3 < v10 )
      {
        ...
        if ( !(_DWORD)result )
        {
          do
          {
            ...
            v14 = v21;
            v15 = 2LL * v13;
            v12 = *((_QWORD *)&WPP_MAIN_CB.Queue.ListEntry.Flink->Flink + v21);
          ...
          if ( v13 && v12 )
          {
            ...
            v23[1] = v13;
            v24 = &PepParkLists;
            v18 = ((__int64 (__fastcall *)(_QWORD, _DWORD *))qword_1C001A860)(*(_QWORD *)(v12 + 1088), v23);
            if ( v18 < 0 )
