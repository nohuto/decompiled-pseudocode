/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C002C760
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C002D1F8 (DecodeDoorbellAddressIo.c)
 */
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  v17 = qword_1C001AA40;
  v18 = dword_1C001AA48;
  if ( (unsigned __int8)qword_1C001AA40 <= 1u )
  {
    v4 = qword_1C001AA38;
    v5 = qword_1C001AA30;
    v15 = 0LL;
    if ( (_BYTE)qword_1C001AA40 == 1 )
    {
  ...
  {
    LODWORD(v21[0]) = 0;
    HIDWORD(v21[0]) = dword_1C001A9F0;
    v21[2] = qword_1C001AA20;
    LODWORD(v21[3]) = dword_1C001AA28;
    v21[6] = v5 << v3;
    v21[5] = v4 << v3;
