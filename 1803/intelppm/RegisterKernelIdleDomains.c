/*
 * XREFs of RegisterKernelIdleDomains @ 0x1C001FFC8
 * Callers:
...
__int64 __fastcall RegisterKernelIdleDomains(_QWORD *a1)
{
  ...
  _BYTE v24[24]; // [rsp+28h] [rbp-91h] BYREF
...
LABEL_22:
    ...
    KeOrAffinityEx(*(_QWORD *)(32LL * v19 + a1[87] + 16) + 48LL, v25, v25);
LABEL_21:
    v18 = i;
    goto LABEL_22;
  }
