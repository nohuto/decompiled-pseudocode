/*
 * XREFs of ProcLibDeviceStart @ 0x1C001EF5C
 * Callers:
...
__int64 __fastcall ProcLibDeviceStart(__int64 a1)
{
  ...
  _BYTE v59[8]; // [rsp+B0h] [rbp-58h] BYREF
  __int64 v60; // [rsp+B8h] [rbp-50h] BYREF
  _QWORD v61[3]; // [rsp+C0h] [rbp-48h] BYREF
  __int64 v62; // [rsp+D8h] [rbp-30h] BYREF
  unsigned __int64 v63; // [rsp+E0h] [rbp-28h]
  ...
  *(_DWORD *)(a1 + 48) = HIDWORD(v63);
  *(_DWORD *)(a1 + 52) = v62;
  v4 = ((__int64 (__fastcall *)(__int64))qword_1C001A9A8)(a1);
  v5 = v4;
  if ( v4 < 0 )
  {
    *(_QWORD *)(a1 + 264) = 0LL;
  ...
  v61[2] = 0LL;
  v61[1] = &DEVPKEY_Device_BiosDeviceName;
  v61[0] = 24LL;
  ...
  *(_BYTE *)(a1 + 1145) = 1;
  ...
  if ( qword_1C001A6F8 )
  {
    v12 = AcpiEval_OSC(a1, (_DWORD *)qword_1C001A6F8, v11, &v55);
    if ( v12 >= 0 )
    {
      v13 = *v55;
      if ( (*v55 & 0xE) == 0 )
      ...
      if ( (v13 & 4) != 0 )
        WPP_RECORDER_SF_DDDDDDDDDDD(
          (__int64)WPP_GLOBAL_Control->DeviceExtension,
          *(unsigned __int8 *)(qword_1C001A6F8 + 13),
          *(unsigned __int8 *)(qword_1C001A6F8 + 12),
          *(unsigned __int8 *)(qword_1C001A6F8 + 11),
          Type);
      if ( (v13 & 8) == 0 )
      {
LABEL_33:
      ...
      v15 = 2;
      v16 = 1;
      Sizeb[0] = *(_DWORD *)(qword_1C001A6F8 + 16);
LABEL_32:
      WPP_RECORDER_SF_D(
        (__int64)WPP_GLOBAL_Control->DeviceExtension,
        v15,
...
LABEL_34:
  if ( qword_1C001A6F0 )
    AcpiEval_PDC(a1, qword_1C001A6F0, (unsigned __int16)word_1C001A700);
LABEL_36:
  ...
  if ( !qword_1C001A708 || (v33 = qword_1C001A708(a1), v5 = v33, v33 >= 0) )
  {
    if ( dword_1C001A9EC == 1 )
      goto LABEL_104;
    v35 = *(_QWORD *)(a1 + 264);
    if ( (v35 & 0x60000000) != 0 && *(_BYTE *)(a1 + 392) == 127 )
    {
      if ( (v35 & 0x20000000) != 0 )
      {
        *(_QWORD *)(a1 + 280) = qword_1C001A728;
        *(_QWORD *)(a1 + 296) = qword_1C001A738;
      }
      if ( (v35 & 0x40000000) == 0 )
        goto LABEL_91;
      v35 &= ~0x400000uLL;
...
LABEL_91:
    if ( (v35 & 0x4000000) != 0 )
      *(_QWORD *)(a1 + 312) = qword_1C001A750;
    if ( (v35 & 0xA8000000) != 0 )
    {
      *(_QWORD *)(a1 + 328) = qword_1C001A760;
      *(_QWORD *)(a1 + 336) = qword_1C001A768;
    }
    v36 = *(_BYTE *)(a1 + 448);
    if ( (v35 & 0x2000000) != 0 && v36 == 127 )
    {
      *(_QWORD *)(a1 + 288) = qword_1C001A730;
      *(_QWORD *)(a1 + 304) = qword_1C001A740;
    }
...
LABEL_104:
    ...
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      *(_QWORD *)(a1 + 208),
      0LL);
    v37 = ((__int64 (__fastcall *)(__int64))qword_1C001A970)(a1);
    ...
    else
    {
      if ( byte_1C001A9E8 )
      {
        if ( !(unsigned int)((__int64 (__fastcall *)(__int64))qword_1C001A9B0)(a1) )
          goto LABEL_129;
        goto LABEL_139;
      }
      v44 = 1;
...
LABEL_129:
      if ( (int)ValidatePerfDomainSymmetry(a1) >= 0 )
      {
        ...
        {
          ((void (__fastcall *)(__int64))qword_1C001A9A0)(a1);
        }
        else if ( (v45 & 0x8000000) != 0 )
        {
          ((void (__fastcall *)(__int64))qword_1C001A998)(a1);
        }
        else if ( (v45 & 0x80000000) != 0 )
        {
          ((void (__fastcall *)(__int64))qword_1C001A990)(a1);
        }
        else
        {
          v46 = (void (__fastcall *)(__int64))qword_1C001A978;
          if ( (*(_QWORD *)(a1 + 264) & 0x73300000LL) == 0 )
            v46 = (void (__fastcall *)(__int64))qword_1C001A988;
          v46(a1);
        }
      }
    }
LABEL_139:
    if ( (*(_QWORD *)(a1 + 264) & 0x2000000000LL) != 0 && ++dword_1C001AD60 == dword_1C001A5D4 )
...
LABEL_145:
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, (const EVENT_DESCRIPTOR *)qword_1C001A9C8, 0, 0LL);
    v47 = *(_DWORD *)(a1 + 256);
    v48 = *(_QWORD *)(a1 + 264);
  }
  v49 = v47 & 0x40000000;
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, (const EVENT_DESCRIPTOR *)qword_1C001A9D0, 0, 0LL);
    v47 = *(_DWORD *)(a1 + 256);
    v48 = *(_QWORD *)(a1 + 264);
  }
  if ( ((unsigned int)v48 & v47 & 0x3300000) != (unsigned __int64)(v47 & 0x3300000) )
  {
    ProcLibTraceProcessorSpecificEvent(a1, (const EVENT_DESCRIPTOR *)qword_1C001A9D8, 0, 0LL);
    v47 = *(_DWORD *)(a1 + 256);
    v48 = *(_QWORD *)(a1 + 264);
  }
