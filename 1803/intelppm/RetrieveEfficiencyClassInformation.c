/*
 * XREFs of RetrieveEfficiencyClassInformation @ 0x1C0022DE0
 * Callers:
 ...
 *     GetProcessorEfficiencyClass @ 0x1C00238D4 (GetProcessorEfficiencyClass.c)
 */
...
__int64 RetrieveEfficiencyClassInformation()
{
  ...
  qword_1C001AB58 = 0LL;
  InitializeEnumerationContext((__int64)&qword_1C001A5E8, 32, (__int64)v7);
...
LABEL_5:
  ...
  dword_1C001AB54 = 1;
  qword_1C001AB58 = 0LL;
  LODWORD(qword_1C001AB58) = dword_1C001A5D4;
  return v5;
}
