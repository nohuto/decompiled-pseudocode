/*
 * XREFs of RegisterIdleDomain @ 0x1C0030D80
 * Callers:
...
bool __fastcall RegisterIdleDomain(__int64 a1, unsigned int a2)
{
  ...
  {
    v6 = qword_1C001A618;
    if ( (__int64 *)qword_1C001A618 == &qword_1C001A618 )
      goto LABEL_6;
    do
    {
      v7 = v6;
    ...
    while ( (__int64 *)v6 != &qword_1C001A618 );
    if ( !v7 )
    {
LABEL_6:
      ...
      *(_QWORD *)(v7 + 24) = v7 + 16;
      *(_QWORD *)(v7 + 16) = v7 + 16;
      v9 = (__int64 *)qword_1C001A620;
      if ( *(__int64 **)qword_1C001A620 != &qword_1C001A618 )
        __fastfail(3u);
      *(_QWORD *)v7 = &qword_1C001A618;
      *(_QWORD *)(v7 + 8) = v9;
      *v9 = v7;
      qword_1C001A620 = v7;
