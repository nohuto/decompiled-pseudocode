/*
 * XREFs of DeactivateFixedFunctionCounters @ 0x1C000688C
 * Callers:
 *     SnapEnergyCounters @ 0x1C0006900 (SnapEnergyCounters.c)
 *     UnInitEnergyCounters @ 0x1C0027940 (UnInitEnergyCounters.c)
 * Callees:
 *     <none>
 */
