/*
 * XREFs of ProcLibDeviceStart @ 0x1C0026E8C
 * Callers:
 ...
 *     AcpiEval_PDC @ 0x1C00231BC (AcpiEval_PDC.c)
...
__int64 __fastcall ProcLibDeviceStart(__int64 a1)
{
  ...
  _QWORD v59[2]; // [rsp+98h] [rbp-70h] BYREF
  ...
  *(_DWORD *)(a1 + 52) = v64;
  v4 = ((__int64 (__fastcall *)(__int64))qword_1C00117E8)(a1);
  v5 = v4;
  if ( v4 < 0 )
  {
    *(_QWORD *)(a1 + 264) = 0LL;
  ...
  *(_BYTE *)(a1 + 1145) = 1;
  ...
  if ( qword_1C0011538 )
  {
    v12 = AcpiEval_OSC(a1, (_DWORD *)qword_1C0011538, v11, &v57);
    if ( v12 >= 0 )
    {
      v13 = *v57;
      if ( (*v57 & 0xE) == 0 )
      ...
      if ( (v13 & 4) != 0 )
        WPP_RECORDER_SF_DDDDDDDDDDD(
          (__int64)WPP_GLOBAL_Control->DeviceExtension,
          *(unsigned __int8 *)(qword_1C0011538 + 13),
          *(unsigned __int8 *)(qword_1C0011538 + 12),
          *(unsigned __int8 *)(qword_1C0011538 + 11),
          Type);
      if ( (v13 & 8) == 0 )
      {
LABEL_33:
      ...
      v15 = 2;
      v16 = 1;
      Sizeb[0] = *(_DWORD *)(qword_1C0011538 + 16);
LABEL_32:
      WPP_RECORDER_SF_D(
        (__int64)WPP_GLOBAL_Control->DeviceExtension,
        v15,
...
LABEL_34:
  if ( qword_1C0011530 )
    AcpiEval_PDC(a1, (const void *)qword_1C0011530, word_1C0011540);
LABEL_36:
  ...
  if ( !qword_1C0011548 || (v33 = qword_1C0011548(a1), v5 = v33, v33 >= 0) )
  {
    if ( dword_1C001182C == 1 )
    {
LABEL_104:
      ...
      if ( (*(_DWORD *)(a1 + 264) & 0x7B07F070) == 0 || (v5 = AcquireAcpiInterfaces(a1), v5 >= 0) )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
          ...
          *(_QWORD *)(a1 + 208),
          0LL);
        v39 = ((__int64 (__fastcall *)(__int64))qword_1C00117B0)(a1);
        ...
        if ( (*(_QWORD *)(a1 + 264) & 0x10FF300000LL) != 0 )
        {
          if ( *(_QWORD *)(a1 + 520) )
            ...
            v46 = !byte_1C0011828 || (unsigned int)((__int64 (__fastcall *)(__int64))qword_1C00117F0)(a1) == 0;
          if ( v46 && (int)ValidatePerfDomainSymmetry(a1) >= 0 )
          {
            v47 = *(_QWORD *)(a1 + 264);
            if ( (v47 & 0x1000000000LL) != 0 )
            {
              ((void (__fastcall *)(__int64))qword_1C00117E0)(a1);
            }
            else if ( (v47 & 0x8000000) != 0 )
            {
              ((void (__fastcall *)(__int64))qword_1C00117D8)(a1);
            }
            else if ( (v47 & 0x80000000) != 0 )
            {
              ((void (__fastcall *)(__int64))qword_1C00117D0)(a1);
            }
            else
            {
              v48 = (void (__fastcall *)(__int64))qword_1C00117B8;
              if ( (*(_QWORD *)(a1 + 264) & 0x73300000LL) == 0 )
                v48 = (void (__fastcall *)(__int64))qword_1C00117C8;
              v48(a1);
            }
          }
        }
        if ( (*(_QWORD *)(a1 + 264) & 0x2000000000LL) != 0 && ++dword_1C0011BA0 == dword_1C0011414 )
    ...
    if ( (v35 & 0x60000000) != 0 && *(_BYTE *)(a1 + 392) == 127 )
    {
      if ( (v35 & 0x20000000) != 0 )
      {
        *(_QWORD *)(a1 + 280) = qword_1C0011568;
        *(_QWORD *)(a1 + 296) = qword_1C0011578;
      }
      if ( (v35 & 0x40000000) == 0 )
        goto LABEL_91;
      v35 &= ~0x400000uLL;
...
LABEL_91:
    if ( (v35 & 0x4000000) != 0 )
      *(_QWORD *)(a1 + 312) = qword_1C0011590;
    if ( (v35 & 0xA8000000) != 0 )
    {
      *(_QWORD *)(a1 + 328) = qword_1C00115A0;
      *(_QWORD *)(a1 + 336) = qword_1C00115A8;
    }
    v36 = *(_BYTE *)(a1 + 448);
    if ( (v35 & 0x2000000) != 0 && v36 == 127 )
    {
      *(_QWORD *)(a1 + 288) = qword_1C0011570;
      *(_QWORD *)(a1 + 304) = qword_1C0011580;
    }
...
LABEL_148:
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, (const EVENT_DESCRIPTOR *)qword_1C0011808, 0, 0LL);
    v49 = *(_DWORD *)(a1 + 256);
    v50 = *(_QWORD *)(a1 + 264);
  }
  v51 = v49 & 0x40000000;
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, (const EVENT_DESCRIPTOR *)qword_1C0011810, 0, 0LL);
    v49 = *(_DWORD *)(a1 + 256);
    v50 = *(_QWORD *)(a1 + 264);
  }
  if ( ((unsigned int)v50 & v49 & 0x3300000) != (unsigned __int64)(v49 & 0x3300000) )
  {
    ProcLibTraceProcessorSpecificEvent(a1, (const EVENT_DESCRIPTOR *)qword_1C0011818, 0, 0LL);
    v49 = *(_DWORD *)(a1 + 256);
    v50 = *(_QWORD *)(a1 + 264);
  }
