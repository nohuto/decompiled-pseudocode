/*
 * XREFs of RetrieveEfficiencyClassInformation @ 0x1C0030464
 * Callers:
...
__int64 RetrieveEfficiencyClassInformation()
{
  ...
  qword_1C0011998 = 0LL;
  InitializeEnumerationContext((__int64)&qword_1C0011428, 32, (__int64)v11);
...
LABEL_12:
  ...
  dword_1C0011994 = 1;
  qword_1C0011998 = 0LL;
  LODWORD(qword_1C0011998) = dword_1C0011414;
