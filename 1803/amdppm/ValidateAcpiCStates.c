/*
 * XREFs of ValidateAcpiCStates @ 0x1C002E98C
 * Callers:
...
LABEL_24:
          ...
          case 1:
            return (unsigned int)-1073741823;
          case 2:
            if ( !IsValidAcpiGenericAddress((char *)&dword_1C0011BDC) )
            {
              v8 = 26;
              goto LABEL_24;
            }
            break;
          default:
            if ( !IsValidAcpiGenericAddress((char *)&dword_1C0011BF4)
              || !IsValidAcpiGenericAddress((char *)&dword_1C0011BC4)
              || !IsValidAcpiGenericAddress((char *)&dword_1C0011BDC) )
            {
              v8 = 27;
              goto LABEL_24;
            }
