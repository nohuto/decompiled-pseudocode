/*
 * XREFs of AcquirePccInterface @ 0x1C0021124
 * Callers:
...
__int64 __fastcall AcquirePccInterface(__int64 a1)
{
  ...
  if ( v3 >= 0 )
  {
    v3 = -1073741811;
    v4 = -1073741811;
    if ( *(_DWORD *)qword_1C00118E0 != 609239875 )
    {
      v5 = 43;
LABEL_5:
      WPP_RECORDER_SF_(
...
LABEL_22:
      ((void (__fastcall *)(__int64))qword_1C00118B0)(qword_1C00118A0);
      memset(&unk_1C0011898, 0, 0x80uLL);
      goto LABEL_24;
    }
    if ( *(_WORD *)(qword_1C00118E0 + 4) < 0x28u )
    {
      v5 = 44;
      goto LABEL_5;
    }
    v6 = *(_BYTE *)(qword_1C00118E0 + 6);
    if ( (v6 || *(_BYTE *)(qword_1C00118E0 + 7) < 6u) && (v6 != 1 || *(_BYTE *)(qword_1C00118E0 + 7)) )
    {
      WPP_RECORDER_SF_(
        (__int64)WPP_GLOBAL_Control->DeviceExtension,
        2u,
    ...
    {
      v7 = *(_DWORD *)(qword_1C00118E0 + 36);
      if ( v7 > *(_DWORD *)(qword_1C00118E0 + 28) )
      {
        v5 = 46;
        goto LABEL_5;
      }
      if ( *(_DWORD *)(qword_1C00118E0 + 32) > v7 )
      {
        v5 = 47;
        goto LABEL_5;
      }
