/*
 * XREFs of InitAcpiLegacyPcc @ 0x1C002D60C
 * Callers:
...
__int64 __fastcall InitAcpiLegacyPcc(_QWORD *a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    if ( qword_1C00118E0 )
    {
      if ( *v5 <= (unsigned int)(dword_1C00118E8 - 4) )
      {
        if ( v5[1] <= (unsigned int)(dword_1C00118E8 - 4) )
        {
          v3 = 0;
          if ( (unsigned int)(dword_1C00118DC - 1) > 0x26 )
          {
LABEL_20:
