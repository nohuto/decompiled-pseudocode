/*
 * XREFs of RegisterKernelPepIdleStatesV2 @ 0x1C001CC58
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStatesV2(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 48) = 0LL;
  *(_DWORD *)(a3 + 40) = 0;
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(v13 + 2504))(v12, qword_1C0011420, 0LL);
  *(_BYTE *)(a1 + 1145) = 0;
  v37[1] = 0x100000000LL;
  v15 = 0LL;
  v37[0] = 127LL;
...
LABEL_22:
  ...
  if ( v21 != (unsigned int *)v37 )
    *(_QWORD *)v16 = v21;
  if ( (int)DecodeAcpi2CState(a1, (_DWORD)v21, 0, (unsigned int)&v33, v16) >= 0 )
  {
