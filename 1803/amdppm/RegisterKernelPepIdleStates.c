/*
 * XREFs of RegisterKernelPepIdleStates @ 0x1C001C90C
 * Callers:
...
__int64 __fastcall RegisterKernelPepIdleStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  unsigned __int8 v27; // [rsp+30h] [rbp-79h] BYREF
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C0011418,
    0LL);
  if ( !dword_1C0011948 || PlatformStatesRegistered )
  {
    v7 = 0;
  }
  else
  {
    ...
    HIDWORD(v30[0]) = dword_1C0011948;
    v7 = ((__int64 (__fastcall *)(_QWORD *))qword_1C0011648)(v30);
    if ( v7 >= 0 )
    {
...
LABEL_27:
  ...
  if ( v17 != (unsigned int *)v31 )
    *v14 = v17;
  if ( (int)DecodeAcpi2CState(a1, (_DWORD)v17, 0, (unsigned int)&v27, (__int64)v14) >= 0 )
  {
    if ( !*v14 && (*v15 & 0x78u) > 8 )
    {
      *v13 |= 0x40000000u;
