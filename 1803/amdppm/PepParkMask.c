/*
 * XREFs of PepParkMask @ 0x1C0009520
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  if ( !PepSkipParkNotification && dword_1C0011940 >= (unsigned int)dword_1C0011414 )
  {
    memset(&PepParkLists, 0, (unsigned int)(16 * dword_1C0011414));
    v4 = 0;
    KeInitializeEnumerationContext(v11, &unk_1C0011708);
    if ( !(unsigned int)KeEnumerateNextProcessor(&v12, v11) )
    {
      ...
      if ( v4 )
      {
        ...
        v8 = v4;
        v10 = &PepParkLists;
        v7 = ((__int64 (__fastcall *)(_QWORD, unsigned int *))qword_1C00116A8)(*(_QWORD *)(v6 + 1088), &v8);
        if ( v7 < 0 )
        {
          WPP_RECORDER_SF_D(
