/*
 * XREFs of DriverEntry @ 0x1C0031168
 * Callers:
 ...
 *     EvtDriverUnload @ 0x1C001C340 (EvtDriverUnload.c)
...
LABEL_3:
  ...
  dword_1C0011414 = KeQueryActiveProcessorAffinity(&unk_1C0011478);
  KeInitializeAffinityEx(&unk_1C0011708);
