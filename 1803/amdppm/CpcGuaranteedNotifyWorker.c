/*
 * XREFs of CpcGuaranteedNotifyWorker @ 0x1C0022358
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C00222E0 (CpcNativeInterruptWorker.c)
 *     AcpiCppcGuaranteedNotifyWorker @ 0x1C0026890 (AcpiCppcGuaranteedNotifyWorker.c)
 * Callees:
 *     ReadGenAddrMaybeHidden @ 0x1C0003678 (ReadGenAddrMaybeHidden.c)
 *     WPP_RECORDER_SF_s @ 0x1C0003994 (WPP_RECORDER_SF_s.c)
 *     ProcLibTracePccCapChange @ 0x1C00090DC (ProcLibTracePccCapChange.c)
    ...
    if ( *(_BYTE *)(v7 + 99) )
    {
        ...
        && (*(int (__fastcall **)(_QWORD, _QWORD))(qword_1C0011918 + 104))(*(_QWORD *)(qword_1C0011918 + 56), 0LL) >= 0 )
      {
        ...
        *(_DWORD *)(v7 + 84) = v12;
        ...
        {
          ProcLibCapChange(v5, *(unsigned int *)(v5 + 432), *(unsigned int *)(v5 + 480), v12);
          ((void (__fastcall *)(__int64))qword_1C00117C0)(v5);
        }
