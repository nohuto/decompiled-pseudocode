/*
 * XREFs of PccInitiateExecuteCallback @ 0x1C000AD00
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PccInitiateExecuteCallback(int a1, void (*a2)(void))
{
  ...
  if ( a1 >= 0 )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2528))(
      ...
      qword_1C0011930);
    v3 = qword_1C0011468;
    for ( i = 0; (__int64 *)v3 != &qword_1C0011468; v3 = *(_QWORD *)v3 )
    {
      ...
      *(_DWORD *)(v3 + 20) = *v5;
      ...
      if ( v6 != *(_DWORD *)(v3 + 40) )
      {
        ...
        *(_DWORD *)(v3 + 40) = v6;
        ...
        WPP_RECORDER_SF_dD((__int64)WPP_GLOBAL_Control->DeviceExtension, v8, v9, v10, v12);
      }
    }
    v11 = 0;
    if ( i )
    {
      LOBYTE(word_1C0011944) = 1;
      if ( !HIBYTE(word_1C0011944) )
      {
        HIBYTE(word_1C0011944) = 1;
        v11 = 1;
      }
    }
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(
      ...
      qword_1C0011930);
    if ( v11 )
      IoQueueWorkItem(qword_1C0011938, PccCapWorker, CriticalWorkQueue, 0LL);
  }
  if ( a2 )
    a2();
}
