/*
 * XREFs of UpdateKernelPlatformStates @ 0x1C0002004
 * Callers:
...
LABEL_26:
    ...
    *((_BYTE *)v3 + 48) = 1;
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(v28 + 2504))(v29, qword_1C0011418, 0LL);
    v30 = ((__int64 (__fastcall *)(unsigned int *))qword_1C0011648)(v3);
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      do
      {
        ...
        *v4 = v21;
        v4[8] = v5;
        if ( (int)((__int64 (__fastcall *)(_QWORD, _DWORD *, __int64))qword_1C00116B8)(*(_QWORD *)(a1 + 1088), v4, v23) >= 0 )
        {
