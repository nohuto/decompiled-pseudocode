/*
 * XREFs of GetWmiBiosThrottleStateInfo @ 0x1C0005180
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  *(_BYTE *)a3 = byte_1C0011C06;
  *(_BYTE *)(a3 + 1) = byte_1C0011C07;
  *(_DWORD *)(a3 + 4) = *(_DWORD *)(v10 + 56);
  *(_DWORD *)(a3 + 8) = *(_DWORD *)(v10 + 480);
  v12 = *(_QWORD *)(v10 + 264);
  if ( (v12 & 0x3000000) != 0 )
    v13 = 3;
  else
  ...
  *(_DWORD *)(a3 + 4) = *(_DWORD *)(v11 + 56);
  do
  {
    v16 = *(unsigned __int8 *)(v11 + v15++ + 448);
    *v14++ = v16;
  }
  while ( v15 < 4 );
  v17 = (_DWORD *)(a3 + 56);
  *(_QWORD *)(a3 + 48) = *(_QWORD *)(v11 + 452);
  for ( i = 0LL; i < 4; ++i )
  {
    v19 = *(unsigned __int8 *)(v11 + i + 460);
    *v17++ = v19;
  }
  *(_QWORD *)(a3 + 72) = *(_QWORD *)(v11 + 464);
  v20 = *(unsigned int **)(v11 + 472);
  if ( !v20 )
  {
