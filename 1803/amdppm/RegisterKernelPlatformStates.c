/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C001D038
 * Callers:
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = (unsigned int)dword_1C0011948;
  v2 = dword_1C0011414;
  if ( !dword_1C0011948 )
    return 0;
  v4 = (48 * dword_1C0011948 + 59) & 0xFFFFFFFC;
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + 8 * dword_1C0011414 * dword_1C0011948, 0x72637250u);
  v6 = PoolWithTag;
  if ( !PoolWithTag )
  {
    WPP_RECORDER_SF_(
  ...
  if ( (_DWORD)v1 )
  {
    ...
    while ( 1 )
    {
      ...
      *v8 = v9;
      v8[8] = v2;
      v11 = ((__int64 (__fastcall *)(_QWORD, _DWORD *, _QWORD))qword_1C00116B8)(*(_QWORD *)(a1 + 1088), v8, 0LL);
...
LABEL_16:
    *(_DWORD *)v6 = 56;
    *((_DWORD *)v6 + 1) = dword_1C0011948;
    *((_DWORD *)v6 + 2) = dword_1C0011948;
    ...
    *((_QWORD *)v6 + 4) = PepIdleComplete;
    v11 = ((__int64 (__fastcall *)(char *))qword_1C0011648)(v6);
    ProcessorNumberFromIndex = v11;
    if ( v11 >= 0 )
    {
      Src = v6;
