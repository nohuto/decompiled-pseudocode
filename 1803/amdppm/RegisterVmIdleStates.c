/*
 * XREFs of RegisterVmIdleStates @ 0x1C001B2F8
 * Callers:
 *     RegisterHvIdleStates @ 0x1C001A410 (RegisterHvIdleStates.c)
 *     RegisterGuestIdleStates @ 0x1C001B2D0 (RegisterGuestIdleStates.c)
 * Callees:
...
__int64 __fastcall RegisterVmIdleStates(__int64 a1)
{
  ...
  if ( v2 && (v3 = *v2) != 0 )
  {
    ...
    if ( ProcessorNumberFromIndex >= 0 )
    {
      ...
      BYTE3(v8[2]) = 1;
      HIDWORD(v8[14]) = 1;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD *))qword_1C0011638)(v8);
      if ( ProcessorNumberFromIndex >= 0 )
      {
        if ( !*(_BYTE *)(a1 + 688) )
        {
