/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C001AC60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  v9 = 0LL;
  v10 = -1073741823;
  v15[0] = qword_1C0011880;
  if ( (unsigned __int8)qword_1C0011880 <= 1u )
  {
    v3 = qword_1C0011878;
    v5 = qword_1C0011870;
    if ( (_BYTE)qword_1C0011880 == 1 )
    {
      v11 = v15[0];
      v6 = v15[0] >> 8;
      if ( BYTE1(v15[0]) )
  ...
  if ( v10 >= 0 )
  {
    HIDWORD(v18[0]) = dword_1C0011830;
    v18[2] = qword_1C0011860;
    LODWORD(v18[3]) = dword_1C0011868;
    v18[6] = v5 << v4;
    v18[5] = v3 << v4;
    LODWORD(v18[0]) = 0;
