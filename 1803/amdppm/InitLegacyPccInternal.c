/*
 * XREFs of InitLegacyPccInternal @ 0x1C000246C
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x1C0002450 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x1C001B4A0 (RegisterHvLegacyPccCounters.c)
 * Callees:
 ...
 *     InitCommonPerfStateContext @ 0x1C001DC78 (InitCommonPerfStateContext.c)
  ...
  if ( qword_1C0011938 )
  {
          ...
          (v3 = v12) != 0LL) )
    {
      ...
      *((_DWORD *)v3 + 8) = v16;
      ...
      if ( dword_1C00118DC )
      {
        v17 = 0x989680 % ((unsigned int)dword_1C00118DC >> 1);
        *((_DWORD *)v3 + 10) = 0x989680 / ((unsigned int)dword_1C00118DC >> 1);
      }
      *((_QWORD *)v13 + 1) = 100LL;
        ...
        if ( !(unsigned int)EnumerateNextDevice(&v30, &v35) )
        {
          ...
          do
          {
            *(_QWORD *)(v35 + 232) = v26 - 1;
            v28 = (__int64 *)qword_1C0011470;
            if ( *(__int64 **)qword_1C0011470 != v27 )
              __fastfail(3u);
            *v26 = v27;
            v26[1] = v28;
            *v28 = (__int64)v26;
            qword_1C0011470 = (__int64)v26;
          }
          while ( !(unsigned int)EnumerateNextDevice(&v30, &v35) );
        }
