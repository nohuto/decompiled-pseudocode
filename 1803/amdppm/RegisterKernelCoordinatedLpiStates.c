/*
 * XREFs of RegisterKernelCoordinatedLpiStates @ 0x1C001D450
 * Callers:
...
__int64 __fastcall RegisterKernelCoordinatedLpiStates(__int64 a1)
{
  ...
  v11 = 0LL;
  v12 = 0LL;
  CoordinatedLpiStates = AcpiGetCoordinatedLpiStates(a1, &qword_1C0011978);
  ...
  if ( CoordinatedLpiStates >= 0 )
  {
    ...
    if ( !*(_DWORD *)qword_1C0011978 )
      return 0;
    v3 = LpiTranslateCoordinatedIdleStates(a1, qword_1C0011978, (unsigned int)&v11, (unsigned int)&v12, (__int64)&v13);
    if ( v3 < 0 )
    ...
    *(_QWORD *)(v6 + 24) = v7;
    ...
    qword_1C0011960 = v6;
    qword_1C0011968 = v8;
    CoordinatedLpiStates = ((__int64 (__fastcall *)(__int64))qword_1C0011650)(v6);
    v3 = CoordinatedLpiStates;
    if ( CoordinatedLpiStates >= 0 )
      return 0;
    v4 = 24;
