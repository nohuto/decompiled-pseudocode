/*
 * XREFs of WPP_RECORDER_SF_xx @ 0x1C0002A4C
 * Callers:
 *     SetPerfStateFFH @ 0x1C0002C60 (SetPerfStateFFH.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_xx(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 4) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_a139920ec3ce3924d30861e7b2217bab_Traceguids,
      25LL,
      (__int64 *)va,
      8LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 25;
  return WppAutoLogTrace(a1, 3LL, 3LL, &WPP_a139920ec3ce3924d30861e7b2217bab_Traceguids, v7, (__int64 *)va);
}
