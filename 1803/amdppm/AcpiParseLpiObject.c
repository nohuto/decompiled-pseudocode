/*
 * XREFs of AcpiParseLpiObject @ 0x1C002529C
 * Callers:
  ...
  *((_DWORD *)v17 + 4) = v15;
  ...
  if ( (unsigned __int64)v20 < a1 + (unsigned __int64)*(unsigned int *)(a1 + 4) )
  {
    while ( v21 != v15 )
    {
      ...
      v26 = &v17[v23 + 6];
      if ( *v26 != 127 )
        AcpiTranslateAccessSize(v26, v24);
      v27 = (char *)&v17[v23 + 7] + 4;
      if ( *v27 != 127 )
        AcpiTranslateAccessSize(v27, v24);
      v28 = &v17[v23 + 9];
      if ( *v28 != 127 )
        AcpiTranslateAccessSize(v28, v24);
