/*
 * XREFs of ?FxStubUnbindClasses@@YAXPEAU_WDF_BIND_INFO@@@Z @ 0x1C000C774
 * Callers:
 ...
 *     WdfVersionUnbindClass_0 @ 0x1C000C830 (WdfVersionUnbindClass_0.c)
 */
...
void __fastcall FxStubUnbindClasses(struct _WDF_BIND_INFO *a1)
{
  ...
  if ( off_1C0011148 != &__KMDF_CLASS_BIND_START && &__KMDF_CLASS_BIND_END <= (_QWORD *)off_1C0011148 )
  {
    do
    {
