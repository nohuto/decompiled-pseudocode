/*
 * XREFs of HUBMISC_IsD3ColdSupported @ 0x1C002C104
 * Callers:
 *     HUBPSM30_CheckingIsD3ColdIsEnabled @ 0x1C000F5C0 (HUBPSM30_CheckingIsD3ColdIsEnabled.c)
 * Callees:
...
__int64 __fastcall HUBMISC_IsD3ColdSupported(__int64 a1)
{
  ...
  {
    v3 = 3089;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 1432), 4u, 5u, 0x73u, (__int64)&WPP_6dc2a34f378238ba241799b961c3ba51_Traceguids);
