/*
 * XREFs of HUBHTX_GetHubStatusUsingControlTransfer @ 0x1C0002FF4
 * Callers:
 *     HUBHSM_GettingHubPortStatus @ 0x1C0007630 (HUBHSM_GettingHubPortStatus.c)
 * Callees:
...
__int64 __fastcall HUBHTX_GetHubStatusUsingControlTransfer(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 776) = *(_DWORD *)(a1 + 772);
  WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 4u, 3u, 0x19u, (__int64)&WPP_657f02cd6e64326733be7ab9e49a31de_Traceguids);
