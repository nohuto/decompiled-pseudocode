/*
 * XREFs of HUBPDO_ValidateConfigurationDescriptor @ 0x1C0012F98
 * Callers:
...
__int64 __fastcall HUBPDO_ValidateConfigurationDescriptor(__int64 a1, unsigned __int8 *a2, int a3)
{
  ...
  if ( !*((_WORD *)a2 + 1) )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(v12 + 1432), 2u, 5u, 0x1Au, (__int64)&WPP_0e6bdc1f81e733846865473e2191b11e_Traceguids);
    return (unsigned int)-1073737984;
  }
