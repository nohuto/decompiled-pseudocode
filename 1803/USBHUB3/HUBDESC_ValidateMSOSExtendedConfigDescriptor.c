/*
 * XREFs of HUBDESC_ValidateMSOSExtendedConfigDescriptor @ 0x1C0033B14
 * Callers:
...
bool __fastcall HUBDESC_ValidateMSOSExtendedConfigDescriptor(_DWORD *a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( a2 != *a1 )
  {
    WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x106u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids, a2, *a1);
  ...
  do
  {
    if ( *v9 )
    {
      ...
      {
        WPP_RECORDER_SF_(a4, 2u, 5u, 0x108u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
...
LABEL_16:
  ...
  WPP_RECORDER_SF_(a4, 2u, 5u, 0x109u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 124LL);
  v7 = 0;
LABEL_19:
  if ( !v7 )
LABEL_22:
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x10Au, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  return v7;
}
