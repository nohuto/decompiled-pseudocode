/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSet @ 0x1C0035238
 * Callers:
...
LABEL_23:
    *(_DWORD *)a2 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x163u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
    return v5;
  }
  if ( v7 < 0xA )
  {
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x162u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
