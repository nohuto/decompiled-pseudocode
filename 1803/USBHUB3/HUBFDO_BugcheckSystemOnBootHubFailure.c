/*
 * XREFs of HUBFDO_BugcheckSystemOnBootHubFailure @ 0x1C000C2F0
 * Callers:
 *     HUBHSM_BugcheckingSystemOnExcessiveResetsForHubInBootPath @ 0x1C0007270 (HUBHSM_BugcheckingSystemOnExcessiveResetsForHubInBootPath.c)
 * Callees:
