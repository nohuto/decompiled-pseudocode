/*
 * XREFs of WerKernelSubmitReport @ 0x1C0039040
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C0075900 (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpGetRegistryKey @ 0x1C0038834 (WerpGetRegistryKey.c)
 *     WerpAllocateAndInitializeSid @ 0x1C00388EC (WerpAllocateAndInitializeSid.c)
 *     WerpParseKeyName @ 0x1C00389D4 (WerpParseKeyName.c)
 *     WerStartSystemErrorHandler @ 0x1C0038E84 (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C0038F90 (WerWaitForSystemErrorHandler.c)
