/*
 * XREFs of HUBACPI_EvalAcpiMethodEx @ 0x1C0073450
 * Callers:
 *     HUBACPI_GetAcpiPortAttributes @ 0x1C0073BA8 (HUBACPI_GetAcpiPortAttributes.c)
 * Callees:
 *     WPP_RECORDER_SF_d @ 0x1C00019D4 (WPP_RECORDER_SF_d.c)
 *     WPP_RECORDER_SF_ @ 0x1C0001DC8 (WPP_RECORDER_SF_.c)
 *     RtlStringCbCatNA @ 0x1C0035BA4 (RtlStringCbCatNA.c)
...
LABEL_3:
  ...
  if ( (unsigned __int64)(unsigned int)(v12 + 1) + 5 <= 0x100 )
  {
    ...
    *v18 = 0;
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, _QWORD *))(WdfFunctions_01015 + 2024))(
            ...
            v21,
            v29) )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 2u, 3u, 0x15u, (__int64)&WPP_22ffb5924eb63740e896026b857d240f_Traceguids);
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 2u, 3u, 0x17u, (__int64)&WPP_22ffb5924eb63740e896026b857d240f_Traceguids);
      v10 = -1072431089;
    }
  }
  else
  {
    v10 = -1073741811;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 2u, 3u, 0x12u, (__int64)&WPP_22ffb5924eb63740e896026b857d240f_Traceguids);
  }
LABEL_23:
  if ( v26 )
