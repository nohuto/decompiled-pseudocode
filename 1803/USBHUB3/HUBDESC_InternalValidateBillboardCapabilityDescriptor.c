/*
 * XREFs of HUBDESC_InternalValidateBillboardCapabilityDescriptor @ 0x1C00316AC
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *a3 <= v10 )
  {
    ...
    if ( result )
    {
      if ( result <= 0x80u )
      {
        ...
        *v5 = 1;
        LODWORD(v18) = a1[5];
        WPP_RECORDER_SF_d(v11, 2u, 5u, 0xA0u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids, v18);
        v17 = 241LL;
      }
      else
      {
        *v5 = 1;
        LODWORD(v18) = a1[4];
        WPP_RECORDER_SF_d(v11, 2u, 5u, 0x9Fu, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids, v18);
        v17 = 239LL;
      }
    }
    else
    {
      *v5 = 1;
      WPP_RECORDER_SF_(v11, 2u, 5u, 0x9Eu, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
      v17 = 238LL;
    }
  }
  else
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v5 = 2;
    LODWORD(v18) = v9;
    WPP_RECORDER_SF_d(v11, 2u, 5u, 0x9Du, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids, v18);
    v17 = 237LL;
  }
  result = (*(__int64 (__fastcall **)(_QWORD, __int64))(a2 + 24))(*(_QWORD *)(a2 + 40), v17);
LABEL_24:
  if ( *v5 )
    return WPP_RECORDER_SF_(v11, 2u, 5u, 0xA4u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  return result;
}
