/*
 * XREFs of HUBUCX_UpdateHubInformationUsingUCXIoctl @ 0x1C00220C4
 * Callers:
...
LABEL_3:
    LODWORD(v6) = v3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2512), 2u, 3u, v5, (__int64)&WPP_ac19941ca8303ac9317dca70d7291dce_Traceguids, v6);
    goto LABEL_14;
  }
  memset(v7, 0, 0x38uLL);
  v7[4] = v9;
