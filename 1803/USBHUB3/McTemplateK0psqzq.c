/*
 * XREFs of McTemplateK0psqzq @ 0x1C0026BD0
 * Callers:
...
NTSTATUS McTemplateK0psqzq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  __int64 v4; // rdx
  __int64 v5; // rcx
  int v6; // ecx
  ...
  v19 = v9;
  va_copy(v22, va2);
  return McGenEventWriteKM((__int64)v29, &USBHUB3_ETW_EVENT_USBENUM_SERIAL_MISMATCH_ON_RENUMERATION, a3, 6u, &v11);
}
