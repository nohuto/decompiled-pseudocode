/*
 * XREFs of HUBDTX_ValidateAndCacheSerialNumberStringDescriptor @ 0x1C0025E70
 * Callers:
 *     HUBDSM_ValidatingSerialNumberStringDescriptorFor1xDevice @ 0x1C001C3E0 (HUBDSM_ValidatingSerialNumberStringDescriptorFor1xDevice.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheSerialNumberStringDescriptor(__int64 a1)
{
  ...
  if ( (v16 - 2) >> 1 )
  {
    ...
    do
    {
      ...
      if ( !(_WORD)v14 )
        break;
      if ( (unsigned __int16)(v14 - 32) > 0x5Fu || (_WORD)v14 == 44 )
      {
        v15 = 0;
        LODWORD(v28) = (unsigned __int16)v14;
        WPP_RECORDER_SF_d(v18, 2u, 5u, 0x111u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids, v28);
...
LABEL_20:
    WPP_RECORDER_SF_(v31, 2u, 5u, 0x112u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  if ( v15 )
  {
    v22 = *(void **)(v1 + 2152);
    if ( v22 )
