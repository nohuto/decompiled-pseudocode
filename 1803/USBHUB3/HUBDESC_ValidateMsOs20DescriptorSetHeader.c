/*
 * XREFs of HUBDESC_ValidateMsOs20DescriptorSetHeader @ 0x1C00343F0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HUBDESC_ValidateMsOs20DescriptorSetHeader(__int64 a1, __int64 a2, unsigned __int16 *a3)
{
  ...
  if ( (*(_BYTE *)a2 & 2) != 0 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x12Cu, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  ...
  if ( v6 == 1 )
    *(_DWORD *)a2 |= 2u;
    ...
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x12Eu, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  return v6;
}
