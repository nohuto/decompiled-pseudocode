/*
 * XREFs of WER_StoreDeviceContext @ 0x1C0035CC4
 * Callers:
...
__int64 __fastcall WER_StoreDeviceContext(__int64 a1, __int64 a2)
{
  ...
  inserted = TelemetryData_InsertTriageDataBlock(a1, a2, 2704LL);
  if ( inserted >= 0 )
  {
    v5 = *(_QWORD *)(a2 + 48);
    if ( !v5 )
...
LABEL_12:
        v13 = *(_QWORD *)(a2 + 72);
        if ( !v13
          || (inserted = TelemetryData_InsertTriageDataBlock(a1, v13, 72LL * *(unsigned int *)(v13 + 24) + 40),
              inserted >= 0) )
        {
          v14 = *(_QWORD *)(a2 + 80);
          if ( !v14
            || (inserted = TelemetryData_InsertTriageDataBlock(a1, v14, 72LL * *(unsigned int *)(v14 + 24) + 40),
                inserted >= 0) )
          {
            v15 = *(_QWORD *)(a2 + 104);
            if ( !v15
                        ...
                        if ( !v24 || (inserted = TelemetryData_InsertTriageDataBlock(a1, v24, *v24), inserted >= 0) )
                        {
                          ...
                          if ( !v25 || (inserted = TelemetryData_InsertTriageDataBlock(a1, v25, *v25), inserted >= 0) )
                          {
                                  ...
                                  inserted >= 0) )
                            {
                              v27 = *(_QWORD *)(a2 + 16);
                              if ( v27 )
                                return (unsigned int)TelemetryData_InsertTriageDataBlock(a1, v27, 456LL);
                            }
                          }
                        }
                      }
