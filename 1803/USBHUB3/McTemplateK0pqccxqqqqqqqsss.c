/*
 * XREFs of McTemplateK0pqccxqqqqqqqsss @ 0x1C0001764
 * Callers:
...
NTSTATUS McTemplateK0pqccxqqqqqqqsss(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  __int64 v3; // rcx
  __int64 v6; // rdx
  int v7; // edx
  ...
  if ( v75 )
    v8 = v75;
  v46 = v8;
  return McGenEventWriteKM(v13, a2, a3, 0x10u, &v15);
}
