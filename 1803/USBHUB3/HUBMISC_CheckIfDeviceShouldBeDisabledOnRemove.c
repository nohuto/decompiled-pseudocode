/*
 * XREFs of HUBMISC_CheckIfDeviceShouldBeDisabledOnRemove @ 0x1C00292F4
 * Callers:
 *     HUBDSM_CheckingIfDeviceShouldBeDisabled @ 0x1C0019980 (HUBDSM_CheckingIfDeviceShouldBeDisabled.c)
 * Callees:
