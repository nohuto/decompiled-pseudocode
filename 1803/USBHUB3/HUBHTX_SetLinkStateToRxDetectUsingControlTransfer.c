/*
 * XREFs of HUBHTX_SetLinkStateToRxDetectUsingControlTransfer @ 0x1C0006218
 * Callers:
 *     HUBPSM30_EnablingSuperSpeedOnTimerExpiration @ 0x1C000F870 (HUBPSM30_EnablingSuperSpeedOnTimerExpiration.c)
 * Callees:
