/*
 * XREFs of HUBPSM30_AcquiringPortReferenceAndGettingPortEvent @ 0x1C0010260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM30_AcquiringPortReferenceAndGettingPortEvent(__int64 a1)
{
  ...
  if ( *(int *)(*(_QWORD *)v1 + 40LL) < 0 && (*(_WORD *)(v1 + 184) & 0x1E0) == 0xE0 )
    WPP_RECORDER_SF_(*(_QWORD *)(v1 + 1432), 2u, 4u, 0x6Du, (__int64)&WPP_657f02cd6e64326733be7ab9e49a31de_Traceguids);
