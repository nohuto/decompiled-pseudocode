/*
 * XREFs of HUBMUX_AcquireDevicePowerReference @ 0x1C000E58C
 * Callers:
 *     HUBDSM_AcquiringPowerReferenceOnHubResume @ 0x1C0019940 (HUBDSM_AcquiringPowerReferenceOnHubResume.c)
 * Callees:
