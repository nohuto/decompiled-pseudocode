/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionAttributes @ 0x1C0067C94
 * Callers:
...
LABEL_8:
      ...
      *((_DWORD *)v20 + 1) = *((_DWORD *)v13 + 356);
    }
  }
  else
  {
    WPP_RECORDER_SF_d(v9[314], 2u, 3u, 0x25u, (__int64)&WPP_4a56a43616cc3150b1f03ded22a040ae_Traceguids, v10);
  }
LABEL_9:
