/*
 * XREFs of HUBPDO_ReturnDeviceConfigInfo @ 0x1C0012C8C
 * Callers:
      ...
      *(_QWORD *)(v4 + 52) = 0LL;
      if ( *(_QWORD *)(v15 + 2168) && *(_DWORD *)(v15 + 2164) )
      {
        *(_OWORD *)(v4 + 44) = *(_OWORD *)(v15 + 2160);
        PoolWithTag = ExAllocatePoolWithTag(ExDefaultNonPagedPoolType, *(unsigned int *)(v15 + 2164), 0x64334855u);
