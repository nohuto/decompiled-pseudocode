/*
 * XREFs of TelemetryData_SubmitReport @ 0x1C0075900
 * Callers:
 ...
 *     WerKernelCloseHandle @ 0x1C0039694 (WerKernelCloseHandle.c)
 *     TelemetryData_pDeleteDumpFile @ 0x1C00753FC (TelemetryData_pDeleteDumpFile.c)
