/*
 * XREFs of HUBDSM_ValidatingMSOSExtendedConfigDescriptor @ 0x1C001C220
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_ValidatingMSOSExtendedConfigDescriptor(__int64 a1)
{
  ...
  {
    WPP_RECORDER_SF_d(v13, 2u, 5u, 0x52u, (__int64)&WPP_0a0f952dc11639804361b505720162cd_Traceguids, v12, v17[0]);
  }
