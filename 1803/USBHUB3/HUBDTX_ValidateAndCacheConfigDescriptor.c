/*
 * XREFs of HUBDTX_ValidateAndCacheConfigDescriptor @ 0x1C0024C54
 * Callers:
 *     HUBDSM_ValidatingAlternateConfigurationDescriptor @ 0x1C001B7F0 (HUBDSM_ValidatingAlternateConfigurationDescriptor.c)
 * Callees:
...
LABEL_67:
  ...
  *(_QWORD *)(a1 + 2008) = v23;
  if ( v23 )
  {
    ...
    {
      if ( (v24 = *(_DWORD *)(a1 + 172), v24 == 3) && (*(_DWORD *)(*(_QWORD *)a1 + 752LL) & 1) != 0 || v24 == 2 )
      {
