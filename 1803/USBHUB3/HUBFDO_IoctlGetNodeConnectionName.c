/*
 * XREFs of HUBFDO_IoctlGetNodeConnectionName @ 0x1C0068294
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlGetNodeConnectionName(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( v10 >= 0 )
  {
                    ...
                    + 1632LL) & 2) != 0 )
    {
      ...
      *(_DWORD *)v22 = v7;
      v23 = 0LL;
      DeviceInterfacePath = HUBMISC_GetDeviceInterfacePath((__int64)&GUID_DEVINTERFACE_USB_HUB, v12, &v23, 0LL, v9[314]);
...
LABEL_12:
  ...
  WPP_RECORDER_SF_d(v9[314], 2u, 3u, 0x28u, (__int64)&WPP_4a56a43616cc3150b1f03ded22a040ae_Traceguids, v10);
LABEL_15:
