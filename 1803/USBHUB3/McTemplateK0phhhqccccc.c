/*
 * XREFs of McTemplateK0phhhqccccc @ 0x1C0026CD8
 * Callers:
...
NTSTATUS McTemplateK0phhhqccccc(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v22 = 1LL;
  v24 = 1LL;
  return McGenEventWriteKM(a1, &USBHUB3_ETW_EVENT_ILLEGAL_ENDPOINT_SHARING_ACROSS_INTERFACES, a3, 0xBu, &v4);
}
