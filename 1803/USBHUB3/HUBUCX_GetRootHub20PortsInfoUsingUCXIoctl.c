/*
 * XREFs of HUBUCX_GetRootHub20PortsInfoUsingUCXIoctl @ 0x1C0021524
 * Callers:
 *     HUBHSM_GettingRootHub20PortsInfo @ 0x1C0008990 (HUBHSM_GettingRootHub20PortsInfo.c)
 * Callees:
...
LABEL_15:
  ...
  v8 = 28LL * *(unsigned __int16 *)(a1 + 112);
  memset(v14, 0, 0x38uLL);
  v14[4] = *(_QWORD *)(a1 + 16);
  LODWORD(v14[0]) = 56;
  v14[3] = 0x100000001LL;
