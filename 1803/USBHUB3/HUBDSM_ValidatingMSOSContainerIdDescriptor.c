/*
 * XREFs of HUBDSM_ValidatingMSOSContainerIdDescriptor @ 0x1C001BFC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_ValidatingMSOSContainerIdDescriptor(__int64 a1)
{
  ...
  if ( *(_DWORD *)(v1 + 256) == 24 )
  {
    ...
    WPP_RECORDER_SF_(v3, 2u, 5u, 0x104u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
    v4 = 114LL;
  }
  else
  {
  ...
  WPP_RECORDER_SF_(v3, 2u, 5u, 0x105u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  v2 = 4065;
