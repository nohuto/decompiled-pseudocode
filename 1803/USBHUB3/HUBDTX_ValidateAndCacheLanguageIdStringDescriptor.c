/*
 * XREFs of HUBDTX_ValidateAndCacheLanguageIdStringDescriptor @ 0x1C0025598
 * Callers:
 *     HUBDSM_ValidatingLanguageIdStringDescriptor @ 0x1C001B990 (HUBDSM_ValidatingLanguageIdStringDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheLanguageIdStringDescriptor(__int64 a1)
{
  ...
  {
    *(_DWORD *)(a1 + 2432) = 1073807380;
  }
  v4 = 4065;
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x100) != 0 )
    McTemplateK0p(
      v15,
      &USBHUB3_ETW_EVENT_INVALID_LANGUAGE_ID_DESCRIPTOR,
      (const GUID *)(a1 + 1516),
      *(_QWORD *)(a1 + 24));
  return v4;
}
