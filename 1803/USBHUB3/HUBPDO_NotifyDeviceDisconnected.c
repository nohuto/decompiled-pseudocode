/*
 * XREFs of HUBPDO_NotifyDeviceDisconnected @ 0x1C0013B2C
 * Callers:
 ...
 *     HUBDSM_NotifyingDeviceDisconnectedOnDetachWithSpecialFile @ 0x1C001A160 (HUBDSM_NotifyingDeviceDisconnectedOnDetachWithSpecialFile.c)
