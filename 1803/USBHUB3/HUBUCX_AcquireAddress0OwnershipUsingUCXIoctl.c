/*
 * XREFs of HUBUCX_AcquireAddress0OwnershipUsingUCXIoctl @ 0x1C0020124
 * Callers:
 *     HUBDSM_AcquiringAddressZeroOwnershipOnRenum @ 0x1C001AEA0 (HUBDSM_AcquiringAddressZeroOwnershipOnRenum.c)
 * Callees:
