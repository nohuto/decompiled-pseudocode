/*
 * XREFs of HUBHSM_SendingAckForHubChange @ 0x1C0007DD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_SendingAckForHubChange(__int64 a1)
{
  ...
  *(_DWORD *)(v1 + 948) = 0;
  v6 = v3;
  WPP_RECORDER_SF_d(*(_QWORD *)(v1 + 2512), 4u, 3u, 0xCu, (__int64)&WPP_657f02cd6e64326733be7ab9e49a31de_Traceguids, v6);
