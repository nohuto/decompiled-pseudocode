/*
 * XREFs of EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup @ 0x1C0017EB4
 * Callers:
...
_DWORD *__fastcall EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup(__int64 a1, __int64 a2)
{
  ...
  if ( a1 && *(_QWORD *)a1 )
  {
    ...
    do
    {
      ...
      *v4 = 0;
      result = __KMDF_CLASS_BIND_START;
      ++v4;
      v3 += 2;
    }
    while ( (__int64)v3 < (__int64)__KMDF_CLASS_BIND_START );
  }
  return result;
}
