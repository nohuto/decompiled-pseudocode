/*
 * XREFs of HUBPDO_CompleteClientSerialRequestWithStatusFailed @ 0x1C00121E4
 * Callers:
 *     HUBDSM_CompletingClientRequestOnFailureInDisabled @ 0x1C0019BA0 (HUBDSM_CompletingClientRequestOnFailureInDisabled.c)
