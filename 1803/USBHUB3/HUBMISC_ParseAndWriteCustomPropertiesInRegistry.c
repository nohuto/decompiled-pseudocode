/*
 * XREFs of HUBMISC_ParseAndWriteCustomPropertiesInRegistry @ 0x1C006E2CC
 * Callers:
 *     HUBDSM_WritingCustomPropertiesInRegistry @ 0x1C001EA90 (HUBDSM_WritingCustomPropertiesInRegistry.c)
 * Callees:
