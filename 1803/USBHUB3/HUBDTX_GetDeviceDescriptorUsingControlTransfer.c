/*
 * XREFs of HUBDTX_GetDeviceDescriptorUsingControlTransfer @ 0x1C0023FBC
 * Callers:
 *     HUBDSM_GettingAlternateDeviceDescriptor @ 0x1C001B770 (HUBDSM_GettingAlternateDeviceDescriptor.c)
 * Callees:
