/*
 * XREFs of HUBMUX_QueuePowerUpEventToDSMs @ 0x1C000E218
 * Callers:
 *     HUBHSM_NotifyingHubResumeInS0ToDevices @ 0x1C0007800 (HUBHSM_NotifyingHubResumeInS0ToDevices.c)
 *     HUBHSM_NotifyingHubResumeToDevices @ 0x1C0007830 (HUBHSM_NotifyingHubResumeToDevices.c)
 *     HUBHSM_NotifyingHubResumeWithResetToDevices @ 0x1C0007870 (HUBHSM_NotifyingHubResumeWithResetToDevices.c)
 *     HUBHSM_NotifyingHubResumeWithResetToDevicesOnFailure @ 0x1C00078B0 (HUBHSM_NotifyingHubResumeWithResetToDevicesOnFailure.c)
 *     HUBHSM_WaitingForDevicesToAcquireReferenceOnStart @ 0x1C0008060 (HUBHSM_WaitingForDevicesToAcquireReferenceOnStart.c)
 * Callees:
