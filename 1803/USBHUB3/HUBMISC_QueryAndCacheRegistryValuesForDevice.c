/*
 * XREFs of HUBMISC_QueryAndCacheRegistryValuesForDevice @ 0x1C006E0B8
 * Callers:
 *     HUBDSM_QueryingRegistryValuesForDevice @ 0x1C001B790 (HUBDSM_QueryingRegistryValuesForDevice.c)
 * Callees:
