/*
 * XREFs of HUBREG_EvtWorkItemPerformPostSurpriseRemovalRecoveryActions @ 0x1C00722E0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  LODWORD(v11) = v7;
  WPP_RECORDER_SF_d(*(_QWORD *)(v8 + 64), 2u, 2u, v9, (__int64)&WPP_cdad0992e1bf302d72a6f37b218e7fd9_Traceguids, v11);
LABEL_11:
  if ( v15 )
