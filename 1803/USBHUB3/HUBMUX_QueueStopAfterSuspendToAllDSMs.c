/*
 * XREFs of HUBMUX_QueueStopAfterSuspendToAllDSMs @ 0x1C000DFC4
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove @ 0x1C0007930 (HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove.c)
 * Callees:
