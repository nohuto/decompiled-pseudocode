/*
 * XREFs of McTemplateK0pqqh @ 0x1C000A71C
 * Callers:
...
NTSTATUS McTemplateK0pqqh(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v10 = 4LL;
  v12 = 2LL;
  return McGenEventWriteKM(a1, a2, a3, 5u, &v4);
}
