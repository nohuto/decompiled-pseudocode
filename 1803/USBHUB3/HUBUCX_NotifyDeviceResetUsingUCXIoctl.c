/*
 * XREFs of HUBUCX_NotifyDeviceResetUsingUCXIoctl @ 0x1C00201C8
 * Callers:
 *     HUBDSM_NotifyingDeviceResetToUCXAfterReset2 @ 0x1C001B210 (HUBDSM_NotifyingDeviceResetToUCXAfterReset2.c)
 * Callees:
