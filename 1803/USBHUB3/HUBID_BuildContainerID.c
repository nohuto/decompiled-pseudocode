/*
 * XREFs of HUBID_BuildContainerID @ 0x1C001935C
 * Callers:
 ...
 *     RtlUnicodeStringCbCatStringN @ 0x1C0018474 (RtlUnicodeStringCbCatStringN.c)
...
void __fastcall HUBID_BuildContainerID(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)pbOutput = 0;
  ...
  if ( DestinationString.Buffer )
  {
    ...
    if ( v10 > 0x200u )
    {
      v13 = RtlUnicodeStringPrintf(&DestinationString, L"%.4X%.4X.%4X", *(unsigned __int16 *)(a1 + 1996), v11, v10);
    }
    else
    {
      v12 = *(_WORD *)(a1 + 2000);
      v25[4] = 0;
      v25[0] = (v12 >> 12) + 48;
      v25[1] = (HIBYTE(v12) & 0xF) + 48;
      v25[2] = ((unsigned __int8)v12 >> 4) + 48;
      v25[3] = (v12 & 0xF) + 48;
      v13 = RtlUnicodeStringPrintf(&DestinationString, L"%.4X%.4X%S", *(unsigned __int16 *)(a1 + 1996), v11, v25);
    }
    Property = v13;
    if ( v13 < 0 )
      goto LABEL_36;
