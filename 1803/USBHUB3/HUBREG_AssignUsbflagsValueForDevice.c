/*
 * XREFs of HUBREG_AssignUsbflagsValueForDevice @ 0x1C006EFE0
 * Callers:
 *     HUBDSM_MarkingDeviceAsNotSupportingContainerIdBasedOnMSOSDescriptor @ 0x1C001BF60 (HUBDSM_MarkingDeviceAsNotSupportingContainerIdBasedOnMSOSDescriptor.c)
