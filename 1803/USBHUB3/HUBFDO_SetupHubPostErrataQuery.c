/*
 * XREFs of HUBFDO_SetupHubPostErrataQuery @ 0x1C000C41C
 * Callers:
 *     HUBHSM_SettingUpHubPostErrataQuery @ 0x1C0007F40 (HUBHSM_SettingUpHubPostErrataQuery.c)
 * Callees:
  ...
  if ( (*((_DWORD *)Context + 10) & 0x80u) == 0 && (*((_DWORD *)Context + 11) & 1) == 0 && Context[252] )
  {
    ...
    *((_DWORD *)Context + 642) = 50;
    ...
    if ( v16 >= 0 )
    {
      ...
      v24 = (struct _DEVICE_OBJECT *)(*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 248))(
                                       WdfDriverGlobals,
                                       v1);
