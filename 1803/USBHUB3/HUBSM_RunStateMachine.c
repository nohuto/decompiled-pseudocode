/*
 * XREFs of HUBSM_RunStateMachine @ 0x1C000A038
 * Callers:
 *     HUBSM_EvtSmWorkItem @ 0x1C0009BB0 (HUBSM_EvtSmWorkItem.c)
...
KIRQL __fastcall HUBSM_RunStateMachine(__int64 a1, int a2, KIRQL *a3, char a4)
{
  ...
  while ( 1 )
  {
    if ( a2 == 1000 )
    {
      ...
      if ( v14 == 1000 )
      {
        v40 = WdfFunctions_01015;
        v41 = *(_QWORD *)(a1 + 960);
        v42 = WdfDriverGlobals;
        *(_BYTE *)(a1 + 848) = 0;
        v43 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(v40 + 1632))(v42, v41);
...
LABEL_51:
    KeReleaseSpinLock(v5, *a3);
    if ( !HUBSM_FindAndSetTargetState(a1, v14, &v47) )
      goto LABEL_85;
    v27 = *(_DWORD *)(a1 + 984);
...
LABEL_87:
    ...
    if ( (*(_DWORD *)(*(_QWORD *)(v4
                                + 8LL * (unsigned int)(*(_DWORD *)(a1 + 4LL * *(unsigned int *)(a1 + 880) + 852) - v46))
                    + 16LL) & 0x10) != 0
      && KeGetCurrentIrql()
      || !v7 && v6 > 0x64 )
    {
