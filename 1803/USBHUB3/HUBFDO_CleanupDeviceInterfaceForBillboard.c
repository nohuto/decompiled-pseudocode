/*
 * XREFs of HUBFDO_CleanupDeviceInterfaceForBillboard @ 0x1C000CA5C
 * Callers:
...
__int64 __fastcall HUBFDO_CleanupDeviceInterfaceForBillboard(__int64 a1, unsigned __int16 a2, __int64 a3, char a4)
{
  ...
  {
    v8 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 4u, 3u, 0x41u, (__int64)&WPP_4a56a43616cc3150b1f03ded22a040ae_Traceguids);
    goto LABEL_9;
  }
