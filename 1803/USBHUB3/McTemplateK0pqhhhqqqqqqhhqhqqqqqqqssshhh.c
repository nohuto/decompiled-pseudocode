/*
 * XREFs of McTemplateK0pqhhhqqqqqqhhqhqqqqqqqssshhh @ 0x1C0010D68
 * Callers:
...
NTSTATUS __fastcall McTemplateK0pqhhhqqqqqqhhqhqqqqqqqssshhh(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a31)
{
  ...
  v101 = 2LL;
  v100 = &a31;
  return McGenEventWriteKM(v40, &USBHUB3_ETW_EVENT_DEVICE_ENUMERATION_FAILURE, a3, 0x1Du, &v42);
}
