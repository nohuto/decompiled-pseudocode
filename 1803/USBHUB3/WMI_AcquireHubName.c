/*
 * XREFs of WMI_AcquireHubName @ 0x1C0074300
 * Callers:
...
__int64 __fastcall WMI_AcquireHubName(__int64 a1, unsigned int a2, _DWORD *a3, __int64 a4)
{
  ...
  *a3 = 0;
  ...
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2512), 2u, 3u, 0xAu, (__int64)&WPP_1362546fee9e322e2fa74dbd802c5a46_Traceguids);
    return (unsigned int)-1073741789;
  }
  else
  {
    v8 = v7 - 8;
    v9 = HUBMISC_StripSymbolicNamePrefix((unsigned __int16 *)(a1 + 2536), &v13);
