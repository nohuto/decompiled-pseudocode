/*
 * XREFs of McTemplateK0pnq @ 0x1C00012E0
 * Callers:
...
NTSTATUS McTemplateK0pnq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  va_copy(v10, va1);
  v11 = 4LL;
  return McGenEventWriteKM(0LL, a2, a3, 4u, &v4);
}
