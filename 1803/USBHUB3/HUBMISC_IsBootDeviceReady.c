/*
 * XREFs of HUBMISC_IsBootDeviceReady @ 0x1C002BDA8
 * Callers:
 *     HUBBOOT_IsBootDeviceReady @ 0x1C00369E0 (HUBBOOT_IsBootDeviceReady.c)
 * Callees:
...
char __fastcall HUBMISC_IsBootDeviceReady(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)a1 + 2344LL) & 0x10) != 0 )
  {
    v2 = 1;
  ...
  *(_DWORD *)(a1 + 2240) = 0;
  ...
  v2 = 0;
LABEL_19:
  WPP_RECORDER_SF_(v3, 4u, 5u, v4, (__int64)&WPP_6dc2a34f378238ba241799b961c3ba51_Traceguids);
  if ( v2 )
  {
