/*
 * XREFs of HUBDSM_WaitingForPDOD0ExitOnDetachInUnConfigured @ 0x1C001AD60
 * Callers:
 *     <none>
 * Callees:
 *     HUBMISC_RemoveDeviceInfoFromGlobalChildList @ 0x1C0029470 (HUBMISC_RemoveDeviceInfoFromGlobalChildList.c)
