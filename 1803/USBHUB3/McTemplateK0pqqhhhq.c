/*
 * XREFs of McTemplateK0pqqhhhq @ 0x1C0010B84
 * Callers:
 ...
 *     EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup @ 0x1C0017EB4 (EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup.c)
 * Callees:
 *     McGenEventWriteKM @ 0x1C00011B4 (McGenEventWriteKM.c)
 *     __security_check_cookie @ 0x1C00396C0 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pqqhhhq(__int64 a1, __int64 a2, const GUID *a3, ...)
{
  ...
  v16 = 2LL;
  v18 = 4LL;
  return McGenEventWriteKM(a1, &USBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_V1, a3, 8u, &v4);
}
