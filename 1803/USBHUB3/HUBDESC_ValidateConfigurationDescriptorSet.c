/*
 * XREFs of HUBDESC_ValidateConfigurationDescriptorSet @ 0x1C0030954
 * Callers:
        ...
        _BYTE *a5)
{
  ...
  *(_QWORD *)&v24[3] = v10;
  if ( !a1 )
  {
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x7Bu, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
    v12 = 60LL;
LABEL_5:
...
LABEL_6:
  ...
  {
    WPP_RECORDER_SF_dD(a4, 2u, 5u, 0x7Cu, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids, v5, 9);
    v12 = 56LL;
    goto LABEL_5;
  }
  v22 = 0;
...
LABEL_31:
  ...
  if ( !v13 )
LABEL_41:
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x7Du, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  return v13;
}
