/*
 * XREFs of McTemplateK0pqhhh @ 0x1C0010CC8
 * Callers:
...
NTSTATUS McTemplateK0pqhhh(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  v12 = 2LL;
  v14 = 2LL;
  return McGenEventWriteKM(a1, a2, a3, 6u, &v4);
}
