/*
 * XREFs of HUBDTX_ValidateAndCacheProductIdStringDescriptor @ 0x1C0025CAC
 * Callers:
 *     HUBDSM_ValidatingLanguageSpecificProductIdString @ 0x1C001AE80 (HUBDSM_ValidatingLanguageSpecificProductIdString.c)
 * Callees:
