/*
 * XREFs of HUBPDO_ReleaseWdfPowerReferenceOnHub @ 0x1C0016E4C
 * Callers:
 *     HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure @ 0x1C001A470 (HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure.c)
 * Callees:
