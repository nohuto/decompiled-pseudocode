/*
 * XREFs of HUBFDO_IoctlResetHub @ 0x1C0069B28
 * Callers:
...
__int64 __fastcall HUBFDO_IoctlResetHub(__int64 a1, __int64 a2)
{
  ...
  v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
         ...
         v4,
         off_1C005B0C0);
  IsAdmin = HUBMISC_VerifyCallerIsAdmin(*(_QWORD *)(v5 + 2512));
  if ( IsAdmin >= 0 )
  {
  ...
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x400) != 0 )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.DmaWaitEntry.Blink & 0x400) != 0 )
    {
      ...
      if ( ActivityIdIrp < 0 )
        v11 = 0LL;
      McTemplateK0pqq(v10, &USBHUB3_ETW_EVENT_HUB_IOCTL_USB_RESET_HUB_COMPLETE, v11, *(_QWORD *)(v5 + 240), 0, IsAdmin);
    }
  }
