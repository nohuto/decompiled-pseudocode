/*
 * XREFs of HUBDESC_ValidateMsOs20RegistryProperty @ 0x1C0034BC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
    ...
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x14Au, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
    return 0;
  }
  v8 = a3[3];
