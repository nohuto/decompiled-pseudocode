/*
 * XREFs of McTemplateK0ppqq @ 0x1C0010A74
 * Callers:
 ...
 *     HUBMISC_LogDescriptorValidationErrorForHub @ 0x1C002C5D0 (HUBMISC_LogDescriptorValidationErrorForHub.c)
 *     HUBMISC_LogDescriptorValidationWarningForHub @ 0x1C002C620 (HUBMISC_LogDescriptorValidationWarningForHub.c)
...
NTSTATUS McTemplateK0ppqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
