/*
 * XREFs of HUBREG_OpenQueryAttemptRecoveryFromUsbPowerDrainValue @ 0x1C0072EC4
 * Callers:
...
__int64 __fastcall HUBREG_OpenQueryAttemptRecoveryFromUsbPowerDrainValue(_DWORD *a1)
{
  ...
  LODWORD(v8) = v4;
  WPP_RECORDER_SF_d(*(_QWORD *)(v3 + 64), 2u, 2u, v6, (__int64)&WPP_cdad0992e1bf302d72a6f37b218e7fd9_Traceguids, v8);
LABEL_6:
  if ( v9 )
