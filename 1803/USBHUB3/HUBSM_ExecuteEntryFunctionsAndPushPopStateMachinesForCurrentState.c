/*
 * XREFs of HUBSM_ExecuteEntryFunctionsAndPushPopStateMachinesForCurrentState @ 0x1C00094D0
 * Callers:
...
LABEL_25:
    ...
    *(_BYTE *)(a1 + 832) = (*(_BYTE *)(a1 + 832) + 1) & 0x3F;
    ...
    {
      LODWORD(v53) = v3;
      v27 = (unsigned int)(v24 - *(_DWORD *)(a1 + 984));
      LODWORD(v52) = 1000;
      LODWORD(v51) = **(_DWORD **)(*(_QWORD *)(a1 + 976) + 8 * v27);
      LODWORD(v50) = *(_DWORD *)(a1 + 984);
      McTemplateK0ppqqqq(
        v27,
        &USBHUB3_ETW_EVENT_STATE_MACHINE,
