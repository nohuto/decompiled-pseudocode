/*
 * XREFs of HUBMISC_CreateNewDSM @ 0x1C0029E0C
 * Callers:
 *     HUBPSM30_CreatingDeviceInConnectedWithResetInProgress @ 0x1C000E840 (HUBPSM30_CreatingDeviceInConnectedWithResetInProgress.c)
 * Callees:
