/*
 * XREFs of HUBHTX_DisablePortUsingControlTransfer @ 0x1C0003ECC
 * Callers:
 *     HUBPSM20_DisablingPortOnPortCycleWithTimer @ 0x1C000E900 (HUBPSM20_DisablingPortOnPortCycleWithTimer.c)
 * Callees:
