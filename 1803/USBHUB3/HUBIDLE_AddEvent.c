/*
 * XREFs of HUBIDLE_AddEvent @ 0x1C00354EC
 * Callers:
 ...
 *     HUBIDLE_CancelIdle @ 0x1C00359E0 (HUBIDLE_CancelIdle.c)
...
LABEL_21:
      ...
      *(_DWORD *)(a1 + 144) = v10;
      v15 = *(__int64 (__fastcall **)(__int64, IRP *))(*(_QWORD *)(v42 + 8LL * (unsigned int)(v10 - v39)) + 8LL);
      if ( v15 )
        v8 = v15(a1, a3);
      else
        v8 = 1000;
