/*
 * XREFs of HUBMISC_StoreDeviceMSOSVendorCodeInRegsitry @ 0x1C006E080
 * Callers:
 *     HUBDSM_MarkDeviceAsSupportingMSOSDescriptor @ 0x1C001BF40 (HUBDSM_MarkDeviceAsSupportingMSOSDescriptor.c)
 * Callees:
