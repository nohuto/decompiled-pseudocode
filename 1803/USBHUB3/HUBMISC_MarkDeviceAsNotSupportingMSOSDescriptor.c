/*
 * XREFs of HUBMISC_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C006E048
 * Callers:
 *     HUBDSM_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C001BF20 (HUBDSM_MarkDeviceAsNotSupportingMSOSDescriptor.c)
 * Callees:
