/*
 * XREFs of HUBUCX_CheckIfEndpointsNeedToBeDisabledOnConfigFailure @ 0x1C0022B94
 * Callers:
 *     HUBDSM_CheckingIfEndpointsToBeDisabledOnDetach @ 0x1C001EDF0 (HUBDSM_CheckingIfEndpointsToBeDisabledOnDetach.c)
 * Callees:
