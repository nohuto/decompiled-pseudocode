/*
 * XREFs of HUBFDO_IoctlGetDescriptorFromNodeConnection @ 0x1C0068680
 * Callers:
...
LABEL_38:
    ...
    if ( (unsigned __int16)(*(_WORD *)(v15 + 2148) - v20) < (unsigned __int64)(unsigned int)a3 - 12 )
      v8 = (unsigned __int16)(*(_WORD *)(v15 + 2148) - v20);
...
LABEL_40:
  ...
  WPP_RECORDER_SF_d(v10[314], 2u, 3u, 0x29u, (__int64)&WPP_4a56a43616cc3150b1f03ded22a040ae_Traceguids, v11);
  return HUBFDO_CompleteGetDescriptorRequest((__int64)v10, v7, v33, v12, v8);
}
