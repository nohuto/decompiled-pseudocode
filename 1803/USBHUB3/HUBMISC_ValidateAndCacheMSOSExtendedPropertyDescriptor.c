/*
 * XREFs of HUBMISC_ValidateAndCacheMSOSExtendedPropertyDescriptor @ 0x1C002B1FC
 * Callers:
 *     HUBDSM_ValidatingMSOSExtendedPropertyDescriptor @ 0x1C001E960 (HUBDSM_ValidatingMSOSExtendedPropertyDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBMISC_ValidateAndCacheMSOSExtendedPropertyDescriptor(__int64 a1)
{
  ...
  if ( *v2 > 0x1000u )
  {
    ...
    v7 = 72;
LABEL_25:
    WPP_RECORDER_SF_(v6, 2u, 5u, v7, (__int64)&WPP_6dc2a34f378238ba241799b961c3ba51_Traceguids);
