/*
 * XREFs of HUBUCX_DeleteDeviceFromUCX @ 0x1C0021E20
 * Callers:
 ...
 *     HUBDSM_DeletingUCXDeviceOnOperationFailureFor30OnHubSuspend @ 0x1C001B190 (HUBDSM_DeletingUCXDeviceOnOperationFailureFor30OnHubSuspend.c)
 * Callees:
