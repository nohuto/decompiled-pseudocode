/*
 * XREFs of HUBDESC_ValidateMsOs20ConfigurationSubset @ 0x1C00344F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x134u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
...
LABEL_4:
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 96), 2u, 5u, 0x135u, (__int64)&WPP_6a2c9542c6d8380783208b53af0e836a_Traceguids);
  return v8;
}
