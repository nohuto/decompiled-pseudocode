/*
 * XREFs of HUBMISC_CheckIfDeviceProgrammingWasLost @ 0x1C0029BCC
 * Callers:
 *     HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum @ 0x1C001AF50 (HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum.c)
 * Callees:
 *     <none>
 */
