/*
 * XREFs of ?VidMmReserveGpuVirtualAddressRangeCb@VIDMM_GLOBAL@@QEAAJPEAU_DXGKARGCB_RESERVEGPUVIRTUALADDRESSRANGE@@@Z @ 0x1C0068E10
 * Callers:
 *     VidMmReserveGpuVirtualAddressRangeCb @ 0x1C00040B0 (VidMmReserveGpuVirtualAddressRangeCb.c)
 * Callees:
...
int __fastcall VIDMM_GLOBAL::VidMmReserveGpuVirtualAddressRangeCb(
        VIDMM_GLOBAL *this,
...
LABEL_34:
  ...
  v5 = v2->BaseAddress;
  v6 = (1LL << *((_DWORD *)this + 10361) << 12) - 1;
  if ( v5 && (v5 & v6) != 0 )
  {
    v17 = WdLogNewEntry5_WdAssertion(v5, a2);
    *(_QWORD *)(v17 + 24) = 20800LL;
    goto LABEL_34;
  }
  v7 = v2->SizeInBytes;
  if ( !v7 || (v7 & v6) != 0 )
...
LABEL_9:
  ...
  v10 = 1;
  if ( *(_BYTE *)(*((_QWORD *)v2->hDxgkProcess + 4) + 321LL) )
  {
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      else if ( (*(_BYTE *)(*((_QWORD *)this + 5090) + v12 + 436) & 1) != 0 )
      {
        return -1073741811;
      }
      ++v11;
