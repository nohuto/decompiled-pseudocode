/*
 * XREFs of ?ReserveVPRResource@VIDMM_SEGMENT@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@EE@Z @ 0x1C00B4300
 * Callers:
 ...
 *     ?GetMoveableResourceCallback@VIDMM_GLOBAL@@QEAAP6A_NPEAU_VIDMM_GLOBAL_ALLOC@@@ZXZ @ 0x1C00A0910 (-GetMoveableResourceCallback@VIDMM_GLOBAL@@QEAAP6A_NPEAU_VIDMM_GLOBAL_ALLOC@@@ZXZ.c)
        ...
        char a4)
{
  ...
  unsigned __int64 v29; // [rsp+138h] [rbp+6Fh]
  ...
  if ( (int)v9 < 0 )
  {
    VIDMM_SEGMENT::TrimOfferLists(this, 1LL, v29, *((unsigned int *)a2 + 8));
    LODWORD(v9) = VIDMM_LINEAR_POOL::Allocate(
                    *((VIDMM_LINEAR_POOL **)this + 19),
                    v29,
                    v26,
    ...
    if ( (int)v9 < 0 )
    {
      if ( *((_QWORD *)this + 55) + v29 < (unsigned __int64)(unsigned int)dword_1C0047440
                                        * *((_QWORD *)this + 54)
                                        / (unsigned int)dword_1C0047444 )
      {
        v17 = v4;
        v18 = (VIDMM_GLOBAL *)*((_QWORD *)this + 1);
        v28 = 0;
        if ( (*(_DWORD *)(352LL * *((unsigned int *)this + 95) + *(_QWORD *)(*((_QWORD *)v18 + 3) + 2360LL) + 16) & 4) != 0 )
        {
      ...
      else
      {
        ...
        if ( (int)v9 < 0 )
        {
          ...
          if ( (*(_DWORD *)(352LL * *((unsigned int *)this + 95) + *(_QWORD *)(*((_QWORD *)v10 + 3) + 2360LL) + 16) & 4) != 0 )
          {
