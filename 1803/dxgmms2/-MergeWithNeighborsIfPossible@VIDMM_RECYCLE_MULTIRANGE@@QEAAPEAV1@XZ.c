/*
 * XREFs of ?MergeWithNeighborsIfPossible@VIDMM_RECYCLE_MULTIRANGE@@QEAAPEAV1@XZ @ 0x1C006EF50
 * Callers:
 ...
 *     ?MarkAllRangesWithNewOwner@VIDMM_RECYCLE_MULTIRANGE@@QEAAXXZ @ 0x1C006F868 (-MarkAllRangesWithNewOwner@VIDMM_RECYCLE_MULTIRANGE@@QEAAXXZ.c)
        ...
        PSLIST_ENTRY ListEntry)
{
  ...
  __int64 v47; // rcx
  __int64 v48; // r8
  struct _SLIST_ENTRY *v49; // [rsp+70h] [rbp+8h]
  __int64 v50; // [rsp+70h] [rbp+8h]
  __int64 v51; // [rsp+78h] [rbp+10h]
  struct _SLIST_ENTRY *v52; // [rsp+78h] [rbp+10h]
  ...
  if ( v2 )
  {
    if ( v5 )
    {
      ...
      {
        v37 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v5 - 1, v6, v2);
        v37[3] = 270LL;
        v37[4] = 52LL;
        v37[5] = 10LL;
        v37[6] = 0LL;
  ...
  if ( v9 )
  {
    ...
    if ( v12 )
    {
      ...
      if ( (_DWORD)v13 )
      {
        ...
        {
          v38 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v13, v10, v9);
          v38[3] = 270LL;
          v38[4] = 52LL;
          v38[5] = 10LL;
          v38[6] = 0LL;
  ...
  if ( v7 )
  {
    if ( v11 )
    {
      v25 = *((_DWORD *)&v4[5].Next + 2);
      v52 = v7[4].Next;
      v53 = *((_QWORD *)&v11[4].Next + 1);
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree(v4[5].Next[2].Next, v25, v7);
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree(v4[5].Next[2].Next, v25, v4);
      VIDMM_RECYCLE_HEAP::RemoveMultirangeFromTree(v4[5].Next[2].Next, v25, v11);
      v26 = v7[6].Next;
      v27 = v7[2].Next;
      v50 = *((_QWORD *)&v11[2].Next + 1);
      v28 = *((_QWORD *)&v3[2].Next->Next + 1);
      if ( v26 )
      {
      ...
      {
        ++*(_DWORD *)(v29 + 32);
        (*(void (__fastcall **)(struct _SLIST_ENTRY *, __int64))(v29 + 56))(v7, v29);
      }
      else
      {
        ExpInterlockedPushEntrySList((PSLIST_HEADER)v29, v7);
      }
      v30 = v4[6].Next;
      ...
      {
        ++*(_DWORD *)(v32 + 32);
        (*(void (__fastcall **)(PSLIST_ENTRY, __int64))(v32 + 56))(v4, v32);
      }
      else
      {
        ExpInterlockedPushEntrySList((PSLIST_HEADER)v32, v4);
      }
      v33 = v11[6].Next;
      ...
      {
        ++*(_DWORD *)(v35 + 32);
        (*(void (__fastcall **)(PSLIST_ENTRY, __int64))(v35 + 56))(v11, v35);
      }
      else
      {
        ExpInterlockedPushEntrySList((PSLIST_HEADER)v35, v11);
      }
      ...
      if ( v4
        || (v39 = *(unsigned int *)(v36 + 44),
            v40 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(v36 + 48),
            v41 = *(unsigned int *)(v36 + 40),
            v42 = *(unsigned int *)(v36 + 36),
            ++*(_DWORD *)(v36 + 24),
            (v4 = (PSLIST_ENTRY)v40(v42, v39, v41, v36)) != 0LL) )
      {
        VIDMM_RECYCLE_MULTIRANGE::Init(v4, v5, v3, v27, v50);
      }
      v4[4].Next = v52;
      *((_QWORD *)&v4[4].Next + 1) = v53;
      VIDMM_RECYCLE_MULTIRANGE::MarkAllRangesWithNewOwner((VIDMM_RECYCLE_MULTIRANGE *)v4);
      VIDMM_RECYCLE_HEAP::AddMultirangeToTree(v3[2].Next, v25, v4);
  ...
  {
    ++*(_DWORD *)(v22 + 32);
    (*(void (__fastcall **)(PSLIST_ENTRY, __int64))(v22 + 56))(v11, v22);
  }
  else
  {
    ExpInterlockedPushEntrySList((PSLIST_HEADER)v22, v11);
  }
  v23 = *(_QWORD *)(*((_QWORD *)&v3[2].Next->Next + 1) + 1320LL);
  ++*(_DWORD *)(v23 + 20);
  v4 = ExpInterlockedPopEntrySList((PSLIST_HEADER)v23);
  if ( v4
    || (v44 = *(unsigned int *)(v23 + 44),
        v45 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(v23 + 48),
        v46 = *(unsigned int *)(v23 + 40),
        v47 = *(unsigned int *)(v23 + 36),
        ++*(_DWORD *)(v23 + 24),
        (v4 = (PSLIST_ENTRY)v45(v47, v44, v46, v23)) != 0LL) )
  {
    VIDMM_RECYCLE_MULTIRANGE::Init(v4, v5, v3, v16, v17);
  }
  v4[4].Next = v49;
  *((_QWORD *)&v4[4].Next + 1) = v51;
  VIDMM_RECYCLE_MULTIRANGE::MarkAllRangesWithNewOwner((VIDMM_RECYCLE_MULTIRANGE *)v4);
