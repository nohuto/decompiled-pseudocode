/*
 * XREFs of ?RecordVaPagingHistoryVirtualFill@VIDMM_GLOBAL@@QEAAXPEAU_DXGKARG_BUILDPAGINGBUFFER@@KPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00ACB3C
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a4)
{
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    ...
    if ( v8 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = 6;
