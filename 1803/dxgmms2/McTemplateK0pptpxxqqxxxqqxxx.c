/*
 * XREFs of McTemplateK0pptpxxqqxxxqqxxx @ 0x1C0017548
 * Callers:
...
__int64 McTemplateK0pptpxxqqxxxqqxxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v34 = 8LL;
  v36 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpVirtualTransfer, a3, 17LL, v4);
}
