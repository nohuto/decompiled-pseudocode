/*
 * XREFs of ?UpdatePageTableInvalidate@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@II_KU_DXGK_UPDATEPAGETABLEFLAGS@@@Z @ 0x1C00594C0
 * Callers:
        ...
        struct _DXGK_UPDATEPAGETABLEFLAGS a6)
{
  ...
  if ( (int)VIDMM_PAGE_TABLE_BASE::GetDriverUpdateAddress(this, a2, &v20, &v21, &v19) < 0 )
  {
    ...
    *(_QWORD *)(v18 + 24) = 3690LL;
    WdLogEvent5_WdError(v18);
    return 3221225473LL;
  }
  else
  {
    if ( (*((_BYTE *)v6 + 41448) & 0x10) != 0 )
