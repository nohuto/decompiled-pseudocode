/*
 * XREFs of ?FreeFenceStorageSlot@VIDMM_PROCESS_FENCE_STORAGE@@QEAAXPEAUVIDMM_MONITORED_FENCE_STORAGE@@@Z @ 0x1C0012060
 * Callers:
...
void __fastcall VIDMM_PROCESS_FENCE_STORAGE::FreeFenceStorageSlot(KSPIN_LOCK *this, KSPIN_LOCK **a2)
{
  ...
  v5 = *v4;
  if ( *(KSPIN_LOCK **)(*v4 + 8) != v4 || (v6 = (KSPIN_LOCK **)v4[1], *v6 != v4) )
    __fastfail(3u);
  *v6 = (KSPIN_LOCK *)v5;
  *(_QWORD *)(v5 + 8) = v6;
  v7 = (KSPIN_LOCK **)(this + 3);
  v8 = this[3];
  if ( *(KSPIN_LOCK **)(v8 + 8) != this + 3 )
    __fastfail(3u);
  *v4 = v8;
  v4[1] = (KSPIN_LOCK)v7;
  *(_QWORD *)(v8 + 8) = v4;
