/*
 * XREFs of ?GetTotalSegmentSize@VIDMM_GLOBAL@@QEAAXIPEA_K00000@Z @ 0x1C0068344
 * Callers:
 *     VidMmGetTotalSegmentSize @ 0x1C0003AE0 (VidMmGetTotalSegmentSize.c)
 * Callees:
        ...
        unsigned __int64 *a8)
{
  ...
  *a8 = 0LL;
  v14 = 0LL;
  v15 = (_DWORD *)(*((_QWORD *)this + 5090) + 1560LL * a2);
  v16 = v15[6];
  if ( v16 )
  {
    v17 = *((_QWORD *)this + 464);
  ...
  *a8 = v12;
  ...
  if ( Current )
    v26 = *(_QWORD *)(368LL * *(unsigned int *)(*((_QWORD *)this + 3) + 200LL) + *((_QWORD *)Current + 4) + 16);
  v28 = *a8;
  if ( *a8 > v26 )
  {
    *a8 = v26;
  ...
  v29 = *((_DWORD *)this + 10360);
  if ( v28 > 1LL << v29 && (*((_BYTE *)this + 41448) & 2) != 0 )
    *a8 = 1LL << v29;
  if ( Current )
  {
