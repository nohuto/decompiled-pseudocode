/*
 * XREFs of VidSchiUpdateLastCompletedPresentTimestamp @ 0x1C000C050
 * Callers:
...
LONGLONG __fastcall VidSchiUpdateLastCompletedPresentTimestamp(__int64 a1, char a2, char a3)
{
  ...
  else
  {
    ...
    if ( v19 < *(_QWORD *)(v8.QuadPart + 2720) )
      return result;
    v15 = v9;
  }
...
LABEL_39:
  ...
  if ( !*(_DWORD *)(v8.QuadPart + 64) )
    goto LABEL_20;
  do
  {
    v28 = *(_QWORD *)(v8.QuadPart + 8LL * v26 + 440);
    if ( (v27 & *(_DWORD *)(v28 + 1736)) != 0 || (v27 & *(_DWORD *)(v28 + 1740)) != 0 )
    {
      v48 = (unsigned __int64 *)(v28 + 8 * (v15 + 242));
      v46 = *v48;
...
LABEL_18:
  ...
  while ( v26 < *(_DWORD *)(v8.QuadPart + 64) );
  v16 = v49;
  v9 = v45;
  if ( v25 )
  {
...
LABEL_20:
  for ( i = 0; i < *(_DWORD *)(v8.QuadPart + 64); ++i )
  {
    v30 = *(_QWORD *)(v8.QuadPart + 8LL * i + 440);
    *(_QWORD *)(v30 + 8 * v15 + 1904) = 0LL;
    *(_QWORD *)(v30 + 8 * v15 + 1936) = 0LL;
    *(LARGE_INTEGER *)(v30 + 8 * v15 + 1872) = v16;
    v31 = *(_QWORD *)(v30 + 8LL * *(unsigned int *)(v30 + 1552) + 1560);
    if ( v31 && gulPriorityToYieldPriorityBand[*(unsigned int *)(v31 + 404)] >= (int)v9 && v16.QuadPart )
      *(LARGE_INTEGER *)(v30 + 8 * v15 + 1904) = v16;
    if ( v25
      && *(_BYTE *)(v30 + 1992)
      && !*(_QWORD *)(v30 + 1968)
      && v31
      && *(_DWORD *)(v31 + 404) <= *(_DWORD *)(v8.QuadPart + 176) )
    {
      refreshed = VidSchiMonitorRefreshPeriodFromNode(v30);
      VidSchiStartNodeYield(v30, v16.QuadPart, PerformanceFrequency.QuadPart, refreshed);
      v15 = (int)v9;
    }
  }
  result = (LONGLONG)v50;
