/*
 * XREFs of ?ProcessPendingTerminations@VIDMM_WORKER_THREAD@@AEAAX_NPEA_N1@Z @ 0x1C009E168
 * Callers:
...
void __fastcall VIDMM_WORKER_THREAD::ProcessPendingTerminations(KSPIN_LOCK **this, char a2, bool *a3, bool *a4)
{
  ...
  *a3 = 0;
  ...
  while ( 1 )
  {
    ...
    LODWORD(v12[0]) = 200;
    VIDMM_GLOBAL::ProcessDeferredCommand(v10, (__int64)v12, &v13, 0, 0LL, 0LL, 0, &v14);
    *a3 = 1;
    if ( !a2 )
      break;
    v7 = *this;
