/*
 * XREFs of ?RemoveFenceGpuData@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_FENCE_STORAGE_PAGE_GPU_DATA@@@Z @ 0x1C006B59C
 * Callers:
...
void __fastcall VIDMM_GLOBAL::RemoveFenceGpuData(VIDMM_GLOBAL *this, struct VIDMM_FENCE_STORAGE_PAGE_GPU_DATA *a2)
{
  ...
  *(_QWORD *)(v5 + 8) = v6;
  if ( *((_BYTE *)this + 40676) )
    DpiUnmapIommuIdentityRange(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 6) + 24LL) + 192LL), *((_QWORD *)a2 + 7));
  if ( v9 )
  {
    v7 = v8;
    *(_QWORD *)(v8 + 8) = 0LL;
