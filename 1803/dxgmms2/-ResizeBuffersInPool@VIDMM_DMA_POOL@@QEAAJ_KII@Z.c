/*
 * XREFs of ?ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z @ 0x1C00A9808
 * Callers:
 *     VidMmResizeBuffersInPool @ 0x1C00234D0 (VidMmResizeBuffersInPool.c)
 * Callees:
