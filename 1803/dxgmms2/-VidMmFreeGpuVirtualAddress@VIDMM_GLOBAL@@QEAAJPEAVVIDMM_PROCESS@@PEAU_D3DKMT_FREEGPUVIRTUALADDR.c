/*
 * XREFs of ?VidMmFreeGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAU_D3DKMT_FREEGPUVIRTUALADDRESS@@E@Z @ 0x1C0069298
 * Callers:
 *     VidMmFreeGpuVirtualAddress @ 0x1C0003B60 (VidMmFreeGpuVirtualAddress.c)
