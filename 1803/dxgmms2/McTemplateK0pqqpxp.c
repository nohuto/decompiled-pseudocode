/*
 * XREFs of McTemplateK0pqqpxp @ 0x1C0029478
 * Callers:
...
NTSTATUS McTemplateK0pqqpxp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventWaitQueueSubmit, a3, 7u, &v4);
}
