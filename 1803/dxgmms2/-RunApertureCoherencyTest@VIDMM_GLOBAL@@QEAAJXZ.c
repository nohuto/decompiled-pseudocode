/*
 * XREFs of ?RunApertureCoherencyTest@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C00B527C
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::RunApertureCoherencyTest(VIDMM_GLOBAL *this, __int64 a2)
{
  ...
  {
LABEL_5:
    v10 = WdLogNewEntry5_WdWarning(v5, a2);
    WdLogEvent5_WdWarning(v10);
  }
  else
  {
    v6 = (*(__int64 (__fastcall **)(_DWORD *, __int64, __int64 *, unsigned __int64 *))(*(_QWORD *)v9 + 184LL))(
           v9,
           1LL,
           &v31,
           &v30);
        ...
        && v22 )
      {
        ...
        if ( *((_DWORD *)this + 926) )
        {
          while ( 1 )
          {
            ...
            {
              v6 = VIDMM_GLOBAL::ValidateApertureCoherency(this, v7, v30, v23, PagesForMdl, v2, v21, v4, 0);
              if ( v6 < 0 )
                break;
            }
...
LABEL_20:
          ...
          if ( v2 && v24 )
          {
            for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 926); i = (unsigned int)(i + 1) )
            {
              ...
              {
                v6 = VIDMM_GLOBAL::ValidateApertureCoherency(this, v7, v30, i, PagesForMdl, v2, v21, v4, 1u);
                if ( v6 < 0 )
                  break;
              }
            }
