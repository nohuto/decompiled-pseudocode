/*
 * XREFs of ?LogMemoryState@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAU_GUID@@@Z @ 0x1C00B71DC
 * Callers:
...
void __fastcall VIDMM_COMMIT_TELEMETRY::LogMemoryState(VIDMM_COMMIT_TELEMETRY *this, struct _GUID *a2)
{
  ...
  {
    v3 = "Discrete";
    if ( (*(_BYTE *)(*(_QWORD *)(*(_QWORD *)this + 40720LL) + 536LL) & 2) == 0 )
      v3 = "Integrated";
      ...
      && (qword_1C0047068 & 0x400000000008LL) == qword_1C0047068 )
    {
      ...
      TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003A9DA, v8, v7, 5u, &pData);
    }
    ...
    if ( *(_DWORD *)(*(_QWORD *)this + 6992LL) )
    {
      ...
      do
      {
        SegmentGroupState = VIDMM_GLOBAL::GetSegmentGroupState(
                              ...
                              *(struct VIDMM_PARTITION **)(v10 + 240));
        ...
        if ( (unsigned int)hProvider <= 5 )
          goto LABEL_22;
        if ( (qword_1C0047060 & 0x400000000008LL) == 0 || (v22 = 1, (v13 & 0x400000000008LL) != v13) )
          v22 = 0;
        if ( v22 )
        {
          v23 = *(unsigned __int16 **)(*(_QWORD *)(v11 + 24) + 1344LL);
          v38 = &v41;
          v39 = 2LL;
          v24 = *v23;
          v40 = *((_QWORD *)v23 + 1);
          ...
          *(_QWORD *)&pDesc.Size = 6LL;
          ...
          v49 = 8LL;
          v25 = a2;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003A95B, a2, (LPCGUID)v18, 8u, &pData);
          v18 = v35;
          v11 = *(_QWORD *)this;
          v13 = qword_1C0047068;
        }
...
LABEL_22:
        ...
        if ( (*(_BYTE *)(1560LL * v12 + *(_QWORD *)(v11 + 40720) + 536) & 2) != 0 )
        {
          v32 = *((_QWORD *)v18 + 1);
          v33 = *((_QWORD *)v18 + 14);
          v26 = 100 * v33 / v32;
          ...
          if ( (unsigned int)hProvider > 5 )
          {
            if ( (qword_1C0047060 & 0x400000000008LL) == 0 || (v28 = 1, (v13 & 0x400000000008LL) != v13) )
              v28 = 0;
            if ( v28 )
            {
              v29 = *(unsigned __int16 **)(*(_QWORD *)(v11 + 24) + 1344LL);
              v38 = &v41;
              v39 = 2LL;
              v30 = *v29;
              v40 = *((_QWORD *)v29 + 1);
              ...
              *(_QWORD *)&pDesc.Size = 9LL;
              ...
              v36 = v27;
              v49 = 8LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003A95B, v25, (LPCGUID)v18, 8u, &pData);
              v11 = *(_QWORD *)this;
              v13 = qword_1C0047068;
            }
          }
