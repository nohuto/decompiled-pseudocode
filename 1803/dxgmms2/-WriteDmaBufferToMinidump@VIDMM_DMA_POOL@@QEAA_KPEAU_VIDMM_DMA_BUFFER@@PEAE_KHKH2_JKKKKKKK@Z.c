/*
 * XREFs of ?WriteDmaBufferToMinidump@VIDMM_DMA_POOL@@QEAA_KPEAU_VIDMM_DMA_BUFFER@@PEAE_KHKH2_JKKKKKKK@Z @ 0x1C00A9A58
 * Callers:
        ...
        unsigned int a16)
{
  ...
  size_t v55; // [rsp+30h] [rbp-69h]
  unsigned __int64 v56; // [rsp+38h] [rbp-61h]
  __int128 v57; // [rsp+58h] [rbp-41h]
  __int128 v58; // [rsp+68h] [rbp-31h]
  __int128 v59; // [rsp+78h] [rbp-21h]
  unsigned int v60; // [rsp+E8h] [rbp+4Fh]
  int v64; // [rsp+108h] [rbp+6Fh]
  unsigned int v65; // [rsp+110h] [rbp+77h]
  unsigned int v66; // [rsp+118h] [rbp+7Fh]
  ...
  *((_QWORD *)&v59 + 1) = __PAIR64__(v25, v65);
  *(_QWORD *)&v57 = __PAIR64__(a10, v20);
  ...
  if ( v26 && v26 <= v16 )
  {
    memmove(v17, *(const void **)(*((_QWORD *)v18 + 7) + 368LL), v26);
    v17 += v26;
    v51 += v26;
    v16 -= v26;
  }
  ...
  if ( v60 && v52 <= v16 )
  {
    memmove(v17, (const void *)(*((_QWORD *)v18 + 15) + 24LL * v65), 24LL * v60);
    v17 += v52;
    v51 += v52;
    v16 -= v52;
  }
  ...
  if ( v54 )
  {
    if ( v53 <= v16 )
    {
      memmove(v17, (const void *)(*((_QWORD *)v18 + 14) + 24LL * v27), 24LL * v54);
      v51 += v53;
    }
  }
  return v51;
