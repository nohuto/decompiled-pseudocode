/*
 * XREFs of ?AddCommitment@VIDMM_PROCESS@@QEAAXPEAU_VIDMM_DEVICE_COMMITMENT_INFO@@KPEAVVIDMM_SEGMENT@@EPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0074550
 * Callers:
...
LABEL_6:
  ...
  {
    PriorityClass = VIDMM_SEGMENT::GetPriorityClass(*((_DWORD *)a6 + 94));
