/*
 * XREFs of ?ReadCommitLimitInformation@VIDMM_GLOBAL@@KAXXZ @ 0x1C0085A2C
 * Callers:
...
void VIDMM_GLOBAL::ReadCommitLimitInformation(void)
{
  ...
  dword_1C0047478 = v1;
  dword_1C004747C = v8 << 20;
  dword_1C0047480 = v2;
  dword_1C0047484 = v4;
  if ( !v0 )
    qword_1C0047180 = (unsigned __int64)qword_1C0047168 >> 3;
}
