/*
 * XREFs of ??1VIDMM_PROCESS_FENCE_STORAGE@@QEAA@XZ @ 0x1C0077AE0
 * Callers:
...
void __fastcall VIDMM_PROCESS_FENCE_STORAGE::~VIDMM_PROCESS_FENCE_STORAGE(VIDMM_PROCESS_FENCE_STORAGE *this)
{
  ...
  while ( 1 )
  {
    ...
    if ( *((VIDMM_FENCE_STORAGE_PAGE ***)v5 + 1) != v4
      || (v8 = *(VIDMM_FENCE_STORAGE_PAGE **)v5, *(VIDMM_FENCE_STORAGE_PAGE **)(*(_QWORD *)v5 + 8LL) != v5) )
    {
      __fastfail(3u);
    }
    *v4 = v8;
  ...
  while ( 1 )
  {
    ...
    if ( *((VIDMM_FENCE_STORAGE_PAGE ***)v7 + 1) != v6
      || (v10 = *(VIDMM_FENCE_STORAGE_PAGE **)v7, *(VIDMM_FENCE_STORAGE_PAGE **)(*(_QWORD *)v7 + 8LL) != v7) )
    {
      __fastfail(3u);
    }
    *v6 = v10;
