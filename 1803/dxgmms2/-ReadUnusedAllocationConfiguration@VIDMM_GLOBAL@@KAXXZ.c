/*
 * XREFs of ?ReadUnusedAllocationConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C0085374
 * Callers:
...
void VIDMM_GLOBAL::ReadUnusedAllocationConfiguration(void)
{
  ...
  xmmword_1C0047240 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C0047260 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C0047250 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C0047280 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v6 = 1000000;
  v11 = 1000000;
  xmmword_1C0047270 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v1 = 1;
  v3 = 15;
  v8 = 1;
  v12 = 15;
  v13 = 15;
  qword_1C0047238 = 1LL;
  xmmword_1C0047310 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v2 = 0;
  v4 = 45;
  v5 = 120;
  v7 = 0;
  ...
  v14 = 30;
  v15 = 30;
  xmmword_1C0047300 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  ...
  LODWORD(v16[6]) = 4;
  v16[3] = &qword_1C0047238;
  v16[5] = &v1;
  v16[9] = L"Unused.MinimumThreshold";
  v16[10] = &xmmword_1C0047240;
  v16[12] = &v2;
  v16[16] = L"Unused.LowThreshold";
  v16[17] = (char *)&xmmword_1C0047240 + 8;
  v16[19] = &v3;
  v16[23] = L"Unused.NormalThreshold";
  v16[24] = &xmmword_1C0047250;
  v16[26] = &v4;
  v16[7] = 0LL;
  LODWORD(v16[8]) = 288;
  ...
  qword_1C0047238 *= 10000000LL;
  *(_QWORD *)&xmmword_1C0047240 = 10000000 * xmmword_1C0047240;
  *((_QWORD *)&xmmword_1C0047240 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0047250 = 10000000 * xmmword_1C0047250;
  *((_QWORD *)&xmmword_1C0047250 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0047260 = 10000000 * xmmword_1C0047260;
  *((_QWORD *)&xmmword_1C0047260 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0047270 = 10000000 * xmmword_1C0047270;
  *((_QWORD *)&xmmword_1C0047270 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C0047280 = 10000000 * xmmword_1C0047280;
  *((_QWORD *)&xmmword_1C0047280 + 1) *= 10000000LL;
  do
  {
    *(_QWORD *)v0 *= 10000000LL;
    v0 = (__int128 *)((char *)v0 + 8);
  }
  while ( (__int64)v0 < (__int64)&qword_1C0047320 );
}
