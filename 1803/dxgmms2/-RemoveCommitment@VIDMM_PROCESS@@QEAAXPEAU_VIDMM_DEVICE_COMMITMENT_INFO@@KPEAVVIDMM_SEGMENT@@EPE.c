/*
 * XREFs of ?RemoveCommitment@VIDMM_PROCESS@@QEAAXPEAU_VIDMM_DEVICE_COMMITMENT_INFO@@KPEAVVIDMM_SEGMENT@@EPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00746CC
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a6)
{
  ...
  *(_QWORD *)(v13 + 16) -= v10;
  ...
  if ( *(struct _VIDMM_DEVICE_COMMITMENT_INFO **)(v19 + 8) != (struct _VIDMM_DEVICE_COMMITMENT_INFO *)((char *)a2 + 16)
    || (v20 = (_QWORD *)*((_QWORD *)a2 + 3), *v20 != v14) )
  {
    __fastfail(3u);
  }
  *v20 = v19;
...
LABEL_6:
  ...
  {
    v21 = *v16;
    if ( *(_QWORD **)(*v16 + 8LL) != v16 || (v22 = (_QWORD *)v16[1], (_QWORD *)*v22 != v16) )
      __fastfail(3u);
    *v22 = v21;
    *(_QWORD *)(v21 + 8) = v22;
    *v16 = 0LL;
  ...
  if ( ((unsigned __int16)Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
    McTemplateK0xxpqhc(v17[5], &EventVidMmProcessCommitmentChange, *v17);
  if ( (*((_DWORD *)a4 + 20) & 0x1001) != 0 && (*((_DWORD *)a6 + 19) & 0x400) == 0 )
  {
    PriorityClass = (int)VIDMM_SEGMENT::GetPriorityClass(*((_DWORD *)a6 + 94));
    *(_QWORD *)(v18 + 8 * PriorityClass + 256) -= v10;
    if ( ((unsigned __int16)Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
      McTemplateK0xxpqhc(*((_WORD *)a6 + 38) & 0x3F, &EventVidMmProcessDemotedCommitmentChange, PriorityClass);
  }
}
