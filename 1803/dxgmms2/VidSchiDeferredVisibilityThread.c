/*
 * XREFs of VidSchiDeferredVisibilityThread @ 0x1C002A970
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchiDeferredVisibilityThread(__int64 a1)
{
  ...
  {
    v3 = 0;
    v4 = *(_QWORD *)(*(_QWORD *)(a1 + 2464) + 528LL);
    _InterlockedExchange((volatile __int32 *)(v4 + 2112), 0);
    if ( *(_DWORD *)(v4 + 40) )
    {
      do
      {
        if ( _InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(v4 + 8LL * v3 + 3032) + 61280LL), 0, 3) == 3 )
        {
          LOBYTE(v2) = 1;
          LOBYTE(v11) = 0;
