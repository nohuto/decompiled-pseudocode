/*
 * XREFs of ?RecordVaPagingHistoryFlushTlb@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAU_DXGK_BUILDPAGINGBUFFER_FLUSHTLB@@I@Z @ 0x1C00ABECC
 * Callers:
        ...
        int a4)
{
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    ...
    if ( v8 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = 5;
