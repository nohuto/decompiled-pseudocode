/*
 * XREFs of McTemplateK0pppxqq @ 0x1C0025724
 * Callers:
...
NTSTATUS McTemplateK0pppxqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingQueueSubmitSystem, a3, 7u, &v4);
}
