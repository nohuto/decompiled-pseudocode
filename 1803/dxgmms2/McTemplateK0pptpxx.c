/*
 * XREFs of McTemplateK0pptpxx @ 0x1C00172A4
 * Callers:
...
__int64 McTemplateK0pptpxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  _BYTE v4[16]; // [rsp+30h] [rbp-51h] BYREF
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpSignalMonitoredFence, a3, 7LL, v4);
}
