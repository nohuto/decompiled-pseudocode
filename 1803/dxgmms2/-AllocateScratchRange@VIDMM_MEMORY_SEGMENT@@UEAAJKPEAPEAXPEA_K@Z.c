/*
 * XREFs of ?AllocateScratchRange@VIDMM_MEMORY_SEGMENT@@UEAAJKPEAPEAXPEA_K@Z @ 0x1C00B04D0
 * Callers:
 *     <none>
 * Callees:
        ...
        union _LARGE_INTEGER *a4)
{
  ...
  if ( v5 > 0xFFFFFFFF )
    return 3221225621LL;
  result = VIDMM_LINEAR_POOL::Allocate(this[19], (unsigned int)v5, 0, 1, 0LL, 0LL, 0, 0, 0LL, &v7, a3);
  if ( (int)result >= 0 )
    *a4 = v7;
  return result;
}
