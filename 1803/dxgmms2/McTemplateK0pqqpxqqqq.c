/*
 * XREFs of McTemplateK0pqqpxqqqq @ 0x1C0029538
 * Callers:
...
NTSTATUS McTemplateK0pqqpxqqqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventMMIOFlip, a3, 0xAu, &v4);
}
