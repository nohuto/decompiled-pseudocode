/*
 * XREFs of ?ReleaseResource@VIDMM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAX_K@Z @ 0x1C00727F0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a3 )
  {
    ...
    if ( *((_DWORD *)this + 92) != -1 && v6 && (*((_DWORD *)v6 + 19) & 0x200) == 0 )
    {
      ...
      if ( v20 < a4 )
      {
        ...
        *(_QWORD *)(v22 + 24) = 1931LL;
        WdLogEvent5_WdAssertion(v22);
        v21 = this[29];
      }
      v23 = (unsigned __int64)v21 - a4;
      this[29] = (VIDMM_GLOBAL *)v23;
      if ( v20 > qword_1C0047410 && v23 <= qword_1C0047410 )
      {
        (*((void (__fastcall **)(_QWORD, _QWORD))this[1] + 5075))(
          *((_QWORD *)this[1] + 5081),
    ...
    if ( ((_DWORD)this[10] & 0x1001) != 0 )
    {
      ...
      {
        v12 = **((_QWORD **)v6 + 61);
        v13 = _InterlockedExchangeAdd64((volatile signed __int64 *)(v12 + 56), -(__int64)a4);
        if ( v13 < a4 )
        {
          v24 = WdLogNewEntry5_WdAssertion(v12, v13);
          *(_QWORD *)(v24 + 24) = 1957LL;
          WdLogEvent5_WdAssertion(v24);
        }
      }
      *((_QWORD *)this[1] + 5088) -= a4;
    }
  }
  else
  {
