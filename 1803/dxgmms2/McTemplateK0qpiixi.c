/*
 * XREFs of McTemplateK0qpiixi @ 0x1C002A284
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qpiixi(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventContextHasNegativeQuantum, a3, 7u, &v10);
}
