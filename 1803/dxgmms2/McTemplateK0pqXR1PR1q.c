/*
 * XREFs of McTemplateK0pqXR1PR1q @ 0x1C0029068
 * Callers:
...
NTSTATUS McTemplateK0pqXR1PR1q(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 0;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventUnwaitCpuWaiter, 0LL, 6u, &v4);
}
