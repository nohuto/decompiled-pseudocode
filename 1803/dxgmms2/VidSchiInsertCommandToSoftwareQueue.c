/*
 * XREFs of VidSchiInsertCommandToSoftwareQueue @ 0x1C0007FE0
 * Callers:
...
__int64 __fastcall VidSchiInsertCommandToSoftwareQueue(__int64 a1, _DWORD *a2)
{
  ...
  v6 = *(_QWORD *)(v2 + 104);
  v7 = *(_QWORD *)(v5 + 24);
  _InterlockedIncrement((volatile signed __int32 *)(v7 + 964));
  _InterlockedIncrement((volatile signed __int32 *)(v5 + 2820));
  _InterlockedIncrement((volatile signed __int32 *)(v6 + 1220));
  v8 = *(unsigned int *)(a1 + 48);
  if ( (unsigned int)(v8 - 4) > 1 )
  {
    _InterlockedIncrement((volatile signed __int32 *)(v6 + 1224));
    v8 = *(unsigned int *)(a1 + 48);
  }
  if ( !(_DWORD)v8 && (*(_DWORD *)(a1 + 72) & 4) != 0 )
  {
    v8 = *(_QWORD *)(v7 + 8LL * *(unsigned int *)(a1 + 160) + 3032);
    _InterlockedExchangeAdd((volatile signed __int32 *)(v8 + 2308), 1u);
  }
  _InterlockedIncrement((volatile signed __int32 *)(v2 + 776));
  ++*(_DWORD *)(v2 + 772);
  ++*(_DWORD *)(v5 + 2816);
  ++*(_DWORD *)(v7 + 960);
  *(_QWORD *)(a1 + 56) = MEMORY[0xFFFFF78000000320];
  *(_DWORD *)(a1 + 52) = 6;
  v9 = (_QWORD *)WdLogNewEntry5_WdEvent(v8, a2);
  v9[3] = a1;
  v9[4] = *(_QWORD *)(a1 + 112);
  v9[5] = v2;
  v9[6] = *(_QWORD *)(v2 + 144);
  ...
  *(_QWORD *)(a1 + 40) = v12;
  *v12 = result;
  *(_QWORD *)(v2 + 664) = result;
  if ( *(_DWORD *)(v2 + 772) == 1 )
  {
    v10 = 0;
    *(_QWORD *)(v2 + 640) = a1;
    v15 = ((unsigned int)(*(_DWORD *)(a1 + 48) - 4) <= 1) | *(_DWORD *)(v2 + 636) & 0xFFFFFFFE;
    v16 = 0;
    *(_DWORD *)(v2 + 636) = v15;
    if ( *(_DWORD *)(a1 + 48) == 3 )
      v16 = 2;
    ...
    *(_DWORD *)(v2 + 636) = (unsigned int)v12 | v20;
              ...
              if ( (result & 0x80u) == 0LL )
              {
                ...
                if ( (result & 0x100) == 0 )
                {
                  ...
                  if ( (result & 0x20) == 0 )
                  {
                    ...
                    result = VidSchiUpdateContextStatus(v2, 5LL, 13896LL);
                    *a2 = result;
                  }
                }
              }
