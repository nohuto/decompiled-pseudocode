/*
 * XREFs of ?ExpandLargePagePte@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEBUVIDMM_PAGE_TABLE_LEVEL_DESC@@E_KIPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00AADA4
 * Callers:
        ...
        struct VIDMM_ALLOC **a7)
{
  ...
  if ( (v22 & (unsigned __int8)v20) == 0 || a4 )
    v20 = 0;
  PageTable = CreatePageTable(a2, (v21 >> 7) & 0x1F, v14, v20);
  v24 = (struct VIDMM_ALLOC **)PageTable;
  if ( !PageTable )
    return 3221225495LL;
  ...
  if ( v28 >= 0 )
  {
    ExFreeToPagedLookasideList(
      (PPAGED_LOOKASIDE_LIST)(*((_QWORD *)a2 + 10) + 40768LL),
  ...
  else
  {
    ...
    VIDMM_PAGE_TABLE::DestroyPageTable(v24, a2, (unsigned __int64)a5);
