/*
 * XREFs of ?PrepareMoveResources@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@W4VIDMM_MOVE_RESOURCES_OPERATION@@I_KW4VIDMM_MOVE_RESOURCES_DEFRAG_STAGE@@22W4VIDMM_DEFRAGMENT_DIRECTION@@PEA_NPEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00A272C
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC **a11)
{
  ...
  v14 = VIDMM_GLOBAL::MoveResources(a1, v13, 0LL, a4, v16, 0, a7, a8, 1u, a10, a11);
