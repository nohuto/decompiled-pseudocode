/*
 * XREFs of ?CloseLocalAllocation@VIDMM_GLOBAL@@IEAAXPEAU_VIDMM_LOCAL_ALLOC@@H@Z @ 0x1C0063330
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( g_IsInternalReleaseOrDbg )
  {
    ...
    a3 = (struct _VIDMM_LOCAL_ALLOC *)*((unsigned int *)a2 + 9);
    *(_QWORD *)(v21 + 24) = a3;
  }
  v8 = **(unsigned int **)(v5 + 504);
  if ( (v8 & 8) != 0 || (v9 = **((_QWORD **)a2 + 1), v9 == PsGetCurrentProcess(v8, a2, a3, a4)) )
  {
    if ( !v4 )
    {
      *(_DWORD *)(v5 + 84) |= 1u;
    ...
    if ( (*((_DWORD *)a2 + 9))-- == 1 )
    {
      if ( *((_DWORD *)a2 + 19) )
      {
        ...
        v17 = *(unsigned int *)(v5 + 344);
        v18 = *((unsigned int *)a2 + 19);
        if ( (unsigned int)v17 < (unsigned int)v18 && g_IsInternalRelease )
        {
          v23 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v17, v18, v16);
          v23[5] = 0LL;
          v23[6] = 0LL;
          v23[7] = 0LL;
          v23[3] = 270LL;
          ...
          LODWORD(v18) = *((_DWORD *)a2 + 19);
        }
        *(_DWORD *)(v5 + 344) = v17 - v18;
