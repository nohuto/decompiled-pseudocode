/*
 * XREFs of VidSchDestroySyncObject @ 0x1C00774D0
 * Callers:
...
LABEL_10:
      ...
      if ( *(_DWORD *)(v3 + 168) != 2 )
      {
        if ( *(_DWORD *)(v3 + 168) != 3 )
        {
          if ( *(_DWORD *)(v3 + 168) != 4 )
          {
            v8 = (unsigned int)(*(_DWORD *)(v3 + 168) - 5);
            if ( *(_DWORD *)(v3 + 168) == 5 )
            {
              if ( ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) == 0 )
                goto LABEL_10;
              v8 = *(unsigned int *)(v3 + 240);
              v27 = *(_QWORD *)(v3 + 176);
              v9 = *(_DWORD *)(v3 + 172);
              v24 = v8;
              goto LABEL_17;
            ...
            if ( *(_DWORD *)(v3 + 168) == 6 )
            {
              if ( ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) == 0 )
                goto LABEL_10;
              v17 = *(unsigned int *)(v3 + 176);
              v18 = *(unsigned int *)(v3 + 240);
              v32 = *(_QWORD *)(v3 + 184);
              v30 = *(_DWORD *)(v3 + 180);
              v19 = *(_DWORD *)(v3 + 172);
              goto LABEL_40;
