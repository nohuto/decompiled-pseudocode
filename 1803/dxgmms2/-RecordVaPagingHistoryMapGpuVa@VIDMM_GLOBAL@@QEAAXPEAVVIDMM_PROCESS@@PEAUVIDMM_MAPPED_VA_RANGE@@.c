/*
 * XREFs of ?RecordVaPagingHistoryMapGpuVa@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAUVIDMM_MAPPED_VA_RANGE@@PEAVVIDMM_PAGING_QUEUE@@_K@Z @ 0x1C00AC1AC
 * Callers:
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    ...
    if ( v9 )
    {
      ...
      *((_QWORD *)this + 5190) = KeGetCurrentThread();
      v10 = *((unsigned int *)this + 10376);
      if ( (_DWORD)v10 == dword_1C004733C )
      {
        *((_DWORD *)this + 10376) = 0;
        v10 = 0LL;
      }
      v11 = *(void **)(*((_QWORD *)this + 5187) + 24 * v10 + 16);
      if ( v11 )
        operator delete(v11);
      *v9 = *(_QWORD *)a2;
      v9[1] = *((_QWORD *)a2 + 4);
      ...
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = 14;
