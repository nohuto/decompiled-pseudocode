/*
 * XREFs of VidSchiCheckNodeTimeout @ 0x1C0077330
 * Callers:
 ...
 *     VidSchiRunningDeviceAllowsLongRunningPackets @ 0x1C002CA3C (VidSchiRunningDeviceAllowsLongRunningPackets.c)
...
__int64 __fastcall VidSchiCheckNodeTimeout(__int64 a1, _QWORD *a2)
{
  ...
  if ( (*(_DWORD *)(a1 + 440) & 2) == 0 && !*(_DWORD *)(a1 + 1996) && !*(_DWORD *)(a1 + 2000) )
  {
    if ( (*(_DWORD *)(a1 + 12) & 2) != 0 )
    {
      if ( !*(_DWORD *)(a1 + 1704) )
...
LABEL_6:
    ...
    *(_QWORD *)(a1 + 456) = MEMORY[0xFFFFF78000000320];
    ...
    if ( v8 * (unsigned __int64)KeQueryTimeIncrement() <= v9 )
      return (*(_DWORD *)(a1 + 440) >> 1) & 1;
    v12 = *(_QWORD *)(a1 + 24);
    if ( (*(_DWORD *)(*(_QWORD *)(v12 + 16) + 300LL) & 0x200) != 0 )
    {
      v13 = __rdtsc();
