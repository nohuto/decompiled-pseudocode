/*
 * XREFs of ?MapApertureRange@VIDMM_APERTURE_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@_K11PEAU_MDL@@HH@Z @ 0x1C007E900
 * Callers:
 *     <none>
 * Callees:
 *     McTemplateK0ppxt @ 0x1C0026010 (McTemplateK0ppxt.c)
 *     ?MapVideoApertureSegment@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@I_K11PEAU_MDL@@HH@Z @ 0x1C00A1924 (-MapVideoApertureSegment@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@I_K11PEAU_MDL@@HH@Z.c)
 */
        ...
        int a8)
{
  ...
  *(_QWORD *)(*((_QWORD *)this + 1) + 8088LL) += a3 << 12;
