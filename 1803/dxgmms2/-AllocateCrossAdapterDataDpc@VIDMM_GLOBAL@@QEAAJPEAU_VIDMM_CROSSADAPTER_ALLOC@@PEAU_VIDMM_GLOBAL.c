/*
 * XREFs of ?AllocateCrossAdapterDataDpc@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0023770
 * Callers:
 ...
 *     VidSchGetRunEvent @ 0x1C0079570 (VidSchGetRunEvent.c)
 */
        ...
        struct _VIDMM_GLOBAL_ALLOC *a3)
{
  ...
  {
    _InterlockedIncrement(&dword_1C00476C0);
    v8 = WdLogNewEntry5_WdLowResource();
    *(_QWORD *)(v8 + 24) = 29912LL;
