/*
 * XREFs of ?UpdateAllocationProperty@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_UPDATEALLOCPROPERTY@@PEA_K@Z @ 0x1C00A442C
 * Callers:
 *     ?VidMmUpdateAllocationProperty@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_ALLOC@@PEAU_VIDMM_UPDATEALLOCPROPERTY@@PEA_K@Z @ 0x1C00230E0 (-VidMmUpdateAllocationProperty@@YAJPEAVVIDMM_GLOBAL@@PEAVVIDMM_PAGING_QUEUE@@PEAU_VIDMM_MULTI_AL.c)
 * Callees:
        ...
        unsigned __int64 *a5)
{
  ...
  *(_OWORD *)((char *)&v26[4] + 4) = *(_OWORD *)a4;
  ...
  if ( (_mm_srli_si128(*(__m128i *)(v26 + 36), 8).m128i_i8[4] & 2) != 0 )
  {
    ...
    if ( !HIDWORD(v26[4]) )
      goto LABEL_3;
    v17 = *((_QWORD *)this + 5090) + 1560LL * v10;
...
LABEL_4:
  ...
  v25 = WdLogNewEntry5_WdWarning(v9, v8);
