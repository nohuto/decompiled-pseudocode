/*
 * XREFs of McTemplateK0pptpxqqx @ 0x1C00171C4
 * Callers:
...
__int64 McTemplateK0pptpxqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpFill, a3, 9LL, v4);
}
