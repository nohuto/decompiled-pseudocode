/*
 * XREFs of ?TransferMemoryFast@VIDMM_MEMORY_SEGMENT@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_DXGK_MEMORY_TRANSFER_DIRECTION@@PEAVVIDMM_SEGMENT@@T_LARGE_INTEGER@@PEA_N@Z @ 0x1C0079844
 * Callers:
 ...
 *     ?ReleaseTemporaryResourcesForAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0079B14 (-ReleaseTemporaryResourcesForAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z.c)
        ...
        bool *a6)
{
  ...
  if ( (*(_DWORD *)(v8 + 7040) & 0x400) == 0 )
  {
    ...
    v29 = 0;
    v13 = *(_BYTE *)(v12 + *(_QWORD *)(v8 + 40720) + 436);
    v14 = *((_QWORD *)a2 + 33);
    v28 = 0LL;
