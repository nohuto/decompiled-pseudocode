/*
 * XREFs of ?InvalidateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C00A0F14
 * Callers:
 *     VidMmInvalidateAllocation @ 0x1C0023320 (VidMmInvalidateAllocation.c)
 * Callees:
