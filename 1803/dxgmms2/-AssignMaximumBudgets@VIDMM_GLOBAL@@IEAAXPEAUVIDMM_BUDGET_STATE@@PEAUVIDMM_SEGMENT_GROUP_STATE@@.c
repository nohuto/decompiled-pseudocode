/*
 * XREFs of ?AssignMaximumBudgets@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@@Z @ 0x1C00B60B4
 * Callers:
    ...
    if ( *v4 )
    {
      ...
      while ( v11 != (struct VIDMM_SEGMENT_GROUP_STATE *)((char *)a3 + 16 * i + 128) )
      {
        ...
        *(_QWORD *)(v14 + 8) = v15;
        ...
        if ( *(struct VIDMM_SEGMENT_GROUP_STATE ***)*v6 != v6 - 1 )
          __fastfail(3u);
        v7 = this;
        *(_QWORD *)v13 = v6 - 1;
        *((_QWORD *)v13 + 1) = v16;
