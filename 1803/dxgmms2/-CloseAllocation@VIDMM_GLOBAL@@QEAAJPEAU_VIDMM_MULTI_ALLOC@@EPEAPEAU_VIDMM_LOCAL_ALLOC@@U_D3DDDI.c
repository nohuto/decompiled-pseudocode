/*
 * XREFs of ?CloseAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@EPEAPEAU_VIDMM_LOCAL_ALLOC@@U_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAPEAU_KEVENT@@@Z @ 0x1C006873C
 * Callers:
 *     VidMmCloseAllocation @ 0x1C0003170 (VidMmCloseAllocation.c)
 *     VidMmTryCloseAllocation @ 0x1C00039F0 (VidMmTryCloseAllocation.c)
 * Callees:
