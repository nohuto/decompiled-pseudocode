/*
 * XREFs of ?RecordVaPagingHistoryUpdateGpuVa@VIDMM_GLOBAL@@QEAAXEPEAVVIDMM_PROCESS@@PEAU_VIDSCH_CONTEXT@@IPEAU_VIDSCH_SYNC_OBJECT@@_K@Z @ 0x1C00AC600
 * Callers:
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    ...
    if ( v11 )
    {
      ...
      *((_QWORD *)this + 5190) = KeGetCurrentThread();
      v12 = *((_DWORD *)this + 10376);
      if ( v12 == dword_1C004733C )
      {
        *((_DWORD *)this + 10376) = 0;
        v12 = 0;
      }
      v13 = *(void **)(*((_QWORD *)this + 5187) + 24LL * v12 + 16);
      if ( v13 )
        operator delete(v13);
      *v11 = *(_QWORD *)a3;
      v11[1] = *((_QWORD *)a3 + 4);
      ...
      *(_QWORD *)(*((_QWORD *)this + 5187) + 24LL * *((unsigned int *)this + 10376) + 16) = v11;
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = a2 != 0 ? 19 : 17;
