/*
 * XREFs of McTemplateK0pptpqxxt @ 0x1C00170E4
 * Callers:
...
__int64 McTemplateK0pptpqxxt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 8LL;
  v20 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpUnmapApertureSegment, a3, 9LL, v4);
}
