/*
 * XREFs of ?CalculatePartitionAdapterBudgets@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PARTITION@@PEAUVIDMM_PARTITION_ADAPTER_INFO@@@Z @ 0x1C0015F4C
 * Callers:
 ...
 * Callees:
 *     ?GetSegmentGroupStateForPartition@VIDMM_GLOBAL@@QEAAPEAUVIDMM_SEGMENT_GROUP_STATE@@KPEAUVIDMM_PARTITION@@@Z @ 0x1C006BD18 (-GetSegmentGroupStateForPartition@VIDMM_GLOBAL@@QEAAPEAUVIDMM_SEGMENT_GROUP_STATE@@KPEAUVIDMM_PA.c)
        ...
        struct VIDMM_PARTITION_ADAPTER_INFO *a3)
{
  ...
  v3 = (unsigned int)dword_1C0047480;
  v4 = 0;
  v5 = *((_QWORD *)a2 + 5);
  if ( *((_DWORD *)a2 + 6) )
    v3 = (unsigned int)dword_1C0047484;
  v8 = v5 * v3 / 0x64;
  if ( v8 < (unsigned int)dword_1C0047478 )
  {
    if ( v5 > (unsigned int)dword_1C004747C )
    {
      v8 = (v5 - (unsigned int)dword_1C004747C) >> 1;
      if ( (unsigned int)dword_1C0047478 > v8 )
        v8 = (unsigned int)dword_1C0047478;
    }
    else
    {
      v8 = (unsigned int)dword_1C0047478;
  ...
  *((_QWORD *)a3 + 2) = v8;
  ...
  if ( qword_1C0047350 && v8 >= qword_1C0047350 )
    v8 = qword_1C0047350;
  if ( *((_DWORD *)this + 1748) )
  {
    do
