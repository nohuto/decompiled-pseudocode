/*
 * XREFs of ?SuspendWorkerThread@VIDMM_GLOBAL@@QEAAXW4_VIDMM_WORKER_THREAD_SUSPEND_REASON@@@Z @ 0x1C0068548
 * Callers:
 *     VidMmSuspendWorkerThread @ 0x1C00040F0 (VidMmSuspendWorkerThread.c)
 * Callees:
