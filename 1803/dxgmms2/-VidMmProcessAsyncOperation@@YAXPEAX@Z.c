/*
 * XREFs of ?VidMmProcessAsyncOperation@@YAXPEAX@Z @ 0x1C00555B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsAllocationInPresentQueue@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@PEAI@Z @ 0x1C007A040 (-IsAllocationInPresentQueue@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@PEAI@Z.c)
  ...
  if ( v2 )
  {
    ...
    if ( (_DWORD)v5 )
    {
      if ( (_DWORD)v5 == 1 )
      {
        ...
        ExAcquirePushLockExclusiveEx(v9 + 41728, 0LL);
        *(_QWORD *)(v9 + 41736) = KeGetCurrentThread();
        if ( (*(_DWORD *)(v9 + 41768))-- == 1 )
          KeSetEvent((PRKEVENT)(v9 + 41744), 0, 0);
        *(_QWORD *)(v9 + 41736) = 0LL;
        ExReleasePushLockExclusiveEx(v9 + 41728, 0LL);
