/*
 * XREFs of ?CalculateBudgetGroupTargetUsage@VIDMM_GLOBAL@@IEAAXPEAUVIDMM_PHYSICAL_ADAPTER@@PEAUVIDMM_BUDGET_STATE@@PEAUVIDMM_SEGMENT_GROUP_STATE@@@Z @ 0x1C00B6448
 * Callers:
        ...
        struct VIDMM_SEGMENT_GROUP_STATE *a4)
{
  ...
  {
    v7 = dword_1C0047450;
    v8 = (unsigned int)dword_1C0047454;
  }
  else
  {
    v6 = *(int *)a4;
    if ( (_DWORD)v6 )
    {
      ...
      {
        v7 = dword_1C0047460;
        v8 = (unsigned int)dword_1C0047464;
      }
      else
      {
    ...
    {
      v7 = dword_1C0047458;
      v8 = (unsigned int)dword_1C004745C;
    }
  }
