/*
 * XREFs of ?UncommitVirtualAddressRange@CVirtualAddressAllocator@@QEAAJPEAUVIDMM_MAPPED_VA_RANGE@@PEAPEAUVIDMM_ALLOC@@E@Z @ 0x1C005B1F0
 * Callers:
 ...
 *     ?GetKmdProcessHandle@VIDMM_PROCESS@@QEBAPEAXK@Z @ 0x1C0073AA8 (-GetKmdProcessHandle@VIDMM_PROCESS@@QEBAPEAXK@Z.c)
 */
        ...
        char a4)
{
  ...
  *(_QWORD *)&v26.SegmentId = 32LL * v25;
  ...
  if ( v27 )
  {
    ...
    v12 = *(_QWORD *)(*((_QWORD *)this + 10) + 40720LL);
    v30[13] = -1;
    ...
    if ( a4 )
    {
      ...
      v16 = v9 + (v10 << 12);
      if ( (*((_BYTE *)v15 + 41448) & 0x10) == 0 && v9 <= v16 )
      {
