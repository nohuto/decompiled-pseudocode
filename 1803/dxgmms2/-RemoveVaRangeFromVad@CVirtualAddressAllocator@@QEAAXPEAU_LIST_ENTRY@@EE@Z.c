/*
 * XREFs of ?RemoveVaRangeFromVad@CVirtualAddressAllocator@@QEAAXPEAU_LIST_ENTRY@@EE@Z @ 0x1C005996C
 * Callers:
        ...
        char a4)
{
  ...
  Flink = a2->Flink;
  if ( a2->Flink->Blink != a2 || (v11 = a2->Blink, v11->Flink != a2) )
    __fastfail(3u);
  v11->Flink = Flink;
  Flink->Blink = v11;
  ...
  if ( VidMmAllocFromOwner )
  {
    ...
    if ( v15 )
    {
      if ( v15->Blink != v14 || (v16 = p_Blink[4], v16->Flink != v14) )
        __fastfail(3u);
      v16->Flink = v15;
      v15->Blink = v16;
      v14->Flink = 0LL;
