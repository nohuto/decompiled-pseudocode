/*
 * XREFs of ?AllocateBlock@VIDMM_PROCESS_HEAP@@AEAAJ_KKW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAU_VIDMM_PROCESS_HEAP_BLOCK@@E@Z @ 0x1C00B8358
 * Callers:
        ...
        char a6)
{
  ...
  *a5 = 0LL;
  ...
  Handle = 0LL;
  v11 = 0LL;
  if ( v8 <= (unsigned int)dword_1C00472CC )
    v8 = (unsigned int)dword_1C00472CC;
...
LABEL_23:
    ...
    {
      Object = 0LL;
      _InterlockedIncrement(&dword_1C0047674);
...
LABEL_21:
  ...
  if ( ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &BaseAddress, 0LL, &RegionSize, AllocationType, v7) < 0 )
  {
    AllocationType &= ~0x800000u;
    v14 = ZwAllocateVirtualMemory((HANDLE)0xFFFFFFFFFFFFFFFFLL, &BaseAddress, 0LL, &RegionSize, AllocationType, v7);
    v16 = v14;
    if ( v14 < 0 )
    {
      BaseAddress = 0LL;
      _InterlockedIncrement(&dword_1C00475C4);
LABEL_36:
...
LABEL_30:
  ...
  if ( !v10 )
  {
    _InterlockedIncrement(&dword_1C00475C8);
  ...
  if ( v30 < 0 )
  {
    _InterlockedIncrement(&dword_1C00475CC);
    goto LABEL_36;
  }
