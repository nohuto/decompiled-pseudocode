/*
 * XREFs of ?VidMmMapViewOfAllocation@@YAPEAXPEAU_VIDMM_LOCAL_ALLOC@@_K1PEAPEAXH@Z @ 0x1C0078B70
 * Callers:
...
char *__fastcall VidMmMapViewOfAllocation(struct _VIDMM_LOCAL_ALLOC *a1, __int64 a2, __int64 a3, void **a4, int a5)
{
  ...
  *a4 = 0LL;
  ...
  if ( (*(_BYTE *)(v5 + 84) & 4) != 0 || (*(_DWORD *)(v5 + 76) & 0x100) != 0 )
  {
    v22 = *(_QWORD *)(v5 + 360);
    v30 = a2;
    if ( (int)MmMapViewInSystemSpaceEx(v22, v5 + 368, &v29, &v30, 0LL) >= 0 )
    {
      v16 = (char *)(*(_QWORD *)(v5 + 368) - v30);
      return &v16[a2];
    }
  ...
  if ( ((unsigned __int8)a1 & (*(_BYTE *)(v5 + 80) >= 0)) != 0 )
  {
    if ( (v10 & 0x20000000) == 0 )
    {
      ...
      MappedBase = (PVOID)(*(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64, int))(**(_QWORD **)(*((_QWORD *)v9 + 1) + 24LL)
                                                                                           + 56LL))(
      ...
      if ( (qword_1C0047010 & 2) != 0 && ((unsigned __int16)Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
        McTemplateK0q(v20, (__int64)&EventProfilerExit, v21, v26);
      return (char *)MappedBase;
    }
    ...
    else
    {
      ...
      CurrentProcess = PsGetCurrentProcess(a1, v11, a3, a4);
...
LABEL_8:
    ...
    *(_QWORD *)(v19 + 24) = a5;
    ...
    if ( !a5 )
    {
      v15 = MmMapViewInSystemSpace(*(PVOID *)(v5 + 360), &MappedBase, (PSIZE_T)(v5 + 8));
      if ( v15 < 0 )
        return (char *)MappedBase;
      *((_BYTE *)v9 + 32) |= 8u;
    }
