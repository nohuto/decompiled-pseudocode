/*
 * XREFs of ?RecordVaPagingHistoryVirtualTransfer@VIDMM_GLOBAL@@QEAAXPEAU_DXGKARG_BUILDPAGINGBUFFER@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00ACCB0
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a3)
{
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    ...
    if ( v6 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = 7;
