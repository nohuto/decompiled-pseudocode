/*
 * XREFs of McTemplateK0pptpqxxqt @ 0x1C0016FF4
 * Callers:
...
__int64 McTemplateK0pptpqxxqt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  _BYTE v4[16]; // [rsp+30h] [rbp-99h] BYREF
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPagingOpMapApertureSegment, a3, 10LL, v4);
}
