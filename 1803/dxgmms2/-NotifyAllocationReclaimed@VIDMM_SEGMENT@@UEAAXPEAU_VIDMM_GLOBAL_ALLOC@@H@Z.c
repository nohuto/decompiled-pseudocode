/*
 * XREFs of ?NotifyAllocationReclaimed@VIDMM_SEGMENT@@UEAAXPEAU_VIDMM_GLOBAL_ALLOC@@H@Z @ 0x1C00B3160
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( (_DWORD)a3 )
  {
    ...
    if ( v5 < v6 )
    {
      v7 = WdLogNewEntry5_WdAssertion(v5, v6);
      *(_QWORD *)(v7 + 24) = 1974LL;
    ...
    *((_QWORD *)this + 28) = v8;
    ...
    if ( *((_DWORD *)this + 92) != -1 && (*((_DWORD *)a2 + 19) & 0x200) == 0 )
    {
      ...
      v14 = v12 - v11;
      *((_QWORD *)this + 29) = v14;
      if ( v10 > qword_1C0047410 && v14 <= qword_1C0047410 )
      {
        (*(void (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)this + 1) + 40600LL))(
          *(_QWORD *)(*((_QWORD *)this + 1) + 40648LL),
    ...
    if ( (*((_DWORD *)this + 20) & 0x1001) != 0 )
    {
      ...
      {
        v16 = **((_QWORD **)a2 + 61);
        v17 = _InterlockedExchangeAdd64((volatile signed __int64 *)(v16 + 56), -*((_QWORD *)a2 + 2));
        if ( v17 < *((_QWORD *)a2 + 2) )
        {
          v18 = WdLogNewEntry5_WdAssertion(v16, v17);
          *(_QWORD *)(v18 + 24) = 2010LL;
