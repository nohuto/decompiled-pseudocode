/*
 * XREFs of ?OpenAdapter@VIDMM_PROCESS@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x1C0073DE0
 * Callers:
 *     VidMmOpenAdapter @ 0x1C0003DB0 (VidMmOpenAdapter.c)
  ...
  if ( v8 )
  {
    *((_QWORD *)this[2] + v5) = v8;
    ...
    if ( bTracingEnabled )
    {
      ...
      VIDMM_GLOBAL::ReportProcessAdapterBudget(a2, (struct _KTHREAD **)v10);
    }
    return 0LL;
  }
  return 3221225495LL;
