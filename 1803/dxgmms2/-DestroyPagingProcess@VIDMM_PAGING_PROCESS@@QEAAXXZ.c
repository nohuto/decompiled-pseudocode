/*
 * XREFs of ?DestroyPagingProcess@VIDMM_PAGING_PROCESS@@QEAAXXZ @ 0x1C00AACD4
 * Callers:
  ...
  if ( v4 )
  {
    ...
    if ( *(_DWORD *)(v4 + 6992) )
    {
      do
      {
        ...
        if ( v7 )
        {
          for ( i = 0; i < *(_DWORD *)(*((_QWORD *)v7 + 10) + 6992LL); ++i )
          {
      ...
      while ( (unsigned int)v6 < *(_DWORD *)(*((_QWORD *)this + 2) + 6992LL) );
    }
