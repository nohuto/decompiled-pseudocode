/*
 * XREFs of ?NotifyMemorySegmentActive@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_SEGMENT@@@Z @ 0x1C0023B2C
 * Callers:
...
void __fastcall VIDMM_GLOBAL::NotifyMemorySegmentActive(VIDMM_GLOBAL *this, struct VIDMM_SEGMENT *a2)
{
  ...
  v2 = (char *)this + 41568;
  v5 = *((_QWORD *)this + 5090) + 1560LL * *((unsigned int *)a2 + 95);
  v6 = 0;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 5196, &LockHandle);
  ...
  *((_QWORD *)this + 5197) = 0LL;
  ...
  if ( !v7 && *(_DWORD *)(v5 + 24) )
  {
    do
    {
      ...
      if ( v9[92] != -1 )
      {
        v10 = ((v9[20] >> 12) & 1) != 0 ? 0 : v9[4] + 1;
        if ( *(_DWORD *)(v5 + 64) == v10
          || (((v9[20] >> 12) & 1) == 0 ? (v11 = v9[4] + 1) : (v11 = 0), *(_DWORD *)(v5 + 48) == v11) )
        {
          LOBYTE(v8) = 1;
          if ( (*((unsigned int (__fastcall **)(_QWORD, _QWORD, __int64))this + 5080))(
                 *((_QWORD *)this + 5081),
                 *((unsigned int *)a2 + 92),
                 v8) == -1071775466 )
          {
  ...
  LOBYTE(v8) = 1;
  (*((void (__fastcall **)(_QWORD, _QWORD, __int64))this + 5080))(
    *((_QWORD *)this + 5081),
    *((unsigned int *)a2 + 92),
    v8);
