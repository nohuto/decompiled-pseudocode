/*
 * XREFs of VidSchiRestartQueuedFlip @ 0x1C002C8AC
 * Callers:
  ...
  if ( v10 != a4 )
  {
    ...
    if ( v11 )
    {
      v12 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 40) + 24LL)
                      ...
                      + 8 * v6
                      + 520);
      _InterlockedExchangeAdd((volatile signed __int32 *)(*(_QWORD *)(v4 + 8 * v6 + 6248) + 8LL), -v11);
      *(_DWORD *)(*(_QWORD *)(v4 + 8 * v6 + 6248) + 4LL) += v11;
