/*
 * XREFs of VidSchiFinishMeasuringPreemptionTime @ 0x1C0011544
 * Callers:
...
LABEL_9:
    if ( v7 >= *(_QWORD *)(v3 + 2632) )
    {
      _InterlockedIncrement((volatile signed __int32 *)(v4 + 2656));
      if ( v7 >= *(_QWORD *)(v3 + 2616) && !*(_BYTE *)(*(_QWORD *)(v2 + 40) + 2624LL) )
      {
        v11 = *(_DWORD *)(v2 + 48);
        if ( (v11 & 8) == 0
          && (v11 & 1) == 0
          && !*(_DWORD *)(v3 + 2860)
          && !*(_BYTE *)(v2 + 188)
          && !_InterlockedCompareExchange((volatile signed __int32 *)(v2 + 184), 0, 0)
          && (*(_DWORD *)(v3 + 2192) & 0x200) != 0 )
        {
          KeSetTimer((PKTIMER)(a1 + 504), (LARGE_INTEGER)-*(_QWORD *)(v3 + 2624), (PKDPC)(a1 + 568));
          VidSchiUpdateContextStatus(a1, (_QWORD *)7, (_QWORD *)0x61FA);
          if ( bTracingEnabled )
          {
            v14 = *(_QWORD *)(a1 + 56);
