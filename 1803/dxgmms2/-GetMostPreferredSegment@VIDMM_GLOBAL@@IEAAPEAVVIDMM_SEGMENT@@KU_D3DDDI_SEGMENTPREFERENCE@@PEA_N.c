/*
 * XREFs of ?GetMostPreferredSegment@VIDMM_GLOBAL@@IEAAPEAVVIDMM_SEGMENT@@KU_D3DDDI_SEGMENTPREFERENCE@@PEA_N@Z @ 0x1C009DFD0
 * Callers:
  ...
  if ( a3.0 )
  {
    if ( (*(_BYTE *)&a3.0 & 0x1F) != 0 )
    {
      v4 = *(_QWORD *)(*((_QWORD *)this + 464)
                     + 8LL * ((*(_BYTE *)&a3.0 & 0x1Fu) + *(_DWORD *)(1560LL * a2 + *((_QWORD *)this + 5090) + 20) - 1));
      *a4 = *(_BYTE *)(v4 + 80) & 1;
    }
    else
    {
      ...
      if ( v5 )
        return *(struct VIDMM_SEGMENT **)(*((_QWORD *)this + 464)
                                        + 8LL * (v5 + *(_DWORD *)(1560LL * a2 + *((_QWORD *)this + 5090) + 20) - 1));
    }
  }
