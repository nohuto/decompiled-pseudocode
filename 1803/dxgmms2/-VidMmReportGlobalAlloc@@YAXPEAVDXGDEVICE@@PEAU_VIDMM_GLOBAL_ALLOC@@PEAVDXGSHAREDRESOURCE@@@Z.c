/*
 * XREFs of ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00AA270
 * Callers:
 *     VidMmReportContextAllocList @ 0x1C00AA770 (VidMmReportContextAllocList.c)
 *     VidMmReportMultiGlobalAlloc @ 0x1C00AA9A0 (VidMmReportMultiGlobalAlloc.c)
 * Callees:
        ...
        struct DXGSHAREDRESOURCE *a3)
{
  ...
  if ( (_WORD)v17 && bTracingEnabled && ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
  {
