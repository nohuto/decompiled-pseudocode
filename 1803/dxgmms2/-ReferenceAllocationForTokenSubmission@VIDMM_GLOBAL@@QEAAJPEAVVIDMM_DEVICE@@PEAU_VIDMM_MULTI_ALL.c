/*
 * XREFs of ?ReferenceAllocationForTokenSubmission@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_ALLOC@@PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0079FD4
 * Callers:
 *     VidMmReferenceAllocationForTokenSubmission @ 0x1C0013C10 (VidMmReferenceAllocationForTokenSubmission.c)
 * Callees:
 *     <none>
 */
