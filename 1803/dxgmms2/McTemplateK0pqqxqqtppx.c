/*
 * XREFs of McTemplateK0pqqxqqtppx @ 0x1C0029C58
 * Callers:
...
NTSTATUS McTemplateK0pqqxqqtppx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventQueueSubmit, a3, 0xBu, &v4);
}
