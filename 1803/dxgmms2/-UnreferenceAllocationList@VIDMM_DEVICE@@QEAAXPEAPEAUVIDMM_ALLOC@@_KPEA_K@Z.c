/*
 * XREFs of ?UnreferenceAllocationList@VIDMM_DEVICE@@QEAAXPEAPEAUVIDMM_ALLOC@@_KPEA_K@Z @ 0x1C00769EC
 * Callers:
  ...
  while ( a2 != (__int64 ***)v8 )
  {
    ...
    else
    {
      ...
      if ( !(*((_BYTE *)v9 + 25) & 1 | *((_DWORD *)v9 + 38)) )
        VIDMM_DEVICE::NotifyAllocationEvicted((VIDMM_DEVICE ***)this, v9);
    }
    ++a2;
  }
  VIDMM_PROCESS_ADAPTER_INFO::GetNumBytesToTrim(*((struct VIDMM_GLOBAL ***)this + 2), a4, 0, 1u);
