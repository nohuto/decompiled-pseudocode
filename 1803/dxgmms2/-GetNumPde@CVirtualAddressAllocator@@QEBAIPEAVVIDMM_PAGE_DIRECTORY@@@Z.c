/*
 * XREFs of ?GetNumPde@CVirtualAddressAllocator@@QEBAIPEAVVIDMM_PAGE_DIRECTORY@@@Z @ 0x1C0004F9C
 * Callers:
...
__int64 __fastcall CVirtualAddressAllocator::GetNumPde(CVirtualAddressAllocator *this, struct VIDMM_PAGE_DIRECTORY *a2)
{
  ...
  if ( (v2 & 0x10) != 0 )
    ...
    return *(unsigned int *)(*(_QWORD *)(*((_QWORD *)this + 10) + 40720LL) + 48LL * (v2 & 7) + 1560 * v3 + 88);
}
