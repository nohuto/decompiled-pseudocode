/*
 * XREFs of ?CommitGlobalBackingStore@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C006C694
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::CommitGlobalBackingStore(VIDMM_GLOBAL *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  if ( (v4 & 0x1000) == 0 )
  {
    ...
    else
    {
      ...
      if ( v12 < 0 )
      {
        _InterlockedIncrement(&dword_1C00476C8);
    ...
    if ( (**((_DWORD **)a2 + 63) & 8) != 0 )
    {
      ...
      if ( v15 >= 0 )
        goto LABEL_4;
      _InterlockedIncrement(&dword_1C00476CC);
...
LABEL_4:
    ...
    *((_DWORD *)a2 + 23) |= 1u;
    _InterlockedExchangeAdd64(
      (volatile signed __int64 *)(1560LL * (v6 & 0x3F) + *((_QWORD *)this + 5090) + 1528),
      *((_QWORD *)a2 + 1));
LABEL_5:
