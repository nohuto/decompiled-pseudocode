/*
 * XREFs of VidSchiRunningDeviceAllowsLongRunningPackets @ 0x1C002CA3C
 * Callers:
...
char __fastcall VidSchiRunningDeviceAllowsLongRunningPackets(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 12) & 2) != 0 || *(_DWORD *)(a1 + 2832) )
    return 0;
  v3 = 1;
  KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(*(_QWORD *)(a1 + 24) + 1904LL), &LockHandle);
