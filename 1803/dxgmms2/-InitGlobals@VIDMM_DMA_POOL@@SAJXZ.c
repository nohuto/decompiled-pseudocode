/*
 * XREFs of ?InitGlobals@VIDMM_DMA_POOL@@SAJXZ @ 0x1C0082908
 * Callers:
...
__int64 VIDMM_DMA_POOL::InitGlobals(void)
{
  ...
  qword_1C0047738 = (__int64)&VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_DmaPoolsListHead.Flink = &VIDMM_DMA_POOL::_DmaPoolsListHead;
  VIDMM_DMA_POOL::_MaxNbDmaBuffers = dword_1C0047298;
  VIDMM_DMA_POOL::_MaxNbCddDmaBuffers = dword_1C004729C;
  VIDMM_DMA_POOL::_MaxDmaBufferBytes = (unsigned int)dword_1C00472A0;
  VIDMM_DMA_POOL::_MaxAllocationListBytes = (unsigned int)dword_1C00472A4;
  VIDMM_DMA_POOL::_MaxPatchLocationListBytes = (unsigned int)dword_1C00472A4;
  v0 = (unsigned int)dword_1C00472A0 / 0x64uLL;
  ...
  v1 = (unsigned int)dword_1C00472A4 / 0x64uLL;
  ...
  if ( v2 )
  {
    ...
    {
      VIDMM_DMA_POOL::_NbDmaBufferLimitCompareWatermark = dword_1C00472A8;
      return 0LL;
    }
  }
  else
