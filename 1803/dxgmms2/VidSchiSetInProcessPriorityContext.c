/*
 * XREFs of VidSchiSetInProcessPriorityContext @ 0x1C0003EF8
 * Callers:
 *     VidSchSetInProcessPriorityContext @ 0x1C00569C0 (VidSchSetInProcessPriorityContext.c)
 * Callees:
    ...
    *(_DWORD *)(a1 + 408) = a2;
    if ( (v8 & 1) != 0 )
    {
      ...
      else
      {
        v14 = (_QWORD *)(a1 + 416);
        v15 = *(_QWORD *)(a1 + 416);
        if ( *(_QWORD *)(v15 + 8) != a1 + 416 || (v16 = *(_QWORD **)(a1 + 424), (_QWORD *)*v16 != v14) )
          __fastfail(3u);
        *v16 = v15;
        *(_QWORD *)(v15 + 8) = v16;
        *(_QWORD *)(a1 + 424) = 0LL;
