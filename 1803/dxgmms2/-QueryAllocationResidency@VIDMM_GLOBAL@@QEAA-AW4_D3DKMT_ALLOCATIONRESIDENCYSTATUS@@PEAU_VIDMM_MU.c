/*
 * XREFs of ?QueryAllocationResidency@VIDMM_GLOBAL@@QEAA?AW4_D3DKMT_ALLOCATIONRESIDENCYSTATUS@@PEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00A2BC8
 * Callers:
 *     VidMmQueryAllocationResidency @ 0x1C00233D0 (VidMmQueryAllocationResidency.c)
 * Callees:
