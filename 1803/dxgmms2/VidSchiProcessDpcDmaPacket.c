/*
 * XREFs of VidSchiProcessDpcDmaPacket @ 0x1C002B520
 * Callers:
...
void __fastcall VidSchiProcessDpcDmaPacket(struct _VIDSCH_DMA_PACKET *a1, __int64 a2)
{
  ...
  *(_DWORD *)(v4 + 496) = ((unsigned __int8)*(_DWORD *)(v4 + 496) + 1) & 0xF;
  KeAcquireInStackQueuedSpinLockAtDpcLevel(v6 + 238, &LockHandle);
  v8 = *((_DWORD *)a1 + 23);
  if ( (v8 & 0x400) != 0 )
  {
    v8 &= ~0x400u;
    *((_DWORD *)a1 + 23) = v8;
    if ( *(_DWORD *)(v4 + 6256) != -1 )
    {
      v9 = (void (__fastcall *)(KSPIN_LOCK))v6[365];
      if ( v9 )
      {
        v9(v6[369]);
        v8 = *((_DWORD *)a1 + 23);
  ...
  if ( (v8 & 0x800) != 0 )
  {
    if ( *(_DWORD *)(v6[*(unsigned int *)(*((_QWORD *)a1 + 7) + 388LL) + 379] + 28128) != -1 )
    {
      v10 = (void (__fastcall *)(KSPIN_LOCK))v6[363];
      if ( v10 )
      {
        v10(v6[369]);
        v8 = *((_DWORD *)a1 + 23);
  ...
  VidSchiInterlockedInsertTailList((KSPIN_LOCK *)(*(_QWORD *)(v4 + 24) + 1912LL), v4 + 6264, (_QWORD *)a1 + 2, 0LL);
}
