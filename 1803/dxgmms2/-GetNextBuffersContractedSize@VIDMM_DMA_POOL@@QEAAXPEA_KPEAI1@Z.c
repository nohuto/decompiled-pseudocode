/*
 * XREFs of ?GetNextBuffersContractedSize@VIDMM_DMA_POOL@@QEAAXPEA_KPEAI1@Z @ 0x1C00A9254
 * Callers:
 *     VidMmGetNextBuffersContractedSize @ 0x1C00232E0 (VidMmGetNextBuffersContractedSize.c)
 * Callees:
