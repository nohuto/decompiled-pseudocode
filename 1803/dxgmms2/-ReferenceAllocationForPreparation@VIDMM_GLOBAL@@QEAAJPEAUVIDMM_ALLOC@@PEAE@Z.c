/*
 * XREFs of ?ReferenceAllocationForPreparation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@PEAE@Z @ 0x1C0063200
 * Callers:
        ...
        unsigned __int8 *a3)
{
  ...
  if ( !v7 )
  {
    ...
    if ( bTracingEnabled && ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0pqt((__int64)this, (__int64)a2, (__int64)a3, a2, 0, 1);
    *((_QWORD *)this + 988) += *(_QWORD *)(v6 + 16);
    ++*((_DWORD *)this + 1974);
    v8 = *(_DWORD *)(v6 + 76);
    if ( (v8 & 0x1000000) != 0 )
...
LABEL_22:
      ...
      if ( bTracingEnabled && ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      {
        LODWORD(v11) = 1;
        LODWORD(v10) = 4;
        McTemplateK0pqt((__int64)this, (__int64)a2, (__int64)a3, a2, v10, v11);
      }
      *((_QWORD *)this + 982) += *(_QWORD *)(v6 + 16);
      ++*((_DWORD *)this + 1962);
      *(_DWORD *)(v6 + 76) |= 0x2000000u;
      if ( bTracingEnabled && ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
        McTemplateK0p((__int64)this, &EventMigrateAllocation, (__int64)a3, v6);
    ...
    if ( g_IsInternalReleaseOrDbg )
      *(_QWORD *)(WdLogNewEntry5_WdTrace(this) + 24) = a2;
    if ( bTracingEnabled && ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
      McTemplateK0pqt((__int64)this, (__int64)a2, (__int64)a3, a2, 1, 1);
    *((_QWORD *)this + 980) += *(_QWORD *)(v6 + 16);
    ++*((_DWORD *)this + 1958);
