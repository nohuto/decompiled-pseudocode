/*
 * XREFs of ?Lock@VIDMM_RECYCLE_MULTIRANGE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@_K1W4_LOCK_OPERATION@@PEAVVIDMM_SEGMENT@@E@Z @ 0x1C006FEE0
 * Callers:
        ...
        unsigned __int8 a7)
{
  ...
  if ( *((_BYTE *)this + 130) )
  {
    v20 = (_QWORD *)WdLogNewEntry5_WdCriticalError(this, a2, a3);
    v20[3] = 270LL;
    v20[4] = 52LL;
    v20[5] = 12LL;
    v20[6] = 0LL;
  ...
  if ( v8 || (v11 = this[6], v7 != (struct VIDMM_RECYCLE_RANGE *)(this[5] - v11)) || v11 != this[4] )
  {
    ...
    if ( v24 < i )
    {
      ...
      if ( v35 < 0 )
      {
        while ( 1 )
        {
          v43 = VIDMM_RECYCLE_RANGE::GetPreviousRange(v37);
          v44 = v43;
          if ( v43 == NextRange )
            break;
...
LABEL_53:
          ...
          if ( a7 )
            ...
            *((_BYTE *)this + 128) = 1;
          VIDMM_RECYCLE_MULTIRANGE::ZeroIfNeeded((VIDMM_RECYCLE_MULTIRANGE *)this, v38, v39);
          v18 = (_QWORD *)WdLogNewEntry5_WdEvent(v48, v47);
          v18[4] = v8;
LABEL_12:
          v18[3] = this;
          v18[5] = v7;
...
LABEL_46:
  ...
  {
    v14 = VIDMM_RECYCLE_RANGE::Lock(k, a2, (enum _LOCK_OPERATION)a3, a6);
    if ( v14 < 0 )
      break;
    if ( k == this[9] )
    {
      ...
      if ( a7 )
        ...
        *((_BYTE *)this + 128) = 1;
      VIDMM_RECYCLE_MULTIRANGE::ZeroIfNeeded((VIDMM_RECYCLE_MULTIRANGE *)this, v13, v15);
