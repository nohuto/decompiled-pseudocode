/*
 * XREFs of McTemplateK0pqqiix @ 0x1C00292A0
 * Callers:
...
NTSTATUS McTemplateK0pqqiix(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPeriodicFrameNotificationTimer, a3, 7u, &v4);
}
