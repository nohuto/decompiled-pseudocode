/*
 * XREFs of ?OpenLocalAllocation@VIDMM_GLOBAL@@IEAAPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_PROCESS@@PEAXPEAE@Z @ 0x1C00634E8
 * Callers:
        ...
        unsigned __int8 *a5)
{
  ...
  __int64 v32; // rdx
  _QWORD *v33; // rcx
  enum _LOCK_OPERATION v34; // [rsp+28h] [rbp-90h]
  struct _KAPC_STATE ApcState; // [rsp+40h] [rbp-78h] BYREF

  v6 = a3;
  if ( !a3 )
    v6 = (struct VIDMM_PROCESS *)*((_QWORD *)this + 5112);
  if ( g_IsInternalReleaseOrDbg )
    *(_QWORD *)(WdLogNewEntry5_WdTrace(this) + 24) = a2;
  if ( !v6 )
  {
    v24 = WdLogNewEntry5_WdAssertion(this, a2);
    *(_QWORD *)(v24 + 24) = 11961LL;
    goto LABEL_42;
  }
  v9 = (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 296);
  v10 = (struct _VIDMM_GLOBAL_ALLOC *)*((_QWORD *)a2 + 37);
  if ( v10 != (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 296) && (**((_DWORD **)a2 + 63) & 0x20000000) == 0 )
  {
    v24 = WdLogNewEntry5_WdAssertion(this, v10);
    *(_QWORD *)(v24 + 24) = 11971LL;
    goto LABEL_42;
  }
  v11 = (VIDMM_GLOBAL *)(**((_DWORD **)a2 + 63) & 0x20000010);
  if ( (_DWORD)v11 != 536870928 || (v25 = *((_QWORD *)a2 + 13)) == 0 || *(struct VIDMM_PROCESS **)(v25 + 8) == v6 )
  {
    while ( v10 != v9 )
    {
      v14 = (__int64)v10 - 56;
      if ( *((struct VIDMM_PROCESS **)v10 - 6) == v6 )
      {
        ...
        if ( (v21 & 2) != 0 )
        {
          *(_BYTE *)(v14 + 32) = v21 & 0xFD;
          v26 = WdLogNewEntry5_WdEvent(v11, v10);
          *(_QWORD *)(v26 + 24) = v14;
    ...
    if ( !v12 )
    {
      _InterlockedIncrement(&dword_1C0047570);
      v29 = WdLogNewEntry5_WdLowResource(v13);
      *(_QWORD *)(v29 + 24) = 12052LL;
...
LABEL_37:
    ...
    --*((_DWORD *)a2 + 78);
    v32 = *(_QWORD *)(v14 + 56);
    if ( *(_QWORD *)(v32 + 8) != v14 + 56 || (v33 = *(_QWORD **)(v14 + 64), *v33 != v14 + 56) )
      __fastfail(3u);
    *v33 = v32;
    *(_QWORD *)(v32 + 8) = v33;
  ...
  if ( v6 == *((struct VIDMM_PROCESS **)this + 5112) )
    return 0LL;
  v24 = WdLogNewEntry5_WdAssertion(v11, v10);
  *(_QWORD *)(v24 + 24) = 11990LL;
LABEL_42:
