/*
 * XREFs of VidSchQueryDmaHeader @ 0x1C00BFA1C
 * Callers:
...
LABEL_7:
  if ( *((_QWORD *)i + 2) != __PAIR64__(v15, v6) )
    goto LABEL_8;
  v14 = 224LL * v10;
  *(_DWORD *)a5 = *(_DWORD *)(v14 + a2 + 6360);
  *(_QWORD *)(a5 + 8) = *(_QWORD *)(v14 + a2 + 6368);
  *(_DWORD *)(a5 + 16) = *(_DWORD *)(v14 + a2 + 6376);
  *(_DWORD *)(a5 + 20) = *(_DWORD *)(v14 + a2 + 6380);
  *(_DWORD *)(a5 + 24) = *(_DWORD *)(v14 + a2 + 6384);
  *(_QWORD *)(a5 + 32) = *(_QWORD *)(v14 + a2 + 6392);
  return 0LL;
}
