/*
 * XREFs of ?SetStatus@VIDMM_PAGING_QUEUE@@QEAAXW4VIDMM_PAGING_QUEUE_STATUS@@@Z @ 0x1C0073358
 * Callers:
 ...
 *     ?Resume@VIDMM_PAGING_QUEUE@@QEAAXXZ @ 0x1C00737FC (-Resume@VIDMM_PAGING_QUEUE@@QEAAXXZ.c)
...
LABEL_13:
  ...
  if ( v5 == 1 )
  {
    ...
    {
      v16 = (__int64 *)*a1;
      if ( *(__int64 **)(*a1 + 8) != a1 || (v17 = (__int64 **)a1[1], *v17 != a1) )
        __fastfail(3u);
      *v17 = v16;
      v16[1] = (__int64)v17;
      *a1 = 0LL;
