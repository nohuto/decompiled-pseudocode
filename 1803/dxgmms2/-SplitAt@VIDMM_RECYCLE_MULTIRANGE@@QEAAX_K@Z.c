/*
 * XREFs of ?SplitAt@VIDMM_RECYCLE_MULTIRANGE@@QEAAX_K@Z @ 0x1C006F4E8
 * Callers:
...
void __fastcall VIDMM_RECYCLE_MULTIRANGE::SplitAt(VIDMM_RECYCLE_MULTIRANGE *this, __int64 a2)
{
  ...
  __int64 v33; // rcx
  __int64 v34; // rax
  unsigned __int64 v35; // [rsp+30h] [rbp-58h] BYREF
  ...
  if ( v14
    || (v30 = *(unsigned int *)(v13 + 44),
        v31 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64))(v13 + 48),
        v32 = *(unsigned int *)(v13 + 40),
        v33 = *(unsigned int *)(v13 + 36),
        ++*(_DWORD *)(v13 + 24),
        (v14 = (PSLIST_ENTRY)v31(v33, v30, v32, v13)) != 0LL) )
  {
    ...
    *((_QWORD *)this + 5) = i;
    ...
    if ( !(_DWORD)v16 )
    {
      ...
      *(_QWORD *)(v25 + 32) = 2LL;
      ...
      if ( v27 )
      {
        while ( 1 )
        {
          if ( (int)VidMmCompareForInsertAlignedRange(&v35, v27) >= 0 )
          {
            v29 = v27->Children[1];
            if ( !v29 )
            {
      ...
      LOBYTE(v26) = v2;
      RtlAvlInsertNodeEx(v24 + 64, v27, v26, v14);
    ...
    if ( !(_DWORD)v17 )
    {
      VIDMM_RECYCLE_HEAP::AddMultirangeToTree(*(_QWORD *)(*((_QWORD *)this + 10) + 32LL), 1LL, v14);
      return;
    }
    if ( (_DWORD)v17 == 1 )
    {
      v18 = *(_QWORD *)(*((_QWORD *)this + 10) + 32LL);
      v19 = WdLogNewEntry5_WdEvent(v17, v15);
      *(_QWORD *)(v19 + 24) = v14;
      *(_QWORD *)(v19 + 32) = 0LL;
      WdLogEvent5_WdEvent(v19);
      LOBYTE(v20) = 0;
      v21 = *(struct _RTL_BALANCED_NODE **)(v18 + 48);
      v22 = *((_QWORD *)&v14[3].Next + 1);
      v35 = *((_QWORD *)&v14[2].Next + 1) - (unsigned __int64)v14[2].Next;
      v36 = v22;
      v37 = 0;
      if ( !v21 )
      ...
      while ( 1 )
      {
        if ( (int)VidMmCompareForInsertAlignedRange(&v35, v21) >= 0 )
        {
          v23 = v21->Children[1];
          if ( !v23 )
          {
        ...
        else
        {
          ...
          if ( !v21->Children[0] )
          {
            LOBYTE(v20) = 0;
LABEL_29:
            RtlAvlInsertNodeEx(v18 + 48, v21, v20, v14);
