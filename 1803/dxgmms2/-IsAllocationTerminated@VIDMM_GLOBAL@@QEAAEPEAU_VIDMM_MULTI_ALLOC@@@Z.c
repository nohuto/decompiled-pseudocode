/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00A1270
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C0023360 (VidMmIsAllocationTerminated.c)
 * Callees:
