/*
 * XREFs of McTemplateK0pqqqqCR4 @ 0x1C0029870
 * Callers:
...
NTSTATUS McTemplateK0pqqqqCR4(REGHANDLE *a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 4LL;
  v17 = 0;
  return McGenEventWriteKM(a1, &EventHistoryBuffer, 0LL, 7u, &v4);
}
