/*
 * XREFs of ?AllocateFenceStorageSlot@VIDMM_GLOBAL@@SAJPEAUVIDMM_MONITORED_FENCE_STORAGE@@_N11_K1@Z @ 0x1C007798C
 * Callers:
 *     ?VidMmAllocateFenceStorageSlot@@YAJPEAUVIDMM_MONITORED_FENCE_STORAGE@@_N11_K1@Z @ 0x1C0011DA0 (-VidMmAllocateFenceStorageSlot@@YAJPEAUVIDMM_MONITORED_FENCE_STORAGE@@_N11_K1@Z.c)
        ...
        bool a6)
{
  ...
  if ( DXGPROCESS::GetCurrent() && (v10 = *((_QWORD *)DXGPROCESS::GetCurrent() + 9)) != 0 )
    ...
    v11 = 0LL;
  if ( v11 && (*(_BYTE *)(*(_QWORD *)(v11 + 32) + 323LL) & 8) != 0 )
    v12 = v11;
  else
    v12 = 0LL;
  if ( a4 || a2 || a3 || !v11 )
