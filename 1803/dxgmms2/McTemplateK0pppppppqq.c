/*
 * XREFs of McTemplateK0pppppppqq @ 0x1C0025C20
 * Callers:
 ...
 *     ?ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ @ 0x1C00AE248 (-ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00161E0 (__security_check_cookie.c)
 *     McGenEventWriteKM @ 0x1C0023E78 (McGenEventWriteKM.c)
 */

NTSTATUS McTemplateK0pppppppqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventRecycleRangeCreate, a3, 0xAu, &v4);
}
