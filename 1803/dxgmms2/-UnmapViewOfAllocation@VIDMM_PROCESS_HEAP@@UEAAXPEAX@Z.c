/*
 * XREFs of ?UnmapViewOfAllocation@VIDMM_PROCESS_HEAP@@UEAAXPEAX@Z @ 0x1C00BA060
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall VIDMM_PROCESS_HEAP::UnmapViewOfAllocation(VIDMM_PROCESS_HEAP *this, PVOID *a2, __int64 a3, __int64 a4)
{
  ...
  if ( (*(_DWORD *)a2 & 2) != 0 )
  {
    ...
    if ( (v11 & 1) != 0 )
    {
      ...
      VidMmUnmapViewAsync(CurrentProcess, a2[4], v12);
    }
    else
    {
      v14 = PsGetCurrentProcess(v7, v6, v8, v9);
      MmUnmapViewOfSection(v14, v12);
    }
    *(_DWORD *)a2 &= ~2u;
LABEL_13:
    a2[11] = 0LL;
