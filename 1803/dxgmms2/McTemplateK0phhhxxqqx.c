/*
 * XREFs of McTemplateK0phhhxxqqx @ 0x1C00263E4
 * Callers:
...
NTSTATUS McTemplateK0phhhxxqqx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v21 = 4LL;
  v23 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventVidMmVprDefragmentCheck, 0LL, 0xAu, &v5);
}
