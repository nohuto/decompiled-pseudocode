/*
 * XREFs of ?FreeAllocMappedVaRangeList@CVirtualAddressAllocator@@QEAAXPEAUVIDMM_ALLOC@@@Z @ 0x1C005ADD0
 * Callers:
        ...
        struct VIDMM_ALLOC *a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( *((volatile signed __int32 ***)v8 + 1) != v7
      || (v18 = *(_QWORD *)v8, *(volatile signed __int32 **)(*(_QWORD *)v8 + 8LL) != v8) )
    {
      __fastfail(3u);
    }
    ...
    *((_QWORD *)v8 + 1) = 0LL;
    ...
    if ( *(volatile signed __int32 **)(*(_QWORD *)v19 + 8LL) != v19
      || (v23 = (volatile signed __int32 **)*((_QWORD *)v19 + 1), *v23 != v19) )
    {
      __fastfail(3u);
    }
    ...
    *(_QWORD *)v19 = 0LL;
    ...
    if ( v25 )
    {
      ...
      if ( *(_QWORD *)v8 )
      {
        if ( *(volatile signed __int32 **)(v27 + 8) != v8
          || (v26 = (volatile signed __int32 **)*((_QWORD *)v20 + 4), *v26 != v8) )
        {
          __fastfail(3u);
        }
        *v26 = (volatile signed __int32 *)v27;
        *(_QWORD *)(v27 + 8) = v26;
        *(_QWORD *)v8 = 0LL;
      }
      v28 = (__int64 *)(v20 + 10);
      if ( *((_QWORD *)v20 + 5) )
      {
        ...
        v34 = (__int64 *)*v28;
        if ( *(__int64 **)(*v28 + 8) != v28 || (v35 = (__int64 **)*((_QWORD *)v20 + 6), *v35 != v28) )
          __fastfail(3u);
        *v35 = v34;
        v34[1] = (__int64)v35;
        *v28 = 0LL;
    ...
    *(_QWORD *)v20 = 0LL;
    ...
    if ( (*(_BYTE *)(v21 + 72) & 0xF) == 3 && !*(_DWORD *)(v21 + 76) )
      CVirtualAddressAllocator::FreeVadVirtualAddressRangeInternal(this, (struct VIDMM_VAD *)v21, (__int64)v26);
  ...
  while ( v9 != (__int64 *)&v41 )
  {
    ...
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)v10 + 32, 0xFFFFFFFF) == 1 )
    {
      ...
      if ( v14 )
      {
        if ( *(_QWORD **)(v14 + 8) != v15 || (v36 = (_QWORD *)v10[2], (_QWORD *)*v36 != v15) )
          __fastfail(3u);
        *v36 = v14;
        *(_QWORD *)(v14 + 8) = v36;
        *v15 = 0LL;
      ...
      if ( (v16 & 0x1000) == 0 )
      {
        ...
        if ( v10[5] )
        {
          ...
          v38 = (__int64 *)*v17;
          if ( *(__int64 **)(*v17 + 8) != v17 || (v39 = (__int64 **)v10[6], *v39 != v17) )
            __fastfail(3u);
          *v39 = v38;
          v38[1] = (__int64)v39;
          *v17 = 0LL;
