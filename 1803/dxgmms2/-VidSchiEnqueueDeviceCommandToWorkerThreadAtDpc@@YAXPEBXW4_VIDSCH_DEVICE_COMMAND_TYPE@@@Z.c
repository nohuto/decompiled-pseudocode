/*
 * XREFs of ?VidSchiEnqueueDeviceCommandToWorkerThreadAtDpc@@YAXPEBXW4_VIDSCH_DEVICE_COMMAND_TYPE@@@Z @ 0x1C0027284
 * Callers:
...
LONG __fastcall VidSchiEnqueueDeviceCommandToWorkerThreadAtDpc(__int128 *a1, int a2)
{
  ...
  *((_QWORD *)&v26[1] + 1) = v9;
LABEL_7:
  Flink = v4[9].Header.WaitListHead.Flink;
  ...
  *((_QWORD *)PacketFromGuaranteedPacketPool + 11) = Flink;
  CurrentThread = KeGetCurrentThread();
  v18 = v26[1];
  v27 = 0;
  *((_OWORD *)PacketFromGuaranteedPacketPool + 17) = v26[0];
  *((_QWORD *)PacketFromGuaranteedPacketPool + 13) = CurrentThread;
  v19 = v26[2];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 18) = v18;
  v20 = v26[3];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 19) = v19;
  v21 = v26[4];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 20) = v20;
  v22 = v26[5];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 21) = v21;
  v23 = v26[6];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 22) = v22;
  v24 = v26[7];
  *((_OWORD *)PacketFromGuaranteedPacketPool + 23) = v23;
  *((_OWORD *)PacketFromGuaranteedPacketPool + 24) = v24;
  result = VidSchiUpdatePriorityTables(v4, PacketFromGuaranteedPacketPool, &v27);
  if ( (_DWORD)v2 == 5 )
  {
    ++LODWORD(Flink[50].Flink);
  }
  else if ( (_DWORD)v2 == 6 )
  {
    ++HIDWORD(Flink[50].Flink);
  }
  if ( v27 )
  {
    v4[58].Header.WaitListHead.Flink = (struct _LIST_ENTRY *)MEMORY[0xFFFFF78000000320];
    return KeSetEvent(v4 + 57, 0, 0);
  }
  return result;
}
