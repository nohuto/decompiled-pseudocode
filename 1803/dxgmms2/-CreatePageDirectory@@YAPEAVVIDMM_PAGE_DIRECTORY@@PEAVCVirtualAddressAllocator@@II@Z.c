/*
 * XREFs of ?CreatePageDirectory@@YAPEAVVIDMM_PAGE_DIRECTORY@@PEAVCVirtualAddressAllocator@@II@Z @ 0x1C00567D4
 * Callers:
        ...
        unsigned int a3)
{
  ...
  v6 = *(_QWORD *)(*((_QWORD *)a1 + 10) + 40720LL) + 1560LL * a2;
  ...
  if ( v10 )
  {
    ...
    *(_QWORD *)(v15 + 24) = 4172LL;
    WdLogEvent5_WdAssertion(v15);
    VIDMM_PAGE_DIRECTORY::DestroyPageDirectory(v10, a1, 0LL);
  }
  else
  {
    v14 = WdLogNewEntry5_WdAssertion(v9, v8);
    *(_QWORD *)(v14 + 24) = 4166LL;
