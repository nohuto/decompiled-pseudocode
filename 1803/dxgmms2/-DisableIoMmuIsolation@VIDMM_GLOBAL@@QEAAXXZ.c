/*
 * XREFs of ?DisableIoMmuIsolation@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C009FAD0
 * Callers:
 *     ?VidMmDisableIoMmuIsolation@@YAXPEAVVIDMM_GLOBAL@@@Z @ 0x1C0022D20 (-VidMmDisableIoMmuIsolation@@YAXPEAVVIDMM_GLOBAL@@@Z.c)
...
void __fastcall VIDMM_GLOBAL::DisableIoMmuIsolation(VIDMM_GLOBAL *this)
{
  ...
  else
  {
    memset(v6, 0, 0x58uLL);
    v6[0] = 131;
    VIDMM_GLOBAL::QueueSystemCleanupCommandAndWait(this, (struct _VIDMM_SYSTEM_COMMAND *)v6);
  }
}
