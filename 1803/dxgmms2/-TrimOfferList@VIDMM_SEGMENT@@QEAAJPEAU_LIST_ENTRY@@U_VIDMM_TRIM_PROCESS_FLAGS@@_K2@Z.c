/*
 * XREFs of ?TrimOfferList@VIDMM_SEGMENT@@QEAAJPEAU_LIST_ENTRY@@U_VIDMM_TRIM_PROCESS_FLAGS@@_K2@Z @ 0x1C00B4CEC
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  DXGPUSHLOCK::AcquireExclusive((DXGPUSHLOCK *)(*(_QWORD *)(a1 + 8) + 40488LL));
  v9 = (_QWORD *)*a2;
  while ( v9 != a2 )
  {
    v10 = (__int64)(v9 - 50);
