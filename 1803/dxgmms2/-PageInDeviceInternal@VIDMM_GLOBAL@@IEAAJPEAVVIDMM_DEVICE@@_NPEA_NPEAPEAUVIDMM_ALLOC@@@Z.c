/*
 * XREFs of ?PageInDeviceInternal@VIDMM_GLOBAL@@IEAAJPEAVVIDMM_DEVICE@@_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00603BC
 * Callers:
        ...
        struct VIDMM_ALLOC **a5)
{
  ...
  *a5 = 0LL;
  ...
  {
    v10 = *((_QWORD *)a2 + 4);
    if ( !v10 || !*(_BYTE *)(v10 + 188) && !_InterlockedCompareExchange((volatile signed __int32 *)(v10 + 184), 0, 0) )
    {
      v11 = *((_QWORD *)a2 + 3);
      if ( v11 )
      {
        DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(v11 + 624));
        a4 = v24;
        a3 = v23;
      }
...
LABEL_29:
            if ( v11 )
            {
              ExReleasePushLockSharedEx(v11 + 624, 0LL);
