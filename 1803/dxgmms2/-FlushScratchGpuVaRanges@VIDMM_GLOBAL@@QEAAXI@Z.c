/*
 * XREFs of ?FlushScratchGpuVaRanges@VIDMM_GLOBAL@@QEAAXI@Z @ 0x1C0079BF4
 * Callers:
...
void __fastcall VIDMM_GLOBAL::FlushScratchGpuVaRanges(VIDMM_GLOBAL *this, unsigned int a2)
{
  ...
  v3 = a2;
  v4 = 1560LL * a2;
  if ( (*(_BYTE *)(*((_QWORD *)this + 5090) + v4 + 436) & 1) != 0 )
  {
    if ( *((_QWORD *)this + a2 + 143) )
    {
      if ( *((_DWORD *)this + 2) )
      {
        ...
        if ( (v5 & 1) == 0 )
        {
          *((_BYTE *)this + 41449) = v5 | 1;
          v6 = (struct _KTHREAD **)*((_QWORD *)this + a2 + 5116);
          while ( 1 )
          {
            v7 = 0;
            while ( 1 )
            {
              v8 = (_QWORD **)(v4 + *((_QWORD *)this + 5090) + 464LL);
              v9 = *v8;
              if ( *v8 == v8 || !VidSchIsMonitoredFenceSignaled(*((_QWORD *)this + v3 + 746), v9[2]) )
                break;
              v11 = *v9;
              ...
              *v9 = 0LL;
              ...
              if ( VIDMM_GLOBAL::_Config >= 0 )
              {
                ...
                CVirtualAddressAllocator::UncommitVirtualAddressRange(
                  *((CVirtualAddressAllocator **)this + v3 + 5116),
