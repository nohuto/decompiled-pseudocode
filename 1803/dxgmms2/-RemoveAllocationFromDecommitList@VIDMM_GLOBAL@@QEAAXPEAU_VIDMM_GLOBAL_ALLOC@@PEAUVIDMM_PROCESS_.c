/*
 * XREFs of ?RemoveAllocationFromDecommitList@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAUVIDMM_PROCESS_ADAPTER_INFO@@@Z @ 0x1C00A30F4
 * Callers:
        ...
        struct VIDMM_PROCESS_ADAPTER_INFO *a3)
{
  ...
  v5 = v4 + 360;
  ExAcquirePushLockSharedEx(v4 + 360, 0LL);
  v6 = (_QWORD *)(v4 + 376);
