/*
 * XREFs of ?UpdatePageTable@VIDMM_PAGE_TABLE@@QEAAJPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@PEAX_KW4VIDMM_VAD_OWNER_TYPE@@II3U_DXGK_UPDATEPAGETABLEFLAGS@@@Z @ 0x1C009E6BC
 * Callers:
        ...
        struct _DXGK_UPDATEPAGETABLEFLAGS a10)
{
  ...
  struct _VIDMM_GLOBAL_ALLOC *v22; // rdx
  ...
  if ( (int)VIDMM_PAGE_TABLE_BASE::GetDriverUpdateAddress(a1, (struct CVirtualAddressAllocator *)a2, &v28, &v26, &v27) >= 0 )
  {
    ...
    if ( (*((_BYTE *)v10 + 41448) & 0x10) != 0 )
      v23 = DXGK_PAGETABLEUPDATE_CPU_VIRTUAL;
    else
      v23 = (__int16)*(_DWORD *)a1 >> 13;
    v24 = (void *)v26;
