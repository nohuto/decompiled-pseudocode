/*
 * XREFs of ?RecordVaPagingHistoryUpdatePte@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAU_DXGK_BUILDPAGINGBUFFER_UPDATEPAGETABLE@@PEAUVIDMM_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@I@Z @ 0x1C00AC8DC
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    ...
    *((_QWORD *)v10 + 1) = KeGetCurrentThread();
    ...
    if ( v13 )
    {
      v14 = *((_DWORD *)this + 10376);
      if ( v14 == dword_1C004733C )
      {
        *((_DWORD *)this + 10376) = 0;
        v14 = 0;
      }
      v15 = *(void **)(*((_QWORD *)this + 5187) + 24LL * v14 + 16);
      if ( v15 )
        operator delete(v15);
      ...
      *(_QWORD *)(*((_QWORD *)this + 5187) + 24LL * *((unsigned int *)this + 10376) + 16) = v13;
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = 4;
    }
    *((_QWORD *)v10 + 1) = 0LL;
