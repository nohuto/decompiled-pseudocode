/*
 * XREFs of VidSchiRecoverFromTDR @ 0x1C00BFBC0
 * Callers:
...
void __fastcall VidSchiRecoverFromTDR(__int64 a1)
{
    ...
    && (qword_1C0047068 & 0x400000000010LL) == qword_1C0047068 )
  {
    ...
    v20 = 8LL;
    v22 = 4LL;
    TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003AEDC, 0LL, (LPCGUID)8, 8u, &pData);
  }
  v5 = *(struct _TDR_RECOVERY_CONTEXT **)(a1 + 2864);
  *(_DWORD *)(a1 + 2860) = 2;
