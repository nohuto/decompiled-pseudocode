/*
 * XREFs of ?Free@VIDMM_LINEAR_POOL@@QEAAXPEAX@Z @ 0x1C00543D0
 * Callers:
 ...
 *     ?FreeScratchRange@VIDMM_MEMORY_SEGMENT@@UEAAXPEAX@Z @ 0x1C00B08C0 (-FreeScratchRange@VIDMM_MEMORY_SEGMENT@@UEAAXPEAX@Z.c)
 ...
 *     ?FreeMemoryBlocks@VIDMM_LINEAR_POOL@@QEAAJW4_VIDMM_POOL_BLOCK_STATE@@IPEAU_DXGK_MEMORYRANGE@@@Z @ 0x1C00BAB54 (-FreeMemoryBlocks@VIDMM_LINEAR_POOL@@QEAAJW4_VIDMM_POOL_BLOCK_STATE@@IPEAU_DXGK_MEMORYRANGE@@@Z.c)
 * Callees:
  ...
  if ( v2 && (v11 = *((_QWORD *)v2 + 1), v11 + *(_QWORD *)v2 == *(_QWORD *)a2) && *((_BYTE *)v2 + 56) == 2 )
  {
    *((_QWORD *)v2 + 1) = v11 + *((_QWORD *)a2 + 1);
    ...
    if ( *(struct _VIDMM_POOL_BLOCK **)(v15 + 8) != (struct _VIDMM_POOL_BLOCK *)((char *)a2 + 40)
      || (v16 = (struct _VIDMM_POOL_BLOCK **)*((_QWORD *)a2 + 6), *v16 != (struct _VIDMM_POOL_BLOCK *)((char *)a2 + 40)) )
    {
      __fastfail(3u);
    }
    ...
    *(_QWORD *)(v15 + 8) = v16;
    ...
    {
      v17 = *((_QWORD *)v2 + 1);
      if ( *(_QWORD *)v3 == v17 + *(_QWORD *)v2 && *((_BYTE *)v3 + 56) == 2 )
      {
        *((_QWORD *)v2 + 1) = v17 + *((_QWORD *)v3 + 1);
        v18 = *((_QWORD *)v3 + 3);
        if ( *(struct _VIDMM_POOL_BLOCK **)(v18 + 8) != (struct _VIDMM_POOL_BLOCK *)((char *)v3 + 24)
          || (v19 = (struct _VIDMM_POOL_BLOCK **)*((_QWORD *)v3 + 4),
              *v19 != (struct _VIDMM_POOL_BLOCK *)((char *)v3 + 24)) )
        {
          __fastfail(3u);
        }
        ...
        *(_QWORD *)(v18 + 8) = v19;
        v20 = *((_QWORD *)v3 + 5);
        if ( *(struct _VIDMM_POOL_BLOCK **)(v20 + 8) != (struct _VIDMM_POOL_BLOCK *)((char *)v3 + 40)
          || (v21 = (struct _VIDMM_POOL_BLOCK **)*((_QWORD *)v3 + 6),
              *v21 != (struct _VIDMM_POOL_BLOCK *)((char *)v3 + 40)) )
        {
          __fastfail(3u);
        }
        ...
        *(_QWORD *)(v20 + 8) = v21;
        v22 = v3;
LABEL_36:
        VIDMM_LINEAR_POOL::FreeBlock(this, v22);
      }
    }
  }
  else
