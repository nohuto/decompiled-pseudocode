/*
 * XREFs of ?ChangeVideoMemoryReservation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@KW4_D3DKMT_MEMORY_SEGMENT_GROUP@@_K@Z @ 0x1C009F138
 * Callers:
 *     VidMmChangeVideoMemoryReservation @ 0x1C0023220 (VidMmChangeVideoMemoryReservation.c)
 * Callees:
        ...
        unsigned __int64 a5)
{
  ...
  {
    DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED((DXGAUTOPUSHLOCKSHARED *)v12, (VIDMM_GLOBAL *)((char *)this + 41544));
