/*
 * XREFs of McTemplateK0pqqqPR3XR3p @ 0x1C0029628
 * Callers:
...
NTSTATUS McTemplateK0pqqqPR3XR3p(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  v20 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventSignalQueueSubmit, a3, 8u, &v4);
}
