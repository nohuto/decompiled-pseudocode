/*
 * XREFs of ?VidMmMapPagingProcessGpuVA@@YAJPEAVVIDMM_GLOBAL@@PEAUVIDMM_MONITORED_FENCE_STORAGE@@PEA_K@Z @ 0x1C0003C30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidMmMapPagingProcessGpuVA(
        ...
        unsigned __int64 *a3)
{
  return VIDMM_GLOBAL::MapGpuVA(a1, 0LL, 0LL, a2, a3, 1u, 0);
}
