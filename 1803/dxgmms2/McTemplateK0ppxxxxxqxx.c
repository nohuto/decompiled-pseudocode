/*
 * XREFs of McTemplateK0ppxxxxxqxx @ 0x1C00258D4
 * Callers:
...
NTSTATUS McTemplateK0ppxxxxxqxx(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v22 = 8LL;
  v24 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 0xBu, &v4);
}
