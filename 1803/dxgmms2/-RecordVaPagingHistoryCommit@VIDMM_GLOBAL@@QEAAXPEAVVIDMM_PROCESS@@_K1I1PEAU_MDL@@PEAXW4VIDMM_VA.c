/*
 * XREFs of ?RecordVaPagingHistoryCommit@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@_K1I1PEAU_MDL@@PEAXW4VIDMM_VAD_OWNER_TYPE@@@Z @ 0x1C00ABBF4
 * Callers:
        ...
        int a9)
{
  ...
  if ( *(_QWORD *)(a1 + 41496) )
  {
    ...
    *(_QWORD *)(v13 + 8) = KeGetCurrentThread();
    ...
    if ( v14 )
    {
      v15 = *(unsigned int *)(a1 + 41504);
      if ( (_DWORD)v15 == dword_1C004733C )
      {
        *(_DWORD *)(a1 + 41504) = 0;
        v15 = 0LL;
      }
      v16 = *(void **)(*(_QWORD *)(a1 + 41496) + 24 * v15 + 16);
      if ( v16 )
        operator delete(v16);
      v14[15] = a9;
      *((_QWORD *)v14 + 5) = a7;
      ...
      *((_QWORD *)v14 + 2) = a3;
      *((_QWORD *)v14 + 3) = a4;
      *(_QWORD *)(*(_QWORD *)(a1 + 41496) + 24LL * *(unsigned int *)(a1 + 41504)) = MEMORY[0xFFFFF78000000014];
      *(_QWORD *)(*(_QWORD *)(a1 + 41496) + 24LL * *(unsigned int *)(a1 + 41504) + 16) = v14;
      *(_DWORD *)(*(_QWORD *)(a1 + 41496) + 24LL * (unsigned int)(*(_DWORD *)(a1 + 41504))++ + 8) = 1;
    }
    *(_QWORD *)(v13 + 8) = 0LL;
