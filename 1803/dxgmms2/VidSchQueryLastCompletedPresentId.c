/*
 * XREFs of VidSchQueryLastCompletedPresentId @ 0x1C002EDB0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall VidSchQueryLastCompletedPresentId(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( a1 && a3 )
  {
    ...
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v6 + 1912), &LockHandle);
      *(_DWORD *)a3 = *(_DWORD *)(a1 + 4 * v3 + 492);
      v8 = *(_DWORD *)(a1 + 8 * v3 + 560);
      *(_DWORD *)(a3 + 8) = v8;
      *(_DWORD *)(a3 + 4) = v8;
      *(_QWORD *)(a3 + 16) = *(_QWORD *)(a1 + 8 * v3 + 688);
      *(_QWORD *)(a3 + 24) = *(_QWORD *)(a1 + 8 * v3 + 816);
