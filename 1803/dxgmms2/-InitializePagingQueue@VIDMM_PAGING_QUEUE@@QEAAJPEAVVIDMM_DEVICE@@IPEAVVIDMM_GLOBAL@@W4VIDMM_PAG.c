/*
 * XREFs of ?InitializePagingQueue@VIDMM_PAGING_QUEUE@@QEAAJPEAVVIDMM_DEVICE@@IPEAVVIDMM_GLOBAL@@W4VIDMM_PAGING_QUEUE_TYPE@@@Z @ 0x1C0073644
 * Callers:
      ...
      *(_QWORD *)(a1 + 24) = v12;
      if ( v10 >= 2 )
      {
        ...
        *(_BYTE *)(a1 + 128) = v15;
        ...
        if ( v16 )
        {
          if ( !*(_BYTE *)(v16 + 320) && !*(_BYTE *)(v16 + 322) )
            v6 = 0;
          *(_BYTE *)(a1 + 129) = v6;
        }
