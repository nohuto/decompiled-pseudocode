/*
 * XREFs of ?EnableIoMmuIsolation@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C009FBD0
 * Callers:
 *     ?VidMmEnableIoMmuIsolation@@YAJPEAVVIDMM_GLOBAL@@@Z @ 0x1C0022D40 (-VidMmEnableIoMmuIsolation@@YAJPEAVVIDMM_GLOBAL@@@Z.c)
 ...
 *     ?FlushAllTemporaryAllocation@VIDMM_GLOBAL@@IEAAXI@Z @ 0x1C009DE54 (-FlushAllTemporaryAllocation@VIDMM_GLOBAL@@IEAAXI@Z.c)
...
__int64 __fastcall VIDMM_GLOBAL::EnableIoMmuIsolation(VIDMM_GLOBAL *this)
{
  ...
  _DWORD v22[24]; // [rsp+30h] [rbp-68h] BYREF

  if ( KeGetCurrentThread() != *(struct _KTHREAD **)(*(_QWORD *)this + 8LL) )
  {
    memset(v22, 0, 0x58uLL);
    v22[0] = 130;
    return VIDMM_GLOBAL::QueueSystemCleanupCommandAndWait(this, (struct _VIDMM_SYSTEM_COMMAND *)v22);
  }
  for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 926); i = (unsigned int)(i + 1) )
  {
    ...
    if ( (v5 & 0x1001) != 0 )
    {
      v6 = VIDMM_SEGMENT::MapAllocationsToIoMmu(*(VIDMM_SEGMENT **)(*((_QWORD *)this + 464) + 8 * i));
    }
    else
    {
      if ( (v5 & 0x40) == 0 )
  ...
  for ( j = 0; j < *((_DWORD *)this + 1748); ++j )
    VIDMM_GLOBAL::FlushAllTemporaryAllocation(this, j);
  DXGAUTOPUSHLOCKFASTEXCLUSIVE::DXGAUTOPUSHLOCKFASTEXCLUSIVE(
    (DXGAUTOPUSHLOCKFASTEXCLUSIVE *)&v20,
    (VIDMM_GLOBAL *)((char *)this + 3816));
  for ( k = (_QWORD *)*((_QWORD *)this + 475); ; k = (_QWORD *)*k )
  {
    if ( k == (_QWORD *)((char *)this + 3800) )
    {
      v16 = v21 == 0;
      *((_BYTE *)this + 40676) = 1;
      if ( !v16 )
    ...
    v13 = DpiMapIommuIdentityRange(*(_QWORD *)(*((_QWORD *)this + 3) + 192LL), k[5]);
    v9 = v13;
    if ( v13 < 0 )
      break;
  }
