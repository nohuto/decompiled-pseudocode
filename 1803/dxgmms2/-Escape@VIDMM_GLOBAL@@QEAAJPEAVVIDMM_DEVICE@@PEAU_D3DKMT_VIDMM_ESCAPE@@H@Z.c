/*
 * XREFs of ?Escape@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@PEAU_D3DKMT_VIDMM_ESCAPE@@H@Z @ 0x1C009FF04
 * Callers:
 *     VidMmEscape @ 0x1C00232A0 (VidMmEscape.c)
 * Callees:
...
LABEL_20:
  ...
  {
    v7 = VIDMM_GLOBAL::ApertureCorruptionCheck(this, 0LL, (__int64)a3);
    goto LABEL_20;
  }
  if ( Type != D3DKMT_VIDMMESCAPETYPE_SUSPEND_CPU_ACCESS_TEST )
  {
    switch ( Type )
    {
      case D3DKMT_VIDMMESCAPETYPE_SET_TRIM_INTERVALS:
        ...
        v10 = dword_1C004739C;
        v11 = dword_1C0047394;
        dword_1C00473A0 = a3->Wake.bFlush;
        dword_1C004739C = a3->Evict.AllocationHandle;
        dword_1C0047394 = a3->SuspendProcess.bAllowWakeOnSubmission;
...
LABEL_21:
        ...
        switch ( a3->Type )
        {
          ...
          case D3DKMT_VIDMMESCAPETYPE_SET_BUDGET:
            ...
            v21 = *(VIDMM_GLOBAL ***)(*(_QWORD *)(v18 + 16) + 8LL * *(unsigned int *)(*((_QWORD *)this + 3) + 200LL));
            if ( v21 )
            {
              v22 = *v21;
