/*
 * XREFs of ?ReadBudgetConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C0083D0C
 * Callers:
...
void VIDMM_GLOBAL::ReadBudgetConfiguration(void)
{
  ...
  v4 = 10000 * v26;
  v5 = 10000 * v24;
  dword_1C00473A0 = 10000 * v26;
  dword_1C0047394 = 10000 * v2;
  dword_1C004739C = 10000 * v24;
  dword_1C0047398 = 10000 * v3;
  if ( 10000 * v24 <= 0xEA60 )
  {
    if ( v5 < 0x10 )
    {
