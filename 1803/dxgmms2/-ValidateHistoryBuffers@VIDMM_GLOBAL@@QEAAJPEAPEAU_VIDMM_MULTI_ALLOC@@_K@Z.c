/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00A54EC
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C00236C0 (VidMmValidateHistoryBuffers.c)
 * Callees:
