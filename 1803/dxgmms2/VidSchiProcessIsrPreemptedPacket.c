/*
 * XREFs of VidSchiProcessIsrPreemptedPacket @ 0x1C000E144
 * Callers:
    ...
    do
    {
      ...
      *(_DWORD *)(a1 + 492) = ((unsigned __int8)*(_DWORD *)(a1 + 492) + 1) & 0xF;
      ...
      if ( *(_DWORD *)(v10 + 88) == 3 )
      {
        ...
        *(_DWORD *)(v10 + 72) = 10;
        *(_DWORD *)(v10 + 16) = 1;
        _InterlockedDecrement((volatile signed __int32 *)(a1 + 2840));
      }
      else
      {
        *(_QWORD *)(a1 + 56) = v13;
