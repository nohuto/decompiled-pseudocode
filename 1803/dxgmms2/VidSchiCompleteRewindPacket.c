/*
 * XREFs of VidSchiCompleteRewindPacket @ 0x1C000E5FC
 * Callers:
      ...
      do
      {
        ...
        if ( (v16 & 0x10) != 0 )
        {
          *(_DWORD *)(v13 + 80) = v16 & 0xFFFFFFEF;
          v11 = *(unsigned int *)(v2 + 6256);
          if ( (_DWORD)v11 != -1 )
          {
            v20 = *(void (__fastcall **)(_QWORD))(v6 + 2920);
            if ( v20 )
              v20(*(_QWORD *)(v6 + 2952));
          }
        }
        ...
        if ( a2 )
        {
          ...
          {
            _InterlockedIncrement((volatile signed __int32 *)(v2 + 2808));
            *(_QWORD *)(v6 + 424) |= 1LL << *(_WORD *)(v2 + 4);
          }
        }
        v12 = *(_QWORD *)(v13 + 32);
        v13 = v12 - 32;
    ...
    *(_QWORD *)(a1 + 648) = 0LL;
    if ( (v18 & 0x200) != 0 )
    {
      if ( (((unsigned __int8)(*(_DWORD *)(a1 + 184) >> 9) | *(_BYTE *)(a1 + 184)) & 2) == 0 )
        VidSchiUpdateContextStatus(a1, (_QWORD *)0xA, (_QWORD *)0x3513);
    }
    ...
    {
      return (unsigned int)VidSchiUpdateContextStatus(a1, (_QWORD *)5, (_QWORD *)0x3520);
    }
  }
  return v3;
}
