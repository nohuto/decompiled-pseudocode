/*
 * XREFs of ?ReadPhysicalAdapterConfiguration@VIDMM_GLOBAL@@IEAAXI@Z @ 0x1C007D160
 * Callers:
...
void __fastcall VIDMM_GLOBAL::ReadPhysicalAdapterConfiguration(VIDMM_GLOBAL *this, unsigned int a2)
{
  ...
  v2 = (unsigned __int64 *)(*((_QWORD *)this + 5090) + 1560LL * a2);
  DpiGetPnpRegistryKeyName(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 3) + 2360LL) + 352LL * a2 + 8));
  v3 = Source;
  v4 = 0;
