/*
 * XREFs of McTemplateK0pppxxq @ 0x1C0024190
 * Callers:
...
NTSTATUS McTemplateK0pppxxq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v14 = 8LL;
  v16 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventMemoryTransfer, a3, 7u, &v4);
}
