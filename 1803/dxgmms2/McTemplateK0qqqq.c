/*
 * XREFs of McTemplateK0qqqq @ 0x1C002A45C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqq(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 4LL;
  v15 = &a7;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventDWMVsyncSignal, a3, 5u, &v8);
}
