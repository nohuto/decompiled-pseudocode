/*
 * XREFs of ?PatchGapsWithFreeBlocks@VIDMM_LINEAR_POOL@@QEAAX_K0@Z @ 0x1C00BB39C
 * Callers:
    ...
    if ( v3 != v12 )
    {
      if ( v11 == 2 )
      {
        ...
        if ( *(struct _VIDMM_POOL_BLOCK **)(v17 + 8) != (struct _VIDMM_POOL_BLOCK *)((char *)v9 + 24)
          || (v18 = (_QWORD *)*((_QWORD *)v9 + 4), (_QWORD *)*v18 != v16) )
        {
          __fastfail(3u);
        }
        *v18 = v17;
        ...
        *((_QWORD *)v9 + 4) = 0LL;
        v19 = *(_QWORD *)v10;
        if ( *(char **)(*(_QWORD *)v10 + 8LL) != v10 || (v20 = (char **)*((_QWORD *)v10 + 1), *v20 != v10) )
          __fastfail(3u);
        *v20 = (char *)v19;
        *(_QWORD *)(v19 + 8) = v20;
        *(_QWORD *)v10 = 0LL;
