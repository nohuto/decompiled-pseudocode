/*
 * XREFs of ?DestroyAllocation@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_DEVICE@@PEAU_VIDMM_MULTI_GLOBAL_ALLOC@@@Z @ 0x1C0068680
 * Callers:
 *     VidMmDestroyAllocation @ 0x1C0003140 (VidMmDestroyAllocation.c)
 * Callees:
