/*
 * XREFs of ?CurateVPR@VIDMM_SEGMENT@@QEAAXXZ @ 0x1C00B1F04
 * Callers:
 ...
 *     Percentagex100 @ 0x1C00B33F0 (Percentagex100.c)
 *     ?CalculateCapacity@VIDMM_LINEAR_POOL@@QEAA_KXZ @ 0x1C00BA338 (-CalculateCapacity@VIDMM_LINEAR_POOL@@QEAA_KXZ.c)
 */
    ...
    *((_BYTE *)this + 448) = 1;
    if ( !v2 )
    {
      ...
      if ( ((unsigned __int16)Microsoft_Windows_DxgKrnlEnableBits & 0x400) != 0 )
      {
        ...
        Percentagex100((unsigned int)dword_1C0047440, (unsigned int)dword_1C0047444);
        v28 = v4;
        LOWORD(v27) = v3;
    ...
    v8 = *((_QWORD *)this + 54);
    v9 = *((_QWORD *)this + 55);
    if ( v9 < v8 * (unsigned __int64)(unsigned int)dword_1C0047440 / (unsigned int)dword_1C0047444 )
    {
      v10 = VIDMM_LINEAR_POOL::CalculateCapacity(*((VIDMM_LINEAR_POOL **)this + 19));
      v12 = v8 - v9;
      v13 = (unsigned int)dword_1C004744C;
      v14 = (unsigned __int64)(unsigned int)dword_1C0047448 * v12 % (unsigned int)dword_1C004744C;
      if ( v10 < (unsigned __int64)(unsigned int)dword_1C0047448 * v12 / (unsigned int)dword_1C004744C )
      {
        v30 = 0LL;
        v29 = 0;
