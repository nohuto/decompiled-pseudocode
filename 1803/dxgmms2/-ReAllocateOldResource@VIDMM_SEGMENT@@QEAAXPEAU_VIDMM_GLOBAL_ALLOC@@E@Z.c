/*
 * XREFs of ?ReAllocateOldResource@VIDMM_SEGMENT@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@E@Z @ 0x1C00B3CC0
 * Callers:
...
void __fastcall VIDMM_SEGMENT::ReAllocateOldResource(VIDMM_SEGMENT *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  *((_QWORD *)this + 28) += *((_QWORD *)a2 + 2);
  if ( *((_DWORD *)this + 92) != -1 && (*((_DWORD *)a2 + 19) & 0x200) == 0 )
  {
    ...
    v13 = v12 + *((_QWORD *)a2 + 2);
    *((_QWORD *)this + 29) = v13;
    if ( v12 <= qword_1C0047410 && v13 > qword_1C0047410 )
      (*(void (__fastcall **)(_QWORD))(*((_QWORD *)this + 1) + 40584LL))(*(_QWORD *)(*((_QWORD *)this + 1) + 40648LL));
    if ( !v12 )
...
LABEL_21:
    *(_QWORD *)(*((_QWORD *)this + 1) + 40704LL) += *((_QWORD *)a2 + 2);
    v14 = *((_DWORD *)this + 20);
  }
  if ( (v14 & 0x20) != 0 )
    v16 = *((_QWORD *)a2 + 3);
  ...
  *v20 = (VIDMM_SEGMENT *)v19;
  ...
  if ( *v21 != (VIDMM_SEGMENT *)((char *)this + 160) )
    __fastfail(3u);
