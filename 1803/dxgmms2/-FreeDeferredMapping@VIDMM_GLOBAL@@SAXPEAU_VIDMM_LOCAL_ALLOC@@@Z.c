/*
 * XREFs of ?FreeDeferredMapping@VIDMM_GLOBAL@@SAXPEAU_VIDMM_LOCAL_ALLOC@@@Z @ 0x1C00A06C8
 * Callers:
 *     VidMmFreeDeferredMapping @ 0x1C00232C0 (VidMmFreeDeferredMapping.c)
 * Callees:
...
void __fastcall VIDMM_GLOBAL::FreeDeferredMapping(struct _VIDMM_LOCAL_ALLOC *a1, __int64 a2, __int64 a3)
{
  ...
  v5 = *(_QWORD *)a1;
  v6 = (*(_DWORD *)(*(_QWORD *)a1 + 80LL) & 0x20000) != 0;
