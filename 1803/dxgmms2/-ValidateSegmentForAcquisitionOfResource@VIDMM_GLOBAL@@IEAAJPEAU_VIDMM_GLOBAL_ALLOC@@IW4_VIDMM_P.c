/*
 * XREFs of ?ValidateSegmentForAcquisitionOfResource@VIDMM_GLOBAL@@IEAAJPEAU_VIDMM_GLOBAL_ALLOC@@IW4_VIDMM_PLACEMENT_RESTRICTION@@E@Z @ 0x1C0062DE0
 * Callers:
        ...
        char a5)
{
  ...
  else
  {
    ...
    if ( (a1 & 0x8000) != 0 && *(_DWORD *)(a2 + 344) || (a1 & 0x4000) != 0 )
      goto LABEL_11;
  }
  if ( a4 != 2 || (v8 & 0x1001) != 0 )
  {
...
LABEL_5:
      ...
      if ( _bittest(&v9, (unsigned __int8)(a3 - *(_BYTE *)(a1 + v7[5090] + 20))) )
        return 0LL;
    }
  }
LABEL_11:
