/*
 * XREFs of VidSchSetQueuedPresentLimit @ 0x1C0057FF0
 * Callers:
...
__int64 __fastcall VidSchSetQueuedPresentLimit(__int64 a1, __int64 a2)
{
  ...
  v3 = *(_QWORD *)(a1 + 32);
  if ( *(_BYTE *)(a1 + 188) || _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 184), 0, 0) )
  {
