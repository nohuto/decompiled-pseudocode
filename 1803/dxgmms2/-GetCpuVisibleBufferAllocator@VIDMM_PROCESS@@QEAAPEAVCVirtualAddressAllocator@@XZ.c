/*
 * XREFs of ?GetCpuVisibleBufferAllocator@VIDMM_PROCESS@@QEAAPEAVCVirtualAddressAllocator@@XZ @ 0x1C00A887C
 * Callers:
...
struct CVirtualAddressAllocator *__fastcall VIDMM_PROCESS::GetCpuVisibleBufferAllocator(VIDMM_PROCESS *this)
{
  ...
  *((_QWORD *)this + 26) = v7;
  if ( v7 )
  {
    ...
    v11 = CVirtualAddressAllocator::InitializeVaAllocator(v7, *(_QWORD *)(*(_QWORD *)(v10 + 456) + 168LL), 0, 0LL, 0LL);
