/*
 * XREFs of McTemplateK0qqqxxp @ 0x1C002618C
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqqxxp(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a9)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventUpdateVPR, a3, 7u, &v10);
}
