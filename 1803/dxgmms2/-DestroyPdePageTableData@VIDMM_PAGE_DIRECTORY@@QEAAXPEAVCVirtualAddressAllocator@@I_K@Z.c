/*
 * XREFs of ?DestroyPdePageTableData@VIDMM_PAGE_DIRECTORY@@QEAAXPEAVCVirtualAddressAllocator@@I_K@Z @ 0x1C0053584
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  if ( (v9 & 2) == 0 )
  {
    ...
    if ( (v9 & 0x400) != 0 )
    {
      ExFreeToPagedLookasideList((PPAGED_LOOKASIDE_LIST)(*((_QWORD *)a2 + 10) + 40768LL), *(PVOID *)(v10 + 8LL * a3));
    }
    else
    {
      v11 = *(VIDMM_PAGE_TABLE **)(v10 + 8LL * a3);
      if ( (*(_DWORD *)this & 0x20) != 0 )
        VIDMM_PAGE_TABLE::DestroyPageTable(v11, a2, a4);
      else
        VIDMM_PAGE_DIRECTORY::DestroyPageDirectory(v11, a2, a4);
    }
