/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00A55DC
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C0023240 (VidMmCreateCompanionContext.c)
 * Callees:
