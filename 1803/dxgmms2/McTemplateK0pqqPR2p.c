/*
 * XREFs of McTemplateK0pqqPR2p @ 0x1C00291EC
 * Callers:
...
NTSTATUS McTemplateK0pqqPR2p(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  va_copy(v14, va3);
  v15 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventReferenceWrittenPrimaries, a3, 6u, &v4);
}
