/*
 * XREFs of ?DemoteAllocationsToFitGlobalAlloc@VIDMM_WORKER_THREAD@@AEAAXPEAU_VIDMM_GLOBAL_ALLOC@@PEAVVIDMM_DEVICE@@AEBUVIDMM_PAGE_IN_POLICY_PER_COMBINATION@@W4VIDMM_BUDGET_PRIORITY_BAND@@PEA_N@Z @ 0x1C00A75BC
 * Callers:
 ...
 *     ?CanSuspendThisDevice@VIDMM_DEVICE@@QEAA_NPEAV1@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_PRIORITY_BAND@@@Z @ 0x1C00A7540 (-CanSuspendThisDevice@VIDMM_DEVICE@@QEAA_NPEAV1@W4VIDMM_SUSPEND_CANDIDATE_PASS@@W4VIDMM_BUDGET_P.c)
...
char VIDMM_WORKER_THREAD::DemoteAllocationsToFitGlobalAlloc(__int64 *a1, __int64 a2, VIDMM_DEVICE *a3, ...)
{
  ...
  *v69 = 0;
  ...
  do
  {
    ...
    v49 &= ~(1 << v11);
    v57 = v11 + *(_DWORD *)(1560 * (v13 & 0x3F) + *(_QWORD *)(*v4 + 40720) + 20);
    v7 = *(_QWORD *)(v12 + 3712);
    v62 = v57;
            ...
            if ( !(unsigned __int8)PsIsSystemProcess(*v32) )
            {
              ...
              while ( v34 != v33 )
              {
                ...
                if ( VIDMM_DEVICE::CanSuspendThisDevice(v35, v65, v66, v68) )
                {
                  ...
                  if ( *v31 )
                  {
                    if ( *(__int64 **)(v40 + 8) != v31 || (v41 = (__int64 **)v31[1], *v41 != v31) )
                      __fastfail(3u);
                    *v41 = (__int64 *)v40;
                    *(_QWORD *)(v40 + 8) = v41;
                    v42 = v55;
                    v43 = *(__int64 ***)(v55 + 144);
                    if ( *v43 != (__int64 *)(v55 + 136) )
                      __fastfail(3u);
                    *v31 = v55 + 136;
                    v31[1] = (__int64)v43;
                    *v43 = v31;
...
LABEL_90:
    ...
    if ( (VIDMM_GLOBAL::_Config & 0x40) != 0 && (_DWORD)v68 != 2 )
    {
