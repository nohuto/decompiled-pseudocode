/*
 * XREFs of ?ReadPagingConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C00837C0
 * Callers:
...
void VIDMM_GLOBAL::ReadPagingConfiguration(void)
{
  ...
  qword_1C00473B8 = 10000LL * v3;
  qword_1C00473C0 = 10000LL * v4;
  qword_1C00473C8 = 10000LL * v5;
  qword_1C00473D0 = 10000LL * v6;
  qword_1C00473F0 = v29;
  dword_1C00473F8 = v9;
  qword_1C00473D8 = 10000LL * v0;
  qword_1C00473E0 = (unsigned int)(10000 * v7);
  qword_1C0047418 = (unsigned __int64)v10 << 20;
  dword_1C0047348 = v11;
  dword_1C00473FC = v12;
  dword_1C0047400 = v13;
  qword_1C00473E8 = (unsigned int)(10000 * v8);
}
