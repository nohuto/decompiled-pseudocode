/*
 * XREFs of ?CreateVaAllocator@VIDMM_PAGING_PROCESS@@QEAAJPEAVVIDMM_GLOBAL@@@Z @ 0x1C00AAB60
 * Callers:
...
__int64 __fastcall VIDMM_PAGING_PROCESS::CreateVaAllocator(VIDMM_PAGING_PROCESS *this, struct VIDMM_GLOBAL *a2)
{
  ...
  *((_QWORD *)this + 2) = a2;
  ...
  while ( 1 )
  {
    ...
    if ( (*(_BYTE *)(*((_QWORD *)a2 + 5090) + v5 + 436) & 1) == 0 )
      goto LABEL_9;
