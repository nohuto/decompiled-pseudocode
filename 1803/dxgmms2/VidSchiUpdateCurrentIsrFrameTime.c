/*
 * XREFs of VidSchiUpdateCurrentIsrFrameTime @ 0x1C001555C
 * Callers:
...
LARGE_INTEGER __fastcall VidSchiUpdateCurrentIsrFrameTime(__int64 a1, __int64 a2, char a3)
{
  ...
  v3 = 0LL;
  v16.QuadPart = 0LL;
  result.QuadPart = (unsigned int)_InterlockedExchange((volatile __int32 *)(a2 + 28072), 0);
  v6 = a3 != 0;
  if ( result.LowPart )
  {
    v16 = KeQueryPerformanceCounter(&PerformanceFrequency);
    if ( !*(_QWORD *)(a2 + 28064) )
      *(union _LARGE_INTEGER *)(a2 + 28064) = PerformanceFrequency;
    v11 = _InterlockedCompareExchange64((volatile signed __int64 *)(a2 + 28088), 0LL, 0LL);
    v10 = v16;
    v12 = v11;
    v13 = *(_QWORD *)(a2 + 28008);
  ...
  if ( LowPart )
  {
    ...
    *(_QWORD *)(a2 + 28016) += LowPart;
    *(LARGE_INTEGER *)(a2 + 28008) = v10;
    if ( *(_BYTE *)(a2 + 8) )
    {
      if ( !*(_BYTE *)(a1 + 136) )
      {
        ...
        v19 = 0LL;
        v20 = 0;
        result.QuadPart = ((__int64 (__fastcall *)(__int64, _QWORD, _QWORD, __int64 *))DxgCoreInterface[59])(
                            v14,
                            0LL,
                            0LL,
                            &v17);
