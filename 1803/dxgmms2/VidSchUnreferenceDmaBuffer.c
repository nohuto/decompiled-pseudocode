/*
 * XREFs of VidSchUnreferenceDmaBuffer @ 0x1C00BE764
 * Callers:
...
void __fastcall VidSchUnreferenceDmaBuffer(__int64 a1, struct _VIDMM_DMA_BUFFER *a2)
{
  ...
  *(_QWORD *)(a1 + 1680) = MEMORY[0xFFFFF78000000320];
  KeSetEvent((PRKEVENT)(a1 + 1648), 0, 0);
  VidSchiSignalRegisteredEvent(a1, (struct _KEVENT **)(a1 + 1864));
}
