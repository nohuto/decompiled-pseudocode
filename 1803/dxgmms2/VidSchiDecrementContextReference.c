/*
 * XREFs of VidSchiDecrementContextReference @ 0x1C0012890
 * Callers:
...
void __fastcall VidSchiDecrementContextReference(struct _VIDSCH_CONTEXT *a1, int a2)
{
  ...
  if ( _InterlockedExchangeAdd((volatile signed __int32 *)a1 + 18, 0xFFFFFFFF) == 1 )
  {
    ...
    *(_QWORD *)(v8 + 8) = v9;
    while ( 1 )
    {
      v10 = VidSchiInterlockedRemoveHeadListIfExist((KSPIN_LOCK *)(v4 + 1912), (_QWORD **)a1 + 88, (_DWORD *)a1 + 180);
      if ( !v10 )
        break;
    ...
    if ( (*((_DWORD *)a1 + 28) & 0x100) != 0 )
    {
      while ( 1 )
      {
        v12 = VidSchiInterlockedRemoveHeadListIfExist((KSPIN_LOCK *)(v4 + 1912), (_QWORD **)a1 + 91, (_DWORD *)a1 + 186);
        if ( !v12 )
          break;
