/*
 * XREFs of ?VidMmFindAlignedRange@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z @ 0x1C007138C
 * Callers:
...
__int64 __fastcall VidMmFindAlignedRange(_BYTE *a1, struct _RTL_BALANCED_NODE *a2)
{
  ...
  else if ( ((__int64)a2[3].Children[0][5].Right & 1) == 0 && a1[16] )
  {
    return 0xFFFFFFFFLL;
  }
  v7 = ~(*((_QWORD *)v6 + 1) - 1LL) & ((unsigned __int64)v4 + *((_QWORD *)v6 + 1) - 1);
  if ( v7 >= (unsigned __int64)v4 && v7 < ParentValue && ParentValue - v7 >= v5 )
  {
    v3[2].Children[0] = (struct _RTL_BALANCED_NODE *)v7;
    return 0LL;
  }
  return 0xFFFFFFFFLL;
}
