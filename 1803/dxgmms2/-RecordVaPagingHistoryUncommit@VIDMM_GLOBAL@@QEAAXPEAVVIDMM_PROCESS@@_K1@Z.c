/*
 * XREFs of ?RecordVaPagingHistoryUncommit@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@_K1@Z @ 0x1C00AC4B4
 * Callers:
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    ...
    *((_QWORD *)v8 + 1) = KeGetCurrentThread();
    ...
    if ( v9 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = 2;
    }
    *((_QWORD *)v8 + 1) = 0LL;
