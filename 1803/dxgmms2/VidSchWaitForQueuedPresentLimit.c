/*
 * XREFs of VidSchWaitForQueuedPresentLimit @ 0x1C0074940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall VidSchWaitForQueuedPresentLimit(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( a1 )
  {
    ...
    else if ( *(_BYTE *)(a1 + 188) || (v6 = 0, _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 184), 0, 0)) )
    {
    ...
    else
    {
      ...
      if ( *(_DWORD *)(v7 + 1084) >= *(_DWORD *)(a1 + 228) )
      {
        if ( !a3 )
          return 3223191810LL;
        ...
        VidSchiInterlockedRemoveEntryList((KSPIN_LOCK *)(v5 + 1920), v12, 0LL);
      }
      return v6;
    }
  }
