/*
 * XREFs of ?VidSchiSelectContextFromThisPriority@@YAPEAU_VIDSCH_CONTEXT@@PEAU_VIDSCH_NODE@@K_N@Z @ 0x1C000B980
 * Callers:
        ...
        char a3)
{
  ...
  v4 = 0;
  v20 = 0LL;
  v6 = (*(_DWORD *)(v3 + 2192) >> 2) & 1;
  v7 = v6 && a3;
  v8 = 2LL * a2;
  v9 = (_QWORD *)*((_QWORD *)a1 + 2 * a2 + 251);
  v10 = v9 - 1;
  v11 = *((_QWORD *)a1 + 2 * a2 + 252) - 8LL;
  if ( v9 - 1 == (_QWORD *)v11 )
  {
    if ( !v7 )
    {
  ...
  result = v20;
  if ( !v20 )
    return (struct _VIDSCH_CONTEXT *)(*((_QWORD *)a1 + v8 + 251) - 8LL);
  return result;
}
