/*
 * XREFs of ?SetupAllocationForCPUAccess@VIDMM_GLOBAL@@IEAAJPEAUVIDMM_ALLOC@@IEE@Z @ 0x1C00A3950
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::SetupAllocationForCPUAccess(VIDMM_GLOBAL *this, __int64 **a2)
{
  ...
  if ( (*(_DWORD *)(v6 + 80) & 4) != 0
    ...
    && (LOBYTE(this) = (*(_DWORD *)(v5 + 80) & 0x8000) == 0, ((unsigned __int8)this & ((v7 & 2) == 0)) != 0) )
  {
          ...
          if ( v13 < 0 )
          {
            ...
            if ( bTracingEnabled )
            {
              if ( ((unsigned __int8)Microsoft_Windows_DxgKrnlEnableBits & 0x40) != 0 )
                McTemplateK0q(v14, (__int64)&EventPerformanceWarning, v15, 7);
            }
            _InterlockedIncrement(dword_1C0047660);
