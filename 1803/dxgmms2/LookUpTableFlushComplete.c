/*
 * XREFs of LookUpTableFlushComplete @ 0x1C0085CF4
 * Callers:
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0053710 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C0034F30 (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C00C0014 (UpdateInternalStatsOnFlush.c)
 */
...
_UNKNOWN **__fastcall LookUpTableFlushComplete(_DWORD *a1)
{
  ...
  if ( a1[64] )
  {
    ...
    if ( *(_QWORD *)(v4 + 288) )
    {
      if ( (unsigned int)dword_1C0047090 > 5
        && (qword_1C00470A0 & 0x400000000000LL) != 0
        && (qword_1C00470A8 & 0x400000000000LL) == qword_1C00470A8 )
      {
        ...
        v33 = 4LL;
        v35 = 4LL;
        TlgWrite((TraceLoggingHProvider)&dword_1C0047090, &unk_1C003AFCF, 0LL, v5, 0xBu, &pData);
      }
