/*
 * XREFs of McTemplateK0pqqxxxxqb @ 0x1C003217C
 * Callers:
...
NTSTATUS McTemplateK0pqqxxxxqb(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v23 = 0;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventSchedulingLog, 0LL, 0xAu, &v4);
}
