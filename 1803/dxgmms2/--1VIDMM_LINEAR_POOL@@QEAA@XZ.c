/*
 * XREFs of ??1VIDMM_LINEAR_POOL@@QEAA@XZ @ 0x1C00BA1DC
 * Callers:
...
void __fastcall VIDMM_LINEAR_POOL::~VIDMM_LINEAR_POOL(VIDMM_LINEAR_POOL *this)
{
  ...
  {
    if ( *((_QWORD **)v8 + 1) != v7 || (v9 = *(_QWORD *)v8, *(VIDMM_LINEAR_POOL **)(*(_QWORD *)v8 + 8LL) != v8) )
      __fastfail(3u);
    *v7 = v9;
    *(_QWORD *)(v9 + 8) = v7;
    ...
    if ( v11[1] != (VIDMM_LINEAR_POOL *)((char *)this + 72) || (v13 = *v11, *((VIDMM_LINEAR_POOL ***)*v11 + 1) != v11) )
      __fastfail(3u);
    *v10 = v13;
    *((_QWORD *)v13 + 1) = v10;
  ...
  while ( 1 )
  {
    ...
    if ( *v14 == v14 )
      break;
    if ( *((void ***)v15 + 1) != v14 || (v16 = *(void ***)v15, *(void **)(*(_QWORD *)v15 + 8LL) != v15) )
      __fastfail(3u);
    *v14 = v16;
    v16[1] = v14;
