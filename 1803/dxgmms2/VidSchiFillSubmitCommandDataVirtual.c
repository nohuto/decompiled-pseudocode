/*
 * XREFs of VidSchiFillSubmitCommandDataVirtual @ 0x1C00069B0
 * Callers:
...
__int64 __fastcall VidSchiFillSubmitCommandDataVirtual(__int64 a1, _QWORD *a2)
{
  ...
  *((_DWORD *)a2 + 14) = *(unsigned __int16 *)(*(_QWORD *)(v6 + 8LL * *(unsigned __int16 *)(v5 + 4) + 440) + 6LL);
  result = *(unsigned __int16 *)(*(_QWORD *)(v6 + 8LL * *(unsigned __int16 *)(v5 + 4) + 440) + 8LL);
  *((_DWORD *)a2 + 15) = result;
  return result;
}
