/*
 * XREFs of VidSchiIsQuantumLeft @ 0x1C000E89C
 * Callers:
 ...
 * Callees:
 *     ?VidSchiSelectContextFromThisProcess@@YAXPEAU_VIDSCH_CONTEXT@@PEAPEAU1@@Z @ 0x1C000E99C (-VidSchiSelectContextFromThisProcess@@YAXPEAU_VIDSCH_CONTEXT@@PEAPEAU1@@Z.c)
...
__int64 __fastcall VidSchiIsQuantumLeft(__int64 a1, struct _VIDSCH_CONTEXT **a2)
{
  ...
  if ( _InterlockedCompareExchange((volatile signed __int32 *)(a1 + 436), (*(_DWORD *)(a1 + 184) >> 1) & 1, 3) == 2 )
  {
    ...
    v8 = (__int64 *)(a1 + 8);
    v9 = *(__int64 **)(a1 + 8);
    if ( v9[1] != a1 + 8 || (v10 = *(__int64 ***)(a1 + 16), *v10 != v8) )
      __fastfail(3u);
    *v10 = v9;
    v9[1] = (__int64)v10;
    v11 = 16LL * *(unsigned int *)(a1 + 404) + v3 + 2008;
    v12 = *(__int64 ***)(v11 + 8);
    if ( *v12 != (__int64 *)v11 )
      __fastfail(3u);
    *(_QWORD *)(a1 + 16) = v12;
