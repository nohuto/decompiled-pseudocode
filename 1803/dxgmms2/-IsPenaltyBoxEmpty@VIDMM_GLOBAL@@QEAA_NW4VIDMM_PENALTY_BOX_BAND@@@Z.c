/*
 * XREFs of ?IsPenaltyBoxEmpty@VIDMM_GLOBAL@@QEAA_NW4VIDMM_PENALTY_BOX_BAND@@@Z @ 0x1C00051D0
 * Callers:
...
__int64 __fastcall VIDMM_GLOBAL::IsPenaltyBoxEmpty(__int64 a1)
{
  ...
  v1 = a1;
  DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED((DXGAUTOPUSHLOCKSHARED *)v3, (struct DXGPUSHLOCK *const)(a1 + 41816));
