/*
 * XREFs of ?InitDmaPools@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C007D4AC
 * Callers:
 ...
 *     ??0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z @ 0x1C007B02C (--0VIDMM_DMA_POOL@@QEAA@PEAVVIDMM_GLOBAL@@KPEAVVIDMM_DEVICE@@PEAVDXGCONTEXT@@KKKKKH@Z.c)
...
__int64 __fastcall VIDMM_GLOBAL::InitDmaPools(VIDMM_GLOBAL *this)
{
  ...
  v1 = (struct VIDMM_DEVICE *)*((_QWORD *)this + 5113);
  v2 = 0LL;
  if ( *((_DWORD *)this + 1748) )
  {
    while ( 1 )
    {
      ...
      *((_QWORD *)this + v2 + 79) = v5;
      ...
      if ( v7 < 0 )
      {
        _InterlockedAdd(&dword_1C0047600, 1u);
    ...
    _InterlockedAdd(&dword_1C00475FC, 1u);
    v13 = WdLogNewEntry5_WdLowResource(v6);
    *(_QWORD *)(v13 + 24) = 1829LL;
...
LABEL_11:
    for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 1748); i = (unsigned int)(i + 1) )
    {
      ...
      if ( v15 )
        VIDMM_DMA_POOL::`scalar deleting destructor'(v15);
