/*
 * XREFs of ?RecordVaPagingHistoryMakeResident@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PAGING_QUEUE@@PEAUVIDMM_ALLOC@@E_K@Z @ 0x1C00AC030
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    ...
    if ( v9 )
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = 11;
