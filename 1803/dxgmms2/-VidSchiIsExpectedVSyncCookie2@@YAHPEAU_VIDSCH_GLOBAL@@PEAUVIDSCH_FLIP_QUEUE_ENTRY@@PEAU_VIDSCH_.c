/*
 * XREFs of ?VidSchiIsExpectedVSyncCookie2@@YAHPEAU_VIDSCH_GLOBAL@@PEAUVIDSCH_FLIP_QUEUE_ENTRY@@PEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x1C00278AC
 * Callers:
        ...
        struct _VIDSCH_VSYNC_COOKIE *a3)
{
  ...
  while ( 1 )
  {
    v9 = *(_QWORD *)((char *)v3 + ((8 * v3[2] + 175) & 0xFFFFFFF8) * v8 + 24);
    if ( v9 )
    {
