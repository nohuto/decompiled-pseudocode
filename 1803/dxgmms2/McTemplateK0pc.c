/*
 * XREFs of McTemplateK0pc @ 0x1C0023F64
 * Callers:
...
NTSTATUS McTemplateK0pc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v10 = 0;
  v9 = 1;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventOfferAllocation, a3, 3u, &v4);
}
