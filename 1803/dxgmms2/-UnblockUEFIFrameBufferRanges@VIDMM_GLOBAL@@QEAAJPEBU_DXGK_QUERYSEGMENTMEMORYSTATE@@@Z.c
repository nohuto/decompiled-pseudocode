/*
 * XREFs of ?UnblockUEFIFrameBufferRanges@VIDMM_GLOBAL@@QEAAJPEBU_DXGK_QUERYSEGMENTMEMORYSTATE@@@Z @ 0x1C00A3F08
 * Callers:
 *     VidMmUnblockUEFIFrameBufferRanges @ 0x1C00235F0 (VidMmUnblockUEFIFrameBufferRanges.c)
 * Callees:
        ...
        const struct _DXGK_QUERYSEGMENTMEMORYSTATE *a2)
{
  ...
  {
    v7 = 1560LL * a2->PhysicalAdapterIndex;
    v8 = *(_DWORD *)(v7 + *((_QWORD *)this + 5090) + 20) + (unsigned int)a2->DriverSegmentId;
