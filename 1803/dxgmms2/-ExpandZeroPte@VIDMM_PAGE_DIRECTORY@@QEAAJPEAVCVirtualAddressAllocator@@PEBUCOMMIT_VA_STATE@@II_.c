/*
 * XREFs of ?ExpandZeroPte@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@PEBUCOMMIT_VA_STATE@@II_K222PEAPEAUVIDMM_ALLOC@@@Z @ 0x1C00AAF98
 * Callers:
        ...
        struct VIDMM_ALLOC **a10)
{
  ...
  __int64 v26; // r10
  int v27; // eax
  struct VIDMM_ALLOC *v28; // [rsp+20h] [rbp-A1h]
  struct VIDMM_ALLOC *v29; // [rsp+20h] [rbp-A1h]
  unsigned __int64 v30; // [rsp+28h] [rbp-99h]
  unsigned __int64 v31; // [rsp+28h] [rbp-99h]
