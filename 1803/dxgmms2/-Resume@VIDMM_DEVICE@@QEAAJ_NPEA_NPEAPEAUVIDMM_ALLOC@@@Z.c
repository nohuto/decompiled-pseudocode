/*
 * XREFs of ?Resume@VIDMM_DEVICE@@QEAAJ_NPEA_NPEAPEAUVIDMM_ALLOC@@@Z @ 0x1C0076290
 * Callers:
...
__int64 __fastcall VIDMM_DEVICE::Resume(VIDMM_DEVICE *this, bool a2, bool *a3, struct VIDMM_ALLOC **a4)
{
  ...
  *((_BYTE *)this + 50) |= 2u;
  v8 = 0;
  v9 = *((_QWORD *)this + 4);
  if ( v9 && (*(_BYTE *)(v9 + 188) || _InterlockedCompareExchange((volatile signed __int32 *)(v9 + 184), 0, 0))
