/*
 * XREFs of McTemplateK0qtpiixi @ 0x1C002A4FC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qtpiixi(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v23 = 8LL;
  v25 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventSelectingContextWithNegativeQuantum, a3, 8u, &v11);
}
