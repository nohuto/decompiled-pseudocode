/*
 * XREFs of McTemplateK0ppqqxqq @ 0x1C00253B0
 * Callers:
...
NTSTATUS McTemplateK0ppqqxqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v18 = 4LL;
  v20 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventProcessPolicyChange, a3, 8u, &v6);
}
