/*
 * XREFs of McTemplateK0pppqxqqqqqqqpppqqqqqqqqqqtpht @ 0x1C001625C
 * Callers:
 ...
 *     ?VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z @ 0x1C00AA270 (-VidMmReportGlobalAlloc@@YAXPEAVDXGDEVICE@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAVDXGSHAREDRESOURCE@@@Z.c)
...
__int64 __fastcall McTemplateK0pppqxqqqqqqqpppqqqqqqqqqqtpht(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        char a32)
{
  ...
  v93 = 4LL;
  v92 = &a32;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 30LL, v35);
}
