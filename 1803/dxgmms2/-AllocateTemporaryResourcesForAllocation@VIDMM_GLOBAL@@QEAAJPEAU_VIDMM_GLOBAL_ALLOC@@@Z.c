/*
 * XREFs of ?AllocateTemporaryResourcesForAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0079B70
 * Callers:
        ...
        struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  {
    v5 = VIDMM_GLOBAL::AcquireGPUResourcesFromSegmentSet((__int64)this, (__int64)a2, 0, 1);
    if ( v5 >= 0 )
      goto LABEL_5;
    if ( g_IsInternalReleaseOrDbg )
