/*
 * XREFs of McTemplateK0qqix @ 0x1C002A3BC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qqix(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7)
{
  ...
  v16 = 8LL;
  v15 = &a7;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventPeriodicFrameNotificationDpc, a3, 5u, &v8);
}
