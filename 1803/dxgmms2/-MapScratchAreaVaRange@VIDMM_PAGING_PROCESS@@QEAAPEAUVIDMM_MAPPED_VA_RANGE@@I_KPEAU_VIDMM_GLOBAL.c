/*
 * XREFs of ?MapScratchAreaVaRange@VIDMM_PAGING_PROCESS@@QEAAPEAUVIDMM_MAPPED_VA_RANGE@@I_KPEAU_VIDMM_GLOBAL_ALLOC@@0I0PEAU_MDL@@PEAE0@Z @ 0x1C0058200
 * Callers:
        ...
        unsigned __int64 a10)
{
  ...
  __int64 v17; // rdx
  __int64 v18; // r8
  CVirtualAddressAllocator *v19; // r14
  __int64 v20; // rax
  __int64 v21; // rdx
  __int64 v22; // rcx
  __int64 v23; // rbx
  ...
  if ( a6
    && (v14 = (_QWORD *)*((_QWORD *)this + 2),
        *(_DWORD *)(*(_QWORD *)(v14[464] + 8LL * (a6 + *(_DWORD *)(1560LL * a2 + v14[5090] + 20) - 1)) + 376LL) == 0x10000)
    && !(_WORD)a3
    && (v15 = *((_DWORD *)a4 + 8)) != 0
    && !(_WORD)v15 )
  {
  ...
  *(_BYTE *)a9 = v16;
  ...
  v19 = (CVirtualAddressAllocator *)*((_QWORD *)this + v11 + 4);
  v20 = CVirtualAddressAllocator::MapVirtualAddressRange(v19, a4, a5, 3LL, a3, 0LL, v17, v18, v15, 1LL, a10, v11, 0LL);
  v23 = v20;
  if ( v20 )
  {
    ...
    *(_QWORD *)(v20 + 40) = 0LL;
    if ( (int)CVirtualAddressAllocator::CommitVirtualAddressRange(
                ...
                &a9) < 0 )
    {
      v29 = (_QWORD *)WdLogNewEntry5_WdCriticalError(v25, v24, v26);
      v29[3] = 270LL;
      v29[4] = 48LL;
      v29[5] = this;
      v29[6] = 0LL;
  ...
  {
    v28 = WdLogNewEntry5_WdEvent(v22, v21);
