/*
 * XREFs of McTemplateK0ppqqpqq @ 0x1C00166C0
 * Callers:
...
__int64 McTemplateK0ppqqpqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, a2, a3, 8LL, v4);
}
