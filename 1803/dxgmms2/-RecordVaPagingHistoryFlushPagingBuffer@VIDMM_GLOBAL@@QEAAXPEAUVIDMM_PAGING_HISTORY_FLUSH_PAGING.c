/*
 * XREFs of ?RecordVaPagingHistoryFlushPagingBuffer@VIDMM_GLOBAL@@QEAAXPEAUVIDMM_PAGING_HISTORY_FLUSH_PAGING_BUFFER@@K@Z @ 0x1C00ABD6C
 * Callers:
        ...
        int a3)
{
  ...
  if ( *((_QWORD *)this + 5187) )
  {
    v6 = operator new[](0x50uLL, 0x32356956u, PagedPool);
    if ( v6 )
    {
      KeEnterCriticalRegion();
      ExAcquirePushLockExclusiveEx((char *)this + 41512, 0LL);
      *((_QWORD *)this + 5190) = KeGetCurrentThread();
      v7 = *((_DWORD *)this + 10376);
      if ( v7 == dword_1C004733C )
      {
        *((_DWORD *)this + 10376) = 0;
        v7 = 0;
      }
      v8 = *(void **)(*((_QWORD *)this + 5187) + 24LL * v7 + 16);
      if ( v8 )
        operator delete(v8);
      v9 = *((_OWORD *)a2 + 1);
      *v6 = *(_OWORD *)a2;
      ...
      *(_DWORD *)(*((_QWORD *)this + 5187) + 24LL * (unsigned int)(*((_DWORD *)this + 10376))++ + 8) = 8;
