/*
 * XREFs of ?DestroyContextAllocation@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CONTEXT_ALLOC@@@Z @ 0x1C006A3E4
 * Callers:
 *     VidMmDestroyContextAllocation @ 0x1C0003FE0 (VidMmDestroyContextAllocation.c)
 * Callees:
