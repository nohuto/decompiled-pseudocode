/*
 * XREFs of McTemplateK0ppqPR2TR2 @ 0x1C00242D0
 * Callers:
...
NTSTATUS McTemplateK0ppqPR2TR2(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v15 = 4 * v21;
  v10 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventReferenceAllocations, a3, 6u, &v4);
}
