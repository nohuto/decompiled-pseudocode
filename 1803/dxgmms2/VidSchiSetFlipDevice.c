/*
 * XREFs of VidSchiSetFlipDevice @ 0x1C0005D0C
 * Callers:
 ...
 *     ?InitializeFlipQueueEntry@VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z @ 0x1C0014488 (-InitializeFlipQueueEntry@VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z.c)
        ...
        char a7)
{
  ...
  v8 = 0;
  v9 = a4;
  Resource = (struct _ERESOURCE *)((char *)a1 + 1160);
  v12 = *((_QWORD *)a1 + a2 + 379);
  ExAcquireResourceExclusiveLite((PERESOURCE)((char *)a1 + 1160), 1u);
  ...
  if ( (_DWORD)v9 )
  {
    ...
    if ( v19 )
    {
      if ( v19 != a3 || *(_DWORD *)(v12 + 4) != (_DWORD)v9 )
      {
        ...
        JUMPOUT(0x1C001A853LL);
      }
    }
    else
    {
      if ( ((int)v9 >= 4 || *((_BYTE *)a1 + 136))
      ...
      else
      {
        ...
        if ( *((_DWORD *)a1 + 33) )
        {
          while ( 1 )
          {
            v30 = operator new[](0x14038uLL, 0x68536956u, (POOL_TYPE)512);
            v31 = v30;
            if ( v30 )
              memset(v30, 0, 0x14038uLL);
            else
              v31 = 0LL;
            *(_QWORD *)(v12 + 8 * v29 + 24) = v31;
            if ( !v31 )
              break;
            memset(v31, 0, 0x14038uLL);
            v32 = 0LL;
            while ( (int)VIDSCH_FLIP_QUEUE_ENTRY::InitializeFlipQueueEntry(
                           (VIDSCH_FLIP_QUEUE_ENTRY *)(*(_QWORD *)(v12 + 8 * v29 + 24) + 56LL + 1280 * v32),
                           a1) >= 0 )
            {
...
LABEL_32:
            ...
            *(_DWORD *)(v33 + 52) = 63;
            if ( (unsigned int)v29 >= *((_DWORD *)a1 + 33) )
              goto LABEL_34;
          }
          v8 = -1073741801;
        }
LABEL_34:
        ...
        {
LABEL_56:
          for ( i = 0LL; (unsigned int)i < *((_DWORD *)a1 + 33); i = (unsigned int)(i + 1) )
          {
            v42 = *(void **)(v12 + 8 * i + 24);
            if ( v42 )
            {
        ...
        v34 = (_QWORD *)(a3 + 104);
        v35 = *(_QWORD *)(a3 + 104);
        if ( *(_QWORD *)(v35 + 8) != a3 + 104 || (v36 = *(_QWORD **)(a3 + 112), (_QWORD *)*v36 != v34) )
          __fastfail(3u);
        *v36 = v35;
        v37 = (char *)a1 + 272;
        *(_QWORD *)(v35 + 8) = v36;
  ...
  else if ( !a3 || a3 == *(_QWORD *)(v12 + 16) )
  {
    ...
    v22 = *(_DWORD *)(v12 + 4);
    v23 = *(_QWORD *)(v12 + 16);
    VidSchiUnreferenceDisplayingAllocations(v21, (struct _VIDSCH_PRESENT_INFO *)v12, *(_WORD *)(v12 + 28000));
    for ( j = 0LL; (unsigned int)j < *((_DWORD *)a1 + 33); j = (unsigned int)(j + 1) )
    {
      v26 = *(void **)(v12 + 8 * j + 24);
      if ( v26 )
      {
