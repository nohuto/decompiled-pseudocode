/*
 * XREFs of ?ProcessFrozenProcesses@VIDMM_WORKER_THREAD@@AEAAXPEAVVIDMM_DEVICE@@PEA_N@Z @ 0x1C00A8250
 * Callers:
        ...
        bool *a3)
{
  ...
  *a3 = 0;
  DXGAUTOPUSHLOCKSHARED::DXGAUTOPUSHLOCKSHARED(
    ...
    (struct DXGPUSHLOCK *const)(*(_QWORD *)this + 41544LL));
  v6 = (_QWORD **)(*(_QWORD *)this + 41584LL);
  v7 = *v6;
  while ( v7 != v6 )
  {
    ...
    if ( *((_QWORD **)a2 + 2) != v7 - 3 )
    {
      ...
      if ( v9 )
      {
        if ( *(_BYTE *)(v9 + 432) && VIDMM_PROCESS_ADAPTER_INFO::SuspendAllDevices(v8, 1) )
          *a3 = 1;
      }
    }
    v7 = (_QWORD *)*v7;
