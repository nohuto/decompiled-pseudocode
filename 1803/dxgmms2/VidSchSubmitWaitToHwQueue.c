/*
 * XREFs of VidSchSubmitWaitToHwQueue @ 0x1C0032FB0
 * Callers:
 *     <none>
 * Callees:
 *     ?VidSchiAcquireSyncObjectForHwQueue@@YAJPEAU_VIDSCH_SYNC_OBJECT@@PEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C002F920 (-VidSchiAcquireSyncObjectForHwQueue@@YAJPEAU_VIDSCH_SYNC_OBJECT@@PEAU_VIDSCH_QUEUE_PACKET@@@Z.c)
...
__int64 __fastcall VidSchSubmitWaitToHwQueue(struct VIDSCH_HW_QUEUE *a1, struct _VIDSCH_SYNC_OBJECT *a2, __int64 a3)
{
  ...
  v6 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 3) + 16LL) + 24LL);
