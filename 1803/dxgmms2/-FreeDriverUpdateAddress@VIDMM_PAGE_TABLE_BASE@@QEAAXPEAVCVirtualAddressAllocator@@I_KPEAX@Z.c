/*
 * XREFs of ?FreeDriverUpdateAddress@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@I_KPEAX@Z @ 0x1C005BF68
 * Callers:
        ...
        struct _MDL *a5)
{
  ...
  v5 = *((_QWORD *)a2 + 10);
  if ( (*(_BYTE *)(v5 + 41448) & 0x10) != 0 || (v6 = (int)(*(_DWORD *)this << 16) >> 29) == 0 )
  {
                                                ...
                                                + 40928) != a2 )
  {
    ...
    *(_QWORD *)(v9 + 8) = v7;
    ...
    v10 = 1560LL * ((*(_DWORD *)this >> 7) & 0x1F) + *(_QWORD *)(v5 + 40720) + 464LL;
    v11 = *(__int64 ***)(v10 + 8);
    if ( *v11 != (__int64 *)v10 )
      __fastfail(3u);
    *v8 = v10;
