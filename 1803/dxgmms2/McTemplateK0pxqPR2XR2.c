/*
 * XREFs of McTemplateK0pxqPR2XR2 @ 0x1C002DF58
 * Callers:
...
NTSTATUS McTemplateK0pxqPR2XR2(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v8 = 8LL;
  v10 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventCreateSyncPoint, a3, 6u, &v4);
}
