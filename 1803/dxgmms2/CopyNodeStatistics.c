/*
 * XREFs of CopyNodeStatistics @ 0x1C00BCCCC
 * Callers:
 *     VidSchQueryNodeStatistics @ 0x1C00BD4E0 (VidSchQueryNodeStatistics.c)
 *     VidSchQueryProcessNodeStatistics @ 0x1C00BD590 (VidSchQueryProcessNodeStatistics.c)
 * Callees:
 *     <none>
 */
