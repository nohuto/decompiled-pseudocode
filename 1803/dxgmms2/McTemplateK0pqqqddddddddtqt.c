/*
 * XREFs of McTemplateK0pqqqddddddddtqt @ 0x1C00296F4
 * Callers:
...
NTSTATUS McTemplateK0pqqqddddddddtqt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v32 = 4LL;
  v34 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &MMIOFlipMultiPlaneOverlay3, a3, 0x10u, &v4);
}
