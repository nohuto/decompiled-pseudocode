/*
 * XREFs of ?TlgAggregateInternalRegisteredProviderEtwCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0056AB0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C0017A50 (_guard_dispatch_icall_nop.c)
 *     LookUpTableFlushComplete @ 0x1C0085CF4 (LookUpTableFlushComplete.c)
 *     LookUpTableFlushPartial @ 0x1C00BFF14 (LookUpTableFlushPartial.c)
 */
