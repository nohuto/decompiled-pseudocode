/*
 * XREFs of ?UpdateActiveVPRAfterMove@VIDMM_SEGMENT@@QEAAJXZ @ 0x1C00B4F2C
 * Callers:
...
__int64 __fastcall VIDMM_SEGMENT::UpdateActiveVPRAfterMove(VIDMM_SEGMENT *this)
{
                       ...
                       (__int64)v19) == -1073741823 )
  {
    ...
    if ( v6 > v5 )
    {
      ...
      *((_QWORD *)this + 52) = v6;
      if ( (unsigned int)DXG_DEFERRED_WORK_QUEUE::GetNumWorkItems((DXG_DEFERRED_WORK_QUEUE *)(v8 + 41600)) )
      {
