/*
 * XREFs of ?LogProcessInformation@VIDMM_COMMIT_TELEMETRY@@AEAAXPEAUVIDMM_PROCESS_ADAPTER_INFO@@PEAU_GUID@@@Z @ 0x1C00B774C
 * Callers:
    ...
    if ( a2 )
    {
      ...
      if ( *(_DWORD *)(v6 + 6992) )
      {
        ...
        do
        {
          ...
          {
            if ( (qword_1C0047060 & 0x400000000008LL) == 0 || (v11 = 1, (v8 & 0x400000000008LL) != v8) )
              v11 = 0;
            v9 = v6;
            if ( v11 )
            {
              v12 = *(unsigned __int16 **)(*(_QWORD *)(v6 + 24) + 1344LL);
              v27 = v30;
              v28 = 2LL;
              v13 = *v12;
              v29 = *((_QWORD *)v12 + 1);
              ...
              v52 = 8LL;
              v54 = 8LL;
              TlgWrite((TraceLoggingHProvider)&hProvider, &unk_1C003AA20, a3, v22, 0x11u, &pData);
              v9 = *(_QWORD *)this;
              v8 = qword_1C0047068;
            }
          }
