/*
 * XREFs of ?EndCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKPEAU_VIDMM_REGION@@@Z @ 0x1C0068B78
 * Callers:
 *     VidMmEndCPUAccess @ 0x1C0003EC0 (VidMmEndCPUAccess.c)
 * Callees:
