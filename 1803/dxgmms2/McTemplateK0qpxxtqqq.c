/*
 * XREFs of McTemplateK0qpxxtqqq @ 0x1C00265BC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qpxxtqqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a10)
{
  ...
  v29 = 4LL;
  v31 = 4LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventStartReserveResource, 0LL, 9u, &v15);
}
