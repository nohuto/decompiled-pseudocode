/*
 * XREFs of ?ResizeMultirangeToExcludeOverlap@VIDMM_RECYCLE_HEAP@@AEAAXPEAVVIDMM_RECYCLE_MULTIRANGE@@0@Z @ 0x1C0070E04
 * Callers:
  ...
  if ( v3 > v7 )
  {
    ...
    Multirange = VIDMM_RECYCLE_HEAP_MGR::CreateMultirange(
                   ...
                   *((_QWORD *)a2 + 10),
                   v5,
                   v14);
    v21 = (struct VIDMM_RECYCLE_MULTIRANGE *)Multirange;
    if ( Multirange )
    {
      Multirange[4].Next = (struct _SLIST_ENTRY *)v17;
      *((_QWORD *)&Multirange[4].Next + 1) = v16;
      VIDMM_RECYCLE_MULTIRANGE::MarkAllRangesWithNewOwner((VIDMM_RECYCLE_MULTIRANGE *)Multirange, v19, v20);
      v13 = v21;
      goto LABEL_5;
    }
    while ( 1 )
    {
      ...
      VIDMM_RECYCLE_HEAP::AddRangeToTree(this, v27, v17);
LABEL_28:
      if ( v17 == v16 )
        return;
