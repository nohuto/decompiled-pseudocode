/*
 * XREFs of ?FillAllocationInternal@VIDMM_GLOBAL@@IEAAXKPEAU_VIDMM_GLOBAL_ALLOC@@_KIPEAVVIDMM_SEGMENT@@PEAT_LARGE_INTEGER@@@Z @ 0x1C0061E6C
 * Callers:
        ...
        union _LARGE_INTEGER *a7)
{
  ...
  v8 = a2;
  if ( (*((_BYTE *)this[5090] + 1560 * a2 + 436) & 4) != 0 )
  {
  ...
  else
  {
    ...
    VIDMM_GLOBAL::SetupForBuildPagingBuffer((VIDMM_GLOBAL *)this, v8, (struct _VIDMM_GLOBAL_ALLOC *)a3, &v26);
    do
    {
      ...
      if ( bTracingEnabled )
      {
        ...
        {
          LODWORD(v25) = 0;
          McTemplateK0pppxxq(v23, v22, v24, CurrentProcessId, a3, v20, 0LL, a4, v25);
        }
      }
      VidMmRecordTransfer((struct _VIDMM_GLOBAL_STATISTICS *)(this + 963), a4, 0);
