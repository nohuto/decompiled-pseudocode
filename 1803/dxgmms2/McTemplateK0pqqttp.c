/*
 * XREFs of McTemplateK0pqqttp @ 0x1C002992C
 * Callers:
...
NTSTATUS McTemplateK0pqqttp(_DWORD a1, _DWORD a2, _DWORD a3, __int64 a4, char a5, char a6, ...)
{
  ...
  v18 = 4LL;
  v20 = 8LL;
  return McGenEventWriteKM(&DxgkControlGuid_Context, &EventQueueComplete, 0LL, 7u, &v8);
}
