/*
 * XREFs of ?TerminateAllocation@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_MULTI_ALLOC@@IU_D3DDDICB_DESTROYALLOCATION2FLAGS@@PEAVDXGTERMINATIONTRACKER@@@Z @ 0x1C006871C
 * Callers:
 *     VidMmTerminateAllocation @ 0x1C0003420 (VidMmTerminateAllocation.c)
 * Callees:
