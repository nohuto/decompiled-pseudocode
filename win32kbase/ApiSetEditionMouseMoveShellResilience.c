/*
 * XREFs of ApiSetEditionMouseMoveShellResilience @ 0x1C007D5B8
 * Callers:
...
__int64 (*__fastcall ApiSetEditionMouseMoveShellResilience(__int64 a1))(void)
{
  ...
  result = qword_1C02D7708;
  if ( qword_1C02D7708 )
  {
    result = (__int64 (*)(void))qword_1C02D7708();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D7710;
      if ( qword_1C02D7710 )
        result = (__int64 (*)(void))qword_1C02D7710(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
