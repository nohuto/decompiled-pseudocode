/*
 * XREFs of ApiSetSend4FingerTapHotkey @ 0x1C0246610
 * Callers:
...
__int64 (*ApiSetSend4FingerTapHotkey())(void)
{
  char v0; // bl
  char v1; // dl
  char v2; // r8
  ...
  result = qword_1C02D7E78;
  if ( qword_1C02D7E78 )
  {
    result = (__int64 (*)(void))qword_1C02D7E78();
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7E80;
      if ( qword_1C02D7E80 )
        result = (__int64 (*)(void))qword_1C02D7E80();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
