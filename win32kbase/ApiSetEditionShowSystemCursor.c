/*
 * XREFs of ApiSetEditionShowSystemCursor @ 0x1C00B35E8
 * Callers:
...
__int64 ApiSetEditionShowSystemCursor()
{
  char v0; // bl
  char v1; // dl
  char v2; // r8
  ...
  v3 = 0;
  if ( qword_1C02D7C18 && (int)qword_1C02D7C18() >= 0 && qword_1C02D7C20 )
    v3 = qword_1C02D7C20(1LL);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
