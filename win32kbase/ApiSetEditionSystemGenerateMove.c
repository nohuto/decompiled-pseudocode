/*
 * XREFs of ApiSetEditionSystemGenerateMove @ 0x1C00C6EC4
 * Callers:
...
__int64 (*__fastcall ApiSetEditionSystemGenerateMove(unsigned int a1))(void)
{
  ...
  result = qword_1C02D7E38;
  if ( qword_1C02D7E38 )
  {
    result = (__int64 (*)(void))qword_1C02D7E38();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D7E40;
      if ( qword_1C02D7E40 )
        result = (__int64 (*)(void))qword_1C02D7E40(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
