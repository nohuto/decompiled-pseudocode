/*
 * XREFs of NtUserStopAndEndInertia @ 0x1C0178420
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserStopAndEndInertia(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  int v4; // ebx
  PVOID Reserved; // rdx
  ...
  if ( CurrentProcess && CurrentProcess == *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels )
  {
    ...
    v4 = CTouchProcessor::StopAndEndInertia(*(CTouchProcessor **)(v28 + 3424), a2, v29);
  }
  else
  {
    UserSetLastError(5);
