/*
 * XREFs of McTemplateK0ppqt_EtwWriteTransfer @ 0x1C0165C84
 * Callers:
 *     EtwTraceDwmVisRgnUpdate @ 0x1C00BA9D0 (EtwTraceDwmVisRgnUpdate.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x1C0038218 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x1C00DA480 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0ppqt_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite_EtwWriteTransfer(a1, &DwmVisRgnUpdate, &W32kControlGuid, 5u, &v4);
}
