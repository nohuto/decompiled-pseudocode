/*
 * XREFs of ?EmitCreationCommand@?$CSharedResourceMarshaler@VCVisualSurfaceMarshaler@DirectComposition@@$01@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00D4960
 * Callers:
 *     <none>
 * Callees:
