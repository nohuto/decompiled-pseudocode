/*
 * XREFs of ApiSetEditionSetForegroundCheckNoActivate @ 0x1C0242C30
 * Callers:
...
__int64 __fastcall ApiSetEditionSetForegroundCheckNoActivate(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v7 = 1;
  if ( qword_1C02D7678 && (int)qword_1C02D7678(v4, a2, a3, v6) >= 0 )
  {
    if ( qword_1C02D7680 )
      v7 = qword_1C02D7680(a1);
    else
      v7 = 0;
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
