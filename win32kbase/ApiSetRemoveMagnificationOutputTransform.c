/*
 * XREFs of ApiSetRemoveMagnificationOutputTransform @ 0x1C007E7E8
 * Callers:
...
__int64 (*__fastcall ApiSetRemoveMagnificationOutputTransform(__int64 a1))(void)
{
  ...
  result = qword_1C02D77A8;
  if ( qword_1C02D77A8 )
  {
    result = (__int64 (*)(void))qword_1C02D77A8();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D77B0;
      if ( qword_1C02D77B0 )
        result = (__int64 (*)(void))qword_1C02D77B0(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
