/*
 * XREFs of ApiSetEditionUpdateInputTransformFromHitTest @ 0x1C0008F00
 * Callers:
...
PDEVICE_OBJECT *__fastcall ApiSetEditionUpdateInputTransformFromHitTest(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        unsigned int a4,
        ...
        __int64 a6)
{
  ...
  if ( qword_1C02D77B8 && (int)qword_1C02D77B8(v10, a2, a3, v12) >= 0 && qword_1C02D77C0 )
    qword_1C02D77C0(a1, v8, v7, a4, a5, a6);
