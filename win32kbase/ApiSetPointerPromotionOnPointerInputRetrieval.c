/*
 * XREFs of ApiSetPointerPromotionOnPointerInputRetrieval @ 0x1C0245B00
 * Callers:
...
PDEVICE_OBJECT *__fastcall ApiSetPointerPromotionOnPointerInputRetrieval(
        unsigned __int16 a1,
        __int64 a2,
        __int64 a3,
        unsigned int a4)
{
  ...
  if ( qword_1C02D7B08 && (int)qword_1C02D7B08(v8, a2, a3, v10) >= 0 && qword_1C02D7B10 )
    qword_1C02D7B10(a1, v6, v5, a4);
