/*
 * XREFs of ApiSetEditionDevicePnpNotification @ 0x1C002F690
 * Callers:
...
__int64 (*__fastcall ApiSetEditionDevicePnpNotification(__int64 a1))(void)
{
  char v2; // bl
  char v3; // dl
  char v4; // r8
  ...
  result = qword_1C02D7788;
  if ( qword_1C02D7788 )
  {
    result = (__int64 (*)(void))qword_1C02D7788();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D7790;
      if ( qword_1C02D7790 )
        result = (__int64 (*)(void))qword_1C02D7790(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
