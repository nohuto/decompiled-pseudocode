/*
 * XREFs of ?EmitSetOpacityAnimationCommand@CLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0257DBC
 * Callers:
...
char __fastcall DirectComposition::CLegacyMilBrushMarshaler::EmitSetOpacityAnimationCommand(
