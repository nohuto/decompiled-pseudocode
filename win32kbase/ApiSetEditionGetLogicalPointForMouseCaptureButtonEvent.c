/*
 * XREFs of ApiSetEditionGetLogicalPointForMouseCaptureButtonEvent @ 0x1C023E7B4
 * Callers:
        ...
        _QWORD *a5)
{
  ...
  v12 = a5;
  *a5 = v6;
  if ( qword_1C02D7DB8 && (int)qword_1C02D7DB8(v9, a2, a3, v11) >= 0 )
  {
    AtomicExecutionCheck::AtomicExecutionCheck((AtomicExecutionCheck *)&a5, a2, v13, v14);
    v18 = 0LL;
    v21 = 0LL;
    if ( qword_1C02D7DC0 )
    {
      qword_1C02D7DC0(a1, v7, v6, a4, &v21);
      v18 = v21;
    }
    *v12 = v18;
    AtomicExecutionCheck::Disarm((AtomicExecutionCheck *)&a5, v15, v16, v17);
  }
