/*
 * XREFs of McTemplateK0ppqxxxqqq_EtwWriteTransfer @ 0x1C00EE5C0
 * Callers:
 *     EtwTraceTokenCompositionSurfaceObjectEvent @ 0x1C000B270 (EtwTraceTokenCompositionSurfaceObjectEvent.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x1C0038218 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x1C00DA480 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0ppqxxxqqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &TokenCompositionSurfaceObjectEvent, &W32kControlGuid, 0xAu, &v4);
}
