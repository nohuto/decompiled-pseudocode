/*
 * XREFs of NtUserRegisterManipulationThread @ 0x1C00D1240
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserRegisterManipulationThread(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v9 )
  {
    ...
    {
      v14 = PsGetCurrentThreadWin32Thread(v11, v10, v12, v13, v33);
      if ( v14 )
      {
  ...
  if ( CurrentProcess && CurrentProcess == *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfChannels )
  {
    ...
    v30 = PsGetCurrentThreadWin32Thread(v23, v22, v24, v25, v33);
    if ( v30 )
      *(_DWORD *)(v30 + 44) |= 2u;
  }
  else
