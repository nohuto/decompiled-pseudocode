/*
 * XREFs of ??1?$CTypeIsolation@$0IAAA@$0IA@@NSInstrumentation@@IEAA@XZ @ 0x1C00A0A10
 * Callers:
...
void __fastcall NSInstrumentation::CTypeIsolation<32768,128>::~CTypeIsolation<32768,128>(__int64 a1)
{
