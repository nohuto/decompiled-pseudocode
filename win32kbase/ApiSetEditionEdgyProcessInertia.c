/*
 * XREFs of ApiSetEditionEdgyProcessInertia @ 0x1C023D6EC
 * Callers:
...
__int64 (*__fastcall ApiSetEditionEdgyProcessInertia(__int64 a1))(void)
{
  ...
  result = qword_1C02D7CA8;
  if ( qword_1C02D7CA8 )
  {
    result = (__int64 (*)(void))qword_1C02D7CA8();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D7CB0;
      if ( qword_1C02D7CB0 )
        result = (__int64 (*)(void))qword_1C02D7CB0(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
