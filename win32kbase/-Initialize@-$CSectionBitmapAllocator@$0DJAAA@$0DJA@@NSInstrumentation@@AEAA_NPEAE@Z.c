/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0DJAAA@$0DJA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C00CEE20
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<233472,912>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = Pool2;
  if ( !Pool2 )
    return 0;
  *Pool2 = 0LL;
  v10 = _lambda_31498f3d16e1daf3a969a045e22f9fd8_::operator()(v9, 0xE4u);
  if ( !v10 )
    return 0;
