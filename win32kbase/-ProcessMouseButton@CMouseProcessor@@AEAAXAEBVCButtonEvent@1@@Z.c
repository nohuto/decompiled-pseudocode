/*
 * XREFs of ?ProcessMouseButton@CMouseProcessor@@AEAAXAEBVCButtonEvent@1@@Z @ 0x1C022F50C
 * Callers:
 ...
 *     IsPointerPromotedMouseMessage @ 0x1C0231C10 (IsPointerPromotedMouseMessage.c)
