/*
 * XREFs of ApiSetEditionDeactivateMitInput @ 0x1C0093CC4
 * Callers:
...
__int64 (*ApiSetEditionDeactivateMitInput())(void)
{
  char v0; // bl
  char v1; // dl
  char v2; // r8
  ...
  result = qword_1C02D7778;
  if ( qword_1C02D7778 )
  {
    result = (__int64 (*)(void))qword_1C02D7778();
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7780;
      if ( qword_1C02D7780 )
        result = (__int64 (*)(void))qword_1C02D7780();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
