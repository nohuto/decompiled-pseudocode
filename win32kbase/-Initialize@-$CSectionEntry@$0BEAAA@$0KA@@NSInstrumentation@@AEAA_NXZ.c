/*
 * XREFs of ?Initialize@?$CSectionEntry@$0BEAAA@$0KA@@NSInstrumentation@@AEAA_NXZ @ 0x1C002CCF8
 * Callers:
...
bool __fastcall NSInstrumentation::CSectionEntry<81920,160>::Initialize(__int64 a1)
{
  ...
  *(_QWORD *)(a1 + 16) = Section;
  if ( !Section || NSInstrumentation::PlatformMapViewInSessionSpace(Section, (PVOID *)(a1 + 24), (void **)0x14000) < 0 )
    return 0;
  v3 = NSInstrumentation::CSectionBitmapAllocator<81920,160>::Create(*(_QWORD *)(a1 + 24));
  *(_QWORD *)(a1 + 32) = v3;
  return v3 != 0;
}
