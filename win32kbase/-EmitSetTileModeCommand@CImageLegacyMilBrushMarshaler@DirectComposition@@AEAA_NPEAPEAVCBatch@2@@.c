/*
 * XREFs of ?EmitSetTileModeCommand@CImageLegacyMilBrushMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C025939C
 * Callers:
...
char __fastcall DirectComposition::CImageLegacyMilBrushMarshaler::EmitSetTileModeCommand(
