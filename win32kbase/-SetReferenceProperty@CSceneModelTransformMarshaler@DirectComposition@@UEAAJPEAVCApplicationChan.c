/*
 * XREFs of ?SetReferenceProperty@CSceneModelTransformMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C025D9B0
 * Callers:
 *     <none>
 * Callees:
