/*
 * XREFs of ?SetReferenceProperty@CAtlasedRectsGroupMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C025D1B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CAtlasedRectsGroupMarshaler::SetReferenceProperty(
