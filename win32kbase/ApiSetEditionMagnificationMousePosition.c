/*
 * XREFs of ApiSetEditionMagnificationMousePosition @ 0x1C02406E4
 * Callers:
...
__int64 (*__fastcall ApiSetEditionMagnificationMousePosition(__int64 a1))(void)
{
  ...
  result = qword_1C02D7D08;
  if ( qword_1C02D7D08 )
  {
    result = (__int64 (*)(void))qword_1C02D7D08();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D7D10;
      if ( qword_1C02D7D10 )
        result = (__int64 (*)(void))qword_1C02D7D10(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
