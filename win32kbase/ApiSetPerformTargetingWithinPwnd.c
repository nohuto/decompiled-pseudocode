/*
 * XREFs of ApiSetPerformTargetingWithinPwnd @ 0x1C0245698
 * Callers:
...
__int64 (__fastcall *__fastcall ApiSetPerformTargetingWithinPwnd(
        __int64 a1,
        __int64 a2,
        __int64 a3))(_QWORD, _QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C02D7B48;
  if ( qword_1C02D7B48 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C02D7B48(v6, a2, a3, v8);
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7B50;
      if ( qword_1C02D7B50 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C02D7B50(a1, v4, v3);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
