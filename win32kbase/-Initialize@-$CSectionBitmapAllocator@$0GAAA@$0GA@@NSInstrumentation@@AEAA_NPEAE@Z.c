/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0GAAA@$0GA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C00CED5C
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<24576,96>::Initialize(_QWORD *a1, __int64 a2)
{
