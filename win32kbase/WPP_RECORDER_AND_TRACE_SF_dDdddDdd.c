/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_dDdddDdd @ 0x1C01AB218
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_dDdddDdd(
        __int64 a1,
        char a2,
        char a3,
        _DWORD a4,
        ...
        ...)
{
  ...
  v8 = gRimLog;
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
               a1,
               43LL,
               &WPP_d0136f6132203aac44a878359d3f87a2_Traceguids,
               13LL,
               (__int64 *)va,
               4LL,
               (__int64 *)va1,
