/*
 * XREFs of ?Create@?$CSectionBitmapAllocator@$0HAAA@$0HA@@NSInstrumentation@@SAPEAV12@QEAE@Z @ 0x1C002CBA8
 * Callers:
...
__int64 __fastcall NSInstrumentation::CSectionBitmapAllocator<28672,112>::Create(__int64 a1)
{
  __int64 Pool2; // rax
  __int64 v3; // rbx
