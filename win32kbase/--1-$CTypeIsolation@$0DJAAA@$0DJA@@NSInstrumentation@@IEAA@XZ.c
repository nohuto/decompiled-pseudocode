/*
 * XREFs of ??1?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@IEAA@XZ @ 0x1C00A0998
 * Callers:
...
void __fastcall NSInstrumentation::CTypeIsolation<233472,912>::~CTypeIsolation<233472,912>(__int64 a1)
{
