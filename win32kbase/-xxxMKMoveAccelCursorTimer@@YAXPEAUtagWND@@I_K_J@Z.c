/*
 * XREFs of ?xxxMKMoveAccelCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01E5120
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    {
      v5 = (unsigned __int8)byte_1C02D14B2;
      giMouseMoveTable = 1;
    ...
    {
      a2 = byte_1C02D1431;
      v5 = byte_1C02D1431[giMouseMoveTable];
  ...
  v5 = 4 * (unsigned __int8)byte_1C02D14B2;
LABEL_10:
