/*
 * XREFs of NtUserSetMouseInputRateLimitingTimer @ 0x1C0177480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetMouseInputRateLimitingTimer(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rdi
...
LABEL_50:
  ...
  v25 = ApiSetEditionSetMouseInputRateLimitingTimer(v5);
