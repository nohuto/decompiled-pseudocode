/*
 * XREFs of ?Create@?$CSectionEntry@$0BEAAA@$0KA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00C8554
 * Callers:
...
_QWORD *NSInstrumentation::CSectionEntry<81920,160>::Create()
{
  ...
  if ( Pool2 )
  {
    ...
    Pool2[3] = 0LL;
    Pool2[4] = 0LL;
    if ( NSInstrumentation::CSectionEntry<81920,160>::Initialize((__int64)Pool2) )
      return v1;
