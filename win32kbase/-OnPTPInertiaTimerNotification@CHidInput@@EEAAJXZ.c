/*
 * XREFs of ?OnPTPInertiaTimerNotification@CHidInput@@EEAAJXZ @ 0x1C0211410
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTouchpadDevice@CHidInput@@AEBAHPEAUDEVICEINFO@@@Z @ 0x1C00F3940 (-IsTouchpadDevice@CHidInput@@AEBAHPEAUDEVICEINFO@@@Z.c)
...
__int64 __fastcall CHidInput::OnPTPInertiaTimerNotification(CHidInput *this)
{
  ...
  InputTraceLogging::ThreadLockedPerfRegion::ThreadLockedPerfRegion(&v34, "OnPTPInertiaTimerNotification", 0LL);
  ...
  {
    CurrentThreadWin32Thread = (LARGE_INTEGER *)PsGetCurrentThreadWin32Thread(v2, Reserved, v5, v3, v32);
...
LABEL_15:
  ...
  {
    v13 = PsGetCurrentThreadWin32Thread(v10, v9, v11, v12, v32);
    if ( v13 )
    {
      ...
      *(LARGE_INTEGER *)(v13 + 8) = PerformanceCounter;
      ...
      {
        LODWORD(v33) = 1000000 * v15 / gliQpcFreq.QuadPart;
                          ...
                          - (unsigned __int64)WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink) >= W32KEtwUserCritTelemetryThrottleQPC )
      {
        ...
        {
          LODWORD(v33) = 1000 * v15 / gliQpcFreq.QuadPart;
          McTemplateK0xqx_EtwWriteTransfer(
            gullUserCritAcquireToken,
...
LABEL_46:
  ...
  if ( v25 )
  {
    Processor = (struct tagPOINT *)CPTPProcessorFactory::GetProcessor(v26);
    if ( Processor )
      CPTPProcessor::HandleInertiaTimer(Processor, (__int64)v26, v28, v29);
  }
