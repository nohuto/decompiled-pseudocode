/*
 * XREFs of NtUserUnloadKeyboardLayout @ 0x1C0179DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserUnloadKeyboardLayout(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v25 = (struct tagKL *)HKLtoPKL((__int64)gptiCurrent, a1);
  if ( v25 )
    v4 = xxxInternalUnloadKeyboardLayout(ProcessWindowStation, v25, 0LL, v29);
