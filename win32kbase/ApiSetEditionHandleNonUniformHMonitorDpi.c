/*
 * XREFs of ApiSetEditionHandleNonUniformHMonitorDpi @ 0x1C023EEA0
 * Callers:
...
__int64 (*ApiSetEditionHandleNonUniformHMonitorDpi())(void)
{
  ...
  result = qword_1C02D7FB0;
  if ( qword_1C02D7FB0 )
  {
    result = (__int64 (*)(void))qword_1C02D7FB0();
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7FB8;
      if ( qword_1C02D7FB8 )
        result = (__int64 (*)(void))qword_1C02D7FB8();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
