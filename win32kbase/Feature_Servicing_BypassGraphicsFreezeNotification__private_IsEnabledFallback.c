/*
 * XREFs of Feature_Servicing_BypassGraphicsFreezeNotification__private_IsEnabledFallback @ 0x1C00DCCE8
 * Callers:
...
__int64 __fastcall Feature_Servicing_BypassGraphicsFreezeNotification__private_IsEnabledFallback(
        __int64 a1,
        unsigned int a2)
{
