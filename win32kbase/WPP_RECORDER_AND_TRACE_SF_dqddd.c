/*
 * XREFs of WPP_RECORDER_AND_TRACE_SF_dqddd @ 0x1C0217010
 * Callers:
...
__int64 WPP_RECORDER_AND_TRACE_SF_dqddd(__int64 a1, char a2, char a3, __int64 a4, int a5, int a6, int a7, int a8, ...)
{
  ...
  if ( a2 )
    result = ((__int64 (__fastcall *)(__int64, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))WPP_MAIN_CB.DeviceQueue.32)(
               a1,
               43LL,
               &WPP_86908d42d98631d196c6ca9688fccfc3_Traceguids,
               16LL,
               (__int64 *)va,
               4LL,
               (__int64 *)va1,
