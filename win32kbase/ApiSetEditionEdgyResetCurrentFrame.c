/*
 * XREFs of ApiSetEditionEdgyResetCurrentFrame @ 0x1C023D9BC
 * Callers:
...
__int64 (*ApiSetEditionEdgyResetCurrentFrame())(void)
{
  ...
  result = qword_1C02D7C88;
  if ( qword_1C02D7C88 )
  {
    result = (__int64 (*)(void))qword_1C02D7C88();
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7C90;
      if ( qword_1C02D7C90 )
        result = (__int64 (*)(void))qword_1C02D7C90();
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
