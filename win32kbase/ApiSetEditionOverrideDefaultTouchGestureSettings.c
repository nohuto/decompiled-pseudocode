/*
 * XREFs of ApiSetEditionOverrideDefaultTouchGestureSettings @ 0x1C009D718
 * Callers:
...
__int64 (*__fastcall ApiSetEditionOverrideDefaultTouchGestureSettings(__int64 a1))(void)
{
  ...
  result = qword_1C02D7F60;
  if ( qword_1C02D7F60 )
  {
    result = (__int64 (*)(void))qword_1C02D7F60();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D7F68;
      if ( qword_1C02D7F68 )
        result = (__int64 (*)(void))qword_1C02D7F68(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
