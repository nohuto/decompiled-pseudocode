        ...
        __int64 a3))(_QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C02D7958;
  if ( qword_1C02D7958 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C02D7958(v5, a2, a3, v7);
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7960;
      if ( qword_1C02D7960 )
      {
        LOBYTE(a2) = v3;
        result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C02D7960(a1, a2);
      }
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
