/*
 * XREFs of ?Initialize@?$CSectionBitmapAllocator@$0IAAA@$0IA@@NSInstrumentation@@AEAA_NPEAE@Z @ 0x1C002ABE4
 * Callers:
...
char __fastcall NSInstrumentation::CSectionBitmapAllocator<32768,128>::Initialize(_QWORD *a1, __int64 a2)
{
  ...
  *a1 = Pool2;
  if ( !Pool2 )
    return 0;
  *Pool2 = 0LL;
  v10 = _lambda_31498f3d16e1daf3a969a045e22f9fd8_::operator()(v9, 0x100u);
  if ( !v10 )
    return 0;
