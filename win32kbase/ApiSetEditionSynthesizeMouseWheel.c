/*
 * XREFs of ApiSetEditionSynthesizeMouseWheel @ 0x1C0243198
 * Callers:
...
PDEVICE_OBJECT *__fastcall ApiSetEditionSynthesizeMouseWheel(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  __int64 v6; // rsi
  __int64 v7; // rbp
  ...
  if ( qword_1C02D7E28 && (int)qword_1C02D7E28(v9, a2, a3, v11) >= 0 && qword_1C02D7E30 )
    qword_1C02D7E30(a1, v7, v6, a4, a5);
