        ...
        __int64 a3))(_QWORD, _QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C02D7480;
  if ( qword_1C02D7480 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C02D7480(v6, a2, a3, v8);
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7488;
      if ( qword_1C02D7488 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C02D7488(a1, v4, v3);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
