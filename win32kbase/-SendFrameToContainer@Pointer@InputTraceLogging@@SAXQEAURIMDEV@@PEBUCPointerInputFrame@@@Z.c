/*
 * XREFs of ?SendFrameToContainer@Pointer@InputTraceLogging@@SAXQEAURIMDEV@@PEBUCPointerInputFrame@@@Z @ 0x1C0226408
 * Callers:
    ...
    if ( (unsigned int)(v2 - 5) > 1 )
    {
      if ( v2 == 7 )
      {
        if ( (unsigned int)dword_1C02CA7E0 <= 4 || !tlgKeywordOn((__int64)&dword_1C02CA7E0, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C029D231;
      }
      else
      {
        if ( (unsigned int)dword_1C02CA7E0 <= 4 || !tlgKeywordOn((__int64)&dword_1C02CA7E0, 32LL) )
          return;
        v7 = (unsigned __int8 *)&unk_1C029D295;
      }
    }
    else
    {
      if ( (unsigned int)dword_1C02CA7E0 <= 4 || !tlgKeywordOn((__int64)&dword_1C02CA7E0, 32LL) )
        return;
      v7 = (unsigned __int8 *)&unk_1C029D363;
    }
    v10 = *(_DWORD *)(v5 + 48);
    v11 = *(_DWORD *)(v5 + 40);
    v12 = *(_QWORD *)(v5 + 72);
