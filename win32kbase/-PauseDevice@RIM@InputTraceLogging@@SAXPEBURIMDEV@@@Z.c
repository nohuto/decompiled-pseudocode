/*
 * XREFs of ?PauseDevice@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C01D209C
 * Callers:
...
void __fastcall InputTraceLogging::RIM::PauseDevice(const struct RIMDEV *a1)
{
  ...
  if ( (unsigned int)dword_1C02CA7E0 > 4 && tlgKeywordOn((__int64)&dword_1C02CA7E0, 256LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C02CA7E0, (unsigned __int8 *)dword_1C0298296, 0LL, 0LL, 3u, &v3);
  }
}
