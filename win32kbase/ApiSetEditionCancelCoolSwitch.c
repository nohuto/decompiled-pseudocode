/*
 * XREFs of ApiSetEditionCancelCoolSwitch @ 0x1C023C6EC
 * Callers:
...
__int64 (*__fastcall ApiSetEditionCancelCoolSwitch(_DWORD *a1))(void)
{
  ...
  if ( a1 )
    *a1 = 0;
  result = qword_1C02D75E0;
  if ( qword_1C02D75E0 )
  {
    result = (__int64 (*)(void))qword_1C02D75E0();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D75E8;
      if ( qword_1C02D75E8 )
        result = (__int64 (*)(void))qword_1C02D75E8(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
