/*
 * XREFs of McTemplateK0pxxq_EtwWriteTransfer @ 0x1C0165F40
 * Callers:
 *     EtwTraceFlipManagerContentFlip @ 0x1C01626D0 (EtwTraceFlipManagerContentFlip.c)
 * Callees:
 *     McGenEventWrite_EtwWriteTransfer @ 0x1C0038218 (McGenEventWrite_EtwWriteTransfer.c)
 *     __security_check_cookie @ 0x1C00DA480 (__security_check_cookie.c)
 */

NTSTATUS McTemplateK0pxxq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 4LL;
  va_copy(v11, va3);
  return McGenEventWrite_EtwWriteTransfer(a1, &FlipManagerContentFlip, &W32kControlGuid, 5u, &v4);
}
