/*
 * XREFs of ApiSetHasInputTransform @ 0x1C0244DFC
 * Callers:
...
__int64 __fastcall ApiSetHasInputTransform(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  v7 = 0;
  if ( qword_1C02D7AB8 && (int)qword_1C02D7AB8(v4, a2, a3, v6) >= 0 && qword_1C02D7AC0 )
    v7 = qword_1C02D7AC0(a1);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
