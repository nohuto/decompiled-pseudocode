/*
 * XREFs of ?SetReferenceProperty@CSharedSectionWrapperMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C026EF90
 * Callers:
 *     <none>
 * Callees:
