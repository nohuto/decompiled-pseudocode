/*
 * XREFs of NtUserDestroyPalmRejectionDelayZone @ 0x1C016E2A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserDestroyPalmRejectionDelayZone(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    CurrentThreadWin32Thread = (LARGE_INTEGER *)PsGetCurrentThreadWin32Thread(a1, Reserved, v7, a4, v29);
  ...
  if ( v10 )
  {
    ...
    {
      v15 = PsGetCurrentThreadWin32Thread(v12, v11, v13, v14, v29);
      if ( v15 )
      {
        ...
        *(LARGE_INTEGER *)(v15 + 8) = PerformanceCounter;
        ...
        {
          LODWORD(v30) = 1000000 * v17 / gliQpcFreq.QuadPart;
                            ...
                            - (unsigned __int64)WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink) >= W32KEtwUserCritTelemetryThrottleQPC )
        {
          ...
          {
            LODWORD(v30) = 1000 * v17 / gliQpcFreq.QuadPart;
            McTemplateK0xqx_EtwWriteTransfer(
              gullUserCritAcquireToken,
  ...
  Instance = DelayZonePalmRejection::GetInstance((__int64)v12, v11, v13, v14);
  if ( Instance )
    LOBYTE(v4) = DelayZonePalmRejection::RemoveDelayZoneFromList(Instance, v5);
