/*
 * XREFs of NtRIMUnregisterForInput @ 0x1C01A2BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtRIMUnregisterForInput(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  PVOID Reserved; // rdx
