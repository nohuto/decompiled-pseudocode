/*
 * XREFs of NtUserRegisterTouchPadCapable @ 0x1C00D0D70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserRegisterTouchPadCapable(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    CurrentThreadWin32Thread = (LARGE_INTEGER *)PsGetCurrentThreadWin32Thread(a1, Reserved, v6, a4, v30);
  ...
  if ( v9 )
  {
    ...
    {
      v14 = PsGetCurrentThreadWin32Thread(v11, v10, v12, v13, v30);
      if ( v14 )
      {
  ...
  AtomicExecutionCheck::AtomicExecutionCheck((AtomicExecutionCheck *)&v31, v10, v12, v13);
  v21 = gptiCurrent;
  v22 = *((_DWORD *)gptiCurrent + 318) & 0xFFFEFFFF | (v4 != 0 ? 0x10000 : 0);
  *((_DWORD *)gptiCurrent + 318) = v22;
  AtomicExecutionCheck::Disarm((AtomicExecutionCheck *)&v31, v22, (__int64)v21, v23);
