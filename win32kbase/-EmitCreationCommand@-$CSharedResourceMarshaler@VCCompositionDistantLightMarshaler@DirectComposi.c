/*
 * XREFs of ?EmitCreationCommand@?$CSharedResourceMarshaler@VCCompositionDistantLightMarshaler@DirectComposition@@$01@DirectComposition@@UEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00D3980
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CSharedResourceMarshaler<DirectComposition::CCompositionDistantLightMarshaler,2>::EmitCreationCommand(
        __int64 a1,
        __int64 *a2)
{
