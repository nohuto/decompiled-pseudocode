/*
 * XREFs of ApiSetPostPointerEventMessage @ 0x1C0245F48
 * Callers:
        ...
        __int64 a3))(_QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  result = qword_1C02D7460;
  if ( qword_1C02D7460 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))qword_1C02D7460(v5, a2, a3, v7);
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7468;
      if ( qword_1C02D7468 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))qword_1C02D7468(a1, 568LL, v3, 1LL);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
