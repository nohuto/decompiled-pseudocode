/*
 * XREFs of NtUserActivateKeyboardLayout @ 0x1C00823E0
 * Callers:
 *     <none>
 * Callees:
...
struct tagKL *__fastcall NtUserActivateKeyboardLayout(__int64 a1, unsigned int a2)
{
  ...
  {
    CurrentThreadWin32Thread = (LARGE_INTEGER *)PsGetCurrentThreadWin32Thread(a1, Reserved, v5, v7, v29);
  ...
  else
  {
    ...
    v2 = xxxActivateKeyboardLayout(ProcessWindowStation, a1, a2, 0LL);
  }
