/*
 * XREFs of ?EmitSetOffsetCommand@CCompositionTextLineMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0257A2C
 * Callers:
...
char __fastcall DirectComposition::CCompositionTextLineMarshaler::EmitSetOffsetCommand(
