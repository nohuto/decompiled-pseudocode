/*
 * XREFs of ?vDeleteREGION@REGION@@QEAAXXZ @ 0x1C00558E0
 * Callers:
 ...
 *     vRestoreRegion @ 0x1C00B1BD0 (vRestoreRegion.c)
 ...
 *     ?CleanUpRegion@@YAXPEAVREGION@@@Z @ 0x1C0183140 (-CleanUpRegion@@YAXPEAVREGION@@@Z.c)
