/*
 * XREFs of ApiSetEditionHandleMoveSizeDataOnDestroyMonitor @ 0x1C00B60F0
 * Callers:
...
__int64 (*__fastcall ApiSetEditionHandleMoveSizeDataOnDestroyMonitor(__int64 a1))(void)
{
  ...
  result = qword_1C02D7600;
  if ( qword_1C02D7600 )
  {
    result = (__int64 (*)(void))qword_1C02D7600();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D7608;
      if ( qword_1C02D7608 )
        result = (__int64 (*)(void))qword_1C02D7608(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
