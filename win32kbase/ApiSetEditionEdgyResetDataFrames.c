/*
 * XREFs of ApiSetEditionEdgyResetDataFrames @ 0x1C023DB08
 * Callers:
...
__int64 (*__fastcall ApiSetEditionEdgyResetDataFrames(__int64 a1))(void)
{
  char v2; // bl
  char v3; // dl
  char v4; // r8
  ...
  result = qword_1C02D7C98;
  if ( qword_1C02D7C98 )
  {
    result = (__int64 (*)(void))qword_1C02D7C98();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D7CA0;
      if ( qword_1C02D7CA0 )
        result = (__int64 (*)(void))qword_1C02D7CA0(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
