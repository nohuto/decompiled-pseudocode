/*
 * XREFs of ?Add@?$CStructDynamicArray@UInjectManipulationArgs@@@@QEAAJAEBUInjectManipulationArgs@@@Z @ 0x1C02516D4
 * Callers:
...
__int64 __fastcall CStructDynamicArray<InjectManipulationArgs>::Add(__int64 a1, _OWORD *a2)
{
  ...
  if ( *(_DWORD *)(a1 + 8) != *(_DWORD *)(a1 + 12)
    || (v2 = CDynamicArray<InjectManipulationArgs *,2003858261>::Grow(), v2 >= 0) )
  {
    if ( *(_DWORD *)(a1 + 8) >= *(_DWORD *)(a1 + 12) )
    ...
    {
      Pool2 = ExAllocatePool2(260LL, 128LL, 845431620LL);
      if ( Pool2 )
    ...
    if ( v6 == 1 )
    {
      ...
      {
        v8 = (_QWORD *)ExAllocatePool2(v16 & 0xFFFFFFFFFFFFFFFDuLL, 144LL, v14);
        Pool2 = (__int64)v8;
        if ( !v8
          || (_InterlockedIncrement64((volatile signed __int64 *)v5 + 14),
              *v8 = 845431620LL,
...
LABEL_23:
    ...
    else if ( v6 == 2 )
    {
      ...
      Pool2 = ExAllocatePool2(v9, 144LL, 845431620LL);
      if ( Pool2 )
      {
