/*
 * XREFs of ?BuildReportDescriptor@@YAHGGPEAUtagUSAGE_PROPERTIES@@KKPEAU_HIDP_DEVICE_DESC@@@Z @ 0x1C01C5EBC
 * Callers:
 ...
 *     ?BuildDeviceHeader@@YAHPEAEKPEAKGG@Z @ 0x1C01C5B10 (-BuildDeviceHeader@@YAHPEAEKPEAKGG@Z.c)
