/*
 * XREFs of ApiSetEditionContactVisualization @ 0x1C023CE48
 * Callers:
...
__int64 __fastcall ApiSetEditionContactVisualization(unsigned int a1, __int64 a2, __int64 a3, unsigned int a4, int a5)
{
  ...
  v11 = 0;
  if ( qword_1C02D7BF8 && (int)qword_1C02D7BF8(v8, a2, a3, v10) >= 0 && qword_1C02D7C00 )
    v11 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, _QWORD, int))qword_1C02D7C00)(a1, v6, 480LL, a4, a5);
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
    || (LOBYTE(a2) = 1, BYTE1(WPP_GLOBAL_Control->Timer) < 5u) )
  {
