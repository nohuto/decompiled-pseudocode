/*
 * XREFs of NtRIMOnTimerNotification @ 0x1C01A20D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtRIMOnTimerNotification(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  PVOID Reserved; // rdx
  ...
  if ( IsEtwUserCritEnabled() )
  {
    ...
    if ( v14 )
    {
      ...
      *(LARGE_INTEGER *)(v14 + 8) = PerformanceCounter;
      ...
      {
        LODWORD(v31) = 1000000 * v16 / gliQpcFreq.QuadPart;
                          ...
                          - (unsigned __int64)WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink) >= W32KEtwUserCritTelemetryThrottleQPC )
      {
        ...
        {
          LODWORD(v31) = 1000 * v16 / gliQpcFreq.QuadPart;
          McTemplateK0xqx_EtwWriteTransfer(
            gullUserCritAcquireToken,
