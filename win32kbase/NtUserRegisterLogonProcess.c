/*
 * XREFs of NtUserRegisterLogonProcess @ 0x1C008CD50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserRegisterLogonProcess(__int64 a1, __int64 a2)
{
  ...
  {
    CurrentThreadWin32Thread = (LARGE_INTEGER *)PsGetCurrentThreadWin32Thread(a1, Reserved, v4, v6, v28);
  ...
  v21 = (int)RegisterLogonProcess(v3, a2);
