/*
 * XREFs of ?BufferMouseInput@Mouse@InputTraceLogging@@SAXPEAUDEVICEINFO@@@Z @ 0x1C0214B78
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::BufferMouseInput(struct DEVICEINFO *a1)
{
  ...
  if ( (unsigned int)dword_1C02CA7E0 > 4 && tlgKeywordOn((__int64)&dword_1C02CA7E0, 64LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C02CA7E0, (unsigned __int8 *)dword_1C029C851, 0LL, 0LL, 3u, &v3);
  }
}
