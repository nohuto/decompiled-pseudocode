/*
 * XREFs of ?ProcessPTPInertiaActions@CHidInput@@QEAA_NPEAX_K@Z @ 0x1C0212654
 * Callers:
...
char __fastcall CHidInput::ProcessPTPInertiaActions(CHidInput *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *((_QWORD *)this + 188) = a3;
  ...
  CRIMBase::SensorDoWorkAndWait((__int64)this, 0x10u);
  ...
  {
    CurrentThreadWin32Thread = (LARGE_INTEGER *)PsGetCurrentThreadWin32Thread(v5, Reserved, v8, v6, v27);
    if ( CurrentThreadWin32Thread )
      CurrentThreadWin32Thread[1] = KeQueryPerformanceCounter(0LL);
  }
  v10 = SGDGetUserSessionState(v5, Reserved, v8, v6);
...
LABEL_15:
  ...
  {
    v16 = PsGetCurrentThreadWin32Thread(v13, v12, v14, v15, v27);
    if ( v16 )
    {
      ...
      *(LARGE_INTEGER *)(v16 + 8) = PerformanceCounter;
      ...
      {
        LODWORD(v28) = 1000000 * v18 / gliQpcFreq.QuadPart;
                          ...
                          - (unsigned __int64)WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink) >= W32KEtwUserCritTelemetryThrottleQPC )
      {
        ...
        {
          LODWORD(v28) = 1000 * v18 / gliQpcFreq.QuadPart;
          McTemplateK0xqx_EtwWriteTransfer(
            gullUserCritAcquireToken,
