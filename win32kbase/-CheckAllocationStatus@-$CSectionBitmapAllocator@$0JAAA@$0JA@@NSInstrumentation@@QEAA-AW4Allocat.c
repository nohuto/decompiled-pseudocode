/*
 * XREFs of ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0JAAA@$0JA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C00A789C
 * Callers:
        ...
        unsigned __int64 a2)
{
  ...
  if ( !a2 || a2 < v2 || a2 >= v2 + 36864 )
    return 0LL;
  if ( (a2 & 0xFFF) == 144 * ((a2 & 0xFFF) / 0x90) )
    return 2
         - (unsigned int)(RtlTestBit(
                            (PRTL_BITMAP)(a1[3] ^ a1[2]),
                            28 * (((unsigned int)a2 - ((unsigned int)a1[2] ^ *((_DWORD *)a1 + 2))) >> 12)
                          + (a2 & 0xFFF) / 0x90) != 0);
  return 3LL;
}
