/*
 * XREFs of ApiSetTraceLoggingUserIsActive @ 0x1C00C954C
 * Callers:
...
__int64 (__fastcall *__fastcall ApiSetTraceLoggingUserIsActive(
        unsigned int a1,
        __int64 a2,
        __int64 a3))(_QWORD, _QWORD)
{
  ...
  result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C02D7F00;
  if ( qword_1C02D7F00 )
  {
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C02D7F00(v5, a2, a3, v7);
    if ( (int)result >= 0 )
    {
      result = qword_1C02D7F08;
      if ( qword_1C02D7F08 )
        result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C02D7F08(a1, v3);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
