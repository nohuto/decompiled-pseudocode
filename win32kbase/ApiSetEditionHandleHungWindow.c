/*
 * XREFs of ApiSetEditionHandleHungWindow @ 0x1C023ED50
 * Callers:
...
__int64 (*__fastcall ApiSetEditionHandleHungWindow(__int64 a1))(void)
{
  ...
  result = qword_1C02D75D0;
  if ( qword_1C02D75D0 )
  {
    result = (__int64 (*)(void))qword_1C02D75D0();
    if ( (int)result >= 0 )
    {
      result = (__int64 (*)(void))qword_1C02D75D8;
      if ( qword_1C02D75D8 )
        result = (__int64 (*)(void))qword_1C02D75D8(a1);
    }
  }
  if ( WPP_GLOBAL_Control == (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    || (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) == 0
