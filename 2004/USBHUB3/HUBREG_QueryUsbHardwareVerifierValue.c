/*
 * XREFs of HUBREG_QueryUsbHardwareVerifierValue @ 0x1C007D2C0
 * Callers:
...
LABEL_23:
    if ( v13 == -1073741772 )
    {
      ...
      {
        LODWORD(v18) = v13;
        WPP_RECORDER_SF_d(a6, 2u, 5u, 0x10u, (__int64)&WPP_bb780d5c926432a673b7a78c72bdde31_Traceguids, v18);
      }
    }
    goto LABEL_13;
  }
  ...
  {
    LODWORD(v18) = v13;
    WPP_RECORDER_SF_d(a6, 2u, 5u, 0xFu, (__int64)&WPP_bb780d5c926432a673b7a78c72bdde31_Traceguids, v18);
  }
LABEL_13:
  if ( v13 < 0 )
  {
    *a7 = 0;
    ...
    {
      LODWORD(v18) = v13;
      WPP_RECORDER_SF_d(a6, 2u, 5u, 0x11u, (__int64)&WPP_bb780d5c926432a673b7a78c72bdde31_Traceguids, v18);
    }
    goto LABEL_51;
  }
LABEL_49:
  ...
  {
    LODWORD(v18) = *a7;
    WPP_RECORDER_SF_d(a6, 2u, 5u, 0x12u, (__int64)&WPP_bb780d5c926432a673b7a78c72bdde31_Traceguids, v18);
  }
LABEL_51:
  if ( v19 )
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 1848))(WdfDriverGlobals);
