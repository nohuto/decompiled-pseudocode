/*
 * XREFs of sub_18000112C @ 0x18000112C
 * Callers:
 *     sub_180005224 @ 0x180005224 (sub_180005224.c)
 * Callees:
 *     sub_180001090 @ 0x180001090 (sub_180001090.c)
 *     __security_check_cookie @ 0x1800396C0 (__security_check_cookie.c)
 */

ULONG __fastcall sub_18000112C(
        __int64 a1,
        unsigned __int8 *a2,
        __int64 a3,
        __int64 a4,
        ...
        void **a19)
{
  ...
  v50 = 4LL;
  v48 = 8LL;
  return sub_180001090(a1, a2, 0LL, 0LL, 0x11u, &v46);
}
