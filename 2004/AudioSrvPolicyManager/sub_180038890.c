/*
 * XREFs of sub_180038890 @ 0x180038890
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180038890(__int64 a1, const WCHAR *a2)
{
  char v3; // di
  LSTATUS v4; // eax
  char v5; // si
  ...
  v3 = 0;
  hKey = 0LL;
  v4 = RegOpenKeyExW(HKEY_LOCAL_MACHINE, *(LPCWSTR *)(a1 + 8), 0, 0x20019u, &hKey);
  v5 = 1;
  if ( v4 )
  {
