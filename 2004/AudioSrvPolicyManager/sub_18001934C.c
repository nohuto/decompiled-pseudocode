/*
 * XREFs of sub_18001934C @ 0x18001934C
 * Callers:
...
_QWORD *__fastcall sub_18001934C(_QWORD *a1, _QWORD *a2, char a3, _QWORD *a4, __int64 a5, _QWORD *a6)
{
  ...
  {
    sub_180019300(0x38E38E38E38E38DLL, a6);
