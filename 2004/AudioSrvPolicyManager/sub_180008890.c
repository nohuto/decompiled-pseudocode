/*
 * XREFs of sub_180008890 @ 0x180008890
 * Callers:
...
BOOL __fastcall sub_180008890(LPINIT_ONCE *a1)
{
  DWORD v1; // edx
  LPINIT_ONCE v3; // rdi
  ULONGLONG *Ptr; // rsi
  ...
  if ( !v1 )
  {
    ...
    v5 = *(GUID *)(Ptr[1] - 16);
    Ptr[6] = 0LL;
    Ptr[5] = (ULONGLONG)sub_1800059B0;
    v8 = v5;
    if ( !EventRegister(&v8, (PENABLECALLBACK)EnableCallback, Ptr, Ptr + 4) )
