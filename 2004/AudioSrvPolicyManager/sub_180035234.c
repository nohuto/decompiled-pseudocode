/*
 * XREFs of sub_180035234 @ 0x180035234
 * Callers:
...
__int64 __fastcall sub_180035234(PSID pSid, PACL pAcl, struct _ACL **a3, DWORD *a4)
{
  DWORD LastError; // ebx
  struct _ACL *v9; // rdi
  int v10; // edi
  ...
  *a4 = 0;
  ...
  if ( v11 > 0xFFFF )
    v11 = 0xFFFF;
  v12 = (struct _ACL *)sub_180039E78(v11, &unk_18004FFC8);
  v9 = v12;
  if ( v12 )
  {
