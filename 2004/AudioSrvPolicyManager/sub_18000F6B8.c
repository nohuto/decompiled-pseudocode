/*
 * XREFs of sub_18000F6B8 @ 0x18000F6B8
 * Callers:
...
__int64 __fastcall sub_18000F6B8(__int64 a1, __int64 a2)
{
  __int64 v2; // rbp
  signed int v4; // ebx
...
LABEL_12:
      v8 = (_QWORD *)sub_180039DDC(24LL, &unk_18004FFC8);
      v9 = v8;
      if ( v8 )
      {
        *v8 = 0LL;
      ...
      if ( v9 )
      {
        ...
        if ( v10 )
          v17 = (**v10)(v10, v16);
        v4 = sub_18000F494(v9, (__int64)v16, a1);
      }
      if ( v4 >= 0 )
      {
        ThreadpoolWork = CreateThreadpoolWork((PTP_WORK_CALLBACK)pfnwk, v9, (PTP_CALLBACK_ENVIRON)(a1 + 8));
        if ( ThreadpoolWork )
        {
          v4 = 0;
        }
