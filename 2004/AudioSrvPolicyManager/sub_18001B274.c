/*
 * XREFs of sub_18001B274 @ 0x18001B274
 * Callers:
...
__int64 __fastcall sub_18001B274(__int64 a1, __int64 a2, int a3)
{
  __int64 v5; // rbx
  ...
  if ( v7 < 0 )
  {
    ...
    {
      sub_1800050FC(*((_QWORD *)off_18004F000 + 2), 0x12u, &stru_1800445C8, v7);
    }
    sub_180005724("CApplicationManager::RegisterSoundLevelNotificationClient", 628, v7);
  }
  else
  {
    sub_180015640(a2, 1, a3);
  }
  if ( v6 )
