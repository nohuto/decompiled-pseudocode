/*
 * XREFs of sub_180013E44 @ 0x180013E44
 * Callers:
...
__int64 __fastcall sub_180013E44(
        _DWORD *pv,
        void *a2,
        int a3,
        int a4,
        ...
        int a21)
{
  ...
  *((_QWORD *)pv + 25) = 0LL;
  ...
  try
  {
    v37 = sub_180018844((_DWORD)pv, (_DWORD)a2, a5, v34);
    if ( v37 < 0 )
    {
      sub_180003AB0(
        retaddr,
    ...
    *((_QWORD *)pv + 27) = 0LL;
    ...
    do
      ++v41;
    while ( *(_WORD *)(a8 + 2 * v41) );
    v42 = sub_180018844(v36, v35, a8, v41);
    v45 = v42;
    if ( v42 < 0 )
    {
      sub_180003AB0(
    ...
    if ( a6 )
    {
      ...
      *((_QWORD *)pv + 26) = 0LL;
      ...
      do
        ++v48;
      while ( *(_WORD *)(a6 + 2 * v48) );
      v49 = sub_180018844(v44, v43, a6, v48);
      v50 = v49;
      if ( v49 < 0 )
      {
        sub_180003AB0(
    ...
    if ( v73 )
    {
      ...
      *((_QWORD *)pv + 29) = 0LL;
      do
        ++v33;
      while ( *(_WORD *)(v51 + 2 * v33) );
      v54 = sub_180018844(v44, v43, v51, v33);
      v55 = v54;
      if ( v54 < 0 )
      {
        sub_180003AB0(
    ...
    while ( 1 )
    {
      ...
      if ( *((DWORD **)pv + 17) == v64 )
      {
        sub_180018520(pv + 30, v64, &hSourceHandle);
      }
      else
      {
        *v64 = v58;
      ...
      if ( hObject )
      {
        ...
        else
        {
          ...
          if ( i != v66 )
          {
            v68 = (_DWORD *)*((_QWORD *)sub_1800055CC() + 1);
            if ( *v68 > 4u )
            {
              ...
              v77 = &v73;
              v78 = 4LL;
              sub_180001090((__int64)v68, (unsigned __int8 *)dword_180046255, 0LL, 0LL, 4u, &v76);
            }
LABEL_63:
            v65 = (char *)hObject;
LABEL_64:
