/*
 * XREFs of sub_18002CECC @ 0x18002CECC
 * Callers:
...
__int64 __fastcall sub_18002CECC(__int64 a1, __int64 a2, int a3, int a4, _QWORD *a5)
{
  ...
  if ( v14 < 0 )
  {
    ...
    {
      sub_1800050FC(*((_QWORD *)off_18004F000 + 2), 0x23u, &stru_180045198, v14);
    }
    sub_180005724("HostedAppStateChangedContext::CreateInstance", 952, v14);
  }
