 ...
 *     sub_18003AA5C @ 0x18003AA5C (sub_18003AA5C.c)
 *     sub_18003AB74 @ 0x18003AB74 (sub_18003AB74.c)
 */

__int64 __fastcall sub_180036708(DWORD SessionId)
{
  WCHAR v1; // di
  char v2; // bl
  unsigned int v4; // ebx
  ...
  v6[0] = 0;
  v2 = 0;
  if ( !(unsigned __int8)sub_18003AA5C() || !(unsigned __int8)sub_18003AB74() )
    return 0;
  if ( SessionId == -1 )
