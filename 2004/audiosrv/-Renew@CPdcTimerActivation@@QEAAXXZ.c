/*
 * XREFs of ?Renew@CPdcTimerActivation@@QEAAXXZ @ 0x1800EF5B0
 * Callers:
...
void __fastcall CPdcTimerActivation::Renew(CPdcTimerActivation *this)
{
  ...
  _QWORD v20[3]; // [rsp+A0h] [rbp-60h] BYREF
