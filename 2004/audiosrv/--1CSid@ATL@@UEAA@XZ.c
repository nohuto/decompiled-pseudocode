 ...
 *     _CAudioDGProcess::GetADGProcessSD_::_1_::dtor$3 @ 0x180076309 (_CAudioDGProcess--GetADGProcessSD_--_1_--dtor$3.c)
 *     _DetermineLowRightsKeySecurityDescriptor_::_1_::dtor$4 @ 0x1800763B6 (_DetermineLowRightsKeySecurityDescriptor_--_1_--dtor$4.c)
 *     _ATL::CDacl::Copy_::_1_::dtor$0 @ 0x1800765A0 (_ATL--CDacl--Copy_--_1_--dtor$0.c)
