/*
 * XREFs of AudioServerResetEndpoint @ 0x1800E0F20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerResetEndpoint(char *a1, __int64 a2)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v5[1], v6, (struct _TP_TIMER *)L"AudioServerResetEndpoint");
  v7 = (*(__int64 (__fastcall **)(char *, __int64))(*(_QWORD *)a1 + 80LL))(a1, a2);
  v8 = v7;
  if ( v7 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerResetEndpoint", 3361, v7);
