/*
 * XREFs of ??1?$unique_ptr@VCVpoContextProxy@@U?$default_delete@VCVpoContextProxy@@@std@@@std@@QEAA@XZ @ 0x1800DB5B0
 * Callers:
 *     AudioServerGetEndpointVpoContext$dtor$4 @ 0x1800DFAB0 (AudioServerGetEndpointVpoContext$dtor$4.c)
 *     AudioServerGetStreamVpoContext$dtor$6 @ 0x1800E08D8 (AudioServerGetStreamVpoContext$dtor$6.c)
 * Callees:
