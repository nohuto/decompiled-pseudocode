/*
 * XREFs of ?GetStaticObjectPosition@SpatialAudioDevicePropertyReader@@UEAAJW4AudioObjectType@@PEAM11@Z @ 0x180129010
 * Callers:
 *     <none>
 * Callees:
        ...
        float *a5)
{
  ...
  if ( a3 && a4 && (v13 = a5) != 0LL && (unsigned int)(a2 - 2) <= 0x1FFFE )
  {
    ...
    *a4 = *(float *)(v14 + 8 * v15 + 4);
    *v13 = *(float *)(v14 + 8 * v15 + 8);
  }
  else
  {
