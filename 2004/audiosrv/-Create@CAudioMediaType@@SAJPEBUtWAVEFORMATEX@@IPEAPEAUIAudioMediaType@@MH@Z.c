/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x18001FAE0
 * Callers:
 ...
 * Callees:
 *     ??0CAudioMediaType@@IEAA@XZ @ 0x180020AE8 (--0CAudioMediaType@@IEAA@XZ.c)
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x18004790C (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
