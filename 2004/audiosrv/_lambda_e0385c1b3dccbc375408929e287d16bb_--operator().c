/*
 * XREFs of _lambda_e0385c1b3dccbc375408929e287d16bb_::operator() @ 0x180073C54
 * Callers:
 *     Windows::Internal::ComTaskPool::CTaskWrapper__lambda_e0385c1b3dccbc375408929e287d16bb___::Run @ 0x180074810 (Windows--Internal--ComTaskPool--CTaskWrapper__lambda_e0385c1b3dccbc375408929e287d16bb___--Run.c)
 * Callees:
                   ...
                   0x18u) )
      {
        if ( (unsigned int)dword_18019D520 > 2 )
        {
          ...
          _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>>(
            (unsigned int)&dword_18019D520,
            (unsigned int)&unk_18016DC7B,
            v8,
            v9,
            (__int64)&v14);
        }
