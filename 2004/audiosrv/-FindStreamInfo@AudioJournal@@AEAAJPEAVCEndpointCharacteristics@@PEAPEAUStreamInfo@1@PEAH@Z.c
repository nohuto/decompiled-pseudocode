/*
 * XREFs of ?FindStreamInfo@AudioJournal@@AEAAJPEAVCEndpointCharacteristics@@PEAPEAUStreamInfo@1@PEAH@Z @ 0x18001BF20
 * Callers:
        ...
        int *a4)
{
  ...
  if ( !a2 )
  {
    v9 = (struct AudioJournal::StreamInfo *)&unk_1801A0490;
    v26 = (struct AudioJournal::StreamInfo *)&unk_1801A0490;
LABEL_24:
  ...
  {
    v5 = (struct AudioJournal::StreamInfo *)&unk_1801A0300;
    v6 = 2;
  }
  else
  {
    v5 = (struct AudioJournal::StreamInfo *)&unk_1801A00A8;
    v6 = 3;
  }
  v26 = v5;
  Src = 0LL;
