/*
 * XREFs of ?OnNotify@CVolumeStrip@@UEAAJKPEBU_GUID@@@Z @ 0x1800C4340
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF__guid_ @ 0x1800C4C40 (WPP_SF__guid_.c)
 */
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_q(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      0x10u,
      (__int64)&WPP_42b4fa7daad03b80922a8ee15d46dabb_Traceguids,
      (char *)this - 8);
  }
  if ( !a3 )
    goto LABEL_9;
...
LABEL_43:
            ...
            else
            {
              ...
              {
                WPP_SF__guid_(*((_QWORD *)v20 + 2), 18LL, &WPP_42b4fa7daad03b80922a8ee15d46dabb_Traceguids, v13 + 24);
                v20 = WPP_GLOBAL_Control;
              }
              if ( v20 != (CAudioSessionManager *)&WPP_GLOBAL_Control )
              {
