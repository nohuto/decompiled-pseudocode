 ...
 *     ?GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ @ 0x180136698 (-GetNearestLicenseExpiryDate@AtmosCheck@@AEAA_KXZ.c)
  ...
  if ( !ThreadpoolTimer )
  {
    ...
    if ( !ThreadpoolTimer )
    {
      ...
      if ( (unsigned int)dword_18019D520 > 5 )
      {
        ...
        tlgWriteTransfer_EventWriteTransfer((int)&dword_18019D520, (int)&dword_18016D6EE, 0, 0, 3u, &v9);
      }
      return;
    }
  }
