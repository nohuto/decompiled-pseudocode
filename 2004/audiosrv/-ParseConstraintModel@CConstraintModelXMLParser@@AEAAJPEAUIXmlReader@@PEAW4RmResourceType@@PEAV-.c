/*
 * XREFs of ?ParseConstraintModel@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEAW4RmResourceType@@PEAV?$CAtlMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@W4RmResourceType@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@V?$CElementTraits@W4RmResourceType@@@2@@ATL@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@5@PEAV?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@5@PEAV?$CAtlArray@PEAV?$CAtlArray@PEAVExclusiveEndpointInfo@@V?$CElementTraits@PEAVExclusiveEndpointInfo@@@ATL@@@ATL@@V?$CElementTraits@PEAV?$CAtlArray@PEAVExclusiveEndpointInfo@@V?$CElementTraits@PEAVExclusiveEndpointInfo@@@ATL@@@ATL@@@2@@5@@Z @ 0x18013B8A8
 * Callers:
 ...
 *     ?ParseExclusiveEndpoints@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEAV?$CAtlArray@PEAVExclusiveEndpointInfo@@V?$CElementTraits@PEAVExclusiveEndpointInfo@@@ATL@@@ATL@@@Z @ 0x18013BD00 (-ParseExclusiveEndpoints@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEAV-$CAtlArray@PEAVExc.c)
 *     ?ParseLimits@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEAW4RmResourceType@@PEAV?$CAtlMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@W4RmResourceType@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@V?$CElementTraits@W4RmResourceType@@@2@@ATL@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@5@@Z @ 0x18013BE58 (-ParseLimits@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEAW4RmResourceType@@PEAV-$CAtlMap@.c)
 *     ?ParseResourceConsumer@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEAV?$CAtlMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@W4RmResourceType@@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@V?$CElementTraits@W4RmResourceType@@@2@@ATL@@PEAV?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@4@@Z @ 0x18013C1BC (-ParseResourceConsumer@CConstraintModelXMLParser@@AEAAJPEAUIXmlReader@@PEAV-$CAtlMap@V-$CStringT.c)
 */

__int64 __fastcall CConstraintModelXMLParser::ParseConstraintModel(
        ...
        _QWORD *a7)
{
  int v11; // esi
  int v12; // ebp
  int StartElement; // ebx
  int v14; // r13d
  int StartOrEndElement; // eax
  _QWORD *v16; // rax
  _QWORD *v17; // rdi
  ...
  LogOutput((size_t *)L"Parsing constraint model");
  v11 = 0;
  v22 = 0;
  v12 = 1;
  v21 = 1;
  StartElement = CConstraintModelXMLParser::FindStartElement(this, a2, L"Limits");
  if ( StartElement >= 0 )
    StartElement = CConstraintModelXMLParser::ParseLimits((_DWORD)this, (_DWORD)a2, a3, a4, a5);
  v14 = 0;
  if ( StartElement >= 0 )
  {
    while ( v14 >= 0 && v12 )
    {
      StartOrEndElement = CConstraintModelXMLParser::FindStartOrEndElement(
                            ...
                            &v21);
      v12 = v21;
      v14 = StartOrEndElement;
      if ( StartOrEndElement >= 0 && v21 )
      {
        ...
        if ( StartElement < 0 )
          break;
        StartElement = CConstraintModelXMLParser::ParseExclusiveEndpoints(this, a2);
        if ( StartElement < 0 )
          break;
        v18 = a7[1];
        if ( v18 >= a7[2]
  ...
  if ( StartElement >= 0 )
  {
    do
    {
      ...
      {
        v11 = 1;
        StartElement = CConstraintModelXMLParser::ParseResourceConsumer(this, a2);
      }
    }
    while ( StartElement >= 0 );
    if ( StartElement >= 0 && !v11 )
