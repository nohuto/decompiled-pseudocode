/*
 * XREFs of ??$_Destroy_range@V?$allocator@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@YAXPEAV?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@0AEAV?$allocator@V?$com_ptr_t@UIProcessSubmixProxy@@Uerr_returncode_policy@wil@@@wil@@@0@@Z @ 0x180058CB4
 * Callers:
 ...
 *     _std::vector_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy____::_1_::catch$58 @ 0x18007614F (_std--vector_wil--com_ptr_t_IAudioProcess_wil--err_returncode_policy__std--allocator_wil--com_pt.c)
 *     _std::vector_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_IAudioProcess_wil::err_returncode_policy__const_&__::_1_::catch$60 @ 0x18007676B (_std--vector_wil--com_ptr_t_IAudioProcess_wil--err_returncode_policy__std--allocato_ea_18007676B.c)
 *     _std::vector_wil::com_ptr_t_CEndpointCharacteristics_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_CEndpointCharacteristics_wil::err_returncode_policy_____::_Emplace_reallocate_CEndpointCharacteristics___&__::_1_::catch$33 @ 0x18007B1E8 (_std--vector_wil--com_ptr_t_CEndpointCharacteristics_wil--err_returncode_policy__std--allocator_.c)
 ...
 *     _std::vector_wil::com_ptr_t_IProcessSubmixProxy_wil::err_returncode_policy__std::allocator_wil::com_ptr_t_IProcessSubmixProxy_wil::err_returncode_policy_____::_Emplace_reallocate_wil::com_ptr_t_IProcessSubmixProxy_wil::err_returncode_policy____::_1_::catch$33 @ 0x1800D23E1 (_std--vector_wil--com_ptr_t_IProcessSubmixProxy_wil--err_returncode_policy__std--allocator_wil--.c)
 *     ??1?$vector@V?$com_ptr_t@UIAudioStreamVolumeCallback@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIAudioStreamVolumeCallback@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x1800D24E8 (--1-$vector@V-$com_ptr_t@UIAudioStreamVolumeCallback@@Uerr_returncode_policy@wil@@@wil@@V-$alloc.c)
