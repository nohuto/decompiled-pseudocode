 ...
 *     ?reset@?$unique_storage@U?$resource_policy@PEAU_TP_TIMER@@P6AXPEAU1@@Z$1?Destroy@?$DestroyThreadPoolTimer@USystemThreadPoolMethods@details@wil@@$0A@@details@wil@@SAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAU_TP_TIMER@@@Z @ 0x1800698D0 (-reset@-$unique_storage@U-$resource_policy@PEAU_TP_TIMER@@P6AXPEAU1@@Z$1-Destroy@-$DestroyThread.c)
        ...
        _DWORD *a5)
{
  ...
  if ( a4 )
  {
    ...
    v10 = (_OWORD *)*(&xmmword_18019F590 + 1);
    v11 = xmmword_18019F5A0;
    LODWORD(v19) = v6;
    *((_QWORD *)&v19 + 1) = a4;
    if ( (unsigned __int64)(*(&xmmword_18019F590 + 1) - xmmword_18019F590 + 16LL) >= (_QWORD)xmmword_18019F5A0
                                                                                   - xmmword_18019F590 )
    {
      v15 = 16LL;
      if ( (unsigned __int64)(2 * (xmmword_18019F5A0 - xmmword_18019F590)) > 0x10 )
        v15 = 2 * (xmmword_18019F5A0 - xmmword_18019F590);
      if ( !wil::details_abi::heap_buffer::reserve((wil::details_abi::heap_buffer *)&xmmword_18019F590, v15) )
        goto LABEL_20;
      v11 = xmmword_18019F5A0;
      v10 = (_OWORD *)*(&xmmword_18019F590 + 1);
    }
