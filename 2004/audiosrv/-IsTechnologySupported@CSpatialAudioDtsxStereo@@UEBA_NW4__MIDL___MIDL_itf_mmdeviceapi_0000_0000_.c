/*
 * XREFs of ?IsTechnologySupported@CSpatialAudioDtsxStereo@@UEBA_NW4__MIDL___MIDL_itf_mmdeviceapi_0000_0000_0003@@PEBUtWAVEFORMATEX@@1V?$function@$$A6A_NPEBUWAVEFORMATEXTENSIBLE@@@Z@std@@KPEAIPEA_NPEAUWAVEFORMATEXTENSIBLE@@@Z @ 0x18004B1D0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a9)
{
  ...
  *a8 = 0;
  ...
  v16 = 0LL;
  if ( *((_QWORD *)this + 1) || !byte_18019EA20 )
  {
    a7 = (unsigned int *)v22;
    v23 = 0LL;
