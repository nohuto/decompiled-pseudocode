/*
 * XREFs of ?InstantiateADG@CAudioDGProcess@@QEAAJXZ @ 0x180010F60
 * Callers:
  ...
  *((_BYTE *)this + 100) = 0;
  ...
  if ( (unsigned int)dword_18019D4E8 > 4 )
  {
    ...
    *(_DWORD *)&EventDescriptor.Level = 4;
    ...
    UserData.Ptr = (ULONGLONG)off_18019D4F0;
    UserData.Size = *(unsigned __int16 *)off_18019D4F0;
    UserData.Reserved = 2;
    v21 = &unk_18016D45C;
    v22 = 36;
    v23 = 1;
    pvData = (unsigned int)&TraceLoggingMetadataEnd - (unsigned int)&TraceLoggingMetadata;
    EventWriteTransfer(qword_18019D508, &EventDescriptor, 0LL, 0LL, 3u, &UserData);
  }
