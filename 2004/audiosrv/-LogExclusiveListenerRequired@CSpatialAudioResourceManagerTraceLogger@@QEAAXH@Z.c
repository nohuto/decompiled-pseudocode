/*
 * XREFs of ?LogExclusiveListenerRequired@CSpatialAudioResourceManagerTraceLogger@@QEAAXH@Z @ 0x180107FBC
 * Callers:
        ...
        int a2)
{
  ...
  if ( (unsigned int)dword_18019D350 > 4 )
  {
    ...
    v6 = 0;
    v5 = 4;
    tlgWriteTransfer_EventWriteTransfer((int)&dword_18019D350, (int)&dword_18016A1D6, 0, 0, 3u, &v3);
  }
}
