/*
 * XREFs of _CMonitorManager::IsMonitorMirrorEligible_::_1_::dtor$0 @ 0x1800FDD12
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CMonitorManager::IsMonitorMirrorEligible_::_1_::dtor_0(__int64 a1, __int64 a2)
{
