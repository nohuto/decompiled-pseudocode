/*
 * XREFs of _DynamicAudioEndpointManager::GetRule_::_1_::dtor$1 @ 0x180112CC8
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DynamicAudioEndpointManager::GetRule_::_1_::dtor_1(__int64 a1, __int64 a2)
{
