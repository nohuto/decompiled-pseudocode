/*
 * XREFs of AudioServerGetStreamLatency @ 0x1800DFF30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerGetStreamLatency(char *a1, __int64 a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v7[1], v8, (struct _TP_TIMER *)L"AudioServerGetStreamLatency");
  v9 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*(_QWORD *)a1 + 112LL))(a1, a2, a3);
  v10 = v9;
  if ( v9 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioServerGetStreamLatency", 3693, v9);
