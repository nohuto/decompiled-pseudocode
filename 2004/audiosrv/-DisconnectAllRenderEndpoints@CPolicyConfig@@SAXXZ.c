/*
 * XREFs of ?DisconnectAllRenderEndpoints@CPolicyConfig@@SAXXZ @ 0x1800D7584
 * Callers:
...
void __fastcall CPolicyConfig::DisconnectAllRenderEndpoints(__int64 a1)
{
  ...
  v1 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                 ...
                 + 1);
  if ( *v1 > 4u )
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v1, byte_180168360, 0LL, 0LL, 2, (__int64)&p_pv);
