/*
 * XREFs of _ATL::CAtlMap_ResourceConsumer___ATL::CAtlList__ResourceInfo_ResourceInfoTraits____ResourceConsumerTraits_ATL::CElementTraits_ATL::CAtlList__ResourceInfo_ResourceInfoTraits______::SetAt_::_1_::catch$0 @ 0x18013AF93
 * Callers:
 *     <none>
 * Callees:
 *     _CxxThrowException_0 @ 0x180074C37 (_CxxThrowException_0.c)
 *     ?RemoveAtPos@?$CAtlMap@PEAVResourceConsumer@@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@VResourceConsumerTraits@@V?$CElementTraits@PEAV?$CAtlList@U_ResourceInfo@@VResourceInfoTraits@@@ATL@@@3@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x18013ADC8 (-RemoveAtPos@-$CAtlMap@PEAVResourceConsumer@@PEAV-$CAtlList@U_ResourceInfo@@VResourceInfoTraits@.c)
 */
