/*
 * XREFs of ??_GTelephonyControllerCallInstance@@MEAAPEAXI@Z @ 0x180143A80
 * Callers:
 *     ??_ETelephonyControllerCallInstance@@O7EAAPEAXI@Z @ 0x180075BE0 (--_ETelephonyControllerCallInstance@@O7EAAPEAXI@Z.c)
 * Callees:
