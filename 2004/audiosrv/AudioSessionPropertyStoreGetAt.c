/*
 * XREFs of AudioSessionPropertyStoreGetAt @ 0x1800CD8A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionPropertyStoreGetAt(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v6[1], v7, (struct _TP_TIMER *)L"AudioSessionPropertyStoreGetAt");
  ...
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionPropertyStoreGetAt", 2433, v8);
