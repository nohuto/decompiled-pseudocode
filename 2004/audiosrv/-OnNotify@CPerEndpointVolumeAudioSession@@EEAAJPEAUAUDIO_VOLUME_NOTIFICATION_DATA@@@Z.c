/*
 * XREFs of ?OnNotify@CPerEndpointVolumeAudioSession@@EEAAJPEAUAUDIO_VOLUME_NOTIFICATION_DATA@@@Z @ 0x1800C9FA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RecalculateSessionVolume@CAudioSession@@UEAAXW4AudioVolumeChangeType@@PEBU_GUID@@K_NPEA_J@Z @ 0x180046ED0 (-RecalculateSessionVolume@CAudioSession@@UEAAXW4AudioVolumeChangeType@@PEBU_GUID@@K_NPEA_J@Z.c)
 ...
 *     WPP_SF_qdgg @ 0x1800C3164 (WPP_SF_qdgg.c)
 *     WPP_SF_q_guid__guid_ @ 0x1800CBF74 (WPP_SF_q_guid__guid_.c)
 *     WPP_SF_qdd @ 0x1800CBFE8 (WPP_SF_qdd.c)
 *     WPP_SF_qgg_HEX__HEX_ @ 0x1800CC048 (WPP_SF_qgg_HEX__HEX_.c)
 */
  ...
  if ( v9 )
  {
    ...
    if ( v3 || v38 || v4 )
    {
      if ( v13 != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)v13 + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)v13 + 2), 0x59u, (__int64)&WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids);
        v13 = WPP_GLOBAL_Control;
      }
      if ( v4 )
      {
        ...
        if ( v13 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v13 + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)v13 + 2), 0x5Au, (__int64)&WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids);
        }
      ...
      if ( v38 )
      {
        if ( v13 != (CAudioSessionManager *)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)v13 + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)v13 + 2), 0x5Bu, (__int64)&WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids);
        }
        EnterCriticalSection(v10);
    ...
    operator delete(v39);
         ...
         && *((_BYTE *)v7 + 25) >= 4u )
  {
    WPP_SF_q(*((_QWORD *)v7 + 2), 0x54u, (__int64)&WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, (char *)this - 984);
  }
  return 0LL;
}
