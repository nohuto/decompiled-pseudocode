/*
 * XREFs of ??$MakeAndInitialize@VRemapPolicyRule@@UIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Details@WRL@Microsoft@@YAJPEAPEAUIPolicyRule@@AEAPEAUIAudioProcess@@AEAPEAU_DynamicRoutingRule@@@Z @ 0x180111464
 * Callers:
  ...
  *a1 = 0LL;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)v7 = &RemapPolicyRule::`vftable';
    v8 = ((__int64 (__fastcall *)(PolicyRule *, _QWORD, _QWORD))RemapPolicyRule::RuntimeClassInitialize)(v7, *a2, *a3);
    if ( v8 >= 0 )
