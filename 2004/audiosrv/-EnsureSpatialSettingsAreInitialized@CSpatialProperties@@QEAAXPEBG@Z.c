/*
 * XREFs of ?EnsureSpatialSettingsAreInitialized@CSpatialProperties@@QEAAXPEBG@Z @ 0x18005BEB8
 * Callers:
  ...
  if ( !LOBYTE(lpCriticalSection[1].SpinCount) )
  {
           ...
           &v10) < 0 )
    {
      ...
      *(GUID *)((char *)&lpCriticalSection[2].SpinCount + 4) = v17;
      ...
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_18019D478, 16LL) )
        {
          v12 = v9;
          v13 = v11;
          v14 = v10;
