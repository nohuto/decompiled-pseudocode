/*
 * XREFs of ?GetPropertyValue@CPolicyConfig@@UEAAJPEBGHAEBU_tagpropertykey@@PEAUtagPROPVARIANT@@@Z @ 0x1800D7E90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    AudSrvTraceLoggingErrorHelper("CPolicyConfig::GetPropertyValue", 2345, PropertyStoreProperty);
    goto LABEL_7;
  }
