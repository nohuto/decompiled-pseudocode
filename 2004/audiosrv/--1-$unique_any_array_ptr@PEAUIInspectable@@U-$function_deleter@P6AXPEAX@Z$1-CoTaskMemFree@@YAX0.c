/*
 * XREFs of ??1?$unique_any_array_ptr@PEAUIInspectable@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@Ucom_unknown_deleter@details@3@@wil@@QEAA@XZ @ 0x18013501C
 * Callers:
 *     _ScanForInstalledSpatialAudioSubtypeAppServices_::_1_::dtor$11 @ 0x18007CCE0 (_ScanForInstalledSpatialAudioSubtypeAppServices_--_1_--dtor$11.c)
 * Callees:
 *     <none>
 */
