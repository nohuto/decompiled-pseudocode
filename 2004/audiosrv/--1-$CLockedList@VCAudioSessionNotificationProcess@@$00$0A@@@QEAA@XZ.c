/*
 * XREFs of ??1?$CLockedList@VCAudioSessionNotificationProcess@@$00$0A@@@QEAA@XZ @ 0x1800CE5A0
 * Callers:
 *     _CAudioSessionManager::_CAudioSessionManager_::_1_::dtor$5 @ 0x1800CEA78 (_CAudioSessionManager--_CAudioSessionManager_--_1_--dtor$5.c)
 * Callees:
