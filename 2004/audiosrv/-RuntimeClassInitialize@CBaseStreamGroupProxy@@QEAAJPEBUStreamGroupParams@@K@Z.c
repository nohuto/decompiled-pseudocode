/*
 * XREFs of ?RuntimeClassInitialize@CBaseStreamGroupProxy@@QEAAJPEBUStreamGroupParams@@K@Z @ 0x1800E6ED0
 * Callers:
 ...
 *     ??0CResourcePriorityTracker@@QEAA@K@Z @ 0x1800E3EE0 (--0CResourcePriorityTracker@@QEAA@K@Z.c)
 */
