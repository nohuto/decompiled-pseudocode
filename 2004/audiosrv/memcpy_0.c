 ...
 *     ?GetDeviceSettings@SpatialAudioDevicePropertyReader@@UEAAJPEAUSpatialAudioSettings@@PEAUSpatialAudioEncoderDescriptor@@I@Z @ 0x180045730 (-GetDeviceSettings@SpatialAudioDevicePropertyReader@@UEAAJPEAUSpatialAudioSettings@@PEAUSpatialA.c)
 ...
 *     s_winmmGetPnpInfo @ 0x1800505A0 (s_winmmGetPnpInfo.c)
 ...
 *     ?CopyDictionaryData@SpatialAudioMetadataDictionaryData@@UEAAJPEAEI@Z @ 0x18012CAB0 (-CopyDictionaryData@SpatialAudioMetadataDictionaryData@@UEAAJPEAEI@Z.c)
 *     ?CopyDictionaryData@SpatialAudioMetadataDictionary@@UEAAJPEAEI@Z @ 0x18012D490 (-CopyDictionaryData@SpatialAudioMetadataDictionary@@UEAAJPEAEI@Z.c)
