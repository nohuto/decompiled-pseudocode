/*
 * XREFs of ?GetNewestWorkItem@PhoneTopology@@AEAAHPEAVPhoneTopologyWorkItem@@@Z @ 0x18014096C
 * Callers:
 ...
 *     ??4PhoneTopologyWorkItem@@QEAAAEBV0@AEBV0@@Z @ 0x18013F6F8 (--4PhoneTopologyWorkItem@@QEAAAEBV0@AEBV0@@Z.c)
 */
