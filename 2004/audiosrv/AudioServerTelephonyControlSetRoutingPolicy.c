/*
 * XREFs of AudioServerTelephonyControlSetRoutingPolicy @ 0x1800E1CD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioServerTelephonyControlSetRoutingPolicy(__int64 a1, unsigned int a2)
{
  ...
  v5 = ((__int64 (__fastcall *)(struct IUnknown *, _QWORD))g_TelephonyControl->lpVtbl[2].QueryInterface)(
         g_TelephonyControl,
         a2);
