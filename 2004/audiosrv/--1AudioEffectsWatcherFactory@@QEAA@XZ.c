/*
 * XREFs of ??1AudioEffectsWatcherFactory@@QEAA@XZ @ 0x180069ECC
 * Callers:
 *     _dynamic_atexit_destructor_for__TheAudioEffectsWatcherFactory__ @ 0x18007D7D0 (_dynamic_atexit_destructor_for__TheAudioEffectsWatcherFactory__.c)
 * Callees:
...
{
  ATL::CAtlList<IPolicyRule *,ATL::CElementTraits<IPolicyRule *>>::RemoveAll(&qword_18019FF58);
