/*
 * XREFs of ?GetModeEffect@CEndpointCharacteristics@@QEAAJU_GUID@@HW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEAPEAUICompositeSystemEffect@@PEAPEAUIAudioProcessingObject@@PEAPEAUIAudioSystemEffects2@@@Z @ 0x180038064
 * Callers:
        ...
        struct IAudioSystemEffects2 **a7)
{
  ...
  if ( (unsigned int)CEndpointCharacteristics::EndpointConnectorSupportsProcessingModes(this, a4) )
  {
    ...
    {
      v15 = *a2;
      v12 = CEndpointCharacteristics::IsConnectorModeSupported(
              this,
              (enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001)v8,
              &v15) != 0;
      v15 = *a2;
      v13 = gsl::span<SystemEffectDescriptor,-1>::operator[]((unsigned __int64 *)this + 209, v8);
