/*
 * XREFs of ??1CVADServer@@QEAA@XZ @ 0x1800DB5F4
 * Callers:
 *     _ATL::CComObject_CVADServer_::CreateInstance_::_1_::dtor$1 @ 0x180077290 (_ATL--CComObject_CVADServer_--CreateInstance_--_1_--dtor$1.c)
 * Callees:
