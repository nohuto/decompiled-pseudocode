/*
 * XREFs of ?DoReacquireSaDeviceResource@CConstraintModelResourceManager@@AEAAJKPEAUReacquireResourceHandleInfo@@@Z @ 0x1800F38F8
 * Callers:
 ...
 *     ?SetAt@?$CAtlList@UResourceHandleInfo@@V?$CElementTraits@UResourceHandleInfo@@@ATL@@@ATL@@QEAAXPEAU__POSITION@@AEBUResourceHandleInfo@@@Z @ 0x1800F5B10 (-SetAt@-$CAtlList@UResourceHandleInfo@@V-$CElementTraits@UResourceHandleInfo@@@ATL@@@ATL@@QEAAXP.c)
 *     WPP_SF_ddI @ 0x1800F6450 (WPP_SF_ddI.c)
 *     WPP_SF_ddID @ 0x1800F64BC (WPP_SF_ddID.c)
        ...
        unsigned __int64 **a3)
{
  ...
  struct _ResourceInfo *v28; // [rsp+50h] [rbp-B0h] BYREF
  ...
  LPCRITICAL_SECTION v40; // [rsp+C0h] [rbp-40h] BYREF
  char v41[256]; // [rsp+CCh] [rbp-34h] BYREF
  __int128 v42; // [rsp+1CCh] [rbp+CCh]
  int v43; // [rsp+1E0h] [rbp+E0h]
  unsigned int v44; // [rsp+588h] [rbp+488h]
      ...
      if ( StreamResourceConsumption >= 0 && v27[0] )
      {
        ...
        if ( v6 < 0 )
        {
          ATL::CComCritSecLock<ATL::CComAutoCriticalSection>::CComCritSecLock<ATL::CComAutoCriticalSection>(
            (__int64)&v31,
            v31);
          ATL::CAtlList<ResourceHandleInfo,ATL::CElementTraits<ResourceHandleInfo>>::RemoveAt((__int64 *)v33, v13);
          if ( v32 )
        ...
        else
        {
          ...
          ATL::CComCritSecLock<ATL::CComAutoCriticalSection>::CComCritSecLock<ATL::CComAutoCriticalSection>(
            (__int64)&v33,
            v31);
          ATL::CAtlList<ResourceHandleInfo,ATL::CElementTraits<ResourceHandleInfo>>::SetAt(v22, v13, &v40);
          if ( v34 )
