/*
 * XREFs of s_pbmLaunchBackgroundTask @ 0x1800F9490
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmLaunchBackgroundTask(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  else if ( g_PolicyManager )
  {
    ...
    v8 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64 *))(*(_QWORD *)g_PolicyManager + 32LL))(
           ...
           &v12);
    if ( v8 >= 0 )
      v8 = (*(__int64 (__fastcall **)(struct IAudioPolicyManager *, __int64, __int64, __int64, __int64))(*(_QWORD *)g_PolicyManager + 128LL))(
             g_PolicyManager,
             v12,
             a2,
             a3,
