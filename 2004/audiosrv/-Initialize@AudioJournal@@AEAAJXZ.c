/*
 * XREFs of ?Initialize@AudioJournal@@AEAAJXZ @ 0x1800538C4
 * Callers:
 *     ??0AudioJournal@@QEAA@XZ @ 0x180053C88 (--0AudioJournal@@QEAA@XZ.c)
 * Callees:
 ...
 *     ?ResetData@AudioJournal@@AEAAX_N@Z @ 0x1800F71DC (-ResetData@AudioJournal@@AEAAX_N@Z.c)
 *     ?Return_NtStatus@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z @ 0x1800F72F0 (-Return_NtStatus@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z.c)
