/*
 * XREFs of ?_Push_back_internal@?$deque@V?$shared_ptr@VWorkItem@CWorkFifo@@@std@@V?$allocator@V?$shared_ptr@VWorkItem@CWorkFifo@@@std@@@2@@std@@AEAAXAEBV?$shared_ptr@VWorkItem@CWorkFifo@@@2@@Z @ 0x18010A030
 * Callers:
...
__int64 __fastcall std::deque<std::shared_ptr<CWorkFifo::WorkItem>>::_Push_back_internal(_QWORD *a1, _QWORD *a2)
{
