/*
 * XREFs of AudioSessionGetAllVolumes @ 0x1800CCE60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionGetAllVolumes(__int64 *a1, unsigned int a2, __int64 a3)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v6[1], v7, (struct _TP_TIMER *)L"AudioSessionGetAllVolumes");
  v8 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64))(*(_QWORD *)v3 + 352LL))(v3, a2, a3);
  v9 = v8;
  if ( v8 < 0 )
    AudSrvTraceLoggingErrorHelper("AudioSessionGetAllVolumes", 2306, v8);
