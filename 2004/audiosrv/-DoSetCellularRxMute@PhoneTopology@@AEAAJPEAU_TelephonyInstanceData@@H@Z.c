/*
 * XREFs of ?DoSetCellularRxMute@PhoneTopology@@AEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x18013FC24
 * Callers:
 *     ?Process@CallHoldWorkItem@@UEAAXPEAVPhoneTopology@@@Z @ 0x180140D50 (-Process@CallHoldWorkItem@@UEAAXPEAVPhoneTopology@@@Z.c)
 * Callees:
