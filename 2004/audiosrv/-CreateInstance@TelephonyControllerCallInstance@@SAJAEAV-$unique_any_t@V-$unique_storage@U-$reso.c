 ...
 *     ?Initialize@TelephonyControllerCallInstance@@IEAAJAEAV?$unique_any_t@V?$unique_storage@U?$resource_policy@_KP6AX_K@Z$1?ReleaseAudioResourceHandle@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@_K_K$0A@$$T@details@wil@@@details@wil@@@wil@@PEAUIKsControl@@PEAU_TelephonyInstanceData@@@Z @ 0x180143E14 (-Initialize@TelephonyControllerCallInstance@@IEAAJAEAV-$unique_any_t@V-$unique_storage@U-$resour.c)
 */
