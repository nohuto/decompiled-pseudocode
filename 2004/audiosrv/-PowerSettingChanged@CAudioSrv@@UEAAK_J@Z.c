/*
 * XREFs of ?PowerSettingChanged@CAudioSrv@@UEAAK_J@Z @ 0x180068390
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSrv::PowerSettingChanged(CAudioSrv *this, UUID *Uuid1)
{
  ...
  if ( Uuid1[1].Data1 == 4 && UuidEqual(Uuid1, &GUID_ACDC_POWER_SOURCE, &Status) )
  {
    ...
    {
      WPP_SF_d(*((_QWORD *)WPP_GLOBAL_Control + 2), 31LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids, v6);
    }
    if ( v6 )
    {
      if ( v6 - 1 <= 1 )
  ...
  else
  {
    ...
    if ( !v9 && Uuid1[1].Data1 == 4 )
    {
      ...
      if ( *v11 > 4u )
      {
        ...
        v16 = 4LL;
        v15 = &v12;
        tlgWriteTransfer_EtwEventWriteTransfer((__int64)v11, byte_18016711C, 0LL, 0LL, 3, (__int64)v14);
      }
