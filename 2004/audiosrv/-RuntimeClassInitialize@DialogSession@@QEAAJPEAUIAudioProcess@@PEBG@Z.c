/*
 * XREFs of ?RuntimeClassInitialize@DialogSession@@QEAAJPEAUIAudioProcess@@PEBG@Z @ 0x1800F7DB0
 * Callers:
 ...
 *     ?Start@CVirtualAudioStream@@QEAAXXZ @ 0x180072804 (-Start@CVirtualAudioStream@@QEAAXXZ.c)
