/*
 * XREFs of ?CreateStream@CVADServer@@UEAAJPEAUIAudioProcess@@W4SYSTEM_AUDIO_STREAM_TYPE@@_J2PEBGPEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x1800319A0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v16 )
  {
    ...
    *((_BYTE *)v16 + 456) = 0;
    ...
    if ( !a3 )
    {
      ...
      if ( qword_18019FB20 )
      {
        _InterlockedIncrement((volatile signed __int32 *)qword_18019FB20 + 2);
        v18 = qword_18019FB20;
      }
...
LABEL_34:
            ...
            if ( (unsigned int)(a3 - 1) <= 1 )
              v31 = dword_180161550[v29];
            else
              v31 = dword_1801614F0[v29];
            v32 = 0;
            if ( v30 )
              v32 = 16;
