/*
 * XREFs of AudioServerGetSharedModeEnginePeriod @ 0x1800DFB00
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a9)
{
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(v51, v15[1], v16, (struct _TP_TIMER *)L"AudioServerGetSharedModeEnginePeriod");
