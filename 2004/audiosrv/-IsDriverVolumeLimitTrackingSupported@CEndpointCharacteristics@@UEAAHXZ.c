/*
 * XREFs of ?IsDriverVolumeLimitTrackingSupported@CEndpointCharacteristics@@UEAAHXZ @ 0x18011E590
 * Callers:
 *     <none>
 * Callees:
...
LABEL_4:
    ...
    && (*(int (__fastcall **)(LPVOID, LPVOID, __int64 *))(*(_QWORD *)v15 + 40LL))(v15, pv, &v14) >= 0 )
  {
    ...
    {
      HIDWORD(v17) = v19;
      *(GUID *)v16 = GUID_45ffaaa0_6e1b_11d0_bcf2_444553540000;
      v18 = 0;
      *(_DWORD *)&v16[16] = 57;
      LODWORD(v17) = 512;
      LODWORD(ppv) = 4;
