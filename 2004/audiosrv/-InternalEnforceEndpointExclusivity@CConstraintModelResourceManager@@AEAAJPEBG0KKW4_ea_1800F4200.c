/*
 * XREFs of ?InternalEnforceEndpointExclusivity@CConstraintModelResourceManager@@AEAAJPEBG0KKW4AUDIO_DIRECTION@@HK@Z @ 0x1800F4200
 * Callers:
...
LABEL_41:
    ...
    while ( 1 )
    {
      ...
      for ( i = 0LL; i < v24[1]; ++i )
      {
        ...
        if ( ExclusiveEndpointInfo::CompareTo<ExclusiveEndpointInfo>((__int64)v52, (unsigned __int64)v12, v21, v22) )
        {
          v23 = 1;
          v35 = 1;
          v45 = v12;
...
LABEL_42:
  if ( v13 != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)v13 + 25) >= 4u )
  {
    WPP_SF_d(*((_QWORD *)v13 + 2), 0x1Cu, (__int64)&WPP_4eb83dabec2331805ae9d1ae37e3a182_Traceguids, v11);
  }
