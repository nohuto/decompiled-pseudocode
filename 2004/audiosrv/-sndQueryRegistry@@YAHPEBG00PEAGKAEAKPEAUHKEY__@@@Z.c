/*
 * XREFs of ?sndQueryRegistry@@YAHPEBG00PEAGKAEAKPEAUHKEY__@@@Z @ 0x18013398C
 * Callers:
 ...
 *     ?StringCbCatW@@YAJPEAG_KPEBG@Z @ 0x1800DE250 (-StringCbCatW@@YAJPEAG_KPEBG@Z.c)
 *     ?GetSoundRegistryPath@@YAHPEAG_KPEBG22@Z @ 0x1801335BC (-GetSoundRegistryPath@@YAHPEAG_KPEBG22@Z.c)
 *     ?sndRegQueryUserValue@@YAHPEBG0KPEAG@Z @ 0x180133B50 (-sndRegQueryUserValue@@YAHPEBG0KPEAG@Z.c)
 *     ?sndRegQueryValue@@YAHPEAUHKEY__@@PEBG1KPEAG@Z @ 0x180133BD8 (-sndRegQueryValue@@YAHPEAUHKEY__@@PEBG1KPEAG@Z.c)
 */
