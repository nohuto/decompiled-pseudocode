/*
 * XREFs of ?InitAdapterInformation@EndpointDevice@@AEAAJXZ @ 0x18005762C
 * Callers:
...
__int64 __fastcall EndpointDevice::InitAdapterInformation(GUID *this)
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    v16 = *(_QWORD *)&v12->Data1 - *((_QWORD *)&unk_18019D240 + 3 * (int)i);
    if ( *(_QWORD *)&v12->Data1 == *((_QWORD *)&unk_18019D240 + 3 * (int)i) )
      v16 = *(_QWORD *)v12->Data4 - *((_QWORD *)&unk_18019D240 + 3 * (int)i + 1);
    if ( !v16 )
      break;
  }
  v17 = (_WORD *)*((_QWORD *)&unk_18019D240 + 3 * (int)i + 2);
  v18 = -1LL;
  v19 = -1LL;
  do
    ++v19;
