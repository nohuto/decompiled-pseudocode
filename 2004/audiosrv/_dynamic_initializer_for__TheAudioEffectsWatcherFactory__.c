/*
 * XREFs of _dynamic_initializer_for__TheAudioEffectsWatcherFactory__ @ 0x180001990
 * Callers:
 *     <none>
 * Callees:
 *     ??0AudioEffectsWatcherFactory@@QEAA@XZ @ 0x180054AA0 (--0AudioEffectsWatcherFactory@@QEAA@XZ.c)
 */
