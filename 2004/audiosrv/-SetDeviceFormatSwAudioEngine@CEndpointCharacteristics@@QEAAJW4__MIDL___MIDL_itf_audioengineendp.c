/*
 * XREFs of ?SetDeviceFormatSwAudioEngine@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@@Z @ 0x180049200
 * Callers:
      ...
      else
      {
        ...
        else
        {
          ...
          if ( v12 >= 0 )
          {
            ...
            DeviceFormatAndSpatialSettings = 0;
LABEL_16:
            wil::details::lambda_call__lambda_00b803850aab493b48638f22b09b2a64___::_lambda_call__lambda_00b803850aab493b48638f22b09b2a64___(v27);
            goto LABEL_17;
          }
          v19 = 8549LL;
        }
