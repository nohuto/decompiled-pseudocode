/*
 * XREFs of _CAudioSession::ParseStreamSwitchId_::_1_::dtor$3 @ 0x1800CA9D6
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall CAudioSession::ParseStreamSwitchId_::_1_::dtor_3(__int64 a1, __int64 a2)
{
