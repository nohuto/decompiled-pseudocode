/*
 * XREFs of ?GetVolumeStrip@CPerEndpointVolumeAudioSession@@AEAAJPEAPEAUIVolumeStrip@@@Z @ 0x1800C9148
 * Callers:
 ...
 *     ?Reused@CPerEndpointVolumeAudioSession@@EEAAJXZ @ 0x1800CB210 (-Reused@CPerEndpointVolumeAudioSession@@EEAAJXZ.c)
