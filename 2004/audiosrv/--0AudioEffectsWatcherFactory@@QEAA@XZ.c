/*
 * XREFs of ??0AudioEffectsWatcherFactory@@QEAA@XZ @ 0x180054AA0
 * Callers:
 *     _dynamic_initializer_for__TheAudioEffectsWatcherFactory__ @ 0x180001990 (_dynamic_initializer_for__TheAudioEffectsWatcherFactory__.c)
 * Callees:
 *     <none>
 */
