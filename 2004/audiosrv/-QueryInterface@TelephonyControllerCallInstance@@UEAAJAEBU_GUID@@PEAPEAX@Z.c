/*
 * XREFs of ?QueryInterface@TelephonyControllerCallInstance@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180143FB0
 * Callers:
 *     ?QueryInterface@TelephonyControllerCallInstance@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180075BF0 (-QueryInterface@TelephonyControllerCallInstance@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
