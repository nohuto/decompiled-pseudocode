/*
 * XREFs of ??$LogAecEffectPolicy@$07@@YAXAEBU_AEC_POLICY_RESULTS@@PEBGU_GUID@@W4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@@Z @ 0x180122998
 * Callers:
...
void __fastcall LogAecEffectPolicy<8>(__int64 a1, __int64 a2)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_18019D478, 8LL) )
    {
      v8 = v6[16];
      v9 = v6[15];
      v22 = v6 + 11;
