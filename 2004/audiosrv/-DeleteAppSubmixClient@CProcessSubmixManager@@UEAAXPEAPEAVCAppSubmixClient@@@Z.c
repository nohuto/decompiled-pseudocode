/*
 * XREFs of ?DeleteAppSubmixClient@CProcessSubmixManager@@UEAAXPEAPEAVCAppSubmixClient@@@Z @ 0x1800F1470
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CProcessSubmixManager::DeleteAppSubmixClient(CProcessSubmixManager *this, struct CAppSubmixClient **a2)
{
  ...
  struct CAppSubmixClient **v10; // [rsp+58h] [rbp+10h]
  ...
  std::_Destroy_range<std::allocator<std::unique_ptr<CAppSubmixClient>>>(v7, *(__int64 ***)(v5 + 56));
  *(_QWORD *)(v5 + 56) = v7;
