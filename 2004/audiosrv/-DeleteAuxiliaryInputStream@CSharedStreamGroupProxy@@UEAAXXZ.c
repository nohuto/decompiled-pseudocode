/*
 * XREFs of ?DeleteAuxiliaryInputStream@CSharedStreamGroupProxy@@UEAAXXZ @ 0x18004FAA0
 * Callers:
  ...
  if ( *(_QWORD *)(this + 360) )
  {
    ...
    if ( (*(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v4 + 88LL))(v4, &v24) >= 0 )
    {
      ...
      if ( *v6 > 4u )
      {
        ...
        tlgWriteTransfer_EtwEventWriteTransfer((_DWORD)v6, (unsigned int)&unk_180168C78, 0, 0, 3, (__int64)v28);
      }
    }
