/*
 * XREFs of ?LoadEndpointVolumeInformation@CPerEndpointVolumeAudioSession@@AEAAJPEBGPEAUIVolumeStrip@@@Z @ 0x1800C9678
 * Callers:
...
LABEL_25:
    ...
    *((_QWORD *)this + 121) = v23;
    ...
    if ( v25 )
    {
            ...
            do
            {
              ...
              *(float *)(v32 + 4 * v31) = v33;
                ...
                && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
              {
                ...
                v35[4] = v33;
                WPP_SF_dg(v34, 0x26u, (__int64)&WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, v31);
              }
      ...
      if ( this != (CPerEndpointVolumeAudioSession *)-808LL )
