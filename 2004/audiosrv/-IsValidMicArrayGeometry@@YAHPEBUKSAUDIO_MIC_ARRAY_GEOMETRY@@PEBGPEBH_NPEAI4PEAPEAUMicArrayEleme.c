/*
 * XREFs of ?IsValidMicArrayGeometry@@YAHPEBUKSAUDIO_MIC_ARRAY_GEOMETRY@@PEBGPEBH_NPEAI4PEAPEAUMicArrayElementErrorDetails@@@Z @ 0x180133C28
 * Callers:
        ...
        unsigned int *a5)
{
  unsigned int v5; // ebx
  const char *v7; // r8
  __int64 usNumberOfMicrophones; // r10
  int v9; // eax
  int v10; // ecx
  int v11; // eax
  int v12; // edx
...
LABEL_3:
  ...
  do
  {
    ...
    if ( v31 || *(p_wHorizontalAngle - 2) )
      v25 = 0;
    if ( v26 < (unsigned __int16)usNumberOfMicrophones )
    {
      p_wYCoord = &a1->KsMicCoord[v26].wYCoord;
      v33 = (unsigned __int16)(usNumberOfMicrophones - v26);
