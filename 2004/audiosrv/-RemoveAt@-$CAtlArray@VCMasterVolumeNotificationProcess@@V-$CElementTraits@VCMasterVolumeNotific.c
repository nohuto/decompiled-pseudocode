/*
 * XREFs of ?RemoveAt@?$CAtlArray@VCMasterVolumeNotificationProcess@@V?$CElementTraits@VCMasterVolumeNotificationProcess@@@ATL@@@ATL@@QEAAX_K0@Z @ 0x18005316C
 * Callers:
 ...
 *     sub_18009DB2C @ 0x18009DB2C (sub_18009DB2C.c)
