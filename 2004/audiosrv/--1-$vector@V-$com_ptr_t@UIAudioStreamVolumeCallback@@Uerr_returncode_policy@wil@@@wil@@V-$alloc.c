/*
 * XREFs of ??1?$vector@V?$com_ptr_t@UIAudioStreamVolumeCallback@@Uerr_returncode_policy@wil@@@wil@@V?$allocator@V?$com_ptr_t@UIAudioStreamVolumeCallback@@Uerr_returncode_policy@wil@@@wil@@@std@@@std@@QEAA@XZ @ 0x1800D24E8
 * Callers:
 *     _CEndpointCharacteristicsCache::PopulateEndpointCharacteristicsCache_::_1_::dtor$1 @ 0x18007B1B2 (_CEndpointCharacteristicsCache--PopulateEndpointCharacteristicsCache_--_1_--dtor$1.c)
 *     _CAudioStream::CAudioStream_::_1_::dtor$13 @ 0x18007BDC0 (_CAudioStream--CAudioStream_--_1_--dtor$13.c)
 * Callees:
