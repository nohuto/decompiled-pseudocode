 ...
 *     <none>
 * Callees:
 *     ?StaticInitialize@?$Module@$00VServiceModule@Internal@Windows@@@WRL@Microsoft@@CA_NXZ @ 0x180054924 (-StaticInitialize@-$Module@$00VServiceModule@Internal@Windows@@@WRL@Microsoft@@CA_NXZ.c)
 */
