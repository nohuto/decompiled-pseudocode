/*
 * XREFs of _DynamicAudioEndpointManager::OnRuleOperation_::_1_::dtor$3 @ 0x1801132E2
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DynamicAudioEndpointManager::OnRuleOperation_::_1_::dtor_3(__int64 a1, __int64 a2)
{
