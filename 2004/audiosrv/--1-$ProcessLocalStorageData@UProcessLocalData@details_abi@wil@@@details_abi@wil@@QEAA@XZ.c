/*
 * XREFs of ??1?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@QEAA@XZ @ 0x1800B5354
 * Callers:
 ...
 *     ?Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ @ 0x1800B550C (-Clear@ThreadLocalData@details_abi@wil@@QEAAXXZ.c)
 */
