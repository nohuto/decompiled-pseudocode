/*
 * XREFs of ?SetMasterVolumeLevelScalar@CVolumeControlBase@@UEAAJMPEBU_GUID@@PEAH@Z @ 0x1800C22E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qg_guid_ @ 0x1800C32B4 (WPP_SF_qg_guid_.c)
 *     WPP_SF_qggg @ 0x1800C3388 (WPP_SF_qggg.c)
 */
