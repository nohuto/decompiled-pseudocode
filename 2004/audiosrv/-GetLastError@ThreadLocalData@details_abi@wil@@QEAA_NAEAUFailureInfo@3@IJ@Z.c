/*
 * XREFs of ?GetLastError@ThreadLocalData@details_abi@wil@@QEAA_NAEAUFailureInfo@3@IJ@Z @ 0x1800B9B44
 * Callers:
 ...
 * Callees:
 *     ?Get@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEAUFailureInfo@3@@Z @ 0x1800B96C0 (-Get@ThreadLocalFailureInfo@details_abi@wil@@QEAAXAEAUFailureInfo@3@@Z.c)
 */
