/*
 * XREFs of ?SetMute@CMuteControlBase@@UEAAJHPEBU_GUID@@PEAH@Z @ 0x1800BF210
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qd_guid_ @ 0x1800BF6E0 (WPP_SF_qd_guid_.c)
 */
...
__int64 __fastcall CMuteControlBase::SetMute(CMuteControlBase *this, unsigned int a2, const struct _GUID *a3, int *a4)
{
  ...
  v11 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                  ...
                  + 1);
  if ( *v11 > 4u && tlgKeywordOn((__int64)v11, 0x400000000000LL) )
  {
  ...
  v15 = (*(__int64 (__fastcall **)(CMuteControlBase *, _QWORD))(*(_QWORD *)this + 80LL))(this, a2);
  v16 = v15;
  if ( v15 < 0 )
  {
