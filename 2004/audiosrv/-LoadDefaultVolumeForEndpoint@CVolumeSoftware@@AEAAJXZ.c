/*
 * XREFs of ?LoadDefaultVolumeForEndpoint@CVolumeSoftware@@AEAAJXZ @ 0x1800C0960
 * Callers:
 ...
 *     WPP_SF_qg @ 0x1800C3258 (WPP_SF_qg.c)
 */
...
__int64 __fastcall CVolumeSoftware::LoadDefaultVolumeForEndpoint(CVolumeSoftware *this)
{
  ...
  ATL::CAtlException *v15; // [rsp+58h] [rbp-80h] BYREF
  _BYTE v16[64]; // [rsp+60h] [rbp-78h] BYREF
        ...
        if ( LOWORD(pvar[0]) == 19 )
        {
          ...
          for ( i = 0; i < *((_DWORD *)v1 + 31); ++i )
          {
            ...
            if ( *((_DWORD *)v1 + 74) == 4 )
              ...
              v8 = 0.0;
            CVolumeUnit::SetDBRange((__int64)v16, v7, -96.0, v8, SLODWORD(FLOAT_1_5), *(__int64 *)&DOUBLE_1_75);
