/*
 * XREFs of ?OnStopStream@AudioJournal@@QEAAJJPEAVCEndpointCharacteristics@@N@Z @ 0x1800F6FF8
 * Callers:
 ...
 *     ?AddError@AudioJournal@@AEAAXJPEAUErrorInfo@1@@Z @ 0x1800F6A54 (-AddError@AudioJournal@@AEAAXJPEAUErrorInfo@1@@Z.c)
        ...
        double a4)
{
  ...
  struct AudioJournal::StreamInfo *v15[2]; // [rsp+20h] [rbp-20h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+48h] [rbp+8h]
  AudioJournal *v17; // [rsp+50h] [rbp+10h] BYREF

  v17 = this;
  EnterCriticalSection(&CriticalSection);
  v15[1] = (struct AudioJournal::StreamInfo *)&CriticalSection;
  if ( g_AudioJournal )
  {
