/*
 * XREFs of ?Initialize@CVADServer@@UEAAJPEAUIAudioProcess@@PEBGW4_AUDCLNT_SHAREMODE@@KPEBUtWAVEFORMATEX@@PEBU_GUID@@PEAUVadServerSettings@@PEAPEAGPEAUIProcessSubmixProxy@@@Z @ 0x180019920
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_DDd @ 0x1800E1F04 (WPP_SF_DDd.c)
 ...
 *     ?UseAutoConvertPCMForLoopbackStreams@CEndpointCharacteristics@@QEAA_NXZ @ 0x180120864 (-UseAutoConvertPCMForLoopbackStreams@CEndpointCharacteristics@@QEAA_NXZ.c)
 */
...
LABEL_134:
      ...
      JUMPOUT(0x1800861DBLL);
    }
LABEL_242:
    JUMPOUT(0x1800861E2LL);
  }
  if ( a4 > 1 )
  {
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
...
LABEL_70:
  ...
  *((_DWORD *)v12 + 46) = 1;
  ...
  pvar[0] = &g_csVadList;
  v56 = g_VADServerList;
  i = (__int64 *)qword_18019EA00;
  if ( !qword_18019EA00 )
  {
    if ( dword_18019EA08 )
    {
      if ( dword_18019EA08 == 10LL )
        v58 = 0x1999999999999999LL;
      else
        v58 = 0xFFFFFFFFFFFFFFFFuLL / (unsigned int)dword_18019EA08;
      if ( v58 < 0x18 )
        goto LABEL_217;
      v59 = 24LL * (unsigned int)dword_18019EA08;
    }
    else
    {
      v59 = 0LL;
    ...
    if ( (unsigned __int64)~v59 >= 8 )
    {
      ...
      {
        *v60 = qword_18019E9F8;
        qword_18019E9F8 = (__int64)v60;
        v61 = &v60[3 * (unsigned int)(dword_18019EA08 - 1) + 1];
        v62 = dword_18019EA08 - 1;
        for ( i = (__int64 *)qword_18019EA00; v62 >= 0; --v62 )
        {
          *v61 = (__int64)i;
          i = v61;
          qword_18019EA00 = (__int64)v61;
          v61 -= 3;
        }
        goto LABEL_91;
      }
...
LABEL_230:
  ...
  v68 = (const BYTE *)Src;
  if ( Src == &unk_1801A00A8 )
  {
    v69 = L"Render";
    v70 = 600;
  }
  else if ( Src == &unk_1801A0300 )
  {
    v69 = L"Capture";
    v70 = 400;
  }
  ...
  pvar[0] = &hKey;
  LOBYTE(pvar[1]) = 1;
  v71 = RegCreateKeyExW(HKEY_LOCAL_MACHINE, &word_1801A0558, 0, 0LL, 0, 2u, 0LL, &hKey, 0LL);
  v64 = v71;
  if ( v71 > 0 )
