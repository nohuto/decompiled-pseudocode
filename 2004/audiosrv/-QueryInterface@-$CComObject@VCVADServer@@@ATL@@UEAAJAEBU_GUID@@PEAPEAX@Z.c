/*
 * XREFs of ?QueryInterface@?$CComObject@VCVADServer@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800DD700
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATL::CComObject<CVADServer>::QueryInterface(__int64 a1, const struct _GUID *a2, _QWORD *a3)
{
  unsigned int v3; // edi
  _QWORD *v7; // rbx
