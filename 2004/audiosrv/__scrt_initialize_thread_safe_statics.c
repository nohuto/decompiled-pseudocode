/*
 * XREFs of __scrt_initialize_thread_safe_statics @ 0x18006AD50
 * Callers:
 *     <none>
 * Callees:
...
__int64 _scrt_initialize_thread_safe_statics()
{
  ...
  InitializeCriticalSectionAndSpinCount(&stru_18019F1B8, 0xFA0u);
  ...
  {
    hHandle = 0LL;
    ((void (__fastcall *)(void *))ProcAddress)(&unk_18019F1E0);
    qword_18019F1F0 = __ROR8__(v2, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    qword_18019F1F8 = __ROR8__(v4, 64 - ((unsigned __int8)_security_cookie & 0x3Fu)) ^ _security_cookie;
    goto LABEL_7;
  }
