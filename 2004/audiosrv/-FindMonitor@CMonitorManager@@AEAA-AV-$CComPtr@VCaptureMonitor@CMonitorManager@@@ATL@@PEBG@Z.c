/*
 * XREFs of ?FindMonitor@CMonitorManager@@AEAA?AV?$CComPtr@VCaptureMonitor@CMonitorManager@@@ATL@@PEBG@Z @ 0x1800FC7B8
 * Callers:
...
struct IUnknown **__fastcall CMonitorManager::FindMonitor(__int64 a1, struct IUnknown **a2, const wchar_t *a3)
{
  ...
  *a2 = 0LL;
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x52u, (__int64)&WPP_107eeefd23a13a1e42820564321ad14e_Traceguids, a3);
  }
  v7 = *(_QWORD **)(a1 + 112);
  v15 = v7;
  while ( v7 )
