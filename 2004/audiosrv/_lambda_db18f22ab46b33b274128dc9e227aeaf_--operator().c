/*
 * XREFs of _lambda_db18f22ab46b33b274128dc9e227aeaf_::operator() @ 0x18007082C
 * Callers:
 ...
 *     ??1?$unique_any_t@V?$unique_storage@U?$resource_policy@_KP6AX_K@Z$1?ReleaseAudioResourceHandle@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@_K_K$0A@$$T@details@wil@@@details@wil@@@wil@@QEAA@XZ @ 0x1800E4054 (--1-$unique_any_t@V-$unique_storage@U-$resource_policy@_KP6AX_K@Z$1-ReleaseAudioResourceHandle@@.c)
 */
