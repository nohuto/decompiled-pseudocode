/*
 * XREFs of ?ConfigureDtsxHeadphones@SpatialAudioConfigureDevice@@AEAAJPEAUISpatialAudioEncoderProperties@@@Z @ 0x18012A58C
 * Callers:
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( MetadataDictionaryData >= 0 )
    {
      ...
      if ( MetadataDictionaryData >= 0 )
      {
        ...
        MetadataDictionaryData = Create_MetadataDictionaryData(v11, &DTSX_HEADPHONES_METADATA_V1_0, v12, v17);
        v7 = MetadataDictionaryData;
        if ( MetadataDictionaryData >= 0 )
        {
