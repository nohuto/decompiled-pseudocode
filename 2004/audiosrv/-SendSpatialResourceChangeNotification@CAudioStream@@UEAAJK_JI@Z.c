/*
 * XREFs of ?SendSpatialResourceChangeNotification@CAudioStream@@UEAAJK_JI@Z @ 0x1800D34E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioStream::SendSpatialResourceChangeNotification(CAudioStream *this, int a2, __int64 a3, int a4)
{
  ...
  if ( *v8 > 4u )
  {
    ...
    v32 = 8LL;
    v30 = 8LL;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v8, byte_180167E3A, 0LL, 0LL, 6, (__int64)v28);
  }
  v10 = *((_QWORD *)this + 8);
  if ( !v10 )
    return 0LL;
