 ...
 *     ??1Completer@?$static_lazy@VAudioSrvTelemetryProvider@@@details@wil@@QEAA@XZ @ 0x180054960 (--1Completer@-$static_lazy@VAudioSrvTelemetryProvider@@@details@wil@@QEAA@XZ.c)
 ...
 *     ??$query_dispatch@VCAudioSessionManagerProvider@@V1@@default_query_policy@details@wil@@CAJPEAVCAudioSessionManagerProvider@@U?$integral_constant@_N$00@wistd@@PEAPEAV3@@Z @ 0x1800D16B0 (--$query_dispatch@VCAudioSessionManagerProvider@@V1@@default_query_policy@details@wil@@CAJPEAVCA.c)
...
LABEL_295:
    ...
    if ( !a16 )
    {
      v56 = *((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                          65534LL,
      ...
      if ( *(_DWORD *)v56 > 4u )
      {
        ...
        v238 = 0;
        v491 = &v238;
        tlgWriteTransfer_EtwEventWriteTransfer(v56, (unsigned int)&unk_180169CC2, 0, 0, 3, (__int64)v490);
      }
      goto LABEL_56;
    }
...
LABEL_56:
        ...
        if ( v217 )
        {
          ...
          else
          {
            ...
            v382.Data1 = v61;
            v62 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                          65534LL,
                                          _lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_)
                            + 1);
            if ( *v62 > 4u )
        ...
        {
          v60 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                        v56,
                                        _lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_)
                          + 1);
          if ( *v60 > 4u )
          {
            ...
            v245 = 0;
            v503 = &v245;
            tlgWriteTransfer_EtwEventWriteTransfer((_DWORD)v60, (unsigned int)&unk_180169B5D, 0, 0, 3, (__int64)v502);
          }
        }
        v68 = v218;
        if ( v218 )
        {
          ...
          else
          {
            ...
            v381.Data1 = v70;
            v71 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                          65534LL,
                                          _lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_)
                            + 1);
            if ( *v71 > 4u )
        ...
        {
          v69 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                        (__int64)v60,
                                        _lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_)
                          + 1);
          if ( *v69 > 4u )
          {
            ...
            v252 = 0;
            v494 = &v252;
            tlgWriteTransfer_EtwEventWriteTransfer((_DWORD)v69, (unsigned int)&unk_1801699F1, 0, 0, 3, (__int64)v493);
          }
        }
        v77 = Src;
        if ( Src )
        {
          ...
          else
          {
            ...
            v380.Data1 = v79;
            v80 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                          65534LL,
                                          _lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_)
                            + 1);
            if ( *v80 > 4u )
        ...
        else
        {
          ...
          if ( *v78 > 4u )
          {
            ...
            v259 = 0;
            v497 = &v259;
            tlgWriteTransfer_EtwEventWriteTransfer((_DWORD)v78, (unsigned int)&unk_180169880, 0, 0, 3, (__int64)v496);
          }
        }
        v86 = v207;
        if ( v207 )
        {
          ...
          else
          {
            ...
            v379.Data1 = v88;
            v89 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                          65534LL,
                                          _lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_)
                            + 1);
            if ( *v89 > 4u )
        ...
        {
          v87 = (_DWORD *)*((_QWORD *)wil::details::static_lazy<AudioSrvTelemetryProvider>::get(
                                        (__int64)v78,
                                        _lambda_b4cb8953ddd9016186cd5ae31274160b_::_lambda_invoker_cdecl_)
                          + 1);
          if ( *v87 > 4u )
          {
            ...
            v500 = &v266;
            v501 = 4LL;
            tlgWriteTransfer_EtwEventWriteTransfer((_DWORD)v87, (unsigned int)&unk_180169712, 0, 0, 3, (__int64)v499);
          }
        }
        v295 = 0LL;
        v374 = v51;
