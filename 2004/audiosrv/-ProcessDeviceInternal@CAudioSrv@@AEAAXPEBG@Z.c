/*
 * XREFs of ?ProcessDeviceInternal@CAudioSrv@@AEAAXPEBG@Z @ 0x1800BA2B8
 * Callers:
...
LABEL_22:
  ...
  if ( AudioSessionManagerProvider >= 0 )
  {
    ...
    {
      WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 42LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids, a2);
    }
    pv = 0LL;
...
LABEL_46:
  if ( v4 < 0 )
    AudSrvTraceLoggingErrorHelper("CAudioSrv::ProcessDeviceInternal", 1992, v4);
LABEL_48:
  CoTaskMemFree(v20);
  v20 = 0LL;
  if ( v21 )
