/*
 * XREFs of ?PublishCaptureAudioStatus@CCaptureNotifier@@AEAAXXZ @ 0x180065BBC
 * Callers:
...
void __fastcall CCaptureNotifier::PublishCaptureAudioStatus(CCaptureNotifier *this)
{
  ...
  if ( *v8 > 4u )
  {
    ...
    v14 = &v12;
    v15 = 4LL;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v8, byte_180169E62, 0LL, 0LL, 3, (__int64)v13);
  }
}
