/*
 * XREFs of ?SetDeviceFormatAndSpatialSettings@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@PEBUtWAVEFORMATEX@@PEBUSpatialAudioSettings@@@Z @ 0x180048908
 * Callers:
...
LABEL_27:
  ...
  wil::details::lambda_call__lambda_7a4aa03cdf3c75c0f652933ca8714d6d___::_lambda_call__lambda_7a4aa03cdf3c75c0f652933ca8714d6d___(&p_pv);
LABEL_30:
  v14 = pv;
  pv = 0LL;
  if ( v14 )
