/*
 * XREFs of ??1?$unique_ptr@VCPowerReferenceManager@@U?$default_delete@VCPowerReferenceManager@@@std@@@std@@QEAA@XZ @ 0x180069C6C
 * Callers:
 *     _dynamic_atexit_destructor_for__g_powerReferenceManager__ @ 0x18007D890 (_dynamic_atexit_destructor_for__g_powerReferenceManager__.c)
 * Callees:
