/*
 * XREFs of dllmain_crt_process_attach @ 0x18006A248
 * Callers:
 ...
 *     __scrt_dllmain_after_initialize_c @ 0x18006A87C (__scrt_dllmain_after_initialize_c.c)
 *     __scrt_dllmain_before_initialize_c @ 0x18006A8B8 (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_crt @ 0x18006A9DC (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x18006AAE4 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x18006AB84 (__scrt_release_startup_lock.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x18006B144 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x18006B16C (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x18006B190 (__scrt_get_dyn_tls_init_callback.c)
 *     __scrt_fastfail @ 0x18006B1B0 (__scrt_fastfail.c)
 *     _RTC_Initialize @ 0x18006B304 (_RTC_Initialize.c)
 *     _initterm_0 @ 0x18006B546 (_initterm_0.c)
 *     _initterm_e_0 @ 0x18006B552 (_initterm_e_0.c)
