/*
 * XREFs of McTemplateU0pxx_EtwEventWriteTransfer @ 0x180105394
 * Callers:
...
__int64 McTemplateU0pxx_EtwEventWriteTransfer(__int64 a1, __int64 a2, ...)
{
  ...
  va_copy(v8, va2);
  v9 = 8LL;
  return McGenEventWrite_EtwEventWriteTransfer(a1, a2, v11, 4LL, (__int64)v3);
}
