/*
 * XREFs of ?GetPacketSizeConstraints@@YAJPEAUIPropertyStore@@PEAPEAUPacketSizeConstraints@@@Z @ 0x18011D5E4
 * Callers:
...
__int64 __fastcall GetPacketSizeConstraints(struct IPropertyStore *a1, LPVOID **a2)
{
  ...
  *(_OWORD *)v22 = 0LL;
  Src = 0LL;
  if ( dword_1801A0BE0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1801A0BE0);
    if ( dword_1801A0BE0 == -1 )
    {
      xmmword_1801A0AD0 = DEVPKEY_KsAudio_PacketSize_Constraints2;
      dword_1801A0AE0 = 2;
      xmmword_1801A0AE4 = DEVPKEY_KsAudio_PacketSize_Constraints;
      dword_1801A0AF4 = 2;
      Init_thread_footer(&dword_1801A0BE0);
    }
  }
  v6 = &xmmword_1801A0AD0;
  while ( 1 )
  {
    v21 = 0LL;
