/*
 * XREFs of ?DisconnectStreams@CAudioSession@@UEAAJW4StreamDisconnect_StreamType@@@Z @ 0x1800C7EB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::DisconnectStreams(__int64 a1, int a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x66u, (__int64)&WPP_7cf3fc3344fb31d0ce2bf36427d5d6eb_Traceguids, 0LL);
  }
  v6 = *(_QWORD *)(v3 + 88);
  while ( 1 )
  {
