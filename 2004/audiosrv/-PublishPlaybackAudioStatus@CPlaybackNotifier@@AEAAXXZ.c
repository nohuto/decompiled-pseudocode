/*
 * XREFs of ?PublishPlaybackAudioStatus@CPlaybackNotifier@@AEAAXXZ @ 0x180065CA4
 * Callers:
...
void __fastcall CPlaybackNotifier::PublishPlaybackAudioStatus(CPlaybackNotifier *this)
{
  ...
  if ( *v8 > 4u )
  {
    ...
    LODWORD(v11) = v6;
    v14 = 4;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v8, (unsigned __int8 *)&unk_180169E95, 0LL, 0LL, 3, (__int64)v12);
  }
}
