/*
 * XREFs of ??4?$unique_ptr@VCAppSubmixClientContext@@U?$default_delete@VCAppSubmixClientContext@@@std@@@std@@QEAAAEAV01@$$QEAV01@@Z @ 0x1800F1384
 * Callers:
 ...
 *     ??1CAppSubmixClientContext@@QEAA@XZ @ 0x1800F128C (--1CAppSubmixClientContext@@QEAA@XZ.c)
 */
