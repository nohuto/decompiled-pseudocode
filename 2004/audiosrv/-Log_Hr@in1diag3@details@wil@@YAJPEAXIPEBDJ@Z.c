/*
 * XREFs of ?Log_Hr@in1diag3@details@wil@@YAJPEAXIPEBDJ@Z @ 0x1800DD1E4
 * Callers:
 ...
 *     _CPdcActivationClient::AcquirePdcTimerActivation_::_1_::catch$40 @ 0x180076A30 (_CPdcActivationClient--AcquirePdcTimerActivation_--_1_--catch$40.c)
 *     _CSebNotifier::AcquireSebReference_::_1_::catch$16 @ 0x180076AD0 (_CSebNotifier--AcquireSebReference_--_1_--catch$16.c)
 *     _CExclusiveModeListener::OnHoloshellStateChange_::_1_::catch$1 @ 0x18010E371 (_CExclusiveModeListener--OnHoloshellStateChange_--_1_--catch$1.c)
