/*
 * XREFs of ?RpcBeginDialogSession@@YAJPEBGPEAPEAVDialogSession@@@Z @ 0x1800F7CFC
 * Callers:
...
__int64 __fastcall RpcBeginDialogSession(const unsigned __int16 *a1, struct DialogSession **a2)
{
  ...
  struct IAudioProcess *v9; // [rsp+40h] [rbp+18h] BYREF
  struct IAudioProcess *v10; // [rsp+48h] [rbp+20h] BYREF
