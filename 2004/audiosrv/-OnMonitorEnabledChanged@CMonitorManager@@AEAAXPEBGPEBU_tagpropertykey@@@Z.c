/*
 * XREFs of ?OnMonitorEnabledChanged@CMonitorManager@@AEAAXPEBGPEBU_tagpropertykey@@@Z @ 0x1800FE8F0
 * Callers:
        ...
        const struct _tagpropertykey *a3)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x27u, (__int64)&WPP_107eeefd23a13a1e42820564321ad14e_Traceguids, a2);
  }
  ...
  if ( v15 )
  {
    ...
    if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_qS(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, (__int64)&WPP_107eeefd23a13a1e42820564321ad14e_Traceguids);
      v7 = WPP_GLOBAL_Control;
    }
    if ( *((_BYTE *)v15 + 12) )
      goto LABEL_31;
...
LABEL_31:
      if ( v7 != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)v7 + 25) >= 4u )
      {
        WPP_SF_S(*((_QWORD *)v7 + 2), 0x2Au, (__int64)&WPP_107eeefd23a13a1e42820564321ad14e_Traceguids, a2);
      }
...
LABEL_19:
    ...
    if ( !(unsigned int)_o__wcsicmp(v9, pv) )
    {
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x29u, (__int64)&WPP_107eeefd23a13a1e42820564321ad14e_Traceguids);
      }
      CoTaskMemFree(v6);
      v10 = v15;
      goto LABEL_27;
