/*
 * XREFs of ?CreateInstance@AudioDeviceMgr@@SAJPEAUIEndpointNotificationCallback@@PEAPEAUIAudioDeviceMgr@@@Z @ 0x180068584
 * Callers:
 ...
 *     ??0AudioDeviceMgr@@IEAA@XZ @ 0x180056DC8 (--0AudioDeviceMgr@@IEAA@XZ.c)
