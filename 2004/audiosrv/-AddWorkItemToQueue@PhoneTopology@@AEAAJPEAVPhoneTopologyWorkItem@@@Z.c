/*
 * XREFs of ?AddWorkItemToQueue@PhoneTopology@@AEAAJPEAVPhoneTopologyWorkItem@@@Z @ 0x18013F7D4
 * Callers:
 ...
 *     ?SetCellularEnable@PhoneTopology@@UEAAJPEAU_TelephonyInstanceData@@H@Z @ 0x1801411F0 (-SetCellularEnable@PhoneTopology@@UEAAJPEAU_TelephonyInstanceData@@H@Z.c)
