/*
 * XREFs of s_pbmSetSmtcSubscriptionState @ 0x1800F9900
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall s_pbmSetSmtcSubscriptionState(__int64 a1, unsigned int a2, unsigned int a3, unsigned int a4)
{
  int v8; // ebx
  ...
  CWatchdogTimer<1>::CWatchdogTimer<1>(pv, v9[1], v10, (struct _TP_TIMER *)L"s_pbmSetSmtcSubscriptionState");
  ...
  else if ( g_PolicyManager )
  {
    ...
    {
      if ( a3 )
        (*(void (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v12 + 560LL))(v12, a3);
