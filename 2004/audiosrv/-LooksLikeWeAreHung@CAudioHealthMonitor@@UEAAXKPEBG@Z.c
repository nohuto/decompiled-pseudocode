/*
 * XREFs of ?LooksLikeWeAreHung@CAudioHealthMonitor@@UEAAXKPEBG@Z @ 0x1800B7BE0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (unsigned int)v8 >= *((_DWORD *)this + 3) && *((_DWORD *)this + 4) == 16 && !*((_DWORD *)this + 16) )
    {
      ...
      *((_DWORD *)this + 16) = 1;
      ...
      if ( *v15 > 4u && tlgKeywordOn((__int64)v15, 1LL) )
      {
        ...
        v26 = 4;
        v27 = 0;
        tlgWriteTransfer_EtwEventWriteTransfer(v16, byte_180166F90, 0LL, 0LL, 3, (__int64)v24);
      }
      if ( v13 >= 0 )
        Sleep(0xEA60u);
