/*
 * XREFs of McTemplateU0pqpqqqqqq_EventWriteTransfer @ 0x180132EF8
 * Callers:
 *     ?AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z @ 0x1800542D0 (-AERTMemoryInitOnce@@YAHPEAT_RTL_RUN_ONCE@@PEAXPEAPEAX@Z.c)
 ...
 *     ?IncreaseProcessWorkingSet@@YAJ_K@Z @ 0x180132D84 (-IncreaseProcessWorkingSet@@YAJ_K@Z.c)
 * Callees:
 *     __security_check_cookie @ 0x18006A580 (__security_check_cookie.c)
 *     McGenEventWrite_EventWriteTransfer @ 0x180132A3C (McGenEventWrite_EventWriteTransfer.c)
 */
