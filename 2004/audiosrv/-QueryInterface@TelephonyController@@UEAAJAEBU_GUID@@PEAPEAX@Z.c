/*
 * XREFs of ?QueryInterface@TelephonyController@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801432E0
 * Callers:
 *     ?QueryInterface@TelephonyController@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x180075BD0 (-QueryInterface@TelephonyController@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
