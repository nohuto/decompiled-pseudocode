/*
 * XREFs of ??0CVolumeControlBase@@QEAA@PEAUIVolumeStrip@@@Z @ 0x1800616F0
 * Callers:
 *     ??0CVolumeHardware@@QEAA@PEAUIVolumeStrip@@@Z @ 0x180061638 (--0CVolumeHardware@@QEAA@PEAUIVolumeStrip@@@Z.c)
 *     ??0CVolumeSoftware@@QEAA@PEAUIVolumeStrip@@@Z @ 0x1800C33FC (--0CVolumeSoftware@@QEAA@PEAUIVolumeStrip@@@Z.c)
 * Callees:
 *     ??0AudioSrvVolumeTelemetry@@QEAA@XZ @ 0x1800567C8 (--0AudioSrvVolumeTelemetry@@QEAA@XZ.c)
