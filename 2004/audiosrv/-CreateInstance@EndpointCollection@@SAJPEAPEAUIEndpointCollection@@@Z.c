/*
 * XREFs of ?CreateInstance@EndpointCollection@@SAJPEAPEAUIEndpointCollection@@@Z @ 0x180056F04
 * Callers:
 ...
 *     ??0EndpointCollection@@IEAA@XZ @ 0x180057004 (--0EndpointCollection@@IEAA@XZ.c)
