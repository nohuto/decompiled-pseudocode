/*
 * XREFs of ?GetMixFormat@CEndpointCharacteristics@@QEAAJW4__MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001@@U_GUID@@PEAPEAUtWAVEFORMATEX@@@Z @ 0x1800206E0
 * Callers:
 ...
 *     ?Log_Win32@in1diag3@details@wil@@YAKPEAXIPEBDK@Z @ 0x18011EF54 (-Log_Win32@in1diag3@details@wil@@YAKPEAXIPEBDK@Z.c)
  ...
  *a4 = 0LL;
  ...
  else
  {
    ...
    if ( v10 )
    {
      ...
      while ( 1 )
      {
        v12 = qword_18019E7E0[2 * v11] - v50;
        if ( !v12 )
          v12 = qword_18019E7E0[2 * v11 + 1] - *((_QWORD *)&v50 + 1);
        if ( !v12 )
          break;
        if ( ++v11 >= 9 )
        {
