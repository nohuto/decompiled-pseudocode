/*
 * XREFs of ?ReloadApos@AudioEffectsWatcher@@AEAAJXZ @ 0x1800C6678
 * Callers:
...
__int64 __fastcall AudioEffectsWatcher::ReloadApos(AudioEffectsWatcher *this)
{
  ...
  enum __MIDL___MIDL_itf_audioengineendpoint_0000_0000_0001 v13; // [rsp+28h] [rbp-79h]
  struct ICompositeSystemEffect **v14; // [rsp+30h] [rbp-71h]
  struct IAudioProcessingObject **v15; // [rsp+38h] [rbp-69h]
  CEndpointCharacteristics *v16; // [rsp+88h] [rbp-19h] BYREF
  struct _tagpropertykey v17; // [rsp+98h] [rbp-9h] BYREF
  struct _GUID v18; // [rsp+B8h] [rbp+17h] BYREF
  struct _GUID v19; // [rsp+C8h] [rbp+27h] BYREF
