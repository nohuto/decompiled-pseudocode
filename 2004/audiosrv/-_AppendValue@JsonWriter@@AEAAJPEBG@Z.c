/*
 * XREFs of ?_AppendValue@JsonWriter@@AEAAJPEBG@Z @ 0x18013D124
 * Callers:
 ...
 *     ?_EncodeJsonString@JsonWriter@@AEAAXPEBGPEADPEAK2@Z @ 0x18013D218 (-_EncodeJsonString@JsonWriter@@AEAAXPEBGPEADPEAK2@Z.c)
 */
