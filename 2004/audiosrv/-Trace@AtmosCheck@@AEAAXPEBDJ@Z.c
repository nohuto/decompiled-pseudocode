/*
 * XREFs of ?Trace@AtmosCheck@@AEAAXPEBDJ@Z @ 0x18005F718
 * Callers:
 ...
 *     ?StaticClientAtmosCheckEventFired@AtmosCheck@@SAXPEAXE@Z @ 0x18005F6E0 (-StaticClientAtmosCheckEventFired@AtmosCheck@@SAXPEAXE@Z.c)
...
void __fastcall AtmosCheck::Trace(AtmosCheck *this, const char *a2, int a3)
{
  ...
  if ( a3 )
  {
    if ( (unsigned int)dword_18019D520 > 2 )
    {
      v3 = (__int64)a2;
      LODWORD(v4) = a3;
  ...
  else if ( (unsigned int)dword_18019D520 > 5 )
  {
    v3 = (__int64)a2;
