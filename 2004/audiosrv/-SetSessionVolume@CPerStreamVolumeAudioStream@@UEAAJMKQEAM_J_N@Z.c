/*
 * XREFs of ?SetSessionVolume@CPerStreamVolumeAudioStream@@UEAAJMKQEAM_J_N@Z @ 0x1800338F0
 * Callers:
 *     <none>
 * Callees:
        ...
        bool a6)
{
  ...
  if ( a3 < v6 )
  {
    ...
    if ( v6 )
    {
      ...
      while ( (unsigned int)v16 < *((_DWORD *)this + 23) );
    }
  }
  else
  {
    ...
    if ( v6 )
    {
      ...
      while ( (unsigned int)v9 < *((_DWORD *)this + 23) );
    }
  }
  *((_QWORD *)this + 56) = a5;
  if ( !a6 )
