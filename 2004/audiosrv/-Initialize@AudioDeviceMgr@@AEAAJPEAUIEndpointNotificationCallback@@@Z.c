/*
 * XREFs of ?Initialize@AudioDeviceMgr@@AEAAJPEAUIEndpointNotificationCallback@@@Z @ 0x1800568CC
 * Callers:
 ...
 *     ?CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ @ 0x180068E24 (-CreateWorkItemThread@AudioDeviceMgr@@AEAAJXZ.c)
