/*
 * XREFs of ?MyServiceInitialization@@YAKPEAUSERVICE_STATUS_HANDLE__@@KPEAPEBG@Z @ 0x1800626D0
 * Callers:
 *     ServiceStart @ 0x180062590 (ServiceStart.c)
 * Callees:
 *     ?InitializeAudioThreadpool@@YAJXZ @ 0x180062898 (-InitializeAudioThreadpool@@YAJXZ.c)
 *     McGenEventRegister_EtwEventRegister @ 0x1800629A0 (McGenEventRegister_EtwEventRegister.c)
