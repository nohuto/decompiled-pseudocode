...
__int64 __fastcall SpatialPolicy::OnPropertyChange(struct IMMDevice *a1, const struct _tagpropertykey *a2)
{
                                   ...
                                   + 4LL) )
  {
    ...
    {
      xmmword_18019F4A0 = (__int128)GUID_00000000_0000_0000_0000_000000000000;
      dword_18019F4B0 = 0;
      Init_thread_footer(&dword_18019FE2C);
    }
  }
  v4 = xmmword_18019F4A0 - *(_QWORD *)&GUID_00000000_0000_0000_0000_000000000000.Data1;
  if ( (_QWORD)xmmword_18019F4A0 == *(_QWORD *)&GUID_00000000_0000_0000_0000_000000000000.Data1 )
    v4 = *((_QWORD *)&xmmword_18019F4A0 + 1) - *(_QWORD *)GUID_00000000_0000_0000_0000_000000000000.Data4;
  if ( !v4 )
  {
    xmmword_18019F4A0 = PKEY_SpatialAudio_Signaling_Key;
    dword_18019F4B0 = 2;
  }
  if ( dword_18019E874 == -1 )
  {
    dword_18019E874 = 1;
  ...
  if ( dword_18019E874 )
    return 0LL;
  v5 = *(_QWORD *)&a2->fmtid.Data1 - xmmword_18019F4A0;
  if ( *(_QWORD *)&a2->fmtid.Data1 == (_QWORD)xmmword_18019F4A0 )
    v5 = *(_QWORD *)a2->fmtid.Data4 - *((_QWORD *)&xmmword_18019F4A0 + 1);
  if ( v5 || a2->pid != dword_18019F4B0 )
    return 0LL;
  v16 = 0LL;
