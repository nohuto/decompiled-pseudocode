 ...
 *     ?Init@CNtDeleteKey@@QEAA_NXZ @ 0x1800D8148 (-Init@CNtDeleteKey@@QEAA_NXZ.c)
 */
...
LABEL_6:
  ...
  if ( dword_18019FBE0 > *((_DWORD *)v14 + 1) )
  {
    Init_thread_header(&dword_18019FBE0);
    if ( dword_18019FBE0 == -1 )
    {
      atexit(SafeRegCreateKeyEx_::_2_::_dynamic_atexit_destructor_for__delKey__);
      Init_thread_footer(&dword_18019FBE0);
    }
  }
  v15 = v13 - 1;
  if ( v15 )
...
LABEL_21:
  ...
  else if ( CNtDeleteKey::Init(v14) && !(qword_18019FBF0 ? qword_18019FBF0(hKey) : 87) )
  {
    RegCloseKey(hKey);
    hKey = 0LL;
    dwDisposition = 0;
