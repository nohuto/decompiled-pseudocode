/*
 * XREFs of ?StringCbCopyExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x1800BD5F8
 * Callers:
 ...
 *     StringExHandleOtherFlagsW @ 0x1800BB21C (StringExHandleOtherFlagsW.c)
 *     StringCopyWorkerW @ 0x1800BD7C8 (StringCopyWorkerW.c)
 */
        ...
        DWORD a6)
{
  ...
  if ( (a6 & 0x100) != 0 )
  {
    v13 = (const wchar_t *)&unk_18015D734;
    if ( pszSrc )
      v13 = pszSrc;
    pszSrc = v13;
  }
