/*
 * XREFs of ?GetDictionaryMetadataFormatId@SpatialAudioMetadataDictionaryData@@UEAAJPEAU_GUID@@@Z @ 0x18012CD10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _GUID *a2)
{
  ...
  else
  {
    if ( (unsigned int)dword_18019D4B0 > 2 )
    {
      ...
      v11 = (__int64)"SpatialAudioMetadataDictionaryData::GetDictionaryMetadataFormatId";
      LODWORD(v10) = 153;
