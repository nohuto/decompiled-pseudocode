/*
 * XREFs of ?OnDeviceAdded@CMonitorManager@@EEAAJPEBG@Z @ 0x1800FE480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMonitorManager::OnDeviceAdded(PVOID pv, const unsigned __int16 *a2)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x19u, (__int64)&WPP_107eeefd23a13a1e42820564321ad14e_Traceguids, a2);
  }
