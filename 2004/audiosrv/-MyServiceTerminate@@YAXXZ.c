/*
 * XREFs of ?MyServiceTerminate@@YAXXZ @ 0x180116374
 * Callers:
 *     ?OnServiceShutdown@@YAXPEAXE@Z @ 0x180115DC0 (-OnServiceShutdown@@YAXPEAXE@Z.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x180074C80 (_guard_dispatch_icall_nop.c)
 *     ?Terminate@CAudioThreadPool@@QEAAJXZ @ 0x180105CF0 (-Terminate@CAudioThreadPool@@QEAAJXZ.c)
 *     McGenEventUnregister_EtwEventUnregister @ 0x180116704 (McGenEventUnregister_EtwEventUnregister.c)
 */
