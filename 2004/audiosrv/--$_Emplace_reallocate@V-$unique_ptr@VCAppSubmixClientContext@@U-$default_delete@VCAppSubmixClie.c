        ...
        __int64 *a3)
{
  ...
  *v14 = v15;
  ...
  if ( a2 != v16 )
  {
    std::_Uninitialized_move<std::unique_ptr<CAppSubmixClientContext> *,std::unique_ptr<CAppSubmixClientContext> *,std::allocator<std::unique_ptr<CAppSubmixClientContext>>>(
      v18,
      a2,
      v13);
    v17 = v20;
  ...
  std::_Uninitialized_move<std::unique_ptr<CAppSubmixClientContext> *,std::unique_ptr<CAppSubmixClientContext> *,std::allocator<std::unique_ptr<CAppSubmixClientContext>>>(
    ...
    v16,
    v17);
  std::vector<std::unique_ptr<CAppSubmixClientContext>>::_Change_array(a1, v13, v8, v11, v13);
  return *a1 + 8 * v6;
}
