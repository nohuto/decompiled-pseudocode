/*
 * XREFs of ??0CComAutoCriticalSection@ATL@@QEAA@XZ @ 0x1800572D0
 * Callers:
 ...
 *     ??0CConstraintModelResourceManager@@AEAA@XZ @ 0x180057124 (--0CConstraintModelResourceManager@@AEAA@XZ.c)
