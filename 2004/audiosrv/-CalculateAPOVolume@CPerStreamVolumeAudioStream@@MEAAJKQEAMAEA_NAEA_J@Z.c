/*
 * XREFs of ?CalculateAPOVolume@CPerStreamVolumeAudioStream@@MEAAJKQEAMAEA_NAEA_J@Z @ 0x180037490
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a2 == *((_DWORD *)this + 23) )
  {
    ...
    if ( a2 )
    {
      if ( a2 >= 0x10 )
      {
        ...
        v12 = &a3[v10];
        v13 = _mm_shuffle_ps((__m128)*((unsigned int *)this + 25), (__m128)*((unsigned int *)this + 25), 0);
    ...
    *a5 = v21;
    if ( a2 )
    {
      v22 = *((_QWORD *)this + 55) - (_QWORD)a3;
      v23 = a2;
      do
      {
        v24 = (double *)*((_QWORD *)this + 58);
        if ( v24 )
