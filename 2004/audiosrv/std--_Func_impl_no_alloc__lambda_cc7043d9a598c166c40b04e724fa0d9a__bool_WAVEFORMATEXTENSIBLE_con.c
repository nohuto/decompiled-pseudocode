/*
 * XREFs of std::_Func_impl_no_alloc__lambda_cc7043d9a598c166c40b04e724fa0d9a__bool_WAVEFORMATEXTENSIBLE_const___::_Do_call @ 0x18004BBC0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall std::_Func_impl_no_alloc__lambda_cc7043d9a598c166c40b04e724fa0d9a__bool_WAVEFORMATEXTENSIBLE_const___::_Do_call(
        __int64 a1,
...
LABEL_7:
  ...
  while ( 1 )
  {
    if ( v14 < 0 || v13 >= v10[6] )
    {
      ...
      JUMPOUT(0x18004BCDBLL);
    }
    if ( (unsigned int)CompareWaveFormat(v2, **(const struct tWAVEFORMATEX ***)(v14 + *((_QWORD *)v10 + 2))) )
      return v6;
    ++v13;
    v14 += 8LL;
    if ( v13 >= v10[6] )
