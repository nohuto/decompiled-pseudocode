/*
 * XREFs of wistd::__function::__func__lambda_ca79050dc30379a8d322bb4b6dd56097__void___cdecl(enum_wil::RegistryChangeKind)_::operator() @ 0x1800FAA50
 * Callers:
 *     <none>
 * Callees:
 *     ?OnAudioMirrorEnabledChange@CMonitorManager@@AEAAXXZ @ 0x1800FDDF4 (-OnAudioMirrorEnabledChange@CMonitorManager@@AEAAXXZ.c)
 *     ?UpdateAudioMirroringEnabled@CMonitorManager@@AEAAJPEA_N@Z @ 0x1801005A4 (-UpdateAudioMirroringEnabled@CMonitorManager@@AEAAJPEA_N@Z.c)
 *     ?UpdateRoutedEndpointId@CMonitorManager@@AEAAXPEA_N@Z @ 0x180100658 (-UpdateRoutedEndpointId@CMonitorManager@@AEAAXPEA_N@Z.c)
 */
