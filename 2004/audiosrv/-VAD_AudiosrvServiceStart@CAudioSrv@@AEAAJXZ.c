/*
 * XREFs of ?VAD_AudiosrvServiceStart@CAudioSrv@@AEAAJXZ @ 0x180063D30
 * Callers:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_HangDetectionThresholdTweaking@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x180064790 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_HangDetectionThresholdTweaking@@@details@.c)
 ...
 *     Microsoft::WRL::Details::OutOfProcModuleBase_Windows::Internal::SvcHostModule_::Create__lambda_b07e40d598d2e6cc64bbba968f53c163___ @ 0x180064F90 (Microsoft--WRL--Details--OutOfProcModuleBase_Windows--Internal--SvcHostModule_--Create__lambda_b.c)
 ...
 *     ??0CAudioHealthMonitor@@QEAA@K@Z @ 0x180065ED4 (--0CAudioHealthMonitor@@QEAA@K@Z.c)
 ...
 *     ??$make_shared@VCVolumeUnit@@$$V@std@@YA?AV?$shared_ptr@VCVolumeUnit@@@0@XZ @ 0x1800B82FC (--$make_shared@VCVolumeUnit@@$$V@std@@YA-AV-$shared_ptr@VCVolumeUnit@@@0@XZ.c)
...
__int64 __fastcall CAudioSrv::VAD_AudiosrvServiceStart(CAudioSrv *this)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 43LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids);
  }
...
LABEL_46:
  ...
  {
    wil::details::in1diag3::_FailFast_NullAlloc(retaddr, (void *)0x8A6, v10, v11);
    goto LABEL_52;
  }
...
LABEL_61:
  ...
  {
    wil::details::in1diag3::_FailFast_NullAlloc(retaddr, (void *)0x8CF, v20, v21);
    goto LABEL_64;
  }
...
LABEL_64:
  ...
  if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 44LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids);
  }
LABEL_32:
    ...
    if ( v24 >= 0 )
    {
      *((_DWORD *)this + 26) = 1;
      if ( WPP_GLOBAL_Control != (CAudioSessionManager *)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
      {
        WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 45LL, &WPP_bd0a34596ab73049bcbc5190e65788c6_Traceguids);
      }
      LastError = 0;
      goto LABEL_37;
    }
