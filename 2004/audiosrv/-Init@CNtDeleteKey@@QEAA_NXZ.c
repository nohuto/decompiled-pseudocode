/*
 * XREFs of ?Init@CNtDeleteKey@@QEAA_NXZ @ 0x1800D8148
 * Callers:
...
bool __fastcall CNtDeleteKey::Init(CNtDeleteKey *this)
{
  ...
  else
  {
    ...
    if ( Library )
    {
      qword_18019FBF0 = (__int64 (__fastcall *)(_QWORD))GetProcAddress(Library, "NtDeleteKey");
      LOBYTE(Library) = qword_18019FBF0 != 0LL;
    }
  }
  return (char)Library;
}
