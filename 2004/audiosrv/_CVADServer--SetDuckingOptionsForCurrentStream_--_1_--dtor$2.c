/*
 * XREFs of _CVADServer::SetDuckingOptionsForCurrentStream_::_1_::dtor$2 @ 0x18006F5DC
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CVADServer::SetDuckingOptionsForCurrentStream_::_1_::dtor_2(__int64 a1, __int64 a2)
{
