/*
 * XREFs of Controller_D0ExitSaveState @ 0x1C003063C
 * Callers:
...
__int64 __fastcall Controller_D0ExitSaveState(__int64 a1, char a2, __int64 a3, int a4)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 124, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  ...
  if ( (Ulong & 1) != 0 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 128, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  ...
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v12 = 125;
LABEL_14:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2, 4, v12, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  }
LABEL_35:
  v4 = -1073741630;
LABEL_36:
