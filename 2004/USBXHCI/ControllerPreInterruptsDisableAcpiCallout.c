/*
 * XREFs of ControllerPreInterruptsDisableAcpiCallout @ 0x1C0009EB4
 * Callers:
...
__int64 __fastcall ControllerPreInterruptsDisableAcpiCallout(__int64 a1)
{
  ...
  if ( (*(_QWORD *)(v4 + 336) & 0x40000000000000LL) != 0 )
  {
    ...
    {
      LOBYTE(v3) = 4;
      WPP_RECORDER_SF_i(*(_QWORD *)(v4 + 72), v3, 4, 79, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, a1);
    }
    v15 = 0;
    v18 = 0;
    v10 = 0;
