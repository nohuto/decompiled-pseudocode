/*
 * XREFs of Bulk_IsTransferEventLikelyDuplicate_Internal @ 0x1C0043910
 * Callers:
 *     Bulk_EP_IsTransferEventLikelyDuplicate @ 0x1C0043650 (Bulk_EP_IsTransferEventLikelyDuplicate.c)
 *     Bulk_ValidateED0TrbPointerOnMismatch @ 0x1C0043EE8 (Bulk_ValidateED0TrbPointerOnMismatch.c)
 * Callees:
 *     TR_DoesSegmentContainDequeuePointer @ 0x1C000B574 (TR_DoesSegmentContainDequeuePointer.c)
