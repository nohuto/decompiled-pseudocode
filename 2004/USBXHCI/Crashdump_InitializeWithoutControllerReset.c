/*
 * XREFs of Crashdump_InitializeWithoutControllerReset @ 0x1C0049FE4
 * Callers:
 *     Crashdump_Initialize @ 0x1C0049870 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_PrepareForHibernate @ 0x1C004AF90 (Crashdump_Register_PrepareForHibernate.c)
 *     Crashdump_EventRing_PrepareForHibernate @ 0x1C004BE68 (Crashdump_EventRing_PrepareForHibernate.c)
...
__int64 __fastcall Crashdump_InitializeWithoutControllerReset(char *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, *((PVOID *)Address + 77), 0x328uLL, 0x43434858u);
