/*
 * XREFs of Bulk_RetrieveNextStage @ 0x1C000C480
 * Callers:
 ...
 *     Bulk_Stage_Acquire @ 0x1C000C7D4 (Bulk_Stage_Acquire.c)
 *     Bulk_TransferData_ConfigureBuffer @ 0x1C000C8CC (Bulk_TransferData_ConfigureBuffer.c)
