/*
 * XREFs of Controller_D0EntryRestoreState @ 0x1C0030314
 * Callers:
...
__int64 __fastcall Controller_D0EntryRestoreState(__int64 a1, char a2, __int64 a3, int a4)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 108, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  ...
  if ( (Ulong & 1) != 0 )
  {
    ...
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 112, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  ...
  else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v11 = 109;
LABEL_14:
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2, 4, v11, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  }
LABEL_36:
  v20 = -1073741630;
LABEL_37:
