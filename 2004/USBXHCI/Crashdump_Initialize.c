/*
 * XREFs of Crashdump_Initialize @ 0x1C0049870
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x1C0018DB0 (__security_check_cookie.c)
 *     memset @ 0x1C00194C0 (memset.c)
 *     Crashdump_InitializeWithControllerReset @ 0x1C0049DC0 (Crashdump_InitializeWithControllerReset.c)
 *     Crashdump_InitializeWithoutControllerReset @ 0x1C0049FE4 (Crashdump_InitializeWithoutControllerReset.c)
 *     Crashdump_Register_BiosHandoff @ 0x1C004AC84 (Crashdump_Register_BiosHandoff.c)
