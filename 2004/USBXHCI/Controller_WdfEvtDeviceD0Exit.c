/*
 * XREFs of Controller_WdfEvtDeviceD0Exit @ 0x1C000AC00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceD0Exit(__int64 a1, unsigned __int32 a2)
{
  ...
  if ( v9 || a2 != 6 )
  {
      ...
      || (_mm_srli_si128(v4[21], 8).m128i_u8[0] & 8) != 0 && (unsigned __int8)Controller_InUseByDebugger(v4) )
    {
      ...
      {
        LOBYTE(v11) = 4;
        WPP_RECORDER_SF_(v4[4].m128i_i64[1], v11, 4, 85, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
      }
    }
    else
    {
  ...
  if ( (v4[21].m128i_i64[0] & 0x80000000000LL) != 0 && v8 == 5 )
  {
    ...
    {
      LOBYTE(v20) = 4;
      WPP_RECORDER_SF_d(v4[4].m128i_i64[1], v20, 4, 87, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v19);
    }
  }
