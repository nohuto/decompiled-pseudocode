/*
 * XREFs of IoControl_WdfEvtIoDeviceControl @ 0x1C003B900
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v17 >= 0 )
      {
        ...
        if ( v21 == a4 )
        {
          ...
          if ( v33[3] <= v33[2] )
          {
            if ( *v33 == -2147483647 )
            {
              v24 = _InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(v13 + 8) + 784LL), 0, 0);
              v23[4] = v24;
              if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
              {
                LOBYTE(v23) = 4;
            ...
            else
            {
              ...
              if ( v25 == -1 )
              {
                _InterlockedExchange((volatile __int32 *)(v26 + 788), 1);
              ...
              {
                _InterlockedExchange((volatile __int32 *)(v26 + 784), v25);
                if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                {
                  v31 = v23[4];
                  LOBYTE(v23) = 4;
