/*
 * XREFs of UsbDevice_EnableCompletion @ 0x1C000EEE0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall UsbDevice_EnableCompletion(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (_DWORD)a2 == 3 )
  {
    ...
    {
      LOBYTE(a2) = 4;
      WPP_RECORDER_SF_i(v6[9], a2, 12, 15, (__int64)&WPP_2d0c5f6bf4263c2e7a5f7f01b810c292_Traceguids, *(_QWORD *)v3);
    }
    v15 = 1;
  ...
  else
  {
    ...
    else
    {
      ...
      {
        LOBYTE(a2) = 3;
        WPP_RECORDER_SF_d(v6[9], a2, 12, 19, (__int64)&WPP_2d0c5f6bf4263c2e7a5f7f01b810c292_Traceguids, v9);
        v9 = *(_BYTE *)(a1 + 60);
      }
      if ( v9 == 9 )
      {
