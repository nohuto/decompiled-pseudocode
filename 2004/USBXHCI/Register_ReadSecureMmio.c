/*
 * XREFs of Register_ReadSecureMmio @ 0x1C003C240
 * Callers:
 ...
 *     XilRegister_ReadUlong64 @ 0x1C003C75C (XilRegister_ReadUlong64.c)
 *     XilRegister_ReadUshort @ 0x1C003C7CC (XilRegister_ReadUshort.c)
 * Callees:
...
LABEL_26:
  ...
  {
    PoolWithTag = (int *)ExAllocatePoolWithTag((POOL_TYPE)WPP_MAIN_CB.DeviceLock.Header.SignalState, v12, 0x49434858u);
    if ( !PoolWithTag )
    {
