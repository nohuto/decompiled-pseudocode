/*
 * XREFs of Controller_PopulateDeviceFlagsFromKse @ 0x1C0015AB0
 * Callers:
 *     Controller_PopulateDeviceFlags @ 0x1C006E8E0 (Controller_PopulateDeviceFlags.c)
 * Callees:
 *     RtlStringCchPrintfW @ 0x1C0008DA4 (RtlStringCchPrintfW.c)
...
LABEL_55:
  ...
  if ( (result & 0x1000000) != 0 )
  {
    ...
    {
      LOBYTE(v17) = 2;
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), v17, 4, 161, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
    }
