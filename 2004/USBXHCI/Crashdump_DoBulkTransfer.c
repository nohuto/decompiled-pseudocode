/*
 * XREFs of Crashdump_DoBulkTransfer @ 0x1C0049730
 * Callers:
 *     Crashdump_SendUrb @ 0x1C004A420 (Crashdump_SendUrb.c)
 *     Crashdump_SendUrbAsync @ 0x1C004A510 (Crashdump_SendUrbAsync.c)
 * Callees:
 *     Crashdump_Endpoint_SendBulkTransfer @ 0x1C004C778 (Crashdump_Endpoint_SendBulkTransfer.c)
 */
