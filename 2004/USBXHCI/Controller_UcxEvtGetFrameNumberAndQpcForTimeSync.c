/*
 * XREFs of Controller_UcxEvtGetFrameNumberAndQpcForTimeSync @ 0x1C0033400
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a4)
{
  ...
  if ( v14 >= 0 )
  {
    if ( !*v18 )
    {
      ...
      {
        LOBYTE(v10) = 2;
        WPP_RECORDER_SF_(v9[9].QuadPart, v10, 4, 298, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
      }
LABEL_9:
      v14 = -1073741811;
      goto LABEL_28;
    ...
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      return (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD, unsigned __int64))(WdfFunctions_01023
               ...
               a3);
    LOBYTE(v10) = 2;
    WPP_RECORDER_SF_i(v9[9].QuadPart, v10, 4, 300, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v8);
  }
LABEL_28:
