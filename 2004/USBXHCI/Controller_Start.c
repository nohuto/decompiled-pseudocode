/*
 * XREFs of Controller_Start @ 0x1C00109E8
 * Callers:
 ...
 *     Register_GetExtendedTBCTRBStatusSupported @ 0x1C0013234 (Register_GetExtendedTBCTRBStatusSupported.c)
...
__int64 __fastcall Controller_Start(__int64 a1, char a2, int a3, int a4)
{
  ...
  v6 = 0LL;
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 116, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  if ( Controller_IsControllerAccessible(a1) )
  {
    ...
    if ( (XilRegister_ReadUlong(v7, v8 + 4) & 1) != 0 )
    {
      ...
      *(_BYTE *)(a1 + 539) = Register_GetExtendedTBCTRBStatusSupported();
      ...
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 118, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
...
LABEL_14:
      ...
      DynamicLock_Acquire(*(_QWORD *)(a1 + 600), v20, v22, v23);
      ++*(_DWORD *)(a1 + 608);
      ...
      DynamicLock_Release(*(_QWORD *)(a1 + 600), v25, v27, v28);
      if ( v26 )
    ...
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 2, 4, 117, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
