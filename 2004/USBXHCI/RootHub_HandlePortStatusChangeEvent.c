/*
 * XREFs of RootHub_HandlePortStatusChangeEvent @ 0x1C0010F2C
 * Callers:
...
__int64 __fastcall RootHub_HandlePortStatusChangeEvent(_QWORD *a1, __int64 a2)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    v15 = *(_BYTE *)(a2 + 3);
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_d(*(_QWORD *)(v2 + 72), a2, 11, 207, (__int64)&WPP_f97631885c123b34877e2ec176e34bf2_Traceguids, v15);
    v2 = a1[1];
  }
  v6 = v4 - 1;
  v7 = 16LL * (v4 - 1);
  ...
  else
  {
    ...
    if ( !(_BYTE)result )
      return ((__int64 (__fastcall *)(__int64, _QWORD))qword_1C00616D0)(UcxDriverGlobals, *a1);
  }
  return result;
}
