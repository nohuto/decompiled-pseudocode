/*
 * XREFs of Controller_AudioOffloadWnfStateUpdateWorker @ 0x1C0030210
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WnfHelper_PublishUsbXhciAudioOffloadState @ 0x1C0077EA4 (WnfHelper_PublishUsbXhciAudioOffloadState.c)
 */
...
__int64 __fastcall Controller_AudioOffloadWnfStateUpdateWorker(__int64 a1)
{
  ...
  v2 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01023 + 1616))(
         ...
         v1,
         off_1C0060428);
  DynamicLock_Acquire(*(_QWORD *)(v2 + 584), v3, v4, v5);
  v6 = *(_BYTE *)(v2 + 768);
  DynamicLock_Release(*(_QWORD *)(v2 + 584), v7, v8, v9);
  LOBYTE(v10) = v6;
