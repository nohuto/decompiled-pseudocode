/*
 * XREFs of Controller_ConfigureSxWakeSettings @ 0x1C006FB2C
 * Callers:
...
__int64 __fastcall Controller_ConfigureSxWakeSettings(__int64 *a1)
{
  ...
  {
    LOBYTE(v4) = 2;
    return WPP_RECORDER_SF_d(a1[9], v4, 4, 32, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, result);
  }
  return result;
}
