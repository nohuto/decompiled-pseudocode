/*
 * XREFs of Controller_InternalReset @ 0x1C0031AF8
 * Callers:
...
__int64 __fastcall Controller_InternalReset(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 72), 4, 4, 176, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  ...
  if ( !_InterlockedCompareExchange((volatile signed __int32 *)(a1 + 788), 0, 1)
    && !_InterlockedCompareExchange((volatile signed __int32 *)(a1 + 784), 0, 0) )
  {
    ++*(_DWORD *)(a1 + 476);
    *(_BYTE *)(a1 + 472) = 1;
...
LABEL_34:
  ...
  if ( v13 < 0 )
  {
    ...
    result = ((__int64 (__fastcall *)(__int64, _QWORD))qword_1C00616C0)(UcxDriverGlobals, *(_QWORD *)(a1 + 8));
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      LOBYTE(v33) = 2;
