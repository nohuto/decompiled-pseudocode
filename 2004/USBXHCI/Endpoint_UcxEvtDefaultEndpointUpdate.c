/*
 * XREFs of Endpoint_UcxEvtDefaultEndpointUpdate @ 0x1C0014FE0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall Endpoint_UcxEvtDefaultEndpointUpdate(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(v8 + 16) = *(_DWORD *)(v3 + 32);
  v9 = XilEndpoint_AcquireBuffer((_BYTE *)v4, (*(_DWORD *)(v6 + 100) & 4) != 0 ? 2112 : 1056, v4, 829714501);
  v10 = 0;
  *(_QWORD *)(v8 + 8) = v9;
  if ( v9 )
  {
    v11 = *(_QWORD *)(v9 + 16);
    v12 = -(__int64)((*(_DWORD *)(v6 + 100) & 4) != 0);
    *(_DWORD *)(v11 + 4) |= 2u;
    v13 = v11 + (v12 & 0x40) + 64;
