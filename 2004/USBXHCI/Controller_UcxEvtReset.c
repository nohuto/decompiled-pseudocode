/*
 * XREFs of Controller_UcxEvtReset @ 0x1C0033780
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_UcxEvtReset(__int64 a1)
{
  ...
  {
    LOBYTE(v3) = 2;
    WPP_RECORDER_SF_(*(_QWORD *)(v2 + 72), v3, 4, 184, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids);
  }
  v7 = 1;
  v6 = 12LL;
  return ((__int64 (__fastcall *)(__int64, __int64, __int64 *))qword_1C00616B8)(UcxDriverGlobals, a1, &v6);
}
