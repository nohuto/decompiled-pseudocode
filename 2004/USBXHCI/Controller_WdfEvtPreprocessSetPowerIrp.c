/*
 * XREFs of Controller_WdfEvtPreprocessSetPowerIrp @ 0x1C0009B80
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_d @ 0x1C000E688 (WPP_RECORDER_SF_d.c)
 *     _guard_dispatch_icall_nop @ 0x1C00191C0 (_guard_dispatch_icall_nop.c)
 *     Crashdump_ProcessSystemPowerAction @ 0x1C004A224 (Crashdump_ProcessSystemPowerAction.c)
 */
...
LABEL_14:
  ...
  *(_QWORD *)(a2 + 184) += 72LL;
  ...
  {
    LOBYTE(v13) = 2;
    WPP_RECORDER_SF_d(*(_QWORD *)(v6 + 16), v13, 4, 208, (__int64)&WPP_2a10b20b34c83bd3dea18079565cd6d6_Traceguids, v12);
  }
  return v14;
}
