/*
 * XREFs of XilCoreCommonBuffer_ReleaseBuffers @ 0x1C0009A60
 * Callers:
 ...
 * Callees:
 *     XilCoreCommonBuffer_ReleaseBufferInternal @ 0x1C000DDD8 (XilCoreCommonBuffer_ReleaseBufferInternal.c)
 */
