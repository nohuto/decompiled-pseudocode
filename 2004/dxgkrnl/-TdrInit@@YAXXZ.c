/*
 * XREFs of ?TdrInit@@YAXXZ @ 0x1C018D454
 * Callers:
...
void TdrInit(void)
{
  ...
  if ( dword_1C00B2164 != v26 )
  {
    v18 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v18 + 24) = v26;
    *(_QWORD *)(v18 + 32) = (unsigned int)dword_1C00B2164;
  ...
  if ( dword_1C00B2168 != v27 )
  {
    v19 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v19 + 24) = v27;
    *(_QWORD *)(v19 + 32) = (unsigned int)dword_1C00B2168;
  ...
  if ( dword_1C00B216C != v28 )
  {
    v20 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v20 + 24) = v28;
    *(_QWORD *)(v20 + 32) = (unsigned int)dword_1C00B216C;
  ...
  if ( dword_1C00B2170 != v29 )
  {
    v21 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v21 + 24) = v29;
    *(_QWORD *)(v21 + 32) = (unsigned int)dword_1C00B2170;
  ...
  if ( dword_1C00B2178 != v31 )
  {
    v22 = WdLogNewEntry5_WdWarning(v3, v2, v4);
    *(_QWORD *)(v22 + 24) = v31;
    *(_QWORD *)(v22 + 32) = (unsigned int)dword_1C00B2178;
  ...
  if ( dword_1C00B217C != v32 )
  {
    v23 = WdLogNewEntry5_WdWarning(3600LL, v2, v4);
    *(_QWORD *)(v23 + 24) = v32;
    *(_QWORD *)(v23 + 32) = (unsigned int)dword_1C00B217C;
    WdLogEvent5_WdWarning(v23);
  }
  LOBYTE(v12) = 1;
  byte_1C00B2174 = (unsigned __int8)WdIsDebuggerPresent(v12) != 0;
  if ( v25 <= 3 )
    v0 = v25;
  g_TdrDebugMode = v0;
  if ( v0 != v25 )
