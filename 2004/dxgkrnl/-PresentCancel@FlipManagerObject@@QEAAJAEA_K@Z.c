/*
 * XREFs of ?PresentCancel@FlipManagerObject@@QEAAJAEA_K@Z @ 0x1C0067AD8
 * Callers:
 ...
 *     ?PresentCancel@CFlipManager@@QEAAJAEA_K@Z @ 0x1C006ABA0 (-PresentCancel@CFlipManager@@QEAAJAEA_K@Z.c)
 */
