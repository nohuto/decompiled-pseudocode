/*
 * XREFs of ??1DXGADAPTER@@QEAA@XZ @ 0x1C020B270
 * Callers:
 *     ??_GDXGADAPTER@@QEAAPEAXI@Z @ 0x1C004561C (--_GDXGADAPTER@@QEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??_GADAPTER_RENDER@@QEAAPEAXI@Z @ 0x1C0036094 (--_GADAPTER_RENDER@@QEAAPEAXI@Z.c)
