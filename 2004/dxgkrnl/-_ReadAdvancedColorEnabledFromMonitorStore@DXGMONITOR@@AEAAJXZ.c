/*
 * XREFs of ?_ReadAdvancedColorEnabledFromMonitorStore@DXGMONITOR@@AEAAJXZ @ 0x1C0186BC8
 * Callers:
...
__int64 __fastcall DXGMONITOR::_ReadAdvancedColorEnabledFromMonitorStore(DXGMONITOR *this, __int64 a2)
{
  __int64 result; // rax
  __int64 v4; // rdi
  __int64 v5; // rdx
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (_DWORD)v4 != -1073741772 )
    {
      if ( (int)v4 >= 0 )
      {
        if ( v13 == 4 && v14 == 4 )
        {
          *((_DWORD *)this + 10) = *((_DWORD *)this + 10) & 0xFFFFF7FF | (v15 != 0 ? 0x800 : 0);
          return 0LL;
        }
        else
        {
