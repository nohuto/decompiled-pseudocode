/*
 * XREFs of IoMmuDetachDomainFromDevices @ 0x1C02D1808
 * Callers:
  ...
  if ( (result & 2) != 0 )
  {
    ...
    if ( *(_DWORD *)(a1 + 504) )
    {
      if ( *(_DWORD *)(a1 + 2736) )
      {
        do
        {
          result = ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C00B2040)(
                     *(_QWORD *)(a1 + 5752),
    ...
    {
      return ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_1C00B2040)(
               *(_QWORD *)(a1 + 5752),
               *(_QWORD *)(a1 + 32),
               0LL);
    }
