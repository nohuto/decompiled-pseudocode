/*
 * XREFs of ?GetAnalogExclusive@CompositionSurfaceObject@@QEAA_NXZ @ 0x1C001C288
 * Callers:
 *     ?SignalFlipImmediate@CFlipToken@@UEAAXXZ @ 0x1C001C190 (-SignalFlipImmediate@CFlipToken@@UEAAXXZ.c)
 * Callees:
