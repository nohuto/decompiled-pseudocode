/*
 * XREFs of ?SignalRenderKmMonitoredFence@DXGCONTEXT@@CAJPEAU_DXGKARG_RENDER@@PEAV1@PEAVDXGHWQUEUE@@_K@Z @ 0x1C028F33C
 * Callers:
        ...
        D3DGPU_VIRTUAL_ADDRESS a4)
{
  ...
  void *v10; // rdx
  __int64 result; // rax
  struct _DXGKARG_SIGNALMONITOREDFENCE v12; // [rsp+20h] [rbp-50h] BYREF
  ...
  *(&v12.DmaSize + 1) = 0;
  ...
  v12.MonitoredFenceValue = *((_QWORD *)a2 + 31);
