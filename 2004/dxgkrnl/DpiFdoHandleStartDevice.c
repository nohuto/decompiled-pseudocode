/*
 * XREFs of DpiFdoHandleStartDevice @ 0x1C0191F90
 * Callers:
 *     <none>
 * Callees:
 *     DpiCheckForOutstandingD3Requests @ 0x1C001E440 (DpiCheckForOutstandingD3Requests.c)
 *     WindowsQueryLicenseDWORD @ 0x1C0022F70 (WindowsQueryLicenseDWORD.c)
...
LABEL_40:
        if ( byte_1C00B1B59 )
          KeSetEvent(&stru_1C00B1B60, 0, 0);
LABEL_21:
        if ( byte_1C00B1B5A && !*(_BYTE *)(DeviceExtension + 1158) )
        {
          ThreadHandle = 0LL;
