/*
 * XREFs of ?Initialize@VIDPNSOURCEINFO@@QEAAJPEAVDXGADAPTER@@I@Z @ 0x1C02BB038
 * Callers:
 ...
 *     ?IsPointerVisible@ADAPTER_DISPLAY@@QEBAEI@Z @ 0x1C001A7F4 (-IsPointerVisible@ADAPTER_DISPLAY@@QEBAEI@Z.c)
 ...
 *     ?RtlStringCchCopyA@@YAJPEAD_KPEBD@Z @ 0x1C004D1B0 (-RtlStringCchCopyA@@YAJPEAD_KPEBD@Z.c)
...
__int64 __fastcall VIDPNSOURCEINFO::Initialize(VIDPNSOURCEINFO *this, struct DXGADAPTER *a2, unsigned int a3)
{
  ...
  *((_DWORD *)this + 7) ^= (*((_DWORD *)this + 7) ^ (ADAPTER_DISPLAY::IsEmulatedVidPnSourceOwner(
                                                       *((DXGADAPTER ***)a2 + 337),
                                                       ...
                                                       v3) << 15)) & 0x8000;
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v27, (struct DXGFASTMUTEX *const)(v7 + 65), 0);
