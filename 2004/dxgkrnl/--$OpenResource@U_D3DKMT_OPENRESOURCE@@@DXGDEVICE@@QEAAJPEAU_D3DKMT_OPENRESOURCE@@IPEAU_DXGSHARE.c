/*
 * XREFs of ??$OpenResource@U_D3DKMT_OPENRESOURCE@@@DXGDEVICE@@QEAAJPEAU_D3DKMT_OPENRESOURCE@@IPEAU_DXGSHAREDALLOCOBJECT@@IPEAVCOREDEVICEACCESS@@HPEAU_EPROCESS@@PEAIPEA_K@Z @ 0x1C0115C38
 * Callers:
...
LABEL_57:
  ...
  {
    v65 = *(_QWORD *)(*(_QWORD *)&this->SupportedReadSegmentSet + 88LL);
    if ( v65 )
    {
