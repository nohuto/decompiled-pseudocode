/*
 * XREFs of ?EnsureGdiOutput@ADAPTER_DISPLAY@@QEAAXPEAVDXGDEVICE@@PEAVCOREDEVICEACCESS@@PEAE2PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C01493BC
 * Callers:
 ...
 *     ??1ADAPTEROWNERTRACKER@@QEAA@XZ @ 0x1C000CEB8 (--1ADAPTEROWNERTRACKER@@QEAA@XZ.c)
