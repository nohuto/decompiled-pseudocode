/*
 * XREFs of ??1ADAPTER_DISPLAY@@QEAA@XZ @ 0x1C02105F8
 * Callers:
 *     ??_GADAPTER_DISPLAY@@QEAAPEAXI@Z @ 0x1C0036060 (--_GADAPTER_DISPLAY@@QEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ?DestroyOutputDuplManager@@YAJPEAVOUTPUTDUPL_MGR@@@Z @ 0x1C0298EE8 (-DestroyOutputDuplManager@@YAJPEAVOUTPUTDUPL_MGR@@@Z.c)
 */
...
void __fastcall ADAPTER_DISPLAY::~ADAPTER_DISPLAY(ADAPTER_DISPLAY *this, __int64 a2)
{
  ...
  v8 = (struct _KEVENT *)*((_QWORD *)this + 70);
  if ( v8 )
  {
    KeSetEvent(v8, 0, 0);
    ObfDereferenceObject(*((PVOID *)this + 70));
    *((_QWORD *)this + 70) = 0LL;
  }
  if ( *((ADAPTER_DISPLAY **)this + 76) != (ADAPTER_DISPLAY *)((char *)this + 608) )
  {
    v9 = WdLogNewEntry5_WdAssertion(v8, a2);
    *(_QWORD *)(v9 + 24) = 953LL;
    WdLogEvent5_WdAssertion(v9);
  }
  DXGFASTMUTEX::~DXGFASTMUTEX((ADAPTER_DISPLAY *)((char *)this + 568), a2);
  DXGFASTMUTEX::~DXGFASTMUTEX((ADAPTER_DISPLAY *)((char *)this + 520), v10);
  DXGFASTMUTEX::~DXGFASTMUTEX((ADAPTER_DISPLAY *)((char *)this + 456), v11);
  DXGFASTMUTEX::~DXGFASTMUTEX((ADAPTER_DISPLAY *)((char *)this + 400), v12);
  DXGFASTMUTEX::~DXGFASTMUTEX((ADAPTER_DISPLAY *)((char *)this + 320), v13);
