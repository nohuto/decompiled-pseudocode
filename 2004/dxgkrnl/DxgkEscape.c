/*
 * XREFs of DxgkEscape @ 0x1C00F8350
 * Callers:
 ...
 *     DxgkGetAdapterMiracastInfo @ 0x1C0054594 (DxgkGetAdapterMiracastInfo.c)
 ...
 *     DxgkWriteUserModeDiagEntry @ 0x1C0226F6C (DxgkWriteUserModeDiagEntry.c)
 ...
 *     ?TdrDbgCtrl@@YAJW4_TDR_DBG_CTRL@@@Z @ 0x1C02656A8 (-TdrDbgCtrl@@YAJW4_TDR_DBG_CTRL@@@Z.c)
 ...
 *     ?IsAMDDriverEscapeAllowed@@YAHPEAX_K@Z @ 0x1C0267D68 (-IsAMDDriverEscapeAllowed@@YAHPEAX_K@Z.c)
...
LABEL_72:
        ...
        v126 = v219;
        if ( v219 && *((_BYTE *)v219 + 209) )
        {
          if ( (v64 = v219, v222 = v219, v211.Type == D3DKMT_ESCAPE_DRIVERPRIVATE)
...
LABEL_327:
          ...
          case D3DKMT_ESCAPE_VIDMM:
            ...
            if ( *v13 != 16 )
            {
              LODWORD(v29) = (*(__int64 (__fastcall **)(_QWORD, __int64, int *, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v219 + 338) + 640LL) + 8LL)
                                                                                        + 40LL))(
...
LABEL_361:
          ...
          case D3DKMT_ESCAPE_OUTPUTDUPL_SNAPSHOT:
            ...
            if ( v221 )
              LODWORD(v29) = OutputDuplGetDebugInfo(0LL, (struct _D3DKMT_OUTPUTDUPL_SNAPSHOT *)v13);
            else
              LODWORD(v29) = OutputDuplGetDebugInfo(v64, (struct _D3DKMT_OUTPUTDUPL_SNAPSHOT *)v13);
            goto LABEL_554;
          case D3DKMT_ESCAPE_OUTPUTDUPL_DIAGNOSTICS:
            ...
            if ( v221 )
              LODWORD(v29) = OutputDuplGetDiagnosticBuffer(0LL, (struct _D3DKMT_OUTPUTDUPL_DIAGNOSTICS *)v13);
            else
              LODWORD(v29) = OutputDuplGetDiagnosticBuffer(v64, (struct _D3DKMT_OUTPUTDUPL_DIAGNOSTICS *)v13);
            goto LABEL_554;
...
LABEL_553:
          ...
          case D3DKMT_ESCAPE_HISTORY_BUFFER_STATUS:
            ...
            {
              v179 = 0;
              if ( (qword_1C00B09B0 & 0x61C8ED7) != 0
                && (qword_1C00B09B8 & 0xFFFFFFFFF9E37128uLL) == 0
                && (qword_1C00B09B0 & 0x4000) != 0 )
              {
