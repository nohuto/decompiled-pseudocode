/*
 * XREFs of DpiPowerArbiterThread @ 0x1C0196790
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DpiGetPowerActionQueueEntry@@YAPEAU_LIST_ENTRY@@PEAU_FDO_CONTEXT@@@Z @ 0x1C001FC18 (-DpiGetPowerActionQueueEntry@@YAPEAU_LIST_ENTRY@@PEAU_FDO_CONTEXT@@@Z.c)
 *     _guard_dispatch_icall_nop @ 0x1C00271E0 (_guard_dispatch_icall_nop.c)
 *     DpiSetDevicePowerTransitionStateAtPassiveLevel @ 0x1C0050E4C (DpiSetDevicePowerTransitionStateAtPassiveLevel.c)
 *     ?DpiFinishSuspendAdapter@@YAXPEAU_FDO_CONTEXT@@@Z @ 0x1C00510FC (-DpiFinishSuspendAdapter@@YAXPEAU_FDO_CONTEXT@@@Z.c)
 *     ?DpiStartSuspendingAdapter@@YAEPEAU_FDO_CONTEXT@@@Z @ 0x1C0051218 (-DpiStartSuspendingAdapter@@YAEPEAU_FDO_CONTEXT@@@Z.c)
 *     DxgkReleaseAdapterCoreSync @ 0x1C011F19C (DxgkReleaseAdapterCoreSync.c)
 *     DpiIsPowerRuntimeDStateTransition @ 0x1C011F4CC (DpiIsPowerRuntimeDStateTransition.c)
 ...
 *     DxgkSuspendMemorySegments @ 0x1C0217B7C (DxgkSuspendMemorySegments.c)
