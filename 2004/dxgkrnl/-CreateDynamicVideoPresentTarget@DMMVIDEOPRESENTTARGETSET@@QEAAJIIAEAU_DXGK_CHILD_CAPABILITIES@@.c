/*
 * XREFs of ?CreateDynamicVideoPresentTarget@DMMVIDEOPRESENTTARGETSET@@QEAAJIIAEAU_DXGK_CHILD_CAPABILITIES@@EPEAW4_CONNECTION_CHANGE_FAILURE_REASON@@@Z @ 0x1C02E564C
 * Callers:
...
LABEL_18:
  ...
  if ( v57 )
  {
    ...
    if ( v64 >= 0 )
    {
      ...
      if ( v69 >= 0 )
      {
        DMMVIDEOPRESENTTARGET::AddChildTarget(TargetById, v57);
        ReferenceCounted::Release((DMMVIDEOPRESENTTARGET *)((char *)v57 + 64), v74);
        return 0LL;
      }
    ...
    else
    {
      *(_DWORD *)a6 = -2147483647;
      v67 = WdLogNewEntry5_WdError(v65, a6);
      *(_QWORD *)(v67 + 24) = v6;
      *(_QWORD *)(v67 + 32) = v66;
