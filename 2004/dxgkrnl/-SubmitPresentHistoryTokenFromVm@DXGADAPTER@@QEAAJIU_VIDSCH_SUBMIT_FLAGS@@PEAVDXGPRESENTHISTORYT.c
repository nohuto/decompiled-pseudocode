/*
 * XREFs of ?SubmitPresentHistoryTokenFromVm@DXGADAPTER@@QEAAJIU_VIDSCH_SUBMIT_FLAGS@@PEAVDXGPRESENTHISTORYTOKENQUEUE@@PEAU_D3DKMT_PRESENTHISTORYTOKEN@@2PEAVCRefCountedBuffer@@II3K@Z @ 0x1C023AF74
 * Callers:
 ...
 *     ?GetSizeOfPresentToken@@YAIPEBU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x1C027FB54 (-GetSizeOfPresentToken@@YAIPEBU_D3DKMT_PRESENTHISTORYTOKEN@@@Z.c)
 ...
 *     ?GetPresentHistoryTokenSlot@DXGPRESENTHISTORYTOKENQUEUE@@QEAAPEAU_D3DKMT_PRESENTHISTORYTOKEN@@XZ @ 0x1C0283994 (-GetPresentHistoryTokenSlot@DXGPRESENTHISTORYTOKENQUEUE@@QEAAPEAU_D3DKMT_PRESENTHISTORYTOKEN@@XZ.c)
        ...
        if ( a9 )
        {
          if ( Src )
          {
            ...
            if ( (_DWORD)Size )
            {
              ...
              {
                DXGADAPTERSTOPRESETLOCKSHARED::Release((DXGADAPTERSTOPRESETLOCKSHARED *)v63);
                COREDEVICEACCESS::Release((COREDEVICEACCESS *)v82, v42);
                ...
                DXGADAPTERSTOPRESETLOCKSHARED::Acquire((DXGADAPTERSTOPRESETLOCKSHARED *)v63);
                COREDEVICEACCESS::AcquireSharedUncheck((COREDEVICEACCESS *)v82, v45);
                if ( PresentHistoryTokenSlot )
                {
                  ...
                  *((_QWORD *)v32 + 13) = PresentHistoryTokenSlot;
                  ...
                  v46 = PrepareIndependentFlipToken(
                  ...
                  if ( v46 < 0 )
                  {
                    v48 = WdLogNewEntry5_WdWarning(v38, v34, v47);
                    *(_QWORD *)(v48 + 24) = v30;
    ...
    *((_QWORD *)v32 + 96) = a7;
    if ( v37 )
    {
      if ( (*((_DWORD *)v37 + 105) & 0x10) != 0
        && (v50 = DXGCONTEXT::SynchronizeImplicitQueueWithRenderQueues(v37, 0LL, 0, 1, 0LL, 1), v30 = v50, v50 < 0) )
      {
    ...
    v54 = (PERESOURCE *)DXGGLOBAL::GetGlobal(v38, v34);
    DXGSYNCOBJECTLOCK::DXGSYNCOBJECTLOCK((DXGSYNCOBJECTLOCK *)v77, v54, 0);
    DXGSYNCOBJECTLOCK::AcquireShared((DXGSYNCOBJECTLOCK *)v77, v55);
    DXGPUSHLOCK::AcquireShared((DXGPUSHLOCK *)(v19 + 26));
    if ( v67 < *((_DWORD *)v19 + 64) )
    {
      v56 = v19[30];
      v57 = *((_DWORD *)v56 + 4 * v67 + 2);
      if ( ((v12 >> 25) & 0x60) == (*((_BYTE *)v56 + 16 * v67 + 8) & 0x60) && (v57 & 0x2000) == 0 && (v57 & 0x1F) != 0 )
      {
        v58 = v57 & 0x1F;
        if ( (_BYTE)v58 == 11 )
        {
          v60 = *((_QWORD *)v56 + 2 * v67);
          goto LABEL_51;
        }
        v59 = WdLogNewEntry5_WdError(v58, v56);
        *(_QWORD *)(v59 + 24) = 267LL;
...
LABEL_51:
    ...
    if ( !v60 || *(_QWORD *)(v60 + 16) == v15 )
    {
      VidSchSyncObject = DXGSYNCOBJECT::GetVidSchSyncObject(
                           *(DXGSYNCOBJECT **)(v60 + 32),
                           *(struct ADAPTER_RENDER **)(*(_QWORD *)(v60 + 16) + 16LL));
