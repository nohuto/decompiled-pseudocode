/*
 * XREFs of ?EDIDV1_ObtainMonitorColorCharacteristics@@YAJPEBEPEAU_WmiMonitorColorCharacteristics@@@Z @ 0x1C005EBB4
 * Callers:
 ...
 *     ?GetWmiColorCharacteristics@EDID_PARSER@MonDescParser@@QEBAJAEAU_WmiMonitorColorCharacteristics@@@Z @ 0x1C0060B28 (-GetWmiColorCharacteristics@EDID_PARSER@MonDescParser@@QEBAJAEAU_WmiMonitorColorCharacteristics@.c)
 */
