/*
 * XREFs of ?VmBusCreateProcessCblt@DXG_HOST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C00D7950
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IncrementNumVmProcesses@DXGVIRTUALMACHINE@@QEAAJXZ @ 0x1C0285120 (-IncrementNumVmProcesses@DXGVIRTUALMACHINE@@QEAAJXZ.c)
