/*
 * XREFs of ?_PrepareMonitorCCDName@DXGMONITOR@@AEAAJXZ @ 0x1C018A19C
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1C0024390 (__report_rangecheckfailure.c)
 ...
 *     MonitorUnifyCCDMonitorString @ 0x1C01821A8 (MonitorUnifyCCDMonitorString.c)
...
LABEL_25:
          ...
          if ( Flink )
          {
            ...
            *(_WORD *)(v38 + 2 * v34 + 24) = 0;
            v46 = (__int64 *)qword_1C00B2E68;
            if ( *(struct _LIST_ENTRY **)qword_1C00B2E68 != &DXGMONITOR::_UniqueEntryList )
              __fastfail(3u);
