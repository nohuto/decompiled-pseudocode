/*
 * XREFs of ?VmBusCreateAllocation@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C023D6C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_72:
  ...
  *((_DWORD *)&v95.Flags + 1) = 0;
  ...
  v42 = DxgkCreateAllocationInternal(&v95, (unsigned __int64 *)v90, v38);
  v45 = v42;
  if ( v42 < 0 )
  {
    v34 = WdLogNewEntry5_WdError(v44, v43);
    *(_QWORD *)(v34 + 24) = v45;
    *(_QWORD *)(v34 + 32) = 1194LL;
LABEL_69:
