/*
 * XREFs of ?DxgkpAdapterCheckStereoMode@@YAJU_LUID@@IPEAE1@Z @ 0x1C00DD284
 * Callers:
 ...
 *     ?GetCachedStereoStates@ADAPTER_DISPLAY@@QEBAJIPEAE0@Z @ 0x1C00DD7E8 (-GetCachedStereoStates@ADAPTER_DISPLAY@@QEBAJIPEAE0@Z.c)
...
LABEL_54:
    ...
    if ( !ADAPTER_DISPLAY::IsPartOfDesktop(*((ADAPTER_DISPLAY **)v52 + 337), v54.VidPnSourceId) )
    {
      v31 = (_QWORD *)WdLogNewEntry5_WdDmmEvent();
      LOBYTE(v4) = v52 != 0LL;
      v31[3] = v4;
        ...
        if ( (int)v34 >= 0 )
        {
          if ( v33 )
          {
            if ( !DXGADAPTER::IsCoreResourceExclusiveOwner((PERESOURCE *)v64) )
            {
              ...
              v42 = COREADAPTERACCESS::AcquireExclusive((__int64)v63, v30);
              v43 = v42;
              if ( v42 < 0 )
              {
...
LABEL_27:
        ...
        {
          DisplayModeInfo = ADAPTER_DISPLAY::GetDisplayModeInfo(*((ADAPTER_DISPLAY **)v52 + 337), v54.VidPnSourceId);
          pModeList = v54.pModeList;
          v40 = 0;
          if ( v54.ModeCount )
          {
