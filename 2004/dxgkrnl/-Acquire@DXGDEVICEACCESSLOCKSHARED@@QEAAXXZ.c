/*
 * XREFs of ?Acquire@DXGDEVICEACCESSLOCKSHARED@@QEAAXXZ @ 0x1C0024800
 * Callers:
 ...
 *     ?ReleasePowerTransitionLockShared@ADAPTER_RENDER@@QEAAXXZ @ 0x1C00245C0 (-ReleasePowerTransitionLockShared@ADAPTER_RENDER@@QEAAXXZ.c)
