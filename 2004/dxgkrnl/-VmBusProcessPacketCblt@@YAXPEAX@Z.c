/*
 * XREFs of ?VmBusProcessPacketCblt@@YAXPEAX@Z @ 0x1C00D91C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetErrorState@DXG_VMBUS_CHANNEL_BASE@@QEAAXXZ @ 0x1C023AF4C (-SetErrorState@DXG_VMBUS_CHANNEL_BASE@@QEAAXXZ.c)
 */
