/*
 * XREFs of ?Initialize@DXGOVERLAY@@QEAAJPEAU_D3DKMT_CREATEOVERLAY@@@Z @ 0x1C027A218
 * Callers:
 ...
 *     ?AcquireOverlayId@ADAPTER_RENDER@@QEAAIPEAVDXGOVERLAY@@@Z @ 0x1C021566C (-AcquireOverlayId@ADAPTER_RENDER@@QEAAIPEAVDXGOVERLAY@@@Z.c)
...
__int64 __fastcall DXGOVERLAY::Initialize(DXGOVERLAY *this, struct _D3DKMT_CREATEOVERLAY *a2)
{
  ...
  {
    v7 = ADAPTER_RENDER::AcquireOverlayId(*(ADAPTER_RENDER **)(v5 + 2704), this);
    *((_DWORD *)this + 8) = v7;
    if ( v7 == -1 )
    {
...
LABEL_33:
    ...
    if ( (v26 & 8) != 0 && (v40[0][9].Count & 0x800) != 0 )
    {
      ...
      v33 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v28 + 16) + 16LL) + 2704LL);
