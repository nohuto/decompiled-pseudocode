/*
 * XREFs of ?CreateAdapter@DXGGLOBAL@@QEAAJPEAU_DEVICE_OBJECT@@PEAPEAVDXGADAPTER@@PEAXPEAU_DXGK_ADAPTER_CAPS@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C017890C
 * Callers:
 ...
 *     DxgkDetermineAffectedSession @ 0x1C01785CC (DxgkDetermineAffectedSession.c)
