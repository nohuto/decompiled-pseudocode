/*
 * XREFs of DxgkUseAdapterViewInCurrentSession @ 0x1C014C304
 * Callers:
 ...
 *     ?AddDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z @ 0x1C014C504 (-AddDisplaySource@SESSION_ADAPTER@@QEAAJPEAVDISPLAY_SOURCE@@@Z.c)
