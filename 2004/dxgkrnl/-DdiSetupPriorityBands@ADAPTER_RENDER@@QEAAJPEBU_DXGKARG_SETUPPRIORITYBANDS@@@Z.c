/*
 * XREFs of ?DdiSetupPriorityBands@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_SETUPPRIORITYBANDS@@@Z @ 0x1C021F84C
 * Callers:
 *     ?ADAPTER_RENDER_DdiSetupPriorityBands@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETUPPRIORITYBANDS@@@Z @ 0x1C00415E0 (-ADAPTER_RENDER_DdiSetupPriorityBands@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_SETUPPRIORITYBANDS@@@.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  __int64 v14; // rdx
  __int64 v15; // rcx
  __int64 (__fastcall *v16)(_QWORD, const struct _DXGKARG_SETUPPRIORITYBANDS *); // rax
  int v17; // ebx
  __int64 v18; // rcx
  _QWORD *v19; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v28, 5115LL);
  ...
  v15 = *((_QWORD *)this + 2);
  v16 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETUPPRIORITYBANDS *))(v15 + 1200);
  if ( v16 )
