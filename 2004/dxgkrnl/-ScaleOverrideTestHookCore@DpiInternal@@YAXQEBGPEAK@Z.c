/*
 * XREFs of ?ScaleOverrideTestHookCore@DpiInternal@@YAXQEBGPEAK@Z @ 0x1C000C1BC
 * Callers:
 *     ?ScaleOverrideTestHook@@YAXQEBGPEAK@Z @ 0x1C000C198 (-ScaleOverrideTestHook@@YAXQEBGPEAK@Z.c)
 * Callees:
