/*
 * XREFs of ?EnableClockCalibration@ADAPTER_RENDER@@QEAAXE@Z @ 0x1C011F2D0
 * Callers:
 ...
 *     ?IsClockCalibrationSupported@ADAPTER_RENDER@@QEBAEXZ @ 0x1C0007ABC (-IsClockCalibrationSupported@ADAPTER_RENDER@@QEBAEXZ.c)
 */
