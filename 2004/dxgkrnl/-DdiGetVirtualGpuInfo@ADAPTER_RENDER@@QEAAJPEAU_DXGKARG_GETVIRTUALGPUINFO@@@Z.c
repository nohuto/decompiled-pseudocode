/*
 * XREFs of ?DdiGetVirtualGpuInfo@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z @ 0x1C0233320
 * Callers:
 *     ?GetVirtualGpuInfo@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z @ 0x1C0237470 (-GetVirtualGpuInfo@DXGK_VIRTUAL_GPU_GPUP@@UEAAJPEAU_DXGKARG_GETVIRTUALGPUINFO@@@Z.c)
 * Callees:
