/*
 * XREFs of ?PostNewMessage@CDWMBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z @ 0x1C006C9D0
 * Callers:
 *     <none>
 * Callees:
 *     ??$FindProperty@UPresentConfirmedStatistics@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentConfirmedStatistics@@@Z @ 0x1C006C7AC (--$FindProperty@UPresentConfirmedStatistics@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentConfirmed.c)
 *     ?PostNewMessage@CBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z @ 0x1C006CB90 (-PostNewMessage@CBackchannelManager@@UEAAXPEAVCFlipConsumerMessage@@@Z.c)
 */
