/*
 * XREFs of ?AcquireTargetSet@DXGDMM_INTERFACE_V1_IMPL@@YAJQEAXPEAPEAUD3DKMDT_HVIDEOPRESENTTARGETSET__@@PEAPEBU_DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE@@@Z @ 0x1C02E2250
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _DXGDMM_VIDEOPRESENTTARGETSET_INTERFACE **a4)
{
  ...
  struct D3DKMDT_HVIDEOPRESENTTARGETSET__ *v24; // [rsp+58h] [rbp+10h]
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v21, 6050LL);
  if ( a2 && a3 )
  {
    *a2 = 0LL;
    *a3 = 0LL;
    if ( this )
    {
      ...
      {
        v17 = *(_QWORD *)(v16 + 88);
        v24 = *(struct D3DKMDT_HVIDEOPRESENTTARGETSET__ **)(v17 + 416);
