/*
 * XREFs of ?_ResolveCloneGroupOnAdapter@CCD_BTL_CLONE_GROUP_RESOLVER@@AEAAJPEAVDXGADAPTER@@IPEAVDMMVIDPN@@@Z @ 0x1C012C52C
 * Callers:
 ...
 *     ?QueryCloneInfo@CCD_SET_STRING_ID@@QEBAJIPEAI00@Z @ 0x1C012C838 (-QueryCloneInfo@CCD_SET_STRING_ID@@QEBAJIPEAI00@Z.c)
 ...
 *     ?QueryUnicodeMonitorId@CCD_SET_STRING_ID@@QEBAJIPEAU_UNICODE_STRING@@@Z @ 0x1C012CC84 (-QueryUnicodeMonitorId@CCD_SET_STRING_ID@@QEBAJIPEAU_UNICODE_STRING@@@Z.c)
 */
...
LABEL_42:
        ...
        v26 = 272LL * v14;
        LOBYTE(v25) = -(char)v53;
        *(_DWORD *)((char *)this[1] + v26 + 76) = v46;
        *(_DWORD *)((char *)this[1] + v26 + 136) = v49;
        *(_DWORD *)((char *)this[1] + v26 + 140) = v50;
        *((_BYTE *)this[1] + v26 + 177) = ((_BYTE)v25 != 0 ? 2 : 0) | (v45[0] != 0);
        *(_DWORD *)((char *)this[1] + v26 + 232) = v51 | 0xFE520000;
        *(_QWORD *)((char *)this[1] + v26 + 48) |= 0xCC00000000000uLL;
        if ( v4 )
        {
          if ( PathSourceFromTarget == -1 )
          {
            PathSourceFromTarget = DMMVIDPNTOPOLOGY::GetPathSourceFromTarget(
                                     (struct DMMVIDPN *)((char *)v4 + 96),
                                     v46,
                                     v25);
            if ( PathSourceFromTarget != -1 )
            {
