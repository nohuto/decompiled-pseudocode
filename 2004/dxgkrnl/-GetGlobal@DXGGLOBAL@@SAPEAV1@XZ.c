 ...
 *     DxgkGetPresenterViewMode @ 0x1C0166900 (DxgkGetPresenterViewMode.c)
 ...
 *     ?DxgkGetBootAnimationRelayState@@YA?AW4_CDD_BOOT_ANIMATION_RELAY_STATE@@XZ @ 0x1C0169C80 (-DxgkGetBootAnimationRelayState@@YA-AW4_CDD_BOOT_ANIMATION_RELAY_STATE@@XZ.c)
 *     DxgkGetGpuUsageStatistics @ 0x1C0169CA0 (DxgkGetGpuUsageStatistics.c)
 ...
 *     ?VmBusWnfNotification@DXG_GUEST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C0250E20 (-VmBusWnfNotification@DXG_GUEST_GLOBAL_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z.c)
