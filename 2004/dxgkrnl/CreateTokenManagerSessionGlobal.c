/*
 * XREFs of CreateTokenManagerSessionGlobal @ 0x1C001ADF8
 * Callers:
 ...
 *     ??_GCTokenManager@@AEAAPEAXI@Z @ 0x1C0012C68 (--_GCTokenManager@@AEAAPEAXI@Z.c)
 *     ?Initialize@CTokenManager@@AEAAJXZ @ 0x1C001AE78 (-Initialize@CTokenManager@@AEAAJXZ.c)
 *     ??0CTokenManager@@AEAA@XZ @ 0x1C001AFD4 (--0CTokenManager@@AEAA@XZ.c)
 */
