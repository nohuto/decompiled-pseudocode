/*
 * XREFs of DxgNotifyInterruptCB @ 0x1C000D7B0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00271E0 (_guard_dispatch_icall_nop.c)
 *     DpiProcessMiracastNotifyInterrupt @ 0x1C00543B4 (DpiProcessMiracastNotifyInterrupt.c)
 *     ?NotifyInterrupt@DXGDODPRESENT@@QEAAXPEAVDXGADAPTER@@PEAU_DXGKARGCB_NOTIFY_INTERRUPT_DATA@@@Z @ 0x1C005E198 (-NotifyInterrupt@DXGDODPRESENT@@QEAAXPEAVDXGADAPTER@@PEAU_DXGKARGCB_NOTIFY_INTERRUPT_DATA@@@Z.c)
 */
    ...
    if ( (_InterlockedCompareExchange((volatile signed __int32 *)(v4 + 3916), 0, 0) & 2) != 0 )
    {
      ...
      if ( v5 && *(_DWORD *)(v5 + 16) == 1953656900 && *(_DWORD *)(v5 + 20) == 2 )
      {
        ...
        if ( v6 )
        {
          ...
          {
            v9 = *(DXGDODPRESENT **)(*((_QWORD *)v6 + 337) + 384LL);
            if ( v9 )
