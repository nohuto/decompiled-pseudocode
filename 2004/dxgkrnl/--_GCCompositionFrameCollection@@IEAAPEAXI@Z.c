/*
 * XREFs of ??_GCCompositionFrameCollection@@IEAAPEAXI@Z @ 0x1C000D95C
 * Callers:
 *     ?Release@CCompositionFrameCollection@@UEAAJXZ @ 0x1C000D930 (-Release@CCompositionFrameCollection@@UEAAJXZ.c)
 * Callees:
