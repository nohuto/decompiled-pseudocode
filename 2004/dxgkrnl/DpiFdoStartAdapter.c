/*
 * XREFs of DpiFdoStartAdapter @ 0x1C0182794
 * Callers:
 *     DpiFdoStartAdapterThreadImpl @ 0x1C0183850 (DpiFdoStartAdapterThreadImpl.c)
 *     DpiLdaStartAdapterInChain @ 0x1C02D7EB8 (DpiLdaStartAdapterInChain.c)
 * Callees:
 ...
 *     DxgkDiagCalcDuration1us @ 0x1C001FE34 (DxgkDiagCalcDuration1us.c)
 ...
 *     DpiFdoInitializeDisplayDiagnostics @ 0x1C00215DC (DpiFdoInitializeDisplayDiagnostics.c)
 *     DpiFdoCleanupDisplayDiagnostics @ 0x1C0021658 (DpiFdoCleanupDisplayDiagnostics.c)
 *     DpiHybridInternalPanelOverride @ 0x1C0021760 (DpiHybridInternalPanelOverride.c)
 *     ?DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z @ 0x1C002180C (-DpiFdoSetAdapterLuid@@YAJPEAU_FDO_CONTEXT@@@Z.c)
 ...
 *     DxgkAddAdapter @ 0x1C0177590 (DxgkAddAdapter.c)
 *     DxgkRetrieveStringFromRegistry @ 0x1C017A240 (DxgkRetrieveStringFromRegistry.c)
 *     DpiOpenPnpRegistryKey @ 0x1C017B090 (DpiOpenPnpRegistryKey.c)
 ...
 *     DpiFdoIsCompatibleWithHighResolutionBoot @ 0x1C01989B8 (DpiFdoIsCompatibleWithHighResolutionBoot.c)
 ...
 *     ?LPMDisplayRegisterInternalDisplay@@YAXPEAXI@Z @ 0x1C0275BD0 (-LPMDisplayRegisterInternalDisplay@@YAXPEAXI@Z.c)
 ...
 *     DpiFdoDisconnectInterrupt @ 0x1C02C891C (DpiFdoDisconnectInterrupt.c)
 *     DpiFdoRemoveChildDescriptors @ 0x1C02CB7FC (DpiFdoRemoveChildDescriptors.c)
...
LABEL_126:
  ...
  *(_QWORD *)&v197[5] = *((_QWORD *)DeviceExtension + 334);
  qword_1C00B1E70 = (__int64)KeGetCurrentThread();
  qword_1C00B1E78 = (__int64)a1;
    ...
    *(_QWORD *)(v113 + 32) = started;
    ...
    if ( (_DWORD)started != -1071775735 )
    {
      if ( (_DWORD)started == -1071774944 && DeviceExtension[1152] )
      {
        ...
        v117[4] = 26LL;
        v117[5] = v11;
        v118 = (unsigned __int8)byte_1C00B1B16;
        v117[7] = 0LL;
        v117[6] = v118;
...
LABEL_122:
  ...
  if ( DeviceExtension[1152] )
  {
    xmmword_1C00B1DD8 = 0LL;
    DWORD2(xmmword_1C00B1DD8) = -1;
    xmmword_1C00B1DC8 = 0LL;
    memset(&xmmword_1C00B1DE8, 0, 0x80uLL);
    dword_1C00B1E68 = 3;
  }
...
LABEL_41:
  ...
  {
    v42 = qword_1C00B1B20;
    if ( qword_1C00B1B20 && (struct _DEVICE_OBJECT *)qword_1C00B1B20 != a1 )
    {
      if ( !*(_BYTE *)(v9 + 2692) || (_BYTE)word_1C00B1B1D )
      {
        *v39 &= ~0x40u;
        goto LABEL_42;
      }
      *(_BYTE *)(*(_QWORD *)(qword_1C00B1B20 + 64) + 3904LL) &= ~0x40u;
    }
    qword_1C00B1B20 = (__int64)a1;
    HIBYTE(word_1C00B1B1D) = (*(_BYTE *)(v9 + 3905) & 2) != 0;
  }
LABEL_42:
  if ( qword_1C00B1B28 )
  {
    v20 = (struct _LUID *)qword_1C00B1B20;
    if ( qword_1C00B1B20 )
    {
      if ( !(_BYTE)word_1C00B1B1D )
      {
        LOBYTE(v42) = *(_BYTE *)(*(_QWORD *)(qword_1C00B1B28 + 64) + 2692LL);
        if ( *(_BYTE *)(*(_QWORD *)(qword_1C00B1B20 + 64) + 2692LL) )
        {
          if ( !(_BYTE)v42 )
            goto LABEL_186;
        }
        ...
        {
LABEL_186:
          LOBYTE(word_1C00B1B1D) = 0;
          goto LABEL_43;
        }
        LOBYTE(word_1C00B1B1D) = 1;
        *((_BYTE *)DXGGLOBAL::GetGlobal(v42, qword_1C00B1B20) + 761) = 1;
      }
    }
  }
LABEL_43:
...
LABEL_74:
  ...
  if ( (int)started < 0 )
  {
    ...
    if ( v9 )
    {
      ...
      if ( (struct _DEVICE_OBJECT *)qword_1C00B1B20 == a1 )
      {
        qword_1C00B1B20 = 0LL;
        word_1C00B1B1D = 0;
      }
      if ( (struct _DEVICE_OBJECT *)qword_1C00B1B28 == a1 )
      {
        LOBYTE(word_1C00B1B1D) = 0;
        qword_1C00B1B28 = 0LL;
      }
