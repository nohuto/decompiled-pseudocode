/*
 * XREFs of ?CreateCompleted@CFlipToken@@SAJ_KPEAVCompositionSurfaceObject@@AEBU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@PEAPEAV1@@Z @ 0x1C0064004
 * Callers:
        ...
        struct CFlipToken **a4)
{
  ...
  *a4 = 0LL;
  ...
  v10 = (CFlipToken *)operator new[](0x250uLL, 0x6F744D54u, PagedPool);
  if ( v10 )
