/*
 * XREFs of ?SetPrimaryPath@ADAPTER_DISPLAY@@QEAAXIIW4_DXGK_PRIMARY_TARGET_TYPE@@@Z @ 0x1C0165280
 * Callers:
 ...
 *     DxgkSetPostDeviceCandidateTarget @ 0x1C0019AF0 (DxgkSetPostDeviceCandidateTarget.c)
 */
