/*
 * XREFs of DpiFdoHandleStopDevice @ 0x1C02CA270
 * Callers:
 ...
 *     DpiLdaStopAllAdaptersInChain @ 0x1C02D8094 (DpiLdaStopAllAdaptersInChain.c)
 */
  ...
  if ( (unsigned int)(*((_DWORD *)DeviceExtension + 60) - 5) <= 1 )
  {
    ...
    if ( v7 )
    {
      if ( v23 )
      {
        ...
        if ( dword_1C00B1E68 == 2 )
          DpiEnableMsBddFallbackDriver((__int64)v28, v24);
        if ( (struct _DEVICE_OBJECT *)qword_1C00B1DB8 == a1 )
          qword_1C00B1DB8 = 0LL;
