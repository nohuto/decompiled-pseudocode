/*
 * XREFs of ?_HandleCreatePhysicalMonitor@MONITOR_MGR@@QEAAJIPEAU_DEVICE_OBJECT@@EEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C018B2FC
 * Callers:
 *     MonitorCreatePhysicalMonitor @ 0x1C018B170 (MonitorCreatePhysicalMonitor.c)
 * Callees:
 *     McTemplateK0q_EtwWriteTransfer @ 0x1C0024458 (McTemplateK0q_EtwWriteTransfer.c)
 *     ?_ChangeLIDStatus@DXGMONITOR@@QEAAXE@Z @ 0x1C005D014 (-_ChangeLIDStatus@DXGMONITOR@@QEAAXE@Z.c)
 ...
 *     ?_RemoveMonitorFromList@MONITOR_MGR@@QEAAJPEAVDXGMONITOR@@@Z @ 0x1C018B6D4 (-_RemoveMonitorFromList@MONITOR_MGR@@QEAAJPEAVDXGMONITOR@@@Z.c)
 *     ?_InsertMonitorToList@MONITOR_MGR@@QEAAJPEAVDXGMONITOR@@@Z @ 0x1C018B770 (-_InsertMonitorToList@MONITOR_MGR@@QEAAJPEAVDXGMONITOR@@@Z.c)
 ...
 *     ?_UnregisterPnPTargetDeviceNotification@DXGMONITOR@@AEAAJXZ @ 0x1C02F93B8 (-_UnregisterPnPTargetDeviceNotification@DXGMONITOR@@AEAAJXZ.c)
 */
        ...
        struct _DXGK_DISPLAY_SCENARIO_CONTEXT *a6)
{
  ...
  if ( *((_BYTE *)this + 5) && (Microsoft_Windows_DxgKrnlEnableBits & 4) != 0 )
    McTemplateK0q_EtwWriteTransfer(
      ...
      v6);
  v8 = a6;
  MONITOR_MGR::_IssueMonitorEvent((struct _FAST_MUTEX *)this, v6, 0, 0LL, 1u, (__int64)a6);
  v45 = 0LL;
  ...
  if ( MonitorInstance >= 0 )
  {
    ...
    if ( *((_DWORD *)v17 + 108) == 1 )
    {
      if ( v48 && *((struct _DEVICE_OBJECT **)v17 + 7) == v47 )
      {
        ...
        v33 = this[1];
        if ( *(_DWORD *)(*((_QWORD *)v33 + 2) + 324LL) == 32902 )
        {
      ...
      v37 = v17;
      v17 = 0LL;
      MONITOR_MGR::_RemoveMonitorFromList((MONITOR_MGR *)this, v37);
    }
    else
    {
...
LABEL_14:
  ...
  if ( v23 >= 0 )
  {
    ...
    {
      MONITOR_MGR::_InsertMonitorToList((MONITOR_MGR *)this, v24);
    }
    if ( !MONITOR_MGR::_DelayNotifyClient )
    {
      if ( v13 )
        v12 = v13;
      return MONITOR_MGR::_HandleCreateMonitorStep2((MONITOR_MGR *)this, v6, v12, v24, v8);
    }
    if ( *((_QWORD *)v24 + 61) )
    {
  ...
  if ( v12 )
    MONITOR_MGR::_InsertMonitorToList((MONITOR_MGR *)this, v12);
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 4) != 0 )
    McTemplateK0q_EtwWriteTransfer(v21, &Dxgk_PerfTrack_DMM_Hotplug_Monitor_Set_VideoMode_Cancel, v22, v6);
