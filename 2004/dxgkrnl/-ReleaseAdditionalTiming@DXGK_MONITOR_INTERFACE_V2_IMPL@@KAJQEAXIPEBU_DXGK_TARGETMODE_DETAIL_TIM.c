/*
 * XREFs of ?ReleaseAdditionalTiming@DXGK_MONITOR_INTERFACE_V2_IMPL@@KAJQEAXIPEBU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z @ 0x1C01971C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
  ...
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(DxgAdapter) || (v19 = *((_QWORD *)v16 + 337)) == 0 )
  {
