/*
 * XREFs of ?SubmitSingleEntry@DXGDISPLAYCALLOUTQUEUE@@QEAAJPEAUDISPLAY_CALLOUT_ENTRY@@_K@Z @ 0x1C026BB68
 * Callers:
 ...
 *     DpiGdiAsyncDisplayCallout @ 0x1C02C61C4 (DpiGdiAsyncDisplayCallout.c)
 */
