/*
 * XREFs of MonitorGetCachedApiGammaRampForDiagnostics @ 0x1C02F36D4
 * Callers:
 ...
 *     ?GetCachedGammaRampForDiagnostics@DXGMONITOR@@QEAAJPEAU_DXGK_DIAG_BLACK_SCREEN_DXGKRNL_SAMPLED_GAMMA@@@Z @ 0x1C02FB134 (-GetCachedGammaRampForDiagnostics@DXGMONITOR@@QEAAJPEAU_DXGK_DIAG_BLACK_SCREEN_DXGKRNL_SAMPLED_G.c)
 */
