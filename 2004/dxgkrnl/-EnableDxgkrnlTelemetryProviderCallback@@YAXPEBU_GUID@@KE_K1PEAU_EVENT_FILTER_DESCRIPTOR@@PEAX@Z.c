/*
 * XREFs of ?EnableDxgkrnlTelemetryProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C0198AB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall EnableDxgkrnlTelemetryProviderCallback(const struct _GUID *a1, __int64 a2)
{
  ...
  if ( (_DWORD)a2 == 1 )
  {
    if ( (unsigned int)++dword_1C00B21CC <= 4 )
    {
LABEL_3:
    ...
    a2 = 864000000000LL;
    a1 = (const struct _GUID *)(MEMORY[0xFFFFF78000000014] - qword_1C00B21D0);
    if ( (unsigned __int64)(MEMORY[0xFFFFF78000000014] - qword_1C00B21D0) > 0xC92A69C000LL )
    {
      qword_1C00B21D0 = MEMORY[0xFFFFF78000000014];
      goto LABEL_3;
    }
  }
}
