/*
 * XREFs of ?FindBlockListStrings@@YAJPEAGIIPEBGW4_QAI_DRIVERVERSION@@PEAIPEAU_UNICODE_STRING@@@Z @ 0x1C017D374
 * Callers:
 ...
 *     wcscmp_0 @ 0x1C00271B8 (wcscmp_0.c)
...
LABEL_44:
                      if ( (v39 || v48)
                        && (unsigned int)dword_1C00B0A90 > 5
                        && tlgKeywordOn((__int64)&dword_1C00B0A90, 0x400000000200LL) )
                      {
                      ...
                      if ( v59[0] != (_BYTE)v20 && (unsigned int)dword_1C00B0A90 > 5 )
                      {
                        if ( tlgKeywordOn((__int64)&dword_1C00B0A90, 0x400000001000LL) )
                        {
                          v64 = a5;
                          v73 = v71;
