/*
 * XREFs of ?DxgkOpenAdapterFromLuidImpl@@YAJPEAU_D3DKMT_OPENADAPTERFROMLUID@@E@Z @ 0x1C0136A68
 * Callers:
 *     DxgkOpenAdapterFromLuid @ 0x1C0136A50 (DxgkOpenAdapterFromLuid.c)
 *     DxgkOpenAdapterFromLuidInternal @ 0x1C0151750 (DxgkOpenAdapterFromLuidInternal.c)
 * Callees:
 ...
 *     ?IsProcessGpuAccessBlocked@ADAPTER_RENDER@@QEAAEPEAVDXGPROCESS@@@Z @ 0x1C011D6A8 (-IsProcessGpuAccessBlocked@ADAPTER_RENDER@@QEAAEPEAVDXGPROCESS@@@Z.c)
 */
