/*
 * XREFs of ??0CDWMBackchannelManager@@IEAA@PEAU_KEVENT@@@Z @ 0x1C006C810
 * Callers:
 *     ?Create@CDWMBackchannelManager@@SAJPEAU_KEVENT@@PEAPEAV1@@Z @ 0x1C006C91C (-Create@CDWMBackchannelManager@@SAJPEAU_KEVENT@@PEAPEAV1@@Z.c)
 * Callees:
 *     <none>
 */
