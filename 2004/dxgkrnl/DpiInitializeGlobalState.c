/*
 * XREFs of DpiInitializeGlobalState @ 0x1C03061B0
 * Callers:
 *     DriverEntry @ 0x1C0306D00 (DriverEntry.c)
 * Callees:
 *     __security_check_cookie @ 0x1C0024350 (__security_check_cookie.c)
 *     _guard_dispatch_icall_nop @ 0x1C00271E0 (_guard_dispatch_icall_nop.c)
 *     DpiIsXboxOne @ 0x1C019894C (DpiIsXboxOne.c)
...
__int64 DpiInitializeGlobalState()
{
  ...
  *((_QWORD *)&v66 + 1) = &v43;
  ...
  if ( v2 < 0 || !dword_1C00B1F3C )
    dword_1C00B1F3C = 7236;
  if ( v2 < 0 || (byte_1C00B1B17 = 1, !HIDWORD(v43)) )
    byte_1C00B1B17 = 0;
  v3 = -(int)v43;
  LODWORD(v43) = 0;
  DueTime.QuadPart = v3;
  ...
  v62 = 0LL;
  v61 = 0LL;
  byte_1C00B1B19 = (int)RtlQueryRegistryValuesEx(2LL, L"GraphicsDrivers", &v51, 0LL, 0LL) >= 0 && (_DWORD)v43 != 0;
  v43 = 0x100000000LL;
  v53 = L"HwSchMode";
  v51 = 0LL;
  v54 = (int *)&v43;
  ...
  *((_QWORD *)&v61 + 1) = (char *)&v43 + 4;
  ...
  if ( v4 < 0 || (dword_1C00B1B30 = v43, (unsigned int)v43 >= 3) )
    dword_1C00B1B30 = 0;
  if ( v4 < 0 || (byte_1C00B1B34 = 0, HIDWORD(v43)) )
    byte_1C00B1B34 = 1;
  v55 = 67108868;
  v43 = -1LL;
  LODWORD(v61) = 67108868;
...
LABEL_52:
  ...
  if ( PhysicalMemoryRanges )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      qword_1C00B1B48 = (__int64)&qword_1C00B1B40;
      qword_1C00B1B40 = (__int64)&qword_1C00B1B40;
      RtlInitUnicodeString(
        (PUNICODE_STRING)&DestinationString[1],
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      byte_1C00B1B59 = 0;
      byte_1C00B1B58 = v32 == 0LL;
      KeInitializeEvent(&stru_1C00B1B60, NotificationEvent, 0);
      byte_1C00B1B5A = 0;
      ...
      if ( v33 )
      {
        ...
        dword_1C00B1D98 = 0;
        qword_1C00B1DA8 = (__int64)&Entry;
        Entry = &Entry;
        KeInitializeTimerEx(&stru_1C00B1D10, SynchronizationTimer);
        KeInitializeDpc(&stru_1C00B1D50, (PKDEFERRED_ROUTINE)DpiPdoPollingDpc, 0LL);
        qword_1C00B1D90 = IoAllocateWorkItem((PDEVICE_OBJECT)g_pDriverObject);
        if ( qword_1C00B1D90 )
        {
          ExInitializeNPagedLookasideList(&stru_1C00B1C00, 0LL, 0LL, 0x200u, 0x30uLL, 0x74727044u, 0);
          byte_1C00B1EB8 = 0;
          KeInitializeMutex(&stru_1C00B1EC0, 0);
          HIDWORD(DestinationString[0]) = 2;
          qword_1C00B1F00 = (__int64)&qword_1C00B1EF8;
          qword_1C00B1EF8 = (__int64)&qword_1C00B1EF8;
          v48 = 4;
          if ( ((int (__fastcall *)(__int64, __int64, char *, int *))HalDispatchTable->HalQuerySystemInformation)(
                 ...
                 &v48) < 0
            || (byte_1C00B1B16 = 1, HIDWORD(DestinationString[0]) == 2) )
          {
            byte_1C00B1B16 = 0;
          }
          dword_1C00B1E6C = -1;
          ...
          qword_1C00B1F20 = (__int64)&qword_1C00B1F18;
          qword_1C00B1F18 = (__int64)&qword_1C00B1F18;
          dword_1C00B1F38 = 0;
          qword_1C00B1F30 = (__int64)&qword_1C00B1F28;
          qword_1C00B1F28 = (__int64)&qword_1C00B1F28;
          ...
          {
            IoWorkItem = 0LL;
            qword_1C00B1CE8 = (__int64)&qword_1C00B1CE0;
            qword_1C00B1CE0 = (__int64)&qword_1C00B1CE0;
            dword_1C00B1CF0 = 0;
            qword_1C00B1CD8 = 0LL;
            dword_1C00B1CA0 = 1;
            qword_1C00B1CA8 = 0LL;
            dword_1C00B1CB0 = 0;
            KeInitializeEvent(&stru_1C00B1CB8, SynchronizationEvent, 0);
            KeInitializeEvent(&Event, NotificationEvent, 1u);
            byte_1C00B2090 = 0;
            KeInitializeMutex(&stru_1C00B2098, 0);
            byte_1C00B1B1C = 0;
            qword_1C00B20D8 = (__int64)&qword_1C00B20D0;
            qword_1C00B20D0 = &qword_1C00B20D0;
            qword_1C00B2000 = 1LL;
            dword_1C00B1EB4 = 0;
            byte_1C00B1B1F = DpiIsXboxOne();
          }
LABEL_39:
          v1 = v0;
          if ( (int)v12 >= 0 )
