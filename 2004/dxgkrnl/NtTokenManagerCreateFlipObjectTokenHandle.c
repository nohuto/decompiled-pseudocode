/*
 * XREFs of NtTokenManagerCreateFlipObjectTokenHandle @ 0x1C0062460
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a8)
{
  ...
  if ( a7 )
  {
    ...
    v14 = (*(__int64 (__fastcall **)(__int64, unsigned __int64 *))(*((_QWORD *)Global + 38048) + 192LL))(
            0x80000000LL,
            &v20);
    if ( v14 >= 0 )
    {
  ...
  if ( v20 )
  {
    ...
    (*(void (__fastcall **)(unsigned __int64))(*((_QWORD *)v18 + 38048) + 312LL))(v20);
  }
  if ( Handle )
    NtClose(Handle);
