/*
 * XREFs of McTemplateK0ppqpttq_EtwWriteTransfer @ 0x1C0042884
 * Callers:
 *     TraceDxgkDevice @ 0x1C0026700 (TraceDxgkDevice.c)
...
NTSTATUS McTemplateK0ppqpttq_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v16 = 4LL;
  v18 = 4LL;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, a2, a3, 8u, &v4);
}
