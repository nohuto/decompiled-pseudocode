/*
 * XREFs of DpiPdoSetMonitorDriverInterfaceState @ 0x1C02D96A0
 * Callers:
...
__int64 __fastcall DpiPdoSetMonitorDriverInterfaceState(PVOID Object, char a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *((_BYTE *)PoolWithTag + 24) = a2;
    ...
    v11 = (_QWORD *)qword_1C00B1F00;
    if ( *(__int64 **)qword_1C00B1F00 != &qword_1C00B1EF8 )
      __fastfail(3u);
    *PoolWithTag = &qword_1C00B1EF8;
    PoolWithTag[1] = v11;
    *v11 = PoolWithTag;
    qword_1C00B1F00 = (__int64)PoolWithTag;
    if ( !byte_1C00B1EB8 )
    {
