/*
 * XREFs of DpiFdoEnumChildDevices @ 0x1C0185D54
 * Callers:
 ...
 *     DxgkDWCloneCheckTargetID @ 0x1C018620C (DxgkDWCloneCheckTargetID.c)
      ...
      *(_BYTE *)(v1 + 2699) &= (v24 & 0xF0000000) == 0;
      ...
      if ( v56 == -1 )
      {
        *(_DWORD *)(v1 + 3484) = v10[v22 + 6];
        ...
        if ( RtlCompareMemory((const void *)(v1 + 544), &GUID_BUS_VMBUS, 0x10uLL) == 16 && byte_1C00B1B19 )
          goto LABEL_12;
        v54 = 1;
        if ( v28 == v50 )
          goto LABEL_66;
...
LABEL_97:
    ...
    if ( !*(_BYTE *)(*(_QWORD *)(v1 + 168) + 108LL)
      ...
      && !*(_BYTE *)(v1 + 2692)
      || !*(_BYTE *)(v1 + 2692) && !byte_1C00B1B19 && (_DWORD)v17 != -1 )
    {
LABEL_45:
      LODWORD(v14) = -1073741637;
      v38 = WdLogNewEntry5_WdError(v20, v17);
