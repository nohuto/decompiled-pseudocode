/*
 * XREFs of ?DisplayID_GetPreferredMode@@YAJPEBUDisplayIDObj@@PEAUDISPLAY_PREFERRED_MODE_INFO@@@Z @ 0x1C005F820
 * Callers:
 *     MonitorGetDpiInfoFromDescriptor @ 0x1C0141C4C (MonitorGetDpiInfoFromDescriptor.c)
 * Callees:
 *     ?DisplayID_GetFirstType7Desc@@YAJAEBUDisplayIDObj@@AEAPEAU_DISPLAYID_TYPE7_TIMING_BLOCK@@@Z @ 0x1C005F5D0 (-DisplayID_GetFirstType7Desc@@YAJAEBUDisplayIDObj@@AEAPEAU_DISPLAYID_TYPE7_TIMING_BLOCK@@@Z.c)
