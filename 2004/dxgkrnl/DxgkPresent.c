/*
 * XREFs of DxgkPresent @ 0x1C0100670
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CWin32kLocks@@QEAA@QEBU_DXGKWIN32KENG_INTERFACE@@PEAVDXGADAPTER@@@Z @ 0x1C00268A0 (--0CWin32kLocks@@QEAA@QEBU_DXGKWIN32KENG_INTERFACE@@PEAVDXGADAPTER@@@Z.c)
...
LABEL_222:
  ...
  if ( *(int *)(v57 + 2328) >= 0x2000 || *(_BYTE *)(v57 + 2628) )
    v60 = *(_DWORD *)(v57 + 2536) * ((v58 << 6) + ((8 * v58 + 199) & 0xFFFFFFF8)) + 8 * v58 + 584;
  else
    v60 = 1288;
  memset(v54, 0, v60);
  v61 = *(_QWORD *)(v217 + 16);
