/*
 * XREFs of ?GetVendorAndDevice@ADAPTER_RENDER@@QEAAJW4DXG_VIRTUAL_GPU_TYPE@@PEAU_DXGKARG_GETVENDORANDDEVICE@@@Z @ 0x1C023020C
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::GetVendorAndDevice(__int64 a1, int a2, unsigned int *a3)
{
  ...
  {
    v10 = (*(__int64 (__fastcall **)(struct DXGK_VIRTUAL_GPU *, unsigned int *))(*(_QWORD *)VirtualGpuByIndex + 80LL))(
            VirtualGpuByIndex,
            a3);
  }
  else
