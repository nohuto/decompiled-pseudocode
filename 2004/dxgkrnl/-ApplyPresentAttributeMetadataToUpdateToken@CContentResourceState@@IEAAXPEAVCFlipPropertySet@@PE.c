/*
 * XREFs of ?ApplyPresentAttributeMetadataToUpdateToken@CContentResourceState@@IEAAXPEAVCFlipPropertySet@@PEAVCFlipContentToken@@@Z @ 0x1C006D5C0
 * Callers:
 ...
 * Callees:
 *     ??$FindProperty@UPresentedContentUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedContentUpdateFlags@@@Z @ 0x1C006B118 (--$FindProperty@UPresentedContentUpdateFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentedConten.c)
 *     ??$FindProperty@UPresentAttributeFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentAttributeFlags@@@Z @ 0x1C006D490 (--$FindProperty@UPresentAttributeFlags@@@CFlipPropertySetBase@@QEAAXPEAPEAUPresentAttributeFlags.c)
 *     ??$ReadData@I@CFlipBlobPropertyReader@@QEAA_NPEAI@Z @ 0x1C006D4F4 (--$ReadData@I@CFlipBlobPropertyReader@@QEAA_NPEAI@Z.c)
 *     ??$ReadData@UtagRECT@@@CFlipBlobPropertyReader@@QEAA_NPEAUtagRECT@@@Z @ 0x1C006D520 (--$ReadData@UtagRECT@@@CFlipBlobPropertyReader@@QEAA_NPEAUtagRECT@@@Z.c)
 *     ??$ReadData@_N@CFlipBlobPropertyReader@@QEAA_NPEA_N@Z @ 0x1C006D550 (--$ReadData@_N@CFlipBlobPropertyReader@@QEAA_NPEA_N@Z.c)
 *     ?FindBlobProperty@CFlipPropertySetBase@@QEAA_NPEAVCFlipBlobPropertyReader@@@Z @ 0x1C006DA70 (-FindBlobProperty@CFlipPropertySetBase@@QEAA_NPEAVCFlipBlobPropertyReader@@@Z.c)
 */
