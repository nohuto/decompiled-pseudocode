/*
 * XREFs of ?DdiBeginExclusiveAccess@ADAPTER_RENDER@@QEAAJXZ @ 0x1C0217BF0
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiBeginExclusiveAccess(ADAPTER_RENDER *this, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5130LL);
  v5 = *((_QWORD *)this + 2);
  LODWORD(v6) = 0;
  if ( *(_QWORD *)(v5 + 1248) )
  {
    ...
    v13 = *((_QWORD *)this + 2);
    v24 = 0;
    v6 = (*(int (__fastcall **)(_QWORD, int *))(v13 + 1248))(*(_QWORD *)(v13 + 272), &v24);
    if ( v28[0] )
