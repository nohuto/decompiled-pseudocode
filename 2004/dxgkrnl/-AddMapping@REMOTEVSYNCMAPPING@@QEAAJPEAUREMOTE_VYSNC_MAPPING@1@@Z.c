/*
 * XREFs of ?AddMapping@REMOTEVSYNCMAPPING@@QEAAJPEAUREMOTE_VYSNC_MAPPING@1@@Z @ 0x1C004E4E0
 * Callers:
 ...
 *     ?IncrementVSyncWaiter@DXGADAPTER@@QEAAXI@Z @ 0x1C000D37C (-IncrementVSyncWaiter@DXGADAPTER@@QEAAXI@Z.c)
 *     ?Assign@DXGADAPTER_REFERENCE@@QEAAXPEAVDXGADAPTER@@@Z @ 0x1C00187D4 (-Assign@DXGADAPTER_REFERENCE@@QEAAXPEAVDXGADAPTER@@@Z.c)
 *     REMOTEVSYNCMAPPING::IterateList__lambda_daaf3f6a0c98c285f3d4af1bfc621455___ @ 0x1C004E118 (REMOTEVSYNCMAPPING--IterateList__lambda_daaf3f6a0c98c285f3d4af1bfc621455___.c)
...
__int64 __fastcall REMOTEVSYNCMAPPING::AddMapping(KSPIN_LOCK *this, struct _LUID *a2)
{
  ...
  __int64 v6; // r8
  DXGADAPTER *v7; // rsi
  int SourceConnectedToTargetInClientVidPn; // r14d
  _QWORD *v9; // rax
  __int64 v10; // rdx
  __int64 v11; // rcx
  __int64 v12; // r8
