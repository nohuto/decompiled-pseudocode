/*
 * XREFs of ?DpiPdoHandleOpmIoctlsInternal@@YAJPEAU_FDO_CONTEXT@@PEAU_PDO_CONTEXT@@KPEAXK2KPEA_K@Z @ 0x1C001C6B4
 * Callers:
 ...
 *     DpiPdoVerifyOpmParameters @ 0x1C016F408 (DpiPdoVerifyOpmParameters.c)
 ...
 *     DpiMiracastFindRenderAdapterForSession @ 0x1C0171A3C (DpiMiracastFindRenderAdapterForSession.c)
 */
...
LABEL_159:
      ...
      else
      {
        ...
        if ( (int)v13 >= 0 )
        {
          ...
          if ( (unsigned int)dword_1C00B09E8 > 5 && tlgKeywordOn((__int64)&dword_1C00B09E8, 0x400000100000LL) )
          {
