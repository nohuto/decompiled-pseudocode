/*
 * XREFs of ?IsVidPnSourceVisible@ADAPTER_DISPLAY@@QEBAEI@Z @ 0x1C000A37C
 * Callers:
 ...
 *     ?IsDisplayingOnVidPnSource@DXGDEVICE@@QEAA_NI@Z @ 0x1C02551B4 (-IsDisplayingOnVidPnSource@DXGDEVICE@@QEAA_NI@Z.c)
