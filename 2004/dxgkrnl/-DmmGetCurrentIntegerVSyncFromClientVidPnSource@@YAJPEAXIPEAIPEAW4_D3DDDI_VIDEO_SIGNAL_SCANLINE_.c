/*
 * XREFs of ?DmmGetCurrentIntegerVSyncFromClientVidPnSource@@YAJPEAXIPEAIPEAW4_D3DDDI_VIDEO_SIGNAL_SCANLINE_ORDERING@@@Z @ 0x1C0165A10
 * Callers:
...
LABEL_28:
  ...
  if ( v12 )
  {
    ...
    if ( v44 )
    {
      v18 = *(_QWORD *)(*((_QWORD *)a1 + 337) + 112LL);
      v46 = 3968 * v5;
