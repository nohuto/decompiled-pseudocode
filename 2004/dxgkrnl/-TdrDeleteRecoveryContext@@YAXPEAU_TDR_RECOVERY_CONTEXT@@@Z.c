/*
 * XREFs of ?TdrDeleteRecoveryContext@@YAXPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C0265734
 * Callers:
 ...
 * Callees:
 *     ??_GCTDR_DUMP_BUFFER@@QEAAPEAXI@Z @ 0x1C0263C1C (--_GCTDR_DUMP_BUFFER@@QEAAPEAXI@Z.c)
 */
