/*
 * XREFs of McTemplateK0ppqqpppz_EtwWriteTransfer @ 0x1C00265D0
 * Callers:
...
NTSTATUS McTemplateK0ppqqpppz_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  if ( !v39 )
    v3 = L"NULL";
  v22 = v3;
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventCreateDxgProcessVm, 0LL, 9u, &v7);
}
