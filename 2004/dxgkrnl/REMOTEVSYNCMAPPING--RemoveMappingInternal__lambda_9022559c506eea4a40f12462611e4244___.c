/*
 * XREFs of REMOTEVSYNCMAPPING::RemoveMappingInternal__lambda_9022559c506eea4a40f12462611e4244___ @ 0x1C001FB4C
 * Callers:
 *     ?SetVidPnPrimaryTarget@ADAPTER_DISPLAY@@QEAAXII@Z @ 0x1C001A714 (-SetVidPnPrimaryTarget@ADAPTER_DISPLAY@@QEAAXII@Z.c)
 * Callees:
...
LABEL_2:
  ...
  while ( v8 != (REMOTE_VYSNC_MAPPING_ENTRY *)v19 )
  {
    ...
    DXGADAPTER::DecrementVSyncWaiter(*((DXGADAPTER **)v15 + 7), *((unsigned int *)v15 + 12));
