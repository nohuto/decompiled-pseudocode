/*
 * XREFs of ?DxgkpDuplicateHandleToVm@@YAJPEAU_D3DKMT_DUPLICATEHANDLE@@@Z @ 0x1C027731C
 * Callers:
 ...
 *     ??0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z @ 0x1C0237B6C (--0DXGKVMB_GUEST_TRANSACTION@@QEAA@PEAXI@Z.c)
