/*
 * XREFs of ??1?$NT_OBJECT_REFERENCE@PEAUDXGDISPLAYMANAGEROBJECT_CONTAINER@@@@QEAA@XZ @ 0x1C0161144
 * Callers:
 ...
 *     DxgkDispMgrReferenceObjectByHandle @ 0x1C02B1920 (DxgkDispMgrReferenceObjectByHandle.c)
