/*
 * XREFs of DxgkSetContextSchedulingPriority @ 0x1C00E06E0
 * Callers:
...
__int64 __fastcall DxgkSetContextSchedulingPriority(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  int v42[2]; // [rsp+48h] [rbp-F0h]
  DXGCONTEXT *v43[2]; // [rsp+50h] [rbp-E8h] BYREF
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v39, 2029LL);
  ...
  if ( Current )
  {
    ...
    *(_QWORD *)v42 = v11;
    v43[0] = 0LL;
    DXGCONTEXTBYHANDLE::DXGCONTEXTBYHANDLE((DXGCONTEXTBYHANDLE *)v44, v11, Current, v43, 0);
    v15 = v43[0];
    if ( !v43[0] )
    {
...
LABEL_32:
    ...
    if ( *((_BYTE *)v43[0] + 457) )
    {
      v19 = DXG_GUEST_VIRTUALGPU_VMBUS::VmBusSendSetContextSchedulingPriority(
              (DXG_GUEST_VIRTUALGPU_VMBUS *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v43[0] + 2) + 16LL) + 16LL) + 4240LL),
              Current,
              v43[0],
              v42[1],
              0);
...
LABEL_19:
    ...
    COREDEVICEACCESS::COREDEVICEACCESS((__int64)v45, *((_QWORD *)v15 + 2), 0, v31, 0);
    v32 = COREDEVICEACCESS::AcquireShared((COREDEVICEACCESS *)v45, 0LL);
    v9 = v32;
    if ( v32 >= 0 )
    {
      if ( v26 )
      ...
      {
        DXGCONTEXT::SetSchedulingPriority(v15, v18 + *((_DWORD *)v15 + 110), 1);
        *((_DWORD *)v15 + 111) = v18;
        LODWORD(v9) = 0;
      }
    }
