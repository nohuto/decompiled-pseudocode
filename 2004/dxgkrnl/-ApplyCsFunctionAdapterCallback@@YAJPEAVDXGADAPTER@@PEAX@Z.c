/*
 * XREFs of ?ApplyCsFunctionAdapterCallback@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C0283E50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z @ 0x1C0047D24 (-SetCsStartRunningTime@DXGPROCESS@@QEAAXI_K@Z.c)
