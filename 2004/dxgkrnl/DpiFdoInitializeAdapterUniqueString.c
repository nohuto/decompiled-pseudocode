/*
 * XREFs of DpiFdoInitializeAdapterUniqueString @ 0x1C0181DFC
 * Callers:
...
LABEL_42:
        ...
        *(_QWORD *)&SourceString.Length = 0LL;
        DevicePropertyString = DpiGetDevicePropertyString(v37, DevicePropertyHardwareID, PagedPool, (__int64)&v52);
