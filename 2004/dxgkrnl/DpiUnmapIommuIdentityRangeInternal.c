/*
 * XREFs of DpiUnmapIommuIdentityRangeInternal @ 0x1C0056E78
 * Callers:
 ...
 *     DpiUnmapMemoryTrackerFromIoMmu @ 0x1C0056EE0 (DpiUnmapMemoryTrackerFromIoMmu.c)
...
__int64 __fastcall DpiUnmapIommuIdentityRangeInternal(__int64 a1, __int64 a2, int a3, char a4, __int64 a5)
{
  ...
  result = ((__int64 (__fastcall *)(_QWORD))qword_1C00B2078)(*(_QWORD *)(a1 + 8));
  if ( (int)result < 0 )
  {
