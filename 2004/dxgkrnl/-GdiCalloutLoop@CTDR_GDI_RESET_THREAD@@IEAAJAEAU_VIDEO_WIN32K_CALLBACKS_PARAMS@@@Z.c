/*
 * XREFs of ?GdiCalloutLoop@CTDR_GDI_RESET_THREAD@@IEAAJAEAU_VIDEO_WIN32K_CALLBACKS_PARAMS@@@Z @ 0x1C026422C
 * Callers:
 *     ?SwitchGdi@CTDR_GDI_RESET_THREAD@@IEAAJ_N@Z @ 0x1C02644E0 (-SwitchGdi@CTDR_GDI_RESET_THREAD@@IEAAJ_N@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  v17 = Status;
  DxgkWriteDiagEntry((struct _DXGK_DIAG_HEADER *)v10, 0x100000000LL);
  ProductType[0] = 0;
