/*
 * XREFs of ?_ReadPath@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@AEAAJPEAXIPEAUD3DKMT_PATHMODALITY_DESCRIPTOR@@@Z @ 0x1C01336C8
 * Callers:
 ...
 *     ?BmlIsSupportedGraphicsFormat@@YA_NAEBU_D3DKMDT_GRAPHICS_RENDERING_FORMAT@@_N@Z @ 0x1C02EBC90 (-BmlIsSupportedGraphicsFormat@@YA_NAEBU_D3DKMDT_GRAPHICS_RENDERING_FORMAT@@_N@Z.c)
 */
        ...
        struct D3DKMT_PATHMODALITY_DESCRIPTOR *a4)
{
  ...
  if ( v7 >= 0 )
  {
    v12 = CcdReadRegistryValues(a2, &Dest, &unk_1C00B0340, 0xDu, (__int64)a4);
    v16 = *(unsigned int *)a4;
    *(_QWORD *)a4 = v16;
    v10 = v12;
    if ( v12 >= 0 )
    {
      if ( (v16 & 0x100) != 0 )
      {
        v18 = CcdReadRegistryValues(a2, &Dest, &unk_1C00B0850, 6u, (__int64)a4);
        v10 = v18;
        if ( v18 >= 0 )
        {
          v28 = *(_QWORD *)a4;
        ...
        else
        {
          ...
          RegistryValues = CcdReadRegistryValues(a2, 0LL, &unk_1C00B0620, 8u, (__int64)a4);
          v26 = RegistryValues;
          if ( RegistryValues < 0 )
          {
      ...
      if ( (v16 & 0x800000) != 0 )
      {
        v29 = CcdReadRegistryValues(a2, &Dest, &unk_1C00B0220, 5u, (__int64)a4);
        v10 = v29;
        if ( v29 >= 0 )
        {
