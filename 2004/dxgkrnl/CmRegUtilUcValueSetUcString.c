/*
 * XREFs of CmRegUtilUcValueSetUcString @ 0x1C02C52CC
 * Callers:
 *     PpRegStateReadCreateClassCreationSettings @ 0x1C02C4BB4 (PpRegStateReadCreateClassCreationSettings.c)
 *     CmRegUtilWstrValueSetWstrString @ 0x1C02C5478 (CmRegUtilWstrValueSetWstrString.c)
 * Callees:
 *     memmove @ 0x1C0027200 (memmove.c)
 *     CmpRegUtilAllocateUnicodeString @ 0x1C02C54D4 (CmpRegUtilAllocateUnicodeString.c)
 */
