/*
 * XREFs of DpiReportDevicePowerStateWorkItemCallback @ 0x1C02C6CD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AddD0LagTimeToLastActiveEntry@DripsBlockerTrackingHelper@@IEAAXXZ @ 0x1C02BF584 (-AddD0LagTimeToLastActiveEntry@DripsBlockerTrackingHelper@@IEAAXXZ.c)
 */
