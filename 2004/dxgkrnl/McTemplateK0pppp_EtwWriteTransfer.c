/*
 * XREFs of McTemplateK0pppp_EtwWriteTransfer @ 0x1C003EECC
 * Callers:
...
NTSTATUS McTemplateK0pppp_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v12 = 8LL;
  va_copy(v11, va3);
  return McGenEventWrite_EtwWriteTransfer((REGHANDLE *)&DxgkControlGuid_Context, &EventAssociateContext, a3, 5u, &v4);
}
