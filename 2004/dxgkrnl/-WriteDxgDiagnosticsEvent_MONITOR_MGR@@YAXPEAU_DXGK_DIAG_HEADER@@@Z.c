/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MONITOR_MGR@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C001A12C
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MONITOR_MGR(struct _DXGK_DIAG_HEADER *a1, __int64 a2)
{
  ...
  {
    if ( (unsigned int)dword_1C00B0A20 > 1
      && tlgKeywordOn((__int64)&dword_1C00B0A20, 0x200000000020LL)
      && tlgKeywordOn((__int64)&dword_1C00B0A20, v4) )
    {
      v8 = &unk_1C007F5CF;
LABEL_11:
      v10 = *((_WORD *)a1 + 2);
  ...
  else if ( (unsigned int)dword_1C00B0A20 > 4
         && tlgKeywordOn((__int64)&dword_1C00B0A20, 0x200000000020LL)
         && tlgKeywordOn((__int64)&dword_1C00B0A20, v3) )
  {
    v8 = &unk_1C007F5A5;
    goto LABEL_11;
  }
