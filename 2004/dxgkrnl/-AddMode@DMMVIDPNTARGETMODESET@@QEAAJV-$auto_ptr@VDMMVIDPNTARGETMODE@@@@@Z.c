/*
 * XREFs of ?AddMode@DMMVIDPNTARGETMODESET@@QEAAJV?$auto_ptr@VDMMVIDPNTARGETMODE@@@@@Z @ 0x1C0110874
 * Callers:
 ...
 *     ??9DMMVIDPNTARGETMODE@@QEBA_NAEBV0@@Z @ 0x1C0019F4C (--9DMMVIDPNTARGETMODE@@QEBA_NAEBV0@@Z.c)
