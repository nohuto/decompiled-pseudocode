/*
 * XREFs of DxgkMiracastQueryMiracastSupportInternal @ 0x1C0171734
 * Callers:
 ...
 *     DxgkNetDispQueryMiracastDisplayDeviceSupport @ 0x1C0171300 (DxgkNetDispQueryMiracastDisplayDeviceSupport.c)
 ...
 *     ?IsMiniportListMutexOwnedByCurrentThread@@YAEXZ @ 0x1C001E550 (-IsMiniportListMutexOwnedByCurrentThread@@YAEXZ.c)
...
LABEL_8:
    ...
    xmmword_1C00B1FE0 = 0LL;
    dword_1C00B1FF0 = 0;
LABEL_22:
    MiracastSupportForFDO = -1073741637;
    goto LABEL_16;
  }
  DWORD1(xmmword_1C00B1FE0) = dword_1C00B1F3C;
  LOBYTE(xmmword_1C00B1FE0) = 0;
  BYTE8(xmmword_1C00B1FE0) = 0;
  *(_QWORD *)((char *)&xmmword_1C00B1FE0 + 12) = v8;
  if ( a1 )
  {
    *(_OWORD *)a1 = xmmword_1C00B1FE0;
    *(_DWORD *)(a1 + 16) = dword_1C00B1FF0;
  }
