/*
 * XREFs of DpiGdoSetupGdiParameters @ 0x1C0184E1C
 * Callers:
 *     DpiGdoCreateGdiObjects @ 0x1C0184014 (DpiGdoCreateGdiObjects.c)
 * Callees:
 ...
 *     DpiCopyUnicodeString @ 0x1C01869B4 (DpiCopyUnicodeString.c)
 */
