/*
 * XREFs of ?VSyncTelemetryBucket@ADAPTER_DISPLAY@@QEAAXXZ @ 0x1C003A214
 * Callers:
 *     ?VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z @ 0x1C003A560 (-VSyncTelemetryTimerDpc@ADAPTER_DISPLAY@@SAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
LABEL_14:
  if ( v3 )
  {
    if ( (*((_DWORD *)this + 216) || *((_DWORD *)this + 215))
      && (unsigned int)dword_1C00B0A20 > 4
      && tlgKeywordOn((__int64)&dword_1C00B0A20, 0x400000002000LL)
      && v10 > 5
      && tlgKeywordOn((__int64)&dword_1C00B0A20, v9) )
    {
      v14 = *((_QWORD *)this + 114);
      if ( v14 )
      {
