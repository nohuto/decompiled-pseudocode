/*
 * XREFs of ?IsWindowVisible@DXGGLOBAL@@QEAAEQEBUtagRECT@@@Z @ 0x1C016206C
 * Callers:
 *     DxgkCheckOcclusion @ 0x1C0161EB0 (DxgkCheckOcclusion.c)
 *     ?CheckOcclusion@DXGPRESENT@@QEAAEXZ @ 0x1C027F624 (-CheckOcclusion@DXGPRESENT@@QEAAEXZ.c)
 * Callees:
...
LABEL_11:
  ...
  IsWindowVisible = ADAPTER_DISPLAY::IsWindowVisible((ADAPTER_DISPLAY *)v7[337], a2);
