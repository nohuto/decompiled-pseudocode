/*
 * XREFs of _DxgDbgBugcheckCallback @ 0x1C0042D20
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C00B3570 )
    {
      v4 = (unsigned int)(dword_1C00B3568 - 1);
      if ( dword_1C00B3568 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C00B3570) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C00B2118;
      ReasonSpecificData[4] = qword_1C00B3570;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C00B2118;
      if ( v5 )
      {
