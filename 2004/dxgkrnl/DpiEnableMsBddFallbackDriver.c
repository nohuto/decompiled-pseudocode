/*
 * XREFs of DpiEnableMsBddFallbackDriver @ 0x1C02C7B2C
 * Callers:
 ...
 *     DxgkAcquireAdapterStopResetSync @ 0x1C0217580 (DxgkAcquireAdapterStopResetSync.c)
 *     DxgkReleaseAdapterStopResetSync @ 0x1C0217AA0 (DxgkReleaseAdapterStopResetSync.c)
 */
...
__int64 __fastcall DpiEnableMsBddFallbackDriver(__int64 a1, __int64 a2)
{
  ...
  if ( qword_1C00B1DC0 )
  {
    ...
    if ( *(_QWORD *)(v5 + 3896) )
    {
      ...
      v9 = *(_QWORD *)(v5 + 48);
      *(_QWORD *)(v5 + 5704) = a1;
      LOBYTE(v7) = byte_1C00B1B1C;
      LOBYTE(v6) = dword_1C00B1E68 == 1;
      v8(v9, &xmmword_1C00B1DC8, v6, v7);
      *(_QWORD *)(v5 + 5704) = 0LL;
      byte_1C00B1B1C = 0;
      ...
      qword_1C00B1DB8 = qword_1C00B1DC0;
      dword_1C00B1E68 = 4;
