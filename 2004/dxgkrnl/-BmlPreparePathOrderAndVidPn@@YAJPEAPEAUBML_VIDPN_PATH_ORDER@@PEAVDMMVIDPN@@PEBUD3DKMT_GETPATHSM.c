/*
 * XREFs of ?BmlPreparePathOrderAndVidPn@@YAJPEAPEAUBML_VIDPN_PATH_ORDER@@PEAVDMMVIDPN@@PEBUD3DKMT_GETPATHSMODALITY@@GGW4DXGK_DIAG_CCD_BML_ORIGIN@@I@Z @ 0x1C0135160
 * Callers:
 ...
 *     ?ForceIHVScaling@ADAPTER_DISPLAY@@QEBAEXZ @ 0x1C001A33C (-ForceIHVScaling@ADAPTER_DISPLAY@@QEBAEXZ.c)
 *     ?GetDisplayOnlyDriverUseRawModes@ADAPTER_DISPLAY@@QEBAHXZ @ 0x1C0042EB8 (-GetDisplayOnlyDriverUseRawModes@ADAPTER_DISPLAY@@QEBAHXZ.c)
 *     ?D3DKMDT_VPPR_CONVERT_ROTATION_GIVEN_OFFSET@@YA?AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W41@0@Z @ 0x1C005CE4C (-D3DKMDT_VPPR_CONVERT_ROTATION_GIVEN_OFFSET@@YA-AW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@W41@0@Z.c)
 *     ?GetDisplayOnlyDriverIgnoreMonitorFreqCheck@ADAPTER_DISPLAY@@QEBAHXZ @ 0x1C005CE74 (-GetDisplayOnlyDriverIgnoreMonitorFreqCheck@ADAPTER_DISPLAY@@QEBAHXZ.c)
 ...
 *     ?GetAdapterDefaultScaling@VIDPN_MGR@@QEBA?AW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@XZ @ 0x1C0146A70 (-GetAdapterDefaultScaling@VIDPN_MGR@@QEBA-AW4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@XZ.c)
  ...
  *a1 = (__int64)v11;
  ...
  else
  {
    ...
    if ( *(_QWORD *)(*(_QWORD *)(v126 + 16) + 2704LL) )
    {
      ...
      *(_QWORD *)(v127 + 24) = 6632LL;
      WdLogEvent5_WdAssertion(v127);
    }
    v128 = *a1;
    v129 = (*(_DWORD *)(*a1 + 8) ^ *(_DWORD *)(v126 + 368)) & 1;
    *(_DWORD *)(*a1 + 8) ^= v129;
    v130 = *(_QWORD *)(v9 + 48);
    v131 = *(_QWORD *)(v130 + 8);
    if ( !v131 )
