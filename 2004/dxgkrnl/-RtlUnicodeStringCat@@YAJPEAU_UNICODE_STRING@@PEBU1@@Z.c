/*
 * XREFs of ?RtlUnicodeStringCat@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z @ 0x1C00400CC
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateDestWorker_0 @ 0x1C00402A8 (RtlUnicodeStringValidateDestWorker_0.c)
