/*
 * XREFs of ?DdiDPAuxIoTransmission@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_DPAUXIOTRANSMISSION@@@Z @ 0x1C02195CC
 * Callers:
        ...
        __int64 a3)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rcx
  __int64 (__fastcall *v13)(_QWORD, struct _DXGKARG_DPAUXIOTRANSMISSION *); // rax
  int v14; // ebx
  _QWORD *v15; // rax
  ...
  if ( (qword_1C00B09B0 & 2) != 0 )
  {
    ...
    if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x2000) != 0 )
      McTemplateK0q_EtwWriteTransfer((__int64)this, &EventProfilerEnter, a3, 5151);
  }
  else
  {
    v28 = 0;
  }
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5151LL);
  ...
  if ( v12 && (v13 = *(__int64 (__fastcall **)(_QWORD, struct _DXGKARG_DPAUXIOTRANSMISSION *))(v12 + 48)) != 0LL )
