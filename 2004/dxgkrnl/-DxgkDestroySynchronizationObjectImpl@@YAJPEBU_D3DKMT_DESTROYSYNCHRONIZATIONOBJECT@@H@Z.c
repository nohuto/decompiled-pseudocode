/*
 * XREFs of ?DxgkDestroySynchronizationObjectImpl@@YAJPEBU_D3DKMT_DESTROYSYNCHRONIZATIONOBJECT@@H@Z @ 0x1C0112B9C
 * Callers:
 ...
 *     DxgkDestroySynchronizationObject @ 0x1C01112A0 (DxgkDestroySynchronizationObject.c)
