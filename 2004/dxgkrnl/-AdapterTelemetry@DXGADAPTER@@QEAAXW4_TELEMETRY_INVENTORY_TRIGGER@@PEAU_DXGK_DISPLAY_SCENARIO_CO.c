/*
 * XREFs of ?AdapterTelemetry@DXGADAPTER@@QEAAXW4_TELEMETRY_INVENTORY_TRIGGER@@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0177C80
 * Callers:
 ...
 *     DxgkMiracastQueryMiracastSupportNoLock @ 0x1C00212C4 (DxgkMiracastQueryMiracastSupportNoLock.c)
...
void __fastcall DXGADAPTER::AdapterTelemetry(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( *(_QWORD *)(a1 + 2704) || *(_QWORD *)(a1 + 2696) )
  {
    ...
    *(_OWORD *)P = 0LL;
    ...
    if ( (unsigned int)dword_1C00B0A58 > 5 && tlgKeywordOn((__int64)&dword_1C00B0A58, 0x800000000004LL) )
    {
      v24 = *(_DWORD *)(a1 + 348);
      v51 = *(_DWORD *)(a1 + 1872);
      v34 = *(_WORD *)(a1 + 1456);
      ...
      v38 = *(_WORD *)(a1 + 340);
      v33 = v21 && tlgKeywordOn((__int64)&dword_1C00B0A58, 0x200000000000LL);
      if ( !v21 || !tlgKeywordOn((__int64)&dword_1C00B0A58, 0x400000000000LL) )
        v5 = 0;
