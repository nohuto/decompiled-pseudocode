/*
 * XREFs of ?ValidatePlaneHelper@MOCKDRIVERSTATE@@AEAAXPEAU_MOCKDRIVERSTATE_VALIDATE_PLANE@@@Z @ 0x1C004D6F8
 * Callers:
 ...
 *     ?DXGADAPTER_ValidateMockDriverState@@YAXPEAVDXGADAPTER@@W4MOCKDRIVERSTATE_VALIDATE_TYPE@@PEAX@Z @ 0x1C00416E0 (-DXGADAPTER_ValidateMockDriverState@@YAXPEAVDXGADAPTER@@W4MOCKDRIVERSTATE_VALIDATE_TYPE@@PEAX@Z.c)
 * Callees:
 *     ?QueuePlaneViolationWorkItem@@YAXIIPEAU_MOCKDRIVERSTATE_VALIDATE_PLANE@@PEAVDXGADAPTER@@PEAU_MOCKDRIVERSTATE_PLANE@@@Z @ 0x1C004D5C0 (-QueuePlaneViolationWorkItem@@YAXIIPEAU_MOCKDRIVERSTATE_VALIDATE_PLANE@@PEAVDXGADAPTER@@PEAU_MOC.c)
 */
