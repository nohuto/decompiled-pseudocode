/*
 * XREFs of DpExcludeAdapterAccess @ 0x1C02C5750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpExcludeAdapterAccess(PDEVICE_OBJECT DeviceObject, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !DeviceObject || !a3 )
  {
    ...
    v32 = WdLogNewEntry5_WdError(DeviceObject, a2);
...
LABEL_32:
  ...
  if ( ((*((_DWORD *)DeviceExtension + 994) - 1) & 0xFFFFFFFB) == 0 )
  {
    v11 = -1073741661LL;
LABEL_29:
    LODWORD(v12) = v11;
...
LABEL_10:
  ...
  v15 = v8 & 2;
  if ( (v8 & 2) != 0 && ((v8 & 1) != 0 || !DxgkIsAdapterCoreSyncAcquired(*((DXGADAPTER **)DeviceExtension + 487), 2LL)) )
  {
