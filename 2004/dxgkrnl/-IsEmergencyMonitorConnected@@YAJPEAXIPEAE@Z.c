/*
 * XREFs of ?IsEmergencyMonitorConnected@@YAJPEAXIPEAE@Z @ 0x1C01454AC
 * Callers:
 ...
 *     ?_IsUsingSimulatedMonitor@MONITOR_MGR@@QEAAEXZ @ 0x1C0145648 (-_IsUsingSimulatedMonitor@MONITOR_MGR@@QEAAEXZ.c)
 */
