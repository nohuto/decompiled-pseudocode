/*
 * XREFs of DpiFdoHandleRemoveDevice @ 0x1C02C9E40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiCheckSpbResourceLeakage @ 0x1C00587D4 (DpiCheckSpbResourceLeakage.c)
...
__int64 __fastcall DpiFdoHandleRemoveDevice(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  if ( (PDEVICE_OBJECT)qword_1C00B1DC0 == DeviceObject )
  {
