/*
 * XREFs of TraceLoggingWriteMiracastSessionStop @ 0x1C0059AF4
 * Callers:
...
void TraceLoggingWriteMiracastSessionStop()
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C00B0A90, 0x800000000002LL) )
    {
      v7 = *(_DWORD *)(v0 + 676);
      v8 = dword_1C00B1F50 - *(_DWORD *)(v0 + 672);
      v9 = *(_DWORD *)(v0 + 668);
      v10 = *(_DWORD *)(v0 + 696);
