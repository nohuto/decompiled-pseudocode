/*
 * XREFs of ?_InsertMonitorSourceMode@DXGMONITOR@@AEAAJQEBU_D3DKMDT_MONITOR_SOURCE_MODE@@@Z @ 0x1C0190C54
 * Callers:
 ...
 *     ?_ValidateDdiVideoSignalModeInfo@DMMVIDEOSIGNALMODE@@SAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@@Z @ 0x1C0006200 (-_ValidateDdiVideoSignalModeInfo@DMMVIDEOSIGNALMODE@@SAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@@Z.c)
 */
...
LABEL_15:
    ...
    *v18 = v17;
    ...
    if ( *((_DWORD *)v15 + 22) == 1 )
    {
      v20 = WdLogNewEntry5_WdDmmEvent(v18, v13);
      *(_QWORD *)(v20 + 24) = v15;
