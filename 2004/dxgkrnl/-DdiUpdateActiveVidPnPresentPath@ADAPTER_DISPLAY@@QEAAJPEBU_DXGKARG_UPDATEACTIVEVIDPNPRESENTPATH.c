/*
 * XREFs of ?DdiUpdateActiveVidPnPresentPath@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH@@@Z @ 0x1C013B94C
 * Callers:
        ...
        __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v26, 5012LL);
  ...
  v12 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_UPDATEACTIVEVIDPNPRESENTPATH *))(*((_QWORD *)this + 2)
                                                                                            + 568LL))(
  ...
  *(_QWORD *)(v14 + 32) = a2;
  ...
  if ( (_DWORD)v12 != -1073741801 && (_DWORD)v12 != -1071774906 && (_DWORD)v12 != -1071774904 && (_DWORD)v12 )
  {
