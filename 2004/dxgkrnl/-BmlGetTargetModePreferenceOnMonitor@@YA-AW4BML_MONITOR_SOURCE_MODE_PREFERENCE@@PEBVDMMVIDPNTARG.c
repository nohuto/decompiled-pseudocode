/*
 * XREFs of ?BmlGetTargetModePreferenceOnMonitor@@YA?AW4BML_MONITOR_SOURCE_MODE_PREFERENCE@@PEBVDMMVIDPNTARGETMODE@@EPEAVDMMVIDEOPRESENTTARGET@@@Z @ 0x1C01389FC
 * Callers:
 *     BmlCompareTargetModesWithMonitor @ 0x1C013C1F0 (BmlCompareTargetModesWithMonitor.c)
 * Callees:
 ...
 *     MonitorGetNextMonitorSourceMode @ 0x1C0138B90 (MonitorGetNextMonitorSourceMode.c)
 *     BmlGetMonitorModePreference @ 0x1C0138CAC (BmlGetMonitorModePreference.c)
 *     BmlIsEDIDCapableOutputTechonology @ 0x1C0139210 (BmlIsEDIDCapableOutputTechonology.c)
 */
