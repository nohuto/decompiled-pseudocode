/*
 * XREFs of ?SubmitCommand@DXGCONTEXT@@QEAAJPEAU_D3DKMT_SUBMITCOMMAND@@PEAVCOREDEVICEACCESS@@PEAVDXGADAPTERSTOPRESETLOCKSHARED@@PEAPEAV1@PEAPEAU_VIDMM_MULTI_ALLOC@@IE@Z @ 0x1C00F1DF0
 * Callers:
        ...
        unsigned __int8 a8)
{
  ...
  if ( *((int *)&v25[145].Next + 2) >= 0x2000 || BYTE4(v25[164].Next) )
    v28 = *((_DWORD *)&v25[158].Next + 2) * ((v26 << 6) + ((8 * v26 + 199) & 0xFFFFFFF8)) + 8 * v26 + 584;
  else
    v28 = 1288;
  memset(v22, 0, v28);
  v29 = Next[1].Next;
  ...
  *((_BYTE *)&v22[21].Next + 12) = v31;
  if ( v31 )
  {
    *((_DWORD *)&v22[35].Next + 3) = v32;
    LODWORD(v22[36].Next) = v30;
    v33 = 8 * v30;
    v34 = v30 << 6;
    HIDWORD(v22[36].Next) = v32 * (v34 + ((v33 + 199) & 0xFFFFFFF8)) + 16;
    v35 = v32 * (v34 + ((v33 + 199) & 0xFFFFFFF8)) + 584;
