/*
 * XREFs of ?NotifyChannelClosed@DXGCHANNELENDPOINTPROXY@@QEAAXXZ @ 0x1C02B2F1C
 * Callers:
 ...
 *     ?GetUsedEntryCount@HMGRTABLE@@QEAAIXZ @ 0x1C004C8A4 (-GetUsedEntryCount@HMGRTABLE@@QEAAIXZ.c)
