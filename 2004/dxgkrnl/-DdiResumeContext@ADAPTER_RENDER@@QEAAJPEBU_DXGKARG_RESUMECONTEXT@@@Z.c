/*
 * XREFs of ?DdiResumeContext@ADAPTER_RENDER@@QEAAJPEBU_DXGKARG_RESUMECONTEXT@@@Z @ 0x1C021DAC8
 * Callers:
 *     ?ADAPTER_RENDER_DdiResumeContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_RESUMECONTEXT@@@Z @ 0x1C0041540 (-ADAPTER_RENDER_DdiResumeContext@@YAJPEAVADAPTER_RENDER@@PEBU_DXGKARG_RESUMECONTEXT@@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // rcx
  __int64 (__fastcall *v13)(_QWORD, const struct _DXGKARG_RESUMECONTEXT *); // rax
  int v14; // ebx
  __int64 v15; // rcx
  _QWORD *v16; // rax
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5119LL);
  ...
  v12 = *((_QWORD *)this + 2);
  v13 = *(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_RESUMECONTEXT *))(v12 + 1232);
  if ( v13 )
