/*
 * XREFs of ?PrepareDripsBlockerProcessName@DripsBlockerTrackingHelper@@QEAAJPEBDPEAU_EPROCESS@@PEADIPEA_K@Z @ 0x1C02C3500
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCbCatA@@YAJPEAD_KPEBD@Z @ 0x1C004DB14 (-RtlStringCbCatA@@YAJPEAD_KPEBD@Z.c)
 *     ?RtlStringCbCopyExA@@YAJPEAD_KPEBDPEAPEADPEA_KK@Z @ 0x1C004DB8C (-RtlStringCbCopyExA@@YAJPEAD_KPEBDPEAPEADPEA_KK@Z.c)
 *     RtlStringLengthWorkerA @ 0x1C004DCF8 (RtlStringLengthWorkerA.c)
 */
