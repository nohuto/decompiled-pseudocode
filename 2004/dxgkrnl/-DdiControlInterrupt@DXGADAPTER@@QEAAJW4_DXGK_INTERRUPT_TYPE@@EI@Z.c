/*
 * XREFs of ?DdiControlInterrupt@DXGADAPTER@@QEAAJW4_DXGK_INTERRUPT_TYPE@@EI@Z @ 0x1C011D06C
 * Callers:
 *     DXGADAPTER_DdiControlInterrupt @ 0x1C0007470 (DXGADAPTER_DdiControlInterrupt.c)
