/*
 * XREFs of DpiMiracastHandlePowerCallback @ 0x1C02CDEE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiMiracastHandlePowerCallback(LPCGUID SettingGuid, _DWORD *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( v4 )
  {
    ...
    if ( !v5 )
    {
      if ( *Value )
      {
        if ( byte_1C00B1B1A && KeCancelTimer(&Timer) )
        {
          _InterlockedIncrement(&dword_1C00B1F50);
          v19 = 0LL;
          v15[0] = 6;
          v17 = 0LL;
          v16 = 0LL;
      ...
      {
        byte_1C00B1B1A = 1;
        if ( byte_1C00B1B18 && dword_1C00B1F38 )
        {
