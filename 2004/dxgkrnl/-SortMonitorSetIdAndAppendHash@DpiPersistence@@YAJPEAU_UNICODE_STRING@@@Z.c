/*
 * XREFs of ?SortMonitorSetIdAndAppendHash@DpiPersistence@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1C0143B28
 * Callers:
 ...
 *     ??_GCCD_SET_STRING_ID@@QEAAPEAXI@Z @ 0x1C000C4B0 (--_GCCD_SET_STRING_ID@@QEAAPEAXI@Z.c)
