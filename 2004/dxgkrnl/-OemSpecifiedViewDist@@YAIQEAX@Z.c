/*
 * XREFs of ?OemSpecifiedViewDist@@YAIQEAX@Z @ 0x1C02A9124
 * Callers:
 *     ?DetermineViewDistance@@YA_NQEAXAEBUtagSIZE@@H1PEAI@Z @ 0x1C0167FD0 (-DetermineViewDistance@@YA_NQEAXAEBUtagSIZE@@H1PEAI@Z.c)
 * Callees:
