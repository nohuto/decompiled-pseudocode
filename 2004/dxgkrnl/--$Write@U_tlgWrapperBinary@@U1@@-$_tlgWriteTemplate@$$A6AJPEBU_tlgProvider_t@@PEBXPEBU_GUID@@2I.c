/*
 * XREFs of ??$Write@U_tlgWrapperBinary@@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EtwWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU_tlgWrapperBinary@@3@Z @ 0x1C0044BCC
 * Callers:
        ...
        __int64 *a6)
{
  ...
  v11[1] = 0;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C00B0A20, a2, 0LL, 0LL, 6u, &v7);
}
