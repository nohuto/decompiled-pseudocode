/*
 * XREFs of ?_DispatchIoctrls@DXGMONITOR@@QEAAJKKPEAXK0PEA_K@Z @ 0x1C013BEB0
 * Callers:
 ...
 *     ?_QueryColorSpaceTransformCaps@DXGMONITOR@@AEAAJKPEAXPEA_K@Z @ 0x1C013F324 (-_QueryColorSpaceTransformCaps@DXGMONITOR@@AEAAJKPEAXPEA_K@Z.c)
        ...
        unsigned __int64 *a7)
{
  ...
  *(_QWORD *)(v11 + 32) = this;
  ...
  active = DXGMONITOR::_SetColorSpaceTransform(this, v9, (int *)a4);
LABEL_4:
  v17 = active;
  *a7 = 0LL;
  return v17;
