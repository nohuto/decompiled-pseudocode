/*
 * XREFs of ?DpiIndirectGetMiniport@@YAJAEBUDXGK_MINIPORT_FILTER@@AEAVAUTO_REMOVE_LOCK@@AEAVAUTO_PNPPOWER_LOCK@@PEAPEAU_FDO_CONTEXT@@@Z @ 0x1C02D4958
 * Callers:
 ...
 *     DpiGetDeviceInstanceId @ 0x1C02C7E58 (DpiGetDeviceInstanceId.c)
 */
        ...
        struct _FDO_CONTEXT **a4)
{
  ...
  v7 = qword_1C00B1B40;
  v14 = 0;
  if ( (__int64 *)qword_1C00B1B40 == &qword_1C00B1B40 )
    goto LABEL_33;
  do
  {
...
LABEL_27:
  ...
  while ( (__int64 *)v7 != &qword_1C00B1B40 );
  v5 = v15;
