/*
 * XREFs of ?DisplayID_UpdateForTelemetry@@YAJPEAUDisplayIDObj@@@Z @ 0x1C005F23C
 * Callers:
...
__int64 __fastcall DisplayID_UpdateForTelemetry(struct DisplayIDObj *a1)
{
  ...
  while ( 2 )
  {
    ...
    if ( !v3[1] )
      goto LABEL_36;
    v10 = (unsigned __int8 *)((unsigned __int64)(v3 + 4) & -(__int64)((_BYTE)v5 != 0));
    v6 = 0;
    while ( 1 )
    {
      v11 = v10[2];
      ...
      if ( !(_BYTE)v13 )
      {
        ...
        if ( v14 == 2 )
          goto LABEL_34;
        if ( v14 == 1 && (unsigned __int8 *)(v1 + 4) != v10 )
        {
          LOBYTE(v6) = v7 == 127;
          break;
        }
