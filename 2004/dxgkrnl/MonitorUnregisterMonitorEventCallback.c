/*
 * XREFs of MonitorUnregisterMonitorEventCallback @ 0x1C02F5008
 * Callers:
 *     ??1VIDPN_MGR@@UEAA@XZ @ 0x1C005A280 (--1VIDPN_MGR@@UEAA@XZ.c)
 * Callees:
 *     ?_RemoveMonitorEventHandler@MONITOR_MGR@@QEAAJPEAUHDXGMONITOREVENT__@@@Z @ 0x1C02F2B78 (-_RemoveMonitorEventHandler@MONITOR_MGR@@QEAAJPEAUHDXGMONITOREVENT__@@@Z.c)
 */
