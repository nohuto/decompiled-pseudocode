/*
 * XREFs of ?WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START@@YAXPEAU_DXGK_DIAG_HEADER@@@Z @ 0x1C0045094
 * Callers:
...
void __fastcall WriteDxgDiagnosticsEvent_MIRACAST_SESSION_START(struct _DXGK_DIAG_HEADER *a1)
{
  ...
  if ( (unsigned int)dword_1C00B0A20 > 4 && tlgKeywordOn((__int64)&dword_1C00B0A20, 0x200000000400LL) )
  {
