/*
 * XREFs of ?ProcessPointerShapeChange@OUTPUTDUPL_MGR@@QEAAJPEBU_DXGKARG_SETPOINTERPOSITION@@PEBU_DXGKARG_SETPOINTERSHAPE@@II@Z @ 0x1C0155970
 * Callers:
 *     OutputDuplProcessRemoteSessionSetPointerShape @ 0x1C029DF68 (OutputDuplProcessRemoteSessionSetPointerShape.c)
 * Callees:
