/*
 * XREFs of ??1?$Queue@UDISPMODECHANGEREQUEST@VIDPN_MGR@@@@UEAA@XZ @ 0x1C005A07C
 * Callers:
 *     ??1VIDPN_MGR@@UEAA@XZ @ 0x1C005A280 (--1VIDPN_MGR@@UEAA@XZ.c)
 *     ??_G?$Queue@UDISPMODECHANGEREQUEST@VIDPN_MGR@@@@UEAAPEAXI@Z @ 0x1C005AAF0 (--_G-$Queue@UDISPMODECHANGEREQUEST@VIDPN_MGR@@@@UEAAPEAXI@Z.c)
 * Callees:
