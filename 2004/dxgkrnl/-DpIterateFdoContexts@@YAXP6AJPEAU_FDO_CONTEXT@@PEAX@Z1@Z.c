/*
 * XREFs of ?DpIterateFdoContexts@@YAXP6AJPEAU_FDO_CONTEXT@@PEAX@Z1@Z @ 0x1C02D1A50
 * Callers:
 *     ?DpiKsrCancel@@YAXPEAX@Z @ 0x1C02D2114 (-DpiKsrCancel@@YAXPEAX@Z.c)
 *     DpiKsrCallback @ 0x1C02D2710 (DpiKsrCallback.c)
 *     DpiKsrDoKsrSave @ 0x1C02D2764 (DpiKsrDoKsrSave.c)
 * Callees:
...
void __fastcall DpIterateFdoContexts(__int64 (__fastcall *a1)(__int64 *, void *), void *a2)
{
  ...
  if ( *(_QWORD *)v4 != v4 )
  {
    ...
    while ( *(_QWORD *)v4 != qword_1C00B1B40 );
  }
