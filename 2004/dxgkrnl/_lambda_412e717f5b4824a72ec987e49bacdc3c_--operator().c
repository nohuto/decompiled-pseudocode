/*
 * XREFs of _lambda_412e717f5b4824a72ec987e49bacdc3c_::operator() @ 0x1C00D5660
 * Callers:
 *     _DXGKCALLONEXIT__lambda_412e717f5b4824a72ec987e49bacdc3c____::_2_::DXGKCALLONEXIT::_DXGKCALLONEXIT @ 0x1C002471C (_DXGKCALLONEXIT__lambda_412e717f5b4824a72ec987e49bacdc3c____--_2_--DXGKCALLONEXIT--_DXGKCALLONEX.c)
 * Callees:
...
char __fastcall lambda_412e717f5b4824a72ec987e49bacdc3c_::operator()(__int64 a1)
{
  ...
  if ( *v8 )
  {
    ...
    {
      LOBYTE(v8) = tlgKeywordOn((__int64)&dword_1C00B0A90, 0x800000000004LL);
      if ( (_BYTE)v8 )
      {
        v9 = *(__int64 **)(a1 + 16);
        v40 = 0;
        ...
        LOBYTE(v8) = tlgWriteTransfer_EtwWriteTransfer(
                       (__int64)&dword_1C00B0A90,
                       (unsigned __int8 *)dword_1C007EEDA,
                       0LL,
                       0LL,
                       6u,
                       &v28);
