/*
 * XREFs of ?VmBusSendSyncMessage@DXG_VMBUS_CHANNEL_BASE@@QEAAJPEAUDXGKVMB_COMMAND_BASE@@IPEAXPEAIPEAU_MDL@@@Z @ 0x1C024D0C8
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( v37 - 24 <= 0x1FFE7 && v13 < 0x20000 )
  {
    ...
    v17 = _InterlockedIncrement64(&qword_1C00B3518);
...
LABEL_29:
    v15 = (int)((__int64 (__fastcall *)(struct _KTHREAD *, struct DXGKVMB_COMMAND_BASE *, _QWORD, _QWORD, int, char *, unsigned int *, _QWORD))qword_1C00B3130)(
                 *this,
                 a2,
                 v37,
                 0LL,
