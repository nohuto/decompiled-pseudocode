/*
 * XREFs of DpiFdoHandleDevicePower @ 0x1C0172950
 * Callers:
 *     DpiFdoDispatchPower @ 0x1C0172070 (DpiFdoDispatchPower.c)
 * Callees:
 *     DxgkReportDeviceDirectedPowerDown @ 0x1C003B3AC (DxgkReportDeviceDirectedPowerDown.c)
 ...
 *     DpiFdoDetermineAffectedSession @ 0x1C02C7DB8 (DpiFdoDetermineAffectedSession.c)
 *     DpiFdoIsDevicePresent @ 0x1C02CB034 (DpiFdoIsDevicePresent.c)
 *     DpiFdoRebootForSurpriseRemoval @ 0x1C02CB5DC (DpiFdoRebootForSurpriseRemoval.c)
...
LABEL_95:
      v17 = v52;
LABEL_96:
      if ( (PDEVICE_OBJECT)qword_1C00B1DB8 == DeviceObject )
      {
        if ( (_BYTE)v27 )
        {
          if ( dword_1C00B1E68 == 3 && byte_1C00B1E88 )
          {
            LOBYTE(v28) = 1;
            DpiAcquirePostDisplayInfoFromBgfx(&xmmword_1C00B1DC8, v28, 0LL);
            byte_1C00B1E88 = 0;
            dword_1C00B1EB4 = 1;
          }
        }
