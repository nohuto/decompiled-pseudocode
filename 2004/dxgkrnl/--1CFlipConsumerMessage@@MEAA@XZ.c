/*
 * XREFs of ??1CFlipConsumerMessage@@MEAA@XZ @ 0x1C0067464
 * Callers:
 *     ??_ECFlipConsumerMessage@@MEAAPEAXI@Z @ 0x1C00674C0 (--_ECFlipConsumerMessage@@MEAAPEAXI@Z.c)
 * Callees:
 *     ??1CFlipPropertySetBase@@MEAA@XZ @ 0x1C006B06C (--1CFlipPropertySetBase@@MEAA@XZ.c)
 */
