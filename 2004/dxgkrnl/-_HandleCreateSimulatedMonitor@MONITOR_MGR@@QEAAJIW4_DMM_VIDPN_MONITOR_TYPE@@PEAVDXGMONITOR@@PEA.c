/*
 * XREFs of ?_HandleCreateSimulatedMonitor@MONITOR_MGR@@QEAAJIW4_DMM_VIDPN_MONITOR_TYPE@@PEAVDXGMONITOR@@PEAPEAV3@PEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C02F1ED8
 * Callers:
 ...
 *     ?_CreateTtmDevice@DXGMONITOR@@QEAAJXZ @ 0x1C018C00C (-_CreateTtmDevice@DXGMONITOR@@QEAAJXZ.c)
 ...
 *     ?_DestroyTtmDevice@DXGMONITOR@@QEAAXXZ @ 0x1C02F8A1C (-_DestroyTtmDevice@DXGMONITOR@@QEAAXXZ.c)
 */
