/*
 * XREFs of ?DdiControlDiagnosticReporting@DXGADAPTER@@QEAAJPEAU_DXGKARG_CONTROLDIAGNOSTICREPORTING@@@Z @ 0x1C02189F8
 * Callers:
        ...
        __int64 a3)
{
  ...
  v15 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_CONTROLDIAGNOSTICREPORTING *))this + 159))(
          *((_QWORD *)this + 34),
          a2);
  if ( v35[0] )
