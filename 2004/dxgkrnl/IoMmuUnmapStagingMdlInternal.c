/*
 * XREFs of IoMmuUnmapStagingMdlInternal @ 0x1C00565D4
 * Callers:
 *     IoMmuMapStagingMdlInternal @ 0x1C0056290 (IoMmuMapStagingMdlInternal.c)
 *     IoMmuUnmapStagingMdl @ 0x1C0056570 (IoMmuUnmapStagingMdl.c)
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00271E0 (_guard_dispatch_icall_nop.c)
 *     IoMmuReferenceMdl @ 0x1C00563D4 (IoMmuReferenceMdl.c)
 */
  ...
  do
  {
    ...
    if ( v9 )
    {
      ...
      *(_WORD *)(v10 + 8) = 8 * ((v11 >> 12) + 6);
      if ( (int)((__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C00B2078)(*(_QWORD *)(a1 + 8), *(_QWORD *)(a1 + 48)) < 0 )
      {
