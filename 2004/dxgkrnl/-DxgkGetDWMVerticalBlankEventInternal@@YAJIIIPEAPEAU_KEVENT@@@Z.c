/*
 * XREFs of ?DxgkGetDWMVerticalBlankEventInternal@@YAJIIIPEAPEAU_KEVENT@@@Z @ 0x1C0167B18
 * Callers:
 *     DxgkGetDWMVerticalBlankEvent @ 0x1C01679F0 (DxgkGetDWMVerticalBlankEvent.c)
 * Callees:
