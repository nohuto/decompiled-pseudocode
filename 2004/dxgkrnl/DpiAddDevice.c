/*
 * XREFs of DpiAddDevice @ 0x1C017EFC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DpiGetAgpStatus @ 0x1C0197C74 (DpiGetAgpStatus.c)
 *     DpiGetVgaStatus @ 0x1C0197E54 (DpiGetVgaStatus.c)
 ...
 *     DpiSetDeviceUsageType @ 0x1C02C7FC4 (DpiSetDeviceUsageType.c)
...
LABEL_63:
  ...
  *((_QWORD *)DeviceExtension + 49) = &DpiFdoHandleFilterResources;
  if ( !byte_1C00B1B11 && !DeviceExtension[480] )
...
LABEL_95:
  ...
  v200 = 0;
  v79 = (int)DpiReadPnpRegistryValue((__int64)DeviceObjecta, L"SoftGPUAdapter", (char *)&v200, 4u, 2u) >= 0 && v200;
...
LABEL_238:
  ...
  *((_QWORD *)DeviceExtension + 16) = DpiFdoDispatchPnp;
    ...
    *((_QWORD *)v6 + 17) = DpiFdoDispatchPower;
    if ( v6[1152] )
    {
      *(_BYTE *)(*((_QWORD *)v6 + 21) + 108LL) = 1;
      ...
      if ( qword_1C00B1DB8 && qword_1C00B1DB8 != qword_1C00B1DC0 )
      {
      ...
      qword_1C00B1DB8 = (__int64)DeviceObjecta;
      v167 = *((_QWORD *)v6 + 6);
      v205 = 0LL;
      started = (int)DpiDxgkDdiExchangePreStartInfo(v10, v167, &v205);
      ...
      if ( *((_DWORD *)v6 + 4) == 1953656900 && *((_DWORD *)v6 + 5) == 2 )
      {
        v162 = 1LL;
        v163 = HIDWORD(v205) >> 1;
        LOBYTE(v163) = (v205 & 0x200000000LL) != 0;
  ...
  if ( v182 && v188 )
  {
    qword_1C00B1DC0 = (__int64)DeviceObjecta;
    if ( !qword_1C00B1DB8 )
      qword_1C00B1DB8 = (__int64)DeviceObjecta;
...
LABEL_291:
  ...
  v227 = 0;
  v176 = DxgkDiagCalcDuration1us(&v217);
  v223[0] = 6;
  v229 = v196;
  v223[1] = 64;
  v226 = 0;
