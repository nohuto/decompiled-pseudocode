/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C004022C
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C0040360 (RtlWideCharArrayCopyStringWorker.c)
 */
