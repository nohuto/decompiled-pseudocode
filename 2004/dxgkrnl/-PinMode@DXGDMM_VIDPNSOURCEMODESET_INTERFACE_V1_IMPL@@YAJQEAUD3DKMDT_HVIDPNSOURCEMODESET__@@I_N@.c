/*
 * XREFs of ?PinMode@DXGDMM_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@I_N@Z @ 0x1C01327C0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a3)
{
  ...
  if ( v6 )
  {
    ...
    if ( v15 < 0 )
    {
      v22 = WdLogNewEntry5_WdDmmEvent(v14, v13);
      *(_QWORD *)(v22 + 24) = v5;
      *(_QWORD *)(v22 + 32) = this;
