/*
 * XREFs of ?VmBusSignalFenceNtSharedByRefCblt@DXG_HOST_VIRTUALGPU_VMBUS@@SAEPEAUDXGADAPTER_VMBUS_PACKET@@@Z @ 0x1C00D9D70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?AddReference@DXGSHAREDVMOBJECT@@QEAAJXZ @ 0x1C0237BC8 (-AddReference@DXGSHAREDVMOBJECT@@QEAAJXZ.c)
