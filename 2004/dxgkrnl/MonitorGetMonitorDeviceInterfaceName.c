/*
 * XREFs of MonitorGetMonitorDeviceInterfaceName @ 0x1C0142D9C
 * Callers:
 ...
 * Callees:
 *     ?RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x1C0018864 (-RtlStringCchCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z.c)
