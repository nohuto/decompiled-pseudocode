/*
 * XREFs of ?IncreaseMonitorUniquenessAllSessions@DXGSESSIONMGR@@QEAAXXZ @ 0x1C018BF20
 * Callers:
 *     DxgkIncreaseMonitorUniqueness @ 0x1C018BEF4 (DxgkIncreaseMonitorUniqueness.c)
 * Callees:
