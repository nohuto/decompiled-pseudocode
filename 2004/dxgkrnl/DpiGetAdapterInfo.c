/*
 * XREFs of DpiGetAdapterInfo @ 0x1C0178D14
 * Callers:
...
__int64 __fastcall DpiGetAdapterInfo(__int64 a1, _DWORD *a2, _QWORD *a3, _OWORD *a4)
{
  ...
  HANDLE v97; // [rsp+48h] [rbp-B8h] BYREF
  ...
  struct _UNICODE_STRING v101; // [rsp+90h] [rbp-70h] BYREF
  _QWORD v102[36]; // [rsp+A0h] [rbp-60h] BYREF

  Handle = 0LL;
  memset(v102, 0, 0x118uLL);
  v8 = *(_QWORD *)(a1 + 64);
  v9 = 1;
  v10 = *(_QWORD *)(v8 + 40);
  if ( !a3 )
    goto LABEL_79;
  memset(a3, 0, 0x460uLL);
  *a3 = *(_QWORD *)(v8 + 48);
  v11 = 0;
  v12 = 1;
  if ( *(_DWORD *)(v8 + 504) )
  ...
  *((_BYTE *)a3 + 80) = v31;
  ...
  if ( !(unsigned int)Feature_WSL_Device_GPU__private_IsEnabled()
    || (v100 = 0LL,
        ...
        MiniportInterface = DpiQueryMiniportInterface(a1, (unsigned int)&GUID_DEVINTERFACE_WDDM3_ON_VB, 56, 1),
        v34 = MiniportInterface,
        MiniportInterface < 0) )
  {
LABEL_79:
    *(_BYTE *)a2 = 0;
    ...
    else if ( !*(_BYTE *)(*(_QWORD *)(v8 + 40) + 133LL) && !*(_BYTE *)(v8 + 481) )
    {
      *(_BYTE *)a2 = 1;
      ...
      v40 = DpiOpenPnpRegistryKey(a1, 2LL, 131097LL, &Handle);
      v34 = v40;
      if ( v40 >= 0 )
      {
        RtlInitUnicodeString(&DestinationString, L"UserModeDriverName");
        v44 = DxgkRetrieveStringFromRegistry(Handle, &DestinationString);
        v34 = v44;
        if ( v44 >= 0 )
        {
          ...
          *(&ObjectAttributes.Attributes + 1) = 0;
          KeyHandle = 0LL;
          v101 = 0LL;
          RtlInitUnicodeString(&v101, L"DX9");
          ObjectAttributes.RootDirectory = Handle;
          ObjectAttributes.Length = 48;
          ObjectAttributes.ObjectName = &v101;
          ...
          *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
          ...
          if ( (int)DxgkRetrieveStringFromRegistry(Handle, &DestinationString) < 0 )
          {
            v65 = WdLogNewEntry5_WdEvent(v64, v63);
          ...
          if ( (int)DxgkRetrieveStringFromRegistry(Handle, &DestinationString) < 0 )
          {
            v68 = WdLogNewEntry5_WdEvent(v67, v66);
          ...
          if ( (int)DxgkRetrieveStringFromRegistry(Handle, &DestinationString) < 0 )
          {
            v71 = WdLogNewEntry5_WdEvent(v70, v69);
          ...
          *(_QWORD *)(v78 + 24) = DxgkRetrieveStringFromRegistry;
          ...
          if ( (int)DxgkRetrieveStringFromRegistry(Handle, &DestinationString) < 0 )
          {
            v81 = WdLogNewEntry5_WdEvent(v80, v79);
          ...
          if ( (int)DxgkRetrieveStringFromRegistry(Handle, &DestinationString) < 0 )
          {
            v83 = WdLogNewEntry5_WdEvent(0LL, v82);
            *(_QWORD *)(v83 + 24) = DxgkRetrieveStringFromRegistry;
          ...
          if ( *((_WORD *)a2 + 36) && **((_WORD **)a2 + 10) == 35 )
          {
            ...
            RtlInitUnicodeString(&v101, L"OpenGL");
            ObjectAttributes.RootDirectory = Handle;
            ObjectAttributes.Length = 48;
            ObjectAttributes.ObjectName = &v101;
            ObjectAttributes.Attributes = 576;
            *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
            if ( ZwOpenKey(&v97, 0x20019u, &ObjectAttributes) >= 0 )
            {
              RtlInitUnicodeString(&DestinationString, L"DriverName");
              if ( (int)DxgkRetrieveStringFromRegistry(v97, &DestinationString) < 0 )
              {
              ...
              if ( (int)DxgkRetrieveStringFromRegistry(v97, &DestinationString) < 0 )
              {
                ...
                *(_QWORD *)(v89 + 24) = DxgkRetrieveStringFromRegistry;
          ...
          if ( *((_QWORD *)a2 + 10) )
          {
            v102[5] = 0LL;
            LODWORD(v102[1]) = 288;
            LODWORD(v102[4]) = 0x4000000;
            v102[2] = L"OpenGLVersion";
            LODWORD(v102[6]) = 0;
            v102[3] = a2 + 22;
            LODWORD(v102[8]) = 288;
            v102[9] = L"OpenGLFlags";
            v102[10] = a2 + 23;
            v102[16] = L"OpenGLVersionWow";
            v102[17] = a2 + 28;
            v102[23] = L"OpenGLFlagsWow";
            v102[24] = a2 + 29;
            LODWORD(v102[11]) = 0x4000000;
            v102[12] = 0LL;
            LODWORD(v102[13]) = 0;
            LODWORD(v102[15]) = 288;
            LODWORD(v102[18]) = 0x4000000;
            v102[19] = 0LL;
            LODWORD(v102[20]) = 0;
            LODWORD(v102[22]) = 288;
            LODWORD(v102[25]) = 0x4000000;
            v102[26] = 0LL;
            LODWORD(v102[27]) = 0;
            if ( v9 )
            {
            ...
            if ( (int)RtlQueryRegistryValuesEx(v91, v90, v102, 0LL, 0LL) < 0 )
            {
              v94 = WdLogNewEntry5_WdEvent(v93, v92);
              *(_QWORD *)(v94 + 24) = RtlQueryRegistryValuesEx;
...
LABEL_81:
  ...
  SecurityQualityOfService = ObjectAttributes.SecurityQualityOfService;
  v37 = v100;
  a3[137] = ObjectAttributes.SecurityDescriptor;
  a3[138] = SecurityQualityOfService;
  a3[139] = v37;
  v38 = WdLogNewEntry5_WdError(SecurityDescriptor, SecurityQualityOfService);
  *(_QWORD *)(v38 + 24) = v34;
