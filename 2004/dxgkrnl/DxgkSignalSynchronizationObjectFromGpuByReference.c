/*
 * XREFs of DxgkSignalSynchronizationObjectFromGpuByReference @ 0x1C00E8A20
 * Callers:
 *     ?SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z @ 0x1C00026E0 (-SignalTokenSync@CAdapter@@UEAAJPEAX_K_N@Z.c)
 *     ?AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z @ 0x1C00639D0 (-AddSignalToContextByPtr@CAdapter@@UEAAJIPEAX_K@Z.c)
