/*
 * XREFs of ?UpdateTrackedWorkload@DXGTRACKEDWORKLOAD@@QEAAJPEAVDXGDEVICE@@PEBU_D3DKMT_UPDATETRACKEDWORKLOAD@@_K@Z @ 0x1C02BCEA0
 * Callers:
 ...
 *     ?FindInstancePair@DXGTRACKEDWORKLOAD@@IEAA_NPEAPEAUWorkloadInstancePair@1@@Z @ 0x1C02BC4FC (-FindInstancePair@DXGTRACKEDWORKLOAD@@IEAA_NPEAPEAUWorkloadInstancePair@1@@Z.c)
 *     ?GetInstanceForPair@DXGTRACKEDWORKLOAD@@IEAA_N_N_KPEAUWorkloadInstancePair@1@@Z @ 0x1C02BC644 (-GetInstanceForPair@DXGTRACKEDWORKLOAD@@IEAA_N_N_KPEAUWorkloadInstancePair@1@@Z.c)
        ...
        __int64 a4)
{
  ...
  DXGPUSHLOCK *v26; // [rsp+48h] [rbp-30h]
  int v27; // [rsp+50h] [rbp-28h]
  struct DXGTRACKEDWORKLOAD::WorkloadInstancePair *v28; // [rsp+88h] [rbp+10h] BYREF

  v6 = 0;
  v28 = 0LL;
  DXGAUTOPUSHLOCK::DXGAUTOPUSHLOCK((DXGAUTOPUSHLOCK *)v25, (struct _KTHREAD **)this + 5, 0);
  ...
  *((_QWORD *)this + 39) = a3->GPUCalibrationTimestamp;
  if ( !DXGTRACKEDWORKLOAD::FindInstancePair(this, &v28) )
  {
    v6 = -2147483622;
...
LABEL_19:
  ...
  v14 = v28;
  if ( !DXGTRACKEDWORKLOAD::GetInstanceForPair(this, a3->BeginTrackedWorkloadIndex != 0, a3->FenceSubmissionValue, v28) )
  {
