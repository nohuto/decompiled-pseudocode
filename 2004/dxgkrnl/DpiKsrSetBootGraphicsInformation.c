/*
 * XREFs of DpiKsrSetBootGraphicsInformation @ 0x1C02D2CC4
 * Callers:
...
NTSTATUS DpiKsrSetBootGraphicsInformation()
{
  ...
  v4 = 0LL;
  v5 = 0;
  v2 = xmmword_1C00B1DC8;
  v3 = DWORD1(xmmword_1C00B1DC8);
  SystemInformation = xmmword_1C00B1DD8;
  if ( HIDWORD(xmmword_1C00B1DC8) == 20 )
  {
    HIDWORD(v4) = 3;
    HIDWORD(v3) = DWORD2(xmmword_1C00B1DC8) / 3;
    return ZwSetSystemInformation(MaxSystemInfoClass|SystemTimeAdjustmentInformation, &SystemInformation, 0x20uLL);
  }
  if ( SHIDWORD(xmmword_1C00B1DC8) <= 20 )
    goto LABEL_8;
  if ( SHIDWORD(xmmword_1C00B1DC8) <= 22 )
  {
    HIDWORD(v4) = 4;
    goto LABEL_7;
  }
  if ( (unsigned int)(HIDWORD(xmmword_1C00B1DC8) - 32) > 1 )
  {
LABEL_8:
    HIDWORD(v4) = 0;
    return ZwSetSystemInformation(MaxSystemInfoClass|SystemTimeAdjustmentInformation, &SystemInformation, 0x20uLL);
  ...
  HIDWORD(v4) = 2;
LABEL_7:
  HIDWORD(v3) = DWORD2(xmmword_1C00B1DC8) >> 2;
  return ZwSetSystemInformation(MaxSystemInfoClass|SystemTimeAdjustmentInformation, &SystemInformation, 0x20uLL);
}
