/*
 * XREFs of ?DxgkCddPresentOnScreen@@YAJPEAU_DXGKCDD_PRESENT_ON_SCREEN@@@Z @ 0x1C00DD900
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsIdenticalMode@ADAPTER_DISPLAY@@QEAAEI@Z @ 0x1C0039E74 (-IsIdenticalMode@ADAPTER_DISPLAY@@QEAAEI@Z.c)
