/*
 * XREFs of CreateDxgkSharedObjectTypes @ 0x1C019069C
 * Callers:
 *     ?Initialize@DXGGLOBAL@@QEAAJXZ @ 0x1C018D86C (-Initialize@DXGGLOBAL@@QEAAJXZ.c)
 * Callees:
 *     ?GenericMapping@DxgkCompositionObject@@SA?AU_GENERIC_MAPPING@@XZ @ 0x1C001AAD4 (-GenericMapping@DxgkCompositionObject@@SA-AU_GENERIC_MAPPING@@XZ.c)
...
__int64 CreateDxgkSharedObjectTypes()
{
  ...
  if ( g_pDxgkSharedAllocationObjectType
    || (v1 = (struct _GENERIC_MAPPING)xmmword_1C007CA10,
        ...
        (int)result >= 0) )
  {
    ...
    {
      v1 = (struct _GENERIC_MAPPING)xmmword_1C007CA30;
      result = CreateSharedObject(
    ...
    if ( (int)result >= 0 )
    {
      ...
      {
        v1 = (struct _GENERIC_MAPPING)xmmword_1C007CA40;
        result = CreateSharedObject(
          ...
          if ( (int)result >= 0 )
          {
            ...
            if ( (int)result >= 0 )
            {
              ...
              if ( (int)result >= 0 )
              {
                ...
                {
                  v1 = (struct _GENERIC_MAPPING)xmmword_1C007CA20;
                  result = CreateSharedObject(
