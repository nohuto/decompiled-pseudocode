/*
 * XREFs of ??_GDXG_GUEST_COMPOSITIONOBJECTCHANNEL@@IEAAPEAXI@Z @ 0x1C02B3C74
 * Callers:
 *     ?Delete@DXG_GUEST_COMPOSITIONOBJECTCHANNEL@@UEAAXXZ @ 0x1C02B4CB0 (-Delete@DXG_GUEST_COMPOSITIONOBJECTCHANNEL@@UEAAXXZ.c)
 * Callees:
