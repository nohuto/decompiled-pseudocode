/*
 * XREFs of DxgkDeviceIoctl @ 0x1C00435C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreateHandle@DxgkCompositionObject@@QEBAJK_NDPEAPEAX@Z @ 0x1C005DA80 (-CreateHandle@DxgkCompositionObject@@QEBAJK_NDPEAPEAX@Z.c)
