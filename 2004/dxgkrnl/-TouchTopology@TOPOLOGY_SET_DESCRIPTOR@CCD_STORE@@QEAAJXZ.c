/*
 * XREFs of ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x1C015B7B8
 * Callers:
 ...
 *     _anonymous_namespace_::_UpdateTimestampTopologySetCallback @ 0x1C015B7A0 (_anonymous_namespace_--_UpdateTimestampTopologySetCallback.c)
 * Callees:
 *     <none>
 */
