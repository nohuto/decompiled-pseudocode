/*
 * XREFs of ?VmBusChannelProcessPacket@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUVMBCHANNEL__@@PEAUVMBPACKETCOMPLETION__@@PEAXII@Z @ 0x1C00403D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?VmBusSignalGuestEvent@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUDXGKVMB_COMMAND_SIGNALGUESTEVENT@@@Z @ 0x1C0040F58 (-VmBusSignalGuestEvent@DXG_GUEST_GLOBAL_VMBUS@@SAXPEAUDXGKVMB_COMMAND_SIGNALGUESTEVENT@@@Z.c)
        ...
        unsigned int a5)
{
    ...
    if ( v10 )
    {
      ...
      else
      {
        ...
        if ( PoolWithTag )
        {
          ...
          v16[2].List.Flink = (struct _LIST_ENTRY *)((__int64 (__fastcall *)(struct _LIST_ENTRY *))qword_1C00B30C8)(a1);
          ExQueueWorkItem(v16, NormalWorkQueue);
          goto LABEL_13;
        }
        v18 = WdLogNewEntry5_WdLowResource(v13, v12, v14, v15);
        *(_QWORD *)(v18 + 24) = 12509LL;
  ...
  ((void (__fastcall *)(struct _LIST_ENTRY *, _QWORD, _QWORD))qword_1C00B3108)(a2, 0LL, 0LL);
LABEL_13:
  if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x400000) != 0 )
    McTemplateK0pxq_EtwWriteTransfer(
      (unsigned int)&DxgkControlGuid_Context,
