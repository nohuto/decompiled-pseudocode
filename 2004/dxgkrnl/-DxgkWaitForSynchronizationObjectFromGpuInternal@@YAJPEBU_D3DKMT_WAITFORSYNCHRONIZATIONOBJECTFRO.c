/*
 * XREFs of ?DxgkWaitForSynchronizationObjectFromGpuInternal@@YAJPEBU_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMGPU@@_N1PEB_K1@Z @ 0x1C00EB700
 * Callers:
 ...
 *     DxgkWaitForSynchronizationObjectFromGpu @ 0x1C00EB6D0 (DxgkWaitForSynchronizationObjectFromGpu.c)
