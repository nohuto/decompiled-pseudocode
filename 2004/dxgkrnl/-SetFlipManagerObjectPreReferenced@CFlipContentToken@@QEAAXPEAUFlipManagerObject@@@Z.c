/*
 * XREFs of ?SetFlipManagerObjectPreReferenced@CFlipContentToken@@QEAAXPEAUFlipManagerObject@@@Z @ 0x1C006F0D4
 * Callers:
 ...
 *     ?Discard@CFlipContentToken@@UEAAXXZ @ 0x1C006EFA0 (-Discard@CFlipContentToken@@UEAAXXZ.c)
 * Callees:
 *     <none>
 */
