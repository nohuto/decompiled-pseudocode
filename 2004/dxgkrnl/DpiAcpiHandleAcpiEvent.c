/*
 * XREFs of DpiAcpiHandleAcpiEvent @ 0x1C02D5B84
 * Callers:
 *     DpiAcpiHandleAcpiEventWork @ 0x1C02D6070 (DpiAcpiHandleAcpiEventWork.c)
 * Callees:
...
void __fastcall DpiAcpiHandleAcpiEvent(char *P)
{
  ...
  if ( v2 == 1 )
  {
    ...
    {
      if ( HIBYTE(word_1C00B1B1D) && qword_1C00B1B28 == *((_QWORD *)P + 2) )
      {
        *((_DWORD *)P + 6) = 4;
        v2 = 4;
        *((_QWORD *)P + 2) = qword_1C00B1B20;
      }
    }
  }
