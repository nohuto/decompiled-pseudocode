/*
 * XREFs of ?DdiResetFromTimeout@ADAPTER_RENDER@@QEAAJXZ @ 0x1C021D638
 * Callers:
...
__int64 __fastcall ADAPTER_RENDER::DdiResetFromTimeout(ADAPTER_RENDER *this, __int64 a2, __int64 a3)
{
  ...
  DXGETWPROFILER_BASE::PushProfilerEntry((__int64)&v25, 5020LL);
  ...
  v11 = (*(int (__fastcall **)(_QWORD))(*((_QWORD *)this + 2) + 480LL))(*(_QWORD *)(*((_QWORD *)this + 2) + 272LL));
  if ( v28[0] )
