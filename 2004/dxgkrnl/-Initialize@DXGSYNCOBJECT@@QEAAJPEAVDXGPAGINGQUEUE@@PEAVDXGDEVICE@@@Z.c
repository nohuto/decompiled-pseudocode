/*
 * XREFs of ?Initialize@DXGSYNCOBJECT@@QEAAJPEAVDXGPAGINGQUEUE@@PEAVDXGDEVICE@@@Z @ 0x1C00DBA98
 * Callers:
 ...
 *     ?Initialize@DXGSYNCOBJECTCA@@QEAAJXZ @ 0x1C0290A04 (-Initialize@DXGSYNCOBJECTCA@@QEAAJXZ.c)
 */
