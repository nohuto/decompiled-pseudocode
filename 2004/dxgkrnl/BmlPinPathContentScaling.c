/*
 * XREFs of BmlPinPathContentScaling @ 0x1C013B380
 * Callers:
...
__int64 __fastcall BmlPinPathContentScaling(__int64 a1, __int64 a2, unsigned __int16 a3)
{
  ...
  else
  {
    ...
    {
      if ( (dword_1C00B36AC & 1) == 0 )
      {
        v24 = *(VIDPN_MGR **)(a2 + 48);
        dword_1C00B36AC |= 1u;
        dword_1C00B3660[0] = VIDPN_MGR::GetAdapterDefaultScaling(v24);
        dword_1C00B3664 = 3;
        dword_1C00B3668 = 4;
        dword_1C00B366C = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v25 >= 4 )
          break;
        v11 = dword_1C00B3660;
        v12 = (unsigned int)dword_1C00B3660[v25];
