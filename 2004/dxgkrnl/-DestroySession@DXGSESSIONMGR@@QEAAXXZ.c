/*
 * XREFs of ?DestroySession@DXGSESSIONMGR@@QEAAXXZ @ 0x1C015F0C8
 * Callers:
 ...
 *     ?ReleaseSessionModeChangeLock@DXGSESSIONDATA@@QEAAXXZ @ 0x1C00191B4 (-ReleaseSessionModeChangeLock@DXGSESSIONDATA@@QEAAXXZ.c)
    ...
    if ( v5 == v7 )
    {
      ...
      *(_QWORD *)(v17 + 24) = 5002LL;
      ...
      if ( v5 == (DXGSESSIONDATA *)v19 )
      {
        ...
        DXGSESSIONMGR::SetConsoleSession(*((struct DXGSESSIONDATA ***)Global + 102), 0LL);
      }
    }
