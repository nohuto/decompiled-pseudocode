/*
 * XREFs of ?IsDriverCustomScalingSupported@DMMVIDPNPRESENTPATH@@QEBAEXZ @ 0x1C010F518
 * Callers:
...
bool __fastcall DMMVIDPNPRESENTPATH::IsDriverCustomScalingSupported(DMMVIDPNPRESENTPATH *this, __int64 a2)
{
  __int64 v2; // rdi
  __int64 v3; // rbx
  __int64 v4; // rax
