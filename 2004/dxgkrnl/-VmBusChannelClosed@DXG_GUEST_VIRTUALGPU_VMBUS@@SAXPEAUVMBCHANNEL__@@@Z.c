/*
 * XREFs of ?VmBusChannelClosed@DXG_GUEST_VIRTUALGPU_VMBUS@@SAXPEAUVMBCHANNEL__@@@Z @ 0x1C023CF10
 * Callers:
...
void __fastcall DXG_GUEST_VIRTUALGPU_VMBUS::VmBusChannelClosed(struct VMBCHANNEL__ *a1)
{
  ...
  v2 = ((__int64 (__fastcall *)(struct VMBCHANNEL__ *))qword_1C00B30C8)(a1);
