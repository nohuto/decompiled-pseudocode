/*
 * XREFs of DpiAddMemoryTracker @ 0x1C00567F0
 * Callers:
 ...
 *     ?PinFrameBufferForSave@DXGADAPTER@@QEAAJI_KPEAPEAU_MDL@@@Z @ 0x1C020E180 (-PinFrameBufferForSave@DXGADAPTER@@QEAAJI_KPEAPEAU_MDL@@@Z.c)
 * Callees:
