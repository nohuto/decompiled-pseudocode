/*
 * XREFs of DpiMiracastGetDeviceContextFromLuid @ 0x1C005262C
 * Callers:
...
__int64 __fastcall DpiMiracastGetDeviceContextFromLuid(__int64 a1, char a2)
{
  ...
  v4 = qword_1C00B1F18;
  if ( (__int64 *)qword_1C00B1F18 == &qword_1C00B1F18 )
    goto LABEL_9;
  do
  {
    v5 = v4;
  ...
  while ( (__int64 *)v4 != &qword_1C00B1F18 );
  if ( (__int64 *)v4 == &qword_1C00B1F18 )
  {
LABEL_9:
    v5 = 0LL;
  }
