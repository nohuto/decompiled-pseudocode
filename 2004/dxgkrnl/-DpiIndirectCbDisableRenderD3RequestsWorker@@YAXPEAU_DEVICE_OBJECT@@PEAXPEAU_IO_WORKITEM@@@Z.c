/*
 * XREFs of ?DpiIndirectCbDisableRenderD3RequestsWorker@@YAXPEAU_DEVICE_OBJECT@@PEAXPEAU_IO_WORKITEM@@@Z @ 0x1C02D43A0
 * Callers:
 *     <none>
 * Callees:
 *     ??3@YAXPEAX@Z @ 0x1C00027E4 (--3@YAXPEAX@Z.c)
 *     ?Release@AUTO_PNPPOWER_LOCK@@QEAAXXZ @ 0x1C001E310 (-Release@AUTO_PNPPOWER_LOCK@@QEAAXXZ.c)
 *     ?Release@AUTO_REMOVE_LOCK@@QEAAXXZ @ 0x1C001E368 (-Release@AUTO_REMOVE_LOCK@@QEAAXXZ.c)
...
void __fastcall DpiIndirectCbDisableRenderD3RequestsWorker(PVOID IoObject, PVOID Context, PIO_WORKITEM IoWorkItem)
{
  ...
  while ( 1 )
  {
    KeWaitForSingleObject(&stru_1C00B2098, Executive, 0, 0, 0LL);
    v4 = (char *)qword_1C00B20D0;
    if ( qword_1C00B20D0 == &qword_1C00B20D0 )
      break;
    if ( *((void ***)qword_1C00B20D0 + 1) != &qword_1C00B20D0
      || (v5 = *(_QWORD *)qword_1C00B20D0, *(void **)(*(_QWORD *)qword_1C00B20D0 + 8LL) != qword_1C00B20D0) )
    {
      __fastfail(3u);
    }
    qword_1C00B20D0 = *(void **)qword_1C00B20D0;
    *(_QWORD *)(v5 + 8) = &qword_1C00B20D0;
    KeReleaseMutex(&stru_1C00B2098, 0);
    v6 = *(_QWORD *)(v4 + 20);
    v17 = 0LL;
    v13 = 0LL;
    v14 = 0;
