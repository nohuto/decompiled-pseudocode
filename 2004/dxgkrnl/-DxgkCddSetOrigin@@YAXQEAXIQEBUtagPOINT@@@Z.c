/*
 * XREFs of ?DxgkCddSetOrigin@@YAXQEAXIQEBUtagPOINT@@@Z @ 0x1C014A270
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetContentRect@ADAPTER_DISPLAY@@QEAAXIQEBUtagRECT@@@Z @ 0x1C000D028 (-SetContentRect@ADAPTER_DISPLAY@@QEAAXIQEBUtagRECT@@@Z.c)
...
void __fastcall DxgkCddSetOrigin(struct DXGADAPTER *a1, unsigned int a2, const struct tagPOINT *const a3)
{
  ...
  else
  {
    ...
    v11 = COREADAPTERACCESS::AcquireExclusive((__int64)v39, 1LL);
    v14 = v11;
    if ( v11 < 0 )
    {
    ...
    else
    {
      ...
      DisplayModeInfo = ADAPTER_DISPLAY::GetDisplayModeInfo(v10[337], (unsigned int)v5);
      x = a3->x;
      y = a3->y;
      v20 = 3968 * v5;
      v21 = *((_QWORD *)v10[337] + 14);
      ...
      ADAPTER_DISPLAY::SetContentRect(v10[337], v5, &v34);
    }
