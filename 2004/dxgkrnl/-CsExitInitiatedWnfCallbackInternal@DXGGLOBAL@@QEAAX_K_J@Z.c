/*
 * XREFs of ?CsExitInitiatedWnfCallbackInternal@DXGGLOBAL@@QEAAX_K_J@Z @ 0x1C0268898
 * Callers:
    ...
    while ( v7 != (DXGGLOBAL *)((char *)this + 664) && v7 )
    {
      ...
      if ( *((_QWORD *)v8 + 338) && *((_DWORD *)v8 + 739) && *((_DWORD *)v8 + 736) )
      {
        ...
        if ( (_BYTE)v9 )
        {
          ...
          if ( (unsigned int)dword_1C00B0A90 > 5 && tlgKeywordOn((__int64)&dword_1C00B0A90, 0x400000000004LL) )
          {
