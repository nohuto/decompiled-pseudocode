/*
 * XREFs of ?SendUnPairAndRelease@DXGCOMPOSITIONSURFACEPROXY@@IEAAJXZ @ 0x1C028E1C8
 * Callers:
...
LABEL_17:
    ...
    {
      v20 = *((_DWORD *)this + 5);
      if ( v20 && *((_BYTE *)this + 24) )
      {
        v21 = DXGSESSIONDATA::VailSendReleaseCompositionSurfaceReference(SessionDataForSpecifiedSession, v20);
        v3 = v21;
        if ( v21 >= 0 )
        {
          *((_BYTE *)this + 24) = 0;
...
LABEL_19:
  ...
  *((_DWORD *)this + 5) = 0;
  if ( v24[8] )
    DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)v24, v23);
