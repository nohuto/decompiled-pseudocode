/*
 * XREFs of ?AdjustFullscreenGammaRamp@ADAPTER_DISPLAY@@QEAAJPEBUDXGK_GAMMA_RAMP@@PEAU2@PEAUDXGK_GAMMA_ADJUSTMENT@@@Z @ 0x1C0210A18
 * Callers:
 ...
 * Callees:
 *     ?ScaleAndOffset@@YAGGMM@Z @ 0x1C0214D64 (-ScaleAndOffset@@YAGGMM@Z.c)
 */
