/*
 * XREFs of ??$OpenResource@U_D3DKMT_OPENRESOURCEFROMNTHANDLE@@@DXGDEVICE@@QEAAJPEAU_D3DKMT_OPENRESOURCEFROMNTHANDLE@@IPEAU_DXGSHAREDALLOCOBJECT@@IPEAVCOREDEVICEACCESS@@HPEAU_EPROCESS@@PEAIPEA_K@Z @ 0x1C011AE60
 * Callers:
        ...
        unsigned __int64 *a10)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(v23 + 136) - 44LL) & 2) == 0
    || (v55 = *(_QWORD *)(*(_QWORD *)&this->SupportedReadSegmentSet + 88LL)) == 0
