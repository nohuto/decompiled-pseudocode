/*
 * XREFs of ?EnableEntryAccounting@DripsBlockerTrackingHelper@@IEAAXII_N@Z @ 0x1C02C0728
 * Callers:
 ...
 * Callees:
 *     ?AddActiveTime@DripsBlockerTrackingHelper@@IEAAXII@Z @ 0x1C02BF48C (-AddActiveTime@DripsBlockerTrackingHelper@@IEAAXII@Z.c)
 */
