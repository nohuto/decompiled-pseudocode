/*
 * XREFs of ?_InitColorSpaceTransformCaps@DXGMONITOR@@AEAAJXZ @ 0x1C0187280
 * Callers:
 ...
 * Callees:
 *     ?_IsTargetMatrix_3x4Supported@DXGMONITOR@@AEAAEXZ @ 0x1C013F390 (-_IsTargetMatrix_3x4Supported@DXGMONITOR@@AEAAEXZ.c)
 */
