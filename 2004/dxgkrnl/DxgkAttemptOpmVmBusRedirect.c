/*
 * XREFs of DxgkAttemptOpmVmBusRedirect @ 0x1C016F450
 * Callers:
 *     DpiPdoHandleOpmIoctls @ 0x1C016F248 (DpiPdoHandleOpmIoctls.c)
 * Callees:
 *     ?GetGlobal@DXGGLOBAL@@SAPEAV1@XZ @ 0x1C0004010 (-GetGlobal@DXGGLOBAL@@SAPEAV1@XZ.c)
 *     _tlgKeywordOn @ 0x1C000AE58 (_tlgKeywordOn.c)
 *     DXGKCALLONEXIT__lambda_0f534b3d3ec4016b5fe0be2c2202598e___ @ 0x1C001D1D4 (DXGKCALLONEXIT__lambda_0f534b3d3ec4016b5fe0be2c2202598e___.c)
        ...
        _DWORD *a8)
{
  ...
  *a8 = -1073741823;
  ...
  if ( v37
    ...
    && (unsigned int)dword_1C00B09E8 > 5
    && tlgKeywordOn((__int64)&dword_1C00B09E8, 0x400000100000LL) )
  {
