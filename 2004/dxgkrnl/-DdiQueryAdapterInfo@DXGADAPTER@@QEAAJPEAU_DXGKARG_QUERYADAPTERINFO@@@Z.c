/*
 * XREFs of ?DdiQueryAdapterInfo@DXGADAPTER@@QEAAJPEAU_DXGKARG_QUERYADAPTERINFO@@@Z @ 0x1C0126C58
 * Callers:
 *     DXGADAPTER_DdiQueryAdapterInfo @ 0x1C00242C0 (DXGADAPTER_DdiQueryAdapterInfo.c)
