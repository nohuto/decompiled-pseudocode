/*
 * XREFs of _lambda_30de2fb5eb4f6d1d827b6d0e4acdd9ca_::operator() @ 0x1C00D6C68
 * Callers:
 ...
 *     ?RemoveMapping@REMOTEVSYNCMAPPING@@QEAAJPEAXU_LUID@@I0_N@Z @ 0x1C004E818 (-RemoveMapping@REMOTEVSYNCMAPPING@@QEAAJPEAXU_LUID@@I0_N@Z.c)
 */

__int64 __fastcall lambda_30de2fb5eb4f6d1d827b6d0e4acdd9ca_::operator()(__int64 **a1)
{
  __int64 v2; // rcx
  __int64 v3; // rdx
  __int64 v4; // rax
