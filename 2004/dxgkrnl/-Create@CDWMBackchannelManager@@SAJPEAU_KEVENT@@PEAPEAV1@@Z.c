/*
 * XREFs of ?Create@CDWMBackchannelManager@@SAJPEAU_KEVENT@@PEAPEAV1@@Z @ 0x1C006C91C
 * Callers:
 *     ?Initialize@CFlipManager@@IEAAJXZ @ 0x1C006A754 (-Initialize@CFlipManager@@IEAAJXZ.c)
 * Callees:
 *     ??0CDWMBackchannelManager@@IEAA@PEAU_KEVENT@@@Z @ 0x1C006C810 (--0CDWMBackchannelManager@@IEAA@PEAU_KEVENT@@@Z.c)
 */
