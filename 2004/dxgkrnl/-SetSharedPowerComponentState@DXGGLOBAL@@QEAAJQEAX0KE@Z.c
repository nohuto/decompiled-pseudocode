/*
 * XREFs of ?SetSharedPowerComponentState@DXGGLOBAL@@QEAAJQEAX0KE@Z @ 0x1C026B644
 * Callers:
 *     DxgSetSharedPowerComponentStateCB @ 0x1C0251810 (DxgSetSharedPowerComponentStateCB.c)
 * Callees:
