/*
 * XREFs of ?DxgkCddOpenResourceFromNtHandle@@YAJPEAU_D3DKMT_OPENRESOURCEFROMNTHANDLE@@IPEAU_EPROCESS@@PEAIPEAPEAXPEA_K@Z @ 0x1C022CDF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  if ( v13 >= 0 )
  {
    v13 = DXGDEVICE::OpenResource<_D3DKMT_OPENRESOURCEFROMNTHANDLE>(
            (struct _DXGK_ALLOCATIONINFO *)v29,
            (__int64)a1,
            0,
            (__int64)v20,
            (UINT)v51,
...
LABEL_31:
            ...
            if ( v41 )
            {
              if ( !ADAPTER_RENDER::GdiNodeSupportsGpuVa(*((ADAPTER_RENDER **)v29 + 2))
                || (v13 = MapGpuVirtualAddressToAllocation(v42, (struct DXGALLOCATION *)v41), v13 >= 0) )
              {
                if ( a5 )
                  *a5 = (void *)(*(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v29 + 2)
                                                                                                  + 640LL)
                                                                                      + 8LL)
                                                                          + 688LL))(
                                  *(_QWORD *)(*((_QWORD *)v29 + 2) + 648LL),
                                  *(_QWORD *)(v41 + 24));
