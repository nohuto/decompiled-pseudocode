/*
 * XREFs of ?DxgkCddOpenResource@@YAJPEAU_D3DKMT_OPENRESOURCE@@IPEAU_EPROCESS@@PEAIPEAPEAXPEA_K@Z @ 0x1C022CA30
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v42 )
  {
    ...
    if ( v29 < 0
      || (v29 = DXGDEVICE::OpenResource<_D3DKMT_OPENRESOURCE>(
                  (struct _DXGK_ALLOCATIONINFO *)v23,
                  (__int64)a1,
                  a1->hGlobalShare,
                  0LL,
                  a2,
...
LABEL_21:
          ...
          if ( v37 )
          {
            if ( ADAPTER_RENDER::GdiNodeSupportsGpuVa(*((ADAPTER_RENDER **)v23 + 2))
            ...
            {
              if ( a5 )
                *a5 = (void *)(*(__int64 (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v23 + 2)
                                                                                                + 640LL)
                                                                                    + 8LL)
                                                                        + 688LL))(
                                *(_QWORD *)(*((_QWORD *)v23 + 2) + 648LL),
                                *(_QWORD *)(v37 + 24));
              v17 = 0;
            }
          }
