/*
 * XREFs of ?RemoveAllSourceViewFromSession@DXGSESSIONDATA@@QEAAXXZ @ 0x1C00DF3C0
 * Callers:
 ...
 *     ?RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ @ 0x1C00DF460 (-RemoveAllDisplaySource@SESSION_VIEW@@QEAAXXZ.c)
 */
