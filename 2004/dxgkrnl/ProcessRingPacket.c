/*
 * XREFs of ProcessRingPacket @ 0x1C02B39E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ProcessRingPacket(__int64 a1, struct VMBPACKETCOMPLETION__ *a2, unsigned int *a3, unsigned int a4)
{
  ...
  if ( a4 <= 8
    || (v8 = ((__int64 (*)(void))qword_1C00B30C8)()) == 0
    || *(_BYTE *)(v8 + 28)
    || (result = DXGVMBUSCHANNEL::ProcessPacket((struct _EX_RUNDOWN_REF *)v8, *a3, a2, a3, a4), (int)result < 0) )
  {
    ...
    {
      v10 = ((__int64 (__fastcall *)(__int64))qword_1C00B30C8)(a1);
      if ( v10 )
        *(_BYTE *)(v10 + 28) = 1;
    }
    return ((__int64 (__fastcall *)(struct VMBPACKETCOMPLETION__ *, _QWORD, _QWORD))qword_1C00B3108)(a2, 0LL, 0LL);
  }
  return result;
}
