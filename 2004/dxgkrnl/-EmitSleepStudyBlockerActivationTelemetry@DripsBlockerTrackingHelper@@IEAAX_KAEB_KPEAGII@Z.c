/*
 * XREFs of ?EmitSleepStudyBlockerActivationTelemetry@DripsBlockerTrackingHelper@@IEAAX_KAEB_KPEAGII@Z @ 0x1C02BFB9C
 * Callers:
        ...
        unsigned int a6)
{
  ...
  {
    if ( tlgKeywordOn((__int64)&dword_1C00B0A90, 0x400000002000LL) )
    {
