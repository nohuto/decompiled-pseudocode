/*
 * XREFs of DxgkMultiPlaneOverlayDisabledCB @ 0x1C00422A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?NotifyMultiPlaneOverlayDisable@DXGADAPTER@@QEAAXI@Z @ 0x1C0036CAC (-NotifyMultiPlaneOverlayDisable@DXGADAPTER@@QEAAXI@Z.c)
 */
