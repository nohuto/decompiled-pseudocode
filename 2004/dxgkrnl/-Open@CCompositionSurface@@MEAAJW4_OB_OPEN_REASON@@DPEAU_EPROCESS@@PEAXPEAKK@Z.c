/*
 * XREFs of ?Open@CCompositionSurface@@MEAAJW4_OB_OPEN_REASON@@DPEAU_EPROCESS@@PEAXPEAKK@Z @ 0x1C0017830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCompositionSurface::Open(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (*(unsigned int (__fastcall **)(__int64))(*((_QWORD *)DXGGLOBAL::m_pGlobal + 38048) + 304LL))(a4) )
  {
    *(_QWORD *)(a1 + 40) = a4;
