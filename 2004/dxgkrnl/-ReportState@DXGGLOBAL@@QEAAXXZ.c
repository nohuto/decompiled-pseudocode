/*
 * XREFs of ?ReportState@DXGGLOBAL@@QEAAXXZ @ 0x1C026B02C
 * Callers:
 *     ?DxgkReportGlobalState@@YAXXZ @ 0x1C0268E90 (-DxgkReportGlobalState@@YAXXZ.c)
 * Callees:
 ...
 *     ?ReportAdapterObjectState@DXGADAPTERSYNCOBJECT@@QEAAXPEAVDXGSYNCOBJECT@@@Z @ 0x1C02916AC (-ReportAdapterObjectState@DXGADAPTERSYNCOBJECT@@QEAAXPEAVDXGSYNCOBJECT@@@Z.c)
 */
