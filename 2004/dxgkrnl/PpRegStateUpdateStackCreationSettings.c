/*
 * XREFs of PpRegStateUpdateStackCreationSettings @ 0x1C02C4D18
 * Callers:
 *     IoDevObjCreateDeviceSecure @ 0x1C02C3B60 (IoDevObjCreateDeviceSecure.c)
 * Callees:
 *     PiRegStateOpenClassKey @ 0x1C02C4824 (PiRegStateOpenClassKey.c)
 *     CmRegUtilCreateWstrKey @ 0x1C02C4FF0 (CmRegUtilCreateWstrKey.c)
 *     CmRegUtilWstrValueSetFullBuffer @ 0x1C02C541C (CmRegUtilWstrValueSetFullBuffer.c)
 */
