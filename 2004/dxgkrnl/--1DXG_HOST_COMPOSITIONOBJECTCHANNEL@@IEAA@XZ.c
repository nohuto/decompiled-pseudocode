/*
 * XREFs of ??1DXG_HOST_COMPOSITIONOBJECTCHANNEL@@IEAA@XZ @ 0x1C02B3BDC
 * Callers:
 *     ?Delete@DXG_HOST_COMPOSITIONOBJECTCHANNEL@@UEAAXXZ @ 0x1C02B4CF0 (-Delete@DXG_HOST_COMPOSITIONOBJECTCHANNEL@@UEAAXXZ.c)
 * Callees:
