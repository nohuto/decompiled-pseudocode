/*
 * XREFs of ??0DISPLAY_CALLOUT_ENTRY@@QEAA@AEBU_LUID@@IW4MONITOR_EVENT@@_KEPEAU_DXGK_DISPLAY_SCENARIO_CONTEXT@@@Z @ 0x1C0267DF0
 * Callers:
        ...
        __int64 a7)
{
  ...
  *(_QWORD *)(a1 + 128) = *(_QWORD *)(a7 + 64);
  if ( a6 )
    _InterlockedIncrement((volatile signed __int32 *)DXGGLOBAL::GetGlobal(a1, (__int64)a2) + 442);
  return a1;
}
