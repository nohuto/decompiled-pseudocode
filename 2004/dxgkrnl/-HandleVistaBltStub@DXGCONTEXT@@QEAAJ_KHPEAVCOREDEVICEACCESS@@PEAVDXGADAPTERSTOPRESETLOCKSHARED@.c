/*
 * XREFs of ?HandleVistaBltStub@DXGCONTEXT@@QEAAJ_KHPEAVCOREDEVICEACCESS@@PEAVDXGADAPTERSTOPRESETLOCKSHARED@@IPEAIPEAPEAV1@@Z @ 0x1C027FC60
 * Callers:
...
LABEL_72:
    if ( v69 )
      DXGCONTEXT::DestroyAllocation(this, v69, (char **)a4);
    if ( v67 )
    ...
    if ( v15 )
    {
      if ( (_DWORD)v8 )
      {
        ...
        do
        {
          v66 = *v65;
          if ( (_DWORD)v66 )
            DXGCONTEXT::DestroyAllocation(this, v66, (char **)a4);
          ++v65;
          --v8;
        }
        while ( v8 );
