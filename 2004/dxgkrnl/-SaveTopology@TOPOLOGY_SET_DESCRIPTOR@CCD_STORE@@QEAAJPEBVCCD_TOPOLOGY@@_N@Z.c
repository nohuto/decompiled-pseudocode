/*
 * XREFs of ?SaveTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJPEBVCCD_TOPOLOGY@@_N@Z @ 0x1C015B224
 * Callers:
 *     _anonymous_namespace_::_SaveTopologySetCallback @ 0x1C015B1F0 (_anonymous_namespace_--_SaveTopologySetCallback.c)
 * Callees:
 ...
 *     _CcdWriteRegistryValues @ 0x1C015B628 (_CcdWriteRegistryValues.c)
 *     ?MapModalitySetIdPath@CCD_TOPOLOGY@@QEBAJIPEAG@Z @ 0x1C015B744 (-MapModalitySetIdPath@CCD_TOPOLOGY@@QEBAJIPEAG@Z.c)
 *     ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x1C015B7B8 (-TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ.c)
 */
