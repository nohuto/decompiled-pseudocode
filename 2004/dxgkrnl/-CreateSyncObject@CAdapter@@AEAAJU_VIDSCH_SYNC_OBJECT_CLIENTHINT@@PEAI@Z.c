/*
 * XREFs of ?CreateSyncObject@CAdapter@@AEAAJU_VIDSCH_SYNC_OBJECT_CLIENTHINT@@PEAI@Z @ 0x1C0063CF0
 * Callers:
 ...
 *     DxgkCreateSynchronizationObjectInternal @ 0x1C0292FB4 (DxgkCreateSynchronizationObjectInternal.c)
 */
