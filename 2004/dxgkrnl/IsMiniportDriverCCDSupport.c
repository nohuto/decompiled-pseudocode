/*
 * XREFs of IsMiniportDriverCCDSupport @ 0x1C01462A0
 * Callers:
 *     DxgkConvertDisplayConfigCScalingToDdiScaling @ 0x1C0146210 (DxgkConvertDisplayConfigCScalingToDdiScaling.c)
 * Callees:
