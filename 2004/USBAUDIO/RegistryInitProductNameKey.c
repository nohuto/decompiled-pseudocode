/*
 * XREFs of RegistryInitProductNameKey @ 0x1C002AB30
 * Callers:
 *     FilterInitComponentId @ 0x1C002391C (FilterInitComponentId.c)
 * Callees:
 *     RegistryCreateMediaCategoriesKey @ 0x1C002AA24 (RegistryCreateMediaCategoriesKey.c)
 */
