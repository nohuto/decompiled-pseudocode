/*
 * XREFs of USBHwGetSetProperty @ 0x1C002C6B8
 * Callers:
 *     USBHwGetSetByte @ 0x1C002C810 (USBHwGetSetByte.c)
 *     USBHwGetSetShort @ 0x1C002C8C0 (USBHwGetSetShort.c)
 *     USBHwGetSetMemory @ 0x1C002C980 (USBHwGetSetMemory.c)
 *     USBCntrlGetSetGEQ @ 0x1C0031730 (USBCntrlGetSetGEQ.c)
 *     USBCntrlGetSetProcessingUnitValue @ 0x1C00318F0 (USBCntrlGetSetProcessingUnitValue.c)
 *     USBCntrlMuxSource @ 0x1C00319A0 (USBCntrlMuxSource.c)
 *     USBCntrlGetSetMixerLevels @ 0x1C0031A50 (USBCntrlGetSetMixerLevels.c)
