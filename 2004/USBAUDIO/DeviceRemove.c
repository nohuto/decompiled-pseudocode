/*
 * XREFs of DeviceRemove @ 0x1C0002CA0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_q @ 0x1C00011B4 (WPP_RECORDER_SF_q.c)
 *     McGenEventUnregister_EtwUnregister @ 0x1C0001A70 (McGenEventUnregister_EtwUnregister.c)
 *     _guard_dispatch_icall_nop @ 0x1C0013270 (_guard_dispatch_icall_nop.c)
 *     WmiUnregisterProvider @ 0x1C002B49C (WmiUnregisterProvider.c)
 */
