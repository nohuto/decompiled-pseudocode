/*
 * XREFs of PropertyAudioSignalProcessingBasicSupport @ 0x1C00280C0
 * Callers:
 *     <none>
 * Callees:
 *     PropertyAudioSignalProcessingPinValidation @ 0x1C0028010 (PropertyAudioSignalProcessingPinValidation.c)
 */
