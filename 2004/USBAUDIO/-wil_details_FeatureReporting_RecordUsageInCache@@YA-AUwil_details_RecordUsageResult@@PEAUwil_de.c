/*
 * XREFs of ?wil_details_FeatureReporting_RecordUsageInCache@@YA?AUwil_details_RecordUsageResult@@PEAUwil_details_FeatureReportingCache@@W4wil_details_ServiceReportingKind@@II@Z @ 0x1C0001BE8
 * Callers:
...
LABEL_8:
    ...
    v7 = v6 | 1;
    _m_prefetchw(&Feature_Servicing_2101c_29879707__private_reporting);
    v8 = _InterlockedOr(&Feature_Servicing_2101c_29879707__private_reporting, v7);
    *(_DWORD *)a1 = (v8 & 1) == 0;
  ...
  {
LABEL_38:
    v13 = Feature_Servicing_2101c_29879707__private_reporting;
    v21 = a3 == 4;
    while ( 1 )
    {
      *(_DWORD *)(a1 + 4) = 0;
...
LABEL_17:
  ...
  if ( v9 < 0x40 )
  {
    ...
    do
    {
      ...
      *(_DWORD *)(a1 + 16) = v11;
      v12 = v10;
      v10 = _InterlockedCompareExchange(&dword_1C001CD04, (32 * (v9 & 0x3F)) | v10 & 0xFFFFF81F | 0x10, v10);
    }
    while ( v12 != v10 );
  }
  *(_DWORD *)(a1 + 8) = a3;
