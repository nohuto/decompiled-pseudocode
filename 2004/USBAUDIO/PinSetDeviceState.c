/*
 * XREFs of PinSetDeviceState @ 0x1C0024950
 * Callers:
 ...
 *     WmiLogStreamStateChange @ 0x1C00035B4 (WmiLogStreamStateChange.c)
 ...
 *     DecrementActivePinCount @ 0x1C00248C8 (DecrementActivePinCount.c)
 */
