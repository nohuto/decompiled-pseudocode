 ...
 * Callers:
 *     PropertyGetBoolean @ 0x1C00289E0 (PropertyGetBoolean.c)
 *     PropertyGetDbLevel @ 0x1C0029090 (PropertyGetDbLevel.c)
 * Callees:
...
__int64 WPP_RECORDER_SF__guid_d(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, __int64 a6, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x200) != 0 )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, _QWORD, __int64, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_358075431bf43b153029af410f10e6dc_Traceguids,
      a4,
      a6,
      16LL,
      va,
      ...
      0LL);
  LOWORD(v9) = a4;
  return WppAutoLogTrace(a1, 0LL, 10LL, &WPP_358075431bf43b153029af410f10e6dc_Traceguids, v9, a6);
}
