/*
 * XREFs of DeviceCreate @ 0x1C0002950
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_q @ 0x1C00011B4 (WPP_RECORDER_SF_q.c)
 *     WPP_RECORDER_SF_qd @ 0x1C0001404 (WPP_RECORDER_SF_qd.c)
 *     McGenEventRegister_EtwRegister @ 0x1C0001A3C (McGenEventRegister_EtwRegister.c)
 *     InitializeSidebandContext @ 0x1C00085B4 (InitializeSidebandContext.c)
 *     _guard_dispatch_icall_nop @ 0x1C0013270 (_guard_dispatch_icall_nop.c)
 *     memset @ 0x1C0014140 (memset.c)
 *     WmiRegisterProvider @ 0x1C002B428 (WmiRegisterProvider.c)
 */
