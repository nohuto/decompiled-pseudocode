/*
 * XREFs of USBCaptureSubmitRequest @ 0x1C00329F8
 * Callers:
 *     USBCaptureRequeueWorker @ 0x1C0006A80 (USBCaptureRequeueWorker.c)
 *     USBCaptureStartTransfers @ 0x1C0032B54 (USBCaptureStartTransfers.c)
 * Callees:
