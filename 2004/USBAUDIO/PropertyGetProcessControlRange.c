/*
 * XREFs of PropertyGetProcessControlRange @ 0x1C002A3EC
 * Callers:
 *     TopologyPU3DExtender @ 0x1C0026A20 (TopologyPU3DExtender.c)
 *     TopologyPUChorus @ 0x1C0026B10 (TopologyPUChorus.c)
 *     TopologyPUReverb @ 0x1C0026C80 (TopologyPUReverb.c)
 *     TopologyPUDynRangeCompressor @ 0x1C0026E20 (TopologyPUDynRangeCompressor.c)
 * Callees:
