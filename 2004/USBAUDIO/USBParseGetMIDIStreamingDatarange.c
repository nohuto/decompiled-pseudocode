/*
 * XREFs of USBParseGetMIDIStreamingDatarange @ 0x1C0030D90
 * Callers:
        ...
        _QWORD *PoolWithTag)
{
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v20 )
    {
      ...
      *((_OWORD *)v11 + 1) = xmmword_1C0017270;
      *((_DWORD *)v11 + 24) = ((v26 >> 31) & 8) + 8;
      *((_OWORD *)v11 + 2) = xmmword_1C0017280;
      *((_OWORD *)v11 + 3) = xmmword_1C0017290;
      *((_OWORD *)v11 + 4) = xmmword_1C00172A0;
      *((_OWORD *)v11 + 5) = xmmword_1C00172B0;
      *a5 = v11;
      v27 = 88;
