/*
 * XREFs of ?_AddProjectionBorderForDisplay@CProjectionBorderManager@@AEAAJPEAUHMONITOR__@@AEBUDWM_CAPTURE_TOKEN@@@Z @ 0x1800917B4
 * Callers:
...
LABEL_22:
    ...
    if ( v15 > Element[11] )
    {
      v17 = DynArrayImpl<0>::AddMultipleAndSet((__int64)(Element + 6), 8u, 1, &v18);
      v7 = v17;
      if ( v17 < 0 )
      {
