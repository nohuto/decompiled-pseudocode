/*
 * XREFs of ?InvalidateBitmaps@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@K@Z @ 0x18000702C
 * Callers:
...
LABEL_10:
        v10 = v9;
LABEL_17:
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBEA0, 1LL, v10, v11);
        return v6;
      }
    }
    else
