/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_TabThumbnailsRefreshedOnDemand@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180055520
 * Callers:
 ...
 *     ?__private_IsEnabled@?$FeatureImpl@U__WilFeatureTraits_Feature_TabThumbnailsRefreshedOnDemand@@@details@wil@@QEAA_NXZ @ 0x180055864 (-__private_IsEnabled@-$FeatureImpl@U__WilFeatureTraits_Feature_TabThumbnailsRefreshedOnDemand@@@.c)
 * Callees:
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    if ( !v11 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_1800E505C
        || (v13 = 0, v14 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_1800E5090, &v13, 0x10uLL)) )
      {
