/*
 * XREFs of ?Initialize@CDesktopManager@@AEAAJPEBUStartupInfo@@PEAUCompositionInfo@@@Z @ 0x18004AC50
 * Callers:
 ...
 *     ??0CWindowList@@QEAA@XZ @ 0x180049C8C (--0CWindowList@@QEAA@XZ.c)
 *     ??0CContactManager@@QEAA@XZ @ 0x180049E08 (--0CContactManager@@QEAA@XZ.c)
 *     ??0CTransitionVisualController@@QEAA@XZ @ 0x180049F0C (--0CTransitionVisualController@@QEAA@XZ.c)
 *     ??0CAnimationClockCoordinator@@QEAA@XZ @ 0x180049F98 (--0CAnimationClockCoordinator@@QEAA@XZ.c)
 ...
 *     ?SetWindowAnimation@CDesktopManager@@SAX_N@Z @ 0x18004A048 (-SetWindowAnimation@CDesktopManager@@SAX_N@Z.c)
 ...
 *     ??0CProjectionBorderManager@@QEAA@XZ @ 0x18004A70C (--0CProjectionBorderManager@@QEAA@XZ.c)
 ...
 *     ?_InitializeWnf@CDesktopManager@@AEAAJXZ @ 0x18004AAC8 (-_InitializeWnf@CDesktopManager@@AEAAJXZ.c)
 *     ?ReadProductType@CDesktopManager@@AEAAXXZ @ 0x18004ABE4 (-ReadProductType@CDesktopManager@@AEAAXXZ.c)
 *     ?reset@?$unique_storage@U?$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1?RegCloseKey@@YAJ0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUHKEY__@@@Z @ 0x18004BD3C (-reset@-$unique_storage@U-$resource_policy@PEAUHKEY__@@P6AJPEAU1@@Z$1-RegCloseKey@@YAJ0@ZU-$inte.c)
        ...
        struct CompositionInfo *a3)
{
  ...
  HKEY v47; // [rsp+40h] [rbp-18h] BYREF
  char v48; // [rsp+48h] [rbp-10h]
  ...
  *((_QWORD *)this + 6) = *(_QWORD *)a3;
  ...
  v6 = 0;
  v48 = 1;
  v7 = RegOpenKeyExW(HKEY_LOCAL_MACHINE, L"Software\\Microsoft\\Windows\\Dwm", 0, 0x20019u, &v47) == 0;
  if ( v48 )
...
LABEL_70:
    v22 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBE88, 1LL, -2147024882, phkResult);
    goto LABEL_62;
  }
...
LABEL_82:
    v37 = updated;
LABEL_116:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBE88, 1LL, v37, phkResulta);
    goto LABEL_59;
  }
  pvParam[0] = 8;
...
LABEL_88:
    v22 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBE88, 1LL, -2147024882, phkResultb);
LABEL_118:
  ...
  *((_QWORD *)this + 65) = v30;
  ...
  v31 = (struct CVisual **)*((_QWORD *)this + 61);
  ...
  {
    RootVisual = CWindowList::RegisterTransparencySystemPolicyChangeEvent((CWindowList *)v31, v33, v34);
    v22 = RootVisual;
    if ( RootVisual >= 0 )
    {
      v22 = 0;
...
LABEL_115:
  ...
  *((_QWORD *)this + 83) = Thread;
  if ( !Thread )
  {
    ...
    v22 = v41;
    if ( v41 > 0 )
      v22 = (unsigned __int16)v41 | 0x80070000;
    phkResulta = 460;
    goto LABEL_113;
  }
  SetThreadDescription(Thread, L"uDWM Event Thread");
  v47 = (HKEY)*((_QWORD *)this + 83);
  Handles = EventW;
  SetLastError(0);
