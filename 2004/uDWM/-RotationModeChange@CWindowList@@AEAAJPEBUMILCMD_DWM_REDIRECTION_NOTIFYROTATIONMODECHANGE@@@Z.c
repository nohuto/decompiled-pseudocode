  ...
  if ( *((_DWORD *)a2 + 1) )
  {
    if ( v5 || (v6 = CScreenRotation::Create((struct CScreenRotation **)this + 62), v4 = v6, v6 >= 0) )
    {
      ...
      if ( v8 >= 0 )
      {
        ...
        v4 = v9;
        if ( v9 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x19A8u);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x19A6u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x199Du);
    }
  }
