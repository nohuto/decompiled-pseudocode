    ...
    if ( v7 >= 0 )
    {
      ...
      *((float *)v8 + 93) = GammaLUT_sRGB_to_scRGB[BYTE2(a2)] / 255.0;
      ...
      if ( v9 >= 0 )
      {
        ...
        v6 = v10;
        if ( v10 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x7DCu);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x7D8u);
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x7D5u);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x7D0u);
  }
