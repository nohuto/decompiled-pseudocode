/*
 * XREFs of ?get@?$static_lazy@VWindowFrameLogging@@@details@wil@@QEAAPEAVWindowFrameLogging@@P6AXXZ@Z @ 0x18002E3D8
 * Callers:
 ...
 *     ??$UpdateCaptureControllerTransformFromDisplay@NN@WindowFrameLoggingTelemetry@@SAX$$QEAN0@Z @ 0x18008D630 (--$UpdateCaptureControllerTransformFromDisplay@NN@WindowFrameLoggingTelemetry@@SAX$$QEAN0@Z.c)
...
_QWORD *__fastcall wil::details::static_lazy<WindowFrameLogging>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  v5 = a1;
  v6 = 0LL;
  if ( InitOnceBeginInitialize(&`WindowFrameLogging::Instance'::`2'::wrapper, 0, (PBOOL)&v5, (LPVOID *)&v6)
    && (_DWORD)v5 )
  {
    v6 = qword_1800E5258;
    qword_1800E5258[0] = &WindowFrameLogging::`vftable';
    qword_1800E5270 = (struct _tlgProvider_t *)&`WindowFrameLogging::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_1800E5258, qword_1800E5270, v4);
    InitOnceComplete(&`WindowFrameLogging::Instance'::`2'::wrapper, 0, qword_1800E5258);
  }
  return v6;
}
