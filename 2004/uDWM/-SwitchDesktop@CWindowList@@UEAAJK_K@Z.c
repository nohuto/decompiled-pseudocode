/*
 * XREFs of ?SwitchDesktop@CWindowList@@UEAAJK_K@Z @ 0x180037E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::SwitchDesktop(CWindowList *this, int a2, unsigned __int64 a3)
{
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x1942u);
    goto LABEL_7;
  }
...
LABEL_7:
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x1958u);
    goto LABEL_7;
  }
  ...
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x195Cu);
    goto LABEL_7;
  }
  if ( *((_QWORD *)this + 65) )
    goto LABEL_18;
...
LABEL_18:
    ...
    v9 = started;
    if ( started < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, started, 0x1965u);
    else
      v6 = 0;
    goto LABEL_7;
  }
  v9 = -2147024882;
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x1961u);
LABEL_31:
