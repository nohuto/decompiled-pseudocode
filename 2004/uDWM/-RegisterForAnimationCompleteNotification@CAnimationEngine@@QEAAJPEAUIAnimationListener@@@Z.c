/*
 * XREFs of ?RegisterForAnimationCompleteNotification@CAnimationEngine@@QEAAJPEAUIAnimationListener@@@Z @ 0x180038AFC
 * Callers:
...
LABEL_9:
      ...
      if ( (int)v4 < 0 )
      {
        ...
        else
        {
          ...
          {
            v12 = DynArrayImpl<0>::AddMultipleAndSet(v7, 8LL, 1LL, &v14);
            v11 = v12;
            if ( v12 < 0 )
