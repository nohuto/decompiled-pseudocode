/*
 * XREFs of ?CloneVisualTree@CClientArea@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x18000BB60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CClientArea::CloneVisualTree(__int64 a1, CVisualProxy **a2, unsigned int a3)
{
  float v6; // xmm1_4
  int v7; // eax
  unsigned int v8; // esi
  ...
  int v11; // eax
  int v12; // eax
  CVisualProxy *v13; // rbx
  int v14; // eax
  CVisualProxy *v15; // rbx
  CBaseObject *v17; // rcx
  int v18; // eax
  CVisualProxy *v19; // rbx
  __int64 v20; // rax
  __int64 v21; // r8
  __int64 v22; // rdx
  __int64 v23; // rdx
  ...
  __int64 v26; // rdx
  __int64 v27; // rdx
  CVisualProxy *v28; // [rsp+40h] [rbp-39h] BYREF
  ...
  *a2 = 0LL;
  ...
  if ( (a3 & 4) != 0 )
  {
    ...
    *(float *)&v34[3] = (float)v33.bottom;
    ...
    {
      v9 = v31;
      v7 = CCachedVisualImageProxy::Update(v31, v34, &v35, 0LL, 0LL);
      v8 = v7;
      if ( v7 < 0 )
      {
        v22 = 108LL;
...
LABEL_12:
  ...
  {
    v14 = CVisual::InitializeVisualTreeClone(a1, v28, a3);
    v8 = v14;
    if ( v14 >= 0 )
    {
      v8 = 0;
