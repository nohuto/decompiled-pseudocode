/*
 * XREFs of ?InitializeVisualTreeClone@CTopLevelWindow@@IEAAJPEAV1@W4CloneOptions@@@Z @ 0x180014780
 * Callers:
 ...
 *     ?SetShadowOpacity@CTopLevelWindow@@QEAAXM@Z @ 0x1800402B8 (-SetShadowOpacity@CTopLevelWindow@@QEAAXM@Z.c)
...
__int64 __fastcall CTopLevelWindow::InitializeVisualTreeClone(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_BYTE *)(a1 + 240) |= 8 * (a3 & 2);
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v5, 0x13B2u);
    goto LABEL_45;
  }
  v7 = *(_BYTE *)(a1 + 241);
  if ( (v7 & 4) != 0 )
  {
    ...
    if ( v38 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v38, 0x13B7u);
      goto LABEL_45;
    }
    v7 = *(_BYTE *)(a1 + 241);
  }
  ...
  else
  {
    ...
    if ( v11 )
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x13CCu);
        goto LABEL_45;
      }
    }
