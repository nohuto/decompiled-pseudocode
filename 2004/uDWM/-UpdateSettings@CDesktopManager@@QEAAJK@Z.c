/*
 * XREFs of ?UpdateSettings@CDesktopManager@@QEAAJK@Z @ 0x180030C50
 * Callers:
 ...
 *     ?RecreateDesktopWindowReplacementForDesktops@CWindowList@@QEAAXXZ @ 0x180030490 (-RecreateDesktopWindowReplacementForDesktops@CWindowList@@QEAAXXZ.c)
 ...
 *     ?UpdateWindowShadows@CDesktopManager@@QEAAXXZ @ 0x180049BAC (-UpdateWindowShadows@CDesktopManager@@QEAAXXZ.c)
  ...
  if ( (v6 & 1) != 0 )
  {
    ...
    *((_DWORD *)this + 114) = GetSystemMetrics(79);
    ...
    else
    {
      ...
      dword_1800E4EA0 = GetSystemMetrics(6);
      dword_1800E4E9C = CTopLevelWindow::s_marMinInflationThickness.cxLeftWidth;
      dword_1800E4EA4 = dword_1800E4EA0;
    }
    if ( Theme < 0 )
    {
