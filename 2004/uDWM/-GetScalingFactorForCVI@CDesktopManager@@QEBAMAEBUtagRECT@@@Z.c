/*
 * XREFs of ?GetScalingFactorForCVI@CDesktopManager@@QEBAMAEBUtagRECT@@@Z @ 0x18000CF2C
 * Callers:
 ...
 *     ?_IsSameAsTargetCachedCVI@CDesktopManager@@CA_NHH@Z @ 0x18000BAA4 (-_IsSameAsTargetCachedCVI@CDesktopManager@@CA_NHH@Z.c)
