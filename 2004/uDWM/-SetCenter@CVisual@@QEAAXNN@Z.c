/*
 * XREFs of ?SetCenter@CVisual@@QEAAXNN@Z @ 0x180095878
 * Callers:
...
void __fastcall CVisual::SetCenter(CVisual *this, double a2, double a3)
{
  ...
  v3 = a2;
  if ( COERCE_FLOAT(COERCE_UNSIGNED_INT((float)*((double *)this + 18) - v3) & _xmm) > 0.0000011920929
    || (v4 = a3, COERCE_FLOAT(COERCE_UNSIGNED_INT((float)*((double *)this + 19) - v4) & _xmm) > 0.0000011920929) )
  {
    v5 = *(double *)this;
    *((double *)this + 18) = a2;
    *((double *)this + 19) = a3;
