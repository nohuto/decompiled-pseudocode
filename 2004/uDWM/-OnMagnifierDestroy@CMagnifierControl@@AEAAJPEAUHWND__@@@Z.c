/*
 * XREFs of ?OnMagnifierDestroy@CMagnifierControl@@AEAAJPEAUHWND__@@@Z @ 0x18008CBC4
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierDestroy(CMagnifierControl *this, __int64 a2)
{
  ...
  if ( dword_1800E8014 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E8014);
    if ( dword_1800E8014 == -1 )
    {
      dword_1800E7F40 = -2147023728;
      Init_thread_footer(&dword_1800E8014);
    }
  }
  ...
  {
    v2 = -2147023728;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F40, 1LL, -2147023728, 0x2A3u);
  }
  return v2;
}
