/*
 * XREFs of ?_UpdateHandleInstructions@CTextTetherVisual@@AEAAJXZ @ 0x1800A294C
 * Callers:
 ...
 *     ?GetBoundedContactWidth@CContactManager@@QEAAHHUtagPOINT@@@Z @ 0x180046008 (-GetBoundedContactWidth@CContactManager@@QEAAHHUtagPOINT@@@Z.c)
