/*
 * XREFs of ?IsWindowSetToDefaultMargins@@YA_NPEBVCWindowData@@@Z @ 0x180010448
 * Callers:
 ...
 *     ?GetDefaultWindowMarginsForWindowStyle@@YA?AU_MARGINS@@KKKN@Z @ 0x180010588 (-GetDefaultWindowMarginsForWindowStyle@@YA-AU_MARGINS@@KKKN@Z.c)
