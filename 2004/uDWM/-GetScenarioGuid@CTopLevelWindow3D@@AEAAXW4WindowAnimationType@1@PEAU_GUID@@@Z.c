/*
 * XREFs of ?GetScenarioGuid@CTopLevelWindow3D@@AEAAXW4WindowAnimationType@1@PEAU_GUID@@@Z @ 0x18003FCC4
 * Callers:
    ...
    if ( v4 )
    {
      ...
      if ( v5 )
      {
        ...
        if ( v6 )
        {
          ...
          {
            if ( v7 == 1 )
              v8 = (GUID)xmmword_1800CCD88;
            else
              v8 = GUID_NULL;
          }
          else
          {
            v8 = (GUID)xmmword_1800CCD78;
          }
        }
        else
        {
          v8 = (GUID)xmmword_1800CD1C8;
        }
      }
      else
      {
        v8 = (GUID)xmmword_1800CCD68;
      }
    }
    else
    {
      v8 = (GUID)xmmword_1800CD1D8;
    }
  }
  else
  {
    v8 = (GUID)xmmword_1800CCD58;
  }
  *a3 = v8;
}
