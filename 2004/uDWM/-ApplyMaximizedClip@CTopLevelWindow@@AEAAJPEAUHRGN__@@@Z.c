/*
 * XREFs of ?ApplyMaximizedClip@CTopLevelWindow@@AEAAJPEAUHRGN__@@@Z @ 0x18001CD90
 * Callers:
  ...
  if ( (*((_BYTE *)this + 240) & 4) != 0 )
  {
    ...
    if ( v8 )
    {
      ...
      if ( !CombineRgn(a2, a2, v8, 1) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBF08, 11LL, v2, 0x11EEu);
      }
      DeleteObject(v8);
    }
    else
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBF08, 11LL, v2, 0x11ECu);
    }
  }
