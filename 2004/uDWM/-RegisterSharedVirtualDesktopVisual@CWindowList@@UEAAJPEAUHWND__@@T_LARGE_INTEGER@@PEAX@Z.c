/*
 * XREFs of ?RegisterSharedVirtualDesktopVisual@CWindowList@@UEAAJPEAUHWND__@@T_LARGE_INTEGER@@PEAX@Z @ 0x180098EF0
 * Callers:
 ...
 *     ??0CDCompVirtualDesktopThumbnailData@@QEAA@XZ @ 0x180095D90 (--0CDCompVirtualDesktopThumbnailData@@QEAA@XZ.c)
 */
        ...
        void *a4)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowDataByHwnd, 0xF84u);
    goto LABEL_28;
  }
  v11 = v24;
  if ( !v24 )
  ...
  {
    v10 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0xF8Fu);
    goto LABEL_28;
  }
  ...
  *((_DWORD *)v13 + 28) = 2;
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0xF9Bu);
    v8 = v23;
    goto LABEL_28;
  }
  v8 = v23;
...
LABEL_21:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0xFA1u);
    goto LABEL_28;
  }
  ...
  if ( v18 + 1 < v18 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0xB5u);
LABEL_27:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0xFA7u);
    goto LABEL_28;
  }
