/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCVisualProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCVisualProxy@@@Z @ 0x180016324
 * Callers:
        ...
        volatile signed __int32 **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 )
  {
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle(v7, 38LL, *(_QWORD *)(a1 + 16), a2);
    v9 = v8;
    if ( v8 < 0 )
