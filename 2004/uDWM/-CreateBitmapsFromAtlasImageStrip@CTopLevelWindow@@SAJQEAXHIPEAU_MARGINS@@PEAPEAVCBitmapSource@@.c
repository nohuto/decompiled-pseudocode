/*
 * XREFs of ?CreateBitmapsFromAtlasImageStrip@CTopLevelWindow@@SAJQEAXHIPEAU_MARGINS@@PEAPEAVCBitmapSource@@@Z @ 0x1800496E0
 * Callers:
        ...
        struct CBitmapSource **a5)
{
  ...
  if ( dword_1800E7DB0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E7DB0);
    if ( dword_1800E7DB0 == -1 )
    {
      dword_1800E50FC = -2147023728;
      Init_thread_footer(&dword_1800E7DB0);
    }
  }
...
LABEL_28:
  ...
  pRect = 852;
LABEL_31:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E50FC, 1LL, v24, pRect);
  return v11;
}
