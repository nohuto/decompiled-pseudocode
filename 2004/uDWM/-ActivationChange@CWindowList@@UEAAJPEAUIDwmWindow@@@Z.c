/*
 * XREFs of ?ActivationChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x1800120C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ActivationChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x1311u);
  }
  else
  {
    v6 = v10;
    if ( v10 )
    {
      ...
      *((_BYTE *)v6 + 608) |= 2 * (v7 & 1);
      ...
      v5 = v8;
      if ( v8 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x1316u);
    }
  }
