        ...
        struct _LUID a5)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x154Du);
    goto LABEL_8;
  }
  if ( !v15 || (v11 = (CTopLevelWindow *)*((_QWORD *)v15 + 48)) == 0LL )
  {
    v10 = -2147467261;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147467261, 0x1550u);
LABEL_8:
    if ( hObject )
      CloseHandle(hObject);
    goto LABEL_10;
  ...
  v10 = v12;
  if ( v12 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x1557u);
LABEL_10:
