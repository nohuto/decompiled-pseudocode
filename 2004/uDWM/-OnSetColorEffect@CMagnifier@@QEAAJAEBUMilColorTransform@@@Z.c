/*
 * XREFs of ?OnSetColorEffect@CMagnifier@@QEAAJAEBUMilColorTransform@@@Z @ 0x18008B954
 * Callers:
...
__int64 __fastcall CMagnifier::OnSetColorEffect(CMagnifier *this, const struct MilColorTransform *a2)
{
  ...
  if ( !memcmp_0(&g_MilColorTransfIdentity, a2, 0x64uLL) )
  {
    ...
    *(_OWORD *)((char *)this + 84) = xmmword_1800D3090;
    *(_OWORD *)((char *)this + 100) = xmmword_1800D30A0;
    *(_OWORD *)((char *)this + 116) = xmmword_1800D30B0;
    *(_OWORD *)((char *)this + 132) = xmmword_1800D30C0;
    *(_OWORD *)((char *)this + 148) = xmmword_1800D30D0;
    v6 = 1065353216;
    goto LABEL_16;
  }
