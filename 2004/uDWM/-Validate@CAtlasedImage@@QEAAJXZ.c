/*
 * XREFs of ?Validate@CAtlasedImage@@QEAAJXZ @ 0x18001E860
 * Callers:
...
__int64 __fastcall CAtlasedImage::Validate(CAtlasedImage *this)
{
  ...
  *(_OWORD *)v13 = 0LL;
  ...
  v2 = DynArrayImpl<0>::Grow((char **)&v10, 0x10u, v20, 0, 0LL);
  if ( v2 < 0 )
  {
...
LABEL_27:
  ...
  v2 = DynArrayImpl<0>::Grow((char **)v13, 0x10u, v20, 0, 0LL);
  if ( v2 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v2, 0x191u);
    goto LABEL_27;
  }
  v2 = DynArrayImpl<0>::Grow((char **)&v16, 4u, v20, 0, 0LL);
  if ( v2 < 0 )
  {
