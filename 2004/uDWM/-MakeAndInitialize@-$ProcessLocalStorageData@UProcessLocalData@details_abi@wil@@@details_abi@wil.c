/*
 * XREFs of ?MakeAndInitialize@?$ProcessLocalStorageData@UProcessLocalData@details_abi@wil@@@details_abi@wil@@CAJPEBG$$QEAV?$unique_any_t@V?$mutex_t@V?$unique_storage@U?$resource_policy@PEAXP6AXPEAX@Z$1?CloseHandle@details@wil@@YAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@Uerr_returncode_policy@3@@wil@@@3@PEAPEAV123@@Z @ 0x18007E414
 * Callers:
 ...
 *     ?_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ @ 0x18007FA04 (-_FailFastImmediate_Unexpected@in1diag3@details@wil@@YAXXZ.c)
 */
  ...
  *a3 = 0LL;
  ...
  if ( v6 )
  {
    *(_OWORD *)v18 = 0LL;
    ...
    v11 = wil::details_abi::SemaphoreValue::CreateFromValueInternal((wil::details **)v18, a1, v8, v6 >> 2);
    v10 = v11;
    if ( v11 >= 0 )
    {
      *(_DWORD *)v9 = 1;
