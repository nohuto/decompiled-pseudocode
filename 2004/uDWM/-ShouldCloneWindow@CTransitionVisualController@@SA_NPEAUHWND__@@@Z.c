/*
 * XREFs of ?ShouldCloneWindow@CTransitionVisualController@@SA_NPEAUHWND__@@@Z @ 0x18002C0C4
 * Callers:
    ...
    do
    {
      ...
      if ( CAnimationScheduler::IsWindowCurrentlyAnimating(
             *((CAnimationScheduler **)v3 + 30),
             0LL,
             *((_DWORD *)&off_1800C6350 + 4 * v5 + 2),
             0) )
      {
        v12 = ClassName;
        v13 = (char *)(&off_1800C6350)[2 * v5] - (char *)ClassName;
        while ( 1 )
        {
          v14 = *v12;
