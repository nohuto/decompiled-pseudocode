/*
 * XREFs of ?CloneVisualTree@CCanvasVisual@@UEAAJPEAPEAVCVisual@@W4CloneOptions@@@Z @ 0x1800159E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCanvasVisual::CloneVisualTree(__int64 a1, CBaseObject **a2, unsigned int a3)
{
  ...
  struct CCanvasVisual *v13; // [rsp+48h] [rbp+10h] BYREF

  v13 = 0LL;
  *a2 = 0LL;
  v6 = CCanvasVisual::Create(&v13);
  v7 = v13;
  v8 = v6;
  if ( v6 < 0 )
  {
  ...
  wil::details::in1diag3::Return_Hr(
    retaddr,
    (void *)v11,
    (__int64)"clientcore\\windows\\dwm\\udwm\\canvasvisual.cpp",
