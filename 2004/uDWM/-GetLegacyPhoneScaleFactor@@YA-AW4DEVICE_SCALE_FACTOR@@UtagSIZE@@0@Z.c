/*
 * XREFs of ?GetLegacyPhoneScaleFactor@@YA?AW4DEVICE_SCALE_FACTOR@@UtagSIZE@@0@Z @ 0x1800C1398
 * Callers:
 ...
 * Callees:
 *     ?LoadScalingOverrides@@YAXXZ @ 0x1800401B4 (-LoadScalingOverrides@@YAXXZ.c)
 ...
 *     ?CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z @ 0x1800C122C (-CalcBucketedScaleFactor@@YAIUtagSIZE@@0@Z.c)
 */
