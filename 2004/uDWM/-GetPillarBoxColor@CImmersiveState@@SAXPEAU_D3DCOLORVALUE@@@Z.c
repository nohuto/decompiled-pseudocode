/*
 * XREFs of ?GetPillarBoxColor@CImmersiveState@@SAXPEAU_D3DCOLORVALUE@@@Z @ 0x1800B8FB4
 * Callers:
 ...
 *     GetStaticImmersiveColorPrivForHighContrastState @ 0x1800C16D0 (GetStaticImmersiveColorPrivForHighContrastState.c)
 */
