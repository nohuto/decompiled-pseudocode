/*
 * XREFs of ?CleanupAnimationResources@CWindowIconic@@QEAAXXZ @ 0x180043948
 * Callers:
 ...
 *     ?StopIconicAnimation@CTopLevelWindow@@QEAAXXZ @ 0x180040438 (-StopIconicAnimation@CTopLevelWindow@@QEAAXXZ.c)
 */
