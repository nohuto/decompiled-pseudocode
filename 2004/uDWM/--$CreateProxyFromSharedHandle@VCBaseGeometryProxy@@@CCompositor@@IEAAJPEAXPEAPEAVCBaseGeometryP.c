/*
 * XREFs of ??$CreateProxyFromSharedHandle@VCBaseGeometryProxy@@@CCompositor@@IEAAJPEAXPEAPEAVCBaseGeometryProxy@@@Z @ 0x180013EF8
 * Callers:
        ...
        volatile signed __int32 **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v7 )
  {
    ...
    v8 = CResourceProxy::InitializeFromSharedHandle(v7, 13LL, *(_QWORD *)(a1 + 16), a2);
    v9 = v8;
    if ( v8 < 0 )
    {
