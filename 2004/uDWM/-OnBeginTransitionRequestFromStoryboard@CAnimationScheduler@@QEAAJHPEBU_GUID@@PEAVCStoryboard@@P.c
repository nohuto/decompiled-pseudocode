/*
 * XREFs of ?OnBeginTransitionRequestFromStoryboard@CAnimationScheduler@@QEAAJHPEBU_GUID@@PEAVCStoryboard@@PEAU2@@Z @ 0x180033444
 * Callers:
...
LABEL_41:
      v22 = v12;
LABEL_44:
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D33EC, 1LL, v22, v23);
      goto LABEL_20;
    }
    if ( a3 )
...
LABEL_13:
        ...
        v17 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 16, 8LL, 1LL, &v24);
        v10 = v17;
        if ( v17 < 0 )
