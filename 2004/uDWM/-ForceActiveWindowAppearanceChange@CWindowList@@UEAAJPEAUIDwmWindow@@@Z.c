/*
 * XREFs of ?ForceActiveWindowAppearanceChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180052D50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::ForceActiveWindowAppearanceChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x1493u);
  }
  else
  {
    v6 = v9;
    if ( v9 )
    {
      v7 = (*(__int64 (__fastcall **)(struct IDwmWindow *))(*(_QWORD *)a2 + 272LL))(a2);
      if ( *((_QWORD *)v6 + 48) )
      {
        if ( v7 != ((*((_BYTE *)v6 + 611) & 0x20) != 0) )
        {
          *((_BYTE *)v6 + 611) ^= (*((_BYTE *)v6 + 611) ^ (32 * v7)) & 0x20;
          CVisual::SetDirtyFlags(*((CVisual **)v6 + 48), 1081346);
        }
      }
    }
  }
