/*
 * XREFs of ?_WindowEnumCallback@CVirtualDesktopSwitch@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x1800B5110
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v8 == *(_DWORD *)(a1 + 144) )
    {
      ...
      if ( (unsigned int)(v9 - 75) <= 1 )
      {
        ...
        if ( v8 )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v20, 0x12D9u);
LABEL_17:
          if ( v21 )
            CBaseObject::Release(v21);
        }
