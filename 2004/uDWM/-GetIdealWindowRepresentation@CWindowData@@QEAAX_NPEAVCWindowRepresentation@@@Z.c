/*
 * XREFs of ?GetIdealWindowRepresentation@CWindowData@@QEAAX_NPEAVCWindowRepresentation@@@Z @ 0x180027D68
 * Callers:
...
void __fastcall CWindowData::GetIdealWindowRepresentation(CWindowData *this, char a2, struct CWindowRepresentation *a3)
{
  ...
  *(_QWORD *)a3 = this;
  ...
  if ( !v3 )
  {
    v7 = *((_QWORD *)this + 52) ? 2 : CWindowData::HasNonTrivialRepresentation(this) != 0;
    *((_DWORD *)a3 + 2) = v7;
