/*
 * XREFs of ?Create@CTransitionWindowSnapshot@@SAJPEAVCTopLevelWindow@@PEAVCVisual@@PEBUtagRECT@@PEAPEAV1@@Z @ 0x180001744
 * Callers:
        ...
        struct CTransitionWindowSnapshot **a4)
{
  ...
  if ( dword_1800E7B80 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E7B80);
    if ( dword_1800E7B80 == -1 )
    {
      dword_1800E4F08 = -2147023434;
      Init_thread_footer(&dword_1800E7B80);
    }
  }
  *a4 = 0LL;
  ...
  if ( v9 )
  {
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E4F08, 1u, v11, 0x30u, v14);
    }
    else
    {
  ...
  {
    v12 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E4F08, 1u, -2147024882, 0x22u, v14);
  }
  return v12;
}
