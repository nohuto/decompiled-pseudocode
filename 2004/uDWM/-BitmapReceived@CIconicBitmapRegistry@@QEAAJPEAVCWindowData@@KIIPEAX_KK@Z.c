/*
 * XREFs of ?BitmapReceived@CIconicBitmapRegistry@@QEAAJPEAVCWindowData@@KIIPEAX_KK@Z @ 0x180089458
 * Callers:
        ...
        char a8)
{
  ...
  v11 = 0;
  v30 = 0LL;
  if ( GetWindowThreadProcessId(*((HWND *)a2 + 5), &v31) && a3 == v31 )
  {
    v14 = 1;
  }
  else
    ...
    && v14 )
  {
    if ( !CIconicBitmapRegistry::CanAcceptBitmap(this, a2) )
    {
      if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
        McTemplateU0qp_EtwEventWriteTransfer(v20, (__int64)&UdwmManageIconicThumbnail_Info, 1LL, *((_QWORD *)a2 + 5));
      return v11;
    }
    if ( !IsWindowTab(a2) )
    {
      ...
      {
        if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
          McTemplateU0qp_EtwEventWriteTransfer(v21, (__int64)&UdwmManageIconicThumbnail_Info, 1LL, *((_QWORD *)a2 + 5));
        v11 = -2147467259;
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBEA0, 1LL, -2147467259, 0x2B2u);
        return v11;
      }
      v22 = nNumerator[0];
      v23 = nNumerator[1];
    ...
    if ( v24 >= 0 )
    {
      ...
      *((_BYTE *)a2 + 610) |= 8 * (v26 & 1);
      CIconicBitmapRegistry::AcceptBitmap((CWindowIconic ****)this, a2, v27);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBEA0, 1LL, v24, 0x2C1u);
    }
    if ( v25 )
  ...
  else
  {
    ...
    v11 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBEA0, 1LL, -2147024809, 0x2A0u);
  }
  return v11;
}
