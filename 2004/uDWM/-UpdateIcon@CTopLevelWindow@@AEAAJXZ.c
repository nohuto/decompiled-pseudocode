/*
 * XREFs of ?UpdateIcon@CTopLevelWindow@@AEAAJXZ @ 0x18002B8A4
 * Callers:
...
LABEL_8:
    ...
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x129Fu);
    }
    else if ( v8 != v6 )
    {
  ...
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x129Cu);
  v1 = v11;
LABEL_11:
  if ( v1 )
