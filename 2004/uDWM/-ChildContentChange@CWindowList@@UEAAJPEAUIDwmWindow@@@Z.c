/*
 * XREFs of ?ChildContentChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18003B500
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
  ...
  {
LABEL_16:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x13B6u);
    goto LABEL_7;
  }
  if ( v5 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0x13C0u);
    }
  }
LABEL_7:
