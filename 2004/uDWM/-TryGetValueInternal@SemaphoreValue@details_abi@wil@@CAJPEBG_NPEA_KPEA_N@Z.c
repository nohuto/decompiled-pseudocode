/*
 * XREFs of ?TryGetValueInternal@SemaphoreValue@details_abi@wil@@CAJPEBG_NPEA_KPEA_N@Z @ 0x18003B8B8
 * Callers:
 ...
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x18003C074 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
  ...
  *a3 = 0LL;
  ...
  if ( v15 )
  {
    ...
    if ( v27 )
    {
      ...
      wil::details::in1diag3::Return_Hr(retaddr, (void *)0xD7, (__int64)"wil", (const char *)(unsigned int)v29);
    }
    else
    {
  ...
  if ( GetLastError() != 2 )
    v4 = wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0xC9, (unsigned int)"wil", v32);
LABEL_34:
