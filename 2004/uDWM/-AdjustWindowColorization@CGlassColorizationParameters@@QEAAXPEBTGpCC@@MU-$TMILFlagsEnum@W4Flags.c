/*
 * XREFs of ?AdjustWindowColorization@CGlassColorizationParameters@@QEAAXPEBTGpCC@@MU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@@Z @ 0x180020C30
 * Callers:
    ...
    if ( (a4 & 4) != 0 )
    {
      ...
      else
      {
        if ( v57 == 0.0 )
        {
          ...
          {
            v45 = dword_1800CE8E8[v15];
            if ( v45 != 31 )
              StaticImmersiveColorPrivForHighContrastState = GetSysColor(v45) | 0xFF000000;
          }
          else
          {
            StaticImmersiveColorPrivForHighContrastState = dword_1800CD5B0[v15];
          }
