/*
 * XREFs of __DllMainCRTStartup @ 0x180054598
 * Callers:
 *     _DllMainCRTStartup @ 0x180054554 (_DllMainCRTStartup.c)
 * Callees:
 *     _CRT_INIT @ 0x18005431C (_CRT_INIT.c)
 *     _XcptFilter_0 @ 0x1800547EA (_XcptFilter_0.c)
...
__int64 __fastcall _DllMainCRTStartup(HINSTANCE hinstDLL, __int64 fdwReason, void *a3)
{
  ...
  if ( (_DWORD)fdwReason || dword_1800E4D58 )
  {
