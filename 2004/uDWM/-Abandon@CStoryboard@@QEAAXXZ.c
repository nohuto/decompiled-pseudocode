 ...
 *     ?OnAnimationStart@CAppArrangementDelayed@@EEAAJXZ @ 0x1800AFA10 (-OnAnimationStart@CAppArrangementDelayed@@EEAAJXZ.c)
 ...
 *     ?_NotifyStoryboardState@CStoryboard@@IEAAXW4DWMTRANSITION_STORYBOARD_STATE@@@Z @ 0x1800371E8 (-_NotifyStoryboardState@CStoryboard@@IEAAXW4DWMTRANSITION_STORYBOARD_STATE@@@Z.c)
