/*
 * XREFs of ?OnMagnifierApiMessage@CMagnifierControl@@QEAAJW4DWMCMD@@PEBX_N@Z @ 0x18008C3CC
 * Callers:
...
__int64 __fastcall CMagnifierControl::OnMagnifierApiMessage(unsigned __int64 a1, int a2, __int64 a3, char a4)
{
  ...
  v4 = 0;
  v8 = 0;
  if ( dword_1800E8004 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E8004);
    if ( dword_1800E8004 == -1 )
    {
      dword_1800E7F50 = -2147023728;
      Init_thread_footer(&dword_1800E8004);
    }
  }
  ...
  if ( a2 > 1073741927 )
  {
    ...
    if ( !v35 )
    {
      ...
      if ( v57 >= 0 )
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v57, 0xF1u);
      goto LABEL_74;
    }
    v36 = v35 - 1;
    if ( !v36 )
    {
      ...
      if ( v54 >= 0 )
      {
        ...
        v8 = v55;
        if ( v55 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v55, 0x13Fu);
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v54, 0x13Du);
      }
      goto LABEL_74;
    }
    v37 = v36 - 1;
    if ( !v37 )
    {
      ...
      if ( v51 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v51, 0x147u);
        goto LABEL_74;
      }
      goto LABEL_65;
    }
    ...
    if ( !v38 )
    {
      ...
      if ( v50 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v50, 0x151u);
        goto LABEL_74;
      }
      goto LABEL_65;
    }
    ...
    if ( v39 )
    {
      ...
      if ( v40 )
      {
        ...
        if ( v43 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v43, 0x189u);
          goto LABEL_74;
        }
        goto LABEL_54;
      }
    ...
    else
    {
      ...
      if ( v46 )
      {
        ...
        if ( v49 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v49, 0x16Au);
          goto LABEL_74;
        }
LABEL_54:
  ...
  if ( a2 == 1073741927 )
  {
    ...
    if ( *(_BYTE *)(a1 + 128) )
    {
      ...
      *(double *)(a1 + 152) = *v31;
      ...
      if ( v33 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v33, 0x127u);
        goto LABEL_74;
      }
    }
    else
    {
      ...
      if ( v34 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v34, 0x130u);
        goto LABEL_74;
      }
    }
    goto LABEL_65;
      ...
      if ( v15 )
      {
        ...
        if ( v16 )
        {
          ...
          if ( v17 )
          {
            ...
            if ( v18 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v18, 0xFDu);
              goto LABEL_74;
            }
LABEL_65:
            ...
            v8 = v52;
            if ( v52 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v52, 0x198u);
            goto LABEL_74;
          }
          v20 = *(_QWORD *)(a3 + 8);
          v59 = 0LL;
          ...
          if ( v21 >= 0 )
          {
            ...
            v8 = v22;
            if ( v22 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v22, 0xE7u);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v21, 0xE3u);
          }
        }
        else
        {
          ...
          if ( v24 >= 0 )
          {
            ...
            v8 = v25;
            if ( v25 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v25, 0xD9u);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v24, 0xD5u);
          }
        }
      }
      else
      {
        ...
        if ( v27 >= 0 )
        {
          ...
          v8 = v28;
          if ( v28 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v28, 0xCBu);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v27, 0xC9u);
        }
      }
    }
    else
    {
      *(_BYTE *)(a1 + 128) = 0;
      ...
      v8 = v29;
      if ( v29 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v29, 0xBFu);
    }
  }
  else
  {
    ...
    v8 = v30;
    if ( v30 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E7F50, 1LL, v30, 0xB4u);
  }
LABEL_74:
  if ( v8 != -2147023728 )
    v4 = v8;
