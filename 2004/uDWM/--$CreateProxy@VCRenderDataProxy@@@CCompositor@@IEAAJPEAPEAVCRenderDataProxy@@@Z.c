/*
 * XREFs of ??$CreateProxy@VCRenderDataProxy@@@CCompositor@@IEAAJPEAPEAVCRenderDataProxy@@@Z @ 0x1800186F0
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CRenderDataProxy>(__int64 a1, __int64 *a2)
{
  __int64 v4; // rax
  __int64 v5; // rdi
  __int64 v6; // rbx
  ...
  *(_QWORD *)v7 = &CResource::`vftable';
  v9 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v6 + 96LL))(v6, 29LL, v7 + 24);
  v10 = v9;
  if ( v9 < 0 )
  {
