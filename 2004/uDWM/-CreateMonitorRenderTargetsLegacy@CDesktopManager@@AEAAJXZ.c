/*
 * XREFs of ?CreateMonitorRenderTargetsLegacy@CDesktopManager@@AEAAJXZ @ 0x18002C7B4
 * Callers:
 ...
 *     ?IsTsDisplay@CDWMDisplay@@QEBA_NXZ @ 0x1800421C0 (-IsTsDisplay@CDWMDisplay@@QEBA_NXZ.c)
