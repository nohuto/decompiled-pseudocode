/*
 * XREFs of ?ProcessPenContact@CContactManager@@IEAAJIUtagPOINT@@PEBUtagRECT@@W4DIGITIZER_CONTACT_TYPE@@K_K@Z @ 0x18009FFE8
 * Callers:
 ...
 *     ?LoadPenResources@CContactManager@@AEAAXXZ @ 0x18009E2AC (-LoadPenResources@CContactManager@@AEAAXXZ.c)
 ...
 *     ?PlaceVisuals@CPenBarrelKeyVisual@@IEAAJXZ @ 0x1800A5B3C (-PlaceVisuals@CPenBarrelKeyVisual@@IEAAJXZ.c)
