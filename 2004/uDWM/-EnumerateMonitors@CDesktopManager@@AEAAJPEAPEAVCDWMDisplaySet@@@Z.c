/*
 * XREFs of ?EnumerateMonitors@CDesktopManager@@AEAAJPEAPEAVCDWMDisplaySet@@@Z @ 0x18002CD30
 * Callers:
    ...
    *((_QWORD *)v9 + 1) = *v4;
    ...
    if ( v12 >= 0 )
    {
      ...
      if ( v13 >= 0 )
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBE08, 1LL, v13, 0x78u);
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800CBE08, 1LL, v12, 0x76u);
    }
  }
