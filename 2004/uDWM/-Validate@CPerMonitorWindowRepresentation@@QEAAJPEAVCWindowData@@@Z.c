/*
 * XREFs of ?Validate@CPerMonitorWindowRepresentation@@QEAAJPEAVCWindowData@@@Z @ 0x1800BED4C
 * Callers:
...
__int64 __fastcall CPerMonitorWindowRepresentation::Validate(CPerMonitorWindowRepresentation *this, RECT *a2)
{
  ...
  CBaseObject *v17; // rcx
  int v18; // eax
  struct CBaseGeometryProxy *v19; // r15
  int updated; // eax
  __int64 v21; // rcx
  struct tagPOINT *v22; // rcx
  struct CBaseGeometryProxy *v23; // rbx
  int v24; // eax
  int v25; // eax
  struct CBaseGeometryProxy *v27[2]; // [rsp+30h] [rbp-49h] BYREF
