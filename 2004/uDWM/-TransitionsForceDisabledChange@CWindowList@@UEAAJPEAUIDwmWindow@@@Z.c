/*
 * XREFs of ?TransitionsForceDisabledChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x180099E20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowList::TransitionsForceDisabledChange(CWindowList *this, struct IDwmWindow *a2)
{
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x15CDu);
  }
