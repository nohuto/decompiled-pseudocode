/*
 * XREFs of ?LoadTheme@CDesktopManager@@AEAAJXZ @ 0x1800462C8
 * Callers:
...
__int64 __fastcall CDesktopManager::LoadTheme(CDesktopManager *this)
{
  ...
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McGenEventWrite_EtwEventWriteTransfer(
      ...
      1,
      (__int64)v26);
  if ( dword_1800E7DA0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E7DA0);
    if ( dword_1800E7DA0 == -1 )
    {
      dword_1800E50DC = -2147024864;
      Init_thread_footer(&dword_1800E7DA0);
    }
  }
  SetLastError(0);
...
LABEL_36:
  v19 = v9;
LABEL_40:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E50DC, 1LL, v19, piVal);
LABEL_23:
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McGenEventWrite_EtwEventWriteTransfer(
      (unsigned int)&Microsoft_Windows_Dwm_Udwm_Provider_Context,
  ...
  if ( v9 < 0 )
  {
    ...
    {
      v9 = -2003302654;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E50DC, 1LL, -2003302654, 0x2E2u);
    }
  }
