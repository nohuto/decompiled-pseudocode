/*
 * XREFs of ?_UpdateBorderShadowParts@CAccent@@IEAAJXZ @ 0x180004B08
 * Callers:
 ...
 *     ?_IsShadowPartApplicableFromFlags@CAccent@@IEAA_NH@Z @ 0x180004EF4 (-_IsShadowPartApplicableFromFlags@CAccent@@IEAA_NH@Z.c)
...
__int64 __fastcall CAccent::_UpdateBorderShadowParts(CAtlasedRectsVisual **this)
{
  ...
  struct CAtlasedImage *v28; // [rsp+80h] [rbp+18h]
  const struct tagSIZE *v29; // [rsp+88h] [rbp+20h]
  ...
  while ( 1 )
  {
    if ( !*v6 )
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x198u);
        return v3;
      }
      *((_DWORD *)*v6 + 30) = v5;
      ...
      if ( v10 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v10, 0x19Fu);
        return v3;
      }
    }
    if ( v7 )
