        ...
        struct _LUID a4)
{
  ...
  {
    v9 = -2147024891;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024891, 0x152Eu);
LABEL_13:
    if ( hObject )
      CloseHandle(hObject);
    goto LABEL_22;
  ...
  {
    v9 = -2147467261;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147467261, 0x153Fu);
    goto LABEL_13;
  }
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v11, 0x1545u);
  ...
  if ( v12 >= 0 )
  {
    ...
    *((_QWORD *)this + 98) = v4;
    ...
    v9 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v13, 0x1586u);
    if ( v9 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x1555u);
    v4 = (volatile signed __int32 *)v15;
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v12, 0x1550u);
  }
LABEL_22:
  if ( v4 )
  {
