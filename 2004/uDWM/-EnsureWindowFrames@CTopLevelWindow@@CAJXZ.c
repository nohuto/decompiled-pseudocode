/*
 * XREFs of ?EnsureWindowFrames@CTopLevelWindow@@CAJXZ @ 0x180031014
 * Callers:
...
__int64 CTopLevelWindow::EnsureWindowFrames(void)
{
  ...
  if ( !dword_1800E7D58 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v4 )
        break;
      v5 = dword_1800E7D58 + 1;
      if ( dword_1800E7D58 + 1 < (unsigned int)dword_1800E7D58 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024362, 0xB5u);
      }
      else if ( v5 > dword_1800E7D54 )
      {
      ...
      {
        *(_QWORD *)(CTopLevelWindow::s_rgpwfWindowFrames + 8LL * (unsigned int)dword_1800E7D58) = v4;
        dword_1800E7D58 = v5;
      }
