/*
 * XREFs of ?PostEventMessage@CDesktopManager@@QEAAJI_K_J@Z @ 0x180086E78
 * Callers:
...
__int64 __fastcall CDesktopManager::PostEventMessage(HANDLE *this, UINT a2, WPARAM a3, LPARAM a4)
{
  ...
  if ( this[83] )
  {
    ...
    if ( !PostThreadMessageW(ThreadId, a2, a3, a4) )
    {
      ...
      v4 = LastError;
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D2D48, 1LL, LastError, 0xA83u);
    }
  }
  else
  {
    v4 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800D2D48, 1LL, -2147467259, 0xA80u);
  }
  return v4;
}
