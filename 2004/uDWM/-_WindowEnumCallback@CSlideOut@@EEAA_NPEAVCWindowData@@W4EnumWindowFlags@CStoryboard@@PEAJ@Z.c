/*
 * XREFs of ?_WindowEnumCallback@CSlideOut@@EEAA_NPEAVCWindowData@@W4EnumWindowFlags@CStoryboard@@PEAJ@Z @ 0x180003F20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SlideWindowAnimationRectCheck@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x1800B05D0 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_SlideWindowAnimationRectCheck@@@details@w.c)
  ...
  if ( (v10 & 0xFFF) != 0 )
  {
    if ( (*(_DWORD *)(a2 + 616) & 0xFFF) == 8 )
    {
      ...
      *(_DWORD *)(a2 + 616) |= 0x200000u;
      ...
      v4 = v34;
      if ( v34 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v34, 0x3CFu);
      else
        *(_BYTE *)(*(_QWORD *)(*(_QWORD *)&v36.left + 40LL) + 968LL) = 1;
      goto LABEL_21;
    }
      ...
      *(_DWORD *)(a2 + 616) = v10 | 0x200000;
      ...
      if ( v33 >= 0 )
        *(_DWORD *)(a2 + 616) = v10;
        ...
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v33, 0x3DAu);
      goto LABEL_28;
    }
    if ( (*(_DWORD *)(a2 + 616) & 0xFFF) != 0x18 && (*(_DWORD *)(a2 + 616) & 0xFFF) != 0x2A )
    {
      ...
      {
        v23 = CSlide::_SlideWindowVertically(a1, (struct CWindowData *)a2, &v38, 0, (struct CAnimationComponent **)&v36);
        v4 = v23;
        if ( v23 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v23, 0x3EFu);
        goto LABEL_21;
      }
      if ( (*(_DWORD *)(a2 + 616) & 0xFFF) == 0x46 )
      {
        ...
        if ( (*(_DWORD *)(a2 + 616) & 0x1800000) == 0 )
          goto LABEL_28;
        v22 = CSlide::_SlideWindow(a1, (struct CWindowData *)a2, 1.0, (struct CAnimationComponent **)&v36);
        v4 = v22;
        if ( v22 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v22, 0x3E9u);
        goto LABEL_21;
      }
...
LABEL_21:
          ...
          v30 = CSlide::_SlideWindowHorizontally(a1, v27, &v38, 0, 0LL, (struct CAnimationComponent **)&v36.right);
          v4 = v30;
          if ( v30 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(
...
LABEL_51:
        ...
        else
        {
          ...
          v32 = CSlide::_SlideWindowHorizontally(a1, v27, &v38, 0, 0LL, (struct CAnimationComponent **)&v36.right);
          v4 = v32;
          if ( v32 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(
...
LABEL_9:
        ...
        if ( v12 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v12, 0x39Fu);
          goto LABEL_21;
        }
        v13 = *(_QWORD *)&v36.left;
      ...
      if ( v15 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v15, 0x3B5u);
        v6 = v37;
      }
      else
      {
        ...
        if ( v37 )
        {
          v16 = *(_QWORD *)(*(_QWORD *)&v36.left + 40LL);
          v17 = *(struct tagRECT *)(v16 + 848);
          v18 = *(_OWORD *)(v16 + 864);
          v19 = (CAnimatedTransitionVisual *)*((_QWORD *)v37 + 5);
          v38 = v17;
  ...
  else if ( v10 < 0 )
  {
    ...
    v4 = v35;
    if ( v35 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v35, 0x3F8u);
  }
LABEL_28:
  result = 1;
  *v7 = v4;
