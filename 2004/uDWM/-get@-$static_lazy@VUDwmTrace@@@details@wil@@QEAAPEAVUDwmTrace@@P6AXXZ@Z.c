/*
 * XREFs of ?get@?$static_lazy@VUDwmTrace@@@details@wil@@QEAAPEAVUDwmTrace@@P6AXXZ@Z @ 0x1800813A8
 * Callers:
...
_QWORD *__fastcall wil::details::static_lazy<UDwmTrace>::get(__int64 a1, void (__cdecl *a2)())
{
  ...
  {
    v6 = qword_1800E7B10;
    qword_1800E7B10[0] = &WindowFrameLogging::`vftable';
    qword_1800E7B28 = (struct _tlgProvider_t *)&`UDwmTrace::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)qword_1800E7B10, qword_1800E7B28, v3);
    InitOnceComplete(&`UDwmTrace::Instance'::`2'::wrapper, 0, qword_1800E7B10);
  }
  return v6;
}
