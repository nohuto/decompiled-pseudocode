/*
 * XREFs of ?CalculateRotationAngles@CDWMDisplaySet@@SAJPEBV1@0PEAH1@Z @ 0x18008060C
 * Callers:
 ...
 *     ?DXGIRotationToInt@@YAHW4DXGI_MODE_ROTATION@@@Z @ 0x1800806FC (-DXGIRotationToInt@@YAHW4DXGI_MODE_ROTATION@@@Z.c)
 */
