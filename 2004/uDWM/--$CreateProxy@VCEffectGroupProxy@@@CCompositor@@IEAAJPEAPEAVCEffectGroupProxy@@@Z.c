/*
 * XREFs of ??$CreateProxy@VCEffectGroupProxy@@@CCompositor@@IEAAJPEAPEAVCEffectGroupProxy@@@Z @ 0x180018820
 * Callers:
...
__int64 __fastcall CCompositor::CreateProxy<CEffectGroupProxy>(__int64 a1, __int64 *a2)
{
  ...
  *(_QWORD *)v7 = &CResource::`vftable';
  v9 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)v6 + 96LL))(v6, 10LL, v7 + 24);
  v10 = v9;
  if ( v9 < 0 )
  {
