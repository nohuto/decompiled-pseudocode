/*
 * XREFs of ?GetNCAreaHelper@CTopLevelWindow@@CAJPEAXPEBH1PEAUWindowFrame@1@2@Z @ 0x180046A04
 * Callers:
 ...
 *     ?SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z @ 0x180047244 (-SetSizingMargins@CTopLevelWindow@@CAXPEAUWindowFrame@1@0IU_MARGINS@@@Z.c)
        ...
        struct CTopLevelWindow::WindowFrame *a5)
{
  ...
  v6 = a1;
  v43 = a1;
  if ( dword_1800E7DB8 > *(_DWORD *)(ThreadLocalStoragePointer[tls_index] + 4LL) )
  {
    Init_thread_header(&dword_1800E7DB8);
    if ( dword_1800E7DB8 == -1 )
    {
      dword_1800E50F4 = -2147023728;
      Init_thread_footer(&dword_1800E7DB8);
    }
  }
  ...
  if ( ThemeMargins < 0 )
  {
    iPropId = 990;
LABEL_59:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E50F4, 1LL, ThemeMargins, iPropId);
    return v11;
  }
