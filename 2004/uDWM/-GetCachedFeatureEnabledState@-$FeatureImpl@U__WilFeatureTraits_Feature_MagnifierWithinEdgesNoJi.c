/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_MagnifierWithinEdgesNoJitter@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18008C0B8
 * Callers:
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    if ( !v10 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v5
        || v5 != dword_1800E505C
        || (v12 = 0, v13 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_1800E5090, &v12, 0x10uLL)) )
      {
