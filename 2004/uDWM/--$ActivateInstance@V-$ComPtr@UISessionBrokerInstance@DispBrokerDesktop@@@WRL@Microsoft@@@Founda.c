/*
 * XREFs of ??$ActivateInstance@V?$ComPtr@UISessionBrokerInstance@DispBrokerDesktop@@@WRL@Microsoft@@@Foundation@Windows@@YAJPEAUHSTRING__@@V?$ComPtrRef@V?$ComPtr@UISessionBrokerInstance@DispBrokerDesktop@@@WRL@Microsoft@@@Details@WRL@Microsoft@@@Z @ 0x18004EB50
 * Callers:
