/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_SimulationDriver@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x18004D8D0
 * Callers:
  ...
  *a2 = *a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    if ( !v11 && wil::details::g_enabledStateManager )
    {
      ...
      if ( !v6
        || v6 != dword_1800E505C
        || (v12 = 1, v13 = a1, !wil::details_abi::heap_buffer::push_back((void **)&xmmword_1800E5090, &v12, 0x10uLL)) )
      {
