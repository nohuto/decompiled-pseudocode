/*
 * XREFs of ?_StageCloneRelative@CTransitionVisualController@@IEAAJPEAVCTopLevelWindow@@PEAVCVisual@@_N122PEA_N@Z @ 0x180038678
 * Callers:
 ...
 *     _lambda_bf936d7524fffe447915a29aa2e3ab18_::operator() @ 0x180051D7C (_lambda_bf936d7524fffe447915a29aa2e3ab18_--operator().c)
 * Callees:
...
LABEL_36:
  ...
  {
    v27 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 24, 24LL, 1LL, &v32);
    v9 = v27;
    if ( v27 < 0 )
