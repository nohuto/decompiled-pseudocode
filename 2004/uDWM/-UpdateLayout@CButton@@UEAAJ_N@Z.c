/*
 * XREFs of ?UpdateLayout@CButton@@UEAAJ_N@Z @ 0x180028A10
 * Callers:
 *     <none>
 * Callees:
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x1800039DC (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ?SetDirtyFlags@CAtlasedImage@@IEAAXKK@Z @ 0x1800285A8 (-SetDirtyFlags@CAtlasedImage@@IEAAXKK@Z.c)
 *     ?DoCanvasLayout@CVisual@@SA_NAEBUtagSIZE@@AEBU_MARGINS@@0PEAUtagPOINT@@PEAU2@@Z @ 0x180028CB0 (-DoCanvasLayout@CVisual@@SA_NAEBUtagSIZE@@AEBU_MARGINS@@0PEAUtagPOINT@@PEAU2@@Z.c)
  ...
  else
  {
    ...
    if ( *(_DWORD *)(v7 + 24) != *((_DWORD *)this + 30) || *(_DWORD *)(v7 + 28) != *((_DWORD *)this + 31) )
    {
      *(_QWORD *)(v7 + 24) = *((_QWORD *)this + 15);
      CAtlasedImage::SetDirtyFlags((CAtlasedImage *)v7, 1, 0x2000u);
      v7 = *((_QWORD *)this + 36);
    }
