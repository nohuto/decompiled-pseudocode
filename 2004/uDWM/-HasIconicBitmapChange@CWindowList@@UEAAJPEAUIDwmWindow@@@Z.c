/*
 * XREFs of ?HasIconicBitmapChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18001C0F0
 * Callers:
...
__int64 __fastcall CWindowList::HasIconicBitmapChange(char **this, struct IDwmWindow *a2)
{
  ...
  v17 = 0LL;
  SyncedWindowData = CWindowList::GetSyncedWindowData((CWindowList *)this, a2, 0, &v17);
  v5 = SyncedWindowData;
  if ( SyncedWindowData < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x15B0u);
    goto LABEL_11;
  }
  ...
  if ( v17 && (*((int *)v17 + 28) < 8 || *((int *)v17 + 28) > 11) )
  {
    ...
    if ( !v9 )
    {
      if ( (*((_BYTE *)v7 + 610) & 4) == 0 && v8 )
      {
        ...
        {
          v18 = &v17;
          v16 = DynArrayImpl<0>::Grow(this + 58, 8u, 1, 0, (unsigned __int64 *)&v18);
          if ( v16 < 0 )
