/*
 * XREFs of ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_SimulationDriver@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18004D4B4
 * Callers:
...
void wil::details::FeatureImpl<__WilFeatureTraits_Feature_SimulationDriver>::ReportUsage(
        _DWORD *a1,
        unsigned __int8 a2,
        __int64 a3,
        ...)
