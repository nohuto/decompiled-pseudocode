/*
 * XREFs of ?StartActivity@AnimationClockStateChange@AnimationClockLoggingTelemetry@@QEAAXU_GUID@@HH@Z @ 0x18002EC00
 * Callers:
        ...
        int a4)
{
  ...
  if ( *v9 > 4u )
  {
    ...
    v21 = 4;
    v18 = 8;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)v9, byte_1800D1329, v11 + 8, v10, 7, (__int64)v16);
  }
  if ( !*((_DWORD *)this + 8) )
