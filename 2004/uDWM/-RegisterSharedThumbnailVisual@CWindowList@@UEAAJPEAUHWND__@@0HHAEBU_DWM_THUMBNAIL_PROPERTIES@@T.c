/*
 * XREFs of ?RegisterSharedThumbnailVisual@CWindowList@@UEAAJPEAUHWND__@@0HHAEBU_DWM_THUMBNAIL_PROPERTIES@@T_LARGE_INTEGER@@PEAX@Z @ 0x18000E660
 * Callers:
 *     <none>
 * Callees:
 *     ?MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z @ 0x1800039DC (-MilInstrumentationCheckHR_MaybeFailFast@@YAXKQEBJIJIPEAX@Z.c)
 *     ?IsBaseThumbnailDestinationReachable@CWindowList@@AEAA_NPEAVCWindowData@@@Z @ 0x18000E370 (-IsBaseThumbnailDestinationReachable@CWindowList@@AEAA_NPEAVCWindowData@@@Z.c)
...
LABEL_6:
  ...
  *(_BYTE *)(v20 + 34) = 1;
  ...
  if ( v21 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0xF32u);
    v12 = v41;
    goto LABEL_57;
  }
...
LABEL_64:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0xF39u);
LABEL_57:
    if ( v12 )
  ...
  v34 = DynArrayImpl<0>::AddMultipleAndSet(v23, 8LL, 1LL, &v42);
  v14 = v34;
  if ( v34 < 0 )
...
LABEL_18:
  ...
  v35 = DynArrayImpl<0>::AddMultipleAndSet((char *)v15 + 472, 8LL, 1LL, &v42);
  v14 = v35;
  if ( v35 < 0 )
...
LABEL_21:
  if ( v17 )
  {
    ...
    else
    {
      ...
      v36 = DynArrayImpl<0>::AddMultipleAndSet((char *)v17 + 504, 8LL, 1LL, &v42);
      v14 = v36;
      if ( v36 < 0 )
