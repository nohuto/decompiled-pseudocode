/*
 * XREFs of ?UpdateAccentPolicy@CAccent@@QEAAJPEBUtagRECT@@PEBUACCENT_POLICY@@PEAVCBaseGeometryProxy@@@Z @ 0x18000FC64
 * Callers:
 ...
 *     ?StopAnimation@CAccentTransition@@QEAAXXZ @ 0x1800B5C14 (-StopAnimation@CAccentTransition@@QEAAXXZ.c)
 */
        ...
        struct CBaseGeometryProxy *a4)
{
  ...
  v70 = 0LL;
  CVisual::SetInsetFromParent(this, &v70);
