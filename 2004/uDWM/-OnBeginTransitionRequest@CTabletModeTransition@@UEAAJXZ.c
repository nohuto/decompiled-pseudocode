/*
 * XREFs of ?OnBeginTransitionRequest@CTabletModeTransition@@UEAAJXZ @ 0x1800AFC90
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( GetMonitorInfoW(v2, &mi) )
  {
    ...
    *(RECT *)&pt[0].x = *p_rcMonitor;
    ...
    if ( DesktopSnapshotComponent >= 0 )
    {
      ...
      v3 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, &CStoryboard::MILINSTRUMENTATIONHRESULTLIST, 1LL, v7, 0x1337u);
    }
    else
    {
