/*
 * XREFs of ?SetTitle@CWindowData@@QEAAJPEAGH@Z @ 0x180011CB0
 * Callers:
...
__int64 __fastcall CWindowData::SetTitle(CWindowData *this, char *a2, int a3)
{
  ...
  if ( v3 == (CWindowData *)((char *)this + 702) )
  {
    if ( v7 > 26 )
    {
      ...
      *v4 = v3;
      if ( !v3 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x1FB6u);
        return 2147942414LL;
      }
    }
  }
  ...
  else
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x1FC7u);
      return v15;
    }
    v3 = *v4;
    if ( !*v4 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, -2147024882, 0x1FC8u);
      return 2147942414LL;
    }
  }
  v8 = v7;
...
LABEL_13:
  if ( v9 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v9, 0x1FCCu);
