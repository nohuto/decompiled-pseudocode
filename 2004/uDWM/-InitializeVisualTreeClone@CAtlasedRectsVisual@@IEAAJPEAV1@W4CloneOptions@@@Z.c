/*
 * XREFs of ?InitializeVisualTreeClone@CAtlasedRectsVisual@@IEAAJPEAV1@W4CloneOptions@@@Z @ 0x180018350
 * Callers:
 ...
 *     ??0CAtlasedImage@@IEAA@XZ @ 0x1800195DC (--0CAtlasedImage@@IEAA@XZ.c)
...
__int64 __fastcall CAtlasedRectsVisual::InitializeVisualTreeClone(__int64 a1, __int64 a2, __int64 a3)
{
  unsigned int v3; // edi
  CBaseObject *v6; // rbx
  int v7; // eax
  ...
  v3 = a3;
  v6 = 0LL;
  v7 = CVisual::InitializeVisualTreeClone(a1, a2, a3);
  v8 = v7;
  if ( v7 < 0 )
  {
    v42 = (unsigned int)v7;
  ...
  while ( 1 )
  {
    ...
    {
      *((RECT *)v14 + 3) = v24[3];
      CAtlasedImage::SetDirtyFlags(v14, 1u, 0x2000u);
    }
    v25 = *(_QWORD *)(a1 + 240);
    ...
    {
      CAtlasedImage::SetDirtyFlags(v14, 2u, 0x2000u);
      *((_DWORD *)v14 + 17) = v27;
      v25 = *(_QWORD *)(a1 + 240);
    }
    v28 = *(_QWORD *)(v11 + v25);
