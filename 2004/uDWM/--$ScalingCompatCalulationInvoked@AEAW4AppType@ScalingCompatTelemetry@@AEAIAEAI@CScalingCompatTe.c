/*
 * XREFs of ??$ScalingCompatCalulationInvoked@AEAW4AppType@ScalingCompatTelemetry@@AEAIAEAI@CScalingCompatTelemetry@ScalingCompatTelemetry@@SAXAEAW4AppType@1@AEAI1@Z @ 0x1800C110C
 * Callers:
  ...
  if ( result )
  {
           ...
           &Context) )
    {
      if ( fPending )
      {
        ...
        Context = &qword_1800E7C18;
        qword_1800E7C18 = (__int64)&WindowFrameLogging::`vftable';
