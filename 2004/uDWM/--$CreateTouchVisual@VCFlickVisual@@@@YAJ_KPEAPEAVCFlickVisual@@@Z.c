/*
 * XREFs of ??$CreateTouchVisual@VCFlickVisual@@@@YAJ_KPEAPEAVCFlickVisual@@@Z @ 0x18009CB80
 * Callers:
...
__int64 __fastcall CreateTouchVisual<CFlickVisual>(__int64 a1, CFlickVisual **a2)
{
  unsigned int v3; // edi
  CTouchVisual *v4; // rax
  CFlickVisual *v5; // rbx
