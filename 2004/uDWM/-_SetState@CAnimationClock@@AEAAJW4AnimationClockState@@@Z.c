/*
 * XREFs of ?_SetState@CAnimationClock@@AEAAJW4AnimationClockState@@@Z @ 0x18002E93C
 * Callers:
 *     ?_OnTimerCallback@CAnimationClock@@AEAAXXZ @ 0x18002E5FC (-_OnTimerCallback@CAnimationClock@@AEAAXXZ.c)
...
LABEL_11:
  ...
  if ( (Microsoft_Windows_Dwm_UdwmEnableBits & 1) != 0 )
    McTemplateU0jdd_EtwEventWriteTransfer(v9, v8, a1 + 120, *(_DWORD *)(a1 + 80), a2);
  ...
  *(_DWORD *)(a1 + 80) = a2;
  ...
  if ( a2 == v11 )
  {
    ...
    if ( v3 >= 0 )
    {
      ...
      {
        if ( v14 == 1 )
          v3 = CAnimationClock::_SetTime(a1, 0LL, 0LL);
      }
      else if ( v4 == -1 )
      {
