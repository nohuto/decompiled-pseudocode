/*
 * XREFs of ?UpdateWindowVisuals@CTopLevelWindow@@AEAAJXZ @ 0x180018950
 * Callers:
 ...
 *     ?IsSheetOfGlass@CTopLevelWindow@@AEAA_NXZ @ 0x180015CB8 (-IsSheetOfGlass@CTopLevelWindow@@AEAA_NXZ.c)
 ...
 *     ?GetCurrentDefaultColorizationFlags@CTopLevelWindow@@AEAA?AU?$TMILFlagsEnum@W4FlagsEnum@ColorizationFlags@@@@XZ @ 0x18003CC64 (-GetCurrentDefaultColorizationFlags@CTopLevelWindow@@AEAA-AU-$TMILFlagsEnum@W4FlagsEnum@Coloriza.c)
 *     ?GetNonClientCaptionFont@CWindowData@@QEAAXPEAUtagLOGFONTW@@@Z @ 0x18003E210 (-GetNonClientCaptionFont@CWindowData@@QEAAXPEAUtagLOGFONTW@@@Z.c)
 *     ?TreatAsActiveWindow@CTopLevelWindow@@AEAA_NXZ @ 0x18003E358 (-TreatAsActiveWindow@CTopLevelWindow@@AEAA_NXZ.c)
 *     ?BlendColors@@YAKKKM@Z @ 0x18003E728 (-BlendColors@@YAKKKM@Z.c)
