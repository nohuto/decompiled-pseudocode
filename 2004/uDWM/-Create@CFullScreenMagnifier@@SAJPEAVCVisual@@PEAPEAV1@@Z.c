/*
 * XREFs of ?Create@CFullScreenMagnifier@@SAJPEAVCVisual@@PEAPEAV1@@Z @ 0x1800493F8
 * Callers:
 ...
 *     ??0CFullScreenMagnifier@@AEAA@PEAVCVisual@@@Z @ 0x180049488 (--0CFullScreenMagnifier@@AEAA@PEAVCVisual@@@Z.c)
