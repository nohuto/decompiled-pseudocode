/*
 * XREFs of ?UpdateWindowScale@CTopLevelWindow@@AEAAXXZ @ 0x180024A08
 * Callers:
 ...
 *     ?NeedsCorrectionScaleForUniformSpaceWindow@CTopLevelWindow@@CA_NPEAVCWindowData@@@Z @ 0x180026248 (-NeedsCorrectionScaleForUniformSpaceWindow@CTopLevelWindow@@CA_NPEAVCWindowData@@@Z.c)
...
void __fastcall CTopLevelWindow::UpdateWindowScale(CTopLevelWindow *this)
{
  ...
  *((_DWORD *)this + 172) = -1;
  ...
  if ( v2 )
  {
    ...
    {
      CVisual::SetInterpolationMode(*((_QWORD *)this + 68), 6LL);
    }
    else
    {
