/*
 * XREFs of ?OnFlick@CContactManager@@QEAAJPEBUMILCMD_DWM_REDIRECTION_RENDERFLICK@@@Z @ 0x18009E61C
 * Callers:
...
__int64 __fastcall CContactManager::OnFlick(CContactManager *this, const struct MILCMD_DWM_REDIRECTION_RENDERFLICK *a2)
{
  ...
  if ( *((_DWORD *)a2 + 1) <= 0x14u )
  {
    ...
    *((_DWORD *)this + 80) = v8 + 1;
    ...
    Touch = CreateTouchVisual<CFlickVisual>(v12, (CFlickVisual **)this + 39);
    v5 = Touch;
    if ( Touch >= 0 )
    {
