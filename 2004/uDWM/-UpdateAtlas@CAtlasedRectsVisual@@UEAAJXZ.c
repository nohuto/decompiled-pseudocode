/*
 * XREFs of ?UpdateAtlas@CAtlasedRectsVisual@@UEAAJXZ @ 0x18001E4F0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_26:
    if ( v6 )
      ...
      v25 = 0LL;
    v26 = (*(__int64 (__fastcall **)(void (__fastcall *)(_QWORD, _QWORD), _QWORD, __int64, __int64, _DWORD))(**(_QWORD **)(*((_QWORD *)v1 + 2) + 16LL) + 928LL))(
            *(void (__fastcall **)(_QWORD, _QWORD))(*((_QWORD *)v1 + 2) + 16LL),
