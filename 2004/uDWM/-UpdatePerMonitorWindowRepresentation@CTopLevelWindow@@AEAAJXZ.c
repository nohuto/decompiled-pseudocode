/*
 * XREFs of ?UpdatePerMonitorWindowRepresentation@CTopLevelWindow@@AEAAJXZ @ 0x18001EE74
 * Callers:
...
__int64 __fastcall CTopLevelWindow::UpdatePerMonitorWindowRepresentation(CTopLevelWindow *this)
{
  ...
  if ( (*((_BYTE *)v1 + 348) & 2) != 0 )
  {
    ...
    if ( !v6 )
    {
      ...
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v7, 0x15F6u);
        return v2;
      }
      v1 = (struct CWindowData *)*((_QWORD *)this + 91);
      v6 = *v5;
          ...
          if ( inserted >= 0 )
          {
            if ( *(_BYTE *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 61) + 601LL) )
            {
              ...
              if ( v12 )
              {
                ...
                if ( v14 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v14, 0x1610u);
                  return v2;
                }
                ...
                if ( v15 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v15, 0x1611u);
                  return v2;
                }
              }
              else
              {
                ...
                if ( v16 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v16, 0x1615u);
                  return v2;
                }
                ...
                if ( v17 < 0 )
                {
                  MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v17, 0x1616u);
                  return v2;
                }
              }
            }
            else
            {
              ...
              if ( v18 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v18, 0x161Bu);
                return v2;
              }
              ...
              if ( v19 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v19, 0x161Cu);
                return v2;
              }
            }
            ...
            v2 = v20;
            if ( v20 < 0 )
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v20, 0x161Fu);
          }
          else
          {
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, inserted, 0x1608u);
          }
        }
      }
        ...
        if ( v21 >= 0 )
        {
          if ( *(_BYTE *)(*((_QWORD *)CDesktopManager::s_pDesktopManagerInstance + 61) + 601LL) )
          {
            ...
            if ( v23 )
            {
              ...
              if ( v24 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v24, 0x162Fu);
                return v2;
              }
              ...
              if ( v25 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v25, 0x1630u);
                return v2;
              }
            }
            else
            {
              ...
              if ( v26 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v26, 0x1634u);
                return v2;
              }
              ...
              if ( v27 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v27, 0x1635u);
                return v2;
              }
            }
          }
          else
          {
            ...
            if ( v28 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v28, 0x163Au);
              return v2;
            }
            ...
            if ( v29 < 0 )
            {
              MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v29, 0x163Bu);
              return v2;
            }
          }
          ...
          v2 = v30;
          if ( v30 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v30, 0x163Eu);
        }
        else
        {
          MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v21, 0x1627u);
        }
      }
    }
    else
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x15FCu);
    }
  }
  return v2;
}
