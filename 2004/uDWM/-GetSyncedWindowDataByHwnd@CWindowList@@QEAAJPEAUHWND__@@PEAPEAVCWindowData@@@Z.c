/*
 * XREFs of ?GetSyncedWindowDataByHwnd@CWindowList@@QEAAJPEAUHWND__@@PEAPEAVCWindowData@@@Z @ 0x18001B3A4
 * Callers:
  ...
  if ( a2 )
  {
    ...
    if ( v6 )
    {
      ...
      if ( SyncedWindowData < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, SyncedWindowData, 0x865u);
    }
  }
  return v3;
}
