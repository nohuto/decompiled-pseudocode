/*
 * XREFs of ?DPIChange@CWindowList@@UEAAJPEAUIDwmWindow@@@Z @ 0x18001EAC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v28, 0x886u);
  v8 = v6;
  if ( v6 < 0 )
  {
LABEL_51:
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v6, 0x14BCu);
    goto LABEL_35;
  }
  if ( v5 )
  {
    ...
    *((_DWORD *)v5 + 15) = (_DWORD)v20;
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v22, 0xD47u);
    }
    else if ( v15 || v12 )
    {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(0x14u, 0LL, 0LL, v8, 0x14D9u);
    }
