/*
 * XREFs of ?_SetProjectionBorderForWindow@CProjectionBorderManager@@AEAAJPEAUHWND__@@_N@Z @ 0x1800927E8
 * Callers:
  ...
  if ( SyncedWindowDataByHwnd >= 0 )
  {
    ...
    if ( v12 && *((_QWORD *)v12 + 48) )
    {
      if ( a3 )
      {
        ...
        if ( !v8 )
        {
          CWindowList::ShowProjectionBorder(*((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 61), v12, 1);
          v8 = *((_DWORD *)v7 + 102);
        }
        *((_DWORD *)v7 + 102) = v8 + 1;
      }
      else if ( (*((_DWORD *)v12 + 102))-- == 1 )
      {
        CWindowList::ShowProjectionBorder(*((CWindowList **)CDesktopManager::s_pDesktopManagerInstance + 61), v7, 0);
      }
    }
    v6 = 0;
  }
