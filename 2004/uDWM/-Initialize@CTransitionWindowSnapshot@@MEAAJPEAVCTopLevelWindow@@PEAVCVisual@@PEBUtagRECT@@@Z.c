/*
 * XREFs of ?Initialize@CTransitionWindowSnapshot@@MEAAJPEAVCTopLevelWindow@@PEAVCVisual@@PEBUtagRECT@@@Z @ 0x180001860
 * Callers:
 ...
 * Callees:
 *     ?CanUseCVIFromSnapshot@CTransitionWindowSnapshot@@SA_NPEBVCWindowData@@@Z @ 0x1800019F8 (-CanUseCVIFromSnapshot@CTransitionWindowSnapshot@@SA_NPEBVCWindowData@@@Z.c)
        ...
        const struct tagRECT *a4)
{
  ...
  if ( dword_1800E7B84 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1800E7B84);
    if ( dword_1800E7B84 == -1 )
    {
      dword_1800E4F04 = -2147023434;
      Init_thread_footer(&dword_1800E7B84);
    }
  }
  v19 = 0LL;
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E4F04, 1u, v8, 0x57u, v18);
    return v9;
  }
...
LABEL_21:
  v16 = v10;
LABEL_23:
  MilInstrumentationCheckHR_MaybeFailFast(0x14u, &dword_1800E4F04, 1u, v16, v17, v18);
LABEL_15:
  if ( v19 )
