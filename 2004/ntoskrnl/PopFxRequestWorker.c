/*
 * XREFs of PopFxRequestWorker @ 0x140350050
 * Callers:
...
char __fastcall PopFxRequestWorker(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  LOBYTE(v6) = KeReleaseSemaphoreEx((__int64)(v4 + 16), 0LL, 1LL, a4, 0);
