/*
 * XREFs of CcWriteBehindInternal @ 0x1402BFC70
 * Callers:
    ...
    if ( !*(_DWORD *)(v1 + 516) && v24 && !v23 )
    {
      ...
      if ( FlushedValidData.QuadPart >= *(_QWORD *)(v1 + 40) )
      {
        if ( (*(_DWORD *)(v1 + 152) & 0x40000000) != 0
          || (KeReleaseGuardedMutex((PKGUARDED_MUTEX)(v1 + 280)),
              v33 = (struct _FILE_OBJECT *)CcReferenceSharedCacheMapFileObject(v1),
              valid = CcSetValidData(v33, (__int64 *)&FlushedValidData),
