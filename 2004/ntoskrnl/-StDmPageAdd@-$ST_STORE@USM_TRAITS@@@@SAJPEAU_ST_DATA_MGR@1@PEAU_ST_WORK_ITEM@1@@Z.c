/*
 * XREFs of ?StDmPageAdd@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x1402D02B0
 * Callers:
 ...
 *     StIoCountsMovePeriod @ 0x140598010 (StIoCountsMovePeriod.c)
 */
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmPageAdd(__int64 a1, __int64 a2)
{
  ...
  v18 = v2;
  v19 = v4;
  v6 = SmMapPage(_mm_srli_si128(v2, 8).m128i_i64[0], &v20);
  v7 = v2.m128i_i32[0];
  if ( v6 )
  {
    if ( v2.m128i_i32[0] >= 0 )
    ...
    for ( v18.m128i_i64[1] = (__int64)v6; ; v18.m128i_i64[1] += 4096LL )
    {
      v10 = v7 >= 0 ? 1 : (v8 + *(_DWORD *)(a1 + 824) + 15) >> 4;
      v21 = v10;
      do
      {
        v11 = ST_STORE<SM_TRAITS>::StDmpSinglePageAdd(a1, &v18, a2, &v21);
        v12 = v11;
      }
