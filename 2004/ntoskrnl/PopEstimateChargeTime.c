/*
 * XREFs of PopEstimateChargeTime @ 0x1408EA654
 * Callers:
...
unsigned __int64 PopEstimateChargeTime()
{
  ...
  {
    for ( i = qword_140C23130; (__int64 *)i != &qword_140C23130; i = *(_QWORD *)i )
    {
      v7 = *(_DWORD *)(i + 64);
      if ( v7 != -1 )
      {
  ...
  if ( (unsigned int)dword_140C021E8 > 5 )
  {
    ...
    v13 = v4;
    v35 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)&word_14002825E, 0LL, 0LL, 8u, &v18);
  }
  return v0;
}
