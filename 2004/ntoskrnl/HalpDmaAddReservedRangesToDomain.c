/*
 * XREFs of HalpDmaAddReservedRangesToDomain @ 0x1404BFB20
 * Callers:
 ...
 *     HalpIommuGetReservedRanges @ 0x1404C491C (HalpIommuGetReservedRanges.c)
 *     HalpLaReserveRange @ 0x1404D6434 (HalpLaReserveRange.c)
 */
