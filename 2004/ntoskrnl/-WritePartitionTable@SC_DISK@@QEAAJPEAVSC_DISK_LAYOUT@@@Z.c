/*
 * XREFs of ?WritePartitionTable@SC_DISK@@QEAAJPEAVSC_DISK_LAYOUT@@@Z @ 0x1405C1DD4
 * Callers:
 *     IoWritePartitionTable @ 0x14088B020 (IoWritePartitionTable.c)
 *     IoWritePartitionTableEx @ 0x14088B190 (IoWritePartitionTableEx.c)
 * Callees:
 *     ?CreatePartitionTable@SC_DISK@@QEAAJPEAU_CREATE_DISK@@@Z @ 0x1405C1758 (-CreatePartitionTable@SC_DISK@@QEAAJPEAU_CREATE_DISK@@@Z.c)
