/*
 * XREFs of IoOpenDriverRegistryKey @ 0x1407B2510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IoOpenDriverRegistryKey(__int64 a1, int a2, ACCESS_MASK a3, int a4, _QWORD *a5)
{
  ...
  HANDLE v18; // rax
  _DWORD *v20; // [rsp+40h] [rbp-31h] BYREF
...
LABEL_35:
  if ( (unsigned int)Feature_Servicing_VB_Memory_Leak_33934456__private_IsEnabled() && v7 )
