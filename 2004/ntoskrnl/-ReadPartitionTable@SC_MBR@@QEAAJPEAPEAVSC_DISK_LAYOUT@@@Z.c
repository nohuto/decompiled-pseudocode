/*
 * XREFs of ?ReadPartitionTable@SC_MBR@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x1405C2128
 * Callers:
 ...
 *     ?CheckSum@MBR_HEADER@@QEAAKXZ @ 0x1405C1EFC (-CheckSum@MBR_HEADER@@QEAAKXZ.c)
 *     ?Validate@MBR_ENTRY@@QEAAEK_K@Z @ 0x1405C2500 (-Validate@MBR_ENTRY@@QEAAEK_K@Z.c)
