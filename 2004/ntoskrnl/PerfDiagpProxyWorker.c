/*
 * XREFs of PerfDiagpProxyWorker @ 0x14079D790
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PerfDiagpProxyWorker(_DWORD *a1)
{
  ...
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_140C1A020, 0LL);
  if ( !(unsigned int)PerfDiagpIsTracingAllowed() )
    goto LABEL_30;
  if ( dword_140C1A028 != v1 - 1 )
  {
    if ( v1 == 3 )
    {
      if ( dword_140C1A028 == 1 )
        goto LABEL_11;
    }
...
LABEL_16:
        ...
        NtTraceControl(2u, dword_140C1A050, dword_140C1A050[0], dword_140C1A050, dword_140C1A050[0], &v8);
        goto LABEL_11;
      case 5:
...
LABEL_11:
  dword_140C1A028 = v1;
LABEL_12:
  v6 = _InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C1A020, 0xFFFFFFFFFFFFFFFFuLL);
  if ( (v6 & 2) != 0 && (v6 & 4) == 0 )
    ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C1A020);
  KeAbPostRelease((ULONG_PTR)&qword_140C1A020);
