/*
 * XREFs of PopMarkHiberPhase @ 0x1409AE758
 * Callers:
...
void __fastcall PopMarkHiberPhase(unsigned int *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140C23070, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_140C23038, (unsigned int)dword_140C23040, 0);
