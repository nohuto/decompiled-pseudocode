/*
 * XREFs of ViInitSystemPhase0 @ 0x140A6C258
 * Callers:
 ...
 *     VfDisableCodeIntegrityBreaks @ 0x1409C4E20 (VfDisableCodeIntegrityBreaks.c)
...
void __fastcall ViInitSystemPhase0(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !v6 && v5 )
  {
    *(_QWORD *)&VfBugcheckTmpData = *(unsigned int *)(v5 + 56);
    ...
    qword_140D48038 = *(_QWORD *)(v5 + 72);
    *(_OWORD *)&xmmword_140D48040 = *(_OWORD *)(v5 + 80);
  }
  if ( (VfOptionFlags & 0x410) == 0
