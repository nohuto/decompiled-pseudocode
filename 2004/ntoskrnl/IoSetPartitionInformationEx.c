/*
 * XREFs of IoSetPartitionInformationEx @ 0x14088AEB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPartition@SC_DISK@@QEAAJKPEAU_SET_PARTITION_INFORMATION_EX@@@Z @ 0x1405C1D2C (-SetPartition@SC_DISK@@QEAAJKPEAU_SET_PARTITION_INFORMATION_EX@@@Z.c)
