/*
 * XREFs of MiMapPagesToZero @ 0x14023D1E0
 * Callers:
...
LABEL_35:
  ...
  {
    if ( *(_BYTE *)(((LeafVa >> 39) & 0x1FF) - 256 + v22 + 12908488) == 1
      || LeafVa >= 0xFFFFF68000000000uLL && LeafVa <= (unsigned __int64)SchedulerAssist )
    {
      goto LABEL_66;
    }
    if ( LeafVa < qword_140C4F938 || (v31 = HIBYTE(word_140C4DE08), LeafVa > qword_140C4E168) )
      v31 = (unsigned __int8)word_140C4DE08;
  }
  else
  {
    v31 = HIBYTE(word_140C4DE08);
  }
  if ( v31 )
LABEL_65:
    v27 |= 0x100uLL;
LABEL_66:
  v32 = a3;
  v33 = v27 ^ ((unsigned __int16)v27 ^ (unsigned __int16)((unsigned __int8)word_140C4DE08 << 8)) & 0x100 | 0x42;
  v34 = v27 ^ ((unsigned __int16)v27 ^ (unsigned __int16)((unsigned __int8)word_140C4DE08 << 8)) & 0x100 | 0xC2;
  if ( (v25 & 0x4000000) == 0 )
    v34 = v33;
