...
void PerfDiagpSaveActiveDCLLogFileName()
{
  ...
  if ( ValueData )
  {
    memset(dword_140C1A050, 0, 0xB0uLL);
    wcscpy(&xmmword_140C1A02C, L"WdiContextLog");
    dword_140C1A07C = 0x20000;
    RtlInitUnicodeString(&DestinationString, &xmmword_140C1A02C);
    qword_140C1A0D8 = (__int64)ValueData;
    word_140C1A0D2 = 520;
    dword_140C1A050[0] = 176;
    if ( (int)NtTraceControl(3u, dword_140C1A050, 0xB0u, dword_140C1A050, 0xB0u, &v2) < 0
