/*
 * XREFs of CcSetDirtyPinnedData @ 0x1402C28E0
 * Callers:
...
void __stdcall CcSetDirtyPinnedData(PVOID BcbVoid, PLARGE_INTEGER Lsn)
{
  ...
  int v67; // [rsp+B8h] [rbp+20h] BYREF

  v5 = *(_WORD *)BcbVoid;
  memset(&LockHandle, 0, sizeof(LockHandle));
  if ( v5 != 765 && v5 != 762 )
    KeBugCheckEx(0x34u, 0xE79uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
  v7 = v62;
  v8 = BcbVoid;
  v62[0] = BcbVoid;
  v62[1] = 0LL;
  ...
  if ( *(_QWORD *)(v9 + 168) )
  {
    ...
    else
    {
      ...
      if ( _interlockedbittestandset(&dword_140C4C780, 0x1Fu) )
      {
        ...
        v65 = ExpWaitForSpinLockExclusiveAndAcquire(&dword_140C4C780, CurrentIrql);
      }
      ...
      if ( (dword_140C4C780 & 0xBFFFFFFF) != 0x80000000 )
      {
        do
        {
          if ( (v15 & 0x40000000) == 0 )
          {
            v47 = _InterlockedCompareExchange(&dword_140C4C780, v15 | 0x40000000, v15);
            v29 = (_DWORD)v15 == v47;
            v15 = v47;
            if ( !v29 )
              continue;
  ...
  if ( (v19 & 0x200) != 0 )
  {
    ...
    if ( *v7 )
    {
      while ( 1 )
      {
        ...
        ++v7;
        if ( (v20 & 1) != 0 )
          KeBugCheckEx(0x34u, 0xED9uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
        v21 = *(_QWORD *)(v20 + 176);
        v67 = 0;
...
LABEL_30:
        ...
        KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v21 + 280, &v67);
  ...
  {
    CcSetDirtyInMask(v9, (__int64 *)BcbVoid + 1, *((_DWORD *)BcbVoid + 1), 0LL);
  }
}
