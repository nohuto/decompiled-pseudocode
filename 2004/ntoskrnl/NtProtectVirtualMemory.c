/*
 * XREFs of NtProtectVirtualMemory @ 0x140696D50
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall NtProtectVirtualMemory(void *a1, unsigned __int64 *a2, _QWORD *a3, unsigned int a4, _DWORD *a5)
{
  void *v7; // r10
  ...
  if ( result >= 0 )
  {
    ...
    if ( (v20[992] & 1) != 0 )
      ...
      v21 = MmProtectVirtualMemory((__int64)Process, (__int64)v20, &v26, &v28, a4, &v25);
    v22 = v21;
    LODWORD(Object) = v21;
    if ( v9 )
