/*
 * XREFs of KiLockExtendedServiceTable @ 0x1403D88C8
 * Callers:
                    ...
                    if ( v97 )
                    {
                      ...
                      if ( BaseOfImage )
                      {
                        ...
                        while ( (PVOID)*v99 != BaseOfImage )
                        {
                          if ( !*v99 )
                          {
                            qword_140C12FC0[v98] = (__int64)BaseOfImage;
                            break;
                          }
...
LABEL_115:
  ...
  {
    v100 = (unsigned __int64)&qword_140C12ED0;
    v101 = (unsigned __int64)&qword_140C12ED0 & 0x3F;
    v132 = (unsigned __int64)&qword_140C12ED0 & 0x3F;
