/*
 * XREFs of KiUpdateProcessorCount @ 0x14099BBB0
 * Callers:
 *     KiUpdateNumberProcessorsIpi @ 0x1409AC7C0 (KiUpdateNumberProcessorsIpi.c)
 *     KeStartAllProcessors @ 0x140A45D28 (KeStartAllProcessors.c)
 * Callees:
 *     KeAddProcessorAffinityEx @ 0x14021E120 (KeAddProcessorAffinityEx.c)
 *     KiGetCurrentGroupCount @ 0x140360F08 (KiGetCurrentGroupCount.c)
 */
