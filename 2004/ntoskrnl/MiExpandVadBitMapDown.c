/*
 * XREFs of MiExpandVadBitMapDown @ 0x1408CD824
 * Callers:
...
__int64 __fastcall MiExpandVadBitMapDown(_QWORD *a1, unsigned __int64 a2)
{
  ...
  *a1 += v6 << 15;
  ...
  a1[4] = v8;
  a1[3] = 0LL;
  MiUpdateVadBits((a1[1] - qword_140C4E160) << 19, ((a1[1] - qword_140C4E160) << 19) + (v6 << 31));
  return 1LL;
}
