/*
 * XREFs of RtlGenerateQpcToIncrementConstants @ 0x14039569C
 * Callers:
 *     KeSetTimeAdjustment @ 0x14038FE24 (KeSetTimeAdjustment.c)
 *     KiSetupTimeIncrement @ 0x1403B086C (KiSetupTimeIncrement.c)
 * Callees:
 *     RtlpComputeFraction @ 0x1403956D8 (RtlpComputeFraction.c)
 */
