/*
 * XREFs of PopPowerAggregatorRecordIntent @ 0x1407639A0
 * Callers:
 ...
 *     PopPowerAggregatorAreTargetStatesEqual @ 0x1408EABC4 (PopPowerAggregatorAreTargetStatesEqual.c)
 */
        ...
        int a7)
{
  ...
  v13 = (char *)&unk_140C21660 + 144 * (((unsigned __int8)dword_140C21658 - 1) & 0x1F);
  if ( *(_DWORD *)v13 != 1
    || *((_DWORD *)v13 + 6) != a2
    || *((_DWORD *)v13 + 8) != a4
    || *((_DWORD *)v13 + 34) != v9
