...
LABEL_39:
            ...
            *((_QWORD *)&v23->Next + 1) = 0LL;
            ...
            v34 = ObOpenObjectByNameEx(a3, IoFileObjectType, v68, 0LL, a2, v23, v23[12].Next, &Handle);
            v67 = v34;
...
LABEL_63:
              ...
              if ( (v37 & 1) == 0 )
              {
                ...
                if ( (*(_DWORD *)(v36 + 4) & 4) != 0 )
                {
                  ...
                  {
                    ++dword_140CDB160;
                    ((void (__fastcall *)(__int64))qword_140CDB178)(v36);
                  }
                  else
                  {
              ...
              if ( v56 )
              {
                if ( Next == -1096154543 )
                {
                  if ( (*(_DWORD *)(v56 + 80) & 0x40000) == 0 )
                    IopCloseFile(0LL, *((_QWORD *)&v23->Next + 1), 1LL);
                }
                else
                {
                  if ( *(_WORD *)(v56 + 88) )
