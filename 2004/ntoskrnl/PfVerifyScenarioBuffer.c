/*
 * XREFs of PfVerifyScenarioBuffer @ 0x1406CD4F0
 * Callers:
 ...
 *     PfMetadataRecordIsEqual @ 0x1406BDDAC (PfMetadataRecordIsEqual.c)
 *     PfVerifyScenarioId @ 0x1406CE4B4 (PfVerifyScenarioId.c)
 */
