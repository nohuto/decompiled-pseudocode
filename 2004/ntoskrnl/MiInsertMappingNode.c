/*
 * XREFs of MiInsertMappingNode @ 0x140350868
 * Callers:
...
__int64 __fastcall MiInsertMappingNode(_QWORD *a1)
{
  ...
  v1 = a1[3];
  v3 = ExAcquireSpinLockExclusive(&dword_140C4E9C0);
  v4 = (_QWORD *)qword_140C4E9C8;
  v5 = 0;
  v6 = v3;
  if ( qword_140C4E9C8 )
  {
  ...
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4E9C8, (unsigned __int64)v4, v5, a1);
