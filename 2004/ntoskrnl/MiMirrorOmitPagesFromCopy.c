/*
 * XREFs of MiMirrorOmitPagesFromCopy @ 0x14038339C
 * Callers:
 ...
 *     MiMirrorRemoveBlackChildPartitionPages @ 0x14052F840 (MiMirrorRemoveBlackChildPartitionPages.c)
...
__int64 __fastcall MiMirrorOmitPagesFromCopy(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  v7 = a2;
  v8 = a2 & 0x1F;
  v9 = (volatile signed __int32 *)(qword_140C4E528 + 4 * (a2 >> 5));
  if ( v8 + v6 > 0x20 )
  {
    if ( (a2 & 0x1F) != 0 )
    {
...
LABEL_5:
  if ( *(_QWORD *)(a1 + 24) )
    RtlClearBitsEx((__int64)&qword_140C4E510, v7, v4);
