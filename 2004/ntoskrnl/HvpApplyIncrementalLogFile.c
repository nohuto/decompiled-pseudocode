/*
 * XREFs of HvpApplyIncrementalLogFile @ 0x14087E1C0
 * Callers:
 *     HvApplyLogFile @ 0x14087E0CC (HvApplyLogFile.c)
 * Callees:
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     SymCryptMarvin32 @ 0x1403E8628 (SymCryptMarvin32.c)
  ...
  *(_QWORD *)&v25.L.AllocateMisses = a5;
  ...
  while ( 1 )
  {
    ...
    if ( !(unsigned __int8)HvpIsLogEntryHeaderCoherent(&v25.L.48, v17, v24) || HIDWORD(v25.L.Free) != a2 )
      goto LABEL_17;
    result = HvpRecoverDataReadRoutine(v13, v17, SHIDWORD(v25.L.Allocate), &v25);
    if ( (int)result < 0 )
      break;
