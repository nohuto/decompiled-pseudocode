/*
 * XREFs of PfSnGetSectionObject @ 0x140604F18
 * Callers:
 ...
 *     PfSnIsSectionPrefetchedAfterPhase @ 0x1406052C4 (PfSnIsSectionPrefetchedAfterPhase.c)
  ...
  if ( (*(_QWORD *)(v19 + 24) & 0x400000000LL) == 0 )
  {
    ...
    if ( v20 < 0
      || (v20 = PfpFileCheckAttributesForPrefetch(
                  ...
                  (((dword_140C500B0 & 0x10) == 0) << 14) + 4864),
          v20 < 0) )
    {
