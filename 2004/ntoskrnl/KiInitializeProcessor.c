/*
 * XREFs of KiInitializeProcessor @ 0x14099B800
 * Callers:
 ...
 *     KiInitializeDpcList @ 0x140360DA4 (KiInitializeDpcList.c)
 *     KeInitializeThreadedDpc @ 0x1403B1060 (KeInitializeThreadedDpc.c)
