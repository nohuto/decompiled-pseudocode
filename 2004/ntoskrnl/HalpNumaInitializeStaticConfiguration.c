/*
 * XREFs of HalpNumaInitializeStaticConfiguration @ 0x140A5B560
 * Callers:
 ...
 *     HalpGetAvailableProximityId @ 0x140A8A2B0 (HalpGetAvailableProximityId.c)
 *     HalpGetNumaProcMemoryCount @ 0x140A8A33C (HalpGetNumaProcMemoryCount.c)
 *     HalpUpdateConfigurationFromMsct @ 0x140A8A75C (HalpUpdateConfigurationFromMsct.c)
 *     HalpVerifySratEntryLengthAndFlag @ 0x140A8AB20 (HalpVerifySratEntryLengthAndFlag.c)
 */
