/*
 * XREFs of PoClearTransitionMarker @ 0x140783274
 * Callers:
...
__int64 (__fastcall *PoClearTransitionMarker())(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD)
{
  ...
  xmmword_140C50398 = 0LL;
  PopBsdPowerTransitionExtension = 0LL;
  xmmword_140C50558 = 0LL;
  HIDWORD(xmmword_140C50398) = MEMORY[0xFFFFF780000002C4];
  ...
  *(_QWORD *)&xmmword_140C50398 = MEMORY[0xFFFFF78000000014];
  v1 = RtlComputeCrc32(0, (char *)&xmmword_140C50398, 8u);
  BYTE14(PopBsdPowerTransition) &= ~0x10u;
  DWORD2(xmmword_140C50398) = v1;
