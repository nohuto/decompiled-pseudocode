/*
 * XREFs of PfpEventHandleFullBuffer @ 0x1403435D0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall PfpEventHandleFullBuffer(struct _SLIST_ENTRY *a1)
{
  ...
  {
    result = LOWORD(stru_140C4FBA0.Alignment);
    if ( LOWORD(stru_140C4FBA0.Alignment) >= (((_DWORD)KeNumberProcessors_0 + 2) & 0x7FFFFFFFu) )
