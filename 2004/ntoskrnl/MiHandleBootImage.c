/*
 * XREFs of MiHandleBootImage @ 0x140A47F38
 * Callers:
 ...
 *     MiGetBootImagePageProtection @ 0x140A481B4 (MiGetBootImagePageProtection.c)
 ...
 *     MiBootImageRelocated @ 0x140A90010 (MiBootImageRelocated.c)
...
__int64 __fastcall MiHandleBootImage(int a1, __int64 a2, __int64 a3)
{
  ...
  v3 = 1;
  v4 = *(_QWORD *)(a2 + 48);
  v6 = ((unsigned int)dword_140C4CAB0 >> 12) + ((dword_140C4CAB0 & 0xFFF) != 0);
  LODWORD(v23) = dword_140C4CA4C;
