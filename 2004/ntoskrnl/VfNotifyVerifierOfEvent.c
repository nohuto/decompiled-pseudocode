/*
 * XREFs of VfNotifyVerifierOfEvent @ 0x1409C3040
 * Callers:
 ...
 *     VfStartBranchTracing @ 0x1409D551C (VfStartBranchTracing.c)
 *     VfStopBranchTracing @ 0x1409D55A8 (VfStopBranchTracing.c)
 */
