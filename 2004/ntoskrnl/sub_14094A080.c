/*
 * XREFs of sub_14094A080 @ 0x14094A080
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14094A080(__int64 a1, _DWORD *a2, _DWORD *a3, unsigned int a4, _DWORD *a5, _BYTE *a6)
{
  _DWORD *v8; // rbx
  ...
  v35 = 0LL;
  v36 = 0LL;
  if ( !*(_QWORD *)a1 && *(_QWORD *)(a1 + 37456) )
  {
    v10 = (signed __int64 *)(a1 + 37648);
    ExAcquirePushLockSharedEx(a1 + 37648, 0LL);
    v11 = *(_QWORD *)(a1 + 37640);
    v12 = v11 == 0;
...
LABEL_37:
  ...
  if ( v39 )
  {
    v26 = a5;
    *a6 = 1;
    return (unsigned int)sub_140949EDC(v8, a3, a4, v26, 0);
  }
  else
  {
    v25 = -1073741772;
