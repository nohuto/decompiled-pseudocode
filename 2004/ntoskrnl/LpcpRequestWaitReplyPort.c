/*
 * XREFs of LpcpRequestWaitReplyPort @ 0x1408BE9DC
 * Callers:
 *     LpcRequestWaitReplyPort @ 0x1408BE690 (LpcRequestWaitReplyPort.c)
 *     LpcRequestWaitReplyPortEx @ 0x1408BE6B0 (LpcRequestWaitReplyPortEx.c)
 * Callees:
