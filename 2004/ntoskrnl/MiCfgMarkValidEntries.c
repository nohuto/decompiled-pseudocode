/*
 * XREFs of MiCfgMarkValidEntries @ 0x140607044
 * Callers:
 ...
 *     MiIsProcessCfgExportSuppressionEnabled @ 0x14025362C (MiIsProcessCfgExportSuppressionEnabled.c)
 *     CfgAddressToBitState @ 0x140253678 (CfgAddressToBitState.c)
 *     MiGetProtoPteAddress @ 0x14029A830 (MiGetProtoPteAddress.c)
 *     MiUnlockAndDereferenceVad @ 0x1402AD420 (MiUnlockAndDereferenceVad.c)
 *     MiSelectCfgBitMap @ 0x140602298 (MiSelectCfgBitMap.c)
...
LABEL_14:
         ...
         v30 == a9)) )
  {
    ...
    LODWORD(v31) = v12;
    *((_QWORD *)&v31 + 1) = a4;
    v24 = MiPopulateCfgBitMap(v14, (unsigned int)&v31, v21, 1, a2, (v23 + 4095) & 0xFFFFFFFFFFFFF000uLL);
    if ( v24 >= 0 )
      v24 = 0;
  }
  else
