 ...
 *     AslpFileHasSecuromWrapper @ 0x140968498 (AslpFileHasSecuromWrapper.c)
 *     AslpHasStarForceWrapper @ 0x14096890C (AslpHasStarForceWrapper.c)
