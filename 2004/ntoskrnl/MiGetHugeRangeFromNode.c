/*
 * XREFs of MiGetHugeRangeFromNode @ 0x14052D584
 * Callers:
...
__int64 __fastcall MiGetHugeRangeFromNode(_QWORD *a1, unsigned int a2, int a3)
{
  ...
  if ( v3 )
  {
    v7 = dword_140C4DD80[0];
    v8 = (unsigned int)dword_140C4DD80[0];
    v9 = (_QWORD *)(v3 + 16LL * a2 * dword_140C4DD80[0]);
    if ( a3 )
    {
      v10 = 0LL;
    }
    ...
    {
      v9 += (unsigned int)dword_140C4DD80[0];
      v10 = 1LL;
    }
    v11 = 0LL;
    SpinLock = a1 + 516;
...
LABEL_22:
    ...
    __writecr8(OldIrql);
    if ( v14 && a3 && (*(_DWORD *)(qword_140C4E470 + 8 * v14) & 0x3FFFF) == 1LL )
    {
      MiHugePageOperation(v4);
      KeAcquireInStackQueuedSpinLock(SpinLock, &LockHandle);
      *(_QWORD *)(qword_140C4E470 + 8 * v14) &= 0xFFFFFFFFFFFC0000uLL;
      KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
