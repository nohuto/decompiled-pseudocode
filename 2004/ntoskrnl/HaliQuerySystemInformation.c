/*
 * XREFs of HaliQuerySystemInformation @ 0x14098CF00
 * Callers:
 *     <none>
 * Callees:
 *     HalpGetPlatformTimerInformation @ 0x14035D8A4 (HalpGetPlatformTimerInformation.c)
 *     HalpQueryNumaRangeTableInformation @ 0x1403CB88C (HalpQueryNumaRangeTableInformation.c)
 *     HalpGetDisplayBiosInformation @ 0x1403CC350 (HalpGetDisplayBiosInformation.c)
 *     xKdEnumerateDebuggingDevices @ 0x1403CCE40 (xKdEnumerateDebuggingDevices.c)
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     memmove @ 0x140409FC0 (memmove.c)
 *     memset @ 0x14040A280 (memset.c)
 *     HalpTimerQueryWatchdogType @ 0x1404B1BD0 (HalpTimerQueryWatchdogType.c)
 *     HalpDpQueryMaxHotPlugMemoryAddress @ 0x1404B8E38 (HalpDpQueryMaxHotPlugMemoryAddress.c)
 *     HalpHvQueryHyperlaunchEntrypoint @ 0x1404CD10C (HalpHvQueryHyperlaunchEntrypoint.c)
 *     HalpQueryHeterogeneousMemoryAttributesInterface @ 0x14070BCBC (HalpQueryHeterogeneousMemoryAttributesInterface.c)
 *     HalpQueryPerDeviceMsiLimitInformation @ 0x14070BCD0 (HalpQueryPerDeviceMsiLimitInformation.c)
 *     xHalAllocatePmcCounterSet @ 0x140713BE0 (xHalAllocatePmcCounterSet.c)
 ...
 *     HalpGetProcessorBrandString @ 0x1407B5260 (HalpGetProcessorBrandString.c)
 ...
 *     HalpQuerySecondaryInterruptInformation @ 0x1407C1810 (HalpQuerySecondaryInterruptInformation.c)
 *     HalpDmaGetRemappingInformation @ 0x1407C1ED8 (HalpDmaGetRemappingInformation.c)
 *     HalpGetMcaLog @ 0x140861054 (HalpGetMcaLog.c)
 *     HalpQueryAcpiWakeAlarmSystemPowerState @ 0x140862D10 (HalpQueryAcpiWakeAlarmSystemPowerState.c)
 *     HalpAuditQueryResults @ 0x1408630C4 (HalpAuditQueryResults.c)
 ...
 *     HalpQueryChannelTopologyInformation @ 0x140A8AED8 (HalpQueryChannelTopologyInformation.c)
 */
