/*
 * XREFs of WdipSemAddContextEventToScenario @ 0x14079BEE8
 * Callers:
 *     WdipSemMergeScenarios @ 0x14079BE58 (WdipSemMergeScenarios.c)
 * Callees:
 *     WdipSemFastAllocate @ 0x1407765E0 (WdipSemFastAllocate.c)
 *     WdipSemMergeEvents @ 0x14079C03C (WdipSemMergeEvents.c)
 */
