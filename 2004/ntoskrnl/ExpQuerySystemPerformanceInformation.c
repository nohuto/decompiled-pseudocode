/*
 * XREFs of ExpQuerySystemPerformanceInformation @ 0x1406605D0
 * Callers:
 *     ExpQuerySystemInformation @ 0x14068F290 (ExpQuerySystemInformation.c)
 * Callees:
 *     MiFreePoolPagesLeft @ 0x14027C82C (MiFreePoolPagesLeft.c)
 *     MiMaximumCommitmentAvailable @ 0x14027C85C (MiMaximumCommitmentAvailable.c)
 ...
 *     MmGetSystemPageCounts @ 0x14027D30C (MmGetSystemPageCounts.c)
 ...
 *     ExQueryPoolUsage @ 0x14027D394 (ExQueryPoolUsage.c)
