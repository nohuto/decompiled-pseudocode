/*
 * XREFs of MiCombineCandidate @ 0x140367510
 * Callers:
...
__int64 __fastcall MiCombineCandidate(_QWORD *a1, char a2, __int128 *a3)
{
  ...
  if ( (BYTE2(v4) & 7u) <= 1 )
    return 0LL;
  v5 = *((_QWORD *)&v19 + 1);
  if ( *(_QWORD *)(qword_140C4E448 + 8 * ((*((_QWORD *)&v21 + 1) >> 39) & 0x3FFLL)) != *a1 && (a2 & 1) == 0 )
    return 0LL;
  if ( (unsigned int)MI_PFN_IS_PROTO(&v19)
    ...
    && (BYTE3(v21) & 0x20) != 0
    || byte_140C51E5E
    && _bittest64((const signed __int64 *)qword_140C52388, (unsigned __int64)((v7 + 0x58000000000LL) / 48) >> 9) )
  {
    return 0LL;
  }
  v8 = v20;
  ...
  v22 = v8;
  if ( (v8 & 1) != 0 || v8 && qword_140C4DD40 && (qword_140C4DD40 & v8) == 0 )
    return 0LL;
  v13 = (v8 >> 5) & 0x1F;
  if ( (_DWORD)v13 == 24
    || (_DWORD)v13 == 31
  ...
  if ( v14 >= 0xFFFF800000000000uLL )
    v15 = (unsigned __int8)byte_140C4F7C8[((v14 >> 39) & 0x1FF) - 256];
  else
    v15 = 0;
  ...
  if ( (unsigned __int8)((BYTE2(v21) & 7) - 2) > 1u || (_WORD)v21 )
  {
    ...
    if ( v16 == 1 && (v8 & 0x400) == 0 )
    {
      ...
      {
        v18 = v8;
        if ( qword_140C4DD40 && (v8 & 0x10) == 0 )
          v18 = v8 & ~qword_140C4DD40;
        if ( HIDWORD(v18) == 1 )
          return 0LL;
      }
