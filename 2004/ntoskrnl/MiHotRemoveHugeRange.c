/*
 * XREFs of MiHotRemoveHugeRange @ 0x14052D828
 * Callers:
...
void __fastcall MiHotRemoveHugeRange(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  v4 = a2 >> 18;
  v5 = (unsigned __int64 *)(qword_140C4E470 + 8 * v2);
...
LABEL_14:
  *(_QWORD *)(v6 + 424) -= v4;
  ...
  __writecr8(OldIrql);
  v20 = (void *)(qword_140C4E470 + 8 * v2);
  KeAcquireInStackQueuedSpinLock(&qword_140C4E480, &LockHandle);
  RtlClearBitsEx((__int64)&qword_140C4E460, v2, v4);
  if ( v4 )
    memset(v20, 0, 8 * v4);
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
