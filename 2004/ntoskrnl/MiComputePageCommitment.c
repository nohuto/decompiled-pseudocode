/*
 * XREFs of MiComputePageCommitment @ 0x140254480
 * Callers:
    ...
    do
    {
      ...
      do
      {
        ...
        if ( v20 )
        {
          ...
          if ( (v23 & 1) != 0 )
          {
            v29 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v35);
...
LABEL_57:
              CloneAddress = MiLocateCloneAddress(Process, v31);
                 ...
                 && !(unsigned int)MiIsPrototypePteVadLookup(v23, v14, v15, v23)
                 && !(unsigned __int8)MI_PROTO_FORMAT_COMBINED(v32) )
          {
            if ( qword_140C4DD40 && (v33 & 0x10) == 0 )
              v33 &= ~qword_140C4DD40;
            v31 = v33 >> 16;
            goto LABEL_57;
          }
