/*
 * XREFs of ObDuplicateObject @ 0x1405E96C0
 * Callers:
 *     NtDuplicateObject @ 0x1405E8200 (NtDuplicateObject.c)
 *     PspPropagateHandle @ 0x1406170AC (PspPropagateHandle.c)
 ...
 * Callees:
 *     ObpFilterOperation @ 0x14020367C (ObpFilterOperation.c)
 ...
 *     ObpPreInterceptHandleDuplicate @ 0x1406F1E80 (ObpPreInterceptHandleDuplicate.c)
 *     SeAuditHandleCreation @ 0x1406FFD94 (SeAuditHandleCreation.c)
 *     ObpIncrementHandleCount @ 0x1408D9A8C (ObpIncrementHandleCount.c)
  ...
  else
  {
    ...
    if ( a3 )
    {
      ...
      if ( v18 )
      {
        ...
        if ( (~v19 & v25) != 0 )
        {
          if ( (v17 & 8) != 0 || (v36 = v52, *(_UNKNOWN **)(v52 + 152) != &SeDefaultObjectMethod) )
          {
            v28 = v47;
            v29 = -1073741790;
            goto LABEL_29;
          ...
          SeCreateAccessState(v56, v57, v43, v36 + 76);
          v28 = v47;
          v27 = v56;
...
LABEL_65:
            ...
            else
            {
              if ( v27 )
              {
                ...
                {
                  v28 = v47 | 4;
                  LODWORD(v49) = *(_DWORD *)(*((_QWORD *)v27 + 9) + 28LL);
                }
              }
              v53[1] = v53;
              v53[0] = v53;
...
LABEL_34:
                ...
                if ( v32 )
                {
                  ...
                  if ( (v28 & 4) != 0 )
                  {
                    ...
                    v40 = SeAuditingWithTokenForSubcategory(123LL, v26);
                    v33 = PROCESS;
                    if ( v40 )
