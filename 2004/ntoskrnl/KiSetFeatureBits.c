/*
 * XREFs of KiSetFeatureBits @ 0x14099920C
 * Callers:
 ...
 *     HalIsHyperThreadingEnabled @ 0x1403A6120 (HalIsHyperThreadingEnabled.c)
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     KeBugCheckEx @ 0x1403F70D0 (KeBugCheckEx.c)
 *     HvlSetApicVirtualizationAvailable @ 0x1404ECAC8 (HvlSetApicVirtualizationAvailable.c)
 *     HvlSetHardwareMbecAvailable @ 0x1404ECAD8 (HvlSetHardwareMbecAvailable.c)
...
char __fastcall KiSetFeatureBits(__int64 a1)
{
  ...
  char v134; // r8
  unsigned int v136; // [rsp+30h] [rbp-78h]
  bool v137; // [rsp+38h] [rbp-70h]
  unsigned int v138; // [rsp+40h] [rbp-68h]
  int v139; // [rsp+44h] [rbp-64h]
  int v140; // [rsp+48h] [rbp-60h]
  __int16 v141; // [rsp+4Ch] [rbp-5Ch]
  unsigned int v142; // [rsp+50h] [rbp-58h]

  v2 = *(_BYTE *)(a1 + 64);
  v3 = *(_BYTE *)(a1 + 67);
  v4 = *(_BYTE *)(a1 + 141);
  v5 = (unsigned __int8)(v4 - 1) <= 1u;
  v137 = (unsigned __int8)(v4 - 1) <= 1u;
  if ( *(_DWORD *)(a1 + 36) )
  {
...
LABEL_6:
  ...
  if ( *(_BYTE *)(a1 + 141) == 1 )
    v33 |= 0x100000u;
  *(_DWORD *)(a1 + 212) = HIBYTE(v142);
  *(_DWORD *)(a1 + 232) = (v142 >> 5) & 0x7F8;
  v36 = 0;
  ...
  *(_WORD *)(a1 + 142) = 257;
  ...
  if ( (unsigned __int8)(v38 - 2) > 1u )
  {
    ...
    if ( v38 == 1 && v138 >= 0x80000008 )
    {
      ...
      *(_BYTE *)(a1 + 142) = 1 << v99;
      if ( v138 >= 0x8000001E && (v34 & 0x400000) != 0 )
      {
        _RAX = 2147483678LL;
        __asm { cpuid }
...
LABEL_27:
      *(_DWORD *)(a1 + 212) = _RDX;
      ...
      while ( (_WORD)_RBX );
      *(_BYTE *)(a1 + 142) = v46 / *(unsigned __int8 *)(a1 + 143);
      v39 = v136;
      v35 = 1;
    }
    else
    {
      ...
      {
        _BitScanReverse(&v114, 2 * BYTE2(v142) - 1);
        *(_BYTE *)(a1 + 143) = (1 << v114) / (unsigned int)*(unsigned __int8 *)(a1 + 142);
      }
    }
    v54 = v138;
  }
