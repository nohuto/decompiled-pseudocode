/*
 * XREFs of CmpWalkOneLevel @ 0x1405EC120
 * Callers:
...
LABEL_36:
    ...
    if ( *v49 == 26994 )
    {
      if ( (int)CmpFindSubKeyInRoot(v34, (__int64)v49, (int)a6, &v80) < 0 )
      {
        v35 = -1073741670;
        goto LABEL_85;
      }
...
LABEL_145:
    ...
    if ( *v49 != 26732 )
    {
      SubKeyInLeafWithStatus = CmpFindSubKeyInLeafWithStatus(v34, (__int64)v49, (unsigned __int16 *)a6, &v80, &v88);
...
LABEL_80:
    ...
    while ( 1 )
    {
      if ( v50 != *(_DWORD *)&v49[4 * v55 + 4] )
        goto LABEL_77;
      v61 = CmpDoCompareKeyName(v87, (const UNICODE_STRING *)a6, *(_DWORD *)&v49[4 * v55 + 2]);
      if ( v61 == 2 )
        break;
      if ( !v61 )
      {
