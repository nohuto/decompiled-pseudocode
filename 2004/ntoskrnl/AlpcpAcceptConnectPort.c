/*
 * XREFs of AlpcpAcceptConnectPort @ 0x14062A6A8
 * Callers:
...
LABEL_36:
  ...
  v26 = AlpcpLookupMessage((_DWORD)v25, DWORD2(v58), v59, v14, (__int64)&v47);
  if ( v26 < 0 )
  {
    if ( v25 )
...
LABEL_108:
          ...
          {
            inserted = AlpcpCaptureAttributes(v51, (unsigned int)v36, v61, v37, v70);
          }
          if ( inserted < 0
            || (ObfReferenceObject(v39), inserted = ObInsertObjectEx(v39, 0LL, 0, 0LL, (__int64)&v52), inserted < 0) )
          {
