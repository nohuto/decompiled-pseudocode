/*
 * XREFs of HalpDmaAllocateContiguousPagesFromContiguousPoolAtHighLevelV2 @ 0x1404C81A8
 * Callers:
 ...
 *     HalpDmaLinkContiguousTranslations @ 0x1404C2DE4 (HalpDmaLinkContiguousTranslations.c)
 */
