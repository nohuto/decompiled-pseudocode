/*
 * XREFs of MiEmptyPageAccessLog @ 0x14024BCD0
 * Callers:
...
void __fastcall MiEmptyPageAccessLog(PVOID *P)
{
  ...
  PVOID *v46; // rbx
  PVOID *i; // rcx
  PVOID *v48; // [rsp+30h] [rbp-58h]
  unsigned __int64 v49; // [rsp+38h] [rbp-50h]
      ...
      do
      {
        ...
        if ( v14 )
        {
          if ( v1 > 1 )
          {
            ...
            if ( v14 == v2 )
            {
              v7 += (__int64)(v18 - v11) >> 3 << 12 << *(&v52 + ((v7 >> 10) & 1));
            }
            else
            {
              ...
              v2 = v14;
              v23 = v22 << *((_BYTE *)&v52 + 4 * ((v4 >> 10) & 1));
              HIDWORD(v54) = HIDWORD(v23);
              LODWORD(v54) = v14 | v4 & 0x400 | v23 & 0xFFFFFA00;
              v7 = v54;
            }
            v3 = Pa;
            v11 = v18;
  ...
  do
  {
    ...
    if ( v29 )
    {
      ...
      if ( BugCheckParameter4 <= 0 )
      {
        ...
        ObpDeferObjectDeletion(v30 - 48, v38);
      }
LABEL_29:
      if ( v30 )
        goto LABEL_30;
