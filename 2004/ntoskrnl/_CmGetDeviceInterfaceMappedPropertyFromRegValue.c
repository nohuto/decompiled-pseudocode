/*
 * XREFs of _CmGetDeviceInterfaceMappedPropertyFromRegValue @ 0x1406BE310
 * Callers:
 *     _CmGetDeviceInterfaceMappedProperty @ 0x1406C00E8 (_CmGetDeviceInterfaceMappedProperty.c)
 *     _CmGetDeviceInterfaceMappedPropertyKeys @ 0x14071BF80 (_CmGetDeviceInterfaceMappedPropertyKeys.c)
 * Callees:
...
LABEL_6:
  ...
  v10 = *(_QWORD *)a4 - *(_QWORD *)&v19->fmtid.Data1;
  if ( *(_QWORD *)a4 == *(_QWORD *)&v19->fmtid.Data1 )
    v10 = *(_QWORD *)(a4 + 8) - *(_QWORD *)v19->fmtid.Data4;
  if ( v10 )
  {
    v10 = 0LL;
    goto LABEL_6;
...
LABEL_11:
  ...
  if ( a3 )
    goto LABEL_15;
  v21 = CmOpenDeviceInterfaceRegKey(a1, (_DWORD)a2, 48, (_DWORD)v19, 1, v10, (__int64)v34, v10);
  v10 = 0LL;
...
LABEL_15:
    ...
    if ( v22 == 2 )
    {
      ...
      if ( a1 )
        v10 = *(_QWORD *)(a1 + 224);
      v29 = SysCtxRegOpenKey(v10, (__int64)v28, (__int64)L"Device Parameters", 0, 1u, (__int64)&v32);
