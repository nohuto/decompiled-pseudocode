/*
 * XREFs of MiUpdatePageFileList @ 0x1403BCDD8
 * Callers:
...
void __fastcall MiUpdatePageFileList(__int64 a1, int a2)
{
  ...
  v5 = ExAcquireSpinLockExclusive(&dword_140C4EAB8);
  if ( !a2 )
  {
    RtlAvlRemoveNode((unsigned __int64 *)&qword_140C4EAB0, v4);
    goto LABEL_5;
  }
  v6 = *(_QWORD *)(a1 + 56);
  *(_WORD *)(a1 + 204) |= 0x100u;
  v7 = 0;
  v8 = (_QWORD *)qword_140C4EAB0;
  if ( !qword_140C4EAB0 )
    goto LABEL_4;
  while ( v6 < *(v8 - 25) )
  {
...
LABEL_10:
  ...
  v7 = 1;
LABEL_4:
  RtlAvlInsertNodeEx((unsigned __int64 *)&qword_140C4EAB0, (unsigned __int64)v8, v7, v4);
LABEL_5:
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C4EAB8);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
