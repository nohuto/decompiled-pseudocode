/*
 * XREFs of PspSetupUserProcessAddressSpace @ 0x14065D2E4
 * Callers:
 ...
 *     PspWow64SetupUserProcessAddressSpace @ 0x14027C054 (PspWow64SetupUserProcessAddressSpace.c)
...
__int64 __fastcall PspSetupUserProcessAddressSpace(struct _KPROCESS *a1, _KPROCESS *a2, __int64 a3, __int64 a4)
{
  void **v5; // r15
  unsigned int *v8; // rbp
  int v10; // ecx
