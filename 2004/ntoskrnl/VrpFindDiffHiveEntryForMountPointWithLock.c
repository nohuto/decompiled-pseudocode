/*
 * XREFs of VrpFindDiffHiveEntryForMountPointWithLock @ 0x1405CD250
 * Callers:
...
__int64 __fastcall VrpFindDiffHiveEntryForMountPointWithLock(PCUNICODE_STRING String1)
{
  ...
  v7 = -1LL << (dword_140C477C4 & 0x1F);
  v8 = v5 & v7;
  if ( (unsigned int)dword_140C477C4 >> 5 )
  {
    v13 = v5 & v7;
    v9 = qword_140C477C8
       + 8LL
       * ((37
         * (BYTE6(v13)
         ...
         + HIBYTE(v13)) & (((unsigned int)dword_140C477C4 >> 5) - 1));
    while ( 1 )
    {
      v9 = *(_QWORD *)v9;
      if ( (v9 & 1) != 0 )
