/*
 * XREFs of EtwpDeleteRegistrationObject @ 0x14066FF90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EtwpDeleteRegistrationObject(__int64 *BugCheckParameter2)
{
  ...
  void *v20; // r14
  __int64 v21; // rax
  volatile signed __int32 *v22; // rbp
...
LABEL_10:
  ...
  if ( (v13 & 2) != 0 )
  {
    ...
    do
    {
      v15 = _InterlockedExchange64(v14, 0LL);
      if ( v15 )
      {
        v24 = *(_QWORD *)(v15 + 32);
        ...
        EtwpReleaseQueueEntry((PADAPTER_OBJECT *)v15, 2);
      }
      ++v14;
      --v2;
    }
  ...
  else
  {
    ...
    if ( v21 )
    {
      ...
      do
      {
        v26 = (volatile signed __int32 **)v23;
