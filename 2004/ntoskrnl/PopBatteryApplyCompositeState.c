...
__int64 __fastcall PopBatteryApplyCompositeState(_DWORD *a1, int a2)
{
  ...
  if ( byte_140C23118 )
  {
    ...
    v28 = 0LL;
    v6 = 0LL;
    while ( (__int64 *)v27 != &qword_140C23120 )
    {
      v29 = *(_DWORD *)(v27 + 104);
      if ( v29 == 2 )
      {
    ...
    if ( PopCachedValidBatteryCount == -1 || PopCachedValidBatteryCount != dword_140C23114 )
    {
      ...
      PopDiagTraceBatteryCountChange((unsigned int)dword_140C23114, v6, v28, &qword_140C23120);
    }
    v43 = 1;
  }
  ...
  do
  {
    ...
    if ( (unsigned __int8)PopBatteryCheckTrigger(v18) )
    {
      if ( PopBatteryCachedFlags[v15] != v17 )
      {
        ...
        v12 = v44;
        if ( dword_140C2322C[6 * v44] == 128 )
        {
          PopDiagTraceBatteryTriggerMet(0x140000000LL + 24LL * v44 + 12726824, (char *)PopPolicy + 24 * v44 + 96, &v44);
          v12 = v44;
        }
      }
      if ( !byte_140C23220 )
  ...
  if ( dword_140C23114 )
  {
    ...
    LOBYTE(v24) = byte_140C23288 != 0 || (unk_140C23140 & 2) != 0;
  ...
  if ( v46 )
  {
    ...
    if ( dword_140C2328C == -1 )
      v35 = (MEMORY[0xFFFFF78000000008] - qword_140C23290 + 5000) / 0x2710uLL;
    if ( PopPlatformAoAc )
    {
