/*
 * XREFs of HalpIommuBlockDevice @ 0x1404C3F70
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( a1 )
  {
    ...
    if ( *(_DWORD *)v4 != 1
      || (ExAcquirePushLockExclusiveEx((ULONG_PTR)&HalpDeviceBlockUnblockPushLock, 0LL),
          v2 = 1,
          v7 = HalpIommuDecreaseAliasTrack((__int64)v4, &v22),
          v7 < 0)
      || *(__int64 *)(v22 + 24) <= 0 )
    {
...
LABEL_28:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, (__int64)&HalpDeviceBlockUnblockPushLock, &v21);
