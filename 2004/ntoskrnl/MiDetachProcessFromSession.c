/*
 * XREFs of MiDetachProcessFromSession @ 0x140345418
 * Callers:
...
__int64 __fastcall MiDetachProcessFromSession(int a1)
{
  ...
  v2 = (unsigned __int64 *)(8 * (((unsigned __int64)qword_140C4DBE0 >> 39) & 0x1FF) - 0x90482413000LL);
...
LABEL_2:
  *v2 = v3;
  ...
  if ( a1 == 1 )
  {
    v7 = *(_QWORD *)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(v6 + 430));
