/*
 * XREFs of KseDriverUnloadImage @ 0x140760764
 * Callers:
    ...
    if ( v9 )
    {
      do
      {
        ...
        if ( !*((_DWORD *)v13 + 6) )
        {
          ...
          dword_140C2A844[2 * v14] = -1073740768;
          KsepHistoryErrors[2 * v14] = 460173;
    ...
    *(_QWORD *)(v19 + 8) = v20;
    ...
    if ( *v8 )
    {
      ...
      do
      {
        ...
        v25 = *(struct _DMA_ADAPTER **)(v24 + 32);
        if ( v25 )
        ...
        if ( (*(_DWORD *)(v24 + 28) & 4) != 0 && !*(_DWORD *)(v24 + 24) )
        {
          ...
          LODWORD(KsepHistoryMessages[v26]) = 460230;
    ...
    LODWORD(KsepHistoryMessages[v28]) = 460238;
    if ( (KsepDebugFlag & 1) != 0 )
