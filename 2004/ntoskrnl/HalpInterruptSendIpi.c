/*
 * XREFs of HalpInterruptSendIpi @ 0x1402150D0
 * Callers:
 ...
 *     HalRequestDeferredRecoveryServiceInterrupt @ 0x1404B8E50 (HalRequestDeferredRecoveryServiceInterrupt.c)
 * Callees:
...
LABEL_7:
      ...
      else
      {
        ...
        if ( (unsigned __int16)HalpInterruptPhysicalTargets >= *(_WORD *)v5 )
          v11 = *(_WORD *)v5;
        v51 = v11;
        for ( i = 0; i < v51; *(_QWORD *)&v52[4 * v13 + 3] = qword_140C4B848[v13] & v5[v13 + 1] )
          v13 = i++;
        v52[0] = 20;
        *(_DWORD *)&v52[1] = 0;
        if ( i < 0x14u )
