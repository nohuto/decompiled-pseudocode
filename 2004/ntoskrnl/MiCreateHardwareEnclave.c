/*
 * XREFs of MiCreateHardwareEnclave @ 0x1408CF2D0
 * Callers:
...
__int64 __fastcall MiCreateHardwareEnclave(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4, _DWORD *a5)
{
  ...
  if ( !ExAcquireRundownProtection_0((PEX_RUNDOWN_REF)&stru_140C4ECC0) )
    return 3221225738LL;
    ...
    *(_QWORD *)v17 = ValidPte;
    ...
    if ( v13 >= 0 )
    {
      ...
      *(_QWORD *)(a2 + 112) = Process;
      ...
      v27 = (_QWORD *)qword_140C4ECB0;
      v28 = (_QWORD *)(a2 + 120);
      if ( *(__int64 **)qword_140C4ECB0 != &qword_140C4ECA8 )
        __fastfail(3u);
      *v28 = &qword_140C4ECA8;
      v28[1] = v27;
      *v27 = v28;
      qword_140C4ECB0 = (__int64)v28;
...
LABEL_32:
  ExReleaseRundownProtection_0((PEX_RUNDOWN_REF)&stru_140C4ECC0);
