/*
 * XREFs of CcExtendVacbArray @ 0x14034FAB0
 * Callers:
 ...
 *     VacbLevelReference @ 0x1402C5410 (VacbLevelReference.c)
...
__int64 __fastcall CcExtendVacbArray(__int64 a1, __int64 a2)
{
  ...
  _DWORD *v33; // rax
  __int64 v34; // rdx
  _QWORD v35[3]; // [rsp+20h] [rbp-48h] BYREF
  int v36; // [rsp+38h] [rbp-30h]
  int v37; // [rsp+3Ch] [rbp-2Ch]
...
LABEL_48:
    ...
    if ( CcAllocateVacbLevels(v24 - v22, 0, (__int64)v35) )
    {
      CcAcquireBcbLockAndVacbLock(v2, (struct _FAST_MUTEX *)a1);
      if ( v22 == 1 )
        CcCalculateVacbLevelLockCount(a1, *(_QWORD *)(a1 + 88));
      v28 = *(_QWORD **)(a1 + 88);
      if ( *(_QWORD *)VacbLevelReference(a1, (__int64)v28, v22 - 1) )
      {
        do
        {
          ++v22;
          VacbLevel = (_QWORD *)CcAllocateVacbLevel(v35, 0LL, v29);
          *VacbLevel = *(_QWORD *)(a1 + 88);
          v33 = (_DWORD *)VacbLevelReference(a1, (__int64)VacbLevel, v22);
          ++*v33;
          *(_QWORD *)(a1 + 88) = v34;
        }
        while ( v22 < v24 );
      ...
      {
        *(_QWORD *)(a1 + 88) = CcAllocateVacbLevel(v35, 0LL, v29);
        v30 = v28[128];
        v31 = (_QWORD *)v28[255];
        *(_QWORD *)(v30 + 8) = v31;
        *v31 = v30;
      ...
      *(_QWORD *)(a1 + 32) = a2;
      CcReleaseBcbLockAndVacbLock(v2, (struct _FAST_MUTEX *)a1);
      goto LABEL_48;
    }
    return 3221225626LL;
  }
  ...
  if ( PoolWithTag )
  {
    ...
    if ( v12 )
      ...
      v6 = 0;
    memset(&PoolWithTag[v6], 0, v38 - v6);
    if ( a2 >= 0x2000000 )
    ...
    if ( v2 )
    {
      ...
      if ( *(__int64 *)(a1 + 32) > 0x200000 && v12 )
      {
        ...
        while ( 1 )
        {
          ...
          *(_QWORD *)v15 = v17;
          v14 += 0x80000LL;
          *(_QWORD *)&PoolWithTag[v38 - (unsigned __int64)v6 - (_QWORD)v12 + 8 + (_QWORD)v16] = v18;
          v16 += 16;
          *v18 = v15;
          *(_QWORD *)(v17 + 8) = v15;
          v15 += 16;
