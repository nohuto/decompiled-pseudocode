/*
 * XREFs of MiCombineIdenticalPages @ 0x140714C54
 * Callers:
 *     MmCombineIdenticalPages @ 0x140714C04 (MmCombineIdenticalPages.c)
 *     MmManagePartitionCombineMemory @ 0x1408D8268 (MmManagePartitionCombineMemory.c)
 * Callees:
...
LABEL_14:
      ...
      KiStackAttachProcess((_KPROCESS *)v21, 0LL, (__int64)v31);
    }
    ...
    if ( (a3 & 1) == 0 || v23 == &MiSystemPartition )
    {
      ...
      v22[0] = 0;
      v22[1] = -1;
      v25[0] = qword_140C4EB98;
      v25[1] = qword_140C4EBA0;
      v28[5] = v25;
      v28[6] = v22;
      v28[2] = v27;
      v28[3] = &v29;
