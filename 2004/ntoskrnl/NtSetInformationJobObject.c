/*
 * XREFs of NtSetInformationJobObject @ 0x14061AF00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     wcsnlen @ 0x1403D0AD0 (wcsnlen.c)
 *     memmove @ 0x140409FC0 (memmove.c)
 *     memset @ 0x14040A280 (memset.c)
 *     KeAddGroupAffinityEx @ 0x14050E090 (KeAddGroupAffinityEx.c)
 ...
 *     IoAllocateMiniCompletionPacket @ 0x14060EE00 (IoAllocateMiniCompletionPacket.c)
 *     PspUnlockJobChain @ 0x140617CD4 (PspUnlockJobChain.c)
 *     PspLockJobChain @ 0x140617D5C (PspLockJobChain.c)
 *     PspNotificationLimitRateControlToleranceIntervalField @ 0x14061C954 (PspNotificationLimitRateControlToleranceIntervalField.c)
 *     PspNotificationLimitRateControlToleranceField @ 0x14061C97C (PspNotificationLimitRateControlToleranceField.c)
 *     PspUnlockJobMemoryLimitsExclusive @ 0x14061C9A4 (PspUnlockJobMemoryLimitsExclusive.c)
 *     PspRateControlLimitFlag @ 0x14061C9FC (PspRateControlLimitFlag.c)
 ...
 *     PspGetJobMemoryUsageNotificationViolations @ 0x1406EACB8 (PspGetJobMemoryUsageNotificationViolations.c)
 ...
 *     PspGetJobLimitInformationValidFlags @ 0x140706448 (PspGetJobLimitInformationValidFlags.c)
 ...
 *     PspSetJobSiloThreadImpersonationPolicy @ 0x140906464 (PspSetJobSiloThreadImpersonationPolicy.c)
        ...
        ULONG JobObjectInformationLength)
{
  ...
  __int64 v153; // [rsp+B0h] [rbp-B18h] BYREF
...
LABEL_6:
  ...
  if ( PreviousMode )
  {
    ...
    if ( (_DWORD)v4 )
    {
      if ( ((dword_140982BEC[v5] - 1) & (unsigned int)Src) != 0 )
...
LABEL_208:
                  ...
                  v129 = (__int64)v14;
LABEL_209:
                  PspUnlockJobChain(v129, (__int64)v128, 0);
                  goto LABEL_35;
                }
              }
              else if ( (v72 & 0x20) == 0 )
...
LABEL_315:
        ...
        if ( (unsigned __int8)PspDoesJobHierarchyPermitUILimits((__int64)v14) )
        {
          ...
          else
          {
            ...
            v180 = 0;
            v182 = v150;
            v13 = PsInvokeWin32Callout(6, (__int64)&v179, 1, (__int64)&v154);
            v136 = v13;
            if ( v13 >= 0 )
            {
LABEL_247:
...
LABEL_446:
    ...
    else
    {
      ...
      {
        v14 = (char *)DeferredContext;
        v13 = PspSetJobIoRateControl((__int64)DeferredContext, (__int64)v190);
        goto LABEL_278;
      }
      v13 = -1073741790;
    }
