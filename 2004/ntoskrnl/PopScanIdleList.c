/*
 * XREFs of PopScanIdleList @ 0x1402DCEA0
 * Callers:
...
__int64 __fastcall PopScanIdleList(int a1, unsigned __int64 a2)
{
  ...
  else
  {
      ...
      do
      {
        ...
        *((_DWORD *)v13 - 5) += v16;
        ...
        if ( PopDiagHandleRegistered )
        {
          ...
          {
            DeviceAttachmentBaseRefWithTag = IoGetDeviceAttachmentBaseRefWithTag(v15[3], 0x67446F50u);
    ...
    if ( !v5 || (_BYTE)v2 )
    {
      ...
      if ( !PopBackgroundTaskIgnoreCount && !dword_140C238AC && PopSIdle >= 50 && PopBackgroundTaskAllowed )
      {
