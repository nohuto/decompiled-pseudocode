/*
 * XREFs of MmGetSessionIdEx @ 0x140207F90
 * Callers:
 ...
 *     IoGetRequestorSessionId @ 0x14035FCA0 (IoGetRequestorSessionId.c)
 ...
 *     KeRemoveSystemServiceTable @ 0x1408B7CB0 (KeRemoveSystemServiceTable.c)
