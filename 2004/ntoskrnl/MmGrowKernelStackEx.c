/*
 * XREFs of MmGrowKernelStackEx @ 0x140359230
 * Callers:
 ...
 *     MmGrowKernelStack @ 0x1405311E0 (MmGrowKernelStack.c)
 * Callees:
...
__int64 __fastcall MmGrowKernelStackEx(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(CurrentThread + 56) - (*(_QWORD *)(*(_QWORD *)(CurrentThread + 40) + 8LL) & 0xFFFFFFFFFFFFFFFEuLL) < 0x12000 )
    return 3221225659LL;
  v3 = 0;
  v4 = *(_QWORD *)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(CurrentThread + 544) + 1838LL));
  ...
  if ( v6 < ((*(_QWORD *)(CurrentThread + 48) >> 9) & 0x7FFFFFFFF8uLL) - 0x98000000000LL )
  {
    ...
    else
    {
      ...
      {
        v8 = MI_GET_NODE_FROM_VALID_PTE(((*(_QWORD *)(CurrentThread + 56) >> 9) & 0x7FFFFFFFF8LL) - 0x98000000008LL);
        if ( (unsigned int)MiAllocateKernelStackPages(v4, v6, v7, CurrentThread | 1, v8, 2) )
        {
