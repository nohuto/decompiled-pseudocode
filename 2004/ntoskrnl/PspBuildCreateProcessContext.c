/*
 * XREFs of PspBuildCreateProcessContext @ 0x1406B1BF4
 * Callers:
 ...
 *     IsTrustletCreateAttributeWellFormed @ 0x14057D5EC (IsTrustletCreateAttributeWellFormed.c)
 ...
 *     RtlValidProcessProtection @ 0x140711000 (RtlValidProcessProtection.c)
...
__int64 __fastcall PspBuildCreateProcessContext(unsigned __int64 *a1, char a2, int a3, __int64 a4)
{
  ...
  unsigned __int64 v147; // [rsp+168h] [rbp-110h]
  int v148; // [rsp+170h] [rbp-108h]
  char *v149; // [rsp+180h] [rbp-F8h]
  const void *v150; // [rsp+188h] [rbp-F0h]
  char *v151; // [rsp+190h] [rbp-E8h]
  char *v152; // [rsp+198h] [rbp-E0h]
  unsigned __int64 v153; // [rsp+1A0h] [rbp-D8h]
  unsigned __int64 v154; // [rsp+1A8h] [rbp-D0h]
  __int128 v155; // [rsp+1B0h] [rbp-C8h] BYREF
  __int64 v156; // [rsp+1C0h] [rbp-B8h]
  __int128 v157; // [rsp+1D0h] [rbp-A8h] BYREF
  __int64 v158; // [rsp+1E0h] [rbp-98h]
  __int128 v159; // [rsp+1F0h] [rbp-88h] BYREF
  __int64 v160; // [rsp+200h] [rbp-78h]
  __int128 v161; // [rsp+208h] [rbp-70h] BYREF
  __int64 v162; // [rsp+218h] [rbp-60h]
  int v164; // [rsp+290h] [rbp+18h]
...
LABEL_17:
          ...
          if ( (unsigned __int64)(UmsContextExtendedSize - 1) > 0xFFFE )
          {
            if ( UmsContextExtendedSize )
            {
              if ( (v110 & 3) != 0 )
                ExRaiseDatatypeMisalignment();
              if ( v110 + UmsContextExtendedSize > v109 || v110 + UmsContextExtendedSize < v110 )
                MEMORY[0x7FFFFFFF0000] = 0;
            }
          }
          else if ( (v110 & 3) != 0 )
          ...
          if ( v103 )
          {
            ...
            if ( v104 )
            {
              ...
              if ( !v105 )
              {
                if ( v11[1] != 1LL )
                  goto LABEL_17;
                v106.Level = *((_BYTE *)v11 + 16);
                *(PS_PROTECTION *)(a4 + 384) = v106;
                valid = RtlValidProcessProtection(v106);
                goto LABEL_189;
              }
              if ( v105 != 9 || v11[1] != 1LL )
                goto LABEL_17;
      ...
      else
      {
        ...
        if ( !v61 )
        {
          ...
          if ( v4 )
          {
            if ( (v96 & 3) != 0 )
              ExRaiseDatatypeMisalignment();
            if ( v96 + 8 > 0x7FFFFFFF0000LL || v96 + 8 < v96 )
              MEMORY[0x7FFFFFFF0000] = 0;
          }
          ...
          *PoolWithQuotaTag = *(_QWORD *)v96;
          v98 = *(_DWORD **)(a4 + 472);
          if ( (*v98 & 3) == 0 || (unsigned int)(v98[1] - 1) > 5 )
            goto LABEL_17;
          goto LABEL_247;
        }
        v62 = v61 - 1;
        ...
        if ( v64 )
        {
          ...
          if ( !v65 )
          {
            ...
            memmove(&v161, (const void *)v72, v71);
            v73 = v161;
            v157 = v161;
            v74 = v162;
            v158 = v162;
            v14 = PspValidateMitigationAuditOptions(&v157);
            if ( v14 < 0 )
              goto LABEL_306;
            *(_OWORD *)(a4 + 488) = v73;
            *(_QWORD *)(a4 + 504) = v74;
...
LABEL_158:
      ...
      if ( !v40 )
      {
        ...
        memmove(&v159, (const void *)v53, v52);
        v54 = v159;
        v155 = v159;
        v55 = v160;
        v156 = v160;
        v14 = PspValidateMitigationOptions(&v155, 0LL);
        if ( v14 < 0 )
          goto LABEL_306;
        *(_OWORD *)(a4 + 360) = v54;
        *(_QWORD *)(a4 + 376) = v55;
      ...
      if ( !v42 )
      {
        ...
        *(_DWORD *)(a4 + 412) = v44 >> 3;
        ...
        for ( i = 0LL; i < *(unsigned int *)(a4 + 412); ++i )
        {
          ...
          if ( v14 < 0 )
            goto LABEL_306;
          *(_QWORD *)(*(_QWORD *)(a4 + 400) + 8 * v47) = v132;
          v47 = i + 1;
          v133 = i + 1;
        }
LABEL_246:
