...
__int64 __fastcall PspBuildCreateProcessContext(unsigned __int64 *a1, char a2, int a3, __int64 a4)
{
  ...
  _DWORD *v98; // rcx
  struct _PROCESSOR_NUMBER *v99; // rax
  ...
  __int64 v110; // rax
  unsigned __int64 *v111; // [rsp+48h] [rbp-230h]
  ...
  struct _PROCESSOR_NUMBER *v140; // [rsp+130h] [rbp-148h]
...
LABEL_17:
      ...
      else
      {
        if ( v13 == 196622 )
        {
          if ( !a3 || v11[1] != 4 )
            goto LABEL_17;
          v99 = (struct _PROCESSOR_NUMBER *)v11[2];
          v140 = v99;
          if ( v4 )
          {
