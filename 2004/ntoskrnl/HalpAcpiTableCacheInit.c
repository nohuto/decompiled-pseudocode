/*
 * XREFs of HalpAcpiTableCacheInit @ 0x140A5BD10
 * Callers:
 *     HalpAcpiGetTable @ 0x140335770 (HalpAcpiGetTable.c)
 *     HalpSetupAcpiPhase0 @ 0x140A5B3A0 (HalpSetupAcpiPhase0.c)
 * Callees:
 *     HalpAcpiGetCachedTable @ 0x140335904 (HalpAcpiGetCachedTable.c)
 ...
 *     HalpAcpiCalculateCacheSizeForOverrideTables @ 0x140A89D30 (HalpAcpiCalculateCacheSizeForOverrideTables.c)
 */
...
__int64 __fastcall HalpAcpiTableCacheInit(__int64 a1)
{
  ...
  qword_140CDB348 = (__int64)&HalpAcpiTableCacheList;
