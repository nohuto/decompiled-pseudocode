/*
 * XREFs of PpmInstallNewIdleStates @ 0x1403C1340
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x1403C1320 (PpmIdleInstallDefaultStates.c)
 * Callees:
 ...
 *     PpmDeepestHardwareIdleState @ 0x1403C188C (PpmDeepestHardwareIdleState.c)
 *     PpmResetIdlePolicy @ 0x1403C18C8 (PpmResetIdlePolicy.c)
 *     PpmUpdateProcessorIdleAccounting @ 0x1403C1A58 (PpmUpdateProcessorIdleAccounting.c)
