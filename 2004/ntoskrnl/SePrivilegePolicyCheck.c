/*
 * XREFs of SePrivilegePolicyCheck @ 0x14026DA70
 * Callers:
...
__int64 __fastcall SePrivilegePolicyCheck(int *a1, _DWORD *a2, __int64 *a3, int a4, __int64 a5, char a6)
{
  unsigned int v6; // ebp
  char v7; // r13
  __int64 v8; // r14
  ...
  if ( (*a1 & 0x1000000) != 0 )
  {
    ...
    v24 = 0;
    if ( !(unsigned __int8)SepPrivilegeCheck(v8, (unsigned int)&v23, 1, 1, a6) )
      return 3221225569LL;
    *a1 &= ~0x1000000u;
    v11 = v19;
    *a2 |= 0x1000000u;
  ...
  v24 = 0;
  if ( (unsigned __int8)SepPrivilegeCheck(v8, (unsigned int)&v23, v16, v16, a6) )
  {
    *a1 &= ~0x80000u;
    ++v11;
    *a2 |= 0x80000u;
