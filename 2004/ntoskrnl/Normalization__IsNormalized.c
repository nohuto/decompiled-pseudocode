/*
 * XREFs of Normalization__IsNormalized @ 0x140914A14
 * Callers:
 *     RtlIsNormalizedString @ 0x140915AF0 (RtlIsNormalizedString.c)
 * Callees:
 *     CanComposeHangul @ 0x1405885CC (CanComposeHangul.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x140914478 (Normalization__CanCombinableCharactersCombine.c)
 *     Normalization__CanCombineWithStartBase @ 0x1409145DC (Normalization__CanCombineWithStartBase.c)
 *     Normalization__CanCombineWithStartFirstPair @ 0x140914628 (Normalization__CanCombineWithStartFirstPair.c)
 *     Normalization__GetLastChar @ 0x14091475C (Normalization__GetLastChar.c)
 */
