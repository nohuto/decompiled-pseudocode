/*
 * XREFs of Uart16550InitializePortCommon @ 0x1405C58D4
 * Callers:
 *     Uart16550InitializePort @ 0x1405C58B0 (Uart16550InitializePort.c)
 *     Uart16550LegacyInitializePort @ 0x1405C5990 (Uart16550LegacyInitializePort.c)
 *     Uart16550MmInitializePort @ 0x1405C5A00 (Uart16550MmInitializePort.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1403FFC70 (_guard_dispatch_icall.c)
 *     Uart16550SetBaud @ 0x1405C5BA0 (Uart16550SetBaud.c)
 *     UartpSetAccess @ 0x1405C647C (UartpSetAccess.c)
 */
