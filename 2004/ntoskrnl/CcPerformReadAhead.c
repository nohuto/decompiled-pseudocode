/*
 * XREFs of CcPerformReadAhead @ 0x140264AD4
 * Callers:
...
__int64 __fastcall CcPerformReadAhead(__int64 a1, __int64 a2)
{
  ...
  unsigned int v39; // [rsp+44h] [rbp-184h]
  ...
  unsigned int v58; // [rsp+D4h] [rbp-F4h]
  ...
  *(_QWORD *)v62 = 0LL;
  ...
  if ( v4 )
  {
    while ( 1 )
    {
      ...
      PsSetPagePriorityThread(v15, v39);
      LOBYTE(v17) = 1;
