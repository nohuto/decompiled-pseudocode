/*
 * XREFs of CcInitializeCacheMapEx @ 0x1402C05C0
 * Callers:
 *     CcInitializeCacheMap @ 0x14035F590 (CcInitializeCacheMap.c)
 * Callees:
...
LABEL_121:
    ...
    Partition = CcGetPartitionWithCreate(*(_QWORD *)(*(_QWORD *)(qword_140C4E448
                                                               + 8LL
