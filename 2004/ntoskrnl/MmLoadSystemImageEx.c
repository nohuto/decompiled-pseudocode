/*
 * XREFs of MmLoadSystemImageEx @ 0x14074603C
 * Callers:
 ...
 *     IopLoadCrashdmpImage @ 0x14077C660 (IopLoadCrashdmpImage.c)
 ...
 *     MiValidateStrongCodeDriverImage @ 0x140530354 (MiValidateStrongCodeDriverImage.c)
 ...
 *     MiRelocateAmount @ 0x1407C2814 (MiRelocateAmount.c)
...
LABEL_51:
  ...
  if ( (a4 & 1) == 0 )
  {
    _InterlockedExchangeAdd(&dword_140C4EDD0, v18);
    v15 = P;
    v48 = v50;
  }
  ...
  {
    _InterlockedExchangeAdd((_DWORD *)&xmmword_140C4CB48 + 3, -v18);
    v30 = v50;
    v27 = (void *)v29;
    v15 = P;
