/*
 * XREFs of HalpTimerQueryAndResetRtcErrors @ 0x14038AEA0
 * Callers:
 *     <none>
 * Callees:
...
bool __fastcall HalpTimerQueryAndResetRtcErrors(char a1)
{
  ...
  if ( a1 )
  {
    if ( (unsigned int)dword_140C02DF8 > 5 && tlgKeywordOn((__int64)&dword_140C02DF8, 0x400000000000LL) )
    {
      v13 = 0;
      v11 = &v8;
      v8 = v1;
      v12 = 4;
      tlgWriteEx_EtwWriteEx((__int64)&dword_140C02DF8, (unsigned __int8 *)&byte_140021819, v4, 1u, v6, v7, 3u, &v10);
    }
    v2 = 9;
  }
  else
  {
    if ( (unsigned int)dword_140C02DF8 > 5 && tlgKeywordOn((__int64)&dword_140C02DF8, 0x400000000000LL) )
    {
      ...
      v9 = v1;
      v16 = 4;
      tlgWriteEx_EtwWriteEx((__int64)&dword_140C02DF8, (unsigned __int8 *)&word_1400217DE, v5, 1u, v6, v7, 3u, &v14);
    }
    v2 = 31;
  }
  return (v2 & v1) != 0;
