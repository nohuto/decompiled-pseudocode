        ...
        unsigned int *a5)
{
  ...
  unsigned int v102; // [rsp+78h] [rbp-8A0h]
      ...
      if ( v53 )
      {
        ...
        if ( v54 )
        {
          ...
          if ( !v55 )
          {
            ...
            v19 = (void *)a3;
            memmove((void *)a3, ServerSiloGlobals[140], v88);
            v92 = 1;
            v18 = a5;
            goto LABEL_40;
          }
...
LABEL_79:
        ...
        LODWORD(v147[2]) = (PspGetJobLimitInformationValidFlags((unsigned int)a2, v100) | 0x7FFF) & *((_DWORD *)v15 + 64);
        if ( a2 == 9 )
        {
          ExAcquirePushLockSharedEx((ULONG_PTR)(v15 + 1032), 0LL);
