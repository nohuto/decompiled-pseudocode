/*
 * XREFs of NtQueryInformationJobObject @ 0x140698FB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeIsSingleGroupAffinityEx @ 0x140353060 (KeIsSingleGroupAffinityEx.c)
 ...
 *     PspLimitViolationRateControlToleranceLimitField @ 0x140706408 (PspLimitViolationRateControlToleranceLimitField.c)
      ...
      if ( v53 )
      {
        ...
        if ( v54 )
        {
          ...
          if ( !v55 )
          {
            ...
            memmove(JobObjectInformation, ServerSiloGlobals[140], v88);
            v92 = 1;
            v18 = ReturnLength;
            goto LABEL_40;
          }
          ...
          if ( !v56 )
          {
            PspLockJobShared((__int64)v15, (__int64)CurrentThread);
            JobIoAttribution = PspQueryJobIoAttribution((__int64)v15, (__int64)v149);
            PspUnlockJob((__int64)v15, (__int64)v101);
            v16 = (bool *)v149;
            goto LABEL_38;
          }
          v82 = v56 - 1;
        ...
        {
          v89 = *(_QWORD *)(v61 + 1272);
          *(_QWORD *)((char *)&v124 + 4) = *(_QWORD *)(v89 + 1104);
          BYTE12(v124) = *(_BYTE *)(v89 + 1168);
          if ( v98 )
          {
            v125 = 0LL;
          }
    ...
    else
    {
      if ( JobObjectInformationClass != JobObjectSiloBasicInformation )
      {
        switch ( JobObjectInformationClass )
        {
          ...
          case JobObjectMemoryUsageInformation:
            *(_OWORD *)&v140[24] = 0LL;
            PspLockJobMemoryLimitsShared((__int64)v15, (__int64)CurrentThread);
            *(_QWORD *)&v140[8] = *((_QWORD *)v15 + 76) << 12;
            *(_QWORD *)v140 = *((_QWORD *)v15 + 122) << 12;
            *(_QWORD *)&v140[16] = *((_QWORD *)v15 + 167) << 12;
            v15 = (char *)Object;
            PspUnlockJobMemoryLimitsShared((__int64)Object, (__int64)v101);
            v16 = v140;
            goto LABEL_37;
...
LABEL_94:
      ...
      *(_OWORD *)&v128[11] = 0LL;
      ...
      v128[3] = Src[10];
      v128[5] = Src[0];
      PspLockJobExclusive((__int64)v15, (__int64)v101);
      v22 = *((_DWORD *)v15 + 330);
      ...
      PspUnlockJobMemoryLimitsShared((__int64)v15, 0LL);
      ...
      if ( v23 )
      {
        ...
        do
        {
          v31 = (_DWORD *)PspLimitViolationRateControlToleranceLimitField(v128, v30);
          v35 = v33[16];
          if ( v35 )
            *v34 = 1;
          else
      ...
      else
      {
        ...
        do
        {
          *(_DWORD *)PspLimitViolationRateControlToleranceLimitField(v128, v59) = 0;
      ...
      do
      {
        if ( *((_QWORD *)v15 + 123) && (v39 = PspRateControlLimitFlag(v36), (v39 & *v40) != 0) )
          v41 = *(_DWORD *)((char *)v40 + v38);
        else
          v41 = 1;
        v113 = v41;
        LOBYTE(v38) = *(_BYTE *)p_Size_4;
        PspQueryRateControlHistory((_DWORD)v15, v41, v38, (unsigned int)&v112, v36);
        if ( v36 )
        {
          if ( v36 == 1 )
            v42 = &v128[11];
...
LABEL_125:
    ...
    if ( v45 )
    {
      ...
      *((_QWORD *)&v132[1] + 1) = *(_QWORD *)(v45 + 40) << 12;
      for ( i = 0; i < 3; i = v52 + 1 )
      {
        v47 = (_DWORD *)PspNotificationLimitRateControlToleranceField((__int64)v132, i);
        *v47 = *(_DWORD *)(v48 - 12);
...
LABEL_79:
        ...
        LODWORD(v147[2]) = (PspGetJobLimitInformationValidFlags((unsigned int)JobObjectInformationClass, v100) | 0x7FFF) & *((_DWORD *)v15 + 64);
