/*
 * XREFs of MiConfigureMemoryInsertion @ 0x1408C21D0
 * Callers:
...
__int64 __fastcall MiConfigureMemoryInsertion(_QWORD *a1, unsigned int *a2, __int64 a3)
{
  ...
  *a1 = 0LL;
  ...
  v12 = v11 + 48;
  if ( v9 )
    v12 = v11 + 8 * ((unsigned int)(v8 + 1) + 6LL);
  v13 = 0LL;
  v34 = 1LL;
  v14 = 0LL;
  v15 = a2 + 6;
  ...
  while ( 1 )
  {
    ...
    if ( *v15 )
    {
      ...
      if ( (v5 == v18 || v7 == v17)
        && (!v9 || v9[2 * v13] == *(_DWORD *)(a3 + 32) && v9[2 * v13 + 1] == *(_DWORD *)(a3 + 36)) )
      {
        if ( v16 == 1 )
        {
          v14 = v13;
  ...
  if ( v9 )
    v20 += 8 * (v10 + v16);
  Pool = MiAllocatePool(64, v20, 0x20206D4Du);
  if ( !Pool )
    return 3221225626LL;
  ...
  *((_DWORD *)Pool + 4) = v16 + v10;
  v24 = &Pool[2 * (unsigned int)(v16 + v10) + 4];
  Pool[3] = v35 + *((_QWORD *)a2 + 1);
  v25 = Pool + 4;
  if ( v34 == -1 )
  {
    v26 = 4 * v14;
    ...
    *(_QWORD *)&v23[v26 * 4 + 24] += v35 + *(_QWORD *)&a2[v26 + 10];
    if ( v14 + 2 != v10 )
    {
      ...
      if ( v9 )
        memmove(&v24[2 * v14 + 2], &v9[2 * v14 + 4], 8 * v27 - 16);
    }
  }
  else if ( v34 )
  {
