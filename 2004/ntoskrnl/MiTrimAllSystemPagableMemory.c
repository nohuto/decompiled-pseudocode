/*
 * XREFs of MiTrimAllSystemPagableMemory @ 0x140536B70
 * Callers:
...
__int64 __fastcall MiTrimAllSystemPagableMemory(int a1, int a2)
{
  ...
  CurrentThread = 0LL;
  v13 = 0;
  if ( _InterlockedIncrement(&dword_140C4EC48) <= 1 && KeAreInterruptsEnabled() )
  {
...
LABEL_22:
        ...
        {
          if ( a1 == 1 )
            v17 = *(ULONG_PTR **)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(SessionVm + 174));
          else
...
LABEL_28:
  _InterlockedAdd(&dword_140C4EC48, 0xFFFFFFFF);
  if ( v13 == 1 )
