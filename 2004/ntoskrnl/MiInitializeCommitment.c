/*
 * XREFs of MiInitializeCommitment @ 0x1403BC954
 * Callers:
...
__int64 __fastcall MiInitializeCommitment(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 492) = 0;
  ...
  if ( dword_140C4DCFC )
  {
    ...
    v5 = (unsigned int)dword_140C4DCFC;
  ...
  *(_QWORD *)(a1 + 7168) = v3;
  ...
  if ( (ULONG_PTR *)a1 == &MiSystemPartition )
  {
    qword_140C4EDB0 = *(_QWORD *)(a1 + 7464);
    qword_140C4EDB0 -= qword_140C4EDB8;
    result = qword_140C4EDD8;
    qword_140C4EDB0 -= qword_140C4EDD8;
  }
  return result;
}
