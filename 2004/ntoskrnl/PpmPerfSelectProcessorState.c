/*
 * XREFs of PpmPerfSelectProcessorState @ 0x1403230F0
 * Callers:
 *     PpmPerfSelectProcessorStates @ 0x140323060 (PpmPerfSelectProcessorStates.c)
 * Callees:
...
char __fastcall PpmPerfSelectProcessorState(__int64 *a1)
{
  ...
  if ( (unsigned int)PpmMfBufferingThreshold > 0x64 )
    v3 = 100;
  v7 = &PpmCurrentProfile[342 * dword_140C238AC + 5];
  if ( v6 && PpmCurrentProfile == (__int64 *)PpmLowPowerProfile && byte_140C238EC && *(_BYTE *)(v6 + 329) < v3 )
  {
    v2 = 4096;
    v7 = (__int64 *)((char *)&unk_140C1EC28 + 2736 * dword_140C238AC);
    v48 = 4096;
  }
