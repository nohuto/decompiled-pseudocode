/*
 * XREFs of KiSaveProcessorControlState @ 0x1403F7420
 * Callers:
 *     KeBugCheckEx @ 0x1403F70D0 (KeBugCheckEx.c)
 *     KeSaveStateForHibernate @ 0x1403F7DE0 (KeSaveStateForHibernate.c)
 ...
 *     IopLiveDumpCorralDpc @ 0x1409A8DC0 (IopLiveDumpCorralDpc.c)
...
__int64 __fastcall KiSaveProcessorControlState(__int64 _RCX, int a2)
{
  ...
  *(_WORD *)(_RCX + 114) = 0;
  v6 = (unsigned __int8)(BYTE5(Mm64BitPhysicalAddress) | VslVsmEnabled);
  if ( !(_BYTE)v6 )
  {
    __sgdt((void *)(_RCX + 86));
