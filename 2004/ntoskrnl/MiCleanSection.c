/*
 * XREFs of MiCleanSection @ 0x14037CD1C
 * Callers:
 ...
 *     MiRemoveWakeListEntry @ 0x14052542C (MiRemoveWakeListEntry.c)
...
__int64 __fastcall MiCleanSection(__int64 a1, __int64 a2, char a3)
{
  ...
  while ( 1 )
  {
    ...
    *(_QWORD *)(a1 + 80) = &v24;
    ...
    v14 = MiFlushSectionInternal(0LL, 0LL, (__int64 *)(a1 + 128), 0LL, 0LL, 0x80000000, &v23);
...
LABEL_17:
  *(_QWORD *)(a1 + 40) = v15 - 1;
  ...
  if ( v16 == 2 && (inserted = MiInsertUnusedSegment(a1)) != 0 )
    v18 = *(_QWORD *)(qword_140C4E448 + 8LL * (*(_WORD *)(a1 + 60) & 0x3FF));
  else
    v18 = 0LL;
