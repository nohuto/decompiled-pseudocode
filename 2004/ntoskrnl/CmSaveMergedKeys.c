/*
 * XREFs of CmSaveMergedKeys @ 0x14087958C
 * Callers:
  ...
  if ( v10 == CmpMasterHive || v7 == CmpMasterHive )
  {
    if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 0x400000000000LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140022C90,
        0LL,
        v22,
        3u,
        &v38);
...
LABEL_41:
  ...
  if ( v12 >= 0 )
  {
    ...
    v11 = 7;
    v18 = CmpCopyKeyPartial(v7, v32, v6, 0xFFFFFFFF, 6, v24, 0);
    if ( v18 == -1 || (*(_DWORD *)(*(_QWORD *)(v6 + 64) + 36LL) = v18, !CmpCopySyncTree(v7, v15, v6, v18, 2, 0)) )
    {
      v12 = -1073741670;
LABEL_42:
      v14 = v27;
