/*
 * XREFs of IommuMapIdentityRange @ 0x1404D5830
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IommupValidateMdl @ 0x1404D5E44 (IommupValidateMdl.c)
...
__int64 __fastcall IommuMapIdentityRange(ULONG_PTR BugCheckParameter3, unsigned int a2, __int64 a3)
{
  ...
  BYTE4(v22) = 0;
  v9 = ((__int64 (__fastcall *)(__int64 *, _QWORD, __int64, unsigned __int64 *))qword_140C4A3A0)(
         &v22,
         a2,
         v8 + 48,
         &v21);
