/*
 * XREFs of ExAllocateHeapPool @ 0x14028C7B0
 * Callers:
 ...
 *     RtlpHpExtrasAppend @ 0x14058F3CC (RtlpHpExtrasAppend.c)
...
LABEL_201:
      ...
      if ( (unsigned int)v6 >= dword_140C57E90 )
        LODWORD(v6) = 0;
      v15 = &qword_140C57EC0[1048 * (unsigned int)v6];
      if ( v12 < NonPagedPool )
      {
        v17 = v15[3];
      }
      ...
      if ( v9 <= 0xFE0 )
      {
        ...
        ++*((_DWORD *)v53 + 5);
        if ( !*v53 || (v35 = (__int64)RtlpInterlockedPopEntrySList((PSLIST_HEADER)(v52 + ((v51 + 1LL) << 6)))) == 0 )
        {
          ++*((_DWORD *)v53 + 6);
          v35 = 0LL;
        }
...
LABEL_27:
            ...
            if ( (v20 || (v21 = qword_140C1DBE8) != 0) && v19 > v21 )
            {
              v103 = *(_QWORD *)(v17 + 56);
              if ( v103 )
...
LABEL_128:
                  ...
                  else
                  {
                    ...
                    v133 = 0LL;
                    v132 = 0LL;
                    v35 = (__int64)RtlpHpVsContextAllocateInternal(v17 + 640, v19, v25, v26, (__int64)&v132, &v123);
                    if ( v123 && (v22 & 1) == 0 )
                ...
                if ( (v22 & 0x30000F08) != 0 )
                {
                  v106 = RtlpHpExtrasAppend(v17, v35, v19, v34, v126, v22, 0);
                  if ( v113 )
                  {
                    *(_BYTE *)(v106 + 2) ^= (*(_BYTE *)(v106 + 2) ^ v113) & 0xF;
                    if ( (_WORD)v113 != 1
                      || (int)((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))RtlpInterceptorRoutines)(
                                ...
                                v106 + 16) < 0 )
                    {
                      RtlpHpFreeHeap((__int128 *)v17, v35, v22);
                      goto LABEL_181;
                    }
                  }
                }
...
LABEL_181:
            if ( v111 )
              RtlpHpFreeHeap((__int128 *)v17, v111, 0);
            goto LABEL_247;
          }
          memset((void *)v35, 0, v19);
        }
        if ( v35 )
        {
LABEL_54:
          ...
          *(_BYTE *)(v35 + 3) = v37;
          ...
          {
            EtwTracePool(3616, v37, v137, v35 + 16, v19);
...
LABEL_65:
                  ...
                  {
                    *(_BYTE *)(v35 + 3) &= ~4u;
                    v54 = (*(_DWORD *)((char *)&Mm64BitPhysicalAddress + 7) - 1) & (-16 - v35);
                    if ( v54 )
                    {
                      v55 = v35 + v54;
                      v56 = (__int64)v54 >> 4;
                      *(_BYTE *)v55 = v56;
                      *(_BYTE *)(v55 + 2) = *(_BYTE *)(v35 + 2) - v56;
                      *(_BYTE *)(v55 + 1) = *(_BYTE *)(v35 + 1);
                      *(_BYTE *)(v55 + 3) = *(_BYTE *)(v35 + 3) | 4;
                      *(_DWORD *)(v55 + 4) = *(_DWORD *)(v35 + 4);
                      if ( (unsigned __int8)*(_WORD *)v55 > 1u )
                        *(_QWORD *)(v35 + 16) = ExpPoolQuotaCookie ^ v55;
                      v35 = v55;
                    }
                  }
                  v5 = v35 + 16;
...
LABEL_151:
      ...
      v124 = 0LL;
      v62 = v61 & 0x93000F0B;
      if ( (v58 || (v60 = qword_140C1DBE8) != 0) && v57 > v60 )
      {
        v96 = *(_QWORD *)(v17 + 56);
        if ( v96 )
...
LABEL_112:
          if ( v67 && (v62 & 0x30000F08) != 0 )
          {
            ...
            if ( v115 )
            {
              *(_BYTE *)(v98 + 2) ^= (*(_BYTE *)(v98 + 2) ^ v115) & 0xF;
              ...
              {
                RtlpHpFreeHeap((__int128 *)v17, v111, v62);
                v67 = 0LL;
                v111 = 0LL;
              }
            }
      ...
      else
      {
        ...
        v131 = 0LL;
        v130 = 0LL;
        v67 = (__int64)RtlpHpVsContextAllocateInternal(v17 + 640, v57, v66, v65, (__int64)&v130, &v122);
        v111 = v67;
        if ( v122 && (v62 & 1) == 0 )
        {
