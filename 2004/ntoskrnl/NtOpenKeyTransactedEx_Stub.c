/*
 * XREFs of NtOpenKeyTransactedEx_Stub @ 0x1409796FC
 * Callers:
...
__int64 __fastcall NtOpenKeyTransactedEx_Stub(__int64 a1)
{
  ...
  if ( byte_140CF9F88 )
  {
    v1 = (NTSTATUS (__stdcall *)(PHANDLE, ACCESS_MASK, POBJECT_ATTRIBUTES, ULONG, HANDLE))qword_140CF9F80;
  }
  else
  {
    v1 = ZwOpenKeyTransactedEx;
    byte_140CF9F88 = 1;
    qword_140CF9F80 = (__int64)ZwOpenKeyTransactedEx;
  }
  if ( v1 )
