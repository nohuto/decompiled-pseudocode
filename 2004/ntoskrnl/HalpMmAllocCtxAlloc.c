/*
 * XREFs of HalpMmAllocCtxAlloc @ 0x14037AA88
 * Callers:
 ...
 *     HalpRegisterUsbController @ 0x1404D2338 (HalpRegisterUsbController.c)
...
LABEL_30:
    v29 = 0LL;
    LOBYTE(v8) = KeAcquireSpinLockRaiseToDpc(&qword_140C4B830);
    goto LABEL_22;
  }
  v6 = KeAcquireSpinLockRaiseToDpc(&qword_140C4B830);
