/*
 * XREFs of EtwpLogSystemEventUnsafe @ 0x1403A68BC
 * Callers:
        ...
        ...)
{
  ...
  _QWORD *v31; // [rsp+48h] [rbp-70h]
  unsigned __int64 v32; // [rsp+50h] [rbp-68h]
  _QWORD *v33; // [rsp+58h] [rbp-60h]
  ...
  v27[0] = 0;
  v29.QuadPart = 0LL;
  result = (_QWORD *)EtwpOpenLogger(a4, a1, 1, v27);
  v31 = result;
  v12 = result;
  v33 = result;
  if ( result )
  {
    ...
    v16 = EtwpReserveTraceBuffer((__int64)result, v13 + 32, (__int64)&v34, &v29, a7);
    if ( v16 )
    {
      v17 = -1073676288;
        ...
        if ( (v12[104] & 0x4000000) != 0 && *(_DWORD *)(v12[127] + 24LL) )
        {
          while ( 1 )
          {
            ...
            if ( ++v10 >= *(_DWORD *)(v26 + 24) )
              return EtwpCloseLogger(a4, a1, v27[0]);
          }
