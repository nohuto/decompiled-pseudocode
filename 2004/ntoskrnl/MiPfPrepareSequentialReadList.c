/*
 * XREFs of MiPfPrepareSequentialReadList @ 0x1405F9950
 * Callers:
 ...
 *     MiGetAvailablePagesExcludeSlists @ 0x1403564BC (MiGetAvailablePagesExcludeSlists.c)
...
LABEL_6:
  ...
  *v16 = v16;
  ...
  if ( a5 )
  {
    v17 = (__int64 *)MiOffsetToProtos(v10, a3, &v79);
    v75 = v17;
  }
  else
  {
...
LABEL_53:
      ...
      {
        v89 = MiAddViewsForSection((__int64 **)v17, *((unsigned int *)v17 + 11), (_DWORD *)4, v23);
        if ( v89 < 0 )
        {
          if ( v71 )
      ...
      v20 = v40 + 8LL * *((unsigned int *)v17 + 11);
      v44 = MiStartingOffset(v17, v40, a7);
...
LABEL_54:
      ...
      MiSetPfnLink(v65, v15[*(int *)(SlabAllocator + 52) + 6]);
      v15[*(int *)(v66 + 52) + 6] = v67;
    }
    else
    {
      v38 = v71;
