/*
 * XREFs of MiFreeContiguousPages @ 0x140337158
 * Callers:
 ...
 *     MiResidentPageDangleFree @ 0x1403F13E4 (MiResidentPageDangleFree.c)
 *     MiFreeLargePageCharges @ 0x140558FDC (MiFreeLargePageCharges.c)
 */

__int64 __fastcall MiFreeContiguousPages(unsigned __int64 a1, __int64 a2, __int64 a3, _DWORD *SchedulerAssist)
{
  ...
  do
  {
    ...
    if ( (v5 & 0x1FF) != 0 || v4 < 0x200 || !(unsigned int)MiResidentPageDangleFree(v5, 1LL) )
    {
      ...
      v7 = *(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(v8 + 40) >> 39) & 0x3FFLL));
      if ( v10 )
        v7 = v10;
      --*(_WORD *)(v8 + 32);
      ++v6;
