/*
 * XREFs of PopMarkComponentsBootPhase @ 0x140995EE0
 * Callers:
 ...
 *     FirstEntrySList @ 0x1403FEFE0 (FirstEntrySList.c)
 ...
 *     VfIsVerifierExtensionEnabled @ 0x14059B214 (VfIsVerifierExtensionEnabled.c)
...
void __fastcall PopMarkComponentsBootPhase(PVOID Address)
{
  ...
  if ( !byte_140C23061 )
  {
    ...
    for ( j = FirstEntrySList(&stru_140C504A0); j; j = j->Next )
