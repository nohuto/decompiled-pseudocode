/*
 * XREFs of MiPfnShareCountIsZero @ 0x140235440
 * Callers:
...
__int64 __fastcall MiPfnShareCountIsZero(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( (unsigned int)MI_PFN_IS_PROTO(a1) )
  {
    ...
    v20 = (v14 << 12) & 0xFAFFFFFFFFFFFEFFuLL | MmProtectToPteMask[v16 & 0x1F] & 0xFAFF000000000E7FuLL | 0x21 | ((unsigned __int64)(word_140C4DE08 & 1) << 8) | 0xA00000000000042LL;
...
LABEL_32:
            ...
            {
              if ( (unsigned int)MiPteHasShadow(qword_140C4DD40, v34, v33, v6) )
              {
...
LABEL_70:
    ...
    *(_BYTE *)(a1 + 34) = v38;
    if ( (*(_DWORD *)(a1 + 16) & 0x400LL) == 0 )
    {
      if ( (unsigned int)MiGetPagingFileOffset(a1 + 16) )
        *(_BYTE *)(*(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(a1 + 40) >> 39) & 0x3FFLL)) + 675LL) = 1;
    }
    return 3LL;
  }
  else if ( (_DWORD)v36 )
  {
    ...
    v49 = *(_QWORD *)(a1 + 16);
    v42 = *(_QWORD *)(qword_140C4E448 + 8 * v41);
