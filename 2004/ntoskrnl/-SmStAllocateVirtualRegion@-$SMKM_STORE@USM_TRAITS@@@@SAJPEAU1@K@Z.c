/*
 * XREFs of ?SmStAllocateVirtualRegion@?$SMKM_STORE@USM_TRAITS@@@@SAJPEAU1@K@Z @ 0x140303508
 * Callers:
...
__int64 __fastcall SMKM_STORE<SM_TRAITS>::SmStAllocateVirtualRegion(__int64 a1, unsigned int a2)
{
  ...
  *((_QWORD *)&v10 + 1) = v5;
  ...
  result = ((__int64 (__fastcall *)(__int64, __int64, __int128 *, __int64))SMKM_STORE<SM_TRAITS>::SmStHelperSendCommand)(
             a1,
             2LL,
             &v10,
             4LL);
