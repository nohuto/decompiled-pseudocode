/*
 * XREFs of _CmGetDevicesInBaseContainerList @ 0x140972D58
 * Callers:
  ...
  if ( CachedContextBaseKey >= 0 )
  {
    ...
    if ( CachedContextBaseKey >= 0 )
    {
      ...
      if ( CachedContextBaseKey >= 0 )
      {
        ...
        if ( CachedContextBaseKey >= 0 )
        {
          CachedContextBaseKey = PnpCtxRegQueryInfoKey(v13, (int)Handle, 0, 0, (__int64)&v22, (__int64)&v27, 0LL);
          if ( CachedContextBaseKey >= 0 )
          {
            v14 = v22 * (v27 + 1) + 1;
            ...
            *a4 = PoolWithTag;
            ...
            {
              v27 = v14 - 1;
              v18 = PnpCtxRegEnumValue(v16, Handle, i, v8, (__int64)&v27, 0LL, 0LL, 0LL);
