/*
 * XREFs of IoQueryEnvironmentVariableInfoEx @ 0x140896954
 * Callers:
...
__int64 __fastcall IoQueryEnvironmentVariableInfoEx(unsigned int a1, PDEVICE_OBJECT *a2, __int64 *a3, __int64 *a4)
{
  ...
  if ( (unsigned int)dword_140C044D0 > 5 && tlgKeywordOn((__int64)&dword_140C044D0, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C044D0, (unsigned __int8 *)byte_140023DF9, 0LL, 0LL, 7u, &v15);
  }
