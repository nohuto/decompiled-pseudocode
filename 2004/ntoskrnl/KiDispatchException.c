/*
 * XREFs of KiDispatchException @ 0x1402E5930
 * Callers:
 *     KiInitializeUserApc @ 0x1402E30B0 (KiInitializeUserApc.c)
 *     KxExceptionDispatchOnExceptionStack @ 0x1403F7F50 (KxExceptionDispatchOnExceptionStack.c)
...
int __fastcall KiDispatchException(NTSTATUS *a1, unsigned __int64 a2, __int64 a3, unsigned __int8 a4, char a5)
{
  ...
  unsigned __int64 v46; // [rsp+90h] [rbp+60h]
  ...
  if ( a5 && *(_QWORD *)&Process[2].Affinity.Count )
  {
    ...
    {
      LODWORD(v17) = ((__int64 (__fastcall *)(NTSTATUS *, unsigned __int64, __int64, _QWORD, char))xmmword_140C1DE00)(
                       a1,
                       v36,
                       a3,
                       0LL,
