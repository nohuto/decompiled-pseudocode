/*
 * XREFs of EtwQueryPerformanceTraceInformation @ 0x14093486C
 * Callers:
  ...
  if ( v52 > 5 )
  {
    ...
    else
    {
      ...
      if ( !PsIsCurrentThreadInServerSilo() )
      {
        ...
        v28 = (unsigned int *)EtwpAcquireLoggerContextByLoggerId(v12, v26, 1);
        v23 = v28;
  ...
  switch ( v52 )
  {
    ...
    case 1:
      *a4 = 48;
      ...
      ObjectsSecurityDescriptor = (PSECURITY_DESCRIPTOR)v22;
      if ( v22 )
      {
        if ( (*(_DWORD *)(v22 + 12) & 0x2000000) == 0 )
        {
          EtwpReleaseLoggerContext((unsigned int *)v22, 1);
          KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
          return 3221225485LL;
        }
    ...
    case 4:
      *a4 = 24;
      if ( a2 >= 0x18 )
      {
        ...
        if ( v15 )
        {
          v17 = (void *)EtwpReferenceLoggerSecurityDescriptor(v15);
