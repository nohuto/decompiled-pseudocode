/*
 * XREFs of HalpTscTraceProcessorSynchronization @ 0x14039A624
 * Callers:
 *     HalpTscAdjustToLeader @ 0x14039A288 (HalpTscAdjustToLeader.c)
 *     HalpTscAdjustToTarget @ 0x1404BC098 (HalpTscAdjustToTarget.c)
 *     HalpTscAdvSynchToLeader @ 0x1404BC25C (HalpTscAdvSynchToLeader.c)
