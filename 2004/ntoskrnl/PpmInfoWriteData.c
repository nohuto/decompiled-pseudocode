/*
 * XREFs of PpmInfoWriteData @ 0x1406A84C0
 * Callers:
 *     PpmInfoAdjustSetting @ 0x1406A8404 (PpmInfoAdjustSetting.c)
 * Callees:
 *     PpmInfoApplyMinMaxConstraint @ 0x1402DEFCC (PpmInfoApplyMinMaxConstraint.c)
 */
