/*
 * XREFs of GetOperandValue @ 0x140923F0C
 * Callers:
 ...
 *     GetBinaryOperandLen @ 0x140923C90 (GetBinaryOperandLen.c)
 *     GetDigitFromChar @ 0x140923D7C (GetDigitFromChar.c)
 *     GetNextNoneWhiteSpace @ 0x140923E90 (GetNextNoneWhiteSpace.c)
 *     GetOperandValue @ 0x140923F0C (GetOperandValue.c)
 *     GetStringOperandValue @ 0x140924678 (GetStringOperandValue.c)
 *     IsValueSizeFixed @ 0x1409248CC (IsValueSizeFixed.c)
