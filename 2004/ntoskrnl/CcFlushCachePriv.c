/*
 * XREFs of CcFlushCachePriv @ 0x1402BEDA0
 * Callers:
 ...
 *     CcFlushCache @ 0x14034EF30 (CcFlushCache.c)
 *     CcFlushCacheToLsn @ 0x14035AE20 (CcFlushCacheToLsn.c)
 * Callees:
  ...
  *((_QWORD *)v10 + 1) = 0LL;
  ...
  if ( (v15 & 0x2000) != 0 )
  {
    if ( ((unsigned __int8)v12 & 1) == 0 )
      goto LABEL_36;
    v14 = (__int64 *)((unsigned __int64)v12 ^ 1);
    v69 = (__int64 *)((unsigned __int64)v12 ^ 1);
  }
  v16 = v64;
  if ( !v64 )
  {
...
LABEL_64:
    ...
    if ( v13 )
      CcUnmapVacbArray(v13, v69, a3, 0, 0, 0);
    v21 = v69;
