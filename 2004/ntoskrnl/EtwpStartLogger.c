/*
 * XREFs of EtwpStartLogger @ 0x1406C7A14
 * Callers:
 ...
 *     EtwpSetQpcDeltaTracking @ 0x1405A52D8 (EtwpSetQpcDeltaTracking.c)
 ...
 *     EtwpInitializeLoggerSecurityDescriptor @ 0x1406C8940 (EtwpInitializeLoggerSecurityDescriptor.c)
...
LABEL_181:
    RtlFreeAnsiString(&DestinationString);
    v53 = *(_QWORD *)&v11.Data1 - SystemTraceControlGuid;
    if ( *(_QWORD *)&v11.Data1 == SystemTraceControlGuid )
      v53 = *(_QWORD *)v11.Data4 - 0x3969A8086000829ALL;
    if ( v53 )
    {
      v54 = 2;
      v67 = 1;
...
LABEL_228:
  ...
  {
    v58 = *(_QWORD *)&v11.Data1 - AuditLoggerGuid;
    if ( *(_QWORD *)&v11.Data1 == AuditLoggerGuid )
      v58 = *(_QWORD *)v11.Data4 + 0x6A2DF162E6CE8D6ELL;
    if ( v58 )
      goto LABEL_211;
  }
  v16 = v68;
      ...
      if ( (unsigned int)dword_140C02BB0 > 5 )
      {
        if ( tlgKeywordOn((__int64)&dword_140C02BB0, 0x800000000000LL) )
        {
          ...
          tlgWriteTransfer_EtwWriteTransfer(
            ...
            (unsigned __int8 *)&dword_14002C21C,
            0LL,
            0LL,
            3u,
            &v79);
...
LABEL_58:
  ...
  if ( FlagExtension )
  {
    ...
    {
      FileName = EtwpSetPartitionContext((__int64 *)inited + 167, *(_QWORD *)(FlagExtension + 4), v26);
      if ( FileName < 0 )
        goto LABEL_234;
    }
  }
...
LABEL_258:
    inited[14] = FileName;
    EtwpStopLoggerInstance((__int64)inited);
    if ( (inited[3] & 0x400) != 0 )
    {
      EtwpGetLoggerInfoFromContext(a2, inited);
      EtwpReleaseLoggerContext(inited, 1);
