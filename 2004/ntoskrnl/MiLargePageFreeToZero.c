/*
 * XREFs of MiLargePageFreeToZero @ 0x14031A0B0
 * Callers:
...
void __fastcall MiLargePageFreeToZero(ULONG_PTR BugCheckParameter2, unsigned int a2, int a3, char a4)
{
  ...
  *(_QWORD *)&LockHandle.OldIrql = 0LL;
  ...
  v34 = *(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(v7 + 40) >> 39) & 0x3FFLL));
  ...
  *(_QWORD *)(v7 + 16) = MiSwizzleInvalidPte(128LL);
  if ( !a4 )
  {
    ...
    *(_QWORD *)(v17 + 8) = v18;
    ...
    v33 = 24 * (BugCheckParameter2 / *v32 % (unsigned int)dword_140C4DD80[v20]);
    ...
    if ( dword_140C4E4CC == 1 )
    {
      ...
      v25 = v9;
      v26 = (volatile signed __int32 *)(qword_140C4E528 + 4 * (BugCheckParameter2 >> 5));
      if ( v24 + v9 <= 0x20 )
      {
        if ( v9 == 32 )
        {
...
LABEL_39:
  ...
  if ( dword_140C4E4CC == 1 )
  {
    ...
    v14 = (volatile signed __int32 *)(qword_140C4E528 + 4 * (BugCheckParameter2 >> 5));
    if ( v13 + v9 > 0x20 )
    {
      if ( (BugCheckParameter2 & 0x1F) != 0 )
      {
