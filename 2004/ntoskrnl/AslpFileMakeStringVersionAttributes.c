/*
 * XREFs of AslpFileMakeStringVersionAttributes @ 0x14079EA70
 * Callers:
 *     AslpFileGetVersionAttributes @ 0x14079EA0C (AslpFileGetVersionAttributes.c)
 * Callees:
 *     AslpFileStringTokenize @ 0x1403BA7D0 (AslpFileStringTokenize.c)
 ...
 *     AslStringXmlSanitize @ 0x14079EE04 (AslStringXmlSanitize.c)
...
LABEL_47:
  ...
  do
  {
    v24 = *(int *)&byte_1400089E0[v22];
    v40 = *(_DWORD *)&byte_1400089E0[v22];
    VersionString = AslpFileQueryVersionString(
                      ...
                      (int)v20,
                      v23,
                      *(NTSTRSAFE_PCWSTR *)&byte_1400089E0[v22 + 8]);
    v6 = VersionString;
    if ( VersionString < 0 )
    {
