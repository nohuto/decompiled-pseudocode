/*
 * XREFs of SepSecureBootSetRegistryKey @ 0x140A6D0C8
 * Callers:
...
__int64 __fastcall SepSecureBootSetRegistryKey(__int64 a1)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v2 >= 0 )
  {
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&qword_1400097E0;
    ObjectAttributes.Length = 48;
    ObjectAttributes.Attributes = 576;
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v2 >= 0 )
    {
      ...
      {
        Data = dword_140C54434 & 1;
        v2 = ZwSetValueKey(Handle, (PUNICODE_STRING)&stru_1400097F0, 0, 4u, &Data, 4u);
        if ( v2 < 0 )
          goto LABEL_4;
        if ( Data )
      ...
      if ( a1 )
      {
        ...
        if ( v2 >= 0 )
        {
          ...
          if ( v2 >= 0 )
            v2 = ZwSetValueKey(Handle, (PUNICODE_STRING)&stru_1400097B0, 0, 4u, (PVOID)(a1 + 20), 4u);
        }
      }
    }
  }
