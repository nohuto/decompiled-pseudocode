/*
 * XREFs of MiProcessCrcList @ 0x1407150D0
 * Callers:
 ...
 *     MiValidCombineProtection @ 0x140365B50 (MiValidCombineProtection.c)
 *     MiAllocateCombineProto @ 0x140365B80 (MiAllocateCombineProto.c)
 *     MiCompareActiveCrcEntries @ 0x140365E08 (MiCompareActiveCrcEntries.c)
 *     MiCapturePfnVm @ 0x140365E70 (MiCapturePfnVm.c)
 *     MiSharePages @ 0x1403660D0 (MiSharePages.c)
 *     MiPushCombineBlock @ 0x140368BF8 (MiPushCombineBlock.c)
...
LABEL_79:
      ...
      v43 = v64;
      MiPopulateCombineMdls((__int64)v64, v4, (__int64)&v70);
    }
    else
    {
      v43 = v64;
