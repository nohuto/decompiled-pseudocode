/*
 * XREFs of IopInitActivityIdIrp @ 0x1404FB844
 * Callers:
...
LABEL_17:
    ...
    {
      v10 = 0;
      if ( KeGetPcr()->NtTib.$CC7ADE021331F41D731EA9DD485E62BD::$58191C77EAB639A512BFC482EB8FAE38::Self )
      {
        v12 = *(__m128i *)&KeGetPcr()->NtTib.$CC7ADE021331F41D731EA9DD485E62BD::$58191C77EAB639A512BFC482EB8FAE38::Self[105].SubSystemTib;
        v10 = 1;
      }
      if ( v10 )
      {
