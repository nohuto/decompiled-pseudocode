/*
 * XREFs of VfMajorIsNewRequest @ 0x1409D4A50
 * Callers:
...
__int64 __fastcall VfMajorIsNewRequest(__int64 a1, _BYTE *a2)
{
  ...
  v5 = (unsigned int (__fastcall *)(__int64))*((_QWORD *)&unk_140D4A0F8 + 12 * v4);
  if ( v5 && v5(a1) )
    return 1LL;
  result = (__int64)qword_140D4AB78;
  if ( qword_140D4AB78 )
    return qword_140D4AB78(a1, a2);
  return result;
}
