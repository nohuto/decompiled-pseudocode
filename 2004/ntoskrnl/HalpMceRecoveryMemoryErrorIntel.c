/*
 * XREFs of HalpMceRecoveryMemoryErrorIntel @ 0x1404CB52C
 * Callers:
 *     HalpMceRecoveryRequired @ 0x1404CB828 (HalpMceRecoveryRequired.c)
 * Callees:
 *     HalpHvMceConsumedMemoryErrorRecovery @ 0x1404BD3FC (HalpHvMceConsumedMemoryErrorRecovery.c)
 *     HalpMceMemoryErrorRecovery @ 0x1404CB328 (HalpMceMemoryErrorRecovery.c)
 */
