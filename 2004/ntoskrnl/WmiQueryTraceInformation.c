/*
 * XREFs of WmiQueryTraceInformation @ 0x1407766A0
 * Callers:
  ...
  if ( TraceInformationClass > TraceHandleByNameClass )
  {
    ...
    if ( !v15 )
    {
      ...
      *RequiredLength = 32;
      ...
      v51 = (unsigned int *)EtwpAcquireLoggerContextByLoggerId(v50[108], v54, 0);
      if ( v51 )
      {
    ...
    if ( v16 )
    {
      ...
      if ( !v18 )
      {
        ...
        *((_OWORD *)TraceInformation + 1) = *(_OWORD *)off_140983560;
        *((_OWORD *)TraceInformation + 2) = *(_OWORD *)&off_140983570;
        *((_OWORD *)TraceInformation + 3) = *(_OWORD *)&off_140983580;
        *((_OWORD *)TraceInformation + 4) = *(_OWORD *)off_140983590;
        *((_OWORD *)TraceInformation + 5) = *(_OWORD *)&off_1409835A0;
        *((_OWORD *)TraceInformation + 6) = *(_OWORD *)off_1409835B0;
