/*
 * XREFs of PnpRemoveDeviceActionRequestFromQueue @ 0x1405093D0
 * Callers:
...
__int64 __fastcall PnpRemoveDeviceActionRequestFromQueue(volatile signed __int32 *a1)
{
  ...
  if ( !*((_BYTE *)a1 + 76) )
  {
    ...
    *(_QWORD *)(v4 + 8) = v5;
    ...
    v7 = KeAcquireSpinLockRaiseToDpc(&qword_140C24BE8);
    v8 = dword_140C24BF0-- == 1;
    v9 = v7;
    if ( v8 )
    ...
    __writecr8(v9);
    v14 = KeAcquireSpinLockRaiseToDpc(&qword_140C1E930);
