/*
 * XREFs of EtwpCoverageSamplerStart @ 0x140943BFC
 * Callers:
 ...
 *     ExReInitializeRundownProtection @ 0x14037C960 (ExReInitializeRundownProtection.c)
 ...
 *     PsSetLoadImageNotifyRoutine @ 0x140782430 (PsSetLoadImageNotifyRoutine.c)
...
LABEL_16:
  ...
  else
  {
    ...
    if ( ImageNotifyRoutine >= 0 )
    {
      ...
      qword_140C196D8 = (__int64)Object;
      ExReInitializeRundownProtection((PEX_RUNDOWN_REF)&stru_140C196E0);
      Object[287] |= 1u;
