/*
 * XREFs of CmpCopySyncTree2 @ 0x1408750C0
 * Callers:
        ...
        int a7)
{
  ...
  unsigned __int16 v75[32]; // [rsp+C8h] [rbp-1h] BYREF
...
LABEL_26:
    ...
    if ( !v16 )
      goto LABEL_89;
    CmpInitializeKeyNameString(v16, v75, v8);
    ...
    if ( !v18 )
      goto LABEL_89;
    v63 = 0;
    CmpFindSubKeyByNameWithStatus(BugCheckParameter2, v18, v75, &v63);
    v19 = v63;
