/*
 * XREFs of MiInitializePoolCommitPacket @ 0x140258BC8
 * Callers:
  ...
  *(_QWORD *)(a8 + 56) = (((v12 + v9 - 1) >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
  ...
  if ( (a5 & 1) != 0 )
  {
    *(_WORD *)(a8 + 78) = v15 | 2;
    ...
    {
      v17 = 6;
      v18 = (unsigned __int16 *)&unk_140C4F080;
    }
    v19 = v18[87];
    *(_QWORD *)(a8 + 48) = v18;
    v20 = qword_140C4E448;
    *(_DWORD *)(a8 + 40) = v17;
    v21 = (unsigned int)MiChargeCommit(*(_QWORD *)(v20 + 8 * v19), v16, 1LL) == 0;
    goto LABEL_7;
  }
  if ( (v13 & 0x20000000) == 0 )
  {
...
LABEL_8:
  ...
  if ( (unsigned int)MiObtainPoolCharges(v16, 0LL) )
  {
