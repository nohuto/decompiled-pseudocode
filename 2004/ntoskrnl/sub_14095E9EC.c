/*
 * XREFs of sub_14095E9EC @ 0x14095E9EC
 * Callers:
...
__int64 __fastcall sub_14095E9EC(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbx
  unsigned int v7; // r8d
  unsigned int *v8; // rax
...
LABEL_19:
  if ( (v7 & 0x80000000) == 0 )
  {
    ...
    v15 = KeWaitForSingleObject(&stru_140C13CA0, UserRequest, 1, 0, &Timeout);
    if ( v15 >= 0 && v15 != 192 && v15 != 258 )
    {
      if ( stru_140C13C80.Header.SignalState || !dword_140D2D1C4 )
      {
        v16 = MEMORY[0xFFFFF78000000320];
        TimeIncrement = KeQueryTimeIncrement();
        dword_140D2D1C4 = 1;
        qword_140D2D168 = v16 * TimeIncrement / 10000;
        KeResetEvent(&stru_140C13C80);
        v4 = v31;
      }
      KeReleaseMutex((PRKMUTEX)&stru_140C13CA0, 0);
    }
    v18 = *(_DWORD *)(a2 + 32);
