/*
 * XREFs of VfFlushAdapterBuffers @ 0x1409C86E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ViGetMapRegisterFile @ 0x1409CB904 (ViGetMapRegisterFile.c)
  ...
  else
  {
    if ( a5 )
    {
      ViHalPreprocessOptions(
        ...
        a3,
        a4);
      VfReportIssueWithOptions(0xE6u, 0x20uLL, (ULONG_PTR)a3, (ULONG_PTR)a4, a2, byte_140C12D24);
    }
    return 0;
  }
}
