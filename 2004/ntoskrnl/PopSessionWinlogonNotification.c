/*
 * XREFs of PopSessionWinlogonNotification @ 0x1405CF974
 * Callers:
...
__int64 __fastcall PopSessionWinlogonNotification(unsigned int a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    ...
    if ( v2 )
    {
      BYTE4(xmmword_140C20350) = 1;
      LockConsoleTimeoutUnsafe = PopGetLockConsoleTimeoutUnsafe();
      LODWORD(v11) = LockConsoleTimeoutUnsafe;
      if ( LockConsoleTimeoutUnsafe && !BYTE5(xmmword_140C20350) )
      {
        *(_WORD *)((char *)&xmmword_140C20350 + 5) = 256;
