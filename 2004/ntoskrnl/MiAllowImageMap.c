/*
 * XREFs of MiAllowImageMap @ 0x140601DB0
 * Callers:
 ...
 *     PsBlockNonCetBinaries @ 0x1405C81EC (PsBlockNonCetBinaries.c)
...
LABEL_18:
  ...
  if ( v18 || v17 )
  {
    ...
    ObjectSecurity = ObpGetObjectSecurity(v19, SecurityDescriptor, &MemoryAllocated, 0LL);
    if ( ObjectSecurity < 0 )
    {
