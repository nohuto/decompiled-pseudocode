/*
 * XREFs of MiUnlinkBadPages @ 0x140529C28
 * Callers:
 *     MmMarkPhysicalMemoryAsGood @ 0x14052AF90 (MmMarkPhysicalMemoryAsGood.c)
 * Callees:
...
__int64 __fastcall MiUnlinkBadPages(ULONG_PTR BugCheckParameter2, ULONG_PTR a2)
{
  ...
  if ( BugCheckParameter2 < a2 )
  {
    ...
    do
    {
      ...
      v20 = *(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(v4 + 40) >> 39) & 0x3FFLL));
