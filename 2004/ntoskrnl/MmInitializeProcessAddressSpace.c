/*
 * XREFs of MmInitializeProcessAddressSpace @ 0x1406B424C
 * Callers:
 ...
 *     MiInitializeProcessPageTableCommitmentBitMaps @ 0x1402FDA70 (MiInitializeProcessPageTableCommitmentBitMaps.c)
        ...
        char a5)
{
  ...
  if ( Pool )
  {
    ...
    KiStackAttachProcess((_KPROCESS *)BugCheckParameter1, 0LL, (__int64)v37);
