/*
 * XREFs of IopTrackLink @ 0x1406D3810
 * Callers:
 ...
 *     IoGetTransactionParameterBlock @ 0x140323D60 (IoGetTransactionParameterBlock.c)
        ...
        if ( *(_QWORD *)PoolWithQuota )
        {
          ...
          if ( *(_QWORD *)PoolWithQuota )
          {
            if ( (v9->DeviceObject->Characteristics & 0x10) != 0 )
            {
              ...
              if ( v13 < 0 )
                goto LABEL_14;
              IopMarshalIds(Src, v35, v37, PoolWithQuota);
              v16 = a5;
...
LABEL_78:
        ...
        v34 = v35[5];
        LOBYTE(v32) = _mm_cvtsi128_si32((__m128i)v35[3]) & 0xFE;
        v23 = IopSendMessageToTrackService(v36, &v31, PoolWithQuota);
      }
      v13 = v23;
      goto LABEL_14;
    }
