  ...
  switch ( a2 )
  {
    ...
    case 8u:
      ...
      if ( !SeSinglePrivilegeCheck(SeTcbPrivilege, v9) )
        return -1073741727;
      v289 = 0LL;
      result = ObReferenceObjectByHandle(Handlea, 0, LpcPortObjectType, v9, &v289, 0LL);
...
LABEL_80:
    ...
    case 0x12u:
      ...
      {
        v21 = Object;
        v22 = PspSetProcessPriorityClass(Object, HIBYTE(v272), Handle, v9);
        if ( v22 >= 0 )
        {
...
LABEL_208:
    ...
    case 0x20u:
      ...
      if ( ((a4 - 4) & 0xFFFFFFFB) != 0 )
        return -1073741820;
      v65 = *(_DWORD *)a3;
      LODWORD(v290) = *(_DWORD *)a3;
      if ( a4 == 8 )
        HIDWORD(v290) = *(_DWORD *)(a3 + 4);
      else
        HIDWORD(v290) = 0;
      if ( v65 )
        return -1073741811;
...
LABEL_330:
        ...
        for ( j = 0LL; ; j = Handlea )
        {
          ...
          v105 = Handlea;
          if ( !Handlea || v264 >= *((_DWORD *)PoolWithQuotaTag + 2) )
            break;
              ...
              if ( *((_DWORD *)PoolWithQuotaTag + 1) == 1 )
              {
                ...
                *(_DWORD *)(v281 + 24LL * v264 + 16) |= 1u;
                ...
                if ( v270 )
                  ...
                  *(_QWORD *)(v106 + 88) = Ptr;
                v115 = v281 + 24LL * v264;
                *(_QWORD *)(v115 + 32) = *((_QWORD *)Handlea + 144);
                *(_QWORD *)(v115 + 24) = v280;
                *(_DWORD *)(v115 + 16) ^= 3u;
                ++v264;
              }
...
LABEL_378:
    ...
    case 0x34u:
      ...
      if ( a4 != 8 )
        return -1073741820;
      v268 = *(HANDLE *)a3;
      if ( Handle != (HANDLE)-1LL && (_DWORD)v268 != 2 )
        return -1073741811;
      break;
    case 0x35u:
      if ( Handle != (HANDLE)-1LL )
...
LABEL_235:
    ...
    case 0x44u:
      if ( (PsGetCurrentProcess()[1].IdealProcessorPadding[10] & 0x100) == 0 )
        return -1073741727;
      v297 = 0LL;
      result = ObReferenceObjectByHandle(Handle, 0x200u, (POBJECT_TYPE)PsProcessType, v9, &v297, 0LL);
      v220 = result;
      if ( result >= 0 )
      {
    ...
    case 0x52u:
      ...
      if ( a4 < 0x90 )
        v227 = a4;
      memmove(v348, (const void *)a3, v227);
      result = ObReferenceObjectByHandleWithTag(
                 Handle,
                 0x200u,
                 (POBJECT_TYPE)PsProcessType,
...
LABEL_209:
    ...
    case 0x64u:
      ...
      if ( v9 )
        return -1073741790;
      v302 = 0LL;
      result = ObReferenceObjectByHandle(Handle, 0xBEAu, (POBJECT_TYPE)PsProcessType, 0, &v302, 0LL);
      if ( result >= 0 )
      {
    ...
    case 0x65u:
      ...
      *(_OWORD *)Address = *(_OWORD *)a3;
      ...
      if ( v9 != 1 )
        return -1073741790;
      v287 = 0LL;
      result = ObReferenceObjectByHandle(Handle, 0x200u, (POBJECT_TYPE)PsProcessType, 1, &v287, 0LL);
      v256 = (_KPROCESS *)v287;
      Object = v287;
      if ( result < 0 )
        return result;
    ...
    case 0x66u:
      ...
      *(_OWORD *)v301 = *(_OWORD *)a3;
      ...
      if ( v9 != 1 )
        return -1073741790;
      v288 = 0LL;
      result = ObReferenceObjectByHandle(Handle, 0x200u, (POBJECT_TYPE)PsProcessType, 1, &v288, 0LL);
