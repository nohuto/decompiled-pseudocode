/*
 * XREFs of PfpRpControlRequest @ 0x1406E9684
 * Callers:
 *     PfSetSuperfetchInformation @ 0x1406A9D30 (PfSetSuperfetchInformation.c)
 * Callees:
 *     PfpRpControlRequestVerify @ 0x1403432C4 (PfpRpControlRequestVerify.c)
    ...
    else
    {
      ...
      if ( v2 >= 0 )
      {
        if ( (unsigned int)PfpRpControlRequestVerify(0LL) )
          ...
          return (unsigned int)PfpRpControlRequestPerform(&unk_140C50158, 0LL);
      }
    }
  }
  else
