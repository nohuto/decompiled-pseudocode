/*
 * XREFs of MiLogOutswappedProcessCommitRelease @ 0x1405263B0
 * Callers:
...
void __fastcall MiLogOutswappedProcessCommitRelease(__int64 a1, __int64 a2)
{
  ...
  {
    if ( tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 4LL) )
    {
      ...
      v12 = a2;
      v13 = v6;
      tlgWriteEx_EtwWriteEx(v8, (unsigned __int8 *)&byte_140024A71, v7, 1u, v9, v10, 6u, &v14);
    }
  }
}
