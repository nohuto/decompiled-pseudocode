/*
 * XREFs of MiStoreLogNotCandidate @ 0x14038AB88
 * Callers:
...
void __fastcall MiStoreLogNotCandidate(int a1)
{
  ...
  if ( *(_QWORD *)&qword_140C4ECE0 && a1 != -1073741401 && **(_DWORD **)&qword_140C4ECE0 > 5u )
  {
    if ( tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 0x400000000002LL) )
    {
      ...
      v14 = 4;
      v8 = v4;
      tlgWriteEx_EtwWriteEx(v3, (unsigned __int8 *)&word_140025A4E, v1, 1u, v5, v6, 4u, &v9);
    }
  }
}
