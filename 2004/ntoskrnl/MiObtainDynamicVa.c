/*
 * XREFs of MiObtainDynamicVa @ 0x14033DDBC
 * Callers:
 ...
 *     MiFindNextAlignedForwardRunClearEx @ 0x1403C2B54 (MiFindNextAlignedForwardRunClearEx.c)
 *     MiExtendDynamicBitMap @ 0x1403C621C (MiExtendDynamicBitMap.c)
 *     KiRemoveSystemWorkPriorityKick @ 0x1403EDAA4 (KiRemoveSystemWorkPriorityKick.c)
 */

__int64 __fastcall MiObtainDynamicVa(__int64 *a1, unsigned int a2, int a3)
{
  int v3; // r13d
...
LABEL_87:
  ...
  if ( v5 == &qword_140C4DFB8 )
  {
    qword_140C4DE48 -= v9 << 21;
    MiReclaimSystemVa(0LL);
  }
  _InterlockedExchangeAdd64(&qword_140C4F748[v32], v9);
  KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
