/*
 * XREFs of _CmDeleteInterfaceClassMappedPropertyFromRegValue @ 0x140976440
 * Callers:
...
__int64 __fastcall CmDeleteInterfaceClassMappedPropertyFromRegValue(__int64 a1, __int64 a2, HANDLE a3, __int64 a4)
{
...
LABEL_26:
      ...
      v5 = PnpOpenPropertiesKey(a1, (__int64)a3, 0LL, 2u, 0, v17, &KeyHandle);
      if ( v5 == -1073741772 )
      {
        v5 = -1073741275;
      }
