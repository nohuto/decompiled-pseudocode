/*
 * XREFs of PopNetUpdateDsAccounting @ 0x1405732A0
 * Callers:
...
__int64 __fastcall PopNetUpdateDsAccounting(char a1)
{
  ...
  if ( a1 )
  {
    if ( PopNetStandbyState == 2 )
      qword_140C23DB8 = MEMORY[0xFFFFF78000000008];
  }
  else if ( qword_140C23DB8 )
  {
    qword_140C23DC0 += (MEMORY[0xFFFFF78000000008] - qword_140C23DB8) / 0xAuLL;
    qword_140C23DB8 = 0LL;
  }
