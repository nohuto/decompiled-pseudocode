/*
 * XREFs of _CmOpenDeviceInterfaceRegKeyWorker @ 0x1406C035C
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  void *v33; // [rsp+58h] [rbp-28h] BYREF
...
LABEL_15:
      ...
      if ( Tree != -1073741444 )
      {
        ...
        if ( P )
          v24 = 917510;
        Tree = PnpCtxRegCreateTree(a1, (_DWORD)v19, v18, 0, v24, (__int64)P, (__int64)&v31, (__int64)a8);
        if ( Tree != -1073741444 )
        {
          if ( Tree >= 0 )
          {
            ...
            if ( a1 )
              ...
              v27 = 0LL;
            Tree = SysCtxRegOpenKey(v27, (__int64)v31, 0LL, 0, v21, (__int64)a7);
            if ( Tree == -1073741444 )
            {
              DeviceInterfaceRegKeyPath = -1073741772;
              goto LABEL_19;
...
LABEL_19:
           ...
           1u) )
    {
      ...
      DeviceInterfaceRegKeyPath = PnpCtxGetCachedContextBaseKey(a1, v13, (__int64)&v33);
      if ( DeviceInterfaceRegKeyPath < 0 )
        goto LABEL_19;
      v19 = v33;
      goto LABEL_15;
