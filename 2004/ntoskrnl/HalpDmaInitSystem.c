/*
 * XREFs of HalpDmaInitSystem @ 0x14099CA20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HalpDmaInitSystem(int a1, __int64 a2, __int64 a3)
{
  ...
  if ( !v5 )
  {
    ...
    qword_140C49BC8 = (__int64)&HalpDmaControllers;
    HalpDmaControllers = (__int64)&HalpDmaControllers;
    qword_140C4BCE8 = (__int64)&HalpDmaHibernateAdapters;
    HalpDmaHibernateAdapters = (__int64)&HalpDmaHibernateAdapters;
    qword_140C4BCC8 = (__int64)&HalpDmaPdoList;
