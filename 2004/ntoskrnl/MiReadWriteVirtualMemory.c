/*
 * XREFs of MiReadWriteVirtualMemory @ 0x1405EA680
 * Callers:
 *     NtReadVirtualMemory @ 0x1405EA650 (NtReadVirtualMemory.c)
 *     NtWriteVirtualMemory @ 0x140701830 (NtWriteVirtualMemory.c)
 * Callees:
 *     PsIsProcessLoggingEnabled @ 0x140205660 (PsIsProcessLoggingEnabled.c)
