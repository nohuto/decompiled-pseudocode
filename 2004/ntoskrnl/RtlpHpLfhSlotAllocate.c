/*
 * XREFs of RtlpHpLfhSlotAllocate @ 0x14028D3E0
 * Callers:
 *     ExAllocateHeapPool @ 0x14028C7B0 (ExAllocateHeapPool.c)
 *     RtlpHpLfhBucketAllocate @ 0x14038FB50 (RtlpHpLfhBucketAllocate.c)
 * Callees:
 ...
 *     RtlpLfhBlockBitmapAllocate @ 0x14028EA90 (RtlpLfhBlockBitmapAllocate.c)
 ...
 *     RtlpHpLfhSubsegmentSetUnusedBytes @ 0x14038FEA4 (RtlpHpLfhSubsegmentSetUnusedBytes.c)
...
unsigned __int64 __fastcall RtlpHpLfhSlotAllocate(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, unsigned int a5)
{
  ...
  int v206; // eax
  unsigned __int8 v207; // [rsp+40h] [rbp-C0h]
  ...
  int v224; // [rsp+88h] [rbp-78h] BYREF
  int v225; // [rsp+8Ch] [rbp-74h] BYREF
  int v226; // [rsp+90h] [rbp-70h] BYREF
  int v227; // [rsp+94h] [rbp-6Ch]
  int v228; // [rsp+98h] [rbp-68h] BYREF
  int v229; // [rsp+9Ch] [rbp-64h]
  int v230; // [rsp+A0h] [rbp-60h] BYREF
  int v231; // [rsp+A4h] [rbp-5Ch]
  int v232; // [rsp+A8h] [rbp-58h] BYREF
  int v233; // [rsp+ACh] [rbp-54h] BYREF
  int v234; // [rsp+B0h] [rbp-50h]
  int v235; // [rsp+B4h] [rbp-4Ch] BYREF
  int v236; // [rsp+B8h] [rbp-48h]
  int v237; // [rsp+BCh] [rbp-44h] BYREF
  unsigned int v238; // [rsp+C0h] [rbp-40h]
  int v239; // [rsp+C8h] [rbp-38h]
  int v240; // [rsp+CCh] [rbp-34h]
  int v241; // [rsp+D0h] [rbp-30h]
  int v242; // [rsp+D4h] [rbp-2Ch] BYREF
...
LABEL_262:
        ...
        KiAbThreadRemoveBoosts((ULONG_PTR)CurrentThread, v5 + 16, &v242);
          ...
          if ( v110(v114, v12 + v112, v113, v24) < 0 )
          {
            ...
            else
            {
              ...
              if ( (unsigned int)MiGetSystemRegionType(v12 + 24) == 1 )
                v174 = MmGetSessionIdEx((__int64)v173->ApcState.Process);
              else
                v174 = -1;
...
LABEL_352:
              ...
              KiAbThreadRemoveBoosts((ULONG_PTR)v173, v12 + 24, &v228);
              v94 = v173->SpecialApcDisable++ == -1;
              if ( v94 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v173->ApcState.ApcListHead[0].Flink != &v173->152 )
            ...
            if ( v215 == 2 )
            {
              if ( !*(_BYTE *)(v41 + 57) )
              {
                ...
                if ( (unsigned int)MiGetSystemRegionType(v186) == 1 )
                  v188 = (unsigned int)MmGetSessionIdEx((__int64)v187->ApcState.Process);
                else
                  v188 = 0xFFFFFFFFLL;
...
LABEL_391:
                ...
                KiAbThreadRemoveBoosts((ULONG_PTR)v187, v186, &v232);
                v94 = v187->SpecialApcDisable++ == -1;
                if ( v94 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v187->ApcState.ApcListHead[0].Flink != &v187->152 )
...
LABEL_155:
            ...
            --*(_BYTE *)(v115 + 794);
            KiAbThreadRemoveBoosts(v115, v12 + 24, &v230);
            v121 = v221;
...
LABEL_26:
      ...
      {
        v7 = 1;
        v169 = RtlpHpAcquireLockShared(v8, *(unsigned __int8 *)(v6 + 57));
        v6 = a1;
        v207 = v169;
      }
LABEL_39:
      ...
      if ( v7 == 2 )
      {
        ...
        if ( (unsigned int)MiGetSystemRegionType(v5 + 16) == 1 )
          v126 = MmGetSessionIdEx((__int64)v125->ApcState.Process);
        else
          v126 = -1;
...
LABEL_244:
        ...
        KiAbThreadRemoveBoosts((ULONG_PTR)v125, v5 + 16, &v225);
        v94 = v125->SpecialApcDisable++ == -1;
        if ( v94 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v125->ApcState.ApcListHead[0].Flink != &v125->152 )
...
LABEL_176:
      ...
      v7 = 2;
      v215 = 2;
      v207 = RtlpHpAcquireLockExclusive(v8, *(unsigned __int8 *)(a1 + 57));
...
LABEL_67:
      ...
      else
      {
        ...
        v88 = (unsigned int)MiGetSystemRegionType(v8) == 1
            ? (unsigned int)MmGetSessionIdEx((__int64)v87->ApcState.Process)
            : 0xFFFFFFFFLL;
...
LABEL_124:
        ...
        KiAbThreadRemoveBoosts((ULONG_PTR)v87, v8, &v224);
    ...
    v7 = 2;
    v215 = 2;
    v171 = RtlpHpAcquireLockExclusive(v8, *(unsigned __int8 *)(a1 + 57));
    v6 = a1;
    v207 = v171;
  }
  v60 = 3LL;
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( (_DWORD)v24 )
        break;
      LODWORD(v221) = 1;
      v124 = RtlpHpAcquireLockExclusive(v46 + 24, *(unsigned __int8 *)(a1 + 57));
      v24 = 1LL;
      v209 = v124;
    }
    v80 = v211;
...
LABEL_84:
  ...
  if ( v80 == -1 )
  {
    ...
    if ( (unsigned int)MiGetSystemRegionType(v46 + 24) == 1 )
      v148 = (unsigned int)MmGetSessionIdEx((__int64)v147->ApcState.Process);
    else
      v148 = 0xFFFFFFFFLL;
...
LABEL_282:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)v147, v46 + 24, &v237);
    v94 = v147->SpecialApcDisable++ == -1;
    if ( v94 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v147->ApcState.ApcListHead[0].Flink != &v147->152 )
...
LABEL_89:
  ...
  else
  {
    ...
    else
    {
      ...
      if ( (unsigned int)MiGetSystemRegionType(v46 + 24) == 1 )
        v198 = MmGetSessionIdEx((__int64)v197->ApcState.Process);
      else
        v198 = -1;
...
LABEL_432:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)v197, v46 + 24, &v235);
      v94 = v197->SpecialApcDisable++ == -1;
      if ( v94 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v197->ApcState.ApcListHead[0].Flink != &v197->152 )
