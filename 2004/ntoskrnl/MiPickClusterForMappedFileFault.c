/*
 * XREFs of MiPickClusterForMappedFileFault @ 0x14025ED3C
 * Callers:
...
LABEL_5:
  ...
  if ( !a3 && (v21 & 0x20000000) != 0 )
  {
    ...
    v27 = v22 & (dword_140C4EB50 - 1);
    if ( v17 > v12 + 8 * (((unsigned int)(dword_140C4EB50 - v27) >> 12) - 1LL) )
      v17 = v12 + 8 * (((unsigned int)(dword_140C4EB50 - v27) >> 12) - 1LL);
  }
  else
  {
    v22 = 0;
  ...
  else
  {
    ...
    {
      v28 = (v22 >> 12) & ((unsigned int)(dword_140C4EB50 - 1) >> 12);
      if ( v25 < v12 - 8 * v28 )
...
LABEL_6:
  ...
  if ( (_DWORD)v18 )
  {
    if ( a6 == -1 )
      v11 = 3;
    v9 = MiObtainFaultCharges(a1, v18, v11);
  }
  result = v9 + 1;
  if ( a6 == -1 )
    result = v9;
