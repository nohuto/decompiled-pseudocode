/*
 * XREFs of HsaFreeRemappingTableEntry @ 0x1404DE510
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HsaFreeRemappingTableEntry(__int64 a1, unsigned int a2, int a3)
{
  ...
  else
  {
    ...
    byte_140C48758 = HalpAcquireHighLevelLock(&qword_140C48750);
    ...
    *(_DWORD *)(DeviceAperture + 48) -= a3;
    ...
    v10 = (unsigned __int8)byte_140C48758;
    KxReleaseSpinLock(&qword_140C48750);
    if ( KiIrqlFlags )
    {
      if ( (KiIrqlFlags & 1) != 0 )
      {
