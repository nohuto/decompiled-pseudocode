      ...
      && a3 >= 0 )
    {
      ...
      if ( v9 )
      {
        ...
        else
        {
          ...
          if ( (a4 & 2) == 0 )
            v13 = a3;
          v14 = MiSecureVad((_DWORD)v10, v7, v6, v13, a4, (__int64)v16);
          MiUnlockAndDereferenceVad((PVOID)v10);
          if ( v14 >= 0 )
            return qword_140C4DC50 ^ (__int64)KeGetCurrentThread()->ApcState.Process ^ v16[0];
        }
      }
    }
  }
