/*
 * XREFs of KiResumeThread @ 0x1402FA1B0
 * Callers:
      ...
      *(_DWORD *)(a1 + 116) = v25;
      if ( v26 != 5
        || (LOBYTE(a3) = *(_BYTE *)(a1 + 391),
            LOBYTE(v15) = (v25 & 0x10) != 0,
            (unsigned int)KiTestForAlertPending(a1, v15, a3, 0LL)) )
      {
        v4 = 1;
      }
  ...
  if ( v14 != (_QWORD *)(a1 + 744) )
  {
    while ( 1 )
    {
      ...
      *(_QWORD *)v27 = 0LL;
      ...
      {
        LOBYTE(v42) = KeIsThreadRunning(v40->CurrentThread, v10);
      ...
      if ( (_QWORD *)*v38 == v38
        ...
        || (LOBYTE(v9) = KiWakeQueueWaiter((__int64)v40, v37, v27), !(_BYTE)v9) )
      {
        v43 = *(_DWORD *)(v37 + 4);
        *(_DWORD *)(v37 + 4) = v43 + 1;
        v9 = v37 + 24;
        ...
        *(_QWORD *)(v37 + 32) = v27;
        if ( !v43 && (_QWORD *)*v38 != v38 )
          LOBYTE(v9) = KiWakeOtherQueueWaiters((__int64)v40, v37, v11, (__int64)v12);
      }
