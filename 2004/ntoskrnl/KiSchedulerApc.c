/*
 * XREFs of KiSchedulerApc @ 0x1402FA4E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiRemoveQueueApc @ 0x1403005E4 (KiRemoveQueueApc.c)
 ...
 *     KiSuspendUmsThread @ 0x1408BA3A8 (KiSuspendUmsThread.c)
 */
...
char __fastcall KiSchedulerApc(ULONG_PTR a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 120) & 0x400) != 0 && !v7 )
  {
      ...
      && (NextThread = (__int64)CurrentPrcb->IdleThread, KiSetProcessorIdle((__int64)CurrentPrcb, 1, 1), NextThread) )
    {
      ...
      *(_BYTE *)(a1 + 643) = 38;
      *(_BYTE *)(a1 + 390) = 0;
      KiQueueReadyThread(CurrentPrcb, a1, v27, v28);
