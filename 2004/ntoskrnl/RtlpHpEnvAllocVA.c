        ...
        int a9)
{
  ...
  int v21; // eax
  int v22; // eax
  unsigned __int64 v23[2]; // [rsp+30h] [rbp-10h] BYREF
  ...
  if ( PoolMemory >= 0 && (v15 & 0x2000) != 0 )
  {
    ...
    if ( v19 != v23[0] )
    {
      v22 = RtlpHpEnvFreeVA(v23, &a8, 0x8000);
      v20 = a8;
      PoolMemory = v22;
      v19 = v24;
    }
    ...
    if ( v25 - v20 != v9 )
    {
      v21 = RtlpHpEnvFreeVA(v23, &a8, 0x8000);
      v19 = v24;
      PoolMemory = v21;
    }
    *a1 = v19;
