/*
 * XREFs of CcLazyWriteScan @ 0x1402C5C5C
 * Callers:
 ...
 *     CcPostWorkQueue @ 0x1402C64F8 (CcPostWorkQueue.c)
 *     CcScanLogHandleList @ 0x1402C69F4 (CcScanLogHandleList.c)
 *     CcCalculatePagesToWrite @ 0x1402C7A40 (CcCalculatePagesToWrite.c)
 *     CcSetLazyWriteScanQueued @ 0x1402C8D80 (CcSetLazyWriteScanQueued.c)
 *     CcRescheduleLazyWriteScan @ 0x1402C8DC4 (CcRescheduleLazyWriteScan.c)
 *     CcAdjustThrottle @ 0x1402C9370 (CcAdjustThrottle.c)
 *     CcUpdateTimeOnLogHandles @ 0x14034F1BC (CcUpdateTimeOnLogHandles.c)
 *     CcComputeNextScanTime @ 0x14035C9C4 (CcComputeNextScanTime.c)
...
__int64 __fastcall CcLazyWriteScan(__int64 a1, int a2, __int64 a3)
{
  ...
  unsigned __int64 v87; // [rsp+98h] [rbp-1h] BYREF
  __int64 v88; // [rsp+A0h] [rbp+7h]
  __int64 v89; // [rsp+A8h] [rbp+Fh]
  _QWORD v90[8]; // [rsp+B0h] [rbp+17h] BYREF
  char v91; // [rsp+100h] [rbp+67h]
  unsigned int v92; // [rsp+110h] [rbp+77h]
...
LABEL_89:
  ...
  *(_BYTE *)(a1 + 633) = 0;
  v19 = CcCalculatePagesToWrite(a1, v3, (int)a1 + 640, (int)a1 + 664, 0);
  v20 = *(unsigned int *)(a1 + 496);
  v82 = v19;
  v21 = v19;
  CcAdjustThrottle(a1, a1 + 640, a1 + 664, v20);
  ...
  if ( *(_QWORD *)(a1 + 72) != 136LL )
  {
    while ( 1 )
    {
      ...
      if ( v25 )
        v29 = v25;
      v89 = v29;
      v30 = CcShouldLazyWriteCacheMap(v26, v82, v28 & 0xFFFFFFFFFFFFFFF0uLL, v92);
      v31 = *(_DWORD *)(v26 + 152);
      if ( v30 )
        break;
...
LABEL_45:
    ...
    *(_DWORD *)(v26 + 152) |= 0x20u;
    ...
    __writecr8(v39);
    WorkQueueEntry = CcAllocateWorkQueueEntry(a1, (PSLIST_ENTRY *)&v87);
...
LABEL_19:
  ...
  if ( (_BYTE)dword_140CFB19C
    ...
    || (CcComputeNextScanTime(a1, v90, &v86), v86 != 0x7FFFFFFFFFFFFFFFLL) )
  {
  ...
  if ( (xmmword_140CFC490 & 0x20000) != 0 )
    CcPerfLogLoggedStreamsStats(v92, *(unsigned int *)(a1 + 496));
  result = a1 + 784;
