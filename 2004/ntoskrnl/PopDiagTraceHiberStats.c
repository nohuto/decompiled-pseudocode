/*
 * XREFs of PopDiagTraceHiberStats @ 0x140761F6C
 * Callers:
...
char PopDiagTraceHiberStats()
{
  ...
  v3 = qword_140C23470;
  qword_140C234B0 -= qword_140C23498 + qword_140C23490;
  qword_140C23478 = v2 - (qword_140C23498 + qword_140C23490);
  dword_140C2357C = dword_140C23064;
  dword_140C23578 = dword_140C230E8;
  v20 = qword_140C23470;
  LODWORD(qword_140C23528) = PopQpcTimeInMs(&qword_140C23358, &qword_140C23360);
  qword_140C233D8 = (unsigned int)PopQpcTimeInMs(&qword_140C23328, &qword_140C233E0);
  PopComputeDerivedHiberStats(&qword_140C23398, v3, &v21);
  v4 = 47LL;
  ...
  qword_140C234F0 /= v3;
  qword_140C233A0 /= v3;
  v15 = qword_140C23478 / v3 - (unsigned int)qword_140C233E8 - (unsigned int)dword_140C233F0;
  qword_140C23580 = v15;
  if ( v1 )
  {
    RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"KernelResumeIoCpuTime");
    ZwSetValueKey(v1, (PUNICODE_STRING)&DestinationString[1], 0, 4u, &qword_140C234F0, 4u);
    RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"HiberIoCpuTime");
    ZwSetValueKey(v1, (PUNICODE_STRING)&DestinationString[1], 0, 4u, &qword_140C233A0, 4u);
    if ( qword_140C23518 )
    {
      dword_140C23044 += PopQpcTimeInMs(&qword_140C23348, &qword_140C23520);
      RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"HybridBootAnimationTime");
      ZwSetValueKey(v1, (PUNICODE_STRING)&DestinationString[1], 0, 4u, &dword_140C23044, 4u);
    }
    qword_140C23588 = (((unsigned __int64)MEMORY[0xFFFFF78000000004] << 32)
                     * (unsigned __int128)(unsigned __int64)(MEMORY[0xFFFFF78000000320] << 8)) >> 64;
    RtlInitUnicodeString((PUNICODE_STRING)&DestinationString[1], L"ResumeCompleteTimestamp");
    ZwSetValueKey(DestinationString[0], (PUNICODE_STRING)&DestinationString[1], 0, 0xBu, &qword_140C23588, 8u);
