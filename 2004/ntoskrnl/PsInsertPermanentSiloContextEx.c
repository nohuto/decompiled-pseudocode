/*
 * XREFs of PsInsertPermanentSiloContextEx @ 0x14070FE94
 * Callers:
 *     CmpGetOrCreateContextForSiloNoRef @ 0x14070FDD8 (CmpGetOrCreateContextForSiloNoRef.c)
 *     PsInsertPermanentSiloContext @ 0x1407C1990 (PsInsertPermanentSiloContext.c)
 ...
 *     PspIsSiloContext @ 0x140710088 (PspIsSiloContext.c)
 */
