/*
 * XREFs of MiLockAddressSpaceToo @ 0x140252198
 * Callers:
...
LABEL_10:
  ...
  if ( v4 >= 0xFFFF800000000000uLL && byte_140C4F7C8[((v4 >> 39) & 0x1FF) - 256] == 1 )
...
LABEL_11:
  ...
  result = (_QWORD *)KiAbThreadRemoveBoosts((ULONG_PTR)v5, v4, &v13);
