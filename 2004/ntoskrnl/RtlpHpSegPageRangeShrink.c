/*
 * XREFs of RtlpHpSegPageRangeShrink @ 0x140259780
 * Callers:
...
__int64 __fastcall RtlpHpSegPageRangeShrink(__int64 a1, __int64 a2, __int64 a3, __int64 SchedulerAssist)
{
  ...
  *(_DWORD *)a2 = -857879331;
  *(_BYTE *)(a2 + 24) &= 0xF3u;
  v11 = RtlpHpSegPageRangeCoalesce(a1, a2, v5, 0, (__int64)&v41);
  v12 = *(_BYTE *)(a1 + 13);
  v13 = v11;
  if ( (v12 & 0x10) != 0
...
LABEL_28:
    ...
    RtlRbInsertNodeEx(a1 + 96, v15, v16, v13);
  ...
  if ( (v5 & 1) == 0 )
  {
    if ( (*(_DWORD *)(a1 + 40) & 1) != 0 )
    {
      ...
      {
        v22 = v41;
        if ( (unsigned __int8)v41 <= 0xFu && v35 >= 2u )
        {
...
LABEL_66:
        if ( (*((_DWORD *)&v24->0 + 1) & 0x10000) == 0 )
          KeBugCheckEx(0x162u, (ULONG_PTR)v24, a1 + 64, (unsigned int)SessionId, 0LL);
      }
      else
      {
        *(_BYTE *)(v30 + 32) |= 2u;
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)v24, a1 + 64, &v40);
