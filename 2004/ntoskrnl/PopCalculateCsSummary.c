/*
 * XREFs of PopCalculateCsSummary @ 0x14056AA60
 * Callers:
 ...
 *     PopBatteryCapacityToRate @ 0x14056E978 (PopBatteryCapacityToRate.c)
 *     PopBatteryGetEnergyDrainFromDischage @ 0x14056E99C (PopBatteryGetEnergyDrainFromDischage.c)
...
__int64 __fastcall PopCalculateCsSummary(__int64 a1, int a2)
{
  ...
  v52 = HIDWORD(xmmword_140C23154);
  if ( HIDWORD(xmmword_140C23154) )
    LODWORD(v8) = (unsigned int)(100 * xmmword_140C23164) / HIDWORD(xmmword_140C23154);
  else
    LOBYTE(v8) = 0;
  v9 = 0;
  if ( (xmmword_140C23154 & 0x40000000) == 0 )
    v9 = xmmword_140C23164;
  v51 = v8;
  v40 = *((_QWORD *)&v45 + 1) - qword_140C4FD10;
  v31 = v9;
  v32 = DWORD2(v46) - dword_140C4FD20;
  v10 = PopCalculateTotalHwDripsResidency(qword_140C4FD98, v46, v5);
  v11 = v5 + qword_140C4FD18 - v45;
  v44 = v10;
  v12 = _InterlockedExchangeAdd64(&qword_140C4FE40, 0LL);
  if ( v12 )
    v12 = (v12 - qword_140C4FD08) / 0xA;
  v36 = qword_140C4FD50;
  v36 -= PpmConvertTime(qword_140C4FD40, PopQpcFrequency, 0xF4240uLL);
  v13 = qword_140C4FD60;
  v43 = v5 - qword_140C4FD50;
  if ( qword_140C4FD58 )
  {
  ...
  v15 = v13 / 0xA;
  v41 = PpmConvertTime(qword_140C4FD70, PopQpcFrequency, 0xF4240uLL);
  v42 = PpmConvertTime(qword_140C4FD80, PopQpcFrequency, 0xF4240uLL);
  v34 = 0LL;
  v35 = 0LL;
  ModernStandbyTransitionReason = PopGetModernStandbyTransitionReason(0LL, 0LL);
  PpmGetPlatformSelectionVetoCounts(dword_140C4FE80, &v34, &v35);
  v34 -= qword_140C4FDA0;
  v35 -= qword_140C4FDA8;
  if ( qword_140C4FD28 )
  {
    v16 = 100 * qword_140C4FD30 % (unsigned __int64)qword_140C4FD28;
    v38 = 100 * qword_140C4FD30 / (unsigned __int64)qword_140C4FD28;
  }
  v50 = 0;
  PopQueryInputSuppressionCount(&v50, v16);
  v18 = v50 - dword_140C4FDF8;
  v19 = v52;
  v20 = v47;
  *(_DWORD *)a1 = v49;
  *(_QWORD *)(a1 + 40) = v40;
  ...
  *(_QWORD *)(a1 + 152) = v6;
  v50 = v18;
  *(_BYTE *)(a1 + 125) ^= (byte_140C4FDC1 ^ v22) & 1;
  LOBYTE(v19) = *(_BYTE *)(a1 + 125) ^ (byte_140C4FDC1 ^ *(_BYTE *)(a1 + 125)) & 2;
  *(_BYTE *)(a1 + 125) = v19;
  *(_BYTE *)(a1 + 125) = v19 ^ (byte_140C4FDC1 ^ v19) & 4;
  *(_DWORD *)(a1 + 164) = dword_140C4FDB0;
  *(_DWORD *)(a1 + 168) = dword_140C4FDB4;
  *(_BYTE *)(a1 + 172) = byte_140C4FDB8;
  *(_DWORD *)(a1 + 176) = dword_140C4FDBC;
  *(_DWORD *)(a1 + 180) = dword_140C4FDC4;
  *(_DWORD *)(a1 + 184) = dword_140C4FDC8;
  *(_BYTE *)(a1 + 188) = byte_140C4FDCC;
  *(_DWORD *)(a1 + 192) = HIDWORD(v48[0]);
  *(_DWORD *)(a1 + 196) = DWORD2(v48[0]);
  *(_BYTE *)(a1 + 204) = byte_140C4FDD4;
  *(_BYTE *)(a1 + 205) = byte_140C4FDD5;
  *(_DWORD *)(a1 + 208) = dword_140C4FDD8;
  *(_DWORD *)(a1 + 212) = dword_140C4FDDC;
  *(_DWORD *)(a1 + 216) = v18;
  *(_QWORD *)(a1 + 224) = qword_140C4FD88;
  *(_QWORD *)(a1 + 232) = qword_140C4FD90;
  *(_DWORD *)(a1 + 264) = dword_140C4FDFC;
  *(_DWORD *)(a1 + 268) = dword_140C4FE00;
  v25 = KeAcquireSpinLockRaiseToDpc(&qword_140C23C58);
  *(_QWORD *)(a1 + 248) = qword_140C23C48;
  *(_QWORD *)(a1 + 240) = qword_140C23C50;
