/*
 * XREFs of PopInitializePowerButtonHold @ 0x140A3C87C
 * Callers:
...
void __fastcall PopInitializePowerButtonHold(int a1)
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      if ( ZwOpenKey(&KeyHandle, 0x11u, &ObjectAttributes) >= 0 )
      {
        *(_QWORD *)PopPowerButtonBugcheckWatchWorkItem = 0LL;
        qword_140C206F0 = (__int64)PopPowerButtonBugcheckWatchCallback;
        qword_140C206F8 = (__int64)KeyHandle;
  ...
  else
  {
    ...
    memset(&unk_140C20608, 0, 0xC8uLL);
    memset(&PopPowerButtonTriageBlock, 0, 0x70uLL);
    dword_140C205D0 = 0;
    dword_140C205D4 = 0;
    PopPowerButtonHold = 0LL;
    qword_140C205E0 = (__int64)&PopBlackBoxEntries;
    LODWORD(PopPowerButtonTriageBlock) = 2;
    dword_140C205E8 = 22;
    PopInitializeWorkItem((__int64)&unk_140C20690, (__int64)PopPowerButtonWorkCallback, 0LL);
  }
}
