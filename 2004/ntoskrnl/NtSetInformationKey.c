/*
 * XREFs of NtSetInformationKey @ 0x1406726A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
      ...
      if ( !v33
        || (v19 = CmKeyBodyReplicateToVirtual(&DmaAdapter, v34, 2u, (__int64)&SubjectContext),
            v7 = v33,
            v20 = DmaAdapter,
            v19 >= 0) )
      {
