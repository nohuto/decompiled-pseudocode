/*
 * XREFs of CmpSortedValueEnumStackCleanup @ 0x14087817C
 * Callers:
 ...
 *     CmpSortedValueEnumStackGetEntryAtLayerHeight @ 0x1408783A4 (CmpSortedValueEnumStackGetEntryAtLayerHeight.c)
 */
