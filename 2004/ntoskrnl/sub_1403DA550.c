/*
 * XREFs of sub_1403DA550 @ 0x1403DA550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1403DA550(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v7; // r10
  char v8; // r8
  ...
  v7 = *(_QWORD *)(a1 + 32);
  v8 = 1;
  v9 = (unsigned __int64)&qword_140C12E88 ^ ((v7 ^ ((v7 ^ 0xE0E20100uLL) >> 4)) >> 4);
  v10 = v9;
  if ( (v9 & 0xF) != 0 )
    v8 = v9 & 0xF;
  for ( ; v8; --v8 )
