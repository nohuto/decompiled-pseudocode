/*
 * XREFs of SdbpGetFirstIndexedRecord @ 0x1407442FC
 * Callers:
 ...
 *     SdbpBinarySearchFirst @ 0x140744D20 (SdbpBinarySearchFirst.c)
 *     SdbpBinarySearchUnique @ 0x14076C378 (SdbpBinarySearchUnique.c)
 */
