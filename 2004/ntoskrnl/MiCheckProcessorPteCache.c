/*
 * XREFs of MiCheckProcessorPteCache @ 0x14021AC30
 * Callers:
...
LABEL_9:
      ...
      if ( v13 + a1 > 8 )
      {
        ...
        if ( !a1 )
          goto LABEL_13;
        v15 = byte_14001D960[a1];
      }
      else
      {
        v15 = byte_14001D960[a1] << v13;
      }
      *v14 |= v15;
LABEL_13:
      v4 = qword_140C4ED50 + 8 * (v12 + CurrentPrcb->PteBitOffset);
LABEL_14:
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
...
LABEL_21:
  while ( 2 )
  {
    ...
    if ( qword_140C4ED88 )
    {
      while ( qword_140C4ED40 < v18 )
      {
        KeAcquireInStackQueuedSpinLock(&qword_140C4ED70, &LockHandle);
      ...
      v19 = (__int64 *)&v61;
      *(_QWORD *)&v61 = qword_140C4ED40 - v18;
      *((_QWORD *)&v61 + 1) = qword_140C4ED48 + 8 * (v18 >> 6);
      if ( v17 )
        v17 -= v18;
    }
LABEL_25:
...
LABEL_30:
          ...
          if ( v26 <= v23 && v26 != -1LL )
          {
            ...
            v28 = *(_QWORD *)(qword_140C4ED48 + 8 * (v27 >> 6));
            v29 = (volatile signed __int64 *)(qword_140C4ED48 + 8 * (v27 >> 6));
            if ( v28 != -1LL )
            {
              while ( 1 )
              {
...
LABEL_91:
    ...
    if ( (unsigned int)MiEmptyPteBins(&qword_140C4ED40, 0LL) )
    {
      v17 = 0LL;
      continue;
    }
