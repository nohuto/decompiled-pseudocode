/*
 * XREFs of KeResumeClockTimerFromIdle @ 0x140219980
 * Callers:
 ...
 *     KiGetPendingTick @ 0x1403499E0 (KiGetPendingTick.c)
 ...
 *     ExRecordOneTimerExpiry @ 0x1405B11A0 (ExRecordOneTimerExpiry.c)
 */
...
void __fastcall KeResumeClockTimerFromIdle(_DWORD *a1)
{
  ...
  KiClockLatencyMeasurementEnabled = 0;
  if ( v9 - KiClockTimerOneShotStartTime < qword_140C31368 )
    qword_140C31368 = v9 - KiClockTimerOneShotStartTime;
  if ( v9 - KiClockTimerOneShotStartTime > qword_140C31360 )
    qword_140C31360 = v9 - KiClockTimerOneShotStartTime;
