/*
 * XREFs of ?StDmPageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x1403056F4
 * Callers:
 ...
 *     MmAreMdlPagesCached @ 0x14033ACF0 (MmAreMdlPagesCached.c)
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmPageRetrieve(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_BYTE *)(a3 + 8) = 0;
  ...
  v24 = v8;
  v23 = v10;
  if ( !v6 && !(unsigned int)MmAreMdlPagesCached(*(_QWORD *)(a3 + 16)) )
...
LABEL_12:
  ...
  if ( v22 != (__int64 *)&v21 )
  {
    while ( v17 != (__int64 *)&v21 )
    {
      ...
      ST_STORE<SM_TRAITS>::StDmDeviceIoCompletion(a1, v19);
      v17 = v22;
    }
    return 259;
  }
