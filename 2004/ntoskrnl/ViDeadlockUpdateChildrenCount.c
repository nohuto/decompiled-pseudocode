/*
 * XREFs of ViDeadlockUpdateChildrenCount @ 0x1409DCF04
 * Callers:
 *     VfDeadlockAcquireResource @ 0x1409DA5B8 (VfDeadlockAcquireResource.c)
 *     ViDeadlockMergeNodes @ 0x1409DC604 (ViDeadlockMergeNodes.c)
 *     ViDeadlockRemoveNode @ 0x1409DC904 (ViDeadlockRemoveNode.c)
 * Callees:
 *     <none>
 */
