/*
 * XREFs of PsQueryProcessSignatureMitigationPolicy @ 0x14070CD80
 * Callers:
...
void __fastcall PsQueryProcessSignatureMitigationPolicy(__int64 a1, _DWORD *a2, __int64 a3)
{
  ...
  *a2 = 0;
  ...
  else if ( qword_140C1D8E0
         && (LOBYTE(a2) = 6, (unsigned int)qword_140C1D8E0(a1, a2, a3))
         && qword_140C1D8E0
         && (LOBYTE(v7) = *(_BYTE *)(v3 + 2169), LOBYTE(v6) = 6, (unsigned int)qword_140C1D8E0(v7, v6, v8)) )
  {
    *v5 |= 2u;
  }
