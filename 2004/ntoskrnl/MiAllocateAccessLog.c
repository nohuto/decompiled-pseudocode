/*
 * XREFs of MiAllocateAccessLog @ 0x140247E40
 * Callers:
...
_QWORD *__fastcall MiAllocateAccessLog(__int64 a1)
{
  ...
  v2 = *(_QWORD *)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(a1 + 174));
  if ( (unsigned int)MiSufficientAvailablePages(v2, 1056LL)
    && *(__int64 *)(v2 + 7168) >= 1056
    && (unsigned __int64)(MiState[0] - qword_140C4C6C8) >= 0x800 )
  {
    v3 = 4096LL;
  }
  else
