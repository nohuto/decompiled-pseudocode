/*
 * XREFs of PopEsUpdateState @ 0x140398018
 * Callers:
 ...
 *     PopEsSnapTelemetry @ 0x140766250 (PopEsSnapTelemetry.c)
...
LABEL_19:
    ...
    if ( dword_140C238F0 )
    {
      if ( BYTE1(v14[0]) )
      {
        if ( v14[2] )
        {
          ...
          if ( (unsigned int)result <= dword_140C238F0 )
          {
            v6 = 2;
            goto LABEL_19;
          }
  ...
  if ( byte_140C238F4 && dword_140C238F0 && PopEsBgActivityPolicy == 1 )
  {
    v6 = 8;
    goto LABEL_19;
  }
