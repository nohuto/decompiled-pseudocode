/*
 * XREFs of PopPowerAggregatorHandleModernStandbyIntent @ 0x1408EAF50
 * Callers:
 *     PopPowerAggregatorHandleIntentUnsafe @ 0x140763854 (PopPowerAggregatorHandleIntentUnsafe.c)
 * Callees:
 *     PopPowerAggregatorAllowModernStandbyPromotion @ 0x1408EAB6C (PopPowerAggregatorAllowModernStandbyPromotion.c)
 *     PopPowerAggregatorGetModernStandbySessionType @ 0x1408EAE48 (PopPowerAggregatorGetModernStandbySessionType.c)
 */
