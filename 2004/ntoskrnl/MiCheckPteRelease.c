/*
 * XREFs of MiCheckPteRelease @ 0x14054E630
 * Callers:
...
__int64 __fastcall MiCheckPteRelease(__int64 a1, ULONG_PTR a2)
{
  ...
  v5 = 2LL * (unsigned int)((a1 - qword_140C4ED50) >> 3);
  if ( _bittest64((const signed __int64 *)qword_140C4E8E0, v5) )
    KeBugCheckEx(0xDAu, 0x303uLL, v4, a2, 0LL);
  LOBYTE(v6) = 2;
  if ( v5 && *(_DWORD *)(qword_140C4E8E0 + 4 * ((v5 - 2) >> 5)) >> ((v5 - 2) & 0x1F) == 2 )
    KeBugCheckEx(0xDAu, 0x304uLL, v4, a2, 0LL);
  for ( i = v5 + 1; _bittest64((const signed __int64 *)qword_140C4E8E0, i) == 1; i += 2LL )
    ;
  ...
  v10 = 2LL * (unsigned int)((a1 - qword_140C4ED50) >> 3);
  if ( v5 < v9 )
  {
    do
    {
      if ( _bittest64((const signed __int64 *)qword_140C4E8E0, v10) == 1 )
