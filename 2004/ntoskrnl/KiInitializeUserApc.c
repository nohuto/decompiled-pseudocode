/*
 * XREFs of KiInitializeUserApc @ 0x1402E30B0
 * Callers:
        ...
        char a7)
{
  ...
  *(_WORD *)(a2 + 368) = 51;
  ...
  if ( result >= qword_140C4C5D0 )
  {
    ...
    while ( v20 >= 8 )
    {
      v21 = __ROR8__(v21 - *v18++, qword_140C4C5C8);
      v20 -= 8;
    }
    while ( v20 )
    {
      v21 = __ROR8__(v21 - *(unsigned __int8 *)v18, qword_140C4C5C8);
      v18 = (_QWORD *)((char *)v18 + 1);
      --v20;
    }
    if ( qword_140C4C5D8 != v21 )
    {
      if ( qword_140C4C590 )
        goto LABEL_29;
      qword_140C4C590 = (unsigned int)__ROR4__(150994945, 88);
      qword_140C4C598 = 0LL;
      qword_140C4C5A0 = 0LL;
      qword_140C4C5A8 = 269LL;
      qword_140C4C5B0 = v34;
    }
    if ( !qword_140C4C590 )
    {
