/*
 * XREFs of IopBuildDeviceIoControlRequest @ 0x140220620
 * Callers:
        ...
        __int64 a10)
{
  ...
  *(_DWORD *)(v16 - 48) = a1;
  ...
  if ( v17 )
  {
    ...
    if ( a3 )
    {
      Pool_0 = (struct _IRP *)IopVerifierExAllocatePool_0(516LL, v10);
      v15->AssociatedIrp.MasterIrp = Pool_0;
      if ( !Pool_0 )
        goto LABEL_36;
...
LABEL_36:
  ...
  if ( (_DWORD)v10 || Length )
  {
    ...
    if ( (unsigned int)v10 <= Length )
      v18 = Length;
    v19 = (struct _IRP *)IopVerifierExAllocatePool_0(516LL, v18);
