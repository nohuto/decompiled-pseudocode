/*
 * XREFs of RtlDispatchException @ 0x1402E6C20
 * Callers:
 ...
 *     RtlpExecuteHandlerForException @ 0x1403FFF80 (RtlpExecuteHandlerForException.c)
 *     memset @ 0x14040A280 (memset.c)
 *     RtlpLogExceptionDispatch @ 0x14057FB00 (RtlpLogExceptionDispatch.c)
 *     RtlpLogExceptionHandler @ 0x14057FCA0 (RtlpLogExceptionHandler.c)
 */
...
BOOLEAN __cdecl RtlDispatchException(PEXCEPTION_RECORD ExceptionRecord, PCONTEXT ContextRecord)
{
  ...
  v7 = v39 == 10;
  v39 = v7;
  if ( !RtlpGetStackLimitsEx(Rsp, &v45, &v44) )
  {
  ...
  while ( 1 )
  {
    ...
    if ( v28 )
    {
      ...
      if ( v13 != (PRUNTIME_FUNCTION)ControlPc[2]
        || (v14 = ImageBase,
            (int)RtlLookupExceptionHandler((_DWORD)v13, ImageBase, 2, v31, (__int64)&ContextEx, (__int64)&HandlerData) < 0)
