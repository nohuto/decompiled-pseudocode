/*
 * XREFs of KiGetNextTimerExpirationDueTime @ 0x14021A340
 * Callers:
 ...
 *     KeEstimateClockTickDuration @ 0x14050E730 (KeEstimateClockTickDuration.c)
 * Callees:
 *     KiFindNextTimerDueTime @ 0x14021A620 (KiFindNextTimerDueTime.c)
 *     KeIsEmptyAffinityEx @ 0x14021D300 (KeIsEmptyAffinityEx.c)
 *     _guard_dispatch_icall @ 0x1403FFC70 (_guard_dispatch_icall.c)
 *     ExGetNextWakeTimeForDeepSleep @ 0x1405B0B44 (ExGetNextWakeTimeForDeepSleep.c)
 */
...
LABEL_7:
  if ( *(_BYTE *)(a1 + 33) )
  {
    ...
    do
    {
      v21 = qword_140C31A90[3 * v12];
      if ( v12 == 2 )
      {
        if ( v21 < v8 )
          v8 = qword_140C31A90[6];
      }
      else if ( v21 < v15 )
      {
        v15 = qword_140C31A90[3 * v12];
        if ( v12 == 4 )
          LOBYTE(v16) = 1;
      }
      ++v12;
