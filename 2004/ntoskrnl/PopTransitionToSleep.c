/*
 * XREFs of PopTransitionToSleep @ 0x140992920
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall PopTransitionToSleep(struct _KEVENT *a1)
{
  ...
  if ( Lock == 3 || Lock == 6 )
  {
    ...
    *(_QWORD *)&v13 = PopMirrorPhysicalMemory;
    ...
    else if ( (dword_140C22E4C & 0x20) != 0 && PopEnableMinimalHiberFile || PopForceMinimalHiberFile )
    {
      MmEmptyAllWorkingSets();
      v6 = 1;
      v8 = v14 | 4;
...
LABEL_11:
  ...
  KeSetEvent(a1, 0, 1u);
  KeWaitForSingleObject(&a1[1], Executive, 0, 0, 0LL);
  v9 = PopInvokeSystemStateHandler(Lock, qword_140C22E80);
LABEL_14:
  v10 = v9;
LABEL_15:
  qword_140C234A0 = __rdtsc();
