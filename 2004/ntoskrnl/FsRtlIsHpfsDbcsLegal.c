/*
 * XREFs of FsRtlIsHpfsDbcsLegal @ 0x140889B40
 * Callers:
 *     FsRtlIsHpfsDbcsLegal @ 0x140889B40 (FsRtlIsHpfsDbcsLegal.c)
 * Callees:
          ...
          do
          {
            ...
            if ( (unsigned __int8)v13 >= 0x80u && (_BYTE)NlsMbOemCodePageTag && NlsOemLeadByteInfoTable[v13] )
            {
              ...
              ++v12;
                   ...
                   && ((WildCardsPermissible != 0 ? 10 : 2) & *((unsigned __int8 *)qword_1400117C0 + v13)) == 0 )
            {
              return 0;
            }
            ++v12;
