/*
 * XREFs of EtwpQueryCoverageSamplerInformation @ 0x140944254
 * Callers:
 ...
 *     EtwpCoverageSamplerQueryStatusInformation @ 0x140943A3C (EtwpCoverageSamplerQueryStatusInformation.c)
 */
...
LABEL_4:
  ...
  {
    Object = 0LL;
    StatusInformation = ObReferenceObjectByHandle(Handle[1], 1u, qword_140C196D0, a3, &Object, 0LL);
