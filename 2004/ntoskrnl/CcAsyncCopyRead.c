/*
 * XREFs of CcAsyncCopyRead @ 0x1402C7F30
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a8)
{
  ...
  ListEntry = 0LL;
  v13 = *(_QWORD *)(v11 + 8);
  Partition = CcGetPartition((_QWORD *)v13, (__int64)a2, a3, a4);
  if ( (signed __int64)(*a2 + v9) > *(_QWORD *)(v13 + 8) )
  ...
  {
    if ( ((v9 + 4095) & 0xFFFFF000) != 0 )
      _InterlockedExchangeAdd64(DeepFreezeStartTime, (v9 + 4095) & 0xFFFFF000);
  ...
  *((_QWORD *)&v25[6].Next + 1) = 0LL;
  IoReferenceIoAttributionFromThread(CurrentThread, &v25[6].Next + 1);
