/*
 * XREFs of ViFlushDoubleBuffer @ 0x1409CB200
 * Callers:
 ...
 *     ViFindMappedRegisterInFile @ 0x1409CB1C8 (ViFindMappedRegisterInFile.c)
 *     ViFreeMapRegistersToFile @ 0x1409CB56C (ViFreeMapRegistersToFile.c)
...
__int64 __fastcall ViFlushDoubleBuffer(_QWORD *a1, __int64 a2, int a3, unsigned int a4, char a5)
{
  ...
  {
    ViHalPreprocessOptions(byte_140C12CF8, "Cannot flush buffers that aren't mapped (Addr %p).", (const void *)0x16);
    VfReportIssueWithOptions(0xE6u, 0x16uLL, v10, (ULONG_PTR)a1, 0LL, byte_140C12CF8);
    return 0LL;
  }
  v12 = a1[7];
  ...
  if ( (unsigned int)v6 > v16 )
  {
    ViHalPreprocessOptions(
      ...
      0x10000000,
      1);
    VfReportIssueWithOptions(0xE6u, 0LL, 1uLL, v16, v6, byte_140C12CFC);
    v13 = v18[0];
    LODWORD(v6) = v16;
  }
  if ( !a5 )
