/*
 * XREFs of MiFindEmptyAddressRangeDownTree @ 0x1406DDD44
 * Callers:
 *     MiFinishCreateSection @ 0x1405FB480 (MiFinishCreateSection.c)
 *     MiFindEmptyAddressRangeDown @ 0x1406DDC30 (MiFindEmptyAddressRangeDown.c)
 * Callees:
 *     MiHonorRangeStraddleRequirement @ 0x14033A978 (MiHonorRangeStraddleRequirement.c)
