/*
 * XREFs of RtlpHpSegSizeInternal @ 0x14058FBF0
 * Callers:
 *     RtlpHpSizeHeapInternal @ 0x14058F640 (RtlpHpSizeHeapInternal.c)
 * Callees:
 *     RtlpHpLfhSubsegmentSizeBlock @ 0x14058FC80 (RtlpHpLfhSubsegmentSizeBlock.c)
 *     RtlpHpVsChunkSize @ 0x14059025C (RtlpHpVsChunkSize.c)
 */
