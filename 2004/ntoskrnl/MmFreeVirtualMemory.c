/*
 * XREFs of MmFreeVirtualMemory @ 0x1405F9180
 * Callers:
 *     PsDispatchIumService @ 0x14057D8B4 (PsDispatchIumService.c)
 *     NtFreeVirtualMemory @ 0x1405F90B0 (NtFreeVirtualMemory.c)
...
LABEL_18:
  ...
  else
  {
    ...
    {
      v13 = 1;
      KiStackAttachProcess((_KPROCESS *)BugCheckParameter1a, 0LL, (__int64)&v55);
    }
    v10 = v39;
    v12 = v43;
  }
  ...
  while ( 1 )
  {
    ...
    {
      v47 = *((unsigned int *)v17 + 7) | ((unsigned __int64)*((unsigned __int8 *)v17 + 33) << 32);
      v21 = v20;
      v14 = (v20 << 12) | 0xFFF;
...
LABEL_49:
    ...
    if ( (*(_DWORD *)(v15 + 1124) & 0x20) == 0 )
    {
      ...
      v30 = (_DWORD)v19 << 12;
LABEL_66:
      v16 = MiCheckSecuredVad((_DWORD)v17, v30, (v29 + 1) << 12, 85, a5);
      goto LABEL_67;
    }
    v16 = 0;
LABEL_67:
...
LABEL_69:
    if ( !(_DWORD)BugCheckParameter1a )
    {
      ...
      if ( (v34 & 0x100000) == 0
        || (v34 & 0x1000000) != 0
        || (v34 & 0x2000000) == 0
        || (v35 = MiDecommitEnclavePages(v15, (_DWORD)v17, v43, v33, v28), v16 = v35, v35 == -1073741802) )
      {
        v36 = *((_DWORD *)v17 + 12);
        if ( (v17[12] & 0x70) == 0x30
          || (v36 & 0x100000) != 0
          && ((v36 & 0x400000) != 0 || (v36 & 0xC0000u) >= 0x80000)
          && ((v36 & 0x500000) != 0x500000
           || v33 && (((MiGetVadPageSize((__int64)v17) << 12) - 1) & (v32 | (v14 + 1))) != 0)
          || (v37 = *((unsigned int *)v17 + 13),
        ...
        if ( !v33 )
        {
          if ( v49 >> 12 != (*((unsigned int *)v17 + 6) | ((unsigned __int64)*((unsigned __int8 *)v17 + 32) << 32)) )
          {
LABEL_105:
            v16 = -1073741665;
            goto LABEL_120;
