/*
 * XREFs of LookupSidInTable @ 0x14068E37C
 * Callers:
...
LABEL_7:
  ...
  do
  {
    ...
    Str2a = (wchar_t *)((char *)&unk_140C0F400 + 104 * v14 + 2);
...
LABEL_10:
  ...
  {
    v16 = v14;
    return (__int64)&unk_140C0F400 + 104 * v16;
  }
  if ( v10 && a6 && !a3 && v11 < 0x3F )
  {
    if ( v23 )
    {
      ...
      {
        v18 = 104LL * v11;
        v19 = *(void **)((char *)&unk_140C0F400 + v18 + 16);
        if ( v19 )
        {
          v20 = RtlLengthSid(v19);
          v21 = SddlpAlloc(v20 + 1);
          *a7 = v21;
          if ( v21 )
          {
            _mm_lfence();
            memmove(v21, *(const void **)((char *)&unk_140C0F400 + v18 + 16), v20);
            v22 = RtlSubAuthorityCountSid(*(PSID *)((char *)&unk_140C0F400 + v18 + 16));
