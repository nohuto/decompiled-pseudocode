/*
 * XREFs of MiDemoteCombinedPte @ 0x140368FD0
 * Callers:
...
__int64 __fastcall MiDemoteCombinedPte(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v38 = *(_QWORD *)(qword_140C4E448 + 8 * v12);
  Process = 0LL;
  if ( (*(_BYTE *)(a1 + 184) & 7) == 0 )
  {
  ...
  if ( (v20 == 1 || v20 == 2 && (v11[2].m128i_i8[2] & 8) != 0)
    && *(_QWORD *)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(a1 + 174)) == v38
    && _InterlockedCompareExchange64((volatile signed __int64 *)(v10 + 32), 0LL, 1LL) == 1 )
  {
    ...
    if ( (WsleContents & 0xF) == 8 )
      MiUnlockPageTableCharges(48 * v36 - 0x58000000000LL, 1uLL);
