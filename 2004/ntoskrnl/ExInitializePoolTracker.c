/*
 * XREFs of ExInitializePoolTracker @ 0x140A643EC
 * Callers:
...
__int64 ExInitializePoolTracker()
{
  ...
  *(_DWORD *)((char *)&Mm64BitPhysicalAddress + 7) = 1 << v5;
  if ( (unsigned int)(1 << v5) < 0x10 )
  {
    *(_DWORD *)((char *)&Mm64BitPhysicalAddress + 7) = 16;
  }
  else if ( (unsigned int)(1 << v5) > 0x1000 )
  {
    *(_DWORD *)((char *)&Mm64BitPhysicalAddress + 7) = 4096;
  }
