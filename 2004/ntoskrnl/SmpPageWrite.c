/*
 * XREFs of SmpPageWrite @ 0x1402CDC50
 * Callers:
...
__int64 __fastcall SmpPageWrite(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, int a7)
{
  ...
  v10 = -1;
  if ( (*(_DWORD *)(a2 + 8) & 3) != 0
    || (v11 = SmpKeyedStoreReference((signed __int64 *)qword_140D24188, (__int64)&SmGlobals), v10 = v11, v11 == -1) )
  {
    v12 = v16;
  }
  else
...
LABEL_8:
  if ( v10 != -1 )
  {
    v15 = (struct _EX_RUNDOWN_REF *)SmKmStoreRefFromStoreIndex(&SmGlobals, v10 & 0x3FF);
