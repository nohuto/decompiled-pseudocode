/*
 * XREFs of MmCreateKernelStack @ 0x1402F8A30
 * Callers:
...
__int64 __fastcall MmCreateKernelStack(unsigned int a1, unsigned int a2, __int64 a3)
{
  ...
  if ( (a1 & 0x10) != 0 )
  {
    ...
    v70 = -32LL;
    if ( a3 )
      v5 = *(ULONG_PTR **)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(a3 + 544) + 1838LL));
  }
  else if ( a3 )
  {
    v6 = *(_QWORD *)(a3 + 544);
    v7 = a3;
    v70 = a3;
    v5 = *(ULONG_PTR **)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(v6 + 1838));
  }
  else
  {
    v7 = -16LL;
  ...
  {
    v8 = (unsigned __int8)byte_140C4E9BC;
    v67 = (unsigned __int8)byte_140C4E9BC;
    v68 = (unsigned __int8)byte_140C4E9BC;
    if ( (a1 & 0x10) != 0 )
    {
      ...
      for ( i = v9; ; i = 0LL )
      {
        ...
        if ( LOWORD(v11->Alignment) )
        {
          ...
          if ( v14 )
          {
            ...
            v17 = (unsigned __int64)&v14[-255] ^ qword_140C4ECC8;
            if ( Next != v17 )
            ...
            if ( v9 != 1 )
            {
              v20 = v18 - 8LL * (unsigned __int8)byte_140C4E9BC + 8;
              v21 = MiPteInShadowRange((unsigned __int64)&v69);
  ...
  if ( !(unsigned int)MiChargeCommit((__int64)v5, v8, (v4 >> 1) & 1) )
    return 0LL;
  v40 = MiReservePtes((__int64)&unk_140C4E958, v67 + 1, v38, v39);
  v42 = (_QWORD *)v40;
  if ( !v40 )
  {
LABEL_127:
  ...
  v44 = v68;
  if ( !(unsigned int)MiAllocateKernelStackPages((__int64)v5, v43 + 8, v68, v70, BugCheckParameter4, v4) )
  {
    if ( v5 == &MiSystemPartition )
    {
      ...
      {
        if ( (unsigned __int64)(v68 + CachedResidentAvailable) <= 0x100 )
        {
          do
          {
          ...
          while ( v64 != -1 && (unsigned __int64)(v68 + v64) <= 0x100 );
        }
...
LABEL_126:
    MiReleasePtes((__int64)&unk_140C4E958, v42, v67 + 1);
    goto LABEL_127;
  }
  if ( v5 == &MiSystemPartition )
    _InterlockedExchangeAdd64(&qword_140C4EDC8, v37);
LABEL_28:
