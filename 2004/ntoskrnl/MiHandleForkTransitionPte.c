/*
 * XREFs of MiHandleForkTransitionPte @ 0x1405555C4
 * Callers:
        ...
        _DWORD *a12)
{
  ...
  v66 = v16;
  v67 = v16;
  v22 = *(_QWORD *)(qword_140C4E448 + 8 * v21);
  v24 = *(unsigned __int16 *)(v23 + 1838);
  v71 = v22;
  v72 = *(_QWORD *)(qword_140C4E448 + 8 * v24);
  if ( v72 == v22 )
  {
    while ( 1 )
    {
...
LABEL_22:
    ...
    *(_QWORD *)v12 = v30;
    ...
    if ( v40 )
    {
      ...
      {
        v43 = v42 + 1;
        if ( HIBYTE(word_140C4DE08) != (_BYTE)v42 )
          goto LABEL_36;
...
LABEL_36:
    ...
    *(_QWORD *)(v48 + 24) ^= (*(_QWORD *)(v48 + 24) ^ (*(_QWORD *)(v48 + 24) + 1LL)) & 0x3FFFFFFFFFFFFFFFLL;
    ...
    if ( v53 )
    {
      ...
      {
        v56 = v55 + 1;
        if ( HIBYTE(word_140C4DE08) == (_BYTE)v55 && ((unsigned __int8)v15 & (unsigned __int8)v56) != 0 )
