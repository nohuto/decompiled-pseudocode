...
void __fastcall IopGetLegacyVetoListDrivers(__int64 a1)
{
  ...
  POBJECT_TYPE v13; // [rsp+20h] [rbp-59h]
  PADAPTER_OBJECT *p_DmaAdapter; // [rsp+38h] [rbp-41h]
  ...
  *v6 = 0;
  while ( 1 )
  {
    ...
    if ( v9 > v5 )
    {
      ...
      WORD1(v16) = v9;
      v5 = v9;
      *((_QWORD *)&v16 + 1) = ExAllocatePoolWithTag(PagedPool, v9, 0x6F697050u);
      v7 = (void *)*((_QWORD *)&v16 + 1);
      if ( !*((_QWORD *)&v16 + 1) )
        break;
    }
    v10 = PoolWithTag[1];
    LOWORD(v16) = v9 - 2;
    RtlStringCbPrintfW((NTSTRSAFE_PWSTR)v7, v5, L"\\Driver\\%ws", v10, v13, &v20, &NumberOfBytes, p_DmaAdapter);
    p_DmaAdapter = &DmaAdapter;
    v13 = IoDriverObjectType;
    if ( (int)ObReferenceObjectByName(&v16, 576LL, 0LL) >= 0 )
    {
      v11 = DmaAdapter;
