/*
 * XREFs of PfSnCheckActionsNeeded @ 0x1406B8CBC
 * Callers:
  ...
  *(_QWORD *)&v35[1] = a1;
  ...
  else
  {
    ...
    else
    {
      ...
      v27 = PfSnPrefetchCacheEntryGet(&unk_140C502B8, *(_QWORD *)&v35[1], v16, &v34);
      v28 = (_DWORD *)v27;
      if ( v27 )
      {
        if ( v34 )
