/*
 * XREFs of sub_140A18FE4 @ 0x140A18FE4
 * Callers:
...
__int64 __fastcall sub_140A18FE4(__int64 a1, ULONG_PTR a2, char a3)
{
  _BYTE *v3; // rbx
  __int64 v5; // r13
  int v6; // edi
          ...
          if ( v112 != v74 )
          {
            ...
            if ( (_DWORD)v113 )
            {
              ...
              do
              {
                ...
                v131 = v186;
                v132 = (__int64)v191;
                sub_1403E6EEC((__int64)v22, (__int64)v191, v117);
                v133 = v207;
...
LABEL_212:
        ...
        *(_DWORD *)(v152 + 2088) += v146;
        ...
        {
          if ( (_DWORD)v146 )
            sub_1403E6E8C(v152, v40, v146, v161 + 28);
        }
        *(_DWORD *)(v161 + 24) = 1;
        *(_QWORD *)a1 = v152;
        return 0LL;
      }
      v152 = sub_140A0BB30(v22, v151, v149);
      if ( v152 )
      {
        v153 = *((_DWORD *)v22 + 612);
        if ( (v153 & 4) == 0 )
