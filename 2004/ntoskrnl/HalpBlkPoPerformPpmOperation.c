/*
 * XREFs of HalpBlkPoPerformPpmOperation @ 0x140A16DC4
 * Callers:
 *     HalpBlkHandleIpi @ 0x140A17190 (HalpBlkHandleIpi.c)
 * Callees:
 *     HalpBlkPoPerformPpmOperationForIoPort @ 0x140A16E50 (HalpBlkPoPerformPpmOperationForIoPort.c)
 *     HalpBlkPoPerformPpmOperationForMsr @ 0x140A16EE0 (HalpBlkPoPerformPpmOperationForMsr.c)
 */
