/*
 * XREFs of HvAnalyzeLogFiles @ 0x14087DAD4
 * Callers:
 ...
 *     HvpHeaderCheckSum @ 0x1406399EC (HvpHeaderCheckSum.c)
 *     HvpDetermineIncrementalLogFileMaximums @ 0x14087E620 (HvpDetermineIncrementalLogFileMaximums.c)
 *     HvpDetermineLatestLogFile @ 0x14087E6D8 (HvpDetermineLatestLogFile.c)
...
LABEL_61:
    if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 0x400000000008LL) )
    {
      ...
      v85 = &v77;
      v86 = 8LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02130, (unsigned __int8 *)&unk_140022DE8, 0LL, 0LL, 3u, v84);
    }
  ...
  if ( (unsigned int)dword_140C02130 > 5 && tlgKeywordOn((__int64)&dword_140C02130, 8LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&dword_140022E1C,
      0LL,
      0LL,
      7u,
      &v87);
