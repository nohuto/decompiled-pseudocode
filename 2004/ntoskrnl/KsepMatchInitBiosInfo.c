/*
 * XREFs of KsepMatchInitBiosInfo @ 0x140A65B1C
 * Callers:
 ...
 *     KsepRegistryQueryMULTISZ @ 0x1407AC840 (KsepRegistryQueryMULTISZ.c)
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  v12 = 0LL;
  KeyHandle = 0LL;
  xmmword_140C54030 = 0LL;
  qword_140C54060 = 0LL;
  v0 = -1;
  xmmword_140C54040 = 0LL;
  xmmword_140C54050 = 0LL;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( MULTISZ >= 0 )
    {
      ...
      MULTISZ = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", (__int64)&unk_140C53DF0, 520LL, (__int64)&v12);
      word_140C53FF6 = 0;
      v4 = 0LL;
      v5 = &unk_140C53DF0;
      while ( *v5 != 32 )
...
LABEL_11:
  ...
  if ( MULTISZ < 0 )
  {
    DWORD2(xmmword_140C54050) = -1;
    *(_QWORD *)&xmmword_140C54030 = 0LL;
  }
  else
  {
    *(_QWORD *)&xmmword_140C54030 = &unk_140C53DF0;
    DWORD2(xmmword_140C54050) = v0;
  }
