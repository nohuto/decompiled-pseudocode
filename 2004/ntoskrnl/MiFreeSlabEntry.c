/*
 * XREFs of MiFreeSlabEntry @ 0x14054D730
 * Callers:
...
void __fastcall MiFreeSlabEntry(__int64 a1, __int64 a2, __int64 a3, _DWORD *SchedulerAssist)
{
  ...
  if ( v7 <= v8 )
  {
    ...
    do
    {
      ...
      if ( !v6 )
        v6 = *(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(v11 + 16) >> 39) & 0x3FFLL));
      if ( !*(_DWORD *)(a1 + 48) )
  ...
  v19 = v5[3] >> 9;
  v20 = v19 & 0x1F;
  v21 = (volatile signed __int32 *)(qword_140C52388 + 4 * (v5[3] >> 14));
  if ( (v19 & 0x1F) + 1 <= 0x20 )
  {
    v22 = 1 << v20;
LABEL_31:
...
LABEL_32:
  MiFreeLargePageMemory(v5[3], 1u, 6);
