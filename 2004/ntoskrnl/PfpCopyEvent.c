/*
 * XREFs of PfpCopyEvent @ 0x1406CE610
 * Callers:
 *     PfpFlushEventBuffers @ 0x1406CE510 (PfpFlushEventBuffers.c)
 *     PfpFlushBuffers @ 0x1406CE830 (PfpFlushBuffers.c)
 * Callees:
 *     ObfDereferenceObjectWithTag @ 0x140208290 (ObfDereferenceObjectWithTag.c)
 *     PfpIsProcessInfoPresent @ 0x1403050EC (PfpIsProcessInfoPresent.c)
 *     memmove @ 0x140409FC0 (memmove.c)
 *     PsLookupProcessByProcessId @ 0x140666370 (PsLookupProcessByProcessId.c)
 *     PfpLogPageAccess @ 0x1406CEBD0 (PfpLogPageAccess.c)
 *     PfTAcquireLogEntry @ 0x1406CF220 (PfTAcquireLogEntry.c)
 */
...
__int64 __fastcall PfpCopyEvent(__int64 *Src)
{
  ...
  {
    v13 = (v1 >> 2) & 0x3FF;
    v14 = PfTAcquireLogEntry(&unk_140C4F9D8, &v18, v13);
    if ( !v14 )
      return 3221225626LL;
  ...
  *(_QWORD *)&v17 = v6 & 0xFFFFFFFF00FFFFFFuLL | v7;
  ...
  if ( !v10 )
    return 3221225864LL;
  v11 = ((qword_140C4FA18 + 47) & 0xFFFFFFFFFFFFFFF8uLL)
      + 40LL * (*(unsigned __int16 *)(v10 + 10) - (unsigned int)*(unsigned __int16 *)(qword_140C4FA18 + 36));
