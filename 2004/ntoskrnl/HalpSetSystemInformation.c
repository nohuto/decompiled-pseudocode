/*
 * XREFs of HalpSetSystemInformation @ 0x1407211A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpTimerGetProfilingHandler @ 0x1404BC948 (HalpTimerGetProfilingHandler.c)
 *     HalpTimerSetProfilingHandler @ 0x1404BCAB4 (HalpTimerSetProfilingHandler.c)
...
__int64 __fastcall HalpSetSystemInformation(int a1, int a2, __int64 (**a3)(void))
{
  ...
  switch ( a1 )
  {
    ...
    case 1:
      ...
      if ( qword_140CF5040 )
      {
        if ( qword_140CF5040 == PsGetCurrentThreadProcessId() )
        {
      ...
      else
      {
        HalpPerfInterruptHandler = (__int64 (__fastcall *)(_QWORD))*a3;
        if ( HalpPerfInterruptHandler )
          qword_140CF5040 = PsGetCurrentThreadProcessId();
      }
    ...
    case 10:
      ...
      if ( !qword_140CF5030 )
      {
        ...
        if ( HalpTimerGetProfilingHandler() )
          qword_140CF5030 = PsGetCurrentThreadProcessId();
        goto LABEL_34;
      }
      if ( qword_140CF5030 == PsGetCurrentThreadProcessId() )
      {
        HalpTimerSetProfilingHandler(*a3);
        if ( !HalpTimerGetProfilingHandler() )
          qword_140CF5030 = 0LL;
    ...
    case 19:
      ...
      if ( !qword_140CF5038 )
      {
        ...
        if ( HalpProcessorTraceInterruptHandler )
          qword_140CF5038 = PsGetCurrentThreadProcessId();
        goto LABEL_34;
      }
      if ( qword_140CF5038 == PsGetCurrentThreadProcessId() )
      {
        HalpProcessorTraceInterruptHandler = (__int64 (__fastcall *)(_QWORD))*a3;
        if ( !HalpProcessorTraceInterruptHandler )
          qword_140CF5038 = 0LL;
