/*
 * XREFs of MmAllocateIndependentPagesEx @ 0x14074F63C
 * Callers:
 *     MmAllocateIndependentPages @ 0x14074F620 (MmAllocateIndependentPages.c)
...
__int64 __fastcall MmAllocateIndependentPagesEx(unsigned __int64 a1, int a2, __int64 a3, unsigned __int64 a4)
{
  ...
  v30 = 0LL;
  v7 = MiReservePtes((__int64)&qword_140C4ED40, v6, a3, a4);
  if ( !v7 )
    return 0LL;
  if ( !(unsigned int)MiObtainPoolCharges(v6, 1) )
  {
    MiReleasePtes((__int64)&qword_140C4ED40, (_QWORD *)v7, v6);
    return 0LL;
  }
  v31 = a3 && (dword_140C50B84 & 8) != 0 && (a2 == -1 || KeNumberNodes == 1);
