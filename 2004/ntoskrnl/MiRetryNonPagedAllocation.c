/*
 * XREFs of MiRetryNonPagedAllocation @ 0x1402E1CAC
 * Callers:
...
__int64 MiRetryNonPagedAllocation()
{
  ...
  for ( i = 1; ; i = KeWaitForSingleObject(&stru_140C51EE8, WrFreePage, 0, 0, Timeout) )
  {
    ...
    if ( i == 1 )
    {
      if ( byte_140C4C6E4 == 1 )
      {
        if ( dword_140C4C6E0 == dword_140C51F00 )
          goto LABEL_29;
        byte_140C4C6E4 = 0;
      }
    }
    else
    {
      if ( i == 258 )
      {
        if ( !byte_140C4C6E4 )
        {
          dword_140C4C6E0 = dword_140C51F00;
          byte_140C4C6E4 = 1;
        }
        goto LABEL_29;
      }
