/*
 * XREFs of HalpBlkAllocateAndShadowMemory @ 0x140A8B118
 * Callers:
 *     HalpBlkAllocateShadowCodePages @ 0x140A8B320 (HalpBlkAllocateShadowCodePages.c)
 ...
 *     HalpBlkAddVirtualMapping @ 0x140A8AFDC (HalpBlkAddVirtualMapping.c)
 */
