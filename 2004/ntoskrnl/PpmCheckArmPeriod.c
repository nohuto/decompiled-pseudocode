/*
 * XREFs of PpmCheckArmPeriod @ 0x1403BFC64
 * Callers:
...
char PpmCheckArmPeriod()
{
  ...
  if ( (unsigned int)(10000 * HIDWORD(PpmCurrentProfile[342 * dword_140C238AC + 7])) > (unsigned __int64)PpmCheckMinimumPeriod )
    v1 = (unsigned int)(10000 * HIDWORD(PpmCurrentProfile[342 * dword_140C238AC + 7]));
  if ( !PpmCheckArmed )
    goto LABEL_7;
