/*
 * XREFs of PopTransitionTelemetryOsState @ 0x140786610
 * Callers:
...
__int64 __fastcall PopTransitionTelemetryOsState(int a1, int a2)
{
  ...
  v48 = 0LL;
  v47 = 0LL;
  if ( !dword_140C021E8 || !tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) || !byte_140C22B4C )
    return v4;
  switch ( a1 )
  {
    case 2:
      if ( a2 == 2 )
      {
        if ( (unsigned int)dword_140C0ED7C < MEMORY[0xFFFFF7800000037C] )
        {
          if ( !dword_140C0ED78 )
            dword_140C0ED78 = TelemetryCoverageStringHashInternal(off_140C0ED70, &v32);
          v6 = &off_140C0ED70;
          goto LABEL_67;
        }
      }
      else if ( (unsigned int)dword_140C0ED64 < MEMORY[0xFFFFF7800000037C] )
      {
        if ( !dword_140C0ED60 )
          dword_140C0ED60 = TelemetryCoverageStringHashInternal(off_140C0ED58, &v33);
        v6 = &off_140C0ED58;
        goto LABEL_67;
      }
      break;
    case 3:
      ...
      {
        case 3:
          if ( (unsigned int)dword_140C0EDAC < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0EDA8 )
              dword_140C0EDA8 = TelemetryCoverageStringHashInternal(off_140C0EDA0, &v37);
            v6 = &off_140C0EDA0;
            goto LABEL_67;
          }
          break;
        case 4:
          if ( (unsigned int)dword_140C0ED94 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ED90 )
              dword_140C0ED90 = TelemetryCoverageStringHashInternal(off_140C0ED88, &v36);
            v6 = &off_140C0ED88;
            goto LABEL_67;
          }
          break;
        case 5:
          if ( (unsigned int)dword_140C0ED1C < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ED18 )
              dword_140C0ED18 = TelemetryCoverageStringHashInternal(off_140C0ED10, &v35);
            v6 = &off_140C0ED10;
            goto LABEL_67;
          }
          break;
        case 6:
          if ( (unsigned int)dword_140C0ED04 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ED00 )
              dword_140C0ED00 = TelemetryCoverageStringHashInternal(off_140C0ECF8, &v40);
            v6 = &off_140C0ECF8;
            goto LABEL_67;
          }
          break;
        default:
          if ( a2 == 8 && (unsigned int)dword_140C0ED4C < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ED48 )
              dword_140C0ED48 = TelemetryCoverageStringHashInternal(off_140C0ED40, &v39);
            v6 = &off_140C0ED40;
            goto LABEL_67;
          }
          break;
    ...
    case 4:
      ...
      {
        case 3:
          if ( (unsigned int)dword_140C0ED34 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ED30 )
              dword_140C0ED30 = TelemetryCoverageStringHashInternal(off_140C0ED28, &v38);
            v6 = &off_140C0ED28;
            goto LABEL_67;
          }
          break;
        case 4:
          if ( (unsigned int)dword_140C0ECBC < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ECB8 )
              dword_140C0ECB8 = TelemetryCoverageStringHashInternal(off_140C0ECB0, &v19);
            v6 = &off_140C0ECB0;
            goto LABEL_67;
          }
          break;
        case 5:
          if ( (unsigned int)dword_140C0ECA4 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ECA0 )
              dword_140C0ECA0 = TelemetryCoverageStringHashInternal(off_140C0EC98, &v20);
            v6 = &off_140C0EC98;
            goto LABEL_67;
          }
          break;
        case 6:
          if ( (unsigned int)dword_140C0ECEC < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ECE8 )
              dword_140C0ECE8 = TelemetryCoverageStringHashInternal(off_140C0ECE0, &v21);
            v6 = &off_140C0ECE0;
            goto LABEL_67;
          }
          break;
        default:
          if ( a2 == 8 && (unsigned int)dword_140C0ECD4 < MEMORY[0xFFFFF7800000037C] )
          {
            if ( !dword_140C0ECD0 )
              dword_140C0ECD0 = TelemetryCoverageStringHashInternal(off_140C0ECC8, &v22);
            v6 = &off_140C0ECC8;
LABEL_67:
  ...
  v4 = dword_140C22B48;
  if ( a1 != 5 || dword_140C22B10 == 1 || (unsigned int)(dword_140C22B10 - 4) <= 1 )
  {
    v8 = (KiQueryUnbiasedInterruptTime() - qword_140C22B28) / 0x2710uLL;
    v9 = v8 - qword_140C22B38;
    v10 = (MEMORY[0xFFFFF78000000008] - qword_140C22B20) / 0x2710uLL;
    qword_140C22B38 = v8;
    v11 = v10 - qword_140C22B30;
    v33 = v10 - qword_140C22B30;
    v12 = v10 - qword_140C22B30;
    qword_140C22B30 = v10;
    if ( v9 <= v11 )
      v12 = v9;
    v32 = v12;
    v21 = v7 + dword_140C22B40;
    dword_140C22B40 += v7;
    v19 = dword_140C22B10;
    v20 = dword_140C22B14;
    if ( a1 != 5 )
    ...
    v34 = qword_140C22B18;
    if ( (unsigned int)dword_140C021E8 > 5 && tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) )
    {
      v15 = a1;
      v50 = &v15;
      v52 = &v16;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)byte_140026D0D,
        0LL,
        0LL,
        0x16u,
        &v49);
