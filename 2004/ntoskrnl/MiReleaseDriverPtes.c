/*
 * XREFs of MiReleaseDriverPtes @ 0x14074A1E8
 * Callers:
 ...
 *     RtlAreBitsSet @ 0x14033BAA0 (RtlAreBitsSet.c)
...
void __fastcall MiReleaseDriverPtes(unsigned int a1, unsigned __int64 a2, unsigned int a3)
{
  ...
  v13 = v5;
  v10 = (RTL_BITMAP *)*(&qword_140C4CB30 + v5);
  if ( !v10 )
    goto LABEL_16;
  do
  {
    ...
    v7 = v10;
    v10 = *(RTL_BITMAP **)&v10->SizeOfBitMap;
  }
  while ( v10 );
  if ( !v10 )
LABEL_16:
