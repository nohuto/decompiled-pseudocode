/*
 * XREFs of WheaWmiDispatch @ 0x1403C9470
 * Callers:
 *     <none>
 * Callees:
 *     WheapWmiRegisterInfo @ 0x1403C94CC (WheapWmiRegisterInfo.c)
 *     WheapWmiExecuteMethod @ 0x1405B8800 (WheapWmiExecuteMethod.c)
 *     WheapWmiGetAllData @ 0x1405B8A28 (WheapWmiGetAllData.c)
 *     WheapWmiGetSingleInstance @ 0x1405B8A8C (WheapWmiGetSingleInstance.c)
 */
