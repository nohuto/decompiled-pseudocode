/*
 * XREFs of MmIsFileObjectAPagingFile @ 0x140227A0C
 * Callers:
 ...
 *     FsRtlIsSystemPagingFile @ 0x14036A370 (FsRtlIsSystemPagingFile.c)
 * Callees:
...
__int64 __fastcall MmIsFileObjectAPagingFile(unsigned __int64 a1)
{
  ...
  v2 = 0;
  v3 = ExAcquireSpinLockShared(&dword_140C4EAB8);
  v4 = (_QWORD *)qword_140C4EAB0;
  while ( v4 )
  {
    if ( a1 < *(v4 - 25) )
    {
  ...
  ExReleaseSpinLockSharedFromDpcLevel(&dword_140C4EAB8);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
