/*
 * XREFs of IvtAttachDeviceDomainInternal @ 0x1404DA628
 * Callers:
 *     IvtAttachDeviceDomain @ 0x1404DA610 (IvtAttachDeviceDomain.c)
 *     IvtDetachDeviceDomain @ 0x1404DAA90 (IvtDetachDeviceDomain.c)
 * Callees:
 ...
 *     IvtGetDomainId @ 0x1404DAFF8 (IvtGetDomainId.c)
