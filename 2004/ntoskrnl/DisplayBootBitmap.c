/*
 * XREFs of DisplayBootBitmap @ 0x1403B0DA0
 * Callers:
 *     DisplayFilter @ 0x1404B0ED0 (DisplayFilter.c)
 ...
 *     RotBarInit @ 0x1404F9E40 (RotBarInit.c)
...
int __fastcall DisplayBootBitmap(char a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( qword_140C50960 )
    {
      v3 = *(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))(qword_140C50960 + 72);
      if ( v3 )
      {
...
LABEL_29:
  ...
  qword_140C50968 = (__int64 (__fastcall *)(_QWORD))DisplayFilter;
  ...
  if ( v7 )
  {
    ...
    if ( qword_140C50960 )
    {
      v10 = *(void (__fastcall **)(__int64, _QWORD, _QWORD))(qword_140C50960 + 96);
      if ( v10 )
      {
        v10(v7, 0LL, 0LL);
        v5 = qword_140C50960;
