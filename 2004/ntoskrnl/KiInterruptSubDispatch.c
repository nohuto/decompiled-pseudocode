/*
 * XREFs of KiInterruptSubDispatch @ 0x1403F87E0
 * Callers:
...
void __fastcall KiInterruptSubDispatch(__int64 a1, __int64 a2, __int64 CurrentThread)
{
  __int64 v3; // rbp
  __int64 v4; // rsi
  ...
  *(_BYTE *)(v3 + 243) = (WORD2(PerfGlobalGroupMask) & 0x4000) != 0;
  ...
  v16 = KiCallInterruptServiceRoutine(v4, 1, CurrentThread);
  if ( *(_BYTE *)(v3 + 243) )
  {
    v17 = v16;
