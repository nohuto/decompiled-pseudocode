/*
 * XREFs of PopUpdateNonAttributedCpuTimeReference @ 0x140571418
 * Callers:
...
__int64 __fastcall PopUpdateNonAttributedCpuTimeReference(char a1)
{
  ...
  v2 = KeAcquireSpinLockRaiseToDpc(&qword_140C4FE88);
  if ( a1 )
  {
    if ( ++dword_140C4FE84 == 1 )
    {
      v3 = 0;
LABEL_6:
      PopAccumulateNonActivatedCpuTime(v3, &qword_140C4FD78, &qword_140C4FD80);
    }
  }
  else if ( !--dword_140C4FE84 )
  {
    v3 = 1;
    goto LABEL_6;
  }
  KxReleaseSpinLock(&qword_140C4FE88);
