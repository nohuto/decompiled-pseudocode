/*
 * XREFs of PopDiagTraceControlCallback @ 0x14064EB10
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (_DWORD)ControlCode == 2 )
  {
    ...
    if ( CallbackContext == &dword_140C021E8 )
    {
      if ( (MatchAnyKeyword & 0x800000000000LL) != 0 )
      {
        ...
        if ( dword_140C021E8 )
        {
          if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x800000000000LL) && byte_140C22B4C )
          {
            PopAcquireRwLockExclusive((ULONG_PTR)&PopTelemetryOsState);
            if ( dword_140C22B10 == 1 || (unsigned int)(dword_140C22B10 - 4) <= 1 )
            {
              v27 = (KiQueryUnbiasedInterruptTime() - qword_140C22B28) / 0x2710uLL;
              v28 = v27 - qword_140C22B38;
              v29 = (MEMORY[0xFFFFF78000000008] - qword_140C22B20) / 0x2710uLL;
              qword_140C22B38 = v27;
              v30 = v29 - qword_140C22B30;
              qword_140C22B30 = v29;
              v31 = v30;
              if ( v28 <= v30 )
                v31 = v28;
