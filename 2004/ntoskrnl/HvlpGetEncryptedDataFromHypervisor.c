/*
 * XREFs of HvlpGetEncryptedDataFromHypervisor @ 0x1404F3C88
 * Callers:
 *     HvlGetEncryptedData @ 0x1404F3A40 (HvlGetEncryptedData.c)
 * Callees:
        ...
        unsigned __int64 a5)
{
  ...
  *(_DWORD *)a5 = 0;
  ...
  if ( v13 )
  {
    ...
    do
    {
      ...
      *(_QWORD *)(8 * (((unsigned __int64)qword_140C473A8 >> 12) & 0xFFFFFFFFFLL) - 0x98000000000LL) = v19;
      v16 = __readcr4();
      if ( (v16 & 0x20080) != 0 )
      {
        __writecr4(v16 ^ 0x80);
      ...
      memmove(a2, qword_140C473A8, 0x1000uLL);
      *a4 = v15;
      a2 += 4096;
      v14 += 4096LL;
      ++a4;
  ...
  *v5 = v13 << 12;
  LODWORD(xmmword_140C473D0) = v10 - v13;
