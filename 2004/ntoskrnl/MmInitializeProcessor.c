/*
 * XREFs of MmInitializeProcessor @ 0x14099BD3C
 * Callers:
...
__int64 __fastcall MmInitializeProcessor(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( *(_DWORD *)(a1 + 36) )
    *(_QWORD *)(a1 + 34224) = -1LL;
  v5 = MiReservePtes((__int64)&qword_140C4ED40, 0x40u, a3, a4);
  if ( v5 )
  {
    *(_QWORD *)(a1 + 33280) = (__int64)(v5 << 25) >> 16;
    *(_DWORD *)(a1 + 32540) = dword_140C4DCF8;
