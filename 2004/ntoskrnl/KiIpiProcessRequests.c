/*
 * XREFs of KiIpiProcessRequests @ 0x140326090
 * Callers:
            ...
            if ( v12 )
            {
              if ( KiFlushPcid )
              {
                ...
                if ( !Process->AddressPolicy )
                {
                  ...
                  {
                    KiSetUserTbFlushPending(Process, v10);
                    v13 = v31;
                  }
                }
              }
              ...
              do
              {
                ...
                if ( v12 && KiFlushPcid )
                {
                  ...
                  if ( !v18->AddressPolicy )
                  {
                    ...
                    {
                      KiSetUserTbFlushPending(v18, v10);
                      v10 = v30;
                    }
                  }
                  v16 = v29;
        ...
        else
        {
          switch ( v7 & 0xF )
          {
            ...
            case 2LL:
              ...
              {
                KiSetUserTbFlushPending(v25, v23);
                v5 = v28;
LABEL_39:
                __invlpg(v24);
              }
...
LABEL_7:
              ...
              if ( v21->AddressPolicy )
                goto LABEL_15;
              KiSetUserTbFlushPending(v21, v7);
              break;
            default:
              __fastfail(0x25u);
          }
