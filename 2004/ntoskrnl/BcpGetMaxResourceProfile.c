/*
 * XREFs of BcpGetMaxResourceProfile @ 0x1403B971C
 * Callers:
 *     BgpBcInitializeCriticalMode @ 0x140A93F20 (BgpBcInitializeCriticalMode.c)
 * Callees:
 *     BcpGetCharacterMaxResourceProfile @ 0x1403B97E0 (BcpGetCharacterMaxResourceProfile.c)
 */
...
__int64 __fastcall BcpGetMaxResourceProfile(__int64 a1, _OWORD *a2)
{
  ...
  *a2 = 0LL;
  ...
  {
    v7 = (__int64 *)*(v3 - 1);
    if ( v7 != &qword_140005900 || (dword_140C13310 & 0x20000) == 0 )
    {
      CharacterMaxResourceProfile = 0;
