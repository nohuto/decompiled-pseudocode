/*
 * XREFs of MiSwitchToPfns @ 0x140A3DD18
 * Callers:
...
__int64 __fastcall MiSwitchToPfns(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  ...
  v32 = 0LL;
  v33 = 0LL;
  v5 = MmPfnDatabase + 48 * qword_140C52680;
  if ( !qword_140C52680 && !*(_WORD *)(v5 + 32) )
  {
    v22 = (unsigned __int8)MiLockPageInline(MmPfnDatabase + 48 * qword_140C52680, a2, a3, a4);
