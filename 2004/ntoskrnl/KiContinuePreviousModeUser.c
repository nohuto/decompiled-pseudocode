/*
 * XREFs of KiContinuePreviousModeUser @ 0x1402EA1A0
 * Callers:
 ...
 *     KiVerifyContextRecord @ 0x1402EA910 (KiVerifyContextRecord.c)
 ...
 *     RtlGuardIsValidStackPointer @ 0x1406ADE80 (RtlGuardIsValidStackPointer.c)
