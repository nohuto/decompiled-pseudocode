/*
 * XREFs of VerifierKeAcquireInStackQueuedSpinLockForDpcCommon @ 0x1409D7758
 * Callers:
 *     VerifierKeAcquireInStackQueuedSpinLockForDpc @ 0x1409D7710 (VerifierKeAcquireInStackQueuedSpinLockForDpc.c)
 *     VerifierKeAcquireInStackQueuedSpinLockForDpcNoReboot @ 0x1409D77D0 (VerifierKeAcquireInStackQueuedSpinLockForDpcNoReboot.c)
 * Callees:
