/*
 * XREFs of MiPrefetchVirtualMemory @ 0x140248300
 * Callers:
...
LABEL_36:
        ...
        if ( (v19 = *(_QWORD *)v17 + (v43 << 12), LeafVa = v19, v19 >= qword_140C4F938) && v19 <= qword_140C4E168
...
LABEL_6:
      v13 = *(__int64 **)(qword_140C4E448 + 8 * v12);
      goto LABEL_7;
    }
  }
  else if ( !v10 )
