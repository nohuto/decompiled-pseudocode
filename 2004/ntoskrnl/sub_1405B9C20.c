/*
 * XREFs of sub_1405B9C20 @ 0x1405B9C20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsQueryThreadTerminationPort @ 0x1405C7384 (PsQueryThreadTerminationPort.c)
 *     KeRundownApcQueues @ 0x1406B0D4C (KeRundownApcQueues.c)
 */

void __fastcall __noreturn sub_1405B9C20(__int64 a1)
{
