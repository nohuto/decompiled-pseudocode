/*
 * XREFs of HalpBuildScatterGatherList @ 0x14039C6A4
 * Callers:
 *     HalGetScatterGatherList @ 0x1403420C0 (HalGetScatterGatherList.c)
 *     HalBuildScatterGatherListV3 @ 0x14039C620 (HalBuildScatterGatherListV3.c)
 *     HalBuildScatterGatherListEx @ 0x1404C0F10 (HalBuildScatterGatherListEx.c)
 *     HalGetScatterGatherListEx @ 0x1404C13C0 (HalGetScatterGatherListEx.c)
 * Callees:
