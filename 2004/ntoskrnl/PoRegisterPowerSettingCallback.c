/*
 * XREFs of PoRegisterPowerSettingCallback @ 0x140711A90
 * Callers:
 *     HvlpRegisterPowerPolicyCallbacks @ 0x1404F3274 (HvlpRegisterPowerPolicyCallbacks.c)
...
LABEL_25:
    ...
    {
      v21 = (_QWORD *)qword_140C23D28;
      if ( *(__int64 **)qword_140C23D28 == &PopRegisteredPowerSettingCallbacks )
      {
        *(_QWORD *)v12 = &PopRegisteredPowerSettingCallbacks;
        *((_QWORD *)v12 + 1) = v21;
        *v21 = v12;
        qword_140C23D28 = (__int64)v12;
LABEL_18:
        v19 = 0;
