/*
 * XREFs of IopInitializeSystemDrivers @ 0x140A4DC4C
 * Callers:
 ...
 *     ExIsManufacturingModeEnabled @ 0x140728BD0 (ExIsManufacturingModeEnabled.c)
...
__int64 IopInitializeSystemDrivers()
{
  ...
  SystemDriverList = CmGetSystemDriverList((unsigned __int64)qword_140C195B0 & -(__int64)(IsManufacturingModeEnabled != 0));
  v2 = SystemDriverList;
  if ( SystemDriverList )
  {
    v3 = SystemDriverList;
