/*
 * XREFs of PopRequestRead @ 0x1409AE9E4
 * Callers:
 *     PopRestoreHiberContext @ 0x140990478 (PopRestoreHiberContext.c)
 *     PopDecompressCallback @ 0x1409AE400 (PopDecompressCallback.c)
 * Callees:
    ...
    do
    {
      if ( v8 )
      {
        if ( v8 != 1 )
        {
          ...
          v9 = __rdtsc();
          qword_140C234C8 += v9 - *(_QWORD *)(BugCheckParameter3 + 336);
          ...
          v10 = __rdtsc();
          qword_140C234F8 += (((unsigned __int64)HIDWORD(v10) << 32) | (unsigned int)v10) - v9;
        ...
        v17 = __rdtsc();
        qword_140C234F0 += (((unsigned __int64)HIDWORD(v17) << 32) | (unsigned int)v17) - v14;
...
LABEL_34:
        ...
        v28 = __rdtsc();
        qword_140C234F0 += (((unsigned __int64)HIDWORD(v28) << 32) | (unsigned int)v28)
