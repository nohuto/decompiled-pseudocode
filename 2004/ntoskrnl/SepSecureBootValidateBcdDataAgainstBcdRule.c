/*
 * XREFs of SepSecureBootValidateBcdDataAgainstBcdRule @ 0x1409211C4
 * Callers:
 ...
 *     SepSecureBootGetQWordPolicyValue @ 0x140920FC0 (SepSecureBootGetQWordPolicyValue.c)
 */
...
__int64 __fastcall SepSecureBootValidateBcdDataAgainstBcdRule(__int64 a1, _BYTE *a2, unsigned int a3)
{
  ...
  v4 = (_WORD *)(qword_140CF9E78 + *(unsigned int *)(a1 + 8));
  QWordPolicyValue = 0;
  v6 = *v4 & 0x1F;
  if ( v6 != 8 )
  {
