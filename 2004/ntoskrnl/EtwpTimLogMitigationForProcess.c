/*
 * XREFs of EtwpTimLogMitigationForProcess @ 0x140939044
 * Callers:
 *     MiAllowImageMap @ 0x140601DB0 (MiAllowImageMap.c)
 *     EtwTimLogProhibitDynamicCode @ 0x140938778 (EtwTimLogProhibitDynamicCode.c)
 *     EtwTimLogProhibitWin32kSystemCalls @ 0x140938E30 (EtwTimLogProhibitWin32kSystemCalls.c)
 * Callees:
 ...
 *     EtwpTiFillThreadIdentity @ 0x1402FBA84 (EtwpTiFillThreadIdentity.c)
...
void __fastcall EtwpTimLogMitigationForProcess(int a1, int a2, const EVENT_DESCRIPTOR *a3, __int64 a4)
{
  ...
  *(_QWORD *)&UserData.Size = 2LL;
  ...
  v19 = P[1];
  if ( (unsigned int)dword_140C02BB0 > 5 && tlgKeywordOn((__int64)&dword_140C02BB0, 0x200000000000LL) )
  {
    v22 = a1;
    v28 = &v22;
    v29 = 4LL;
    ...
    v39[1] = 0;
    v41 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BB0, (unsigned __int8 *)byte_14002C683, 0LL, 0LL, 9u, &v27);
  }
  if ( v19 )
