/*
 * XREFs of AnFwConfigureProgressResources @ 0x1409EE608
 * Callers:
...
__int64 __fastcall AnFwConfigureProgressResources(int *a1)
{
  ...
  v8 = 0LL;
  v5 = 0LL;
  KeInitializeEvent(&stru_140CF2F40, NotificationEvent, 1u);
  if ( !a1 )
    return 0LL;
  if ( (a1[6] & 1) == 0 )
    return 0LL;
  if ( (int)BgpFoGetFontHandle(0LL) < 0 )
    return 0LL;
  v4[0] = HIDWORD(qword_140C13490);
  v4[1] = dword_140C13498;
  v6 = a1[5];
  v7 = 1;
  if ( (int)BgpTxtCreateRegion((_DWORD)a1, (int)a1 + 8, (unsigned int)v4, (unsigned int)&v8, 10) < 0 )
    return 0LL;
  BitsPerPixel = BgpGetBitsPerPixel();
  dword_140C13334 = ((BgpGxRectangleSize(a1[3], a1[2], BitsPerPixel) + 15) & 0xFFFFFFF0) + 128;
  dword_140C13330 = 122 * dword_140C13334;
  dword_140C13338 = BgpTxtRegionSize(v8);
  return v8;
}
