/*
 * XREFs of PopPepWork @ 0x1402E3E30
 * Callers:
 ...
 *     PopPepGetReadyActivityType @ 0x1402D0270 (PopPepGetReadyActivityType.c)
  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      if ( v13 )
      {
        ...
        started = PopPepStartActivity(v9, v22, v22 + 56, v21, (volatile signed __int32 *)(v22 + 104), a1);
        ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)(v9 + 64));
        v17 = 2;
        goto LABEL_28;
      }
LABEL_18:
      if ( v12 )
      {
        ...
        started = PopPepStartActivity(v9, 0LL, v9 + 72, v18, (volatile signed __int32 *)(v9 + 120), a1);
        ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)(v9 + 64));
        v17 = 3;
        goto LABEL_28;
      }
