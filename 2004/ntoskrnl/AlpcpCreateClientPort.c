/*
 * XREFs of AlpcpCreateClientPort @ 0x14062B308
 * Callers:
        ...
        char a11)
{
  ...
  PADAPTER_OBJECT *v35; // [rsp+50h] [rbp-10h]
  ...
  v36 = 0LL;
  if ( a5 )
    result = ObReferenceObjectByNameEx(a5, a2, 1LL, AlpcPortObjectType, PreviousMode, 0LL, &DmaAdapter);
  else
...
LABEL_60:
        ...
        if ( v17 >= 0 )
        {
          ...
          if ( v20 >= 0 )
          {
            v21 = v19 + 104;
            v19[104] |= 8u;
            Blob = (PADAPTER_OBJECT *)AlpcpAllocateBlob(AlpcConnectionType, 72LL, 1LL);
            v35 = Blob;
            if ( Blob )
            {
              *((_QWORD *)v19 + 2) = Blob;
              v23 = (ULONG_PTR *)(Blob + 8);
              Blob[8] = 0LL;
              Blob[1] = 0LL;
              *Blob = v14;
              Blob[2] = (PADAPTER_OBJECT)v19;
...
LABEL_38:
                      ...
                      inserted = ObInsertObjectEx((PADAPTER_OBJECT)v19, 0LL, 0, 0LL, (__int64)&v36);
                      if ( inserted >= 0 )
                      {
                        v31 = v36;
                        *((_QWORD *)v19 + 7) = v36;
