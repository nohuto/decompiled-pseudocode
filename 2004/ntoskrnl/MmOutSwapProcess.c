/*
 * XREFs of MmOutSwapProcess @ 0x140280DDC
 * Callers:
...
char __fastcall MmOutSwapProcess(__int64 a1)
{
  ...
  *v8 = 0LL;
  ...
  v27 = (unsigned __int64 *)(MiMapPageInHyperSpaceWorker(v25, &v49, 0x80000000LL)
                           + 8LL * ((*(_DWORD *)(v26 + 8) >> 3) & 0x1FF));
  TransitionPte = MiMakeTransitionPte(v25, 4);
  v29 = TransitionPte;
...
LABEL_45:
      if ( !v34 )
        v29 = TransitionPte | 0x8000000000000000uLL;
    }
  }
  *v27 = v29;
  if ( v2 )
    MiWritePteShadow(v27, v29);
  MiUnmapPageInHyperSpaceWorker((unsigned __int64)v27, v49, 0x80000000);
