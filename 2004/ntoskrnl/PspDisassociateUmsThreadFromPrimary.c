/*
 * XREFs of PspDisassociateUmsThreadFromPrimary @ 0x14090B458
 * Callers:
 ...
 *     KeDoesTebMatchThread @ 0x1405217C0 (KeDoesTebMatchThread.c)
 *     KeGetCurrentUmsTeb @ 0x1405217DC (KeGetCurrentUmsTeb.c)
 *     KeSetCurrentUmsTeb @ 0x140521824 (KeSetCurrentUmsTeb.c)
 ...
 *     KeRemoveUmsThreadCidOwnership @ 0x1408BA09C (KeRemoveUmsThreadCidOwnership.c)
 ...
 *     KeFixUserSwitchContext @ 0x1408BB500 (KeFixUserSwitchContext.c)
 *     PspFindThreadForTeb @ 0x140906D30 (PspFindThreadForTeb.c)
 *     PspSetUmsThreadContext @ 0x14090B9B8 (PspSetUmsThreadContext.c)
 */
...
LABEL_23:
  if ( SBYTE8(PerfGlobalGroupMask[0]) < 0 )
  {
    ...
    v34 = 20;
    EtwTraceKernelEvent((int)&p_CycleTime, 1, 0x40000080u, 6435, 4200450);
  }
  if ( v8 )
  {
    if ( v9 )
