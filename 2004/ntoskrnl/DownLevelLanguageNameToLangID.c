/*
 * XREFs of DownLevelLanguageNameToLangID @ 0x1403B3F1C
 * Callers:
...
__int64 __fastcall DownLevelLanguageNameToLangID(const void *a1, int a2)
{
  ...
  if ( a1
    && (a2 & 0xFFFFFFFD) == 0
    && (v3 = bsearch(a1, &off_140002F50, 0x1B4uLL, 8uLL, CompareLangName)) != 0LL
    && ((v4 = &(&off_140003CF0)[2 * word_14001F410[(v3 - (_BYTE *)&off_140002F50) >> 3]], (v2 & 2) != 0)
