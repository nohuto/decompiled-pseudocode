/*
 * XREFs of CmpGetSystemControlValues @ 0x140A49A40
 * Callers:
 ...
 *     CmpFindSubKeyByName @ 0x14078B224 (CmpFindSubKeyByName.c)
 ...
 *     CmpConvertLangId @ 0x140A4A024 (CmpConvertLangId.c)
 */
...
__int64 __fastcall CmpGetSystemControlValues(_DWORD *a1, __int64 a2, char a3)
{
  ...
  if ( a3 == 1 )
  {
    result = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140D5A768)(&CmControlHive, v7, v26);
    v24 = result;
    if ( !result )
      return result;
  ...
  else
  {
    ...
    ControlSet = CmpFindControlSet((ULONG_PTR)&CmControlHive, v7, (int)&DestinationString, (_BYTE *)&v25 + 1);
    if ( ControlSet == -1 )
      KeBugCheckEx(0x74u, 1uLL, 2uLL, (ULONG_PTR)&CmControlHive, (ULONG_PTR)&DestinationString);
    result = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140D5A768)(&CmControlHive, ControlSet, v26);
    v10 = result;
    if ( !result )
      return result;
  ...
  ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140D5A770)(&CmControlHive, v26);
  if ( CmControlVector[0] )
  {
    do
    {
      if ( a3 != 1 || *((_BYTE *)v3 + 40) )
      {
        ...
        if ( v14 != -1 )
        {
          result = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140D5A768)(&CmControlHive, v14, v26);
          v15 = result;
          if ( !result )
            return result;
          ...
          if ( ValueByName != -1 )
          {
            ...
            if ( v19 )
              v13 = *v19;
            result = ((__int64 (__fastcall *)(ULONG_PTR *, _QWORD, _DWORD *))qword_140D5A768)(
                       &CmControlHive,
                       ValueByName,
                       v29);
            v20 = result;
            ...
            if ( v13 && !(unsigned __int8)CmpGetBootValueData(v21, result, v3[2], v13) )
              return ((__int64 (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140D5A770)(&CmControlHive, v29);
            v23 = v3[4];
            if ( v23 )
              *(_DWORD *)v23 = *(_DWORD *)(v20 + 12);
            ((void (__fastcall *)(ULONG_PTR *, _DWORD *))qword_140D5A770)(&CmControlHive, v29);
          }
        }
