/*
 * XREFs of CcUnmapVacbArray @ 0x1402BEA50
 * Callers:
...
__int64 __fastcall CcUnmapVacbArray(__int64 a1, __int64 *a2, unsigned int a3, char a4, char a5, char a6)
{
  ...
  signed __int64 v31; // [rsp+30h] [rbp-38h]
  ...
  if ( *(_QWORD *)(a1 + 88) )
  {
    ...
    if ( v14 < v15 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v17 <= 0x2000000 )
        {
          i = *(_QWORD *)(v18 + 8 * ((unsigned __int64)(unsigned int)v31 >> 18));
        }
        else
        {
          v19 = v14;
...
LABEL_22:
      ...
      if ( v17 > 0x2000000 )
        ...
        *(_QWORD *)(v18 + 8 * ((unsigned __int64)(unsigned int)v31 >> 18)) = 0LL;
      ...
      *(_QWORD *)(i + 8) = 0LL;
      v27 = v26;
      LOBYTE(v28) = (v8 & 2) != 0;
      CcSetVacbInFreeList(Partition, i, v28);
