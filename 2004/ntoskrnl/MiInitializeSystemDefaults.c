/*
 * XREFs of MiInitializeSystemDefaults @ 0x140A6E768
 * Callers:
...
ULONG_PTR __fastcall MiInitializeSystemDefaults(__int64 a1)
{
  ...
  dword_140C4DCE4 = LogicalProcessorsPerCore;
...
LABEL_23:
  ...
  {
    byte_140C00DE3 = 4;
    qword_140C4DD40 = 1LL << ((unsigned __int8)KiImplementedPhysicalBits - 1);
