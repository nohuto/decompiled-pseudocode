 ...
 *     RtlGetSwapReferenceIndex @ 0x1407C24D4 (RtlGetSwapReferenceIndex.c)
 ...
 *     CmFcpSwapSectionState @ 0x14087B454 (CmFcpSwapSectionState.c)
...
__int64 CmFcManagerStartRuntimePhase()
{
  ...
  *(_OWORD *)&DestinationString[1] = 0LL;
  ...
  if ( SectionFromBuffer >= 0 )
  {
    ...
    RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C47FB0, (__int64)&Buffer, DestinationString);
    v6 = Buffer;
    v7 = v33;
    v8 = 3LL;
    do
    ...
    if ( !QuadPart
      || (SectionFromBuffer = CmFcpManagerCreateSectionFromBuffer(
          ...
          SectionFromBuffer >= 0) )
    {
      RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C47FB0, (__int64)v9);
      v9 = 0LL;
      v12 = 0;
      while ( 1 )
      {
        ...
        if ( ++v12 >= 3 )
        {
          ...
          while ( v16 != 1 );
          RtlpFcBufferManagerUpdateBuffers(qword_140C47FB0, Buffer, (__int64)v32);
          memset(v32, 0, 0x48uLL);
          ...
          if ( SectionFromBuffer >= 0 )
          {
            for ( i = 0; i < 2; ++i )
            {
              v18 = ((unsigned __int8)RtlGetSwapReferenceIndex(qword_140C48070) - 1) & 1;
              ...
              RtlUpdateSwapReference(qword_140C48070, v18);
            }
            qword_140C48128 = ExAllocateTimer(
