/*
 * XREFs of sub_14095BE30 @ 0x14095BE30
 * Callers:
...
__int64 __fastcall sub_14095BE30(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // r8
  __int64 v5; // r15
  int v6; // r11d
...
LABEL_29:
    if ( v10 >= 0 )
    {
      ...
      if ( qword_140D2D498 )
        v24 = qword_140D2D498(PoolWithTag);
      else
        v24 = -1073741637;
      v10 = v24;
      if ( v24 < 0 )
      ...
      if ( *(_DWORD *)(a2 + 16) >= 0xFFFFF7C8 )
        goto LABEL_102;
      v26 = *(_DWORD *)(a2 + 16) + 2108;
      if ( v26 < *(_DWORD *)(a2 + 16) + 2104 )
        goto LABEL_102;
...
LABEL_103:
      ...
      *(_DWORD *)(a4 + 4) = 2080;
      v10 = 0;
      v27 = ExAllocatePoolWithTag(PagedPool, 0x820uLL, 0x20534C53u);
      if ( v27 )
      {
        *(_QWORD *)(a4 + 8) = v27;
        *(_DWORD *)a4 = 0;
...
LABEL_85:
          if ( v49 + 1 < v49 )
            goto LABEL_102;
          v10 = 0;
          if ( (unsigned __int64)(v49 + 513) <= v44 + (unsigned __int64)*(unsigned int *)(a4 + 4) )
          {
            *v49 = 2048;
            memmove(v49 + 1, PoolWithTag, 0x800uLL);
            ++*(_DWORD *)a4;
            goto LABEL_88;
          }
LABEL_58:
