/*
 * XREFs of MiInitializeBootLoadedDriverPfns @ 0x140A5D67C
 * Callers:
...
LABEL_10:
    if ( (PVOID)v10 != PsHalImageBase && (PVOID)v10 != PsNtosImageBase )
    {
      _InterlockedExchangeAdd(&dword_140C4EDD0, v11);
      qword_140C4EDB0 -= v9;
    }
    goto LABEL_13;
  }
...
LABEL_9:
  ...
  if ( (int)MiAcquireNonPagedResources((__int64)&MiSystemPartition, v16, 0LL, 0) >= 0 )
  {
    qword_140C4EDB0 += v16;
    goto LABEL_9;
  }
