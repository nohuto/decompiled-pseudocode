/*
 * XREFs of WbDecryptWarbirdEncryptionSegmentBlockV0 @ 0x1405CE220
 * Callers:
...
__int64 __fastcall WbDecryptWarbirdEncryptionSegmentBlockV0(__int64 *a1, int a2, _DWORD *a3)
{
  ...
  else
  {
    ...
    if ( v7 >= 0 )
    {
      v7 = sub_1405CE5A8((_DWORD)v6, a3[2] & 0xFFFFFFF, (*a3 & 2) == 0, (unsigned int)&Mdl, (__int64)&v11);
      if ( v7 >= 0 )
      {
        v8 = v11;
        if ( !a2
          || (v7 = ApplyRelocations(
              ...
              v7 >= 0) )
        {
          v7 = sub_1406D9554(0, (_DWORD)v6, v8, a3[2] & 0xFFFFFFF, a1[7] + 72, a3[1] & 0xFFFFFFF, a1[7] + 80);
          if ( v7 >= 0 )
          {
            if ( !a2
              || (v7 = ApplyRelocations(
