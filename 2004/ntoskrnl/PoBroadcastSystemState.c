/*
 * XREFs of PoBroadcastSystemState @ 0x14098F324
 * Callers:
 ...
 *     PopMapInternalActionToIrpAction @ 0x140381044 (PopMapInternalActionToIrpAction.c)
 ...
 *     PopUpdateSmbiosData @ 0x140767470 (PopUpdateSmbiosData.c)
 *     PopDiagTraceDevicesWakeEnd @ 0x14076761C (PopDiagTraceDevicesWakeEnd.c)
 *     IoNotifyPowerOperationVetoed @ 0x14089C960 (IoNotifyPowerOperationVetoed.c)
 ...
 *     PopSetupSleepNotifies @ 0x140991A00 (PopSetupSleepNotifies.c)
 *     PopHandleWakeSources @ 0x1409950C0 (PopHandleWakeSources.c)
 *     PopBootLoaderSiData @ 0x140995BE4 (PopBootLoaderSiData.c)
...
__int64 __fastcall PoBroadcastSystemState(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = (char *)qword_140C22DF0;
  v29 = *(_BYTE *)(a1 + 25);
  v4 = v29;
  *(_BYTE *)qword_140C22DF0 = *(_BYTE *)(a1 + 26);
...
LABEL_37:
    ...
    v15 = *(_DWORD *)(a1 + 16);
    if ( v15 == 4 && (PopShutdownPowerOffPolicy || *(_QWORD *)&qword_140C22E70) )
    {
      v16 = 4LL;
    }
    else
    ...
    *((_DWORD *)v6 + 1) = 1;
    if ( *(_BYTE *)(a1 + 26) != 2
      || (PopDiagTraceEventNoPayload(&POP_ETW_EVENT_DEVICESWAKE),
          qword_140C23358 = KeQueryPerformanceCounter(0LL).QuadPart,
          *v6 == 2) )
    {
      if ( v11 )
        PopFxActivateDevicesForSx(1u);
    ...
    do
    {
      ...
      if ( v22 == 1 && *(_BYTE *)(a1 + 26) == 2 && !v11 )
      {
        ...
        {
          if ( qword_140C22E80 && *(_QWORD *)(qword_140C22E80 + 216) )
            PopBootLoaderSiData();
          PopUpdateSmbiosData(
            *(_BYTE *)(*(_QWORD *)(qword_140C22E80 + 200) + 980LL),
            *(_BYTE *)(*(_QWORD *)(qword_140C22E80 + 200) + 981LL),
            *(_DWORD *)(*(_QWORD *)(qword_140C22E80 + 200) + 976LL),
            *(_QWORD *)(*(_QWORD *)(qword_140C22E80 + 200) + 968LL));
        }
        if ( dword_140C22E68 == 5 )
    ...
    {
      PopFxIdleDevicesFromSx();
      qword_140C23360 = KeQueryPerformanceCounter(0LL).QuadPart;
