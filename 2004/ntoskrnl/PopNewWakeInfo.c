/*
 * XREFs of PopNewWakeInfo @ 0x1409951DC
 * Callers:
...
LONG PopNewWakeInfo()
{
  ...
  if ( v1 )
  {
    ...
    {
      v7 = (_QWORD *)qword_140C24118;
      v8 = *(_QWORD **)(qword_140C24118 + 8);
      if ( *(__int64 **)qword_140C24118 == &PopWakeInfoList && *v8 == qword_140C24118 )
      {
        qword_140C24118 = *(_QWORD *)(qword_140C24118 + 8);
        *v8 = &PopWakeInfoList;
        v7[1] = v7;
        *v7 = v7;
