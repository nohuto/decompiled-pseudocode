/*
 * XREFs of MiAddPrivateFixupEntryForSystemImage @ 0x1403A2C58
 * Callers:
...
LABEL_7:
  ...
  v7 = ExAcquireSpinLockExclusive(&dword_140C4CAE4);
  v8 = (_QWORD *)qword_140C4CAC8;
  if ( *(__int64 **)qword_140C4CAC8 != &qword_140C4CAC0 )
    __fastfail(3u);
  *v5 = &qword_140C4CAC0;
  v5[1] = v8;
  *v8 = v5;
  qword_140C4CAC8 = (__int64)v5;
