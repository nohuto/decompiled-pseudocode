/*
 * XREFs of ExpSnapShotHandleTables @ 0x1409496A0
 * Callers:
 *     ObGetHandleInformation @ 0x1408D97EC (ObGetHandleInformation.c)
 *     ObGetHandleInformationEx @ 0x1408D9840 (ObGetHandleInformationEx.c)
 * Callees:
