/*
 * XREFs of RtlpWalkFrameChain @ 0x1402E7990
 * Callers:
 ...
 *     RtlWow64GetCpuAreaInfo @ 0x1406E65F0 (RtlWow64GetCpuAreaInfo.c)
...
__int64 __fastcall RtlpWalkFrameChain(__int64 a1, unsigned int a2, char a3, unsigned int a4)
{
  ...
  char *v75; // [rsp+F8h] [rbp+A8h] BYREF
  ...
  v47 = 0;
  v54 = 0;
  if ( !(unsigned __int8)RtlpGetStackLimits((__int64)&v57, (__int64)&v59) )
    return 0LL;
  v7 = 0LL;
  v77 = 0LL;
  v8 = a3 & 1;
...
LABEL_15:
    ...
    if ( (v20 & 2) != 0 )
    {
      ...
      v45 = (unsigned int)RtlpGetEntireXStateAreaLength(v11) - 512;
      ...
      v46 = ((unsigned __int64)&STACK[0x577] & 0xFFFFFFFFFFFFFFC0uLL) - (unsigned int)&STACK[0x520];
  ...
  if ( v8 )
  {
    ...
    if ( !Teb || (*((_WORD *)Teb + 3063) & 0x100) != 0 )
      return 0LL;
    if ( (unsigned __int16)PsWow64GetProcessMachine(v73) != 332 || v41[43] == 2 )
    {
      v25 = v53;
    }
    else
    ...
    for ( j = v23->InitialStack; (j[1] & 1) != 0; j = (_QWORD *)j[5] )
      ;
    v24 = j[4];
    v63 = v24;
...
LABEL_24:
  ...
  while ( 1 )
  {
    ...
    {
      v21 = (char *)v82;
      if ( v82 >= 0xFFFF800000000000uLL && byte_140C4F7C8[((v82 >> 39) & 0x1FF) - 256] == 1 )
      {
        if ( !(unsigned int)MmIsSessionExecutionValid(v23, v73, v82, 0xFFFF800000000000uLL) )
          goto LABEL_155;
        v26 = 0xFFFF800000000000uLL;
      }
    }
    ...
    v75 = 0LL;
    v56 = 0;
    if ( ((unsigned __int8)v73 & 7) != 0 )
      goto LABEL_154;
    if ( (unsigned __int64)v73 < v57 || v73 >= v59 )
      break;
LABEL_31:
...
LABEL_43:
  ...
  if ( v57 < 0xFFFF800000000000uLL )
    goto LABEL_154;
  KeQueryCurrentStackInformation(&v56, &v75, &v76);
  if ( v56 <= 9 )
  {
    v33 = 929;
    if ( _bittest(&v33, v56) )
  ...
  if ( v56 != 1 )
  {
    ...
    {
      v44 = (unsigned __int64 *)((char *)KeGetPcr()->Prcb.DpcStack + 80);
      v21 = (char *)v44 - (unsigned int)KeKernelStackSize;
  ...
  {
    v75 = (char *)*((_QWORD *)&v79 + 1);
    v76 = v35;
    if ( (unsigned __int64)v28 >= *((_QWORD *)&v79 + 1) && (unsigned __int64)v28 < v35 )
    {
      v57 = *((_QWORD *)&v79 + 1);
      v59 = (unsigned __int64 *)v35;
LABEL_88:
      v58 = v63;
      v6 = v54;
      v55 = v62;
