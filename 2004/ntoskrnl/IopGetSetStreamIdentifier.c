/*
 * XREFs of IopGetSetStreamIdentifier @ 0x1405013CC
 * Callers:
 *     IoAllocateSfioStreamIdentifier @ 0x140500460 (IoAllocateSfioStreamIdentifier.c)
 *     IoGetSfioStreamIdentifier @ 0x1405007C0 (IoGetSfioStreamIdentifier.c)
 * Callees:
