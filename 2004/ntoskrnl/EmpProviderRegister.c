/*
 * XREFs of EmpProviderRegister @ 0x140785DE0
 * Callers:
 *     EmProviderRegister @ 0x140785D70 (EmProviderRegister.c)
 *     EmInitSystem @ 0x140A4009C (EmInitSystem.c)
 *     HalRegisterErrataCallbacks @ 0x140A403C0 (HalRegisterErrataCallbacks.c)
