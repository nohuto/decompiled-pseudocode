/*
 * XREFs of KiExpireTimer2 @ 0x14027FA60
 * Callers:
...
__int64 __fastcall KiExpireTimer2(unsigned __int64 a1, __int64 a2, unsigned __int64 a3, _DWORD *a4)
{
  ...
  ULONG_PTR v29; // rsi
  volatile signed __int32 v30; // ecx
  int v31; // r13d
  ...
  LARGE_INTEGER v87; // [rsp+58h] [rbp-51h] BYREF
...
LABEL_66:
      ...
      while ( 1 )
      {
        ...
        if ( v52 )
        {
          if ( (unsigned __int8)PsTimerResolutionActive(*(_QWORD *)(v53[3] + 544), v17) )
            break;
        }
        if ( v50 == (__int64 *)v51 )
          goto LABEL_66;
...
LABEL_15:
  ...
  *(_QWORD *)(a1 + 72) = v18;
  while ( !(unsigned __int8)KiInsertTimer2(a1, 0LL, &v81) )
  {
    if ( v19 )
      goto LABEL_4;
    v57 = *(_QWORD *)(a1 + 72);
...
LABEL_32:
  ...
  if ( v29 )
  {
    ...
    KiUpdateTimer2Flags((volatile signed __int32 *)a1, v8 | 0x10, 0);
    if ( *(_QWORD *)(v7 + 11528) )
