/*
 * XREFs of HvlAddSecurePagesCallbackRoutine @ 0x1404F34C0
 * Callers:
 *     HvlAddSecureHvPagesCallbackRoutine @ 0x1404F34A0 (HvlAddSecureHvPagesCallbackRoutine.c)
 *     HvlAddSecureSkPagesCallbackRoutine @ 0x1404F36F0 (HvlAddSecureSkPagesCallbackRoutine.c)
 * Callees:
 *     HvlpAddCrashdumpAreaPages @ 0x1404F3C1C (HvlpAddCrashdumpAreaPages.c)
 ...
 *     IoIsPartialDumpRetry @ 0x1404FD278 (IoIsPartialDumpRetry.c)
 */
...
LABEL_5:
    ...
    xmmword_140C473D0 = 0LL;
    xmmword_140C473E0 = 0LL;
    result = HvlpStartSecurePageListIteration(1LL, v4, 0LL, 0LL, 0, &v14);
    if ( (int)result < 0 )
      return result;
    *((_QWORD *)&xmmword_140C473E0 + 1) = v14;
  ...
  if ( (_BYTE)HvlpCrashdumpIterationState )
  {
      ...
      || (LOBYTE(v8) = 1, result = HvlpAddCrashdumpAreaPages(a4, v8), !(_BYTE)result) )
    {
      if ( BYTE2(HvlpCrashdumpIterationState) || (result = HvlpAddCrashdumpAreaPages(a4, 0LL), !(_BYTE)result) )
      {
        ...
        {
          while ( (_DWORD)xmmword_140C473E0 )
          {
LABEL_22:
            *(_QWORD *)(a4 + 24) = (**((_QWORD **)&xmmword_140C473D0 + 1) >> 40) + 1LL;
            result = 0xFFFFFFFFFFLL;
            *(_QWORD *)(a4 + 16) = **((_QWORD **)&xmmword_140C473D0 + 1) & 0xFFFFFFFFFFLL;
            *((_QWORD *)&xmmword_140C473D0 + 1) += 8LL;
            LODWORD(xmmword_140C473E0) = xmmword_140C473E0 - 1;
            if ( *(_QWORD *)(a4 + 24) )
            {
          ...
          while ( 1 )
          {
            ...
            if ( (int)VslGetSecurePageList(0LL, 0LL, 0LL, &v13) < 0 )
              break;
            LODWORD(xmmword_140C473E0) = *(unsigned __int16 *)(*((_QWORD *)&xmmword_140C473E0 + 1) + 8LL);
            *((_QWORD *)&xmmword_140C473D0 + 1) = *((_QWORD *)&xmmword_140C473E0 + 1) + 16LL;
            if ( (_DWORD)xmmword_140C473E0 )
              goto LABEL_22;
          }
        }
        result = HvlpEndSecurePageListIteration(1LL, 0LL, 0LL);
