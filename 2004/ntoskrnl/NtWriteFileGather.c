        ...
        ULONG *a9)
{
  ...
  __int64 v70; // [rsp+110h] [rbp+18h] BYREF
  void *v71; // [rsp+118h] [rbp+20h]
  ...
  *(_QWORD *)&v55[7] = 0LL;
  ...
  result = IopReferenceFileObject(a1, 0, PreviousMode, (PVOID *)&FileObject, &v65);
  if ( (int)result < 0 )
    return result;
  ...
  if ( PreviousMode )
  {
    ...
    *(_DWORD *)v23 = *(_DWORD *)v23;
    IopMarkApcRoutineIfAsynchronousIo32((unsigned int **)&a5, &v70, *(_BYTE *)p_Flags & 2);
    ...
    v15 = FileObject;
    if ( FileObject->CompletionContext && (v70 & 0xFFFFFFFFFFFFFFFEuLL) != 0 )
      RtlRaiseStatus(0xC000000D);
    if ( v10 )
    {
      if ( (v10 & 3) != 0 )
        ExRaiseDatatypeMisalignment();
      *(_QWORD *)&v55[7] = *(_QWORD *)v10;
      v15 = FileObject;
    }
    p_Flags = &v15->Flags;
    v61 = &v15->Flags;
  ...
  if ( (*p_Flags & 2) != 0 )
  {
    ...
    v50 = FileObject;
    v51 = KeAbPreAcquire((ULONG_PTR)&FileObject->Lock, 0LL, 0LL);
    v55[0] = 0;
...
LABEL_125:
  ...
  if ( Irp )
  {
    ...
    Irp->Overlay.AllocationSize.QuadPart = v70;
