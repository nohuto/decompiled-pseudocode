/*
 * XREFs of IovCallDriver @ 0x1409C1CA4
 * Callers:
        ...
        if ( !*(_BYTE *)(v9 - 72) )
        {
          ...
          if ( v10 )
          {
            if ( (*(_DWORD *)(v10 + 80) & 0x204000) == 0x204000 && (MmVerifierData & 0x400000) == 0 )
            {
              v8[157] = KeAcquireSpinLockRaiseToDpc(&VfBugcheckTmpDataLock);
              qword_140D48038 = *((_QWORD *)v8 + 20);
              xmmword_140D48040 = *((_QWORD *)v8 + 21);
              *(&xmmword_140D48040 + 1) = *(_QWORD *)(v9 - 24);
              *(_QWORD *)&VfBugcheckTmpData = 201LL;
