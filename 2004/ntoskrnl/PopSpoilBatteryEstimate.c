/*
 * XREFs of PopSpoilBatteryEstimate @ 0x14076C16C
 * Callers:
 *     PopSpoilEstimatesOnPowerStateTransitionWorker @ 0x140767660 (PopSpoilEstimatesOnPowerStateTransitionWorker.c)
  ...
  if ( a1 < 2 )
  {
    ...
    if ( (unsigned int)dword_140C021E8 > 5 )
    {
      ...
      return tlgWriteTransfer_EtwWriteTransfer(
               ...
               (unsigned __int8 *)&dword_140028834,
               0LL,
               0LL,
               4u,
               &v9);
