/*
 * XREFs of ObpCreateHandle @ 0x1405F6330
 * Callers:
 ...
 *     ObpPreInterceptHandleCreate @ 0x140687F10 (ObpPreInterceptHandleCreate.c)
        ...
        unsigned __int64 *a11)
{
  ...
  bool v143; // [rsp+A1h] [rbp-7Fh]
  int v144; // [rsp+A4h] [rbp-7Ch] BYREF
  ...
  unsigned int *v154; // [rsp+F0h] [rbp-30h]
  int v155; // [rsp+F8h] [rbp-28h] BYREF
  int v156; // [rsp+FCh] [rbp-24h] BYREF
...
LABEL_8:
  ...
  v154 = (unsigned int *)ObReferenceProcessHandleTable((struct _EX_RUNDOWN_REF *)Process);
  v17 = v154;
  if ( !v154 )
  ...
  v145 = 1;
LABEL_9:
  v143 = v17 == (unsigned int *)ObpKernelHandleTable;
  if ( !v14 || v17 == (unsigned int *)ObpKernelHandleTable && !v14->OriginalDesiredAccess )
  {
    ...
    if ( (PreviouslyGrantedAccess & 0xF0000000) != 0 )
    {
      RtlMapGenericMask(
        &AccessMask,
        (PGENERIC_MAPPING)(ObTypeIndexTable[(unsigned __int8)ObHeaderCookie ^ *(unsigned __int8 *)(v12 - 24) ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)(v12 - 48) >> 8)]
                         + 76));
      PreviouslyGrantedAccess = AccessMask;
    }
    goto LABEL_114;
  ...
  if ( v15 - 1 > 1 )
  {
    ...
    if ( (RemainingDesiredAccess & 0x1000000) != 0 )
    {
      ...
      {
        SePrivilegedServiceAuditAlarm(0LL, &v14->SubjectSecurityContext, &RequiredPrivileges, 0LL);
...
LABEL_41:
  ...
  if ( *(_UNKNOWN **)(v22 + 152) == &SeDefaultObjectMethod )
  {
    ...
    if ( v36 <= 1 && PoolWithTag )
    {
      ...
      ObDereferenceSecurityDescriptor(PoolWithTag, 15LL);
    }
LABEL_62:
    v41 = 0;
...
LABEL_115:
  ...
  if ( v14 )
  {
    if ( v13 )
    {
      ...
      NamedObject = ObpInsertOrLocateNamedObject(BugCheckParameter1, a7, v13, (__int64)&v158);
      if ( NamedObject < 0 )
        goto LABEL_291;
  ...
  if ( v14 )
  {
    ...
    if ( v70 <= 1 && v71 )
    {
      ...
      ObDereferenceSecurityDescriptor(v71, 15LL);
    }
LABEL_147:
...
LABEL_151:
  ...
  *(_QWORD *)&v166 = &v166;
  ...
  {
    v156 = v144;
    NamedObject = ObpPreInterceptHandleCreate(v88, v143, &v156, &v166);
    if ( NamedObject < 0 )
    {
...
LABEL_217:
  ...
  if ( v14 )
  {
           ...
           || (*(_DWORD *)(*((_QWORD *)Object + 1) + 52LL) & 0x10) == 0 )
    {
      AuxData = v14->AuxData;
      v116 = 0;
      if ( AuxData && (v117 = AuxData[7]) != 0 )
        v116 = 1;
      else
        v117 = 0LL;
      if ( (int)ObpAllocateAndQuerySecurityDescriptorInfo(Object, 32LL, v117, &P) >= 0 )
      {
