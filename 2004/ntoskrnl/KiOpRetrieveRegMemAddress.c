/*
 * XREFs of KiOpRetrieveRegMemAddress @ 0x1403C9DE0
 * Callers:
 *     KiOp_Div @ 0x1403C9CE0 (KiOp_Div.c)
 *     KiOp_SGDTSIDT @ 0x14051F590 (KiOp_SGDTSIDT.c)
 *     KiOp_SLDTSTRSMSW @ 0x14051F750 (KiOp_SLDTSTRSMSW.c)
 * Callees:
 *     KiOpComputeLinearAddress @ 0x14051F0FC (KiOpComputeLinearAddress.c)
 */
