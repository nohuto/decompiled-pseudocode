/*
 * XREFs of ViDeadlockRemoveMemoryRangeResources @ 0x14059CD58
 * Callers:
 ...
 *     VfUtilAddressRangeFit @ 0x1409C32EC (VfUtilAddressRangeFit.c)
 *     ViDeadlockDatabaseHashIndex @ 0x1409DC214 (ViDeadlockDatabaseHashIndex.c)
