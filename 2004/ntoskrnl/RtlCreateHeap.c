/*
 * XREFs of RtlCreateHeap @ 0x140756C80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlpHpLegacyGetEnvHandle @ 0x1403608CC (RtlpHpLegacyGetEnvHandle.c)
 *     DbgPrint @ 0x140361340 (DbgPrint.c)
 *     RtlpHpFixedHeapCreate @ 0x1403795D8 (RtlpHpFixedHeapCreate.c)
 *     RtlpHpConvertCreationFlags @ 0x140379888 (RtlpHpConvertCreationFlags.c)
