/*
 * XREFs of sub_1403E8424 @ 0x1403E8424
 * Callers:
 *     KiMarkBugCheckRegions @ 0x1403D91D8 (KiMarkBugCheckRegions.c)
 * Callees:
 *     KeKvaShadowingActive @ 0x1402FDE54 (KeKvaShadowingActive.c)
 *     IoAddTriageDumpDataBlock @ 0x1403C9218 (IoAddTriageDumpDataBlock.c)
 *     MmIsAddressValid @ 0x1405316A0 (MmIsAddressValid.c)
 *     ExQueryBigPoolTag @ 0x1405AE5D0 (ExQueryBigPoolTag.c)
 */

void __fastcall sub_1403E8424(__int64 a1, __int64 a2, int a3, int a4)
{
  int v4; // eax
