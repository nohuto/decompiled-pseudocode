/*
 * XREFs of TtmiLogDeviceToTerminalAssigned @ 0x1408FF210
 * Callers:
...
void __fastcall TtmiLogDeviceToTerminalAssigned(int a1, int a2)
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v6 = a1;
      v7 = a2;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)byte_14002A021, 0LL, 0LL, 5u, &v8);
    }
  }
}
