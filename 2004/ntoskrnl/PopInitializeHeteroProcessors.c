/*
 * XREFs of PopInitializeHeteroProcessors @ 0x1407A7F88
 * Callers:
 ...
 *     PpmIdleEnableIdleDurationExpirationTimeout @ 0x140561548 (PpmIdleEnableIdleDurationExpirationTimeout.c)
  ...
  if ( v2 )
  {
    ...
    if ( !v9 )
    {
      ...
      else
      {
        ...
        {
          v30[1] = (unsigned __int16 *)qword_140C11538;
          v31 = 0;
...
LABEL_56:
  ...
  {
    v34[1] = (unsigned __int16 *)qword_140C11258[0];
