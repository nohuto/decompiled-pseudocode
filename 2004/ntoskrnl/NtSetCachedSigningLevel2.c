/*
 * XREFs of NtSetCachedSigningLevel2 @ 0x140718B20
 * Callers:
 *     NtSetCachedSigningLevel @ 0x140718AF0 (NtSetCachedSigningLevel.c)
 * Callees:
 *     _guard_dispatch_icall @ 0x1403FFC70 (_guard_dispatch_icall.c)
 *     memmove @ 0x140409FC0 (memmove.c)
 *     RtlUnicodeStringValidateEx @ 0x14057FE68 (RtlUnicodeStringValidateEx.c)
    ...
    if ( (Flags & 4) == 0 )
    {
      ...
      if ( !qword_140C1D8E0
        || (LOBYTE(Process) = (__int64)Process[2].Header.WaitListHead.Flink & 0xF,
            LOBYTE(v21) = v22,
            !(unsigned int)qword_140C1D8E0(v21, Process, SourceFiles)) )
      {
        v10 = v22;
      }
      v7 = SourceFiles;
...
LABEL_9:
      ...
      v12 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, __int64, UNICODE_STRING *, ULONG, HANDLE, PCUNICODE_STRING))qword_140C1D8A8)(
              v8 & 0x807,
              v19,
              v16,
              v17,
