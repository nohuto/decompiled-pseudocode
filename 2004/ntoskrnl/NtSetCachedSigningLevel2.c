    ...
    if ( (a1 & 4) == 0 )
    {
      ...
      if ( !qword_140C1D8E0
        || (LOBYTE(Process) = (__int64)Process[2].Header.WaitListHead.Flink & 0xF,
            LOBYTE(v21) = v22,
            !(unsigned int)qword_140C1D8E0(v21, Process, a3)) )
      {
        v10 = v22;
      }
      v7 = (SIZE_T)a3;
...
LABEL_9:
      ...
      v12 = ((__int64 (__fastcall *)(_QWORD, __int64, __int64, __int64, UNICODE_STRING *, unsigned int, __int64, PCUNICODE_STRING))qword_140C1D8A8)(
              v8 & 0x807,
              v19,
              v16,
              v17,
