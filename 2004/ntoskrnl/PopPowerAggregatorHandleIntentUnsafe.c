/*
 * XREFs of PopPowerAggregatorHandleIntentUnsafe @ 0x140763854
 * Callers:
 ...
 *     PopPowerAggregatorHandleSystemTransitionStartIntent @ 0x140713F00 (PopPowerAggregatorHandleSystemTransitionStartIntent.c)
 ...
 *     PopPowerAggregatorIsAtTargetState @ 0x140763E04 (PopPowerAggregatorIsAtTargetState.c)
 *     PopPowerAggregatorHandleSystemTransitionEndIntent @ 0x140767640 (PopPowerAggregatorHandleSystemTransitionEndIntent.c)
 *     PopPowerAggregatorCachePoPolicy @ 0x14077BFAC (PopPowerAggregatorCachePoPolicy.c)
 *     PopPowerAggregatorHandleActiveIntent @ 0x1408EAE80 (PopPowerAggregatorHandleActiveIntent.c)
 *     PopPowerAggregatorHandleDirectedDripsIntent @ 0x1408EAEC0 (PopPowerAggregatorHandleDirectedDripsIntent.c)
 *     PopPowerAggregatorHandleModernStandbyIntent @ 0x1408EAF50 (PopPowerAggregatorHandleModernStandbyIntent.c)
 *     PopPowerAggregatorHandleModernStandbyResumeIntent @ 0x1408EB010 (PopPowerAggregatorHandleModernStandbyResumeIntent.c)
 *     PopPowerAggregatorHandleModernStandbySuspendIntent @ 0x1408EB070 (PopPowerAggregatorHandleModernStandbySuspendIntent.c)
 */
...
__int64 __fastcall PopPowerAggregatorHandleIntentUnsafe(_QWORD *a1, unsigned int a2, unsigned int a3)
{
  ...
  *((_QWORD *)&v9 + 1) = a3;
        ...
        (v6 = (__int64 (__fastcall *)(__int64 *, __int128 *, _QWORD))PopPowerAggregatorIntentHandlers[v5]) != 0LL) )
  {
    ...
    if ( v7 >= 0 )
    {
      xmmword_140C21538 = v9;
      ymmword_140C21548 = v10;
