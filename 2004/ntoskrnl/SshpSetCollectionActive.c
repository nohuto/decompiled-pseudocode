/*
 * XREFs of SshpSetCollectionActive @ 0x14057A9FC
 * Callers:
 *     PdcPoSleepStudyHelperSetPhaseActive @ 0x1407C2620 (PdcPoSleepStudyHelperSetPhaseActive.c)
 *     SshpPowerSettingCallback @ 0x1408F8730 (SshpPowerSettingCallback.c)
 * Callees:
