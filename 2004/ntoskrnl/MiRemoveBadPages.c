/*
 * XREFs of MiRemoveBadPages @ 0x1405296F8
 * Callers:
...
__int64 __fastcall MiRemoveBadPages(__int64 a1, unsigned __int64 a2, unsigned __int64 a3)
{
  ...
  ExAcquirePushLockSharedEx((ULONG_PTR)&qword_140C50C40, 0LL);
  if ( a3 )
  {
...
LABEL_43:
      ...
      if ( *(ULONG_PTR **)(qword_140C4E448 + 8 * ((v16 >> 39) & 0x3FF)) != &MiSystemPartition )
        break;
