/*
 * XREFs of ExpWatchProductTypeInitialization @ 0x140A43A08
 * Callers:
...
char __fastcall ExpWatchProductTypeInitialization(__int64 a1)
{
  ...
  qword_140C19330 = (__int64)ExpWatchProductTypeWork;
  qword_140C19338 = 0LL;
  ...
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      else
      {
        ...
        qword_140C540A0 = ExAllocatePoolWithTag(PagedPool, (unsigned int)BugCheckParameter2, 0x2079654Bu);
        if ( !qword_140C540A0 )
        ...
        if ( (int)NtQueryValueKey(
                    ...
                    (unsigned __int64)&v42,
                    2u,
                    (unsigned __int64)qword_140C540A0,
                    (size_t)Objectd,
                    (unsigned __int64)&BugCheckParameter2) >= 0
          || (ExFreePoolWithTag(qword_140C540A0, 0), qword_140C540A0 = 0LL, !ExpSetupModeDetected) )
        {
LABEL_18:
          v11 = -1LL;
          do
