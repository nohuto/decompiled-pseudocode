/*
 * XREFs of BapdRecordFirmwareBootStats @ 0x140997F00
 * Callers:
...
void BapdRecordFirmwareBootStats()
{
  ...
  Data = 0LL;
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation((ULONGLONG *)&dword_140C02E30, 0LL, 0LL);
  if ( !ExIsSoftBoot() )
  {
      ...
      *(_QWORD *)&UserData.Size = 8LL;
      ...
      if ( (unsigned int)dword_140C02E30 > 4 && tlgKeywordOn((__int64)&dword_140C02E30, 0x400000000000LL) )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)word_14002C882,
          0LL,
          0LL,
          7u,
          &v24);
