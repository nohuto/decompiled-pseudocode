/*
 * XREFs of PopFxUpdateGlobalDeviceAccountingInfo @ 0x140568210
 * Callers:
...
__int64 __fastcall PopFxUpdateGlobalDeviceAccountingInfo(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  result = qword_140C246A8;
  if ( qword_140C246A8 < a1 )
  {
    v3 = a1 - qword_140C246A8;
    qword_140C246B0 += a1 - qword_140C246A8;
    if ( a1 - qword_140C246A8 < a2 )
    {
      qword_140C246B8 += v3;
    }
    else
