/*
 * XREFs of ViKeAcquireSpinLockAtDpcLevelCommon @ 0x1409D8EE0
 * Callers:
 *     VerifierKeAcquireSpinLockAtDpcLevel @ 0x1409D7980 (VerifierKeAcquireSpinLockAtDpcLevel.c)
 *     VerifierKeAcquireSpinLockAtDpcLevelNoReboot @ 0x1409D79D0 (VerifierKeAcquireSpinLockAtDpcLevelNoReboot.c)
 * Callees:
