/*
 * XREFs of CcForEachPartition @ 0x140343DA0
 * Callers:
 *     CcGetDirtyPages @ 0x140343D60 (CcGetDirtyPages.c)
 ...
 *     CcCoalescingCallBack @ 0x1404E4570 (CcCoalescingCallBack.c)
 *     CcIsThereDirtyData @ 0x1404E58B0 (CcIsThereDirtyData.c)
