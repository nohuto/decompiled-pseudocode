/*
 * XREFs of PopTraceThermalStandbyInitiated @ 0x14056E5F4
 * Callers:
...
void PopTraceThermalStandbyInitiated()
{
  ...
  if ( (unsigned int)dword_140C021E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      v1 = v0;
      v4 = 4;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)byte_140027308, 0LL, 0LL, 3u, &v2);
    }
  }
}
