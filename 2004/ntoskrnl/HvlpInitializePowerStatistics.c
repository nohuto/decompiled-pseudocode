/*
 * XREFs of HvlpInitializePowerStatistics @ 0x1404F2F80
 * Callers:
...
__int64 HvlpInitializePowerStatistics()
{
  ...
  *(_DWORD *)v2 = 4;
  ...
  {
    xmmword_140CED1A0 = *(_OWORD *)v3;
    xmmword_140CED1B0 = *((_OWORD *)v3 + 1);
    unk_140CED1C0 = *((_OWORD *)v3 + 2);
    qword_140CED1D0 = v3[6];
  }
