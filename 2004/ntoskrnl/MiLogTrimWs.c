/*
 * XREFs of MiLogTrimWs @ 0x140311A80
 * Callers:
...
void __fastcall MiLogTrimWs(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  {
    MiFillLogProcessInfo(a1, &v16, &v17, *(_QWORD *)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(a1 + 174)));
    if ( *v9 > 5u )
    {
      if ( tlgKeywordOn((__int64)v9, 1LL) )
      {
        ...
        v40 = 4LL;
        v42 = 4LL;
        tlgWriteEx_EtwWriteEx(v14, (int)&qword_140024CC0, 0, v13, 0, 0, 0xCu, (__int64)v25);
      }
    }
  }
}
