/*
 * XREFs of SleepstudyHelperCreateLibrary @ 0x1407BA480
 * Callers:
 *     SleepstudyHelper_Initialize @ 0x1408F8050 (SleepstudyHelper_Initialize.c)
 * Callees:
    ...
    if ( SshpInitialized )
    {
      ...
      if ( NonPaged )
      {
        ...
        *(_QWORD *)(v6 + 56) = v6 + 56;
        ...
        v7 = (__int64 *)qword_140C1E0D8;
        if ( *(__int64 **)qword_140C1E0D8 != &SshpLibraryList )
          __fastfail(3u);
