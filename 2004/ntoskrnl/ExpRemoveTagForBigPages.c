/*
 * XREFs of ExpRemoveTagForBigPages @ 0x1405AE688
 * Callers:
        ...
        _BYTE *a8)
{
  ...
  if ( (v11 & 0x20) != 0 )
  {
    v13 = *(_QWORD *)(qword_140C4DBE0 + 992);
    v14 = (volatile signed __int32 *)(qword_140C4DBE0 + 864);
    v15 = *(_QWORD *)(qword_140C4DBE0 + 1000);
  }
  else
  {
