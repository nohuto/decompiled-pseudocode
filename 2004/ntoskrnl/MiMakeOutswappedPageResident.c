/*
 * XREFs of MiMakeOutswappedPageResident @ 0x1405265F0
 * Callers:
...
unsigned __int64 __fastcall MiMakeOutswappedPageResident(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5)
{
  ...
  v7 = (_QWORD *)(a1 + 1432);
  v81 = (_QWORD *)(a1 + 1432);
  v77 = *(_QWORD *)(qword_140C4E448 + 8 * v6);
  while ( 1 )
  {
    do
  ...
  *(_QWORD *)(v30 + 16) = v8;
  ...
  while ( 1 )
  {
    ...
    *(_DWORD *)&BugCheckParameter2[192] = v40;
    ...
    MiSetPageTablePfnBuddy(v30, 0xFFFF800000000030uLL, 0);
    v43 = 0;
    ...
    *(_QWORD *)&BugCheckParameter2[320] = v13;
    ...
    if ( (*(_WORD *)(v44 + 204) & 0x800) == 0 )
    {
      if ( (*(_WORD *)&BugCheckParameter2[192] & 0x100) != 0 )
      {
        ...
        *(_QWORD *)&BugCheckParameter2[88] = 0LL;
        v45 = SmPageRead((union _MM_STORE_KEY *)&BugCheckParameter2[96], (unsigned __int64)&BugCheckParameter2[272]);
      }
      else
      {
        v45 = IoPageReadEx(
    ...
    MiSetPageTablePfnBuddy(v30, 0LL, 0);
    if ( v55 >= 0 )
      break;
