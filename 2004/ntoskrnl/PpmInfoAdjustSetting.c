/*
 * XREFs of PpmInfoAdjustSetting @ 0x1406A8404
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x1406A74A0 (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x140569334 (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x1406A84C0 (PpmInfoWriteData.c)
 */
