/*
 * XREFs of NtSetInformationFile @ 0x14028FD10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_43:
  ...
  if ( v10 != FileTrackingInformation )
  {
    ...
    *(_QWORD *)(v37 + 48) = v19;
    ...
    v34->MdlAddress = 0LL;
    PoolWithQuota_0 = (struct _IRP *)IopVerifierExAllocatePoolWithQuota_0(0LL, v5, v34);
    v95 = (struct _KTHREAD *)PoolWithQuota_0;
    v39 = Irp;
...
LABEL_70:
        v18 = IopCallDriverReference(DeviceObject, v39, v44, FileObject, 2);
LABEL_71:
        v45 = v83;
        goto LABEL_72;
      }
      ...
      if ( v10 != FileDispositionInformationEx && v10 != FileDispositionInformation )
      {
        switch ( v10 )
        {
          ...
          case FileIoPriorityHintInformation:
            ...
            {
              v18 = IopAllocateFileObjectExtension((__int64)FileObject, &v98);
              if ( v18 >= 0 )
...
LABEL_72:
            ...
            else
            {
              ...
              __writecr8(1uLL);
              IopCompleteRequest((__int64)&v39->Tail, (__int64)&v103, &v99, (__int64 *)&FileObject, &v99);
              if ( KiIrqlFlags )
              {
                if ( (KiIrqlFlags & 1) != 0 )
                {
