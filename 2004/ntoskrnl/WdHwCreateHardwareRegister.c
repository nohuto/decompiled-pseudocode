/*
 * XREFs of WdHwCreateHardwareRegister @ 0x1404D9428
 * Callers:
 ...
 *     WdHwpGetReadMethod @ 0x1404D955C (WdHwpGetReadMethod.c)
 *     WdHwpGetWriteMethod @ 0x1404D95CC (WdHwpGetWriteMethod.c)
 */
