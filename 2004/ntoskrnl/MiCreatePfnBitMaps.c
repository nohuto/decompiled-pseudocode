/*
 * XREFs of MiCreatePfnBitMaps @ 0x1407A5734
 * Callers:
 ...
 *     MiInitializeRebuildCandidateCounts @ 0x140A637D4 (MiInitializeRebuildCandidateCounts.c)
 */
...
__int64 __fastcall MiCreatePfnBitMaps(__int64 a1, _DWORD *a2, __int64 a3, unsigned __int64 a4)
{
  ...
  for ( i = 0; i < 3; ++i )
  {
    ...
    v12 = MiReservePtes((__int64)&qword_140C4ED40, v11, a3, a4);
    v31 = (_QWORD *)v12;
    if ( !v12 )
      goto LABEL_30;
    if ( !(unsigned int)MiInitializeDynamicBitmap(v10, (__int64)(v12 << 25) >> 16, v30, 4) )
    {
      ...
      v27 = v11;
LABEL_29:
      MiReleasePtes((__int64)&qword_140C4ED40, v28, v27);
LABEL_30:
...
LABEL_7:
  ...
  v13 = MiReservePtes((__int64)&qword_140C4ED40, 0x8000u, a3, a4);
  v14 = (_QWORD *)v13;
  if ( !v13 )
    goto LABEL_30;
  ...
  *(_QWORD *)(a1 + 5104) = v15;
  v18 = MiReservePtes((__int64)&qword_140C4ED40, 8u, v16, v17);
  v19 = (_QWORD *)v18;
  if ( !v18 )
    goto LABEL_30;
  ...
  *(_QWORD *)(a1 + 5112) = 0LL;
  v22 = MiReservePtes((__int64)&qword_140C4ED40, 0x80u, v20, v21);
  v23 = (_QWORD *)v22;
  if ( !v22 )
    goto LABEL_30;
