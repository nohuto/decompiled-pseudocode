/*
 * XREFs of HalpVpptInitializePhysicalTimer @ 0x1404BBBB4
 * Callers:
 *     HalpTimerInitializeVpptClockTimer @ 0x140383AE0 (HalpTimerInitializeVpptClockTimer.c)
 * Callees:
...
__int64 HalpVpptInitializePhysicalTimer()
{
  ...
  v4 = (unsigned __int8)byte_140C4A518;
  v5 = v3;
