/*
 * XREFs of PsRegisterPicoProvider @ 0x140908810
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall PsRegisterPicoProvider(__int64 a1, _QWORD *a2)
{
  ...
  xmmword_140C1DDF0 = *(_OWORD *)(a1 + 16);
  xmmword_140C1DE00 = *(_OWORD *)(a1 + 32);
  xmmword_140C1DE10 = *(_OWORD *)(a1 + 48);
  xmmword_140C1DE20 = *(_OWORD *)(a1 + 64);
  qword_140C1DE30 = *(_QWORD *)(a1 + 80);
  PspPicoProviderRanges = _mm_srli_si128((__m128i)xmmword_140C1DE10, 8).m128i_u64[0];
