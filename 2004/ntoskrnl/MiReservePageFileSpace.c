/*
 * XREFs of MiReservePageFileSpace @ 0x1402BA590
 * Callers:
...
LABEL_15:
  ...
  else
  {
    ...
    if ( qword_140C4DD40 && (v23 & 0x10) == 0 )
      v39 = v23 & ~qword_140C4DD40;
    if ( v27 < HIDWORD(v39) )
    {
      if ( qword_140C4DD40 && (v23 & 0x10) == 0 )
        v40 = ~qword_140C4DD40 & v23;
...
LABEL_36:
    ...
    for ( i = a2 - Address; i <= v32; updated = Address )
    {
      ...
      if ( qword_140C4DD40 && (v36 & 0x10) == 0 )
        v36 &= ~qword_140C4DD40;
      if ( v37 && qword_140C4DD40 )
      {
        if ( (v37 & 0x10) != 0 )
          LODWORD(v37) = v37 & 0xFFFFFFEF;
        else
          LODWORD(v37) = ~(_DWORD)qword_140C4DD40 & v37;
      }
