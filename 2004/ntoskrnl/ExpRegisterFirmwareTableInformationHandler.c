/*
 * XREFs of ExpRegisterFirmwareTableInformationHandler @ 0x1407B8AD8
 * Callers:
...
LABEL_7:
  ...
  if ( PoolWithTag )
  {
    *(_DWORD *)PoolWithTag = *(_DWORD *)a1;
    ...
    v11 = (_QWORD *)qword_140C195C8;
    if ( *(__int64 **)qword_140C195C8 != &ExpFirmwareTableProviderListHead )
      goto LABEL_21;
    *v10 = &ExpFirmwareTableProviderListHead;
    v10[1] = v11;
    *v11 = v10;
    qword_140C195C8 = (__int64)v10;
  }
  else
  {
    v3 = -1073741670;
