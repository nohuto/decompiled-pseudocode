/*
 * XREFs of ?ReadPartitionTable@SC_DISK@@QEAAJPEAPEAVSC_DISK_LAYOUT@@@Z @ 0x1405C1AF8
 * Callers:
 ...
 * Callees:
 *     ?ResetPartitionCache@SC_DISK@@QEAAJXZ @ 0x1405C1BCC (-ResetPartitionCache@SC_DISK@@QEAAJXZ.c)
