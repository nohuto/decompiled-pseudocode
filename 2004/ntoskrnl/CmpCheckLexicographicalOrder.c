/*
 * XREFs of CmpCheckLexicographicalOrder @ 0x140671B70
 * Callers:
...
LABEL_14:
  ...
  if ( !v10 )
  {
    ...
    if ( (int)((__int64 (__fastcall *)(UNICODE_STRING *, __int64, _QWORD, _QWORD, _QWORD, wchar_t *))CmpCompareCompressedName)(
                &String1,
                v6 + 76,
                v13,
                0LL,
