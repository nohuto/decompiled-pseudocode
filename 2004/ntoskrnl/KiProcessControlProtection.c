/*
 * XREFs of KiProcessControlProtection @ 0x14050D2F0
 * Callers:
 *     KiControlProtectionFault @ 0x140407000 (KiControlProtectionFault.c)
 * Callees:
 *     KiFixupControlProtectionUserModeReturnMismatch @ 0x1403ED49C (KiFixupControlProtectionUserModeReturnMismatch.c)
