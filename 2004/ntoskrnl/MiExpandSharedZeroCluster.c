/*
 * XREFs of MiExpandSharedZeroCluster @ 0x14031580C
 * Callers:
...
__int64 __fastcall MiExpandSharedZeroCluster(__int64 a1)
{
  ...
  unsigned __int64 v39; // [rsp+110h] [rbp+77h]
  ...
  v34 = MiComputeZeroClusterMaximum(
          (__int64)v5,
  ...
  {
    ProtoPteAddress = MiGetProtoPteAddress(v2, v9, 4, &v32);
    v13 = ProtoPteAddress;
