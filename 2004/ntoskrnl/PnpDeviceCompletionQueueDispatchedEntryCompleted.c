/*
 * XREFs of PnpDeviceCompletionQueueDispatchedEntryCompleted @ 0x14036B388
 * Callers:
...
__int64 __fastcall PnpDeviceCompletionQueueDispatchedEntryCompleted(__int64 a1, _QWORD *a2)
{
  ...
  if ( *(_QWORD **)(*a2 + 8LL) != a2
    ...
    || (*v7 = v5,
        *(_QWORD *)(v5 + 8) = v7,
        v8 = (_QWORD *)qword_140C44980,
        --dword_140C44970,
        *(__int64 **)qword_140C44980 != &qword_140C44978) )
  {
    __fastfail(3u);
  }
  *a2 = &qword_140C44978;
  a2[1] = v8;
  *v8 = a2;
  qword_140C44980 = (__int64)a2;
  KeReleaseSemaphoreEx((__int64)&byte_140C44988, 0LL, 1LL, v4, 0);
