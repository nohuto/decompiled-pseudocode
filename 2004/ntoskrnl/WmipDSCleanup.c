/*
 * XREFs of WmipDSCleanup @ 0x14075A100
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WmipUnlinkInstanceSetFromGuidEntry @ 0x14075A21C (WmipUnlinkInstanceSetFromGuidEntry.c)
...
void __fastcall WmipDSCleanup(ULONG_PTR BugCheckParameter2)
{
  ...
  while ( v2 != (_QWORD *)(BugCheckParameter2 + 40) )
  {
    ...
    if ( v4 && (v3[2] & 8) == 0 )
    {
      ...
      WmipUnreferenceEntry((__int64)&WmipGEChunkInfo, (volatile signed __int64 *)v4);
    }
    *((_QWORD *)v3 + 7) = 0LL;
    v2 = (_QWORD *)*v2;
