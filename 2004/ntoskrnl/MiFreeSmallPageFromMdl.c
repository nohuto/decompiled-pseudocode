/*
 * XREFs of MiFreeSmallPageFromMdl @ 0x1403176EC
 * Callers:
...
_BOOL8 __fastcall MiFreeSmallPageFromMdl(ULONG_PTR BugCheckParameter2, char a2)
{
  ...
  v8 = *(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(v5 + 40) >> 39) & 0x3FFLL));
  MiUpdateLargePageBitMap(v8, BugCheckParameter2, 1, 0, 0);
  ...
  *(_WORD *)(v5 + 32) -= 2;
  if ( v9 )
  {
    ...
    {
      v11 = (_QWORD *)qword_140C4EC80;
      if ( qword_140C4EC80 && ((*(_QWORD *)(v5 + 40) >> 60) & 7) == 1 )
      {
        v12 = v3 / 48;
        while ( v11 )
        {
