/*
 * XREFs of WheapWmiExecuteMethod @ 0x1405B8800
 * Callers:
 *     WheaWmiDispatch @ 0x1403C9470 (WheaWmiDispatch.c)
 * Callees:
 *     WheapWmiExecuteErrorInjectionMethod @ 0x1405B82FC (WheapWmiExecuteErrorInjectionMethod.c)
 *     WheapWmiExecuteErrorSourceMethod @ 0x1405B83E8 (WheapWmiExecuteErrorSourceMethod.c)
 *     WheapWmiExecutePolicyManagementMethod @ 0x1405B8930 (WheapWmiExecutePolicyManagementMethod.c)
 */
