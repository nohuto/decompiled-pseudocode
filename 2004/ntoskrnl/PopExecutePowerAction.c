/*
 * XREFs of PopExecutePowerAction @ 0x140762C18
 * Callers:
 ...
 *     PopPromoteActionFlag @ 0x140762FFC (PopPromoteActionFlag.c)
 *     PopCompareActions @ 0x14076304C (PopCompareActions.c)
...
LABEL_13:
      ...
      if ( v14 )
      {
        ...
        if ( v14 == 4 )
          v18 = v17;
        v46 = v18;
        if ( (int)PopCompareActions(v14, (unsigned int)qword_140C22E44) < 0 )
        {
          v22 = 2;
        }
        else
        {
          ...
          if ( v26 > SHIDWORD(qword_140C22E44) )
          {
            v45 |= v25;
            HIDWORD(qword_140C22E44) = v26;
          }
        }
        LOBYTE(v20) = 1;
        ...
        else
        {
          ...
          if ( !(unsigned int)PopCompareActions(v36, v35) )
            v37 |= v22;
          LODWORD(qword_140C22E44) = v14;
          v38 = v37 | 5;
          v33 = v14;
          dword_140C22E54 = *(_DWORD *)a1;
          dword_140C22E58 = 0;
          v45 = v38;
          if ( !*(_DWORD *)a1 )
            dword_140C22E58 = *(_DWORD *)(a1 + 16);
        }
        if ( v33 == 3 )
          LODWORD(qword_140C22E44) = v22;
        if ( v38 )
        {
          if ( TtmpEnabled == 1 )
            PopTtmIsSxTransitionInProgress = 1;
          v10 = 1;
          if ( (unsigned __int8)byte_140C22E41 < (unsigned __int8)v22 )
          {
...
LABEL_42:
  ...
  if ( (v40 & 0x20) != 0 )
  {
    if ( v10 )
    {
      v41 = (__int64 *)qword_140C23978;
      v40 = *(_QWORD *)(a1 + 8) + 32LL;
      if ( *(__int64 **)qword_140C23978 != &PopActionWaiters )
        __fastfail(3u);
