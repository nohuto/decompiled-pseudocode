/*
 * XREFs of MiScrubNodeLargePageList @ 0x140551998
 * Callers:
 ...
 *     MiScrubInterrupted @ 0x14055E5B8 (MiScrubInterrupted.c)
        ...
        __int64 a10)
{
  ...
  if ( a5 )
  {
    ...
    if ( a3 > 1 )
    {
      v18 = MiReservePtes((__int64)&qword_140C4ED40, v16, v12, a5);
      v14 = v18;
      if ( !v18 )
        return 1LL;
...
LABEL_34:
      ...
      if ( !a5 )
      {
        ...
        *((_QWORD *)&v125 + 1) = 0x100000001LL;
        CurrentIrql = v102;
        v126 = v102;
        MiInsertLargePageInNodeList((__int64)&v125, v43, v35, (__int64)v36);
        goto LABEL_40;
      }
      ...
      *((_QWORD *)v46 + 6) = UltraMapping + (v100 << 12) - 1;
      ...
      ValidPte = MiMakeValidPte(v14, v54, v55, v54);
      if ( a3 <= 1 )
      {
        v59 = 0;
...
LABEL_116:
      ...
      *v114 = v89;
      ...
      if ( a3 <= 1 )
        goto LABEL_135;
      v32 = v100;
      MiReleasePtes((__int64)&qword_140C4ED40, (_QWORD *)v14, v100);
      v92 = MiReservePtes((__int64)&qword_140C4ED40, v100, v90, v91);
      v14 = v92;
      if ( !v92 )
        goto LABEL_137;
...
LABEL_138:
  *((_DWORD *)&v124[1].SwapListEntry + 3) &= ~0x100u;
  ...
  {
    if ( v14 )
      MiReleasePtes((__int64)&qword_140C4ED40, (_QWORD *)v14, v32);
  }
  return v31;
}
