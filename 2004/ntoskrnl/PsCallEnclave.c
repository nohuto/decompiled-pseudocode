/*
 * XREFs of PsCallEnclave @ 0x140909E00
 * Callers:
 ...
 *     RtlPrepareEnclaveCall @ 0x14058DED4 (RtlPrepareEnclaveCall.c)
...
LABEL_9:
  ...
  *(_QWORD *)v7 = *(_QWORD *)v7;
  ...
  EnclaveReturnFrame = RtlPrepareEnclaveCall(BaseTrapFrame, (__int64)a4, v13, v14, &v39, &v38);
...
LABEL_61:
  ...
  *((_DWORD *)&CurrentThread[1].SwapListEntry + 3) &= ~0x200u;
  ...
  --CurrentThread->SpecialApcDisable;
  EnclaveReturnFrame = RtlCreateEnclaveReturnFrame(v42, v23, v24, *((_QWORD *)v10 + 1), v25, ExitStatus, v39, v38, v35);
  KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
  if ( v45 )
    goto LABEL_85;
  v26 = *(_DWORD *)(v16 + 36);
