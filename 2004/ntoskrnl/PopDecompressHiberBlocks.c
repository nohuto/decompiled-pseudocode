/*
 * XREFs of PopDecompressHiberBlocks @ 0x140991804
 * Callers:
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  LODWORD(v8) = (_DWORD)qword_140C230B8;
  v9 = 0;
  v43 = 0;
  v47 = 0LL;
  v41 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( !qword_140C23518 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_140C23060 )
      qword_140C23518 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_140C23061
      && (!byte_140C23060 || (unsigned int)dword_140C23044 > 0x640) )
    {
      v15 = __rdtsc();
      if ( byte_140C50450 )
      {
      ...
      v16 = __rdtsc();
      qword_140C23500 += (((unsigned __int64)HIDWORD(v16) << 32) | (unsigned int)v16) - v15;
    }
    v40 = 4;
