/*
 * XREFs of MiCfgInitializeProcess @ 0x1406B4E54
 * Callers:
 ...
 *     MiMapCfgBitMapSection @ 0x1406B9378 (MiMapCfgBitMapSection.c)
...
__int64 __fastcall MiCfgInitializeProcess(__int64 a1)
{
  ...
  v19 = 0x20000000000LL;
  result = MiMapCfgBitMapSection(a1, qword_140C4CA20, (unsigned int)&v20, (unsigned int)&v18, (__int64)&v19);
  if ( (int)result >= 0 )
  {
...
LABEL_5:
    ...
    v14 = *((_QWORD *)&unk_140C4C9B8 + 8 * v16);
LABEL_30:
    v17 = *(_QWORD *)(a1 + 1496);
    v20 = 0LL;
    v18 = 0LL;
