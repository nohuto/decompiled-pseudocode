/*
 * XREFs of EtwTraceAdminlessAccessFailure @ 0x14093C6A0
 * Callers:
...
char __fastcall EtwTraceAdminlessAccessFailure(int a1, __int64 a2, int a3, char a4)
{
  ...
  if ( !a3 )
  {
    ...
    LOBYTE(v5) = tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BB0, (unsigned __int8 *)v10, 0LL, 0LL, 6u, v11);
    goto LABEL_13;
  }
  if ( (unsigned int)dword_140C02BB0 > 5 )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      LOBYTE(v5) = tlgWriteTransfer_EtwWriteTransfer(
                     ...
                     (unsigned __int8 *)byte_14002C7D9,
                     0LL,
                     0LL,
                     7u,
                     &v26);
