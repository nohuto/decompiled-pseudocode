/*
 * XREFs of IopInitializeBuiltinDriver @ 0x140A4EB10
 * Callers:
...
LABEL_30:
          ...
          if ( v25 )
          {
            ...
            *(_QWORD *)(v17 + 32) = v25;
            *(_WORD *)(v17 + 26) = v28;
            v26->Length = (unsigned __int16)v27;
            memmove(v25, v22, (size_t)v27);
            v29 = v46;
            *((_WORD *)v38 + ((unsigned __int64)v26->Length >> 1)) = 0;
            inserted = IopOpenRegistryKeyEx(&v35, 0LL, v29, 0xF003Fu);
            if ( inserted >= 0 )
            {
              inserted = PnpPrepareDriverLoading(v26, v35, v6, a5, &v45);
              NtClose(v35);
              if ( inserted >= 0 )
              {
                p_Length = &v46->Length;
