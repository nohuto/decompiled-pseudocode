/*
 * XREFs of KiTpEmulateInstruction @ 0x140A0F8C0
 * Callers:
 *     KiTpHandleTrap @ 0x140517D20 (KiTpHandleTrap.c)
 *     KiTpCompletion @ 0x140A0F130 (KiTpCompletion.c)
 *     KiTpParseInstruction @ 0x140A102AC (KiTpParseInstruction.c)
 * Callees:
 *     KiTpAccessMemory @ 0x140A0F008 (KiTpAccessMemory.c)
 *     KiTpDecodeModRm @ 0x140A0F168 (KiTpDecodeModRm.c)
 *     KiTpDecodeModRmOperand @ 0x140A0F254 (KiTpDecodeModRmOperand.c)
 *     KiTpEmulateGroup0Instruction @ 0x140A0F3B4 (KiTpEmulateGroup0Instruction.c)
 *     KiTpEmulateGroup11Instruction @ 0x140A0F610 (KiTpEmulateGroup11Instruction.c)
 *     KiTpEmulateGroup1Instruction @ 0x140A0F6D0 (KiTpEmulateGroup1Instruction.c)
 *     KiTpEmulateMovRegImm @ 0x140A0FF3C (KiTpEmulateMovRegImm.c)
 *     KiTpEmulateMovzx @ 0x140A0FFCC (KiTpEmulateMovzx.c)
 *     KiTpEmulateRegisterPushPop @ 0x140A100DC (KiTpEmulateRegisterPushPop.c)
 *     KiTpFetchInstructionBytes @ 0x140A10210 (KiTpFetchInstructionBytes.c)
 *     KiTpGetRegisterAddressByIndex @ 0x140A10254 (KiTpGetRegisterAddressByIndex.c)
 *     KiTpReadOperandValue @ 0x140A103EC (KiTpReadOperandValue.c)
 *     KiTpSetFlagsZeroSignParity @ 0x140A10640 (KiTpSetFlagsZeroSignParity.c)
 *     KiTpSetImmediateOperandSize @ 0x140A106B0 (KiTpSetImmediateOperandSize.c)
 *     KiTpSignExtendOperandValue @ 0x140A106E0 (KiTpSignExtendOperandValue.c)
 *     KiTpWriteRegisterValue @ 0x140A1070C (KiTpWriteRegisterValue.c)
 */
