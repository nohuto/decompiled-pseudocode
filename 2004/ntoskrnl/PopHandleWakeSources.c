/*
 * XREFs of PopHandleWakeSources @ 0x1409950C0
 * Callers:
 ...
 *     PopWakeInfoReference @ 0x140360FA8 (PopWakeInfoReference.c)
...
void PopHandleWakeSources()
{
  ...
  if ( dword_140C22EA0 < 0 || (unsigned __int64)dword_140C22EA0 >= 3 )
    v3 = 0LL;
  else
    v3 = (SIZE_T *)qword_140C22EB8[3 * dword_140C22EA0];
  if ( v0 == 4 )
  {
...
LABEL_37:
  ...
  PopAcquireWakeSourceSpinLock(&LockHandle);
  v6 = (__int64 *)qword_140C24118;
  if ( *(__int64 **)qword_140C24118 != &PopWakeInfoList )
    goto LABEL_37;
  ++PopWakeInfoCount;
