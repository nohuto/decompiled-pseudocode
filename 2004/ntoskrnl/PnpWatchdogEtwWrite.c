/*
 * XREFs of PnpWatchdogEtwWrite @ 0x1408A8794
 * Callers:
 ...
 * Callees:
 *     PsGetCurrentThreadId @ 0x140338FB0 (PsGetCurrentThreadId.c)
 *     McTemplateK0izzx_EtwWriteTransfer @ 0x140509618 (McTemplateK0izzx_EtwWriteTransfer.c)
 *     PnpWatchdogExtractTriageInformation @ 0x140509AE0 (PnpWatchdogExtractTriageInformation.c)
 *     PnpWatchdogGetElapsedTime @ 0x140509BC8 (PnpWatchdogGetElapsedTime.c)
 */
