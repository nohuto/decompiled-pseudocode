/*
 * XREFs of IopLiveDumpWriteDumpFileWithExtraPages @ 0x140895C20
 * Callers:
 ...
 *     IopLiveDumpCheckTermination @ 0x140894CDC (IopLiveDumpCheckTermination.c)
 *     IopLiveDumpFreeDumpBuffers @ 0x140894DA0 (IopLiveDumpFreeDumpBuffers.c)
 *     IopLiveDumpGetExtraMergePages @ 0x140894F10 (IopLiveDumpGetExtraMergePages.c)
 *     IopLiveDumpGetNtMergePages @ 0x1408951C4 (IopLiveDumpGetNtMergePages.c)
