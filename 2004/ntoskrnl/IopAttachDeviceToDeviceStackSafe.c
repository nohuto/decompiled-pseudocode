/*
 * XREFs of IopAttachDeviceToDeviceStackSafe @ 0x140277254
 * Callers:
 *     IoAttachDeviceToDeviceStackSafe @ 0x140277230 (IoAttachDeviceToDeviceStackSafe.c)
 *     IoAttachDeviceToDeviceStack @ 0x14037ED20 (IoAttachDeviceToDeviceStack.c)
 *     IoAttachDeviceByPointer @ 0x1405004B0 (IoAttachDeviceByPointer.c)
 * Callees:
