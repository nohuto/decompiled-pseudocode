/*
 * XREFs of PnpRequestDeviceAction @ 0x14036DAE4
 * Callers:
 ...
 *     PnpInitializeProcessor @ 0x140506EF8 (PnpInitializeProcessor.c)
 ...
 *     PiResetProblemDevicesWorker @ 0x14075C0B0 (PiResetProblemDevicesWorker.c)
 ...
 *     PpSystemHiveLimitCallback @ 0x14089E8F0 (PpSystemHiveLimitCallback.c)
...
LABEL_9:
      if ( v12 && (KeGetPcr()->Prcb.DpcRequestSummary & 0x10001) == 0 )
      {
        ...
        {
          v43 = *(GUID *)&KeGetPcr()->NtTib.$CC7ADE021331F41D731EA9DD485E62BD::$58191C77EAB639A512BFC482EB8FAE38::Self[105].SubSystemTib;
        }
      }
      goto LABEL_13;
    }
...
LABEL_13:
  *(GUID *)(PoolWithTag + 56) = v43;
  ...
  v15 = KeAcquireSpinLockRaiseToDpc(&qword_140C24BE8);
  if ( ++dword_140C24BF0 == 1 )
  ...
  __writecr8(v15);
  v16 = KeAcquireSpinLockRaiseToDpc(&qword_140C1E930);
  ...
  v19 = (_QWORD *)qword_140C433C8;
  if ( *(__int64 **)qword_140C433C8 != &PnpEnumerationRequestList )
    __fastfail(3u);
  *(_QWORD *)PoolWithTag = &PnpEnumerationRequestList;
  *((_QWORD *)PoolWithTag + 1) = v19;
  *v19 = PoolWithTag;
  qword_140C433C8 = (__int64)PoolWithTag;
  if ( a7 )
  {
