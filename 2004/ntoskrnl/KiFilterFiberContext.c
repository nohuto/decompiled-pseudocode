/*
 * XREFs of KiFilterFiberContext @ 0x140A18BA0
 * Callers:
 ...
 *     KeKeepData @ 0x140A708B8 (KeKeepData.c)
 */
...
_BOOL8 __fastcall KiFilterFiberContext(__int64 a1)
{
  ...
  if ( !*(_QWORD *)&MaxDataSize && !a1 && !__32 )
  {
    if ( PsIntegrityCheckEnabled )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      {
        ExNotifyCallback(CallbackObject, sub_1403DA850, &__29);
  ...
  *(_QWORD *)&v7 = __rdtsc();
  ...
  Parameter[1] = v11;
  Parameter[0] = v9 % 0xD;
  v12 = KeExpandKernelStackAndCallout(sub_140A349E0, Parameter, 0xC000uLL);
  v14 = v33;
  if ( v12 < 0 )
    v14 = 0;
  v33 = v14;
  if ( v14 )
  {
    if ( v5 < 6 )
    {
      ...
      v36 = 0;
      v37 = 0;
      v20 = KeExpandKernelStackAndCallout(sub_140A349E0, v34, 0xC000uLL);
      v21 = v37;
      if ( v20 < 0 )
        v21 = 0;
      v37 = v21;
    ...
    if ( v14 )
    {
      if ( !*(_QWORD *)&MaxDataSize && !a1 && ((int)KiSwInterruptPresent() >= 0 || __32) )
      {
        ...
        if ( v22 >= 0 )
          v23 = 0;
        v40 = v23;
        v24 = KeExpandKernelStackAndCallout(sub_140A349E0, v38, 0xC000uLL);
        v25 = v41;
        if ( v24 < 0 )
          v25 = 0;
        v41 = v25;
      ...
      {
        if ( qword_140D56650 )
          ExFreePoolWithTag(qword_140D56650, v13);
        v26 = 24;
        v27 = &__2a;
        v28 = 3LL;
        do
