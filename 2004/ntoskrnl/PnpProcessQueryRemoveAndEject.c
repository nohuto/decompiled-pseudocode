/*
 * XREFs of PnpProcessQueryRemoveAndEject @ 0x1407303C4
 * Callers:
 ...
 *     PiDetermineDeleteType @ 0x140730B9C (PiDetermineDeleteType.c)
 ...
 *     PiEventAreDeviceRelationsExcluded @ 0x140733028 (PiEventAreDeviceRelationsExcluded.c)
