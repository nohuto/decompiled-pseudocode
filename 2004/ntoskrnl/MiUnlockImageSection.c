/*
 * XREFs of MiUnlockImageSection @ 0x140324F00
 * Callers:
        ...
        ULONG_PTR a4)
{
  ...
  int v44; // [rsp+30h] [rbp-58h] BYREF
  unsigned int v45; // [rsp+34h] [rbp-54h]
  unsigned __int64 v46; // [rsp+40h] [rbp-48h] BYREF
  struct _KTHREAD *v47; // [rsp+48h] [rbp-40h]
  ...
  if ( v8 == 1 )
  {
    if ( a2 <= a3 )
    {
      v10 = MiPteInShadowRange((unsigned __int64)&v46);
      SchedulerAssist = v10;
      v45 = v10;
      ...
      while ( 1 )
      {
        ...
        if ( (_DWORD)SchedulerAssist )
        {
          if ( (MiFlags & 0xC00000) != 0 )
          {
            ...
            if ( *(_BYTE *)(Process + 912) != 1 && (v15 & 1) != 0 && ((v15 & 0x20) == 0 || (v15 & 0x42) == 0) )
            {
              ...
              if ( v12 )
              {
                v17 = *(_QWORD *)(v12 + 8 * (((unsigned __int64)&v46 >> 3) & 0x1FF));
                v12 = v15 | 0x20;
        ...
        if ( _interlockedbittestandset64((volatile signed __int32 *)(v19 + 24), 0x3FuLL) )
        {
          ...
          {
            do
              KeYieldProcessorEx(&v44, Process, v12, SchedulerAssist);
...
LABEL_79:
        ...
        if ( KiIrqlFlags )
        {
          if ( (KiIrqlFlags & 1) != 0 )
          {
            ...
            if ( v39 <= 0xFu && v20 <= 0xFu && v39 >= 2u )
            {
              CurrentPrcb = KeGetCurrentPrcb();
              v41 = CurrentPrcb->SchedulerAssist;
              v42 = ~(unsigned __int16)(-1LL << (v20 + 1));
              v22 = (v42 & v41[5]) == 0;
              v41[5] &= v42;
              if ( v22 )
...
LABEL_52:
        ...
        v33 = (v31 >> 39) & 0x3FF;
        v34 = *(_QWORD *)(qword_140C4E448 + 8 * v33);
        if ( v32 == 1 )
          MiReturnCommit(*(_QWORD *)(qword_140C4E448 + 8 * v33), 1LL);
        v35 = 1LL;
          ...
          if ( (_DWORD)CachedResidentAvailable != -1 )
          {
            if ( (unsigned __int64)(CachedResidentAvailable + 1) <= 0x100 )
            {
              while ( 1 )
              {
                ...
                v22 = (_DWORD)CachedResidentAvailable == v38;
                LODWORD(CachedResidentAvailable) = v38;
                if ( v22 )
                  break;
                if ( v38 == -1 || (unsigned __int64)(v38 + 1LL) > 0x100 )
                  goto LABEL_72;
              }
LABEL_77:
              if ( !v27 )
...
LABEL_72:
        ...
        _InterlockedExchangeAdd64((volatile signed __int64 *)(v34 + 7168), v35);
        goto LABEL_77;
      }
      if ( v23 == 1 )
      {
...
LABEL_88:
    ...
    if ( qword_140C4CB58 )
      result = ExpUnblockPushLock(&qword_140C4CB58, 0LL, 0LL);
  }
  if ( !(_BYTE)CurrentIrql )
