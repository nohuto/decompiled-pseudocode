/*
 * XREFs of MmAssignProcessToJob @ 0x1406598B0
 * Callers:
...
__int64 __fastcall MmAssignProcessToJob(__int64 a1, __int64 a2, int a3)
{
  ...
  v7 = MiLockVadRange(a1, 0xFFFFFFFFFFFFFFFFuLL, 0xFFFFFFFFFFFFFFFFuLL, 0);
  ...
  MiUnlockVadRange(a1, 0xFFFFFFFFFFFFFFFFuLL, v7, 0);
  if ( v3 )
