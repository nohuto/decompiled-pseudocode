/*
 * XREFs of MiInitializeBootDefaults @ 0x140A6DEE4
 * Callers:
...
__int64 __fastcall MiInitializeBootDefaults(__int64 a1)
{
  ...
  if ( (NtGlobalFlag & 0x80000) == 0 )
    MiFlags = v4 | 0x40;
  stru_140C4E7C8.TargetInfoAsUlong = 275;
  stru_140C4E7C8.DeferredRoutine = (PKDEFERRED_ROUTINE)MiAllocatePfnRepurposeLogDispatch;
  stru_140C4E7C8.DeferredContext = 0LL;
  qword_140C4DC30 = (__int64)&qword_140C4DC28;
  qword_140C4DC28 = (__int64)&qword_140C4DC28;
  qword_140C4DC20 = -10000000LL * dword_140CFB194;
  stru_140C4E7C8.DpcData = 0LL;
  stru_140C4E7C8.ProcessorHistory = 0LL;
  qword_140C4CAD0 = 0LL;
  qword_140C4CB58 = 0LL;
  dword_140C4E62C = 5;
  qword_140C4E640 = 0LL;
  SpinLock = 0LL;
  qword_140C4C790 = 0LL;
  qword_140C4C7A8 = 0x7FF5FFFFFFFFLL;
  result = (unsigned __int8)ExGenRandom(1) << 16;
  qword_140C4C7A8 += 0xFFFFFFFDFF800000uLL - result;
  return result;
}
