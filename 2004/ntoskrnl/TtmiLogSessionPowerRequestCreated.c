/*
 * XREFs of TtmiLogSessionPowerRequestCreated @ 0x140900C38
 * Callers:
...
void TtmiLogSessionPowerRequestCreated()
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v6 = v2;
      v11 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)word_140029ECA, 0LL, 0LL, 5u, &v7);
    }
  }
}
