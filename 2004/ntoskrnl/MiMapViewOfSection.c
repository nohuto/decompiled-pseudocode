/*
 * XREFs of MiMapViewOfSection @ 0x1405FD010
 * Callers:
...
LABEL_25:
  ...
  {
    KiStackAttachProcess((_KPROCESS *)BugCheckParameter1, 0LL, (__int64)v65);
    v53 = 1;
    v37 = 0;
  }
  v40 = *(_DWORD *)(v13 + 56);
  ...
  else
  {
    if ( (v40 & 0x20) != 0 )
    {
      ...
      {
        v46 = (int)v57;
        v42 = MiMapViewOfImageSection(v13, a2, (unsigned int)&v51, (_DWORD)v57, a1, a6, ProtectionMask, v37);
        LODWORD(v56) = v42;
        v47 = *(_DWORD *)(a2 + 40);
        if ( (v47 & 0x20000000) == 0 )
          break;
        *(_DWORD *)(a2 + 40) = v47 & 0xDFFFFFFF;
        v49 = MiMapViewOfImageSection(v13, a2, (unsigned int)&Src, v46, a1, a6, ProtectionMask, 0);
        if ( v42 < 0 )
        {
          v51 = Src;
          v42 = v49;
