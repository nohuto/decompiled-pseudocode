/*
 * XREFs of PpmCheckComputeHeteroResponse @ 0x1405727D0
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x14021DBD0 (KeGetPrcb.c)
 *     KeEnumerateNextProcessor @ 0x14021E1A0 (KeEnumerateNextProcessor.c)
 *     PpmParkCalculateUnparkCount @ 0x140342170 (PpmParkCalculateUnparkCount.c)
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     qsort @ 0x1403CF4C0 (qsort.c)
 *     PpmHeteroUtilityGreaterThanOrEqualThreshold @ 0x140572F7C (PpmHeteroUtilityGreaterThanOrEqualThreshold.c)
 *     PpmHeteroUtilityToNormalizedUtility @ 0x140572FCC (PpmHeteroUtilityToNormalizedUtility.c)
...
char PpmCheckComputeHeteroResponse()
{
  ...
  v32 = 0LL;
  v31 = 0LL;
  v0 = &PpmCurrentProfile[342 * dword_140C238AC];
