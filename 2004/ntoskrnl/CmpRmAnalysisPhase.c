/*
 * XREFs of CmpRmAnalysisPhase @ 0x1408721A0
 * Callers:
...
__int64 __fastcall CmpRmAnalysisPhase(__int64 a1, CLFS_LSN a2)
{
  ...
  __int64 v13; // rcx
  char **v14; // rdx
  CLFS_LSN plsnUser; // [rsp+50h] [rbp-9h] BYREF
  ...
  _QWORD *v21; // [rsp+78h] [rbp+1Fh] BYREF
...
LABEL_18:
      ...
      while ( 1 )
      {
        NextElement = CmListGetNextElement(v2, &v21, 0);
