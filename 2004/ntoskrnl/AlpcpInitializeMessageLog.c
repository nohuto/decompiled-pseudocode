/*
 * XREFs of AlpcpInitializeMessageLog @ 0x1407BB7E4
 * Callers:
...
LABEL_11:
    ...
    if ( a1 )
    {
      ...
      while ( 1 )
      {
        ...
        *((_QWORD *)v13 + 7) = v13 + 48;
        *((_QWORD *)v13 + 6) = v13 + 48;
        v14 = (char **)qword_140C2A758;
        if ( *(__int64 **)qword_140C2A758 != &AlpcpFreeMessageLogListHead )
          break;
        *((_QWORD *)v13 + 1) = qword_140C2A758;
        ++v11;
        *(_QWORD *)v13 = &AlpcpFreeMessageLogListHead;
        *v14 = v13;
        v12 = v11;
        qword_140C2A758 = (__int64)v13;
        if ( v11 >= a1 )
          goto LABEL_17;
      }
LABEL_22:
