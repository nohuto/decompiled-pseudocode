/*
 * XREFs of PspInitializeSiloStructures @ 0x140A39060
 * Callers:
 ...
 *     PspSiloInitializeSharedUserSessionId @ 0x1407117A8 (PspSiloInitializeSharedUserSessionId.c)
...
char PspInitializeSiloStructures()
{
  ...
  qword_140D249A0 = (__int64)PoolWithTag;
  if ( !PoolWithTag )
    return 0;
  memset(PoolWithTag, 0, 0x270uLL);
  if ( (int)PspSiloInitializeSharedUserSessionId(qword_140D249A0) < 0
...
LABEL_13:
  ...
  qword_140C1DE48 = (__int64)&PspSiloMonitorList;
  ...
  if ( (int)ObCreateObjectType((const UNICODE_STRING *)L"$&", (__int64)v4, 0LL, (__int64)&PsSiloContextPagedType) >= 0 )
  {
    ...
    {
      if ( (int)PspAllocStorage(&qword_140D24988) >= 0 )
        return 1;
