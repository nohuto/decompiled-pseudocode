/*
 * XREFs of PiDqIrpQueryCreate @ 0x1405D243C
 * Callers:
 *     PiDqDispatch @ 0x1405D20D0 (PiDqDispatch.c)
 * Callees:
 *     IoClearActivityIdThread @ 0x140201B10 (IoClearActivityIdThread.c)
 ...
 *     PiDqQueryGetNextIoctlInfo @ 0x1405D1B80 (PiDqQueryGetNextIoctlInfo.c)
 ...
 *     PnpConvertDevpropcompkeyArrayToString @ 0x14089EBA0 (PnpConvertDevpropcompkeyArrayToString.c)
 *     PiDqConvertObjectTypeToString @ 0x1408A1540 (PiDqConvertObjectTypeToString.c)
 *     PiDqConvertQueryFlagsToString @ 0x1408A1608 (PiDqConvertQueryFlagsToString.c)
  ...
  else
  {
    if ( CurrentStackLocation->Parameters.Read.Length >= 0x10 )
    {
      ...
      if ( ValidateQueryData < 0 )
        goto LABEL_14;
      v10 = (void **)(v3 + 24);
      NdrMesTypeDecode3(*(_QWORD *)(v3 + 16), "TP 3\a", &off_1400011E0, &off_140C01A50, 0, v3 + 24);
