/*
 * XREFs of IopConnectInterrupt @ 0x14074EDFC
 * Callers:
        ...
        __int64 a11)
{
  ...
  struct _PROCESSOR_NUMBER ProcNumber; // [rsp+8Ch] [rbp-7Ch] BYREF
  ...
  *a1 = 0LL;
  ...
  v54 = v13;
  v51 = v14;
  v15 = v13.m128i_i64[0] & qword_140CFC848[(unsigned __int16)_mm_extract_epi16(v13, 4)];
  v16 = *(_BYTE *)(a11 + 16);
  v54.m128i_i64[0] = v15;
  v49 = v16;
  if ( !*(_DWORD *)(a11 + 8)
