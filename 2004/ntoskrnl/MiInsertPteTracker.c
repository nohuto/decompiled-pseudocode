/*
 * XREFs of MiInsertPteTracker @ 0x140559940
 * Callers:
...
__int64 __fastcall MiInsertPteTracker(__int64 a1, int a2, char a3, char a4)
{
  ...
  if ( LOWORD(stru_140C4E8C0.Alignment) < 0xAu )
  {
    v8 = RtlpInterlockedPopEntrySList(&stru_140C4E8C0);
    goto LABEL_6;
  }
  v9 = RtlpInterlockedFlushSList(&stru_140C4E8C0);
  v8 = v9;
  if ( v9 )
  {
    Next = v9->Next;
...
LABEL_15:
  ...
  *((_QWORD *)&v8[3].Next + 1) = *(_QWORD *)(a1 + 48);
  ...
  v22 = (char *)&unk_140C4F630 + 16 * (((unsigned __int8)v21 ^ BYTE4(v21)) & 0xF);
  v23 = *(_QWORD *)v22;
  ...
  *(_QWORD *)v22 = v8;
  qword_140C4F730 += v19;
  v24 = ++qword_140C4F738;
  if ( qword_140C4F738 > (unsigned __int64)qword_140C4F740 )
    qword_140C4F740 = v24;
