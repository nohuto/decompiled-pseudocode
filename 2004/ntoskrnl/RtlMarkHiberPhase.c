/*
 * XREFs of RtlMarkHiberPhase @ 0x14058D8A4
 * Callers:
...
void RtlMarkHiberPhase()
{
  ...
  if ( (KiBugCheckActive & 3) == 0 )
  {
    ...
    v1 = *(_DWORD *)(qword_140C22E80 + 184);
    if ( v1 == 8 )
    {
      v2 = (unsigned __int64)XpressHashFunction >> 12;
      for ( i = (unsigned __int64)"te on non-list, non-root tag" >> 12; v2 < i; v2 += v7 )
      {
        v49 = 0;
        v51 = 0LL;
