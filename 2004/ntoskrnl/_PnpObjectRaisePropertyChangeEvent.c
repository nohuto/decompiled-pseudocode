/*
 * XREFs of _PnpObjectRaisePropertyChangeEvent @ 0x140726584
 * Callers:
 *     _CmRemoveDeviceFromContainerWorker @ 0x14071A340 (_CmRemoveDeviceFromContainerWorker.c)
 *     _CmSetInstallerClassMappedProperty @ 0x14071ED7C (_CmSetInstallerClassMappedProperty.c)
 ...
 *     _CmSetDeviceInterfaceMappedProperty @ 0x1407564C4 (_CmSetDeviceInterfaceMappedProperty.c)
