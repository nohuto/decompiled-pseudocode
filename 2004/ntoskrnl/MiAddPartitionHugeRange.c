/*
 * XREFs of MiAddPartitionHugeRange @ 0x14052D2C8
 * Callers:
...
__int64 __fastcall MiAddPartitionHugeRange(__int64 a1, __int64 a2, int a3)
{
  ...
  v15 = v13 & 0x3FFFF;
  if ( v12 >= qword_140C4E460 )
    goto LABEL_13;
  if ( v15 > 1 )
  {
    if ( qword_140C4E460 - v12 < v15 )
      goto LABEL_13;
    v17 = (__int64 *)(qword_140C4E468 + 8 * (v12 >> 6));
    v18 = *v17;
    v19 = qword_140C4E468 + 8 * ((v12 + v15 - 1) >> 6);
    if ( v17 != (__int64 *)v19 )
    {
...
LABEL_13:
  ...
  else if ( v15 != 1 || _bittest64((const signed __int64 *)qword_140C4E468, v12) )
  {
    goto LABEL_13;
  }
  RtlSetBitsEx((__int64)&qword_140C4E460, v12, v15);
  memset64((void *)(qword_140C4E470 + 8 * v12), 0x80200000C0000uLL, v15);
  KeReleaseInStackQueuedSpinLock(&v23);
  KeReleaseInStackQueuedSpinLock(&LockHandle);
  if ( a3 == 3 )
    v14 = ((unsigned __int64)(*(_WORD *)a1 & 0x7FF) << 41) | 0xC0000;
  v22 = (unsigned __int64 *)(qword_140C4E470 + 8 * v12);
  if ( a3 == 3 )
    KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(a1 + 4128), &v23);
  do
  {
