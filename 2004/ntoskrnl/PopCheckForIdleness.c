/*
 * XREFs of PopCheckForIdleness @ 0x1402DE700
 * Callers:
 *     <none>
 * Callees:
...
__int64 PopCheckForIdleness()
{
  ...
  if ( byte_140C22DB5 )
  {
    ...
    if ( !PopPlatformAoAc )
    {
      if ( dword_140C22D8C )
      {
        dword_140C22D88 += PopIdleScanInterval;
        PopDiagTraceIdleCheck(v14, (unsigned int)v13, v11);
        if ( !PopPlatformAoAc
          && PopPreSleepNotificationSeconds + 120 <= (unsigned int)dword_140C22D8C
          && dword_140C22D88 + PopPreSleepNotificationSeconds >= (unsigned int)dword_140C22D8C
          && !PopIsAboutToSleep )
        {
          PopIsAboutToSleep = 1;
