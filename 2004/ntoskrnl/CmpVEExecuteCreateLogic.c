/*
 * XREFs of CmpVEExecuteCreateLogic @ 0x14064FCAC
 * Callers:
        ...
        UNICODE_STRING *a9)
{
  ...
  char v26; // [rsp+70h] [rbp+30h] BYREF
...
LABEL_26:
  ...
  v15 = CmpReplicateKeyToVirtual(a1, v13, v20, &v24);
  if ( v15 >= 0 )
  {
    v15 = CmpExamineSaclForAuditEvent(*(_QWORD *)(a1 + 88) + 32LL, v13, &v26);
    if ( v15 >= 0 )
    {
      if ( !v26 || (v15 = CmpReportAuditVirtualizationEvent(a1, v13), v15 >= 0) )
      {
        v21 = v24;
        *(_DWORD *)(v12 + 100) |= 2u;
        *(_QWORD *)(v12 + 112) = v21;
