/*
 * XREFs of HalpExtRegisterResourceDescriptor @ 0x1404BF460
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpExtGetRegisteredResourceIdString @ 0x1404BF40C (HalpExtGetRegisteredResourceIdString.c)
 *     HalpRegisterDmaChannel @ 0x1404CA4CC (HalpRegisterDmaChannel.c)
