/*
 * XREFs of RtlpSetSecurityObject @ 0x140669BF0
 * Callers:
 ...
 *     SeSetSecurityDescriptorInfoEx @ 0x1407019D0 (SeSetSecurityDescriptorInfoEx.c)
 * Callees:
...
LABEL_192:
      ...
      if ( !SepValidLabelSubjectContext(v124, v53, v96) )
        goto LABEL_192;
      ++Index;
    }
    while ( v52 );
