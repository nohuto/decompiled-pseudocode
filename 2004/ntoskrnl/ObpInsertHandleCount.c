/*
 * XREFs of ObpInsertHandleCount @ 0x1406DA72C
 * Callers:
 *     ObpLockHandleDataBaseEntry @ 0x1406DA5B0 (ObpLockHandleDataBaseEntry.c)
 * Callees:
 *     OBJECT_HEADER_TO_HANDLE_INFO @ 0x14032FF10 (OBJECT_HEADER_TO_HANDLE_INFO.c)
