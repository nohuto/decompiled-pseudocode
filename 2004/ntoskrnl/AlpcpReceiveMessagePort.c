/*
 * XREFs of AlpcpReceiveMessagePort @ 0x140683B20
 * Callers:
 ...
 *     AlpcpQueryHeadLargeQueue @ 0x140684330 (AlpcpQueryHeadLargeQueue.c)
...
LABEL_2:
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        v13 = KeAbPreAcquire(HeadLargeQueue - 16, 0LL, 1LL);
