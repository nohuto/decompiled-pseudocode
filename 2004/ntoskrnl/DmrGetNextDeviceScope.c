/*
 * XREFs of DmrGetNextDeviceScope @ 0x1404E34B4
 * Callers:
 *     IvtpGetNextInternalDeviceScope @ 0x1404E2AF4 (IvtpGetNextInternalDeviceScope.c)
 *     DmrGetNextDrhdDeviceScope @ 0x1404E330C (DmrGetNextDrhdDeviceScope.c)
