/*
 * XREFs of CmpTryAcquireKcbIXLocks @ 0x14075B7F0
 * Callers:
 *     CmpPerformUnloadKey @ 0x1406503FC (CmpPerformUnloadKey.c)
 *     CmpPrepareForSubtreeInvalidationWorker @ 0x14075B7A0 (CmpPrepareForSubtreeInvalidationWorker.c)
 ...
 * Callees:
 *     CmpTryAcquireIXLockWithRollbackPacket @ 0x14075B85C (CmpTryAcquireIXLockWithRollbackPacket.c)
 */
