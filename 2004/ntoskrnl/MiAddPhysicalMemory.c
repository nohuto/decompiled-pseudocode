/*
 * XREFs of MiAddPhysicalMemory @ 0x1408C1890
 * Callers:
...
__int64 __fastcall MiAddPhysicalMemory(ULONG_PTR *a1, _DWORD *a2, _DWORD *a3, int a4, __int64 a5)
{
  ...
  *((_QWORD *)&v6 + 1) = *(_QWORD *)a3 >> 12;
  ...
  if ( (unsigned __int64)v6 >= (_QWORD)v6 + *((_QWORD *)&v6 + 1) )
    return 3221225711LL;
  v8 = 0xFFFFFFFFFLL;
  if ( ((unsigned __int64)qword_140C4DD40 >> 12) - 1 < 0xFFFFFFFFFLL )
    v8 = ((unsigned __int64)qword_140C4DD40 >> 12) - 1;
  if ( v7 - 1 > v8 )
  {
    if ( (a4 & 2) == 0 )
    {
...
LABEL_9:
  ...
  if ( (unsigned __int64)v6 >= v7 )
    return 3221225711LL;
  if ( (_QWORD)v6 + *((_QWORD *)&v6 + 1) >= qword_140C4E7A0 && (unsigned __int64)v6 < qword_140C4E7A0 + 2048
...
LABEL_72:
  ...
  v21 = qword_140C52690 + *((_QWORD *)&v6 + 1);
  if ( qword_140C52690 + *((_QWORD *)&v6 + 1) > qword_140C4DCF0 )
    v7 = v6 + qword_140C4DCF0 - qword_140C52690;
  *((_QWORD *)&v6 + 1) = qword_140C4DCF0 - qword_140C52690;
  if ( v21 <= qword_140C4DCF0 )
    *((_QWORD *)&v6 + 1) = v9;
      ...
      *(_QWORD *)&v36 = 0LL;
      ...
      if ( (unsigned int)MiSplitPfnBitMaps(&MiSystemPartition, v6, *((__int64 *)&v6 + 1)) )
      {
        ...
        while ( (unsigned int)MiSplitMirrorBitMap(
                                (unsigned __int64 *)&qword_140C4E510[2 * v23],
                                v6,
                                *((__int64 *)&v6 + 1)) )
        {
          if ( ++v23 >= 2 )
