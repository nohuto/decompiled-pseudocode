/*
 * XREFs of MiDemotePfnListChain @ 0x140558D78
 * Callers:
 ...
 *     MiSetResidentPageMemberInPfn @ 0x1403EECE8 (MiSetResidentPageMemberInPfn.c)
    ...
    *(_QWORD *)(a1 + 8 * v8) = *v7;
    ...
    if ( (_DWORD)v8 == 1 )
    {
      MiUpdateLargePageBitMap(
        *(_QWORD *)(qword_140C4E448 + 8 * ((v7[5] >> 39) & 0x3FFLL)),
