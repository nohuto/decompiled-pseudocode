/*
 * XREFs of MiInitializeSystemChannelOrdering @ 0x140A8FAB8
 * Callers:
 *     MiInitializeChannelOrdering @ 0x140781588 (MiInitializeChannelOrdering.c)
 * Callees:
...
void __fastcall MiInitializeSystemChannelOrdering(__int64 a1, unsigned int a2)
{
  ...
  for ( i = (char *)qword_140C4DCD0; *(_QWORD *)i != -1LL; i += 16 )
  {
