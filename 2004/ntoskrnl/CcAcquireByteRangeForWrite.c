/*
 * XREFs of CcAcquireByteRangeForWrite @ 0x1402C1790
 * Callers:
 ...
 *     CcFindBcb @ 0x1402C4B24 (CcFindBcb.c)
        ...
        char a8)
{
  ...
  unsigned int v85; // [rsp+180h] [rbp+18h]
  ...
  Partition = CcGetPartition(v10, (__int64)a2, a3, a4);
  *a5 = 0LL;
  *a6 = 0;
  if ( a4 )
    (*(void (__fastcall **)(_QWORD, _QWORD))(*(_QWORD *)(a1 + 240) + 8LL))(**(_QWORD **)(a1 + 240), *(_QWORD *)a4);
  Mutex = (struct _FAST_MUTEX *)(a1 + 280);
  ExAcquireFastMutex((PFAST_MUTEX)(a1 + 280));
  v15 = a1;
  v16 = *(_QWORD *)(a1 + 160);
  v72 = v16;
  if ( v16 && *(_DWORD *)(v16 + 8) && (*(_DWORD *)(v16 + 4) || v85) )
  {
    if ( !a2 )
    {
      v35 = 0LL;
...
LABEL_17:
    ...
    while ( 1 )
    {
      if ( *(_WORD *)v19 != 765 )
        goto LABEL_15;
      if ( (*(_DWORD *)(v15 + 152) & 0x1000000) != 0 && a4 && *(_QWORD *)(v19 + 48) > *(_QWORD *)a4 )
      {
        v22 = *(_QWORD *)(v19 + 24);
...
LABEL_15:
      ...
      {
        v15 = a1;
        if ( (*(_DWORD *)(a1 + 152) & 0x1000000) == 0 || !a4 || *(_QWORD *)(v19 + 48) <= *(_QWORD *)a4 )
          goto LABEL_52;
        ++CcDbgLsnLargerThanHint;
      }
      KeReleaseGuardedMutex(Mutex);
