/*
 * XREFs of ViThunkRecoverPristines @ 0x1409D6184
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x1409D58A4 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x1409D6678 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x1409D6760 (ViThunkReplaceSpecialPristine.c)
 */
