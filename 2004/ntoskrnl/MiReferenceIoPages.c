/*
 * XREFs of MiReferenceIoPages @ 0x140336B14
 * Callers:
 ...
 *     MiIoSpaceIsConstant @ 0x140336F10 (MiIoSpaceIsConstant.c)
 *     MiDereferenceIoPages @ 0x140337818 (MiDereferenceIoPages.c)
 *     MiRemoveUnmappedIoNode @ 0x140337E00 (MiRemoveUnmappedIoNode.c)
...
__int64 __fastcall MiReferenceIoPages(unsigned int a1, __int64 a2, __int64 a3, int a4, _DWORD *a5, _QWORD *a6)
{
  ...
  v9 = a2 & 0xFFFFFFFFFLL;
  v54 = v9;
  v55 = (unsigned __int64 *)&xmmword_140C4EA48 + v8;
  v10 = &qword_140C4EA58;
  v11 = 0LL;
  v12 = v9;
  if ( (_DWORD)v8 != 1 )
  ...
  ExAcquireSpinLockExclusiveAtDpcLevel(&dword_140C4EA40);
  v18 = a3;
  if ( !a3 )
  {
LABEL_39:
