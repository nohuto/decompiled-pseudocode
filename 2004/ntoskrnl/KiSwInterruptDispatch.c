/*
 * XREFs of KiSwInterruptDispatch @ 0x1403D9620
 * Callers:
 *     KiSwInterrupt @ 0x1403FCD20 (KiSwInterrupt.c)
 * Callees:
 *     KeExitRetpoline @ 0x140329324 (KeExitRetpoline.c)
 *     KiGetTrapFrameMode @ 0x140392230 (KiGetTrapFrameMode.c)
 *     memmove @ 0x140409FC0 (memmove.c)
 *     KiReadKernelDr7 @ 0x14050D790 (KiReadKernelDr7.c)
...
char __fastcall KiSwInterruptDispatch(__int64 a1)
{
  ...
  PoolWithTag = ExAllocatePoolWithTag(
                  NonPagedPoolNx,
                  v1[338] + 2807LL,
                  dword_140C12EE0[((unsigned __int8)v4 ^ (unsigned __int8)v154) & 0xF]);
  v153 = PoolWithTag;
  v6 = PoolWithTag;
  if ( PoolWithTag )
  {
