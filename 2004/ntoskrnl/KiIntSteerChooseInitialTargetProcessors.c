/*
 * XREFs of KiIntSteerChooseInitialTargetProcessors @ 0x140375BF4
 * Callers:
 ...
 *     KeIntSteerGetSteeringMode @ 0x140375D00 (KeIntSteerGetSteeringMode.c)
