/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x14058E4D0
 * Callers:
...
LABEL_70:
    ...
    if ( v15 )
    {
      qword_140C117E8 = *(unsigned __int16 *)(a1 + 140) ^ (unsigned __int64)*(unsigned __int16 *)(v15 + 12);
      v24 = *(_DWORD *)(a1 + 124);
    }
    if ( v16 )
    {
    ...
    if ( qword_140C117E8 == (unsigned __int16)result )
    {
      result = *(unsigned __int16 *)(a1 + 140);
      if ( qword_140C117F0 != (result ^ *(unsigned __int16 *)(v16 + 8 * v26 + 12)) )
        dword_140C117A8 = 7;
    }
    else
    {
