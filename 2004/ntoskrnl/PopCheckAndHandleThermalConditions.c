/*
 * XREFs of PopCheckAndHandleThermalConditions @ 0x1403C2228
 * Callers:
 ...
 *     PopCriticalShutdown @ 0x1408E42E4 (PopCriticalShutdown.c)
 ...
 *     PopSqmThermalCriticalShutdown @ 0x1408F6990 (PopSqmThermalCriticalShutdown.c)
 *     PopSqmThermalHibernate @ 0x1408F69B4 (PopSqmThermalHibernate.c)
...
LABEL_4:
  ...
  if ( *(_BYTE *)(a1 + 72) != *(_BYTE *)(a1 + 211) )
  {
    ...
    *(_BYTE *)(a1 + 72) = v17;
    if ( v17 )
    {
      if ( ++dword_140C22C74 == 1 )
      {
        byte_140C22C7C = 1;
        ++dword_140C22C78;
        PopTraceCr3Tripped();
      }
      PopTraceZoneCr3Tripped((unsigned int)dword_140C22C78, a1);
    }
    else
    {
      PopTraceZoneCr3Mitigated((unsigned int)dword_140C22C78, a1);
      --dword_140C22C74;
    }
    if ( dword_140C22C74 )
    {
    ...
    else
    {
      ...
      PopTraceCr3Mitigated((unsigned int)dword_140C22C78);
      if ( HIBYTE(word_140C22C70) )
      {
...
LABEL_39:
    ...
    if ( !v5 && v21 && (_BYTE)word_140C22C70 && !HIBYTE(word_140C22C70) )
    {
      LOBYTE(v19) = 1;
