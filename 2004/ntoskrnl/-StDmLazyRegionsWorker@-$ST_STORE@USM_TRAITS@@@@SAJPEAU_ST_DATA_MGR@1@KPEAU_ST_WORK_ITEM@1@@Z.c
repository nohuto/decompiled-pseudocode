/*
 * XREFs of ?StDmLazyRegionsWorker@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@KPEAU_ST_WORK_ITEM@1@@Z @ 0x140596740
 * Callers:
...
LABEL_44:
    ...
    {
      v14 = v7 & 0x1F;
      if ( (*v13 | *((_DWORD *)qword_140011690 + v14)) == -1 )
      {
        v11 = v7 - v14 + 32;
    ...
    {
      v16 = v11 & 0x1F;
      if ( (*v13 & ~*((_DWORD *)qword_140011690 + v16)) == 0 )
      {
        v15 = 32 - v16;
        if ( (_DWORD)v16 == 33 )
          goto LABEL_25;
