/*
 * XREFs of HalpIrtInitializeDeviceApertures @ 0x1408628AC
 * Callers:
...
__int64 HalpIrtInitializeDeviceApertures()
{
  ...
  v1 = 0;
  qword_140C49708 = (__int64)&HalpIrtAllocatedDeviceAperturesHead;
  HalpIrtAllocatedDeviceAperturesHead = (__int64)&HalpIrtAllocatedDeviceAperturesHead;
  qword_140C49938 = (__int64)&HalpIrtFreeDeviceAperturesHead;
