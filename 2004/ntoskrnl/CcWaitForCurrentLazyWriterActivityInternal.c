/*
 * XREFs of CcWaitForCurrentLazyWriterActivityInternal @ 0x14037EF9C
 * Callers:
 *     CcWaitForCurrentLazyWriterActivityHelper @ 0x14037EF70 (CcWaitForCurrentLazyWriterActivityHelper.c)
