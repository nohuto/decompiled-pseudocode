/*
 * XREFs of PsGetThreadProperty @ 0x1403271E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsGetJobProperty @ 0x1403273E0 (PsGetJobProperty.c)
...
PVOID __stdcall PsGetThreadProperty(PETHREAD Thread, ULONG_PTR Key, ULONG Flags)
{
  ...
  {
    Key = (unsigned __int8)ObHeaderCookie ^ LOBYTE(Thread[-1].EndPadding[2]) ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)((_WORD)Thread - 48) >> 8);
