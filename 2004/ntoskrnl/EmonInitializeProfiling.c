/*
 * XREFs of EmonInitializeProfiling @ 0x14099CDA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     EmonFreeCounter @ 0x1403B7D18 (EmonFreeCounter.c)
...
__int64 EmonInitializeProfiling()
{
  ...
  if ( !Number )
  {
    ...
    qword_140C48E28 = (__int64)&EmonProfileSourceDescriptorListHead;
    EmonProfileSourceDescriptorListHead = (__int64)&EmonProfileSourceDescriptorListHead;
    qword_140C48E48 = (__int64)&EmonReservedResourcesList;
    ...
    if ( Memory )
    {
      ...
      do
      {
        ...
        if ( !EmonProfileSourceDescriptorTable[v24 + 29] )
        {
          ...
          v26 = (_QWORD *)qword_140C48E28;
          if ( *(__int64 **)qword_140C48E28 != &EmonProfileSourceDescriptorListHead )
            __fastfail(3u);
          ++EmonProfileSourceDescriptorCount;
          *v25 = &EmonProfileSourceDescriptorListHead;
          v25[1] = v26;
          *v26 = v25;
          qword_140C48E28 = (__int64)v25;
        }
  ...
  v9 = 0;
  v10 = (unsigned __int8 *)&unk_140C034F4;
  v11 = &unk_140C03440;
  v12 = 32LL;
  do
  {
    ...
    {
LABEL_7:
      result = KeAddProcessorAffinityEx((_WORD *)&unk_140C03440 + 112 * v9, Number);
      v11 = &unk_140C03440;
    }
    ++v9;
    v10 += 224;
