/*
 * XREFs of RtlpHpLfhSubsegmentCreate @ 0x1402CAD40
 * Callers:
 ...
 *     RtlpHpLfhBucketComputeNewSubsegmentBlockCount @ 0x1402CB008 (RtlpHpLfhBucketComputeNewSubsegmentBlockCount.c)
...
__int64 __fastcall RtlpHpLfhSubsegmentCreate(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (a3 & 1) != 0 )
    ...
    v21 = RtlpHpAcquireLockShared(a1 + 72, *(unsigned __int8 *)(a1 + 57));
