/*
 * XREFs of NormBuffer__SortBeforeSameClass @ 0x140588D04
 * Callers:
 *     NormBuffer__AppendAndSortDecomposed @ 0x140588718 (NormBuffer__AppendAndSortDecomposed.c)
 * Callees:
 *     NormBuffer__GetCurrentOutputChar @ 0x1405887D0 (NormBuffer__GetCurrentOutputChar.c)
 *     Normalization__PageLookup @ 0x140915AA8 (Normalization__PageLookup.c)
 *     Normalization__TableLookup @ 0x140915AC0 (Normalization__TableLookup.c)
 */
