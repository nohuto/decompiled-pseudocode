/*
 * XREFs of PopTraceThermalRequestActiveActivity @ 0x140388164
 * Callers:
 ...
 *     PopDiagSnapActiveActivity @ 0x140388434 (PopDiagSnapActiveActivity.c)
        ...
        if ( v11 )
        {
            ...
            && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              ...
              (unsigned __int8 *)word_140027042,
              0LL,
              0LL,
              8u,
              &v15);
