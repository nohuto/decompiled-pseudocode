/*
 * XREFs of ExpQuerySystemInformation @ 0x14068F290
 * Callers:
 ...
 *     MmGetTotalCommittedPages @ 0x14027D254 (MmGetTotalCommittedPages.c)
 *     MmGetTotalCommitLimit @ 0x14027D274 (MmGetTotalCommitLimit.c)
 *     MmGetPeakCommitment @ 0x14027D294 (MmGetPeakCommitment.c)
 *     MmGetSharedCommit @ 0x14027D364 (MmGetSharedCommit.c)
 *     MmGetResidentAvailablePages @ 0x14027D374 (MmGetResidentAvailablePages.c)
 ...
 *     MmGetLowestPhysicalPage @ 0x140360BEC (MmGetLowestPhysicalPage.c)
 ...
 *     KeIsCetCapable @ 0x1403ED690 (KeIsCetCapable.c)
 *     ZwFilterBootOption @ 0x1403F5220 (ZwFilterBootOption.c)
 *     _guard_dispatch_icall @ 0x1403FFC70 (_guard_dispatch_icall.c)
 *     memmove @ 0x140409FC0 (memmove.c)
 *     memset @ 0x14040A280 (memset.c)
 *     HvlQueryActiveProcessors @ 0x1404ECE00 (HvlQueryActiveProcessors.c)
 *     HvlQueryProcessorTopologyCount @ 0x1404ED000 (HvlQueryProcessorTopologyCount.c)
 ...
 *     IoQueryLowPriorityIoInformation @ 0x14070C208 (IoQueryLowPriorityIoInformation.c)
 ...
 *     HvlQueryEnlightenmentInfo @ 0x1407C023C (HvlQueryEnlightenmentInfo.c)
 ...
 *     ExpGetSystemProcessorFeaturesInformation @ 0x140947004 (ExpGetSystemProcessorFeaturesInformation.c)
 ...
 *     VfGetVerifierInformationEx @ 0x1409E9B5C (VfGetVerifierInformationEx.c)
        ...
        unsigned int *a6)
{
  ...
  char v130[4]; // [rsp+48h] [rbp-2F0h] BYREF
  ...
  unsigned int v147; // [rsp+98h] [rbp-2A0h] BYREF
  ...
  char *v156; // [rsp+E8h] [rbp-250h]
  __int64 v157; // [rsp+F0h] [rbp-248h] BYREF
  _DWORD *v158; // [rsp+F8h] [rbp-240h]
      ...
      switch ( v16 )
      {
        ...
        case 3u:
          if ( Length <= 0x30 )
          {
            ...
            v51 = *((_QWORD *)PsGetCurrentServerSiloGlobals() + 132);
        ...
        case 0x39u:
        case 0x94u:
          SystemBasicInformation = ExpGetProcessInformation((_DWORD *)a4, Length, &Size, 0LL, v16);
          goto LABEL_640;
        case 6u:
          return -1073741637;
        case 7u:
...
LABEL_91:
        ...
        case 0xBu:
          ...
          ModuleInformation = ExpQueryModuleInformation(v59, (_DWORD *)a4, Length, &Size);
          goto LABEL_167;
        case 0xCu:
          if ( Length < 0x38 )
          {
...
LABEL_121:
        ...
        case 0x24u:
          ...
          *(_DWORD *)(a4 + 8) = dword_140C319E8;
          *(_DWORD *)(a4 + 12) = dword_140C319E4;
          *(_DWORD *)(a4 + 16) = dword_140C319EC;
          *(_DWORD *)(a4 + 20) = dword_140C319F0;
          *(_DWORD *)(a4 + 24) = dword_140C319F8;
          *(_DWORD *)(a4 + 28) = dword_140C319F4;
          *(_DWORD *)(a4 + 32) = dword_140C319FC;
          *(_DWORD *)(a4 + 36) = dword_140C31A00;
          *(_DWORD *)(a4 + 40) = dword_140C31A04;
          *(_DWORD *)(a4 + 44) = dword_140C31A08;
          Size = 48;
          BootGraphicsInformation = Size_4;
          goto LABEL_641;
        case 0x25u:
        ...
        case 0x2Cu:
          ...
          v75 = *((_QWORD *)PsGetCurrentServerSiloGlobals() + 132);
          LOBYTE(v76) = 1;
...
LABEL_290:
        ...
        case 0x35u:
          if ( Length >= 0x10 )
          {
            ...
            SystemBasicInformation = ExpGetProcessInformation(v158, v142, &Size, &v135, 5);
            goto LABEL_640;
          }
          if ( a6 )
            *a6 = 16;
        ...
        case 0x58u:
          ...
          *(_OWORD *)ProcessId = *(_OWORD *)a4;
          ...
          if ( v9 && WORD1(ProcessId[1]) )
          {
            ...
            if ( (unsigned __int64)v54 > 0x7FFFFFFF0000LL || v54 < v156 )
          ...
          BootGraphicsInformation = PsQueryFullProcessImageName((__int64)Process, (_OWORD *)(a4 + 8), v156, &v147);
...
LABEL_279:
        ...
        case 0x66u:
          if ( Length >= 0x1B0 )
          {
            v77 = (_OWORD *)*((_QWORD *)PsGetCurrentServerSiloGlobals() + 132);
            LOBYTE(v78) = 1;
...
LABEL_307:
        ...
        case 0x99u:
          ...
          if ( Length >= 0x20 )
          {
            ...
            *(_QWORD *)(a4 + 16) = xmmword_140C24F70;
            *(_DWORD *)(a4 + 24) = DWORD2(xmmword_140C24F70);
LABEL_521:
            BootGraphicsInformation = Size_4;
            goto LABEL_641;
          }
        ...
        case 0x9Du:
          ...
          if ( Length >= Size )
          {
            ...
            *(_DWORD *)(a4 + 8) = DWORD2(ExpManufacturingInformation);
            ...
            {
              *(_QWORD *)(a4 + 16) = v107;
              memmove(v107, qword_140C195B0, WORD5(ExpManufacturingInformation));
            }
            BootGraphicsInformation = Size_4;
          }
          else
