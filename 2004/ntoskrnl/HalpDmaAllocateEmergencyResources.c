/*
 * XREFs of HalpDmaAllocateEmergencyResources @ 0x140A5D5A8
 * Callers:
 ...
 *     MmAllocateMappingAddress @ 0x1406FCC20 (MmAllocateMappingAddress.c)
...
__int64 __fastcall HalpDmaAllocateEmergencyResources(__int64 a1)
{
  ...
  if ( !MemoryDescriptorList )
    return 3221225626LL;
  qword_140C53CF8 = (PMDL)HalpMmAllocCtxAlloc(v1, 56LL);
  v2 = qword_140C53CF8;
  if ( !qword_140C53CF8 )
  {
...
LABEL_10:
  ...
  *(_QWORD *)&v2->ByteCount = 4096LL;
  ...
  qword_140C53D10 = MmAllocateMappingAddress(0x1000uLL, 0x206C6148u);
  if ( qword_140C53D10 )
  {
    qword_140CF23D8 = 0LL;
    return 0LL;
  ...
  HalpMmAllocCtxFree(v7, (__int64)qword_140C53CF8);
