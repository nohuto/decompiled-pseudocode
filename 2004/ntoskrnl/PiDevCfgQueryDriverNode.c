/*
 * XREFs of PiDevCfgQueryDriverNode @ 0x14072D37C
 * Callers:
...
LABEL_52:
  ...
  else
  {
    ...
    v38[3] = v12 + 88;
    LODWORD(v38[1]) = 288;
    DriverPackageId = RtlpQueryRegistryValues(3221225472LL, (const WCHAR *)v29, (__int64)v38, 0LL);
    if ( DriverPackageId < 0 )
      goto LABEL_41;
...
LABEL_39:
  ...
  if ( v19 >= 0 )
  {
    ...
    v38[17] = v12 + 160;
    LODWORD(v38[15]) = 304;
    DriverPackageId = RtlpQueryRegistryValues(3221225472LL, (const WCHAR *)v28, (__int64)v38, 0LL);
    if ( DriverPackageId >= 0 )
    {
