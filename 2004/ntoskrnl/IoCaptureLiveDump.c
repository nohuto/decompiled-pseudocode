/*
 * XREFs of IoCaptureLiveDump @ 0x140893018
 * Callers:
 ...
 *     KeGetSupervisorStateExtensionHost @ 0x1405149E0 (KeGetSupervisorStateExtensionHost.c)
  ...
  *(_QWORD *)v12[51].Data4 = v10;
  ...
  if ( (unsigned int)dword_140C04498 > 5 && tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&word_1400236BE,
      v12 + 54,
      v12 + 53,
      3u,
      &v68);
...
LABEL_37:
      ...
      if ( inited >= 0 )
      {
        ...
        else
        {
          ...
          if ( (unsigned int)dword_140C04498 > 5 && tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer(
              (__int64)&dword_140C04498,
              (unsigned __int8 *)byte_140023805,
              v12 + 54,
              v12 + 53,
              4u,
              &v63);
  ...
  if ( (unsigned int)dword_140C04498 > 5 && tlgKeywordOn((__int64)&dword_140C04498, 0x200000000000LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C04498, (unsigned __int8 *)&word_14002378E, v36, v35, 6u, &v54);
  }
  if ( v12 )
  {
    if ( (*(_DWORD *)v12[2].Data4 & 8) == 0 )
