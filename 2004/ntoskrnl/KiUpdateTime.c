/*
 * XREFs of KiUpdateTime @ 0x14021C4D0
 * Callers:
  ...
  if ( v19 <= 0 )
  {
    *((_QWORD *)&v13 + 1) = 1LL;
    ...
    if ( v19 <= 0 )
    {
      ...
      LODWORD(v19) = (v45 + 1) * KeMaximumIncrement + v19;
      *((_QWORD *)&v13 + 1) = v45 + 2;
    }
...
LABEL_95:
  ...
  while ( _interlockedbittestandset64((volatile signed __int32 *)&KiForceIdleLock, 0LL) )
  {
    ...
    do
      KeYieldProcessorEx(&v72, *((_QWORD *)&v13 + 1));
  ...
  if ( (unsigned int)KeNumberProcessors_0 > 1 )
  {
    ...
    for ( ; v28 < (unsigned __int16)*v26; *(_QWORD *)&KiClockCheckPending[4 * v30 + 4] = *(_QWORD *)&v26[4 * v30 + 4] )
      v30 = v28++;
    for ( dword_140C11014 = v27; v28 < (unsigned __int16)word_140C11012; *(_QWORD *)&KiClockCheckPending[4 * v68 + 4] = v27 )
      v68 = v28++;
  }
