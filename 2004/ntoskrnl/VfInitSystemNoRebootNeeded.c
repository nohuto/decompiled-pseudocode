/*
 * XREFs of VfInitSystemNoRebootNeeded @ 0x1409C3D30
 * Callers:
 ...
 *     IoVerifierInit @ 0x1409C176C (IoVerifierInit.c)
...
void __fastcall VfInitSystemNoRebootNeeded(__int64 a1, int a2)
{
  ...
  if ( !ViFullyInitialized )
  {
    ...
    qword_140C1D158 = (__int64)&ViVerifierDriverAddedThunkListHead;
    ViVerifierDriverAddedThunkListHead = (__int64)&ViVerifierDriverAddedThunkListHead;
    qword_140C1CE88 = (__int64)&ViVerifierDriverAddedSpecialThunkListHead;
