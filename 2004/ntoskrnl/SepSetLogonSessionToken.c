/*
 * XREFs of SepSetLogonSessionToken @ 0x14071097C
 * Callers:
...
void __fastcall SepSetLogonSessionToken(__int64 a1)
{
  ...
  if ( !*(_QWORD *)(v1 + 48) )
  {
    ...
    if ( (v3 & 0x10) == 0 && (v3 & 8) == 0 )
    {
      ...
      v6[0] = 48;
      v11 = 0LL;
      if ( (int)SepDuplicateToken(a1, (int)v6, 0, 1, 0, 0, 0, &DmaAdapter) >= 0 )
      {
        v4 = SepStopReferencingLogonSession((__int64)DmaAdapter);
        v5 = DmaAdapter;
        if ( v4 < 0 )
        {
LABEL_9:
