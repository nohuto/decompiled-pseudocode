/*
 * XREFs of KiSetProcessorSignature @ 0x14099AC68
 * Callers:
 ...
 *     KiPublishProcessorFeatures @ 0x140A3CC00 (KiPublishProcessorFeatures.c)
 */
  ...
  for ( i = 0LL; ; i = (unsigned int)(v54 + 1) )
  {
    ...
    if ( (v20 & 2) == 0 )
    {
      if ( !HIBYTE(v20) || (v21 = HIBYTE(v20), _bittest((const int *)&v21, *(unsigned __int8 *)(a1 + 141))) )
      {
        ...
        v23 = 0;
        BugCheckParameter4 = dword_140010158[2 * v19];
        v25 = (unsigned int)dword_140010154[2 * v19];
        if ( ((unsigned int)v25 & *((_DWORD *)&v56 + BugCheckParameter4)) == 0
          && ((v20 & 8) == 0 || (v15 & qword_140010160[v19]) != qword_140010160[v19]) )
        {
          v27 = v20 & 0x10;
          if ( (v20 & 0x10) != 0 )
          {
            if ( (v16 & qword_140010160[v19]) == qword_140010160[v19] )
              v23 = 1;
            v27 = v20 & 0x10;
          }
          if ( !v23 )
          {
            if ( (v20 & 1) != 0 )
            {
              if ( !*(_DWORD *)(a1 + 36) )
              {
                ...
                LODWORD(BugCheckParameter4) = dword_140010158[2 * v19];
                LODWORD(v25) = dword_140010154[2 * v19];
              }
              KeBugCheckEx(
                0x5Du,
                0xFFFFFFFFuLL,
            ...
            if ( (v20 & 4) != 0 && *(_DWORD *)(a1 + 36) )
            {
              ...
              if ( (v20 & 8) != 0 )
              {
                LOBYTE(v28) = (KeFeatureBits & qword_140010160[v19]) == qword_140010160[v19];
              }
              else if ( v27 && (KeFeatureBits2 & qword_140010160[v19]) == qword_140010160[v19] )
              {
LABEL_70:
        ...
        if ( (v20 & 8) != 0 )
        {
          v15 |= qword_140010160[v19];
        }
        else if ( (v20 & 0x10) != 0 )
        {
          v16 |= qword_140010160[v19];
        }
        if ( (v20 & 4) != 0 && *(_DWORD *)(a1 + 36) )
        {
          v26 = 0;
          if ( (v20 & 8) != 0 )
          {
            LOBYTE(v26) = (KeFeatureBits & qword_140010160[v19]) == qword_140010160[v19];
            goto LABEL_13;
          }
          if ( (v20 & 0x10) == 0 || (KeFeatureBits2 & qword_140010160[v19]) != qword_140010160[v19] )
          {
LABEL_13:
            if ( !v26 )
...
LABEL_14:
  ...
  {
    v36 = (unsigned int *)(0x140000000LL + 24 * j + 24976);
    v37 = *(_DWORD *)(0x140000004LL + 24 * j + 24976);
    if ( (v37 & 2) == 0 )
    {
      if ( !HIBYTE(v37) || (v38 = HIBYTE(v37), _bittest((const int *)&v38, *(unsigned __int8 *)(a1 + 141))) )
      {
        ...
        if ( (v39 & *(_QWORD *)(0x140000010LL + 24 * j + 24976)) == *(_QWORD *)(0x140000010LL + 24 * j + 24976) )
        {
          v43 = __readmsr(*v36);
          for ( k = *(_QWORD *)(0x140000008LL + 24 * j + 24976); ; k += 24LL )
          {
            v14 = *(_QWORD *)k;
            if ( !*(_QWORD *)k )
              break;
...
LABEL_92:
  ...
  v34 = 0LL;
  v35 = a2;
  while ( dword_14001E7E8[5 * v34] != 19 )
  {
    if ( KiCpuTable[5 * v34] == *(unsigned __int8 *)(a1 + 141) && dword_14001E7E4[5 * v34] == a2 )
    {
      *(_DWORD *)(a1 + 1740) = dword_14001E7F0[5 * v34];
      break;
    }
