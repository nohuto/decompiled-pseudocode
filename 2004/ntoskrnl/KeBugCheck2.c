/*
 * XREFs of KeBugCheck2 @ 0x140511660
 * Callers:
 ...
 *     KiFilterBugCheckInfo @ 0x1403D883C (KiFilterBugCheckInfo.c)
...
LABEL_14:
  ...
  *(_QWORD *)&xmmword_140C2B290 = a3;
  if ( v69 == -1073741103 )
    v29 = 195;
  *((_QWORD *)&xmmword_140C2B290 + 1) = a4;
  ...
  switch ( v29 )
  {
    ...
    case 0x4Cu:
      ...
      *(_QWORD *)&KiBugCheckData = (unsigned int)a2;
      ...
      while ( (__int64)v38 < (__int64)qword_140C2B2A8 );
      v35 = CurrentThread;
      goto LABEL_115;
  }
  if ( v29 != 80 )
...
LABEL_66:
    v72 = *(_QWORD *)(v8 + 360);
    *((_QWORD *)&xmmword_140C2B290 + 1) = v72;
  ...
  if ( !CurrentPrcb->NmiActive )
  {
    DbgPrintEx(
      ...
      *((const void **)&KiBugCheckData + 1),
      (const void *)xmmword_140C2B290,
      *((const void **)&xmmword_140C2B290 + 1),
      (const void *)qword_140C2B2A0);
    if ( KiBugCheckDriver )
    ...
    if ( v48 )
    {
      if ( v69 == 265 )
      {
        KiMarkBugCheckRegions(
          *((__int64 *)&KiBugCheckData + 1),
          xmmword_140C2B290,
          *((unsigned __int64 *)&xmmword_140C2B290 + 1),
          qword_140C2B2A0);
        if ( qword_140C2B2A0 == 47 )
        {
          v58 = *((_QWORD *)&xmmword_140C2B290 + 1);
          if ( MmIsAddressValid((PVOID)(*((_QWORD *)&xmmword_140C2B290 + 1) + 1928LL)) )
...
LABEL_185:
      ...
      if ( v69 == 239 )
      {
        ...
        if ( CriticalProcessExceptionData )
        {
          ...
          if ( (_WORD)xmmword_140C19670 )
            IoAddTriageDumpDataBlock(DWORD2(xmmword_140C19670), (PVOID)(unsigned __int16)xmmword_140C19670);
        }
      }
      goto LABEL_185;
    }
