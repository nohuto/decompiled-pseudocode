/*
 * XREFs of MiBuildReservationCluster @ 0x1403844EC
 * Callers:
  ...
  if ( (unsigned int)v19 < DWORD2(v99) )
  {
    ...
    *(_QWORD *)(v98 + 24) ^= ((*(_QWORD *)(v98 + 24) + 1LL) ^ *(_QWORD *)(v98 + 24)) & 0x3FFFFFFFFFFFFFFFLL;
    ...
    if ( (unsigned int)MI_PFN_IS_PROTO(v12)
      ...
      || (v44 = (_QWORD *)MiReservePtes((__int64)&qword_140C4ED40, 1u, v40, (unsigned __int64)v41),
          v102 = v44,
          (v45 = (unsigned __int64)v44) == 0) )
    {
      v71 = Src;
LABEL_99:
      v74 = v98;
      v75 = (unsigned __int8)MiLockPageInline(v98, v42, v40, v41);
    ...
    ValidPte = MiMakeValidPte((unsigned __int64)v44, v96, 536870913LL, (__int64)v41);
    v47 = 0;
...
LABEL_51:
    ...
    *(_QWORD *)v45 = ValidPte;
    ...
    if ( (unsigned int)v54 >= v97 - 1 )
      LODWORD(v54) = v97 - 1;
    if ( qword_140C4DD40 && (v53 & 0x10) == 0 )
      v56 = v53 & ~qword_140C4DD40;
    v57 = HIDWORD(v56);
    ...
    if ( qword_140C4DD40 && (v73 & 0x10) == 0 )
      v73 &= ~qword_140C4DD40;
    v19 = HIDWORD(v73);
    MiReleasePtes((__int64)&qword_140C4ED40, v102, 1u);
    goto LABEL_99;
  }
  _InterlockedAnd64((volatile signed __int64 *)(v12 + 24), 0x7FFFFFFFFFFFFFFFuLL);
  if ( KiIrqlFlags )
