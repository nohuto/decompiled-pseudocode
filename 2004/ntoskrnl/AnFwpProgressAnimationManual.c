/*
 * XREFs of AnFwpProgressAnimationManual @ 0x1409F4288
 * Callers:
...
LONGLONG AnFwpProgressAnimationManual()
{
  ...
  result = qword_140CDAF68;
  if ( v0.QuadPart + v2 >= qword_140CDAF68 + v7.QuadPart / 33 )
  {
    v4 = word_140C10DD8;
    if ( word_140C10DD8 != -7989 && (qword_140CDAF68 - v0.QuadPart - v2) / v1 >= 2 )
      v4 = ++word_140C10DD8;
    if ( (unsigned __int16)(v4 + 8110) <= 0x79u )
    {
      LogFwStat(1, 1, 0LL);
      BgpTxtDisplayCharacter(qword_140C133D0, word_140C10DD8, 0, 0LL, 0LL);
      LogFwStat(0, 1, 0LL);
      v4 = word_140C10DD8;
    }
    v5 = -8118;
