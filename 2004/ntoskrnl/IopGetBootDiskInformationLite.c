/*
 * XREFs of IopGetBootDiskInformationLite @ 0x140A40750
 * Callers:
 *     IoGetBootDiskInformationLite @ 0x140785DB0 (IoGetBootDiskInformationLite.c)
 * Callees:
 ...
 *     IopAddBootDiskInformation @ 0x1403B07C4 (IopAddBootDiskInformation.c)
