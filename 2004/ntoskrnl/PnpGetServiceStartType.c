/*
 * XREFs of PnpGetServiceStartType @ 0x140728B30
 * Callers:
  ...
  *a3 = 4;
  if ( (ExpManufacturingInformation & 1) != 0 )
  {
    ...
    if ( v10 >= 0 )
    {
      ...
      v12 = (__int64)qword_140CF51D8;
      if ( qword_140CF51D8 )
      {
        if ( qword_140CF51D8 == (HANDLE)-1LL )
          goto LABEL_2;
        v13 = 0;
      }
      else
      {
        ...
        v13 = SysCtxRegOpenKey(v12, qword_140CF51D0, (__int64)L"*Driver", 0, 0x20019u, (__int64)&qword_140CF51D8);
        if ( v13 == -1073741772 )
        {
          v12 = -1LL;
          qword_140CF51D8 = (HANDLE)-1LL;
        }
        else
        {
          v12 = (__int64)qword_140CF51D8;
