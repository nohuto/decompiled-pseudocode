/*
 * XREFs of WdipSemUpdateProviderTableWithEvent @ 0x14079BB64
 * Callers:
 *     WdipSemUpdateProviderTableWithScenario @ 0x14079BAF0 (WdipSemUpdateProviderTableWithScenario.c)
 * Callees:
 *     EtwEventEnabled @ 0x140212640 (EtwEventEnabled.c)
 *     memset @ 0x14040A280 (memset.c)
 *     WdipSemFastAllocate @ 0x1407765E0 (WdipSemFastAllocate.c)
 *     WdipSemQueryProviderTable @ 0x14079BC08 (WdipSemQueryProviderTable.c)
...
__int64 __fastcall WdipSemUpdateProviderTableWithEvent(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    else if ( (unsigned int)dword_140C1C380 >= 0x400 )
    {
    ...
    else
    {
      ...
      if ( v5 )
      {
        memset(v5, 0, 0x50uLL);
        *v6 = *(_OWORD *)a1;
        WdipSemProviderTable[dword_140C1C380++] = v6;
        *(_QWORD *)(a1 + 40) = v6;
      }
      else
      {
