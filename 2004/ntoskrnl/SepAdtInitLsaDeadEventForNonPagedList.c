/*
 * XREFs of SepAdtInitLsaDeadEventForNonPagedList @ 0x1405903F0
 * Callers:
...
bool __fastcall SepAdtInitLsaDeadEventForNonPagedList(__int64 a1)
{
  ...
  KeAcquireInStackQueuedSpinLock(&qword_140C544D8, &LockHandle);
  qword_140C54518 = a1;
  v2 = qword_140C54460 != (_QWORD)&qword_140C54460;
