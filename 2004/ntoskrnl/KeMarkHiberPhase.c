/*
 * XREFs of KeMarkHiberPhase @ 0x1409AC118
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( qword_140C2B138 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C2B138, 16 * (unsigned int)(unsigned __int8)qword_140C2B128, 0x7272744Du);
  if ( qword_140C2B140 )
    PoSetHiberRange(0LL, 0x10000u, qword_140C2B140, 0x58uLL, 0x7272744Du);
  v13 = *(_QWORD **)(v1 + 8);
