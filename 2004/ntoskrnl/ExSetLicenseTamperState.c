/*
 * XREFs of ExSetLicenseTamperState @ 0x140949D40
 * Callers:
 *     <none>
 * Callees:
...
__int64 (__fastcall *__fastcall ExSetLicenseTamperState(int a1))(_QWORD)
{
  ...
  if ( a1 && a1 != 3 )
  {
    ...
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)(v3 + 37464), 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)(v3 + 37464));
    ...
    if ( v5 )
    {
      ...
      result = qword_140D2D510;
      if ( qword_140D2D510 )
        return (__int64 (__fastcall *)(_QWORD))qword_140D2D510(v6);
    }
  }
  return result;
}
