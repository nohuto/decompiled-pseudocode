/*
 * XREFs of PpmSnapPerformanceAccumulation @ 0x140216050
 * Callers:
...
LABEL_8:
  ...
  if ( v16 )
  {
    ...
    {
      v62 = *(_QWORD *)(a1 + 33616);
      v9 = *(_QWORD *)(v62 + 8LL * DWORD2(xmmword_140CED1A0)) >> 1;
      if ( (*(_QWORD *)(v62 + 8LL * DWORD2(xmmword_140CED1A0)) & 1) == 0 )
        v9 = 0LL;
    }
  }
  if ( !v9 )
    ...
    *((_DWORD *)a5 + 22) = *(_DWORD *)(a1 + 12508);
    if ( a3 )
    {
      ...
      if ( v34 )
      {
        if ( *(_DWORD *)(a1 + 32984) == 3 )
        {
          v34 = *(_QWORD *)(*(_QWORD *)(a1 + 33616) + 8LL * DWORD2(xmmword_140CED1A0)) >> 1;
          if ( (*(_QWORD *)(*(_QWORD *)(a1 + 33616) + 8LL * DWORD2(xmmword_140CED1A0)) & 1) == 0 )
            v34 = 0LL;
        }
      }
      if ( v9 != v34 )
