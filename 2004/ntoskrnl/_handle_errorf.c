/*
 * XREFs of _handle_errorf @ 0x1403D2A7C
 * Callers:
 *     sqrtf @ 0x1403CFEA0 (sqrtf.c)
 * Callees:
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     _call_matherr @ 0x1403D280C (_call_matherr.c)
 *     _exception_enabled @ 0x1403D287C (_exception_enabled.c)
 *     _raise_excf @ 0x1403D3160 (_raise_excf.c)
 *     _set_errno_from_matherr @ 0x1403D3194 (_set_errno_from_matherr.c)
