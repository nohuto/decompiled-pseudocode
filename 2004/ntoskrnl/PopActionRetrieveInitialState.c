/*
 * XREFs of PopActionRetrieveInitialState @ 0x14038A998
 * Callers:
...
__int64 __fastcall PopActionRetrieveInitialState(_DWORD *a1, _DWORD *a2, _DWORD *a3, _BYTE *a4)
{
  ...
  else if ( (_DWORD)qword_140C22E44 == 7 )
  {
    *a2 = 5;
  ...
  if ( *v4 > *a2 )
    *a2 = *v4;
  *a4 = 1;
  if ( *v4 == 6 || dword_140C22E4C < 0 && (unsigned int)(dword_140C22E54 - 1) <= 1 )
    *a4 = 0;
  ...
  if ( (dword_140C22E4C & 0x10000000) == 0 )
    v4 = a2;
