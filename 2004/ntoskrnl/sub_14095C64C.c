/*
 * XREFs of sub_14095C64C @ 0x14095C64C
 * Callers:
...
__int64 __fastcall sub_14095C64C(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // rax
  __int64 v5; // r14
  signed int v8; // ebx
...
LABEL_15:
  if ( v8 >= 0 )
  {
    v15 = qword_140D2D3C0 ? qword_140D2D3C0() : -1073741637;
    v8 = v15;
    if ( v15 >= 0 )
    {
      v16 = *(_DWORD *)(a2 + 32);
