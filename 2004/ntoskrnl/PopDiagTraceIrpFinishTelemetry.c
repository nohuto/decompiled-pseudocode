/*
 * XREFs of PopDiagTraceIrpFinishTelemetry @ 0x140378DFC
 * Callers:
 ...
 *     IoFindDeviceThatFailedIrp @ 0x14036B9E8 (IoFindDeviceThatFailedIrp.c)
 *     PopDiagGetDriverName @ 0x14038667C (PopDiagGetDriverName.c)
 *     PopComputeWatchdogTimeout @ 0x140395C7C (PopComputeWatchdogTimeout.c)
  ...
  if ( v6 )
  {
    if ( *(_BYTE *)(v2 + 196) )
    {
      ...
      if ( (unsigned int)(*((_QWORD *)&v4 + 1) >> 11) >= 0x1388 )
      {
        ...
        {
          LOBYTE(v4) = tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL);
          if ( (_BYTE)v4 )
          {
            v26 = 0;
            v29 = 0;
            ...
            LOBYTE(v4) = tlgWriteTransfer_EtwWriteTransfer(
                           ...
                           (unsigned __int8 *)byte_140027D11,
                           0LL,
                           0LL,
                           0xBu,
                           &v23);
