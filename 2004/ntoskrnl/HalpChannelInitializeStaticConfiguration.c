/*
 * XREFs of HalpChannelInitializeStaticConfiguration @ 0x140A5B8C0
 * Callers:
 ...
 *     HalpValidateMpns @ 0x140863690 (HalpValidateMpns.c)
 *     HalpSelectFeasibleLowPowerState @ 0x140A8AF08 (HalpSelectFeasibleLowPowerState.c)
 */
