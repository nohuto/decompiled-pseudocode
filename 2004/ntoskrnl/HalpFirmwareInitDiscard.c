/*
 * XREFs of HalpFirmwareInitDiscard @ 0x140A6B2D4
 * Callers:
 *     HalpFirmwareInitSystem @ 0x14099DD60 (HalpFirmwareInitSystem.c)
 * Callees:
...
__int64 __fastcall HalpFirmwareInitDiscard(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 264) & 1) != 0 )
  {
    ...
    xmmword_140C49D90 = *(_OWORD *)(a1 + 280);
    xmmword_140C49DA0 = *(_OWORD *)(a1 + 296);
    xmmword_140C49DB0 = *(_OWORD *)(a1 + 312);
    HalpEfiTimeCalls = 0;
    HalpEfiTimeWrites = 0;
