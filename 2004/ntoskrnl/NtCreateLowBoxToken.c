...
LABEL_73:
  ...
  if ( AppContainerSidType < 0 )
    goto LABEL_73;
  AppContainerSidType = SepDuplicateToken((__int64)Token, v9, 0, 1, 0, PreviousMode, 0, &v38[3]);
  if ( AppContainerSidType < 0 )
    goto LABEL_73;
  v27 = 1;
  ...
  if ( AppContainerSidType < 0 )
    goto LABEL_53;
  AppContainerSidType = SepSetTokenLowboxNumber(*(__int64 *)&v38[3], (__int64)v20);
  if ( AppContainerSidType < 0 )
    goto LABEL_53;
  *((_QWORD *)&v47 + 1) = v20;
  AppContainerSidType = SepSetTokenCachedHandles(*(_QWORD **)&v38[3], &v47, a8, (HANDLE *)P);
  if ( AppContainerSidType < 0 )
    goto LABEL_53;
  AppContainerSidType = SepSetTokenPackage(*(__int64 *)&v38[3], (unsigned __int8 *)v20);
  if ( AppContainerSidType < 0 )
    goto LABEL_53;
