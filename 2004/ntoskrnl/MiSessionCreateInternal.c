/*
 * XREFs of MiSessionCreateInternal @ 0x140774830
 * Callers:
...
__int64 __fastcall MiSessionCreateInternal(ULONG_PTR *a1)
{
  ...
  ClearBitsAndSet = RtlFindClearBitsAndSet(qword_140C4ED10, 1u, 0);
  if ( ClearBitsAndSet == -1 )
  {
    v5 = qword_140C4ED10->SizeOfBitMap + 128;
    if ( v5 > 0x7FFFF )
      v5 = 0x7FFFF;
    ...
    memmove(
      ...
      8 * (((unsigned __int64)qword_140C4ED10->SizeOfBitMap >> 6) + ((qword_140C4ED10->SizeOfBitMap & 0x3F) != 0)));
    ExFreePoolWithTag(qword_140C4ED10, 0);
    qword_140C4ED10 = v7;
  ...
  {
    v10 = MiReservePtes((__int64)&qword_140C4ED40, 1u, v8, v9);
    v11 = (_QWORD *)v10;
    if ( v10 )
    {
        ...
        *(_QWORD *)(v12 + 1048) = CurrentServerSilo;
        if ( CurrentServerSilo )
        {
          ...
          _InterlockedCompareExchange(
            *((volatile signed __int32 **)PsGetServerSiloGlobals(*(_QWORD *)(v12 + 1048)) + 140),
            ClearBitsAndSet,
            -1);
        }
        MiMarkSessionMasterProcess(v23, v12);
        *(_DWORD *)(v12 + 904) = 4;
        *(_QWORD *)(v12 + 896) = MiGetPteAddress(qword_140C4CBA0);
    ...
    if ( v11 )
      MiReleasePtes((__int64)&qword_140C4ED40, v11, 1u);
  }
  --CurrentThread->SpecialApcDisable;
  ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_140C4DBB8, 0LL);
  _bittestandreset((signed __int32 *)qword_140C4ED10->Buffer, ClearBitsAndSet);
LABEL_21:
  if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C4DBB8, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
    ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C4DBB8);
  KeAbPostRelease((ULONG_PTR)&qword_140C4DBB8);
