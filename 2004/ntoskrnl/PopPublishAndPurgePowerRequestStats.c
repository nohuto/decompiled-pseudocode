/*
 * XREFs of PopPublishAndPurgePowerRequestStats @ 0x1408F302C
 * Callers:
 ...
 *     PoQueryStopWatch @ 0x1402781E0 (PoQueryStopWatch.c)
 ...
 *     PoResetStopWatch @ 0x14057A704 (PoResetStopWatch.c)
    ...
    if ( StopWatchByRequestType )
    {
      ...
      if ( (unsigned int)dword_140C021E8 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)&word_140028CB6,
          0LL,
          0LL,
          7u,
          &v37);
