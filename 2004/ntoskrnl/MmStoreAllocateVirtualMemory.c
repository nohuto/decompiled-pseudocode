/*
 * XREFs of MmStoreAllocateVirtualMemory @ 0x140704130
 * Callers:
...
unsigned __int64 __fastcall MmStoreAllocateVirtualMemory(__int64 a1)
{
  ...
  __int64 v10[16]; // [rsp+40h] [rbp-79h] BYREF
  ...
  *(_OWORD *)v11 = 0LL;
  ...
  v10[12] = (__int64)KeGetCurrentThread()->ApcState.Process;
  v10[11] = v10[12];
  v10[2] = 0x10000LL;
  v10[1] = 0x7FFFFFFEFFFFLL;
  v10[10] = (__int64)&SecureHandle;
  v10[3] = a1;
  v10[5] = 0x200003000LL;
  HIDWORD(v10[7]) = 1;
  HIDWORD(v10[9]) = -2147483647;
  LOBYTE(v10[13]) = 0;
  if ( (int)MiAllocateVirtualMemory(v10, 0LL, &v16) < 0 )
    return v2;
  v3 = MiObtainReferencedSecureVad((unsigned __int64)SecureHandle ^ v10[12] ^ qword_140C4DC50, &v15);
  v4 = v3;
  if ( !v3 )
    return v2;
