/*
 * XREFs of BgpClearScreen @ 0x1405BEDC4
 * Callers:
 ...
 *     BgpGxFillRectangle @ 0x140399C30 (BgpGxFillRectangle.c)
 *     BgpGxInitializeRectangle @ 0x1403AA604 (BgpGxInitializeRectangle.c)
 */
...
__int64 __fastcall BgpClearScreen(unsigned int a1)
{
  ...
  result = BgpGxInitializeRectangle((int *)&v12, BitsPerPixel, (__int64)byte_140CF74A0, 0x2000u);
  if ( (int)result >= 0 )
  {
    BgpGxFillRectangle((__int64)byte_140CF74A0, a1);
    v11 = 0;
    for ( i = 0; v11 < v4; i = v11 )
    {
      ...
      if ( v3 )
      {
        do
        {
          BgpGxDrawRectangle(byte_140CF74A0, (__int64)&v15);
          if ( (byte_140CF74B0 & 0x10) != 0 )
            BgpGxFillRectangle((__int64)byte_140CF74A0, a1);
          v15 += v9;
        }
        while ( v15 < v3 );
