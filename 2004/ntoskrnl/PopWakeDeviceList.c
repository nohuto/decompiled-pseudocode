/*
 * XREFs of PopWakeDeviceList @ 0x140380C2C
 * Callers:
 ...
 *     PopIsNotifyForDirectedPowerTransition @ 0x140381084 (PopIsNotifyForDirectedPowerTransition.c)
...
int __fastcall PopWakeDeviceList(_QWORD *a1, __int64 a2)
{
  ...
  if ( v3 > 0 )
  {
    do
    {
      ...
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)qword_140C22DF0 + 1, &LockHandle);
      v9 = *v2;
      v10 = **v2;
      if ( (__int64 **)(*v2)[1] != v2
        || *(__int64 **)(v10 + 8) != v9
      ...
      *v11 = v9;
      ...
      --v3;
      ++v7;
      if ( (unsigned __int8)PopIsNotifyForDirectedPowerTransition(v9) )
