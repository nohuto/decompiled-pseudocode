/*
 * XREFs of MiDemoteLocalLargePage @ 0x14023B280
 * Callers:
...
__int64 __fastcall MiDemoteLocalLargePage(__int64 a1, unsigned int a2, unsigned int a3, unsigned __int64 a4)
{
  ...
  {
    v6 = (unsigned __int16)(unsigned __int8)MiChannelMaximumPowerOf2Mask & (unsigned __int16)(a2 >> byte_140C4DC8D);
    v31 = v6;
  }
  v7 = a2 >> byte_140C4DC8C;
  v33 = *(_QWORD *)(a1 + 16) + 4544LL * (a2 >> byte_140C4DC8C);
