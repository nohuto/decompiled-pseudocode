/*
 * XREFs of MmCopyVirtualMemory @ 0x1405EA910
 * Callers:
...
LABEL_18:
  for ( i = v10; ; i = v10 )
  {
    ...
    v18 = v20;
    v55 = v20;
    KiStackAttachProcess((_KPROCESS *)BugCheckParameter1, 0LL, (__int64)v57);
    v21 = Src;
...
LABEL_43:
    KiUnstackDetachProcess((__int64)v57, 0LL);
    KiStackAttachProcess((_KPROCESS *)v43, 0LL, (__int64)v57);
    if ( a6 && Src == v45 )
    {
      v28 = v38;
