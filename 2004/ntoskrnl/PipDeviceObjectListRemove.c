/*
 * XREFs of PipDeviceObjectListRemove @ 0x14076ABA0
 * Callers:
 *     IopRemoveDeviceRelationsFromList @ 0x140760800 (IopRemoveDeviceRelationsFromList.c)
 *     IopRemoveCurrentRelationFromList @ 0x1408AF714 (IopRemoveCurrentRelationFromList.c)
 *     IopRemoveRelationFromList @ 0x1408AF794 (IopRemoveRelationFromList.c)
 * Callees:
