/*
 * XREFs of VmpConvertPortionVpnRangeToGpnRange @ 0x14059D9B0
 * Callers:
 *     VmpFillGpnRanges @ 0x14059DED0 (VmpFillGpnRanges.c)
 *     VmpFlushTbVaRange @ 0x14059E2E0 (VmpFlushTbVaRange.c)
 *     VmpQueryAccessedState @ 0x14059F71C (VmpQueryAccessedState.c)
 * Callees:
 *     VmpVaMemoryRangeGetNext @ 0x1405A0090 (VmpVaMemoryRangeGetNext.c)
 */
