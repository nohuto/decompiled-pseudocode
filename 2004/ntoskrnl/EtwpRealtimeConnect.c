/*
 * XREFs of EtwpRealtimeConnect @ 0x1406C6788
 * Callers:
...
__int64 __fastcall EtwpRealtimeConnect(__int64 a1)
{
  ...
  *(_DWORD *)v7 = *(_DWORD *)v7;
  ...
  {
    v14 = EtwpCheckLoggerControlAccess(0x400u);
    if ( v14 >= 0 )
    {
          ...
          if ( v14 >= 0 )
          {
            ...
            if ( v14 >= 0 )
            {
              ...
              *(_DWORD *)&v18[6].Version = v43 >> 12;
              ...
              inserted = ObInsertObjectEx(v21, 0LL, 0x400u, 1, 0, (__int64)&v35, (unsigned __int64 *)(a1 + 72));
              if ( inserted >= 0 )
              {
                ExAcquirePushLockExclusiveEx(v13 + 704, 0LL);
                *(_QWORD *)(v13 + 368) = v21;
                ExReleasePushLockEx(v13 + 704, 0LL);
