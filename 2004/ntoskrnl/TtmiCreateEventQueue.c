/*
 * XREFs of TtmiCreateEventQueue @ 0x140902028
 * Callers:
...
__int64 __fastcall TtmiCreateEventQueue(__int64 a1, PADAPTER_OBJECT *a2, __int64 *a3)
{
  ...
  *a2 = 0LL;
  ...
  v8 = CurrentThread->$6A88714AB977AAA8032D9F5E2A96BA31::gap0[10];
  *a3 = 0LL;
  v20 = 0LL;
  DmaAdapter = 0LL;
  v17[0] = 48LL;
  ...
  v17[2] = 0LL;
  v18 = 0LL;
  inserted = ObCreateObjectEx(0, v6, (int)v17, v8, v16, 176, 0, 0, &DmaAdapter, 0LL);
  v10 = inserted;
  if ( inserted >= 0 )
  {
    v12 = DmaAdapter;
    ...
    *(_QWORD *)&v14->Size = v13;
    *(_QWORD *)(a1 + 88) = v13;
    inserted = ObInsertObjectEx(v13, 0LL, 0x1F0000u, 0, 0, 0LL, (unsigned __int64 *)&v20);
    v10 = inserted;
    if ( inserted >= 0 )
    {
