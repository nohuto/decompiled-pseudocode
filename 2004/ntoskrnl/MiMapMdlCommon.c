/*
 * XREFs of MiMapMdlCommon @ 0x1403C56B4
 * Callers:
...
LABEL_33:
    ...
    if ( (unsigned __int64)*v9 <= 0xFFFFFFFFFLL && (*(_QWORD *)(48 * v16 - 0x57FFFFFFFD8LL) & 0x4000000000000LL) != 0 )
    {
      ...
      if ( !*(_WORD *)(v18 + 32) && !dword_140C4E4CC )
        MiShowBadMapper(v16);
...
LABEL_12:
      ...
      {
        v27 = 1;
        if ( HIBYTE(word_140C4DE08) == (_BYTE)v26 && (v22 & 1) != 0 )
...
LABEL_117:
      ...
      v67 = ExAcquireSpinLockExclusive(&dword_140C4E9C0);
      *v36 = qword_140C4E9D0;
      qword_140C4E9D0 = v35;
    ...
    if ( v43 < v79 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v51 )
        {
          ...
          {
            v50 = v53 + 1;
            if ( HIBYTE(word_140C4DE08) == (_BYTE)v53 )
            {
