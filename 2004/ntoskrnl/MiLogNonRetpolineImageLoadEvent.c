/*
 * XREFs of MiLogNonRetpolineImageLoadEvent @ 0x140760FA0
 * Callers:
...
void __fastcall MiLogNonRetpolineImageLoadEvent(__int64 a1, int a2)
{
  ...
  {
    if ( tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 0x400000000000LL) )
    {
      v8 = 1LL;
      v12 = 8LL;
      v11 = &v8;
      ...
      v7 = v5;
      v20 = 4LL;
      tlgWriteAgg(v4, (unsigned __int8 *)&byte_14002569F, 0LL, 8u, &v10);
    }
  }
}
