/*
 * XREFs of HalpTimerAlwaysOnClockInterrupt @ 0x1404CF860
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall HalpTimerAlwaysOnClockInterrupt(__int64 a1)
{
  ...
  if ( (KeGetCurrentPrcb()->PendingTickFlags & 2) != 0 )
  {
    ...
    if ( KeGetCurrentPrcb()->ClockOwner )
    {
      ...
      v8 = (_QWORD *)(HalpCounterSetInfo + 24 * CurrentPrcb);
      if ( (_QWORD *)*v8 != v8 && MEMORY[0xFFFFF78000000008] - v8[2] >= 0x4C4B40uLL )
      {
