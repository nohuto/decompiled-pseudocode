/*
 * XREFs of EtwpCompressBuffer @ 0x1405A71A0
 * Callers:
 ...
 *     EtwpRotateCompressionTarget @ 0x1405A8264 (EtwpRotateCompressionTarget.c)
 *     EtwpRotateCompressionTargetIfNeeded @ 0x1405A82D0 (EtwpRotateCompressionTargetIfNeeded.c)
 */
...
LABEL_5:
  ...
  while ( 1 )
  {
    ...
    if ( *(_DWORD *)(v10 + 8) == 72 || v5 < (int)CompressedBufferSize * *(_DWORD *)(a1 + 1188) )
    {
      ...
      if ( v13 >= 0 )
      {
        ...
        *(_DWORD *)(v10 + v11 + 12) = 0;
        *(_DWORD *)(v10 + v11 + 44) = 3;
        *(_DWORD *)(*(_QWORD *)(a1 + 1168) + 8LL) += 72;
        *(_DWORD *)(*(_QWORD *)(a1 + 1168) + 8LL) += FinalCompressedSize;
        return (unsigned int)v7;
      }
  ...
  while ( 1 )
  {
    ...
    if ( i )
    {
             ...
             *(PVOID *)(a1 + 1176)) >= 0 )
      {
        ...
        *(_DWORD *)(v10 + v11 + 44) = 3;
        *(_DWORD *)(*(_QWORD *)(a1 + 1168) + 8LL) += 72;
        v8 = FinalCompressedSize + *(_DWORD *)(*(_QWORD *)(a1 + 1168) + 8LL);
        *(_DWORD *)(*(_QWORD *)(a1 + 1168) + 8LL) = v8;
        goto LABEL_27;
      }
      v14 = ++v25;
      goto LABEL_24;
    }
    if ( *(_DWORD *)(*(_QWORD *)(a1 + 1168) + 8LL) != 72 )
      goto LABEL_27;
    if ( !NextEventOffsetType )
      break;
