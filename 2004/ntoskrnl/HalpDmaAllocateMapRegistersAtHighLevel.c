/*
 * XREFs of HalpDmaAllocateMapRegistersAtHighLevel @ 0x1404C1DFC
 * Callers:
 *     HalDmaAllocateCrashDumpRegistersEx @ 0x1403A36F0 (HalDmaAllocateCrashDumpRegistersEx.c)
 *     HalAllocateCrashDumpRegisters @ 0x1404B3E60 (HalAllocateCrashDumpRegisters.c)
 * Callees:
 ...
 *     HalpDmaForceAllocation @ 0x1404C2A84 (HalpDmaForceAllocation.c)
