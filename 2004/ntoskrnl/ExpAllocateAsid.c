/*
 * XREFs of ExpAllocateAsid @ 0x1405B317C
 * Callers:
...
__int64 ExpAllocateAsid()
{
  ...
  {
    v15 = dword_140C16684;
    if ( (_DWORD)dword_140C16684 != dword_140C16688 )
      break;
    if ( (_DWORD)dword_140C16684 == ExpSvmAgents )
    {
    ...
    KeAcquireInStackQueuedSpinLock(&qword_140C16698, &LockHandle);
    v9 = PoolWithTag;
    if ( v15 == (_DWORD)dword_140C16684 )
    {
      v9 = qword_140C16690;
      if ( qword_140C16690 )
        memmove(PoolWithTag, qword_140C16690, 16LL * v15);
      memset(&PoolWithTag[16 * v15], 0, 16LL * (v7 - v15));
      qword_140C16690 = PoolWithTag;
      LODWORD(dword_140C16684) = v7;
    }
    if ( v9 )
    {
      KeReleaseInStackQueuedSpinLockFromDpcLevel(&LockHandle);
  ...
  v16 = (_KPROCESS **)qword_140C16690;
  v17 = 0;
  if ( (_DWORD)dword_140C16684 )
  {
    while ( *v16 )
    {
      v16 += 2;
      if ( ++v17 >= (unsigned int)dword_140C16684 )
        goto LABEL_43;
    }
    v16[1] = (_KPROCESS *)1;
    *v16 = Process;
