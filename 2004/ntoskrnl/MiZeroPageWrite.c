/*
 * XREFs of MiZeroPageWrite @ 0x14034D928
 * Callers:
 *     MmZeroPageWrite @ 0x14034D8A8 (MmZeroPageWrite.c)
 * Callees:
...
__int64 __fastcall MiZeroPageWrite(struct _FILE_OBJECT *a1, _QWORD *a2, unsigned int a3, unsigned int a4)
{
  ...
  _QWORD *v27; // [rsp+68h] [rbp-98h]
  struct _IO_STATUS_BLOCK v28; // [rsp+70h] [rbp-90h] BYREF
  struct _FILE_OBJECT *v29; // [rsp+80h] [rbp-80h]
  _BYTE MemoryDescriptorList[176]; // [rsp+90h] [rbp-70h] BYREF

  HIDWORD(v28.Pointer) = 0;
  v5 = a3;
  v27 = a2;
  v29 = a1;
  v25 = a3;
  ...
  while ( 1 )
  {
    ...
    Status = IoSynchronousPageWriteEx(v29, Mdl, v27, &Object, 0, 0LL, &v28);
    if ( Status >= 0 )
    {
