/*
 * XREFs of sub_14095D280 @ 0x14095D280
 * Callers:
...
__int64 __fastcall sub_14095D280(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  int v4; // esi
...
LABEL_60:
  if ( v10 >= 0 )
  {
    ...
    if ( qword_140D2D450 )
    {
      ...
      if ( !v4 )
        v45 = Src;
      v46 = qword_140D2D450(v88, v31, v30, v37, v36, v45, v8, &v89);
    }
    else
    {
      v46 = -1073741637;
