/*
 * XREFs of PopEtIsrDpcQuery @ 0x1406F2690
 * Callers:
 ...
 *     KeQueryCycleTimeStatsProcessor @ 0x14034A3F0 (KeQueryCycleTimeStatsProcessor.c)
...
__int64 __fastcall PopEtIsrDpcQuery(__int64 a1, _OWORD *a2)
{
  ...
  v9[1] = (unsigned __int16 *)qword_140CFC848[0];
