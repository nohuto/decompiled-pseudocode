/*
 * XREFs of MmResourcesAvailable @ 0x14028EC00
 * Callers:
...
LABEL_8:
  ...
  if ( (a1 & 0x20) == 0 )
  {
    v11 = qword_140C4ED38 - qword_140C4ED28;
    goto LABEL_8;
  }
  ...
  v3 = *(ULONG_PTR **)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(v9 + 430));
LABEL_9:
  v17 = a2 + 0x80000;
  if ( a3 != 16 )
    v17 = a2 + 0x200000;
...
LABEL_30:
  ...
  if ( (a1 & 0x20) == 0 )
  {
    if ( v10 )
    {
      ...
      KeAbPostRelease((ULONG_PTR)&qword_140C4ED18);
