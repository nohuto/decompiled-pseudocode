/*
 * XREFs of KiSuspendThread @ 0x1402FADDC
 * Callers:
        ...
        *(_BYTE *)(a1 + 193) = 1;
        ...
        do
        {
          if ( *(_BYTE *)v18 < 5u )
          {
            ...
            KiAcquireKobjectLockSafe(v20, (__int64)v14, v15, v16);
            if ( *(_BYTE *)v18 == 4 )
            {
              v21 = *(_QWORD **)(v18 - 9);
              v14 = (_DWORD *)(v18 - 17);
              v22 = *(_QWORD *)(v18 - 17);
              if ( *(_QWORD *)(v22 + 8) != v18 - 17 || (_DWORD *)*v21 != v14 )
                __fastfail(3u);
              *v21 = v22;
              *(_QWORD *)(v22 + 8) = v21;
            }
        ...
        if ( (*(_DWORD *)(a1 + 116) & 0x200) != 0 )
        {
          ...
          if ( (unsigned __int8)KiCancelTimer(a1 + 256, v14) )
          {
            v27 = *(_QWORD *)(a1 + 280);
            if ( v27 <= v26 )
            {
        ...
        while ( 1 )
        {
          ...
          do
            KeYieldProcessorEx(&v35, (__int64)v14, v15, v16);
          while ( *(_QWORD *)(a1 + 64) );
        }
