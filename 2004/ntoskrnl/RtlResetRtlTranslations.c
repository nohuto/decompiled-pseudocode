/*
 * XREFs of RtlResetRtlTranslations @ 0x1407BD254
 * Callers:
...
__int64 RtlResetRtlTranslations()
{
  ...
  result = *((_QWORD *)&xmmword_140D56930 + 1);
  Nls844UnicodeUpcaseTable = xmmword_140D56930;
  LOBYTE(NlsMbOemCodePageTag) = v7;
  Nls844UnicodeLowercaseTable = *((_QWORD *)&xmmword_140D56930 + 1);
  return result;
}
