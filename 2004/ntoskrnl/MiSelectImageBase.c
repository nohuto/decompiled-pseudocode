/*
 * XREFs of MiSelectImageBase @ 0x140605F18
 * Callers:
 ...
 *     MiGetImageWowSubsystemIndex @ 0x14070345C (MiGetImageWowSubsystemIndex.c)
 *     MiSelectSystemImageAddress @ 0x14074A350 (MiSelectSystemImageAddress.c)
 *     MiImageCanUseHighOverflowArea @ 0x1408D46D0 (MiImageCanUseHighOverflowArea.c)
  ...
  if ( !a3 )
  {
    ...
    if ( (*(_WORD *)(v9 + 44) & 0x2000) != 0 )
    {
      ...
      if ( (_BYTE)v17 )
      {
        ...
        {
          v19 = MiObtainRelocationBits((unsigned __int64 **)v29, v16, started);
          v9 = v30;
          v14 = v19;
          if ( v19 != -1LL )
