/*
 * XREFs of PopWriteImageHeader @ 0x1409AEEB0
 * Callers:
...
__int64 (*__fastcall PopWriteImageHeader(__int64 a1, __int64 a2, unsigned int a3, __int64 a4))(void)
{
  ...
  v8 = __rdtsc();
  qword_140C233B0 = (((unsigned __int64)HIDWORD(v8) << 32) | (unsigned int)v8) - a4;
  dword_140C23574 = ((unsigned int)dword_140C23040 >> 4) - 1;
  PerformanceCounter = KeQueryPerformanceCounter(0LL);
  v10 = 0;
  for ( qword_140C233E0 = PerformanceCounter.QuadPart;
        v10 < *(_DWORD *)(a1 + 256);
        qword_140C233C0 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 80) )
  {
    v11 = v10++;
    v11 <<= 7;
    qword_140C23540 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 56);
    qword_140C233B8 += *(_QWORD *)(v11 + *(_QWORD *)(a1 + 264) + 40);
  }
  qword_140C23550 = qword_140C23568;
  qword_140C23560 = (unsigned int)dword_140C23570;
  qword_140C23568 += qword_140C23548;
  v12 = qword_140C23538;
  dword_140C23570 += qword_140C23558;
  *(_QWORD *)(a2 + 88) = qword_140C23538;
  if ( byte_140C23061 )
    *(_QWORD *)(a2 + 88) = qword_140C23540 + v12;
  v13 = 3LL;
  v14 = a2 + 136;
  v15 = &qword_140C23398;
  do
