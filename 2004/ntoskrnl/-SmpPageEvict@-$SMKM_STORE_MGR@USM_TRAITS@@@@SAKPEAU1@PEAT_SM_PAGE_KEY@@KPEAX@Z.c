/*
 * XREFs of ?SmpPageEvict@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAKPEAU1@PEAT_SM_PAGE_KEY@@KPEAX@Z @ 0x140303FD0
 * Callers:
...
__int64 __fastcall SMKM_STORE_MGR<SM_TRAITS>::SmpPageEvict(__int64 a1, _DWORD *a2, unsigned int a3, __int64 a4)
{
  ...
  if ( v6 != 1024 )
  {
    ...
    if ( v5 )
      SMKM_STORE_MGR<SM_TRAITS>::SmWorkItemFreeResource(&SmGlobals, v5, v14);
    if ( v14 )
