/*
 * XREFs of Normalization__CanCombineWithStartFirstPair @ 0x140914628
 * Callers:
 *     Normalization__IsNormalized @ 0x140914A14 (Normalization__IsNormalized.c)
 * Callees:
 *     Normalization__CanCombinableCharactersCombine @ 0x140914478 (Normalization__CanCombinableCharactersCombine.c)
 *     Normalization__GetFirstDecomposedCharPlane0 @ 0x1409146F0 (Normalization__GetFirstDecomposedCharPlane0.c)
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x140914904 (Normalization__GetSecondDecomposedCharPlane0.c)
 */
