/*
 * XREFs of NtQueryKey @ 0x140695470
 * Callers:
...
LABEL_34:
  ...
  if ( v10 == 1 )
  {
    if ( (_DWORD)v5 )
    {
      ...
      v12 = (unsigned __int64)a3 + v5 - 1;
      if ( (unsigned __int64)a3 > v12 || v12 >= 0x7FFFFFFF0000LL )
...
LABEL_29:
  ...
  Key = CmKeyBodyRemapToVirtualForEnum((__int64 *)&DmaAdapter, v30, v15, (__int64 *)&v37);
  v29 = Key;
  if ( Key >= 0 )
  {
    v25 = Size;
    Key = CmpBounceContextStart((__int64)Src, a3, (unsigned int)Size, v30, 2);
    v29 = Key;
    if ( Key >= 0 )
    {
      Key = CmQueryKey((__int64)DmaAdapter, (__int64)v37, a2, (unsigned int *)Src[1], Size, (unsigned int *)&Size + 1);
      v29 = Key;
