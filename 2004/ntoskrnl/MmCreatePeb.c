/*
 * XREFs of MmCreatePeb @ 0x14065D900
 * Callers:
...
__int64 __fastcall MmCreatePeb(_QWORD *a1, __int64 a2, _QWORD *a3, __int64 a4)
{
  ...
  *(_OWORD *)a4 = 0LL;
  ...
  v29 = v7;
  *(_WORD *)(a4 + 8) = v7;
  KiStackAttachProcess(v8, 0LL, (__int64)v42);
  ...
  else
  {
    ...
    *(_QWORD *)&v37[9] = v35;
    ...
    {
      v25 = _InterlockedExchangeAdd(&dword_140C4DC1C, 1u) + 1;
      do
      {
        v26 = v25 & 0x3F;
        v27 = 1LL << v26;
    ...
    *(_QWORD *)(v22 + 192) = qword_140C4DC20;
