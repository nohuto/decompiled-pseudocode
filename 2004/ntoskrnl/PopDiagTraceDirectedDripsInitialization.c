/*
 * XREFs of PopDiagTraceDirectedDripsInitialization @ 0x1407B9384
 * Callers:
...
void __fastcall PopDiagTraceDirectedDripsInitialization(int a1)
{
    ...
    && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
  {
    ...
    v3 = v1;
    v11 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)&word_1400262FE, 0LL, 0LL, 3u, &v9);
  }
