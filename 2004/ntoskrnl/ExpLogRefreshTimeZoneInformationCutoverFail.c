/*
 * XREFs of ExpLogRefreshTimeZoneInformationCutoverFail @ 0x140948370
 * Callers:
...
int __fastcall ExpLogRefreshTimeZoneInformationCutoverFail(int *a1, char a2, __int64 *a3, char a4)
{
  ...
  v9 = (_DWORD *)CurrentServerSiloGlobals[132];
  if ( (unsigned int)dword_140C02C20 > 5 )
  {
    ...
    v35 = 1LL;
    v37 = 8LL;
    tlgCreate1Sz_wchar_t((__int64)v38, (const size_t *)(a1 + 43));
    v10 = *((_BYTE *)a1 + 428);
    v39 = &v15;
    v19 = *a1;
    v15 = v10;
    ...
    LODWORD(CurrentServerSiloGlobals) = tlgWriteTransfer_EtwWriteTransfer(
                                          ...
                                          (unsigned __int8 *)byte_14002CDE5,
                                          0LL,
                                          0LL,
                                          0x10u,
                                          &v23);
