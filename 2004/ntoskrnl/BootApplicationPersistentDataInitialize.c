/*
 * XREFs of BootApplicationPersistentDataInitialize @ 0x140A6901C
 * Callers:
...
void __fastcall BootApplicationPersistentDataInitialize(__int64 a1)
{
  ...
  qword_140CF2638 = &qword_140CF2630;
  qword_140CF2630 = (__int64)&qword_140CF2630;
    ...
    if ( *((_DWORD *)v3 + 6) )
    {
      ...
      *((_DWORD *)PoolWithTag + 6) = *((_DWORD *)v3 + 6);
      ...
      if ( *(__int64 **)qword_140CF2638 != &qword_140CF2630 )
        __fastfail(3u);
      *PoolWithTag = &qword_140CF2630;
      PoolWithTag[1] = v6;
      *v6 = PoolWithTag;
      qword_140CF2638 = PoolWithTag;
    }
  }
}
