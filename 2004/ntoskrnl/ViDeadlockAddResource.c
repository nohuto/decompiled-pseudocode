/*
 * XREFs of ViDeadlockAddResource @ 0x1409DB828
 * Callers:
 ...
 *     VfUtilAddressRangeAdd @ 0x1409C32BC (VfUtilAddressRangeAdd.c)
        ...
        __int64 a6)
{
  ...
  if ( v11 )
  {
    ...
    {
      ViDeadlockPreprocessOptions(byte_140C12D94, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(0xC4u, 0x1005uLL, a1, v11, 0LL, byte_140C12D94);
    }
    if ( *(_QWORD *)(v11 + 16) )
    {
      ViDeadlockPreprocessOptions(byte_140C12D80, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(0xC4u, 0x1005uLL, a1, v11, 1uLL, byte_140C12D80);
    }
