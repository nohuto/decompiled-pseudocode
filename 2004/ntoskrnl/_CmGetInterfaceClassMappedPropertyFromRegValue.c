/*
 * XREFs of _CmGetInterfaceClassMappedPropertyFromRegValue @ 0x1406C1168
 * Callers:
  ...
  *v10 = 0;
  ...
  if ( (_DWORD)v15 == 2 )
  {
    ...
    if ( !v21 )
    {
      ...
      LOBYTE(v25) = 0;
      v22 = PnpOpenPropertiesKey(a1, a3, 0LL, 1LL, v25);
      v9 = v22;
      if ( v22 == -1073741772 )
      {
LABEL_16:
      ...
      {
        LODWORD(a5) = v14;
        v24 = RegRtlQueryValue(0LL, L"Default", &v28, v13, (unsigned int *)&a5);
        ZwClose(0LL);
