/*
 * XREFs of MiDecommitHardwareEnclavePages @ 0x140544558
 * Callers:
 ...
 *     RtlInterlockedSetClearRun @ 0x1402D4E40 (RtlInterlockedSetClearRun.c)
 ...
 *     MiGetExceptionInfo @ 0x14052F4F0 (MiGetExceptionInfo.c)
          ...
          if ( v23 < 0 )
          {
            ...
            else
            {
              if ( !v54 )
              {
                while ( 1 )
                {
                  v25 = *(_DWORD *)qword_140C4EC90;
                  v26 = *(_QWORD *)(qword_140C4EC90 + 8);
                  v27 = (*(_DWORD *)(qword_140C4EC90 + 8) & 4) != 0LL ? 0x20 : 0;
                  v60 = 0;
                  v28 = v27 + v25 - 1;
                  v29 = v26 - ((v26 & 4) != 0 ? 4 : 0);
                  if ( v25 )
...
LABEL_43:
                  ...
                  if ( v9 == -1 )
                    break;
                  if ( (unsigned int)RtlInterlockedSetClearRun(qword_140C4EC90, v9, 1u) )
                    goto LABEL_56;
                }
                MiFlushTbList((__int64)v69, (_KPROCESS *)v30);
                v33 = v67;
                MiUnlockPageTableInternal(v67, v8);
                MiUnlockWorkingSetShared(v33, v50);
                --CurrentThread->SpecialApcDisable;
                ExAcquirePushLockExclusiveEx((ULONG_PTR)&qword_140C4EC98, 0LL);
                v9 = 0;
                MiLockWorkingSetShared(v33);
                MiMakeSystemAddressValid(v15, 0LL, (*(_DWORD *)(v63 + 48) >> 12) & 0x3F, v50, 0);
LABEL_56:
                v54 = qword_140C4EC88 + 8 * v9;
                ++v53;
                v24 = v51;
              }
              KeBlockEnclavePage();
        ...
        else
        {
          do
          {
            ExAcquireSpinLockShared(&dword_140C4ECA0);
            v34 = KeOutPageEnclavePage(v19, *(_QWORD *)(v59 + 88));
            ExReleaseSpinLockSharedFromDpcLevel(&dword_140C4ECA0);
          }
...
LABEL_62:
  ...
  if ( v54 )
  {
    ...
    {
      v46 = 1;
      v47 = (volatile signed __int32 *)(*(_QWORD *)(qword_140C4EC90 + 8) + 4 * ((unsigned __int64)v9 >> 5));
      v48 = v9 & 0x1F;
      result = v48 + 1;
    ...
    {
      if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)&qword_140C4EC98, 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
        ExfTryToWakePushLock((volatile signed __int64 *)&qword_140C4EC98);
      v55 = 0;
      v36 = KeGetCurrentThread();
      if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)&qword_140C4EC98) == 1 )
      ...
      while ( 1 )
      {
        ...
        if ( (*(_BYTE *)(v41 + 26) & 1) != 0
          && (*(_DWORD *)(v41 + 32) & 1) == 0
          && (*(_QWORD *)(v41 + 32) & 0x7FFFFFFFFFFFFFFCLL) == ((unsigned __int64)&qword_140C4EC98 & 0x7FFFFFFFFFFFFFFCLL)
      ...
      {
        KeBugCheckEx(0x162u, (ULONG_PTR)v36, (ULONG_PTR)&qword_140C4EC98, SessionId, 0LL);
      }
      --v36->AbAllocationRegionCount;
      KiAbThreadRemoveBoosts((ULONG_PTR)v36, (__int64)&qword_140C4EC98, &v55);
