/*
 * XREFs of MiCheckPteReserve @ 0x14054E8FC
 * Callers:
...
__int64 __fastcall MiCheckPteReserve(__int64 a1, ULONG_PTR a2)
{
  ...
  v4 = 2LL * (unsigned int)((a1 - qword_140C4ED50) >> 3);
  v5 = v4;
  LOBYTE(v6) = 2;
  v7 = v4 + 2 * (a2 - 1);
  if ( v4 < v7 )
  {
    do
    {
      if ( !_bittest64((const signed __int64 *)qword_140C4E8E0, v5) )
        KeBugCheckEx(0xDAu, 0x201uLL, v3, v3 + (((v5 - v4) << 11) & 0xFFFFFFFFFFFFF000uLL), a2);
      v8 = v5 & 0x1F;
      LOBYTE(v9) = 1;
      v10 = (volatile signed __int32 *)(qword_140C4E8E0 + 4 * (v5 >> 5));
      if ( v8 + 1 > 0x20 )
      {
        if ( (v5 & 0x1F) != 0 )
        {
...
LABEL_14:
  ...
  v13 = v5 & 0x1F;
  v14 = (volatile signed __int32 *)(qword_140C4E8E0 + 4 * (v5 >> 5));
  result = v13 + 2;
  if ( v13 + 2 > 0x20 )
  {
    if ( (v5 & 0x1F) == 0 )
