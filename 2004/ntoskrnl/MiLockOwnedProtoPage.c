/*
 * XREFs of MiLockOwnedProtoPage @ 0x140229F90
 * Callers:
...
__int64 __fastcall MiLockOwnedProtoPage(__int64 a1, __int64 a2, __int64 a3, _DWORD *SchedulerAssist)
{
  ...
  v4 = (_BYTE *)(*(_QWORD *)(a1 + 8) | 0x8000000000000000uLL);
  v5 = *(_BYTE *)(a1 + 34);
  v6 = a1;
  ...
  *(_BYTE *)(v6 + 34) = v5 | 0x20;
  ...
  if ( (*(_QWORD *)(v6 + 24) & 0x4000000000000000LL) == 0 && (*v4 & 0x20) == 0 )
    result = MiWriteValidPteVolatile(v4, 1LL);
  _InterlockedAnd64((volatile signed __int64 *)(v6 + 24), 0x7FFFFFFFFFFFFFFFuLL);
  return result;
}
