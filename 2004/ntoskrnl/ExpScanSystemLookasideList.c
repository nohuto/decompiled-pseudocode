/*
 * XREFs of ExpScanSystemLookasideList @ 0x140325940
 * Callers:
 *     KeBalanceSetManager @ 0x1403B5C40 (KeBalanceSetManager.c)
 * Callees:
 *     ExpComputeLookasideDepth @ 0x140325B04 (ExpComputeLookasideDepth.c)
...
__int64 ExpScanSystemLookasideList()
{
  ...
  for ( i = 0; i < dword_140C57E90; ++i )
  {
    v12 = 2LL;
    v13 = (char *)&unk_140C57F00 + 8384 * i;
    do
    {
