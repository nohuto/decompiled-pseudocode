/*
 * XREFs of RtlEnumerateBoundaryDescriptorEntries @ 0x1406BAC20
 * Callers:
 *     ObpCompareEntryLevel1 @ 0x1406BAB30 (ObpCompareEntryLevel1.c)
 *     ObpCheckDuplicateEntries @ 0x1406BC578 (ObpCheckDuplicateEntries.c)
