/*
 * XREFs of ExpWorkQueueManagerThread @ 0x140797760
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KeSetMaximumCountPriQueue @ 0x14051F07C (KeSetMaximumCountPriQueue.c)
 *     ExpCreateWorkerThread @ 0x1406CF978 (ExpCreateWorkerThread.c)
 *     ExpPartitionCreatePoolDelayed @ 0x140952848 (ExpPartitionCreatePoolDelayed.c)
...
void __fastcall ExpWorkQueueManagerThread(_QWORD *a1)
{
  ...
  v35 = CurrentThread;
  KeSetActualBasePriorityThread((__int64)CurrentThread, 12LL, v4, v5);
  v37[1] = -1LL;
  v37[0] = 0LL;
  KeSetTimer2(
    (__int64)(a1 + 16),
