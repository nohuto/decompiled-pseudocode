/*
 * XREFs of KiInsertTimer2WithCollectionLockHeld @ 0x14027F1E0
 * Callers:
...
LABEL_20:
  ...
  else
  {
    *(_BYTE *)(a1 + 131) = v21 & 0xEF;
    v22 = (_RTL_RB_TREE *)(0x140000000LL + 24LL * (v21 & 7) + 12786304);
    v23 = *(_QWORD *)(0x140000008LL + 24LL * (v21 & 7) + 12786304);
