/*
 * XREFs of SymCryptInitEnvWindowsKernelmodeWin8_1nLater @ 0x1403E8A2C
 * Callers:
 *     SymCryptInit @ 0x1403B55C0 (SymCryptInit.c)
 *     KeInitSystem @ 0x140A4495C (KeInitSystem.c)
 * Callees:
 *     RtlGetEnabledExtendedFeatures @ 0x1403A4780 (RtlGetEnabledExtendedFeatures.c)
