/*
 * XREFs of AlpcpProcessConnectionRequest @ 0x140628D28
 * Callers:
        ...
        char a8)
{
  ...
  int v32[2]; // [rsp+58h] [rbp-B0h] BYREF
  ...
  *(_QWORD *)v32 = 0LL;
  ...
  result = AlpcpFormatConnectionRequest(v32, a2, v11, a3, &v36, a5, 0LL, 0LL, 0, a8);
  if ( (int)result < 0 )
    return result;
  v17 = *(_QWORD *)v32;
  v41 = *(_DWORD *)(*(_QWORD *)v32 + 264LL);
  if ( AlpcpLogEnabled )
    AlpcpLogConnectRequest(*(_QWORD *)v32);
  *(_QWORD *)v39 = v11;
  *(_QWORD *)&v39[2] = v17;
  v39[12] = a2;
  ...
  *(_QWORD *)v32 = 0LL;
  ...
  v20 = AlpcpReceiveSynchronousReply((int)v39, v18, (int)v32, v31, a7);
  v21 = v20;
  if ( v20 )
  {
    if ( AlpcpLogEnabled )
  ...
  else
  {
    ...
    v22 = *(_QWORD *)v32;
    v23 = *(unsigned __int16 *)(*(_QWORD *)v32 + 240LL);
    v24 = 24;
    ...
    if ( a4 )
    {
      ...
      {
        AlpcpUnlockMessage(*(ULONG_PTR *)v32);
        *a4 = v30;
        return 3221225507LL;
      }
    }
