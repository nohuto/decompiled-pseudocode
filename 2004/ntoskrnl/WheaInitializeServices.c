/*
 * XREFs of WheaInitializeServices @ 0x140A68DA4
 * Callers:
 *     InitBootProcessor @ 0x140A36F64 (InitBootProcessor.c)
 * Callees:
 *     WheapInitializeInUsePageOfflineNotifications @ 0x1407B5338 (WheapInitializeInUsePageOfflineNotifications.c)
 */
...
PVOID *WheaInitializeServices()
{
  ...
  qword_140CF4848 = (__int64)&WheapPfaList;
  ...
  *(_QWORD *)&WheapDispatchPtr.DeviceType = &WheapDispatchPtr.DeviceType;
  ...
  qword_140C15E38 = (__int64)WheapDeferredRecoveryServiceDpcRoutine;
