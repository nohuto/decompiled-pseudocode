/*
 * XREFs of MiLogHotPatchOperationStatus @ 0x1408C8440
 * Callers:
  ...
  if ( *(_QWORD *)&qword_140C4ECE0 )
  {
    ...
    if ( a5 )
    {
      if ( a5 == 1 )
      {
        if ( **(_DWORD **)&qword_140C4ECE0 <= 5u )
          return (char)v5;
        LOBYTE(v5) = tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 0x400000000020LL);
        if ( !(_BYTE)v5 )
          return (char)v5;
        v25 = a4;
        v37[4] = (__int64)&v25;
        v16 = (unsigned __int8 *)&byte_14002529F;
        v37[5] = 4LL;
        v37[6] = (__int64)&v26;
        v37[8] = (__int64)&v27;
        v37[10] = (__int64)v38;
      ...
      else
      {
        ...
        v28 = a4;
        v42 = &v28;
        v16 = (unsigned __int8 *)&word_140025226;
        v43 = 4LL;
        v44 = &v29;
        v46 = &v30;
        v48 = v51;
    ...
    if ( **(_DWORD **)&qword_140C4ECE0 > 5u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v67[1] = 0;
        v69 = 8LL;
        LOBYTE(v5) = tlgWriteEx_EtwWriteEx(v10, (unsigned __int8 *)word_140025312, v12, 1u, v19, v20, 0xAu, &v54);
      }
    }
  }
  return (char)v5;
