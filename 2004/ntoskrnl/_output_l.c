/*
 * XREFs of _output_l @ 0x1403D1DCC
 * Callers:
 ...
 *     write_multi_char_0 @ 0x1403D2658 (write_multi_char_0.c)
 *     write_string_0 @ 0x1403D26B0 (write_string_0.c)
 *     _get_printf_count_output @ 0x1403D2D6C (_get_printf_count_output.c)
