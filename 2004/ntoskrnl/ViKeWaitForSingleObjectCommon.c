/*
 * XREFs of ViKeWaitForSingleObjectCommon @ 0x1409D9548
 * Callers:
 *     VerifierKeWaitForSingleObject @ 0x1409D8A00 (VerifierKeWaitForSingleObject.c)
 *     VerifierKeWaitForSingleObjectNoReboot @ 0x1409D8A70 (VerifierKeWaitForSingleObjectNoReboot.c)
 * Callees:
