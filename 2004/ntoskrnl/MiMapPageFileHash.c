/*
 * XREFs of MiMapPageFileHash @ 0x1403129A0
 * Callers:
...
void __fastcall MiMapPageFileHash(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, unsigned int a5)
{
  ...
  MiInitializePageColorBase((__int64)AnyMultiplexedVm, 0, (__int64)&v113);
  if ( v7 )
  {
    if ( (*(_BYTE *)(v7 + 10) & 5) == 0 )
...
LABEL_109:
      _InterlockedDecrement64(&qword_140C4F628);
LABEL_110:
      v50 = a5;
      v5 = v116;
      v8 = a1;
...
LABEL_21:
    *(_QWORD *)(v22 + 16) = v31;
    ...
    if ( (_DWORD)v27 )
      *(_BYTE *)(v22 + 34) &= ~0x10u;
    updated = MiMakeValidPte(v16, v112, 2684354564LL, v35);
    v37 = updated;
    v38 = 0;
    v39 = updated;
    if ( !MiPteInShadowRange(v16) )
