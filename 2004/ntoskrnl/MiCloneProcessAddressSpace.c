/*
 * XREFs of MiCloneProcessAddressSpace @ 0x1408D5A60
 * Callers:
...
__int64 __fastcall MiCloneProcessAddressSpace(_KPROCESS *BugCheckParameter1, _KPROCESS *a2, unsigned int a3)
{
  char v3; // r15
  int v6; // r12d
  int v7; // r13d
  ...
  unsigned int v22; // [rsp+40h] [rbp-39h]
  ...
  if ( !*(_QWORD *)(v25 + 360) || v11 )
  {
    ...
    if ( v24 )
    {
      ...
      if ( v12 >= 0 )
      {
        ...
        {
          v6 = 1;
          KiStackAttachProcess(a2, 0LL, (__int64)v27);
        }
        MiCreateForkWsles();
        if ( v8 )
        {
