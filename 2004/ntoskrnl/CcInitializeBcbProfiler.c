/*
 * XREFs of CcInitializeBcbProfiler @ 0x140A18354
 * Callers:
 ...
 *     KiAreCodePatchesAllowed @ 0x140A70BD0 (KiAreCodePatchesAllowed.c)
 *     KiGetLoadOptions @ 0x140A712A4 (KiGetLoadOptions.c)
 */
  ...
  if ( MEMORY[0xFFFFF780000002D4] < 2u )
  {
    ...
    if ( !PoolWithTag )
    {
      ...
      *((_QWORD *)&v5 + 1) = (((unsigned __int64)v5 ^ *((_QWORD *)&v5 + 1)) * (unsigned __int128)0x47AE147AE147AE15uLL) >> 64;
      ...
      v92 = v7;
      if ( v7 >= 0x32 )
        LODWORD(v4) = (unsigned int)sub_1405C7010;
      LOBYTE(v8) = v7 >= 0x32;
      v90 = v8;
          ...
          *(_QWORD *)&Dpc[2].Header.Lock = v43;
          ...
          if ( v7 >= 0x32 )
          {
            *(_QWORD *)&Dpc[2].Processor = 0LL;
            Dpc[3].Header.WaitListHead.Flink = (struct _LIST_ENTRY *)sub_1405C7010;
