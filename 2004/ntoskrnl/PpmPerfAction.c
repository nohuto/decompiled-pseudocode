/*
 * XREFs of PpmPerfAction @ 0x140215630
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PpmParkReportParkedCore @ 0x140578374 (PpmParkReportParkedCore.c)
 *     PpmParkReportSoftParkChange @ 0x14057846C (PpmParkReportSoftParkChange.c)
 *     PpmParkReportUnparkedCore @ 0x140578520 (PpmParkReportUnparkedCore.c)
 */
