/*
 * XREFs of KiIntersectFeaturesWithPolicy @ 0x14099D210
 * Callers:
 ...
 *     KiIsXSaveFeatureAllowed @ 0x14099D370 (KiIsXSaveFeatureAllowed.c)
 *     KiLoadPolicyFromImage @ 0x14099D400 (KiLoadPolicyFromImage.c)
 */
