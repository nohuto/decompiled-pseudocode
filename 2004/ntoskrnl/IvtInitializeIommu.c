/*
 * XREFs of IvtInitializeIommu @ 0x1409A6B10
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IvtBuildContextEntry @ 0x1404DA880 (IvtBuildContextEntry.c)
 ...
 *     IvtGetIdentityMappedDomain @ 0x1404DB084 (IvtGetIdentityMappedDomain.c)
 *     IvtInitializeIdentityMappings @ 0x1404DB250 (IvtInitializeIdentityMappings.c)
 *     IvtInitializeMTRR @ 0x1404DB4D4 (IvtInitializeMTRR.c)
