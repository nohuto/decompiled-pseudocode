/*
 * XREFs of __C_specific_handler @ 0x1403CCE90
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x1403F2CD8 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x1402E70E0 (RtlUnwindEx.c)
 *     KeCheckStackAndTargetAddress @ 0x140340640 (KeCheckStackAndTargetAddress.c)
 *     _NLG_Notify @ 0x1403CE360 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x1403CE390 (__NLG_Return2.c)
 */
