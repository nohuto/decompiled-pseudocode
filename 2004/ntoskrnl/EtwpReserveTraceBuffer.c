...
unsigned __int64 __fastcall EtwpReserveTraceBuffer(__int64 i, __int64 a2, __int64 a3, LARGE_INTEGER *a4, __int16 a5)
{
  __int64 v7; // rdi
  unsigned int v8; // r9d
  __int64 v9; // r8
  ...
  unsigned __int8 v41; // [rsp+90h] [rbp+8h] BYREF
...
LABEL_40:
  ...
  while ( 1 )
  {
    ...
    v11 = (_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 1112) + 4136LL) + ((unsigned __int64)Number << 6));
...
LABEL_29:
    v25 = EtwpSwitchBuffer(v7, v13, (signed __int64 *)v12, Number, a5);
    if ( (*(_DWORD *)(v7 + 12) & 0x4000000) != 0 )
    {
      PerformanceCounter = KeQueryPerformanceCounter(0LL);
      v32 = PerformanceCounter.QuadPart
          - _InterlockedExchange64((volatile __int64 *)(v7 + 1272), PerformanceCounter.QuadPart);
      do
      {
        v33 = *(_QWORD *)(v7 + 1280);
        if ( v33 )
      ...
      while ( v33 != _InterlockedCompareExchange64((volatile signed __int64 *)(v7 + 1280), i, v33) );
    }
    if ( v25 < 0 )
      goto LABEL_40;
    v9 = v35;
...
LABEL_70:
      ...
      {
        v18.QuadPart = RtlGetSystemTimePrecise(i);
        v9 = v35;
        v8 = v34;
      }
    }
