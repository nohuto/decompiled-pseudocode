/*
 * XREFs of MiInitializeDriverImages @ 0x140A46EB8
 * Callers:
...
__int64 __fastcall MiInitializeDriverImages(__int64 a1)
{
  ...
  while ( v6 );
  MxMarkActiveDriverBits((unsigned int)&qword_140C4DEE0, v1, v4, (unsigned int)&v22, 3);
  v7 = qword_140C4DEE8;
  v8 = (_DWORD *)((((unsigned __int64)qword_140C4DEE8 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL);
  for ( i = 0LL; i < qword_140C4DEE0; i += 0x8000LL )
  {
    if ( (*v8 & 0x800LL) == 0 )
    {
      if ( !(unsigned int)MiSplitBitmapPages(5, v7, 8LL) )
        return 0LL;
      RtlClearBitsEx((__int64)&qword_140C4DEE0, i, 0x8000uLL);
    }
    v7 += 4096LL;
    v8 += 2;
  }
  ...
  qword_140C4CAF8 = (__int64)&qword_140C4CAF8;
    ...
    if ( &MmLargePageDriverBuffer < (_UNKNOWN *)v14 )
    {
      ...
      do
      {
        ...
        else
        {
          ...
          *((_WORD *)Pool + 8) = v20;
          *((_WORD *)Pool + 9) = v20;
          v21 = (_QWORD *)qword_140C4CB00;
          if ( *(__int64 **)qword_140C4CB00 != &qword_140C4CAF8 )
            __fastfail(3u);
          *Pool = &qword_140C4CAF8;
          Pool[1] = v21;
          v15 = 0x100002601LL;
          *v21 = Pool;
          qword_140C4CB00 = (__int64)Pool;
        }
        v13 = j + 1;
      }
      while ( j + 1 < v14 );
  ...
  MiFreeKernelPadSections(
    *(_QWORD *)(qword_140C4CB18 + 48),
    *(_QWORD *)(qword_140C4CB18 + 48) + *(unsigned int *)(qword_140C4CB18 + 64));
  if ( !(unsigned int)MiReloadBootLoadedDrivers(a1) || !(unsigned int)MiCreateInitialSystemWsles() )
    return 0LL;
  VfInitBootDriversLoaded(a1);
  result = 1LL;
  qword_140C4CB10 = (__int64)&qword_140C4CB08;
  qword_140C4CB08 = &qword_140C4CB08;
  return result;
}
