/*
 * XREFs of IopSetupArbiterAndTranslators @ 0x14073C34C
 * Callers:
 *     IopResourceRequirementsListToReqList @ 0x14073BD84 (IopResourceRequirementsListToReqList.c)
 * Callees:
 *     IopFindResourceHandlerInfo @ 0x14073C72C (IopFindResourceHandlerInfo.c)
 *     IopFindLegacyBusDeviceNode @ 0x14073C7BC (IopFindLegacyBusDeviceNode.c)
