/*
 * XREFs of MiInsertPartitionPages @ 0x14055D0A0
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( (ULONG_PTR *)v9 == &MiSystemPartition )
  {
    v17 = *(_DWORD *)(a3 + 24);
    if ( (v17 & 0x10) == 0 )
      _InterlockedExchangeAdd64(&qword_140C4E450, -(__int64)a4);
    ...
    *(_QWORD *)&v65 = _mm_srli_si128(v19, 8).m128i_u64[0];
    ...
    CurrentThread = (struct _KTHREAD *)v70;
    if ( (v21 & 0x10) == 0 )
      _InterlockedExchangeAdd64(&qword_140C4E450, v20);
  }
  if ( !v9 )
    goto LABEL_90;
  if ( !a5 )
...
LABEL_75:
  ...
  if ( !a5 )
  {
    if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)(v9 + 192), 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
      ExfTryToWakePushLock((volatile signed __int64 *)(v9 + 192));
