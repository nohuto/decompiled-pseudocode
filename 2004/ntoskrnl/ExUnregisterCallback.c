/*
 * XREFs of ExUnregisterCallback @ 0x14037F540
 * Callers:
 ...
 *     KeDeregisterProcessorChangeCallback @ 0x1408B86A0 (KeDeregisterProcessorChangeCallback.c)
 *     SeUnregisterImageVerificationCallback @ 0x140918B70 (SeUnregisterImageVerificationCallback.c)
 *     PopUmpoInitializeMonitorChannel @ 0x140A6D250 (PopUmpoInitializeMonitorChannel.c)
 *     IoUnregisterBootDriverCallback @ 0x140A712C0 (IoUnregisterBootDriverCallback.c)
 * Callees:
