/*
 * XREFs of BgpFwSetBootGraphicsInformation @ 0x1405BEFE0
 * Callers:
...
__int64 __fastcall BgpFwSetBootGraphicsInformation(__int64 a1, __int64 a2)
{
  ...
  xmmword_140C132F0 = *(_OWORD *)a2;
  xmmword_140C13300 = *(_OWORD *)(a2 + 16);
  DWORD2(BgInternal) = *(_DWORD *)(a2 + 8);
  DWORD1(BgInternal) = *(_DWORD *)(a2 + 12);
  HIDWORD(BgInternal) = *(_DWORD *)(a2 + 16);
  if ( *(_DWORD *)(a2 + 24) == 3 )
  {
    LODWORD(xmmword_140C132B0) = 4;
    goto LABEL_7;
  }
  if ( *(_DWORD *)(a2 + 24) == 4 )
  {
    LODWORD(xmmword_140C132B0) = 5;
LABEL_7:
    LOWORD(BgInternal) = 1;
    qword_140C132C0 = *(PVOID *)a2;
    return v2;
  }
  return (unsigned int)-1073741637;
}
