/*
 * XREFs of DrvDbSetDeviceIdDriverInfMatches @ 0x140714464
 * Callers:
...
__int64 __fastcall DrvDbSetDeviceIdDriverInfMatches(__int64 a1, void *a2, const wchar_t *a3)
{
  ...
  MaxCount = 0;
  v24 = 0;
  InfoKey = PnpCtxRegQueryInfoKey(a1, (int)a2, 0, 0, (__int64)&v32, (__int64)&MaxCount, 0LL);
  inited = InfoKey;
  if ( InfoKey >= 0 )
  {
    v6 = MaxCount + 1;
    ...
    if ( v3 )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        if ( v32 )
        {
          ...
          {
            MaxCount = v6;
            v14 = PnpCtxRegEnumValue(0LL, KeyHandle, v13, PoolWithTag, (__int64)&MaxCount, (__int64)&v24, 0LL, 0LL);
            inited = v14;
            if ( v14 < 0 )
              break;
            if ( v24 == 3 || !v24 )
    ...
    else
    {
      ...
      if ( PoolWithTag )
      {
        ...
        if ( v21 )
        {
          ...
          {
            MaxCount = v6;
            inited = PnpCtxRegEnumValue(0LL, a2, v22, PoolWithTag, (__int64)&MaxCount, 0LL, 0LL, 0LL);
            if ( inited < 0 )
              break;
            DestinationString = 0LL;
            inited = RtlInitUnicodeStringEx(&DestinationString, (PCWSTR)PoolWithTag);
