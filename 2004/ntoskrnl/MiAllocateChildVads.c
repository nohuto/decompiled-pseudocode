/*
 * XREFs of MiAllocateChildVads @ 0x1408D5490
 * Callers:
 ...
 *     MiVadShouldBeForked @ 0x140556624 (MiVadShouldBeForked.c)
...
LABEL_52:
    ...
    {
      KiStackAttachProcess((_KPROCESS *)BugCheckParameter1, 0LL, (__int64)v30);
      v4 = 1;
