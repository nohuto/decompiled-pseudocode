/*
 * XREFs of CmpTryAcquireIXLockWithRollbackPacket @ 0x14075B85C
 * Callers:
 *     CmpTryAcquireKcbIXLocks @ 0x14075B7F0 (CmpTryAcquireKcbIXLocks.c)
 * Callees:
 *     CmpSnapshotTxOwnerArrayToRollbackPacket @ 0x140871D14 (CmpSnapshotTxOwnerArrayToRollbackPacket.c)
 */
