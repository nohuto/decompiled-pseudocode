/*
 * XREFs of KiTransitionSchedulingGroupGeneration @ 0x1402EDB30
 * Callers:
 ...
 *     KiInsertNonMaxOverQuotaScb @ 0x1402F08CC (KiInsertNonMaxOverQuotaScb.c)
...
LABEL_26:
    if ( *(_BYTE *)(a1 + 32409) )
    {
      ...
      *(_BYTE *)(a1 + 32409) = 0;
      ...
      _InterlockedAnd64(&qword_140C11178[result], ~(1LL << (v34 & 0x3F)));
    }
    return result;
  }
  LOBYTE(result) = v6;
