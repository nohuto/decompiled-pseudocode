/*
 * XREFs of PiProcessNewDeviceNode @ 0x140724960
 * Callers:
 ...
 *     PpvUtilFailDriver @ 0x14050AC80 (PpvUtilFailDriver.c)
  ...
  while ( 1 )
  {
    if ( GloballyUniqueId < 0 )
    {
      ...
      if ( v71 || *(_DWORD *)(MaxDataSize + 404) != 9 )
      {
        ...
        {
          v73 = (unsigned int)GloballyUniqueId;
          v72 = 19LL;
        }
        PipSetDevNodeProblem(MaxDataSize, v72, v73);
      }
    }
    v18 = PiBuildDeviceNodeInstancePath(MaxDataSize, v128, v122, v15);
    if ( v18 >= 0 )
    {
      if ( (byte_140C130BB & 8) != 0 )
      ...
      if ( v18 < 0 )
      {
        PipSetDevNodeProblem(MaxDataSize, 19LL, (unsigned int)v18);
        v3 = HIDWORD(v111);
        v4 = Handle;
      }
      else
...
LABEL_67:
    ...
    && ((*(_DWORD *)(MaxDataSize + 396) & 0x2000) == 0 || *(_DWORD *)(MaxDataSize + 404) != 14) )
  {
    if ( v106 )
    {
      ...
      if ( HIDWORD(v111) == 1 )
        v66 = v118 | 1;
      PpDevCfgProcessDevice(MaxDataSize, v37, v66);
    }
    else if ( v37 )
    {
    ...
    || (v102 = 524808, !_bittest(&v102, v101)) )
  {
    ...
    if ( v55 < 0 )
      PipSetDevNodeProblem(MaxDataSize, 19LL, (unsigned int)v55);
    v37 = Handle;
    v39 = P;
    v46 = v125;
    v38 = v121;
