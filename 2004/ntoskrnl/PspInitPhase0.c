/*
 * XREFs of PspInitPhase0 @ 0x140A3A054
 * Callers:
 ...
 *     PspInitializeJobStructures @ 0x140A6E8F4 (PspInitializeJobStructures.c)
 */
...
char __fastcall PspInitPhase0(PVOID StartContext)
{
  ...
  qword_140C1DF68 = (__int64)&PsActiveProcessHead;
              ...
              if ( PspInitializeSiloStructures() )
              {
                ...
                if ( PspCidTable )
                {
                  ...
                  *(_BYTE *)(PspCidTable + 44) |= 1u;
                  qword_140C1DF90 = (__int64)PspReaper;
                  qword_140C1DFF0 = (__int64)PspProcessRundownWorker;
