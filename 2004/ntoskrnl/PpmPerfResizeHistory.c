/*
 * XREFs of PpmPerfResizeHistory @ 0x1408E2C88
 * Callers:
 *     PpmRegisterPerfStates @ 0x1407A7090 (PpmRegisterPerfStates.c)
 *     PpmPerfResizeHistoryAll @ 0x1408E2D64 (PpmPerfResizeHistoryAll.c)
 * Callees:
 *     PpmGetPerfPolicyClass @ 0x1403313EC (PpmGetPerfPolicyClass.c)
 *     PpmPerfResetHistory @ 0x1403C0414 (PpmPerfResetHistory.c)
...
__int64 __fastcall PpmPerfResizeHistory(__int64 a1)
{
  ...
  v5 = *(_DWORD **)(v4 + 32);
  v6 = *((unsigned __int8 *)&PpmCurrentProfile[342 * dword_140C238AC + 8] + PerfPolicyClass);
  v7 = v6;
  if ( v5 )
  {
    if ( *v5 == v6 )
