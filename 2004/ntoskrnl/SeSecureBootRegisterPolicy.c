/*
 * XREFs of SeSecureBootRegisterPolicy @ 0x140A6CFEC
 * Callers:
 ...
 *     SepSecureBootBuildRules @ 0x140A90C58 (SepSecureBootBuildRules.c)
...
__int64 __fastcall SeSecureBootRegisterPolicy(ULONG_PTR BugCheckParameter2, ULONG_PTR BugCheckParameter3)
{
  ...
  qword_140C54440 = *(_QWORD *)(BugCheckParameter2 + 16);
  ...
  if ( v6[18] || v6[19] )
  {
    qword_140CF9E78 = (__int64)v10 + v10[13] + 60;
...
LABEL_32:
              if ( qword_140CF4B98 )
              {
                ExFreePoolWithTag(qword_140CF4B98, 0);
                qword_140CF4B98 = 0LL;
              }
