/*
 * XREFs of SecureDump_PrepareForInit @ 0x1403C8E60
 * Callers:
...
LABEL_4:
      ...
      if ( v5 >= 0 )
      {
        DWORD1(xmmword_140C4C658) = *(_DWORD *)P;
        ExFreePoolWithTag(P, 0);
        if ( !DWORD1(xmmword_140C4C658)
          || (*a2 = 1,
              (int)SecureDump_ReadRegistry(
                     ...
                     3,
                     (unsigned int)&xmmword_140C4C658 + 8,
                     (__int64)&dwFlags) >= 0)
          && (int)SecureDump_ReadRegistry(
                    (unsigned int)v6,
