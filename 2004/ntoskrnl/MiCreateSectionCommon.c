/*
 * XREFs of MiCreateSectionCommon @ 0x1405FAC40
 * Callers:
 *     NtCreateSection @ 0x1405FABD0 (NtCreateSection.c)
 *     NtCreateSectionEx @ 0x1408C43F0 (NtCreateSectionEx.c)
 * Callees:
...
LABEL_18:
  ...
  if ( (int)result >= 0 )
  {
    ...
    else
    {
      ...
      result = ObInsertObjectEx(v17, 0LL, 0, 0LL, (__int64)&v24);
      if ( (int)result >= 0 )
        *v26 = v24;
    }
  }
