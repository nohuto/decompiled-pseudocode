/*
 * XREFs of KeLoadMTRR @ 0x1409961A0
 * Callers:
 *     HalpPostSleepMP @ 0x140992004 (HalpPostSleepMP.c)
 *     KiLoadMTRRTarget @ 0x14099E130 (KiLoadMTRRTarget.c)
 * Callees:
 *     KeFlushCurrentTbImmediately @ 0x14039DCF0 (KeFlushCurrentTbImmediately.c)
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     KiLockStepExecution @ 0x140996384 (KiLockStepExecution.c)
 *     KiWriteFixedMtrr @ 0x1409963CC (KiWriteFixedMtrr.c)
 *     KiReadFixedMtrr @ 0x1409964D8 (KiReadFixedMtrr.c)
 *     KiCompareVarMtrr @ 0x1409965E4 (KiCompareVarMtrr.c)
 */
...
__int64 __fastcall KeLoadMTRR(__int64 a1)
{
  ...
  if ( byte_140C2B130 )
  {
    ...
    if ( qword_140C2B140 )
    {
      ...
      {
        v2 = 0LL;
        v3 = (PVOID)((_BYTE *)qword_140C2B140 - v18);
        v17 = v18;
...
LABEL_6:
    ...
    if ( (_BYTE)qword_140C2B128 )
    {
      ...
      do
      {
        v12 = qword_140C2B138;
        v13 = 2 * v10;
        __writemsr(v11 - 1, *((_QWORD *)qword_140C2B138 + v13));
        v8 = HIDWORD(v12[v13 + 1]);
        __writemsr(v11, v12[v13 + 1]);
        v10 = ++v9;
        v11 += 2;
      }
      while ( v9 < (unsigned __int64)(unsigned __int8)qword_140C2B128 );
    }
    if ( qword_140C2B140 )
      KiWriteFixedMtrr(qword_140C2B140, v8);
