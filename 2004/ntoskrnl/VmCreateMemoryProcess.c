/*
 * XREFs of VmCreateMemoryProcess @ 0x14092B670
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a6)
{
  ...
  RegionSize = 0LL;
  ProcessHandle = 0LL;
  v9 = BYTE2(Process[2].Header.WaitListHead.Flink);
  if ( (a4 & 0xFFFFFFC0) != 0 )
  {
  ...
  else
  {
    ...
    if ( (a4 & 0x10) == 0 )
      v13 = v12;
    v14 = PsCreateMinimalProcess(Process, a2, 0LL, v9, a3, v13, (a4 & 0x20 | 0x40u) >> 3, 0LL, a5, &ProcessHandle);
    v15 = ProcessHandle;
    v10 = v14;
    if ( v14 >= 0 )
    {
