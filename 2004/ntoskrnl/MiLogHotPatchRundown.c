/*
 * XREFs of MiLogHotPatchRundown @ 0x1408C89BC
 * Callers:
 *     MiTracingEnabledCallback @ 0x1408D4410 (MiTracingEnabledCallback.c)
 * Callees:
 ...
 *     MiIsActiveSystemHotPatch @ 0x1408C75A0 (MiIsActiveSystemHotPatch.c)
 */
...
struct _EX_RUNDOWN_REF *MiLogHotPatchRundown()
{
  ...
  v67 = 0LL;
  if ( *(_QWORD *)&qword_140C4ECE0 && dword_140C4CAB0 )
  {
    ...
    while ( i )
    {
      if ( **(_DWORD **)&qword_140C4ECE0 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
      {
        v47 = *(_DWORD *)(i + 24);
        v135 = 4LL;
        v134 = &v47;
        ...
        v139 = 2LL;
        v141[1] = 0;
        tlgWriteEx_EtwWriteEx(v5, (unsigned __int8 *)&word_1400250BE, v4, 1u, v45, v46, 6u, &v133);
      }
      v6 = *(_QWORD ***)(i + 8);
      v7 = i;
      if ( v6 )
    ...
    while ( k )
    {
      ...
      while ( j )
      {
        if ( **(_DWORD **)&qword_140C4ECE0 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
        {
          ...
          v132 = 0;
          v131 = 4 * v15 + 8;
          tlgWriteEx_EtwWriteEx(v14, (unsigned __int8 *)&byte_14002505B, v13, 1u, v45, v46, 7u, &v121);
        }
        v16 = *(_QWORD ***)(j + 8);
        v17 = j;
        if ( v16 )
    ...
    while ( m )
    {
      if ( **(_DWORD **)&qword_140C4ECE0 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
      {
        ...
        v83 = 2LL;
        v85[1] = 0;
        tlgWriteEx_EtwWriteEx(v25, (unsigned __int8 *)&byte_140024FC5, v24, 1u, v45, v46, 9u, &v71);
      }
      v26 = *(_QWORD ***)(m + 8);
      v27 = m;
      if ( v26 )
    ...
    for ( n = (PVOID *)PsLoadedModuleList; n != &PsLoadedModuleList; n = (PVOID *)*n )
    {
      if ( MiIsActiveSystemHotPatch((__int64)n)
        && **(_DWORD **)&qword_140C4ECE0 > 5u
        && tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
      {
        v56 = *(_DWORD *)(v31 + 120);
        v110 = 4LL;
        v109 = &v56;
        ...
        v118 = 2LL;
        v120[1] = 0;
        tlgWriteEx_EtwWriteEx(v32, (unsigned __int8 *)&byte_140024F4D, v30, 1u, v45, v46, 8u, &v108);
      }
    }
...
LABEL_92:
    ...
    KiStackAttachProcess((_KPROCESS *)v44, 0LL, (__int64)v70);
...
LABEL_91:
      ...
      ExReleaseRundownProtection_0((PEX_RUNDOWN_REF)(v44 + 1112));
      goto LABEL_92;
    }
...
LABEL_88:
    ...
    while ( jj )
    {
      if ( *(_DWORD *)(jj + 88) )
      {
        v38 = *(_QWORD *)&qword_140C4ECE0;
        if ( **(_DWORD **)&qword_140C4ECE0 > 5u )
        {
          if ( tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
          {
            ...
            v105 = 4LL;
            v107 = 4LL;
            tlgWriteEx_EtwWriteEx(v38, (unsigned __int8 *)&byte_140025111, v40, 1u, v45, v46, 0xDu, &v86);
          }
        }
      }
      v41 = *(_QWORD ***)(jj + 8);
