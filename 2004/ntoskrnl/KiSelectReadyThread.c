/*
 * XREFs of KiSelectReadyThread @ 0x14020D530
 * Callers:
...
__int64 __fastcall KiSelectReadyThread(signed int a1, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v2 )
    {
      ...
      v11 = v38;
      if ( v13 > v38 || v13 == v38 && !_bittest((const signed __int32 *)(a2 + 31772), v38) )
      {
...
LABEL_18:
    ...
    if ( v11 >= a1 )
    {
      v9 = *(_QWORD *)(a2 + 16 * (v11 + 1992LL)) - 216LL;
