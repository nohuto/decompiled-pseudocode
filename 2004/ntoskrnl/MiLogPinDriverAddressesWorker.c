/*
 * XREFs of MiLogPinDriverAddressesWorker @ 0x1407A21E0
 * Callers:
 *     <none>
 * Callees:
 *     _tlgKeywordOn @ 0x14026C5B4 (_tlgKeywordOn.c)
 *     _tlgWriteAgg @ 0x1403735C4 (_tlgWriteAgg.c)
 *     RtlInterlockedClearBitRun @ 0x1403BC8F0 (RtlInterlockedClearBitRun.c)
...
char MiLogPinDriverAddressesWorker()
{
  ...
  do
  {
    ...
    if ( (v2 & 1) != 0 )
    {
      ...
      RtlInterlockedClearBitRun((__int64)&dword_140C29E60, v0, 1u);
    ...
    for ( i = 0; i < 2; ++i )
    {
      for ( j = 0; j < 2; ++j )
      {
        ...
        if ( v7 != *v4 )
        {
          ...
          {
            LOBYTE(v2) = tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 0x400000000000LL);
            if ( (_BYTE)v2 )
            {
              v20 = 8LL;
              v13 = v3;
              ...
              v25 = &v15;
              v27 = &v17;
              LOBYTE(v2) = tlgWriteAgg(v10, (unsigned __int8 *)&dword_140025954, v8, 7u, &v18);
            }
          }
          *v4 = v7;
        }
