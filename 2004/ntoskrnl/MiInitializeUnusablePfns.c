/*
 * XREFs of MiInitializeUnusablePfns @ 0x1403A86F0
 * Callers:
        ...
        char a7)
{
  ...
  __m128i v39; // xmm1
  __m128i v40; // xmm2
  __m128i v41; // [rsp+30h] [rbp-30h] BYREF
  __m128i v42; // [rsp+40h] [rbp-20h] BYREF
  __m128i v43; // [rsp+50h] [rbp-10h] BYREF
  int v44; // [rsp+A0h] [rbp+40h] BYREF
  ...
  MiCreatePfnTemplate(1LL, &v41);
  LOBYTE(v16) = 6;
  v46 = 6;
  if ( v7 < 0 )
  {
    v43.m128i_i64[1] = v43.m128i_i64[1] & 0x8FFFFFFFFFFFFFFFuLL | 0x3000000000000000LL;
    _InterlockedExchangeAdd64(&qword_140C4DE00, a2);
    goto LABEL_13;
  }
  if ( (v7 & 0x40) != 0 )
  {
    v41.m128i_i64[1] = 0xFFFFF68000000000uLL;
    goto LABEL_13;
  }
  if ( (v7 & 2) != 0 )
  {
    ...
    {
      v43.m128i_i16[0] = 1;
      v42.m128i_i64[1] = v42.m128i_i64[1] & 0xC000000000000000uLL | 1;
      goto LABEL_13;
    }
    v16 = 2;
  }
  ...
  v46 = v16;
LABEL_13:
  v43.m128i_i8[2] = v16 | v43.m128i_i8[2] & 0xF8;
  result = 0x1FF8000000000LL;
  v43.m128i_i64[1] ^= (v43.m128i_i64[1] ^ (v15 << 39)) & 0x1FF8000000000LL;
  if ( (v7 & 0xC0) != 0 )
  {
    v42.m128i_i64[1] = v42.m128i_i64[1] & 0xC000000000000000uLL | 1;
    v42.m128i_i64[0] = MiSwizzleInvalidPte(128LL);
    v43.m128i_i64[1] = v17 & 0xFFFFFFF000000000uLL | 0xFFFFFFFFDLL;
    MiSetPageTablePfnBuddy((__int64)&v41, (__int64)KeGetCurrentThread()->ApcState.Process, 1);
    v42.m128i_i64[1] |= 0x4000000000000000uLL;
    v43.m128i_i16[0] = 2;
    result = _InterlockedExchangeAdd64(&qword_140C4EDB8, a2);
  }
  if ( (v7 & 2) != 0 )
  {
    ...
    v42.m128i_i64[0] = v19;
    v21 = (v18 >> 1) & 0x1F;
    v43.m128i_i64[1] = v22 | 0x8000000000000000uLL;
    ContainingPageTable = MiGetContainingPageTable(a6);
    v25 = 48 * ContainingPageTable - 0x58000000000LL;
    v43.m128i_i64[1] = v26 ^ (ContainingPageTable ^ v26) & 0xFFFFFFFFFLL;
    if ( v46 == 6 )
      ValidPte = MiMakeValidPte((unsigned __int64)v20, v13, v21, v24);
    else
      ValidPte = MiMakeTransitionPte(v13, v21);
    for ( i = ValidPte; v9 != v12; i ^= (i ^ (i + 4096)) & 0xFFFFFFFFF000LL )
    {
      v32 = v42;
      v41.m128i_i64[1] = (__int64)v20;
      *v9 = v41;
      v33 = v43;
      v9[1] = v32;
      v9[2] = v33;
      v34 = MiPteInShadowRange((unsigned __int64)v20);
      if ( (i & 1) == 0 )
      {
        v28 = 0LL;
        if ( v34 )
          v28 = (unsigned int)MiPteHasShadow() != 0;
        *v20 = i;
        if ( !(_DWORD)v28 )
          goto LABEL_34;
        v28 = i;
LABEL_33:
        MiWritePteShadow((__int64)v20, v28, v29);
        goto LABEL_34;
      }
      v29 = 0LL;
      v28 = i;
...
LABEL_34:
    ...
    {
      do
        KeYieldProcessorEx(&v44, v28, v29, v30);
      while ( *(__int64 *)(v25 + 24) < 0 );
    }
    result = 0x7FFFFFFFFFFFFFFFLL;
    *(_QWORD *)(v25 + 24) ^= (*(_QWORD *)(v25 + 24) ^ (*(_QWORD *)(v25 + 24) + v45)) & 0x3FFFFFFFFFFFFFFFLL;
  ...
  else
  {
    if ( v9 != v12 )
    {
      v35 = _mm_loadu_si128(&v43);
      v36 = _mm_loadu_si128(&v42);
      v37 = _mm_loadu_si128(&v41);
      do
      {
        _mm_stream_si128(v9, v37);
        _mm_stream_si128(v9 + 1, v36);
        _mm_stream_si128(v9 + 2, v35);
        v9 += 3;
      }
      while ( v9 != v12 );
    }
