 ...
 *     MmGetPagedPoolCommitPointer @ 0x140360F98 (MmGetPagedPoolCommitPointer.c)
  ...
  else
  {
    ...
    if ( !KdpDebuggerDataListHead )
    {
      *((_QWORD *)&KdpContext + 1) = KdDebugDevice;
      ...
      qword_140C40618 = (__int64)&KdpPowerListHead;
      KdpPowerListHead = (__int64)&KdpPowerListHead;
      qword_140C40628 = (__int64)&KdpDebuggerDataListHead;
