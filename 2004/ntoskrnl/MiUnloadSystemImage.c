/*
 * XREFs of MiUnloadSystemImage @ 0x1406A8E58
 * Callers:
 ...
 *     MiVaToSoftwareWsle @ 0x140556FD8 (MiVaToSoftwareWsle.c)
...
void __fastcall MiUnloadSystemImage(__int64 BugCheckParameter2, char a2)
{
  ...
  if ( (unsigned int)MiGetSystemRegionType((unsigned __int64)v5) == 1 )
  {
    ...
    if ( v12 )
    {
      v14 = (dword_140C4CAB0 & 0xFFF) != 0;
      if ( v14 + ((unsigned int)dword_140C4CAB0 >> 12) )
        MiUnmapPatchTable(PteAddress + 8 * (v41 - (v14 + ((unsigned int)dword_140C4CAB0 >> 12))));
  ...
  *(_QWORD *)(BugCheckParameter2 + 136) = 1LL;
  ...
  qword_140C4CB20 = BugCheckParameter2;
  ...
  qword_140C4CB20 = 0LL;
  _InterlockedExchangeAdd((_DWORD *)&xmmword_140C4CB48 + 3, v27 - v26);
  v28 = Object;
  if ( !Object )
  {
    MiReleasePrivilegedPtes(PteAddress, (unsigned int)v41);
