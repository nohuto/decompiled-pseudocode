/*
 * XREFs of KiInsertQueueDpc @ 0x140214C20
 * Callers:
 ...
 *     PoExecutePerfCheck @ 0x14021CB40 (PoExecutePerfCheck.c)
 ...
 *     KiForegroundTimerCallback @ 0x14034E400 (KiForegroundTimerCallback.c)
 ...
 *     ExpTimeRefreshCallback @ 0x140360C80 (ExpTimeRefreshCallback.c)
 ...
 *     KiEpfCompletionIsr @ 0x14051ECB0 (KiEpfCompletionIsr.c)
 *     PpmHeteroDispatchHgsInterrupt @ 0x140572690 (PpmHeteroDispatchHgsInterrupt.c)
 *     ExpSvmFaultRoutine @ 0x1405B3D60 (ExpSvmFaultRoutine.c)
            ...
            if ( CurrentPrcb->SchedulerAssist )
            {
              if ( KiVpThreadSystemWorkPriority >= 8 )
              {
                  ...
                  || (v40 & 0x40000) != 0 && (unsigned __int8)v40 < KiVpThreadSystemWorkPriority )
                {
                  ...
                  if ( v41 )
                    LODWORD(v43) = (unsigned __int8)byte_140D006C1[2 * (unsigned int)v43] | ((unsigned __int8)HvlpVirtualProcessorMapping[2 * v43] << 6);
                  v42[2] = v43;
