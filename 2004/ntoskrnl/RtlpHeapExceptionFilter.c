/*
 * XREFs of RtlpHeapExceptionFilter @ 0x14058DF68
 * Callers:
...
__int64 __fastcall RtlpHeapExceptionFilter(int a1, __int64 a2)
{
  ...
  if ( a1 == -1073741571 || a1 == -1073741420 || a1 == -1073741801 )
    return 0LL;
  v2 = *(_OWORD **)a2;
  unk_140C11900 = *(_OWORD *)*(_QWORD *)a2;
  *((_OWORD *)&unk_140C11900 + 1) = v2[1];
  *((_OWORD *)&unk_140C11900 + 2) = v2[2];
  *((_OWORD *)&unk_140C11900 + 3) = v2[3];
  *((_OWORD *)&unk_140C11900 + 4) = v2[4];
  *((_OWORD *)&unk_140C11900 + 5) = v2[5];
  *((_OWORD *)&unk_140C11900 + 6) = v2[6];
  *((_OWORD *)&unk_140C11900 + 7) = v2[7];
  *((_OWORD *)&unk_140C11900 + 8) = v2[8];
  *((_QWORD *)&unk_140C11900 + 18) = *((_QWORD *)v2 + 18);
  v3 = &unk_140C119A0;
  v4 = *(_OWORD **)(a2 + 8);
  v5 = 9LL;
  do
