/*
 * XREFs of PopNetGetNextDueRefreshTime @ 0x1408EE9A4
 * Callers:
...
LARGE_INTEGER PopNetGetNextDueRefreshTime()
{
  ...
  if ( qword_140C22DA8
    && MEMORY[0xFFFFF78000000014] < qword_140C22DA8
    && qword_140C22DA8 - MEMORY[0xFFFFF78000000014] >= 1200000000 )
  {
    return (LARGE_INTEGER)(qword_140C22DA8 - 1200000000);
  }
  else
  {
