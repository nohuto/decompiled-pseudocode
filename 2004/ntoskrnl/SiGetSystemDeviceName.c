/*
 * XREFs of SiGetSystemDeviceName @ 0x1407039C8
 * Callers:
 *     SyspartDirectGetSystemPartition @ 0x1407039A0 (SyspartDirectGetSystemPartition.c)
 *     SyspartDirectGetSystemDisk @ 0x140769850 (SyspartDirectGetSystemDisk.c)
 *     SyspartGetFirmwarePartition @ 0x140773C18 (SyspartGetFirmwarePartition.c)
 *     SyspartDirectGetFirmwareSystemPartition @ 0x14077C5D0 (SyspartDirectGetFirmwareSystemPartition.c)
