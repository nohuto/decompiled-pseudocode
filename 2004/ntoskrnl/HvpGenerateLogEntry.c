/*
 * XREFs of HvpGenerateLogEntry @ 0x14063C098
 * Callers:
 *     HvStoreModifiedData @ 0x14063B818 (HvStoreModifiedData.c)
 * Callees:
 *     HvpGenerateLogEntryMetadata @ 0x140271964 (HvpGenerateLogEntryMetadata.c)
  ...
  if ( PoolWithTag )
  {
    ...
    else
    {
      ...
      HvpGenerateLogEntryMetadata(
        ...
        (__int64)PoolWithTag,
        SHIDWORD(v23));
      HvpGenerateLogEntryDirtyData(BugCheckParameter2, (int)v14, v16, (__int64)&v26, (__int64)&v23, v22);
