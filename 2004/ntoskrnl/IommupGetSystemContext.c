/*
 * XREFs of IommupGetSystemContext @ 0x1403C8A04
 * Callers:
 *     IommuGetLibraryContext @ 0x1404D3E70 (IommuGetLibraryContext.c)
 *     IommuGetConfiguration @ 0x140A6C5C0 (IommuGetConfiguration.c)
 *     IommuHvGetConfiguration @ 0x140A8ABA0 (IommuHvGetConfiguration.c)
 * Callees:
