/*
 * XREFs of SLUpdateLicenseDataInternal @ 0x14094AD00
 * Callers:
 ...
 *     ExpLicUpdateChecksum @ 0x1405AD8C8 (ExpLicUpdateChecksum.c)
 ...
 *     ExpReducedLicenseData @ 0x1407116C0 (ExpReducedLicenseData.c)
...
LABEL_146:
  ...
  *(_OWORD *)MappedBase = *(_OWORD *)a3;
  ...
  v49 = sub_140794F2C((__int64)v24, 1, 0LL, 0, (unsigned int *)&NumOfElements);
  if ( v49 == -1073741789 )
  {
    ...
    v49 = sub_140794F2C((__int64)MappedBase, 0, PoolWithTag, NumOfElements, 0LL);
    if ( v49 >= 0 )
      qsort(v7, v28, 0x10uLL, (int (__cdecl *)(const void *, const void *))sub_14079E020);
  }
  else
  {
    v7 = 0LL;
  ...
  if ( !v60 )
  {
    ...
    while ( v30 < (unsigned int)NumOfElements )
    {
      ...
      v33 = sub_14079E020(&v53[2 * v30], (_QWORD *)(16 * v31 + a1 + 24));
      v72 = v33;
      v34 = v53[2 * v30 + 1];
      v75 = v34;
