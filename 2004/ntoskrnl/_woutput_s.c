/*
 * XREFs of _woutput_s @ 0x1403D5BD4
 * Callers:
 *     _swoutput_s @ 0x1403D5AA4 (_swoutput_s.c)
 * Callees:
 *     xHalTimerWatchdogStop @ 0x140398100 (xHalTimerWatchdogStop.c)
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     _safecrt_mbtowc @ 0x1403CF350 (_safecrt_mbtowc.c)
 *     write_char_1 @ 0x1403D6500 (write_char_1.c)
 *     write_string_2 @ 0x1403D6554 (write_string_2.c)
...
__int64 __fastcall woutput_s(__int64 a1, unsigned __int16 *a2, int *a3)
{
  ...
  wchar_t v56[2]; // [rsp+40h] [rbp-C0h] BYREF
  ...
  do
  {
    ...
    v13 = *((unsigned __int8 *)_lookuptable_s + (unsigned int)(v14 + v13 + 8 * v14)) >> 4;
    v55 = v13;
    switch ( v13 )
    {
      case 8:
...
LABEL_45:
              ...
              if ( (v5 & 0x20) != 0 )
              {
                SrcCh[0] = v19;
                SrcCh[1] = v9;
                v20 = safecrt_mbtowc(DstCh, SrcCh, _mb_cur_max);
                v9 = 0;
                if ( v20 < 0 )
                  v63 = 1;
              }
