/*
 * XREFs of ViDeadlockAnalyze @ 0x1409DBB84
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x1409DB7F4 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x1409DBB84 (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x1409DBE6C (ViDeadlockCertify.c)
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)ViDeadlockGlobals + 4107) = a1;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(0xC4u, 0x1001uLL, a1, a2, 0LL, byte_140C12D90);
      return 0LL;
    }
    v8 = 0;
    goto LABEL_30;
