/*
 * XREFs of MiAllocatePartitionPhysicalPages @ 0x1408D7378
 * Callers:
 ...
 *     MiHugeRangeIsZeroed @ 0x14052DEA8 (MiHugeRangeIsZeroed.c)
 *     MiInsertHugeRangeInList @ 0x14052E138 (MiInsertHugeRangeInList.c)
 *     MiAddMdlToPartitionTree @ 0x14055BBE0 (MiAddMdlToPartitionTree.c)
        ...
        unsigned int a6)
{
  ...
  *(_OWORD *)&v54.m256i_u64[2] = 0LL;
  ...
  while ( 1 )
  {
    ...
    {
      LargeNodePage = MiFindLargeNodePage((__int64)v7, v8, (unsigned int *)&v55, 1, v14, 1, 1u);
      if ( !LargeNodePage )
      {
        v9 = v57;
        goto LABEL_39;
      ...
      if ( (*(_DWORD *)(LargeNodePage + 16) & 0x3E0LL) != 0 )
      {
        if ( (v14 & 1) != 0 )
          goto LABEL_30;
        MiZeroLargePage(LargeNodePage, v55, 1LL);
      }
      v19 = 1;
    }
LABEL_30:
    ...
    if ( v46 == &MiSystemPartition && !v58 )
      _InterlockedExchangeAdd64(&qword_140C4EDB8, v27);
    v9 = v57;
    v11 += v27;
    if ( v11 == v57 )
      goto LABEL_48;
