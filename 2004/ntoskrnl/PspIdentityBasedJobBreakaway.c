/*
 * XREFs of PspIdentityBasedJobBreakaway @ 0x1405CFE44
 * Callers:
...
__int64 __fastcall PspIdentityBasedJobBreakaway(__int64 a1, __int64 a2, int *a3)
{
  ...
  *a3 = 0;
  ...
  String2 = 0LL;
  v22 = 0LL;
  v6 = RtlQueryPackageIdentityEx(a1, (__int64)SourceString, (__int64)&v17, (__int64)v24, (__int64)&v19, v12, &v14);
  v7 = v6;
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( !v9 )
    {
      v10 = RtlQueryPackageIdentityEx(a2, (__int64)v27, (__int64)&v16, (__int64)v25, (__int64)&v18, v13, &v15);
      v7 = v10;
