/*
 * XREFs of IopCreateArcName @ 0x14076DB08
 * Callers:
 *     IoCreateArcName @ 0x14076DAF0 (IoCreateArcName.c)
 ...
 *     IopVerifyDiskSignature @ 0x1407C1B08 (IopVerifyDiskSignature.c)
...
LABEL_34:
        ...
        v36 = 0x8000LL;
        Pool_0 = IopVerifierExAllocatePool_0(NonPagedPoolNxCacheAligned, v11);
        v3 = Pool_0;
        if ( Pool_0 )
        {
