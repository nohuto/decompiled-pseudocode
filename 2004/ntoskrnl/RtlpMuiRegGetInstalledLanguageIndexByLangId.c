/*
 * XREFs of RtlpMuiRegGetInstalledLanguageIndexByLangId @ 0x14078AA58
 * Callers:
 ...
 *     RtlpMuiRegGetInstalledLanguageIndexByName @ 0x14097E09C (RtlpMuiRegGetInstalledLanguageIndexByName.c)
