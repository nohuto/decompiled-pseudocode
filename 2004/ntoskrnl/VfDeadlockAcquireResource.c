/*
 * XREFs of VfDeadlockAcquireResource @ 0x1409DA5B8
 * Callers:
 ...
 *     VerifierKeAcquireInStackQueuedSpinLockForDpc @ 0x1409D7710 (VerifierKeAcquireInStackQueuedSpinLockForDpc.c)
 *     VerifierKeAcquireInStackQueuedSpinLockRaiseToSynch @ 0x1409D7810 (VerifierKeAcquireInStackQueuedSpinLockRaiseToSynch.c)
 *     VerifierKeAcquireSpinLockAtDpcLevel @ 0x1409D7980 (VerifierKeAcquireSpinLockAtDpcLevel.c)
 *     VerifierKeAcquireSpinLockRaiseToDpc @ 0x1409D79F0 (VerifierKeAcquireSpinLockRaiseToDpc.c)
 *     VerifierKeInitializeMutant @ 0x1409D7BC0 (VerifierKeInitializeMutant.c)
 *     VerifierKeTryToAcquireSpinLockAtDpcLevel @ 0x1409D8850 (VerifierKeTryToAcquireSpinLockAtDpcLevel.c)
 *     ViKeObjectAcquired @ 0x1409D91F4 (ViKeObjectAcquired.c)
 ...
 *     VerifierExAcquireFastMutexUnsafe @ 0x1409E1830 (VerifierExAcquireFastMutexUnsafe.c)
 ...
 *     ViDeadlockCheckDuplicatesAmongChildren @ 0x1409DC090 (ViDeadlockCheckDuplicatesAmongChildren.c)
 *     ViDeadlockCheckDuplicatesAmongRoots @ 0x1409DC110 (ViDeadlockCheckDuplicatesAmongRoots.c)
 ...
 *     ViDeadlockSimilarNode @ 0x1409DCE58 (ViDeadlockSimilarNode.c)
 *     ViDeadlockUpdateChildrenCount @ 0x1409DCF04 (ViDeadlockUpdateChildrenCount.c)
    ...
    if ( *v19 != (_DWORD)v6 )
    {
      if ( ((unsigned int)(v6 - 3) > 1 || (unsigned int)(v21 - 3) > 1) && (v21 != 7 || (unsigned int)(v6 - 5) > 1) )
      {
        ViDeadlockPreprocessOptions(
          ...
          (const void *)0x1008);
        VfReportIssueWithOptions(0xC4u, 0x1008uLL, a1, *v19, v6, byte_140C12D84);
        goto LABEL_35;
      }
      *v19 = v6;
    }
    ...
    if ( v22 )
    {
      if ( v24 > 1u )
      {
        ...
        ViDeadlockPreprocessOptions(
          ...
          (const void *)0x1000);
        VfReportIssueWithOptions(0xC4u, 0x1000uLL, a1, (ULONG_PTR)v19, v10, &dword_140C12D88);
LABEL_35:
        v15 = v46;
        v16 = 0;
        goto LABEL_52;
