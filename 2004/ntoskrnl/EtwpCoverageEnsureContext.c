/*
 * XREFs of EtwpCoverageEnsureContext @ 0x1407B754C
 * Callers:
          ...
          if ( v9 >= 0 )
          {
            ...
            if ( v9 >= 0 )
            {
              ...
              *((_DWORD *)v2 + 8) = 3 * ((unsigned int)(v10 - 52) >> 4);
              ...
              if ( (unsigned int)dword_140C04734 < MEMORY[0xFFFFF7800000037C] )
              {
                if ( !dword_140C04730 )
                {
                  v24 = 0;
                  dword_140C04730 = TelemetryCoverageStringHashInternal(off_140C04728, &v24);
                }
                EtwTelemetryCoverageReport(&off_140C04728);
              }
              if ( EtwpCoverageCoreTracingEnabled && (unsigned int)dword_140C0EF84 < MEMORY[0xFFFFF7800000037C] )
              {
                ...
                EtwTelemetryCoverageReport(&off_140C0EF78);
              }
              v9 = 0;
            }
          }
