/*
 * XREFs of HvlGetStatsUpdateCounter @ 0x1404F2980
 * Callers:
...
char __fastcall HvlGetStatsUpdateCounter(unsigned int a1)
{
  ...
  if ( LpcbByLpIndex )
  {
    ...
    LpcbByLpIndex = *(int **)(v4 + 8LL * (unsigned int)dword_140CED1C8);
    v5 = (unsigned int)dword_140CED1CC;
    *v2 = *(_QWORD *)(v4 + 8LL * DWORD2(xmmword_140CED1A0)) & 1;
