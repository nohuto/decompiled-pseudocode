/*
 * XREFs of HalpPciGetHpetInterruptSource @ 0x140A8B5B0
 * Callers:
 *     HalpTimerRegister @ 0x1403AF660 (HalpTimerRegister.c)
 * Callees:
 *     HalSocGetAcpiTable @ 0x1403AFBA4 (HalSocGetAcpiTable.c)
 *     HalpPciGetHpetInterruptSourceAmd @ 0x140A8B67C (HalpPciGetHpetInterruptSourceAmd.c)
 *     HalpPciGetHpetInterruptSourceIntel @ 0x140A8B768 (HalpPciGetHpetInterruptSourceIntel.c)
 */
