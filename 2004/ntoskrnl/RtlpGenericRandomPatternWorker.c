/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x14058B7CC
 * Callers:
 *     RtlScrubMemory @ 0x14058B128 (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x14058B25C (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x14058BCB8 (RtlpTestMemoryRandomUp.c)
 */
