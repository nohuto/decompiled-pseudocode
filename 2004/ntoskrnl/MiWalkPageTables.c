/*
 * XREFs of MiWalkPageTables @ 0x140204BE0
 * Callers:
 ...
 * Callees:
 *     MiInitializeWalkBounds @ 0x140205030 (MiInitializeWalkBounds.c)
...
__int64 __fastcall MiWalkPageTables(__int16 *a1)
{
  ...
  if ( !*((_BYTE *)a1 + 5) )
    *((_BYTE *)a1 + 5) = 15;
  v2 = *((_QWORD *)a1 + 7);
  *((_QWORD *)a1 + 9) = *(_QWORD *)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(*((_QWORD *)a1 + 3) + 174LL));
  if ( v2 )
  {
    if ( v2 == 0xFFFFF6FB7DBEDF68uLL )
    {
      v2 = 0xFFFFF6FB7DBEDF70uLL;
      *((_QWORD *)a1 + 7) = 0xFFFFF6FB7DBEDF70uLL;
    }
    v3 = -1;
  ...
  do
  {
    ...
    do
    {
      ...
      *((_QWORD *)v1 + 16) = v24;
      *((_QWORD *)v1 + 17) = v6 + ((v23 >> 9) & 0x7FFFFFFFF8LL);
      v25 = *v1;
      *((_QWORD *)v1 + 8) = v7;
      if ( (v25 & 4) != 0 )
      {
