/*
 * XREFs of SPCallServerHandleQueryPolicy @ 0x14066E740
 * Callers:
...
LABEL_118:
  ...
  v101 = ((__int64 (__fastcall *)(UNICODE_STRING *, char *, _QWORD, _QWORD, unsigned int *))qword_140D2D4B0)(
           &DestinationString,
...
LABEL_121:
  ...
  v57 = ((__int64 (__fastcall *)(UNICODE_STRING *, char *, PVOID, _QWORD, unsigned int *))qword_140D2D4B0)(
          &DestinationString,
          (char *)&NumberOfBytes + 4,
          v7,
          v6,
...
LABEL_141:
  ...
  {
    v125 = 0;
    if ( DestinationString.Length == stru_140D2D240.Length
      && !memcmp(DestinationString.Buffer, stru_140D2D240.Buffer, stru_140D2D240.Length) )
    {
    ...
    v75 = ((__int64 (__fastcall *)(UNICODE_STRING *, int *, int *, __int64, int *))qword_140D2D4B0)(
            &v143,
            &v128,
            &v129,
            4LL,
...
LABEL_156:
    ...
    {
      v103 = KeWaitForSingleObject(&stru_140C13CA0, UserRequest, 1, 0, &Timeout);
      if ( v103 >= 0 && v103 != 192 && v103 != 258 )
      {
        ...
        if ( !dword_140D2D0BC )
        {
          ...
          if ( v113 < 0 )
          {
            v113 = ((__int64 (__fastcall *)(wchar_t *, int *, int *, __int64, __int64 *, int, int))qword_140D2D4B0)(
                     aBd,
                     &v130,
                     &v124,
                     4LL,
        ...
        v145 = 0;
        v132 = 0;
        if ( (int)((__int64 (__fastcall *)(wchar_t *, int *, __int64 *, __int64, int *))qword_140D2D4B0)(
                    aLn,
                    &v131,
                    &v144,
                    12LL,
