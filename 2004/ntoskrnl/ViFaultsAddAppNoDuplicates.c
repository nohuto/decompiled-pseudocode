/*
 * XREFs of ViFaultsAddAppNoDuplicates @ 0x1409D9CC4
 * Callers:
...
__int64 __fastcall ViFaultsAddAppNoDuplicates(void *Src, __int64 a2)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *(unsigned __int16 *)((char *)&v6[2].Length + v2) = 0;
    ...
    {
      v8 = (UNICODE_STRING **)qword_140C1CBD8;
      if ( *(PVOID **)qword_140C1CBD8 != &ViFaultApplicationsList )
        __fastfail(3u);
      *(_QWORD *)&v6->Length = &ViFaultApplicationsList;
      v6->Buffer = (wchar_t *)v8;
      *v8 = v6;
      qword_140C1CBD8 = (__int64)v6;
    }
