/*
 * XREFs of MiAddPhysicalMemoryChunks @ 0x1408C1E2C
 * Callers:
 *     MiActOnPartitionNodePages @ 0x14055B400 (MiActOnPartitionNodePages.c)
 *     MmAddPhysicalMemory @ 0x1408C2D20 (MmAddPhysicalMemory.c)
 ...
 *     MiNodeLargeFreeZeroPages2 @ 0x1405518C0 (MiNodeLargeFreeZeroPages2.c)
...
__int64 __fastcall MiAddPhysicalMemoryChunks(ULONG_PTR *a1, unsigned __int64 *a2, _QWORD *a3, int a4)
{
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      v31 = qword_140C50B90 + 4544LL * ((unsigned int)MiGetClosestImplicitNode(v15 + 1) - 1);
      if ( v11 < 0 )
      {
        v14 = v32;
        if ( v32 > 0x200 )
