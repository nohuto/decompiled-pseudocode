/*
 * XREFs of RtlpDynamicLookasideRebalance @ 0x140325B90
 * Callers:
 *     ExpScanSystemLookasideList @ 0x140325940 (ExpScanSystemLookasideList.c)
 * Callees:
 *     RtlpLookasideAdjustDepth @ 0x140325CD8 (RtlpLookasideAdjustDepth.c)
