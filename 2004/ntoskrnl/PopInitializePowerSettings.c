/*
 * XREFs of PopInitializePowerSettings @ 0x140A6EBAC
 * Callers:
...
const WNF_STATE_NAME *PopInitializePowerSettings()
{
  ...
  qword_140C23D28 = (__int64)&PopRegisteredPowerSettingCallbacks;
  PopRegisteredPowerSettingCallbacks = (__int64)&PopRegisteredPowerSettingCallbacks;
  qword_140C23D08 = (__int64)&PopPowerSettings;
