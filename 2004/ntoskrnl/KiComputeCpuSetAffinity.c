/*
 * XREFs of KiComputeCpuSetAffinity @ 0x14030BEF8
 * Callers:
...
__int64 __fastcall KiComputeCpuSetAffinity(__int64 a1)
{
  ...
  v7 = KiSystemAllowedCpuSets[2 * v3] | KiSystemAllowedCpuSets[2 * v3
                                                             + (((unsigned __int64)*(unsigned int *)(a1 + 1300) >> 11) & 1)];
  if ( (*(_DWORD *)(v1 + 1120) & 0x8000000) != 0 && (v8 = v4[v3]) != 0 )
  {
    v7 = v4[v3];
    v6 = 0;
  }
