/*
 * XREFs of EtwpCovSampCaptureSample @ 0x1405A9C78
 * Callers:
 *     EtwpCovSampProfileInterrupt @ 0x1405AA060 (EtwpCovSampProfileInterrupt.c)
 *     EtwpCoverageSamplerContextSwap @ 0x1405AA75C (EtwpCoverageSamplerContextSwap.c)
 *     EtwpCoverageSamplerPageFault @ 0x1405AA924 (EtwpCoverageSamplerPageFault.c)
 *     EtwpCoverageSamplerReadyThread @ 0x1405AAB34 (EtwpCoverageSamplerReadyThread.c)
 * Callees:
 ...
 *     EtwpCovSampCaptureUserAddresses @ 0x14093F42C (EtwpCovSampCaptureUserAddresses.c)
 */
...
__int64 __fastcall EtwpCovSampCaptureSample(unsigned __int64 a1, unsigned int a2)
{
  ...
  v5 = qword_140C196E8;
  v12 = 0;
  result = (*(_QWORD *)(qword_140C196E8 + 8) >> 4) & 0x1FFLL;
  v8 = ((unsigned int)*(_QWORD *)(qword_140C196E8 + 8) >> 13) & 0x3FFFF;
  ...
  else
  {
    ...
    {
      result = EtwpCovSampCaptureBufferGet(qword_140C196E8);
      v4 = result;
      if ( result )
      {
