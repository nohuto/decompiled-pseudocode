/*
 * XREFs of ExpSystemErrorHandler2 @ 0x1409B0190
 * Callers:
...
void __fastcall ExpSystemErrorHandler2(unsigned int a1, unsigned int a2, int a3, const void *a4, char a5)
{
  ...
  *(_OWORD *)BugCheckParameter2 = 0LL;
  ...
  if ( SystemDllInfo )
  {
    ...
    if ( (int)RtlFindMessage(v16, 0xBu, (_BYTE)NlsMbCodePageTag != 0 ? 0x409 : 0, a1, (unsigned __int16 **)&v31) < 0 )
    {
      v14 = "Unknown Hard Error";
    ...
    if ( (v31[2] & 1) != 0 )
    {
      RtlInitUnicodeString(&UnicodeString, (PCWSTR)v31 + 2);
...
LABEL_42:
  ...
  *(_QWORD *)&BugCheckParameter1[1] = "Unknown Hard Error";
  ...
  if ( RtlAnsiStringToUnicodeString(&UnicodeString, &SourceString, 1u) >= 0 )
  {
    v34.Length = RtlxUnicodeStringToOemSize(&UnicodeString);
    v34.MaximumLength = v34.Length;
    BugCheckParameter4 = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, v34.Length, 0x20727245u);
    v34.Buffer = BugCheckParameter4;
