/*
 * XREFs of ?SmStTrimWsStoreBatch@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAU1@PEAKPEAPEAXKKPEA_K@Z @ 0x1405948F4
 * Callers:
        ...
        _QWORD *a6)
{
  ...
  char *v32; // [rsp+30h] [rbp-20h] BYREF
        ...
        if ( (_DWORD)v7 )
        {
          ...
          do
          {
            ...
            if ( v23 < v24 )
            {
              ...
              while ( v23 < v24 );
              if ( v25 )
                ZwUnlockVirtualMemory(-1LL, (__int64)&v32);
              v22 = v38;
            }
            if ( !*v11 )
              break;
