/*
 * XREFs of MiInitNucleus @ 0x140A3D174
 * Callers:
 ...
 *     MiInitializeWsSwapping @ 0x140781558 (MiInitializeWsSwapping.c)
 ...
 *     MiMemoryLicense @ 0x140A62E5C (MiMemoryLicense.c)
...
char __fastcall MiInitNucleus(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( ((unsigned __int8)&stru_140C4E8C0 & 0xF) != 0 )
    goto LABEL_86;
  qword_140C4E8D0 = 0LL;
  stru_140C4E8C0 = 0LL;
  v12 = &unk_140C4F630;
  ...
  qword_140C4EAA0 = 0LL;
  qword_140C4EA58 = 0LL;
  qword_140C4EA68 = (__int64)&qword_140C4EA60;
  qword_140C4EA60 = (__int64)&qword_140C4EA60;
  xmmword_140C4EA48 = 0LL;
  ...
  {
    v17 = (char *)&unk_140C4DCA8;
    v47[0] = &unk_140C4DCA8;
  }
  qword_140C4DCC8 = v17;
  MiInitializeChannelRangesTemporary(v16, v15);
  MiMemoryLicense(BugCheckParameter2);
  qword_140D567F8 = KeQueryPerformanceCounter(0LL).QuadPart;
  MiRemoveLargeFreeLoaderDescriptors(BugCheckParameter2);
  qword_140D56800 = KeQueryPerformanceCounter(0LL).QuadPart;
  ...
  MiCreateResidentPfnTemplate((__int64)&xmmword_140C4E380);
  MiCreateResidentBasePfnTemplate((__int64)&xmmword_140C4E3B0);
  qword_140D56808 = KeQueryPerformanceCounter(0LL).QuadPart;
  if ( !(unsigned int)MiCreatePfnDatabase(BugCheckParameter2) )
  {
    byte_140C4E5FA = 6;
    return 0;
  }
  qword_140D56810 = KeQueryPerformanceCounter(0LL).QuadPart;
  MiInitializePfnsForValidMappings(BugCheckParameter2);
  qword_140D56818 = KeQueryPerformanceCounter(0LL).QuadPart;
  MiSwitchToPfns(BugCheckParameter2);
  qword_140D56820 = KeQueryPerformanceCounter(0LL).QuadPart;
  MxRelocatePageTables(BugCheckParameter2);
  qword_140D56828 = KeQueryPerformanceCounter(0LL).QuadPart;
  MiZeroBootMappings();
  MiInitializeDecayPfns();
  if ( ((unsigned __int8)&stru_140C4E810 & 0xF) != 0 )
LABEL_86:
  ...
  v20 = BYTE2(MiFlags);
  qword_140D56830 = KeQueryPerformanceCounter(0LL).QuadPart;
...
LABEL_85:
  ...
  v26 = MiReservePtes((__int64)&qword_140C4ED40, 1u, v24, v25);
  qword_140C4E688 = v26;
  v27 = (_QWORD *)v26;
  if ( !v26 )
  {
...
LABEL_58:
  *v27 = v28;
  ...
  qword_140D56838 = KeQueryPerformanceCounter(0LL).QuadPart;
  ...
  qword_140C50BA0 = (__int64)MiCreateNodeLists((__int64)&MiSystemPartition, (__int64)v35);
  if ( !qword_140C50BA0 )
  {
    byte_140C4E5FA = 13;
    return 0;
  ...
  if ( !(unsigned int)MiInitializeGapFrames(-1LL, &unk_140C4EBA8) )
    goto LABEL_85;
  qword_140D56840 = KeQueryPerformanceCounter(0LL).QuadPart;
  ...
  qword_140D56848 = KeQueryPerformanceCounter(0LL).QuadPart;
  MiMarkLargePageRanges();
  qword_140D56850 = KeQueryPerformanceCounter(0LL).QuadPart;
  MiInitializeWsSwapping(&MiSystemPartition);
  if ( qword_140C4DCC8 != &unk_140C4DCA8 )
  {
    v41 = 16 * (dword_140C4DC88 + 2);
    Pool = MiAllocatePool(64, v41, 0x20206D4Du);
    v43 = Pool;
    if ( Pool )
    {
      memmove(Pool, qword_140C4DCC8, v41);
      qword_140C4DCC8 = v43;
    }
  }
  if ( qword_140C4DCD0 )
  {
    v44 = 16 * (dword_140C4DC94 + 2);
    v45 = MiAllocatePool(64, v44, 0x20206D4Du);
    v46 = v45;
    if ( v45 )
    {
      memmove(v45, qword_140C4DCD0, v44);
      qword_140C4DCD0 = v46;
    }
  }
  ExInitializeNPagedLookasideListInternal((__int64)&stru_140C4E840, 0LL, 0LL, 512, 144, 1800170829, 0, 0);
  return 1;
}
