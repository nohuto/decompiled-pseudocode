/*
 * XREFs of ExpSvmReferenceAsid @ 0x1405B3DB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ExpSvmReferenceAsid(ULONG_PTR BugCheckParameter1)
{
  ...
  v2 = 0LL;
  v3 = (ULONG_PTR *)((char *)qword_140C16690 + 16 * (unsigned int)v1);
  if ( (unsigned int)v1 >= (unsigned int)dword_140C16684 )
  {
    BugCheckParameter4 = 0LL;
LABEL_14:
    if ( (unsigned int)v1 < (unsigned int)dword_140C16684 )
      v2 = *v3;
    KeBugCheckEx(0x158u, v1, (unsigned int)dword_140C16684, v2, BugCheckParameter4);
  }
  v4 = *v3;
  if ( !*v3 || (v5 = v3[1], v5 < 0) )
  {
