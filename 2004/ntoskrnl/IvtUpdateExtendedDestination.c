/*
 * XREFs of IvtUpdateExtendedDestination @ 0x1404DBFDC
 * Callers:
 *     IvtUpdateRemappingDestination @ 0x1404DC1C0 (IvtUpdateRemappingDestination.c)
 *     HsaUpdateRemappingDestination @ 0x1404DF650 (HsaUpdateRemappingDestination.c)
 * Callees:
 *     IvtUpdateSingleTargetExtendedDestination @ 0x1404DC460 (IvtUpdateSingleTargetExtendedDestination.c)
 */
