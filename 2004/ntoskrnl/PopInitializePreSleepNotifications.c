/*
 * XREFs of PopInitializePreSleepNotifications @ 0x1407C175C
 * Callers:
...
__int64 PopInitializePreSleepNotifications()
{
  ...
  dword_140C202C4 = v0;
  result = (unsigned int)_InterlockedExchange(&dword_140C20300, 0);
  qword_140C202F8 = 0LL;
  PopPreSleepNotifyWorkItem = 0LL;
  qword_140C202F0 = (__int64)PopPreSleepNotifyWorker;
  return result;
}
