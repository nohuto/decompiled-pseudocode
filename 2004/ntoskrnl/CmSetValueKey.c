/*
 * XREFs of CmSetValueKey @ 0x1405E3F50
 * Callers:
 ...
 *     CmpTryConvertKcbLockSharedToExclusive @ 0x1405E2C98 (CmpTryConvertKcbLockSharedToExclusive.c)
        ...
        char a7)
{
  ...
  while ( 1 )
  {
    ...
    {
      v14 = 1;
      CmpLockKcbStackTopExclusiveRestShared((__int64)&v69);
    }
    else
    {
      v14 = 0;
...
LABEL_28:
            ...
            if ( !v15 )
            {
              ...
              else
              {
                ...
                LODWORD(Size) = v60;
                started = CmpSetValueKeyExisting(*(_QWORD *)(v9 + 32), (unsigned int)v58, v36, v61, v72, Size, v24);
