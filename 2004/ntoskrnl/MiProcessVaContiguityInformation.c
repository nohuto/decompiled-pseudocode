/*
 * XREFs of MiProcessVaContiguityInformation @ 0x14054CE20
 * Callers:
 ...
 *     MiVadSupportsPhysicalContiguityQuery @ 0x1408CE1CC (MiVadSupportsPhysicalContiguityQuery.c)
 */
...
__int64 __fastcall MiProcessVaContiguityInformation(unsigned __int64 a1, __int64 a2)
{
  ...
  v31 = 0LL;
  v7 = 0;
  v8 = *(_QWORD *)(qword_140C4E448 + 8LL * *((unsigned __int16 *)v6 + 87));
