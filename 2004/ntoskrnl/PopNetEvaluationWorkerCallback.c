/*
 * XREFs of PopNetEvaluationWorkerCallback @ 0x1403C8040
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopNetEvaluateStateMask @ 0x1407BA80C (PopNetEvaluateStateMask.c)
 ...
 *     PopNetUpdateCsConsumptionFlags @ 0x1407BA9F8 (PopNetUpdateCsConsumptionFlags.c)
...
__int64 __fastcall PopNetEvaluationWorkerCallback(__int64 a1, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    v5 = 1;
    if ( PopNetResiliencyEngaged && qword_140C54200 )
    {
      LOBYTE(v8) = 1;
      v18 = 1;
...
LABEL_6:
    ...
    if ( v19 != v3 )
    {
      ...
      if ( PopCsResiliencyStats[0] && !dword_140C23DAC )
        dword_140C23DAC = v10;
  ...
  _InterlockedExchange(&dword_140C207C8, 0);
