/*
 * XREFs of IopConstructInMemoryDumpHeader @ 0x1404FE7B0
 * Callers:
...
__int64 IopConstructInMemoryDumpHeader()
{
  ...
  if ( (_DWORD)result != 1 )
  {
    dword_140C509F8 = 0;
    if ( dword_140C509C4
      && (result = qword_140C509E0 & 1, (v1 = *(_DWORD **)&InMemData[2 * result + 2]) != 0LL)
      && (v2 = *(_QWORD *)&InMemData[2 * (((_BYTE)qword_140C509E0 - 1) & 1) + 2]) != 0 )
    {
      IoFillDumpHeader((_NT_PRODUCT_TYPE *)(v2 + 24), 1, 332, 0LL, 0LL, 0LL, 0LL, (__int64)KeGetCurrentThread());
      *(_QWORD *)(v2 + 4040) = qword_140C509E8;
      ...
      *v1 = result;
      LODWORD(qword_140C509E0) = qword_140C509E0 + 1;
    }
    else
    {
      dword_140C509F8 = -1073741823;
    }
