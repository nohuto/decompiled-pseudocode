/*
 * XREFs of LocalConvertAclToString @ 0x140641F7C
 * Callers:
...
LABEL_37:
    ...
    v126 = v11;
    v34 = LookupSidInTable(0LL, Sid1, Str2, a9, (__int64)&v118);
    ...
    v39 = LocalConvertSidToStringSidW(Sid1, (wchar_t **)P + (unsigned int)v13);
    if ( v39 < 0 )
      break;
LABEL_48:
...
LABEL_67:
    ...
    v114 = v59;
    v114 = LocalGetAceCondition(v54, Sid1, &Src, &v114);
    AceCondition = v114;
    if ( v114 )
      goto LABEL_176;
    v60 = *((_DWORD *)v119 + v53);
