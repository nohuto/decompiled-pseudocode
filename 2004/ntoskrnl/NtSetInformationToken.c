/*
 * XREFs of NtSetInformationToken @ 0x1406B9BC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     SepRemoveAceFromTokenDefaultDacl @ 0x1403524B0 (SepRemoveAceFromTokenDefaultDacl.c)
 ...
 *     SepIdAssignableAsOwner @ 0x1406EDEBC (SepIdAssignableAsOwner.c)
        ...
        ULONG TokenInformationLength)
{
  ...
  KPROCESSOR_MODE v115; // [rsp+5Dh] [rbp-ABh]
              ...
              if ( !v20 )
              {
                ...
                if ( TokenInformation && TokenInformationLength >= 0x10 )
                {
                  ...
                  if ( v21 >= 0 )
                  {
                    ...
                    {
                      v22 = P;
                      v23 = (unsigned __int8)SepShouldSetDelinkFlags(*((_QWORD *)P + 1), *(_QWORD *)P) != 0;
                      ...
                      v27 = Token;
                      v113 = AuthzBasepSetSecurityAttributesToken(*((_QWORD *)Token + 97), v26, *(_QWORD *)P);
                      if ( v113 >= 0 && v23 )
                        v27[50] |= 0x20000u;
...
LABEL_150:
            ...
            else
            {
              ...
              v43 = SeSetMandatoryPolicyToken(v15, &v126);
            }
LABEL_50:
            v28 = v43;
            goto LABEL_42;
