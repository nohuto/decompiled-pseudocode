/*
 * XREFs of KiRaiseException @ 0x14051C9E0
 * Callers:
 ...
 *     KiSetupForInstrumentationReturn @ 0x14036A998 (KiSetupForInstrumentationReturn.c)
...
LABEL_18:
  ...
  {
    v10 = v36;
    result = RtlGetExtendedContextLength(v36, &v37);
    if ( (int)result >= 0 )
    {
      v11 = v37 + 15LL;
      if ( v11 <= v37 )
