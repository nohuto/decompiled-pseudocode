/*
 * XREFs of VrpPostOpenOrCreate @ 0x1405CB3C0
 * Callers:
 ...
 *     CmRetrieveExtraParameter @ 0x1405CC338 (CmRetrieveExtraParameter.c)
    ...
    *(_QWORD *)&v10->Length = 0LL;
    ...
    if ( v27 == 872 || v27 == 260 )
    {
      if ( (unsigned int)dword_140C02168 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C02168,
          (unsigned __int8 *)byte_14002331B,
          &ActivityId,
          0LL,
          5u,
          v44);
