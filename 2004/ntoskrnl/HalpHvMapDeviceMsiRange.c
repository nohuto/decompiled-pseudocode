/*
 * XREFs of HalpHvMapDeviceMsiRange @ 0x1409A4418
 * Callers:
 *     HalpInterruptRemap @ 0x1403761C0 (HalpInterruptRemap.c)
 * Callees:
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     _guard_dispatch_icall @ 0x1403FFC70 (_guard_dispatch_icall.c)
 *     HalpHvBuildDeviceId @ 0x1409A4298 (HalpHvBuildDeviceId.c)
 */
...
__int64 __fastcall HalpHvMapDeviceMsiRange(__int64 a1, __int64 a2, int *a3, char a4, __int64 a5, unsigned int a6)
{
  ...
  v15 = 0LL;
  v16 = a6;
  v8 = ((__int64 (__fastcall *)(__int64, __int64 *, __int64, __int128 *))qword_140C4A228)(v13, &v15, a5 + 24, &v14);
  if ( v8 >= 0 && a6 )
  {
    v9 = DWORD2(v14);
    v10 = a5 + 48;
