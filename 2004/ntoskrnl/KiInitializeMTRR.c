/*
 * XREFs of KiInitializeMTRR @ 0x140A45684
 * Callers:
 ...
 *     KiMaskToLength @ 0x14099BA14 (KiMaskToLength.c)
...
void __fastcall KiInitializeMTRR(char a1)
{
  ...
  if ( !KeGetPcr()->Prcb.Number )
  {
    ...
    if ( CurrentPrcb->CpuVendor == 1 )
      byte_140C2B131 = (__readmsr(0xC0010010) & 0x40000) != 0;
    if ( (((_BYTE)qword_140C2B128 != 0) & _bittest64(&KiMtrrInfo, 0xBu)) != 0 )
    {
      if ( (KeFeatureBits & 0x40) == 0 && (qword_140C2B128 & 0x400) != 0 )
        qword_140C2B128 &= ~0x400uLL;
      PoolWithTag = qword_140C2B138;
      v15 = 16 * (unsigned int)(unsigned __int8)qword_140C2B128;
      if ( qword_140C2B138
        || (PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, (unsigned int)v15, 0x2020654Bu),
            (qword_140C2B138 = PoolWithTag) != 0LL) )
      {
      ...
      if ( qword_140C2B140
        ...
        && (v16 = ExAllocatePoolWithTag(NonPagedPoolNx, 0x58uLL, 0x2020654Bu), (qword_140C2B140 = v16) != 0LL) )
      {
  ...
  {
    if ( qword_140C2B140 )
      KiReadFixedMtrr(qword_140C2B140);
