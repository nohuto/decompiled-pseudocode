/*
 * XREFs of MiLogHotPatchManagement @ 0x1408C7CC0
 * Callers:
    ...
    if ( a1 )
    {
      if ( a1 == 3 )
      {
        if ( **(_DWORD **)&qword_140C4ECE0 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
        {
          ...
          v44[1] = 0;
          v47 = 0;
          tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)&dword_1400254FC, v10, 1u, v14, v15, 9u, &v32);
        }
      }
      else if ( a1 == 1 )
      {
        if ( **(_DWORD **)&qword_140C4ECE0 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
        {
          ...
          v79 = 4LL;
          v81 = 4LL;
          tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)word_1400254AA, v11, 1u, v14, v15, 6u, &v73);
        }
      }
      else if ( a1 == 4 && **(_DWORD **)&qword_140C4ECE0 > 5u && tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
      {
        ...
        v71 = 4 * v12 + 8;
        v72 = 0;
        tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)&unk_140025448, v13, 1u, v14, v15, 7u, &v61);
      }
    }
    else if ( **(_DWORD **)&qword_140C4ECE0 > 5u )
    {
      if ( tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 32LL) )
      {
        ...
        v58 = 2LL;
        v60[1] = 0;
        tlgWriteEx_EtwWriteEx(v4, (unsigned __int8 *)byte_1400251CB, v8, 1u, v14, v15, 8u, &v48);
      }
    }
  }
}
