/*
 * XREFs of PopCheckShutdownMarker @ 0x140A3F5F0
 * Callers:
 ...
 *     RtlGetSystemBootStatusEx @ 0x140783460 (RtlGetSystemBootStatusEx.c)
...
char __fastcall PopCheckShutdownMarker(__int64 a1)
{
  ...
  xmmword_140C54110 = xmmword_140C50368;
  xmmword_140C54120 = xmmword_140C50378;
    ...
    && tlgKeywordOn((__int64)&dword_140C021E8, 0x200000000000LL) )
  {
    ...
    v25 = &v13;
    v27 = &v14;
    v29 = &xmmword_140C54110;
    v15 = WORD6(xmmword_140C54110);
    v31 = &v15;
    v33 = &v16;
    v35 = &v17;
    v18 = BYTE6(v5);
    ...
    v6 = HIBYTE(v5);
    v11 = v6 & 1;
    v17 = HIWORD(*((_QWORD *)&xmmword_140C54110 + 1));
    v39 = &v11;
    v12 = (v6 & 2) != 0;
    v41 = &v12;
    v24 = 8LL;
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      ...
      (unsigned __int8 *)&byte_140025D97,
      0LL,
      0LL,
      0xCu,
      &v22);
  ...
  xmmword_140C54140 = xmmword_140C50558;
  PopBsdPowerTransitionAtBoot = PopBsdPowerTransition;
  xmmword_140C54160 = xmmword_140C50398;
  ...
  if ( (PopSimulate & 0x20000000) != 0 )
  {
    ...
    *((_QWORD *)&xmmword_140C54140 + 1) = 1LL;
  }
