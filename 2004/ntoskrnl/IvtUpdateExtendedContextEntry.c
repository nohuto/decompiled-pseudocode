/*
 * XREFs of IvtUpdateExtendedContextEntry @ 0x1404DBDA0
 * Callers:
 ...
 * Callees:
 *     IvtBuildExtendedContextEntry @ 0x1404DA8CC (IvtBuildExtendedContextEntry.c)
 *     IvtGetBlockedDomain @ 0x1404DAF7C (IvtGetBlockedDomain.c)
 *     IvtGetContextEntryType @ 0x1404DAFD0 (IvtGetContextEntryType.c)
