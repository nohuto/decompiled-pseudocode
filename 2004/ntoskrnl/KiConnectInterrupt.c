/*
 * XREFs of KiConnectInterrupt @ 0x14037551C
 * Callers:
 ...
 *     KiInsertInterruptObjectOrdered @ 0x14051BEF8 (KiInsertInterruptObjectOrdered.c)
 */
        ...
        if ( *(_DWORD *)(a1 + 108) == *((_DWORD *)v10 + 27) )
        {
          if ( *(_BYTE *)(a1 + 100) )
          {
            if ( v10[100] )
            {
              ...
              {
                v13 = (__int64 (__fastcall *)())*((_QWORD *)v10 + 10);
                if ( v13 == KiInterruptDispatch || v13 == KiChainedDispatch )
                {
                  *(_BYTE *)(a1 + 95) = 1;
                  v4 = 1;
                  if ( *((__int64 (__fastcall **)())v10 + 10) != KiChainedDispatch )
                  {
