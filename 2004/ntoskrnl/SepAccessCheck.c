/*
 * XREFs of SepAccessCheck @ 0x14029D500
 * Callers:
        ...
        char a20)
{
  ...
  __int64 v86; // rax
  char v87; // [rsp+70h] [rbp-F8h]
  unsigned __int8 v88; // [rsp+71h] [rbp-F7h]
  char v89; // [rsp+72h] [rbp-F6h]
  unsigned __int8 v90; // [rsp+73h] [rbp-F5h]
  unsigned __int8 v91; // [rsp+74h] [rbp-F4h]
  int v92; // [rsp+78h] [rbp-F0h]
  unsigned int v93; // [rsp+7Ch] [rbp-ECh]
  unsigned int v94; // [rsp+80h] [rbp-E8h]
  __int128 *v95; // [rsp+A0h] [rbp-C8h]
  __int64 v98; // [rsp+D0h] [rbp-98h] BYREF
  int v99; // [rsp+D8h] [rbp-90h]
  __int128 v100; // [rsp+E0h] [rbp-88h] BYREF
  __int128 v101; // [rsp+F0h] [rbp-78h]
  __int128 v102; // [rsp+100h] [rbp-68h]
...
LABEL_16:
  ...
  v99 = 0;
  v56 = SepPrivilegeCheck(a4, (__int64)&v98, 1u, 1, a10);
  v26 = v93;
  v32 = v92;
  if ( v56 )
  {
...
LABEL_105:
  ...
  {
    SepNormalAccessCheck(v26, a4, a3, v30, v31, a17, a2, v33, (__int64)v34, a7, 0, a15, a16, a20);
    v36 = v95;
    v37 = (__int64)a16;
    a16[3] = *((_DWORD *)v95 + 6);
    if ( *((_DWORD *)v95 + 6) )
...
LABEL_67:
      ...
      SepNormalAccessCheck(v55 & v93, a4, a3, v30, v31, a17, a2, v94, (__int64)v95, a7, 1, a15, a16, a20);
      v36 = v95;
      v37 = (__int64)a16;
      v39 = *((_DWORD *)v95 + 6);
    }
  ...
  if ( (v48 & 0x10) != 0 )
  {
    if ( (v48 & 8) != 0 )
      ...
      v58 = a8[3] | 0x1FFFFF;
    SepMaximumAccessCheck(a4, a3, v30, v31, a17, (__int64)a2, v94, (__int64)v95, a7, v58, 1, a15, a16, a20);
    v48 = *(_DWORD *)(a4 + 200);
  }
  v49 = (_DWORD *)v95 + 7;
  v50 = *((_DWORD *)v95 + 7);
...
LABEL_29:
    if ( v27 )
    {
      ...
      if ( KeGetCurrentIrql() < 2u )
      {
        if ( v32 )
        {
          SepAssemblePrivileges(v92, v91, v42, v90, (__int64)v21);
          if ( v21 )
          {
            if ( !*v21 )
            {
...
LABEL_62:
  ...
  v89 = v62;
  v70 = (char *)a11;
  if ( KeGetCurrentIrql() < 2u && v62 && v92 )
  {
    SepAssemblePrivileges(v92, v91, v88, v90, (__int64)a12);
    if ( a12 && !*a12 )
    {
      v71 = v94;
      v44 = 0;
