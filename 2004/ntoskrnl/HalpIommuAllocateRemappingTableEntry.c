/*
 * XREFs of HalpIommuAllocateRemappingTableEntry @ 0x1404C0428
 * Callers:
 *     HalpIrtAllocateIndex @ 0x140862354 (HalpIrtAllocateIndex.c)
 * Callees:
 *     HalpIommuConvertPciBusMasterDescriptorToDeviceId @ 0x1403ECB2C (HalpIommuConvertPciBusMasterDescriptorToDeviceId.c)
