/*
 * XREFs of MxSwitchDescriptors @ 0x140A904DC
 * Callers:
 *     MxGetNextPage @ 0x140A3F124 (MxGetNextPage.c)
 * Callees:
 *     MiSearchNumaNodeTable @ 0x14023A180 (MiSearchNumaNodeTable.c)
 *     MiInitializeBootMemoryDescriptor @ 0x140A3F220 (MiInitializeBootMemoryDescriptor.c)
 */
...
unsigned __int64 *__fastcall MxSwitchDescriptors(unsigned int a1)
{
  ...
  v4 = (unsigned __int64 *)&qword_140D59D60[5 * a1];
  v5 = v4[4];
  while ( 2 )
  {
    if ( !v5 )
