/*
 * XREFs of ExSvmFinalizeDeviceReset @ 0x1405B2DA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
  ...
  if ( v11 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v3->ApcState.ApcListHead[0].Flink != &v3->152 )
  ...
  else
  {
    ...
    v15 = (*(__int64 (__fastcall **)(__int64))(HalIommuDispatch + 144))(v14[14]);
  }
