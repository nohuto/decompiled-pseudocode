/*
 * XREFs of VfThunkAddDriverThunks @ 0x1409D5820
 * Callers:
...
__int64 __fastcall VfThunkAddDriverThunks(void *a1)
{
  ...
  VfThunksExtended = 1;
  _InterlockedOr(v4, 0);
  v3 = (_QWORD *)qword_140C1D158;
  ++ViActiveVerifierThunks;
  if ( *(__int64 **)qword_140C1D158 != &ViVerifierDriverAddedThunkListHead )
    __fastfail(3u);
  *ThunkTable = &ViVerifierDriverAddedThunkListHead;
  ThunkTable[1] = v3;
  *v3 = ThunkTable;
  qword_140C1D158 = (__int64)ThunkTable;
