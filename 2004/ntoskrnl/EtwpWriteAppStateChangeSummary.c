/*
 * XREFs of EtwpWriteAppStateChangeSummary @ 0x14061F28C
 * Callers:
        ...
        unsigned __int16 *a6)
{
  ...
  memset(v72, 0, 29);
  if ( dword_140C02B78 && tlgKeywordOn((__int64)&dword_140C02B78, 0x200000000000LL) )
  {
    v10 = 1LL;
    v11 = 257LL;
  }
  ...
  *(_QWORD *)&v72[0] = v10;
  ...
  {
    LOBYTE(v16) = tlgKeywordOn((__int64)&dword_140C02B78, 0x400000000000LL);
    if ( (_BYTE)v16 )
    {
      v19 = *a2;
      v20 = v18;
      ...
      v71 = 50331648LL;
      v139 = 8LL;
      LOBYTE(v16) = tlgWriteAgg((__int64)&dword_140C02B78, (unsigned __int8 *)&word_14002B85E, v43, 0x24u, &v73);
    }
  }
  return v16;
}
