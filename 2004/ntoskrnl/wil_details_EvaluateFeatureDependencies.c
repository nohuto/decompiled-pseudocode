/*
 * XREFs of wil_details_EvaluateFeatureDependencies @ 0x1405C7638
 * Callers:
 ...
 *     wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState @ 0x1405C76E4 (wil_details_EvaluateFeatureDependencies_GetCachedFeatureEnabledState.c)
 */
...
__int64 (__fastcall **wil_details_EvaluateFeatureDependencies())()
{
  ...
  for ( i = (__int64 (__fastcall **)())&wil_details_featureDescriptors_a; ; i = v6 + 3 )
  {
