/*
 * XREFs of WmipGetSMBiosTableData @ 0x1406DE5D4
 * Callers:
 *     WmipRawSMBiosTableHandler @ 0x140335A30 (WmipRawSMBiosTableHandler.c)
 ...
 *     WmipSMBiosHideMachine @ 0x14092EBEC (WmipSMBiosHideMachine.c)
 */
