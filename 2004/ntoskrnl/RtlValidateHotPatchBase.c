/*
 * XREFs of RtlValidateHotPatchBase @ 0x140917DD4
 * Callers:
 *     MiPerformImageHotPatch @ 0x1408C98C4 (MiPerformImageHotPatch.c)
 * Callees:
 *     RtlGetHotPatchSize @ 0x14058A8CC (RtlGetHotPatchSize.c)
 *     RtlDetermineHotPatchExtent @ 0x1409179DC (RtlDetermineHotPatchExtent.c)
 */
