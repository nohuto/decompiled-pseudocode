/*
 * XREFs of PfpLogPageAccess @ 0x1406CEBD0
 * Callers:
...
unsigned __int64 __fastcall PfpLogPageAccess(__int64 a1, _DWORD *a2, _BYTE *a3, __int64 a4, int a5)
{
  ...
  {
    v14 = qword_140C4FA18;
    v15 = *(unsigned int *)(qword_140C4FA18 + 16);
    v16 = (qword_140C4FA18 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
      ...
      v15 = (HIBYTE(v54)
           ...
           * (BYTE6(v54)
            ...
            * (BYTE5(v54)
             + 37
             * (BYTE4(v54)
              + 37 * (BYTE3(v54) + 37 * (BYTE2(v54) + 37 * (BYTE1(v54) + 37 * ((unsigned __int8)v12 + 11623883)))))))) & (unsigned int)(*(_DWORD *)(qword_140C4FA18 + 32) - 1);
            ...
            v44 = (HIBYTE(v54)
                 ...
                 * (BYTE6(v54)
                  ...
                  * (BYTE5(v54)
                   + 37
                   * (BYTE4(v54)
                    + 37 * (BYTE3(v54) + 37 * (BYTE2(v54) + 37 * (BYTE1(v54) + 37 * ((unsigned __int8)v12 + 11623883)))))))) & (*(_DWORD *)(qword_140C4FA18 + 32) - 1);
            if ( v43 >= 2 )
            {
              v10 = -1;
              goto LABEL_55;
...
LABEL_55:
    ...
    if ( v51 < 3 * (*(_DWORD *)(v14 + 32) >> 2) )
      break;
    if ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C4FA00) == -1073741823 )
      return 0LL;
  }
  v13 = 1;
  *(_DWORD *)(v14 + 28) = v51 + 1;
...
LABEL_19:
      v27 = qword_140C4F9F0;
      v28 = ((*a3 & 3) == 2) + 1;
      if ( (unsigned int)(v28 + *(_DWORD *)(qword_140C4F9F0 + 16)) > *(_DWORD *)(qword_140C4F9F0 + 20) )
      {
        while ( (unsigned int)PfTReplaceCurrentBuffer(&unk_140C4F9D8) != -1073741823 )
        {
          v27 = qword_140C4F9F0;
          if ( (unsigned int)(v28 + *(_DWORD *)(qword_140C4F9F0 + 16)) <= *(_DWORD *)(qword_140C4F9F0 + 20) )
            goto LABEL_20;
...
LABEL_12:
  ...
  {
    v22 = qword_140C4FA18;
    v23 = *(unsigned int *)(v21 + qword_140C4FA18);
    v24 = (qword_140C4FA18 + 47) & 0xFFFFFFFFFFFFFFF8uLL;
...
LABEL_14:
    ...
    else
    {
      ...
      if ( v41 == v19 )
      {
        *(_DWORD *)(v21 + qword_140C4FA18) = v40;
...
LABEL_52:
        ...
        while ( 1 )
        {
          ...
          if ( v50 == v19 )
          {
            *(_DWORD *)(v21 + qword_140C4FA18) = v48;
            LOWORD(v23) = v48;
            goto LABEL_14;
          }
          if ( !v50 )
