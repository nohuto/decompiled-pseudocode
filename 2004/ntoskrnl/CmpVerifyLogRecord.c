/*
 * XREFs of CmpVerifyLogRecord @ 0x1405C78FC
 * Callers:
 ...
 *     CmpVerifyRenameKeyLogRecord @ 0x1405C79B8 (CmpVerifyRenameKeyLogRecord.c)
 *     CmpVerifySetOrDeleteValueLogRecord @ 0x1405C7A00 (CmpVerifySetOrDeleteValueLogRecord.c)
