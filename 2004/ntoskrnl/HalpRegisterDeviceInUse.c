/*
 * XREFs of HalpRegisterDeviceInUse @ 0x1409B356C
 * Callers:
 *     HalpKdSetupDebuggingDevice @ 0x1409B3480 (HalpKdSetupDebuggingDevice.c)
 * Callees:
  ...
  if ( v1 != 3 )
  {
    ...
    if ( !HalpFindDevice(a1) )
    {
      ...
      *(_QWORD *)(v7 + 264) = *(_QWORD *)(a1 + 240);
      ...
      v8 = (__int64 *)qword_140C48B90;
      if ( *(__int64 **)qword_140C48B90 != &qword_140C48B88 )
        __fastfail(3u);
      *(_QWORD *)v7 = &qword_140C48B88;
      *(_QWORD *)(v7 + 8) = v8;
      *v8 = v7;
      ++DevicesList;
      qword_140C48B90 = v7;
