/*
 * XREFs of MiIsExtentDangling @ 0x1408CCAF8
 * Callers:
 *     FsRtlIsExtentDangling @ 0x140889170 (FsRtlIsExtentDangling.c)
...
LABEL_8:
  if ( (a3 & 2) == 0 )
  {
    ...
    ExAcquirePushLockSharedEx((ULONG_PTR)&qword_140C4CAA8, 0LL);
    v10 = (_QWORD *)qword_140C4CAA0;
    if ( qword_140C4CAA0 )
    {
      do
      {
    ...
    if ( _InterlockedCompareExchange64((volatile signed __int64 *)&qword_140C4CAA8, 0LL, 17LL) != 17 )
      ExfReleasePushLockShared((signed __int64 *)&qword_140C4CAA8);
