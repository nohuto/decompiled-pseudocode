/*
 * XREFs of AlpcpCompleteDispatchMessage @ 0x140685F60
 * Callers:
 ...
 *     AlpcpAllocateCompletionBuffer @ 0x1406DD470 (AlpcpAllocateCompletionBuffer.c)
 ...
 *     AlpcpFreeBitmap @ 0x1408C003C (AlpcpFreeBitmap.c)
