/*
 * XREFs of MiLogNotifyPageHeat @ 0x14055A1D8
 * Callers:
...
void __fastcall MiLogNotifyPageHeat(_DWORD *a1)
{
  ...
  {
    v2 = 64LL;
    if ( !**(_DWORD **)&qword_140C4ECE0 || (v3 = tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, 64LL) == 0, v4 = 1, v3) )
      v4 = 0;
    if ( v4 )
    {
      ...
      if ( *v1 )
      {
        if ( **(_DWORD **)&qword_140C4ECE0 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, v2) )
          goto LABEL_23;
        v19 = *v5;
        v16 = (unsigned __int8 *)&word_140025C8A;
        v29 = *(_DWORD *)(v18 + 4);
        v40 = &v29;
        v42 = &v34;
        v35 = v19 >> 12;
      ...
      else
      {
        if ( **(_DWORD **)&qword_140C4ECE0 <= 5u || !tlgKeywordOn(*(__int64 *)&qword_140C4ECE0, v2) )
          goto LABEL_23;
        v15 = *v5;
        v16 = (unsigned __int8 *)qword_140025D10;
        v26 = *(_DWORD *)(v14 + 4);
        v36[4] = (__int64)&v26;
        v36[6] = (__int64)&v32;
        v33 = v15 >> 12;
      ...
      tlgWriteEx_EtwWriteEx(v13, v16, 0LL, 1u, 0, 0, 9u, v17);
LABEL_23:
      if ( KiIrqlFlags )
      {
        if ( (KiIrqlFlags & 1) != 0 )
