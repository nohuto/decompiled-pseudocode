/*
 * XREFs of KiSegmentNotPresentFault @ 0x1404044C0
 * Callers:
 *     KiSegmentNotPresentFaultShadow @ 0x140A116C0 (KiSegmentNotPresentFaultShadow.c)
 * Callees:
...
void __fastcall __noreturn KiSegmentNotPresentFault(__int64 a1, unsigned __int64 Object)
{
  ...
  if ( ((unsigned __int8)retaddr & 4) != 0 )
    _InterlockedExchange64(MK_FP(__GS__, 35304LL), 0LL);
  if ( (v12 & 0x200) != 0 )
    _enable();
  if ( (v6 & 4) != 0 )
