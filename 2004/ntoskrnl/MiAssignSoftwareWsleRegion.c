/*
 * XREFs of MiAssignSoftwareWsleRegion @ 0x1403B31B0
 * Callers:
...
__int64 __fastcall MiAssignSoftwareWsleRegion(__int64 a1, unsigned __int64 a2)
{
  ...
  *(_QWORD *)&v13[3] = 0x1000000000LL;
  ...
  while ( v8 );
  qword_140C4E130 = *(_QWORD *)&v13[1];
  qword_140C4E138 = *(_QWORD *)&v13[1];
  qword_140C4E140 = *(_QWORD *)&v13[1];
  qword_140C4E050 = v14;
  qword_140C4E048 = *(_QWORD *)&v13[7];
  *(_QWORD *)(*(_QWORD *)(a1 + 240) + 2928LL) = *(_QWORD *)&v13[7];
  result = qword_140C4E050;
  *(_QWORD *)(*(_QWORD *)(a1 + 240) + 2936LL) = qword_140C4E050;
  return result;
}
