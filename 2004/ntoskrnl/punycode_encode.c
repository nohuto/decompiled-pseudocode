/*
 * XREFs of punycode_encode @ 0x140913C24
 * Callers:
 ...
 *     FindLabelEnd @ 0x140587DB8 (FindLabelEnd.c)
 *     GetUTF32 @ 0x140587DF4 (GetUTF32.c)
 *     ValidateStd3Range @ 0x140588490 (ValidateStd3Range.c)
 *     adapt @ 0x1405884CC (adapt.c)
 */
...
LABEL_85:
        ...
        for ( i = v5; i < v16; ++i )
        {
          ...
          {
            if ( !v10
              && ((_BYTE)v64 != (_BYTE)v8 && !ValidateStd3Range(v21)
               || (unsigned __int16)v21 < 0x20u
               || (_WORD)v21 == 127)
              || !(_WORD)v21 )
            {
              goto LABEL_89;
