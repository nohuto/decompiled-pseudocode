/*
 * XREFs of CmpGlobalLockKeyForWrite @ 0x1407B0EA0
 * Callers:
...
__int64 __fastcall CmpGlobalLockKeyForWrite(__int64 a1, __int64 *a2)
{
  ...
  GlobalKeyLockEntry = qword_140C47CA8;
  v6 = 0;
  while ( 1 )
  {
    if ( (__int64 *)GlobalKeyLockEntry == &qword_140C47CA8 )
      goto LABEL_5;
...
LABEL_5:
  ...
  if ( GlobalKeyLockEntry )
  {
    *(_WORD *)(a1 + 8) |= 0x80u;
    ...
    v8 = (__int64 *)qword_140C47CB0;
    if ( *(__int64 **)qword_140C47CB0 != &qword_140C47CA8 )
      __fastfail(3u);
    *(_QWORD *)GlobalKeyLockEntry = &qword_140C47CA8;
    *(_QWORD *)(GlobalKeyLockEntry + 8) = v8;
    *v8 = GlobalKeyLockEntry;
    qword_140C47CB0 = GlobalKeyLockEntry;
    goto LABEL_8;
  }
