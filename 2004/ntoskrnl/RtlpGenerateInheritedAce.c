/*
 * XREFs of RtlpGenerateInheritedAce @ 0x14068E6E0
 * Callers:
...
LABEL_7:
  ...
  if ( !(_BYTE)v35 && v32 )
  {
    if ( (unsigned __int8)RtlpIsDuplicateAce(v22, v24) )
    {
      v19 = v32;
      v20 = 0;
      --*(_WORD *)(v22 + 4);
      ...
      if ( v18 <= 0xFFFF )
      {
        ...
        else if ( !(_BYTE)v35 )
        {
          ...
          *(_BYTE *)(v33 + 1) |= 8u;
          ...
          {
            *(_BYTE *)(v33 + 1) |= 0x10u;
            if ( (unsigned __int8)RtlpIsDuplicateAce(v22, v33) )
            {
              --*(_WORD *)(v22 + 4);
