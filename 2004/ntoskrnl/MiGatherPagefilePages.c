/*
 * XREFs of MiGatherPagefilePages @ 0x1402F2788
 * Callers:
...
__int64 __fastcall MiGatherPagefilePages(__int64 a1)
{
  ...
  int v68; // eax
  unsigned int v69; // [rsp+60h] [rbp-39h] BYREF
  ...
  unsigned int v83; // [rsp+110h] [rbp+77h] BYREF
  unsigned int v84; // [rsp+118h] [rbp+7Fh] BYREF
...
LABEL_10:
  ...
  {
    v69 = 0;
    MiFindPageFileWriteCluster(v1, &v69, &v83, 0LL);
    v2 = v83;
    if ( v83 )
    {
      v18 = MiFillNoReservationCluster(v7, v74);
      v17 = v69;
      v16 = v18;
      v84 = v18;
      goto LABEL_23;
...
LABEL_23:
  if ( v18 )
  {
    ...
    if ( (v5 & 2) != 0 )
    {
      MiFindPageFileWriteCluster(v1, &v69, &v83, 1LL);
      v17 = v69;
      v19 = v83;
    }
    else
...
LABEL_45:
    *(_DWORD *)(a1 + 40) = (4 * v30) | *(_DWORD *)(a1 + 40) & 0xFFFFFFE3;
    ...
    MI_PAGEFILE_WRITE(a1, a1 + 184, v30, ((v5 >> 1) & 1) == 0, -1);
    v33 = *(_DWORD *)(v28 + 848);
    v34 = *(_QWORD *)(v28 + 840);
    if ( v33 == 512 )
      v34 -= v34 >> 9;
