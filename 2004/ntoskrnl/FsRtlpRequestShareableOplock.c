/*
 * XREFs of FsRtlpRequestShareableOplock @ 0x140296DF0
 * Callers:
...
LABEL_115:
      ...
      || (v38 & 0x10000) != 0 )
    {
      ...
      else
      {
        ...
        {
          if ( FsRtlpOplockKeysEqual(*(_QWORD *)(a2 + 48), v40[3], 0) )
            goto LABEL_64;
          v40 = (_QWORD *)*v40;
        }
      ...
      if ( v42 == 16 || v42 == 4096 || v42 == 4112 || v42 == 45056 )
      {
        for ( k = *(__int64 **)(Oplock + 40); k != (__int64 *)(Oplock + 40); k = (__int64 *)*k )
        {
          ...
          if ( (*(_DWORD *)(v44 + 24) == 590400 || *(_QWORD *)(v44 + 48) != *(_QWORD *)(v41 + 48))
            && FsRtlpOplockKeysEqual(*(_QWORD *)(v41 + 48), *(_QWORD *)(v44 + 48), 0) )
          {
    ...
    if ( v21 == 4096 || v21 == 45056 )
    {
      ...
      while ( 1 )
      {
        if ( v50 == (__int64 *)(Oplock + 40) )
          goto LABEL_30;
        if ( FsRtlpOplockKeysEqual(*(_QWORD *)(v20 + 48), *(_QWORD *)(v50[2] + 48), 0) )
          break;
        v50 = (__int64 *)*v50;
        v20 = a2;
      }
    ...
    if ( (((*(_DWORD *)(Oplock + 144) & 0x1F0FFDF) - 12288) & 0xFFFF7FFF) == 0 )
    {
      ...
      while ( 1 )
      {
        if ( v30 == (__int64 *)(Oplock + 56) )
          goto LABEL_31;
        if ( FsRtlpOplockKeysEqual(*(_QWORD *)(v20 + 48), v30[3], 0) && !v30[7] )
          break;
        v30 = (__int64 *)*v30;
        v20 = a2;
      }
      ...
      FsRtlpRemoveAndBreakRHIrp(*(PVOID *)v30[1], 12288, 0, 0, 0);
      v20 = a2;
    }
LABEL_31:
    ...
    if ( v22 != (_QWORD *)(Oplock + 72) )
    {
      while ( 1 )
      {
        if ( v22 == (_QWORD *)(Oplock + 72) )
          goto LABEL_32;
        if ( FsRtlpOplockKeysEqual(*(_QWORD *)(v20 + 48), v22[3], 0) )
          break;
        v22 = (_QWORD *)*v22;
        v20 = a2;
      }
