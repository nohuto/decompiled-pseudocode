/*
 * XREFs of MiDeleteVa @ 0x140242B90
 * Callers:
...
__int64 __fastcall MiDeleteVa(__int64 a1, ULONG_PTR a2, unsigned int a3)
{
  ...
  ULONG_PTR v119; // rbx
  _KPROCESS *v120; // [rsp+30h] [rbp-69h]
  int v121; // [rsp+38h] [rbp-61h]
  char v123; // [rsp+40h] [rbp-59h]
  int v124; // [rsp+40h] [rbp-59h]
  __int64 v125; // [rsp+48h] [rbp-51h]
  int v126; // [rsp+50h] [rbp-49h] BYREF
  unsigned __int64 v127; // [rsp+58h] [rbp-41h] BYREF
  unsigned __int64 v128; // [rsp+60h] [rbp-39h] BYREF
  __int64 v129; // [rsp+68h] [rbp-31h]
  ULONG_PTR v130; // [rsp+70h] [rbp-29h] BYREF
  ULONG_PTR v131; // [rsp+78h] [rbp-21h] BYREF
  unsigned __int64 v132; // [rsp+80h] [rbp-19h] BYREF
  ULONG_PTR v133; // [rsp+88h] [rbp-11h]
  _DWORD v134[8]; // [rsp+90h] [rbp-9h] BYREF
...
LABEL_37:
    ...
    {
      MiInsertTbFlushEntry(v20, (__int64)(a2 << 25) >> 16, 1LL, 0LL);
      if ( (v21 & 0x100) == 0 )
      {
        v37 = 0xFFFFF68000000000uLL;
        if ( v22 >= 0xFFFFF68000000000uLL && v22 <= 0xFFFFF6FFFFFFFFFFuLL )
        {
          if ( !(unsigned int)MiEvictPageTableLock(v120, a2, v3 & 0xFFFFFFFFFFFFFBFEuLL | 0x400, (int)a3 > 1) )
            return 0LL;
          goto LABEL_279;
        }
      }
    ...
    if ( (v21 & 0x10) != 0 )
    {
      ...
      MiInsertTbFlushEntry(v20, (__int64)(a2 << 25) >> 16, v24, 0LL);
      goto LABEL_279;
    }
    if ( (v21 & 0x60) != 0 )
    {
...
LABEL_155:
      ...
      else
      {
        ...
        if ( (unsigned __int64)&v127 >= 0xFFFFF6FB7DBED000uLL
          && (unsigned __int64)&v127 <= v43
          && (unsigned int)MiPteHasShadow(&v127, v54, v49, v53)
          && (v54 & 1) != 0
          && ((v54 & 0x20) == 0 || (v54 & 0x42) == 0) )
        {
          ...
          if ( v56 )
          {
            v57 = *((_QWORD *)&v56->Flink + (((unsigned __int64)&v127 >> 3) & 0x1FF));
            v58 = v54 | 0x20;
            if ( (v57 & 0x20) == 0 )
              v58 = v54;
            v54 = v58;
        ...
        {
          MiTerminateWsleCluster((__int64 *)v48);
          LOBYTE(v5) = v123;
LABEL_154:
          *(_QWORD *)v48 = v120;
...
LABEL_279:
          ...
          if ( (*(_DWORD *)(v20 + 12) >= *(_DWORD *)(v20 + 8) || *(_BYTE *)(v20 + 5) || *(_QWORD *)(v20 + 16) > v101)
            ...
            && !*(_BYTE *)(v20 + 5) )
          {
            MiFlushTbList(v20, (_KPROCESS *)v101);
          }
          v18 = v125;
LABEL_290:
          if ( !*(_QWORD *)v18 )
      ...
      if ( v22 >= 0xFFFFF68000000000uLL && v22 <= 0xFFFFF6FFFFFFFFFFuLL )
      {
        ...
        v124 = v40;
        if ( !(unsigned int)MiEvictPageTableLock(v120, ((v22 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL, ZeroPte, 0LL) )
          return 0LL;
        goto LABEL_209;
      }
      v73 = *(_QWORD *)v66;
      ...
      {
        MiUnlockWsle(v120, (__int64)(a2 << 25) >> 16, v78);
      ...
      if ( (v83 & 0x20) != 0 )
      {
        if ( v66 >= v84 && v66 <= v86 )
        {
          ...
          {
            if ( !HIBYTE(word_140C4DE08) && (v82 & 1) != 0 )
...
LABEL_210:
          v88 = WsleContents;
          v38 = v120;
          MiRemoveWsle((_DWORD)v120, (__int64)(a2 << 25) >> 16, 1, v88, 10, v121);
          if ( v124 )
          {
            ...
            if ( (unsigned __int64)&v128 >= v89 )
            {
              v35 = (unsigned __int64)&v128;
              if ( (unsigned __int64)&v128 <= v37
                && (unsigned int)MiPteHasShadow(&v128, v90, v36, v37)
                && (v90 & 1) != 0
                && ((v90 & 0x20) == 0 || (v90 & 0x42) == 0) )
              {
                ...
                if ( v36 )
                {
                  v93 = *(_QWORD *)(v36 + 8 * (((unsigned __int64)&v128 >> 3) & 0x1FF));
                  v36 = v90 | 0x20;
            ...
            {
              MiCountWslesInPageTable(v35, (__int64)(a2 << 25) >> 16, v134);
              LOBYTE(v35) = 8;
              while ( 1 )
              {
                LOBYTE(v35) = v35 - 1;
                v34 = (unsigned int)v134[(unsigned __int8)v35];
                if ( (_DWORD)v34 )
                  break;
                if ( !(_BYTE)v35 )
                  goto LABEL_239;
...
LABEL_209:
    ...
    if ( (v21 & 2) != 0 && (v19->Affinity.Bitmap[12] & 0x1000000) == 0 && dword_140C4E628 )
    {
      if ( v22 < 0xFFFFF68000000000uLL || v22 > 0xFFFFF6FFFFFFFFFFuLL )
      {
...
LABEL_74:
    v30 = v3;
    if ( MiPteInShadowRange((unsigned __int64)&v130)
      && (MiFlags & 0xC00000) != 0
      && KeGetCurrentThread()->ApcState.Process->AddressPolicy != 1
      && ((v3 & 0x20) == 0 || (v3 & 0x42) == 0) )
    {
      ...
      {
        v30 = v3 | 0x20;
        v32 = *((_QWORD *)&v31->Flink + (((unsigned __int64)&v130 >> 3) & 0x1FF));
        if ( (v32 & 0x20) == 0 )
          v30 = v3;
        if ( (v32 & 0x42) != 0 )
          v30 |= 0x42uLL;
  ...
  if ( (v3 & 0x400) == 0 )
  {
    ...
    v131 = v3;
    v114 = *(_QWORD *)(qword_140C4E448 + 8 * v106);
    if ( (v3 & 4) != 0 || (v3 & 2) != 0 )
      v115 = MI_READ_PTE_LOCK_FREE((unsigned __int64)&v131);
    else
      v115 = 0LL;
    v131 = v115;
    if ( v115 )
      MiReleasePageFileInfo(v114, v115, 0LL);
    if ( (v120->Affinity.Bitmap[12] & 7) != 0 )
      goto LABEL_331;
    if ( (v21 & 0x80u) != 0 )
    {
      if ( qword_140C4DD40 && (v3 & 0x10) == 0 )
        LOWORD(v3) = ~(_WORD)qword_140C4DD40 & v3;
...
LABEL_331:
  ...
  v103 = v3;
  if ( qword_140C4DD40 && (v3 & 0x10) == 0 )
    v103 = v3 & ~qword_140C4DD40;
  v104 = v103 >> 16;
  v105 = v3;
  if ( qword_140C4DD40 && (v3 & 0x10) == 0 )
    v105 = v3 & ~qword_140C4DD40;
  v106 = 0xFFFFFFFFLL;
...
LABEL_308:
  ...
  {
    if ( !(unsigned int)MiIsPrototypePteVadLookup(v3, v104, v19, v5) )
    {
...
LABEL_334:
  if ( a2 <= v113 )
  {
    ...
    {
      if ( !HIBYTE(word_140C4DE08) && (v111 & 1) != 0 )
...
LABEL_344:
  ...
  {
    v116 = (unsigned __int64 *)(((v22 >> 18) & 0x3FFFFFF8) - 0x904C0000000LL);
    PteShadow = *v116;
    if ( (unsigned __int64)v116 >= v112 && (unsigned __int64)v116 <= 0xFFFFF6FB7DBED7F8uLL )
      PteShadow = MiReadPteShadow(v116, *v116);
    v132 = PteShadow;
    v118 = &v132;
    if ( (unsigned __int64)&v132 >= v112 )
    {
      v118 = &v132;
      if ( (unsigned __int64)&v132 <= 0xFFFFF6FB7DBED7F8uLL )
        PteShadow = MiReadPteShadow(&v132, PteShadow);
    }
    v119 = 48 * ((PteShadow >> 12) & 0xFFFFFFFFFLL) - 0x58000000000LL;
    if ( (*(_DWORD *)(v119 + 16) & 0x3FF0000) == 0 )
      KeBugCheckEx(0x1Au, 0x41790uLL, v119, HIWORD(*(_DWORD *)(v119 + 16)) & 0x3FF, 1uLL);
    v126 = 0;
    while ( _interlockedbittestandset64((volatile signed __int32 *)(v119 + 24), 0x3FuLL) )
    {
      do
        KeYieldProcessorEx(&v126, v118);
      while ( *(__int64 *)(v119 + 24) < 0 );
    }
    *(_QWORD *)(v119 + 16) ^= ((unsigned int)*(_QWORD *)(v119 + 16) ^ (((unsigned int)(*(_QWORD *)(v119 + 16) >> 16) - 1) << 16)) & 0x3FF0000;
