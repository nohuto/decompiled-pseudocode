/*
 * XREFs of MiRemoveLowestPriorityStandbyPage @ 0x140382660
 * Callers:
...
LABEL_63:
  ...
  if ( (*(_BYTE *)(v15 + 34) & 7) != 2
    || *(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(v15 + 40) >> 39) & 0x3FFLL)) != a1 )
  {
    goto LABEL_47;
  }
  LockHandle.LockQueue.Lock = v5;
...
LABEL_54:
  ...
  if ( dword_140C4E4CC == 1 )
  {
    v35 = v9 & 0x1F;
    LOBYTE(v36) = 1;
    v37 = (volatile signed __int32 *)(qword_140C4E528 + 4 * (v9 >> 5));
    if ( v35 + 1 <= 0x20 )
    {
      v38 = 1 << v35;
      goto LABEL_75;
...
LABEL_75:
  ...
  *(_QWORD *)(v15 + 16) = ZeroPte;
  MiSetOriginalPtePfnFromFreeList((unsigned __int64 *)(v15 + 16), 5056LL, v52, v53);
  if ( (v57 & 1) != 0 )
