/*
 * XREFs of KiEnableKvaShadowing @ 0x14099BE8C
 * Callers:
 ...
 *     HvlRescindEnlightenments @ 0x140360EA8 (HvlRescindEnlightenments.c)
 *     KiInitializeDescriptorIst @ 0x1403B1BC8 (KiInitializeDescriptorIst.c)
 *     KiIsKvaLeakSimulated @ 0x1403B1C18 (KiIsKvaLeakSimulated.c)
 *     KiIsKvaShadowDisabled @ 0x1403B1C2C (KiIsKvaShadowDisabled.c)
