/*
 * XREFs of RtlQueryAllFeatureConfigurations @ 0x14090CDC0
 * Callers:
 *     <none>
 * Callees:
        ...
        PSIZE_T ConfigurationCount)
{
  ...
  RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C47FB0, (__int64)v13, &v12);
  ...
  RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C47FB0, v9);
