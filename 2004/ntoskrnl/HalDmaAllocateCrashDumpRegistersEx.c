/*
 * XREFs of HalDmaAllocateCrashDumpRegistersEx @ 0x1403A36F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpIommuDomainMapLogicalRange @ 0x1404C43DC (HalpIommuDomainMapLogicalRange.c)
...
LABEL_9:
  ...
  if ( v5 != (__int64 *)a1 )
  {
    v13 = (_QWORD *)qword_140C4BCE8;
    v14 = (_QWORD *)(a1 + 280);
    if ( *(__int64 **)qword_140C4BCE8 != &HalpDmaHibernateAdapters )
      __fastfail(3u);
    *v14 = &HalpDmaHibernateAdapters;
    v14[1] = v13;
    *v13 = v14;
    qword_140C4BCE8 = (__int64)v14;
  }
  return 0LL;
}
