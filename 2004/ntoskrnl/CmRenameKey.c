/*
 * XREFs of CmRenameKey @ 0x14086934C
 * Callers:
 ...
 *     EnlistKeyBodyWithKCB @ 0x14079148C (EnlistKeyBodyWithKCB.c)
 *     CmpReleaseKeyNodeForKcb @ 0x1408607E8 (CmpReleaseKeyNodeForKcb.c)
 *     CmpInsertKeyHash @ 0x14086BD9C (CmpInsertKeyHash.c)
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( (*(_DWORD *)(v5 + 8) & 0x180) != 0
        || (v14 = *(_QWORD *)(v5 + 32), (*(_DWORD *)(v14 + 160) & 0x100000) != 0)
        || v14 == CmpMasterHive
