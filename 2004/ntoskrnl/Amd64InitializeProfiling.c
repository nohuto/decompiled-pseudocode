/*
 * XREFs of Amd64InitializeProfiling @ 0x1409A68E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Amd64FreeCounter @ 0x1404D8ABC (Amd64FreeCounter.c)
 */
...
__int64 Amd64InitializeProfiling()
{
  ...
  if ( !Number )
  {
    ...
    qword_140C489D8 = (__int64)&Amd64ProfileSourceDescriptorListHead;
    ...
    for ( i = 0; i < 0xB0; ++i )
    {
      ...
      if ( !Amd64ProfileSourceDescriptorTable[v6 + 29] )
      {
        ...
        v8 = (_QWORD *)qword_140C489D8;
        if ( *(__int64 **)qword_140C489D8 != &Amd64ProfileSourceDescriptorListHead )
          __fastfail(3u);
        ++Amd64ProfileSourceDescriptorCount;
        *v7 = &Amd64ProfileSourceDescriptorListHead;
        v7[1] = v8;
        *v8 = v7;
        qword_140C489D8 = (__int64)v7;
      }
    }
  }
  v9 = &unk_140C05790;
