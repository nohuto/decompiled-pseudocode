/*
 * XREFs of CmpInitializeTransactions @ 0x140A55FF8
 * Callers:
...
__int64 *CmpInitializeTransactions()
{
  ...
  qword_140C47988 = (__int64)&CmpRmListHead;
  ...
  qword_140C47C08 = (__int64)&CmpLazyCommitListHead;
  ...
  _mm_lfence();
  if ( (void *)qword_140C4C5C0 == CmpRmListLock.Owner )
  {
    v0 = __rdtsc();
    ...
    qword_140C4C5D8 = v1;
    qword_140C4C5D0 = KiQueryUnbiasedInterruptTime() + 41929663 * (__rdtsc() >> 4) % 0x12A05F2000LL + 288000000000LL;
  }
  CmpLazyCommitTimer = 8LL;
  qword_140C47C38 = (__int64)CmpLazyCommitDpcRoutine;
  CmpLazyCommitDpc = 275;
  qword_140C47C70 = (__int64)&qword_140C47C68;
  qword_140C47C68 = (__int64)&qword_140C47C68;
  qword_140C479E8 = (__int64)&CmpDelayFreeRMListHead;
  ...
  qword_140C47A38 = (__int64)CmpDelayFreeRMDpcRoutine;
  qword_140C47C40 = 0LL;
  qword_140C47C58 = 0LL;
  qword_140C47C30 = 0LL;
  qword_140C47C78 = 0LL;
  ...
  qword_140C47BC8 = (__int64)&CmpLightTransactionList;
