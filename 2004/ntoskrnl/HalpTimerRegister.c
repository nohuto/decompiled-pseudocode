/*
 * XREFs of HalpTimerRegister @ 0x1403AF660
 * Callers:
 ...
 *     HalpTimerBuildKnownResourceIdString @ 0x1403AF974 (HalpTimerBuildKnownResourceIdString.c)
  ...
  else
  {
    ...
    if ( MemoryInternal )
    {
      ...
      *(_WORD *)(v11 + 26) = p_DestinationString->Length + 2;
      ...
      v16 = (__int64 *)qword_140C4BF48;
      if ( *(ULONG_PTR **)qword_140C4BF48 != &HalpRegisteredTimers )
        __fastfail(3u);
