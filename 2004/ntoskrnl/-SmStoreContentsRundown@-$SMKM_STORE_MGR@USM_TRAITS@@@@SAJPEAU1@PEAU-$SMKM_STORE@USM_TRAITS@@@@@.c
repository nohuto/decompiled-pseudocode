/*
 * XREFs of ?SmStoreContentsRundown@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAU?$SMKM_STORE@USM_TRAITS@@@@@Z @ 0x14059A294
 * Callers:
 *     SmEtwEnableCallback @ 0x1407AA010 (SmEtwEnableCallback.c)
 * Callees:
