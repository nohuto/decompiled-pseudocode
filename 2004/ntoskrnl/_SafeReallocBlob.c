/*
 * XREFs of _SafeReallocBlob @ 0x1405C559C
 * Callers:
 *     RtlpMuiRegResizeLanguageConfigList @ 0x14097E4B8 (RtlpMuiRegResizeLanguageConfigList.c)
 *     RtlpMuiRegResizeLanguages @ 0x14097E524 (RtlpMuiRegResizeLanguages.c)
 * Callees:
