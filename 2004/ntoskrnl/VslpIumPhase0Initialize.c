/*
 * XREFs of VslpIumPhase0Initialize @ 0x140A8CA68
 * Callers:
 ...
 *     VslpIumPhase0InitializeNtKd @ 0x140A8CCF0 (VslpIumPhase0InitializeNtKd.c)
 */
...
__int64 __fastcall VslpIumPhase0Initialize(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(result + 132) & 0x200) != 0 )
  {
    ...
    v10 = 0;
    qword_140C47170 = (__int64)&qword_140C47168;
    qword_140C47168 = (__int64)&qword_140C47168;
    dword_140C47164 = HIDWORD(v12[2]);
    dword_140C47178 = HIDWORD(v12[2]);
