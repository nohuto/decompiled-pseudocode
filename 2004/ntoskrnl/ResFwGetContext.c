/*
 * XREFs of ResFwGetContext @ 0x1409EE088
 * Callers:
...
__int64 __fastcall ResFwGetContext(__int64 *a1)
{
  ...
  *a1 = 0LL;
  if ( (v3 & 1) == 0 )
    return 3221225473LL;
  v4 = dword_140C1332C;
  if ( dword_140C13330 >= (unsigned int)dword_140C1332C )
    v4 = dword_140C13330;
  v5 = (dword_140C1333C + v4 + dword_140C13338 + 20479) & 0xFFFFF000;
  ...
  *(_QWORD *)(v10 + 240) = v1;
  BgpAnimationRegionSave = qword_140C133D0;
  BgpTextRegionSave = qword_140C133D8;
  result = 0LL;
  *a1 = v10;
  return result;
}
