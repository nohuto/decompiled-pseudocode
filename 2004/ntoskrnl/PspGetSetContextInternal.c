/*
 * XREFs of PspGetSetContextInternal @ 0x1406AC990
 * Callers:
 ...
 *     RtlpVirtualUnwind @ 0x1402E94A0 (RtlpVirtualUnwind.c)
 *     __security_check_cookie @ 0x1403CCE60 (__security_check_cookie.c)
 *     KeVerifyContextIpForUserCet @ 0x1403ED6A4 (KeVerifyContextIpForUserCet.c)
...
LABEL_33:
    ...
    if ( !v41 )
    {
      ...
      if ( CurrentThread[1].WaitBlock[3].Thread && *(_BYTE *)(a1 + 88) == 1 )
      {
        ...
        {
          RtlCopyContext(v35, *(unsigned int *)(v35 + 48), CurrentThread[1].WaitBlock[3].Thread);
          *(_DWORD *)(a1 + 92) = 0;
          goto LABEL_60;
        }
      }
