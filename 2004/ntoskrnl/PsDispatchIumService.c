/*
 * XREFs of PsDispatchIumService @ 0x14057D8B4
 * Callers:
 ...
 *     PspIumGetSystemData @ 0x1409098A8 (PspIumGetSystemData.c)
    ...
    if ( v5 <= 0x12 )
    {
      ...
      if ( v24 )
      {
        ...
        if ( !v25 )
        {
          ...
          if ( Process != v29 )
          {
            KiStackAttachProcess(v29, 0LL, (__int64)v73);
            v29 = *(_KPROCESS **)(a1 + 8);
          }
      ...
      v31 = *(_KPROCESS **)(a1 + 8);
      if ( v17 != v31 )
        KiStackAttachProcess(v31, 0LL, (__int64)v73);
...
LABEL_146:
  ...
  if ( v5 == 12 )
  {
    ...
    v18 = *(_KPROCESS **)(a1 + 8);
    if ( v17 != v18 )
      KiStackAttachProcess(v18, 0LL, (__int64)v73);
    v19 = 0;
    v20 = 0LL;
    v21 = *(_QWORD *)(a1 + 48);
    if ( v21 || *(_QWORD *)(a1 + 56) )
  ...
  if ( v5 > 6 )
  {
    ...
    if ( !v12 )
    {
      LOBYTE(v11) = KeAlertThreadByThreadId(*(_QWORD *)(a1 + 8), a2);
      goto LABEL_24;
    }
    v13 = v12 - 1;
    if ( v13 )
