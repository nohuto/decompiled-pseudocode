/*
 * XREFs of IopCreateSecureDeviceClassSettings @ 0x14074CC84
 * Callers:
...
__int64 __fastcall IopCreateSecureDeviceClassSettings(PGUID Guid, __int64 a2, _BYTE *a3)
{
  ...
  ULONG v23; // [rsp+100h] [rbp+7Fh] BYREF
...
LABEL_44:
    ...
    {
      SecureDeviceClassState = IopQuerySecureDeviceClassState(v17, (__int64)a3);
      if ( SecureDeviceClassState < 0 )
        goto LABEL_12;
      if ( (*a3 & 0xF) == 0xF )
        goto LABEL_11;
...
LABEL_11:
        ...
        if ( v23 == 2 )
        {
          ...
          *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
          ...
          if ( v12 >= 0 )
          {
            v13 = IopQuerySecureDeviceClassState(v17, (__int64)a3);
LABEL_41:
