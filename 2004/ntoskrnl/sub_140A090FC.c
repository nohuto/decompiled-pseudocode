/*
 * XREFs of sub_140A090FC @ 0x140A090FC
 * Callers:
...
__int64 __fastcall sub_140A090FC(_QWORD *a1, __int64 a2, unsigned int a3)
{
  __int64 v3; // r13
  __int64 v4; // r15
  int *v5; // r8
...
LABEL_88:
  ...
  if ( (v29 & 0x10) != 0 && !(unsigned int)sub_140A0CC50(v10, BugCheckParameter2, v57, v58) )
  {
    v29 &= ~0x10u;
    v387 = v29;
  }
  if ( (v29 & 2) == 0 || v56 )
  {
    ...
    {
      v33 = sub_140A18FE4(&v341, BugCheckParameter2, v29);
      goto LABEL_477;
    }
    ...
    {
      v344 = sub_140A0BB30(v10, v72, v69);
      v73 = (_BYTE *)v344;
      if ( !v344 )
      {
        v33 = -1073741670;
...
LABEL_151:
      ...
      if ( (*((_DWORD *)v73 + 613) & 0x8000) == 0 || (v103[8] |= 1u, !(unsigned int)sub_140A0CC50(v73, v104, v93, v71)) )
      {
LABEL_152:
        v106 = v387;
        v345 = v73;
        v341 = v73;
        v33 = sub_140A0B098((unsigned int)&v345, (_DWORD)v336, v339, v104, v105, v387, (__int64)&v346, (__int64)v351);
        if ( v33 < 0 )
          goto LABEL_476;
        v107 = 6LL;
        v108 = v345;
        ...
        *((_DWORD *)v108 + 522) += v110;
        ...
        if ( v109 == (_DWORD *)-96LL )
        {
          ...
          {
            v136 = (_BYTE *)sub_140A0BB30(v108, v135, *((unsigned int *)v108 + 585));
            if ( !v136 )
              goto LABEL_195;
        ...
        if ( (*((_DWORD *)v136 + 612) & 0x40000000) != 0 && v149 )
          sub_1403E6E8C((__int64)v136, v147, v149, (__int64)(v131 + 28));
        *((_DWORD *)v131 + 6) = 0;
        if ( v132 )
          *((_DWORD *)v131 + 6) = 1;
...
LABEL_271:
            ...
            {
              v343 = (_DWORD *)sub_140A0BB30(v136, v198, *((unsigned int *)v136 + 585));
              v199 = v343;
              if ( !v343 )
                goto LABEL_195;
  ...
  if ( (v322 & 0x80000004) != 0x80000004 )
  {
    ...
    if ( (unsigned int)v326 >= 0x14 )
    {
      ...
      for ( kk = v327 + v324; kk != v328; kk += 20LL )
      {
        ...
        if ( v331 )
        {
          result = sub_140A090FC(&v341, v331, v323);
          *a1 = v341;
