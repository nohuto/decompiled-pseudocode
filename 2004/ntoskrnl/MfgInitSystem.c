/*
 * XREFs of MfgInitSystem @ 0x140A7056C
 * Callers:
...
__int64 __fastcall MfgInitSystem(__int64 a1)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    inited = ZwSetValueKey(KeyHandle, &ValueName, 0, 1u, qword_140C195B0, WORD5(ExpManufacturingInformation));
    if ( inited < 0 )
      goto LABEL_22;
