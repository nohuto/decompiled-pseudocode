/*
 * XREFs of EtwpEnableKernelTrace @ 0x140780518
 * Callers:
...
LABEL_57:
  ...
  {
    v12 |= 0x400u;
    qword_140C54550 = (__int64)EtwpTraceIoInit;
    LODWORD(v25) = v12;
  }
  v13 = *((_DWORD *)a2 + 4);
  v14 = v26;
  ...
  {
    v14 = v26 | 1;
    qword_140C54558 = (__int64)EtwpTraceOpticalIo;
    v13 = *((_DWORD *)a2 + 4);
    LODWORD(v26) = v26 | 1;
  }
  if ( (v13 & 2) != 0 )
  {
    v14 |= 2u;
    qword_140C54560 = (__int64)EtwpTraceOpticalIoInit;
    LODWORD(v26) = v14;
  }
  ...
  {
    v14 |= 0x1000000u;
    qword_140C11EC0 = (__int64)EtwpTraceWdf;
    v15 = *((_DWORD *)a2 + 4);
    LODWORD(v26) = v14;
  }
  if ( (v15 & 0x2000000) != 0 )
  {
    v14 |= 0x2000000u;
    qword_140C11EC8 = (__int64)EtwpTraceWdf;
    LODWORD(v26) = v14;
  }
  if ( (*((_DWORD *)a2 + 2) & 0x8000000) != 0 )
  {
    DWORD2(v25) |= 0x8000000u;
    qword_140C11ED0 = (__int64)EtwpSystemTraceWdf;
  }
  v16 = *(_DWORD *)a2;
...
LABEL_50:
    ...
    if ( (v17 & 0x400) != 0 )
    {
      for ( i = 0; i < EtwpPmcProfile; ++i )
        KeStartProfile((ULONG_PTR)qword_140C19C28 + 248 * i);
      DWORD1(v25) = v8 | 0x400;
    }
