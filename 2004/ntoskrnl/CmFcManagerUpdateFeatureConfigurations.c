/*
 * XREFs of CmFcManagerUpdateFeatureConfigurations @ 0x14087A7F4
 * Callers:
 ...
 *     CmFcpIncrementChangeStamp @ 0x1407C297C (CmFcpIncrementChangeStamp.c)
...
__int64 __fastcall CmFcManagerUpdateFeatureConfigurations(__int64 a1, __int64 a2, int a3, __int64 a4, unsigned int a5)
{
  ...
  CmpVolumeManagerLockContextListExclusive((ULONG_PTR)&stru_140C47F50);
  RtlpFcBufferManagerReferenceBuffers((__int64)qword_140C47FB0, (__int64)&v29, &v35);
  v10 = v35;
  v11 = 3LL;
  if ( a2 && v29 != a2 )
  {
    ...
    if ( v12 >= 0 )
    {
      ...
      if ( v12 >= 0 )
      {
        ...
        if ( v12 >= 0 )
        {
          if ( (int)RtlpFcValidateFeatureConfigurationBuffer((unsigned int *)v9[1], v9[2]) < 0 )
          {
            if ( (unsigned int)dword_140C01988 > 5 && tlgKeywordOn((__int64)&dword_140C01988, 0x400000000001LL) )
            {
              ...
              tlgWriteTransfer_EtwWriteTransfer(
                ...
                (unsigned __int8 *)byte_140022D1F,
                0LL,
                0LL,
                3u,
                &v38);
          ...
          v15 = v33;
LABEL_18:
          RtlpFcBufferManagerDereferenceBuffers((__int64)qword_140C47FB0, v10);
          CmpVolumeManagerLockContextListExclusive((ULONG_PTR)&RunOnce);
          v21 = 3LL * v30[0];
          v22 = qword_140C47F68[3 * v30[0]];
          qword_140C47F68[v21] = v15;
          v23 = qword_140C47F68[v21 + 1];
          *(_QWORD *)&v33 = v22;
          qword_140C47F68[v21 + 1] = *((_QWORD *)&v33 + 1);
          v24 = qword_140C47F68[v21 + 2];
          qword_140C47F68[v21 + 2] = v20;
          *((_QWORD *)&v33 + 1) = v23;
          v34 = v24;
          RtlpFcBufferManagerUpdateBuffers(qword_140C47FB0, v13, (__int64)v37);
          RtlpFcWriteHighLowHigh((__int64)&qword_140C47F58, v13);
          RtlpFcWriteHighLowHigh(0xFFFFF78000000710uLL, v25);
          CmSiRWLockReleaseExclusive((volatile signed __int64 *)&RunOnce);
          CmSiRWLockReleaseExclusive((volatile signed __int64 *)&stru_140C47F50);
