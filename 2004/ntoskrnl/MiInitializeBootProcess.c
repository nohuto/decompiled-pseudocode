/*
 * XREFs of MiInitializeBootProcess @ 0x140A55BC4
 * Callers:
...
__int64 MiInitializeBootProcess()
{
  ...
  *v1 = 0LL;
  ...
  v2 = (unsigned __int64 **)qword_140C4DC30;
  p_UserDirectoryTableBase = &Process[1].UserDirectoryTableBase;
  if ( *(__int64 **)qword_140C4DC30 != &qword_140C4DC28 )
    __fastfail(3u);
  *(_QWORD *)&Process[1].AddressPolicy = qword_140C4DC30;
  *p_UserDirectoryTableBase = (unsigned __int64)&qword_140C4DC28;
  *v2 = p_UserDirectoryTableBase;
  qword_140C4DC30 = (__int64)&Process[1].UserDirectoryTableBase;
