/*
 * XREFs of HalpAllocateDomainCommonBufferInternal @ 0x14039E464
 * Callers:
 *     HalAllocateCommonBufferExV3 @ 0x14039E3E0 (HalAllocateCommonBufferExV3.c)
 *     HalAllocateDomainCommonBuffer @ 0x1404BF650 (HalAllocateDomainCommonBuffer.c)
 *     HalAllocateCommonBufferWithBounds @ 0x1404C0C20 (HalAllocateCommonBufferWithBounds.c)
 * Callees:
