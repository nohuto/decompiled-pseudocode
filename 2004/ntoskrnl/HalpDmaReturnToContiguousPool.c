/*
 * XREFs of HalpDmaReturnToContiguousPool @ 0x1404C3124
 * Callers:
 *     HalpDmaReturnPageToOwner @ 0x1404C305C (HalpDmaReturnPageToOwner.c)
 *     HalpDmaReturnPageToSource @ 0x1404C30D4 (HalpDmaReturnPageToSource.c)
 * Callees:
 *     KeReleaseInStackQueuedSpinLockFromDpcLevel @ 0x14020A870 (KeReleaseInStackQueuedSpinLockFromDpcLevel.c)
 *     RtlClearBits @ 0x140281070 (RtlClearBits.c)
 *     KeAcquireInStackQueuedSpinLock @ 0x1402C0E10 (KeAcquireInStackQueuedSpinLock.c)
 *     HalpDmaTranslationEntryToIndex @ 0x1403B8AD8 (HalpDmaTranslationEntryToIndex.c)
