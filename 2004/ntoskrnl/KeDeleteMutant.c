/*
 * XREFs of KeDeleteMutant @ 0x140338CD8
 * Callers:
 *     ExpDeleteMutant @ 0x140338CC0 (ExpDeleteMutant.c)
 * Callees:
    ...
    if ( v24 != (_QWORD *)(BugCheckParameter2 + 8) )
    {
      while ( 1 )
      {
        ...
        *v30 = v28;
        ...
        if ( v31 == 1 )
        {
          if ( (unsigned __int8)KiTryUnwaitThread((__int64)CurrentPrcb, v29, *(unsigned __int16 *)(v29 + 18), &v40) )
          {
        ...
        else if ( v31 == 2 )
        {
          ...
          *(_QWORD *)v29 = 0LL;
          ...
          {
            LOBYTE(v38) = KeIsThreadRunning(v36->CurrentThread, v21);
          ...
          if ( (_QWORD *)*v34 == v34
            ...
            || !KiWakeQueueWaiter((__int64)v36, v33, v29) )
          {
            ...
            *(_QWORD *)(v33 + 32) = v29;
            if ( !(_DWORD)v22 && (_QWORD *)*v34 != v34 )
              KiWakeOtherQueueWaiters((__int64)v36, v33, v22, (__int64)v23);
          }
...
LABEL_58:
        ...
        {
          KiTryUnwaitThread((__int64)CurrentPrcb, v29, 256LL, 0LL);
        }
        if ( v24 == (_QWORD *)(BugCheckParameter2 + 8) )
          goto LABEL_58;
      }
