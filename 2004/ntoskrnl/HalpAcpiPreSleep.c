/*
 * XREFs of HalpAcpiPreSleep @ 0x14099269C
 * Callers:
 ...
 *     KeSynchronizeTimeToQpc @ 0x140383B90 (KeSynchronizeTimeToQpc.c)
 ...
 *     HalpSaveDmaControllerState @ 0x140992830 (HalpSaveDmaControllerState.c)
 */
...
void *__fastcall HalpAcpiPreSleep(int a1)
{
  ...
  {
    HalpAcpiPmRegisterRead(0, (unsigned __int8)byte_140C49E98 >> 1, (__int64)&v10, 2u, 0LL);
    v6 = v10;
    v9 = v10;
    if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
    {
      HalpAcpiPmRegisterRead(3, (unsigned __int8)byte_140C49E98 >> 1, (__int64)&v10, 2u, 0LL);
      v6 = v10 | v9;
      v9 |= v10;
    }
    if ( (dword_140C49EB0 & 0x40) == 0 )
    {
    ...
    HalpAcpiPmRegisterWrite(0, (unsigned __int8)byte_140C49E98 >> 1, (__int64)&v9, 2u, 0LL);
    if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
      HalpAcpiPmRegisterWrite(3, (unsigned __int8)byte_140C49E98 >> 1, (__int64)&v9, 2u, 0LL);
