        ...
        __int64 a4)
{
  ...
  _DWORD v98[2]; // [rsp+70h] [rbp-29h] BYREF
  ULONG_PTR v99; // [rsp+78h] [rbp-21h]
  __int64 v100; // [rsp+80h] [rbp-19h]
  ULONG_PTR BugCheckParameter1; // [rsp+88h] [rbp-11h]
  int v102; // [rsp+90h] [rbp-9h]
  __int64 v103; // [rsp+98h] [rbp-1h]
  _DWORD *v104; // [rsp+A0h] [rbp+7h]
  __int64 v105; // [rsp+A8h] [rbp+Fh]
  void *retaddr; // [rsp+F8h] [rbp+5Fh]
  int v107; // [rsp+100h] [rbp+67h]
  struct _KTHREAD *v108; // [rsp+100h] [rbp+67h]
  char v110; // [rsp+110h] [rbp+77h]
  unsigned __int8 AbAllocationRegionCount; // [rsp+110h] [rbp+77h]
  KIRQL v112; // [rsp+110h] [rbp+77h]
  unsigned __int8 v113; // [rsp+110h] [rbp+77h]
  ...
  v84 = CurrentIrql + 1;
  v105 = 0x7FFFFFFFFFFFFFFCLL;
  while ( 1 )
  {
    v100 = v7;
    if ( *(_QWORD *)(v7 + 8) )
      break;
    v102 = *(_DWORD *)(v7 + 52) & 0x3FFFFFFF;
      ...
      if ( active != -1073741302 )
      {
        ...
        if ( !v107 )
        {
          ...
          if ( (unsigned int)MiGetSystemRegionType(v51) == 1 )
            v52 = (unsigned int)MmGetSessionIdEx((__int64)v108->ApcState.Process);
          else
            v52 = 0xFFFFFFFFLL;
          v53 = (ULONG_PTR)v108;
          --v108->SpecialApcDisable;
          ++v108->AbAllocationRegionCount;
          v54 = BugCheckParameter2b;
          AbAllocationRegionCount = v108->AbAllocationRegionCount;
          v100 = BugCheckParameter2b & 0x7FFFFFFFFFFFFFFCLL;
          LODWORD(v55) = ((char)v108->AbEntrySummary | (char)v108->AbOrphanedEntrySummary) ^ 0x3F;
          ...
          while ( 1 )
          {
            v57 = (__int64)&v108->LockEntries[v56];
            v103 = v57;
            v55 = ~(1 << v56) & (unsigned int)v55;
            if ( (*(_BYTE *)(v57 + 26) & 1) != 0
              && (*(_DWORD *)(v57 + 32) & 1) == 0
              && (*(_QWORD *)(v57 + 32) & 0x7FFFFFFFFFFFFFFCLL) == v100
          ...
          {
LABEL_135:
            if ( (*((_DWORD *)&v108->0 + 1) & 0x10000) == 0 )
              KeBugCheckEx(0x162u, (ULONG_PTR)v108, BugCheckParameter2b, v52, 0LL);
          }
          else
          {
            *(_BYTE *)(v57 + 32) |= 2u;
    ...
    v99 = v7;
    if ( v107 != 1 || (*(_DWORD *)(v7 + 52) & 0x40000000) == 0 )
      goto LABEL_14;
    ExReleaseSpinLockExclusiveFromDpcLevel((PEX_SPIN_LOCK)v4 + 18);
    if ( KiIrqlFlags )
    {
...
LABEL_191:
  ...
  if ( !v107 )
  {
    ...
    if ( (unsigned int)MiGetSystemRegionType(v76) == 1 )
      v77 = (unsigned int)MmGetSessionIdEx((__int64)v108->ApcState.Process);
    else
      v77 = 0xFFFFFFFFLL;
    v53 = (ULONG_PTR)v108;
    --v108->SpecialApcDisable;
    ...
    v113 = v108->AbAllocationRegionCount;
    LODWORD(v78) = ((char)v108->AbEntrySummary | (char)v108->AbOrphanedEntrySummary) ^ 0x3F;
    ...
    {
      v80 = ~(1 << v79);
      v81 = (__int64)&v108->LockEntries[v79];
      v78 = v80 & (unsigned int)v78;
      v100 = v81;
      if ( (*(_BYTE *)(v81 + 26) & 1) != 0
        && (*(_DWORD *)(v81 + 32) & 1) == 0
        && (v105 & *(_QWORD *)(v81 + 32)) == (BugCheckParameter2c & 0x7FFFFFFFFFFFFFFCLL)
...
LABEL_189:
      if ( (*((_DWORD *)&v108->0 + 1) & 0x10000) == 0 )
        KeBugCheckEx(0x162u, (ULONG_PTR)v108, BugCheckParameter2c, (unsigned int)v77, 0LL);
    }
    else
    {
      *(_BYTE *)(v81 + 32) |= 2u;
...
LABEL_140:
    ...
    v20 = v108->SpecialApcDisable++ == -1;
    if ( v20 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v108->ApcState.ApcListHead[0].Flink != &v108->152 )
      KiCheckForKernelApcDelivery();
    KiLeaveGuardedRegionUnsafe((__int64)CurrentThread);
  }
LABEL_144:
...
LABEL_145:
  if ( v99 )
  {
    v112 = ExAcquireSpinLockExclusive(v45);
    ...
    if ( KiIrqlFlags && (KiIrqlFlags & 1) != 0 && (v62 = KeGetCurrentIrql(), v62 <= 0xFu) )
    {
      ...
      if ( v112 <= 0xFu && v62 >= 2u )
      {
        ...
        v65 = ~(unsigned __int16)(-1LL << (v112 + 1));
    ...
    __writecr8(v63);
    if ( v61 )
      MiReturnCrossPartitionSectionCharges(*(_QWORD *)(qword_140C4E448 + 8LL * (*((_WORD *)v4 + 30) & 0x3FF)), v50, v61);
    result = v114;
  }
  if ( (v5 & 1) != 0 )
  {
