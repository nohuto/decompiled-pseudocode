/*
 * XREFs of HalpAllocateDmaResourcesInternal @ 0x1404C56AC
 * Callers:
 *     HalpDmaReturnEmergencyLogicalAddressResources @ 0x1404B3488 (HalpDmaReturnEmergencyLogicalAddressResources.c)
 *     HalpDmaProcessMapRegisterQueueV3 @ 0x1404C1468 (HalpDmaProcessMapRegisterQueueV3.c)
 ...
 *     HalpAllocateDmaResources @ 0x1404C5690 (HalpAllocateDmaResources.c)
 * Callees:
