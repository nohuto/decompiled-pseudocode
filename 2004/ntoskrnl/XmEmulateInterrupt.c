/*
 * XREFs of XmEmulateInterrupt @ 0x140393B0C
 * Callers:
...
__int64 __fastcall XmEmulateInterrupt(unsigned __int8 a1, __int64 a2)
{
  ...
  if ( !XmEmulatorInitialized )
    return 4LL;
  XmStatus = 0;
  word_140CED21C = dword_140CED380;
  dword_140CED208 = HIWORD(dword_140CED380);
  v4 = x86BiosTranslateAddress((unsigned __int16)dword_140CED380, HIWORD(dword_140CED380));
  *(_WORD *)(v4 - 6) = -1;
  *(_DWORD *)(v4 - 4) = 0xFFFF;
  LOWORD(dword_140CED208) = dword_140CED208 - 6;
