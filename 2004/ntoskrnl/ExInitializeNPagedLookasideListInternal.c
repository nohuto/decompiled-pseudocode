/*
 * XREFs of ExInitializeNPagedLookasideListInternal @ 0x1403787D0
 * Callers:
        ...
        int a8)
{
  ...
  *(_QWORD *)(a1 + 80) = 0LL;
  ...
  v13 = (_QWORD *)qword_140C168E8;
  v14 = (_QWORD *)(a1 + 64);
  if ( *(__int64 **)qword_140C168E8 != &ExNPagedLookasideListHead )
    __fastfail(3u);
  *v14 = &ExNPagedLookasideListHead;
  v14[1] = v13;
  *v13 = v14;
  qword_140C168E8 = (__int64)v14;
