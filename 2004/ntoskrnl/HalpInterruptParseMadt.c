/*
 * XREFs of HalpInterruptParseMadt @ 0x1403AC664
 * Callers:
 *     HalpInterruptParseAcpiTables @ 0x1403AC5F0 (HalpInterruptParseAcpiTables.c)
 * Callees:
 *     HalpInterruptGsiToLine @ 0x140376B3C (HalpInterruptGsiToLine.c)
 *     HalpInterruptSortProcessorTable @ 0x1403ACBDC (HalpInterruptSortProcessorTable.c)
...
LABEL_44:
        v34 = ~((unsigned int)KeGetCurrentPrcb()->LogicalProcessorsPerCore - 1);
        ...
        if ( (unsigned int)HalpInterruptProcessorCount > 1 )
        {
          ...
          do
          {
            if ( (*v39 & (unsigned int)v34) != (_DWORD)v35 )
              break;
            ++v38;
            v39 += 16;
          }
          ...
          if ( v29 == 2 && (_BYTE)v27 == 10 )
          {
            if ( (int)HalpInterruptGsiToLine(*((unsigned int *)v28 + 1), &v87) >= 0 )
            {
              ...
              *(_DWORD *)(v57 + 32) = (v28[8] & 8) == 0;
              v61 = (__int64 *)qword_140C496C8;
              if ( *(__int64 **)qword_140C496C8 != &HalpInterruptOverrides )
                __fastfail(3u);
