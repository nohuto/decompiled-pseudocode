/*
 * XREFs of WheaInitialize @ 0x140A5A6DC
 * Callers:
 ...
 *     WheapCheckForClzeroSupport @ 0x1403B76BC (WheapCheckForClzeroSupport.c)
 ...
 *     WheapQueryPshedForErrorSources @ 0x140A5AF78 (WheapQueryPshedForErrorSources.c)
 */
...
__int64 __fastcall WheaInitialize(__int64 a1, unsigned int a2)
{
  ...
  if ( !a2 )
  {
    ...
    qword_140CDAF30 = (__int64)&qword_140CDAF28;
    qword_140CDAF28 = (__int64)&qword_140CDAF28;
    KeInitializeEvent(&stru_140CDAF38, SynchronizationEvent, 1u);
    ...
    if ( v49 )
    {
      do
      {
        v10 = qword_140CF4418[8 * (__int64)v8[2]](0LL, v8, 0LL);
        if ( v10 < 0 )
  ...
  qword_140C15F18 = (__int64)&WheapPrevErrList;
...
LABEL_19:
  ...
  if ( (unsigned __int64)&WheapConfigTableLock >= 0xFFFF800000000000uLL
    && byte_140C4F7C8[(((unsigned __int64)&WheapConfigTableLock >> 39) & 0x1FF) - 256] == 1
...
LABEL_29:
  ...
  for ( j = qword_140CDAF28; (__int64 *)j != &qword_140CDAF28; j = *(_QWORD *)j )
  {
    if ( *(_DWORD *)(j + 104) == 7 )
    {
      *(_DWORD *)(j + 108) = 2;
  ...
  v29 = qword_140CDAF28;
  v30 = 0;
  while ( (__int64 *)v29 != &qword_140CDAF28 )
  {
