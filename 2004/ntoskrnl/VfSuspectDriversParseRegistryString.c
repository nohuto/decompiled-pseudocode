/*
 * XREFs of VfSuspectDriversParseRegistryString @ 0x140A91304
 * Callers:
...
LABEL_27:
    ...
    else
    {
      ...
      {
        VfDriverLock();
        v11 = (_QWORD *)qword_140C1CC28;
        if ( *(__int64 **)qword_140C1CC28 != &VfExcludedDriversList )
          __fastfail(3u);
        *v10 = &VfExcludedDriversList;
        v10[1] = v11;
        *v11 = v10;
        qword_140C1CC28 = (__int64)v10;
        goto LABEL_27;
      }
    }
    v4 = 0x100002601LL;
