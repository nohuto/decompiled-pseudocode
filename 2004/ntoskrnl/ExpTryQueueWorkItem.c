/*
 * XREFs of ExpTryQueueWorkItem @ 0x1402BCA80
 * Callers:
...
char __fastcall ExpTryQueueWorkItem(__int64 a1, _QWORD *a2, unsigned int a3, int a4)
{
  int v4; // r12d
  char inserted; // r15
  ...
  if ( (unsigned __int16)v9 < (unsigned __int16)KeNumberNodes )
  {
    while ( 1 )
    {
      ...
      {
        v14 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 8) + 8LL * *(unsigned __int16 *)(v11 + 146)) + 8LL * a4);
        if ( (v14 & 1) != 0 )
          v14 = 0LL;
