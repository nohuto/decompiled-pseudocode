/*
 * XREFs of PpmPerfApplyDomainState @ 0x140330D80
 * Callers:
 ...
 *     PpmPerfApplyCapsAndFloors @ 0x14033133C (PpmPerfApplyCapsAndFloors.c)
...
__int64 __fastcall PpmPerfApplyDomainState(__int64 a1)
{
  ...
  v53 = 0;
  v4 = *(_QWORD *)(a1 + 16);
  v65 = &PpmCurrentProfile[342 * dword_140C238AC + 5];
