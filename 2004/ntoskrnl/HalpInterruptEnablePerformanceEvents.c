/*
 * XREFs of HalpInterruptEnablePerformanceEvents @ 0x1403A0C10
 * Callers:
 *     EmonPreOverflowHandler @ 0x1404CF170 (EmonPreOverflowHandler.c)
 ...
 *     HalpInterruptGetPriority @ 0x1403A12EC (HalpInterruptGetPriority.c)
