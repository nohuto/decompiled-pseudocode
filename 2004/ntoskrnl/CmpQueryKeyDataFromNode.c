/*
 * XREFs of CmpQueryKeyDataFromNode @ 0x140670220
 * Callers:
 ...
 *     CmGetVisibleValueCount @ 0x140654398 (CmGetVisibleValueCount.c)
...
LABEL_4:
    ...
    if ( a8 )
    {
      while ( 1 )
      {
        ...
        if ( !PrevElement )
          break;
        if ( CmEqualTrans(*(_QWORD *)(PrevElement + 56), a8) && *(_DWORD *)(v22 + 68) == 8 )
        {
          v12 = *(_QWORD *)(v22 + 88);
          break;
        }
