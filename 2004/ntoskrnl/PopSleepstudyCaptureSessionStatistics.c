/*
 * XREFs of PopSleepstudyCaptureSessionStatistics @ 0x1408F6E08
 * Callers:
...
struct _KTHREAD *__fastcall PopSleepstudyCaptureSessionStatistics(__int64 a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( !v7 )
  {
    for ( i = 1; i <= 2; ++i )
    {
      v9 = (char *)&unk_140C1E2B8 + 96 * (((unsigned __int8)dword_140C1E2B0 - (unsigned __int8)i) & 7);
