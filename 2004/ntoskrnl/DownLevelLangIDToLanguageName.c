/*
 * XREFs of DownLevelLangIDToLanguageName @ 0x140362A8C
 * Callers:
 ...
 * Callees:
 *     ?StringCchCopyNW@@YAJPEAG_KPEBG1@Z @ 0x14037DE7C (-StringCchCopyNW@@YAJPEAG_KPEBG1@Z.c)
 *     ?IsNeutralLanguageItem@@YAHPEBUCultureDataType@@@Z @ 0x1403A4CA0 (-IsNeutralLanguageItem@@YAHPEBUCultureDataType@@@Z.c)
