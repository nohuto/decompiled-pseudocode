        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_140CDAF61 )
  {
    ...
    v56 = qword_140C10DE8;
    v55 = qword_140C10E60;
    v54 = (_BYTE *)qword_140C10E20;
    v57 = (_BYTE *)qword_140C10E30;
    v10 = 10 * (dword_140C10DE0 - dword_140C10DE0 / (unsigned int)(dword_140C13314 - dword_140C10DE4));
    v13 = 0;
    if ( (unsigned int)BgpGetBitsPerPixel() == 24 )
    {
      if ( !v9 )
      {
        ...
        v32 = 0LL;
        v33 = *(_QWORD *)(v6 + 24);
        for ( i = *(_QWORD *)(qword_140C10E28 + 24);
    ...
    else
    {
      if ( !v9 )
      {
        ...
        v15 = 0LL;
        v16 = *(_QWORD *)(v6 + 24);
        for ( m = *(_QWORD *)(qword_140C10E28 + 24);
    ...
    if ( !v7 )
    {
      if ( !v4 && !v22 || (BgpGxDrawRectangle(v54, (__int64)&xmmword_140C10E00), !v22) )
        v7 = 1;
    }
    if ( !v8 )
    {
      if ( !v4 && !v30 || (BgpGxDrawRectangle((_BYTE *)v55, (__int64)&xmmword_140C10E38), !v30) )
        v8 = 1;
    }
    ...
    if ( v13 || v30 || v22 )
    {
      byte_140C10DF0 = v7;
      byte_140C10DF1 = v8;
      dword_140C10DE0 = v10 / 0xA;
      dword_140C10DE4 = v4 + 1;
      byte_140C10DF2 = v9;
    }
    else
    {
      byte_140CDAF61 = 0;
      KeCancelTimer(&stru_140CF2F00);
      KeSetEvent(&stru_140CF2F40, 0, 0);
    }
  }
  BgpFwReleaseLock();
}
