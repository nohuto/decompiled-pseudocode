/*
 * XREFs of KiEpfStart @ 0x14051EDA4
 * Callers:
 *     KeWaitPhysicalFaultCompletion @ 0x14051EAAC (KeWaitPhysicalFaultCompletion.c)
 *     KiEpfHandleNotification @ 0x14051ED80 (KiEpfHandleNotification.c)
 * Callees:
...
LABEL_6:
  ...
  if ( v5 )
  {
    _InterlockedIncrement(&dword_140C2AE50);
    v6 = _InterlockedIncrement(&dword_140C2AE54);
    do
      v9 = dword_140C2AE58;
    while ( dword_140C2AE58 < v6 && v9 != _InterlockedCompareExchange(&dword_140C2AE58, v6, dword_140C2AE58) );
    v10 = KeSetKernelStackSwapEnable(0);
    KeWaitForGate((__int64)&v14, 0x27u);
    KeSetKernelStackSwapEnable(v10);
    _InterlockedDecrement(&dword_140C2AE54);
  }
}
