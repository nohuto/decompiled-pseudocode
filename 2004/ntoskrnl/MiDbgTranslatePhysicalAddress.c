/*
 * XREFs of MiDbgTranslatePhysicalAddress @ 0x140540D20
 * Callers:
...
unsigned __int64 __fastcall MiDbgTranslatePhysicalAddress(unsigned __int64 a1, char a2, __int64 a3)
{
  ...
  v3 = qword_140C4E688;
  v6 = a1;
  if ( !qword_140C4E688 || !(unsigned int)MiCheckPhysicalAddressRange(a1, 1LL) )
    return 0LL;
  v9 = 2LL;
  v10 = v3 << 25 >> 16;
  v11 = v7 >> 12;
  ...
  *(_BYTE *)(a3 + 4) = CurrentIrql;
  ...
  {
    *(_DWORD *)a3 = 8;
    if ( !(unsigned int)ExTryAcquireSpinLockExclusiveAtDpcLevel(&dword_140C4EA40) )
      return 0LL;
  }
  else
  {
  ...
  v18 = (_QWORD *)*((_QWORD *)&xmmword_140C4EA48 + 1);
  v19 = 3;
  while ( v18 )
  {
    v20 = v18[5];
...
LABEL_67:
  v28 = v12 | 0xA0000000;
  v29 = (volatile signed __int64 *)qword_140C4E688;
  ValidPte = MiMakeValidPte(qword_140C4E688, v11, v28, v17);
  if ( (a2 & 0x41) != 0 )
    byte_140C4E680 = 1;
