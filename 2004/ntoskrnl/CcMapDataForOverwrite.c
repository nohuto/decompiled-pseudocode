/*
 * XREFs of CcMapDataForOverwrite @ 0x14033C3B8
 * Callers:
...
__int64 __fastcall CcMapDataForOverwrite(__int64 a1, _DWORD *a2, __int64 a3, _DWORD *a4, unsigned __int64 *a5)
{
  int v5; // r12d
  int v6; // r13d
  ...
  v6 = (int)a2;
  v24 = 0LL;
  v23 = ((unsigned int)a3 + 4095LL + (unsigned __int64)(*a2 & 0xFFF)) >> 12;
  ...
  {
    Partition = CcGetPartition(*(_QWORD **)(v8 + 8), (__int64)a2, a3, a4);
  ...
  v11 = a5;
  CcMapDataCommon(v28, v6, v5, 1, (__int64)&v24, (__int64)a5);
  v12 = *v11;
  v25 = v12;
  v13 = v23;
  while ( v13 )
  {
    ...
    MmCheckCachedPageStates(v12, 1LL, 5, &v29);
    if ( !v29 )
