/*
 * XREFs of MiInitializeTbFlush @ 0x140A536F8
 * Callers:
...
_QWORD *__fastcall MiInitializeTbFlush(unsigned __int64 a1)
{
  ...
  result = (_QWORD *)MiReservePtes((__int64)&qword_140C4ED40, v1, v2, v3);
  v36 = result;
  v6 = result;
  if ( result )
  {
    v37[3] = 0LL;
    LODWORD(v37[1]) = 20;
    ValidPte = MiMakeValidPte((unsigned __int64)result, qword_140C4EB68, 1LL, v5);
...
LABEL_25:
              if ( v13 == 3 )
                return (_QWORD *)MiReleasePtes((__int64)&qword_140C4ED40, v36, v1);
LABEL_29:
              qword_140C4DD90 = v14;
              return (_QWORD *)MiReleasePtes((__int64)&qword_140C4ED40, v36, v1);
            }
