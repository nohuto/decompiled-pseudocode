/*
 * XREFs of MiRemoveUnusedSegments @ 0x14052524C
 * Callers:
...
__int64 __fastcall MiRemoveUnusedSegments(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( a2 )
  {
    if ( a2 >= qword_140C528A8 )
      v6 = 0LL;
    else
      v6 = qword_140C528A8 - a2;
    v7 = 0;
  }
  else
  {
  ...
  v8 = 1000LL * *(_QWORD *)(a1 + 6928) / qword_140C52690;
  if ( v8 )
  {
    v9 = *(_QWORD *)(a1 + 1696);
    v10 = v9;
    if ( v8 * (qword_140C4C798 / 0x3E8uLL) <= v9 )
      v10 = v8 * (qword_140C4C798 / 0x3E8uLL);
    if ( v10 )
    {
      v11 = v9 - v10;
      if ( v11 < 0x100000 )
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          if ( a2 )
          {
            if ( qword_140C528A8 <= v6 )
              return v2;
          }
          else
          {
            if ( !v7 || qword_140C528A8 < 9 * (qword_140C52928 / 0xAuLL) )
              return v2;
            --v7;
          }
