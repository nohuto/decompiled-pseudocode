/*
 * XREFs of PnpDeviceActionWorker @ 0x14036DEC0
 * Callers:
...
LABEL_6:
    ...
    if ( v5 )
    {
      ...
      if ( v8 )
      {
        v34 = 1;
        v37 = *(_OWORD *)(v5 + 56);
        KeGetCurrentThread()[1].WaitBlock[1].WaitListEntry.Flink = (struct _LIST_ENTRY *)&v37;
      }
...
LABEL_36:
    ...
    else if ( v0 || v1 )
    {
      ...
      PipProcessDevNodeTree((ULONG)IopRootDeviceNode, v0, 0, 0);
      v0 = 0;
      v1 = 0;
    }
    else
