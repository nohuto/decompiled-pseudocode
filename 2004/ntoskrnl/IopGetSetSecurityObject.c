/*
 * XREFs of IopGetSetSecurityObject @ 0x14068C9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a9)
{
  ...
  if ( !v13 || !*((_WORD *)v13 + 44) && !v13[8] || (v13[10] & 0x800) != 0 )
  {
    if ( a2 == 3 )
    {
      ...
      {
        v20 = ObLogSecurityDescriptor(a4, &v40, 1u);
        if ( (v20 & 0x80000000) == 0 )
        {
  ...
  if ( (v16 & 2) != 0 )
  {
    ...
    {
      v20 = IopWaitAndAcquireFileObjectLock((volatile signed __int32 *)v13, PreviousMode, v17, v19, &v44);
    }
    else
    {
      if ( v19 )
