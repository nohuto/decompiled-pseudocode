/*
 * XREFs of MiDeleteStaleCacheMaps @ 0x1402F3000
 * Callers:
...
void MiDeleteStaleCacheMaps()
{
  ...
  if ( (__int64 *)qword_140C4EA60 != &qword_140C4EA60 )
  {
    ...
    if ( (unsigned int)(KiCacheFlushTimeStamp - dword_140C4EA70) > 2
      || (dword_140C4EA70 & 1) == 0 && (unsigned int)(KiCacheFlushTimeStamp - dword_140C4EA70) >= 2 )
    {
      v17[1] = v17;
      v17[0] = v17;
      v1 = ExAcquireSpinLockExclusive(&dword_140C4EA40);
      while ( (__int64 *)qword_140C4EA60 != &qword_140C4EA60 )
      {
        v2 = (unsigned __int64 *)(qword_140C4EA60 - 24);
        v3 = *(_DWORD *)(qword_140C4EA60 - 24 + 56);
        if ( (unsigned int)(v0 - v3) <= 2 && ((v3 & 1) != 0 || (unsigned int)(v0 - v3) < 2) )
          break;
        v4 = (_QWORD *)qword_140C4EA60;
        v5 = *(_QWORD *)qword_140C4EA60;
        v6 = (_QWORD *)v2[4];
        if ( *(_QWORD *)(*(_QWORD *)qword_140C4EA60 + 8LL) != qword_140C4EA60
          || *v6 != qword_140C4EA60
          || (*v6 = v5,
              *(_QWORD *)(v5 + 8) = v6,
              RtlAvlRemoveNode((unsigned __int64 *)&qword_140C4EA58, v2),
              v7 = v17[0],
              --qword_140C4EA78,
