/*
 * XREFs of PopBatteryWorker @ 0x14076D000
 * Callers:
 *     <none>
 * Callees:
...
void PopBatteryWorker()
{
  ...
  for ( j = (__int64 *)qword_140C23130; j != &qword_140C23130; j = (__int64 *)*j )
  ...
  do
  {
    ...
    if ( (__int64 *)qword_140C23130 != &qword_140C23130 )
    {
      ...
      while ( v28 != &qword_140C23130 );
    }
    v11 = qword_140C23120;
    if ( (__int64 *)qword_140C23120 != &qword_140C23120 )
    {
      do
      {
        if ( *(_DWORD *)(v11 + 104) == 1 )
      ...
      while ( (__int64 *)v11 != &qword_140C23120 );
      LOBYTE(v8) = v85;
    }
    v12 = qword_140C23130;
    if ( (__int64 *)qword_140C23130 != &qword_140C23130 )
    {
      ...
      while ( (__int64 *)v12 != &qword_140C23130 );
      LOBYTE(v8) = v85;
      v80 = v6;
    }
    if ( v9 )
    ...
    if ( (v8 & 4) != 0 || v7 )
    {
      if ( PopEstimateSpoilerMask )
      {
        ...
        KeCancelTimer(&stru_140C22920);
      }
      else
      {
        PopEstimateSpoiledUntilTime = MEMORY[0xFFFFF78000000008] + 300000000LL;
        KiSetTimerEx((__int64)&stru_140C22920, -300000000LL, 0, 0, (__int64)&PopPostSpoilingRefresh);
        v13 = -1LL;
      }
    }
    else
    ...
    if ( dword_140C23114 )
    {
      ...
      if ( (__int64 *)qword_140C23130 != &qword_140C23130 )
      {
        ...
        while ( (__int64 *)v35 != &qword_140C23130 );
        v13 = -1LL;
      }
      if ( (v19 & 2) != 0 )
      {
      ...
      else
      {
        ...
        if ( (__int64 *)qword_140C23130 != &qword_140C23130 )
        {
          ...
          while ( (__int64 *)v40 != &qword_140C23130 );
          LOBYTE(v6) = v80;
          if ( v41 )
          {
            v42 = (__int64 *)qword_140C23130;
            do
            {
    ...
    if ( (xmmword_140C23140 & 0x10) != v21 )
    {
      ...
      if ( (unsigned int)dword_140C021E8 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          ...
          (unsigned __int8 *)byte_14002887D,
          0LL,
          0LL,
          4u,
          &v140);
...
LABEL_137:
    ...
    qword_140C232C0 = MEMORY[0xFFFFF78000000008];
    _InterlockedOr(v72, 0);
    if ( qword_140C232C8 )
      ExfUnblockPushLock(&qword_140C232C8, 0LL);
  }
  while ( _InterlockedCompareExchange(&PopBatteryWorkRequests, 0, 0x80000000) != 0x80000000 );
  v23 = (__int64 *)qword_140C23130;
  if ( (__int64 *)qword_140C23130 != &qword_140C23130 )
  {
    do
    {
  ...
  {
    *(_DWORD *)v107 = dword_140C23174;
    v105 = xmmword_140C23154;
    v108 = dword_140C23110;
    *(_OWORD *)&v107[4] = xmmword_140C23140;
    *(_DWORD *)&v107[20] = dword_140C23114;
    v106 = xmmword_140C23164;
    ...
    if ( (unsigned int)dword_140C021E8 > 5 && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
    {
      ...
      if ( (_DWORD)xmmword_140C23164 )
        v67 = (((unsigned int)xmmword_140C23164 >> 1) + 100 * DWORD1(xmmword_140C23140))
            / (unsigned int)xmmword_140C23164;
      else
        v67 = 0;
      v89 = v67;
      v119 = &v89;
      v120 = 4LL;
      if ( (_DWORD)xmmword_140C23164 )
        v68 = 100000 * (unsigned __int64)DWORD1(xmmword_140C23140) / (unsigned int)xmmword_140C23164;
      else
        LODWORD(v68) = 0;
      ...
      v122 = 4LL;
      v121 = &v90;
      v91 = DWORD1(xmmword_140C23140);
      v123 = &v91;
      v125 = &v92;
      v93 = *((_QWORD *)&xmmword_140C23140 + 1);
      v127 = &v93;
      v129 = (char *)&v93 + 4;
      v94 = dword_140C23110;
      v131 = &v94;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_140C021E8,
        (unsigned __int8 *)word_1400282B2,
        0LL,
        0LL,
        0x15u,
        &v109);
    ...
    if ( v7 )
    {
      ...
      if ( (unsigned int)dword_140C021E8 > 5 )
      {
        ...
        tlgWriteTransfer_EtwWriteTransfer(
          (__int64)&dword_140C021E8,
          (unsigned __int8 *)byte_140028498,
          0LL,
          0LL,
          3u,
          &v145);
