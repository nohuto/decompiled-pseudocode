/*
 * XREFs of PnpQueuePendingSurpriseRemoval @ 0x140731638
 * Callers:
 ...
 *     IopMergeRelationLists @ 0x1408AF628 (IopMergeRelationLists.c)
...
_QWORD *__fastcall PnpQueuePendingSurpriseRemoval(PVOID a1, void **a2, int a3, int a4)
{
  ...
  *a2 = 0LL;
  ...
  if ( v6 == v10 )
  {
    ...
    v12 = (__int64 *)qword_140C44A78;
    if ( *(PVOID **)qword_140C44A78 != &IopPendingSurpriseRemovals )
LABEL_27:
      __fastfail(3u);
    *(_QWORD *)CriticalMemory = &IopPendingSurpriseRemovals;
    *(_QWORD *)(CriticalMemory + 8) = v12;
    *v12 = CriticalMemory;
    qword_140C44A78 = CriticalMemory;
  }
  else
  {
