/*
 * XREFs of KdpSendWaitContinue @ 0x1409B54F4
 * Callers:
 ...
 *     KdpWriteCustomBreakpoint @ 0x14050C1C4 (KdpWriteCustomBreakpoint.c)
 *     KdpSysReadIoSpace @ 0x14050C8A4 (KdpSysReadIoSpace.c)
 *     KdpSysReadMsr @ 0x14050C964 (KdpSysReadMsr.c)
 *     KdpSysWriteIoSpace @ 0x14050C998 (KdpSysWriteIoSpace.c)
 *     KdpSysWriteMsr @ 0x14050CA50 (KdpSysWriteMsr.c)
 ...
 *     KdpGetContext @ 0x1409B4628 (KdpGetContext.c)
 *     KdpQueryMemory @ 0x1409B471C (KdpQueryMemory.c)
 *     KdpReadControlSpace @ 0x1409B47B4 (KdpReadControlSpace.c)
 *     KdpReadPhysicalMemory @ 0x1409B4870 (KdpReadPhysicalMemory.c)
 *     KdpReadPhysicalMemoryLong @ 0x1409B49C0 (KdpReadPhysicalMemoryLong.c)
 ...
 *     KdpSearchPhysicalPageRange @ 0x1409B5450 (KdpSearchPhysicalPageRange.c)
 *     KdpSetBusData @ 0x1409B5CF0 (KdpSetBusData.c)
 *     KdpSetContext @ 0x1409B5D7C (KdpSetContext.c)
 *     KdpWriteBreakPointEx @ 0x1409B6090 (KdpWriteBreakPointEx.c)
 *     KdpWriteControlSpace @ 0x1409B6254 (KdpWriteControlSpace.c)
 ...
 *     KdpDeleteBreakpoint @ 0x1409B7248 (KdpDeleteBreakpoint.c)
 */
