/*
 * XREFs of PfSetSuperfetchInformation @ 0x1406A9D30
 * Callers:
  ...
  if ( DWORD2(v20) != 11 )
  {
    if ( DWORD2(v20) == 13 )
    {
      if ( DWORD2(v21) == 8 )
      {
        ...
        {
          v8 = PfpScenCtxPrefetchStateSet((ULONG_PTR)&qword_140C500E0);
          goto LABEL_11;
        }
        goto LABEL_84;
      }
