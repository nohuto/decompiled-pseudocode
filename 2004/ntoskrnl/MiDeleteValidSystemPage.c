/*
 * XREFs of MiDeleteValidSystemPage @ 0x1402B6220
 * Callers:
...
struct _KTHREAD *__fastcall MiDeleteValidSystemPage(__int64 a1, ULONG_PTR a2, int a3, __int64 a4)
{
  ...
  v47 = v5;
  v13 = *(_QWORD *)(qword_140C4E448 + 8 * v12);
...
LABEL_24:
  ...
  v48 = *(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(v17 - 0x58000000000LL + 40) >> 39) & 0x3FFLL));
