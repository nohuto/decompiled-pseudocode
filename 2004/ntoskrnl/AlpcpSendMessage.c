/*
 * XREFs of AlpcpSendMessage @ 0x1406851E0
 * Callers:
...
LABEL_25:
  ...
  result = AlpcpValidateMessage(&v51, a2);
  if ( (int)result < 0 )
    return result;
  v13 = v51.m256i_i32[6];
  v15 = v51.m256i_i16[2];
...
LABEL_64:
  ...
  if ( !v13 )
  {
    ...
    {
      ++dword_140CEBBD8;
      v20 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140CEBBF0)(
                            (unsigned int)dword_140CEBBE4,
                            (unsigned int)dword_140CEBBEC,
                            (unsigned int)dword_140CEBBE8);
      if ( !v20 )
        return 3221225626LL;
    }
...
LABEL_121:
  ...
  if ( v13 && ((*(_DWORD *)(v21 + 40) & 0x200) != 0 || (*(_DWORD *)(v21 + 40) & 0x80) != 0) )
  {
    ...
    AlpcpCancelMessage(v54, v21, 0x10000);
    return v36;
  }
  else if ( v25 >= 0 )
  {
    if ( v13 )
    {
      ...
      if ( v38 )
      {
        PsReleaseProcessWakeCounter(v38);
        *(_QWORD *)(v21 + 216) = 0LL;
      }
    }
    v39 = 0LL;
