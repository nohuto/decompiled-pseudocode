/*
 * XREFs of MiCoalescePageFileBitmapsCache @ 0x1402D4890
 * Callers:
 ...
 *     RtlLengthCurrentClearRunBackward @ 0x1402D3FD4 (RtlLengthCurrentClearRunBackward.c)
 *     RtlLengthCurrentClearRunForward @ 0x1402D4C1C (RtlLengthCurrentClearRunForward.c)
...
LABEL_17:
    ...
    else
    {
      ...
      {
        return MiRescanPageFileBitmapPortion(a1, v39, a3 - v29, v30, (__int64)&v37);
      }
    }
  }
  return result;
