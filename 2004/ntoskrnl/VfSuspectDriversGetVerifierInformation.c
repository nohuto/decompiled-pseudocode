/*
 * XREFs of VfSuspectDriversGetVerifierInformation @ 0x1409D68D0
 * Callers:
 ...
 *     VfTargetDriversGetZeroCounters @ 0x1409D3E84 (VfTargetDriversGetZeroCounters.c)
  ...
  *a3 = 0;
  ...
  if ( (__int64 *)VfSuspectDriversList != &VfSuspectDriversList )
  {
    while ( 1 )
    {
      ...
      *(_DWORD *)(v6 + 40) = dword_140C2A5E4;
      *(_DWORD *)(v6 + 44) = dword_140C2A5E8;
      *(_DWORD *)(v6 + 92) = dword_140C2A618;
      *(_DWORD *)(v6 + 48) = dword_140C2A5EC;
      *(_DWORD *)(v6 + 52) = dword_140C2A5F0;
      *(_DWORD *)(v6 + 56) = dword_140C2A5F4;
      *(_DWORD *)(v6 + 60) = dword_140C2A5F8;
      *(_DWORD *)(v6 + 64) = dword_140C2A5FC;
      *(_DWORD *)(v6 + 68) = dword_140C2A600;
      *(_DWORD *)(v6 + 72) = dword_140C2A604;
      *(_DWORD *)(v6 + 76) = dword_140C2A608;
      *(_DWORD *)(v6 + 80) = dword_140C2A60C;
