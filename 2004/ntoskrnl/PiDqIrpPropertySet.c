/*
 * XREFs of PiDqIrpPropertySet @ 0x140714030
 * Callers:
 ...
 *     _PnpSetGenericStoreProperty @ 0x140726C68 (_PnpSetGenericStoreProperty.c)
...
__int64 __fastcall PiDqIrpPropertySet(PIRP Irp)
{
  ...
  if ( v6 < 0 )
    goto LABEL_27;
  NdrMesTypeDecode3(v20, "TP 3\a", &off_1400011E0, &off_140C01A50, 2, &P);
  if ( !P
    || !*((_QWORD *)P + 1)
    || !*((_QWORD *)P + 3)
    || !*((_DWORD *)P + 4)
