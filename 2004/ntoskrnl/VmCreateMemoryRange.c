/*
 * XREFs of VmCreateMemoryRange @ 0x14092B800
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VmpDecodePreallocationRangeHandle @ 0x14092C044 (VmpDecodePreallocationRangeHandle.c)
 *     VmpFreeMemoryRanges @ 0x14092C098 (VmpFreeMemoryRanges.c)
 *     VmpProcessContextCleanup @ 0x14092C4BC (VmpProcessContextCleanup.c)
 *     VmpValidateMemoryRangeParameters @ 0x14092C4D0 (VmpValidateMemoryRangeParameters.c)
