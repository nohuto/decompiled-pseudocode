/*
 * XREFs of MiTrimSharedPageFromViews @ 0x14031EC94
 * Callers:
        ...
        if ( v27 < v90 )
        {
          while ( 1 )
          {
            ...
            else
            {
              ...
              MiFlushTbList((__int64)v105, (_KPROCESS *)i);
              if ( DmaAdapter )
              {
                if ( v11 )
...
LABEL_74:
            ...
            if ( (i & 1) == 0 )
              v44 = i;
            if ( v10 != *(_QWORD *)(qword_140C4E448 + 8LL * (*(_WORD *)(*(_QWORD *)v44 + 60LL) & 0x3FF)) + 7232LL )
              goto LABEL_136;
...
LABEL_137:
    ...
    else
    {
      if ( v29 == -2 )
        goto LABEL_25;
      SessionById = (_KPROCESS *)MmGetSessionById(v29);
      v99 = SessionById;
      if ( !SessionById )
        goto LABEL_138;
      if ( (int)MmAttachSession(SessionById, (__int64)v104) < 0 )
      {
...
LABEL_170:
    ...
    if ( v99 )
    {
      MmDetachSession((__int64)v99, (__int64)v104);
      MmQuitNextSession(v76);
    }
    else if ( v93 == 1 )
    {
      KeForceDetachProcess(v104, 0LL);
