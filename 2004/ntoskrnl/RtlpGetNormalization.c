/*
 * XREFs of RtlpGetNormalization @ 0x140918410
 * Callers:
 ...
 *     NormalizationList__InsertTail @ 0x14058EE58 (NormalizationList__InsertTail.c)
 *     NormalizationList__Lock @ 0x14058EE8C (NormalizationList__Lock.c)
 *     NormalizationList__Lookup @ 0x14058EEBC (NormalizationList__Lookup.c)
