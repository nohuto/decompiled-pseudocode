/*
 * XREFs of ExpInitSystemPhase0 @ 0x140A6490C
 * Callers:
...
char ExpInitSystemPhase0()
{
  ...
  qword_140C168E8 = (__int64)&ExNPagedLookasideListHead;
  ExNPagedLookasideListHead = (__int64)&ExNPagedLookasideListHead;
  qword_140C16908 = (__int64)&ExPagedLookasideListHead;
  ExPagedLookasideListHead = (__int64)&ExPagedLookasideListHead;
  qword_140C195C8 = (__int64)&ExpFirmwareTableProviderListHead;
