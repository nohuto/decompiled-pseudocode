/*
 * XREFs of TtmiLogDeviceDepartedTerminalEvent @ 0x1408FE9E0
 * Callers:
...
void __fastcall TtmiLogDeviceDepartedTerminalEvent(int a1)
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v9 = &v4;
      v4 = a1;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)byte_14002A571, 0LL, 0LL, 4u, &v5);
    }
  }
}
