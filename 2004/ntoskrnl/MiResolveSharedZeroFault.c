/*
 * XREFs of MiResolveSharedZeroFault @ 0x1402B5230
 * Callers:
...
LABEL_48:
  ...
  {
    v21 = MiSwizzleInvalidPte(32 * (v5 & 0x1F | 0xFFFFFFFFF8000020uLL), Process, v8, v11);
  }
...
LABEL_164:
    ...
    result = MiGetProtoPteAddress(v23, v35 >> 12, 4, &v69);
    v39 = result;
    if ( !result )
      return result;
    v40 = *(_QWORD **)(v23 + 120);
    ...
    v43 = v42;
    v44 = 0LL;
    while ( v43 > 0x7FFFFFFEFFFFLL )
    {
      v44 = (unsigned int)(v44 + 1);
      v43 = (__int64)((v43 << 25) - v71) >> 16;
...
LABEL_101:
    ...
    v61 = v49;
    if ( (unsigned __int64)&v61 >= v48
      && (unsigned __int64)&v61 <= v41
      && (unsigned int)MiPteHasShadow(&v61, v49, v47, v41)
      && (v49 & 1) != 0
      && ((v49 & 0x20) == 0 || (v49 & 0x42) == 0) )
    {
      ...
      if ( v47 )
      {
        v52 = *(_QWORD *)(v47 + 8 * (((unsigned __int64)&v61 >> 3) & 0x1FF));
        v47 = v49 | 0x20;
        if ( (v52 & 0x20) == 0 )
          v47 = v49;
        v49 = v47;
    ...
    v42 = (v49 >> 12) & 0xFFFFFFFFFLL;
    v53 = 48 * v42 - 0x58000000000LL;
    v78 = 0;
    if ( _interlockedbittestandset64((volatile signed __int32 *)(v53 + 24), 0x3FuLL) )
    {
      ...
      {
        do
          KeYieldProcessorEx(&v78, v42, v47, v41);
    ...
    *(_QWORD *)(v53 + 16) ^= ((unsigned int)*(_QWORD *)(v53 + 16) ^ ((unsigned int)*(_QWORD *)(v53 + 16) + 0x10000)) & 0x3FF0000;
    ...
    v25 = 0x8000000000000000uLL;
    v44 = *(_QWORD *)(v53 + 8) | 0x8000000000000000uLL;
    v74 = 0LL;
    v75 = 0LL;
    if ( (unsigned __int64)((v44 >> 47) + 1) > 1 )
      goto LABEL_101;
    v42 = 0xFFFFF68000000000uLL;
    v41 = 4LL;
    *(_QWORD *)&v74 = (((unsigned __int64)v44 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
    ...
    *((_QWORD *)&v75 + 1) = (((unsigned __int64)v75 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL;
    do
    {
      ...
      v44 = *(_QWORD *)v54;
      if ( v54 >= v48 && v54 <= 0xFFFFF6FB7DBED7F8uLL && (MiFlags & 0xC00000) != 0 )
      {
    ...
    while ( (v44 & 1) != 0 && (v44 & 0x80u) == 0LL && v41 );
    v25 = 0x8000000000000000uLL;
LABEL_102:
    if ( v76 == 256 )
    {
      v46 = MiSwizzleInvalidPte((v39 << 16) | 0x400, v42, 0x8000000000000000uLL, v41);
    }
    else
    {
      v46 = 32 * (v76 & 0x1F | 0xFFFFFFFFF8000020uLL);
      if ( qword_140C4DD40 )
      {
        if ( (qword_140C4DD40 & v46) != 0 )
          v46 |= 0x10uLL;
        else
          v46 |= qword_140C4DD40;
      }
    }
    if ( v36 >= 0xFFFFF6FB7DBED000uLL && v36 <= v45 )
    {
      if ( (unsigned int)MiPteHasShadow(v44, v46, v25, v41) )
      {
        if ( !HIBYTE(word_140C4DE08) && (v46 & 1) != 0 )
          v46 |= v25;
        *(_QWORD *)v36 = v46;
