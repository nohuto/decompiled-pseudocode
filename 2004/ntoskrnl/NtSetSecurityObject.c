/*
 * XREFs of NtSetSecurityObject @ 0x140626D40
 * Callers:
 ...
 *     SeSetSecurityAccessMask @ 0x140627078 (SeSetSecurityAccessMask.c)
...
LABEL_12:
    ...
    if ( v11 >= 0 )
    {
      ...
      if ( v11 >= 0 && (v11 = ObSetSecurityObjectByPointer(v17, v19, v18, v16), v11 >= 0) && (v7 || SaclPresent) )
      {
        v28 = v18;
        v22 = P;
        SeSecurityDescriptorChangedAuditAlarm(
          0LL,
          (__int64)v17,
          (UNICODE_STRING *)(ObTypeIndexTable[(unsigned __int8)ObHeaderCookie ^ LOBYTE(v17[-2].DmaOperations) ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)((_WORD)v17 - 48) >> 8)]
                           + 16),
          0LL,
          (__int64)Handle,
          0LL,
