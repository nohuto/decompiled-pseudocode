/*
 * XREFs of PfSnEndTrace @ 0x1406CDD38
 * Callers:
 *     PfSnEndTraceWorkerThreadRoutine @ 0x1406CDD20 (PfSnEndTraceWorkerThreadRoutine.c)
 * Callees:
...
__int64 __fastcall PfSnEndTrace(struct _EX_RUNDOWN_REF *P)
{
  ...
  if ( (int)Count_low >= dword_140C500B4 )
  {
    if ( (int)Count_low > 10 )
    {
...
LABEL_29:
        __fastfail(3u);
      v8[1] = qword_140C50260;
      *v8 = &qword_140C50258;
      *v9 = v8;
      v10 = dword_140C502A0 + 1;
      qword_140C50260 = v8;
      while ( 1 )
      {
        dword_140C502A0 = v10;
        if ( v10 <= dword_140C4FF4C )
          break;
        v12 = qword_140C50258;
        if ( qword_140C50258 == &qword_140C50258 )
          break;
        if ( *((PVOID **)qword_140C50258 + 1) != &qword_140C50258 )
          goto LABEL_29;
        v13 = *(_QWORD *)qword_140C50258;
        if ( *(PVOID *)(*(_QWORD *)qword_140C50258 + 8LL) != qword_140C50258 )
          goto LABEL_29;
        qword_140C50258 = *(PVOID *)qword_140C50258;
        *(_QWORD *)(v13 + 8) = &qword_140C50258;
