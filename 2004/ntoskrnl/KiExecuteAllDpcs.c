/*
 * XREFs of KiExecuteAllDpcs @ 0x14029A020
 * Callers:
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(v18 + 56) = 0LL;
      ...
      if ( (DWORD1(PerfGlobalGroupMask) & 0x40000) != 0 )
      {
        ...
        *((_QWORD *)&v77 + 1) = 0x7E35C6C7F3DD7277LL
                              * (KiWaitNever ^ __ROR8__(
                                                 ...
                                                 KiWaitNever));
        v81[0] = &v77;
        EtwTraceKernelEvent((int)v81, 1, 0x20040000u, 3941, 4196866);
        v6 = a3;
        v20 = v62;
        v21 = v65;
        v22 = v63;
      ...
      if ( v70 )
      {
        ...
        if ( (v4 & 4) != 0 )
        {
          SystemTimePrecise = RtlGetSystemTimePrecise(v24);
          v6 = a3;
          v20 = v62;
          v22 = v63;
          ...
          do
          {
            ...
            if ( v47 )
            {
              if ( (*(_DWORD *)(v47 + 4) & 0x80u) != 0 )
              {
                ...
                v82[1] = 8LL;
                v82[0] = &v78 + v48;
                EtwpLogKernelEvent((unsigned int)v82, EtwpHostSiloState, v49, 2, v43, v42);
              }
            }
            v27 = !_BitScanForward(&v45, v44);
          }
