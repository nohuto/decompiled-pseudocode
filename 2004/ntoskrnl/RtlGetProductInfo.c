        ...
        PULONG ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  ...
  v17 = xmmword_140011CD0;
  v16[2] = SpMajorVersion;
  v16[3] = SpMinorVersion;
  if ( (int)CompareVersions(v16, &v17) < 0 )
    return 0;
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1400027C8, &Type, &Data, 4u, &ResultDataSize) < 0
    || Type != 4
    || ResultDataSize != 4 )
  {
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_1400027B8, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
