/*
 * XREFs of MiSlistGetFreePage @ 0x140320DC0
 * Callers:
 *     MiRemovePageAnyColor @ 0x140320B3C (MiRemovePageAnyColor.c)
 *     MiGetPageSlist @ 0x140320D1C (MiGetPageSlist.c)
 * Callees:
...
_QWORD *__fastcall MiSlistGetFreePage(__int64 a1, int *a2, unsigned int a3)
{
  ...
  if ( v3 )
  {
    MiSetOriginalPtePfnFromFreeList((unsigned __int64 *)&v9[1], v10, v11, v12);
  }
