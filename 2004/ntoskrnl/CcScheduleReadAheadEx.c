/*
 * XREFs of CcScheduleReadAheadEx @ 0x1402C8600
 * Callers:
 ...
 *     CcScheduleReadAhead @ 0x1404E55D0 (CcScheduleReadAhead.c)
...
char __fastcall CcScheduleReadAheadEx(_SLIST_ENTRY *Object, _QWORD *a2, __int64 a3, struct _KTHREAD *a4)
{
  ...
  struct _KTHREAD *v64; // [rsp+F0h] [rbp+7Fh]
  ...
  if ( v11 )
  {
    Partition = CcGetPartition(*(_QWORD **)(v7 + 8), (__int64)a2, a3, a4);
    v58 = Partition;
  }
  if ( !CurrentThread )
  {
...
LABEL_28:
                            ...
                            else
                            {
                              ...
                              if ( (v11[38] & 0x10000000) != 0 )
                                CcChargeThreadForReadAhead((_DWORD)Object, v26, v27, v17, (__int64)v64);
                  ...
                  if ( (v11[38] & 0x10000000) != 0 )
                  {
                    CcChargeThreadForReadAhead((_DWORD)Object, v22, v21, v17, (__int64)v64);
                    v31 = 1;
                  }
                  goto LABEL_37;
                }
