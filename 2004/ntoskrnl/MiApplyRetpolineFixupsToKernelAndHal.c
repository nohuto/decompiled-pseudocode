/*
 * XREFs of MiApplyRetpolineFixupsToKernelAndHal @ 0x140A48CF0
 * Callers:
 ...
 *     RtlLookupImageSectionByName @ 0x140587B94 (RtlLookupImageSectionByName.c)
...
__int64 __fastcall MiApplyRetpolineFixupsToKernelAndHal(__int64 a1)
{
  ...
  _DWORD v27[2]; // [rsp+60h] [rbp-61h] BYREF
  ...
  v26 = 0LL;
  v3 = *(_QWORD *)(a1 + 16);
  dword_140C4CA4C = *(_DWORD *)(v1 + 3468) >> 12;
  if ( (KiSpeculationFeatures & 0x2000000) != 0
    && (v26 = v3,
        ...
        dword_140C4CA88 = (v12 >> 12) + ((v12 & 0xFFF) != 0),
        dword_140C4CA88 > (unsigned int)dword_140C4CA4C) )
  {
    updated = -1073741811;
  }
  ...
  {
    v15 = v26;
    v16 = RtlImageNtHeader(*(_QWORD *)(v26 + 48));
    v17 = RtlLookupImageSectionByName(v16, "INITKDBG");
    v18 = 0;
    v19 = &v26;
    v28[0] = *((_DWORD *)v17 + 3);
    v20 = 1;
    ...
    {
      v21 = *v19;
      v22 = RtlLookupImageSectionByName(v16, "MINIEX");
      v23 = Base;
      v24 = *(_DWORD *)(v21 + 64);
      v25 = *((_DWORD *)v22 + 3);
      v27[v20] = *((_DWORD *)v22 + 2);
      v28[v20] = v25;
