/*
 * XREFs of CmRestoreKey @ 0x140878A38
 * Callers:
...
__int64 __fastcall CmRestoreKey(_QWORD *a1, void *a2, int a3, char a4)
{
  ...
  _BYTE v83[496]; // [rsp+F0h] [rbp-10h] BYREF
...
LABEL_111:
    ...
    v30 = CmpPrepareForSubtreeInvalidation(v9, (__int64)&v74);
    Hive = v30;
    if ( v30 != -1073741267 )
    {
      if ( v30 < 0 )
      ...
      if ( !v26 )
      {
        CmpInvalidateAllHigherLayerKcbs(v9, 0, 1, (__int64)&v82);
        CmpInvalidateSubtree(v9, 1, (__int64)&v82, 0LL);
...
LABEL_94:
  ...
  {
    v34 = (*(__int64 (__fastcall **)(__int64, _QWORD, _DWORD *))(CmpMasterHive + 8))(CmpMasterHive, v33, v70);
    if ( !v34 )
      goto LABEL_68;
    *(_DWORD *)(v34 + 28) = v65;
    (*(void (__fastcall **)(__int64, _DWORD *))(CmpMasterHive + 16))(CmpMasterHive, v70);
...
LABEL_70:
  ...
  *(_WORD *)(v9 + 8) = 64;
  ...
  CmpReportNotify(v9, 0, 1LL, (struct _LOOKASIDE_LIST_EX *)v83);
  if ( !CmpProfileLoaded )
  {
