/*
 * XREFs of MiHandleTransitionFault @ 0x1402A98F0
 * Callers:
        ...
        __int64 *a7)
{
  ...
  __int64 v41; // rbx
  __int64 v42; // rax
  __int64 v43[7]; // [rsp+40h] [rbp-38h] BYREF
...
LABEL_23:
      ...
      if ( (unsigned int)MiIsPfnFileOnly(BugCheckParameter4, v28, v29, v30) )
      {
LABEL_71:
        v42 = *(_QWORD *)(BugCheckParameter4 + 24);
        ++*(_WORD *)(BugCheckParameter4 + 32);
        *(_QWORD *)(BugCheckParameter4 + 24) = v42 & 0xC000000000000000uLL | 1;
      ...
      if ( (unsigned int)MI_PFN_IS_PROTO(BugCheckParameter4) )
      {
        if ( (*(_DWORD *)(BugCheckParameter4 + 16) & 0x400LL) != 0 )
          goto LABEL_63;
        v34 = *(_QWORD *)(v33 + 432) == 0LL;
      }
      else
      {
        v34 = *(_QWORD *)(v33 + 424) == 0LL;
      }
      if ( !v34 )
      {
        ...
        {
          v35 = MI_PFN_IS_PROTO(BugCheckParameter4);
          v37 = v36 & 0x100000;
          if ( v35 )
          {
            if ( !v37 )
...
LABEL_54:
              v38 = a1;
              v39 = MiIdealClusterPage((int)a1, (int)Address, a2, a6, (void *)BugCheckParameter4, a3, (__int64)v43);
              v32 = v39;
              if ( v39 )
              {
                if ( BugCheckParameter4 != v39 )
                {
...
LABEL_60:
        ...
        if ( !v32 )
          goto LABEL_66;
LABEL_64:
        v32 = MiMigratePfn(v38, BugCheckParameter4, a3, a7);
        *a5 = v32;
