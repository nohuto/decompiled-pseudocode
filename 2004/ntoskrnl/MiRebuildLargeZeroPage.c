/*
 * XREFs of MiRebuildLargeZeroPage @ 0x140331AA0
 * Callers:
...
char __fastcall MiRebuildLargeZeroPage(__int64 a1)
{
...
LABEL_7:
  ...
  v11 = _InterlockedExchange((volatile __int32 *)(a1 + 5136), 0);
  if ( v11 )
  {
    v18 = *(_WORD **)(a1 + 5128);
    do
    {
      if ( *v18 == 512 )
        LOBYTE(v11) = MiCoalesceFreeLargePages(a1, v1, 1u);
      ++v18;
      v1 += 0x40000LL;
    }
