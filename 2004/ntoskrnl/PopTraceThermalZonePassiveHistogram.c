/*
 * XREFs of PopTraceThermalZonePassiveHistogram @ 0x140387B14
 * Callers:
 ...
 *     PopDiagSnapPassiveHistogram @ 0x1403884F4 (PopDiagSnapPassiveHistogram.c)
      ...
      if ( (unsigned int)dword_140C021E8 > 5 )
      {
        ...
        if ( (_BYTE)DeviceAttachmentBaseRefWithTag )
        {
          ...
          LOBYTE(DeviceAttachmentBaseRefWithTag) = tlgWriteTransfer_EtwWriteTransfer(
                                                     ...
                                                     (unsigned __int8 *)&dword_140026FCB,
                                                     0LL,
                                                     0LL,
                                                     7u,
                                                     &v7);
