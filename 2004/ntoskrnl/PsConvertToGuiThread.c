/*
 * XREFs of PsConvertToGuiThread @ 0x1406EFB30
 * Callers:
...
__int64 PsConvertToGuiThread()
{
  ...
  {
    v7 = (char)qword_140C1D8E0;
    if ( qword_140C1D8E0 )
    {
      LOBYTE(v5) = v17;
      LOBYTE(v4) = 12;
      v7 = qword_140C1D8E0(v5, v4, v6);
      v3 = v12;
    }
    v12 = ((unsigned __int8)v3 ^ (unsigned __int8)(2 * v7)) & 2 ^ v3;
  }
  result = PsInvokeWin32Callout(0, (__int64)&v11, 0, 0LL);
  if ( (int)result >= 0 )
  {
    ...
    v15 = 0;
    v14 = CurrentThread;
    v10 = PsInvokeWin32Callout(1, (__int64)&v14, 0, 0LL);
    if ( v10 < 0 )
    {
