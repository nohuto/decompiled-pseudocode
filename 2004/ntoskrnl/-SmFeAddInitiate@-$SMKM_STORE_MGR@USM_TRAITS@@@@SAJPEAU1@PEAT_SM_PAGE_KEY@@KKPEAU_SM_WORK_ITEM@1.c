/*
 * XREFs of ?SmFeAddInitiate@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU1@PEAT_SM_PAGE_KEY@@KKPEAU_SM_WORK_ITEM@1@PEAU_SM_IO_CONTEXT@1@K@Z @ 0x1402CFA3C
 * Callers:
        ...
        char a7)
{
  ...
  __int64 v31; // rdi
  __int64 v32; // rdx
  $C774EFD68449142D8271B1EC1EB7FB26 *v33; // rcx
  __int64 v34; // rcx
  ...
  _DWORD v49[2]; // [rsp+34h] [rbp-CCh] BYREF
  ...
  while ( 1 )
  {
    ...
    if ( !(_QWORD)v57 )
      break;
    v20 = *((_QWORD *)&v57 + 1) + 8LL;
    v21 = (unsigned __int16)*(_DWORD *)v57 + 2LL;
    *((_QWORD *)&v57 + 1) = v20;
    if ( v20 >= (__int64)v57 + 8 * v21 )
    {
      v34 = *(_QWORD *)(v57 + 8);
      if ( v34 )
      {
    ...
    *(_DWORD *)(a1 + 1648) = v10;
    ...
    else
    {
      ...
      v37 = (unsigned int)MiGetSystemRegionType(a1 + 440) == 1 ? MmGetSessionIdEx((__int64)v36->ApcState.Process) : -1;
...
LABEL_78:
      ...
      KiAbThreadRemoveBoosts((ULONG_PTR)v36, a1 + 440, v49);
      v29 = v36->SpecialApcDisable++ == -1;
      if ( v29 && ($C774EFD68449142D8271B1EC1EB7FB26 *)v36->ApcState.ApcListHead[0].Flink != &v36->152 )
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( ++v22 == v50 )
      {
        SMKM_STORE_MGR<SM_TRAITS>::SmIoCtxQueueWork(v63, a1, v55, v64);
        v16 = 0;
        goto LABEL_17;
      }
      ++v10;
    ...
    if ( v22 )
      SMKM_STORE_MGR<SM_TRAITS>::SmFeAddComplete(a1, v62, v22, v24, 2);
  }
LABEL_38:
  if ( v11 )
  {
...
LABEL_33:
    ...
    KiAbThreadRemoveBoosts((ULONG_PTR)v25, v12, &v52);
    v29 = v25->SpecialApcDisable++ == -1;
    if ( v29 )
    {
      v33 = &v25->152;
      if ( ($C774EFD68449142D8271B1EC1EB7FB26 *)v33->ApcState.ApcListHead[0].Flink != v33 )
