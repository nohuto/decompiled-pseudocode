/*
 * XREFs of MiLogProcessWorkingSetsStop @ 0x14026C550
 * Callers:
...
void __fastcall MiLogProcessWorkingSetsStop(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(*(_QWORD *)&qword_140C4ECE0, 1LL, a3, a4) )
    {
      v8 = v7[888];
      v16 = 0;
      v19 = 0;
      ...
      v18 = 8;
      v21 = 8;
      tlgWriteEx_EtwWriteEx(v6, (int)&word_140024D66, v5, v4, v9, v10, 5u, (__int64)v14);
    }
  }
}
