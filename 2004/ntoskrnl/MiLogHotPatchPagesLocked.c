/*
 * XREFs of MiLogHotPatchPagesLocked @ 0x1408C87E8
 * Callers:
  ...
  if ( *(_QWORD *)&qword_140C4ECE0 )
  {
    if ( **(_DWORD **)&qword_140C4ECE0 > 5u )
    {
      ...
      if ( (_BYTE)v5 )
      {
        ...
        v18 = a4;
        v22 = 0x1000000LL;
        LOBYTE(v5) = tlgWriteEx_EtwWriteEx(v6, (unsigned __int8 *)&byte_14002539D, v12, 1u, v14, v15, 9u, &v23);
      }
    }
  }
  return (char)v5;
