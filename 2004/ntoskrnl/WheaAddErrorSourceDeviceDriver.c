/*
 * XREFs of WheaAddErrorSourceDeviceDriver @ 0x140797010
 * Callers:
 *     WheaAddErrorSourceDeviceDriverV1 @ 0x1403B7830 (WheaAddErrorSourceDeviceDriverV1.c)
 * Callees:
 *     WheapDeviceDriverGetPacketLength @ 0x1403B7C20 (WheapDeviceDriverGetPacketLength.c)
