/*
 * XREFs of ObCloseHandleTableEntry @ 0x1405F34B0
 * Callers:
        ...
        char a6)
{
  ...
  if ( v14 )
  {
    ...
    {
      KiStackAttachProcess(v7, 0LL, (__int64)v64);
      v14 = *(unsigned __int8 (__fastcall **)(_KPROCESS *, unsigned __int64, ULONG_PTR, _QWORD))(v13 + 168);
      v50 = 1;
    }
...
LABEL_77:
      ...
      if ( v32 )
      {
        ...
        if ( KeGetCurrentThread()->ApcState.Process != v7 )
        {
          ...
          KiStackAttachProcess(v7, 0LL, (__int64)v65);
              ...
              *(_OWORD *)v57 = 0LL;
              ...
              if ( *(struct _DMA_ADAPTER **)v38 == i && (*(_BYTE *)(v8 + 27) & 0x10) == 0 && !*(_QWORD *)(v8 + 8) )
              {
                ...
                if ( !*(_DWORD *)(v38 + 24) )
                {
                  ...
                  v48 = (struct _DMA_ADAPTER *)ObpLookupDirectoryEntryEx(v43, 0, (__int64)v57);
                  v46 = v48;
                  if ( v47 == ObpDirectoryObjectType )
                    ObfReferenceObject(v48);
                  else
                    v46 = 0LL;
                  ObpDeleteDirectoryEntry(v57);
                }
