/*
 * XREFs of CmpAddDriverToList @ 0x140A4A7B0
 * Callers:
...
LABEL_64:
  ...
  *((_WORD *)v8 + 60) = v17 - 2;
  *((_WORD *)v8 + 61) = v17;
  ValueByName = CmpFindValueByName(BugCheckParameter3, v11, (int)&CmpImagePathString);
  if ( ValueByName == -1 )
  {
...
LABEL_10:
  ...
  *((_QWORD *)v30 + 1) = v8;
  v7 = 0LL;
  *v29 = v8;
  v31 = CmpFindValueByName(BugCheckParameter3, v11, (int)&CmpErrorControlString);
  if ( v31 == -1 )
  {
    *((_DWORD *)v8 + 35) = 1;
  }
  ...
  v34 = CmpFindValueByName(BugCheckParameter3, v11, (int)&CmpGroupString);
  if ( v34 == -1 )
  {
    v36 = (_DWORD)v8 + 104;
    *((_WORD *)v8 + 52) = 0;
    ...
    if ( *((_QWORD *)v8 + 14) )
    {
      ...
      *((_WORD *)v8 + 52) = Size - 2;
      if ( v37 <= (unsigned __int16)Size )
      {
        *((_WORD *)v8 + 53) = v37;
LABEL_29:
        v38 = CmpFindValueByName(BugCheckParameter3, v11, (int)&CmpDriverDependencyString);
        if ( v38 == -1 )
        {
          *((_DWORD *)v8 + 22) = 0;
          *((_QWORD *)v8 + 12) = 0LL;
LABEL_31:
          v11 = v49;
          v39 = CmpFindValueByName(BugCheckParameter3, v49, (int)&CmpTagString);
          if ( v39 == -1 )
            *((_DWORD *)v8 + 34) = -1;
          else
