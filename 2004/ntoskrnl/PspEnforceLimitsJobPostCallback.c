/*
 * XREFs of PspEnforceLimitsJobPostCallback @ 0x14068A6E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PspGetEffectiveNoWakeCharge @ 0x14068AB84 (PspGetEffectiveNoWakeCharge.c)
...
__int64 __fastcall PspEnforceLimitsJobPostCallback(_QWORD *Object, __int64 a2)
{
  ...
  {
    PspLockJobMemoryLimitsShared((__int64)Object, (__int64)CurrentThread);
    v51 = PspGetJobMemoryUsageNotificationViolations(Object, Object[122], Object[122] + Object[167], 33280LL) | v4;
    PspUnlockJobMemoryLimitsShared((__int64)Object, (__int64)CurrentThread);
  }
  v17 = DWORD2(v66[2]);
  v18 = DWORD1(v66[3]);
  ...
  if ( v54 && *((_QWORD *)&v59 + 1) + v57 > v54 )
  {
    if ( v53 )
    {
      ...
      {
        PspUnlockJob(Object, v52);
        PspTerminateAllProcessesInJobHierarchy((PRKEVENT)Object, 0xC0000044, 1);
        goto LABEL_17;
      }
    ...
    {
      if ( !PspTerminateAllProcessesInJobHierarchy((PRKEVENT)Object, 0xC0000044, 1) )
        goto LABEL_17;
      v50 = v52;
      PspLockJobExclusive(Object, v52);
