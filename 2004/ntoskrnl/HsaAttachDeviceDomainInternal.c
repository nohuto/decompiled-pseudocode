/*
 * XREFs of HsaAttachDeviceDomainInternal @ 0x1404DD4A8
 * Callers:
 *     HsaAttachDeviceDomain @ 0x1404DD490 (HsaAttachDeviceDomain.c)
 *     HsaDetachDeviceDomain @ 0x1404DD9A0 (HsaDetachDeviceDomain.c)
 * Callees:
