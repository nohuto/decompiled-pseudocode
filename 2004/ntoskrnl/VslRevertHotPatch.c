/*
 * XREFs of VslRevertHotPatch @ 0x1404F82FC
 * Callers:
...
NTSTATUS __fastcall VslRevertHotPatch(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  v5 = a3;
  memset(v8, 0, 0x68uLL);
  _InterlockedIncrement(&dword_140C4724C);
  v8[1] = a1;
  v8[2] = v3;
  v8[3] = v5;
  result = VslpEnterIumSecureMode(2u, 71, 0, (__int64)v8);
  v7 = (volatile signed __int32 *)&unk_140C47250;
  if ( result < 0 )
    v7 = (volatile signed __int32 *)&unk_140C47254;
