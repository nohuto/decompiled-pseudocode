/*
 * XREFs of AuthzBasepRollbackSecurityAttributeChanges @ 0x1405BC1A0
 * Callers:
 ...
 *     AuthzBasepRemoveSecurityAttributeFromLists @ 0x14035E0FC (AuthzBasepRemoveSecurityAttributeFromLists.c)
