...
void __fastcall HalpDpPreReplace(__int64 a1)
{
  ...
  if ( !*(_BYTE *)(a1 + 45) )
  {
    ...
    {
      HalpAcpiPmRegisterRead(0, (unsigned __int8)byte_140C49E98 >> 1, (__int64)&v6, 2u, 0LL);
      v4 = v6;
      v5 = v6;
      if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
      {
        HalpAcpiPmRegisterRead(3, (unsigned __int8)byte_140C49E98 >> 1, (__int64)&v6, 2u, 0LL);
        v4 = v6 | v5;
      }
      v5 = v4 & 0x20;
      HalpAcpiPmRegisterWrite(0, (unsigned __int8)byte_140C49E98 >> 1, (__int64)&v5, 2u, 0LL);
      if ( (int)HalpAcpiPmRegisterAvailable(3) >= 0 )
        HalpAcpiPmRegisterWrite(3, (unsigned __int8)byte_140C49E98 >> 1, (__int64)&v5, 2u, 0LL);
    }
