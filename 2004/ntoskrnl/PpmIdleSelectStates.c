/*
 * XREFs of PpmIdleSelectStates @ 0x140392C50
 * Callers:
 ...
 *     PpmCheckPreConditionsForDeepSleep @ 0x14038E72C (PpmCheckPreConditionsForDeepSleep.c)
 ...
 *     PpmIdleRollbackCoordinatedSelection @ 0x14056181C (PpmIdleRollbackCoordinatedSelection.c)
 *     PpmIdleSetSynchronizationState @ 0x140561920 (PpmIdleSetSynchronizationState.c)
 *     PpmIdleUpdateSelectionStatistics @ 0x140561C18 (PpmIdleUpdateSelectionStatistics.c)
...
LABEL_9:
  ...
  *(_DWORD *)(v11 + 528) = v22;
  ...
  {
    v23 = BYTE6(PpmCurrentProfile[342 * dword_140C238AC + 24]);
    *(_BYTE *)(v11 + 542) = v23;
    if ( v23 )
