/*
 * XREFs of ExtEnvAllocatePhysicalMemory @ 0x1404D01D0
 * Callers:
 ...
 *     MmAllocateContiguousMemorySpecifyCacheNode @ 0x1403CC210 (MmAllocateContiguousMemorySpecifyCacheNode.c)
...
LABEL_13:
  ...
  *(_DWORD *)(v22 + 48) = CacheType;
  ...
  v24 = (__int64 *)qword_140C48C48;
  if ( *(__int64 **)qword_140C48C48 != &ExtEnvAllocationList )
    __fastfail(3u);
