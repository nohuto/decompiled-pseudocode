/*
 * XREFs of EtwpDequeueBufferPendingCompression @ 0x1405A7A94
 * Callers:
 ...
 *     EtwpDequeueBufferPendingCompressionFromQueue @ 0x1405A7B88 (EtwpDequeueBufferPendingCompressionFromQueue.c)
