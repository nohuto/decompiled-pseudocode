/*
 * XREFs of HvlGetPpmStatsForProcessor @ 0x14038B530
 * Callers:
...
__int64 __fastcall HvlGetPpmStatsForProcessor(struct _KPRCB *a1, _QWORD *a2, _QWORD *a3)
{
  ...
  {
    v6 = HIDWORD(xmmword_140CED1A0);
    StatisticsPage = a1->StatisticsPage;
    do
    {
      v8 = StatisticsPage[v6];
      *a3 = a1->StatisticsPage[(unsigned int)xmmword_140CED1B0];
    }
    while ( v8 != StatisticsPage[v6] );
    v9 = DWORD1(xmmword_140CED1B0);
  ...
  {
    ReferenceTime = HvlGetReferenceTime();
    v13 = (unsigned int)xmmword_140CED1B0;
    *a2 = ReferenceTime - a1->StatisticsPage[DWORD1(xmmword_140CED1A0)];
