/*
 * XREFs of MiRemoveMdlPages @ 0x1408C3460
 * Callers:
...
_DWORD *__fastcall MiRemoveMdlPages(char *P, unsigned int a2)
{
  ...
  if ( v2 <= (__int64 *)v5 )
  {
    do
    {
      if ( v12 || (v6 = *v2, *v2 != v11) )
      {
        if ( v8 )
        {
          if ( v7 < 0 || (v20 = MiRemovePhysicalMemory(v10, v8, HIWORD(a2) & 8), v7 = v20, v20 < 0) )
          {
            ...
            while ( v14 );
            v5 = v21;
            MiFreeContiguousPages(v10, v8, v15, v16);
            v7 = v20;
            v9 += v8;
          }
        }
  ...
  _InterlockedExchangeAdd64(&qword_140C4EDB8, -(__int64)v3);
  if ( v9 )
  {
    if ( v9 == v3 )
    {
