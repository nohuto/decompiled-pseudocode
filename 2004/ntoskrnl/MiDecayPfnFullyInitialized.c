/*
 * XREFs of MiDecayPfnFullyInitialized @ 0x14033A13C
 * Callers:
...
__int64 __fastcall MiDecayPfnFullyInitialized(ULONG_PTR BugCheckParameter2)
{
  ...
  KeAcquireInStackQueuedSpinLock(
    (PKSPIN_LOCK)(*(_QWORD *)(qword_140C4E448 + 8 * ((*(_QWORD *)(BugCheckParameter2 + 40) >> 39) & 0x3FFLL)) + 2664LL),
    &LockHandle);
  v4 = *(_QWORD *)(BugCheckParameter2 + 16);
  if ( qword_140C4DD40 && (v4 & 0x10) == 0 )
    v4 &= ~qword_140C4DD40;
...
LABEL_10:
  ...
  *(_BYTE *)(BugCheckParameter2 + 35) = v6 & 0xF7;
  ...
  __writecr8(OldIrql);
  if ( v2 == 1 )
    return (__int64)RtlpInterlockedPushEntrySList(&stru_140C4E7B0, (PSLIST_ENTRY)BugCheckParameter2);
  return result;
}
