/*
 * XREFs of KeInitSystem @ 0x140A4495C
 * Callers:
 ...
 *     KeInitializeCatRegisters @ 0x1403A4E58 (KeInitializeCatRegisters.c)
 ...
 *     KeInitializeSchedulerAssist @ 0x140A44750 (KeInitializeSchedulerAssist.c)
    ...
    else
    {
      ...
      if ( (HvlpFlags & 0x100000) != 0 )
      {
        ...
        if ( PoolWithTag )
        {
          ...
          qword_140C2AE78 = (__int64)KiEpfCompletionDpcRoutine;
          qword_140C2AE80 = 0LL;
          qword_140C2AE98 = 0LL;
          qword_140C2AE70 = 0LL;
