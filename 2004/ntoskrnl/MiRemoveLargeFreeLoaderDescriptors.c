/*
 * XREFs of MiRemoveLargeFreeLoaderDescriptors @ 0x140A3E844
 * Callers:
...
void __fastcall MiRemoveLargeFreeLoaderDescriptors(__int64 a1)
{
  ...
  qword_140D56758 = (__int64)&MxDeferredBootFreeDescriptorHead;
