...
__int64 __fastcall CmFcManagerStartBootPhase(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  v6 = CmFcpIncrementChangeStamp(qword_140C47F58);
  v11[8] = a5;
  v11[1] = v7;
  v11[2] = v8;
  v11[4] = v7;
  ...
  v11[6] = v6;
  v11[7] = v9;
  RtlpFcBufferManagerUpdateBuffers(qword_140C47FB0, v6, (__int64)v11);
  result = RtlpFcWriteHighLowHigh((__int64)&qword_140C47F58, v6);
  qword_140C48098[0] = a6;
  return result;
}
