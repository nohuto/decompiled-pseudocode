/*
 * XREFs of MiReserveBootDriverPtes @ 0x140A62A08
 * Callers:
...
__int64 __fastcall MiReserveBootDriverPtes(unsigned __int64 a1, int a2)
{
  ...
  v3 = ((dword_140C4CAB0 & 0xFFF) != 0) + a2 + ((unsigned int)dword_140C4CAB0 >> 12);
  v4 = (__int64)(a1 << 25) >> 16;
  if ( (PVOID)v4 != PsHalImageBase && (PVOID)v4 != PsNtosImageBase )
    v3 = (unsigned int)(dword_140C4CA4C + v3);
  v5 = (const void **)qword_140C4CB30;
  v6 = a1 & 0xFFFFFFFFFFFFF000uLL;
  if ( qword_140C4CB30 )
  {
    v7 = *((_QWORD *)qword_140C4CB30 + 1);
    v8 = v7 + 8LL * *((unsigned int *)qword_140C4CB30 + 4);
    if ( a1 + 8 * v3 <= v8 )
    {
      RtlSetBits((PRTL_BITMAP)qword_140C4CB30 + 1, (__int64)(a1 - v7) >> 3, v3);
      return 1LL;
    }
    v5 = (const void **)((unsigned __int64)qword_140C4CB30 & -(__int64)(a1 < v8));
    if ( v5 )
      v6 = *(_QWORD *)(((unsigned __int64)qword_140C4CB30 & -(__int64)(a1 < v8)) + 8);
  }
  ...
  if ( result )
  {
    ...
    *(_QWORD *)&v11->SizeOfBitMap = qword_140C4CB30;
    qword_140C4CB30 = v11;
    return 1LL;
  }
  return result;
