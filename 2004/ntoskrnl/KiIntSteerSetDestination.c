/*
 * XREFs of KiIntSteerSetDestination @ 0x140351860
 * Callers:
 *     KiIntSteerDistributeInterrupts @ 0x14021E400 (KiIntSteerDistributeInterrupts.c)
 *     KiIntSteerConnect @ 0x140375804 (KiIntSteerConnect.c)
 * Callees:
 *     KiIntSteerVerifyDestination @ 0x1403518DC (KiIntSteerVerifyDestination.c)
...
LABEL_12:
  ...
  result = ((__int64 (__fastcall *)(ULONG_PTR, ULONG_PTR, ULONG_PTR))off_140C00868[0])(
