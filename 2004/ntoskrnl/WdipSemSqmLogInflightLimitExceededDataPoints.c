/*
 * XREFs of WdipSemSqmLogInflightLimitExceededDataPoints @ 0x14064CC18
 * Callers:
...
__int64 WdipSemSqmLogInflightLimitExceededDataPoints()
{
  ...
  v3 = (unsigned int)dword_140C1C7C0;
  if ( dword_140C1C7C0 )
  {
    v1 = WdipSemSqmIncrementDword(v2, (unsigned int)dword_140C1C7C0);
    if ( v1 < 0 )
      v1 = 0;
    if ( (_DWORD)v3 )
    {
  ...
  for ( i = 0; i < dword_140C1C7C0; WdipSemFrequentScenarioTable[v8] = 0LL )
  {
    v8 = i;
