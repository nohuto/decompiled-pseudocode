/*
 * XREFs of EtwpCoverageSamplerReadyThread @ 0x1405AAB34
 * Callers:
...
__int64 __fastcall EtwpCoverageSamplerReadyThread(__int64 a1)
{
  ...
  if ( *(_QWORD *)qword_140C196E8 != result && *(_QWORD *)qword_140C196E8 != a1 )
  {
    CurrentPrcb = KeGetCurrentPrcb();
    result = (__int64)KeGetCurrentThread();
    if ( (_KTHREAD *)result != CurrentPrcb->IdleThread || CurrentPrcb->NestingLevel > 1u )
    {
      v3 = (*(_QWORD *)(qword_140C196E8 + 8) >> 4) & 0x1FFLL;
      v4 = ((unsigned int)*(_QWORD *)(qword_140C196E8 + 8) >> 13) & 0x3FFFF;
