/*
 * XREFs of MiWalkPageTablesRecursively @ 0x14029DD80
 * Callers:
 ...
 *     MiWalkPageTablesRecursively @ 0x14029DD80 (MiWalkPageTablesRecursively.c)
 *     MiComputePxeWalkAction @ 0x14029EA30 (MiComputePxeWalkAction.c)
        ...
        unsigned __int64 DpcRequestSummary)
{
  ...
  unsigned __int64 v86[11]; // [rsp+40h] [rbp-58h] BYREF
      ...
      if ( v11 )
      {
        ...
        if ( (a1[1] & 1) != 0 )
        {
          ...
          if ( (*(_BYTE *)a1 & 4) == 0 )
          {
            ...
            *(_DWORD *)(SharedVm + 4) = 0;
            if ( (*a1 & 0x400) != 0 )
              ExAcquireSpinLockExclusiveAtDpcLevel(&dword_140C4E11C);
            goto LABEL_18;
          }
...
LABEL_26:
          ...
          while ( 1 )
          {
            ...
            v20 += 8;
            if ( (unsigned int)v9 >= dword_140C4DCFC )
              goto LABEL_26;
          }
        }
      }
      ...
      if ( (*(_BYTE *)a1 & 4) != 0 )
      {
        ...
        else
        {
            ...
            || (v33 = *(_QWORD *)(KeGetCurrentThread()->ApcState.Process[1].ActiveProcessorsPadding[8] + 608)) == 0 )
          {
            ...
            {
              PageTableLockBuffer = MiGetPageTableLockBuffer(v26, ((a2 >> 9) & 0x7FFFFFFFF8LL) - 0x98000000000LL, &v87);
              if ( ((*(_DWORD *)PageTableLockBuffer >> v87) & 2) != 0 )
                goto LABEL_99;
              goto LABEL_75;
            }
            v36 = *(_QWORD *)v28;
...
LABEL_75:
      if ( (*a1 & 0x400) != 0 && (dword_140C4E11C & 0x40000000) != 0 )
        goto LABEL_99;
      if ( *((_BYTE *)a1 + 6) < 2u )
      {
...
LABEL_148:
      ...
      if ( *v90 != a2 )
      {
        ...
        v47 = a2;
        *((_QWORD *)a1 + 8) = a2;
        if ( !(_WORD)v9 || (v65 = (unsigned __int64 *)&a1[v82 + 40], a2 > *v65) )
        {
          v65 = (unsigned __int64 *)&a1[v82 + 40];
          *v65 = a2;
        }
        v66 = v83;
        if ( v83 < 3 )
...
LABEL_190:
        ...
        *((_BYTE *)a1 + 3) = 0;
        ...
        {
          v70 = a2;
          if ( (*a1 & 0x4000) == 0 || (v71 = (unsigned __int64 *)&a1[v82 + 40], a2 > *v71) )
          {
            v71 = (unsigned __int64 *)&a1[v82 + 40];
            *v71 = a2;
          }
          v72 = v6;
          if ( v6 < 3LL )
