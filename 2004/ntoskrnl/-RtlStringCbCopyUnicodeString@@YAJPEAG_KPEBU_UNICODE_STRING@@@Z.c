/*
 * XREFs of ?RtlStringCbCopyUnicodeString@@YAJPEAG_KPEBU_UNICODE_STRING@@@Z @ 0x14059826C
 * Callers:
 *     SmKmKeyGenStart @ 0x140928678 (SmKmKeyGenStart.c)
 * Callees:
 *     RtlUnicodeStringValidateSrcWorker @ 0x140598328 (RtlUnicodeStringValidateSrcWorker.c)
 */
