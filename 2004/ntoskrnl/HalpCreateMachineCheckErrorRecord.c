/*
 * XREFs of HalpCreateMachineCheckErrorRecord @ 0x1404B4C10
 * Callers:
 *     HalpCreateErrorRecord @ 0x1404B4BD0 (HalpCreateErrorRecord.c)
 * Callees:
 ...
 *     HalpMcaAMDIsMemoryError @ 0x1404B82B4 (HalpMcaAMDIsMemoryError.c)
 */
