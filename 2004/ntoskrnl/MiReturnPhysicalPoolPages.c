/*
 * XREFs of MiReturnPhysicalPoolPages @ 0x14032E1F4
 * Callers:
...
void __fastcall MiReturnPhysicalPoolPages(__int64 a1, char a2)
{
  __int64 v2; // rdi
  _QWORD *v3; // r13
  __int64 v4; // r12
  ...
  _DWORD *v19; // r8
  int v20; // eax
  _QWORD *v21; // [rsp+20h] [rbp-49h]
  _QWORD *v22; // [rsp+28h] [rbp-41h]
  ...
  v26 = 0LL;
  v27 = 0LL;
  v30 = *((_DWORD *)MiSearchNumaNodeTable((a1 + 0x58000000000LL) / 48) + 2);
  v29 = a2 & 1;
  v28 = a2 & 2;
  do
  {
