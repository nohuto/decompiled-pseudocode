/*
 * XREFs of VfSuspectDriversLoadCallback @ 0x1409D6B88
 * Callers:
...
LABEL_46:
    ...
    else if ( ViVerifyAllDrivers != 1 )
    {
      if ( !VfRandomVerifiedDrivers
        || (++ViLoadedDriversCount, !_bittest((const signed __int32 *)qword_140D481F8, ViLoadedDriversCount)) )
      {
        v14 = 0;
LABEL_42:
        if ( !v14 )
...
LABEL_38:
    ...
    if ( !Entry )
      goto LABEL_46;
    v15 = (__int64 *)qword_140C1D168;
    if ( *(__int64 **)qword_140C1D168 != &VfSuspectDriversList )
      __fastfail(3u);
    *(_QWORD *)Entry = &VfSuspectDriversList;
    *(_QWORD *)(Entry + 8) = v15;
    *v15 = Entry;
    qword_140C1D168 = Entry;
    goto LABEL_45;
  }
LABEL_58:
  ViDriversLoadLockOwner = 0LL;
  result = KeReleaseMutex((PRKMUTEX)&ViDriversLoadLock, 0);
  if ( v9 )
