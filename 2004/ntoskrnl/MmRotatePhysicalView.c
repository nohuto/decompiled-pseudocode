/*
 * XREFs of MmRotatePhysicalView @ 0x1406DE780
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (unsigned int)MiChargeCommit(ProcessPartition, v11 >> 12, 0) )
        {
          ...
          if ( Pool )
          {
            ...
            *((_QWORD *)&v61 + 1) = v10;
            ...
            MiMapLockedPagesInUserSpaceHelper(v9, (__int64)&v7[1], &v23[1].Next, (_DWORD *)v46, v11 >> 12, 0LL, 16);
