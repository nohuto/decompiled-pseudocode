/*
 * XREFs of MiInPageSingleKernelStack @ 0x1402E4BE0
 * Callers:
...
void *__fastcall MiInPageSingleKernelStack(ULONG_PTR a1, _QWORD *a2)
{
  ...
  v8 = 0LL;
  v50 = *(ULONG_PTR **)(qword_140C4E448 + 8LL * *(unsigned __int16 *)(*(_QWORD *)(a1 + 544) + 1838LL));
  ...
  while ( v6 >= v46 )
  {
    ...
    if ( (*(_BYTE *)v6 & 1) != 0 )
    {
      ...
      *(_BYTE *)(v21 + 35) = *(_BYTE *)(v21 + 35) & 0xF8 | 5;
      ...
      __writecr8(v22);
      if ( v24 )
        MiReleasePageFileInfo((__int64)v50, v24, 0);
      v6 -= 8LL;
      v19 = v51;
      v18 -= 4096LL;
      v16 = ++v44;
