/*
 * XREFs of MiLockAndMapEntireDriver @ 0x1408CD4F4
 * Callers:
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( a3 )
    {
      ...
      if ( v10 )
      {
        ...
        do
        {
          v12->Next = (struct _MDL *)qword_140C4EB78;
    ...
    if ( v8 >= 0 && a3 )
    {
      v18 = MiReservePtes((__int64)&qword_140C4ED40, v10, v16, v17);
      if ( v18 )
      {
        v8 = MiFillSystemPtes(v18, v10, v7, 4u, 4u, &v20);
        v6->MdlFlags |= 1u;
