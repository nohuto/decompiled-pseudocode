/*
 * XREFs of MiAllocateLargeZeroPages @ 0x1405585BC
 * Callers:
 ...
 *     MiIsFreshPfnFromZeroedList @ 0x14031A090 (MiIsFreshPfnFromZeroedList.c)
...
LABEL_11:
          ...
          MiZeroLargePage((__int64)FastLargePages, PfnPageSizeIndex, (unsigned int)v46);
        }
        v23 = v49;
        if ( *v49 != &v48 )
          __fastfail(3u);
