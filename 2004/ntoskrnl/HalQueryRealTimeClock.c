/*
 * XREFs of HalQueryRealTimeClock @ 0x1403413F0
 * Callers:
...
LABEL_22:
  if ( (_BYTE)v2 && v5 )
  {
    if ( !ExpRealTimeIsUniversal )
      v25 += *(_QWORD *)(*((_QWORD *)PsGetCurrentServerSiloGlobals() + 132) + 440LL);
    goto LABEL_55;
  }
...
LABEL_56:
    ...
    if ( !ExpRealTimeIsUniversal )
      v25 = v21 - *(_QWORD *)(*((_QWORD *)PsGetCurrentServerSiloGlobals() + 132) + 440LL);
