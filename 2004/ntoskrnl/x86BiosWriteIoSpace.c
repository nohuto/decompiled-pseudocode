/*
 * XREFs of x86BiosWriteIoSpace @ 0x140396CB0
 * Callers:
 *     XmOutOp @ 0x140393CF0 (XmOutOp.c)
 *     XmOutsOp @ 0x1404E12E0 (XmOutsOp.c)
 * Callees:
 *     x86BiosWritePciAddressPort @ 0x1403C86A4 (x86BiosWritePciAddressPort.c)
 *     x86BiosWriteCmosPort @ 0x1404BA4E8 (x86BiosWriteCmosPort.c)
