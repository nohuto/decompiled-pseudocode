/*
 * XREFs of PpmIdleExecuteTransition @ 0x140217280
 * Callers:
 ...
 *     PpmIdleSetSynchronizationState @ 0x140561920 (PpmIdleSetSynchronizationState.c)
...
LABEL_53:
  ...
  *(_DWORD *)(BugCheckParameter4 + 32820) = v41;
  ...
  if ( v31 || *(_BYTE *)(v191 + 6) || *(_BYTE *)(v191 + 7) )
  {
    ...
    if ( *(_BYTE *)(v191 + 7) )
    {
      v46 = PpmCurrentProfile[342 * dword_140C238AC + 24];
  ...
  *(_QWORD *)(BugCheckParameter4 + 32848) = v77;
  ...
  if ( v12 >= 0 )
  {
    ...
    if ( v193 != -1 )
    {
      ...
      if ( !qword_140C4FE40 && v193 == dword_140C4FE80 )
        _InterlockedCompareExchange64(&qword_140C4FE40, MEMORY[0xFFFFF78000000008], 0LL);
      if ( a5 )
      {
    ...
    *(_BYTE *)(BugCheckParameter4 + 248) &= ~1u;
    if ( DeepSleep )
    {
      ...
      if ( v120 )
      {
        ...
        v121->DeepSleep = 0;
        _InterlockedAnd64(
          &qword_140C2B168[(unsigned __int64)(unsigned int)KiProcessorIndexToNumberMappingTable[v122] >> 6],
