/*
 * XREFs of MiBuildDynamicRegion @ 0x1403B1F94
 * Callers:
...
ULONG_PTR __fastcall MiBuildDynamicRegion(__int64 *a1, __int64 a2, unsigned __int64 a3)
{
  ...
  a1[3] = v5;
  if ( a1 == &qword_140C4DE98 )
    a1[3] = v5 & 0xFFF;
  a1[2] = v4;
  v7 = 1LL;
  if ( a1 == &qword_140C4DE98 && (v12 = a1[1]) != 0 )
  {
  ...
  {
    v8 = 8 * ((v4 >> 6) + ((v4 & 0x3F) != 0));
    result = MiReservePtes((__int64)&qword_140C4ED40, (unsigned int)(v8 >> 12) + ((v8 & 0xFFF) != 0), v6, 1uLL);
    v10 = result;
    if ( !result )
      return result;
    v7 = 3LL;
