/*
 * XREFs of CcShouldLazyWriteCacheMap @ 0x1402C63DC
 * Callers:
...
bool __fastcall CcShouldLazyWriteCacheMap(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4)
{
  int v6; // ecx
  __int64 v8; // r8
  __int64 v9; // rdx
  int v10; // eax
  __int64 v11; // r9
  unsigned __int64 *Partition; // rax
  ...
  *(_DWORD *)(a1 + 268) = v10;
  ...
  else
  {
    if ( (*(_DWORD *)(a3 + 80) & 0x8000) == 0 || !(_DWORD)v8 )
      return 1;
    Partition = (unsigned __int64 *)CcGetPartition((_QWORD *)a1, v9, v8, a4);
    return !CcCanIWriteStreamEx(Partition, a3, 0x1000000u, 0, 8, 0LL);
  }
}
