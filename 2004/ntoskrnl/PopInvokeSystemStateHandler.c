/*
 * XREFs of PopInvokeSystemStateHandler @ 0x14098FAAC
 * Callers:
...
__int64 __fastcall PopInvokeSystemStateHandler(int a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    qword_140C50480 = DeferredContext[4];
    dword_140C50488 = DeferredContext[5];
    byte_140C5048C = BYTE4(DeferredContext[5]);
    dword_140C50490 = DeferredContext[6];
    qword_140C50468 = (__int64)v7;
    v9 = &PopHibernateSystemContext;
    qword_140C50470 = v8;
    qword_140C50478 = v6;
    qword_140C50498 = DeferredContext[7];
    RtlpInterlockedPushEntrySList(&stru_140C504A0, &v38[8]);
  }
  else
  {
  ...
  if ( SLODWORD(v38[7].Next) >= 0 )
  {
    *((_BYTE *)v9 + 44) = 1;
    ...
    if ( a2 )
    {
      ...
      MmInvalidateDumpAddresses(qword_140C23048, 19LL);
      v13 = *(_QWORD *)(a2 + 304);
      if ( v13 )
  ...
  if ( a2 )
  {
    ...
    v23 = qword_140C23A20 == 0;
    *v9 = (__int64)&unk_140C23A18;
    v9[3] = 0LL;
    if ( !v23 )
      PopIssueNextState(v9, v38, 6LL);
...
LABEL_49:
  ...
  if ( Next >= 0 )
  {
    if ( dword_140C22E60 != 4 || PoResumeFromHibernate )
    {
      v15 = 0;
      v28 = KeQueryPerformanceCounter(0LL);
      ((void (__fastcall *)(void *, __int64 *))off_140C006A0[0])(&unk_140C23488, &qword_140C23490);
    }
    else
    {
      v15 = 1;
    ...
    if ( v15 )
    {
      ...
      qword_140C23368 = v28.QuadPart - PerformanceCounter.QuadPart;
    }
  }
  ...
  if ( a2 )
  {
    if ( !byte_140C23061 && Next == 1073742484 )
    {
      if ( byte_140C50450 )
        BgLibraryInitialize(qword_140C50448, 0LL);
    }
  }
  else
  {
