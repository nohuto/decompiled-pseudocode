/*
 * XREFs of EtwpNotifyGuid @ 0x1406329B8
 * Callers:
...
__int64 __fastcall EtwpNotifyGuid(__int64 a1, __int64 a2, char a3)
{
  ...
  *(_DWORD *)(a2 + 20) = 0;
  ...
  if ( a3 )
  {
    if ( *(_DWORD *)a2 != 4 )
    {
      UmReplyObject = EtwpAccessCheck(*(PSECURITY_DESCRIPTOR *)(GuidEntryByGuid + 72), v12, 0LL);
      if ( UmReplyObject < 0 )
        goto LABEL_51;
    }
  }
  ...
  *(_QWORD *)(v15 + 416) = KeGetCurrentThread();
  ...
  if ( *(_BYTE *)(a2 + 12) )
  {
    UmReplyObject = EtwpCreateUmReplyObject(v15, (__int64)&v27);
    if ( UmReplyObject < 0 )
      goto LABEL_50;
    *(_QWORD *)(a2 + 24) = 0LL;
  }
...
LABEL_27:
  ...
  for ( i = (_QWORD *)*v16; i != v16; i = (_QWORD *)*i )
  {
    ...
    if ( (v19 & 2) != 0
      ...
      && (!v24 || (unsigned int)PsGetProcessId((PEPROCESS)i[10]) == v24) )
    {
      if ( !v25 || (v17 = EtwpCheckCurrentUserProcessAccess(i[10]), v17 >= 0) )
      {
        if ( *(_DWORD *)a2 == 4 )
        {
          v29 = 0;
