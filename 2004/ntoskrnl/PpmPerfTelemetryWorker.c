/*
 * XREFs of PpmPerfTelemetryWorker @ 0x14070E530
 * Callers:
 *     <none>
 * Callees:
...
__int64 PpmPerfTelemetryWorker()
{
  ...
  if ( (unsigned int)dword_140C021E8 > 5 && tlgKeywordOn((__int64)&dword_140C021E8, 0x400000000000LL) )
  {
    ...
    v10 = 0x1000000LL;
    v19 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C021E8, (unsigned __int8 *)&word_140025F46, 0LL, 0LL, 6u, &v11);
  }
  return PopOkayToQueueNextWorkItem((__int64)&unk_140C24408);
}
