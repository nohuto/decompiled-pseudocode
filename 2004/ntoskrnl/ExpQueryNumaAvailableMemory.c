/*
 * XREFs of ExpQueryNumaAvailableMemory @ 0x14094777C
 * Callers:
 *     ExpQuerySystemInformation @ 0x14068F290 (ExpQuerySystemInformation.c)
 * Callees:
 *     MmGetProcessPartitionId @ 0x14027D224 (MmGetProcessPartitionId.c)
 *     MmGetAvailablePages @ 0x14027D234 (MmGetAvailablePages.c)
