/*
 * XREFs of PiDevCfgConfigurePropertyMatchCallback @ 0x1408A2B70
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
char __fastcall PiDevCfgConfigurePropertyMatchCallback(__int64 a1, __int64 a2)
{
  ...
  if ( (*(_DWORD *)(a2 + 104) & 2) != 0 )
    goto LABEL_11;
  v3 = *(_QWORD *)a1 - *(_QWORD *)off_140D2D790[0];
  if ( *(_QWORD *)a1 == *(_QWORD *)off_140D2D790[0] )
    v3 = *(_QWORD *)(a1 + 8) - *(_QWORD *)off_140D2D790[0]->fmtid.Data4;
  if ( v3 )
  {
LABEL_11:
    v8 = &off_140D2D338;
