/*
 * XREFs of CcMapAndCopyInToCache @ 0x140222C30
 * Callers:
        ...
        struct _KTHREAD *a9)
{
  ...
  NTSTATUS v149; // [rsp+1E8h] [rbp+18h]
  ...
  *(_OWORD *)v127 = 0LL;
  ...
  if ( !v12 )
  {
    ...
    v16 = *(_QWORD *)(a1 + 528);
    if ( *(_QWORD *)(a1 + 168)
      && v16 != *(_QWORD *)(MmGetControlAreaPartition(*(_QWORD *)((*(_QWORD *)(a1 + 96) & 0xFFFFFFFFFFFFFFF0uLL) + 0x28))
                          + 8) )
    {
      KeBugCheckEx(0x34u, 0x1313uLL, 0xFFFFFFFFC0000420uLL, 0LL, 0LL);
    }
    if ( (*(_DWORD *)(a6 + 80) & 0x1000000) == 0 || (unsigned __int8)CcCanIWriteStreamEx(v16, a6, v150, 0, 0, 0LL) )
    {
...
LABEL_8:
    ...
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)(v16 + 128), &v146);
...
LABEL_20:
  ...
  while ( v150 )
  {
    ...
    {
      CcFlushCachePriv(*(_QWORD *)(a6 + 40), (unsigned int)&v117, v26, 0, v100, (__int64)v127);
      v60 = v127[0];
      if ( v127[0] < 0 )
      {
...
LABEL_120:
  ...
  if ( v109 || v105 )
  {
    ...
    if ( !v100 || (*(_DWORD *)(v9 + 152) & 0x40000000) == 0 )
    {
      ...
      CcFlushCachePriv(*(_QWORD *)(a6 + 40), v11, v66, 0, v100, (__int64)v127);
      v11 = v127[0];
    }
    if ( v110 )
    {
    ...
    if ( v11 < 0 )
    {
      v98 = FsRtlIsNtstatusExpected(v11);
      v99 = -1073741591;
      if ( v98 )
        v99 = v11;
      RtlRaiseStatus(v99);
