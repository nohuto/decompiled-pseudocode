/*
 * XREFs of ?StDmpSinglePageRetrieve@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAXPEAU_ST_PAGE_LOCATION@1@@Z @ 0x14030580C
 * Callers:
 ...
 *     ?StDmpSinglePageLookup@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@PEAU_ST_IO_PARAMS@1@PEAPEAU_ST_PAGE_RECORD@1@@Z @ 0x14030635C (-StDmpSinglePageLookup@-$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_READ_CONTEXT@1@P.c)
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmpSinglePageRetrieve(__int64 a1, __int64 a2, __int64 a3, int a4, __int64 a5)
{
  int v5; // r13d
  ...
  {
    v9 = ST_STORE<SM_TRAITS>::StDmpSinglePageLookup(a1, a2, a3, &v26);
    if ( v9 < 0 )
  ...
  {
    v28 = SmSetThreadSystemPagePriority(v27, 0LL, 0LL);
    v8 = 1;
  }
  ...
  *(_QWORD *)(a2 + 56) = a3;
  ...
  if ( v7 )
  {
    ...
    {
      SMKM_STORE<SM_TRAITS>::SmStUnmapVirtualRegion(v20, v12, v19, v20);
    }
    else
    {
      v22 = *(_QWORD *)(v20 + 6216);
...
LABEL_20:
  if ( v8 )
    SmSetThreadSystemPagePriority(v27, v28, 1LL);
  return (unsigned int)v9;
}
