/*
 * XREFs of BgkSetVirtualFrameBuffer @ 0x1403C96F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     BgGetIsColorOverridden @ 0x1409F1B58 (BgGetIsColorOverridden.c)
 *     BgConvertResources @ 0x1409F3550 (BgConvertResources.c)
 */
