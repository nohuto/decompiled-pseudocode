/*
 * XREFs of KiNpxSegmentOverrunAbort @ 0x140403EC0
 * Callers:
 *     KiNpxSegmentOverrunAbortShadow @ 0x140A115C0 (KiNpxSegmentOverrunAbortShadow.c)
 * Callees:
...
void __fastcall __noreturn KiNpxSegmentOverrunAbort(__int64 a1, __int64 a2)
{
  ...
  v5 = __readcr4();
  v6 = __readcr0();
  KiBugCheckDispatch(127LL, 9LL, v6, v5);
}
