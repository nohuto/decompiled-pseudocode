/*
 * XREFs of MiSwitchBaseAddress @ 0x1406FCDAC
 * Callers:
 *     MiRelocateImageAgain @ 0x14060666C (MiRelocateImageAgain.c)
 * Callees:
 *     MiWalkEntireImage @ 0x14022B620 (MiWalkEntireImage.c)
 *     MiApplyBytestreamFixup @ 0x140350904 (MiApplyBytestreamFixup.c)
 *     DbgUnLoadImageSymbolsUnicode @ 0x140370690 (DbgUnLoadImageSymbolsUnicode.c)
 */

__int64 __fastcall MiSwitchBaseAddress(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rdi
  __int64 v5; // r10
  __int64 v7; // rsi
