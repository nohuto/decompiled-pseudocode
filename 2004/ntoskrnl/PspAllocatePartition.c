/*
 * XREFs of PspAllocatePartition @ 0x1407B9758
 * Callers:
        ...
        __int64 a7)
{
  ...
  *((_QWORD *)v11 + 12) = 0LL;
  ...
  if ( !a5 )
  {
    KiStackAttachProcess(PsInitialSystemProcess, 0LL, (__int64)v23);
...
LABEL_8:
  ...
  {
    v9 = 0;
    PartitionSystemProcess = ObInsertObjectEx((PADAPTER_OBJECT)v11, 0LL, v20, 0, 0, 0LL, (unsigned __int64 *)&v21);
    if ( PartitionSystemProcess >= 0 )
    {
      v13 = (_QWORD *)v22;
      v14 = v21;
