/*
 * XREFs of Normalization__NormalizeCharacter @ 0x140915290
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x14091436C (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x1409150D4 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x140588610 (ComposeHangulLV.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x140588CBC (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x14091436C (Normalization__AppendDecomposedChar.c)
