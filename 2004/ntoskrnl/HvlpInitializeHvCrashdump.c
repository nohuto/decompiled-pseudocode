/*
 * XREFs of HvlpInitializeHvCrashdump @ 0x1404F3F8C
 * Callers:
 ...
 *     KeRegisterNmiCallback @ 0x14050F4A0 (KeRegisterNmiCallback.c)
...
__int64 __fastcall HvlpInitializeHvCrashdump(__int64 a1)
{
  ...
  v2 = -1073741823;
  v3 = *(_QWORD *)(a1 + 16);
  dword_140C4739C = *(_DWORD *)a1;
  qword_140C473A0 = *(_QWORD *)(a1 + 8);
  dword_140C47398 = v1;
  qword_140C47390 = v3;
  if ( !v1 || (qword_140C47388 = (void *)MmMapIoSpaceEx(v3, (unsigned int)(v1 << 12), 2u)) != 0LL )
  {
    ...
    if ( !VslVsmEnabled )
    {
      ...
      *(_QWORD *)&HvlpCrashdumpData = KeRegisterNmiCallback((PNMI_CALLBACK)HvlCrashdumpCallbackRoutine, 0LL);
      qword_140C473A8 = MmAllocateMappingAddress(0x1000uLL, 0x204C5648u);
      if ( !qword_140C473A8 )
        goto LABEL_16;
      if ( !VslVsmEnabled )
        return 0;
    }
    stru_140C47328.State = 0;
    if ( KeRegisterBugCheckReasonCallback(
           &stru_140C47328,
