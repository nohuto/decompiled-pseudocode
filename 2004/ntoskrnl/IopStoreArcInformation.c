/*
 * XREFs of IopStoreArcInformation @ 0x140A4D76C
 * Callers:
...
__int64 __fastcall IopStoreArcInformation(__int64 a1)
{
  ...
  v2 = dword_140C19590;
  v3 = 0;
  qword_140D2E858 = (__int64)&IoArcTableListHead;
  ...
  for ( i = *v1; ; i = (__int64 *)*i )
  {
    ...
    *((_OWORD *)Pool_0 + 3) = *((_OWORD *)i + 3);
    ...
    if ( v2 == 1 && v7 >= 9 && !strnicmp(&v8[v7 - 9], "rdisk(0)", 8uLL) )
      *((_BYTE *)Pool_0 + 76) = 1;
    v10 = (PVOID **)qword_140D2E858;
    if ( *(PVOID **)qword_140D2E858 != &IoArcTableListHead )
LABEL_30:
      __fastfail(3u);
    *Pool_0 = &IoArcTableListHead;
    Pool_0[1] = v10;
    *v10 = Pool_0;
    qword_140D2E858 = (__int64)Pool_0;
  }
  while ( 1 )
  {
