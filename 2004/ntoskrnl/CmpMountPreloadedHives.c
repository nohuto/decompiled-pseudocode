...
LABEL_17:
      ...
      *(_WORD *)(v2 + 202) = 0;
      *(_QWORD *)(v2 + 208) = 0LL;
      SystemPartition = CmpOpenHiveFile(&Destination_8, 0, &v25, &v17, 7u, 0LL, (__int64)Length, 0LL, 0LL);
...
LABEL_52:
        *(_QWORD *)(v2 - 1560) = v30;
        ...
        ExRaiseHardError(-1073741288, 1, 1, (unsigned int)&p_Destination_8, 1, (__int64)&v23);
      ...
      SystemPartition = CmpOpenHiveFile(&Destination_8, 5u, &v27, &v20, v8, 0LL, 0LL, 0LL, 0LL);
      if ( SystemPartition < 0 )
      {
        v0 = 48;
        goto LABEL_52;
      ...
      *(_DWORD *)(v2 - 1456) = v13 & 0xFFFFF7FF;
      CmpUnlockRegistry();
      KiStackAttachProcess(PsInitialSystemProcess, 0LL, (__int64)v31);
...
LABEL_45:
    ...
    *(_QWORD *)&Destination_8.Length = 0x10000000LL;
    ...
    else
    {
      if ( (v4 & 0x2000) != 0 )
      {
        SystemPartition = SyspartGetSystemPartition(v1, 4096LL, &v18);
        if ( SystemPartition < 0 )
          goto LABEL_52;
        goto LABEL_16;
      }
