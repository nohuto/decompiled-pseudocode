/*
 * XREFs of HalpTimerWatchdogStart @ 0x1404BD780
 * Callers:
 *     HalpTimerInitializeSystemWatchdog @ 0x1404BD5F0 (HalpTimerInitializeSystemWatchdog.c)
 * Callees:
 *     HalpTimerGetInternalData @ 0x14021F560 (HalpTimerGetInternalData.c)
 *     HalpSetTimer @ 0x1402FE504 (HalpSetTimer.c)
 *     HalpTimerWatchdogWakeSetDueTime @ 0x14039118C (HalpTimerWatchdogWakeSetDueTime.c)
