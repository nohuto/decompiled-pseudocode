/*
 * XREFs of PopEtInit @ 0x140A6A118
 * Callers:
 ...
 *     PopEtInitializeBuiltinAppId @ 0x1407B8D6C (PopEtInitializeBuiltinAppId.c)
 *     RtlInternTableInitialize @ 0x1407B8DD4 (RtlInternTableInitialize.c)
