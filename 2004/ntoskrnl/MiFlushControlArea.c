/*
 * XREFs of MiFlushControlArea @ 0x1405242E4
 * Callers:
...
__int64 __fastcall MiFlushControlArea(char *P, unsigned __int8 a2, __int64 *a3, struct _FILE_OBJECT **a4)
{
  ...
  *(_QWORD *)(*(_QWORD *)(qword_140C4E448 + 8LL * (*((_WORD *)P + 30) & 0x3FF)) + 1688LL) = 0LL;
  ...
  else
  {
    ...
    v20 = MiFlushSectionInternal(0LL, 0LL, (__int64 *)P + 16, 0LL, 0LL, 2u, &v35);
...
LABEL_34:
    ...
    v25 = *(_QWORD *)(qword_140C4E448 + 8LL * (*((_WORD *)P + 30) & 0x3FF));
