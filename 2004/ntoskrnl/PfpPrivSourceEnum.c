/*
 * XREFs of PfpPrivSourceEnum @ 0x1406980C8
 * Callers:
 ...
 *     MiFillSessionWorkingSetEntry @ 0x1403582A0 (MiFillSessionWorkingSetEntry.c)
 ...
 *     PfpPrivSourceAdd @ 0x140698854 (PfpPrivSourceAdd.c)
  ...
  if ( v6 )
  {
    ...
    do
    {
      ...
      if ( !v20 || (*(_DWORD *)(v6 + 2172) & 1) == 0 )
      {
        ...
        v34[2] = (v6 ^ *(_QWORD *)(v6 + 1128)) & 0x1FFFFFFFFFFFFFFFLL;
        v21 = v34[3];
        if ( v29 )
          v21 = v6;
        v34[3] = v21;
