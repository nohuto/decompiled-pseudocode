/*
 * XREFs of EtwpCoverageRecord @ 0x140703E28
 * Callers:
 ...
 *     EtwpCoverageAddToStringBuffer @ 0x140356B18 (EtwpCoverageAddToStringBuffer.c)
...
LABEL_9:
  ...
  if ( !v4 && v5 && (unsigned int)dword_140C02BE8 > 5 && tlgKeywordOn((__int64)&dword_140C02BE8, 2LL) )
  {
    ...
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140C02BE8, (unsigned __int8 *)byte_14002B5FB, 0LL, 0LL, 7u, &v50);
  }
  if ( EtwpCoverageCoreTracingEnabled && (unsigned int)dword_140C02BE8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140C02BE8, 1LL) )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)&dword_14002B65C,
        0LL,
        0LL,
        9u,
        &v36);
