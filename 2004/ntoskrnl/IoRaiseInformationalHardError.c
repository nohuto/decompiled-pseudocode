/*
 * XREFs of IoRaiseInformationalHardError @ 0x140500AE0
 * Callers:
...
BOOLEAN __stdcall IoRaiseInformationalHardError(NTSTATUS ErrorStatus, PUNICODE_STRING String, PKTHREAD Thread)
{
  ...
  if ( ErrorStatus == -1073741283
    ...
    || !Thread && dword_140C45D3C >= 25 )
  {
    return 0;
  }
  if ( dword_140C45D5C > 25 )
    return 0;
...
LABEL_47:
  ...
  if ( !Thread )
  {
    v10 = KeAcquireSpinLockRaiseToDpc(&qword_140C45D30);
    if ( dword_140C45D3C < 25
      && (!IopCurrentHardError
        ...
        || memcmp(v12, *(const void **)(IopCurrentHardError + 32), *((unsigned __int16 *)PoolWithTag + 12)))) )
    {
      ...
      {
LABEL_35:
        v16 = (_QWORD *)qword_140C45D28;
        if ( *(__int64 **)qword_140C45D28 != &qword_140C45D20 )
          __fastfail(3u);
        *(_QWORD *)PoolWithTag = &qword_140C45D20;
        *((_QWORD *)PoolWithTag + 1) = v16;
        *v16 = PoolWithTag;
        qword_140C45D28 = (__int64)PoolWithTag;
        KeReleaseSemaphoreEx((__int64)&byte_140C45D38, 0LL, 1LL, v11, 0);
        if ( !byte_140C45D58 )
        {
          byte_140C45D58 = 1;
      ...
      while ( 1 )
      {
        ...
        v13 = *(_QWORD *)v13;
        if ( (__int64 *)v13 == &qword_140C45D20 )
          goto LABEL_35;
      }
    }
    KxReleaseSpinLock(&qword_140C45D30);
...
LABEL_45:
  ...
  _InterlockedIncrement(&dword_140C45D5C);
  KeInitializeApc(
    (__int64)v9,
    (__int64)Thread,
    0,
