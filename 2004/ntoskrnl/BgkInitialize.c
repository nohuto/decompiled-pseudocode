/*
 * XREFs of BgkInitialize @ 0x140A94414
 * Callers:
    ...
    if ( !a2 )
    {
      ...
      if ( Interface )
        ((void (__fastcall *)(_QWORD, __int64, _QWORD, _QWORD))*Interface)(
          ...
          4291217094LL,
          (unsigned int)dword_140CF5140,
          0LL);
      v6 = ((__int64 (__fastcall *)(__int64, __int64, int *, int *))off_140C00A68[0])(9LL, 4LL, &dword_140CF23E0, &v8);
      v7 = dword_140CF23E0;
      if ( v6 < 0 )
        v7 = 2;
      dword_140CF23E0 = v7;
