/*
 * XREFs of SLQueryLicenseValueInternal @ 0x1407946B4
 * Callers:
...
LABEL_11:
  ...
  v47 = 0;
  v49 = 0;
  v9 = sub_1403B596C(v7, (__int64)&qword_140980700, 0LL, (__int64)&v49, 4, (__int64)&v58);
  v47 = v9;
  if ( !qword_140D2D408 || !v49 || RtlEqualUnicodeString(a2, &stru_140980710, 0) )
  {
LABEL_15:
    v16 = v52;
    v17 = (__int64)v51;
...
LABEL_68:
  ...
  v16 = v52;
  v17 = (__int64)v51;
  v42 = qword_140D2D408(P, 0LL, 0LL, 0LL, Str1, v37, v55, a5, v51, v52, 0LL);
...
LABEL_16:
  ...
  if ( v18 )
  {
    v9 = sub_1403B596C(v7, (__int64)&v60, v16, v55, a5, v17);
    v47 = v9;
    if ( v9 == -1073741762 )
    {
      ...
      *(_BYTE *)(v7 + 37616) = 1;
      if ( (_InterlockedExchangeAdd64((volatile signed __int64 *)(v7 + 37464), 0xFFFFFFFFFFFFFFFFuLL) & 6) == 2 )
        ExfTryToWakePushLock((volatile signed __int64 *)(v7 + 37464));
      KeAbPostRelease(v7 + 37464);
      KeLeaveCriticalRegionThread((__int64)KeGetCurrentThread());
      v9 = v47;
    }
