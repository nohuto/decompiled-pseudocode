/*
 * XREFs of CmpLoadHiveThread @ 0x140786B20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlUnicodeStringInit @ 0x1404E7694 (RtlUnicodeStringInit.c)
 ...
 *     CmpIsShutdownRundownActive @ 0x14087276C (CmpIsShutdownRundownActive.c)
