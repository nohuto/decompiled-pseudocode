/*
 * XREFs of IopIrpHasValidCombinationOfExtensionTypes @ 0x140502830
 * Callers:
 *     IoSetAdapterCryptoEngineExtension @ 0x1405026C0 (IoSetAdapterCryptoEngineExtension.c)
 *     IoSetFsTrackOffsetState @ 0x140502720 (IoSetFsTrackOffsetState.c)
