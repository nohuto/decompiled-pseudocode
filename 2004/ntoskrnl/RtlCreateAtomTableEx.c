/*
 * XREFs of RtlCreateAtomTableEx @ 0x140201810
 * Callers:
 *     RtlCreateAtomTable @ 0x1405D0390 (RtlCreateAtomTable.c)
 * Callees:
 *     RtlULongLongMult @ 0x1402FE7AC (RtlULongLongMult.c)
 *     memset @ 0x14040A280 (memset.c)
 *     RtlpInitializeLockAtomTable @ 0x1405D03AC (RtlpInitializeLockAtomTable.c)
 *     RtlpInitializeHandleTableForAtomTable @ 0x1405D03BC (RtlpInitializeHandleTableForAtomTable.c)
