/*
 * XREFs of MmManageFaultRange @ 0x14039AD78
 * Callers:
...
__int64 __fastcall MmManageFaultRange(ULONG_PTR BugCheckParameter3, ULONG_PTR BugCheckParameter4, char a3, char a4)
{
  ...
  {
    v9 = 0;
    v10 = (volatile signed __int64 *)&unk_140C4C720;
    while ( 1 )
    {
      v11 = v10 - 3;
...
LABEL_5:
  ...
  {
    v15 = (unsigned __int64 *)&unk_140C4C700;
  }
  v16 = ExAcquireSpinLockExclusive(&dword_140C4C6F8);
...
LABEL_17:
  ...
  v17 = 0LL;
LABEL_18:
  ExReleaseSpinLockExclusiveFromDpcLevel(&dword_140C4C6F8);
  if ( KiIrqlFlags )
  {
    if ( (KiIrqlFlags & 1) != 0 )
    {
  ...
  {
    v21 = 0LL;
    while ( v17 != (unsigned __int64 *)((char *)&unk_140C4C708 + 40 * v21) )
    {
