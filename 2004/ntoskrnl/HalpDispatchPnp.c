/*
 * XREFs of HalpDispatchPnp @ 0x1407530D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     HalpInitializeLateSystemActions @ 0x1403A560C (HalpInitializeLateSystemActions.c)
 *     HalpAllocateCR3Root @ 0x1403C84B8 (HalpAllocateCR3Root.c)
 *     HalpQueryInterface @ 0x140753350 (HalpQueryInterface.c)
