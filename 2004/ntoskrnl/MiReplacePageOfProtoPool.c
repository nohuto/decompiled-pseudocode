/*
 * XREFs of MiReplacePageOfProtoPool @ 0x1402F4350
 * Callers:
...
LABEL_44:
    ...
    if ( (unsigned int)v18 < 0x200 )
    {
      ...
      if ( (signed __int32 *)v17 != &v64[15] && (*(_DWORD *)v17 | *((_DWORD *)qword_140011690 + (v18 & 0x1F))) == -1 )
      {
        v19 = v18 - (v18 & 0x1F) + 32;
      ...
      if ( (signed __int32 *)v17 == &v64[15] )
        goto LABEL_27;
      v11 = v19 & 0x1F;
      if ( (*(_DWORD *)v17 & ~*((_DWORD *)qword_140011690 + v11)) != 0 )
        goto LABEL_27;
...
LABEL_33:
  ...
  if ( v6 )
  {
    MiLockNestedPageAtDpcInline(48 * v60 - 0x58000000000LL);
  }
  else
  {
    v52 = 0;
