/*
 * XREFs of MmReadProcessPageTables @ 0x140542930
 * Callers:
...
__int64 __fastcall MmReadProcessPageTables(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v6 = ValidPte;
  __wbinvd();
  result = ExTryAcquireSpinLockSharedAtDpcLevel(&dword_140C50C48);
  v8 = 0;
  if ( (_DWORD)result )
  {
...
LABEL_18:
    ...
    KeFlushSingleCurrentTb(v9, 0);
    ExReleaseSpinLockSharedFromDpcLevel(&dword_140C50C48);
    return 1LL;
  }
  return result;
}
