/*
 * XREFs of MmIsAddressValidEx @ 0x1402594E0
 * Callers:
 ...
 *     IopGetMaxValidMemorySizeDown @ 0x1404FED74 (IopGetMaxValidMemorySizeDown.c)
 *     IopGetMaxValidSectionSize @ 0x1404FEDE8 (IopGetMaxValidSectionSize.c)
 *     IopGetMaxValidSectionSizeDown @ 0x1404FEE30 (IopGetMaxValidSectionSizeDown.c)
 ...
 *     KiValidateComponentName @ 0x1405136D0 (KiValidateComponentName.c)
 *     MmIsAddressValid @ 0x1405316A0 (MmIsAddressValid.c)
 *     MmIsSpecialPoolAddress @ 0x140532020 (MmIsSpecialPoolAddress.c)
 ...
 *     EtwpIsValidImageAddress @ 0x1405C9604 (EtwpIsValidImageAddress.c)
