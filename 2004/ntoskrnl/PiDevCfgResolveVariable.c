/*
 * XREFs of PiDevCfgResolveVariable @ 0x140768FB0
 * Callers:
...
__int64 __fastcall PiDevCfgResolveVariable(__int64 a1, const WCHAR *a2, _QWORD *a3)
{
  ...
  *(&ObjectAttributes.Length + 1) = 0;
  ...
  if ( v13 >= 0 )
  {
    RegistryValue = IopGetRegistryValue(KeyHandle, (const WCHAR *)&dword_1409889C4, 0, &P);
    v5 = (unsigned int *)P;
    v4 = RegistryValue;
    if ( RegistryValue < 0 )
      goto LABEL_29;
    ...
    v15 = (const wchar_t **)&off_1409824D0;
    ...
    v6 = (__int64 (__fastcall *)(__int64, HANDLE, _OWORD *))*(&funcs_140769216 + 2 * v17);
    if ( !v6 )
    {
LABEL_11:
      v4 = -1073741772;
...
LABEL_29:
  ...
  {
    v4 = 0;
    v18 = (const wchar_t **)&off_140981F20;
    v19 = 0LL;
