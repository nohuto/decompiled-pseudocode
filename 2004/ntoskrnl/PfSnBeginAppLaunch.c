/*
 * XREFs of PfSnBeginAppLaunch @ 0x1406B7880
 * Callers:
 ...
 *     PfSnCheckScenario @ 0x1406B7A8C (PfSnCheckScenario.c)
 ...
 *     PfSnFindImageFileName @ 0x1406B8C70 (PfSnFindImageFileName.c)
...
LABEL_17:
  ...
  *(_DWORD *)&SubStr[30] = a3 + v14;
  if ( (dword_140C50350 & 0x20) != 0 || v21 == 2 )
    v7 |= 2u;
