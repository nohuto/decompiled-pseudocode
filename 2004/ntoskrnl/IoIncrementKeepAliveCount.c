/*
 * XREFs of IoIncrementKeepAliveCount @ 0x140501BC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IoIncrementKeepAliveCount(__int64 a1, void *a2)
{
  ...
  if ( v4 >= 0 && v16 == 1 )
  {
    ...
    {
      v6 = KeAcquireSpinLockRaiseToDpc(&qword_140C45CB0);
      v7 = (_BYTE *)v17;
      v8 = v6;
      ++*(_DWORD *)(v17 + 32);
      if ( !v7[16] )
      {
        v9 = qword_140C45CA0;
        if ( *((PVOID **)qword_140C45CA0 + 1) != &qword_140C45CA0 )
          __fastfail(3u);
        *(_QWORD *)v7 = qword_140C45CA0;
        *((_QWORD *)v7 + 1) = &qword_140C45CA0;
        v9[1] = v7;
        qword_140C45CA0 = v7;
        v7[16] = 1;
        if ( !byte_140C45CD8 )
