/*
 * XREFs of KiCaptureUmsThreadContext @ 0x1408BB630
 * Callers:
 *     KiParkUmsThread @ 0x140520A70 (KiParkUmsThread.c)
 * Callees:
 *     KeContextFromKframes @ 0x1402E6110 (KeContextFromKframes.c)
 *     KeCopyLastBranchInformation @ 0x1402EAAF0 (KeCopyLastBranchInformation.c)
...
__int64 __fastcall KiCaptureUmsThreadContext(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(v5 + 1264) = *(_DWORD *)(v5 + 1264) & 0xFFFFFFFB | (4 * (*(_DWORD *)(a2 + 72) & 1));
  ...
  if ( (*(_BYTE *)(a2 + 72) & 1) != 0 )
  {
    KeContextFromKframes(v4, v3, v12);
  ...
  else
  {
    if ( (*(_DWORD *)(v4 + 256) & 0x355LL) != 0 )
    {
      ...
      *(_QWORD *)(v5 + 128) = *(_QWORD *)(v4 + 256);
      KeCopyLastBranchInformation(v12, v4);
    }
    else
    {
      *(_QWORD *)(v5 + 128) = 0LL;
