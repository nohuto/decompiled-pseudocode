/*
 * XREFs of PopRestoreHiberContext @ 0x140990478
 * Callers:
  ...
  if ( Number < *(_DWORD *)(BugCheckParameter3 + 256) )
  {
    ...
    *(_QWORD *)(*(_QWORD *)(BugCheckParameter3 + 264) + ((unsigned __int64)Number << 7) + 80) = 0LL;
    if ( Number == *(_DWORD *)(BugCheckParameter3 + 192) )
    {
      ...
      if ( qword_140C50448 )
      {
        v12 = BgLibraryInitialize(qword_140C50448, 0xFFFFFFFFLL);
        v13 = byte_140C50450;
        if ( v12 >= 0 )
          v13 = 1;
        byte_140C50450 = v13;
      ...
      v14 = __rdtsc();
      qword_140C23500 += (((unsigned __int64)HIDWORD(v14) << 32) | (unsigned int)v14) - v11;
    }
    if ( !Number )
    {
      v5 = 0LL;
      ...
      *(_BYTE *)(BugCheckParameter3 + 4) = 1;
      ...
      if ( *(_QWORD *)(BugCheckParameter3 + 400) )
      {
        ...
        *(_QWORD *)&v34 = qword_140C23038;
        *((_QWORD *)&v34 + 1) = qword_140C23038;
        v35 = 0LL;
        ...
        v29 = __rdtsc();
        v10 = v36;
        qword_140C234E0 = (((unsigned __int64)HIDWORD(v29) << 32) | (unsigned int)v29) - v36;
      ...
      if ( v15 )
      {
        ...
        do
        {
          ...
          qword_140C234C0 += *(_QWORD *)(v23 + v21 + 64);
          qword_140C234D0 += *(_QWORD *)(v23 + *(_QWORD *)(BugCheckParameter3 + 264) + 72);
          qword_140C234F8 += *(_QWORD *)(v23 + *(_QWORD *)(BugCheckParameter3 + 264) + 80);
          v21 = *(_QWORD *)(BugCheckParameter3 + 264);
      ...
      if ( v25 > v24 )
      {
        v33 = 100 * (qword_140C234C8 * v15 / (v18 + v19 + 1) - v24) / (v25 - v24);
        if ( v33 > 99 )
        {
          dword_140C23064 = 99;
          goto LABEL_27;
...
LABEL_27:
      v26 = __rdtsc();
      qword_140C234E8 = (((unsigned __int64)HIDWORD(v26) << 32) | (unsigned int)v26) - v10;
      result = (struct _KPRCB *)(qword_140C234E8 - qword_140C234E0 - v4);
      qword_140C234B8 = (__int64)result;
      return result;
    }
