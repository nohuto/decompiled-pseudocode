/*
 * XREFs of SeSubProcessToken @ 0x140613E54
 * Callers:
 ...
 *     SepSetTokenBnoIsolation @ 0x1402683E4 (SepSetTokenBnoIsolation.c)
        ...
        char *a11)
{
  ...
  char v36; // [rsp+55h] [rbp-ABh] BYREF
  ...
  *(_WORD *)a11 = 0;
  ...
  if ( v31 || v29 )
  {
    ...
    if ( (*(_DWORD *)a6 & 2) != 0 )
    {
      v25 = PsReferenceEffectiveToken(
              (unsigned int)KeGetCurrentThread(),
              (unsigned int)&v37,
              (unsigned int)&v36,
              (unsigned int)&v38,
              0LL);
      v26 = (struct _DMA_ADAPTER *)v25;
      if ( v37 == 2 && v38 < 2 || (v23 = SeTokenIsNoChildProcessRestrictionEnforced(v25) ? 0xC000049D : 0, v37 != 1) )
      {
        if ( v26 )
...
LABEL_22:
  ...
  *(_QWORD *)&v47 = 0LL;
  ...
  LODWORD(v46) = 48;
  v48 = 0LL;
  inserted = SepDuplicateToken(v40, (unsigned int)&v46, 0, 1, 0, 0, 1, (__int64)&DmaAdapter);
  if ( inserted < 0 )
  {
LABEL_52:
    DmaAdapter = 0LL;
  ...
  if ( ((__int64)DmaAdapter[12].DmaOperations & 0x4000) != 0 )
  {
    ...
    if ( DmaOperations != a5 )
    {
      ...
      v27 = SepSetTokenLowboxNumber(DmaAdapter, *(_QWORD *)&DmaAdapter[49].Version);
      inserted = v27;
      if ( v27 < 0 )
        goto LABEL_59;
      v17 = DmaAdapter;
  ...
  SepSetTokenSessionById((__int64)v17, a5, 0, 0LL, 0LL);
  LODWORD(DmaAdapter[7].DmaOperations) = a5;
