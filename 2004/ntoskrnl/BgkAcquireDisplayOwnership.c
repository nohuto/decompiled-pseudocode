/*
 * XREFs of BgkAcquireDisplayOwnership @ 0x1404FA200
 * Callers:
 *     <none>
 * Callees:
...
__int64 (__fastcall *__fastcall BgkAcquireDisplayOwnership(__int64 a1))(_QWORD, _QWORD, _QWORD)
{
  ...
  v5 = 0LL;
  if ( byte_140C50999 && !byte_140C50988 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))BgLibraryEnable(0LL, 1);
  result = qword_140C50980;
  if ( qword_140C50980 )
  {
    v3 = 0LL;
    LOBYTE(a1) = 1;
    result = (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD))qword_140C50980(a1, v4, &v3);
    if ( (int)result >= 0 )
    {
