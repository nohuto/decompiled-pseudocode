/*
 * XREFs of MiAddPagesToEnclave @ 0x140543C34
 * Callers:
        ...
        unsigned int a5)
{
  ...
  v12 = *(_QWORD *)(qword_140C4E448 + 8LL * *((unsigned __int16 *)v11 + 87));
  v13 = *(_QWORD *)(a1 + 104);
  v52 = v12;
...
LABEL_21:
      ...
      if ( a2 <= 0x14 )
        v24 = a2;
      MiCreatePteCopyList(v24 + 1, v24 + 1, (__int64)&v50, a4);
      if ( !HIDWORD(v50) )
        goto LABEL_8;
      v25 = 4;
      v26 = (a5 >> 1) & 2 | 0x35;
...
LABEL_68:
          ...
          if ( v16 )
            MiReleasePtes((__int64)&qword_140C4ED40, (_QWORD *)v16, 1u);
          if ( v10 )
...
LABEL_58:
    ...
    v14 = MiReservePtes((__int64)&qword_140C4ED40, 1u, a3, a4);
    v16 = v14;
    if ( !v14 )
    {
LABEL_8:
    ...
    ValidPte = MiMakeValidPte(v14, qword_140C4EB80, 536870913LL, v15);
    v19 = 0;
