/*
 * XREFs of VmAccessFault @ 0x14092B360
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  if ( a3 > 0x10 || v11[1] > 0x10 )
  {
    ...
    {
      ++dword_140CEE858;
      v7 = (PSLIST_ENTRY)((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, union _SLIST_HEADER *))qword_140CEE870)(
                           (unsigned int)dword_140CEE864,
                           (unsigned int)dword_140CEE86C,
                           (unsigned int)dword_140CEE868,
...
LABEL_30:
  ...
  {
    ++dword_140CEE85C;
    if ( LOWORD(VmpLargeFaultBatchLookasideList.Alignment) < (unsigned __int16)word_140CEE850 )
    {
    ...
    {
      ++dword_140CEE860;
      ((void (__fastcall *)(PSLIST_ENTRY, union _SLIST_HEADER *))qword_140CEE878)(v7, &VmpLargeFaultBatchLookasideList);
    }
  }
