/*
 * XREFs of MiReserveUserMemory @ 0x1405FF360
 * Callers:
 ...
 *     MiStoreGraphicsProtectionInVad @ 0x1408C3854 (MiStoreGraphicsProtectionInVad.c)
...
LABEL_67:
                        *(_QWORD *)a1[10] = qword_140C4DC50 ^ a1[11] ^ v44;
                        goto LABEL_56;
                      }
                    }
                    else
