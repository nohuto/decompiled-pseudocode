/*
 * XREFs of SeQuerySigningPolicy @ 0x140617370
 * Callers:
        ...
        _BYTE *a7)
{
  ...
  LOBYTE(v8) = 8;
  LOBYTE(v11) = *a5;
  if ( !(unsigned int)qword_140C1D8E0(v11, v8, v9)
    || (SeCiDebugOptions & 4) == 0
    && ((SeCiDebugOptions & 2) == 0 || !(_BYTE)KdDebuggerEnabled || (_BYTE)KdDebuggerNotPresent) )
  {
    return IsMinTCB;
  }
  if ( !qword_140C1D8E0 || (LOBYTE(v13) = 8, LOBYTE(v14) = v7, !(unsigned int)qword_140C1D8E0(v14, v13, v15)) )
  {
    if ( (*a7 & 7) != 0 )
    {
      *a5 = *a5 & 0x30 | 8;
      v17 = (unsigned int (__fastcall *)(__int64, __int64))qword_140C1D8E0;
      if ( qword_140C1D8E0 )
      {
        LOBYTE(v14) = 8;
        goto LABEL_25;
