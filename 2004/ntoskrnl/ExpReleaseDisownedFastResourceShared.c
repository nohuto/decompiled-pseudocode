/*
 * XREFs of ExpReleaseDisownedFastResourceShared @ 0x14038BBBC
 * Callers:
 ...
 *     KeAbCrossThreadRelease @ 0x14038BDF0 (KeAbCrossThreadRelease.c)
 *     ExpRotateFastOwnerEntrySublistHead @ 0x14038C118 (ExpRotateFastOwnerEntrySublistHead.c)
 *     ExpPrepareToWakeResourceShared @ 0x14038C208 (ExpPrepareToWakeResourceShared.c)
