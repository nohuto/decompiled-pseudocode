/*
 * XREFs of KiForceIdleParkUnparkProcessor @ 0x14051DC48
 * Callers:
 *     KiForceIdleParkUnparkDpcRoutine @ 0x14051DC20 (KiForceIdleParkUnparkDpcRoutine.c)
...
__int64 __fastcall KiForceIdleParkUnparkProcessor(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !(_BYTE)a2 )
  {
    ...
    if ( v11 )
    {
      _InterlockedAnd64(&qword_140C125A8[v16], ~(1LL << (v17 & 0x3F)));
      v18 = 0LL;
    }
    else
    {
      _InterlockedAnd64(&qword_140C124F8[v16], ~(1LL << (v17 & 0x3F)));
      v18 = 2LL;
    }
  ...
  if ( *(_BYTE *)(a1 + 33212) )
  {
    ...
    _InterlockedOr64(&qword_140C124F8[v6 >> 6], 1LL << (v6 & 0x3F));
  }
  else
  {
    v5 = KiProcessorIndexToNumberMappingTable[*(unsigned int *)(a1 + 36)];
    _InterlockedOr64(&qword_140C125A8[v5 >> 6], 1LL << (v5 & 0x3F));
  }
