/*
 * XREFs of TtmiLogTerminalHandleOpened @ 0x14090178C
 * Callers:
...
void __fastcall TtmiLogTerminalHandleOpened(int a1)
{
  ...
  if ( (unsigned int)dword_140D2D8E8 > 5 )
  {
    if ( tlgKeywordOn((__int64)&dword_140D2D8E8, 1LL) )
    {
      ...
      v15 = 8LL;
      v17 = 4LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_140D2D8E8, (unsigned __int8 *)byte_14002AF93, 0LL, 0LL, 6u, &v9);
    }
  }
}
