/*
 * XREFs of KiEmulateAtlThunk @ 0x140521520
 * Callers:
 *     KiCheckForAtlThunk @ 0x14051F094 (KiCheckForAtlThunk.c)
 * Callees:
...
__int64 __fastcall KiEmulateAtlThunk(unsigned int *a1, _DWORD *a2, unsigned int *a3, unsigned int *a4, _DWORD *a5)
{
  ...
  v23 = (unsigned int)*a2;
  v22 = 0;
  v11 = (_WORD *)&KeGetPcr()->NtTib.$CC7ADE021331F41D731EA9DD485E62BD::$58191C77EAB639A512BFC482EB8FAE38::Self[218].SubSystemTib
      + 1;
  if ( (*v11 & 1) != 0 )
  {
    v12 = 1;
