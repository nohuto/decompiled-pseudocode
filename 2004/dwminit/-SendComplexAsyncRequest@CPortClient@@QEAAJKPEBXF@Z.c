/*
 * XREFs of ?SendComplexAsyncRequest@CPortClient@@QEAAJKPEBXF@Z @ 0x1800049F8
 * Callers:
 ...
 *     ?CheckStatus@CPortClient@@AEAAJJ@Z @ 0x180004814 (-CheckStatus@CPortClient@@AEAAJJ@Z.c)
 */

__int64 __fastcall CPortClient::SendComplexAsyncRequest(HANDLE *this, int a2, _QWORD *a3)
{
  unsigned int v3; // ebx
  int v7; // r9d
  _DWORD *v8; // rax
...
LABEL_3:
  ...
  v8 = HeapAlloc(this[6], 8u, 0x48uLL);
  v9 = v8;
  if ( !v8 )
  {
    v7 = -2147024882;
