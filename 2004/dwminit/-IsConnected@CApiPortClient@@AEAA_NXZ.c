/*
 * XREFs of ?IsConnected@CApiPortClient@@AEAA_NXZ @ 0x180004440
 * Callers:
 ...
 *     ?ResetConnection@CApiPortClient@@QEAAXXZ @ 0x18000466C (-ResetConnection@CApiPortClient@@QEAAXXZ.c)
 * Callees:
 *     ?IsConnected@CPortClient@@QEAA_NXZ @ 0x1800049E8 (-IsConnected@CPortClient@@QEAA_NXZ.c)
 */
