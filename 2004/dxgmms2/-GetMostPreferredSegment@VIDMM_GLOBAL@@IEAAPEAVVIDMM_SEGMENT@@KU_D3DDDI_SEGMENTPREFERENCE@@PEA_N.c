/*
 * XREFs of ?GetMostPreferredSegment@VIDMM_GLOBAL@@IEAAPEAVVIDMM_SEGMENT@@KU_D3DDDI_SEGMENTPREFERENCE@@PEA_N@Z @ 0x1C00B136C
 * Callers:
    ...
    else
    {
      ...
      if ( v5 )
        return *(struct VIDMM_SEGMENT **)(*((_QWORD *)this + 464)
                                        + 8LL * (v5 + *(_DWORD *)(1584LL * a2 + *((_QWORD *)this + 5027) + 20) - 1));
    }
  }
