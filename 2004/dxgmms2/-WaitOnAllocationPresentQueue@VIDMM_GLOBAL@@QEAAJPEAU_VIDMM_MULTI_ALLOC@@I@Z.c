/*
 * XREFs of ?WaitOnAllocationPresentQueue@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@I@Z @ 0x1C00B8C88
 * Callers:
 *     VidMmWaitOnAllocationPresentQueue @ 0x1C0022EB0 (VidMmWaitOnAllocationPresentQueue.c)
