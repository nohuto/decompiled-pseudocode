/*
 * XREFs of ?TransferOwnershipToSystemProcess@VIDMM_GLOBAL@@IEAAPEAU_VIDMM_LOCAL_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@PEAU2@@Z @ 0x1C005EE74
 * Callers:
        ...
        struct _VIDMM_LOCAL_ALLOC *a3)
{
  ...
  v20 = 0LL;
  v19 = 0;
  LODWORD(v8) = VIDMM_GLOBAL::OpenOneAllocation((VIDMM_GLOBAL *)this, this[5049], a2, 0LL, 0, 0LL, &v20, &v19);
  if ( (int)v8 < 0 )
  {
