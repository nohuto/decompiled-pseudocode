/*
 * XREFs of ?Init@VIDMM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C008F830
 * Callers:
 *     ?Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z @ 0x1C008F5F0 (-Init@VIDMM_SYSMEM_SEGMENT@@UEAAJP6AXPEAX@ZPEAT_LARGE_INTEGER@@@Z.c)
    ...
    || (LOBYTE(a2) = 6, result = VIDMM_SEGMENT::BlockMemoryRanges(this, a2, 12LL), (int)result >= 0) )
  {
      ...
      || (LOBYTE(a2) = 7, result = VIDMM_SEGMENT::BlockMemoryRanges(this, a2, 18LL), (int)result >= 0) )
    {
      if ( a3 )
        ...
        QuadPart = *(_QWORD *)(*(_QWORD *)(this[1].QuadPart + 24) + 1968LL);
      ...
      if ( (int)v10 >= 0 )
      {
        ...
        if ( PagesForMdl )
        {
          v15 = (unsigned int)dword_1C0051204;
          this[30].QuadPart = (unsigned int)dword_1C0051204;
          if ( (_DWORD)v15 )
          {
            v24 = v15;
            v23 = 16 * v15;
        ...
        _InterlockedIncrement(&dword_1C0051718);
