/*
 * XREFs of ?AllocateBlock@VIDMM_PROCESS_HEAP@@AEAAJ_KKW4_VIDMM_PROCESS_HEAP_MAPPING@@PEAPEAU_VIDMM_PROCESS_HEAP_BLOCK@@E@Z @ 0x1C00CD470
 * Callers:
 ...
 *     ?Init@VIDMM_LINEAR_POOL@@QEAAJ_KEP6AXPEAX@ZP6AH1@Z@Z @ 0x1C008FADC (-Init@VIDMM_LINEAR_POOL@@QEAAJ_KEP6AXPEAX@ZP6AH1@Z@Z.c)
 *     ??0VIDMM_LINEAR_POOL@@QEAA@XZ @ 0x1C008FBA4 (--0VIDMM_LINEAR_POOL@@QEAA@XZ.c)
...
LABEL_23:
      ...
      {
        Object = 0LL;
        _InterlockedIncrement(&dword_1C0051778);
...
LABEL_31:
  ...
  if ( v32 < 0 )
  {
    _InterlockedIncrement(&dword_1C00516D0);
    goto LABEL_37;
  }
