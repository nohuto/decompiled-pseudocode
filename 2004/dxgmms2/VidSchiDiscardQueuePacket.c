/*
 * XREFs of VidSchiDiscardQueuePacket @ 0x1C00D0EEC
 * Callers:
 ...
 *     VidSchFlushPendingCommand @ 0x1C00D2C00 (VidSchFlushPendingCommand.c)
 * Callees:
 ...
 *     ?VidSchiFreeHistoryBufferStorage@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C002B024 (-VidSchiFreeHistoryBufferStorage@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z.c)
