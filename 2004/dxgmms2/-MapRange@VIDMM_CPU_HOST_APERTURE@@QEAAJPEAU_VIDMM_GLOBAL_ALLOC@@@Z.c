/*
 * XREFs of ?MapRange@VIDMM_CPU_HOST_APERTURE@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C0029224
 * Callers:
 ...
 *     ?CopyRangeToArray@VIDMM_CPU_HOST_APERTURE@@AEBAXPEAI_KPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z @ 0x1C00290C8 (-CopyRangeToArray@VIDMM_CPU_HOST_APERTURE@@AEBAXPEAI_KPEBUVIDMM_CPU_HOST_APERTURE_RANGE@@@Z.c)
...
__int64 __fastcall VIDMM_CPU_HOST_APERTURE::MapRange(VIDMM_SEGMENT **this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  ...
  v6 = *((unsigned int *)this[5] + *((unsigned int *)a2 + 117));
  v7 = v6;
  v8 = 4 * v6;
  ...
  v27 = ((__int64 (__fastcall *)(_QWORD, __int64 *))DxgCoreInterface[50])(
          *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v26 + 8) + 24LL) + 2680LL),
          &v32);
  v28 = *this;
  v29 = (struct _VIDMM_GLOBAL_ALLOC *)((char *)a2 + 448);
