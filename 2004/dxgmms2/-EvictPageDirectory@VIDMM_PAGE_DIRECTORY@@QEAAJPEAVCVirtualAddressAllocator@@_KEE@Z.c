/*
 * XREFs of ?EvictPageDirectory@VIDMM_PAGE_DIRECTORY@@QEAAJPEAVCVirtualAddressAllocator@@_KEE@Z @ 0x1C005EB24
 * Callers:
 *     ?EvictRootPageTable@CVirtualAddressAllocator@@QEAAXIE@Z @ 0x1C00236C4 (-EvictRootPageTable@CVirtualAddressAllocator@@QEAAXIE@Z.c)
 ...
 *     ?FreeDriverUpdateAddress@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@I_KPEAX@Z @ 0x1C0071878 (-FreeDriverUpdateAddress@VIDMM_PAGE_TABLE_BASE@@QEAAXPEAVCVirtualAddressAllocator@@I_KPEAX@Z.c)
...
LABEL_13:
    ...
    {
      v30 = *(VIDMM_PAGE_DIRECTORY **)((char *)this[4] + v17);
      if ( !v30 )
        goto LABEL_13;
...
LABEL_18:
    ...
    *((_BYTE *)this[1] + 89) = 0;
    VIDMM_GLOBAL::EvictOneAllocation((VIDMM_GLOBAL *)v10, this[2], 0);
    *((_DWORD *)this[1] + 19) &= ~0x100000u;
    return 0LL;
  }
  v32 = 0;
