/*
 * XREFs of ??0VIDSCH_INDEPENDENT_FLIP_VIDPNSOURCE_ITERATOR@@QEAA@PEAU_VIDSCH_INDEPENDENT_FLIP_STATE@@@Z @ 0x1C00329D8
 * Callers:
 *     VidSchEnterIndependentFlip @ 0x1C0034410 (VidSchEnterIndependentFlip.c)
