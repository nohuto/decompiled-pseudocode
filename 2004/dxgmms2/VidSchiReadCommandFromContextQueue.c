/*
 * XREFs of VidSchiReadCommandFromContextQueue @ 0x1C0030824
 * Callers:
 *     VidSchiDrainContextFromWorkerThread @ 0x1C002F5B4 (VidSchiDrainContextFromWorkerThread.c)
 * Callees:
  ...
  *a3 = *(_DWORD *)(a1 + 184) & 1;
  ...
  if ( v8 )
  {
    ...
    if ( v9 == a1 + 664 )
    {
      ...
      VidSchiUpdateContextStatus(a1, 1uLL, 17613LL);
    }
    else
    {
