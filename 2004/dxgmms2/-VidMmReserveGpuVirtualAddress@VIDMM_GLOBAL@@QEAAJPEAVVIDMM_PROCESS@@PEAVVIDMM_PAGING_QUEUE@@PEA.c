/*
 * XREFs of ?VidMmReserveGpuVirtualAddress@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_PROCESS@@PEAVVIDMM_PAGING_QUEUE@@PEAUD3DDDI_RESERVEGPUVIRTUALADDRESS@@@Z @ 0x1C00B7A80
 * Callers:
 *     VidMmReserveGpuVirtualAddress @ 0x1C0022C60 (VidMmReserveGpuVirtualAddress.c)
 * Callees:
