/*
 * XREFs of ?VidMmiOpenCurrentPartition@@YAJPEAVVIDMM_PROCESS@@PEAPEAUVIDMM_PARTITION@@@Z @ 0x1C00020BC
 * Callers:
 ...
 *     ?CompareVidMmPartitionById@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z @ 0x1C0013D98 (-CompareVidMmPartitionById@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z.c)
...
__int64 __fastcall VidMmiOpenCurrentPartition(struct VIDMM_PROCESS *a1, struct _RTL_BALANCED_NODE **a2)
{
  ...
  v6 = 0;
  if ( *(_BYTE *)(DxgCoreInterface[3]() + 304200) )
  {
