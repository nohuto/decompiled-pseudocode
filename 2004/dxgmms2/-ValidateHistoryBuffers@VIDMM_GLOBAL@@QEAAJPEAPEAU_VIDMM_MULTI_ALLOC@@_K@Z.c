/*
 * XREFs of ?ValidateHistoryBuffers@VIDMM_GLOBAL@@QEAAJPEAPEAU_VIDMM_MULTI_ALLOC@@_K@Z @ 0x1C00B7080
 * Callers:
 *     VidMmValidateHistoryBuffers @ 0x1C0022E90 (VidMmValidateHistoryBuffers.c)
 * Callees:
