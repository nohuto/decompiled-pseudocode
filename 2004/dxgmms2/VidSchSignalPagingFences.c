/*
 * XREFs of VidSchSignalPagingFences @ 0x1C0075064
 * Callers:
        ...
        char a6)
{
  ...
  if ( !*(_BYTE *)(a1 + 55) )
  {
    ...
    return VidSchSignalSyncObjectsFromGpu(v9, (__int64)v10, v6, v8, 1u, (__int64)a2, 0, a3);
  }
  v10 = *(_QWORD **)(a1 + 272);
  if ( *v10 )
  {
  ...
  return VidSchSignalSyncObjectsFromCpu(1LL, a2, 0LL, (char *)a3);
}
