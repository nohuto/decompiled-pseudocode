/*
 * XREFs of ?wil_details_EvaluateFeatureDependencies@@YAXXZ @ 0x1C005E234
 * Callers:
...
void wil_details_EvaluateFeatureDependencies(void)
{
  ...
  for ( j = (unsigned __int64 *)&wil_details_featureDescriptors_a; ; j = (unsigned __int64 *)((char *)v7 + 24) )
  {
