/*
 * XREFs of ?MapVirtualAddressRange@CVirtualAddressAllocator@@QEAAPEAUVIDMM_MAPPED_VA_RANGE@@PEAX_KW4VIDMM_VAD_OWNER_TYPE@@_K333IU_D3DDDIGPUVIRTUALADDRESS_PROTECTION_TYPE@@1IPEAPEAUVIDMM_VAD_PENDING_OPERATION@@@Z @ 0x1C006FA98
 * Callers:
 ...
 *     ?CompareVadAddressInsideAvl@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z @ 0x1C0088118 (-CompareVadAddressInsideAvl@@YAJPEAXPEAU_RTL_BALANCED_NODE@@@Z.c)
 */
...
struct VIDMM_MAPPED_VA_RANGE *__fastcall CVirtualAddressAllocator::MapVirtualAddressRange(
        ...
        void **a13)
{
  struct VIDMM_MAPPED_VA_RANGE *v13; // rdi
  struct _RTL_AVL_TREE *v15; // rdx
  __int64 v16; // r12
  struct VIDMM_MAPPED_VA_RANGE *v17; // r13
  int v18; // eax
  unsigned __int64 v19; // rdx
  __int64 v20; // rcx
  struct VIDMM_VAD *v21; // rsi
  PVOID v22; // rax
  struct VIDMM_MAPPED_VA_RANGE *v23; // rax
  __int64 v24; // rdx
  __int64 v25; // rcx
  __int64 v26; // r8
  char *v27; // rsi
...
LABEL_5:
    ...
    if ( v18 >= 0 )
    {
      ...
      CVirtualAddressAllocator::InsertVadToReservedListForNewVaRange(
        (CVirtualAddressAllocator *)a1,
        v41,
        (struct _D3DDDIGPUVIRTUALADDRESS_PROTECTION_TYPE)a10);
    }
    goto LABEL_7;
  }
  v20 = *((_QWORD *)v21 + 4);
...
LABEL_7:
  if ( v21 )
  {
    ...
    {
      if ( (*((_BYTE *)v21 + 72) & 0xF) == 3 && ((a10 & 8) != 0 || (a10 & 4) != 0) )
      {
      ...
      else
      {
        if ( v46 )
          v16 = *((_QWORD *)v21 + 3);
        v23 = CVirtualAddressAllocator::MapVadVaRange(
                (CVirtualAddressAllocator *)a1,
                v21,
                a12,
                a4,
