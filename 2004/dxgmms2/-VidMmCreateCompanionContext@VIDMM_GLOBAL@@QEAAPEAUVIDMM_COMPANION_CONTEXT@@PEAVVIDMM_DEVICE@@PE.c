/*
 * XREFs of ?VidMmCreateCompanionContext@VIDMM_GLOBAL@@QEAAPEAUVIDMM_COMPANION_CONTEXT@@PEAVVIDMM_DEVICE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C00B7428
 * Callers:
 *     VidMmCreateCompanionContext @ 0x1C0022920 (VidMmCreateCompanionContext.c)
 * Callees:
