/*
 * XREFs of VidSchiProcessDpcPreemptedPacket @ 0x1C000ED88
 * Callers:
...
LONG __fastcall VidSchiProcessDpcPreemptedPacket(__int64 a1)
{
  ...
  *(_DWORD *)(v3 + 1552) = ((_BYTE)v10 + 1) & 0xF;
  ...
  if ( v12 )
    VidSchiStartExecutionTimeAtThisPriority((struct _VIDSCH_NODE *)v3, *(_DWORD *)(v12 + 404), v9.QuadPart);
  if ( *(int *)(v3 + 2864) > 0 )
    RtlSetBitEx(v4 + 480);
  ...
  if ( v17 )
    KeSetEvent(v17, 0, 0);
  VidSchiSignalRegisteredEvent(v4, (struct _KEVENT **)(v2 + 376));
  VidSchiSignalRegisteredEvent(v4, (struct _KEVENT **)(v3 + 408));
  VidSchiSignalRegisteredEvent(v4, (struct _KEVENT **)(v4 + 1624));
