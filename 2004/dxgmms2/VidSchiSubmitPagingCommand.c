/*
 * XREFs of VidSchiSubmitPagingCommand @ 0x1C0084E80
 * Callers:
 ...
 *     VidSchGetDriverPagingContext @ 0x1C0075B64 (VidSchGetDriverPagingContext.c)
...
void __fastcall VidSchiSubmitPagingCommand(struct _VIDSCH_QUEUE_PACKET *a1)
{
  ...
  else
  {
    ...
    *(_QWORD *)(v8 + 64) = v14;
    ...
    if ( !*(_BYTE *)(*(_QWORD *)(*((_QWORD *)v16 + 2) + 2560LL) + 360LL * *(unsigned __int16 *)(v4 + 6) + 48) )
    {
      v22 = *((_DWORD *)a1 + 87);
    ...
    *(_QWORD *)(v8 + 120) = v15;
    if ( *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v5 + 8) + 16LL) + 2560LL)
