/*
 * XREFs of LookUpTableFlushComplete @ 0x1C00966C8
 * Callers:
 ...
 *     ?TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z @ 0x1C00D5D20 (-TlgAggregateInternalFlushWorkItemRoutineKernelMode@@YAXPEAX@Z.c)
 *     ?TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z @ 0x1C00D5DB0 (-TlgAggregateInternalProviderCallback@@YAXPEBU_GUID@@KE_K1PEAU_EVENT_FILTER_DESCRIPTOR@@PEAX@Z.c)
 ...
 *     FlushLookUpTableBucket @ 0x1C003E13C (FlushLookUpTableBucket.c)
 *     UpdateInternalStatsOnFlush @ 0x1C00D5E18 (UpdateInternalStatsOnFlush.c)
 */
...
void __fastcall LookUpTableFlushComplete(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 256) )
  {
    ...
    if ( *(_QWORD *)(v3 + 288) )
    {
      if ( (unsigned int)dword_1C0051080 > 5 && tlgKeywordOn((__int64)&dword_1C0051080, 0x400000000000LL) )
      {
