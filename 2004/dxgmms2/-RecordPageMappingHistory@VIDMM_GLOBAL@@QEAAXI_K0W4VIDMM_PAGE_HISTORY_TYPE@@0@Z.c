/*
 * XREFs of ?RecordPageMappingHistory@VIDMM_GLOBAL@@QEAAXI_K0W4VIDMM_PAGE_HISTORY_TYPE@@0@Z @ 0x1C00B4074
 * Callers:
...
void __fastcall VIDMM_GLOBAL::RecordPageMappingHistory(__int64 a1, int a2, __int64 a3, __int64 a4, int a5, __int64 a6)
{
  ...
  if ( *(_QWORD *)(a1 + 41024) )
  {
    ...
    *(_QWORD *)(v10 + 8) = KeGetCurrentThread();
    v11 = *(unsigned int *)(a1 + 41032);
    if ( (_DWORD)v11 == dword_1C00513B0 )
    {
      *(_DWORD *)(a1 + 41032) = 0;
      v11 = 0LL;
    }
    v12 = *(_QWORD *)(a1 + 41024) + 48 * v11;
