/*
 * XREFs of ?RemoveAllocationFromDecommitList@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00B4288
 * Callers:
...
void __fastcall VIDMM_GLOBAL::RemoveAllocationFromDecommitList(VIDMM_GLOBAL *this, struct _VIDMM_GLOBAL_ALLOC *a2)
{
  VIDMM_GLOBAL::RemoveAllocationFromDecommitList(
    *(VIDMM_GLOBAL **)(*((_QWORD *)a2 + 12) + 8LL),
    a2,
    *(struct VIDMM_PROCESS_ADAPTER_INFO **)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 12) + 8LL) + 16LL)
