/*
 * XREFs of ?TrimOfferCommitmentInternal@VIDMM_GLOBAL@@QEAAXPEAVVIDMM_PROCESS@@PEAUDXGDECOMMITITERATOR@@T_D3DKMT_TRIMPROCESSCOMMITMENT_FLAGS@@_KPEA_K@Z @ 0x1C00B53A4
 * Callers:
 ...
 *     ?IsAllocationDecommitCandidate@VIDMM_GLOBAL@@QEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@_N@Z @ 0x1C00B1D44 (-IsAllocationDecommitCandidate@VIDMM_GLOBAL@@QEAA_NPEAU_VIDMM_GLOBAL_ALLOC@@_N@Z.c)
 */
        ...
        unsigned __int64 *a6)
{
  ...
  *(_QWORD *)(v12 + 24) = v24;
  ...
  if ( (v6 & 1) != 0 )
  {
    v7 = (unsigned int)(dword_1C00514C0 << 20);
    if ( a5 < v7 )
      v7 = a5;
  }
