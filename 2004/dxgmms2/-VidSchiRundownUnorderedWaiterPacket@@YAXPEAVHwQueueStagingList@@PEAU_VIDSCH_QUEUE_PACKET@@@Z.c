/*
 * XREFs of ?VidSchiRundownUnorderedWaiterPacket@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C002BDA4
 * Callers:
 ...
 *     VidSchiRundownUnorderedWaiterContext @ 0x1C0031658 (VidSchiRundownUnorderedWaiterContext.c)
 *     VidSchiRundownUnorderedWaiterDevice @ 0x1C00316A4 (VidSchiRundownUnorderedWaiterDevice.c)
 *     ?VidSchiRundownUnorderedWaiterHwQueue@@YAXPEAVHwQueueStagingList@@PEAUVIDSCH_HW_QUEUE@@@Z @ 0x1C003323C (-VidSchiRundownUnorderedWaiterHwQueue@@YAXPEAVHwQueueStagingList@@PEAUVIDSCH_HW_QUEUE@@@Z.c)
 * Callees:
