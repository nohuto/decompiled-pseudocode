/*
 * XREFs of VidSchiInsertCommandToSoftwareQueue @ 0x1C0008090
 * Callers:
 ...
 *     VidSchiUpdatePriorityTables @ 0x1C00326FC (VidSchiUpdatePriorityTables.c)
 * Callees:
              ...
              if ( (result & 0x80u) == 0LL )
              {
                ...
                if ( (result & 0x100) == 0 )
                {
                  ...
                  if ( (result & 0x20) == 0 )
                  {
                    ...
                    result = VidSchiUpdateContextStatus(v2, 5uLL, 15021LL);
                    *a2 = result;
                  }
                }
              }
