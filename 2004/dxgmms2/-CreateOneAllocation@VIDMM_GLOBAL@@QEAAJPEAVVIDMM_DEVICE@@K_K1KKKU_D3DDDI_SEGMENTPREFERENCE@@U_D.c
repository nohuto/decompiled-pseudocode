/*
 * XREFs of ?CreateOneAllocation@VIDMM_GLOBAL@@QEAAJPEAVVIDMM_DEVICE@@K_K1KKKU_D3DDDI_SEGMENTPREFERENCE@@U_DXGK_ALLOCATIONINFOFLAGS@@PEAVDXGADAPTERALLOCATION@@PEAX5KE5EPEAPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAPEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C006BD90
 * Callers:
 ...
 *     ??_GDXGFASTMUTEX@@QEAAPEAXI@Z @ 0x1C0022FC8 (--_GDXGFASTMUTEX@@QEAAPEAXI@Z.c)
 *     ??_G_VIDMM_GLOBAL_ALLOC@@QEAAPEAXI@Z @ 0x1C0023154 (--_G_VIDMM_GLOBAL_ALLOC@@QEAAPEAXI@Z.c)
 *     ?AllocateCrossAdapterDataDpc@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00232F4 (-AllocateCrossAdapterDataDpc@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAU_VIDMM_GLOBAL.c)
 ...
 *     ?ReleaseReference@VIDMM_FLIP_QUEUE_REFERENCES@@QEAAXI@Z @ 0x1C0023AC8 (-ReleaseReference@VIDMM_FLIP_QUEUE_REFERENCES@@QEAAXI@Z.c)
 ...
 *     ?VerifySegmentSet@VIDMM_GLOBAL@@QEAAEKKKPEAK@Z @ 0x1C0086CE8 (-VerifySegmentSet@VIDMM_GLOBAL@@QEAAEKKKPEAK@Z.c)
...
LABEL_364:
  ...
  *(_QWORD *)&v103[124].0 = v113;
  if ( !v113 )
  {
    _InterlockedIncrement(&dword_1C0051780);
  ...
  if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)this + 2) + 624LL) + 57LL) )
  {
    if ( (v49 & 0x40000000) != 0 || (v49 & 0x80000000) != 0 )
    {
      *(_QWORD *)(*(_QWORD *)&v103[124].0 + 24LL) = operator new[](0xA8uLL, 0x33306956u, (POOL_TYPE)512);
      ...
      _InterlockedIncrement(&dword_1C005166C);
