/*
 * XREFs of ?VidSchiSubmitDisablePlanesFlip@@YAJPEAU_VIDSCH_DEVICE@@I@Z @ 0x1C002C1F0
 * Callers:
...
__int64 __fastcall VidSchiSubmitDisablePlanesFlip(struct _VIDSCH_DEVICE *a1, unsigned int a2)
{
  ...
  v7 = *(_QWORD *)(v2 + 16);
  v24[0] = 0LL;
  v24[1] = *(struct _SLIST_ENTRY **)(v7 + 2680);
  CVidSchSubmitData::InitializeSubmitData((CVidSchSubmitData *)v24);
  if ( v24[0] )
  {
    v10 = (unsigned int *)(&v24[0][35].Next + 1);
    if ( !*((_BYTE *)&v24[0][21].Next + 12) )
      v10 = (unsigned int *)&v24[0][30];
    *v10 ^= (*v10 ^ (((1 << *(_DWORD *)(v2 + 144)) - 1) << 10)) & 0xFFC00;
    ...
    ++*((_DWORD *)a1 + 394);
    ++*(_DWORD *)(v6 + 2340);
    v14 = ((unsigned __int16)*v10 | (unsigned __int16)(*v10 >> 10)) & 0x3FF;
    ...
    *(_DWORD *)(v19 + 1140) = 4;
    v29 = 0;
    VidSchiExecuteMmIoFlip((struct HwQueueStagingList *)v25, v2, v21, v23, v18, (__int64)&v29);
