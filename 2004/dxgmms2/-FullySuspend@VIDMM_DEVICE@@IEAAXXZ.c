/*
 * XREFs of ?FullySuspend@VIDMM_DEVICE@@IEAAXXZ @ 0x1C00B91F0
 * Callers:
 *     ?Run@VIDMM_WORKER_THREAD@@QEAAXXZ @ 0x1C008B6F0 (-Run@VIDMM_WORKER_THREAD@@QEAAXXZ.c)
 *     ?SuspendAllDevices@VIDMM_PROCESS_ADAPTER_INFO@@QEAA_N_N@Z @ 0x1C00BAFD8 (-SuspendAllDevices@VIDMM_PROCESS_ADAPTER_INFO@@QEAA_N_N@Z.c)
 ...
 *     VidSchDeviceQueuesNotEmpty @ 0x1C0012338 (VidSchDeviceQueuesNotEmpty.c)
...
void __fastcall VIDMM_DEVICE::FullySuspend(VIDMM_GLOBAL **this)
{
  ...
  this[29] = (VIDMM_GLOBAL *)qword_1C0051458;
  v4 = *(_QWORD *)*this;
  ...
  *(_QWORD *)(v4 + 152) = KeGetCurrentThread();
  ...
  v5 = (__int64)this[4];
  v14 = 2;
  if ( VidSchDeviceQueuesNotEmpty(v5) || *((_DWORD *)this + 16) )
    v2 = 3;
  ...
  *(_QWORD *)(v6 + 8) = 0LL;
  ...
  v10 = qword_1C0051448 + TimeIncrement * v7;
  this[27] = (VIDMM_GLOBAL *)v10;
  ...
  if ( *(_BYTE *)(*((_QWORD *)this[3] + 5) + 346LL) )
