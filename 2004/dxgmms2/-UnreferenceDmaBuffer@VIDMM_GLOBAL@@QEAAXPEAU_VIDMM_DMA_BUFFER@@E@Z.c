/*
 * XREFs of ?UnreferenceDmaBuffer@VIDMM_GLOBAL@@QEAAXPEAU_VIDMM_DMA_BUFFER@@E@Z @ 0x1C0023BF8
 * Callers:
 *     VidMmUnreferenceDmaBuffer @ 0x1C0022DF0 (VidMmUnreferenceDmaBuffer.c)
 ...
 *     VidSchUnreferenceDmaBuffer @ 0x1C00D4490 (VidSchUnreferenceDmaBuffer.c)
 * Callees:
