/*
 * XREFs of VidSchDestroySyncObject @ 0x1C0081DD0
 * Callers:
 ...
 *     ?DestroyPagingFenceObjects@VIDMM_GLOBAL@@QEAAXXZ @ 0x1C00B0120 (-DestroyPagingFenceObjects@VIDMM_GLOBAL@@QEAAXXZ.c)
 * Callees:
