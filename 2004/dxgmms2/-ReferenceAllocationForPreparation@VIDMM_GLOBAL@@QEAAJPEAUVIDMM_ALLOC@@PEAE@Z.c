/*
 * XREFs of ?ReferenceAllocationForPreparation@VIDMM_GLOBAL@@QEAAJPEAUVIDMM_ALLOC@@PEAE@Z @ 0x1C00704F8
 * Callers:
...
LABEL_22:
    ...
    *((_QWORD *)this + 914) += *(_QWORD *)(v6 + 16);
    ++*((_DWORD *)this + 1826);
    VIDMM_SEGMENT::ReclaimResource(*(VIDMM_LINEAR_POOL ***)(v6 + 128), (struct _VIDMM_GLOBAL_ALLOC *)v6, (__int64)a3);
    *a3 = 1;
  }
  if ( (*(_DWORD *)(v6 + 76) & 0x1000000) != 0 )
    goto LABEL_22;
