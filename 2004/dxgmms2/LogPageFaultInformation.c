/*
 * XREFs of LogPageFaultInformation @ 0x1C002CFC0
 * Callers:
...
void __fastcall LogPageFaultInformation(int a1)
{
  ...
  if ( (unsigned int)dword_1C0051048 > 5 )
  {
    v2 = tlgKeywordOn((__int64)&dword_1C0051048, 0x400000000010LL);
    v6 = 0LL;
    if ( v2 )
    {
      if ( v4 )
