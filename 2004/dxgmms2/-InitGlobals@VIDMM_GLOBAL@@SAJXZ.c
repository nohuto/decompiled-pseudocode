/*
 * XREFs of ?InitGlobals@VIDMM_GLOBAL@@SAJXZ @ 0x1C008FFDC
 * Callers:
 *     VidMmInitGlobals @ 0x1C00156F0 (VidMmInitGlobals.c)
 * Callees:
 ...
 *     McGenEventRegister_EtwRegister @ 0x1C0015708 (McGenEventRegister_EtwRegister.c)
...
LABEL_27:
  ...
  if ( v15 < 0 )
    goto LABEL_27;
  qword_1C00517F0 = (__int64)&VIDMM_RECYCLE_HEAP_MGR::_GlobalHeapManagerListHead;
  ...
  qword_1C0051838 = (__int64)&VIDMM_GLOBAL::_AdapterListHead;
