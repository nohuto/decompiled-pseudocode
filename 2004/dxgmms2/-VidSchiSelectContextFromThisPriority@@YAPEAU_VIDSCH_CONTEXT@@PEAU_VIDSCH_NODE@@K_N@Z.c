/*
 * XREFs of ?VidSchiSelectContextFromThisPriority@@YAPEAU_VIDSCH_CONTEXT@@PEAU_VIDSCH_NODE@@K_N@Z @ 0x1C000BE90
 * Callers:
 *     VidSchiSelectContext @ 0x1C000A960 (VidSchiSelectContext.c)
 * Callees:
 *     VidSchiIsQuantumLeft @ 0x1C0012DD8 (VidSchiIsQuantumLeft.c)
