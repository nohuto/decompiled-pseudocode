/*
 * XREFs of VidSchiSetPriorityContext @ 0x1C0010AB8
 * Callers:
 *     VidSchSubmitPagingCommand @ 0x1C00684BC (VidSchSubmitPagingCommand.c)
 *     VidSchSubmitCommand @ 0x1C007E4E0 (VidSchSubmitCommand.c)
 *     VidSchSetPriorityContext @ 0x1C007FAB0 (VidSchSetPriorityContext.c)
 *     VidSchSubmitGlobalCommand @ 0x1C008AB94 (VidSchSubmitGlobalCommand.c)
 *     VidSchSetAbsolutePriorityContext @ 0x1C00D3AF0 (VidSchSetAbsolutePriorityContext.c)
 * Callees:
 ...
 *     ?VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z @ 0x1C002CEDC (-VidSchiUpdateReadyBitsInNewPriority@@YAXPEAU_VIDSCH_NODE@@PEAU_VIDSCH_CONTEXT@@@Z.c)
 */
