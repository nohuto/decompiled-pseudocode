/*
 * XREFs of ?RemoveDmaBufferFromPool@VIDMM_DMA_POOL@@IEAAXPEAU_VIDMM_DMA_BUFFER@@@Z @ 0x1C0089920
 * Callers:
 ...
 *     ?TrimPool@VIDMM_DMA_POOL@@QEAAXE@Z @ 0x1C00BC698 (-TrimPool@VIDMM_DMA_POOL@@QEAAXE@Z.c)
 * Callees:
