/*
 * XREFs of ?ReadUnusedAllocationConfiguration@VIDMM_GLOBAL@@KAXXZ @ 0x1C009319C
 * Callers:
...
void VIDMM_GLOBAL::ReadUnusedAllocationConfiguration(void)
{
  ...
  xmmword_1C00512B0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C00512D0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C00512C0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  xmmword_1C00512F0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v6 = 1000000;
  v11 = 1000000;
  xmmword_1C00512E0 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v1 = 1;
  v3 = 15;
  v8 = 1;
  v12 = 15;
  v13 = 15;
  qword_1C00512A8 = 1LL;
  xmmword_1C0051380 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  v2 = 0;
  v4 = 45;
  v5 = 120;
  v7 = 0;
  ...
  v14 = 30;
  v15 = 30;
  xmmword_1C0051370 = (__int128)_mm_load_si128((const __m128i *)&_xmm);
  ...
  v16[3] = &qword_1C00512A8;
  v16[5] = &v1;
  v16[9] = L"Unused.MinimumThreshold";
  v16[10] = &xmmword_1C00512B0;
  v16[12] = &v2;
  v16[16] = L"Unused.LowThreshold";
  v16[17] = (char *)&xmmword_1C00512B0 + 8;
  v16[19] = &v3;
  v16[23] = L"Unused.NormalThreshold";
  v16[24] = &xmmword_1C00512C0;
  v16[26] = &v4;
  LODWORD(v16[8]) = 288;
  ...
  qword_1C00512A8 *= 10000000LL;
  *(_QWORD *)&xmmword_1C00512B0 = 10000000 * xmmword_1C00512B0;
  *((_QWORD *)&xmmword_1C00512B0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C00512C0 = 10000000 * xmmword_1C00512C0;
  *((_QWORD *)&xmmword_1C00512C0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C00512D0 = 10000000 * xmmword_1C00512D0;
  *((_QWORD *)&xmmword_1C00512D0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C00512E0 = 10000000 * xmmword_1C00512E0;
  *((_QWORD *)&xmmword_1C00512E0 + 1) *= 10000000LL;
  *(_QWORD *)&xmmword_1C00512F0 = 10000000 * xmmword_1C00512F0;
  *((_QWORD *)&xmmword_1C00512F0 + 1) *= 10000000LL;
  do
  {
    *(_QWORD *)v0 *= 10000000LL;
    v0 = (__int128 *)((char *)v0 + 8);
  }
  while ( (__int64)v0 < (__int64)&qword_1C0051390 );
}
