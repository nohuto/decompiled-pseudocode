/*
 * XREFs of ?Init@VIDMM_DMA_POOL@@QEAAJXZ @ 0x1C008AD38
 * Callers:
 ...
 *     ?UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ @ 0x1C008B4F8 (-UpdateFairResourceUsage@VIDMM_DMA_POOL@@IEAAXXZ.c)
 */
  ...
  if ( VIDMM_GLOBAL::VerifySegmentSet(*(VIDMM_GLOBAL **)this, *((_DWORD *)this + 2), *((_DWORD *)this + 9), 1, &v13) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)++v5 >= 2 )
      {
        ...
        v7 = (VIDMM_DMA_POOL **)qword_1C0051820;
        v8 = (VIDMM_DMA_POOL *)((char *)this + 112);
        if ( *(struct _LIST_ENTRY **)qword_1C0051820 != &VIDMM_DMA_POOL::_DmaPoolsListHead )
          __fastfail(3u);
        *(_QWORD *)v8 = &VIDMM_DMA_POOL::_DmaPoolsListHead;
        *((_QWORD *)this + 15) = v7;
        *v7 = v8;
        qword_1C0051820 = (__int64)this + 112;
