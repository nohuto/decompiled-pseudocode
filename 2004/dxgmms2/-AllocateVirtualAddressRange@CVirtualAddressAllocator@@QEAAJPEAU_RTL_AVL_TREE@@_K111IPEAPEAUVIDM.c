/*
 * XREFs of ?AllocateVirtualAddressRange@CVirtualAddressAllocator@@QEAAJPEAU_RTL_AVL_TREE@@_K111IPEAPEAUVIDMM_VAD@@E@Z @ 0x1C0070C20
 * Callers:
 ...
 *     ?FindNodeInFreeList@CVirtualAddressAllocator@@IEAAPEAUVIDMM_VAD@@PEAX@Z @ 0x1C0070F20 (-FindNodeInFreeList@CVirtualAddressAllocator@@IEAAPEAUVIDMM_VAD@@PEAX@Z.c)
 ...
 *     ?AllocateVad@CVirtualAddressAllocator@@SAPEAUVIDMM_VAD@@_K0I@Z @ 0x1C00745E8 (-AllocateVad@CVirtualAddressAllocator@@SAPEAUVIDMM_VAD@@_K0I@Z.c)
...
LABEL_49:
  ...
  v18 = 0;
  v50 = a3;
  if ( v9 && dword_1C0051490 && v15 != *((_QWORD *)v11 + 2) )
  {
    v41 = a3 + 4096;
...
LABEL_33:
      ...
      _InterlockedAdd(&dword_1C005178C, 1u);
