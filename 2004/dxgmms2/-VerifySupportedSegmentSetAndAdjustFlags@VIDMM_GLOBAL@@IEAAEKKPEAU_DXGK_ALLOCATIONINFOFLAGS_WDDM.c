/*
 * XREFs of ?VerifySupportedSegmentSetAndAdjustFlags@VIDMM_GLOBAL@@IEAAEKKPEAU_DXGK_ALLOCATIONINFOFLAGS_WDDM2_0@@_K1_NPEAU_VIDMM_VERIFY_SUPPORTED_SEGMENT@@@Z @ 0x1C006E450
 * Callers:
...
LABEL_19:
  ...
  if ( (a4->Value & 0x20000) != 0 )
  {
    ...
    {
      v25 = *((_QWORD *)this + 3);
      v9 = *(unsigned int *)(*(_QWORD *)(v25 + 2560) + 360LL * v37 + 16);
      if ( (v9 & 0x10) == 0 )
      {
        v26 = WdLogNewEntry5_WdAssertion(v9, v25, v24);
        *(_QWORD *)(v26 + 24) = 12229LL;
        goto LABEL_80;
      }
...
LABEL_56:
  ...
  {
    v26 = WdLogNewEntry5_WdAssertion(v9, Value, v32);
    *(_QWORD *)(v26 + 24) = 12331LL;
    goto LABEL_80;
  }
  if ( (Value & 0x100000) != 0 && !v19 )
  {
    v26 = WdLogNewEntry5_WdAssertion(v9, Value, v32);
    *(_QWORD *)(v26 + 24) = 12338LL;
    goto LABEL_80;
  }
  if ( (Value & 0x4000) != 0 && !v19 )
  {
    v26 = WdLogNewEntry5_WdAssertion(v9, Value, v32);
    *(_QWORD *)(v26 + 24) = 12345LL;
    goto LABEL_80;
  }
  if ( a7 && (Value & 1) != 0 && !v19 )
  {
    v26 = WdLogNewEntry5_WdAssertion(v9, Value, v32);
    *(_QWORD *)(v26 + 24) = 12357LL;
    goto LABEL_80;
  }
  result = 1;
