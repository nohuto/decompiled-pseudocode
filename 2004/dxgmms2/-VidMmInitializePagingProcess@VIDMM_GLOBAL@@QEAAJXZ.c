/*
 * XREFs of ?VidMmInitializePagingProcess@VIDMM_GLOBAL@@QEAAJXZ @ 0x1C009582C
 * Callers:
 *     VidMmInitializePagingProcess @ 0x1C0015AD0 (VidMmInitializePagingProcess.c)
 * Callees:
