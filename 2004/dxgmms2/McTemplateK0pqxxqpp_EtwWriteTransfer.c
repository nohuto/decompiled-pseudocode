/*
 * XREFs of McTemplateK0pqxxqpp_EtwWriteTransfer @ 0x1C003382C
 * Callers:
...
NTSTATUS McTemplateK0pqxxqpp_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v16 = 8LL;
  v18 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, a2, a3, 8u, &v4);
}
