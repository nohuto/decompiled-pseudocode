/*
 * XREFs of VidSchiProcessIsrVSync @ 0x1C000DCF0
 * Callers:
 ...
 *     ?VidSchiProcessIsrVSyncMultiPlaneOverlay2@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@PEAU_DXGKARGCB_NOTIFY_INTERRUPT_DATA@@PEAU_VIDSCH_VSYNC_COOKIE@@@Z @ 0x1C002BC08 (-VidSchiProcessIsrVSyncMultiPlaneOverlay2@@YAXPEAU_VIDSCH_GLOBAL@@PEAU_VIDSCH_PRESENT_INFO@@PEAU.c)
 */
        ...
        __int64 a4)
{
  ...
  v9 = 0;
  v10 = 0;
  v11 = *(_QWORD *)(a1[1].Alignment + 2672);
  v12 = *(_DWORD *)(v11 + 80);
  if ( v12 )
  {
    a3 = *(_QWORD *)(v11 + 112);
...
LABEL_20:
      ...
      *((_DWORD *)&v19[5].Next + 2) = v10;
      ...
      v30 = 0;
      v31 = *(_BYTE *)(Alignment + 2586);
      v32 = *(_BYTE *)(Alignment + 2587);
