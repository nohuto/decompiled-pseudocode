/*
 * XREFs of ?SetWorkingSetInformation@VIDMM_PROCESS@@QEAAJPEAU_D3DKMT_WORKINGSETINFO@@@Z @ 0x1C00BBBEC
 * Callers:
 *     VidMmSetWorkingSetInformation @ 0x1C0022D10 (VidMmSetWorkingSetInformation.c)
 * Callees:
