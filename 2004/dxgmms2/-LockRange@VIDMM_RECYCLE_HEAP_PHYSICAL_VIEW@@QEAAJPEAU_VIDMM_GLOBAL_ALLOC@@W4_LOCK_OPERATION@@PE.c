/*
 * XREFs of ?LockRange@VIDMM_RECYCLE_HEAP_PHYSICAL_VIEW@@QEAAJPEAU_VIDMM_GLOBAL_ALLOC@@W4_LOCK_OPERATION@@PEAVVIDMM_SEGMENT@@_K3@Z @ 0x1C0078944
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  void *v34; // rcx
  enum _LOCK_OPERATION v36; // [rsp+90h] [rbp+18h] BYREF
  struct VIDMM_SEGMENT *v37; // [rsp+98h] [rbp+20h]
  ...
  if ( (unsigned int)(v22 - 3) <= 3 && (unsigned int)(v22 - 5) > 1 )
  {
    ...
    if ( v28 < 0 )
    {
      ...
      v32[5] = *(_QWORD *)this;
      v32[6] = v29;
      v32[7] = **(_QWORD **)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 32LL) + 8LL) + 8LL);
  ...
  v23 = VIDMM_MDL_RANGE::Lock((VIDMM_MDL_RANGE *)v19, v7, v18, v37, a2);
  ...
  if ( (unsigned int)(v24 - 3) <= 3 )
  {
    ...
    if ( (unsigned int)v25 > 1 )
    {
      if ( v12 )
        ...
        CurrentProcess = (VIDMM_RECYCLE_HEAP_MGR *)PsGetCurrentProcess(v25);
      if ( v9 <= VIDMM_RECYCLE_HEAP_MGR::GetSmallAllocationSize(CurrentProcess, 0) )
      {
        if ( v34 )
          MmUnmapViewOfSection(v34, v21);
        else
          MmUnmapViewInSystemSpace(v21);
      }
      else
      {
        VidMmUnmapViewAsync(v34, *(PVOID *)(*(_QWORD *)this + 56LL), v21);
      }
    }
  }
  if ( v23 < 0 )
