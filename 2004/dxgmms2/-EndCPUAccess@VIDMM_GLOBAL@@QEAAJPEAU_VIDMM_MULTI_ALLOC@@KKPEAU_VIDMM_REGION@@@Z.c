/*
 * XREFs of ?EndCPUAccess@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_MULTI_ALLOC@@KKPEAU_VIDMM_REGION@@@Z @ 0x1C00852B0
 * Callers:
 *     VidMmEndCPUAccess @ 0x1C0012B60 (VidMmEndCPUAccess.c)
 * Callees:
