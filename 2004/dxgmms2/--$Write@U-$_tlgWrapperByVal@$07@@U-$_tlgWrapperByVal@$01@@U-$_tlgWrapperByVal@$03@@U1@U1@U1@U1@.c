 ...
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C0026C28 (_tlgWriteTransfer_EtwWriteTransfer.c)
 */
        ...
        __int64 a12)
{
  ...
  v17 = 2LL;
  v15 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0051048, a2, 0, 0, 0xAu, &v13);
}
