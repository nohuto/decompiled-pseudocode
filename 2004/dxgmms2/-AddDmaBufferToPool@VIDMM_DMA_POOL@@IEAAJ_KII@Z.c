/*
 * XREFs of ?AddDmaBufferToPool@VIDMM_DMA_POOL@@IEAAJ_KII@Z @ 0x1C008AE2C
 * Callers:
 ...
 *     ?Init@VIDMM_DMA_POOL@@QEAAJXZ @ 0x1C008AD38 (-Init@VIDMM_DMA_POOL@@QEAAJXZ.c)
 *     ?ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z @ 0x1C00BC504 (-ResizeBuffersInPool@VIDMM_DMA_POOL@@QEAAJ_KII@Z.c)
 * Callees:
...
LABEL_67:
  ...
  if ( (*((_BYTE *)this + 32) & 1) != 0 || (_DWORD)v4 )
  {
    ...
    if ( !v8 )
    {
      _InterlockedAdd(&dword_1C0051690, 1u);
    ...
    if ( !v11 )
    {
      ...
      *((_QWORD *)v10 + 9) = v66;
      if ( !v66 )
      {
        _InterlockedAdd(&dword_1C00516A4, 1u);
...
LABEL_20:
      if ( (_DWORD)v4 )
      {
        ...
        *((_QWORD *)v10 + 13) = v31;
        if ( !v31 )
        {
          _InterlockedAdd(&dword_1C00516B0, 1u);
...
LABEL_85:
      ...
      *((_QWORD *)v10 + 16) = v37;
      ...
      _InterlockedAdd(&dword_1C005170C, 1u);
...
LABEL_83:
    ...
    if ( OneAllocation < 0 )
    {
      _InterlockedAdd(&dword_1C0051698, 1u);
...
LABEL_84:
      ...
      _InterlockedAdd(&dword_1C005169C, 1u);
