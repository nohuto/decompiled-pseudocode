/*
 * XREFs of ?VidMmGetAllocationGpuVirtualAddress@VIDMM_GLOBAL@@QEAA_KPEAU_VIDMM_MULTI_ALLOC@@EI@Z @ 0x1C00863DC
 * Callers:
 *     VidMmGetAllocationGpuVirtualAddress @ 0x1C0012CD0 (VidMmGetAllocationGpuVirtualAddress.c)
 * Callees:
