/*
 * XREFs of ?IsAllocationTerminated@VIDMM_GLOBAL@@QEAAEPEAU_VIDMM_MULTI_ALLOC@@@Z @ 0x1C00B1F90
 * Callers:
 *     VidMmIsAllocationTerminated @ 0x1C0022A60 (VidMmIsAllocationTerminated.c)
 * Callees:
