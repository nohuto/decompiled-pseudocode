/*
 * XREFs of ?VidMmiMoveAndFlipDisplayingAllocation@@YAXPEAVVIDMM_GLOBAL@@PEAU_VIDMM_GLOBAL_ALLOC@@_K2@Z @ 0x1C00C72F8
 * Callers:
 ...
 * Callees:
 *     VidSchiUpdateFlipQueueEntriesForMove @ 0x1C0032490 (VidSchiUpdateFlipQueueEntriesForMove.c)
