/*
 * XREFs of ?VidMmUpdateContextAllocationCb@VIDMM_GLOBAL@@QEAAJPEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@E@Z @ 0x1C00B7EB4
 * Callers:
 *     ?VidMmUpdateContextAllocationCb@@YAJPEAVVIDMM_GLOBAL@@PEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@@Z @ 0x1C0022770 (-VidMmUpdateContextAllocationCb@@YAJPEAVVIDMM_GLOBAL@@PEBU_DXGKARGCB_UPDATECONTEXTALLOCATION@@@Z.c)
 ...
 *     ?UpdateContextAllocation@VIDMM_GLOBAL@@QEAAX_K0PEAXI@Z @ 0x1C00B60C4 (-UpdateContextAllocation@VIDMM_GLOBAL@@QEAAX_K0PEAXI@Z.c)
        ...
        __int64 a3)
{
  ...
  __int64 v11; // rax
  struct VIDMM_MAPPED_VA_RANGE *v12; // rax
  __int64 v13; // rdx
  __int64 v14; // rcx
  __int64 v15; // r8
  __int64 v16; // rdi
  ...
  int v23; // eax
  _QWORD v24[12]; // [rsp+70h] [rbp-88h] BYREF
  struct VIDMM_ALLOC *v25; // [rsp+118h] [rbp+20h] BYREF
  ...
  if ( (_BYTE)a3 )
  {
    ...
    v10 = (struct VIDMM_VAD **)*((_QWORD *)this + (*(_DWORD *)(v8 + 76) & 0x3F) + 5052);
    if ( (*(_DWORD *)(v5 + 28) & 3) == 2 )
    {
      ...
      if ( v12 )
      {
        ...
        CVirtualAddressAllocator::FreeVirtualAddressRange((CVirtualAddressAllocator *)v10, v18);
        return 0LL;
      }
      else
      {
        v17 = WdLogNewEntry5_WdAssertion(v14, v13, v15);
        *(_QWORD *)(v17 + 24) = 23532LL;
