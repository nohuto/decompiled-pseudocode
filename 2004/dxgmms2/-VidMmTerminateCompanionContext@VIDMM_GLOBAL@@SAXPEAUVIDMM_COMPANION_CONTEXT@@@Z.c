/*
 * XREFs of ?VidMmTerminateCompanionContext@VIDMM_GLOBAL@@SAXPEAUVIDMM_COMPANION_CONTEXT@@@Z @ 0x1C00B7D1C
 * Callers:
 *     VidMmTerminateCompanionContext @ 0x1C0022D70 (VidMmTerminateCompanionContext.c)
 * Callees:
