/*
 * XREFs of ?CreateReservedVaRange@CVirtualAddressAllocator@@AEAAPEAUVIDMM_MAPPED_VA_RANGE@@PEAUVIDMM_VAD@@I_K1U_D3DDDIGPUVIRTUALADDRESS_PROTECTION_TYPE@@1@Z @ 0x1C00BDD84
 * Callers:
        ...
        unsigned __int64 a7)
{
  ...
  if ( !v12 )
  {
    _InterlockedIncrement(&dword_1C0051794);
