/*
 * XREFs of McTemplateK0pppppppqq_EtwWriteTransfer @ 0x1C0027EE8
 * Callers:
 ...
 *     ?ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ @ 0x1C00C2F58 (-ReportStates@VIDMM_RECYCLE_BLOCK@@QEAAXXZ.c)
 * Callees:
...
NTSTATUS McTemplateK0pppppppqq_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 4LL;
  v22 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventRecycleRangeCreate, a3, 0xAu, &v4);
}
