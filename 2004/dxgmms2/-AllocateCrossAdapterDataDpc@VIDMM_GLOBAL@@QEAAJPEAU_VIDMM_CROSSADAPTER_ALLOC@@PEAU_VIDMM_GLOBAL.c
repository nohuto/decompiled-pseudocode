/*
 * XREFs of ?AllocateCrossAdapterDataDpc@VIDMM_GLOBAL@@QEAAJPEAU_VIDMM_CROSSADAPTER_ALLOC@@PEAU_VIDMM_GLOBAL_ALLOC@@@Z @ 0x1C00232F4
 * Callers:
 ...
 *     VidSchGetRunEvent @ 0x1C0088800 (VidSchGetRunEvent.c)
 */
