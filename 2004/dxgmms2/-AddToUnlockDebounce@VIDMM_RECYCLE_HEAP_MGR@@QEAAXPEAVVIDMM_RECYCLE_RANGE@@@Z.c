/*
 * XREFs of ?AddToUnlockDebounce@VIDMM_RECYCLE_HEAP_MGR@@QEAAXPEAVVIDMM_RECYCLE_RANGE@@@Z @ 0x1C007A96C
 * Callers:
 ...
 *     ?Unlock@VIDMM_RECYCLE_RANGE@@QEAAXXZ @ 0x1C007A918 (-Unlock@VIDMM_RECYCLE_RANGE@@QEAAXXZ.c)
 ...
 *     ?Decommit@VIDMM_RECYCLE_RANGE@@QEAAXXZ @ 0x1C00C2470 (-Decommit@VIDMM_RECYCLE_RANGE@@QEAAXXZ.c)
