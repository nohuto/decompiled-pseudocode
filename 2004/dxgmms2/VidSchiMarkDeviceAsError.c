/*
 * XREFs of VidSchiMarkDeviceAsError @ 0x1C0014160
 * Callers:
 ...
 * Callees:
 *     VidSchiSignalRegisteredSyncObjects @ 0x1C001422C (VidSchiSignalRegisteredSyncObjects.c)
 *     _guard_dispatch_icall_nop @ 0x1C0016AE0 (_guard_dispatch_icall_nop.c)
 *     _tlgKeywordOn @ 0x1C0026C04 (_tlgKeywordOn.c)
 *     ?VidSchiRundownHardwareContext@@YAXPEAVHwQueueStagingList@@PEAUVIDSCH_HW_CONTEXT@@@Z @ 0x1C00383B4 (-VidSchiRundownHardwareContext@@YAXPEAVHwQueueStagingList@@PEAUVIDSCH_HW_CONTEXT@@@Z.c)
 ...
 *     VidSchiNotifyDeviceRemoved @ 0x1C003D048 (VidSchiNotifyDeviceRemoved.c)
 */
...
void __fastcall VidSchiMarkDeviceAsError(struct HwQueueStagingList *a1, __int64 a2, int a3, _OWORD *a4)
{
  ...
  if ( !v9 && a3 != 14 )
  {
    ...
    if ( DxgKrnlTelemetryGlobal_LogTelemetryEvent()
      ...
      && (unsigned __int8)tlgKeywordOn(&dword_1C0051048, 0x400000000010LL) )
    {
      v13 = *(_QWORD *)(a2 + 40);
      v14 = *(_QWORD *)(a2 + 32);
      v15 = *(_QWORD *)(v13 + 2632);
      ...
      v24 = *(_QWORD *)(v13 + 2640);
      v18 = v15;
      v17 = *(_QWORD *)(*(_QWORD *)(v14 + 16) + 1496LL);
      v22 = 1;
      v21 = 1LL;
      v20 = v16;
      v19 = v17;
