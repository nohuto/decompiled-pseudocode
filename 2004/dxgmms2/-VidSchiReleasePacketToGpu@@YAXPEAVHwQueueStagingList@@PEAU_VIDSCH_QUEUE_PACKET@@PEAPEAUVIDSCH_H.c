/*
 * XREFs of ?VidSchiReleasePacketToGpu@@YAXPEAVHwQueueStagingList@@PEAU_VIDSCH_QUEUE_PACKET@@PEAPEAUVIDSCH_HW_QUEUE@@@Z @ 0x1C00381E0
 * Callers:
 ...
 *     ?VidSchiCompleteHwQueueWaitPacket@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z @ 0x1C0036F58 (-VidSchiCompleteHwQueueWaitPacket@@YAXPEAU_VIDSCH_QUEUE_PACKET@@@Z.c)
        ...
        struct VIDSCH_HW_QUEUE **a3)
{
  ...
  if ( *(struct _VIDSCH_QUEUE_PACKET **)(v3 + 208) == (struct _VIDSCH_QUEUE_PACKET *)((char *)a2 + 32) )
  {
