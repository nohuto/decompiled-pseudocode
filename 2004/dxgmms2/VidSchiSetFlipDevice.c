/*
 * XREFs of VidSchiSetFlipDevice @ 0x1C0002924
 * Callers:
 ...
 *     ?GetFlipQueueRef@VIDSCH_FLIP_QUEUE_ITERATOR@@QEAAPEAPEAUVIDSCH_FLIP_QUEUE@@XZ @ 0x1C0029FA0 (-GetFlipQueueRef@VIDSCH_FLIP_QUEUE_ITERATOR@@QEAAPEAPEAUVIDSCH_FLIP_QUEUE@@XZ.c)
 *     ?InitializeFlipQueueEntry@VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z @ 0x1C002A02C (-InitializeFlipQueueEntry@VIDSCH_FLIP_QUEUE_ENTRY@@QEAAJPEAU_VIDSCH_GLOBAL@@@Z.c)
 ...
 *     VidSchIsVSyncAvailable @ 0x1C00D2F70 (VidSchIsVSyncAvailable.c)
 */
  ...
  if ( (_DWORD)v8 )
  {
    ...
    else
    {
      ...
      while ( 1 )
      {
        ...
        v35 = operator new[](0x15058uLL, 0x39616956u, (POOL_TYPE)512);
