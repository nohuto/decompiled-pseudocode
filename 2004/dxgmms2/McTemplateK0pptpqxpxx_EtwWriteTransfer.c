/*
 * XREFs of McTemplateK0pptpqxpxx_EtwWriteTransfer @ 0x1C0027010
 * Callers:
...
NTSTATUS McTemplateK0pptpqxpxx_EtwWriteTransfer(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(&DxgkControlGuid_Context, &EventPagingOpFlushTlb, a3, 0xAu, &v4);
}
