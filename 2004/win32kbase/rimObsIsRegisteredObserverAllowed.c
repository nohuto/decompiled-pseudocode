/*
 * XREFs of rimObsIsRegisteredObserverAllowed @ 0x1C017E238
 * Callers:
 *     rimObsRouteInputAndCheckForExclusiveObservers @ 0x1C017FCEC (rimObsRouteInputAndCheckForExclusiveObservers.c)
 * Callees:
 *     ?rimIsProcessLocalSystem@@YAHPEAU_EPROCESS@@@Z @ 0x1C017DFC8 (-rimIsProcessLocalSystem@@YAHPEAU_EPROCESS@@@Z.c)
