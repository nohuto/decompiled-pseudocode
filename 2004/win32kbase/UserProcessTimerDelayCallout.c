/*
 * XREFs of UserProcessTimerDelayCallout @ 0x1C0123504
 * Callers:
...
__int64 __fastcall UserProcessTimerDelayCallout(__int64 a1)
{
  ...
  {
    v52 = qword_1C0251F78;
    v51 = *(unsigned int *)(v1 + 12);
    v49 = *(unsigned int *)(v1 + 8);
    if ( qword_1C0251F78 )
      v53 = ((__int64 (__fastcall *)(__int64, __int64, __int64))qword_1C0251F78)(ProcessWin32Process, v49, v51);
    else
      v53 = -1073741637;
  }
  else
