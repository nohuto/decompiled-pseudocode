/*
 * XREFs of ?FindEntry@InputObjectMap@@CAPEAUInputObjectMapEntry@@AEBU_LUID@@@Z @ 0x1C01F71C0
 * Callers:
...
struct InputObjectMapEntry *__fastcall InputObjectMap::FindEntry(const struct _LUID *a1)
{
  ...
  v3 = -1LL << (dword_1C0250464 & 0x1F);
  v4 = v3 & v2;
  if ( (unsigned int)dword_1C0250464 >> 5 )
  {
    v7 = v3 & v2;
    v5 = (char *)Buffer
       + 8
       * ((37
         * (BYTE6(v7)
         ...
         + HIBYTE(v7)) & (((unsigned int)dword_1C0250464 >> 5) - 1));
    while ( 1 )
    {
      v5 = *(char **)v5;
