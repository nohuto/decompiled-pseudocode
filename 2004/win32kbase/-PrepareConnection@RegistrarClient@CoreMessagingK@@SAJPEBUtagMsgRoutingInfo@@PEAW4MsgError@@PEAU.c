/*
 * XREFs of ?PrepareConnection@RegistrarClient@CoreMessagingK@@SAJPEBUtagMsgRoutingInfo@@PEAW4MsgError@@PEAU_GUID@@@Z @ 0x1C0048C14
 * Callers:
        ...
        struct _GUID *a3)
{
  ...
  *((_QWORD *)&v19 + 1) = 0LL;
  ...
  v23 = 0LL;
  v8 = CoreUICallSend((int)&v15, (int)&v23, 1, 1, 3, (__int64)&unk_1C020A0C3, v21);
  if ( v8 < 0 )
  {
