/*
 * XREFs of NtGdiGetDeviceCapsAll @ 0x1C0145E20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?NtGdiGetDeviceCapsAllInternal@@YAHAEAVPDEVOBJ@@PEAU_DEVCAPS@@@Z @ 0x1C00CFEFC (-NtGdiGetDeviceCapsAllInternal@@YAHAEAVPDEVOBJ@@PEAU_DEVCAPS@@@Z.c)
 */
