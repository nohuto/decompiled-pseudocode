/*
 * XREFs of ?ApplyAccelerationToDelta@CMouseProcessor@@AEAAXJJUtagPOINT@@_NPEAU_SUBPIXELS@@PEAJ3@Z @ 0x1C00103B8
 * Callers:
        ...
        int *a8)
{
  ...
  v9 = a3;
  v10 = a2;
  if ( a5 && (*((_BYTE *)qword_1C0241098 + 112) || (*(_BYTE *)(&qword_1C024AFC0 + 1) & 0x40) == 0) )
  {
    v12 = qword_1C02410B0;
