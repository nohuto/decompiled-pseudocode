/*
 * XREFs of ?AnimationScenarioBegin@CTelemetryInfo@DirectComposition@@QEAAJ_KPEBX@Z @ 0x1C00442B8
 * Callers:
 *     NtDCompositionTelemetryAnimationScenarioBegin @ 0x1C004A4F0 (NtDCompositionTelemetryAnimationScenarioBegin.c)
 * Callees:
 *     ?VerifyInfo@DCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@SA_NPEBX_K@Z @ 0x1C00443D4 (-VerifyInfo@DCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@SA_NPEBX_K@Z.c)
