/*
 * XREFs of ?RouteSyntheticTouchpadToMT@CInertiaManager@@QEBAXIUtagPOINT@@0_K@Z @ 0x1C01A6268
 * Callers:
...
void __fastcall CInertiaManager::RouteSyntheticTouchpadToMT(
        ...
        unsigned __int64 a5)
{
  _QWORD v8[20]; // [rsp+20h] [rbp-E0h] BYREF
  ...
  *(_QWORD *)&v9 = 0x18000000400LL;
  ...
  v13[8] = a4;
  LODWORD(v13[12]) = a2;
  CTouchProcessor::ForwardInputToManipulationThread(gpTouchProcessor, (const struct CPointerInputFrame *)v8);
