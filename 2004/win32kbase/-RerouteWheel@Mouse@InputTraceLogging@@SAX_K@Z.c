/*
 * XREFs of ?RerouteWheel@Mouse@InputTraceLogging@@SAX_K@Z @ 0x1C01BE58C
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::RerouteWheel()
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 64LL) )
  {
    ...
    v1 = v0;
    v4 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0246A70, (unsigned __int8 *)dword_1C021B7E4, 0LL, 0LL, 3u, &v2);
  }
}
