/*
 * XREFs of ?ForwardInputToISM@CMouseProcessor@@AEAA?AW4ISMForwardingDecision@1@AEAVCInputDest@@AEBVCMouseEvent@1@AEBUInputDeliveryContext@1@AEBUtagPOINT@@II_K@Z @ 0x1C006B6FC
 * Callers:
        ...
        __int64 a8)
{
  ...
  v45 = *(_OWORD *)RIMGetVirtualDesktopPhysicalSize((__int64)v50);
...
LABEL_27:
  ...
  if ( ThreadInfo )
    HIDWORD(v51[23]) = IsMiPActive((__int64)ThreadInfo, 0LL);
