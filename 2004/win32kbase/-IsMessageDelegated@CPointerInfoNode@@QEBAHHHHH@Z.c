/*
 * XREFs of ?IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z @ 0x1C0195034
 * Callers:
 *     ?IsAnyMessageDelegated@CPointerInfoNode@@QEBAHXZ @ 0x1C0194D28 (-IsAnyMessageDelegated@CPointerInfoNode@@QEBAHXZ.c)
