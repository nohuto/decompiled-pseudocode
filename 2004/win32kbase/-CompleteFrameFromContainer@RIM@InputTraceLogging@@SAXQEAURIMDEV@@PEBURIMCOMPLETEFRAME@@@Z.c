/*
 * XREFs of ?CompleteFrameFromContainer@RIM@InputTraceLogging@@SAXQEAURIMDEV@@PEBURIMCOMPLETEFRAME@@@Z @ 0x1C0171860
 * Callers:
        ...
        const struct RIMCOMPLETEFRAME *a2)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 256LL) )
  {
    ...
    v29 = 4;
    v26 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0246A70, (unsigned __int8 *)dword_1C0216BF0, 0LL, 0LL, 8u, &v15);
  }
}
