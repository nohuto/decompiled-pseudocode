/*
 * XREFs of DrvEnumDisplaySettings @ 0x1C00A3CE0
 * Callers:
    ...
    if ( DeviceFromName )
    {
      switch ( v6 )
      {
        case 0xFFFFFFFD:
          ...
          break;
        case 0xFFFFFFFE:
          v25 = (UNICODE_STRING *)PALLOCMEM2(0x100DBuLL, 0x76656447u, 1);
          v26 = (__int64)v25;
          String1 = v25;
          if ( v25 )
          {
            ...
            {
              *(_DWORD *)(&v25[4].MaximumLength + 1) = -8739;
        ...
        case 0xFFFFFFFF:
          ...
          for ( i = gppdevList; i; i = *(struct PDEV **)i )
          {
            ...
            if ( v17 == DeviceFromName && *((_DWORD *)i + 3) )
            {
              ...
              {
                v29 = DrvGetDevModeForLddmPath((struct tagGRAPHICS_DEVICE *)DeviceFromName, -1, 0LL, (bool *)&v55);
                v30 = v29;
                if ( v29 < 0 )
                {
...
LABEL_69:
            ...
            {
              v39 = PALLOCMEM2(0x100DBuLL, 0x76656447u, 1);
              v40 = (__int64)v39;
              if ( v39 )
              {
          ...
          if ( *(_DWORD *)(DeviceFromName + 184) && *(_QWORD *)(DeviceFromName + 176) )
          {
            ...
            if ( v6 < v42 )
            {
              ...
              {
                _mm_lfence();
                v41 = *(_QWORD *)(*(_QWORD *)(DeviceFromName + 192) + 16LL * v6 + 8);
LABEL_94:
                v11 = v51;
              }
              else
