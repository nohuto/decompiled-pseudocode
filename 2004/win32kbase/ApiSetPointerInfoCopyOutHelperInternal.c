/*
 * XREFs of ApiSetPointerInfoCopyOutHelperInternal @ 0x1C01CC284
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( qword_1C0253698 )
    ...
    v11 = -1073741637;
  if ( v11 >= 0 && qword_1C02536A0 )
    v10 = ((__int64 (__fastcall *)(__int64, __int64, __int64, _QWORD, int, __int64))qword_1C02536A0)(
            a1,
            v8,
            a3,
            a4,
