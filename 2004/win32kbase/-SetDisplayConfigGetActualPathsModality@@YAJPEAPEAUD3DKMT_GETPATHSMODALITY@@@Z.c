/*
 * XREFs of ?SetDisplayConfigGetActualPathsModality@@YAJPEAPEAUD3DKMT_GETPATHSMODALITY@@@Z @ 0x1C00B19FC
 * Callers:
...
__int64 __fastcall SetDisplayConfigGetActualPathsModality(struct D3DKMT_GETPATHSMODALITY **a1)
{
  ...
  v35 = 0LL;
  v36 = 0LL;
  if ( (unsigned int)((__int64 (__fastcall *)(__int128 *, _QWORD))qword_1C024CAF8)(&v35, 0LL) == -1073741789 )
  {
