/*
 * XREFs of ?GetRemoteScaleOverrideTestHook@@YAXPEBG_KPEAU_DPI_INFORMATION@@@Z @ 0x1C00CA8A0
 * Callers:
 ...
 *     ?RtlStringCchCatW@@YAJPEAG_KPEBG@Z @ 0x1C00CAB14 (-RtlStringCchCatW@@YAJPEAG_KPEBG@Z.c)
