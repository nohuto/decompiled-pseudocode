/*
 * XREFs of ?vUpdateWtoDXform@DC@@QEAAXXZ @ 0x1C007C750
 * Callers:
...
LABEL_43:
    ...
    *(float *)(v33 + 400) = v42;
    v43 = *((_QWORD *)this + 122);
    *((float *)this + 109) = v42;
    v44 = (float)(16 * *(_DWORD *)(v43 + 328)) + *((float *)this + 110);
    *(float *)(v43 + 404) = v44;
    *((float *)this + 110) = v44;
LABEL_47:
    bFToL(*((float *)this + 109), (int *)this + 86, 6u);
    bFToL(*((float *)this + 110), (int *)this + 87, v45);
    goto LABEL_9;
  }
  if ( (v4 & 2) != 0 && !(unsigned int)DC::bDpiScaleTransform(this) )
  {
    ...
    *(_DWORD *)(v60 + 340) = *(_DWORD *)(v60 + 440);
    bFToL(*(float *)(v60 + 436), (int *)(v60 + 344), 6u);
    bFToL(*((float *)this + 110), (int *)this + 87, v61);
    if ( (*(_DWORD *)(*((_QWORD *)this + 122) + 340LL) & 0x800) == 0 )
    {
      *((_DWORD *)this + 88) = (*(_DWORD *)(*((_QWORD *)this + 122) + 340LL) & 0x1000 | 0x4800u) >> 11;
      goto LABEL_13;
...
LABEL_16:
  ...
  else
  {
    ...
    *((float *)this + 80) = v62 * *((float *)this + 98);
    *((float *)this + 82) = v62 * *((float *)this + 100);
    *((float *)this + 81) = v63 * *((float *)this + 99);
  ...
  *((float *)this + 85) = v20;
  ...
  if ( (v27 & 1) != 0 && (v27 & 2) == 0 )
  {
    ...
    *((float *)this + 85) = *((float *)this + 132) * *((float *)this + 85);
    v64 = (float)*((int *)this + 2 * (*((_DWORD *)this + 10) & 1) + 255);
    *((float *)this + 84) = (float)((float)((float)((float)*((int *)this + 2 * (*((_DWORD *)this + 10) & 1) + 254)
                                                  * *((float *)this + 131))
                                          - (float)*((int *)this + 2 * (*((_DWORD *)this + 10) & 1) + 254))
                                  * v13)
                          + *((float *)this + 84);
    v65 = *((float *)this + 84);
    *((float *)this + 85) = (float)((float)((float)(v64 * *((float *)this + 132)) - v64) * v13) + *((float *)this + 85);
    bFToL(v65, (int *)this + 86, 6u);
    bFToL(*((float *)this + 85), v25, v66);
  }
