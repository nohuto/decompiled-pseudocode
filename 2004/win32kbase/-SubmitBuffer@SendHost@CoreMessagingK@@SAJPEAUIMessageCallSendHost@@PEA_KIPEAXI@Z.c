/*
 * XREFs of ?SubmitBuffer@SendHost@CoreMessagingK@@SAJPEAUIMessageCallSendHost@@PEA_KIPEAXI@Z @ 0x1C004D910
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?HRESULTFromNTStatus@HResultUtil@CoreMessagingK@@YAJJ@Z @ 0x1C004DB20 (-HRESULTFromNTStatus@HResultUtil@CoreMessagingK@@YAJJ@Z.c)
 *     CoreUICallReceive @ 0x1C0054118 (CoreUICallReceive.c)
 *     ?Free@BufferCache@CoreMessagingK@@SAXPEAX@Z @ 0x1C006AB5C (-Free@BufferCache@CoreMessagingK@@SAXPEAX@Z.c)
