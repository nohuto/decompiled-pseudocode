/*
 * XREFs of wil_details_FeatureReporting_ReportUsageToServiceDirect @ 0x1C0071050
 * Callers:
 ...
 *     ?wil_details_FeatureReporting_IncrementOpportunityInCache@@YAXPEAUwil_details_FeatureReportingCache@@W4wil_details_ServiceReportingKind@@IPEAUwil_details_RecordUsageResult@@@Z @ 0x1C011B1C8 (-wil_details_FeatureReporting_IncrementOpportunityInCache@@YAXPEAUwil_details_FeatureReportingCa.c)
 *     wil_details_FeatureReporting_IncrementUsageInCache @ 0x1C011B2B0 (wil_details_FeatureReporting_IncrementUsageInCache.c)
 */
