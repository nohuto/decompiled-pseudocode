/*
 * XREFs of ?TransformPointWithUniformSpaceMapping@@YAHPEAU_MDEV@@PEAH1H@Z @ 0x1C0012C90
 * Callers:
 *     DrvUniformSpaceToPixelSpacePoint @ 0x1C0012C60 (DrvUniformSpaceToPixelSpacePoint.c)
 *     DrvPixelSpaceToUniformSpacePoint @ 0x1C0015AA0 (DrvPixelSpaceToUniformSpacePoint.c)
 * Callees:
