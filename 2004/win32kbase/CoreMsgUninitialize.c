/*
 * XREFs of CoreMsgUninitialize @ 0x1C005BC60
 * Callers:
 *     ?Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x1C01224A0 (-Win32KDriverUnload@@YAXPEAU_DRIVER_OBJECT@@@Z.c)
 * Callees:
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C0038CF8 (_tlgWriteTransfer_EtwWriteTransfer.c)
 *     ?Uninitialize@ServerPorts@CoreMessagingK@@SAXXZ @ 0x1C005BD5C (-Uninitialize@ServerPorts@CoreMessagingK@@SAXXZ.c)
  ...
  if ( CoreMessagingK::EntryLock::s_Initialized )
  {
    if ( (unsigned int)dword_1C0245450 > 5 )
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C0245450,
        (unsigned __int8 *)dword_1C021DE2B,
        0LL,
        0LL,
        2u,
        &v4);
    ...
    if ( (unsigned int)dword_1C0245450 > 5 )
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C0245450,
        (unsigned __int8 *)dword_1C021DEB4,
        0LL,
        0LL,
        2u,
        &v4);
