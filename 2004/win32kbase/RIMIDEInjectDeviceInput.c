/*
 * XREFs of RIMIDEInjectDeviceInput @ 0x1C016AD1C
 * Callers:
 ...
 *     ?RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z @ 0x1C0168FA4 (-RIMIDEInjectionIndexToLinkIndex@@YAHPEAURIMDEV@@KPEAGH@Z.c)
