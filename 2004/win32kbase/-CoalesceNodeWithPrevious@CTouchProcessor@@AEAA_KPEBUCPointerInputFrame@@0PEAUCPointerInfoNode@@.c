/*
 * XREFs of ?CoalesceNodeWithPrevious@CTouchProcessor@@AEAA_KPEBUCPointerInputFrame@@0PEAUCPointerInfoNode@@KH@Z @ 0x1C0189D48
 * Callers:
 ...
 * Callees:
 *     EtwTracePointerCoalesce @ 0x1C01285A0 (EtwTracePointerCoalesce.c)
