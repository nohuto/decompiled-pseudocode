/*
 * XREFs of ?SetBufferProperty@CBaseExpressionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C0039890
 * Callers:
        ...
        bool *a6)
{
  ...
  if ( a5 == 12 )
  {
    if ( *a4 != 1 )
      return (unsigned int)-1073741811;
    v10 = Win32AllocPoolWithQuota(12LL, 1835352900LL);
    if ( v10 )
    {
      *((_QWORD *)this + 11) = v10;
  ...
  if ( a5 == 16 )
  {
    if ( *a4 != 2 )
      return (unsigned int)-1073741811;
    v11 = (_OWORD *)Win32AllocPoolWithQuota(16LL, 1835352900LL);
    if ( v11 )
    {
      *((_QWORD *)this + 11) = v11;
      *v11 = *(_OWORD *)a4;
