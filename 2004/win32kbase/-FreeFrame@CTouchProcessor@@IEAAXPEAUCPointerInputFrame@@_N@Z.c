/*
 * XREFs of ?FreeFrame@CTouchProcessor@@IEAAXPEAUCPointerInputFrame@@_N@Z @ 0x1C018E1FC
 * Callers:
...
void __fastcall CTouchProcessor::FreeFrame(struct _KTHREAD **this, struct CPointerInputFrame *a2, char a3)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 5 && tlgKeywordOn((__int64)&dword_1C0246A70, 32LL) )
  {
    v25 = *((_DWORD *)a2 + 10);
    v24 = *((_QWORD *)a2 + 9);
    v26 = *((_QWORD *)a2 + 14);
