/*
 * XREFs of RIMGetPointerDeviceProperties @ 0x1C0160B00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RIMGetPointerDeviceProperties(__int64 a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)rimHidP_GetSpecificValueCaps(0, 0, v6, 0, 0LL, (__int64)v32, v36) != -1072627705 )
    return 0LL;
  v16 = Win32AllocPoolZInit(72LL * (v32[0] + (unsigned int)v7), 1668707157LL);
  if ( v16 )
  {
...
LABEL_20:
        ...
        else
        {
          ...
          v5 = Win32AllocPoolZInit(72 * v21, 1668707157LL);
          if ( v5 )
          {
            if ( *(_DWORD *)(a1 + 24) == 7 )
              v6 = 0;
