/*
 * XREFs of ?UnregisterPort@RegistrarClient@CoreMessagingK@@SAJPEBU_GUID@@@Z @ 0x1C00484B8
 * Callers:
 *     ?UninitializeServerPort@ServerPorts@CoreMessagingK@@SAXPEAUServerPortInfo@2@@Z @ 0x1C0048180 (-UninitializeServerPort@ServerPorts@CoreMessagingK@@SAXPEAUServerPortInfo@2@@Z.c)
 * Callees:
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C0038CF8 (_tlgWriteTransfer_EtwWriteTransfer.c)
 *     CoreUICallSend @ 0x1C0042A38 (CoreUICallSend.c)
 ...
 *     ?NtStatusFromHRESULT@HResultUtil@CoreMessagingK@@YAJJ@Z @ 0x1C01FAF20 (-NtStatusFromHRESULT@HResultUtil@CoreMessagingK@@YAJJ@Z.c)
 */
...
__int64 __fastcall CoreMessagingK::RegistrarClient::UnregisterPort(const struct _GUID *a1)
{
  ...
  v9 = v1;
  v3 = CoreUICallSend((int)&v8, (int)&v7, 1, 1, 14, (__int64)&unk_1C020A075, &v9);
  if ( v3 < 0 )
  {
  ...
  if ( (unsigned int)dword_1C0245450 > 5 )
  {
    ...
    v11 = a1;
    v12 = 16;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0245450, (unsigned __int8 *)dword_1C021E00B, 0LL, 0LL, 4u, &v10);
  }
  return v5;
}
