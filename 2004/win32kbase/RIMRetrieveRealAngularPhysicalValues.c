/*
 * XREFs of RIMRetrieveRealAngularPhysicalValues @ 0x1C0181F30
 * Callers:
 *     RIMRetrieveNormalizationRange @ 0x1C0181DF4 (RIMRetrieveNormalizationRange.c)
 * Callees:
 *     RIMComputePower @ 0x1C0181CC0 (RIMComputePower.c)
      ...
      if ( v19 == 4 )
      {
        ...
        if ( v8 < -4 )
        {
          ...
          do
          {
            ...
            --v9;
            ++v3;
            v20 = dword_1C0221D28[v21] + 10 * v20;
          }
          while ( v9 > v8 );
          v23 = v20;
        }
