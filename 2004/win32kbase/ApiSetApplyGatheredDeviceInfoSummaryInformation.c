/*
 * XREFs of ApiSetApplyGatheredDeviceInfoSummaryInformation @ 0x1C00C2010
 * Callers:
        ...
        int a7)
{
  ...
  if ( qword_1C02532D8 )
    result = qword_1C02532D8();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C02532E0;
    if ( qword_1C02532E0 )
      result = qword_1C02532E0(a1, v9, a3, a4, a5, a6, a7);
  }
