/*
 * XREFs of efSin @ 0x1C003CCD0
 * Callers:
 *     efCos @ 0x1C003CCA0 (efCos.c)
 ...
 * Callees:
 *     bFToL @ 0x1C003BD60 (bFToL.c)
 *     eFraction @ 0x1C0053058 (eFraction.c)
 */
...
__int64 __fastcall efSin(int a1)
{
  ...
  {
    v8 = 4LL * (v14 & 0x1F);
    v9 = (__m128)*(unsigned int *)((char *)&unk_1C024A4B0 - v8);
    v9.m128_f32[0] = (float)(v9.m128_f32[0] - gaefSin[32 - (int)v7 - 1]) * *(float *)&v4;
    v10 = _mm_xor_ps(v9, v5);
    v10.m128_f32[0] = v10.m128_f32[0] + *(float *)((char *)&unk_1C024A4B0 - v8);
    v11 = v10;
  }
  else
  {
