/*
 * XREFs of ?SetBufferProperty@CLegacyRenderTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C00548E0
 * Callers:
 *     <none>
 * Callees:
 *     ?IsValidRect@@YA_NAEBUtagRECT@@@Z @ 0x1C005499C (-IsValidRect@@YA_NAEBUtagRECT@@@Z.c)
 */
