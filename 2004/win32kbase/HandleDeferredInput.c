/*
 * XREFs of HandleDeferredInput @ 0x1C0001270
 * Callers:
 ...
 *     UpdateKeyStateForMessage @ 0x1C003D0E0 (UpdateKeyStateForMessage.c)
...
__int64 __fastcall HandleDeferredInput(__int64 a1, int a2, int a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( v15 != a1
      ...
      && ((*(_DWORD *)(v15 + 1224) & 0x1000000) == 0 || ((unsigned int)v16 & 0x40000) != 0) )
    {
      v14 = (__int64 *)*v14;
      goto LABEL_46;
    }
    ...
    if ( (*(_DWORD *)(a1 + 1224) & 0x1000000) == 0 || (v17 = 1, v4 == *((_DWORD *)v14 + 39)) )
      v17 = 0;
    ...
    if ( (*(_DWORD *)(a1 + 1224) & 0x1000000) == 0 && (*((_DWORD *)v14 + 25) & 0x10000) != 0 )
      *(_DWORD *)(v14[13] + 1224) &= ~0x20000000u;
    v18 = *((_DWORD *)v14 + 25);
...
LABEL_28:
  for ( i = *v13; i; i = (__int64 *)*i )
  {
    ...
    if ( (v24 & 0x80000) != 0 || __CFSHR__(v24, 18) )
    {
      ...
      {
        *(_DWORD *)(result + 1224) &= ~0x20000000u;
