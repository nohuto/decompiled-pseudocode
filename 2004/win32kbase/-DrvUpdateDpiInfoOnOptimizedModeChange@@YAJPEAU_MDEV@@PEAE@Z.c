/*
 * XREFs of ?DrvUpdateDpiInfoOnOptimizedModeChange@@YAJPEAU_MDEV@@PEAE@Z @ 0x1C0148B5C
 * Callers:
  ...
  *a2 = 0;
  if ( a1 )
  {
    for ( i = 0; i < *((_DWORD *)a1 + 5); ++i )
    {
      ...
      v22 = v7;
      if ( (unsigned int)PDEVOBJ::bLddmDriver((PDEVOBJ *)&v22) )
      {
        v8 = *(_QWORD *)(v7 + 2576);
        v9 = *(_OWORD *)(v7 + 2472);
        ...
        Buf1[4] = v14;
        Buf1[5] = v15;
        v16 = ((__int64 (__fastcall *)(__int64, __int64, __int64, __int64))qword_1C024CA30)(
                v11,
                v12,
                v7 + 2136,
                v7 + 2456);
        ...
        else
        {
          ...
          v20[5] = *(unsigned int *)(*(_QWORD *)(v7 + 2576) + 256LL);
