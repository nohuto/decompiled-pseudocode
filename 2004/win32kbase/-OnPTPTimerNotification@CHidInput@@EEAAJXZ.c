/*
 * XREFs of ?OnPTPTimerNotification@CHidInput@@EEAAJXZ @ 0x1C01A6E50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CHidInput::OnPTPTimerNotification(CHidInput *this)
{
  ...
  int v58; // [rsp+3Ch] [rbp-7Dh] BYREF
  CHidInput *v59; // [rsp+40h] [rbp-79h]
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    if ( v60 )
    {
      v11 = *(unsigned int *)(v60 + 24);
      if ( *(_DWORD *)(v60 + 48) || (int)v11 > 0 )
      {
        *(_DWORD *)(v60 + 44) = 1;
  ...
  if ( CHidInput::IsTouchpadDevice(v49, v48) )
  {
    ...
    {
      v58 = 0;
      PTPEngineTraceProducer::OnEvent(*(PTPEngineTraceProducer **)(v51 + 512), (struct PTPEngineEvent *)&v58);
    }
  }
