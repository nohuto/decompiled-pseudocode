/*
 * XREFs of ?vFreeOrCacheRBrush@RBRUSH@@QEAAXW4RBTYPE@@@Z @ 0x1C00C1790
 * Callers:
...
void __fastcall RBRUSH::vFreeOrCacheRBrush(_DWORD *a1, int a2)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if ( v3 )
      {
        v5 = qword_1C0251620 ? qword_1C0251620() : -1073741637;
        if ( v5 >= 0 && qword_1C0251628 )
          qword_1C0251628(v2 + 16);
      }
    }
