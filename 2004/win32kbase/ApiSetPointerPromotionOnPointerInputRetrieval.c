/*
 * XREFs of ApiSetPointerPromotionOnPointerInputRetrieval @ 0x1C01CC48C
 * Callers:
        ...
        unsigned int a4)
{
  ...
  if ( qword_1C02535D8 )
    result = qword_1C02535D8();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C02535E0;
    if ( qword_1C02535E0 )
      result = qword_1C02535E0(a1, v6, a3, a4);
  }
