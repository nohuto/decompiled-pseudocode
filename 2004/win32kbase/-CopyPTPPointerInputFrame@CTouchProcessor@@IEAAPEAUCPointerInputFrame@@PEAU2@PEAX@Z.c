/*
 * XREFs of ?CopyPTPPointerInputFrame@CTouchProcessor@@IEAAPEAUCPointerInputFrame@@PEAU2@PEAX@Z @ 0x1C018B814
 * Callers:
 ...
 *     ??4CPointerInfoNode@@QEAAAEAU0@AEBU0@@Z @ 0x1C01878D4 (--4CPointerInfoNode@@QEAAAEAU0@AEBU0@@Z.c)
 *     ??4CPointerQFrame@@QEAAAEAU0@AEBU0@@Z @ 0x1C0187C74 (--4CPointerQFrame@@QEAAAEAU0@AEBU0@@Z.c)
        ...
        unsigned __int64 a3)
{
  ...
  __int64 *v33[2]; // [rsp+20h] [rbp-98h] BYREF
  ...
  if ( v6 )
  {
    ...
    *(_OWORD *)&v6[18].LowPart = *((_OWORD *)a2 + 9);
    ...
    for ( i = 0; i < *((_DWORD *)a2 + 12); ++i )
      CPointerQFrame::operator=(v10[18].QuadPart + 160LL * i, 160LL * i + *((_QWORD *)a2 + 18));
    if ( !*((_QWORD *)a2 + 16)
      || (v22 = CTouchProcessor::CopyRawDataList((CTouchProcessor *)this, a2), (v10[16].QuadPart = (LONGLONG)v22) != 0) )
    {
      ...
      v33[1] = *(__int64 **)(v25 + 480);
      v33[0] = (__int64 *)&v10[19];
