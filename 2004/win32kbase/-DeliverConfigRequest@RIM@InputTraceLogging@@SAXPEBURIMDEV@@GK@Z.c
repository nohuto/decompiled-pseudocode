/*
 * XREFs of ?DeliverConfigRequest@RIM@InputTraceLogging@@SAXPEBURIMDEV@@GK@Z @ 0x1C0163508
 * Callers:
...
void __fastcall InputTraceLogging::RIM::DeliverConfigRequest(const struct RIMDEV *a1)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 256LL) )
  {
    ...
    v11 = 2LL;
    v9 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0246A70, (unsigned __int8 *)dword_1C02165F7, 0LL, 0LL, 5u, &v7);
  }
}
