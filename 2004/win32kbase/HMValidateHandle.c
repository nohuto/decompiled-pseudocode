/*
 * XREFs of HMValidateHandle @ 0x1C0074300
 * Callers:
...
__int64 __fastcall HMValidateHandle(__int64 a1, unsigned __int8 a2)
{
  ...
  if ( (unsigned __int64)(unsigned __int16)a1 < *((_QWORD *)gpsi + 1) )
  {
    ...
    CLockDomainSharedAllowAllRecursion<DLT_HANDLEMANAGER>::CLockDomainSharedAllowAllRecursion<DLT_HANDLEMANAGER>((__int64)v10);
    v6 = gpKernelHandleTable;
    v7 = 3LL * (unsigned int)((v5 - (char *)qword_1C024AD48) >> 5);
