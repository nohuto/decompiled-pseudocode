/*
 * XREFs of NtUserSetProcessDpiAwarenessContext @ 0x1C0020350
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetProcessDpiAwarenessContext(unsigned int a1, int a2)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    if ( v51 && (*(int *)(v51 + 24) > 0 || *(_DWORD *)(v66 + 48)) )
    {
      ...
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 0x2000LL, v52, v53) )
        {
          v72 = 0;
          v62 = v67;
          v71 = 4;
          v70 = &v62;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0246A70, (int)&dword_1C0213E87, (int)&ActivityId, 0, 3u, &v69);
        }
      }
    }
  }
    ...
    *(GUID *)(v66 + 28) = ActivityId;
    if ( (unsigned int)dword_1C0246A70 > 6 )
    {
      if ( (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 0x2000LL, (unsigned int)dword_1C0246A70, v12) )
      {
        ...
        v75 = 4;
        v74 = &v63;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0246A70, (int)&dword_1C0213E30, (int)&ActivityId, 0, 3u, &v73);
        v54 = (unsigned int)dword_1C0246A70;
      }
      if ( (unsigned int)v54 > 6 && (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 0x2000LL, v54, v55) )
      {
        v80 = 0;
        v64 = v67;
        v79 = 4;
        v78 = &v64;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0246A70, (int)&dword_1C0213E5D, (int)&ActivityId, 0, 3u, &v77);
      }
    }
  }
