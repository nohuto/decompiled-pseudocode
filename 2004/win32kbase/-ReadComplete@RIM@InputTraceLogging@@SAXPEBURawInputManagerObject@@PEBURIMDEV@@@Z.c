/*
 * XREFs of ?ReadComplete@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@PEBURIMDEV@@@Z @ 0x1C0175508
 * Callers:
...
void __fastcall InputTraceLogging::RIM::ReadComplete(const struct RawInputManagerObject *a1, const struct RIMDEV *a2)
{
  ...
  if ( v2 )
  {
    ...
    else if ( v2 == 1 && (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 256LL) )
    {
      v5 = (unsigned __int8 *)&unk_1C0217D32;
      goto LABEL_17;
    }
  }
  else if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 256LL) )
  {
    v5 = (unsigned __int8 *)&unk_1C0217CF9;
LABEL_17:
