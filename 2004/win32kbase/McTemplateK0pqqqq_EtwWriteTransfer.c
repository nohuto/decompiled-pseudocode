/*
 * XREFs of McTemplateK0pqqqq_EtwWriteTransfer @ 0x1C012B0E8
 * Callers:
 *     EtwTraceInternalSetTimer @ 0x1C0029990 (EtwTraceInternalSetTimer.c)
 *     EtwTraceTimerProc @ 0x1C0029E40 (EtwTraceTimerProc.c)
 *     EtwDirtyRectUpdate @ 0x1C0030A80 (EtwDirtyRectUpdate.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C014FD70 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C014FDB0 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C0150140 (EtwTranslationUpdate.c)
 * Callees:
