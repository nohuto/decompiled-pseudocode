/*
 * XREFs of ?FindContactToBreakSuperCurtains@CPTPEngine@@AEAAHPEAUPTPInput@@PEAUCContactState@@@Z @ 0x1C01C21C0
 * Callers:
        ...
        struct CContactState *a3)
{
  ...
  if ( v3 )
  {
    ...
    {
      v7 = (CPTPEngine *)((char *)this + 392 * (unsigned int)(*i % *((_DWORD *)this + 4)) + 1160);
