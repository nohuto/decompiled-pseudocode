/*
 * XREFs of xxxInternalToUnicode @ 0x1C00193E0
 * Callers:
 ...
 *     GetModifierBits @ 0x1C00197D0 (GetModifierBits.c)
        ...
        __int64 a8)
{
  ...
  *a7 = v14;
  ...
  if ( v14 )
  {
    if ( a1 != 18 )
    {
      if ( a1 == (unsigned __int16)word_1C024D054 )
        word_1C024D054 = 0;
      goto LABEL_9;
    }
    if ( !word_1C024D050 )
...
LABEL_76:
    ...
    {
      if ( (word_1C024D050 & 0xFF00) != 0 )
      {
        v19 = _byteswap_ushort(word_1C024D050);
        word_1C024D050 = v19;
      }
      else if ( ((_WORD)v37 != 932 || (unsigned __int16)(word_1C024D050 - 161) > 0x3Eu)
             && (unsigned __int16)(word_1C024D050 - 128) <= 0x7Fu )
      {
        v37 = 1252LL;
      }
    }
...
LABEL_57:
      if ( v36 < 0 )
        goto LABEL_58;
      if ( (unsigned __int16)word_1C024D054 == a1 )
        return 0LL;
      if ( (unsigned __int8)(byte_1C024D052 - 2) > 1u )
      {
        word_1C024D050 = v36 + 10 * v19;
        if ( !word_1C024D050 )
        {
          v43 = byte_1C024D052;
          if ( !v36 )
