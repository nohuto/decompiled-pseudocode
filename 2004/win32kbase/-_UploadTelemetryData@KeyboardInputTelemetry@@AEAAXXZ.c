/*
 * XREFs of ?_UploadTelemetryData@KeyboardInputTelemetry@@AEAAXXZ @ 0x1C0001B30
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C0245250 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0245250, 0x400000000000LL, a3, a4) )
