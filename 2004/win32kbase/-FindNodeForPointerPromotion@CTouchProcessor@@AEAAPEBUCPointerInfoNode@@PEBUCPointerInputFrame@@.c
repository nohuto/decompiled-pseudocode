/*
 * XREFs of ?FindNodeForPointerPromotion@CTouchProcessor@@AEAAPEBUCPointerInfoNode@@PEBUCPointerInputFrame@@@Z @ 0x1C018DCE4
 * Callers:
 ...
 *     ?IsPrimary@CPointerInfoNode@@QEBAHXZ @ 0x1C019550C (-IsPrimary@CPointerInfoNode@@QEBAHXZ.c)
