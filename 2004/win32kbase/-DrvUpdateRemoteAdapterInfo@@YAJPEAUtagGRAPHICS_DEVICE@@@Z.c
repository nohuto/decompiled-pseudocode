/*
 * XREFs of ?DrvUpdateRemoteAdapterInfo@@YAJPEAUtagGRAPHICS_DEVICE@@@Z @ 0x1C00CC39C
 * Callers:
    ...
    if ( v2 >= 0 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( IoGetDeviceObjectPointer(&DestinationString, 0, &FileObject, &DeviceObject) >= 0 )
        {
          ...
          if ( v2 >= 0 && (_QWORD)v10 == qword_1C024D234 )
          {
            if ( dword_1C024D230 )
            {
              ...
              if ( v2 >= 0 )
              {
                qword_1C024D240 = (PVOID)*((_QWORD *)P + 1);
...
LABEL_19:
  ...
  else if ( !qword_1C024D240 && (unsigned __int8)((__int64 (*)(void))qword_1C024CAB8)() )
  {
    qword_1C024D234 = *((_QWORD *)a1 + 37);
    qword_1C024D240 = (PVOID)*((_QWORD *)a1 + 38);
  }
  return (unsigned int)v2;
}
