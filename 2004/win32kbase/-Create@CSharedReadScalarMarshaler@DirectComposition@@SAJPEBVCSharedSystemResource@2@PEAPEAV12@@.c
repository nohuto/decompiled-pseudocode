/*
 * XREFs of ?Create@CSharedReadScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F4938
 * Callers:
 *     CreateSharedReadScalarMarshaler @ 0x1C01F4B10 (CreateSharedReadScalarMarshaler.c)
 * Callees:
