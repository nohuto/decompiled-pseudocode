/*
 * XREFs of ?CitpPostUpdateUseInfoLoad@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C00363A0
 * Callers:
...
__int64 __fastcall CitpPostUpdateUseInfoLoad(struct _CIT_IMPACT_CONTEXT *a1)
{
  ...
  *((_QWORD *)a1 + 71) = v40;
  CitpStatIncrement(&v55[2], 1u);
LABEL_9:
  CitpStatIncrement(&v55[4], 1u);
