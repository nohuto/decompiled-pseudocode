/*
 * XREFs of ?FilterMoveForStableContact@CPTPEngine@@AEAAHPEAUPTPInput@@UtagPOINT@@PEAUCContactState@@@Z @ 0x1C01C2024
 * Callers:
 ...
 * Callees:
 *     ?CrossedTPMoveFilteringThreshold@CPTPEngine@@AEAAHPEAUCContactState@@UtagPOINT@@@Z @ 0x1C01C0240 (-CrossedTPMoveFilteringThreshold@CPTPEngine@@AEAAHPEAUCContactState@@UtagPOINT@@@Z.c)
 */
...
LABEL_10:
  ...
  v12 = *((_DWORD *)this + 958);
  v13 = (v12 & 1) != 0 && *((_QWORD *)a4 + 8) <= *((_QWORD *)this + 456);
