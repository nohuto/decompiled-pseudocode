/*
 * XREFs of ??0PDEVOBJ@@QEAA@PEAU_LDEV@@PEAU_devicemodeW@@PEAG22PEAXPEAUtagREMOTETYPEONENODE@@PEAU_GDIINFO@@PEAUtagDEVINFO@@HKK@Z @ 0x1C00C2650
 * Callers:
 ...
 *     ?GeneratePDEVUniqueUMPDHandle@@YAPEAUHDEV__@@XZ @ 0x1C0052CE0 (-GeneratePDEVUniqueUMPDHandle@@YAPEAUHDEV__@@XZ.c)
...
LABEL_67:
    ...
    if ( !a11 || (unsigned int)GreSetPaletteOwner(*(void **)v54, 0LL) )
    {
      v58 = *(_QWORD *)this;
      v94 = 0LL;
      *(_QWORD *)(v58 + 1808) = v54;
      ...
      if ( *(_DWORD *)(*(_QWORD *)(v59 + 1792) + 24LL) == 2 )
      {
        ...
        if ( v61 < 0 )
          goto LABEL_92;
        v62 = (__int64 (__fastcall *)(PDEVOBJ *))qword_1C0251658;
      }
      else
      {
        if ( qword_1C0251660 )
        ...
        if ( v63 < 0 )
          goto LABEL_92;
        v62 = (__int64 (__fastcall *)(PDEVOBJ *))qword_1C0251668;
      }
      if ( v62 )
        v64 = v62(this);
      else
...
LABEL_144:
      ...
      *(_QWORD *)(*(_QWORD *)this + 1776LL) = *(_QWORD *)(v18 + 3384);
      ...
      if ( v69 >= 0 )
      {
        v71 = qword_1C0251678 ? (int *)qword_1C0251678() : 0LL;
        ...
        if ( *v71 )
        {
          ...
          if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 1792LL) + 24LL) == 1 )
          {
            ...
            if ( v73 >= 0 && qword_1C0251688 )
              qword_1C0251688(*(unsigned int *)(v72 + 2180));
