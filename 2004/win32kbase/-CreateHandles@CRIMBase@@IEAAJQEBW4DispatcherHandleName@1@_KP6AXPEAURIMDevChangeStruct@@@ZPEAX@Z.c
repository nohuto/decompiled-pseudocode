  ...
  if ( a3 )
  {
    do
    {
      ...
      if ( (unsigned int)v9 >= 0x11 )
        return 3221225485LL;
      if ( dword_1C0208710[3 * v9] != (_DWORD)v9 )
        MicrosoftTelemetryAssertTriggeredNoArgsKM(dword_1C0208710, a2, a3, a4);
      DispatcherHandles = CRIMBase::SensorDispatcherObject::CreateDispatcherHandles(
                            ...
                            (const struct CRIMBase::DispatcherCreation *)&dword_1C0208710[3 * v9]);
