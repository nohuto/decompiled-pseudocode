/*
 * XREFs of CitProcessCallout @ 0x1C009E2D8
 * Callers:
 ...
 *     ?CitpAudioStatDecrementStreams@@YAXPEAU_CIT_AUDIO_STATS@@E@Z @ 0x1C00C7CD8 (-CitpAudioStatDecrementStreams@@YAXPEAU_CIT_AUDIO_STATS@@E@Z.c)
 *     ?CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z @ 0x1C01F9AA4 (-CitpInteractionSummaryGetOutstanding@@YAPEAU_CIT_INTERACTION_SUMMARY@@PEAU_CIT_PROCESS@@G@Z.c)
 */
...
void __fastcall CitProcessCallout(__int64 a1, char a2)
{
  ...
  if ( a2 )
  {
    *(_QWORD *)(a1 + 928) = 52976LL;
    ...
    if ( xmmword_1C02504A0 && !*((_QWORD *)xmmword_1C02504A0 + 12) )
    {
...
LABEL_28:
      ...
      if ( v9 != *(_QWORD *)&DOUBLE_0_0 )
        CitpContextUserLogon(xmmword_1C02504A0, &v11);
    }
  }
  else
  {
    ...
    if ( CitpProcessInfoIsValid((struct _CIT_PROCESS *)v3) )
    {
      ...
      {
        if ( a1 == *((_QWORD *)xmmword_1C02504A0 + 15) )
