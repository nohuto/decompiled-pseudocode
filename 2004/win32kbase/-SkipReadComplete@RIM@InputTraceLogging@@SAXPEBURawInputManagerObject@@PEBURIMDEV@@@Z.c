/*
 * XREFs of ?SkipReadComplete@RIM@InputTraceLogging@@SAXPEBURawInputManagerObject@@PEBURIMDEV@@@Z @ 0x1C0175730
 * Callers:
        ...
        const struct RIMDEV *a2)
{
  ...
  if ( v2 )
  {
    ...
    else if ( v2 == 1 && (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 256LL) )
    {
      v19 = v16;
      v4 = &v19;
      v5 = (unsigned __int8 *)&dword_1C0217BF4;
      goto LABEL_17;
    }
  }
  else if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 256LL) )
  {
    v18 = v3;
    v4 = &v18;
    v5 = (unsigned __int8 *)&unk_1C0217BC1;
LABEL_17:
    v26 = 0;
    v24 = v4;
    v25 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0246A70, v5, 0LL, 0LL, 3u, &v23);
  }
}
