/*
 * XREFs of _xxxUserChangeDisplaySettings_::_2_::_AUTO_KM::__AUTO_KM @ 0x1C000DB14
 * Callers:
...
__int64 (__fastcall *__fastcall xxxUserChangeDisplaySettings_::_2_::_AUTO_KM::__AUTO_KM(_QWORD *a1))(_QWORD)
{
  ...
  if ( a1[4] )
  {
    ...
    if ( qword_1C0251FE8 )
      result = (__int64 (__fastcall *)(_QWORD))qword_1C0251FE8(a1 + 5);
  }
  if ( *a1 )
  {
    result = qword_1C0251FE8;
    if ( qword_1C0251FE8 )
      return (__int64 (__fastcall *)(_QWORD))qword_1C0251FE8(a1 + 1);
  }
  return result;
}
