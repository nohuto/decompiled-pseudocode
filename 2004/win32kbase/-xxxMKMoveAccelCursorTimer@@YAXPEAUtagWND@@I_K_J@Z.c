/*
 * XREFs of ?xxxMKMoveAccelCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C0184A00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
    ...
    {
      v5 = (unsigned __int8)byte_1C024BAE2;
      giMouseMoveTable = 1;
    ...
    {
      a2 = byte_1C024BA61;
      v5 = byte_1C024BA61[giMouseMoveTable++];
    }
    if ( !v5 )
      return;
    goto LABEL_10;
  }
  v5 = 4 * (unsigned __int8)byte_1C024BAE2;
LABEL_10:
