/*
 * XREFs of xxxUpdatePerUserAccessPackSettings @ 0x1C002DD30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CalculateMouseTable@@YAXXZ @ 0x1C002F200 (-CalculateMouseTable@@YAXXZ.c)
...
void __fastcall xxxUpdatePerUserAccessPackSettings(__int64 a1)
{
  ...
  if ( v2 )
  {
    if ( v3 )
    {
      LODWORD(xmmword_1C024BBCC) = xmmword_1C024BBCC | 1;
      v9 = gdwPUDFlags | 1;
    }
    else
    {
    ...
    if ( v7 )
    {
      LODWORD(qword_1C024BB94) = qword_1C024BB94 | 1;
      v13 = v12 | 0x10;
    }
    else
    {
      LODWORD(qword_1C024BB94) = qword_1C024BB94 & 0xFFFFFFFE;
      v13 = v12 & 0xFFFFFFEF;
    }
    if ( Length )
    {
  ...
  if ( (((unsigned __int8)gdwPUDFlags ^ (unsigned __int8)xmmword_1C024BBCC) & 1) == 0 )
  {
    if ( v3 )
      v27 = xmmword_1C024BBCC | 1;
    else
      v27 = xmmword_1C024BBCC & 0xFFFFFFFE;
    LODWORD(xmmword_1C024BBCC) = v27;
  }
  if ( (dword_1C024BBC4 & 1) == (((unsigned int)gdwPUDFlags >> 1) & 1) )
  {
...
LABEL_65:
  v28 = gdwPUDFlags;
  if ( (((unsigned __int8)dword_1C024BBA4 ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 2)) & 1) == 0 )
  {
    if ( v5 )
      v29 = dword_1C024BBA4 | 1;
    else
      v29 = dword_1C024BBA4 & 0xFFFFFFFE;
    dword_1C024BBA4 = v29;
  }
  if ( (((unsigned __int8)dword_1C024BB8C ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 3)) & 1) == 0 )
  {
    if ( v6 )
      v30 = dword_1C024BB8C | 1;
    else
      v30 = dword_1C024BB8C & 0xFFFFFFFE;
    dword_1C024BB8C = v30;
  }
  if ( (((unsigned __int8)qword_1C024BB94 ^ (unsigned __int8)((unsigned int)gdwPUDFlags >> 4)) & 1) == 0 )
  {
    if ( v7 )
      v31 = qword_1C024BB94 | 1;
    else
      v31 = qword_1C024BB94 & 0xFFFFFFFE;
    LODWORD(qword_1C024BB94) = v31;
  }
  ...
  if ( (((unsigned __int8)dword_1C024BB7C ^ (unsigned __int8)(v28 >> 7)) & 1) == 0 )
  {
    if ( v8 )
      v32 = dword_1C024BB7C | 1;
    else
      v32 = dword_1C024BB7C & 0xFFFFFFFE;
    dword_1C024BB7C = v32;
  }
LABEL_22:
  ...
  Value = v16;
  LODWORD(xmmword_1C024BBCC) = v16;
  FastGetProfileIntW(a1, 15, (int)L"DelayBeforeAcceptance", 1000, (PULONG)&xmmword_1C024BBCC + 1, 0);
  FastGetProfileIntW(a1, 15, (int)L"AutoRepeatRate", 500, (PULONG)&xmmword_1C024BBCC + 3, 0);
  FastGetProfileIntW(a1, 15, (int)L"AutoRepeatDelay", 1000, (PULONG)&xmmword_1C024BBCC + 2, 0);
  FastGetProfileIntW(a1, 15, (int)L"BounceTime", 0, &::Value, 0);
  FastGetProfileIntW(a1, 19, (int)L"Flags", 2, &dword_1C024EE24, 0);
  FastGetProfileIntW(a1, 19, (int)L"FSTextEffect", 0, &dword_1C024EE28, 0);
  FastGetProfileIntW(a1, 19, (int)L"WindowsEffect", 0, &dword_1C024EE40, 0);
  ...
  *((_DWORD *)gpsi + 544) = (v17 >> 15) & 1;
  ...
  Value = v19;
  dword_1C024BBA4 = v19;
  FastGetProfileIntW(a1, 16, (int)L"MaximumSpeed", 40, &dword_1C024BBA8, 0);
  FastGetProfileIntW(a1, 16, (int)L"TimeToMaximumSpeed", 3000, &dword_1C024BBAC, 0);
  if ( dword_1C024BBA8 - 10 > 0x15E )
    dword_1C024BBA8 = 40;
  if ( dword_1C024BBAC - 1000 > 0xFA0 )
    dword_1C024BBAC = 3000;
  CalculateMouseTable();
  gbMKMouseMode = ((dword_1C024BBA4 & 0x80) != 0) ^ (((unsigned __int8)(1 << (2 * (gNumLockVk & 3) + 1)) & *((_BYTE *)&gafAsyncKeyState + ((unsigned __int64)(unsigned __int8)gNumLockVk >> 2))) != 0);
  if ( (dword_1C024BBA4 & 1) != 0 )
    MKShowMouseCursor();
  else
    MKHideMouseCursor();
  ...
  FastGetProfileIntW(a1, 18, (int)L"TimeToWait", 300000, (PULONG)&qword_1C024BB94 + 1, 0);
...
LABEL_52:
  ...
  FastGetProfileIntW(a1, 48, (int)L"On", 0, &dword_1C024BB6C, 0);
  FastGetProfileIntW(a1, 48, (int)L"Locale", 0, &dword_1C024BB70, 0);
  AccessTimeOutReset();
