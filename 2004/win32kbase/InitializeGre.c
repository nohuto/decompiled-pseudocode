/*
 * XREFs of InitializeGre @ 0x1C0296F90
 * Callers:
 ...
 *     ?Initialize@SfmState@@QEAAHXZ @ 0x1C004C8A0 (-Initialize@SfmState@@QEAAHXZ.c)
 *     GreCreateSemaphoreNonTracked @ 0x1C005D5EC (GreCreateSemaphoreNonTracked.c)
 ...
 *     bLockEtwEnabled @ 0x1C005E108 (bLockEtwEnabled.c)
 *     ?bUseActualGDIScale@@YAHXZ @ 0x1C005E394 (-bUseActualGDIScale@@YAHXZ.c)
 ...
 *     ?InitializeDefaultDCAttributes@@YAXXZ @ 0x1C01408F8 (-InitializeDefaultDCAttributes@@YAXXZ.c)
...
char InitializeGre()
{
  ...
  RtlGetSuiteMask();
  qword_1C0250250 = (__int64)&MultiUserGreEngAllocList;
  ...
  if ( MultiUserEngAllocListLock )
  {
    ...
    if ( qword_1C02514F0 )
      ...
      v2 = -1073741637;
    if ( v2 >= 0 && qword_1C02514F8 )
      qword_1C02514F8();
    qword_1C0250240 = (__int64)&GreEngLoadModuleAllocList;
    ...
    {
      v3 = qword_1C0251500 ? qword_1C0251500() : -1073741637;
      if ( v3 < 0 || (!qword_1C0251508 ? (v4 = 0) : (v4 = qword_1C0251508()), v4) )
      {
        ...
        if ( (unsigned int)HmgCreate() )
        {
          if ( RGNMEMOBJ::InitializeScanLookAsideList() )
          {
            ...
            if ( v5 >= 0 )
            {
              ...
              if ( qword_1C0251518 )
              {
                qword_1C0251518(&v19, &BitMapBuffer, &BitMapHeader, &v21);
                v6 = v19;
              }
                                              ...
                                              if ( v13[0] )
                                              {
                                                ...
                                                if ( (unsigned int)bInitPALOBJ() )
                                                {
                                                  ...
                                                  if ( (unsigned int)bInitBMOBJ() )
                                                  {
                                                    ...
                                                    {
                                                      v9 = qword_1C0251520 ? qword_1C0251520() : -1073741637;
                                                      if ( v9 < 0
                                                        || (!qword_1C0251528 ? (v10 = 0) : (v10 = qword_1C0251528()), v10) )
                                                      {
                                                        v11 = qword_1C0251530 ? qword_1C0251530() : -1073741637;
                                                        if ( v11 < 0
                                                          || (!qword_1C0251538 ? (v12 = 0) : (v12 = qword_1C0251538()),
                                                              v12) )
                                                        {
                                                          if ( qword_1C0251540 )
                                                            v1 = qword_1C0251540();
