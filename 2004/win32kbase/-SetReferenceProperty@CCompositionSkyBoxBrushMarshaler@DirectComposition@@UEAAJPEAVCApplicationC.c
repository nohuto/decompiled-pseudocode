/*
 * XREFs of ?SetReferenceProperty@CCompositionSkyBoxBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01F0660
 * Callers:
 *     <none>
 * Callees:
