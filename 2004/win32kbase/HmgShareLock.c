/*
 * XREFs of HmgShareLock @ 0x1C008A850
 * Callers:
...
__int64 __fastcall HmgShareLock(unsigned int a1, char a2)
{
  ...
  if ( *(_BYTE *)(v25 + 14) == a2 && *(_WORD *)(v25 + 12) == v4 )
  {
    ...
    if ( a2 == 5 )
    {
      v23 = *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v5 + 680);
      v24 = 0;
    }
    else
    {
      if ( a2 != 16 )
        goto LABEL_13;
      v23 = *(struct NSInstrumentation::CReferenceTracker::CReferenceCountedType::SCircularBuffer **)(v5 + 136);
      v24 = 2;
    }
