/*
 * XREFs of ?CreateActivationGroupWithId@CActivationObjectManager@@AEAAJAEBUACTIVATION_GROUP_ID@@@Z @ 0x1C005CDBC
 * Callers:
        ...
        const struct ACTIVATION_GROUP_ID *a2)
{
  ...
  __int128 v25; // [rsp+24h] [rbp-3Ch]
  __int128 v26; // [rsp+34h] [rbp-2Ch]
  __int128 v27; // [rsp+44h] [rbp-1Ch]
  ...
  if ( v6 )
  {
    ...
    v23 = (37
         * (BYTE6(v30)
         ...
         + HIBYTE(v30)) & (((unsigned int)v19 >> 5) - 1);
    *v6 = *(_QWORD *)(v22 + 8 * v23);
    *(_QWORD *)(v22 + 8 * v23) = v6;
    ++*(_DWORD *)this;
    v28 = 0;
    DWORD1(v27) = *(_DWORD *)a2;
    ((void (__fastcall *)(__int64, __int64, int *, __int64))InputExtensibilityCallout::CoreMsgSendMessage)(
      v22,
      11LL,
      &v24,
      56LL);
