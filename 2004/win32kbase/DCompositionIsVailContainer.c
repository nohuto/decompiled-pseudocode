/*
 * XREFs of DCompositionIsVailContainer @ 0x1C01CE578
 * Callers:
 ...
 *     ?CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEAPEAX@Z @ 0x1C01F3A40 (-CreateSection@CCrossContainerGuestReadWriteSharedSectionMarshaler@DirectComposition@@EEAAJ_KPEA.c)
 * Callees:
...
__int64 DCompositionIsVailContainer()
{
  ...
  return (unsigned __int8)byte_1C02545E0;
}
