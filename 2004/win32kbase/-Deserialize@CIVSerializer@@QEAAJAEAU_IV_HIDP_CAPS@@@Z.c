/*
 * XREFs of ?Deserialize@CIVSerializer@@QEAAJAEAU_IV_HIDP_CAPS@@@Z @ 0x1C01B0FA8
 * Callers:
...
__int64 __fastcall CIVSerializer::Deserialize(CIVSerializer *this, struct _IV_HIDP_CAPS *a2)
{
