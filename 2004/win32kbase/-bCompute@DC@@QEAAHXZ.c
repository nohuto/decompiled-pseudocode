/*
 * XREFs of ?bCompute@DC@@QEAAHXZ @ 0x1C007E030
 * Callers:
 *     ?bLock@DEVLOCKOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C007D350 (-bLock@DEVLOCKOBJ@@QEAAHAEAVXDCOBJ@@H@Z.c)
 * Callees:
 *     ?vGetSubRect@RGNOBJ@@QEBAXPEAU_RECTL@@@Z @ 0x1C007AB00 (-vGetSubRect@RGNOBJ@@QEBAXPEAU_RECTL@@@Z.c)
...
LABEL_173:
          ...
          if ( (*(_BYTE *)(v27 + 15) & 4) != 0 )
          {
            ...
            *(_DWORD *)(*(_QWORD *)&this[122] + 116LL) = v32;
            ...
            {
LABEL_110:
              *(_OWORD *)(*(_QWORD *)&this[122] + 120LL) = xmmword_1C020D210;
            }
            else
            {
              y = this[129].y;
