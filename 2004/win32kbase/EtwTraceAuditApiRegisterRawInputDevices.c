/*
 * XREFs of EtwTraceAuditApiRegisterRawInputDevices @ 0x1C001AC90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EtwpTraceAuditApiQueryAddressVADInformation@@YAJPEAXPEAU_MEMORY_BASIC_INFORMATION@@PEAPEAU_OBJECT_NAME_INFORMATION@@@Z @ 0x1C001B41C (-EtwpTraceAuditApiQueryAddressVADInformation@@YAJPEAXPEAU_MEMORY_BASIC_INFORMATION@@PEAPEAU_OBJE.c)
 */
