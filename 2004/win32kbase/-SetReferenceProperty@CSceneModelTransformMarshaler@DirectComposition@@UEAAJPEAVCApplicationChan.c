/*
 * XREFs of ?SetReferenceProperty@CSceneModelTransformMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C01DAE60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DirectComposition::CSceneModelTransformMarshaler::SetReferenceProperty(
