/*
 * XREFs of ?ConfigureActivationObject@CActivationObjectManager@@QEAAJAEBU_LUID@@W4ACTIVATIONOBJECTSTATECHANGE_REASON@@W4ACTIVATION_OBJECT_STATE@@2@Z @ 0x1C012CB30
 * Callers:
        ...
        int a5)
{
  ...
  v5 = qword_1C024C728;
  RIMLockExclusive((__int64)&qword_1C02504D0);
