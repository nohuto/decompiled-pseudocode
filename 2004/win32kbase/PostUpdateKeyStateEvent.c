/*
 * XREFs of PostUpdateKeyStateEvent @ 0x1C00AD330
 * Callers:
...
LABEL_5:
    ...
    if ( *(_DWORD *)(v3 + 96) == 4 )
    {
      ...
      *v5 = gafAsyncKeyState;
      v8 = v5 + 4;
      v5[1] = xmmword_1C024B8B0;
      v5[2] = unk_1C024B8C0;
      v5[3] = xmmword_1C024B8D0;
      do
      {
        ++v6;
        *v8++ |= *v7++;
      ...
      while ( v6 < 8 );
      if ( qword_1C0252018 )
        qword_1C0252018(*(_QWORD *)(a1 + 96), 8256LL);
      goto LABEL_5;
    }
    ...
    if ( v4 )
    {
      ...
      v2 = (_OWORD *)(a1 + 196);
      *v4 = gafAsyncKeyState;
      v4[1] = xmmword_1C024B8B0;
      v4[2] = unk_1C024B8C0;
      v4[3] = xmmword_1C024B8D0;
      v4[4] = *(_OWORD *)(a1 + 196);
      v4[5] = *(_OWORD *)(a1 + 212);
