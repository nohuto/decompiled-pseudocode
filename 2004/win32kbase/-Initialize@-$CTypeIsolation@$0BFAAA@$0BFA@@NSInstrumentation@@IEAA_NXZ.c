/*
 * XREFs of ?Initialize@?$CTypeIsolation@$0BFAAA@$0BFA@@NSInstrumentation@@IEAA_NXZ @ 0x1C000979C
 * Callers:
 *     ?Create@?$CTypeIsolation@$0BFAAA@$0BFA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00096AC (-Create@-$CTypeIsolation@$0BFAAA@$0BFA@@NSInstrumentation@@SAPEAV12@XZ.c)
 * Callees:
 ...
 *     ?PlatformDebugModeEnabled@NSInstrumentation@@YA_NXZ @ 0x1C00D10E0 (-PlatformDebugModeEnabled@NSInstrumentation@@YA_NXZ.c)
 */
