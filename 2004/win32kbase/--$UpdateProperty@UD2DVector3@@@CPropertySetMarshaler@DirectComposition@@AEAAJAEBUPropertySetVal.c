/*
 * XREFs of ??$UpdateProperty@UD2DVector3@@@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEBUD2DVector3@@@Z @ 0x1C01E802C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (unsigned int)v3 < *(_DWORD *)(a1 + 80)
    && (v6 = *(_QWORD *)(a1 + 72), v7 = *(_DWORD *)(v6 + 8 * v3 + 4), a2[1] == (v7 & 0x1FFFFFFF))
