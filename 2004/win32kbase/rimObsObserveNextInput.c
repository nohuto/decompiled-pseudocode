/*
 * XREFs of rimObsObserveNextInput @ 0x1C017F630
 * Callers:
 *     NtRIMObserveNextInput @ 0x1C0156B20 (NtRIMObserveNextInput.c)
 *     RIMObserveNextInput @ 0x1C015A8B0 (RIMObserveNextInput.c)
 * Callees:
