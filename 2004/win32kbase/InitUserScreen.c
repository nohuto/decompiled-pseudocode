/*
 * XREFs of InitUserScreen @ 0x1C00139D8
 * Callers:
 ...
 *     GreGetSystemFont @ 0x1C005DBC0 (GreGetSystemFont.c)
...
__int64 InitUserScreen()
{
  ...
  *(_QWORD *)(gpDispInfo + 56) = GreCreateDisplayDC(*(_QWORD *)(gpDispInfo + 40), 0LL, 0LL);
  v3 = *(_QWORD *)(gpDispInfo + 56);
  if ( !v3 )
    goto LABEL_43;
  if ( qword_1C02519B8 )
    qword_1C02519B8(v3, *((_QWORD *)v2 + 640));
  ...
  *(_QWORD *)(gpDispInfo + 64) = GreCreateCompatibleDC(*(HDC *)(gpDispInfo + 56));
  ...
  if ( !v4 )
    goto LABEL_43;
  if ( qword_1C02519B8 )
    qword_1C02519B8(v4, *((_QWORD *)v2 + 640));
      ...
      if ( (unsigned int)ApiSetEditionInitGlobalCursorSizes() )
      {
        ...
        else
        {
          ...
          if ( v6 )
          {
            ...
            *((_DWORD *)gpsi + 547) = 0;
            xxxODI_ColorInit(v1);
            v32 = qword_1C0252A18 ? qword_1C0252A18() : -1073741637;
            if ( v32 >= 0 && qword_1C0252A20 )
              qword_1C0252A20();
          }
        }
        goto LABEL_39;
