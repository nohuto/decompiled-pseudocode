/*
 * XREFs of ?SetLastAction@Usage@PTPTelemetry@@SAXW4tagPTP_ACTION@@@Z @ 0x1C01A43E8
 * Callers:
...
char __fastcall PTPTelemetry::Usage::SetLastAction(int a1)
{
  ...
  v3 = (unsigned __int64)(1000
                        * (PerformanceCounter.QuadPart - _InterlockedCompareExchange64(&qword_1C0250DE0, 0LL, 0LL)))
     / gliQpcFreq.QuadPart;
  if ( v3 <= 500 )
  {
    _InterlockedCompareExchange64(&qword_1C0250DD0, 0LL, 0LL);
    LOBYTE(v3) = _InterlockedCompareExchange64(&qword_1C0250DD8, 0LL, 0LL);
    if ( (unsigned int)dword_1C0245250 > 5 )
    {
      LOBYTE(v3) = tlgKeywordOn((__int64)&dword_1C0245250, 0x400000000000LL);
      if ( (_BYTE)v3 )
      {
        v12 = dword_1C0250DEC;
        v8 = v4 - v7;
  ...
  if ( dword_1C024CD08 || qword_1C024CCF0 || PTPTelemetry::Usage::gTPTelemTimings <= 0 )
    dword_1C024CD0C = a1;
  else
    dword_1C024CD08 = a1;
  if ( a1 > 12 )
...
LABEL_57:
  if ( (unsigned int)dword_1C0245250 > 5 )
  {
    ...
    LOBYTE(v3) = tlgWriteTransfer_EtwWriteTransfer(
                   ...
                   (unsigned __int8 *)dword_1C021A503,
                   0LL,
                   0LL,
                   3u,
                   &v18);
