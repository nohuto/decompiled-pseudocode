/*
 * XREFs of ?SetNewValidState@CTouchProcessor@@QEAAHIPEAUCInputPointerNode@@@Z @ 0x1C019A084
 * Callers:
        ...
        __int64 a4)
{
  ...
  v6 = &WPP_8113a81d21a7371434699e4b0bdc9bc8_Traceguids;
      ...
      else
      {
        ...
        else
        {
          if ( (v5 & 0x70006) != 0x40002 )
          {
            ...
            {
              LOBYTE(v6) = 2;
              WPP_RECORDER_SF_L(1, (_DWORD)v6, 7, 65, (__int64)&WPP_8113a81d21a7371434699e4b0bdc9bc8_Traceguids, v5);
            }
            goto LABEL_14;
          }
          v10 = 1;
...
LABEL_14:
  ...
  if ( (*((_DWORD *)a3 + 70) & 8) != 0 )
  {
    v8 = (v5 & 0x8000) != 0;
    if ( (v5 & 0x8000) == 0 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(1LL, &WPP_8113a81d21a7371434699e4b0bdc9bc8_Traceguids, a3, a4);
  }
  if ( v8 )
  {
    *((_DWORD *)a3 + 13) = v10;
