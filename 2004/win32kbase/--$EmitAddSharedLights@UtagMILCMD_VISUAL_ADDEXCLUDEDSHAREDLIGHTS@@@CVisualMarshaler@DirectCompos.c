/*
 * XREFs of ??$EmitAddSharedLights@UtagMILCMD_VISUAL_ADDEXCLUDEDSHAREDLIGHTS@@@CVisualMarshaler@DirectComposition@@IEAA_NAEBVCResourceMarshalerArray@1@W4MILCMD@@PEA_KPEAPEAVCBatch@1@@Z @ 0x1C00A0844
 * Callers:
...
bool __fastcall DirectComposition::CVisualMarshaler::EmitAddSharedLights<tagMILCMD_VISUAL_ADDEXCLUDEDSHAREDLIGHTS>(
        __int64 a1,
        _QWORD *a2,
        __int64 a3,
        unsigned __int64 *a4,
        struct DirectComposition::CBatch **a5)
{
  ...
  if ( *a4 < v5 )
  {
    ...
    do
    {
      v12 = 4096LL - *(_QWORD *)(*((_QWORD *)*v11 + 17) + 40LL);
      v19 = v12;
      if ( v12 < 0x14 )
      {
      ...
      if ( v5 - v7 >= v14 )
        v13 = v14;
      v20 = 0LL;
      if ( !DirectComposition::CBatch::EnsureBatchBuffer(v11, (unsigned int)(4 * v13 + 16), &v20) )
        break;
      v15 = (char *)v20;
      v16 = 0LL;
      *(_DWORD *)v20 = 4 * v13 + 16;
