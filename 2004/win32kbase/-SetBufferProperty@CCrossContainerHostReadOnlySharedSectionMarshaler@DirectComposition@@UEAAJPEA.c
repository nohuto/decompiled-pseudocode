/*
 * XREFs of ?SetBufferProperty@CCrossContainerHostReadOnlySharedSectionMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C01E5660
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DirectComposition::SetGuidProperty @ 0x1C01E56BC (DirectComposition--SetGuidProperty.c)
 */
