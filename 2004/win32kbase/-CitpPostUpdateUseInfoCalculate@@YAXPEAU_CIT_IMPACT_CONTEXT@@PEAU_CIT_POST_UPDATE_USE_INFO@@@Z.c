/*
 * XREFs of ?CitpPostUpdateUseInfoCalculate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_POST_UPDATE_USE_INFO@@@Z @ 0x1C00372B0
 * Callers:
...
void __fastcall CitpPostUpdateUseInfoCalculate(struct _CIT_IMPACT_CONTEXT *a1, struct _CIT_POST_UPDATE_USE_INFO *a2)
{
  ...
  *((_DWORD *)a2 + 9) += ((int)v4 - DWORD2(xmmword_1C02504C0)) / 0x3E8u;
  v10 = Citp100NSToMS(v6 - *((_QWORD *)&xmmword_1C02504B0 + 1) - v5);
