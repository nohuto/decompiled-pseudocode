/*
 * XREFs of rimExtractPointerDeviceUsages @ 0x1C017BC48
 * Callers:
 ...
 *     RIMEnsureUsageWithinLogicalBoundary @ 0x1C0179800 (RIMEnsureUsageWithinLogicalBoundary.c)
        ...
        _DWORD *a11)
{
  ...
  v21 = &WPP_fa968752f5ee31807da3aa7ca7449649_Traceguids;
    ...
    if ( (unsigned int)(v38 - 1) > 3 )
    {
      if ( (_DWORD)v38 != 7 )
      {
        if ( (unsigned int)(v38 - 5) > 1 )
        {
          ...
          MicrosoftTelemetryAssertTriggeredNoArgsKM(v38, v35, v36, v37);
        }
        else
        {
          v39 = a6;
          *(_DWORD *)(v13 + 64) = 3;
          rimExtractPenInfo(a1, v39, (_DWORD *)v13, v37);
        }
LABEL_53:
        ...
        if ( DigitizerPageButtonUsages >= 0 )
        {
          ...
          if ( (v41 & 8) != 0 && (v41 & 0x2000) == 0 )
          {
            ...
            LODWORD(a10) = 1;
            LOWORD(a9) = 0;
            if ( rimHidP_GetUsages(v40, 0xFF00u, v42, (unsigned __int16 *)&a9, (unsigned int *)&a10, a2, a3, v17) >= 0
              && (_DWORD)a10 == 1
              && (_WORD)a9 == 207 )
            {
              *a11 = 1;
...
LABEL_60:
  ...
  while ( 1 )
  {
    ...
    {
      DigitizerPageButtonUsages = rimHidP_GetUsageValueArray(v24, 1u, v27, v26, &v47, v44, v14, a3, v17);
      if ( DigitizerPageButtonUsages < 0 )
      {
        if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          return (unsigned int)DigitizerPageButtonUsages;
    ...
    v29 = (_DWORD *)(v12 + 52);
    UsageValue = rimHidP_GetUsageValue(HidP_Input, *(_WORD *)v12, v27, v26, (unsigned int *)(v12 + 52), v14, a3, v48);
    v16 = 0LL;
      ...
      if ( *v29 < *(_DWORD *)(v12 + 32) || *v29 > *(_DWORD *)(v12 + 36) )
      {
        if ( *(_WORD *)v12 == 1 && v28 && *(_DWORD *)(a1 + 24) == 5 )
        {
          ...
          else
          {
            if ( v31 != 49 )
            {
              MicrosoftTelemetryAssertTriggeredNoArgsKM(49LL, v15, v21, a4);
              v16 = 0LL;
            }
            v32 = a10;
          }
...
LABEL_34:
    ...
    if ( v25 >= *(_DWORD *)(a1 + 724) )
    {
      if ( DigitizerPageButtonUsages < 0 )
      {
        MicrosoftTelemetryAssertTriggeredNoArgsKM(1LL, v15, v21, a4);
        v16 = 0LL;
      }
      goto LABEL_43;
    }
