/*
 * XREFs of RIMIDECreatePseudoMouseOrKeyboardDevice @ 0x1C016A5C0
 * Callers:
...
__int64 __fastcall RIMIDECreatePseudoMouseOrKeyboardDevice(__int64 a1, __int64 *a2, __int64 a3, __int64 a4)
{
  ...
  UNICODE_STRING v17; // [rsp+48h] [rbp-B8h] BYREF
  ...
  *(_QWORD *)&v17.Length = 0x1000000LL;
  ...
  Object = 0LL;
  ReferencedRimObj = RIMIDECreateDeviceInstancePath(v5, 0LL);
