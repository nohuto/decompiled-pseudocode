/*
 * XREFs of ?InitializeSecurityDescriptor@RegistrarClient@CoreMessagingK@@CAJPEAU_SECURITY_DESCRIPTOR@@@Z @ 0x1C0048FF8
 * Callers:
        ...
        PSECURITY_DESCRIPTOR SecurityDescriptor)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    if ( v5 >= 0 )
    {
      v5 = RtlAddAccessAllowedAce(v4, 2u, 1u, &unk_1C020A168);
      if ( v5 >= 0 )
      {
