/*
 * XREFs of ?Free@?$CTypeIsolation@$0KAAA@$0KA@@NSInstrumentation@@IEAAXPEAX@Z @ 0x1C011AB70
 * Callers:
 *     ?HMFreeIsolatedType@@YAXEPEAX@Z @ 0x1C00991D4 (-HMFreeIsolatedType@@YAXEPEAX@Z.c)
 *     ?FreeBrushMemory@@YAXPEAVBRUSH@@@Z @ 0x1C00C0CAC (-FreeBrushMemory@@YAXPEAVBRUSH@@@Z.c)
 * Callees:
 ...
 *     ?CheckAllocationStatus@?$CSectionBitmapAllocator@$0KAAA@$0KA@@NSInstrumentation@@QEAA?AW4AllocationStatus@2@PEBX@Z @ 0x1C003CBA4 (-CheckAllocationStatus@-$CSectionBitmapAllocator@$0KAAA@$0KA@@NSInstrumentation@@QEAA-AW4Allocat.c)
