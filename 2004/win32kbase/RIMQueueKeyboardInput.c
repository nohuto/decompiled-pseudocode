/*
 * XREFs of RIMQueueKeyboardInput @ 0x1C016C4E0
 * Callers:
...
__int64 __fastcall RIMQueueKeyboardInput(struct RawInputManagerObject *a1, struct RIMDEV *a2, __int64 *a3, __int64 a4)
{
  int v4; // eax
  unsigned int v5; // esi
  __int64 v6; // rdi
