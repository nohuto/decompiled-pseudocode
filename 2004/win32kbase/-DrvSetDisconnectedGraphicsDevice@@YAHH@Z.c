/*
 * XREFs of ?DrvSetDisconnectedGraphicsDevice@@YAHH@Z @ 0x1C00B5770
 * Callers:
...
__int64 __fastcall DrvSetDisconnectedGraphicsDevice(int a1)
{
  ...
  *((_DWORD *)v4 + 54) = 0;
  *((_QWORD *)v4 + 28) = 0LL;
  RegistryHandleFromDeviceMap = (WCHAR *)DrvGetRegistryHandleFromDeviceMap((unsigned __int16 *)v4, 0, 0LL, 0LL, 0, &v10);
