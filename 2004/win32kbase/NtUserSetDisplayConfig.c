/*
 * XREFs of NtUserSetDisplayConfig @ 0x1C0137F00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_62:
  ...
  {
    v10 = *(_QWORD *)(*((_QWORD *)gptiCurrent + 52) + 768LL);
  ...
  if ( v17 || !CheckAccessEx((int *)(*((_QWORD *)gptiCurrent + 52) + 880LL), v34, 0) )
  {
    v9 = -1073741790;
    v13 = -2147483647;
    v14 = a3;
  ...
  else
  {
    ...
    if ( (_DWORD)v7 )
    {
      ...
      if ( v20 )
      {
        ...
        if ( qword_1C0251EC0 )
          ((void (__fastcall *)(__int64, __int128 *, void (__fastcall *)(__int64)))qword_1C0251EC0)(
            v22,
            &v38,
            Win32FreePool);
      }
...
LABEL_63:
  if ( v9 >= 0 )
  {
    v24 = qword_1C0252B60 ? qword_1C0252B60(v10, v16, v11, v12) : -1073741637;
    if ( v24 >= 0 && qword_1C0252B68 )
      qword_1C0252B68();
  }
  if ( v29 && qword_1C0251FE8 )
    qword_1C0251FE8(&v38);
