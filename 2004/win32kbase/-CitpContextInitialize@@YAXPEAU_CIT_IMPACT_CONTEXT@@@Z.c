/*
 * XREFs of ?CitpContextInitialize@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C00354FC
 * Callers:
 *     ?CitpStart@@YAJXZ @ 0x1C00353FC (-CitpStart@@YAJXZ.c)
 * Callees:
 *     ?CitpContextResetTrackingValues@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z @ 0x1C0035624 (-CitpContextResetTrackingValues@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z.c)
...
void __fastcall CitpContextInitialize(struct _CIT_IMPACT_CONTEXT *a1)
{
  ...
  *((_DWORD *)a1 + 50) = 1;
  *((_BYTE *)a1 + 112) = v3;
  CIT_USER_ACTIVITY_STAT::SetActive((struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 220), 1u);
  *((_DWORD *)a1 + 58) = v2;
  *((_DWORD *)a1 + 59) = v2;
