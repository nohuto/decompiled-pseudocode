/*
 * XREFs of DrvDisplayConfigSetScaleFactorOverride @ 0x1C014AA80
 * Callers:
      ...
      if ( ((unsigned __int64)(v7 + 1) & 0xFFFFFFFFFFFFFFFBuLL) != 0 )
      {
        ...
        if ( (v8 & 0x800000) != 0 )
        {
          ...
          if ( a2 )
          {
            if ( *a2 )
            {
              v10 = ((__int64 (__fastcall *)(_DWORD *, _QWORD, _QWORD, char *))qword_1C024CA88)(
                      v7 + 62,
                      (unsigned int)v7[64],
                      (unsigned int)a1[5],
                      v9);
            ...
            else if ( (v8 & 4) != 0 )
            {
              ...
              v15 = v7 + 62;
LABEL_18:
              LODWORD(v4) = ((__int64 (__fastcall *)(_DWORD *, __int64, _QWORD, char *))qword_1C024CA88)(
                              v15,
                              v14,
                              (unsigned int)a1[5],
                              v9);
