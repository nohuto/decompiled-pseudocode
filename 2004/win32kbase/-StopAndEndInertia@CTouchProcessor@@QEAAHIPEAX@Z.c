/*
 * XREFs of ?StopAndEndInertia@CTouchProcessor@@QEAAHIPEAX@Z @ 0x1C019C468
 * Callers:
...
LABEL_9:
  ...
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    ...
    LOBYTE(v11) = 2;
LABEL_14:
    WPP_RECORDER_SF_((_DWORD)DeviceExtension, v11, 7, v13, (__int64)&WPP_8113a81d21a7371434699e4b0bdc9bc8_Traceguids);
  }
LABEL_15:
  v8 = 0;
LABEL_16:
