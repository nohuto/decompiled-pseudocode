/*
 * XREFs of ?TrackObjectReferenceIncrement@@YAXW4ReferenceTrackerCountedType@@PEAX@Z @ 0x1C0086C54
 * Callers:
 ...
 *     ?TrackHmgrReferenceIncrement@@YAXEPEAVOBJECT@@@Z @ 0x1C0086C24 (-TrackHmgrReferenceIncrement@@YAXEPEAVOBJECT@@@Z.c)
 ...
 *     ?IncrementClientReferenceCount@PDEV@@QEAAXXZ @ 0x1C00A7EC0 (-IncrementClientReferenceCount@PDEV@@QEAAXXZ.c)
