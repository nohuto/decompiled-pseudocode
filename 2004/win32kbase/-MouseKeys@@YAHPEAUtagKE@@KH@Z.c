/*
 * XREFs of ?MouseKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C0183D90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MouseKeys(struct tagKE *a1)
{
  ...
  {
    if ( (dword_1C024BBA4 & 4) != 0 && v2 == gNumLockVk && (*((_WORD *)a1 + 1) & 0x8000) == 0 && v4 == 17 )
    {
  ...
  gMKPreviousVk = v2;
  return off_1C0206570[v5](word_1C0221DB0[v5]);
}
