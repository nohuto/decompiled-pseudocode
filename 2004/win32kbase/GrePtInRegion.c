/*
 * XREFs of GrePtInRegion @ 0x1C00320B0
 * Callers:
 *     NtGdiPtInRegion @ 0x1C0142F40 (NtGdiPtInRegion.c)
 * Callees:
 *     ?bInside@RGNOBJ@@QEAAHPEAU_POINTL@@@Z @ 0x1C0032130 (-bInside@RGNOBJ@@QEAAHPEAU_POINTL@@@Z.c)
