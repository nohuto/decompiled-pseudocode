/*
 * XREFs of ?vUnlockAndRelease@HANDLELOCK@@QEAAXXZ @ 0x1C00865B0
 * Callers:
...
void __fastcall HANDLELOCK::vUnlockAndRelease(HANDLELOCK *this)
{
  ...
  if ( (v2 & 0xFFFFFFFE) != 0 && v3 != -2147483630 )
  {
    ...
    if ( W32ProcessFromId )
    {
      GreAcquireHmgrSemaphore(v28, v27);
...
LABEL_40:
  ...
  if ( (Microsoft_Windows_Win32kEnableBits & 0x40000000000LL) != 0 )
  {
    ...
    McTemplateK0pqqq_EtwWriteTransfer(v35, (unsigned int)&GdiDestroyHandle, v36, *v34, EtwGdiHandleType);
    v4 = *(unsigned __int16 **)this;
  }
  *((_BYTE *)v4 + 14) = 0;
...
LABEL_44:
  ...
  if ( v21 )
  {
    v37 = *(_DWORD *)(v21 + 4LL * (unsigned __int16)v20);
    if ( v37 )
    {
      if ( GdiHandleEntryDirectory::AcquireEntryLock(*((GdiHandleEntryDirectory **)v14 + 2), v37, 1) )
        GdiHandleEntryDirectory::ReleaseLockAndEntry(*((GdiHandleEntryDirectory **)v14 + 2), v37, 1);
