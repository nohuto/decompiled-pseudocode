/*
 * XREFs of RIMTransferInjectionDeviceDataFifoToDataBuffer @ 0x1C016C760
 * Callers:
...
__int64 __fastcall RIMTransferInjectionDeviceDataFifoToDataBuffer(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !v6 )
  {
    ...
    if ( v8 )
    {
      ...
      {
        ++v9;
        v10 = 3LL * ((*(_BYTE *)(v5 + 924) - *(_BYTE *)(v5 + 920) + 1) & 0xF);
        v11 = 3LL * *(unsigned int *)(v5 + 916);
        *(_OWORD *)(v5 + 8 * v11 + 476) = *(_OWORD *)(v5
                                                    + 24LL * ((*(_BYTE *)(v5 + 924) - *(_BYTE *)(v5 + 920) + 1) & 0xF)
                                                    + 928);
        *(_QWORD *)(v5 + 8 * v11 + 492) = *(_QWORD *)(v5 + 8 * v10 + 944);
        LODWORD(v11) = *(_DWORD *)(v5 + 916);
        --*(_DWORD *)(v5 + 920);
        v12 = v11 + 1;
        *(_DWORD *)(v5 + 916) = v12;
      }
