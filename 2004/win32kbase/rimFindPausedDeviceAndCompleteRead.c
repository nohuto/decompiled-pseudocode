/*
 * XREFs of rimFindPausedDeviceAndCompleteRead @ 0x1C005B608
 * Callers:
        ...
        __int64 a4)
{
  ...
  while ( 1 )
  {
    ...
    if ( (struct RawInputManagerObject *)v9[53] != v4 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(a1, a2, a3, a4);
    if ( ((unsigned int)RimDeviceTypeToRimInputType((__int64)(v9 + 11), *((unsigned __int8 *)v9 + 136)) & *((_DWORD *)v4 + 21)) == 0 )
