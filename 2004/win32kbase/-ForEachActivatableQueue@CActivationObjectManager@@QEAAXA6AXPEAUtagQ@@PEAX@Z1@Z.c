/*
 * XREFs of ?ForEachActivatableQueue@CActivationObjectManager@@QEAAXA6AXPEAUtagQ@@PEAX@Z1@Z @ 0x1C012CBDC
 * Callers:
 *     MarkQueuesForKeyStateUpdate @ 0x1C01ABAB0 (MarkQueuesForKeyStateUpdate.c)
 * Callees:
 ...
 *     ?MarkQueuesForKeyStateUpdateWorker@KeyboardProcessing@@YAXPEAUtagQ@@QEAX@Z @ 0x1C01AB318 (-MarkQueuesForKeyStateUpdateWorker@KeyboardProcessing@@YAXPEAUtagQ@@QEAX@Z.c)
 */
