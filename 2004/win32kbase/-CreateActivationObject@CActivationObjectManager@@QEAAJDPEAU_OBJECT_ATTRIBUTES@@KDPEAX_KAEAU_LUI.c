/*
 * XREFs of ?CreateActivationObject@CActivationObjectManager@@QEAAJDPEAU_OBJECT_ATTRIBUTES@@KDPEAX_KAEAU_LUID@@@Z @ 0x1C0027D94
 * Callers:
        ...
        struct _LUID *a8)
{
  ...
  else if ( qword_1C0253A78 )
  {
    v10 = qword_1C0253A78(a6, &v19);
  }
  else
  {
    v10 = 0;
