/*
 * XREFs of ?SendNewIdentityCreated@CDeviceIdentity@@AEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C001A2E0
 * Callers:
 *     _lambda_fdb4fbfabcbae4b7f8e3309af96f3b1a_::_lambda_invoker_cdecl_ @ 0x1C001A290 (_lambda_fdb4fbfabcbae4b7f8e3309af96f3b1a_--_lambda_invoker_cdecl_.c)
...
void __fastcall CDeviceIdentity::SendNewIdentityCreated(CDeviceIdentity *this, struct RawInputManagerDeviceObject *a2)
{
  ...
  InputExtensibilityCallout::CoreMsgSendMessage(v2, 0LL, &v5, 24LL, v4);
}
