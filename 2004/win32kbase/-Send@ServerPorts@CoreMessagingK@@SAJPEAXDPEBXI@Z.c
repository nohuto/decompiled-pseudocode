/*
 * XREFs of ?Send@ServerPorts@CoreMessagingK@@SAJPEAXDPEBXI@Z @ 0x1C006A9C8
 * Callers:
...
__int64 __fastcall CoreMessagingK::ServerPorts::Send(void *a1, __int64 a2, void *a3, unsigned int a4)
{
  ...
  *(_QWORD *)v15 = v4[2];
  ...
  v16 = ZwAlpcSendWaitReceivePort(*(_QWORD *)v4[3], 0x10000LL, v6, 0LL);
  v10 = v16;
