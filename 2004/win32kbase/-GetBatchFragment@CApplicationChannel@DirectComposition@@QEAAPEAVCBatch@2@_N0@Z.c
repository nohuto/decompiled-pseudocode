/*
 * XREFs of ?GetBatchFragment@CApplicationChannel@DirectComposition@@QEAAPEAVCBatch@2@_N0@Z @ 0x1C009C55C
 * Callers:
 ...
 *     ?SubmitDwmBatch@CDwmChannel@DirectComposition@@QEAAX_KPEBUSynchronizationObject@2@@Z @ 0x1C009C2AC (-SubmitDwmBatch@CDwmChannel@DirectComposition@@QEAAX_KPEBUSynchronizationObject@2@@Z.c)
 ...
 *     ?BeginDynamicAllocation@CBatchSharedMemoryPool@DirectComposition@@QEAA_N_KPEA_K@Z @ 0x1C00A2FF8 (-BeginDynamicAllocation@CBatchSharedMemoryPool@DirectComposition@@QEAA_N_KPEA_K@Z.c)
        ...
        char a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v8 )
      break;
    --*((_DWORD *)this + 57);
    v21 = *((_QWORD *)&v8[4].Next + 1);
    if ( v21 > *((_QWORD *)this + 29) )
    {
      *((_BYTE *)this + 240) |= 2u;
      *((_QWORD *)this + 29) = v21;
    }
        ...
        if ( v15 <= 4096 - v16 )
        {
          *((_BYTE *)v14 + 64) = 1;
          ...
          if ( v17 == (DirectComposition::CBatchSharedMemoryPool **)v11 )
            goto LABEL_10;
          v23 = *(DirectComposition::CBatchSharedMemoryPool **)v14;
...
LABEL_49:
                ...
                &v29) >= 0 )
    {
      ...
      v25 = *(DirectComposition::CBatchSharedMemoryPool **)v11;
      if ( *(DirectComposition::CBatchSharedMemoryPool **)(*(_QWORD *)v11 + 8LL) != v11 )
        goto LABEL_49;
      v16 = v26[0];
      *(_QWORD *)v14 = v25;
...
LABEL_10:
  if ( v14 )
  {
    ...
    else
    {
      do
      {
        v22 = DirectComposition::CApplicationChannel::CreateBatch(this, &v27);
        if ( v22 < 0
          && *((int *)this + 57) > 0
          && DirectComposition::CApplicationChannel::WaitForPendingAndProcessReturnedBatches(this, 0, 0) )
        {
