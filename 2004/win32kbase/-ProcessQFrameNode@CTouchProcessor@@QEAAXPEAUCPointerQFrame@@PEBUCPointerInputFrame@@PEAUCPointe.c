/*
 * XREFs of ?ProcessQFrameNode@CTouchProcessor@@QEAAXPEAUCPointerQFrame@@PEBUCPointerInputFrame@@PEAUCPointerInfoNode@@@Z @ 0x1C0198480
 * Callers:
        ...
        struct CPointerInfoNode *a4)
{
  ...
  v8 = &WPP_8113a81d21a7371434699e4b0bdc9bc8_Traceguids;
