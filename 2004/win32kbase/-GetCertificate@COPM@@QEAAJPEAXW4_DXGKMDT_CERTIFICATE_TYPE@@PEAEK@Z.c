/*
 * XREFs of ?GetCertificate@COPM@@QEAAJPEAXW4_DXGKMDT_CERTIFICATE_TYPE@@PEAEK@Z @ 0x1C00C6730
 * Callers:
 *     NtGdiGetCertificateByHandle @ 0x1C00C64D0 (NtGdiGetCertificateByHandle.c)
 * Callees:
