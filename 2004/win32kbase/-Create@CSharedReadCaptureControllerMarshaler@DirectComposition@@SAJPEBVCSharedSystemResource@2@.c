/*
 * XREFs of ?Create@CSharedReadCaptureControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F51A0
 * Callers:
 *     CreateSharedReadCaptureControllerMarshaler @ 0x1C01F5360 (CreateSharedReadCaptureControllerMarshaler.c)
 * Callees:
