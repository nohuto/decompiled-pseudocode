/*
 * XREFs of ?Dispatch@IOCPDispatcher@@QEAAXW4WaitCompletionPacketPurpose@@K@Z @ 0x1C0078970
 * Callers:
...
void __fastcall IOCPDispatcher::Dispatch(IOCPDispatcher *a1, int a2, __int64 a3)
{
  if ( a2 == 1 )
  {
    IOCPDispatcher::HandleSensorDispatcherSignal(a1, (unsigned int)a3, a3, 0LL);
  }
  else if ( a2 == 2 )
  {
