/*
 * XREFs of ?EmitSetClearCommand@CParticleEmitterVisualMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01D3824
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( (*((_DWORD *)this + 136) & 0x2000000) == 0 )
    return 1;
  v5 = 0LL;
