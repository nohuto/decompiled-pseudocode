/*
 * XREFs of CoreMsgInitialize @ 0x1C0047E8C
 * Callers:
 ...
 *     ?Initialize@EntryLock@CoreMessagingK@@SAJXZ @ 0x1C00492E4 (-Initialize@EntryLock@CoreMessagingK@@SAJXZ.c)
...
__int64 CoreMsgInitialize()
{
  ...
  TraceLoggingRegisterEx_EtwRegister_EtwSetInformation(&dword_1C0245450);
  if ( (unsigned int)dword_1C0245450 > 5 )
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0245450, (unsigned __int8 *)dword_1C021DED5, 0LL, 0LL, 2u, &v3);
  ...
  if ( (unsigned int)dword_1C0245450 > 5 )
  {
    ...
    v2 = v0;
    v5 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0245450, (unsigned __int8 *)dword_1C021DE4D, 0LL, 0LL, 3u, &v3);
  }
