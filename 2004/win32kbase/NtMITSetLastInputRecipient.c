/*
 * XREFs of NtMITSetLastInputRecipient @ 0x1C01304E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtMITSetLastInputRecipient(__int64 a1)
{
  ...
  if ( v23 == v22 )
  {
    v30 = (struct tagTHREADINFO *)PtiFromThreadId(v1);
    if ( v30 )
    {
      CInputGlobals::SetPtiLastWoken(gpInputGlobals, v30, 0);
      v2 = 1LL;
      goto LABEL_40;
    }
    v25 = 87LL;
