/*
 * XREFs of ?CapturePointer@CApplicationChannel@DirectComposition@@QEAAJIW4CapturePointerType@@I_K@Z @ 0x1C01D0E88
 * Callers:
 ...
 *     ?OwnsPointerId@CInputManager@@SA_NII@Z @ 0x1C01F62DC (-OwnsPointerId@CInputManager@@SA_NII@Z.c)
 */
