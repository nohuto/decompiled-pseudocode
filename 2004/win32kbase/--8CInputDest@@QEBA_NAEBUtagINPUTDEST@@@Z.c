/*
 * XREFs of ??8CInputDest@@QEBA_NAEBUtagINPUTDEST@@@Z @ 0x1C007471C
 * Callers:
 ...
 *     ?HasForeground@CForegroundInfo@@QEAA_NAEBVCInputDest@@@Z @ 0x1C01A06E0 (-HasForeground@CForegroundInfo@@QEAA_NAEBVCInputDest@@@Z.c)
