/*
 * XREFs of ?ReportRimDevice@RimTelemetry@@SAXHHQEAURIMDEV@@@Z @ 0x1C00559F0
 * Callers:
...
void __fastcall RimTelemetry::ReportRimDevice(int a1, int a2, struct RIMDEV *const a3)
{
  ...
  v5 = 0;
  v30 = 0;
  v40 = (unsigned __int16 *)RimDeviceTypeToRimInputTypeString(a3, *((unsigned __int8 *)a3 + 48));
  ...
  if ( v5 < 0xFF00u )
  {
    if ( v7 )
    {
      if ( (unsigned int)dword_1C0245170 > 5
        && (unsigned __int8)tlgKeywordOn(&dword_1C0245170, 0x800000000000LL, v13, v14) )
      {
        v24 = &unk_1C021551A;
        v48 = v36;
        v49 = (char *)a3 + 2104;
...
LABEL_24:
    ...
    else if ( (unsigned int)dword_1C0245170 > 5
           && (unsigned __int8)tlgKeywordOn(&dword_1C0245170, 0x800000000000LL, v13, v14) )
    {
      v24 = &unk_1C0215107;
      v54 = v36;
