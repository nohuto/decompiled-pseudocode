/*
 * XREFs of ?TraceLoggingPTPSettingsConfigEvent@@YAXPEAUtagTPSETTINGS@@KHPEAG1HHUtagRECT@@2@Z @ 0x1C01A4A4C
 * Callers:
        ...
        struct tagRECT *a9)
{
  ...
  if ( (unsigned int)dword_1C0245170 > 5 && tlgKeywordOn((__int64)&dword_1C0245170, 0x800000000000LL) )
  {
    v28 = 2048LL;
    v30 = v10;
    v19 = v9;
