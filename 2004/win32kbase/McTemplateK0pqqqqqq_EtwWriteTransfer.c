/*
 * XREFs of McTemplateK0pqqqqqq_EtwWriteTransfer @ 0x1C01502B4
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C0030B50 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C0045ED0 (EtwDevLockEndTightUpdate.c)
 * Callees:
