/*
 * XREFs of ?SetDisplayConfigHandleBrokerProvidedPaths@@YAJPEAX_NIPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@PEAPEAUD3DKMT_GETPATHSMODALITY@@PEA_NPEAW4_DXGK_DIAG_SDC_STAGE@@@Z @ 0x1C01495C8
 * Callers:
 ...
 *     _SetDisplayConfigHandleBrokerProvidedPaths_::_2_::_AUTO_USING_PM_VirtualTopologyButNotVirtualModePath14135::__AUTO_USING_PM_VirtualTopologyButNotVirtualModePath14135 @ 0x1C01466A8 (_SetDisplayConfigHandleBrokerProvidedPaths_--_2_--_AUTO_USING_PM_VirtualTopologyButNotVirtualMod.c)
 *     ?ConvertDisplayConfigPathIntoExistingPathModalityAtIdx@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@@II_N1PEAUD3DKMT_GETPATHSMODALITY@@PEA_N@Z @ 0x1C01468F0 (-ConvertDisplayConfigPathIntoExistingPathModalityAtIdx@@YAJPEBUDISPLAYCONFIG_PATH_INFO_INTERNAL@.c)
 */
        ...
        enum _DXGK_DIAG_SDC_STAGE *a7)
{
  ...
  __int64 v45; // rax
  __int64 v46; // rax
  struct D3DKMT_GETPATHSMODALITY *v48; // [rsp+40h] [rbp-20h]
  struct D3DKMT_GETPATHSMODALITY *v49; // [rsp+48h] [rbp-18h] BYREF
  ...
  if ( !a2 )
  {
    PathsModality = GetPathsModality(a1, &v49, 16777280LL, 0);
    if ( PathsModality < 0 )
    {
      *(_DWORD *)a7 = 44;
      goto LABEL_66;
      ...
      *((_WORD *)v11 + 10) = 0;
      ...
      if ( *((_WORD *)v49 + 10) )
      {
        do
        {
          ...
          if ( !(unsigned __int8)((__int64 (__fastcall *)(__int64, _QWORD, _QWORD))qword_1C024CB20)(
                                   a1,
                                   *(_QWORD *)(v16 + 16),
                                   *(unsigned int *)(v16 + 28)) )
          {
...
LABEL_38:
  ...
  *(_DWORD *)a7 = 48;
LABEL_65:
  SetDisplayConfigHandleBrokerProvidedPaths_::_2_::_AUTO_USING_PM_VirtualTopologyButNotVirtualModePath14135::__AUTO_USING_PM_VirtualTopologyButNotVirtualModePath14135(&v50);
LABEL_66:
  FreePathsModality(v49);
  FreePathsModality(v48);
