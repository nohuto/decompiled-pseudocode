/*
 * XREFs of ?ReadLayoutFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@PEAXII@Z @ 0x1C0041E08
 * Callers:
 ...
 *     strcmp_0 @ 0x1C00D29B1 (strcmp_0.c)
...
LABEL_126:
                                if ( a4 )
                                {
                                  ...
                                  v78 = qword_1C0253378 ? qword_1C0253378() : -1073741637;
                                  if ( v78 >= 0 && !(qword_1C0253380 ? qword_1C0253380(v6) : 0) )
                                    break;
                                  *((_QWORD *)a1 + 6) = v6;
                                }
                                if ( v30 )
