/*
 * XREFs of ?DestroyAllHandlesFromAdapter@?$CMonitorHandleTable@VCOPMProtectedOutput@@PEAX@OPM@@QEAAXPEAU_LUID@@PEAVCMutex@2@@Z @ 0x1C0034244
 * Callers:
 *     OPMDestroyAllProtectedOutputs @ 0x1C00341F0 (OPMDestroyAllProtectedOutputs.c)
