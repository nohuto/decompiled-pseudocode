/*
 * XREFs of PowerIsDisplayIdleExpired @ 0x1C0031C20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z @ 0x1C0031E70 (-IsTimeFromLastInputEvent@CInputGlobals@@QEBA_NK@Z.c)
 *     PowerIsDisplayBurstActive @ 0x1C0120F40 (PowerIsDisplayBurstActive.c)
...
_BOOL8 __fastcall PowerIsDisplayIdleExpired(int a1, int *a2)
{
  ...
  v6 = 0;
  if ( CInputGlobals::GetGlobalTickCount(gpInputGlobals, 0LL) < (unsigned __int64)qword_1C024D118 )
  {
