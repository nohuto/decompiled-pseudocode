/*
 * XREFs of rimExtractTransducerUsages @ 0x1C0179474
 * Callers:
...
__int64 __fastcall rimExtractTransducerUsages(__int64 a1, unsigned __int16 a2, char *a3, unsigned int a4, __int64 a5)
{
  ...
  if ( !*(_DWORD *)(a5 + 2828) )
  {
    ...
    if ( UsageValue >= 0 && *v8 && (*v8 != dword_1C0254520 || *(_DWORD *)(v5 + 2472) % 0x64u < 2) )
    {
      LODWORD(v15) = *v8;
      if ( (unsigned int)dword_1C0245250 > 5 && tlgKeywordOn((__int64)&dword_1C0245250, 0x800000000000LL) )
      {
        v19 = *(_DWORD *)v10;
        v23 = *(_DWORD *)(v5 + 48);
        LOBYTE(v6) = v18 >= 0;
