/*
 * XREFs of McTemplateK0pppqqqqpppqqqq_EtwWriteTransfer @ 0x1C012AB08
 * Callers:
 *     EtwTraceWindowRenderingOldToNewRedirectionBitmap @ 0x1C005B3B0 (EtwTraceWindowRenderingOldToNewRedirectionBitmap.c)
 *     EtwWindowRendering @ 0x1C0150200 (EtwWindowRendering.c)
 * Callees:
