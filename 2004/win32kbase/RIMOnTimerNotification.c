/*
 * XREFs of RIMOnTimerNotification @ 0x1C015A8D0
 * Callers:
 *     NtRIMOnTimerNotification @ 0x1C0156B40 (NtRIMOnTimerNotification.c)
 *     ?OnAutoRepeatTimerNotification@CBaseInput@@AEAAJXZ @ 0x1C01A0DC0 (-OnAutoRepeatTimerNotification@CBaseInput@@AEAAJXZ.c)
 *     ?OnTimerNotification@CBaseInput@@AEAAJXZ @ 0x1C01A1610 (-OnTimerNotification@CBaseInput@@AEAAJXZ.c)
 * Callees:
