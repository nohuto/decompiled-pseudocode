/*
 * XREFs of DrvSetDisplayConfigValidateParams @ 0x1C00D3C30
 * Callers:
 ...
 *     _stricmp @ 0x1C00CCF68 (_stricmp.c)
        ...
        char a5)
{
  ...
  unsigned __int8 v22; // [rsp+51h] [rbp-1E7h] BYREF
  char v23; // [rsp+52h] [rbp-1E6h]
  unsigned int j; // [rsp+54h] [rbp-1E4h]
  unsigned int k; // [rsp+58h] [rbp-1E0h]
  unsigned int i; // [rsp+5Ch] [rbp-1DCh]
  char v27; // [rsp+60h] [rbp-1D8h]
  char v28; // [rsp+61h] [rbp-1D7h]
  char v29; // [rsp+62h] [rbp-1D6h]
  char v30; // [rsp+63h] [rbp-1D5h]
  char v31; // [rsp+64h] [rbp-1D4h]
  char v32; // [rsp+65h] [rbp-1D3h]
  char v33; // [rsp+66h] [rbp-1D2h]
  char v34; // [rsp+67h] [rbp-1D1h]
  char v35; // [rsp+68h] [rbp-1D0h]
  char v36; // [rsp+69h] [rbp-1CFh]
  char v37; // [rsp+6Ah] [rbp-1CEh]
  char v38; // [rsp+6Bh] [rbp-1CDh]
  char v39; // [rsp+6Ch] [rbp-1CCh]
  char v40; // [rsp+6Dh] [rbp-1CBh]
  char v41; // [rsp+6Eh] [rbp-1CAh]
  char v42; // [rsp+6Fh] [rbp-1C9h]
  char v43; // [rsp+70h] [rbp-1C8h]
  char v44; // [rsp+71h] [rbp-1C7h]
  char v45; // [rsp+72h] [rbp-1C6h]
  char v46; // [rsp+73h] [rbp-1C5h]
  char v47; // [rsp+74h] [rbp-1C4h]
  char v48; // [rsp+75h] [rbp-1C3h]
  char v49; // [rsp+76h] [rbp-1C2h]
  char v50; // [rsp+77h] [rbp-1C1h]
  char v51; // [rsp+78h] [rbp-1C0h]
  char v52; // [rsp+79h] [rbp-1BFh]
  char v53; // [rsp+7Ah] [rbp-1BEh]
  char v54; // [rsp+7Bh] [rbp-1BDh]
  char v55; // [rsp+7Ch] [rbp-1BCh]
  char v56; // [rsp+7Dh] [rbp-1BBh]
  char v57; // [rsp+7Eh] [rbp-1BAh]
  char v58; // [rsp+7Fh] [rbp-1B9h]
  char v59; // [rsp+80h] [rbp-1B8h]
  char v60; // [rsp+81h] [rbp-1B7h]
  char v61; // [rsp+82h] [rbp-1B6h]
  char v62; // [rsp+83h] [rbp-1B5h]
  char v63; // [rsp+84h] [rbp-1B4h]
  char v64; // [rsp+85h] [rbp-1B3h]
  char v65; // [rsp+86h] [rbp-1B2h]
  char v66; // [rsp+87h] [rbp-1B1h]
  char v67; // [rsp+88h] [rbp-1B0h]
  char v68; // [rsp+89h] [rbp-1AFh]
  char v69; // [rsp+8Ah] [rbp-1AEh]
  char v70; // [rsp+8Bh] [rbp-1ADh]
  char v71; // [rsp+8Ch] [rbp-1ACh]
  char v72; // [rsp+8Dh] [rbp-1ABh]
  char v73; // [rsp+8Eh] [rbp-1AAh]
  BOOL v74; // [rsp+90h] [rbp-1A8h]
  int v75; // [rsp+94h] [rbp-1A4h]
  int v76; // [rsp+98h] [rbp-1A0h]
  ...
  if ( (v128 & 0x10000) != 0 && ((v128 & 0x1F) != 0 || (v128 & 0x200) != 0) )
  {
    ...
    *(_QWORD *)(v114 + 24) = -1073741637LL;
    v28 = WdLogEvent5_WdError(v114);
    return 3221225659LL;
  }
  if ( (v128 & 0xC0000000) != 0 )
  {
    if ( (v128 & 0x80) != 0 )
    {
      if ( v128 == 1073741952 || v128 == -2147483520 )
      {
        ...
        {
          v84 = WdLogNewEntry5_WdError(v8, v7, v9);
          *(_QWORD *)(v84 + 24) = v128;
          *(_QWORD *)(v84 + 32) = -1073741581LL;
          v31 = WdLogEvent5_WdError(v84);
          return 3221225715LL;
        }
      }
      else
  ...
  else if ( (a4 & 1) != 0 )
  {
    ...
    else
    {
      ...
      *(_QWORD *)(v85 + 32) = -1073741581LL;
      v34 = WdLogEvent5_WdAssertion(v85);
      return 3221225715LL;
    }
  }
  else
  {
    if ( (a4 & 0x10) != 0 && (a4 & 8) == 0 )
    {
      ...
      *(_QWORD *)(v86 + 32) = -1073741581LL;
      v35 = WdLogEvent5_WdAssertion(v86);
      return 3221225715LL;
    }
    if ( (a4 & 8) != 0 && v126 != 1 )
    {
    ...
    {
      v87 = WdLogNewEntry5_WdAssertion(a1, a2, a3);
      *(_QWORD *)(v87 + 24) = v128;
      *(_QWORD *)(v87 + 32) = -1073741581LL;
      v37 = WdLogEvent5_WdAssertion(v87);
      return 3221225715LL;
    }
    ...
    if ( (v128 & 0x1F) != 0 )
    {
      ...
      if ( (v128 & 0x10) != 0 )
      {
        ...
        if ( !a2 )
        {
          ...
          *(_QWORD *)(v98 + 24) = v128;
          *(_QWORD *)(v98 + 32) = -1073741584LL;
          v48 = WdLogEvent5_WdError(v98);
          return 3221225712LL;
        }
        if ( !v126 )
        {
          ...
          *(_QWORD *)(v99 + 24) = v128;
          *(_QWORD *)(v99 + 32) = -1073741585LL;
          v49 = WdLogEvent5_WdError(v99);
          return 3221225711LL;
        }
        for ( i = 0; i < v126; ++i )
        {
    ...
    else
    {
      ...
      if ( (v128 & 0x10000) == 0 )
      {
        if ( !a2 )
        {
          ...
          *(_QWORD *)(v104 + 32) = -1073741584LL;
          v55 = WdLogEvent5_WdError(v104);
          return 3221225712LL;
        }
        if ( !v126 )
        {
          v105 = WdLogNewEntry5_WdError(v11, v10, v12);
          *(_QWORD *)(v105 + 24) = v128;
          *(_QWORD *)(v105 + 32) = -1073741585LL;
          v56 = WdLogEvent5_WdError(v105);
          return 3221225711LL;
        }
      }
      if ( v126 )
      {
        ...
        for ( j = 0; j < v126; ++j )
        {
          ...
          {
            v106 = WdLogNewEntry5_WdError(v16, v13, v15);
            *(_QWORD *)(v106 + 24) = *(_QWORD *)v20;
            *(_QWORD *)(v106 + 32) = *((_QWORD *)v20 + 1);
            v59 = WdLogEvent5_WdError(v106);
            return 3221225485LL;
          }
          ...
          if ( *(__int64 *)v20 < 0 )
          {
            ...
            if ( (*(_QWORD *)v20 & 0x87LL) != 0 )
            {
              if ( (*(_QWORD *)v20 & 4LL) != 0 )
              {
                ...
                if ( v75 <= 0 || v75 > 3 )
                {
                  ...
                  *(_QWORD *)(v107 + 24) = *((int *)v20 + 19);
                  *(_QWORD *)(v107 + 32) = -1073741582LL;
                  v65 = WdLogEvent5_WdError(v107);
                  return 3221225714LL;
                }
              }
            ...
            if ( (*(_QWORD *)v20 & 0x800000LL) != 0 )
            {
              ...
              if ( (*(_QWORD *)v20 & 0x1000000000LL) == 0 )
              {
                ...
                if ( (*(_QWORD *)v20 & 0x100LL) == 0 )
                {
                  v109 = WdLogNewEntry5_WdError(0x1000000000LL, v13, v15);
                  *(_QWORD *)(v109 + 24) = j;
                ...
                {
                  v111 = WdLogNewEntry5_WdError(v14, v13, v15);
                  *(_QWORD *)(v111 + 24) = j;
