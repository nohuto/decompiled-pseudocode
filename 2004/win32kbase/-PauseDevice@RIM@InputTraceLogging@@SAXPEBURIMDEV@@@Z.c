/*
 * XREFs of ?PauseDevice@RIM@InputTraceLogging@@SAXPEBURIMDEV@@@Z @ 0x1C0175394
 * Callers:
...
void __fastcall InputTraceLogging::RIM::PauseDevice(const struct RIMDEV *a1)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 256LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0246A70, (unsigned __int8 *)dword_1C0217A12, 0LL, 0LL, 3u, &v3);
  }
}
