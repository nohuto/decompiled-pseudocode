/*
 * XREFs of ?BuildReportDescriptor@@YAHGGPEAUtagUSAGE_PROPERTIES@@KKPEAU_HIDP_DEVICE_DESC@@@Z @ 0x1C016CE20
 * Callers:
 ...
 *     ?BuildDeviceHeader@@YAHPEAEKPEAKGG@Z @ 0x1C016CA74 (-BuildDeviceHeader@@YAHPEAEKPEAKGG@Z.c)
