/*
 * XREFs of ?_CreateCompositionInputSink@@YAJPEBUCOMPOSITION_INPUT_SINK@@HPEAPEAX@Z @ 0x1C006BD78
 * Callers:
 *     NtCreateImplicitCompositionInputSink @ 0x1C0068C40 (NtCreateImplicitCompositionInputSink.c)
 *     NtCreateCompositionInputSink @ 0x1C006BAE0 (NtCreateCompositionInputSink.c)
 * Callees:
