/*
 * XREFs of ?Create@CSharedClientProjectedShadowCasterMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F5790
 * Callers:
 *     CreateSharedClientProjectedShadowCasterMarshaler @ 0x1C01F5980 (CreateSharedClientProjectedShadowCasterMarshaler.c)
 * Callees:
