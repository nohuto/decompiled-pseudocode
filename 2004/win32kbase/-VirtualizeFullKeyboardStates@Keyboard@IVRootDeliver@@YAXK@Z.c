/*
 * XREFs of ?VirtualizeFullKeyboardStates@Keyboard@IVRootDeliver@@YAXK@Z @ 0x1C01B9B50
 * Callers:
 *     VirtualizeFullKeyboardStates @ 0x1C01AC4A0 (VirtualizeFullKeyboardStates.c)
 * Callees:
