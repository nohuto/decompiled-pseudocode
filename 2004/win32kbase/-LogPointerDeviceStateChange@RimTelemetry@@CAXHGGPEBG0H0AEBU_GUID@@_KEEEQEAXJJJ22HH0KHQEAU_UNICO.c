/*
 * XREFs of ?LogPointerDeviceStateChange@RimTelemetry@@CAXHGGPEBG0H0AEBU_GUID@@_KEEEQEAXJJJ22HH0KHQEAU_UNICODE_STRING@@400AEBUtagRECT@@5@Z @ 0x1C0152A84
 * Callers:
        ...
        const struct tagRECT *a29)
{
  ...
  else if ( (unsigned int)dword_1C0245170 > 5 && tlgKeywordOn((__int64)&dword_1C0245170, 0x800000000000LL) )
  {
    v63 = 2048LL;
    v50 = (__int64)v33;
    v38[0] = v32;
