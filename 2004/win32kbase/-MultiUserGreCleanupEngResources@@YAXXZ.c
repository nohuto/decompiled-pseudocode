/*
 * XREFs of ?MultiUserGreCleanupEngResources@@YAXXZ @ 0x1C002213C
 * Callers:
 *     MultiUserNtGreCleanup @ 0x1C00214C8 (MultiUserNtGreCleanup.c)
 * Callees:
 *     EngFreeMem @ 0x1C0022210 (EngFreeMem.c)
 *     GreDeleteSemaphoreNonTracked @ 0x1C00222F0 (GreDeleteSemaphoreNonTracked.c)
  ...
  if ( GreEngLoadModuleAllocListLock )
  {
    while ( GreEngLoadModuleAllocList.Flink != &GreEngLoadModuleAllocList )
    {
      ...
      if ( qword_1C0251410 )
        ...
        v5 = -1073741637;
      if ( v5 >= 0 && qword_1C0251418 )
        qword_1C0251418(&GreEngLoadModuleAllocList.Flink[1].Blink);
    }
  }
