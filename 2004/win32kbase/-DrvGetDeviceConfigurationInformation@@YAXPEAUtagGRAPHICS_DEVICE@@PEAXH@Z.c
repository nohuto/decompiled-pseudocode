/*
 * XREFs of ?DrvGetDeviceConfigurationInformation@@YAXPEAUtagGRAPHICS_DEVICE@@PEAXH@Z @ 0x1C00B2A14
 * Callers:
...
void __fastcall DrvGetDeviceConfigurationInformation(__int64 *Context, WCHAR *Path, int a3)
{
  ...
  __int64 (__fastcall *v64)(unsigned __int16 *, __int64, void *, unsigned int, _QWORD *); // [rsp+128h] [rbp+28h] BYREF
  ...
  __int64 (__fastcall *v105)(unsigned __int16 *, int, void *, unsigned int, _QWORD *); // [rsp+2B8h] [rbp+1B8h]
  ...
  __int64 (__fastcall *v112)(unsigned __int16 *, int, void *, unsigned int, _QWORD *); // [rsp+2F0h] [rbp+1F0h]
  ...
  __int64 (__fastcall *v119)(unsigned __int16 *, int, void *, unsigned int, _QWORD *); // [rsp+328h] [rbp+228h]
  ...
  __int64 (__fastcall *v139)(unsigned __int16 *, __int64, void *, unsigned int, _QWORD *); // [rsp+408h] [rbp+308h]
  ...
  if ( !v4 && !*((_DWORD *)Context + 67) )
  {
    ...
    if ( RegistryValues == -1073741789 )
    {
        ...
        if ( RegistryValues >= 0 )
        {
          ...
          if ( *v12 >> 1 )
          {
            ...
            if ( v16 )
            {
              ...
              v54 = aVideo[6];
              v62 = *(_QWORD *)L"\\Video";
              v11 = (char *)PALLOCMEM2(2 * v16 + 14, 0x73726447u, 0);
              if ( v11 )
              {
      ...
      if ( v11 )
      {
        ...
        v63.QueryRoutine = (PRTL_QUERY_REGISTRY_ROUTINE)__EnumDisplayQueryRoutine;
        v63.DefaultType = 0;
        ...
        *(_OWORD *)Src = 0LL;
        ...
        if ( RegistryValues >= 0 )
        {
          ...
          if ( LOWORD(Src[0]) )
          {
            ...
            v62 = *(_QWORD *)L"Class\\";
            v27 = (WCHAR *)PALLOCMEM2((unsigned int)LOWORD(Src[0]) + 14, 0x73726447u, 0);
            v28 = v27;
            if ( v27 )
            {
              *(_QWORD *)v27 = v62;
...
LABEL_71:
                v37 = v33 + 2 * (1 - v3);
                v38 = PALLOCMEM2(v37, 0x73726447u, 0);
                v39 = (__int64)v38;
                if ( v38 )
                {
...
LABEL_84:
    ...
    v42 = PALLOCMEM2(v22, 0x73726447u, 0);
  ...
  {
    Win32FreePool(Context[26]);
    v44 = PALLOCMEM2(LODWORD(Length[1]), 0x73726447u, 0);
