/*
 * XREFs of ?vCreate@RGNMEMOBJ@@QEAAXAEAVEPATHOBJ@@KPEAU_RECTL@@@Z @ 0x1C009A120
 * Callers:
 ...
 * Callees:
 *     ?bFlatten@EPATHOBJ@@QEAAHXZ @ 0x1C002A460 (-bFlatten@EPATHOBJ@@QEAAHXZ.c)
 ...
 *     ?vCloseAllFigures@EPATHOBJ@@QEAAXXZ @ 0x1C009A7E0 (-vCloseAllFigures@EPATHOBJ@@QEAAXXZ.c)
 *     ?bAddNullScan@RGNMEMOBJ@@AEAAHJJ@Z @ 0x1C00C3244 (-bAddNullScan@RGNMEMOBJ@@AEAAHJJ@Z.c)
 *     bConstructGET @ 0x1C00C4860 (bConstructGET.c)
 *     vAdvanceAETEdges @ 0x1C00C4B90 (vAdvanceAETEdges.c)
 *     vXSortAETEdges @ 0x1C00C53F0 (vXSortAETEdges.c)
 *     vMoveNewEdges @ 0x1C00C5BE0 (vMoveNewEdges.c)
