/*
 * XREFs of ApiSetEditionPostRawMouseInputMessage @ 0x1C0069444
 * Callers:
        ...
        __int64 a5)
{
  ...
  v9 = 0;
  if ( (int)IsEditionPostRawMouseInputMessageSupported() >= 0 && qword_1C0253840 )
    v9 = qword_1C0253840(a1, v7, a3, a4, a5);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(v10) = 5;
    WPP_RECORDER_SF_(
