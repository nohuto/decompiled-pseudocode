/*
 * XREFs of ?Win32kNtUserCleanupInternal@@YAXXZ @ 0x1C0020D6C
 * Callers:
...
void Win32kNtUserCleanupInternal(void)
{
  ...
  if ( v11 >= 0 )
  {
    if ( qword_1C0251AA8 )
    {
      qword_1C0251AA8(&gWndsMonitorSnapshotHead);
      if ( qword_1C0251AA8 )
    ...
    if ( gsmsList )
    {
      while ( 1 )
      {
        ...
        *(_QWORD *)(v26 + 8) = &gsmsList;
        if ( qword_1C0251AE8 )
          qword_1C0251AE8(v15, 0LL);
      }
    }
    qword_1C024EB20 = (__int64)&gsmsList;
    gsmsList = &gsmsList;
  }
  if ( qword_1C0251AF0 )
    v16 = qword_1C0251AF0();
  ...
  if ( qword_1C02509E8 )
  {
    if ( (int)IsFreeMessageListSupported() >= 0 && qword_1C0252048 )
      qword_1C0252048(qword_1C02509E8 + 24);
    Win32FreeToPagedLookasideList(QLookaside, qword_1C02509E8);
    qword_1C02509E8 = 0LL;
  }
  if ( QLookaside )
  {
