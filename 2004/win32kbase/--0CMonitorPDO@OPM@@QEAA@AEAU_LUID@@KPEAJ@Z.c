/*
 * XREFs of ??0CMonitorPDO@OPM@@QEAA@AEAU_LUID@@KPEAJ@Z @ 0x1C00C79C0
 * Callers:
 *     ??0COPMProtectedOutput@@QEAA@W4_DXGKMDT_OPM_VIDEO_OUTPUT_SEMANTICS@@AEAU_LUID@@KPEAJ@Z @ 0x1C00C7808 (--0COPMProtectedOutput@@QEAA@W4_DXGKMDT_OPM_VIDEO_OUTPUT_SEMANTICS@@AEAU_LUID@@KPEAJ@Z.c)
 * Callees:
 *     ?Lock@CMutex@OPM@@QEAAXXZ @ 0x1C0034370 (-Lock@CMutex@OPM@@QEAAXXZ.c)
 *     ??0CMutex@OPM@@QEAA@PEAJ@Z @ 0x1C0058920 (--0CMutex@OPM@@QEAA@PEAJ@Z.c)
        ...
        int *a4)
{
  ...
  *((_QWORD *)this + 1) = v11;
  ...
  DeviceInterfaces = ((__int64 (__fastcall *)(struct _LUID *, _QWORD, PVOID *, PVOID *))qword_1C024C9E8)(
                       a2,
                       v18,
                       &EventCategoryData,
                       v4);
