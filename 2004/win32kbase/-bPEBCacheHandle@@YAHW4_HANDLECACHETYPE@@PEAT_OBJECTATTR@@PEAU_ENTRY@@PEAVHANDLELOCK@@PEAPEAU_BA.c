/*
 * XREFs of ?bPEBCacheHandle@@YAHW4_HANDLECACHETYPE@@PEAT_OBJECTATTR@@PEAU_ENTRY@@PEAVHANDLELOCK@@PEAPEAU_BASEOBJECT@@@Z @ 0x1C00932A0
 * Callers:
 ...
 *     EtwTraceGdiTransformHandle @ 0x1C00159BC (EtwTraceGdiTransformHandle.c)
