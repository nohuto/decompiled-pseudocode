/*
 * XREFs of ?xxxDispBrokerChangeDisplaySettings@@YAJPEBU_UNICODE_STRING@@PEAU_devicemodeW@@I_N@Z @ 0x1C011CE78
 * Callers:
 ...
 *     _lambda_86d58a30ac6ca0f5146c7ad98b0ef6a6_::operator() @ 0x1C011CC38 (_lambda_86d58a30ac6ca0f5146c7ad98b0ef6a6_--operator().c)
 */
        ...
        char a4)
{
  ...
  if ( result >= 0 )
  {
    v10[0] = 19398912;
    LOWORD(v10[1]) = 0x8000;
    result = lambda_86d58a30ac6ca0f5146c7ad98b0ef6a6_::operator()((__int64)v8, (unsigned __int64)v10);
    if ( result >= 0 )
    {
