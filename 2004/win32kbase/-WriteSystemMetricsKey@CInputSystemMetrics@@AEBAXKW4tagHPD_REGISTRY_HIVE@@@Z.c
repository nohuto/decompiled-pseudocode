/*
 * XREFs of ?WriteSystemMetricsKey@CInputSystemMetrics@@AEBAXKW4tagHPD_REGISTRY_HIVE@@@Z @ 0x1C0034B44
 * Callers:
 *     ?Initialize@CInputSystemMetrics@@SAJXZ @ 0x1C0034A90 (-Initialize@CInputSystemMetrics@@SAJXZ.c)
 *     ForceUpdatePointerDeviceSystemMetrics @ 0x1C0034B00 (ForceUpdatePointerDeviceSystemMetrics.c)
