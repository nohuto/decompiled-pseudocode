/*
 * XREFs of ?CitpContextTrackingDataStart@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C00354AC
 * Callers:
...
__int64 __fastcall CitpContextTrackingDataStart(struct _CIT_IMPACT_CONTEXT *a1, const char *a2)
{
  ...
  if ( !BYTE5(qword_1C0250494) )
    return v2;
  v5 = -1;
  v6 = 96LL * (unsigned int)xmmword_1C0250474;
  if ( v6 > 0xFFFFFFFF )
  {
    v8 = -1073741675;
    v9 = 454;
...
LABEL_28:
  ...
  v10 = (unsigned int)xmmword_1C0250474;
  v11 = 0;
  if ( (_DWORD)xmmword_1C0250474 )
  {
    v12 = (char *)a1 + 8;
    do
    {
    ...
    while ( v11 < (unsigned int)xmmword_1C0250474 );
  }
  *((_DWORD *)a1 + 14) = v10;
