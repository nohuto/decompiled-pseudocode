/*
 * XREFs of NtInputSpaceRegionFromPoint @ 0x1C012DDD0
 * Callers:
 *     <none>
 * Callees:
 *     ?RegionFromPoint@InputConfig@@SA_NAEBVCLockedInputSpace@@UtagPOINT@@PEAVCLockedInputSpaceRegion@@@Z @ 0x1C00106C8 (-RegionFromPoint@InputConfig@@SA_NAEBVCLockedInputSpace@@UtagPOINT@@PEAVCLockedInputSpaceRegion@.c)
 *     ??0CLockedInputSpace@@QEAA@XZ @ 0x1C0012654 (--0CLockedInputSpace@@QEAA@XZ.c)
 *     UserSetLastError @ 0x1C009228C (UserSetLastError.c)
 *     ??1CLockedInputSpace@@QEAA@XZ @ 0x1C00CEFE4 (--1CLockedInputSpace@@QEAA@XZ.c)
 *     ?GetInputSpace@InputConfig@@SA_NU_LUID@@PEAVCLockedInputSpace@@@Z @ 0x1C01AFEBC (-GetInputSpace@InputConfig@@SA_NU_LUID@@PEAVCLockedInputSpace@@@Z.c)
 */
