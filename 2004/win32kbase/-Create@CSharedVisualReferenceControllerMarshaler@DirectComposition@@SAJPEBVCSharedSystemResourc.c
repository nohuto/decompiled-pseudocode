/*
 * XREFs of ?Create@CSharedVisualReferenceControllerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F3FC4
 * Callers:
 *     CreateSharedVisualReferenceControllerMarshaler @ 0x1C01F41A0 (CreateSharedVisualReferenceControllerMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedVisualReferenceControllerMarshaler **a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( v6 < 0 )
    {
      (*(void (__fastcall **)(struct DirectComposition::CSharedVisualReferenceControllerMarshaler *, __int64))(*(_QWORD *)v5 + 80LL))(
        v5,
        1LL);
      v5 = 0LL;
    }
