/*
 * XREFs of ?CitpLogoff@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0034FE0
 * Callers:
 *     CitUserChange @ 0x1C0034ED0 (CitUserChange.c)
 *     CitModerncoreShutdown @ 0x1C01FA8A0 (CitModerncoreShutdown.c)
 * Callees:
