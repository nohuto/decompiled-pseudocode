/*
 * XREFs of ?SetPointerInfoNodeMessagePosted@CTouchProcessor@@IEAAH_KIH@Z @ 0x1C019B638
 * Callers:
...
LABEL_14:
    LOBYTE(v8) = 5;
    WPP_RECORDER_SF_(v12->DeviceExtension, v8, 7, v13, (__int64)&WPP_8113a81d21a7371434699e4b0bdc9bc8_Traceguids);
    return 0LL;
  }
