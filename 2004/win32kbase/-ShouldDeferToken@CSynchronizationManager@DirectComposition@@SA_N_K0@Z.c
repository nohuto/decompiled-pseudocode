/*
 * XREFs of ?ShouldDeferToken@CSynchronizationManager@DirectComposition@@SA_N_K0@Z @ 0x1C002FD08
 * Callers:
 *     DCompositionShouldDeferToken @ 0x1C002FCF0 (DCompositionShouldDeferToken.c)
 * Callees:
