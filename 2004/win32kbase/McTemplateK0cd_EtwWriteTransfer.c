/*
 * XREFs of McTemplateK0cd_EtwWriteTransfer @ 0x1C01296A0
 * Callers:
 *     EtwTraceEndAppMessageProcessing @ 0x1C0026BE0 (EtwTraceEndAppMessageProcessing.c)
 *     EtwTraceBeginDispatchMessage @ 0x1C0040D40 (EtwTraceBeginDispatchMessage.c)
 *     EtwTraceEndDispatchMessage @ 0x1C0040D60 (EtwTraceEndDispatchMessage.c)
 *     EtwTraceWakeDIT @ 0x1C00458A0 (EtwTraceWakeDIT.c)
 *     EtwTraceEndTranslateMessage @ 0x1C00536F0 (EtwTraceEndTranslateMessage.c)
 *     EtwTraceBeginTranslateMessage @ 0x1C0053710 (EtwTraceBeginTranslateMessage.c)
