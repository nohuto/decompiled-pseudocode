/*
 * XREFs of InitializeWin32KSyscallFilter @ 0x1C002CCD0
 * Callers:
...
LABEL_10:
  ...
  while ( 1 )
  {
    v2 = (void *)OpenCacheKeyEx(0LL, 52LL, 131097LL, &v18);
    if ( !v2 )
      break;
...
LABEL_22:
  ...
  v6 = (v4 & 7) == 0;
  qword_1C024BC68 = 0LL;
  qword_1C024BC78 = 550LL;
  qword_1C024BC88 = 320LL;
  v7 = (v4 >> 3) + 1;
  qword_1C024BC98 = 1LL;
  if ( v6 )
    v7 = v5;
  qword_1C024BCA8 = 440LL;
  qword_1C024BC70 = (__int64)&Win32KSyscallFilterList::Rs1RestrictedAppcontainer;
  v8 = v7;
  qword_1C024BCB8 = 276LL;
  qword_1C024BC80 = (__int64)&Win32KSyscallFilterList::Rs1RestrictedAppcontainerPlugin;
  qword_1C024BC90 = (__int64)&Win32KSyscallFilterList::FontDrvHost;
  qword_1C024BCA0 = (__int64)&Win32KSyscallFilterList::Rs1RestrictedAppcontainerMiniPlugin;
  qword_1C024BCB0 = (__int64)&Win32KSyscallFilterList::Rs3RestrictedAppcontainer;
  qword_1C024BCC0 = (__int64)&Win32KSyscallFilterList::Rs3HvsiRdpClient;
  dword_1C024BCC8 = 383;
  dword_1C024BCCC = 1;
...
LABEL_31:
  v10 = 0;
  v11 = (unsigned int *)&qword_1C024BC68;
