/*
 * XREFs of wil_details_UpdateFeatureConfiguredStates @ 0x1C027A290
 * Callers:
 *     wil_details_OnFeatureConfigurationChange @ 0x1C027A210 (wil_details_OnFeatureConfigurationChange.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00CCA30 (__security_check_cookie.c)
 *     wil_details_FeatureDescriptors_SkipPadding @ 0x1C00CEA28 (wil_details_FeatureDescriptors_SkipPadding.c)
 *     wil_details_BuildFeatureStateCacheFromQueryResults @ 0x1C027A008 (wil_details_BuildFeatureStateCacheFromQueryResults.c)
 */
