/*
 * XREFs of NtGdiGetOPMInformation @ 0x1C00C6C90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetInformation@COPM@@QEAAJPEAXQEAU_DXGKMDT_OPM_GET_INFO_PARAMETERS@@QEAU_DXGKMDT_OPM_REQUESTED_INFORMATION@@@Z @ 0x1C00C6E44 (-GetInformation@COPM@@QEAAJPEAXQEAU_DXGKMDT_OPM_GET_INFO_PARAMETERS@@QEAU_DXGKMDT_OPM_REQUESTED_.c)
 *     SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_GET_INFO_PARAMETERS_ @ 0x1C00C7094 (SafelyCopyUserModeDataToKernelModeData__DXGKMDT_OPM_GET_INFO_PARAMETERS_.c)
...
__int64 __fastcall NtGdiGetOPMInformation(void *a1, __int64 a2, void *a3)
{
  ...
  v14[0] = v8;
  v14[1] = v3;
  COPMSimpleBufferPool<_DXGKMDT_OPM_REQUESTED_INFORMATION>::AcquireBufferSafe((char *)qword_1C024CBD0 + 8, Src);
