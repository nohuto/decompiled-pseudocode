/*
 * XREFs of WmsgpPostMessage @ 0x1C027AC2C
 * Callers:
 *     PostWinlogonMessage @ 0x1C0060510 (PostWinlogonMessage.c)
 * Callees:
 *     ClientI_WMsgkSendMessage @ 0x1C006058C (ClientI_WMsgkSendMessage.c)
 *     WMsg_midl_user_allocate @ 0x1C00605D0 (WMsg_midl_user_allocate.c)
