/*
 * XREFs of ApiSetGetInputTransformList @ 0x1C01CB408
 * Callers:
...
__int64 __fastcall ApiSetGetInputTransformList(__int64 a1, unsigned int a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( qword_1C02535A8 )
    ...
    v9 = -1073741637;
  if ( v9 >= 0 && qword_1C02535B0 )
  {
    LOBYTE(a4) = 1;
    v8 = ((__int64 (__fastcall *)(__int64, _QWORD, __int64, __int64, __int64))qword_1C02535B0)(a1, v6, a3, a4, a5);
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(a2) = 5;
