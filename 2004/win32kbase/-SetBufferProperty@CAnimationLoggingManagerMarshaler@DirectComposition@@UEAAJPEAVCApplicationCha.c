/*
 * XREFs of ?SetBufferProperty@CAnimationLoggingManagerMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEBX_KPEA_N@Z @ 0x1C00A79A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StringCchLengthW@@YAJPEBG_KPEA_K@Z @ 0x1C00A7C34 (-StringCchLengthW@@YAJPEBG_KPEA_K@Z.c)
