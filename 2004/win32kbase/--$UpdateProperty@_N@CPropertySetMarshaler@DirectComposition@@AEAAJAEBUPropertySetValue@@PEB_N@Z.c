/*
 * XREFs of ??$UpdateProperty@_N@CPropertySetMarshaler@DirectComposition@@AEAAJAEBUPropertySetValue@@PEB_N@Z @ 0x1C01E80B8
 * Callers:
        ...
        _BYTE *a3)
{
  ...
  if ( (unsigned int)v3 < *(_DWORD *)(a1 + 80)
    && (v6 = *(_QWORD *)(a1 + 72), a2[1] == (*(_DWORD *)(v6 + 8 * v3 + 4) & 0x1FFFFFFF))
    && a2[2] == *(_DWORD *)(v6 + 8LL * (unsigned int)v3) )
  {
    *(_BYTE *)((*(_DWORD *)(v6 + 8 * v3 + 4) & 0x1FFFFFFF) + *(_QWORD *)(a1 + 88)) = *a3;
    v7 = *(_QWORD *)(a1 + 72);
