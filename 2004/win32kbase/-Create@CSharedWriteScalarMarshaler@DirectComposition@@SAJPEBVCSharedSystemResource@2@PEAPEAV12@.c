/*
 * XREFs of ?Create@CSharedWriteScalarMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F4A10
 * Callers:
 *     CreateSharedWriteScalarMarshaler @ 0x1C01F4B60 (CreateSharedWriteScalarMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedWriteScalarMarshaler **a2)
{
  ...
  v4 = Win32AllocPoolWithQuotaZInit(0x58uLL, 0x6E734344u);
  v5 = v4;
  if ( v4 )
  {
    memset(v4, 0, 0x58uLL);
