/*
 * XREFs of ?HandlePTPTimer@CHidInput@@QEAAX_NKPEAX@Z @ 0x1C01A675C
 * Callers:
...
void __fastcall CHidInput::HandlePTPTimer(CHidInput *this, char a2, int a3, __int64 a4)
{
  CBaseInput *v4; // rdi
  __int64 v6; // rbp
  ...
  v4 = gpHidInput;
  v6 = a3;
  DispatcherHandleByName = (void *)CRIMBase::GetDispatcherHandleByName((__int64)gpHidInput, 4LL, 1LL, a4);
  if ( a2 )
  {
