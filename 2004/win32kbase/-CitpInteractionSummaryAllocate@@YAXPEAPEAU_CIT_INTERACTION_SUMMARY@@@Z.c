/*
 * XREFs of ?CitpInteractionSummaryAllocate@@YAXPEAPEAU_CIT_INTERACTION_SUMMARY@@@Z @ 0x1C004C6B4
 * Callers:
...
void __fastcall CitpInteractionSummaryAllocate(struct _CIT_INTERACTION_SUMMARY **a1)
{
  ...
  v1 = dword_1C025049C;
  v3 = (unsigned __int16)dword_1C025049C;
  v4 = CitAllocZero((unsigned __int16)dword_1C025049C);
  if ( v4 )
  {
    v4[1] = v4;
    *v4 = v4;
