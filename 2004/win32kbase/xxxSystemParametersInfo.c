/*
 * XREFs of xxxSystemParametersInfo @ 0x1C0025210
 * Callers:
 ...
 *     WritePointerDeviceSettings @ 0x1C012C920 (WritePointerDeviceSettings.c)
 *     ?IsSPIActionAllowedForFilteredProcess@@YAHI@Z @ 0x1C013C898 (-IsSPIActionAllowedForFilteredProcess@@YAHI@Z.c)
...
__int64 __fastcall xxxSystemParametersInfo(unsigned int a1, unsigned int a2, void *a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)PsIsWin32KFilterEnabled() && !(unsigned int)IsSPIActionAllowedForFilteredProcess(a1) )
  {
    ...
    if ( (unsigned int)dword_1C02451E0 > 5
      && (unsigned __int8)tlgKeywordOn(&dword_1C02451E0, 0x400000000000LL, v25, v26) )
    {
      v31 = a1;
      v38 = &v31;
      v39 = 4LL;
  ...
  if ( a1 > 0x92 )
  {
    ...
    switch ( a1 )
    {
      case 0x93u:
        ...
        goto LABEL_64;
      case 0xAEu:
        PrecisionTouchPadConfiguration = GetPrecisionTouchPadConfiguration(v32);
...
LABEL_91:
          ...
          *(_OWORD *)Dest = 0LL;
          ...
          if ( !ProfileUserName )
            goto LABEL_64;
          v23 = (void (__fastcall *)(wchar_t *))qword_1C0251FE8;
          if ( !qword_1C0251FE8 )
            goto LABEL_64;
          v24 = Dest;
          goto LABEL_63;
...
LABEL_80:
    ...
    if ( a2 && a2 != 12 || !v32 || *(_DWORD *)v32 != 12 )
      return 0LL;
    *(_QWORD *)((char *)v32 + 4) = qword_1C024BB94;
    return 1;
  }
  switch ( a1 )
  {
    ...
    case '2':
      ...
      if ( !v32 || *(_DWORD *)v32 != 24 )
        return 0LL;
      *(_OWORD *)((char *)v32 + 4) = xmmword_1C024BBCC;
      v21[5] = Value;
      return 1;
    case '3':
...
LABEL_11:
  ...
  v15 = 0;
  if ( qword_1C02527C8 )
    v16 = qword_1C02527C8(v14, v7, v9, v12);
  else
    v16 = -1073741637;
  if ( v16 >= 0 && qword_1C02527D0 )
    v15 = qword_1C02527D0(a1, a2, v32, a4);
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
  {
    if ( LOWORD(WPP_GLOBAL_Control->DeviceType) )
    {
