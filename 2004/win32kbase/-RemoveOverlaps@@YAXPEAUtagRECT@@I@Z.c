/*
 * XREFs of ?RemoveOverlaps@@YAXPEAUtagRECT@@I@Z @ 0x1C01CE25C
 * Callers:
 *     AlignRects @ 0x1C00B8208 (AlignRects.c)
 * Callees:
 *     IntersectRect @ 0x1C0012434 (IntersectRect.c)
 *     ?CenterRectangles@@YAXPEAUtagRECT@@I@Z @ 0x1C01CDE1C (-CenterRectangles@@YAXPEAUtagRECT@@I@Z.c)
 *     ?RemoveOverlap@@YAPEAUtagRECT@@PEAU1@00@Z @ 0x1C01CE04C (-RemoveOverlap@@YAPEAUtagRECT@@PEAU1@00@Z.c)
 */
