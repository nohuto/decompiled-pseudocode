/*
 * XREFs of ?AreTheseTwoContactsAZoom@CPTPEngine@@AEAAHPEBUPTPInput@@PEBUCContactState@@1@Z @ 0x1C01BFDD4
 * Callers:
 ...
 * Callees:
 *     ?ndotprod@@YA_NHHHHPEAN@Z @ 0x1C01C5E6C (-ndotprod@@YA_NHHHHPEAN@Z.c)
 */
