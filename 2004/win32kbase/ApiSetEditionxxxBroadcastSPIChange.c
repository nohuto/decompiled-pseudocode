/*
 * XREFs of ApiSetEditionxxxBroadcastSPIChange @ 0x1C01CAC18
 * Callers:
...
__int64 (__fastcall *__fastcall ApiSetEditionxxxBroadcastSPIChange(unsigned int a1))(_QWORD, _QWORD)
{
  ...
  if ( qword_1C0252808 )
    result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C0252808();
  else
    result = 0LL;
  if ( (int)result >= 0 )
  {
    result = qword_1C0252810;
    if ( qword_1C0252810 )
      result = (__int64 (__fastcall *)(_QWORD, _QWORD))qword_1C0252810(a1, 0LL);
  }
