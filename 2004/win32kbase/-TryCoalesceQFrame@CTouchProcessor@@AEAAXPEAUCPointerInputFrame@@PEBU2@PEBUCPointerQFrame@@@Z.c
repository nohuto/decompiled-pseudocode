/*
 * XREFs of ?TryCoalesceQFrame@CTouchProcessor@@AEAAXPEAUCPointerInputFrame@@PEBU2@PEBUCPointerQFrame@@@Z @ 0x1C019C8D0
 * Callers:
...
LABEL_17:
  ...
  if ( v16 && (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 32LL) )
  {
    v30 = *((_DWORD *)a2 + 10);
    v27 = *((_QWORD *)a2 + 9);
    v28[0] = *((_QWORD *)a2 + 14);
