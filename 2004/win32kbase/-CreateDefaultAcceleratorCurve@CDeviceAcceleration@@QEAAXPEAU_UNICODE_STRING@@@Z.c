/*
 * XREFs of ?CreateDefaultAcceleratorCurve@CDeviceAcceleration@@QEAAXPEAU_UNICODE_STRING@@@Z @ 0x1C002DB6C
 * Callers:
 *     ReadDefaultAccelerationCurves @ 0x1C002D890 (ReadDefaultAccelerationCurves.c)
 * Callees:
        ...
        struct _UNICODE_STRING *a2)
{
  ...
  else
  {
    if ( *((_BYTE *)this + 8) )
      goto LABEL_6;
    *((_OWORD *)this + 1) = xmmword_1C024A9F0;
    *((_OWORD *)this + 2) = xmmword_1C024AA00;
    *((_QWORD *)this + 6) = qword_1C024AA10;
    *(_OWORD *)((char *)this + 56) = xmmword_1C024A9C8;
    *(_OWORD *)((char *)this + 72) = xmmword_1C024A9D8;
    v10 = qword_1C024A9E8;
  }
  *((_QWORD *)this + 11) = v10;
LABEL_6:
