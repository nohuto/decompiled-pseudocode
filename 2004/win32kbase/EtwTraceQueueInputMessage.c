/*
 * XREFs of EtwTraceQueueInputMessage @ 0x1C0024C58
 * Callers:
...
_UNKNOWN **__fastcall EtwTraceQueueInputMessage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 96) )
  {
    if ( (Microsoft_Windows_Win32kEnableBits & 0x4000) != 0 )
    {
      if ( W32GetThreadWin32Thread(KeGetCurrentThread()) )
        v11 = *(_BYTE *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 1240);
      else
        v11 = -1;
      LOBYTE(v10) = v11;
  ...
  {
    if ( W32GetThreadWin32Thread(KeGetCurrentThread()) )
      v3 = *(_BYTE *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 1240);
    else
      v3 = -1;
    v4 = *(_DWORD *)(a1 + 100);
    v5 = -__CFSHR__(v4, 8);
