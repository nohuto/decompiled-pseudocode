/*
 * XREFs of ?vInitBrush@EBRUSHOBJ@@QEAAXPEAVDC@@PEAVBRUSH@@VXEPALOBJ@@2PEAVSURFACE@@H@Z @ 0x1C00C1150
 * Callers:
 ...
 *     rgbFromColorref @ 0x1C00C1560 (rgbFromColorref.c)
 *     ?ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z @ 0x1C00C15A4 (-ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z.c)
 *     ?vFreeOrCacheRBrush@RBRUSH@@QEAAXW4RBTYPE@@@Z @ 0x1C00C1790 (-vFreeOrCacheRBrush@RBRUSH@@QEAAXW4RBTYPE@@@Z.c)
 *     ?hFindIcmDIB@BRUSH@@QEAAPEAUHBITMAP__@@PEAX@Z @ 0x1C01403C0 (-hFindIcmDIB@BRUSH@@QEAAPEAUHBITMAP__@@PEAX@Z.c)
 */
        ...
        unsigned int a7)
{
  ...
  tagPALETTEENTRY v51; // ebx
  int v52; // eax
  __int64 v53; // r8
  unsigned int v54; // [rsp+20h] [rbp-48h]
  tagPALETTEENTRY v56; // [rsp+80h] [rbp+18h]
...
LABEL_31:
  ...
  if ( (_DWORD)result != -1 )
  {
    ...
    {
      if ( (v35 & 2) == 0 || (result = (unsigned int)v56, *(_DWORD *)(a3 + 104) == v56) )
      {
...
LABEL_51:
  ...
  if ( *a1 == -1 && !v26 )
  {
    ...
    if ( *(_DWORD *)(a6 + 96) == 1 )
    {
      NearestIndexFromColorref = ulGetNearestIndexFromColorref(v7, a4, v56, 0);
      *a1 = (int)NearestIndexFromColorref;
      v51 = NearestIndexFromColorref;
      result = rgbFromColorref(v7, a4, *(unsigned int *)&v56);
      a1[7] = result;
      if ( v56 != a1[6] )
      {
        *a1 = 1 - *(_DWORD *)&v51;
        result = *(_QWORD *)(v7 + 112);
        a1[7] = *(_DWORD *)(result + 4LL * (unsigned int)(1 - *(_DWORD *)&v51));
      }
    }
    else
    {
      v52 = (int)ulGetNearestIndexFromColorref(v7, a4, (tagPALETTEENTRY)a1[6], 0);
