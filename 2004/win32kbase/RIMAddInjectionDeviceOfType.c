/*
 * XREFs of RIMAddInjectionDeviceOfType @ 0x1C0157990
 * Callers:
        ...
        __int64 a6)
{
  ...
  const UNICODE_STRING *p_DestinationString; // [rsp+70h] [rbp-118h]
...
LABEL_27:
          ...
          {
            v28 = 0LL;
            v12 = RIMCreateDev(v13, v17, p_DestinationString, 0LL, 1, (__int64)v36, (struct _UNICODE_STRING **)&v28);
            if ( v12 >= 0 )
            {
              if ( a5 )
              {
