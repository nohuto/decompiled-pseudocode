/*
 * XREFs of ?OnTelemetryOutput@CPTPProcessor@@UEAAXPEBUPTPTelemetryOutput@@@Z @ 0x1C01A38E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     EtwTraceTouchPadAAP @ 0x1C0128C90 (EtwTraceTouchPadAAP.c)
 ...
 *     ?OnNewSession@Usage@PTPTelemetry@@SAX_J@Z @ 0x1C01A3878 (-OnNewSession@Usage@PTPTelemetry@@SAX_J@Z.c)
        ...
        if ( v8 )
        {
          ...
          if ( v9 )
          {
            ...
            if ( v10 )
            {
                ...
                if ( v12 )
                {
                  ...
                  if ( v13 )
                  {
                    ...
                    else
                    {
                      ...
                      {
                        if ( v24 == 1 )
                          qword_1C0253B58 = *(_QWORD *)((char *)a2 + 12);
                      }
                      else
                      {
                        qword_1C0253B50 = *(_QWORD *)((char *)a2 + 12);
                      }
                    }
                  }
                  else
                  {
                    ...
                    {
                      qword_1C0253B30 += v26;
                      if ( v26 > qword_1C0253B38 )
                        qword_1C0253B38 = v26;
                      if ( !qword_1C0253B40 || v26 < qword_1C0253B40 )
                        qword_1C0253B40 = v26;
                    }
                  }
                }
              ...
              else if ( qword_1C024CCE8 < qword_1C0250DD8 )
              {
                qword_1C024CCE8 = *((_QWORD *)a2 + 1);
              }
            }
            else
            {
