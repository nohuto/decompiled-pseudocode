/*
 * XREFs of ?PostQEventWork@CBaseProcessor@@IEAAXPEAUHWND__@@W4EventWorkId@1@I_K_J@Z @ 0x1C00535B0
 * Callers:
...
__int64 __fastcall CBaseProcessor::PostQEventWork(__int64 a1, int a2, int a3, int a4, __int64 a5, __int64 a6)
{
  ...
  if ( dword_1C020A410[2 * a3 + 1] == (_DWORD)result )
    return EditionPostInputEvent(dword_1C020A410[2 * a3], a2, 0, a4, a5, a6);
  return result;
}
