/*
 * XREFs of ?EngineInput@PTP@InputTraceLogging@@SAXPEBUCPointerInputFrame@@_N@Z @ 0x1C01A2C98
 * Callers:
...
void __fastcall InputTraceLogging::PTP::EngineInput(const struct CPointerInputFrame *a1)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 128LL) )
  {
    v5 = *(_DWORD *)(v1 + 48);
    v6 = *(_DWORD *)(v1 + 40);
    v7 = *(_QWORD *)(v1 + 72);
    ...
    v13 = 8LL;
    v11 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0246A70, (unsigned __int8 *)dword_1C021A72E, 0LL, 0LL, 7u, &v9);
  }
}
