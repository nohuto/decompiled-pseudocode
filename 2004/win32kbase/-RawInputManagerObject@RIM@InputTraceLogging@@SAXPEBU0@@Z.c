/*
 * XREFs of ?RawInputManagerObject@RIM@InputTraceLogging@@SAXPEBU0@@Z @ 0x1C005D4CC
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 256LL, a1, a4) )
  {
    v5 = *(_DWORD *)(v4 + 84);
