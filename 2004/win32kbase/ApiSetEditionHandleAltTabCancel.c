/*
 * XREFs of ApiSetEditionHandleAltTabCancel @ 0x1C006A118
 * Callers:
        ...
        int a7)
{
  ...
  v11 = 0;
  if ( (int)IsEditionHandleAltTabCancelSupported() >= 0 && qword_1C0253430 )
  {
    LOBYTE(v14) = a5;
    v11 = qword_1C0253430(a1, v9, a3, a4, v14, a6, a7);
  }
  if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
  {
    LOBYTE(v12) = 5;
