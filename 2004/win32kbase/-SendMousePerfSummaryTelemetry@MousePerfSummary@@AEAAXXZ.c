/*
 * XREFs of ?SendMousePerfSummaryTelemetry@MousePerfSummary@@AEAAXXZ @ 0x1C01BF624
 * Callers:
 ...
 *     ?Reset@MousePerfSummary@@AEAAXXZ @ 0x1C01BF344 (-Reset@MousePerfSummary@@AEAAXXZ.c)
 */
