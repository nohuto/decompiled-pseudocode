/*
 * XREFs of ?xxxAdjustPushState@@YAXPEAUtagTHREADINFO@@EEPEAUtagKL@@1@Z @ 0x1C01A7CEC
 * Callers:
        ...
        struct tagKL *a5)
{
  ...
  if ( a2 )
  {
    ...
    if ( ((unsigned __int8)v10 & gafRawKeyState[v9]) != 0
      ...
      || (*(_BYTE *)(*((_QWORD *)a1 + 53) + v9 + 228) & (unsigned __int8)v10) != 0 )
    {
      v11 = InternalMapVirtualKeyEx(v7, 0, *(_QWORD *)(*((_QWORD *)a4 + 6) + 32LL));
      v12 = InternalMapVirtualKeyEx(v7, 0, *(_QWORD *)(*((_QWORD *)a5 + 6) + 32LL));
      if ( v11 )
      {
        if ( !v12 )
  ...
  if ( (_BYTE)v5 )
  {
    ...
    if ( ((unsigned __int8)v14 & gafRawKeyState[v5 >> 2]) != 0
      ...
      || (*(_BYTE *)(*((_QWORD *)a1 + 53) + v13 + 228) & (unsigned __int8)v14) != 0 )
    {
