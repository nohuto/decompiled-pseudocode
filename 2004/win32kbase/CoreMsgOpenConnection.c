/*
 * XREFs of CoreMsgOpenConnection @ 0x1C004879C
 * Callers:
 ...
 *     UserCoreMsgOpenConnectionHandle @ 0x1C01AEC40 (UserCoreMsgOpenConnectionHandle.c)
 * Callees:
