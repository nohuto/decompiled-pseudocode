/*
 * XREFs of ?vDisableSurface@PDEVOBJ@@QEAAXW4_CLEANUPTYPE@@E@Z @ 0x1C00BF4C0
 * Callers:
...
__int64 __fastcall PDEVOBJ::vDisableSurface(__int64 *a1, unsigned int a2, char a3)
{
  ...
  v3 = *a1;
  if ( (*(_DWORD *)(*a1 + 40) & 0x80000) == 0 && qword_1C02515E8 )
    qword_1C02515E8(v3);
  if ( qword_1C02516B0 )
    v7 = qword_1C02516B0();
  else
    v7 = -1073741637;
  if ( v7 >= 0 && qword_1C02516B8 )
    qword_1C02516B8(*a1, a2);
  result = *a1;
  v9 = *(_QWORD *)(*a1 + 2552);
  if ( !v9 || !a3 )
  {
