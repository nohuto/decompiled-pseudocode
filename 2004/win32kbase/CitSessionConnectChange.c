/*
 * XREFs of CitSessionConnectChange @ 0x1C005C5E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CitSessionConnectChange(char a1, char a2)
{
  ...
  if ( !xmmword_1C02504A0 || ((*((_BYTE *)xmmword_1C02504A0 + 112) & 2) != 0) == a1 )
    return;
  v5 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  if ( a1 )
    ++*((_WORD *)xmmword_1C02504A0 + 57);
  else
  ...
  if ( !a2 )
  {
    if ( a1 )
    {
      if ( (unsigned int)dword_1C0246B24 >= MEMORY[0xFFFFF7800000037C] )
        goto LABEL_6;
      v8 = &off_1C0246B18;
    }
    else
    {
      if ( (unsigned int)dword_1C0245364 >= MEMORY[0xFFFFF7800000037C] )
        goto LABEL_6;
      v8 = &off_1C0245358;
    }
