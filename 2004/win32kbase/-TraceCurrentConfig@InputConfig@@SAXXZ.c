/*
 * XREFs of ?TraceCurrentConfig@InputConfig@@SAXXZ @ 0x1C000F968
 * Callers:
...
void InputConfig::TraceCurrentConfig(void)
{
  ...
  if ( gpInputConfig )
  {
    ...
    for ( i = **(CInputConfig ***)v0; v3 != v0; i = *(CInputConfig **)i )
    {
      ...
      if ( !v5 )
        break;
      if ( (unsigned int)dword_1C0246A70 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 2LL, v1, v2) )
      {
        ...
        v40 = 4;
        v37 = 8;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0246A70, (int)&dword_1C021AF3B, 0, 0, 6u, &v35);
      }
      v6 = v5 + 178;
      KeEnterCriticalRegion();
      ExAcquireResourceSharedLite(CInputConfig::slock, 1u);
      for ( j = v5[178]; j != v6; j = (_QWORD *)*j )
      {
        ...
        if ( (v11 & 2) != 0 )
        {
          if ( (unsigned int)dword_1C0246A70 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 2LL, v11, v8) )
          {
            v13 = *((_DWORD *)j + 45);
            v18 = *((_DWORD *)j + 53);
            v23 = *((_DWORD *)j + 52);
        ...
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 2LL, v11, v8) )
          {
