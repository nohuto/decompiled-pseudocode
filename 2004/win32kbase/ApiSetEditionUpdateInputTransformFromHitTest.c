/*
 * XREFs of ApiSetEditionUpdateInputTransformFromHitTest @ 0x1C0002390
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( qword_1C02532C8 )
    result = qword_1C02532C8();
  else
    result = 3221225659LL;
  if ( (int)result >= 0 )
  {
    result = (__int64)qword_1C02532D0;
    if ( qword_1C02532D0 )
      result = qword_1C02532D0(a1, v8, a3, a4, a5, a6);
  }
