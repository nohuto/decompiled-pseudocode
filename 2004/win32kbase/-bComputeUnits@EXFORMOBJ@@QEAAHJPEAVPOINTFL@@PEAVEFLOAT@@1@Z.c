/*
 * XREFs of ?bComputeUnits@EXFORMOBJ@@QEAAHJPEAVPOINTFL@@PEAVEFLOAT@@1@Z @ 0x1C0140CB0
 * Callers:
 *     <none>
 * Callees:
 *     efSin @ 0x1C003CCD0 (efSin.c)
 *     ?eqLength@EFLOAT@@QEAA?AV1@AEBVPOINTFL@@@Z @ 0x1C003DA80 (-eqLength@EFLOAT@@QEAA-AV1@AEBVPOINTFL@@@Z.c)
 *     ?bXform@EXFORMOBJ@@QEAAHPEAVVECTORFL@@0_K@Z @ 0x1C007BA20 (-bXform@EXFORMOBJ@@QEAAHPEAVVECTORFL@@0_K@Z.c)
 *     ?bIsZero@EFLOAT@@QEBAHXZ @ 0x1C007C72C (-bIsZero@EFLOAT@@QEBAHXZ.c)
 */
