/*
 * XREFs of ?CitpInteractionSummaryStopTracking@@YAXPEAU_CIT_INTERACTION_SUMMARY@@I@Z @ 0x1C0037CA8
 * Callers:
 ...
 * Callees:
 *     ?OnlyCompositionMetrics@@YAHPEBU_CIT_INTERACTION_SUMMARY@@U_CIT_INPUT_TIMES@@@Z @ 0x1C0038294 (-OnlyCompositionMetrics@@YAHPEBU_CIT_INTERACTION_SUMMARY@@U_CIT_INPUT_TIMES@@@Z.c)
 ...
 *     ?CitpAudioStatSnapDelta@@YAXPEAU_CIT_AUDIO_STATS@@@Z @ 0x1C00C7D04 (-CitpAudioStatSnapDelta@@YAXPEAU_CIT_AUDIO_STATS@@@Z.c)
...
void __fastcall CitpInteractionSummaryStopTracking(struct _CIT_INTERACTION_SUMMARY *a1, int a2)
{
  ...
  *(_QWORD *)v2 = v2;
  ...
  while ( v9 );
  if ( ((xmmword_1C0250484 & 0x10) == 0
     || *((_WORD *)v2 + 57) != 4
     || *((_WORD *)v2 + 54)
     && *((_WORD *)v2 + 55)
     && ((*((_BYTE *)v2 + 100) & 1) != 0 || (v10 = **(PVOID **)(*((_QWORD *)v2 + 3) + 8LL)) == 0LL || v10 != g_pepDwm))
    && ((xmmword_1C0250484 & 0x20) == 0
     || (*((_WORD *)v2 + 57) & 0xFFF3) != 0
     || (*((_WORD *)v2 + 57) & 8) == 0
     || *((_WORD *)v2 + 53) >= 3u
     || *((_WORD *)v2 + 54) && *((_WORD *)v2 + 55)) )
  {
    v11 = xmmword_1C02504A0;
    v12 = a2 - *((_DWORD *)v2 + 23);
    v13 = a2 - *((_DWORD *)xmmword_1C02504A0 + 218);
    v14 = *((_QWORD *)xmmword_1C02504A0 + 105) + 1LL;
    v15 = *((_QWORD *)xmmword_1C02504A0 + 108);
    *((_QWORD *)xmmword_1C02504A0 + 105) = v14;
    if ( (*((_BYTE *)v2 + 100) & 1) != 0 )
    {
      v31 = *((_QWORD *)v2 + 3);
      v32 = &word_1C020BCB0;
      ...
      if ( !(unsigned int)OnlyCompositionMetrics(v2, &v90, 0LL, v15)
        ...
        && (unsigned __int8)tlgKeywordOn(&dword_1C0245250, 0x800000000800LL, v38, v39) )
      {
        v101 = *(_QWORD *)(v42 + 16);
        ...
        v54 = *(_WORD *)(v42 + 104);
        v78 = *((_DWORD *)v11 + 219);
        v79 = xmmword_1C0250484;
        v80 = DWORD2(xmmword_1C0250484);
        v75 = DWORD1(xmmword_1C0250484);
        v81 = DWORD1(xmmword_1C0250474);
        v55 = *(_WORD *)(v42 + 70);
        v103 = *(_BYTE *)(v42 + 72);
        v56 = *(_WORD *)(v42 + 68);
        v57 = *(_WORD *)(v42 + 66);
    ...
    else
    {
      ...
      v93 = v18;
      v91 = v17;
      if ( !(unsigned int)OnlyCompositionMetrics(v2, &v90, 0LL, v15) && (unsigned int)dword_1C0245250 > 5 )
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C0245250, 0x800000000800LL, v19, v20) )
        {
          v99 = *(_QWORD *)(v24 + 16);
          v25 = *v7 & 0xFFFFFF;
          v102[0] = 0x2000000LL;
          ...
          v68 = *(_WORD *)(v24 + 104);
          v84 = *((_DWORD *)v11 + 219);
          v83 = xmmword_1C0250484;
          v82 = *(_QWORD *)((char *)&xmmword_1C0250484 + 4);
          v81 = DWORD1(xmmword_1C0250474);
          v67 = *(_WORD *)(v24 + 70);
          v103 = *(_BYTE *)(v24 + 72);
          v66 = *(_WORD *)(v24 + 68);
