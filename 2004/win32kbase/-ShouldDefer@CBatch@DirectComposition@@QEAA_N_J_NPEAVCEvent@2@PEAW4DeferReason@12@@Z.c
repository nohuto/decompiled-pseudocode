/*
 * XREFs of ?ShouldDefer@CBatch@DirectComposition@@QEAA_N_J_NPEAVCEvent@2@PEAW4DeferReason@12@@Z @ 0x1C00A9570
 * Callers:
 ...
 *     ?KeepOrDeferBatches@CConnection@DirectComposition@@AEAAX_KPEAPEAVCBatch@2@@Z @ 0x1C01CFF6C (-KeepOrDeferBatches@CConnection@DirectComposition@@AEAAX_KPEAPEAVCBatch@2@@Z.c)
 * Callees:
...
LABEL_14:
  ...
  else
  {
    ...
    while ( v9 )
    {
      ...
      v9 = *(_QWORD *)v16;
      if ( v16 )
        DirectComposition::CEvent::`scalar deleting destructor'(v16);
      *((_QWORD *)this + 13) = v9;
    }
    v11 = *((_QWORD *)this + 12);
    if ( !v11 )
