/*
 * XREFs of ?Create@?$CTypeIsolation@$0BEAAA@$0KA@@NSInstrumentation@@SAPEAV12@XZ @ 0x1C00094DC
 * Callers:
...
void *NSInstrumentation::CTypeIsolation<81920,160>::Create()
{
  ...
  *PoolWithTag = PoolWithTag;
  if ( !(unsigned __int8)NSInstrumentation::CTypeIsolation<81920,160>::Initialize(PoolWithTag) )
  {
