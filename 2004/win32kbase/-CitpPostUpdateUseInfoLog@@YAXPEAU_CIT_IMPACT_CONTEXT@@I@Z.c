/*
 * XREFs of ?CitpPostUpdateUseInfoLog@@YAXPEAU_CIT_IMPACT_CONTEXT@@I@Z @ 0x1C0036958
 * Callers:
 ...
 *     ?CitpPostUpdateUseInfoCalculate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_POST_UPDATE_USE_INFO@@@Z @ 0x1C00372B0 (-CitpPostUpdateUseInfoCalculate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_POST_UPDATE_USE_INFO@@@Z.c)
 *     ?CitUpdateInputTypeCoverage@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C003750C (-CitUpdateInputTypeCoverage@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z.c)
...
void __fastcall CitpPostUpdateUseInfoLog(struct _CIT_IMPACT_CONTEXT *a1, int a2)
{
  ...
  if ( *((_WORD *)a1 + 172) )
  {
    ...
    if ( (unsigned int)dword_1C0245250 > 5 && (unsigned __int8)tlgKeywordOn(&dword_1C0245250, 0x800000000800LL, v5, v6) )
    {
      v7 = *((_DWORD *)a1 + 133);
    ...
    HIDWORD(Data[6]) += v37;
    if ( v2 == 2 || v36 >= HIDWORD(xmmword_1C0250474) )
    {
      v45 = HIDWORD(xmmword_1C0250474) / 0x3E8;
      if ( (unsigned int)v38 >= (unsigned int)v45 )
      {
        v38 = (unsigned int)(v45 - 1);
        HIDWORD(Data[6]) = v45 - 1;
      }
      if ( (unsigned int)dword_1C0245418 > 5 )
      {
        if ( (unsigned __int8)tlgKeywordOn(&dword_1C0245418, 0x400000000000LL, v38, v45) )
        {
