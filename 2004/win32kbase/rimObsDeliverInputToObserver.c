/*
 * XREFs of rimObsDeliverInputToObserver @ 0x1C017EFC0
 * Callers:
...
__int64 __fastcall rimObsDeliverInputToObserver(__int64 a1, __int64 a2)
{
  ...
  HANDLE v44; // [rsp+E0h] [rbp+67h] BYREF
  __int64 v45; // [rsp+E8h] [rbp+6Fh] BYREF
  __int64 v46; // [rsp+F0h] [rbp+77h] BYREF
  ...
  v44 = rimObsCheckForExistingDeviceHandle(a2, *(PVOID *)(a1 + 32));
  if ( v44 == (HANDLE)-1LL )
  {
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
    ...
    v6 = ObOpenObjectByPointer(*(PVOID *)(a1 + 32), 0, 0LL, 3u, ExRawInputManagerObjectType, 0, &v44);
    if ( v6 < 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
    ...
    {
      v11 = Win32AllocPoolZInit(0x18uLL, 1701334866LL);
      v13 = v11;
      if ( !v11 )
      {
        if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
...
LABEL_45:
  if ( *(_DWORD *)(a2 + 88) == 1 )
  {
    ...
    v20 = *(void ***)(a2 + 96);
    v6 = rimObsCopyMessage((__int64)v31, *(unsigned int *)(a2 + 72), v20, *(unsigned int *)(a2 + 104));
    if ( v6 == -1073741789 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
      ...
      v42 = 0LL;
      v43 = 0LL;
      rimObsCopyMessage((__int64)&v39, v23, v20, v22);
      v6 = rimObsPushInputMessage(a2, v31);
    }
    else
    {
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
