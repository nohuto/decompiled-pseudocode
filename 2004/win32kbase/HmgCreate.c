/*
 * XREFs of HmgCreate @ 0x1C00087BC
 * Callers:
...
__int64 HmgCreate()
{
  ...
  v0 = (unsigned int)qword_1C02513D8;
  if ( qword_1C02513D8 )
    v0 = qword_1C02513D8();
