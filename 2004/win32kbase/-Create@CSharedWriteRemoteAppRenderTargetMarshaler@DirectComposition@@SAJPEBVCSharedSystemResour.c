/*
 * XREFs of ?Create@CSharedWriteRemoteAppRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F4DB4
 * Callers:
 *     CreateSharedWriteRemoteAppRenderTargetMarshaler @ 0x1C01F4F20 (CreateSharedWriteRemoteAppRenderTargetMarshaler.c)
 * Callees:
