/*
 * XREFs of ?UnqueuePowerRequest@@YAPEAUtagPOWERREQUEST@@XZ @ 0x1C00645F0
 * Callers:
...
struct tagPOWERREQUEST *UnqueuePowerRequest(void)
{
  ...
  {
    v0 = qword_1C024F678;
    v3 = *(_QWORD **)(qword_1C024F678 + 8);
    if ( *(struct _LIST_ENTRY **)qword_1C024F678 != &gPowerRequestList || *v3 != qword_1C024F678 )
      __fastfail(3u);
    qword_1C024F678 = *(_QWORD *)(qword_1C024F678 + 8);
