/*
 * XREFs of HMCreateHandleForObject @ 0x1C0017550
 * Callers:
...
LABEL_5:
    ...
    *v5 = *((_QWORD *)gpKernelHandleTable + 3 * *v5);
    ...
    v8[24] = a2;
    v7[v10] = a1;
    v11 = *(unsigned __int16 *)((char *)qword_1C024AD48 + v6 * (unsigned int)dword_1C024AD50 + 26) << 16;
