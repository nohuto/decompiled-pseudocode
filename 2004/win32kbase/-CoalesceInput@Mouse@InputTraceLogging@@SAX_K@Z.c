/*
 * XREFs of ?CoalesceInput@Mouse@InputTraceLogging@@SAX_K@Z @ 0x1C005EDB0
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::CoalesceInput(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    if ( (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 64LL, a1, a4) )
    {
      v9 = 0;
      v7 = &v5;
      v5 = v4;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        ...
        (unsigned __int8 *)dword_1C021BA24,
        0LL,
        0LL,
        3u,
        &v6);
