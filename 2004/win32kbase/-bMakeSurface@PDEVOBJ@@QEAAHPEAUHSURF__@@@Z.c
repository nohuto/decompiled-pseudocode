/*
 * XREFs of ?bMakeSurface@PDEVOBJ@@QEAAHPEAUHSURF__@@@Z @ 0x1C0052410
 * Callers:
    ...
    || (v6 = *(__int64 (__fastcall **)(_QWORD))(v2 + 2712)) != 0LL && (v4 = (HSURF)v6(*(_QWORD *)(v2 + 1800))) != 0LL )
  {
    ...
    if ( v7 )
    {
      ...
      *(_QWORD *)(*(_QWORD *)(*(_QWORD *)this + 2552LL) + 128LL) = *(_QWORD *)(*(_QWORD *)this + 1808LL);
      ...
      {
        v13 = qword_1C0251630 ? qword_1C0251630() : -1073741637;
        if ( v13 >= 0 && qword_1C0251638 )
          qword_1C0251638(v2, 0xFFFFFFFFLL, 0xFFFFFFFFLL, 1LL);
      }
      PDEVOBJ::vFilterDriverHooks(this);
      if ( qword_1C02512B8 )
        v11 = qword_1C02512B8(v2);
      else
        v11 = 0;
      if ( qword_1C02512C8 )
        qword_1C02512C8(v2);
