/*
 * XREFs of ?createrec@EPATHOBJ@@IEAAHPEAVEXFORMOBJ@@PEAU_PATHDATAL@@PEAU_POINTFIX@@@Z @ 0x1C0024224
 * Callers:
 ...
 *     ?vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z @ 0x1C0141604 (-vOffsetPoints@@YAXPEAU_POINTFIX@@0IJJ@Z.c)
 */
