/*
 * XREFs of ?HandleCapture_BreakHasMouseOwner@CMouseProcessor@@AEAA?AVCInputDest@@AEBV2@AEBVCButtonEvent@1@@Z @ 0x1C0049940
 * Callers:
...
LABEL_14:
  ...
  v18 = CInputDest::operator==(a1 + 3568, a3, v11);
LABEL_17:
  if ( !v18 )
  {
