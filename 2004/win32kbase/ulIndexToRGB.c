/*
 * XREFs of ulIndexToRGB @ 0x1C001B900
 * Callers:
 *     GreGetNearestColor @ 0x1C00A4250 (GreGetNearestColor.c)
 *     ulColorRefToRGB @ 0x1C00C8610 (ulColorRefToRGB.c)
 * Callees:
 *     ?ulIndexToRGB@XEPALOBJ@@QEAAKK@Z @ 0x1C001B950 (-ulIndexToRGB@XEPALOBJ@@QEAAKK@Z.c)
