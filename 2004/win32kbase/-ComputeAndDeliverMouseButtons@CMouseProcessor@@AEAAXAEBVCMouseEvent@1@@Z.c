/*
 * XREFs of ?ComputeAndDeliverMouseButtons@CMouseProcessor@@AEAAXAEBVCMouseEvent@1@@Z @ 0x1C0068D90
 * Callers:
 *     <none>
 * Callees:
  ...
  for ( i = 1; v7; i *= 2 )
  {
    if ( (v7 & 3) != 0 )
    {
      if ( (v7 & 1) != 0 )
      {
        ...
        CMouseProcessor::CButtonEvent::CButtonEvent((__int64)v15, i, 1LL, v10, (__int64)a2);
        CMouseProcessor::ProcessMouseButton(this, (const struct CMouseProcessor::CButtonEvent *)v15);
      }
      if ( (v7 & 2) != 0 )
      {
        CMouseProcessor::CButtonEvent::CButtonEvent((__int64)v15, i, 2LL, 0LL, (__int64)a2);
        CMouseProcessor::ProcessMouseButton(this, (const struct CMouseProcessor::CButtonEvent *)v15);
      }
      v11 = *((_QWORD *)a2 + 1);
      if ( (*(_BYTE *)(v11 + 112) & 1) == 0 && *(_DWORD *)(v11 + 108) != 1 )
      {
        ...
        v13 = *(_QWORD *)(v11 + 132);
        v14 = v12;
        if ( !(unsigned int)ApiSetEditionForegroundQAccessibleToMouseProducer(&v13, a2, 0LL) )
          break;
      }
    }
    v7 >>= 2;
