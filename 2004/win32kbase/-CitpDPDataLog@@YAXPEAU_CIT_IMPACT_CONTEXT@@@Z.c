/*
 * XREFs of ?CitpDPDataLog@@YAXPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C01F92C0
 * Callers:
 ...
 * Callees:
 *     ?CitpDPDataSave@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0034F08 (-CitpDPDataSave@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z.c)
...
void __fastcall CitpDPDataLog(struct _CIT_IMPACT_CONTEXT *a1)
{
  ...
  v1 = (char *)a1 + 592;
  v3 = 0x546000u / BYTE3(qword_1C0250494);
  v4 = 8.0 / (double)BYTE2(qword_1C0250494);
  memset(v88, 0, sizeof(v88));
  CitpDPCalcInit((struct _CIT_DP_CALC_CONTEXT *)v88, v4, (double)(((unsigned int)qword_1C0250494 >> 2) & 0xF) * 0.025);
  ...
  if ( CitpDPDataSave(a1) >= 0 )
  {
    ...
    for ( i = (_DWORD *)&v91 + 2; ; ++i )
    {
      ...
      *(float *)&v28 = COERCE_FLOAT(CitpDPProcessDuration(v6, (const struct _CIT_DP_CALC_CONTEXT *)v88, v25, v27));
      if ( (qword_1C0250494 & 1) != 0 )
      {
        if ( (unsigned int)dword_1C0245250 > 5 )
        {
          v29 = (float)v3;
          if ( tlgKeywordOn((__int64)&dword_1C0245250, 0x800000000800LL) )
          {
            v66 = (float)v3;
            v32 = v30 >> 2;
            v33 = v4;
            ...
            v68 = v33;
            LOWORD(v32) = v32 & 0xF;
            v76 = HIDWORD(xmmword_1C0250484) / 0x3E8;
            v62 = v32;
            v67 = *(float *)&v28;
            v56 = v25;
            v57 = 4;
...
LABEL_13:
          if ( (unsigned int)dword_1C0245250 > 5 && tlgKeywordOn((__int64)&dword_1C0245250, 0x400000000800LL) )
          {
            v38 = v4;
            v70 = v29;
            v69 = v38;
            ...
            v83 = v28;
            v79 = v24 / 0x3E8;
            LOWORD(v66) = ((unsigned int)qword_1C0250494 >> 2) & 0xF;
            v81 = v70;
            v82 = v69;
            v80 = HIDWORD(xmmword_1C0250484) / 0x3E8;
            v60 = v25;
            v61 = 4;
      ...
      else if ( (unsigned int)dword_1C0245250 > 5 )
      {
        v29 = (float)v3;
        if ( tlgKeywordOn((__int64)&dword_1C0245250, 0x400000000800LL) )
        {
          v67 = (float)v3;
          v36 = v34 >> 2;
          v37 = v4;
          ...
          v69 = v37;
          LOWORD(v36) = v36 & 0xF;
          v73 = HIDWORD(xmmword_1C0250484) / 0x3E8;
          v63 = v36;
          v70 = *(float *)&v28;
          v58 = v25;
          v59 = 4;
