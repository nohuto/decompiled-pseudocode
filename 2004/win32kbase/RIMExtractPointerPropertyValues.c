/*
 * XREFs of RIMExtractPointerPropertyValues @ 0x1C015FBA0
 * Callers:
 ...
 *     SignExtendLong @ 0x1C016335C (SignExtendLong.c)
        ...
        __int64 a7)
{
  ...
  if ( a1 )
  {
    if ( a5 <= *(_DWORD *)(a1 + 336) )
    {
      v15 = (struct _USAGE_AND_PAGE *)Win32AllocPoolZInit(4LL * *(unsigned int *)(a1 + 984), 2020635477LL);
      v48 = v15;
      if ( v15 )
      {
