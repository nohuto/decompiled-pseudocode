/*
 * XREFs of GreSfmCleanupPresentHistory @ 0x1C0060670
 * Callers:
...
_BYTE *GreSfmCleanupPresentHistory()
{
  ...
  LOBYTE(v1) = 1;
  v2 = v9;
  result = (_BYTE *)((__int64 (__fastcall *)(__int64 *, _QWORD, __int64, _QWORD))qword_1C024C868)(&v6, 0LL, v1, 0LL);
  if ( (int)result >= 0 )
  {
    v4 = (unsigned int)v6;
    if ( (_DWORD)v6 )
    {
      if ( (unsigned int)v6 <= 8 || (result = (_BYTE *)PALLOCMEM2((unsigned int)(20 * v6)), (v2 = result) != 0LL) )
      {
        ...
        v7 = v2;
        LOBYTE(v5) = 1;
        if ( (int)((__int64 (__fastcall *)(__int64 *, _QWORD, __int64, _QWORD))qword_1C024C868)(&v6, 0LL, v5, 0LL) >= 0
          && (_DWORD)v6
          && (unsigned int)v6 <= (unsigned int)v4 )
        {
          do
          {
            ...
            ((void (__fastcall *)(_DWORD *, _QWORD))qword_1C024C878)(v8, 0LL);
            ++v0;
          }
