/*
 * XREFs of NtUserReportInertia @ 0x1C0003BD0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
  ...
  if ( !v16 )
  {
    v19 = CInertiaManager::InvalidateInertiaInfo(Instance, *((_QWORD *)v14 + 52), v53);
    v21 = v19;
    if ( v19 )
      goto LABEL_12;
    if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
