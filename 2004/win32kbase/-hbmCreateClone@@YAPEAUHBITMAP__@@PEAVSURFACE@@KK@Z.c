/*
 * XREFs of ?hbmCreateClone@@YAPEAUHBITMAP__@@PEAVSURFACE@@KK@Z @ 0x1C0015380
 * Callers:
...
__int64 __fastcall hbmCreateClone(struct SURFACE *a1, int a2, int a3)
{
                       ...
                       0) )
  {
    ...
    if ( v9 < 0
      || (!qword_1C0251188
        ? (v10 = 0)
        : (v10 = ((__int64 (__fastcall *)(__int64, unsigned __int64, _QWORD, void *, __int64 *, __int64 *))qword_1C0251188)(
