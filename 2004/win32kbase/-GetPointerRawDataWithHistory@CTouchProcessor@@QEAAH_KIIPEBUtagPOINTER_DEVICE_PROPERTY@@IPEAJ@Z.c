/*
 * XREFs of ?GetPointerRawDataWithHistory@CTouchProcessor@@QEAAH_KIIPEBUtagPOINTER_DEVICE_PROPERTY@@IPEAJ@Z @ 0x1C0193360
 * Callers:
...
LABEL_22:
  ...
  else
  {
    ...
    if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      goto LABEL_33;
    LOBYTE(v33) = 3;
    WPP_RECORDER_SF_LL(v30, (_DWORD)v33, v31, 141, v52, a3, HistoryCount);
  }
  v33 = &WPP_RECORDER_INITIALIZED;
LABEL_33:
  ...
  LOBYTE(v33) = 5;
  WPP_RECORDER_SF_(v34->DeviceExtension, (_DWORD)v33, 7, v35, (__int64)&WPP_8113a81d21a7371434699e4b0bdc9bc8_Traceguids);
LABEL_65:
  CInpLockGuardExclusiveIfNeeded::~CInpLockGuardExclusiveIfNeeded(v55);
