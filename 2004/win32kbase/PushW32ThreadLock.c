/*
 * XREFs of PushW32ThreadLock @ 0x1C0030B70
 * Callers:
...
__int64 (__fastcall *__fastcall PushW32ThreadLock(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4))(_QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  result = qword_1C0251EC0;
  if ( qword_1C0251EC0 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD))qword_1C0251EC0(a1, a2, a3, a4);
  return result;
}
