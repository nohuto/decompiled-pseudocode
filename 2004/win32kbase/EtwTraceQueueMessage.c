/*
 * XREFs of EtwTraceQueueMessage @ 0x1C0024B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EtwTraceQueueMessage(__int64 a1)
{
  ...
  if ( !*(_DWORD *)(a1 + 24) )
  {
    ...
    v11 = &unk_1C0220028;
    v12 = CurrentProcess ? (void *)PsGetProcessImageFileName(CurrentProcess) : &unk_1C0220028;
  ...
  if ( (result & 4) != 0 )
  {
    if ( (Microsoft_Windows_Win32kEnableBits & 0x800) != 0 )
    {
      ...
      if ( W32GetThreadWin32Thread(KeGetCurrentThread()) )
        LOBYTE(v20) = *(_BYTE *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 1240);
      else
        LOBYTE(v20) = -1;
