/*
 * XREFs of ?SetPointerExplicitCapture@CTouchProcessor@@AEAAH_KAEBVCInputDest@@HH@Z @ 0x1C019A528
 * Callers:
        ...
        int a5)
{
  ...
  return CTouchProcessor::SetPointerCapture(this, a2, a3, 2LL, v5, a5);
}
