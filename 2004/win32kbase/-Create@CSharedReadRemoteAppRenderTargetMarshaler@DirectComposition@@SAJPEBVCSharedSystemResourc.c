/*
 * XREFs of ?Create@CSharedReadRemoteAppRenderTargetMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F4D00
 * Callers:
 *     CreateSharedReadRemoteAppRenderTargetMarshaler @ 0x1C01F4EE0 (CreateSharedReadRemoteAppRenderTargetMarshaler.c)
 * Callees:
