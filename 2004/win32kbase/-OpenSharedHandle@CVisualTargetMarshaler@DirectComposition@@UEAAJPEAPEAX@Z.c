/*
 * XREFs of ?OpenSharedHandle@CVisualTargetMarshaler@DirectComposition@@UEAAJPEAPEAX@Z @ 0x1C00A8120
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall DirectComposition::CVisualTargetMarshaler::OpenSharedHandle(
