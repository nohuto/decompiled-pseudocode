/*
 * XREFs of ?OnDisplayRequiredChange@CIT_USER_ACTIVE_TRACKER@@QEAAXII@Z @ 0x1C006164C
 * Callers:
...
LABEL_3:
  ...
  if ( *(_DWORD *)this && (unsigned int)(DWORD1(xmmword_1C0250474) + *((_DWORD *)this + 1)) < *((_DWORD *)this + 2) )
  {
    v5 = 0;
    goto LABEL_3;
  }
