/*
 * XREFs of EtwTraceFocusedProcessChange @ 0x1C0051AA0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall EtwTraceFocusedProcessChange(__int64 a1, __int64 a2)
{
  ...
  {
    LOBYTE(v4) = byte_1C0245748 - 1;
    if ( (unsigned __int8)(byte_1C0245748 - 1) > 2u && (qword_1C0245730 & 0x8000000000020000uLL) != 0 )
    {
      LOBYTE(v4) = 0;
      if ( (qword_1C0245738 & 0x8000000000020000uLL) == qword_1C0245738 )
      {
        v5 = 0;
        if ( a1 )
        {
