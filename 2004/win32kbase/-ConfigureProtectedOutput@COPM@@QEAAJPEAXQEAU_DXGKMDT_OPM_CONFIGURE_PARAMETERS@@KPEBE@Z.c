/*
 * XREFs of ?ConfigureProtectedOutput@COPM@@QEAAJPEAXQEAU_DXGKMDT_OPM_CONFIGURE_PARAMETERS@@KPEBE@Z @ 0x1C01438D8
 * Callers:
 *     NtGdiConfigureOPMProtectedOutput @ 0x1C0143DB0 (NtGdiConfigureOPMProtectedOutput.c)
 * Callees:
        ...
        unsigned __int8 *a5)
{
  ...
  v12 = this;
  v5 = qword_1C024CBD0;
  v9 = (PRKMUTEX *)((char *)qword_1C024CBD0 + 48);
