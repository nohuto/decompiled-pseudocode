/*
 * XREFs of ?SendRootPnp@PnP@IVRootDeliver@@YAJPEAUDEVICEINFO@@KAEBUCONTAINER_ID@@@Z @ 0x1C01B8BCC
 * Callers:
        ...
        const struct CONTAINER_ID *a4)
{
  ...
  if ( v22 )
  {
    v11 = CIVSerializer::Serialize((CIVSerializer *)&v20, (struct _UNICODE_STRING *)(v22 + 8), this + 13, 1);
    v12 = v11;
    if ( v11 < 0 )
    {
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    ...
    else
    {
      ...
      if ( v11 >= 0 )
      {
        ...
        *(_DWORD *)v14 = -16;
        *(_DWORD *)v15 = v5;
        *(_DWORD *)(v15 + 24) = LOBYTE(this[3].Length);
        v11 = CIVSerializer::Serialize((CIVSerializer *)&v20, (struct _UNICODE_STRING *)(v15 + 8), this + 13, 0);
        v12 = v11;
        if ( v11 >= 0 )
        {
          v16 = v20;
          ...
          *(_DWORD *)v22 = v5;
          ...
          LODWORD(v18) = LOBYTE(this[3].Length);
