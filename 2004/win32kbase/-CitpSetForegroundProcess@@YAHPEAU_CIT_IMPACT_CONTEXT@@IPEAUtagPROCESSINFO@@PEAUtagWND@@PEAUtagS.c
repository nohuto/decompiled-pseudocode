/*
 * XREFs of ?CitpSetForegroundProcess@@YAHPEAU_CIT_IMPACT_CONTEXT@@IPEAUtagPROCESSINFO@@PEAUtagWND@@PEAUtagSHELL_INPUT_USAGE_DATA_INFO@@@Z @ 0x1C006CF88
 * Callers:
 ...
 *     ?CitpInteractionSummariesFlush@@YAXPEAU_CIT_IMPACT_CONTEXT@@_N@Z @ 0x1C0037BBC (-CitpInteractionSummariesFlush@@YAXPEAU_CIT_IMPACT_CONTEXT@@_N@Z.c)
 ...
 *     ?CitpBitmapUpdateForTimeRange@@YAXPEAU_CIT_BITMAP@@IIII@Z @ 0x1C004A6D8 (-CitpBitmapUpdateForTimeRange@@YAXPEAU_CIT_BITMAP@@IIII@Z.c)
 ...
 *     ?CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEAA?AU1@AEBU1@@Z @ 0x1C006C5A8 (-CalculateDeltaFrom@CIT_USER_ACTIVITY_STAT@@QEAA-AU1@AEBU1@@Z.c)
 ...
 *     ?CitpProcessGetAppSessionId@@YA?AU_GUID@@PEAUtagPROCESSINFO@@PEAI@Z @ 0x1C009E91C (-CitpProcessGetAppSessionId@@YA-AU_GUID@@PEAUtagPROCESSINFO@@PEAI@Z.c)
 ...
 *     ?CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z @ 0x1C01FA104 (-CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z.c)
 */
        ...
        struct tagSHELL_INPUT_USAGE_DATA_INFO *a5)
{
  ...
  unsigned int v121; // [rsp+188h] [rbp-28h] BYREF
  unsigned int v122; // [rsp+18Ch] [rbp-24h] BYREF
  unsigned int v123; // [rsp+190h] [rbp-20h] BYREF
  struct tagSHELL_INPUT_USAGE_DATA_INFO *v124; // [rsp+198h] [rbp-18h] BYREF
  unsigned int v125; // [rsp+1A0h] [rbp-10h] BYREF
  int v126; // [rsp+1A4h] [rbp-Ch]
  unsigned int v127; // [rsp+1A8h] [rbp-8h] BYREF
  ...
  v130 = v12;
  if ( v13 > DWORD2(xmmword_1C0250474) )
  {
    v76 = 3;
LABEL_60:
  ...
  if ( a2 - *((_DWORD *)a1 + 144) > 2 * DWORD2(xmmword_1C0250474) )
  {
    v76 = 4;
    goto LABEL_60;
  }
LABEL_4:
  if ( a2 - *((_DWORD *)a1 + 206) >= HIDWORD(xmmword_1C0250484) )
    CitpDPDataLog(a1);
  if ( *((_QWORD *)a1 + 15) )
  {
    v14 = *((_DWORD *)a1 + 81);
    ...
    *((_DWORD *)a1 + 82) = v20;
    ...
    CIT_USER_ACTIVITY_STAT::CalculateDeltaFrom((unsigned int *)&v129, &v125, (unsigned int *)a1 + 46);
    CIT_USER_ACTIVITY_STAT::CalculateDeltaFrom((unsigned int *)&v130, &v127, (unsigned int *)a1 + 48);
    v23 = v116;
    v24 = v127;
    *((_DWORD *)a1 + 158) += v127;
    ...
    if ( dword_1C0245250 && (unsigned __int8)tlgKeywordOn(&dword_1C0245250, 0x800000000800LL, v21, v22) )
    {
      ...
      if ( HIBYTE(qword_1C0250494) )
      {
        ...
        *((_QWORD *)a1 + 104) = v32;
        ...
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C0245250, 0x800000000800LL, v32, v31) )
          {
            v119 = v117;
            v36 = *((_WORD *)a1 + 80);
            v115 = *((_WORD *)a1 + 81);
        ...
        if ( v77 )
        {
          ...
          *((_DWORD *)v77 + 20) = v79;
          if ( v81 + v92 >= v81 )
            v82 = v81 + v92;
          *((_DWORD *)v77 + 21) = v82;
          CitpProgDataNotifyUseUpdate(xmmword_1C02504A0, v77);
        }
      }
      if ( (xmmword_1C0250484 & 1) != 0 )
      {
        v44 = CitpInteractionSummaryEnsure(a1, v116, 2u);
        v45 = v44;
        if ( v44 )
        {
          v46 = *((_DWORD *)v44 + 33);
          ...
          *(_DWORD *)(v60 + 70) = v145;
          CitpBitmapUpdateForTimeRange(
            ...
            *((_DWORD *)a1 + 34),
            a2,
            *((_DWORD *)a1 + 218),
            DWORD2(xmmword_1C0250484));
        }
        if ( (xmmword_1C0250484 & 1) != 0 && a2 - *((_DWORD *)a1 + 218) > DWORD1(xmmword_1C0250484) )
  ...
  if ( v7 )
  {
    v61 = v7 & -(__int64)CitpAllowForegroundProcess(a1);
    v7 = v61;
    if ( v61 )
    {
      v7 = v61 & -(__int64)(CitpProcessEnsureContext((struct tagPROCESSINFO *)v61) != 0LL);
      v6 = v91;
    }
  }
  *((_QWORD *)a1 + 15) = v7;
  ...
  *(_DWORD *)((char *)a1 + 178) = 0;
  ...
  {
    v65 = *(_QWORD *)(v7 + 928);
    if ( dword_1C0245250 && (unsigned __int8)tlgKeywordOn(&dword_1C0245250, 0x800000000800LL, v62, v63) )
    {
      if ( (xmmword_1C0250484 & 1) != 0
      ...
      *(_DWORD *)((char *)a1 + 178) = v66;
      if ( HIBYTE(qword_1C0250494) )
      {
        ...
        *((_QWORD *)a1 + 104) = v69;
        ...
        if ( (unsigned int)dword_1C0245250 > 5 )
        {
          if ( (unsigned __int8)tlgKeywordOn(&dword_1C0245250, 0x800000000800LL, v69, v68) )
          {
            LODWORD(v124) = v118;
            v111 = v147;
            v88 = BYTE2(v147);
