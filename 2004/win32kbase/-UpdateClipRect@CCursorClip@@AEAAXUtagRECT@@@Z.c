/*
 * XREFs of ?UpdateClipRect@CCursorClip@@AEAAXUtagRECT@@@Z @ 0x1C00126F4
 * Callers:
 ...
 * Callees:
 *     SendAppClipChanged @ 0x1C00127E0 (SendAppClipChanged.c)
...
void __fastcall CCursorClip::UpdateClipRect(struct tagRECT *this, struct tagRECT *a2)
{
  ...
  if ( (int)left > (int)right || top > bottom )
    *a2 = *this;
  this[1] = *a2;
  if ( (unsigned int)dword_1C0246A70 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 64LL, right, left) )
  {
    v15 = this[1].bottom;
    v16 = this[1].right;
    v17 = this[1].top;
