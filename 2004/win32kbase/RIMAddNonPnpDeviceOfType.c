/*
 * XREFs of RIMAddNonPnpDeviceOfType @ 0x1C0157FF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_23:
          ...
          {
            v25 = 0LL;
            v9 = RIMCreateDev(v10, a3, p_DestinationString, 1LL, 0, 0LL, (struct _UNICODE_STRING **)&v25);
            if ( v9 >= 0 )
            {
              v18 = v25;
              *(_DWORD *)(v25 + 184) |= 1u;
        ...
        if ( (unsigned __int64)v6 >= MmUserProbeAddress )
          v6 = (const UNICODE_STRING *)MmUserProbeAddress;
