/*
 * XREFs of ?vAltUnlockFast@XDCOBJ@@QEAAXXZ @ 0x1C009249C
 * Callers:
 ...
 * Callees:
 *     ?ReleaseEntryLock@GdiHandleEntryTable@@QEAAXI@Z @ 0x1C008A2D0 (-ReleaseEntryLock@GdiHandleEntryTable@@QEAAXI@Z.c)
