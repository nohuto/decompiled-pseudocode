/*
 * XREFs of xxxODI_ColorInit @ 0x1C002E9F0
 * Callers:
 *     InitUserScreen @ 0x1C00139D8 (InitUserScreen.c)
 * Callees:
 *     ?CI_GetClrVal@@YAKPEAGK@Z @ 0x1C002EC64 (-CI_GetClrVal@@YAKPEAGK@Z.c)
...
__int64 __fastcall xxxODI_ColorInit(__int64 a1)
{
  ...
  *(_OWORD *)(v1 + 4584) = xmmword_1C020D320;
  *(_OWORD *)(v1 + 4600) = xmmword_1C020D330;
  *(_OWORD *)(v1 + 4616) = xmmword_1C020D340;
  *(_OWORD *)(v1 + 4632) = xmmword_1C020D350;
  *(_OWORD *)(v1 + 4648) = xmmword_1C020D360;
  *(_OWORD *)(v1 + 4664) = xmmword_1C020D370;
