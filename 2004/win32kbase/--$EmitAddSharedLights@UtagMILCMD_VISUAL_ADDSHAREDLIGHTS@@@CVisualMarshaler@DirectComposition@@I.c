/*
 * XREFs of ??$EmitAddSharedLights@UtagMILCMD_VISUAL_ADDSHAREDLIGHTS@@@CVisualMarshaler@DirectComposition@@IEAA_NAEBVCResourceMarshalerArray@1@W4MILCMD@@PEA_KPEAPEAVCBatch@1@@Z @ 0x1C00A0708
 * Callers:
