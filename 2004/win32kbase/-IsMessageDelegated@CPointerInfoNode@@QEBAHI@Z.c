/*
 * XREFs of ?IsMessageDelegated@CPointerInfoNode@@QEBAHI@Z @ 0x1C0195058
 * Callers:
 ...
 * Callees:
 *     ?IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z @ 0x1C0195034 (-IsMessageDelegated@CPointerInfoNode@@QEBAHHHHH@Z.c)
