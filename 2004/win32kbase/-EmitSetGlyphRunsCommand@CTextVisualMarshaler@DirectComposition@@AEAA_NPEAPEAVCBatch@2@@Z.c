/*
 * XREFs of ?EmitSetGlyphRunsCommand@CTextVisualMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01D42F0
 * Callers:
...
bool __fastcall DirectComposition::CTextVisualMarshaler::EmitSetGlyphRunsCommand(
        ...
        struct DirectComposition::CBatch ***a2)
{
  ...
  if ( (v2 & 2) != 0 )
  {
    v5 = *((_QWORD *)this + 47) == 0LL;
    *((_DWORD *)this + 115) = v2 & 0xFFFFFFFD;
    v6 = *((unsigned int *)this + 98);
    v7 = v5;
    while ( v6 < *((_QWORD *)this + 47) || v7 )
    {
      v7 = 0;
      ...
      if ( v8 < 0x18 )
      {
        ...
        {
          *((_DWORD *)this + 115) |= 2u;
          return *((unsigned int *)this + 98) == *((_QWORD *)this + 47);
        }
        v8 = v18;
      }
      v9 = *((unsigned int *)this + 98);
      v10 = (v8 - 20) >> 2;
      if ( *((_QWORD *)this + 47) - v9 < v10 )
        LODWORD(v10) = *((_DWORD *)this + 94) - v9;
      v19 = 0LL;
      ...
      *((_DWORD *)v11 + 3) = 4 * v10;
      ...
      if ( (_DWORD)v10 )
      {
        ...
        do
        {
          if ( (unsigned __int64)v13 >= *((_QWORD *)this + 47) )
          {
            v16 = 0LL;
          }
          else
          {
            _mm_lfence();
            v16 = *(_QWORD *)(*((_QWORD *)this + 46) + 8LL * v13);
          }
          ++v13;
