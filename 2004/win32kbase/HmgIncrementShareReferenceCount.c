/*
 * XREFs of HmgIncrementShareReferenceCount @ 0x1C0087570
 * Callers:
...
void __fastcall HmgIncrementShareReferenceCount(int *a1)
{
  ...
  if ( v21 )
  {
    ...
    if ( v5 == 5 )
    {
      ...
      if ( v6 && qword_1C02473D8 )
        NSInstrumentation::CReferenceTracker::CReferenceCountedType::ReferenceDereferenceCommon(qword_1C02473D8, v6, 1);
    }
    else if ( v5 == 16 )
    {
