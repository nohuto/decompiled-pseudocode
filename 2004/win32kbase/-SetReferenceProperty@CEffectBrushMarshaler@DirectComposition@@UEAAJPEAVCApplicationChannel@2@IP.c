/*
 * XREFs of ?SetReferenceProperty@CEffectBrushMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C003A2C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  if ( !*((_QWORD *)this + 11) )
  {
    ...
    if ( v19 )
    {
      ...
      {
        v21 = Win32AllocPoolWithQuotaZInit(8 * v20);
        *((_QWORD *)this + 11) = v21;
        if ( v21 )
