/*
 * XREFs of ?ProcessInputWithRateLimitingIfEnabled@Mouse@InputTraceLogging@@SAXPEAUDEVICEINFO@@_N_J22K@Z @ 0x1C01AF3D8
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 64LL) )
  {
    ...
    v33 = 4;
    v21 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0246A70, (unsigned __int8 *)dword_1C021ABD0, 0LL, 0LL, 8u, &v16);
  }
}
