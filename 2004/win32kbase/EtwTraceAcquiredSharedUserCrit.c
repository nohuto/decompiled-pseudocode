/*
 * XREFs of EtwTraceAcquiredSharedUserCrit @ 0x1C00916A0
 * Callers:
...
__int64 __fastcall EtwTraceAcquiredSharedUserCrit(__int64 a1)
{
  ...
  if ( result )
  {
    ...
    _InterlockedIncrement64(&qword_1C024CE90[v8 + 15]);
LABEL_9:
    _InterlockedExchangeAdd64((_QWORD *)&xmmword_1C024CFF8 + 1, v7);
    _InterlockedIncrement64((volatile signed __int64 *)&xmmword_1C024D018);
