/*
 * XREFs of ?SetInputRateLimitingTime@CMouseSensor@@QEAAJK@Z @ 0x1C00076C8
 * Callers:
 *     ?PostInitialize@CMouseSensor@@EEAAJXZ @ 0x1C0005760 (-PostInitialize@CMouseSensor@@EEAAJXZ.c)
 *     SetMouseInputRateLimitingTime @ 0x1C01ABFE0 (SetMouseInputRateLimitingTime.c)
 * Callees:
...
__int64 __fastcall CMouseSensor::SetInputRateLimitingTime(CMouseSensor *this, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && (unsigned __int8)tlgKeywordOn(&dword_1C0246A70, 64LL, v4, a4) )
  {
    v11 = 0;
    v9 = &v7;
    v7 = v6;
    v10 = 8;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0246A70, (int)&dword_1C021AD03, 0, 0, 3u, &v8);
  }
  return 0LL;
}
