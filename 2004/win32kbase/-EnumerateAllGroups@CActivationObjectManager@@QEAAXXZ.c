/*
 * XREFs of ?EnumerateAllGroups@CActivationObjectManager@@QEAAXXZ @ 0x1C0057220
 * Callers:
...
LABEL_10:
  ...
  while ( v5 )
  {
    ...
    v23 = 0LL;
    v24 = 0LL;
    InputExtensibilityCallout::CoreMsgSendMessage(v5, 11LL, &v22, 56LL, v21);
    if ( !v3 )
      goto LABEL_37;
    v5 = (_QWORD *)*v3;
