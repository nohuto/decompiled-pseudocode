/*
 * XREFs of ?EmitSetBrushCommand@CTextObjectMarshaler@DirectComposition@@AEAA_NPEAPEAVCBatch@2@@Z @ 0x1C01D30A0
 * Callers:
...
char __fastcall DirectComposition::CTextObjectMarshaler::EmitSetBrushCommand(
