/*
 * XREFs of NtGdiPolyPolyDraw @ 0x1C00C5440
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiPolyPolyDraw(__int64 a1, void *a2, void *a3, unsigned int a4, int a5)
{
  ...
  if ( a5 == 2 )
  {
    ...
    v23 = (int)qword_1C02517F8;
    if ( qword_1C02517F8 )
      v23 = qword_1C02517F8(a1, a2, a3, (unsigned int)v5);
    if ( v23 )
      return PolyPolygonRgnInternal;
  }
  else
...
LABEL_21:
      ...
      switch ( a5 )
      {
        case 1:
          if ( qword_1C02517E0 )
            v9 = qword_1C02517E0(a4, v26);
          if ( v9 >= 0 )
          {
            v18 = (__int64 (__fastcall *)(__int64, struct _POINTL *, unsigned int *, _QWORD, unsigned int))qword_1C02517E8;
            goto LABEL_28;
          }
          goto LABEL_67;
        case 2:
          if ( qword_1C0251810 )
            v9 = qword_1C0251810(a4, v26);
          if ( v9 >= 0 )
          {
            v18 = (__int64 (__fastcall *)(__int64, struct _POINTL *, unsigned int *, _QWORD, unsigned int))qword_1C0251818;
LABEL_28:
            if ( v18 )
            {
...
LABEL_30:
        ...
        case 3:
          if ( qword_1C0251800 )
            v9 = qword_1C0251800(a4, v26);
          if ( v9 < 0 )
            goto LABEL_67;
          v21 = (__int64 (__fastcall *)(__int64, struct _POINTL *, _QWORD))qword_1C0251808;
          break;
        case 4:
          if ( qword_1C0251830 )
            v9 = qword_1C0251830(a4, v26);
          if ( v9 < 0 )
            goto LABEL_67;
          v21 = (__int64 (__fastcall *)(__int64, struct _POINTL *, _QWORD))qword_1C0251838;
          break;
        case 5:
          if ( qword_1C0251820 )
            v9 = qword_1C0251820(a4, v26);
          if ( v9 >= 0 )
          {
            v21 = (__int64 (__fastcall *)(__int64, struct _POINTL *, _QWORD))qword_1C0251828;
            break;
          }
          break;
        case 6:
