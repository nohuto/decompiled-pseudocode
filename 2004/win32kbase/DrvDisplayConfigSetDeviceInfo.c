/*
 * XREFs of DrvDisplayConfigSetDeviceInfo @ 0x1C014A5A0
 * Callers:
...
__int64 __fastcall DrvDisplayConfigSetDeviceInfo(int *a1, __int64 a2)
{
  ...
  result = ((__int64 (__fastcall *)(int *, _QWORD, int *, int *))qword_1C024CA50)(
             a1 + 2,
             (unsigned int)a1[4],
             a1 + 2,
             a1 + 4);
    ...
    else
    {
      switch ( v10 )
      {
        ...
        case -16:
          if ( a1[1] != 68 )
            return -1073741811LL;
          v59 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C024C918)(0LL, a1);
          v11 = v59;
          if ( v59 < 0 )
            goto LABEL_58;
          if ( v59 != 259 )
        ...
        case -6:
          if ( a1[1] == 28 )
          {
            v58 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C024C918)(0LL, a1);
            v11 = v58;
            if ( v58 >= 0 )
            {
              if ( !a1[6] )
        ...
        case 5:
          ...
          v27 = ((__int64 (*)(void))qword_1C024C930)();
          v11 = v27;
          if ( v27 < 0 )
          {
          ...
          if ( (v31 & 1) != 0 )
          {
            ...
            if ( PathsModality < 0 )
            {
              ...
              {
                if ( (int)((__int64 (*)(void))qword_1C024C938)() < 0 )
                {
          ...
          v44 = ((__int64 (__fastcall *)(_QWORD, _QWORD, __int64, _QWORD))qword_1C024C900)(*(_QWORD *)v6, *v5, v43, 0LL);
          v11 = v44;
          if ( v44 >= 0 )
          {
            if ( !v32 )
...
LABEL_40:
        ...
        case 8:
          if ( a1[1] != 24 )
            return -1073741811LL;
          v25 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C024C918)(0LL, a1);
          v11 = v25;
          if ( v25 < 0 )
            goto LABEL_58;
LABEL_18:
...
LABEL_59:
        ...
        case 10:
          if ( a1[1] == 24 )
          {
            v14 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C024C918)(0LL, a1);
            v11 = v14;
            if ( v14 >= 0 )
            {
              if ( v14 == 255 )
...
LABEL_14:
    ...
    v61 = ((__int64 (__fastcall *)(_QWORD, int *))qword_1C024C918)(0LL, a1);
    v11 = v61;
    if ( v61 >= 0 )
      return (unsigned int)v11;
    goto LABEL_58;
