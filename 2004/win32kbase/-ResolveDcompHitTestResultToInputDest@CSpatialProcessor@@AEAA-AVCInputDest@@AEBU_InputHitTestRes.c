/*
 * XREFs of ?ResolveDcompHitTestResultToInputDest@CSpatialProcessor@@AEAA?AVCInputDest@@AEBU_InputHitTestResult@@K_K@Z @ 0x1C006ED0C
 * Callers:
  ...
  if ( !v4 )
  {
    ...
    if ( v9 )
    {
      ...
      if ( v10 )
      {
        ...
        LODWORD(v21[0]) |= 4u;
        *(_QWORD *)&v21[5] = v10;
        HIDWORD(v21[6]) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 16) + 416LL) + 1088LL);
      }
      if ( v11 )
      {
LABEL_8:
...
LABEL_20:
  ...
  v17 = (int)qword_1C02531B0;
  v18 = 0LL;
  if ( qword_1C02531B0 )
    v17 = qword_1C02531B0(*(_QWORD *)&v21[5]);
  if ( v17 )
  {
    if ( HIDWORD(v21[5]) != 2 )
      MicrosoftTelemetryAssertTriggeredNoArgsKM(v14, v13, v15, v16);
