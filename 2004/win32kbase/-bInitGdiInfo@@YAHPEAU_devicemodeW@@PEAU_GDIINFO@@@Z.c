/*
 * XREFs of ?bInitGdiInfo@@YAHPEAU_devicemodeW@@PEAU_GDIINFO@@@Z @ 0x1C001F888
 * Callers:
...
LABEL_8:
    a2->ulNumColors = -1;
    v6 = *((__int16 *)&unk_1C020D270 + 2 * v4);
    a2->ulPanningHorzRes = v6;
    a2->ulHorzRes = v6;
    v7 = *((__int16 *)&unk_1C020D270 + 2 * v4 + 1);
