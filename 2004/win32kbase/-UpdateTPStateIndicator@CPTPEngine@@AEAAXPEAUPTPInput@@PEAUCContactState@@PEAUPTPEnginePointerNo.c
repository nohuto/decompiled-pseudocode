/*
 * XREFs of ?UpdateTPStateIndicator@CPTPEngine@@AEAAXPEAUPTPInput@@PEAUCContactState@@PEAUPTPEnginePointerNode@@PEAH@Z @ 0x1C01C5A24
 * Callers:
 ...
 *     ?CrossedTPDragThreshold@CPTPEngine@@AEAAHPEAUCContactState@@UtagPOINT@@H@Z @ 0x1C01C0074 (-CrossedTPDragThreshold@CPTPEngine@@AEAAHPEAUCContactState@@UtagPOINT@@H@Z.c)
 *     ?CrossedTPTapWarpBackThreshold@CPTPEngine@@AEAAHPEAUCContactState@@UtagPOINT@@@Z @ 0x1C01C02B8 (-CrossedTPTapWarpBackThreshold@CPTPEngine@@AEAAHPEAUCContactState@@UtagPOINT@@@Z.c)
 *     ?PassedCurtainMoveThresholds@CPTPEngine@@AEAAH_K0PEAUCContactState@@@Z @ 0x1C01C29B0 (-PassedCurtainMoveThresholds@CPTPEngine@@AEAAH_K0PEAUCContactState@@@Z.c)
        ...
        int *a5)
{
  ...
  if ( *((_DWORD *)a4 + 3) )
  {
    ...
    v12 = (struct PTPInput *)*((unsigned int *)this + 958);
    if ( ((unsigned int)v12 & 0x4000000) != 0
      && (unsigned int)(*((_DWORD *)a2 + 6) - *((_DWORD *)this + 909)) > *((_DWORD *)this + 90) )
    {
      LODWORD(v12) = (unsigned int)v12 & 0xFBFFFFFF;
      *((_DWORD *)this + 958) = (_DWORD)v12;
    }
    v13 = *(_DWORD *)a3;
    if ( (*(_DWORD *)a3 & 0x40) == 0 && !PtInRect((_DWORD *)this + 942, v5) )
    {
      v13 |= 0x40u;
      *(_DWORD *)a3 = v13;
    }
      ...
      *(_DWORD *)a3 = v19;
      if ( (*((_DWORD *)a4 + 3) & 0x40000) == 0 )
      {
        ...
        if ( (v21 & 0x20000) == 0
           ...
           * (int)((HIDWORD(*((_QWORD *)a3 + 5)) - HIDWORD(v5)) * (HIDWORD(*((_QWORD *)a3 + 5)) - HIDWORD(v5))) >= *((unsigned int *)this + 89) * (unsigned __int64)*((unsigned int *)this + 88) )
        {
          v21 |= 0x20000u;
          *(_DWORD *)a3 = v21;
        }
        ...
        if ( (v19 & 0x4000000) == 0 )
        {
          ...
          if ( v23 * (int)((*((_QWORD *)a3 + 1) - v5) * (*((_QWORD *)a3 + 1) - v5))
             + v22 * (int)((HIDWORD(*((_QWORD *)a3 + 1)) - HIDWORD(v5)) * (HIDWORD(*((_QWORD *)a3 + 1)) - HIDWORD(v5))) >= (unsigned __int64)(v23 * v22) )
          {
            v19 |= 0x4000000u;
            *(_DWORD *)a3 = v19;
          }
      ...
      v24 = *((_QWORD *)this + 456);
      v25 = v8 - *((_QWORD *)a3 + 8);
      v26 = v19 & 0xFFFFFFDF | (*((_QWORD *)this + 458) < v25 ? 0x20 : 0);
      *(_DWORD *)a3 = v26;
      v27 = v26 & 0xFFFBFFFF | (*((_QWORD *)this + 459) < v25 ? 0x40000 : 0);
      *(_DWORD *)a3 = v27;
      v28 = v27 & 0xFFF7FFFF | (*((_QWORD *)this + 460) < v25 ? 0x80000 : 0);
      *(_DWORD *)a3 = v28;
      v29 = v28 & 0xFFEFFFFF | (*((_QWORD *)this + 461) < v25 ? 0x100000 : 0);
      *(_DWORD *)a3 = v29;
      v30 = v29 & 0xFFDFFFFF | (*((_QWORD *)this + 459) < (unsigned __int64)(v8 - v24) ? 0x200000 : 0);
      *(_DWORD *)a3 = v30;
      v31 = v30;
      if ( (v30 & 0x10) == 0 && (unsigned __int64)(v8 - *((_QWORD *)a3 + 9)) > *((_QWORD *)this + 457) )
      {
        v31 = v30 | 0x10;
        *(_DWORD *)a3 = v30 | 0x10;
        *a5 = 1;
      }
      if ( (v31 & 0x800000) == 0 && v25 > *((_QWORD *)this + 462) )
      {
        v31 |= 0x800000u;
        *(_DWORD *)a3 = v31;
      }
      if ( (v31 & 0x80u) == 0
        && (*((_DWORD *)this + 958) & 0x20000) != 0
    ...
    else
    {
      ...
      *(_DWORD *)a3 = v15;
      *((_DWORD *)a3 + 34) = 0;
      if ( !*((_DWORD *)this + 879) || (v16 = 0x2000, *((_DWORD *)this + 887) == 1) )
        v16 = 0;
      *((_DWORD *)a3 + 35) = 0;
      v17 = v15 & 0x1F3E1A3F | v16 & 0x1F3E3A3F | 0xC0000000;
      *(_DWORD *)a3 = v17;
      if ( (unsigned int)(*((_DWORD *)this + 887) - 1) <= 1
        && *(_QWORD *)a2 - *((_QWORD *)this + 469) >= *((_QWORD *)this + 12)
