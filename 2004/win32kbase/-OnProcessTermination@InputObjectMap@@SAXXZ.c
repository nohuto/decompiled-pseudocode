/*
 * XREFs of ?OnProcessTermination@InputObjectMap@@SAXXZ @ 0x1C003D3A4
 * Callers:
 *     DestroyProcessInfo @ 0x1C0078F74 (DestroyProcessInfo.c)
 * Callees:
 *     ??0CAutoPushLockEx@@QEAA@PEAU_EX_PUSH_LOCK@@@Z @ 0x1C003D464 (--0CAutoPushLockEx@@QEAA@PEAU_EX_PUSH_LOCK@@@Z.c)
 */
...
LABEL_3:
      for ( i = v4 + 1; ; ++i )
      {
        if ( i >= (_QWORD *)((char *)Buffer + 8 * ((unsigned __int64)(unsigned int)dword_1C0250464 >> 5)) )
        {
          v7 = 0LL;
          goto LABEL_6;
        }
