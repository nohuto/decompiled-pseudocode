/*
 * XREFs of ?FlushHoldingBuffer@Mouse@InputTraceLogging@@SAXPEAUDEVICEINFO@@@Z @ 0x1C01AEF24
 * Callers:
...
void __fastcall InputTraceLogging::Mouse::FlushHoldingBuffer(struct DEVICEINFO *a1)
{
  ...
  if ( (unsigned int)dword_1C0246A70 > 4 && tlgKeywordOn((__int64)&dword_1C0246A70, 64LL) )
  {
    ...
    v2 = v1;
    v5 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C0246A70, (unsigned __int8 *)dword_1C021ACC7, 0LL, 0LL, 3u, &v3);
  }
}
