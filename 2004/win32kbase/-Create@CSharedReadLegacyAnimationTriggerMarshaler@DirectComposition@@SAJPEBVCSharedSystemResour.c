/*
 * XREFs of ?Create@CSharedReadLegacyAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C01F4BB0
 * Callers:
 *     CreateSharedReadLegacyAnimationTriggerMarshaler @ 0x1C01F4C90 (CreateSharedReadLegacyAnimationTriggerMarshaler.c)
 * Callees:
