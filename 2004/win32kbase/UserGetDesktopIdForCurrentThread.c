/*
 * XREFs of UserGetDesktopIdForCurrentThread @ 0x1C00A9A40
 * Callers:
...
__int64 __fastcall UserGetDesktopIdForCurrentThread(__int64 a1)
{
  ...
  if ( InputTraceLogging::Perf::s_userCritLoggingEnabled )
  {
    ...
    v26 = v24;
    if ( v24 && (*(int *)(v24 + 24) > 0 || *(_DWORD *)(v26 + 48)) )
    {
  ...
  {
    v22 = *(__int64 ***)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 448) + 8LL);
    v19 = *v22;
    v1 = **v22;
  }
