/*
 * XREFs of sub_1C002F348 @ 0x1C002F348
 * Callers:
...
LONG __fastcall sub_1C002F348(__int64 a1, __int64 a2, __int64 a3)
{
  int v6; // eax
  int v7; // r11d

  sub_1C000F050(a1);
  v6 = sub_1C002EF2C(a3, a2, 5);
  sub_1C000FD80(a1, 0x8000, 1718383411, v6, *(unsigned __int16 *)(a2 + 4));
  if ( v7 == 4 )
  {
