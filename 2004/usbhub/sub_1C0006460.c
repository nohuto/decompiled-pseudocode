/*
 * XREFs of sub_1C0006460 @ 0x1C0006460
 * Callers:
...
__int64 __fastcall sub_1C0006460(PDEVICE_OBJECT DeviceObject, __int64 a2)
{
  __int64 v2; // rbp
...
LABEL_140:
  ...
  if ( *(_DWORD *)(v2 + 128) == 2 && (int)sub_1C0015BF8(DeviceObject) < 0 )
  {
  ...
  else
  {
    for ( i = 1; ; ++i )
    {
      ...
      if ( *(_DWORD *)v11 != 541218120 )
        sub_1C002DC78(DeviceObject, v11);
      if ( i > v11[2938] )
        break;
      ...
      if ( i )
      {
        ...
        if ( *(_DWORD *)v13 != 541218120 )
          sub_1C002DC78(DeviceObject, v13);
        if ( i > v13[2938] )
        {
          v15 = 0LL;
          v74 = 0LL;
      ...
      v25 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels);
        ...
        if ( i <= v28[2938] )
        {
          ...
          if ( v29 )
          {
            ...
            if ( v30 )
            {
              ...
              if ( v22 )
              {
                v63 = sub_1C0011220(*(_QWORD *)(v30 + 392));
      ...
      KeReleaseSpinLock((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels, v25);
      if ( v22 )
      {
        v67 = sub_1C0011220(v22);
        KeWaitForSingleObject((PVOID)(v67 + 2896), Executive, 0, 0, 0LL);
        *(_DWORD *)(v67 + 1420) |= 0x10000000u;
        KeSetEvent((PRKEVENT)(v67 + 2896), 0, 0);
        sub_1C000FD80((_DWORD)DeviceObject, 256, 1968194639, v22, 1348564304LL);
        LOBYTE(v67) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels);
        stru_1C006B480.Dpc.DeferredRoutine = (PKDEFERRED_ROUTINE)&stru_1C006B480.Dpc.DeferredContext;
        sub_1C0003770((__int64)DeviceObject, v22, 0LL, 0x50617550u);
        stru_1C006B480.Dpc.DeferredRoutine = 0LL;
        KeReleaseSpinLock((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels, v67);
      }
      HIDWORD(v75) = 0;
      ...
      if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(::DeviceObject->DeviceType) )
        sub_1C002E188(::DeviceObject->DeviceExtension, 0, 1, 79, (__int64)&unk_1C0062098, i);
      if ( (dword_1C006B268 & 8) != 0 )
      {
      ...
      if ( i )
      {
        ...
        if ( *(_DWORD *)v37 != 541218120 )
          sub_1C002DC78(DeviceObject, v37);
        if ( i <= v37[2938] )
        {
          v38 = *((_QWORD *)v37 + 382);
          if ( v38 )
          {
            ...
            if ( v39 )
              sub_1C0007840((_DWORD)DeviceObject, v39, 4, a2, v75, 0, 0LL, 0LL);
          }
        }
      }
      if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(::DeviceObject->DeviceType) )
        sub_1C002E188(::DeviceObject->DeviceExtension, 0, 1, 80, (__int64)&unk_1C0062098, i);
      v41 = DeviceObject->DeviceExtension;
      if ( !v41 )
        goto LABEL_140;
      if ( *v41 != 541218120 )
        sub_1C002DC78(DeviceObject, v41);
      if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(::DeviceObject->DeviceType) )
        sub_1C002E55C(::DeviceObject->DeviceExtension, (_DWORD)v41, v32, 66, (__int64)&unk_1C0062098, i, a2);
      if ( (dword_1C006B268 & 0x200) != 0 )
      {
      ...
      if ( i )
      {
        ...
        if ( *(_DWORD *)v46 != 541218120 )
          sub_1C002DC78(DeviceObject, v46);
        if ( i <= v46[2938] )
        {
          v47 = *((_QWORD *)v46 + 382);
          if ( v47 )
          {
            ...
            if ( v48 )
            {
              sub_1C0007840((_DWORD)DeviceObject, v48, 2, a2, 0LL, 0, 0LL, 0LL);
              v50 = 0LL;
              ...
              v54 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels);
              stru_1C006B480.Dpc.DeferredRoutine = (PKDEFERRED_ROUTINE)&stru_1C006B480.Dpc.DeferredContext;
              if ( (dword_1C006B268 & 8) != 0 )
              {
              ...
              if ( (_WORD)v51 )
              {
                ...
                if ( *(_DWORD *)v57 != 541218120 )
                  sub_1C002DC78(DeviceObject, v57);
                if ( (unsigned __int16)v51 <= v57[2938] )
                {
                  ...
                  if ( v58 )
                  {
                    ...
                    if ( v59 )
                    {
                      ...
                      if ( v50 )
                      {
                        v68 = sub_1C0011220(*(_QWORD *)(v59 + 392));
                        v69 = (char *)ExAllocatePoolWithTag(PoolType, 0x30uLL, 0x42554855u);
                        if ( v69 )
                        {
                          *(_QWORD *)(v69 + 4) = 0LL;
                          *(_QWORD *)(v69 + 12) = 0LL;
...
LABEL_134:
              ...
              stru_1C006B480.Dpc.DeferredRoutine = 0LL;
              KeReleaseSpinLock((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels, v54);
              if ( v50 )
              {
                v72 = *(_DWORD *)(v48 + 400);
                *(_QWORD *)(v48 + 376) = v48 + 24;
                *(_DWORD *)(v48 + 416) = 1;
                sub_1C00023E0((__int64)DeviceObject, v72, v48, v50);
                *(_QWORD *)(v48 + 376) = 0LL;
                if ( *(_DWORD *)(v48 + 416) )
                {
                  sub_1C000FD80((_DWORD)DeviceObject, 1024, 1970032689, v50, v48);
                  v73 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels);
                  stru_1C006B480.Dpc.DeferredRoutine = (PKDEFERRED_ROUTINE)&stru_1C006B480.Dpc.DeferredContext;
                  *(_DWORD *)(v48 + 416) = 0;
                  sub_1C000FD80((_DWORD)DeviceObject, 1024, 1970032690, v50, v48);
                  sub_1C0003770((__int64)DeviceObject, v50, 0LL, 0x7050444Fu);
                  stru_1C006B480.Dpc.DeferredRoutine = 0LL;
                  KeReleaseSpinLock((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels, v73);
                }
                else
                {
                  *(_DWORD *)(v48 + 400) = 0;
