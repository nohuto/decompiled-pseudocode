/*
 * XREFs of sub_1C005A9D0 @ 0x1C005A9D0
 * Callers:
...
__int64 __fastcall sub_1C005A9D0(__int64 a1, _OWORD *a2)
{
  unsigned int v2; // edi
  ...
  *a2 = 0LL;
  ...
  if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 )
  {
    if ( LOWORD(DeviceObject->DeviceType) )
      sub_1C002E188((__int64)DeviceObject->DeviceExtension, 0, 1u, 0x3Eu, (__int64)&unk_1C0063940, v4);
    if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
      sub_1C003B2A0(
