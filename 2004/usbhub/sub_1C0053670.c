/*
 * XREFs of sub_1C0053670 @ 0x1C0053670
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1C0053670(__int64 a1, _DWORD *a2, unsigned __int16 *a3, unsigned __int64 a4)
{
  __int64 v8; // r9
  int v9; // r8d
...
LABEL_18:
  ...
  do
  {
    ...
    if ( (unsigned int)v13 < 9 )
    {
      ...
      if ( !*((_BYTE *)&off_1C0061D40 + 8 * v14 + 9) )
      {
        sub_1C000FD80(a1, 256, 1447449395, v11[1], 0LL);
        v12 = 0;
      }
