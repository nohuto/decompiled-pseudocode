/*
 * XREFs of sub_1C0053480 @ 0x1C0053480
 * Callers:
...
char __fastcall sub_1C0053480(__int64 a1, __int64 a2, unsigned int *a3)
{
  _DWORD *v5; // rax
  __int64 v6; // r9
  _DWORD *v7; // rdi
...
LABEL_3:
    sub_1C000FD80(a1, 256, v11, v9, v16);
    return 0;
  }
  ...
  if ( *v10 != 10 )
  {
    sub_1C000FD80(a1, 256, 1447907122, *v10, 0LL);
    return 0;
  }
  v13 = v10[4];
  if ( (_WORD)v6 != (_WORD)v13 )
  {
    sub_1C000FD80(a1, 256, 1447907123, v6, v10[4]);
    return 0;
  }
  ...
  do
  {
    ...
    if ( v15 < 9 )
    {
      v8 = ((unsigned __int8 (__fastcall *)(__int64, _DWORD *, unsigned __int16 *, unsigned __int64))*(&off_1C0061D40 + 2 * v10[1]))(
             a1,
             v7 + 706,
             v10,
             v14) != 0
      ...
      {
        sub_1C000FD80(a1, 256, 1447907125, 0LL, 0LL);
        v8 = 0;
      }
    }
    if ( !sub_1C003321C(v14, &v17) )
    {
      sub_1C000FD80(a1, 256, 1447907126, 0LL, 0LL);
      v8 = 0;
    }
    v10 = v17;
  }
