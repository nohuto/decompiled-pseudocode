/*
 * XREFs of sub_1C004DB30 @ 0x1C004DB30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1C004DB30(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
  {
    ...
    sub_1C002E188((__int64)DeviceObject->DeviceExtension, 0, 1u, 0x14u, (__int64)&unk_1C0062100, v7);
  }
  sub_1C000FD80(a1, 1024, 1884443492, a2, 0LL);
