/*
 * XREFs of sub_1C0042600 @ 0x1C0042600
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1C0042600(struct _DEVICE_OBJECT *Context, PIRP Irp)
{
  ...
  sub_1C000FD80((__int64)Context, 2, 1715754318, 0LL, (__int64)Irp);
    ...
    && (Status >= 0 && Options == 1 && CurrentStackLocation->Parameters.SetLock.Lock || Options == 4) )
  {
    ...
    if ( !_InterlockedCompareExchange64((volatile signed __int64 *)v6 + 659, (signed __int64)v10, 0LL) )
    {
      ...
      *((_BYTE *)v6 + 5268) = 1;
      ...
      if ( IoSetCompletionRoutineEx(Context, v10, sub_1C0043AE0, Context, 1u, 1u, 1u) < 0 )
      {
        v12 = v10->Tail.Overlay.CurrentStackLocation;
        v12[-1].CompletionRoutine = sub_1C0043AE0;
