/*
 * XREFs of sub_1C003D8B8 @ 0x1C003D8B8
 * Callers:
...
__int64 __fastcall sub_1C003D8B8(__int64 a1, int a2)
{
  __int64 v3; // rdi
  _DWORD *v4; // rbp
  unsigned int v5; // esi
  ...
  {
    v8 = v3;
    sub_1C002E188((__int64)DeviceObject->DeviceExtension, 0, 1u, 0x12u, (__int64)&unk_1C0062E08, v8);
  }
  if ( (_DWORD)v3 == 4 || (_DWORD)v3 == 7 )
  {
    v6 = sub_1C0031838(*(_QWORD *)(a1 + 8), a1, 1u);
