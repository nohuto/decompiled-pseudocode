/*
 * XREFs of sub_1C001AC00 @ 0x1C001AC00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1C001AC00(__int64 a1, __int64 a2)
{
  ...
  if ( KeReadStateEvent(v3 + 143) )
  {
    ...
    if ( *(_DWORD *)v5 != 541218120 )
      sub_1C002DC78(a2, v5);
    if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
      sub_1C002E188(DeviceObject->DeviceExtension, 0, 1, 45, (__int64)&unk_1C0062088, 0);
    PoolWithTag = ExAllocatePoolWithTag(PoolType, 0x48uLL, 0x42554855u);
        ...
        if ( v13 )
        {
          ...
          *(_QWORD *)(v10 + 16) = a2;
          ...
          if ( *(_DWORD *)(v10 + 4) != 2001228627 )
            sub_1C000FD80(a2, 8, 1464552747, 0LL, v10);
          ...
          if ( v14 )
          {
            ...
            {
              LOBYTE(v17) = v6;
              v15(a2, *(_QWORD *)(v10 + 40), sub_1C001A220, 1LL, v10, v17);
            }
            else
            {
              v8 = -1073741822;
