/*
 * XREFs of sub_1C0008BD0 @ 0x1C0008BD0
 * Callers:
...
__int64 __fastcall sub_1C0008BD0(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 *a4)
{
  __int64 v5; // r9
  __int64 v8; // r15
  __int64 v9; // rdx
  ...
  {
    sub_1C002E55C(DeviceObject->DeviceExtension, v9, (unsigned __int16)v9, 88, (__int64)&unk_1C0062098, v9, 0);
    v11 = *(_WORD *)(a2 + 4);
    v5 = a3;
  }
  if ( (dword_1C006B268 & 0x200) != 0 )
  ...
  v20 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels);
    ...
    if ( v24 )
    {
      ...
      if ( v25 )
      {
        ...
        if ( v16 )
        {
          v53 = *(_QWORD *)(v16 + 64);
          if ( !v53 )
            sub_1C002DC78(*(_QWORD *)(v25 + 392), 0LL);
          if ( *(_DWORD *)v53 != 1329877064 )
            sub_1C002DC78(*(_QWORD *)(v25 + 392), *(_QWORD *)(v16 + 64));
  ...
  *(_WORD *)(a2 + 420) = v27;
  ...
  if ( (*(_WORD *)(a2 + 420) & 0x108) == 0 )
  {
    ...
    if ( (v76 & 0x80008) == 0 )
    {
      ...
      {
        sub_1C002E188(DeviceObject->DeviceExtension, 0, 1, 93, (__int64)&unk_1C0062098, *(_WORD *)(a2 + 4));
        v77 = a3;
        v76 = *(unsigned int *)(a3 + 8);
      }
      sub_1C000FD80(a1, 512, 1886353240, v30, v76);
      v30 &= ~8u;
      sub_1C00015A0(a1, a2);
      sub_1C0034E5C(a1, a2);
      sub_1C004A608(a1, *(unsigned __int16 *)(a2 + 4), 60, v77, 56, 0, 0, (__int64)aPchangeC, 5582, 0);
      v37 = a3;
    }
  }
  v41 = *(_DWORD *)(v37 + 8);
...
LABEL_67:
    if ( (*(_DWORD *)(v37 + 8) & 0x20000) == 0 || (v75 = *(_QWORD *)(v37 + 40), v75 == v16) )
    {
      if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
      {
        sub_1C002E188(DeviceObject->DeviceExtension, 0, 1, 94, (__int64)&unk_1C0062098, *(_WORD *)(a2 + 4));
        v37 = a3;
      }
      v49 = *(_DWORD *)(a2 + 400);
      if ( v49 )
        ...
        if ( v71 )
        {
          ...
          if ( v72 )
          {
            ...
            if ( v73 )
            {
              ...
              {
                if ( v74 == 1 )
                  *(_DWORD *)(a2 + 400) = sub_1C001BDDC(a1, *(_QWORD *)(v37 + 8), v30, a2, v16);
              }
              else
              {
                if ( (*(_DWORD *)(v37 + 8) & 8) != 0 )
                {
                  *(_DWORD *)(a2 + 400) = sub_1C004C954(a1, 4, v38, a2, v16);
                }
                else
                {
                  *(_DWORD *)(a2 + 400) = 4;
                  ...
                  if ( (v83 & 0x20000) != 0 )
                  {
                    sub_1C001518C(a1, v16, 3221225473LL);
                    sub_1C0017FEC(a1, a2);
                    v84 = a3;
                    v83 = *(_DWORD *)(a3 + 8);
                  }
                  ...
                  if ( (v83 & 0x100000) != 0 )
                  {
                    ...
                    if ( v30 == 1 )
                    {
                      ...
                      sub_1C004C7A4(a1, a2, v16);
                    }
                  }
                }
                if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
                  sub_1C002E0B4(DeviceObject->DeviceExtension, 0, 1, 96, (__int64)&unk_1C0062098);
                sub_1C000FD80(a1, 512, 1885435206, *(unsigned __int16 *)(a2 + 420), v30);
              }
            }
            else
            {
              if ( (*(_DWORD *)(v37 + 8) & 8) != 0 )
                sub_1C004C954(a1, 3, v38, a2, v16);
              *(_DWORD *)(a2 + 400) = 3;
              if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
                sub_1C002E0B4(DeviceObject->DeviceExtension, 0, 1, 95, (__int64)&unk_1C0062098);
              sub_1C000FD80(a1, 512, 1701999174, *(unsigned __int16 *)(a2 + 420), v30);
            }
          }
          else
          {
            *(_DWORD *)(a2 + 400) = sub_1C004C428(a1, *(_QWORD *)(v37 + 8), v30, a2, v16);
          }
        }
        else
        {
          *(_DWORD *)(a2 + 400) = sub_1C001C7A8(a1, *(_QWORD *)(v37 + 8), v30, a2, v16);
        }
      }
      else
      {
        *(_DWORD *)(a2 + 400) = sub_1C000ABD0(a1, *(_QWORD *)(v37 + 8), v30, a2, v16);
      }
    }
    else
    {
      sub_1C000FD80(a1, 512, 1685222994, v75, *(unsigned int *)(v37 + 8));
      sub_1C001518C(a1, *(_QWORD *)(v82 + 40), 3221225486LL);
      sub_1C0017FEC(a1, a2);
    }
    goto LABEL_73;
  }
  ...
  if ( *(_DWORD *)v57 != 1329877064 )
    sub_1C002DC78(v16, *(_QWORD *)(v16 + 64));
  if ( !*(_BYTE *)(v57 + 2740) || (*(_BYTE *)(a2 + 420) & 1) != 0 )
  {
    if ( (*(_DWORD *)(v57 + 1420) & 0x400000) != 0 )
    {
      ...
      {
        sub_1C000FD80(a1, 512, 1144213585, HIBYTE(*(_DWORD *)(v57 + 1420)) & 1, *(unsigned __int16 *)(a2 + 420));
  ...
  if ( (v78 & 0x30008) != 0 )
  {
    if ( (v78 & 0x30000) != 0 )
    {
      sub_1C000FD80(a1, 512, 1650742098, *(_QWORD *)(v37 + 40), *(unsigned int *)(v37 + 8));
      sub_1C001518C(a1, v16, 3221225473LL);
      sub_1C0017FEC(a1, a2);
      v78 = *(unsigned int *)(a3 + 8);
    }
    sub_1C000FD80(a1, 512, 1650741836, 0, v78);
    v79 = *(unsigned __int16 *)(a2 + 4);
    if ( *(_DWORD *)(v8 + 3072) == v79 )
    {
      v80 = *(_QWORD *)(a2 + 376);
      if ( *(_QWORD *)(v8 + 3080) == v80 )
        sub_1C00029EC(a1, v80, v79);
    }
    LOBYTE(v86) = 1;
    sub_1C004A608(a1, 0, 62, 0, 0, -1073741823, -1073704960, (__int64)aPchangeC, 5639, v86);
  }
LABEL_73:
  if ( !*(_DWORD *)(a2 + 416) )
    goto LABEL_74;
  if ( (dword_1C006B268 & 0x400) != 0 )
  {
    v58 = *(_QWORD *)(a1 + 64);
    if ( v58 )
    {
  ...
  v88 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels);
  stru_1C006B480.Dpc.DeferredRoutine = (PKDEFERRED_ROUTINE)&stru_1C006B480.Dpc.DeferredContext;
  *(_DWORD *)(a2 + 416) = 0;
  if ( (dword_1C006B268 & 0x400) != 0 )
  {
...
LABEL_114:
  ...
  stru_1C006B480.Dpc.DeferredRoutine = 0LL;
  KeReleaseSpinLock((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels, v88);
LABEL_74:
  if ( (dword_1C006B268 & 0x200) != 0 )
  {
    v50 = *(_QWORD *)(a1 + 64);
  ...
  if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
    sub_1C002E188(DeviceObject->DeviceExtension, 0, 1, 97, (__int64)&unk_1C0062098, *(_WORD *)(a2 + 4));
