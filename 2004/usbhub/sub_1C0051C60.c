/*
 * XREFs of sub_1C0051C60 @ 0x1C0051C60
 * Callers:
...
__int64 sub_1C0051C60(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, __int64 a5, const wchar_t *a6, ...)
{
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 1) != 0 )
  {
    ...
    if ( !a6 )
      v12 = L"NULL";
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, __int64, _QWORD, const wchar_t *, __int64, __int64 *, __int64, char *, __int64, _QWORD))qword_1C006B728)(
