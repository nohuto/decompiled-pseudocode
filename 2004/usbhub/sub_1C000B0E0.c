/*
 * XREFs of sub_1C000B0E0 @ 0x1C000B0E0
 * Callers:
...
_UNKNOWN **sub_1C000B0E0(__int64 a1, __int64 a2, char a3, ...)
{
  _DWORD *v6; // rdx
  KIRQL v7; // al
  __int64 v8; // rdx
  ...
  *(_QWORD *)(v16 + 24) = 0LL;
  ...
  if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
    sub_1C002E55C(DeviceObject->DeviceExtension, v8, v19, 19, (__int64)&unk_1C0062098, *(_WORD *)(a2 + 4), a3);
  if ( (v80 & 0x80000) != 0 )
  {
    v23 = *(_QWORD *)(a1 + 64);
    if ( v23 )
...
LABEL_31:
  if ( (_DWORD)v17 == 2 )
  {
    v28 = v83;
    v29 = v82;
    v30 = sub_1C000B870(a1, (unsigned __int16)v18, (unsigned int)va, v82, v83);
    ...
    {
      if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
        sub_1C002E188(DeviceObject->DeviceExtension, 0, 1, 20, (__int64)&unk_1C0062098, v18);
      ...
      *(_DWORD *)(v42 + a2 + 1384) = v38;
      ...
      if ( *(_DWORD *)(a2 + 2412) != 1 )
      {
        *(_DWORD *)(a2 + 2412) = 1;
        ...
        IoQueueWorkItem(*(PIO_WORKITEM *)(a2 + 2456), (PIO_WORKITEM_ROUTINE)WorkerRoutine, DelayedWorkQueue, (PVOID)a2);
      }
      KeReleaseSpinLock((PKSPIN_LOCK)(a2 + 2448), v43);
      LOBYTE(v17) = v78;
      goto LABEL_52;
    }
    sub_1C000FD80(a1, 8, 1902727218, a2, v18);
    if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
      sub_1C002E354(DeviceObject->DeviceExtension, v74, 1, 21, (__int64)&unk_1C0062098, v18, v76);
    if ( v29 == 1 )
    {
      sub_1C000FD80(a1, 512, 1902735480, v28, *(unsigned __int16 *)(a2 + 4));
      sub_1C001518C(a1, v28, 3221225473LL);
  ...
  else
  {
    switch ( (int)v17 )
    {
      case 1:
      case 18:
        sub_1C000FD80(a1, 512, 1597272118, 0, *(unsigned __int16 *)(a2 + 4));
        if ( off_1C006B000 == v70 )
          goto LABEL_81;
        v59 = DeviceObject;
        if ( LOWORD(DeviceObject->DeviceType) == v69 )
          goto LABEL_81;
        v60 = 25;
        goto LABEL_80;
      case 3:
      case 14:
        sub_1C000FD80(a1, 512, 1597272116, 0, *(unsigned __int16 *)(a2 + 4));
        if ( off_1C006B000 != v63 && LOWORD(DeviceObject->DeviceType) != v61 )
          sub_1C002E188(DeviceObject->DeviceExtension, 0, 1, 23, v62, v18);
        sub_1C000B870(a1, (unsigned __int16)v18, (unsigned int)va, v82, v83);
        v64 = 32LL * *(unsigned int *)(a2 + 2400);
        *(_DWORD *)(a2 + 12) = 14;
        *(_DWORD *)(v64 + a2 + 1384) = 14;
        break;
      case 4:
        sub_1C000FD80(a1, 512, 1597272115, 0, *(unsigned __int16 *)(a2 + 4));
        if ( off_1C006B000 == v58 )
          goto LABEL_81;
        v59 = DeviceObject;
        if ( LOWORD(DeviceObject->DeviceType) == v56 )
          goto LABEL_81;
        v60 = 22;
LABEL_80:
        sub_1C002E188(v59->DeviceExtension, 0, 1, v60, v57, v18);
LABEL_81:
        sub_1C000B870(a1, (unsigned __int16)v18, (unsigned int)va, v82, v83);
        break;
      case 5:
      ...
      case 17:
      case 20:
        sub_1C000FD80(a1, 512, 1597272117, v82, *(unsigned __int16 *)(a2 + 4));
        if ( v66 == 1 )
        {
          sub_1C000FD80(a1, 512, 1597272184, v83, *(unsigned __int16 *)(a2 + 4));
          sub_1C001518C(a1, v68, 3221225473LL);
          if ( (unsigned int)sub_1C00180B8(a1, a2) )
            sub_1C0034DE4(a1, a2, 3LL);
        }
        else
        {
          if ( v66 != 2 )
            goto LABEL_74;
          LOBYTE(v65) = 1;
          sub_1C00336FC(a1, a2, v83, v65);
        }
        v67 = &unk_1C0062098;
LABEL_74:
        if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
          sub_1C002E188(DeviceObject->DeviceExtension, 0, 1, 24, (__int64)v67, v18);
        break;
      case 7:
        sub_1C000FD80(a1, 512, 1597272113, 0, *(unsigned __int16 *)(a2 + 4));
        v50 = v82;
        v51 = 32LL * *(unsigned int *)(a2 + 2400);
        *(_DWORD *)(a2 + 12) = 7;
        *(_DWORD *)(v51 + a2 + 1384) = 7;
        sub_1C000B870(a1, (unsigned __int16)v18, (unsigned int)va, v50, v83);
        sub_1C0002580(a1, a2, v52, v53);
      ...
      case 8:
      case 10:
        sub_1C000FD80(a1, 512, 1597272119, 0, *(unsigned __int16 *)(a2 + 4));
        sub_1C000B870(a1, (unsigned __int16)v18, (unsigned int)va, v82, v83);
        ...
        *(_DWORD *)(v71 + a2 + 1384) = 10;
        break;
      case 9:
        sub_1C000FD80(a1, 512, 1597272120, 0, *(unsigned __int16 *)(a2 + 4));
        sub_1C000B870(a1, (unsigned __int16)v18, (unsigned int)va, v82, v83);
        break;
      default:
        sub_1C000FD80(a1, 512, 1597272152, 0, *(unsigned __int16 *)(a2 + 4));
  ...
  v72 = 0LL;
LABEL_96:
  sub_1C0034EEC(a1, a2, v10, v72);
LABEL_52:
  result = &off_1C006B000;
  if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 )
  {
    if ( LOWORD(DeviceObject->DeviceType) )
      return (_UNKNOWN **)sub_1C00360C8(DeviceObject->DeviceExtension, v47, v48, 26, v77, v18, (char)v17);
  }
  return result;
}
