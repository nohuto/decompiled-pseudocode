/*
 * XREFs of sub_1C0014280 @ 0x1C0014280
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_1C0014280(struct _KDPC *Dpc, _QWORD *DeferredContext, PVOID SystemArgument1, PVOID SystemArgument2)
{
  char v5; // r13
  __int64 v6; // r15
  __int64 ****v7; // rdi
  ...
  if ( *(_DWORD *)v6 != 541218120 )
    sub_1C002DC78(DeferredContext, DeferredContext[8]);
...
LABEL_5:
    ...
    if ( v15 )
    {
      ...
      *v19 = v10;
      ...
      if ( dword_1C006B650 )
      {
        ...
        if ( !v54 )
          sub_1C002DC78(DeferredContext, 0LL);
        if ( *(_DWORD *)v54 != 541218120 )
          sub_1C002DC78(DeferredContext, v54);
        ...
        *(_QWORD *)&v74 = *(unsigned int *)(v54 + 2548);
        ...
        LODWORD(v67) = 4;
        v76 = *(_DWORD *)(v54 + 2536);
        sub_1C00125E0(&stru_1C0061E00, 0LL, &v72, 12LL, &v74, 36LL, v71, 4LL, v10 + 2, v67, 0LL);
        v53 = *((unsigned int *)v10 - 8);
      }
  ...
  while ( 1 )
  {
    ...
    else
    {
      if ( v28 != 1 )
        continue;
      sub_1C000FD80((__int64)DeferredContext, 0x2000, 1684886068, (__int64)v25, v9);
LABEL_36:
      v34 = *(__int64 ***)(v6 + 3752);
      if ( *v34 != (__int64 *)v7 )
        goto LABEL_108;
  ...
  if ( !(_DWORD)v36 )
  {
    sub_1C000FD80((__int64)DeferredContext, 0x2000, 1680948785, 0LL, v9);
...
LABEL_45:
  ...
  if ( !v5 )
    return;
  v42 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels);
  ...
  if ( v45 != (_QWORD *)(v43 + 2512) )
  {
    ...
    if ( v45 )
    {
      while ( v45 != v44 )
      {
        ...
        sub_1C002DC78(DeferredContext, DeferredContext);
      }
      if ( v46 && v45 != v44 )
      {
        v49 = (_QWORD *)*v45;
...
LABEL_70:
  ...
  KeReleaseSpinLock((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels, v42);
}
