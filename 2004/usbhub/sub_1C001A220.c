/*
 * XREFs of sub_1C001A220 @ 0x1C001A220
 * Callers:
 *     <none>
 * Callees:
...
__int64 (__fastcall *__fastcall sub_1C001A220(__int64 a1, __int64 a2))(__int64)
{
  __int64 v4; // rdx
  __int64 v5; // r8
  __int64 v6; // rcx
  ...
  if ( (_DWORD)v4 != 2001228627 && (dword_1C006B268 & 8) != 0 )
  {
    if ( a1 )
    {
      v5 = *(_QWORD *)(a1 + 64);
  ...
  *(_QWORD *)(v13 + 8) = v14;
  ...
  v15 = *(_QWORD *)(a2 + 40);
  if ( *(_DWORD *)(a2 + 4) != 2001228627 && (dword_1C006B268 & 8) != 0 )
  {
    if ( a1 )
    {
      v16 = *(_QWORD *)(a1 + 64);
