/*
 * XREFs of sub_1C005844C @ 0x1C005844C
 * Callers:
...
__int64 sub_1C005844C(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 1) != 0 )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))qword_1C006B728)(
      ...
      0LL);
  LOWORD(v7) = 18;
  return WppAutoLogTrace(a1, 0LL, 1LL, &unk_1C0065258, v7, (__int64 *)va);
}
