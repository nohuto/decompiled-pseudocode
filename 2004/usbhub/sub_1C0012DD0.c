/*
 * XREFs of sub_1C0012DD0 @ 0x1C0012DD0
 * Callers:
 *     <none>
 * Callees:
        ...
        PIO_STATUS_BLOCK IoStatus)
{
  ...
  Context[12] = Status;
  sub_1C000FD80(DeviceObject, 16, 1902409795, Status, (__int64)Context);
  ...
  {
    sub_1C000FD80(DeviceObject, 16, 1347374641, *(_QWORD *)&v11[2 * v12 + 210], (__int64)Context);
    sub_1C000FD80(DeviceObject, 16, 1347374642, *(_QWORD *)(v14 + 8 * v13 + 856), v10);
