/*
 * XREFs of sub_1C002D554 @ 0x1C002D554
 * Callers:
...
__int64 __fastcall sub_1C002D554(__int64 a1, char a2)
{
  _DWORD *v4; // rax
  int v5; // r10d
  __int64 v6; // rbx
  ...
  v12 = 0;
  v13 = a2 != 0 ? 3 : 1;
  sub_1C000FD80(a1, 8, 1400332651, (unsigned int)v4[344], 0LL);
  v14 = v5;
  v15 = 0;
  v6 = (int)sub_1C000A740(a1, (__int64)&v12, 0LL, &v10, v9, &v11);
  sub_1C000FD80(a1, 8, 1937206065, v6, v11);
  if ( (v6 & 0xC0000000) == 0xC0000000 && !sub_1C001CEB4(v6) )
    sub_1C004A608(a1, 0, 123, 0, 0, v6, v7, (__int64)aHubC, 3746, 0);
  sub_1C000FD80(a1, 8, 1937206066, v6, 0LL);
