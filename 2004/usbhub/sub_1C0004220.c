/*
 * XREFs of sub_1C0004220 @ 0x1C0004220
 * Callers:
...
LONG __fastcall sub_1C0004220(__int64 a1, __int64 a2, __int64 a3)
{
  int v3; // esi
  _DWORD *v6; // rdx
  _QWORD *v7; // r15
  ...
  if ( *v6 != 541218120 )
    sub_1C002DC78(a1, v6);
  v7 = (_QWORD *)sub_1C0004060(a1, a3, a1, 1383162736, 0);
  ...
  if ( (_DWORD)v19 == 6 )
  {
    ...
    if ( v54 )
    {
      ...
      *(_DWORD *)(32 * (*(unsigned int *)(a2 + 2400) + 43LL) + a2 + 24) = 10;
      ...
      sub_1C000B870(a1, *(unsigned __int16 *)(a2 + 4), (unsigned int)v96, 0, 0LL);
      v69 = *(int *)(a2 + 12);
      v70 = *(_DWORD *)(a2 + 12);
...
LABEL_98:
  ...
  switch ( (int)v19 )
  {
    ...
    case 13:
      ...
      LODWORD(v96[0]) = 0x100000;
      sub_1C000FD80(a1, 512, 1597206583, v19, Timeoutb);
      sub_1C0001CB0(a1, a2);
      sub_1C0034DE4(a1, a2, 1LL);
      sub_1C000B870(a1, *(unsigned __int16 *)(a2 + 4), (unsigned int)v96, 0, 0LL);
      v88 = 0x100000LL;
    ...
    case 11:
      ...
      LODWORD(v96[0]) = 0x100000;
      sub_1C000FD80(a1, 512, 1597206577, v19, Timeout);
      sub_1C0001CB0(a1, a2);
      ...
      *(_DWORD *)(v84 + a2 + 12) = 0x100000;
      KeReleaseSpinLock((PKSPIN_LOCK)(a2 + 440), v11);
      return sub_1C0003610(a1, v85, v7);
    case 8:
    case 9:
    case 10:
      if ( (_DWORD)v19 == 9 )
      ...
      sub_1C0034CDC(a1, a2);
      sub_1C0036088(a1, a2);
      sub_1C000FD80(a1, 512, 1597206580, v86, *(unsigned __int16 *)(a2 + 4));
      if ( *(_DWORD *)(a2 + 400) == 5 )
      {
        Timeouta = *(unsigned __int16 *)(a2 + 4);
        LODWORD(v96[0]) = 0x100000;
        sub_1C000FD80(a1, 512, 1597206610, v19, Timeouta);
        sub_1C0001CB0(a1, a2);
        sub_1C000B870(a1, *(unsigned __int16 *)(a2 + 4), (unsigned int)v96, 0, 0LL);
      }
    ...
    case 18:
      v89 = 1597206584;
LABEL_88:
      sub_1C000FD80(a1, 512, v89, v19, *(unsigned __int16 *)(a2 + 4));
      v90 = 32LL * *(unsigned int *)(a2 + 2400);
      *(_DWORD *)(a2 + 12) = v19;
      *(_DWORD *)(v90 + a2 + 1384) = v19;
      break;
    default:
      sub_1C000FD80(a1, 512, 1597206616, v19, *(unsigned __int16 *)(a2 + 4));
