/*
 * XREFs of sub_1C002F27C @ 0x1C002F27C
 * Callers:
...
LONG __fastcall sub_1C002F27C(__int64 a1, __int64 a2, __int64 a3)
{
  int v6; // eax
  int v7; // r11d
  ...
  sub_1C000FD80(a1, 0x8000, 1718383410, v6, *(unsigned __int16 *)(a2 + 4));
  if ( v7 <= 0 )
