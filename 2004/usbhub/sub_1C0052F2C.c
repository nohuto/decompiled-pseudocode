/*
 * XREFs of sub_1C0052F2C @ 0x1C0052F2C
 * Callers:
...
char __fastcall sub_1C0052F2C(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, _OWORD *a5)
{
  _OWORD *v7; // rcx
  char v9; // cl
  ...
  *((_QWORD *)v7 + 6) = 0LL;
  if ( a4 < 5 )
    return 0;
  v9 = sub_1C005255C(a1, (unsigned __int8 *)a2, (__int64)&v12);
  if ( !v9 )
    return 0;
  if ( a4 != *(unsigned __int16 *)(a2 + 2) )
  {
    sub_1C000FD80(a1, 256, 1447186259, a4, *(unsigned __int16 *)(a2 + 2));
    v9 = 0;
  }
  for ( i = (unsigned __int8 *)(a2 + 5); (unsigned __int64)i < v13; i += v20 )
  {
    v9 = sub_1C00527A8(a1, i, &v12, &v20);
    if ( !v9 )
      return 0;
    if ( i[1] == 16 )
    {
      v9 = sub_1C0052948(a1, i, (__int64)&v12);
      if ( !v9 )
        return 0;
    }
  }
