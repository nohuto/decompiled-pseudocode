/*
 * XREFs of sub_1C000ABD0 @ 0x1C000ABD0
 * Callers:
...
__int64 __fastcall sub_1C000ABD0(PDEVICE_OBJECT a1, unsigned int a2, unsigned __int8 a3, __int64 a4, __int64 a5)
{
    ...
    if ( a1 )
    {
      ...
      if ( DeviceExtension )
      {
        ...
        *(_DWORD *)&a1->Type = 1313754947;
        a1->AttachedDevice = (struct _DEVICE_OBJECT *)a2;
        a1->DriverObject = 0LL;
        a1->NextDevice = (struct _DEVICE_OBJECT *)a4;
      }
    }
  }
  ...
  if ( a2 == 0x80000 )
  {
    ...
    if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 )
    {
      a1 = DeviceObject;
      if ( LOWORD(DeviceObject->DeviceType) )
        sub_1C002E188(DeviceObject->DeviceExtension, 0, 1, 43, (__int64)&unk_1C0062100, *(_WORD *)(a4 + 4));
    }
    ...
    {
      v46 = *(_QWORD *)(a4 + 376);
      sub_1C001CDA8(a1, v46, 19LL);
      if ( *(_DWORD *)(sub_1C0011220(a5) + 1124) == 2 )
      {
        sub_1C004C6A0((_DWORD)v9, a5, a4, v47, v46 + 132);
        sub_1C0054AFC(v9, a5, 2LL);
      }
      else
      {
        v48 = *(_QWORD *)(a4 + 376);
        ...
        *(_DWORD *)(v48 + 88) = 1734964085;
        KeReleaseSpinLock((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels, v49);
      }
    }
    return 4;
  }
  if ( a2 == 0x100000 )
  {
    ...
    if ( !v17 )
      sub_1C002DC78(v9, 0LL);
    if ( *(_DWORD *)v17 != 541218120 )
      sub_1C002DC78(v9, v9->DeviceExtension);
    v18 = v17 + 618;
  ...
  if ( a2 <= 0x10 )
  {
    if ( a2 == 16 )
    {
      sub_1C000FD80((_DWORD)v9, 4, 1129270898, (_DWORD)v7, 0LL);
      ...
      if ( v35 )
      {
        ...
        if ( v36 )
        {
          ...
          if ( v37 )
          {
            if ( v37 != 4 )
              return v5;
            sub_1C000FD80((_DWORD)v9, 4, 1129270902, (_DWORD)v7, 0LL);
            return (unsigned int)sub_1C004C954((_DWORD)v9, 0, a5, a4, a5);
          }
          sub_1C000FD80((_DWORD)v9, 4, 1129270899, (_DWORD)v7, 0LL);
          v39 = (__int64 (__fastcall *)())qword_1C005EB28[2 * v38];
        }
        else
        {
          sub_1C000FD80((_DWORD)v9, 4, 1129270885, (_DWORD)v7, 0LL);
          v39 = off_1C0060748[2 * v42];
        }
      }
      else
      {
        sub_1C000FD80((_DWORD)v9, 4, 1129270883, (_DWORD)v7, 0LL);
...
LABEL_54:
  ...
  {
    case 0x20000u:
      sub_1C000FD80((_DWORD)v9, 4, 1129270904, (_DWORD)v7, 0LL);
      v39 = (__int64 (__fastcall *)())qword_1C005E928[2 * v41];
      goto LABEL_54;
    case 0x10000u:
      sub_1C000FD80((_DWORD)v9, 4, 1129270900, (_DWORD)v7, 0LL);
      v39 = off_1C0060948[2 * v45];
      goto LABEL_54;
    case 0x40000u:
      sub_1C000FD80((_DWORD)v9, 4, 1129270867, (_DWORD)v7, 0LL);
      return (unsigned int)sub_1C0016130((_DWORD)v9, v34, (unsigned __int8)v7, a4, a5);
  }
  return v5;
}
