/*
 * XREFs of sub_1C0051AFC @ 0x1C0051AFC
 * Callers:
        ...
        ...)
{
  ...
  if ( (HIDWORD(DeviceObject->Timer) & 1) != 0 && BYTE1(DeviceObject->Timer) >= a2 )
  {
    ...
    if ( !a6 )
      v13 = L"NULL";
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, __int64, _QWORD, const wchar_t *, __int64, char *, __int64, _QWORD))qword_1C006B728)(
