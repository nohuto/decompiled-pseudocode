/*
 * XREFs of UsbhPCE_QueueDriverReset @ 0x1C0018840
 * Callers:
...
__int64 __fastcall UsbhPCE_QueueDriverReset(__int64 a1, unsigned __int16 a2, __int64 a3, __int64 a4, __int64 a5)
{
  __int64 v6; // rsi
  __int64 result; // rax
