/*
 * XREFs of sub_1C005C3DC @ 0x1C005C3DC
 * Callers:
...
NTSTATUS __fastcall sub_1C005C3DC(__int64 a1, int a2, int a3, int a4, char a5, __int64 a6, int a7)
{
  __int64 v7; // rbx
  NTSTATUS result; // eax
  _DWORD *v9; // rax
  ...
  if ( dword_1C006B650 )
  {
    ...
    v16 = *((_WORD *)v9 + 2614);
    v17 = *((_WORD *)v9 + 2615);
    sub_1C001BAFC((__int64)v9, (__int64)v18);
    return sub_1C00125E0(
             &stru_1C0062B88,
             0LL,
             &v13,
             12LL,
