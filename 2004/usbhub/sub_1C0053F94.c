/*
 * XREFs of sub_1C0053F94 @ 0x1C0053F94
 * Callers:
...
__int64 __fastcall sub_1C0053F94(__int64 a1, __int64 a2)
{
  ULONG v3; // ebx
  __int64 v5; // rcx
  _DWORD *v6; // r13
  ...
  sub_1C000FD80(a1, 256, 1666204751, a2, 0LL);
  if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(::DeviceObject->DeviceType) )
    sub_1C002E0B4((__int64)::DeviceObject->DeviceExtension, 0, 1u, 0x1Au, (__int64)&unk_1C0065258);
  v6 = sub_1C000F050(a1);
  do
  {
    v7 = sub_1C004373C(v5, &DeviceName, v3);
    if ( v7 >= 0 )
    {
      v7 = IoCreateDevice(
             (PDRIVER_OBJECT)stru_1C006B480.Queue.ListEntry.Blink,
             0xBF8u,
             &DeviceName,
             0x22u,
             0,
  ...
  while ( v7 == -1073741771 );
  sub_1C000FD80(a1, 256, 1668310065, a2, v7);
  ...
  sub_1C000FD80(a1, v9, 1666204721, v8, (__int64)DeviceObject);
  ...
  *((_DWORD *)DeviceExtension + 742) = 1000;
  sub_1C0036194((__int64)DeviceObject, 1, 7);
  ...
  *((_QWORD *)DeviceExtension + 159) = DeviceExtension + 1272;
  ...
  sub_1C000FD80(a1, 0x2000, 1768843604, (__int64)(DeviceExtension + 1704), (__int64)sub_1C0042380);
  v14 = PoolType;
    ...
    *(_OWORD *)PoolWithTag = 0LL;
    ...
    else
    {
      ...
      *((_DWORD *)DeviceExtension + 537) = DestinationString.MaximumLength;
      sub_1C000FD80(a1, 256, 1668310066, a2, (__int64)v18);
      v20 = sub_1C004FEB8(a1, 0LL, (__int64)(DeviceExtension + 2080));
      v10 = v20;
      v21 = a1;
      ...
      {
        v23 = sub_1C0050274(a1, 0LL, (__int64)(DeviceExtension + 2096));
        v10 = v23;
        v21 = a1;
        ...
        {
          v24 = sub_1C004F5D0(a1, 0LL, (__int64)(DeviceExtension + 2112));
          v10 = v24;
          ...
          {
            v25 = sub_1C0029D80((__int64)DeviceObject, a1);
            v10 = v25;
            ...
            else
            {
              ...
              *((_QWORD *)DeviceExtension + 181) = DeviceExtension + 1448;
              IoCsqInitialize(
                ...
                sub_1C00591D0,
                sub_1C00594C0,
                (PIO_CSQ_PEEK_NEXT_IRP)sub_1C001CC30,
                (PIO_CSQ_ACQUIRE_LOCK)sub_1C001CEE0,
                (PIO_CSQ_RELEASE_LOCK)sub_1C001CF10,
                sub_1C0058540);
              sub_1C000FD80(a1, 0x2000, 1768843604, (__int64)(DeviceExtension + 1544), (__int64)sub_1C00586B0);
              *(_QWORD *)(v26 + 48) = v27;
              *(_QWORD *)v26 = 1332899156LL;
              *(_DWORD *)(v26 + 8) = 0;
              *(_DWORD *)(v26 + 72) = 1231318117;
              sub_1C000FD80(a1, v29, v28, (__int64)(DeviceExtension + 1624), (__int64)sub_1C00594F0);
              ...
              *(__m128i *)(DeviceExtension + 892) = si128;
              v33 = sub_1C0014F6C((__int64)DeviceObject, (__int64)DeviceObject, 1162637161, 0);
              v10 = v33;
              ...
              *((_DWORD *)DeviceExtension + 684) = 0;
              ...
              LOBYTE(NewIrql) = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels);
              HIDWORD(NewIrql) = 1;
              stru_1C006B480.Dpc.DeferredRoutine = (PKDEFERRED_ROUTINE)&stru_1C006B480.Dpc.DeferredContext;
              sub_1C0058304(a1, DeviceObject, &NewIrql);
              sub_1C0051020(a1, (__int64)DeviceObject, v34, (__int64)(DeviceExtension + 2224));
              HIDWORD(NewIrql) = 0;
              stru_1C006B480.Dpc.DeferredRoutine = 0LL;
              KeReleaseSpinLock((PKSPIN_LOCK)&stru_1C006B480.Queue.Wcb.NumberOfChannels, NewIrql);
              if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(::DeviceObject->DeviceType) )
                sub_1C002E62C(
      ...
      sub_1C000FD80(v21, 256, v22, (__int64)DeviceObject, v10);
    }
  }
LABEL_16:
  if ( (v10 & 0xC0000000) == 0xC0000000 )
  {
    sub_1C000FD80(a1, 256, 1346653985, (__int64)DeviceObject, (int)v10);
    sub_1C003AB30(a1, (__int64)DeviceObject, a2 + 24);
  }
  else
  {
    DeviceObject->Flags &= ~0x80u;
    sub_1C000FE00(a1, *(_WORD *)(a2 + 4), 2, 1);
    sub_1C0053CC8((__int64)DeviceObject, 100, 6);
  }
