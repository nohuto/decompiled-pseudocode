/*
 * XREFs of sub_1C005AC64 @ 0x1C005AC64
 * Callers:
...
NTSTATUS __fastcall sub_1C005AC64(__int64 a1, __int64 a2, const GUID *a3, _QWORD *a4, _DWORD *a5)
{
  NTSTATUS result; // eax
  ...
  if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
    sub_1C002E0B4((__int64)DeviceObject->DeviceExtension, 0, 1u, 0x20u, (__int64)&unk_1C00654F0);
