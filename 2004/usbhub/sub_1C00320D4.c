/*
 * XREFs of sub_1C00320D4 @ 0x1C00320D4
 * Callers:
...
__int64 __fastcall sub_1C00320D4(unsigned int *a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  unsigned int v7; // ebx
  __int16 v8; // r15
  __m128 *v9; // rsi
  ...
  if ( a1 && a2 >= 0x10 )
  {
    ...
    if ( v10 < 9 || v10 > a4 )
      return (unsigned int)-1073741811;
    PoolWithTag = (__m128 *)ExAllocatePoolWithTag(PoolType, 0x100uLL, 0x42554855u);
    v9 = PoolWithTag;
    if ( !PoolWithTag )
      return (unsigned int)-1073741670;
    sub_1C001D340(PoolWithTag, 0, 0x100uLL);
