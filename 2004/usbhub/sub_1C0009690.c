/*
 * XREFs of sub_1C0009690 @ 0x1C0009690
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1C0009690(_QWORD *BugCheckParameter3, IRP *BugCheckParameter4)
{
...
LABEL_176:
  ...
  if ( *(_DWORD *)v5 != 1329877064 )
    sub_1C002DC78(BugCheckParameter3, BugCheckParameter3[8]);
  LowPart = CurrentStackLocation->Parameters.Read.ByteOffset.LowPart;
  switch ( LowPart )
  {
    case 0x220FB3u:
      sub_1C001853C(*(_QWORD *)(v5 + 1184), 100LL);
      if ( *(_BYTE *)(v5 + 2741) )
      {
        if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
          sub_1C002E0B4(DeviceObject->DeviceExtension, 0, 3, 10, (__int64)&unk_1C0065258);
        sub_1C000FD80(*(_QWORD *)(v5 + 1184), 256, 1397903939, 0, *(_QWORD *)(v5 + 1184));
        sub_1C003D218(v29, BugCheckParameter3);
      ...
      if ( *(_DWORD *)(v5 + 784) != 2 )
        goto LABEL_96;
      if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
        sub_1C002E0B4(DeviceObject->DeviceExtension, 0, 3, 11, (__int64)&unk_1C0065258);
      sub_1C000FD80(*(_QWORD *)(v5 + 1184), 256, 1397903953, 0, *(_QWORD *)(v5 + 1184));
    ...
    case 0x220FABu:
      if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 && LOWORD(DeviceObject->DeviceType) )
        sub_1C002E62C(
          ...
          3,
          12,
          (__int64)&unk_1C0065258,
          *(_QWORD *)(v5 + 1184));
      sub_1C000FD80(*(_QWORD *)(v5 + 1184), 256, 1397903944, 0, *(_QWORD *)(v5 + 1184));
...
LABEL_9:
  ...
  if ( LowPart == 2228243 )
    return sub_1C00099C0(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
  if ( LowPart != 2228227 )
  {
    if ( LowPart > 0x22042C )
    {
      ...
      {
        if ( LowPart == 2229327 )
          return sub_1C00309F4(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
        v37 = LowPart - 2229299;
        if ( v37 )
        {
          v38 = v37 - 4;
          if ( v38 )
          {
            v39 = v38 - 4;
            if ( !v39 )
              return sub_1C002A5E8(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
            v40 = v39 - 4;
            if ( !v40 )
              return sub_1C0030E40(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
            if ( v40 == 4 )
              return sub_1C0058A58(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4, 7LL, 0);
            goto LABEL_153;
          }
          LOBYTE(v14) = 1;
        }
        ...
        return sub_1C002A530(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4, v14);
      }
      v41 = LowPart - 2232243;
      if ( v41 )
      {
        v42 = v41 - 2557009;
        if ( !v42 )
          return sub_1C00300F4(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
        v43 = v42 - 4;
        if ( !v43 )
          return sub_1C0030090(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
        if ( v43 == 7 )
          return sub_1C00301E8(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
LABEL_153:
    ...
    else
    {
      ...
      if ( LowPart > 0x220020 )
      {
        v34 = LowPart - 2228263;
        if ( !v34 )
          return sub_1C0030F00(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
        v35 = v34 - 4;
        if ( !v35 )
          return sub_1C00302D0(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
        v36 = v35 - 1013;
        if ( !v36 )
          return sub_1C0030934(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
        if ( v36 == 4 )
          return sub_1C00308D0(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
        goto LABEL_153;
      }
      if ( LowPart == 2228256 )
        return sub_1C0030CB0(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
      v30 = LowPart - 2228231;
      if ( v30 )
      {
        v31 = v30 - 8;
        if ( !v31 )
          return sub_1C0030D50(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
        v32 = v31 - 8;
        if ( v32 )
        {
          v33 = v32 - 4;
          if ( !v33 )
            return sub_1C0030C08(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
          if ( v33 == 4 )
            return sub_1C002FF30(*(_QWORD *)(v5 + 1184), BugCheckParameter3, BugCheckParameter4);
          goto LABEL_153;
        }
        BugCheckParameter4->IoStatus.Status = 0;
        IofCompleteRequest(BugCheckParameter4, 0);
    ...
    return sub_1C00304E0(*(PDEVICE_OBJECT *)(v5 + 1184), (ULONG_PTR)BugCheckParameter3, (ULONG_PTR)BugCheckParameter4);
  }
  ...
  if ( *(_DWORD *)DeviceExtension != 541218120 )
    sub_1C002DC78(*(_QWORD *)(v5 + 1184), v17->DeviceExtension);
  v19 = BugCheckParameter3[8];
  if ( !v19 )
LABEL_175:
    sub_1C002DC78(BugCheckParameter3, 0LL);
  if ( *(_DWORD *)v19 != 1329877064 )
    sub_1C002DC78(BugCheckParameter3, v19);
  SecurityContext = BugCheckParameter4->Tail.Overlay.CurrentStackLocation->Parameters.Create.SecurityContext;
  SecurityContext->AccessState = *(PACCESS_STATE *)(v19 + 1160);
  switch ( WORD1(SecurityContext->SecurityQos) )
  {
    case 0:
      return (unsigned int)sub_1C002A7DC(v17, (ULONG_PTR)BugCheckParameter3, (ULONG_PTR)BugCheckParameter4);
    case 1:
      return (unsigned int)sub_1C002AA94(v17, BugCheckParameter3, BugCheckParameter4);
    case 0x13:
      ...
      if ( off_1C006B000 != (_UNKNOWN *)&off_1C006B000 )
      {
        if ( LOWORD(DeviceObject->DeviceType) )
          sub_1C002E62C(DeviceObject->DeviceExtension, v19, 1, 19, (__int64)&unk_1C0062088, *(_QWORD *)(v19 + 840));
      }
      v23 = -1073741637;
      BugCheckParameter4->IoStatus.Status = -1073741637;
      IofCompleteRequest(BugCheckParameter4, 0);
    ...
    case 0x30:
    case 0x31:
      return (unsigned int)sub_1C002ABC4(v17, BugCheckParameter3, BugCheckParameter4);
    case 0x2A:
      return (unsigned int)sub_1C002A3CC(v17, BugCheckParameter3, BugCheckParameter4);
    default:
LABEL_26:
