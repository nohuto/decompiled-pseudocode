/*
 * XREFs of ?IsCandidateTransformOwner@@YAHPEAUtagWND@@0@Z @ 0x1C0107460
 * Callers:
 ...
 *     ?IsAdjacentRect@@YAHPEBUtagRECT@@0@Z @ 0x1C0107650 (-IsAdjacentRect@@YAHPEBUtagRECT@@0@Z.c)
...
_BOOL8 __fastcall IsCandidateTransformOwner(struct tagWND *a1, struct tagWND *a2)
{
  ...
  if ( !(unsigned int)IsTitleWindow(a1, 1LL)
    || *(_QWORD *)(v7 + 424) != *(_QWORD *)(v8 + 424) && *(_QWORD *)(v7 + 416) != *(_QWORD *)(v8 + 416) )
  {
    return 0LL;
  }
  v10 = *((_QWORD *)a1 + 5);
  ...
  if ( !v6 || v17 )
    return 1LL;
  if ( !(unsigned int)UnionRect(&v19, (int *)v16, &v15->left) )
    return 0LL;
  v18 = v19 - *(_QWORD *)v16;
