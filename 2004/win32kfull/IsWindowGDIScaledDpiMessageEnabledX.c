/*
 * XREFs of IsWindowGDIScaledDpiMessageEnabledX @ 0x1C01E5E48
 * Callers:
 *     NtUserIsWindowGDIScaledDpiMessageEnabled @ 0x1C01FEEB0 (NtUserIsWindowGDIScaledDpiMessageEnabled.c)
 * Callees:
