/*
 * XREFs of ?ValidUmpdHdev@@YAPEAUHDEV__@@PEAU1@@Z @ 0x1C014D81C
 * Callers:
 *     NtGdiEngAssociateSurface @ 0x1C014D530 (NtGdiEngAssociateSurface.c)
 *     NtGdiGetDhpdev @ 0x1C02B4F30 (NtGdiGetDhpdev.c)
 * Callees:
 *     <none>
 */
