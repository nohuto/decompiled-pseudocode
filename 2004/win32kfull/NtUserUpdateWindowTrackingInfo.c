/*
 * XREFs of NtUserUpdateWindowTrackingInfo @ 0x1C0204D60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserUpdateWindowTrackingInfo(__int64 a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  ...
  if ( v7 && (((*(_WORD *)(*(_QWORD *)(v7 + 40) + 42LL) & 0x3FFF) - 669) & 0xFFFFFFFD) != 0 )
  {
    ...
    *((_QWORD *)&v22 + 1) = v7;
    HMLockObject(v7);
    if ( IsShellParticipatesInSizing(v11) )
    {
        ...
        *(_QWORD *)v21 = *a2;
        ...
        if ( (int)v18 > 0 )
        {
          ...
          if ( SHIDWORD(v18) > 0 && (int)v19 > 0 )
          {
            ...
            {
              ShellWindowManagement::TransformWindowTrackInfo((__int64)v11, v21, (INT *)&v24, 1);
              updated = UpdateSizeTrackingInfo(v11);
              goto LABEL_21;
            }
          }
        }
