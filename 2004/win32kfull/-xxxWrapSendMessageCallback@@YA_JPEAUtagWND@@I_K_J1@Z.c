/*
 * XREFs of ?xxxWrapSendMessageCallback@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C0036620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxWrapSendMessageCallback(struct tagWND *a1, int a2, int a3, int a4, ULONG64 a5)
{
  ...
  else
  {
    ...
    *(_OWORD *)BugCheckParameter3 = *(_OWORD *)a5;
    ...
    v13 = (int)xxxSendMessageCallback((int)a1, a2, a3, a4, BugCheckParameter3[0], BugCheckParameter3[1], 1, 0, 1);
    if ( a1 != (struct tagWND *)-1LL )
