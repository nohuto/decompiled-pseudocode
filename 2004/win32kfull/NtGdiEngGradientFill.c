/*
 * XREFs of NtGdiEngGradientFill @ 0x1C02B32B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?bValidVertexMeshData@@YAHPEAU_TRIVERTEX@@PEAXKKK@Z @ 0x1C02B2374 (-bValidVertexMeshData@@YAHPEAU_TRIVERTEX@@PEAXKKK@Z.c)
 */
