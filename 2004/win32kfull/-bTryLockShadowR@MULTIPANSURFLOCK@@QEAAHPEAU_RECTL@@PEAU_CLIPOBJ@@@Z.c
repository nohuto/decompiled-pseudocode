/*
 * XREFs of ?bTryLockShadowR@MULTIPANSURFLOCK@@QEAAHPEAU_RECTL@@PEAU_CLIPOBJ@@@Z @ 0x1C02970EC
 * Callers:
 ...
 *     ?ShadowUnLockWait@@YAXPEAU_PANDEV@@@Z @ 0x1C0296F24 (-ShadowUnLockWait@@YAXPEAU_PANDEV@@@Z.c)
