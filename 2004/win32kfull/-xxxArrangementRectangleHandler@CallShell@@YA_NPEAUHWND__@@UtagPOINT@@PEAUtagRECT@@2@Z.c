/*
 * XREFs of ?xxxArrangementRectangleHandler@CallShell@@YA_NPEAUHWND__@@UtagPOINT@@PEAUtagRECT@@2@Z @ 0x1C023E6A0
 * Callers:
        ...
        struct tagRECT *a4)
{
  ...
  *(_OWORD *)*(_QWORD *)&a3 = 0LL;
  v15 = a2;
  *a4 = 0LL;
  v7 = *(_DWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 388LL);
  if ( (v7 & 0x800000) != 0 )
    v17 = 2;
  else
    v17 = HIBYTE(v7) & 1;
  v18 = *(_DWORD *)(gptiCurrent + 1232LL);
  v8 = *(_BYTE *)(*(_QWORD *)(gptiCurrent + 424LL) + 232LL);
  v9 = (4 * (v8 & 1)) | 1;
  if ( (v8 & 0x10) == 0 )
    v9 = 4 * (v8 & 1);
  v10 = v9 | 2;
