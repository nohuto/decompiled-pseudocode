/*
 * XREFs of LogicalToPhysicalInPlaceRgnWorker @ 0x1C010AF94
 * Callers:
 ...
 *     ?TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z @ 0x1C01E4924 (-TransformRgn@@YAPEAUHRGN__@@PEAU1@PEAUtagXFORM@@@Z.c)
 */
