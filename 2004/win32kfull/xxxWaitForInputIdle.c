/*
 * XREFs of xxxWaitForInputIdle @ 0x1C0121F80
 * Callers:
 *     NtUserWaitForInputIdle @ 0x1C0121F20 (NtUserWaitForInputIdle.c)
 * Callees:
 ...
 *     WaitOnPseudoEvent @ 0x1C0122334 (WaitOnPseudoEvent.c)
 */
        ...
        if ( ProcessWin32Process )
        {
          ...
          if ( (v11 & 0x21) == 0x20 )
          {
            ...
            *(_DWORD *)(v10 + 12) &= ~0x20000u;
            for ( j = *(_QWORD *)(v10 + 320); j; j = *(_QWORD *)(j + 656) )
