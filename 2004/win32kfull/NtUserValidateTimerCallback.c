/*
 * XREFs of NtUserValidateTimerCallback @ 0x1C00E8CA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 NtUserValidateTimerCallback()
{
  ...
  if ( (v10 & 0x1000000) == 0
    || (*(_DWORD *)(v2 + 480) & 0xC) != 0
    || (ProcessId = PsGetProcessId(**(PEPROCESS **)(v2 + 416)), v8 = gpidLogon, ProcessId == (HANDLE)gpidLogon) )
  {
    v11 = gtmrListHead[0];
    v0 = 0LL;
  }
  UserSessionSwitchLeaveCrit(v8, v11, v9);
  return v0;
}
