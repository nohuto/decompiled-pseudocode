/*
 * XREFs of SetWindowCompositionAllowNCPaint @ 0x1C0214C14
 * Callers:
...
__int64 __fastcall SetWindowCompositionAllowNCPaint(__int64 *a1, __int128 *a2, __int64 a3)
{
  bool v4; // zf
  int v6; // esi
  unsigned int v7; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 2) == v6 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFFFD | (2 * v6);
