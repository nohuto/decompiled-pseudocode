/*
 * XREFs of ?bEnumStartLine@XCLIPOBJ@@QEAAHK@Z @ 0x1C013E048
 * Callers:
 *     ?bGetLine@XCLIPOBJ@@IEAAHPEAVEPATHOBJ@@PEBK@Z @ 0x1C013DEB8 (-bGetLine@XCLIPOBJ@@IEAAHPEAVEPATHOBJ@@PEBK@Z.c)
 * Callees:
 ...
 *     ?vUpdateStyleState@XCLIPOBJ@@QEAAXXZ @ 0x1C02CFA3C (-vUpdateStyleState@XCLIPOBJ@@QEAAXXZ.c)
 */
