/*
 * XREFs of ?DelegateMoveSizeToShell@@YAXPEAUtagWND@@I@Z @ 0x1C0224110
 * Callers:
...
void __fastcall DelegateMoveSizeToShell(struct tagWND *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (_BYTE)a2 )
  {
    v10 = *(_DWORD *)(*(_QWORD *)(v4 + 424) + 388LL);
    if ( (v10 & 0x800000) != 0 || (v10 & 0x1000000) != 0 )
    {
      v11 = word_1C033AAB0[0];
    ...
    v13 = *(unsigned __int16 *)(v4 + 756) | (*(unsigned __int16 *)(v4 + 760) << 16);
    v37 = 0;
    v42 = *(__int128 **)(v4 + 424);
    v14 = v13;
