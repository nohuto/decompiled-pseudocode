/*
 * XREFs of CheckHandleFlag @ 0x1C00B3318
 * Callers:
 *     _GetUserObjectInformation @ 0x1C00690B0 (_GetUserObjectInformation.c)
 *     OkayToCloseWindowStation @ 0x1C00B1950 (OkayToCloseWindowStation.c)
 *     OkayToCloseDesktop @ 0x1C00B2EF0 (OkayToCloseDesktop.c)
