/*
 * XREFs of NtUserInteractiveControlQueryUsage @ 0x1C01FEB50
 * Callers:
 *     <none>
 * Callees:
        ...
        int *a5)
{
  ...
  __int64 v13; // rcx
  __int64 v14; // r8
  int v16[12]; // [rsp+40h] [rbp-48h] BYREF
  ...
  *v10 = *v10;
  ...
  if ( (int)InteractiveControlManager::GetReportExtendedUsage(v11, (unsigned __int16)a1, HIWORD(a1), a3, a2, a4, v16) < 0 )
    v9 = 0;
  else
    *a5 = v16[0];
