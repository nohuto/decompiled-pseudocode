/*
 * XREFs of UserGetHipDeviceInfo @ 0x1C01EF4A0
 * Callers:
 *     <none>
 * Callees:
  ...
  for ( i = CBaseInput::TmpGetDeviceList(gpHidInput); i; i = (struct DEVICEINFO *)*((_QWORD *)i + 7) )
  {
    if ( (*((_DWORD *)i + 50) & 0x80u) != 0 )
    {
      ...
      if ( v4 )
      {
        ...
        a1[v12 + 4] = *(_DWORD *)(v11 + 2120);
        *(_OWORD *)&a1[v12 + 5] = *(_OWORD *)(v11 + 2104);
        *(_QWORD *)&a1[v12 + 9] = *(_QWORD *)(v11 + 1904);
        a1[v12 + 11] = *(_DWORD *)(v11 + 1916);
        a1[v12 + 16] = *(_DWORD *)(v11 + 1996);
        *(_QWORD *)&a1[v12 + 19] = *(_QWORD *)(v11 + 2096);
        *(_QWORD *)&a1[v12 + 17] = *(_QWORD *)(v11 + 2088);
        RtlStringCchCopyW((char *)&a1[v12 + 85], 128LL, (char *)(v11 + 1612));
        RtlStringCchCopyW((char *)&a1[v12 + 149], 128LL, (char *)(v30 + 1356));
        v22 = *(_QWORD *)(v30 + 1344);
        if ( v22 )
