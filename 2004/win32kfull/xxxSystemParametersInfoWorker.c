/*
 * XREFs of xxxSystemParametersInfoWorker @ 0x1C003E1F8
 * Callers:
 *     EditionxxxSystemParametersInfoWorker @ 0x1C003E1E0 (EditionxxxSystemParametersInfoWorker.c)
 * Callees:
 ...
 *     ?UpdateThresholdFromMetric@@YAXHPEAH0IEW4_THRESHOLD_SELECTOR@@@Z @ 0x1C000D7E8 (-UpdateThresholdFromMetric@@YAXHPEAH0IEW4_THRESHOLD_SELECTOR@@@Z.c)
 ...
 *     ?PostWindowArrangementCheck@@YAXK@Z @ 0x1C0123794 (-PostWindowArrangementCheck@@YAXK@Z.c)
 ...
 *     ?NotifyISMPenButtonYieldSettingChange@@YAXXZ @ 0x1C01D6B50 (-NotifyISMPenButtonYieldSettingChange@@YAXXZ.c)
 ...
 *     WritePointerDeviceSettingsFull @ 0x1C020A68C (WritePointerDeviceSettingsFull.c)
 *     ?TraceLoggingMouseWheelRoutingModeChange@@YAXK@Z @ 0x1C0225B18 (-TraceLoggingMouseWheelRoutingModeChange@@YAXK@Z.c)
 *     ?TraceLoggingSPISetDesktopDPIOverrideEvent@@YAXHH@Z @ 0x1C0225E4C (-TraceLoggingSPISetDesktopDPIOverrideEvent@@YAXHH@Z.c)
 *     ?TraceLoggingSPISetModernDPIOverrideEvent@@YAXHH@Z @ 0x1C0225ECC (-TraceLoggingSPISetModernDPIOverrideEvent@@YAXHH@Z.c)
 *     ?TraceLoggingSPISetPenVisualizationEvent@@YAXKK@Z @ 0x1C0225F4C (-TraceLoggingSPISetPenVisualizationEvent@@YAXKK@Z.c)
 ...
 *     DwmAsyncNotifyWindowShadowChange @ 0x1C0275E00 (DwmAsyncNotifyWindowShadowChange.c)
 */
...
__int64 __fastcall xxxSystemParametersInfoWorker(__int64 a1, unsigned int a2, void *a3, __int16 a4)
{
  ...
  void *v38; // rcx
  __int64 SystemArgument2_high; // rcx
  int v40; // ecx
  ...
  int v68; // eax
  struct _UNICODE_STRING *v69; // rdi
  int v70; // ebx
  _DWORD *v71; // r9
  struct tagMOUSEKEYS *v72; // rbx
  int v73; // r8d
  ...
  struct tagSOUNDSENTRYW *v108; // rbx
  int v109; // r8d
  unsigned int v110; // eax
  int v111; // r8d
  struct _UNICODE_STRING *v112; // rdi
  char *v113; // rcx
  _DWORD *v114; // rdx
  ...
  __int64 v186; // [rsp+60h] [rbp-458h] BYREF
  ...
  if ( (unsigned int)v5 <= 0x64 )
  {
    ...
    if ( (unsigned int)v5 <= 0x2B )
    {
      if ( (_DWORD)v5 == 43 )
      {
        v71 = Src;
        *(_DWORD *)Src = 20;
        v71[1] = *(_DWORD *)(gpsi + 2124LL) - 6;
        v71[2] = *(_DWORD *)(gpsi + 2084LL) - *(_DWORD *)(gpsi + 2124LL);
        v71[3] = *(_DWORD *)(gpsi + 2088LL) - *(_DWORD *)(gpsi + 2128LL);
        v71[4] = *(_DWORD *)(gpsi + 2120LL);
        goto LABEL_68;
      }
      if ( (unsigned int)v5 <= 0x18 )
      {
        if ( (_DWORD)v5 == 24 )
        {
          if ( ((unsigned __int64)Src & 0xFFFFFFFFFFFF0000uLL) == 0 )
          {
            if ( a2 )
            {
              if ( (W32GetCurrentThreadDpiAwarenessContext(v15) & 0xF) != 0 )
              {
                ...
                v61 = EngMulDiv(a2, *(unsigned __int16 *)(gpsi + 6998LL), *(unsigned __int16 *)(v62 + 284));
                v64 = PsGetCurrentProcessWin32Process(v63);
                a2 = EngMulDiv(v61, 96, *(unsigned __int16 *)(v64 + 284));
              }
              else
              {
                v61 = EngMulDiv(a2, *(unsigned __int16 *)(gpsi + 6998LL), 96);
              }
              v65 = *(_DWORD *)(gpsi + 2308LL);
              if ( v61 > v65 )
                v65 = v61;
              v66 = *(_DWORD *)(gpsi + 2428LL);
              if ( a2 > v66 )
                v66 = a2;
              if ( v9 )
              {
                updated = SetWindowMetricInt(0LL, 0x41u, v65);
                v11 = updated;
              }
              if ( v11 )
              {
                SetDpiDepSysMet(19LL);
                *(_DWORD *)(gpsi + 2480LL) = v66;
              }
            }
            goto LABEL_68;
          }
          ...
          v43 = 19LL;
LABEL_112:
          UserHandedness = GetDpiDependentMetric(v43, DpiForSystem, v42);
LABEL_113:
          ...
          if ( (_DWORD)v5 != 13 )
          {
            if ( (_DWORD)v5 != 1 )
            {
              ...
              if ( (_DWORD)v5 != 4 )
              {
                if ( (_DWORD)v5 == 5 )
                {
                  DeferredContext_high = *(_DWORD *)(GetDPIServerInfo(13LL) + 4);
                  goto LABEL_75;
                }
                if ( (_DWORD)v5 != 6 )
                {
...
LABEL_480:
                  ...
                  DeferredContext_high = gnKeyboardSpeed & 0x1F;
LABEL_75:
                  *(_DWORD *)Src = DeferredContext_high;
                  goto LABEL_68;
                }
                v25 = 1;
                if ( (int)a2 > 1 )
...
LABEL_99:
                ...
                {
                  v38 = Src;
                  LODWORD(WPP_MAIN_CB.Dpc.DpcData) = *(_DWORD *)Src;
                  HIDWORD(WPP_MAIN_CB.Dpc.SystemArgument2) = *((_DWORD *)Src + 1);
                  LOBYTE(v38) = *((_DWORD *)Src + 2) != 0;
                  EnableMouseAcceleration(v38, v10, v12, CurrentProcessWin32Process);
                }
                goto LABEL_68;
              }
...
LABEL_98:
                ...
                UpdateWinIniInt(v30, 12LL, 10LL, LODWORD(WPP_MAIN_CB.Dpc.DpcData));
              }
              if ( v31 )
                UpdateWinIniInt(v30, 12LL, 11LL, HIDWORD(WPP_MAIN_CB.Dpc.SystemArgument2));
              if ( v36 )
              {
...
LABEL_109:
          ...
          if ( ((unsigned __int64)Src & 0xFFFFFFFFFFFF0000uLL) == 0 )
          {
            if ( a2 )
            {
              if ( (W32GetCurrentThreadDpiAwarenessContext(13LL) & 0xF) != 0 )
              {
                ...
                v46 = EngMulDiv(a2, *(unsigned __int16 *)(gpsi + 6998LL), *(unsigned __int16 *)(v47 + 284));
                v49 = PsGetCurrentProcessWin32Process(v48);
                a2 = EngMulDiv(v46, 96, *(unsigned __int16 *)(v49 + 284));
              }
              else
              {
                v46 = EngMulDiv(a2, *(unsigned __int16 *)(gpsi + 6998LL), 96);
              }
              v50 = *(_DWORD *)(gpsi + 2304LL);
              if ( v46 > v50 )
                v50 = v46;
              v51 = *(_DWORD *)(gpsi + 2424LL);
              if ( a2 > v51 )
                v51 = a2;
              if ( v9 )
              {
                updated = SetWindowMetricInt(0LL, 0x40u, v50);
                v11 = updated;
              }
              if ( v11 )
              {
                SetDpiDepSysMet(18LL);
                *(_DWORD *)(gpsi + 2476LL) = v51;
              }
            }
            goto LABEL_68;
          }
        ...
        if ( (_DWORD)v5 == 14 )
        {
          v59 = (int)abs32(giScreenSaveTimeOutMs) / 1000;
          goto LABEL_216;
        }
        if ( (_DWORD)v5 != 15 )
        {
          if ( (_DWORD)v5 == 16 )
          {
            DeferredContext_high = giScreenSaveTimeOutMs > 0;
            goto LABEL_75;
          }
          if ( (_DWORD)v5 != 17 )
          {
            if ( (_DWORD)v5 != 20 )
            {
              if ( (_DWORD)v5 != 21 )
              {
                ...
                DeferredContext_high = (gnKeyboardSpeed >> 5) & 3;
                goto LABEL_75;
              }
              v186 = (__int64)Src;
              if ( a2 == -1 && Src )
...
LABEL_439:
              ...
              if ( v9 && v186 )
              {
                FastGetProfileStringFromIDW(v27, 4LL, 2LL, &word_1C02E3EA4, v213, 260, 0);
              ...
              if ( v11 )
              {
                if ( !(unsigned int)SetDesktopPattern(v27, v52) )
                {
                  if ( v9 && v186 )
                ...
                v53 = *(_QWORD *)(gptiCurrent + 448LL);
                if ( v53 )
                  v54 = *(struct tagWND **)(*(_QWORD *)(v53 + 8) + 24LL);
                else
                  v54 = 0LL;
                xxxInternalInvalidate(v54, (HRGN)1, 0x10485u);
              }
              goto LABEL_85;
            }
            v55 = CreateProfileUserName(&v188);
            if ( (unsigned int)CheckDesktopPolicy(v55, 67LL) )
            {
              v9 = 0;
              v11 = 0;
            }
            if ( v9 )
            {
              ...
              {
                FastGetProfileStringFromIDW(v55, 4LL, 67LL, &word_1C02E3EA4, v213, 260, 8);
                updated = FastUpdateWinIni(v55, 4LL, 67LL, Src);
                v11 = updated;
              }
            }
            if ( v11 )
            {
              if ( (unsigned int)xxxSetDeskWallpaper(v55, Src) )
              {
              ...
              else
              {
                if ( v9 )
                {
                  if ( a2 == -1 )
                    goto LABEL_170;
                  FastUpdateWinIni(v55, 4LL, 67LL, v213);
                }
                v11 = 0;
                updated = 0;
              }
...
LABEL_762:
        ...
        *(_QWORD *)&v201 = giScreenSaveTimeOutMs;
        ...
        if ( gdwRITdemonLockState && !(_DWORD)v12 )
          goto LABEL_762;
        v56 = 1000 * a2;
        v57 = 1000 * GetEasTimeout(13LL, 2LL, v12, CurrentProcessWin32Process);
        LODWORD(v187) = v57;
        if ( v57 )
        {
          if ( *(int *)v201 > 0 && v57 < v56 || v56 <= 0 )
          {
        ...
        if ( (unsigned int)CheckDesktopPolicy(0LL, 99LL) )
        {
          if ( v8 )
          {
            ...
            v58 = 1000 * v185;
            v185 = v58;
            if ( !v58 || v58 >= (int)v187 || *(int *)v201 <= 0 || v58 >= v56 )
              goto LABEL_206;
            UserSetLastError(1260LL);
          }
          v184 = 0;
...
LABEL_206:
        if ( v9 )
        {
          updated = UpdateWinIniInt(0LL, 4LL, 99LL, v56 / 0x3E8u);
          v183 = updated;
          v11 = updated;
          v184 = updated;
        }
...
LABEL_69:
      ...
      v69 = (struct _UNICODE_STRING *)CreateProfileUserName(&v188);
      v70 = xxxSetSPIMetrics(v69, 34, (struct tagMINIMIZEDMETRICS *)Src, v9, &v183);
      FreeProfileUserName(v69, &v188);
      if ( v70 )
      {
        updated = v183;
        v21 = v180;
      ...
      if ( (unsigned int)v5 <= 0x39 )
      {
        switch ( (_DWORD)v5 )
        {
          ...
          case '-':
            v92 = Src;
            *(_DWORD *)Src = 108;
            v93 = GetDpiForSystem(v15, 2LL);
            v92[1] = GetDpiDependentMetric(18LL, v93, v94);
            v97 = GetDpiForSystem(v96, v95);
            v92[2] = GetDpiDependentMetric(19LL, v97, v98);
            v99 = (gdwPUDFlags >> 21) & 1;
            v92[3] = v99;
            DPIMetrics = GetDPIMetrics(v99, v100, v101, v102);
LABEL_245:
            GreExtGetObjectW(*(HBRUSH *)(DPIMetrics + 64));
            goto LABEL_68;
          case '.':
LABEL_274:
            v68 = xxxSetSPIMetrics(0LL, v5, (struct tagMINIMIZEDMETRICS *)Src, v9, &v183);
            updated = v183;
            if ( v68 )
            {
              if ( v9 )
          ...
          case '/':
            ...
            if ( Src )
            {
              if ( *((_DWORD *)Src + 2) < *(_DWORD *)Src || *((_DWORD *)Src + 3) < *((_DWORD *)Src + 1) )
                return 0LL;
              v82 = MonitorFromRect((struct tagRECT *)Src, 1LL, 0);
            }
            else
            {
              v82 = *(_QWORD *)(GetDispInfo(v15, 2LL) + 96);
            }
            v190 = v82;
            v203 = *GetMonitorRect(&v197, v82);
            v83 = &v203;
            if ( Src )
              v83 = (__int128 *)Src;
            if ( !(unsigned int)IntersectRect(&v201, v83, &v203) || v201 != *v83 )
              goto LABEL_5;
            ...
            if ( v210 != v201 )
            {
              ...
              if ( a2 )
              {
                v85 = SnapshotMonitorRects();
                if ( !v85 )
                  return 0LL;
              }
              if ( (W32GetCurrentThreadDpiAwarenessContext(v84) & 0xF) != 2
                && *(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 448)
                && (v86 = **(_QWORD **)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 448) + 8LL),
                    (*(_DWORD *)(v86 + 64) & 1) != 0) )
              {
                v87 = *(_QWORD *)(v190 + 40);
                CurrentThreadDpiAwarenessContext = W32GetCurrentThreadDpiAwarenessContext(v86);
                LogicalToPhysicalDPIRect(v87 + 44, &v201, CurrentThreadDpiAwarenessContext, &v190);
              }
              else
              {
                v89 = v190;
                *(_QWORD *)(*(_QWORD *)(v190 + 40) + 44LL) = v201;
                *(_DWORD *)(*(_QWORD *)(v89 + 40) + 52LL) = DWORD2(v201);
                v90 = *(_QWORD *)(v89 + 40);
                *(_DWORD *)(v90 + 56) = HIDWORD(v201);
              }
              DispInfo = GetDispInfo(v90, v89);
              ...
              if ( a2 )
              {
                v193 = 0LL;
                v194 = 0LL;
                PushW32ThreadLock(v85, &v193, (__int64)Win32FreePool);
                xxxDesktopRecalc(*(ShellWindowManagement **)(gptiCurrent + 448LL));
        ...
        if ( (_DWORD)v5 != 48 )
        {
          if ( (_DWORD)v5 == 54 )
          {
            ...
            *(struct tagMOUSEKEYS **)(v77 + 20) = *(struct tagMOUSEKEYS *const *)((char *)&gMouseKeys + 20);
            v78 = *((_DWORD *)v77 + 1) & 0x4CFFFFFF;
            *((_DWORD *)v77 + 1) = v78;
            if ( gbMKMouseMode )
            {
              v78 |= 0x80000000;
            ...
            v79 = v78 | ((gwMKButtonState & 3) << 24);
            *((_DWORD *)v77 + 1) = v79;
            *((_DWORD *)v77 + 1) = v79 | ((gwMKCurrentButton & 3) << 28);
            goto LABEL_68;
          }
          if ( (_DWORD)v5 == 55 )
          {
            v72 = (struct tagMOUSEKEYS *)Src;
            if ( a2 && a2 != 28 )
              return 0LL;
            if ( !Src )
              return 0LL;
            if ( *(_DWORD *)Src != 28 )
              return 0LL;
            v73 = *((_DWORD *)Src + 1) & 0x4CFFFFFF;
            *((_DWORD *)Src + 1) = v73;
            if ( (unsigned __int8)v73 != v73 )
              return 0LL;
            v74 = (HIDWORD(gMouseKeys) & 2) != 0 ? v73 | 2 : v73 & 0xFFFFFFFD;
            *((_DWORD *)v72 + 1) = v74;
            if ( (unsigned int)(*((_DWORD *)v72 + 2) - 10) > 0x15E
              || (unsigned int)(*((_DWORD *)v72 + 3) - 1000) > 0xFA0 )
            {
              return 0LL;
            }
            if ( v9 )
            {
              v75 = (struct _UNICODE_STRING *)CreateProfileUserName(&v188);
              updated = SetMouseKeys(v75, v72);
              v11 = updated;
              if ( !updated )
                SetMouseKeys(v75, gMouseKeys);
              FreeProfileUserName(v75, &v188);
            }
            if ( v11 )
            {
              memmove(gMouseKeys, v72, *(unsigned int *)v72);
              LODWORD(gMouseKeys) = 28;
              CalculateMouseTable();
              v76 = HIDWORD(gMouseKeys);
              if ( (v76 & 1) != 0 )
              {
                gbMKMouseMode = ((v76 >> 7) & 1) != (((unsigned __int8)(1 << (2 * (gNumLockVk & 3) + 1)) & gafAsyncKeyState[(unsigned __int64)gNumLockVk >> 2]) != 0);
                MKShowMouseCursor();
              }
              else
              {
        ...
        v80 = GetDispInfo(v15, 2LL);
        MonitorWorkRect = GetMonitorWorkRect(&v196, *(_QWORD *)(v80 + 96));
LABEL_340:
      ...
      switch ( (_DWORD)v5 )
      {
        case '@':
          ...
          *(_OWORD *)(v113 + 20) = *(_OWORD *)((char *)&gSoundSentry + 20);
          *(_OWORD *)(v113 + 36) = *(_OWORD *)((char *)&gSoundSentry + 36);
          *((_DWORD *)v113 + 13) = *((_DWORD *)&gSoundSentry + 13);
          goto LABEL_68;
        case 'A':
          v108 = (struct tagSOUNDSENTRYW *)Src;
          if ( a2 && a2 != 56 )
            return 0LL;
          if ( !Src )
            return 0LL;
          if ( *(_DWORD *)Src != 56 )
            return 0LL;
          v109 = *((_DWORD *)Src + 1);
          if ( (v109 & 7) != v109 || *((_DWORD *)Src + 8) > 3u || *((_DWORD *)Src + 2) || *((_DWORD *)Src + 5) )
            return 0LL;
          ...
          *((_DWORD *)Src + 1) = v111;
          if ( v9 )
          {
            v112 = (struct _UNICODE_STRING *)CreateProfileUserName(&v188);
            updated = SetSoundSentry(v112, v108);
            v11 = updated;
            if ( !updated )
              SetSoundSentry(v112, gSoundSentry);
            FreeProfileUserName(v112, &v188);
          }
          if ( v11 )
          {
            memmove(gSoundSentry, v108, *(unsigned int *)v108);
        ...
        case 'B':
          ...
          *((_DWORD *)Src + 1) = gHighContrast[1];
          v106 = (_OWORD *)v105[1];
          v107 = gHighContrastDefaultScheme;
          do
          {
            *v106 = *(_OWORD *)v107;
            v106[1] = *((_OWORD *)v107 + 1);
            v106[2] = *((_OWORD *)v107 + 2);
            v106[3] = *((_OWORD *)v107 + 3);
            v106[4] = *((_OWORD *)v107 + 4);
            v106[5] = *((_OWORD *)v107 + 5);
            v106[6] = *((_OWORD *)v107 + 6);
            v106 += 8;
            *(v106 - 1) = *((_OWORD *)v107 + 7);
            v107 += 64;
            --v10;
          }
          while ( v10 );
        ...
        switch ( (_DWORD)v5 )
        {
          ...
          case 'E':
            if ( v9 )
            {
              ...
              if ( !a2 )
                v104 = L"0";
              updated = FastWriteProfileStringW(0LL, 27LL, L"On", v104);
              v11 = updated;
            }
            if ( v11 )
            {
          ...
          case 'G':
            if ( v9 )
            {
              ...
              if ( !a2 )
                v103 = L"0";
              updated = FastWriteProfileStringW(0LL, 28LL, L"On", v103);
              v11 = updated;
            }
            if ( v11 )
            {
...
LABEL_399:
    ...
    if ( (unsigned int)v5 <= 0x5A )
    {
      if ( (_DWORD)v5 == 90 )
      {
        v117 = HKLtoPKL(gptiCurrent, *(_QWORD *)Src, v12, CurrentProcessWin32Process);
        if ( !v117 )
          return 0LL;
        if ( v11 )
        {
      ...
      if ( (_DWORD)v5 != 74 )
      {
        switch ( (_DWORD)v5 )
        {
          case 'K':
            ...
            if ( v9 )
            {
              updated = UpdateWinIniInt(0LL, 4LL, 200LL, v115);
              v11 = updated;
            }
            if ( v11 )
              GreSetFontEnumeration(v115 | 4);
            goto LABEL_68;
          case 'L':
          ...
          case 'W':
            v55 = CreateProfileUserName(&v188);
            xxxUpdateSystemCursorsFromRegistry(v55, 2LL);
            break;
          case 'X':
            v55 = CreateProfileUserName(&v188);
            xxxUpdateSystemIconsFromRegistry(v55);
            break;
          case 'Y':
            if ( !gspklBaseLayout )
            {
...
LABEL_463:
    ...
    {
      case '[':
        return GetKbdLangSwitch(0LL, 2LL, 91LL, CurrentProcessWin32Process);
      case ']':
        if ( v9 )
        {
        ...
        if ( v11 )
          SetMouseTrails(a2, v10, v118, CurrentProcessWin32Process);
        goto LABEL_68;
      case '^':
        DeferredContext_high = LODWORD(WPP_MAIN_CB.Dpc.ProcessorHistory) + 1;
        if ( !LODWORD(WPP_MAIN_CB.Dpc.ProcessorHistory) )
          DeferredContext_high = 0;
        goto LABEL_75;
    }
    if ( (_DWORD)v5 != 95 )
    {
      ...
      if ( (_DWORD)v5 != 98 )
      {
        ...
        v22 = v181;
        if ( v11 )
          LODWORD(WPP_MAIN_CB.Dpc.SystemArgument1) = a2;
        goto LABEL_480;
      }
      DeferredContext_high = (int)WPP_MAIN_CB.Dpc.SystemArgument1;
      goto LABEL_75;
    }
    ...
    if ( (unsigned int)v5 <= 0x9C )
    {
      ...
      if ( (unsigned int)v5 <= 0x94 )
      {
        if ( (_DWORD)v5 != 148 )
        {
          ...
          {
            case 0x8A:
              DeferredContext_high = dword_1C0330C04;
              goto LABEL_75;
            case 0x8B:
              if ( a2 > *(_DWORD *)(gpDispInfo + 136LL) || a2 < dword_1C0330C00 || a2 < dword_1C0330BF4 )
                goto LABEL_68;
              UpdateThresholdFromMetric(v9, &v183, &v184, 0x16u, a2, 5);
              goto LABEL_609;
            case 0x8C:
              v116 = dword_1C0330C0C;
              goto LABEL_463;
            case 0x8D:
              v129 = 624;
              v8 = 2;
...
LABEL_697:
    ...
    if ( (unsigned int)v5 > 0xA6 )
    {
      if ( (_DWORD)v5 != 167 )
      {
        if ( (_DWORD)v5 == 168 )
        {
          DeferredContext_high = gbLockScreenAutoLockActive;
          goto LABEL_75;
        }
        if ( (_DWORD)v5 != 169 )
        {
          if ( (_DWORD)v5 != 170 )
          {
            switch ( (_DWORD)v5 )
            {
              case 0xAB:
                ...
                {
                  if ( !gptiForeground
                    || (v142 = *(_QWORD *)(gptiForeground + 424LL)) == 0
          ...
          switch ( (_DWORD)v5 )
          {
            ...
            case 0xA3:
              ...
              if ( Src )
              {
                if ( *((_DWORD *)Src + 2) < *(_DWORD *)Src || *((_DWORD *)Src + 3) < *((_DWORD *)Src + 1) )
                  return 0LL;
                v133 = MonitorFromRect((struct tagRECT *)Src, 1LL, 0);
              }
              else
              {
              ...
              if ( Src )
                v134 = (__int128 *)Src;
              if ( !(unsigned int)IntersectRect(&v202, v134, &v204) || v202 != *v134 )
                goto LABEL_5;
              if ( (W32GetCurrentThreadDpiAwarenessContext(v135) & 0xF) != 2 )
              {
                if ( *(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 448) )
                {
                  v136 = **(_QWORD **)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 448) + 8LL);
...
LABEL_710:
  ...
  if ( (_DWORD)v5 == 137 )
  {
    if ( a2 > *(_DWORD *)(gpDispInfo + 136LL) || a2 > dword_1C0330C04 || a2 < gWinArrGlobal[0] )
      goto LABEL_68;
      ...
      if ( (_DWORD)v5 != 129 )
      {
        switch ( (_DWORD)v5 )
        {
          case 'y':
            ...
            break;
          case 'z':
            DeferredContext_high = gdwWaitToKillTimeout;
            goto LABEL_75;
          case '{':
          ...
          case '}':
            ...
            break;
          case '~':
            DeferredContext_high = gWinArrGlobal[0];
            goto LABEL_75;
          case '\x7F':
            ...
            goto LABEL_609;
          default:
            DeferredContext_high = dword_1C0330BF4;
            goto LABEL_75;
        }
        *v128 = a2;
        goto LABEL_68;
      }
      if ( a2 > *(_DWORD *)(gpDispInfo + 136LL) || a2 < gWinArrGlobal[0] || a2 > dword_1C0330BFC || a2 > dword_1C0330C04 )
        goto LABEL_68;
...
LABEL_609:
    ...
    if ( (_DWORD)v5 != 131 )
    {
      ...
      {
        case 0x84:
          DeferredContext_high = dword_1C0330BF8;
          goto LABEL_75;
        case 0x85:
          if ( a2 > *(_DWORD *)(gpDispInfo + 136LL) || a2 > dword_1C0330BFC || a2 < gWinArrGlobal[0] )
            goto LABEL_68;
          UpdateThresholdFromMetric(v9, &v183, &v184, 0x13u, a2, 2);
          break;
        case 0x86:
          DeferredContext_high = dword_1C0330BFC;
          goto LABEL_75;
        case 0x87:
          if ( a2 > *(_DWORD *)(gpDispInfo + 136LL) || a2 < dword_1C0330BF8 || a2 < dword_1C0330BF4 )
            goto LABEL_68;
          UpdateThresholdFromMetric(v9, &v183, &v184, 0x14u, a2, 3);
          break;
        default:
          DeferredContext_high = dword_1C0330C00;
          goto LABEL_75;
      }
      goto LABEL_609;
    }
...
LABEL_677:
  ...
  if ( (unsigned int)v5 <= 0x6F )
  {
    ...
    {
      case 'o':
        v11 = xxxSetIMEShowStatus(a2 != 0, v9, &v183, CurrentProcessWin32Process);
        goto LABEL_294;
      case 'e':
        if ( v9 )
        {
        ...
        v22 = v181;
        if ( v11 )
          HIDWORD(WPP_MAIN_CB.Dpc.DeferredContext) = a2;
        goto LABEL_480;
      case 'f':
        DeferredContext_high = (int)WPP_MAIN_CB.Dpc.DeferredContext;
        goto LABEL_75;
      case 'g':
        if ( a2 >= 0xA )
          v19 = a2;
        ...
        v22 = v181;
        if ( v11 )
          LODWORD(WPP_MAIN_CB.Dpc.DeferredContext) = v19;
        goto LABEL_70;
      case 'j':
        DeferredContext_high = HIDWORD(WPP_MAIN_CB.Dpc.DpcData);
        goto LABEL_75;
      case 'k':
        ...
        v22 = v181;
        if ( v11 )
          HIDWORD(WPP_MAIN_CB.Dpc.DpcData) = a2;
        goto LABEL_480;
      case 'l':
        v59 = *(_DWORD *)(gpsi + 4992LL);
        goto LABEL_216;
      case 'm':
          ...
          switch ( v180 )
          {
            case 0x2007u:
              *(_DWORD *)(gpsi + 7008LL) = *(_DWORD *)UPDWORDPointer(8199LL);
              break;
            case 0x200Bu:
              v177 = (_DWORD *)UPDWORDPointer(8203LL);
              GreSetFontEnumeration(8 * (*v177 & 2 | 4u));
              break;
            case 0x200Du:
...
LABEL_832:
      ...
      if ( (_DWORD)v5 == 4133 )
      {
        v171 = (void *)ReferenceDwmApiPort(0LL);
...
LABEL_847:
    ...
    v120 = HIDWORD(WPP_MAIN_CB.Dpc.SystemArgument1) == 0;
LABEL_513:
    DeferredContext_high = !v120;
    goto LABEL_75;
  }
  switch ( (_DWORD)v5 )
  {
    ...
    case 'q':
      ...
      if ( v9 )
      {
        RtlStringCchPrintfW(v211, 0x28uLL, L"%d", Src);
    ...
    case 's':
      ...
      v55 = CreateProfileUserName(&v188);
      LoadWallpaperFilenameFromRegistry(v55, Src, 260LL);
      goto LABEL_170;
    case 't':
    ...
    case 'u':
      ...
      if ( v9 )
      {
        ...
        RtlStringCchPrintfW(v211, 0x28uLL, L"%d", *((unsigned int *)Src + 2));
