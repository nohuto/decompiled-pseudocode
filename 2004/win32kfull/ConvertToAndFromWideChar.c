/*
 * XREFs of ConvertToAndFromWideChar @ 0x1C00F4524
 * Callers:
 ...
 *     EngMultiByteToWideChar @ 0x1C027E580 (EngMultiByteToWideChar.c)
 *     EngWideCharToMultiByte @ 0x1C027E6F0 (EngWideCharToMultiByte.c)
 ...
 *     ConvertToAndFromWideCharSymCP @ 0x1C027E1FC (ConvertToAndFromWideCharSymCP.c)
    ...
    if ( !p_CodePageTable )
    {
      ...
      *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
      ...
      if ( ZwQueryInformationFile(FileHandle, &IoStatusBlock, &FileInformation, 0x18u, FileStandardInformation) >= 0 )
      {
        ...
        {
          v15 = (USHORT *)PALLOCMEM2(DWORD2(FileInformation), 1668768583LL, 1);
          v11 = v15;
          if ( v15 )
          {
