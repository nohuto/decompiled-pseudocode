/*
 * XREFs of ?MakeITable@@YAHPEAEPEAURGBX@@H@Z @ 0x1C00EA524
 * Callers:
 ...
 *     ?MakeITable256@@YAHPEAE@Z @ 0x1C029BD34 (-MakeITable256@@YAHPEAE@Z.c)
 *     ?MakeITableMono@@YAHPEAE@Z @ 0x1C029BD8C (-MakeITableMono@@YAHPEAE@Z.c)
