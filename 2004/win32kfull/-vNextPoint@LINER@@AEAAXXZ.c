/*
 * XREFs of ?vNextPoint@LINER@@AEAAXXZ @ 0x1C01333D4
 * Callers:
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C01332F4 (-vNextEvent@LINER@@QEAAXXZ.c)
 * Callees:
 *     ?vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z @ 0x1C0131FBC (-vInit@BEZIER@@QEAAXPEAU_POINTFIX@@PEAU_RECTFX@@PEB_J@Z.c)
