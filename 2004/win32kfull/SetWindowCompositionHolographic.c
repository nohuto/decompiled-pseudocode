/*
 * XREFs of SetWindowCompositionHolographic @ 0x1C0214DBC
 * Callers:
...
__int64 __fastcall SetWindowCompositionHolographic(__int64 *a1, __int128 *a2, __int64 a3)
{
  bool v4; // zf
  int v6; // edi
  unsigned int v7; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 14) == v6 )
      return 0;
    LODWORD(v11[0]) = (v6 << 13) | v11[0] & 0xFFFFDFFF;
