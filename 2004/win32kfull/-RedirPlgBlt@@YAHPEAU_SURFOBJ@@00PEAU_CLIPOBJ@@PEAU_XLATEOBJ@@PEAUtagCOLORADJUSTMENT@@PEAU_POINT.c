/*
 * XREFs of ?RedirPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C029D200
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (v19 & 0x20000) != 0 )
        {
          for ( i = **(struct _DISPSURF ***)(v18 + 1800); i; i = *(struct _DISPSURF **)i )
          {
              ...
              && *(_QWORD *)(*(_QWORD *)(v20 + 1792) + 624LL) )
            {
              ...
              (*(void (__fastcall **)(struct _SURFOBJ *, __int64, struct _SURFOBJ *, CLIPOBJ *, XLATEOBJ *, COLORADJUSTMENT *, POINTL *, POINTFIX *, RECTL *, POINTL *, ULONG))(v23 + 624))(
                v22,
                v24,
                DevBitmap,
                pco,
