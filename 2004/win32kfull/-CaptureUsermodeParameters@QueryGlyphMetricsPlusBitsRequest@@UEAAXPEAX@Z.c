/*
 * XREFs of ?CaptureUsermodeParameters@QueryGlyphMetricsPlusBitsRequest@@UEAAXPEAX@Z @ 0x1C0086910
 * Callers:
 *     <none>
 * Callees:
 *     ?ValidateGlyphBitsBuffer@@YA_NKJJKK@Z @ 0x1C0089E54 (-ValidateGlyphBitsBuffer@@YA_NKJJKK@Z.c)
 *     ?CaptureUsermodeFontObj@FontDriverDdiRequest@@KA_NPEAU_FONTOBJ@@0@Z @ 0x1C008A0E8 (-CaptureUsermodeFontObj@FontDriverDdiRequest@@KA_NPEAU_FONTOBJ@@0@Z.c)
