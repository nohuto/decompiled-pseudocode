/*
 * XREFs of ?NtGdiFlushUserBatchInternal@@YAXPEAX@Z @ 0x1C007AD40
 * Callers:
 *     NtGdiFlushUserBatch @ 0x1C007AD10 (NtGdiFlushUserBatch.c)
 * Callees:
...
void __fastcall NtGdiFlushUserBatchInternal(PVOID Parameter, __int64 a2, DC *a3, __int64 a4)
{
  ...
  unsigned int v96; // [rsp+10Ch] [rbp-15Ch]
  unsigned int v97; // [rsp+110h] [rbp-158h]
              ...
              case 0:
                ...
                else
                {
                  ...
                  *(_DWORD *)(*((_QWORD *)v68 + 122) + 180LL) = v81;
                  GreMaskBlt(FiberData, v98, v84, v83, v82, 0LL, 0, 0, 0LL, 0, 0, v97 << 16, 0);
