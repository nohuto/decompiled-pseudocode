/*
 * XREFs of xxxRemoteStopScreenUpdates @ 0x1C011E450
 * Callers:
 *     xxxRemoteDisconnect @ 0x1C011E080 (xxxRemoteDisconnect.c)
 *     xxxRemoteReconnect @ 0x1C01541B0 (xxxRemoteReconnect.c)
 *     NtUserRemoteStopScreenUpdates @ 0x1C0201AD0 (NtUserRemoteStopScreenUpdates.c)
...
__int64 __fastcall xxxRemoteStopScreenUpdates(int a1, __int16 a2)
{
  ...
  {
    LOBYTE(a2) = 4;
    WPP_RECORDER_SF_(a1, a2, 9, 19, (__int64)&WPP_0f27963f307c3266edb1c5990ca93414_Traceguids);
  }
