/*
 * XREFs of xxxRemoteConsoleShadowStop @ 0x1C0227910
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DrvReleaseHDEV @ 0x1C02749E8 (DrvReleaseHDEV.c)
...
__int64 xxxRemoteConsoleShadowStop()
{
  ...
  *(_OWORD *)&DestinationString[1] = 0LL;
  ...
  {
    LOBYTE(v0) = 4;
    WPP_RECORDER_SF_(v1, v0, 9, 10, (__int64)&WPP_0f27963f307c3266edb1c5990ca93414_Traceguids);
  }
  ...
  {
    LOBYTE(v5) = 4;
    WPP_RECORDER_SF_(v6, v5, 9, 11, (__int64)&WPP_0f27963f307c3266edb1c5990ca93414_Traceguids);
  }
