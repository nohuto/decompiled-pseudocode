/*
 * XREFs of PlaySoundPostMessage @ 0x1C037C4FC
 * Callers:
 *     ?PlaySync@CUserPlaySound@@AEAAJK@Z @ 0x1C00FD010 (-PlaySync@CUserPlaySound@@AEAAJK@Z.c)
 * Callees:
 *     I_PlaySoundkPostMessage @ 0x1C00FD0A8 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C00FD100 (PlaySndClient_midl_user_allocate.c)
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C01050A0 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 */
