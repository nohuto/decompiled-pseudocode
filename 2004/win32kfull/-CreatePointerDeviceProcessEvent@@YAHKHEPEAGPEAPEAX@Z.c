/*
 * XREFs of ?CreatePointerDeviceProcessEvent@@YAHKHEPEAGPEAPEAX@Z @ 0x1C00C7E24
 * Callers:
 *     CreatePointerDeviceProcessEvents @ 0x1C00C7DC8 (CreatePointerDeviceProcessEvents.c)
 * Callees:
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C00C818C (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
