/*
 * XREFs of ?vDeleteRFONT@RFONTOBJ@@QEAAXPEAVPDEVOBJ@@PEAVPFFOBJ@@H@Z @ 0x1C00DC528
 * Callers:
 ...
 *     RFONTOBJ_vDeleteRFONTWrap @ 0x1C01240C0 (RFONTOBJ_vDeleteRFONTWrap.c)
 ...
 *     ?vDeleteCache@RFONTOBJ@@QEAAXXZ @ 0x1C00DC870 (-vDeleteCache@RFONTOBJ@@QEAAXXZ.c)
 ...
 *     ?cInactive@PDEVOBJ@@QEAAIXZ @ 0x1C00FE620 (-cInactive@PDEVOBJ@@QEAAIXZ.c)
 */

void __fastcall RFONTOBJ::vDeleteRFONT(struct _FONTOBJ **this, struct PDEVOBJ *a2, struct PFFOBJ *a3, __int64 a4)
{
  ...
  if ( *((_QWORD *)sizLogResPpi + 379) && (_DWORD)a4 )
  {
