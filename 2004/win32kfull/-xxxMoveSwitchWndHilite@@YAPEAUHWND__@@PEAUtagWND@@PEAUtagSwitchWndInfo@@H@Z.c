/*
 * XREFs of ?xxxMoveSwitchWndHilite@@YAPEAUHWND__@@PEAUtagWND@@PEAUtagSwitchWndInfo@@H@Z @ 0x1C01F3BAC
 * Callers:
 ...
 *     ?NextPrevPhwnd@@YAPEAPEAUHWND__@@PEAUtagSwitchWndInfo@@PEAPEAU1@H@Z @ 0x1C01F3948 (-NextPrevPhwnd@@YAPEAPEAUHWND__@@PEAUtagSwitchWndInfo@@PEAPEAU1@H@Z.c)
 *     ?NextPrevTaskIndex@@YAHPEAUtagSwitchWndInfo@@HHH@Z @ 0x1C01F3984 (-NextPrevTaskIndex@@YAHPEAUtagSwitchWndInfo@@HHH@Z.c)
...
LABEL_23:
  ...
  *((_DWORD *)v6 + 17) = v10;
  ...
  if ( v6 )
  {
    ...
    _ReleaseDC(DCEx);
    xxxWindowEvent(0x8005u, a1, -4, v10 + v4 * *((_DWORD *)v6 + 14) + 1, 1u);
  }
  else
  {
    _ReleaseDC(DCEx);
