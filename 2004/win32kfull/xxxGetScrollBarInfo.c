/*
 * XREFs of xxxGetScrollBarInfo @ 0x1C00272B4
 * Callers:
 *     NtUserGetScrollBarInfo @ 0x1C0026E90 (NtUserGetScrollBarInfo.c)
 *     xxxSBWndProc @ 0x1C0246EA0 (xxxSBWndProc.c)
 * Callees:
 *     unsafe_cast_fnid_or_class_to_PSBWND @ 0x1C00274E0 (unsafe_cast_fnid_or_class_to_PSBWND.c)
...
__int64 __fastcall xxxGetScrollBarInfo(__int64 a1, int a2, __int64 a3)
{
  ...
  if ( *(_DWORD *)a3 == 60 )
  {
    ...
    if ( a2 == -4 && !v6 )
    {
      ...
      return xxxSendTransformableMessageTimeout(a1, 235, 0, a3, 0, 0, 0LL, 1, 1);
    }
    *(_OWORD *)(a3 + 36) = 0LL;
    *(_QWORD *)(a3 + 52) = 0LL;
    switch ( a2 )
