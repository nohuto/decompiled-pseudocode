/*
 * XREFs of ??0PROXYPORT@@QEAA@_K@Z @ 0x1C00EF4E4
 * Callers:
    ...
    *(_QWORD *)this = v3;
    if ( v3 )
    {
      ...
      *(_OWORD *)&SectionHandle.ViewBase = 0LL;
      ...
      if ( v12 >= 0 )
      {
        *(_QWORD *)(*(_QWORD *)this + 16LL) = MmSecureVirtualMemory(SectionHandle.ViewBase, SectionHandle.ViewSize, 4u);
      ...
      if ( v12 < 0 || !*(_QWORD *)(*(_QWORD *)this + 16LL) )
      {
LABEL_23:
