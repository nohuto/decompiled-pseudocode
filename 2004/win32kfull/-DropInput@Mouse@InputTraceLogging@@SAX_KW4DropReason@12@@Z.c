/*
 * XREFs of ?DropInput@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z @ 0x1C0213ECC
 * Callers:
...
int __fastcall InputTraceLogging::Mouse::DropInput(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( (unsigned int)dword_1C0330B30 > 4 && (qword_1C0330B40 & 0x40) != 0 )
  {
    v4 = qword_1C0330B48 & 0x40;
    if ( v4 == qword_1C0330B48 )
    {
      v7 = a1;
      v6 = "PTPQueueFull";
