/*
 * XREFs of CitGetWindowInfo @ 0x1C01112C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CitGetWindowInfo(__int64 a1, _WORD *a2)
{
  ...
  if ( result )
  {
    ...
    {
      Prop = (struct tagRECT *)GetProp(result, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink), 1LL);
      if ( Prop )
        v17 = *Prop;
    }
    ...
    *a2 = LOWORD(v17.right) - LOWORD(v17.left);
    ...
    v6 = MonitorFromRect(&v17, 1LL, 0x12u);
    if ( v6 )
