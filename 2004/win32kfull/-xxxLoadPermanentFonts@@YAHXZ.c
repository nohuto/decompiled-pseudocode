/*
 * XREFs of ?xxxLoadPermanentFonts@@YAHXZ @ 0x1C0048C2C
 * Callers:
...
__int64 xxxLoadPermanentFonts(void)
{
  ...
  if ( PsGetCurrentProcess() == gpepCSRSS )
    xxxbEnumerateRegistryFonts(0x80000000LL, 0x36u, v1, v2);
  KeyHandle = 0LL;
  ResultLength = 0;
  v19 = 0LL;
  v17 = 0LL;
  ...
  if ( v4 )
  {
    v6 = xxxbEnumerateRegistryFontsInternal(v4);
    v7 = Win32AllocPool(544LL, 1919972181LL);
    v10 = (unsigned int *)v7;
    if ( v7 )
    {
      PushW32ThreadLock(v7, &v16, (__int64)Win32FreePool);
      for ( i = 0; ; ++i )
      {
...
LABEL_10:
            ...
            *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
            ...
            {
              v6 |= xxxbEnumerateRegistryFontsInternal(KeyHandle);
              ZwClose(KeyHandle);
            }
          }
        }
    ...
    result = v6;
    if ( v6 )
      result = xxxbEnumerateRegistryFonts(1LL, 0x39u, v8, v9);
  }
  else
  {
    result = 0LL;
