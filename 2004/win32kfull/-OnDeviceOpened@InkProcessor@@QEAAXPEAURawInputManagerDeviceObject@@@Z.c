/*
 * XREFs of ?OnDeviceOpened@InkProcessor@@QEAAXPEAURawInputManagerDeviceObject@@@Z @ 0x1C02506A8
 * Callers:
 ...
 * Callees:
 *     ?OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ @ 0x1C0244700 (-OnDeviceOpened@RimBackedDeviceBase@Rim@@UEAAXXZ.c)
