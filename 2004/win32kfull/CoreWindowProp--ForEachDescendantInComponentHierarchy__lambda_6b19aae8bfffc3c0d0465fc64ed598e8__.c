/*
 * XREFs of CoreWindowProp::ForEachDescendantInComponentHierarchy__lambda_6b19aae8bfffc3c0d0465fc64ed598e8___ @ 0x1C0035800
 * Callers:
  ...
  if ( a1 && (unsigned int)CoreWindowProp::IsHost(a1) )
  {
    for ( i = 0LL; ; i = v8 )
    {
      ...
      if ( !NextComponentWindow )
        break;
      lambda_6b19aae8bfffc3c0d0465fc64ed598e8_::operator()(v7, NextComponentWindow);
      LOBYTE(v5) = a2;
