/*
 * XREFs of ?AdjustLegacyDeviceFlags@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C00F8170
 * Callers:
 ...
 *     ?InProcessDeviceTypeRequestTable@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z @ 0x1C00F83F0 (-InProcessDeviceTypeRequestTable@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z.c)
 */
    ...
    *(_DWORD *)(v1 + 100) = v8;
    ...
    if ( gpqForeground )
    {
      ...
      if ( v9 )
      {
        ...
        {
          if ( *(_QWORD *)(*(_QWORD *)(v10 + 416) + 832LL) == v1 )
  ...
  else
  {
    ...
    *(_DWORD *)(v1 + 100) = v13 & 0xFFFFFFF3;
    if ( gpqForeground )
    {
      ...
      if ( v14 )
      {
        if ( (unsigned int)HasHidTable(v14) && *(_QWORD *)(*(_QWORD *)(v15 + 416) + 832LL) == v1 )
