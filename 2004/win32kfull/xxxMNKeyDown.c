/*
 * XREFs of xxxMNKeyDown @ 0x1C0239468
 * Callers:
 ...
 *     MNFindItemInColumn @ 0x1C0251778 (MNFindItemInColumn.c)
...
LABEL_135:
  ...
  result = *(_QWORD **)(v80 + 1464);
  if ( result )
  {
    result = (_QWORD *)*result;
    *(_QWORD *)(v80 + 1464) = result;
  }
  return result;
}
