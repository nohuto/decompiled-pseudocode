/*
 * XREFs of xxxSetModernAppWindow @ 0x1C0005A00
 * Callers:
...
LABEL_57:
            ...
            if ( *(_QWORD *)(v2 + 1392) == v5 && *(struct tagWND **)(v17 + 120) == a1 )
            {
          ...
          if ( v6 )
          {
            if ( *(struct tagWND **)(v6 + 104) == a1 )
            {
              ...
              if ( *(_QWORD *)(v18 + 424) == *(_QWORD *)(v2 + 424) )
              {
                ...
                if ( v25 && gptiForeground == *(_QWORD *)(v6 + 16) && *(_QWORD *)(v2 + 424) == gpqForeground )
