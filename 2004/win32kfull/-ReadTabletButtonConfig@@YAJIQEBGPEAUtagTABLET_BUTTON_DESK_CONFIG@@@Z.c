/*
 * XREFs of ?ReadTabletButtonConfig@@YAJIQEBGPEAUtagTABLET_BUTTON_DESK_CONFIG@@@Z @ 0x1C01D8F6C
 * Callers:
 *     ?ReadTabletButtonSettings@@YAXXZ @ 0x1C01D9394 (-ReadTabletButtonSettings@@YAXXZ.c)
 * Callees:
