/*
 * XREFs of ?TrackBackground@@YAHPEAUtagWINDOWPOS@@PEAUtagWND@@1111@Z @ 0x1C0024154
 * Callers:
 ...
 *     ?IsLastTopMostWindow@@YAHPEBUtagWND@@@Z @ 0x1C0126FB8 (-IsLastTopMostWindow@@YAHPEBUtagWND@@@Z.c)
 */
  ...
  if ( a4 || (v7 = (const struct tagWND *)CalcForegroundInsertAfter(a2)) != 0LL )
  {
    if ( !a6 || *(_QWORD *)(*((_QWORD *)a2 + 2) + 424LL) != gpqForeground || !(unsigned int)IsLastTopMostWindow(v7) )
    {
      if ( !(unsigned int)IsLastTopMostWindow(v7) && a5 == GetRootOwner(a2) )
      {
        ...
        if ( *(_QWORD *)(v12 + 1384) )
        {
          if ( *(_QWORD *)(v12 + 424) == gpqForeground && a5 == *(struct tagWND **)(gpqForeground + 120LL) )
