/*
 * XREFs of DwmSyncFlushForceRenderAndWaitForBatch @ 0x1C003DF10
 * Callers:
...
__int64 __fastcall DwmSyncFlushForceRenderAndWaitForBatch(PVOID Object, int a2)
{
  unsigned int v4; // ebx
  int v5; // eax
  _PORT_MESSAGE v7; // [rsp+30h] [rbp-30h] BYREF
  ...
  if ( Object )
  {
    ...
    if ( !gbInVideoPnpCallout )
    {
      ...
      v8 = -2147483639;
      v9 = a2;
      v5 = ((__int64 (__fastcall *)(PVOID, __int64, _PORT_MESSAGE *, _PORT_MESSAGE *, __int64 *, _QWORD))LpcSendWaitReceivePort)(
             Object,
             0x20000LL,
             &v7,
             &v7,
