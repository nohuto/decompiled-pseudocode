/*
 * XREFs of ?FinishStockFontInitInternal@@YAXPEBGH@Z @ 0x1C000FA04
 * Callers:
 *     FinishStockFontInit @ 0x1C000DD20 (FinishStockFontInit.c)
 * Callees:
 *     bDeleteFont @ 0x1C000F8D0 (bDeleteFont.c)
 *     ?bOpenKey@@YAHPEBGPEAPEAX@Z @ 0x1C000F978 (-bOpenKey@@YAHPEBGPEAPEAX@Z.c)
...
void __fastcall FinishStockFontInitInternal(const unsigned __int16 *a1, int a2)
{
  ...
  do
  {
    if ( !bOpenKey(SourceString[v4], (PHANDLE)&v25 + (int)v3) )
  ...
  do
  {
    ...
    while ( 1 )
    {
      ...
      if ( v15 )
        v18 = v16;
      *v18 = 0;
      if ( !v15 || (int)StringCchCatW(v10, v15, v5) < 0 )
        goto LABEL_34;
      LOBYTE(v19) = 10;
      v20 = v12[*v9];
