/*
 * XREFs of ?InkProcessorOnInkDeviceInputReport@@YAXPEAURawInputManagerDeviceObject@@PEAX@Z @ 0x1C0220FD0
 * Callers:
        ...
        const void *a3)
{
  ...
  else if ( (unsigned int)dword_1C032B288 > 2 )
  {
    ...
    v6 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032B288, (unsigned __int8 *)dword_1C02F13FC, 0LL, 0LL, 3u, &v4);
  }
}
