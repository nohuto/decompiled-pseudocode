/*
 * XREFs of _ChildWindowFromPointEx @ 0x1C0151590
 * Callers:
 *     NtUserChildWindowFromPointEx @ 0x1C0151510 (NtUserChildWindowFromPointEx.c)
...
_QWORD *__fastcall ChildWindowFromPointEx(__int64 a1, unsigned __int64 a2, char a3)
{
  ...
  if ( a1 )
  {
    ...
    {
      v5 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 472);
