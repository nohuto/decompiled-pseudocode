/*
 * XREFs of ?vGradientFill1@@YAXPEAVSURFACE@@PEAU_TRIANGLEDATA@@@Z @ 0x1C02D2B50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Xlate555 )
  {
    ...
    if ( v2 < v7 )
    {
      ...
      do
      {
        ...
        if ( v10 >= *((_DWORD *)v5 + 2) )
          v10 = *((_DWORD *)v5 + 2);
        v32 = (char *)&gDitherMatrix16x16Default + 16 * (((_BYTE)v8 + (_BYTE)v2) & 0xFu);
        if ( v9 < v10 )
        {
          ...
          do
          {
            ...
            v11 += v25;
            v12 += v26;
            LOBYTE(v18) = *v16 & ~(1 << (7 - v15)) | (vTranslateIdentity[Xlate555[(v20 >= 0xFF ? 0x7C00 : 0) | v19]] << (7 - v15));
            v21 = v15 + 1;
            *v16 = v18;
            v22 = v16 + 1;
            v17 = ++v27;
