/*
 * XREFs of ?vSqrt@EFLOAT@@QEAAXXZ @ 0x1C0118458
 * Callers:
 ...
 *     ?efWorldLength@STYLER@@IEAA?AVEFLOAT@@VEVECTORFX@@@Z @ 0x1C02CF098 (-efWorldLength@STYLER@@IEAA-AVEFLOAT@@VEVECTORFX@@@Z.c)
 * Callees:
 *     <none>
 */
