/*
 * XREFs of ?vStripStyledDiagonal@@YAXPEAU_STRIP@@PEAU_BMINFO@@PEAU_LINESTATE@@@Z @ 0x1C02D4200
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall vStripStyledDiagonal(struct _STRIP *a1, struct _BMINFO *a2, struct _LINESTATE *a3)
{
  ...
  do
  {
    ...
    while ( 1 )
    {
      ...
      v13 = v12;
      v4 = *((_DWORD *)a2 + 7) & v12;
      v5 = (int *)((char *)v5 + 4 * (v13 >> *((_BYTE *)a2 + 24)) + v8);
    }
    v9 -= *((_DWORD *)a3 + 2);
    if ( v9 <= 0 )
    {
