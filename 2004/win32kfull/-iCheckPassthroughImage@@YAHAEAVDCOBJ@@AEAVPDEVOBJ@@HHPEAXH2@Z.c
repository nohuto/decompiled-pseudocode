/*
 * XREFs of ?iCheckPassthroughImage@@YAHAEAVDCOBJ@@AEAVPDEVOBJ@@HHPEAXH2@Z @ 0x1C014C224
 * Callers:
 ...
 *     ?bSupportsJPEG@XDCOBJ@@QEAAHXZ @ 0x1C014C550 (-bSupportsJPEG@XDCOBJ@@QEAAHXZ.c)
