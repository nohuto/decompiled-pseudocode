/*
 * XREFs of CalcForegroundInsertAfter @ 0x1C003C8F8
 * Callers:
 ...
 *     ?GetLastNonBottomMostWindow@@YAPEAUtagWND@@PEAU1@H@Z @ 0x1C0102C04 (-GetLastNonBottomMostWindow@@YAPEAUtagWND@@PEAU1@H@Z.c)
 */
