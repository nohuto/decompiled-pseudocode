/*
 * XREFs of xxxMNLoop @ 0x1C0235428
 * Callers:
  ...
  if ( (v9 & 1) == 0 )
  {
    ...
    if ( KeyState >= 0 )
    {
      if ( (*v11 & 0x800) == 0 && *(_QWORD *)(**a1 + 8) )
      {
        ...
        *(_QWORD *)&v41 = *(_QWORD *)(ThreadWin32Thread + 408);
...
LABEL_84:
  ...
  if ( (v9 & 0x100) == 0 )
  {
    while ( 1 )
    {
      ...
      if ( (*(_DWORD *)**a1 & 8) == 0 )
      {
        v22 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 120LL);
        if ( v22 != *(_QWORD *)(**a1 + 8)
          && (!v22
...
LABEL_42:
      *(_DWORD *)(gptiCurrent + 480LL) |= 0x200000u;
      ...
      if ( !(unsigned int)xxxInternalGetMessage(v45, 0LL, v45[1], v45[1], 1, 0) )
      {
        ...
        if ( (v25 & 0x200000) != 0 )
        {
          *(_DWORD *)(gptiCurrent + 480LL) = v25 & 0xFFDFFFFF;
LABEL_60:
