/*
 * XREFs of ?QueryGlyphMetricsPlusBits@PFFOBJ@@QEAAJPEAUDHPDEV__@@PEAU_FONTOBJ@@KKPEAPEAU_GLYPHDATA@@PEAPEAU_GLYPHBITS@@@Z @ 0x1C00DFA2C
 * Callers:
        ...
        struct _GLYPHBITS **a7)
{
  ...
  if ( *(struct PDEV **)(*(_QWORD *)this + 88LL) != qword_1C0341A00 )
    return 0xFFFFFFFFLL;
