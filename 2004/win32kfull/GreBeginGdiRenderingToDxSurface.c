/*
 * XREFs of GreBeginGdiRenderingToDxSurface @ 0x1C002E0B8
 * Callers:
 *     NtGdiBeginGdiRendering @ 0x1C002E0A0 (NtGdiBeginGdiRendering.c)
 * Callees:
 ...
 *     ?bReset@DC@@QEAAHXZ @ 0x1C002EE30 (-bReset@DC@@QEAAHXZ.c)
