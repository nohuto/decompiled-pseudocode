/*
 * XREFs of bUnloadEudcFont @ 0x1C0011CF8
 * Callers:
 ...
 * Callees:
 *     ?vFreePql@PFEOBJ@@QEAAXXZ @ 0x1C0011DD0 (-vFreePql@PFEOBJ@@QEAAXXZ.c)
...
__int64 __fastcall bUnloadEudcFont(__int64 *a1)
{
  ...
  if ( v11 )
  {
    ...
    {
      v3 = 0;
      if ( (dword_1C033B088 & 0x10) != 0 || !bFinallyInitializeFontAssocDefault )
        goto LABEL_5;
      v4 = (char *)&unk_1C0334A9C;
      v8 = 7LL;
      do
      {
