/*
 * XREFs of _InitThreadCoreMessagingIocp @ 0x1C0114300
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
  ...
  v12 = 0LL;
  v15 = 0LL;
  if ( (int)ZwAllocateReserveObject(gptiCurrent + 1448LL, v10, 1LL) < 0 )
  {
  ...
  {
    v3 = *(_QWORD *)(gptiCurrent + 1424LL);
    if ( v3 )
    {
      v9[0] = gptiCurrent + 1456LL;
      v9[1] = a1;
      HMAssignmentLock(v9);
    }
  }
