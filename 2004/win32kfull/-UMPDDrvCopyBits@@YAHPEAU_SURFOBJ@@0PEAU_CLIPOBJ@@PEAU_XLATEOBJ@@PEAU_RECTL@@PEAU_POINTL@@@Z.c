/*
 * XREFs of ?UMPDDrvCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C0140D50
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _POINTL *a6)
{
  ...
  _QWORD v32[10]; // [rsp+F0h] [rbp-20h] BYREF
...
LABEL_3:
    ...
    v32[4] = v9;
    v32[6] = a4;
    if ( !(unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 64), (struct _SURFOBJ **)&v32[3])
      || !(unsigned int)UMPDOBJ::pso(v12, (UMPDOBJ *)((char *)v12 + 80), (struct _SURFOBJ **)&v32[4])
      || !(unsigned int)UMPDOBJ::ThunkDDIOBJ(v12, (UMPDOBJ *)((char *)v12 + 112), (const void **)&v32[5], 0x18u, 0LL)
      || !(unsigned int)UMPDOBJ::pxlo(v12, (struct _XLATEOBJ **)&v32[6])
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v12, (const void **)&v32[7], 0x10u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v12, (const void **)&v32[8], 8u)
      || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v12, v32, 0x48u, &v18, Size) == -1)
      || (v13 = 1, !v18) )
    {
      v13 = 0;
    }
