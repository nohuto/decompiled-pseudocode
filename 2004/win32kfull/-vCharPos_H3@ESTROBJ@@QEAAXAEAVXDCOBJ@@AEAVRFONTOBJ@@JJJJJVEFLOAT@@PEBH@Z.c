/*
 * XREFs of ?vCharPos_H3@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJJJJVEFLOAT@@PEBH@Z @ 0x1C00DEEAC
 * Callers:
 ...
 *     ?bInsertGlyphbits@RFONTOBJ@@QEAAHPEAU_GLYPHDATA@@K@Z @ 0x1C00DE708 (-bInsertGlyphbits@RFONTOBJ@@QEAAHPEAU_GLYPHDATA@@K@Z.c)
        ...
        unsigned __int16 *a10)
{
  ...
  if ( a7 | a6 )
  {
    ...
    *(_DWORD *)(a1 + 4) = v50;
    ...
    v52 = (_DWORD *)(a1 + 120);
    if ( bCalcBreakExtra((unsigned int)_mm_cvtsi128_si32(v49), a7, a8, a1 + 120) )
    {
      v53 = *(_QWORD *)v11;
      v54 = *(_DWORD *)(a1 + 116);
  ...
  else
  {
    ...
    {
      v28 = 0;
      result = RFONTOBJ::bGetGlyphMetrics(v11, (struct RFONTOBJ *)v24, v16, v18, a2, (struct ESTROBJ *)a1);
    }
    else
    {
      v27 = *(_DWORD **)(v26 + 480);
