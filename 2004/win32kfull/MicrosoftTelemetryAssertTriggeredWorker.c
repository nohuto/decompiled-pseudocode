/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C02DF7F4
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredNoArgsKM @ 0x1C02DF7C4 (MicrosoftTelemetryAssertTriggeredNoArgsKM.c)
 * Callees:
 *     TakeTelemetryAssertsLock @ 0x1C0126F84 (TakeTelemetryAssertsLock.c)
 *     __security_check_cookie @ 0x1C0157760 (__security_check_cookie.c)
 *     _tlgWriteTransfer_EtwWriteTransfer @ 0x1C01D2934 (_tlgWriteTransfer_EtwWriteTransfer.c)
 *     GetImageTuple @ 0x1C02DF774 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C02DFD50 (_tlgCreate1Sz_char.c)
 */
...
LABEL_39:
  ...
  v19 = "<unknown>";
  v20 = v27;
  if ( (unsigned int)dword_1C037B040 > 5
    && (qword_1C037B050 & 0x400000000000LL) != 0
    && (qword_1C037B058 & 0x400000000000LL) == qword_1C037B058 )
  {
    v29 = 10;
    v60 = &v29;
    v21 = "<unknown>";
    ...
    tlgWriteTransfer_EtwWriteTransfer(
      (__int64)&dword_1C037B040,
      (unsigned __int8 *)dword_1C02F376E,
      0LL,
      0LL,
      0xBu,
      &v59);
  }
  if ( dword_1C037B078 && !v18 && !KeGetCurrentIrql() )
  {
      ...
      && (qword_1C037B058 & 0x400000000000LL) == qword_1C037B058 )
    {
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C037B040,
        (unsigned __int8 *)dword_1C02F37DB,
        0LL,
        0LL,
        v24,
        &v43);
