/*
 * XREFs of ?GreBatchTextOut@@YAHAEAVXDCOBJ@@PEAU_BATCHTEXTOUT@@K@Z @ 0x1C0082DE0
 * Callers:
...
__int64 __fastcall GreBatchTextOut(struct XDCOBJ *a1, struct _BATCHTEXTOUT *Src, size_t Size)
{
  ...
  if ( !v6 )
    return 0LL;
  if ( (struct _BATCHTEXTOUT *)((char *)Src + v3) < Src || (unsigned __int64)Src + v3 > MmUserProbeAddress )
