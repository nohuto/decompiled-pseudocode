/*
 * XREFs of ?vUMPDCachedResourceCleanup@@YAXPEAU_W32THREAD@@@Z @ 0x1C00ED958
 * Callers:
 *     ?UMPDDrvDisablePDEV@@YAXPEAUDHPDEV__@@@Z @ 0x1C00ED890 (-UMPDDrvDisablePDEV@@YAXPEAUDHPDEV__@@@Z.c)
 *     UMPDCachedResourceCleanupWrap @ 0x1C00ED940 (UMPDCachedResourceCleanupWrap.c)
 * Callees:
 *     ?Close@PROXYPORT@@QEAAXXZ @ 0x1C00EF43C (-Close@PROXYPORT@@QEAAXXZ.c)
