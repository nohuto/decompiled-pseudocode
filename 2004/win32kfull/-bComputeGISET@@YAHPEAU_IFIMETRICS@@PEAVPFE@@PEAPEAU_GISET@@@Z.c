/*
 * XREFs of ?bComputeGISET@@YAHPEAU_IFIMETRICS@@PEAVPFE@@PEAPEAU_GISET@@@Z @ 0x1C0011618
 * Callers:
 ...
 * Callees:
 *     ?cComputeGISET@@YAKPEBGKPEAU_GISET@@K@Z @ 0x1C00104EC (-cComputeGISET@@YAKPEBGKPEAU_GISET@@K@Z.c)
...
__int64 __fastcall bComputeGISET(struct _IFIMETRICS *a1, struct PFE *a2, struct _GISET **a3)
{
  ...
  *a3 = 0LL;
  ...
  v6 = 1;
  v7 = 0LL;
  if ( *(struct PDEV **)(v29 + 88) != qword_1C0341A00 || *(_DWORD *)(*(_QWORD *)(v29 + 80) + 8LL) )
  {
    v8 = 0;
    ...
    if ( !dpwszFamilyName )
    {
      ...
      if ( v12 <= 0xFFFFFFFF )
      {
        ...
        if ( v13 )
        {
          ...
          v22 = (struct _GISET *)PALLOCMEM2((unsigned int)(4 * v21 + 8));
          v23 = v22;
          if ( v22 )
          {
