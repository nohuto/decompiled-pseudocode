/*
 * XREFs of _RealChildWindowFromPoint @ 0x1C024A33C
 * Callers:
 *     NtUserRealChildWindowFromPoint @ 0x1C02013F0 (NtUserRealChildWindowFromPoint.c)
 * Callees:
...
_QWORD *__fastcall RealChildWindowFromPoint(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( a1 )
  {
    ...
    {
      v4 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 472);
