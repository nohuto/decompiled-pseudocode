/*
 * XREFs of ?bLines@@YAHPEAU_BMINFO@@PEAU_POINTFIX@@1PEAU_RUN@@KPEAU_LINESTATE@@PEAU_RECTL@@PEAP6AXPEAU_STRIP@@03@ZKPEAKJPEAU_W32KCDD_ENG_CALLBACKS@@@Z @ 0x1C013D05C
 * Callers:
        ...
        struct _W32KCDD_ENG_CALLBACKS *a12)
{
  ...
  v12 = a3;
  v90 = a3;
  if ( a1 <= (struct _BMINFO *)&off_1C032B5F0 || !bUMPDSecurityGateEx() )
  {
    v93 = &v12[a5];
    v79 = 0;
    v85 = 0;
