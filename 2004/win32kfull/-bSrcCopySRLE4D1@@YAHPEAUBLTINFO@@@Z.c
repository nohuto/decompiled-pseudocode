/*
 * XREFs of ?bSrcCopySRLE4D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02CD680
 * Callers:
 *     <none>
 * Callees:
  ...
  for ( i = v21 <= v11; ; i = v21 <= v66 )
  {
    ...
    if ( v23 )
    {
      ...
      else
      {
        ...
        if ( (int)v52 < (int)v55 )
        {
          *(_BYTE *)(v25 + v3) = v15 | ((unsigned __int8)(v50 & EndMask[v52 + 1]) >> v76);
          LODWORD(v51) = v73;
          if ( (v73 & 1) == 0 )
          {
            v50 *= 2;
...
LABEL_73:
    ...
    else
    {
      if ( v9 >= v60 )
      {
        v30 = byte_1C02FAFF8[(unsigned __int8)(7 - (v9 & 7))];
      }
      else
      {
        v29 = v60 - v9;
        ...
        LODWORD(v26) = v26 - v29;
        v30 = byte_1C02FAFF8[(unsigned __int8)(7 - (v60 & 7))];
        if ( (v29 & 1) != 0 )
        {
          v31 = v15 | v30;
          v30 >>= 1;
