/*
 * XREFs of GetDpiSettingWithNoDefault @ 0x1C000A760
 * Callers:
 *     GetDpiSetting @ 0x1C000A740 (GetDpiSetting.c)
 *     ?PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z @ 0x1C01D4B18 (-PerformWin8DpiUpgrade@@YAHPEAU_UNICODE_STRING@@K@Z.c)
 * Callees:
