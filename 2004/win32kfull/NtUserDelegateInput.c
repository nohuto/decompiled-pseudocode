/*
 * XREFs of NtUserDelegateInput @ 0x1C0114A70
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v9 )
  {
    ...
    if ( *(char *)(v16 + 19) >= 0 && *(char *)(v16 + 20) >= 0 )
    {
      ...
      if ( v18 == PsGetCurrentProcessWin32Process(v11) )
      {
        ...
        else if ( v18 == *(_QWORD *)(v15 + 416) && v17 != v15 )
        {
          v11 = 1LL;
          if ( *(_DWORD *)(*(_QWORD *)(v15 + 424) + 392LL) == 1
            && *(_QWORD *)(v17 + 448) == *(_QWORD *)(v15 + 448)
            && !*(_QWORD *)(v17 + 1248) )
          {
            v13 = 1LL;
            *(_QWORD *)(v14 + 264) = v15;
            *(_DWORD *)(v14 + 260) = a5;
            *(_DWORD *)(v15 + 1224) |= 0x2000u;
            *(_DWORD *)(v15 + 480) |= 0xC0u;
            ++*(_DWORD *)(v15 + 1264);
            *(_QWORD *)(v15 + 1248) = a2;
            *(_QWORD *)(v15 + 1256) = a3;
            ++*(_DWORD *)(v17 + 1264);
