/*
 * XREFs of PrepareForLogoff @ 0x1C0127530
 * Callers:
 *     <none>
 * Callees:
 *     RegisterPerUserKeyboardIndicators @ 0x1C01275EC (RegisterPerUserKeyboardIndicators.c)
 */
...
__int64 PrepareForLogoff()
{
  ...
  if ( (*(_DWORD *)(gptiCurrent + 480LL) & 0x20000000) != 0
    && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 768LL) + 24LL) & 0x80u) != 0 )
  {
    return 0LL;
  }
