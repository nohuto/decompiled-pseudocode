/*
 * XREFs of ?bRealizeFont@RFONTOBJ@@QEAAHPEAVXDCOBJ@@PEAVPDEVOBJ@@PEAUtagENUMLOGFONTEXDVW@@PEAVPFE@@PEAU_FD_XFORM@@QEAU_POINTL@@KKHHK@Z @ 0x1C00DD304
 * Callers:
 ...
 *     ?ulSimpleOrientation@RFONTOBJ@@QEAAKPEAVXDCOBJ@@@Z @ 0x1C00D9810 (-ulSimpleOrientation@RFONTOBJ@@QEAAKPEAVXDCOBJ@@@Z.c)
 *     ??$FreeIsolatedType@V?$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@@@YAXPEAX@Z @ 0x1C00DC840 (--$FreeIsolatedType@V-$CTypeIsolation@$0DJAAA@$0DJA@@NSInstrumentation@@@@YAXPEAX@Z.c)
 ...
 *     ?vSetNotionalToDevice@RFONTOBJ@@QEAAXAEAVEXFORMOBJ@@@Z @ 0x1C00DCCBC (-vSetNotionalToDevice@RFONTOBJ@@QEAAXAEAVEXFORMOBJ@@@Z.c)
 ...
 *     UmfdQueryFontCapsEx @ 0x1C00DD2C4 (UmfdQueryFontCapsEx.c)
 ...
 *     ?ulSimpleDeviceOrientation@@YAKAEAVRFONTOBJ@@@Z @ 0x1C0123070 (-ulSimpleDeviceOrientation@@YAKAEAVRFONTOBJ@@@Z.c)
        ...
        unsigned int a12)
{
  ...
  __int64 v66; // rdx
  __int64 v67; // rdx
  __int64 (__fastcall *v68)(__int64, int *); // rax
  int v69; // eax
  ...
  v74 = (__int64 *)a5;
  v16 = 0LL;
  v72 = (struct RFONT *)PFEOBJ::pfdg(&v74);
  if ( !v72 )
    goto LABEL_84;
...
LABEL_84:
  ...
  *(_QWORD *)(v24 + 472) = v23;
  ...
  v79 = v25;
  v73 = *(_WORD *)(v25 + 116);
  RFONTOBJ::vXlatGlyphArray(this, &v73, 1u, (unsigned int *)&v72, 2u, 0);
...
LABEL_17:
  ...
  *(_DWORD *)(*(_QWORD *)this + 656LL) = a10;
  ...
  if ( (struct PDEV *)v42 == qword_1C0341A00 )
  {
  ...
  {
    v68 = *(__int64 (__fastcall **)(__int64, int *))(v42 + 3040);
    if ( v68 )
    {
      v69 = v68(2LL, &v76);
      v41 = a10;
