/*
 * XREFs of ?ValidatePointerPromotion@@YAHGKPEAKPEAPEAUtagMOUSE_PROMOTION_ENTRY@@1@Z @ 0x1C0219C7C
 * Callers:
 ...
 * Callees:
 *     ?DetectPromotionType@@YAKPEBUtagMOUSE_PROMOTION_ENTRY@@0@Z @ 0x1C0219240 (-DetectPromotionType@@YAKPEBUtagMOUSE_PROMOTION_ENTRY@@0@Z.c)
        ...
        struct tagMOUSE_PROMOTION_ENTRY **a5)
{
  ...
  v10 = CacheById;
  if ( !CacheById || CacheById == word_1C033AAB8 && (dword_1C033ABB8 & 2) != 0 )
    return 0LL;
  ...
  if ( v5 != 0x10000000 || (v5 = DetectPromotionType(v12, v13), v5 != v15) )
  {
    ...
    else if ( v18 || v10 != word_1C033AAB8 )
    {
      return 0LL;
    }
    *a3 = v5;
