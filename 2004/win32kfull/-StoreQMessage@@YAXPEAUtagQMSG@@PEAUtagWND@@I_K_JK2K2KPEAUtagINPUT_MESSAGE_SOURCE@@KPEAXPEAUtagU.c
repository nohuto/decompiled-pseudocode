/*
 * XREFs of ?StoreQMessage@@YAXPEAUtagQMSG@@PEAUtagWND@@I_K_JK2K2KPEAUtagINPUT_MESSAGE_SOURCE@@KPEAXPEAUtagUIPI_INFO@@@Z @ 0x1C0097B60
 * Callers:
        ...
        struct tagUIPI_INFO *a14)
{
  ...
  *((_QWORD *)a1 + 18) = a13;
  ...
  else
  {
    v35 = a14;
    if ( !a14 )
      v35 = (struct tagUIPI_INFO *)(*(_QWORD *)(gptiCurrent + 416LL) + 880LL);
    v36 = *(_QWORD *)v35;
    *((_DWORD *)a1 + 25) |= 0x1000u;
    *((_QWORD *)a1 + 14) = v36;
  }
