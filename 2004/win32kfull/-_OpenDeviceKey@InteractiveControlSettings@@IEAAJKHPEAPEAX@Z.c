/*
 * XREFs of ?_OpenDeviceKey@InteractiveControlSettings@@IEAAJKHPEAPEAX@Z @ 0x1C00C7794
 * Callers:
 ...
 *     RtlUnicodeStringValidateDestWorker @ 0x1C00420E8 (RtlUnicodeStringValidateDestWorker.c)
