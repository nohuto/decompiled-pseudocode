/*
 * XREFs of SfnINLPDELETEITEMSTRUCT @ 0x1C022BAA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfnINLPDELETEITEMSTRUCT(__int64 *a1, int a2, __int64 a3, __int128 *a4, __int64 a5, __int64 a6)
{
  ...
  _QWORD v25[7]; // [rsp+60h] [rbp-D8h] BYREF
  __int128 v26; // [rsp+98h] [rbp-A0h]
  ...
  *(_QWORD *)(*(_QWORD *)(v11 + 472) + 80LL) = v16;
  ...
  v17 = KeUserModeCallback(11LL, &v27, 72LL, &v38, &v37);
