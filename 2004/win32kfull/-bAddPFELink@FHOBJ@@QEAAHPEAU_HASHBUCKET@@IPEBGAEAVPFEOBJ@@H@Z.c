/*
 * XREFs of ?bAddPFELink@FHOBJ@@QEAAHPEAU_HASHBUCKET@@IPEBGAEAVPFEOBJ@@H@Z @ 0x1C00D9EC8
 * Callers:
 ...
 *     ?efstyCompute@PFEOBJ@@QEAA?AW4_ENUMFONTSTYLE@@XZ @ 0x1C0112F98 (-efstyCompute@PFEOBJ@@QEAA-AW4_ENUMFONTSTYLE@@XZ.c)
 */
        ...
        int a6)
{
  ...
  *v11 = 0LL;
  ...
  if ( v13 )
  {
    ...
    *((_DWORD *)v14 + 14) = *(_DWORD *)(*(_QWORD *)a5 + 80LL);
    ...
    *(_DWORD *)(v19 + 28) = v18 & 1;
    ...
    else
    {
      ...
      do
      {
        *(const unsigned __int16 *)((char *)a4 + v21 + 60) = *a4;
        ++a4;
        --v20;
      }
      while ( v20 );
