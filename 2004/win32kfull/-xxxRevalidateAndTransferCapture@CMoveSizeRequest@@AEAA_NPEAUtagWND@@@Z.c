/*
 * XREFs of ?xxxRevalidateAndTransferCapture@CMoveSizeRequest@@AEAA_NPEAUtagWND@@@Z @ 0x1C0242898
 * Callers:
...
char __fastcall CMoveSizeRequest::xxxRevalidateAndTransferCapture(CMoveSizeRequest *this, struct tagWND *a2)
{
  ...
  *(_BYTE *)(*(_QWORD *)(v12 + 424) + 228LL) &= ~4u;
  ...
  v8 = *((_QWORD *)this + 1);
  v9 = *(_DWORD *)(gptiCurrent + 756LL);
  HIDWORD(v11) = *(_DWORD *)(gptiCurrent + 760LL);
  *(_QWORD *)(gptiCurrent + 768LL) = v8;
  LODWORD(v11) = v9;
  PhysicalToLogicalPointForWindow(v8, (__int64)a2, &v11);
  *(_QWORD *)(gptiCurrent + 756LL) = v11;
