/*
 * XREFs of MergeDeferredMessagesOfThreadOnQueue @ 0x1C0112A5C
 * Callers:
...
void __fastcall MergeDeferredMessagesOfThreadOnQueue(__int64 a1)
{
  ...
  CLockExclusiveAllowRecursion<DLT_QUEUE>::CLockExclusiveAllowRecursion<DLT_QUEUE>((__int64)&v17, *(_QWORD *)(a1 + 424));
  v2 = 0;
  v3 = *(_QWORD *)(a1 + 424) + 24LL;
  v4 = *(_QWORD *)(*(_QWORD *)(a1 + 424) + 48LL);
  v5 = *(_QWORD *)(*(_QWORD *)(a1 + 424) + 32LL);
  if ( v4 )
  {
    do
    {
