/*
 * XREFs of NtUserGetPointerDeviceProperties @ 0x1C01FBC70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetPointerDeviceProperties(__int64 a1, unsigned int *a2, volatile void *a3)
{
  ...
  _BYTE v28[16]; // [rsp+58h] [rbp-50h] BYREF
  ...
  if ( !(unsigned int)ResolveMouseOrPointerDevice(a1, v25, 0LL) )
  {
    v6 = 0;
    UserSetLastError(6LL, v9, v10);
    goto LABEL_29;
  }
  v11 = *(_DWORD *)(v25[0] + 336LL);
  if ( !a3 )
  {
...
LABEL_18:
    ...
    v19 = Win32AllocPoolZInit(v16, 1668313941LL);
    v20 = (const void *)v19;
    v26 = v19;
    if ( !v19 )
      goto LABEL_18;
    v6 = RIMGetPointerDeviceProperties(v25[0], v11, v19, v14);
    if ( v6 )
    {
