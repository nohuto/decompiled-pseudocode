/*
 * XREFs of NtGdiGetCharABCWidthsW @ 0x1C00E1BD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetCharABCWidthsW(HDC a1, int a2, unsigned int a3, const void *a4, char a5, char *a6)
{
  __int64 v6; // r14
  ...
  if ( !v10 || v9 )
  {
    ...
    if ( v8 )
    {
      ...
      CharABCWidthsW = GreGetCharABCWidthsW(a1, a2, v6, (unsigned __int16 *)v9, a5, (__int64)v8);
      if ( CharABCWidthsW )
      {
        v12 = &a6[v11];
