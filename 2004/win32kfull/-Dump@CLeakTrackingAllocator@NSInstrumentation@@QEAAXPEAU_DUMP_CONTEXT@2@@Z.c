/*
 * XREFs of ?Dump@CLeakTrackingAllocator@NSInstrumentation@@QEAAXPEAU_DUMP_CONTEXT@2@@Z @ 0x1C02DD99C
 * Callers:
 ...
 *     ??$Enumerate@P6AXPEAX00@Z@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAAXP6AXPEAX00@Z0@Z @ 0x1C02DE024 (--$Enumerate@P6AXPEAX00@Z@-$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTrace.c)
 */
        ...
        struct NSInstrumentation::_DUMP_CONTEXT *a2)
{
  ...
  if ( v2 )
  {
    ...
    if ( v4 )
    {
      ...
      if ( !v6 )
      {
        v7 = *((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 7);
        if ( v7 )
    ...
    {
      v5 = (NSInstrumentation::CPointerHashTable *)*((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 6);
      if ( v5 )
  ...
  {
    v3 = (NSInstrumentation::CPrioritizedWriterLock *)*((_QWORD *)WPP_MAIN_CB.Queue.Wcb.DeviceRoutine + 8);
    if ( v3 )
