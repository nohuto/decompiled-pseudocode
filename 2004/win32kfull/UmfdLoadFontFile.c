/*
 * XREFs of UmfdLoadFontFile @ 0x1C00E26D0
 * Callers:
 *     <none>
 * Callees:
...
PVOID __fastcall UmfdLoadFontFile(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5, int a6, int a7)
{
  ...
  if ( (int)UmfdClientSendAndWaitForCompletion(2u, (__int64)v19) >= 0 && (v12 = pv, (v15 = pv) != 0LL) )
  {
    ...
    if ( !NSInstrumentation::CSortedVector<unsigned __int64,unsigned __int64>::Insert(v13, &v15, &v15) )
    {
  ...
  else if ( v27 )
  {
    ...
    v16 = v27;
    v17 = v28;
    UmfdUnloadFontFileInternal((__int64)&v16);
  }
  return v12;
}
