/*
 * XREFs of GreSfmRegisterLogicalSurfaceForSignaling @ 0x1C0112D54
 * Callers:
 ...
 *     ?SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z @ 0x1C0112E38 (-SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z.c)
 */
