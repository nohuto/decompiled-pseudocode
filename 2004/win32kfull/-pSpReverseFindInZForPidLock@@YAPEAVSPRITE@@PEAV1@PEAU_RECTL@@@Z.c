/*
 * XREFs of ?pSpReverseFindInZForPidLock@@YAPEAVSPRITE@@PEAV1@PEAU_RECTL@@@Z @ 0x1C0157628
 * Callers:
 ...
 * Callees:
 *     ?bIsCursorSprite@@YAHPEAVSPRITE@@@Z @ 0x1C0105158 (-bIsCursorSprite@@YAHPEAVSPRITE@@@Z.c)
 */
