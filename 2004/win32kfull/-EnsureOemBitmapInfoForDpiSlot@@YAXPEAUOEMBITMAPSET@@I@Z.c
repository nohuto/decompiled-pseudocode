/*
 * XREFs of ?EnsureOemBitmapInfoForDpiSlot@@YAXPEAUOEMBITMAPSET@@I@Z @ 0x1C0101F0C
 * Callers:
 ...
 * Callees:
 *     ?ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z @ 0x1C0102090 (-ArrangeFrameControls@@YAFHHPEAUOEMBITMAPSET@@@Z.c)
