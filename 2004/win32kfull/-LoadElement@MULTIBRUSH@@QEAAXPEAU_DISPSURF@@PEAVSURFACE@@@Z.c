/*
 * XREFs of ?LoadElement@MULTIBRUSH@@QEAAXPEAU_DISPSURF@@PEAVSURFACE@@@Z @ 0x1C02A1BA0
 * Callers:
        ...
        || (v12 = (unsigned int)v11[7], (_DWORD)v12 == -1) )
      {
        ...
        else
        {
          ...
          if ( v14 && (v15 & 0x3000000) == 0 && (*(_DWORD *)(v8 + 2172) & 0x100) != 0 )
            ...
            NearestIndexFromColorref = ulGetNearestIndexFromColorref(v14, v9, *(unsigned int *)(v13 + 28));
          **((_DWORD **)this + 1) = NearestIndexFromColorref;
        }
      }
      else
      {
        **((_DWORD **)this + 1) = ulGetNearestIndexFromColorref(*((_QWORD *)a3 + 16), v9, v12);
