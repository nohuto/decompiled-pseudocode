/*
 * XREFs of ?Reset@InteractiveControlDefaultScroller@@AEAAXPEAUtagWND@@@Z @ 0x1C025A378
 * Callers:
...
void __fastcall InteractiveControlDefaultScroller::Reset(InteractiveControlDefaultScroller *this, struct tagWND *a2)
{
  ...
  dword_1C0341998 = 0;
  dword_1C0341988 = v4;
  dword_1C0341984 = *((_DWORD *)InteractiveControlManager::Instance() + 59);
  dword_1C034198C = *((_DWORD *)InteractiveControlManager::Instance() + 61);
  dword_1C0341994 = *((_DWORD *)InteractiveControlManager::Instance() + 63);
  dword_1C034199C = *((_DWORD *)InteractiveControlManager::Instance() + 65);
