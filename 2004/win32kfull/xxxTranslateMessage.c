/*
 * XREFs of xxxTranslateMessage @ 0x1C0107B70
 * Callers:
...
LABEL_3:
  v28 = v3;
  LOBYTE(v6) = *(_BYTE *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 1240);
  ...
  if ( v10 )
  {
    ...
    if ( v19 )
    {
      ...
      while ( v11 > 0 )
      {
        ...
        v23 = v22;
        *v20++ = 0;
        if ( v22 >= MmSystemRangeStart && *((_DWORD *)v22 + 6) == 258 && (*(_DWORD *)(gptiCurrent + 1336LL) & 1) != 0 )
        {
