/*
 * XREFs of ??0SPRITEDDIACCESS@@QEAA@AEAVPDEVOBJ@@@Z @ 0x1C00A7EE8
 * Callers:
 ...
 *     ?vSpTlSpriteStateDirectDriverAccess@@YAXPEAU_SPRITESTATE@@H@Z @ 0x1C00A8298 (-vSpTlSpriteStateDirectDriverAccess@@YAXPEAU_SPRITESTATE@@H@Z.c)
  ...
  *((_DWORD *)this + 3) = 0;
  if ( v6 && PDEVOBJ::bAllowShareAccess(a2) && (*(_DWORD *)(v6 + 104) || *(_DWORD *)(v6 + 108)) )
  {
    ...
    if ( *(_QWORD *)(*(_QWORD *)(v13 + 280) + 32LL) == *(_QWORD *)this )
      v18 = **(_DWORD **)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 280);
    else
      v18 = 0;
    *((_DWORD *)this + 2) = v18;
  ...
  if ( *((_DWORD *)this + 3) == 1 )
  {
    v85 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 280);
