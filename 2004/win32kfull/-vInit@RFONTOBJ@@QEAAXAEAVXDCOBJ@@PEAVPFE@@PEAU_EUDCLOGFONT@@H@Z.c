/*
 * XREFs of ?vInit@RFONTOBJ@@QEAAXAEAVXDCOBJ@@PEAVPFE@@PEAU_EUDCLOGFONT@@H@Z @ 0x1C00FDE6C
 * Callers:
...
void __fastcall RFONTOBJ::vInit(RFONTOBJ *this, struct XDCOBJ *a2, struct PFE *a3, struct _EUDCLOGFONT *a4)
{
  ...
  _FD_XFORM v37; // [rsp+B0h] [rbp-50h] BYREF
  ...
  v30 = *(_DWORD *)(v5 + 248) & 1;
  v29 = *(_QWORD *)(v5 + 48);
  LFONTOBJ::LFONTOBJ((LFONTOBJ *)v33, *(struct HLFONT__ **)(v5 + 1728), (struct PDEVOBJ *)&v29);
  v9 = v33[0];
  v10 = 0;
  if ( !v33[0] )
  {
