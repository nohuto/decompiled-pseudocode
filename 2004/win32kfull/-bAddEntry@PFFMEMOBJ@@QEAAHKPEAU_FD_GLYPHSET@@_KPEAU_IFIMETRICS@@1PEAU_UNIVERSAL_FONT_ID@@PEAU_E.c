/*
 * XREFs of ?bAddEntry@PFFMEMOBJ@@QEAAHKPEAU_FD_GLYPHSET@@_KPEAU_IFIMETRICS@@1PEAU_UNIVERSAL_FONT_ID@@PEAU_EUDCLOAD@@@Z @ 0x1C0010FD4
 * Callers:
 ...
 * Callees:
 *     ?IsCHSBaseFont@@YAHPEBGI@Z @ 0x1C00103B0 (-IsCHSBaseFont@@YAHPEBGI@Z.c)
 ...
 *     ?bCheckFamilyName@PFEOBJ@@QEAAHPEBGHPEAH@Z @ 0x1C0012E5C (-bCheckFamilyName@PFEOBJ@@QEAAHPEBGHPEAH@Z.c)
 */
