/*
 * XREFs of ?bGetRealizedBrush@@YAHPEAVBRUSH@@PEAVEBRUSHOBJ@@P6AHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@33PEAU_XLATEOBJ@@K@Z@Z @ 0x1C00CBD3C
 * Callers:
 ...
 *     HT_CreateHalftoneBrush @ 0x1C0262378 (HT_CreateHalftoneBrush.c)
 *     ?bIsCMYKColor@EBRUSHOBJ@@QEBAHXZ @ 0x1C026E184 (-bIsCMYKColor@EBRUSHOBJ@@QEBAHXZ.c)
 ...
 *     ?pCreateXlate@@YAPEAVXLATE@@K@Z @ 0x1C02BFBFC (-pCreateXlate@@YAPEAVXLATE@@K@Z.c)
 *     ?vCheckForICM@XLATE@@QEAAXPEAXK@Z @ 0x1C02BFC90 (-vCheckForICM@XLATE@@QEAAXPEAXK@Z.c)
 *     ?vCheckForTrivial@XLATE@@QEAAXXZ @ 0x1C02BFD28 (-vCheckForTrivial@XLATE@@QEAAXXZ.c)
 */
    ...
    if ( v27 )
    {
      ...
      if ( Xlate )
      {
        ...
        else
        {
          ...
          v31 = ulGetNearestIndexFromColorref(*((_QWORD *)a2 + 11), *((_QWORD *)a2 + 12), *((unsigned int *)a2 + 6));
          v30 = v31;
