/*
 * XREFs of ?bSrcCopySRLE4D32@@YAHPEAUBLTINFO@@@Z @ 0x1C0143AA0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall bSrcCopySRLE4D32(struct BLTINFO *a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( !v15 )
      break;
    if ( v6 < v13 && v12 < v7 && (int)(v15 + v12) > (int)v11 )
    {
      if ( v12 < (int)v11 )
      {
        v43 = v11 - v12;
...
LABEL_19:
  ...
  if ( (_DWORD)v17 != 2 )
  {
    ...
    if ( v6 >= v46 || v12 >= v7 || (int)v17 + v12 <= (int)v11 )
    {
      v12 += v17;
    ...
    else
    {
      if ( v12 < (int)v11 )
      {
        ...
        if ( (v37 & 1) != 0 )
        {
          ...
          v38 = *v2++ & 0xF;
          LODWORD(v17) = v17 - 1;
          *(_DWORD *)(v3 + 4 * v11) = *(_DWORD *)(v49 + 4 * v38);
        }
      }
      if ( (int)v17 + v12 > v7 )
      {
