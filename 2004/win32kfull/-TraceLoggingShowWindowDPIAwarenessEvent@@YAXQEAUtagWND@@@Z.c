/*
 * XREFs of ?TraceLoggingShowWindowDPIAwarenessEvent@@YAXQEAUtagWND@@@Z @ 0x1C0056EA4
 * Callers:
...
void __fastcall TraceLoggingShowWindowDPIAwarenessEvent(struct tagWND *const a1)
{
  ...
  if ( (*(_DWORD *)(gpsi + 2236LL) & 0x20) == 0 )
  {
    ...
    if ( (v1 & 0xF) == 2 )
    {
      for ( i = *(_QWORD *)(PsGetCurrentProcessWin32Process(v3) + 320); i; i = *(_QWORD *)(i + 656) )
      {
        v3 = **(unsigned int **)(i + 472);
        if ( (v3 & 0x20000000) != 0 )
        {
          v2 = 128;
          break;
