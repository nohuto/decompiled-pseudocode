/*
 * XREFs of ?xxxActivateOnMinimize@@YAHPEAUtagWND@@@Z @ 0x1C00F5A1C
 * Callers:
...
__int64 __fastcall xxxActivateOnMinimize(struct tagWND *a1)
{
  ...
  v1 = 0;
  v3 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 128LL) != 0LL;
  ...
  while ( 1 )
  {
    v7 = v3 ? *(_QWORD **)(*(_QWORD *)(gptiCurrent + 424LL) + 128LL) : v6;
    v8 = 0LL;
    if ( v7 )
    {
      do
...
LABEL_28:
  ...
  *((_QWORD *)&v21 + 1) = v7;
  HMLockObject(v7);
  v13 = *((_QWORD *)a1 + 2);
  if ( (*(_DWORD *)(v13 + 1224) & 0x40000) != 0 && *(struct tagWND **)(v13 + 1384) == a1 )
  {
    v18 = *(_QWORD *)(v13 + 424);
  ...
  xxxSetForegroundWindowWithOptions(v7, v12, 0LL, 0LL);
