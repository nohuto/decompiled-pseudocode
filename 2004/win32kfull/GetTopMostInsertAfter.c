/*
 * XREFs of GetTopMostInsertAfter @ 0x1C01D147C
 * Callers:
...
_QWORD *__fastcall GetTopMostInsertAfter(__int64 a1)
{
  ...
  if ( (((*(_WORD *)(*(_QWORD *)(a1 + 40) + 42LL) & 0x3FFF) - 668) & 0xFFFB) != 0
    && gptiCurrent != gHardErrorHandler
    && (*(_DWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 12LL) & 0x200000) == 0 )
  {
    v1 = *(PVOID *)(gptiCurrent + 448LL);
    if ( v1 != grpdeskLogon && v1 == *(PVOID *)(gHardErrorHandler + 448LL) )
    {
