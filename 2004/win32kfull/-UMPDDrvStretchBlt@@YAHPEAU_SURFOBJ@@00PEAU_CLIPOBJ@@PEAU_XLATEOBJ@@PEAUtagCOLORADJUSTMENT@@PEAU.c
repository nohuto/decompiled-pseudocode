/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C0141540
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall UMPDDrvStretchBlt(
        struct _SURFOBJ *a1,
        struct _SURFOBJ *a2,
        struct _SURFOBJ *a3,
        struct _CLIPOBJ *a4,
        ...
        unsigned int a11)
{
  ...
  struct tagCOLORADJUSTMENT *v40; // [rsp+108h] [rbp-8h]
  struct _POINTL *v41; // [rsp+110h] [rbp+0h]
  struct _RECTL *v42; // [rsp+118h] [rbp+8h]
  struct _RECTL *v43; // [rsp+120h] [rbp+10h]
  struct _POINTL *v44; // [rsp+128h] [rbp+18h]
  _QWORD v45[16]; // [rsp+130h] [rbp+20h] BYREF
...
LABEL_3:
    ...
    v45[3] = v12;
    v45[7] = a5;
    if ( !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 64), (struct _SURFOBJ **)&v45[3])
      || !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 80), (struct _SURFOBJ **)&v45[4])
      || !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 96), (struct _SURFOBJ **)&v45[5])
      ...
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v45[8], 0x18u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v45[9], 8u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v45[10], 0x10u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v45[11], 0x10u)
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&v45[12], 8u)
      || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v16, v45, 0x80u, &v22, Size) == -1)
      || (v17 = 1, !v22) )
    {
      v17 = 0;
    }
