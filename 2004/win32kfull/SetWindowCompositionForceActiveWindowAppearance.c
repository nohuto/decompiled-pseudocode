/*
 * XREFs of SetWindowCompositionForceActiveWindowAppearance @ 0x1C01201CC
 * Callers:
...
__int64 __fastcall SetWindowCompositionForceActiveWindowAppearance(__int64 *a1, __int128 *a2, __int64 a3)
{
  bool v4; // zf
  int v6; // edi
  unsigned int v7; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 9) == v6 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFEFF | (v6 << 8);
