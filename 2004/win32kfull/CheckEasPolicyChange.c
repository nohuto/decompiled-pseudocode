/*
 * XREFs of CheckEasPolicyChange @ 0x1C01D4C78
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C033C9E8 != KeyInformation )
  {
    qword_1C033C9E8 = KeyInformation;
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C033C9E0 != KeyInformation )
  {
    qword_1C033C9E0 = KeyInformation;
    return 1;
  }
  return v0;
}
