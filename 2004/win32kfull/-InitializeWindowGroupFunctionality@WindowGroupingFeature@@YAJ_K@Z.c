/*
 * XREFs of ?InitializeWindowGroupFunctionality@WindowGroupingFeature@@YAJ_K@Z @ 0x1C0241530
 * Callers:
 ...
 *     ?Initialize@CWindowGroupManager@@SAJ_K@Z @ 0x1C02414D0 (-Initialize@CWindowGroupManager@@SAJ_K@Z.c)
 */
