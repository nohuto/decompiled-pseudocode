/*
 * XREFs of ?HandleRawInput@@YA?AW4RAW_INPUT_PROCESSING_RESULT@@PEAXPEAU_KEYBOARD_INPUT_DATA@@PEBURAW_INPUT_SUPPLEMENTAL_INFO@@@Z @ 0x1C0055358
 * Callers:
...
__int64 __fastcall HandleRawInput(void *a1, struct _KEYBOARD_INPUT_DATA *a2, __int64 a3)
{
  ...
  if ( !v7 )
    goto LABEL_9;
  if ( (*(_DWORD *)(*((_QWORD *)&v16 + 1) + 1224LL) & 0x200000) != 0 )
  {
LABEL_2:
    v11 = 0;
    if ( v7 )
  ...
  if ( v9 )
  {
    if ( *(_DWORD *)(a3 + 16)
      ...
      && (v14 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 416) + 832LL) + 100LL), (v14 & 0x20) != 0)
      && ((*(_DWORD *)(v10 + 1224) & 0x200000) != 0 || (v15 = *(_WORD *)(a3 + 8), v15 != 18)
                                                    && v15 != 9
                                                    && !gspwndAltTab)
