/*
 * XREFs of ?_StoreGestureConfig@@YAHPEAUtagWND@@IPEAUtagGESTURECONFIG@@@Z @ 0x1C0120EE0
 * Callers:
 *     SetGestureConfigSettings @ 0x1C0121044 (SetGestureConfigSettings.c)
 * Callees:
 *     UserSetLastError @ 0x1C0090F00 (UserSetLastError.c)
 *     ?SetBitMask@@YAXPEAUtagWND@@IH@Z @ 0x1C0120CC0 (-SetBitMask@@YAXPEAUtagWND@@IH@Z.c)
 ...
 *     ?GCRemoveHashElement@@YAXPEAPEAUtagGESTURECONFIGLIST@@I@Z @ 0x1C0227E8C (-GCRemoveHashElement@@YAXPEAPEAUtagGESTURECONFIGLIST@@I@Z.c)
 */
...
LABEL_24:
  ...
  for ( i = (int *)((char *)a3 + 4); ; i += 3 )
  {
    ...
    if ( (unsigned int)(v15 - 1) > 6 )
      break;
    v7 = (unsigned int)~dword_1C02EAD60[v15];
