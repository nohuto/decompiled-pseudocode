/*
 * XREFs of ?CheckOnTop@@YAHPEAUtagTHREADINFO@@PEAUtagWND@@I@Z @ 0x1C01E08CC
 * Callers:
...
__int64 __fastcall CheckOnTop(struct tagTHREADINFO *a1, struct tagWND *a2, int a3)
{
  ...
  if ( a2 != *(struct tagWND **)(*((_QWORD *)a1 + 53) + 120LL) )
    return 0LL;
  v5 = a3 - 513;
  if ( v5 )
  {
  ...
  v8 = *((_QWORD *)a2 + 5);
  if ( (*(_BYTE *)(v8 + 24) & 8) == 0
    && ((*(_WORD *)(v8 + 42) & 0x3FFF) != 0x29D ? (v9 = (struct tagWND *)*((_QWORD *)a2 + 12)) : (v9 = 0LL),
