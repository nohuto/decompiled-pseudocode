/*
 * XREFs of ?TraceLoggingYieldedHotkey@@YAXII@Z @ 0x1C02264C8
 * Callers:
...
void __fastcall TraceLoggingYieldedHotkey(__int64 a1, int a2)
{
  ...
  {
    v7 = 0x400000000000LL;
    if ( (qword_1C032B408 & 0x400000000000LL) != 0 && (qword_1C032B410 & 0x400000000000LL) == qword_1C032B410 )
    {
      if ( CurrentProcessWin32Process )
        ProcessImageFileName = (void *)PsGetProcessImageFileName(*CurrentProcessWin32Process);
      else
        ProcessImageFileName = &unk_1C02F4540;
