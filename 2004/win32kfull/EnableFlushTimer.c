/*
 * XREFs of EnableFlushTimer @ 0x1C025DF64
 * Callers:
 *     InsertEventEntryInLookUpTable @ 0x1C025E174 (InsertEventEntryInLookUpTable.c)
 *     ?TlgAggregateInternalFlushTimerCallbackKernelMode@@YAXPEAU_EX_TIMER@@PEAX@Z @ 0x1C025E510 (-TlgAggregateInternalFlushTimerCallbackKernelMode@@YAXPEAU_EX_TIMER@@PEAX@Z.c)
