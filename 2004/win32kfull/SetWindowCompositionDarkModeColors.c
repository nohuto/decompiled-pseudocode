/*
 * XREFs of SetWindowCompositionDarkModeColors @ 0x1C011EC04
 * Callers:
...
__int64 __fastcall SetWindowCompositionDarkModeColors(__int64 *a1, __int128 *a2, __int64 a3)
{
  unsigned int v5; // ebx
  int v6; // ecx
  __int64 v8; // rcx
  ...
  {
    v6 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v10[0], 17) == v6 )
      return 0;
    LODWORD(v10[0]) = v10[0] & 0xFFFEFFFF | (v6 << 16);
