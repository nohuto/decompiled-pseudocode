/*
 * XREFs of ?UpdateContactPrediction@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@1PEAUtagHPD_PREDICTION_INFO@@PEAU2@3@Z @ 0x1C01EDBAC
 * Callers:
 *     DoPrediction @ 0x1C01EECE0 (DoPrediction.c)
 * Callees:
 *     ?DeltaOvershootCompensation@Prediction@@YA_J_J0@Z @ 0x1C01EC864 (-DeltaOvershootCompensation@Prediction@@YA_J_J0@Z.c)
 ...
 *     ?Smooth@tagExpoSmoother@Prediction@@QEAA?AVCFixPred@2@V32@@Z @ 0x1C01EDA1C (-Smooth@tagExpoSmoother@Prediction@@QEAA-AVCFixPred@2@V32@@Z.c)
 */
