/*
 * XREFs of ?vPlgWriteAND@@YAXPEAU_PLGRUN@@0PEAVSURFACE@@PEAU_CLIPOBJ@@@Z @ 0x1C02DA080
 * Callers:
 *     <none>
 * Callees:
 *     ?vFindScan@XCLIPOBJ@@QEAAXPEAU_RECTL@@J@Z @ 0x1C00CD1A0 (-vFindScan@XCLIPOBJ@@QEAAXPEAU_RECTL@@J@Z.c)
 *     ?vFindSegment@XCLIPOBJ@@QEBAXPEAU_RECTL@@JJ@Z @ 0x1C00CD224 (-vFindSegment@XCLIPOBJ@@QEBAXPEAU_RECTL@@JJ@Z.c)
              ...
              do
              {
                ...
                if ( !v29 )
                {
                  if ( v31 )
                    *v28 = v30;
                  ++v28;
                  v29 = *((_BYTE *)&dword_1C02FB268 + (v25 & 7));
                  v34 = v29;
                  if ( (int)v25 < 0
                    || (int)v25 >= *((_DWORD *)a3 + 14)
                    || (unsigned __int64)v28 < v4
    ...
    else if ( a1 < a2 )
    {
      do
      {
        ...
        for ( j = *((_QWORD *)a3 + 10) + v10; v11; --v11 )
        {
          ...
          v17 = *((_BYTE *)&dword_1C02FB268 + (*(_DWORD *)v5 & 7));
                ...
                if ( !v17 )
                {
                  *v16++ = v18;
                  if ( (unsigned __int64)v16 < v4 || (unsigned __int64)v16 > v9 )
                    ...
                    v18 = *v16;
                  v17 = *((_BYTE *)&dword_1C02FB268 + (v14 & 7));
                }
                if ( v15 >= 0 )
                  continue;
              }
