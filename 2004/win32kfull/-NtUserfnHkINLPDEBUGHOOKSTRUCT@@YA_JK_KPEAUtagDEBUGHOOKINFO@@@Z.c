/*
 * XREFs of ?NtUserfnHkINLPDEBUGHOOKSTRUCT@@YA_JK_KPEAUtagDEBUGHOOKINFO@@@Z @ 0x1C01F7060
 * Callers:
 *     NtUserCallNextHookEx @ 0x1C0144110 (NtUserCallNextHookEx.c)
 * Callees:
 *     xxxCallNextHookEx @ 0x1C0045FF4 (xxxCallNextHookEx.c)
 *     __security_check_cookie @ 0x1C0157760 (__security_check_cookie.c)
 *     GetDebugHookLParamSize @ 0x1C02295C4 (GetDebugHookLParamSize.c)
 */

__int64 __fastcall NtUserfnHkINLPDEBUGHOOKSTRUCT(__int64 a1, __int64 a2, struct tagDEBUGHOOKINFO *a3)
{
