/*
 * XREFs of xxxMNEndMenuStateInternal @ 0x1C0222DE0
 * Callers:
 ...
 *     MNDestroyAnimationBitmap @ 0x1C02224A4 (MNDestroyAnimationBitmap.c)
...
void __fastcall xxxMNEndMenuStateInternal(__int64 a1, __int64 a2)
{
  ...
  if ( IsMiPEnabledForThread(a1) && *(_QWORD *)(a1 + 1272) )
