/*
 * XREFs of ?vSrcCopyS24D8@@YAXPEAUBLTINFO@@@Z @ 0x1C02CA2F0
 * Callers:
 *     <none>
 * Callees:
 *     ?XLATEOBJ_pGetXlate555@@YAPEAEPEAU_XLATEOBJ@@@Z @ 0x1C0146EA4 (-XLATEOBJ_pGetXlate555@@YAPEAEPEAU_XLATEOBJ@@@Z.c)
 *     ?XLATEOBJ_RGB32ToPalSurf@@YAEPEAU_XLATEOBJ@@PEBEK@Z @ 0x1C02BF790 (-XLATEOBJ_RGB32ToPalSurf@@YAEPEAU_XLATEOBJ@@PEBEK@Z.c)
 */
  ...
  if ( Xlate555 )
  {
    while ( 1 )
    {
      ...
      if ( v9 )
      {
        ...
        do
        {
          v13 = XLATEOBJ_RGB32ToPalSurf(v21, Xlate555, v11[2] | ((v11[1] | (*v11 << 8)) << 8));
          v14 = XLATEOBJ_RGB32ToPalSurf(v21, Xlate555, v11[5] | ((v11[4] | (v11[3] << 8)) << 8));
          v15 = XLATEOBJ_RGB32ToPalSurf(v21, Xlate555, v11[8] | ((v11[7] | (v11[6] << 8)) << 8));
