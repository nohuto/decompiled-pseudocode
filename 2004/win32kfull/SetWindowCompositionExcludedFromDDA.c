/*
 * XREFs of SetWindowCompositionExcludedFromDDA @ 0x1C0155D20
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludedFromDDA(__int64 *a1, __int128 *a2, __int64 a3)
{
  unsigned int v5; // ebx
  int v6; // edx
  __int64 v7; // rcx
  ...
  {
    v6 = *(_DWORD *)a2 != 0;
    if ( -__CFSHR__(v10[0], 15) == v6 )
      return 0;
    LODWORD(v10[0]) = (v6 << 14) | v10[0] & 0xFFFFBFFF;
