/*
 * XREFs of SetupAAHeader @ 0x1C00D70EC
 * Callers:
 *     AAHalftoneBitmap @ 0x1C00D5470 (AAHalftoneBitmap.c)
 * Callees:
 *     ComputeBytesPerScanLine @ 0x1C00C9E78 (ComputeBytesPerScanLine.c)
 *     _ALIGN_MEM @ 0x1C00D7990 (_ALIGN_MEM.c)
 *     ComputeByteOffset @ 0x1C00D79C0 (ComputeByteOffset.c)
 *     ComputeInputColorInfo @ 0x1C00D7A14 (ComputeInputColorInfo.c)
 *     ComputeAABBP @ 0x1C00D7B50 (ComputeAABBP.c)
