/*
 * XREFs of ?_TTIntersectLine@@YAHUtagPOINT@@0PEBUtagTOUCHTARGETINGCONTACT@@PEAU1@2@Z @ 0x1C02601C8
 * Callers:
 *     TouchTargetingIntersectSegment @ 0x1C0260B9C (TouchTargetingIntersectSegment.c)
 *     TouchTargetingRankForRectDeep @ 0x1C026129C (TouchTargetingRankForRectDeep.c)
 * Callees:
 *     ?_TTAddLineAndSegmentIntersection@@YAXUtagPOINT@@0JJJJPEAU1@PEAH@Z @ 0x1C0260014 (-_TTAddLineAndSegmentIntersection@@YAXUtagPOINT@@0JJJJPEAU1@PEAH@Z.c)
 */
