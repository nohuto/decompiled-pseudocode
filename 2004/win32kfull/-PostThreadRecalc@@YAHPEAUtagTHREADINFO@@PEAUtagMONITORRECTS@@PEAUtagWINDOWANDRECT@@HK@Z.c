/*
 * XREFs of ?PostThreadRecalc@@YAHPEAUtagTHREADINFO@@PEAUtagMONITORRECTS@@PEAUtagWINDOWANDRECT@@HK@Z @ 0x1C01059C4
 * Callers:
    ...
    *(_QWORD *)v11 = v13;
    if ( v13 )
    {
      ...
      *(_DWORD *)(v11 + 12) = a4;
      ...
      v9 = PostEventMessageEx(a1, *((struct tagQ **)a1 + 53), 0x16u, 0LL, 0, v11, 0LL, 0LL);
      if ( v9 )
        return v9;
