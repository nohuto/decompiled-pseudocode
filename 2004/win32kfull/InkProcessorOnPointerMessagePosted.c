/*
 * XREFs of InkProcessorOnPointerMessagePosted @ 0x1C0221270
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall InkProcessorOnPointerMessagePosted(unsigned int a1, unsigned __int64 a2)
{
  ...
  else if ( (unsigned int)dword_1C032B288 > 2 )
  {
    ...
    v5 = 4;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032B288, (unsigned __int8 *)dword_1C02F13FC, 0LL, 0LL, 3u, &v3);
  }
}
