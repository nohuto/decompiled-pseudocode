/*
 * XREFs of xxxSetInformationThread @ 0x1C00BD1B0
 * Callers:
    ...
    else
    {
      ...
      if ( !v15 )
      {
        if ( ThreadWin32Thread )
        {
          ...
          {
            v31 = *(_DWORD *)(ThreadWin32Thread + 480) & 0xFFFDFFFF;
            v32 = *(_DWORD *)(v14 + 480) | 0x20000;
            if ( !*(_DWORD *)a3 )
              v32 = v31;
            *(_DWORD *)(v14 + 480) = v32;
          }
