/*
 * XREFs of UmfdSessionUninitialize @ 0x1C0127180
 * Callers:
 *     <none>
 * Callees:
 *     ?Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z @ 0x1C0123634 (-Destroy@CMultipleConsumerWorkQueue@@SAXQEAV1@@Z.c)
 *     ?SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ @ 0x1C012722C (-SessionUninitialize@UmfdHostLifeTimeManager@@CAXXZ.c)
