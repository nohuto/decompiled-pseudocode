/*
 * XREFs of ?xxxTargetingHitTest@@YAPEAUHWND__@@PEAUtagWND@@UtagPOINT@@1PEAUtagPNTRWINDOWHITTTESTARGS@@PEAHUtagRECT@@KW4tagTARGETING_PROPERTY@@@Z @ 0x1C0216B38
 * Callers:
        ...
        int a8)
{
  ...
  unsigned __int64 v65; // [rsp+B0h] [rbp-50h] BYREF
  ...
  if ( v11 != -2 && v11 != 1 )
  {
    ...
    *(_QWORD *)&v62 = *(_QWORD *)(ThreadWin32Thread + 408);
    ...
    *((_QWORD *)&v62 + 1) = v25;
    ...
    if ( *(_DWORD *)(a4 + 84) )
    {
      ...
      v27 = xxxDCEWindowHitTest(*(struct tagWND **)(v15 + 112));
    }
    else
    {
      v27 = xxxWindowHitTest(*(_QWORD *)(v15 + 112), *(_QWORD *)&v58, a4 + 32);
    }
    v17 = v27;
    if ( v27 )
    {
...
LABEL_51:
  ...
  *((_QWORD *)&v62 + 1) = v33;
  ...
  if ( *(_DWORD *)(a4 + 84) )
  {
    ...
    v35 = xxxDCEWindowHitTest(*(struct tagWND **)(v15 + 112));
  }
  else
  {
    v35 = xxxWindowHitTest(*(_QWORD *)(v15 + 112), v60, a4 + 32);
  }
  v17 = v35;
