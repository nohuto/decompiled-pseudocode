 ...
 *     ?bEqualEntries@XEPALOBJ@@QEAAHV1@@Z @ 0x1C00CB1AC (-bEqualEntries@XEPALOBJ@@QEAAHV1@@Z.c)
 ...
 *     ?bSetHTSurfInfo@@YAHPEAU_SURFOBJ@@PEAU_HTSURFACEINFO@@J@Z @ 0x1C00D45E4 (-bSetHTSurfInfo@@YAHPEAU_SURFOBJ@@PEAU_HTSURFACEINFO@@J@Z.c)
 *     ?pDevHTInfo@PDEVOBJ@@QEAAPEAXXZ @ 0x1C00D4FF8 (-pDevHTInfo@PDEVOBJ@@QEAAPEAXXZ.c)
 *     ?vRelease@HTSEMOBJ@@QEAAXXZ @ 0x1C00D50B0 (-vRelease@HTSEMOBJ@@QEAAXXZ.c)
 *     ?ppalGetFromXlate@@YAPEAVPALETTE@@PEAVSURFACE@@0PEAVXLATE@@IH@Z @ 0x1C00D50FC (-ppalGetFromXlate@@YAPEAVPALETTE@@PEAVSURFACE@@0PEAVXLATE@@IH@Z.c)
 *     HT_HalftoneBitmap @ 0x1C00D5194 (HT_HalftoneBitmap.c)
 *     ??1?$AutoResource@$1?FreeTmpBuffer@@YAXPEAX@Z@@QEAA@XZ @ 0x1C0112820 (--1-$AutoResource@$1-FreeTmpBuffer@@YAXPEAX@Z@@QEAA@XZ.c)
    ...
    else
    {
      ...
      if ( v25 )
      {
        ...
        else
        {
          ...
          if ( *(_DWORD *)(v21 + 2376) != 2 )
            v83 = -1;
          LOBYTE(v85) = *(_DWORD *)(v21 + 2376) != 2;
          v106 = v83;
          v31 = v85 + 2;
          v18 = (__int64)v109;
        }
...
LABEL_96:
          ...
          v133 = 0LL;
          v115 = 0LL;
          if ( v31 == *(_DWORD *)(v108 + 2376) )
          {
            v37 = *(_DWORD *)(v108 + 40) & 0x200;
          }
          else
          {
            if ( !PALMEMOBJ::bCreateHTPalette((PALMEMOBJ *)&v133, v31, (struct _GDIINFO *)(v108 + 2136)) )
              goto LABEL_113;
            v115 = &v133;
...
LABEL_27:
            ...
            *(_QWORD *)&prclDest[5] = **(_QWORD **)&pptlSrc;
            prclDest[1] = v41;
            BYTE3(prclDest[0]) = *(_BYTE *)(v35 + 2368);
            if ( v120 )
              v42 = *((_DWORD *)v120 + 18);
            else
              LOBYTE(v42) = 0;
                      ...
                      if ( (_DWORD)v109 )
                      {
                        ...
                        *(_QWORD *)&prclTrg.left = 0LL;
                        v93 = (*((_DWORD *)v116 + 28) & 0x400) != 0
                            ? (*(__int64 (__fastcall **)(__int64, SURFOBJ *, _QWORD, XLATEOBJ *, RECTL *, _OWORD *))(v108 + 2840))(
                                (__int64)v60 + 24,
                                psoDest,
                                0LL,
                                v63,
                    ...
                    if ( (_DWORD)v109 && v66 )
                    {
                      ...
                      if ( v74->iType )
                      {
                        if ( (*((_DWORD *)v73 + 28) & 0x400) != 0 )
                          v75 = (*(__int64 (__fastcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, _OWORD *, POINTL *))(v108 + 2840))(
                                  v74,
                                  v67,
                                  v72,
                                  v61,
