/*
 * XREFs of ?GreStartDocInternal@@YAHPEAUHDC__@@PEAU_DOCINFOW@@PEAHH@Z @ 0x1C013FB68
 * Callers:
      ...
      if ( (v11 & 0x8000) != 0 )
      {
        if ( PDEVOBJ::bMakeSurface((PDEVOBJ *)&v20, 0LL) )
        {
          ...
          *a3 = *(_DWORD *)(*(_QWORD *)(v20 + 2552) + 112LL) & 0x2000000;
          ...
          v21 = 0LL;
          v15 = *(__int64 (__fastcall **)(__int64, LPCWSTR, _QWORD))(v20 + 2968);
          ...
          if ( gUMPDSecurityLevel == 2
            || gUMPDSecurityLevel
            && (CurrentProcess = (struct _EPROCESS *)PsGetCurrentProcess(gUMPDSecurityLevel, v13, v14),
