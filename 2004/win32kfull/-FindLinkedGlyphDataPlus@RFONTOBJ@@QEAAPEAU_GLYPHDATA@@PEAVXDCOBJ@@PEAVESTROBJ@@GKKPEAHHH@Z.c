/*
 * XREFs of ?FindLinkedGlyphDataPlus@RFONTOBJ@@QEAAPEAU_GLYPHDATA@@PEAVXDCOBJ@@PEAVESTROBJ@@GKKPEAHHH@Z @ 0x1C00E2CB8
 * Callers:
        ...
        int a9)
{
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a2 + 304LL) )
  {
    if ( a8 )
    {
      ...
      {
        if ( (unsigned __int16)v10 >= gqlTTSystem && (unsigned __int16)v10 <= (unsigned __int16)word_1C033C8A2 )
        {
          a3 = (struct ESTROBJ *)(0x80000000 >> ((v10 - gqlTTSystem) % 32));
          if ( ((unsigned int)a3 & *(_DWORD *)(qword_1C033C8A8 + 4LL * ((v10 - gqlTTSystem) / 32))) != 0 )
          {
            if ( !*(_QWORD *)(v14 + 720) )
            ...
            if ( v36
              && (!a9
                ...
                : (EudcMetrics = RFONTOBJ::pgdGetEudcMetricsPlus(
                                   (RFONTOBJ *)&v36,
                                   (struct RFONTOBJ *)(unsigned __int16)v10,
                                   a3)),
                  (v17 = EudcMetrics) != 0LL) )
            {
              if ( v11 )
  ...
  if ( (_DWORD)v20 )
  {
    ...
    if ( v21 )
    {
      ...
      if ( (unsigned int)PFFOBJ::bIsPerFontEUDC((PFFOBJ *)&v35) )
      {
        v20 = v22;
        v24 = a9
            ? RFONTOBJ::pgdGetEudcMetricsPlus((RFONTOBJ *)&v36, (struct RFONTOBJ *)(unsigned __int16)v10, v23)
...
LABEL_35:
  ...
  if ( *(_QWORD *)(v19 + 728) )
  {
    v36 = *(_QWORD *)(v19 + 728);
    if ( a9 )
      EudcMetricsPlus = RFONTOBJ::pgdGetEudcMetricsPlus((RFONTOBJ *)&v36, (struct RFONTOBJ *)(unsigned __int16)v10, a3);
    else
  ...
  if ( (_DWORD)v20 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v30 )
      {
        ...
        {
          v32 = a9
              ? RFONTOBJ::pgdGetEudcMetricsPlus((RFONTOBJ *)&v36, (struct RFONTOBJ *)(unsigned __int16)v10, v31)
...
LABEL_58:
  if ( *(_QWORD *)(*(_QWORD *)this + 736LL) )
  {
    ...
    if ( a9 )
      v33 = RFONTOBJ::pgdGetEudcMetricsPlus((RFONTOBJ *)&v36, (struct RFONTOBJ *)(unsigned __int16)v10, a3);
    else
