/*
 * XREFs of xxxBroadcastDisplaySettingsChange @ 0x1C01055A0
 * Callers:
 ...
 *     xxxBroadcastModernAppRedraw @ 0x1C021F0C0 (xxxBroadcastModernAppRedraw.c)
 * Callees:
...
__int64 __fastcall xxxBroadcastDisplaySettingsChange(__int64 a1, int a2, unsigned int a3)
{
  ...
  xxxBroadcastMessageEx(
    ...
    *(unsigned __int16 *)(gpsi + 6996LL),
    ...
    1,
    a3);
  if ( (dword_1C033B0B0 & 1) == 0 )
  {
    dword_1C033B0B0 |= 1u;
    v9 = *(_QWORD *)(*(_QWORD *)(GetDispInfo(v9, v8) + 96) + 40LL);
    word_1C033B0B4 = *(_WORD *)(v9 + 64);
  }
  v11 = *(_QWORD *)(*(_QWORD *)(GetDispInfo(v9, v8) + 96) + 40LL);
  result = *(unsigned __int16 *)(v11 + 64);
  if ( word_1C033B0B4 != (_WORD)result )
  {
    word_1C033B0B4 = *(_WORD *)(*(_QWORD *)(*(_QWORD *)(GetDispInfo(v11, v10) + 96) + 40LL) + 64LL);
    v13 = word_1C033B0B4 == *(_WORD *)(gpsi + 6998LL);
    result = v13;
    v15 = v13;
    if ( !v13 )
