/*
 * XREFs of ?MNGetPopupBoundsRect@@YAXV?$SmartObjStackRef@UtagPOPUPMENU@@@@PEAUtagMONITOR@@PEAUtagRECT@@H@Z @ 0x1C0236148
 * Callers:
...
_QWORD *__fastcall MNGetPopupBoundsRect(int ***a1, __int64 a2, _OWORD *a3, int a4)
{
  ...
  int v33[6]; // [rsp+48h] [rbp-21h] BYREF
  ...
  *(_OWORD *)v33 = v12;
  ...
  if ( a4 )
  {
    SubtractRect((__int64)a3, (int *)&v34, v33);
    goto LABEL_16;
  }
LABEL_15:
  *a3 = *(_OWORD *)v33;
LABEL_16:
  ...
  result = *(_QWORD **)(v20 + 1464);
  if ( result )
  {
    result = (_QWORD *)*result;
    *(_QWORD *)(v20 + 1464) = result;
  }
  return result;
}
