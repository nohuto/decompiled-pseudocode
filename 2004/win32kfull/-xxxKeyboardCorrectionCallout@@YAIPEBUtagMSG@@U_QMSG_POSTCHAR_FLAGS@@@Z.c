/*
 * XREFs of ?xxxKeyboardCorrectionCallout@@YAIPEBUtagMSG@@U_QMSG_POSTCHAR_FLAGS@@@Z @ 0x1C0116598
 * Callers:
...
__int64 __fastcall xxxKeyboardCorrectionCallout(__int128 *a1, int a2)
{
  ...
  *(_OWORD *)v23 = v2;
  ...
  if ( *(char *)(v12 + 20) >= 0 && *(char *)(v12 + 19) >= 0 )
  {
    ...
    if ( gptiCurrent == v13 )
      return 0LL;
    if ( (unsigned __int8)CheckAccess(*(_QWORD *)(v13 + 416) + 880LL, *(_QWORD *)(gptiCurrent + 416LL) + 880LL) )
    {
      v14 = *(_QWORD *)(v10 + 248);
