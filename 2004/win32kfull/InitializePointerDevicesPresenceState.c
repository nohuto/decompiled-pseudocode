/*
 * XREFs of InitializePointerDevicesPresenceState @ 0x1C00BFD80
 * Callers:
 *     ?InitiateWin32kCleanup@@YAHXZ @ 0x1C00C02E4 (-InitiateWin32kCleanup@@YAHXZ.c)
 * Callees:
 *     FreePointerDeviceClientList @ 0x1C00BFDE0 (FreePointerDeviceClientList.c)
 */
...
int __fastcall InitializePointerDevicesPresenceState(int a1)
{
  ...
  if ( a1 )
  {
    ...
    qword_1C033B6B8 = (__int64)&gPointerDeviceClients;
