/*
 * XREFs of EditionPostMouseMoveToQ @ 0x1C00F99F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tagINPUT_MESSAGE_SOURCE *a6)
{
  ...
  if ( v10 )
    v11 = (__int128 *)(v10 + 384);
  v12 = *((_QWORD *)v37 + 11);
  v13 = (__int128 *)gObjDummyLock;
  if ( v12 )
    v13 = (__int128 *)(v12 + 384);
  v14 = *((_QWORD *)v37 + 12);
  ...
  v35 = v29;
  v36 = v30;
  return PostInputMessage(v37, v34, 0x200u, 0LL, a2, a3, a4, a5, 0, v6, 0LL, 0LL, v32, v33);
}
