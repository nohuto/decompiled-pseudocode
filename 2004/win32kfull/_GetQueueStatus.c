/*
 * XREFs of _GetQueueStatus @ 0x1C014EB7C
 * Callers:
 *     NtUserGetThreadState @ 0x1C00F1DC0 (NtUserGetThreadState.c)
 * Callees:
...
__int64 __fastcall GetQueueStatus(__int16 a1)
{
  ...
  CLockExclusiveUMCBAInUserCrit<DLT_THREADINFO>::CLockExclusiveUMCBAInUserCrit<DLT_THREADINFO>(
    v10,
    (tagDomLock *)(ThreadWin32Thread + 48));
  if ( ThreadWin32Thread[182] && (a1 & 8) != 0 )
    xxxDrainQueueCompletions(1LL);
  v3 = ThreadWin32Thread[55];
  v4 = a1 & 0x5DFF;
  v5 = *(unsigned __int16 *)(v3 + 4);
  *(_WORD *)(v3 + 4) = v5 & ~(a1 & 0x5DFF);
  v6 = ThreadWin32Thread[55];
