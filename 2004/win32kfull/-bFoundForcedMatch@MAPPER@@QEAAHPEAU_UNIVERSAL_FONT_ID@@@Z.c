/*
 * XREFs of ?bFoundForcedMatch@MAPPER@@QEAAHPEAU_UNIVERSAL_FONT_ID@@@Z @ 0x1C0141B24
 * Callers:
 ...
 *     ?pvSimBold@IFIOBJ@@QEAAPEAXXZ @ 0x1C0104DE8 (-pvSimBold@IFIOBJ@@QEAAPEAXXZ.c)
 ...
 *     ??$SafeDivide@KKK@@YAJKKPEAK@Z @ 0x1C011B89C (--$SafeDivide@KKK@@YAJKKPEAK@Z.c)
 ...
 *     ?bSimItalic@IFIOBJ@@QEAAHXZ @ 0x1C01489DC (-bSimItalic@IFIOBJ@@QEAAHXZ.c)
 *     ?bWin31BitmapWidthScaling@MAPPER@@QEAAHJJPEAJ@Z @ 0x1C01534A0 (-bWin31BitmapWidthScaling@MAPPER@@QEAAHJJPEAJ@Z.c)
 *     ?ppfeFirst@ENUMFHOBJ@@QEAAPEAVPFE@@XZ @ 0x1C0294AD0 (-ppfeFirst@ENUMFHOBJ@@QEAAPEAVPFE@@XZ.c)
 *     ?ppfeNext@ENUMFHOBJ@@QEAAPEAVPFE@@XZ @ 0x1C0294B08 (-ppfeNext@ENUMFHOBJ@@QEAAPEAVPFE@@XZ.c)
 */
