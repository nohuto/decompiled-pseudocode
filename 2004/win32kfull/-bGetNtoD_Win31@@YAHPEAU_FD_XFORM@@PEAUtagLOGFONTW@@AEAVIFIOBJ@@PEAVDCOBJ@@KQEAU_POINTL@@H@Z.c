/*
 * XREFs of ?bGetNtoD_Win31@@YAHPEAU_FD_XFORM@@PEAUtagLOGFONTW@@AEAVIFIOBJ@@PEAVDCOBJ@@KQEAU_POINTL@@H@Z @ 0x1C009D138
 * Callers:
 ...
 *     ?bParityViolatingXform@@YAHPEAVDCOBJ@@@Z @ 0x1C01226F4 (-bParityViolatingXform@@YAHPEAVDCOBJ@@@Z.c)
