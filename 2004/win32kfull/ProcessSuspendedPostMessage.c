/*
 * XREFs of ProcessSuspendedPostMessage @ 0x1C011CBE0
 * Callers:
 ...
 * Callees:
 *     ?ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z @ 0x1C0008B54 (-ProcessComplexCoalescence@@YAHII_K_JPEA_KPEA_J@Z.c)
 *     ?FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z @ 0x1C011CCA8 (-FindQMsgForCoalesce@@YAPEAUtagQMSG@@PEAUtagMLIST@@IPEAUHWND__@@PEAU1@@Z.c)
 */
