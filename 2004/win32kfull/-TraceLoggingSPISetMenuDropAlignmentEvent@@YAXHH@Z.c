/*
 * XREFs of ?TraceLoggingSPISetMenuDropAlignmentEvent@@YAXHH@Z @ 0x1C012AD60
 * Callers:
...
void __fastcall TraceLoggingSPISetMenuDropAlignmentEvent(char a1, char a2)
{
    ...
    && (qword_1C032B410 & 0x200000000000LL) == qword_1C032B410 )
  {
    ...
    v9 = 1LL;
    v7 = 8LL;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C032B3F8, (int)&dword_1C02F1BFF, 0, 0, 5u, &v5);
  }
}
