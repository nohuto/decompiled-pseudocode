/*
 * XREFs of ?vCharPos_G3@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJJJJPEBJPEAJ@Z @ 0x1C02BE4F0
 * Callers:
  ...
  if ( !*(_DWORD *)(*(_QWORD *)a3 + 640LL) )
  {
    ...
    if ( !a9 )
    {
      ...
      *v21 = 0;
      ...
      if ( bCalcBreakExtra(*(unsigned int *)(*(_QWORD *)a3 + 444LL), a7, a8, (__int64)v21) )
      {
        v24 = *(_QWORD *)a3;
        vGenWidths(
          &v58,
    ...
    v66 = 0x80000000;
    v64 = 0x7FFFFFFF;
    *(_QWORD *)v67 = 0x800000007FFFFFFFuLL;
    *(_QWORD *)&v67[2] = 0x7FFFFFFF80000000LL;
    if ( (unsigned int)RFONTOBJ::bGetGlyphMetricsPlus(a3, v33, v26, v28, &v72, a2, this) )
    {
      ...
      if ( *(_DWORD *)this )
      {
        ...
        while ( 1 )
        {
          ...
          v55 = v70[6];
          v69 = v70[3];
          vGenWidths(&v58, &v59, (struct EFLOAT *)&v63, (struct EFLOAT *)&v62, v69, v55, v56, v65);
          v37 = v58 + v31;
          v57 = 0;
