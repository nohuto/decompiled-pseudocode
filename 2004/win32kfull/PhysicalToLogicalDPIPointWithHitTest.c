/*
 * XREFs of PhysicalToLogicalDPIPointWithHitTest @ 0x1C0050F48
 * Callers:
...
__int64 __fastcall PhysicalToLogicalDPIPointWithHitTest(_QWORD *a1, _QWORD *a2, __int64 a3, __int64 a4)
{
  unsigned int v7; // ebp
  __int64 v8; // rsi
...
LABEL_7:
  ...
  if ( TopLevelOrDpiBoundaryWindow )
  {
    v11 = PtInRect(*((_QWORD *)TopLevelOrDpiBoundaryWindow + 5) + 88LL, v10);
    goto LABEL_7;
  }
  return PhysicalToLogicalDPIPoint(a1, a2, v7, 0LL);
}
