/*
 * XREFs of _SetClassWord @ 0x1C01E9834
 * Callers:
 *     NtUserSetClassWord @ 0x1C02024F0 (NtUserSetClassWord.c)
 * Callees:
...
LABEL_27:
  ...
  v16 = *(_QWORD **)(ThreadWin32Thread + 1464);
  if ( v16 )
    *(_QWORD *)(ThreadWin32Thread + 1464) = *v16;
  return v13;
}
