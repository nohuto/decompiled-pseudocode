/*
 * XREFs of ?TraceLoggingDrawMenuBarTempCalled@@YAXXZ @ 0x1C0225724
 * Callers:
 *     NtUserDrawMenuBarTemp @ 0x1C01F90C0 (NtUserDrawMenuBarTemp.c)
 * Callees:
...
void TraceLoggingDrawMenuBarTempCalled(void)
{
    ...
    && (qword_1C032B410 & 0x200000000000LL) == qword_1C032B410 )
  {
    ...
    v4 = 0;
    v3 = 8;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032B3F8, (unsigned __int8 *)dword_1C02F18F5, 0LL, 0LL, 3u, &v1);
  }
}
