/*
 * XREFs of NtUserSetCursorIconData @ 0x1C0065C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetCursorIconData(__int64 a1, unsigned int *a2, ULONG64 a3, _BYTE *a4)
{
  __int64 v8; // rdx
  __int64 v9; // rax
...
LABEL_15:
    MicrosoftTelemetryAssertTriggeredNoArgsKM(MmUserProbeAddress, v12);
    v17 = (unsigned __int64 *)MmUserProbeAddress;
    goto LABEL_16;
  }
LABEL_17:
...
LABEL_25:
      MicrosoftTelemetryAssertTriggeredNoArgsKM(v17, v18);
      v17 = (unsigned __int64 *)MmUserProbeAddress;
      goto LABEL_26;
    }
  }
