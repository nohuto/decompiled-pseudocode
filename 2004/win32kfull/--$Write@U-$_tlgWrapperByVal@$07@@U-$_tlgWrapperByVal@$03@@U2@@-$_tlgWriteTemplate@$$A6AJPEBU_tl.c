 ...
 *     ?TraceLoggingBSDRRaceConditionEvent@@YAXHH@Z @ 0x1C022562C (-TraceLoggingBSDRRaceConditionEvent@@YAXHH@Z.c)
        ...
        __int64 a7)
{
  ...
  v12 = 4LL;
  v10 = 8LL;
  return tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032B3F8, a2, 0LL, 0LL, 5u, &v8);
}
