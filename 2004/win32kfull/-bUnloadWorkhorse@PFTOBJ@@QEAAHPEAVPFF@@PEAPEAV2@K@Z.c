/*
 * XREFs of ?bUnloadWorkhorse@PFTOBJ@@QEAAHPEAVPFF@@PEAPEAV2@K@Z @ 0x1C0012A4C
 * Callers:
 ...
 *     PFTOBJ_bUnloadWorkhorseWrap @ 0x1C02741D0 (PFTOBJ_bUnloadWorkhorseWrap.c)
 ...
 *     ?bRemoveMergeFont@XDCOBJ@@QEAAHU_UNIVERSAL_FONT_ID@@@Z @ 0x1C02ADB78 (-bRemoveMergeFont@XDCOBJ@@QEAAHU_UNIVERSAL_FONT_ID@@@Z.c)
 ...
 *     ?bDeleteLoadRef@PFFOBJ@@QEAAHKPEAUtagPvtData@@PEAH@Z @ 0x1C0012C18 (-bDeleteLoadRef@PFFOBJ@@QEAAHKPEAUtagPvtData@@PEAH@Z.c)
 ...
 *     bKillPFFOBJ @ 0x1C00133D0 (bKillPFFOBJ.c)
