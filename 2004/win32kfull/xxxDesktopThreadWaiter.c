/*
 * XREFs of xxxDesktopThreadWaiter @ 0x1C00BE118
 * Callers:
 ...
 *     SleepInputIdle @ 0x1C00BE304 (SleepInputIdle.c)
...
__int64 __fastcall xxxDesktopThreadWaiter(char a1, char a2)
{
  ...
  v4 = (LegacyInputDispatcher *)qword_1C033AEF0;
  if ( gptiCurrent == gTermIO[2] )
    v4 = (LegacyInputDispatcher *)qword_1C033AEF8;
  v5 = *((_DWORD *)v4 + 15);
  v6 = 0;
  if ( a1 )
  {
  ...
  {
    if ( (*(_DWORD *)(gptiCurrent + 480LL) & 0x400) != 0 )
    {
