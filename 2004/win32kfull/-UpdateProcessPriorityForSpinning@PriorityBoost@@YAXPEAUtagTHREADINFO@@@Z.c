/*
 * XREFs of ?UpdateProcessPriorityForSpinning@PriorityBoost@@YAXPEAUtagTHREADINFO@@@Z @ 0x1C003554C
 * Callers:
...
void __fastcall PriorityBoost::UpdateProcessPriorityForSpinning(PriorityBoost *this, struct tagTHREADINFO *a2)
{
  ...
  v3 = *((_QWORD *)this + 52);
  v4 = *(_DWORD *)(v3 + 12);
  if ( (*((_DWORD *)this + 120) & 0x400) != 0 )
  {
    if ( (v4 & 0x800) == 0 )
    {
      *(_DWORD *)(v3 + 12) = v4 | 0x800;
      if ( (*(_DWORD *)(*((_QWORD *)this + 52) + 820LL) & 0x60000) == 0x20000 )
      {
        v6 = 2LL;
LABEL_10:
  ...
  {
    for ( i = *(_QWORD *)(v3 + 320); i; i = *(_QWORD *)(i + 656) )
    {
      if ( (*(_DWORD *)(i + 480) & 0x400) != 0 )
        goto LABEL_11;
    }
    *(_DWORD *)(v3 + 12) = v4 & 0xFFFFF7FF;
    if ( (*(_DWORD *)(*((_QWORD *)this + 52) + 820LL) & 0x60000) == 0x40000 )
    {
      v6 = 1LL;
      goto LABEL_10;
    }
