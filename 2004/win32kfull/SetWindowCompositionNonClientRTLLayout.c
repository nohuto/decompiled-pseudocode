/*
 * XREFs of SetWindowCompositionNonClientRTLLayout @ 0x1C0214F44
 * Callers:
...
__int64 __fastcall SetWindowCompositionNonClientRTLLayout(__int64 *a1, __int128 *a2, __int64 a3)
{
  bool v4; // zf
  int v6; // esi
  unsigned int v7; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 3) == v6 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFFFB | (4 * v6);
