/*
 * XREFs of ?QueuePTPMouseEvent@@YAXPEAXUtagPOINT@@K_K2PEAU_PTPMouseLatencyTracker@@@Z @ 0x1C0213F38
 * Callers:
 *     SendPTPAsMouse @ 0x1C0214850 (SendPTPAsMouse.c)
 * Callees:
 *     ?DropInput@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z @ 0x1C0213ECC (-DropInput@Mouse@InputTraceLogging@@SAX_KW4DropReason@12@@Z.c)
 */
