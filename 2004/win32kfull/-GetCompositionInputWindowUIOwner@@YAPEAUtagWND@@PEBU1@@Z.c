/*
 * XREFs of ?GetCompositionInputWindowUIOwner@@YAPEAUtagWND@@PEBU1@@Z @ 0x1C01D2C18
 * Callers:
 ...
 *     EditionGetCompositionInputWindowUIOwner @ 0x1C0209B10 (EditionGetCompositionInputWindowUIOwner.c)
 * Callees:
