/*
 * XREFs of ?GenerateCookie@?$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@CAIXZ @ 0x1C022041C
 * Callers:
 ...
 *     Win32UAFMAllocPoolWithQuotaImpl @ 0x1C0220CF0 (Win32UAFMAllocPoolWithQuotaImpl.c)
