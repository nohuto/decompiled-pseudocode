/*
 * XREFs of UmfdLoadFontFileView @ 0x1C0014BA8
 * Callers:
 ...
 *     ?bIsPathInSystemFontsDir@@YAHPEBG@Z @ 0x1C011A0BC (-bIsPathInSystemFontsDir@@YAHPEBG@Z.c)
 *     ?FNTCacheValidateFntFileInfo@@YA?AW4FntFileInfoValidationResult@@PEAPEAU_FONTFILEVIEW@@K@Z @ 0x1C02894CC (-FNTCacheValidateFntFileInfo@@YA-AW4FntFileInfoValidationResult@@PEAPEAU_FONTFILEVIEW@@K@Z.c)
 *     ?PutFntCacheDrvAndFileInfo@@YAXKPEAVPDEV@@KPEAPEAU_FONTFILEVIEW@@K@Z @ 0x1C02895FC (-PutFntCacheDrvAndFileInfo@@YAXKPEAVPDEV@@KPEAPEAU_FONTFILEVIEW@@K@Z.c)
 */
  ...
  *v15 = 0LL;
  if ( (_BYTE)result )
  {
    ...
    if ( !v42 )
    {
      ...
      v21 = v47;
      v22 = 1;
      for ( i = qword_1C0341A00; v20 < v47; v21 = v47 )
      {
        v23 = v20++;
        *((_DWORD *)v46[v23] + 16) = 0;
      }
      ...
      else
      {
        ...
        PutFntCacheDrvAndFileInfo(*v17, qword_1C0341A00, v39, v46, v47);
      }
      if ( v30 )
      {
        *v15 = qword_1C0341A00;
