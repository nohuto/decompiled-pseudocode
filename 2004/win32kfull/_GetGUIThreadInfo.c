/*
 * XREFs of _GetGUIThreadInfo @ 0x1C00F4AD4
 * Callers:
...
__int64 __fastcall GetGUIThreadInfo(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  if ( *(_QWORD *)(v5 + 296) )
  {
    ...
    a1 = *(_QWORD **)(v5 + 296);
    a2 = a1[2];
    if ( *(_QWORD *)(a2 + 448) != *(_QWORD *)(v27 + 448) )
      goto LABEL_33;
  }
  if ( v4 )
  {
...
LABEL_34:
  ...
  *(_QWORD *)(v3 + 32) = 0LL;
  ...
  if ( v19 && (*(_DWORD *)(v19 + 196) & 8) == 0 && *(_QWORD *)(v19 + 16) )
  {
    *(_DWORD *)(v3 + 4) = 2;
    v20 = 2;
    *(_QWORD *)(v3 + 40) = **(_QWORD **)(v4[83] + 16LL);
  }
  v21 = (int **)v4[75];
  if ( !v21 || !*v21 )
    goto LABEL_19;
...
LABEL_19:
  ...
  *(_QWORD *)(v3 + 24) = v24;
  ...
  else if ( v4 && (*(_DWORD *)(v4[52] + 12LL) & 0x4000000) != 0 )
  {
    *(_QWORD *)(v3 + 48) = *(_QWORD *)(v4[56] + 144LL);
    *(_OWORD *)(v3 + 56) = *(_OWORD *)(v4[56] + 152LL);
  }
  else
  {
    *(_OWORD *)(v3 + 56) = 0LL;
