/*
 * XREFs of ?bMakeInactiveHelper@RFONTOBJ@@QEAAHPEAPEAVRFONT@@@Z @ 0x1C00DBF50
 * Callers:
 ...
 *     ?prfntInactive@PDEVOBJ@@QEAAPEAVRFONT@@PEAV2@@Z @ 0x1C00DB570 (-prfntInactive@PDEVOBJ@@QEAAPEAVRFONT@@PEAV2@@Z.c)
...
__int64 __fastcall RFONTOBJ::bMakeInactiveHelper(struct RFONT **this, struct RFONT **a2)
{
  ...
  struct RFONT *v37; // [rsp+90h] [rbp+8h] BYREF
  ...
  if ( v5 )
  {
    ...
    RFONTOBJ::vDeleteRFONT((RFONTOBJ *)&v37, 0LL, (struct PFFOBJ *)&v35, 1);
