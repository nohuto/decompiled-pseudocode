/*
 * XREFs of xxxDoSysExpunge @ 0x1C0042A4C
 * Callers:
        ...
        if ( (_WORD)v7 )
        {
          ...
          if ( ((1 << v2) & *(_DWORD *)(v8 + 404)) != 0 )
          {
            ...
            *(_DWORD *)(*(_QWORD *)(a1 + 416) + 404LL) &= v10;
            ...
            {
              UserDeleteAtomFromAtomTable(UserLibmgmtAtomTableHandle, v7, v8, 0x1C0000000uLL);
              if ( v4 >= 0x40 )
                _report_rangecheckfailure();
              LODWORD(WPP_MAIN_CB.Dpc.DpcListEntry.Next) &= v10;
