/*
 * XREFs of _anonymous_namespace_::SetForegroundPriorityProcess @ 0x1C003564C
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::SetProcessPriorityByClass @ 0x1C0035770 (_anonymous_namespace_--SetProcessPriorityByClass.c)
        ...
        unsigned int a3)
{
  ...
  if ( (result & 0xC) == 0 && (result & 1) == 0 && ((result & 0x40000) == 0 || a3 == 1) )
  {
    ...
    {
      MicrosoftTelemetryAssertTriggeredNoArgsKM(gppiScreenSaver, v4);
    }
