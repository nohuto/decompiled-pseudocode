/*
 * XREFs of SetWindowCompositionVideoOverlayActive @ 0x1C02150EC
 * Callers:
...
__int64 __fastcall SetWindowCompositionVideoOverlayActive(__int64 *a1, __int128 *a2, __int64 a3)
{
  bool v4; // zf
  int v6; // edi
  unsigned int v7; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 8) == v6 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFF7F | (v6 << 7);
