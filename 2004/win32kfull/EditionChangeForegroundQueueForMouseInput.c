/*
 * XREFs of EditionChangeForegroundQueueForMouseInput @ 0x1C0008640
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EditionChangeForegroundQueueForMouseInput(__int64 a1, __int64 a2)
{
  ...
  {
    v4 = 1;
    if ( !(unsigned __int8)CheckAccess(a2, *(_QWORD *)(*(_QWORD *)(v3 + 16) + 424LL) + 428LL) )
    {
      EtwTraceUIPIInputError(
        gptiCurrent,
        *(_QWORD *)(v3 + 16),
        *(_QWORD *)(*(_QWORD *)(v3 + 16) + 424LL),
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 16) + 424LL) + 428LL),
        1);
      return 0LL;
    }
  }
