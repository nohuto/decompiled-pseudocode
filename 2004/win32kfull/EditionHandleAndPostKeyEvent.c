/*
 * XREFs of EditionHandleAndPostKeyEvent @ 0x1C00F9270
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _KEYBOARD_VIRTUAL_DEVICE_INFO *a16)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 456) + 56LL)
    ...
    || (a5 != 9 || (a6 & 1) != 0) && (a5 != 27 || (a6 & 2) != 0) )
  {
    ...
    if ( (unsigned __int8)IsKeyboardDelegationEnabledForThread(*(_QWORD *)(gpqForeground + 96LL))
      ...
      && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(PtiKbdFromQ(gpqForeground) + 416) + 832LL) + 100LL) & 0x400) != 0
      && (unsigned __int8)(a5 + 90) <= 0x11u )
    {
      ...
      if ( !a4 && gpqForeground )
      {
        if ( (unsigned __int8)(a5 + 83) <= 2u )
        {
          ...
          {
            v27 = *(_QWORD *)(*(_QWORD *)(v26 + 16) + 424LL);
            if ( v27 )
            {
...
LABEL_49:
        ...
        if ( !(unsigned __int8)IsKeyboardDelegationEnabledForThread(*(_QWORD *)(gpqForeground + 96LL)) )
        {
                               ...
                               (__int64)&v54) )
          {
            ...
            if ( v35 )
              v36 = (__int128 *)(v35 + 384);
            v37 = *((_QWORD *)v55 + 12);
            v38 = (__int128 *)gObjDummyLock;
            if ( v37 )
              v38 = (__int128 *)(v37 + 384);
            v39 = gObjDummyLock;
            if ( v56 )
              v39 = v56 + 384;
