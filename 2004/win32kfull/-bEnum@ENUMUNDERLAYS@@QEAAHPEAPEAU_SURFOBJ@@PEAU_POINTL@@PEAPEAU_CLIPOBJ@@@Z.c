/*
 * XREFs of ?bEnum@ENUMUNDERLAYS@@QEAAHPEAPEAU_SURFOBJ@@PEAU_POINTL@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C0083518
 * Callers:
...
LABEL_10:
    ...
    {
      v14 = *this;
      *(_DWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280) + 12LL) = *((_DWORD *)v14 + 25);
      v15 = *this;
      *(_DWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280) + 16LL) = *((_DWORD *)v15 + 26);
      CurrentThread = KeGetCurrentThread();
      v17 = *(_QWORD *)(W32GetThreadWin32Thread(CurrentThread) + 280);
      *(_DWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(CurrentThread) + 280) + 20LL) = *(_DWORD *)(v17 + 12);
      v18 = KeGetCurrentThread();
      v19 = *(_QWORD *)(W32GetThreadWin32Thread(v18) + 280);
      *(_DWORD *)(*(_QWORD *)(W32GetThreadWin32Thread(v18) + 280) + 24LL) = *(_DWORD *)(v19 + 16);
      ...
      **(_DWORD **)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280) = 0;
      if ( *((_DWORD *)this + 21) == 1 )
      {
        ...
        v66 = v37;
        v67 = v30;
        v38 = *(_OWORD **)(W32GetThreadWin32Thread(KeGetCurrentThread()) + 280);
        v39 = v58;
        *v38 = v57;
        v40 = v59;
        v38[1] = v39;
