/*
 * XREFs of ?EngStretchBltNew@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C00D2B9C
 * Callers:
                ...
                if ( v44 == v45 && ((v45 - 3) & 0xFFFFFFFC) == 0 && v45 != 5 )
                {
                  if ( v134 && *((_BYTE *)v134 + 20) == 3 )
                  {
                    ...
                    *(_QWORD *)&v186.left = 0LL;
                    ...
                    do
                    {
                      v55 = XCLIPOBJ::bEnum(v54, 0x14u, (char *)&v194, 0LL);
                      v119 = v55;
                      if ( v194.left )
                      {
                        StretchDIBDirect(
                        ...
                        if ( !ERECTL::bEmpty((ERECTL *)&v187) )
                        {
                          ...
                          if ( v62 >= v15->left )
                          {
                            ...
                            if ( v63 >= v64 )
                            {
                              ...
                              {
                                v67 = (struct _STRDDA *)PALLOCMEM2(4 * v66 + 40);
...
LABEL_205:
                      v117 = XCLIPOBJ::bEnum(v59, 0x144u, (char *)v57, 0LL);
                    }
                  }
                  *v57 = 1;
