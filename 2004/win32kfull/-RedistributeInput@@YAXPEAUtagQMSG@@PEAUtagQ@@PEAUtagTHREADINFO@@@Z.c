/*
 * XREFs of ?RedistributeInput@@YAXPEAUtagQMSG@@PEAUtagQ@@PEAUtagTHREADINFO@@@Z @ 0x1C00390C4
 * Callers:
...
void __fastcall RedistributeInput(struct tagQMSG *a1, struct tagQ *a2, struct tagTHREADINFO *a3)
{
  ...
  if ( a1 )
  {
    ...
    do
    {
      ...
      if ( v13 )
      {
        if ( (*(_DWORD *)(v13 + 1224) & 0x20000000) != 0 && (unsigned int)IsHiddenByInputService(v6) )
        {
          *(_DWORD *)(v13 + 1224) = v39 & 0xDFFFFFFF;
      ...
      if ( v21 )
      {
        ...
        *((_DWORD *)v6 + 25) &= 0xFFF0FFFF;
        ...
        if ( (v24 - 256 <= 9 || InputTraceLogging::IsMouseInputMessage(v24))
          && dword_1C0330B30 > (unsigned int)v19
          ...
          && (qword_1C0330B48 & 0x10) == qword_1C0330B48 )
        {
          ...
          v55 = v19;
          v53 = 8LL;
          tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0330B30, (int)&dword_1C02EFD23, 0, 0, 8u, &v51);
          v3 = 0LL;
        }
        v26 = v6;
        v27 = v6;
        ...
        *(_DWORD *)(v10 + 16) = v28;
        ...
        if ( *((_DWORD *)v27 + 24) != (_DWORD)v3 && (*(_WORD *)(*((_QWORD *)v21 + 55) + 6LL) & 0x2000) == 0 )
        {
  ...
  if ( v11 )
  {
    ...
    {
      v41 = *(_QWORD *)(v11 + 8);
      if ( *(struct tagQ **)(*(_QWORD *)(v11 + 104) + 424LL) != a2 )
      {
        RemoveQMsgFromDeferList((struct tagQ *)((char *)a2 + 24), (struct tagQMSG *)v11);
        DeferMessage((struct tagMLIST *)(*(_QWORD *)(*(_QWORD *)(v42 + 104) + 424LL) + 24LL), (struct tagQMSG *)v42);
      }
      v11 = v41;
    }
    while ( v41 );
