/*
 * XREFs of xxxPointerWindowHitTest @ 0x1C0218754
 * Callers:
        ...
        struct tagPOINT *a11)
{
    ...
    if ( v14 )
    {
      ...
      if ( v16 )
      {
        ...
        *(_QWORD *)&v30 = v22;
        ...
        if ( *(_DWORD *)(v16 + 180) )
        {
          v13 = xxxWindowHitTestWithoutTargeting(v20, a2, a3, a4, a5, a6, a7);
        }
        else
        {
          *a7 = *(_DWORD *)(v16 + 32);
  ...
  v13 = xxxWindowHitTestWithoutTargeting(a1, a2, a3, a4, a5, a6, a7);
LABEL_25:
