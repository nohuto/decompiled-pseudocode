/*
 * XREFs of ?vAddStartCap@WIDENER@@IEAAXXZ @ 0x1C0131DD4
 * Callers:
 *     ?bWiden@WIDENER@@IEAAHXZ @ 0x1C0133110 (-bWiden@WIDENER@@IEAAHXZ.c)
 * Callees:
 ...
 *     ?vecOutPerp@WIDENER@@IEAA?AVEVECTORFX@@XZ @ 0x1C0133E10 (-vecOutPerp@WIDENER@@IEAA-AVEVECTORFX@@XZ.c)
 *     ?vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z @ 0x1C02CF2AC (-vAddRoundEndCap@WIDEPENOBJ@@QEAAXAEAVWIDENER@@AEAVLINEDATA@@HH@Z.c)
