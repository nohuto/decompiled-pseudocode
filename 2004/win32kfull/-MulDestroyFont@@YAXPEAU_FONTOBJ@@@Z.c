/*
 * XREFs of ?MulDestroyFont@@YAXPEAU_FONTOBJ@@@Z @ 0x1C02A35E0
 * Callers:
 *     <none>
 * Callees:
 *     ?DestroyFont@PDEVOBJ@@QEAAXPEAU_FONTOBJ@@@Z @ 0x1C00DC3F8 (-DestroyFont@PDEVOBJ@@QEAAXPEAU_FONTOBJ@@@Z.c)
 *     ??0MULTIFONT@@QEAA@PEAU_FONTOBJ@@JPEAU_VDEV@@@Z @ 0x1C02A1844 (--0MULTIFONT@@QEAA@PEAU_FONTOBJ@@JPEAU_VDEV@@@Z.c)
 *     ??1MULTIFONT@@QEAA@XZ @ 0x1C02A19F4 (--1MULTIFONT@@QEAA@XZ.c)
 *     ?DestroyTable@MULTIFONT@@QEAAXXZ @ 0x1C02A1B28 (-DestroyTable@MULTIFONT@@QEAAXXZ.c)
 */
