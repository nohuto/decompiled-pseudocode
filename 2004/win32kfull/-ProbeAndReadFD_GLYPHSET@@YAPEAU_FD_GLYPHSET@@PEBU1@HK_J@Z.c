/*
 * XREFs of ?ProbeAndReadFD_GLYPHSET@@YAPEAU_FD_GLYPHSET@@PEBU1@HK_J@Z @ 0x1C02A9778
 * Callers:
  ...
  *v13 = v11;
  ...
  if ( v13[3] == v26 )
  {
    ...
    if ( v13[2] == v29 )
    {
      ...
      v18 = 0;
      v19 = 0;
      v20 = (unsigned __int64 *)MmUserProbeAddress;
      while ( v19 < v15 )
      {
        ...
        if ( v23 )
        {
          v24 = v23 - a4;
          v25 = 4 * v21;
          if ( v24 < (unsigned __int64)Src
            || v24 - (unsigned __int64)Src > a3
            || (unsigned int)v25 > (unsigned __int64)Src + a3 - v24 )
          {
            goto LABEL_35;
          }
          if ( !a2 && (_DWORD)v25 )
          {
            if ( (v24 & 3) != 0 )
              ExRaiseDatatypeMisalignment();
            if ( v25 + v24 > *v20 || v25 + v24 < v24 )
              *(_BYTE *)*v20 = 0;
          }
          memmove(v17, (const void *)v24, (unsigned int)v25);
