/*
 * XREFs of ?InternalBuildHwndList@@YAPEAUtagBWL@@PEAU1@PEAUtagWND@@I@Z @ 0x1C006C710
 * Callers:
      ...
      || (a3 & 0x10) != 0 && (*(_DWORD *)(*((_QWORD *)v4 + 5) + 232LL) & 0x1000000) != 0 )
    {
      if ( (a3 & 0x40) == 0
        ...
        || !ShellWindowManagement::BehaviorEnabled(
              *((ShellWindowManagement **)v4 + 3),
              (const struct tagDESKTOP *)0xFF,
              a3)
        || !(unsigned __int8)anonymous_namespace_::EligibleWindow(v4) )
      {
