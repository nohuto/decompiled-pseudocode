/*
 * XREFs of DwmChildRectChange @ 0x1C00A5C78
 * Callers:
...
LONG_PTR __fastcall DwmChildRectChange(unsigned __int64 a1, __int64 a2, __int64 a3)
{
  ...
  INT v63; // edi
  __m128i v64; // [rsp+30h] [rbp-D0h]
  __int128 v65; // [rsp+48h] [rbp-B8h] BYREF
  __m128i v66; // [rsp+58h] [rbp-A8h] BYREF
  __m128i v67; // [rsp+68h] [rbp-98h] BYREF
  __m128i v68; // [rsp+80h] [rbp-80h] BYREF
  _DWORD v69[28]; // [rsp+90h] [rbp-70h] BYREF
    ...
    if ( v6.m128i_i32[1] < SHIDWORD(v9) )
    {
      ...
      else if ( (*(_DWORD *)(v3 + 232) & 0x8000000) != 0 )
      {
        WindowDpiLastNotify = GetWindowDpiLastNotify(v5);
             ...
             && (v49 = *(_QWORD *)(*(_QWORD *)(v5 + 16) + 448LL)) != 0
             && (*(_DWORD *)(**(_QWORD **)(v49 + 8) + 64LL) & 1) != 0 )
      {
        WindowDpiLastNotify = 96;
      }
      else
      {
        WindowDpiLastNotify = *(unsigned __int16 *)(*(_QWORD *)(*(_QWORD *)(v5 + 16) + 416LL) + 284LL);
      }
      AdjustWindowRectExForDpi(&v65, *(_DWORD *)(v3 + 28), a3, *(_DWORD *)(v3 + 24), WindowDpiLastNotify);
      v3 = *(_QWORD *)(v5 + 40);
      v4 = DWORD2(v65);
      v12 = v8 - DWORD2(v65);
      v13 = v7 - v65;
      v14 = v6.m128i_i32[1] - DWORD1(v65);
      v15 = v6.m128i_i32[3] - HIDWORD(v65);
      v16 = *(_DWORD *)(v3 + 104);
  ...
  if ( !(unsigned __int8)KeIsAttachedProcess(a1)
    || (v50 = PsGetCurrentProcess(v25, v24, v26),
      ...
      if ( *ThreadWin32Thread )
      {
        ...
        if ( *(_QWORD *)(v30 + 448) )
        {
          ...
          if ( !(unsigned __int8)KeIsAttachedProcess(v35)
            || (v58 = PsGetCurrentProcess(v39, v38, v40),
          ...
          if ( (*(_DWORD *)(**(_QWORD **)(*(_QWORD *)(v37 + 448) + 8LL) + 64LL) & 1) != 0 )
          {
            v42 = *(_QWORD *)(v5 + 40);
            v43 = *(_DWORD *)(v42 + 288);
            if ( (v43 & 0xF) == 0 && (v43 & 0x40000000) != 0 )
            {
              v48 = *(unsigned __int16 *)(v42 + 284);
              if ( (_WORD)v48 != 96 )
              {
                ScaledLogPixels = GreGetScaledLogPixels(v48);
                v63 = ScaledLogPixels;
                ScaleDPIRect(&v66, &v66, ScaledLogPixels, 0x60u, 0LL, 0LL);
                ScaleDPIRect(&v67, &v67, v63, 0x60u, 0LL, 0LL);
                ScaleDPIRect(&v68, &v68, v63, 0x60u, 0LL, 0LL);
                v4 = EngMulDiv(v4, v63, 96);
              }
            }
          }
        }
  ...
  DirtyVisRgnTrackers((struct tagWND *)v5);
  v44 = *(_QWORD *)v5;
  result = ReferenceDwmApiPort(v45);
  v47 = (void *)result;
