/*
 * XREFs of ?NextTopWindow@FindNextTopWindow@@YAPEAUtagWND@@PEBU2@0W4FindOption@1@@Z @ 0x1C00F5DC8
 * Callers:
 *     _lambda_9e1c073be7703093e3ca0af05debe537_::operator() @ 0x1C00F5D2C (_lambda_9e1c073be7703093e3ca0af05debe537_--operator().c)
 *     ?IsTopmostRealApp@@YAHPEAUtagWND@@@Z @ 0x1C0235B18 (-IsTopmostRealApp@@YAHPEAUtagWND@@@Z.c)
 ...
 *     _anonymous_namespace_::NTW_GetNextTop @ 0x1C00F5F1C (_anonymous_namespace_--NTW_GetNextTop.c)
 *     _anonymous_namespace_::GNT_NextTopScan @ 0x1C00F5F70 (_anonymous_namespace_--GNT_NextTopScan.c)
 *     _anonymous_namespace_::CheckTopLevelOnly @ 0x1C00F5FE4 (_anonymous_namespace_--CheckTopLevelOnly.c)
 *     SkipWindowOnMonitor @ 0x1C00F6014 (SkipWindowOnMonitor.c)
 *     _anonymous_namespace_::NTW_GetPrevTop @ 0x1C0241EE4 (_anonymous_namespace_--NTW_GetPrevTop.c)
 */
