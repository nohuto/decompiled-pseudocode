/*
 * XREFs of ??0EBOX@@QEAA@AEAVDCOBJ@@AEAU_RECTL@@PEAU_LINEATTRS@@H@Z @ 0x1C0135B44
 * Callers:
...
EBOX *__fastcall EBOX::EBOX(EBOX *this, struct DCOBJ *a2, struct _RECTL *a3, struct _LINEATTRS *a4, int a5)
{
  ...
  struct _POINTFIX v59; // [rsp+48h] [rbp-18h] BYREF
  FIX v60; // [rsp+50h] [rbp-10h]
  FIX v61; // [rsp+54h] [rbp-Ch]
...
LABEL_12:
  ...
  {
    EXFORMOBJ::bXformRound((EXFORMOBJ *)v58, (struct _POINTL *)&v59, &v59, 2uLL);
    v27 = 16;
    if ( a5 && v20[44] == 5 )
    {
      v30 = v59.y;
