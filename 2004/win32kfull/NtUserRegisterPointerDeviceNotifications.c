/*
 * XREFs of NtUserRegisterPointerDeviceNotifications @ 0x1C0128A70
 * Callers:
 *     <none>
 * Callees:
 *     UserSetLastError @ 0x1C0090F00 (UserSetLastError.c)
 *     _RegisterPointerDeviceNotifications @ 0x1C0128B44 (_RegisterPointerDeviceNotifications.c)
 */
...
__int64 __fastcall NtUserRegisterPointerDeviceNotifications(__int64 a1, unsigned int a2)
{
  ...
  if ( v4 )
  {
    ...
    {
      if ( a2 && !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 416LL) + 880LL, &v14) )
      {
