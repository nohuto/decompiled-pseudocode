/*
 * XREFs of OffStretchBlt @ 0x1C014A078
 * Callers:
        ...
        int a14)
{
  ...
  struct _CLIPOBJ *v26; // [rsp+80h] [rbp-49h]
  __int64 v27; // [rsp+88h] [rbp-41h]
  __int64 v28; // [rsp+90h] [rbp-39h]
  __int64 v29; // [rsp+98h] [rbp-31h]
  __int64 (__fastcall *v30)(__int64, __int64, __int64, struct _CLIPOBJ *, __int64, __int64, __int64 *, _DWORD *, _DWORD *, __int64, int); // [rsp+A0h] [rbp-29h]
  _DWORD v31[4]; // [rsp+A8h] [rbp-21h] BYREF
  _DWORD v32[4]; // [rsp+B8h] [rbp-11h] BYREF
