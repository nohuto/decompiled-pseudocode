/*
 * XREFs of ?SetWinlogonHotKeys@@YAXXZ @ 0x1C00C837C
 * Callers:
...
void SetWinlogonHotKeys(void)
{
  ...
  RegisterHotKey(0LL, (__int64)WinlogonHotkeyCallback, 13, 24586, BugCheckParameter2d);
  LODWORD(BugCheckParameter2e) = 13;
  RegisterHotKey(0LL, (__int64)WinlogonHotkeyCallback, 14, 24584, BugCheckParameter2e);
  LODWORD(BugCheckParameter2f) = 187;
  RegisterHotKey(0LL, (__int64)WinlogonHotkeyCallback, 12, 24584, BugCheckParameter2f);
  ...
  RegisterHotKey(0LL, (__int64)WinlogonHotkeyCallback, 15, 8206, BugCheckParameter2h);
