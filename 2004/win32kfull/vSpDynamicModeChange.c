/*
 * XREFs of vSpDynamicModeChange @ 0x1C004C970
 * Callers:
 *     <none>
 * Callees:
 *     ??1MULTISPRITEDDIACCESS@@QEAA@XZ @ 0x1C004CB90 (--1MULTISPRITEDDIACCESS@@QEAA@XZ.c)
 *     ??0MULTISPRITEDDIACCESS@@QEAA@AEAVPDEVOBJ@@@Z @ 0x1C004CBE0 (--0MULTISPRITEDDIACCESS@@QEAA@AEAVPDEVOBJ@@@Z.c)
 *     ?vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z @ 0x1C004CC80 (-vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z.c)
 ...
 *     ?vFixupMetaSpriteList@@YAXAEAVPDEVOBJ@@@Z @ 0x1C0282E7C (-vFixupMetaSpriteList@@YAXAEAVPDEVOBJ@@@Z.c)
 */
