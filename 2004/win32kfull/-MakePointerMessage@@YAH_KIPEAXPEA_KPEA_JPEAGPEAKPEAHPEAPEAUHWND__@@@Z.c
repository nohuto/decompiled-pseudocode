/*
 * XREFs of ?MakePointerMessage@@YAH_KIPEAXPEA_KPEA_JPEAGPEAKPEAHPEAPEAUHWND__@@@Z @ 0x1C01F17B8
 * Callers:
 *     PrepareSentPointerMessageForClient @ 0x1C01F0110 (PrepareSentPointerMessageForClient.c)
 *     TranslateSentPointerMessageForClient @ 0x1C01F02C4 (TranslateSentPointerMessageForClient.c)
 * Callees:
