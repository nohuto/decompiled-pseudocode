/*
 * XREFs of ?bCreateHalftoneBrushes@PDEVOBJ@@QEAAHXZ @ 0x1C00C9A78
 * Callers:
 *     PDEVOBJ_bCreateHalftoneBrushesWrap @ 0x1C00C9A60 (PDEVOBJ_bCreateHalftoneBrushesWrap.c)
 * Callees:
