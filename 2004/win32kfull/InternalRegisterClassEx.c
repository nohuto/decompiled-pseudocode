/*
 * XREFs of InternalRegisterClassEx @ 0x1C008D05C
 * Callers:
...
__int64 __fastcall InternalRegisterClassEx(__int64 a1, __int16 a2, unsigned int a3, _DWORD *a4)
{
  ...
  _STRING v57; // [rsp+68h] [rbp-80h] BYREF
...
LABEL_87:
  ...
  if ( Atom && !v10 )
  {
    v53 = *(struct tagDESKTOP **)(gptiCurrent + 416LL);
    ClassPtr = (__int64 *)InnerGetClassPtr(Atom, (char *)v53 + 344);
    if ( ClassPtr )
    {
    ...
    {
      v37 = (__int64 *)InnerGetClassPtr(Atom, (char *)v53 + 352);
      if ( v37 )
      {
        if ( (unsigned int)PsGetWin32KFilterSet() == 5 )
        {
    ...
    *(_WORD *)(*(_QWORD *)(*(_QWORD *)v50[0] + 8LL) + 4LL) = a2;
    if ( a2 )
    {
      ...
      if ( *(_DWORD *)(a1 + 92) == 1 )
        ...
        v39 = *(_DWORD *)(v38 + 80);
      *(_WORD *)(gpsi + 2LL * ((a2 & 0x3FFFu) - 666) + 328) = v39 + 320;
    }
    if ( (*(_WORD *)(*(_QWORD *)(*(_QWORD *)v50[0] + 8LL) + 6LL) & 1) == 0 )
    {
      ...
      if ( v21 )
      {
        ...
        *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v50[0] + 8LL) + 32LL) = v21;
        ...
        v46 = 6LL * v44;
        v47 = dword_1C02E0A88[2 * v46];
        if ( *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v50[0] + 8LL) + 80LL) >= v47 )
        {
          *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v50[0] + 8LL) + 84LL) = v47;
          *(_DWORD *)(*(_QWORD *)(*(_QWORD *)v50[0] + 8LL) + 80LL) -= dword_1C02E0A88[2 * v46];
        }
      }
    }
LABEL_25:
...
LABEL_101:
    ...
    *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v50[0] + 8LL) + 56LL) = v25;
    ...
    {
      v28 = ValidateClassAtomForRegisterClass(*(struct tagPROCESSINFO **)(gptiCurrent + 416LL), v26);
      v27 = 0;
    }
    if ( !v28 )
    {
LABEL_100:
    ...
    *(_WORD *)(*(_QWORD *)(*(_QWORD *)v50[0] + 8LL) + 2LL) = v28;
    ...
    {
      v30 = ValidateClassAtomForRegisterClass(*(struct tagPROCESSINFO **)(gptiCurrent + 416LL), v29);
      v19 = 0;
    }
    if ( !v30 )
    {
...
LABEL_46:
      ...
      {
        **(_QWORD **)v50[0] = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 352LL);
        *(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 352LL) = *(_QWORD *)v50[0];
      }
      else
      {
        **(_QWORD **)v50[0] = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 344LL);
        *(_QWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 344LL) = *(_QWORD *)v50[0];
      }
      v8 = *(_QWORD *)v50[0];
      goto LABEL_50;
    }
