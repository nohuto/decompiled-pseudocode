/*
 * XREFs of GetScreenRectForDpi @ 0x1C00231F0
 * Callers:
...
__m128i *__fastcall GetScreenRectForDpi(__m128i *a1, unsigned __int16 a2)
{
  ...
  char v21[16]; // [rsp+30h] [rbp-10h] BYREF
...
LABEL_3:
  ...
  if ( *(_DWORD *)v5 == 1 )
  {
    ...
    v6 = *(__m128i *)GetMonitorRectForDpi(&v20, *(_QWORD *)(DispInfo + 96), a2);
    goto LABEL_3;
  }
  v9 = v4[13];
  v10 = 0LL;
  ...
  if ( v9 )
  {
    ...
    do
    {
      ...
      {
        MonitorRectForDpi = (__m128i *)GetMonitorRectForDpi(v21, v9, a2);
        v16 = *MonitorRectForDpi;
        v17 = MonitorRectForDpi->m128i_i64[0];
