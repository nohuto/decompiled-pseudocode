/*
 * XREFs of UmfdFontManagement @ 0x1C02DEAD0
 * Callers:
 ...
 *     ?GetDrvType@FontManagementRequest@@UEBA?AW4FontDriverType@@XZ @ 0x1C02DE9A0 (-GetDrvType@FontManagementRequest@@UEBA-AW4FontDriverType@@XZ.c)
 */
