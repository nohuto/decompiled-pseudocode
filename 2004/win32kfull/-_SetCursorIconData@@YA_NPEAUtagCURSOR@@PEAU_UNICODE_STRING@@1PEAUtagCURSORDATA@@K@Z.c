/*
 * XREFs of ?_SetCursorIconData@@YA_NPEAUtagCURSOR@@PEAU_UNICODE_STRING@@1PEAUtagCURSORDATA@@K@Z @ 0x1C006530C
 * Callers:
        ...
        size_t Size)
{
  ...
  *((_DWORD *)a1 + 20) &= ~0x800u;
  ...
  if ( a2->Buffer )
  {
    ...
    *((_WORD *)a1 + 36) = (int)RtlStringCchCopyW(&gawchAtomScratch, 0x100uLL, a2->Buffer) < 0
                        ? 0
  ...
  *((_WORD *)a1 + 37) = *((_WORD *)a4 + 8);
  DpiForSystem = GetDpiForSystem(v9, a2);
  *((_DWORD *)a1 + 19) = GetDpiDependentMetric(7LL, DpiForSystem, v13);
  if ( (*((_DWORD *)a1 + 20) & 8) == 0 )
  {
    v14 = *((_QWORD *)_GetCurrentLogicalCursorThread() + 52);
    *((_QWORD *)a4 + 6) = 0LL;
