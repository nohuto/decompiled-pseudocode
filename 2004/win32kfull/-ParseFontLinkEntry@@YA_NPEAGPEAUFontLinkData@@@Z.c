/*
 * XREFs of ?ParseFontLinkEntry@@YA_NPEAGPEAUFontLinkData@@@Z @ 0x1C001248C
 * Callers:
 *     bAddFlEntry @ 0x1C0011ED4 (bAddFlEntry.c)
 *     bDeleteFlEntry @ 0x1C0298E50 (bDeleteFlEntry.c)
 * Callees:
 *     ?ParseFontScaleFactor@@YA_NPEBGPEAJ@Z @ 0x1C0012F6C (-ParseFontScaleFactor@@YA_NPEBGPEAJ@Z.c)
 */
