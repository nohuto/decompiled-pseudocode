/*
 * XREFs of PostPointerEventMessage @ 0x1C01EF040
 * Callers:
 *     PostDeviceNotification @ 0x1C00F8C00 (PostDeviceNotification.c)
 *     PostPointerDeviceInRangeMessage @ 0x1C01EF000 (PostPointerDeviceInRangeMessage.c)
 *     PostPointerDeviceOutOfRangeMessage @ 0x1C01EF020 (PostPointerDeviceOutOfRangeMessage.c)
 * Callees:
