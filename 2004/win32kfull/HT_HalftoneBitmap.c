/*
 * XREFs of HT_HalftoneBitmap @ 0x1C00D5194
 * Callers:
 *     EngHTBlt @ 0x1C00D4640 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C00D5440 (SanityCheckDimension.c)
 *     AAHalftoneBitmap @ 0x1C00D5470 (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x1C00D6484 (pDCIAdjClr.c)
 *     CheckABInfo @ 0x1C02620CC (CheckABInfo.c)
 */
