/*
 * XREFs of ?GetElement@?$CList@VCPhysicalMonitorHandle@@@OPM@@QEAAJKPEAPEAVCPhysicalMonitorHandle@@@Z @ 0x1C0272A6C
 * Callers:
 *     MonitorAPIProcessTerminating @ 0x1C0104600 (MonitorAPIProcessTerminating.c)
