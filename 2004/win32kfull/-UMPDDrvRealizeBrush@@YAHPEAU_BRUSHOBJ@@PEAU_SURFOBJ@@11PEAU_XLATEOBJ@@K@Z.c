/*
 * XREFs of ?UMPDDrvRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z @ 0x1C02AC670
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    if ( !(unsigned int)UMPDOBJ::ThunkDDIOBJ(v11, (UMPDOBJ *)((char *)v11 + 144), (const void **)&v35[6], 0x18u, 0LL)
      || !(unsigned int)UMPDOBJ::pso(v11, (UMPDOBJ *)((char *)v11 + 64), (struct _SURFOBJ **)&v35[3])
      || !(unsigned int)UMPDOBJ::pso(v11, (UMPDOBJ *)((char *)v11 + 80), (struct _SURFOBJ **)&v35[4])
      || !(unsigned int)UMPDOBJ::pso(v11, (UMPDOBJ *)((char *)v11 + 96), (struct _SURFOBJ **)&v35[5])
      || !(unsigned int)UMPDOBJ::pxlo(v11, (struct _XLATEOBJ **)&v35[7])
      || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v11, v35, 0x48u, &v17, Size) == -1)
      || (v14 = 1, !v17) )
    {
      v14 = 0;
    }
