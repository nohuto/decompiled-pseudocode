/*
 * XREFs of ?CompareDeviceVIDPID@@YAHU_UNICODE_STRING@@PEAU_KEY_VALUE_FULL_INFORMATION@@K@Z @ 0x1C02215E8
 * Callers:
 *     ?IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z @ 0x1C0116DDC (-IsDeviceOnRegistryList@@YAHU_UNICODE_STRING@@0H@Z.c)
 * Callees:
 *     <none>
 */
