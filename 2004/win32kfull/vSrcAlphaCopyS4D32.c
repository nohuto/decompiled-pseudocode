/*
 * XREFs of vSrcAlphaCopyS4D32 @ 0x1C0279D20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
  ...
  if ( a8 )
  {
    ...
    do
    {
      ...
      if ( v11 )
      {
        ...
        if ( (result & 0xF) != 0 )
        {
          result = dword_1C02F9550[result & 0xF];
          *v10 = result;
        }
        v17 = v15 + 1;
      }
      if ( (int)v13 > 0 )
      {
        ...
        do
        {
          ...
          if ( (*v17 & 0xF0) != 0 )
          {
            result = dword_1C02F9550[(unsigned __int64)(unsigned __int8)*v17 >> 4];
            *v18 = result;
          }
          v18 += 2;
          if ( (v20 & 0xF) != 0 )
          {
            result = dword_1C02F9550[v22 & 0xF];
            *v21 = result;
          }
          ++v17;
          --v19;
      ...
      if ( a6 != (a6 & 0xFFFFFFFE) )
      {
        ...
        if ( (result & 0xF0) != 0 )
        {
          result = dword_1C02F9550[result >> 4];
          *v18 = result;
        }
      }
      v15 += v8;
