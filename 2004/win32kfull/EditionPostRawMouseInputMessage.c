/*
 * XREFs of EditionPostRawMouseInputMessage @ 0x1C0039980
 * Callers:
 ...
 *     ??$?0UtagObjLock@@U0@U0@U0@U0@U0@U0@U0@U0@U0@U0@@?$CMultiPerObjectLockExclusive@$0L@@@QEAA@AEAUtagObjLock@@0000000000@Z @ 0x1C0005710 (--$-0UtagObjLock@@U0@U0@U0@U0@U0@U0@U0@U0@U0@U0@@-$CMultiPerObjectLockExclusive@$0L@@@QEAA@AEAUt.c)
        ...
        __int64 a5)
{
  ...
  if ( v9 )
  {
    if ( *(_DWORD *)(v9 + 92) == 2 )
      ...
      v37 = 0LL;
    v12 = (__int64 *)(*(_QWORD *)(v37 + 16) + 424LL);
  }
  else
  {
    if ( gptiForeground )
  ...
  v15 = 0LL;
  if ( v13 )
    v15 = *(_QWORD *)(*(_QWORD *)(PtiMouseFromQ(v13, v6) + 416) + 832LL);
  v16 = v13;
  if ( v15 && (*(_DWORD *)(v15 + 100) & 1) != 0 )
  {
      ...
      && (qword_1C0330B48 & 0x40) == qword_1C0330B48 )
    {
      ...
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<8>,_tlgWrapperByVal<4>>(
        ...
        (unsigned int)&unk_1C02EFBB6,
        v7,
        v8,
        (__int64)&v43,
        (__int64)&v41);
    }
    v33 = *(_QWORD *)(*(_QWORD *)(PtiMouseFromQ(v13, v6) + 416) + 832LL);
    v34 = *(_QWORD *)(v33 + 64);
    if ( v34 )
    {
      v35 = *(_QWORD *)(v34 + 16);
  ...
  if ( gHidCounters[1] )
  {
    ...
    if ( v16 )
    {
      v43 = *(struct tagWND **)(PtiMouseFromQ(v16, v17) + 416);
      v42 = *(_QWORD *)(v16 + 428);
    }
    if ( v18 != v17 )
    {
        ...
        if ( (*((_DWORD *)v18 + 25) & 4) != 0 )
        {
          ...
          if ( v19 )
          {
            ...
            if ( *(char *)(v20 + 20) >= 0 && *(char *)(v20 + 19) >= 0 )
            {
              ...
              {
                if ( (unsigned __int8)CheckAccess(*(_QWORD *)(*(_QWORD *)(v28 + 16) + 416LL) + 880LL, &v42)
                  || (v38 = *(_QWORD *)(v18[8] + 16), *(int *)(*(_QWORD *)(v38 + 416) + 12LL) < 0) )
                {
                  if ( *(struct tagWND **)(*(_QWORD *)(v18[8] + 16) + 416LL) != v43
                    && ((*((_DWORD *)v18 + 25) & 8) == 0 || v39) )
                  {
                    ...
                    *(_QWORD *)(v29 + 72) = *(_QWORD *)(a5 + 16);
                    ...
                    if ( (unsigned int)PostInputMessage(
                                         *(struct tagQ **)(*((_QWORD *)v27 + 2) + 424LL),
                                         v27,
                                         0xFFu,
                                         *v32,
                                         a3,
