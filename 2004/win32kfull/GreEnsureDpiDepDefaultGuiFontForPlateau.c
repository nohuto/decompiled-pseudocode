/*
 * XREFs of GreEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C0294050
 * Callers:
 *     NtGdiEnsureDpiDepDefaultGuiFontForPlateau @ 0x1C02AED30 (NtGdiEnsureDpiDepDefaultGuiFontForPlateau.c)
 * Callees:
