/*
 * XREFs of EditionUnloadCursorsAndIcons @ 0x1C01219F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EditionUnloadCursorsAndIcons(__int64 a1)
{
  ...
  v1 = (__int64 *)&unk_1C0330D18;
  v2 = 7LL;
  v3 = (char *)&unk_1C0330D18;
  do
  {
    if ( *v1 )
    {
  ...
  {
    result = gasyscur[0];
    v9 = *(_QWORD *)(v5 + gasyscur[0] + 8);
    if ( v9 )
    {
      *(_QWORD *)(v9 + 24) = PsGetCurrentProcessWin32Process(a1);
      result = HMAssignmentUnlock(&gasyscur[v6 + 1]);
    }
    v6 += 69LL;
    v5 += 552LL;
    --v7;
