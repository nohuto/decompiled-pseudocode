/*
 * XREFs of xxxMetricsRecalc @ 0x1C01D8204
 * Callers:
...
struct tagBWL *__fastcall xxxMetricsRecalc(char a1, int a2, int a3, int a4, int a5, int a6, int a7)
{
  ...
  v40 = 0LL;
  v8 = gptiCurrent;
  result = BuildHwndList(*(struct tagWND **)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 456LL) + 24LL) + 112LL), 3, 0LL);
  v38 = result;
  v10 = result;
  if ( !result )
    return result;
  ...
  do
  {
    ...
    if ( !v13
      ...
      || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 416LL) + 820LL) & 0x30) == 0x10 )
    {
      goto LABEL_47;
    }
    *(_QWORD *)&v40 = *(_QWORD *)(v8 + 408);
    *(_QWORD *)(v8 + 408) = &v40;
    *((_QWORD *)&v40 + 1) = v14;
    HMLockObject(v14);
    v15 = 0;
...
LABEL_36:
    ...
    {
      v20 = *(_QWORD *)(v14 + 16);
      v21 = *(_DWORD *)(v20 + 624) <= 0x9900u ? *(_DWORD *)(v20 + 640) : 0;
      if ( (v21 & 0x30000000) == 0 )
        v22 = 1;
    }
    if ( (a1 & 1) != 0 && ((*(_BYTE *)(v18 + 30) & 4) != 0 || (_DWORD)v22) )
    {
      Prop = (_DWORD *)GetProp(v14, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink), 1LL);
      v24 = *(_QWORD *)v16;
      v19 = Prop;
      v25 = a6;
    ...
    if ( (v7 & 2) != 0 )
    {
      ...
      if ( ((unsigned __int8)v19 & 0x20) == 0 && !v15 )
      {
        ...
        if ( (v27 & 8) != 0
          ...
          && (v36 = *(_QWORD *)(*(_QWORD *)(v14 + 104) + 40LL), (*(_WORD *)(v36 + 42) & 0x3FFF) == 0x2A7) )
        {
          xxxSetWindowPos(
            (struct tagWND *)v14,
            0LL,
