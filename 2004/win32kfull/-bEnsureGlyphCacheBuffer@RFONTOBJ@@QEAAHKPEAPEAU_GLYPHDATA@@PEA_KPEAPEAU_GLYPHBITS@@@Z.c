/*
 * XREFs of ?bEnsureGlyphCacheBuffer@RFONTOBJ@@QEAAHKPEAPEAU_GLYPHDATA@@PEA_KPEAPEAU_GLYPHBITS@@@Z @ 0x1C0089C98
 * Callers:
 ...
 *     ?vFlushCache@RFONTOBJ@@QEAAXXZ @ 0x1C02D5B28 (-vFlushCache@RFONTOBJ@@QEAAXXZ.c)
 */
