/*
 * XREFs of ?vSpUpdateWndobjOverlap@@YAXPEAU_SPRITESTATE@@PEAVEWNDOBJ@@@Z @ 0x1C0285920
 * Callers:
 ...
 *     ?vSpDeviceWndobjChange@@YAXPEAUHDEV__@@PEAVEWNDOBJ@@@Z @ 0x1C0283E50 (-vSpDeviceWndobjChange@@YAXPEAUHDEV__@@PEAVEWNDOBJ@@@Z.c)
 * Callees:
 ...
 *     ?bSpSpriteOnTopOfWndObjInZ@@YAHPEAVSPRITE@@PEAVEWNDOBJ@@@Z @ 0x1C0281BE4 (-bSpSpriteOnTopOfWndObjInZ@@YAHPEAVSPRITE@@PEAVEWNDOBJ@@@Z.c)
 *     ?bSpWndObjTrackedSprite@@YAHPEAVSPRITE@@@Z @ 0x1C02821AC (-bSpWndObjTrackedSprite@@YAHPEAVSPRITE@@@Z.c)
...
LABEL_42:
  ...
  if ( (v8 & 0x200) != 0 )
  {
    ...
    if ( v17[0] && v18[0] && v16[0] )
    {
      ...
      if ( !v21 )
        goto LABEL_36;
      if ( RGNOBJ::bMerge((RGNOBJ *)v17, (struct RGNOBJ *)&v21, (struct RGNOBJ *)&v22, 8u)
...
LABEL_37:
        ...
        if ( RGNOBJ::bMerge((RGNOBJ *)v17, (struct RGNOBJ *)&v20, v13, 0xEu) )
        {
