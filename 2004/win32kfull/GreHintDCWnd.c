/*
 * XREFs of GreHintDCWnd @ 0x1C00E8690
 * Callers:
...
__int64 __fastcall GreHintDCWnd(__int64 a1, __int64 a2, __int64 a3, int a4, int a5)
{
  ...
  int v16; // eax
  __m128 v17; // xmm0
  unsigned __int16 v18[12]; // [rsp+20h] [rbp-18h] BYREF
  ...
  *(_QWORD *)(v8 + 464) = v6;
  ...
  {
    v18[0] = 0;
    if ( v6 && (unsigned int)UserIsWindowGdiScaled(v6, v18) && v18[0] != 96 )
    {
      v17 = (__m128)COERCE_UNSIGNED_INT((float)(unsigned __int16)GreGetScaledLogPixels(v18[0]));
    ...
    else
    {
      ...
      if ( (v16 & 1) != 0 )
      {
        *(_DWORD *)(v9 + 36) |= 0x10u;
        *(_QWORD *)(v9 + 524) = 0LL;
        *(_DWORD *)(v9 + 520) = v16 & 0xFFFFFFF8 | 4;
        *(_QWORD *)(v9 + 532) = 0LL;
  ...
  *(_DWORD *)v18 = 0;
  v12 = *(_QWORD *)v9;
  HmgDecrementShareReferenceCountEx(v9, v18);
  if ( *(_DWORD *)v18 )
