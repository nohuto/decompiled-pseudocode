/*
 * XREFs of ?TabletButtonHandler@@YAXPEAUDEVICEINFO@@@Z @ 0x1C01D96D0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( v5 )
    {
      Usages = HidP_GetUsages(
                 ...
                 *(PCHAR *)(*((_QWORD *)a1 + 58) + 24LL),
                 ReportLength);
      if ( dword_1C03341CC != 10 )
      {
        if ( Usages >= 0 && (v13 = 0LL, UsageLength[0]) )
        {
          while ( v5[v13] - 1 != dword_1C03341CC )
          {
...
LABEL_17:
      ...
      if ( (unsigned int)(*(_DWORD *)v10 + 2147483636) <= 1 )
      {
        ...
        v12 = 0;
LABEL_25:
        gtmridTabletButtonTimer = SetRITTimer(gtmridTabletButtonTimer, v11, (__int64)xxxTabletButtonTimerCallback, v12);
        goto LABEL_34;
      }
