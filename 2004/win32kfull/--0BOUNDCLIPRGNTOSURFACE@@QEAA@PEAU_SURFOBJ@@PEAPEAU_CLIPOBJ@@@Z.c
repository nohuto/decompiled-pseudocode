/*
 * XREFs of ??0BOUNDCLIPRGNTOSURFACE@@QEAA@PEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C013BF90
 * Callers:
 ...
 *     ?bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z @ 0x1C013C058 (-bContain@ERECTL@@QEBAHAEBU_RECTL@@@Z.c)
