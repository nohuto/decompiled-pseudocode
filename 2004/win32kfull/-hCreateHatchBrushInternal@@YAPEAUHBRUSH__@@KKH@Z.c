/*
 * XREFs of ?hCreateHatchBrushInternal@@YAPEAUHBRUSH__@@KKH@Z @ 0x1C02B7710
 * Callers:
 *     GreExtCreatePen @ 0x1C00FEF60 (GreExtCreatePen.c)
 *     NtGdiCreateHatchBrushInternal @ 0x1C02B77D0 (NtGdiCreateHatchBrushInternal.c)
 * Callees:
 *     ??1BRUSHMEMOBJ@@QEAA@XZ @ 0x1C014FE70 (--1BRUSHMEMOBJ@@QEAA@XZ.c)
 */
