/*
 * XREFs of ?Remove@CPointerHashTable@NSInstrumentation@@QEAA_NPEBXPEAPEAX@Z @ 0x1C00E1788
 * Callers:
 *     ?ReleaseKernelmodeAllocation@UmfdAllocation@@SAXPEAX@Z @ 0x1C00E16CC (-ReleaseKernelmodeAllocation@UmfdAllocation@@SAXPEAX@Z.c)
 *     ?_RemoveAllocationFromLookup@UmfdAllocation@@CAXPEAX00@Z @ 0x1C00E22B0 (-_RemoveAllocationFromLookup@UmfdAllocation@@CAXPEAX00@Z.c)
 *     Win32FreeToPagedLookasideListImpl @ 0x1C00EA1A0 (Win32FreeToPagedLookasideListImpl.c)
 *     Win32FreePoolImpl @ 0x1C00EB080 (Win32FreePoolImpl.c)
