/*
 * XREFs of NtGdiAddRemoteMMInstanceToDC @ 0x1C027D940
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0PUBLIC_PFTOBJ@@QEAA@XZ @ 0x1C01599F8 (--0PUBLIC_PFTOBJ@@QEAA@XZ.c)
 ...
 *     ?GreGetBaseUFIBits@@YAHPEAU_UNIVERSAL_FONT_ID@@PEAU_FONTFILEVIEW@@@Z @ 0x1C027C5DC (-GreGetBaseUFIBits@@YAHPEAU_UNIVERSAL_FONT_ID@@PEAU_FONTFILEVIEW@@@Z.c)
 */
