/*
 * XREFs of GreGetAppClipBox @ 0x1C0019498
 * Callers:
...
__int64 __fastcall GreGetAppClipBox(HDC a1, LONG *a2)
{
  ...
  LONG v39; // eax
  LONG v40; // ecx
  _QWORD v41[2]; // [rsp+20h] [rbp-79h] BYREF
  ...
  if ( (v45[24] & 1) != 0 )
  {
    v42 = XDCOBJ::prgnEffRao((XDCOBJ *)v41);
...
LABEL_15:
      if ( v14 )
      {
        if ( (*(_DWORD *)(*(_QWORD *)(v4 + 976) + 108LL) & 1) != 0 )
        {
          v39 = *a2;
          v40 = a2[2];
          if ( *a2 > v40 )
    ...
    if ( v43 )
    {
      ...
      v5 = a2[2];
      v6 = a2[1];
      v7 = (_DWORD *)(v41[0] + 1024LL);
      if ( (*(_DWORD *)(v41[0] + 40LL) & 1) == 0 )
        v7 = (_DWORD *)(v41[0] + 1016LL);
      v8 = *a2 - *v7;
      *a2 = v8;
      v9 = v5 - *v7;
      a2[2] = v9;
      ...
      else
      {
        ...
        v48.y = v10;
        v50 = v10;
        EXFORMOBJ::bXform((EXFORMOBJ *)&v43, &v48, 4uLL);
        v17 = v49;
        v18 = v49;
        x = v48.x;
        v20 = v51;
