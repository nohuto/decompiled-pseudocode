/*
 * XREFs of ?SendDeviceIOControl@SimpleHapticsController@@QEAAJKPEAXK0KPEAK@Z @ 0x1C025BC8C
 * Callers:
 ...
 *     ??0LeaveEnterUserCritIfAcquired@@QEAA@XZ @ 0x1C025AAD8 (--0LeaveEnterUserCritIfAcquired@@QEAA@XZ.c)
 */
