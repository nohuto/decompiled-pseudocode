/*
 * XREFs of ?bSetHTSrcSurfInfo@@YAHPEAU_SURFOBJ@@VXEPALOBJ@@PEAU_HTSURFACEINFO@@PEAU_XLATEOBJ@@@Z @ 0x1C00D4384
 * Callers:
...
LABEL_7:
  ...
  *(_QWORD *)&v19 = a1;
  ...
  if ( v10 <= v9 )
    v9 = v10;
  v11 = AllocThreadBufferWithTag(4 * v9 + 24, 1668573255LL, 0LL);
  v21 = v11;
  v12 = v11;
  if ( !v11 )
  {
