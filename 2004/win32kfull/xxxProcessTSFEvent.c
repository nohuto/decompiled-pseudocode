/*
 * XREFs of xxxProcessTSFEvent @ 0x1C00068E4
 * Callers:
 ...
 * Callees:
 *     ?TSFRangeFromEvent@@YAKKW4TSFLocality@@@Z @ 0x1C00069AC (-TSFRangeFromEvent@@YAKKW4TSFLocality@@@Z.c)
...
void *__fastcall xxxProcessTSFEvent(struct tagNOTIFY *a1)
{
  ...
  *(_QWORD *)a1 = a1;
  ...
  result = &unk_1C033C3E0;
  if ( a1 != (struct tagNOTIFY *)&unk_1C033C3E0 )
