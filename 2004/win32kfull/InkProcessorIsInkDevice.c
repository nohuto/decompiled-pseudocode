/*
 * XREFs of InkProcessorIsInkDevice @ 0x1C00FCF20
 * Callers:
 *     <none>
 * Callees:
 *     ?IsEnabled@InkProcessor@@QEBA_NXZ @ 0x1C00FCFB0 (-IsEnabled@InkProcessor@@QEBA_NXZ.c)
...
__int64 __fastcall InkProcessorIsInkDevice(__int16 a1, __int16 a2, _WORD *a3, _WORD *a4)
{
  ...
  else if ( (unsigned int)dword_1C032B288 > 2 )
  {
    ...
    v12 = &v10;
    v13 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C032B288, (int)&dword_1C02F13FC, 0, 0, 3u, &v11);
  }
  return v5;
}
