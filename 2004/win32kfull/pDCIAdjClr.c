/*
 * XREFs of pDCIAdjClr @ 0x1C00D6484
 * Callers:
 *     HT_CreateStandardMonoPattern @ 0x1C00C9C50 (HT_CreateStandardMonoPattern.c)
 ...
 *     CompareMemory @ 0x1C011DAFC (CompareMemory.c)
 *     __security_check_cookie @ 0x1C0157760 (__security_check_cookie.c)
 *     GenCMYMaskXlate @ 0x1C02635A4 (GenCMYMaskXlate.c)
 *     TintAngle @ 0x1C02637DC (TintAngle.c)
 */
...
__int64 __fastcall pDCIAdjClr(__int64 a1, __m128i *a2, char **a3, unsigned int a4, __int16 a5, int a6, _DWORD *a7)
{
  ...
  if ( a1 && (v11 = a1 + 40, *(_DWORD *)(a1 + 40) == 1414021956) )
  {
    ...
    {
      dwABPreMul = 0;
      v90 = (unsigned int *)&unk_1C0334404;
      for ( i = 1; i < 0x100; ++i )
      {
        v92 = (i - 16777217) / i;
        *v90++ = v92;
      ...
      *a3 = v109;
      ...
      if ( v109 )
      {
        ...
        *(_OWORD *)&v113.m256i_u64[2] = v26;
        ...
        {
          v45 |= 0x10u;
          HIDWORD(v111) = RaisePower(1015000, (unsigned int)(__int16)v125, 2LL);
          LODWORD(v110) = v45;
        }
        if ( WORD1(v125) )
        {
