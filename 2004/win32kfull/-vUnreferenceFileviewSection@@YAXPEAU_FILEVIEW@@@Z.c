/*
 * XREFs of ?vUnreferenceFileviewSection@@YAXPEAU_FILEVIEW@@@Z @ 0x1C0016CE4
 * Callers:
 ...
 *     EngUnmapFile @ 0x1C028ACE0 (EngUnmapFile.c)
 *     bMapFile @ 0x1C028B0A0 (bMapFile.c)
 *     GreMakeFontDir @ 0x1C02BAFCC (GreMakeFontDir.c)
 * Callees:
 *     ZwWin32CreateSection @ 0x1C0016B04 (ZwWin32CreateSection.c)
