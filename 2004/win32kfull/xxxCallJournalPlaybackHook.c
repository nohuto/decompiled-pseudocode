/*
 * XREFs of xxxCallJournalPlaybackHook @ 0x1C01E6EA4
 * Callers:
...
LABEL_41:
    ...
    *((_DWORD *)a1 + 6) = v7;
    ...
    if ( (unsigned int)(v7 - 256) <= 8 )
    {
      ...
      {
        *(_WORD *)(gptiCurrent + 866LL) = HIWORD(v36[1]);
      }
      goto LABEL_37;
    }
    if ( (_DWORD)v7 == 35 )
    {
      if ( !v36[1] || (v3 = HMValidateHandleNoSecure((int)v36[1], 1)) == 0 )
        v3 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 120LL);
      goto LABEL_37;
    }
...
LABEL_37:
  ...
  if ( v3 )
    ...
    v32 = *(_DWORD *)(*(_QWORD *)(PtiKbdFromQ(*(_QWORD *)(gptiCurrent + 424LL)) + 416) + 280LL);
  StoreQMessage(
    a1,
    (struct tagWND *)v3,
    v36[0],
