/*
 * XREFs of ?IsNativeOrientationPortrait@@YAHXZ @ 0x1C0055E1C
 * Callers:
...
__int64 IsNativeOrientationPortrait(void)
{
  ...
  v2[0] = 1;
  v0 = 0;
  if ( (int)((__int64 (__fastcall *)(__int64, int *, _BYTE *, _QWORD))DrvQueryDisplayConfig)(1073741825LL, v2, v4, 0LL) < 0 )
    return 0LL;
