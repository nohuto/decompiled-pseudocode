/*
 * XREFs of ?bCreateSectionFromHandle@@YAHPEAXPEBGPEAU_FILEVIEW@@HPEAHE@Z @ 0x1C00166CC
 * Callers:
 ...
 *     ?TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z @ 0x1C0016C1C (-TryGetFileDeviceRemoteBit@@YAJPEAXPEA_N@Z.c)
