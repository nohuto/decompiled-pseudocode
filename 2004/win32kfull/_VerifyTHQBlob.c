/*
 * XREFs of _VerifyTHQBlob @ 0x1C01D64BC
 * Callers:
 *     ?CoreSignatureVerify@@YAHGGPEAEPEAK@Z @ 0x1C01EC7E8 (-CoreSignatureVerify@@YAHGGPEAEPEAK@Z.c)
 * Callees:
 *     ?_HashTHQAText@@YAHPEAEKPEAPEAEPEAK@Z @ 0x1C01D5880 (-_HashTHQAText@@YAHPEAEKPEAPEAEPEAK@Z.c)
 */
