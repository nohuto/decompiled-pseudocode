/*
 * XREFs of ?ChangeWindowTreeProtection@@YAHPEAUtagWND@@K@Z @ 0x1C0248E20
 * Callers:
 ...
 *     ?Add@?$CDynamicArray@PEAUtagWND@@$0HHHAHDFF@@@QEAAJAEBQEAUtagWND@@@Z @ 0x1C0248DE4 (-Add@-$CDynamicArray@PEAUtagWND@@$0HHHAHDFF@@@QEAAJAEBQEAUtagWND@@@Z.c)
...
__int64 __fastcall ChangeWindowTreeProtection(struct tagWND *a1, unsigned int a2)
{
  ...
  if ( v5 )
  {
    ...
    if ( (int)CDynamicArray<tagWND *,2003858261>::Add((__int64)&v18, &v21) >= 0 )
    {
      ...
      v7 = 0LL;
      v8 = *(_QWORD *)(v6 + 416);
      if ( a1 == *(struct tagWND **)(v6 + 1384) )
      {
        v9 = *(_QWORD *)(v6 + 1392);
        if ( v9 )
          v7 = *(_QWORD *)(*(_QWORD *)(v9 + 16) + 416LL);
      }
      for ( i = (unsigned __int64 *)((char *)v5 + 32); *i != 1; ++i )
      {
        ...
        {
          v12 = *(_QWORD *)(*(_QWORD *)(v11 + 16) + 416LL);
