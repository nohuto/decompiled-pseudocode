/*
 * XREFs of ?InitSwitchWndInfo@@YAPEAUtagWND@@PEAPEAUtagSwitchWndInfo@@PEAU1@H@Z @ 0x1C01F35D0
 * Callers:
...
LABEL_9:
  ...
  *(_DWORD *)(v14 + 44) = v12;
  ...
  v19 = EngMulDiv(11, *(unsigned __int16 *)(*(_QWORD *)(gptiCurrent + 416LL) + 284LL), 96);
  v20 = v48;
