/*
 * XREFs of ?MiPIdleTimerFunc@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01E10D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MiPIdleTimerFunc(struct tagWND *a1, __int64 a2, __int64 a3)
{
  ...
  if ( v3 )
  {
    ...
    if ( v6 )
    {
      ...
      {
        *(_DWORD *)(*(_QWORD *)(v3 + 1272) + 32LL) = GetNextFrameId();
        *(_DWORD *)(*(_QWORD *)(v3 + 1272) + 88LL) = (MEMORY[0xFFFFF78000000320]
                                                    * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
        *(_DWORD *)(*(_QWORD *)(v3 + 1272) + 112LL) = 0;
        *(LARGE_INTEGER *)(*(_QWORD *)(v3 + 1272) + 104LL) = KeQueryPerformanceCounter(0LL);
        v7 = *(_QWORD *)(v3 + 1272);
        v8 = *(_DWORD *)(v7 + 36);
        if ( (v8 & 0x10000) != 0 )
        {
          *(_DWORD *)(v7 + 36) = v8 & 0xFFFEFFFF;
          *(_DWORD *)(*(_QWORD *)(v3 + 1272) + 36LL) |= 0x20000u;
          v7 = *(_QWORD *)(v3 + 1272);
        }
