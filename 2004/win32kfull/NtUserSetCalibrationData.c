/*
 * XREFs of NtUserSetCalibrationData @ 0x1C0202230
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetCalibrationData(unsigned __int64 a1, unsigned int a2, volatile void *a3, int a4)
{
  ...
  __int64 v23; // rcx
  __int64 v24; // r8
  _DWORD v26[2]; // [rsp+20h] [rbp-38h] BYREF
  ...
  if ( a4 == 3 )
  {
    if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 416LL) + 880LL, v26) )
      goto LABEL_10;
  }
  else if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 416LL) + 880LL, &v29) )
  {
LABEL_10:
