/*
 * XREFs of ?pSpCreateSprite@@YAPEAVSPRITE@@PEAUHDEV__@@PEAU_RECTL@@PEAUHWND__@@PEAU_POINTL@@@Z @ 0x1C004C7B8
 * Callers:
 ...
 *     ?vSpRenumberZOrder@@YAXPEAU_SPRITESTATE@@@Z @ 0x1C005039C (-vSpRenumberZOrder@@YAXPEAU_SPRITESTATE@@@Z.c)
