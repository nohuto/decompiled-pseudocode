/*
 * XREFs of ?bHobbyize@WIDEPENOBJ@@AEAAHQEAVEVECTORFX@@@Z @ 0x1C0134288
 * Callers:
...
__int64 __fastcall WIDEPENOBJ::bHobbyize(WIDEPENOBJ *this, struct EVECTORFX *const a2)
{
  ...
  else if ( v3 >= 5184 )
  {
    if ( v3 < 7744 )
    {
      v4 = (struct _POINTFIX **)&off_1C032BA70;
      v5 = (unsigned int *)&unk_1C032BA78;
    }
    else
    {
      v4 = (struct _POINTFIX **)&off_1C032BA80;
      v5 = (unsigned int *)&unk_1C032BA88;
    }
  }
  else
  {
