/*
 * XREFs of ?LoadModuleWorkHorse@@YAPEAXPEAGH@Z @ 0x1C0289F8C
 * Callers:
 *     EngLoadModule @ 0x1C028ABA0 (EngLoadModule.c)
 *     EngLoadModuleForWrite @ 0x1C028ABC0 (EngLoadModuleForWrite.c)
 * Callees:
 *     PALLOCMEM2 @ 0x1C00D8F8C (PALLOCMEM2.c)
 *     ?StringCchCopyW@@YAJPEAG_KPEBG@Z @ 0x1C00DAAB4 (-StringCchCopyW@@YAJPEAG_KPEBG@Z.c)
 *     ?GetModuleHandleAndIncrementRefcount@@YAPEAXPEBG@Z @ 0x1C0289EC4 (-GetModuleHandleAndIncrementRefcount@@YAPEAXPEBG@Z.c)
