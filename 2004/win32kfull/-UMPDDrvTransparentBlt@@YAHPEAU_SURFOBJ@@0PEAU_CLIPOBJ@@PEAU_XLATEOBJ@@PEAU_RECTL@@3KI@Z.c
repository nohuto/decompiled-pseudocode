/*
 * XREFs of ?UMPDDrvTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KI@Z @ 0x1C02AD0D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    v34[4] = v11;
    v34[6] = a4;
    if ( !(unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 64), (struct _SURFOBJ **)&v34[3])
      || !(unsigned int)UMPDOBJ::pso(v14, (UMPDOBJ *)((char *)v14 + 80), (struct _SURFOBJ **)&v34[4])
