/*
 * XREFs of SetWindowCompositionExcludeFromLivePreview @ 0x1C011EA1C
 * Callers:
...
__int64 __fastcall SetWindowCompositionExcludeFromLivePreview(__int64 *a1, __int128 *a2, __int64 a3)
{
  bool v4; // zf
  int v6; // edi
  unsigned int v7; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 5) == v6 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFFEF | (16 * v6);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v9, *a1, 13, a2);
    }
  }
  return v7;
}
