/*
 * XREFs of LockDesktopMenu @ 0x1C011EFC8
 * Callers:
...
__int64 __fastcall LockDesktopMenu(__int64 a1, _QWORD **a2)
{
    ...
    && *(_QWORD *)(*(_QWORD *)(**a2 + 88LL) + 16LL) )
  {
    *(_DWORD *)(*(_QWORD *)(**a2 + 40LL) + 40LL) |= 0x40u;
    v5 = a2[2];
    v6 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 448LL) + 40LL) + 56LL) + 16LL);
    if ( !v5 )
      v5 = (_QWORD *)**a2;
    HMChangeOwnerProcess(v5, v6);
    SmartObjStackRefBase<tagMENU>::operator=(v11, *(_QWORD *)(*(_QWORD *)(**a2 + 88LL) + 16LL));
