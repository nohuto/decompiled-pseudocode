/*
 * XREFs of ?bExtraRectsToPath@ESTROBJ@@QEAAHAEAVEPATHOBJ@@@Z @ 0x1C02BDAE0
 * Callers:
 ...
 *     ??0CFixPred@Prediction@@QEAA@XZ @ 0x1C012C900 (--0CFixPred@Prediction@@QEAA@XZ.c)
 *     ?bLinkedGlyphs@ESTROBJ@@QEBAHXZ @ 0x1C0299050 (-bLinkedGlyphs@ESTROBJ@@QEBAHXZ.c)
 *     ?cGetGlyphData@RFONTOBJ@@QEAAKKPEAU_GLYPHPOS@@@Z @ 0x1C02A7EB4 (-cGetGlyphData@RFONTOBJ@@QEAAKKPEAU_GLYPHPOS@@@Z.c)
 *     ?GetLinkedRfontOnIndex@ESTROBJ@@QEAAPEAVRFONT@@JAEAVRFONTOBJ@@@Z @ 0x1C02BD858 (-GetLinkedRfontOnIndex@ESTROBJ@@QEAAPEAVRFONT@@JAEAVRFONTOBJ@@@Z.c)
