/*
 * XREFs of ?DdcciGetCapabilitiesStringLength@CMonitorAPI@@QEAAJPEAXPEAK@Z @ 0x1C027213C
 * Callers:
 *     NtGdiDDCCIGetCapabilitiesStringLength @ 0x1C0272E60 (NtGdiDDCCIGetCapabilitiesStringLength.c)
 * Callees:
...
__int64 __fastcall CMonitorAPI::DdcciGetCapabilitiesStringLength(CMonitorAPI *this, void *a2, unsigned int *a3)
{
  ...
  v8 = this;
  v3 = (char *)qword_1C033B048;
  OPM::CAutoMutex::CAutoMutex((OPM::CAutoMutex *)&v9, (struct OPM::CMutex *)qword_1C033B048);
  v8 = 0LL;
