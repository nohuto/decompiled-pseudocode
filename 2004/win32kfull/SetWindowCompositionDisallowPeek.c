/*
 * XREFs of SetWindowCompositionDisallowPeek @ 0x1C0214CE8
 * Callers:
...
__int64 __fastcall SetWindowCompositionDisallowPeek(__int64 *a1, __int128 *a2, __int64 a3)
{
  bool v4; // zf
  int v6; // edi
  unsigned int v7; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 10) == v6 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFDFF | (v6 << 9);
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v9, *a1, 16, a2);
    }
  }
  return v7;
}
