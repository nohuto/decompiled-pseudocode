/*
 * XREFs of MagSlicerControl @ 0x1C01CE994
 * Callers:
...
__int64 __fastcall MagSlicerControl(_QWORD *a1, __int64 a2, __int64 a3, int a4, _DWORD *a5, unsigned int a6)
{
  ...
  if ( v12 )
  {
    ...
    v21 = (void *)ReferenceDwmApiPort(**(_QWORD **)(*(_QWORD *)(*(_QWORD *)(v17 + 16) + 448LL) + 8LL));
  ...
  if ( v26 )
  {
    v27 = (void *)ReferenceDwmApiPort(**(_QWORD **)(*(_QWORD *)(*(_QWORD *)(v25 + 16) + 448LL) + 8LL));
