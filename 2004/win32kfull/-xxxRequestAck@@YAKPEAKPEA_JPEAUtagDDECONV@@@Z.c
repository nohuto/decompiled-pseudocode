/*
 * XREFs of ?xxxRequestAck@@YAKPEAKPEA_JPEAUtagDDECONV@@@Z @ 0x1C021CF70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GiveObject@@YAHIPEAXK@Z @ 0x1C021B78C (-GiveObject@@YAHIPEAXK@Z.c)
 *     ?IsObjectPublic@@YAPEAUtagPUBOBJ@@PEAX@Z @ 0x1C021B7E0 (-IsObjectPublic@@YAPEAUtagPUBOBJ@@PEAX@Z.c)
