/*
 * XREFs of ?BltLnk@@YAHPEAVSURFACE@@00PEAVECLIPOBJ@@PEAVXLATE@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C00CF2B0
 * Callers:
...
LABEL_31:
  ...
  while ( 1 )
  {
    ...
    if ( !v34 )
      break;
LABEL_100:
    v34 = XCLIPOBJ::bEnum(v32, 0x144u, (char *)v101, 0LL);
    v73 = v34;
  }
LABEL_54:
