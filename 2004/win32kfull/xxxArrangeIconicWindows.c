/*
 * XREFs of xxxArrangeIconicWindows @ 0x1C01505E0
 * Callers:
 *     <none>
 * Callees:
...
struct tagBWL *__fastcall xxxArrangeIconicWindows(__int64 a1)
{
  ...
  unsigned __int64 v62; // [rsp+50h] [rbp-49h]
  int v63; // [rsp+58h] [rbp-41h]
  int v64; // [rsp+5Ch] [rbp-3Dh]
  int v65; // [rsp+60h] [rbp-39h]
  int v66; // [rsp+64h] [rbp-35h]
  int v67; // [rsp+68h] [rbp-31h]
  unsigned __int64 *v68; // [rsp+70h] [rbp-29h]
  __int64 v69; // [rsp+78h] [rbp-21h]
  unsigned __int64 *v70; // [rsp+78h] [rbp-21h]
  __int128 v71; // [rsp+80h] [rbp-19h] BYREF
  struct tagBWL *v72; // [rsp+90h] [rbp-9h]
  __int128 v73; // [rsp+98h] [rbp-1h] BYREF
  __int64 v74; // [rsp+A8h] [rbp+Fh]
  unsigned __int16 v75; // [rsp+100h] [rbp+67h]
  int v76; // [rsp+108h] [rbp+6Fh]
  int v77; // [rsp+110h] [rbp+77h]
  ...
  if ( !result )
    return result;
  v64 = IsTrayWindow(*(_QWORD **)(a1 + 112));
  v5 = *(_DWORD *)(gpsi + 2084LL);
  v6 = *(_DWORD *)(gpsi + 2088LL);
  InternalGetRealClientRect(a1, (__int64)&v71, 1, 0LL, 1);
  v69 = HMValidateHandleNoSecure(ghwndSwitch, 1);
  v68 = (unsigned __int64 *)((char *)v4 + 32);
...
LABEL_9:
  ...
  do
  {
    ...
    if ( v11 == v69 )
      goto LABEL_6;
    Prop = GetProp(v11, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink), 1LL);
    if ( !Prop )
      goto LABEL_6;
    v15 = *(_DWORD *)(Prop + 48);
    v16 = (_DWORD *)(Prop + 32);
...
LABEL_7:
  ...
  {
    v65 = v71 + *(_DWORD *)(gpsi + 2084LL) - *(_DWORD *)(gpsi + 2124LL);
    v22 = v65;
    LODWORD(v62) = v65;
    v77 = v5;
  }
  ...
  {
    v78 = v6;
    v66 = DWORD1(v71) + *(_DWORD *)(gpsi + 2088LL) - *(_DWORD *)(gpsi + 2128LL);
    v23 = v66;
    HIDWORD(v62) = v66;
  }
  else
  ...
  if ( *v68 != 1 )
  {
    while ( 2 )
    {
      if ( v28 )
      {
        ...
        v70 = (unsigned __int64 *)v29;
        if ( v29 )
        {
          v30 = v26;
          v31 = 0;
          v32 = *(_QWORD *)(GetProp(v29, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink), 1LL) + 32);
          *(_QWORD *)&v71 = v32;
          if ( v26 < v27 )
          {
            v33 = DWORD1(v71);
...
LABEL_90:
            ...
            v35 = *(_QWORD *)(GetProp(v34, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink), 1LL) + 32);
...
LABEL_103:
  ...
  if ( *v68 != 1 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( !v51 )
        goto LABEL_114;
      v52 = GetProp(v51, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink), 1LL);
      if ( v52 )
      {
        *(_DWORD *)(v52 + 48) |= 0x20u;
        *(_QWORD *)(v52 + 32) = v62;
...
LABEL_114:
  ...
  v13 = v75;
  v53 = (struct tagSMWP *)InternalBeginDeferWindowPos(2 * (unsigned int)v75);
  if ( v53 )
  {
    while ( 1 )
    {
      ...
      if ( v61 )
      {
        v54 = HMValidateHandleNoSecure(v61, 1);
        v55 = (_QWORD *)v54;
        if ( v54 )
        {
          v56 = GetProp(v54, WORD2(WPP_MAIN_CB.DeviceQueue.DeviceListHead.Blink), 1LL);
          ThreadWin32Thread = W32GetThreadWin32Thread((__int64)KeGetCurrentThread());
          *(_QWORD *)&v73 = *(_QWORD *)(ThreadWin32Thread + 408);
