/*
 * XREFs of FreeWindowGCData @ 0x1C008CEBC
 * Callers:
...
__int64 __fastcall FreeWindowGCData(struct tagWND *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v4 = *((_QWORD *)a1 + 2);
  v11 = 0LL;
  result = VWPLRemoveBase((struct tagVWPL **)(*(_QWORD *)(v4 + 416) + 872LL), a2, a1, a4, (unsigned __int64 *)&v11);
  if ( (_DWORD)result )
  {
    ...
    if ( v11 )
    {
      ...
      Win32FreePool(v7);
      return VWPLRemoveBase((struct tagVWPL **)(*(_QWORD *)(*((_QWORD *)a1 + 2) + 416LL) + 872LL), v9, a1, v10, 0LL);
    }
  }
  return result;
}
