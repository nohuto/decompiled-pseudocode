/*
 * XREFs of NtUserEnableMouseInputForCursorSuppression @ 0x1C004A6A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
    TransitionCursorSuppressionState(v8);
    goto LABEL_5;
  }
...
LABEL_4:
  if ( !a1 )
  {
    v9 = PsGetCurrentProcessWin32Process(v5);
    v8 = 1LL;
...
LABEL_5:
  v4 = 1LL;
LABEL_6:
  UserSessionSwitchLeaveCrit(v5, v2, v3);
  return v4;
}
