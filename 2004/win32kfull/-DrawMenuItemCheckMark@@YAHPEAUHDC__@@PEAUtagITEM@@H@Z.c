/*
 * XREFs of ?DrawMenuItemCheckMark@@YAHPEAUHDC__@@PEAUtagITEM@@H@Z @ 0x1C024CA20
 * Callers:
    ...
    if ( v16 )
    {
      ...
      if ( (unsigned int)GreExtGetObjectW(v15, 104LL, (char *)v24) == 104 && HIWORD(v24[11]) == 32 && !v24[12] )
      {
        ...
        if ( !v17 )
          v18 = 0x80;
        BYTE1(v21) = v18;
        NtGdiAlphaBlend(a1, v2, v13, v10[3], v10[3], *(HDC *)ghdcMem2, 0, 0, v10[2], v10[3], v21);
      }
      else
      {
        NtGdiBitBltInternal(a1, v2, v13, v10[2], v10[3], *(HDC *)ghdcMem2, 0, 0, 12060490, 0xFFFFFF, 0);
      }
