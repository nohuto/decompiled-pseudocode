/*
 * XREFs of InitializeClientPfnArrays @ 0x1C0125D64
 * Callers:
 *     NtUserInitializeClientPfnArrays @ 0x1C0125C70 (NtUserInitializeClientPfnArrays.c)
 * Callees:
 *     <none>
 */
...
__int64 __fastcall InitializeClientPfnArrays(__int128 *a1, _OWORD *a2, __int64 a3, __int64 a4)
{
  ...
  if ( PsGetCurrentProcess(a1, a2, a3) == gpepCSRSS )
  {
    ...
    *((_QWORD *)&WPP_MAIN_CB.Reserved + 1) = *(_QWORD *)(gpsi + 648LL);
    ...
    qword_1C0339EC0 = *(_QWORD *)(gpsi + 688LL);
    qword_1C0339EC8 = *(_QWORD *)(gpsi + 656LL);
    qword_1C0339F18 = 1LL;
    qword_1C0339F28 = 3LL;
    qword_1C0339F30 = 2LL;
    qword_1C0339F40 = 5LL;
