/*
 * XREFs of ?ProcessRangeInCache@@YAXPEAUtagMOUSE_PROMOTION_CACHE@@PEAUtagMOUSE_PROMOTION_ENTRY@@1HHH@Z @ 0x1C0219708
 * Callers:
 ...
 * Callees:
 *     ?AppendMousePromotionQueue@@YAXAEAUtagMOUSE_PROMOTION_QUEUE@@PEAUtagMOUSE_PROMOTION_ENTRY@@1@Z @ 0x1C0218F44 (-AppendMousePromotionQueue@@YAXAEAUtagMOUSE_PROMOTION_QUEUE@@PEAUtagMOUSE_PROMOTION_ENTRY@@1@Z.c)
 ...
 *     ?ResetPendingPromotion@@YAXXZ @ 0x1C0219BC8 (-ResetPendingPromotion@@YAXXZ.c)
 */
        ...
        int a6)
{
  ...
  *(_OWORD *)v15 = 0LL;
  ...
  if ( v11 )
    AppendMousePromotionQueue((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C033AB30, v11, v10);
}
