/*
 * XREFs of ?ProcessInkFeedbackCommand@InkDevice@@EEAAJW4INK_FEEDBACK_COMMAND@@PEBXI@Z @ 0x1C0256D30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsSuperWetInkStartDataSupported@@YA_NW4InkFeedbackCapabilities@@PEBUIFC_SUPERWET_INK_START_DATA@@@Z @ 0x1C0254DAC (-IsSuperWetInkStartDataSupported@@YA_NW4InkFeedbackCapabilities@@PEBUIFC_SUPERWET_INK_START_DATA.c)
...
__int64 __fastcall InkDevice::ProcessInkFeedbackCommand(__int64 a1, int a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_BYTE *)(a1 - 20) )
  {
    ...
    if ( a2 == 1 )
    {
      ...
      v14 = (unsigned int)dword_1C032B288;
