/*
 * XREFs of InternalInvalidate3 @ 0x1C0073974
 * Callers:
...
LABEL_24:
      if ( (a3 & 0x404) != 0 )
      {
        ...
        {
          if ( (*(_BYTE *)(v28 + 19) & 0x18) == 0 && *((_QWORD *)a1 + 13) == GetDesktopWindow((__int64)a1) )
          {
...
LABEL_40:
            if ( !v57 )
            {
              ...
              if ( *(_QWORD *)(v39 + 136) || (*(_BYTE *)(v39 + 17) & 0x10) != 0 )
              {
                ...
                {
                  v41 = *(_DWORD *)(v40 + 592);
                  *(_DWORD *)(v40 + 592) = v41 + 1;
                  if ( !v41 )
                  {
                    EtwTraceWakePump(v40, a1, 15LL);
                    if ( (*(_DWORD *)(v40 + 480) & 1) == 0 )
                    {
                      *(_WORD *)(*(_QWORD *)(v40 + 440) + 6LL) |= 0x20u;
                      *(_WORD *)(*(_QWORD *)(v40 + 440) + 4LL) |= 0x20u;
                      if ( (*(_BYTE *)(*(_QWORD *)(v40 + 440) + 10LL) & 0x20) != 0 )
                        KeSetEvent(*(PRKEVENT *)(v40 + 728), 2, 0);
                    }
                  }
                }
              }
...
LABEL_76:
    if ( *(_QWORD *)(*((_QWORD *)a1 + 5) + 136LL) == 1LL )
    {
      *(_QWORD *)(*((_QWORD *)a1 + 5) + 136LL) = CreateEmptyRgnPublic();
      ...
      if ( !(unsigned int)CalcWindowRgn(a1, v46, (v44 >> 3) & 1) )
        goto LABEL_52;
    }
