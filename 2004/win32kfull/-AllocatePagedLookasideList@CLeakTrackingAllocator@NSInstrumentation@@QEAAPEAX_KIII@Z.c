/*
 * XREFs of ?AllocatePagedLookasideList@CLeakTrackingAllocator@NSInstrumentation@@QEAAPEAX_KIII@Z @ 0x1C011D8D4
 * Callers:
 *     Win32AllocPagedLookasideListImpl @ 0x1C011D8B0 (Win32AllocPagedLookasideListImpl.c)
