/*
 * XREFs of ?GetDeviceFeatures@InkDeviceParser@@SAJPEAU_HIDP_PREPARSED_DATA@@PEBXKPEBUUsageValueInfo@@PEAVFeatures@InkDevice@@@Z @ 0x1C0251014
 * Callers:
        ...
        struct InkDevice::Features *a5)
{
  ...
  else if ( (unsigned int)dword_1C032B288 > 2 )
  {
    ...
    v17 = 4;
    v16 = &v10;
    tlgWriteTransfer_EtwWriteTransfer((__int64)&dword_1C032B288, (unsigned __int8 *)dword_1C02F13FC, 0LL, 0LL, 3u, &v15);
  }
  return v7;
}
