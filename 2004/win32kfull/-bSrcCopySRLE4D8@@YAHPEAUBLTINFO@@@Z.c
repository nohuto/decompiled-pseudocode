/*
 * XREFs of ?bSrcCopySRLE4D8@@YAHPEAUBLTINFO@@@Z @ 0x1C02CE800
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall bSrcCopySRLE4D8(struct BLTINFO *a1)
{
  ...
  unsigned int v49; // [rsp+88h] [rbp+20h]
...
LABEL_51:
  ...
  if ( (_DWORD)v16 )
  {
    ...
    else
    {
      ...
      if ( v7 >= v42 || v8 >= v3 || (int)v16 + v8 <= (int)v6 )
      {
        v8 += v16;
      ...
      else
      {
        ...
        {
          v28 = v8++;
          *(_BYTE *)(v28 + v5) = *(_BYTE *)(v45 + 4 * ((unsigned __int64)*v4 >> 4));
