/*
 * XREFs of ?MulTransparentBlt@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3KK@Z @ 0x1C02A5BB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_51:
      ...
      if ( v23 != v13 )
      {
        ...
        NearestIndexFromColorref = ulGetNearestIndexFromColorref(v39, ppalDefault, v40);
        v23 = psoSrc;
