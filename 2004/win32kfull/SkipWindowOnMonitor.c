/*
 * XREFs of SkipWindowOnMonitor @ 0x1C00F6014
 * Callers:
 ...
 *     _lambda_dc07bf9eeab06415d9a9c521953e95b1_::_lambda_invoker_cdecl_ @ 0x1C00F6090 (_lambda_dc07bf9eeab06415d9a9c521953e95b1_--_lambda_invoker_cdecl_.c)
 * Callees:
...
__int64 __fastcall SkipWindowOnMonitor(__int64 a1)
{
  ...
  {
    v3 = (__int64 *)(v1 + 312);
    v4 = _MonitorFromWindowInternal((struct tagWND *)a1, 0LL, 0);
    for ( i = *(__int64 **)(v1 + 312); i != v3; i = (__int64 *)*i )
    {
      if ( *((_DWORD *)i + 6) && _MonitorFromWindowInternal((struct tagWND *)i[2], 0LL, 0) == v4 )
        return 1;
    }
  }
  return v2;
