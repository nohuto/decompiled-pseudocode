/*
 * XREFs of ?bSrcCopySRLE8D4@@YAHPEAUBLTINFO@@@Z @ 0x1C02CCB80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall bSrcCopySRLE8D4(struct BLTINFO *a1)
{
  ...
  unsigned int v44; // [rsp+Ch] [rbp-5Ch]
  int v45; // [rsp+10h] [rbp-58h]
  int v46; // [rsp+14h] [rbp-54h]
  __int64 v47; // [rsp+18h] [rbp-50h]
    ...
    while ( 1 )
    {
      ...
      if ( v18 )
      {
        if ( v5 < v6 && v8 < v7 && (int)(v18 + v8) > v11 )
        {
          ...
          v39 = *(_DWORD *)(v47 + 4 * v20);
          if ( (v8 & 1) != 0 )
          {
            ++v8;
            *(_BYTE *)(v15 + v3) = v16 ^ (v16 ^ v39) & 0xF;
        ...
        if ( (_DWORD)v20 )
        {
          if ( (_DWORD)v20 == 1 )
          {
            if ( v5 < v6 )
            {
              ...
              {
                *(_BYTE *)(v49 + v3) = v16 ^ (*(_BYTE *)(v49 + v3) ^ v16) & 0xF;
              }
            }
            return 0LL;
          }
          if ( (_DWORD)v20 != 2 )
          {
            ...
            if ( v21 > v51 )
              return 0LL;
            v22 = v20 & 1;
            if ( v5 >= v50 || v8 >= v7 || (int)v20 + v8 <= v11 )
            {
              v30 = &v2[v20];
              v8 += v20;
            }
            else
            {
              ...
              if ( v26 )
              {
                do
                {
                  ...
                  v29 = *v28;
                  v2 = v28 + 1;
                  v16 = (16 * *(_BYTE *)(v47 + 4 * v27)) | *(_BYTE *)(v47 + 4 * v29) & 0xF;
                  *(_BYTE *)(v15 + v3) = v16;
                  v15 = (unsigned int)(v15 + 1);
                  --v26;
                }
              ...
              if ( (v25 & 1) != 0 )
                v16 = v16 & 0xF | (16 * *(_BYTE *)(v47 + 4LL * *v2++));
              v30 = &v2[v18];
              v8 = v18 + v25;
            }
            v17 = v22 + v21;
          ...
          if ( (v7 & 1) != 0 && v8 >= v7 )
          {
            v31 = (unsigned int)(v7 - 1) >> 1;
            v16 ^= (*(_BYTE *)(v49 + v3) ^ v16) & 0xF;
            *(_BYTE *)(v49 + v3) = v16;
          }
          else
          {
