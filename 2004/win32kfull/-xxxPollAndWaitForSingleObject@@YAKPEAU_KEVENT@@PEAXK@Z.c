/*
 * XREFs of ?xxxPollAndWaitForSingleObject@@YAKPEAU_KEVENT@@PEAXK@Z @ 0x1C01220F4
 * Callers:
  ...
  *(_WORD *)(*(_QWORD *)(gptiCurrent + 440LL) + 10LL) = 64;
  ...
  do
  {
    ...
    **(_QWORD **)(gptiCurrent + 872LL) = Object;
    v9 = *(_QWORD *)(gptiCurrent + 872LL);
    *(_QWORD *)(v9 + 8) = *(_QWORD *)(gptiCurrent + 1408LL);
    *(_QWORD *)(*(_QWORD *)(gptiCurrent + 872LL) + 16LL) = a2;
    ...
    UserSessionSwitchLeaveCrit(v9, 0LL, 0xFFFFF78000000320uLL);
