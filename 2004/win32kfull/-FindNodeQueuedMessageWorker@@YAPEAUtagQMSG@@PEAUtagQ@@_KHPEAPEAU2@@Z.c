/*
 * XREFs of ?FindNodeQueuedMessageWorker@@YAPEAUtagQMSG@@PEAUtagQ@@_KHPEAPEAU2@@Z @ 0x1C020975C
 * Callers:
 *     EditionFindNodeQueuedMessage @ 0x1C02098B0 (EditionFindNodeQueuedMessage.c)
 * Callees:
