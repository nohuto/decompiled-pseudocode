/*
 * XREFs of ?xxxReadPostMessage@@YAHPEAUtagTHREADINFO@@PEAUtagMSG@@PEAUtagWND@@IIPEAU_QMSG_POSTCHAR_FLAGS@@H@Z @ 0x1C0095EB0
 * Callers:
        ...
        unsigned int a7)
{
  ...
  {
    v11 = (char *)a1 + 800;
    QMsg = FindQMsg(a1, (char *)a1 + 800, a3);
    v13 = QMsg;
    if ( !QMsg )
    {
...
LABEL_42:
    ...
    *((_DWORD *)a1 + 140) = *(_DWORD *)(v13 + 48);
    v15 = *(_QWORD *)((char *)a1 + 756);
    if ( v15 != *(_QWORD *)(v13 + 52) )
      *v9 |= 0x100000u;
    *((_DWORD *)a1 + 189) = *(_DWORD *)(v13 + 52);
    *((_DWORD *)a1 + 190) = *(_DWORD *)(v13 + 56);
    v16 = *(_QWORD *)(v13 + 16);
...
LABEL_15:
        ...
        *((_DWORD *)a1 + 191) = v26;
        *((_QWORD *)a1 + 96) = *(_QWORD *)(v13 + 80);
        *((_QWORD *)a1 + 71) = v13;
        *(_QWORD *)(*((_QWORD *)a1 + 53) + 408LL) = *(_QWORD *)(v13 + 72);
        *((_QWORD *)a1 + 154) = *(_QWORD *)(v13 + 120);
        ...
        *((_OWORD *)a2 + 2) = *(_OWORD *)(v13 + 48);
        ...
        if ( v14 )
        {
          v27 = (unsigned __int64 *)*((_QWORD *)a1 + 59);
          v28 = *v27;
...
LABEL_53:
  ...
  *((_DWORD *)a2 + 8) = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  ...
  v40 = *(_QWORD *)(v39 + 16);
LABEL_68:
  *(_QWORD *)((char *)a2 + 36) = LogicalCursorPosFromDpiAwarenessContext(*(unsigned int *)(*(_QWORD *)(v40 + 416) + 280LL));
