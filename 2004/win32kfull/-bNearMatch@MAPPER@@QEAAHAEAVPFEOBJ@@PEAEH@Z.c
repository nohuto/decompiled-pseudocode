/*
 * XREFs of ?bNearMatch@MAPPER@@QEAAHAEAVPFEOBJ@@PEAEH@Z @ 0x1C009E620
 * Callers:
 ...
 *     ?bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z @ 0x1C00A16FC (-bNoMatch@MAPPER@@QEBAHPEAVPFE@@@Z.c)
 ...
 *     ?bCalcOrientation@MAPPER@@QEAAHXZ @ 0x1C00FB920 (-bCalcOrientation@MAPPER@@QEAAHXZ.c)
...
LABEL_31:
  if ( v120 )
  {
    ...
    v117 = 0;
    if ( (unsigned int)PFEOBJ::bCheckFamilyName((PFEOBJ *)a2, v101, 0, (unsigned int *)&v117) )
    {
      if ( v117 )
        ++*((_DWORD *)this + 46);
    }
