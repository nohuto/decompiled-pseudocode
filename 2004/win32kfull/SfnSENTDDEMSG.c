/*
 * XREFs of SfnSENTDDEMSG @ 0x1C0230C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfnSENTDDEMSG(__int64 *a1, int a2, __int64 a3, __int64 a4, __int64 a5, __int64 a6, char a7)
{
  ...
  *(_QWORD *)(v16 + 72) = v13;
  if ( a1 )
    ...
    v17 = 0LL;
  *(_QWORD *)(*(_QWORD *)(v12 + 472) + 64LL) = v17;
  if ( a1 )
    v18 = *(_QWORD *)(a1[5] + 224);
  else
    v18 = 0LL;
  *(_QWORD *)(*(_QWORD *)(v12 + 472) + 80LL) = v18;
  if ( v14 >= 0 )
  {
    v31 = v13;
    v32 = v14;
  ...
  else
  {
    ...
    *((_QWORD *)&v29 + 1) = a4;
    ...
    v31 = _HMObjectFromHandle(v28) - *(_QWORD *)(v12 + 464);
    v32 = DWORD2(v28);
    v34 = v29;
  }
  v35 = a5;
