/*
 * XREFs of GetInheritedMonitor @ 0x1C006AB48
 * Callers:
    ...
    *(_QWORD *)&v59 = v14;
    while ( 1 )
    {
      ...
      do
      {
        if ( v14 )
        {
          ...
          if ( (*(_BYTE *)(v17 + 31) & 0x10) != 0
            ...
            && (*(_QWORD *)(v27 + 424) == *(_QWORD *)(v28 + 424) || *(_QWORD *)(v27 + 416) == *(_QWORD *)(v28 + 416)) )
          {
            v30 = *(_DWORD *)(v17 + 288);
            v31 = *(_DWORD *)(v16 + 288);
      ...
      if ( !v19
        ...
        && !IsRectEmptyInl((const struct tagRECT *)(v17 + 104))
        && ((*(_BYTE *)(v17 + 26) & 8) == 0 || (*(_BYTE *)(v17 + 27) & 0x20) != 0)
        && (*(_QWORD *)(v20 + 424) == *(_QWORD *)(v21 + 424) || *(_QWORD *)(v20 + 416) == *(_QWORD *)(v21 + 416)) )
      {
        v23 = *(_DWORD *)(v17 + 288);
        v24 = *(_DWORD *)(v18 + 288);
...
LABEL_42:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v13 + 16) + 416LL) != *(_QWORD *)(*((_QWORD *)a1 + 2) + 416LL)
