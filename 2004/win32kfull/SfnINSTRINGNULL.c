/*
 * XREFs of SfnINSTRINGNULL @ 0x1C0044240
 * Callers:
...
__int64 __fastcall SfnINSTRINGNULL(__int64 *a1, unsigned int a2, __int64 a3, int *a4, __int64 a5, __int64 a6, char a7)
{
  ...
  *(_QWORD *)&v40 = a3;
  ...
  if ( v13 )
  {
    v9 = (unsigned __int8 *)AllocCallbackMessage(0x58u, v13, (unsigned int)v14, v50, 1, 0x200uLL);
    v37 = v9;
    if ( !v9 )
      return 0LL;
  }
  ...
  if ( v13 )
  {
    ...
    else
    {
      if ( (a7 & 1) == 0 )
      {
        v31 = v29 + 2;
LABEL_40:
        v32 = CaptureCallbackData((struct _CAPTUREBUF *)v9, v30, v31, v28);
        goto LABEL_41;
      }
...
LABEL_13:
  ...
  *((_QWORD *)v9 + 2) = 0LL;
  v20 = KeUserModeCallback(27LL, v9, *(unsigned int *)v9, &v39, &v36);
