/*
 * XREFs of ?GeneratePointerMessageFromMouse@@YAHPEAUtagQMSG@@I0PEAUtagWND@@H@Z @ 0x1C01E0A4C
 * Callers:
        ...
        int a5)
{
  ...
  v9 = *(_DWORD **)(gptiCurrent + 1272LL);
  if ( !v9 )
  {
    v9 = (_DWORD *)Win32AllocPoolZInit(384LL, 1347253077LL);
    if ( !v9 )
      goto LABEL_29;
    *(_QWORD *)(gptiCurrent + 1272LL) = v9;
  }
  if ( a5 && (*v9 & 0x10) != 0 )
  {
    *v9 &= ~0x10u;
    **(_DWORD **)(gptiCurrent + 1272LL) &= ~4u;
  }
  if ( (unsigned int)IsMiPMouseMessage(*((unsigned int *)a3 + 6)) )
  {
    ...
    *(_QWORD *)&v23[5] = *((_QWORD *)a3 + 16);
    ...
    if ( HIDWORD(v23[0]) )
    {
      if ( (**(_DWORD **)(gptiCurrent + 1272LL) & 4) == 0 )
      {
      ...
      **(_DWORD **)(gptiCurrent + 1272LL) |= 1u;
      if ( a5 )
      {
        if ( ((*v12 - 579) & 0xFFFFFFFB) == 0 )
        {
          v19 = *(_DWORD **)(gptiCurrent + 1272LL);
          if ( (*v19 & 4) != 0 )
          {
            *v19 |= 0x10u;
            **(_DWORD **)(gptiCurrent + 1272LL) &= ~2u;
          }
        }
      }
      v20 = *v12;
      ...
      {
        *(_QWORD *)(*(_QWORD *)(gptiCurrent + 1272LL) + 376LL) = *((_QWORD *)a1 + 5);
