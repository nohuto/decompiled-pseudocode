/*
 * XREFs of bMoveDevPreviewRect @ 0x1C028696C
 * Callers:
...
__int64 __fastcall bMoveDevPreviewRect(HDEV a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  unsigned int v7; // ebx
  int v9; // r15d
  __int64 v10; // r8
  ...
  v9 = a3 & 1;
  v26 = 0LL;
  SEMOBJSHARED::SEMOBJSHARED((SEMOBJSHARED *)v25, ghsemDynamicModeChange, a3, a4);
  v24 = ghsemGreLock;
