/*
 * XREFs of ?PackAffectedThreadList@@YAXPEBUtagTHREADINFO@@0@Z @ 0x1C0038F30
 * Callers:
 *     zzzReattachThreads @ 0x1C0038514 (zzzReattachThreads.c)
 *     PackAffectedThreadsFromThreadCleanup @ 0x1C0039060 (PackAffectedThreadsFromThreadCleanup.c)
 * Callees:
...
void __fastcall PackAffectedThreadList(const struct tagTHREADINFO *a1, struct _LIST_ENTRY **a2)
{
  ...
  for ( i = *p_Blink; i != (struct _LIST_ENTRY *)p_Blink; i = i->Flink )
  {
      ...
      && !InAffectedThreadList((const struct tagTHREADINFO *)&i[-46]) )
    {
      ...
      v9[1].Flink = v7;
      v10 = off_1C032B238;
      if ( off_1C032B238->Flink != &gListAffectedThreadsForQueueRecalc )
        __fastfail(3u);
