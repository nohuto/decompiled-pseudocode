/*
 * XREFs of ?xxxMS_TrackMove@@YAXPEAUtagWND@@W4_WM_VALUE@@_K_JPEAU_MOVESIZEDATA@@@Z @ 0x1C020F978
 * Callers:
 ...
 *     ?UpdateMoveSizeDataForCancelation@@YAXPEAU_MOVESIZEDATA@@@Z @ 0x1C020D23C (-UpdateMoveSizeDataForCancelation@@YAXPEAU_MOVESIZEDATA@@@Z.c)
...
LABEL_17:
        ...
        {
          v17 = *((_DWORD *)a5 + 45) == 0;
          *((_DWORD *)a5 + 46) = dword_1C02F5764[a3];
LABEL_27:
          if ( !v17 )
          {
            v20 = *((_DWORD *)a5 + 49);
    ...
    {
      v17 = *((_DWORD *)a5 + 46) == 0;
      *((_DWORD *)a5 + 45) = dword_1C02F5764[a3];
      goto LABEL_27;
    }
...
LABEL_36:
    ...
    if ( (_DWORD)v26 )
    {
      v27 = v15 + *((_WORD *)a5 + 2 * dword_1C02F57C8[v26] + 20);
      LOWORD(v93) = v27;
      LODWORD(v24) = v93;
    }
    else
    ...
    if ( (_DWORD)v28 )
    {
      WORD1(v93) = v14 + *((_WORD *)a5 + 2 * dword_1C02F5798[v28] + 20);
      LODWORD(v24) = v93;
    }
    if ( v23 != 9 )
    {
...
LABEL_71:
  ...
  if ( (v40 & 0x10) != 0 )
  {
    ...
    *(_DWORD *)(gptiCurrent + 480LL) = v40 & 0xFFFFFFEF;
  }
LABEL_76:
