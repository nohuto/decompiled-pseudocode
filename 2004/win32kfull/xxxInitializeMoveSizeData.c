/*
 * XREFs of xxxInitializeMoveSizeData @ 0x1C021285C
 * Callers:
 ...
 *     ?AreDockTargetsActive@@YAEPEAU_MOVESIZEDATA@@@Z @ 0x1C020B19C (-AreDockTargetsActive@@YAEPEAU_MOVESIZEDATA@@@Z.c)
...
LABEL_100:
  ...
  *((_DWORD *)v7 + 45) = dword_1C02F5768[a3];
  *((_DWORD *)v7 + 46) = dword_1C02F5738[a3];
  v67 = dword_1C02F57C8[a3];
  if ( v67 != -1 )
    *((_DWORD *)v7 + 42) = *((_DWORD *)v7 + (__int16)v67 + 30) - v21;
  v68 = dword_1C02F5798[a3];
  if ( v68 != -1 )
