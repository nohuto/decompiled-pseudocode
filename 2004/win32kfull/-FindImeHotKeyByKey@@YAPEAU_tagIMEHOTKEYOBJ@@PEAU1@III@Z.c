/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C0101A80
 * Callers:
 *     CheckImeHotKey @ 0x1C010181C (CheckImeHotKey.c)
 * Callees:
 *     GetActiveHKL @ 0x1C0101B38 (GetActiveHKL.c)
 *     ?GetHotKeyLangID@@YAGK@Z @ 0x1C010D54C (-GetHotKeyLangID@@YAGK@Z.c)
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C021E370 (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
