/*
 * XREFs of ?ppfeGetPFEFromUFIInternal@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z @ 0x1C0141C80
 * Callers:
 ...
 *     ?ppfeGetPFEFromUFI@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z @ 0x1C027CEF4 (-ppfeGetPFEFromUFI@@YAPEAVPFE@@PEAU_UNIVERSAL_FONT_ID@@HH@Z.c)
 * Callees:
 ...
 *     ?SameProccess@PFEOBJ@@QEAAHXZ @ 0x1C0141D7C (-SameProccess@PFEOBJ@@QEAAHXZ.c)
 */
