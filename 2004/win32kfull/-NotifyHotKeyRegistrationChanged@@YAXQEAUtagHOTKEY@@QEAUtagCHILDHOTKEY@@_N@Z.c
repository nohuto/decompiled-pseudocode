/*
 * XREFs of ?NotifyHotKeyRegistrationChanged@@YAXQEAUtagHOTKEY@@QEAUtagCHILDHOTKEY@@_N@Z @ 0x1C003DA4C
 * Callers:
 ...
 *     ?HKRemoveHotkeyOrMakePlaceholder@@YA_NPEAPEAUtagHOTKEY@@@Z @ 0x1C003D968 (-HKRemoveHotkeyOrMakePlaceholder@@YA_NPEAPEAUtagHOTKEY@@@Z.c)
 ...
 *     _lambda_ee96b6502effcc67d9cd908cd78240cc_::_lambda_invoker_cdecl_ @ 0x1C012BF30 (_lambda_ee96b6502effcc67d9cd908cd78240cc_--_lambda_invoker_cdecl_.c)
  ...
  if ( !*((_QWORD *)a1 + 1) )
  {
    ...
    if ( (unsigned __int64)(v6 - 2) <= 0xFFFFFFFFFFFFFFFBuLL || !v6 )
    {
      ...
      if ( (v7 & 0x9C00) == 0 )
      {
        ...
        v10[1] = *(_DWORD *)(*(_QWORD *)(v8 + 416) + 56LL);
        if ( v8 )
