/*
 * XREFs of ?xxxHideGhostWindow@@YAXPEAUtagWND@@0@Z @ 0x1C0004124
 * Callers:
...
void __fastcall xxxHideGhostWindow(struct tagWND *a1, struct tagWND *a2)
{
  ...
  v5 = 49185;
  v51 = 0;
  v50 = *(_DWORD *)(gptiCurrent + 480LL) & 1;
  ...
  if ( !(unsigned int)IsWindowBeingDestroyed(a1) )
  {
    ...
    if ( v57 )
    {
      ...
      PostEventMessageEx(v57, *((struct tagQ **)v57 + 53), 8u, 0LL, 0, *(_QWORD *)a1, 0LL, 0LL);
    }
  }
...
LABEL_41:
  ...
  if ( (unsigned int)IsWindowBeingDestroyed(v3) )
  {
    ...
    if ( (*(_BYTE *)(*(_QWORD *)v14 + 25LL) & 8) != 0 )
      PostIAMShellHookMessageEx(*(_QWORD *)(gptiCurrent + 448LL), 18LL, *(_QWORD *)v3);
  }
  else
  {
      ...
      else
      {
        ...
        if ( v22 )
        {
          ...
          else if ( (*(_BYTE *)(*(_QWORD *)(v22 + 40) + 24LL) & 8) == 0 || (*(_BYTE *)(*(_QWORD *)v14 + 24LL) & 8) != 0 )
          {
            ...
            *(_QWORD *)&v61 = *(_QWORD *)(ThreadWin32Thread + 408);
      ...
      if ( v55 )
      {
        ...
        if ( v24 )
        {
                               ...
                               (__int64)&v49) )
          {
            ...
            if ( v31 )
              v32 = (__int128 *)(v31 + 384);
            v33 = *((_QWORD *)v59 + 12);
            v34 = (__int128 *)gObjDummyLock;
            if ( v33 )
              v34 = (__int128 *)(v33 + 384);
            v3 = v52;
