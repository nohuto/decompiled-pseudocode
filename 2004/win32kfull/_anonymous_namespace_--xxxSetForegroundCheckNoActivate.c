/*
 * XREFs of _anonymous_namespace_::xxxSetForegroundCheckNoActivate @ 0x1C01D2F50
 * Callers:
 *     EditionSetForegroundCheckNoActivate @ 0x1C01D3150 (EditionSetForegroundCheckNoActivate.c)
 * Callees:
...
bool __fastcall anonymous_namespace_::xxxSetForegroundCheckNoActivate(struct tagWND *a1)
{
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)&v11 = *(_QWORD *)(ThreadWin32Thread + 408);
