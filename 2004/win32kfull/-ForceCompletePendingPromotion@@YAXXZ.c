/*
 * XREFs of ?ForceCompletePendingPromotion@@YAXXZ @ 0x1C02193F4
 * Callers:
...
void ForceCompletePendingPromotion(void)
{
  ...
  v3 = 0LL;
  v0 = word_1C033AB90;
  v2 = ((dword_1C033ABA0 != 0) + 16842753) | (dword_1C033ABA4 != 0 ? 0x2000000 : 0);
  if ( !ValidatePointerPromotion(word_1C033AB90, dword_1C033AB94, &v2, &v4, &v3) )
    goto LABEL_5;
  v1 = v3;
  if ( v3 )
  {
