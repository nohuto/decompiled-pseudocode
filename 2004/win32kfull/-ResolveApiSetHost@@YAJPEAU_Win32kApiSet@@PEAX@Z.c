/*
 * XREFs of ?ResolveApiSetHost@@YAJPEAU_Win32kApiSet@@PEAX@Z @ 0x1C011CF00
 * Callers:
 *     InitializeWin32kCall @ 0x1C011CE50 (InitializeWin32kCall.c)
 * Callees:
 *     ?ResolveApiSetFunction@@YAJPEAU_Win32kApiSetFunction@@PEAD1HPEAX@Z @ 0x1C011CFD4 (-ResolveApiSetFunction@@YAJPEAU_Win32kApiSetFunction@@PEAD1HPEAX@Z.c)
 ...
 *     ApiSetResolveToHost @ 0x1C011D21C (ApiSetResolveToHost.c)
 */
