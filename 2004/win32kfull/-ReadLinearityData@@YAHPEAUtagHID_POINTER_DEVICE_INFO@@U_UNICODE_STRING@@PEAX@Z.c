/*
 * XREFs of ?ReadLinearityData@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@U_UNICODE_STRING@@PEAX@Z @ 0x1C01CF178
 * Callers:
 ...
 *     ?GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C01CEDD8 (-GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
