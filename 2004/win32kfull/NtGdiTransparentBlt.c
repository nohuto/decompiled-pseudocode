/*
 * XREFs of NtGdiTransparentBlt @ 0x1C0148ED0
 * Callers:
 ...
 *     ?bRotationOrMirroring@EXFORMOBJ@@QEBAHXZ @ 0x1C0149564 (-bRotationOrMirroring@EXFORMOBJ@@QEBAHXZ.c)
        ...
        unsigned int a11)
{
  ...
  _BYTE v92[192]; // [rsp+120h] [rbp+20h] BYREF
  __int128 v93; // [rsp+1E0h] [rbp+E0h] BYREF
  RECTL prcl; // [rsp+1F0h] [rbp+F0h] BYREF
  RECTL v95; // [rsp+200h] [rbp+100h] BYREF
  _BYTE v96[4]; // [rsp+210h] [rbp+110h] BYREF
  RECTL v97; // [rsp+214h] [rbp+114h] BYREF
  __int64 v98; // [rsp+260h] [rbp+160h]
  int v99; // [rsp+268h] [rbp+168h]
  int v100; // [rsp+290h] [rbp+190h]
  __int64 v101; // [rsp+2A0h] [rbp+1A0h]
  struct _POINTFIX v102; // [rsp+2B0h] [rbp+1B0h] BYREF
  FIX v103; // [rsp+2B8h] [rbp+1B8h]
  int v104; // [rsp+2BCh] [rbp+1BCh]
  int v105; // [rsp+2C0h] [rbp+1C0h]
  FIX v106; // [rsp+2C4h] [rbp+1C4h]
  FIX v107; // [rsp+2C8h] [rbp+1C8h]
  int v108; // [rsp+2CCh] [rbp+1CCh]
  __int128 v109; // [rsp+2D0h] [rbp+1D0h] BYREF
  unsigned int v110; // [rsp+2E0h] [rbp+1E0h]
  int v111; // [rsp+2E4h] [rbp+1E4h]
  POINTFIX pptfx; // [rsp+2F0h] [rbp+1F0h] BYREF
  POINTFIX v113; // [rsp+2F8h] [rbp+1F8h]
  POINTFIX v114; // [rsp+300h] [rbp+200h]
...
LABEL_29:
      ...
      else
      {
        ...
        NearestIndexFromColorref = ulGetNearestIndexFromColorref(v27, v28, a11);
