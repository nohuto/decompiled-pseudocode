/*
 * XREFs of ?xxxMNPositionHierarchy@@YAIAEBV?$SmartObjStackRef@UtagPOPUPMENU@@@@PEAUtagITEM@@HHPEAH2PEAPEAUtagMONITOR@@@Z @ 0x1C0236D04
 * Callers:
...
__int64 __fastcall xxxMNPositionHierarchy(__int64 **a1, __int64 *a2, int a3, int a4, int *a5, LONG *a6, __int64 a7)
{
  ...
  if ( v11 )
  {
    ...
    v31 = _MonitorFromWindowInternal(*(struct tagWND **)(**a1 + 16), 1LL, 0);
    v32 = *a1;
    v33 = (__int64)v31;
    v42 = (__int64)v31;
