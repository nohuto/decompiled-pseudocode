/*
 * XREFs of xxxMNChar @ 0x1C0238274
 * Callers:
...
_QWORD *__fastcall xxxMNChar(__int64 **a1, __int64 a2, unsigned int a3)
{
  ...
  if ( (*(_DWORD *)**a1 & 0x8000) == 0 )
  {
    ...
    *(_QWORD *)&v43 = *(_QWORD *)(ThreadWin32Thread + 408);
...
LABEL_58:
    ...
    {
      if ( !*(_QWORD *)(**a1 + 8)
        || (v26 = **a1, v27 = gptiCurrent, *(_QWORD *)(gptiCurrent + 1384LL) != *(_QWORD *)(v26 + 8)) )
      {
        xxxMessageBeep(0LL);
      }
      if ( (v28 & 0x10) != 0 )
