/*
 * XREFs of vInitFontsDirectoryNameInformation @ 0x1C00C2F50
 * Callers:
 *     <none>
 * Callees:
 *     ?bAppendSysDirectory@@YAHPEAGPEBGI@Z @ 0x1C0012250 (-bAppendSysDirectory@@YAHPEAGPEBGI@Z.c)
 *     ?QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z @ 0x1C0016A64 (-QueryNameStringFromHandle@@YAJPEAXPEAU_OBJECT_NAME_INFORMATION@@KD@Z.c)
...
int vInitFontsDirectoryNameInformation()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (int)v0 >= 0 )
  {
    ...
    if ( v4 )
    {
      if ( (unsigned int)bAppendSysDirectory(v4, &word_1C02E3EA4) )
      {
        v5 = -1LL;
        do
          ++v5;
