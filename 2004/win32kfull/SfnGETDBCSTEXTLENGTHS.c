/*
 * XREFs of SfnGETDBCSTEXTLENGTHS @ 0x1C0047690
 * Callers:
 *     <none>
 * Callees:
...
LABEL_62:
  ...
  *(_QWORD *)&v54 = v30;
  ...
  v76 = 0LL;
  if ( v30 != v79 && v30 != v80 )
    PushW32ThreadLock((__int64)v30, &v75, (__int64)Win32FreePool);
  *((_QWORD *)v30 + 5) = v51;
  *((_DWORD *)v30 + 12) = a2 - 1;
  v31 = v52;
  if ( a2 != 14 )
  ...
  *((_QWORD *)&v64 + 1) = a1;
  ...
  v67 = *(_QWORD *)(v33 + 80);
  *(_QWORD *)(v33 + 72) = v51;
  *(_QWORD *)(*(_QWORD *)(v27 + 472) + 64LL) = *a1;
  *(_QWORD *)(*(_QWORD *)(v27 + 472) + 80LL) = *(_QWORD *)(a1[5] + 224LL);
  if ( gdwInAtomicOperation && (gdwExtraInstrumentations & 1) != 0 )
    KeBugCheckEx(0x160u, gdwInAtomicOperation, 0LL, 0LL, 0LL);
