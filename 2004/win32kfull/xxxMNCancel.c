/*
 * XREFs of xxxMNCancel @ 0x1C0237E64
 * Callers:
...
__int64 *__fastcall xxxMNCancel(__int64 a1, unsigned int a2, unsigned int a3, struct _LARGE_STRING *a4)
{
  ...
  **(_DWORD **)v35[0] |= 0x8000u;
      ...
      *((_QWORD *)&v38 + 1) = v13;
      ...
      if ( v7 )
      {
        ...
        if ( *(_QWORD *)(*(_QWORD *)v35[0] + 16LL) )
          xxxDestroyWindow(*(__int64 **)(*(_QWORD *)v35[0] + 16LL));
      }
      if ( v13 )
      {
  ...
  result = *(__int64 **)(v24 + 1464);
  if ( result )
  {
    result = (__int64 *)*result;
    *(_QWORD *)(v24 + 1464) = result;
  }
  return result;
}
