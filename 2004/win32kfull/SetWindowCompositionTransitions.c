/*
 * XREFs of SetWindowCompositionTransitions @ 0x1C0215018
 * Callers:
...
__int64 __fastcall SetWindowCompositionTransitions(__int64 *a1, __int128 *a2, __int64 a3)
{
  bool v4; // zf
  int v6; // edi
  unsigned int v7; // ebx
  ...
  {
    if ( -__CFSHR__(v11[0], 7) == v6 )
      return 0;
    LODWORD(v11[0]) = v11[0] & 0xFFFFFFBF | (v6 << 6);
