/*
 * XREFs of ?MsgSQMFlushMsgRecord@@YAXPEAUtagPROCESSINFO@@0PEAUtagMSGSQM_MSGRECORD@@@Z @ 0x1C021E604
 * Callers:
 *     MSGSQMAddMessage @ 0x1C0037AE8 (MSGSQMAddMessage.c)
 *     ?MsgSQMFreeMsgList@@YAXPEAUtagPROCESSINFO@@0PEAPEAUtagMSGSQM_MSGRECORD@@@Z @ 0x1C021E714 (-MsgSQMFreeMsgList@@YAXPEAUtagPROCESSINFO@@0PEAPEAUtagMSGSQM_MSGRECORD@@@Z.c)
 * Callees:
        ...
        struct tagMSGSQM_MSGRECORD *a3)
{
  ...
  v3 = (const struct tagMSGSQM_PROCESSSQMINFO *)*((_QWORD *)a1 + 108);
  v5 = (const struct tagMSGSQM_PROCESSSQMINFO *)*((_QWORD *)a2 + 108);
  v6 = 0;
  if ( v3 || v5 )
  {
    v7 = *((_DWORD *)a3 + 6);
