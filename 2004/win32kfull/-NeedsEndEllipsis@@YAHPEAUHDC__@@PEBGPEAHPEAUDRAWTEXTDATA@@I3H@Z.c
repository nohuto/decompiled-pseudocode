/*
 * XREFs of ?NeedsEndEllipsis@@YAHPEAUHDC__@@PEBGPEAHPEAUDRAWTEXTDATA@@I3H@Z @ 0x1C025FAE0
 * Callers:
 ...
 *     ?DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z @ 0x1C025F49C (-DT_AdjustBreakForSurrogatesAndVariationSelectors@@YAHPEBGHH@Z.c)
        ...
        struct DRAWTEXTDATA *a6)
{
  ...
  if ( (int)DT_GetExtentMinusPrefixes(a1, a2, v6, a5, v17, a6, -1) <= v11
    || !(unsigned int)GreGetTextExtentW(a1, L"...", 3u, &v19, 1u) )
  {
    return 0LL;
  }
  v13 = v12 - v19.cx + v11;
