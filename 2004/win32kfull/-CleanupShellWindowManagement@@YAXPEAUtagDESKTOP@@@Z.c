/*
 * XREFs of ?CleanupShellWindowManagement@@YAXPEAUtagDESKTOP@@@Z @ 0x1C00BF55C
 * Callers:
 ...
 *     ?Cleanup@CWindowGroupManager@@QEAAXW4CleanupType@1@@Z @ 0x1C0240E94 (-Cleanup@CWindowGroupManager@@QEAAXW4CleanupType@1@@Z.c)
 */
