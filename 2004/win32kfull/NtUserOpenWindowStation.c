/*
 * XREFs of NtUserOpenWindowStation @ 0x1C00C4110
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?RtlStringCbPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C01F73EC (-RtlStringCbPrintfW@@YAJPEAG_KPEBGZZ.c)
 */
...
__int64 __fastcall NtUserOpenWindowStation(unsigned __int64 a1, unsigned int a2)
{
  ...
  *(_OWORD *)DestinationString = v5[1];
  ...
  v9 = (ULONG64)DestinationString[0];
  ...
  *(struct _UNICODE_STRING *)Address = *DestinationString[0];
    ...
    if ( Address[1] )
    {
      ...
      if ( LODWORD(Address[0]) == 3801144 )
      {
        ...
        if ( !_wcsicmp((const wchar_t *)Address[1], L"Service-0x00000000-00000000$") )
        {
          ...
          {
            RtlStringCbPrintfW((wchar_t *)Address[1], 0x3AuLL, L"Service-0x%x-%x$", HIDWORD(v17), v17);
  ...
  UserSessionSwitchLeaveCrit(v10, v9, v7);
  return v4;
}
