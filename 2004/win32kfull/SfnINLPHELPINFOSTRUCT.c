/*
 * XREFs of SfnINLPHELPINFOSTRUCT @ 0x1C022BDF0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( result )
  {
    ...
    *(_QWORD *)(v16 + 72) = v12;
    if ( a1 )
      ...
      v17 = 0LL;
    *(_QWORD *)(*(_QWORD *)(v11 + 472) + 64LL) = v17;
    if ( a1 )
      v18 = *(_QWORD *)(a1[5] + 224);
    else
      v18 = 0LL;
    *(_QWORD *)(*(_QWORD *)(v11 + 472) + 80LL) = v18;
    ...
    *((_QWORD *)v14 + 2) = 0LL;
    v19 = KeUserModeCallback(13LL, v14, *(unsigned int *)v14, &v30, v28);
