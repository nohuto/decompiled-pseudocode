/*
 * XREFs of ?CreateFadeInternal@@YAPEAUHDC__@@PEAUtagWND@@PEAUtagRECT@@KKK@Z @ 0x1C01E7568
 * Callers:
...
HDC __fastcall CreateFadeInternal(struct tagWND *a1, struct tagRECT *a2, int a3, int a4, unsigned int a5)
{
  ...
  if ( a1 )
  {
    ...
    if ( W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) )
    {
      ...
      {
        if ( (*(_DWORD *)(**(_QWORD **)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 448) + 8LL)
                        + 64LL) & 1) != 0 )
        {
          v18 = *((_QWORD *)a1 + 5);
          v19 = *(_DWORD *)(v18 + 288);
