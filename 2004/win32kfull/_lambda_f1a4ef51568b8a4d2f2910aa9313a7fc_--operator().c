/*
 * XREFs of _lambda_f1a4ef51568b8a4d2f2910aa9313a7fc_::operator() @ 0x1C01592A4
 * Callers:
...
__int64 __fastcall lambda_f1a4ef51568b8a4d2f2910aa9313a7fc_::operator()(__int64 a1, __int64 a2, __int64 a3)
{
  __int64 result; // rax
  __int64 v5; // rbx
  __int64 v6; // rcx
  ...
  if ( result )
  {
    ...
    *(_QWORD *)(*(_QWORD *)(v5 + 40) + 48LL) = 0LL;
    ...
    DereferenceClass(*(struct tagPROCESSINFO **)(**(_QWORD **)(a1 + 24) + 416LL), v5);
