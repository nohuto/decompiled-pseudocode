/*
 * XREFs of Win32kRIMDevChangeCallback @ 0x1C0122730
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsPublicPointerDevice @ 0x1C01EEF94 (IsPublicPointerDevice.c)
 *     UpdatePointerDeviceCount @ 0x1C01EF478 (UpdatePointerDeviceCount.c)
