/*
 * XREFs of ?AllocatePool@?$UAFMitigationAllocator@VWin32UAFMAllocatorCollection@@@NSInstrumentation@@SAPEAXW4_POOL_TYPE@@_KIPEAI@Z @ 0x1C022037C
 * Callers:
 *     Win32UAFMAllocPagedLookasideListImpl @ 0x1C0220BE0 (Win32UAFMAllocPagedLookasideListImpl.c)
 *     Win32UAFMAllocPoolImpl @ 0x1C0220C60 (Win32UAFMAllocPoolImpl.c)
 * Callees:
