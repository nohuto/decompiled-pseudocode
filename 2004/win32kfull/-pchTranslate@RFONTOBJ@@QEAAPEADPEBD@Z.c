/*
 * XREFs of ?pchTranslate@RFONTOBJ@@QEAAPEADPEBD@Z @ 0x1C02A8B6C
 * Callers:
 *     ?pjTable@RFONTOBJ@@QEAAPEAEKPEAK@Z @ 0x1C02A8E38 (-pjTable@RFONTOBJ@@QEAAPEAEKPEAK@Z.c)
 *     ?pvFile@RFONTOBJ@@QEAAPEAXPEAK@Z @ 0x1C02A8EE8 (-pvFile@RFONTOBJ@@QEAAPEAXPEAK@Z.c)
 * Callees:
 *     ?MapFontFileInKernel@@YAJPEAXPEAPEAX@Z @ 0x1C02A84F4 (-MapFontFileInKernel@@YAJPEAXPEAPEAX@Z.c)
