/*
 * XREFs of ?EngMapFontFileInternal@@YAH_KPEAPEAKPEAK@Z @ 0x1C0289CA0
 * Callers:
 *     EngMapFontFile @ 0x1C028AC80 (EngMapFontFile.c)
 * Callees:
 *     vUnmapFile @ 0x1C000992C (vUnmapFile.c)
 *     ?bMapRoutine@@YAHPEAU_FONTFILEVIEW@@PEAU_FILEVIEW@@W4_MAP_MODE@@H@Z @ 0x1C0016428 (-bMapRoutine@@YAHPEAU_FONTFILEVIEW@@PEAU_FILEVIEW@@W4_MAP_MODE@@H@Z.c)
