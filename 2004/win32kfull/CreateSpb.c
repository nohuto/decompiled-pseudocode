/*
 * XREFs of CreateSpb @ 0x1C0153C30
 * Callers:
  ...
  *((_QWORD *)&v27 + 1) = v4;
  ...
  if ( (a2 & 2) == 0 )
  {
    ...
    if ( *(_DWORD *)(gpsi + 2220LL)
      || ((v12 = MonitorFromRect((struct tagRECT *)(v8 + 24), 1LL, 0),
           v27 = 0LL,
           v13 = v12,
           !SubtractRect((__int64)&v27, (int *)(v8 + 24), (int *)(*(_QWORD *)(v12 + 40) + 28LL)))
...
LABEL_29:
      ...
      *(_QWORD *)(v8 + 16) = CompatibleBitmapInternal;
      if ( CompatibleBitmapInternal )
      {
        ...
        if ( v19 )
        {
          v20 = NtGdiBitBltInternal(*(HDC *)ghdcMem, v17, 0, v15, v16, a3, *v10, *(_DWORD *)(v8 + 28), 13369344, 0, 0);
