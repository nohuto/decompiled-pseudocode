/*
 * XREFs of ?xxxUpdateSystemCursorFromRegistry@@YAXPEAU_UNICODE_STRING@@HW4InputTracing_SetSystemCursorReason@@@Z @ 0x1C0042BEC
 * Callers:
...
__int64 __fastcall xxxUpdateSystemCursorFromRegistry(__int64 a1, unsigned int a2, unsigned int a3)
{
  ...
  v5 = 576;
  FastGetProfileStringFromIDW(a1, 1LL, WORD1(gasyscur[69 * (int)a2]), &word_1C02E3EA4, SourceString, 260, 0);
  if ( SourceString[0] )
  {
    v6 = 4LL;
    v5 = 592;
