/*
 * XREFs of zzzAttachThreadInput @ 0x1C00381C0
 * Callers:
...
__int64 __fastcall zzzAttachThreadInput(__int64 a1, __int64 a2, __int16 a3)
{
  ...
  if ( a1 != a2 )
  {
    if ( (a3 & 0x8000) == 0 )
    {
      ...
      {
        if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 416LL) + 880LL, *(_QWORD *)(a2 + 424) + 428LL)
...
LABEL_39:
        ...
        if ( !(unsigned __int8)CheckAccess(*(_QWORD *)(gptiCurrent + 416LL) + 880LL, *(_QWORD *)(a1 + 424) + 428LL)
          && *(int *)(*(_QWORD *)(gptiCurrent + 416LL) + 12LL) >= 0
          ...
          && (*(_DWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 820LL) & 0x100) == 0 )
        {
          v16 = *(_QWORD *)(a1 + 424);
          v17 = a1;
          goto LABEL_39;
