/*
 * XREFs of ?xxxWindowSizeStartingHandler@CallShell@@YA_NPEAUtagWND@@H@Z @ 0x1C023E794
 * Callers:
...
bool __fastcall CallShell::xxxWindowSizeStartingHandler(CallShell *this, struct tagWND *a2)
{
  ...
  *(_QWORD *)v10 = *(_QWORD *)this;
  ...
  v8 = *((_QWORD *)this + 5);
  v10[8] = v7;
  TransformRectBetweenCoordinateSpaces(&v10[3], v8 + 88, *(_QWORD *)(*(_QWORD *)(v2 + 448) + 328LL), this);
