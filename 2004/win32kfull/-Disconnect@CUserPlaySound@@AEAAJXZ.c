/*
 * XREFs of ?Disconnect@CUserPlaySound@@AEAAJXZ @ 0x1C0122F80
 * Callers:
 *     NtUserDoSoundConnect @ 0x1C0129C20 (NtUserDoSoundConnect.c)
 *     NtUserDoSoundDisconnect @ 0x1C012BE40 (NtUserDoSoundDisconnect.c)
 * Callees:
