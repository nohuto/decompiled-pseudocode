/*
 * XREFs of xxxEndMenu @ 0x1C024B45C
 * Callers:
...
__int64 *__fastcall xxxEndMenu(__int64 a1)
{
  ...
  if ( *(_QWORD *)v18[0] )
  {
    ...
    **v3 |= 0x8000u;
    ...
    if ( *(_QWORD *)(*(_QWORD *)(gptiCurrent + 424LL) + 104LL) == v2 )
        ...
        else
        {
          ...
          if ( (v6 & 8) != 0 )
          {
            ...
            if ( *(_QWORD *)(*(_QWORD *)v18[0] + 16LL) )
              xxxDestroyWindow(*(__int64 **)(*(_QWORD *)v18[0] + 16LL));
          }
        }
      }
    }
  ...
  result = *(__int64 **)(v8 + 1464);
  if ( result )
  {
    result = (__int64 *)*result;
    *(_QWORD *)(v8 + 1464) = result;
  }
  return result;
}
