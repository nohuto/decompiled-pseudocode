/*
 * XREFs of ?xxxUserReinitializeAutoRotation@CLegacyRotationMgr@@UEAAXXZ @ 0x1C0055FF0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CLegacyRotationMgr::xxxUserReinitializeAutoRotation(CLegacyRotationMgr *this)
{
  ...
  dword_1C0336618 = AutoRotationRegistrySetting;
  if ( (unsigned int)dword_1C032B3F8 > 5 && (qword_1C032B408 & 0x400000000001LL) != 0 )
  {
    v3 = (CLegacyRotationMgr *)(qword_1C032B410 & 0x400000000001LL);
    if ( (qword_1C032B410 & 0x400000000001LL) == qword_1C032B410 )
    {
      v11 = AutoRotationRegistrySetting;
      v10 = 1;
      _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EtwWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapperByVal<4>,_tlgWrapperByVal<4>>(
        (_DWORD)v3,
        (unsigned int)&unk_1C02EF51D,
        1,
        v4,
        (__int64)&v11,
        (__int64)&v10);
  ...
  dword_1C0336648 = CLegacyRotationMgr::QueryAutoRotationRegistrySetting(
                      v3,
                      L"SlateEnable",
                      1u,
                      L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\CurrentVersion\\AutoRotation");
  ...
  if ( v9 > 3 )
    v9 = 0;
  dword_1C0336614 = v9;
  dword_1C0336628 = IsNativeOrientationPortrait();
  dword_1C033662C = 0;
