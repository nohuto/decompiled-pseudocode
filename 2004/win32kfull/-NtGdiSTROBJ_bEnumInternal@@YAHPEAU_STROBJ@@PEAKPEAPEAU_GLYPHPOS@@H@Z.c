/*
 * XREFs of ?NtGdiSTROBJ_bEnumInternal@@YAHPEAU_STROBJ@@PEAKPEAPEAU_GLYPHPOS@@H@Z @ 0x1C02B1F38
 * Callers:
 *     NtGdiSTROBJ_bEnum @ 0x1C02B56C0 (NtGdiSTROBJ_bEnum.c)
 *     NtGdiSTROBJ_bEnumPositionsOnly @ 0x1C02B56E0 (NtGdiSTROBJ_bEnumPositionsOnly.c)
 * Callees:
 ...
 *     STROBJ_bEnumPositionsOnly @ 0x1C02BF1D0 (STROBJ_bEnumPositionsOnly.c)
 */
