/*
 * XREFs of xxxDCompSpeedHitTest @ 0x1C00B0CEC
 * Callers:
        ...
        _OWORD *a7)
{
  ...
  _QWORD v60[17]; // [rsp+60h] [rbp-A8h] BYREF
  _BYTE v61[112]; // [rsp+E8h] [rbp-20h] BYREF
  _BYTE v62[112]; // [rsp+158h] [rbp+50h] BYREF
  _BYTE v63[128]; // [rsp+1C8h] [rbp+C0h] BYREF

  v8 = (_OWORD *)DCompHitTest(v61, a1, a2, a4, a6);
  v10 = a7;
  v11 = 0;
  v12 = v8[1];
  v13 = v8[2];
  ...
  else
  {
    ...
    if ( v36 )
    {
      ...
      if ( (*(_DWORD *)(*((_QWORD *)CompositionInputWindowUIOwner + 5) + 288LL) & 0xF) != 2 )
      {
        ...
        v58 = ValidateHmonitorNoRip(*(_QWORD *)(*((_QWORD *)CompositionInputWindowUIOwner + 5) + 256LL));
  ...
  if ( a5 )
  {
    if ( v20 == 2 )
    {
      ...
      if ( TopLevelWindow )
      {
        ...
        v60[0] = *(_QWORD *)(ThreadWin32Thread + 408);
        *(_QWORD *)(ThreadWin32Thread + 408) = v60;
        v60[1] = TopLevelWindow;
        ...
        if ( v51 )
        {
          v55 = TouchTargetChildTree(TopLevelWindow, a5, v56);
          v39 = (_OWORD *)INPUTDEST_FROM_PWND(v62, v55);
          v11 = 1;
          goto LABEL_35;
        }
      }
...
LABEL_34:
    v39 = (_OWORD *)INPUTDEST_FROM_PWND(v63, *(_QWORD *)(*(_QWORD *)(grpdeskRitInput + 8LL) + 24LL));
LABEL_35:
    v40 = v39[1];
    v41 = v39[2];
    v42 = v39[3];
