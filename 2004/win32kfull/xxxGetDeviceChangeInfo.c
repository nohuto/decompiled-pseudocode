/*
 * XREFs of xxxGetDeviceChangeInfo @ 0x1C01DEC40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxGetDeviceChangeInfo(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  {
    v4 = qword_1C033B1C0;
    v5 = *(_QWORD **)(qword_1C033B1C0 + 8);
    if ( *(struct _LIST_ENTRY **)qword_1C033B1C0 != &gMediaChangeList || *v5 != qword_1C033B1C0 )
      __fastfail(3u);
    qword_1C033B1C0 = *(_QWORD *)(qword_1C033B1C0 + 8);
    *v5 = &gMediaChangeList;
  }
