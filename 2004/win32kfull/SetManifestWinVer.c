/*
 * XREFs of SetManifestWinVer @ 0x1C00FA5A0
 * Callers:
 *     <none>
 * Callees:
 *     SbGetProcessSwitchContext @ 0x1C00FA670 (SbGetProcessSwitchContext.c)
 *     SbGetContextDetailsByGuid @ 0x1C00FA6C8 (SbGetContextDetailsByGuid.c)
 */
