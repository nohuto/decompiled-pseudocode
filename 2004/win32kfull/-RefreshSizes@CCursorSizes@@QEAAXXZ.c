/*
 * XREFs of ?RefreshSizes@CCursorSizes@@QEAAXXZ @ 0x1C0048DF4
 * Callers:
 *     xxxSystemParametersInfoWorker @ 0x1C003E1F8 (xxxSystemParametersInfoWorker.c)
 *     EditionUpdateCursorSizes @ 0x1C0048DD0 (EditionUpdateCursorSizes.c)
 *     xxxUpdatePerUserSystemParameters @ 0x1C00492E0 (xxxUpdatePerUserSystemParameters.c)
 *     ??0CCursorSizes@@QEAA@XZ @ 0x1C012A8DC (--0CCursorSizes@@QEAA@XZ.c)
 * Callees:
  ...
  *((_DWORD *)this + 1) = v3;
  ...
  do
  {
    if ( *(_DWORD *)((char *)v30 + v20) )
    {
      ...
      if ( (unsigned int)dword_1C0330B30 > 5 && (qword_1C0330B40 & 8) != 0 && (v18 & 8) == v18 )
      {
        v27 = *(_DWORD *)((char *)v30 + v20 + 4);
        v35 = &v27;
        v36 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0330B30, (int)&dword_1C02EF718, 0, 0, 3u, &v34);
      }
    ...
    if ( *(_DWORD *)((char *)v32 + v20) )
    {
      ...
      if ( (unsigned int)dword_1C0330B30 > 5 && (qword_1C0330B40 & 8) != 0 && (v18 & 8) == v18 )
      {
        ...
        v38 = &v28;
        v39 = 4LL;
        tlgWriteTransfer_EtwWriteTransfer((int)&dword_1C0330B30, (int)&dword_1C02EF6E4, 0, 0, 3u, &v37);
        v18 = qword_1C0330B48;
      }
    }
    v20 += 8LL;
