/*
 * XREFs of ?GetConsoleHostProcess@@YAJKPEAPEAX@Z @ 0x1C01E9B14
 * Callers:
 *     GetConsoleDesktop @ 0x1C01E9CBC (GetConsoleDesktop.c)
 * Callees:
 *     LockThreadByClientId @ 0x1C002A2E8 (LockThreadByClientId.c)
 */
...
int __fastcall GetConsoleHostProcess(int a1, void **a2)
{
  ...
  *(&ObjectAttributes.Attributes + 1) = 0;
  ...
  result = LockThreadByClientId((void *)a1, &Thread);
  if ( result >= 0 )
  {
