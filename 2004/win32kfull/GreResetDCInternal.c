/*
 * XREFs of GreResetDCInternal @ 0x1C014D06C
 * Callers:
 *     NtGdiResetDC @ 0x1C014CF20 (NtGdiResetDC.c)
 * Callees:
...
LABEL_7:
  ...
  if ( *((_WORD *)v32[0] + 6) > 1u )
  {
    if ( (unsigned int)dword_1C032B3F8 > 5 && tlgKeywordOn((__int64)&dword_1C032B3F8, 0x400000000000LL) )
    {
      v28 = 0;
      v29 = v14;
      v31[0] = (DC *)0x1000000;
  ...
  *(_QWORD *)(v16 + 1712) = 0LL;
  ...
  if ( (*((_DWORD *)v32[0] + 9) & 0x100) == 0 && *((_DWORD *)v32[0] + 8) != 1 && (*(_DWORD *)(v16 + 40) & 0x80u) != 0 )
  {
    ...
    if ( XDCOBJ::bCleanDC((XDCOBJ *)v32, 0) )
    {
      if ( *(_DWORD *)(v16 + 8) == 1 )
      {
        v20 = (HDC)hdcOpenDCW(&word_1C02E3EA4, a2, 0LL, 0LL, *(_QWORD *)(v16 + 2560), v31[0], a4, a5, 0);
        v9 = v20;
        if ( v20 )
        {
          *(_QWORD *)(v16 + 2560) = 0LL;
