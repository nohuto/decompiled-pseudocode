/*
 * XREFs of ?xxxCallHook2@@YA_JPEAUtagHOOK@@H_K_JPEAH_N@Z @ 0x1C009A2E0
 * Callers:
...
LABEL_127:
  ...
  if ( v16 != gptiCurrent )
  {
    if ( (v15 & 0x24) != 0
      ...
      && (*((_DWORD *)Valid + 16) & 1) != 0
      && ((v19 = *(_QWORD *)(*((_QWORD *)Valid + 2) + 416LL),
      ...
      || (v22 = (_QWORD *)*((_QWORD *)Valid + 2), v22[52] != *(_QWORD *)(gptiCurrent + 416LL))
  ...
  if ( (unsigned int)(*((_DWORD *)Valid + 12) - 13) <= 1 )
  {
    if ( a6
      || !gpqForeground
      || (unsigned __int8)CheckAccess(*(_QWORD *)(*((_QWORD *)Valid + 2) + 416LL) + 880LL, gpqForeground + 428LL)
      || (unsigned int)IsForegroundShellFrameQueueAccessible(*((const struct tagTHREADINFO **)Valid + 2))
      || (v25 = *((_QWORD *)Valid + 2), *(int *)(*(_QWORD *)(v25 + 416) + 12LL) < 0) )
    {
      if ( *((_DWORD *)Valid + 12) != 14 )
        goto LABEL_83;
      if ( *(_DWORD *)(gptiCurrent + 1360LL) == -1 )
        goto LABEL_83;
      if ( (unsigned __int8)CheckAccess(*(_QWORD *)(*((_QWORD *)Valid + 2) + 416LL) + 880LL, gptiCurrent + 1360LL) )
        goto LABEL_83;
      v25 = *((_QWORD *)Valid + 2);
      if ( *(int *)(*(_QWORD *)(v25 + 416) + 12LL) < 0 )
        goto LABEL_83;
      v27 = *(_QWORD *)(gptiCurrent + 1360LL);
      v26 = 0LL;
    }
    else
    {
  ...
  if ( !(unsigned __int8)CheckAccess(
                           *(_QWORD *)(*((_QWORD *)Valid + 2) + 416LL) + 880LL,
                           *(_QWORD *)(gptiCurrent + 416LL) + 880LL) )
  {
    v24 = *((_QWORD *)Valid + 2);
...
LABEL_83:
  ...
  {
    v28 = *(_QWORD *)(*((_QWORD *)Valid + 2) + 416LL);
    if ( *(int *)(v28 + 12) >= 0 )
    {
  ...
  *(_QWORD *)&v85 = *(_QWORD *)(gptiCurrent + 408LL);
  ...
  *((_QWORD *)&v85 + 1) = Valid;
  ...
  if ( v23 )
  {
    ...
    if ( (v15 & 0x10) != 0 )
    {
      ...
      {
        v51 = *(_QWORD *)(gptiCurrent + 680LL);
        *(_QWORD *)&v77 = *(_QWORD *)(gptiCurrent + 408LL);
        *(_QWORD *)(gptiCurrent + 408LL) = &v77;
        *((_QWORD *)&v77 + 1) = v51;
        if ( v51 )
          HMLockObject(v51);
        v73[0] = gptiCurrent + 680LL;
        v73[1] = Valid;
        HMAssignmentLock(v73);
        if ( *(_QWORD *)(gptiCurrent + 472LL) )
        {
          v52 = (_QWORD *)PhkNextValid((__int64)Valid);
          v9 = *(_QWORD *)(v53 + 48);
          v76 = v9;
          if ( v52 )
            v52 = (_QWORD *)*v52;
        ...
        if ( v54 || (v15 & 4) == 0 && (*(_DWORD *)(gptiCurrent + 480LL) & 0xC) != 0 )
        {
          v92 = 0LL;
          v93 = 0LL;
          v94 = 0;
          ...
          if ( v54 )
          {
            v83 = *(_QWORD *)(gptiCurrent + 1352LL);
            v84 = *(_QWORD *)(gptiCurrent + 1360LL);
            v82 = *(_QWORD *)(gptiCurrent + 1368LL);
          }
          if ( (*(_DWORD *)(gptiCurrent + 480LL) & 0x20000) != 0
            || (unsigned int)IsThreadHung(*((_QWORD **)Valid + 2), 0)
            || (LODWORD(v68) = 1,
                LODWORD(ReturnLength) = 1,
                !xxxInterSendMsgEx(0LL, 0x314u, v72[0], &v79, ReturnLength, *((_QWORD *)Valid + 2), &v91, v68, 0)) )
          {
            v58 = dword_1C02EBC50[v74 + 1];
            v70 = v58;
          }
          else
          {
        ...
        else
        {
          v89 = 0LL;
          v90 = 0LL;
          v56 = PsChargeProcessWakeCounter(**(_QWORD **)(*((_QWORD *)Valid + 2) + 416LL), 0LL, 2LL, 2LL);
          v57 = v56;
          if ( v56 )
            PushW32ThreadLock(v56, &v89, (__int64)ReleaseWakeReference);
          LODWORD(v68) = 1;
          LODWORD(ReturnLength) = 1;
          v70 = xxxInterSendMsgEx(0LL, 0x314u, v72[0], &v79, ReturnLength, *((_QWORD *)Valid + 2), 0LL, v68, 0);
          if ( v57 )
            PopAndFreeAlwaysW32ThreadLock((__int64)&v89);
        }
        v72[0] = gptiCurrent + 680LL;
        v72[1] = v51;
        HMAssignmentLock(v72);
        v62 = *(_QWORD *)(gptiCurrent + 472LL);
        if ( v62 )
          *(_QWORD *)(v62 + 48) = v9;
  ...
  if ( (_DWORD)v31 != -1 )
  {
    v32 = *(unsigned int *)(*(_QWORD *)(gptiCurrent + 416LL) + 404LL);
...
LABEL_126:
  ...
  v34 = v71;
LABEL_104:
  v35 = *(_QWORD *)(gptiCurrent + 680LL);
  *(_QWORD *)&v77 = *(_QWORD *)(gptiCurrent + 408LL);
  *(_QWORD *)(gptiCurrent + 408LL) = &v77;
  *((_QWORD *)&v77 + 1) = v35;
  if ( v35 )
    HMLockObject(v35);
  v36 = *(_QWORD *)(gptiCurrent + 472LL);
  if ( !v36 )
    goto LABEL_120;
  v37 = Valid;
  while ( 2 )
...
LABEL_112:
  ...
  {
    v37 = *(struct tagHOOK **)(*(_QWORD *)(gptiCurrent + 456LL) + 8LL * *((int *)v37 + 12) + 48);
    goto LABEL_112;
  }
  v37 = 0LL;
LABEL_116:
