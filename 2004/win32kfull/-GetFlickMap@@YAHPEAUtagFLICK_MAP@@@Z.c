/*
 * XREFs of ?GetFlickMap@@YAHPEAUtagFLICK_MAP@@@Z @ 0x1C0042308
 * Callers:
...
_BOOL8 __fastcall GetFlickMap(struct tagFLICK_MAP *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  {
    v15 = xmmword_1C032B738;
    xmmword_1C032B738 = xmmword_1C032B6D8;
    dword_1C032B024 = dword_1C032B024 == 0;
    xmmword_1C032B6D8 = v15;
  }
...
LABEL_2:
    ...
    *(_OWORD *)a1 = xmmword_1C032B6D8;
    *((_OWORD *)a1 + 1) = xmmword_1C032B6F0;
    *((_OWORD *)a1 + 2) = xmmword_1C032B708;
    *((_OWORD *)a1 + 3) = xmmword_1C032B720;
    *((_OWORD *)a1 + 4) = xmmword_1C032B738;
    *((_OWORD *)a1 + 5) = xmmword_1C032B750;
    *((_OWORD *)a1 + 6) = xmmword_1C032B768;
    *((_OWORD *)a1 + 7) = xmmword_1C032B780;
  }
