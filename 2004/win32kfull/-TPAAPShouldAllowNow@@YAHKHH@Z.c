/*
 * XREFs of ?TPAAPShouldAllowNow@@YAHKHH@Z @ 0x1C0214050
 * Callers:
 *     EditionLegacyTouchPadMouseAllowTap @ 0x1C02145A0 (EditionLegacyTouchPadMouseAllowTap.c)
 * Callees:
 *     ?TPAAPSqmBlockedCount@@YAXH@Z @ 0x1C021418C (-TPAAPSqmBlockedCount@@YAXH@Z.c)
 */
