/*
 * XREFs of SfnGESTURE @ 0x1C0229AC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfnGESTURE(__int64 *a1, int a2, __int64 a3, unsigned __int64 a4, __int64 a5, __int64 a6)
{
  ...
  *(_QWORD *)(*(_QWORD *)(v11 + 472) + 80LL) = v16;
  ...
  v17 = KeUserModeCallback(113LL, &v30, 48LL, &v26, v25);
