/*
 * XREFs of zzzUpdateCursorImage @ 0x1C0087670
 * Callers:
...
void zzzUpdateCursorImage()
{
     ...
     || *(int *)(gpqForeground + 384LL) >= 0) )
  {
    ...
    if ( *(int *)(gpqCursor + 384LL) >= 0 )
    {
      ...
      if ( (HIDWORD(WPP_MAIN_CB.Dpc.DpcListEntry.Next) || gtmridAutorunCursor)
  ...
  if ( (struct tagCURSOR *)v0 != gpcurLogCurrent )
  {
    if ( v0 && (*(_DWORD *)(v0 + 80) & 8) != 0 && *(_QWORD *)(v0 + 112) )
    {
      if ( !WPP_MAIN_CB.Dpc.DeferredRoutine )
      {
        *(_DWORD *)(v0 + 120) = 0;
        ...
        WPP_MAIN_CB.Dpc.DeferredRoutine = (PKDEFERRED_ROUTINE)SetRITTimer(
    ...
    else if ( WPP_MAIN_CB.Dpc.DeferredRoutine )
    {
      FindTimer(0, WPP_MAIN_CB.Dpc.DeferredRoutine, 4, 1, 0LL);
