/*
 * XREFs of ?xxxSetWindowWord@@YAGPEAUtagWND@@HG@Z @ 0x1C014E27C
 * Callers:
 *     NtUserSetWindowWord @ 0x1C014E1A0 (NtUserSetWindowWord.c)
 * Callees:
...
LABEL_69:
    ...
    if ( (*(_WORD *)(v9 + 42) & 0x3FFF) == 0x2A4 )
    {
      if ( v4 + 2 <= *(unsigned int *)(v9 + 252) )
        goto LABEL_9;
      v23 = *(_QWORD *)(*((_QWORD *)a1 + 2) + 416LL);
...
LABEL_8:
  v12 = *((_QWORD *)a1 + 5);
  v8 = *(_WORD *)(v12 + 42) & 0x3FFF;
  if ( (*(_WORD *)(v12 + 42) & 0x3FFF) == 0 )
  {
LABEL_9:
