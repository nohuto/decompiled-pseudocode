/*
 * XREFs of xxxMsgWaitForMultipleObjectsEx @ 0x1C0157F54
 * Callers:
...
__int64 __fastcall xxxMsgWaitForMultipleObjectsEx(__int64 a1, __int64 a2, __int64 a3, char a4, char a5)
{
  __int64 *v5; // rsi
  bool v6; // di
  int v7; // r15d
  ...
  do
  {
    ...
    if ( !(unsigned int)xxxRemoveQueueCompletion() )
      break;
    a1 = 3LL;
    LOBYTE(a1) = (*(_WORD *)(*(_QWORD *)(v22 + 440) + 6LL) & 8) != 0;
  }
