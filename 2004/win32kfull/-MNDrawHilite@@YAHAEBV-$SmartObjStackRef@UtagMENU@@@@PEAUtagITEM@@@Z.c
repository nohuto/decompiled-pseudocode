/*
 * XREFs of ?MNDrawHilite@@YAHAEBV?$SmartObjStackRef@UtagMENU@@@@PEAUtagITEM@@@Z @ 0x1C0061048
 * Callers:
...
__int64 __fastcall MNDrawHilite(__int64 **a1, __int64 a2)
{
  ...
  if ( (v4 & 0x80u) != 0 && (v4 & 0xC0000000) == 0 )
  {
    ...
    if ( !v6 )
      v6 = (__int64 *)**a1;
    if ( (unsigned int)MNIsUAHMenu(v6, a2, 0LL, a1) || !(unsigned int)MNIsCachedBmpOnly(v7) )
      return 1;
  }
  return v3;
}
