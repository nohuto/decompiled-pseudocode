/*
 * XREFs of ATAShimGetMsftId @ 0x1C00572D0
 * Callers:
 *     ATADeviceIdShimStorageDeviceIdCompletionHook @ 0x1C0057260 (ATADeviceIdShimStorageDeviceIdCompletionHook.c)
 * Callees:
 *     __security_check_cookie @ 0x1C001BE70 (__security_check_cookie.c)
 *     RaidAddATADeviceIdMapping @ 0x1C0034234 (RaidAddATADeviceIdMapping.c)
 *     RaidCheckATADeviceIdMapping @ 0x1C0034520 (RaidCheckATADeviceIdMapping.c)
 *     RaidSaveATADeviceIdMapping @ 0x1C0034AC8 (RaidSaveATADeviceIdMapping.c)
 *     TrimString @ 0x1C0057A80 (TrimString.c)
 */
