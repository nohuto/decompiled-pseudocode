/*
 * XREFs of StorPortUnitIdleState @ 0x1C0040970
 * Callers:
 ...
 *     RaidAdapterIsRegisteredForIdleDetection @ 0x1C002C32C (RaidAdapterIsRegisteredForIdleDetection.c)
...
LABEL_54:
              ...
              LODWORD(v28) = a3;
              LODWORD(v27) = a2;
              LOBYTE(v26) = *(_BYTE *)(a1 + 98);
              LOBYTE(v25) = *(_BYTE *)(a1 + 97);
              LOBYTE(v24) = *(_BYTE *)(a1 + 96);
              LODWORD(v23) = *(_DWORD *)(v22 + 56);
              McTemplateK0pquuuqq_EtwWriteTransfer(
                v22,
                v18,
                v17,
...
LABEL_44:
    ...
    else if ( *(char *)(*(_QWORD *)(a1 + 24) + 110LL) < 0
           ...
           && RaidAdapterIsRegisteredForIdleDetection(*(_QWORD *)(a1 + 24)) )
    {
      if ( !a3 )
      {
        ...
        {
          *(_BYTE *)(a1 + 449) = v21 | 8;
          RaidAdapterPoFxActivateComponent(v19, 0LL, 0LL);
        }
        goto LABEL_48;
      }
      v20 = *(_BYTE *)(a1 + 449);
