/*
 * XREFs of RaidInitializePerfOpts @ 0x1C00306D0
 * Callers:
...
__int64 __fastcall RaidInitializePerfOpts(__int64 a1, char a2, __int64 i)
{
  ...
  if ( !v7 )
  {
    ...
    v15 = 23LL;
LABEL_6:
    WPP_SF_(v14->AttachedDevice, v15, &WPP_026814134b593ed6508f665f094ed446_Traceguids);
LABEL_7:
    v13 = -1056964602;
    goto LABEL_116;
  }
  ...
  if ( v19 >= 5 && *(_DWORD *)(v7 + 4) >= 0x28u )
  {
    ...
    {
      RaidInitializeDma(v22, *(_QWORD *)(v8 + 32), v8 + 312);
      v3 = 0LL;
      v9 = 1;
    }
    if ( v8 != -712 && (v23 = *v21) != 0 && (v24 = *(_QWORD *)(v23 + 8)) != 0 )
    {
      if ( *(int *)(v8 + 740) < 3 || (v25 = *(__int64 (__fastcall **)(__int64, __int128 *))(v24 + 128)) == 0LL )
      {
LABEL_50:
        v4 = a2;
LABEL_51:
    ...
    else
    {
      ...
      if ( v11 && (*(_DWORD *)(v7 + 8) & 4) != 0 )
      {
        ...
        if ( v28 > v31 || v31 > v30 )
        {
          ...
          v18 = 26LL;
LABEL_18:
          WPP_SF_(v17->AttachedDevice, v18, &WPP_026814134b593ed6508f665f094ed446_Traceguids);
LABEL_19:
          v13 = -1056964607;
          goto LABEL_116;
        }
