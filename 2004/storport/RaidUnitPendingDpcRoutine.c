/*
 * XREFs of RaidUnitPendingDpcRoutine @ 0x1C000F8B0
 * Callers:
 *     <none>
 * Callees:
 *     StorTickEventQueue @ 0x1C000F960 (StorTickEventQueue.c)
 *     RaidUnitDisablePendingTimer @ 0x1C000FA74 (RaidUnitDisablePendingTimer.c)
 ...
 *     RaidUnitAbortHierarchicalResetWorkItem @ 0x1C0049108 (RaidUnitAbortHierarchicalResetWorkItem.c)
      ...
      if ( v14 != -1 )
      {
        ...
        if ( !v14 || v14 < (unsigned int)v13 )
        {
          ...
          *(_BYTE *)(v4 + 450) |= 2u;
          ...
          {
            WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 59LL, &WPP_315ac634f457316aea96af95ee1292c6_Traceguids, v4);
          }
        }
      }
    }
