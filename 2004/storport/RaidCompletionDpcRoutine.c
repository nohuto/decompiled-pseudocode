/*
 * XREFs of RaidCompletionDpcRoutine @ 0x1C002F8E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     StorPurgeEventQueue @ 0x1C00337B4 (StorPurgeEventQueue.c)
 */
        ...
        PVOID SystemArgument2)
{
  ...
  v6 = 0;
  v7.QuadPart = 0LL;
  if ( StorEtwLoggingEnabled && (byte_1C0068843 & 4) != 0 )
  {
    if ( UseQPCTime )
  ...
  while ( v11 != (__int64 *)v10 )
  {
    ...
    if ( StorEtwLoggingEnabled && (byte_1C0068843 & 4) != 0 && v6 >= 0x19 )
    {
