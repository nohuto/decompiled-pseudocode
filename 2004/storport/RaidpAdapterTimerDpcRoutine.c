/*
 * XREFs of RaidpAdapterTimerDpcRoutine @ 0x1C000CA10
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( v5 )
  {
    ...
    if ( (int)v6 < 6 || (SystemArgument1 = *(unsigned int *)(v4 + 276), (int)SystemArgument1 < 4) )
    {
      if ( (int)RaidAcquireAdapterRemoveLock(v4, v6, SystemArgument1, SystemArgument2) >= 0 )
      {
        RaidAdapterAcquireStartIoLock(v4, &v10, v7, v8);
        v5(*(_QWORD *)(v4 + 544) + 16LL);
        RaidAdapterReleaseStartIoLock(v4, &v10);
        ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(v4 + 264));
        if ( *(_BYTE *)(v4 + 105) )
        {
