/*
 * XREFs of RaUnitSmartDataIoctl @ 0x1C0047548
 * Callers:
 ...
 *     StorFreeSynchronousScsiRequest @ 0x1C001B5C8 (StorFreeSynchronousScsiRequest.c)
 *     StorBuildSynchronousScsiRequest @ 0x1C001B614 (StorBuildSynchronousScsiRequest.c)
 *     memset @ 0x1C001DA00 (memset.c)
 *     RaUnitBuildSrbForSmartReadData @ 0x1C0046060 (RaUnitBuildSrbForSmartReadData.c)
 *     RaUnitBuildSrbForSmartReturnStatus @ 0x1C00462A8 (RaUnitBuildSrbForSmartReturnStatus.c)
...
LABEL_25:
  v19 = *(_QWORD *)(a1 + 24) + 312LL;
  v42 = v19;
  Srb = RaidAllocateSrb(*(_QWORD *)(a1 + 8), 0, *(_BYTE *)(*(_QWORD *)(a1 + 24) + 410LL), 1);
  if ( !Srb )
  {
    Status = -1073741801;
    goto LABEL_5;
