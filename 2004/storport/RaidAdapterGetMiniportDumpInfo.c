/*
 * XREFs of RaidAdapterGetMiniportDumpInfo @ 0x1C00772AC
 * Callers:
 *     RaidAdapterPopulateMiniportDumpInfo @ 0x1C0077790 (RaidAdapterPopulateMiniportDumpInfo.c)
 * Callees:
    ...
    *(_DWORD *)(a3 + 72) = v4 << 16;
    ...
    if ( Pool )
    {
      ...
      *v9 = 32;
      ...
      Srb = RaidAllocateSrb(*(_QWORD *)(a1 + 8), 0x2Au, *(_BYTE *)(a1 + 410), 0);
      if ( Srb
        ...
        *(_QWORD *)(v10 + 168) = Srb;
          ...
          && BYTE1(WPP_GLOBAL_Control->Timer) )
        {
          WPP_SF_qq(
            ...
            0x49u,
            (__int64)&WPP_026814134b593ed6508f665f094ed446_Traceguids,
            v10,
            Srb);
        }
        if ( *(_BYTE *)(a1 + 4514) )
