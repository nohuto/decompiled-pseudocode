/*
 * XREFs of RaidAdapterSetSystemPowerIrp @ 0x1C0011224
 * Callers:
 *     RaidAdapterSetPowerIrp @ 0x1C0010ED8 (RaidAdapterSetPowerIrp.c)
 * Callees:
...
__int64 __fastcall RaidAdapterSetSystemPowerIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 38LL, &WPP_e3909ed325cf3aaa071da1dbc70c911f_Traceguids, a1, a2);
  }
  ...
  *(_OWORD *)(&CurrentStackLocation[-1].Parameters.SetQuota + 6) = *(_OWORD *)(&CurrentStackLocation->Parameters.SetQuota
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 39LL, &WPP_e3909ed325cf3aaa071da1dbc70c911f_Traceguids, a1, a2, 259);
  }
  return 259LL;
}
