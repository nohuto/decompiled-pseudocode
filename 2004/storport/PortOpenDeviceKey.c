/*
 * XREFs of PortOpenDeviceKey @ 0x1C007B2EC
 * Callers:
 *     PortGetLinkTimeoutValue @ 0x1C0058980 (PortGetLinkTimeoutValue.c)
 *     PortGetDriverParameters @ 0x1C007AF8C (PortGetDriverParameters.c)
 ...
 *     PortpOpenParametersKey @ 0x1C007B50C (PortpOpenParametersKey.c)
 */
