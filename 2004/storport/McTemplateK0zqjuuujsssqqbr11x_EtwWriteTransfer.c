/*
 * XREFs of McTemplateK0zqjuuujsssqqbr11x_EtwWriteTransfer @ 0x1C004D9A0
 * Callers:
 *     StorEtwMiniportBugResetBrokenEvent @ 0x1C004F0BC (StorEtwMiniportBugResetBrokenEvent.c)
 * Callees:
        ...
        char a17)
{
  ...
  v60 = 0;
  v62 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(v27, &EventMiniportBugResetBroken, a3, 0xFu, &v29);
}
