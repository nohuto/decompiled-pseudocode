/*
 * XREFs of RaUnitScsiGetDumpPointersIoctl @ 0x1C00144EC
 * Callers:
 ...
 *     RaidQueryCrashdumpFunctions @ 0x1C0014E0C (RaidQueryCrashdumpFunctions.c)
...
LABEL_111:
    ...
    *(_QWORD *)&MasterIrp->Flags = 0LL;
    ...
    if ( (unsigned __int8)(*(_BYTE *)(v2 + 456) - 2) <= 2u )
      MasterIrp->IoStatus.Status |= 1u;
    if ( (*(_DWORD *)(*(_QWORD *)(v2 + 536) + 184LL) & 0x20) != 0 )
      MasterIrp->IoStatus.Status |= 4u;
    if ( *(_BYTE *)(v2 + 4514) && (*(_DWORD *)(*(_QWORD *)(v2 + 536) + 184LL) & 8) == 0 )
      goto LABEL_97;
    ...
    if ( v22 )
    {
      ...
      Srb = RaidAllocateSrb(*(_QWORD *)(a1 + 8), 0x26u, *(_BYTE *)(v2 + 410), 0);
      if ( Srb )
      {
        ...
        if ( ContiguousIoResources )
        {
          ...
          *(_QWORD *)(v27 + 656) = RaidXrbSignalCompletion;
          ...
          if ( !*(_BYTE *)(v2 + 4514) || (*(_DWORD *)(*(_QWORD *)(v2 + 536) + 184LL) & 0x1000) != 0 )
          {
            if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
              && (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x100) != 0
              && BYTE1(WPP_GLOBAL_Control->Timer) )
...
LABEL_45:
          if ( *(_BYTE *)(v2 + 4514) )
          {
            ...
            v36 = (*(_DWORD *)(v2 + 452) + 7) & 0xFFFFFFF8;
            if ( !v36 )
              v36 = 16;
            MasterIrp->AssociatedIrp.IrpCount = (*(_DWORD *)(v2 + 760) + 4095 + 16 * v36) & 0xFFFFF000;
            if ( !HIDWORD(MasterIrp->IoStatus.Information) )
              HIDWORD(MasterIrp->IoStatus.Information) = *((_DWORD *)v34 + 6);
            *(_QWORD *)&MasterIrp->RequestorMode = *(_QWORD *)(v2 + 712);
            MasterIrp->UserIosb = (_IO_STATUS_BLOCK *)(v2 + 776);
            if ( (*(_DWORD *)(v2 + 532) & 1) != 0 || (v37 = *(_DWORD *)(a1 + 3280), v37 == 10) || v37 == 1 )
