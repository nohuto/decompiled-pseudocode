/*
 * XREFs of RaUnitStorageQueryDeviceTemperaturePropertyIoctl @ 0x1C00487C0
 * Callers:
 ...
 *     RaidUnitLogSenseTemperatureSrb @ 0x1C0049ED4 (RaidUnitLogSenseTemperatureSrb.c)
 */
...
LABEL_7:
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(a1 + 24) + 532LL) & 0x20) == 0 )
  {
LABEL_16:
