/*
 * XREFs of RaidAdapterReleaseResources @ 0x1C0077970
 * Callers:
 ...
 *     RaAdapterDeregisterFromIdleDetection @ 0x1C003D550 (RaAdapterDeregisterFromIdleDetection.c)
 *     RaidFreeMappingList @ 0x1C004414C (RaidFreeMappingList.c)
