/*
 * XREFs of StorpTelemetryLogUnitPerfDataCriticalData @ 0x1C0053920
 * Callers:
...
void __fastcall StorpTelemetryLogUnitPerfDataCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0068058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v73 = &v18;
      v11 = v9[40];
      v18 = 3 * qword_1C0068640;
      v75 = v11;
      v76 = 8 * (unsigned __int16)(3 * qword_1C0068640);
      tlgWriteTransfer_EtwWriteTransfer(
        (3 * qword_1C0068640) & 0x1FFFFFFFFFFFFFFFLL,
        (unsigned __int8 *)dword_1C005E6BB,
        v12,
        v13,
        0x1Du,
        &v30);
