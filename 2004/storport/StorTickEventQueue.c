/*
 * XREFs of StorTickEventQueue @ 0x1C000F960
 * Callers:
 ...
 *     StorEtwHwTimeoutDetectedEvent @ 0x1C004E17C (StorEtwHwTimeoutDetectedEvent.c)
 *     StorEtwMiniportBugAbortTimeoutEvent @ 0x1C004EE9C (StorEtwMiniportBugAbortTimeoutEvent.c)
