/*
 * XREFs of RaidInitializeAdapter @ 0x1C0078078
 * Callers:
 ...
 *     RaidAllocateDeviceProperty @ 0x1C002F644 (RaidAllocateDeviceProperty.c)
    ...
    if ( (unsigned int)dword_1C0068058 > 5 )
    {
      if ( tlgKeywordOn(v41, 0x400000000000LL) )
      {
        ...
        *(_QWORD *)&v66[12].Size = 1LL;
        tlgWriteTransfer_EtwWriteTransfer(v42, (unsigned __int8 *)dword_1C005BD51, v43, v44, 0xDu, v66);
      }
    }
    KeInitializeDpc(
