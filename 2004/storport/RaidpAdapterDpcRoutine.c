/*
 * XREFs of RaidpAdapterDpcRoutine @ 0x1C000FAF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_33:
  ...
  else
  {
    ...
    if ( !ExQueryDepthSList((PSLIST_HEADER)(v4 + 224)) && *(_DWORD *)(v4 + 856) < 0xFFFFu )
      goto LABEL_16;
  }
...
LABEL_16:
  ...
  if ( v7 > *(_DWORD *)(v4 + 4852) )
    *(_DWORD *)(v4 + 4852) = v7;
  if ( StorEtwLoggingEnabled && (byte_1C0068843 & 4) != 0 && v7 >= 0x19 )
  {
