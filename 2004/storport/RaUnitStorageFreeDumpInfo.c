/*
 * XREFs of RaUnitStorageFreeDumpInfo @ 0x1C0048108
 * Callers:
 ...
 *     StorPortReleaseAdditionalCrashDumpArea @ 0x1C00135B8 (StorPortReleaseAdditionalCrashDumpArea.c)
...
LABEL_24:
    ...
    *(_QWORD *)(v11 + 8) = v12;
    ...
    if ( (int)RaidAcquireAdapterRemoveLock(v14) >= 0 )
    {
      ...
      StorPortReleaseAdditionalCrashDumpArea(v14 + 712, v13 + 64);
      if ( *(_WORD *)(v14 + 5154) )
      {
      ...
      ExReleaseRundownProtectionCacheAware(*(PEX_RUNDOWN_REF_CACHE_AWARE *)(v14 + 264));
    }
