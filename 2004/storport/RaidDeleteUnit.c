/*
 * XREFs of RaidDeleteUnit @ 0x1C001567C
 * Callers:
 ...
 *     RaidAdapterDisableQosWaitTimeoutCheck @ 0x1C002B818 (RaidAdapterDisableQosWaitTimeoutCheck.c)
 *     RaidSecondaryDumpDeregister @ 0x1C0056F1C (RaidSecondaryDumpDeregister.c)
 */
