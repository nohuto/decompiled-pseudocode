/*
 * XREFs of RaidAdapterStartDevice @ 0x1C002E9CC
 * Callers:
 ...
 *     RaidAdapterInitializeWmi @ 0x1C002C274 (RaidAdapterInitializeWmi.c)
 *     RaidAdapterPoFxIdleComponent @ 0x1C002C628 (RaidAdapterPoFxIdleComponent.c)
 *     RaidAdapterRegisterDeviceInterface @ 0x1C002CD28 (RaidAdapterRegisterDeviceInterface.c)
 *     RaidAdapterRegisterNonPoFxMiniportInterface @ 0x1C002CDA0 (RaidAdapterRegisterNonPoFxMiniportInterface.c)
 *     RaidAdapterRegisterRpmbInterface @ 0x1C002CE04 (RaidAdapterRegisterRpmbInterface.c)
...
__int64 __fastcall RaidAdapterStartDevice(char *Context, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 16LL, &WPP_026814134b593ed6508f665f094ed446_Traceguids, Context, a2);
  }
