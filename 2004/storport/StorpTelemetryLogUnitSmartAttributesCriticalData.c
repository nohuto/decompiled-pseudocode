/*
 * XREFs of StorpTelemetryLogUnitSmartAttributesCriticalData @ 0x1C0053FD4
 * Callers:
...
void __fastcall StorpTelemetryLogUnitSmartAttributesCriticalData(__int64 a1)
{
  ...
  if ( (unsigned int)dword_1C0068058 > 5 )
  {
    if ( tlgKeywordOn(a1, 0x800000000000LL) )
    {
      ...
      v103 = v11;
      v104 = 512LL;
      tlgWriteTransfer_EtwWriteTransfer((__int64)v11, (unsigned __int8 *)dword_1C005E9DE, v12, v13, 0x24u, &v40);
    }
  }
}
