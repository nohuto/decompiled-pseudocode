/*
 * XREFs of RaUnitScsiIrp @ 0x1C000A8C0
 * Callers:
 ...
 *     RaUnitCheckRemoveStateForDisabled @ 0x1C00464D8 (RaUnitCheckRemoveStateForDisabled.c)
 *     RaUnitFlushQueueSrb @ 0x1C00466CC (RaUnitFlushQueueSrb.c)
 *     RaUnitReleaseDeviceSrb @ 0x1C0046BAC (RaUnitReleaseDeviceSrb.c)
 *     RaUnitResetBusSrb @ 0x1C0046C30 (RaUnitResetBusSrb.c)
 *     RaUnitSwallowStopUnitCommand @ 0x1C0048B98 (RaUnitSwallowStopUnitCommand.c)
...
LABEL_24:
    ...
    && (v39 = RaUnitSwallowStopUnitCommand(a1)) != 0 )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_315ac634f457316aea96af95ee1292c6_Traceguids, a1, a2);
    }
    return v40;
  }
  else
