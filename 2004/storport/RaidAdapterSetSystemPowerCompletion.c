/*
 * XREFs of RaidAdapterSetSystemPowerCompletion @ 0x1C00139B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterSetSystemPowerCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 42LL, &WPP_e3909ed325cf3aaa071da1dbc70c911f_Traceguids, v2, a2);
  }
  v5 = *(_QWORD *)(a2 + 184);
  v6 = *(int *)(v5 + 24);
  v7.SystemState = (_SYSTEM_POWER_STATE)DeviceStateTable[v6];
  if ( *(_DWORD *)(v2 + 272) < (int)v6 )
  {
    v4 = 0;
    goto LABEL_5;
  }
...
LABEL_6:
  ...
  if ( v10 >= 0 )
  {
    v11 = (_DWORD)v6 != 1 && *(_DWORD *)(v2 + 272) < (int)v6;
    *(_DWORD *)(v2 + 280) = *(_DWORD *)(*(_QWORD *)(a2 + 184) + 32LL);
    *(_BYTE *)(v2 + 284) = v11;
    *(_DWORD *)(v2 + 272) = v6;
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 43LL, &WPP_e3909ed325cf3aaa071da1dbc70c911f_Traceguids, v2, a2, v10);
  }
