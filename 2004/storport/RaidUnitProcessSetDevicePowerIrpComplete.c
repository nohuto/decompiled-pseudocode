/*
 * XREFs of RaidUnitProcessSetDevicePowerIrpComplete @ 0x1C00118F8
 * Callers:
 ...
 *     RaidUnitReleasePoFx @ 0x1C0031F30 (RaidUnitReleasePoFx.c)
  ...
  *(POWER_STATE *)(Context + 492) = v5;
  ...
  else
  {
    ...
    if ( RaidUnitCheckAndAcquirePoFx(Context) )
    {
      ...
      if ( *(char *)(v18 + 110) < 0 && *(_DWORD *)(v18 + 5908) == *(_DWORD *)(v18 + 144) )
      {
        LOBYTE(v17) = 1;
