/*
 * XREFs of StorpAllocateContiguousMemorySpecifyCacheNodeEx @ 0x1C0039AA4
 * Callers:
...
__int64 StorpAllocateContiguousMemorySpecifyCacheNodeEx(__int64 a1, __int64 a2, ...)
{
  ...
  if ( *(_BYTE *)(v3 + 720) && *(_DWORD *)(v3 + 740) == 3 )
  {
    v4 = (*(__int64 (__fastcall **)(_QWORD, __int64 *, __int64 *, _QWORD, _DWORD, __int64 *, _DWORD, PHYSICAL_ADDRESS *))(*(_QWORD *)(*(_QWORD *)(v3 + 712) + 8LL) + 272LL))(
           *(_QWORD *)(v3 + 712),
           (__int64 *)va,
           (__int64 *)va1,
           (unsigned int)a2,
