/*
 * XREFs of RaInitializeDriver @ 0x1C0078D94
 * Callers:
 *     StorPortInitialize @ 0x1C0034DD0 (StorPortInitialize.c)
 * Callees:
 *     McGenEventRegister_EtwRegister @ 0x1C0033068 (McGenEventRegister_EtwRegister.c)
 *     RaidAddPortDriver @ 0x1C003449C (RaidAddPortDriver.c)
