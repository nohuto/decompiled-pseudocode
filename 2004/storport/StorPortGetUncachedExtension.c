/*
 * XREFs of StorPortGetUncachedExtension @ 0x1C0038570
 * Callers:
 *     StorPortGetUncachedExtensionVrfy @ 0x1C007E380 (StorPortGetUncachedExtensionVrfy.c)
 * Callees:
 *     RaidDmaAllocateUncachedExtension @ 0x1C0032E50 (RaidDmaAllocateUncachedExtension.c)
 *     StorpUpdateUncachedExtensionAllocationRegion @ 0x1C003C524 (StorpUpdateUncachedExtensionAllocationRegion.c)
...
__int64 __fastcall StorPortGetUncachedExtension(__int64 a1, __int64 a2, int a3)
{
  ...
  {
    if ( *(_DWORD *)(v7 + 760) )
      return *(_QWORD *)(v7 + 744);
    if ( (unsigned __int8)RaidIsDmaInitialized(v7 + 712)
      || (int)RaidInitializeDma(v8, *(_QWORD *)(v7 + 32), v7 + 312) >= 0 )
    {
      if ( !a2 )
        goto LABEL_27;
