/*
 * XREFs of RaidUnitResetUnit @ 0x1C004A610
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C00508E0 (StorpAggregateHierarchicalResetLun.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0068058 > 5 )
      {
        ...
        v29[0] = v18;
        v46 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v22, (unsigned __int8 *)dword_1C005C503, v18, v19, 0xAu, &v30);
      }
