/*
 * XREFs of RaidAdapterCheckWaitTimeout @ 0x1C002A7BC
 * Callers:
 *     RaidQueueWaitCheckDpcRoutine @ 0x1C0031BF0 (RaidQueueWaitCheckDpcRoutine.c)
 * Callees:
 ...
 *     RaidLunQueueCheckWaitTimeout @ 0x1C0033AB0 (RaidLunQueueCheckWaitTimeout.c)
 *     GatewayCheckWaitTimeout @ 0x1C004C730 (GatewayCheckWaitTimeout.c)
 */
