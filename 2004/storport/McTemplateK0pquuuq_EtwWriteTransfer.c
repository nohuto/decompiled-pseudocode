/*
 * XREFs of McTemplateK0pquuuq_EtwWriteTransfer @ 0x1C003CA2C
 * Callers:
 ...
 *     StorPortUnitDirectedPowerDownRequestD3 @ 0x1C0040408 (StorPortUnitDirectedPowerDownRequestD3.c)
...
NTSTATUS McTemplateK0pquuuq_EtwWriteTransfer(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  v14 = 1LL;
  v16 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(a1, a2, 0LL, 7u, &v4);
}
