/*
 * XREFs of RaidAdapterRequestComplete @ 0x1C000DA70
 * Callers:
 ...
 *     StorTickEventQueue @ 0x1C000F960 (StorTickEventQueue.c)
 *     RaidAdapterProgramCryptoKeyRoutine @ 0x1C002C730 (RaidAdapterProgramCryptoKeyRoutine.c)
 *     RaidpAdapterContinueDataBufferScatterGather @ 0x1C0031F60 (RaidpAdapterContinueDataBufferScatterGather.c)
 *     RaidUnitAbortSrbCompletion @ 0x1C0049430 (RaidUnitAbortSrbCompletion.c)
 * Callees:
 *     _tlgKeywordOn @ 0x1C0002AFC (_tlgKeywordOn.c)
 *     RaidLogMiniportCompletion @ 0x1C000DC30 (RaidLogMiniportCompletion.c)
...
char __fastcall RaidAdapterRequestComplete(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( (*(_BYTE *)(a1 + 552) & 2) != 0 && !a3 )
    _InterlockedIncrement((volatile signed __int32 *)(a1 + 5216));
  if ( a3 )
    goto LABEL_6;
  if ( (((unsigned __int64)qword_1C0068350 >> 3) & 1) != 0 )
      ...
      if ( v8 || (_BYTE)v7 == 1 )
      {
        if ( (unsigned int)dword_1C0068058 > 5 )
        {
          ...
          if ( (_BYTE)v7 )
          {
            ...
            LOBYTE(v7) = tlgWriteTransfer_EtwWriteTransfer((int)&v20, (int)&dword_1C005BF3D, v14, v15, 7u, &v20);
          }
        }
        return (char)v7;
      }
