/*
 * XREFs of StorEtwIORequestDispatch @ 0x1C004E424
 * Callers:
 ...
 *     StRtlIoStorInfoGetNvCachePriority @ 0x1C0059BA8 (StRtlIoStorInfoGetNvCachePriority.c)
 */
  ...
  if ( !v9 )
  {
    if ( ((v2 - 8) & 0x5F) != 0 )
    {
      ...
      if ( ((v2 - 10) & 0x5F) == 0 )
      {
        ...
        {
          if ( (byte_1C0068841 & 0x20) != 0 )
          {
            v14 = (const EVENT_DESCRIPTOR *)&EventPagingWriteRequest;
            goto LABEL_28;
          }
        }
        else if ( (byte_1C0068841 & 8) != 0 )
        {
    ...
    else
    {
      ...
      if ( (NvCachePriority & 0x42) != 0 )
      {
        if ( (byte_1C0068841 & 0x10) != 0 )
        {
          v14 = (const EVENT_DESCRIPTOR *)&EventPagingReadRequest;
          goto LABEL_28;
        }
      }
      else if ( (byte_1C0068841 & 4) != 0 )
      {
