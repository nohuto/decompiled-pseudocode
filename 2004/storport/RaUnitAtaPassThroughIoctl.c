 ...
 *     RaUnitSetAtaPassThroughCdb @ 0x1C00020F0 (RaUnitSetAtaPassThroughCdb.c)
  ...
  *(_QWORD *)&v42 = 0LL;
  ...
  if ( Status >= 0 )
  {
    ...
    if ( (_DWORD)MdlAddress_low )
    {
      ...
      if ( (unsigned int)MdlAddress_low > *(_DWORD *)(v20 + 336) || (unsigned int)v14 > v21 )
      {
        Status = -1073741811;
LABEL_17:
        v7 = 0LL;
    ...
    LOBYTE(v23) = *(_BYTE *)(*(_QWORD *)(a1 + 24) + 410LL);
