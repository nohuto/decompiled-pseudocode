/*
 * XREFs of RaWmiPassToMiniPort @ 0x1C0074424
 * Callers:
 *     RaWmiIrpRegisterRequest @ 0x1C00742FC (RaWmiIrpRegisterRequest.c)
 *     RaWmiIrpNormalRequest @ 0x1C007A880 (RaWmiIrpNormalRequest.c)
 * Callees:
 ...
 *     RaidBuildMdlAndLockPagesForXrb @ 0x1C001B9A8 (RaidBuildMdlAndLockPagesForXrb.c)
...
__int64 __fastcall RaWmiPassToMiniPort(__int64 a1, char a2, __int64 a3)
{
  ...
  if ( a2 == 9 && v8 <= **(_DWORD **)(a3 + 24) )
    v9 = **(_DWORD **)(a3 + 24);
  Srb = RaidAllocateSrb(*(_QWORD *)(v7 + 8), 0x17u, *(_BYTE *)(v7 + 410), 0);
  if ( !Srb
    || (ContiguousIoResources = StorAllocateContiguousIoResources(
                                  ((*(_DWORD *)(v7 + 452) + 7) & 0xFFFFFFF8) + 1088,
                                  v10,
                                  v7),
...
LABEL_20:
        if ( v3 )
        {
          RaidUnitPoFxActivateComponent(v3, 0, 1u, &v42);
        }
