/*
 * XREFs of StorpAdapterInitializePoFxPower @ 0x1C003970C
 * Callers:
 ...
 *     RaidInitPoFxPlaceHolderMode @ 0x1C001C158 (RaidInitPoFxPlaceHolderMode.c)
  ...
  if ( Pool )
  {
    ...
    *(_QWORD *)(v5 + 5088) = v16;
    ...
    if ( StorEtwLoggingEnabled )
    {
      ...
      if ( (_DWORD)v27 != -1 && (byte_1C0068841 & 1) != 0 )
      {
