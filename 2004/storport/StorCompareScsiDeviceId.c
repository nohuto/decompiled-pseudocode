/*
 * XREFs of StorCompareScsiDeviceId @ 0x1C0012694
 * Callers:
 *     StorCompareScsiIdentity @ 0x1C0018148 (StorCompareScsiIdentity.c)
 *     RaidCheckEnclosureIdMapping @ 0x1C003459C (RaidCheckEnclosureIdMapping.c)
 * Callees:
 *     StorGetNextVPDIdDescriptor @ 0x1C00127F8 (StorGetNextVPDIdDescriptor.c)
 *     StorInitVPDIdEnumeration @ 0x1C0012848 (StorInitVPDIdEnumeration.c)
 *     __security_check_cookie @ 0x1C001BE70 (__security_check_cookie.c)
 *     __report_rangecheckfailure @ 0x1C001BEB0 (__report_rangecheckfailure.c)
 *     memcmp @ 0x1C001D650 (memcmp.c)
 */
