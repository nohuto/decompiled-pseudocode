/*
 * XREFs of RaidAdapterCreateDevmapEntry @ 0x1C002B0D4
 * Callers:
 ...
 *     PortMapBuildAdapterEntry @ 0x1C0058624 (PortMapBuildAdapterEntry.c)
 *     PortMapBuildBusEntry @ 0x1C0058738 (PortMapBuildBusEntry.c)
 *     PortMapOpenKey @ 0x1C00588C0 (PortMapOpenKey.c)
 */
                ...
                (__int64)&Handle) >= 0 )
    {
      ...
      if ( *(_BYTE *)(a1 + 384) )
      {
        do
        {
          if ( v2 >= 0xFF )
            break;
          v5 = (unsigned __int8)v2 < 8u ? *(_BYTE *)((unsigned __int8)v2 + a1 + 385) : -1;
