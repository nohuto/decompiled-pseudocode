/*
 * XREFs of RaidAdapterDevicePowerstopAdapter @ 0x1C00116BC
 * Callers:
 ...
 *     RaidAdapterClearCryptoKeyTable @ 0x1C002AB8C (RaidAdapterClearCryptoKeyTable.c)
...
NTSTATUS __fastcall RaidAdapterDevicePowerstopAdapter(PIRP Irp, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 20LL, &WPP_e3909ed325cf3aaa071da1dbc70c911f_Traceguids, a2, Irp);
  }
  RaidAdapterStop(a2);
  ...
  *(_DWORD *)(a2 + 276) = LowPart;
  ...
  if ( *(char *)(a2 + 109) < 0 )
  {
    LODWORD(v9) = *(_DWORD *)(a2 + 692);
    *((_QWORD *)&v9 + 1) = *(_QWORD *)(a2 + 680);
