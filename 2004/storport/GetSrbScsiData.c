/*
 * XREFs of GetSrbScsiData @ 0x1C001B86C
 * Callers:
 *     RaUnitAtaPassThroughMarshalResults @ 0x1C0001F7C (RaUnitAtaPassThroughMarshalResults.c)
 ...
 *     StorPortGetPhysicalAddress @ 0x1C001AF00 (StorPortGetPhysicalAddress.c)
