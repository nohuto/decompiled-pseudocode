/*
 * XREFs of RaidUnitResetTarget @ 0x1C004A358
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C0050934 (StorpAggregateHierarchicalResetTarget.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0068058 > 5 )
      {
        ...
        v28 = v18;
        v42 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(8LL, (unsigned __int8 *)dword_1C005C491, v18, v19, 8u, &v30);
      }
