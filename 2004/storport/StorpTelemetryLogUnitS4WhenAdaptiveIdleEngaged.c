/*
 * XREFs of StorpTelemetryLogUnitS4WhenAdaptiveIdleEngaged @ 0x1C00115E0
 * Callers:
...
void __fastcall StorpTelemetryLogUnitS4WhenAdaptiveIdleEngaged(__int64 a1)
{
  ...
  if ( RaidUnitCheckAndAcquirePoFx(a1) )
  {
    ...
    if ( (v2 & 0x100) != 0 && (v2 & 0x200) != 0 && (unsigned int)dword_1C0068058 > 5 )
    {
      if ( tlgKeywordOn(v2, 0x400000000000LL) )
      {
        ...
        v14 = v5;
        v33 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v6, (int)&dword_1C005DE81, v7, v5, 0xBu, &v15);
      }
    }
