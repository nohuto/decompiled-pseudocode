/*
 * XREFs of PortPassThroughExMarshalResultsFromSrbEx @ 0x1C0058C80
 * Callers:
 *     PortpCompleteRequestIrp @ 0x1C0059480 (PortpCompleteRequestIrp.c)
 * Callees:
 *     memmove @ 0x1C001D740 (memmove.c)
 *     PortPassThroughExApplyNormalizedRequest @ 0x1C0058AC4 (PortPassThroughExApplyNormalizedRequest.c)
