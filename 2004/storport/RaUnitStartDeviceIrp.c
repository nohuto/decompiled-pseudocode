/*
 * XREFs of RaUnitStartDeviceIrp @ 0x1C00738F8
 * Callers:
 ...
 *     RaidIsUnitQueueLocked @ 0x1C0010838 (RaidIsUnitQueueLocked.c)
 *     RaidUnlockUnitQueue @ 0x1C0010848 (RaidUnlockUnitQueue.c)
 ...
 *     RaidUnitGetPowerCycleCount @ 0x1C001A7BC (RaidUnitGetPowerCycleCount.c)
 ...
 *     RaUnitInitializeWMI @ 0x1C0073570 (RaUnitInitializeWMI.c)
...
__int64 __fastcall RaUnitStartDeviceIrp(__int64 a1, IRP *a2)
{
  ...
  *(_QWORD *)(a1 + 3264) = 0x10000000LL;
  ...
  if ( *(_QWORD *)(a1 + 104) && (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(v7, 0x400000000000LL) )
  {
    v8 = *(_QWORD *)(a1 + 24);
    v36 = 16LL;
    v38 = 16LL;
    ...
    *(_QWORD *)&v33 = *(_QWORD *)(a1 + 3208);
    ...
    v73 = 4LL;
    v75 = 4LL;
    tlgWriteTransfer_EtwWriteTransfer((__int64)v10, (unsigned __int8 *)dword_1C005C2B7, v13, v14, 0x19u, &v34);
  }
