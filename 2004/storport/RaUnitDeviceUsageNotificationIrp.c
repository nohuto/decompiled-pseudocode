/*
 * XREFs of RaUnitDeviceUsageNotificationIrp @ 0x1C0012D94
 * Callers:
 ...
 *     RaidSecondaryDumpRegister @ 0x1C0056F64 (RaidSecondaryDumpRegister.c)
        ...
        if ( Lock )
        {
          ...
          *(_BYTE *)(v2 + 104) |= 0x80u;
          ...
          if ( (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(v10, 0x400000000000LL) )
          {
            ...
            tlgWriteTransfer_EtwWriteTransfer((int)&v37, (int)&dword_1C005C65A, v14, v15, 0xBu, &v37);
          }
        }
        else
        {
