/*
 * XREFs of RaidAdapterSetDevicePowerIrp @ 0x1C00112FC
 * Callers:
...
__int64 __fastcall RaidAdapterSetDevicePowerIrp(__int64 a1, IRP *a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 17LL, &WPP_e3909ed325cf3aaa071da1dbc70c911f_Traceguids, a1, a2);
  }
  v4 = *(_DWORD *)(a1 + 276);
...
LABEL_9:
  ...
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 19LL, &WPP_e3909ed325cf3aaa071da1dbc70c911f_Traceguids, a1, a2, v6);
  }
  return v7;
}
