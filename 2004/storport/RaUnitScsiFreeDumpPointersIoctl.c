/*
 * XREFs of RaUnitScsiFreeDumpPointersIoctl @ 0x1C00131D4
 * Callers:
...
__int64 __fastcall RaUnitScsiFreeDumpPointersIoctl(__int64 a1, IRP *a2, __int64 a3, __int64 a4)
{
  ...
  if ( *(_BYTE *)(a1 + 1733) == 1 && v4 )
  {
    ...
    *(_QWORD *)(v10 + 656) = RaidXrbSignalCompletion;
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 34LL, &WPP_315ac634f457316aea96af95ee1292c6_Traceguids, v10, Srb);
    }
    if ( *(_BYTE *)(v4 + 4514) )
