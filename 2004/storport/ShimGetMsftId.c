/*
 * XREFs of ShimGetMsftId @ 0x1C0057740
 * Callers:
 *     DeviceIdShimStorageDeviceIdCompletionHook @ 0x1C0057540 (DeviceIdShimStorageDeviceIdCompletionHook.c)
 * Callees:
 *     __security_check_cookie @ 0x1C001BE70 (__security_check_cookie.c)
 *     RaidAddEnclosureIdMapping @ 0x1C0034370 (RaidAddEnclosureIdMapping.c)
 *     RaidCheckEnclosureIdMapping @ 0x1C003459C (RaidCheckEnclosureIdMapping.c)
 *     RaidSaveEnclosureIdMapping @ 0x1C0034C0C (RaidSaveEnclosureIdMapping.c)
