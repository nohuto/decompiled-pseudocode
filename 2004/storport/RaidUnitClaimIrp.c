/*
 * XREFs of RaidUnitClaimIrp @ 0x1C0005540
 * Callers:
 ...
 *     RaidGetSystemAddressForMdl @ 0x1C0044384 (RaidGetSystemAddressForMdl.c)
 *     McTemplateK0dud_EtwWriteTransfer @ 0x1C0045258 (McTemplateK0dud_EtwWriteTransfer.c)
 *     StorpDataInBufferAllocateMdlAndLockPages @ 0x1C004B2F0 (StorpDataInBufferAllocateMdlAndLockPages.c)
 */
    ...
    if ( *(_BYTE *)(v38 + 410) == 1 )
    {
      ...
      result = TranslateToExtendedSrb(
                 ...
                 *(_DWORD *)(v4 + 744),
                 v39,
                 a3,
                 (*(_DWORD *)(*(_QWORD *)(v38 + 536) + 184LL) & 0x80) != 0);
      if ( (int)result < 0 )
      {
        *(_BYTE *)(v10 + 3) = 48;
