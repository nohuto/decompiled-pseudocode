/*
 * XREFs of McTemplateK0dqddddddiiiii_EtwWriteTransfer @ 0x1C00340EC
 * Callers:
...
NTSTATUS __fastcall McTemplateK0dqddddddiiiii_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a16)
{
  ...
  v41 = 8LL;
  v43 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(a1, &EventHwInitData, 0LL, 0xEu, &v17);
}
