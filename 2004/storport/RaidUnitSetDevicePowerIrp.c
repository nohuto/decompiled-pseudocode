/*
 * XREFs of RaidUnitSetDevicePowerIrp @ 0x1C001110C
 * Callers:
...
__int64 __fastcall RaidUnitSetDevicePowerIrp(struct _SLIST_ENTRY *Context, _SLIST_ENTRY *Irp)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 50LL, &WPP_e3909ed325cf3aaa071da1dbc70c911f_Traceguids, Context, Irp);
  }
  if ( *((_DWORD *)&Context[30].Next + 3) == 4 && *(_DWORD *)(*((_QWORD *)&Irp[11].Next + 1) + 24LL) == 1 )
  {
    ...
    if ( *(int *)(v2 + 276) > 1 )
    {
      ...
      *(_BYTE *)(*((_QWORD *)&Irp[11].Next + 1) + 3LL) |= 1u;
      ExpInterlockedPushEntrySList((PSLIST_HEADER)(v2 + 5072), Context + 121);
