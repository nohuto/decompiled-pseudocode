/*
 * XREFs of StorpCSEntryTelemetry @ 0x1C0050988
 * Callers:
    ...
    *(_QWORD *)(a1 + 5464) = 0LL;
    if ( v5 )
    {
      ...
      if ( (unsigned int)dword_1C0068058 > 5 && tlgKeywordOn(v5, 0x400000000000LL) )
      {
        ...
        v29 = v6;
        v61 = 8LL;
        tlgWriteTransfer_EtwWriteTransfer(v9, (unsigned __int8 *)dword_1C005F17F, v10, v11, 5u, &v55);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 7)) )
      {
        ...
        if ( (unsigned int)dword_1C0068058 > 5 )
        {
          if ( tlgKeywordOn(v14, 0x400000000000LL) )
          {
            ...
            v52 = 8LL;
            v54 = 4LL;
            tlgWriteTransfer_EtwWriteTransfer(v15, (unsigned __int8 *)dword_1C005E5DF, v16, v17, 0xDu, &v32);
          }
        }
