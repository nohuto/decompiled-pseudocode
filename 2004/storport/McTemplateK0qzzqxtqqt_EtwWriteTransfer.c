/*
 * XREFs of McTemplateK0qzzqxtqqt_EtwWriteTransfer @ 0x1C0029A50
 * Callers:
...
NTSTATUS __fastcall McTemplateK0qzzqxtqqt_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a12)
{
  ...
  struct _EVENT_DATA_DESCRIPTOR v20; // [rsp+40h] [rbp-99h] BYREF
  int *v21; // [rsp+50h] [rbp-89h]
  __int64 v22; // [rsp+58h] [rbp-81h]
  const wchar_t *v23; // [rsp+60h] [rbp-79h]
  int v24; // [rsp+68h] [rbp-71h]
  int v25; // [rsp+6Ch] [rbp-6Dh]
  const wchar_t *v26; // [rsp+70h] [rbp-69h]
  ...
  v38 = 4LL;
  v40 = 4LL;
  return McGenEventWrite_EtwWriteTransfer(v12, &EventInitializeStorageD3, 0LL, 0xAu, &v20);
}
