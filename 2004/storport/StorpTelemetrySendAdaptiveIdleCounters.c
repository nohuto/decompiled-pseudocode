/*
 * XREFs of StorpTelemetrySendAdaptiveIdleCounters @ 0x1C000232C
 * Callers:
 *     StorpLogPerUnitStatistics @ 0x1C000CD98 (StorpLogPerUnitStatistics.c)
 * Callees:
 *     _tlgKeywordOn @ 0x1C0002AFC (_tlgKeywordOn.c)
 *     RaidUnitGetMinimumPowerCyclePeriod @ 0x1C000704C (RaidUnitGetMinimumPowerCyclePeriod.c)
...
void __fastcall StorpTelemetrySendAdaptiveIdleCounters(__int64 a1)
{
  ...
  if ( (unsigned __int8)RaidUnitCheckAndAcquirePoFx() )
  {
    if ( (*(_DWORD *)(*(_QWORD *)(a1 + 1744) + 32LL) & 0x100) != 0 )
    {
      ...
      v2 = MEMORY[0xFFFFF78000000014] - *(_QWORD *)(a1 + 3208);
      if ( v2 > 0 )
      ...
      if ( (unsigned int)dword_1C0068058 > 5 )
      {
        if ( (unsigned __int8)tlgKeywordOn(v2, 0x400000000000LL) )
        {
          ...
          v46 = &v20;
          v47 = 8LL;
          tlgWriteTransfer_EtwWriteTransfer(v9, (int)&dword_1C005DA21, v3, v4, 0xFu, &v21);
        }
      }
