/*
 * XREFs of ndisReadNicBindProperties @ 0x1C0125298
 * Callers:
...
__int64 __fastcall ndisReadNicBindProperties(struct _GUID *a1, struct _GUID *a2)
{
  ...
  *a2 = v2;
  ...
  {
    m_ptr = (void **)&v8;
    v5 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D3600, (__int64)&a2[1]);
    if ( !v5 )
    {
      v5 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D35D0, (__int64)&a2[2]);
      if ( !v5 )
      {
        v5 = ndisBlowStringListIntoAtoms(&m_ptr, (const struct _NETSETUPPROPKEY *)&unk_1C00D35B8, (__int64)&a2[3]);
        if ( !v5 )
