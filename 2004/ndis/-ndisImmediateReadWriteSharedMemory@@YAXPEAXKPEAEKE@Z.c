/*
 * XREFs of ?ndisImmediateReadWriteSharedMemory@@YAXPEAXKPEAEKE@Z @ 0x1C00BDE30
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00BE060 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00BE110 (NdisImmediateWriteSharedMemory.c)
 * Callees:
