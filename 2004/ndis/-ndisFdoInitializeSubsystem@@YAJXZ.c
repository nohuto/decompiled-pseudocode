/*
 * XREFs of ?ndisFdoInitializeSubsystem@@YAJXZ @ 0x1C01462E8
 * Callers:
 ...
 *     ?ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z @ 0x1C01096B8 (-ndisCreateSecurityDescriptorEx@@YAJPEAXK@Z.c)
 *     ?CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z @ 0x1C0146448 (-CreateDeviceDriverSecurityDescriptor@@YAJPEAXEEPEAU_ACL@@@Z.c)
 */
