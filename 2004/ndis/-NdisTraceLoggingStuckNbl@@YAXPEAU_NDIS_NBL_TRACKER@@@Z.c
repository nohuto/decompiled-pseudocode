/*
 * XREFs of ?NdisTraceLoggingStuckNbl@@YAXPEAU_NDIS_NBL_TRACKER@@@Z @ 0x1C008C178
 * Callers:
...
LABEL_6:
    ...
    {
      v6 = (unsigned __int8 *)&unk_1C00CF78C;
...
LABEL_9:
  ...
  else if ( (unsigned int)dword_1C00E3108 > 5 && tlgKeywordOn((__int64)&dword_1C00E3108, 0x400000000000LL) )
  {
    v7 = v4 + 672;
    v21 = 1;
    v6 = (unsigned __int8 *)&unk_1C00CF6F5;
    goto LABEL_9;
  }
}
