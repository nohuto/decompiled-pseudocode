        ...
        PVOID SystemArgument2)
{
  ...
  if ( dword_1C00E4104 != -1 && MiniportSupportsReceiveThrottle(v4)
  ...
  {
    ndisQueueDpcWorkItem(v8, (_DWORD)v7, v12, (_DWORD)SystemArgument2, byte_1C00E4101);
    return;
  }
...
LABEL_40:
  ...
  ndisQueueDpcWorkItem((_DWORD)v36, (_DWORD)v7, v21, (_DWORD)SystemArgument2, byte_1C00E4101);
LABEL_28:
  if ( v15 )
  {
