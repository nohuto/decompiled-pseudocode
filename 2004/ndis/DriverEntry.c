 ...
 *     McGenEventRegister_EtwRegister @ 0x1C00329AC (McGenEventRegister_EtwRegister.c)
 *     ?ndisDoesSystemSupportSriov@@YAXXZ @ 0x1C0032D98 (-ndisDoesSystemSupportSriov@@YAXXZ.c)
 *     ?ndisRegisterPDCounterSets@@YAXXZ @ 0x1C00335D4 (-ndisRegisterPDCounterSets@@YAXXZ.c)
 ...
 *     ?ndisWppInitTracingEx@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z @ 0x1C00395F4 (-ndisWppInitTracingEx@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z.c)
 *     ?ndisVerifierInitialization@@YAEXZ @ 0x1C0039FB4 (-ndisVerifierInitialization@@YAEXZ.c)
 ...
 *     ??0NDIS_PD_GLOBAL@@QEAA@XZ @ 0x1C0108664 (--0NDIS_PD_GLOBAL@@QEAA@XZ.c)
 ...
 *     TraceLoggingRegisterEx_EtwRegister_EtwSetInformation @ 0x1C010B378 (TraceLoggingRegisterEx_EtwRegister_EtwSetInformation.c)
 *     ?ndisInitializeStackTraces@@YAXXZ @ 0x1C010B86C (-ndisInitializeStackTraces@@YAXXZ.c)
 ...
 *     ?ndisCreateGenericSD@@YAJPEAU_ACL@@PEAD@Z @ 0x1C0144304 (-ndisCreateGenericSD@@YAJPEAU_ACL@@PEAD@Z.c)
 *     ?ndisCreateAcl@@YAPEAU_ACL@@EEEEEEK@Z @ 0x1C01443D4 (-ndisCreateAcl@@YAPEAU_ACL@@EEEEEEK@Z.c)
 ...
 *     ?ndisMiniportFdoInitializeSubsystem@@YAJXZ @ 0x1C01459C0 (-ndisMiniportFdoInitializeSubsystem@@YAJXZ.c)
 *     ?ndisVBusNmrInitializeClient@@YAJXZ @ 0x1C0145A18 (-ndisVBusNmrInitializeClient@@YAJXZ.c)
 *     ndisGetProcessorInfo @ 0x1C0145AF8 (ndisGetProcessorInfo.c)
 *     ?ndisFdoInitializeSubsystem@@YAJXZ @ 0x1C01462E8 (-ndisFdoInitializeSubsystem@@YAJXZ.c)
...
NTSTATUS __stdcall DriverEntry(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    KeInitializeSpinLock(&qword_1C00E5E70);
    qword_1C00E6100 = (__int64)&qword_1C00E60F8;
    qword_1C00E60F8 = (__int64)&qword_1C00E60F8;
    KeInitializeSpinLock(&qword_1C00E5E78);
    qword_1C00E6110 = (__int64)&qword_1C00E6108;
    qword_1C00E6108 = (__int64)&qword_1C00E6108;
    qword_1C00E6040 = (__int64)&ndisGlobalPacketPoolList;
    ndisGlobalPacketPoolList.Flink = &ndisGlobalPacketPoolList;
    qword_1C00E4D08 = (__int64)&ndisGlobalTimerList;
    ...
    *(_QWORD *)&Parameters.PoolTag = 1684948046LL;
    qword_1C00E4B00 = (__int64)&g_ndisWatchdogList;
    ...
    *(_QWORD *)&v41.PoolTag = 1684948046LL;
    ...
    if ( (int)ndisGetProcessorInfo() >= 0 )
    {
      ...
      qword_1C00E4438 = (__int64)KeRegisterProcessorChangeCallback(
...
LABEL_43:
    ...
    *(_QWORD *)&Info.CounterCount = 10LL;
    ...
    qword_1C00E3FE0 = (__int64)ndisPktMonRegisterComponentsCallback;
    ...
    qword_1C00E3808 = (__int64)&qword_1C00E6108;
