/*
 * XREFs of ?ndisNotifyWmiAdapterArrival@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C003ED6C
 * Callers:
 *     NdisWdfNotifyWmiAdapterArrival @ 0x1C003D840 (NdisWdfNotifyWmiAdapterArrival.c)
