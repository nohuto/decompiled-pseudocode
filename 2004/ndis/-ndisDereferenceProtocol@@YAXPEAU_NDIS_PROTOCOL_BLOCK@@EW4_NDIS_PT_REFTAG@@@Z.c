/*
 * XREFs of ?ndisDereferenceProtocol@@YAXPEAU_NDIS_PROTOCOL_BLOCK@@EW4_NDIS_PT_REFTAG@@@Z @ 0x1C0029FB8
 * Callers:
 ...
 *     ??_G_NDIS_PROTOCOL_BLOCK@@QEAAPEAXI@Z @ 0x1C0096C90 (--_G_NDIS_PROTOCOL_BLOCK@@QEAAPEAXI@Z.c)
 */
