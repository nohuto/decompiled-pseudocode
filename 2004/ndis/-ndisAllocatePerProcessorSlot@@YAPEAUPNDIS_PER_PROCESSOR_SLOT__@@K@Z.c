/*
 * XREFs of ?ndisAllocatePerProcessorSlot@@YAPEAUPNDIS_PER_PROCESSOR_SLOT__@@K@Z @ 0x1C002CFD4
 * Callers:
 ...
 *     ?ndisInitializeRWLock@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAX@Z @ 0x1C00A4960 (-ndisInitializeRWLock@@YAEPEAU_NDIS_RW_LOCK_EX@@PEAX@Z.c)
 ...
 * Callees:
 *     ndisAllocateFreeSlotFromDescriptor @ 0x1C002D190 (ndisAllocateFreeSlotFromDescriptor.c)
