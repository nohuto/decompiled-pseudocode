/*
 * XREFs of NdisGetThreadObjectCompartmentId @ 0x1C0007B30
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  {
    v11 = 0;
    v12 = KeAcquireSpinLockRaiseToDpc(&qword_1C00E4B20);
    if ( ThreadSessionId < dword_1C00E6190 )
      v11 = *((_DWORD *)P + 6 * ThreadSessionId);
    KeReleaseSpinLock(&qword_1C00E4B20, v12);
    if ( !v11 )
      return 1;
    return v11;
  }
