/*
 * XREFs of ?NdisTraceLoggingRscHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C00204D8
 * Callers:
...
void __fastcall NdisTraceLoggingRscHardwareOffloads(
