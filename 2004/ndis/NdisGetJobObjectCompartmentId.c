/*
 * XREFs of NdisGetJobObjectCompartmentId @ 0x1C00B0B70
 * Callers:
 *     NdisGetProcessObjectCompartmentId @ 0x1C001DE00 (NdisGetProcessObjectCompartmentId.c)
 *     ?ndisNsiGetAllJobInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C00B0A00 (-ndisNsiGetAllJobInformation@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z.c)
