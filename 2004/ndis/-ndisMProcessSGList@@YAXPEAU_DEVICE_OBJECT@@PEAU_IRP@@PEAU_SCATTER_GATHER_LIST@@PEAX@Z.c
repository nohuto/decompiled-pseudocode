/*
 * XREFs of ?ndisMProcessSGList@@YAXPEAU_DEVICE_OBJECT@@PEAU_IRP@@PEAU_SCATTER_GATHER_LIST@@PEAX@Z @ 0x1C0063A20
 * Callers:
 *     <none>
 * Callees:
  ...
  else
  {
    ...
    else
    {
      v9 = (*(__int64 (__fastcall **)(__int64, struct _NDIS_PACKET *, _QWORD))(*(_QWORD *)(v7 + 3760) + 200LL))(
             ...
             v10->Private.Flags);
      if ( v9 != 259 )
        ndisMSendCompleteX((struct _NDIS_OBJECT_HEADER *)v7, v10, v9);
    }
  }
}
