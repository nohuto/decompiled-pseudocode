/*
 * XREFs of ?Reload@BindRegistry@Ndis@@YAJPEAU_NDIS_MINIPORT_BLOCK@@W4Flags@ReadBindingsOptions@2@@Z @ 0x1C0107AE8
 * Callers:
        ...
        enum Ndis::ReadBindingsOptions::Flags a3)
{
  ...
  v5 = 0;
  if ( *((_BYTE *)qword_1C00E45D8 + 97) && !ndisBuildBindings((const struct _GUID *)((char *)this + 4008), &v9)
