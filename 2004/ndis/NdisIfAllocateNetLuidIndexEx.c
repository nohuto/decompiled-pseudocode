/*
 * XREFs of NdisIfAllocateNetLuidIndexEx @ 0x1C0126670
 * Callers:
...
__int64 __fastcall NdisIfAllocateNetLuidIndexEx(__int16 a1, char a2, unsigned int *a3)
{
  return ndisIfAllocateAndVerifyNetLuidIndex(a1, a3, 1, (a2 & 1) == 0);
}
