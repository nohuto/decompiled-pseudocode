/*
 * XREFs of ndisReceiveWorkerThread @ 0x1C0037130
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisPeriodicReceivesGetTimerPeriod @ 0x1C00A3878 (ndisPeriodicReceivesGetTimerPeriod.c)
...
int *__fastcall ndisReceiveWorkerThread(ULONG a1)
{
  ...
  v2 = (KSPIN_LOCK *)((char *)qword_1C00E4140 + 64 * (unsigned __int64)a1);
  ...
  while ( 1 )
  {
    ...
    if ( v6 == v2 )
    {
      *((_DWORD *)qword_1C00E4138 + a1) = 0;
      KeCancelTimer((PKTIMER)((char *)qword_1C00E4130 + v8));
    }
    else
    {
      v9.QuadPart = ndisPeriodicReceivesGetTimerPeriod(v5, v8);
      KeSetTimer((PKTIMER)((char *)qword_1C00E4130 + v10), v9, (PKDPC)((char *)qword_1C00E4130 + v10 + 64));
    }
  ...
  if ( v3 != (_QWORD *)((char *)ndisPerCpuPoisonPills + 32 * a1) )
  {
    if ( (_BYTE)word_1C00E6184 )
    {
      ...
      *(_OWORD *)&v17.m256i_u64[2] = 0LL;
      ...
      WnodeEventItem = 56;
      v17.m256i_i64[0] = 0LL;
      *(_QWORD *)((char *)&v16 + 6) = qword_1C00E6178;
