/*
 * XREFs of NdisIMInitializeDeviceInstanceEx @ 0x1C00667C0
 * Callers:
 *     ?NdisIMInitializeDeviceInstance@@YAHPEAXPEAU_UNICODE_STRING@@@Z @ 0x1C0065EC0 (-NdisIMInitializeDeviceInstance@@YAHPEAXPEAU_UNICODE_STRING@@@Z.c)
 * Callees:
