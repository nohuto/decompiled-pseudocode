/*
 * XREFs of NdisSetSessionCompartmentId @ 0x1C00B0E90
 * Callers:
 *     ?ndisNsiSetAllSessionInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z @ 0x1C00B0E40 (-ndisNsiSetAllSessionInformation@@YAJPEAU_NM_REQUEST_SET_ALL_PARAMETERS@@@Z.c)
 * Callees:
 ...
 *     ?ndisCmLazyInitializeCleanup@@YAXXZ @ 0x1C00B0CFC (-ndisCmLazyInitializeCleanup@@YAXXZ.c)
 */
...
__int64 __fastcall NdisSetSessionCompartmentId(unsigned int a1, unsigned int a2)
{
  ...
  else
  {
    ...
    if ( P )
    {
      memmove(PoolWithTag, P, 24LL * (unsigned int)dword_1C00E6190);
      ExFreePoolWithTag(v12, 0);
    }
    memset(&PoolWithTag[24 * dword_1C00E6190], 0, 24LL * (unsigned int)(v6 - dword_1C00E6190));
...
LABEL_21:
  ...
  _InterlockedExchangeAdd(&dword_1C00E6188, 2u);
  return 0LL;
}
