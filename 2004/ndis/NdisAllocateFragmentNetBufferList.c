/*
 * XREFs of NdisAllocateFragmentNetBufferList @ 0x1C00AD0A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NdisAllocateNetBuffer @ 0x1C0017E70 (NdisAllocateNetBuffer.c)
 ...
 *     NetioCopyOpaqueNetBufferListInformation @ 0x1C00AD038 (NetioCopyOpaqueNetBufferListInformation.c)
        ...
        ULONG AllocateFragmentFlags)
{
  ...
  const struct _GUID *v41; // [rsp+28h] [rbp-58h]
  _BYTE v42[4]; // [rsp+80h] [rbp+0h] BYREF

  v8 = (unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL;
  *(_QWORD *)(v8 + 160) = 0LL;
  v9 = StartOffset;
  ...
  *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40) = v10;
  if ( (v11[15] & 1) != 0 )
  {
...
LABEL_54:
  ...
  {
    *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 4) = i;
    if ( !MdlChain )
      goto LABEL_53;
  ...
  v22 = DataLength - v9;
  v23 = ByteCount - i;
  *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 8) = v22;
  v24 = v22;
  if ( v23 <= v22 )
    v24 = v23;
  while ( !v24 )
...
LABEL_46:
  ...
  *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) = v26;
  Mdl = IoAllocateMdl(v26, v25, 0, 0, 0LL);
  *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x90) = Mdl;
  if ( !Mdl )
    goto LABEL_63;
  v28 = *(void **)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10);
  if ( v25 < v24 )
  {
    IoBuildPartialMdl(MdlChain, Mdl, v28, v25);
    i = v25 + *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 4);
    *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 4) = i;
  }
  else
  {
    ...
    i = *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 4);
  }
  v29 = *(_MDL **)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x90);
  v17 += v25;
  if ( v16->MdlChain )
  {
    **(_QWORD **)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0xA0) = v29;
  }
  else
  {
  ...
  v24 -= v25;
  v22 = *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 8) - v25;
  *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0xA0) = v29;
  v29->Next = 0LL;
  *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 8) = v22;
  if ( v22 )
  {
    ...
    else
    {
      ...
      i = 0;
      *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 4) = 0;
...
LABEL_43:
        if ( v30 )
        {
          v31 = *(void **)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40);
          *(_BYTE *)v8 = 0;
          ...
          i = *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 4);
          v17 = 0;
          v22 = *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 8);
...
LABEL_55:
    ...
    if ( v34 )
      goto LABEL_64;
    v36 = *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x80);
    NetioCopyOpaqueNetBufferListInformation((__int64)NetBufferAndNetBufferList, v36);
    if ( byte_1C00E3FD8 )
    {
      NetBufferAndNetBufferList->NetBufferListInfo[13] = *(void **)(v36 + 248);
    }
    else if ( Microsoft_Windows_Networking_CorrelationEnabled )
    {
      *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x88) = 0LL;
      *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x48) = 0LL;
      *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x80) = *(_QWORD *)(v36 + 248) & 0x7FFFFFFFFFFFFFFFLL;
      v38 = (__int64)NetBufferAndNetBufferList->NetBufferListInfo[13] & 0x7FFFFFFFFFFFFFFFLL;
      *(_OWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x90) = *(_OWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL)
                                                                                      + 0x80);
      *(_QWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40) = v38;
      LODWORD(v38) = Microsoft_Windows_Networking_CorrelationEnabled;
      *(_OWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0xA0) = *(_OWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL)
                                                                                      + 0x40);
      if ( (_DWORD)v38 )
    ...
    if ( *(int *)ndisNblTrackerMode >= 3 )
      ndisNblTrackerRecordEventInternal(NetBufferAndNetBufferList, 0LL, 7u, v36, 0);
    return NetBufferAndNetBufferList;
  }
  v9 = *(_DWORD *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0xC);
  if ( FirstNetBuffer->DataLength <= v9 )
    goto LABEL_54;
  v33 = NdisAllocateNetBuffer(*(NDIS_HANDLE *)(((unsigned __int64)v42 & 0xFFFFFFFFFFFFFFC0uLL) + 0x40), 0LL, 0, 0LL);
  if ( v33 )
  {
