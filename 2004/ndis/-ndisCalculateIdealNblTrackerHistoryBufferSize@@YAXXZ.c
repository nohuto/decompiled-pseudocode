/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1C011761C
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x1C0144F88 (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C003D700 (__security_check_cookie.c)
 *     memset @ 0x1C003FE40 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x1C01472E0 (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
