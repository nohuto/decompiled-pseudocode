/*
 * XREFs of WPP_RECORDER_SF_Si @ 0x1C0062264
 * Callers:
...
__int64 WPP_RECORDER_SF_Si(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, const wchar_t *a6, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x1000) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
  {
    ...
    if ( !a6 )
      v11 = L"NULL";
    ndisWppFastTraceMessage(&WPP_66115b70b0283e09187d30b01541a16f_Traceguids, 0x75u, v11, v10, va, 8LL, 0LL);
  }
  v12 = a6 == 0LL;
  if ( a6 )
  {
  ...
  if ( v12 )
    v6 = L"NULL";
  LOWORD(v14) = 117;
  return WppAutoLogTrace(a1, 4LL, 13LL, &WPP_66115b70b0283e09187d30b01541a16f_Traceguids, v14, v6);
}
