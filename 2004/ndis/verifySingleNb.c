/*
 * XREFs of verifySingleNb @ 0x1C0074DFC
 * Callers:
 *     verifySingleRxNbl @ 0x1C0074F18 (verifySingleRxNbl.c)
 *     verifySingleTxNbl @ 0x1C0074F60 (verifySingleTxNbl.c)
 * Callees:
 *     datapathVerifierReportProblem @ 0x1C0074780 (datapathVerifierReportProblem.c)
 *     validateMemoryPages @ 0x1C0074D08 (validateMemoryPages.c)
 *     verifySingleMdl @ 0x1C0074D98 (verifySingleMdl.c)
 */
