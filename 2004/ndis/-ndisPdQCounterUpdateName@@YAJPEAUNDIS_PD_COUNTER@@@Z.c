/*
 * XREFs of ?ndisPdQCounterUpdateName@@YAJPEAUNDIS_PD_COUNTER@@@Z @ 0x1C011D60C
 * Callers:
 ...
 *     ?ndisPdGetIfIndexVPortStr@@YAXPEAUNDIS_PD_ASSOCIATION@@PEA_WI@Z @ 0x1C007DFCC (-ndisPdGetIfIndexVPortStr@@YAXPEAUNDIS_PD_ASSOCIATION@@PEA_WI@Z.c)
 */
...
__int64 __fastcall ndisPdQCounterUpdateName(struct NDIS_PD_COUNTER *a1)
{
  ...
  if ( *((int *)a1 + 22) <= 1 )
  {
    ...
    {
      v10 = *((_OWORD *)a1 + 7);
      v4 = RtlStringCbPrintfW((wchar_t *)SourceString, 0x202uLL, (wchar_t *)L"%s: %wZ", v11, &v10);
    }
  }
  else
  {
