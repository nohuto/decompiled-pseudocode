/*
 * XREFs of ?ndisMergeOffloadCapsAndRegistry@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0031318
 * Callers:
...
void __fastcall ndisMergeOffloadCapsAndRegistry(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( a2->Header.Type == 0xA7 && a2->Header.Size >= 0x70u && a2->Header.Revision )
  {
    ...
    if ( (v3 & 0x300) == 0 && (((unsigned __int8)v3 | (unsigned __int8)(v3 >> 2)) & 0x30) == 0 )
    ...
    if ( (v5 & 0x300) == 0 && (((unsigned __int8)v5 | (unsigned __int8)(v5 >> 2)) & 0x30) == 0 )
    ...
    if ( (((unsigned __int8)v7 | (unsigned __int8)(v7 >> 6)) & 3) == 0 && (v7 & 0x30) == 0 )
    ...
    if ( (((unsigned __int8)v9 | (unsigned __int8)(v9 >> 6)) & 3) == 0 && (v9 & 0x30) == 0 )
    ...
    if ( Revision >= 2u && a2->Header.Size >= 0x90u )
    {
      v12 = a1->OffloadRegistry.Value;
      if ( (v12 & 0x400000) != 0 )
      {
