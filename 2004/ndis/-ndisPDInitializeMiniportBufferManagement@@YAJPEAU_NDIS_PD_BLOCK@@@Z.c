 ...
 *     ?ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z @ 0x1C011D1E0 (-ndisPDFindAndReferenceBMDomainUnderLock@@YAPEAUNDIS_PD_BM_DOMAIN@@K@Z.c)
 *     ?ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z @ 0x1C011D5C8 (-ndisPdAreBMsCompatible@@YAEPEBU_NDIS_PD_BLOCK@@PEBUNDIS_PD_BM_DOMAIN@@@Z.c)
 */
...
LABEL_13:
    ...
    v10 = qword_1C00E4538 + 8240;
    v11 = *(__int64 ***)(qword_1C00E4538 + 8248);
    if ( *v11 != (__int64 *)(qword_1C00E4538 + 8240) )
      goto LABEL_42;
    *v9 = v10;
    *((_QWORD *)v4 + 2) = v11;
    *v11 = v9;
