/*
 * XREFs of WPP_RECORDER_SF_Dqqqqd @ 0x1C000B910
 * Callers:
...
__int64 WPP_RECORDER_SF_Dqqqqd(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (*((_DWORD *)WPP_GLOBAL_Control + 11) & 0x400) != 0 && *((_BYTE *)WPP_GLOBAL_Control + 41) >= 4u )
    ndisWppFastTraceMessage(
      &WPP_0e2ec831e88c31193e413b6f3daa2a3f_Traceguids,
      0x10u,
      va,
      4LL,
      va1,
      ...
      0LL);
  LOWORD(v7) = 16;
  return WppAutoLogTrace(a1, 4LL, 11LL, &WPP_0e2ec831e88c31193e413b6f3daa2a3f_Traceguids, v7, (__int64 *)va);
}
