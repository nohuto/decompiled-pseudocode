/*
 * XREFs of ?ndisEnableWppTracingCallback@@YAXPEBU_GUID@@_JEKE@Z @ 0x1C00AACD4
 * Callers:
 *     WppClassicProviderCallback @ 0x1C00AB770 (WppClassicProviderCallback.c)
 ...
 *     ndisWppExtendedCallback @ 0x1C0038ED0 (ndisWppExtendedCallback.c)
