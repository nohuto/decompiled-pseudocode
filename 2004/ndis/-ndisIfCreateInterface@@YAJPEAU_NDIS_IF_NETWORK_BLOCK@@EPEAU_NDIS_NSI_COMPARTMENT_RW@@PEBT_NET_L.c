/*
 * XREFs of ?ndisIfCreateInterface@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@EPEAU_NDIS_NSI_COMPARTMENT_RW@@PEBT_NET_LUID_LH@@PEBU_GUID@@PEBUNdisNetworkInterfacePersistedState@@PEAU_NDIS_FILTER_BLOCK@@W4NdisIfBlockSource@@@Z @ 0x1C01056E8
 * Callers:
 ...
 *     ?ndisIfNdisProviderGetHandle@@YAPEAX_N@Z @ 0x1C002C0BC (-ndisIfNdisProviderGetHandle@@YAPEAX_N@Z.c)
...
LABEL_71:
          ...
          *(_QWORD *)(v13 + 632) = 1LL;
          if ( v44 )
          {
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00E4602);
            ...
            *(_WORD *)(v13 + 48) = Destination.Length;
            RtlInitUnicodeString(&DestinationString, &xmmword_1C00E4812);
            *(_DWORD *)&Destination.Length = 0x2000000;
