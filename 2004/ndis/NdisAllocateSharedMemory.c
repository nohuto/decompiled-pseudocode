/*
 * XREFs of NdisAllocateSharedMemory @ 0x1C0033C80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ndisGetAnyProcInsideNode@@YA?AU_PROCESSOR_NUMBER@@G@Z @ 0x1C0076218 (-ndisGetAnyProcInsideNode@@YA-AU_PROCESSOR_NUMBER@@G@Z.c)
