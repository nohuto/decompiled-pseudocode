/*
 * XREFs of ?ndisFindMiniportOnGlobalList@@YAPEAU_NDIS_MINIPORT_BLOCK@@PEBU_UNICODE_STRING@@@Z @ 0x1C01352A0
 * Callers:
...
struct _NDIS_MINIPORT_BLOCK *__fastcall ndisFindMiniportOnGlobalList(PCUNICODE_STRING SourceString)
{
  ...
  result = (struct _NDIS_MINIPORT_BLOCK *)ExAllocatePoolWithTag(
                                            NonPagedPoolNx,
