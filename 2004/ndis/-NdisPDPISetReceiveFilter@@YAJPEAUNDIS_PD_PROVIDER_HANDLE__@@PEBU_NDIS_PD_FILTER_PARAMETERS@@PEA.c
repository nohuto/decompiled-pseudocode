/*
 * XREFs of ?NdisPDPISetReceiveFilter@@YAJPEAUNDIS_PD_PROVIDER_HANDLE__@@PEBU_NDIS_PD_FILTER_PARAMETERS@@PEAPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C011BA40
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v13 <= 0xFFFFFFFF )
        {
          ...
          if ( (unsigned int)v13 <= HeaderGroupMatchArrayTotalSize )
          {
            ...
            *((_QWORD *)v4 + 12) = a2->RxFilterContext;
            v26.m_Lock = (KPushLockBase *)qword_1C00E4538;
