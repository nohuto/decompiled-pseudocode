/*
 * XREFs of NdisCoCreateVc @ 0x1C00B8480
 * Callers:
 *     <none>
 * Callees:
...
LABEL_27:
  ...
  if ( !v7 )
  {
    v9 = (*((__int64 (__fastcall **)(LARGE_INTEGER, _DWORD *, _DWORD *))NdisBindingHandle + 128))(v52[3], v10, v10 + 50);
    if ( v9 )
    {
  ...
  *v10 = 1;
  if ( !NdisAfHandle )
  {
    ...
    *((_QWORD *)v10 + 21) = *((_QWORD *)NdisBindingHandle + 132);
    v41 = *((_QWORD *)NdisBindingHandle + 133);
...
LABEL_58:
  ...
  if ( !v9 )
  {
    ...
    if ( Increment )
    {
      ExInterlockedInsertHeadList((PLIST_ENTRY)NdisBindingHandle + 69, (PLIST_ENTRY)v10 + 2, v32);
      *((_QWORD *)v10 + 13) = *v25;
      if ( *((_DWORD *)NdisAfHandle + 98) >= 6u )
    ...
    else
    {
      ...
      *((_QWORD *)v10 + 12) = *(_QWORD *)(*((_QWORD *)NdisAfHandle + 46) + 1048LL);
      ExInterlockedInsertHeadList((PLIST_ENTRY)NdisBindingHandle + 69, (PLIST_ENTRY)(v10 + 38), v32);
      v34 = *((_QWORD *)NdisAfHandle + 46);
      v35 = (_LIST_ENTRY *)(v10 + 8);
    }
    ExInterlockedInsertHeadList((PLIST_ENTRY)(v34 + 1104), v35, (PKSPIN_LOCK)(v34 + 232));
    goto LABEL_99;
  }
  if ( !v8 )
  {
