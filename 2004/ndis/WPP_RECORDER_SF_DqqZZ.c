/*
 * XREFs of WPP_RECORDER_SF_DqqZZ @ 0x1C003CC04
 * Callers:
...
__int64 __fastcall WPP_RECORDER_SF_DqqZZ(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, int a6, char a7)
{
  ...
  {
    v9 = &a7;
    ndisWppFastTraceMessage(&WPP_c229d34f9dad36469b52bf5a53ae9d53_Traceguids, 0xBu, v10);
  }
  LOWORD(v9) = 11;
  return WppAutoLogTrace(a1, 4LL, 9LL, &WPP_c229d34f9dad36469b52bf5a53ae9d53_Traceguids, (_DWORD)v9, v10);
}
