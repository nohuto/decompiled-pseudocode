/*
 * XREFs of ?RtlUnicodeStringCopy@@YAJPEAU_UNICODE_STRING@@PEBU1@@Z @ 0x1C0065ED8
 * Callers:
 ...
 * Callees:
 *     RtlUnicodeStringValidateWorker_0 @ 0x1C0065FB8 (RtlUnicodeStringValidateWorker_0.c)
 */
