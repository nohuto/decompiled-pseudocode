/*
 * XREFs of NdisCmDeregisterSapComplete @ 0x1C00B7C40
 * Callers:
 ...
 *     ?ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z @ 0x1C00B7A30 (-ndisDereferenceSap@@YAXPEAU_NDIS_CO_SAP_BLOCK@@@Z.c)
 */
