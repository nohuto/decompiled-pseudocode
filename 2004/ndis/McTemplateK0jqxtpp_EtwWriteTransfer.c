/*
 * XREFs of McTemplateK0jqxtpp_EtwWriteTransfer @ 0x1C0096558
 * Callers:
...
NTSTATUS __fastcall McTemplateK0jqxtpp_EtwWriteTransfer(
        __int64 a1,
        __int64 a2,
        const GUID *a3,
        __int64 a4,
        ...
        char a9)
{
  ...
  v20 = 8LL;
  v22 = 8LL;
  return McGenEventWrite_EtwWriteTransfer(NDIS_PROVIDER_ID_Context, &SetEnableWakeUpCompleted, a3, 7u, &v10);
}
