/*
 * XREFs of ?ndisIfNdisProvidedInterfaceSubsystemInitialize@@YAJXZ @ 0x1C0108518
 * Callers:
...
__int64 ndisIfNdisProvidedInterfaceSubsystemInitialize(void)
{
  ...
  *(_OWORD *)&Src.Reserved1 = 0LL;
  v0 = ndisIfRegisterProviderInternal(&Src, &qword_1C00E6130, &qword_1C00E6130);
  if ( v0 )
  {
    v3 = v0;
  ...
  Src.SetObjectHandler = (int (__fastcall *)(void *, unsigned int, unsigned int, void *))ndisIfSetObject;
  result = ndisIfRegisterProviderInternal(&Src, &qword_1C00E6128, &qword_1C00E6128);
  v2 = result;
  if ( (_DWORD)result )
  {
    NdisIfDeregisterProvider(&qword_1C00E6130);
    qword_1C00E6130 = 0LL;
    v3 = v2;
    return NdisConvertNdisStatusToNtStatus(v3);
  }
