 ...
 *     ?ndisNblTrackerUpdateOwnershipCount@@YAXT_NDIS_NBL_TRACKER_OWNER@@_JPEAE2@Z @ 0x1C00171A4 (-ndisNblTrackerUpdateOwnershipCount@@YAXT_NDIS_NBL_TRACKER_OWNER@@_JPEAE2@Z.c)
...
void __fastcall ndisMSendCompleteNetBufferListsInternal(_DWORD *a1, struct _NET_BUFFER_LIST *a2, unsigned int a3)
{
  ...
  unsigned int i; // r8d
  $1A1078C262B2F4247ED8F303116E1B94 *FirstNetBuffer; // rcx
  int j; // eax
  ...
  if ( (v44 & 0x280) != 0 || (v44 & 0x20000000000LL) != 0 )
  {
    ...
    if ( (v44 & 0x200) != 0 )
    {
      ...
      {
        FirstNetBuffer = ($1A1078C262B2F4247ED8F303116E1B94 *)Alignment->FirstNetBuffer;
        for ( j = 0; FirstNetBuffer; ++j )
          FirstNetBuffer = ($1A1078C262B2F4247ED8F303116E1B94 *)FirstNetBuffer->Link.Alignment;
