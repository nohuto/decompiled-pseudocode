/*
 * XREFs of ?ndisFIndicateStatusInternal@@YAXPEAU_NDIS_FILTER_BLOCK@@PEAU_NDIS_STATUS_INDICATION@@@Z @ 0x1C001A680
 * Callers:
 *     ?ndisFIndicateStatusWrapper@@YAXPEAX@Z @ 0x1C001A660 (-ndisFIndicateStatusWrapper@@YAXPEAX@Z.c)
