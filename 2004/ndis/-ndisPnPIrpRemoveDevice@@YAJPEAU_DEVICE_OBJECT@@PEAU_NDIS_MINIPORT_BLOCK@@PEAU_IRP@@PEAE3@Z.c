/*
 * XREFs of ?ndisPnPIrpRemoveDevice@@YAJPEAU_DEVICE_OBJECT@@PEAU_NDIS_MINIPORT_BLOCK@@PEAU_IRP@@PEAE3@Z @ 0x1C011DF34
 * Callers:
        ...
        unsigned __int8 *a5)
{
  ...
  if ( ndisIsMiniportStarted(a2) )
  {
    ...
    if ( (a2->Flags & 0x20000) != 0 )
      ndisDereferencePackage((PVOID *)&dword_1C00E30A8);
  }
