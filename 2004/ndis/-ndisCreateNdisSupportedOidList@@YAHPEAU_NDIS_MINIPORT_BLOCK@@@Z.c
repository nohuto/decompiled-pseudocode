/*
 * XREFs of ?ndisCreateNdisSupportedOidList@@YAHPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0038AD8
 * Callers:
  ...
  if ( PoolWithTag )
  {
    ...
    *((_OWORD *)PoolWithTag + 10) = *((_OWORD *)&ndisHandledNdis5Ndis6GenOids + 10);
    ...
    if ( a1->MajorNdisVersion >= 6u )
    {
      ...
      *((_OWORD *)v8 + 1) = *(_OWORD *)(0x1C0000000LL + 1317616);
      *((_OWORD *)v8 + 2) = *(_OWORD *)(0x1C0000000LL + 1317632);
      *((_OWORD *)v8 + 3) = *(_OWORD *)(0x1C0000000LL + 1317648);
      *((_OWORD *)v8 + 4) = *(_OWORD *)(0x1C0000000LL + 1317664);
      *((_OWORD *)v8 + 5) = *(_OWORD *)(0x1C0000000LL + 1317680);
      *((_OWORD *)v8 + 6) = *(_OWORD *)(0x1C0000000LL + 1317696);
      *((_OWORD *)v8 + 7) = *(_OWORD *)(0x1C0000000LL + 1317712);
      *((_OWORD *)v8 + 8) = *(_OWORD *)(0x1C0000000LL + 1317728);
      *((_QWORD *)v8 + 18) = *(_QWORD *)(0x1C0000000LL + 1317744);
    }
    if ( a1->MediaType == NdisMedium802_3 )
    {
