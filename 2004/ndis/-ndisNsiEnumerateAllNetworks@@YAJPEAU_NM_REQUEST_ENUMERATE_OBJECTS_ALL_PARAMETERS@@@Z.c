/*
 * XREFs of ?ndisNsiEnumerateAllNetworks@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C0020850
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllNetworks(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  v21 = v2;
  v5 = 0;
  if ( (__int64 *)qword_1C00E4B40 != &qword_1C00E4B40 )
  {
    do
    {
    ...
    while ( (__int64 *)v3 != &qword_1C00E4B40 );
    v4 = v21;
  }
  v9 = *((_DWORD *)a1 + 22);
  *((_DWORD *)a1 + 22) = v5;
...
LABEL_26:
  ...
  if ( (!v10 || *((_DWORD *)a1 + 6) == 16) && (!v11 || *((_DWORD *)a1 + 12) >= 0x210u) )
  {
    ...
    do
    {
      if ( (__int64 *)v12 == &qword_1C00E4B40 )
        break;
