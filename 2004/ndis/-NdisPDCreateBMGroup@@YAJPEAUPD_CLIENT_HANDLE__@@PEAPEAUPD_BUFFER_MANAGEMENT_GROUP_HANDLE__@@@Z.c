/*
 * XREFs of ?NdisPDCreateBMGroup@@YAJPEAUPD_CLIENT_HANDLE__@@PEAPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@@Z @ 0x1C0119F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisPDCreateBMGroup(struct PD_CLIENT_HANDLE__ *a1, struct PD_BUFFER_MANAGEMENT_GROUP_HANDLE__ **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( v6 )
  {
    v10.m_Lock = (KPushLockBase *)qword_1C00E4538;
    *((_QWORD *)v6 + 2) = a1;
