/*
 * XREFs of ndisDoPeriodicReceivesIndication @ 0x1C00A2644
 * Callers:
...
LABEL_18:
        ...
        {
          v16 = v15;
          v15->Flags = v15->Flags & 0xFFFFFFF0 | 4;
...
LABEL_48:
        if ( v5 )
        {
          if ( byte_1C00E3FD8 && (*((_DWORD *)&v4->PktMonComp + 13) & 2) != 0 )
            PktMonClientNblDropNdis((_DWORD)v4 + 5808, (_DWORD)v5, v18, 1, -1073676270, -536866809);
