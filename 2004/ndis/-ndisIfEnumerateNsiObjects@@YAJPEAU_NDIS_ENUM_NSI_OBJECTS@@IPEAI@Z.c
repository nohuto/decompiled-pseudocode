/*
 * XREFs of ?ndisIfEnumerateNsiObjects@@YAJPEAU_NDIS_ENUM_NSI_OBJECTS@@IPEAI@Z @ 0x1C01272EC
 * Callers:
 *     ?ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z @ 0x1C012BDB8 (-ndisHandlePnPRequest@@_Y2PAGENPNP@@AJPEAU_IRP@@@Z.c)
 * Callees:
 *     memset @ 0x1C003FE40 (memset.c)
 *     NdisIfGetNetLuidFromInterfaceIndex @ 0x1C00B1B90 (NdisIfGetNetLuidFromInterfaceIndex.c)
 */
    ...
    if ( NetLuidFromInterfaceIndex >= 0 )
    {
      ...
      if ( LODWORD(v32[13]) )
      {
        ...
        while ( 1 )
        {
          ...
          *((_DWORD *)a1 + 4) = 0;
          *((_DWORD *)a1 + 5) = v30 * 8;
          *((_DWORD *)a1 + 6) = v29 * 8 + v30 * 8;
          v3 = 1232 * v28;
          if ( *((_DWORD *)a1 + 7) < 1232 * v28 )
            break;
          LODWORD(v32[10]) = 656;
          v32[9] = &v7[v30];
          LODWORD(v32[12]) = 568;
