/*
 * XREFs of ndisReportTimeoutWaitingForExternalDriver @ 0x1C0121C98
 * Callers:
 ...
 *     ?ndisLiveBugCheck@@YAX_K000@Z @ 0x1C005EB9C (-ndisLiveBugCheck@@YAX_K000@Z.c)
 *     ?ndisMLiveBugCheck@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_K111@Z @ 0x1C005EBE4 (-ndisMLiveBugCheck@@YAXPEAU_NDIS_MINIPORT_BLOCK@@_K111@Z.c)
 *     ndisGetMiniportFromObject @ 0x1C0121C64 (ndisGetMiniportFromObject.c)
 */
