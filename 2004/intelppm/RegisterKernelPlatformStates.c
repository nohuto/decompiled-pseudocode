/*
 * XREFs of RegisterKernelPlatformStates @ 0x1C0036C6C
 * Callers:
 ...
 *     ValidatePlatformIdleState @ 0x1C002F304 (ValidatePlatformIdleState.c)
...
__int64 __fastcall RegisterKernelPlatformStates(__int64 a1)
{
  ...
  v1 = (unsigned int)dword_1C001C9AC;
  v2 = dword_1C001C414;
  if ( !dword_1C001C9AC )
    return 0;
  v4 = (48 * dword_1C001C9AC + 59) & 0xFFFFFFFC;
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v4 + 8 * dword_1C001C9AC * dword_1C001C414, 0x72637250u);
  v6 = PoolWithTag;
  if ( !PoolWithTag )
  {
  ...
  memset(PoolWithTag, 0, v4 + 8 * (_DWORD)v1 * v2);
  ...
  if ( (_DWORD)v1 )
  {
    ...
    while ( 1 )
    {
      ...
      *v8 = v9;
      v8[8] = v2;
      ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_QWORD, _DWORD *, _QWORD))qword_1C001C6C8)(
                                   *(_QWORD *)(a1 + 1104),
                                   v8,
                                   0LL);
...
LABEL_20:
  *(_DWORD *)v6 = 62;
  *((_DWORD *)v6 + 1) = dword_1C001C9AC;
  *((_DWORD *)v6 + 2) = dword_1C001C9AC;
  ...
  *((_QWORD *)v6 + 4) = PepIdleComplete;
  ProcessorNumberFromIndex = ((__int64 (__fastcall *)(char *))qword_1C001C658)(v6);
  if ( ProcessorNumberFromIndex >= 0 )
  {
    Src = v6;
    v6 = 0LL;
