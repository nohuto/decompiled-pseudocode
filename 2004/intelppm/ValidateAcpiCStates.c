/*
 * XREFs of ValidateAcpiCStates @ 0x1C0021208
 * Callers:
 ...
 *     IsValidAcpiGenericAddress @ 0x1C00215AC (IsValidAcpiGenericAddress.c)
 */
...
LABEL_29:
          ...
          case 1:
            goto LABEL_29;
          case 2:
            if ( !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001CE5C, v2, v4, v1) )
            {
              if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                goto LABEL_29;
              v16 = 26;
            ...
            break;
          default:
            if ( !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001CE74, v2, v4, v1)
              || !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001CE44, v10, v11, v12)
              || !(unsigned __int8)IsValidAcpiGenericAddress(&dword_1C001CE5C, v13, v14, v15) )
            {
              if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                goto LABEL_29;
              v16 = 27;
