/*
 * XREFs of ConnectHwpInterrupt @ 0x1C0006760
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ConnectHwpInterrupt(__int64 a1)
{
  ...
  if ( v1 && (*(_DWORD *)(v1 + 4) & 0x1000) != 0 )
  {
    ...
    v3 = IsHgsInterruptSupported() && qword_1C001C6F0 && (unsigned __int8)qword_1C001C6F0();
    ...
    if ( v6 >= 0 )
    {
      if ( HIBYTE(WPP_MAIN_CB.Queue.Wcb.CurrentIrp) )
      {
        v7 = __readmsr(0x1B1u);
        if ( (v7 & 0x4000000) != 0 )
          ((void (__fastcall *)(__int64))qword_1C001C6F8)(433LL);
      }
      return 0;
    }
    else if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
    {
      ...
      WPP_RECORDER_SF_D(
        ...
        3u,
        0xEu,
        (__int64)&WPP_839ec2002e32316adf7bb8cd76f5d3dc_Traceguids,
        v9);
    }
  }
  else
