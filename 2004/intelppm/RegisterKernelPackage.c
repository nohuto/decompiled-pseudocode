/*
 * XREFs of RegisterKernelPackage @ 0x1C0035DE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterKernelPackage(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 80) )
    ...
    v2 = ((__int64 (__fastcall *)(_QWORD))qword_1C001C720)(*(unsigned int *)(a1 + 56));
  v3 = v2;
  v4 = qword_1C001C450;
  if ( (__int64 *)qword_1C001C450 != &qword_1C001C450 )
  {
    ...
    while ( (__int64 *)v4 != &qword_1C001C450 );
    if ( v5 )
      goto LABEL_12;
  }
  ...
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)PoolWithTag + 9) = ((__int64 (__fastcall *)(_QWORD))qword_1C001C728)(v3);
    *(_DWORD *)(v5 + 36) += HalPrivateDispatchTable[145](v3);
    *(_QWORD *)(v5 + 24) = v5 + 16;
    *(_QWORD *)(v5 + 16) = v5 + 16;
    v8 = (__int64 *)qword_1C001C458;
    if ( *(__int64 **)qword_1C001C458 != &qword_1C001C450 )
      goto LABEL_15;
    *(_QWORD *)v5 = &qword_1C001C450;
    *(_QWORD *)(v5 + 8) = v8;
    *v8 = v5;
    qword_1C001C458 = v5;
LABEL_12:
