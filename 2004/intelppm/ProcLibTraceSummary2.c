/*
 * XREFs of ProcLibTraceSummary2 @ 0x1C0023958
 * Callers:
    ...
    if ( (_BYTE)EventDescriptorAndProcessorId )
    {
      ...
      else
      {
        if ( (v7 & 0x8000000) == 0 )
        {
          ...
          {
            v28 = 2;
            v11 = *(_DWORD *)(qword_1C001C900 + 28);
            v25 = v11;
            v26 = 100 * *(_DWORD *)(qword_1C001C900 + 36) / v11;
            v27 = 100 * *(_DWORD *)(qword_1C001C900 + 32) / v11;
          }
          else
          {
            if ( (v7 & 0x73300000) == 0 )
