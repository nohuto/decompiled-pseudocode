...
__int64 __fastcall AddSubspace(_QWORD *a1)
{
  ...
  v2 = (_QWORD *)qword_1C001C968;
  if ( *(__int64 **)qword_1C001C968 != &qword_1C001C960 )
    __fastfail(3u);
  *a1 = &qword_1C001C960;
  a1[1] = v2;
  *v2 = a1;
  ++dword_1C001C970;
  qword_1C001C968 = (__int64)a1;
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2536))(WdfDriverGlobals, qword_1C001C950);
