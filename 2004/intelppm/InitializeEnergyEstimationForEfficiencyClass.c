/*
 * XREFs of InitializeEnergyEstimationForEfficiencyClass @ 0x1C002440C
 * Callers:
...
__int64 __fastcall InitializeEnergyEstimationForEfficiencyClass(unsigned int a1)
{
  ...
  InitializeEnumerationContext((__int64)&qword_1C001C430, 32, (__int64)v12);
  ...
  if ( !(_DWORD)result )
  {
    ...
    *(__int64 *)((char *)&Globals + v1 + 1784) = 0LL;
    v5 = 0LL;
    *(__int64 *)((char *)&Globals + v1 + 1776) = 0LL;
    v6 = 0LL;
    result = *(unsigned int *)((char *)&Globals + v1 + 1576);
    if ( (_DWORD)result )
    {
      do
      {
        if ( (*(_DWORD *)((_BYTE *)&Globals + 12 * v6 + v1 + 1584) & 1) == 0 )
        {
          if ( (_DWORD)v6 != (_DWORD)v5 )
          {
            v7 = (char *)&Globals + v1;
            v8 = 3 * v5;
            *(_QWORD *)&v7[4 * v8 + 1580] = *(__int64 *)((char *)&Globals + 12 * v6 + v1 + 1580);
            *(_DWORD *)&v7[4 * v8 + 1588] = *(_DWORD *)((char *)&Globals + 12 * v6 + v1 + 1588);
          }
    ...
    {
      result = (__int64)memset((char *)&unk_1C001CA2C + 12 * v5 + v1, 0, 12LL * (unsigned int)(result - v5));
      *(_DWORD *)((char *)&Globals + v1 + 1576) = v5;
    }
    if ( (_DWORD)v5 )
    {
      ResetEnumerationContext((__int64 *)v12);
      ...
      {
LABEL_30:
        if ( *(__int64 *)((char *)&Globals + v1 + 1776) )
          return result;
      }
      else
      {
...
LABEL_7:
  if ( !*(__int64 *)((char *)&Globals + v1 + 1776) )
  {
    ...
    *(__int64 *)((char *)&Globals + v1 + 1776) = (__int64)ComputeProcessorEnergy;
  }
  return result;
}
