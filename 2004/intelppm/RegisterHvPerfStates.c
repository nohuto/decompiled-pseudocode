/*
 * XREFs of RegisterHvPerfStates @ 0x1C0030AF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeAcpiPStates @ 0x1C0037210 (DecodeAcpiPStates.c)
 *     DecodeAcpiTStates @ 0x1C00373B4 (DecodeAcpiTStates.c)
 */
...
LABEL_18:
    ...
    if ( v5 )
      v5[770] = dword_1C001C850;
    if ( v7 )
      v7[802] = dword_1C001C850;
    ++dword_1C001C850;
    v9 = 0;
