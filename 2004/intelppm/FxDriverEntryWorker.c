/*
 * XREFs of FxDriverEntryWorker @ 0x1C0001B40
 * Callers:
 *     FxDriverEntry @ 0x1C0001AB0 (FxDriverEntry.c)
 * Callees:
...
NTSTATUS __fastcall FxDriverEntryWorker(_DRIVER_OBJECT *DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  *(_DWORD *)&DestinationString.Length = 34078720;
  DestinationString.Buffer = (wchar_t *)&unk_1C001CC30;
    ...
    if ( v6 >= 0 )
    {
      ...
      else
      {
        ...
        if ( v8 >= 0 )
        {
          ...
          {
            DriverUnload = (void (__fastcall *)(_DRIVER_OBJECT *))qword_1C001C3F0;
            if ( DriverObject->DriverUnload )
              DriverUnload = DriverObject->DriverUnload;
            qword_1C001C3F0 = (__int64)DriverUnload;
