/*
 * XREFs of DecodeMWaitIdleState @ 0x1C0026160
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED && LOWORD(WPP_GLOBAL_Control->DeviceType) )
        WPP_RECORDER_SF_(
          ...
          3u,
          0xBu,
          (__int64)&WPP_0cb5d3cf777f39c45c134b1470a65817_Traceguids);
      v12 = *(_QWORD *)(a2 + 4);
      v13 = *(_BYTE *)(a2 + 3);
      *(_QWORD *)&v19 = v12;
      LODWORD(v20) = v13;
      *((_QWORD *)&v19 + 1) = *(_QWORD *)(a1 + 200);
      if ( (*(_DWORD *)(a1 + 280) & 0x80000) != 0 )
      ...
      if ( a8 )
      {
        *(_BYTE *)(a8 + 80) = 1;
        if ( (v13 & 2) == 0
          || (v18 = IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C001CE44) == 0, v15 = MWaitIdleCheck, v18) )
        {
          v15 = 0LL;
        }
        *(_QWORD *)(v14 + 16) = v15;
