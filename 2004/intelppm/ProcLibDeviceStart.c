/*
 * XREFs of ProcLibDeviceStart @ 0x1C0021A14
 * Callers:
...
__int64 __fastcall ProcLibDeviceStart(__int64 a1)
{
  ...
  *(_DWORD *)(a1 + 48) = v4;
  *(_DWORD *)(a1 + 52) = v63;
  v6 = ((__int64 (__fastcall *)(__int64))qword_1C001C810)(a1);
  v7 = v6;
  if ( v6 >= 0 )
  {
    if ( *v5 == -1 )
    ...
    *(_BYTE *)(a1 + 1161) = 1;
    ...
    if ( qword_1C001C540 )
    {
      v14 = AcpiEval_OSC(a1, (_DWORD *)qword_1C001C540, v13, &v56);
      if ( v14 >= 0 )
      {
        v15 = *v56;
        if ( (*v56 & 0xE) == 0 )
        ...
        if ( (v15 & 4) != 0 && WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
          WPP_RECORDER_SF_DDDDDDDDDDD(
            (__int64)WPP_GLOBAL_Control->DeviceExtension,
            *(unsigned __int8 *)(qword_1C001C540 + 13),
            *(unsigned __int8 *)(qword_1C001C540 + 12),
            *(unsigned __int8 *)(qword_1C001C540 + 11),
            Type);
...
LABEL_15:
        ...
        v44 = 2;
        v45 = 1;
        Sizeb[0] = *(_DWORD *)(qword_1C001C540 + 16);
LABEL_140:
        WPP_RECORDER_SF_D(
          (__int64)WPP_GLOBAL_Control->DeviceExtension,
          v44,
...
LABEL_136:
    if ( qword_1C001C538 )
      AcpiEval_PDC(a1, qword_1C001C538, (unsigned __int16)word_1C001C548);
LABEL_16:
...
LABEL_162:
      ...
      (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
        ...
        *(_QWORD *)(a1 + 208),
        0LL);
      v30 = ((__int64 (__fastcall *)(__int64))qword_1C001C7D8)(a1);
...
LABEL_97:
          if ( (int)ValidatePerfDomainSymmetry(a1) >= 0 )
          {
            ...
            {
              ((void (__fastcall *)(__int64))qword_1C001C808)(a1);
            }
            else if ( (v41 & 0x8000000) != 0 )
            {
              ((void (__fastcall *)(__int64))qword_1C001C800)(a1);
            }
            else if ( (v41 & 0x80000000) != 0 )
            {
              ((void (__fastcall *)(__int64))qword_1C001C7F8)(a1);
            }
            else
            {
              v42 = (void (__fastcall *)(__int64))qword_1C001C7E0;
              if ( (*(_QWORD *)(a1 + 272) & 0x73300000LL) == 0 )
                v42 = (void (__fastcall *)(__int64))qword_1C001C7F0;
              v42(a1);
            }
          }
          goto LABEL_78;
        }
        if ( !(unsigned int)((__int64 (__fastcall *)(__int64))qword_1C001C818)(a1) )
          goto LABEL_97;
      }
LABEL_78:
      if ( (*(_QWORD *)(a1 + 272) & 0x2000000000LL) != 0 && ++dword_1C001CC00 == dword_1C001C414 )
    ...
    if ( (v29 & 0x60000000) != 0 && *(_BYTE *)(a1 + 408) == 127 )
    {
      if ( (v29 & 0x20000000) != 0 )
      {
        *(_QWORD *)(a1 + 288) = qword_1C001C570;
        *(_QWORD *)(a1 + 320) = qword_1C001C598;
        *(_QWORD *)(a1 + 304) = qword_1C001C580;
      }
      if ( (v29 & 0x40000000) == 0 )
        goto LABEL_58;
      v29 &= ~0x400000uLL;
...
LABEL_58:
    if ( (v29 & 0x4000000) != 0 )
      *(_QWORD *)(a1 + 328) = qword_1C001C5A0;
    if ( (v29 & 0xA8000000) != 0 )
    {
      *(_QWORD *)(a1 + 344) = qword_1C001C5B0;
      *(_QWORD *)(a1 + 352) = qword_1C001C5B8;
    }
    if ( (v29 & 0x2000000) != 0 && *(_BYTE *)(a1 + 464) == 127 )
    {
      *(_QWORD *)(a1 + 296) = qword_1C001C578;
      *(_QWORD *)(a1 + 312) = qword_1C001C588;
    }
...
LABEL_84:
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C001C828, (__int64)&PPM_ETW_IDLE_STATES_ERROR_HV, 0, 0LL);
    v37 = *(_DWORD *)(a1 + 264);
    v38 = *(_QWORD *)(a1 + 272);
  }
  v39 = v37 & 0x40000000;
  ...
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C001C830, (__int64)&PPM_ETW_PERF_STATES_ERROR_HV, 0, 0LL);
    v37 = *(_DWORD *)(a1 + 264);
    v38 = *(_QWORD *)(a1 + 272);
  }
  if ( ((unsigned int)v38 & v37 & 0x3300000) != (unsigned __int64)(v37 & 0x3300000) )
  {
    ProcLibTraceProcessorSpecificEvent(a1, qword_1C001C838, (__int64)&PPM_ETW_THROTTLE_STATES_ERROR_HV, 0, 0LL);
    v37 = *(_DWORD *)(a1 + 264);
    v38 = *(_QWORD *)(a1 + 272);
  }
