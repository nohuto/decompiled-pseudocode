/*
 * XREFs of AcquirePccInterface @ 0x1C00224A8
 * Callers:
...
__int64 __fastcall AcquirePccInterface(__int64 a1)
{
  ...
  else
  {
    ...
    {
      PccInternalInterfaceInfo = ValidatePccHeader(qword_1C001C900);
      if ( PccInternalInterfaceInfo < 0 )
        goto LABEL_9;
      ...
      {
LABEL_9:
        ((void (__fastcall *)(__int64))qword_1C001C8D0)(qword_1C001C8C0);
        memset(&unk_1C001C8B8, 0, 0x80uLL);
      }
    }
  }
