/*
 * XREFs of RegisterHvPackage @ 0x1C00308A0
 * Callers:
 *     <none>
 * Callees:
 *     _guard_dispatch_icall_nop @ 0x1C00044E0 (_guard_dispatch_icall_nop.c)
 *     GetHvPackage @ 0x1C002F7D4 (GetHvPackage.c)
 */
...
__int64 __fastcall RegisterHvPackage(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      0LL);
    v3 = qword_1C001C450;
    if ( (__int64 *)qword_1C001C450 == &qword_1C001C450 )
      goto LABEL_6;
    do
    {
      HvPackage = (_OWORD *)v3;
    ...
    while ( (__int64 *)v3 != &qword_1C001C450 );
    if ( !HvPackage )
    {
LABEL_6:
...
LABEL_11:
      ...
      v5 = (_QWORD *)qword_1C001C458;
      if ( *(__int64 **)qword_1C001C458 != &qword_1C001C450 )
LABEL_13:
        __fastfail(3u);
      *(_QWORD *)HvPackage = &qword_1C001C450;
      *((_QWORD *)HvPackage + 1) = v5;
      *v5 = HvPackage;
      qword_1C001C458 = (__int64)HvPackage;
    }
