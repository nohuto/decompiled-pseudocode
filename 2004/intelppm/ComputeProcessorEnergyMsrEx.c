/*
 * XREFs of ComputeProcessorEnergyMsrEx @ 0x1C0005F10
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a5)
{
  ...
  if ( (WPP_MAIN_CB.DeviceQueue.Type & 0x40) != 0 )
  {
    ...
    v84 = 0LL;
    *(_QWORD *)&v80 = 0LL;
    *(_QWORD *)&v79 = &qword_1C001C430;
    *((_QWORD *)&v79 + 1) = &qword_1C001C430;
    v83 = 0LL;
    ...
    while ( !(unsigned int)EnumerateNextDevice((__int64 *)&v79, &v76) )
    {
      ...
      v85[0] = 3LL;
      v23 = (unsigned __int64 *)(*(_QWORD *)(v76 + 360) + 24LL);
      do
      {
        v24 = *v23;
        v25 = *(v23 - 1);
    ...
    if ( (v27 = 1000000 * v77 / (qword_1C001CC08 * (unsigned __int64)(unsigned int)dword_1C001CC00)) == 0
      || !(_QWORD)v83
      || (v83 < 0
...
LABEL_60:
    if ( HIDWORD(WPP_MAIN_CB.Dpc.DpcData) )
    {
      v49 = qword_1C001CC10 * v27;
      if ( ((qword_1C001CC10 * v27) & 0x8000000000000000uLL) != 0LL )
      {
        v51 = v49 & 1 | ((qword_1C001CC10 * v27) >> 1);
