/*
 * XREFs of RegisterKernelPepPerf @ 0x1C0036610
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PepTranslateLimitReason @ 0x1C0039A3C (PepTranslateLimitReason.c)
 */
...
__int64 __fastcall RegisterKernelPepPerf(__int64 a1)
{
  ...
  v50 = 0;
  memset(v48, 0, 32);
  v2(WdfDriverGlobals, qword_1C001C418, 0LL);
  v3 = *(_QWORD *)(a1 + 1176);
  v4 = 0LL;
  v5 = 0LL;
  v45 = *(_DWORD *)(v3 + 16);
...
LABEL_17:
    ...
    *((_DWORD *)v4 + 9) = 1;
    ...
    v6 = ((__int64 (__fastcall *)(_QWORD *))qword_1C001C628)(v4);
    if ( v6 < 0 )
    {
      if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
        goto LABEL_66;
