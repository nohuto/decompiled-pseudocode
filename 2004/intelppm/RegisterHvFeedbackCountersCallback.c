/*
 * XREFs of RegisterHvFeedbackCountersCallback @ 0x1C002FE90
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeGenAddressToHvPerfReg @ 0x1C002F6DC (DecodeGenAddressToHvPerfReg.c)
 */
...
__int64 __fastcall RegisterHvFeedbackCountersCallback(__int64 a1)
{
  ...
  bool v21; // al
  __int64 v22; // rcx
  __int64 (__fastcall *v23)(__int64, char, _QWORD *, _QWORD *); // rax
  __int64 v24; // rax
          ...
          *v14 = 0;
          ...
          for ( j = 0; (unsigned int)v17 < *(_DWORD *)(a1 + 36); v30 = v13 )
          {
            ...
            if ( *(_BYTE *)(v18 + 24 * v17 + 17) && *(_BYTE *)(v18 + 24 * v17 + 16) )
            {
              ...
              {
                v23 = *(__int64 (__fastcall **)(__int64, char, _QWORD *, _QWORD *))(v18 + 24 * v17);
