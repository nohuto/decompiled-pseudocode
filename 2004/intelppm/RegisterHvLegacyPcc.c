/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C0030390
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C0031168 (DecodeDoorbellAddressIo.c)
 */
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  v19 = dword_1C001C8A8;
  v14 = 0LL;
  if ( (unsigned __int8)qword_1C001C8A0 <= 1u )
  {
    v3 = qword_1C001C898;
    v5 = qword_1C001C890;
    if ( (_BYTE)qword_1C001C8A0 == 1 )
    {
  ...
  if ( v9 >= 0 )
  {
    HIDWORD(v23[0]) = dword_1C001C850;
    v23[2] = qword_1C001C880;
    LODWORD(v23[3]) = dword_1C001C888;
    v23[6] = v5 << v4;
    v23[5] = v3 << v4;
