/*
 * XREFs of BuildReadWriteCommand @ 0x1C000FAC8
 * Callers:
 *     MdlToPrp @ 0x1C0003FE0 (MdlToPrp.c)
 * Callees:
 *     GetLbaFromCdb @ 0x1C0010FD4 (GetLbaFromCdb.c)
 *     GetStreamId @ 0x1C0011038 (GetStreamId.c)
 */
...
LABEL_11:
  ...
  *(_DWORD *)(a5 + 4) = a6;
  *(_QWORD *)(a5 + 16) = 0LL;
  v14 = *(_DWORD *)(*(_QWORD *)(a1 + 8 * v11 + 1720) + 52LL);
