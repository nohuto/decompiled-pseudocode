/*
 * XREFs of ScsiSanitizeRequest @ 0x1C00157F4
 * Callers:
...
__int64 __fastcall ScsiSanitizeRequest(__int64 a1, __int64 a2)
{
  ...
  if ( v10 < 0
    ...
    || (*(_BYTE *)(v7 + 256) & 2) == 0
    || *(_DWORD *)(a1 + 188) > 1u && (*(_BYTE *)(v7 + 524) & 2) != 0
  ...
  {
    v12 = *(unsigned __int8 *)(*(_QWORD *)(a1 + 8 * v9 + 1720) + 64LL);
    if ( v11 == 3 )
      v13 = 2;
    else
      v13 = v11 == 2;
    *(_BYTE *)(SrbExtension + 4253) = *(_BYTE *)(SrbExtension + 4253) & 0xFC | 1;
    ...
    v15 = *(_WORD *)(*(_QWORD *)(a1 + 8 * v9 + 1720) + 48LL);
    v16 = *(_QWORD *)(a1 + 1608);
