 ...
 *     IoctlStorageStreamsGetOpenStreams @ 0x1C0012158 (IoctlStorageStreamsGetOpenStreams.c)
 *     IoctlStorageStreamsGetParameters @ 0x1C001230C (IoctlStorageStreamsGetParameters.c)
 *     IoctlStorageStreamsReleaseId @ 0x1C00126C0 (IoctlStorageStreamsReleaseId.c)
