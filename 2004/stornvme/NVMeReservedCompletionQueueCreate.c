/*
 * XREFs of NVMeReservedCompletionQueueCreate @ 0x1C0019C80
 * Callers:
 *     IoctlCreateReservedQueuePair @ 0x1C001112C (IoctlCreateReservedQueuePair.c)
 * Callees:
 ...
 *     GetFreeReservedQueueIndex @ 0x1C0010F8C (GetFreeReservedQueueIndex.c)
