/*
 * XREFs of ??$MakeAndInitialize@VEventTargetArray@Details@WRL@Microsoft@@V1234@_K@Details@WRL@Microsoft@@YAJPEAPEAVEventTargetArray@012@$$QEA_K@Z @ 0x140010F50
 * Callers:
 ...
 *     ??0EventTargetArray@Details@WRL@Microsoft@@QEAA@XZ @ 0x140011114 (--0EventTargetArray@Details@WRL@Microsoft@@QEAA@XZ.c)
