/*
 * XREFs of ??1?$com_ptr_t@VCInPlaceBuffer@@Uerr_returncode_policy@wil@@@wil@@QEAA@XZ @ 0x14003BD40
 * Callers:
 *     _CPipeInstance::CreateAPOConnections_::_1_::dtor$0 @ 0x140021AB0 (_CPipeInstance--CreateAPOConnections_--_1_--dtor$0.c)
 * Callees:
