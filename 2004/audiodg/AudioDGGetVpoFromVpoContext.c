/*
 * XREFs of AudioDGGetVpoFromVpoContext @ 0x140043F20
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?FindKey@?$CSimpleMap@KPEAVCVpoContext@@V?$CSimpleMapEqualHelper@KPEAVCVpoContext@@@ATL@@@ATL@@QEBAHAEBK@Z @ 0x140043940 (-FindKey@-$CSimpleMap@KPEAVCVpoContext@@V-$CSimpleMapEqualHelper@KPEAVCVpoContext@@@ATL@@@ATL@@Q.c)
 */
...
__int64 __fastcall AudioDGGetVpoFromVpoContext(__int64 a1, int a2, __int64 a3, unsigned int a4, __int64 *a5)
{
  ...
  if ( Key == -1 )
    goto LABEL_14;
  if ( Key < 0 || Key >= (int)qword_140085258 )
  {
