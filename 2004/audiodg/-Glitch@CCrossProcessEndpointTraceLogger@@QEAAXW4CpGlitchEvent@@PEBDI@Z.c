/*
 * XREFs of ?Glitch@CCrossProcessEndpointTraceLogger@@QEAAXW4CpGlitchEvent@@PEBDI@Z @ 0x140059484
 * Callers:
        ...
        __int64 a4)
{
  ...
  v11 = a4;
  v7 = 1;
  if ( (unsigned int)dword_140084010 > 5 && (byte_140084020 & 2) != 0 && (qword_140084028 & 2) == qword_140084028 )
  {
    v10 = a2;
    v9[0] = a1 + 8;
    v11 = 1;
