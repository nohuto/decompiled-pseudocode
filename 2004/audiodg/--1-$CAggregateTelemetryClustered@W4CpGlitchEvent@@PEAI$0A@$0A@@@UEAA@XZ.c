/*
 * XREFs of ??1?$CAggregateTelemetryClustered@W4CpGlitchEvent@@PEAI$0A@$0A@@@UEAA@XZ @ 0x140016A88
 * Callers:
 *     ??1CCrossProcessBaseEndpoint@@UEAA@XZ @ 0x1400169C4 (--1CCrossProcessBaseEndpoint@@UEAA@XZ.c)
 *     ??1CCrossProcessEndpointTraceLogger@@UEAA@XZ @ 0x1400590AC (--1CCrossProcessEndpointTraceLogger@@UEAA@XZ.c)
