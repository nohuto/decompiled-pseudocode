/*
 * XREFs of ?CreateSystemEffect@CAPOWrapperSrv@@UEAAJU_GUID@@PEBGW4APO_TYPE@@AEBU2@PEAPEAUIAudioProcessingObject@@@Z @ 0x140009F30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CSystemEffectWrapper@@QEAA@XZ @ 0x14000AF6C (--0CSystemEffectWrapper@@QEAA@XZ.c)
