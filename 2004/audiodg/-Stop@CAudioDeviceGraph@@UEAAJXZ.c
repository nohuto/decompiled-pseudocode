/*
 * XREFs of ?Stop@CAudioDeviceGraph@@UEAAJXZ @ 0x140002E00
 * Callers:
 *     <none>
 * Callees:
 *     ?ResetAPOs@CPipeInstance@@QEBAXXZ @ 0x140003030 (-ResetAPOs@CPipeInstance@@QEBAXXZ.c)
 *     ?Stop@CPipeInstance@@QEAAJXZ @ 0x140003100 (-Stop@CPipeInstance@@QEAAJXZ.c)
 *     ?Stop@DurationTracker@CAudioDeviceGraph@@QEAA?AUDurationInformation@2@XZ @ 0x1400046C0 (-Stop@DurationTracker@CAudioDeviceGraph@@QEAA-AUDurationInformation@2@XZ.c)
