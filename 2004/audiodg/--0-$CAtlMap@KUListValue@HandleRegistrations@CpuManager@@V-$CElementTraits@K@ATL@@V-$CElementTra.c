/*
 * XREFs of ??0?$CAtlMap@KUListValue@HandleRegistrations@CpuManager@@V?$CElementTraits@K@ATL@@V?$CElementTraits@UListValue@HandleRegistrations@CpuManager@@@5@@ATL@@QEAA@IMMMI@Z @ 0x140013C6C
 * Callers:
 *     ??0HandleRegistrations@CpuManager@@QEAA@XZ @ 0x140013C34 (--0HandleRegistrations@CpuManager@@QEAA@XZ.c)
 * Callees:
