/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@MH@Z @ 0x14000C690
 * Callers:
 ...
 * Callees:
 *     ??0CAudioMediaType@@IEAA@XZ @ 0x14000C978 (--0CAudioMediaType@@IEAA@XZ.c)
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x14000FE74 (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
