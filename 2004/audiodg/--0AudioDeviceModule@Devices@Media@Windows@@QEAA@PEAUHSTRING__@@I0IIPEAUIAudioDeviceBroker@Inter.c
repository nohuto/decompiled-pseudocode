/*
 * XREFs of ??0AudioDeviceModule@Devices@Media@Windows@@QEAA@PEAUHSTRING__@@I0IIPEAUIAudioDeviceBroker@Internal@123@@Z @ 0x14004AA00
 * Callers:
 ...
 *     ?Set@HString@Wrappers@WRL@Microsoft@@QEAAJAEBQEAUHSTRING__@@@Z @ 0x140051498 (-Set@HString@Wrappers@WRL@Microsoft@@QEAAJAEBQEAUHSTRING__@@@Z.c)
 */
        ...
        struct Windows::Media::Devices::Internal::IAudioDeviceBroker *a7)
{
  ...
  *((_DWORD *)this + 16) = a5;
  *((_DWORD *)this + 17) = a6;
  Microsoft::WRL::ComPtr<ISpatialAudioResourceTaskCompletion>::operator=((char *)this + 96, v11);
  return this;
}
