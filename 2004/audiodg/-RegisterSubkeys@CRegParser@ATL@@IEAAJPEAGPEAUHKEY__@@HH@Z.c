/*
 * XREFs of ?RegisterSubkeys@CRegParser@ATL@@IEAAJPEAGPEAUHKEY__@@HH@Z @ 0x140056084
 * Callers:
 ...
 *     ?AtlHresultFromWin32@ATL@@YAJK@Z @ 0x140053F8C (-AtlHresultFromWin32@ATL@@YAJK@Z.c)
 *     ?CanForceRemoveKey@CRegParser@ATL@@IEAAHPEBG@Z @ 0x140053FA4 (-CanForceRemoveKey@CRegParser@ATL@@IEAAHPEBG@Z.c)
 ...
 *     ?HasSubKeys@CRegParser@ATL@@IEAAHPEAUHKEY__@@@Z @ 0x140054CE0 (-HasSubKeys@CRegParser@ATL@@IEAAHPEAUHKEY__@@@Z.c)
