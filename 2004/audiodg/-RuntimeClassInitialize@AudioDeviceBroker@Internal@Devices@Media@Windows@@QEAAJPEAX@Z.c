/*
 * XREFs of ?RuntimeClassInitialize@AudioDeviceBroker@Internal@Devices@Media@Windows@@QEAAJPEAX@Z @ 0x140012914
 * Callers:
        ...
        HANDLE hSourceHandle)
{
  ...
  if ( hSourceHandle )
  {
    ...
    {
      if ( Windows::Media::Devices::Internal::AudioDeviceBroker::RetrieveNotificationDeviceId(this) < 0
