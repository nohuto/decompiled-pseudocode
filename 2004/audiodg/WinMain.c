 ...
 *     McGenEventRegister_EtwEventRegister @ 0x14001505C (McGenEventRegister_EtwEventRegister.c)
 *     WppInitUm @ 0x14001509C (WppInitUm.c)
 *     WPP_SF_D @ 0x14003424C (WPP_SF_D.c)
 *     WPP_SF_S @ 0x140034290 (WPP_SF_S.c)
