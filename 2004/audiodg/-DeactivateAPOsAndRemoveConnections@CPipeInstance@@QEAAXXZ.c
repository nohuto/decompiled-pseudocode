/*
 * XREFs of ?DeactivateAPOsAndRemoveConnections@CPipeInstance@@QEAAXXZ @ 0x14000F560
 * Callers:
...
void __fastcall CPipeInstance::DeactivateAPOsAndRemoveConnections(struct IAudioProcessor **this)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 40LL, &WPP_0fecdcbf10bb38a7bbad2ceb2ecd9592_Traceguids, this);
  }
  if ( *((_DWORD *)this + 29) )
  {
    v2 = this[19];
