/*
 * XREFs of ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x14000DDE0
 * Callers:
 ...
 *     ?MaybeGetExceptionString@details@wil@@YAXAEBVexception@std@@PEAG_K@Z @ 0x14003106C (-MaybeGetExceptionString@details@wil@@YAXAEBVexception@std@@PEAG_K@Z.c)
 ...
 *     ?GetApoRegKeyPath@@YAJPEAGIPEBG@Z @ 0x1400460BC (-GetApoRegKeyPath@@YAJPEAGIPEBG@Z.c)
 * Callees:
