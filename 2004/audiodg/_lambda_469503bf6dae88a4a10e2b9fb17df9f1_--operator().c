/*
 * XREFs of _lambda_469503bf6dae88a4a10e2b9fb17df9f1_::operator() @ 0x14001412C
 * Callers:
 ...
 *     ?reset@?$unique_storage@U?$resource_policy@PEAXP6APEAXPEAX@Z$1?LocalFree@@YAPEAX0@ZU?$integral_constant@_K$0A@@wistd@@PEAXPEAX$0A@$$T@details@wil@@@details@wil@@QEAAXPEAX@Z @ 0x14001469C (-reset@-$unique_storage@U-$resource_policy@PEAXP6APEAXPEAX@Z$1-LocalFree@@YAPEAX0@ZU-$integral_c.c)
 *     ?PreMessageLoop@?$CAtlExeModuleT@VCAudioDGModule@@@ATL@@QEAAJH@Z @ 0x1400146E4 (-PreMessageLoop@-$CAtlExeModuleT@VCAudioDGModule@@@ATL@@QEAAJH@Z.c)
...
LABEL_34:
         ...
         0LL) )
  {
    ...
    {
      pcbBytesNeeded = 1234;
      v7 = RpcServerRegisterIf3(&unk_140068160, 0LL, 0LL, 33LL);
      if ( !v7 )
      {
        fRpcStarted = 1;
