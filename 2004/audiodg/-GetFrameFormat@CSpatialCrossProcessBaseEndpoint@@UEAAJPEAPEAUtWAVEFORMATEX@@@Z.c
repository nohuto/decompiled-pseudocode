/*
 * XREFs of ?GetFrameFormat@CSpatialCrossProcessBaseEndpoint@@UEAAJPEAPEAUtWAVEFORMATEX@@@Z @ 0x140060C50
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  if ( !*((_BYTE *)this + 96) )
  {
    v4 = -2005139437;
LABEL_6:
    SpatialCPTraceLoggingErrorHelper("CSpatialCrossProcessBaseEndpoint::GetFrameFormat", 441, v4, a4);
    return v4;
  }
  if ( !a2 )
  {
