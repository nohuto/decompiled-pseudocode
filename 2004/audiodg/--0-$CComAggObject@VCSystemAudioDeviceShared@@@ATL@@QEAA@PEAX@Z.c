/*
 * XREFs of ??0?$CComAggObject@VCSystemAudioDeviceShared@@@ATL@@QEAA@PEAX@Z @ 0x14003A08C
 * Callers:
 ...
 *     ??0CSystemAudioDeviceShared@@QEAA@XZ @ 0x14003A15C (--0CSystemAudioDeviceShared@@QEAA@XZ.c)
 */
