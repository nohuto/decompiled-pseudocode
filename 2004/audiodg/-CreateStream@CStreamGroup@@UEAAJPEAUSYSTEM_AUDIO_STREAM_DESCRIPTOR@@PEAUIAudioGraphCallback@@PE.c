/*
 * XREFs of ?CreateStream@CStreamGroup@@UEAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x140042EE0
 * Callers:
 *     ?CreateStream@CStreamGroup@@WBI@EAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x14001F600 (-CreateStream@CStreamGroup@@WBI@EAAJPEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUIAudioGraphCallback@.c)
 * Callees:
        ...
        struct _RTL_CRITICAL_SECTION *a4)
{
  ...
  LPCRITICAL_SECTION lpCriticalSection; // [rsp+48h] [rbp-B0h]
  char *v25; // [rsp+50h] [rbp-A8h]
  ...
  char *v30; // [rsp+78h] [rbp-80h]
  char *v31; // [rsp+80h] [rbp-78h]
  ATL::CAtlException *v32; // [rsp+88h] [rbp-70h] BYREF
