/*
 * XREFs of ?Term@CAtlComModule@ATL@@QEAAXXZ @ 0x14001C5D0
 * Callers:
 *     ??1CAudioDGModule@@UEAA@XZ @ 0x14001C7D8 (--1CAudioDGModule@@UEAA@XZ.c)
 *     ATL::_dynamic_atexit_destructor_for___AtlComModule__ @ 0x140023070 (ATL--_dynamic_atexit_destructor_for___AtlComModule__.c)
