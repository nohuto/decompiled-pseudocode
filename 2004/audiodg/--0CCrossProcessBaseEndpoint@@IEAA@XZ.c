/*
 * XREFs of ??0CCrossProcessBaseEndpoint@@IEAA@XZ @ 0x140016D1C
 * Callers:
 *     ??0CCrossProcessServerInputEndpoint@@QEAA@XZ @ 0x140016C2C (--0CCrossProcessServerInputEndpoint@@QEAA@XZ.c)
