/*
 * XREFs of ?GetSpatialAudioStreamProcessor@CPipeInstance@@QEBAJPEAPEAUISpatialAudioStreamProcessor@@@Z @ 0x14003CFC4
 * Callers:
        ...
        struct ISpatialAudioStreamProcessor **a2)
{
  ...
  unsigned int v4; // edi
  struct IAudioProcessingObject *v6; // [rsp+48h] [rbp+10h] BYREF
