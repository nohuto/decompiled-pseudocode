/*
 * XREFs of ??_GCEndpointInstance@@QEAAPEAXI@Z @ 0x14003D76C
 * Callers:
 ...
 *     ??1?$CAutoPtr@VCEndpointInstance@@@ATL@@QEAA@XZ @ 0x14003FBE0 (--1-$CAutoPtr@VCEndpointInstance@@@ATL@@QEAA@XZ.c)
 *     ??1?$unique_ptr@VCEndpointInstance@@U?$default_delete@VCEndpointInstance@@@wistd@@@wistd@@QEAA@XZ @ 0x14003FCEC (--1-$unique_ptr@VCEndpointInstance@@U-$default_delete@VCEndpointInstance@@@wistd@@@wistd@@QEAA@X.c)
 * Callees:
