/*
 * XREFs of ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z @ 0x140047178
 * Callers:
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x1400390A8 (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
 * Callees:
 *     ?ResetEngineThreadPriority@@YAJPEAPEAX@Z @ 0x140047118 (-ResetEngineThreadPriority@@YAJPEAPEAX@Z.c)
 */
