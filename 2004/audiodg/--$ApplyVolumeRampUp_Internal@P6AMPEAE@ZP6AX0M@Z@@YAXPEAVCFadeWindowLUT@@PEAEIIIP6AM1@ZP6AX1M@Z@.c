/*
 * XREFs of ??$ApplyVolumeRampUp_Internal@P6AMPEAE@ZP6AX0M@Z@@YAXPEAVCFadeWindowLUT@@PEAEIIIP6AM1@ZP6AX1M@Z@Z @ 0x14005C1D8
 * Callers:
 ...
 *     ?SetStep@CFadeWindowLUT@@QEAAXIW4FadeType@1@@Z @ 0x14005C314 (-SetStep@CFadeWindowLUT@@QEAAXIW4FadeType@1@@Z.c)
 */
        ...
        __int64 (__fastcall *a7)(__int64))
{
  ...
  v8 = a4;
  result = CFadeWindowLUT::SetStep(a1, a3, 0LL);
  if ( v11 )
  {
    v12 = v11;
    do
