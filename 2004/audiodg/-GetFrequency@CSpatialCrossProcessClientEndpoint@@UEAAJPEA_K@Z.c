/*
 * XREFs of ?GetFrequency@CSpatialCrossProcessClientEndpoint@@UEAAJPEA_K@Z @ 0x140063020
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  if ( !_InterlockedCompareExchange((volatile signed __int32 *)this - 306, 1, 1) )
  {
    v3 = -2005139437;
    goto LABEL_5;
  }
  *a2 = *((unsigned int *)this - 253);
LABEL_7:
  if ( v8 )
