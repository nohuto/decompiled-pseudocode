 ...
 *     WppInitKm @ 0x1C000E2B0 (WppInitKm.c)
 *     WppLoadTracingSupport @ 0x1C000E370 (WppLoadTracingSupport.c)
 *     WppCleanupKm @ 0x1C000F9A8 (WppCleanupKm.c)
  ...
  *(_DWORD *)&DestinationString.Length = 0x2000000;
  ...
  if ( PoolWithTag )
  {
    ...
    *((_WORD *)::P + ((unsigned __int64)RegistryPath->Length >> 1)) = 0;
    ...
    {
      j = KbdCreateClassObject(DriverObject, (__int128 *)&WPP_MAIN_CB.Dpc, &v32, (__int64 *)P, 1);
      if ( j < 0 )
      {
        v3 = P[0];
        goto LABEL_15;
    ...
    else
    {
      ...
      KbdDeterminePortsServiced(&DestinationString.Length, &v31);
      if ( WPP_RECORDER_INITIALIZED != (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
      {
        LOBYTE(v11) = 4;
        WPP_RECORDER_SF_d(WPP_GLOBAL_Control->DeviceExtension, v11, v12, 12, *(_DWORD *)v30, v31);
      }
      ...
      if ( v13 )
      {
        ...
        for ( i = 0; i < *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Busy; ++i )
        {
          ...
          v20 = KbdCreateClassObject(DriverObject, (__int128 *)&WPP_MAIN_CB.Dpc, &v32, (__int64 *)P, 1);
          if ( v20 >= 0 )
          {
