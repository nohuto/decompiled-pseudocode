 ...
 *     SmpConfigureExcludeKnownDlls @ 0x140014140 (SmpConfigureExcludeKnownDlls.c)
 *     SmpConfigureExecute @ 0x1400141C0 (SmpConfigureExecute.c)
 *     SmpConfigureFileRenames @ 0x140014210 (SmpConfigureFileRenames.c)
 * Callees:
