/*
 * XREFs of SmpConfigureSharedSessionData @ 0x14000A7D0
 * Callers:
...
NTSTATUS SmpConfigureSharedSessionData()
{
  ...
  v47 = L"Execute";
  v48 = &dword_140024B28;
  qword_140024B48 = (__int64)&qword_140024B40;
  qword_140024B40 = (__int64)&qword_140024B40;
  v29 = 0LL;
  v30 = 0;
  v35 = 0;
  v36 = 0LL;
  ...
  v56 = 0LL;
  v57 = 0;
  qword_140024B38 = (__int64)&qword_140024B30;
  qword_140024B30 = &qword_140024B30;
  qword_140024B58 = (__int64)&qword_140024B50;
  qword_140024B50 = (__int64)&qword_140024B50;
  result = RtlQueryRegistryValuesEx(2LL, L"Session Manager", &v24);
  if ( result >= 0 )
  {
    v2 = (PVOID *)qword_140024B30;
    while ( v2 != &qword_140024B30 )
    {
      v3 = (PVOID *)*v2;
    ...
    if ( (__int64 *)qword_140024B50 == &qword_140024B50 )
    {
      v6 = 0LL;
    }
    else
    {
      v6 = qword_140024B58;
      v18 = *(_QWORD **)(qword_140024B58 + 8);
      if ( *(__int64 **)qword_140024B58 != &qword_140024B50 || *v18 != qword_140024B58 )
LABEL_25:
        __fastfail(3u);
      qword_140024B58 = *(_QWORD *)(qword_140024B58 + 8);
      *v18 = &qword_140024B50;
    }
    SmpInitExecuteCmd = v6;
    v7 = (16LL * (unsigned int)dword_140024B28 + 105) & 0xFFFFFFFFFFFFFFFEuLL;
    if ( v6 )
    ...
    if ( result >= 0 )
    {
      ...
      if ( result >= 0 )
      {
        ...
        *(_WORD *)v14 = 0;
        ...
        SmpCopyListToSharedSection((unsigned int)&qword_140024B40, 0, 1, 0, (__int64)&v20, (__int64)&v19);
        SmpCopyListToSharedSection((unsigned int)&SmpSubSystemsRequired, 1, 0, 1, (__int64)&v20, (__int64)&v19);
        SmpCopyListToSharedSection((unsigned int)&qword_140024B50, 0, 1, 2, (__int64)&v20, (__int64)&v19);
