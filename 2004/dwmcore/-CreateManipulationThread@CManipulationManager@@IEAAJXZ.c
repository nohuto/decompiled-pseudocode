/*
 * XREFs of ?CreateManipulationThread@CManipulationManager@@IEAAJXZ @ 0x18002B9B4
 * Callers:
...
LABEL_8:
    v6 = v3;
LABEL_10:
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, &dword_1802DAC28, 3u, v6, dwCreationFlags, 0LL);
    return v3;
  }
