/*
 * XREFs of DispatchDwmDiagnosticsControlMessage @ 0x180211744
 * Callers:
 *     McGenControlCallbackV2 @ 0x1800D2350 (McGenControlCallbackV2.c)
 * Callees:
 ...
 *     ?HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z @ 0x180211824 (-HandleMessage@DwmDiagnosticsControlMessage_0@@SAXPEBU1@@Z.c)
 */
