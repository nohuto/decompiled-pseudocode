/*
 * XREFs of ?NotifyPropertyValue@CPropertySet@@AEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@@Z @ 0x1800AF0F4
 * Callers:
    ...
    if ( v11 )
    {
      if ( *(_DWORD *)(a1 + 56) )
      {
        ...
        if ( _bittest(&v12, a2) )
        {
          ...
          v28 = v24;
          v29 = v25;
          v13 = CoreUICallSend(v23, &v28, 2LL, 13LL, 0, &unk_1802CCE47);
          if ( v13 == -2018375675 )
            v13 = 0;
          if ( v13 < 0 )
          {
    ...
    if ( v8 )
    {
      if ( *(_DWORD *)(a1 + 56) )
      {
        ...
        if ( _bittest(&v9, v3) )
        {
          ...
          v13 = CoreUICallSend(v20, &v28, 2LL, 13LL, 7, &unk_1802CCE6D);
          if ( v13 == -2018375675 )
            v13 = 0;
          if ( v13 < 0 )
          {
