/*
 * XREFs of ?WaitForNextFrameStart@CPartitionVerticalBlankScheduler@@AEAAJ_N@Z @ 0x18005B890
 * Callers:
 ...
 *     ?EstimateNextVSync@CPartitionVerticalBlankScheduler@@AEAA_KXZ @ 0x1800D91D8 (-EstimateNextVSync@CPartitionVerticalBlankScheduler@@AEAA_KXZ.c)
...
LABEL_25:
  ...
  *((_BYTE *)this + 5373) = v19;
  ...
  {
    if ( v18 != -2003304307 )
      MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802AB078, 2u, v18, 0x1CCu, 0LL);
  }
  else
  {
    v20 = 0LL;
