/*
 * XREFs of ?ProcessTransformParentStack@CTransformParentPreComputeHelper@@EEAAJPEBVCVisualTree@@_K_N@Z @ 0x180021C10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
      ...
      if ( v31 < v11 )
      {
        updated = CVisual::UpdateWorldTransform((CComposition **)v5, a2, UnusedTreeData, (char)v63, v61);
        v15 = updated;
        if ( updated < 0 )
        {
