 ...
 *     ??$_Uninitialized_move@PEAV?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@std@@PEAV12@V?$allocator@V?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@std@@@2@@std@@YAPEAV?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@0@QEAV10@0PEAV10@AEAV?$allocator@V?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@std@@@0@@Z @ 0x180249F6C (--$_Uninitialized_move@PEAV-$unique_ptr@VCAtlasTexture@@U-$default_delete@VCAtlasTexture@@@std@@.c)
 *     ?_Change_array@?$vector@V?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@std@@V?$allocator@V?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@std@@@2@@std@@AEAAXQEAV?$unique_ptr@VCAtlasTexture@@U?$default_delete@VCAtlasTexture@@@std@@@2@_K1@Z @ 0x18024A4A8 (-_Change_array@-$vector@V-$unique_ptr@VCAtlasTexture@@U-$default_delete@VCAtlasTexture@@@std@@@s.c)
 */

__int64 __fastcall std::vector<std::unique_ptr<CAtlasTexture>>::_Emplace_reallocate<std::unique_ptr<CAtlasTexture>>(
        __int64 *a1,
        __int64 a2,
        __int64 *a3)
{
  ...
  *(_QWORD *)(v13 + 8 * v4) = v14;
  ...
  if ( a2 != v17 )
  {
    std::_Uninitialized_move<std::unique_ptr<CAtlasTexture> *,std::unique_ptr<CAtlasTexture> *,std::allocator<std::unique_ptr<CAtlasTexture>>>(
      v18,
      a2,
      v13);
    v17 = a1[1];
  ...
  std::_Uninitialized_move<std::unique_ptr<CAtlasTexture> *,std::unique_ptr<CAtlasTexture> *,std::allocator<std::unique_ptr<CAtlasTexture>>>(
    ...
    v17,
    v16);
  std::vector<std::unique_ptr<CAtlasTexture>>::_Change_array(a1, v15, v8, v11);
  return *a1 + 8 * v4;
}
