/*
 * XREFs of ?SetStateOnDevice@CCommonRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEAI@Z @ 0x18004D9B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetColorChannelDepth@@YAIW4DXGI_FORMAT@@@Z @ 0x18004E0D0 (-GetColorChannelDepth@@YAIW4DXGI_FORMAT@@@Z.c)
 *     ?ToD3D11TextureAddressMode@ExtendMode@@YA?AW4D3D11_TEXTURE_ADDRESS_MODE@@W4Enum@1@@Z @ 0x1800DA6D4 (-ToD3D11TextureAddressMode@ExtendMode@@YA-AW4D3D11_TEXTURE_ADDRESS_MODE@@W4Enum@1@@Z.c)
 ...
 *     ?IsHDRColorSpace@ColorConversion@@SA_NW4DXGI_COLOR_SPACE_TYPE@@@Z @ 0x1801A8EDC (-IsHDRColorSpace@ColorConversion@@SA_NW4DXGI_COLOR_SPACE_TYPE@@@Z.c)
 */
...
LABEL_8:
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v7, 0LL, 0, v12, 0x8Fu, 0LL);
...
LABEL_34:
    ...
    *((_QWORD *)&v96 + v18) = v35;
    ...
    v40 = (unsigned int)HIBYTE(v79) + 4 * (_DWORD)v39;
