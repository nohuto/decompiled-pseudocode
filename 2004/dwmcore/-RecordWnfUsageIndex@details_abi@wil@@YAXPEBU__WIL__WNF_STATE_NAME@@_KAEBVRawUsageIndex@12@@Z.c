/*
 * XREFs of ?RecordWnfUsageIndex@details_abi@wil@@YAXPEBU__WIL__WNF_STATE_NAME@@_KAEBVRawUsageIndex@12@@Z @ 0x18002F4C0
 * Callers:
 *     ?Record@UsageIndexes@details_abi@wil@@QEAAXXZ @ 0x18002FE9C (-Record@UsageIndexes@details_abi@wil@@QEAAXXZ.c)
 * Callees:
        ...
        const struct wil::details_abi::RawUsageIndex *a4)
{
  ...
  _BYTE v27[24]; // [rsp+80h] [rbp-80h] BYREF
  void *v28; // [rsp+98h] [rbp-68h]
  int v29; // [rsp+A0h] [rbp-60h]
  wil::details *v30; // [rsp+B0h] [rbp-50h]
  char v31; // [rsp+B8h] [rbp-48h]
  char v32; // [rsp+B9h] [rbp-47h]
  _BYTE v33[8]; // [rsp+C0h] [rbp-40h] BYREF
  void **v34; // [rsp+C8h] [rbp-38h] BYREF
  __int128 v35; // [rsp+D0h] [rbp-30h]
  _BYTE *v36; // [rsp+E0h] [rbp-20h]
  void ***v37; // [rsp+130h] [rbp+30h]
  _BYTE v38[4096]; // [rsp+140h] [rbp+40h] BYREF
  ...
  while ( 1 )
  {
    ...
    *((_QWORD *)&v25 + 1) = &v24;
    ...
    if ( v31 )
    {
      updated = wil_details_NtUpdateWnfStateData(v7, v28, v29 - (int)v28, a4, v19, v22, 1u);
