/*
 * XREFs of __local_stdio_printf_options @ 0x1800E25FC
 * Callers:
 *     initialize_printf_standard_rounding @ 0x1800E25E0 (initialize_printf_standard_rounding.c)
 ...
 *     _vsnprintf @ 0x1800E3B88 (_vsnprintf.c)
