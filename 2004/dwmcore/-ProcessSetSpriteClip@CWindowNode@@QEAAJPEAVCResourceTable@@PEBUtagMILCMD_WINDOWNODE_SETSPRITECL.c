/*
 * XREFs of ?ProcessSetSpriteClip@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_WINDOWNODE_SETSPRITECLIP@@@Z @ 0x1800CD8DC
 * Callers:
...
LABEL_8:
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x259u, 0LL);
    }
  }
  else
  {
    v3 = -2003303421;
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, -2003303421, 0x253u, 0LL);
  }
  if ( v9 )
    goto LABEL_8;
  return v3;
