/*
 * XREFs of ?CreateTokenThread@CGlobalSurfaceManager@@IEAAJXZ @ 0x18002B2BC
 * Callers:
...
__int64 __fastcall CGlobalSurfaceManager::CreateTokenThread(CGlobalSurfaceManager *this)
{
  ...
  {
    v4 = -2147467260;
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)this, 0LL, 0, -2147467260, 0x142u, 0LL);
  }
  else
  {
    ...
    {
      v4 = -2147024882;
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v3, 0LL, 0, -2147024882, 0x14Du, 0LL);
    }
  }
  return v4;
}
