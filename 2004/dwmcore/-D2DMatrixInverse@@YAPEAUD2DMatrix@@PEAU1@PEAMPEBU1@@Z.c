/*
 * XREFs of ?D2DMatrixInverse@@YAPEAUD2DMatrix@@PEAU1@PEAMPEBU1@@Z @ 0x18021B910
 * Callers:
 *     ?GenerateVector3Basis@CNaturalAnimation@@AEAA_NXZ @ 0x1801D8F08 (-GenerateVector3Basis@CNaturalAnimation@@AEAA_NXZ.c)
 *     ?Inverse@CExpressionValueStack@@QEAAJXZ @ 0x1801FD64C (-Inverse@CExpressionValueStack@@QEAAJXZ.c)
 *     ?ChangeBasis@CVector3ForceEvaluator@@QEAAXAEBUD2DMatrix@@@Z @ 0x180214FDC (-ChangeBasis@CVector3ForceEvaluator@@QEAAXAEBUD2DMatrix@@@Z.c)
