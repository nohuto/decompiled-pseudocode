/*
 * XREFs of ?GetBrushParameters@CLinearGradientBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x1801D3C10
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct CDrawingContext **a2)
{
  ...
  if ( CurrentSurface < 0 )
  {
    v28 = 165;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast(v5, &dword_180302B70, 2u, CurrentSurface, v28, 0LL);
    goto LABEL_21;
  }
  v19 = *((float *)&v43 + 1) + 0.5;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v22, &dword_180302B70, 2u, v6, 0xB6u, 0LL);
LABEL_21:
    CBrushDrawListGenerator::Reset((CBrushDrawListGenerator *)a2);
    goto LABEL_22;
  }
