/*
 * XREFs of ?RemoveHolographicComposition@CHolographicManager@@QEAAXPEAVCHolographicComposition@@@Z @ 0x180252480
 * Callers:
 *     ?DetachFromChannel@CHolographicComposition@@UEAAXPEAVCChannelContext@@_N@Z @ 0x1802543C0 (-DetachFromChannel@CHolographicComposition@@UEAAXPEAVCChannelContext@@_N@Z.c)
 * Callees:
 ...
 *     ?DwmHolographicCompositionRemove_@CompositorTracing@@QEAAXXZ @ 0x18025134C (-DwmHolographicCompositionRemove_@CompositorTracing@@QEAAXXZ.c)
