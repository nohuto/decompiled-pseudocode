/*
 * XREFs of ?ClipToPolygon@ClipPlaneIterator@@QEAAJPEAVCPolygon@@AEBVCMILMatrix@@AEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMILSurfaceRect_@RectUniqueness@@UNotNeeded@4@@@@Z @ 0x180190240
 * Callers:
 ...
 *     ?ResetToStart@ClipPlaneIterator@@AEAAXXZ @ 0x180190804 (-ResetToStart@ClipPlaneIterator@@AEAAXXZ.c)
