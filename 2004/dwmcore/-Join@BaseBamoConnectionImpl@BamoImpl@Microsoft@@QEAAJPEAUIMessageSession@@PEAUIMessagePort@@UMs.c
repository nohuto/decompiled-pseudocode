/*
 * XREFs of ?Join@BaseBamoConnectionImpl@BamoImpl@Microsoft@@QEAAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBG_N@Z @ 0x18002D270
 * Callers:
 ...
 *     ?StringCchCatW@@YAJPEAG_KPEBG@Z @ 0x180033538 (-StringCchCatW@@YAJPEAG_KPEBG@Z.c)
...
LABEL_39:
  ...
  *(_DWORD *)&v37[4] = *(_DWORD *)L"O";
  ...
  if ( v35 )
  {
    ConversationHost = StringCchCatW((unsigned __int16 *)v35, v14, v37);
