/*
 * XREFs of ?SetBrush@CTextObject@@UEAAJPEAVCBrush@@@Z @ 0x180171FA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTextObject::SetBrush(struct CResource **this, struct CBrush *a2)
{
  unsigned int v2; // ebx
  int v5; // eax
  __int64 v6; // rcx
  ...
  if ( a2 != this[10] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1119u, 0LL);
    }
    else
    {
