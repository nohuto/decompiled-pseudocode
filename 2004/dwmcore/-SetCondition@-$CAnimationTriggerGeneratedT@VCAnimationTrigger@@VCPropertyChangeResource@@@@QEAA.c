/*
 * XREFs of ?SetCondition@?$CAnimationTriggerGeneratedT@VCAnimationTrigger@@VCPropertyChangeResource@@@@QEAAJPEAVCBaseExpression@@@Z @ 0x180172234
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[9] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x768u, 0LL);
    }
    else
    {
