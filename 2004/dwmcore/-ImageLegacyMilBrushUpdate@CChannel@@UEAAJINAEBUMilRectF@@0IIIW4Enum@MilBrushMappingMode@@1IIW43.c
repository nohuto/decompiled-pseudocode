/*
 * XREFs of ?ImageLegacyMilBrushUpdate@CChannel@@UEAAJINAEBUMilRectF@@0IIIW4Enum@MilBrushMappingMode@@1IIW43MilStretch@@W43MilTileMode@@W43MilHorizontalAlignment@@W43MilVerticalAlignment@@I@Z @ 0x1800D1DA0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a17)
{
  ...
  int v32; // [rsp+58h] [rbp-49h]
  __int128 v33; // [rsp+5Ch] [rbp-45h]
  int v34; // [rsp+6Ch] [rbp-35h]
  ...
  v19 = a6;
  CChannel::CheckOptionalHandle(v17, a6);
  v20 = a7;
  CChannel::CheckOptionalHandle(v17, a7);
  v21 = a8;
  CChannel::CheckOptionalHandle(v17, a8);
  v22 = a11;
  CChannel::CheckOptionalHandle(v17, a11);
  v23 = a12;
  CChannel::CheckOptionalHandle(v17, a12);
  LODWORD(v17) = a17;
  CChannel::CheckOptionalHandle(a1, a17);
  v29 = 487;
