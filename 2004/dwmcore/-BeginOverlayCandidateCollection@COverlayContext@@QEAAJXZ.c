/*
 * XREFs of ?BeginOverlayCandidateCollection@COverlayContext@@QEAAJXZ @ 0x18007CA80
 * Callers:
 ...
 * Callees:
 *     ?clear_region@?$vector_facade@VOverlayPlaneInfo@COverlayContext@@V?$buffer_impl@VOverlayPlaneInfo@COverlayContext@@$0BA@$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAX_K0@Z @ 0x180032A80 (-clear_region@-$vector_facade@VOverlayPlaneInfo@COverlayContext@@V-$buffer_impl@VOverlayPlaneInf.c)
...
__int64 __fastcall COverlayContext::BeginOverlayCandidateCollection(COverlayContext *this)
{
  ...
  *((_BYTE *)this + 11421) = v7;
  ...
  v10 = dword_18034939C;
  v11 = dword_180349394;
  if ( TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::sc_rcEmpty >= dword_180349398
    || dword_180349394 >= dword_18034939C )
  {
    **((_DWORD **)this + 1413) = 0;
  }
  else
