/*
 * XREFs of ?DetectInputGlitch@CTelemetryTouchLatencyAnalysis@@AEBAXAEAUTouchScenarioInfo@1@_K11111111III1@Z @ 0x18001446C
 * Callers:
 ...
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U?$_tlgWrapperByVal@$00@@U1@U?$_tlgWrapSz@G@@U3@U2@U?$_tlgWrapperByRef@$0BA@@@U2@U2@U2@U2@U?$_tlgWrapperByVal@$07@@U2@U?$_tlgWrapperByVal@$01@@U6@U5@U1@U1@U1@U5@U1@U1@U1@U1@U1@U1@U1@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@U5@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@33AEBU?$_tlgWrapperByVal@$00@@3AEBU?$_tlgWrapSz@G@@54AEBU?$_tlgWrapperByRef@$0BA@@@4444AEBU?$_tlgWrapperByVal@$07@@4AEBU?$_tlgWrapperByVal@$01@@873337333333377777777777@Z @ 0x18015AE14 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U-$_tlgWrapperByVal@$00@@U1@U-$_tlgWrapSz@G@@U3@U2@U-$_t.c)
    ...
    if ( !a3 || (v30 = *((_DWORD *)a2 + 101)) != 0 && a12 == v30 + 1 )
    {
      ...
      if ( v25 - v26 > v23 )
      {
        ...
        if ( (unsigned int)dword_180342E48 > 4 && (qword_180342E58 & 2) != 0 && (qword_180342E60 & 2) == qword_180342E60 )
        {
          ...
          v60 = v26;
          v62 = a10;
          v68 = (v25 - v26) / (qword_180345400 / 0x3E8uLL);
          v63 = a9;
          v64 = v22;
          v66 = a4;
          v67 = a3;
          ...
          if ( IsVailContainer() )
            v33 = (a4 - v31) / (qword_180345400 / 0xF4240uLL);
          else
            LODWORD(v33) = 0;
          v45 = v33;
          if ( IsVailContainer() )
            v34 = (v31 - v32) / (qword_180345400 / 0xF4240uLL);
          else
            LODWORD(v34) = 0;
          v46 = v34;
          if ( IsVailContainer() )
            v35 = (v32 - a3) / (qword_180345400 / 0xF4240uLL);
          else
            LODWORD(v35) = 0;
          v47 = v35;
          v54 = v24;
          v48 = (v22 - a5) / (qword_180345400 / 0x3E8uLL);
          v49 = (a5 - a4) / (qword_180345400 / 0xF4240uLL);
          v50 = (a4 - a3) / (qword_180345400 / 0xF4240uLL);
          v51 = (v22 - a3) / (qword_180345400 / 0x3E8uLL);
          v70 = a15;
          v52 = a13;
          v53 = *((_DWORD *)a2 + 101);
          v71 = *((_QWORD *)a2 + 1);
