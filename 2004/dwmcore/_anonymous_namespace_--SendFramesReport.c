/*
 * XREFs of _anonymous_namespace_::SendFramesReport @ 0x180084D50
 * Callers:
 ...
 *     ??$_Emplace_reallocate@D@?$vector@DV?$allocator@D@std@@@std@@QEAAPEADQEAD$$QEAD@Z @ 0x180086BF0 (--$_Emplace_reallocate@D@-$vector@DV-$allocator@D@std@@@std@@QEAAPEADQEAD$$QEAD@Z.c)
 ...
 *     _anonymous_namespace_::QpcToFileTimeAndGetCurrentFileTime @ 0x180088D10 (_anonymous_namespace_--QpcToFileTimeAndGetCurrentFileTime.c)
...
LABEL_81:
  ...
  *v57 = 0;
  ...
  if ( (unsigned int)dword_180342E80 > 5 && (unsigned __int8)tlgKeywordOn(&dword_180342E80, 0x400000000000LL) )
  {
    v66 = v103;
