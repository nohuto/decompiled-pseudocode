/*
 * XREFs of ?CollectOcclusion@CWindowNode@@UEAAJPEAVCOcclusionContext@@PEAVCOcclusionInfo@@@Z @ 0x180061750
 * Callers:
 *     <none>
 * Callees:
        ...
        int a4)
{
  ...
  tagRECT v112; // [rsp+60h] [rbp-A0h] BYREF
  tagRECT v113; // [rsp+70h] [rbp-90h] BYREF
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, v8, 0x42Eu, 0LL);
...
LABEL_4:
  ...
  *((_DWORD *)a2 + 214) = 0;
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v13, 0LL, 0, v10, 0x42Fu, 0LL);
  ...
  *((_DWORD *)a3 + 8) = v14;
    ...
    && (int)CCompositionSurfaceBitmap::GetCurrentRenderingRealization((CCompositionSurfaceBitmap *)(v15 + 64), &v111) >= 0 )
  {
    ...
    if ( *((_BYTE *)a2 + 1245) )
    {
      ...
      if ( v73 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v74, 0LL, 0, v73, 0x44Eu, 0LL);
        goto LABEL_75;
      }
      v75 = *((_DWORD *)this + 209);
  ...
  *((_DWORD *)a3 + 6) = *((_DWORD *)a2 + 364);
  if ( *((_QWORD *)this + 90) && !*((_BYTE *)this + 914) && (*((_BYTE *)this + 836) & 2) == 0 )
  {
    ...
    *(_QWORD *)&v113.right = __PAIR64__(v22, v21);
    ...
    v24 = *v23;
    rcDst = 0LL;
    EffectiveBounds = (*(__int64 (__fastcall **)(__int64 *, tagRECT *, _QWORD))(v24 + 32))(v23, &rcDst, 0LL);
    if ( EffectiveBounds < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, EffectiveBounds, 0x3ADu, 0LL);
      v20 = 0LL;
    }
    else
    {
    ...
    *(float *)&v112.bottom = (float)bottom;
    if ( !v16 )
    {
      if ( v106 )
      {
        ...
        EffectiveBounds = v59;
        if ( v59 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v59, 0x49Du, 0LL);
      }
LABEL_74:
      if ( EffectiveBounds < 0 )
      {
...
LABEL_81:
        if ( EffectiveBounds < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, EffectiveBounds, 0x496u, 0LL);
        goto LABEL_74;
      }
    }
    if ( (float)right > v37 && (float)bottom > v38 )
    {
      ...
      if ( v43 )
      {
        v93 = (tagRECT *)(*((_QWORD *)a2 + 19) + 16LL * (unsigned int)(v43 - 1));
        v44 = *v93;
