/*
 * XREFs of ?RemoveResourceDebugInfo@CAnimationLoggingManager@@QEAAXPEAVCResource@@@Z @ 0x1800C06D8
 * Callers:
 ...
 *     ?DetachFromChannel@CResource@@UEAAXPEAVCChannelContext@@_N@Z @ 0x1800C8F30 (-DetachFromChannel@CResource@@UEAAXPEAVCChannelContext@@_N@Z.c)
