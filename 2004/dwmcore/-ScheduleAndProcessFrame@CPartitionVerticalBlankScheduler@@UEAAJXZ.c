/*
 * XREFs of ?ScheduleAndProcessFrame@CPartitionVerticalBlankScheduler@@UEAAJXZ @ 0x180059EC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_24:
  ...
  do
  {
    v20 = v19 | 1u;
    v21 = v19;
    v19 = _InterlockedCompareExchange(&dword_180345750, v20, v19);
  }
  while ( v21 != v19 );
