...
void ***__fastcall std::_Uninitialized_move<std::unique_ptr<CRegion> *,std::unique_ptr<CRegion> *,std::allocator<std::unique_ptr<CRegion>>>(
        void ***a1,
        void ***a2,
        void ***a3)
{
