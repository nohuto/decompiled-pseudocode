/*
 * XREFs of ?ProcessConditionalExpression@CConditionalExpression@@SAJPEAV1@PEAVCExpressionValueStack@@_KW4OutputCoordinate@@PEA_NPEAM@Z @ 0x1801BF6C4
 * Callers:
        ...
        float *a6)
{
  ...
  if ( IsAnyConditionSatisfied < 0 )
  {
    wil::details::in1diag3::Return_Hr(
      retaddr,
      (void *)0x263,
      (__int64)"onecoreuap\\windows\\dwm\\dwmcore\\resources\\conditionalexpression.cpp",
