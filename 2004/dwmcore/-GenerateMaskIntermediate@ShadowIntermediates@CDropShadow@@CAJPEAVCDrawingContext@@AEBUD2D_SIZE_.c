/*
 * XREFs of ?GenerateMaskIntermediate@ShadowIntermediates@CDropShadow@@CAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCBrush@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x180020C10
 * Callers:
        ...
        struct IRenderTargetBitmap **a4)
{
  ...
  {
    v11 = CDrawingContext::Clear((struct CDrawingContext *)((char *)this + 16), &stru_1802AB028);
    v10 = v11;
    if ( v11 < 0 )
    {
