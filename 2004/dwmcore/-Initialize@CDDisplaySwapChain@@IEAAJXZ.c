/*
 * XREFs of ?Initialize@CDDisplaySwapChain@@IEAAJXZ @ 0x18023864C
 * Callers:
    ...
    while ( 1 )
    {
      ...
      if ( *((CRegion ***)this + 48) == v13 )
      {
        std::vector<std::unique_ptr<CRegion>>::_Emplace_reallocate<std::unique_ptr<CRegion>>(
          ...
          (__int64 *)&v18);
        if ( v18 )
          CRegion::`scalar deleting destructor'((void **)v18, 1);
      }
      else
      {
        *v13 = v12;
