/*
 * XREFs of ?PresentNeeded@COverlayContext@@QEAA_NXZ @ 0x180032E98
 * Callers:
...
char __fastcall COverlayContext::PresentNeeded(COverlayContext *this)
{
  ...
  if ( !v2 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( *((_BYTE *)this + 11422) || v9 == -1 || CCommonRegistryData::m_fDisableIndependentFlip )
        goto LABEL_22;
LABEL_23:
...
LABEL_22:
  ...
  if ( *((_BYTE *)this + 11422) && CDirectFlipInfo::IsIndependentFlip(v2) )
