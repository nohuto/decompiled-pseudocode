/*
 * XREFs of ?GenerateDrawList@CPrimitiveGroupDrawListGenerator@@QEAAJPEAVCDrawingContext@@PEBUD2D_MATRIX_3X2_F@@PEAVCDrawListCache@@@Z @ 0x1800C0E40
 * Callers:
 ...
 *     ?FromD2D1ExtendMode@ExtendMode@@YA?AW4Enum@1@W4D2D1_EXTEND_MODE@@@Z @ 0x1800C1440 (-FromD2D1ExtendMode@ExtendMode@@YA-AW4Enum@1@W4D2D1_EXTEND_MODE@@@Z.c)
...
LABEL_42:
  ...
  {
    if ( !CCpuClip::IsAxisAlignedRectangle((CCpuClip *)&v73) || !CMILMatrix::Is2DAxisAlignedPreserving<1>((__int64)v91) )
    {
      BYTE12(v66) = 1;
      goto LABEL_11;
    }
