/*
 * XREFs of ?_UpdateEdgyExperienceInput@CManipulation@@AEAAJW4Enum@EdgyCompositionUpdateType@@@Z @ 0x1801D71E4
 * Callers:
...
LABEL_16:
    if ( *(_QWORD *)(a1 + 712) )
    {
      ...
      v1 = updated;
      if ( updated < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, updated, 0x401u, 0LL);
    }
  }
  else
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v5, 0LL, 0, v1, 0x3E6u, 0LL);
  }
