/*
 * XREFs of ?EnsureSwapChain@CLocalAppRenderTarget@@IEAAJXZ @ 0x18018BBAC
 * Callers:
 ...
 *     ?SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z @ 0x18018C24C (-SendCompSurfHandle@CLocalAppRenderTarget@@IEBAXPEAX@Z.c)
