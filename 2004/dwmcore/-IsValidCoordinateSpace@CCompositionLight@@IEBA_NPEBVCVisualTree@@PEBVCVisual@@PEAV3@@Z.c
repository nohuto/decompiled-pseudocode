/*
 * XREFs of ?IsValidCoordinateSpace@CCompositionLight@@IEBA_NPEBVCVisualTree@@PEBVCVisual@@PEAV3@@Z @ 0x1801F5A8C
 * Callers:
 ...
 *     ?IsInvertibleDeterminant@CMILMatrix@@SA_NM@Z @ 0x1800C235C (-IsInvertibleDeterminant@CMILMatrix@@SA_NM@Z.c)
