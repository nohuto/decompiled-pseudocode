/*
 * XREFs of ?CalculateValue@CBaseExpression@@QEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x18005FB20
 * Callers:
 ...
 *     ?IsExpressionValueValid@CBaseExpression@@AEAA_NPEAVCExpressionValue@@@Z @ 0x180060A20 (-IsExpressionValueValid@CBaseExpression@@AEAA_NPEAVCExpressionValue@@@Z.c)
...
LABEL_16:
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_180289A70, 2u, v13, 0x401u, 0LL);
    goto LABEL_46;
  }
  if ( !v11 )
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v16, &dword_180289A70, 2u, v13, 0x408u, 0LL);
    goto LABEL_46;
  }
  if ( v5.QuadPart )
  {
  ...
  {
    v13 = -2147024890;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v37, &dword_180289A70, 2u, -2147024890, 0x422u, 0LL);
    v42 = v62;
    if ( !v62 )
      goto LABEL_46;
    goto LABEL_80;
...
LABEL_76:
  ...
  if ( v63 != *((_DWORD *)this + 36) )
  {
    ...
    v53 = 1071;
LABEL_78:
    MilInstrumentationCheckHR_MaybeFailFast(v39, &dword_180289A70, 2u, v41, v53, 0LL);
    v42 = v62;
    if ( v62 )
    {
      v62 = 0LL;
...
LABEL_24:
  ...
  {
    v13 = -2147467259;
    MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_180289A70, 2u, -2147467259, 0x448u, 0LL);
    goto LABEL_47;
  }
  if ( v17 )
  {
...
LABEL_104:
  MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_180289A70, 2u, v27, 0x455u, 0LL);
LABEL_47:
  v28 = *((_DWORD *)a2 + 4);
  if ( v28 > v20 )
  {
