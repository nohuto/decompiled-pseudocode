/*
 * XREFs of ?Trim@CTrimPathOperation@@QEAAJPEBVCPathData@@MMMPEAPEAV2@@Z @ 0x18025D300
 * Callers:
 ...
 *     ??0CPathLengthOperation@@QEAA@XZ @ 0x18025C5CC (--0CPathLengthOperation@@QEAA@XZ.c)
