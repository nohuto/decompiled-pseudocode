/*
 * XREFs of ?EnsureRenderBuffers@CHolographicInteropTexture@@QEAAJPEAVCD3DDevice@@W4DXGI_FORMAT@@@Z @ 0x180256FF8
 * Callers:
 ...
 *     ?PostInteropTextureInitialize@CHolographicManager@@QEAAXPEAVCHolographicInteropTexture@@@Z @ 0x180252150 (-PostInteropTextureInitialize@CHolographicManager@@QEAAXPEAVCHolographicInteropTexture@@@Z.c)
 *     ?PostInteropTextureResize@CHolographicManager@@QEAAXPEAVCHolographicInteropTexture@@@Z @ 0x18025219C (-PostInteropTextureResize@CHolographicManager@@QEAAXPEAVCHolographicInteropTexture@@@Z.c)
        ...
        enum DXGI_FORMAT a3)
{
  ...
  if ( !LOBYTE(this[27].Ptr) )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, 0LL, 0, -2147024875, 0x1F0u, 0LL);
LABEL_37:
  ...
  if ( !BYTE1(this[28].Ptr) )
  {
    ...
    if ( (unsigned int)(Ptr_high - 1) > 0x3FFF || (Ptr = (unsigned int)this[30].Ptr) == 0 || Ptr > 0x4000 )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(Ptr_high, 0LL, 0, -2147024809, 0x1FBu, 0LL);
LABEL_36:
      if ( (int)v6 < 0 )
        goto LABEL_37;
      goto LABEL_38;
    ...
    if ( LODWORD(this[29].Ptr) )
    {
      while ( 2 )
      {
        ...
        do
        {
          ...
          if ( v13 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x21Bu, 0LL);
            goto LABEL_31;
          }
          ...
          if ( v15 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v15, 0x21Du, 0LL);
            goto LABEL_31;
          }
          ...
          if ( v17 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x223u, 0LL);
            goto LABEL_31;
          }
          ...
          {
            MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, RenderTargetBitmap, 0x22Du, 0LL);
LABEL_31:
