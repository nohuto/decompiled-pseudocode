/*
 * XREFs of ?PushLayerTransformOnExplicitSurfaceInput@CTreeEffectLayer@@IEAAXXZ @ 0x1800078B0
 * Callers:
 ...
 *     ?GetTransformToLayerSpace@CTreeEffectLayer@@IEBA?AVMatrix3x2F@D2D1@@XZ @ 0x180191AA8 (-GetTransformToLayerSpace@CTreeEffectLayer@@IEBA-AVMatrix3x2F@D2D1@@XZ.c)
 */
  ...
  if ( v2 )
  {
    if ( CLayerVisual::IsAutomaticBoundsToLocalSpaceEnabled(v2) )
    {
      ...
      if ( v4 )
      {
        ...
        do
        {
          v7 = *(_QWORD *)(*((_QWORD *)this + 31) + 112LL);
          v8 = *(_QWORD *)(v5 + v7);
          if ( v8 )
          {
