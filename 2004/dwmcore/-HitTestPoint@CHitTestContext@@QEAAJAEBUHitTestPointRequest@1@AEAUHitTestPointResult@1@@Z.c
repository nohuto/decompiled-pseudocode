/*
 * XREFs of ?HitTestPoint@CHitTestContext@@QEAAJAEBUHitTestPointRequest@1@AEAUHitTestPointResult@1@@Z @ 0x18009D0F8
 * Callers:
 ...
 *     ?GetInputType@CInputSinkStruct@@SA?AW4CompositionInputType@@W4InputType@@@Z @ 0x18001EEC8 (-GetInputType@CInputSinkStruct@@SA-AW4CompositionInputType@@W4InputType@@@Z.c)
 ...
 *     ?HasInputSink@CInteraction@@QEBA_NXZ @ 0x18009D534 (-HasInputSink@CInteraction@@QEBA_NXZ.c)
 ...
 *     ?AdjustInputTypeForInteraction@CHitTestContext@@AEBA?AW4InputType@@W42@PEBVCInteraction@@@Z @ 0x18009D59C (-AdjustInputTypeForInteraction@CHitTestContext@@AEBA-AW4InputType@@W42@PEBVCInteraction@@@Z.c)
        ...
        struct CHitTestContext::HitTestPointResult *a3)
{
  ...
  if ( (unsigned int)(*((_DWORD *)this + 24) - 2) <= 4 )
  {
    ...
    if ( v8 != v9 )
    {
      while ( 1 )
      {
        v42 = (const struct CInteraction *)v8[1];
...
LABEL_11:
  ...
  *((_QWORD *)v5 + 3) = v15;
  ...
  {
    v17 = v33 | 0x10000000;
    MilInstrumentationCheckHR_MaybeFailFast(v34, &dword_1802DAC20, 2u, v33 | 0x10000000, 0x2CDu, 0LL);
  }
  else
  {
    v35 = *((_DWORD *)v4 + 424);
