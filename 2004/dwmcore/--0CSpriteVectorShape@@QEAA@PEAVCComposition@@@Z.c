/*
 * XREFs of ??0CSpriteVectorShape@@QEAA@PEAVCComposition@@@Z @ 0x18016CCF4
 * Callers:
 ...
 * Callees:
 *     ??0CVectorShape@@IEAA@PEAVCComposition@@@Z @ 0x18016CEEC (--0CVectorShape@@IEAA@PEAVCComposition@@@Z.c)
 */
