/*
 * XREFs of ?UpdateOnManipulationThread@CManipulation@@UEAAJAEBUUpdateOnManipulationThreadArgs@@PEAUIManipulationTelemetryData@@@Z @ 0x1801D64F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     _anonymous_namespace_::StoreIfChanged_float_ @ 0x1801D4BD8 (_anonymous_namespace_--StoreIfChanged_float_.c)
 *     _anonymous_namespace_::StoreIfChanged_D2DVector3_ @ 0x1801D4BF4 (_anonymous_namespace_--StoreIfChanged_D2DVector3_.c)
 *     ?_ResetManipulationThreadDataIfNecessary@CManipulation@@AEAAXW4InteractionState@@@Z @ 0x1801D6BBC (-_ResetManipulationThreadDataIfNecessary@CManipulation@@AEAAXW4InteractionState@@@Z.c)
 ...
 *     ?_UpdateCaptureState@CManipulation@@AEAAX_N@Z @ 0x1801D71C8 (-_UpdateCaptureState@CManipulation@@AEAAX_N@Z.c)
 */
