/*
 * XREFs of ?UpdateTransform@CInteractionContextTransformHelper@@QEAAJAEBVMatrix3x2F@D2D1@@PEA_N@Z @ 0x180269E14
 * Callers:
 ...
 *     GetInverse @ 0x1802691F4 (GetInverse.c)
 *     IsEqualMatrix @ 0x180269390 (IsEqualMatrix.c)
 */
