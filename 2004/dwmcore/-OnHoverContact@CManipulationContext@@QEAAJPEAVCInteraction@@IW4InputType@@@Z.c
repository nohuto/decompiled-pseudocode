/*
 * XREFs of ?OnHoverContact@CManipulationContext@@QEAAJPEAVCInteraction@@IW4InputType@@@Z @ 0x180233004
 * Callers:
 ...
 *     ?LockTree@CManipulationManager@@SAXPEAVCVisualTree@@_N@Z @ 0x180223830 (-LockTree@CManipulationManager@@SAXPEAVCVisualTree@@_N@Z.c)
