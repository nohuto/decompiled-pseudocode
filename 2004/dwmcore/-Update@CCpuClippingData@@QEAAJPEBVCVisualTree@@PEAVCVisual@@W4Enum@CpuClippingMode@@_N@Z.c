/*
 * XREFs of ?Update@CCpuClippingData@@QEAAJPEBVCVisualTree@@PEAVCVisual@@W4Enum@CpuClippingMode@@_N@Z @ 0x18006A8E0
 * Callers:
...
LABEL_8:
  ...
  if ( v9 )
  {
    v26 = CCpuClippingData::CalcMode((__int64)a3, v5, v53);
    v17 = *a1;
    if ( *a1 != v26 )
    {
      *a1 = v26;
...
LABEL_21:
  ...
  *((_QWORD *)a1 + 3) = v20;
  ...
  {
LABEL_34:
    CVisual::CalcCpuClippingTransform(a3, *a1, a2, v19, &a5, *((_QWORD *)a1 + 2), v20);
