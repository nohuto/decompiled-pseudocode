/*
 * XREFs of ?EnsureBitmapCacheSource@CSectionBitmapRealization@@MEAAJXZ @ 0x18008F8E0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( !*((_QWORD *)this + 39) )
  {
    ...
    if ( v5 )
    {
      ...
      if ( v6 )
      {
        ...
        {
          RequiredBufferSize = GetRequiredBufferSize(*((enum DXGI_FORMAT *)this + 85), *((_DWORD *)this + 84), &v20);
