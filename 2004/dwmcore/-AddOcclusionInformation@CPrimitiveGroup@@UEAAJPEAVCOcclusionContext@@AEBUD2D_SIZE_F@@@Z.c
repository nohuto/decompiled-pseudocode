/*
 * XREFs of ?AddOcclusionInformation@CPrimitiveGroup@@UEAAJPEAVCOcclusionContext@@AEBUD2D_SIZE_F@@@Z @ 0x1800C19F8
 * Callers:
 *     ?AddOcclusionInformation@CPrimitiveGroup@@$4PPPPPPPM@A@EAAJPEAVCOcclusionContext@@AEBUD2D_SIZE_F@@@Z @ 0x1800EEF60 (-AddOcclusionInformation@CPrimitiveGroup@@$4PPPPPPPM@A@EAAJPEAVCOcclusionContext@@AEBUD2D_SIZE_F.c)
 * Callees:
        ...
        const struct D2D_SIZE_F *a3)
{
  ...
  if ( *((_QWORD *)this - 26) )
  {
    ...
    if ( v3 > v9[0] && v5 > v4 )
    {
      ...
      if ( v7 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0x42Eu, 0LL);
    }
  }
  return 0LL;
}
