/*
 * XREFs of ?GetTopGpuClipInScope@CScopedClipStack@@QEBAX_NPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800DBBA4
 * Callers:
 *     ?PopCpuClip@CDrawingContext@@AEAAXXZ @ 0x180179198 (-PopCpuClip@CDrawingContext@@AEAAXXZ.c)
 * Callees:
 *     ?HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ @ 0x18007FF94 (-HasGpuClipsInScope@CScopedClipStack@@QEBA_NXZ.c)
