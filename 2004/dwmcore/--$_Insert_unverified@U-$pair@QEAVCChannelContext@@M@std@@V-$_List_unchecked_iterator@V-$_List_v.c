        ...
        __int64 *a4)
{
  ...
  while ( v12 != *(_QWORD *)(a1[3] + 8 * v11) )
  {
    ...
    {
      std::list<std::pair<CResource const * const,CWeakResourceReference *>>::erase(a1 + 1, &v20, a4);
      *(_QWORD *)a2 = v12;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
