/*
 * XREFs of ?DrawLegacyCommandList@CD2DContext@@UEAAJPEBVID2DContextOwner@@PEAUID2D1PrivateCompositorCommandList@@MW4D2D1_ANTIALIAS_MODE@@W4D2D1_DRAW_COMPOSITOR_COMMAND_LIST_OPTIONS@@I_N@Z @ 0x180239DB0
 * Callers:
 *     <none>
 * Callees:
        ...
        char a8)
{
  ...
  if ( !CCommonRegistryData::m_fEnableDisallowNonDrawListRendering
    || (*(_BYTE *)((*(__int64 (__fastcall **)(__int64 *))(*a2 + 32))(a2) + 94) & 0x20) == 0 )
  {
    goto LABEL_28;
  }
  while ( 1 )
...
LABEL_28:
  ...
  if ( a8 )
  {
    (*(void (__fastcall **)(__int64 *, _BYTE *))(v18 + 16))(a2, v25);
    v19 = *(_QWORD *)(a1 + 240);
    v23 = 0;
    v24 = 0;
    v22 = _xmm;
  ...
  {
    (*(void (__fastcall **)(__int64 *, __int128 *))(v18 + 8))(a2, &v22);
    (*(void (__fastcall **)(_QWORD, __int128 *))(**(_QWORD **)(a1 + 240) + 240LL))(*(_QWORD *)(a1 + 240), &v22);
  }
  CD2DContext::SetAntiAliasMode((CD2DContext *)a1, a5);
  (*(void (__fastcall **)(_QWORD, __int64, _QWORD, _BYTE *, unsigned int, int))(**(_QWORD **)(a1 + 248) + 32LL))(
    *(_QWORD *)(a1 + 248),
    a3,
    a6,
    v11,
