/*
 * XREFs of ?SetD2DEffectProperties@CBrightnessEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x1801F70E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CBrightnessEffect::SetD2DEffectProperties(CBrightnessEffect *this, struct ID2D1Effect *a2)
{
  ...
  v12 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 38), (__m128)*((unsigned int *)this + 39)).m128_u64[0];
  ...
  else
  {
    ...
    v12 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 40), (__m128)*((unsigned int *)this + 41)).m128_u64[0];
