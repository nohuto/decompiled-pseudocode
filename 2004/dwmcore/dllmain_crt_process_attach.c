/*
 * XREFs of dllmain_crt_process_attach @ 0x1800E2CF8
 * Callers:
 ...
 *     __scrt_initialize_crt @ 0x1800E2A20 (__scrt_initialize_crt.c)
 *     __scrt_is_nonwritable_in_current_image @ 0x1800E2B28 (__scrt_is_nonwritable_in_current_image.c)
 *     __scrt_release_startup_lock @ 0x1800E2BC8 (__scrt_release_startup_lock.c)
 *     __scrt_fastfail @ 0x1800E3400 (__scrt_fastfail.c)
 *     ?__scrt_initialize_type_info@@YAXXZ @ 0x1800E37C0 (-__scrt_initialize_type_info@@YAXXZ.c)
 *     __scrt_initialize_default_local_stdio_options @ 0x1800E37E8 (__scrt_initialize_default_local_stdio_options.c)
 *     __scrt_get_dyn_tls_init_callback @ 0x1800E380C (__scrt_get_dyn_tls_init_callback.c)
 *     _RTC_Initialize @ 0x1800E381C (_RTC_Initialize.c)
 *     _initterm_0 @ 0x1800E3936 (_initterm_0.c)
 *     _initterm_e_0 @ 0x1800E3942 (_initterm_e_0.c)
