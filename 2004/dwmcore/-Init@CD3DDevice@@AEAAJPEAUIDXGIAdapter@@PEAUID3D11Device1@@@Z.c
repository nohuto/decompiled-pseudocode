/*
 * XREFs of ?Init@CD3DDevice@@AEAAJPEAUIDXGIAdapter@@PEAUID3D11Device1@@@Z @ 0x1800B1CA8
 * Callers:
...
__int64 __fastcall CD3DDevice::Init(CD3DDevice *this, struct IDXGIAdapter *a2, struct ID3D11Device1 *a3)
{
  ...
  int v34; // eax
  __int64 v35; // rcx
  char IsShaderLinkingBlacklistedGpu; // al
  __int64 v37; // r8
  int v38; // ebx
  __int64 v39; // rcx
                ...
                else
                {
                  ...
                  else
                  {
                    IsShaderLinkingBlacklistedGpu = CCommonRegistryData::IsShaderLinkingBlacklistedGpu(
                                                      (const char *)*((unsigned int *)this + 224),
                                                      *((_DWORD *)this + 225));
                    v38 = *((_DWORD *)this + 236);
                    ...
                    *((_QWORD *)this + 77) = 0LL;
                    ...
                    {
                      v43 = CD2DContext::InitializeD2D((struct CD2DResourceManager **)this + 2, *v15);
                      v9 = v43;
                      if ( v43 < 0 )
                      {
