/*
 * XREFs of ?Present@CDDisplayRenderTarget@@UEAAJ_N@Z @ 0x18018D9A0
 * Callers:
 *     ?Present@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800EF790 (-Present@CDDisplayRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
 ...
 *     ?CheckForOcclusionChange@CDDisplayRenderTarget@@IEAAXJ@Z @ 0x1800E8578 (-CheckForOcclusionChange@CDDisplayRenderTarget@@IEAAXJ@Z.c)
 *     ?GetDirtyRects@CDDisplaySwapChain@@UEBAIPEAV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@@Z @ 0x1800E85C0 (-GetDirtyRects@CDDisplaySwapChain@@UEBAIPEAV-$vector@UtagRECT@@V-$allocator@UtagRECT@@@std@@@std.c)
 ...
 *     ?IsPrimaryMonitor@CDDisplayRenderTarget@@UEBA_NXZ @ 0x180171510 (-IsPrimaryMonitor@CDDisplayRenderTarget@@UEBA_NXZ.c)
 ...
 *     ?GetOutstandingFrameCount@CDDisplayRenderTarget@@UEBAIPEAI@Z @ 0x18018D830 (-GetOutstandingFrameCount@CDDisplayRenderTarget@@UEBAIPEAI@Z.c)
 */
