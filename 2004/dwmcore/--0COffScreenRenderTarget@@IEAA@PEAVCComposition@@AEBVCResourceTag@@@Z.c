/*
 * XREFs of ??0COffScreenRenderTarget@@IEAA@PEAVCComposition@@AEBVCResourceTag@@@Z @ 0x1801867BC
 * Callers:
 ...
 * Callees:
 *     ??0CRenderTarget@@IEAA@PEAVCComposition@@@Z @ 0x1800264DC (--0CRenderTarget@@IEAA@PEAVCComposition@@@Z.c)
