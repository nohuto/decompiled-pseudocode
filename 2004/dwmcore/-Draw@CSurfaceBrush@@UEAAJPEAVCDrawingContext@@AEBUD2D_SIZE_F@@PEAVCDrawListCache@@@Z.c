/*
 * XREFs of ?Draw@CSurfaceBrush@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18005598C
 * Callers:
 *     ?Draw@CSurfaceBrush@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x1800F0FE0 (-Draw@CSurfaceBrush@@$4PPPPPPPM@A@EAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@.c)
 * Callees:
  ...
  if ( !v5 || (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 56LL))(v5, 200LL) )
    ...
    v9 = (***((__int64 (__fastcall ****)(_QWORD, GUID *, struct IBitmapResource **))this - 11))(
           *((_QWORD *)this - 11),
           ...
           &v15);
  if ( v9 >= 0 && CDrawingContext::DrawAsOverlay(a2, v15) )
  {
    v12 = 0;
  }
  else
