/*
 * XREFs of ?PushRenderOptionsInternal@CDrawingContext@@IEAAJPEBVCVisual@@PEBUMilRenderOptions@@_N@Z @ 0x1800AAC20
 * Callers:
...
LABEL_7:
    ...
    LOBYTE(v43) = *((_BYTE *)this + 292);
    *(_QWORD *)&v41 = *((_QWORD *)this + 34);
    DWORD2(v41) = *((_DWORD *)this + 75);
    HIDWORD(v41) = *((_DWORD *)this + 70);
    v42 = *(_QWORD *)((char *)this + 284);
...
LABEL_8:
      ...
      *(_DWORD *)(v20 + 24) = v19;
      v21 = *((_DWORD *)this + 232);
      v22 = (unsigned int)++*((_DWORD *)this + 226);
...
LABEL_3:
      v10 = 0;
      *(_OWORD *)(*((_QWORD *)this + 49) + 16LL * v8) = v41;
      v11 = *((_DWORD *)this + 100);
      v12 = (unsigned int)++*((_DWORD *)this + 94);
