/*
 * XREFs of ?NewInteractionSummary@InteractionTraceProvider@@SAXAEBUTouchScenarioInfo@CTelemetryTouchLatencyAnalysis@@_N@Z @ 0x180161B0C
 * Callers:
        ...
        char a2)
{
  ...
  if ( (unsigned int)dword_180342E48 > 5 && (qword_180342E58 & 8) != 0 && (qword_180342E60 & 8) == qword_180342E60 )
  {
    ...
    tlgWriteTransfer_EventWriteTransfer(
      ...
      (unsigned __int8 *)dword_1802E4B54,
      0LL,
      0LL,
      6u,
      &v6);
