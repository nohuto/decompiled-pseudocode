/*
 * XREFs of ?BeginFrame@CDrawingContext@@QEAAJPEAVIDeviceTarget@@PEBVCMILMatrix@@PEBU_D3DCOLORVALUE@@PEAVCOverlayContext@@@Z @ 0x18006622C
 * Callers:
        ...
        struct COverlayContext *a5)
{
  ...
  *(_QWORD *)((char *)this + 284) = 0LL;
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x115u, 0LL);
    return v12;
  }
  ...
  *((_QWORD *)this + 435) = 0LL;
  if ( dword_180349258 > *(_DWORD *)(v23 + 4) )
  {
    Init_thread_header(&dword_180349258);
    if ( dword_180349258 == -1 )
    {
      v33 = CProcessAttributionManager::CreateProcessAttribution(
              v22,
              0xFFFFFFFF,
              (const struct CProcessAttributionManager::ProcessAttributionRecord *)&unk_1803456E0,
              0,
              &v45);
      if ( v33 < 0 )
        ModuleFailFastForHRESULT((unsigned int)v33, retaddr);
      qword_180345668 = (__int64)v45;
      Init_thread_footer(&dword_180349258);
    }
  }
  v24 = (struct CProcessAttribution *)qword_180345668;
  LODWORD(v42) = 11;
  v43 = 0LL;
