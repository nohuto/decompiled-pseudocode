/*
 * XREFs of ?QueryInterface@CLegacySwapChain@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18005A1C0
 * Callers:
 *     ?QueryInterface@CLegacySwapChain@@$4PPPPPPPM@BCA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800F1BF0 (-QueryInterface@CLegacySwapChain@@$4PPPPPPPM@BCA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
