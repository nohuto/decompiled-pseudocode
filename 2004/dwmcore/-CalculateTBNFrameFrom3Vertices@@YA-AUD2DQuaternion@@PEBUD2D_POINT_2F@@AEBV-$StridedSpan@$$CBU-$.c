/*
 * XREFs of ?CalculateTBNFrameFrom3Vertices@@YA?AUD2DQuaternion@@PEBUD2D_POINT_2F@@AEBV?$StridedSpan@$$CBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@@@AEBVCMILMatrix@@2@Z @ 0x1800233AC
 * Callers:
 *     VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____0_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x180012480 (VertexTransfer--Transfer_VertexTransfer--CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldX.c)
 ...
 *     VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801A9908 (VertexTransfer--Transfer_VertexTransfer--CGeneral3DOperator_Vertex_UVxN_VertexXYW_C_ea_1801A9908.c)
 *     VertexTransfer::Transfer_VertexTransfer::CGeneral3DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____2_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801A9A68 (VertexTransfer--Transfer_VertexTransfer--CGeneral3DOperator_Vertex_UVxN_VertexXYW_C_ea_1801A9A68.c)
 *     VertexTransfer::Transfer_VertexTransfer::CNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____1_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801A9D30 (VertexTransfer--Transfer_VertexTransfer--CNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_World.c)
 *     VertexTransfer::Transfer_VertexTransfer::CNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____2_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801A9E2C (VertexTransfer--Transfer_VertexTransfer--CNonScale2DOperator_Vertex_UVxN_VertexXYW__ea_1801A9E2C.c)
 *     VertexTransfer::Transfer_VertexTransfer::CNonScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent____0_Vertex_UVxN_VertexXYW_ColorDW_WorldXYZ_Tangent___ @ 0x1801A9F28 (VertexTransfer--Transfer_VertexTransfer--CNonScale2DOperator_Vertex_UVxN_VertexXYW__ea_1801A9F28.c)
 ...
 *     CalculateTBNFrame @ 0x180023B0C (CalculateTBNFrame.c)
        ...
        CMILMatrix *a5)
{
  __int64 v7; // r9
  __int64 v8; // rdx
  struct D2D_VECTOR_3F *v9; // rax
  __int64 v10; // xmm0_8
  CMILMatrix *v11; // rcx
  struct D2D_VECTOR_3F *v12; // rax
  __int64 v13; // xmm0_8
  struct D2D_VECTOR_3F *v14; // rax
  float y; // xmm8_4
  float x; // xmm7_4
  float z; // xmm6_4
  __int64 v18; // xmm0_8
  ...
  float v24; // xmm7_4
  float v25; // xmm9_4
  _QWORD v27[3]; // [rsp+38h] [rbp-71h] BYREF
  _QWORD v28[3]; // [rsp+50h] [rbp-59h] BYREF
  struct D2D_VECTOR_3F v29; // [rsp+68h] [rbp-41h] BYREF
  struct D2D_VECTOR_3F v30; // [rsp+78h] [rbp-31h] BYREF
  struct D2D_VECTOR_3F v31; // [rsp+88h] [rbp-21h] BYREF
  ...
  v29.z = 1.0;
  v27[1] = v8 + v7 + 16;
  v27[2] = 2 * (int)v8 + v7 + 16;
  CalculateTBNFrame((unsigned int)v28, (unsigned int)v27, (unsigned int)&v29, (unsigned int)&v31, (__int64)&v30);
  v9 = CMILMatrix::Transform3DVector(a4, (struct D2D_VECTOR_3F *)v27, &v31);
  v10 = *(_QWORD *)&v9->x;
  *(FLOAT *)&v9 = v9->z;
  *(_QWORD *)&v31.x = v10;
  LODWORD(v31.z) = (_DWORD)v9;
  v12 = CMILMatrix::Transform3DVector(v11, (struct D2D_VECTOR_3F *)v27, &v30);
  v13 = *(_QWORD *)&v12->x;
  *(FLOAT *)&v12 = v12->z;
  *(_QWORD *)&v30.x = v13;
  LODWORD(v30.z) = (_DWORD)v12;
  v14 = CMILMatrix::Transform3DVector(a5, (struct D2D_VECTOR_3F *)v27, &v29);
  y = v31.y;
  x = v31.x;
  z = v31.z;
  v18 = *(_QWORD *)&v14->x;
  *(FLOAT *)&v14 = v14->z;
  *(_QWORD *)&v29.x = v18;
  LODWORD(v29.z) = (_DWORD)v14;
  *(float *)&v18 = sqrtf_0((float)((float)(y * y) + (float)(x * x)) + (float)(z * z));
  v31.x = x * (float)(1.0 / *(float *)&v18);
  v19 = v30.x;
  v31.y = y * (float)(1.0 / *(float *)&v18);
  v20 = v30.y;
  v31.z = z * (float)(1.0 / *(float *)&v18);
  v21 = v30.z;
  *(float *)&v18 = sqrtf_0((float)((float)(v20 * v20) + (float)(v19 * v19)) + (float)(v21 * v21));
  v30.y = v20 * (float)(1.0 / *(float *)&v18);
  v22 = v29.y;
  v30.z = v21 * (float)(1.0 / *(float *)&v18);
  v23 = v29.x;
  v30.x = v19 * (float)(1.0 / *(float *)&v18);
  v24 = v29.z;
  v25 = 1.0 / sqrtf_0((float)((float)(v22 * v22) + (float)(v23 * v23)) + (float)(v24 * v24));
  v29.x = v25 * v23;
  v29.y = v25 * v22;
  v29.z = v25 * v24;
