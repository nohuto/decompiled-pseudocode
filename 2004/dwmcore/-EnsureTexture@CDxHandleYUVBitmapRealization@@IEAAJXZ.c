/*
 * XREFs of ?EnsureTexture@CDxHandleYUVBitmapRealization@@IEAAJXZ @ 0x180263BCC
 * Callers:
  ...
  if ( !*((_QWORD *)this + 43) )
  {
    ...
    else
    {
      ...
      else
      {
        ...
        v11 = (__int64 *)((char *)*v2 + 88);
        v17 = v10;
        v12 = (_QWORD *)v11[1];
        if ( (_QWORD *)v11[2] == v12 )
        {
          std::vector<ShaderLinkingBody const *>::_Emplace_reallocate<ShaderLinkingBody const *>(v11, v12, &v17);
        }
        else
        {
          *v12 = v10;
