/*
 * XREFs of GetLPCreateDCompositionDirectInkFactoryPartner @ 0x18024B5BC
 * Callers:
...
__int64 __fastcall GetLPCreateDCompositionDirectInkFactoryPartner(FARPROC *a1)
{
  ...
  v1 = dword_180349CE4;
  if ( dword_180349CE4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((__int64)a1, 0LL, 0, dword_180349CE4, 0x18u, 0LL);
    goto LABEL_13;
  }
  ProcAddress = (FARPROC)qword_180349CE8;
  if ( qword_180349CE8 )
    goto LABEL_11;
  SetLastError(0);
  ...
  if ( LibraryW )
  {
    ...
    qword_180349CE8 = (__int64)ProcAddress;
    if ( !ProcAddress )
    {
      v1 = -2147467261;
