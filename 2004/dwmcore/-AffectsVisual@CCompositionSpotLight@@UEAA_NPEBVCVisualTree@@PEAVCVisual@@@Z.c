/*
 * XREFs of ?AffectsVisual@CCompositionSpotLight@@UEAA_NPEBVCVisualTree@@PEAVCVisual@@@Z @ 0x180003C20
 * Callers:
 *     <none>
 * Callees:
...
LABEL_41:
  ...
  if ( v13 >= 0 )
  {
    ...
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)Flink, 0LL, 0, -2003292412, 0x74u, 0LL);
    v13 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v36, 0LL, 0, -2003292412, 0x6E2u, 0LL);
LABEL_26:
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)Flink, 0LL, 0, v13, 0x264u, 0LL);
    return 1;
  }
  MilInstrumentationCheckHR_MaybeFailFast((unsigned int)Flink, 0LL, 0, v13, 0x6DDu, 0LL);
LABEL_53:
  if ( v13 < 0 )
    goto LABEL_26;
  LOBYTE(v14) = 1;
...
LABEL_89:
  ...
  if ( v51[7].Blink < (struct _LIST_ENTRY *)v63 )
  {
    ...
    v42 = v64;
    if ( v64 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v50, 0LL, 0, v64, 0x793u, 0LL);
  }
  if ( v42 >= 0 )
  {
    if ( v51[7].Blink )
    ...
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v50, 0LL, 0, -2003292412, 0x74u, 0LL);
    v42 = -2003292412;
    MilInstrumentationCheckHR_MaybeFailFast(v69, 0LL, 0, -2003292412, 0x6E2u, 0LL);
LABEL_73:
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v50, 0LL, 0, v42, 0x287u, 0LL);
    return 1;
  }
  MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v50, 0LL, 0, v42, 0x6DDu, 0LL);
LABEL_98:
  if ( v42 < 0 )
    goto LABEL_73;
