/*
 * XREFs of ??0?$CInputTypeContext@UDwmMousewheelInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeMousewheelPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeMousewheelPrimitiveType@@@@QEAA@W4InputType@@@Z @ 0x1800DCA10
 * Callers:
        ...
        __int64 a1)
{
  ...
  *(_QWORD *)a1 = 0LL;
  *(_OWORD *)(a1 + 20) = xmmword_1802DD610;
  *(_OWORD *)(a1 + 36) = xmmword_1802DD620;
  *(_OWORD *)(a1 + 52) = xmmword_1802DD630;
  *(_OWORD *)(a1 + 68) = xmmword_1802DD640;
  *(_QWORD *)(a1 + 88) = 0LL;
  *(_QWORD *)(a1 + 96) = 0LL;
  *(_QWORD *)(a1 + 104) = 0LL;
  *(_DWORD *)(a1 + 112) = 0;
