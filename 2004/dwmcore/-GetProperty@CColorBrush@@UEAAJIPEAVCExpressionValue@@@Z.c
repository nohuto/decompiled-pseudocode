/*
 * XREFs of ?GetProperty@CColorBrush@@UEAAJIPEAVCExpressionValue@@@Z @ 0x1800BA620
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CColorBrush::GetProperty(CColorBrush *this, int a2, struct CExpressionValue *a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( a2 == **(_DWORD **)v5 )
      break;
    if ( ++v5 == (const struct AnimationHelper::AnimatedProperty *const near *const *)&unk_180273378 )
      goto LABEL_11;
  }
  if ( !v6 )
  {
