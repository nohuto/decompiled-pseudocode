/*
 * XREFs of _anonymous_namespace_::VectorInsideAngleThreshold @ 0x18022E034
 * Callers:
 ...
 *     _anonymous_namespace_::CanAddThisColumnVectorToMatrix @ 0x18022AA80 (_anonymous_namespace_--CanAddThisColumnVectorToMatrix.c)
