/*
 * XREFs of ?GetPresentStatisticsDWM@CHolographicInteropTarget@@UEBAJPEAUDXGI_FRAME_STATISTICS_DWM@@PEAU_UNSIGNED_RATIO@@@Z @ 0x180255E10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _UNSIGNED_RATIO *a3)
{
  ...
  if ( v3 )
  {
    ...
    if ( v6 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802EE908, 2u, v6, 0x119u, 0LL);
  }
  else
  {
    v6 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802EE908, 2u, -2003304307, 0x11Du, 0LL);
  }
