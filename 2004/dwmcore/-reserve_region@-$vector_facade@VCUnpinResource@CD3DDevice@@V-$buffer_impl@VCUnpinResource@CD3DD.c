/*
 * XREFs of ?reserve_region@?$vector_facade@VCUnpinResource@CD3DDevice@@V?$buffer_impl@VCUnpinResource@CD3DDevice@@$06$00Vliberal_expansion_policy@detail@@@detail@@@detail@@IEAAPEAVCUnpinResource@CD3DDevice@@_K0@Z @ 0x18023F3B0
 * Callers:
 ...
 *     ??$move_backward_uninitialized@V?$basic_iterator@VCUnpinResource@CD3DDevice@@@detail@@V?$checked_array_iterator@PEAVCUnpinResource@CD3DDevice@@@stdext@@@detail@@YAXV?$basic_iterator@VCUnpinResource@CD3DDevice@@@0@0V?$checked_array_iterator@PEAVCUnpinResource@CD3DDevice@@@stdext@@@Z @ 0x18023B8EC (--$move_backward_uninitialized@V-$basic_iterator@VCUnpinResource@CD3DDevice@@@detail@@V-$checked.c)
