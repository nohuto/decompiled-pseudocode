/*
 * XREFs of ?DeriveDesktopPlaneAttributes@COverlayContext@@AEAAXAEBV?$span@PEAVOverlayPlaneInfo@COverlayContext@@$0?0@gsl@@_N@Z @ 0x180033264
 * Callers:
 ...
 *     ?OverlaysEnabled@COverlayContext@@AEBA_NXZ @ 0x18017E428 (-OverlaysEnabled@COverlayContext@@AEBA_NXZ.c)
...
LABEL_2:
  ...
  *((_DWORD *)this + 2754) = 2;
  ...
  else
  {
    ...
    v26 = 0LL;
    if ( FastRegion::CRegion::GetBoundingRect((FastRegion::CRegion *)&v27, &v26) )
