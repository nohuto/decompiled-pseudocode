/*
 * XREFs of ??0CInteractionContextWrapper@@QEAA@XZ @ 0x18002BE18
 * Callers:
 ...
 *     ??0CInteractionContextTransformHelper@@QEAA@XZ @ 0x18002BFEC (--0CInteractionContextTransformHelper@@QEAA@XZ.c)
 */
