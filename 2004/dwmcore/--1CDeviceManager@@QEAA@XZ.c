/*
 * XREFs of ??1CDeviceManager@@QEAA@XZ @ 0x1800E1DF8
 * Callers:
 *     _dynamic_atexit_destructor_for__g_DeviceManager__ @ 0x1800F3F00 (_dynamic_atexit_destructor_for__g_DeviceManager__.c)
 * Callees:
...
void __fastcall CDeviceManager::~CDeviceManager(CDeviceManager *this)
{
  ...
  v1 = (void *)qword_1803495A8;
  if ( qword_1803495A8 )
  {
    std::_Destroy_range<std::allocator<CDeviceManager::DeviceInfo>>(qword_1803495A8, xmmword_1803495B0);
    std::_Deallocate<16,0>(v1, (*((_QWORD *)&xmmword_1803495B0 + 1) - (_QWORD)v1) & 0xFFFFFFFFFFFFFFF0uLL);
    qword_1803495A8 = 0LL;
    xmmword_1803495B0 = 0LL;
  }
  DeleteCriticalSection(&stru_180349580);
  if ( g_DeviceManager )
  {
