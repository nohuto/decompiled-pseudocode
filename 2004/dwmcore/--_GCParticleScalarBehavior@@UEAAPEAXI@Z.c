/*
 * XREFs of ??_GCParticleScalarBehavior@@UEAAPEAXI@Z @ 0x18016F070
 * Callers:
 *     ??_ECParticleScalarBehavior@@WGI@EAAPEAXI@Z @ 0x1800EEED0 (--_ECParticleScalarBehavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
