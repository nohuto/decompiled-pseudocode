/*
 * XREFs of ?AddShaderToCache@CRenderingTechnique@@AEBAJPEAVCCompiledEffectCache@@IAEBUShaderLinkingConfig@@PEAPEAVCLinkedShader@@@Z @ 0x1800B9AE8
 * Callers:
        ...
        struct CLinkedShader **a5)
{
  ...
  *(_OWORD *)v22 = 0LL;
  ...
  while ( ((char *)v22[1] - (char *)v22[0]) >> 4 )
  {
    ...
    if ( v5 == v11 )
    {
      std::vector<ShaderLinkingBody const *>::_Emplace_reallocate<ShaderLinkingBody const *>((__int64 *)&v24, v11, &v26);
      v5 = v25;
      v11 = (unsigned __int64 *)*((_QWORD *)&v24 + 1);
    }
    else
  ...
  v13 = *(v11 - 1);
  v14 = v24;
  v15 = ((__int64)((__int64)v11 - v24) >> 3) - 1;
