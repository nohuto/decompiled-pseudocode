/*
 * XREFs of ?wil_RtlStagingConfig_QueryFeatureState@@YAHPEAUwil_FeatureState@@IHPEAH@Z @ 0x18002F27C
 * Callers:
 *     ?wil_QueryFeatureState@@YAHPEAUwil_FeatureState@@IHW4wil_FeatureStore@@PEAH2@Z @ 0x18002EE5C (-wil_QueryFeatureState@@YAHPEAUwil_FeatureState@@IHW4wil_FeatureStore@@PEAH2@Z.c)
 * Callees:
        ...
        int *a4)
{
  ...
  if ( g_wil_details_pfnRtlQueryFeatureConfiguration
    || (NtDllModuleHandle = wil_details_GetNtDllModuleHandle(),
        ...
        (g_wil_details_pfnRtlQueryFeatureConfiguration = (int (__high *)(unsigned int, enum _RTL_FEATURE_CONFIGURATION_TYPE, unsigned __int64 *, struct _RTL_FEATURE_CONFIGURATION *))ProcAddress) != 0LL) )
  {
