/*
 * XREFs of ?Initialize@CDxHandleYUVBitmapRealization@@IEAAJPEAVIYUVSwapChainRealization@@@Z @ 0x180264420
 * Callers:
...
LABEL_13:
  ...
  else
  {
    ...
    v17 = (__int64 *)(*((_QWORD *)this + 43) + 88LL);
    v21 = v16;
    v18 = (CD3DDevice **)v17[1];
    if ( (CD3DDevice **)v17[2] == v18 )
    {
      std::vector<ShaderLinkingBody const *>::_Emplace_reallocate<ShaderLinkingBody const *>(v17, v18, &v21);
    }
    else
    {
      *v18 = v16;
