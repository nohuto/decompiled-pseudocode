/*
 * XREFs of ??$AddLinkInternal@VCResource@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVCResource@@_N@Z @ 0x1801EF384
 * Callers:
...
__int64 __fastcall CVisualTreeDumpContext::AddLinkInternal<CResource>(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( a3 )
    return CDebugTreeDumper::RegisterNodeForVisit<CResource>(a1[14], a3);
  return result;
}
