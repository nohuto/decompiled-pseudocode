/*
 * XREFs of _anonymous_namespace_::SynthesizeDescription @ 0x18001D4EC
 * Callers:
 ...
 * Callees:
 *     _anonymous_namespace_::GetExpressionTypeString @ 0x18001D598 (_anonymous_namespace_--GetExpressionTypeString.c)
 ...
 *     swprintf_s @ 0x1800E3B30 (swprintf_s.c)
 */
...
__int64 __fastcall anonymous_namespace_::SynthesizeDescription(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  ExpressionTypeString = anonymous_namespace_::GetExpressionTypeString(
                           ...
                           *(unsigned int *)(a2 + 184));
  v10 = v5;
  v7 = swprintf_s(Buffer, 0x64uLL, L"%s::%s::%d", off_180278950[*(int *)(v6 + 204)], ExpressionTypeString, v10);
