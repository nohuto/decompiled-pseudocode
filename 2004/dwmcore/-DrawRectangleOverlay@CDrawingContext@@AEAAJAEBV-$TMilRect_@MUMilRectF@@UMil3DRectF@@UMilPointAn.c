/*
 * XREFs of ?DrawRectangleOverlay@CDrawingContext@@AEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801778A8
 * Callers:
...
__int64 __fastcall CDrawingContext::DrawRectangleOverlay(__int64 a1, __int64 a2)
{
  ...
  v2 = (__m128)_mm_loadu_si128(&xmmword_1802EE670[g_DirtyRegionColor]);
