/*
 * XREFs of ?Initialize@CSecondarySysmemBitmap@@IEAAJXZ @ 0x180091708
 * Callers:
...
__int64 __fastcall CSecondarySysmemBitmap::Initialize(enum DXGI_FORMAT *this)
{
  ...
  if ( PixelFormatSize && (v3 = *((unsigned int *)this + 32), (unsigned int)v3 <= 0x7FFFFFF8u / PixelFormatSize) )
  {
    v4 = 0;
    v5 = ((((unsigned int)v3 * PixelFormatSize + 7) >> 3) + 3) & 0xFFFFFFFC;
  }
  else
  {
    v4 = -2147024362;
