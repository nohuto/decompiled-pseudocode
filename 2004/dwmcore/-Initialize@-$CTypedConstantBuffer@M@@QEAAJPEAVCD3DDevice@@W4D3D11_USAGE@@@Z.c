/*
 * XREFs of ?Initialize@?$CTypedConstantBuffer@M@@QEAAJPEAVCD3DDevice@@W4D3D11_USAGE@@@Z @ 0x1800B26B8
 * Callers:
...
__int64 __fastcall CTypedConstantBuffer<float>::Initialize(struct ID3D11Buffer **a1, struct CD3DDevice *a2)
{
  unsigned int v2; // ebx
  int v3; // eax
  __int64 v4; // rcx
