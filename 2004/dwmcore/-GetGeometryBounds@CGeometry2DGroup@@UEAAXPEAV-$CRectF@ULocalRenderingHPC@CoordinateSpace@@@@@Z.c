/*
 * XREFs of ?GetGeometryBounds@CGeometry2DGroup@@UEAAXPEAV?$CRectF@ULocalRenderingHPC@CoordinateSpace@@@@@Z @ 0x1801B6100
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( *(_DWORD *)(a1 + 96) )
      {
        do
        {
          ...
          if ( v7 )
          {
            v8 = *v7;
            v12 = 0LL;
            (*(void (__fastcall **)(__int64 *, __int128 *))(v8 + 216))(v7, &v12);
