/*
 * XREFs of ??1CaptureBitsResponse@@UEAA@XZ @ 0x180035244
 * Callers:
...
void __fastcall CaptureBitsResponse::~CaptureBitsResponse(CaptureBitsResponse *this)
{
  ...
  *(_QWORD *)this = &CaptureBitsResponse::`vftable';
  ...
  wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>((char *)this + 48);
