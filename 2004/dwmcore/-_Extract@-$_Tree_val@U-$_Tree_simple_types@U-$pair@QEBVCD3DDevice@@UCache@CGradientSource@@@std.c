 ...
 *     ?NotifyAtlasEntryInvalidated@CGradientSource@@MEAAXPEBVCD3DDevice@@@Z @ 0x18020956C (-NotifyAtlasEntryInvalidated@CGradientSource@@MEAAXPEBVCD3DDevice@@@Z.c)
...
__int64 *__fastcall std::_Tree_val<std::_Tree_simple_types<std::pair<CD3DDevice const * const,CGradientSource::Cache>>>::_Extract(
        __int64 **a1,
        __int64 a2)
{
  __int64 v3; // rdx
