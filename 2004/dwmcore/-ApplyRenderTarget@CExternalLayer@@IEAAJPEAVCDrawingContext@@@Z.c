/*
 * XREFs of ?ApplyRenderTarget@CExternalLayer@@IEAAJPEAVCDrawingContext@@@Z @ 0x18003A5C4
 * Callers:
...
__int64 __fastcall CExternalLayer::ApplyRenderTarget(CExternalLayer *this, struct CDrawingContext *a2)
{
  ...
  else
  {
    ...
    *((_BYTE *)this + 33) = 1;
    ...
    {
      v12 = CDrawingContext::Clear((struct CDrawingContext *)((char *)a2 + 16), &stru_1802AB000);
      v7 = v12;
      if ( v12 < 0 )
      {
