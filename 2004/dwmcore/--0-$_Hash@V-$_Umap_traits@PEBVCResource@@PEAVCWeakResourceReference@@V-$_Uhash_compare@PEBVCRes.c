 ...
 * Callers:
 *     ??0?$unordered_map@PEBVCResource@@PEAVCWeakResourceReference@@U?$hash@PEBVCResource@@@std@@U?$equal_to@PEBVCResource@@@4@V?$allocator@U?$pair@QEBVCResource@@PEAVCWeakResourceReference@@@std@@@4@@std@@QEAA@XZ @ 0x1800CAEF4 (--0-$unordered_map@PEBVCResource@@PEAVCWeakResourceReference@@U-$hash@PEBVCResource@@@std@@U-$eq.c)
 * Callees:
        ...
        int *a2)
{
  ...
  *v2 = v2;
  v2[1] = v2;
  qword_180349418 = (__int64)v2;
  qword_180349428 = 0LL;
  xmmword_180349430 = 0LL;
  ...
  memset64((void *)qword_180349428, (unsigned __int64)v2, 0x10uLL);
  CWeakResourceReference::s_weakReferenceMap = (int)FLOAT_1_0;
  *(_QWORD *)&xmmword_180349430 = v3 + 128;
  result = &CWeakResourceReference::s_weakReferenceMap;
  xmmword_180349440 = (__int128)si128;
  return result;
}
