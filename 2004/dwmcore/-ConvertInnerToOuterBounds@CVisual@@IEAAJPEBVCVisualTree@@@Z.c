/*
 * XREFs of ?ConvertInnerToOuterBounds@CVisual@@IEAAJPEBVCVisualTree@@@Z @ 0x180078060
 * Callers:
...
__int64 __fastcall CVisual::ConvertInnerToOuterBounds(CVisual *this, CVisual **a2)
{
  ...
  if ( (v7 & 0x4000000) != 0 )
  {
    ...
    if ( v9 )
    {
      ...
      if ( v19 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x5A7u, 0LL);
        return v5;
      }
...
LABEL_117:
  ...
  if ( !v9 )
  {
    ...
    if ( v23 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v24, 0LL, 0, v23, 0x5B9u, 0LL);
      return v5;
    }
  }
...
LABEL_75:
            ...
            updated >= 0) )
      {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, -2003292412, 0x74u, 0LL);
          MilInstrumentationCheckHR_MaybeFailFast(v49, 0LL, 0, -2003292412, 0x6E2u, 0LL);
        }
      }
      else
      {
        MilInstrumentationCheckHR_MaybeFailFast(v31, 0LL, 0, updated, 0x793u, 0LL);
        MilInstrumentationCheckHR_MaybeFailFast(v48, 0LL, 0, v47, 0x6DDu, 0LL);
      }
    }
LABEL_82:
    if ( this == a2[7] )
...
LABEL_108:
        ...
        *(_QWORD *)((char *)this + 156) = qword_1803447E8;
      }
    }
    else
    {
