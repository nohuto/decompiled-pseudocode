/*
 * XREFs of ??$CreateServer@VDiagnosticCallbacksManager@@@BaseBamoConnection@Bamo@Microsoft@@SAJPEAUIMessageSession@@PEAUIMessagePort@@UMsgScopeID@@PEBGPEAPEAVDiagnosticCallbacksManager@@@Z @ 0x18002CC3C
 * Callers:
 ...
 * Callees:
 *     ??0DiagnosticCallbacksManager@@QEAA@XZ @ 0x18002CD08 (--0DiagnosticCallbacksManager@@QEAA@XZ.c)
