/*
 * XREFs of ?ComputeOverlayConfiguration@COverlayContext@@SAJAEBV?$span@PEAVCOverlayContext@@$0?0@gsl@@@Z @ 0x180059110
 * Callers:
 ...
 *     ?HaveOverlayCandidatesChanged@COverlayContext@@AEAA_NXZ @ 0x180059758 (-HaveOverlayCandidatesChanged@COverlayContext@@AEAA_NXZ.c)
...
LABEL_141:
          ...
          gsl::span<COverlayContext::OverlayPlaneInfo *,-1>::span<COverlayContext::OverlayPlaneInfo *,-1>(&v79, &v109);
...
LABEL_80:
      ...
      else
      {
        do
        {
          ...
          {
            v4 = 0LL;
            MilInstrumentationCheckHR_MaybeFailFast(v44, 0LL, 0, v43, 0x71Fu, 0LL);
            v48 = v109;
            if ( (v110 - (_BYTE *)v109) >> 3 )
            {
              detail::vector_facade<CDesktopTree *,detail::buffer_impl<CDesktopTree *,1,1,detail::liberal_expansion_policy>>::clear_region(&v109);
        ...
        v4 = 0LL;
        MilInstrumentationCheckHR_MaybeFailFast(v46, 0LL, 0, v45, 0x725u, 0LL);
        v48 = v109;
        if ( (v110 - (_BYTE *)v109) >> 3 )
        {
          detail::vector_facade<CDesktopTree *,detail::buffer_impl<CDesktopTree *,1,1,detail::liberal_expansion_policy>>::clear_region(&v109);
...
LABEL_152:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(a1, 0LL, 0, v7, 0xADu, 0LL);
  v15 = (COverlayContext **)v101;
LABEL_57:
  if ( v7 < 0 )
  {
