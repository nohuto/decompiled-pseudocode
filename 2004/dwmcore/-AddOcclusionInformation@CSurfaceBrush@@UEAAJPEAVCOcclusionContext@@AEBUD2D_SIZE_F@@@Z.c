/*
 * XREFs of ?AddOcclusionInformation@CSurfaceBrush@@UEAAJPEAVCOcclusionContext@@AEBUD2D_SIZE_F@@@Z @ 0x180055708
 * Callers:
 *     ?AddOcclusionInformation@CSurfaceBrush@@$4PPPPPPPM@A@EAAJPEAVCOcclusionContext@@AEBUD2D_SIZE_F@@@Z @ 0x1800F0FD0 (-AddOcclusionInformation@CSurfaceBrush@@$4PPPPPPPM@A@EAAJPEAVCOcclusionContext@@AEBUD2D_SIZE_F@@.c)
 * Callees:
...
LABEL_24:
  ...
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD *))(*v23 + 8LL))(v23) )
  {
    *(_OWORD *)v26 = 0LL;
    ...
    {
      v12 = COcclusionContext::CollectRectangleForOcclusion(a2, v26, v13, 0LL);
      v7 = v12;
      if ( v12 >= 0 )
        goto LABEL_19;
      v21 = 314;
