/*
 * XREFs of ?GetWindowClipShape@CWindowNode@@AEBAJPEAVCShapePtr@@@Z @ 0x180040760
 * Callers:
 ...
 *     ?Offset@CRegionShape@@QEAAJJJ@Z @ 0x1800EC660 (-Offset@CRegionShape@@QEAAJJJ@Z.c)
...
__int64 __fastcall CWindowNode::GetWindowClipShape(CWindowNode *this, struct CShapePtr *a2)
{
  ...
  else
  {
    ...
    if ( ShapeData < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, ShapeData, 0x81Fu, 0LL);
    }
    else
    {
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x825u, 0LL);
      }
      else
      {
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x832u, 0LL);
        }
        else
        {
          v18 = v20;
