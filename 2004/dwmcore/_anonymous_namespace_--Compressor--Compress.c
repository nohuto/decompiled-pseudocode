/*
 * XREFs of _anonymous_namespace_::Compressor::Compress @ 0x1800879A8
 * Callers:
 ...
 *     ?_Buy_raw@?$vector@EV?$allocator@E@std@@@std@@AEAAX_K@Z @ 0x180087BC4 (-_Buy_raw@-$vector@EV-$allocator@E@std@@@std@@AEAAX_K@Z.c)
