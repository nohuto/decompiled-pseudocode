/*
 * XREFs of ?CreatePolygonMesh@Mesh@@QEAAJAEBUContentInfo@1@PEBUD2D_POINT_2F@@PEBW4D2D1_EDGE_FLAGS@@H@Z @ 0x1801A212C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  do
  {
    ...
    *(unsigned __int64 *)((char *)v26.m128_u64 + 4) = __PAIR64__(v26.m128_u32[0], LODWORD(y));
    ...
    if ( v18 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0x15Bu, 0LL);
      goto LABEL_22;
    }
    v21 = *(float *)(*((_QWORD *)this + 2) + 4LL);
    if ( v21 > COERCE_FLOAT(COERCE_UNSIGNED_INT(v12 - v10) & _xmm)
      || v21 > COERCE_FLOAT(COERCE_UNSIGNED_INT(v13 - v11) & _xmm) )
    {
      v20 = 1;
      goto LABEL_23;
    }
  ...
  if ( v20 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v22, 0LL, 0, v20, 0x16Bu, 0LL);
  }
  else if ( v20 != 1 )
  {
