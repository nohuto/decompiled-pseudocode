/*
 * XREFs of ?CreateScratchRenderTargetBitmap@CD3DDevice@@IEAAJAEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@AEBVRenderTargetInfo@@PEAPEAVCScratchRenderTargetBitmap@@@Z @ 0x180090A58
 * Callers:
...
LABEL_11:
    v19 = v12;
LABEL_14:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802AB078, 2u, v19, v21, 0LL);
  }
