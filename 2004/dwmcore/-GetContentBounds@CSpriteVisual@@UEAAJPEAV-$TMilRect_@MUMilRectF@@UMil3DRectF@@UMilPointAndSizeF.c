/*
 * XREFs of ?GetContentBounds@CSpriteVisual@@UEAAJPEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800AB140
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSpriteVisual::GetContentBounds(CSpriteVisual *this, __int64 a2)
{
  ...
  *(_QWORD *)a2 = 0LL;
  ...
  if ( v5 )
  {
    ...
    v4 = v7;
    if ( v7 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v8, 0LL, 0, v7, 0xE8Fu, 0LL);
  }
