/*
 * XREFs of ?FillShapeWithBitmap@CDrawingContext@@QEAAJPEAVIBitmapResource@@AEBVCMILMatrix@@AEBVCShape@@_NH@Z @ 0x18004E36C
 * Callers:
 ...
 *     ?SetInverse@MILMatrix3x2@@QEAAXAEBV1@@Z @ 0x18004E6AC (-SetInverse@MILMatrix3x2@@QEAAXAEBV1@@Z.c)
