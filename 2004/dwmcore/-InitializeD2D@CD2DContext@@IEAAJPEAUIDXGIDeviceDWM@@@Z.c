/*
 * XREFs of ?InitializeD2D@CD2DContext@@IEAAJPEAUIDXGIDeviceDWM@@@Z @ 0x1800B0F00
 * Callers:
...
__int64 __fastcall CD2DContext::InitializeD2D(struct CD2DResourceManager **this, struct IDXGIDeviceDWM *a2)
{
  ...
  {
    D2DDevice = CD2DResourceManager::Create((struct CD2DContext *)this, this + 26);
    v7 = D2DDevice;
    if ( D2DDevice < 0 )
    {
      v14 = 37;
    ...
    {
      v9 = this + 28;
      D2DDevice = CD2DFactory::CreateD2DDevice((CD2DFactory *)v6, a2, this + 28);
      v7 = D2DDevice;
      if ( D2DDevice < 0 )
      {
        v14 = 40;
