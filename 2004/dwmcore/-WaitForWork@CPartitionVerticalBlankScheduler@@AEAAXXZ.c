/*
 * XREFs of ?WaitForWork@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x18005BC8C
 * Callers:
 ...
 *     ?UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z @ 0x1801647DC (-UpdateGlitchList@CDebugFrameCounter@@IEAAXAEA_K@Z.c)
  ...
  if ( (char *)hObject - 1 > (char *)0xFFFFFFFFFFFFFFFDLL )
  {
    if ( qword_180349558 )
    {
      ...
      else
      {
        ...
        {
          if ( EventW != (char *)-1LL
            && (*(int (__fastcall **)(CDisplayManager *, char *, int *))(*(_QWORD *)qword_180349558 + 176LL))(
                 qword_180349558,
                 EventW,
                 &dword_180349568) >= 0 )
          {
