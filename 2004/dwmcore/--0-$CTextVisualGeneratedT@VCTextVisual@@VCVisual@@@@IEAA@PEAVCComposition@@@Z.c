/*
 * XREFs of ??0?$CTextVisualGeneratedT@VCTextVisual@@VCVisual@@@@IEAA@PEAVCComposition@@@Z @ 0x1801F20AC
 * Callers:
...
CVisual *__fastcall CTextVisualGeneratedT<CTextVisual,CVisual>::CTextVisualGeneratedT<CTextVisual,CVisual>(
        CVisual *a1,
        struct CComposition *a2)
{
  CVisual::CVisual(a1, a2);
  *((_QWORD *)a1 + 77) = 0LL;
  *((_QWORD *)a1 + 78) = 0LL;
  *((_QWORD *)a1 + 79) = 0LL;
  *((_QWORD *)a1 + 80) = 0LL;
