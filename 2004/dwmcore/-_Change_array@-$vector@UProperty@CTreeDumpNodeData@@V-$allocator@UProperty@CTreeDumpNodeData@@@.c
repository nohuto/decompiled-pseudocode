/*
 * XREFs of ?_Change_array@?$vector@UProperty@CTreeDumpNodeData@@V?$allocator@UProperty@CTreeDumpNodeData@@@std@@@std@@AEAAXQEAUProperty@CTreeDumpNodeData@@_K1@Z @ 0x180157848
 * Callers:
...
void __fastcall std::vector<CTreeDumpNodeData::Property>::_Change_array(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v6 )
  {
    std::_Destroy_range<std::allocator<CTreeDumpNodeData::Property>>(v6, *(_QWORD **)(a1 + 8));
