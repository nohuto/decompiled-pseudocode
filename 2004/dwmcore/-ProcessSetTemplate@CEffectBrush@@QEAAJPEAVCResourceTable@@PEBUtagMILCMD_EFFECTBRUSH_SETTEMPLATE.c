/*
 * XREFs of ?ProcessSetTemplate@CEffectBrush@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_EFFECTBRUSH_SETTEMPLATE@@@Z @ 0x1800B641C
 * Callers:
        ...
        const struct tagMILCMD_EFFECTBRUSH_SETTEMPLATE *a3)
{
  ...
  Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, *((_DWORD *)a3 + 2), 0x1Au);
  v7 = Resource;
  if ( !Resource )
  {
...
LABEL_8:
  ...
  v16 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 112, 8, 1, &v18);
  v9 = v16;
  if ( v16 < 0 )
