/*
 * XREFs of ?RegisterSceneListener@CSceneResourceManager@@QEAAXPEAUISceneNotificationListener@@@Z @ 0x18016A44C
 * Callers:
 ...
 *     ?OnChannelAttached@CSpatialRemarshaler@@MEAAJXZ @ 0x1801EDDA0 (-OnChannelAttached@CSpatialRemarshaler@@MEAAJXZ.c)
