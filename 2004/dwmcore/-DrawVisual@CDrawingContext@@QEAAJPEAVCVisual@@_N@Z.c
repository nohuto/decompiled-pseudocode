/*
 * XREFs of ?DrawVisual@CDrawingContext@@QEAAJPEAVCVisual@@_N@Z @ 0x180037108
 * Callers:
 *     ?DrawVisual@CDrawingContext@@UEAAJPEAVCVisual@@@Z @ 0x180021710 (-DrawVisual@CDrawingContext@@UEAAJPEAVCVisual@@@Z.c)
 *     ?Draw@CRedirectedVisualContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z @ 0x18003670C (-Draw@CRedirectedVisualContent@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEAVCDrawListCache@@@Z.c)
 ...
 *     ?Top@?$CWatermarkStack@M$0EA@$01$09@@QEBAJPEAMI@Z @ 0x1800370DC (-Top@-$CWatermarkStack@M$0EA@$01$09@@QEBAJPEAMI@Z.c)
...
__int64 __fastcall CDrawingContext::DrawVisual(CDrawingContext *this, struct CVisual *a2, char a3)
{
  ...
  if ( VisualTree < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, VisualTree, 0xA90u, 0LL);
LABEL_17:
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0xA92u, 0LL);
    goto LABEL_32;
  }
  ...
  if ( v13 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xA94u, 0LL);
LABEL_32:
    wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>(&v31);
    return v5;
  }
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v19, 0LL, 0, v18, 0xAC8u, 0LL);
    COcclusionContext::~COcclusionContext((COcclusionContext *)v45);
    wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>(&v31);
    v6 = v32;
  }
  else
  {
    ...
    if ( v20 >= 0 )
    {
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0xAD0u, 0LL);
      }
      else
      {
        ...
        *((_DWORD *)v6 + 72) = *((_DWORD *)this + 72);
        ...
        CWatermarkStack<float,64,2,10>::Top((int *)this + 808, &v32);
        v24 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push((char *)v6 + 3232, &v32);
        v5 = v24;
        if ( v24 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v25, 0LL, 0, v24, 0xADEu, 0LL);
        }
        else
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0xAE4u, 0LL);
        }
      }
      COcclusionContext::~COcclusionContext((COcclusionContext *)v45);
      wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>(&v31);
LABEL_18:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0xACCu, 0LL);
    COcclusionContext::~COcclusionContext((COcclusionContext *)v45);
    wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>(&v31);
  }
LABEL_19:
