/*
 * XREFs of ?Lock@CWICBitmapWrapper@@UEAAJPEBUWICRect@@W4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x180091280
 * Callers:
 *     ?LockForRead@CWICBitmapWrapper@@UEBAJAEBV?$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAVIBitmapLock@@@Z @ 0x180217730 (-LockForRead@CWICBitmapWrapper@@UEBAJAEBV-$TMilRect@IUMilRectU@@UMil3DRectU@@UNotNeeded@RectUniq.c)
 * Callees:
        ...
        struct IBitmapLock **a4)
{
  ...
  *a4 = 0LL;
  (***((void (__fastcall ****)(_QWORD, GUID *, unsigned int *))this + 28))(
    *((_QWORD *)this + 28),
...
LABEL_23:
  ...
  *(_OWORD *)v38 = 0LL;
  if ( a2 )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(0LL, 0LL, 0, -2147024809, 0xA8u, 0LL);
    }
    else
    {
...
LABEL_16:
    ...
    v26 = (*(__int64 (__fastcall **)(_QWORD, unsigned int *, _QWORD, _QWORD, void *))(**((_QWORD **)this + 28) + 56LL))(
            *((_QWORD *)this + 28),
            v38,
            v23,
            (unsigned int)v24,
