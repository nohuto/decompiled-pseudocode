/*
 * XREFs of ?GetValueAt@?$LinearKeyframeAnimation@M@Particles@@QEBAMMAEBV?$span@M$0?0@gsl@@AEAV34@@Z @ 0x1801DCDD0
 * Callers:
 ...
 * Callees:
 *     ?FindFirstFrameIndex@?$LinearKeyframeAnimation@M@Particles@@IEBAIM@Z @ 0x1801DCC54 (-FindFirstFrameIndex@-$LinearKeyframeAnimation@M@Particles@@IEBAIM@Z.c)
 */
