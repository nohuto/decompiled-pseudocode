 ...
 *     ?_Destroy_if_node@?$_Tree@V?$_Tmap_traits@PEBVCD3DDevice@@UCache@CGradientSource@@U?$less@PEBVCD3DDevice@@@std@@V?$allocator@U?$pair@QEBVCD3DDevice@@UCache@CGradientSource@@@std@@@5@$0A@@std@@@std@@IEAAXPEAU?$_Tree_node@U?$pair@QEBVCD3DDevice@@UCache@CGradientSource@@@std@@PEAX@2@@Z @ 0x1802095E0 (-_Destroy_if_node@-$_Tree@V-$_Tmap_traits@PEBVCD3DDevice@@UCache@CGradientSource@@U-$less@PEBVCD.c)
 */
        ...
        __int64 a6)
{
  ...
  {
    std::_Tree<std::_Tmap_traits<CD3DDevice const *,CGradientSource::Cache,std::less<CD3DDevice const *>,std::allocator<std::pair<CD3DDevice const * const,CGradientSource::Cache>>,0>>::_Destroy_if_node(
      0x492492492492491LL,
      a6);
