/*
 * XREFs of ?CurrentInertiaVelocity@CScaleMotion@@MEBAMXZ @ 0x18020E650
 * Callers:
 *     ?CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ @ 0x18020E6D0 (-CurrentInertiaVelocity@CPositionMotion@@MEBAMXZ.c)
 * Callees:
