/*
 * XREFs of ?ApplyConfiguration@COverlayContext@@QEAAJPEAV?$vector@PEBVCVisual@@V?$allocator@PEBVCVisual@@@std@@@std@@PEA_N1@Z @ 0x18007DF2C
 * Callers:
...
LABEL_70:
      ...
      *((_QWORD *)this + 1412) = v33;
      ...
      v10 = v36;
      if ( v36 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v34, 0LL, 0, v36, 0x273u, 0LL);
      if ( v10 == -2005532292 )
      {
        COverlayContext::ClearDirectFlip(this);
        v10 = 0;
