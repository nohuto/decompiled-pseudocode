/*
 * XREFs of ??$AddLinkInternal@VCGdiSpriteBitmap@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVCGdiSpriteBitmap@@_N@Z @ 0x1801F44D4
 * Callers:
...
__int64 __fastcall CVisualTreeDumpContext::AddLinkInternal<CGdiSpriteBitmap>(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( a3 )
    return CDebugTreeDumper::RegisterNodeForVisit<CGdiSpriteBitmap>(a1[14], a3);
  return result;
}
