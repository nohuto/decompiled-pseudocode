/*
 * XREFs of ?GetHandoffData@CAnimation@@UEAA_NPEAW4Enum@DwmAnimationHandoffType@@PEAMPEA_K@Z @ 0x1800BFEF0
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (*((_BYTE *)this + 8) & 0x40) == 0 )
    {
      if ( *((_DWORD *)this + 49) )
      {
        ...
        if ( (_DWORD)v14 )
        {
          ...
          v15 = *((_QWORD *)this - 11);
          v16[1] = v14;
          CoreUICallSend(*(_QWORD *)(*(_QWORD *)(v15 + 1080) + 48LL), v16, 2LL, 1LL, 1, &unk_1802CCDDB);
          *((_BYTE *)this + 8) |= 0x40u;
        }
      }
    }
