/*
 * XREFs of ?PreRender@CLocalAppRenderTarget@@UEAAJXZ @ 0x18018BF38
 * Callers:
 *     ?PreRender@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EFFF0 (-PreRender@CLocalAppRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
