/*
 * XREFs of ?ConvertInnerToOuterBounds@CVectorShape@@QEAAXAEBUD2D_MATRIX_3X2_F@@@Z @ 0x1801BF924
 * Callers:
 *     ?PostSubgraph@CShapeBoundingContext@@QEAAJPEA_N@Z @ 0x18025F7D4 (-PostSubgraph@CShapeBoundingContext@@QEAAJPEA_N@Z.c)
 * Callees:
 *     ?Transform2DBounds@MILMatrix3x2@@QEBAXAEBUMilRectF@@AEAU2@@Z @ 0x180016BE0 (-Transform2DBounds@MILMatrix3x2@@QEBAXAEBUMilRectF@@AEAU2@@Z.c)
 */
