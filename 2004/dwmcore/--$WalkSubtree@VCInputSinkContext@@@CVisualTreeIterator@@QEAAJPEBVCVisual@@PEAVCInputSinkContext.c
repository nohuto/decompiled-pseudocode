/*
 * XREFs of ??$WalkSubtree@VCInputSinkContext@@@CVisualTreeIterator@@QEAAJPEBVCVisual@@PEAVCInputSinkContext@@W4WalkReason@@@Z @ 0x1800A0330
 * Callers:
 ...
 *     ?GotoParent@?$CGraphWalker@VCVisual@@@@QEAAXPEAPEAVCVisual@@@Z @ 0x18009F574 (-GotoParent@-$CGraphWalker@VCVisual@@@@QEAAXPEAPEAVCVisual@@@Z.c)
        ...
        int a4)
{
  ...
  v16 = (__int64)a2;
  *(_DWORD *)(a1 + 72) = 1;
  v7 = CGraphWalker<CVisual>::BeginWalk(a1, (void **)&v16);
  v9 = v7;
  if ( v7 < 0 )
  {
    v13 = 207;
