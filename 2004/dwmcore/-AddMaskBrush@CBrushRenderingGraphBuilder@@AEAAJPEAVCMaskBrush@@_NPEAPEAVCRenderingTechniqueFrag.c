/*
 * XREFs of ?AddMaskBrush@CBrushRenderingGraphBuilder@@AEAAJPEAVCMaskBrush@@_NPEAPEAVCRenderingTechniqueFragment@@@Z @ 0x1800B6E80
 * Callers:
...
LABEL_17:
    ...
    *(_QWORD *)v25 = &v28;
    ...
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v21, 0LL, 0, v5, 0x165u, 0LL);
    if ( v28 )
      CRenderingTechniqueFragment::`scalar deleting destructor'(v28, (unsigned int)v18);
  }
  else
