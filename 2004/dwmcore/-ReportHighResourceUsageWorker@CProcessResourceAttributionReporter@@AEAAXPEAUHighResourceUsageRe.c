/*
 * XREFs of ?ReportHighResourceUsageWorker@CProcessResourceAttributionReporter@@AEAAXPEAUHighResourceUsageReport@1@@Z @ 0x1800E56FC
 * Callers:
 *     ?ReportHighResourceUsageWorker@CProcessResourceAttributionReporter@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WORK@@@Z @ 0x1800DAA10 (-ReportHighResourceUsageWorker@CProcessResourceAttributionReporter@@CAXPEAU_TP_CALLBACK_INSTANCE.c)
 * Callees:
  ...
  if ( v4 != v33 )
  {
    ...
    do
    {
      ...
      if ( v6 == v7 || (a3 = *(_DWORD **)v6, v15 = *((_QWORD *)v4 + 1), **(_QWORD **)v6 != v15) )
      {
        if ( !v4[25] )
        {
          if ( (unsigned int)dword_180342E80 > 5
            && (qword_180342E90 & 0x400000000000LL) != 0
            && (qword_180342E98 & 0x400000000000LL) == qword_180342E98 )
          {
            v32 = *((_QWORD *)v4 + 1);
            v24 = *v4;
            v23 = v24;
