/*
 * XREFs of ?Get@CWeakResourceReference@@KAJPEAVCResource@@PEAPEAV1@@Z @ 0x18009C3EC
 * Callers:
 ...
 *     ??0CWeakResourceReference@@AEAA@PEAVCResource@@@Z @ 0x18009C4D4 (--0CWeakResourceReference@@AEAA@PEAVCResource@@@Z.c)
