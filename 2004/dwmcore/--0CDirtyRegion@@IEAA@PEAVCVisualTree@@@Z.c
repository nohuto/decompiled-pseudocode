/*
 * XREFs of ??0CDirtyRegion@@IEAA@PEAVCVisualTree@@@Z @ 0x180035FC4
 * Callers:
 *     ??0CVisualTree@@IEAA@PEAVCComposition@@PEAVCVisual@@@Z @ 0x180035CBC (--0CVisualTree@@IEAA@PEAVCComposition@@PEAVCVisual@@@Z.c)
 * Callees:
 *     ??0CDirtyRegionAnnotationAllocationSet@@QEAA@XZ @ 0x1800360E4 (--0CDirtyRegionAnnotationAllocationSet@@QEAA@XZ.c)
