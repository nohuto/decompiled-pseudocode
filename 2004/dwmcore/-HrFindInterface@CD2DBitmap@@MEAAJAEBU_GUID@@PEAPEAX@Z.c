/*
 * XREFs of ?HrFindInterface@CD2DBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180058820
 * Callers:
 *     ?HrFindInterface@CDeviceTextureTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800587B0 (-HrFindInterface@CDeviceTextureTarget@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
...
LABEL_22:
    ...
    else
    {
      ...
      if ( v14 )
      {
        v10 = *(int *)(*(_QWORD *)((((unsigned __int64)this + 80) & -(__int64)(this != 0LL)) + 8) + 12LL);
        v11 = (char *)(v14 + 8);
        goto LABEL_21;
      }
    }
