/*
 * XREFs of ?ResetBackBuffer@CCompSwapChain@@IEAAJXZ @ 0x18024FC2C
 * Callers:
...
__int64 __fastcall CCompSwapChain::ResetBackBuffer(CCompSwapChain *this)
{
  ...
  *v1 = 0LL;
  ...
  if ( v7 )
  {
    ...
    if ( v9 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_1802EE908, 2u, v9, 0x193u, 0LL);
    }
    else
    {
      v12 = *((_QWORD *)this + 13);
      *((_QWORD *)this + 13) = 0LL;
      ...
      if ( v13 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_1802EE908, 2u, v13, 0x195u, 0LL);
      }
      else
      {
        v15 = *v1;
        ...
        *v1 = 0LL;
        ...
        {
          MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802EE908, 2u, DeviceTextureTarget, 0x19Du, 0LL);
        }
        else
        {
  ...
  {
    v11 = -2003304307;
    MilInstrumentationCheckHR_MaybeFailFast(v3, &dword_1802EE908, 2u, -2003304307, 0x1A3u, 0LL);
  }
  return v11;
}
