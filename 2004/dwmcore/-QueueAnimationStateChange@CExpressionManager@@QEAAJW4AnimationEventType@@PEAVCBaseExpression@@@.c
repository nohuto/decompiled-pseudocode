/*
 * XREFs of ?QueueAnimationStateChange@CExpressionManager@@QEAAJW4AnimationEventType@@PEAVCBaseExpression@@@Z @ 0x18008C5A0
 * Callers:
...
__int64 __fastcall CExpressionManager::QueueAnimationStateChange(__int64 a1, int a2, int *a3)
{
  ...
  *((_QWORD *)&v10 + 1) = a3;
  ...
  if ( v5 > *(_DWORD *)(a1 + 252) )
  {
    v8 = DynArrayImpl<1>::AddMultipleAndSet(a1 + 232, 16LL, a3, &v10);
    v6 = v8;
    if ( v8 < 0 )
