/*
 * XREFs of ?HolographicClientCreated_@CompositorTracing@@QEAAXXZ @ 0x180251E38
 * Callers:
...
void __fastcall CompositorTracing::HolographicClientCreated_(CompositorTracing *this)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802EB239, 0LL, 0LL, 2u, &v2);
  }
}
