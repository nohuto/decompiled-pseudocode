/*
 * XREFs of ?ProcessSetShapes@CShapeVisual@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_SHAPEVISUAL_SETSHAPES@@PEBXI@Z @ 0x1801ED914
 * Callers:
        ...
        unsigned int a5)
{
  ...
  struct CShapeTree *v19; // [rsp+70h] [rbp+18h] BYREF
