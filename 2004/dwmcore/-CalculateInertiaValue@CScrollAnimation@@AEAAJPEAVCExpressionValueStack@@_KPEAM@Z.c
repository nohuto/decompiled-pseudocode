/*
 * XREFs of ?CalculateInertiaValue@CScrollAnimation@@AEAAJPEAVCExpressionValueStack@@_KPEAM@Z @ 0x180202AEC
 * Callers:
        ...
        float *a4)
{
  ...
  int v14; // eax
  __int64 v15; // rcx
  __int64 (__fastcall *v16)(CScrollAnimation *, struct CExpressionValueStack *, wchar_t *); // r9
  int v17; // eax
  __int64 v18; // rcx
  ...
  {
    v20[0] = *(_QWORD *)(*((_QWORD *)this + 2) + 456LL) - *((_QWORD *)this + 42);
