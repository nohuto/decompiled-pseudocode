/*
 * XREFs of ?RenderTargetRectToDesktopRect@CLegacyRenderTarget@@IEAAX_NAEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1801863EC
 * Callers:
...
char __fastcall CLegacyRenderTarget::RenderTargetRectToDesktopRect(__int64 a1, __int64 a2, __int64 a3, _OWORD *a4)
{
  char v4; // al
  __m128i v5; // xmm1
  __m128i v7; // xmm0
  ...
  *(float *)v5.m128i_i32 = (float)*(int *)(a3 + 12);
  ...
  CMILMatrix::SetToInverse((CMILMatrix *)v9, (const struct CMILMatrix *)(a1 + 264 + (v4 != 0 ? 0x44 : 0)));
