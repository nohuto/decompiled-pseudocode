/*
 * XREFs of ?UpdateNumberOfReadersRemoteCache@BamoDataProviderProxyImpl@BamoImpl@@AEAAXXZ @ 0x18018326C
 * Callers:
 *     ?SetNumberOfReaders@BamoDataProviderProxy@@UEAAXI@Z @ 0x180183220 (-SetNumberOfReaders@BamoDataProviderProxy@@UEAAXI@Z.c)
 *     ?PushStateToPrincipalOnPlaceholderProxyReset@BamoDataProviderProxyImpl@BamoImpl@@UEAAXXZ @ 0x1801950C0 (-PushStateToPrincipalOnPlaceholderProxyReset@BamoDataProviderProxyImpl@BamoImpl@@UEAAXXZ.c)
 * Callees:
        ...
        BamoImpl::BamoDataProviderProxyImpl *this)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 24) + 32LL) + 56LL) )
  {
    ...
    v9[0] = v6;
    v9[1] = v5;
    v8 = CoreUICallSend(v7, v9, 2LL, 0LL, 4, &unk_1802CE645);
