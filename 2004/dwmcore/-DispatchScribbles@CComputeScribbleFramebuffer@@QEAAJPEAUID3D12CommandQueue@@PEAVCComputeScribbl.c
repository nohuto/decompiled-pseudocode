/*
 * XREFs of ?DispatchScribbles@CComputeScribbleFramebuffer@@QEAAJPEAUID3D12CommandQueue@@PEAVCComputeScribbleStopwatch@@_KPEAUIUnknown@@AEAV?$vector@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@@Z @ 0x1800E9F40
 * Callers:
 ...
 *     ??$_Resize@U_Value_init_tag@std@@@?$vector@UComputeScribbleLatencyData@@V?$allocator@UComputeScribbleLatencyData@@@std@@@std@@AEAAX_KAEBU_Value_init_tag@1@@Z @ 0x1801A7168 (--$_Resize@U_Value_init_tag@std@@@-$vector@UComputeScribbleLatencyData@@V-$allocator@UComputeScr.c)
