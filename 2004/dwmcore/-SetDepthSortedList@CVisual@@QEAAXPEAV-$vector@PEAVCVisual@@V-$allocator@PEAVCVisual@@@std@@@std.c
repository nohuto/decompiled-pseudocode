/*
 * XREFs of ?SetDepthSortedList@CVisual@@QEAAXPEAV?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@@Z @ 0x1801B0178
 * Callers:
 *     ?DeleteDepthSortedList@CVisual@@AEAAXXZ @ 0x1800A2FF8 (-DeleteDepthSortedList@CVisual@@AEAAXXZ.c)
 *     ?CreateDepthSortedList@CVisual@@AEAAPEAV?$vector@PEAVCVisual@@V?$allocator@PEAVCVisual@@@std@@@std@@XZ @ 0x1801AEB84 (-CreateDepthSortedList@CVisual@@AEAAPEAV-$vector@PEAVCVisual@@V-$allocator@PEAVCVisual@@@std@@@s.c)
 * Callees:
...
__int64 __fastcall CVisual::SetDepthSortedList(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      result = (__int64)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((_QWORD *)(a1 + 224), 4);
      *(_QWORD *)result = a2;
    }
  }
  ...
  {
    *v3 &= ~0x10000000u;
    result = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot((__int64)v3, 4);
