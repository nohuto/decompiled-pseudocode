/*
 * XREFs of ?EnsureSwapChain@CLegacyRenderTarget@@MEAAJPEA_N@Z @ 0x180024E10
 * Callers:
 *     <none>
 * Callees:
      ...
      else
      {
        ...
        *((_BYTE *)this + 18584) = v15;
        ...
        if ( v13 >= 0 )
        {
          ...
          if ( Device < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v19, &dword_1802D9558, 4u, Device, 0x440u, 0LL);
            v26 = v37;
            if ( !v37 )
              goto LABEL_22;
            goto LABEL_21;
          ...
          if ( *((_DWORD *)this + 24) > 1u )
          {
            ...
            *v2 = 0LL;
            ...
            if ( ConversionSwapChain >= 0 )
              goto LABEL_17;
            MilInstrumentationCheckHR_MaybeFailFast(v30, &dword_1802D9558, 4u, ConversionSwapChain, 0x45Bu, 0LL);
          }
          else
          {
            v20 = *v2;
...
LABEL_17:
              ...
              if ( v24 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v25, &dword_1802D9558, 4u, v24, 0x45Eu, 0LL);
              }
              else
              {
                *((_BYTE *)this + 129) = 1;
            ...
            MilInstrumentationCheckHR_MaybeFailFast(v23, &dword_1802D9558, 4u, LegacySwapChain, 0x44Fu, 0LL);
          }
LABEL_19:
          if ( !v21 )
          {
...
LABEL_21:
    ...
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v12, &dword_1802D9558, 4u, v32, v36, 0LL);
    goto LABEL_22;
  }
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v8, &dword_1802D9558, 4u, -2003304442, 0x428u, 0LL);
LABEL_41:
  v33 = *((_QWORD *)this + 19);
  *((_QWORD *)this + 19) = 0LL;
  if ( v33 )
