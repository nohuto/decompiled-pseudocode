/*
 * XREFs of ?Release@ReferencedGitCookie@?$GitStorageType@UIInspectable@@@detail@XWinRT@@QEAAKXZ @ 0x180245A4C
 * Callers:
        ...
        volatile signed __int32 *a1)
{
  ...
  {
    if ( *((_DWORD *)a1 + 1) )
      (*(void (__fastcall **)(__int64))(*(_QWORD *)qword_180345680 + 32LL))(qword_180345680);
