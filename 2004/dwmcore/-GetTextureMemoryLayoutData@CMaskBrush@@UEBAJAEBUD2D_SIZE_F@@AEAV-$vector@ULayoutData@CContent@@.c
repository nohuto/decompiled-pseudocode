/*
 * XREFs of ?GetTextureMemoryLayoutData@CMaskBrush@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801D7810
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMaskBrush::GetTextureMemoryLayoutData(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(a3 + 8) = v3;
  ...
  v22 = 0LL;
  v21 = 0LL;
  v9 = (*(__int64 (__fastcall **)(__int64, __int64, __int128 *))(*(_QWORD *)v6 + 272LL))(v6, a2, &v21);
  v4 = v9;
  if ( v9 >= 0 )
  {
...
LABEL_5:
    ...
    if ( v11 )
    {
      v22 = 0LL;
      v21 = 0LL;
      v12 = (*(__int64 (__fastcall **)(__int64, __int64, __int128 *))(*(_QWORD *)v11 + 272LL))(v11, a2, &v21);
      v4 = v12;
      if ( v12 < 0 )
      {
