/*
 * XREFs of ?MarkAllTargetsDirty@CCachedVisualImage@@IEAAXXZ @ 0x1800D0108
 * Callers:
 ...
 *     ?OnChanged@CCachedVisualImage@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1800D00D0 (-OnChanged@CCachedVisualImage@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z.c)
