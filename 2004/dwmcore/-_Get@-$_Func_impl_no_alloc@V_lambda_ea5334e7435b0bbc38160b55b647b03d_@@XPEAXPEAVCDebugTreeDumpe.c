/*
 * XREFs of ?_Get@?$_Func_impl_no_alloc@V_lambda_ea5334e7435b0bbc38160b55b647b03d_@@XPEAXPEAVCDebugTreeDumper@@@std@@EEBAPEBXXZ @ 0x1800DD890
 * Callers:
...
__int64 __fastcall std::_Func_impl_no_alloc<_lambda_ea5334e7435b0bbc38160b55b647b03d_,void,void *,CDebugTreeDumper *>::_Get(
        __int64 a1)
{
  return a1 + 8;
}
