/*
 * XREFs of ?UpdateInteraction@CManipulationTelemetryData@@UEAAJPEBUIManipulationResource@@W4ScrollState@@_K@Z @ 0x180230ED0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  while ( v40[0] )
  {
    ...
    if ( (unsigned int)dword_180342E48 > 5 && (qword_180342E58 & 2) != 0 && (qword_180342E60 & 2) == qword_180342E60 )
    {
