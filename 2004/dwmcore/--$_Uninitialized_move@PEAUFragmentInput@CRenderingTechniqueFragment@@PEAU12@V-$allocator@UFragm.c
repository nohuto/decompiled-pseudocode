/*
 * XREFs of ??$_Uninitialized_move@PEAUFragmentInput@CRenderingTechniqueFragment@@PEAU12@V?$allocator@UFragmentInput@CRenderingTechniqueFragment@@@std@@@std@@YAPEAUFragmentInput@CRenderingTechniqueFragment@@QEAU12@0PEAU12@AEAV?$allocator@UFragmentInput@CRenderingTechniqueFragment@@@0@@Z @ 0x1800B76C8
 * Callers:
...
char *__fastcall std::_Uninitialized_move<CRenderingTechniqueFragment::FragmentInput *,CRenderingTechniqueFragment::FragmentInput *,std::allocator<CRenderingTechniqueFragment::FragmentInput>>(
        __int64 *a1,
        __int64 *a2,
        char *a3)
{
  ...
  std::_Destroy_range<std::allocator<CRenderingTechniqueFragment::FragmentInput>>(a3, a3);
  return a3;
}
