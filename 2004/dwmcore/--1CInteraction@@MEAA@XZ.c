/*
 * XREFs of ??1CInteraction@@MEAA@XZ @ 0x1800DC3A4
 * Callers:
 ...
 *     ?IsDefaultInteractionStateLocked@CInteraction@@AEAA_NXZ @ 0x1800DCCF4 (-IsDefaultInteractionStateLocked@CInteraction@@AEAA_NXZ.c)
...
void __fastcall CInteraction::~CInteraction(CInteraction *this)
{
  ...
  *((_QWORD *)this + 1) = &CInteraction::`vftable'{for `CResource'};
  ...
  memset_0((char *)qword_180343248 + (unsigned int)(Size * *((_DWORD *)this + 424)), 0, (unsigned int)Size);
  *((_DWORD *)this + 424) = 0;
