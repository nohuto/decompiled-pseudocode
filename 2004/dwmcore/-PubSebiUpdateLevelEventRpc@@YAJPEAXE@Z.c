/*
 * XREFs of ?PubSebiUpdateLevelEventRpc@@YAJPEAXE@Z @ 0x180215E30
 * Callers:
 *     ?SignalSEB@CLegacyRenderTarget@@AEAAX_NI@Z @ 0x1800243EC (-SignalSEB@CLegacyRenderTarget@@AEAAX_NI@Z.c)
 *     ??1CLegacyRenderTarget@@MEAA@XZ @ 0x180025DB0 (--1CLegacyRenderTarget@@MEAA@XZ.c)
 * Callees:
 *     ?PubSebiGetRpcBindingHandle@@YAJPEAPEAX@Z @ 0x180024744 (-PubSebiGetRpcBindingHandle@@YAJPEAPEAX@Z.c)
