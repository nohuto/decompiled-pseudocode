/*
 * XREFs of ?ParseGpuIdListKey@CCommonRegistryData@@CA_NPEBDPEAPEAUGpuId@1@PEAI@Z @ 0x1800AF6E8
 * Callers:
 *     ?IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z @ 0x1800B0D78 (-IsShaderLinkingBlacklistedGpu@CCommonRegistryData@@SA_NII@Z.c)
 * Callees:
...
LABEL_15:
  ...
  while ( 1 )
  {
    ...
    else
    {
      ...
      v20 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&v24, 6, 1, &v29);
      v22 = v20;
      if ( v20 >= 0 )
      {
        v7 = v27;
