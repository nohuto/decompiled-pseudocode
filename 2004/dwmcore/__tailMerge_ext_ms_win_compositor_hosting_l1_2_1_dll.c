/*
 * XREFs of __tailMerge_ext_ms_win_compositor_hosting_l1_2_1_dll @ 0x1800E3EDC
 * Callers:
 *     __imp_load_NotifyInputSinkParented @ 0x1800E3ED0 (__imp_load_NotifyInputSinkParented.c)
 *     __imp_load_NotifyInputSinkRemoved @ 0x1800E47C8 (__imp_load_NotifyInputSinkRemoved.c)
 * Callees:
