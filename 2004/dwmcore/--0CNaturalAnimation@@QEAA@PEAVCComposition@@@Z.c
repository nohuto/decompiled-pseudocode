/*
 * XREFs of ??0CNaturalAnimation@@QEAA@PEAVCComposition@@@Z @ 0x18016C8A4
 * Callers:
 ...
 *     ?ClearState@CNaturalAnimation@@AEAAXXZ @ 0x1801D8CA8 (-ClearState@CNaturalAnimation@@AEAAXXZ.c)
 */
