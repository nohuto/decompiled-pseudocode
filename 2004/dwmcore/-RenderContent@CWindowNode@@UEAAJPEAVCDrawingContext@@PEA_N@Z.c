/*
 * XREFs of ?RenderContent@CWindowNode@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x1800AB3C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CWindowNode::RenderContent(CWindowNode *this, struct _LIST_ENTRY **a2, bool *a3)
{
  ...
  if ( (*((_BYTE *)this + 95) & 4) != 0 )
  {
    if ( *(_BYTE *)(*((_QWORD *)this + 2) + 1129LL) )
    {
      ...
      v11 = v13;
      if ( v13 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x55Fu, 0LL);
      else
        *a3 = 1;
      return v11;
    }
...
LABEL_6:
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v10, 0LL, 0, v9, 0x56Eu, 0LL);
    return v11;
  }
          ...
          LODWORD(a2[5][60].Blink)) )
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x577u, 0LL);
      return v11;
    }
    goto LABEL_41;
  }
...
LABEL_41:
    if ( (*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)this + 90) + 40LL))(*((_QWORD *)this + 90)) )
    {
      ...
      if ( v32 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v33, 0LL, 0, v32, 0x58Eu, 0LL);
        return v11;
      }
    }
LABEL_46:
    ...
    if ( (v11 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v37, 0LL, 0, v11, 0x5A1u, 0LL);
    }
    else
    {
LABEL_54:
      ...
      v11 = v38;
      if ( v38 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v39, 0LL, 0, v38, 0x5A4u, 0LL);
    }
    return v11;
  }
  while ( 1 )
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, v28, 0x588u, 0LL);
  return v11;
}
