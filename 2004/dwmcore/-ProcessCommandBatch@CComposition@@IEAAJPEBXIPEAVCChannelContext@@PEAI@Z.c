/*
 * XREFs of ?ProcessCommandBatch@CComposition@@IEAAJPEBXIPEAVCChannelContext@@PEAI@Z @ 0x1800A6250
 * Callers:
 ...
 *     ?IsOOM@@YA_NJ@Z @ 0x1800D75FC (-IsOOM@@YA_NJ@Z.c)
 ...
 *     ?GetStackCaptureRootFailureAddress@@YAPEAXJ@Z @ 0x180215954 (-GetStackCaptureRootFailureAddress@@YAPEAXJ@Z.c)
        ...
        unsigned int *a5)
{
  ...
  __int64 v29; // r9
  unsigned int v30[2]; // [rsp+20h] [rbp-48h]
  unsigned int v32; // [rsp+80h] [rbp+18h]
  unsigned int *v34; // [rsp+90h] [rbp+28h]
...
LABEL_35:
    if ( !IsOOM(v14) )
    {
      ...
      CComposition::FailFastOnMalformedPacket(v16, (unsigned int)v14, StackCaptureRootFailureAddress, v29);
    }
...
LABEL_11:
  while ( v14 != 1 )
  {
    ...
    *(_QWORD *)v30 = v11;
    v16 = this;
    v17 = CComposition::ProcessMessage(this, v7, v9, v10, *(_QWORD *)v30, v12);
    v14 = v17;
    if ( v17 < 0 )
    {
