/*
 * XREFs of ?PushGpuClipRectInternal@CDrawingContext@@AEAAJPEBVCVisual@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@W4D2D1_ANTIALIAS_MODE@@_N@Z @ 0x1800666A0
 * Callers:
 ...
 *     ?CeilingSat@CFloatFPU@@SAHM@Z @ 0x1800668A8 (-CeilingSat@CFloatFPU@@SAHM@Z.c)
 ...
 *     ?RoundWithHalvesDown@@YAXAEBUMilRectF@@PEAV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800D0EB4 (-RoundWithHalvesDown@@YAXAEBUMilRectF@@PEAV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSize.c)
...
__int64 __fastcall CDrawingContext::PushGpuClipRectInternal(__int64 a1, __int64 a2, float *a3, int a4, char a5)
{
  ...
  if ( a2 )
  {
    *((_QWORD *)&v23 + 1) = a2;
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0xB08u, 0LL);
      goto LABEL_11;
    }
    v5 = 1;
  }
...
LABEL_9:
  if ( v16 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0xB0Du, 0LL);
  else
    *(_BYTE *)(a1 + 5954) = 1;
LABEL_11:
  if ( v16 < 0 && v5 )
