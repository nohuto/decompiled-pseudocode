/*
 * XREFs of ?RenderContent@CVisual@@UEAAJPEAVCDrawingContext@@PEA_N@Z @ 0x1800AB860
 * Callers:
...
__int64 __fastcall CVisual::RenderContent(CVisual *this, struct CDrawingContext *a2, bool *a3)
{
  ...
  int v26; // ecx
  int v27; // r9d
  struct CDrawListCache *v28; // [rsp+A8h] [rbp+20h] BYREF
  ...
  {
    v7 = 4LL;
    if ( dword_1803492DC > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                     + 4LL) )
    {
      Init_thread_header(&dword_1803492DC);
      if ( dword_1803492DC == -1 )
      {
        dword_180343AD8 = -2147022876;
        Init_thread_footer(&dword_1803492DC);
      }
    }
    v8 = 0LL;
    v28 = 0LL;
    ...
    if ( ((unsigned __int8 (__fastcall *)(struct _LIST_ENTRY *, __int64, bool *))v9->Flink[12].Blink)(v9, v7, a3) )
    {
    ...
    if ( v12 )
    {
      ...
      if ( Cache >= 0 )
      {
        v8 = v28;
LABEL_10:
        v15 = v6 + *(int *)(*(_QWORD *)(v6 + 56) + 8LL) + 56LL;
        v16 = (*(__int64 (__fastcall **)(__int64, struct CDrawingContext *, char *, struct CDrawListCache *))(*(_QWORD *)v15 + 16LL))(
                ...
                v8);
        if ( v16 < 0 )
          MilInstrumentationCheckHR_MaybeFailFast(v17, &dword_180343AD0, 3u, v16, 0x1052u, 0LL);
        goto LABEL_12;
      }
...
LABEL_28:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)v12, &dword_180343AD0, 3u, v10, 0x104Du, 0LL);
LABEL_12:
...
LABEL_15:
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x400) == 0
    || !(*(unsigned __int8 (__fastcall **)(CVisual *, struct CDrawingContext *, bool *))(*(_QWORD *)this + 280LL))(
          this,
          a2,
          a3) )
  {
  ...
  v21 = (const char *)&word_1802CD8A6;
  v22 = (const char *)&word_1802CD8A6;
  v23 = 1;
