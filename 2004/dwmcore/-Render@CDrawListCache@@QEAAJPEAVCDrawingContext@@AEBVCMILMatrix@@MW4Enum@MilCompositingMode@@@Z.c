/*
 * XREFs of ?Render@CDrawListCache@@QEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@MW4Enum@MilCompositingMode@@@Z @ 0x180056600
 * Callers:
...
__int64 __fastcall CDrawListCache::Render(__int64 a1, _QWORD *a2, float *a3, float a4)
{
  ...
  struct D2D_RECT_F v63[3]; // [rsp+E0h] [rbp-20h] BYREF
  _BYTE v64[16]; // [rsp+110h] [rbp+10h] BYREF
...
LABEL_9:
      ...
      while ( v15 != v18 )
      {
        ...
        v20 = (*(__int64 (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v19 + 24LL))(v19, v64);
        v21 = 0LL;
        v22 = (struct D2D_RECT_F *)v20;
        v63[0] = 0LL;
        v23 = *(_DWORD *)(v59 + 416);
        if ( v23 )
        ...
        if ( v25 > v63[0].left && v24 > v63[0].top && v63[0].right > v27 && v63[0].bottom > v26 )
        {
