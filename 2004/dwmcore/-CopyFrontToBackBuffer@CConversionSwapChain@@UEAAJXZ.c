/*
 * XREFs of ?CopyFrontToBackBuffer@CConversionSwapChain@@UEAAJXZ @ 0x18024D62C
 * Callers:
 *     ?CopyFrontToBackBuffer@CConversionSwapChain@@$4PPPPPPPM@A@EAAJXZ @ 0x1800F2220 (-CopyFrontToBackBuffer@CConversionSwapChain@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
...
__int64 __fastcall CConversionSwapChain::CopyFrontToBackBuffer(CConversionSwapChain *this, __int64 a2, __int64 a3)
{
  ...
  if ( !v3 || v3 == 3 )
  {
    ...
    while ( (unsigned __int64)v14 < v13 )
    {
      ...
      CLegacySwapChain::NotifyRenderedRect((__int64)this - 424, (__int64)v17);
  ...
  {
    v5 = (CConversionSwapChain *)((char *)this - 424);
    CLegacySwapChain::NotifyRenderedRect((__int64)this - 424, (__int64)this - 96);
  }
