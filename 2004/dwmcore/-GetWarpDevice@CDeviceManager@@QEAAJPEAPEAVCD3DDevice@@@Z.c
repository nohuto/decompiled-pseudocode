/*
 * XREFs of ?GetWarpDevice@CDeviceManager@@QEAAJPEAPEAVCD3DDevice@@@Z @ 0x180236F4C
 * Callers:
...
__int64 __fastcall CDeviceManager::GetWarpDevice(CDeviceManager *this, struct CD3DDevice **a2)
{
  ...
  *a2 = 0LL;
  ...
  for ( i = qword_1803495A8; i != (_QWORD)xmmword_1803495B0; i += 16LL )
  {
  ...
  v10 = Device;
  if ( Device < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v9, &dword_1802EE908, 2u, Device, 0xF5u, 0LL);
  v2 = v10;
LABEL_9:
