/*
 * XREFs of ?GenerateGridAntialiasBorder@Mesh@@AEBAX_NAEBV?$StridedSpan@UVertexXYW_ColorDW@@@@AEBV?$StridedSpan@UVertexAAFixupBase@@@@PEAHPEAGH3@Z @ 0x1800BC1C4
 * Callers:
 ...
 * Callees:
 *     OffsetBaseVertices @ 0x1800BC76C (OffsetBaseVertices.c)
 *     CopyBaseVertices @ 0x1800BC824 (CopyBaseVertices.c)
