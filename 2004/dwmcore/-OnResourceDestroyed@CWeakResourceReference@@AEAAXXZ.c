/*
 * XREFs of ?OnResourceDestroyed@CWeakResourceReference@@AEAAXXZ @ 0x1800C93D4
 * Callers:
 ...
 *     ??0?$vector@PEAVCResource@@V?$allocator@PEAVCResource@@@std@@@std@@QEAA@AEBV01@@Z @ 0x1800C94FC (--0-$vector@PEAVCResource@@V-$allocator@PEAVCResource@@@std@@@std@@QEAA@AEBV01@@Z.c)
 *     ?_Tidy@?$vector@PEAVCResource@@V?$allocator@PEAVCResource@@@std@@@std@@AEAAXXZ @ 0x1800CEEA0 (-_Tidy@-$vector@PEAVCResource@@V-$allocator@PEAVCResource@@@std@@@std@@AEAAXXZ.c)
...
void __fastcall CWeakResourceReference::OnResourceDestroyed(CWeakResourceReference *this)
{
  ...
  for ( i = v10; i != v11; i = (_QWORD *)*i )
    ;
  if ( v10 == *(_QWORD **)qword_180349418 && v11 == (_QWORD *)qword_180349418 )
  {
