/*
 * XREFs of ?DrawInk@CDrawingContext@@UEAAJPEAUID2D1Ink@@AEBU_D3DCOLORVALUE@@PEAUID2D1InkStyle@@@Z @ 0x1801772F0
 * Callers:
 ...
 *     ??$Is2DTransformExceptForZTranslation@$00@CMILMatrix@@AEBA_NXZ @ 0x18020FFC0 (--$Is2DTransformExceptForZTranslation@$00@CMILMatrix@@AEBA_NXZ.c)
        ...
        struct ID2D1InkStyle *a4)
{
  ...
  if ( CDrawingContext::IsIn3DMode((CDrawingContext *)((char *)this + 8)) )
  {
    ...
    {
      v18 = -2147467263;
      MilInstrumentationCheckHR_MaybeFailFast((__int64)v10, 0LL, 0, -2147467263, 0x2C4u, 0LL);
      return v18;
    }
    v11 = v10[3];
    v31 = 0;
  ...
  if ( v19 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x2C8u, 0LL);
  }
  else
  {
    v21 = *((_DWORD *)this + 804);
    *(struct _D3DCOLORVALUE *)&v33.r = *(struct _D3DCOLORVALUE *)&a3->r;
    ...
    v18 = v26;
    if ( v26 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v26, 0x2D3u, 0LL);
  }
  if ( v8 )
