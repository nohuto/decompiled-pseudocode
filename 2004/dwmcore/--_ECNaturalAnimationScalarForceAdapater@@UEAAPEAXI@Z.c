/*
 * XREFs of ??_ECNaturalAnimationScalarForceAdapater@@UEAAPEAXI@Z @ 0x1802152A0
 * Callers:
 *     ??_ECNaturalAnimationScalarForceAdapater@@W7EAAPEAXI@Z @ 0x1800F1270 (--_ECNaturalAnimationScalarForceAdapater@@W7EAAPEAXI@Z.c)
 * Callees:
