/*
 * XREFs of ?RenderEffect@CTreeEffectLayer@@IEAAJPEAVCDrawingContext@@AEBVCMILMatrix@@AEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBUD2D_SIZE_F@@@Z @ 0x180007044
 * Callers:
...
LABEL_12:
  ...
  v21 = (*(__int64 (__fastcall **)(_QWORD *))(*v20 + 240LL))(v20);
  if ( !v21 )
    goto LABEL_12;
