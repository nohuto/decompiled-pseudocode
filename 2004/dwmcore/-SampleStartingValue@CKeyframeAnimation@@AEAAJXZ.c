/*
 * XREFs of ?SampleStartingValue@CKeyframeAnimation@@AEAAJXZ @ 0x18008C678
 * Callers:
 ...
 *     ?ResolveTargetNoRef@CBaseExpression@@IEAAPEAVCResource@@XZ @ 0x18008C794 (-ResolveTargetNoRef@CBaseExpression@@IEAAPEAVCResource@@XZ.c)
...
LABEL_10:
    ...
    v6 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, -2147024809, 0x7E3u, 0LL);
    goto LABEL_11;
  }
  v18 = 1961;
LABEL_35:
