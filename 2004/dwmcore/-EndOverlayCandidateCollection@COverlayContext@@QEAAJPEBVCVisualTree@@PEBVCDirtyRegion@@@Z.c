/*
 * XREFs of ?EndOverlayCandidateCollection@COverlayContext@@QEAAJPEBVCVisualTree@@PEBVCDirtyRegion@@@Z @ 0x18007BF90
 * Callers:
 ...
 *     ?IsCompatibleOutputScaling@COverlayContext@@AEAA_NAEBVCMILMatrix@@@Z @ 0x18007E254 (-IsCompatibleOutputScaling@COverlayContext@@AEAA_NAEBVCMILMatrix@@@Z.c)
 ...
 *     ??0OverlayPlaneInfo@COverlayContext@@QEAA@AEBV01@@Z @ 0x18017B630 (--0OverlayPlaneInfo@COverlayContext@@QEAA@AEBV01@@Z.c)
 ...
 *     ?CopyTransientProperties@OverlayPlaneInfo@COverlayContext@@QEAAXAEBV12@@Z @ 0x18017CF88 (-CopyTransientProperties@OverlayPlaneInfo@COverlayContext@@QEAAXAEBV12@@Z.c)
 *     ?FindOverlayCandidateIndex@COverlayContext@@AEBAHPEBVCVisual@@PEBVCCompositionSurfaceInfo@@_K@Z @ 0x18017D94C (-FindOverlayCandidateIndex@COverlayContext@@AEBAHPEBVCVisual@@PEBVCCompositionSurfaceInfo@@_K@Z.c)
  ...
  if ( *((_BYTE *)this + 11421) && v6 )
  {
    ...
    if ( (unsigned int)((*((_QWORD *)this + 13) - v10) / 224) )
    {
      ...
      do
      {
        ...
        IsOccluded = COcclusionContext::IsOccluded(v6, &v43, 0LL, v16);
...
LABEL_55:
    ...
    *((_BYTE *)this + 11425) = COverlayContext::IsCompatibleOutputScaling(this, v35);
  }
