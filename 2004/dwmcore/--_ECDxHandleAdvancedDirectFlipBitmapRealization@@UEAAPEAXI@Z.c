/*
 * XREFs of ??_ECDxHandleAdvancedDirectFlipBitmapRealization@@UEAAPEAXI@Z @ 0x180261A50
 * Callers:
 *     ??_ECDxHandleAdvancedDirectFlipBitmapRealization@@WBCA@EAAPEAXI@Z @ 0x1800F32F0 (--_ECDxHandleAdvancedDirectFlipBitmapRealization@@WBCA@EAAPEAXI@Z.c)
 * Callees:
