/*
 * XREFs of ?CalculateCasterBounds@CProjectedShadowCaster@@QEBA?AV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEBVCVisualTree@@PEA_N@Z @ 0x1800055D0
 * Callers:
  ...
  *(float *)(a2 + 8) = v9 + 0.0;
  ...
  while ( v15 )
  {
    ...
    if ( !*(_QWORD *)(a1 + 64) || CVisual::GetTransformParentNoRef(v15) )
      break;
    v26 = 0;
    CVisual::CalcCpuClippingTransform(v15, 5LL, a3, 0LL, v22, v25, 0LL);
    if ( v22[0] )
    {
