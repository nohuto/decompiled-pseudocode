/*
 * XREFs of ??0CWARPDrawListEntry@@AEAA@AEBUWARPDrawListEntryParams@@@Z @ 0x1801A2DF0
 * Callers:
 ...
 *     ??0CDrawListEntry@@IEAA@AEBUDrawListEntryParams@@@Z @ 0x1801A5034 (--0CDrawListEntry@@IEAA@AEBUDrawListEntryParams@@@Z.c)
 */
