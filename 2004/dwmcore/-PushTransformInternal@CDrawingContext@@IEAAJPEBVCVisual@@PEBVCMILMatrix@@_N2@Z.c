/*
 * XREFs of ?PushTransformInternal@CDrawingContext@@IEAAJPEBVCVisual@@PEBVCMILMatrix@@_N2@Z @ 0x1800828C0
 * Callers:
 ...
 *     ?Top@?$CWatermarkStack@VCMILMatrix@@$07$01$07@@QEBAJPEAVCMILMatrix@@I@Z @ 0x180080098 (-Top@-$CWatermarkStack@VCMILMatrix@@$07$01$07@@QEBAJPEAVCMILMatrix@@I@Z.c)
...
LABEL_3:
      ...
      *(_OWORD *)(*((_QWORD *)this + 49) + 16LL * v10) = v53;
      v13 = *((_DWORD *)this + 100);
      v14 = (unsigned int)++*((_DWORD *)this + 94);
...
LABEL_51:
    MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v12, 0xC29u, 0LL);
    goto LABEL_24;
  }
LABEL_8:
...
LABEL_14:
  ...
  v55 = 0;
  v57 = 0;
  v29 = CWatermarkStack<CMILMatrix,8,2,8>::Top((__int64)this + 408, (__int64)v54);
  v15 = v29;
  if ( v29 < 0 )
  {
...
LABEL_15:
  if ( v15 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v15, 0xC32u, 0LL);
    goto LABEL_24;
  }
  if ( *v16 )
  ...
  v23 = (unsigned __int8)CMILMatrix::Is2DAffine<0>((__int64)v22) == 0;
...
LABEL_19:
    ...
    *(_BYTE *)(v25 + *((_QWORD *)this + 57)) = v23;
    v26 = *((_DWORD *)this + 116);
    v27 = (unsigned int)++*((_DWORD *)this + 110);
...
LABEL_22:
  ...
  {
LABEL_63:
    MilInstrumentationCheckHR_MaybeFailFast(v27, 0LL, 0, v9, 0xC35u, 0LL);
    goto LABEL_24;
  }
  *((_BYTE *)this + 5953) = 1;
LABEL_24:
