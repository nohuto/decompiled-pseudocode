/*
 * XREFs of ?EnsureEffectiveSpriteClip@CWindowNode@@AEAAJXZ @ 0x180061F30
 * Callers:
...
__int64 __fastcall CWindowNode::EnsureEffectiveSpriteClip(CWindowNode *this)
{
  ...
  _QWORD *v21; // [rsp+40h] [rbp-51h] BYREF
  ...
  if ( !*((_QWORD *)this + 113) )
  {
    ...
    if ( *((_QWORD *)this + 97) )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v5, 0LL, 0, WindowClipShape, 0x7D8u, 0LL);
LABEL_8:
    ...
    else
    {
      ...
      if ( v7 >= 0 )
        v9 = v7;
      v25 = v9;
      CRegionShape::BuildFromRects((__int64)v26, (__int64)&v23, 1);
      CShapePtr::Release((CShapePtr *)&v21);
      v22 = 0;
      v21 = v26;
    }
    v10 = CShapePtr::CopyShape((CShapePtr *)&v21, 0LL, &v20);
    v12 = v20;
    v2 = v10;
    if ( v10 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v11, 0LL, 0, v10, 0x7E8u, 0LL);
    }
    else
    {
      if ( !*((_BYTE *)this + 913) )
...
LABEL_21:
      ...
      if ( v14 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, v14, 0x7F1u, 0LL);
      }
      else
      {
        ...
        MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x7F6u, 0LL);
      }
      CShapePtr::~CShapePtr((CShapePtr *)&v23);
    }
    CRegionShape::~CRegionShape((CRegionShape *)v26);
