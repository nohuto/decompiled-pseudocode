...
__int64 __fastcall std::_Tree_val<std::_Tree_simple_types<std::wstring>>::_Erase_tree<std::allocator<std::_Tree_node<std::wstring,void *>>>(
        __int64 a1,
        __int64 a2,
        __int64 *a3)
{
  ...
  for ( i = a3; !*((_BYTE *)i + 25); result = std::_Deallocate<16,0>(v6, 64LL) )
  {
