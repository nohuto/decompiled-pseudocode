/*
 * XREFs of ?RenderShadow@CTreeEffectLayer@@IEAAJAEBUD2D_POINT_2F@@AEBUD2D_SIZE_F@@MMPEAVCDrawingContext@@PEAVCDropShadow@@PEAVIRenderTargetBitmap@@@Z @ 0x180191DD8
 * Callers:
    ...
    else
    {
      ...
      *(_QWORD *)&v75.x = *((_QWORD *)a7 + 13);
      ...
      if ( *((_DWORD *)g_pComposition + 240) )
      {
        ...
        v22 = CDrawingContext::FillRectanglesWithSolidColor(a6, v64, TopByReference + 4);
        v21 = v22;
        if ( v22 >= 0 )
          goto LABEL_49;
        v61 = 996;
