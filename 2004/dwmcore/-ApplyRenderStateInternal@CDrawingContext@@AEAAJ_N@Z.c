/*
 * XREFs of ?ApplyRenderStateInternal@CDrawingContext@@AEAAJ_N@Z @ 0x18006BEB0
 * Callers:
 ...
 *     ?ApplyRenderState@CDrawingContext@@UEAAJXZ @ 0x1800216B0 (-ApplyRenderState@CDrawingContext@@UEAAJXZ.c)
...
__int64 __fastcall CDrawingContext::ApplyRenderStateInternal(CDrawingContext *this, char a2)
{
  ...
  if ( !v2 )
  {
    ...
    if ( *((_DWORD *)this + 140) )
    {
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v54, 0LL, 0, v53, 0xFC7u, 0LL);
    }
    else
    {
LABEL_50:
    ...
    if ( (v3 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v44, 0LL, 0, v3, 0xFB2u, 0LL);
    }
    ...
    if ( (v3 & 0x80000000) != 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v44, 0LL, 0, v3, 0x1B4u, 0LL);
      return v3;
    }
  }
  if ( *((_BYTE *)this + 5953) )
