/*
 * XREFs of ?CopyPixels@CBitmap@@UEAAJPEBUWICRect@@IIPEAE@Z @ 0x180091980
 * Callers:
 *     ?CopyPixels@CBitmap@@WCA@EAAJPEBUWICRect@@IIPEAE@Z @ 0x1800F01F0 (-CopyPixels@CBitmap@@WCA@EAAJPEBUWICRect@@IIPEAE@Z.c)
 * Callees:
        ...
        unsigned __int8 *a5)
{
  ...
  if ( !a2 )
  {
    ...
    if ( v14 > 0x7FFFFFFF )
    {
      v24 = -1;
      v12 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(0x7FFFFFFFLL, 0LL, 0, -2147024362, 0xB3u, 0LL);
      goto LABEL_10;
    }
    v24 = v14;
    if ( *((_DWORD *)this + 41) > 0x7FFFFFFFu )
    {
      v25 = -1;
      v12 = -2147024362;
      MilInstrumentationCheckHR_MaybeFailFast(0x7FFFFFFFLL, 0LL, 0, -2147024362, 0xB4u, 0LL);
      goto LABEL_10;
    }
    v25 = *((_DWORD *)this + 41);
