/*
 * XREFs of ?TransformInput@CInteractionContextTransformHelper@@QEAAJAEBUtagPOINTER_INFO@@_NPEAU2@@Z @ 0x180269748
 * Callers:
 ...
 *     s_TransformPointByMatrix @ 0x18026A110 (s_TransformPointByMatrix.c)
 */
