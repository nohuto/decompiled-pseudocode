/*
 * XREFs of ?CreateLinkedShader@CCompiledEffectCache@@QEAAJIAEBUShaderLinkingConfig@@AEBUShaderLinkingBody@@V?$span@PEBUShaderLinkingBody@@$0?0@gsl@@PEAPEAVCLinkedShader@@@Z @ 0x1800B3DB4
 * Callers:
 ...
 *     ??0CLinkedShader@@QEAA@PEAUID3D10Blob@@I@Z @ 0x1800B3D14 (--0CLinkedShader@@QEAA@PEAUID3D10Blob@@I@Z.c)
  ...
  *(_OWORD *)v34 = *a5;
  ...
  else
  {
    ...
    *(_OWORD *)v35 = *(_OWORD *)v35[0];
    ...
    if ( LinkedShader >= 0 )
    {
      Microsoft::WRL::ComPtr<CLinkedShader>::operator=(&v32, (volatile signed __int32 *)v34[0]);
      v6 = v32;
LABEL_6:
