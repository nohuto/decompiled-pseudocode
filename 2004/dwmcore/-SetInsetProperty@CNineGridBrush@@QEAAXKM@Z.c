/*
 * XREFs of ?SetInsetProperty@CNineGridBrush@@QEAAXKM@Z @ 0x1800C7E3C
 * Callers:
 ...
 *     ?TryGetInsetFieldPointer@CNineGridBrush@@AEAAPEAMK@Z @ 0x1800C7E8C (-TryGetInsetFieldPointer@CNineGridBrush@@AEAAPEAMK@Z.c)
 */
