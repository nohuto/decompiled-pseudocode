/*
 * XREFs of ??_ECLegacyStereoSwapChain@@UEAAPEAXI@Z @ 0x18024BC60
 * Callers:
 *     ??_ECLegacyStereoSwapChain@@WBA@EAAPEAXI@Z @ 0x1800F1E70 (--_ECLegacyStereoSwapChain@@WBA@EAAPEAXI@Z.c)
 * Callees:
