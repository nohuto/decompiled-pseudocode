/*
 * XREFs of ?CalcFrustumOutline@@YAXVCMILMatrix@@PEAULine3D@@111@Z @ 0x1801F52BC
 * Callers:
 ...
 *     log10f_0 @ 0x1800EECC7 (log10f_0.c)
 *     sqrtf_0 @ 0x1800EECEB (sqrtf_0.c)
 *     ??0Line3D@@QEAA@UMilPoint4F@@0@Z @ 0x1801F51E8 (--0Line3D@@QEAA@UMilPoint4F@@0@Z.c)
 */
