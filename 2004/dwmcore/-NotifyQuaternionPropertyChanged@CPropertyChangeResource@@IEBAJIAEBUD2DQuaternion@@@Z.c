/*
 * XREFs of ?NotifyQuaternionPropertyChanged@CPropertyChangeResource@@IEBAJIAEBUD2DQuaternion@@@Z @ 0x1801B339C
 * Callers:
        ...
        const struct D2DQuaternion *a3)
{
  ...
  if ( CPropertyChangeResource::ShouldNotify(this) )
  {
    ...
    v13[0] = v10;
    v13[1] = v6;
    v3 = CoreUICallSend(v9, v13, 2LL, 13LL, 6, &unk_1802CCE67);
    if ( v3 == -2018375675 )
      v3 = 0;
    if ( v3 < 0 )
