/*
 * XREFs of InterpolateInLinearGamma__lambda_d9ec8cec7b93f46268f106f2fd316fdd___ @ 0x180205868
 * Callers:
 ...
 *     ?Convert_D2D1_COLOR_F_scRGB_To_D2D1_COLOR_F_sRGB@@YA?AU_D3DCOLORVALUE@@AEBU1@@Z @ 0x18021E0A8 (-Convert_D2D1_COLOR_F_scRGB_To_D2D1_COLOR_F_sRGB@@YA-AU_D3DCOLORVALUE@@AEBU1@@Z.c)
 */
        ...
        __int64 a4)
{
  ...
  KeyframeInterpolation::ExpressionValueLerp(v10, v11, (__int64)v20, (__int64)v16, (__int64)a3);
