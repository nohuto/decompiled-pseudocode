/*
 * XREFs of _anonymous_namespace_::FrameSequenceInfo::operator_ @ 0x180028C18
 * Callers:
 *     _anonymous_namespace_::SealCurrentFrameSequence @ 0x180028710 (_anonymous_namespace_--SealCurrentFrameSequence.c)
 * Callees:
 *     std::_Tree_std::_Tmap_traits__anonymous_namespace_::AnimationId_unsigned_int_A0xd209ef2d::AnimationId::LessThan_std::allocator_std::pair__anonymous_namespace_::AnimationId_const__unsigned_int____0___::_Move_assign @ 0x180028BA8 (std--_Tree_std--_Tmap_traits__anonymous_namespace_--AnimationId_unsigned_int_A0xd209ef2d--Animat.c)
 *     ?_Move_assign@?$_Tree@V?$_Tset_traits@_KU?$less@_K@std@@V?$allocator@_K@2@$0A@@std@@@std@@AEAAXAEAV12@U_Equal_allocators@2@@Z @ 0x180029030 (-_Move_assign@-$_Tree@V-$_Tset_traits@_KU-$less@_K@std@@V-$allocator@_K@2@$0A@@std@@@std@@AEAAXA.c)
 */
