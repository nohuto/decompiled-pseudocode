/*
 * XREFs of ?EnsureMipmapSurface@CCompositionMipmapSurface@@AEAAJXZ @ 0x1801BB92C
 * Callers:
      ...
      *(_QWORD *)&v15 = "DWM Composition Mipmap Surface";
      ...
      else
      {
        ...
        *(_QWORD *)&v15 = this + 9;
        ...
        if ( (_QWORD *)v11[2] == v12 )
        {
          std::vector<ShaderLinkingBody const *>::_Emplace_reallocate<ShaderLinkingBody const *>(v11, v12, &v15);
        }
        else
        {
          *v12 = this + 9;
