/*
 * XREFs of ?SetParticleGenerator@?$CParticleEmitterVisualGeneratedT@VCParticleEmitterVisual@@VCVisual@@@@QEAAJPEAVCParticleGenerator@@@Z @ 0x180173A58
 * Callers:
        ...
        struct CResource *a2)
{
  ...
  if ( a2 != this[93] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, v5, 0x1DB1u, 0LL);
    }
    else
    {
      CResource::UnRegisterNotifierInternal((CResource *)this, this[93]);
      v7 = *this;
      this[93] = a2;
