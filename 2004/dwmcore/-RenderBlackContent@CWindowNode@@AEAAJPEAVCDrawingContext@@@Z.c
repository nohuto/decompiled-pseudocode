/*
 * XREFs of ?RenderBlackContent@CWindowNode@@AEAAJPEAVCDrawingContext@@@Z @ 0x1801F4E14
 * Callers:
...
__int64 __fastcall CWindowNode::RenderBlackContent(CWindowNode *this, struct CDrawingContext *a2)
{
  ...
  if ( *((_QWORD *)this + 97) )
  {
    ...
    {
      MilInstrumentationCheckHR_MaybeFailFast(v6, 0LL, 0, WindowClipShape, 0x761u, 0LL);
      goto LABEL_11;
    }
    v4 = v11;
  }
  ...
  v8 = CDrawingContext::FillShapeWithSolidColor(a2, v4, (const __m128i *)&stru_1802EE660);
  v7 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v8, 0x749u, 0LL);
  else
    *((_BYTE *)a2 + 5951) = 1;
  if ( v7 < 0 )
    MilInstrumentationCheckHR_MaybeFailFast(v9, 0LL, 0, v7, 0x764u, 0LL);
LABEL_11:
  CRectanglesShape::~CRectanglesShape((CRectanglesShape *)v13);
  CShapePtr::Release((CShapePtr *)&v11);
