/*
 * XREFs of ?ToggleSuspension@CHolographicManager@@UEAAX_N@Z @ 0x1800D6E70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z @ 0x180251764 (-DwmHolographicSuspendRequest_@CompositorTracing@@QEAAX_N@Z.c)
