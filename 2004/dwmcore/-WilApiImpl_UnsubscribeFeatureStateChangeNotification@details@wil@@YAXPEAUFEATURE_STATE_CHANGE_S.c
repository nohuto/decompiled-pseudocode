/*
 * XREFs of ?WilApiImpl_UnsubscribeFeatureStateChangeNotification@details@wil@@YAXPEAUFEATURE_STATE_CHANGE_SUBSCRIPTION__@@@Z @ 0x1800E1C00
 * Callers:
 *     <none>
 * Callees:
        ...
        struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *a2)
{
  ...
  if ( (this & 0x80000000) != 0 )
  {
    ...
    v3 = (struct _RTL_CRITICAL_SECTION *)&unk_180345590;
    goto LABEL_4;
  }
  if ( wil::details::g_featureStateManager )
  {
    v2 = (struct FEATURE_STATE_CHANGE_SUBSCRIPTION__ *)this;
    v3 = (struct _RTL_CRITICAL_SECTION *)&unk_180345548;
LABEL_4:
    wil::details_abi::SubscriptionList::Unsubscribe(v3, &stru_180345500, v2);
  }
}
