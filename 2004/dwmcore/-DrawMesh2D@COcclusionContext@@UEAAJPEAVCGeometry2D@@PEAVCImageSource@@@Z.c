/*
 * XREFs of ?DrawMesh2D@COcclusionContext@@UEAAJPEAVCGeometry2D@@PEAVCImageSource@@@Z @ 0x180184D30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CImageSource *a3)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(struct CImageSource *, __int64))(*(_QWORD *)a3 + 56LL))(a3, 15LL) )
  {
    v5 = *((_QWORD *)this + 1);
    v7[0] = *((_QWORD *)this + 154);
