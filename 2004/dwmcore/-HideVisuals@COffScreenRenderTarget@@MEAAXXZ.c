/*
 * XREFs of ?HideVisuals@COffScreenRenderTarget@@MEAAXXZ @ 0x180186E90
 * Callers:
 *     ?HideVisuals@CMagnifierRenderTarget@@MEAAXXZ @ 0x18018C880 (-HideVisuals@CMagnifierRenderTarget@@MEAAXXZ.c)
 * Callees:
