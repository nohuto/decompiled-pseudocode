/*
 * XREFs of ??$_Destroy_range@V?$allocator@USuperWetStroke@CSuperWetInkManager@@@std@@@std@@YAXPEAUSuperWetStroke@CSuperWetInkManager@@0AEAV?$allocator@USuperWetStroke@CSuperWetInkManager@@@0@@Z @ 0x18015615C
 * Callers:
 *     ??_GCSuperWetInkManager@@QEAAPEAXI@Z @ 0x180156D3C (--_GCSuperWetInkManager@@QEAAPEAXI@Z.c)
 *     ??$_Uninitialized_move@PEAUSuperWetStroke@CSuperWetInkManager@@PEAU12@V?$allocator@USuperWetStroke@CSuperWetInkManager@@@std@@@std@@YAPEAUSuperWetStroke@CSuperWetInkManager@@QEAU12@0PEAU12@AEAV?$allocator@USuperWetStroke@CSuperWetInkManager@@@0@@Z @ 0x180195F60 (--$_Uninitialized_move@PEAUSuperWetStroke@CSuperWetInkManager@@PEAU12@V-$allocator@USuperWetStro.c)
 *     ?_Change_array@?$vector@USuperWetStroke@CSuperWetInkManager@@V?$allocator@USuperWetStroke@CSuperWetInkManager@@@std@@@std@@AEAAXQEAUSuperWetStroke@CSuperWetInkManager@@_K1@Z @ 0x1801975A8 (-_Change_array@-$vector@USuperWetStroke@CSuperWetInkManager@@V-$allocator@USuperWetStroke@CSuper.c)
 * Callees:
