/*
 * XREFs of ?GetTextureMemoryLayoutData@CNineGridBrush@@UEBAJAEBUD2D_SIZE_F@@AEAV?$vector@ULayoutData@CContent@@V?$allocator@ULayoutData@CContent@@@std@@@std@@@Z @ 0x1801DBDC0
 * Callers:
 *     <none>
 * Callees:
