/*
 * XREFs of ?HrCheckBufferSize@@YAJW4DXGI_FORMAT@@IPEBUWICRect@@I@Z @ 0x180091B70
 * Callers:
...
__int64 __fastcall HrCheckBufferSize(__int64 a1, __int64 a2, const struct WICRect *a3, unsigned int a4)
{
