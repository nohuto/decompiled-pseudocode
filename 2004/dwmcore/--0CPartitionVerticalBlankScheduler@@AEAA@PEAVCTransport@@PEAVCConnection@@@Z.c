/*
 * XREFs of ??0CPartitionVerticalBlankScheduler@@AEAA@PEAVCTransport@@PEAVCConnection@@@Z @ 0x180027244
 * Callers:
 *     ?RunCompositionThread@CConnection@@AEAAJXZ @ 0x1800268FC (-RunCompositionThread@CConnection@@AEAAJXZ.c)
 * Callees:
 *     ??0CTelemetryTouchLatencyAnalysis@@QEAA@XZ @ 0x1800273F8 (--0CTelemetryTouchLatencyAnalysis@@QEAA@XZ.c)
