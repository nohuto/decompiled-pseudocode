...
__int64 __fastcall CVisual::SetDirtyRegionVisualizationData(__int64 a1, __int64 a2)
{
  ...
  if ( a2 )
  {
    ...
    {
      result = (__int64)CSparseAlignedStorage<8,8>::AllocatedStorage::ReserveSlot((_QWORD *)(a1 + 224), 13);
      *(_QWORD *)result = a2;
    }
  }
  ...
  {
    *v3 &= ~0x80000u;
    result = CSparseAlignedStorage<8,8>::AllocatedStorage::FindSlot((__int64)v3, 13);
