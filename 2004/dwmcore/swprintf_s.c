/*
 * XREFs of swprintf_s @ 0x1800E3B30
 * Callers:
 *     _anonymous_namespace_::SynthesizeDescription @ 0x18001D4EC (_anonymous_namespace_--SynthesizeDescription.c)
 *     ?DisplayNumber@CDisplayDebugFrameCounter@@IEAAJIU_D3DCOLORVALUE@@PEAUD2D_RECT_F@@PEAVCDrawingContext@@@Z @ 0x180163B74 (-DisplayNumber@CDisplayDebugFrameCounter@@IEAAJIU_D3DCOLORVALUE@@PEAUD2D_RECT_F@@PEAVCDrawingCon.c)
 * Callees:
 *     __local_stdio_printf_options @ 0x1800E25FC (__local_stdio_printf_options.c)
 *     __stdio_common_vswprintf_s @ 0x1800E397E (__stdio_common_vswprintf_s.c)
 */
