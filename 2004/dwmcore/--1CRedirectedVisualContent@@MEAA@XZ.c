/*
 * XREFs of ??1CRedirectedVisualContent@@MEAA@XZ @ 0x180034D90
 * Callers:
...
void __fastcall CRedirectedVisualContent::~CRedirectedVisualContent(CRedirectedVisualContent *this)
{
  ...
  *((_QWORD *)this + 8) = 0LL;
  ...
  wil::com_ptr_t<CD2DBitmap,wil::err_returncode_policy>::~com_ptr_t<CD2DBitmap,wil::err_returncode_policy>((char *)this + 72);
  v4 = *((_QWORD *)this + 8);
  if ( v4 )
