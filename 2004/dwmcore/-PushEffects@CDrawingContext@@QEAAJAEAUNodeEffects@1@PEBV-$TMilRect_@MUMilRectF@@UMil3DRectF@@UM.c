/*
 * XREFs of ?PushEffects@CDrawingContext@@QEAAJAEAUNodeEffects@1@PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCFilterEffect@@11PEA_N@Z @ 0x18006AEC0
 * Callers:
  ...
  *a7 = 0;
    ...
    && COERCE_FLOAT(COERCE_UNSIGNED_INT(*((float *)a2 + 5) - 1.0) & _xmm) < 0.0000011920929 )
  {
    *((_QWORD *)&v52 + 1) = *a2;
    ...
    v7 = v13;
    if ( v13 < 0 )
      MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0xC7Eu, 0LL);
    return v7;
  }
  v50 = 0LL;
  v15 = 0LL;
  ...
  if ( v12 )
  {
    ...
    *(_QWORD *)&v52 = 0LL;
    ...
    if ( ShapeData < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, ShapeData, 0x881u, 0LL);
    }
    else
    {
      v20 = v52;
...
LABEL_24:
        ...
        if ( (v7 & 0x80000000) != 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast((__int64)v23, 0LL, 0, v7, 0xC87u, 0LL);
      ...
      MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, v19, 0x882u, 0LL);
    }
...
LABEL_32:
  ...
  if ( v28 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, v28, 0xC9Eu, 0LL);
    goto LABEL_78;
  }
  if ( !*a7 )
  {
    ...
    if ( *((_BYTE *)a2 + 166) )
    {
      ...
      if ( v34 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v35, 0LL, 0, v34, 0xCBCu, 0LL);
        goto LABEL_78;
      }
      v30 = 1;
      *a7 |= v49;
    ...
    if ( *((_BYTE *)a2 + 167) )
    {
      ...
      if ( v37 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v38, 0LL, 0, v37, 0xCCFu, 0LL);
        goto LABEL_78;
      }
      v30 = 1;
      *a7 |= v49;
    ...
    if ( *((_DWORD *)a2 + 4) )
    {
      ...
      if ( v39 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v40, 0LL, 0, v39, 0xCD8u, 0LL);
        goto LABEL_78;
      }
      v55[0] = _xmm;
      v55[1] = _xmm;
        ...
        || (*(float *)&v54 <= 1.0 ? (v42 = 1.0 - *(float *)&v54) : (v42 = *(float *)&v54 - 1.0), v42 > 0.0000099999997) )
      {
        ...
        if ( v43 < 0 )
        {
          MilInstrumentationCheckHR_MaybeFailFast(v44, 0LL, 0, v43, 0xCE8u, 0LL);
          goto LABEL_78;
        }
        v30 = 1;
      }
    ...
    if ( updated >= 0 )
      goto LABEL_42;
    MilInstrumentationCheckHR_MaybeFailFast(v47, 0LL, 0, updated, 0xD01u, 0LL);
LABEL_78:
    CShapePtr::Release((CShapePtr *)&v50);
    return v7;
  }
