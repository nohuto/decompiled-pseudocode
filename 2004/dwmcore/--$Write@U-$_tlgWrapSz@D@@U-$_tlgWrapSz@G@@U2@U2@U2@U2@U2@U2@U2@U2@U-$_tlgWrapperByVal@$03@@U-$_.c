        ...
        __int64 a28)
{
  ...
  int v65; // ecx
  struct _EVENT_DATA_DESCRIPTOR v67; // [rsp+30h] [rbp-D0h] BYREF
  const unsigned __int16 *v68; // [rsp+50h] [rbp-B0h]
  int v69; // [rsp+58h] [rbp-A8h]
  int v70; // [rsp+5Ch] [rbp-A4h]
  wchar_t *v71; // [rsp+60h] [rbp-A0h]
  ...
  const unsigned __int16 *v110; // [rsp+150h] [rbp+50h]
  int v111; // [rsp+158h] [rbp+58h]
  int v112; // [rsp+15Ch] [rbp+5Ch]
  const unsigned __int16 *v113; // [rsp+160h] [rbp+60h]
  int v114; // [rsp+168h] [rbp+68h]
  int v115; // [rsp+16Ch] [rbp+6Ch]
  __int64 v116; // [rsp+170h] [rbp+70h]
  __int64 v117; // [rsp+178h] [rbp+78h]
  ...
  v69 = v65;
  v70 = 0;
  return tlgWriteTransfer_EventWriteTransfer(a1, a2, 0LL, 0LL, 0x1Au, &v67);
}
