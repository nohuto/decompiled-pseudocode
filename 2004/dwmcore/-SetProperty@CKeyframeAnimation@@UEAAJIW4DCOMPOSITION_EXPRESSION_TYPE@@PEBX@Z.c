/*
 * XREFs of ?SetProperty@CKeyframeAnimation@@UEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1800C00B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetProgress@CKeyframeAnimation@@AEAAXM@Z @ 0x1800D1C64 (-SetProgress@CKeyframeAnimation@@AEAAXM@Z.c)
 *     ?SetPlaybackRate@CKeyframeAnimation@@AEAAXM@Z @ 0x1800D3D78 (-SetPlaybackRate@CKeyframeAnimation@@AEAAXM@Z.c)
...
LABEL_32:
  ...
  if ( a2 != 16 )
  {
    ...
    if ( *(int *)(*(_QWORD *)(a1 + 304) + 4LL) >= 0
      ...
      || (qword_180342F00 & 4) == 0
      || (qword_180342F08 & 4) != qword_180342F08 )
    {
      return 0;
    }
