/*
 * XREFs of ?Create@?$CWeakReference@VCVisual@@@@SAJPEAVCVisual@@PEAPEAV1@@Z @ 0x18009C3A8
 * Callers:
 ...
 *     ?Initialize@CExcludeVisualReference@@IEAAJPEAVCVisual@@@Z @ 0x1800DC178 (-Initialize@CExcludeVisualReference@@IEAAJPEAVCVisual@@@Z.c)
