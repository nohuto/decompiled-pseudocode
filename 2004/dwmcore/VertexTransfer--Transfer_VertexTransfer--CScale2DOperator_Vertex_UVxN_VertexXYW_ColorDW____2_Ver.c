/*
 * XREFs of VertexTransfer::Transfer_VertexTransfer::CScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___ @ 0x1801AA0C8
 * Callers:
...
_UNKNOWN **VertexTransfer::Transfer_VertexTransfer::CScale2DOperator_Vertex_UVxN_VertexXYW_ColorDW____2_Vertex_UVxN_VertexXYW_ColorDW___(
        __int64 a1,
        float *a2,
        __int64 a3,
        ...)
{
  ...
  for ( i = *(float *)(a1 + 44); v5 < v4; *(_DWORD *)(v10 + 12) = (_DWORD)result )
  {
    ...
    *(_DWORD *)(v10 + 8) = 1065353216;
    result = (_UNKNOWN **)BlendStraightColorDW(*(_DWORD *)(v9 + 12), i);
    ++v5;
  }
  return result;
}
