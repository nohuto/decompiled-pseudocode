/*
 * XREFs of ?CreateSectionBitmap@CGdiSpriteBitmap@@AEAAJPEAXII@Z @ 0x1800CDF8C
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::CreateSectionBitmap(CGdiSpriteBitmap *this, void *a2, UINT32 a3, UINT32 a4)
{
  ...
  if ( v10 <= 0xFFFFFFFF )
  {
    ...
    v29.width = a3;
    v29.height = a4;
    wil::com_ptr_t<IGDIBitmapRealization,wil::err_returncode_policy>::reset((__int64 *)v28);
    ...
    {
      wil::com_ptr_t<IGDIBitmapRealization,wil::err_returncode_policy>::reset((__int64 *)this + 60);
