/*
 * XREFs of ?RedirectVisualSetRedirectedVisual@CChannel@@UEAAJII@Z @ 0x1800D8EF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CChannel::RedirectVisualSetRedirectedVisual(CChannel *this, unsigned int a2, int a3)
{
  unsigned int v6; // ebx
  ...
  CChannel::CheckHandle((__int64)this, a2, 141);
