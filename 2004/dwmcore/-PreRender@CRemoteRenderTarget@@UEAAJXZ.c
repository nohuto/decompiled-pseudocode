/*
 * XREFs of ?PreRender@CRemoteRenderTarget@@UEAAJXZ @ 0x1800E10A4
 * Callers:
 *     ?PreRender@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EF760 (-PreRender@CRemoteRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 * Callees:
