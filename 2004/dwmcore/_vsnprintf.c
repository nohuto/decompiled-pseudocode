/*
 * XREFs of _vsnprintf @ 0x1800E3B88
 * Callers:
 *     ?StringCchPrintfA@@YAJPEAD_KPEBDZZ @ 0x1801FA714 (-StringCchPrintfA@@YAJPEAD_KPEBDZZ.c)
 * Callees:
 *     __local_stdio_printf_options @ 0x1800E25FC (__local_stdio_printf_options.c)
 *     _o___stdio_common_vsprintf_0 @ 0x1800E395A (_o___stdio_common_vsprintf_0.c)
 */
