/*
 * XREFs of ??$AddLinkInternal@VIGDIBitmapRealization@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVIGDIBitmapRealization@@_N@Z @ 0x1801C2C5C
 * Callers:
 *     ?DebugDump@CGdiSpriteBitmap@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x1801C33B0 (-DebugDump@CGdiSpriteBitmap@@UEAAXPEAVCVisualTreeDumpContext@@@Z.c)
 * Callees:
...
__int64 __fastcall CVisualTreeDumpContext::AddLinkInternal<IGDIBitmapRealization>(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( a3 )
    return CDebugTreeDumper::RegisterNodeForVisit<IGDIBitmapRealization>(a1[14], a3);
  return result;
}
