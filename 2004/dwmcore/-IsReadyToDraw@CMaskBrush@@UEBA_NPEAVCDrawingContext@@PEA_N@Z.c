/*
 * XREFs of ?IsReadyToDraw@CMaskBrush@@UEBA_NPEAVCDrawingContext@@PEA_N@Z @ 0x1800AD8A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMaskBrush::IsReadyToDraw(CMaskBrush *this, struct CDrawingContext *a2, bool *a3)
{
         ...
         &v10) )
  {
    v8 = *((_QWORD *)this + 10);
    if ( !v8
      || (*(unsigned __int8 (__fastcall **)(__int64, struct CDrawingContext *, char *))(*(_QWORD *)v8 + 288LL))(
           v8,
           a2,
           &v11) )
    {
