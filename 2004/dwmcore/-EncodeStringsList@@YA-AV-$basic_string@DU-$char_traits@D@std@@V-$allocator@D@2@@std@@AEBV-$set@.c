 ...
 * Callees:
 *     ??$_Emplace_reallocate@AEBE@?$vector@EV?$allocator@E@std@@@std@@QEAAPEAEQEAEAEBE@Z @ 0x180084B68 (--$_Emplace_reallocate@AEBE@-$vector@EV-$allocator@E@std@@@std@@QEAAPEAEQEAEAEBE@Z.c)
...
_OWORD *__fastcall EncodeStringsList(_OWORD *a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(a2 + 8) )
  {
    ...
    while ( (__int64 *)v6 != v3 )
    {
      ...
      if ( v5 == v4 )
      {
        std::vector<unsigned char>::_Emplace_reallocate<unsigned char const &>((__int64 *)&v26, v4, v25);
        v5 = v27;
        v10 = (char *)*((_QWORD *)&v26 + 1);
      }
      else
      {
        *v4 = v7;
      ...
      if ( v5 == v10 )
      {
        std::vector<unsigned char>::_Emplace_reallocate<unsigned char const &>((__int64 *)&v26, v10, v25);
        v5 = v27;
      ...
      while ( v13 != v14 )
      {
        ...
        if ( v5 == v11 )
        {
          std::vector<unsigned char>::_Emplace_reallocate<unsigned char const &>((__int64 *)&v26, v11, v25);
          v5 = v27;
        ...
        if ( v5 == v16 )
        {
          std::vector<unsigned char>::_Emplace_reallocate<unsigned char const &>((__int64 *)&v26, v16, v25);
          v5 = v27;
          v11 = (char *)*((_QWORD *)&v26 + 1);
        }
        else
  ...
  {
    std::string::string(a1, &word_1802CD8A6);
  }
  return v2;
}
