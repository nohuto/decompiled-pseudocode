/*
 * XREFs of ?Create@CColorKeyBitmap@@SAJPEAVIBitmapRealization@@AEBVCColorKey@@PEAPEAV1@@Z @ 0x180265CD8
 * Callers:
 ...
 *     ??0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z @ 0x180265858 (--0CColorKeyBitmap@@IEAA@AEBVCColorKey@@@Z.c)
