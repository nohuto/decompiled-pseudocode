/*
 * XREFs of ?PresentRateSupportsOverlay@CGlobalCompositionSurfaceInfo@@UEAA_NXZ @ 0x1800EAEE0
 * Callers:
 *     <none>
 * Callees:
 *     ?CalcCurrentPresentCount@CPresentRate@@IEBAIPEBVCGlobalCompositionSurfaceInfo@@@Z @ 0x18020C27C (-CalcCurrentPresentCount@CPresentRate@@IEBAIPEBVCGlobalCompositionSurfaceInfo@@@Z.c)
 *     ?IsSufficientIntervalForStats@CPresentRate@@IEBA_N_N@Z @ 0x18020C348 (-IsSufficientIntervalForStats@CPresentRate@@IEBA_N_N@Z.c)
 *     ?IsSufficientPresentCount@CPresentRate@@IEAA_NI_N@Z @ 0x18020C440 (-IsSufficientPresentCount@CPresentRate@@IEAA_NI_N@Z.c)
 */
