/*
 * XREFs of ?OnNormalScaleChanged@CScenePbrMaterial@@QEAAXXZ @ 0x1801EC618
 * Callers:
 *     ?SetNormalScale@?$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJM@Z @ 0x180173158 (-SetNormalScale@-$CScenePbrMaterialGeneratedT@VCScenePbrMaterial@@VCSceneMaterial@@@@QEAAJM@Z.c)
