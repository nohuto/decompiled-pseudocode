/*
 * XREFs of ?PresentMPO@CConversionSwapChain@@UEAAJIIW4DXGI_HDR_METADATA_TYPE@@PEBXPEBU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@I@Z @ 0x18024DEC8
 * Callers:
 *     ?PresentMPO@CConversionSwapChain@@$4PPPPPPPM@A@EAAJIIW4DXGI_HDR_METADATA_TYPE@@PEBXPEBU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@I@Z @ 0x1800F24B0 (-PresentMPO@CConversionSwapChain@@$4PPPPPPPM@A@EAAJIIW4DXGI_HDR_METADATA_TYPE@@PEBXPEBU_DXGI_PRE.c)
 * Callees:
 ...
 *     ??1CRegion@@QEAA@XZ @ 0x1800449A8 (--1CRegion@@QEAA@XZ.c)
 *     ??0CRegion@@QEAA@XZ @ 0x1800449B4 (--0CRegion@@QEAA@XZ.c)
 ...
 *     ?push_back@?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@QEAAXAEBUtagRECT@@@Z @ 0x1800EC388 (-push_back@-$vector@UtagRECT@@V-$allocator@UtagRECT@@@std@@@std@@QEAAXAEBUtagRECT@@@Z.c)
 ...
 *     ??0CRegion@@QEAA@AEBUtagRECT@@@Z @ 0x180175F1C (--0CRegion@@QEAA@AEBUtagRECT@@@Z.c)
...
LABEL_31:
  ...
  if ( (_DWORD)v20 == 1 )
  {
    ...
    CRegion::Copy((CRegion *)v35, (CConversionSwapChain *)((char *)this - 184));
    if ( *((_BYTE *)this - 80) )
    {
