/*
 * XREFs of ?OnChanged@CVisual@@UEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x18005A310
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CVisual::OnChanged(__int64 a1, int a2, _QWORD *a3)
{
  ...
  float v98[4]; // [rsp+D0h] [rbp+7h] BYREF
  ...
  if ( v8 )
  {
    ...
    if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64))(*(_QWORD *)v8 + 56LL))(v8, 14LL) )
    {
      ...
      else
      {
        ...
        {
          LOBYTE(v12) = 1;
          (*(void (__fastcall **)(__int64, __int64))(*(_QWORD *)v11 + 328LL))(v11, v12);
        }
        v13 = *(_BYTE **)(v11 + 64);
        v10 = 0;
        if ( v13 )
        ...
        if ( (*v40)(v4, &GUID_c155b649_2c5b_416a_b836_bbda56b2ec27, &v87) >= 0 )
        {
          ...
          if ( v51 )
          {
            ...
            while ( (unsigned __int64)v95 < v94 )
            {
              v98[1] = (float)*v95;
              v52 = (float)v95[2];
              v98[0] = (float)*(int *)(v96 + 8LL * v97);
              v53 = (float)*(int *)(v96 + 8LL * v97 + 4);
              v98[3] = v52;
              v98[2] = v53;
              CVisual::AddAdditionalDirtyRect((CVisual *)a1, (__int64)v98);
