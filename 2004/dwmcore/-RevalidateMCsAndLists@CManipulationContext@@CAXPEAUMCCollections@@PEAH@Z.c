/*
 * XREFs of ?RevalidateMCsAndLists@CManipulationContext@@CAXPEAUMCCollections@@PEAH@Z @ 0x180234688
 * Callers:
  ...
  *a2 = v2;
  if ( v2 > 0 )
  {
    ...
    do
    {
      ...
      if ( (*((_BYTE *)v7 + 28) & 4) != 0 )
        CManipulationContext::RevalidateMC(v7, a1, &v8, (__int64 *)(unsigned int)v3, *a2);
