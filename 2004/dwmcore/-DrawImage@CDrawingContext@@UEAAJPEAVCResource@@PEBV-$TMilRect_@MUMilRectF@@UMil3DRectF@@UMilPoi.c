/*
 * XREFs of ?DrawImage@CDrawingContext@@UEAAJPEAVCResource@@PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV?$TValueResource@UMilRectF@@UtagMILCMD_RECTRESOURCE@@$0IM@@@@Z @ 0x180177110
 * Callers:
 *     <none>
 * Callees:
 ...
 *     gsl::final_action__lambda_b84a1ee213fa572390f758b550ef68e0___::_final_action__lambda_b84a1ee213fa572390f758b550ef68e0___ @ 0x180175F88 (gsl--final_action__lambda_b84a1ee213fa572390f758b550ef68e0___--_final_action__lambda_b84a1ee213f.c)
 */
  ...
  if ( a2 && (*(unsigned __int8 (__fastcall **)(_QWORD *, __int64))(*a2 + 56LL))(a2, 83LL) )
  {
    ...
    if ( (float)(v10 - v12) >= 2.220446e-16 && (float)(v9 - v11) >= 2.220446e-16 )
    {
      ...
      *(_DWORD *)(a1 + 264) = 0;
      ...
      v4 = v14;
      if ( v14 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x2A0u, 0LL);
