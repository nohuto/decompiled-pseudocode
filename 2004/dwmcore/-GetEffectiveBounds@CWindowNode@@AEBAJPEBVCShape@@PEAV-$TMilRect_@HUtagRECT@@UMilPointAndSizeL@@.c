/*
 * XREFs of ?GetEffectiveBounds@CWindowNode@@AEBAJPEBVCShape@@PEAV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@PEA_N2@Z @ 0x180080210
 * Callers:
...
__int64 __fastcall CWindowNode::GetEffectiveBounds(_DWORD *a1, CShape *a2, _DWORD *a3, char *a4, char *a5)
{
  ...
  *a3 = 0;
  ...
  if ( a2 )
  {
    ...
    if ( v12 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast(v13, 0LL, 0, v12, 0x3ADu, 0LL);
      return v5;
    }
