/*
 * XREFs of ?Add@CDirtyRegion@@QEAAJAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800C221C
 * Callers:
 ...
 *     ?IsDisabled@CDirtyRegion@@QEBA_NXZ @ 0x1800C22B8 (-IsDisabled@CDirtyRegion@@QEBA_NXZ.c)
