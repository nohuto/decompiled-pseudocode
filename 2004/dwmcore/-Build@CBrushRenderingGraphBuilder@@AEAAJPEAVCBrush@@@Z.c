/*
 * XREFs of ?Build@CBrushRenderingGraphBuilder@@AEAAJPEAVCBrush@@@Z @ 0x1800B783C
 * Callers:
...
__int64 __fastcall CBrushRenderingGraphBuilder::Build(CBrushRenderingGraphBuilder *this, struct CBrush *a2)
{
    ...
    if ( v6 )
    {
      ...
      if ( v12 )
      {
        std::_Destroy_range<std::allocator<CRenderingTechniqueFragment::FragmentInput>>(
          *((_QWORD *)v6 + 4),
          *((_QWORD *)v6 + 5));
        std::_Deallocate<16,0>(v12, (*((_QWORD *)v6 + 6) - v12) & 0xFFFFFFFFFFFFFFF0uLL);
        *((_QWORD *)v6 + 4) = 0LL;
        *((_QWORD *)v6 + 5) = 0LL;
        *((_QWORD *)v6 + 6) = 0LL;
      }
  ...
  MilInstrumentationCheckHR_MaybeFailFast((__int64)v4, 0LL, 0, v13, v14, 0LL);
LABEL_8:
  if ( v18 )
