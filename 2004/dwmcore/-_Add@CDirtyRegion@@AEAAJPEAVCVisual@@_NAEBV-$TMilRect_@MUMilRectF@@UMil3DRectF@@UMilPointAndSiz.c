/*
 * XREFs of ?_Add@CDirtyRegion@@AEAAJPEAVCVisual@@_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18006E930
 * Callers:
 ...
 *     ?CalcDirtyRegionCachedData@CDirtyRegion@@AEAAXAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUDirtyRegionCachedData@1@@Z @ 0x18007ED08 (-CalcDirtyRegionCachedData@CDirtyRegion@@AEAAXAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPoint.c)
 ...
 *     ?UpdateAcceleration@CDirtyRegion@@AEAAXI@Z @ 0x1800BEAD4 (-UpdateAcceleration@CDirtyRegion@@AEAAXI@Z.c)
  ...
  if ( !*((_BYTE *)this + 4456) )
  {
    ...
    if ( v14 > v10 && v15 > v13 && v14 > v10 && v15 > v12 )
    {
      ...
      if ( a2 )
      {
        ...
        if ( v18 == 32 )
        {
          v135 = (char *)DefaultHeap::Alloc(0x610uLL);
          v20 = v135;
          if ( !v135 )
          {
            v4 = -2147024882;
...
LABEL_87:
          ...
          else
          {
            ...
            *((__m128 *)this + v36 + 100) = v17;
            CDirtyRegion::CalcDirtyRegionCachedData(v120, &X, (char *)this + 16 * v36 + 1984);
