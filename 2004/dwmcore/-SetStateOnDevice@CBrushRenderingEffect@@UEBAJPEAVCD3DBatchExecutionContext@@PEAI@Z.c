/*
 * XREFs of ?SetStateOnDevice@CBrushRenderingEffect@@UEBAJPEAVCD3DBatchExecutionContext@@PEAI@Z @ 0x18004D400
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a3)
{
  ...
  DXGI_FORMAT v73; // [rsp+C0h] [rbp-48h] BYREF
