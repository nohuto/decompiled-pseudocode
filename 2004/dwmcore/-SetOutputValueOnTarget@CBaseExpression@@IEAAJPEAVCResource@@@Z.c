/*
 * XREFs of ?SetOutputValueOnTarget@CBaseExpression@@IEAAJPEAVCResource@@@Z @ 0x180060030
 * Callers:
 ...
 *     ??$_Try_emplace@AEBQEAVCResource@@$$V@?$unordered_map@PEAVCResource@@UResourceDebugInfo@CAnimationLoggingManager@@U?$hash@PEAVCResource@@@std@@U?$equal_to@PEAVCResource@@@5@V?$allocator@U?$pair@QEAVCResource@@UResourceDebugInfo@CAnimationLoggingManager@@@std@@@5@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@QEAVCResource@@UResourceDebugInfo@CAnimationLoggingManager@@@std@@@std@@@std@@@std@@_N@1@AEBQEAVCResource@@@Z @ 0x180095098 (--$_Try_emplace@AEBQEAVCResource@@$$V@-$unordered_map@PEAVCResource@@UResourceDebugInfo@CAnimati.c)
...
LABEL_65:
              ...
              if ( v66 + 8 != v47 )
              {
                std::wstring::_Tidy_deallocate(v66 + 8);
...
LABEL_39:
          if ( v27 )
          {
            ...
            if ( v37 && !v36[6] )
            {
              v56 = *((_QWORD *)qword_180345450 + 5);
              std::wstring::wstring(&v70, v27);
              LOBYTE(v64) = v65;
...
LABEL_50:
            ...
            {
              operator delete((void *)v40, 0x38uLL);
              ++*(_DWORD *)(v44 + 48);
            }
            else
            {
...
LABEL_6:
    ...
    else
    {
      if ( (unsigned __int8)CExpressionValue::operator==(Buf1)
        && !(*(unsigned __int8 (__fastcall **)(unsigned __int64))(*(_QWORD *)this + 264LL))(this)
        && !(*(unsigned __int8 (__fastcall **)(struct CResource *))(*(_QWORD *)a2 + 136LL))(a2) )
      {
        goto LABEL_6;
      }
