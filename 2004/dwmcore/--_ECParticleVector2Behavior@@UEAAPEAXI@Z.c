/*
 * XREFs of ??_ECParticleVector2Behavior@@UEAAPEAXI@Z @ 0x18016F140
 * Callers:
 *     ??_ECParticleVector2Behavior@@WGI@EAAPEAXI@Z @ 0x1800EEEE0 (--_ECParticleVector2Behavior@@WGI@EAAPEAXI@Z.c)
 * Callees:
