/*
 * XREFs of ?EnsureRenderTargetBitmap@CCachedVisualImage@@AEAAJAEBVRenderTargetInfo@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x180046F8C
 * Callers:
 ...
 *     ?IsRectEmptyOrInvalid@@YA_NPEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180046854 (-IsRectEmptyOrInvalid@@YA_NPEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeede.c)
        ...
        struct IRenderTargetBitmap **a3)
{
  ...
  *a3 = 0LL;
  ...
  CCachedVisualImage::GetSize((CCachedVisualImage *)((char *)this + 64), (__int64)&v24);
  ...
  if ( IsRectEmptyOrInvalid((float *)&v26) )
  {
    v23 = 912;
LABEL_37:
    v21 = -2003304309;
  ...
  CCachedVisualImage::RemoveInvalidTargets(this, v6);
  v10 = CCachedVisualImage::FindExistingCachedTarget(this, a2);
  v24 = (struct D2D_SIZE_U)v10;
  v11 = v10;
  if ( v10 )
  {
    CachedTarget = CCachedVisualImage::CCachedTarget::Update((__int64)v10, &v26, *((_DWORD *)this + 42), (__int64)a2);
    v13 = CachedTarget;
    if ( CachedTarget >= 0 )
    {
...
LABEL_38:
  ...
  v17 = CCachedVisualImage::CCachedTarget::Update(*(_QWORD *)&v24, &v26, *((_DWORD *)this + 42), (__int64)a2);
  v13 = v17;
  if ( v17 >= 0 )
  {
