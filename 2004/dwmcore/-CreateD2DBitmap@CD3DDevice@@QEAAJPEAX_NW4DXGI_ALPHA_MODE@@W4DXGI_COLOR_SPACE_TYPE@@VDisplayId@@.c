/*
 * XREFs of ?CreateD2DBitmap@CD3DDevice@@QEAAJPEAX_NW4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MMPEAPEAVCD2DBitmap@@@Z @ 0x18003E9A0
 * Callers:
...
LABEL_7:
    v20 = v15;
LABEL_9:
    MilInstrumentationCheckHR_MaybeFailFast(a1, &dword_1802AB078, 2u, v20, v21, 0LL);
  }
