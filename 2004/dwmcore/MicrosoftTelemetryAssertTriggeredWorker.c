/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1802162D0
 * Callers:
 *     MicrosoftTelemetryAssertTriggeredArgs @ 0x180216278 (MicrosoftTelemetryAssertTriggeredArgs.c)
 *     MicrosoftTelemetryAssertTriggeredNoArgs @ 0x1802162A8 (MicrosoftTelemetryAssertTriggeredNoArgs.c)
 * Callees:
 *     TraceLoggingRegisterEx_EventRegister_EventSetInformation @ 0x1800D68CC (TraceLoggingRegisterEx_EventRegister_EventSetInformation.c)
 *     __security_check_cookie @ 0x1800E26A0 (__security_check_cookie.c)
 *     EventUnregister_0 @ 0x1800E3C49 (EventUnregister_0.c)
 *     EventRegister_0 @ 0x1800E3C55 (EventRegister_0.c)
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U?$_tlgWrapSz@D@@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@333AEBU?$_tlgWrapSz@D@@3333@Z @ 0x180215F34 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U-$_tlgWrapSz@D@@U1@U1@U1@U1@@-$_tlgWriteTemplate@$$A.c)
 *     ??$Write@U?$_tlgWrapperByVal@$03@@U1@U1@U1@U?$_tlgWrapSz@D@@U1@U1@U2@U1@U1@U1@U1@@?$_tlgWriteTemplate@$$A6AJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2IPEAU_EVENT_DATA_DESCRIPTOR@@@Z$1?_tlgWriteTransfer_EventWriteTransfer@@YAJ0122I3@ZPEBU2@PEBU2@@@SAJPEBU_tlgProvider_t@@PEBXPEBU_GUID@@2AEBU?$_tlgWrapperByVal@$03@@333AEBU?$_tlgWrapSz@D@@3343333@Z @ 0x180216048 (--$Write@U-$_tlgWrapperByVal@$03@@U1@U1@U1@U-$_tlgWrapSz@D@@U1@U1@U2@U1@U1@U1@U1@@-$_tlgWriteTem.c)
 *     GetImageTuple @ 0x1802161CC (GetImageTuple.c)
 */
...
LABEL_5:
  ...
  if ( GetTickCount() - *((_DWORD *)v10 + 2) > 0xEA60 )
  {
    *((_DWORD *)v10 + 2) = GetTickCount();
    ...
    if ( *((_DWORD *)v10 + 4) == 1
      && !(unsigned int)TraceLoggingRegisterEx_EventRegister_EventSetInformation((ULONGLONG *)&dword_180343660) )
    {
      if ( dword_180343660 )
      {
        v20 = v45[0];
    ...
    if ( !(unsigned int)TraceLoggingRegisterEx_EventRegister_EventSetInformation((ULONGLONG *)&dword_180343698) )
    {
      if ( v9 )
      {
        if ( (unsigned int)dword_180343698 > 5
          && (qword_1803436A8 & 0x400000000000LL) != 0
          && (qword_1803436B0 & 0x400000000000LL) == qword_1803436B0 )
        {
      ...
      else if ( (unsigned int)dword_180343698 > 5
             && (qword_1803436A8 & 0x400000000000LL) != 0
             && (qword_1803436B0 & 0x400000000000LL) == qword_1803436B0 )
      {
