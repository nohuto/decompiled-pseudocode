/*
 * XREFs of ?NotifyRenderedRect@CCompSwapChain@@UEAAXPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@UMil3DRectL@@U_CMilRectL_@RectUniqueness@@@@@Z @ 0x18024F890
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)&v12.right = v11;
  if ( a2 )
  {
    if ( TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::IntersectUnsafe(&v12, a2) )
    {
      ...
      v7 = FastRegion::CRegion::Union((void **)(a1 + 104), (const struct FastRegion::Internal::CRgnData **)v13);
      if ( v7 < 0 )
