/*
 * XREFs of ?OnInteractionUpdate@CManipulationManager@@IEAAXXZ @ 0x18009C78C
 * Callers:
 *     _lambda_efd5facd022cf831717386964e02a8d7_::_lambda_invoker_cdecl_ @ 0x1800D9120 (_lambda_efd5facd022cf831717386964e02a8d7_--_lambda_invoker_cdecl_.c)
 * Callees:
 ...
 *     ?SetInteractionConfiguration@CInteractionProcessor@@QEAAJW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@PEBXI@Z @ 0x1800ABEF4 (-SetInteractionConfiguration@CInteractionProcessor@@QEAAJW4Enum@InteractionConfigurationUpdateTy.c)
 ...
 *     ?MidManipulationUpdateTypeToString@InputTraceLogging@@CAPEBDW4MidManipulationUpdateType@@@Z @ 0x1802238A8 (-MidManipulationUpdateTypeToString@InputTraceLogging@@CAPEBDW4MidManipulationUpdateType@@@Z.c)
 ...
 *     ?SetTemporaryConfiguration@CInteractionProcessor@@QEAAXW4TemporaryConfigurationAxis@@W4Enum@InteractionConfigurationUpdateType@@_NU?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchPrimitiveType@@@@@Z @ 0x18022D78C (-SetTemporaryConfiguration@CInteractionProcessor@@QEAAXW4TemporaryConfigurationAxis@@W4Enum@Inte.c)
 ...
 *     ?Revalidate@CManipulationContext@@SAXPEAUMCCollections@@PEAV?$CQueue@PEAVCResource@@@@@Z @ 0x1802339F0 (-Revalidate@CManipulationContext@@SAXPEAUMCCollections@@PEAV-$CQueue@PEAVCResource@@@@@Z.c)
 */
...
LABEL_12:
    if ( v10 )
      CQueue<CResource *>::Insert((__int64)(this + 13), (__int64)v9, (__int64)v10);
    if ( v11 )
      CQueue<CResource *>::Insert((__int64)(this + 13), (__int64)v9, (__int64)v11 + 8);
