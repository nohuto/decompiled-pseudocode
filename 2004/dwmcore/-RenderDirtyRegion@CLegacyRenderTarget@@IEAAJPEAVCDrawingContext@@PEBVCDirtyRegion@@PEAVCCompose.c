/*
 * XREFs of ?RenderDirtyRegion@CLegacyRenderTarget@@IEAAJPEAVCDrawingContext@@PEBVCDirtyRegion@@PEAVCComposeTop@@@Z @ 0x18007CDF8
 * Callers:
 ...
 *     ?IsHDR@RenderTargetInfo@@QEBA_NXZ @ 0x1800472C0 (-IsHDR@RenderTargetInfo@@QEBA_NXZ.c)
 ...
 *     ?UseSuperSample@CLegacyRenderTarget@@AEBA_NXZ @ 0x18007D7EC (-UseSuperSample@CLegacyRenderTarget@@AEBA_NXZ.c)
 ...
 *     ??0narrowing_error@gsl@@QEAA@XZ @ 0x180165460 (--0narrowing_error@gsl@@QEAA@XZ.c)
        ...
        struct CComposeTop *a4)
{
  ...
  _DWORD v93[6]; // [rsp+B8h] [rbp-48h] BYREF
  ...
  if ( *((_QWORD *)a3 + 4) != v10 )
    v11 = 0LL;
  v93[0] = _mm_cvtepi32_ps(v12).m128_u32[0];
  v15 = _mm_cvtsi32_si128(*((_DWORD *)this + 48));
  v93[1] = _mm_cvtepi32_ps(v14).m128_u32[0];
  v16 = (float)*((int *)this + 49);
  v93[2] = _mm_cvtepi32_ps(v15).m128_u32[0];
  *(float *)&v93[3] = v16;
  if ( !*((_BYTE *)a3 + 4456) )
  {
    ...
    *((_QWORD *)&v86 + 1) = __PAIR64__(v36, v35);
                             ...
                             &v86) )
    {
      ...
      *((float *)&v86 + 3) = (float)v38;
      ...
      v8 = CDrawingContext::Clear((struct CDrawingContext *)((char *)a2 + 16), &stru_1802EE660);
    ...
    *((_QWORD *)&v80 + 1) = v82;
    ...
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 8) != 0 )
      McTemplateU0qdffff_EventWriteTransfer(
        ...
        SLOBYTE(v91),
        SLOBYTE(v92));
    dword_180345288 += (int)(float)((float)(v50 - v51) * (float)(v52 - v53));
