/*
 * XREFs of ?CreateSkyBoxPrimitive@CCompositionSkyBoxBrush@@AEAAJPEAVCBrushDrawListGenerator@@PEAPEAVCDrawListPrimitive@@@Z @ 0x1801BD1C4
 * Callers:
        ...
        struct CDrawListPrimitive **a3)
{
  ...
  else
  {
    for ( i = 0; i < 6; ++i )
    {
      v10 = *((_DWORD *)this + 28);
      if ( _bittest(&v10, i) )
        DynArray<unsigned short,0>::AddMultipleAndSet((__int64)&v25, (__int64 *)((char *)&unk_180302740 + 12 * i));
    }
    ...
    v13 = (const struct MilPoint4F *)&unk_180302790;
    v14 = 8LL;
    do
    {
