/*
 * XREFs of ?OnWatchdogTimeout@CDwmRenderThreadWatchdog@@EEAAXXZ @ 0x1801582C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??B_Atomic_int@std@@QEBAHXZ @ 0x180158254 (--B_Atomic_int@std@@QEBAHXZ.c)
 */
