/*
 * XREFs of McTemplateU0xxxxx_EventWriteTransfer @ 0x180155CEC
 * Callers:
 ...
 *     ?TraceTime@CPartitionVerticalBlankScheduler@@AEAAXXZ @ 0x1800DAA6C (-TraceTime@CPartitionVerticalBlankScheduler@@AEAAXXZ.c)
 * Callees:
