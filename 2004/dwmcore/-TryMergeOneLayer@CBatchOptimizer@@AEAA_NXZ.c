/*
 * XREFs of ?TryMergeOneLayer@CBatchOptimizer@@AEAA_NXZ @ 0x18007E480
 * Callers:
 ...
 *     ?SkipContinuations@CBatchOptimizer@@AEBAHH@Z @ 0x180016164 (-SkipContinuations@CBatchOptimizer@@AEBAHH@Z.c)
 *     ?RecycleLayer@CBatchOptimizer@@AEAAXH@Z @ 0x18007BCBC (-RecycleLayer@CBatchOptimizer@@AEAAXH@Z.c)
 *     ?CanTunnelToLayer@CBatchOptimizer@@AEBA_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@HPEAH@Z @ 0x18007E6AC (-CanTunnelToLayer@CBatchOptimizer@@AEBA_NAEBV-$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSi.c)
