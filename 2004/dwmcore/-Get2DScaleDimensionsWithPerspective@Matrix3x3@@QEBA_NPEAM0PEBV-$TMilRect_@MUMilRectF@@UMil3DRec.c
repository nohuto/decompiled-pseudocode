/*
 * XREFs of ?Get2DScaleDimensionsWithPerspective@Matrix3x3@@QEBA_NPEAM0PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18003AF38
 * Callers:
...
char __fastcall Matrix3x3::Get2DScaleDimensionsWithPerspective(__int64 a1, float *a2, float *a3, float *a4)
{
    ...
    && COERCE_FLOAT(*(_DWORD *)(a1 + 20) & _xmm) < 0.0000011920929 )
  {
    ...
    {
      Matrix3x3::Get2DScaleDimensions((Matrix3x3 *)a1, (struct D2D_VECTOR_2F)v18);
      v6 = v18[1];
      *a2 = *(float *)v18;
      *(_DWORD *)a3 = v6;
      return 1;
