/*
 * XREFs of ?DebuggingStarted@BamoCompObjectDiagnosticsRootProxyImpl@BamoImpl@@QEAAJI_KIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBEI@Z @ 0x180183A78
 * Callers:
...
LABEL_3:
  ...
  return CoreUICallSend(v5, v8, 2LL, 0LL, 1, &unk_1802D80EA);
}
