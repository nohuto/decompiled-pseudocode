/*
 * XREFs of ?Present@CRemoteAppRenderTarget@@UEAAJ_N@Z @ 0x1801879CC
 * Callers:
 *     ?Present@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800EFF50 (-Present@CRemoteAppRenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
