/*
 * XREFs of ?GenerateShaders@CD3DDevice@@AEAAJXZ @ 0x1800B4190
 * Callers:
...
LABEL_65:
  ...
  while ( 2 )
  {
    ...
    do
    {
      *(_QWORD *)v55 = 0LL;
      ...
      {
        v21 = *((_OWORD *)&unk_180282E40 + v20);
        v56 = (struct ID3D11PixelShader *)*((_QWORD *)&unk_180282E40 + 2 * v20);
        v58 = v21;
        if ( v56 )
        {
          *(_OWORD *)v55 = *((_OWORD *)&unk_1803431D0 + v18);
          *(_OWORD *)v65 = *((_OWORD *)&unk_180343210 + (int)v17);
          v22 = v65[0];
          if ( v65[0] )
          {
            v23 = *(_QWORD *)v55;
  ...
  do
  {
    ...
    *((_QWORD *)v32 + 202) = 0LL;
    ...
    CommonOrCubeMapRenderingShadersNoRefInternal = v35(v31, &byte_1802EB760[264 * (int)v30], v32 + 1616);
    v9 = CommonOrCubeMapRenderingShadersNoRefInternal;
    if ( CommonOrCubeMapRenderingShadersNoRefInternal < 0 )
    {
      v53 = 595;
  ...
  do
  {
    ...
    *((_QWORD *)v38 + 274) = 0LL;
    ...
    CommonOrCubeMapRenderingShadersNoRefInternal = v41(v37, &_ImageBase + 10 * (int)v36 + 792810, v38 + 2192);
    v9 = CommonOrCubeMapRenderingShadersNoRefInternal;
    if ( CommonOrCubeMapRenderingShadersNoRefInternal < 0 )
    {
      v53 = 601;
  ...
  if ( v57 >= 37632 )
  {
    ...
    if ( (_BYTE)v59 )
    {
      ...
      *(_QWORD *)v58 = *((_QWORD *)&v58 + 1);
      if ( v50 )
      {
        v52 = *(CMILPoolResource **)(v50 + 104);
        if ( v52 )
        {
          *(_QWORD *)(v50 + 104) = 0LL;
          CMILPoolResource::Release(v52);
        }
        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(v50 + 96);
        Microsoft::WRL::ComPtr<ID2D1Geometry>::InternalRelease(v50 + 88);
        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(v50 + 80);
        Microsoft::WRL::ComPtr<IUnknown>::InternalRelease(v50 + 72);
