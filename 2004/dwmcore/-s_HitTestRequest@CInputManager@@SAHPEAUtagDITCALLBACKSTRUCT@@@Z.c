/*
 * XREFs of ?s_HitTestRequest@CInputManager@@SAHPEAUtagDITCALLBACKSTRUCT@@@Z @ 0x18009CE18
 * Callers:
 *     ?HitTestRequest@CInputProxy@@UEAA_NPEAUtagDITCALLBACKSTRUCT@@@Z @ 0x18009CCC0 (-HitTestRequest@CInputProxy@@UEAA_NPEAUtagDITCALLBACKSTRUCT@@@Z.c)
 * Callees:
...
_BOOL8 __fastcall CInputManager::s_HitTestRequest(struct tagDITCALLBACKSTRUCT *a1)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, &dword_1802DAC20, 2u, v11, 0x125u, 0LL);
  }
  else
  {
    ...
    if ( v13 >= 0 )
    {
      ...
      v4 = v15;
      if ( v15 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802DAC20, 2u, v15, 0x132u, 0LL);
...
LABEL_14:
    ...
    MilInstrumentationCheckHR_MaybeFailFast(v14, &dword_1802DAC20, 2u, v13, 0x128u, 0LL);
  }
  if ( v20 )
    CRenderTargetBitmap::Release(v20);
LABEL_16:
