/*
 * XREFs of ?CreateRenderTargetBitmap@CD3DDevice@@QEAAJPEAUID3D11Texture2D@@W4DXGI_ALPHA_MODE@@W4DXGI_COLOR_SPACE_TYPE@@VDisplayId@@MPEAPEAVIRenderTargetBitmap@@@Z @ 0x18023CF48
 * Callers:
        ...
        struct IRenderTargetBitmap **a7)
{
  ...
  *a7 = 0LL;
  ...
  {
    v12 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_1802EE908, 2u, -2147024809, 0x60Du, 0LL);
    goto LABEL_13;
  }
  ...
  if ( v15 < 0 )
  {
    v21 = 1576;
LABEL_12:
    MilInstrumentationCheckHR_MaybeFailFast(v16, &dword_1802EE908, 2u, v15, v21, 0LL);
  }
LABEL_13:
