/*
 * XREFs of ?OpenDrawListEntryBatch@CDrawListBatchManager@@IEAAJPEAPEAVCDrawListEntryBatch@@@Z @ 0x1800B2140
 * Callers:
 ...
 *     ??0CDrawListEntryBatch@@AEAA@PEAVCD3DDevice@@PEAVCSharedDirect3DResources@0@@Z @ 0x1800B22B4 (--0CDrawListEntryBatch@@AEAA@PEAVCD3DDevice@@PEAVCSharedDirect3DResources@0@@Z.c)
        ...
        struct CDrawListEntryBatch **a2)
{
  ...
  else
  {
    ...
    v17 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 120, 8, 1, &v21);
    v4 = v17;
    if ( v17 < 0 )
