/*
 * XREFs of ?ContinueLayer@CBatchOptimizer@@AEAAXH@Z @ 0x1800C85A4
 * Callers:
...
void __fastcall CBatchOptimizer::ContinueLayer(CBatchOptimizer *this, int a2)
{
  ...
  {
    v10 = (void (__fastcall ***)(_QWORD))*((_QWORD *)v6 + 14);
    CBatchOptimizer::FlushBottomLayer(this);
    wil::com_ptr_t<CRenderingEffect,wil::err_returncode_policy>::operator=((__int64 *)v6 + 14, v10);
  }
}
