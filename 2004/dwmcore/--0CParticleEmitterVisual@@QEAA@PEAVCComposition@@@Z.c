/*
 * XREFs of ??0CParticleEmitterVisual@@QEAA@PEAVCComposition@@@Z @ 0x1801DF4B0
 * Callers:
 ...
 *     ??0ParticleCollection@CParticleEmitterVisual@@QEAA@XZ @ 0x1801DF790 (--0ParticleCollection@CParticleEmitterVisual@@QEAA@XZ.c)
 */
