/*
 * XREFs of ?Render@CDrawListEntryBatch@@UEAAJXZ @ 0x180083A10
 * Callers:
 *     <none>
 * Callees:
...
LABEL_47:
  ...
  v35 = *((_DWORD *)this + 13);
  if ( v34 != v35 )
    dword_18034524C += v35 - v34;
  dword_18034536C += *((_DWORD *)this + 30);
  v36 = *((_QWORD *)this + 14);
  ...
  while ( v36 != v37 )
  {
    ...
    if ( *(_QWORD *)(v54 + 32) )
    {
      CHWDrawListEntry::ReplacePrimitive(*(_QWORD **)v54, (__int64 *)&v83, (__int64 *)(v54 + 32), v54 + 40);
      if ( v83 )
