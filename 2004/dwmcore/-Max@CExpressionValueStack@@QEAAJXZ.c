/*
 * XREFs of ?Max@CExpressionValueStack@@QEAAJXZ @ 0x1800D8DD8
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Max(CExpressionValueStack *this)
{
  ...
  if ( v6 != 18 )
  {
    ...
    {
      case '#':
        v12 = fmaxf(*(float *)(v2 + 8 * v4), *(float *)(v2 + 8 * v5));
        v13 = fmaxf(*(float *)(v2 + 8 * v4 + 4), *(float *)(v2 + 8 * v5 + 4));
      ...
      case '4':
        v15 = *(_QWORD *)(v2 + 8 * v4);
        v17 = *(_QWORD *)(v2 + 8 * v5);
        v11 = fmaxf(*(float *)(v2 + 8 * v4 + 8), *(float *)(v2 + 8 * v5 + 8));
        *(_DWORD *)(v2 + 8 * v4 + 72) = 52;
        *(float *)(v2 + 8 * v4) = fmaxf(*(float *)&v15, *(float *)&v17);
        *(float *)(v2 + 8 * v4 + 4) = fmaxf(*((float *)&v15 + 1), *((float *)&v17 + 1));
        *(float *)(v2 + 8 * v4 + 8) = v11;
        goto LABEL_5;
      case 'E':
