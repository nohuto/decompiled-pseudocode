/*
 * XREFs of ?UpdateRestrictToProcessId@BamoDataSourceProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180195940
 * Callers:
 *     ?Thunk_UpdateRestrictToProcessId_5@?$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180195920 (-Thunk_UpdateRestrictToProcessId_5@-$IDataSourceProxy_Receive@VBamoDataSourceProxyImpl@BamoImpl@.c)
