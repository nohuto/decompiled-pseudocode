/*
 * XREFs of ?Initialize@CTextVisual@@MEAAJXZ @ 0x1801F22F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CTextVisualContent@@QEAA@PEAVCTextVisual@@@Z @ 0x1801F210C (--0CTextVisualContent@@QEAA@PEAVCTextVisual@@@Z.c)
