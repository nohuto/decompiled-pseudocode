/*
 * XREFs of ?GetControlPointCount@CPathData@@QEBAIXZ @ 0x18021FF34
 * Callers:
 *     ?IsEmpty@CPathSegmentsShape@@UEBA_NXZ @ 0x18025DA50 (-IsEmpty@CPathSegmentsShape@@UEBA_NXZ.c)
 * Callees:
 *     ??9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z @ 0x18021F9D8 (--9const_iterator@ControlPointCollection@Path@@QEBA_NV012@@Z.c)
 *     ??Dconst_iterator@ControlPointCollection@Path@@QEBAAEBUD2D_POINT_2F@@XZ @ 0x18021FA14 (--Dconst_iterator@ControlPointCollection@Path@@QEBAAEBUD2D_POINT_2F@@XZ.c)
