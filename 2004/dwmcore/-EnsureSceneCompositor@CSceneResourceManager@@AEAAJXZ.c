/*
 * XREFs of ?EnsureSceneCompositor@CSceneResourceManager@@AEAAJXZ @ 0x180169DD4
 * Callers:
 ...
 *     ?reset@?$unique_storage@U?$resource_policy@PEAUHINSTANCE__@@P6AHPEAU1@@Z$1?FreeLibrary@@YAH0@ZU?$integral_constant@_K$0A@@wistd@@PEAU1@PEAU1@$0A@$$T@details@wil@@@details@wil@@QEAAXPEAUHINSTANCE__@@@Z @ 0x18016A684 (-reset@-$unique_storage@U-$resource_policy@PEAUHINSTANCE__@@P6AHPEAU1@@Z$1-FreeLibrary@@YAH0@ZU-.c)
...
__int64 __fastcall CSceneResourceManager::EnsureSceneCompositor(CSceneResourceManager *this, __int64 a2)
{
  ...
  if ( !*((_BYTE *)this + 64) )
  {
    ...
    else
    {
      ...
      {
        v28 = (__int64 *)(*((_QWORD *)this + 3) + 88LL);
        v35 = this;
        v29 = (_QWORD *)v28[1];
        if ( (_QWORD *)v28[2] == v29 )
        {
          std::vector<ShaderLinkingBody const *>::_Emplace_reallocate<ShaderLinkingBody const *>(v28, v29, &v35);
        }
        else
        {
          *v29 = this;
