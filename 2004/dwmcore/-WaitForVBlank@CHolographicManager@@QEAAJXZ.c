/*
 * XREFs of ?WaitForVBlank@CHolographicManager@@QEAAJXZ @ 0x180252A58
 * Callers:
 *     ?WaitForVBlank@CHolographicInteropTarget@@UEBAJPEAX@Z @ 0x180256540 (-WaitForVBlank@CHolographicInteropTarget@@UEBAJPEAX@Z.c)
 * Callees:
