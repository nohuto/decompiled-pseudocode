/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD3DPixelShader@@VCLinkedShader@@@@QEAAJPEAVCD3DDevice@@PEAPEAVCD3DPixelShader@@@Z @ 0x18004C100
 * Callers:
...
LABEL_8:
        v14 = v25;
        v26 = (CD3DDevice *)a1;
        v15 = (__int64 *)((char *)v25 + 88);
        v16 = (_QWORD *)*((_QWORD *)v25 + 12);
        if ( *((_QWORD **)v25 + 13) == v16 )
        {
