/*
 * XREFs of ?GenerateApproxBlurIntermediate@CProjectedShadow@@AEAAJPEAVCDrawingContext@@MAEBUD2D_SIZE_F@@PEAPEAVIRenderTargetBitmap@@@Z @ 0x180010834
 * Callers:
        ...
        struct IRenderTargetBitmap **a5)
{
  ...
  *a5 = 0LL;
  ...
  if ( !CProjectedShadow::s_cpMaskForBlur )
  {
    ...
    v23 = 30;
    v10 = ShadowHelpers::GenerateMaskIntermediate(&v22, a2, &unk_180289640, v9, 0LL, 0, &v24, &v21);
    v12 = v10;
    if ( v10 < 0 )
    {
