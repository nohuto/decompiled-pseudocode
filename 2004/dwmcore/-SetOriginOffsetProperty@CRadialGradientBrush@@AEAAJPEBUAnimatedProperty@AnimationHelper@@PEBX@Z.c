/*
 * XREFs of ?SetOriginOffsetProperty@CRadialGradientBrush@@AEAAJPEBUAnimatedProperty@AnimationHelper@@PEBX@Z @ 0x1801E95C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsCenteredGradient@CRadialGradientBrush@@AEBA_NXZ @ 0x1801E946C (-IsCenteredGradient@CRadialGradientBrush@@AEBA_NXZ.c)
