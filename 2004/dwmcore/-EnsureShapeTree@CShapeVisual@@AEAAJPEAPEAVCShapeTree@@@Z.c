/*
 * XREFs of ?EnsureShapeTree@CShapeVisual@@AEAAJPEAPEAVCShapeTree@@@Z @ 0x1801ED830
 * Callers:
 ...
 *     ??0CShapeTree@@QEAA@PEAVCComposition@@@Z @ 0x1801ED77C (--0CShapeTree@@QEAA@PEAVCComposition@@@Z.c)
 */
