/*
 * XREFs of ?ManipulationThreadMain@CGlobalManipulationManager@@EEAAJXZ @ 0x18002AB00
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IsRegisterManipulationThreadPresent @ 0x1800E3E7C (IsRegisterManipulationThreadPresent.c)
