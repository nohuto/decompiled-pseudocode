/*
 * XREFs of ?Present@CDDARenderTarget@@UEAAJ_N@Z @ 0x18019A63C
 * Callers:
 *     ?Present@CDDARenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z @ 0x1800F03B0 (-Present@CDDARenderTarget@@$4PPPPPPPM@A@EAAJ_N@Z.c)
 * Callees:
