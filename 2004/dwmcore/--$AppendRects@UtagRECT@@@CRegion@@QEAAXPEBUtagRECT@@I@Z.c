/*
 * XREFs of ??$AppendRects@UtagRECT@@@CRegion@@QEAAXPEBUtagRECT@@I@Z @ 0x180041D40
 * Callers:
        ...
        unsigned int a3)
{
  ...
  char *v22; // rdi
  int v23; // r14d
  struct FastRegion::Internal::CRgnData *v24; // rbx
  int v25; // r12d
  int v26; // eax
  int v27; // r14d
  int v28; // ecx
  ...
  struct FastRegion::Internal::CRgnData *v56; // [rsp+48h] [rbp-C0h] BYREF
  ...
  v54 = a2;
  v4 = a3;
  v56 = (struct FastRegion::Internal::CRgnData *)v57;
  v5 = this;
  v57[0] = 0;
  if ( a3 )
  {
...
LABEL_69:
          ...
          FastRegion::Internal::CRgnData::Union(v21, v56, v15);
          v22 = (char *)lpMem;
          v23 = 0;
          if ( *(_DWORD *)lpMem )
          {
            if ( v64 == lpMem )
            {
              ...
              if ( v26 < v27 )
              {
                v24 = (struct FastRegion::Internal::CRgnData *)DefaultHeap::Alloc(v27);
                if ( v24 )
                {
                  FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v56);
                  v56 = v24;
                  v57[0] = v27;
                  goto LABEL_20;
                }
...
LABEL_20:
                ...
                *((_DWORD *)v24 + 2) = *((_DWORD *)v22 + 2);
                ...
                v31 = (_DWORD *)((char *)v24 + 8 * v28 + 12);
                v32 = ((struct FastRegion::Internal::CRgnData *)((char *)v24 + 8 * v28)
                     - (struct FastRegion::Internal::CRgnData *)&v22[*((int *)v22 + 4)]) >> 2;
                if ( *(int *)v24 > 0 )
                {
                  v33 = 4 * v32;
                  v34 = (_DWORD *)((char *)v24 + 12);
                  do
                  {
                    *v34 = *(_DWORD *)((char *)v34 + v22 - (char *)v24);
                    v34 += 2;
                    v35 = v29++;
                    *((_DWORD *)v24 + 2 * v35 + 4) = v33
                                                   + (_DWORD)v22
                                                   + 8 * v35
                                                   + *(_DWORD *)&v22[8 * v35 + 16]
                                                   - ((_DWORD)v24
            ...
            else
            {
              ...
              v62 = 0;
              FastRegion::CRegion::FreeMemory((FastRegion::CRegion *)&v56);
              v56 = (struct FastRegion::Internal::CRgnData *)v22;
              v57[0] = v51;
            }
          }
          else
        ...
        {
          v23 = FastRegion::CRegion::Copy(&v56, (const struct FastRegion::Internal::CRgnData **)&v58);
        }
        if ( v23 < 0 )
          goto LABEL_69;
        if ( v59 != v58 )
...
LABEL_44:
    ...
    if ( *(_DWORD *)*v5 )
    {
      v46 = FastRegion::Internal::CRgnData::EstimateSizeUnion(*v5, v56);
...
LABEL_71:
      ...
      FastRegion::Internal::CRgnData::Union(v47, v41, v56);
