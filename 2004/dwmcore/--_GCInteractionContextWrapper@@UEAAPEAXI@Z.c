/*
 * XREFs of ??_GCInteractionContextWrapper@@UEAAPEAXI@Z @ 0x18002BC10
 * Callers:
 *     ??_ECInteractionContextWrapper@@W7EAAPEAXI@Z @ 0x1800F1460 (--_ECInteractionContextWrapper@@W7EAAPEAXI@Z.c)
 * Callees:
