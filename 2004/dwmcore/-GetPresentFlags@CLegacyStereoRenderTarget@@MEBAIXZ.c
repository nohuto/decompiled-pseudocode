/*
 * XREFs of ?GetPresentFlags@CLegacyStereoRenderTarget@@MEBAIXZ @ 0x180170300
 * Callers:
 *     <none>
 * Callees:
 *     ?GetPresentFlags@CLegacyRenderTarget@@MEBAIXZ @ 0x1800C7C10 (-GetPresentFlags@CLegacyRenderTarget@@MEBAIXZ.c)
 */
