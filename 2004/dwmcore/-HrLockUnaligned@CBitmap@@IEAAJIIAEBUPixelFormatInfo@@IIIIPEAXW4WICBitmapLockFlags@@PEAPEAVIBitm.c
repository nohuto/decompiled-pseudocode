/*
 * XREFs of ?HrLockUnaligned@CBitmap@@IEAAJIIAEBUPixelFormatInfo@@IIIIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@@Z @ 0x180217228
 * Callers:
 ...
 *     ??0CBitmapLockUnaligned@@QEAA@XZ @ 0x1802179E4 (--0CBitmapLockUnaligned@@QEAA@XZ.c)
...
LABEL_25:
  ...
  {
    v16 = -2147024882;
    MilInstrumentationCheckHR_MaybeFailFast(v20, 0LL, 0, -2147024882, 0x304u, 0LL);
LABEL_18:
    if ( (a10 & 2) != 0 )
    {
      *v14 = 0;
  ...
  if ( v22 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v23, 0LL, 0, v22, 0x310u, 0LL);
    goto LABEL_18;
  }
  if ( (a10 & 2) != 0 && (*((_DWORD *)this + 30))++ == -1 )
    ++*((_DWORD *)this + 30);
