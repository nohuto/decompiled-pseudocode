/*
 * XREFs of ?ApplyInputToSpectreResource@CScenePbrMaterial@@IEAAXPEAUISpectreMaterial@@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVCSceneSurfaceMaterialInput@@@Z @ 0x1801EC1B0
 * Callers:
 ...
 *     ?ApplyMetallicRoughnessInputToSpectreResource@CSceneMetallicRoughnessMaterial@@AEAAXPEAUISpectreMaterial@@@Z @ 0x1801EBDF4 (-ApplyMetallicRoughnessInputToSpectreResource@CSceneMetallicRoughnessMaterial@@AEAAXPEAUISpectre.c)
...
__int64 __fastcall CScenePbrMaterial::ApplyInputToSpectreResource(__int64 a1, __int64 a2, __int128 *a3, __int64 a4)
{
  __int64 v4; // rsi
  __int64 v7; // r15
  __int64 v8; // rax
  ...
  if ( v10 >= 0x10 )
  {
    ...
    *(_QWORD *)&v15 = std::_Allocate<16,std::_Default_allocate_traits,0>(v13 + 1);
    memcpy_0((void *)v15, v9, v10 + 1);
    v17 = v13;
  }
  else
  {
  ...
  v16 = v10;
  v11(a2, &v15, v4, v7);
  return std::string::_Tidy_deallocate(a3);
}
