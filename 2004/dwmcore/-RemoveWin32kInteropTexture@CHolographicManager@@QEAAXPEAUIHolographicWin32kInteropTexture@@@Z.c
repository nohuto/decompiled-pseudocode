/*
 * XREFs of ?RemoveWin32kInteropTexture@CHolographicManager@@QEAAXPEAUIHolographicWin32kInteropTexture@@@Z @ 0x180252858
 * Callers:
 *     ?Remove@CHolographicFrameProcessor@@UEAAXXZ @ 0x18025B190 (-Remove@CHolographicFrameProcessor@@UEAAXXZ.c)
 * Callees:
