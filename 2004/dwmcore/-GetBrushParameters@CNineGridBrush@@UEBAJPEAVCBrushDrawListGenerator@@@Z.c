/*
 * XREFs of ?GetBrushParameters@CNineGridBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x180008C50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CNineGridBrush::GetBrushParameters(CNineGridBrush *this, struct CBrushDrawListGenerator *a2)
{
  ...
  v4 = -2147022876;
  if ( dword_180349320 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_180349320);
    if ( dword_180349320 == -1 )
    {
      dword_180343AE4 = -2147022876;
      Init_thread_footer(&dword_180349320);
    }
  }
  ...
  *((_QWORD *)&v37 + 1) = __PAIR64__(
           ...
           180LL) )
    {
      ...
      if ( v23 )
      {
        if ( !CComponentTransform2D::IsIdentity(v23) )
        {
          ...
          MilInstrumentationCheckHR_MaybeFailFast(v24, &dword_180343AE0, 2u, -2147022876, 0x284u, 0LL);
          goto LABEL_45;
        }
      }
    }
  ...
  if ( v10 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v11, &dword_180343AE0, 2u, v10, 0x289u, 0LL);
LABEL_45:
  ...
  else
  {
    ...
    *(_OWORD *)((char *)a2 + 20) = v25;
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v26, &dword_180343AE0, 2u, v4, 0x29Cu, 0LL);
      if ( v34[0] )
  ...
  *((_QWORD *)&v38 + 1) = 0LL;
  ...
  if ( v4 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast((unsigned int)v16, &dword_180343AE0, 2u, v4, 0x2CAu, 0LL);
    if ( v34[0] )
