/*
 * XREFs of ?Release@BamoImplObject@BamoImpl@Microsoft@@UEAAKXZ @ 0x1800D3250
 * Callers:
 ...
 *     ?Release@BufferingMessageCallHost@BamoImpl@Microsoft@@UEAAKXZ @ 0x1800D3240 (-Release@BufferingMessageCallHost@BamoImpl@Microsoft@@UEAAKXZ.c)
