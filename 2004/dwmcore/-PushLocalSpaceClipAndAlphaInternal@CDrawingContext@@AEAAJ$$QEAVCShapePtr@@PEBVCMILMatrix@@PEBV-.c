/*
 * XREFs of ?PushLocalSpaceClipAndAlphaInternal@CDrawingContext@@AEAAJ$$QEAVCShapePtr@@PEBVCMILMatrix@@PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAUNodeEffects@1@PEA_N@Z @ 0x18006B510
 * Callers:
        ...
        _BYTE *a6)
{
  ...
  if ( v14 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0xB7Du, 0LL);
    goto LABEL_123;
  }
  *((_QWORD *)&X + 1) = v13;
...
LABEL_120:
      MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v20, 0xB86u, 0LL);
      LOBYTE(v10) = 0;
LABEL_123:
      v23 = v106[0];
      goto LABEL_10;
...
LABEL_8:
  ...
  if ( v61 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v61, 0xB90u, 0LL);
    LOBYTE(v10) = v106[1];
    goto LABEL_123;
  }
  v23 = v106[0];
...
LABEL_24:
              ...
              if ( v37 != 2 )
              {
                ...
                if ( v37 == 1 )
                {
                  ...
                  *(float *)&lpMem = v62;
                  ...
                  if ( v64 < 0 )
                  {
                    MilInstrumentationCheckHR_MaybeFailFast(v65, 0LL, 0, v64, 0x10B0u, 0LL);
                  }
                  else
                  {
                    v66 = CWatermarkStack<enum MilBitmapInterpolationMode::Enum,64,2,10>::Push(
                            (unsigned int *)this + 808,
                            &lpMem);
                    v9 = v66;
                    if ( v66 < 0 )
                    {
                      MilInstrumentationCheckHR_MaybeFailFast(v67, 0LL, 0, v66, 0x10B4u, 0LL);
                      CWatermarkStack<CDrawingContext::StackStateEntry,64,2,10>::Pop((int *)this + 94, 0LL);
                    }
                  }
                  if ( v9 < 0 )
                    MilInstrumentationCheckHR_MaybeFailFast(v67, 0LL, 0, v9, 0x1094u, 0LL);
                }
                else if ( COERCE_FLOAT(COERCE_UNSIGNED_INT(v38 - 1.0) & _xmm) >= 0.0000011920929 )
                {
                  ...
                  v9 = v68;
                  if ( v68 < 0 )
                    MilInstrumentationCheckHR_MaybeFailFast(v69, 0LL, 0, v68, 0x109Cu, 0LL);
                }
            ...
            else
            {
              ...
              if ( v9 < 0 )
              {
                MilInstrumentationCheckHR_MaybeFailFast(v72, 0LL, 0, v9, 0x1060u, 0LL);
                goto LABEL_85;
              }
              v73 = *(float *)(a5 + 8);
            }
...
LABEL_81:
              ...
              v9 = v82;
              if ( v82 < 0 )
                MilInstrumentationCheckHR_MaybeFailFast(v83, 0LL, 0, v82, 0x1084u, 0LL);
              goto LABEL_85;
            }
            ...
            else
            {
              ...
              MilInstrumentationCheckHR_MaybeFailFast(v77, 0LL, 0, v76, 0x1075u, 0LL);
            }
LABEL_85:
            Microsoft::WRL::ComPtr<ID2D1Geometry>::InternalRelease(&lpMem);
            return (unsigned int)v9;
...
LABEL_47:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v21, 0LL, 0, v9, 0x1023u, 0LL);
  return (unsigned int)v9;
}
