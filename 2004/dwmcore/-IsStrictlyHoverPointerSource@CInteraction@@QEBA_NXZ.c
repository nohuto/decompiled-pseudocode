/*
 * XREFs of ?IsStrictlyHoverPointerSource@CInteraction@@QEBA_NXZ @ 0x180232DD0
 * Callers:
 ...
 * Callees:
 *     ?SupportsAnyPointerType@CInteractionProcessor@@QEBAHXZ @ 0x18022DDCC (-SupportsAnyPointerType@CInteractionProcessor@@QEBAHXZ.c)
 */
