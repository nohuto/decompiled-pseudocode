/*
 * XREFs of ?SetMinScale@CInteractionTracker@@AEAAXM@Z @ 0x1801CD5C0
 * Callers:
 *     ?ProcessSetMinScale@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACKER_SETMINSCALE@@@Z @ 0x1801CBFE4 (-ProcessSetMinScale@CInteractionTracker@@QEAAJPEAVCResourceTable@@PEBUtagMILCMD_INTERACTIONTRACK.c)
 ...
 *     ?EnsureScaleIsGreaterThanOrEqualToMin@CInteractionTracker@@AEAAXXZ @ 0x1801CAA18 (-EnsureScaleIsGreaterThanOrEqualToMin@CInteractionTracker@@AEAAXXZ.c)
 *     ?SetMaxScale@CInteractionTracker@@AEAAXM@Z @ 0x1801CD400 (-SetMaxScale@CInteractionTracker@@AEAAXM@Z.c)
 */
...
void __fastcall CInteractionTracker::SetMinScale(CInteractionTracker *this, float a2)
{
  ...
  if ( *((float *)this + 33) != a2 )
  {
    *((float *)this + 33) = a2;
    ...
    CInteractionTracker::SetMaxScale(this, fmaxf(*((float *)this + 33), *((float *)this + 34)));
