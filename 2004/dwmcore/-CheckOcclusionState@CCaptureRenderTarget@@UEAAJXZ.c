/*
 * XREFs of ?CheckOcclusionState@CCaptureRenderTarget@@UEAAJXZ @ 0x1800E7BDC
 * Callers:
 *     ?CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@A@EAAJXZ @ 0x1800EF230 (-CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@A@EAAJXZ.c)
 *     ?CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@EI@EAAJXZ @ 0x1800EF240 (-CheckOcclusionState@CCaptureRenderTarget@@$4PPPPPPPM@EI@EAAJXZ.c)
 * Callees:
