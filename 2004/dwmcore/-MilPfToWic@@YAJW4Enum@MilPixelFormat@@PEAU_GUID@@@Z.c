/*
 * XREFs of ?MilPfToWic@@YAJW4Enum@MilPixelFormat@@PEAU_GUID@@@Z @ 0x180217548
 * Callers:
 *     ?GetPixelFormat@CBitmap@@UEAAJPEAU_GUID@@@Z @ 0x180216E90 (-GetPixelFormat@CBitmap@@UEAAJPEAU_GUID@@@Z.c)
