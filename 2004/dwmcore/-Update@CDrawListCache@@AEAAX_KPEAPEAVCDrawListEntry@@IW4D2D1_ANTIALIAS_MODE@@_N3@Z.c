/*
 * XREFs of ?Update@CDrawListCache@@AEAAX_KPEAPEAVCDrawListEntry@@IW4D2D1_ANTIALIAS_MODE@@_N3@Z @ 0x180056A04
 * Callers:
...
LABEL_8:
  ...
  if ( (*(_DWORD *)v12 & 3u) > 1 && (*(_DWORD *)v12 & 3u) - 2 >= 2 )
    ModuleFailFastForHRESULT(2147549183LL, retaddr);
  *((_DWORD *)v11 + 24) = a5;
  *((_BYTE *)v11 + 100) = a6;
  *((_BYTE *)v11 + 101) = a7;
    ...
    *((_DWORD *)v11 + 22) = 0;
    do
    {
      ...
      *((_DWORD *)v11 + 23) &= v21;
      ...
      TMilRect<float,MilRectF,Mil3DRectF,RectUniqueness::NotNeeded>::UnionUnsafe(&v28, &v27);
      v7 += 8LL;
      --v9;
    }
    while ( v9 );
