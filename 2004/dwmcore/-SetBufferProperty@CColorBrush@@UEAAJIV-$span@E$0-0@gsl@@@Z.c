/*
 * XREFs of ?SetBufferProperty@CColorBrush@@UEAAJIV?$span@E$0?0@gsl@@@Z @ 0x1801ACD40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  v4 = ((__int64 (__fastcall *)(__int64, void *, _QWORD))xmmword_180343798)(
         a1 + SDWORD2(xmmword_180343798),
