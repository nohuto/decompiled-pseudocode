/*
 * XREFs of ?GetSwapChainSize@CSurfaceBrush@@AEBAJPEAVISwapChainRealization@@PEAUD2D_SIZE_F@@PEAUD2D_RECT_F@@PEAUD2D_MATRIX_3X2_F@@@Z @ 0x1801EF84C
 * Callers:
        ...
        struct D2D_MATRIX_3X2_F *a5)
{
  ...
  {
    v7 = -2003304441;
    MilInstrumentationCheckHR_MaybeFailFast(v10, &dword_180302B70, 2u, -2003304441, 0x375u, 0LL);
  }
  else
  {
    a3->width = v20;
