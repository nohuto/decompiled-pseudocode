/*
 * XREFs of ?GetBrushParameters@CMaskBrush@@UEBAJPEAVCBrushDrawListGenerator@@@Z @ 0x180048940
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMaskBrush::GetBrushParameters(CMaskBrush *this, struct CBrushDrawListGenerator *a2)
{
  ...
  v4 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))(**((_QWORD **)this + 11) + 320LL))(*((_QWORD *)this + 11), v19);
  v6 = v4;
  if ( v4 < 0 )
  {
  ...
  *(_OWORD *)((char *)a2 + 20) = v7;
  ...
  CBrushDrawListGenerator::CBrushDrawListGenerator(
    ...
    *(struct CDrawingContext **)a2,
    (const struct D2D_SIZE_F *)a2 + 1);
  v12 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))(**((_QWORD **)this + 10) + 320LL))(*((_QWORD *)this + 10), v19);
  v6 = v12;
  if ( v12 < 0 )
  {
