/*
 * XREFs of ?RenderImage@CWindowNode@@AEAAJPEAVCDrawingContext@@PEAVCWindowOcclusionInfo@@PEAVIBitmapResource@@PEBVCShape@@PEAU_MARGINS@@H@Z @ 0x1800EA3A0
 * Callers:
        ...
        int a7)
{
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x680u, 0LL);
LABEL_92:
    if ( v52 )
  ...
  {
    MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, EffectiveBounds, 0x685u, 0LL);
    return (unsigned int)v13;
  }
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR_MaybeFailFast(v17, 0LL, 0, v16, 0x689u, 0LL);
    return (unsigned int)v13;
  }
      ...
      if ( a5 )
      {
        if ( v55 )
        {
          ...
          *(_QWORD *)&v58.left = &v54;
          ...
          if ( v13 < 0 )
          {
            MilInstrumentationCheckHR_MaybeFailFast(v28, 0LL, 0, v13, 0x6CAu, 0LL);
          }
          else
          {
            *(_QWORD *)&v58.right = 0LL;
            *(_QWORD *)&v58.left = &v53;
            ...
            MilInstrumentationCheckHR_MaybeFailFast(v29, 0LL, 0, v13, 0x6CFu, 0LL);
          }
          std::unique_ptr<CShape>::~unique_ptr<CShape>((__int64 (__fastcall ****)(_QWORD, __int64))&v54);
          goto LABEL_17;
        }
...
LABEL_52:
          if ( !TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::IsEmpty(&v61)
            && !CDrawingContext::IsOccluded((__int64)a2, (__int64)&v61, a7) )
          {
            v54 = 0LL;
...
LABEL_72:
          ...
          if ( TMilRect<int,tagRECT,MilPointAndSizeL,RectUniqueness::_CMilRectL_>::IsEmpty(&v58)
            || CDrawingContext::IsOccluded((__int64)a2, (__int64)&v58, a7) )
          {
            goto LABEL_85;
          }
          v54 = 0LL;
...
LABEL_17:
      ...
      if ( v40 < 0 )
      {
        MilInstrumentationCheckHR_MaybeFailFast(v41, 0LL, 0, v40, 0x6EEu, 0LL);
      }
      else
      {
          ...
          && (unsigned int)CCompositionSurfaceBitmap::GetSizePreference(v42) == 1 )
        {
          ...
          v13 = v46;
          if ( v46 < 0 )
            MilInstrumentationCheckHR_MaybeFailFast(v47, 0LL, 0, v46, 0x6F5u, 0LL);
        }
      }
      goto LABEL_85;
    }
