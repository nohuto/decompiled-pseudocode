/*
 * XREFs of ?StepIterator@CRgnData@Internal@FastRegion@@QEBAXPEAVIterator@CRegion@3@@Z @ 0x1800C0B90
 * Callers:
 ...
 *     ?CopyFrontToBackBuffer@CLegacyStereoSwapChain@@UEAAJXZ @ 0x18024BCAC (-CopyFrontToBackBuffer@CLegacyStereoSwapChain@@UEAAJXZ.c)
