/*
 * XREFs of ?DirtyRenderingRealization@CGlobalCompositionSurfaceInfo@@IEAA_N_NPEAUHRGN__@@PEBUScrollOptimization@@PEAVCRegion@@@Z @ 0x180045200
 * Callers:
...
LABEL_23:
  ...
  if ( a3 )
  {
    ...
    v9 = 1;
    CRegion::GetBoundingRect(a5, (struct MilRectU *)&v28);
