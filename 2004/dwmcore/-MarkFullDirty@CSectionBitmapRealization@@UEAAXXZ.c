/*
 * XREFs of ?MarkFullDirty@CSectionBitmapRealization@@UEAAXXZ @ 0x180265454
 * Callers:
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXXZ @ 0x1800F2D70 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@A@EAAXXZ.c)
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXXZ @ 0x1800F2D80 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@CA@EAAXXZ.c)
 *     ?MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@EA@EAAXXZ @ 0x1800F2F60 (-MarkFullDirty@CSectionBitmapRealization@@$4PPPPPPPM@EA@EAAXXZ.c)
 * Callees:
