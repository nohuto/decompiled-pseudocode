/*
 * XREFs of ?CompactSingleAtlas@CAtlasManager@@AEAAJPEA_N@Z @ 0x18024A1E0
 * Callers:
 ...
 *     ?PurgeAndNotify@CAtlasTexture@@QEAAXXZ @ 0x18024ABFC (-PurgeAndNotify@CAtlasTexture@@QEAAXXZ.c)
 */
