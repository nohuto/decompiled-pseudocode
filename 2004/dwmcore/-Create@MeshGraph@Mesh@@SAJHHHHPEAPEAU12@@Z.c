/*
 * XREFs of ?Create@MeshGraph@Mesh@@SAJHHHHPEAPEAU12@@Z @ 0x18009AE00
 * Callers:
 ...
 *     ??0MeshLine@Mesh@@QEAA@XZ @ 0x1800DE174 (--0MeshLine@Mesh@@QEAA@XZ.c)
 *     ??0MeshVertex@Mesh@@QEAA@XZ @ 0x1800DE18C (--0MeshVertex@Mesh@@QEAA@XZ.c)
