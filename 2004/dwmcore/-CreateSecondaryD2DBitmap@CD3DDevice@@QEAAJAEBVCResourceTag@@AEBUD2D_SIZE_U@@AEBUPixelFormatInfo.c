/*
 * XREFs of ?CreateSecondaryD2DBitmap@CD3DDevice@@QEAAJAEBVCResourceTag@@AEBUD2D_SIZE_U@@AEBUPixelFormatInfo@@PEAPEAVCSecondaryD2DBitmap@@@Z @ 0x180093394
 * Callers:
 ...
 *     ?GetCompatibleTextureFormat@CD3DDevice@@QEBA?AW4DXGI_FORMAT@@W42@@Z @ 0x1800939D0 (-GetCompatibleTextureFormat@CD3DDevice@@QEBA-AW4DXGI_FORMAT@@W42@@Z.c)
...
LABEL_16:
    v24 = v20;
LABEL_20:
    MilInstrumentationCheckHR_MaybeFailFast((__int64)this, &dword_1802AB078, 2u, v24, v25, 0LL);
  }
  v21 = CD3DDevice::TranslateDXGIorD3DErrorInContext((__int64)this, v9, 0);
