/*
 * XREFs of ?CreateRenderingResources@CDrawListBatchManager@@IEAAJXZ @ 0x1800B1FA0
 * Callers:
 ...
 *     ??0CBatchOptimizer@@QEAA@PEAVCDrawListBatchManager@@@Z @ 0x1800AF694 (--0CBatchOptimizer@@QEAA@PEAVCDrawListBatchManager@@@Z.c)
