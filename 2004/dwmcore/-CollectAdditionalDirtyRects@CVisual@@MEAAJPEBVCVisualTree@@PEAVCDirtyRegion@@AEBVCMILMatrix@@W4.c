/*
 * XREFs of ?CollectAdditionalDirtyRects@CVisual@@MEAAJPEBVCVisualTree@@PEAVCDirtyRegion@@AEBVCMILMatrix@@W4Enum@MilBitmapInterpolationMode@@PEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800A3110
 * Callers:
 ...
 *     ?GetAdditionalDirtyRects@CVisual@@QEBAPEAVCMergedDirtyRect@@XZ @ 0x1800A3410 (-GetAdditionalDirtyRects@CVisual@@QEBAPEAVCMergedDirtyRect@@XZ.c)
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(struct CMergedDirtyRect *))(*(_QWORD *)AdditionalDirtyRects + 32LL))(AdditionalDirtyRects) )
    {
      ...
      if ( v27 )
      {
        while ( 1 )
        {
          ...
          CMILMatrix::Transform2DBoundsHelper<1>(a4, (float *)&v30, (float *)&v29);
          v13 = *((float *)&v29 + 2);
          v14 = *(float *)&v29;
          if ( *((float *)&v29 + 2) > *(float *)&v29 )
          {
            ...
            if ( *((float *)&v29 + 3) > *((float *)&v29 + 1) )
            {
              ...
              if ( v18
                ...
                && (*(unsigned __int8 (__fastcall **)(_QWORD))(**((_QWORD **)a1 + 31) + 304LL))(*((_QWORD *)a1 + 31)) )
              {
                v17 = v17 + 0.5;
              }
              if ( v17 != 0.0 )
