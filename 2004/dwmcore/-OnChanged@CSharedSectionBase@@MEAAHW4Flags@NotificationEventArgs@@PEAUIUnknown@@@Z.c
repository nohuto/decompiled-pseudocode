/*
 * XREFs of ?OnChanged@CSharedSectionBase@@MEAAHW4Flags@NotificationEventArgs@@PEAUIUnknown@@@Z @ 0x1800D4C90
 * Callers:
 *     <none>
 * Callees:
 *     ?UnmapSharedMemory@CSharedSectionBase@@IEBAXXZ @ 0x1800D4510 (-UnmapSharedMemory@CSharedSectionBase@@IEBAXXZ.c)
 *     ?MapSharedMemory@CSharedSectionBase@@KAPEAXPEAX_K@Z @ 0x1800D4CDC (-MapSharedMemory@CSharedSectionBase@@KAPEAXPEAX_K@Z.c)
 */
