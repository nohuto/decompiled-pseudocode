/*
 * XREFs of ?Transform@?$CGeneral3DOperator@U?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@VertexTransfer@@QEAAXAEBU?$Vertex_UVxN@UVertexXYW_ColorDW@@@@AEBUVertexAAFixup_UVxN@@IAEBVCMILMatrix@@PEAU?$Vertex_UVxN@UVertexXYW_ColorDW_WorldXYZ_Tangent@@@@@Z @ 0x18001277C
 * Callers:
  ...
  *((float *)a6 + 2) = v21;
  ...
  if ( (_BYTE)result )
  {
    ...
    if ( (_DWORD)v8 )
    {
      ...
      do
      {
        v27 = (float)(v24 * *(float *)((char *)result + v25)) + (float)(v19 * *result);
        *(float *)((char *)result + v23 + 28) = (float)(v24 * *(float *)((char *)result + v25 - 4))
                                              + (float)(v19 * *(result - 1));
        *(float *)((char *)result + v23 + 32) = v27;
        result += 2;
        --v26;
      }
      while ( v26 );
  ...
  else if ( (_DWORD)v8 )
  {
    ...
    do
    {
      v32 = (float)(v29 * *(float *)((char *)result + v30)) + (float)(v19 * *result);
      *(float *)((char *)result + v28 + 28) = (float)(v29 * *(float *)((char *)result + v30 - 4))
                                            + (float)(v19 * *(result - 1));
      *(float *)((char *)result + v28 + 32) = v32;
      result += 2;
      --v31;
    }
    while ( v31 );
