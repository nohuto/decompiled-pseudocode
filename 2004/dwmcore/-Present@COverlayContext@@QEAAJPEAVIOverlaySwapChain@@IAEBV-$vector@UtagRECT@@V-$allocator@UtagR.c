/*
 * XREFs of ?Present@COverlayContext@@QEAAJPEAVIOverlaySwapChain@@IAEBV?$vector@UtagRECT@@V?$allocator@UtagRECT@@@std@@@std@@I_N@Z @ 0x1800E6210
 * Callers:
 ...
 *     ?LegacyPresentRequired@COverlayContext@@AEBA_NXZ @ 0x180032E44 (-LegacyPresentRequired@COverlayContext@@AEBA_NXZ.c)
        ...
        char a6)
{
  ...
  if ( v6 )
  {
    ...
    v13 = v17;
    if ( v17 >= 0 || (MilInstrumentationCheckHR_MaybeFailFast(v18, 0LL, 0, v17, 0x989u, 0LL), v13 == -2003304309) )
    {
      *((_BYTE *)this + 11423) = 1;
    }
    else
  ...
  else
  {
    *((_BYTE *)this + 11423) = 0;
    if ( a6 || COverlayContext::LegacyPresentRequired(this) )
    {
      ...
      {
        MilInstrumentationCheckHR_MaybeFailFast(v15, 0LL, 0, v14, 0x972u, 0LL);
      }
    }
    else
    {
      ...
      v13 = v11;
      if ( v11 < 0 )
        MilInstrumentationCheckHR_MaybeFailFast(v12, 0LL, 0, v11, 0x968u, 0LL);
    }
  }
  return v13;
}
