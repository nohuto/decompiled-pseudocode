/*
 * XREFs of ?Initialize@CComputeScribbleScheduler@@AEAAJPEAUIDXGIOutputDWM@@PEAUIDCompositionDirectInkCommunicationPartner@@@Z @ 0x1801A5EB4
 * Callers:
 ...
 *     CalculateDisplayBlankTime @ 0x1801A5718 (CalculateDisplayBlankTime.c)
