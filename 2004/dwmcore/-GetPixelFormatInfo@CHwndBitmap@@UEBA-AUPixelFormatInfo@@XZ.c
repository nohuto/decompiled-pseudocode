/*
 * XREFs of ?GetPixelFormatInfo@CHwndBitmap@@UEBA?AUPixelFormatInfo@@XZ @ 0x1801C5BC0
 * Callers:
 *     ?IsOpaque@CHwndBitmap@@UEBA_NXZ @ 0x1801C5DF0 (-IsOpaque@CHwndBitmap@@UEBA_NXZ.c)
 * Callees:
