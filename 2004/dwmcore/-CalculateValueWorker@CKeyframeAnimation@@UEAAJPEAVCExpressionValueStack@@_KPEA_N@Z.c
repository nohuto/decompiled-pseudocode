/*
 * XREFs of ?CalculateValueWorker@CKeyframeAnimation@@UEAAJPEAVCExpressionValueStack@@_KPEA_N@Z @ 0x18008A980
 * Callers:
 ...
 * Callees:
 *     ?Pause@CKeyframeAnimation@@AEAAXXZ @ 0x18001B43C (-Pause@CKeyframeAnimation@@AEAAXXZ.c)
