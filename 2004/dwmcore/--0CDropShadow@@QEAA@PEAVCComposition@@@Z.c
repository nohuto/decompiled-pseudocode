/*
 * XREFs of ??0CDropShadow@@QEAA@PEAVCComposition@@@Z @ 0x1800DD46C
 * Callers:
...
CDropShadow *__fastcall CDropShadow::CDropShadow(CDropShadow *this, struct CComposition *a2, int a3)
{
  ...
  *((_BYTE *)this + 72) = 0;
  v7 = 0;
  *(_QWORD *)((char *)this + *(int *)(v4 + 4) + 56) = &CSystemMemoryBitmap::`vftable'{for `IUnknown'};
