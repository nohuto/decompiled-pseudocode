/*
 * XREFs of ??0CCachedBitmap@CD2DBitmapCache@@QEAA@PEAVIDeviceResourceNotify@@PEAVCSecondaryD2DBitmap@@@Z @ 0x180093330
 * Callers:
        ...
        struct CSecondaryD2DBitmap *a3)
{
  ...
  *((_QWORD *)this + 1) = a3;
  ...
  if ( *((_QWORD **)a3 + 9) == v5 )
  {
    std::vector<ShaderLinkingBody const *>::_Emplace_reallocate<ShaderLinkingBody const *>((__int64 *)a3 + 7, v5, &v7);
  }
  else
  {
    *v5 = a2;
