/*
 * XREFs of ?RemoveSourceEntry@DataProviderProxy@@QEAAJPEAVBamoDataSourceProxy@@@Z @ 0x1801830F8
 * Callers:
 *     ?OnDisconnected@DataSourceProxy@@MEAAJXZ @ 0x180181C70 (-OnDisconnected@DataSourceProxy@@MEAAJXZ.c)
