/*
 * XREFs of ?DwmHolographicCompositionAdd_@CompositorTracing@@QEAAXXZ @ 0x1802512C8
 * Callers:
...
void __fastcall CompositorTracing::DwmHolographicCompositionAdd_(CompositorTracing *this)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer(v1, (unsigned __int8 *)dword_1802EB261, 0LL, 0LL, 2u, &v2);
  }
}
