/*
 * XREFs of ?SendUpdateToRenderThread@CManipulationTelemetryData@@UEAAJXZ @ 0x180230C20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CManipulationTelemetryData::SendUpdateToRenderThread(CManipulationTelemetryData *this)
{
  ...
  *(_QWORD *)&v28 = 0LL;
  ...
  if ( v11 )
  {
    ...
    v33 = this;
    v34 = v11;
    ManipulationManager = CoreUICallSend(v31, &v34, 1LL, 11LL, 0, &unk_1802CCE3A);
    v9 = ManipulationManager;
    if ( ManipulationManager >= 0 )
    {
