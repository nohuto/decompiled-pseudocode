/*
 * XREFs of ?StartInertiaWorker@CInteractionTrackerPositionAnimation@@MEAAXM_N@Z @ 0x180204E30
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetInertiaDecayRate@CInteractionTracker@@QEBAMW4ScrollAxis@@@Z @ 0x1801CAD00 (-GetInertiaDecayRate@CInteractionTracker@@QEBAMW4ScrollAxis@@@Z.c)
 ...
 *     ?StartInertia@CPositionMotion@@QEAAXMMMMMM_N0@Z @ 0x18020E714 (-StartInertia@CPositionMotion@@QEAAXMMMMMM_N0@Z.c)
        ...
        bool a3)
{
  ...
  v7 = (CMotion *)(*(__int64 (__fastcall **)(CInteractionTrackerPositionAnimation *))(*(_QWORD *)this + 320LL))(this);
