/*
 * XREFs of ?HaveOverlayCandidatesChanged@COverlayContext@@AEAA_NXZ @ 0x180059758
 * Callers:
 ...
 *     ?IsEqualTo@CRgnData@Internal@FastRegion@@QEBA_NAEBV123@@Z @ 0x18017DCFC (-IsEqualTo@CRgnData@Internal@FastRegion@@QEBA_NAEBV123@@Z.c)
 */
...
char __fastcall COverlayContext::HaveOverlayCandidatesChanged(COverlayContext *this)
{
  ...
  for ( i = 0; i < (unsigned int)((*((_QWORD *)this + 13) - v4) / 224); ++i )
  {
    ...
    if ( *(_QWORD *)(v7 + v4 + 16) != *(_QWORD *)(v7 + v3 + 16)
      ...
      || (unsigned __int8)operator!=(v7 + v4 + 144, v7 + v3 + 144, v8) )
    {
      return 1;
    }
    v9 = **(FastRegion::Internal::CRgnData ***)(v7 + v4 + 160);
    v10 = **(const struct FastRegion::Internal::CRgnData ***)(v7 + v3 + 160);
    if ( *(_DWORD *)v9 )
    {
      if ( !*(_DWORD *)v10 )
        return 1;
