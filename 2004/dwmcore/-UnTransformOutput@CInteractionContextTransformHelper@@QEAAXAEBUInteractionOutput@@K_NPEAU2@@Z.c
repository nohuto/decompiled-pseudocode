/*
 * XREFs of ?UnTransformOutput@CInteractionContextTransformHelper@@QEAAXAEBUInteractionOutput@@K_NPEAU2@@Z @ 0x180269D30
 * Callers:
 ...
 *     TransformTranslateDelta @ 0x180269CA8 (TransformTranslateDelta.c)
 */
