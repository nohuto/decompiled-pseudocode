/*
 * XREFs of ?LogAnimationEnded@CAnimationLoggingManager@@QEAAX_KPEAVCResource@@IIW4AnimationEndedReasonType@@@Z @ 0x1801B1A64
 * Callers:
        ...
        int a6)
{
  ...
  {
    v14 = qword_180342F08 & 1;
    if ( v14 == qword_180342F08 )
    {
