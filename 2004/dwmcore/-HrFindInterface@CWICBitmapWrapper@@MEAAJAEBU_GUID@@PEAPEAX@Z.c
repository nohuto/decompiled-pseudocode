/*
 * XREFs of ?HrFindInterface@CWICBitmapWrapper@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800CFBE0
 * Callers:
 *     <none>
 * Callees:
 *     ?HrFindInterface@CBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180099820 (-HrFindInterface@CBitmap@@MEAAJAEBU_GUID@@PEAPEAX@Z.c)
...
__int64 __fastcall CWICBitmapWrapper::HrFindInterface(CWICBitmapWrapper *this, const struct _GUID *a2, void **a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( v6 )
    {
      ...
      {
        v11 = 0LL;
        v9 = (int (__fastcall ***)(_QWORD, GUID *, __int64 *))*((_QWORD *)this + 32);
    ...
    {
      *a3 = (void *)(((unsigned __int64)this + 232) & -(__int64)(this != 0LL));
      return 0;
    }
  }
  return v5;
