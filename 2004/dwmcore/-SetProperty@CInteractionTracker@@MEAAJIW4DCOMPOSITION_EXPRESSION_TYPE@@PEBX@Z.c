/*
 * XREFs of ?SetProperty@CInteractionTracker@@MEAAJIW4DCOMPOSITION_EXPRESSION_TYPE@@PEBX@Z @ 0x1801CD7E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?SetPositionInertiaDecayRate@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z @ 0x1801CD71C (-SetPositionInertiaDecayRate@CInteractionTracker@@AEAAXAEBUD2DVector3@@@Z.c)
 ...
 *     ?SetScaleInertiaDecayRate@CInteractionTracker@@AEAAXM@Z @ 0x1801CDD18 (-SetScaleInertiaDecayRate@CInteractionTracker@@AEAAXM@Z.c)
...
LABEL_29:
  ...
  {
    v20 = -2147024809;
    MilInstrumentationCheckHR_MaybeFailFast(v16, 0LL, 0, -2147024809, 0x58Au, 0LL);
  }
  else
  {
    return 0;
