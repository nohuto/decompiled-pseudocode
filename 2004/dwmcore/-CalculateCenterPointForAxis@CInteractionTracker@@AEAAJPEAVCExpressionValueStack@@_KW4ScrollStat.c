/*
 * XREFs of ?CalculateCenterPointForAxis@CInteractionTracker@@AEAAJPEAVCExpressionValueStack@@_KW4ScrollState@@W4ScrollAxis@@PEAM@Z @ 0x1801C96EC
 * Callers:
 ...
 *     ?WasInertiaStartedByImpulse@CInteractionTracker@@QEBA_NW4ScrollAxis@@@Z @ 0x1801CEAD0 (-WasInertiaStartedByImpulse@CInteractionTracker@@QEBA_NW4ScrollAxis@@@Z.c)
...
LABEL_24:
  ...
  MilInstrumentationCheckHR_MaybeFailFast(v14, 0LL, 0, v13, 0x1724u, 0LL);
  return v15;
}
