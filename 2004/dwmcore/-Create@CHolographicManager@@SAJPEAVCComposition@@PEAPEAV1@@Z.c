/*
 * XREFs of ?Create@CHolographicManager@@SAJPEAVCComposition@@PEAPEAV1@@Z @ 0x18002C55C
 * Callers:
 *     ?Initialize@CComposition@@MEAAJXZ @ 0x18002A690 (-Initialize@CComposition@@MEAAJXZ.c)
 * Callees:
 *     ??0CHolographicManager@@AEAA@PEAVCComposition@@@Z @ 0x18002C5FC (--0CHolographicManager@@AEAA@PEAVCComposition@@@Z.c)
