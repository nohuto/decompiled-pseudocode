/*
 * XREFs of ?CreateHdrMetadata@CDDisplayManager@@QEAAJW4DXGI_HDR_METADATA_TYPE@@PEBXPEAPEAUIDisplayHdrMetadata@Core@Display@Devices@Windows@@@Z @ 0x180241EF8
 * Callers:
        ...
        struct Windows::Devices::Display::Core::IDisplayHdrMetadata **a4)
{
  ...
  if ( !v7 )
  {
    ...
    v13 = *(_OWORD *)a3;
    v14 = v8;
    v9 = *(__int64 (__fastcall **)(__int64, __int128 *, struct Windows::Devices::Display::Core::IDisplayHdrMetadata **))(*(_QWORD *)qword_1803495D8 + 56LL);
    v15 = *((_DWORD *)a3 + 6);
    v10 = v9(qword_1803495D8, &v13, &v16);
    v5 = v10;
    if ( v10 < 0 )
    {
