/*
 * XREFs of EmitterShapes::GetPointOnLine @ 0x1802083F4
 * Callers:
 *     ?GetPointOnEdge@Figure@CPathEmitterEdge@EmitterShapes@@QEBA?AUfloat2@Numerics@Foundation@Windows@@MM@Z @ 0x180208328 (-GetPointOnEdge@Figure@CPathEmitterEdge@EmitterShapes@@QEBA-AUfloat2@Numerics@Foundation@Windows.c)
 * Callees:
