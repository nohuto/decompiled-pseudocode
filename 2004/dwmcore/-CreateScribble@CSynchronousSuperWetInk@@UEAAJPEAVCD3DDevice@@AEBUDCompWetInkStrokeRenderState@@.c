/*
 * XREFs of ?CreateScribble@CSynchronousSuperWetInk@@UEAAJPEAVCD3DDevice@@AEBUDCompWetInkStrokeRenderState@@PEAPEAVCComputeScribble@@@Z @ 0x1801F0840
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( v8 >= 0 )
      {
        ...
        *a4 = v17;
        if ( *((_BYTE *)v11 + 12) )
        {
          if ( !*((_BYTE *)this + 136) )
          {
            if ( (unsigned int)dword_180342E48 > 4
              && (qword_180342E58 & 8) != 0
              && (qword_180342E60 & 8) == qword_180342E60 )
            {
              v36 = 0;
              v34 = &v23;
              v23 = (char *)this - 112;
              ...
              tlgWriteTransfer_EventWriteTransfer(
                ...
                (unsigned __int8 *)dword_1802E7BFB,
                0LL,
                0LL,
                3u,
                &v33);
            ...
            && (qword_180342E60 & 8) == qword_180342E60 )
          {
            ...
            tlgWriteTransfer_EventWriteTransfer(
              (__int64)&dword_180342E48,
              (unsigned __int8 *)dword_1802E7C44,
              0LL,
              0LL,
              3u,
              &v33);
