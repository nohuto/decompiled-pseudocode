/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD2DGenericInk@@VCGenericInk@@@@QEAAJPEAVCD3DDevice@@PEAPEAVCD2DGenericInk@@@Z @ 0x1801C4174
 * Callers:
...
LABEL_17:
  v22 = v28;
  v29 = (CD3DDevice *)a1;
  v23 = (__int64 *)((char *)v28 + 56);
  v24 = (__int64 **)*((_QWORD *)v28 + 8);
  if ( *((__int64 ***)v28 + 9) == v24 )
  {
