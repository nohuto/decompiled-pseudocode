/*
 * XREFs of ?DeviceRectToPageInPixelsRect@COcclusionContext@@AEBA_NAEBV?$TMilRect_@MUMilRectF@@UMil3DRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x180184CBC
 * Callers:
...
bool __fastcall COcclusionContext::DeviceRectToPageInPixelsRect(__int64 a1, _OWORD *a2, float *a3)
{
  bool v3; // zf
  ...
  {
    CMILMatrix::Transform2DBoundsHelper<0>((CMILMatrix *)(a1 + 1316), (__int64)a2, (float *)&v6);
    *(_OWORD *)a3 = v6;
  }
