/*
 * XREFs of ?_Tidy@?$vector@MV?$allocator@M@std@@@std@@AEAAXXZ @ 0x180175754
 * Callers:
 ...
 *     ??1ParticleCollection@CParticleEmitterVisual@@QEAA@XZ @ 0x1801DFAA8 (--1ParticleCollection@CParticleEmitterVisual@@QEAA@XZ.c)
