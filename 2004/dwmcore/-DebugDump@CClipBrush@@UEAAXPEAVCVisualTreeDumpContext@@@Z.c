/*
 * XREFs of ?DebugDump@CClipBrush@@UEAAXPEAVCVisualTreeDumpContext@@@Z @ 0x1801B90D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CClipBrush::DebugDump(CClipBrush *this, void **a2)
{
  _QWORD *v4; // rdx
  __int64 v5; // rbx
  ...
  std::string::string(v6, (__int64)"CClipBrush");
  if ( a2 != v6 )
  {
    v4 = v6;
    if ( v6[3] >= 0x10uLL )
