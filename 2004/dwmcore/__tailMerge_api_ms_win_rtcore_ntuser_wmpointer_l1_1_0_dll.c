/*
 * XREFs of __tailMerge_api_ms_win_rtcore_ntuser_wmpointer_l1_1_0_dll @ 0x1800E4949
 * Callers:
 *     __imp_load_GetPointerDeviceRects @ 0x1800E493D (__imp_load_GetPointerDeviceRects.c)
 * Callees:
