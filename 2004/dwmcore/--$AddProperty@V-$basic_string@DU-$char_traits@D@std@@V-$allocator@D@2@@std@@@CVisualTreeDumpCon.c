/*
 * XREFs of ??$AddProperty@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@CVisualTreeDumpContext@@QEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@V12@@Z @ 0x180197824
 * Callers:
...
__int64 __fastcall CVisualTreeDumpContext::AddProperty<std::string>(__int64 a1, _QWORD *a2, size_t *a3)
{
  const void *v6; // rdx
  __int64 *v7; // r15
  ...
  if ( v8 >= 0x10 )
  {
    ...
    *(_QWORD *)&v18 = std::_Allocate<16,std::_Default_allocate_traits,0>(v10 + 1);
    memcpy_0((void *)v18, a2, v8 + 1);
    v20 = v10;
  }
  else
  {
  ...
  if ( si128.m128i_i64[0] >= 0x10uLL )
  {
    ...
    *(_QWORD *)&v21 = std::_Allocate<16,std::_Default_allocate_traits,0>(v14 + 1);
    memcpy_0((void *)v21, v11, v12 + 1);
    v23 = v14;
  }
  else
  {
  ...
  v22 = v12;
  std::vector<CTreeDumpNodeData::Property>::emplace_back<CTreeDumpNodeData::Property>(v7, (__int64)&v18);
