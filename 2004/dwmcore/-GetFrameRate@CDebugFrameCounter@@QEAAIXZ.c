/*
 * XREFs of ?GetFrameRate@CDebugFrameCounter@@QEAAIXZ @ 0x18016469C
 * Callers:
 ...
 * Callees:
 *     ?GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ @ 0x180164668 (-GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ.c)
 */
