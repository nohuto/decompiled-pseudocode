/*
 * XREFs of ??$AddLinkInternal@VCBrush@@@CVisualTreeDumpContext@@AEAAXAEBV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PEAVCBrush@@_N@Z @ 0x1801B8888
 * Callers:
...
__int64 __fastcall CVisualTreeDumpContext::AddLinkInternal<CBrush>(__int64 *a1, __int64 a2, __int64 a3)
{
  ...
  if ( a3 )
    return CDebugTreeDumper::RegisterNodeForVisit<CBrush>(a1[14], a3);
  return result;
}
