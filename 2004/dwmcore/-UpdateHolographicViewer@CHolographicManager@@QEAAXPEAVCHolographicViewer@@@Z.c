/*
 * XREFs of ?UpdateHolographicViewer@CHolographicManager@@QEAAXPEAVCHolographicViewer@@@Z @ 0x1802529D4
 * Callers:
 ...
 *     ?DwmHolographicViewerUpdate_@CompositorTracing@@QEAAXI@Z @ 0x18025192C (-DwmHolographicViewerUpdate_@CompositorTracing@@QEAAXI@Z.c)
