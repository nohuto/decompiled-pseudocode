/*
 * XREFs of ?UpdateActivatableEntityListRemoteCache@BamoActivationWatcherPrincipalImpl@BamoImpl@@AEAAXPEAVBamoStubImpl@2Microsoft@@@Z @ 0x18001D400
 * Callers:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 32LL) + 56LL) )
  {
    ...
    v13[0] = v8;
    v13[1] = v7;
    v10 = CoreUICallSend(SendHost, v13, 2LL, 7LL, 0, &unk_1801BF1BA, v5);
