/*
 * XREFs of ?ResizeEnded@Resize@InputETW@@SAXKPEAUtagPOINT@@0I@Z @ 0x1800FE740
 * Callers:
...
void __fastcall InputETW::Resize::ResizeEnded(__int64 a1, struct tagPOINT *a2, struct tagPOINT *a3, unsigned int a4)
{
  __int64 v4; // rsi
  __int64 v7; // r14
  __int64 v8; // rcx
