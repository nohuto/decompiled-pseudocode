/*
 * XREFs of ??1ConsumerControlNexusDevice@@EEAA@XZ @ 0x1800A2B34
 * Callers:
 ...
 *     ?Clear@?$NtList@UInputBufferListEntry@ConsumerControlNexusDevice@@@@QEAAXXZ @ 0x1800A2CE0 (-Clear@-$NtList@UInputBufferListEntry@ConsumerControlNexusDevice@@@@QEAAXXZ.c)
