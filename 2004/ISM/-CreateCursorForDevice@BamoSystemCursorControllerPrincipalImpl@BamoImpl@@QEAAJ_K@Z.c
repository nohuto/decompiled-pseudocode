/*
 * XREFs of ?CreateCursorForDevice@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x18013B7FC
 * Callers:
 *     ?Thunk_CreateCursorForDevice_2@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013CE00 (-Thunk_CreateCursorForDevice_2@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorContr.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  v7 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 88LL))((char *)this - 16, v6, a2);
  if ( v7 < 0 )
