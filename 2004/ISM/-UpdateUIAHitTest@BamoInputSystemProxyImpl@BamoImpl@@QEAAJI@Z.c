/*
 * XREFs of ?UpdateUIAHitTest@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EFC24
 * Callers:
 ...
 *     ?Thunk_UpdateUIAHitTest_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED130 (-Thunk_UpdateUIAHitTest_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJ.c)
 * Callees:
