/*
 * XREFs of ?SendGameControllerAsVirtualKeys@ControllerProcessor@@AEAAJXZ @ 0x180121BAC
 * Callers:
 ...
 *     ?TestThumbstickAxisAndSetVirtualKeyState@ControllerProcessor@@AEAAXMGG_N@Z @ 0x180122C00 (-TestThumbstickAxisAndSetVirtualKeyState@ControllerProcessor@@AEAAXMGG_N@Z.c)
 *     ?TestTriggerAndSetVirtualKeyState@ControllerProcessor@@AEAAXMG@Z @ 0x180122CA8 (-TestTriggerAndSetVirtualKeyState@ControllerProcessor@@AEAAXMG@Z.c)
