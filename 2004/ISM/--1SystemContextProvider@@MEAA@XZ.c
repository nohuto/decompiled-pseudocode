/*
 * XREFs of ??1SystemContextProvider@@MEAA@XZ @ 0x180147594
 * Callers:
 *     ??_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z @ 0x1801456C0 (--_GVirtualTouchpadContextProvider@@UEAAPEAXI@Z.c)
 *     _VirtualTouchpadContextProvider::Create_::_1_::dtor$2 @ 0x1801458BC (_VirtualTouchpadContextProvider--Create_--_1_--dtor$2.c)
