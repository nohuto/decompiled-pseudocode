/*
 * XREFs of ?NodeStatusOK_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXK@Z @ 0x18016CF80
 * Callers:
        ...
        int a2)
{
  ...
  if ( **((_DWORD **)v3 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v3 + 1), 2LL) )
  {
    ...
    v5 = a2;
    v8 = 4;
    tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801D09B1, 0LL, 0LL, 3u, &v6);
  }
}
