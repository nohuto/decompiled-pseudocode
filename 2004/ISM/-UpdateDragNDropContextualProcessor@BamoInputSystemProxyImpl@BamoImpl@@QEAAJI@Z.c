/*
 * XREFs of ?UpdateDragNDropContextualProcessor@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EDB3C
 * Callers:
 ...
 *     ?Thunk_UpdateDragNDropContextualProcessor_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECE50 (-Thunk_UpdateDragNDropContextualProcessor_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyIm.c)
 * Callees:
