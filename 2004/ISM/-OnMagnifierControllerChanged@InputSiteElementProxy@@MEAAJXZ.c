/*
 * XREFs of ?OnMagnifierControllerChanged@InputSiteElementProxy@@MEAAJXZ @ 0x18000C4D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall InputSiteElementProxy::OnMagnifierControllerChanged(
        ...
        const char *a4)
{
  ...
  if ( v8 != v6 )
  {
    while ( 1 )
    {
      ...
      v13 = v11(v10, &GUID_b5135dce_13f2_00ca_8db4_0bd6f94fc834, &v24) >= 0;
      if ( v9 && v13 )
        break;
      v8 += 2;
      if ( v8 == v6 )
  ...
  v16 = (*(__int64 (__fastcall **)(__int64))(*((_QWORD *)v4 + 1) + 144LL))((__int64)v4 + 8);
  if ( v16 )
  {
    v21 = v4;
    v18 = v16 + 8;
