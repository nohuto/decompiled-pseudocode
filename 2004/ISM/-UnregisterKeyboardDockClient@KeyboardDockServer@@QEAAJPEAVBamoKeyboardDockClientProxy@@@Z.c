/*
 * XREFs of ?UnregisterKeyboardDockClient@KeyboardDockServer@@QEAAJPEAVBamoKeyboardDockClientProxy@@@Z @ 0x180127EC0
 * Callers:
 *     ?OnDisconnected@KeyboardDockClientProxy@@MEAAJXZ @ 0x180128880 (-OnDisconnected@KeyboardDockClientProxy@@MEAAJXZ.c)
 * Callees:
