/*
 * XREFs of ?GetPoseAtTime_@HolographicDriverClientContinuousTrace@@QEAAXPEBXAEBUSPATIAL_NODE_ID@@_J2222W4TracePredictionType@@AEBUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@_NI@Z @ 0x18015D994
 * Callers:
        ...
        int a12)
{
  ...
  ActivityId = 0LL;
  v13 = *(_DWORD *)(a10 + 16);
  v30 = 1000000 * (a5 - a4) / qword_180208310;
  v14 = a12 ^ v13;
  v29 = 1000000 * (a5 - a6) / qword_180208310;
  v28 = 1000000 * (a7 - a5) / qword_180208310;
  v27 = 1000000 * (a7 - a6) / qword_180208310;
  v25 = 1000000 * (a8 - a6) / qword_180208310;
  v26 = 1000000 * (a4 - a8) / qword_180208310;
