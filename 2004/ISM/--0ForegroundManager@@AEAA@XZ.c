/*
 * XREFs of ??0ForegroundManager@@AEAA@XZ @ 0x18003368C
 * Callers:
 ...
 * Callees:
 *     ??0?$KernelInputConnection@U_tagActivationObjectNotification@@@@QEAA@PEBD@Z @ 0x180045EC4 (--0-$KernelInputConnection@U_tagActivationObjectNotification@@@@QEAA@PEBD@Z.c)
