/*
 * XREFs of ?CreateSpatialPayloadDescriptor@SpatialObjectDDIClientFactoryHelper@Holographic@Internal@Windows@@UEAAJPEBX_KPEAPEAUISpatialPayloadDescriptor@234@@Z @ 0x1800D7160
 * Callers:
 *     <none>
 * Callees:
