/*
 * XREFs of ?UpdatePenEventsDispatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF020
 * Callers:
 ...
 *     ?Thunk_UpdatePenEventsDispatcher_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED000 (-Thunk_UpdatePenEventsDispatcher_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
