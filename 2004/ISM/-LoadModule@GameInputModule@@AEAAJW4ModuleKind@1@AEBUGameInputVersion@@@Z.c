/*
 * XREFs of ?LoadModule@GameInputModule@@AEAAJW4ModuleKind@1@AEBUGameInputVersion@@@Z @ 0x1800427F8
 * Callers:
 ...
 *     ?ValidateModuleCertChain@GameInputModule@@CAJPEBG@Z @ 0x18004333C (-ValidateModuleCertChain@GameInputModule@@CAJPEBG@Z.c)
 */
