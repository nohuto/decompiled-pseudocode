/*
 * XREFs of ?EnableGamepadExclusivityForProcess@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800722A8
 * Callers:
 *     ?Thunk_EnableGamepadExclusivityForProcess_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800742C0 (-Thunk_EnableGamepadExclusivityForProcess_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrinc.c)
 * Callees:
