/*
 * XREFs of ??$_Free_non_head@V?$allocator@U?$_List_node@U?$pair@$$CBKW4ContextualProcessorState@@@std@@PEAX@std@@@std@@@?$_List_node@U?$pair@$$CBKW4ContextualProcessorState@@@std@@PEAX@std@@SAXAEAV?$allocator@U?$_List_node@U?$pair@$$CBKW4ContextualProcessorState@@@std@@PEAX@std@@@1@PEAU01@@Z @ 0x180096D14
 * Callers:
 *     ??1?$list@IV?$allocator@I@std@@@std@@QEAA@XZ @ 0x1800976D4 (--1-$list@IV-$allocator@I@std@@@std@@QEAA@XZ.c)
 ...
 *     ?clear@?$list@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@V?$allocator@U?$pair@$$CBKW4ContextualProcessorDecision@@@std@@@2@@std@@QEAAXXZ @ 0x18014DB60 (-clear@-$list@U-$pair@$$CBKW4ContextualProcessorDecision@@@std@@V-$allocator@U-$pair@$$CBKW4Cont.c)
 ...
 *     ?EndCurrentSession@TouchInfoAdapter@@UEAAJK@Z @ 0x180199C50 (-EndCurrentSession@TouchInfoAdapter@@UEAAJK@Z.c)
 * Callees:
