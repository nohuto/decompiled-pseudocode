/*
 * XREFs of ?CreateCursorShapeAnimation@SystemCursorService@@QEAAJIK_K0@Z @ 0x18013EEC0
 * Callers:
 ...
 *     ?shared_from_this@?$enable_shared_from_this@VSystemCursorService@@@std@@QEAA?AV?$shared_ptr@VSystemCursorService@@@2@XZ @ 0x180048548 (-shared_from_this@-$enable_shared_from_this@VSystemCursorService@@@std@@QEAA-AV-$shared_ptr@VSys.c)
 *     _guard_dispatch_icall_nop @ 0x18004A6B0 (_guard_dispatch_icall_nop.c)
 *     ??$_Try_emplace@AEB_K$$V@?$unordered_map@_KV?$shared_ptr@VSystemCursor@@@std@@U?$hash@_K@2@U?$equal_to@_K@2@V?$allocator@U?$pair@$$CB_KV?$shared_ptr@VSystemCursor@@@std@@@std@@@2@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KV?$shared_ptr@VSystemCursor@@@std@@@std@@@std@@@std@@@std@@_N@1@AEB_K@Z @ 0x18013AD88 (--$_Try_emplace@AEB_K$$V@-$unordered_map@_KV-$shared_ptr@VSystemCursor@@@std@@U-$hash@_K@2@U-$eq.c)
 *     ?CursorExists@SystemCursorService@@QEAA_N_K@Z @ 0x18013C008 (-CursorExists@SystemCursorService@@QEAA_N_K@Z.c)
 *     ?ShapeExists@SystemCursor@@QEBA_N_K@Z @ 0x18013CDB0 (-ShapeExists@SystemCursor@@QEBA_N_K@Z.c)
 *     std::function_void___cdecl(Microsoft::WRL::ComPtr_DataProviderPrincipal__&)_::function_void___cdecl(Microsoft::WRL::ComPtr_DataProviderPrincipal__&)___lambda_ba6101031141f0d6e8e74a4c358feff2__void_ @ 0x18013D674 (std--function_void___cdecl(Microsoft--WRL--ComPtr_DataProviderPrincipal__-)_--function_void___cd.c)
 *     _lambda_ba6101031141f0d6e8e74a4c358feff2_::_lambda_ba6101031141f0d6e8e74a4c358feff2_ @ 0x18013E034 (_lambda_ba6101031141f0d6e8e74a4c358feff2_--_lambda_ba6101031141f0d6e8e74a4c358feff2_.c)
 */
