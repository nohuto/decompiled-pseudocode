/*
 * XREFs of ?Materialize_BamoInputSystemProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7810
 * Callers:
 *     ?Thunk_Materialize_BamoInputSystemProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECBD0 (-Thunk_Materialize_BamoInputSystemProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@.c)
 * Callees:
 ...
 *     ?CreateProxy_InputSystem@BamoImpl@@YAXPEAPEAVBamoProxy@Bamo@Microsoft@@@Z @ 0x1800E4354 (-CreateProxy_InputSystem@BamoImpl@@YAXPEAPEAVBamoProxy@Bamo@Microsoft@@@Z.c)
 */
