/*
 * XREFs of ?UpdatePrimaryUsageId@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJG@Z @ 0x1800EF138
 * Callers:
 ...
 *     ?Thunk_UpdatePrimaryUsageId_63@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED010 (-Thunk_UpdatePrimaryUsageId_63@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoI.c)
 * Callees:
