        ...
        _QWORD *a2)
{
  ...
  v5[2] = 1;
  v5[3] = 1;
  *(_QWORD *)v5 = &std::_Ref_count_obj<wil::unique_any_t<wil::details::unique_storage<wil::details::handle_null_resource_policy<long (*)(void *),&long NtCloseCompositionInputSink(void *)>>>>::`vftable';
  *((_QWORD *)v5 + 2) = *a2;
  *a2 = 0LL;
  a1[1] = v5;
  result = a1;
