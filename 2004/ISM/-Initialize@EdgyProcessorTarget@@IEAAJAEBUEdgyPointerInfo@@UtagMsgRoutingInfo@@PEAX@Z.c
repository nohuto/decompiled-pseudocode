/*
 * XREFs of ?Initialize@EdgyProcessorTarget@@IEAAJAEBUEdgyPointerInfo@@UtagMsgRoutingInfo@@PEAX@Z @ 0x18017A4FC
 * Callers:
...
__int64 __fastcall EdgyProcessorTarget::Initialize(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  v8 = a1 + 20;
  Microsoft::WRL::ComPtr<IMessageProxy>::InternalRelease(a1 + 20);
