/*
 * XREFs of ?QueueInputThreadCallback@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAJV?$function@$$A6AXPEAUISpatialInteractionSourceCollectionCallbacks@SpatialInteractions@Internal@Windows@@@Z@std@@@Z @ 0x1800D1A2C
 * Callers:
        ...
        __int64 a2)
{
  ...
  v4 = a1 + 83;
  AcquireSRWLockExclusive(a1 + 83);
  try
  {
    if ( a1[80].Ptr <= (char *)a1[82].Ptr + 1 )
      std::deque<std::function<void (Windows::Internal::SpatialInteractions::ISpatialInteractionSourceCollectionCallbacks *)>>::_Growmap(&a1[78]);
    a1[81].Ptr = (PVOID)((__int64)a1[81].Ptr & ((__int64)a1[80].Ptr - 1));
    v5 = ((__int64)a1[82].Ptr + (unsigned __int64)a1[81].Ptr) & ((__int64)a1[80].Ptr - 1);
    Ptr = a1[79].Ptr;
    if ( !Ptr[v5] )
    {
      *((_QWORD *)a1[79].Ptr + v5) = std::_Allocate<16,std::_Default_allocate_traits,0>(0x40uLL);
      Ptr = a1[79].Ptr;
    }
