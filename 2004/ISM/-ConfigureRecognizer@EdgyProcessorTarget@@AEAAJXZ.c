/*
 * XREFs of ?ConfigureRecognizer@EdgyProcessorTarget@@AEAAJXZ @ 0x18017A1FC
 * Callers:
 ...
 *     ?GetCandidateGestureParameters@EdgyImpl@@QEBA_NPEAIPEAW4OrientationBias@@@Z @ 0x18017B92C (-GetCandidateGestureParameters@EdgyImpl@@QEBA_NPEAIPEAW4OrientationBias@@@Z.c)
 */
