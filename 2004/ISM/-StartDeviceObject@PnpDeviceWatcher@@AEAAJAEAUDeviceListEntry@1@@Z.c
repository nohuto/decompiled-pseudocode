/*
 * XREFs of ?StartDeviceObject@PnpDeviceWatcher@@AEAAJAEAUDeviceListEntry@1@@Z @ 0x18009F398
 * Callers:
 ...
 *     ?StopDeviceObject@PnpDeviceWatcher@@AEAAXAEAUDeviceListEntry@1@@Z @ 0x18009F678 (-StopDeviceObject@PnpDeviceWatcher@@AEAAXAEAUDeviceListEntry@1@@Z.c)
      ...
      if ( i != (char *)a2 )
      {
        ...
        if ( *(_DWORD *)(v8 + 104) == *(_DWORD *)(v7 + 104) )
        {
          ...
          if ( *(_DWORD *)(v8 + 100) < v10 )
            Microsoft::WRL::ComPtr<HidLampArrayDevice>::operator=(v7 + 16);
        }
      }
    }
    v4 = *((_QWORD *)a2 + 2);
...
LABEL_46:
  ...
  if ( (v13 & 0x80000000) != 0 )
  {
    ...
    v12 = 491LL;
LABEL_16:
    wil::details::in1diag3::Return_Hr(retaddr, (void *)v12, (__int64)v11, (const char *)v13);
    return v13;
  }
  if ( v13 != 1 )
    return 0LL;
