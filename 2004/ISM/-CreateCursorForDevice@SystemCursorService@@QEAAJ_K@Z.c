/*
 * XREFs of ?CreateCursorForDevice@SystemCursorService@@QEAAJ_K@Z @ 0x18013EBEC
 * Callers:
 ...
 *     ??$make_shared@VSystemCursor@@V?$shared_ptr@VSystemCursorService@@@std@@AEA_K@std@@YA?AV?$shared_ptr@VSystemCursor@@@0@$$QEAV?$shared_ptr@VSystemCursorService@@@0@AEA_K@Z @ 0x18013DF00 (--$make_shared@VSystemCursor@@V-$shared_ptr@VSystemCursorService@@@std@@AEA_K@std@@YA-AV-$shared.c)
