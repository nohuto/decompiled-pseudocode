/*
 * XREFs of ?QueryInterface@KeyboardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180047D20
 * Callers:
 *     ?QueryInterface@KeyboardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C2B0 (-QueryInterface@KeyboardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
