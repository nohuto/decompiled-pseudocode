/*
 * XREFs of ?SendMaterializeProxy@BamoAsyncHRESULTPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18011B700
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v15, 2LL, 1LL, 1, &unk_1801C190B, v13);
  if ( v8 < 0 )
  {
