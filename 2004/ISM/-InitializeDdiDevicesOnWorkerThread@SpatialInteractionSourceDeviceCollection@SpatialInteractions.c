/*
 * XREFs of ?InitializeDdiDevicesOnWorkerThread@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@AEAAJPEAUISpatialObjectDDIClientFactory@Holographic@34@@Z @ 0x1800D79A8
 * Callers:
 ...
 *     ??4?$ComPtr@UISpatialObjectDDIClientFactory@Holographic@Internal@Windows@@@WRL@Microsoft@@QEAAAEAV012@PEAUISpatialObjectDDIClientFactory@Holographic@Internal@Windows@@@Z @ 0x18007D294 (--4-$ComPtr@UISpatialObjectDDIClientFactory@Holographic@Internal@Windows@@@WRL@Microsoft@@QEAAAE.c)
