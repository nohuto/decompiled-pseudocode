/*
 * XREFs of ?QueryInterface@InputForwardProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180176CD0
 * Callers:
 *     ?QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004CD90 (-QueryInterface@InputForwardProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
