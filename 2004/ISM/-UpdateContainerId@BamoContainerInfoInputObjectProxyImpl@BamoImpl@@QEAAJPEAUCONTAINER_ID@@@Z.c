/*
 * XREFs of ?UpdateContainerId@BamoContainerInfoInputObjectProxyImpl@BamoImpl@@QEAAJPEAUCONTAINER_ID@@@Z @ 0x1800ED78C
 * Callers:
 ...
 *     ?Thunk_UpdateContainerId_34@?$IContainerInfoInputObjectProxy_Receive@VBamoContainerInfoInputObjectProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECE00 (-Thunk_UpdateContainerId_34@-$IContainerInfoInputObjectProxy_Receive@VBamoContainerInfoInputObje.c)
 * Callees:
