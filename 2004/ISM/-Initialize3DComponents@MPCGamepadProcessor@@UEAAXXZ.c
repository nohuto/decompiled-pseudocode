/*
 * XREFs of ?Initialize3DComponents@MPCGamepadProcessor@@UEAAXXZ @ 0x180192330
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::Initialize3DComponents(MPCGamepadProcessor *this)
{
  ...
  v3 = std::make_unique<MPCButtonHoldHelper,float,0>(&v15, flt_1801C5F00);
  ...
  v5 = std::make_unique<MPCButtonHoldHelper,float,0>(&v15, flt_1801C5F00);
