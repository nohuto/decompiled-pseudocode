/*
 * XREFs of ?Materialize_BamoActuationClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E6694
 * Callers:
 *     ?Thunk_Materialize_BamoActuationClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800EC9F0 (-Thunk_Materialize_BamoActuationClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerI.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoActuationClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoActuationClientProxy::`vftable'{for `IActuationClientProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
