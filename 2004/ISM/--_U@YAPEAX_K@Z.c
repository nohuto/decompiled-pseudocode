/*
 * XREFs of ??_U@YAPEAX_K@Z @ 0x18003D304
 * Callers:
 ...
 *     ?GetDevicePath@MobileButtonDeviceCollection@@AEAAPEAGXZ @ 0x180097AC8 (-GetDevicePath@MobileButtonDeviceCollection@@AEAAPEAGXZ.c)
 ...
 *     ??$make_unique@$$BY0A@E$0A@@std@@YA?AV?$unique_ptr@$$BY0A@EU?$default_delete@$$BY0A@E@std@@@0@_K@Z @ 0x18009C0E4 (--$make_unique@$$BY0A@E$0A@@std@@YA-AV-$unique_ptr@$$BY0A@EU-$default_delete@$$BY0A@E@std@@@0@_K.c)
 ...
 *     ??$make_unique@$$BY0A@G$0A@@std@@YA?AV?$unique_ptr@$$BY0A@GU?$default_delete@$$BY0A@G@std@@@0@_K@Z @ 0x18009DC9C (--$make_unique@$$BY0A@G$0A@@std@@YA-AV-$unique_ptr@$$BY0A@GU-$default_delete@$$BY0A@G@std@@@0@_K.c)
 *     ??$make_unique@$$BY0A@U_HIDP_LINK_COLLECTION_NODE@@$0A@@std@@YA?AV?$unique_ptr@$$BY0A@U_HIDP_LINK_COLLECTION_NODE@@U?$default_delete@$$BY0A@U_HIDP_LINK_COLLECTION_NODE@@@std@@@0@_K@Z @ 0x18009DD04 (--$make_unique@$$BY0A@U_HIDP_LINK_COLLECTION_NODE@@$0A@@std@@YA-AV-$unique_ptr@$$BY0A@U_HIDP_LIN.c)
 *     ??$make_unique@$$BY0A@U_HIDP_VALUE_CAPS@@$0A@@std@@YA?AV?$unique_ptr@$$BY0A@U_HIDP_VALUE_CAPS@@U?$default_delete@$$BY0A@U_HIDP_VALUE_CAPS@@@std@@@0@_K@Z @ 0x18009DD6C (--$make_unique@$$BY0A@U_HIDP_VALUE_CAPS@@$0A@@std@@YA-AV-$unique_ptr@$$BY0A@U_HIDP_VALUE_CAPS@@U.c)
 ...
 *     ?IsHighLatencyInterface@PenIdentity@@YA_NAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@Z @ 0x180131F64 (-IsHighLatencyInterface@PenIdentity@@YA_NAEBV-$basic_string@GU-$char_traits@G@std@@V-$allocator@.c)
 * Callees:
 *     <none>
 */
