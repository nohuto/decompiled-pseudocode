/*
 * XREFs of _std::vector_Edge_std::allocator_Edge___::_Emplace_reallocate_Edge_const_&__::_1_::catch$35 @ 0x180178449
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?deallocate@?$allocator@VEdge@@@std@@QEAAXQEAVEdge@@_K@Z @ 0x18017790C (-deallocate@-$allocator@VEdge@@@std@@QEAAXQEAVEdge@@_K@Z.c)
 */
