/*
 * XREFs of ?clear@?$_Hash@V?$_Umap_traits@IV?$vector@IV?$allocator@I@std@@@std@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@2@V?$allocator@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@$0A@@std@@@std@@QEAAXXZ @ 0x1800B3A5C
 * Callers:
        ...
        __int64 a1)
{
  ...
  std::_List_node<std::pair<unsigned int const,std::vector<unsigned int>>,void *>::_Free_non_head<std::allocator<std::_List_node<std::pair<unsigned int const,std::vector<unsigned int>>,void *>>>(
    a1,
    (_QWORD **)qword_180208B78);
  *(_QWORD *)qword_180208B78 = qword_180208B78;
  result = qword_180208B78;
  *(_QWORD *)(qword_180208B78 + 8) = qword_180208B78;
  qword_180208B80 = 0LL;
  v2 = (unsigned __int64)(xmmword_180208B90 - qword_180208B88 + 7) >> 3;
  if ( qword_180208B88 > (unsigned __int64)xmmword_180208B90 )
    v2 = 0LL;
  if ( v2 )
  {
    result = qword_180208B78;
    memset64((void *)qword_180208B88, qword_180208B78, v2);
  }
  return result;
}
