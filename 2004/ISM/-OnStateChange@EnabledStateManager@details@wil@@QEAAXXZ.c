/*
 * XREFs of ?OnStateChange@EnabledStateManager@details@wil@@QEAAXXZ @ 0x180065B18
 * Callers:
 *     ?_lambda_invoker_cdecl_@_lambda_fee8cea507d2413a58be13acfb66740a_@@CAXPEAX@Z @ 0x18003DCB0 (-_lambda_invoker_cdecl_@_lambda_fee8cea507d2413a58be13acfb66740a_@@CAXPEAX@Z.c)
 * Callees:
 ...
 *     ?InvalidateFeatureStateCache@EnabledStateManager@details@wil@@AEAAXPEATwil_details_FeatureStateCache@@W4wil_FeatureChangeTime@@@Z @ 0x18003DEDC (-InvalidateFeatureStateCache@EnabledStateManager@details@wil@@AEAAXPEATwil_details_FeatureStateC.c)
 */
