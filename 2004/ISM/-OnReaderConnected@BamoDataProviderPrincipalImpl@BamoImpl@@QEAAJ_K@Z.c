/*
 * XREFs of ?OnReaderConnected@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x180142CEC
 * Callers:
 *     ?Thunk_OnReaderConnected_0@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801446D0 (-Thunk_OnReaderConnected_0@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoI.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  v7 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 80LL))((char *)this - 16, v6, a2);
  if ( v7 < 0 )
