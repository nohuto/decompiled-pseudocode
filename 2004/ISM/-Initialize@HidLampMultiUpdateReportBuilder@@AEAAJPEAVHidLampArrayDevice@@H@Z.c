/*
 * XREFs of ?Initialize@HidLampMultiUpdateReportBuilder@@AEAAJPEAVHidLampArrayDevice@@H@Z @ 0x1800A9534
 * Callers:
 ...
 *     ?Reset@HidLampMultiUpdateReportBuilder@@QEAAXXZ @ 0x1800A9688 (-Reset@HidLampMultiUpdateReportBuilder@@QEAAXXZ.c)
 */
