/*
 * XREFs of ??1SpatialGraphDriverClient@Holographic@Internal@Windows@@EEAA@XZ @ 0x180157A20
 * Callers:
 *     ??_ESpatialGraphDriverClient@Holographic@Internal@Windows@@EEAAPEAXI@Z @ 0x180158C40 (--_ESpatialGraphDriverClient@Holographic@Internal@Windows@@EEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??$_Erase_tree@V?$allocator@U?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@std@@@std@@@?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@@std@@@std@@QEAAXAEAV?$allocator@U?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@std@@@1@PEAU?$_Tree_node@U?$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@std@@PEAX@1@@Z @ 0x18003F0C4 (--$_Erase_tree@V-$allocator@U-$_Tree_node@U-$pair@$$CB_KPEAUBufferStream@BamoImpl@Microsoft@@@st.c)
 *     _guard_dispatch_icall_nop @ 0x18004A6B0 (_guard_dispatch_icall_nop.c)
 *     ?Destroy@?$DestroyThreadPoolTimer@USystemThreadPoolMethods@details@wil@@$0A@@details@wil@@SAXPEAU_TP_TIMER@@@Z @ 0x180064D84 (-Destroy@-$DestroyThreadPoolTimer@USystemThreadPoolMethods@details@wil@@$0A@@details@wil@@SAXPEA.c)
 *     ??1?$vector@U?$pair@KPEAUIInputProcessor@@@std@@V?$allocator@U?$pair@KPEAUIInputProcessor@@@std@@@2@@std@@QEAA@XZ @ 0x18008706C (--1-$vector@U-$pair@KPEAUIInputProcessor@@@std@@V-$allocator@U-$pair@KPEAUIInputProcessor@@@std@.c)
        ...
        void *a2)
{
  ...
  *((_BYTE *)this + 166) = 1;
  v3 = (wil::details **)((char *)this + 168);
  wil::details::SetEvent(*((wil::details **)this + 21), a2);
  v4 = (PTP_TIMER *)((char *)this + 184);
  wil::details::unique_storage<wil::details::resource_policy<_TP_TIMER *,void (*)(_TP_TIMER *),&public: static void wil::details::DestroyThreadPoolTimer<wil::details::SystemThreadPoolMethods,0>::Destroy(_TP_TIMER *),wistd::integral_constant<unsigned __int64,0>,_TP_TIMER *,_TP_TIMER *,0,std::nullptr_t>>::reset(
    (struct _TP_TIMER **)this + 23,
    0LL);
  v5 = (char *)*((_QWORD *)this + 22);
  if ( (unsigned __int64)(v5 - 1) <= 0xFFFFFFFFFFFFFFFDuLL )
    WaitForSingleObject(v5, 0xFFFFFFFF);
  std::shared_ptr<Windows::Internal::Holographic::SpatialGraphDriverHandleWrapper>::reset((_QWORD *)this + 12);
  ...
  std::_Deallocate<16,0>(*((void **)this + 48), (const struct std::nothrow_t *)0x30);
  std::_Tree_val<std::_Tree_simple_types<std::pair<Windows::Internal::Holographic::V2PropertyRequest * const,std::unique_ptr<Windows::Internal::Holographic::V2PropertyRequest>>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<Windows::Internal::Holographic::V2PropertyRequest * const,std::unique_ptr<Windows::Internal::Holographic::V2PropertyRequest>>,void *>>>(
    (__int64)this + 360,
    (__int64)this + 360,
    *(__int64 **)(*((_QWORD *)this + 45) + 8LL));
  std::_Deallocate<16,0>(*((void **)this + 45), (const struct std::nothrow_t *)0x30);
  std::_Tree_val<std::_Tree_simple_types<std::pair<SPATIAL_NODE_ID const,std::vector<std::unique_ptr<Windows::Internal::Holographic::V2PropertyRequest>>>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<SPATIAL_NODE_ID const,std::vector<std::unique_ptr<Windows::Internal::Holographic::V2PropertyRequest>>>,void *>>>(
    (__int64)this + 344,
    (__int64)this + 344,
    *(__int64 **)(*((_QWORD *)this + 43) + 8LL));
  std::_Deallocate<16,0>(*((void **)this + 43), (const struct std::nothrow_t *)0x48);
  ...
  if ( v6 )
  {
    ...
    std::_Deallocate<16,0>(
      v6,
      (const struct std::nothrow_t *)((*((_QWORD *)this + 42) - (_QWORD)v6) & 0xFFFFFFFFFFFFFFF8uLL));
    *((_QWORD *)this + 40) = 0LL;
    *((_QWORD *)this + 41) = 0LL;
    *((_QWORD *)this + 42) = 0LL;
  }
  std::_Tree_val<std::_Tree_simple_types<std::pair<_GUID const,std::map<_GUID,std::vector<unsigned char>,Windows::Internal::Holographic::PropertyCache::GuidLess,std::allocator<std::pair<_GUID const,std::vector<unsigned char>>>>>>>::_Erase_tree<std::allocator<std::_Tree_node<std::pair<_GUID const,std::map<_GUID,std::vector<unsigned char>,Windows::Internal::Holographic::PropertyCache::GuidLess,std::allocator<std::pair<_GUID const,std::vector<unsigned char>>>>>,void *>>>(
    (__int64)this + 304,
    (__int64)this + 304,
    *(void ***)(*((_QWORD *)this + 38) + 8LL));
  std::_Deallocate<16,0>(*((void **)this + 38), (const struct std::nothrow_t *)0x40);
  ...
  std::_Deallocate<16,0>(*((void **)this + 33), (const struct std::nothrow_t *)0x48);
  std::vector<std::pair<unsigned long,IInputProcessor *>>::~vector<std::pair<unsigned long,IInputProcessor *>>((__int64)this + 200);
  v8 = *((_QWORD *)this + 24);
  if ( v8 )
  {
    *((_QWORD *)this + 24) = 0LL;
