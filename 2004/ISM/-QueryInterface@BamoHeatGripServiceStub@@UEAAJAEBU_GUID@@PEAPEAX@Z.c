/*
 * XREFs of ?QueryInterface@BamoHeatGripServiceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x18012A480
 * Callers:
 *     ?QueryInterface@BamoHeatGripServiceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C1D0 (-QueryInterface@BamoHeatGripServiceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
