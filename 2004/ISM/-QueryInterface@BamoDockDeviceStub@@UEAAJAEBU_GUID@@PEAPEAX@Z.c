/*
 * XREFs of ?QueryInterface@BamoDockDeviceStub@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180126F20
 * Callers:
 *     ?QueryInterface@BamoDockDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C160 (-QueryInterface@BamoDockDeviceStub@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
