/*
 * XREFs of wil::init_once_nothrow__lambda_3ea8e1ac958ff1e75d916de58c44b505___ @ 0x1800A4374
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( !InitOnceBeginInitialize(&InitOnce, 0, &fPending, 0LL) )
    return wil::details::in1diag3::Return_GetLastError(retaddr, (void *)0x1D4, (__int64)"wil", v3);
  if ( fPending )
  {
