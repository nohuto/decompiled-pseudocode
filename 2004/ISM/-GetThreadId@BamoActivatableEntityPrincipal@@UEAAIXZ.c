/*
 * XREFs of ?GetThreadId@BamoActivatableEntityPrincipal@@UEAAIXZ @ 0x180105560
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoActivatableEntityPrincipal::GetThreadId(struct Microsoft::BamoImpl::ConnectionIndirector **this)
{
