/*
 * XREFs of ?LogPnPDeviceInfo@LampArrayTelemetry@@QEAAXPEBGGGGG@Z @ 0x1800A4620
 * Callers:
        ...
        unsigned __int16 a6)
{
  ...
  v14 = this;
  if ( (unsigned int)dword_1802053F0 > 5 && tlgKeywordOn((__int64)&dword_1802053F0, 0x400000000000LL) )
  {
    LOWORD(v14) = a6;
    v10 = a5;
    v11 = v8;
