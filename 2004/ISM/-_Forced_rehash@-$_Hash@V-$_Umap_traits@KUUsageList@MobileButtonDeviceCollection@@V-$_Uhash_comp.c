/*
 * XREFs of ?_Forced_rehash@?$_Hash@V?$_Umap_traits@KUUsageList@MobileButtonDeviceCollection@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKUUsageList@MobileButtonDeviceCollection@@@std@@@4@$0A@@std@@@std@@IEAAX_K@Z @ 0x180098CB4
 * Callers:
 *     ?_Check_size@?$_Hash@V?$_Umap_traits@KUUsageList@MobileButtonDeviceCollection@@V?$_Uhash_compare@KU?$hash@K@std@@U?$equal_to@K@2@@std@@V?$allocator@U?$pair@$$CBKUUsageList@MobileButtonDeviceCollection@@@std@@@4@$0A@@std@@@std@@IEAAXXZ @ 0x180098BAC (-_Check_size@-$_Hash@V-$_Umap_traits@KUUsageList@MobileButtonDeviceCollection@@V-$_Uhash_compare.c)
 * Callees:
