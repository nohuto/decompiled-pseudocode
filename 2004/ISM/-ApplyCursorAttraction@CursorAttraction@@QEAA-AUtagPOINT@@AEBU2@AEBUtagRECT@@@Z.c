/*
 * XREFs of ?ApplyCursorAttraction@CursorAttraction@@QEAA?AUtagPOINT@@AEBU2@AEBUtagRECT@@@Z @ 0x1801703DC
 * Callers:
 ...
 * Callees:
 *     operator___0 @ 0x1801703B0 (operator___0.c)
 *     ?ClampCursorAttractionDelta@CursorAttraction@@AEAA?AUXMFLOAT2@DirectX@@AEBUtagPOINT@@@Z @ 0x180170584 (-ClampCursorAttractionDelta@CursorAttraction@@AEAA-AUXMFLOAT2@DirectX@@AEBUtagPOINT@@@Z.c)
 *     ?ComputeAverageCursorVelocity@CursorAttraction@@AEAA?AUXMFLOAT2@DirectX@@XZ @ 0x18017060C (-ComputeAverageCursorVelocity@CursorAttraction@@AEAA-AUXMFLOAT2@DirectX@@XZ.c)
 *     ?IsCursorAtRest@CursorAttraction@@AEAA_NXZ @ 0x1801706E0 (-IsCursorAtRest@CursorAttraction@@AEAA_NXZ.c)
 *     ?IsPointInRect@CursorAttraction@@AEAA_NAEBUtagPOINT@@AEBUtagRECT@@@Z @ 0x180170774 (-IsPointInRect@CursorAttraction@@AEAA_NAEBUtagPOINT@@AEBUtagRECT@@@Z.c)
