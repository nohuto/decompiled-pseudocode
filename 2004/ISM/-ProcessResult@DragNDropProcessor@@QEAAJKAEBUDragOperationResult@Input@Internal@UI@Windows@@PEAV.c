/*
 * XREFs of ?ProcessResult@DragNDropProcessor@@QEAAJKAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientProxy@@@Z @ 0x1800FA8C0
 * Callers:
 *     ?ProcessResult@DragManagerHost@@MEAAJPEAVBamoDragNDropContextualProcessorStub@@IAEBUDragOperationResult@Input@Internal@UI@Windows@@PEAVBamoDragManagerClientProxy@@@Z @ 0x1800F5CB0 (-ProcessResult@DragManagerHost@@MEAAJPEAVBamoDragNDropContextualProcessorStub@@IAEBUDragOperatio.c)
 * Callees:
