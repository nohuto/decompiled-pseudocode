/*
 * XREFs of ??1TargetingInfo@KeyboardProcessor@@QEAA@XZ @ 0x180047BD4
 * Callers:
 ...
 *     _KeyboardProcessor::OnInputReport_::_1_::dtor$4 @ 0x1801355DA (_KeyboardProcessor--OnInputReport_--_1_--dtor$4.c)
 *     ?OnInputReport@ButtonProcessor@@UEAAJPEAUInputInfo@@@Z @ 0x180187C00 (-OnInputReport@ButtonProcessor@@UEAAJPEAUInputInfo@@@Z.c)
 *     _ButtonProcessor::OnInputReport_::_1_::dtor$2 @ 0x180187F06 (_ButtonProcessor--OnInputReport_--_1_--dtor$2.c)
 * Callees:
