/*
 * XREFs of ?LogGamepadTaskSwitcherInvoked@ControllerProcessorTelemetry@@SAXI@Z @ 0x1801248A8
 * Callers:
...
void __fastcall ControllerProcessorTelemetry::LogGamepadTaskSwitcherInvoked(__int64 a1)
{
  ...
  if ( **(_DWORD **)(v2 + 8) > 5u && tlgKeywordOn(*(_QWORD *)(v2 + 8), 0x400000000000LL) )
  {
    ...
    v4 = v1;
    v7 = 4;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1801CE1EB, 0LL, 0LL, 3u, &v5);
  }
}
