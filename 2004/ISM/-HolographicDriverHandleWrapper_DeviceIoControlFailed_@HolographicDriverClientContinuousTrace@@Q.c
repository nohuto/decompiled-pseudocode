/*
 * XREFs of ?HolographicDriverHandleWrapper_DeviceIoControlFailed_@HolographicDriverClientContinuousTrace@@QEAAXKKPEBXAEBU_GUID@@@Z @ 0x18015F67C
 * Callers:
        ...
        const struct _GUID *a5)
{
  ...
  if ( **(_DWORD **)(v8 + 8) > 5u && tlgKeywordOn(*(_QWORD *)(v8 + 8), 2LL) )
  {
    ...
    v18 = 4LL;
    v16 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801CE7D6, 0LL, 0LL, 7u, &v14);
  }
}
