/*
 * XREFs of ?AddAndPopulateInputType@MPCConstantManager@@QEAAXPEAUIMPCInputProviderBase@@AEBV?$map@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$variant@K_NM@2@U?$less@X@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$variant@K_NM@2@@std@@@2@@std@@@Z @ 0x180036270
 * Callers:
 ...
 *     ?clear@?$_Tree@V?$_Tmap_traits@V?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$variant@K_NM@2@U?$less@X@2@V?$allocator@U?$pair@$$CBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@V?$variant@K_NM@2@@std@@@2@$0A@@std@@@std@@QEAAXXZ @ 0x180036360 (-clear@-$_Tree@V-$_Tmap_traits@V-$basic_string@GU-$char_traits@G@std@@V-$allocator@G@2@@std@@V-$.c)
 *     ?CheckTypeExistence@MPCConstantManager@@QEAA_NW4InputType@@@Z @ 0x180036484 (-CheckTypeExistence@MPCConstantManager@@QEAA_NW4InputType@@@Z.c)
...
__int64 __fastcall MPCConstantManager::AddAndPopulateInputType(__int64 a1, __int64 a2, _QWORD *a3)
{
  int v5; // ebx
  const char *v6; // r9
  _QWORD *v7; // r9
  ...
  v18 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)a2 + 48LL))(a2);
  v5 = v18;
  if ( (unsigned __int8)MPCConstantManager::CheckTypeExistence(a1, v18) )
  {
  ...
  while ( !*(_BYTE *)(v9 + 25) );
  if ( result == *v7 || v5 < *(_DWORD *)(result + 32) )
  {
LABEL_3:
    v19 = &v18;
    result = *(_QWORD *)std::_Tree<std::_Tmap_traits<enum InputType,std::map<std::wstring,std::variant<unsigned long,bool,float>>,std::less<enum InputType>,std::allocator<std::pair<enum InputType const,std::map<std::wstring,std::variant<unsigned long,bool,float>>>>,0>>::emplace_hint<std::piecewise_construct_t const &,std::tuple<enum InputType const &>,std::tuple<>>(
                          (int)a1 + 56,
                          (unsigned int)&v16,
                          result,
                          (_DWORD)v7,
  ...
  v10 = (__int64 *)(result + 40);
  if ( (_QWORD *)(result + 40) != a3 )
  {
    std::_Tree<std::_Tmap_traits<std::wstring,std::variant<unsigned long,bool,float>,std::less<void>,std::allocator<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>,0>>::clear(result + 40);
    *(_QWORD *)(*v10 + 8) = std::_Tree<std::_Tmap_traits<std::wstring,std::variant<unsigned long,bool,float>,std::less<void>,std::allocator<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>,0>>::_Copy_nodes<std::_Tree<std::_Tmap_traits<std::wstring,std::variant<unsigned long,bool,float>,std::less<void>,std::allocator<std::pair<std::wstring const,std::variant<unsigned long,bool,float>>>,0>>::_Copy_tag>(
                              v10,
                              *(_QWORD *)(*a3 + 8LL),
                              *v10);
    v11 = (_QWORD *)*v10;
    ...
    {
      v13 = std::_Tree_val<std::_Tree_simple_types<std::pair<wil::com_ptr_t<MPCManagerBamo_AutoBamos::BamoPeer,wil::err_exception_policy> const,wil::com_ptr_t<IMPCManagerClientProxy,wil::err_exception_policy>>>>::_Min((_QWORD *)v12);
      *v14 = v13;
      result = std::_Tree_val<std::_Tree_simple_types<std::pair<DockInputIdentity const,DisplayOcclusionRect>>>::_Max(*(_QWORD *)(*v10 + 8));
