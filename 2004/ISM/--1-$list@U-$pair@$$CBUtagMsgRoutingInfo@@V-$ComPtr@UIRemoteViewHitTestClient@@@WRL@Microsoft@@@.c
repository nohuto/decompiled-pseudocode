        ...
        void **a1)
{
  ...
  **((_QWORD **)*a1 + 1) = 0LL;
  ...
  if ( *v1 )
  {
    ...
    {
      v4 = (_QWORD *)*v3;
      Microsoft::WRL::ComPtr<Windows::UI::Input::Spatial::Internal::IInputPriv>::InternalRelease(v3 + 7);
