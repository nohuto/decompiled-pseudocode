/*
 * XREFs of ?CompositorRunningStateChanged@SpatialInteractionSourceDeviceCollection@SpatialInteractions@Internal@Windows@@UEAAJ_NPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800D6C60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?CreateDevice@SpatialInteractionHeadObjectDevice@SpatialInteractions@Internal@Windows@@QEAAJPEAUISpatialInteractionSourceCollectionCallbacks@234@@Z @ 0x1800DB5AC (-CreateDevice@SpatialInteractionHeadObjectDevice@SpatialInteractions@Internal@Windows@@QEAAJPEAU.c)
 */
