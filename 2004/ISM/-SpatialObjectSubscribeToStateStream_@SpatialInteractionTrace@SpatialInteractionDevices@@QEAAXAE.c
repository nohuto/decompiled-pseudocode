/*
 * XREFs of ?SpatialObjectSubscribeToStateStream_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@J@Z @ 0x1800D8D2C
 * Callers:
 *     _lambda_86a3fa2e77f671cbbc20107799d6d433_::operator() @ 0x1800D63D8 (_lambda_86a3fa2e77f671cbbc20107799d6d433_--operator().c)
 * Callees:
