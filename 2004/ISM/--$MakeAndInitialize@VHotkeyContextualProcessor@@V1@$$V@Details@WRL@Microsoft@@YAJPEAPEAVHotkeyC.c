/*
 * XREFs of ??$MakeAndInitialize@VHotkeyContextualProcessor@@V1@$$V@Details@WRL@Microsoft@@YAJPEAPEAVHotkeyContextualProcessor@@@Z @ 0x180136E54
 * Callers:
 ...
 *     ??0HotkeyContextualProcessor@@QEAA@XZ @ 0x180137570 (--0HotkeyContextualProcessor@@QEAA@XZ.c)
