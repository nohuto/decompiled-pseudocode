/*
 * XREFs of ?GetDropTargetClient@BamoInputSiteElementProxy@@UEAAPEAVBamoDropTargetClientProxy@@XZ @ 0x180010B40
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 168) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x180055F4ELL);
  }
  return (struct BamoDropTargetClientProxy *)*((_QWORD *)this + 17);
}
