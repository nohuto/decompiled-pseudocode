/*
 * XREFs of ?QueryInterface@BamoPenEventsClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180133D00
 * Callers:
 *     ?QueryInterface@BamoPenEventsClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C270 (-QueryInterface@BamoPenEventsClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
