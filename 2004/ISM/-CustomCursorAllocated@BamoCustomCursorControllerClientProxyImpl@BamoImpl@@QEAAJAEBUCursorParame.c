/*
 * XREFs of ?CustomCursorAllocated@BamoCustomCursorControllerClientProxyImpl@BamoImpl@@QEAAJAEBUCursorParametersInfo@@_K@Z @ 0x1800E486C
 * Callers:
...
LABEL_3:
  ...
  v10[0] = v12;
  v10[1] = v13;
  return CoreUICallSend(v7, v10, 2LL, 19LL, 0, &unk_1801BF1DC, (unsigned int)&v9);
}
