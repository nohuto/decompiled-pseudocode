/*
 * XREFs of ??_GDragNDropProcessorLegacy@@EEAAPEAXI@Z @ 0x180174638
 * Callers:
 *     ??_EDragNDropProcessorLegacy@@G7EAAPEAXI@Z @ 0x18004CD60 (--_EDragNDropProcessorLegacy@@G7EAAPEAXI@Z.c)
 * Callees:
