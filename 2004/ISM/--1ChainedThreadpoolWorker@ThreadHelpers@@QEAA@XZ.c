/*
 * XREFs of ??1ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ @ 0x1801576AC
 * Callers:
 ...
 *     ?GetWorkThreadId@ChainedThreadpoolWorker@ThreadHelpers@@QEAAKXZ @ 0x180049014 (-GetWorkThreadId@ChainedThreadpoolWorker@ThreadHelpers@@QEAAKXZ.c)
