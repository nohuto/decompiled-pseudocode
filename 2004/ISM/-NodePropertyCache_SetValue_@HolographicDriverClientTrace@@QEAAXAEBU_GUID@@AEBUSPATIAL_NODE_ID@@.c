/*
 * XREFs of ?NodePropertyCache_SetValue_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@AEBUSPATIAL_NODE_ID@@0PEBX_K@Z @ 0x180160618
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( **(_DWORD **)(v9 + 8) > 4u && tlgKeywordOn(*(_QWORD *)(v9 + 8), 2LL) )
  {
    ...
    v13 = a2;
    v14 = 16LL;
    tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801CFC59, 0LL, 0LL, 6u, &v12);
  }
}
