/*
 * XREFs of ?UpdateToggleEnabled@BamoMagnifierControllerProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x180100C58
 * Callers:
 ...
 *     ?Thunk_UpdateToggleEnabled_13@?$IMagnifierControllerProxy_Receive@VBamoMagnifierControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180100A20 (-Thunk_UpdateToggleEnabled_13@-$IMagnifierControllerProxy_Receive@VBamoMagnifierControllerProxyI.c)
 * Callees:
