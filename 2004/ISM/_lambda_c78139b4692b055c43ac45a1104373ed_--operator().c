/*
 * XREFs of _lambda_c78139b4692b055c43ac45a1104373ed_::operator() @ 0x1801919E4
 * Callers:
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_c78139b4692b055c43ac45a1104373ed_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x1801915B0 (--$_Callback_once@V-$tuple@$$QEAV_lambda_c78139b4692b055c43ac45a1104373ed_@@AEAVexception_ptr@st.c)
 * Callees:
...
void __fastcall lambda_c78139b4692b055c43ac45a1104373ed_::operator()(
        _QWORD *a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
{
  ...
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    ...
    v6,
    &v7);
  std::wstring::wstring(v12, (__int64)L"ScrollingScale");
  v13 = FLOAT_7_0;
  v14 = 2;
  std::wstring::wstring(v15, (__int64)L"ZoomingScale");
  v16 = FLOAT_0_029999999;
  v17 = 2;
  std::wstring::wstring(v18, (__int64)L"PointScaleFactor");
  v19 = FLOAT_0_037500001;
  v20 = 2;
  v7 = FLOAT_15_0;
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    (__int64)v21,
    (__int64)L"SelectXYDeadzone1M",
    &v7);
  v7 = FLOAT_2_0;
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    (__int64)v22,
    (__int64)L"SelectTemporalDeadzoneSec",
    &v7);
