/*
 * XREFs of ??0SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAA@PEAUIHidDevice@123@KKV?$function@$$A6AXXZ@std@@@Z @ 0x180169694
 * Callers:
 *     std::_Ref_count_obj_Windows::Internal::SpatialInteractions::SpatialInteractionSourceController_::_Ref_count_obj_Windows::Internal::SpatialInteractions::SpatialInteractionSourceController__Windows::Internal::SpatialInteractions::IHidDevice___&_unsigned_long_&_unsigned_long_&__lambda_538a60f2dfb0de3d5e0ccb23ebc37905___ @ 0x1800CC5AC (std--_Ref_count_obj_Windows--Internal--SpatialInteractions--SpatialInteractionSourceController_-.c)
 * Callees:
 ...
 *     ??0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ @ 0x1800CB3FC (--0HID_HANDLE@SpatialInteractionDevices@@QEAA@XZ.c)
 *     ??0?$function@$$A6AXXZ@std@@QEAA@$$QEAV01@@Z @ 0x18015655C (--0-$function@$$A6AXXZ@std@@QEAA@$$QEAV01@@Z.c)
 ...
 *     ??0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z @ 0x180169A0C (--0SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@KKW4InputType@@@Z.c)
        ...
        __int64 a5)
{
  ...
  *((_WORD *)this + 592) = 0;
  memset_0((char *)this + 1024, 0, 0xA0uLL);
  memset_0((char *)this + 960, 0, 0x40uLL);
  v19.m256i_i64[0] = qword_180208A50;
  v19.m256i_i32[2] = dword_180208A58;
  *(_OWORD *)((char *)&v19.m256i_u64[1] + 4) = xmmword_1801C6390;
