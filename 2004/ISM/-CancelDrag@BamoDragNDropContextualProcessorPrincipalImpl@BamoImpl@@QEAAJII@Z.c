/*
 * XREFs of ?CancelDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800F5984
 * Callers:
 *     ?Thunk_CancelDrag_112@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F60C0 (-Thunk_CancelDrag_112@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualP.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDragNDropContextualProcessorPrincipalImpl::CancelDrag(
        ...
        unsigned int a3)
{
  ...
  Microsoft::BamoImpl::DropAndReacquireLock::DropAndReacquireLock(
    ...
    v10);
  v14 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, char *))(*((_QWORD *)this - 2) + 80LL))(
          (char *)this - 16,
          v8,
          a2,
          v13);
