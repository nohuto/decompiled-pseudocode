/*
 * XREFs of ?AnyInputPressed@MPCGamepadProcessor@@AEAA_NXZ @ 0x180191CDC
 * Callers:
 *     ?IsEndOfCapture@MPCGamepadProcessor@@UEAA_NPEAUInputInfo@@@Z @ 0x1801924D0 (-IsEndOfCapture@MPCGamepadProcessor@@UEAA_NPEAUInputInfo@@@Z.c)
 *     ?IsStartOfCapture@MPCGamepadProcessor@@UEAA_NPEAUInputInfo@@@Z @ 0x1801924F0 (-IsStartOfCapture@MPCGamepadProcessor@@UEAA_NPEAUInputInfo@@@Z.c)
...
char __fastcall MPCGamepadProcessor::AnyInputPressed(MPCGamepadProcessor *this, __int64 a2, __int64 a3, const char *a4)
{
  ...
  if ( *((int *)this + 1169) > 0 )
    return 1;
  LODWORD(v6) = *((_DWORD *)this + 1175) & _xmm;
  ...
  *((_QWORD *)&v18 + 1) = 18LL;
  ...
  if ( v6 > COERCE_FLOAT(L"ThumbstickDeadzone") )
    return 1;
  LODWORD(v8) = *((_DWORD *)this + 1174) & _xmm;
  if ( !MPCConstantManager::s_instance )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      retaddr,
  ...
  *((_QWORD *)&v18 + 1) = 18LL;
  ...
  if ( v8 > COERCE_FLOAT(L"ThumbstickDeadzone") )
    return 1;
  LODWORD(v10) = *((_DWORD *)this + 1172) & _xmm;
  if ( !MPCConstantManager::s_instance )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      retaddr,
  ...
  *((_QWORD *)&v18 + 1) = 18LL;
  ...
  if ( v10 > COERCE_FLOAT(L"ThumbstickDeadzone") )
    return 1;
  LODWORD(v12) = *((_DWORD *)this + 1173) & _xmm;
  if ( !MPCConstantManager::s_instance )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      retaddr,
