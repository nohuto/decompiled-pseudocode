/*
 * XREFs of ?GetEnabled@BamoControllerNavigationManagerProxy@@UEAA_NXZ @ 0x1800E60A0
 * Callers:
 ...
 *     ?GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ @ 0x18011E2C0 (-GetEnabled@ControllerNavigationClientProxy@@UEAA_NXZ.c)
