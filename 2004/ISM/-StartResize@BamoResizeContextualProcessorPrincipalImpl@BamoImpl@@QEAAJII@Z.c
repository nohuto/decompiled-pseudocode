/*
 * XREFs of ?StartResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800FCC74
 * Callers:
 *     ?Thunk_StartResize_112@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FCE20 (-Thunk_StartResize_112@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProces.c)
 * Callees:
