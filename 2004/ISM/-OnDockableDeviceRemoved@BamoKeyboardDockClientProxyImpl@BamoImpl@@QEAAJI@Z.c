/*
 * XREFs of ?OnDockableDeviceRemoved@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180128DCC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoKeyboardDockClientProxyImpl::OnDockableDeviceRemoved(
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 4;
      return CoreUICallSend(v8, v10, 2LL, 44LL, v9, &unk_1801BF1BA, a2);
    }
    else
    {
