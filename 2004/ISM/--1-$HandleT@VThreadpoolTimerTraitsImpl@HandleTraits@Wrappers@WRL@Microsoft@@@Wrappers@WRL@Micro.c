/*
 * XREFs of ??1?$HandleT@VThreadpoolTimerTraitsImpl@HandleTraits@Wrappers@WRL@Microsoft@@@Wrappers@WRL@Microsoft@@QEAA@XZ @ 0x180169A84
 * Callers:
 *     _ThreadpoolTimerHelpers::KeepAliveTimer::KeepAliveTimer_::_1_::dtor$1 @ 0x1801694F4 (_ThreadpoolTimerHelpers--KeepAliveTimer--KeepAliveTimer_--_1_--dtor$1.c)
 * Callees:
 *     <none>
 */
