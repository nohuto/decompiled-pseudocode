 ...
 *     _Microsoft::Bamo::ListPrincipalCommon_Microsoft::Bamo::Lib::ISMBamos_AutoBamos::BamoList_PenDevicePrincipal_Principal_ISMBamos_AutoBamos::BamoConnection_wil::com_ptr_t_BamoPenDevicePrincipal_wil::err_returncode_policy___::RemoveAt_::_1_::dtor$0 @ 0x18012FFB2 (_Microsoft--Bamo--ListPrincipalCommon_Microsoft--Bamo--Lib--ISMBamos_AutoBamos--BamoList_PenDevi.c)
 ...
 *     _PenDeviceManager::RepopulateActiveBamoForId_::_1_::dtor$62 @ 0x180130459 (_PenDeviceManager--RepopulateActiveBamoForId_--_1_--dtor$62.c)
 * Callees:
