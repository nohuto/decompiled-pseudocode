/*
 * XREFs of ?ProcessDeviceNotifications@PnpDeviceWatcher@@QEAAJPEAK@Z @ 0x180026EC0
 * Callers:
 ...
 *     ?RemoveInterface@PnpDevice@@AEAAJPEAUHSTRING__@@@Z @ 0x1800A06FC (-RemoveInterface@PnpDevice@@AEAAJPEAUHSTRING__@@@Z.c)
 */
