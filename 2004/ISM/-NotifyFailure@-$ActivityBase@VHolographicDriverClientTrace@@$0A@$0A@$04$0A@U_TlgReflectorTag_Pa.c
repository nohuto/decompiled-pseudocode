/*
 * XREFs of ?NotifyFailure@?$ActivityBase@VHolographicDriverClientTrace@@$0A@$0A@$04$0A@U_TlgReflectorTag_Param0IsProviderType@@@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180160EE0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<HolographicDriverClientTrace,0,0,5,0,_TlgReflectorTag_Param0IsProviderType>::NotifyFailure(
        __int64 a1,
        int *a2)
{
  _DWORD *v4; // rcx
  ...
  v4 = *(_DWORD **)(wil::details::static_lazy<HolographicDriverClientTrace>::get(
                      a1,
