/*
 * XREFs of ?RuntimeClassInitialize@CursorSuppressionProcessor@@QEAAJV?$ComPtr@UISystemInputRouter@@@WRL@Microsoft@@@Z @ 0x180171910
 * Callers:
 ...
 *     ?AddRef@BaseBamoConnection@Bamo@Microsoft@@QEAAKXZ @ 0x180032618 (-AddRef@BaseBamoConnection@Bamo@Microsoft@@QEAAKXZ.c)
