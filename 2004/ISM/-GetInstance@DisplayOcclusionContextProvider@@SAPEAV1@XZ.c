/*
 * XREFs of ?GetInstance@DisplayOcclusionContextProvider@@SAPEAV1@XZ @ 0x180146C70
 * Callers:
...
struct DisplayOcclusionContextProvider *DisplayOcclusionContextProvider::GetInstance(void)
{
  ...
  if ( dword_180209518 > *(_DWORD *)(v1 + 16) )
  {
    Init_thread_header(&dword_180209518);
    if ( dword_180209518 == -1 )
    {
      atexit(DisplayOcclusionContextProvider::GetInstance_::_2_::_dynamic_atexit_destructor_for__s_instance__);
      Init_thread_footer(&dword_180209518);
    }
  }
