/*
 * XREFs of ?AllocateStub@BamoResizeContextualProcessorPrincipal@@MEAAJPEAVBamoPeer@ISMBamos_AutoBamos@@PEAPEAVBamoResizeContextualProcessorStub@@@Z @ 0x180010210
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoResizeContextualProcessorPrincipal::AllocateStub(
