/*
 * XREFs of ?CreateAndInitialize@HidLampMultiUpdateReportBuilder@@SAJPEAVHidLampArrayDevice@@IPEAPEAV1@@Z @ 0x1800A9400
 * Callers:
 ...
 *     ??0HidLampMultiUpdateReportBuilder@@AEAA@XZ @ 0x1800A9278 (--0HidLampMultiUpdateReportBuilder@@AEAA@XZ.c)
