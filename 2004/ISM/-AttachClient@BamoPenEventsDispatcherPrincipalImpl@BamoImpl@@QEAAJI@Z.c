/*
 * XREFs of ?AttachClient@BamoPenEventsDispatcherPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1801326EC
 * Callers:
 *     ?Thunk_AttachClient_10@?$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1801348B0 (-Thunk_AttachClient_10@-$IPenEventsDispatcherPrincipal_Receive@VBamoPenEventsDispatcherPrincipal.c)
 * Callees:
