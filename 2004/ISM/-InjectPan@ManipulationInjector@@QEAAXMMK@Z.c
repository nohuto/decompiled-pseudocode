/*
 * XREFs of ?InjectPan@ManipulationInjector@@QEAAXMMK@Z @ 0x1800C3134
 * Callers:
 ...
 *     ?RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z @ 0x1800C379C (-RoundSubPixelToPixel@ManipulationInjector@@AEAAJM@Z.c)
