/*
 * XREFs of ??1DeviceRemoved@SpatialInteractionTrace@SpatialInteractionDevices@@QEAA@XZ @ 0x1800CE130
 * Callers:
 *     __lambda_bf3e2a6d2db6a722ad52163451912338_::operator()_::_1_::dtor$0 @ 0x1800CE8FA (__lambda_bf3e2a6d2db6a722ad52163451912338_--operator()_--_1_--dtor$0.c)
 * Callees:
