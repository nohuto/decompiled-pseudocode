/*
 * XREFs of ?BeginInitialize@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJXZ @ 0x18016A7B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetTicks@PerfCounter@@YA_JXZ @ 0x18007DA5C (-GetTicks@PerfCounter@@YA_JXZ.c)
 ...
 *     ??B_Atomic_llong@std@@QEBA_JXZ @ 0x180169E98 (--B_Atomic_llong@std@@QEBA_JXZ.c)
 */
