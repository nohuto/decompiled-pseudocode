/*
 * XREFs of ?Clear@?$NtList@UWaitListEntry@AggregateWaitHandle@@@@QEAAXXZ @ 0x1800BF8EC
 * Callers:
 *     ??1AggregateWaitHandle@@QEAA@XZ @ 0x1800BED40 (--1AggregateWaitHandle@@QEAA@XZ.c)
 *     ?Reset@AggregateWaitHandle@@QEAAXXZ @ 0x1800C1710 (-Reset@AggregateWaitHandle@@QEAAXXZ.c)
 * Callees:
