/*
 * XREFs of ??1SpatialInteractionSourceObject@SpatialInteractions@Internal@Windows@@UEAA@XZ @ 0x1800D5D24
 * Callers:
 *     ??_GSpatialInteractionSourceObject@SpatialInteractions@Internal@Windows@@UEAAPEAXI@Z @ 0x1800D67A0 (--_GSpatialInteractionSourceObject@SpatialInteractions@Internal@Windows@@UEAAPEAXI@Z.c)
 *     _Windows::Internal::SpatialInteractions::SpatialInteractionEyeGazeSourceObject::SpatialInteractionEyeGazeSourceObject_::_1_::dtor$0 @ 0x1800DB398 (_Windows--Internal--SpatialInteractions--SpatialInteractionEyeGazeSourceObject--SpatialInteracti.c)
 ...
 *     _Windows::Internal::SpatialInteractions::SpatialInteractionSourceHand::SpatialInteractionSourceHand_::_1_::dtor$0 @ 0x1800DE59A (_Windows--Internal--SpatialInteractions--SpatialInteractionSourceHand--SpatialInteractionSourceH.c)
 *     ??1SpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@UEAA@XZ @ 0x1800DE5C0 (--1SpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@UEAA@XZ.c)
 * Callees:
 ...
 *     ??1SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@XZ @ 0x1800D5CD8 (--1SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAA@XZ.c)
