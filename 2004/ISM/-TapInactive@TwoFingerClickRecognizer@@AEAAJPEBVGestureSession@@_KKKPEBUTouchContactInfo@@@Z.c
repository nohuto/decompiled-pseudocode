/*
 * XREFs of ?TapInactive@TwoFingerClickRecognizer@@AEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x180186448
 * Callers:
 *     ?Add@TwoFingerClickRecognizer@@UEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z @ 0x180186000 (-Add@TwoFingerClickRecognizer@@UEAAJPEBVGestureSession@@_KKKPEBUTouchContactInfo@@@Z.c)
 * Callees:
        ...
        const struct TouchContactInfo *a6)
{
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    if ( a5 <= 2 )
    {
      ...
      v17.x = *((_DWORD *)v9 + 1) - *((_DWORD *)v9 + 11);
      v17.y = *((_DWORD *)v9 + 2) - *((_DWORD *)v9 + 12);
