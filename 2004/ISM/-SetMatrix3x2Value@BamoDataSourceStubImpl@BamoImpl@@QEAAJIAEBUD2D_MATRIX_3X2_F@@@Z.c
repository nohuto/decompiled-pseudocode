/*
 * XREFs of ?SetMatrix3x2Value@BamoDataSourceStubImpl@BamoImpl@@QEAAJIAEBUD2D_MATRIX_3X2_F@@@Z @ 0x180143A1C
 * Callers:
...
LABEL_3:
  ...
  v13 = v8;
  v14 = v9;
  return CoreUICallSend(v11, v12, 2LL, 5LL, v10, &unk_1801C09AF, a2);
}
