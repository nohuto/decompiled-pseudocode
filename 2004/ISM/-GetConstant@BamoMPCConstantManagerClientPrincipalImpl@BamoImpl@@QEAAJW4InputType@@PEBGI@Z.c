/*
 * XREFs of ?GetConstant@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJW4InputType@@PEBGI@Z @ 0x18006E88C
 * Callers:
 *     ?Thunk_GetConstant_16@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180070330 (-Thunk_GetConstant_16@-$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClient.c)
 * Callees:
