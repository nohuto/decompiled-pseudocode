/*
 * XREFs of ?OnInputReport@MPCInputProviderBase@@UEAAJPEAUInputInfo@@@Z @ 0x1800844C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsDesiredCursorActive@MPCHolographicInputManager@@QEAA_NW4InputType@@@Z @ 0x1800400CC (-IsDesiredCursorActive@MPCHolographicInputManager@@QEAA_NW4InputType@@@Z.c)
