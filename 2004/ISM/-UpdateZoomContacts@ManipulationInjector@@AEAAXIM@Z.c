/*
 * XREFs of ?UpdateZoomContacts@ManipulationInjector@@AEAAXIM@Z @ 0x1800C3E24
 * Callers:
 *     ?InjectZoom@ManipulationInjector@@QEAAXMK@Z @ 0x1800C3508 (-InjectZoom@ManipulationInjector@@QEAAXMK@Z.c)
 * Callees:
 *     ?UpdateZoomPoints@ManipulationInjector@@AEAAXAEAUtagPOINT@@0M@Z @ 0x1800C3F1C (-UpdateZoomPoints@ManipulationInjector@@AEAAXAEAUtagPOINT@@0M@Z.c)
 */
