/*
 * XREFs of ?ApplyNavigationDelta@ControllerProcessor@@AEAAJXZ @ 0x18011FAC4
 * Callers:
 ...
 *     ?SendPointerDelta@ControllerProcessor@@AEAAJUtagPOINT@@@Z @ 0x1801223EC (-SendPointerDelta@ControllerProcessor@@AEAAJUtagPOINT@@@Z.c)
