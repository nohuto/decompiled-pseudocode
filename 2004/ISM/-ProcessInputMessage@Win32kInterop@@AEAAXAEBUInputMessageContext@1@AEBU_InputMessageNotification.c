/*
 * XREFs of ?ProcessInputMessage@Win32kInterop@@AEAAXAEBUInputMessageContext@1@AEBU_InputMessageNotification@@_N2@Z @ 0x1800B10FC
 * Callers:
 ...
 *     ?IsIdentityTransform@CInputTransform@@SA_NAEBUtagINPUT_TRANSFORM@@@Z @ 0x1800B0914 (-IsIdentityTransform@CInputTransform@@SA_NAEBUtagINPUT_TRANSFORM@@@Z.c)
...
LABEL_8:
  ...
  *((_QWORD *)v12 + 29) = (unsigned int)v43[1];
  ...
  {
    *((_WORD *)v31 + 98) = word_1801D5640[v33];
    v31 = v43;
    v34 = *((_WORD *)v43 + 98);
