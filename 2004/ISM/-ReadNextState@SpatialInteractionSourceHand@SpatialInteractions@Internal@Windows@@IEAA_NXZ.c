/*
 * XREFs of ?ReadNextState@SpatialInteractionSourceHand@SpatialInteractions@Internal@Windows@@IEAA_NXZ @ 0x1800E1070
 * Callers:
 ...
 *     ??$SpatialObjectReadNextStateError@U_GUID@@AEAJAEA_J@SpatialInteractionTrace@SpatialInteractionDevices@@SAX$$QEAU_GUID@@AEAJAEA_J@Z @ 0x1800DB050 (--$SpatialObjectReadNextStateError@U_GUID@@AEAJAEA_J@SpatialInteractionTrace@SpatialInteractionD.c)
 ...
 *     _lambda_884804a5d7b2f3f35eb5156002e4322b_::operator() @ 0x1800DE674 (_lambda_884804a5d7b2f3f35eb5156002e4322b_--operator().c)
        ...
        Windows::Internal::SpatialInteractions::SpatialInteractionSourceHand *this)
{
  ...
  if ( v3 >= 0 && v31 == *((_QWORD *)this + 28) )
  {
    ...
    *(_QWORD *)v32.Data4 = &v31;
    if ( *((_BYTE *)this + 385)
      || (v7 = 1, !lambda_884804a5d7b2f3f35eb5156002e4322b_::operator()((unsigned __int64 **)&v32, (__int64 *)this + 22)) )
    {
      v7 = 0;
    }
    v8 = *((_BYTE *)this + 385);
    ...
    v12 = *((_DWORD *)this + 65);
    if ( v8
      || (v13 = 1, !lambda_884804a5d7b2f3f35eb5156002e4322b_::operator()(
                      (unsigned __int64 **)&v32,
                      (__int64 *)this + 24)) )
    {
      v13 = 0;
    }
    v14 = lambda_884804a5d7b2f3f35eb5156002e4322b_::operator()((unsigned __int64 **)&v32, (__int64 *)this + 21);
    v30 = lambda_884804a5d7b2f3f35eb5156002e4322b_::operator()((unsigned __int64 **)&v32, (__int64 *)this + 25);
    *((_DWORD *)this + 67) = 0;
    if ( v30 )
      *((_DWORD *)this + 67) = 16;
    if ( v7 )
    ...
    if ( *((_QWORD *)this + 26) )
    {
      ...
      wil::details::in1diag3::FailFast_IfNullMsg<enum SPATIAL_GAZE_CALIBRATION_STATE const *,0>(
        ...
        (__int64)"onecoreuap\\analog\\input\\spatialinteractionclientlib\\hands\\spatialinteractionsourcehand.cpp",
        (__int64)v16);
      *(_OWORD *)((char *)this + 276) = *v16;
      *(_OWORD *)((char *)this + 292) = v16[1];
    }
    if ( *((_QWORD *)this + 27) )
    {
      ...
      wil::details::in1diag3::FailFast_IfNullMsg<enum SPATIAL_GAZE_CALIBRATION_STATE const *,0>(
        ...
        (__int64)"onecoreuap\\analog\\input\\spatialinteractionclientlib\\hands\\spatialinteractionsourcehand.cpp",
        (__int64)v17);
      *(_OWORD *)((char *)this + 308) = *v17;
      *(_OWORD *)((char *)this + 324) = v17[1];
    }
    v18 = (__int64 *)*((_QWORD *)this + 43);
    v19 = *v18;
    *(_QWORD *)&v32.Data1 = *v18;
    ...
    if ( SpatialInteractionDevices::SpatialInteractionTraceContinuous::IsEnabled(v25) )
    {
      ...
      SpatialInteractionDevices::SpatialInteractionTraceContinuous::HandStateRead_(
        (SpatialInteractionDevices::SpatialInteractionTraceContinuous *)*((unsigned int *)this + 65),
        &v32,
        *v33,
        v14,
        v7,
