/*
 * XREFs of ??0hstring@param@winrt@@QEAA@AEBV?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x180033AD8
 * Callers:
 ...
 * Callees:
 *     WINRT_WindowsCreateStringReference @ 0x18003CF27 (WINRT_WindowsCreateStringReference.c)
 */
