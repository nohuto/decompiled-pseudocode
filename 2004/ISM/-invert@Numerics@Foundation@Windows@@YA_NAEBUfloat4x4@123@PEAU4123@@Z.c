/*
 * XREFs of ?invert@Numerics@Foundation@Windows@@YA_NAEBUfloat4x4@123@PEAU4123@@Z @ 0x18007940C
 * Callers:
        ...
        struct Windows::Foundation::Numerics::float4x4 *a3)
{
  ...
  if ( COERCE_FLOAT(LODWORD(v19) & _xmm) >= 0.00000011920929 )
  {
    ...
    *((_DWORD *)a2 + 9) = COERCE_UNSIGNED_INT(
                            (float)((float)((float)(v10 * v34) - (float)(v12 * v44)) + (float)(v14 * v46))
                          * (float)(1.0 / v19)) ^ _xmm;
    *((_DWORD *)a2 + 1) = COERCE_UNSIGNED_INT(
                            (float)((float)((float)(v9 * v44) - (float)(v10 * v45)) + (float)(v11 * v46))
                          * (float)(1.0 / v19)) ^ _xmm;
    ...
    *((_DWORD *)a2 + 6) = COERCE_UNSIGNED_INT((float)((float)((float)(v22 * v34) - (float)(v25 * v45))
                                                    + (float)(v26 * v46)) * v21) ^ _xmm;
    *((float *)a2 + 10) = (float)((float)((float)(v23 * v34) - (float)(v25 * v44)) + (float)(v27 * v46)) * v21;
    *((_DWORD *)a2 + 14) = COERCE_UNSIGNED_INT((float)((float)((float)(v24 * v34) - (float)(v26 * v44))
                                                     + (float)(v27 * v45)) * v21) ^ _xmm;
    ...
    result = 1;
    *((_DWORD *)a2 + 3) = COERCE_UNSIGNED_INT((float)((float)((float)(v28 * v44) - (float)(v29 * v45))
                                                    + (float)(v30 * v46)) * v21) ^ _xmm;
    *((_DWORD *)a2 + 11) = COERCE_UNSIGNED_INT((float)((float)((float)(v29 * v34) - (float)(v31 * v44))
                                                     + (float)(v33 * v46)) * v21) ^ _xmm;
