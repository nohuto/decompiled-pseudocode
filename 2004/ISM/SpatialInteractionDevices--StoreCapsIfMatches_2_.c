/*
 * XREFs of SpatialInteractionDevices::StoreCapsIfMatches_2_ @ 0x1800C7CC4
 * Callers:
...
__int64 __fastcall SpatialInteractionDevices::StoreCapsIfMatches_2_(__int64 a1, __int64 a2, __int64 a3, _BYTE *a4)
{
