/*
 * XREFs of ?Materialize_BamoPenEventsDispatcherProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7D20
 * Callers:
 *     ?Thunk_Materialize_BamoPenEventsDispatcherProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECC80 (-Thunk_Materialize_BamoPenEventsDispatcherProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoP.c)
 * Callees:
