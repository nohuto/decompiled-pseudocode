/*
 * XREFs of ?ResendGamepadIsSupportedForProcess@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1800737E4
 * Callers:
 *     ?Thunk_ResendGamepadIsSupportedForProcess_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800744B0 (-Thunk_ResendGamepadIsSupportedForProcess_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrinc.c)
 * Callees:
