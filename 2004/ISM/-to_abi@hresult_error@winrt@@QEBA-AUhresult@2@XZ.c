/*
 * XREFs of ?to_abi@hresult_error@winrt@@QEBA?AUhresult@2@XZ @ 0x1800BE420
 * Callers:
 *     _winrt::to_hresult_::_1_::catch$19 @ 0x1800BE4AE (_winrt--to_hresult_--_1_--catch$19.c)
 ...
 * Callees:
 *     WINRT_SetRestrictedErrorInfo @ 0x18003CF33 (WINRT_SetRestrictedErrorInfo.c)
 */
