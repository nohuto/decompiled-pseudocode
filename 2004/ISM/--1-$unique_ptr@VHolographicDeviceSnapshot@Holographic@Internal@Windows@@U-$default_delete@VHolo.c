/*
 * XREFs of ??1?$unique_ptr@VHolographicDeviceSnapshot@Holographic@Internal@Windows@@U?$default_delete@VHolographicDeviceSnapshot@Holographic@Internal@Windows@@@std@@@std@@QEAA@XZ @ 0x18003B5E0
 * Callers:
 *     ??__Fs_spDeviceSnapshot@?1??Instance@HolographicDeviceSnapshot@Holographic@Internal@Windows@@KAAEAV1234@XZ@YAXXZ @ 0x180051940 (--__Fs_spDeviceSnapshot@-1--Instance@HolographicDeviceSnapshot@Holographic@Internal@Windows@@KAA.c)
 * Callees:
