/*
 * XREFs of ?SendMaterializeProxy@BamoInputSiteManagerPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18000EE10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v16, 2LL, 74LL, 31, &unk_1801BF1BA, v14);
  if ( v8 < 0 )
  {
