/*
 * XREFs of ?CursorShapeAnimationCreated@BamoSystemCursorControllerClientProxyImpl@BamoImpl@@QEAAJ_K000@Z @ 0x1800E46C4
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 4;
      return CoreUICallSend(v8, v11, 2LL, 64LL, v9, &unk_1801BF2C1, a2);
    }
    else
    {
