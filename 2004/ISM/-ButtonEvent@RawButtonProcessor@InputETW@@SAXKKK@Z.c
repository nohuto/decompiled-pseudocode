/*
 * XREFs of ?ButtonEvent@RawButtonProcessor@InputETW@@SAXKKK@Z @ 0x180181E18
 * Callers:
...
void __fastcall InputETW::RawButtonProcessor::ButtonEvent(__int64 a1, int a2, unsigned int a3)
{
  ...
  if ( InputETW::IsEnabled(a1) )
  {
    ...
    if ( **((_DWORD **)v7 + 1) > 5u && tlgKeywordOn(*((_QWORD *)v7 + 1), 1LL) )
    {
      ...
      v11 = v5;
      v21 = 8;
      tlgWriteTransfer_EventWriteTransfer(v9, (unsigned __int8 *)dword_1801D161E, 0LL, 0LL, 5u, &v13);
    }
  }
}
