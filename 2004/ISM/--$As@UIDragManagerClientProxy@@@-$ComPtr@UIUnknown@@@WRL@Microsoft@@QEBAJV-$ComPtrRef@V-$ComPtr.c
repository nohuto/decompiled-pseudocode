/*
 * XREFs of ??$As@UIDragManagerClientProxy@@@?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEBAJV?$ComPtrRef@V?$ComPtr@UIDragManagerClientProxy@@@WRL@Microsoft@@@Details@12@@Z @ 0x1800F1B64
 * Callers:
