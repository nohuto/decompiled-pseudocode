 ...
 * Callers:
 *     ?QueryInterface@GameControllerRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004A9F0 (-QueryInterface@GameControllerRawInputProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GameControllerRawInputProvider@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004AA00 (-QueryInterface@GameControllerRawInputProvider@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@GameControllerRawInputProvider@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004AA10 (-QueryInterface@GameControllerRawInputProvider@@WBI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
 *     <none>
 */
