/*
 * XREFs of ??0PenEventsDispatcherPrincipal@@QEAA@PEAVBamoConnection@ISMBamos_AutoBamos@@@Z @ 0x18002FC7C
 * Callers:
 ...
 *     ??0?$KernelInputConnection@U_MIT_PEN_EVENT_MESSAGE@@@@QEAA@PEBD@Z @ 0x1800471E0 (--0-$KernelInputConnection@U_MIT_PEN_EVENT_MESSAGE@@@@QEAA@PEBD@Z.c)
