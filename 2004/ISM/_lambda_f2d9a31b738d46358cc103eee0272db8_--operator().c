/*
 * XREFs of _lambda_f2d9a31b738d46358cc103eee0272db8_::operator() @ 0x180158448
 * Callers:
 ...
 *     ??$AreValidFloats@UXMFLOAT3@DirectX@@@@YA_NAEBUXMFLOAT3@DirectX@@@Z @ 0x18014DFF0 (--$AreValidFloats@UXMFLOAT3@DirectX@@@@YA_NAEBUXMFLOAT3@DirectX@@@Z.c)
 *     ??$GetPoseAtTime@AEBQEAVSpatialGraphNodeReference@Holographic@Internal@Windows@@AEAUSPATIAL_NODE_ID@@AEA_JAEB_JAEB_JAEA_JAEA_JAEAW4TracePredictionType@@AEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@AEB_NAEBI@HolographicDriverClientContinuousTrace@@SAXAEBQEAVSpatialGraphNodeReference@Holographic@Internal@Windows@@AEAUSPATIAL_NODE_ID@@AEA_JAEB_J322AEAW4TracePredictionType@@AEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@AEB_NAEBI@Z @ 0x18014E5D0 (--$GetPoseAtTime@AEBQEAVSpatialGraphNodeReference@Holographic@Internal@Windows@@AEAUSPATIAL_NODE.c)
 *     ??$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ?AW4OrthonormalMatrixValidationFailures@1@UXMMATRIX@1@@Z @ 0x18014F704 (--$ValidateOrthonormalRightHandedMatrix@$00@Details@DirectX@@YQ-AW4OrthonormalMatrixValidationFa.c)
 *     Windows::Internal::Holographic::HolographicDeviceSnapshot::Write_Windows::Internal::Holographic::TrackedDeviceSnapshot__lambda_3f94c1c330aebc4cd0e0e5305e75e493___ @ 0x180150FC8 (Windows--Internal--Holographic--HolographicDeviceSnapshot--Write_Windows--Internal-_ea_180150FC8.c)
 ...
 *     ?XMMatrixRTInverse@DirectX@@YQ?AUXMMATRIX@1@U21@@Z @ 0x180166AD0 (-XMMatrixRTInverse@DirectX@@YQ-AUXMMATRIX@1@U21@@Z.c)
...
void __fastcall lambda_f2d9a31b738d46358cc103eee0272db8_::operator()(__int64 **a1)
{
  ...
  if ( v8 && !v7 )
  {
    *(_QWORD *)v4 = qword_180208A30;
    *(_DWORD *)(v4 + 8) = dword_180208A38;
...
LABEL_16:
  if ( (*(_BYTE *)(v19 + 16) & 2) == 0 )
  {
    *(_OWORD *)(v12 + 36) = xmmword_1801C6338;
    *(_OWORD *)(v12 + 52) = xmmword_1801C6348;
  ...
  do
  {
    ...
    {
      *(_QWORD *)v26 = qword_180208A30;
      *((_DWORD *)v26 + 2) = dword_180208A38;
  ...
  if ( ((*v3)[13] & 0x10) == 0 )
  {
    ...
    if ( (*(_BYTE *)(v35 + 16) & 2) != 0 )
    {
      ...
      *(double *)v39.m128_u64 = DirectX::XMMatrixRTInverse();
      v41 = _mm_movelh_ps((__m128)(unsigned __int64)qword_180207AA8, (__m128)(unsigned int)dword_180207AB0);
      v42 = _mm_add_ps(
              _mm_add_ps(
