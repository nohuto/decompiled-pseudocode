/*
 * XREFs of ?SetButtonRoutingPolicy@BamoPenEventsDispatcherProxyImpl@BamoImpl@@QEAAJW4RoutingPolicy@Input@Devices@Internal@Windows@@@Z @ 0x1800EC42C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoPenEventsDispatcherProxyImpl::SetButtonRoutingPolicy(__int64 a1, int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 1;
      return CoreUICallSend(v8, v10, 2LL, 54LL, v9, &unk_1801BF1C0, a2);
    }
    else
    {
