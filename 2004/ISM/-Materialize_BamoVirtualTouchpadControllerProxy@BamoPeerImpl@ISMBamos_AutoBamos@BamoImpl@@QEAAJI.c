/*
 * XREFs of ?Materialize_BamoVirtualTouchpadControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E8434
 * Callers:
 *     ?Thunk_Materialize_BamoVirtualTouchpadControllerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECD90 (-Thunk_Materialize_BamoVirtualTouchpadControllerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@.c)
 * Callees:
