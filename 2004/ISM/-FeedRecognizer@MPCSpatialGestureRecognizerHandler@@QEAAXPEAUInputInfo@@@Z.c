/*
 * XREFs of ?FeedRecognizer@MPCSpatialGestureRecognizerHandler@@QEAAXPEAUInputInfo@@@Z @ 0x1800804AC
 * Callers:
        ...
        struct InputInfo *a2)
{
  ...
  __int64 v185; // rdx
  int v186; // eax
  __int128 v187; // [rsp+38h] [rbp-D0h] BYREF
  __int128 v188; // [rsp+48h] [rbp-C0h]
  __int128 v189; // [rsp+58h] [rbp-B0h]
  __int128 v190; // [rsp+68h] [rbp-A0h] BYREF
  __int128 v191; // [rsp+78h] [rbp-90h]
  __int128 v192; // [rsp+88h] [rbp-80h]
  __int128 v193; // [rsp+98h] [rbp-70h]
  __int128 v194; // [rsp+A8h] [rbp-60h]
  __int128 v195; // [rsp+B8h] [rbp-50h]
  __int128 v196; // [rsp+C8h] [rbp-40h]
  __int128 v197; // [rsp+D8h] [rbp-30h]
  __int128 v198; // [rsp+E8h] [rbp-20h]
  __int128 v199; // [rsp+F8h] [rbp-10h]
  __int128 v200; // [rsp+108h] [rbp+0h]
  __int128 v201; // [rsp+118h] [rbp+10h]
  __int128 v202; // [rsp+128h] [rbp+20h]
  __int128 v203; // [rsp+138h] [rbp+30h]
  __int128 v204; // [rsp+148h] [rbp+40h]
  __int64 v205; // [rsp+158h] [rbp+50h]
