/*
 * XREFs of ?Materialize_BamoCustomCursorControllerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E6C04
 * Callers:
 *     ?Thunk_Materialize_BamoCustomCursorControllerClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECA60 (-Thunk_Materialize_BamoCustomCursorControllerClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Recei.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoCustomCursorControllerClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoCustomCursorControllerClientProxy::`vftable'{for `ICustomCursorControllerClientProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
