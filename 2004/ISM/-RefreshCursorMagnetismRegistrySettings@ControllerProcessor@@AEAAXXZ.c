/*
 * XREFs of ?RefreshCursorMagnetismRegistrySettings@ControllerProcessor@@AEAAXXZ @ 0x1801216C8
 * Callers:
 *     _lambda_828562b8234057b7c70d01bfff3fe312_::_lambda_invoker_cdecl_ @ 0x18011EC50 (_lambda_828562b8234057b7c70d01bfff3fe312_--_lambda_invoker_cdecl_.c)
 *     ?Initialize@ControllerProcessor@@IEAAJXZ @ 0x180120AA0 (-Initialize@ControllerProcessor@@IEAAJXZ.c)
 * Callees:
 *     _lambda_9421d204e635201636d0a16c341872b8_::operator() @ 0x18011F884 (_lambda_9421d204e635201636d0a16c341872b8_--operator().c)
 *     ?ConvertDIPSToPixels@ControllerProcessor@@AEAAKAEBK@Z @ 0x1801206B8 (-ConvertDIPSToPixels@ControllerProcessor@@AEAAKAEBK@Z.c)
 */
...
void __fastcall ControllerProcessor::RefreshCursorMagnetismRegistrySettings(ControllerProcessor *this)
{
  ...
  *((_DWORD *)this + 1928) = ControllerProcessor::ConvertDIPSToPixels(v10, &v20);
  v20 = 100;
  v20 = lambda_9421d204e635201636d0a16c341872b8_::operator()(v11, L"SearchHeightInDIPS", &v20);
  *((_DWORD *)this + 1929) = ControllerProcessor::ConvertDIPSToPixels(v12, &v20);
  v14 = 0LL;
  ...
  *((_QWORD *)this + 946) = _mm_unpacklo_ps(v14, v16).m128_u64[0];
  *((_DWORD *)this + 1894) = v18;
  *((_QWORD *)this + 960) = 10000 * v5;
  v19 = 10000LL * *((_QWORD *)this + 963);
  *((_QWORD *)this + 961) = 10000 * v7;
  *((_QWORD *)this + 962) = v19;
}
