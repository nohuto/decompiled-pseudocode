/*
 * XREFs of ?Create@ControllerProcessor@@SAJPEAUInputProcessorCreateParams@@PEAPEAUIInputProcessor@@@Z @ 0x180120740
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?IsPointerDevice@@YAHPEBUDeviceInfo@@@Z @ 0x180148FDC (-IsPointerDevice@@YAHPEBUDeviceInfo@@@Z.c)
 */
...
LABEL_3:
  ...
  v7 = (ControllerProcessor *)RefCountedObject::operator new(0x1E60uLL);
  if ( v7 )
