/*
 * XREFs of ?OnKeyboardDockInput@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJIAEBUKeyboardDockInput@@@Z @ 0x18012907C
 * Callers:
        ...
        const struct KeyboardDockInput *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v8 >= 0 )
    {
      ...
      v17 = v12;
      v18 = v13;
      return CoreUICallSend(v10, v15, 2LL, 44LL, v14, &unk_1801BF255, a2);
    }
    else
    {
