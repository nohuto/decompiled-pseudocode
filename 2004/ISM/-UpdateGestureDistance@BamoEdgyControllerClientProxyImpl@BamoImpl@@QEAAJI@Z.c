/*
 * XREFs of ?UpdateGestureDistance@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800FFEB8
 * Callers:
 ...
 *     ?Thunk_UpdateGestureDistance_10@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FFDC0 (-Thunk_UpdateGestureDistance_10@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientPr.c)
 * Callees:
