/*
 * XREFs of ?TryCreateAndInitialize@HidLampAttributesResponseReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800AA9A4
 * Callers:
 ...
 *     ??0HidLampAttributesResponseReportParser@@AEAA@XZ @ 0x1800AA274 (--0HidLampAttributesResponseReportParser@@AEAA@XZ.c)
