/*
 * XREFs of ?Initialize@DockDevice@@QEAAJPEAUDockDeviceInfo@@@Z @ 0x18009E1D8
 * Callers:
...
__int64 __fastcall DockDevice::Initialize(DockDevice *this, struct DockDeviceInfo *a2)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *(_QWORD *)&v40 = LinkCollectionNodes;
    ...
    if ( v10 >= 0 )
    {
      if ( dword_18020950C > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                       + 16LL) )
      {
        Init_thread_header(&dword_18020950C);
        if ( dword_18020950C == -1 )
        {
          dword_1802093A8 = 2;
          *(_OWORD *)&xmmword_180209398 = DEVPKEY_Device_PanelId;
          dword_1802093AC = 0;
          qword_1802093B0 = 0LL;
          Init_thread_footer(&dword_18020950C);
        }
      }
