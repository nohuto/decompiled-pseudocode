/*
 * XREFs of _lambda_b16aee874608ec8ce55934157fa7dff9_::operator() @ 0x18007D478
 * Callers:
 *     ??$_Callback_once@V?$tuple@$$QEAV_lambda_b16aee874608ec8ce55934157fa7dff9_@@AEAVexception_ptr@std@@@std@@U?$integer_sequence@_K$0A@@2@$00@std@@YAHPEAX0PEAPEAX@Z @ 0x18007CD30 (--$_Callback_once@V-$tuple@$$QEAV_lambda_b16aee874608ec8ce55934157fa7dff9_@@AEAVexception_ptr@st.c)
 * Callees:
...
void __fastcall lambda_b16aee874608ec8ce55934157fa7dff9_::operator()(
        _QWORD *a1,
        __int64 a2,
        __int64 a3,
        const char *a4)
{
  ...
  std::wstring::wstring(v9, (__int64)L"DisableInputInjection");
  v10 = 0;
  v11 = 1;
  v6 = FLOAT_0_89999998;
  ...
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    ...
    &v6);
  std::wstring::wstring(v15, (__int64)L"TouchXYDeadzone1M");
  v16 = FLOAT_100_0;
  v17 = 2;
  v6 = FLOAT_10_0;
  std::pair<std::wstring const,std::variant<unsigned long,bool,float>>::pair<std::wstring const,std::variant<unsigned long,bool,float>>(
    ...
    &v6);
  std::wstring::wstring(v19, (__int64)L"TouchInjectionContactAreaRadius");
  v20 = 25;
  v21 = 0;
