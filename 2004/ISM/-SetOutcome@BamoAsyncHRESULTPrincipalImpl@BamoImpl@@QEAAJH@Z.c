/*
 * XREFs of ?SetOutcome@BamoAsyncHRESULTPrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x18011B8B4
 * Callers:
 *     ?Thunk_SetOutcome_0@?$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011B9B0 (-Thunk_SetOutcome_0@-$IAsyncHRESULTPrincipal_Receive@VBamoAsyncHRESULTPrincipalImpl@BamoImpl@@@@.c)
 * Callees:
