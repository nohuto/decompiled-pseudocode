/*
 * XREFs of ?HandStateReaderInitialized_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXAEBU_GUID@@_N1111@Z @ 0x1800DFBE8
 * Callers:
        ...
        bool a7)
{
  ...
  if ( **((_DWORD **)v10 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v10 + 1), 2LL) )
  {
    ...
    v18 = a2;
    v19 = 16LL;
    tlgWriteTransfer_EventWriteTransfer(v11, (unsigned __int8 *)dword_1801CCC78, 0LL, 0LL, 8u, &v17);
  }
}
