/*
 * XREFs of ?ReceiveInterceptMessage@ISM@InputTraceLogging@@SAXPEBURawMouseInputInfo@@@Z @ 0x1800B2144
 * Callers:
...
void __fastcall InputTraceLogging::ISM::ReceiveInterceptMessage(const struct RawMouseInputInfo *a1)
{
  ...
  if ( **((_DWORD **)v2 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v2 + 1), 512LL) )
  {
    ...
    v8 = 8;
    v7 = &v5;
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1801CA2FD, 0LL, 0LL, 3u, &v6);
  }
}
