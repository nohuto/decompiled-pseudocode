/*
 * XREFs of ?Thunk_Materialize_BamoHeatGripServiceProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECB30
 * Callers:
 *     <none>
 * Callees:
