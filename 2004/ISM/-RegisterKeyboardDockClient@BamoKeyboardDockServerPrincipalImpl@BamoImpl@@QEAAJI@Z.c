/*
 * XREFs of ?RegisterKeyboardDockClient@BamoKeyboardDockServerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x1801271E8
 * Callers:
 *     ?Thunk_RegisterKeyboardDockClient_10@?$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockServerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180127EB0 (-Thunk_RegisterKeyboardDockClient_10@-$IKeyboardDockServerPrincipal_Receive@VBamoKeyboardDockSer.c)
 * Callees:
