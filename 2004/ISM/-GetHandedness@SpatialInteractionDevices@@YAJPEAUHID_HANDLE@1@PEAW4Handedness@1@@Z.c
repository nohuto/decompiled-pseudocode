/*
 * XREFs of ?GetHandedness@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEAW4Handedness@1@@Z @ 0x1800C9068
 * Callers:
 ...
 *     SpatialInteractionDevices::UpdateFeatureReportIfNeeded @ 0x1800CA4C8 (SpatialInteractionDevices--UpdateFeatureReportIfNeeded.c)
 */
        ...
        enum SpatialInteractionDevices::Handedness *a3)
{
  ...
  void *v20; // [rsp+28h] [rbp-48h] BYREF
  ...
  if ( *((_DWORD *)v23 + 50) )
  {
    while ( 1 )
    {
      ...
      if ( (updated & 0x80000000) != 0 )
        goto LABEL_29;
      v14 = lambda_36699d656eba53771815ebb77b348360_::operator()(
              (__int64)v21,
              *(_WORD *)(v13 + 72LL * v11),
...
LABEL_22:
    ...
    while ( *((_WORD *)v20 + (unsigned int)v10) != v15 )
    {
LABEL_21:
