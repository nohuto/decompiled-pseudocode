/*
 * XREFs of ?UnregisterObserverClientOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x1800F4168
 * Callers:
 *     ?Thunk_UnregisterObserverClientOfType_161@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F4130 (-Thunk_UnregisterObserverClientOfType_161@-$IInputObserverManagerPrincipal_Receive@VBamoInputObs.c)
 * Callees:
