/*
 * XREFs of _PenEventsDispatcherPrincipal::GetClientsForProcess_::_1_::dtor$0 @ 0x180133000
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PenEventsDispatcherPrincipal::GetClientsForProcess_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  ...
  {
    *(_DWORD *)(a2 + 32) &= ~1u;
    std::vector<wil::com_ptr_t<BamoKeyboardDockClientProxy,wil::err_returncode_policy>>::~vector<wil::com_ptr_t<BamoKeyboardDockClientProxy,wil::err_returncode_policy>>(*(_QWORD *)(a2 + 88));
  }
}
