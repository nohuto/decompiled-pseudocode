/*
 * XREFs of ??_EInputRedirectionProcessor@@UEAAPEAXI@Z @ 0x18017ED08
 * Callers:
 *     ??_EInputRedirectionProcessor@@WBI@EAAPEAXI@Z @ 0x18004CE60 (--_EInputRedirectionProcessor@@WBI@EAAPEAXI@Z.c)
 * Callees:
