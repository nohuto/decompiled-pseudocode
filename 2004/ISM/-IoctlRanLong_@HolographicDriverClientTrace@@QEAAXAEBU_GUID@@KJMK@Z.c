/*
 * XREFs of ?IoctlRanLong_@HolographicDriverClientTrace@@QEAAXAEBU_GUID@@KJMK@Z @ 0x18015FF6C
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( **(_DWORD **)(v9 + 8) > 3u && tlgKeywordOn(*(_QWORD *)(v9 + 8), 0x200000000000LL) )
  {
    ...
    v17 = a2;
    v18 = 16LL;
    tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801CF606, 0LL, 0LL, 8u, &v16);
  }
}
