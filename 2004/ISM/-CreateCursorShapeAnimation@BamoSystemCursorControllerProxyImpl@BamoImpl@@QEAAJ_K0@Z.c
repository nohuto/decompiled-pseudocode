/*
 * XREFs of ?CreateCursorShapeAnimation@BamoSystemCursorControllerProxyImpl@BamoImpl@@QEAAJ_K0@Z @ 0x1800E395C
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9 = 3;
      return CoreUICallSend(v8, v10, 2LL, 62LL, v9, &unk_1801BF2AD, a2);
    }
    else
    {
