/*
 * XREFs of ??1?$unordered_map@KUPointerCache@DragNDropProcessor@@U?$hash@K@std@@U?$equal_to@K@4@V?$allocator@U?$pair@$$CBKUPointerCache@DragNDropProcessor@@@std@@@4@@std@@QEAA@XZ @ 0x1800F8188
 * Callers:
 *     _DragNDropProcessor::DragNDropProcessor_::_1_::dtor$4 @ 0x1800F8031 (_DragNDropProcessor--DragNDropProcessor_--_1_--dtor$4.c)
 * Callees:
