/*
 * XREFs of ?RecordContacts@TouchContactFilter@@QEAAXKPEBUTouchContactInfo@@@Z @ 0x180185098
 * Callers:
 *     ?Add@GestureSession@@UEAAJKKKPEBUTouchContactInfo@@@Z @ 0x180182970 (-Add@GestureSession@@UEAAJKKKPEBUTouchContactInfo@@@Z.c)
 * Callees:
