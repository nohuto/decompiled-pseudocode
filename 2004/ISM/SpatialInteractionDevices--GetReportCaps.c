/*
 * XREFs of SpatialInteractionDevices::GetReportCaps @ 0x1800C9400
 * Callers:
 ...
 *     ??$make_shared@USpatialInputReportCaps@SpatialInteractionDevices@@$$V@std@@YA?AV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@0@XZ @ 0x1800C8CF8 (--$make_shared@USpatialInputReportCaps@SpatialInteractionDevices@@$$V@std@@YA-AV-$shared_ptr@USp.c)
