/*
 * XREFs of ??0SpatialInteractionEyeGazeSourceObject@SpatialInteractions@Internal@Windows@@QEAA@PEB_WPEAUISpatialObjectDevice@Holographic@23@PEAUISpatialObject@523@@Z @ 0x1800DB220
 * Callers:
