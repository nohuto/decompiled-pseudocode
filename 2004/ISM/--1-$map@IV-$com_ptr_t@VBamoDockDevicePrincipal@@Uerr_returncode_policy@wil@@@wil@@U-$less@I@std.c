/*
 * XREFs of ??1?$map@IV?$com_ptr_t@VBamoDockDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@U?$less@I@std@@V?$allocator@U?$pair@$$CBIV?$com_ptr_t@VBamoDockDevicePrincipal@@Uerr_returncode_policy@wil@@@wil@@@std@@@4@@std@@QEAA@XZ @ 0x180125F28
 * Callers:
 *     _KeyboardDockServer::KeyboardDockServer_::_1_::dtor$2 @ 0x180050AE1 (_KeyboardDockServer--KeyboardDockServer_--_1_--dtor$2.c)
 *     _KeyboardDockServer::KeyboardDockServer_::_1_::dtor$3 @ 0x180050AF7 (_KeyboardDockServer--KeyboardDockServer_--_1_--dtor$3.c)
 * Callees:
