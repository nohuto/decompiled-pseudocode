/*
 * XREFs of std::call_once__lambda_ce8a15022103a02b96acfc2f7dcf1bbe___ @ 0x1801A40C8
 * Callers:
...
void __fastcall std::call_once__lambda_ce8a15022103a02b96acfc2f7dcf1bbe___(__int64 a1, __int64 a2)
{
  ...
  if ( std::_Execute_once(
         (struct std::once_flag *)&InfoMetadata::s_createdInfoMetadata,
         (int (*)(void *, void *, void **))std::_Callback_once<std::tuple<_lambda_ce8a15022103a02b96acfc2f7dcf1bbe_ &&,std::exception_ptr &>,std::integer_sequence<unsigned __int64,0>,1>,
         v5) )
  {
  ...
  else
  {
    ...
    std::_XGetLastError();
    __debugbreak();
    std::call_once__lambda_ce8a15022103a02b96acfc2f7dcf1bbe____::_1_::dtor_0();
  }
}
