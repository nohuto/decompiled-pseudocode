/*
 * XREFs of ?SuppressInputOfType@BamoInputObserverManagerPrincipalImpl@BamoImpl@@QEAAJW4InputObserverType@InputObservation@@I@Z @ 0x1800F3F74
 * Callers:
 *     ?Thunk_SuppressInputOfType_161@?$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F4110 (-Thunk_SuppressInputOfType_161@-$IInputObserverManagerPrincipal_Receive@VBamoInputObserverManage.c)
 * Callees:
        ...
        unsigned int a3)
{
  ...
  Microsoft::BamoImpl::DropAndReacquireLock::DropAndReacquireLock(
    ...
    v10);
  v14 = (*(__int64 (__fastcall **)(__int64, __int64, _QWORD, char *))(*(_QWORD *)(a1 - 16) + 88LL))(
          a1 - 16,
          v8,
          a2,
          v13);
