/*
 * XREFs of ?UpdateResizeContextualProcessor@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF280
 * Callers:
 ...
 *     ?Thunk_UpdateResizeContextualProcessor_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED050 (-Thunk_UpdateResizeContextualProcessor_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@.c)
 * Callees:
