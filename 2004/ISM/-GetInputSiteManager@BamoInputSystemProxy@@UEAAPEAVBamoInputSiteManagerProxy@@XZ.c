/*
 * XREFs of ?GetInputSiteManager@BamoInputSystemProxy@@UEAAPEAVBamoInputSiteManagerProxy@@XZ @ 0x1800E6270
 * Callers:
 *     <none>
 * Callees:
...
struct BamoInputSiteManagerProxy *__fastcall BamoInputSystemProxy::GetInputSiteManager(BamoInputSystemProxy *this)
{
  ...
  return (struct BamoInputSiteManagerProxy *)*((_QWORD *)this + 12);
}
