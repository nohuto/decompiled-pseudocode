/*
 * XREFs of ??1CachedInputInfo@@QEAA@XZ @ 0x1800AE7FC
 * Callers:
 *     _Win32kInterop::MakeRoutingDecisionsForAllFrames_::_1_::dtor$4 @ 0x1800B0BCF (_Win32kInterop--MakeRoutingDecisionsForAllFrames_--_1_--dtor$4.c)
 * Callees:
