/*
 * XREFs of ?AddOnDeviceAttachCallback@DWMInputRouter@@UEAAXPEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@Z @ 0x18003B130
 * Callers:
 *     <none>
 * Callees:
 *     ??$_Emplace_reallocate@AEBQEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@?$vector@PEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@V?$allocator@PEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@2@@std@@QEAAPEAPEAV?$function@$$A6AXPEAUDeviceInfo@@@Z@1@QEAPEAV21@AEBQEAV21@@Z @ 0x180037A78 (--$_Emplace_reallocate@AEBQEAV-$function@$$A6AXPEAUDeviceInfo@@@Z@std@@@-$vector@PEAV-$function@.c)
 */

_QWORD *__fastcall DWMInputRouter::AddOnDeviceAttachCallback(__int64 a1, _QWORD *a2)
{
  __int64 v2; // rcx
  _QWORD *result; // rax
  _BYTE *v4; // rdx
