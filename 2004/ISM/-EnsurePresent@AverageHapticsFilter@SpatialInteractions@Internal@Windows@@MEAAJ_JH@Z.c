/*
 * XREFs of ?EnsurePresent@AverageHapticsFilter@SpatialInteractions@Internal@Windows@@MEAAJ_JH@Z @ 0x18016C0B0
 * Callers:
 *     <none>
 * Callees:
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180035770 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     __security_check_cookie @ 0x18003C4E0 (__security_check_cookie.c)
 *     ?UpdateCurrentStart@AverageHapticsFilter@SpatialInteractions@Internal@Windows@@IEAAX_J@Z @ 0x18016FB70 (-UpdateCurrentStart@AverageHapticsFilter@SpatialInteractions@Internal@Windows@@IEAAX_J@Z.c)
