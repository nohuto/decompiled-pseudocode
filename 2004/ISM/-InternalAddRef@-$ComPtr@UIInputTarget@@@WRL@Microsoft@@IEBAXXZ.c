/*
 * XREFs of ?InternalAddRef@?$ComPtr@UIInputTarget@@@WRL@Microsoft@@IEBAXXZ @ 0x180033780
 * Callers:
 ...
 *     ?GetFallbackTarget@ContextualProcessorBuffer@@UEAA?AV?$ComPtr@UIInputTarget@@@WRL@Microsoft@@XZ @ 0x18014BF10 (-GetFallbackTarget@ContextualProcessorBuffer@@UEAA-AV-$ComPtr@UIInputTarget@@@WRL@Microsoft@@XZ.c)
