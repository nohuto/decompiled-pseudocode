 ...
 *     ?_Destroy_if_node@?$_Hash@V?$_Umap_traits@EUTargetingInfo@KeyboardProcessor@@V?$_Uhash_compare@EU?$hash@E@std@@U?$equal_to@E@2@@std@@V?$allocator@U?$pair@$$CBEUTargetingInfo@KeyboardProcessor@@@std@@@4@$0A@@std@@@std@@IEAAXV?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBEUTargetingInfo@KeyboardProcessor@@@std@@@std@@@std@@@2@@Z @ 0x180047E34 (-_Destroy_if_node@-$_Hash@V-$_Umap_traits@EUTargetingInfo@KeyboardProcessor@@V-$_Uhash_compare@E.c)
...
_QWORD *__fastcall std::list<std::pair<unsigned char const,KeyboardProcessor::TargetingInfo>>::erase(
        __int64 a1,
        _QWORD *a2,
        __int64 *a3)
{
