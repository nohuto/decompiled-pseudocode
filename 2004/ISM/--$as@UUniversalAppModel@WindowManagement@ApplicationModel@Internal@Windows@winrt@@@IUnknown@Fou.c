/*
 * XREFs of ??$as@UUniversalAppModel@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@IUnknown@Foundation@Windows@winrt@@QEBA?AUUniversalAppModel@WindowManagement@ApplicationModel@Internal@23@XZ @ 0x1800BC6F4
 * Callers:
