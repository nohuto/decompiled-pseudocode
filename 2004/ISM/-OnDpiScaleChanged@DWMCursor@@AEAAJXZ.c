/*
 * XREFs of ?OnDpiScaleChanged@DWMCursor@@AEAAJXZ @ 0x18019CAC4
 * Callers:
 ...
 *     ?SendAndVerifyEndpoints@DWMCursorBroker@@AEAAJPEAUCursorMessage@@@Z @ 0x18019BDCC (-SendAndVerifyEndpoints@DWMCursorBroker@@AEAAJPEAUCursorMessage@@@Z.c)
 */
