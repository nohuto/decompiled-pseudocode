/*
 * XREFs of ?TryCreateAndInitialize@HidLampRangeUpdateReportParser@@SAJPEBUParsedHidReportDescriptor@@PEAPEAV1@@Z @ 0x1800ABFE8
 * Callers:
 ...
 *     ??0HidLampRangeUpdateReportParser@@AEAA@XZ @ 0x1800ABB4C (--0HidLampRangeUpdateReportParser@@AEAA@XZ.c)
