/*
 * XREFs of ??R?$default_delete@VDockProcessor@@@std@@QEBAXPEAVDockProcessor@@@Z @ 0x180187F38
 * Callers:
 *     ??1?$unique_ptr@VDockProcessor@@U?$default_delete@VDockProcessor@@@std@@@std@@QEAA@XZ @ 0x180187F18 (--1-$unique_ptr@VDockProcessor@@U-$default_delete@VDockProcessor@@@std@@@std@@QEAA@XZ.c)
