/*
 * XREFs of ?OnRemoveDataSourceError@BamoDataProviderPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180142DE4
 * Callers:
 *     ?Thunk_OnRemoveDataSourceError_5@?$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180144780 (-Thunk_OnRemoveDataSourceError_5@-$IDataProviderPrincipal_Receive@VBamoDataProviderPrincipalImpl.c)
 * Callees:
