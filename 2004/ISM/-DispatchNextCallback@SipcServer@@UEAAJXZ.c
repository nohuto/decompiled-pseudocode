/*
 * XREFs of ?DispatchNextCallback@SipcServer@@UEAAJXZ @ 0x180039960
 * Callers:
 *     <none>
 * Callees:
 *     ?AddHandle@AggregateWaitHandle@@QEAAJPEAX@Z @ 0x180031598 (-AddHandle@AggregateWaitHandle@@QEAAJPEAX@Z.c)
 *     ?GetSignaledHandle@AggregateWaitHandle@@QEAAJPEAPEAX@Z @ 0x1800399E0 (-GetSignaledHandle@AggregateWaitHandle@@QEAAJPEAPEAX@Z.c)
 ...
 *     ?Disconnect@SipcEndpoint@@QEAAX_N@Z @ 0x1800C0064 (-Disconnect@SipcEndpoint@@QEAAX_N@Z.c)
 ...
 *     ?RemoveEndpoint@SipcServer@@UEAAXPEAVSipcEndpoint@@@Z @ 0x1800C15F0 (-RemoveEndpoint@SipcServer@@UEAAXPEAVSipcEndpoint@@@Z.c)
