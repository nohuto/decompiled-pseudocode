/*
 * XREFs of ?UpdateVertex0@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJPEAUD2D_VECTOR_2F@@@Z @ 0x1801000A4
 * Callers:
 ...
 *     ?Thunk_UpdateVertex0_137@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FFDF0 (-Thunk_UpdateVertex0_137@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl.c)
 * Callees:
