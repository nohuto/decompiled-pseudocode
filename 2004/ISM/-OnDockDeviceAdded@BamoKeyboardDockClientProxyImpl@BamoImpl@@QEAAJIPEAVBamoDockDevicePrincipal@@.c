/*
 * XREFs of ?OnDockDeviceAdded@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJIPEAVBamoDockDevicePrincipal@@@Z @ 0x18012893C
 * Callers:
        ...
        struct BamoDockDevicePrincipal *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this[2] + 3) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      return CoreUICallSend(v8, v10, 2LL, 44LL, 0, &unk_1801BF220, a2);
    }
    else
    {
