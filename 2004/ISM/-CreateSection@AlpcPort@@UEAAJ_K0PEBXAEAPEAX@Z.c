/*
 * XREFs of ?CreateSection@AlpcPort@@UEAAJ_K0PEBXAEAPEAX@Z @ 0x1800BFAD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z @ 0x1800BF938 (-ComputeFromData@SipcSectionId@@QEAAJ_KPEBX@Z.c)
 ...
 *     ?InitializeSectionMemory@SipcPort@@KAXPEAUSectionListEntry@1@AEBUSipcSectionId@@@Z @ 0x1800C0DA0 (-InitializeSectionMemory@SipcPort@@KAXPEAUSectionListEntry@1@AEBUSipcSectionId@@@Z.c)
