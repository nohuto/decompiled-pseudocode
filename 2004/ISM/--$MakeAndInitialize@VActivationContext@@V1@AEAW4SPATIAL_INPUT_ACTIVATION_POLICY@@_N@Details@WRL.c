/*
 * XREFs of ??$MakeAndInitialize@VActivationContext@@V1@AEAW4SPATIAL_INPUT_ACTIVATION_POLICY@@_N@Details@WRL@Microsoft@@YAJPEAPEAVActivationContext@@AEAW4SPATIAL_INPUT_ACTIVATION_POLICY@@$$QEA_N@Z @ 0x180170F2C
 * Callers:
 ...
 *     ??0ActivationContext@@QEAA@XZ @ 0x180170FCC (--0ActivationContext@@QEAA@XZ.c)
 */
