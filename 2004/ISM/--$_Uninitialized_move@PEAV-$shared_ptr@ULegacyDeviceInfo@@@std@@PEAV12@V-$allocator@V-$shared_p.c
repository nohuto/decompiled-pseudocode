/*
 * XREFs of ??$_Uninitialized_move@PEAV?$shared_ptr@ULegacyDeviceInfo@@@std@@PEAV12@V?$allocator@V?$shared_ptr@ULegacyDeviceInfo@@@std@@@2@@std@@YAPEAV?$shared_ptr@ULegacyDeviceInfo@@@0@QEAV10@0PEAV10@AEAV?$allocator@V?$shared_ptr@ULegacyDeviceInfo@@@std@@@0@@Z @ 0x180089CB4
 * Callers:
