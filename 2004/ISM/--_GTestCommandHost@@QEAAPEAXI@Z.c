/*
 * XREFs of ??_GTestCommandHost@@QEAAPEAXI@Z @ 0x1800BC1F4
 * Callers:
 *     ?Initialize@InputStateManager@@IEAAJXZ @ 0x1800220C8 (-Initialize@InputStateManager@@IEAAJXZ.c)
 *     ??1?$unique_ptr@VTestCommandHost@@U?$default_delete@VTestCommandHost@@@std@@@std@@QEAA@XZ @ 0x18003B4E0 (--1-$unique_ptr@VTestCommandHost@@U-$default_delete@VTestCommandHost@@@std@@@std@@QEAA@XZ.c)
 * Callees:
