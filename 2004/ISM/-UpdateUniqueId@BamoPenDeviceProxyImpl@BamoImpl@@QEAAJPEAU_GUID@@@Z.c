/*
 * XREFs of ?UpdateUniqueId@BamoPenDeviceProxyImpl@BamoImpl@@QEAAJPEAU_GUID@@@Z @ 0x1800EFD44
 * Callers:
 ...
 *     ?Thunk_UpdateUniqueId_29@?$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED140 (-Thunk_UpdateUniqueId_29@-$IPenDeviceProxy_Receive@VBamoPenDeviceProxyImpl@BamoImpl@@@@SAJPEAXPE.c)
 * Callees:
