/*
 * XREFs of ?GiveSpatialDataToPID@BamoMPCManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x180072544
 * Callers:
 *     ?Thunk_GiveSpatialDataToPID_25@?$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800742E0 (-Thunk_GiveSpatialDataToPID_25@-$IMPCManagerPrincipal_Receive@VBamoMPCManagerPrincipalImpl@BamoI.c)
 * Callees:
