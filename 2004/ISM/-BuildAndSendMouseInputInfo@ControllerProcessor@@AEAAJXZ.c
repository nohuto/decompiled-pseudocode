/*
 * XREFs of ?BuildAndSendMouseInputInfo@ControllerProcessor@@AEAAJXZ @ 0x180046D0C
 * Callers:
 ...
 *     ?BuildMouseInputInfo@ControllerProcessor@@AEAA?AURawMouseInputInfo@@K@Z @ 0x180120120 (-BuildMouseInputInfo@ControllerProcessor@@AEAA-AURawMouseInputInfo@@K@Z.c)
    ...
    do
    {
      ...
      if ( (v6 != 0) != ((v5 & *((_DWORD *)this + 68)) != 0) )
      {
        ...
        *((_DWORD *)this + v8 + 1875) = v6 != 0;
        if ( v6 )
          v10 = *((_DWORD *)&unk_1801C68E0 + 3 * v8 + 2);
        else
          v10 = *((_DWORD *)&unk_1801C68E0 + 3 * v8 + 1);
        v3 |= v10;
      }
LABEL_12:
      ++v2;
    ...
    do
    {
      ...
      if ( (v12 != 0) != ((*(v11 - 1) & *((_DWORD *)this + 61)) != 0) )
      {
        ...
        *((_DWORD *)this + v14 + 1875) = v12 != 0;
        if ( v12 )
          v16 = *((_DWORD *)&unk_1801C68E0 + 3 * v14 + 2);
        else
          v16 = *((_DWORD *)&unk_1801C68E0 + 3 * v14 + 1);
        v3 |= v16;
      }
LABEL_24:
      ++v2;
