/*
 * XREFs of ?SpatialInteractionEyeGazeObjectDevice_Added_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAXXZ @ 0x1800DC4C4
 * Callers:
        ...
        SpatialInteractionDevices::SpatialInteractionTrace *this)
{
  ...
  if ( **((_DWORD **)v1 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v1 + 1), 2LL) )
    tlgWriteTransfer_EventWriteTransfer(v3, (unsigned __int8 *)dword_1801CC909, 0LL, 0LL, v2, &v4);
}
