/*
 * XREFs of ?OnInputSinkDataChanged@ShellGesturesClientProxy@@MEAAJXZ @ 0x180101190
 * Callers:
 *     ?OnConnected@ShellGesturesClientProxy@@MEAAJXZ @ 0x180045920 (-OnConnected@ShellGesturesClientProxy@@MEAAJXZ.c)
 * Callees:
