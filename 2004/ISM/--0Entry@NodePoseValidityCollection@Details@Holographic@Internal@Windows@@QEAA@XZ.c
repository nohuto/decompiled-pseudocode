/*
 * XREFs of ??0Entry@NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x18001E180
 * Callers:
 *     ??0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ @ 0x180036B14 (--0NodePoseValidityCollection@Details@Holographic@Internal@Windows@@QEAA@XZ.c)
 * Callees:
 *     <none>
 */
