/*
 * XREFs of ?Materialize_BamoSimpleHapticsControllerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7F64
 * Callers:
 *     ?Thunk_Materialize_BamoSimpleHapticsControllerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECCF0 (-Thunk_Materialize_BamoSimpleHapticsControllerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VB.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoSimpleHapticsControllerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoSimpleHapticsControllerProxy::`vftable'{for `ISimpleHapticsControllerProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  v9[2] = &BamoImpl::BamoSimpleHapticsControllerProxyImpl::`vftable';
  v9[5] = 0LL;
  v9[6] = 0LL;
  *((_DWORD *)v9 + 14) = 0;
