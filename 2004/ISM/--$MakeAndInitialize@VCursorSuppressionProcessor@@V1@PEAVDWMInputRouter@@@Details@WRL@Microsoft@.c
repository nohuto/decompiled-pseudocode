/*
 * XREFs of ??$MakeAndInitialize@VCursorSuppressionProcessor@@V1@PEAVDWMInputRouter@@@Details@WRL@Microsoft@@YAJPEAPEAVCursorSuppressionProcessor@@$$QEAPEAVDWMInputRouter@@@Z @ 0x180136D9C
 * Callers:
 ...
 *     ??0CursorSuppressionProcessor@@QEAA@XZ @ 0x180137508 (--0CursorSuppressionProcessor@@QEAA@XZ.c)
