/*
 * XREFs of ?GetSupportedDDILevelsInternal@SpatialGraphDriverClient@Holographic@Internal@Windows@@AEAAJPEAUHOLOGRAPHIC_DEVICE_SUPPORTED_DDI_LEVELS@@@Z @ 0x18015EA04
 * Callers:
        ...
        struct HOLOGRAPHIC_DEVICE_SUPPORTED_DDI_LEVELS *a2)
{
  ...
  if ( v4 >= 0 )
  {
    Windows::Internal::Holographic::PropertyCache::SetValue(
      (Windows::Internal::Holographic::PropertyCache *)(this + 28),
  ...
  else
  {
    ...
    DevicePropertyOfKnownSize = Windows::Internal::Holographic::SpatialGraphDriverClient::GetDevicePropertyOfKnownSize(
                                  ...
                                  v10,
                                  8uLL,
                                  (__int64 (__fastcall *)(void *, unsigned __int64))Windows::Internal::Holographic::ValidateProperty::SupportedDDILevels,
                                  0);
