        ...
        _QWORD **a2)
{
  ...
  *a2[1] = 0LL;
  ...
  if ( *a2 )
  {
    ...
    {
      v3 = (_QWORD *)*v2;
      std::shared_ptr<HotKeyInfo>::`scalar deleting destructor'(v2 + 2);
