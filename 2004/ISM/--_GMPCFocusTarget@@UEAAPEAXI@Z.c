/*
 * XREFs of ??_GMPCFocusTarget@@UEAAPEAXI@Z @ 0x1800B9D20
 * Callers:
 *     ??_EMPCFocusTarget@@W7EAAPEAXI@Z @ 0x18004AEE0 (--_EMPCFocusTarget@@W7EAAPEAXI@Z.c)
 * Callees:
 ...
 *     ??1MPCTarget@@UEAA@XZ @ 0x1800BA588 (--1MPCTarget@@UEAA@XZ.c)
 */
