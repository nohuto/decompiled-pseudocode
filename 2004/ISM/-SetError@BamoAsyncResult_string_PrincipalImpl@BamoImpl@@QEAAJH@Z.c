/*
 * XREFs of ?SetError@BamoAsyncResult_string_PrincipalImpl@BamoImpl@@QEAAJH@Z @ 0x18011B0A4
 * Callers:
 *     ?Thunk_SetError_3@?$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011B2E0 (-Thunk_SetError_3@-$IAsyncResult_string_Principal_Receive@VBamoAsyncResult_string_PrincipalImpl@.c)
 * Callees:
