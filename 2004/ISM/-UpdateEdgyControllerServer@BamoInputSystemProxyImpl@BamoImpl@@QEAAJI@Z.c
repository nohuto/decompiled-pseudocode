/*
 * XREFs of ?UpdateEdgyControllerServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EDCF8
 * Callers:
 ...
 *     ?Thunk_UpdateEdgyControllerServer_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECE60 (-Thunk_UpdateEdgyControllerServer_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoI.c)
 * Callees:
