/*
 * XREFs of ??$_Uninitialized_move@PEAVEdge@@PEAV1@V?$allocator@VEdge@@@std@@@std@@YAPEAVEdge@@QEAV1@0PEAV1@AEAV?$allocator@VEdge@@@0@@Z @ 0x1801784FC
 * Callers:
 ...
 *     ??0Edge@@QEAA@$$QEAV0@@Z @ 0x180178618 (--0Edge@@QEAA@$$QEAV0@@Z.c)
 */
