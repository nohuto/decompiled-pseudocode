/*
 * XREFs of ??_GEndpointListEntry@SipcServer@@QEAAPEAXI@Z @ 0x1800BF0AC
 * Callers:
 ...
 *     ?RemoveHandle@AggregateWaitHandle@@QEAAJPEAX@Z @ 0x1800C1644 (-RemoveHandle@AggregateWaitHandle@@QEAAJPEAX@Z.c)
 *     ?RemoveOwner@SipcEndpoint@@QEAAXXZ @ 0x1800C16E0 (-RemoveOwner@SipcEndpoint@@QEAAXXZ.c)
 */
