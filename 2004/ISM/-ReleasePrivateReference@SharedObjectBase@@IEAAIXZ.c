/*
 * XREFs of ?ReleasePrivateReference@SharedObjectBase@@IEAAIXZ @ 0x1800BEB30
 * Callers:
 ...
 *     ?ReleasePrivateReference@SipcServer@@UEAAXXZ @ 0x1800C15E0 (-ReleasePrivateReference@SipcServer@@UEAAXXZ.c)
 * Callees:
