/*
 * XREFs of ?MPCHolographicInputManager_FocusedAppDisabled3DMouse_@ISMTracing@@QEAAXAEB_N@Z @ 0x18007686C
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_FocusedAppDisabled3DMouse_(ISMTracing *this, const bool *a2)
{
  ...
  if ( **((_DWORD **)v3 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v3 + 1), 1LL) )
  {
    ...
    v10 = v4;
    v9 = &v7;
    tlgWriteTransfer_EventWriteTransfer(v5, (unsigned __int8 *)dword_1801C785C, 0LL, 0LL, 3u, &v8);
  }
}
