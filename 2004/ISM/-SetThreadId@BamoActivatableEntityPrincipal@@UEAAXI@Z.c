/*
 * XREFs of ?SetThreadId@BamoActivatableEntityPrincipal@@UEAAXI@Z @ 0x1800059D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateThreadIdRemoteCacheStatic@BamoActivatableEntityPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImpl@2Microsoft@@PEAV12@@Z @ 0x18010588C (-UpdateThreadIdRemoteCacheStatic@BamoActivatableEntityPrincipalImpl@BamoImpl@@CAJPEAVBamoStubImp.c)
 */
