/*
 * XREFs of ?OnCursorSuppressionStateChanged@SystemCursorService@@UEAAJUCursorId@@UCursorSuppressionStateData@@@Z @ 0x1801400B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SystemCursorService::OnCursorSuppressionStateChanged(
        ...
        bool a3)
{
  ...
  v6 = SystemCursor::SetSuppressionState(*(SystemCursor **)(v9[0] + 24LL), a3);
  v7 = v6;
  if ( v6 >= 0 )
    return 0LL;
