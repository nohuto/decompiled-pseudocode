/*
 * XREFs of ?CallRemoteInsertOnStub@BamoList_ActivatableEntityPrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@CAJPEAVBamoStubImpl@36@IPEAVBamoActivatableEntityPrincipal@@@Z @ 0x1800073D0
 * Callers:
        ...
        struct BamoActivatableEntityPrincipal *a3)
{
        ...
        *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v7 + 3) + 32LL) + 56LL)) )
  {
    ...
    v5 = CoreUICallSend(SendHost, v14, 2LL, 71LL, 0, &unk_1801BF220, a2);
