/*
 * XREFs of ?CallRemoteRemoveOnStub@BamoList_ActivatableEntityPrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@CAJPEAVBamoStubImpl@36@I@Z @ 0x180002E48
 * Callers:
        ...
        int a2)
{
  ...
  if ( *((_BYTE *)a1 + 32) )
  {
    ...
    v12 = 1;
    v5 = CoreUICallSend(SendHost, v13, 2LL, 71LL, v12, &unk_1801BF1BA, a2);
