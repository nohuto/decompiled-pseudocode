/*
 * XREFs of ?UpdateSystemCursorController@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF744
 * Callers:
 ...
 *     ?Thunk_UpdateSystemCursorController_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED0D0 (-Thunk_UpdateSystemCursorController_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@Bam.c)
 * Callees:
