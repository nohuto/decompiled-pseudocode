/*
 * XREFs of ??_E?$ComPtr@UIUnknown@@@WRL@Microsoft@@QEAAPEAXI@Z @ 0x180069CBC
 * Callers:
 *     ??_GEventTargetArray@Details@WRL@Microsoft@@UEAAPEAXI@Z @ 0x180106C90 (--_GEventTargetArray@Details@WRL@Microsoft@@UEAAPEAXI@Z.c)
