/*
 * XREFs of ??1GameInputServerProxy@@EEAA@XZ @ 0x1800421E4
 * Callers:
 *     ??_GGameInputServerProxy@@EEAAPEAXI@Z @ 0x180042410 (--_GGameInputServerProxy@@EEAAPEAXI@Z.c)
 * Callees:
 *     ??3@YAXPEAXAEBUnothrow_t@std@@@Z @ 0x18003C6C0 (--3@YAXPEAXAEBUnothrow_t@std@@@Z.c)
 *     ??_GDevice@GameInputServerProxy@@QEAAPEAXI@Z @ 0x180042358 (--_GDevice@GameInputServerProxy@@QEAAPEAXI@Z.c)
