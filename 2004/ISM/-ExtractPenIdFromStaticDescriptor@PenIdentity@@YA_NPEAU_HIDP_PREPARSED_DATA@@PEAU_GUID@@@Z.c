/*
 * XREFs of ?ExtractPenIdFromStaticDescriptor@PenIdentity@@YA_NPEAU_HIDP_PREPARSED_DATA@@PEAU_GUID@@@Z @ 0x180131E40
 * Callers:
 ...
 *     ?CreatePenId@PenIdentity@@YA_NG_KPEAU_GUID@@@Z @ 0x180131C58 (-CreatePenId@PenIdentity@@YA_NG_KPEAU_GUID@@@Z.c)
 */
