/*
 * XREFs of ??_GDockDeviceCollection@@UEAAPEAXI@Z @ 0x18009B850
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_Tidy@?$deque@UGetInputReportResult@@V?$allocator@UGetInputReportResult@@@std@@@std@@AEAAXXZ @ 0x18009C034 (-_Tidy@-$deque@UGetInputReportResult@@V-$allocator@UGetInputReportResult@@@std@@@std@@AEAAXXZ.c)
