/*
 * XREFs of ??1?$unique_ptr@VComboButtonProcessor@@U?$default_delete@VComboButtonProcessor@@@std@@@std@@QEAA@XZ @ 0x1801719B8
 * Callers:
 *     _ComboButtonProcessor::Create_::_1_::dtor$0 @ 0x180171B77 (_ComboButtonProcessor--Create_--_1_--dtor$0.c)
 *     _RawButtonProcessor::Create_::_1_::dtor$0 @ 0x180182066 (_RawButtonProcessor--Create_--_1_--dtor$0.c)
 * Callees:
