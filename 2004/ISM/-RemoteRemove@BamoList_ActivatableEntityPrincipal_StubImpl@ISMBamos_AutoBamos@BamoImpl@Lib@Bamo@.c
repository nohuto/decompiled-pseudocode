/*
 * XREFs of ?RemoteRemove@BamoList_ActivatableEntityPrincipal_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJI@Z @ 0x180104A1C
 * Callers:
...
LABEL_3:
  ...
  v7[1] = v10;
  v6 = 1;
  return CoreUICallSend(v11, v7, 2LL, 71LL, v6, &unk_1801BF1BA, a2);
}
