/*
 * XREFs of ?Create@ViewMenuChordedKeyHandler@@SAJP6AJPEAXAEAV?$vector@U?$pair@G_N@std@@V?$allocator@U?$pair@G_N@std@@@2@@std@@_N@Z0AEBV23@PEAPEAV1@@Z @ 0x1801246B4
 * Callers:
 ...
 *     ??0ViewMenuChordedKeyHandler@@IEAA@XZ @ 0x180124184 (--0ViewMenuChordedKeyHandler@@IEAA@XZ.c)
