/*
 * XREFs of ?SendMaterializeProxy@BamoMPCManagerClientPrincipalImpl@BamoImpl@@UEAAXPEAUIMessageCallSendHost@@PEAVBamoStubImpl@2Microsoft@@@Z @ 0x18010D320
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Microsoft::BamoImpl::BamoStubImpl *a3)
{
  ...
  v8 = CoreUICallSend(a2, &v15, 2LL, 1LL, 7, &unk_1801C190B, v13);
  if ( v8 < 0 )
  {
