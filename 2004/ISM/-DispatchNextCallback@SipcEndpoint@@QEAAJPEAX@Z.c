/*
 * XREFs of ?DispatchNextCallback@SipcEndpoint@@QEAAJPEAX@Z @ 0x1800C0138
 * Callers:
 ...
 *     ?GetNextSectionEvent@SipcPort@@QEAAJAEAUSipcPortEvent@@@Z @ 0x1800C0C18 (-GetNextSectionEvent@SipcPort@@QEAAJAEAUSipcPortEvent@@@Z.c)
 */
