/*
 * XREFs of ?RemoteInsert@BamoList_PenDevicePrincipal_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJIPEAVBamoPenDevicePrincipal@@@Z @ 0x18012FB3C
 * Callers:
...
LABEL_3:
  ...
  v10[1] = v13;
  v8 = 0;
  return CoreUICallSend(v9, v10, 2LL, 72LL, v8, &unk_1801BF220, a2);
}
