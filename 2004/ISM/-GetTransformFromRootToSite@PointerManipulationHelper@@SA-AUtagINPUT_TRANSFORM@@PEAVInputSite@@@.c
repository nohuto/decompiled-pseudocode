/*
 * XREFs of ?GetTransformFromRootToSite@PointerManipulationHelper@@SA?AUtagINPUT_TRANSFORM@@PEAVInputSite@@@Z @ 0x180048660
 * Callers:
 ...
 *     ??0bad_optional_access@std@@QEAA@XZ @ 0x18006DC3C (--0bad_optional_access@std@@QEAA@XZ.c)
