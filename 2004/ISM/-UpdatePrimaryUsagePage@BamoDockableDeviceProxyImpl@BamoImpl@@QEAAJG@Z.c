/*
 * XREFs of ?UpdatePrimaryUsagePage@BamoDockableDeviceProxyImpl@BamoImpl@@QEAAJG@Z @ 0x1800EF1DC
 * Callers:
 ...
 *     ?Thunk_UpdatePrimaryUsagePage_63@?$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED030 (-Thunk_UpdatePrimaryUsagePage_63@-$IDockableDeviceProxy_Receive@VBamoDockableDeviceProxyImpl@Bam.c)
 * Callees:
