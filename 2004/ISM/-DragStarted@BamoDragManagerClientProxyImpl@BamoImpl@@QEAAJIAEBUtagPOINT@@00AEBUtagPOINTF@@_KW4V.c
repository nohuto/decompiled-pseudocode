/*
 * XREFs of ?DragStarted@BamoDragManagerClientProxyImpl@BamoImpl@@QEAAJIAEBUtagPOINT@@00AEBUtagPOINTF@@_KW4VirtualKeyModifiers@System@Windows@@W4InputType@Input@Internal@UI@7@2@Z @ 0x1800E5994
 * Callers:
...
LABEL_3:
  ...
  v18[1] = v16;
  v17[1] = v15;
  return CoreUICallSend(v13, v18, 2LL, 24LL, 0, &unk_1801BF1F2, a2);
}
