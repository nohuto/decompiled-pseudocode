/*
 * XREFs of ?Materialize_BamoTestCommandsProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E828C
 * Callers:
 *     ?Thunk_Materialize_BamoTestCommandsProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECD30 (-Thunk_Materialize_BamoTestCommandsProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoTestCommandsProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoTestCommandsProxy::`vftable'{for `ITestCommandsProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
