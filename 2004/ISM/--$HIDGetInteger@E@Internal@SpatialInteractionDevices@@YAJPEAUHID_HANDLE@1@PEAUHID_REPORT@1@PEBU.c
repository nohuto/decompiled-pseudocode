/*
 * XREFs of ??$HIDGetInteger@E@Internal@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEAUHID_REPORT@1@PEBU_HIDP_VALUE_CAPS@@PEAEW4_HIDP_REPORT_TYPE@@@Z @ 0x1800C71DC
 * Callers:
 ...
 *     ?HidStatus@SpatialInteractionDevices@@YAJJ@Z @ 0x1800CBC10 (-HidStatus@SpatialInteractionDevices@@YAJJ@Z.c)
 */
