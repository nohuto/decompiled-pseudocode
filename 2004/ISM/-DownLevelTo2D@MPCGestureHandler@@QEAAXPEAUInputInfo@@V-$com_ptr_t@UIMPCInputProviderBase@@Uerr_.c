/*
 * XREFs of ?DownLevelTo2D@MPCGestureHandler@@QEAAXPEAUInputInfo@@V?$com_ptr_t@UIMPCInputProviderBase@@Uerr_exception_policy@wil@@@wil@@@Z @ 0x18007AE34
 * Callers:
 ...
 *     ?IsInContact@ManipulationInjector@@QEAA_NXZ @ 0x18006B6E4 (-IsInContact@ManipulationInjector@@QEAA_NXZ.c)
