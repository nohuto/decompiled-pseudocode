/*
 * XREFs of ?InitializeInputInfoWithPointerInfo@@YAXPEBUtagPOINTER_INFO_UNION@@_NPEAUPointerInputInfo@@@Z @ 0x1800B04F8
 * Callers:
 ...
 *     ?PointerTypeToInputType@@YA?AW4InputType@@K_N@Z @ 0x1800C40C0 (-PointerTypeToInputType@@YA-AW4InputType@@K_N@Z.c)
