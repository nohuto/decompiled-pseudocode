/*
 * XREFs of ??1SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@UEAA@XZ @ 0x180157C78
 * Callers:
 *     ??_GSpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@UEAAPEAXI@Z @ 0x180158C80 (--_GSpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@UEAAPEAXI@Z.c)
 * Callees:
 ...
 *     ?WaitForCompletion@ChainedThreadpoolWorker@ThreadHelpers@@QEAAXXZ @ 0x180166960 (-WaitForCompletion@ChainedThreadpoolWorker@ThreadHelpers@@QEAAXXZ.c)
 */
