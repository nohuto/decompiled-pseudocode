/*
 * XREFs of ?UpdateVertex1@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJPEAUD2D_VECTOR_2F@@@Z @ 0x18010014C
 * Callers:
 ...
 *     ?Thunk_UpdateVertex1_137@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FFE00 (-Thunk_UpdateVertex1_137@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl.c)
 * Callees:
