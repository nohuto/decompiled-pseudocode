/*
 * XREFs of ?SetForegroundActivatableEntity@ForegroundManager@@UEAAJ_KW4ACTIVATIONOBJECTSTATECHANGE_REASON@@@Z @ 0x180045F40
 * Callers:
 *     <none>
 * Callees:
 *     ??1?$com_ptr_t@VAsyncHRESULTPrincipal@@Uerr_exception_policy@wil@@@wil@@QEAA@XZ @ 0x1800107DC (--1-$com_ptr_t@VAsyncHRESULTPrincipal@@Uerr_exception_policy@wil@@@wil@@QEAA@XZ.c)
 *     ?Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z @ 0x180035770 (-Return_Hr@in1diag3@details@wil@@YAXPEAXIPEBDJ@Z.c)
 *     ?ConfigureForegroundOnActivationObject@ForegroundManager@@AEAAXAEBU_LUID@@_NW4ACTIVATIONOBJECTSTATECHANGE_REASON@@@Z @ 0x180045F1C (-ConfigureForegroundOnActivationObject@ForegroundManager@@AEAAXAEBU_LUID@@_NW4ACTIVATIONOBJECTST.c)
