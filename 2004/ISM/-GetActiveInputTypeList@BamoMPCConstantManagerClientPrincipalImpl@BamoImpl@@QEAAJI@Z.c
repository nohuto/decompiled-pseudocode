/*
 * XREFs of ?GetActiveInputTypeList@BamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18006E6B8
 * Callers:
 *     ?Thunk_GetActiveInputTypeList_25@?$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180070320 (-Thunk_GetActiveInputTypeList_25@-$IMPCConstantManagerClientPrincipal_Receive@VBamoMPCConstantMa.c)
 * Callees:
