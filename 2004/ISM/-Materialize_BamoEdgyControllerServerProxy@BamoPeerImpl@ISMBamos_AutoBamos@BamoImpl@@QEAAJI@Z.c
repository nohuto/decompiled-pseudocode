/*
 * XREFs of ?Materialize_BamoEdgyControllerServerProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E7278
 * Callers:
 *     ?Thunk_Materialize_BamoEdgyControllerServerProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECB20 (-Thunk_Materialize_BamoEdgyControllerServerProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamo.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoEdgyControllerServerProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoEdgyControllerServerProxy::`vftable'{for `IEdgyControllerServerProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
