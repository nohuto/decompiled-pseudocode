/*
 * XREFs of ?GetDwordWithDefault@RegistryHelpers@@YAIPEAUHKEY__@@PEB_W1I@Z @ 0x18003A7B0
 * Callers:
 ...
 *     GetConfigurationFlag @ 0x1800CB8FC (GetConfigurationFlag.c)
 ...
 *     SpatialGraphDriverClientHelpers::DefaultSpatialGraphSettings @ 0x18015AD3C (SpatialGraphDriverClientHelpers--DefaultSpatialGraphSettings.c)
