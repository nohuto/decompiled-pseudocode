/*
 * XREFs of ?UpdateGestureTargetingDecisions@Win32kInterop@@SAXIIPEAI@Z @ 0x1800B28D4
 * Callers:
 *     ?SetManipulationInputTarget@@YAHIPEAXIPEAI@Z @ 0x1800689F0 (-SetManipulationInputTarget@@YAHIPEAXIPEAI@Z.c)
 * Callees:
 ...
 *     ??0?$vector@IV?$allocator@I@std@@@std@@QEAA@AEBV01@@Z @ 0x1800AE2B4 (--0-$vector@IV-$allocator@I@std@@@std@@QEAA@AEBV01@@Z.c)
 *     ?RouteCachedInput@Win32kInterop@@CAXXZ @ 0x1800B2640 (-RouteCachedInput@Win32kInterop@@CAXXZ.c)
 *     ?clear@?$_Hash@V?$_Umap_traits@IV?$vector@IV?$allocator@I@std@@@std@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@2@V?$allocator@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@$0A@@std@@@std@@QEAAXXZ @ 0x1800B3A5C (-clear@-$_Hash@V-$_Umap_traits@IV-$vector@IV-$allocator@I@std@@@std@@V-$_Uhash_compare@IU-$hash@.c)
 *     ?equal_range@?$_Hash@V?$_Umap_traits@IV?$vector@IV?$allocator@I@std@@@std@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@2@V?$allocator@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@$0A@@std@@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@std@@@std@@@std@@V12@@2@AEBI@Z @ 0x1800B3ACC (-equal_range@-$_Hash@V-$_Umap_traits@IV-$vector@IV-$allocator@I@std@@@std@@V-$_Uhash_compare@IU-.c)
...
void __fastcall Win32kInterop::UpdateGestureTargetingDecisions(int a1, unsigned int a2, unsigned int *a3)
{
  ...
  v7 = qword_180208BA0 & std::_Fnv1a_append_bytes(v6, (const unsigned __int8 *const)&v27, 4uLL);
  v8 = v27;
  while ( 1 )
  {
...
LABEL_8:
  if ( v10 != qword_180208B78 )
  {
    ...
    if ( v25 == v15 )
    {
      ...
      while ( v19 != v24 )
        v19 = (_QWORD *)*v19;
      if ( v23 == *(_QWORD **)qword_180208B78 && v24 == (_QWORD *)qword_180208B78 )
      {
