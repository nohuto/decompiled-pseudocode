/*
 * XREFs of ?AllocateStubThunk@BamoList_ActivatableEntityPrincipal_PrincipalImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@UEAAJPEAVBaseBamoPeerImpl@36@PEAPEAVBamoStub@56@@Z @ 0x180011160
 * Callers:
 *     <none>
 * Callees:
