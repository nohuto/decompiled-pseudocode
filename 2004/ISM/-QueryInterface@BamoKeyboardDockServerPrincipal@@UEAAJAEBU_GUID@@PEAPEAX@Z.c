/*
 * XREFs of ?QueryInterface@BamoKeyboardDockServerPrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1801270D0
 * Callers:
 *     ?QueryInterface@BamoKeyboardDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C190 (-QueryInterface@BamoKeyboardDockServerPrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
