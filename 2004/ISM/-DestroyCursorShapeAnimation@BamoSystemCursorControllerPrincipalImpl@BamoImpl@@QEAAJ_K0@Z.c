/*
 * XREFs of ?DestroyCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K0@Z @ 0x18013C0C8
 * Callers:
 *     ?Thunk_DestroyCursorShapeAnimation_253@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013CE60 (-Thunk_DestroyCursorShapeAnimation_253@-$ISystemCursorControllerPrincipal_Receive@VBamoSystemCur.c)
 * Callees:
