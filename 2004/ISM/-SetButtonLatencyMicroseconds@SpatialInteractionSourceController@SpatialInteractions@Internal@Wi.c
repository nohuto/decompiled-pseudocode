/*
 * XREFs of ?SetButtonLatencyMicroseconds@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@QEAAXH@Z @ 0x18016E9D8
 * Callers:
        ...
        int a2)
{
  ...
  _InterlockedExchange64((volatile __int64 *)this + 86, qword_180208330 * a2 / 1000000);
