/*
 * XREFs of ??1HolographicDriverHandleWrapper@Holographic@Internal@Windows@@UEAA@XZ @ 0x1801578B4
 * Callers:
 *     _Windows::Internal::Holographic::SpatialGraphDriverHandleWrapper::SpatialGraphDriverHandleWrapper_::_1_::dtor$0 @ 0x180156BBB (_Windows--Internal--Holographic--SpatialGraphDriverHandleWrapper--SpatialGraphDriverHandleWrappe.c)
 ...
 *     ??_EHolographicDriverHandleWrapper@Holographic@Internal@Windows@@UEAAPEAXI@Z @ 0x180158C00 (--_EHolographicDriverHandleWrapper@Holographic@Internal@Windows@@UEAAPEAXI@Z.c)
 * Callees:
