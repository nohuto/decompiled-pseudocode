/*
 * XREFs of ?Unregister@BamoDataProviderRegistrarProxyImpl@BamoImpl@@QEAAJPEAVBamoDataProviderPrincipal@@@Z @ 0x18014489C
 * Callers:
        ...
        struct BamoDataProviderPrincipal *a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)this[2] + 3) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v9[0] = v11;
      v9[1] = v12;
      return CoreUICallSend(v8, v9, 2LL, 2LL, 1, &unk_1801C098D, v5);
    }
    else
    {
