/*
 * XREFs of ?StartDrag@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJI_KI@Z @ 0x1800F5F54
 * Callers:
 *     ?Thunk_StartDrag_107@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6120 (-Thunk_StartDrag_107@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualPr.c)
 * Callees:
