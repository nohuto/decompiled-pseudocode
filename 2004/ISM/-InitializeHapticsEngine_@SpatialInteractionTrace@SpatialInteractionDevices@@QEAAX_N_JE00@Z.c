/*
 * XREFs of ?InitializeHapticsEngine_@SpatialInteractionTrace@SpatialInteractionDevices@@QEAAX_N_JE00@Z @ 0x18016CAF0
 * Callers:
        ...
        bool a6)
{
  ...
  if ( **((_DWORD **)v9 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v9 + 1), 2LL) )
  {
    ...
    v20 = 8LL;
    v18 = 1LL;
    tlgWriteTransfer_EventWriteTransfer(v10, (unsigned __int8 *)dword_1801D0E37, 0LL, 0LL, 7u, &v16);
  }
}
