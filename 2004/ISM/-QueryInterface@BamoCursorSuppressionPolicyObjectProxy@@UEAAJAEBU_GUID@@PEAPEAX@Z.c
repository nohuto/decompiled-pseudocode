/*
 * XREFs of ?QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800E9FB0
 * Callers:
 *     ?QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B270 (-QueryInterface@BamoCursorSuppressionPolicyObjectProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
