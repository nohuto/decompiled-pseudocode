/*
 * XREFs of std::_Func_impl_no_alloc__lambda_9b9f0c840769002edef58b55115a0dea__void_Microsoft::WRL::ComPtr_DataProviderPrincipal__&_::_Copy @ 0x18019C120
 * Callers:
 *     <none>
 * Callees:
