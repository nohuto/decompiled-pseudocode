/*
 * XREFs of ?UpdateRunState@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180100000
 * Callers:
 ...
 *     ?Thunk_UpdateRunState_10@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FFDE0 (-Thunk_UpdateRunState_10@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl.c)
 * Callees:
