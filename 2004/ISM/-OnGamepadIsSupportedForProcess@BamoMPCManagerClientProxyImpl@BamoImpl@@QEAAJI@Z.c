/*
 * XREFs of ?OnGamepadIsSupportedForProcess@BamoMPCManagerClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1801090CC
 * Callers:
        ...
        int a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 3;
      return CoreUICallSend(v8, v10, 2LL, 5LL, v9, &unk_1801C18C9, a2);
    }
    else
    {
