/*
 * XREFs of ??$IID_PPV_ARGS_Helper@V?$ComPtr@UIDCompInputTarget@@@WRL@Microsoft@@@@YAPEAPEAXV?$ComPtrRef@V?$ComPtr@UIDCompInputTarget@@@WRL@Microsoft@@@Details@WRL@Microsoft@@@Z @ 0x18001868C
 * Callers:
