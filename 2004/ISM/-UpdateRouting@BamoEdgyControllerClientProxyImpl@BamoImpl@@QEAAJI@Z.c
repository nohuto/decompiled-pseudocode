/*
 * XREFs of ?UpdateRouting@BamoEdgyControllerClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800FFF5C
 * Callers:
 ...
 *     ?Thunk_UpdateRouting_10@?$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FFDD0 (-Thunk_UpdateRouting_10@-$IEdgyControllerClientProxy_Receive@VBamoEdgyControllerClientProxyImpl@.c)
 * Callees:
