/*
 * XREFs of ?Activate@BamoActivatableEntityPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x180105430
 * Callers:
 *     ?Thunk_Activate_0@?$IActivatableEntityPrincipal_Receive@VBamoActivatableEntityPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180105800 (-Thunk_Activate_0@-$IActivatableEntityPrincipal_Receive@VBamoActivatableEntityPrincipalImpl@Bamo.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoActivatableEntityPrincipalImpl::Activate(
