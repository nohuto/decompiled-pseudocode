/*
 * XREFs of ?EnumerateDevices@Details@PnpApiWrapper@@YAJP6AKAEBU_GUID@@PEBGPEAGI@ZP6AK01AEAI@ZW4DeviceEventId@2@0PEAUHSTRING__@@P6AX67PEAX@Z8@Z @ 0x18002A1F4
 * Callers:
...
LABEL_23:
  ...
  while ( v26 && *v20 )
  {
    ...
    if ( v33 < 0 )
    {
      ...
      return sub_18005D9D6(v40, v39, v41, v42, a5, a6, a7, a8, a9, a10);
    }
    v51(v27, string, v50);
    v20 += v32;
    v46 = v20;
