/*
 * XREFs of __scrt_initialize_onexit_tables @ 0x18003BD50
 * Callers:
 *     __scrt_dllmain_before_initialize_c @ 0x18003BBDC (__scrt_dllmain_before_initialize_c.c)
 *     __scrt_initialize_thread_safe_statics @ 0x18003C700 (__scrt_initialize_thread_safe_statics.c)
 * Callees:
 *     __scrt_fastfail @ 0x18003BF9C (__scrt_fastfail.c)
 *     __scrt_is_ucrt_dll_in_use @ 0x18003C31C (__scrt_is_ucrt_dll_in_use.c)
 *     _initialize_onexit_table @ 0x18003C402 (_initialize_onexit_table.c)
 */
