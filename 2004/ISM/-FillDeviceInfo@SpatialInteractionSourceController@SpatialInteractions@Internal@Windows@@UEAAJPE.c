/*
 * XREFs of ?FillDeviceInfo@SpatialInteractionSourceController@SpatialInteractions@Internal@Windows@@UEAAJPEAUMPCSourceDeviceInfo@@@Z @ 0x18016C2C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?StringCchCopyNW@@YAJPEA_W_KPEB_W1@Z @ 0x1800E1E40 (-StringCchCopyNW@@YAJPEA_W_KPEB_W1@Z.c)
 */
        ...
        struct MPCSourceDeviceInfo *a2)
{
  ...
  _WORD v19[6]; // [rsp+24h] [rbp-5Ch] BYREF
  HSTRING string; // [rsp+30h] [rbp-50h] BYREF
  UINT32 v21; // [rsp+38h] [rbp-48h] BYREF
  __m256i v22; // [rsp+40h] [rbp-40h]
    ...
    if ( v7 >= 0 )
    {
      ...
      *(_OWORD *)((char *)a2 + 904) = *(_OWORD *)((char *)&v22.m256i_u64[1] + 4);
      if ( !Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice::GetDynamicNodeInfo(
              this,
              (struct Windows::Internal::Holographic::DynamicNodeInfo *)&v23)
