/*
 * XREFs of ?Materialize_BamoUIAHitTestInputObjectProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E835C
 * Callers:
 *     ?Thunk_Materialize_BamoUIAHitTestInputObjectProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECD40 (-Thunk_Materialize_BamoUIAHitTestInputObjectProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBam.c)
 * Callees:
