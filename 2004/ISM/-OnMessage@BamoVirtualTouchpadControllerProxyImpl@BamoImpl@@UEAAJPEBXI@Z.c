/*
 * XREFs of ?OnMessage@BamoVirtualTouchpadControllerProxyImpl@BamoImpl@@UEAAJPEBXI@Z @ 0x1800F0650
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoVirtualTouchpadControllerProxyImpl::OnMessage(
        ...
        const void *a2)
{
  ...
  result = CoreUICallReceive(
             *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 72LL),
             &IVirtualTouchpadControllerProxy_Receive<BamoImpl::BamoVirtualTouchpadControllerProxyImpl>::Type,
