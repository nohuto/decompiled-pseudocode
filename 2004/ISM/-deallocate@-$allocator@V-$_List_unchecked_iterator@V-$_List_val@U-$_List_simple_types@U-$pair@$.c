/*
 * XREFs of ?deallocate@?$allocator@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBEUTargetingInfo@KeyboardProcessor@@@std@@@std@@@std@@@std@@@std@@QEAAXQEAV?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBEUTargetingInfo@KeyboardProcessor@@@std@@@std@@@std@@@2@_K@Z @ 0x18003FBDC
 * Callers:
 *     _std::vector_Microsoft::BamoImpl::RemoteCallBuffer___std::allocator_Microsoft::BamoImpl::RemoteCallBuffer_____::_Emplace_reallocate_Microsoft::BamoImpl::RemoteCallBuffer___const_&__::_1_::catch$33 @ 0x18003F098 (_std--vector_Microsoft--BamoImpl--RemoteCallBuffer___std--allocator_Microsoft--BamoImpl--RemoteC.c)
 *     _std::vector_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_unsigned_long_const__ButtonProcessor::TargetingInfo________std::allocator_std::_List_unchecked_iterator_std::_List_val_std::_List_simple_types_std::pair_unsigned_long_const__ButtonProcessor::TargetingInfo___________::_Reallocate_exactly_::_1_::catch$42 @ 0x180045437 (_std--vector_std--_List_unchecked_iterator_std--_List_val_std--_List_simple_types_std--pair_unsi.c)
