/*
 * XREFs of ?RegisterOverride@BamoControllerNavigationManagerPrincipalImpl@BamoImpl@@QEAAJI@Z @ 0x18011D9E0
 * Callers:
 *     ?Thunk_RegisterOverride_10@?$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNavigationManagerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18011DED0 (-Thunk_RegisterOverride_10@-$IControllerNavigationManagerPrincipal_Receive@VBamoControllerNaviga.c)
 * Callees:
