/*
 * XREFs of ?UpdateSupportedFeedback@BamoSimpleHapticsControllerProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EF588
 * Callers:
 ...
 *     ?Thunk_UpdateSupportedFeedback_10@?$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ED0B0 (-Thunk_UpdateSupportedFeedback_10@-$ISimpleHapticsControllerProxy_Receive@VBamoSimpleHapticsCont.c)
 * Callees:
