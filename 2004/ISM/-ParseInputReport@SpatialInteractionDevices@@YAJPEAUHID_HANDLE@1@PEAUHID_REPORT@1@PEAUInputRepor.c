/*
 * XREFs of ?ParseInputReport@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@PEAUHID_REPORT@1@PEAUInputReport@1@@Z @ 0x1800C958C
 * Callers:
 ...
 *     SpatialInteractionDevices::ReadBatteryLevel @ 0x1800C9E90 (SpatialInteractionDevices--ReadBatteryLevel.c)
 *     SpatialInteractionDevices::ReadLocalOrientation @ 0x1800C9ECC (SpatialInteractionDevices--ReadLocalOrientation.c)
 *     SpatialInteractionDevices::ReadPoseOrientation @ 0x1800C9F68 (SpatialInteractionDevices--ReadPoseOrientation.c)
 *     SpatialInteractionDevices::ReadPosePosition @ 0x1800C9F94 (SpatialInteractionDevices--ReadPosePosition.c)
 *     SpatialInteractionDevices::ReadThumbstick @ 0x1800C9FBC (SpatialInteractionDevices--ReadThumbstick.c)
 *     SpatialInteractionDevices::ReadTouchpad @ 0x1800CA048 (SpatialInteractionDevices--ReadTouchpad.c)
 *     SpatialInteractionDevices::ReadTrigger @ 0x1800CA0D4 (SpatialInteractionDevices--ReadTrigger.c)
 *     ?find@?$_Tree@V?$_Tmap_traits@EV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@U?$less@E@2@V?$allocator@U?$pair@$$CBEV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@@std@@@2@$0A@@std@@@std@@QEAA?AV?$_Tree_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBEV?$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@@std@@@std@@@std@@@std@@@2@AEBE@Z @ 0x1800CA640 (-find@-$_Tree@V-$_Tmap_traits@EV-$shared_ptr@USpatialInputReportCaps@SpatialInteractionDevices@@.c)
 */
        ...
        struct SpatialInteractionDevices::InputReport *a4)
{
  ...
  if ( v24 != *v8 )
  {
    ...
    if ( *(_BYTE *)(*(_QWORD *)(v24 + 40) + 143LL) )
    {
      ...
      if ( *((_BYTE *)a3 + 29)
        && *((_BYTE *)a3 + 28)
        && COERCE_FLOAT(*((_DWORD *)a3 + 3) & _xmm) <= 0.001
        && COERCE_FLOAT(*((_DWORD *)a3 + 4) & _xmm) <= 0.001
        && COERCE_FLOAT(*((_DWORD *)a3 + 5) & _xmm) <= 0.001
        && COERCE_FLOAT(*((_DWORD *)a3 + 6) & _xmm) <= 0.001 )
      {
        *((_WORD *)a3 + 14) = 0;
      }
