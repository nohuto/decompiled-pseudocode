/*
 * XREFs of ?MPCHolographicInputManager_DisplayContextChanged_@ISMTracing@@QEAAXAEB_N@Z @ 0x18007672C
 * Callers:
...
void __fastcall ISMTracing::MPCHolographicInputManager_DisplayContextChanged_(ISMTracing *this, const bool *a2)
{
  ...
  if ( ISMTracing::IsEnabled((__int64)this) )
  {
    ...
    if ( **((_DWORD **)v4 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v4 + 1), 1LL) )
    {
      ...
      v11 = v5;
      v10 = &v8;
      tlgWriteTransfer_EventWriteTransfer(v6, (unsigned __int8 *)dword_1801C7AE4, 0LL, 0LL, 3u, &v9);
    }
  }
}
