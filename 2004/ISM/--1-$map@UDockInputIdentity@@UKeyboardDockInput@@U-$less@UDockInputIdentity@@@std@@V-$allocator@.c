/*
 * XREFs of ??1?$map@UDockInputIdentity@@UKeyboardDockInput@@U?$less@UDockInputIdentity@@@std@@V?$allocator@U?$pair@$$CBUDockInputIdentity@@UKeyboardDockInput@@@std@@@4@@std@@QEAA@XZ @ 0x180125F58
 * Callers:
 *     _KeyboardDockServer::KeyboardDockServer_::_1_::dtor$4 @ 0x180050B0D (_KeyboardDockServer--KeyboardDockServer_--_1_--dtor$4.c)
 * Callees:
