 ...
 *     _lambda_05fffcc183c7ee9d162375acc55f4b6c_::operator() @ 0x180157FF8 (_lambda_05fffcc183c7ee9d162375acc55f4b6c_--operator().c)
 *     _lambda_127c0a03318944d5deebafe495b3f28d_::operator() @ 0x180158178 (_lambda_127c0a03318944d5deebafe495b3f28d_--operator().c)
 * Callees:
        ...
        _QWORD *a3)
{
  ...
  if ( v3 == v7 || Windows::Internal::Holographic::CaseInsensitiveStringLess::operator()((__int64)a1, a3, v3 + 4) )
  {
    v9 = *a1;
    v12 = a3;
    v10 = std::_Tree_node<std::pair<std::wstring const,Windows::Internal::Holographic::SpatialGraphSnapshot>,void *>::_Buynode<std::allocator<std::_Tree_node<std::pair<std::wstring const,Windows::Internal::Holographic::SpatialGraphSnapshot>,void *>>,std::piecewise_construct_t const &,std::tuple<std::wstring const &>,std::tuple<>>(
            (__int64)a1,
            v9);
