/*
 * XREFs of ?UpdateVirtualTouchpadController@BamoInputSiteElementProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800F36D0
 * Callers:
 *     ?UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoInputSiteElementProxyImpl@BamoImpl@@UEAAXPEAVBamoProxyImpl@2Microsoft@@@Z @ 0x1800443F0 (-UpdateStateOfProxyOnPlaceholderProxyHookUp@BamoInputSiteElementProxyImpl@BamoImpl@@UEAAXPEAVBam.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *((_QWORD *)this + 25) = v7;
  ...
  if ( *((_BYTE *)this + 28) )
  {
    ...
    v9 = (*(__int64 (__fastcall **)(char *))(*((_QWORD *)this - 2) + 224LL))((char *)this - 16);
    if ( v9 < 0 )
