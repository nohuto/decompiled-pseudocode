/*
 * XREFs of ?CancelResize@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800FC81C
 * Callers:
 *     ?Thunk_CancelResize_112@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FCDE0 (-Thunk_CancelResize_112@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProce.c)
 * Callees:
