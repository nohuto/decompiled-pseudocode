/*
 * XREFs of ?RegisterObserverClient@?$CBaseInputObserverServer@$0M@@@UEAAJPEAVBamoInputObserverManagerStub@@PEAVBamoInputObserverClientProxy@@@Z @ 0x1800F4CC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?UpdateObservationState@?$CBaseInputObserverServer@$0M@@@AEAAXXZ @ 0x180044704 (-UpdateObservationState@-$CBaseInputObserverServer@$0M@@@AEAAXXZ.c)
 *     _guard_dispatch_icall_nop @ 0x18004A6B0 (_guard_dispatch_icall_nop.c)
 *     ??$_Try_emplace@AEB_K$$V@?$unordered_map@_KUInputObserverClient@?$CBaseInputObserverServer@$0M@@@U?$hash@_K@std@@U?$equal_to@_K@4@V?$allocator@U?$pair@$$CB_KUInputObserverClient@?$CBaseInputObserverServer@$0M@@@@std@@@4@@std@@QEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CB_KUInputObserverClient@?$CBaseInputObserverServer@$0M@@@@std@@@std@@@std@@@std@@_N@1@AEB_K@Z @ 0x1800F45DC (--$_Try_emplace@AEB_K$$V@-$unordered_map@_KUInputObserverClient@-$CBaseInputObserverServer@$0M@@.c)
 *     ?GetClientId@@YA_KPEAVBamoInputObserverClientProxy@@@Z @ 0x1800F4BD8 (-GetClientId@@YA_KPEAVBamoInputObserverClientProxy@@@Z.c)
