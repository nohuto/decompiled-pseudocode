/*
 * XREFs of ?OnPromotedToPrimary@MPCGamepadProcessor@@MEAAXXZ @ 0x180193100
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall MPCGamepadProcessor::OnPromotedToPrimary(MPCGamepadProcessor *this)
{
  ...
  *((_QWORD *)this + 633) = *((_QWORD *)Instance + 28);
  *((_DWORD *)this + 1268) = *((_DWORD *)Instance + 58);
  ...
  v6[2] = v10;
  v6[3] = v11;
  v4 = Windows::Foundation::Numerics::transform(v5, (float *)this + 1266, (float *)v6);
  *(_QWORD *)((char *)this + 5076) = *(_QWORD *)v4;
  *(float *)&v4 = v4[2];
  *((_OWORD *)this + 319) = 0LL;
  *((_DWORD *)this + 1271) = (_DWORD)v4;
}
