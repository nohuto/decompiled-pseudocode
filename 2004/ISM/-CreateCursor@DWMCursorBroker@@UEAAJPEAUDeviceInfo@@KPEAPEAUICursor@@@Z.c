/*
 * XREFs of ?CreateCursor@DWMCursorBroker@@UEAAJPEAUDeviceInfo@@KPEAPEAUICursor@@@Z @ 0x180025C80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetCursorDefaultState@@YAJW4InputType@@PEAUCursorState@@@Z @ 0x1800260DC (-GetCursorDefaultState@@YAJW4InputType@@PEAUCursorState@@@Z.c)
