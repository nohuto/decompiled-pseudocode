/*
 * XREFs of ?QueryInterface@ButtonProcessor@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180049F30
 * Callers:
 *     ?QueryInterface@ButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004CFE0 (-QueryInterface@ButtonProcessor@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
