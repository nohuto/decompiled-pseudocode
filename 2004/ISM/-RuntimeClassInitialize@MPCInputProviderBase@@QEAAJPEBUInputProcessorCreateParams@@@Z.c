/*
 * XREFs of ?RuntimeClassInitialize@MPCInputProviderBase@@QEAAJPEBUInputProcessorCreateParams@@@Z @ 0x18001FA40
 * Callers:
 ...
 *     ?Initialize@MPCPerfCounter@@QEAAXKI@Z @ 0x18001FC18 (-Initialize@MPCPerfCounter@@QEAAXKI@Z.c)
