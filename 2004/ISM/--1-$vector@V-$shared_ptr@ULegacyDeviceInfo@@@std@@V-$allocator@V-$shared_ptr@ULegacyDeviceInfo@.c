/*
 * XREFs of ??1?$vector@V?$shared_ptr@ULegacyDeviceInfo@@@std@@V?$allocator@V?$shared_ptr@ULegacyDeviceInfo@@@std@@@2@@std@@QEAA@XZ @ 0x180089EB4
 * Callers:
 *     _MPCRawInputProvider::FlushQueuedDeviceChanges_::_1_::dtor$0 @ 0x18008A6E9 (_MPCRawInputProvider--FlushQueuedDeviceChanges_--_1_--dtor$0.c)
 * Callees:
