/*
 * XREFs of ?GetPresentationModeFromViewId@ViewHelper@@SA?AW4AppModelHolographicPresentationMode@WindowManagement@ApplicationModel@Internal@Windows@winrt@@AEAVViewHierarchyWithWindowManager@@I@Z @ 0x180041F70
 * Callers:
 ...
 *     ??$as@UUniversalAppModel@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@IUnknown@Foundation@Windows@winrt@@QEBA?AUUniversalAppModel@WindowManagement@ApplicationModel@Internal@23@XZ @ 0x1800BC6F4 (--$as@UUniversalAppModel@WindowManagement@ApplicationModel@Internal@Windows@winrt@@@IUnknown@Fou.c)
