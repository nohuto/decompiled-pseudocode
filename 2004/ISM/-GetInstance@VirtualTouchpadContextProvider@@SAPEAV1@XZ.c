/*
 * XREFs of ?GetInstance@VirtualTouchpadContextProvider@@SAPEAV1@XZ @ 0x1801459DC
 * Callers:
...
struct VirtualTouchpadContextProvider *VirtualTouchpadContextProvider::GetInstance(void)
{
  ...
  if ( dword_180209514 > *(_DWORD *)(v1 + 16) )
  {
    Init_thread_header(&dword_180209514);
    if ( dword_180209514 == -1 )
    {
      atexit(VirtualTouchpadContextProvider::GetInstance_::_2_::_dynamic_atexit_destructor_for__s_instance__);
      Init_thread_footer(&dword_180209514);
    }
  }
