/*
 * XREFs of ?DestroyCustomCursorShapeAnimation@BamoSystemCursorControllerPrincipalImpl@BamoImpl@@QEAAJ_K@Z @ 0x18013C37C
 * Callers:
 *     ?Thunk_DestroyCustomCursorShapeAnimation_2@?$ISystemCursorControllerPrincipal_Receive@VBamoSystemCursorControllerPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18013CE80 (-Thunk_DestroyCustomCursorShapeAnimation_2@-$ISystemCursorControllerPrincipal_Receive@VBamoSyste.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  v7 = (*(__int64 (__fastcall **)(char *, __int64, __int64))(*((_QWORD *)this - 2) + 120LL))((char *)this - 16, v6, a2);
  if ( v7 < 0 )
