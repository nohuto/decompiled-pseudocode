        ...
        __int64 a3)
{
  ...
  while ( !*(_BYTE *)(v3 + 25) )
  {
    ...
    if ( v7 )
    {
      v8 = (void (__fastcall ***)(_QWORD))(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v7 + 8LL))(v7);
      (**v8)(v8);
    }
