/*
 * XREFs of ?ReceivedInterceptMessage@Win32kInterop@InputETW@@SAXK@Z @ 0x1800B2494
 * Callers:
...
void __fastcall InputETW::Win32kInterop::ReceivedInterceptMessage(__int64 a1)
{
  ...
  if ( InputETW::IsEnabled(a1) )
  {
    ...
    if ( **((_DWORD **)v3 + 1) > 5u && tlgKeywordOn(*((_QWORD *)v3 + 1), 1LL) )
    {
      ...
      v5 = v1;
      v8 = 8;
      tlgWriteTransfer_EventWriteTransfer(v4, (unsigned __int8 *)dword_1801CA36F, 0LL, 0LL, 3u, &v6);
    }
  }
}
