/*
 * XREFs of ??F?$SafeInt@KUSafeIntErrorPolicy_SafeIntException@utilities@msl@@@utilities@msl@@QEAA?AV012@H@Z @ 0x1800F4940
 * Callers:
 ...
 * Callees:
 *     ?SafeIntOnOverflow@SafeIntErrorPolicy_SafeIntException@utilities@msl@@SAXXZ @ 0x1800F4DE4 (-SafeIntOnOverflow@SafeIntErrorPolicy_SafeIntException@utilities@msl@@SAXXZ.c)
 */
