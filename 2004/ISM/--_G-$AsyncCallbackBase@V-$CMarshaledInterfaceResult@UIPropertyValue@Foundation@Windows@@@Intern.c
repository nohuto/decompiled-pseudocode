/*
 * XREFs of ??_G?$AsyncCallbackBase@V?$CMarshaledInterfaceResult@UIPropertyValue@Foundation@Windows@@@Internal@Windows@@@Internal@Windows@@UEAAPEAXI@Z @ 0x180111E80
 * Callers:
 *     <none>
 * Callees:
