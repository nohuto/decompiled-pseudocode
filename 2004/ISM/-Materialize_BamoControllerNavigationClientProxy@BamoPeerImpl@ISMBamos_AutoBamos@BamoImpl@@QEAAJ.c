/*
 * XREFs of ?Materialize_BamoControllerNavigationClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E6914
 * Callers:
 *     ?Thunk_Materialize_BamoControllerNavigationClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECA20 (-Thunk_Materialize_BamoControllerNavigationClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive.c)
 * Callees:
