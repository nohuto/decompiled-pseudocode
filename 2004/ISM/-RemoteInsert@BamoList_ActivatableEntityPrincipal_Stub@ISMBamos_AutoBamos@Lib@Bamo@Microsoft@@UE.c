/*
 * XREFs of ?RemoteInsert@BamoList_ActivatableEntityPrincipal_Stub@ISMBamos_AutoBamos@Lib@Bamo@Microsoft@@UEAAJIPEAVBamoActivatableEntityPrincipal@@@Z @ 0x180007210
 * Callers:
 *     <none>
 * Callees:
        ...
        struct BamoActivatableEntityPrincipal *a3)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v9 + 3) + 32LL) + 56LL) )
  {
    ...
    if ( *((_BYTE *)this + 40) && *(_QWORD *)(*(_QWORD *)(*((_QWORD *)v9 + 3) + 32LL) + 56LL) )
    {
      ...
      v18[1] = v14;
      v17 = 0;
      v10 = CoreUICallSend(SendHost, v18, 2LL, 71LL, v17, &unk_1801BF220, a2);
      goto LABEL_12;
    }
    v10 = -2018375675;
