/*
 * XREFs of ?UpdateState@MPCButtonHoldHelper@@QEAAX_N_K@Z @ 0x180084FC0
 * Callers:
 ...
 * Callees:
 *     ?ResetState@MPCButtonHoldHelper@@QEAAXXZ @ 0x180084FA4 (-ResetState@MPCButtonHoldHelper@@QEAAXXZ.c)
 */
