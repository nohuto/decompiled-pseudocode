/*
 * XREFs of ?HandStateRead_@SpatialInteractionTraceContinuous@SpatialInteractionDevices@@QEAAXU_GUID@@_J_N2H22@Z @ 0x1800DFAE4
 * Callers:
        ...
        bool a8)
{
  ...
  v22 = this;
  v11 = 1000000 * a3 / qword_180208310;
