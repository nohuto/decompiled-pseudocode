/*
 * XREFs of ??0SpatialGraphDriverHandleWrapper@Holographic@Internal@Windows@@AEAA@PEAUHSTRING__@@AEBU_GUID@@W4HandleWrapperDesiredAccess@123@_NPEAX@Z @ 0x180156AF4
 * Callers:
 ...
 *     ??0ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ @ 0x180156590 (--0ChainedThreadpoolWorker@ThreadHelpers@@QEAA@XZ.c)
