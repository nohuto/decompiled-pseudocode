/*
 * XREFs of ?OnDockDeviceRemoved@BamoKeyboardDockClientProxyImpl@BamoImpl@@QEAAJI@Z @ 0x180128ACC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoKeyboardDockClientProxyImpl::OnDockDeviceRemoved(
