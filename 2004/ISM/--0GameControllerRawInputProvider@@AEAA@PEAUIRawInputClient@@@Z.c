/*
 * XREFs of ??0GameControllerRawInputProvider@@AEAA@PEAUIRawInputClient@@@Z @ 0x1800340CC
 * Callers:
 ...
 *     ??0QpcTimeConverter@@QEAA@XZ @ 0x18003449C (--0QpcTimeConverter@@QEAA@XZ.c)
