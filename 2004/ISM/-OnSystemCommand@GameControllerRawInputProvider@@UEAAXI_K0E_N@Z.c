/*
 * XREFs of ?OnSystemCommand@GameControllerRawInputProvider@@UEAAXI_K0E_N@Z @ 0x180088BB0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??4?$com_ptr_t@UIRawInputClient@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@AEBV01@@Z @ 0x180040AF4 (--4-$com_ptr_t@UIRawInputClient@@Uerr_exception_policy@wil@@@wil@@QEAAAEAV01@AEBV01@@Z.c)
 *     ??I?$com_ptr_t@UIMessageTimer@@Uerr_exception_policy@wil@@@wil@@QEAAPEAPEAUIMessageTimer@@XZ @ 0x180040B48 (--I-$com_ptr_t@UIMessageTimer@@Uerr_exception_policy@wil@@@wil@@QEAAPEAPEAUIMessageTimer@@XZ.c)
 ...
 *     ?PushBack@?$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAXPEAUShellButtonListEntry@GameControllerRawInputProvider@@@Z @ 0x180040BC4 (-PushBack@-$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAXPEAUShellButtonL.c)
 *     ?RemoveAt@?$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAPEAUShellButtonListEntry@GameControllerRawInputProvider@@PEAU23@@Z @ 0x180040BF0 (-RemoveAt@-$NtList@UShellButtonListEntry@GameControllerRawInputProvider@@@@QEAAPEAUShellButtonLi.c)
 *     _guard_dispatch_icall_nop @ 0x18004A6B0 (_guard_dispatch_icall_nop.c)
 *     ?SetTimestampsFromInput@GameControllerRawInputProvider@@AEAAX_KPEAUInputInfo@@@Z @ 0x180089094 (-SetTimestampsFromInput@GameControllerRawInputProvider@@AEAAX_KPEAUInputInfo@@@Z.c)
