/*
 * XREFs of ?UpdateActivationWatcher@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800ED528
 * Callers:
 ...
 *     ?Thunk_UpdateActivationWatcher_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECDD0 (-Thunk_UpdateActivationWatcher_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl.c)
 * Callees:
