/*
 * XREFs of ??1?$pair@$$CBU_GUID@@V?$list@UKeyEventData@VirtualHotKeyTracker@@V?$allocator@UKeyEventData@VirtualHotKeyTracker@@@std@@@std@@@std@@QEAA@XZ @ 0x18017FE24
 * Callers:
 *     _VirtualHotKeyTracker::OnInput_::_1_::dtor$0 @ 0x18018154F (_VirtualHotKeyTracker--OnInput_--_1_--dtor$0.c)
 * Callees:
