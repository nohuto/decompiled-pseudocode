/*
 * XREFs of ?Initialize@?$KernelInputConnection@U_MIT_INPUT_CONFIG_MESSAGE@@@@QEAAXAEBV?$ComPtr@UIMessageSession@@@WRL@Microsoft@@W4_MIT_ENDPOINT@@V?$function@$$A6AXPEBU_MIT_INPUT_CONFIG_MESSAGE@@@Z@std@@@Z @ 0x18002D2E4
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( !*(_BYTE *)ISMTestMode::s_instance )
  {
    ...
    wil::unique_com_token<IMessageSession,unsigned __int64,void (IMessageSession *,unsigned __int64),&void wil::details::IMessageSessionCloseEndpointFunction(IMessageSession *,unsigned __int64),0>::reset(
      ...
      a1[1]);
    v20 = (_DWORD)a1 + 16;
    v15 = v14(v13, KernelInputConnection<_MIT_INPUT_CONFIG_MESSAGE>::s_OnKernelInputEventStatic, a1, *a1);
    if ( v15 < 0 )
    {
      wil::details::in1diag3::FailFast_Hr(
        retaddr,
    ...
    v17 = NtMITCoreMsgKOpenConnectionTo(7LL, a1 + 3);
    if ( v17 < 0 )
    {
