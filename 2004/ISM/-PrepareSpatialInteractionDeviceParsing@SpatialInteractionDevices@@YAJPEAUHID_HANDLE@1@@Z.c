/*
 * XREFs of ?PrepareSpatialInteractionDeviceParsing@SpatialInteractionDevices@@YAJPEAUHID_HANDLE@1@@Z @ 0x1800C9800
 * Callers:
 ...
 *     SpatialInteractionDevices::GetUsageDesc_SpatialInteractionDevices::UsageMapping_SpatialInteractionDevices::UsageDesc_SpatialInteractionDevices::BitUsage_enum_SpatialInteractionDevices::ButtonFlags____1___ @ 0x1800C6F3C (SpatialInteractionDevices--GetUsageDesc_SpatialInteractionDevices--UsageMapping_SpatialInteracti.c)
 *     SpatialInteractionDevices::GetUsageDesc_SpatialInteractionDevices::UsageMapping_SpatialInteractionDevices::UsageDesc_SpatialInteractionDevices::ValueUsage__1___ @ 0x1800C6FE8 (SpatialInteractionDevices--GetUsageDesc_SpatialInteractionDevices--UsageMapping_Spa_ea_1800C6FE8.c)
 *     SpatialInteractionDevices::GetUsageDesc_SpatialInteractionDevices::UsageMapping_SpatialInteractionDevices::UsageDesc_SpatialInteractionDevices::ValueUsage__3___ @ 0x1800C7084 (SpatialInteractionDevices--GetUsageDesc_SpatialInteractionDevices--UsageMapping_Spa_ea_1800C7084.c)
 *     SpatialInteractionDevices::GetUsageDesc_SpatialInteractionDevices::UsageMapping_SpatialInteractionDevices::UsageDesc_SpatialInteractionDevices::ValueUsage__4___ @ 0x1800C7130 (SpatialInteractionDevices--GetUsageDesc_SpatialInteractionDevices--UsageMapping_Spa_ea_1800C7130.c)
 *     SpatialInteractionDevices::HasAllCaps_1_ @ 0x1800C74C0 (SpatialInteractionDevices--HasAllCaps_1_.c)
 *     SpatialInteractionDevices::HasAllCaps_2_ @ 0x1800C74E0 (SpatialInteractionDevices--HasAllCaps_2_.c)
 *     SpatialInteractionDevices::HasAllCaps_4_ @ 0x1800C7500 (SpatialInteractionDevices--HasAllCaps_4_.c)
 ...
 *     std::_Sort_unchecked_SpatialInteractionDevices::SpatialInputButtonCaps____lambda_7cb88ca86370cec64ac2ea824bd2a3de___ @ 0x1800C8AF8 (std--_Sort_unchecked_SpatialInteractionDevices--SpatialInputButtonCaps____lambda_7cb88ca86370cec.c)
 *     ??E?$_Tree_unchecked_const_iterator@V?$_Tree_val@U?$_Tree_simple_types@U?$pair@$$CBKUContactState@MagnifierRecognizer@@@std@@@std@@@std@@U_Iterator_base0@2@@std@@QEAAAEAV01@XZ @ 0x1800C8DB8 (--E-$_Tree_unchecked_const_iterator@V-$_Tree_val@U-$_Tree_simple_types@U-$pair@$$CBKUContactStat.c)
 *     SpatialInteractionDevices::GetReportCaps @ 0x1800C9400 (SpatialInteractionDevices--GetReportCaps.c)
 *     SpatialInteractionDevices::IsValidButtonUsage @ 0x1800C94EC (SpatialInteractionDevices--IsValidButtonUsage.c)
 */
  ...
  *(_BYTE *)(v8 + 237) = (_BYTE)v7;
  ...
  try
  {
    ...
    for ( j = 0; j < *((_DWORD *)this + 34); ++j )
    {
      ...
      LOBYTE(v52) = 0;
      v20 = SpatialInteractionDevices::StoreCapsIfMatches_1_((__int64)&off_1801B8EC8, v18, v19, &v52);
      v21 = v20;
      if ( v20 < 0 )
      {
      ...
      if ( !(_BYTE)v52 )
      {
        v24 = SpatialInteractionDevices::StoreCapsIfMatches_4_((__int64)&off_1801B8D50, v18, v19 + 48, &v52);
        v25 = v24;
        if ( v24 < 0 )
        {
          wil::details::in1diag3::Return_Hr(
        ...
        if ( !(_BYTE)v52 )
        {
          ...
          if ( !(_BYTE)v52 )
          {
            v28 = SpatialInteractionDevices::StoreCapsIfMatches_2_((__int64)&off_1801B8D80, v18, v19 + 8, &v52);
            v29 = v28;
            if ( v28 < 0 )
            {
              wil::details::in1diag3::Return_Hr(
