/*
 * XREFs of ?ProcessResult@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJIPEAUDragOperationResult@Input@Internal@UI@Windows@@I@Z @ 0x1800F5B6C
 * Callers:
 *     ?Thunk_ProcessResult_116@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F60E0 (-Thunk_ProcessResult_116@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextu.c)
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDragNDropContextualProcessorPrincipalImpl::ProcessResult(
        BamoImpl::BamoDragNDropContextualProcessorPrincipalImpl *this,
        unsigned int a2,
        struct Windows::UI::Internal::Input::DragOperationResult *a3,
        unsigned int a4)
{
  int v8; // ecx
  _QWORD *i; // rbx
  ...
  Microsoft::BamoImpl::DropAndReacquireLock::DropAndReacquireLock(
    ...
    v12);
  v16 = (*(__int64 (__fastcall **)(char *, __int64, _QWORD, struct Windows::UI::Internal::Input::DragOperationResult *, char *))(*((_QWORD *)this - 2) + 96LL))(
          (char *)this - 16,
          v10,
          a2,
          a3,
