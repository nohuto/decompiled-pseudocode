/*
 * XREFs of ?UpdateActivatedRemoteCache@BamoActivationControllerProxyImpl@BamoImpl@@AEAAXXZ @ 0x18000AB40
 * Callers:
 *     ?SetActivated@BamoActivationControllerProxy@@UEAAX_N@Z @ 0x18000A8F0 (-SetActivated@BamoActivationControllerProxy@@UEAAX_N@Z.c)
 *     ?PushStateToPrincipalOnPlaceholderProxyReset@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXXZ @ 0x180046270 (-PushStateToPrincipalOnPlaceholderProxyReset@BamoActivationControllerProxyImpl@BamoImpl@@UEAAXXZ.c)
 * Callees:
        ...
        BamoImpl::BamoActivationControllerProxyImpl *this)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 24) + 32LL) + 56LL) )
  {
    ...
    v13[1] = v7;
    v11 = 0;
    v9 = CoreUICallSend(v8, v13, 2LL, 3LL, v11, &unk_1801BF1BD, v6);
