/*
 * XREFs of ??_GGameControllerRawInputProvider@@UEAAPEAXI@Z @ 0x180088344
 * Callers:
 *     ??_EGameControllerRawInputProvider@@WBI@EAAPEAXI@Z @ 0x18004A9E0 (--_EGameControllerRawInputProvider@@WBI@EAAPEAXI@Z.c)
 * Callees:
