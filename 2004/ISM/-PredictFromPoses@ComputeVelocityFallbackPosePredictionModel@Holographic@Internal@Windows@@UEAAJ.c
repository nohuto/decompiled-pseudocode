/*
 * XREFs of ?PredictFromPoses@ComputeVelocityFallbackPosePredictionModel@Holographic@Internal@Windows@@UEAAJPEAUSPATIAL_GRAPH_DYNAMIC_NODE_POSE@@_K_J0@Z @ 0x180161BF0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0PoseWithDifferentials@PosePredictionTools@@QEAA@XZ @ 0x180156788 (--0PoseWithDifferentials@PosePredictionTools@@QEAA@XZ.c)
 ...
 *     ??$SE3_invert@M@ST@@YAXAEAU?$SE3@M@0@AEBU10@@Z @ 0x1801A4FCC (--$SE3_invert@M@ST@@YAXAEAU-$SE3@M@0@AEBU10@@Z.c)
 *     ??$SE3_log@M@ST@@YAXQEAMAEBU?$SE3@M@0@@Z @ 0x1801A5098 (--$SE3_log@M@ST@@YAXQEAMAEBU-$SE3@M@0@@Z.c)
 *     ??$SE3_mult_a_binv@M@ST@@YAXAEAU?$SE3@M@0@AEBU10@1@Z @ 0x1801A522C (--$SE3_mult_a_binv@M@ST@@YAXAEAU-$SE3@M@0@AEBU10@1@Z.c)
 */
...
LABEL_10:
  ...
  v84 = v34;
  v85 = v35;
  v44 = (double)(int)qword_1802082F0;
  v45 = (double)((int)a4 - (int)v76) / (double)(int)qword_1802082F0;
  if ( v45 <= 0.0 )
  {
    v51 = v77;
    *(_OWORD *)a5 = v76;
