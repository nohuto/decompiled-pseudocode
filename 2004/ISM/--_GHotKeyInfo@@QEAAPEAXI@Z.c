/*
 * XREFs of ??_GHotKeyInfo@@QEAAPEAXI@Z @ 0x18019F640
 * Callers:
 ...
 *     ?_Destroy@?$_Ref_count_obj@UHotKeyInfo@@@std@@EEAAXXZ @ 0x1801A1EC0 (-_Destroy@-$_Ref_count_obj@UHotKeyInfo@@@std@@EEAAXXZ.c)
 * Callees:
