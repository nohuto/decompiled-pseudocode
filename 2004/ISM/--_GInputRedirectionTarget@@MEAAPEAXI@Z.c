/*
 * XREFs of ??_GInputRedirectionTarget@@MEAAPEAXI@Z @ 0x18017F524
 * Callers:
 *     ??_EInputRedirectionTarget@@OBA@EAAPEAXI@Z @ 0x18004CED0 (--_EInputRedirectionTarget@@OBA@EAAPEAXI@Z.c)
 * Callees:
