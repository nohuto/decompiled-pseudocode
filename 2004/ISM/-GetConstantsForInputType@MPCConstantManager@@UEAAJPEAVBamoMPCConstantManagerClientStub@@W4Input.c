/*
 * XREFs of ?GetConstantsForInputType@MPCConstantManager@@UEAAJPEAVBamoMPCConstantManagerClientStub@@W4InputType@@PEAVBamoAsyncResult_string_Proxy@@@Z @ 0x18006EDA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MPCConstantManager::GetConstantsForInputType(__int64 a1, __int64 a2, unsigned int a3, __int64 a4)
{
  __int64 v6; // rbx
  _QWORD *v8; // rdx
  unsigned int v9; // ebx
