/*
 * XREFs of ?GetRouting@BamoEdgyControllerClientProxy@@UEAAIXZ @ 0x1800FFA30
 * Callers:
 *     ?OnRoutingChanged@EdgyControllerClientProxy@@MEAAJXZ @ 0x1800FFC20 (-OnRoutingChanged@EdgyControllerClientProxy@@MEAAJXZ.c)
