/*
 * XREFs of ?get@?$static_lazy@VHolographicDriverClientContinuousTrace@@@details@wil@@QEAAPEAVHolographicDriverClientContinuousTrace@@P6AXXZ@Z @ 0x180167ABC
 * Callers:
...
LPVOID __fastcall wil::details::static_lazy<HolographicDriverClientContinuousTrace>::get(
        __int64 a1,
        void (__cdecl *a2)())
{
  ...
  v4 = a1;
  v5 = 0LL;
  if ( InitOnceBeginInitialize(&`HolographicDriverClientContinuousTrace::Instance'::`2'::wrapper, 0, (PBOOL)&v4, &v5)
    && (_DWORD)v4 )
  {
    v5 = &qword_180208A08;
    qword_180208A08 = &RawInputProvidersContinuousTracing::`vftable';
    qword_180208A20 = (struct _tlgProvider_t *)&`HolographicDriverClientContinuousTrace::StaticHandle::StaticHandle'::`2'::__hInner;
    atexit(a2);
    wil::TraceLoggingProvider::Register((wil::TraceLoggingProvider *)&qword_180208A08, qword_180208A20, 0LL);
    InitOnceComplete(&`HolographicDriverClientContinuousTrace::Instance'::`2'::wrapper, 0, &qword_180208A08);
  }
  return v5;
}
