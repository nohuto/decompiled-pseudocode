/*
 * XREFs of ?make_quaternion_from_axis_angle@Numerics@Foundation@Windows@@YA?AUquaternion@123@AEBUfloat3@123@M@Z @ 0x180086854
 * Callers:
 ...
 * Callees:
 *     cosf_0 @ 0x18004A637 (cosf_0.c)
 *     sinf_0 @ 0x18004A64F (sinf_0.c)
 */
