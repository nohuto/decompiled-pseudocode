/*
 * XREFs of _std::vector_INPUT_SPACE_PAYLOAD_std::allocator_INPUT_SPACE_PAYLOAD___::_Emplace_reallocate_INPUT_SPACE_PAYLOAD_const_&__::_1_::catch$50 @ 0x180051203
 * Callers:
 *     <none>
 * Callees:
