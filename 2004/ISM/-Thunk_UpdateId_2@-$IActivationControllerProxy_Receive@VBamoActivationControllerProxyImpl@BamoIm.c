/*
 * XREFs of ?Thunk_UpdateId_2@?$IActivationControllerProxy_Receive@VBamoActivationControllerProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x180011980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall IActivationControllerProxy_Receive<BamoImpl::BamoActivationControllerProxyImpl>::Thunk_UpdateId_2(
        __int64 a1,
        _QWORD **a2)
{
  int v4; // eax
