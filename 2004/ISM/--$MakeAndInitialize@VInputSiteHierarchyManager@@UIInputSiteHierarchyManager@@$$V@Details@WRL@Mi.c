/*
 * XREFs of ??$MakeAndInitialize@VInputSiteHierarchyManager@@UIInputSiteHierarchyManager@@$$V@Details@WRL@Microsoft@@YAJPEAPEAUIInputSiteHierarchyManager@@@Z @ 0x18001EFD8
 * Callers:
 ...
 * Callees:
 *     ??0InputSiteHierarchyManager@@AEAA@XZ @ 0x18001F0D4 (--0InputSiteHierarchyManager@@AEAA@XZ.c)
