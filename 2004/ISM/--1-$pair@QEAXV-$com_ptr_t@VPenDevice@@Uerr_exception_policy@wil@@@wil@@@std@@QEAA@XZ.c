/*
 * XREFs of ??1?$pair@QEAXV?$com_ptr_t@VPenDevice@@Uerr_exception_policy@wil@@@wil@@@std@@QEAA@XZ @ 0x18012E9BC
 * Callers:
 *     _PenDeviceManager::RepopulateActiveBamoForId_::_1_::dtor$2 @ 0x180130441 (_PenDeviceManager--RepopulateActiveBamoForId_--_1_--dtor$2.c)
 * Callees:
 *     <none>
 */
