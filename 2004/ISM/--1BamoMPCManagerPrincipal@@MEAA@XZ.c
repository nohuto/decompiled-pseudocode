/*
 * XREFs of ??1BamoMPCManagerPrincipal@@MEAA@XZ @ 0x180071524
 * Callers:
 *     _MPCManager::MPCManager_::_1_::dtor$0 @ 0x180050EF9 (_MPCManager--MPCManager_--_1_--dtor$0.c)
 *     _PenDeviceManager::PenDeviceManager_::_1_::dtor$0 @ 0x18012E901 (_PenDeviceManager--PenDeviceManager_--_1_--dtor$0.c)
 * Callees:
