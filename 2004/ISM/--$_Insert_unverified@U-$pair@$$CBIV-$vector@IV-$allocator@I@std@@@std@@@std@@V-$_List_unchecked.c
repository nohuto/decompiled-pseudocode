/*
 * XREFs of ??$_Insert_unverified@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@std@@@std@@@2@@?$_Hash@V?$_Umap_traits@IV?$vector@IV?$allocator@I@std@@@std@@V?$_Uhash_compare@IU?$hash@I@std@@U?$equal_to@I@2@@2@V?$allocator@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@2@$0A@@std@@@std@@IEAA?AU?$pair@V?$_List_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@std@@@std@@@std@@_N@1@$$QEAU?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@1@V?$_List_unchecked_iterator@V?$_List_val@U?$_List_simple_types@U?$pair@$$CBIV?$vector@IV?$allocator@I@std@@@std@@@std@@@std@@@std@@@1@@Z @ 0x1800AD974
 * Callers:
        ...
        __int64 *a4)
{
  ...
  v8 = *std::_Hash<std::_Umap_traits<unsigned long,tagPOINT,std::_Uhash_compare<unsigned long,std::hash<unsigned long>,std::equal_to<unsigned long>>,std::allocator<std::pair<unsigned long const,tagPOINT>>,0>>::_End(
          ...
          &v20,
          qword_180208BA0 & appended);
  v10 = qword_180208B88;
  while ( v8 != *(_QWORD *)(qword_180208B88 + 16 * v9) )
  {
    v8 = *(_QWORD *)(v8 + 8);
    if ( *(_DWORD *)a3 == *(_DWORD *)(v8 + 16) )
    {
      std::list<std::pair<unsigned int const,std::vector<unsigned int>>>::erase(&qword_180208B78, &v20, a4);
      *(_QWORD *)a2 = v8;
      *(_BYTE *)(a2 + 8) = 0;
      return a2;
    }
  ...
  if ( v15 == qword_180208B78 )
  {
    *(_QWORD *)(v10 + 16 * v9) = a4;
    *(_QWORD *)(qword_180208B88 + 16 * v9 + 8) = a4;
  }
  else
  {
    ...
    else
    {
      ...
      if ( v18 != a4 )
      {
        v19 = *(_QWORD *)(qword_180208B88 + 8 * v14 + 8);
        *(_QWORD *)(qword_180208B88 + 8 * v14 + 8) = *(_QWORD *)(v19 + 8);
      }
    }
  }
  try
