/*
 * XREFs of ?OnETCalibrationRequested@MPCManager@@QEAAXI@Z @ 0x180072F10
 * Callers:
 *     ?OnDeviceUpdate@MPCEyeGazeProcessor@@UEAAJPEAUDeviceInfo@@@Z @ 0x1801974F0 (-OnDeviceUpdate@MPCEyeGazeProcessor@@UEAAJPEAUDeviceInfo@@@Z.c)
 * Callees:
