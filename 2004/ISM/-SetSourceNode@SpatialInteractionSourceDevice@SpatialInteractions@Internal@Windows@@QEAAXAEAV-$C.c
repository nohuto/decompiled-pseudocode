/*
 * XREFs of ?SetSourceNode@SpatialInteractionSourceDevice@SpatialInteractions@Internal@Windows@@QEAAXAEAV?$ComPtr@UISpatialGraphNodeReference@Holographic@Internal@Windows@@@WRL@Microsoft@@@Z @ 0x1800D8864
 * Callers:
 *     _lambda_2610a4571c07b034f8353f9aca44fe5c_::operator() @ 0x1800D5EC0 (_lambda_2610a4571c07b034f8353f9aca44fe5c_--operator().c)
 *     ?StopTracking@SpatialInteractionSourceObject@SpatialInteractions@Internal@Windows@@UEAAJW4StopTrackingReason@234@@Z @ 0x1800DA050 (-StopTracking@SpatialInteractionSourceObject@SpatialInteractions@Internal@Windows@@UEAAJW4StopTr.c)
