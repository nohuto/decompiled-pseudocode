/*
 * XREFs of ??$make_unique_cotaskmem_nothrow@$$BY0A@UHOLOGRAPHIC_DEVICE_ERROR_STATUS@@@wil@@YA?AV?$unique_ptr@$$BY0A@UHOLOGRAPHIC_DEVICE_ERROR_STATUS@@U?$function_deleter@P6AXPEAX@Z$1?CoTaskMemFree@@YAX0@Z@wil@@@wistd@@_K@Z @ 0x180156150
 * Callers:
