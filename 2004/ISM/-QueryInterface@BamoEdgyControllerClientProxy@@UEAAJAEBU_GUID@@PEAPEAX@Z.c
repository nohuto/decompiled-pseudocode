/*
 * XREFs of ?QueryInterface@BamoEdgyControllerClientProxy@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800FFD20
 * Callers:
 *     ?QueryInterface@BamoEdgyControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004B510 (-QueryInterface@BamoEdgyControllerClientProxy@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
