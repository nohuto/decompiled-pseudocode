/*
 * XREFs of ??$_Sort_unchecked@PEAEU?$less@X@std@@@std@@YAXPEAE0_JU?$less@X@0@@Z @ 0x1800A5A20
 * Callers:
 ...
 * Callees:
 *     ??$_Insertion_sort_unchecked@PEAEU?$less@X@std@@@std@@YAPEAEPEAEQEAEU?$less@X@0@@Z @ 0x1800A4CFC (--$_Insertion_sort_unchecked@PEAEU-$less@X@std@@@std@@YAPEAEPEAEQEAEU-$less@X@0@@Z.c)
 *     ??$_Partition_by_median_guess_unchecked@PEAEU?$less@X@std@@@std@@YA?AU?$pair@PEAEPEAE@0@PEAE0U?$less@X@0@@Z @ 0x1800A50B4 (--$_Partition_by_median_guess_unchecked@PEAEU-$less@X@std@@@std@@YA-AU-$pair@PEAEPEAE@0@PEAE0U-$.c)
 *     ??$_Pop_heap_hole_by_index@PEAEEU?$less@X@std@@@std@@YAXPEAE_J1$$QEAEU?$less@X@0@@Z @ 0x1800A5604 (--$_Pop_heap_hole_by_index@PEAEEU-$less@X@std@@@std@@YAXPEAE_J1$$QEAEU-$less@X@0@@Z.c)
 *     ??$_Sort_heap_unchecked@PEAEU?$less@X@std@@@std@@YAXPEAE0U?$less@X@0@@Z @ 0x1800A5910 (--$_Sort_heap_unchecked@PEAEU-$less@X@std@@@std@@YAXPEAE0U-$less@X@0@@Z.c)
 *     ??$_Sort_unchecked@PEAEU?$less@X@std@@@std@@YAXPEAE0_JU?$less@X@0@@Z @ 0x1800A5A20 (--$_Sort_unchecked@PEAEU-$less@X@std@@@std@@YAXPEAE0_JU-$less@X@0@@Z.c)
 */
...
LABEL_12:
    if ( (__int64)result >= 2 )
      return (unsigned __int8 *)std::_Insertion_sort_unchecked<unsigned char *,std::less<void>>((char *)v8, (char *)v7);
  }
  else
  {
    v10 = (__int64)&v7[-v8];
