/*
 * XREFs of ?Undocked@BamoPenEventsClientProxyImpl@BamoImpl@@QEAAJ_N@Z @ 0x18013499C
 * Callers:
...
__int64 __fastcall BamoImpl::BamoPenEventsClientProxyImpl::Undocked(
        ...
        unsigned __int8 a2)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 5;
      return CoreUICallSend(v8, v10, 2LL, 52LL, v9, &unk_1801BF1BD, v3);
    }
    else
    {
