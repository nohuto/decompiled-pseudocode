/*
 * XREFs of ?UpdateHeatGripService@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE260
 * Callers:
 ...
 *     ?Thunk_UpdateHeatGripService_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECEE0 (-Thunk_UpdateHeatGripService_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@.c)
 * Callees:
