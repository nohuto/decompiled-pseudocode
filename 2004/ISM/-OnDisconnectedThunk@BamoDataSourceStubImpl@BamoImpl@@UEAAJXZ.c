/*
 * XREFs of ?OnDisconnectedThunk@BamoDataSourceStubImpl@BamoImpl@@UEAAJXZ @ 0x180072E80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall BamoImpl::BamoDataSourceStubImpl::OnDisconnectedThunk(BamoImpl::BamoDataSourceStubImpl *this)
{
  __int64 v2; // rdi
  unsigned int v3; // edi
  __int64 v4; // rbx
