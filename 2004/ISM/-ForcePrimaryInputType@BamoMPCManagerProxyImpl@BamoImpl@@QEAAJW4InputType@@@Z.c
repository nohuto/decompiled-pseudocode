/*
 * XREFs of ?ForcePrimaryInputType@BamoMPCManagerProxyImpl@BamoImpl@@QEAAJW4InputType@@@Z @ 0x1801079CC
 * Callers:
...
__int64 __fastcall BamoImpl::BamoMPCManagerProxyImpl::ForcePrimaryInputType(__int64 a1, int a2)
{
  char *v2; // rbx
  int v6; // eax
  unsigned int v7; // esi
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 24LL) + 32LL) + 56LL) )
  {
    ...
    if ( v6 >= 0 )
    {
      ...
      v10[1] = v13;
      v9 = 5;
      return CoreUICallSend(v8, v10, 2LL, 3LL, v9, &unk_1801C18B5, a2);
    }
    else
    {
