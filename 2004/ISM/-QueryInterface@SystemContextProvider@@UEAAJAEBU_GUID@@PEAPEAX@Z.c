/*
 * XREFs of ?QueryInterface@SystemContextProvider@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180147650
 * Callers:
 *     ?QueryInterface@SystemContextProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C760 (-QueryInterface@SystemContextProvider@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
