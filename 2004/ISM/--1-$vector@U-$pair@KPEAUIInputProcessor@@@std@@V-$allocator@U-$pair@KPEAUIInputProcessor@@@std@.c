/*
 * XREFs of ??1?$vector@U?$pair@KPEAUIInputProcessor@@@std@@V?$allocator@U?$pair@KPEAUIInputProcessor@@@std@@@2@@std@@QEAA@XZ @ 0x18008706C
 * Callers:
 *     _InputStateManager::InputStateManager_::_1_::dtor$4 @ 0x1800504FB (_InputStateManager--InputStateManager_--_1_--dtor$4.c)
 *     _SystemCursorService::SystemCursorService_::_1_::dtor$3 @ 0x18013E392 (_SystemCursorService--SystemCursorService_--_1_--dtor$3.c)
 *     ??1?$vector@USPATIAL_NODE_ID@@V?$allocator@USPATIAL_NODE_ID@@@std@@@std@@QEAA@XZ @ 0x18015764C (--1-$vector@USPATIAL_NODE_ID@@V-$allocator@USPATIAL_NODE_ID@@@std@@@std@@QEAA@XZ.c)
