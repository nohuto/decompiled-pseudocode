/*
 * XREFs of ?Materialize_BamoDragManagerClientProxy@BamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@QEAAJI@Z @ 0x1800E6F3C
 * Callers:
 *     ?Thunk_Materialize_BamoDragManagerClientProxy_10@?$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPeerImpl@ISMBamos_AutoBamos@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECAA0 (-Thunk_Materialize_BamoDragManagerClientProxy_10@-$IBamoPeer_ISMBamos_AutoBamos_Receive@VBamoPee.c)
 * Callees:
        ...
        unsigned int a2)
{
  ...
  *v9 = &BamoDragManagerClientProxy::`vftable'{for `Microsoft::Bamo::BamoProxy'};
  v9[1] = &BamoDragManagerClientProxy::`vftable'{for `IDragManagerClientProxy'};
  *((_DWORD *)v9 + 6) = 0;
  v9[4] = 0LL;
  *((_DWORD *)v9 + 10) = 0;
  *((_DWORD *)v9 + 11) = 0;
  v9[2] = &BamoImpl::BamoDragManagerClientProxyImpl::`vftable';
  *((_OWORD *)v9 + 3) = 0LL;
