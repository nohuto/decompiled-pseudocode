/*
 * XREFs of ?QueryInterface@BamoDockDevicePrincipal@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180126E90
 * Callers:
 *     ?QueryInterface@BamoDockDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z @ 0x18004C150 (-QueryInterface@BamoDockDevicePrincipal@@W7EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
