/*
 * XREFs of SpatialInteractionDevices::ParseFloatData_DirectX::XMFLOAT3_ @ 0x1800C7830
 * Callers:
 *     SpatialInteractionDevices::ReadPosePosition @ 0x1800C9F94 (SpatialInteractionDevices--ReadPosePosition.c)
 * Callees:
