/*
 * XREFs of _lambda_88fb4871a400503c69c7f747a4c77519_::operator() @ 0x1800D6454
 * Callers:
 *     std::_Func_impl_no_alloc__lambda_88fb4871a400503c69c7f747a4c77519__void_std::shared_ptr_Windows::Internal::SpatialInteractions::SpatialInteractionSourceDevice__const_&_::_Do_call @ 0x1800DAB70 (std--_Func_impl_no_alloc__lambda_88fb4871a400503c69c7f747a4c77519__void_std--shared_ea_1800DAB70.c)
 * Callees:
      ...
      if ( SpatialInteractionDevices::SpatialInteractionTrace::IsEnabled(v9) )
      {
        ...
        if ( **((_DWORD **)v14 + 1) > 4u && tlgKeywordOn(*((_QWORD *)v14 + 1), 2LL) )
        {
          ...
          _tlgWriteTemplate<long (_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),&long _tlgWriteTransfer_EventWriteTransfer(_tlgProvider_t const *,void const *,_GUID const *,_GUID const *,unsigned int,_EVENT_DATA_DESCRIPTOR *),_GUID const *,_GUID const *>::Write<_tlgWrapSz<wchar_t>,_tlgWrapperByVal<4>>(
            v15,
            (unsigned __int8 *)dword_1801CBC88,
            v15,
            v16,
            (const wchar_t **)&v19,
            (__int64)&v18);
