/*
 * XREFs of ?ValidateModuleVersion@GameInputModule@@CA_NPEAUHINSTANCE__@@AEBUGameInputVersion@@@Z @ 0x1800121C4
 * Callers:
...
bool __fastcall GameInputModule::ValidateModuleVersion(HINSTANCE a1, const struct GameInputVersion *a2)
{
  ...
  return (int)LdrResSearchResource(a1, v4, 3LL, 256LL, &v3, 0LL, 0LL, 0LL) >= 0
      && (*(unsigned int *)(v3 + 52) | ((unsigned __int64)*(unsigned int *)(v3 + 48) << 32)) >= 0x7744A610587LL;
}
