/*
 * XREFs of ?OnHandSpatialObjectRemoved@SpatialInteractionHandObjectDevice@SpatialInteractions@Internal@Windows@@AEAAJAEBU_GUID@@@Z @ 0x1800E06D0
 * Callers:
        ...
        const struct _GUID *a2)
{
  ...
  const char *v19; // r9
  std::_Ref_count_base *v20[2]; // [rsp+20h] [rbp-38h] BYREF
