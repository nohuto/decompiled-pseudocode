/*
 * XREFs of ?StartAnimation@BamoResizeContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800FCB18
 * Callers:
 *     ?Thunk_StartAnimation_112@?$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800FCE00 (-Thunk_StartAnimation_112@-$IResizeContextualProcessorPrincipal_Receive@VBamoResizeContextualPro.c)
 * Callees:
