/*
 * XREFs of ?GetResizeControllerClient@BamoInputSiteElementProxy@@UEAAPEAVBamoResizeControllerClientProxy@@XZ @ 0x1800109B0
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSiteElementProxy *this)
{
  ...
  if ( *(_DWORD *)(v2 + 168) != CurrentThreadId && *(_DWORD *)(v2 + 24) != CurrentThreadId )
  {
    wil::details::in1diag3::_FailFast_Unexpected(
      ...
      v4);
    JUMPOUT(0x180055ED6LL);
  }
  return (struct BamoResizeControllerClientProxy *)*((_QWORD *)this + 22);
}
