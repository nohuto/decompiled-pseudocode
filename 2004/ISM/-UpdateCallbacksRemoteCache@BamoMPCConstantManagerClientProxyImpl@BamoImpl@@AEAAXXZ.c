/*
 * XREFs of ?UpdateCallbacksRemoteCache@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@AEAAXXZ @ 0x18010BE90
 * Callers:
 *     ?PushStateToPrincipalOnPlaceholderProxyReset@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@UEAAXXZ @ 0x180046630 (-PushStateToPrincipalOnPlaceholderProxyReset@BamoMPCConstantManagerClientProxyImpl@BamoImpl@@UEA.c)
 ...
 *     ?GetSendHost@BamoProxyImpl@BamoImpl@Microsoft@@QEBAPEAUIMessageCallSendHost@@XZ @ 0x18004018C (-GetSendHost@BamoProxyImpl@BamoImpl@Microsoft@@QEBAPEAUIMessageCallSendHost@@XZ.c)
        ...
        BamoImpl::BamoMPCConstantManagerClientProxyImpl *this)
{
  ...
  if ( *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 24LL) + 32LL) + 56LL) )
  {
    ...
    v11[0] = v7;
    v11[1] = v6;
    v9 = CoreUICallSend(v8, v11, 2LL, 1LL, 6, &unk_1801C18C9, v3);
