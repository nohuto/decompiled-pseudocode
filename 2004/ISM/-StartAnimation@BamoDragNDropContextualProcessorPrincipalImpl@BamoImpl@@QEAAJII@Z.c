/*
 * XREFs of ?StartAnimation@BamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@QEAAJII@Z @ 0x1800F5DF8
 * Callers:
 *     ?Thunk_StartAnimation_112@?$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContextualProcessorPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800F6100 (-Thunk_StartAnimation_112@-$IDragNDropContextualProcessorPrincipal_Receive@VBamoDragNDropContext.c)
 * Callees:
