/*
 * XREFs of _MPCSixDofProcessor::UpdatePoint_::_1_::dtor$0 @ 0x18018FD78
 * Callers:
 *     <none>
 * Callees:
 *     ??1?$shared_ptr@VSystemCursor@@@std@@QEAA@XZ @ 0x18007D180 (--1-$shared_ptr@VSystemCursor@@@std@@QEAA@XZ.c)
 */
