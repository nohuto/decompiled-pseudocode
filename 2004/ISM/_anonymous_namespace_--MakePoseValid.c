/*
 * XREFs of _anonymous_namespace_::MakePoseValid @ 0x1800C623C
 * Callers:
 ...
 * Callees:
 *     XMQuaternionNormalizeIfNeeded @ 0x1800C6B90 (XMQuaternionNormalizeIfNeeded.c)
 */
...
void __fastcall anonymous_namespace_::MakePoseValid(__int64 a1)
{
  ...
  {
    *(_BYTE *)(a1 + 29) = 1;
    *(_OWORD *)(a1 + 12) = xmmword_1801C6300;
  }
}
