/*
 * XREFs of ?RemoteReplace@BamoList_ActivatableEntityPrincipal_StubImpl@ISMBamos_AutoBamos@BamoImpl@Lib@Bamo@Microsoft@@QEAAJIPEAVBamoActivatableEntityPrincipal@@@Z @ 0x180104B4C
 * Callers:
...
LABEL_3:
  ...
  v10[1] = v13;
  v8 = 2;
  return CoreUICallSend(v9, v10, 2LL, 71LL, v8, &unk_1801BF220, a2);
}
