/*
 * XREFs of ?OnGamepadExclusivityExited@BamoMPCManagerClientPrincipalImpl@BamoImpl@@QEAAJXZ @ 0x18010C904
 * Callers:
 *     ?Thunk_OnGamepadExclusivityExited_41@?$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientPrincipalImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x18010D4C0 (-Thunk_OnGamepadExclusivityExited_41@-$IMPCManagerClientPrincipal_Receive@VBamoMPCManagerClientP.c)
 * Callees:
