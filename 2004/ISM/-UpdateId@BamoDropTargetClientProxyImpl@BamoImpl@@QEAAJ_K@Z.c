/*
 * XREFs of ?UpdateId@BamoDropTargetClientProxyImpl@BamoImpl@@QEAAJ_K@Z @ 0x1800EE4C0
 * Callers:
 ...
 *     ?Thunk_UpdateId_2@?$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF20 (-Thunk_UpdateId_2@-$IDropTargetClientProxy_Receive@VBamoDropTargetClientProxyImpl@BamoImpl@@@@SA.c)
 * Callees:
