/*
 * XREFs of ?GetInputDeliveryServer@BamoInputSystemProxy@@UEAAPEAVBamoInputDeliveryServerProxy@@XZ @ 0x1800E6210
 * Callers:
 *     <none>
 * Callees:
        ...
        BamoInputSystemProxy *this)
{
  ...
  return (struct BamoInputDeliveryServerProxy *)*((_QWORD *)this + 10);
}
