/*
 * XREFs of ?CheckConstantExistence@MPCConstantManager@@QEAA_NW4InputType@@V?$basic_string_view@GU?$char_traits@G@std@@@std@@@Z @ 0x18006E4BC
 * Callers:
...
char __fastcall MPCConstantManager::CheckConstantExistence(__int64 a1, int a2, __m128i *a3)
{
  __int64 v6; // r9
  __int64 *v7; // rcx
  __int64 *v8; // rax
  ...
  while ( !*((_BYTE *)v8 + 25) );
  if ( v7 == *(__int64 **)(a1 + 56) || a2 < *((_DWORD *)v7 + 8) )
  {
LABEL_9:
    v16 = &v15;
