/*
 * XREFs of ?UpdateInputDeliveryServer@BamoInputSystemProxyImpl@BamoImpl@@QEAAJI@Z @ 0x1800EE564
 * Callers:
 ...
 *     ?Thunk_UpdateInputDeliveryServer_10@?$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoImpl@@@@SAJPEAXPEAPEAX@Z @ 0x1800ECF40 (-Thunk_UpdateInputDeliveryServer_10@-$IInputSystemProxy_Receive@VBamoInputSystemProxyImpl@BamoIm.c)
 * Callees:
