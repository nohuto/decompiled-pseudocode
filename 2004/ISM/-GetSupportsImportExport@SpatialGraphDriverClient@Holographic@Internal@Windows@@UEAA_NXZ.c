/*
 * XREFs of ?GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@UEAA_NXZ @ 0x18015EB20
 * Callers:
 *     ?GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAA_NXZ @ 0x18004CAA0 (-GetSupportsImportExport@SpatialGraphDriverClient@Holographic@Internal@Windows@@WBA@EAA_NXZ.c)
 * Callees:
