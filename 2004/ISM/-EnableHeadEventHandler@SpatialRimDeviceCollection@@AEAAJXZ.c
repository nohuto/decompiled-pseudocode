/*
 * XREFs of ?EnableHeadEventHandler@SpatialRimDeviceCollection@@AEAAJXZ @ 0x180092FFC
 * Callers:
 ...
 *     ??1?$MakeAllocator@VInputSiteHierarchyManager@@@Details@WRL@Microsoft@@QEAA@XZ @ 0x18006AE50 (--1-$MakeAllocator@VInputSiteHierarchyManager@@@Details@WRL@Microsoft@@QEAA@XZ.c)
 ...
 *     ?InternalRelease@?$ComPtr@VSpectrumListener@@@WRL@Microsoft@@IEAAKXZ @ 0x18008A77C (-InternalRelease@-$ComPtr@VSpectrumListener@@@WRL@Microsoft@@IEAAKXZ.c)
 ...
 *     ??0SpatialRimDeviceCollectionHeadEventHandler@@QEAA@XZ @ 0x180092290 (--0SpatialRimDeviceCollectionHeadEventHandler@@QEAA@XZ.c)
