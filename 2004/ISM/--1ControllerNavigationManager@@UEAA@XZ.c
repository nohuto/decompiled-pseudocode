/*
 * XREFs of ??1ControllerNavigationManager@@UEAA@XZ @ 0x18011C500
 * Callers:
 *     ??_GControllerNavigationManager@@UEAAPEAXI@Z @ 0x18011C690 (--_GControllerNavigationManager@@UEAAPEAXI@Z.c)
 * Callees:
