/*
 * XREFs of ??1?$set@IU?$less@I@std@@V?$allocator@I@2@@std@@QEAA@XZ @ 0x18019EFD8
 * Callers:
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$3 @ 0x18019EE44 (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$3.c)
 *     _HotKeyProcessor::HotKeyProcessor_::_1_::dtor$10 @ 0x18019EEB9 (_HotKeyProcessor--HotKeyProcessor_--_1_--dtor$10.c)
 * Callees:
