/*
 * XREFs of ?PowerPolSleepingWakeWakeArrived@FxPkgPnp@@KA?AW4_WDF_DEVICE_POWER_POLICY_STATE@@PEAV1@@Z @ 0x1C0086F80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::PowerPolSleepingWakeWakeArrived(FxPkgPnp *This)
{
  ...
  if ( v5 < 0 )
  {
    if ( progress == FxCxCallbackProgressInitialized )
    {
      ...
      WPP_IFR_SF_qL(This->m_Globals, 2u, 0xCu, 0x17u, WPP_PowerPolicyStateMachine_cpp_Traceguids, _a1, _a2);
      return 1468LL;
    }
