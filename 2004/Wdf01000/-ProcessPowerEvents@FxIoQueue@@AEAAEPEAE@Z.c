...
LABEL_83:
    ...
    {
      while ( ($D2630951142BB9990C21B010EDE8224F *)v53[-1].m_IoPkgListNode.m_ListEntry.Blink != &v30->120 )
      {
...
LABEL_71:
          ...
          {
            while ( ($D2630951142BB9990C21B010EDE8224F *)v31[-1].m_IoPkgListNode.m_ListEntry.Blink != &v30->120 )
            {
