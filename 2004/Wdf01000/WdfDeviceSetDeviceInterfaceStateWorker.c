/*
 * XREFs of WdfDeviceSetDeviceInterfaceStateWorker @ 0x1C001B7E0
 * Callers:
 *     imp_WdfDeviceSetDeviceInterfaceStateEx @ 0x1C001B960 (imp_WdfDeviceSetDeviceInterfaceStateEx.c)
 *     imp_WdfDeviceSetDeviceInterfaceState @ 0x1C005D510 (imp_WdfDeviceSetDeviceInterfaceState.c)
 * Callees:
 ...
 *     ?SetState@FxDeviceInterface@@QEAAXE@Z @ 0x1C0062208 (-SetState@FxDeviceInterface@@QEAAXE@Z.c)
 */
