/*
 * XREFs of ?QueryForDsfInterface@FxPkgFdo@@AEAAJXZ @ 0x1C008C218
 * Callers:
 ...
 *     ?QueryForInterface@FxDeviceBase@@QEAAJPEBU_GUID@@PEAU_INTERFACE@@GGPEAXPEAU_DEVICE_OBJECT@@@Z @ 0x1C004F810 (-QueryForInterface@FxDeviceBase@@QEAAJPEBU_GUID@@PEAU_INTERFACE@@GGPEAXPEAU_DEVICE_OBJECT@@@Z.c)
 */
...
__int64 __fastcall FxPkgFdo::QueryForDsfInterface(FxPkgFdo *this)
{
  ...
  else if ( _a1 >= 0 )
  {
    if ( dsfInterface.Interface.Version == 256 )
    {
      ...
      {
        v4 = -1073741762;
        WPP_IFR_SF_d(this->m_Globals, 2u, 0xCu, 0x10u, WPP_FxPkgFdoKm_cpp_Traceguids, -1073741762);
      }
    }
    else
    {
