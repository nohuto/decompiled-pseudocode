/*
 * XREFs of ?FxIFRSendRecordsToWpp@@YAJ_KPEAU_WDF_IFR_HEADER@@@Z @ 0x1C003D1B8
 * Callers:
 *     ?FxIFRReplay@@YAX_K@Z @ 0x1C003CEA8 (-FxIFRReplay@@YAX_K@Z.c)
 * Callees:
 *     memset @ 0x1C001D340 (memset.c)
 *     FxWmiTraceMessage @ 0x1C0039B78 (FxWmiTraceMessage.c)
 *     ?FxIFRValidateRecord@@YAJPEAU_WDF_IFR_RECORD@@_K1@Z @ 0x1C003D468 (-FxIFRValidateRecord@@YAJPEAU_WDF_IFR_RECORD@@_K1@Z.c)
 */
