/*
 * XREFs of ?Initialize@FxIoQueue@@QEAAJPEAU_WDF_IO_QUEUE_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@E@Z @ 0x1C0076284
 * Callers:
        ...
        unsigned __int8 InitialPowerStateOn)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (unsigned int)(DispatchType - 1) > 2 )
    {
      ...
      _a1 = -1073741811;
      WPP_IFR_SF_dqd(m_Globals, 2u, 0xDu, 0xCu, WPP_FxIoQueue_cpp_Traceguids, v26, _a2, -1073741811);
      return _a1;
    }
...
LABEL_20:
        _a1 = -1073741811;
        WPP_IFR_SF_qL(m_Globals, 2u, 0xDu, v18, WPP_FxIoQueue_cpp_Traceguids, ObjectHandleUnchecked, 0xC000000D);
        return _a1;
      }
    ...
    if ( m_PowerManaged )
      v22 = 2 - (InitialPowerStateOn != 0);
    else
      v22 = FxIoQueuePowerOn;
    this->m_PowerState = v22;
