/*
 * XREFs of imp_WdfInterruptCreate @ 0x1C0078150
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFINTERRUPT__ **Interrupt)
{
  ...
  if ( (unsigned int)v16 <= 0x30 && (v17 = 0x1010000000001LL, _bittest64(&v17, v16)) )
  {
    ...
    if ( result >= 0 )
    {
      ...
      {
        PreviousIrql = 0;
        FxNonPagedObject::Lock(v21, &PreviousIrql, v19);
        m_CallbackFlags = v21->m_CallbackFlags;
        FxNonPagedObject::Unlock(v21, PreviousIrql, v23);
...
LABEL_60:
      ...
      v29 = FxInterrupt::_CreateAndInit(m_Globals, v21, pParent, Attributes, Configuration, &pFxInterrupt);
      if ( v29 >= 0 )
