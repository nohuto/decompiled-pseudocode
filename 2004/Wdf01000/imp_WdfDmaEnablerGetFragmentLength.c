/*
 * XREFs of imp_WdfDmaEnablerGetFragmentLength @ 0x1C002F130
 * Callers:
 *     <none>
 * Callees:
        ...
        int DmaDirection)
{
  ...
  $9793661923A12A2D666E36DBEF9899AC *v7; // rbx
  ...
  if ( DmaDirection == 1 )
  {
    v7 = ($9793661923A12A2D666E36DBEF9899AC *)&pDmaEnabler->m_DuplexAdapterInfo[1];
