/*
 * XREFs of ?PnpEventQueryStopEnsureDeviceAwake@FxPkgPnp@@KA?AW4_WDF_DEVICE_PNP_STATE@@PEAV1@@Z @ 0x1C007AD60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPkgPnp::PnpEventQueryStopEnsureDeviceAwake(FxPkgPnp *This)
{
  ...
  WPP_IFR_SF_qL(This->m_Globals, 2u, 0xCu, 0x17u, WPP_PnpStateMachine_cpp_Traceguids, _a1, _a2);
