/*
 * XREFs of imp_WdfCxDeviceInitGetTypedContextWorker @ 0x1C004B420
 * Callers:
 *     <none>
 * Callees:
 *     FxValiateCx @ 0x1C004B084 (FxValiateCx.c)
 *     ?FxObjectGetTypedContext@@YAPEAXPEAVFxObject@@PEBU_WDF_OBJECT_CONTEXT_TYPE_INFO@@@Z @ 0x1C0056768 (-FxObjectGetTypedContext@@YAPEAXPEAVFxObject@@PEBU_WDF_OBJECT_CONTEXT_TYPE_INFO@@@Z.c)
