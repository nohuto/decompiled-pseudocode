/*
 * XREFs of VfEvtIoInternalDeviceControl @ 0x1C00C55F0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int IoControlCode)
{
  ...
  wchar_t critRegion; // [rsp+30h] [rbp-38h] BYREF
  ...
  v11 = (void (__fastcall *)(WDFQUEUE__ *, WDFREQUEST__ *, unsigned __int64, unsigned __int64, unsigned int))*((_QWORD *)TypedContext + 7);
  if ( v11 )
  {
    PPObject = 0LL;
    critRegion = 0;
