/*
 * XREFs of imp_WdfControlDeviceInitSetShutdownNotification @ 0x1C0044220
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  if ( (Flags & 0xFC) != 0 )
  {
    WPP_IFR_SF_D(v4, (unsigned __int8)DeviceInit, 0x12u, 0x4Au, WPP_FxDeviceInitApi_cpp_Traceguids, Flags);
    goto LABEL_7;
  }
