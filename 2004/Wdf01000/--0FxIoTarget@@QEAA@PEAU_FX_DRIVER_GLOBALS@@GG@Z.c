/*
 * XREFs of ??0FxIoTarget@@QEAA@PEAU_FX_DRIVER_GLOBALS@@GG@Z @ 0x1C006471C
 * Callers:
 ...
 *     ??0FxUsbDevice@@QEAA@PEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C006F2F4 (--0FxUsbDevice@@QEAA@PEAU_FX_DRIVER_GLOBALS@@@Z.c)
 * Callees:
 ...
 *     ?Construct@FxIoTarget@@AEAAXXZ @ 0x1C0064958 (-Construct@FxIoTarget@@AEAAXXZ.c)
 */
