/*
 * XREFs of ?RemoveCompletedRequestLocked@FxIoTarget@@IEAAEPEAVFxRequestBase@@@Z @ 0x1C000C9D0
 * Callers:
        ...
        unsigned __int8 a3)
{
  ...
  $D2630951142BB9990C21B010EDE8224F *v7; // rax
  _IRP *Irp; // rdx
  ...
  v7 = &Request->120;
  if ( ($D2630951142BB9990C21B010EDE8224F *)Flink->Blink != &Request->120
    || (Irp = Request->m_CsqContext.Irp, *($D2630951142BB9990C21B010EDE8224F **)&Irp->Type != v7) )
  {
    __fastfail(3u);
  }
