/*
 * XREFs of MicrosoftTelemetryAssertTriggeredWorker @ 0x1C008E6F8
 * Callers:
 ...
 *     GetImageTuple @ 0x1C008E5B4 (GetImageTuple.c)
 *     _tlgCreate1Sz_char @ 0x1C008EDDC (_tlgCreate1Sz_char.c)
 */
