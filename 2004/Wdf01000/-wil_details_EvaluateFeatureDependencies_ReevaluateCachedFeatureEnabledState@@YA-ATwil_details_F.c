/*
 * XREFs of ?wil_details_EvaluateFeatureDependencies_ReevaluateCachedFeatureEnabledState@@YA?ATwil_details_FeatureStateCache@@PEAT1@T1@PEBUwil_details_FeatureDescriptor@@@Z @ 0x1C00BC184
 * Callers:
...
LABEL_11:
  ...
  if ( ((exchange >> 3) & 1) != v5 )
    v10 = 136;
  _InterlockedXor((volatile signed __int32 *)featureState, v10);
  result.exchange = exchange ^ v10;
  return result;
}
