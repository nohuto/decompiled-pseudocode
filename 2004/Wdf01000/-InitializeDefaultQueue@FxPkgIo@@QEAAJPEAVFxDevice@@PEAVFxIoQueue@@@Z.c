/*
 * XREFs of ?InitializeDefaultQueue@FxPkgIo@@QEAAJPEAVFxDevice@@PEAVFxIoQueue@@@Z @ 0x1C00750A8
 * Callers:
...
__int64 __fastcall FxPkgIo::InitializeDefaultQueue(FxPkgIo *this, FxDevice *Device, FxIoQueue *Queue)
{
  ...
  if ( this->m_DefaultQueue )
  {
    ...
    WPP_IFR_SF_qid(_a1[2], 2u, 0xDu, 0x11u, (const _GUID *)&WPP_FxPkgIo_cpp_Traceguids, _a1, _a2, -1073741823);
    return 3221225473LL;
  }
  else
  {
