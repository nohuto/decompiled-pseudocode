/*
 * XREFs of CsInitialize @ 0x1C000D150
 * Callers:
 *     DriverEntry @ 0x1C000D120 (DriverEntry.c)
 * Callees:
 *     WPP_SF_D @ 0x1C0004364 (WPP_SF_D.c)
 *     WPP_SF_d @ 0x1C0004604 (WPP_SF_d.c)
 *     WppLoadTracingSupport @ 0x1C000BA40 (WppLoadTracingSupport.c)
 *     WppInitKm @ 0x1C000BB90 (WppInitKm.c)
 *     CiNdisOpenDevice @ 0x1C000BC00 (CiNdisOpenDevice.c)
 *     CiConfigInitialize @ 0x1C000D310 (CiConfigInitialize.c)
 *     CiDispatchInitialize @ 0x1C000DED0 (CiDispatchInitialize.c)
