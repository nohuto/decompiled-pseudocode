/*
 * XREFs of CiDispatchCreateMmThreadClient @ 0x1C000A690
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_ @ 0x1C00043B8 (WPP_SF_.c)
 *     WPP_SF_dd @ 0x1C000464C (WPP_SF_dd.c)
 *     CiThreadCreate @ 0x1C000A800 (CiThreadCreate.c)
 *     CiLookupTask @ 0x1C000ACF0 (CiLookupTask.c)
 *     CiTaskIndexCreate @ 0x1C000AE00 (CiTaskIndexCreate.c)
 *     CiTaskIndexLocate @ 0x1C000AF90 (CiTaskIndexLocate.c)
 */
