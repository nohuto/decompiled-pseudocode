/*
 * XREFs of CiThreadCreate @ 0x1C000A800
 * Callers:
 ...
 *     WPP_SF_dI @ 0x1C0004810 (WPP_SF_dI.c)
 *     CiThreadIncrementScheduledCount @ 0x1C000AA60 (CiThreadIncrementScheduledCount.c)
 *     CiProcessAddThread @ 0x1C000AAE0 (CiProcessAddThread.c)
 *     CiThreadUpdatePriorities @ 0x1C000AB30 (CiThreadUpdatePriorities.c)
 *     CiProcessLocate @ 0x1C000ABE0 (CiProcessLocate.c)
 *     CiProcessCreate @ 0x1C000B090 (CiProcessCreate.c)
