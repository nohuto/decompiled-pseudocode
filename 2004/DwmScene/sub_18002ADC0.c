/*
 * XREFs of sub_18002ADC0 @ 0x18002ADC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 *__fastcall sub_18002ADC0(__int64 **a1, __int64 *a2)
{
  __int64 v4; // r12
  __int64 **v5; // r13
  __int64 *v6; // rdi
  ...
  else
  {
    ...
    v43[3] = 0;
    v42 = 0LL;
    v18 = (__int64 **)sub_180029BC0((__int64)a1, &v38);
    v19 = *v18;
    v20 = **v18;
    v21 = sub_18001792C(&v42);
    (*(void (__fastcall **)(__int64 *, const IID *, __int64 *))(v20 + 48))(v19, &stru_18013B4A0, v21);
    v22 = v38;
    if ( v38 )
    {
      v38 = 0LL;
    ...
    v23 = sub_180029CB8((__int64)a1, &v36);
    v24 = *v5;
    if ( *v5 )
    {
      *v5 = 0LL;
  ...
  if ( (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v4 + 16LL))(v4) )
  {
    ...
    v27 = *v5;
    v28 = **v5;
    v29 = sub_18001792C(&v41);
    v30 = (*(__int64 (__fastcall **)(__int64 *, _QWORD, void *, __int64 *))(v28 + 72))(v27, 0LL, &unk_18013CC70, v29);
    v31 = v30;
    if ( v30 < 0 )
    {
