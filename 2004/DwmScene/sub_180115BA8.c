...
void *sub_180115BA8()
{
  if ( dword_18021AC60 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                   + 44LL) )
  {
    Init_thread_header(&dword_18021AC60);
    if ( dword_18021AC60 == -1 )
    {
      Mtx_init_in_situ((_Mtx_t)&unk_18021AC10, 2);
      atexit(sub_180133AB0);
      Init_thread_footer(&dword_18021AC60);
    }
  }
  return &unk_18021AC10;
}
