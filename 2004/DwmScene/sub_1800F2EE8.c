/*
 * XREFs of sub_1800F2EE8 @ 0x1800F2EE8
 * Callers:
 ...
 *     sub_1800A4E98 @ 0x1800A4E98 (sub_1800A4E98.c)
...
__int64 __fastcall sub_1800F2EE8(_QWORD *a1, _QWORD *a2, __int64 a3, const void **a4)
{
  __int64 v8; // rdx
  __int64 v9; // rcx
  int v10; // eax
  ...
  if ( !a2[2] )
  {
    v8 = a1[2] + 496LL;
    v50 = 0LL;
    sub_18001CDF8(v49, v8);
    if ( a2 != v49 )
      sub_18001D08C(a2, (__int64)v49);
  ...
  if ( !a4[2] )
  {
    v10 = sub_1800A4E98(a1[2]);
    v11 = (const void **)sub_1800A1448(v58, v10);
    if ( a4 != v11 )
      sub_18001D08C(a4, (__int64)v11);
    if ( v59 >= 0x10 )
    {
      v12 = v58[0];
      if ( v59 + 1 >= 0x1000 )
  ...
  v67 = 0LL;
  sub_1800A4E64(a1[2], &v67);
  v62 = 0LL;
  sub_1800A05E0(v67, (__int64 *)&v62, a3);
  sub_1800A155C(v65, (_QWORD **)&v62);
  v13 = sub_18002C274((const void **)&v51, a2, byte_1801D56AC);
  v14 = a4;
  ...
  v15->m128i_i8[0] = 0;
  v16 = (__m128i *)std::string::append(&Src, byte_1801D56AC, 1uLL);
  si128 = 0LL;
  v45 = *v16;
  si128 = v16[1];
  ...
  *(_BYTE *)v18 = 0;
  ...
  v52 = _mm_load_si128((const __m128i *)&xmmword_18013A450);
  LOBYTE(v51) = 0;
  sub_18002C274(v76, &v63, "/Vertex");
  sub_18002C274(v74, &v63, "/Pixel");
  sub_18002C274(v72, &v63, "/Geometry");
  sub_18002C274(v70, &v63, "/Domain");
  sub_18002C274(v68, &v63, "/Hull");
  v53[2] = 0LL;
  v53[3] = 0LL;
  sub_18001CDF8(v53, (__int64)v76);
  sub_1800F2CE0(a1, 1, v53);
  v54[2] = 0LL;
  v54[3] = 0LL;
  sub_18001CDF8(v54, (__int64)v74);
  sub_1800F2CE0(a1, 5, v54);
  v55[2] = 0LL;
  v55[3] = 0LL;
  sub_18001CDF8(v55, (__int64)v72);
  sub_1800F2CE0(a1, 4, v55);
  v56[2] = 0LL;
  v56[3] = 0LL;
  sub_18001CDF8(v56, (__int64)v70);
  sub_1800F2CE0(a1, 3, v56);
  v57[2] = 0LL;
  v57[3] = 0LL;
  sub_18001CDF8(v57, (__int64)v68);
  sub_1800F2CE0(a1, 2, v57);
  ...
  v69 = _mm_load_si128((const __m128i *)&xmmword_18013A450);
  LOBYTE(v68[0]) = 0;
  ...
  v71 = _mm_load_si128((const __m128i *)&xmmword_18013A450);
  LOBYTE(v70[0]) = 0;
  ...
  v73 = _mm_load_si128((const __m128i *)&xmmword_18013A450);
  LOBYTE(v72[0]) = 0;
  ...
  v75 = _mm_load_si128((const __m128i *)&xmmword_18013A450);
  LOBYTE(v74[0]) = 0;
  ...
  v66 = _mm_load_si128((const __m128i *)&xmmword_18013A450);
  LOBYTE(v65[0]) = 0;
  result = sub_18009C6C8((__int64 *)&v62, (__int64)&v62);
