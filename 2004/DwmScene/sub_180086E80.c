/*
 * XREFs of sub_180086E80 @ 0x180086E80
 * Callers:
...
__int64 __fastcall sub_180086E80(__int64 a1, _QWORD *a2)
{
  __int64 result; // rax
  ...
  if ( !*a2 )
  {
    sub_18000FD48(v8);
    v5 = sub_18000FD48(v7);
    sub_180027FF4(pExceptionObject, v5, 936, (__int64)v8, 0);
    throw (Spectre::Engine::EngineInvalidArgException *)pExceptionObject;
  }
  v6 = *(_QWORD **)(*a2 + 368LL);
  result = sub_18008A104(a1 + 120, &v6);
