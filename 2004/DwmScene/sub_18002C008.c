/*
 * XREFs of sub_18002C008 @ 0x18002C008
 * Callers:
...
_QWORD *__fastcall sub_18002C008(__int64 a1, _QWORD *a2, _QWORD *a3, _QWORD *a4)
{
  _QWORD *v4; // rsi
  _QWORD *j; // rbx
  __int64 *v9; // rbx
  ...
  if ( a3 == **(_QWORD ***)a1 && a4 == v4 )
  {
    ...
    while ( !*((_BYTE *)v9 + 25) )
    {
      sub_180027128(a1, a1, (__int64 *)v9[2]);
      v10 = v9;
      v9 = (__int64 *)*v9;
      j_j__o_free(v10);
    }
