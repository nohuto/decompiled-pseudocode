/*
 * XREFs of sub_1800DC1B8 @ 0x1800DC1B8
 * Callers:
...
_QWORD *__fastcall sub_1800DC1B8(_QWORD *a1)
{
  int v2; // ebx
  _BYTE *v3; // rsi
  __int64 v4; // r14
  ...
  `eh vector constructor iterator'(
    ...
    0x28uLL,
    0x40uLL,
    (void (*)(void *))sub_1800DC1A0,
    (void (*)(void *))sub_180040F80);
  v2 = 0;
  v3 = a1;
  v4 = 31LL;
  do
  {
    sub_1800206C4(v42, v2);
    v5 = sub_180054FC4(v42, 0LL, "System", 6uLL);
    v39 = *(_OWORD *)v5;
    v40 = *((_OWORD *)v5 + 1);
    v5[2] = 0LL;
    v5[3] = (const void *)15;
...
LABEL_18:
  ...
  {
    LOBYTE(v6) = 0;
    sub_18000FB34(v11, 0xEuLL, v6, "System0_Enable");
  }
  else
  {
    v12 = a1 + 1;
  ...
  {
    LOBYTE(v13) = 0;
    sub_18000FB34(v14, 0xFuLL, v13, "System1_Visible");
  }
  else
  {
    v15 = a1 + 6;
  ...
  {
    LOBYTE(v16) = 0;
    sub_18000FB34(v17, 0x13uLL, v16, "System2_VisibleTree");
  }
  else
  {
    v18 = (_BYTE *)*v17;
  ...
  {
    LOBYTE(v19) = 0;
    sub_18000FB34(v20, 0x12uLL, v19, "System3_Renderable");
  }
  else
  {
    v21 = (_BYTE *)*v20;
  ...
  {
    LOBYTE(v22) = 0;
    sub_18000FB34(v23, 0xDuLL, v22, "System4_Debug");
  }
  else
  {
    v24 = a1 + 21;
  ...
  {
    LOBYTE(v25) = 0;
    sub_18000FB34(v26, 0xFuLL, v25, "System5_Loading");
  }
  else
  {
    v27 = a1 + 26;
  ...
  {
    LOBYTE(v28) = 0;
    sub_18000FB34(v29, 0x13uLL, v28, "System8_Transparent");
  }
  else
  {
    v30 = (_BYTE *)*v29;
  ...
  {
    LOBYTE(v31) = 0;
    sub_18000FB34(v32, 0x12uLL, v31, "System9_OpaqueMask");
  }
  else
  {
    v33 = (_BYTE *)*v32;
  ...
  {
    LOBYTE(v34) = 0;
    sub_18000FB34(v35, 0x15uLL, v34, "System16_ShadowCaster");
  }
  else
  {
    v36 = (_BYTE *)*v35;
