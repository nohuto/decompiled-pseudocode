/*
 * XREFs of sub_180114EF0 @ 0x180114EF0
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_180114EF0(__int64 a1, void *a2, __int64 a3, void *a4, void *a5, void *a6, int a7)
{
  ULONG result; // eax
  ...
  if ( (unsigned int)dword_18020DB58 > 5 )
  {
    ...
    return sub_180002B08(
             ...
             (unsigned __int8 *)dword_1801E8308,
             0LL,
             0LL,
             &v13,
             (__int64)&v12,
