/*
 * XREFs of sub_180035220 @ 0x180035220
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall sub_180035220(__int64 a1, __int64 a2, __int64 a3)
{
  int v4; // edi
  ...
  do
  {
    ...
    *((_QWORD *)&v61 + 1) = v9;
    ...
    {
      v64[0] = *(_DWORD *)(v8 + 88);
      sub_18003264C((__int64 **)(v10 + 120), (__int64)&v63, v64);
      v11 = v63;
    ...
    *((_QWORD *)v13 + 1) = 0LL;
    ...
    v50 = 0LL;
    sub_18003292C((__int64 *)&v50, &v46);
    if ( (_QWORD)v50 )
    {
      v18 = sub_18002D46C(v50, &v48);
      v19 = 4;
    }
    else
    {
  ...
  if ( *(_QWORD *)v60 )
  {
    sub_1800339E0((__int64 *)(*(_QWORD *)v60 + 256LL), &v51, *(_DWORD *)(v43 + 88));
    v27 = &v51;
    v28 = v51;
    v29 = 16;
  }
  ...
  *v27 = 0LL;
  ...
  `eh vector destructor iterator'(v65, 8uLL, 8uLL, (void (*)(void *))sub_18000BFB0);
}
