/*
 * XREFs of sub_1800D3308 @ 0x1800D3308
 * Callers:
...
__int128 *__fastcall sub_1800D3308(__int128 *a1, __int128 *a2)
{
  __int128 v2; // xmm0
  __int128 v5; // xmm1
  __int64 v6; // xmm6_8
  ...
  *(_BYTE *)a1 = 0;
  ...
  v14 = v5;
  if ( a1 != a2 )
    sub_18001D08C(a1, (__int64)a2);
  *((_QWORD *)a1 + 4) = *((_QWORD *)a2 + 4);
  *((_QWORD *)a1 + 5) = *((_QWORD *)a2 + 5);
  result = &v13;
  if ( a2 != &v13 )
  {
    result = (__int128 *)sub_18001D08C(a2, (__int64)&v13);
    v7 = v16;
    v6 = v15;
  }
  v9 = *((_QWORD *)&v14 + 1);
