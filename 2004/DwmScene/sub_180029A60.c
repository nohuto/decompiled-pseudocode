/*
 * XREFs of sub_180029A60 @ 0x180029A60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180029A60(__int64 a1, __int64 a2, __int64 a3, __int64 a4, _QWORD *a5)
{
  __int64 result; // rax
  int v10; // eax
  ULONG_PTR v11; // rbx
