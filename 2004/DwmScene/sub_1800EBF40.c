/*
 * XREFs of sub_1800EBF40 @ 0x1800EBF40
 * Callers:
 *     sub_1800A1B30 @ 0x1800A1B30 (sub_1800A1B30.c)
 * Callees:
...
__int64 __fastcall sub_1800EBF40(_QWORD *a1)
{
  __int64 v2; // rcx
