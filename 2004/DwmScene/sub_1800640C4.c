/*
 * XREFs of sub_1800640C4 @ 0x1800640C4
 * Callers:
...
__int64 __fastcall sub_1800640C4(_QWORD *a1, __int64 a2)
{
  __int64 v2; // r13
  __int64 v4; // rbx
  ...
  try
  {
    ...
    else
    {
      ...
      while ( v2 != v17 )
      {
        sub_1800653B8(v12, v2);
        v12 += 152LL;
        v20 = v12;
        v2 += 152LL;
      }
    }
    sub_180067840(a1, v10, v25 + 1, v9, v19, v20, v22);
    result = v26 + *a1;
  }
  catch ( ... )
  {
    sub_180067A1C(a1, v23, v27);
    sub_180067DB4(a1, v10, v9);
    throw;
  }
  return result;
}
