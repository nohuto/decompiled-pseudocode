/*
 * XREFs of sub_18003EE50 @ 0x18003EE50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18003EE50(__int64 a1)
{
  __int64 result; // rax
  _QWORD *v3; // rdi
  _QWORD *v4; // rbx
  ...
  v12 = 0LL;
  sub_18003F20C(a1, &v12);
  v14 = 0LL;
  result = (__int64)sub_1800246C4(v12, &v14);
  v3 = *(_QWORD **)(a1 + 552);
  v4 = (_QWORD *)*v3;
  while ( v4 != v3 )
  {
