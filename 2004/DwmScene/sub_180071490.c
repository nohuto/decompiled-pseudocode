/*
 * XREFs of sub_180071490 @ 0x180071490
 * Callers:
...
__int64 *__fastcall sub_180071490(__int64 *a1, __m128i *a2)
{
  _QWORD *v4; // rax
  __int64 v5; // rsi
  ...
  *a1 = (__int64)v4;
  ...
  {
    v7 = (__int64 *)*a1;
    v8 = sub_18006C840((__int64)a1, *a1, v5);
    sub_18006E3B4((__int64 **)a1, v10, v7, v8 + 4, v8);
    v5 += 64LL;
  }
  return a1;
}
