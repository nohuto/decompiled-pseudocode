/*
 * XREFs of sub_18009360C @ 0x18009360C
 * Callers:
...
__int64 __fastcall sub_18009360C(__int64 a1, __int64 a2)
{
  __int64 *v3; // rax
  unsigned int v4; // eax
  ...
  if ( *(_BYTE *)(a1 + 310) )
  {
    ...
    sub_1800CB940((unsigned int)pExceptionObject, v4, 554, (unsigned int)v6, 0);
  ...
  if ( !a2 )
  {
    sub_18000FD48(v5);
    v3 = sub_18000FD48(v6);
    sub_180091370(pExceptionObject, v3, 559, (__int64)v5, 0);
    throw (Spectre::Engine::EngineInvalidPointerException *)pExceptionObject;
  }
  return sub_1800936D4(a1, a2, *(unsigned int *)(a1 + 120));
}
