...
_UNKNOWN **__fastcall sub_1800C5744(__int64 a1, __int64 *a2)
{
  ...
  v5 = 0;
  v6 = 0;
  if ( (*(unsigned __int8 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v3 + 64LL))(v3, &unk_18020A010, 0LL) )
  {
    v7 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v3 + 88LL))(v3, &unk_180209FB0);
    v4 = LODWORD(v7);
    v8 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v3 + 88LL))(v3, &unk_180209FD0);
    v5 = LODWORD(v8);
    v9 = (*(double (__fastcall **)(__int64, void *))(*(_QWORD *)v3 + 88LL))(v3, &unk_180209FF0);
    v6 = LODWORD(v9);
  }
  v39 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v3 + 72LL))(v3, &unk_180209F70, 0LL);
  v11 = &off_18020C740;
  ...
  do
  {
    ...
    v12 += 16LL;
    v11 += 13;
    result = &off_18020C878;
  }
  while ( (__int64)v11 < (__int64)&off_18020C878 );
  return result;
}
