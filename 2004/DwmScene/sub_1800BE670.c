/*
 * XREFs of sub_1800BE670 @ 0x1800BE670
 * Callers:
 *     sub_1800C31B4 @ 0x1800C31B4 (sub_1800C31B4.c)
 * Callees:
 *     sub_1800B3B14 @ 0x1800B3B14 (sub_1800B3B14.c)
 *     sub_1800B5F5C @ 0x1800B5F5C (sub_1800B5F5C.c)
 */

__int64 __fastcall sub_1800BE670(__int64 a1, _DWORD *a2, __int64 *a3)
{
  __int64 result; // rax
  __int64 *v5; // rdi
  __int64 v6; // rbx
  ...
  result = sub_1800B5F5C(*a3, (__int64)a2);
  v5 = *(__int64 **)(result + 104);
  v6 = *v5;
  while ( (__int64 *)v6 != v5 )
  {
    sub_1800B3B14(*(_DWORD **)(v6 + 40), a2);
    result = *(_QWORD *)(v6 + 16);
    if ( *(_BYTE *)(result + 25) )
    {
