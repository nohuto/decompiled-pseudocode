/*
 * XREFs of sub_1800BD228 @ 0x1800BD228
 * Callers:
...
void __fastcall sub_1800BD228(__m128 *a1)
{
  __m128 v1; // xmm3
  __m128 v2; // xmm0
  __m128 v3; // xmm3
  ...
  v7 = _mm_sqrt_ps(v6);
  v8 = _mm_cmpneq_ps((__m128)xmmword_180139B00, v6);
  *a1 = _mm_or_ps(
          _mm_and_ps(_mm_and_ps(_mm_div_ps(*a1, v7), _mm_cmpneq_ps(v7, (__m128)0LL)), v8),
          _mm_andnot_ps(v8, (__m128)xmmword_180139B10));
}
