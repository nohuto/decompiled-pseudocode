/*
 * XREFs of sub_1800428C0 @ 0x1800428C0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_1800428C0(__int64 a1, __int64 *a2)
{
  __int64 v4; // rdx
  __int64 v5; // rdi
  __int64 v6; // rbx
  ...
  if ( *(_BYTE *)(a1 + 96) )
  {
    ...
    sub_180027FF4(pExceptionObject, v20, 37, (__int64)v22, 0);
...
LABEL_6:
    ...
    if ( v12 < 0 )
    {
      sub_1801163DC(&unk_180208140, 5LL, "ERROR: Failed to create Hull shader.\n");
    }
    else
    {
      *(_BYTE *)(a1 + 96) = 1;
