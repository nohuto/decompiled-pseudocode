/*
 * XREFs of sub_1800C8314 @ 0x1800C8314
 * Callers:
 *     sub_1800C9760 @ 0x1800C9760 (sub_1800C9760.c)
 * Callees:
...
_OWORD *__fastcall sub_1800C8314(__int64 a1, _OWORD *a2, __int64 a3, __int64 *a4)
{
  __int64 v7; // rbx
