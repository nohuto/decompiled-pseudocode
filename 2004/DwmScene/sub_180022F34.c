/*
 * XREFs of sub_180022F34 @ 0x180022F34
 * Callers:
 *     sub_180026B00 @ 0x180026B00 (sub_180026B00.c)
 * Callees:
...
_QWORD *__fastcall sub_180022F34(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_18002169C((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
