/*
 * XREFs of sub_18006EFA4 @ 0x18006EFA4
 * Callers:
...
_QWORD *__fastcall sub_18006EFA4(__int64 **a1, _QWORD *a2, __int64 *a3, unsigned __int64 *a4, _QWORD *a5)
{
  __int64 *v9; // rdi
  _QWORD *result; // rax
  _QWORD *v11; // r9
  ...
  if ( a1[1] )
  {
    ...
    {
LABEL_30:
      *a2 = *(_QWORD *)sub_18006FA14((_DWORD)a1, (unsigned int)&v21, 0, (_DWORD)a4, (__int64)a5);
      return a2;
    }
    if ( v15 )
      sub_180027188(a1, a2, 0, a3, (int)a4, a5);
    else
      sub_180027188(a1, a2, 1, (_QWORD *)v14, (int)a4, a5);
    return a2;
  }
  else
  {
    ...
    {
      sub_18002B780((__int64)v21, (__int64)v20);
      throw;
    }
  }
  return result;
