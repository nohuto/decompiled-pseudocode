/*
 * XREFs of sub_18002C8D0 @ 0x18002C8D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18002C8D0(__int64 a1, int a2, int a3, int a4, int a5)
{
  int v6; // r13d
  int v7; // r12d
  __int64 v9; // rdx
  ...
  v33 = v39;
  sub_1800186E0(&v31, (__int64 *)&v33);
  v38 = 0LL;
  v11 = v31;
  sub_180024694(v31, &v38);
  v30 = 0LL;
  v12 = *(_QWORD *)(a1 + 104);
  if ( v12 )
  {
  ...
  v32[0] = *(_QWORD *)(a1 + 96);
  v32[1] = v12;
  sub_1800186E0(&v30, v32);
  v37 = 0LL;
  sub_1800312B8(v30, &v37);
  ...
  if ( (unsigned int)(a4 - 23) <= 1 )
    ...
    v14 = (a5 & 8) != 0;
  v40[0] = sub_180029D9C(a4, v14);
  v40[1] = 2 * v13 + 4;
  v40[2] = 0;
  v36 = 0LL;
  sub_1800312B8(v30, &v36);
  v15 = v38;
  v16 = (__int64 **)(a1 + 128);
  v17 = *(_QWORD *)(a1 + 128);
  if ( v17 )
  ...
  v18 = (*(__int64 (__fastcall **)(__int64, __int64, _DWORD *, __int64))(*(_QWORD *)v15 + 72LL))(
          ...
          v40,
          a1 + 128);
  sub_1800265A4(v11, v18);
  v19 = sub_180062688(a1, v34);
  if ( *(_QWORD *)(v19 + 24) >= 0x10uLL )
    v19 = *(_QWORD *)v19;
  sub_180010454(*v16, (const char *)v19);
  if ( v35 >= 0x10 )
  {
    v20 = v34[0];
    if ( v35 + 1 >= 0x1000 )
  ...
  result = sub_1800639D8(a1, _mm_unpacklo_ps(v22, v21).m128_u64[0]);
  v24 = v36;
  if ( v36 )
  {
    v36 = 0LL;
