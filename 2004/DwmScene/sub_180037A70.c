/*
 * XREFs of sub_180037A70 @ 0x180037A70
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall sub_180037A70(__int64 a1, _QWORD *a2, const void *a3, int a4)
{
  __int64 *v7; // rcx
  char v8; // bl
  __int64 v9; // rax
  ...
  if ( *a2 )
  {
    v7 = (__int64 *)sub_18009ADA4(*a2, v58, *(unsigned int *)(a1 + 88));
    v8 = 1;
    v9 = *v7;
  }
  else
  ...
  *v7 = 0LL;
  ...
  v12 = -((unsigned int)sub_18009AE34(v49) != 2);
  v46 = 0LL;
  sub_1800329F4((__int64 *)&v46, &v49);
  v14 = 1;
  v15 = *(_QWORD *)(*a2 + 128LL);
  if ( v15 )
    v16 = *(_DWORD *)(v15 + 12);
  ...
  {
    v14 = sub_18009AD88(v46, v13);
    v23 = *(_QWORD *)(a1 + 144);
    v24 = sub_180031288(v17, &v51);
...
LABEL_23:
  ...
  sub_1800265A4(v55, v20);
  v29 = 0;
  if ( v20 < 0 )
  {
    sub_1801163DC(&unk_1802080A0, 3LL, "Failed to update Texture with HRESULT error 0x%.8x", v20);
    goto LABEL_50;
  }
  v30 = (unsigned int)sub_18009ADC0(v17);
  v60[0] = 0;
  v60[1] = 1;
  v31 = &v61;
  for ( i = 20LL; i; --i )
  ...
  v64 = 1;
  v33 = v60[v30];
  v34 = sub_18009ADDC(v17);
  v35 = v14 * v66 * v34 / v33;
  if ( v35 == v47 )
  {
    sub_18000EFA8(v65, v35, a3, v35);
    v29 = 1;
  }
  v36 = *sub_1800312B8(v17, &v52);
  v37 = v52;
  if ( v52 )
  {
    v52 = 0LL;
