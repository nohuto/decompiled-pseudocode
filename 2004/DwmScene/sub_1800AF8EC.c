  ...
  *(_BYTE *)(a1 + 424) = 1;
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)(a1 + 440) = 1000000000 * (perf_counter % perf_frequency) / perf_frequency
    ...
    (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v13 + 88LL))(v13, &unk_180208B30);
    (*(void (__fastcall **)(__int64, void *))(*(_QWORD *)v13 + 88LL))(v13, &unk_180208B50);
    v14 = *(__int64 **)(a1 + 64);
    v15 = *(__int64 **)(a1 + 72);
    v43 = v15;
    while ( v14 != v15 )
...
LABEL_26:
      if ( v17 && (*(unsigned __int8 (__fastcall **)(__int64))(*(_QWORD *)v17 + 352LL))(v17) )
      {
          ...
          && (*(unsigned __int8 (__fastcall **)(_QWORD, __int64, __int64))(*(_QWORD *)v55 + 16LL))(v55, v19, v18) )
        {
          ...
          v24 = (*(__int64 (__fastcall **)(__int64, void *, _QWORD))(*(_QWORD *)v23 + 72LL))(v23, &unk_180208B90, 0LL);
