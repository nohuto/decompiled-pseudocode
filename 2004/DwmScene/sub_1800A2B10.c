/*
 * XREFs of sub_1800A2B10 @ 0x1800A2B10
 * Callers:
...
__int64 __fastcall sub_1800A2B10(__int64 **a1, __int64 a2, char a3, int *a4, _QWORD *a5)
{
  __int64 *v8; // rdx
  __int64 *v9; // rdi
  __int64 v10; // rax
  ...
  try
  {
    ...
    if ( v11 )
    {
      if ( v9 == (__int64 *)*v8 )
      {
        *(_QWORD *)a2 = *sub_1800A23B4(a1, &v15, 1, v9, (int)a4, a5);
        *(_BYTE *)(a2 + 8) = 1;
        return a2;
      }
      sub_180022400(&v15);
    ...
    if ( *((_DWORD *)v13 + 8) >= *a4 )
    {
      sub_18001FFEC(a5 + 7, (__int64)(a5 + 7));
      sub_18007B8A0(a5 + 5);
      j_j__o_free(a5);
      *(_QWORD *)a2 = v13;
      *(_BYTE *)(a2 + 8) = 0;
    ...
    {
      *(_QWORD *)a2 = *sub_1800A23B4(a1, &v15, v11, v9, (int)a4, a5);
      *(_BYTE *)(a2 + 8) = 1;
    }
    result = a2;
  }
