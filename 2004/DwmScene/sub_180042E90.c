/*
 * XREFs of sub_180042E90 @ 0x180042E90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180042E90(__int64 a1, _QWORD *a2, _QWORD *a3)
{
  __int64 *v6; // rax
  ...
  v18 = 0LL;
  sub_1800338FC(*(_QWORD **)(a1 + 104), &v18);
