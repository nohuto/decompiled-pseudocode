...
__int64 __fastcall sub_18003E040(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)(a2 + 36) = 1;
  ...
  if ( *(_BYTE *)(a1 + 24) )
  {
    if ( dword_180218880 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)TlsIndex)
                                     + 44LL) )
    {
      Init_thread_header(&dword_180218880);
      if ( dword_180218880 == -1 )
      {
        dword_18021887C = o_powf();
        Init_thread_footer(&dword_180218880);
      }
    }
    v6 = *(float *)&dword_18021887C * v6;
  }
  *(_DWORD *)(a2 + 12) = (int)v6;
