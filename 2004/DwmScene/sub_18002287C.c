/*
 * XREFs of sub_18002287C @ 0x18002287C
 * Callers:
 *     sub_1800269C0 @ 0x1800269C0 (sub_1800269C0.c)
 * Callees:
...
_QWORD *__fastcall sub_18002287C(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_1800212CC((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
