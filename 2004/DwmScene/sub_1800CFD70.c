/*
 * XREFs of sub_1800CFD70 @ 0x1800CFD70
 * Callers:
...
__int64 __fastcall sub_1800CFD70(_QWORD *a1)
{
  __int64 v2; // rcx
  __int64 *v3; // rbx
  __int64 *v4; // rcx
  ...
  `eh vector destructor iterator'(a1 + 8, 0x10uLL, 5uLL, (void (*)(void *))unknown_libname_96);
  v2 = a1[6];
  v3 = *(__int64 **)(v2 + 8);
  if ( !*((_BYTE *)v3 + 25) )
  {
    do
    {
      sub_180020058((__int64)(a1 + 6), (__int64)(a1 + 6), (__int64 *)v3[2]);
      v4 = v3;
      v3 = (__int64 *)*v3;
      j_j__o_free(v4);
    }
