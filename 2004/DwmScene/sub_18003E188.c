/*
 * XREFs of sub_18003E188 @ 0x18003E188
 * Callers:
...
__int64 __fastcall sub_18003E188(__int64 a1)
{
  *(_DWORD *)(a1 + 8) = 1;
  *(_DWORD *)(a1 + 12) = 1;
  ...
  *(_QWORD *)(a1 + 40) = 0LL;
  *(_QWORD *)(a1 + 48) = 0LL;
  `eh vector constructor iterator'((void *)(a1 + 64), 0x30uLL, 2uLL, sub_18003E330, sub_18003E4C0);
  return a1;
}
