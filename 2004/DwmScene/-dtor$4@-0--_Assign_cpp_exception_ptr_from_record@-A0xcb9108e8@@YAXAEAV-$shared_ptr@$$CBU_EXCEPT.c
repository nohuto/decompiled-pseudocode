/*
 * XREFs of ?dtor$4@?0??_Assign_cpp_exception_ptr_from_record@?A0xcb9108e8@@YAXAEAV?$shared_ptr@$$CBU_EXCEPTION_RECORD@@@std@@AEBUEHExceptionRecord@@@Z@4HA @ 0x18012B67A
 * Callers:
 *     <none>
 * Callees:
