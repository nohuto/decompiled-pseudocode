/*
 * XREFs of sub_18003AE4C @ 0x18003AE4C
 * Callers:
...
__int64 __fastcall sub_18003AE4C(__int64 a1, __int64 a2)
{
  _QWORD *v4; // r12
  _QWORD *v5; // r14
  ...
  *((_QWORD *)&v24 + 1) = v8;
  v9 = a2 + 8;
  sub_180039438(a2 + 8, (__int64)&v24, *(_DWORD *)a2, v7);
  v10 = (__int64 *)sub_18009ADA4(*v5, v34, *(unsigned int *)(a1 + 88));
  ...
  {
    sub_18000FD48(v37);
    v23 = sub_18000FD48(v36);
    sub_180027FF4(v40, v23, 411, (__int64)v37, 0);
  ...
  if ( *(_BYTE *)(a2 + 4) )
  {
    ...
    {
      sub_18000FD48(v39);
      v22 = sub_18000FD48(v38);
      sub_180027FF4(pExceptionObject, v22, 418, (__int64)v39, 0);
    ...
    *((_QWORD *)&v25 + 1) = v17;
    sub_180039438(v9, (__int64)&v25, 3, 64);
    sub_180017744(v4, &v31, 1u);
    ...
    *((_QWORD *)&v26 + 1) = v19;
    result = sub_180039438(v9, (__int64)&v26, 3, 1);
    if ( *((_QWORD *)&v42 + 1) )
    {
