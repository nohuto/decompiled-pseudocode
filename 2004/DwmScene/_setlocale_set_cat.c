/*
 * XREFs of _setlocale_set_cat @ 0x18003A1F0
 * Callers:
...
_QWORD *__fastcall setlocale_set_cat(_QWORD *a1, __int64 *a2, int a3, int a4, const char *a5)
{
  ...
  if ( *((_QWORD *)a5 + 3) >= 0x10uLL )
    v14 = *(const char **)a5;
  sub_180010454(v37, v14);
  v44 = 0;
  v45 = 5LL;
  v38 = 0LL;
  v15 = *sub_180024694(*a2, &v33);
  v16 = v38;
  if ( v38 )
  {
    v38 = 0LL;
  ...
  *(_OWORD *)a1 = 0LL;
  ...
  sub_180039510(v20, v34, (__int64 *)&v30, 5u);
  v21 = v38;
  if ( v38 )
  {
    v38 = 0LL;
