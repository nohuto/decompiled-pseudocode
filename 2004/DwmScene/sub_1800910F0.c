/*
 * XREFs of sub_1800910F0 @ 0x1800910F0
 * Callers:
...
__int64 __fastcall sub_1800910F0(__int64 *a1, __int64 a2, unsigned int a3, int a4, int a5, int a6, _QWORD *a7)
{
  __int64 v11; // rbx
  ...
  v13 = sub_180030CCC(17, a4);
  return sub_1800CD334(v11, a2, a3, v13, a6, 17);
}
