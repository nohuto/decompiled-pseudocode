/*
 * XREFs of sub_1800ED4BC @ 0x1800ED4BC
 * Callers:
...
__int64 __fastcall sub_1800ED4BC(__int64 a1, _QWORD *a2)
{
  __int64 *v4; // r12
  __int64 *v5; // r15
  __int64 result; // rax
  ...
  {
    sub_18000FD48(v38);
    v28 = sub_18000FD48(v37);
    sub_180027FF4(v45, v28, 658, (__int64)v38, 0);
  ...
  while ( v7 != v8 )
  {
    ...
    if ( (_WORD)v9 == 0xFFFF )
    {
      v25 = sub_18009BCB8(
              ...
              (_QWORD *)v7);
      v26 = sub_18002C218((__int64)v44, v25, "' required for import by this layout");
      v27 = sub_18000FD48(v40);
      sub_180027FF4(pExceptionObject, v27, 673, v26, 0);
    ...
    if ( v11 != *(_DWORD *)(v10 + 36) )
    {
      v29 = sub_18009BCB8(
              ...
              (_QWORD *)v7);
      v30 = sub_18002C218((__int64)v42, v29, "' imported by this layout");
      v31 = sub_18000FD48(v39);
      sub_180027FF4(v46, v31, 680, v30, 0);
    ...
    if ( v11 == 8 )
    {
      ...
      if ( (__int64 *)v5[2] == v12 )
      {
        result = sub_1800EB8A4(v5, (unsigned __int64)v12, &v33);
      }
      else
      {
        result = v33;
...
LABEL_27:
    for ( i = 0; i < v19; ++i )
    {
      ...
      if ( (__int64 *)v4[2] == v21 )
      {
        result = sub_1800EB8A4(v4, (unsigned __int64)v21, &v34);
      }
      else
      {
        result = v34;
