/*
 * XREFs of sub_180022E88 @ 0x180022E88
 * Callers:
 *     sub_180026AE0 @ 0x180026AE0 (sub_180026AE0.c)
 * Callees:
...
_QWORD *__fastcall sub_180022E88(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rbx
  __int128 v5; // [rsp+20h] [rbp-28h] BYREF

  v5 = 0LL;
  sub_180021238((__int64)&v5);
  *(_OWORD *)a2 = 0LL;
