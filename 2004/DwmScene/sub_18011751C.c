/*
 * XREFs of sub_18011751C @ 0x18011751C
 * Callers:
 *     sub_18011B480 @ 0x18011B480 (sub_18011B480.c)
 * Callees:
...
__int64 __fastcall sub_18011751C(__int64 a1, _QWORD *a2, int a3, int a4)
{
...
LABEL_28:
  ...
  if ( (unsigned __int8)sub_18011CCD8(v18[0] + 64, v12) )
  {
    ...
    else
    {
      ...
      v13 = (Concurrency::details::WorkItem *)sub_18011CB80(v11, v21);
      if ( (unsigned __int8)sub_18011CD60(v13) )
      {
        ...
        if ( (unsigned __int8)sub_18011CCD8(v13, v14)
          && (v19 = 0LL,
              ...
              v15 = (Concurrency::details::WorkItem *)sub_18011CB80(v13, v18),
              Concurrency::details::WorkItem::IsContext(v15)) )
        {
          if ( (unsigned int)sub_18011CBE4(v15) != a3 )
          {
            v19 = 0LL;
            v20 = 0LL;
            sub_18001269C(v18, (__int64)v25);
            sub_180117464((__int64)v13, v18, a3);
            v10 = 1;
          }
        }
        else
      ...
      {
        if ( (unsigned int)sub_18011CBE4(v13) != a3 )
        {
          v22 = 0LL;
          v23 = 0LL;
          sub_18001269C(v21, (__int64)a2);
          sub_180117464(v11, v21, a3);
          v10 = 1;
        }
      }
      else
