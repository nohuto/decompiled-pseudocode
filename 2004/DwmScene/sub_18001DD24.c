/*
 * XREFs of sub_18001DD24 @ 0x18001DD24
 * Callers:
...
__int64 __fastcall sub_18001DD24(__int64 a1, __int128 *a2, __int64 *a3, _QWORD *a4)
{
  __int64 v5; // rcx
  __int64 v6; // rax
  __int64 v7; // rax
  ...
  *((_QWORD *)&v11 + 1) = v5;
  ...
  v13[0] = v8;
  v13[1] = v9;
  ((void (__fastcall *)(__int64, _OWORD *, _QWORD *, __int128 *))sub_18003E350)(a1 + 16, v13, v12, &v11);
  return a1;
}
