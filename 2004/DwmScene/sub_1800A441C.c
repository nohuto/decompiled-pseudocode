/*
 * XREFs of sub_1800A441C @ 0x1800A441C
 * Callers:
...
void __fastcall sub_1800A441C(__int64 a1, unsigned int a2)
{
  __int64 *v4; // rax
  __int64 v5; // rax
  __int64 v6; // rdx
  ...
  v36 = 0LL;
  v4 = (__int64 *)sub_1800A4E64(a1, v30);
  v5 = sub_1800A038C(*v4);
  sub_1800754FC(v5, (__int64 *)&v36, a2);
  v7 = v31;
  if ( v31 )
  {
  ...
  sub_18006187C(v36 + 24, v6);
  if ( *(_DWORD *)(a1 + 432) != 1 )
  {
    sub_18000FD48(v33);
    v29 = sub_18000FD48(v32);
    sub_180027FF4(pExceptionObject, v29, 545, (__int64)v33, 0);
