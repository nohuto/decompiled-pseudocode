/*
 * XREFs of sub_180115020 @ 0x180115020
 * Callers:
 *     <none>
 * Callees:
...
ULONG __fastcall sub_180115020(__int64 a1, void *a2, __int64 a3, __int64 a4, void *a5, void *a6, int a7)
{
  ULONG result; // eax
  ...
  if ( (unsigned int)dword_18020DB58 > 5 )
  {
    ...
    return sub_180002C58(
             ...
             (unsigned __int8 *)dword_1801E8371,
             0LL,
             0LL,
             &v13,
             (__int64)&v12,
