/*
 * XREFs of sub_1800ADAB4 @ 0x1800ADAB4
 * Callers:
 *     sub_1800AD1E0 @ 0x1800AD1E0 (sub_1800AD1E0.c)
 * Callees:
 *     sub_1800ADC6C @ 0x1800ADC6C (sub_1800ADC6C.c)
 */

// local variable allocation has failed, the output may be wrong!
float __fastcall sub_1800ADAB4(float a1, float a2, float a3, double a4)
{
  __m128 v4; // xmm8
  __m128 v6; // xmm3
  __m128 v7; // xmm1
