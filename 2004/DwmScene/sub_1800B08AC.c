/*
 * XREFs of sub_1800B08AC @ 0x1800B08AC
 * Callers:
...
int __fastcall sub_1800B08AC(__int64 a1)
{
...
LABEL_6:
    ...
    JUMPOUT(0x1800B0998LL);
  }
  v9 = _std_type_info_hash(&qword_18020FB78);
  sub_180020D3C((__int64 **)a1, (__int64)v6, (unsigned __int64 *)&v9);
  v7[0] = &std::_Func_impl_no_alloc<_lambda_966210904f8ddb1ecfe06826adf9ae70_,std::shared_ptr<Spectre::Engine::RendererResource>,>::`vftable';
  v8 = v7;
