/*
 * XREFs of sub_180086B64 @ 0x180086B64
 * Callers:
...
__int64 __fastcall sub_180086B64(_DWORD *a1, unsigned __int64 *a2, unsigned __int64 *a3)
{
  __m128 v3; // xmm8
  __m128 v4; // xmm6
  __m128 v5; // xmm7
  ...
  if ( (_BYTE)result != 7 )
    wassert(L"XMVector3LessOrEqual( Min, Max )", L"OneCoreUap\\External\\Sdk\\Inc\\DirectXCollision.inl", 0x743u);
  v10 = _mm_mul_ps(_mm_add_ps(v8, v7), (__m128)xmmword_18013A500);
  if ( !a1 )
  ...
  *a1 = v10.m128_i32[0];
  ...
  v11 = _mm_mul_ps(_mm_sub_ps(v8, v7), (__m128)xmmword_18013A500);
