/*
 * XREFs of sub_1800D2E8C @ 0x1800D2E8C
 * Callers:
...
unsigned __int64 __fastcall sub_1800D2E8C(__int64 a1, __int64 a2)
{
  ...
  if ( (__int64)((v4 >> 63) + v4) >= 2 )
  {
    ...
    do
    {
      ...
      *((_BYTE *)v6 - 32) = 0;
      ...
      v15 = v11;
      if ( v6 - 2 != (__int128 *)a1 )
        sub_18001D08C((_QWORD *)v6 - 4, a1);
      *(_QWORD *)v6 = *(_QWORD *)(a1 + 32);
      *((_QWORD *)v6 + 1) = *(_QWORD *)(a1 + 40);
      sub_1800D2CC8(a1, 0LL, ((__int64)v6 + v7) / 48, (__int64)&v13);
