/*
 * XREFs of sub_18006BE7C @ 0x18006BE7C
 * Callers:
...
__int64 __fastcall sub_18006BE7C(__int64 a1, _BYTE *a2)
{
  __int64 v2; // rbx
  unsigned int v3; // edi
  __int64 v4; // r15
  ...
  sub_180071FA4(&v14, v2);
  if ( v15 )
  {
    try
    {
      v6 = std::ios_base::getloc(v2 + *(int *)(*(_QWORD *)v2 + 4LL), v16);
      v21 = sub_180071164(v6);
      if ( v17 )
      {
        v7 = (void (__fastcall ***)(_QWORD, __int64))(*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v17 + 16LL))(v17);
        if ( v7 )
          (**v7)(v7, 1LL);
      }
