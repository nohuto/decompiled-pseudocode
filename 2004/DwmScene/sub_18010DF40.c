/*
 * XREFs of sub_18010DF40 @ 0x18010DF40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_18010DF40(__int64 a1, __int64 a2, int a3, int a4, char a5, int a6)
{
  float v8; // xmm1_4
  float v9; // xmm8_4
  float v10; // xmm0_4
  ...
  *(float *)(a1 + 268) = v12;
  ...
  if ( !v14 )
    v14 = 1;
  v39 = *(_DWORD *)(a1 + 376);
  v41 = sub_18006AB04(a2);
  sub_18000F7C8(v41, &v46, 0);
  v15 = (__int64 *)(a1 + 184);
  ...
  LOBYTE(v50[0]) = 0;
  LOBYTE(v16) = 0;
  sub_18000FB34(v50, 0x14uLL, v16, "ImageProcessingBlurX");
  sub_1800628C4(*v15, v50);
  sub_18006313C(*v15, v13, v14, a5, a6, 0LL);
  sub_18000F7C8(v41, &v48, 0);
  v18 = (__int64 *)(a1 + 200);
  ...
  LOBYTE(v51[0]) = 0;
  LOBYTE(v19) = 0;
  sub_18000FB34(v51, 0x14uLL, v19, "ImageProcessingBlurY");
  sub_1800628C4(*v18, v51);
  sub_18006313C(*v18, v13, v14, a5, a6, 0LL);
  v21 = (__int64 *)(a1 + 216);
  v22 = *(_QWORD *)(a1 + 224);
  v23 = *(_QWORD *)(a1 + 216);
  if ( v23 != v22 )
  ...
  *(_QWORD *)(a1 + 224) = v23;
  ...
  {
    v53 = 0LL;
    sub_18000F7C8(v41, &v53, 0);
    sub_1800206C4(v44, v26);
    v27 = sub_180054FC4(v44, 0LL, "ImageProcessingBlur Downsample ", 0x1FuLL);
    v43 = 0uLL;
    Src_8 = *(_OWORD *)v27;
    v43 = *((_OWORD *)v27 + 1);
    v27[2] = 0LL;
...
LABEL_45:
    ...
    *((_QWORD *)&v43 + 1) = 15LL;
    ...
    v52[2] = 0LL;
    v52[3] = 0LL;
    sub_18001CDF8(v52, (__int64)&v54);
    sub_1800628C4(v53, v52);
    v32 = (int)ceilf(v9 / (float)v26);
    v33 = ceilf(v11 / (float)v26);
    sub_18006313C(v53, v32, (int)v33, a5, a6, 0LL);
    v34 = (_QWORD *)v21[1];
    if ( (_QWORD *)v21[2] == v34 )
    {
      result = sub_180010F3C(v21, v34, &v53);
    }
    else
    {
      *v34 = 0LL;
    ...
    if ( (char *)v24[2] == v35 )
    {
      result = sub_1800F56BC(v24, v35, v40);
    }
    else
    {
