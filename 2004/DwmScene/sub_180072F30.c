/*
 * XREFs of sub_180072F30 @ 0x180072F30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_180072F30(__int64 a1, __int64 *a2)
{
  __int64 v4; // rbx
  __int64 v5; // rax
  __int64 v6; // rcx
  ...
  v21 = 0LL;
  sub_18006156C(*a2 + 16, (__int64)&v21);
  v20 = 0LL;
  *(_QWORD *)&v14 = v19;
  ...
  v19[2] = 0LL;
  v19[3] = 0LL;
  sub_18001269C(v19, (__int64)&qword_1802086D0);
  v4 = *a2;
  v5 = sub_18007FC0C(v15);
  sub_1800861F0(v4, &v20, v5, v19);
  ...
  LOBYTE(v15[0]) = 0;
  v13 = 0LL;
  sub_18006C0D8(v20, &v13);
  v18 = 15LL;
  Src[2] = 13LL;
  strcpy((char *)Src, "DefaultCamera");
  v7 = v13;
  sub_180012E34((__int64 *)(v13 + 24), Src);
  if ( v18 >= 0x10 )
  {
    v8 = Src[0];
    if ( v18 + 1 >= 0x1000 )
