/*
 * XREFs of __isa_available_init @ 0x18011F0E0
 * Callers:
...
int __cdecl _isa_available_init()
{
  ...
  if ( (v14 & 0x100000) != 0 )
  {
    ...
    if ( (v14 & 0x8000000) != 0 && (v14 & 0x10000000) != 0 )
    {
      ...
      if ( (_RAX & 6) == 6 )
      {
        v23 = dword_18020DEB8 | 8;
        dword_18020DEB4 = 3;
        dword_18020DEB8 |= 8u;
        if ( (v5 & 0x20) != 0 )
        {
          dword_18020DEB4 = 5;
          dword_18020DEB8 = v23 | 0x20;
        }
      }
    }
  }
