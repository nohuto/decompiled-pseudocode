/*
 * XREFs of AMLILoadDDB @ 0x1C00BE218
 * Callers:
...
__int64 __fastcall AMLILoadDDB(int *a1, _QWORD *a2)
{
  ...
  {
    pszSrc = *a1;
    RtlStringCchCopyNA(byte_1C0082B80, 5uLL, (STRSAFE_PCNZCH)&pszSrc, 4uLL);
    PrintDebugMessage(85, KeGetCurrentThread(), byte_1C0082B80, a1, 0LL);
  }
  v4 = 0;
  v12 = 0;
