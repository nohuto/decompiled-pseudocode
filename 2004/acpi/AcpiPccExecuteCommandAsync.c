/*
 * XREFs of AcpiPccExecuteCommandAsync @ 0x1C0059B80
 * Callers:
 *     AcpiPccExecuteCommand @ 0x1C00B07B0 (AcpiPccExecuteCommand.c)
 * Callees:
 *     AcpiPccRingDoorbell @ 0x1C005A070 (AcpiPccRingDoorbell.c)
 */
