/*
 * XREFs of ACPIIoctlUnregisterDeviceFirmwareLockHandler @ 0x1C0058244
 * Callers:
 *     ACPIIrpDispatchDeviceControl @ 0x1C000B4E0 (ACPIIrpDispatchDeviceControl.c)
 * Callees:
 *     AcpiUnregisterDeviceFirmwareLockHandler @ 0x1C00AE15C (AcpiUnregisterDeviceFirmwareLockHandler.c)
 */
