/*
 * XREFs of DriverEntry @ 0x1C00BB81C
 * Callers:
 ...
 *     AcpiInitializeExternalResourceTranslation @ 0x1C0090388 (AcpiInitializeExternalResourceTranslation.c)
 *     Simulator_InitializeInterface @ 0x1C00BB558 (Simulator_InitializeInterface.c)
 *     ACPIInitializeWorker @ 0x1C00BB5F4 (ACPIInitializeWorker.c)
 *     ACPIInitRecordEmOverrides @ 0x1C00BB744 (ACPIInitRecordEmOverrides.c)
 ...
 *     ACPIInitGetEmOverride @ 0x1C00BD8EC (ACPIInitGetEmOverride.c)
