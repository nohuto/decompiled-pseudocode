/*
 * XREFs of ACPIBuildProcessDelayedDependencyExternalTriggerFilterPowerCheck @ 0x1C002D1E8
 * Callers:
 ...
 *     ACPIBuildProcessDelayedDependencyShouldDelayRequest @ 0x1C002E5E4 (ACPIBuildProcessDelayedDependencyShouldDelayRequest.c)
