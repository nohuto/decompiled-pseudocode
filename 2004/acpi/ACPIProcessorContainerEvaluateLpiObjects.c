/*
 * XREFs of ACPIProcessorContainerEvaluateLpiObjects @ 0x1C005D134
 * Callers:
 *     ACPIProcessorContainerEvaluateLpiObjects @ 0x1C005D134 (ACPIProcessorContainerEvaluateLpiObjects.c)
