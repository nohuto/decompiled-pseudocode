/*
 * XREFs of ACPIDeviceIdMutiStringMatchCallback @ 0x1C0055F80
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIConvertWideStringToUpperCaseHelper @ 0x1C00607D0 (ACPIConvertWideStringToUpperCaseHelper.c)
 */
