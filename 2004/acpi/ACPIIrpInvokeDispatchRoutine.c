/*
 * XREFs of ACPIIrpInvokeDispatchRoutine @ 0x1C00A16D4
 * Callers:
 *     ACPIBusIrpQueryPnpDeviceState @ 0x1C00A1680 (ACPIBusIrpQueryPnpDeviceState.c)
 *     ACPIBusIrpQueryCapabilities @ 0x1C00A16B0 (ACPIBusIrpQueryCapabilities.c)
 *     ACPIBusIrpEject @ 0x1C00ADA40 (ACPIBusIrpEject.c)
 *     ACPIBusIrpSetLock @ 0x1C00ADD00 (ACPIBusIrpSetLock.c)
 * Callees:
