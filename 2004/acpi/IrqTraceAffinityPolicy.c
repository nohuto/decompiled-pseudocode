/*
 * XREFs of IrqTraceAffinityPolicy @ 0x1C0095E64
 * Callers:
 ...
 *     IrqpAllocateInstancePath @ 0x1C00961D4 (IrqpAllocateInstancePath.c)
 */
...
void __fastcall IrqTraceAffinityPolicy(PDEVICE_OBJECT Pdo, unsigned __int16 a2, __int16 a3, __int64 a4)
{
  ...
  v14[0] = 0LL;
  v6 = a2;
  if ( dword_1C007F120 && tlgKeywordOn((__int64)&dword_1C007F120) )
  {
    if ( (_WORD)v6 == 4 )
    ...
    if ( (unsigned int)dword_1C007F120 > 5 && tlgKeywordOn((__int64)&dword_1C007F120) )
    {
      v18 = 0;
      v20[1] = 0;
      v23 = 0;
      ...
      tlgWriteTransfer_EtwWriteTransfer(
        (__int64)&dword_1C007F120,
        (unsigned __int8 *)dword_1C00726D2,
        4LL,
        v10,
        8u,
        &v15);
