/*
 * XREFs of AcpiPccAcquireSubspaceCore @ 0x1C00597A8
 * Callers:
 *     AcpiPccAcquireSubspaceAsync @ 0x1C0059790 (AcpiPccAcquireSubspaceAsync.c)
 *     AcpiPccAcquireSubspace @ 0x1C00B0720 (AcpiPccAcquireSubspace.c)
 * Callees:
 *     <none>
 */
