/*
 * XREFs of ACPIEvaluateSpareDsm @ 0x1C00B0000
 * Callers:
...
__int64 __fastcall ACPIEvaluateSpareDsm(unsigned __int64 *a1, unsigned int a2, __int128 *a3, __int64 a4)
{
  __int64 v4; // rbx
  __int128 v8; // xmm0
  int v9; // eax
  __int128 v10; // xmm1
  _OWORD v12[3]; // [rsp+20h] [rbp-99h] BYREF
  ...
  *(_QWORD *)(a4 + 32) = 0LL;
  ...
  if ( a3 )
  {
    ...
    LODWORD(v12[0]) = 1;
    v10 = a3[1];
    *(_OWORD *)((char *)v12 + 8) = v8;
    *((_QWORD *)&v12[2] + 1) = *((_QWORD *)a3 + 4);
    *(_OWORD *)((char *)&v12[1] + 8) = v10;
    if ( v9 )
      LODWORD(v13[18]) = v9 + 8;
  }
  return AMLIEvalNameSpaceObject(a1, a4, 4, v13, v12[0], v12[1], v12[2]);
}
