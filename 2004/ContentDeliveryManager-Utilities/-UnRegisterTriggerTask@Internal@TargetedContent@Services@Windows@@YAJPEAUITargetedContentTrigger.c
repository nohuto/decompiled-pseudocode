/*
 * XREFs of ?UnRegisterTriggerTask@Internal@TargetedContent@Services@Windows@@YAJPEAUITargetedContentTriggerInternal@1234@V?$shared_ptr@VCorrelationVectorWrapper@Background@ContentDeliveryManager@@@std@@@Z @ 0x1800730A4
 * Callers:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::UnRegisterTriggerTask(__int64 a1, __int64 a2)
{
  ...
  v5 = (const WCHAR *)v11;
  if ( v12 >= 8 )
    v5 = (const WCHAR *)v11[0];
  v9[0] = v5;
  v6 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v15, v9);
  CreativeFramework::CommonHelper::UnregisterTask(v6[1].Reserved.Reserved1, v4);
  if ( v12 >= 8 )
