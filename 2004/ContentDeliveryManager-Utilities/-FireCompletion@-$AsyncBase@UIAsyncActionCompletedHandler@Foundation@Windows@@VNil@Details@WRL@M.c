/*
 * XREFs of ?FireCompletion@?$AsyncBase@UIAsyncActionCompletedHandler@Foundation@Windows@@VNil@Details@WRL@Microsoft@@$00U?$AsyncCausalityOptions@$1?EnableLockScreenRotationOperationName@?A0xb8965cb7@@3QBGB$1?GUID_CAUSALITY_WINDOWS_PLATFORM_ID@@3U_GUID@@B$01@67@@WRL@Microsoft@@UEAAJXZ @ 0x18001D5E0
 * Callers:
 *     <none>
 * Callees:
        ...
        signed __int32 *a1)
{
  ...
  if ( *((_QWORD *)a1 + 3) && _InterlockedIncrement(a1 + 4) == 1 )
  {
    ...
    if ( v5(a1, &GUID_5a648006_843a_4da9_865b_9d26e5dfad7b, &v16) >= 0 )
    {
      v15 = -2;
