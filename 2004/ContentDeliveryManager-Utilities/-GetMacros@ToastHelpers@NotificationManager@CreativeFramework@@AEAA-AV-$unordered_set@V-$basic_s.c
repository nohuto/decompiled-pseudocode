 ...
 *     ?append@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAAEAV12@PEB_W_K@Z @ 0x180079D00 (-append@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEAAAEAV12@PEB_W_K@Z.c)
...
__int64 __fastcall CreativeFramework::NotificationManager::ToastHelpers::GetMacros(__int64 a1, __int64 a2)
{
  ...
  const char *v22; // rcx
  const char *v23; // rax
  char v25[16]; // [rsp+68h] [rbp-19h] BYREF
  void *v26[3]; // [rsp+78h] [rbp-9h] BYREF
  ...
  *(_DWORD *)(a2 + 56) = 1065353216;
  std::_Hash<std::_Uset_traits<std::wstring,std::_Uhash_compare<std::wstring,std::hash<std::wstring>,std::equal_to<std::wstring>>,std::allocator<std::wstring>,0>>::_Init(
    (__int64 *)a2,
    8LL);
  if ( asc_1801689A8[0] && (v4 = *(_QWORD *)(a1 + 16)) != 0 )
  {
    v5 = *(_QWORD *)(a1 + 24);
    if ( v5 < 8 )
      v6 = (const char *)a1;
...
LABEL_21:
  ...
  do
  {
    ...
    wil::details::in1diag3::Throw_HrIfMsg(
      ...
      (__int64)"shellcommon\\shell\\contentdeliverymanager\\utils\\lib\\actionhelpers\\toasthelpers.cpp",
      (const char *)0x80070057LL,
      *(_WORD *)&v16[2 * v14] == asc_1801689A8[0],
      (__int64)"%ls",
      v15);
    if ( *(_QWORD *)(a1 + 24) < 8uLL )
      v17 = (const char *)a1;
      ...
      v17 = *(const char **)a1;
    if ( *(_WORD *)&v17[2 * v14] == asc_1801689AC[0] )
    {
      v18 = v14 + 1;
      v19 = std::wstring::find((char *)a1, L"}", v18, asc_1801689A8[0] != 0);
      if ( *(_QWORD *)(a1 + 24) < 8uLL )
        wil::details::in1diag3::Throw_HrIfMsg(
          retaddr,
          (void *)0x106,
      ...
      v27 = 7LL;
      v26[2] = 0LL;
      for ( LOWORD(v26[0]) = 0; v18 < v19; ++v18 )
      {
        if ( *(_QWORD *)(a1 + 24) < 8uLL )
          v21 = (const char *)a1;
        else
        ...
        wil::details::in1diag3::Throw_HrIfMsg(
          ...
          (__int64)"shellcommon\\shell\\contentdeliverymanager\\utils\\lib\\actionhelpers\\toasthelpers.cpp",
          (const char *)0x80070057LL,
          *(_WORD *)&v22[2 * v18] == asc_1801689AC[0],
          (__int64)"%ls",
          v21);
        if ( *(_QWORD *)(a1 + 24) < 8uLL )
          v23 = (const char *)a1;
          ...
          v23 = *(const char **)a1;
        std::wstring::append(v26, (void **)&v23[2 * v18], 1uLL);
      }
      LOBYTE(v20) = byte_180199319;
