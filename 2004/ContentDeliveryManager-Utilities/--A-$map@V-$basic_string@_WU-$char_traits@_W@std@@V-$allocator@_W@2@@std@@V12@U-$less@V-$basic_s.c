...
__int64 __fastcall std::map<std::wstring,std::wstring>::operator[](__int64 *a1, _QWORD *a2)
{
  ...
  int v12; // eax
  __int64 v13; // rax
  _QWORD v15[2]; // [rsp+38h] [rbp-49h] BYREF
  void *v16[3]; // [rsp+48h] [rbp-39h] BYREF
  unsigned __int64 v17; // [rsp+60h] [rbp-21h]
  void *v18[3]; // [rsp+68h] [rbp-19h] BYREF
  unsigned __int64 v19; // [rsp+80h] [rbp-1h]
  void *v20[3]; // [rsp+88h] [rbp+7h] BYREF
  ...
  if ( v15[0] == *a1 )
    goto LABEL_19;
  v5 = (_QWORD *)(v15[0] + 32LL);
  v6 = *(_QWORD *)(v15[0] + 48LL);
  if ( *(_QWORD *)(v15[0] + 56LL) >= 8uLL )
    v5 = (_QWORD *)*v5;
  v7 = a2[2];
  if ( a2[3] < 8uLL )
    v8 = a2;
...
LABEL_19:
    ...
    v16[2] = 0LL;
    LOWORD(v16[0]) = 0;
    std::wstring::_Assign_rv(v16, a2);
    v19 = 7LL;
    v18[2] = 0LL;
    LOWORD(v18[0]) = 0;
    std::wstring::_Assign_rv(v18, v20);
    v13 = std::_Tree_buy<std::pair<std::wstring const,std::wstring>>::_Buynode<std::pair<std::wstring,std::wstring>>(
            a1,
            v16);
