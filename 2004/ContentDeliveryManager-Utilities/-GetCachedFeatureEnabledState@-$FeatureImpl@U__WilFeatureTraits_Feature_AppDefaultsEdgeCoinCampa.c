/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x180038D28
 * Callers:
 *     ?IsEnabled@?$Feature@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@wil@@SA_NXZ @ 0x180033780 (-IsEnabled@-$Feature@U__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign@@@wil@@SA_NXZ.c)
 * Callees:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_AppDefaultsEdgeCoinCampaign>::GetCachedFeatureEnabledState(
        wil::details *a1,
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    if ( g_wil_details_internalGetFeatureEnabledState || (v6 = g_wil_details_apiGetFeatureEnabledState) != 0LL )
      v7 = ((__int64 (__fastcall *)(__int64, _QWORD, int *))v6)(13974053LL, 0LL, &v19);
    else
      v7 = 0;
    v21 = 0;
    v8 = v7 & 0xFFFFFF3F;
