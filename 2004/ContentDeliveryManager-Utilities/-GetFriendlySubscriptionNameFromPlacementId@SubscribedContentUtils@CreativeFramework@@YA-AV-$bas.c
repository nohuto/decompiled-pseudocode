/*
 * XREFs of ?GetFriendlySubscriptionNameFromPlacementId@SubscribedContentUtils@CreativeFramework@@YA?AV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@PEB_W@Z @ 0x1800875E0
 * Callers:
        ...
        char *a2)
{
  ...
  {
    v7 += 3;
    if ( v7 == (const wchar_t near *const *)off_1800FB2A8 )
      goto LABEL_16;
  }
  v6 = (WCHAR *)*v7;
LABEL_16:
