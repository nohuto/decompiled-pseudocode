/*
 * XREFs of ?StartActivity@TriggerManagerGetTriggeredItemsForStateActivity@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@QEAAXPEB_W0PEBD@Z @ 0x180067268
 * Callers:
        ...
        const char *a4)
{
  ...
  *v8 = 1;
  ...
  if ( *(_DWORD *)v12 > 5u )
  {
    ...
    v29 = 4LL;
    v27 = 8LL;
    tlgWriteTransfer_EventWriteTransfer((__int64)v12, (unsigned __int8 *)dword_1801777F7, v16, v15, 7u, &v25);
  }
  if ( !*((_DWORD *)this + 8) )
