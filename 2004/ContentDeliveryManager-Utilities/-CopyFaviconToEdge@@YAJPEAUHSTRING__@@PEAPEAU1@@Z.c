/*
 * XREFs of ?CopyFaviconToEdge@@YAJPEAUHSTRING__@@PEAPEAU1@@Z @ 0x18009B034
 * Callers:
...
LABEL_22:
  ...
  newString = 0LL;
  v14 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v33, (const WCHAR **)off_1800FB2E0);
  ...
  *v18 = 0LL;
  ...
  v21 = newString;
  v22 = Microsoft::WRL::Wrappers::HStringReference::HStringReference(&v33, (const WCHAR **)off_1800FB2E8);
