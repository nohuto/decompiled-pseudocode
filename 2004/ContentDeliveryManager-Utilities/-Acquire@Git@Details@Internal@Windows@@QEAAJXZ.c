/*
 * XREFs of ?Acquire@Git@Details@Internal@Windows@@QEAAJXZ @ 0x180061A20
 * Callers:
...
__int64 __fastcall Windows::Internal::Details::Git::Acquire(Windows::Internal::Details::Git *this)
{
  ...
  ppv = this;
  v1 = qword_180199378 == 0 ? 0x8000FFFF : 0;
  if ( qword_180199378 )
  {
  ...
  else
  {
    ...
    {
      v2 = ppv;
      if ( !_InterlockedCompareExchange64(&qword_180199378, (signed __int64)ppv, 0LL) )
        v2 = 0LL;
      ppv = v2;
      _InterlockedIncrement(&Windows::Internal::Details::_git);
    }
