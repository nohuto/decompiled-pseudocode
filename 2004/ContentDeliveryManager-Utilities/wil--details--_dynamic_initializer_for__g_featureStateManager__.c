...
int wil::details::_dynamic_initializer_for__g_featureStateManager__()
{
  ...
  xmmword_1801974F8 = 0LL;
  xmmword_180197508 = 0LL;
  InitializeCriticalSectionEx(&stru_180197518, 0, 0);
  wil::details::g_featureStateManager = 1;
  xmmword_180197540 = 0LL;
  xmmword_180197550 = 0LL;
  xmmword_180197560 = 0LL;
  xmmword_180197570 = 0LL;
