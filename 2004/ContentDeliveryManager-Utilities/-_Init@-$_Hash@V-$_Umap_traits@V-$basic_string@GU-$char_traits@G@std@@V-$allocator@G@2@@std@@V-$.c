 ...
 *     ??0SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@QEAA@XZ @ 0x1800496E8 (--0SubscriptionManagerImpl@Internal@TargetedContent@ContentManagement@@QEAA@XZ.c)
 * Callees:
        ...
        __int64 a2)
{
  ...
  v4 = a1[2];
  v5 = 2 * a2;
  if ( (a1[4] - v4) >> 3 < (unsigned __int64)(2 * a2) )
  {
