        ...
        __int64 a5)
{
  ...
  __int64 v27; // rcx
  int v28; // eax
  _QWORD *v29; // [rsp+70h] [rbp+8h] BYREF
...
LABEL_15:
  ...
  try
  {
    ...
    if ( (_BYTE)v11 )
    {
      ...
      std::_Tree_const_iterator<std::_Tree_val<std::_Tree_simple_types<std::pair<std::wstring const,std::wstring>>>>::operator--(&v29);
      v19 = v29;
    }
    v22 = v19 + 4;
    v23 = v5[2];
    ...
    v27 = (unsigned __int16)a3 < *(_WORD *)v5 ? -1 : 1;
LABEL_40:
    v28 = v24 != v23;
    if ( v24 < v23 )
      v28 = -1;
