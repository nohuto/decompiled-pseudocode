 ...
 *     ?GetStringSetting@ContentDeliveryManagerSettings@CreativeFramework@@YAJPEBG0_NPEAPEAG@Z @ 0x18000D01C (-GetStringSetting@ContentDeliveryManagerSettings@CreativeFramework@@YAJPEBG0_NPEAPEAG@Z.c)
  ...
  while ( v15 != v16 )
  {
    ...
    if ( *(_QWORD *)(v15 + 24) < 8uLL )
      wil::details::in1diag3::Throw_HrIfFalseMsg(
        ...
        ((v46 - (_QWORD)v45) & 0xFFFFFFFFFFFFFFE0uLL) == 64,
    ...
    *(_QWORD *)&hstringHeader.Reserved.Reserved2[8] = 0LL;
    ...
    std::wstring::assign((void **)&string, StringRawBuffer, v28);
