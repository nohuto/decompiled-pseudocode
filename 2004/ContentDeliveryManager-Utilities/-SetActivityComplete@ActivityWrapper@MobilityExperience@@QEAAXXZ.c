/*
 * XREFs of ?SetActivityComplete@ActivityWrapper@MobilityExperience@@QEAAXXZ @ 0x18004BC38
 * Callers:
 ...
 *     ??$GetActivationFactory@UIJsonObjectStatics@Json@Data@Windows@@@wil@@YA?AV?$com_ptr_t@UIJsonObjectStatics@Json@Data@Windows@@Uerr_exception_policy@wil@@@0@PEBG@Z @ 0x18004FA28 (--$GetActivationFactory@UIJsonObjectStatics@Json@Data@Windows@@@wil@@YA-AV-$com_ptr_t@UIJsonObje.c)
...
{
  __int64 v2; // rbx
  __int64 (__fastcall *v3)(__int64, PVOID, __int64 *); // rdi
  ...
  __int64 v19; // [rsp+40h] [rbp-11h] BYREF
  const WCHAR *v20[2]; // [rsp+48h] [rbp-9h] BYREF
  void *v21[3]; // [rsp+58h] [rbp+7h] BYREF
  unsigned __int64 v22; // [rsp+70h] [rbp+1Fh]
  HSTRING_HEADER v23; // [rsp+78h] [rbp+27h] BYREF
