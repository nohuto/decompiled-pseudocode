/*
 * XREFs of ?StartActivity@LaunchUriActivity@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEBG@Z @ 0x18002B5A4
 * Callers:
        ...
        const unsigned __int16 *a2)
{
  ...
  *(_DWORD *)v4 = 1;
    ...
    && (*((_QWORD *)v7 + 3) & 0x200000000000LL) == *((_QWORD *)v7 + 3) )
  {
    ...
    v20 = 4LL;
    v18 = 8LL;
    tlgWriteTransfer_EventWriteTransfer(v8, (unsigned __int8 *)dword_1801755B2, v11, v10, 5u, &v16);
  }
  if ( !*((_DWORD *)this + 8) )
