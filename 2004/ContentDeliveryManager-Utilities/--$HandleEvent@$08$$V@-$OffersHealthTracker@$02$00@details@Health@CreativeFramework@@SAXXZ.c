/*
 * XREFs of ??$HandleEvent@$08$$V@?$OffersHealthTracker@$02$00@details@Health@CreativeFramework@@SAXXZ @ 0x18003DB44
 * Callers:
...
void CreativeFramework::Health::details::OffersHealthTracker<3,1>::HandleEvent<9,>()
{
