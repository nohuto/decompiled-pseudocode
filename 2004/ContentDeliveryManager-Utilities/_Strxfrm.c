/*
 * XREFs of _Strxfrm @ 0x1800CD088
 * Callers:
 *     ?do_transform@?$collate@D@std@@MEBA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@2@PEBD0@Z @ 0x1800CC520 (-do_transform@-$collate@D@std@@MEBA-AV-$basic_string@DU-$char_traits@D@std@@V-$allocator@D@2@@2@.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B9BBC (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B9BC8 (_GetLocaleHandleById.c)
 *     __crtLCMapStringA_Stub @ 0x1800B9C94 (__crtLCMapStringA_Stub.c)
