/*
 * XREFs of ??1?$_Tree@V?$_Tmap_traits@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@$0A@@std@@@std@@QEAA@XZ @ 0x18007ED48
 * Callers:
 *     ??1?$map@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V?$allocator@U?$pair@QEBGPEBU_WNF_STATE_NAME@@@std@@@std@@@std@@QEAA@XZ @ 0x18007EA34 (--1-$map@PEBGPEBU_WNF_STATE_NAME@@Uless@Triggers@CreativeFramework@@V-$allocator@U-$pair@QEBGPEB.c)
 ...
 *     CreativeFramework::Triggers::_dynamic_atexit_destructor_for__wellKnownWnfs__ @ 0x1800D8EC0 (CreativeFramework--Triggers--_dynamic_atexit_destructor_for__wellKnownWnfs__.c)
 * Callees:
