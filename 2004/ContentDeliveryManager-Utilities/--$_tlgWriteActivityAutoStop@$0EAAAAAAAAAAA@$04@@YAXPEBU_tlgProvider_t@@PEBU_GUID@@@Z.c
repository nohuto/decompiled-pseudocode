/*
 * XREFs of ??$_tlgWriteActivityAutoStop@$0EAAAAAAAAAAA@$04@@YAXPEBU_tlgProvider_t@@PEBU_GUID@@@Z @ 0x180050374
 * Callers:
...
int __fastcall _tlgWriteActivityAutoStop<70368744177664,5>(__int64 a1, const GUID *a2)
{
  ...
  if ( *(_DWORD *)a1 > 5u && (*(_QWORD *)(a1 + 16) & 0x400000000000LL) != 0 )
  {
    ...
    if ( v2 == *(_QWORD *)(a1 + 24) )
      LODWORD(v2) = tlgWriteTransfer_EventWriteTransfer(a1, (unsigned __int8 *)dword_1801767AF, a2, 0LL, 2u, &v4);
  }
  return v2;
}
