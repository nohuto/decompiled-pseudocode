/*
 * XREFs of ??$verify_hresult@J@wil@@YAJJ@Z @ 0x180006494
 * Callers:
 ...
 *     ?ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA?AW4TargetedContentKnownTrigger@1234@PEB_W@Z @ 0x1800715F8 (-ResolveTriggerFromName@Internal@TargetedContent@Services@Windows@@YA-AW4TargetedContentKnownTri.c)
 ...
 *     ??$?0PEB_WPEB_WPEB_W@?$_Ref_count_obj@VSetDefaultApplicationService@Actions@CreativeFramework@@@std@@QEAA@$$QEAPEB_W00@Z @ 0x18008CFD8 (--$-0PEB_WPEB_WPEB_W@-$_Ref_count_obj@VSetDefaultApplicationService@Actions@CreativeFramework@@@.c)
