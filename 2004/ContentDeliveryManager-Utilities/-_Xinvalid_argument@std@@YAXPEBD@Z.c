/*
 * XREFs of ?_Xinvalid_argument@std@@YAXPEBD@Z @ 0x1800B05F8
 * Callers:
 *     ?stoi@std@@YAHAEBV?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@1@PEA_KH@Z @ 0x1800713AC (-stoi@std@@YAHAEBV-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@1@PEA_KH@Z.c)
 ...
 * Callees:
 *     ??0length_error@std@@QEAA@PEBD@Z @ 0x1800B04D0 (--0length_error@std@@QEAA@PEBD@Z.c)
