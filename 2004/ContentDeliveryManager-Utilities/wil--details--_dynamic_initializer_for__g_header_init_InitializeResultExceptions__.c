/*
 * XREFs of wil::details::_dynamic_initializer_for__g_header_init_InitializeResultExceptions__ @ 0x1800039B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 (__fastcall *wil::details::_dynamic_initializer_for__g_header_init_InitializeResultExceptions__())(wil::details *__hidden this, unsigned __int16 *, unsigned __int64, bool *)
{
  ...
  wil::details::g_pfnRunFunctorWithExceptionFilter = (int (*)(struct wil::details::IFunctor *, struct wil::details::IFunctorHost *, void *))wil::details::RunFunctorWithExceptionFilter;
