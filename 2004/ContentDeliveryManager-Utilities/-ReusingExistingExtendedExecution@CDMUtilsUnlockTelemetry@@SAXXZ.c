/*
 * XREFs of ?ReusingExistingExtendedExecution@CDMUtilsUnlockTelemetry@@SAXXZ @ 0x1800801B0
 * Callers:
...
void CDMUtilsUnlockTelemetry::ReusingExistingExtendedExecution(void)
{
  ...
  {
    tlgWriteTransfer_EventWriteTransfer((__int64)v0, (unsigned __int8 *)dword_180178914, 0LL, 0LL, 2u, &v1);
  }
}
