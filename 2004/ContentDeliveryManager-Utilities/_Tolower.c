/*
 * XREFs of _Tolower @ 0x1800B1B80
 * Callers:
 *     ?do_tolower@?$ctype@D@std@@MEBADD@Z @ 0x1800B7810 (-do_tolower@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_tolower@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x1800B7830 (-do_tolower@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
