/*
 * XREFs of ?do_curr_symbol@?$_Mpunct@G@std@@MEBA?AV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@XZ @ 0x1800C32E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall std::_Mpunct<unsigned short>::do_curr_symbol(__int64 a1, __int64 a2)
{
