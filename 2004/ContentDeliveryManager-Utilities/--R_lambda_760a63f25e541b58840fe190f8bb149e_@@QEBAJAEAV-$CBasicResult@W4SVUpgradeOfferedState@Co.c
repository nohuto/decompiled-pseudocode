/*
 * XREFs of ??R_lambda_760a63f25e541b58840fe190f8bb149e_@@QEBAJAEAV?$CBasicResult@W4SVUpgradeOfferedState@ContentManagement@@$0A@@Internal@Windows@@@Z @ 0x180011A98
 * Callers:
 *     ?Run@?$COperationLambdaVar@$0A@V_lambda_760a63f25e541b58840fe190f8bb149e_@@V?$CBasicResult@W4SVUpgradeOfferedState@ContentManagement@@$0A@@Internal@Windows@@$$V@Internal@Windows@@UEAAJW4AsyncStage@23@JAEAV?$CBasicResult@W4SVUpgradeOfferedState@ContentManagement@@$0A@@23@@Z @ 0x18001C400 (-Run@-$COperationLambdaVar@$0A@V_lambda_760a63f25e541b58840fe190f8bb149e_@@V-$CBasicResult@W4SVU.c)
 * Callees:
 ...
 *     ??$CoCreateInstance@VUpdateSessionOrchestrator@@UIUpdateSessionOrchestrator@@Uerr_exception_policy@wil@@@wil@@YA?AV?$com_ptr_t@UIUpdateSessionOrchestrator@@Uerr_exception_policy@wil@@@0@K@Z @ 0x18001A3C0 (--$CoCreateInstance@VUpdateSessionOrchestrator@@UIUpdateSessionOrchestrator@@Uerr_exception_poli.c)
    ...
    if ( v38[0] )
    {
      ...
      if ( v4 >= 0 )
      {
        ...
        if ( v7 >= 0 )
        {
          ...
          v9 = *v34;
          v33 = 0LL;
          v10 = (*v9)((__int64)v34, &GUID_68da530a_6df6_438a_bf57_452ead01c7cc, &v33);
          v11 = retaddr;
          if ( v10 >= 0 )
          {
            v36 = 0LL;
