/*
 * XREFs of ?ShouldUseInternal@Policy@CreativeFramework@@YA_NXZ @ 0x1800A373C
 * Callers:
...
char __fastcall CreativeFramework::Policy::ShouldUseInternal(CreativeFramework::Policy *this)
{
  ...
  AcquireSRWLockShared(&stru_180199310);
  v1 = 0;
  if ( !byte_1801992BD )
  {
    ReleaseSRWLockShared(&stru_180199310);
    AcquireSRWLockExclusive(&stru_180199310);
    if ( byte_1801992BD )
    {
      v1 = byte_1801992BC;
LABEL_16:
      ReleaseSRWLockExclusive(&stru_180199310);
      return v1;
    }
