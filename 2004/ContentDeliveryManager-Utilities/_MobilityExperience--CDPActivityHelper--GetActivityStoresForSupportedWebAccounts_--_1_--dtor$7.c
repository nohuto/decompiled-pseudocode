/*
 * XREFs of _MobilityExperience::CDPActivityHelper::GetActivityStoresForSupportedWebAccounts_::_1_::dtor$7 @ 0x1800D1882
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MobilityExperience::CDPActivityHelper::GetActivityStoresForSupportedWebAccounts_::_1_::dtor_7(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
