/*
 * XREFs of ??R_lambda_eb8e642fd6379236047631f6462c9202_@@QEBAJAEAVCHSTRINGResult@Internal@Windows@@@Z @ 0x180010F2C
 * Callers:
 *     ?Run@?$COperationLambdaVar@$0A@V_lambda_eb8e642fd6379236047631f6462c9202_@@VCHSTRINGResult@Internal@Windows@@$$V@Internal@Windows@@UEAAJW4AsyncStage@23@JAEAVCHSTRINGResult@23@@Z @ 0x18001C440 (-Run@-$COperationLambdaVar@$0A@V_lambda_eb8e642fd6379236047631f6462c9202_@@VCHSTRINGResult@Inter.c)
 * Callees:
...
LABEL_125:
  ...
  if ( v29 >= 0 )
  {
    ...
    v66 = 0LL;
    v32 = *(_QWORD *)(Microsoft::WRL::Wrappers::HStringReference::HStringReference(&hstringHeader, &off_1800EAE60) + 24);
