/*
 * XREFs of _Toupper @ 0x1800BA654
 * Callers:
 *     ?do_toupper@?$ctype@D@std@@MEBADD@Z @ 0x1800B78A0 (-do_toupper@-$ctype@D@std@@MEBADD@Z.c)
 *     ?do_toupper@?$ctype@D@std@@MEBAPEBDPEADPEBD@Z @ 0x1800B78C0 (-do_toupper@-$ctype@D@std@@MEBAPEBDPEADPEBD@Z.c)
 * Callees:
