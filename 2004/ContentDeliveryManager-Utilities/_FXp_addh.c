/*
 * XREFs of _FXp_addh @ 0x1800B84A0
 * Callers:
 *     _FXp_addx @ 0x1800B87E8 (_FXp_addx.c)
 *     _FXp_mulh @ 0x1800B8914 (_FXp_mulh.c)
 *     _FXp_setn @ 0x1800B8C04 (_FXp_setn.c)
 * Callees:
 *     _FDscale @ 0x1800B82D0 (_FDscale.c)
 *     _Feraise @ 0x1800CC708 (_Feraise.c)
 *     _FDtest @ 0x1800CC73C (_FDtest.c)
 *     _FDint @ 0x1800CC78C (_FDint.c)
 *     _FDunscale @ 0x1800CC868 (_FDunscale.c)
 */
...
LABEL_51:
  ...
  else if ( v7 != 2 && ((HIWORD(v34) ^ *((_WORD *)a1 + 1)) & 0x8000u) != 0 )
  {
    Feraise(1);
    *a1 = FNan._Float;
    if ( (int)v5 > 1 )
