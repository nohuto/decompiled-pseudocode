/*
 * XREFs of ?put_EventName@TargetedContentTriggerStateTransitionImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@@Z @ 0x180062F40
 * Callers:
 *     <none>
 * Callees:
