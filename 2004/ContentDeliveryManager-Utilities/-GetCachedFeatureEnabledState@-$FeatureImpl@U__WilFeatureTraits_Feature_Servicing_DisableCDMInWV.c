/*
 * XREFs of ?GetCachedFeatureEnabledState@?$FeatureImpl@U__WilFeatureTraits_Feature_Servicing_DisableCDMInWVD_33202726@@@details@wil@@AEAA?ATwil_details_FeatureStateCache@@XZ @ 0x1800180DC
 * Callers:
...
signed __int32 *__fastcall wil::details::FeatureImpl<__WilFeatureTraits_Feature_Servicing_DisableCDMInWVD_33202726>::GetCachedFeatureEnabledState(
        wil::details *a1,
        signed __int32 *a2)
{
  ...
  *a2 = *(_DWORD *)a1;
  if ( (v2 & 3) != 3 )
  {
    ...
    if ( g_wil_details_internalGetFeatureEnabledState || (v6 = g_wil_details_apiGetFeatureEnabledState) != 0LL )
      v7 = ((__int64 (__fastcall *)(__int64, __int64, int *))v6)(33202726LL, 3LL, &v19);
    else
      v7 = 0;
    v21 = 0;
    v8 = v7 & 0xFFFFFF3F;
