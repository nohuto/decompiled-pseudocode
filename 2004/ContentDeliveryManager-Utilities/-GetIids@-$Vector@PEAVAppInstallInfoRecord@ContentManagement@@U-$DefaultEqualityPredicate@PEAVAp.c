 ...
 * Callers:
 *     ?GetIids@?$Vector@PEAVAppInstallInfoRecord@ContentManagement@@U?$DefaultEqualityPredicate@PEAVAppInstallInfoRecord@ContentManagement@@@Internal@Collections@Foundation@Windows@@U?$DefaultLifetimeTraits@PEAVAppInstallInfoRecord@ContentManagement@@@4567@U?$VectorOptions@PEAVAppInstallInfoRecord@ContentManagement@@$0A@$00$0A@@4567@@Internal@Collections@Foundation@Windows@@WBA@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x1800617E0 (-GetIids@-$Vector@PEAVAppInstallInfoRecord@ContentManagement@@U-$DefaultEqualityPre_ea_1800617E0.c)
 * Callees:
 *     <none>
 */
