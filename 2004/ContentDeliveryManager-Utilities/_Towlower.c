/*
 * XREFs of _Towlower @ 0x1800B1A20
 * Callers:
 *     ?do_tolower@?$ctype@_W@std@@MEBA_W_W@Z @ 0x18002A480 (-do_tolower@-$ctype@_W@std@@MEBA_W_W@Z.c)
 *     ?do_tolower@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x18002A4A0 (-do_tolower@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B9BBC (_GetLocaleHandleByColl.c)
 *     __crtLCMapStringW_Stub @ 0x1800B9CA0 (__crtLCMapStringW_Stub.c)
 */
