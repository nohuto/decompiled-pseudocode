 ...
 *     ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEAN@Z @ 0x1800B6600 (-do_get@-$num_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-A_ea_1800B6600.c)
 * Callees:
 *     _Stopfx @ 0x1800B7BEC (_Stopfx.c)
 *     _Stoflt @ 0x1800B7D28 (_Stoflt.c)
 *     _Stoxflt @ 0x1800B7FC4 (_Stoxflt.c)
 *     _Dscale @ 0x1800B8F14 (_Dscale.c)
 *     _Xp_addx @ 0x1800B94F0 (_Xp_addx.c)
 *     _Xp_mulx @ 0x1800B9818 (_Xp_mulx.c)
