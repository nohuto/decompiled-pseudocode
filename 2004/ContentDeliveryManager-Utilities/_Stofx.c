 ...
 *     ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MEBA?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AEAVios_base@2@AEAHAEAM@Z @ 0x1800B6500 (-do_get@-$num_get@DV-$istreambuf_iterator@DU-$char_traits@D@std@@@std@@@std@@MEBA-A_ea_1800B6500.c)
 * Callees:
 *     _Stopfx @ 0x1800B7BEC (_Stopfx.c)
 *     _Stoflt @ 0x1800B7D28 (_Stoflt.c)
 *     _Stoxflt @ 0x1800B7FC4 (_Stoxflt.c)
 *     _FDscale @ 0x1800B82D0 (_FDscale.c)
 *     _FXp_addx @ 0x1800B87E8 (_FXp_addx.c)
 *     _FXp_mulx @ 0x1800B8AFC (_FXp_mulx.c)
 *     _FXp_setn @ 0x1800B8C04 (_FXp_setn.c)
 *     _FXp_setw @ 0x1800B8C8C (_FXp_setw.c)
 *     _FDtento @ 0x1800B8D40 (_FDtento.c)
