/*
 * XREFs of ?Destroy@?$DestroyThreadPoolTimer@USystemThreadPoolMethods@details@wil@@$0A@@details@wil@@SAXPEAU_TP_TIMER@@@Z @ 0x180017A3C
 * Callers:
 ...
 *     ??_GEnabledStateManager@details@wil@@QEAAPEAXI@Z @ 0x18001748C (--_GEnabledStateManager@details@wil@@QEAAPEAXI@Z.c)
