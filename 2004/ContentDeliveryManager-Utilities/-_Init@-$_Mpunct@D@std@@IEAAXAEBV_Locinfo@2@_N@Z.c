/*
 * XREFs of ?_Init@?$_Mpunct@D@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x1800C9950
 * Callers:
 *     ?_Getcat@?$moneypunct@D$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800C8114 (-_Getcat@-$moneypunct@D$00@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 *     ?_Getcat@?$moneypunct@D$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z @ 0x1800C81FC (-_Getcat@-$moneypunct@D$0A@@std@@SA_KPEAPEBVfacet@locale@2@PEBV42@@Z.c)
 ...
 *     ??_U@YAPEAX_K@Z @ 0x1800B205C (--_U@YAPEAX_K@Z.c)
 *     ??$_Getvals@D@?$_Mpunct@D@std@@IEAAXDPEBUlconv@@@Z @ 0x1800C6FA4 (--$_Getvals@D@-$_Mpunct@D@std@@IEAAXDPEBUlconv@@@Z.c)
...
errno_t __fastcall std::_Mpunct<char>::_Init(__int64 a1, __int64 a2, char a3)
{
  ...
  *(_QWORD *)(a1 + 48) = 0LL;
  ...
  try
  {
    ...
    *(_QWORD *)(a1 + 16) = v10;
    std::_Mpunct<char>::_Getvals<char>(a1, 0LL, (__int64)v6);
  }
  catch ( ... )
  {
    std::_Mpunct<wchar_t>::_Tidy((void **)a1);
    throw;
  }
  v12 = *(_BYTE *)(a1 + 68);
  if ( v12 )
