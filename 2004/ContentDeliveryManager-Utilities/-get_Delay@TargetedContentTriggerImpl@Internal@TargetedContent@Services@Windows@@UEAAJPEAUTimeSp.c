/*
 * XREFs of ?get_Delay@TargetedContentTriggerImpl@Internal@TargetedContent@Services@Windows@@UEAAJPEAUTimeSpan@Foundation@5@@Z @ 0x180062730
 * Callers:
 *     <none>
 * Callees:
 *     <none>
