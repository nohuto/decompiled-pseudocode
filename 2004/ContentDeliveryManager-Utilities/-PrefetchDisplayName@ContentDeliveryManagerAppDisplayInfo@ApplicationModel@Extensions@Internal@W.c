/*
 * XREFs of ?PrefetchDisplayName@ContentDeliveryManagerAppDisplayInfo@ApplicationModel@Extensions@Internal@Windows@@AEAAXPEBG@Z @ 0x1800A1F48
 * Callers:
 ...
 *     ?_Initialize@?$NativeString@V?$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAJPEBG_K@Z @ 0x180059060 (-_Initialize@-$NativeString@V-$CoTaskMemPolicy@G@Internal@Windows@@@Internal@Windows@@AEAAJPEBG_.c)
 ...
 *     ??1MRTHelperBase@ShellMRTHelper@@QEAA@XZ @ 0x1800A1C34 (--1MRTHelperBase@ShellMRTHelper@@QEAA@XZ.c)
 */
