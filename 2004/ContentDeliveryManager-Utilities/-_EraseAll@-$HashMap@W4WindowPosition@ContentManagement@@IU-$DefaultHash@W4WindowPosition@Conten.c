 ...
 * Callees:
 *     ?ChangeVersion@TagManager@SecureVersionTag@XWinRT@@QEAAJXZ @ 0x18007E9BC (-ChangeVersion@TagManager@SecureVersionTag@XWinRT@@QEAAJXZ.c)
