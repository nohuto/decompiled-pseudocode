/*
 * XREFs of ?_Fput@?$num_put@_WV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@std@@@std@@AEBA?AV?$ostreambuf_iterator@_WU?$char_traits@_W@std@@@2@V32@AEAVios_base@2@_WPEBD_K444@Z @ 0x1800BCCA0
 * Callers:
 ...
 *     ?assign@?$basic_string@_WU?$char_traits@_W@std@@V?$allocator@_W@2@@std@@QEAAAEAV12@_K_W@Z @ 0x1800970B4 (-assign@-$basic_string@_WU-$char_traits@_W@std@@V-$allocator@_W@2@@std@@QEAAAEAV12@_K_W@Z.c)
        ...
        unsigned __int64 a10)
{
  ...
  *(_QWORD *)&v51 = strcspn(Str, (const char *)&Control);
  ...
  v53 = std::use_facet<std::ctype<wchar_t>>((__int64 *)&v53);
  if ( v15 )
  {
  ...
  v22 = std::use_facet<std::numpunct<wchar_t>>((__int64 *)&v53);
  if ( v21 )
  {
