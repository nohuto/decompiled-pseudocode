/*
 * XREFs of _Wcscoll @ 0x1800CCE58
 * Callers:
 *     ?do_compare@?$collate@_W@std@@MEBAHPEB_W000@Z @ 0x1800C3290 (-do_compare@-$collate@_W@std@@MEBAHPEB_W000@Z.c)
 * Callees:
 *     _GetLocaleHandleByColl @ 0x1800B9BBC (_GetLocaleHandleByColl.c)
 *     _GetLocaleHandleById @ 0x1800B9BC8 (_GetLocaleHandleById.c)
 *     __crtCompareStringW_Stub @ 0x1800B9C34 (__crtCompareStringW_Stub.c)
 */
