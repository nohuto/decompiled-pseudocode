  ...
  else if ( _InterlockedIncrement((volatile signed __int32 *)(a1 + 20)) == 1 )
  {
    ...
    *v6 = 0LL;
    ...
    if ( a2 )
    {
      ...
      AgileReference = RoGetAgileReference(0LL, &GUID_d2880150_cd62_5812_99d0_86f1a9e13d58, a2, v6);
    }
    else
    {
      *v6 = 0LL;
