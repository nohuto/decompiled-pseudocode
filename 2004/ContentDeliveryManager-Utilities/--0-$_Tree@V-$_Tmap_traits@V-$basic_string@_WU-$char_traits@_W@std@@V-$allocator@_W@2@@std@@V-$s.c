        ...
        __int64 a2)
{
  ...
  *a1 = v4;
  try
  {
    *(_QWORD *)(*a1 + 8) = std::_Tree<std::_Tmap_traits<std::wstring,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>,CreativeFramework::CommonHelper::Details::less,std::allocator<std::pair<std::wstring const,std::shared_ptr<CreativeFramework::CommonHelper::ISettingsContainer>>>,0>>::_Copy_nodes<std::integral_constant<bool,0>>(a1);
    a1[1] = *(_QWORD *)(a2 + 8);
    v5 = (_QWORD *)*a1;
    v6 = *(__int64 ***)(*a1 + 8);
    if ( *((_BYTE *)v6 + 25) )
