/*
 * XREFs of ?GetEntitlementForRecord@Actions@CreativeFramework@@YAXV?$com_ptr_t@UIAppManager@ContentManagement@@Uerr_exception_policy@wil@@@wil@@AEBQEB_W111_N@Z @ 0x180084E08
 * Callers:
 ...
 *     ?ReportUsage@?$FeatureImpl@U__WilFeatureTraits_Feature_InstallAttribution@@@details@wil@@QEAAX_NW4ReportingKind@3@_K@Z @ 0x18005CA94 (-ReportUsage@-$FeatureImpl@U__WilFeatureTraits_Feature_InstallAttribution@@@details@wil@@QEAAX_N.c)
 *     ?IsMsaConnected@Actions@CreativeFramework@@YA_NXZ @ 0x180084890 (-IsMsaConnected@Actions@CreativeFramework@@YA_NXZ.c)
 *     ??$ReportEntitlementAcquisitionState@AEBQEB_WAEBQEB_WAEA_NIAEBQEB_W@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAXAEBQEB_W0AEA_N$$QEAI0@Z @ 0x1800868D4 (--$ReportEntitlementAcquisitionState@AEBQEB_WAEBQEB_WAEA_NIAEBQEB_W@ContentDeliveryManagerTeleme.c)
 *     __security_check_cookie @ 0x1800CD6D0 (__security_check_cookie.c)
 *     _Init_thread_footer @ 0x1800CE9FC (_Init_thread_footer.c)
 *     _Init_thread_header @ 0x1800CEA6C (_Init_thread_header.c)
        ...
        char a6)
{
  ...
  if ( a6 )
    goto LABEL_5;
  if ( dword_1801994C0 > *(_DWORD *)(*((_QWORD *)NtCurrentTeb()->ThreadLocalStoragePointer + (unsigned int)tls_index)
                                   + 4LL) )
  {
    Init_thread_header(&dword_1801994C0);
    if ( dword_1801994C0 == -1 )
    {
      byte_1801994C4 = CreativeFramework::Actions::IsMsaConnected(v24);
      Init_thread_footer(&dword_1801994C0);
    }
  }
  if ( !byte_1801994C4 )
LABEL_5:
