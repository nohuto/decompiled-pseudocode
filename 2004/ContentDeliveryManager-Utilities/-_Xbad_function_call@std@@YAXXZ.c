/*
 * XREFs of ?_Xbad_function_call@std@@YAXXZ @ 0x1800B05D0
 * Callers:
 ...
 *     _lambda_e34527cb48b3e2822e62a7657f7a4fcf_::operator() @ 0x180078B74 (_lambda_e34527cb48b3e2822e62a7657f7a4fcf_--operator().c)
 *     std::_Func_impl_std::_Callable_obj__lambda_c4c3923748e77b314a455aaed0b87e40__0__std::allocator_std::_Func_class_bool_std::shared_ptr_CreativeFramework::CommonHelper::ISettingsContainer__CreativeFramework::Triggers::PropertySetHelper_&_std::_Nil_std::_Nil_std::_Nil_std::_Nil_std::_Nil____bool_std::shared_ptr_CreativeFramework::CommonHelper::ISettingsContainer__CreativeFramework::Triggers::PropertySetHelper_&_std::_Nil_std::_Nil_std::_Nil_std::_Nil_std::_Nil_::_Do_call @ 0x18007BC60 (std--_Func_impl_std--_Callable_obj__lambda_c4c3923748e77b314a455aaed0b87e40__0__std_ea_18007BC60.c)
 ...
 *     CreativeFramework::EnumerateTargetedContentTiles @ 0x1800A300C (CreativeFramework--EnumerateTargetedContentTiles.c)
 *     ?ExtractTargetedContentTilesInLayout@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramework@@AEAAXXZ @ 0x1800A5F54 (-ExtractTargetedContentTilesInLayout@LayoutResolver@TargetedContentLayoutHelpers@CreativeFramewo.c)
 * Callees:
 *     ??0bad_function_call@std@@QEAA@PEBD@Z @ 0x1800B0480 (--0bad_function_call@std@@QEAA@PEBD@Z.c)
