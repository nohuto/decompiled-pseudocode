/*
 * XREFs of ??0LaunchUriService@Actions@CreativeFramework@@QEAA@QEB_WPEB_W1AEBV?$com_ptr_t@U?$IMapView@W4WindowPosition@ContentManagement@@I@Collections@Foundation@Windows@@Uerr_exception_policy@wil@@@wil@@0_N@Z @ 0x18008D1EC
 * Callers:
        ...
        char a7)
{
  ...
  *(_WORD *)v10 = 0;
  ...
  std::wstring::assign((void **)v10, a2, v11);
  *(_QWORD *)(a1 + 64) = 7LL;
  *(_QWORD *)(a1 + 56) = 0LL;
  *(_WORD *)(a1 + 40) = 0;
  if ( *(_WORD *)a3 )
  ...
  std::wstring::assign((void **)(a1 + 40), a3, v12);
  *(_QWORD *)(a1 + 96) = 7LL;
  *(_QWORD *)(a1 + 88) = 0LL;
  *(_WORD *)(a1 + 72) = 0;
  if ( *(_WORD *)a4 )
  ...
  std::wstring::assign((void **)(a1 + 72), a4, v13);
  v14 = *a5;
  *(_QWORD *)(a1 + 104) = *a5;
  if ( v14 )
