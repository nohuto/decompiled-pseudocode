/*
 * XREFs of ?GetEdgeFaviconCache@@YA?AV?$com_ptr_t@UIStorageFolder@Storage@Windows@@Uerr_exception_policy@wil@@@wil@@XZ @ 0x18009AC00
 * Callers:
 ...
 *     ?GetStateHandle@CallerIdentity@@YAJPEBGPEAPEAX@Z @ 0x1800AB1C4 (-GetStateHandle@CallerIdentity@@YAJPEBGPEAPEAX@Z.c)
