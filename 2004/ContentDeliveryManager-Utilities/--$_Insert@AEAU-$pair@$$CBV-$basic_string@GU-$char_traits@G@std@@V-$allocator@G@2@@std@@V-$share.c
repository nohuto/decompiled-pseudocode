        ...
        _QWORD **a4)
{
  ...
  __int64 v44; // rdi
  _QWORD *iter; // rax
  _QWORD v46[10]; // [rsp+28h] [rbp-50h] BYREF
  ...
  v12 = (HIDWORD(v10) ^ v10) & a1[5];
  if ( a1[6] <= v12 )
    v12 += -1LL - ((unsigned __int64)a1[5] >> 1);
  v13 = 2 * v12;
  v14 = (_QWORD *)a1[2];
  if ( v14[v13] == *a1 )
    v15 = (_QWORD *)*a1;
  else
    v15 = *(_QWORD **)v14[v13 + 1];
  while ( 1 )
  {
    if ( v15 == (_QWORD *)v14[v13] )
      goto LABEL_52;
    v15 = (_QWORD *)v15[1];
    v16 = v15 + 2;
    v17 = v15[4];
...
LABEL_52:
    ...
    {
      v34 = (_QWORD *)v32[v13 + 1];
      v35 = (_QWORD **)*v34;
      v32[v13 + 1] = *v34;
      if ( v35 != a4 )
        *(_QWORD *)(a1[2] + 8 * v13 + 8) = *(_QWORD *)(*(_QWORD *)(a1[2] + 8 * v13 + 8) + 8LL);
    }
    v36 = a1[1];
    v37 = a1[6];
    if ( v36 < 0 )
    {
      v39 = a1[1] & 1 | ((unsigned __int64)v36 >> 1);
      v38 = (float)(int)v39 + (float)(int)v39;
    }
    else
    {
      v38 = (float)(int)v36;
    ...
    if ( (v37 & 0x8000000000000000uLL) != 0LL )
      v40 = (float)(int)(a1[6] & 1 | (v37 >> 1)) + (float)(int)(a1[6] & 1 | (v37 >> 1));
    else
      v40 = (float)(int)v37;
    if ( (float)(v38 / v40) > *((float *)a1 + 14) )
    {
      if ( v37 >= 0x200 )
      {
