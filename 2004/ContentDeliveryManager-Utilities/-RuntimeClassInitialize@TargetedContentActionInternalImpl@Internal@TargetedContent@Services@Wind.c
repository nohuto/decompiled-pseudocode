/*
 * XREFs of ?RuntimeClassInitialize@TargetedContentActionInternalImpl@Internal@TargetedContent@Services@Windows@@QEAAJW4ActionServices@Actions@CreativeFramework@@AEBUActionContext@78@PEAU?$IMapView@PEAUHSTRING__@@PEAU1@@Collections@Foundation@5@@Z @ 0x180052E94
 * Callers:
 *     ?CreateAction@TargetedContentActionStatics@Internal@TargetedContent@Services@Windows@@UEAAJPEAUHSTRING__@@PEAU?$IMapView@PEAUHSTRING__@@PEAU1@@Collections@Foundation@5@PEAPEAUITargetedContentActionInternal@2345@@Z @ 0x180052BE0 (-CreateAction@TargetedContentActionStatics@Internal@TargetedContent@Services@Windows@@UEAAJPEAUH.c)
 * Callees:
...
__int64 __fastcall Windows::Services::TargetedContent::Internal::TargetedContentActionInternalImpl::RuntimeClassInitialize(
        __int64 a1,
        unsigned int a2,
        __int64 a3,
        __int64 (***a4)(void))
{
  ...
  _QWORD *v30; // rcx
  __int64 v31; // rbx
  __int64 (__fastcall *v32)(__int64, HSTRING *); // rdi
  int v33; // eax
  ...
  __int64 v59; // rcx
  _QWORD *v60; // rcx
  __int64 **v61; // [rsp+30h] [rbp-A8h] BYREF
  __int64 v62; // [rsp+38h] [rbp-A0h]
  __int64 v63; // [rsp+40h] [rbp-98h] BYREF
  _QWORD *v64; // [rsp+48h] [rbp-90h]
  __int64 v65; // [rsp+50h] [rbp-88h] BYREF
  HSTRING string; // [rsp+58h] [rbp-80h] BYREF
  HSTRING v67; // [rsp+60h] [rbp-78h] BYREF
  _QWORD v68[4]; // [rsp+68h] [rbp-70h] BYREF
  char v69[8]; // [rsp+88h] [rbp-50h] BYREF
  volatile signed __int32 *v70; // [rsp+90h] [rbp-48h]
  char v71[16]; // [rsp+98h] [rbp-40h] BYREF
  char v72; // [rsp+A8h] [rbp-30h] BYREF
  wil::details::in1diag3 *retaddr; // [rsp+D8h] [rbp+0h]
  int v74; // [rsp+F8h] [rbp+20h] BYREF
  ...
  try
  {
    ...
    {
      v63 = 0LL;
      v11 = (*(__int64 (__fastcall **)(_QWORD *, __int64 *))(*v64 + 48LL))(v64, &v63);
      v12 = v11;
      if ( v11 >= 0 )
      {
        v15 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v63 + 56LL))(v63, &v74);
        v16 = v15;
        if ( v15 >= 0 )
        {
          v62 = 0LL;
          v61 = (__int64 **)std::_Tree_alloc<0,std::_Tree_base_types<std::pair<std::wstring const,std::wstring>>>::_Buyheadnode();
          while ( (_BYTE)v74 )
          {
            v65 = 0LL;
            v19 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v63 + 48LL))(v63, &v65);
            v20 = v19;
            if ( v19 < 0 )
            {
            ...
            string = 0LL;
            v24 = v65;
            v25 = *(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v65 + 48LL);
            ...
            v67 = 0LL;
            v31 = v65;
            v32 = *(__int64 (__fastcall **)(__int64, HSTRING *))(*(_QWORD *)v65 + 56LL);
            WindowsDeleteString(0LL);
            v67 = 0LL;
            v33 = v32(v31, &v67);
            v34 = v33;
            ...
            StringRawBuffer = WindowsGetStringRawBuffer(v67, 0LL);
            v68[3] = StringRawBuffer;
            v68[0] = WindowsGetStringRawBuffer(string, 0LL);
            v68[1] = StringRawBuffer;
            v39 = std::_Tree_buy<std::pair<std::wstring const,std::wstring>>::_Buynode<std::pair<unsigned short const *,unsigned short const *>>(
                    &v61,
                    v68);
            std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Insert_nohint<std::pair<std::wstring const,std::wstring> &,std::_Tree_node<std::pair<std::wstring const,std::wstring>,void *> *>(
              ...
              (_QWORD *)(v39 + 32),
              v39);
            v41 = (*(__int64 (__fastcall **)(__int64, int *))(*(_QWORD *)v63 + 64LL))(v63, &v74);
            v42 = v41;
            if ( v41 < 0 )
            {
              wil::details::in1diag3::Return_Hr(
          ...
          ActionService = CreativeFramework::Actions::GetActionService(v69, a2, a3, &v61);
          v48 = 0LL;
          v49 = 0LL;
          if ( &v72 != (char *)ActionService )
          {
            v48 = *(_QWORD *)(ActionService + 8);
            *(_QWORD *)(ActionService + 8) = 0LL;
            v49 = *(_QWORD *)ActionService;
            *(_QWORD *)ActionService = 0LL;
          }
          v50 = *(volatile signed __int32 **)(a1 + 80);
          *(_QWORD *)(a1 + 80) = v48;
          *(_QWORD *)(a1 + 72) = v49;
          if ( v50 )
          {
          ...
          if ( (__int64 ***)(a1 + 88) != &v61 )
          {
            ...
            *(_QWORD *)(a1 + 96) = 0LL;
            LOBYTE(v53) = v74;
            *(_QWORD *)(*v52 + 8LL) = std::_Tree<std::_Tmap_traits<std::wstring,std::wstring,std::less<std::wstring>,std::allocator<std::pair<std::wstring const,std::wstring>>,0>>::_Copy_nodes<std::integral_constant<bool,0>>(
                                        a1 + 88,
                                        v61[1],
                                        *v52,
                                        v53);
            *(_QWORD *)(a1 + 96) = v62;
            ...
            {
              for ( i = *v55; !*((_BYTE *)i + 25); i = (__int64 *)*i )
                v55 = (__int64 **)i;
              *v54 = v55;
              v57 = *(_QWORD *)(*v52 + 8LL);
              for ( j = *(_QWORD *)(v57 + 16); !*(_BYTE *)(j + 25); j = *(_QWORD *)(j + 16) )
                v57 = j;
              *(_QWORD *)(*v52 + 16LL) = v57;
            }
          }
