/*
 * XREFs of _Towupper @ 0x1800B2068
 * Callers:
 *     ?do_toupper@?$ctype@G@std@@MEBAGG@Z @ 0x18002A510 (-do_toupper@-$ctype@G@std@@MEBAGG@Z.c)
 *     ?do_toupper@?$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z @ 0x18002A530 (-do_toupper@-$ctype@_W@std@@MEBAPEB_WPEA_WPEB_W@Z.c)
 * Callees:
