/*
 * XREFs of ?GetCacheEntry@Details@WRL@Microsoft@@YAJPEAVModuleBase@123@PEAIAEBU_GUID@@PEBUCreatorMap@123@PEAPEAUIUnknown@@@Z @ 0x18002485C
 * Callers:
 *     DllGetClassObject @ 0x1800258E0 (DllGetClassObject.c)
 *     DllGetActivationFactory @ 0x180025A10 (DllGetActivationFactory.c)
 * Callees:
