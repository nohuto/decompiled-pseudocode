/*
 * XREFs of RtlRestoreContext @ 0x1800A1170
 * Callers:
...
void __cdecl RtlRestoreContext(PCONTEXT ContextRecord, struct _EXCEPTION_RECORD *ExceptionRecord)
{
  ...
  __int64 v42; // [rsp+628h] [rbp+138h]

  if ( !ExceptionRecord )
  {
LABEL_6:
    if ( (*((_QWORD *)&xmmword_18017F390 + 1) & 0x1000000000000000LL) == 0
      && (*((_QWORD *)&xmmword_18017F390 + 1) & 0x1000LL) == 0
