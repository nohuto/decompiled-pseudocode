 ...
 *     RtlpCompareProtectedPolicyEntry @ 0x180075B80 (RtlpCompareProtectedPolicyEntry.c)
 *     RtlSidHashLookup @ 0x180077A70 (RtlSidHashLookup.c)
 *     RtlpCheckDynamicTimeZoneInformation @ 0x18007B4B0 (RtlpCheckDynamicTimeZoneInformation.c)
 *     EtwpGuidEntryCompare @ 0x180082658 (EtwpGuidEntryCompare.c)
 ...
 *     RtlpStackDbEntryIsEqual @ 0x180118F5C (RtlpStackDbEntryIsEqual.c)
