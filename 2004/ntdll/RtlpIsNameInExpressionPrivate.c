/*
 * XREFs of RtlpIsNameInExpressionPrivate @ 0x1800FB38C
 * Callers:
 ...
 *     RtlDoesNameContainWildCards @ 0x1800FB1B0 (RtlDoesNameContainWildCards.c)
...
char __fastcall RtlpIsNameInExpressionPrivate(unsigned __int16 *a1, unsigned __int16 *a2, char a3, char a4, __int64 a5)
{
  ...
  _QWORD v61[2]; // [rsp+60h] [rbp-88h] BYREF
    ...
    do
    {
      ...
      while ( 1 )
      {
        while ( 1 )
        {
          ...
          {
            v60 = *v8 >> 1;
            Heap = (char *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, 8LL * (unsigned int)(v60 + 1));
            v9 = (__int64)Heap;
            if ( !Heap )
