/*
 * XREFs of LdrQueryProcessModuleInformationEx2 @ 0x1800CE118
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  while ( v9 < (unsigned __int64)(a2 & 1) + 1 )
  {
    ...
    v29 = a2 & 2;
    if ( (a2 & 2) != 0 )
      off_18011CC60[5 * v9 + 3]();
    Memory = ((__int64 (__fastcall *)(_QWORD *, __int64 *, __int64 *))off_18011CC60[5 * v9])(v6, &v25, &v28);
    if ( Memory < 0 )
    {
LABEL_14:
      v8 = Memory;
    ...
    if ( v25 )
    {
      Memory = ((__int64 (__fastcall *)(_QWORD *, __int64, __int64 *))off_18011CC60[5 * v9 + 1])(v6, v25, &v21);
      if ( Memory < 0 )
        goto LABEL_14;
      while ( v21 != v25 )
      {
        ...
        {
          *v5 = 320;
          Memory = ((__int64 (__fastcall *)(_QWORD *, _WORD *, __int64, __int64, __int64))off_18011CC60[5 * v9 + 2])(
                     v6,
                     v5 + 4,
                     v21,
                     v28,
        ...
        Memory = ((__int64 (__fastcall *)(_QWORD *, __int64, __int64 *))off_18011CC60[5 * v9 + 1])(v6, v21, &v21);
        if ( Memory < 0 )
          goto LABEL_14;
      }
    }
LABEL_36:
    if ( v29 )
      ((void (__fastcall *)(__int64 (__fastcall **)(), __int64, _QWORD))off_18011CC60[5 * v9 + 4])(
        off_18011CC60,
        v14,
        0LL);
    v10 = a5;
