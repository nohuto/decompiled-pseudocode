/*
 * XREFs of RtlNtStatusToDosErrorNoTeb @ 0x1800758E0
 * Callers:
...
ULONG __cdecl RtlNtStatusToDosErrorNoTeb(NTSTATUS Status)
{
  ...
  if ( (Status & 0x20000000) == 0 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( v7 < (unsigned __int8)byte_18012F064[8 * v5] )
        {
          v8 = (unsigned __int16)word_18012F066[4 * v5];
          if ( byte_18012F065[8 * v5] == 1 )
