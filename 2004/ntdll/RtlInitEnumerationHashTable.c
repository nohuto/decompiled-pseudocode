/*
 * XREFs of RtlInitEnumerationHashTable @ 0x180067510
 * Callers:
 *     RtlInitWeakEnumerationHashTable @ 0x1800F59B0 (RtlInitWeakEnumerationHashTable.c)
 * Callees:
 *     RtlpPopulateContext @ 0x18006769C (RtlpPopulateContext.c)
 */
