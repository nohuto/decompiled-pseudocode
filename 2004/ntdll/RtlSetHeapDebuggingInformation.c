/*
 * XREFs of RtlSetHeapDebuggingInformation @ 0x1800F2908
 * Callers:
...
__int64 __fastcall RtlSetHeapDebuggingInformation(_DWORD *HeapHandle, __int64 a2)
{
  ...
  {
    dword_180168DCC = *(_DWORD *)(a2 + 12);
    xmmword_180168DE0 = *(_OWORD *)(a2 + 32);
    *((_QWORD *)&xmmword_180168DD0 + 1) = *(_QWORD *)(a2 + 24);
    LODWORD(xmmword_180168DD0) = *(_DWORD *)(a2 + 16);
