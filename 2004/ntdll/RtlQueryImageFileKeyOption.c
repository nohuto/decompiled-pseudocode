/*
 * XREFs of RtlQueryImageFileKeyOption @ 0x18007A3A0
 * Callers:
...
__int64 __fastcall RtlQueryImageFileKeyOption(__int64 a1, __int64 a2, int a3, int *a4, unsigned int a5, int *a6)
{
  __int64 result; // rax
