/*
 * XREFs of CsrpConnectToServer @ 0x180008FE4
 * Callers:
 ...
 *     NtOpenSection @ 0x18009D4F0 (NtOpenSection.c)
 *     NtCreateSection @ 0x18009D750 (NtCreateSection.c)
 *     ZwConnectPort @ 0x18009E200 (ZwConnectPort.c)
...
__int64 __fastcall CsrpConnectToServer(_WORD *Src, int a2, __int64 *a3, int a4, _DWORD *a5)
{
  ...
  if ( v11 > 0xFFFF )
    return 3221225734LL;
  word_18016AC22 = 2 * v9 + 28;
  Heap = (char *)RtlAllocateHeap(CsrHeap, (unsigned int)NtdllBaseTag, v11);
  qword_18016AC28 = (__int64)Heap;
  v13 = Heap;
  if ( !Heap )
    return 3221225495LL;
  ...
  *((_WORD *)v14 + 12) = aSharedsection[12];
  v36 = 48;
  CsrPortName = (_WORD)v14 - qword_18016AC28 + 26;
  v38 = &CsrPortName;
  v37 = 0LL;
  v39 = 64;
  v40 = 0LL;
  ...
  if ( v15 < 0 )
  {
    RtlFreeHeap(CsrHeap, 0LL, qword_18016AC28);
    return (unsigned int)v15;
  }
  *(_QWORD *)v14 = *(_QWORD *)L"ApiPort";
  *((_DWORD *)v14 + 2) = *(_DWORD *)L"ort";
  *((_WORD *)v14 + 6) = aApiport[6];
  CsrPortName = (_WORD)v14 - qword_18016AC28 + 14;
  v46 = 2;
  v47 = 257;
  v23 = 0x10000LL;
