/*
 * XREFs of RtlpHpTagContextGetTag @ 0x18009C754
 * Callers:
...
__int64 __fastcall RtlpHpTagContextGetTag(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( SubProcessTag == (void *)RtlpHpNullGUID )
    v4 = *((_QWORD *)&v16 + 1) - qword_18016B5D0;
  if ( !v4 )
    return 0LL;
  if ( word_180168B24 )
  {
    v6 = *(_QWORD *)(qword_180168B18 + 8LL * (unsigned __int16)word_180168B24 - 8);
