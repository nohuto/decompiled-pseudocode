/*
 * XREFs of RtlpWalkHeap @ 0x1800F4B8C
 * Callers:
 *     RtlpWalkHeapInternal @ 0x180002560 (RtlpWalkHeapInternal.c)
 * Callees:
 *     RtlGetCurrentServiceSessionId @ 0x180024850 (RtlGetCurrentServiceSessionId.c)
 *     _guard_dispatch_icall_nop @ 0x1800A08F0 (_guard_dispatch_icall_nop.c)
 *     RtlpGetExtraStuffPointerUnsafe @ 0x1800F3C84 (RtlpGetExtraStuffPointerUnsafe.c)
 ...
 *     RtlpWalkLowFragHeapSegment @ 0x18010C130 (RtlpWalkLowFragHeapSegment.c)
 */
...
__int64 __fastcall RtlpWalkHeap(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  if ( (*(_DWORD *)(a1 + 116) & 0x1000000) != 0 )
    return ((__int64 (*)(void))qword_180164A08)();
