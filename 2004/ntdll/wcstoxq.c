/*
 * XREFs of wcstoxq @ 0x18008DF74
 * Callers:
 *     _wcstoi64 @ 0x18008DF10 (_wcstoi64.c)
 *     _wcstoui64 @ 0x18008DF40 (_wcstoui64.c)
 * Callees:
 *     _errno @ 0x180085310 (_errno.c)
 *     _invalid_parameter @ 0x18008C168 (_invalid_parameter.c)
 *     _iswctype_l @ 0x18008FB80 (_iswctype_l.c)
 *     _wchartodigit @ 0x180093B88 (_wchartodigit.c)
 */
