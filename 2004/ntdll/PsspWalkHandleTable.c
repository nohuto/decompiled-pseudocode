/*
 * XREFs of PsspWalkHandleTable @ 0x180115FB4
 * Callers:
 ...
 *     ZwQueryObject @ 0x18009D010 (ZwQueryObject.c)
...
LABEL_19:
    ...
    if ( (a4 & 0x20) != 0 )
    {
      v15 = (const wchar_t **)&off_18011D230;
      ...
      v16 = 3LL * v7;
      if ( ((int (__fastcall *)(HANDLE, _BYTE *, __int64, int *, _QWORD, _DWORD, int))*(&off_18011D230 + v16 + 1))(
             Handle,
             v25,
             64LL,
             &v17,
