/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x1800509A8
 * Callers:
 *     DbgPrintEx @ 0x1800502F0 (DbgPrintEx.c)
 *     DbgPrint @ 0x180050960 (DbgPrint.c)
 *     LdrpLogDbgPrint @ 0x1800CDAE8 (LdrpLogDbgPrint.c)
 *     DbgPrintReturnControlC @ 0x1800E0890 (DbgPrintReturnControlC.c)
 *     vDbgPrintEx @ 0x1800E0950 (vDbgPrintEx.c)
 *     vDbgPrintExWithPrefix @ 0x1800E0980 (vDbgPrintExWithPrefix.c)
 * Callees:
 *     RtlRaiseException @ 0x180051020 (RtlRaiseException.c)
 *     __security_check_cookie @ 0x18008C240 (__security_check_cookie.c)
 *     _vsnprintf @ 0x18008DAA0 (_vsnprintf.c)
 *     ZwQueryDebugFilterState @ 0x18009F620 (ZwQueryDebugFilterState.c)
 *     DbgBreakPointWithStatus @ 0x1800A0930 (DbgBreakPointWithStatus.c)
 *     DebugPrint @ 0x1800A0940 (DebugPrint.c)
