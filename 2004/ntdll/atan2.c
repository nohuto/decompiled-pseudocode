...
LABEL_32:
    ...
    else
    {
      ...
      v27 = qword_1801230F0[v26];
      v28 = qword_180122960[v26];
    ...
    if ( v23 )
    {
      v28 = *(double *)&qword_180164B08 - v28;
      v25 = *(double *)&qword_180164B10 - v25;
    }
    if ( X < 0.0 )
    {
      v28 = *(double *)&qword_180164AF8 - v28;
      v25 = *(double *)&qword_180164B00 - v25;
    }
    v33 = v28 + v25;
    if ( v3 < 0.0 )
      *(_QWORD *)&v33 ^= _xmm;
