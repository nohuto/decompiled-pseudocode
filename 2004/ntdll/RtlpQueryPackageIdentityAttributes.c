        ...
        _QWORD *a5)
{
  ...
  {
    *v5 |= (2LL * v9) | 1;
    if ( ZwQuerySecurityAttributesToken(TokenHandle, (PUNICODE_STRING)&stru_18011C480, 1u, 0LL, 0, &ReturnLength) == -1073741789 )
      *v5 |= 4uLL;
    if ( ZwQuerySecurityAttributesToken(TokenHandle, (PUNICODE_STRING)&stru_18011C470, 1u, 0LL, 0, &ReturnLength) == -1073741789 )
      *v5 |= 8uLL;
  }
  return 0;
}
