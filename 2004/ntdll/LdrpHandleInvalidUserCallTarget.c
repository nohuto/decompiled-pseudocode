/*
 * XREFs of LdrpHandleInvalidUserCallTarget @ 0x18008C4D0
 * Callers:
 ...
 *     LdrpDispatchUserCallTarget @ 0x18008C630 (LdrpDispatchUserCallTarget.c)
 *     LdrpDispatchUserCallTargetES @ 0x18008C680 (LdrpDispatchUserCallTargetES.c)
 * Callees:
