/*
 * XREFs of ?RtlpFlsFree@@YAJPEAU_RTLP_FLS_CONTEXT@@K@Z @ 0x180073580
 * Callers:
 *     RtlFlsFree @ 0x180073570 (RtlFlsFree.c)
 * Callees:
...
__int64 __fastcall RtlpFlsFree(struct _RTLP_FLS_CONTEXT *a1, int a2)
{
  ...
  while ( 2 )
  {
    ...
    for ( i = (__int64 *)qword_18016B2F8; i != &qword_18016B2F8 && (unsigned int)v10 < 0x10; i = (__int64 *)*i )
    {
      if ( !Value )
        goto LABEL_17;
...
LABEL_17:
  ...
  v7[1].Value = 0LL;
  RTL_BINARY_ARRAY<RTLP_FLS_CALLBACK_ENTRY,8,4>::SlotFree(&xmmword_18016B2B8, v2);
