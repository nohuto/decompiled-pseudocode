/*
 * XREFs of LdrRegisterDllNotification @ 0x180084AF0
 * Callers:
...
__int64 __fastcall LdrRegisterDllNotification(int a1, __int64 a2, __int64 a3, __int64 *a4)
{
  ...
  *(_QWORD *)(Heap + 24) = a3;
  ...
  v11 = (__int64 *)off_180164568[0];
  if ( *(_UNKNOWN ***)off_180164568[0] != &LdrpDllNotificationList )
    __fastfail(3u);
  *(_QWORD *)v8 = &LdrpDllNotificationList;
  *(_QWORD *)(v8 + 8) = v11;
  *v11 = v8;
  off_180164568[0] = (_UNKNOWN **)v8;
