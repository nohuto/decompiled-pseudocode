/*
 * XREFs of NormBuffer__LastStartBasePair @ 0x1800FF5F8
 * Callers:
 ...
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x1800FFF5C (Normalization__GetSecondDecomposedCharPlane0.c)
 */
