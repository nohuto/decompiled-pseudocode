/*
 * XREFs of RtlSetSearchPathMode @ 0x18007F980
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlSetSearchPathMode(int a1, unsigned __int64 a2, unsigned __int64 a3, unsigned __int64 a4)
{
  ...
  if ( (a1 & 0x18000) != 0x10000 )
    return 3221225485LL;
LABEL_4:
  RtlAcquireSRWLockExclusive((unsigned __int64)&qword_18016B4D0, a2, a3, a4);
  ...
  RtlReleaseSRWLockExclusive(&qword_18016B4D0);
  if ( v5 >= 0 )
  {
