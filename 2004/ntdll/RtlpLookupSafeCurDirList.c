/*
 * XREFs of RtlpLookupSafeCurDirList @ 0x1800DEEEC
 * Callers:
  ...
  *(_DWORD *)&ValueName.Length = 0x2000000;
  if ( qword_1801677C0 == -1 )
  {
    ...
    if ( Heap )
    {
      Heap[1] = Heap;
      *Heap = Heap;
      KeyHandle = qword_18016B7A8;
      v3 = qword_18016B7A8;
      if ( !qword_18016B7A8 )
      {
        v4 = NtOpenKey(&KeyHandle, 1u, (POBJECT_ATTRIBUTES)&stru_18011D528);
        v5 = (signed __int64)KeyHandle;
        if ( v4 < 0 )
          v5 = -1LL;
        KeyHandle = (HANDLE)v5;
        v3 = (HANDLE)_InterlockedCompareExchange64((volatile signed __int64 *)&qword_18016B7A8, v5, 0LL);
        if ( v3 )
        {
          if ( v4 >= 0 )
            NtClose(KeyHandle);
      ...
      if ( v3 != (HANDLE)-1LL
        && NtQueryValueKey(
             v3,
             (PUNICODE_STRING)&stru_18011D508,
        ...
        && ResultLength[0] == 16
        && v21 == 1
        || RtlQueryEnvironmentVariable_U(0LL, (PUNICODE_STRING)&stru_18011D518, &Value) >= 0
...
LABEL_29:
    ...
    v11 = _InterlockedCompareExchange64(&qword_1801677C0, (signed __int64)v2, -1LL);
    if ( v11 == -1 )
    {
      return (__int64)v2;
    }
