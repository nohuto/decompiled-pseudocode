...
__int64 RtlpLookupSafeCurDirList()
{
  ...
  if ( qword_1801677C0 == -1 )
  {
      ...
      *Heap = Heap;
      ...
      if ( !qword_18016B7A8 )
      {
        ...
        if ( v4 < 0 )
          v5 = -1LL;
        Handle = (HANDLE)v5;
        v3 = _InterlockedCompareExchange64(&qword_18016B7A8, v5, 0LL);
        if ( v3 )
        {
          if ( v4 >= 0 )
            NtClose((HANDLE)v5);
      ...
      if ( (v3 != -1 && (int)NtQueryValueKey() >= 0 && v13 == 16 && v21 == 1
         || (int)RtlQueryEnvironmentVariable_U(0LL, &qword_18011D518, (__int64)&v15) >= 0
    ...
    v9 = _InterlockedCompareExchange64(&qword_1801677C0, (signed __int64)v2, -1LL);
    if ( v9 == -1 )
    {
      return (__int64)v2;
    }
