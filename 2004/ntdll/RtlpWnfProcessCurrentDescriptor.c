/*
 * XREFs of RtlpWnfProcessCurrentDescriptor @ 0x18006286C
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  v9 = *(_QWORD **)(qword_18016B228 + 16);
  if ( v9 == (_QWORD *)(qword_18016B228 + 16) )
    goto LABEL_5;
  v10 = *(_QWORD *)(a1 + 8);
  v23 = v10;
  while ( 1 )
...
LABEL_39:
    ...
    v6 = 128;
LABEL_5:
    RtlReleaseSRWLockShared((volatile signed __int64 *)(qword_18016B228 + 8));
    goto LABEL_23;
  }
  if ( v5 )
  {
  ...
  if ( v6 )
  {
    ...
    for ( *((_DWORD *)v11 + 32) = 2; v19 != v13; v19 = (__int64 *)*v19 )
    {
      if ( (*((_BYTE *)v19 + 52) & 4) != 0 && *((_DWORD *)v19 + 28) )
      {
        if ( !v21 || v21 > v19[15] )
          v21 = v19[15];
        if ( *((_DWORD *)v19 + 32) < *(_DWORD *)(qword_18016B228 + 72) )
          v20 = 0;
      }
    }
    v11[17] = v21;
