...
__int64 __fastcall RtlpWnfProcessCurrentDescriptor(_WNF_STATE_NAME *BaseAddress, int a2)
{
  ...
  v6 = *(_QWORD **)(qword_18016B228 + 16);
  if ( v6 == (_QWORD *)(qword_18016B228 + 16) )
    goto LABEL_4;
  while ( 1 )
  {
    v7 = v6 - 4;
...
LABEL_38:
    ...
    v4 = 128;
LABEL_4:
    RtlReleaseSRWLockShared((PRTL_SRWLOCK)(qword_18016B228 + 8));
    goto LABEL_22;
  }
  if ( a2 )
  {
  ...
  if ( v4 )
  {
    ...
    for ( *((_DWORD *)v7 + 32) = 2; v12 != v9; v12 = (__int64 *)*v12 )
    {
      if ( (*((_BYTE *)v12 + 52) & 4) != 0 && *((_DWORD *)v12 + 28) )
      {
        if ( !v14 || v14 > v12[15] )
          v14 = v12[15];
        if ( *((_DWORD *)v12 + 32) < *(_DWORD *)(qword_18016B228 + 72) )
          v13 = 0;
      }
    }
    v7[17] = v14;
