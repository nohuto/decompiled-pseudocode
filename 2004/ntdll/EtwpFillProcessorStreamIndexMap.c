/*
 * XREFs of EtwpFillProcessorStreamIndexMap @ 0x180058810
 * Callers:
...
__int64 __fastcall EtwpFillProcessorStreamIndexMap(__int64 a1, unsigned __int16 a2, __int64 a3, unsigned int a4)
{
  ...
  {
    v16 = 0;
    for ( *(_QWORD *)(Heap + 8LL * v14) = v12 + 2LL * v13; (unsigned int)v16 < *(_DWORD *)(j + a3 + 44); ++v16 )
    {
      v17 = v13;
      *(_WORD *)(v12 + 2LL * v13) = v13;
      ++v13;
      *(_WORD *)(*(_QWORD *)(a1 + 552) + 4 * v17) = v14;
      *(_WORD *)(*(_QWORD *)(a1 + 552) + 4 * v17 + 2) = v16;
    }
    ++v14;
  }
  *(_DWORD *)(a1 + 496) = v14;
