/*
 * XREFs of EvtIntReportEventWorker @ 0x18004ED30
 * Callers:
 *     EvtIntReportEventAndSourceAsync @ 0x18004ECC0 (EvtIntReportEventAndSourceAsync.c)
 *     EvtIntReportAuthzEventAndSourceAsync @ 0x180111670 (EvtIntReportAuthzEventAndSourceAsync.c)
 * Callees:
 ...
 *     _local_unwind @ 0x18008D010 (_local_unwind.c)
 */
        ...
        __int64 a11)
{
  ...
  int v43; // [rsp+88h] [rbp-250h] BYREF
  char v44; // [rsp+8Ch] [rbp-24Ch]
  char v45; // [rsp+8Dh] [rbp-24Bh]
  __int16 v46; // [rsp+8Eh] [rbp-24Ah]
  unsigned __int64 v47; // [rsp+90h] [rbp-248h]
  ...
  if ( v13 )
  {
    ...
    {
      v34 = 87;
      local_unwind(v42, &loc_18004F086);
      goto LABEL_29;
    }
  ...
  *(_QWORD *)&Heap[8 * v25 + 8] = 4LL;
  ...
  if ( !v38 )
  {
    v29 = EtwpEventWriteFull(v41, (unsigned int)&v43, 0, 0, 4, 0LL, 0LL, v23, (__int64)Heap);
    goto LABEL_30;
  }
LABEL_29:
  v29 = EtwWriteUMSecurityEvent(&v43, 4LL, v23, Heap);
LABEL_30:
  v34 = v29;
  if ( Heap != v48 )
