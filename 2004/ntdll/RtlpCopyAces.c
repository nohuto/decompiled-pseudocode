/*
 * XREFs of RtlpCopyAces @ 0x18003D288
 * Callers:
 *     RtlpInheritAcl2 @ 0x18003A094 (RtlpInheritAcl2.c)
 *     RtlpComputeMergedAcl2 @ 0x1800E72F0 (RtlpComputeMergedAcl2.c)
 * Callees:
        ...
        __int64 a14)
{
  ...
  void *v36; // [rsp+90h] [rbp-59h] BYREF
  __int64 v37; // [rsp+98h] [rbp-51h]
...
LABEL_26:
        ...
        if ( !v23 || v35[0] )
        {
          ...
          if ( (unsigned int)v26 > 0xFFFF )
            return 3221225597LL;
          if ( *(unsigned __int16 *)(v18 + 2) > a14 + *(unsigned __int16 *)(a14 + 2) - (_QWORD)v25 )
          {
            v14 = 1;
          }
          else if ( !v14 )
      ...
      else
      {
        ...
        if ( !v21 || v26 > a14 + *(unsigned __int16 *)(a14 + 2) - (_QWORD)v21 )
        {
          v14 = 1;
          goto LABEL_24;
        }
        ...
        {
          RtlMapGenericMask(v21 + 1, (_DWORD *)v37);
          if ( *(_BYTE *)v21 <= 0xAu && (v31 = 1651, _bittest(&v31, *(unsigned __int8 *)v21)) )
            v32 = *(_DWORD *)(v37 + 12);
          else
            v32 = *(_DWORD *)(v37 + 12) | 0x1000000;
          v21[1] &= v32;
        }
        *((_BYTE *)v21 + 1) &= ~a4;
        ++*(_WORD *)(a14 + 4);
...
LABEL_25:
      v21 = (int *)((char *)v21 + (unsigned int)v26);
      goto LABEL_26;
    }
