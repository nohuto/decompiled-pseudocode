 ...
 *     RtlQueryInformationActiveActivationContext @ 0x18007E360 (RtlQueryInformationActiveActivationContext.c)
 * Callees:
 ...
 *     RtlpQueryInformationActivationContextManifestResourceName @ 0x1800DFFB0 (RtlpQueryInformationActivationContextManifestResourceName.c)
 */
...
LABEL_57:
  ...
  if ( (a1 & 7) != 2 )
  {
    if ( (a1 & 7) == 4 )
    {
      ...
      if ( (unsigned __int64)a2 < *((_QWORD *)&xmmword_18017F510 + 1)
        || (unsigned __int64)a2 >= *((_QWORD *)&xmmword_18017F510 + 1) + (unsigned __int64)(unsigned int)qword_18017F520 )
      {
