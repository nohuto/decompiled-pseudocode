 ...
 *     RtlpInterlockedFlushSList @ 0x1800A0A20 (RtlpInterlockedFlushSList.c)
 ...
 *     RtlpGetReservedBlockSize @ 0x18010B630 (RtlpGetReservedBlockSize.c)
...
LABEL_105:
    ...
    {
      v37 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016BC20, 2 * ((v8 - qword_18016BC18) >> 20));
