/*
 * XREFs of RtlDispatchException @ 0x180051210
 * Callers:
 ...
 *     RtlpExecuteHandlerForException @ 0x1800A2170 (RtlpExecuteHandlerForException.c)
 *     RtlpLogExceptionDispatch @ 0x1801009A8 (RtlpLogExceptionDispatch.c)
