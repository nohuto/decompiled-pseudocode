/*
 * XREFs of RtlInitializeHistoryTable @ 0x180078B5C
 * Callers:
 ...
 *     RtlpFunctionAddressTableEntry @ 0x180078C34 (RtlpFunctionAddressTableEntry.c)
 */
...
void RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v5 + 6] = v4;
    v9 = qword_18017F428;
    if ( v7 < qword_18017F428 )
      v9 = v7;
    qword_18017F428 = v9;
    v10 = qword_18017F430;
    if ( v8 > qword_18017F430 )
      v10 = v8;
    qword_18017F430 = v10;
  }
