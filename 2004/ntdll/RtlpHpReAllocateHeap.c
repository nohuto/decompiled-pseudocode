        ...
        _WORD *a6)
{
  ...
  if ( !dword_1801649B8 )
  {
    v10 = *(_QWORD *)(a1 + 48);
    v11 = v10;
    if ( (v10 || (v11 = qword_180168688) != 0) && a4 > v11 )
    {
      v86 = *(_QWORD *)(a1 + 56);
      if ( v86 )
  ...
  {
    v82 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016BC20, 2 * ((a3 - qword_18016BC18) >> 20));
...
LABEL_28:
  ...
  {
    if ( v92
      || (v50 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016BC20, 2 * ((a3 - qword_18016BC18) >> 20))) != 0
...
LABEL_82:
  ...
  if ( v92
    || (v83 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016BC20, 2 * ((a3 - qword_18016BC18) >> 20))) != 0
