        ...
        _WORD *a6)
{
  ...
  {
    v82 = RtlCSparseBitmapBitmaskRead((__int64)&BaseAddress, 2 * ((a3 - qword_18016BC18) >> 20));
...
LABEL_28:
  ...
  {
    if ( v92
      || (v50 = RtlCSparseBitmapBitmaskRead((__int64)&BaseAddress, 2 * ((a3 - qword_18016BC18) >> 20))) != 0
...
LABEL_82:
  ...
  if ( v92
    || (v83 = RtlCSparseBitmapBitmaskRead((__int64)&BaseAddress, 2 * ((a3 - qword_18016BC18) >> 20))) != 0
