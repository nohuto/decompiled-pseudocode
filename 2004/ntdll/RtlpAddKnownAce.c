 ...
 *     RtlAddAccessAllowedAce @ 0x180077780 (RtlAddAccessAllowedAce.c)
 *     RtlAddAccessAllowedAceEx @ 0x180078ED0 (RtlAddAccessAllowedAceEx.c)
 *     RtlAddAccessDeniedAceEx @ 0x1800857B0 (RtlAddAccessDeniedAceEx.c)
 *     RtlpSysVolCreateSecurityDescriptor @ 0x1800881D0 (RtlpSysVolCreateSecurityDescriptor.c)
 *     RtlAddAuditAccessAceEx @ 0x18008A8A0 (RtlAddAuditAccessAceEx.c)
 *     RtlAddAuditAccessAce @ 0x18008B200 (RtlAddAuditAccessAce.c)
 *     RtlAddAccessDeniedAce @ 0x18008BBA0 (RtlAddAccessDeniedAce.c)
