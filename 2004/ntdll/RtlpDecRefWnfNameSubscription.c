/*
 * XREFs of RtlpDecRefWnfNameSubscription @ 0x180063018
 * Callers:
 ...
 *     NtUnsubscribeWnfStateChange @ 0x1800A07A0 (NtUnsubscribeWnfStateChange.c)
        ...
        unsigned __int64 a4)
{
  ...
  RtlAcquireSRWLockExclusive(qword_18016B228 + 8, a2, a3, a4);
  ...
  return RtlReleaseSRWLockExclusive((volatile signed __int64 *)(qword_18016B228 + 8));
}
