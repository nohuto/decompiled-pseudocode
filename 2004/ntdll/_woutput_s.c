/*
 * XREFs of _woutput_s @ 0x1800999DC
 * Callers:
 *     _swoutput_s @ 0x1800998AC (_swoutput_s.c)
 * Callees:
 *     _invalid_parameter @ 0x18008C168 (_invalid_parameter.c)
 *     __security_check_cookie @ 0x18008C240 (__security_check_cookie.c)
 *     _safecrt_mbtowc @ 0x1800987E8 (_safecrt_mbtowc.c)
 *     write_char_2 @ 0x18009A308 (write_char_2.c)
 *     write_string_2 @ 0x18009A35C (write_string_2.c)
