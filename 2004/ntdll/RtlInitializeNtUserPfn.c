/*
 * XREFs of RtlInitializeNtUserPfn @ 0x18008BF90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlInitializeNtUserPfn(void *Src, size_t Size, void *a3, size_t a4, void *Srca, size_t Sizea)
{
  ...
  memmove(off_18017F0C0, a3, a4);
  memmove(off_18017F180, Srca, Sizea);
  byte_18017F1D8 = 1;
  LdrProtectMrdata(1);
  if ( v6 != qword_18017F3A8 || v11 != *(_QWORD *)_guard_check_icall_fptr )
    __fastfail(0x13u);
  return 0LL;
}
