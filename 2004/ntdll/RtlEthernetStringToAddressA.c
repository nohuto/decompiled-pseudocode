/*
 * XREFs of RtlEthernetStringToAddressA @ 0x1800FBC00
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x18008C240 (__security_check_cookie.c)
 *     __isascii @ 0x18008C8B0 (__isascii.c)
 *     isdigit @ 0x18008C9F0 (isdigit.c)
 *     islower @ 0x18008CA50 (islower.c)
 *     isxdigit @ 0x18008CB40 (isxdigit.c)
 */
