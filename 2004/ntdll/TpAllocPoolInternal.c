/*
 * XREFs of TpAllocPoolInternal @ 0x180061734
 * Callers:
 ...
 *     TppInitializeTimerQueue @ 0x180061C20 (TppInitializeTimerQueue.c)
...
LABEL_35:
      ...
      *((_QWORD *)StartParameter + 50) = retaddr;
      ...
      if ( updated >= 0 )
      {
        ...
        v24 = off_180164618;
        if ( *off_180164618 != (_UNKNOWN *)&TppPoolpList )
          __fastfail(3u);
        *v23 = &TppPoolpList;
        *((_QWORD *)StartParameter + 49) = v24;
        *v24 = v23;
        off_180164618 = (_UNKNOWN **)(StartParameter + 384);
