...
__int64 __fastcall RtlHeapTrkInitialize(void *a1)
{
  ...
  if ( (int)result >= 0 )
  {
    if ( qword_18016B730 )
    {
      dword_18016BA58 = *(_DWORD *)(v19 + 56);
      RtlpHeapTrkGenerateHashRandoms((unsigned int)dword_18016BA58, v3, v4, v5, 0LL, &v21);
      ...
      if ( Heap )
      {
        ...
        if ( (unsigned __int8)RtlpHeapTrkAllocCacheAligned(&qword_18016B738, &qword_18016BBE0, 32LL) )
        {
          if ( (unsigned __int8)RtlpHeapTrkAllocCacheAligned(&qword_18016BBB0, &qword_18016BBA8, 8LL) )
          {
            ...
            {
              qword_18016BA40 = RtlAllocateHeap(qword_18016BBD0, 0, 126704LL);
              if ( qword_18016BA40 )
              {
                v7 = RtlAllocateHeap(qword_18016BBD0, 0, 126704LL);
                qword_18016BA50 = v7;
                if ( v7 )
                {
                  v8 = (_QWORD *)qword_18016BA40;
                  v9 = 7919LL;
                  Handle = a1;
                  v10 = qword_18016BA40 - v7;
                  dword_18016BA48 = 0;
                  v11 = v7 - qword_18016BA40;
                  do
                  {
                    v12 = (char *)v8 + v11;
                    *v8 = v8;
        ...
        RtlDestroyHeap(qword_18016BBD0);
        qword_18016BBD0 = 0LL;
        qword_18016BBE0 = 0LL;
        qword_18016BA40 = 0LL;
        qword_18016BBB0 = 0LL;
