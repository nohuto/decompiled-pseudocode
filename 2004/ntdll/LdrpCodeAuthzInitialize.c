...
__int64 LdrpCodeAuthzInitialize()
{
  ...
  if ( (unsigned __int16)(*(_WORD *)(v16 + 92) - 2) > 1u )
    return 0LL;
  if ( (int)NtOpenKey(&v13, 3LL, &unk_18011C780) < 0
    || (v3 = NtQueryValueKey(v13, &unk_18011D458, 2LL, v29, 80, &v15), NtClose(v13), v3 < 0)
    || v30 != 4
    || v31 != 4
    || !v32 )
  {
    v9 = 0LL;
    v1 = 0;
    if ( (int)NtOpenKey(&v9, 131097LL, &unk_180164530) >= 0 )
    {
    ...
    if ( (int)NtOpenKey(&Handle, 1LL, &unk_18011C750) >= 0 )
    {
    ...
    if ( (int)RtlFormatCurrentUserKeyPath(&UnicodeString) >= 0 )
    {
      ...
      {
LABEL_27:
        if ( (int)LdrLoadDll(0LL, 0LL, (__int64)&unk_18011D438, &v14) >= 0 )
        {
          v6 = v14;
          if ( (int)LdrGetProcedureAddressForCaller(v14, &qword_18011D468, 0, &v10, 0, retaddr) >= 0 && v10 )
          {
