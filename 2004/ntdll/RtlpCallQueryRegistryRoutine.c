/*
 * XREFs of RtlpCallQueryRegistryRoutine @ 0x180045FB4
 * Callers:
 ...
 *     RtlpValidateKeyTrust @ 0x180046398 (RtlpValidateKeyTrust.c)
 *     RtlExpandEnvironmentStrings_U @ 0x180076D00 (RtlExpandEnvironmentStrings_U.c)
