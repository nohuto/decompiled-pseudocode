/*
 * XREFs of RtlpWalkFrameChain @ 0x180051660
 * Callers:
 *     RtlWalkFrameChain @ 0x180051620 (RtlWalkFrameChain.c)
 * Callees:
 *     RtlpIsFrameInBounds @ 0x180051580 (RtlpIsFrameInBounds.c)
 *     RtlpLookupFunctionEntryForStackWalks @ 0x180051964 (RtlpLookupFunctionEntryForStackWalks.c)
...
__int64 __fastcall RtlpWalkFrameChain(__int64 a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  __int128 v32; // [rsp+E0h] [rbp+80h]
  __int64 v33; // [rsp+F0h] [rbp+90h]
  unsigned __int64 v34; // [rsp+F8h] [rbp+98h]
  _BYTE v35[48]; // [rsp+100h] [rbp+A0h] BYREF
  __int64 (__fastcall *v36)(); // [rsp+158h] [rbp+F8h]

  if ( !(unsigned __int8)RtlpGetStackLimits(&v23, &v22) )
    return 0LL;
  v32 = xmmword_18017F390;
  v33 = qword_18017F3A0;
  v7 = RtlRaiseExceptionForReturnAddressHijack;
  if ( ((_mm_srli_si128((__m128i)xmmword_18017F390, 8).m128i_u64[0] >> 60) & 3) != 1 )
    v7 = 0LL;
  RtlGetExtendedContextLength2(v7 != 0LL ? 1048651 : 1048587, &v21, v7 != 0LL ? 0x800 : 0);
  v8 = v21 + 15LL;
  if ( v8 <= v21 )
  ...
  v10 = alloca(v9);
  v11 = alloca(v9);
  RtlInitializeExtendedContext2(v18, v7 != 0LL ? 1048651 : 1048587, &v24, v7 != 0LL ? 0x800 : 0);
  RtlpCaptureContext2(v18);
  v18[0] = 0;
  v12 = 0;
  v20 = 0;
  v25 = xmmword_18017F510;
  v26 = qword_18017F520;
  do
  {
    if ( !RtlpIsFrameInBounds(&v23, v34, &v22) )
      break;
    v13 = RtlpLookupFunctionEntryForStackWalks(v36, &v25);
    v27 = v13;
    if ( !v13 )
      break;
    VirtualMemory = 0;
    ...
    {
      VirtualMemory = ZwQueryVirtualMemory(-1LL, v36, 0LL, v35, 48LL, 0LL);
      v19 = VirtualMemory;
      if ( VirtualMemory < 0 )
        return v12;
    ...
    if ( v12 && v7 && v36 == v7 )
    {
      ExtendedFeature2 = RtlLocateExtendedFeature2(v24, 11LL, 2147353560LL);
      v36 = *(__int64 (__fastcall **)())(*(_QWORD *)(ExtendedFeature2 + 8) - 8LL);
    }
    if ( !v36 )
      break;
    if ( v12 >= a4 )
      *(_QWORD *)(a1 + 8LL * (v12 - a4)) = v36;
    v20 = ++v12;
  }
  while ( v12 < a2 );
  return v12;
