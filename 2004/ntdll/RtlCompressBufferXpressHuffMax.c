/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x18010CB04
 * Callers:
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      do
      {
        v23 = (unsigned __int16)XpressHashFunction[*v21] ^ (unsigned __int16)word_18013E7E0[v21[2]] ^ (unsigned __int64)(unsigned __int16)word_18013E5E0[v21[1]];
        v24 = *(_QWORD *)&a6[8 * v23];
        *(_QWORD *)&a6[8 * v23] = v21++;
