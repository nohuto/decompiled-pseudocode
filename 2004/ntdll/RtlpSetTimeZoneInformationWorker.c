/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1800EE5F8
 * Callers:
 *     RtlSetDynamicTimeZoneInformation @ 0x1800EE550 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1800EE560 (RtlSetTimeZoneInformation.c)
 * Callees:
