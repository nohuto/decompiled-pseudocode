...
volatile signed __int32 *__fastcall RtlpCreateSerializationGroup(int a1)
{
  ...
  RtlAcquireSRWLockShared((PRTL_SRWLOCK)(qword_18016B228 + 48));
  for ( i = *(_QWORD **)(qword_18016B228 + 32); i != (_QWORD *)(qword_18016B228 + 32); i = (_QWORD *)*i )
  {
    ...
    if ( *((_DWORD *)i - 1) == a1 )
    {
      ...
      RtlReleaseSRWLockShared((PRTL_SRWLOCK)(qword_18016B228 + 48));
      return v3;
    }
  }
  RtlReleaseSRWLockShared((PRTL_SRWLOCK)(qword_18016B228 + 48));
  ...
  if ( result )
  {
    ...
    *result = 2623763;
    *((_QWORD *)result + 3) = 0LL;
    v5 = (_RTL_SRWLOCK *)(qword_18016B228 + 48);
    *((_DWORD *)result + 1) = a1;
    *((_DWORD *)result + 8) = 1;
    RtlAcquireSRWLockExclusive(v5);
    v6 = (_RTL_SRWLOCK *)qword_18016B228;
    v7 = qword_18016B228 + 32;
    for ( j = *(_QWORD **)(qword_18016B228 + 32); j != (_QWORD *)v7; j = (_QWORD *)*j )
    {
    ...
    v10 = *(__int64 ***)(qword_18016B228 + 40);
    v11 = (__int64 *)(v3 + 2);
    if ( *v10 != (__int64 *)v7 )
      __fastfail(3u);
    *v11 = v7;
