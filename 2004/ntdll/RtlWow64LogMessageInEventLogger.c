/*
 * XREFs of RtlWow64LogMessageInEventLogger @ 0x1800D6740
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall RtlWow64LogMessageInEventLogger(__int16 a1, __int64 a2, unsigned int a3)
{
  ...
  result = LdrLoadDll(0LL, 0LL, (PUNICODE_STRING)&stru_18011D478, &DllHandle);
  if ( result >= 0 )
  {
    if ( LdrGetProcedureAddressForCaller(DllHandle, (PANSI_STRING)&stru_18011D498, 0, &ProcedureAddress, 0, retaddr) >= 0
      && LdrGetProcedureAddressForCaller(DllHandle, (PANSI_STRING)&stru_18011D488, 0, &v12, 0, retaddr) >= 0
      && LdrGetProcedureAddressForCaller(DllHandle, (PANSI_STRING)&stru_18011D4A8, 0, &v11, 0, retaddr) >= 0 )
    {
