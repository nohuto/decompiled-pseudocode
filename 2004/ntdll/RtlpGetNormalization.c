/*
 * XREFs of RtlpGetNormalization @ 0x180080520
 * Callers:
 ...
 *     NormalizationList__Lookup @ 0x180080640 (NormalizationList__Lookup.c)
 *     Normalization__LoadTables @ 0x180080670 (Normalization__LoadTables.c)
 *     ZwGetNlsSectionPtr @ 0x18009ED20 (ZwGetNlsSectionPtr.c)
 */
...
LABEL_6:
    ...
    if ( Heap )
    {
      ...
      {
        *(_DWORD *)(v13 + 16) = a1;
        v15 = (__int64 *)off_180164608[0];
        if ( *(_UNKNOWN ***)off_180164608[0] != &NormalizationListHead )
          __fastfail(3u);
        *(_QWORD *)v13 = &NormalizationListHead;
        *(_QWORD *)(v13 + 8) = v15;
        *v15 = v13;
        off_180164608[0] = (_UNKNOWN **)v13;
        goto LABEL_3;
      }
