/*
 * XREFs of RtlUnicodeStringCat @ 0x180068C98
 * Callers:
 *     RtlDosSearchPath_Ustr @ 0x180019C40 (RtlDosSearchPath_Ustr.c)
 * Callees:
 *     RtlWideCharArrayCopyWorker @ 0x180068DB0 (RtlWideCharArrayCopyWorker.c)
 *     RtlUnicodeStringValidateSrcWorker @ 0x180068E14 (RtlUnicodeStringValidateSrcWorker.c)
 *     RtlUnicodeStringValidateDestWorker @ 0x180068E50 (RtlUnicodeStringValidateDestWorker.c)
 */
