/*
 * XREFs of RtlpWaitOnAddress @ 0x1800635A4
 * Callers:
 ...
 *     RtlWaitOnAddress @ 0x180063350 (RtlWaitOnAddress.c)
 *     RtlpWaitOnCriticalSection @ 0x180063370 (RtlpWaitOnCriticalSection.c)
 *     RtlPosixBarrier @ 0x1800ED638 (RtlPosixBarrier.c)
 * Callees:
 *     RtlpAddWaitBlockToWaitList @ 0x1800636A4 (RtlpAddWaitBlockToWaitList.c)
