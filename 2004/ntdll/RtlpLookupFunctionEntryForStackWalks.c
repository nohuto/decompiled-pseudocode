/*
 * XREFs of RtlpLookupFunctionEntryForStackWalks @ 0x180051964
 * Callers:
...
unsigned int *__fastcall RtlpLookupFunctionEntryForStackWalks(char *BaseAddress, signed __int64 a2, char *a3, char *a4)
{
  ...
  if ( (unsigned __int64)BaseAddress >= *((_QWORD *)&xmmword_18017F510 + 1)
    && (unsigned __int64)BaseAddress < *((_QWORD *)&xmmword_18017F510 + 1)
                                     + (unsigned __int64)(unsigned int)qword_18017F520 )
  {
    *(_OWORD *)a2 = xmmword_18017F510;
    *(_QWORD *)(a2 + 16) = qword_18017F520;
LABEL_3:
    v6 = *(_QWORD *)a2;
    goto LABEL_4;
  }
