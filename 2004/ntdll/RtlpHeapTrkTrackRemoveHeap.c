/*
 * XREFs of RtlpHeapTrkTrackRemoveHeap @ 0x1800FE864
 * Callers:
        ...
        unsigned __int64 a4)
{
  ...
  {
    v6 = v5 & 0xF;
    RtlAcquireSRWLockExclusive(*(_QWORD *)(qword_18016BBB0 + 8 * v6), a2, a3, a4);
    v7 = *(__int64 **)(qword_18016BA40 + 16LL * v5);
    v8 = qword_18016BA40 + 16LL * v5;
    if ( v7 != (__int64 *)v8 )
    {
      do
      {
...
LABEL_16:
    ...
    RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_18016BBB0 + 8 * v6));
    ++v5;
  }
  while ( v5 < 0x1EEF );
  while ( 1 )
  {
    ...
    *(_QWORD *)(v14 + 8) = v15;
    ...
    RtlFreeHeap(qword_18016BBD0, 0, v12);
  }
}
