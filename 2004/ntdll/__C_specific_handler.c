/*
 * XREFs of __C_specific_handler @ 0x18008C6E0
 * Callers:
 *     __GSHandlerCheck_SEH @ 0x18009C9A4 (__GSHandlerCheck_SEH.c)
 * Callees:
 *     RtlUnwindEx @ 0x180030600 (RtlUnwindEx.c)
 *     _NLG_Notify @ 0x180092470 (_NLG_Notify.c)
 *     __NLG_Return2 @ 0x1800924A0 (__NLG_Return2.c)
 *     __except_validate_context_record @ 0x1800924A8 (__except_validate_context_record.c)
 */
