/*
 * XREFs of RtlpComputePath @ 0x18006C6C0
 * Callers:
 ...
 *     RtlpAddForwarderPath @ 0x1800DED4C (RtlpAddForwarderPath.c)
 */
...
__int64 __fastcall RtlpComputePath(_DWORD *a1, unsigned int a2, wchar_t *a3, char a4)
{
  ...
  v47 = a3;
  v45 = a1;
  v4 = ((unsigned __int64)xmmword_18017F390 >> 60) & 3;
  v44 = 0LL;
  v41 = 0LL;
  v5 = 0LL;
  Src = 0LL;
...
LABEL_32:
          ...
          break;
        case 6:
          v13 = (unsigned __int16)word_1801643E8;
LABEL_36:
          v6 += v13;
          break;
        case 7:
