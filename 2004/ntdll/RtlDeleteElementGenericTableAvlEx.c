/*
 * XREFs of RtlDeleteElementGenericTableAvlEx @ 0x18005B7E0
 * Callers:
 *     RtlDeleteElementGenericTableAvl @ 0x18005B7A0 (RtlDeleteElementGenericTableAvl.c)
 * Callees:
 *     DeleteNodeFromTree @ 0x18005B83C (DeleteNodeFromTree.c)
 *     RealPredecessor @ 0x18005BD8C (RealPredecessor.c)
 */
