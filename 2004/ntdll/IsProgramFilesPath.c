/*
 * XREFs of IsProgramFilesPath @ 0x18004D424
 * Callers:
...
__int64 __fastcall IsProgramFilesPath(wchar_t *String1, size_t *a2)
{
  ...
  v11 = 702;
  *a2 = 0LL;
  result = RtlQueryEnvironmentVariable_U(0LL, &unk_18011C410, &v10);
  ...
  if ( !Heap )
    return 3221225659LL;
  v6 = RtlQueryEnvironmentVariable_U(0LL, &unk_18011C410, &v10);
  v7 = String2;
  v8 = v6;
  if ( v6 >= 0 )
  {
