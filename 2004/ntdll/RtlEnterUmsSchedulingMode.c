/*
 * XREFs of RtlEnterUmsSchedulingMode @ 0x1800F6EE0
 * Callers:
 *     <none>
 * Callees:
 *     RtlGetCurrentUmsThread @ 0x180058990 (RtlGetCurrentUmsThread.c)
 *     ZwRaiseException @ 0x18009FAC0 (ZwRaiseException.c)
 *     RtlpUmsPrimaryContextWrap @ 0x1800A1F20 (RtlpUmsPrimaryContextWrap.c)
