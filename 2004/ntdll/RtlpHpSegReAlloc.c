...
LABEL_23:
        ...
        if ( *(_DWORD *)(a4 + 16) )
        {
          ...
          {
            v52 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016BC20, 2 * ((v25 - qword_18016BC18) >> 20));
...
LABEL_36:
        ...
        else
        {
          ...
          {
            v51 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016BC20, 2 * ((a3 - qword_18016BC18) >> 20));
