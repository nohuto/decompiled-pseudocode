/*
 * XREFs of LdrVerifyImageMatchesChecksumEx @ 0x18008AA90
 * Callers:
 *     LdrVerifyImageMatchesChecksum @ 0x1800CE5F0 (LdrVerifyImageMatchesChecksum.c)
 * Callees:
 ...
 *     NtMakeTemporaryObject @ 0x18009EFE0 (NtMakeTemporaryObject.c)
...
NTSTATUS __cdecl LdrVerifyImageMatchesChecksumEx(HANDLE ImageFileHandle, PLDR_VERIFY_IMAGE_INFO VerifyInfo)
{
  ...
  if ( (VerifyInfo->Flags & 2) == 0 )
    p_SectionInfo = (LDR_SECTION_INFO *)&unk_180122648;
...
LABEL_30:
    if ( v8 < 0 || p_SectionInfo == (LDR_SECTION_INFO *)&unk_180122648 )
    {
