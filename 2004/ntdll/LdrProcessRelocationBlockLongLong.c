/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x180084588
 * Callers:
 *     LdrRelocateImageWithBias @ 0x18008448C (LdrRelocateImageWithBias.c)
 *     LdrProcessRelocationBlock @ 0x1800E3960 (LdrProcessRelocationBlock.c)
 *     LdrProcessRelocationBlockEx @ 0x1800E3990 (LdrProcessRelocationBlockEx.c)
 * Callees:
 *     LdrpArmProcessRelocation @ 0x1800E399C (LdrpArmProcessRelocation.c)
