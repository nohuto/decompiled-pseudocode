 ...
 *     ReadString_0 @ 0x180098B28 (ReadString_0.c)
 *     ReadStringDelimited_0 @ 0x180098CD0 (ReadStringDelimited_0.c)
 *     _inc_0 @ 0x180098E58 (_inc_0.c)
 */

__int64 __fastcall input_s(FILE *Stream, unsigned __int8 *a2, _BYTE **a3)
{
  int v3; // r11d
  _BYTE **v4; // r13
  int v5; // ebx
...
LABEL_128:
    ...
    if ( v25 == 123 )
    {
      v50 = ReadStringDelimited_0(v49, &v74, &v60, &v59, (_WORD **)&v71, v3, Stream, v29, v70);
      v6 = v74;
    }
    else
    {
      v50 = ReadString_0(v49, 0LL, &v60, &v59, (_WORD **)&v71, v3, Stream, v29, v70);
    }
    v10 = v70[0];
    v5 = v60;
    v58 = v70[0];
