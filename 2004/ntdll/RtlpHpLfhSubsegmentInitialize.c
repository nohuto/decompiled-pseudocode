        ...
        __int64 a5)
{
  ...
  *v14 = 1;
  ...
  if ( !dword_18016B208
    && NtQueryInformationProcess((HANDLE)0xFFFFFFFFFFFFFFFFLL, (PROCESSINFOCLASS)36, &dword_18016B208, 4u, 0LL) < 0 )
  {
...
LABEL_17:
  ...
  v21 = _InterlockedExchange(&RtlpRandomExConstantVector[RtlpRandomExAuxVarY & 0x7F], dword_18016B208);
...
LABEL_25:
  dword_18016B208 = (2147483629 * (unsigned __int64)(unsigned int)dword_18016B208 + 2147483587) % 0x7FFFFFFF;
  v29 = _InterlockedExchange(&RtlpRandomExConstantVector[RtlpRandomExAuxVarY & 0x7F], dword_18016B208);
  if ( MEMORY[0x7FFE0290] )
  {
    v30 = 0;
    while ( 1 )
