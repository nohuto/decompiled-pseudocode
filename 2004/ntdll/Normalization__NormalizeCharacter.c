/*
 * XREFs of Normalization__NormalizeCharacter @ 0x18008036C
 * Callers:
 *     Normalization__Normalize @ 0x180080238 (Normalization__Normalize.c)
 *     Normalization__AppendDecomposedChar @ 0x1800FFA0C (Normalization__AppendDecomposedChar.c)
 * Callees:
 *     NormBuffer__AppendEx @ 0x1800804A0 (NormBuffer__AppendEx.c)
 *     NormBuffer__Append @ 0x1800804EC (NormBuffer__Append.c)
 *     ComposeHangulLV @ 0x1800FF238 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1800FF268 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1800FF29C (IsHangulLV.c)
 *     NormBuffer__GetLastChar @ 0x1800FF3C4 (NormBuffer__GetLastChar.c)
 *     NormBuffer__Insert @ 0x1800FF45C (NormBuffer__Insert.c)
 *     NormBuffer__IsBlocked @ 0x1800FF524 (NormBuffer__IsBlocked.c)
 *     NormBuffer__LastStartBase @ 0x1800FF5CC (NormBuffer__LastStartBase.c)
 *     NormBuffer__LastStartBasePair @ 0x1800FF5F8 (NormBuffer__LastStartBasePair.c)
 *     NormBuffer__RecheckStartCombinations @ 0x1800FF648 (NormBuffer__RecheckStartCombinations.c)
 *     NormBuffer__ReplaceLastStartBase @ 0x1800FF7C4 (NormBuffer__ReplaceLastStartBase.c)
 *     NormBuffer__ReplaceLastStartBasePair @ 0x1800FF83C (NormBuffer__ReplaceLastStartBasePair.c)
 *     NormBuffer__RewindOutputCharacter @ 0x1800FF8FC (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x1800FFA0C (Normalization__AppendDecomposedChar.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x1800FFB20 (Normalization__CanCombinableCharactersCombine.c)
 */
