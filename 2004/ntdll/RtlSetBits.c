/*
 * XREFs of RtlSetBits @ 0x180048990
 * Callers:
 *     LdrpInitializeTls @ 0x1800473D8 (LdrpInitializeTls.c)
 *     RtlFindClearBitsAndSet @ 0x180048660 (RtlFindClearBitsAndSet.c)
 *     LdrpInitializeProcess @ 0x1800D1D20 (LdrpInitializeProcess.c)
 *     RtlpValidateRange @ 0x1800D8F28 (RtlpValidateRange.c)
 * Callees:
