/*
 * XREFs of RtlpAddVectoredHandler @ 0x180081690
 * Callers:
 *     RtlAddVectoredExceptionHandler @ 0x180081680 (RtlAddVectoredExceptionHandler.c)
 *     RtlAddVectoredContinueHandler @ 0x1800D9620 (RtlAddVectoredContinueHandler.c)
 * Callees:
...
_QWORD *__fastcall RtlpAddVectoredHandler(int a1, __int64 a2, unsigned int a3)
{
  ...
  v3 = a3;
  if ( (int)LdrEnsureMrdataHeapExists() >= 0 && ((int)RtlQueryProtectedPolicy(&unk_180122258) < 0 || !v28) )
  {
