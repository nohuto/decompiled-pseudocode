/*
 * XREFs of RtlpHpTlLogVAChange @ 0x18010B3DC
 * Callers:
...
void __fastcall RtlpHpTlLogVAChange(int a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  switch ( a1 )
  {
    case 0x1000:
      ...
      v8[0] = a2;
      v12 = &v7;
      v5 = (unsigned __int8 *)&unk_180130599;
      goto LABEL_13;
    case 0x2000:
      if ( (unsigned int)dword_1801645C8 <= 5 )
        return;
      v8[0] = a2;
      v12 = &v7;
      v5 = (unsigned __int8 *)&unk_18013051F;
      goto LABEL_13;
    case 0x4000:
      if ( (unsigned int)dword_1801645C8 <= 5 )
        return;
      v8[0] = a2;
      v12 = &v7;
      v5 = (unsigned __int8 *)&unk_180130478;
LABEL_13:
      v4 = v8;
      v7 = a3;
      goto LABEL_14;
  }
  if ( a1 == 0x8000 && (unsigned int)dword_1801645C8 > 5 )
  {
    v7 = a2;
    v4 = &v7;
    v8[0] = a3;
    v12 = v8;
    v5 = (unsigned __int8 *)&unk_1801305CE;
LABEL_14:
    v10 = v4;
    v14 = &v6;
    v11 = 8LL;
    ...
    v6 = a4;
    v15 = 4LL;
    tlgWriteTransfer_EtwEventWriteTransfer((__int64)&dword_1801645C8, v5, a3, a4, 5, (__int64)v9);
  }
}
