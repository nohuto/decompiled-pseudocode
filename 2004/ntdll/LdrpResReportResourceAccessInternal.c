...
__int64 __fastcall LdrpResReportResourceAccessInternal(unsigned __int64 a1, __int64 a2, __int64 *a3, int a4)
{
  ...
  result = RtlRunOnceExecuteOnce(&unk_18016B250, LdrpResReportResourceAccessInternalInitOnce, 0LL, 0LL);
  if ( (int)result >= 0 )
  {
    v10 = (unsigned __int16)dword_18016B190;
    result = (unsigned int)++dword_18016B190;
    if ( !v10 )
    {
      v25 = 0LL;
      if ( a2 )
        ...
        if ( a4 >= 2 )
        {
          if ( a4 == 2 )
          {
            if ( (unsigned int)dword_180164450 <= 5 )
              return result;
            result = tlgKeywordOn(&dword_180164450, 0x400000000000LL);
            if ( !(_BYTE)result )
              return result;
            v26 = *a3;
            v38 = &v28;
