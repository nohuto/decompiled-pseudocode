/*
 * XREFs of _handle_error @ 0x180094130
 * Callers:
 *     atan @ 0x18008E320 (atan.c)
 *     atan2 @ 0x18008E580 (atan2.c)
 *     ceil @ 0x18008EED0 (ceil.c)
 *     cos @ 0x18008EFF0 (cos.c)
 *     sin @ 0x18008F410 (sin.c)
 *     floor @ 0x18008F9B0 (floor.c)
 *     log @ 0x18008FBE0 (log.c)
 *     sqrt @ 0x1800908C0 (sqrt.c)
 *     tan @ 0x180091760 (tan.c)
 *     _pow_special @ 0x180095280 (_pow_special.c)
 * Callees:
 *     __security_check_cookie @ 0x18008C240 (__security_check_cookie.c)
 *     _call_matherr @ 0x180094004 (_call_matherr.c)
 *     _exception_enabled @ 0x180094070 (_exception_enabled.c)
 *     _raise_exc @ 0x180094BE0 (_raise_exc.c)
