/*
 * XREFs of LdrpLogEtwDllSearchResults @ 0x1800CEE34
 * Callers:
...
void __fastcall LdrpLogEtwDllSearchResults(int a1, __int64 a2)
{
  ...
  if ( Heap )
  {
    ...
    *((_DWORD *)Heap + 11) = *(_DWORD *)(a2 + 36);
    LdrpEventAddUnicodeString(a2, Heap + 24, 0x214u, (int *)&v28);
    v6 = v28;
    v7 = 2147353476LL;
    ...
    if ( (a1 & 0x100) != 0 && (int)LdrpMakeUnicodeStringFromPathElement(*(_QWORD *)(a2 + 16), 4LL, &UnicodeString) >= 0 )
    {
      ...
      if ( v13 )
      {
        ...
        *((_DWORD *)v13 + 8) = a1;
        *((_WORD *)v13 + 3) = 5333;
        LdrpEventAddUnicodeString((__int64)&UnicodeString, (_WORD *)v13 + 18, 0xC78u, (int *)&v28);
        v16 = 3192 - v28;
        v17 = v28 + 4;
        v18 = &v15[2 * ((unsigned __int64)v28 >> 1)];
        LdrpEventAddUnicodeString((__int64)&v25, v18, 3192 - v28, (int *)&v28);
        v19 = v16 - v28;
        v20 = v28 + v17;
        v21 = &v18[2 * ((unsigned __int64)v28 >> 1)];
        LdrpEventAddUnicodeString((__int64)&v27, v21, v19, (int *)&v28);
        v22 = v28 + v20;
        LdrpEventAddUnicodeString((__int64)&v26, &v21[2 * ((unsigned __int64)v28 >> 1)], v19 - v28, (int *)&v28);
        v23 = v28 + v22;
