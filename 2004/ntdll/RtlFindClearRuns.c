/*
 * XREFs of RtlFindClearRuns @ 0x1800EBDF0
 * Callers:
 *     RtlFindLongestRunClear @ 0x1800EC0D0 (RtlFindLongestRunClear.c)
 * Callees:
 *     <none>
 */
  ...
  if ( !v11 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v19 )
      {
        ...
        v13 = v17 - v15 + 8;
        v43 = v13;
        v26 = *((_BYTE *)&unk_18012D248 - v15) | RtlIsSystemAceType[v20 + 16] | v19;
        if ( v26 != 0xFF )
        {
          do
          {
