...
LABEL_135:
  ...
  if ( dword_1801649B8 || (v20 = *((_QWORD *)BaseAddress + 6)) == 0 && (v20 = qword_180168688) == 0 || v17 <= v20 )
  {
    v107 = 0;
    v24 = 0LL;
    v113 = 0LL;
...
LABEL_124:
    ...
    *(_BYTE *)(v54 + 3) = v53 >> 4;
    ...
    {
      v56 = RtlCSparseBitmapBitmaskRead((__int64)&::BaseAddress, 2 * ((Heap - qword_18016BC18) >> 20));
