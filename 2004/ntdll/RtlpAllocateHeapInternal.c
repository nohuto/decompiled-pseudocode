 ...
 *     RtlpHpVsChunkSetExtraPresent @ 0x180069DB0 (RtlpHpVsChunkSetExtraPresent.c)
...
LABEL_206:
    ...
    v75 = v72 & 0x1000000;
    if ( !v75 && !dword_1801649B8 )
    {
      v76 = *(_QWORD *)(a1 + 392);
      v77 = v76;
      if ( (v76 || (v77 = qword_180168688) != 0) && a2 > v77 )
      {
        v78 = *(_QWORD *)(a1 + 400);
        if ( v78 )
...
LABEL_135:
  ...
  if ( dword_1801649B8 || (v20 = *(_QWORD *)(a1 + 48)) == 0 && (v20 = qword_180168688) == 0 || v17 <= v20 )
  {
    v108 = 0;
    v24 = 0LL;
    v114 = 0LL;
...
LABEL_124:
    ...
    *(_BYTE *)(v54 + 3) = v53 >> 4;
    ...
    {
      v56 = RtlCSparseBitmapBitmaskRead((__int64)&unk_18016BC20, 2 * ((unsigned __int64)(Heap - qword_18016BC18) >> 20));
