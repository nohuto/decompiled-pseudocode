...
__int64 __fastcall RtlDebugReAllocateHeap(_DWORD *Src, int a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( (Src[29] & 0x1000000) != 0 )
    return ((__int64 (*)(void))qword_1801649D8)();
...
LABEL_68:
  ...
  if ( RtlpValidateHeapEntry((unsigned __int64)Src, v15, "RtlReAllocateHeap") )
  {
    ...
    else
    {
      ...
      if ( !v20 || v20 != v19 || *((_WORD *)Src + 104) != HIWORD(dword_180168C78) )
        goto LABEL_36;
      if ( NtCurrentPeb()->Ldr )
        DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
      else
...
LABEL_57:
    ...
    if ( (v27->NtGlobalFlag & 0x800) != 0 && __PAIR32__(*((_WORD *)Src + 104), v32) == dword_180168C78 )
    {
      if ( NtCurrentPeb()->Ldr )
        DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
      else
