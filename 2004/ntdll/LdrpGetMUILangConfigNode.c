/*
 * XREFs of LdrpGetMUILangConfigNode @ 0x1800EE8C8
 * Callers:
 *     RtlpTraverseParents @ 0x18004728C (RtlpTraverseParents.c)
 * Callees:
 *     RtlpCompareConfigNodeWithSpec @ 0x1800EFD24 (RtlpCompareConfigNodeWithSpec.c)
 *     RtlpMuiRegGetLanginfoTypeNSpec @ 0x1800F07B4 (RtlpMuiRegGetLanginfoTypeNSpec.c)
 */
