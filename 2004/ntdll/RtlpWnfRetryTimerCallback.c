/*
 * XREFs of RtlpWnfRetryTimerCallback @ 0x18008ADC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     NtGetCompleteWnfStateSubscription @ 0x18009EC20 (NtGetCompleteWnfStateSubscription.c)
 */
...
void __fastcall RtlpWnfRetryTimerCallback(PTP_CALLBACK_INSTANCE a1, PVOID a2, PTP_TIMER a3)
{
  ...
  {
    v3 = 0;
    RtlAcquireSRWLockShared((PRTL_SRWLOCK)(qword_18016B228 + 8));
    v4 = (_RTL_SRWLOCK *)qword_18016B228;
    *(_QWORD *)(qword_18016B228 + 88) = 0LL;
    ...
    while ( 1 )
    {
      ...
      RtlAcquireSRWLockShared((PRTL_SRWLOCK)(qword_18016B228 + 8));
      v7 = (_RTL_SRWLOCK *)qword_18016B228;
      v8 = qword_18016B228 + 16;
      v9 = *(_RTL_SRWLOCK **)(qword_18016B228 + 16);
