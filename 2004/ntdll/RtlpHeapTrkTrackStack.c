/*
 * XREFs of RtlpHeapTrkTrackStack @ 0x1800FE9A4
 * Callers:
...
__int64 RtlpHeapTrkTrackStack()
{
  ...
  v1 = BackTraceHash[0];
  Heap = RtlAllocateHeap(qword_18016BBD0, 0, 8 * v0 + 24);
  v3 = v1 & 0xF;
  RtlAcquireSRWLockExclusive(*(_QWORD *)(qword_18016BBC8 + 8 * v3), v4, v5, v6);
  v7 = qword_18016BA50;
  v8 = (_QWORD *)(qword_18016BA50 + 16LL * v1);
  v9 = (_QWORD *)*v8;
  if ( (_QWORD *)*v8 == v8 )
  {
LABEL_6:
    if ( Heap )
    {
      ...
      *(_QWORD *)(v12 + 8) = Heap;
      *(_QWORD *)v11 = Heap;
      _InterlockedIncrement(&dword_18016BA48);
      RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_18016BBC8 + 8 * v3));
      return Heap;
    }
    else
    {
...
LABEL_5:
  ...
  RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_18016BBC8 + 8 * v3));
  if ( Heap )
    RtlFreeHeap(qword_18016BBD0, 0, Heap);
  return (__int64)v9;
}
