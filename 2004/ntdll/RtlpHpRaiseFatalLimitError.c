/*
 * XREFs of RtlpHpRaiseFatalLimitError @ 0x1801083FC
 * Callers:
...
void __fastcall RtlpHpRaiseFatalLimitError(void *a1)
{
  ...
  v2.ExceptionCode = qword_180167810;
  v2.ExceptionInformation[0] = dword_1801677F8;
  v2.ExceptionInformation[1] = qword_180167800;
  v2.ExceptionInformation[2] = qword_180167818;
  v2.ExceptionInformation[3] = qword_180167820;
  v2.ExceptionFlags = 1;
