/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x18010974C
 * Callers:
...
LABEL_73:
    ...
    if ( v16 )
    {
      qword_180167838 = *(unsigned __int16 *)(a1 + 140) ^ (unsigned __int64)*(unsigned __int16 *)(v16 + 12);
      v26 = *(_DWORD *)(a1 + 124);
    }
    if ( v17 )
    {
    ...
    if ( qword_180167838 == (unsigned __int16)result )
    {
      result = *(unsigned __int16 *)(a1 + 140);
      if ( qword_180167840 != (result ^ *(unsigned __int16 *)(v17 + 16LL * v27 + 12)) )
        dword_1801677F8 = 7;
    }
    else
    {
