/*
 * XREFs of LdrpResGetResourceDirectory @ 0x180049620
 * Callers:
 *     LdrpResSearchResourceMappedFile @ 0x180048EFC (LdrpResSearchResourceMappedFile.c)
 * Callees:
 *     RtlGetCurrentServiceSessionId @ 0x180024850 (RtlGetCurrentServiceSessionId.c)
 *     RtlImageNtHeaderEx @ 0x180032AD0 (RtlImageNtHeaderEx.c)
 *     LdrpSectionTableFromVirtualAddress @ 0x18004B834 (LdrpSectionTableFromVirtualAddress.c)
    ...
    else
    {
      ...
      if ( v17 )
      {
        ...
        else
        {
          v19 = v49;
          v20 = a2;
          v21 = (unsigned int *)LdrpSectionTableFromVirtualAddress(a1, a2, v27, 0, v17, v49 != 0);
          if ( !v21 )
          {
            v26 = -1073741701;
            goto LABEL_41;
