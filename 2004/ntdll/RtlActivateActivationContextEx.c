/*
 * XREFs of RtlActivateActivationContextEx @ 0x1800722B0
 * Callers:
 *     RtlActivateActivationContext @ 0x180072260 (RtlActivateActivationContext.c)
 * Callees:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( a4 )
    *a4 = 0LL;
  v6 = (volatile signed __int32 *)&unk_18011C4C8;
