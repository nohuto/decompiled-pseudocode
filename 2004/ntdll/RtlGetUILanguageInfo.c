/*
 * XREFs of RtlGetUILanguageInfo @ 0x1800EED40
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RtlpMuiRegGetFallbackLanguagesAsMultiSZ @ 0x180104998 (RtlpMuiRegGetFallbackLanguagesAsMultiSZ.c)
 */
...
LABEL_32:
    ...
    else
    {
      ...
      if ( !RtlCultureNameToLCID(&v35.Length, &v29) )
      {
        FallbackLanguagesAsMultiSZ = -1073741811;
        goto LABEL_32;
      }
