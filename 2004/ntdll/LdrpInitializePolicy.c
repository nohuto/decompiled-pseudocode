/*
 * XREFs of LdrpInitializePolicy @ 0x18007FA28
 * Callers:
 *     LdrpInitializeProcess @ 0x1800D1D20 (LdrpInitializeProcess.c)
 * Callees:
 *     AppModelPolicy_GetPolicy_Internal @ 0x180069318 (AppModelPolicy_GetPolicy_Internal.c)
 *     LdrSetDefaultDllDirectories @ 0x18007FBE0 (LdrSetDefaultDllDirectories.c)
 */
