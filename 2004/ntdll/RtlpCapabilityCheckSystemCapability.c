/*
 * XREFs of RtlpCapabilityCheckSystemCapability @ 0x180079270
 * Callers:
...
__int64 __fastcall RtlpCapabilityCheckSystemCapability(void *a1, __int64 a2, _BYTE *a3)
{
  ...
  else
  {
    *a3 = 0;
    ...
    {
      if ( (unsigned int)RtlCompareUnicodeString(&UnicodeString.Length, word_18011D5D8, 0) )
      {
        if ( (unsigned int)RtlCompareUnicodeString(&UnicodeString.Length, word_18011D5C8, 0) )
        {
