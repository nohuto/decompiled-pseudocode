        ...
        unsigned __int64 a4)
{
  ...
  if ( _interlockedbittestandset64((volatile signed __int32 *)UniqueThread, 0LL) )
  {
    ...
    while ( 1 )
    {
      if ( (v5 & 1) != 0 )
      {
        if ( (unsigned __int8)RtlpWaitCouldDeadlock(UniqueThread, i, a3, a4, v11) )
        ...
        v8 = _InterlockedCompareExchange64(v4, i, v5);
        v7 = v5 == v8;
        v5 = v8;
        if ( !v7 )
          goto LABEL_13;
