/*
 * XREFs of LdrpArmProcessRelocation @ 0x1800E399C
 * Callers:
 *     LdrProcessRelocationBlockLongLong @ 0x180084588 (LdrProcessRelocationBlockLongLong.c)
 *     LdrpThumbProcessRelocation @ 0x1800E3A6C (LdrpThumbProcessRelocation.c)
 * Callees:
 *     <none>
 */
