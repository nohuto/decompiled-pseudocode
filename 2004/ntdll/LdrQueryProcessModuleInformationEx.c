        ...
        unsigned int *a5)
{
  ...
  for ( i = 0LL; ; ++i )
  {
    ...
    if ( (a2 & 2) != 0 )
      off_18011CC60[5 * i + 3]();
    v11 = ((__int64 (__fastcall *)(_QWORD *, _QWORD *, __int64 *))off_18011CC60[5 * i])(v22, v17, &v19);
    if ( v11 < 0 )
      goto LABEL_25;
    if ( !v17[0] )
      goto LABEL_27;
    v11 = ((__int64 (__fastcall *)(_QWORD *, _QWORD, __int64 *))off_18011CC60[5 * i + 1])(v22, v17[0], &v16);
    if ( v11 < 0 )
    {
LABEL_25:
      v7 = v11;
    ...
    else
    {
      while ( 1 )
      {
        ...
        {
          v11 = ((__int64 (__fastcall *)(_QWORD *, _DWORD *, __int64, __int64, __int64))off_18011CC60[5 * i + 2])(
                  v22,
                  v15,
                  v16,
                  v19,
        ...
        if ( a3 && v13 >= 0x130 )
          *a3 += v10;
        v11 = ((__int64 (__fastcall *)(_QWORD *, __int64, __int64 *))off_18011CC60[5 * i + 1])(v22, v12, &v16);
        if ( v11 < 0 )
          goto LABEL_25;
      }
    }
