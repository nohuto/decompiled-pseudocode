...
LABEL_14:
  ...
  if ( v15 != 4 )
  {
    ...
    {
      if ( (unsigned __int16)HeapHandle ^ (unsigned __int16)(RtlpLFHKey ^ *(_WORD *)(v4 + 8) ^ (v4 >> 4)) )
        v16 = 0LL;
      else
        v16 = *(_QWORD *)(v4
                        - ((unsigned __int64)((unsigned int)HeapHandle ^ (unsigned int)RtlpLFHKey ^ *(_DWORD *)(v4 + 8) ^ (unsigned int)(v4 >> 4)) >> 12));
      v17 = *(_WORD *)(v16 + 36);
    }
    v18 = *(_BYTE *)(v4 + 15);
    if ( v18 == 5 )
