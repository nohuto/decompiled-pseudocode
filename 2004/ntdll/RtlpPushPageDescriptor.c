/*
 * XREFs of RtlpPushPageDescriptor @ 0x1800F7F28
 * Callers:
 *     RtlpLeakCallbackRoutine @ 0x1800F7DB0 (RtlpLeakCallbackRoutine.c)
    ...
    if ( (int)v8 > 0 )
    {
      ...
      do
      {
        ...
        *(_QWORD *)v9 = v9;
        if ( *(_QWORD *)(v9 + 16) != v13 )
        {
          v14 = (__int64 *)qword_180168CC8;
          if ( *(__int64 **)qword_180168CC8 != &RtlpLeakList )
            __fastfail(3u);
