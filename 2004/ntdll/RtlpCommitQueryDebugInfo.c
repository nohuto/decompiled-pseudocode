/*
 * XREFs of RtlpCommitQueryDebugInfo @ 0x1800D88E8
 * Callers:
 *     RtlCommitDebugInfo @ 0x1800D72D0 (RtlCommitDebugInfo.c)
 ...
 *     RtlpWalkCallbackRoutine @ 0x1800D9430 (RtlpWalkCallbackRoutine.c)
