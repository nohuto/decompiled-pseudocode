/*
 * XREFs of RtlpHeapTrkTrackAdd @ 0x1800FE69C
 * Callers:
...
signed __int64 __fastcall RtlpHeapTrkTrackAdd(__int64 a1, __int64 a2)
{
  ...
  result = RtlAllocateHeap(qword_18016BBD0, 0, 40LL);
  v5 = (_QWORD *)result;
  if ( result )
  {
    ...
    {
      v11 = v6 & 0xF;
      RtlAcquireSRWLockExclusive(*(_QWORD *)(qword_18016BBB0 + 8 * v11), v8, v9, v10);
      v12 = qword_18016BA40 + 16 * v6;
      v13 = *(_QWORD *)v12;
      ...
      *(_QWORD *)(v13 + 8) = v5;
      *(_QWORD *)v12 = v5;
      return RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_18016BBB0 + 8 * v11));
    }
    else
    {
      return RtlFreeHeap(qword_18016BBD0, 0, (__int64)v5);
    }
  }
  return result;
}
