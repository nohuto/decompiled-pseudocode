...
void __cdecl RtlCaptureContext2(PCONTEXT ContextRecord)
{
  ...
  if ( (int)RtlpSanitizeContextFlags(&ContextRecord->ContextFlags) < 0 )
  {
    *(_DWORD *)(v15 + 48) = 0;
  }
  else
