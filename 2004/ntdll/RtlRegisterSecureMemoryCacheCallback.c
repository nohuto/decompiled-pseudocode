/*
 * XREFs of RtlRegisterSecureMemoryCacheCallback @ 0x1800F7940
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( result >= 0 )
  {
    ...
    if ( Heap )
    {
      ...
      *(_QWORD *)(Heap + 24) = a1;
      ...
      v8 = (__int64 *)off_180164A80;
      if ( *off_180164A80 != (_UNKNOWN *)&RtlpSecMemListHead )
        __fastfail(3u);
      *(_QWORD *)v7 = &RtlpSecMemListHead;
      *(_QWORD *)(v7 + 8) = v8;
      *v8 = v7;
      off_180164A80 = (_UNKNOWN **)v7;
