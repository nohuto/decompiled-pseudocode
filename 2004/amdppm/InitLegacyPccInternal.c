/*
 * XREFs of InitLegacyPccInternal @ 0x1C000A5E8
 * Callers:
 *     RegisterKernelLegacyPcc @ 0x1C000B1C0 (RegisterKernelLegacyPcc.c)
 *     RegisterHvLegacyPccCounters @ 0x1C0021F40 (RegisterHvLegacyPccCounters.c)
 * Callees:
  ...
  if ( qword_1C0013960 )
  {
          ...
          (v3 = v12) != 0LL) )
    {
      ...
      *((_DWORD *)v3 + 8) = v16;
      ...
      if ( dword_1C00138DC )
      {
        v17 = 0x989680 % ((unsigned int)dword_1C00138DC >> 1);
        *((_DWORD *)v3 + 10) = 0x989680 / ((unsigned int)dword_1C00138DC >> 1);
      }
      *((_DWORD *)v13 + 3) = 0;
      *((_WORD *)v13 + 8) = 0;
      ...
      *((_DWORD *)v3 + 9) = 1;
      ...
      {
        InitCommonPerfStateContext(v32, v23, v24, 100, 0);
        v21 = *(unsigned int **)(v20 + 568);
        *(_QWORD *)v22 = v20;
        *(_DWORD *)(v22 + 48) = 100;
      ...
      if ( v5 >= 0 )
      {
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2528))(
          ...
          qword_1C0013958);
        ResetEnumerationContext((__int64 *)v29);
        if ( !(unsigned int)EnumerateNextDevice((__int64 *)v29, &v32) )
        {
          v25 = v9 + 1;
          v26 = &qword_1C0013450;
          do
          {
            *(_QWORD *)(v32 + 232) = v25 - 1;
            v27 = (__int64 *)qword_1C0013458;
            if ( *(__int64 **)qword_1C0013458 != v26 )
              __fastfail(3u);
            *v25 = v26;
            v25[1] = v27;
            *v27 = (__int64)v25;
            qword_1C0013458 = (__int64)v25;
          }
          while ( !(unsigned int)EnumerateNextDevice((__int64 *)v29, &v32) );
        }
