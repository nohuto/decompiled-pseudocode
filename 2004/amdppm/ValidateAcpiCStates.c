/*
 * XREFs of ValidateAcpiCStates @ 0x1C002996C
 * Callers:
          ...
          if ( LOBYTE(v2[5 * j + 1]) != 127 )
          {
            switch ( LOBYTE(v2[5 * j + 4]) )
            {
              ...
              case 1:
                return (unsigned int)-1073741823;
              case 2:
                if ( !IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0013C1C) )
                {
                  if ( WPP_RECORDER_INITIALIZED == (_UNKNOWN *)&WPP_RECORDER_INITIALIZED )
                    return (unsigned int)-1073741823;
                  v6 = 26;
                ...
                break;
              default:
                if ( !IsValidAcpiGenericAddress((unsigned __int8 *)&dword_1C0013C34)
