/*
 * XREFs of CpcGuaranteedNotifyWorker @ 0x1C0020548
 * Callers:
 *     CpcNativeInterruptWorker @ 0x1C0020B00 (CpcNativeInterruptWorker.c)
 *     AcpiCppcGuaranteedNotifyWorker @ 0x1C0023630 (AcpiCppcGuaranteedNotifyWorker.c)
 * Callees:
          ...
          || (int)StartPccCommand(*(_QWORD *)(v5 + 248)) >= 0 && (int)ExecutePccCommand(*(_QWORD *)(v5 + 248), 0LL) >= 0 )
        {
          ...
          *(_DWORD *)(v7 + 84) = v12;
          if ( v12 != *(_DWORD *)(v5 + 724) )
          {
            ...
            ((void (__fastcall *)(__int64))qword_1C00137C8)(v5);
          }
