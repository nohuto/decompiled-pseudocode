/*
 * XREFs of DecodeAcpiPStates @ 0x1C0030224
 * Callers:
 *     RegisterHvPerfStates @ 0x1C00223C0 (RegisterHvPerfStates.c)
 * Callees:
 *     DecodeControlStatusRegisterIo @ 0x1C00304F0 (DecodeControlStatusRegisterIo.c)
 */
        ...
        _DWORD *a7)
{
  ...
  *a7 = 0;
  ...
  if ( v12 == 127 && (v13 = *(_QWORD *)(a1 + 272), (v13 & 0x60000000) != 0) )
  {
    ...
    else if ( (v13 & 0x20000000) != 0 && dword_1C00135E0 )
    {
      *a2 = *a2 & 0xFFFFFFFFFFFFFLL | 0x10000000000000LL;
      *(_DWORD *)a2 = dword_1C00135E0;
      *a4 = qword_1C00135E8;
    }
  }
