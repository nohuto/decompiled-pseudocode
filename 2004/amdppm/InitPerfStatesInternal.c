/*
 * XREFs of InitPerfStatesInternal @ 0x1C002D780
 * Callers:
 *     RegisterHvPerfStatesCounters @ 0x1C00228B0 (RegisterHvPerfStatesCounters.c)
 *     RegisterKernelPerfStates @ 0x1C002FBF0 (RegisterKernelPerfStates.c)
 * Callees:
 ...
 *     CalculatePercentageCap @ 0x1C002B85C (CalculatePercentageCap.c)
...
LABEL_16:
        ...
        *((_QWORD *)v6 + 42) = PerfControlPTStates;
        LODWORD(v55) = v19;
        if ( dword_1C0013BF8 == 1 || v19 == 252 || (v20 = v19 == 1, v21 = PerfControlPTStatesHidden, v20) )
