/*
 * XREFs of RegisterHvLegacyPcc @ 0x1C0021C60
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeDoorbellAddressIo @ 0x1C0022BF8 (DecodeDoorbellAddressIo.c)
...
__int64 __fastcall RegisterHvLegacyPcc(__int64 a1)
{
  ...
  (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2504))(
    ...
    qword_1C00133F8,
    0LL);
  PerfDomain = GetPerfDomain(a1, v22, &v14);
  if ( (_DWORD)v14 == 253 )
  {
    v7 = 1;
  }
  ...
  v19 = dword_1C0013888;
  v14 = 0LL;
  if ( (unsigned __int8)qword_1C0013880 <= 1u )
  {
    v3 = qword_1C0013878;
    v5 = qword_1C0013870;
    if ( (_BYTE)qword_1C0013880 == 1 )
    {
  ...
  if ( v9 >= 0 )
  {
    HIDWORD(v23[0]) = dword_1C0013830;
    v23[2] = qword_1C0013860;
    LODWORD(v23[3]) = dword_1C0013868;
    v23[6] = v5 << v4;
    v23[5] = v3 << v4;
