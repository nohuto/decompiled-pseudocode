/*
 * XREFs of InitAcpiCpc @ 0x1C0020B78
 * Callers:
 ...
 *     GetSubspaceFromGenAddrEx @ 0x1C0004ED0 (GetSubspaceFromGenAddrEx.c)
 ...
 *     RegisterSubspaceForGenAddr @ 0x1C0022FEC (RegisterSubspaceForGenAddr.c)
