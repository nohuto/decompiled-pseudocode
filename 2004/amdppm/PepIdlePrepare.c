...
__int64 __fastcall PepIdlePrepare(__int64 a1)
{
  ...
  *(_OWORD *)v17 = 0LL;
  v19 = 0LL;
  if ( dword_1C0013968 >= (unsigned int)dword_1C00133F4 )
  {
    ...
    *(_QWORD *)&v19 = *(_QWORD *)(a1 + 24);
    ...
    v17[1] = v6;
    HIDWORD(v19) = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C00136A0)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( (_DWORD)v18 != -1 && (unsigned int)v18 >= dword_1C001398C )
