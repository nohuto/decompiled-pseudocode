/*
 * XREFs of ProcLibTraceControlCallback @ 0x1C001C5F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ProcLibTraceCoordinatedLpiStates @ 0x1C001CC50 (ProcLibTraceCoordinatedLpiStates.c)
        ...
        ULONGLONG MatchAnyKeyword)
{
  ...
  if ( ControlCode == 2 )
  {
    ...
    if ( (dword_1C0013890 & 0x7F077) != 0 )
    {
      LOBYTE(v4) = 1;
      ProcLibTraceIdleStatesErrata(v4);
    }
    if ( (dword_1C0013890 & 0x70000000) != 0 )
    {
      LOBYTE(v4) = 1;
      ProcLibTracePerfStatesErrata(v4);
    }
    if ( (dword_1C0013890 & 0x3300000) != 0 )
    {
      LOBYTE(v4) = 1;
      ProcLibTraceThrottleStatesErrata(v4);
    }
    if ( dword_1C0013890 < 0 )
    {
      LOBYTE(v4) = 1;
