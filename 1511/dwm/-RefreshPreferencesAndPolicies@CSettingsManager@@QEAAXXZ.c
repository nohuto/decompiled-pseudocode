/*
 * XREFs of ?RefreshPreferencesAndPolicies@CSettingsManager@@QEAAXXZ @ 0x140002930
 * Callers:
 ...
 * Callees:
 *     ?ReadRegistryBitfields@CSettingsManager@@AEAAXW4DwmSettingType@@PEAUBitfieldRegistrySetting@@IPEAK@Z @ 0x1400024F0 (-ReadRegistryBitfields@CSettingsManager@@AEAAXW4DwmSettingType@@PEAUBitfieldRegistrySetting@@IPE.c)
...
void __fastcall CSettingsManager::RefreshPreferencesAndPolicies(CSettingsManager *this)
{
  ...
  CSettingsManager::ReadRegistryBitfields((__int64)this, 1u, (__int64)v9, 6u, (_DWORD *)this + 15);
}
