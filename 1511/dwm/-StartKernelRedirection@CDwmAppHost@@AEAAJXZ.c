/*
 * XREFs of ?StartKernelRedirection@CDwmAppHost@@AEAAJXZ @ 0x140001EA0
 * Callers:
 ...
 *     ?SendSimpleAsyncRequest@CPortClient@@QEAAJK@Z @ 0x140002480 (-SendSimpleAsyncRequest@CPortClient@@QEAAJK@Z.c)
