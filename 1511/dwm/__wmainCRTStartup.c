/*
 * XREFs of __wmainCRTStartup @ 0x140002E80
 * Callers:
 *     wWinMainCRTStartup @ 0x140003100 (wWinMainCRTStartup.c)
 * Callees:
 *     wWinMain @ 0x140001AE0 (wWinMain.c)
 *     _XcptFilter_0 @ 0x14000344E (_XcptFilter_0.c)
 *     _amsg_exit_0 @ 0x140003504 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x140003560 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x1400036DA (_initterm_0.c)
