/*
 * XREFs of ?MilInstrumentationBreak@@YAXK_N@Z @ 0x140004EC8
 * Callers:
 ...
 *     ?IsKernelDebuggerEnabled@@YAHXZ @ 0x1400057EC (-IsKernelDebuggerEnabled@@YAHXZ.c)
 *     ?IsKernelDebuggerPresent@@YAHXZ @ 0x14000583C (-IsKernelDebuggerPresent@@YAHXZ.c)
 */
