/*
 * XREFs of ?Evaluate@?$BaseScenarioEvents@$02@details@Health@CreativeFramework@@AEAAXXZ @ 0x1800209B0
 * Callers:
...
void CreativeFramework::Health::details::BaseScenarioEvents<3>::Evaluate()
{
  ...
  v17[1] = -2LL;
  CreativeFramework::Health::details::BaseScenarioEvents<3>::ReadTrackingInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<3,1>::HandleEvent<1,>'::`2'::s_traits);
  ...
  word_18003E2EC = 256;
  pcbData = 20;
  v0 = (const WCHAR *)&qword_18003E2C8;
  if ( (unsigned __int64)qword_18003E2E0 >= 8 )
    v0 = qword_18003E2C8;
  if ( RegGetValueW(HKEY_CURRENT_USER, v0, L"HealthEvaluation", 8u, 0LL, &dword_18003E2A8, &pcbData)
    || pcbData <= 4
    || (_BYTE)dword_18003E2A8 != 1 )
  {
    dword_18003E2A8 = 1;
    qword_18003E2B0 = 0LL;
    qword_18003E2B8 = 0LL;
  ...
  v1 = qword_18003E2B0;
  v2 = qword_18003E2B0 + 864000000000LL;
  v3 = (*(__int64 (__fastcall **)(__int64 *))`CreativeFramework::Health::details::OffersHealthTracker<3,1>::HandleEvent<1,>'::`2'::s_traits)(&`CreativeFramework::Health::details::OffersHealthTracker<3,1>::HandleEvent<1,>'::`2'::s_traits);
  v4 = v3;
  if ( (v3 & 2) != 0 )
    v5 = 2;
  else
    v5 = (v3 & 1) != 0;
  CreativeFramework::Health::details::HealthTrackingInfo::ToString((__int64)&unk_18003E230, v20);
  CreativeFramework::Health::details::PlacementReportedInfo::ToString((__int64)&unk_18003E288, v18);
  v7 = v18;
  if ( v19 >= 8 )
    v7 = (void **)v18[0];
  v17[0] = v7;
  ...
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::PlacementHealthEvaluation<unsigned int,unsigned short,unsigned __int64,unsigned char const &,unsigned short const *,unsigned short const *>(
    ...
    (__int64)&v16,
    (__int64)v17);
  if ( (_WORD)qword_18003E2B8 != v5 || v2 <= *(_QWORD *)&SystemTimeAsFileTime || !v1 )
  {
    LOWORD(qword_18003E2B8) = v5;
    qword_18003E2B0 = (__int64)SystemTimeAsFileTime;
    LOBYTE(word_18003E2EC) = 1;
    CreativeFramework::Health::details::BaseScenarioEvents<3>::WriteHealthEvaluationInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<3,1>::HandleEvent<1,>'::`2'::s_traits);
    v10 = v18;
    if ( v19 >= 8 )
      v10 = (void **)v18[0];
