...
_UNKNOWN **__fastcall Windows::Internal::AsyncBaseFTM_Windows::Foundation::IAsyncActionCompletedHandler_1_Microsoft::WRL::AsyncCausalityOptions___anonymous_namespace_::EnableLockScreenRotationOperationName_GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2___::_AsyncBaseFTM_Windows::Foundation::IAsyncActionCompletedHandler_1_Microsoft::WRL::AsyncCausalityOptions___anonymous_namespace_::EnableLockScreenRotationOperationName_GUID_CAUSALITY_WINDOWS_PLATFORM_ID_2____::_1_::dtor_3(
        __int64 a1,
        __int64 a2)
{
