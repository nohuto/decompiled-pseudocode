/*
 * XREFs of ?ReportFailure_Msg@details@wil@@YAXPEAXIPEBD110W4FailureType@2@J1PEAD@Z @ 0x180002404
 * Callers:
 ...
 *     ?ReportFailure_Win32Msg@details@wil@@YAJPEAXIPEBD110W4FailureType@2@K1PEAD@Z @ 0x1800082B8 (-ReportFailure_Win32Msg@details@wil@@YAJPEAXIPEBD110W4FailureType@2@K1PEAD@Z.c)
 * Callees:
        ...
        va_list Args)
{
  ...
  if ( a9 )
  {
    ...
    v13 = _vsnwprintf(Buffer, 0x7FFuLL, Format, Args);
  ...
  wil::details::ReportFailure(a1, a2, a3, 0LL, 0LL, a6, 1, a8, Buffer);
}
