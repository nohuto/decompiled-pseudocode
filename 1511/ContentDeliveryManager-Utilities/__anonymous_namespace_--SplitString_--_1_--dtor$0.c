/*
 * XREFs of __anonymous_namespace_::SplitString_::_1_::dtor$0 @ 0x180028A9F
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall _anonymous_namespace_::SplitString_::_1_::dtor_0(__int64 a1, __int64 a2)
{
  if ( (*(_DWORD *)(a2 + 32) & 1) != 0 )
  {
    *(_DWORD *)(a2 + 32) &= ~1u;
