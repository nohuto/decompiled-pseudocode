/*
 * XREFs of ?ReportFailure_Win32Msg@details@wil@@YAJPEAXIPEBD110W4FailureType@2@K1PEAD@Z @ 0x1800082B8
 * Callers:
        ...
        va_list a10)
{
  ...
  if ( a8 <= 0 )
    v10 = a8;
  wil::details::ReportFailure_Msg(a1, a2, a3, (__int64)a10, v12, a6, v13, v10, a9, a10);
  return v10;
}
