/*
 * XREFs of ?ProcessCreativeEventUriAsync@ContentManagementService@ContentManagement@@UEAAJW4CreativeEventType@2@PEAUHSTRING__@@PEAU?$ITypedEventHandler@PEAUIInspectable@@PEAUHSTRING__@@@Foundation@Windows@@PEAUICreativeEventReportedCache@2@PEAPEAUIAsyncAction@67@@Z @ 0x18000F150
 * Callers:
 *     <none>
 * Callees:
...
LABEL_10:
    ...
    if ( v16 )
      ...
      v17 = 0LL;
    if ( v14 )
      v18 = *(HSTRING *)Windows::Internal::StringReference::StringReference(v27, v23);
    else
      v18 = 0LL;
    v23[0] = v28[3];
    v22 = v28[0];
    v19 = *(HSTRING *)Windows::Internal::StringReference::StringReference(v25, v23);
    v20 = (HSTRING *)Windows::Internal::StringReference::StringReference(v26, &v22);
