/*
 * XREFs of ??5?$basic_istream@GU?$char_traits@G@std@@@std@@QEAAAEAV01@AEA_K@Z @ 0x180012698
 * Callers:
...
__int64 __fastcall std::basic_istream<unsigned short>::operator>>(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)std::basic_istream<unsigned short>::_Ipfx(v3) )
  {
    ...
    try
    {
      ...
      v20 = *(_QWORD *)(v9 + 72);
      v21 = v20 == 0;
      (*(void (__fastcall **)(__int64, _BYTE *, __int64 *, __int64 *, __int64, int *, __int64))(*(_QWORD *)v7 + 56LL))(
        v7,
        v24,
        &v20,
        &v18,
