/*
 * XREFs of ?NotifyFailure@?$ActivityBase@$00$0CAAAAAAAAAAA@$04@wil@@UEAA_NAEBUFailureInfo@2@@Z @ 0x180013480
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall wil::ActivityBase<1,35184372088832,5>::NotifyFailure(__int64 a1, int *a2)
{
  __int64 v4; // rdi
  bool v5; // al
  ...
  v4 = *(_QWORD *)(a1 + 48);
  v5 = `wil::TraceLoggingProvider::WasAlreadyReportedToTelemetry'::`2'::s_lastFailureSeen == a2[2];
  `wil::TraceLoggingProvider::WasAlreadyReportedToTelemetry'::`2'::s_lastFailureSeen = a2[2];
  v6 = *(const struct _TlgProvider_t **)(v4 + 40);
  if ( v5 )
  {
    if ( *(_DWORD *)v6 > 5u
      ...
      && (*((_QWORD *)v6 + 3) & 0x200000000000LL) == *((_QWORD *)v6 + 3) )
    {
      ...
      v101 = v26 + 1;
      v102 = 0;
      TlgWrite(v6, &unk_18003540E, (LPCGUID)(v4 + 8), 0LL, 0x13u, &v59);
    }
  }
         ...
         && (*((_QWORD *)v6 + 3) & 0x200000000000LL) == *((_QWORD *)v6 + 3) )
  {
    ...
    v138 = 2 * v9 + 2;
    v139 = 0;
    TlgWrite(v6, &unk_180035AB7, (LPCGUID)(v4 + 8), 0LL, 0x10u, &pData);
  }
