/*
 * XREFs of ?EnableStartMenuSystemPaneSuggestionsAsync@ContentManagementService@ContentManagement@@UEAAJEPEAPEAUIAsyncAction@Foundation@Windows@@@Z @ 0x18000F7B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Foundation::IAsyncAction **a3)
{
  ...
  v24 = (volatile signed __int64 *)((char *)this - 56);
...
LABEL_12:
  ...
  if ( v10 )
  {
    *v10 = &Windows::Internal::COperationLambda0<Windows::Internal::CCallAsyncLambda<_lambda_82a1deb2fd1f92bff772f318311266e7_>,Windows::Internal::CNoResult>::`vftable';
    v10[1] = v5;
    if ( v5 )
    {
      v11 = *((_QWORD *)v5 + 10);
