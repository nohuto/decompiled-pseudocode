/*
 * XREFs of ??$use_facet@V?$numpunct@G@std@@@std@@YAAEBV?$numpunct@G@0@AEBVlocale@0@@Z @ 0x180018DD8
 * Callers:
 ...
 *     ?_Getgloballocale@locale@std@@CAPEAV_Locimp@12@XZ @ 0x1800230C0 (-_Getgloballocale@locale@std@@CAPEAV_Locimp@12@XZ.c)
