/*
 * XREFs of ?EnableLockScreenOverlayAsync@ContentManagementService@ContentManagement@@UEAAJEPEAPEAUIAsyncAction@Foundation@Windows@@@Z @ 0x18000F590
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  if ( v10 )
  {
    *v10 = &Windows::Internal::COperationLambda0<Windows::Internal::CCallAsyncLambda<_lambda_8863cfc67a71fefde8f9ae84226401b4_>,Windows::Internal::CNoResult>::`vftable';
    v10[1] = v5;
    if ( v5 )
    {
      v11 = *((_QWORD *)v5 + 10);
