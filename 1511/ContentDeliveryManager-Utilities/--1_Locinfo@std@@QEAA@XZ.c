/*
 * XREFs of ??1_Locinfo@std@@QEAA@XZ @ 0x18000A624
 * Callers:
 ...
 *     _std::numpunct_unsigned_short_::_Getcat_::_1_::dtor$1 @ 0x18002931B (_std--numpunct_unsigned_short_--_Getcat_--_1_--dtor$1.c)
 * Callees:
 *     ?_Locinfo_dtor@_Locinfo@std@@SAXPEAV12@@Z @ 0x1800232B8 (-_Locinfo_dtor@_Locinfo@std@@SAXPEAV12@@Z.c)
 */
