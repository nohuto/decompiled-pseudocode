/*
 * XREFs of _CRT_INIT @ 0x1800276BC
 * Callers:
 *     __DllMainCRTStartup @ 0x180027964 (__DllMainCRTStartup.c)
 * Callees:
 *     ?_Add_vtordisp2@?$basic_ios@GU?$char_traits@G@std@@@std@@UEAAXXZ @ 0x18000B1C0 (-_Add_vtordisp2@-$basic_ios@GU-$char_traits@G@std@@@std@@UEAAXXZ.c)
 *     _amsg_exit_0 @ 0x18002823A (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1800282A0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x18002840A (_initterm_0.c)
 */
...
LABEL_37:
    ...
    if ( _dyn_tls_init_callback && (unsigned int)IsNonwritableInCurrentImage(&_dyn_tls_init_callback) )
      _dyn_tls_init_callback(a1, 2LL, a3);
    ++dword_18003D64C;
  }
  return 1LL;
}
