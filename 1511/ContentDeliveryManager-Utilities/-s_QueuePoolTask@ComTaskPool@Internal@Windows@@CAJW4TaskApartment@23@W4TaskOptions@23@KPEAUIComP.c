/*
 * XREFs of ?s_QueuePoolTask@ComTaskPool@Internal@Windows@@CAJW4TaskApartment@23@W4TaskOptions@23@KPEAUIComPoolTask@23@@Z @ 0x180009604
 * Callers:
...
LABEL_11:
    v11 = Windows::Internal::ComTaskPool::s_QueuePoolTaskUnderLock(Event, a1, a2, a3, a4, &v16, v15);
    v8 = v15[0];
    goto LABEL_12;
  }
