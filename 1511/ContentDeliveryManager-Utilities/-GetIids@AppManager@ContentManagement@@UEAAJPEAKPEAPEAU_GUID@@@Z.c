/*
 * XREFs of ?GetIids@AppManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180003460
 * Callers:
 *     ?GetIids@AppManager@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180006040 (-GetIids@AppManager@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
