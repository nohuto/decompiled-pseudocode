/*
 * XREFs of ?Evaluate@?$BaseScenarioEvents@$00@details@Health@CreativeFramework@@AEAAXXZ @ 0x180020464
 * Callers:
...
void CreativeFramework::Health::details::BaseScenarioEvents<1>::Evaluate()
{
  ...
  v17[1] = -2LL;
  CreativeFramework::Health::details::BaseScenarioEvents<3>::ReadTrackingInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<1,1>::HandleEvent<1,>'::`2'::s_traits);
  ...
  if ( (unsigned __int64)qword_18003DF80 >= 8 )
    v0 = lpSubKey;
  if ( RegGetValueW(HKEY_CURRENT_USER, v0, L"HealthEvaluation", 8u, 0LL, &dword_18003DF48, &pcbData)
    || pcbData <= 4
    || (_BYTE)dword_18003DF48 != 1 )
  {
    dword_18003DF48 = 1;
    qword_18003DF50 = 0LL;
    qword_18003DF58 = 0LL;
  ...
  v1 = qword_18003DF50;
  v2 = qword_18003DF50 + 864000000000LL;
  v3 = (*(__int64 (__fastcall **)(__int64 *))`CreativeFramework::Health::details::OffersHealthTracker<1,1>::HandleEvent<1,>'::`2'::s_traits)(&`CreativeFramework::Health::details::OffersHealthTracker<1,1>::HandleEvent<1,>'::`2'::s_traits);
  v4 = v3;
  if ( (v3 & 2) != 0 )
    v5 = 2;
  else
    v5 = (v3 & 1) != 0;
  CreativeFramework::Health::details::HealthTrackingInfo::ToString((__int64)&unk_18003DED0, v20);
  CreativeFramework::Health::details::PlacementReportedInfo::ToString((__int64)&unk_18003DF28, v18);
  v7 = v18;
  if ( v19 >= 8 )
    v7 = (void **)v18[0];
  v17[0] = v7;
  ...
  ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry::PlacementHealthEvaluation<unsigned int,unsigned short,unsigned __int64,unsigned char const &,unsigned short const *,unsigned short const *>(
    ...
    (__int64)&v16,
    (__int64)v17);
  if ( (_WORD)qword_18003DF58 != v5 || v2 <= *(_QWORD *)&SystemTimeAsFileTime || !v1 )
  {
    LOWORD(qword_18003DF58) = v5;
    qword_18003DF50 = (__int64)SystemTimeAsFileTime;
    LOBYTE(word_18003DF8C) = 1;
    CreativeFramework::Health::details::BaseScenarioEvents<3>::WriteHealthEvaluationInfo((__int64)&`CreativeFramework::Health::details::OffersHealthTracker<1,1>::HandleEvent<1,>'::`2'::s_traits);
    v10 = v18;
    if ( v19 >= 8 )
      v10 = (void **)v18[0];
