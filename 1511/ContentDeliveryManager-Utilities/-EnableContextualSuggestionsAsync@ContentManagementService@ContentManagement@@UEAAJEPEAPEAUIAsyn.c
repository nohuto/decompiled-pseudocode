/*
 * XREFs of ?EnableContextualSuggestionsAsync@ContentManagementService@ContentManagement@@UEAAJEPEAPEAUIAsyncAction@Foundation@Windows@@@Z @ 0x18000F9D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct Windows::Foundation::IAsyncAction **a3)
{
  ...
  v24 = (volatile signed __int64 *)((char *)this - 64);
...
LABEL_12:
  ...
  if ( v10 )
  {
    *v10 = &Windows::Internal::COperationLambda0<Windows::Internal::CCallAsyncLambda<_lambda_2b7d66fc27412c4e6ec15ee59f9d837a_>,Windows::Internal::CNoResult>::`vftable';
    v10[1] = v5;
    if ( v5 )
    {
      v11 = *((_QWORD *)v5 + 10);
