/*
 * XREFs of ?GetIids@ContextualSuggestionsManager@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180003AF0
 * Callers:
 *     ?GetIids@ContextualSuggestionsManager@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180006140 (-GetIids@ContextualSuggestionsManager@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
