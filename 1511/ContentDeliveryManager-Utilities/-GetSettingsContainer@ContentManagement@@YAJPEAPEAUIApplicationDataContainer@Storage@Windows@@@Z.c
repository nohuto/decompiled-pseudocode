/*
 * XREFs of ?GetSettingsContainer@ContentManagement@@YAJPEAPEAUIApplicationDataContainer@Storage@Windows@@@Z @ 0x180010FAC
 * Callers:
        ...
        struct Windows::Storage::IApplicationDataContainer **a2)
{
  ...
  _QWORD *v18; // rax
  __int64 v19; // rsi
  ContentManagement *v20; // rdi
  __int64 v21; // rsi
  ContentManagement *v22; // r14
  __int64 v23; // rsi
  __int64 v24; // rsi
  __int64 v25; // rsi
  unsigned __int16 v27; // [rsp+28h] [rbp-29h] BYREF
  __int64 v28; // [rsp+30h] [rbp-21h] BYREF
  ContentManagement *v29; // [rsp+38h] [rbp-19h] BYREF
  __int64 v30; // [rsp+40h] [rbp-11h] BYREF
  __int64 v31; // [rsp+48h] [rbp-9h] BYREF
  __int64 v32; // [rsp+50h] [rbp-1h] BYREF
  unsigned __int16 v33[4]; // [rsp+58h] [rbp+7h] BYREF
  ...
  *(_QWORD *)this = 0LL;
  ...
  ActivationFactory = RoGetActivationFactory(string, &GUID_5612147b_e843_45e3_94d8_06169e3c8e17, &v30);
  ...
  {
    v31 = 0LL;
    v6 = (*(__int64 (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v32 + 80LL))(v32, &v31);
    v4 = v6;
    if ( v6 < 0 )
    {
      wil::details::in1diag3::Return_HrPreRelease(
...
LABEL_38:
    ...
    v28 = 0LL;
    v7 = v31;
    v8 = (_QWORD *)Windows::Internal::StringReference::StringReference(&string, &off_1800311F8);
...
LABEL_36:
    ...
    {
      v14 = v31;
      v15 = (_QWORD *)Windows::Internal::StringReference::StringReference(&string, &off_1800311F8);
      ...
      v18 = (_QWORD *)Windows::Internal::StringReference::StringReference(&string, &off_1800311F8);
