/*
 * XREFs of ?LogFailure_@ShellPlacementTelemetry@Logging@CreativeFramework@@QEAAXPEAUFailureInfo@wil@@@Z @ 0x18000CC98
 * Callers:
...
void __fastcall CreativeFramework::Logging::ShellPlacementTelemetry::LogFailure_(
        ...
        struct wil::FailureInfo *a2)
{
  ...
  v3 = (const struct _TlgProvider_t *)*((_QWORD *)CreativeFramework::Logging::ShellPlacementTelemetry::Instance() + 1);
  if ( *(_DWORD *)v3 > 5u
