/*
 * XREFs of ?_Init@?$numpunct@G@std@@IEAAXAEBV_Locinfo@2@_N@Z @ 0x1800196A0
 * Callers:
 ...
 * Callees:
 *     ??$_Maklocstr@G@std@@YAPEAGPEBDPEAGAEBU_Cvtvec@@@Z @ 0x18000A7B8 (--$_Maklocstr@G@std@@YAPEAGPEBDPEAGAEBU_Cvtvec@@@Z.c)
...
wchar_t *__fastcall std::numpunct<unsigned short>::_Init(mbstate_t a1, __int64 a2, char a3)
{
  ...
  *(_QWORD *)(*(_QWORD *)&a1 + 40LL) = 0LL;
  ...
  {
    std::numpunct<unsigned short>::_Tidy(*(void ***)&v15);
    throw;
  }
  if ( a3 )
  {
