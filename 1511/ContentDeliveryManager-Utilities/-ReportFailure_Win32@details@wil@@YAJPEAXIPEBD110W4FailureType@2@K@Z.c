/*
 * XREFs of ?ReportFailure_Win32@details@wil@@YAJPEAXIPEBD110W4FailureType@2@K@Z @ 0x180008250
 * Callers:
        ...
        int a8)
{
  ...
  wil::details::ReportFailure(
    a1,
    a2,
    (__int64)"shell\\contentdeliverymanager\\utils\\inc\\offershealthtracker.h",
    0LL,
    0LL,
    a6,
    3,
