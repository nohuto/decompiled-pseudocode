        ...
        __int64 a1)
{
  ...
  if ( v10 == 3 )
  {
    ...
    if ( v11 == 3 )
    {
      _InterlockedCompareExchange(&v9, *(_DWORD *)(a1 - 84), v9);
      if ( *(_QWORD *)(a1 - 96) )
  ...
  if ( v4 >= 0 )
  {
    ...
    if ( v7[0] == 3 )
    {
      _InterlockedCompareExchange((volatile signed __int32 *)&v8, *(_DWORD *)(a1 - 84), v8);
      if ( *(_QWORD *)(a1 - 96) )
        SetRestrictedErrorInfo();
      return v8;
    }
