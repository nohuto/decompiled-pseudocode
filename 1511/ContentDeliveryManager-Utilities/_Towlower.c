/*
 * XREFs of _Towlower @ 0x180023928
 * Callers:
 *     ?do_tolower@?$ctype@G@std@@MEBAGG@Z @ 0x18000AB10 (-do_tolower@-$ctype@G@std@@MEBAGG@Z.c)
 *     ?do_tolower@?$ctype@G@std@@MEBAPEBGPEAGPEBG@Z @ 0x18000AB30 (-do_tolower@-$ctype@G@std@@MEBAPEBGPEAGPEBG@Z.c)
 * Callees:
