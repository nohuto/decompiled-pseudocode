/*
 * XREFs of ?GetIids@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAKPEAPEAU_GUID@@@Z @ 0x180006500
 * Callers:
 *     ?GetIids@ContentManagementBrokerServer@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z @ 0x180007E40 (-GetIids@ContentManagementBrokerServer@ContentManagement@@WCI@EAAJPEAKPEAPEAU_GUID@@@Z.c)
 * Callees:
 *     <none>
 */
