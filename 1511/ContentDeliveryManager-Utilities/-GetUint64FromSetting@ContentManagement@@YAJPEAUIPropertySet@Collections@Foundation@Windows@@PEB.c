/*
 * XREFs of ?GetUint64FromSetting@ContentManagement@@YAJPEAUIPropertySet@Collections@Foundation@Windows@@PEBGPEA_K@Z @ 0x180010654
 * Callers:
        ...
        unsigned __int64 *a4)
{
  ...
  *(_QWORD *)a3 = 0LL;
  ...
  if ( v12 >= 0 )
  {
    ...
    if ( v13 >= 0 )
    {
      v13 = (*(__int64 (__fastcall **)(__int64, const unsigned __int16 *))(*(_QWORD *)v21 + 112LL))(v21, a3);
      v9 = v13;
      if ( v13 >= 0 )
      {
        v9 = 0;
