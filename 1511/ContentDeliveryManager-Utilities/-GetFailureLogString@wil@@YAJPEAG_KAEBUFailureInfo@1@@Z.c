/*
 * XREFs of ?GetFailureLogString@wil@@YAJPEAG_KAEBUFailureInfo@1@@Z @ 0x18000150C
 * Callers:
 ...
 * Callees:
 *     ?LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ @ 0x180001488 (-LogStringPrintf@details@wil@@YAPEAGPEAGPEBG1ZZ.c)
        ...
        const struct wil::FailureInfo *a4)
{
  ...
  v14 = v12;
  if ( v13 )
    v14 = wil::details::LogStringPrintf((wil::details *)v12, v10, L"(caller: %p) ", v13);
  ...
  {
    v18 = wil::details::LogStringPrintf((wil::details *)v16, v10, L"    ", v17);
