/*
 * XREFs of ?get_ContextualSuggestionsManager@ContentManagementBrokerServer@ContentManagement@@UEAAJPEAPEAUIContextualSuggestionsManager@2@@Z @ 0x180003D30
 * Callers:
 *     <none>
 * Callees:
        ...
        struct ContentManagement::IContextualSuggestionsManager **a2)
{
  ...
  __int64 v11; // rdx
  int v12; // eax
  __int64 (__fastcall ***v13)(_QWORD, GUID *, struct ContentManagement::IContextualSuggestionsManager **); // rdi
