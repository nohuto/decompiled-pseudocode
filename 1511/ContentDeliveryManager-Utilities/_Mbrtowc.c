/*
 * XREFs of _Mbrtowc @ 0x180023A5C
 * Callers:
 *     ??$_Maklocstr@G@std@@YAPEAGPEBDPEAGAEBU_Cvtvec@@@Z @ 0x18000A7B8 (--$_Maklocstr@G@std@@YAPEAGPEBDPEAGAEBU_Cvtvec@@@Z.c)
 *     ?do_widen@?$ctype@G@std@@MEBAGD@Z @ 0x18000AC30 (-do_widen@-$ctype@G@std@@MEBAGD@Z.c)
 *     ?do_widen@?$ctype@G@std@@MEBAPEBDPEBD0PEAG@Z @ 0x18000AC80 (-do_widen@-$ctype@G@std@@MEBAPEBDPEBD0PEAG@Z.c)
