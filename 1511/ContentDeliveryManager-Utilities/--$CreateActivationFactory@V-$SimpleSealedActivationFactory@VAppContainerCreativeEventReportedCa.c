/*
 * XREFs of ??$CreateActivationFactory@V?$SimpleSealedActivationFactory@VAppContainerCreativeEventReportedCache@ContentManagement@@$0A@@WRL@Microsoft@@@Details@WRL@Microsoft@@YAJPEAIPEBUCreatorMap@012@AEBU_GUID@@PEAPEAUIUnknown@@@Z @ 0x180007520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Microsoft::WRL::Details::CreateActivationFactory<Microsoft::WRL::SimpleSealedActivationFactory<ContentManagement::AppContainerCreativeEventReportedCache,0>>(
        _BYTE *a1,
        __int64 a2,
        _DWORD *a3,
        volatile signed __int32 **a4)
{
  ...
  if ( v9 )
  {
    ...
    *(_QWORD *)v9 = &Microsoft::WRL::SimpleSealedActivationFactory<ContentManagement::AppContainerCreativeEventReportedCache,0>::`vftable';
