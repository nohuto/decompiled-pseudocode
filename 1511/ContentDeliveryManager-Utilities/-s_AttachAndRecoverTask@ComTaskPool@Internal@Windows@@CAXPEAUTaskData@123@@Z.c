/*
 * XREFs of ?s_AttachAndRecoverTask@ComTaskPool@Internal@Windows@@CAXPEAUTaskData@123@@Z @ 0x180009E60
 * Callers:
 *     ?s_CheckForDeadlockTimerCallback@CThread@ComTaskPool@Internal@Windows@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_TIMER@@@Z @ 0x180008ED0 (-s_CheckForDeadlockTimerCallback@CThread@ComTaskPool@Internal@Windows@@CAXPEAU_TP_CALLBACK_INSTA.c)
        ...
        struct Windows::Internal::ComTaskPool::TaskData *a1)
{
              ...
              *((_QWORD *)a1 + 2)) < 0 )
  {
    ...
    if ( qword_18003DDE0 )
      *(_QWORD *)(qword_18003DDE0 + 24) = a1;
    else
      Windows::Internal::ComTaskPool::s_taskFloodingList = (__int64)a1;
    qword_18003DDE0 = (__int64)a1;
