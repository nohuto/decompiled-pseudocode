/*
 * XREFs of ??$ReportPlacementHealth@IG_KAEBEPEBGPEBG@ContentDeliveryManagerTelemetry@Background@ContentDeliveryManager@@SAX$$QEAI$$QEAG$$QEA_KAEBE$$QEAPEBG4@Z @ 0x1800212C4
 * Callers:
        ...
        void **a6)
{
  ...
  if ( *(_DWORD *)v10 > 5u && (*((_QWORD *)v10 + 2) & 0x800000000000LL) != 0 )
  {
    v9 = (struct ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry *)(*((_QWORD *)v10 + 3) & 0x800000000000LL);
    if ( v9 == *((struct ContentDeliveryManager::Background::ContentDeliveryManagerTelemetry **)v10 + 3) )
    {
      v21 = a3;
      v17 = a1;
      v23 = &unk_180031350;
      ...
      v29 = 2 * v14 + 2;
      v30 = 0;
      LODWORD(v9) = TlgWrite(v10, &unk_18003533A, 0LL, 0LL, 8u, &pData);
    }
  }
  return (int)v9;
}
