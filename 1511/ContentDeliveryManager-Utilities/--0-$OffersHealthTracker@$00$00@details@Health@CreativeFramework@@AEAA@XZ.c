/*
 * XREFs of ??0?$OffersHealthTracker@$00$00@details@Health@CreativeFramework@@AEAA@XZ @ 0x18001A078
 * Callers:
...
__int64 __fastcall CreativeFramework::Health::details::OffersHealthTracker<1,1>::OffersHealthTracker<1,1>(__int64 a1)
{
