/*
 * XREFs of HUBUCX_GetRootHubInfoUsingUCXIoctl @ 0x1C001DCB0
 * Callers:
...
void __fastcall HUBUCX_GetRootHubInfoUsingUCXIoctl(__int64 a1)
{
  ...
  WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2464), 2u, 3u, v5, (__int64)&WPP_57a0096b32d7c853b2434a6bcfb35827_Traceguids, v3);
LABEL_6:
  if ( v4 < 0 )
  {
    if ( v6 )
