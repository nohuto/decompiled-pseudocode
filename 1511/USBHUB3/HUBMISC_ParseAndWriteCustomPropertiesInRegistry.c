/*
 * XREFs of HUBMISC_ParseAndWriteCustomPropertiesInRegistry @ 0x1C0069EA4
 * Callers:
 *     HUBDSM_WritingCustomPropertiesInRegistry @ 0x1C001B9A0 (HUBDSM_WritingCustomPropertiesInRegistry.c)
 * Callees:
