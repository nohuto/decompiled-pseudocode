/*
 * XREFs of TelemetryData_CreateReport @ 0x1C0031570
 * Callers:
 *     WER_CreateReport @ 0x1C00308C0 (WER_CreateReport.c)
 * Callees:
 *     RtlStringCbPrintfW @ 0x1C000F5AC (RtlStringCbPrintfW.c)
...
_QWORD *__fastcall TelemetryData_CreateReport(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( PoolWithTag )
  {
    ...
    *v7 = v8;
    if ( v8
      && RtlStringCbPrintfW((NTSTRSAFE_PWSTR)v7 + 312, 0x20uLL, L"%ws", L"USBHUB3") >= 0
      && (RtlCaptureContext(&ContextRecord),
          (v9 = ((__int64 (__fastcall *)(CONTEXT *, _QWORD, __int64, __int64, __int64, _QWORD, _QWORD, _QWORD))KeCapturePersistentThreadState)(
                  &ContextRecord,
                  0LL,
                  324LL,
                  a3,
