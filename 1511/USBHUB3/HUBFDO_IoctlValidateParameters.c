/*
 * XREFs of HUBFDO_IoctlValidateParameters @ 0x1C0063830
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( a3 < a2 )
  {
    ...
    v8 = 34;
LABEL_11:
    WPP_RECORDER_SF_(v7, 2u, 3u, v8, (__int64)&WPP_09f4d0c5c09a38c56fad3299ef2ac878_Traceguids);
    return (unsigned int)-1073741811;
  }
  if ( a6 < a5 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0x23u, (__int64)&WPP_09f4d0c5c09a38c56fad3299ef2ac878_Traceguids);
