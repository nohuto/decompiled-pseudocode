/*
 * XREFs of HUBDESC_ValidateMsOs20FunctionSubset @ 0x1C002F250
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Bu, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
...
LABEL_4:
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x13Cu, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
  return v8;
}
