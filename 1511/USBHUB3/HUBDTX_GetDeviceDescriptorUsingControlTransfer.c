/*
 * XREFs of HUBDTX_GetDeviceDescriptorUsingControlTransfer @ 0x1C0020894
 * Callers:
 *     HUBDSM_GettingAlternateDeviceDescriptor @ 0x1C0018AE0 (HUBDSM_GettingAlternateDeviceDescriptor.c)
 * Callees:
