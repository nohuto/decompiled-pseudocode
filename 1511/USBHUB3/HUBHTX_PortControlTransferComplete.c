/*
 * XREFs of HUBHTX_PortControlTransferComplete @ 0x1C00033F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHTX_PortControlTransferComplete(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  else
  {
    WPP_RECORDER_SF_dD(
      ...
      *(_DWORD *)(a3 + 8),
      *(_DWORD *)(a4 + 44));
    if ( (*(_DWORD *)(*(_QWORD *)v5 + 2536LL) & 2) != 0 )
      HUBMISC_VerifierDbgBreak("HubHwVerifierControlTransferFailure", *(_QWORD *)v5 + 1208LL);
    *(_DWORD *)(*(_QWORD *)v5 + 2540LL) = 1073872897;
