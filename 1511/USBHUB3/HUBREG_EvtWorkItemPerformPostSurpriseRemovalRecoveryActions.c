/*
 * XREFs of HUBREG_EvtWorkItemPerformPostSurpriseRemovalRecoveryActions @ 0x1C006DB40
 * Callers:
 *     <none>
 * Callees:
...
LABEL_13:
  LODWORD(v12) = v6;
  WPP_RECORDER_SF_d(*(_QWORD *)(v7 + 64), 2u, 2u, v8, (__int64)&WPP_488b6272cf1c0d12ea361b5ad05fb8f5_Traceguids, v12);
LABEL_14:
  if ( v16 )
