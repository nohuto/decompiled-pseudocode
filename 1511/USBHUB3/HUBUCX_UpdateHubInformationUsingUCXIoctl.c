/*
 * XREFs of HUBUCX_UpdateHubInformationUsingUCXIoctl @ 0x1C001EA2C
 * Callers:
 *     HUBHSM_UpdatingHubInfoInUCX @ 0x1C00082E0 (HUBHSM_UpdatingHubInfoInUCX.c)
 * Callees:
...
LABEL_3:
    LODWORD(v6) = v3;
    WPP_RECORDER_SF_d(*(_QWORD *)(a1 + 2464), 2u, 3u, v5, (__int64)&WPP_57a0096b32d7c853b2434a6bcfb35827_Traceguids, v6);
    goto LABEL_14;
  }
  memset(v7, 0, 0x38uLL);
  v7[4] = v9;
