...
void __fastcall HUBDRIVER_EtwRundownHub(const GUID *a1, __int64 a2)
{
  ...
  if ( v4 )
  {
    ...
    if ( v5 )
    {
      if ( v5 == 2 && ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 1) != 0 )
        Template_pq(
          (__int64)a1,
    ...
    else if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 1) != 0 )
    {
      Template_pnq(
        a2 + 1124,
  ...
  if ( (_QWORD *)(a2 + 2304) != v8 )
  {
    do
    {
      ...
      {
        if ( v9 != 5000 || ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 1) == 0 )
          goto LABEL_72;
        v10 = *(_DWORD *)(a2 + 152);
        if ( v10 == 1 )
      ...
      v6 = (_QWORD *)(a2 + 2304);
LABEL_72:
      if ( (*(_DWORD *)(v7 + 204) & 2) != 0 && ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 1) != 0 )
      {
        LODWORD(v25) = 12;
        LODWORD(v24) = *(unsigned __int16 *)(v7 + 200);
        Template_pqn(
      ...
      if ( (*(_DWORD *)(v7 + 204) & 4) != 0 && ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 1) != 0 )
      {
        LODWORD(v25) = 16;
        LODWORD(v24) = *(unsigned __int16 *)(v7 + 200);
        Template_pqn(
