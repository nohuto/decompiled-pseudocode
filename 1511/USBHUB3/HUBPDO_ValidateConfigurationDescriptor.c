/*
 * XREFs of HUBPDO_ValidateConfigurationDescriptor @ 0x1C00110D0
 * Callers:
 ...
 *     HUBPDO_ValidateBuffer @ 0x1C001109C (HUBPDO_ValidateBuffer.c)
...
__int64 __fastcall HUBPDO_ValidateConfigurationDescriptor(__int64 a1, unsigned __int8 *a2, int a3)
{
  ...
  if ( !v15 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(v13 + 1432), 2u, 5u, 0x1Au, (__int64)&WPP_eff6e990951eaa46dbce5c3335bd4113_Traceguids);
    return (unsigned int)-1073737984;
  }
