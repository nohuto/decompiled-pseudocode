/*
 * XREFs of HUBUCX_CheckIfEndpointsNeedToBeDisabledOnConfigFailure @ 0x1C001F4B8
 * Callers:
 *     HUBDSM_CheckingIfEndpointsToBeDisabledOnDetach @ 0x1C001BCB0 (HUBDSM_CheckingIfEndpointsToBeDisabledOnDetach.c)
 * Callees:
