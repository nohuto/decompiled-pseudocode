/*
 * XREFs of HUBPDO_EvtDeviceSurpriseRemoval @ 0x1C0067390
 * Callers:
 *     <none>
 * Callees:
 *     Template_p @ 0x1C0006048 (Template_p.c)
 *     HUBUCX_CheckIfHubIsDisconnected @ 0x1C001F368 (HUBUCX_CheckIfHubIsDisconnected.c)
 *     HUBMISC_RemoveDeviceInfoFromGlobalChildList @ 0x1C00255F4 (HUBMISC_RemoveDeviceInfoFromGlobalChildList.c)
