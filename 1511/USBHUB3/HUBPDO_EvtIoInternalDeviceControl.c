/*
 * XREFs of HUBPDO_EvtIoInternalDeviceControl @ 0x1C0010790
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)(*(_QWORD *)(v7 + 24) + 440LL) = a2;
                  ...
                  + 4) & 0x1000) != 0 )
  {
    ...
    if ( (!WPP_MAIN_CB.Queue.Wcb.DeviceObject
       || ((int (__fastcall *)(__int64, GUID *))WPP_MAIN_CB.Queue.Wcb.DeviceObject)(v12, &ActivityId) < 0)
      && EtwActivityIdControl(3u, &ActivityId) >= 0 )
    {
      ...
      if ( *(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters )
        (*(void (__fastcall **)(__int64, GUID *))&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters)(v11, &ActivityId);
    }
  }
