/*
 * XREFs of HUBDESC_Validate20HubDescriptor @ 0x1C002EAB8
 * Callers:
...
char __fastcall HUBDESC_Validate20HubDescriptor(unsigned __int8 *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( !a1 )
  {
    WPP_RECORDER_SF_(a4, 2u, 5u, 0x120u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 2LL);
LABEL_40:
    v9 = 0;
    WPP_RECORDER_SF_(v5, 2u, 5u, 0x12Bu, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    return v9;
  }
  if ( !a1[2] )
  {
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x122u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, 0);
  ...
  if ( *a1 > v10 )
  {
    LODWORD(v21) = v10;
    LODWORD(v20) = *a1;
    WPP_RECORDER_SF_dD(v5, 2u, 5u, 0x124u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v20, v21);
  ...
  {
    LODWORD(v20) = v12;
    WPP_RECORDER_SF_d(v5, 2u, 5u, 0x125u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v20);
  ...
  if ( (v13 & 2) != 0 )
  {
    if ( *(_BYTE *)(a3 + 15) )
      v4 = 2;
    LODWORD(v20) = v13;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x126u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v20);
  ...
  if ( (v13 & 0xFF00) != 0 )
  {
    ...
    v15 = a4;
    LODWORD(v20) = v14;
    WPP_RECORDER_SF_d(a4, 2u, 5u, 0x127u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v20);
    (*(void (__fastcall **)(_QWORD, __int64))(a3 + 24))(*(_QWORD *)(a3 + 40), 9LL);
  }
  else
  {
  ...
  if ( (a1[7] & 1) != 0 )
  {
    if ( *(_BYTE *)(a3 + 15) )
      v4 = 2;
    WPP_RECORDER_SF_(v15, 2u, 5u, 0x128u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
  ...
  if ( -1 << v16 != 0xFF && ((unsigned __int8)(-1 << v16) & a1[v24 - 1 + 7]) != 0 )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a3) )
      v4 = 2;
    WPP_RECORDER_SF_(v15, 2u, 5u, 0x129u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
  ...
  for ( i = 0; i < v23; ++i )
  {
    if ( a1[i + 7 + v17] != 0xFF )
    {
      if ( HUBDESC_ShouldEnforceWin8ValidationMutable(a3) )
        v4 = 2;
      WPP_RECORDER_SF_(a4, 2u, 5u, 0x12Au, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
