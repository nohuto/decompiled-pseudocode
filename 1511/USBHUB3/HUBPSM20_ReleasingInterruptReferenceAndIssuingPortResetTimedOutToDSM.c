/*
 * XREFs of HUBPSM20_ReleasingInterruptReferenceAndIssuingPortResetTimedOutToDSM @ 0x1C000DFE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBPSM20_ReleasingInterruptReferenceAndIssuingPortResetTimedOutToDSM(__int64 a1)
{
  ...
  v1 = *(_QWORD *)(a1 + 960);
  (*(void (__fastcall **)(_QWORD, __int64))(*(_QWORD *)(v1 + 1328) + 1456LL))(*(_QWORD *)(v1 + 1328), 4062LL);
