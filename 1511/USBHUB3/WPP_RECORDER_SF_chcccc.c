/*
 * XREFs of WPP_RECORDER_SF_chcccc @ 0x1C000244C
 * Callers:
...
__int64 WPP_RECORDER_SF_chcccc(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_d10ba0436d0df785b384537e9d821623_Traceguids,
      35LL,
      (__int64 *)va,
      1LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 35;
  return WppAutoLogTrace(a1, 4LL, 4LL, &WPP_d10ba0436d0df785b384537e9d821623_Traceguids, v7, (__int64 *)va);
}
