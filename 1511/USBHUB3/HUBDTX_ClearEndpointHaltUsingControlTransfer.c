/*
 * XREFs of HUBDTX_ClearEndpointHaltUsingControlTransfer @ 0x1C00220B0
 * Callers:
 *     HUBDSM_ClearingEndpointHaltOnClientResetPipe @ 0x1C0016ED0 (HUBDSM_ClearingEndpointHaltOnClientResetPipe.c)
 * Callees:
