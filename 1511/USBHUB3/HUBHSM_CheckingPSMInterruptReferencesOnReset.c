/*
 * XREFs of HUBHSM_CheckingPSMInterruptReferencesOnReset @ 0x1C0007120
 * Callers:
 *     <none>
 * Callees:
 *     HUBMUX_QueueSurpriseRemovalToAllPSMs @ 0x1C000CC2C (HUBMUX_QueueSurpriseRemovalToAllPSMs.c)
 *     HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased @ 0x1C000CD3C (HUBMUX_CheckIfAllPSMInterruptReferencesAreReleased.c)
 */
