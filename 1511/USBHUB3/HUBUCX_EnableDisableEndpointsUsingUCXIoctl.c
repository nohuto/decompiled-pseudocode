/*
 * XREFs of HUBUCX_EnableDisableEndpointsUsingUCXIoctl @ 0x1C001D1A8
 * Callers:
 ...
 *     HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency @ 0x1C001AC50 (HUBDSM_ProgrammingEndpointsInControllerAfterDecreasingExitLatency.c)
