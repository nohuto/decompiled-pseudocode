/*
 * XREFs of HUBMUX_ReleaseDevicePowerReference @ 0x1C000D7D0
 * Callers:
 *     HUBDSM_FlushingHubPowerDownEventsForFailedDevice @ 0x1C0016FF0 (HUBDSM_FlushingHubPowerDownEventsForFailedDevice.c)
 *     HUBDSM_FailedDeviceHubSuspended @ 0x1C0017090 (HUBDSM_FailedDeviceHubSuspended.c)
 * Callees:
...
void __fastcall HUBMUX_ReleaseDevicePowerReference(volatile signed __int32 *a1)
{
  ...
  _InterlockedAnd(v2 + 56, 0xFFFFFFFD);
