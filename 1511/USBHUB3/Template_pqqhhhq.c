/*
 * XREFs of Template_pqqhhhq @ 0x1C000F9F4
 * Callers:
 ...
 *     EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup @ 0x1C0015994 (EventWriteUSBHUB3_ETW_EVENT_CLIENT_INITIATED_RECOVERY_ACTION_Cleanup.c)
 * Callees:
