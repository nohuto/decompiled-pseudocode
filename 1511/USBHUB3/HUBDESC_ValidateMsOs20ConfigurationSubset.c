/*
 * XREFs of HUBDESC_ValidateMsOs20ConfigurationSubset @ 0x1C002EFE0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_3:
  ...
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x134u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
...
LABEL_4:
  WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x135u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
  return v8;
}
