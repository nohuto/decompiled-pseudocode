/*
 * XREFs of Template_ppqqqq @ 0x1C00086A8
 * Callers:
...
NTSTATUS Template_ppqqqq(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 4LL;
  v14 = 4LL;
  return EtwWrite(Microsoft_Windows_USB_USBHUB3Handle, a2, a3, 6u, &UserData);
}
