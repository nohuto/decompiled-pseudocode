/*
 * XREFs of HUBFDO_BuildUsb20HubDescriptor @ 0x1C000B2EC
 * Callers:
    ...
    if ( (int)v7 > 0 )
    {
      if ( (int)v7 <= 2 )
      {
        *a2 = *(_OWORD *)(a1 + 1124);
        ...
        a2[2] = *(_OWORD *)(a1 + 1156);
        a2[3] = *(_OWORD *)(a1 + 1172);
        *((_DWORD *)a2 + 16) = *(_DWORD *)(a1 + 1188);
        *((_WORD *)a2 + 34) = *(_WORD *)(a1 + 1192);
        LOBYTE(v7) = *(_BYTE *)(a1 + 1194);
        *((_BYTE *)a2 + 70) = v7;
      }
      else if ( (_DWORD)v7 == 3 )
      {
        ...
        *((_BYTE *)a2 + 2) = v9;
        *(_WORD *)((char *)a2 + 3) = *(_WORD *)(a1 + 1127) & 0x1F;
        *((_BYTE *)a2 + 5) = *(_BYTE *)(a1 + 1129);
        *((_BYTE *)a2 + 6) = *(_BYTE *)(a1 + 1130);
        v10 = v9 >> 3;
        v11 = 0;
        v6 = v10 == -1;
        LODWORD(v7) = v10 + 1;
