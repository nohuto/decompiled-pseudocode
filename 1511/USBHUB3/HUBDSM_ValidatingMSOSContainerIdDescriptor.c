/*
 * XREFs of HUBDSM_ValidatingMSOSContainerIdDescriptor @ 0x1C0019260
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBDSM_ValidatingMSOSContainerIdDescriptor(__int64 a1)
{
  ...
  if ( *(_DWORD *)(v1 + 240) == 24 )
  {
    ...
    WPP_RECORDER_SF_(v3, 2u, 5u, 0x104u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    v4 = 114LL;
  }
  else
  {
    v8 = 24;
    v7 = *(_DWORD *)(v1 + 240);
    WPP_RECORDER_SF_dD(v3, 2u, 5u, 0x103u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v7, v8);
    v4 = 117LL;
  }
  HUBMISC_LogDescriptorValidationErrorForDevice(v1, v4);
  WPP_RECORDER_SF_(v3, 2u, 5u, 0x105u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
  v2 = 4065;
