/*
 * XREFs of HUBID_BuildContainerID @ 0x1C0016788
 * Callers:
 ...
 *     RtlUnicodeStringCbCatStringN @ 0x1C0015A50 (RtlUnicodeStringCbCatStringN.c)
...
void __fastcall HUBID_BuildContainerID(__int64 a1, __int64 a2)
{
  ...
  *(_DWORD *)pbOutput = 0;
  ...
  if ( (v6 & 0x10) != 0 || (v6 & 8) != 0 || (v6 & 0x40) == 0 )
    goto LABEL_31;
  v8 = *(_DWORD *)(a1 + 2132) + 28;
  DestinationString.Buffer = (unsigned __int16 *)ExAllocatePoolWithTag(ExDefaultNonPagedPoolType, v8, 0x64334855u);
  if ( DestinationString.Buffer )
  {
    v9 = *(_WORD *)(a1 + 1974);
    v10 = *(unsigned __int16 *)(a1 + 1982);
    DestinationString.MaximumLength = v8;
    DestinationString.Length = 0;
    if ( v9 > 0x200u )
    {
      v13 = RtlUnicodeStringPrintf(&DestinationString, L"%.4X%.4X.%4X", *(unsigned __int16 *)(a1 + 1980), v10, v9);
    }
    else
    {
      v11 = *(_WORD *)(a1 + 1984);
      ...
      v12 = *(_BYTE *)(a1 + 1984) & 0xF;
      v25[2] = ((unsigned __int8)v11 >> 4) + 48;
      v25[3] = v12 + 48;
      v13 = RtlUnicodeStringPrintf(&DestinationString, L"%.4X%.4X%S", *(unsigned __int16 *)(a1 + 1980), v10, v25);
    }
    Property = v13;
    if ( v13 < 0 )
      goto LABEL_34;
    v14 = *(const wchar_t **)(a1 + 2136);
    if ( v14 )
    {
      v15 = *(unsigned int *)(a1 + 2132);
      if ( (*(_DWORD *)(a1 + 1620) & 0x800) != 0 )
      {
        v15 -= 14LL;
        v14 += 6;
      }
    ...
    if ( PoolWithTag )
    {
      ...
      if ( v17 )
      {
        ...
        if ( Property < 0 )
          goto LABEL_34;
        *(_OWORD *)(a1 + 2048) = *(_OWORD *)v7;
        *(_WORD *)(a1 + 2054) = *(_WORD *)(a1 + 2054) & 0xFFF | 0x5000;
        *(_BYTE *)(a1 + 2056) = *(_BYTE *)(a1 + 2056) & 0x3F | 0x80;
        _InterlockedOr((volatile signed __int32 *)(a1 + 1616), 8u);
LABEL_31:
        if ( (*(_DWORD *)(a1 + 1616) & 0x18) != 0 )
        {
          Property = RtlStringFromGUID((const GUID *const)(a1 + 2048), &GuidString);
          if ( Property >= 0 )
  ...
  if ( Property < 0 )
  {
    ...
    WPP_RECORDER_SF_d(
      *(_QWORD *)(*(_QWORD *)(a1 + 8) + 1432LL),
      ...
      5u,
      0xCu,
      (__int64)&WPP_334859df128939a8c50ce98356845437_Traceguids,
      dwFlags);
  }
}
