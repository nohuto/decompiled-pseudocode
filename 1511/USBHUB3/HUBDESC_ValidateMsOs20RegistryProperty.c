/*
 * XREFs of HUBDESC_ValidateMsOs20RegistryProperty @ 0x1C002F6C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_15:
    ...
    v6 = 0;
    WPP_RECORDER_SF_(*(_QWORD *)(a2 + 88), 2u, 5u, 0x14Au, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    return v6;
  }
  v8 = a3[3];
