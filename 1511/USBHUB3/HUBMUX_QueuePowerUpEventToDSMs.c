/*
 * XREFs of HUBMUX_QueuePowerUpEventToDSMs @ 0x1C000D3E8
 * Callers:
 *     HUBHSM_NotifyingHubResumeInS0ToDevices @ 0x1C0007410 (HUBHSM_NotifyingHubResumeInS0ToDevices.c)
 ...
 *     HUBHSM_WaitingForDevicesToAcquireReferenceOnStart @ 0x1C0007C00 (HUBHSM_WaitingForDevicesToAcquireReferenceOnStart.c)
 * Callees:
...
void __fastcall HUBMUX_QueuePowerUpEventToDSMs(__int64 a1, unsigned int a2)
{
  ...
  v3 = a1 + 2264;
  v17 = &v17;
  v5 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 2264));
  v6 = 0;
  v7 = *(_QWORD *)(v3 + 64);
  v8 = v5;
  while ( 1 )
