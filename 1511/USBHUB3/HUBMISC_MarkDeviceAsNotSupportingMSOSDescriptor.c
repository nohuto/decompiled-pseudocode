/*
 * XREFs of HUBMISC_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C0069D10
 * Callers:
 *     HUBDSM_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C00191D0 (HUBDSM_MarkDeviceAsNotSupportingMSOSDescriptor.c)
 * Callees:
