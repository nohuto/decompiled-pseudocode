/*
 * XREFs of HUBDTX_GetProductIdStringDescriptorUsingControlTransfer @ 0x1C00211C8
 * Callers:
 *     HUBDSM_QueryingLanguageSpecificProductIdString @ 0x1C0018120 (HUBDSM_QueryingLanguageSpecificProductIdString.c)
 * Callees:
