/*
 * XREFs of HUBPDO_FindAndStoreMatchingInternalPipeHandle @ 0x1C0011A34
 * Callers:
 *     HUBDSM_GettingMatchingPipeHandleOnClientResetPipe @ 0x1C00173F0 (HUBDSM_GettingMatchingPipeHandleOnClientResetPipe.c)
 * Callees:
