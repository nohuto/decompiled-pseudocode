/*
 * XREFs of HUBDTX_SetDevicePDChargingPolicyUsingControlTransfer @ 0x1C0022FF4
 * Callers:
 *     HUBDSM_SettingDevicePDChargingPolicy @ 0x1C00182C0 (HUBDSM_SettingDevicePDChargingPolicy.c)
 * Callees:
