/*
 * XREFs of HUBFDO_IoctlGetDescriptorFromNodeConnection @ 0x1C00649C4
 * Callers:
...
LABEL_42:
  ...
  WPP_RECORDER_SF_d(v10[308], 2u, 3u, 0x2Eu, (__int64)&WPP_09f4d0c5c09a38c56fad3299ef2ac878_Traceguids, v11);
  return HUBFDO_CompleteGetDescriptorRequest((__int64)v10, v7, v33, v12, v8);
}
