/*
 * XREFs of HUBHTX_SetLinkStateToRxDetectUsingControlTransfer @ 0x1C0005EF4
 * Callers:
 *     HUBPSM30_EnablingSuperSpeedOnTimerExpiration @ 0x1C000E820 (HUBPSM30_EnablingSuperSpeedOnTimerExpiration.c)
 * Callees:
