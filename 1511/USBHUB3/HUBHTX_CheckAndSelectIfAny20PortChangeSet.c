/*
 * XREFs of HUBHTX_CheckAndSelectIfAny20PortChangeSet @ 0x1C0004340
 * Callers:
 *     HUBPSM20_CheckIfThereIsAPortChangeOnPortStatusWhileWaitingForReconnect @ 0x1C000E3A0 (HUBPSM20_CheckIfThereIsAPortChangeOnPortStatusWhileWaitingForReconnect.c)
 * Callees:
  ...
  if ( v2 )
  {
    ...
    WPP_RECORDER_SF_d(
      *(_QWORD *)(a1 + 1432),
      ...
      v2);
    if ( (*(_DWORD *)(*(_QWORD *)a1 + 2536LL) & 0x10) != 0 )
      HUBMISC_VerifierDbgBreak("HubHwVerifierInvalidPortStatus", *(_QWORD *)a1 + 1208LL);
  }
  else
  {
    return 3005;
