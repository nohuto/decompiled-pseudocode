/*
 * XREFs of HUBHTX_GetPortStatusUsingControlTransfer @ 0x1C00039CC
 * Callers:
 *     HUBPSM20_GettingPortStatusInWaitingForStopSuspend @ 0x1C000DEC0 (HUBPSM20_GettingPortStatusInWaitingForStopSuspend.c)
 * Callees:
