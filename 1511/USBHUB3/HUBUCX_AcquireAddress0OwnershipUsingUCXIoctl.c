/*
 * XREFs of HUBUCX_AcquireAddress0OwnershipUsingUCXIoctl @ 0x1C001CF50
 * Callers:
 *     HUBDSM_AcquiringAddressZeroOwnershipOnRenum @ 0x1C0018190 (HUBDSM_AcquiringAddressZeroOwnershipOnRenum.c)
 * Callees:
