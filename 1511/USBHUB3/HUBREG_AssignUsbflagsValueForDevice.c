/*
 * XREFs of HUBREG_AssignUsbflagsValueForDevice @ 0x1C006AB6C
 * Callers:
 *     HUBDSM_MarkingDeviceAsNotSupportingContainerIdBasedOnMSOSDescriptor @ 0x1C0019210 (HUBDSM_MarkingDeviceAsNotSupportingContainerIdBasedOnMSOSDescriptor.c)
 *     HUBPDO_EvtDevicePrepareHardware @ 0x1C00664B0 (HUBPDO_EvtDevicePrepareHardware.c)
 *     HUBMISC_MarkDeviceAsNotSupportingMSOSDescriptor @ 0x1C0069D10 (HUBMISC_MarkDeviceAsNotSupportingMSOSDescriptor.c)
...
__int64 __fastcall HUBREG_AssignUsbflagsValueForDevice(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  HUBMISC_ConvertUsbDeviceIdsToString((unsigned __int16 *)(a1 + 1972), v15, v16, v17);
  v8 = *(_QWORD *)(a1 + 8);
  v14 = 0LL;
  v13 = 0LL;
