/*
 * XREFs of HUBCONNECTOR_DeRegisterPort @ 0x1C0068F2C
 * Callers:
...
LABEL_7:
    if ( v6 )
    {
      ...
      if ( !v6[7] && !v6[8] )
      {
        v8 = v6[10];
        v9 = (_QWORD *)v6[11];
        if ( *(_QWORD **)(v8 + 8) != v6 + 10 || (_QWORD *)*v9 != v6 + 10 )
          __fastfail(3u);
        *v9 = v8;
        *(_QWORD *)(v8 + 8) = v9;
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 1432), 2u, 4u, 0x13u, (__int64)&WPP_aeb8033ea23ee201a433ac9ecf378619_Traceguids);
      v2 = -1073741823;
    }
  }
LABEL_20:
