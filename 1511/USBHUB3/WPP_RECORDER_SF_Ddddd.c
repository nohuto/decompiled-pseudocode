/*
 * XREFs of WPP_RECORDER_SF_Ddddd @ 0x1C0023444
 * Callers:
 *     HUBMISC_CheckForSharedEndpoints @ 0x1C0023F00 (HUBMISC_CheckForSharedEndpoints.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_Ddddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x10) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_4365074be9fe45a9236a5dea2660cd62_Traceguids,
      20LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 20;
  return WppAutoLogTrace(a1, 2LL, 5LL, &WPP_4365074be9fe45a9236a5dea2660cd62_Traceguids, v7, (__int64 *)va);
}
