/*
 * XREFs of WerKernelCreateReport @ 0x1C00340E4
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C0070F7C (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpCreateRegistryKey @ 0x1C0033C0C (WerpCreateRegistryKey.c)
 *     CheckSpaceAvailable @ 0x1C0033FC4 (CheckSpaceAvailable.c)
 */
...
__int64 __fastcall WerKernelCreateReport(const WCHAR *a1, const WCHAR *a2, HANDLE *a3)
{
  ...
  v9 = WerpCreateRegistryKey(
         0LL,
         L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\Windows Error Reporting\\\\LiveKernelReports",
         0x20004u,
         0,
         &Handle,
         0LL);
