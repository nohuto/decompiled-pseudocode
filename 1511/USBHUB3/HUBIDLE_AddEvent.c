/*
 * XREFs of HUBIDLE_AddEvent @ 0x1C002FEE8
 * Callers:
 ...
 *     HUBIDLE_CancelIdle @ 0x1C00303B0 (HUBIDLE_CancelIdle.c)
...
__int64 __fastcall HUBIDLE_AddEvent(__int64 a1, int a2, IRP *a3)
{
  ...
  if ( a2 != 1000 )
  {
    ...
    while ( 1 )
    {
      v9 = 1001;
      v10 = 0LL;
      v11 = *(_QWORD *)(v41 + 8LL * (unsigned int)(*(_DWORD *)(a1 + 144) - v39));
...
LABEL_21:
      ...
      *(_DWORD *)(a1 + 144) = v9;
      v14 = *(__int64 (__fastcall **)(__int64, IRP *))(*(_QWORD *)(v41 + 8LL * (unsigned int)(v9 - v39)) + 8LL);
      if ( v14 )
        v8 = v14(a1, a3);
      else
        v8 = 1000;
          ...
          else
          {
            ...
            *(_QWORD *)v42.Data4 = 0LL;
            if ( a3 && WPP_MAIN_CB.Queue.Wcb.DeviceObject )
              ((void (__fastcall *)(IRP *, GUID *))WPP_MAIN_CB.Queue.Wcb.DeviceObject)(a3, &v42);
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)v42.Data4 = 0LL;
    if ( WPP_MAIN_CB.Queue.Wcb.DeviceObject )
      ((void (__fastcall *)(IRP *, GUID *))WPP_MAIN_CB.Queue.Wcb.DeviceObject)(v4, &v42);
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x100) != 0 )
    {
      LODWORD(v31) = v6;
      Template_pq(v17, (const EVENT_DESCRIPTOR *)"a", &v42, *(_QWORD *)(*(_QWORD *)(a1 - 48) + 24LL), v31);
    }
