 ...
 *     HUBUCX_CheckIfEndpointsNeedToBeDisabledOnConfigFailure @ 0x1C001F4B8 (HUBUCX_CheckIfEndpointsNeedToBeDisabledOnConfigFailure.c)
 ...
 *     KsPropertyHandleDrmSetContentId @ 0x1C007070C (KsPropertyHandleDrmSetContentId.c)
