/*
 * XREFs of HUBUCX_StartDeviceIoUsingUCXIoctl @ 0x1C001F18C
 * Callers:
 *     HUBDSM_StartingDeviceIoOnDeviceResumeOnHwWake @ 0x1C0017F40 (HUBDSM_StartingDeviceIoOnDeviceResumeOnHwWake.c)
 * Callees:
