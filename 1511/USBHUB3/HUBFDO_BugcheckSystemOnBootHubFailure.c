/*
 * XREFs of HUBFDO_BugcheckSystemOnBootHubFailure @ 0x1C000BDB0
 * Callers:
 *     HUBHSM_BugcheckingSystemOnExcessiveResetsForHubInBootPath @ 0x1C0006EF0 (HUBHSM_BugcheckingSystemOnExcessiveResetsForHubInBootPath.c)
 * Callees:
