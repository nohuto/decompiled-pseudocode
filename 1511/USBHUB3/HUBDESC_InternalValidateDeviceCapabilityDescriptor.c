/*
 * XREFs of HUBDESC_InternalValidateDeviceCapabilityDescriptor @ 0x1C002D434
 * Callers:
        ...
        __int64 a9)
{
  ...
  *a3 = v15;
  ...
  if ( (unsigned __int8)v15 < 3u )
  {
    ...
    {
      *v9 = 1;
      WPP_RECORDER_SF_DDD(v16, 2u, v21, 0xD0u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v31, *a1, 3);
      goto LABEL_48;
    }
    *v9 = 2;
    *a3 = 3;
    WPP_RECORDER_SF_DDDD(v16, v20, v21, 0xCFu, v30);
    v13 = a5;
    v14 = a6;
    v19 = v32;
  }
  if ( v19 < 3 )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v9 = 2;
    WPP_RECORDER_SF_d(v16, 2u, 5u, 0xD1u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v22);
  ...
  if ( a1[2] == 2 )
  {
    ...
    WPP_RECORDER_SF_(v16, 2u, 5u, 0xD2u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    v24 = 76LL;
    goto LABEL_27;
  }
  if ( a1[2] == 3 )
  {
    ...
    WPP_RECORDER_SF_(v16, 2u, 5u, 0xD3u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    v24 = 75LL;
    goto LABEL_27;
  }
  if ( a1[2] != 4 )
  {
    switch ( a1[2] )
    {
      ...
      case 0xAu:
        ...
        WPP_RECORDER_SF_(v16, 2u, 5u, 0xD4u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
        v24 = 203LL;
        break;
      case 0xDu:
        ...
        WPP_RECORDER_SF_(v16, 2u, 5u, 0xD6u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
        v24 = 245LL;
        break;
      default:
        goto LABEL_48;
...
LABEL_49:
    v18 = 0;
    WPP_RECORDER_SF_(v16, 2u, 5u, 0xD7u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    return v18;
  }
  ...
  if ( *(_QWORD *)(v26 + 24) )
  {
    WPP_RECORDER_SF_(v16, 2u, 5u, 0xD5u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    v24 = 74LL;
    goto LABEL_27;
  }
  if ( !*(_BYTE *)(v26 + 40) )
