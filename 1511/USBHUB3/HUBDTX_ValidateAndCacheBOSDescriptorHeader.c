/*
 * XREFs of HUBDTX_ValidateAndCacheBOSDescriptorHeader @ 0x1C0020F0C
 * Callers:
 *     HUBDSM_ValidatingAlternateBOSDescriptorHeader @ 0x1C0019C90 (HUBDSM_ValidatingAlternateBOSDescriptorHeader.c)
 * Callees:
