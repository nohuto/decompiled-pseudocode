/*
 * XREFs of HUBMISC_StoreDeviceMSOSVendorCodeInRegsitry @ 0x1C0069D40
 * Callers:
 *     HUBDSM_MarkDeviceAsSupportingMSOSDescriptor @ 0x1C00191F0 (HUBDSM_MarkDeviceAsSupportingMSOSDescriptor.c)
 * Callees:
