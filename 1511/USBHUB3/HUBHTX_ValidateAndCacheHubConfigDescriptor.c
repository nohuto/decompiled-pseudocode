/*
 * XREFs of HUBHTX_ValidateAndCacheHubConfigDescriptor @ 0x1C0002CBC
 * Callers:
 *     HUBHSM_ValidatingHubConfigurationDescriptor @ 0x1C00084B0 (HUBHSM_ValidatingHubConfigurationDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBHTX_ValidateAndCacheHubConfigDescriptor(__int64 a1)
{
  ...
  if ( v3[1] < 0xFFu )
  {
    ...
    *(_QWORD *)(a1 + 1200) = PoolWithTag;
    if ( !PoolWithTag )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0x15u, (__int64)&WPP_d10ba0436d0df785b384537e9d821623_Traceguids);
      v5 = -1073741670;
      goto LABEL_10;
    }
