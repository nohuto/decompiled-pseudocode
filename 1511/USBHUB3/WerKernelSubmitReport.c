/*
 * XREFs of WerKernelSubmitReport @ 0x1C0034500
 * Callers:
 *     TelemetryData_SubmitReport @ 0x1C0070F7C (TelemetryData_SubmitReport.c)
 * Callees:
 *     WerpGetRegistryKey @ 0x1C0033D1C (WerpGetRegistryKey.c)
 *     WerpAllocateAndInitializeSid @ 0x1C0033DD0 (WerpAllocateAndInitializeSid.c)
 *     WerpParseKeyName @ 0x1C0033EB0 (WerpParseKeyName.c)
 *     WerStartSystemErrorHandler @ 0x1C0034348 (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C0034450 (WerWaitForSystemErrorHandler.c)
...
LABEL_12:
    ...
    {
      v14 = WerpParseKeyName((unsigned __int64)(PoolWithTag + 1), *PoolWithTag >> 1, &v41, &v36, &v42, &v35);
      v2 = v41;
      v8 = v14;
      v3 = v42;
      v4 = v36;
        ...
        if ( v26 <= 0x7FFFFFFE )
        {
          ...
          *v29 = 0;
          if ( v19 >= 0 )
          {
            ...
            v54[0] = 91751760;
            v43 = 1400LL;
            v31 = ZwAlpcSendWaitReceivePort(Handle, 0LL, v53, 0LL, v54, &v43, 0LL, v16);
            v8 = v31;
            if ( v31 < 0 || v31 == 258 )
            {
