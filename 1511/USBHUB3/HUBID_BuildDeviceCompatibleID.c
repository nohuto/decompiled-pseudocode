/*
 * XREFs of HUBID_BuildDeviceCompatibleID @ 0x1C00161E4
 * Callers:
...
__int64 __fastcall HUBID_BuildDeviceCompatibleID(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  v7[1] = v13;
  v12 = *(_DWORD *)L"E";
  LODWORD(v9[0]) = 4718662;
  LODWORD(v8[0]) = 3670070;
  LODWORD(v7[0]) = 2097182;
  LODWORD(v6[0]) = 1835034;
  v6[1] = &v10;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( (int)result >= 0 )
    {
      ...
      if ( (int)result >= 0 )
        return HUBID_AssignIDString(v6, 2, a2, (__int64)a3);
    }
  }
  return result;
}
