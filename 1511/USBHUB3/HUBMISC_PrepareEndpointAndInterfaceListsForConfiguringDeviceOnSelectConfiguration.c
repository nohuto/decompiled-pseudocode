/*
 * XREFs of HUBMISC_PrepareEndpointAndInterfaceListsForConfiguringDeviceOnSelectConfiguration @ 0x1C0023FE8
 * Callers:
 *     HUBDSM_PreparingEndpointAndInterfaceListsOnSelectConfiguration @ 0x1C00174E0 (HUBDSM_PreparingEndpointAndInterfaceListsOnSelectConfiguration.c)
 * Callees:
...
__int64 __fastcall HUBMISC_PrepareEndpointAndInterfaceListsForConfiguringDeviceOnSelectConfiguration(__int64 a1)
{
  ...
  unsigned __int16 *v91; // [rsp+90h] [rbp-78h]
  unsigned __int64 v92; // [rsp+98h] [rbp-70h]
  unsigned __int16 *v93; // [rsp+A0h] [rbp-68h]
  _QWORD *v94; // [rsp+A8h] [rbp-60h]
  ...
  *(_QWORD *)(a1 + 48) = 0LL;
  ...
  if ( v7 >= 0 )
  {
    ...
    *v9 = v90;
    ...
    v92 = v14;
    LODWORD(v87) = 0;
    for ( i = (unsigned __int64)(v3 + 21) < v14; i; i = (unsigned __int64)(v91 + 1) < v92 )
    {
      v16 = *(_QWORD *)(a1 + 8);
      v17 = *v13;
      v18 = v11;
...
LABEL_13:
      *((_DWORD *)v11 + 4) = v20[4];
      ...
      v24 = *v11;
      v93 = v11 + 8;
      v91 = (unsigned __int16 *)((char *)v11 + v24);
      memset(v97, 0, sizeof(v97));
      v97[6] = 1;
      v97[7] = 1;
      v97[0] = 56;
...
LABEL_74:
      ...
      *((_BYTE *)v18 + 6) = v21[7];
      ...
      v30 = (char *)v84;
      v31 = &v21[v29];
      v32 = *(unsigned __int16 *)(*((_QWORD *)v88 + 3) + 2LL) - v29 - (_QWORD)v21;
      v33 = 0;
