/*
 * XREFs of HUBDTX_LogBillboardEvent @ 0x1C00228F4
 * Callers:
 *     HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried @ 0x1C0019860 (HUBDSM_CheckingIfBillboardStringDescriptorShouldBeQueried.c)
...
NTSTATUS __fastcall HUBDTX_LogBillboardEvent(__int64 a1, _BYTE *a2)
{
  ...
  result = WPP_RECORDER_SF_dD(
             *(_QWORD *)(*(_QWORD *)(a1 + 8) + 1432LL),
             ...
             v9,
             v11);
  if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x200000) != 0 )
  {
