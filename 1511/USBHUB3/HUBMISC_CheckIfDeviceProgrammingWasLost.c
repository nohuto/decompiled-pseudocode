/*
 * XREFs of HUBMISC_CheckIfDeviceProgrammingWasLost @ 0x1C0025D18
 * Callers:
 *     HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum @ 0x1C0018210 (HUBDSM_ClearingDeviceProgrammingLostFlagOnEnum.c)
 * Callees:
 *     <none>
 */
