/*
 * XREFs of HUBDESC_InternalValidatePlatformCapabilityDescriptor @ 0x1C002BD44
 * Callers:
        ...
        __int64 a5)
{
  ...
  if ( *a1 < 0x14u )
  {
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_DDD(v11, 2u, v14, 0x8Du, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v9, *v8, 20);
      goto LABEL_14;
    }
    *v5 = 2;
    *a3 = 20;
  ...
  if ( *a3 > v12 )
  {
    if ( HUBDESC_ShouldEnforceWin8ValidationImmutable(a2) )
      *v5 = 2;
    WPP_RECORDER_SF_d(v11, 2u, 5u, 0x8Eu, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v9);
    v15 = 253LL;
    goto LABEL_12;
  }
  if ( v8[3] )
  {
    if ( *(_BYTE *)(a2 + 15) )
      *v5 = 2;
    WPP_RECORDER_SF_d(v11, 2u, 5u, 0x8Fu, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v8[3]);
  ...
  {
    *v5 = 1;
    WPP_RECORDER_SF_(v11, 2u, 5u, 0x90u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
    v15 = 196LL;
LABEL_12:
    ...
    && *(_QWORD *)(v8 + 12) == *(_QWORD *)GUID_USB_MSOS20_PLATFORM_CAPABILITY_ID.Data4 )
  {
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_(v11, 2u, 5u, 0x91u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
      v15 = 197LL;
      goto LABEL_12;
    }
    v17 = *v8;
...
LABEL_30:
      *v5 = 1;
      LODWORD(v30) = *v8;
      WPP_RECORDER_SF_d(v11, 2u, 5u, v18, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v30);
      v15 = 198LL;
      goto LABEL_12;
    }
    if ( ((v17 - 4) & 7) != 0 )
          ...
          do
          {
            if ( *(_DWORD *)v25 == *(_DWORD *)v31 )
            {
              ...
              *(_QWORD *)(*(_QWORD *)(a2 + 80) + 48LL) = 0LL;
              ...
              WPP_RECORDER_SF_d(v11, 2u, 5u, 0x94u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v30);
    ...
    {
LABEL_51:
      WPP_RECORDER_SF_(v11, 2u, 5u, 0x95u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
         ...
         && *(_QWORD *)(v8 + 12) == *(_QWORD *)GUID_USB_PLATFORM_FEATURES.Data4 )
  {
    if ( *v8 < 0x1Au )
    {
      *v5 = 1;
      LODWORD(v30) = *v8;
      WPP_RECORDER_SF_d(v11, 2u, 5u, 0x96u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v30);
      v15 = 250LL;
      goto LABEL_12;
    }
    v27 = v8[20];
    if ( v27 == 1 )
    {
      if ( *v8 != 26 )
      {
        *v5 = 1;
        LODWORD(v30) = *v8;
        WPP_RECORDER_SF_d(v11, 2u, 5u, 0x97u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v30);
        v15 = 247LL;
        goto LABEL_12;
      }
    }
    else if ( !v27 )
    {
      *v5 = 1;
      LODWORD(v30) = v8[20];
      WPP_RECORDER_SF_d(v11, 2u, 5u, 0x98u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids, v30);
      v15 = 249LL;
      goto LABEL_12;
    }
    v28 = *(_QWORD *)(a2 + 80);
    ...
    {
      *v5 = 1;
      WPP_RECORDER_SF_(v11, 2u, 5u, 0x99u, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
      v15 = 248LL;
      goto LABEL_12;
    }
    *(_QWORD *)(v28 + 56) = v8;
...
LABEL_14:
  ...
  {
    v10 = 0;
    WPP_RECORDER_SF_(v11, 2u, 5u, 0x9Au, (__int64)&WPP_c8d10965268029d0460df6a43fc0a9a4_Traceguids);
  }
  return v10;
}
