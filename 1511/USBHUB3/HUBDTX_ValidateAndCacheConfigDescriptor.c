/*
 * XREFs of HUBDTX_ValidateAndCacheConfigDescriptor @ 0x1C00214B8
 * Callers:
 *     HUBDSM_ValidatingAlternateConfigurationDescriptor @ 0x1C0018B50 (HUBDSM_ValidatingAlternateConfigurationDescriptor.c)
 * Callees:
...
__int64 __fastcall HUBDTX_ValidateAndCacheConfigDescriptor(__int64 a1)
{
  ...
  LOBYTE(v22[6]) = v9;
  if ( !(unsigned __int8)HUBDESC_ValidateConfigurationDescriptorSet(v1, v11, (unsigned int)v22, v13, (__int64)&v23) )
  {
