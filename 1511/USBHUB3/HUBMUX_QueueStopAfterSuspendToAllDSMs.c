/*
 * XREFs of HUBMUX_QueueStopAfterSuspendToAllDSMs @ 0x1C000D17C
 * Callers:
 *     HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove @ 0x1C0007500 (HUBHSM_NotifyingHubStopToDevicesOnSuspriseRemove.c)
 * Callees:
