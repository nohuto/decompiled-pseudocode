/*
 * XREFs of HUBCONNECTOR_RegisterPort @ 0x1C0068B7C
 * Callers:
 *     HUBCONNECTOR_MapRootHubPorts @ 0x1C006928C (HUBCONNECTOR_MapRootHubPorts.c)
 *     HUBCONNECTOR_MapIntegratedHubPorts @ 0x1C0069530 (HUBCONNECTOR_MapIntegratedHubPorts.c)
 *     HUBCONNECTOR_MapExternalHubPorts @ 0x1C0069628 (HUBCONNECTOR_MapExternalHubPorts.c)
...
LABEL_6:
  if ( !v7 )
  {
    ...
    if ( !PoolWithTag )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 1432), 2u, 4u, 0xAu, (__int64)&WPP_aeb8033ea23ee201a433ac9ecf378619_Traceguids);
      v2 = -1073741670;
LABEL_41:
      v12 = 18;
      LODWORD(v21) = v2;
  ...
  if ( v11 == 768 )
  {
    ...
    if ( v14 )
    {
      ...
      if ( *((_QWORD *)v7 + 9) )
      {
        v15 = 13;
LABEL_20:
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 1432), 2u, 6u, v15, (__int64)&WPP_aeb8033ea23ee201a433ac9ecf378619_Traceguids);
LABEL_40:
        v2 = -1073741823;
        goto LABEL_41;
      }
...
LABEL_39:
        WPP_RECORDER_SF_d(
          *(_QWORD *)(a1 + 1432),
          ...
          6u,
          v16,
          (__int64)&WPP_aeb8033ea23ee201a433ac9ecf378619_Traceguids,
