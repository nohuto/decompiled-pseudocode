/*
 * XREFs of HUBACPI_EvalAcpiMethodEx @ 0x1C006EB0C
 * Callers:
...
LABEL_3:
  ...
  if ( (unsigned __int64)((int)v12 + 1 + 5LL) <= 0x100 )
  {
    ...
    *v15 = 0;
    ...
    if ( !(*(unsigned __int8 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64, _QWORD *))(WdfFunctions_01015 + 2024))(
            ...
            v20,
            v28) )
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0x15u, (__int64)&WPP_eda1603a3130e9b450b464bbeaa437a3_Traceguids);
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0x17u, (__int64)&WPP_eda1603a3130e9b450b464bbeaa437a3_Traceguids);
      v10 = -1072431089;
    }
  }
  else
  {
    v10 = -1073741811;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0x12u, (__int64)&WPP_eda1603a3130e9b450b464bbeaa437a3_Traceguids);
  }
LABEL_23:
  if ( v25 )
