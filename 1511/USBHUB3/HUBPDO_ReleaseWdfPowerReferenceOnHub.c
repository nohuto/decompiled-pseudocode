/*
 * XREFs of HUBPDO_ReleaseWdfPowerReferenceOnHub @ 0x1C0014C0C
 * Callers:
 *     HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure @ 0x1C0017790 (HUBDSM_ReleasingPowerReferenceOnHubOnEnumerationFailure.c)
 * Callees:
