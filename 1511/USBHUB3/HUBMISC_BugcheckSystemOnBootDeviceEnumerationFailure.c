/*
 * XREFs of HUBMISC_BugcheckSystemOnBootDeviceEnumerationFailure @ 0x1C0027D10
 * Callers:
 *     HUBDSM_BugcheckingSystemOnBootDeviceEnumerationFailure @ 0x1C0016D70 (HUBDSM_BugcheckingSystemOnBootDeviceEnumerationFailure.c)
 * Callees:
