/*
 * XREFs of HUBFDO_EvtDevicePrepareHardware @ 0x1C0062E40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBFDO_EvtDevicePrepareHardware(__int64 a1)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(v4 + 2464), 2u, 3u, 0x1Au, (__int64)&WPP_09f4d0c5c09a38c56fad3299ef2ac878_Traceguids);
      v6 = -1073741823;
LABEL_8:
      v53 = v6;
      goto LABEL_13;
    ...
    *(_QWORD *)(v4 + 2496) = PoolWithTag;
    if ( !PoolWithTag )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(v4 + 2464), 2u, 3u, 0x1Bu, (__int64)&WPP_09f4d0c5c09a38c56fad3299ef2ac878_Traceguids);
      v6 = -1073741670;
      goto LABEL_8;
    }
    *(_WORD *)(v4 + 2488) = 0;
  ...
  if ( (*(_DWORD *)(v8 + 4) & 0x1000) != 0 && v6 >= 0 )
  {
    ...
    if ( (_QWORD *)(v4 + 2304) != v12 )
    {
      while ( 1 )
      {
        ...
        {
          if ( v13 != 5000 || ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 4) == 0 )
            goto LABEL_84;
          v14 = *(_DWORD *)(v4 + 152);
          if ( v14 == 1 )
