/*
 * XREFs of HUBHTX_CompleteGetPortStatusWithPortStatusResult @ 0x1C00053FC
 * Callers:
 *     HUBHSM_CompletingPDORequestForGetPortStatusFromConfigWithIntTransfer @ 0x1C00071B0 (HUBHSM_CompletingPDORequestForGetPortStatusFromConfigWithIntTransfer.c)
 * Callees:
...
__int64 __fastcall HUBHTX_CompleteGetPortStatusWithPortStatusResult(__int64 *a1)
{
  ...
  if ( v3 == 2228240 )
  {
    ...
    if ( v4 >= 0 )
    {
      ...
      v7 = WdfDriverGlobals;
      *(_WORD *)(v6 + 4) = v2;
      (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int64))(WdfFunctions_01015 + 2200))(v7, a1[309], 8LL);
    }
    else
    {
      WPP_RECORDER_SF_d(a1[308], 2u, 3u, 0x71u, (__int64)&WPP_d10ba0436d0df785b384537e9d821623_Traceguids, v4);
    }
  }
  else if ( v3 == 2228243 )
  {
