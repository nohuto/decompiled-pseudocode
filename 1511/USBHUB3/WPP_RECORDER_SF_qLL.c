/*
 * XREFs of WPP_RECORDER_SF_qLL @ 0x1C000875C
 * Callers:
...
__int64 WPP_RECORDER_SF_qLL(__int64 a1, __int64 a2, __int64 a3, unsigned __int16 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 2) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    ((void (__fastcall *)(_DEVICE_OBJECT *, __int64, void *, _QWORD, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_db4ec9e0acb4e5ee01c1628295ad4f74_Traceguids,
      a4,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v8) = a4;
  return WppAutoLogTrace(a1, 4LL, 2LL, &WPP_db4ec9e0acb4e5ee01c1628295ad4f74_Traceguids, v8, (__int64 *)va);
}
