/*
 * XREFs of HUBMUX_CreatePSM @ 0x1C000BF98
 * Callers:
...
LABEL_7:
  ...
  *(_QWORD *)(v4 + 1312) = Timer;
  if ( Timer )
  {
    ...
    v20 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(v18 + 472))(*(_QWORD *)(v18 + 224), v19, 1LL);
    *(_QWORD *)(v4 + 1264) = v20;
    if ( !v20 )
    {
  ...
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 2464), 2u, 3u, 0xCu, (__int64)&WPP_be32aff92db2d8ba6a94dba8682f4b77_Traceguids);
  }
LABEL_15:
  if ( v6 >= 0 )
  {
