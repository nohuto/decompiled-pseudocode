/*
 * XREFs of HUBMISC_CreateNewDSM @ 0x1C0025E98
 * Callers:
 *     HUBPSM30_CreatingDeviceInConnectedWithResetInProgress @ 0x1C000D9D0 (HUBPSM30_CreatingDeviceInConnectedWithResetInProgress.c)
 * Callees:
...
LABEL_12:
  ...
  *(_QWORD *)(v2 + 1528) = Timer;
  if ( Timer )
  {
    ...
    v18 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))(v16 + 472))(*(_QWORD *)(v16 + 224), v17, 1LL);
    *(_QWORD *)(v2 + 1480) = v18;
    if ( !v18 )
    {
      WPP_RECORDER_SF_(
