/*
 * XREFs of HUBMISC_QueryAndCacheRegistryValuesForDevice @ 0x1C0069D70
 * Callers:
 *     HUBDSM_QueryingRegistryValuesForDevice @ 0x1C0018B00 (HUBDSM_QueryingRegistryValuesForDevice.c)
 * Callees:
