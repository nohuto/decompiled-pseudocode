/*
 * XREFs of HUBMISC_IncrementEnumRetryCountAndCheckIfReachedMax @ 0x1C0023D90
 * Callers:
 *     HUBDSM_CheckingIfEnumRetryReachedMaximumOnRenumWithAddress0Ownership @ 0x1C0018200 (HUBDSM_CheckingIfEnumRetryReachedMaximumOnRenumWithAddress0Ownership.c)
 * Callees:
...
__int64 __fastcall HUBMISC_IncrementEnumRetryCountAndCheckIfReachedMax(__int64 a1)
{
  ...
  if ( *(_DWORD *)(a1 + 32) <= 3u )
  {
    ...
    *(_DWORD *)(a1 + 2416) = 0;
    ...
    v9 = *(_QWORD *)(a1 + 8);
    if ( (*(_DWORD *)(*(_QWORD *)v9 + 2536LL) & 0x2000) != 0 )
    {
      v5 = v9 + 272;
  ...
  else
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x40) != 0 )
      Template_p(
        ...
        *(_QWORD *)(a1 + 24));
    v4 = *(_QWORD *)(a1 + 8);
    if ( (*(_DWORD *)(*(_QWORD *)v4 + 2536LL) & 0x1000) != 0 )
    {
      v5 = v4 + 272;
