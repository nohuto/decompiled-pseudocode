/*
 * XREFs of HUBHSM_GettingHubConfigurationDescriptorWithDefaultLength @ 0x1C0007F50
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HUBHSM_GettingHubConfigurationDescriptorWithDefaultLength(__int64 a1)
{
  ...
  *(_QWORD *)(v1 + 1200) = PoolWithTag;
  ...
  {
    WPP_RECORDER_SF_(*(_QWORD *)(v1 + 2464), 2u, 3u, 0x11u, (__int64)&WPP_d10ba0436d0df785b384537e9d821623_Traceguids);
