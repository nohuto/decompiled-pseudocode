/*
 * XREFs of HUBMUX_AcquireInterruptReference @ 0x1C000CE84
 * Callers:
 *     HUBPSM30_AcquiringInterruptReferenceOnHSMInEnabled @ 0x1C000D8C0 (HUBPSM30_AcquiringInterruptReferenceOnHSMInEnabled.c)
 * Callees:
 *     <none>
 */
