/*
 * XREFs of HUBUCX_NotifyDeviceResetUsingUCXIoctl @ 0x1C001CFF0
 * Callers:
 *     HUBDSM_NotifyingDeviceResetToUCXAfterReset2 @ 0x1C0018600 (HUBDSM_NotifyingDeviceResetToUCXAfterReset2.c)
 * Callees:
...
LABEL_12:
    ...
    *v10 = 48;
    *((_QWORD *)v10 + 1) = *(_QWORD *)(**(_QWORD **)(a1 + 8) + 224LL);
