/*
 * XREFs of HUBMISC_CheckIfDeviceShouldBeDisabledOnRemove @ 0x1C002549C
 * Callers:
 *     HUBDSM_CheckingIfDeviceShouldBeDisabled @ 0x1C0016D90 (HUBDSM_CheckingIfDeviceShouldBeDisabled.c)
 * Callees:
