/*
 * XREFs of HUBDTX_LogAlternateMode @ 0x1C00229F4
 * Callers:
 *     HUBDSM_CheckingIfAlternateModeStringDescriptorShouldBeQueried @ 0x1C00197C0 (HUBDSM_CheckingIfAlternateModeStringDescriptorShouldBeQueried.c)
...
NTSTATUS __fastcall HUBDTX_LogAlternateMode(__int64 a1, _BYTE *a2)
{
  ...
  if ( v7 == 3 )
  {
    *((_BYTE *)v2 + 10) = 1;
    ...
    if ( ((__int64)WPP_MAIN_CB.Queue.Wcb.CurrentIrp & 0x400000) == 0 )
      return result;
    LOBYTE(v13) = 3;
