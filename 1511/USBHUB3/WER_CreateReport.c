/*
 * XREFs of WER_CreateReport @ 0x1C00308C0
 * Callers:
 ...
 *     WER_StoreDeviceContext @ 0x1C00305E8 (WER_StoreDeviceContext.c)
 *     TelemetryData_InsertTriageDataBlock @ 0x1C0031408 (TelemetryData_InsertTriageDataBlock.c)
 ...
 *     TelemetryData_SubmitReport @ 0x1C0070F7C (TelemetryData_SubmitReport.c)
 */
...
LABEL_77:
  ...
  *(_OWORD *)&pszDest[24] = 0LL;
  ...
  if ( inserted >= 0 )
  {
    inserted = TelemetryData_InsertTriageDataBlock(v7, a1, 2552LL);
    if ( inserted >= 0 )
    {
      ...
      if ( inserted >= 0 )
      {
        ...
        inserted = imp_WppRecorderLogDumpLiveData(v24, *(_QWORD *)(a1 + 2464), &v48, &v46, v52);
        if ( inserted >= 0 )
        {
                   ...
                   && ((v28 = *(_QWORD *)(v27 + 24)) == 0 || (inserted = WER_StoreDeviceContext(v7, v28), inserted >= 0))) )
                {
                        ...
                        inserted >= 0) )
                  {
                          ...
                          inserted >= 0) )
                    {
                      v31 = *(_QWORD *)(a1 + 2496);
                      if ( !v31
                        || (inserted = TelemetryData_InsertTriageDataBlock(v7, v31, *(unsigned __int16 *)(a1 + 2488)),
                            inserted >= 0) )
                      {
                        v32 = 1;
                        if ( *(_WORD *)(a1 + 44) )
