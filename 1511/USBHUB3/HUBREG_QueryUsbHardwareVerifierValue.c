/*
 * XREFs of HUBREG_QueryUsbHardwareVerifierValue @ 0x1C006A5C8
 * Callers:
        ...
        _DWORD *a7)
{
  ...
  *a7 = 0;
  ...
  {
    LODWORD(v22) = v14;
    WPP_RECORDER_SF_d(a6, 2u, 5u, 0xDu, (__int64)&WPP_488b6272cf1c0d12ea361b5ad05fb8f5_Traceguids, v22);
    goto LABEL_12;
  }
...
LABEL_21:
  if ( v13 == -1073741772 )
  {
    ...
    {
      LODWORD(v22) = v16;
      WPP_RECORDER_SF_d(a6, 2u, 5u, 0xEu, (__int64)&WPP_488b6272cf1c0d12ea361b5ad05fb8f5_Traceguids, v22);
    }
  }
LABEL_12:
  if ( v13 >= 0 )
...
LABEL_45:
    LODWORD(v22) = *a7;
    WPP_RECORDER_SF_d(a6, 2u, 5u, 0x10u, (__int64)&WPP_488b6272cf1c0d12ea361b5ad05fb8f5_Traceguids, v22);
    goto LABEL_46;
  }
  *a7 = 0;
  if ( v13 != -1073741772 )
  {
    LODWORD(v22) = v13;
    WPP_RECORDER_SF_d(a6, 2u, 5u, 0xFu, (__int64)&WPP_488b6272cf1c0d12ea361b5ad05fb8f5_Traceguids, v22);
  }
LABEL_46:
  if ( v23 )
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS))(WdfFunctions_01015 + 1848))(WdfDriverGlobals);
