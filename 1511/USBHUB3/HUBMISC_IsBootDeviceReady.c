/*
 * XREFs of HUBMISC_IsBootDeviceReady @ 0x1C0027A44
 * Callers:
 *     HUBBOOT_IsBootDeviceReady @ 0x1C00312A0 (HUBBOOT_IsBootDeviceReady.c)
 * Callees:
...
char __fastcall HUBMISC_IsBootDeviceReady(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(*(_QWORD *)a1 + 2296LL) & 0x10) != 0 )
  {
    v2 = 1;
    WPP_RECORDER_SF_(
  ...
  *(_DWORD *)(a1 + 2224) = 0;
  if ( (int)HUBHTX_GetPortStatusForBootDevice(a1, &v8) >= 0 )
  {
    if ( (*(_DWORD *)(a1 + 1620) & 0x400) == 0 || (v8 & 0x10000) != 0 )
    {
      ...
      WPP_RECORDER_SF_(*(_QWORD *)(v4 + 1432), 4u, 5u, v6, (__int64)&WPP_4365074be9fe45a9236a5dea2660cd62_Traceguids);
      v2 = 1;
      goto LABEL_18;
    }
    v3 = 92;
...
LABEL_21:
  WPP_RECORDER_SF_(v5, 4u, 5u, v3, (__int64)&WPP_4365074be9fe45a9236a5dea2660cd62_Traceguids);
