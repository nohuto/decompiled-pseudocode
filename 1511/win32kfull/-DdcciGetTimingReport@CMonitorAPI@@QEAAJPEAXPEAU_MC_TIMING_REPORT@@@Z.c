/*
 * XREFs of ?DdcciGetTimingReport@CMonitorAPI@@QEAAJPEAXPEAU_MC_TIMING_REPORT@@@Z @ 0x1C025BA74
 * Callers:
 *     NtGdiDDCCIGetTimingReport @ 0x1C025C550 (NtGdiDDCCIGetTimingReport.c)
 * Callees:
