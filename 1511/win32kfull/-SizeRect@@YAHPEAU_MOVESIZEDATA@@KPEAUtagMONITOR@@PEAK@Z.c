/*
 * XREFs of ?SizeRect@@YAHPEAU_MOVESIZEDATA@@KPEAUtagMONITOR@@PEAK@Z @ 0x1C0206070
 * Callers:
...
__int64 __fastcall SizeRect(struct _MOVESIZEDATA *a1, unsigned int a2, struct tagMONITOR *a3, unsigned int *a4)
{
  ...
  v11 = *((int *)a1 + 40);
  v12 = dword_1C02EAC78[v11];
  if ( (int)v12 >= 0 )
  {
    v13 = dword_1C02EAC78[v11];
  ...
  v19 = *((int *)a1 + 40);
  v20 = dword_1C02EAC48[v19];
  if ( (int)v20 >= 0 )
  {
    v21 = HIWORD(a2);
    v22 = dword_1C02EAC48[v19];
