/*
 * XREFs of ?CommitBuffer@UmfdUMBuffer@@QEAAPEAXK@Z @ 0x1C02D7100
 * Callers:
 *     ?CommitUMBuffer@UmfdTls@@QEAAPEAXK_N@Z @ 0x1C02D5DAC (-CommitUMBuffer@UmfdTls@@QEAAPEAXK_N@Z.c)
 * Callees:
 *     ?AllocTemporaryBuffer@UmfdUMBuffer@@AEAA_NK@Z @ 0x1C02D700C (-AllocTemporaryBuffer@UmfdUMBuffer@@AEAA_NK@Z.c)
 *     ?CommitReservedBuffer@UmfdUMBuffer@@AEAA_NK@Z @ 0x1C02D7188 (-CommitReservedBuffer@UmfdUMBuffer@@AEAA_NK@Z.c)
 */
