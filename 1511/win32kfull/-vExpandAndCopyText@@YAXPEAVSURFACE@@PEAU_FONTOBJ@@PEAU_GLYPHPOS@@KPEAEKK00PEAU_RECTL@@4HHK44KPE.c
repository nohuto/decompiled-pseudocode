/*
 * XREFs of ?vExpandAndCopyText@@YAXPEAVSURFACE@@PEAU_FONTOBJ@@PEAU_GLYPHPOS@@KPEAEKK00PEAU_RECTL@@4HHK44KPEAU_BRUSHOBJ@@PEAU_POINTL@@@Z @ 0x1C00387E0
 * Callers:
        ...
        struct _POINTL *a19)
{
  ...
  LONG bottom; // edx
  int v52; // edx
  LONG v53; // [rsp+A0h] [rbp-378h]
  int v54; // [rsp+A8h] [rbp-370h]
  int v55; // [rsp+ACh] [rbp-36Ch]
  __int64 v56; // [rsp+B0h] [rbp-368h] BYREF
  struct _RECTL *v57; // [rsp+B8h] [rbp-360h]
  struct _POINTL v58; // [rsp+C0h] [rbp-358h] BYREF
  struct _RECTL v59; // [rsp+C8h] [rbp-350h] BYREF
  struct _POINTL *v60; // [rsp+D8h] [rbp-340h]
  struct SURFACE *v61; // [rsp+E0h] [rbp-338h]
  struct _BRUSHOBJ *v62; // [rsp+E8h] [rbp-330h]
  void * near *v63; // [rsp+F0h] [rbp-328h]
  int v64; // [rsp+F8h] [rbp-320h]
  __int64 v65; // [rsp+100h] [rbp-318h] BYREF
  int v66; // [rsp+108h] [rbp-310h]
  _QWORD v67[2]; // [rsp+110h] [rbp-308h]
  __int64 v68; // [rsp+120h] [rbp-2F8h]
  _BYTE v69[80]; // [rsp+130h] [rbp-2E8h] BYREF
  char v70[56]; // [rsp+180h] [rbp-298h] BYREF
  unsigned int v71; // [rsp+1B8h] [rbp-260h]
  int v72; // [rsp+1BCh] [rbp-25Ch]
  unsigned __int8 *v73; // [rsp+1D0h] [rbp-248h]
  unsigned int v74; // [rsp+1D8h] [rbp-240h]
  int v75; // [rsp+1E0h] [rbp-238h]
  __int16 v76; // [rsp+1E4h] [rbp-234h]
    ...
    for ( i = &v57->left; ; i += 4 )
    {
      ...
      if ( v36 < v37 && v39 < v34 )
      {
        if ( a12 == -1 )
        {
          ...
          v58.x = v40 + v55;
          v58.y = v41;
          BltLnk(a8, 0LL, (struct SURFACE *)v70, 0LL, 0LL, &v59, 0LL, &v58, v62, v60, 0xAAF0u);
        }
        else
        {
          v68 = *((_QWORD *)a8 + 10);
