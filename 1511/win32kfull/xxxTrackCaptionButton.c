/*
 * XREFs of xxxTrackCaptionButton @ 0x1C0238BDC
 * Callers:
...
__int64 __fastcall xxxTrackCaptionButton(__int64 *a1, int a2)
{
  ...
  v11 = xxxCalcCaptionButton((__int64)a1, v10, (__int16 *)v19, v26, v21, 0);
  v23 = SHIWORD(v11);
  v24 = (__int16)v11;
  if ( v19[0] )
  {
  ...
  while ( 1 )
  {
    if ( !(unsigned int)xxxInternalGetMessage(v27, 0LL, 0x200u, 0x20Eu, 1u, 0) )
    {
      if ( (unsigned int)xxxInternalGetMessage(v27, 0LL, 0x241u, 0x257u, 1u, 0) )
      {
    ...
    if ( DWORD2(v27[0]) != 514 )
    {
      if ( DWORD2(v27[0]) == 512 && v19[0] )
      {
        v15 = PtInRect(v26, *(unsigned __int64 *)((char *)&v27[2] + 4));
        if ( v13 != v15 )
        {
          LOWORD(v22) = v15;
...
LABEL_23:
    ...
    v20 = 1;
LABEL_24:
    if ( a1 != *(__int64 **)(*(_QWORD *)(gptiCurrent + 384LL) + 64LL) || v14 )
      break;
    v13 = v22;
  }
  if ( v19[0] )
  {
    ...
    if ( v20 && PtInRect(v26, *(unsigned __int64 *)((char *)&v27[2] + 4)) )
      return v19[0];
  }
  return v4;
}
