/*
 * XREFs of CheckSessionPoolAllocations @ 0x1C0113CB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 CheckSessionPoolAllocations()
{
  ...
  struct _UNICODE_STRING ValueName; // [rsp+C8h] [rbp+1Fh] BYREF
  _BYTE Data[32]; // [rsp+D8h] [rbp+2Fh] BYREF

  memset(Data, 0, sizeof(Data));
  result = Win32ExtractSessionPoolTagInfo(gSessionId, Data, 8LL, &v2, &v5, v6, &v4, 0LL, 0);
  if ( (int)result >= 0 && v4 )
  {
    v1 = v2;
    if ( v2 > 8 )
