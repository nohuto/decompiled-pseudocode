/*
 * XREFs of ?bSrcCopySRLE8D1@@YAHPEAUBLTINFO@@@Z @ 0x1C02C42D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSrcCopySRLE8D1(struct BLTINFO *a1)
{
  ...
  unsigned int v48; // [rsp+2Ch] [rbp-7Ch]
  ...
  {
LABEL_8:
    v12 = *(_BYTE *)(((unsigned int)v3 >> 3) + v6);
    goto LABEL_10;
  }
...
LABEL_92:
  ...
  if ( !(_DWORD)v19 )
  {
    if ( v5 < v58 && (v8 & 7) != 0 )
    {
      ...
      *(_BYTE *)(v59 + v6) = v12 | v56 & *(_BYTE *)(v59 + v6);
    }
LABEL_63:
    --v5;
    v6 += v49;
