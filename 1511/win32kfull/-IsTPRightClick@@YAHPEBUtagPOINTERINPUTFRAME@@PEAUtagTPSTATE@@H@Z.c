/*
 * XREFs of ?IsTPRightClick@@YAHPEBUtagPOINTERINPUTFRAME@@PEAUtagTPSTATE@@H@Z @ 0x1C01F1B18
 * Callers:
...
__int64 __fastcall IsTPRightClick(const struct tagPOINTERINPUTFRAME *a1, struct tagTPSTATE *a2, int a3)
{
  ...
  v3 = 0;
  if ( a3 || (qword_1C0322020 & 0x200000000LL) == 0 )
    return 0LL;
  v5 = *((_DWORD *)a1 + 6);
  v6 = 0;
  v7 = *((_QWORD *)a1 + 9);
  if ( v5 )
  {
    ...
    while ( !*v10
         || (*v10 & 0x40000) != 0
         || (*((_DWORD *)a2 + 54 * (*v11 % v8) + 53) & 0x20) != 0
         || !PtInRect((_DWORD *)a2 + 376, *v9) )
    {
      v11 += 108;
      v10 += 54;
      v9 += 27;
