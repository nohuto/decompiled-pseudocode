/*
 * XREFs of ?ZOrderByOwner@@YAPEAUtagSMWP@@PEAU1@@Z @ 0x1C0076330
 * Callers:
...
LABEL_36:
        ...
        if ( (int)v21 <= 0 )
          ...
          v23 = *(struct tagWND **)(*((_DWORD *)&gSharedInfo + 4)
      ...
      v9 = 0;
      v10 = *((_DWORD *)&gSharedInfo + 4);
      v11 = *((_QWORD *)&gSharedInfo + 1);
...
LABEL_24:
      v18 = 0;
LABEL_25:
      if ( (*(_DWORD *)(*(_QWORD *)(*((_QWORD *)&v34 + 1) + 376LL) + 776LL) & 2) != 0
