/*
 * XREFs of ?vMovePointer@@YAXPEAUHDEV__@@HHJ@Z @ 0x1C00884BC
 * Callers:
  ...
  if ( a1[20] != (_DWORD)a2 || a1[21] != (_DWORD)a3 || (a1[14] & 0x100000) != 0 )
  {
    ...
    if ( (v8 & 0x400) == 0 )
    {
      ...
      if ( v9 )
      {
        ...
        if ( (v8 & 2) != 0 )
        {
          v11 = (void (__fastcall *)(struct _SURFOBJ *))*((_QWORD *)a1 + 432);
          if ( v11 )
          {
            v11(v10);
          }
          ...
          {
            v14 = (void (__fastcall *)(struct _SURFOBJ *, __int64, __int64, _QWORD))*((_QWORD *)a1 + 370);
            if ( v14 )
              v14(v10, a2, a3, 0LL);
          }
        }
        ...
        if ( (a1[462] & 0x10000) != 0 && v5 != -1 && v6 < v10->sizlBitmap.cx )
        {
          cy = v10->sizlBitmap.cy;
          if ( v5 < cy )
          {
            v13 = (void (__fastcall *)(struct _SURFOBJ *, _QWORD, _QWORD, _QWORD))*((_QWORD *)a1 + 370);
            if ( v13 )
