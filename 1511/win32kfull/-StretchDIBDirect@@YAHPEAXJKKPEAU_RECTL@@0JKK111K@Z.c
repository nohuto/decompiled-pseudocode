/*
 * XREFs of ?StretchDIBDirect@@YAHPEAXJKKPEAU_RECTL@@0JKK111K@Z @ 0x1C003DD8C
 * Callers:
        ...
        struct _RECTL *a12)
{
  ...
  LONG v28; // [rsp+48h] [rbp-100h]
  LONG left; // [rsp+54h] [rbp-F4h]
  int v30; // [rsp+60h] [rbp-E8h]
  LONG top; // [rsp+64h] [rbp-E4h]
  LONG v32; // [rsp+80h] [rbp-C8h]
  struct _RECTL *v33; // [rsp+90h] [rbp-B8h]
