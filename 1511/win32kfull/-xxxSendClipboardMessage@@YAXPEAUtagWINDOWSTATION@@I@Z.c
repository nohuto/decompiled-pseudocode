/*
 * XREFs of ?xxxSendClipboardMessage@@YAXPEAUtagWINDOWSTATION@@I@Z @ 0x1C014D784
 * Callers:
...
void __fastcall xxxSendClipboardMessage(struct tagWINDOWSTATION *a1, unsigned int a2)
{
  ...
  if ( v2 )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v8;
    ...
    if ( a2 == 775 )
    {
      if ( !xxxSendTransformableMessageTimeout((struct tagWND *)v2, 775LL, 0LL, 0LL, 2, 5000, &v10, 1, 0) )
