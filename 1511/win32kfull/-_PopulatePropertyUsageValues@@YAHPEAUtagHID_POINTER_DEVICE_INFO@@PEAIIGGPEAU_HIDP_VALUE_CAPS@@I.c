/*
 * XREFs of ?_PopulatePropertyUsageValues@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@PEAIIGGPEAU_HIDP_VALUE_CAPS@@IPEAUtagPOINTER_DEVICE_PROPERTY@@PEAU_HIDP_PREPARSED_DATA@@@Z @ 0x1C011876C
 * Callers:
  ...
  if ( HidP_GetSpecificValueCaps(HidP_Input, 0, a4, 0, a6, &a5, a9) >= 0 )
  {
    ...
    if ( v14 < a7 )
    {
      ...
      while ( 1 )
      {
        if ( v16 >= v9 )
          goto LABEL_13;
        if ( *((_BYTE *)a1 + 1424) == v15[v16].ReportID && v14 < a3 )
          break;
LABEL_12:
        ++v16;
        if ( v14 >= a7 )
...
LABEL_11:
        ...
        *(_DWORD *)((char *)v17 + v18 + 8) = 0;
        if ( ((*((_DWORD *)a1 + 191) - 1) & 0xFFFFFFFD) != 0 )
          goto LABEL_18;
      }
      else
      {
