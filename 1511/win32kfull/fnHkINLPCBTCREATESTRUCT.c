/*
 * XREFs of fnHkINLPCBTCREATESTRUCT @ 0x1C011E51C
 * Callers:
...
unsigned __int8 *__fastcall fnHkINLPCBTCREATESTRUCT(int a1, __int64 a2, _QWORD *a3, __int64 a4, unsigned int a5)
{
  ...
  *(_QWORD *)&v56 = a4;
  ...
  if ( ThreadDesktopWindow )
    v54 = ThreadDesktopWindow - *(_QWORD *)(gptiCurrent + 424LL);
  else
    v54 = 0LL;
  v12 = *a3;
  v13 = *(_QWORD *)(v12 + 56);
...
LABEL_58:
            ...
            *(_QWORD *)(v35 + 72) = v54;
            if ( v10 )
              ...
              v36 = 0LL;
            *(_QWORD *)(*(_QWORD *)(v34 + 432) + 64LL) = v36;
            if ( v10 )
              v37 = *(_QWORD *)(v10 + 264);
            else
              v37 = 0LL;
            *(_QWORD *)(*(_QWORD *)(v34 + 432) + 80LL) = v37;
