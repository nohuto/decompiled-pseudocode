/*
 * XREFs of ?bSpPtInSprite@@YAHPEAVSPRITE@@HH@Z @ 0x1C026FA94
 * Callers:
...
__int64 __fastcall bSpPtInSprite(struct SPRITE *a1, LONG a2, LONG a3)
{
  ...
  struct _SPRITESTATE *v16[24]; // [rsp+30h] [rbp-D0h] BYREF
  ...
  v17.left = a2;
  v17.top = a3;
  v11 = *(_QWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)(v10 + 40)) + 120);
  if ( (*(_DWORD *)(v11 + 24) & 2) != 0 )
    v12 = **(_DWORD **)(v11 + 128) | *(_DWORD *)(*(_QWORD *)(v11 + 128) + 4LL) | *(_DWORD *)(*(_QWORD *)(v11 + 128) + 8LL);
  else
    v12 = -1;
