/*
 * XREFs of ?MoveRect@@YAHPEAU_MOVESIZEDATA@@KW4_MOVERECT_STYLE@@@Z @ 0x1C0205C6C
 * Callers:
...
__int64 __fastcall MoveRect(__int64 a1, int a2, int a3)
{
  ...
  if ( !v8 )
  {
    v11 = EngMulDiv(*(_DWORD *)(a1 + 32) - *v3, *(_DWORD *)(a1 + 260), *(_DWORD *)(a1 + 16) - *(_DWORD *)(a1 + 8));
    v12 = v6
        - *(_DWORD *)(a1 + 28)
        - EngMulDiv(
...
LABEL_11:
  ...
  if ( (v14 & 0x40) != 0 )
    return 1LL;
  v15 = *(_QWORD *)a1;
  v16 = *(_QWORD *)(*(_QWORD *)a1 + 88LL);
  if ( !*(_QWORD *)(v16 + 200) )
    return IntersectRect(&v19, v3, (int *)(a1 + 72));
  v20 = *(_QWORD *)(v16 + 200);
