/*
 * XREFs of ?xxxPollAndWaitForSingleObject@@YAKPEAU_KEVENT@@PEAXK@Z @ 0x1C00E2DB4
 * Callers:
 ...
 *     ClientDeliverUserApc @ 0x1C0104054 (ClientDeliverUserApc.c)
 */
...
__int64 __fastcall xxxPollAndWaitForSingleObject(PVOID Object, void *a2, unsigned int a3)
{
  ...
  *(_WORD *)(*(_QWORD *)(gptiCurrent + 400LL) + 10LL) = 64;
  ...
  do
  {
    ...
    **(_QWORD **)(gptiCurrent + 760LL) = Object;
    v12 = *(_QWORD *)(gptiCurrent + 760LL);
    *(_QWORD *)(v12 + 8) = *(_QWORD *)(gptiCurrent + 648LL);
    *(_QWORD *)(*(_QWORD *)(gptiCurrent + 760LL) + 16LL) = a2;
    UserSessionSwitchLeaveCrit(v12, 0xFFFFF78000000004uLL);
    v13 = KeWaitForMultipleObjects(v6, *(PVOID **)(gptiCurrent + 760LL), WaitAny, WrUserRequest, 1, 0, &Timeout, 0LL);
    EnterCrit(0LL, 1LL);
    if ( v13 < 0 )
      goto LABEL_18;
    if ( v13 == 192 )
