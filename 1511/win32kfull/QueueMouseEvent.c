/*
 * XREFs of QueueMouseEvent @ 0x1C0084FBC
 * Callers:
 ...
 *     ?xxxMKMoveConstCursorTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01EED50 (-xxxMKMoveConstCursorTimer@@YAXPEAUtagWND@@I_K_J@Z.c)
 ...
 *     GetMouseDataInputSource @ 0x1C0202498 (GetMouseDataInputSource.c)
...
LABEL_8:
  ...
  v29 = a1;
  v27 = 0;
  if ( a1 || *v37 || a8 && (*(_BYTE *)(a8 + 2) & 8) != 0 || !(unsigned int)IsEqualInputSource(&v39) )
    goto LABEL_8;
