/*
 * XREFs of DoNewMouseAccel @ 0x1C00FD5FC
 * Callers:
  ...
  *a3 = 0;
  if ( result )
  {
    ...
    if ( v13 + result )
    {
      ...
      if ( dword_1C03238A0 != v21 && v21 > dword_1C03238A0 )
        v22 = (*(_QWORD *)(v8 + 8LL * dword_1C03238A0 + 256)
             + (*(_QWORD *)(v8 + 8LL * dword_1C03238A0 + 288) << 16) / v19
             + v22) >> 1;
      v23 = v22;
      dword_1C03238A0 = v21;
      v24 = qword_1C0323890 + ((v10 * v22) >> 16);
      v25 = qword_1C0323898 + ((v9 * v23) >> 16);
      if ( v25 < 0 )
        v26 = -(__int64)(-v25 & 0xFFFFFFFFFFFF0000uLL);
      else
        v26 = v25 & 0x7FFFFFFFFFFF0000LL;
      qword_1C0323898 = v25 - v26;
      *a3 = v25 - v26;
      if ( v25 < 0 )
