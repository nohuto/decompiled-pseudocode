/*
 * XREFs of NtGdiGetCharacterPlacementW @ 0x1C02A6120
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtGdiGetCharacterPlacementW(HDC a1, char *a2, int a3, signed int a4, unsigned __int64 a5, int a6)
{
  ...
  const void *v32; // rdx
  const void *v33; // rdx
  unsigned int v35; // [rsp+34h] [rbp-C4h]
  int CharacterPlacementW; // [rsp+38h] [rbp-C0h]
  unsigned int v37; // [rsp+3Ch] [rbp-BCh]
  unsigned int v38; // [rsp+40h] [rbp-B8h]
  unsigned int v39; // [rsp+44h] [rbp-B4h]
  unsigned int v40; // [rsp+48h] [rbp-B0h]
  unsigned int v41; // [rsp+4Ch] [rbp-ACh]
  void *v42[2]; // [rsp+70h] [rbp-88h]
  void *Src[2]; // [rsp+80h] [rbp-78h]
  void *v44[2]; // [rsp+90h] [rbp-68h]
  void *v45[2]; // [rsp+A0h] [rbp-58h]
  ...
  if ( v11 )
  {
    if ( a5 )
    {
      v10 = (__m128i *)v11;
      if ( v42[1] )
        *(_QWORD *)(v11 + 8) = v11 + v39;
      else
        *(_QWORD *)(v11 + 8) = 0LL;
      if ( Src[0] )
        *(_QWORD *)(v11 + 16) = v11 + v41;
      else
        *(_QWORD *)(v11 + 16) = 0LL;
      if ( v16 )
        *(_QWORD *)(v11 + 24) = v11 + v38;
      else
        *(_QWORD *)(v11 + 24) = 0LL;
      if ( v44[0] )
        *(_QWORD *)(v11 + 32) = v11 + v40;
      else
        *(_QWORD *)(v11 + 32) = 0LL;
      if ( v44[1] )
        *(_QWORD *)(v11 + 40) = v11 + v37;
      else
        *(_QWORD *)(v11 + 40) = 0LL;
      if ( v45[0] )
        *(_QWORD *)(v11 + 48) = v11 + v35;
      else
        *(_QWORD *)(v11 + 48) = 0LL;
      *(_DWORD *)v11 = v9;
      *(_DWORD *)(v11 + 56) = v6;
    ...
    CharacterPlacementW = GreGetCharacterPlacementW(a1, (unsigned __int16 *)(v11 + v9), v6, a4, v10, a6);
    if ( CharacterPlacementW && a5 )
    {
      *(_DWORD *)(a5 + 60) = v10[3].m128i_i32[3];
      v25 = v10[3].m128i_i32[2];
      *(_DWORD *)(a5 + 56) = v25;
      v26 = (unsigned int)(2 * v25);
      v27 = (unsigned int)(4 * v25);
      if ( v42[1] )
      {
        v28 = (const void *)v10->m128i_i64[1];
      ...
      if ( Src[0] )
      {
        v29 = (const void *)v10[1].m128i_i64[0];
      ...
      if ( v16 )
      {
        v30 = (const void *)v10[1].m128i_i64[1];
      ...
      if ( v44[0] )
      {
        v31 = (const void *)v10[2].m128i_i64[0];
      ...
      if ( v44[1] )
      {
        v32 = (const void *)v10[2].m128i_i64[1];
      ...
      if ( v45[0] )
      {
        v33 = (const void *)v10[3].m128i_i64[0];
