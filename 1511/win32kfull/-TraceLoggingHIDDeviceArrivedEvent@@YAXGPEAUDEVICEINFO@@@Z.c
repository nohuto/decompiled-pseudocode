/*
 * XREFs of ?TraceLoggingHIDDeviceArrivedEvent@@YAXGPEAUDEVICEINFO@@@Z @ 0x1C0225548
 * Callers:
 ...
 *     _TlgCreateWsz @ 0x1C02263B4 (_TlgCreateWsz.c)
 */
...
void __fastcall TraceLoggingHIDDeviceArrivedEvent(const struct _TlgProvider_t *a1, struct DEVICEINFO *a2)
{
  ...
  if ( a2
    && *((_QWORD *)a2 + 52)
    && *((_QWORD *)a2 + 50)
    && (unsigned int)dword_1C031B280 > 5
    && TlgKeywordOn(a1, 0x200000000000uLL) )
  {
    ...
    TlgCreateWsz(&v31, *(LPCWSTR *)(v10 + 1512));
    TlgWrite(v11, &unk_1C02E9AAB, v12, v13, 0xAu, &pData);
  }
}
