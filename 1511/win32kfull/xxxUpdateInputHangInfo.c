/*
 * XREFs of xxxUpdateInputHangInfo @ 0x1C005ADE0
 * Callers:
...
LABEL_15:
  ...
  if ( v8 )
  {
    *(_QWORD *)v8 = *(_QWORD *)(gptiCurrent + 1000LL);
    *(_QWORD *)(v8 + 8) = a1;
    *(_DWORD *)(v8 + 16) = v5;
    *(_QWORD *)(gptiCurrent + 1000LL) = v8;
LABEL_12:
    v3 = 1;
  }
