/*
 * XREFs of ?ProbeAndReadFD_KERNINGPAIR@@YAPEAU_FD_KERNINGPAIR@@PEBU1@H_K@Z @ 0x1C029BF5C
 * Callers:
 ...
 *     ??9@YA_NAEBU_FD_KERNINGPAIR@@0@Z @ 0x1C029B9BC (--9@YA_NAEBU_FD_KERNINGPAIR@@0@Z.c)
 */
