/*
 * XREFs of ?ValidateAllCollectionUsages@@YAHPEAU_HIDP_VALUE_CAPS@@GPEAU_HIDP_BUTTON_CAPS@@GGPEAX@Z @ 0x1C01C8664
 * Callers:
 *     IsParallelDevice @ 0x1C01CDC10 (IsParallelDevice.c)
 * Callees:
 *     ?IsButtonCapsEqual@@YAHPEAU_HIDP_BUTTON_CAPS@@0G@Z @ 0x1C01C7344 (-IsButtonCapsEqual@@YAHPEAU_HIDP_BUTTON_CAPS@@0G@Z.c)
 *     ?IsValueCapsEqual@@YAHPEAU_HIDP_VALUE_CAPS@@0G@Z @ 0x1C01C7450 (-IsValueCapsEqual@@YAHPEAU_HIDP_VALUE_CAPS@@0G@Z.c)
