    ...
    if ( ValidateCalibrationData(a2, (__int64)a3, a4) )
    {
      ...
      if ( v4 && updated )
      {
        ...
        if ( (unsigned int)v11 <= 1 )
        {
          ...
          v14 = *(struct _UNICODE_STRING *)(a1 + 200);
          if ( (unsigned int)GetPointerDeviceKey((__int64)&v14, &KeyHandle) )
          {
