/*
 * XREFs of ?Destroy@CBackTraceStoreEx@NSInstrumentation@@SAXPEAV12@@Z @ 0x1C02D577C
 * Callers:
 ...
 * Callees:
 *     ?Uninitialize@?$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@2@VCBackTrace@2@@NSInstrumentation@@QEAAXXZ @ 0x1C02D5C0C (-Uninitialize@-$CSharedStorage@VCBackTraceBucket@NSInstrumentation@@$$CCJVCBackTraceStorageUnit@.c)
 */
