/*
 * XREFs of ?OpenDevice@@YAHPEAUDEVICEINFO@@@Z @ 0x1C01DE3E0
 * Callers:
...
__int64 __fastcall OpenDevice(struct DEVICEINFO *a1)
{
  ...
  ShareAccess = 2;
  v5 = 0;
  if ( W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) == gptiRit && gbDIT == 1 && *((_DWORD *)a1 + 77) )
  {
    *((_DWORD *)a1 + 22) |= 8u;
    RitWakeDITAndWaitForResponse(1u);
    return (unsigned __int8)(*((_BYTE *)a1 + 88) & 4) >> 2;
  }
  *((_QWORD *)a1 + 34) = PsGetCurrentProcessId();
  if ( gProtocolType )
  {
    *((_WORD *)a1 + 32) |= 1u;
    if ( *((_BYTE *)a1 + 48) )
  ...
  else
  {
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)((char *)a1 + 200);
    ...
    if ( !gdwMaxRetries )
      return 0LL;
    v10 = (struct _IO_STATUS_BLOCK *)((char *)a1 + 248);
    do
    {
      v11 = ZwCreateFile((PHANDLE)a1 + 27, v3, &ObjectAttributes, v10, 0LL, 0, ShareAccess, 3u, 0, 0LL, 0);
      *((_DWORD *)a1 + 70) = v11;
      v12 = v11;
