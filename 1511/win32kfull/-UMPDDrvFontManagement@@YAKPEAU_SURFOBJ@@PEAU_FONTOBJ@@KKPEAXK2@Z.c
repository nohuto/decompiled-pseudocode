/*
 * XREFs of ?UMPDDrvFontManagement@@YAKPEAU_SURFOBJ@@PEAU_FONTOBJ@@KKPEAXK2@Z @ 0x1C029D740
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
    ...
    if ( (!v16 || (Src[9] = UMPDOBJ::_AllocUserMem(v12, Size, 1)) != 0LL)
      ...
      && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v12, (struct UMPDOBJ *)((char *)v12 + 176), (const void **)&Src[5], 0x40u)
