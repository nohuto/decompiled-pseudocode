/*
 * XREFs of ?ZOrderByOwner2@@YAPEAUtagSMWP@@PEAU1@H@Z @ 0x1C007694C
 * Callers:
...
struct tagSMWP *__fastcall ZOrderByOwner2(struct tagSMWP *a1, int a2)
{
  ...
  if ( (*(_DWORD *)(v4 + v2 + 32) & 0x204) != 0 )
    return v3;
  v6 = *(struct tagWND **)(*((_DWORD *)&gSharedInfo + 4) * (unsigned int)(unsigned __int16)*(_DWORD *)(v4 + v2)
                         + *((_QWORD *)&gSharedInfo + 1));
  PWInsertAfter(*(_QWORD *)(v4 + v2 + 8));
  v7 = *((_QWORD *)v6 + 11);
  OwnedWindow = NextOwnedWindow(0LL, v6, v7);
  v9 = (struct tagWND *)*((_QWORD *)v6 + 13);
  v10 = 0LL;
  if ( !v9 && !OwnedWindow )
    return v3;
  RealOwner = v6;
