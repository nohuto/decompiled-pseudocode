/*
 * XREFs of ?xxxSetPointerFrameTargetWindows@@YAHPEAUtagTHREADINFO@@_KIPEAH@Z @ 0x1C01FB2E8
 * Callers:
 ...
 *     ?GetQueueForCurrentNode@@YAPEAUtagQ@@PEAUtagTHREADINFO@@HIHPEBUtagPOINTERINFONODE@@@Z @ 0x1C01F8DB0 (-GetQueueForCurrentNode@@YAPEAUtagQ@@PEAUtagTHREADINFO@@HIHPEBUtagPOINTERINFONODE@@@Z.c)
 ...
 *     ?IsNodeMessageDelegated@@YAHPEBUtagPOINTERINFONODE@@I@Z @ 0x1C01F8F48 (-IsNodeMessageDelegated@@YAHPEBUtagPOINTERINFONODE@@I@Z.c)
...
__int64 __fastcall xxxSetPointerFrameTargetWindows(struct tagTHREADINFO *a1, __int64 a2, unsigned int a3, int *a4)
{
  ...
  *(_QWORD *)(gptiCurrent + 368LL) = v63;
  ...
  if ( !*(_DWORD *)(v9 + 24) )
    goto LABEL_100;
  while ( !v11 || (*((_DWORD *)v4 + 268) & 0x2000) != 0 )
  {
...
LABEL_47:
    v29 = *(_QWORD *)(v9 + 80);
    if ( (*(_DWORD *)(v29 + 40LL * *(unsigned int *)(v16 + 8) + 20) & 1) != 0 && (*((_DWORD *)v4 + 268) & 0x2000) == 0 )
