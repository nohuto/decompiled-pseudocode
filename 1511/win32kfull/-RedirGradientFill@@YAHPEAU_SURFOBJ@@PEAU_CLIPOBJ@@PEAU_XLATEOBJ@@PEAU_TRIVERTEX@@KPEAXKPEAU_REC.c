/*
 * XREFs of ?RedirGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1C028EDC0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (*(_DWORD *)(v17 + 56) & 0x20000) != 0 )
        {
          for ( i = **(_QWORD ***)(v17 + 1824); i; i = (_QWORD *)*i )
          {
            ...
            if ( v19 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v19 + 1816) + 608LL) )
                {
                  MARK_ACCDRV_NOTIFICATION::MARK_ACCDRV_NOTIFICATION(
                    (MARK_ACCDRV_NOTIFICATION *)&v23,
                    (struct PDEVOBJ *)&HDEV,
                    a1);
                  (*(void (__fastcall **)(struct _SURFOBJ *, CLIPOBJ *, XLATEOBJ *, TRIVERTEX *, ULONG, PVOID, ULONG, RECTL *, POINTL *, ULONG))(*(_QWORD *)(v20 + 1816) + 608LL))(
                    a1,
                    pco,
                    pxlo,
                    pVertex,
