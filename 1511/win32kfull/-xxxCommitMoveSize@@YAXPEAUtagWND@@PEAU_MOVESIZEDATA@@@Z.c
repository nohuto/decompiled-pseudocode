/*
 * XREFs of ?xxxCommitMoveSize@@YAXPEAUtagWND@@PEAU_MOVESIZEDATA@@@Z @ 0x1C0207464
 * Callers:
...
LABEL_67:
      ...
      || (*((_BYTE *)a1 + 55) & 1) != 0 && (v23 & 0x100000) == 0 )
    {
      ...
      if ( Prop )
      {
        ...
        SwapRect(Prop, &v37);
        xxxMinMaximizeEx(*(struct tagWND **)a2, 9u, 4u, 0LL, 0LL);
        SwapRect(&v37, v25);
    ...
    if ( (*((_DWORD *)a2 + 79) & 0x20) != 0 )
      v27 |= 0x10u;
    if ( (v27 & 1) == 0 && (*((_DWORD *)a2 + 45) & 0x300) != 0 )
      v27 |= 0x100000u;
    if ( (*((_DWORD *)a2 + 64) & 8) != 0 )
      v27 |= 0x200000u;
    v28 = *((_DWORD *)a2 + 3);
    ...
    *((_DWORD *)a2 + 45) |= 0x80000000;
    xxxSetWindowPos(a1, 0, v30, v28, v31, v29, v27);
    v32 = *((_DWORD *)a2 + 45);
  ...
  if ( v10 )
  {
    ...
    else if ( v9 || (*((_BYTE *)a1 + 289) & 3) != 0 )
    {
      ...
      *(_QWORD *)(gptiCurrent + 368LL) = v36;
      ...
      if ( v15 )
        ++*(_DWORD *)(v15 + 8);
      if ( *(_WORD *)(v14 + 152) != *(_WORD *)(v15 + 152) && *((_DWORD *)a1 + 86) == 2 )
