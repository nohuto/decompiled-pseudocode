/*
 * XREFs of ?CancelInputState@@YAXPEAUtagTHREADINFO@@K@Z @ 0x1C00DB8C0
 * Callers:
...
void __fastcall CancelInputState(struct tagTHREADINFO *a1, int a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( v4 )
    {
      if ( v4 != 1 )
        goto LABEL_12;
      *(_DWORD *)(*((_QWORD *)a1 + 48) + 332LL) &= ~0x100000u;
