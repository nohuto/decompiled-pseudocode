/*
 * XREFs of ?CalculateMouseTable@@YAXXZ @ 0x1C00F5258
 * Callers:
...
void CalculateMouseTable(void)
{
  ...
  v0 = 50 * DWORD1(xmmword_1C032229C);
  v1 = 256LL;
  v2 = 0;
  v3 = 50000 * DWORD1(xmmword_1C032229C) / (unsigned int)(20 * DWORD2(xmmword_1C032229C));
  v4 = 0;
  v5 = 0;
  v6 = 0;
  v7 = 0;
