/*
 * XREFs of xxxRealDrawMenuItem @ 0x1C0242490
 * Callers:
      ...
      if ( v122 )
      {
          ...
          || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v123) + 776) & 0x4000) != 0 )
        {
          goto LABEL_281;
             ...
             || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
               ? (v130 = 0)
               : (v130 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                               + 8LL)
                                   + 244LL) & 1),
                 !v130) )
      {
LABEL_281:
        if ( IsDPIDWMSysMet(0x37uLL)
          ...
          && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
            ? (v127 = 0)
            : (v127 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                            + 8LL)
                                + 244LL) & 1),
              v127) )
        {
...
LABEL_322:
          ...
          if ( !v235 )
            goto LABEL_355;
          ObjectW = GreExtGetObjectW(*(HBRUSH *)(v6 + 104), 104LL, v242);
          if ( !a5 || *(_DWORD *)v6 == 4 )
          {
...
LABEL_336:
          if ( CompatibleDC )
            NtGdiAlphaBlend(a1, v234 + v225, v83 + v233, v145, v82, (POINTL)CompatibleDC, 0, 0, v145, v82, v231);
          goto LABEL_338;
        }
        if ( v122 )
        {
...
LABEL_301:
          if ( IsDPIDWMSysMet(0x37uLL)
            ...
            && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
              ? (v134 = 0)
              : (v134 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                              + 8LL)
                                  + 244LL) & 1),
                v134) )
          {
...
LABEL_188:
    ...
    v240[0] = *(_QWORD *)(gptiCurrent + 368LL);
    *(_QWORD *)(gptiCurrent + 368LL) = v240;
    v240[1] = v84;
    ++*(_DWORD *)(v84 + 8);
    ...
    if ( (unsigned int)IsDPIAbsoluteSysMet(0x2EuLL) )
    {
        ...
        || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v89) + 776) & 0x4000) != 0 )
      {
        goto LABEL_199;
           ...
           || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
             ? (v94 = 0)
             : (v94 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                            + 8LL)
                                + 244LL) & 1),
               !v94) )
    {
LABEL_199:
      if ( IsDPIDWMSysMet(0x2EuLL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
          ? (v91 = 0)
          : (v91 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                         + 8LL)
                             + 244LL) & 1),
            v91) )
      {
      ...
      if ( v98 )
      {
          ...
          || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v99) + 776) & 0x4000) != 0 )
        {
          goto LABEL_227;
             ...
             || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
               ? (v102 = 0)
               : (v102 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                               + 8LL)
                                   + 244LL) & 1),
                 !v102) )
      {
LABEL_227:
        if ( IsDPIDWMSysMet(0x2DuLL)
          ...
          && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
            ? (v105 = 0)
            : (v105 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                            + 8LL)
                                + 244LL) & 1),
              v105) )
        {
...
LABEL_241:
          if ( IsDPIDWMSysMet(6uLL)
            ...
            && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
              ? (v109 = 0LL)
              : (v109 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                              + 8LL)
                                  + 244LL) & 1),
                (_DWORD)v109) )
          {
            v112 = (unsigned int *)(gpsi + 2680LL);
          }
          else
          {
            v112 = (unsigned int *)(gpsi + 1904LL);
          }
LABEL_257:
          if ( v98 )
          {
...
LABEL_109:
  v52 = v51 + 16LL * v48;
  v53 = (unsigned int)(*(_DWORD *)(v6 + 84) - *(_DWORD *)(v52 + 12)) >> 1;
  FixHDCBITSBmp(v49);
  v54 = v225;
  BltColor(
    a1,
    ...
    if ( (unsigned int)IsDPIAbsoluteSysMet(0x2DuLL) )
    {
        ...
        || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v157) + 776) & 0x4000) != 0 )
      {
        goto LABEL_366;
           ...
           || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
             ? (v162 = 0)
             : (v162 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                             + 8LL)
                                 + 244LL) & 1),
               !v162) )
    {
LABEL_366:
      if ( IsDPIDWMSysMet(0x2DuLL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
          ? (v159 = 0)
          : (v159 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                          + 8LL)
                              + 244LL) & 1),
            v159) )
      {
...
LABEL_397:
  ...
  {
    v167 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
...
LABEL_386:
  if ( IsDPIDWMSysMet(6uLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
      ? (v167 = 0LL)
      : (v167 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
                          + 244LL) & 1),
        (_DWORD)v167) )
  {
...
LABEL_402:
  ...
  if ( (*(_DWORD *)(PsGetCurrentProcessWin32Process(v185) + 776) & 0x2000) != 0
    ...
    || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
      ? (v187 = 0)
      : (v187 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
                          + 244LL) & 1),
...
LABEL_422:
  if ( IsDPIDWMSysMet(0x2DuLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
      ? (v194 = 0)
      : (v194 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
                          + 244LL) & 1),
        v194) )
  {
...
LABEL_438:
  ...
  if ( (*(_DWORD *)v6 & 0x2000) != 0 && v224 )
  {
    ...
    if ( (unsigned int)MNGetpItemIndex((__int64)v229, v6) == -1 || v232 != *(_QWORD *)(v6 + 56) )
      goto LABEL_457;
    v225 = v199 - v237;
  }
  else
  ...
  xxxDrawMenuItemText(v200, (struct tagITEM *)v6, a1, v234 + v225, v233 + v228, v154, v184, *((_DWORD *)v200 + 10) & 4);
  if ( (unsigned int)MNGetpItemIndex((__int64)v229, v6) == -1 || v232 != *(_QWORD *)(v6 + 56) )
    goto LABEL_457;
...
LABEL_480:
    if ( (unsigned int)CharPosition < v155 - 1 )
    {
      ...
      {
        v235 = 0LL;
        xxxPSMGetTextExtent(a1, &v154[CharPosition + 1], v155 - CharPosition - 1, (__int64)&v235);
        if ( (unsigned int)MNGetpItemIndex((__int64)v229, v6) == -1 || v205 != *(_QWORD *)(v6 + 56) )
          goto LABEL_457;
...
LABEL_457:
  ...
  if ( v30 || !v224 )
  {
    xxxPSMGetTextExtent(a1, &v154[v184 + 1], CharPosition - v184 - 1, (__int64)&v236);
    if ( (unsigned int)MNGetpItemIndex((__int64)v229, v6) == -1 || v232 != *(_QWORD *)(v6 + 56) )
    {
      v204 = a1;
      goto LABEL_458;
  ...
  v203 = v184 + 1;
  v204 = a1;
  xxxPSMTextOut(a1, v201, v228, &v154[v203], v202, (~*((_BYTE *)v229 + 40) & 4) << 18);
  if ( (unsigned int)MNGetpItemIndex((__int64)v229, v6) != -1 )
  {
    v205 = v232;
    if ( v232 != *(_QWORD *)(v6 + 56) )
...
LABEL_458:
  ...
  if ( (*(_DWORD *)(PsGetCurrentProcessWin32Process(v206) + 776) & 0x2000) != 0
    ...
    || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
      ? (v209 = 0)
      : (v209 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
                          + 244LL) & 1),
        !v209) )
  {
    v216 = (_QWORD *)gpsi;
