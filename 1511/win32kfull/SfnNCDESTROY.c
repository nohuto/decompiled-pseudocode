/*
 * XREFs of SfnNCDESTROY @ 0x1C00E3520
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfnNCDESTROY(__int64 *a1, int a2, __int64 a3, __int64 a4, __int64 a5, unsigned __int64 a6)
{
  __int64 v10; // rsi
  __int64 v11; // rdx
  __int64 v12; // rax
  ...
  *(_QWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 80LL) = v14;
  ...
  v15 = KeUserModeCallback(3LL, v23, 48LL, &a6, &v24);
