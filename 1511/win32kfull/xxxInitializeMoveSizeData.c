/*
 * XREFs of xxxInitializeMoveSizeData @ 0x1C020CE20
 * Callers:
 ...
 *     ?AreDockTargetsActive@@YAEPEAU_MOVESIZEDATA@@@Z @ 0x1C0204DE4 (-AreDockTargetsActive@@YAEPEAU_MOVESIZEDATA@@@Z.c)
...
__int64 __fastcall xxxInitializeMoveSizeData(__int64 a1, __int64 a2, int a3, unsigned int a4, int a5)
{
  ...
  *(_OWORD *)(a2 + 120) = *(_OWORD *)(a1 + 112);
  ...
  if ( (*(_BYTE *)(a1 + 48) & 0x88) == 0 && *(_DWORD *)(gpDispInfo + 80LL) <= 1u )
  {
    ...
    if ( (_DWORD)v14
      || (v11 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL), (v11 & 1) == 0) )
    {
      if ( (_DWORD)v14 == 1
        && (v11 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL), (v11 & 1) != 0) )
      {
...
LABEL_26:
  ...
  v19 = *(_DWORD *)(a1 + 344);
  if ( v19 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
  {
    if ( v19 == 1 && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL) & 1) != 0 )
...
LABEL_27:
  ...
  else
  {
    ...
    *(_DWORD *)(a2 + 180) ^= (*(_DWORD *)(a2 + 180) ^ (((unsigned int)IntersectRect(v96, v13, v18) == 0) << 6)) & 0x40;
    v35 = PtInRect(v18, v93);
    *(_DWORD *)(a2 + 180) = v33 ^ (v33 ^ (!v35 << 21)) & 0x200000;
  }
  if ( (*(_DWORD *)(a2 + 180) & 0x100000) != 0 )
    zzzClipCursorEx((LONG *)&v97, 0LL, v33, v34);
...
LABEL_73:
  ...
  *(_DWORD *)(a2 + 268) = v25;
  *(_DWORD *)(a2 + 272) = v27;
  *(_DWORD *)(a2 + 180) = (v54 & 0xFFFFFFFC ^ (v54 & 0xFFFFFFFC ^ ((((unsigned __int8)~(_BYTE)a5 >> 1) & 1) << 26)) & 0x4000000) & 0x7CFBFF7F;
  *(_OWORD *)(a2 + 8) = v55;
  *(_OWORD *)(a2 + 24) = v55;
  *(_OWORD *)(a2 + 40) = v55;
  *(_OWORD *)(a2 + 56) = v55;
  v57 = (unsigned int)SizeWithSnapAllowed((struct tagWND *)a1)
  ...
  *(_DWORD *)(a2 + 180) ^= (*(_DWORD *)(a2 + 180) ^ (v57 << 10)) & 0x400;
  v58 = (unsigned int)MoveWithArrangementAllowed((struct tagWND *)a1)
     && AreDockTargetsActive((struct _MOVESIZEDATA *)a2)
     && (*(_BYTE *)(a1 + 54) & 4) != 0
     && ((*(_BYTE *)(a1 + 55) | *(_BYTE *)(a1 + 48)) & 0x40) == 0
     && (*(_BYTE *)(*(_QWORD *)a2 + 54LL) & 1) != 0
     && *(_WORD *)(*(_QWORD *)(a1 + 152) + 8LL) != *(_WORD *)(gpsi + 884LL);
  v59 = *(_DWORD *)(a2 + 180) ^ (*(_DWORD *)(a2 + 180) ^ (v58 << 11)) & 0x800;
  *(_DWORD *)(a2 + 180) = v59;
  if ( (v59 & 0xC00) != 0xC00
    && ((*(_BYTE *)(a1 + 289) & 3) != 0
  ...
  if ( (v62 & 0xC00) == 0 )
  {
    *(_QWORD *)(a2 + 208) = MonitorFromPoint(v29, 2u);
    goto LABEL_131;
  }
  ...
  if ( (unsigned int)IsDPIAbsoluteSysMet(8uLL) )
  {
      ...
      || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v73) + 776) & 0x4000) != 0 )
    {
      goto LABEL_141;
         ...
         || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
           ? (v78 = 0)
           : (v78 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                          + 8LL)
                              + 244LL) & 1),
             !v78) )
  {
...
LABEL_162:
  ...
  *(_DWORD *)(a2 + 164) = dword_1C02EAC18[a3];
  *(_DWORD *)(a2 + 168) = dword_1C02EABE8[a3];
  v89 = dword_1C02EAC78[a3];
  if ( v89 != -1 )
    *(_DWORD *)(a2 + 152) = *(_DWORD *)(a2 + 4LL * (__int16)v89 + 104) - v25;
  v90 = dword_1C02EAC48[a3];
  if ( v90 != -1 )
  ...
  *(_QWORD *)(a2 + 224) = 0LL;
  *(_QWORD *)(a2 + 232) = 0LL;
  v91 = *(_DWORD *)(a2 + 256) ^ (*(_BYTE *)(a1 + 291) & 1 ^ *(_DWORD *)(a2 + 256)) & 1;
  result = v91 ^ (v91 ^ (2 * v91)) & 2 ^ ((unsigned __int8)(v91 ^ (v91 ^ (2 * v91)) & 2) ^ (unsigned __int8)(8 * ((a5 & 4) != 0))) & 8u;
