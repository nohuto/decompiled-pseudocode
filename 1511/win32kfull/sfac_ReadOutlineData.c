/*
 * XREFs of sfac_ReadOutlineData @ 0x1C00B0720
 * Callers:
        ...
        unsigned int *a14)
{
  ...
  unsigned __int16 v53; // [rsp+78h] [rbp+30h]
...
LABEL_14:
  ...
  while ( 1 )
  {
    ...
    *v48 = *(_WORD *)((char *)v48 + v47 - 2) + 1;
    v51 = __ROR2__(*(_WORD *)((char *)v48 + v49), 8);
    if ( v51 > 0x7FFFu )
      break;
    *v50 = v51;
    if ( v29 > (__int16)v51 || v29 > a5[3] || v29 <= 0 )
      return 5121LL;
    ++v28;
    v29 = (__int16)v51 + 1;
    ++v48;
