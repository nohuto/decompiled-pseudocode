/*
 * XREFs of ??0PFFMEMOBJ@@QEAA@IPEAGKKPEAUtagDESIGNVECTOR@@K_KPEAUHDEV__@@PEAUDHPDEV__@@PEAVPFT@@KKPEAU_FNTCHECKSUM@@PEAPEAU_FONTFILEVIEW@@PEAU_UNIVERSAL_FONT_ID@@@Z @ 0x1C0119FD8
 * Callers:
  ...
  *(_DWORD *)(*(_QWORD *)this + 32LL) = v18;
  if ( (_DWORD)v18 )
  {
    *(_QWORD *)(*(_QWORD *)this + 24LL) = *(_QWORD *)this + v20;
    ...
    if ( a9 == (HDEV)gppdevTrueType && wcsstr(*(const wchar_t **)(*(_QWORD *)this + 24LL), L"YUGOTH") )
    {
      v24 = a12 | 0x100;
      goto LABEL_24;
    }
...
LABEL_24:
  *(_DWORD *)(*(_QWORD *)this + 48LL) = Size;
  if ( (_DWORD)Size )
  {
    *(_QWORD *)(*(_QWORD *)this + 40LL) = *(_QWORD *)this + v34;
  ...
  *(_DWORD *)(*(_QWORD *)this + 136LL) = 0;
  ...
  else if ( a15 )
  {
    *(_DWORD *)(*(_QWORD *)this + 136LL) = *((_DWORD *)a14 + 1);
    ...
    {
      v27 = *(_QWORD *)this;
      *(_DWORD *)(v27 + 136) += ComputeFileviewCheckSumInFontDriverAddressSpace(a15, a5);
      if ( (a13 & 0x10) == 0 )
      {
        v28 = 1;
        if ( !a5 )
...
LABEL_41:
    ...
    {
      v32 = *(_QWORD *)this;
      *(_DWORD *)(v32 + 136) += ComputeFileviewCheckSum(Src, Size);
    }
  }
  return this;
}
