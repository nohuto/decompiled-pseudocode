/*
 * XREFs of xxxUserReinitializeAutoRotation @ 0x1C009A300
 * Callers:
...
__int64 xxxUserReinitializeAutoRotation()
{
  ...
  dword_1C0323D68 = QueryAutoRotationRegistrySetting(
                      L"Enable",
                      1u,
                      L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\CurrentVersion\\AutoRotation");
  if ( (unsigned int)dword_1C031B280 > 5 && TlgKeywordOn(v0, 0x400000000000uLL) )
  {
    v7 = 1;
    v9 = &dword_1C0323D68;
    v10 = 4LL;
    v11 = &v7;
    v12 = 4LL;
    TlgWrite((TraceLoggingHProvider)4, &unk_1C02E9371, v1, v2, 4u, &pData);
  }
  dword_1C0323D98 = QueryAutoRotationRegistrySetting(
                      L"SlateEnable",
                      1u,
                      L"\\Registry\\Machine\\Software\\Microsoft\\Windows\\CurrentVersion\\AutoRotation");
  dword_1C0323D6C = QueryAutoRotationRegistrySetting(
                      L"SensorPresent",
                      0,
  ...
  dword_1C0323D88 = AutoRotationRegistrySetting != -1;
  ...
  if ( v5 > 3 )
    v5 = 0;
  dword_1C0323D64 = v5;
  dword_1C0323D78 = IsNativeOrientationPortrait();
  dword_1C0323D7C = 0;
