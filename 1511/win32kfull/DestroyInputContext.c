/*
 * XREFs of DestroyInputContext @ 0x1C01E333C
 * Callers:
 ...
 *     AssociateInputContext @ 0x1C0100E58 (AssociateInputContext.c)
 */
...
LABEL_3:
  ...
  v5 = BuildHwndList(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v2 + 408) + 8LL) + 16LL) + 96LL), 3, a1[2]);
  v6 = v5;
  if ( v5 )
  {
    for ( i = (unsigned __int64 *)((char *)v5 + 32); *i != 1; ++i )
    {
      ...
      if ( v8 && *(_QWORD *)(v8 + 248) == *a1 )
        AssociateInputContext(v8, *(__int64 **)(v2 + 704));
    }
    FreeHwndList(v6);
  }
