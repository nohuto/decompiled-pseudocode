/*
 * XREFs of SetManifestWinVer @ 0x1C00E1E10
 * Callers:
 *     <none>
 * Callees:
 *     SbGetProcessSwitchContext @ 0x1C00E1EC4 (SbGetProcessSwitchContext.c)
 *     SbGetContextDetailsByGuid @ 0x1C00E1F14 (SbGetContextDetailsByGuid.c)
 */
...
__int64 SetManifestWinVer()
{
  ...
  if ( v1 )
  {
    ...
    if ( ProcessWow64Process )
      ...
      v3 = *(_QWORD *)(PsGetProcessPeb(**(_QWORD **)(gptiCurrent + 376LL)) + 728);
