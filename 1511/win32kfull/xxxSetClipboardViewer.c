/*
 * XREFs of xxxSetClipboardViewer @ 0x1C014C7F4
 * Callers:
 *     NtUserSetClipboardViewer @ 0x1C014C760 (NtUserSetClipboardViewer.c)
 * Callees:
...
__int64 __fastcall xxxSetClipboardViewer(__int64 a1)
{
  ...
  if ( !v2 )
    return 0LL;
  if ( a1 && *(_QWORD **)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 376LL) + 640LL) != v2 )
  {
LABEL_10:
    UserSetLastError(87);
    return 0LL;
