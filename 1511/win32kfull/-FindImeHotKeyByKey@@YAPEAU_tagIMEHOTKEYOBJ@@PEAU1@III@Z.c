/*
 * XREFs of ?FindImeHotKeyByKey@@YAPEAU_tagIMEHOTKEYOBJ@@PEAU1@III@Z @ 0x1C0082110
 * Callers:
 ...
 *     ?GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z @ 0x1C01EC960 (-GetLangIdMatchLevel@@YAHPEAUHKL__@@G@Z.c)
 */
