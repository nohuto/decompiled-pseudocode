/*
 * XREFs of ?bSpCreateShape@@YAHPEAVSPRITE@@PEAU_POINTL@@PEAU_SURFOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAVPALETTE@@KK4@Z @ 0x1C026F420
 * Callers:
...
LABEL_23:
  ...
  *((_DWORD *)a1 + 35) = v19;
  if ( a6 )
    v20 = **((_DWORD **)a6 + 16) | *(_DWORD *)(*((_QWORD *)a6 + 16) + 8LL);
  else
    v20 = 0;
  v21 = v44;
  *((_DWORD *)a1 + 39) = v20;
  ...
  if ( ERECTL::bEmpty((ERECTL *)&v55) )
    goto LABEL_62;
  if ( (*(_DWORD *)a1 & 0x40) == 0
    || (*(_DWORD *)a1 & 0x200) != 0 && (v29 = SURFOBJ_TO_SURFACE_NOT_NULL(v17), *(HSURF *)(v29 + 336) == v47->hsurf) )
  {
    v30 = *(_QWORD *)&v48.left;
    v31 = **(_DWORD **)&v48.left;
...
LABEL_40:
    ...
    v38 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)hdev + 359);
    goto LABEL_40;
  }
  *(_DWORD *)a1 |= 0x80u;
LABEL_62:
