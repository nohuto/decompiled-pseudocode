/*
 * XREFs of ?bEnableHalftone@PDEVOBJ@@QEAAHPEAUtagCOLORADJUSTMENT@@@Z @ 0x1C001C078
 * Callers:
...
LABEL_22:
  ...
  v17 = *(_QWORD *)this;
  v13 = 1;
  if ( (*(_DWORD *)(v17 + 56) & 1) == 0 && (unsigned int)XEPALOBJ::bEqualEntries(&v19, *(_QWORD *)(v17 + 1832)) )
  {
