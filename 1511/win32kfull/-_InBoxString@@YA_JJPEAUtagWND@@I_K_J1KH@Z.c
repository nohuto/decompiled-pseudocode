/*
 * XREFs of ?_InBoxString@@YA_JJPEAUtagWND@@I_K_J1KH@Z @ 0x1C013FF80
 * Callers:
 *     NtUserfnINCBOXSTRING @ 0x1C013FF00 (NtUserfnINCBOXSTRING.c)
 *     NtUserfnINLBOXSTRING @ 0x1C013FF40 (NtUserfnINLBOXSTRING.c)
 * Callees:
        ...
        int a8)
{
  ...
  v13 = *(_DWORD *)(gptiCurrent + 1244LL);
  if ( v10 || v11 )
  {
    *(_DWORD *)(gptiCurrent + 1244LL) = 2;
    if ( a3 == v12 )
