/*
 * XREFs of ?vEudcOpaqueArea@ESTROBJ@@QEAAXPEAU_POINTFIX@@H@Z @ 0x1C00291E0
 * Callers:
 ...
 * Callees:
 *     AdjustBoundingBox @ 0x1C000B798 (AdjustBoundingBox.c)
    ...
    switch ( v8 )
    {
      ...
      default:
        ...
        if ( v10 )
        {
          ...
          {
            v30 = *((_QWORD *)this + 7);
            v29 = *(_QWORD *)(*(_QWORD *)v30 + 752LL);
            if ( v29 )
            {
              if ( *(_QWORD *)(v29 + 8LL * (unsigned int)(v8 - 4)) )
              {
                *(_QWORD *)&v32 = *(_QWORD *)(v29 + 8LL * (unsigned int)(v8 - 4));
LABEL_38:
                AdjustBoundingBox(v30, (__int64)&v32, &v36, &v35, (int *)&v34, &v33);
                goto LABEL_9;
              }
            }
          }
