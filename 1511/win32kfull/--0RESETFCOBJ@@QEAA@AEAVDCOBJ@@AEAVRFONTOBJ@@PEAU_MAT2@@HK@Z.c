/*
 * XREFs of ??0RESETFCOBJ@@QEAA@AEAVDCOBJ@@AEAVRFONTOBJ@@PEAU_MAT2@@HK@Z @ 0x1C01061A8
 * Callers:
 ...
 *     ?vFixedToEf@@YAXPEAVEFLOAT@@AEAU_FIXED@@@Z @ 0x1C02B27CC (-vFixedToEf@@YAXPEAVEFLOAT@@AEAU_FIXED@@@Z.c)
 */
...
LABEL_21:
    ...
    if ( (unsigned int)PFEOBJ::bSetFontXform(v29, a2, v11 + 3, &v30, 1u, v20, &v23, (struct IFIOBJ *)&v29, 0) )
    {
