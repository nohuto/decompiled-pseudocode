/*
 * XREFs of xxxFlashWindow @ 0x1C00C6ACC
 * Callers:
...
__int64 __fastcall xxxFlashWindow(__int64 a1, unsigned int a2, int a3)
{
  ...
  {
    if ( (v9 & 8) != 0 && gpqForeground == *(_QWORD *)(*(_QWORD *)(a1 + 16) + 384LL) )
      v10 = 0;
    if ( v10 )
    {
      v11 = v7 == 0;
...
LABEL_13:
      if ( (!v10 || (v10 & 2) != 0) && (unsigned int)IsTrayWindow(a1) )
      {
        ...
        if ( (v9 & 0x800) != 0 )
          ...
          v3 = v10 != 0 && v11;
        xxxCallHook(6u, *(_QWORD *)a1, v3, 0xAu);
...
LABEL_27:
          ...
          InternalSetProp(a1, (unsigned __int16)gaFlashWState, v14, 5);
        }
      }
      else
      {
        ...
        InternalRemoveProp(a1, gaFlashWState, 1);
      }
      return v7;
    }
LABEL_35:
    xxxSendTransformableMessageTimeout((struct tagWND *)a1, 134LL, v11, 0LL, 0, 100, &v16, 1, 0);
    goto LABEL_13;
  }
  return v7;
}
