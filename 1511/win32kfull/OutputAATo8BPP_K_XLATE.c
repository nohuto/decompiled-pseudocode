/*
 * XREFs of OutputAATo8BPP_K_XLATE @ 0x1C0251F00
 * Callers:
 *     <none>
 * Callees:
    ...
    do
    {
      if ( v9[3] )
      {
        ...
        if ( v23 < v21 && v23 < v15 && v23 < v14 )
          v22 = *(_BYTE *)((((unsigned __int16)(v20 - v14) & (unsigned __int16)(v14 - v24) & 0x7000 | (v18 - v15) & (v15 - DWORD1(v24)) & 0x38000 | (unsigned __int64)((v16 - v21) & (v21 - DWORD2(v24)) & 0x1C0000)) >> 12)
                         + a9);
        *a4 = v22;
      }
      ++a4;
