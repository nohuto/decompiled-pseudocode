/*
 * XREFs of NtUserPhysicalToLogicalPoint @ 0x1C00752D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserPhysicalToLogicalPoint(__int64 a1, __int64 *a2)
{
  ...
  if ( v7 )
  {
    ...
    v18 = *v8;
    v9 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 432);
    if ( (*(_BYTE *)(v9 + 224) & 1) == 0 )
    {
      v10 = *(_QWORD *)(v7 + 16);
      CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v9);
      v12 = SameCoordinateSpace(CurrentProcessWin32Process, *(_QWORD *)(v10 + 376));
      v13 = v19;
      if ( !v12 )
        v13 = v18;
      v19 = v13;
    ...
    if ( (unsigned int)DCEPtInRect(v7 + 112, v18) )
    {
      ...
      if ( (*(_BYTE *)(v6 + 224) & 1) == 0 )
      {
        ...
        v6 = (unsigned int)SameCoordinateSpace(v15, *(_QWORD *)(v14 + 376));
        v16 = v18;
        if ( !(_DWORD)v6 )
          v16 = v19;
        v18 = v16;
