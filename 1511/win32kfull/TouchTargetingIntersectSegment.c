/*
 * XREFs of TouchTargetingIntersectSegment @ 0x1C024BCBC
 * Callers:
 ...
 *     _TTUpdateRankWithSegment @ 0x1C024CCC4 (_TTUpdateRankWithSegment.c)
 * Callees:
 *     _TTIntersectLine @ 0x1C024C950 (_TTIntersectLine.c)
 */
