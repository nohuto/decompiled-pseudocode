/*
 * XREFs of prfntDeactivateEudcRFONTs @ 0x1C000E81C
 * Callers:
...
__int64 __fastcall prfntDeactivateEudcRFONTs(_QWORD *a1)
{
  ...
  if ( *((_DWORD *)gpPFTPublic + 6) )
  {
    do
    {
      for ( i = v3[v4 + 4]; i; i = (struct _FONTHASH *)*((_QWORD *)i + 1) )
      {
        if ( (*((_DWORD *)i + 13) & 8) != 0 )
        {
          v7 = *((_QWORD *)i + 9);
            ...
            do
            {
              ...
              if ( v8 == *a1 || v8 == a1[1] )
              {
                ...
                else
                {
                  ...
                  if ( (*(_DWORD *)(v10 + 56) & 0x800000) != 0 )
                    *(_DWORD *)(*(_QWORD *)(v10 + 3544) + 1568LL) = v9;
                  else
                    *(_DWORD *)(v10 + 1568) = v9;
                }
