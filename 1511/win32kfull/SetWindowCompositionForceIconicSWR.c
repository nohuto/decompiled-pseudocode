/*
 * XREFs of SetWindowCompositionForceIconicSWR @ 0x1C010B884
 * Callers:
...
__int64 __fastcall SetWindowCompositionForceIconicSWR(struct tagWND *a1, __int128 *a2)
{
  unsigned int v4; // ebx
  int v5; // esi
  __int64 v7; // rdx
  ...
  {
    if ( -__CFSHR__(v12[0], 4) == v5 )
      return 0;
    v12[0] ^= (LOBYTE(v12[0]) ^ (unsigned __int8)(8 * v5)) & 8;
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v11, *(_QWORD *)a1, 7, a2);
    }
  }
  return v4;
}
