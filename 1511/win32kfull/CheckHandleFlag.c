/*
 * XREFs of CheckHandleFlag @ 0x1C0064898
 * Callers:
 *     _GetUserObjectInformation @ 0x1C004C060 (_GetUserObjectInformation.c)
 *     zzzSetDesktop @ 0x1C00644C0 (zzzSetDesktop.c)
 *     OkayToCloseDesktop @ 0x1C0065BB0 (OkayToCloseDesktop.c)
 *     OkayToCloseWindowStation @ 0x1C00F1620 (OkayToCloseWindowStation.c)
 * Callees:
