/*
 * XREFs of ?pgdGetEudcMetricsPlus@RFONTOBJ@@QEAAPEAU_GLYPHDATA@@GPEAV1@@Z @ 0x1C00270D0
 * Callers:
...
struct _GLYPHDATA *__fastcall RFONTOBJ::pgdGetEudcMetricsPlus(RFONTOBJ *this, struct RFONTOBJ *a2, struct RFONTOBJ *a3)
{
  ...
  if ( *v11 )
    return result;
  if ( (unsigned int)RFONTOBJ::bInsertMetricsPlus(this, v11, v3) )
