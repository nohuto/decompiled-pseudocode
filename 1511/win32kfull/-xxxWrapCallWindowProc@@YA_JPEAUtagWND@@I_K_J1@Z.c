/*
 * XREFs of ?xxxWrapCallWindowProc@@YA_JPEAUtagWND@@I_K_J1@Z @ 0x1C01045A0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 a5)
{
  ...
  {
    if ( (a2 & 0x1FFFF) >= 0x400 )
      return SfnDWORD((__int64 *)a1, a2, a3, a4, *(_QWORD *)(v9 + 48), *(_QWORD *)(gpsi + 744LL));
    else
