/*
 * XREFs of ExtractPointerPropertyValues @ 0x1C01CBB80
 * Callers:
 *     ?GetPointerRawData@@YAHPEBUtagPOINTERINPUTFRAME@@KGIPEBUtagPOINTER_DEVICE_PROPERTY@@PEAJ@Z @ 0x1C01F8BC4 (-GetPointerRawData@@YAHPEBUtagPOINTERINPUTFRAME@@KGIPEBUtagPOINTER_DEVICE_PROPERTY@@PEAJ@Z.c)
 * Callees:
 ...
 *     SignExtendLong @ 0x1C01CE4FC (SignExtendLong.c)
 */
        ...
        __int64 a7)
{
  ...
  if ( a1 )
  {
    if ( a5 <= *((_DWORD *)a1 + 79) )
    {
      v11 = (struct _USAGE_AND_PAGE *)Win32AllocPool(4LL * *((unsigned int *)a1 + 78));
      v40 = v11;
      if ( v11 )
      {
