/*
 * XREFs of ?TraceLoggingProcessUsageOnTerminationEvent@@YAXQEAUtagPROCESSINFO@@@Z @ 0x1C009427C
 * Callers:
 *     DestroyProcessInfoEditionRundown @ 0x1C0094470 (DestroyProcessInfoEditionRundown.c)
 * Callees:
...
void __fastcall TraceLoggingProcessUsageOnTerminationEvent(struct tagPROCESSINFO *const a1)
{
  ...
  if ( (unsigned int)dword_1C031B280 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      v14 = (int)v5;
      v43 = 4LL;
      TlgWrite(v5, &unk_1C02E9BA8, v6, v7, 0x10u, &pData);
    }
  }
}
