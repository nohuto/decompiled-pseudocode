/*
 * XREFs of ?GrePolyPatBltInternal@@YAHAEAVXDCOBJ@@KPEAU_POLYPATBLT@@KKKKKK@Z @ 0x1C0040258
 * Callers:
        ...
        unsigned int a9)
{
  ...
  __int64 v28; // rcx
  int v30; // [rsp+70h] [rbp-118h]
  int v31; // [rsp+74h] [rbp-114h]
  int v32; // [rsp+78h] [rbp-110h]
  __int64 v33; // [rsp+80h] [rbp-108h]
  __int64 v34; // [rsp+88h] [rbp-100h]
  struct SURFACE *v35; // [rsp+B0h] [rbp-D8h]
  __int64 v36; // [rsp+C0h] [rbp-C8h] BYREF
  int v37; // [rsp+CCh] [rbp-BCh]
  __int64 v38; // [rsp+D0h] [rbp-B8h]
  _BYTE v39[80]; // [rsp+E0h] [rbp-A8h] BYREF
  int v40; // [rsp+130h] [rbp-58h] BYREF
  int v41; // [rsp+134h] [rbp-54h]
  int v42; // [rsp+138h] [rbp-50h]
  int v43; // [rsp+13Ch] [rbp-4Ch]
