/*
 * XREFs of ?PanGradientFill@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAXKPEAU_RECTL@@PEAU_POINTL@@K@Z @ 0x1C0288600
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1PANSURFLOCK@@QEAA@XZ @ 0x1C0287A80 (--1PANSURFLOCK@@QEAA@XZ.c)
 *     ?bIgnoreDeviceSurfaceUpdates@@YAHPEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C02895DC (-bIgnoreDeviceSurfaceUpdates@@YAHPEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z.c)
        ...
        ULONG ulMode)
{
  ...
  BOOL v15; // esi
  CLIPOBJ *pco; // [rsp+50h] [rbp-A1h] BYREF
  int v18; // [rsp+58h] [rbp-99h] BYREF
  ...
  psoDest = a1;
  PANSURFLOCK::PANSURFLOCK((PANSURFLOCK *)v20, dhpdev, &psoDest, prclExtents, &v18, a2);
