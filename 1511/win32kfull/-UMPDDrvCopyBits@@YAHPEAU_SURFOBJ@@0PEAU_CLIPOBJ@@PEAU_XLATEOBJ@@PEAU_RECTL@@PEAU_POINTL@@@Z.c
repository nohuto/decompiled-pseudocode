/*
 * XREFs of ?UMPDDrvCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C029CAB0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _POINTL *a6)
{
  ...
  struct _SURFOBJ *v26; // [rsp+C0h] [rbp-50h]
  ...
  if ( !*((_DWORD *)v24 + 109) )
    goto LABEL_8;
  if ( a4 )
    v13 = ((4 * a4->cEntries + 7) & 0xFFFFFFF8) + 24;
  else
    v13 = 0;
  v18 = v13 + 128;
