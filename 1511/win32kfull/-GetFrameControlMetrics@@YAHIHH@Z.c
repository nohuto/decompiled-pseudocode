/*
 * XREFs of ?GetFrameControlMetrics@@YAHIHH@Z @ 0x1C0017E00
 * Callers:
...
__int64 __fastcall GetFrameControlMetrics(unsigned int a1, int a2, int a3)
{
  ...
  v5 = 0;
  v7 = 0;
  v8 = *((_WORD *)&unk_1C02E1840 + 2 * a1 + 1);
  v9 = gpsi + 5748LL;
  if ( !a3 )
    v9 = gpsi + 4260LL;
  v10 = v9 + 16LL * a1;
  switch ( *((_WORD *)&unk_1C02E1840 + 2 * a1) )
  {
    case 1:
      if ( (v8 & 0x80u) != 0 )
      {
...
LABEL_20:
  ...
  if ( *((_WORD *)&unk_1C02E1840 + 2 * a1) != 4 )
  {
    if ( *((_WORD *)&unk_1C02E1840 + 2 * a1) != 5 )
    {
      if ( *((unsigned __int16 *)&unk_1C02E1840 + 2 * a1) != 0xFFFF )
        goto LABEL_14;
      if ( (v8 & 1) == 0 )
      {
...
LABEL_26:
    v18 = (_DWORD *)gdpiSystem;
    if ( a3 )
      v18 = (_DWORD *)gdpi96;
    if ( (v8 & 0x18) != 0 )
      v7 = v18[17];
    else
      v7 = ((v18[13] + v18[15] + GFCM_SYSMET(6, a3)) & 0xFFFE) - 1;
    goto LABEL_9;
  }
  if ( (v8 & 0x408) != 8 )
  {
    v7 = *(unsigned __int16 *)(gpsi + 7286LL) / 8 + 1;
LABEL_9:
    v5 = v7;
    goto LABEL_14;
  }
