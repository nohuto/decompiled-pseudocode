/*
 * XREFs of ?TraceLoggingStubInvalidParamEvent@@YAXIKPEAD@Z @ 0x1C022614C
 * Callers:
...
void __fastcall TraceLoggingStubInvalidParamEvent(__int64 a1, int a2, char *a3)
{
  ...
  if ( CurrentProcessWin32Process )
  {
    ...
    v5 = *(const struct _TlgProvider_t **)(CurrentProcessWin32Process + 984);
    if ( v5 && *((_QWORD *)&v7 + 1) - (_QWORD)v5 <= 0xEA60uLL )
      return;
    *(_QWORD *)(CurrentProcessWin32Process + 984) = *((_QWORD *)&v7 + 1);
  }
  if ( (unsigned int)dword_1C031B280 > 5 )
  {
    if ( TlgKeywordOn(v5, 0x400000000000uLL) )
    {
      ...
      TlgWrite(v8, &unk_1C02E93FB, v9, v10, 5u, &pData);
    }
  }
}
