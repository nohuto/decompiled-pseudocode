/*
 * XREFs of ?bRectangleMesh@@YAHPEAVSURFACE@@PEAU_XLATEOBJ@@PEAU_TRIVERTEX@@KPEAU_GRADIENT_RECT@@KKPEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C00DF714
 * Callers:
 *     EngGradientFill @ 0x1C00DF0D0 (EngGradientFill.c)
 * Callees:
 *     ?MDiv64@@YA_J_J00@Z @ 0x1C00DFB08 (-MDiv64@@YA_J_J00@Z.c)
 *     ?bUMPDSecurityGateEx@@YAHXZ @ 0x1C00DFB54 (-bUMPDSecurityGateEx@@YAHXZ.c)
 *     ?bCalcGradientRectOffsets@@YAHPEAU_GRADIENTRECTDATA@@@Z @ 0x1C00DFB9C (-bCalcGradientRectOffsets@@YAHPEAU_GRADIENTRECTDATA@@@Z.c)
        ...
        struct _POINTL *a9)
{
  ...
  __int64 v38; // r11
  __int64 v39; // r8
  __int64 v40; // [rsp+28h] [rbp-170h] BYREF
  struct _GRADIENT_RECT *v41; // [rsp+30h] [rbp-168h]
  struct _TRIVERTEX *v42; // [rsp+38h] [rbp-160h]
  void (*v43[3])(struct SURFACE *, struct _GRADIENTRECTDATA *); // [rsp+48h] [rbp-150h] BYREF
  void (*v44)(struct SURFACE *, struct _TRIANGLEDATA *); // [rsp+60h] [rbp-138h] BYREF
  ...
  v13 = 1;
  v40 = *((_QWORD *)a1 + 15);
  if ( v40 || (v45 = *((_QWORD *)a1 + 6), (v40 = *(_QWORD *)(v45 + 1832)) != 0) )
  {
    bDetermineTriangleFillRoutine(a1, (struct XEPALOBJ *)&v40, &v44, v43);
    v61 = a2;
    v62 = &v40;
    v59 = (__int64)*a9;
    v46 = (__int128)*a8;
    ...
    while ( (unsigned int)v15 < a6 )
    {
      ...
      if ( v49 - v47 > 0 && v23 > 0 )
      {
        ...
        v54 = v24;
        v25 = ((unsigned __int64)v20->Red << 40) - v51;
        if ( a7 )
        {
          v57 = 0LL;
          v58 = 0LL;
          v34 = ((unsigned __int64)v20->Alpha << 40) - v24;
          *(_QWORD *)&v55 = MDiv64(v25, 1LL, v23);
          *((_QWORD *)&v55 + 1) = MDiv64(v36, 1LL, v35);
          *(_QWORD *)&v56 = MDiv64(v38, 1LL, v37);
          *((_QWORD *)&v56 + 1) = MDiv64(v34, 1LL, v39);
        }
        else
        {
          v55 = 0LL;
          ...
          *(_QWORD *)&v57 = MDiv64(v25, 1LL, v49 - v47);
          *((_QWORD *)&v57 + 1) = MDiv64(v28, 1LL, v27);
          *(_QWORD *)&v58 = MDiv64(v30, 1LL, v29);
          *((_QWORD *)&v58 + 1) = MDiv64(v26, 1LL, v31);
        }
