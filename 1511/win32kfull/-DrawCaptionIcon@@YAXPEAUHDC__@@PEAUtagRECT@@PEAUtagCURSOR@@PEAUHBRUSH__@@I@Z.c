/*
 * XREFs of ?DrawCaptionIcon@@YAXPEAUHDC__@@PEAUtagRECT@@PEAUtagCURSOR@@PEAUHBRUSH__@@I@Z @ 0x1C0235EA4
 * Callers:
...
LABEL_65:
      if ( IsDPIDWMSysMet(5uLL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
          ? (v41 = 0)
          : (v41 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                         + 8LL)
                             + 244LL) & 1),
            v41) )
      {
      ...
      if ( IsDPIDWMSysMet(0x31uLL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
          ...
          : (v22 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
            ...
            (_DWORD)v22) )
      {
        v25 = (unsigned int *)(gpsi + 2852LL);
        v7 = a3;
      }
      else
      {
        v25 = (unsigned int *)(gpsi + 2076LL);
      }
      goto LABEL_44;
    }
    v25 = (unsigned int *)(gpsi + 2464LL);
LABEL_44:
...
LABEL_50:
  ...
  {
    v35 = 3LL * v15;
    v36 = gcachedCaptions[3 * v15 + 1];
  }
  else
  {
    v35 = 3LL * v15;
    v36 = gcachedCaptions[3 * v15 + 2];
  }
  if ( (a5 & 1) == 0 )
    v36 += 16LL;
  FixHDCBITSBmp(v35);
