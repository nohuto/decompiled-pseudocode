/*
 * XREFs of BmfdQueryFontData @ 0x1C0116898
 * Callers:
 *     BmfdQueryFontDataTE @ 0x1C01167F0 (BmfdQueryFontDataTE.c)
 * Callees:
 *     cjBmfdDeviceMetrics @ 0x1C01164C8 (cjBmfdDeviceMetrics.c)
 *     BmfdOpenFontContext @ 0x1C0116624 (BmfdOpenFontContext.c)
 *     bReconnectBmfdFont @ 0x1C0116AA8 (bReconnectBmfdFont.c)
 *     vComputeSimulatedGLYPHDATA @ 0x1C0116B14 (vComputeSimulatedGLYPHDATA.c)
 *     cjGlyphDataSimulated @ 0x1C0116CC8 (cjGlyphDataSimulated.c)
 *     pjRawBitmap @ 0x1C0116D18 (pjRawBitmap.c)
 *     vBmfdScrubGLYPHBITS @ 0x1C0116DC4 (vBmfdScrubGLYPHBITS.c)
...
__int64 __fastcall BmfdQueryFontData(__int64 a1, int a2, unsigned int a3, __int64 a4, _DWORD *pv, size_t Size)
{
  ...
  ULONG v29; // [rsp+60h] [rbp-168h]
  unsigned int v31; // [rsp+68h] [rbp-160h] BYREF
  ...
  v28 = pjRawBitmap(a3, v12 + 36, v12, &v31);
    ...
    if ( v16 )
    {
      ...
      else
      {
        ...
        if ( v24 )
        {
          ...
          {
            case 8192:
              vCvtToBoldBmp((_DWORD)v9, v18, v28, v16, *(unsigned __int16 *)(v27 + 8), v14);
              break;
            case 16384:
              vCvtToItalicBmp((_DWORD)v9, v18, v28, v16, *(unsigned __int16 *)(v27 + 8), v14);
              break;
            case 24576:
              vCvtToBoldItalicBmp((_DWORD)v9, v18, v28, v16, *(unsigned __int16 *)(v27 + 8), v14);
              break;
          }
        }
        else
        {
          vCvtToBmp((_DWORD)v9, v18, v28, v16, *(unsigned __int16 *)(v27 + 8), v14);
        }
      }
    }
    else
