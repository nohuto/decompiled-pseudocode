/*
 * XREFs of NtUserGetWindowCompositionAttribute @ 0x1C0050DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetWindowCompositionAttribute(__int64 a1, __m128i *a2)
{
  ...
  _QWORD Src[3]; // [rsp+28h] [rbp-140h] BYREF
  unsigned __int64 v33; // [rsp+40h] [rbp-128h]
  void *v34[2]; // [rsp+60h] [rbp-108h]
  SIZE_T v35; // [rsp+70h] [rbp-F8h]
  void *v36; // [rsp+78h] [rbp-F0h]
  __m256i v37; // [rsp+80h] [rbp-E8h] BYREF
  __int64 v38; // [rsp+A0h] [rbp-C8h]
  __int128 v39; // [rsp+B0h] [rbp-B8h]
  __int64 v40; // [rsp+C0h] [rbp-A8h]
  __m128i v41; // [rsp+C8h] [rbp-A0h]
  SIZE_T Length; // [rsp+D8h] [rbp-90h]
  int v43[10]; // [rsp+F8h] [rbp-70h] BYREF
  ...
  *(__m128i *)v34 = v41;
  ...
  ProbeForWrite(
    (volatile void *)_mm_srli_si128(v41, 8).m128i_i64[0],
    (unsigned int)Length,
    CurrentProcessWow64Process != 0 ? 1 : 4);
  v7 = _mm_cvtsi128_si32(v41);
  if ( (unsigned int)(v7 - 1) <= 0x15 )
  {
    Size = qword_1C02E1A88[2 * v7];
    v33 = Size;
    CompositionAttribute = (unsigned int)Length < Size ? 0xC0000023 : 0;
    v31 = CompositionAttribute;
  }
  ...
  if ( !v15 && (LODWORD(v34[0]) != 20 || !(unsigned int)IsTopLevelOrLayeredChildWindow(v14)) )
  {
  ...
  if ( LODWORD(v34[0]) == 1 )
  {
    ...
    if ( v19 || (*(_BYTE *)(v14 + 50) & 8) != 0 && (TopLevelWindow = GetTopLevelWindow(v14), v13 = 0LL, TopLevelWindow) )
    {
      v21 = *(_QWORD *)(v14 + 168);
      if ( !v21 )
        goto LABEL_62;
...
LABEL_32:
      ...
      {
        v37 = *v23;
        v38 = v23[1].m256i_i64[0];
      }
      else
      {
LABEL_62:
        v37.m256i_i64[0] = v37.m256i_i32[0] & 0xFFFFE000;
        v39 = 0uLL;
    ...
    if ( (_DWORD)v13 )
    {
      ...
      if ( !v24 && (v37.m256i_i8[0] & 1) == 0 )
      {
        if ( v37.m256i_i32[1] )
        {
          if ( v37.m256i_i32[1] == 2 )
            v18 = 1;
        }
        else
        {
  ...
  if ( LODWORD(v34[0]) == 20 )
  {
    if ( !(unsigned int)GetWindowCompositionInfo(v14, v43) || (v43[0] & 0x1000) == 0 )
    {
      LODWORD(Src[0]) = 0;
      goto LABEL_47;
    }
...
LABEL_47:
  if ( CompositionAttribute >= 0 )
  {
    v8 = (void *)ReferenceDwmApiPort(v11, v10, v12, v13, v31);
    v36 = v8;
  }
LABEL_49:
  UserSessionSwitchLeaveCrit(v11, v10);
  if ( CompositionAttribute < 0 || LODWORD(v34[0]) == 1 )
    goto LABEL_51;
  switch ( LODWORD(v34[0]) )
  {
    case 5:
      goto LABEL_74;
    case 0x12:
...
LABEL_74:
      ...
      goto LABEL_51;
    case 0xC:
      if ( (((-(__int64)(PsGetCurrentProcessWow64Process(v25) != 0) & 0xFFFFFFFFFFFFFFFDuLL) + 3) & (unsigned __int64)v34[1]) != 0 )
        ExRaiseDatatypeMisalignment();
      if ( (unsigned __int64)v34[1] + 4 > W32UserProbeAddress || (char *)v34[1] + 4 < v34[1] )
        *W32UserProbeAddress = 0;
      LODWORD(Src[0]) = *(_DWORD *)v34[1];
      goto LABEL_74;
  }
  if ( SLODWORD(v34[0]) <= 19 || SLODWORD(v34[0]) > 21 )
    CompositionAttribute = -1073741811;
LABEL_51:
