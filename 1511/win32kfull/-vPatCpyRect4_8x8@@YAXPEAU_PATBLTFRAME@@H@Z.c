/*
 * XREFs of ?vPatCpyRect4_8x8@@YAXPEAU_PATBLTFRAME@@H@Z @ 0x1C02BE4F0
 * Callers:
 *     ?vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z @ 0x1C02C9960 (-vBrushPath4_8x8Enum@@YAXPEAU_RECTL@@KPEAX@Z.c)
 * Callees:
...
void __fastcall vPatCpyRect4_8x8(struct _PATBLTFRAME *a1, int a2)
{
  ...
  do
  {
    v13 = dword_1C02ED390[v3->left & 7];
    v14 = ~v13;
    v15 = dword_1C02ED390[v3->right & 7];
    if ( !v15 )
      v15 = -1;
