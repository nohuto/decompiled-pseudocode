/*
 * XREFs of DoVertDropout @ 0x1C00A7098
 * Callers:
...
__int64 __fastcall DoVertDropout(__int16 *a1, __int64 a2, unsigned int a3, __int64 a4, char a5)
{
  ...
  v7 = dword_1C0323C28;
  v9 = a2;
  if ( (int)v5 < dword_1C0323C28 )
    return 0LL;
  v11 = dword_1C0323C24;
  if ( (int)v5 > dword_1C0323C24 )
    return 0LL;
  if ( (a5 & 1) != 0 )
  {
  ...
  v16 = dword_1C0323C14;
  if ( (int)v5 <= dword_1C0323C14 || !(unsigned int)GetBitAbs(a4, a3, v5 - 1) )
  {
    v17 = dword_1C0323C10;
    if ( (int)v5 >= dword_1C0323C10 || !(unsigned int)GetBitAbs(a4, a3, v5) )
    {
      if ( (a5 & 4) != 0 )
      {
        ...
        v21 = (*(__int64 (__fastcall **)(_QWORD, __int64, __int64))&State[2 * (*(_WORD *)(v9 + 2) & 3) + 60])(
                a3,
                qword_1C0323CF8 + 4LL * (*(_WORD *)(v9 + 2) >> 2),
                qword_1C0323D00 + 4LL * (*(_WORD *)(v9 + 2) >> 2));
        v7 = dword_1C0323C28;
        v11 = dword_1C0323C24;
        v16 = dword_1C0323C14;
        v17 = dword_1C0323C10;
