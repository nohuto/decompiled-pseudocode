/*
 * XREFs of ?bAddHash@PFFOBJ@@QEAAHH@Z @ 0x1C0021AE0
 * Callers:
...
__int64 __fastcall PFFOBJ::bAddHash(PFFOBJ *this, int a2)
{
  ...
  if ( v6 )
  {
    ...
    v9 = v7 + 1;
    v10 = (__int64 *)(v7 + 2);
    if ( v8 == gppdevTrueType || v8 == (struct PDEV *)qword_1C032F218 && !*(_DWORD *)(v6 + 8) )
      ++gcTrueTypeFonts;
  }
  else
  {
  ...
  v16[0] = v7;
  v15[0] = v10;
  if ( FHOBJ::bValid((FHOBJ *)v15) && FHOBJ::bValid((FHOBJ *)v16) && FHOBJ::bValid((FHOBJ *)v17) )
  {
    v12 = *(_QWORD *)this;
    v13 = 0;
    if ( *(_DWORD *)(*(_QWORD *)this + 144LL) )
    {
      while ( 1 )
      {
        ...
        v12 = *(_QWORD *)this;
        if ( ++v13 >= *(_DWORD *)(*(_QWORD *)this + 144LL) )
          return 1;
      }
    }
    else
