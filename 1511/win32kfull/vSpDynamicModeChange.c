/*
 * XREFs of vSpDynamicModeChange @ 0x1C00FA280
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z @ 0x1C00FA6F0 (-vSpCorrectHdevReferences@@YAXPEAU_SPRITESTATE@@PEAUHDEV__@@@Z.c)
