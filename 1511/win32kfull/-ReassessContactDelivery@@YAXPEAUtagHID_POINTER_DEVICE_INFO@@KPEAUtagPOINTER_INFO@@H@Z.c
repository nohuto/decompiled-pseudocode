/*
 * XREFs of ?ReassessContactDelivery@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@KPEAUtagPOINTER_INFO@@H@Z @ 0x1C01C7890
 * Callers:
...
void __fastcall ReassessContactDelivery(struct _LIST_ENTRY *a1, unsigned int a2, struct tagPOINTER_INFO *a3, int a4)
{
  ...
  if ( (unsigned int)(LODWORD(a1[1].Blink) - 1) > 4
    || IsDeviceAllowed(a1, HIDWORD(a1[43].Blink[150 * a2 + 146].Flink), (*((_DWORD *)a3 + 3) >> 14) & 1) )
  {
    if ( a4 )
    {
      v12 = *((_DWORD *)a3 + 3);
      ...
      *((_DWORD *)a3 + 3) = v14;
      ...
      p_Blink = &a1[43].Blink[150 * v5 + 149].Blink;
      *p_Blink &= ~0x200u;
      LODWORD(a1[43].Blink[150 * v5 + 149].Blink) |= 0x20u;
    }
    else
    {
      v8 = *((_DWORD *)a3 + 3);
      if ( (v8 & 4) != 0 )
      {
        ...
        *((_DWORD *)a3 + 3) |= 6u;
        LODWORD(a1[43].Blink[v9 + 149].Blink) &= ~0x20u;
      }
      else if ( (v8 & 2) != 0 )
      {
        if ( (v8 & 0x40000) != 0 )
