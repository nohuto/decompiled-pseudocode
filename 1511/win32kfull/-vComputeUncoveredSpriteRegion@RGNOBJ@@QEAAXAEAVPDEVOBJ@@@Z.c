/*
 * XREFs of ?vComputeUncoveredSpriteRegion@RGNOBJ@@QEAAXAEAVPDEVOBJ@@@Z @ 0x1C0036908
 * Callers:
 ...
 *     ?bEnum@ENUMUNCOVERED@@QEAAHPEAU_RECTL@@@Z @ 0x1C0107928 (-bEnum@ENUMUNCOVERED@@QEAAHPEAU_RECTL@@@Z.c)
 */
...
void __fastcall RGNOBJ::vComputeUncoveredSpriteRegion(RGNOBJ *this, struct PDEVOBJ *a2)
{
  ...
  RGNOBJ::vSet(this);
  if ( !*(_DWORD *)(v3 + 220) )
    vSpComputeSpriteRanges((struct _SPRITESTATE *)(v3 + 96));
  v5 = *(_QWORD *)(v3 + 240);
  v13 = *(_DWORD *)(v3 + 156);
  v14 = v5;
  v16 = v5 + 8;
