/*
 * XREFs of ?UMPDDrvStretchBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_RECTL@@54K@Z @ 0x1C02A02A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
    ...
    if ( !(unsigned int)UMPDOBJ::pso(v16, (UMPDOBJ *)((char *)v16 + 64), (struct _SURFOBJ **)&Src[3], v13)
      ...
      || !(unsigned int)UMPDOBJ::ThunkMemBlock(v16, (const void **)&Src[10], 0x10u)
      ...
      || (LODWORD(Size) = 4, (unsigned int)UMPDOBJ::Thunk(v16, Src, 0x80u, &v22, Size) == -1)
      || (v19 = 1, !v22) )
    {
      v19 = 0;
    }
