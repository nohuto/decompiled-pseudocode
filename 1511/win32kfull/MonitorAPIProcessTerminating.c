/*
 * XREFs of MonitorAPIProcessTerminating @ 0x1C00EE2C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?GetNextElementIndex@?$CList@VCPhysicalMonitorHandle@@@@QEAAEKPEAK@Z @ 0x1C025C348 (-GetNextElementIndex@-$CList@VCPhysicalMonitorHandle@@@@QEAAEKPEAK@Z.c)
 */
...
void __fastcall MonitorAPIProcessTerminating(void *a1)
{
  ...
  v1 = qword_1C0323B50;
  CAutoMutex::CAutoMutex((CAutoMutex *)&v8, (struct CMutex *)qword_1C0323B50);
  v3 = (_QWORD **)(v1 + 8);
  if ( *(_DWORD *)(v1 + 16) )
  {
    if ( !**v3 )
