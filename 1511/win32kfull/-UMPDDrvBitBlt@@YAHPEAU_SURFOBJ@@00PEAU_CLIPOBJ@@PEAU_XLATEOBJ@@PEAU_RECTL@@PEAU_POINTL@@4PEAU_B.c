/*
 * XREFs of ?UMPDDrvBitBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@4PEAU_BRUSHOBJ@@4K@Z @ 0x1C029C6B0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a11)
{
  ...
  struct _POINTL *v40; // [rsp+108h] [rbp-8h]
  struct _BRUSHOBJ *v41; // [rsp+110h] [rbp+0h]
  struct _POINTL *v42; // [rsp+118h] [rbp+8h]
  struct _POINTL *v43; // [rsp+120h] [rbp+10h]
  struct _RECTL *v44; // [rsp+128h] [rbp+18h]
