/*
 * XREFs of ?GetMultiContactDeviceState@@YAJPEAU_HIDP_PREPARSED_DATA@@GPEAUtagPOINTEREVENTINT@@PEAUDEVICEINFO@@KPEADPEAUtagHPD_CONTACT_GEOMETRY@@@Z @ 0x1C01C6CD8
 * Callers:
 ...
 *     ApplyPTPTranslation @ 0x1C01D0850 (ApplyPTPTranslation.c)
  ...
  if ( v13 )
  {
    ...
    do
    {
      ...
      if ( *(_DWORD *)(v17 + v16) == *(_DWORD *)a7 && *(_DWORD *)(v17 + v16 + 2336) )
      {
        ...
        v10 = 1;
        *(_WORD *)a3 = *(_WORD *)(*(_QWORD *)(v7 + 696) + v22 + 2332);
        goto LABEL_18;
      }
    ...
    v19 = *(_DWORD *)(v7 + 704) + 1;
    *(_DWORD *)(v7 + 704) = v19;
    if ( (v18 & 0x80u) != 0 && v19 > 1 )
      *(_DWORD *)(2400LL * v8 + v16 + 2392) |= 0x20u;
    v20 = 2400LL * v8;
    *(_DWORD *)(*(_QWORD *)(v7 + 696) + v20 + 2392) &= ~4u;
    *(_DWORD *)(v20 + *(_QWORD *)(v7 + 696)) = *(_DWORD *)v14;
    *(_DWORD *)(*(_QWORD *)(v7 + 696) + v20 + 2336) = 1;
    *(_DWORD *)(*(_QWORD *)(v7 + 696) + v20 + 2332) = GetNextFreeCursor(v7);
    *(_WORD *)a3 = *(_WORD *)(*(_QWORD *)(v7 + 696) + v20 + 2332);
    if ( *(_DWORD *)(v7 + 704) == 1 )
...
LABEL_18:
    if ( *(_DWORD *)(v7 + 24) == 8 )
    {
      ...
      v24 = 2400LL * v15;
      *(_QWORD *)(*(_QWORD *)(v7 + 696) + v24 + 2260) = *((_QWORD *)a3 + 6);
      *(_QWORD *)(*(_QWORD *)(v7 + 696) + v24 + 2276) = *((_QWORD *)a3 + 8);
      *(_QWORD *)(*(_QWORD *)(v7 + 696) + v24 + 2284) = *(_QWORD *)((char *)v14 + 12);
    }
    else
    {
...
LABEL_25:
  ...
  {
    v25 = (__int64 **)(*(_QWORD *)(*(_QWORD *)(v7 + 712) + 48LL)
                     + 8LL * (unsigned int)(*(_DWORD *)v14 % *(_DWORD *)(v7 + 720)));
