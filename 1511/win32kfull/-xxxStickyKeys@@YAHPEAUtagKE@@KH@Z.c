/*
 * XREFs of ?xxxStickyKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C01EF020
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall xxxStickyKeys(struct tagKE *a1, unsigned int a2, int a3)
{
  ...
  if ( v14 == 10 || v15 == 10 )
  {
    if ( (dword_1C03222C4 & 4) != 0 )
    {
      if ( (dword_1C03222C4 & 1) != 0 )
      {
        xxxTurnOffStickyKeys();
        if ( (dword_1C03222C4 & 0x10) != 0 )
          PostEventMessageEx(
            *(_QWORD *)(v10 + 16),
  ...
  if ( (dword_1C03222C4 & 0x40) != 0 )
  {
    PostEventMessageEx(*(_QWORD *)(v10 + 16), *(_QWORD *)(*(_QWORD *)(v10 + 16) + 384LL), 0xEu, 0LL, 2u, 0LL, 0LL, 0LL);
    PostEventMessageEx(*(_QWORD *)(v10 + 16), *(_QWORD *)(*(_QWORD *)(v10 + 16) + 384LL), 0xEu, 0LL, 3u, 0LL, 0LL, 0LL);
  }
  return 0LL;
}
