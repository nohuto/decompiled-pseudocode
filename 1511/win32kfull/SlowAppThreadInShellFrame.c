/*
 * XREFs of SlowAppThreadInShellFrame @ 0x1C0009E1C
 * Callers:
 ...
 *     ?OtherThreadsKeyboardInput@@YAPEAUtagTHREADINFO@@PEAUtagQ@@PEAUtagQMSG@@@Z @ 0x1C01E2138 (-OtherThreadsKeyboardInput@@YAPEAUtagTHREADINFO@@PEAUtagQ@@PEAUtagQMSG@@@Z.c)
 */
        ...
        int a4)
{
    ...
    if ( v12 != a1 && v12 == a2 )
    {
      ...
      if ( v18 )
      {
        if ( a3 == v18 )
        {
          ...
          if ( (int)v9 - *(_DWORD *)(*(_QWORD *)(v4[3] + 400) + 12LL) >= v11 )
            return v12;
        }
      }
    }
  ...
  if ( !v8 )
    goto LABEL_6;
  v12 = *(struct tagTHREADINFO **)(v8 + 96);
  if ( !v12 )
    goto LABEL_6;
  if ( (unsigned int)IsDebuggerAttached(*((_QWORD *)v12 + 47)) )
    return 0LL;
...
LABEL_8:
  ...
  v23 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a1 + 48) + 80LL) + 96LL);
  if ( v23 )
