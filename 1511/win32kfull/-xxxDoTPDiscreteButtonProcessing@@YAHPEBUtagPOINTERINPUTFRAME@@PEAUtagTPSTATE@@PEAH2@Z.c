/*
 * XREFs of ?xxxDoTPDiscreteButtonProcessing@@YAHPEBUtagPOINTERINPUTFRAME@@PEAUtagTPSTATE@@PEAH2@Z @ 0x1C01F4054
 * Callers:
...
LABEL_8:
  v4 = 1;
  a2[193].LowPart ^= (a2[193].LowPart ^ (4 * v12)) & 4;
  if ( v12 )
...
LABEL_18:
  v19 = 1;
  a2[193].LowPart ^= (a2[193].LowPart ^ (8 * v13)) & 8;
  if ( v13 )
    TPAAPSetCurtainState((struct tagTPSTATE *)a2, 0);
  *a4 = 1;
LABEL_26:
  ...
  if ( v12 )
  {
    ...
    if ( !__CFSHR__(v31, 16) )
    {
      if ( (v31 & 0x10) == 0 )
        goto LABEL_68;
      if ( !__CFSHR__(a2[193].LowPart, 16) )
        goto LABEL_53;
    }
    if ( (v31 & 0x20) != 0 )
      goto LABEL_53;
LABEL_68:
    if ( IsFirstActionAfterKey() )
    {
      ...
      dword_1C0321C20 = ((_DWORD)v34 != 0) + 5;
    }
    else
    {
      v34 = (unsigned int)-v33;
      dword_1C0321C24 = ((_DWORD)v34 != 0) + 5;
    }
    ++dword_1C0321C5C;
    ++dword_1C0321C78;
...
LABEL_92:
  ...
  if ( IsFirstActionAfterKey() )
  {
    ...
    dword_1C0321C20 = 6 - ((_DWORD)v42 != 0);
  }
  else
  {
    v42 = (unsigned int)-v41;
    dword_1C0321C24 = 6 - ((_DWORD)v42 != 0);
  }
  ++dword_1C0321C5C;
  ++dword_1C0321C78;
