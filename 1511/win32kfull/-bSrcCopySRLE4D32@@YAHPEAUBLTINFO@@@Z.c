/*
 * XREFs of ?bSrcCopySRLE4D32@@YAHPEAUBLTINFO@@@Z @ 0x1C00EC710
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall bSrcCopySRLE4D32(struct BLTINFO *a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( v6 < v13 && v12 < v10 && (int)(v15 + v12) > v7 )
    {
      ...
      v20 = v15 & 1;
      v21 = v15 >> 1;
      v22 = *(_DWORD *)(v49 + 4LL * ((unsigned __int8)v17 >> 4));
...
LABEL_19:
  ...
  if ( v17 != 2 )
  {
    ...
    {
      v12 += v17;
      v35 = (unsigned __int64)&v2[(unsigned __int64)(v17 + 1) >> 1];
    }
    else
    {
      if ( v12 < v7 )
      {
        ...
        if ( (v37 & 1) != 0 )
        {
          ...
          v38 = *v2++ & 0xF;
          --v17;
          *(_DWORD *)(v3 + 4LL * (unsigned int)v7) = *(_DWORD *)(v49 + 4 * v38);
        }
      }
      if ( (int)(v17 + v12) > v10 )
      {
