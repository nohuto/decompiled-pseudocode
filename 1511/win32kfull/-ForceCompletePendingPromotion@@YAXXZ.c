/*
 * XREFs of ?ForceCompletePendingPromotion@@YAXXZ @ 0x1C023A194
 * Callers:
...
void ForceCompletePendingPromotion(void)
{
  ...
  v0 = word_1C03235F0;
  v2 = ((dword_1C0323600 != 0) + 1) | 0x1010000;
  if ( !ValidatePointerPromotion(word_1C03235F0, dword_1C03235F4, &v2, &v4, &v3) )
    goto LABEL_5;
  v1 = v3;
  if ( v3 )
  {
