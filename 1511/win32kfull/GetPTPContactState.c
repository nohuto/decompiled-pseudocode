/*
 * XREFs of GetPTPContactState @ 0x1C01D0F54
 * Callers:
 ...
 *     UseLastContactPosition @ 0x1C01CE970 (UseLastContactPosition.c)
 ...
 *     CheckPTPConfidenceBit @ 0x1C01D093C (CheckPTPConfidenceBit.c)
 */
        ...
        unsigned int *a8)
{
  ...
  UsageLength = *(_DWORD *)(v10 + 312);
  v14 = *(_QWORD *)(v10 + 696);
  v15 = 2400LL * a5;
  UsageList = *(PUSAGE *)(v10 + 1416);
  v13 = UsageList;
  *(_DWORD *)(v14 + v15 + 2248) = v12;
  ...
  if ( UsageLength )
  {
    ...
    do
    {
      ...
      {
        v11 |= 2u;
        *(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392) |= 2u;
        v22 = *(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392);
        ...
        else
        {
          ...
          *(_DWORD *)(a3 + 20) |= 0x10006u;
          if ( (*(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392) & 1) != 0 )
            dword_1C032BAEC = 1;
          else
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(v10 + 712) + 4LL) & 4) != 0 )
    *(_DWORD *)(a3 + 20) |= 0x10u;
  if ( (*(_DWORD *)(*(_QWORD *)(v10 + 712) + 4LL) & 8) != 0 )
    *(_DWORD *)(a3 + 20) |= 0x20u;
  if ( (*(_DWORD *)(*(_QWORD *)(v10 + 712) + 4LL) & 0x10) != 0 )
    *(_DWORD *)(a3 + 20) |= 0x40u;
  if ( !v33 )
  {
    if ( (*(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392) & 4) != 0 )
    {
      *(_DWORD *)(a3 + 20) |= 0x40000u;
      if ( (unsigned int)IsFrameReportingPointerDevice(v10)
        && (*(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392) & 1) != 0 )
      {
        *(_DWORD *)(*(_QWORD *)(v10 + 712) + 56LL) = 1;
      }
      *(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392) &= ~2u;
      v26 = *(unsigned int *)(*(_QWORD *)(v10 + 696) + v15 + 2392);
      if ( (v26 & 0x20) == 0 )
    ...
    v27 = *(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392);
    if ( (v27 & 4) == 0 && (v27 & 1) != 0 && !dword_1C0323FA4 )
      dword_1C032BAEC = 0;
    *(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392) &= ~4u;
  }
  if ( (*(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392) & 1) != 0 )
    *(_DWORD *)(a3 + 20) |= 0x2000u;
  if ( (*(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392) & 0x20) != 0 )
  {
    v17 = -1073741668;
  }
  else
  {
    ...
    if ( !*(_DWORD *)(a3 + 20) )
      v28 = -1073741668;
    v17 = v28;
    v29 = *(_DWORD *)(*(_QWORD *)(v10 + 696) + v15 + 2392);
