/*
 * XREFs of ?FixupPrimaryGestureContact@@YAXPEAUtagPOINTERINFONODE@@IPEAUtagTPSTATE@@PEAUtagHID_POINTER_DEVICE_INFO@@H@Z @ 0x1C01F1480
 * Callers:
        ...
        int a5)
{
  ...
  if ( v8 )
  {
    if ( (*(_DWORD *)((_BYTE *)a3 + v10 + 212) & 0x400) != 0 )
    {
      if ( (v8 & 0x40000) != 0 )
    ...
    if ( a5 )
    {
      ...
      *((_QWORD *)a3 + 168) = v5;
      *((_QWORD *)a3 + 167) = *((_QWORD *)a1 + 11);
    }
    else
    {
      v13.x = v5 - *((_DWORD *)a3 + 336);
      v13.y = HIDWORD(v5) - *((_DWORD *)a3 + 337);
      TransformHimetricDeltaToScreenDelta(a4, v13, &v14);
      v12 = (struct tagPOINT *)((char *)a1 + 88);
      *((_DWORD *)a1 + 22) = v14.x + *((_DWORD *)a3 + 334);
      *((_DWORD *)a1 + 23) = v14.y + *((_DWORD *)a3 + 335);
    }
    ...
    *((_QWORD *)a1 + 14) = *((_QWORD *)a1 + 12);
    if ( a5 || (*(_DWORD *)((_BYTE *)a3 + v10 + 212) & 2) != 0 )
      v6 = 1;
