/*
 * XREFs of ?Remove@CPointerHashTable@NSInstrumentation@@QEAA_NPEBXPEAPEAX@Z @ 0x1C02D53A0
 * Callers:
 ...
 *     ?_RemoveAllocationFromLookup@UmfdAllocation@@CAXPEAX00@Z @ 0x1C02D6F50 (-_RemoveAllocationFromLookup@UmfdAllocation@@CAXPEAX00@Z.c)
 * Callees:
