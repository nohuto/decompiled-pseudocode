/*
 * XREFs of ?SetNCMetrics@@YAXPEAUtagNONCLIENTMETRICSW@@@Z @ 0x1C00D7FA0
 * Callers:
...
void __fastcall SetNCMetrics(struct tagNONCLIENTMETRICSW *a1)
{
  ...
  *(_DWORD *)(gpsi + 2012LL) = *(_DWORD *)(gpsi + 2064LL)
  ...
  v6 = HIDWORD(gdpi96[9]) + *(_DWORD *)(gpsi + 2064LL);
  ...
  *(_DWORD *)(gpsi + 2388LL) = v7;
  v8 = HIDWORD(gdpi96[10]) + *(_DWORD *)(gpsi + 2064LL);
  ...
  *(_DWORD *)(gpsi + 2476LL) = v9;
  v10 = HIDWORD(gdpi96[6]) + HIDWORD(gdpi96[7]) + *(_DWORD *)(gpsi + 2064LL);
  ...
  *(_DWORD *)(gpsi + 2016LL) = *(_DWORD *)(gpsi + 2004LL)
                             ...
                             + 2 * (v13 + *(_DWORD *)(gpsi + 2060LL) + 2 * LODWORD(gdpiSystem[9]));
