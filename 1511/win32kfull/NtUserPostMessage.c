/*
 * XREFs of NtUserPostMessage @ 0x1C005F7D0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct tagTOUCHINPUT *a4)
{
  ...
  {
    v8 = (PVOID)(((unsigned __int16)MessageTable[v4] >> 13) & 1);
  ...
  if ( (_DWORD)v4 != 576 )
  {
    ...
    else if ( (_DWORD)v4 != 274 || ((a3 - 61472) & 0xFFFFFFFFFFFFFEBFuLL) != 0 || a3 == 61792 )
    {
      ...
      if ( (unsigned int)v21 <= v19 )
      {
        ...
        {
          if ( (_DWORD)v4 != 793
            || (v25 = *(_QWORD *)(v11 + 16), *(_QWORD *)(v25 + 1224) != v11)
...
LABEL_21:
  UserSessionSwitchLeaveCrit(v8, v10);
  return v9;
}
