/*
 * XREFs of ?SetPointerInfoNodeTarget@PointerFrameList@@YAXPEBUtagPOINTERINPUTFRAME@@KPEAUtagWND@@HPEBUtagPOINT@@HHHH@Z @ 0x1C02305B4
 * Callers:
 ...
 *     ?UpdateHistoryWithTarget@@YAXPEBUtagPOINTERINPUTFRAME@@PEBUtagPOINTERINFONODE@@PEAUtagWND@@HPEBUtagPOINT@@HHH@Z @ 0x1C0230D64 (-UpdateHistoryWithTarget@@YAXPEBUtagPOINTERINPUTFRAME@@PEBUtagPOINTERINFONODE@@PEAUtagWND@@HPEBU.c)
 */
        ...
        int a9)
{
  ...
  v10 = *((_QWORD *)this + 9) + 216LL * (unsigned int)a2;
  v11 = (*(_DWORD *)(gptiCurrent + 1072LL) >> 13) & 1;
  ...
  {
    if ( !v11 )
      *(_DWORD *)(*((_QWORD *)this + 10) + 40LL * *(unsigned int *)(v10 + 8) + 20) &= ~1u;
  }
}
