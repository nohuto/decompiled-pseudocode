/*
 * XREFs of ?xxxEndPointerMessageDelivery@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@KK_KKH@Z @ 0x1C01C89D4
 * Callers:
        ...
        int a6)
{
  ...
  *(_QWORD *)&v34[16] = *(_QWORD *)(v6 + v11 + 2276);
  if ( (unsigned int)(v15 - 1) > 4 )
  {
    if ( v15 == 8 )
    {
      v16 = (unsigned int)(*((_DWORD *)a1 + 180) - 1);
      v34[2] = 5;
  ...
  *(_QWORD *)&v34[22] = v19;
  ...
  xxxProcessPointerEvent(
    ...
    (unsigned int)v10,
    -__CFSHR__(*((_DWORD *)a1 + 63), 6),
    -__CFSHR__(*((_DWORD *)a1 + 63), 7),
    v27,
    v19);
  if ( v10 )
  {
