/*
 * XREFs of ?xxxTM_MoveDragRect@@YAXPEAU_MOVESIZEDATA@@_J@Z @ 0x1C020AD20
 * Callers:
 ...
 *     ?SwapRect@@YAXPEAUtagRECT@@0@Z @ 0x1C0153050 (-SwapRect@@YAXPEAUtagRECT@@0@Z.c)
...
void __fastcall xxxTM_MoveDragRect(struct _MOVESIZEDATA *a1, unsigned int a2)
{
  ...
  *(_OWORD *)((char *)a1 + 56) = v9;
  ...
  if ( (*((_DWORD *)a1 + 45) & 0x800) != 0 )
  {
    ...
    {
      SwapRect(v23, &v25);
      xxxMinMaximizeEx(*(struct tagWND **)a1, 9u, 4u, 0LL, 0LL);
      SwapRect(&v25, v23);
      v11 = 532;
      goto LABEL_10;
    }
...
LABEL_10:
  if ( (v10 & 2) != 0 && (v12 = *(struct tagWND **)a1, (*(_BYTE *)(*(_QWORD *)a1 + 54LL) & 1) != 0) )
  {
    ...
    xxxSendTransformableMessageTimeout(v12, v11, v13, (__int64)&v26, 0, 0, 0LL, 1, 0);
    xxxMinMaximizeEx(*(struct tagWND **)a1, 3u, 0x16u, *((_QWORD *)a1 + 26), 0LL);
    v14 = *(_QWORD *)a1;
  ...
  else
  {
      ...
      if ( (v17 & 0x2000000) != 0 )
      {
        if ( (v17 & 0x20) != 0 )
        {
          ...
          *((_DWORD *)a1 + 45) = v17 & 0xFFFFFFDF;
          _InterlockedIncrement(&glSendMessage);
          xxxSendTransformableMessageTimeout(v19, v11, v18, (__int64)&v26, 0, 0, 0LL, 1, 0);
    ...
    v26 = *(_OWORD *)v6;
    _InterlockedIncrement(&glSendMessage);
    xxxSendTransformableMessageTimeout(v21, v11, v20, (__int64)&v26, 0, 0, 0LL, 1, 0);
