/*
 * XREFs of NtGdiEngLockSurface @ 0x1C02AC0E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?LockSurface@UMPDOBJ@@QEAAPEAU_SURFOBJ@@PEAUHSURF__@@@Z @ 0x1C028670C (-LockSurface@UMPDOBJ@@QEAAPEAU_SURFOBJ@@PEAUHSURF__@@@Z.c)
 */
