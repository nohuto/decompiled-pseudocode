/*
 * XREFs of ?FreeMsgData@PointerList@@YAX_K@Z @ 0x1C01FC6C8
 * Callers:
 ...
 * Callees:
 *     ?FreeMsgDataInt@@YAXPEAUtagPOINTERMSGDATA@@@Z @ 0x1C01FC768 (-FreeMsgDataInt@@YAXPEAUtagPOINTERMSGDATA@@@Z.c)
 *     ?FreeNode@@YAXPEAUtagINPUTPOINTERNODE@@@Z @ 0x1C01FC808 (-FreeNode@@YAXPEAUtagINPUTPOINTERNODE@@@Z.c)
