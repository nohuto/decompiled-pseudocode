/*
 * XREFs of UnloadCursorsAndIcons @ 0x1C010C820
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall UnloadCursorsAndIcons(__int64 a1)
{
  ...
  v1 = (__int64 *)&unk_1C031B8B8;
  v2 = 7LL;
  v3 = (char *)&unk_1C031B8B8;
  do
  {
    if ( *v1 )
    {
  ...
  do
  {
    ...
    v8 = *(_QWORD *)(v5 + *(_QWORD *)gasyscur + 8);
    if ( v8 )
    {
      v9 = *(_QWORD *)(v8 + 40);
      while ( v9 )
      ...
      *(_QWORD *)(v8 + 24) = PsGetCurrentProcessWin32Process(a1);
      result = HMAssignmentUnlock((char *)&gasyscur[4] + v2);
    }
    v2 += 16LL;
    v5 += 16LL;
    --v6;
