/*
 * XREFs of fs__NewTransformation @ 0x1C00A26A4
 * Callers:
 ...
 *     sbit_NewTransform @ 0x1C00A332C (sbit_NewTransform.c)
 *     fsg_QueryPPEMXY @ 0x1C00A339C (fsg_QueryPPEMXY.c)
 *     fsg_UpdatePrivateSpaceAddresses @ 0x1C00A341C (fsg_UpdatePrivateSpaceAddresses.c)
 *     fsg_CopyFontProgramResults @ 0x1C00A36EC (fsg_CopyFontProgramResults.c)
