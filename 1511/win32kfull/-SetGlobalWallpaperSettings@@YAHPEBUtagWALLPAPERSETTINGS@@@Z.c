/*
 * XREFs of ?SetGlobalWallpaperSettings@@YAHPEBUtagWALLPAPERSETTINGS@@@Z @ 0x1C010D2D4
 * Callers:
 *     xxxSetDeskWallpaper @ 0x1C010D0A0 (xxxSetDeskWallpaper.c)
 * Callees:
 *     ReleaseWallpaperSettings @ 0x1C0114B10 (ReleaseWallpaperSettings.c)
 */
...
__int64 __fastcall SetGlobalWallpaperSettings(const struct tagWALLPAPERSETTINGS *a1)
{
  ...
  v3 = (_OWORD *)Win32AllocPool(516LL);
