/*
 * XREFs of ?xxxMNGetBitmapSize@@YAHPEAUtagMENU@@PEAUtagITEM@@PEAUtagWND@@HPEAUHDC__@@@Z @ 0x1C00C6670
 * Callers:
 ...
 *     MNUpdateUAHMaxPopupWidths @ 0x1C00C68F0 (MNUpdateUAHMaxPopupWidths.c)
        ...
        HDC a5)
{
  ...
  {
    xxxSendMessage(a3, 0x2Cu, 0LL, (__int64)v17);
  ...
  xxxSendMessage(a3, 0x94u, 0LL, (__int64)v17);
  if ( (unsigned int)MNGetpItemIndex((__int64)a1, (__int64)a2) == -1 )
    return 0LL;
