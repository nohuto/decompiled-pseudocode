/*
 * XREFs of ValidateDeviceSignature @ 0x1C0108DF0
 * Callers:
 *     CreatePointerDeviceInfo @ 0x1C01C9610 (CreatePointerDeviceInfo.c)
 * Callees:
 *     ?_SqmTHQA@@YAXGGK@Z @ 0x1C0109034 (-_SqmTHQA@@YAXGGK@Z.c)
 *     ?CheckForSegmentedSignatureBlob@@YAJPEAXGPEAU_HIDP_VALUE_CAPS@@PEAG@Z @ 0x1C01C6058 (-CheckForSegmentedSignatureBlob@@YAJPEAXGPEAU_HIDP_VALUE_CAPS@@PEAG@Z.c)
 *     ?RetrieveAndVerifySignature@@YAHPEAU_DEVICE_OBJECT@@PEAU_FILE_OBJECT@@GPEAU_HIDP_VALUE_CAPS@@PEAU_HIDP_CAPS@@PEAU_HIDP_PREPARSED_DATA@@U_HID_COLLECTION_INFORMATION@@GPEAK@Z @ 0x1C01C7D84 (-RetrieveAndVerifySignature@@YAHPEAU_DEVICE_OBJECT@@PEAU_FILE_OBJECT@@GPEAU_HIDP_VALUE_CAPS@@PEA.c)
 *     UserLogDeviceCategorySpecificError @ 0x1C01CEE28 (UserLogDeviceCategorySpecificError.c)
 */
        ...
        int a7)
{
  ...
  if ( !NumberFeatureValueCaps
    || (ValueCaps = (struct _HIDP_VALUE_CAPS *)Win32AllocPool(72LL * NumberFeatureValueCaps)) == 0LL )
  {
...
LABEL_25:
  if ( v11 == 1 || v11 == 2 && *(_DWORD *)(v14 + 24) == 8 || v9 )
  ...
  if ( SpecificValueCaps < 0 )
  {
    if ( *(_DWORD *)(v14 + 24) != 8 )
      return 0LL;
    UserLogDeviceCategorySpecificError(4LL, a4->Usage);
  }
