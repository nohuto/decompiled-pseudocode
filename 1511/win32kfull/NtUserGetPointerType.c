/*
 * XREFs of NtUserGetPointerType @ 0x1C021B670
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserGetPointerType(int a1, _DWORD *a2)
{
  ...
  struct _LIST_ENTRY *v10; // [rsp+80h] [rbp+18h]

  v4 = 1;
  v5 = (struct _LIST_ENTRY *)EnterSharedCrit(0LL, 1LL);
  v10 = v5;
  if ( !a1 || HIWORD(a1) || !a2 )
  {
    v4 = 0;
  ...
  {
    if ( !GetThreadPointerData(v5 + 60, a1, &v9, 0LL, 0LL) )
    {
      UserSetLastError(87);
      v4 = 0;
      goto LABEL_13;
