/*
 * XREFs of DwmAsyncNotifyDigitizerActiveContacts @ 0x1C025EEDC
 * Callers:
 ...
 *     DwmAsyncNotifyDigitizerActiveContactsWrap @ 0x1C01CB340 (DwmAsyncNotifyDigitizerActiveContactsWrap.c)
