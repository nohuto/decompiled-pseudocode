/*
 * XREFs of ?RevalidateFrameProcessing@@YAHPEAUtagTHREADINFO@@HPEBUtagPOINTERINFONODE@@H@Z @ 0x1C01F9A4C
 * Callers:
...
__int64 __fastcall RevalidateFrameProcessing(struct tagTHREADINFO *a1, int a2, const struct tagPOINTERINFONODE *a3)
{
  ...
  if ( a2 && (*((_DWORD *)a1 + 268) & 0x2000) == 0 || !(unsigned int)IsPointerInfoNodeValid(a3) )
    return 0LL;
