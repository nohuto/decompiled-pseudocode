/*
 * XREFs of xxxCallJournalRecordHook @ 0x1C01E74B0
 * Callers:
...
__int16 __fastcall xxxCallJournalRecordHook(__int64 a1)
{
  ...
  if ( (unsigned int)(v9 - 512) > 0xE )
  {
    if ( (unsigned int)(v9 - 256) <= 9 )
    {
      ...
      if ( *(_WORD *)(a1 + 32) != 231 || (_BYTE)v4 )
        LODWORD(v10) = *(unsigned __int8 *)(a1 + 32) | (unsigned __int16)((unsigned __int8)v4 << 8);
      else
        LODWORD(v10) = (*(unsigned __int16 *)(gptiCurrent + 754LL) << 16) | 0xE7;
      v5 = *(_DWORD *)(a1 + 40);
  ...
  GlobalValid = PhkFirstGlobalValid(gptiCurrent, 0, v4, gptiCurrent);
  xxxCallHook2(GlobalValid, 0, 0LL, &v9, (__int64)&v12);
  v7 = *(_DWORD *)(a1 + 24);
