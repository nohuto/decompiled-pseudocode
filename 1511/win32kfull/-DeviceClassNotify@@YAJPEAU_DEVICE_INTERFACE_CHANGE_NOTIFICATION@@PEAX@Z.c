/*
 * XREFs of ?DeviceClassNotify@@YAJPEAU_DEVICE_INTERFACE_CHANGE_NOTIFICATION@@PEAX@Z @ 0x1C01DE200
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DeviceClassNotify(char *NotificationStructure, PVOID Context)
{
    ...
    && *(_QWORD *)(NotificationStructure + 12) == *(_QWORD *)GUID_DEVICE_INTERFACE_ARRIVAL.Data4 )
  {
    ...
    {
      if ( RtlEqualUnicodeString(*((PCUNICODE_STRING *)NotificationStructure + 5), (PCUNICODE_STRING)(i + 200), 0) )
      {
        if ( *(char *)(i + 66) >= 0 )
        {
          if ( (*(_BYTE *)(i + 332) & 1) != 0 )
