/*
 * XREFs of SfnIMECONTROL @ 0x1C020EA00
 * Callers:
 *     <none>
 * Callees:
...
LABEL_69:
        if ( (int)AllocateCallbackData((struct _CAPTUREBUF *)v18, v16, (void **)v18 + 11) >= 0 )
        {
          ...
          *(_QWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 64LL) = v41;
          v42 = v10 ? *(_QWORD *)(v10 + 264) : 0LL;
          *(_QWORD *)(*(_QWORD *)(gptiCurrent + 432LL) + 80LL) = v42;
...
LABEL_55:
  ...
  *(_QWORD *)(v30 + 72) = v58;
  if ( v10 )
    ...
    v31 = 0LL;
  *(_QWORD *)(*((_QWORD *)v11 + 54) + 64LL) = v31;
  if ( v10 )
    v32 = *(_QWORD *)(v10 + 264);
  else
    v32 = 0LL;
  *(_QWORD *)(*((_QWORD *)v11 + 54) + 80LL) = v32;
