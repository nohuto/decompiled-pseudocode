/*
 * XREFs of ?Win32kLeakTrackingLiveDumpCallback@@YAJPEAXP6AJ0PEBU_GUID@@0K@ZK_K3330@Z @ 0x1C01F6F30
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a8)
{
  ...
  if ( !a8 )
    return 0LL;
  result = ((__int64 (__fastcall *)(void *, void *, _QWORD, _QWORD))a2)(a1, &unk_1C02EAB00, *(_QWORD *)a8, a8[2]);
  v12 = result;
  if ( (int)result >= 0 )
  {
    ...
    {
      v13 = 0;
      v15[0] = xmmword_1C02EAAF0;
      v15[1] = xmmword_1C02EAAE0;
      v15[2] = xmmword_1C02EAAD0;
      do
      {
        if ( v12 < 0 )
          break;
