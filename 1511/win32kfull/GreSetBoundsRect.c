/*
 * XREFs of GreSetBoundsRect @ 0x1C00FDB28
 * Callers:
...
__int64 __fastcall GreSetBoundsRect(HDC a1, struct _POINTL *a2, __int16 a3)
{
  ...
  if ( a3 < 0 )
  {
    v7 = (struct tagRECT *)(v38[0] + 1456LL);
    v8 = 32;
  }
  else if ( (a3 & 0x4000) != 0 )
  {
    v7 = (struct tagRECT *)(v38[0] + 1472LL);
    v8 = 64;
  }
  else
  {
    v7 = (struct tagRECT *)(v38[0] + 1488LL);
    v8 = 128;
  }
  v9 = a3 & 0xC000;
  ...
  if ( (a3 & 2) != 0 )
  {
    if ( !v12 )
    {
      ...
      if ( (*(_DWORD *)(v39[0] + 32LL) & 1) == 0 )
      {
        ...
        v44 = a2->y;
        *(_OWORD *)&v40[0].x = v15;
        if ( (unsigned int)EXFORMOBJ::bXform((EXFORMOBJ *)v39, v40) )
        {
          v16 = v40[1].x;
          v17 = v40[1].x;
          v18 = v40[0].x;
