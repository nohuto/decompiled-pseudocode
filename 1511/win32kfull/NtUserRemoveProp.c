/*
 * XREFs of NtUserRemoveProp @ 0x1C0054010
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( v4 )
  {
    ...
    if ( *(_QWORD *)(v9 + 16) == v4
      ...
      || (CurrentProcessWin32Process = PsGetCurrentProcessWin32Process(v9),
          v13 = *(unsigned int *)(*(_QWORD *)(*(_QWORD *)(v8 + 16) + 376LL) + 740LL),
          *(_DWORD *)(CurrentProcessWin32Process + 740) == (_DWORD)v13)
      && *(_DWORD *)(PsGetCurrentProcessWin32Process(v13) + 744) == *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v8 + 16) + 376LL)
                                                                              + 744LL) )
    {
