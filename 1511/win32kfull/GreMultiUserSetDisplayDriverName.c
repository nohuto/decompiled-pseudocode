/*
 * XREFs of GreMultiUserSetDisplayDriverName @ 0x1C014E610
 * Callers:
 *     xxxRemoteReconnect @ 0x1C014DAC0 (xxxRemoteReconnect.c)
 * Callees:
 *     ?StringCchCopyNW@@YAJPEAG_KPEBG1@Z @ 0x1C014E698 (-StringCchCopyNW@@YAJPEAG_KPEBG1@Z.c)
 */
...
__int64 __fastcall GreMultiUserSetDisplayDriverName(__int64 a1, int a2, const unsigned __int16 *a3)
{
  ...
  if ( v5 )
    Win32FreePool(v5);
  v8 = a2 + 1;
  v9 = (unsigned __int16 *)Win32AllocPool(2LL * v8);
  *(_QWORD *)(a1 + 40) = v9;
  if ( v9 )
  {
