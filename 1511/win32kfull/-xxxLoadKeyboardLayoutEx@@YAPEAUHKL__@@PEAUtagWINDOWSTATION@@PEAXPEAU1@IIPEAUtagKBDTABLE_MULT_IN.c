/*
 * XREFs of ?xxxLoadKeyboardLayoutEx@@YAPEAUHKL__@@PEAUtagWINDOWSTATION@@PEAXPEAU1@IIPEAUtagKBDTABLE_MULT_INTERNAL@@PEBGII@Z @ 0x1C0097694
 * Callers:
 ...
 *     ?LoadKeyboardLayoutFile@@YAPEAUtagKBDFILE@@PEAXIIPEBGPEAGKK@Z @ 0x1C00FFDB8 (-LoadKeyboardLayoutFile@@YAPEAUtagKBDFILE@@PEAXIIPEBGPEAGKK@Z.c)
 *     xxxImmLoadLayout @ 0x1C010DCE0 (xxxImmLoadLayout.c)
 *     DestroyKF @ 0x1C0112EB0 (DestroyKF.c)
 *     ?ReorderKeyboardLayouts@@YAXPEAUtagWINDOWSTATION@@PEAUtagKL@@@Z @ 0x1C01DDA14 (-ReorderKeyboardLayouts@@YAXPEAUtagWINDOWSTATION@@PEAUtagKL@@@Z.c)
 */
...
LABEL_13:
    ...
    if ( (v21 & 0x20000000) != 0 )
    {
      v22 = *((_QWORD *)&gSharedInfo + 1)
          + *((_DWORD *)&gSharedInfo + 4) * (unsigned int)(unsigned __int16)*(_DWORD *)v19;
      *(_BYTE *)(v22 + 17) &= ~1u;
...
LABEL_54:
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v46;
    ...
    if ( (v15 & 0x80u) == 0 )
    {
      v37 = (unsigned int)(*(_DWORD *)(gptiCurrent + 600LL) | *(_DWORD *)(*(_QWORD *)(gptiCurrent + 416LL) + 24LL));
