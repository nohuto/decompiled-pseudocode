/*
 * XREFs of ?vIntersectVertical@@YAXPEAVDDA_CLIPLINE@@JPEAU_POINTL@@1PEAJ@Z @ 0x1C02C8908
 * Callers:
 ...
 *     ?yCompute@DDA_CLIPLINE@@QEAAJJ@Z @ 0x1C02C8CCC (-yCompute@DDA_CLIPLINE@@QEAAJJ@Z.c)
 */
