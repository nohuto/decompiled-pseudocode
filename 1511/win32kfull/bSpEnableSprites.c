/*
 * XREFs of bSpEnableSprites @ 0x1C00F9DE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall bSpEnableSprites(__int64 a1)
{
  ...
  struct REGION *v18; // [rsp+30h] [rbp-30h] BYREF
  ...
  *(_QWORD *)(a1 + 232) = GreCreateSemaphore();
  ...
  if ( !v10 )
    goto LABEL_26;
  Surface = psoSpCreateSurface((struct _SPRITESTATE *)(a1 + 96), 0, 1, 1, v17);
  if ( !Surface )
  {
    Win32FreePool(v10);
LABEL_26:
  ...
  *(_QWORD *)(a1 + 240) = v10;
  RGNOBJ::vSet((RGNOBJ *)&v18, (struct _RECTL *)(a1 + 144));
  v12 = v18;
  *(_QWORD *)(a1 + 968) = v18;
