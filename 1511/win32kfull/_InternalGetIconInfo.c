/*
 * XREFs of _InternalGetIconInfo @ 0x1C0049C9C
 * Callers:
        ...
        int a6)
{
  ...
  if ( *(_QWORD *)(v8 + 96) )
  {
    ...
    {
      DIBitmapReal = GreCreateCompatibleBitmapInternal(*(_QWORD *)(gpDispInfo + 32LL), v20, v9 / 2, 0, 0LL);
    }
    v11 = DIBitmapReal;
    v23 = DIBitmapReal;
    if ( !DIBitmapReal )
  ...
  else
  {
    if ( a6 || !*(_QWORD *)(v8 + 96) )
      ...
      v13 = v9 / 2;
    NtGdiBitBltInternal(ghdcMem, 0, 0, v20, v13, ghdcMem2, 0, 0, 0xCC0020u, 0xFFFFFF, 0);
  }
  if ( v11 )
  {
    ...
    if ( v22 )
      ...
      NtGdiBitBltInternal(ghdcMem, 0, 0, v20, v9 / 2, ghdcMem2, 0, 0, 0xCC0020u, 0, 0);
  }
