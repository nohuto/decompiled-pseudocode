/*
 * XREFs of itrp_FLIPRGOFF @ 0x1C02DD030
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_FLIPRGOFF(__int64 a1)
{
  ...
  v4 = 4;
  v5 = (int *)(qword_1C0323E18 - 4);
  qword_1C0323E18 = (__int64)v5;
  ...
  {
    if ( v7 >= *(_DWORD *)(qword_1C0323E30 + 440) || v7 < 0 )
      goto LABEL_14;
    v12 = 4;
  }
  if ( !(unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, LocalGS) )
    goto LABEL_14;
  v13 = *(_WORD *)(v2 + 80);
  if ( v13 >= 1 && v13 <= v11 && v7 >= v12 + *(__int16 *)(*(_QWORD *)(v2 + 64) + 2LL * v13 - 2) + 1 )
    goto LABEL_14;
  qword_1C0323E18 = (__int64)(v5 - 1);
  v14 = *(_WORD **)(v1 + 344);
  v15 = *(v5 - 1);
  v16 = v14[4];
  v17 = v14[6];
  ...
  if ( !(unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND((__int64)&LocalGS, v2)
    ...
    && v20 <= v19
    && (int)v15 >= v4 + *(__int16 *)(*(_QWORD *)(v2 + 64) + 2LL * v20 - 2) + 1 )
  {
LABEL_14:
