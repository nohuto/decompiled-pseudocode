/*
 * XREFs of ?vSrcCopyS1D4@@YAXPEAUBLTINFO@@@Z @ 0x1C00F6F80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
    ...
    if ( v10 )
    {
      ...
      do
      {
        ...
        if ( v22 != &v22[v33] )
        {
          do
          {
            v36 = (unsigned __int8)(v35 | (*++v22 >> v61));
            *v20 = *(&v68 + ((unsigned __int64)(unsigned __int8)(v35 | (*v22 >> v61)) >> 6));
            v20[1] = *(&v68 + ((v36 >> 4) & 3));
            v20[2] = *(&v68 + ((v36 >> 2) & 3));
            v20[3] = *(&v68 + (v36 & 3));
            v20 += 4;
...
LABEL_15:
  if ( v9 | v30 )
  {
    v37 = dword_1C02ED3B0[v9];
    if ( !v60 )
      v37 &= dword_1C02ED390[v14 & 7];
    v38 = *((_DWORD *)v1 + 8);
    v39 = v11 + v7 > 8;
