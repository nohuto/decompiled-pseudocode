/*
 * XREFs of itrp_ROTATE @ 0x1C00DE640
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall itrp_ROTATE(__int64 a1)
{
  ...
  if ( (qword_1C0323E30 ^ *(_QWORD *)qword_1C0323E30 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0323E30 + 424)) == *(_QWORD *)(qword_1C0323E30 + 432)
    && (v2 = qword_1C0323E18, (unsigned __int64)((qword_1C0323E18 - *(_QWORD *)qword_1C0323E30) >> 2) >= 3) )
  {
    v3 = *(_DWORD *)(qword_1C0323E18 - 8);
    *(_DWORD *)(qword_1C0323E18 - 8) = *(_DWORD *)(qword_1C0323E18 - 4);
