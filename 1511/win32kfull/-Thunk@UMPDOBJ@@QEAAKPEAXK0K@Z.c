/*
 * XREFs of ?Thunk@UMPDOBJ@@QEAAKPEAXK0K@Z @ 0x1C0146F48
 * Callers:
 ...
 *     _lambda_a14203f76e9ac3ebf682907d834e7ca5_::operator() @ 0x1C029B9E4 (_lambda_a14203f76e9ac3ebf682907d834e7ca5_--operator().c)
...
__int64 __fastcall UMPDOBJ::Thunk(UMPDOBJ *this, _DWORD *Src, unsigned int a3, void *a4, size_t Size)
{
  ...
  *((_BYTE *)this + 32) = v11 | 1;
  ...
  KernelPtr = UMPDOBJ::GetKernelPtr(this, v22);
  v14 = UMPDOBJ::GetKernelPtr(this, v12);
  v15 = Src[1];
  Srca = v14;
  ...
  lambda_a14203f76e9ac3ebf682907d834e7ca5_::operator()(v18, *((_QWORD *)this + 18));
  lambda_a14203f76e9ac3ebf682907d834e7ca5_::operator()(v19, *((_QWORD *)this + 20));
