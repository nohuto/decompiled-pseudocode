/*
 * XREFs of ApplyGatheredDeviceInfoSummaryInformation @ 0x1C0095550
 * Callers:
...
void __fastcall ApplyGatheredDeviceInfoSummaryInformation(int a1, __int64 a2, int a3, int a4, int a5, int a6, int a7)
{
  int v9; // r15d
