/*
 * XREFs of ?bSpDwmUpdateSpriteShape@@YAHPEAUHDEV__@@PEAVDWMSPRITE@@PEAVSFMLOGICALSURFACE@@PEAU_SURFOBJ@@PEAU_RECTL@@PEAVPALETTE@@PEAK4PEAPEAV3@@Z @ 0x1C003BF04
 * Callers:
                  ...
                  *(_QWORD *)&v33.left = 0LL;
                  ...
                  if ( !(unsigned int)ERECTL::bEmpty((ERECTL *)&v33) )
                  {
                    ...
                    if ( v13 )
                    {
                      ...
                      if ( v13 )
                      {
                        vSpUpdateDirtyRgn(a2, v18, 0LL, (struct _RECTL *)&v33, a7, 0);
                        vSpUpdateDirtyRgn(a2, v18, 0LL, (struct _RECTL *)&v33, a7, 0);
                      }
                    }
