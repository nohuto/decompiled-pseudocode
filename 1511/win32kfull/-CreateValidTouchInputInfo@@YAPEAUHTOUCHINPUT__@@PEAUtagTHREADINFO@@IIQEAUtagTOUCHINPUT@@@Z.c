/*
 * XREFs of ?CreateValidTouchInputInfo@@YAPEAUHTOUCHINPUT__@@PEAUtagTHREADINFO@@IIQEAUtagTOUCHINPUT@@@Z @ 0x1C01DC23C
 * Callers:
...
LABEL_3:
  ...
  v15[1] = 0;
  v15[0] = a3;
  v16 = (struct tagTOUCHINPUT *)Win32AllocPool((unsigned int)v8);
  if ( !v16 )
  {
    v9 = -1073741801;
    goto LABEL_3;
