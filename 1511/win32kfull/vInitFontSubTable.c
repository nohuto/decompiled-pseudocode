/*
 * XREFs of vInitFontSubTable @ 0x1C0378E90
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  if ( v0 )
  {
    *v0 = xmmword_1C02E25C8;
    v0[1] = xmmword_1C02E25D8;
    *((_DWORD *)v0 + 8) = 6684777;
    *((_WORD *)v0 + 18) = 0;
    v2 = gpfsTable;
    *((_OWORD *)gpfsTable + 4) = xmmword_1C02E25A0;
    v2[5] = xmmword_1C02E25B0;
    *((_DWORD *)v2 + 24) = 4587593;
    *((_WORD *)v2 + 50) = 0;
    v3 = (char *)gpfsTable;
    *(_OWORD *)((char *)gpfsTable + 130) = xmmword_1C02E25F0;
