/*
 * XREFs of ?TraceLoggingPTPSettingsConfigEvent@@YAXPEAUtagTPSETTINGS@@KHPEAG1HH@Z @ 0x1C0225CC0
 * Callers:
        ...
        char a7)
{
  ...
  if ( (unsigned int)dword_1C031B280 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x800000000000uLL) )
    {
      ...
      v38 = v11;
      v41 = v11;
      TlgWrite((TraceLoggingHProvider)&a6, &unk_1C02E9A05, v12, v13, 0xCu, &pData);
    }
  }
}
