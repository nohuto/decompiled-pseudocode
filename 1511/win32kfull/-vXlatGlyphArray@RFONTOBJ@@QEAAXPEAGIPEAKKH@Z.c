/*
 * XREFs of ?vXlatGlyphArray@RFONTOBJ@@QEAAXPEAGIPEAKKH@Z @ 0x1C00246E0
 * Callers:
        ...
        int a6)
{
  ...
  if ( a6 && v11 && (v11 & 1) == 0 )
  {
    v7 = *(__int64 **)(*(_QWORD *)(*(_QWORD *)this + 120LL) + 8LL * ((v11 - 1) & 0xFFFFFFFE) + 216);
    v49 = v7;
    v50 = v7;
    if ( v7 )
    {
...
LABEL_55:
        ...
        if ( v13 == 2 || (unsigned int)RFONTOBJ::bIsLinkedGlyph(v51, v20) )
          goto LABEL_44;
        v38 = *a2;
        if ( *(_DWORD *)(*(_QWORD *)v51 + 716LL) && v38 >= gqlTTSystem && v38 <= (unsigned __int16)word_1C0323322 )
        {
          v45 = v38 - gqlTTSystem;
          ...
          if ( ((0x80000000 >> v46) & *(_DWORD *)(qword_1C0323328 + 4LL * (v45 >> 5))) != 0 )
LABEL_44:
