/*
 * XREFs of itrp_ALIGNRP @ 0x1C00B4C90
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_ALIGNRP(__int64 a1)
{
  ...
  {
    if ( (int)qword_1C0323E40 >= (unsigned __int16)v3[8] || (int)qword_1C0323E40 < 0 )
      goto LABEL_50;
    v11 = 0;
  }
  else
...
LABEL_50:
  ...
  if ( (v1 ^ *(_QWORD *)v1 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(v1 + 424)) != *(_QWORD *)(v1 + 432)
    || (v13 = qword_1C0323E18, dword_1C0323E50 + 1LL > (unsigned __int64)((qword_1C0323E18 - *(_QWORD *)v1) >> 2)) )
  {
  ...
  if ( dword_1C0323E50 >= 0 )
  {
    while ( 1 )
    {
      ...
      if ( word_1C0323EA4 && v2 != v8 && *(_BYTE *)(v1 + 333) == 2 && (*(_BYTE *)(v1 + 452) & 2) != 0 )
      {
        if ( word_1C0323EA6 == -1
          || word_1C0323EA8 == -1
          || !(unsigned int)InterAlign(
                              v26,
                              (unsigned int)word_1C0323EA6,
                              (unsigned int)v15,
                              (unsigned int)word_1C0323EA8) )
        {
      ...
      InvokeMovePoint((unsigned int)dword_1C0323E5C, v2, (unsigned int)v15, (unsigned int)-v22);
      if ( --dword_1C0323E50 < 0 )
        break;
      v10 = qword_1C0323E40;
      v1 = qword_1C0323E30;
