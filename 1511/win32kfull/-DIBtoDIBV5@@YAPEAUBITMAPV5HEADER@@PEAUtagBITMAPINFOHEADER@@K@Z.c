/*
 * XREFs of ?DIBtoDIBV5@@YAPEAUBITMAPV5HEADER@@PEAUtagBITMAPINFOHEADER@@K@Z @ 0x1C01EFE90
 * Callers:
...
struct BITMAPV5HEADER *__fastcall DIBtoDIBV5(struct tagBITMAPINFOHEADER *a1)
{
  ...
  if ( a1->biSize != 40 )
    return 0LL;
  v2 = a1->biBitCount * (unsigned __int64)(unsigned int)a1->biWidth;
  if ( v2 > 0xFFFFFFFF )
    return 0LL;
  ...
  if ( v5 < v4 + v3 + 40 )
    return 0LL;
  v8 = (_OWORD *)Win32AllocPool(v6 + (unsigned int)v3);
  v9 = v8;
  if ( !v8 )
    return 0LL;
  memset(v8, 0, 0x7CuLL);
