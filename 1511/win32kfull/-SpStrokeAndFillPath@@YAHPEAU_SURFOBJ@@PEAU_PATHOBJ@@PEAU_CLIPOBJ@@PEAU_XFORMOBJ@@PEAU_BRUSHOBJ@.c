/*
 * XREFs of ?SpStrokeAndFillPath@@YAHPEAU_SURFOBJ@@PEAU_PATHOBJ@@PEAU_CLIPOBJ@@PEAU_XFORMOBJ@@PEAU_BRUSHOBJ@@PEAU_LINEATTRS@@4PEAU_POINTL@@KK@Z @ 0x1C026DDB0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a10)
{
  ...
  __int64 *v37[9]; // [rsp+3B0h] [rbp+2B0h] BYREF
  ...
  while ( (unsigned int)ENUMUNDERLAYS::bEnum(v37, &v25, &v27, &v24) )
  {
    v12 = 0LL;
...
LABEL_49:
      ...
      {
        v22 = (BOOL (__stdcall *)(SURFOBJ *, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, LINEATTRS *, BRUSHOBJ *, POINTL *, MIX, FLONG))*((_QWORD *)v13->hdev + 164);
        goto LABEL_39;
      }
      goto LABEL_38;
    }
...
LABEL_39:
    if ( !(unsigned int)OffStrokeAndFillPath(v22, &v27, v13, this, v24, v29, v31, v28, v32, v33, a9, a10) )
      v11 = -1;
    if ( v12 )
      this = v12;
    if ( v19 )
