/*
 * XREFs of xxxInternalToUnicode @ 0x1C0099650
 * Callers:
 ...
 *     xxxClientCharToWchar @ 0x1C014CEF0 (xxxClientCharToWchar.c)
 *     xxxMessageBeep @ 0x1C014F750 (xxxMessageBeep.c)
 *     ?ComposeDeadKeys@@YAHPEAUtagKL@@PEAUDEADKEY@@GPEAGHIH@Z @ 0x1C0244950 (-ComposeDeadKeys@@YAHPEAUtagKL@@PEAUDEADKEY@@GPEAGHIH@Z.c)
 */
        ...
        __int64 a8)
{
  ...
  *a7 = v15;
  ...
  {
    v23 = byte_1C0323D42;
    if ( a1 == (unsigned __int16)word_1C0323D44 )
      word_1C0323D44 = 0;
    goto LABEL_7;
  }
  if ( word_1C0323D40 )
...
LABEL_58:
        ...
        {
          if ( (word_1C0323D40 & 0xFF00) != 0 )
          {
            v21 = _byteswap_ushort(word_1C0323D40);
            word_1C0323D40 = v21;
          }
          else if ( ((_WORD)v45 != 932 || (unsigned __int16)(word_1C0323D40 - 161) > 0x3Eu)
                 && (unsigned __int16)(word_1C0323D40 - 128) <= 0x7Fu )
          {
            v45 = 1252LL;
          }
        }
...
LABEL_50:
      if ( v44 >= 0 )
      {
        if ( (unsigned __int16)word_1C0323D44 == a1 )
          return 0LL;
        if ( (unsigned __int8)v23 < 2u || (unsigned __int8)v23 > 3u )
        {
          word_1C0323D40 = v44 + 10 * v21;
          if ( !word_1C0323D40 )
          {
            v48 = v23;
            if ( !v44 )
...
LABEL_38:
  ...
  if ( v37 == -4095 )
  {
    ...
    if ( *((_WORD *)v61 + 37) && (GetAppCompatFlags2(0x400u) & 0x8000) == 0 )
      goto LABEL_36;
