/*
 * XREFs of ?bScanLists@FHOBJ@@QEAAHPEAVEFSOBJ@@KPEAU_EFFILTER_INFO@@@Z @ 0x1C001DA3C
 * Callers:
 *     ?bScanTheList@@YAHPEAVFHOBJ@@KPEAVEFSOBJ@@KPEAU_EFFILTER_INFO@@PEBG@Z @ 0x1C0016F5C (-bScanTheList@@YAHPEAVFHOBJ@@KPEAVEFSOBJ@@KPEAU_EFFILTER_INFO@@PEBG@Z.c)
 * Callees:
 *     ?bAdd@EFSOBJ@@QEAAHPEAVPFE@@W4_ENUMFONTSTYLE@@KK@Z @ 0x1C001BB78 (-bAdd@EFSOBJ@@QEAAHPEAVPFE@@W4_ENUMFONTSTYLE@@KK@Z.c)
...
LABEL_6:
  ...
  *((_DWORD *)a4 + 8) = *(_DWORD *)(i + 24);
  while ( 1 )
  {
    ...
    if ( !v11 || v13 == 5 )
    {
      if ( !(unsigned int)EFSOBJ::bAdd(a2, v9, v13, 0, 1) )
        return 0LL;
      v11 = 1;
    }
LABEL_5:
  ...
  if ( (unsigned int)EFSOBJ::bAdd(a2, v9, 0, v7, *((_DWORD *)a4 + 9)) )
    goto LABEL_6;
  return 0LL;
}
