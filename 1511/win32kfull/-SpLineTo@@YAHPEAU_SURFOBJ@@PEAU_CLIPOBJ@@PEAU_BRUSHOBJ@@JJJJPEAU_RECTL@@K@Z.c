/*
 * XREFs of ?SpLineTo@@YAHPEAU_SURFOBJ@@PEAU_CLIPOBJ@@PEAU_BRUSHOBJ@@JJJJPEAU_RECTL@@K@Z @ 0x1C013FBB0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a9)
{
  ...
  while ( (unsigned int)ENUMUNDERLAYS::bEnum(v23, &v16, &v20, &v18) )
  {
    ...
    if ( !NEEDDDILOCK::bRender((NEEDDDILOCK *)&v17, &v18) )
      goto LABEL_10;
    p_iType = &v10->iType;
    if ( v10->iType == 1 )
    {
...
LABEL_31:
    ...
    if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v10) + 112) & 0x100) == 0 )
      goto LABEL_31;
    v13 = (BOOL (__stdcall *)(SURFOBJ *, CLIPOBJ *, BRUSHOBJ *, LONG, LONG, LONG, LONG, RECTL *, MIX))*((_QWORD *)v10->hdev + 172);
LABEL_9:
