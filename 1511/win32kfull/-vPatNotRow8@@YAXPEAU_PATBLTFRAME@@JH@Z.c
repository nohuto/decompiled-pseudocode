/*
 * XREFs of ?vPatNotRow8@@YAXPEAU_PATBLTFRAME@@JH@Z @ 0x1C02BF370
 * Callers:
 *     <none>
 * Callees:
 *     vFetchNotAndCopy @ 0x1C02D2FB4 (vFetchNotAndCopy.c)
 *     vFetchShiftNotAndCopy @ 0x1C02D30E8 (vFetchShiftNotAndCopy.c)
 */
    ...
    do
    {
      ...
      else
      {
        ...
        if ( v15 )
        {
          ...
          {
            vFetchShiftNotAndCopy(&v17);
          }
          else
          {
            v22 = v16 >> 2;
            vFetchNotAndCopy(&v17);
          }
          v9 = v18;
          v15 = v21;
        }
        if ( v24 )
          *(_DWORD *)(v11 + v6) = *(_DWORD *)(v11 + v6) & ~v23 | v23 & ~*(_DWORD *)(((int)v14 + 4
