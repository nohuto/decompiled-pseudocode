/*
 * XREFs of SetWindowCompositionAllowNCPaint @ 0x1C0223C74
 * Callers:
...
__int64 __fastcall SetWindowCompositionAllowNCPaint(struct tagWND *a1, __int128 *a2)
{
  unsigned int v4; // ebx
  int v5; // esi
  __int64 v6; // rdx
  ...
  {
    if ( -__CFSHR__(v12[0], 2) == v5 )
      return 0;
    v12[0] ^= (LOBYTE(v12[0]) ^ (unsigned __int8)(2 * v5)) & 2;
    ...
    else
    {
      ...
      return (unsigned int)DwmAsyncSetCompositionAttribute(v10, *(_QWORD *)a1, 4, a2);
    }
  }
  return v4;
}
