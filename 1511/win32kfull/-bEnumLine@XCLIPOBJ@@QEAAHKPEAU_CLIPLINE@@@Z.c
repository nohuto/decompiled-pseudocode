/*
 * XREFs of ?bEnumLine@XCLIPOBJ@@QEAAHKPEAU_CLIPLINE@@@Z @ 0x1C02C7CB4
 * Callers:
 ...
 *     ?bFindNextScan@XCLIPOBJ@@IEAAHXZ @ 0x1C02C82F4 (-bFindNextScan@XCLIPOBJ@@IEAAHXZ.c)
 ...
 *     ?bRecordRun@XCLIPOBJ@@IEAAHAEAJ@Z @ 0x1C02C8454 (-bRecordRun@XCLIPOBJ@@IEAAHAEAJ@Z.c)
