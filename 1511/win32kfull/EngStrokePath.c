/*
 * XREFs of EngStrokePath @ 0x1C013CBC0
 * Callers:
 ...
 *     W32kCddStrokePath @ 0x1C013CB20 (W32kCddStrokePath.c)
        ...
        MIX mix)
{
  ...
  if ( v19 )
  {
    ...
    else if ( (ppo->fl & 1) == 0 || EPATHOBJ::bFlatten((EPATHOBJ *)ppo) )
    {
      if ( *(_WORD *)(v12 + 100) )
      {
        v15 = *(__int64 (__fastcall **)(__int64, PATHOBJ *, CLIPOBJ *, XFORMOBJ *, BRUSHOBJ *, POINTL *, LINEATTRS *, MIX))(*(_QWORD *)(v12 + 48) + 2832LL);
        if ( !v15 )
          goto LABEL_12;
