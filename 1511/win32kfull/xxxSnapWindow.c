/*
 * XREFs of xxxSnapWindow @ 0x1C01499F0
 * Callers:
 ...
 *     ClientNoMemoryPopup @ 0x1C020E3D0 (ClientNoMemoryPopup.c)
...
__int64 __fastcall xxxSnapWindow(__int64 a1, int a2)
{
  ...
  if ( !(unsigned int)IsToplevelWindowDesktopComposed(a1) )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v41;
    ...
    v12 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(gptiCurrent + 408LL) + 8LL) + 16LL);
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v42;
    ...
    xxxEmptyClipboard(v4);
    v37 = *(_OWORD *)(a1 + 112);
    if ( !(unsigned int)IntersectRect(&v37, (int *)&v37, (int *)(gpDispInfo + 104LL)) )
    {
      v11 = 0;
      goto LABEL_66;
    }
    v18 = DWORD2(v37) - v37;
    v19 = HIDWORD(v37) - DWORD1(v37);
    DWORD2(v37) -= v37;
    HIDWORD(v37) -= DWORD1(v37);
    if ( a1 != GetDesktopWindow(a1) )
    {
      LODWORD(v37) = v37 - *(_DWORD *)(a1 + 112);
      DWORD1(v37) -= *(_DWORD *)(a1 + 116);
    }
...
LABEL_41:
      if ( *v30 )
        CompatibleBitmapInternal = GreCreateCompatibleBitmapInternal((__int64)v22, v18, v19, 0, 0LL);
      else
      ...
      if ( CompatibleBitmapInternal || (Bitmap = GreCreateBitmap(v18, v19, 1LL, 1LL, 0LL)) != 0 )
      {
        ...
        if ( !a2
          && a1 == *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v46 + 408) + 8LL) + 16LL)
        ...
        if ( (unsigned int)IsWindowDesktopComposed(a1) )
        {
          ...
          v11 = NtGdiBitBltInternal(CompatibleDC, 0, 0, v18, v19, v22, v37, DWORD1(v37), 0x40CC0020u, 0, 0);
          EnterCrit(0LL, 1LL);
        }
        else
        {
