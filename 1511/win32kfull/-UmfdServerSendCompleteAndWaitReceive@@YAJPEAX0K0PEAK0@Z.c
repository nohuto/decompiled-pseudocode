/*
 * XREFs of ?UmfdServerSendCompleteAndWaitReceive@@YAJPEAX0K0PEAK0@Z @ 0x1C02D6AF0
 * Callers:
 ...
 *     ?WaitForWorkItem@CWorkItemQueue@@QEBAPEAVCWorkItem@1@_N@Z @ 0x1C02D9420 (-WaitForWorkItem@CWorkItemQueue@@QEBAPEAVCWorkItem@1@_N@Z.c)
 */
