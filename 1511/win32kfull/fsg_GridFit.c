/*
 * XREFs of fsg_GridFit @ 0x1C00AE864
 * Callers:
 ...
 *     fsg_Embold @ 0x1C01421F4 (fsg_Embold.c)
 */
...
LABEL_13:
  ...
  else
  {
    ...
    fsg_InitializeGlyphData(v34, v27, *(unsigned __int16 *)(a1 + 216), 0LL);
    v35 = a13;
...
LABEL_20:
    ...
    if ( !v36 )
    {
      ...
      v43 = *(_WORD *)(*(_QWORD *)(v40 + 64) + 2LL * *(__int16 *)(v40 + 80) - 2);
      ...
      if ( (v45 || v46) && v43 != -9 )
      {
        ...
        while ( v15 < (unsigned __int16)(*(_WORD *)(*(_QWORD *)(v40 + 64) + 2LL * *(__int16 *)(v40 + 80) - 2) + 9) );
      }
    }
  }
  return v36;
