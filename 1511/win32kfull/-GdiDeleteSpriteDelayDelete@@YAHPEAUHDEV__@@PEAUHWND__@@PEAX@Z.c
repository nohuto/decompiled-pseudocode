/*
 * XREFs of ?GdiDeleteSpriteDelayDelete@@YAHPEAUHDEV__@@PEAUHWND__@@PEAX@Z @ 0x1C026B578
 * Callers:
 ...
 *     ?pSpGetMetaSpriteDelayDelete@@YAPEAU_METASPRITE@@PEBU_SPRITESTATE@@PEAUHWND__@@PEAX@Z @ 0x1C0271F84 (-pSpGetMetaSpriteDelayDelete@@YAPEAU_METASPRITE@@PEBU_SPRITESTATE@@PEAUHWND__@@PEAX@Z.c)
 *     ?pSpGetSpriteDelayDelete@@YAPEAVSPRITE@@PEAU_SPRITESTATE@@PEAUHWND__@@PEAX@Z @ 0x1C0271FDC (-pSpGetSpriteDelayDelete@@YAPEAVSPRITE@@PEAU_SPRITESTATE@@PEAUHWND__@@PEAX@Z.c)
...
__int64 __fastcall GdiDeleteSpriteDelayDelete(HDEV a1, HWND a2, void *a3)
{
  ...
  v6 = v25;
  v7 = (const struct _SPRITESTATE *)(v25 + 24);
  if ( *((_DWORD *)v25 + 41) )
  {
      ...
      if ( v9 )
      {
        do
        {
          ...
          if ( v12 )
          {
            ...
            {
              v15 = (W32PIDLOCK *)(v14 + 264);
              W32PIDLOCK::vLockSingleThread((W32PIDLOCK *)(v14 + 264));
              *(_DWORD *)v11 &= ~0x400u;
              *(_DWORD *)v8 &= ~0x400u;
        ...
        while ( v10 < *((_DWORD *)v6 + 41) );
      }
      if ( *((_DWORD *)v6 + 41) )
      {
        do
          vSpDeleteSprite(*((struct SPRITE **)v8 + v5++ + 4));
        while ( v5 < *((_DWORD *)v6 + 41) );
      }
      v16 = *((_QWORD *)v6 + 22);
      if ( (struct _METASPRITE *)v16 == v8 )
      {
        *((_QWORD *)v6 + 22) = *((_QWORD *)v8 + 2);
      }
      else
      {
  ...
  else
  {
    ...
    if ( v18 )
    {
      ...
      if ( v20 )
      {
        ...
        {
          v23 = (W32PIDLOCK *)(v22 + 264);
          W32PIDLOCK::vLockSingleThread((W32PIDLOCK *)(v22 + 264));
          *(_DWORD *)v19 &= ~0x400u;
