/*
 * XREFs of ?pSpFindInZ@@YAPEAVSPRITE@@PEAV1@PEAU_RECTL@@@Z @ 0x1C0111638
 * Callers:
 ...
 * Callees:
 *     ?bIsCursorSprite@@YAHPEAVSPRITE@@@Z @ 0x1C026E42C (-bIsCursorSprite@@YAHPEAVSPRITE@@@Z.c)
 *     ?vLock@SINGLEREADERLOCK@@QEAAXXZ @ 0x1C0272A58 (-vLock@SINGLEREADERLOCK@@QEAAXXZ.c)
