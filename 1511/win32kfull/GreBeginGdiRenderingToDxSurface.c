/*
 * XREFs of GreBeginGdiRenderingToDxSurface @ 0x1C0039A28
 * Callers:
 *     NtGdiBeginGdiRendering @ 0x1C0039A20 (NtGdiBeginGdiRendering.c)
 * Callees:
 *     ?bReset@DC@@QEAAHXZ @ 0x1C0027610 (-bReset@DC@@QEAAHXZ.c)
...
__int64 __fastcall GreBeginGdiRenderingToDxSurface(__int64 a1, unsigned int a2, __int64 a3)
{
  ...
  if ( v8 )
  {
    if ( (a1 & 0x800000) == 0 )
    {
      ...
      {
        v9 = *(_QWORD *)(v8 + 48);
        if ( (*(_DWORD *)(v8 + 116) & 8) != 0 || *(_QWORD *)(v8 + 216) )
        {
          v10 = *(HDC *)(v8 + 152);
          *(_WORD *)(v8 + 102) &= ~0x200u;
          if ( v10 )
