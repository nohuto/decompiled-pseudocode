/*
 * XREFs of xxxProcessKeyEvent @ 0x1C00830F4
 * Callers:
...
LABEL_4:
  ...
  UpdateInputGlobalsEx((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24, a3, 0LL, v11);
  if ( !a3 || !*((_DWORD *)a1 + 1) )
    *((_DWORD *)a1 + 1) = glinp[0];
  v12 = *((_WORD *)a1 + 1);
  if ( (v12 & 0x4000) == 0 )
...
LABEL_20:
        if ( v14 )
        {
          ...
          {
            LOBYTE(v14) = EtwTraceUIPIInputError(gptiCurrent, 0LL, gpqForeground, *(_QWORD *)(gpqForeground + 372LL), 1);
          }
        }
      }
    }
