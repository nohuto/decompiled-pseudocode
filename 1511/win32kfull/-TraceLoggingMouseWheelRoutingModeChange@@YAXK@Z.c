/*
 * XREFs of ?TraceLoggingMouseWheelRoutingModeChange@@YAXK@Z @ 0x1C022577C
 * Callers:
...
void __fastcall TraceLoggingMouseWheelRoutingModeChange(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C031B280 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v4 = (int)v1;
      v7 = 4;
      TlgWrite(v1, &unk_1C02E9473, v2, v3, 3u, &pData);
    }
  }
}
