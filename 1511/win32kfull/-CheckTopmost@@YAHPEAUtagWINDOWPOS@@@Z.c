/*
 * XREFs of ?CheckTopmost@@YAHPEAUtagWINDOWPOS@@@Z @ 0x1C0076B58
 * Callers:
...
__int64 __fastcall CheckTopmost(struct tagWINDOWPOS *a1)
{
  ...
  v1 = 0LL;
  v3 = *(_QWORD *)(*((_DWORD *)&gSharedInfo + 4) * (unsigned int)(unsigned __int16)*(_DWORD *)a1
                 + *((_QWORD *)&gSharedInfo + 1));
  v4 = *((_DWORD *)a1 + 8);
  if ( (v4 & 0x14) == 0
    && *((_QWORD *)a1 + 1) <= 0xFFFFFFFFFFFFFFFDuLL
    && v3 != *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 16) + 384LL) + 80LL) )
  {
    *((_QWORD *)a1 + 1) = 0LL;
  }
  if ( (v4 & 4) != 0 )
  ...
  if ( v6 != 1 )
  {
    switch ( v6 )
    {
      ...
      default:
        ...
        if ( *((_QWORD *)a1 + 1) == v9 )
          return 0LL;
        if ( (*(_BYTE *)(*(_QWORD *)(*((_DWORD *)&gSharedInfo + 4) * (unsigned int)(unsigned __int16)*((_DWORD *)a1 + 2)
                                   + *((_QWORD *)&gSharedInfo + 1))
                       + 48LL) & 8) != 0 )
        {
          if ( (*(_BYTE *)(v3 + 48) & 8) != 0 )
