/*
 * XREFs of ?xxxProcessPointerInputAsMouse@PointerPromotion@@YAXAEBUtagPOINTER_INFO@@GG@Z @ 0x1C023AD48
 * Callers:
 ...
 *     ?CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z @ 0x1C0239EEC (-CoalesceMousePromotionEntry@@YAHAEBUtagPOINTER_INFO@@G@Z.c)
        ...
        __int16 a3)
{
  ...
  *(__m128i *)v20 = v3;
  ...
  if ( (v20[6] & 0x8000) != 0 )
  {
    v12 = dword_1C0323618 & 0xFFFFFFF7;
    dword_1C0323618 &= ~8u;
  }
  v13 = v20[2];
  if ( v20[2] != word_1C0323510[0] || (a3 & 0x10) != 0 )
  {
    if ( (v12 & 2) != 0 )
    {
      CancelAutoPromotion();
    ...
    dword_1C0323618 = v12 & 0xFFFFFFF7;
  ...
  qword_1C0323608 = v21.m128i_i64[1];
  dword_1C0323514 = v9;
  if ( MousePromotionEntry )
  {
    if ( (dword_1C0323618 & 2) != 0 )
    {
      if ( (dword_1C0323618 & 4) != 0 )
        *((_DWORD *)MousePromotionEntry + 10) &= ~1u;
      QueueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0323590, MousePromotionEntry);
      if ( (*((_DWORD *)MousePromotionEntry + 5) & 0x40000) != 0 )
        dword_1C0323618 &= 0xFFFFFFF9;
      goto LABEL_29;
    }
    QueueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&unk_1C0323520, MousePromotionEntry);
  }
  if ( v14 || MousePromotionEntry )
  {
    if ( (dword_1C0323618 & 8) != 0 )
    {
      v15 = DetectPromotionType(0LL, qword_1C0323528);
      if ( v15 == 0x10000000 )
        goto LABEL_29;
      v17 = v15;
      v18 = v9;
