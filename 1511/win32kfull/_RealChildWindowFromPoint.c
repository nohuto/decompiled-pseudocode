/*
 * XREFs of _RealChildWindowFromPoint @ 0x1C023C18C
 * Callers:
 *     NtUserRealChildWindowFromPoint @ 0x1C021ED00 (NtUserRealChildWindowFromPoint.c)
 * Callees:
...
__int64 __fastcall RealChildWindowFromPoint(__int64 a1, unsigned __int64 a2)
{
  ...
  if ( a1 )
  {
    if ( (*(_BYTE *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 432) + 224LL) & 1) == 0 )
    {
      ...
      if ( !(unsigned int)SameCoordinateSpace(CurrentProcessWin32Process, *(_QWORD *)(v3 + 376)) )
