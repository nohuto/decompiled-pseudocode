/*
 * XREFs of ?UMPDDrvQueryFontData@@YAJPEAUDHPDEV__@@PEAU_FONTOBJ@@KKPEAU_GLYPHDATA@@PEAXK@Z @ 0x1C029F2A0
 * Callers:
 *     <none>
 * Callees:
        ...
        size_t Size)
{
  ...
  if ( (unsigned int)UMPDOBJ::ThunkMemBlock(v10, (const void **)&Src[7], Size)
    && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v10, (struct UMPDOBJ *)((char *)v10 + 176), (const void **)&Src[4], 0x40u) )
  {
    ...
    if ( v13 != -1 )
    {
      ...
      if ( a5 )
        *a5 = *(struct _GLYPHDATA *)UMPDOBJ::GetKernelPtr(v10, (char *)Src[6]);
    }
  }
  else
  {
