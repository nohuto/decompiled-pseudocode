/*
 * XREFs of ?xxxGeneratePointerInputMessagesCore@@YAHHHHPEBUtagPOINTERINPUTFRAME@@@Z @ 0x1C01FA3E4
 * Callers:
 ...
 *     CalcManipulationInputInfoSize @ 0x1C01FBC28 (CalcManipulationInputInfoSize.c)
...
LABEL_28:
  ...
  if ( *(_DWORD *)(*((_QWORD *)a4 + 11) + 24LL) != 8 && ((*((_DWORD *)a4 + 14) & 8) != 0 || word_1C0323510) )
  {
    v51 = *((_QWORD *)a4 + 9);
    if ( *((_DWORD *)a4 + 6) )
    {
