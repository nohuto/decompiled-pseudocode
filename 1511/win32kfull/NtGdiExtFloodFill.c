/*
 * XREFs of NtGdiExtFloodFill @ 0x1C012E0C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??1STACKMEMOBJ@@QEAA@XZ @ 0x1C0114228 (--1STACKMEMOBJ@@QEAA@XZ.c)
 *     ?vFindExtent@FLOODBM@@QEAAXJAEAJ0@Z @ 0x1C012DB6C (-vFindExtent@FLOODBM@@QEAAXJAEAJ0@Z.c)
 *     ?bExtendScanline@FLOODBM@@QEAAHAEAVSTACKOBJ@@0JPEAE1@Z @ 0x1C012DC60 (-bExtendScanline@FLOODBM@@QEAAHAEAVSTACKOBJ@@0JPEAE1@Z.c)
...
__int64 __fastcall NtGdiExtFloodFill(HDC a1, LONG a2, LONG a3, unsigned int a4, int a5)
{
  ...
  struct REGION *v74; // [rsp+A0h] [rbp-68h] BYREF
  int v75; // [rsp+A8h] [rbp-60h]
  _QWORD v76[2]; // [rsp+B0h] [rbp-58h] BYREF
  __int64 v77; // [rsp+C0h] [rbp-48h]
  BRUSHOBJ *v78; // [rsp+C8h] [rbp-40h] BYREF
  struct REGION *v79[2]; // [rsp+D0h] [rbp-38h] BYREF
  __int64 v80; // [rsp+E0h] [rbp-28h] BYREF
  char v81; // [rsp+E8h] [rbp-20h]
  int v82; // [rsp+ECh] [rbp-1Ch]
  int v83; // [rsp+F0h] [rbp-18h] BYREF
  __int64 v84; // [rsp+F4h] [rbp-14h]
  __int128 v85; // [rsp+FCh] [rbp-Ch]
  int v86; // [rsp+10Ch] [rbp+4h]
  struct REGION *v87[2]; // [rsp+110h] [rbp+8h] BYREF
  _BYTE v88[4]; // [rsp+120h] [rbp+18h] BYREF
  int v89; // [rsp+124h] [rbp+1Ch]
  __int64 v90; // [rsp+128h] [rbp+20h]
  __int64 v91; // [rsp+140h] [rbp+38h]
  _BYTE v92[4]; // [rsp+148h] [rbp+40h] BYREF
  int v93; // [rsp+14Ch] [rbp+44h]
  __int64 v94; // [rsp+150h] [rbp+48h]
  __int64 v95; // [rsp+168h] [rbp+60h]
  int v96; // [rsp+170h] [rbp+68h] BYREF
  struct _RECTL v97; // [rsp+174h] [rbp+6Ch]
  ULONG v98; // [rsp+184h] [rbp+7Ch]
  int v99; // [rsp+188h] [rbp+80h]
  unsigned __int8 *v100; // [rsp+190h] [rbp+88h]
  int v101; // [rsp+198h] [rbp+90h]
  _BYTE v102[24]; // [rsp+1A0h] [rbp+98h] BYREF
  BRUSHOBJ pbo; // [rsp+1B8h] [rbp+B0h] BYREF
  int v104; // [rsp+1D0h] [rbp+C8h]
  int v105; // [rsp+1D4h] [rbp+CCh]
  __int64 v106; // [rsp+1D8h] [rbp+D0h]
  __int64 v107; // [rsp+1E0h] [rbp+D8h]
  __int64 v108; // [rsp+210h] [rbp+108h]
  __int128 v109; // [rsp+218h] [rbp+110h]
  int v110; // [rsp+238h] [rbp+130h]
  _BYTE v111[80]; // [rsp+248h] [rbp+140h] BYREF
  struct _RECTL v112; // [rsp+298h] [rbp+190h] BYREF
  _QWORD v113[2]; // [rsp+2A8h] [rbp+1A0h] BYREF
...
LABEL_110:
  ...
  if ( (v18 & 0x1000) != 0 )
  {
    GreDCSelectBrush(v71[0], *(_QWORD *)(v17 + 16));
    v16 = v71[0];
  }
  if ( (v18 & 0x2000) != 0 )
  {
  ...
  DEVLOCKOBJ::DEVLOCKOBJ((DEVLOCKOBJ *)v111, (struct XDCOBJ *)v71, 0);
  v21 = *((_QWORD *)v71[0] + 64);
  v68.x = a2;
  v68.y = a3;
  EXFORMOBJ::vQuickInit((EXFORMOBJ *)v102, (struct XDCOBJ *)v71, 0x204u);
  v22 = 1;
  if ( (unsigned int)EXFORMOBJ::bXform((EXFORMOBJ *)v102, &v68) )
  {
    v23 = *(_QWORD *)(v21 + 48);
    v24 = *(_QWORD *)(v21 + 120);
    v25 = *((_QWORD *)v71[0] + 12);
    if ( (*(_DWORD *)(*((_QWORD *)v71[0] + 6) + 56LL) & 0x80u) != 0
    ...
    v30 = (BRUSHOBJ *)((char *)v71[0] + 1560);
    v31 = *((_QWORD *)v71[0] + 10);
    v32 = (*((_BYTE *)v71[0] + 112) & 5) != 0;
    v78 = (BRUSHOBJ *)((char *)v71[0] + 1560);
    v33 = *(_DWORD *)(v31 + 8);
    v72 = v32 ? 2 : 0;
    if ( (v33 & 1) != 0 || (*((_DWORD *)v71[0] + 83) & 1) != 0 )
    {
      *(_DWORD *)(v31 + 8) = v33 & 0xFFFFFFFE;
      *((_DWORD *)v71[0] + 83) &= ~1u;
      EBRUSHOBJ::vInitBrush(v30, v71[0], *((_QWORD *)v71[0] + 18), v25, v24, v21, 1);
      v28 = v71[0];
      v30 = v78;
    }
    ...
    if ( (v111[24] & 1) == 0 )
    {
      v22 = XDCOBJ::bFullScreen((XDCOBJ *)v71);
LABEL_107:
      v9 = v22;
      goto LABEL_108;
    }
    ...
    v68.x += *(_DWORD *)v34;
    v68.y += *((_DWORD *)v34 + 1);
    v74 = XDCOBJ::prgnEffRao((XDCOBJ *)v71);
    if ( RGNOBJ::bInside((RGNOBJ *)&v74, &v68) == 2 )
    {
      v83 = 0;
      v84 = 0LL;
      v85 = 0uLL;
      ...
      v81 = 0;
      v82 = 0;
      *(_QWORD *)v70 = *(_QWORD *)(v21 + 48);
      PDEVOBJ::vSync((PDEVOBJ *)v70, (struct _SURFOBJ *)(v21 + 24), 0LL, 0);
      v75 = 0;
      v35 = *(struct _RECTL *)((char *)v74 + 88);
      v112 = v35;
      if ( !*(_WORD *)(v21 + 100) && (unsigned int)RGNOBJ::iComplexity((RGNOBJ *)&v74) != 3 )
      {
        v36 = *(_QWORD *)(v21 + 80);
        v37 = *(_DWORD *)(v21 + 88);
        v38 = *(_DWORD *)(v21 + 96);
      ...
      *(_QWORD *)((char *)&v85 + 4) = 0LL;
      ...
      v73.x = -v112.left;
      v73.y = -v112.top;
      if ( !v43 || (unsigned int)RGNOBJ::iComplexity((RGNOBJ *)&v74) != 3 )
      {
        v112.right += v47;
        v112.left = v47 + left;
        v112.bottom += v48;
...
LABEL_59:
          ...
          if ( !v56 && v54 == v29 || v56 == 1 && v54 != v29 )
            goto LABEL_104;
          FLOODBM::vFindExtent((FLOODBM *)&v96, v55, &v72, v70);
          v57 = v70[0];
          STACKMEMOBJ::STACKMEMOBJ((STACKMEMOBJ *)v92, 0x1B8u, 1u, y, v72, v70[0]);
          if ( !v95 )
          {
            EngSetLastError(8u);
LABEL_103:
          ...
          if ( v58 )
          {
            ...
            do
            {
              while ( 1 )
              {
                while ( v89 )
                {
                  if ( !RGNMEMOBJ::bMergeScanline((RGNMEMOBJ *)v79, (struct STACKOBJ *)v88) )
                    goto LABEL_98;
                  if ( *(_DWORD *)v90 >= v59 )
                  {
                    v89 -= *(_DWORD *)(v90 + 8);
...
LABEL_98:
                ...
                if ( !v93 )
                  goto LABEL_84;
                v58 &= RGNMEMOBJ::bMergeScanline((RGNMEMOBJ *)v79, (struct STACKOBJ *)v92);
                if ( *(_DWORD *)v94 > v70[0] )
                  break;
                v93 -= *(_DWORD *)(v94 + 8);
                v94 = *(_QWORD *)(v94 + 16);
...
LABEL_84:
            ...
            {
              if ( v75
                && (!RGNOBJ::bOffset((RGNOBJ *)v79, &v73) || !(unsigned int)ERECTL::bOffsetAdd((ERECTL *)&v112, &v73)) )
              {
                goto LABEL_101;
              }
              v61 = v78;
              ...
              ++*(_DWORD *)(v21 + 92);
              mix = v62;
              ECLIPOBJ::ECLIPOBJ((ECLIPOBJ *)&pco, v79[0], (struct ERECTL *)&v112, 0);
              v65 = (POINTL *)v71[0];
              if ( (*((_DWORD *)v71[0] + 9) & 0xE0) != 0 )
              {
                XDCOBJ::vAccumulate((XDCOBJ *)v71, v64, (struct ERECTL *)&v112);
                XDCOBJ::vAccumulateTight((XDCOBJ *)v71, v66, &v112);
                v65 = (POINTL *)v71[0];
              }
              v58 = EngPaint((SURFOBJ *)(v21 + 24), &pco, v61, v65 + 194, mix);
            }
            if ( v58 )
              goto LABEL_100;
          }
...
LABEL_104:
      ...
      if ( !v76[0]
        ...
        || (RGNOBJ::vSet((RGNOBJ *)v76, &v112),
            !RGNOBJ::bMerge((RGNOBJ *)v87, (struct RGNOBJ *)v76, (struct RGNOBJ *)&v74, BYTE4(gafjRgnOp))) )
      {
LABEL_54:
        RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v87);
        RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v76);
      ...
      if ( !RGNOBJ::bOffset((RGNOBJ *)v87, &v73) || !(unsigned int)ERECTL::bOffsetAdd((ERECTL *)&v112, &v73) )
      {
        RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v87);
        RGNMEMOBJTMP::~RGNMEMOBJTMP((RGNMEMOBJTMP *)v76);
        goto LABEL_104;
