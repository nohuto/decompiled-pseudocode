/*
 * XREFs of ?xxxUserNotifyProcessCreate@@YAJKK_KK@Z @ 0x1C00ECA24
 * Callers:
 *     NtUserNotifyProcessCreate @ 0x1C00EC9B0 (NtUserNotifyProcessCreate.c)
 * Callees:
...
__int64 __fastcall xxxUserNotifyProcessCreate(int a1, int a2, __int64 a3, int a4)
{
  ...
  if ( (a4 & 0xB) != 0 )
  {
    ...
    if ( (int)result >= 0 )
    {
      xxxSetProcessInitState(Object, (v5 & 1) != 0 ? 64 : 128);
      if ( (v5 & 8) != 0 )
      {
      ...
      result = LockThreadByClientId(v8, (PETHREAD *)&v14);
      if ( (int)result >= 0 )
      {
        W32GetThreadWin32Thread((__int64)v14);
LABEL_11:
