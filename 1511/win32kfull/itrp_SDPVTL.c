/*
 * XREFs of itrp_SDPVTL @ 0x1C00B37E0
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( (unsigned int)CHECK_ELEMENT_EP_PTR_ALLOW_OUTOF_BOUND(&LocalGS, qword_1C0323DF8) )
        {
          ...
          if ( v16 < 1 || v16 > v7 || (int)v6 < v15 + *(__int16 *)(*(_QWORD *)(v14 + 64) + 2LL * v16 - 2) + 1 )
          {
            ...
            itrp_Normalize(
              ...
              &dword_1C0323E08);
            itrp_Normalize(
              (unsigned int)(*(_DWORD *)(*(_QWORD *)(qword_1C0323DF8 + 16) + 4 * v6)
                           - *(_DWORD *)(*(_QWORD *)(qword_1C0323E00 + 16) + 4 * v4)),
              (unsigned int)(*(_DWORD *)(*(_QWORD *)(qword_1C0323DF8 + 24) + 4 * v6)
                           - *(_DWORD *)(*(_QWORD *)(qword_1C0323E00 + 24) + 4 * v4)),
              &dword_1C0323E10);
            if ( (a2 & 1) != 0 )
            {
              v17 = -HIWORD(dword_1C0323E08);
              HIWORD(dword_1C0323E08) = dword_1C0323E08;
              LOWORD(dword_1C0323E08) = v17;
              v18 = -HIWORD(dword_1C0323E10);
              HIWORD(dword_1C0323E10) = dword_1C0323E10;
              LOWORD(dword_1C0323E10) = v18;
            }
            itrp_ComputeAndCheck_PF_Proj();
            dword_1C0323E5C = 1;
            dword_1C0323E60 = 1;
            v19 = *(_WORD *)(qword_1C0323E30 + 452);
            if ( (v19 & 1) == 0 )
              goto LABEL_32;
            if ( (v19 & 4) != 0 )
            {
              if ( (_WORD)dword_1C0323E08 != 0x4000 )
                goto LABEL_37;
              v21 = HIWORD(dword_1C0323E08) == 0;
            }
            else
            {
              if ( HIWORD(dword_1C0323E08) != 0x4000 )
                goto LABEL_37;
              v21 = (_WORD)dword_1C0323E08 == 0;
            }
            if ( v21 )
            {
LABEL_32:
