/*
 * XREFs of xxxWaitForInputIdle @ 0x1C00E296C
 * Callers:
 *     NtUserWaitForInputIdle @ 0x1C00E2920 (NtUserWaitForInputIdle.c)
 * Callees:
 ...
 *     WaitOnPseudoEvent @ 0x1C00E2AB0 (WaitOnPseudoEvent.c)
...
unsigned int __fastcall xxxWaitForInputIdle(HANDLE a1, unsigned int a2, int a3)
{
  ...
  if ( !a3 )
  {
    if ( (PsGetThreadProcessId((PETHREAD)*gptiCurrent) != a1
       || gptiCurrent != *(_QWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 304LL))
