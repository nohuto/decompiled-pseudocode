/*
 * XREFs of ?TextOutBitBlt@@YAXPEAVSURFACE@@AEAVRFONTOBJ@@PEAU_SURFOBJ@@2PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@6PEAU_BRUSHOBJ@@6K@Z @ 0x1C010F4B8
 * Callers:
        ...
        struct _POINTL *a11)
{
  ...
  struct _RECTL *v24; // [rsp+78h] [rbp-41h]
  struct _BRUSHOBJ *v25; // [rsp+80h] [rbp-39h]
  ...
  {
    v19 = UMPDReleaseRFONTSem(a2, 0LL, &v21, &v20, &v22);
    v13 = v21;
    v15 = v19;
    v14 = v20;
    v11 = v22;
