/*
 * XREFs of ?UMPDDrvQueryDeviceSupport@@YAHPEAU_SURFOBJ@@PEAU_XLATEOBJ@@PEAU_XFORMOBJ@@KKPEAXK3@Z @ 0x1C029ED50
 * Callers:
 *     <none>
 * Callees:
...
LABEL_2:
  ...
  if ( v10 )
  {
    ...
    if ( (!v16 || (unsigned int)UMPDOBJ::ThunkMemBlock(v12, (const void **)&Src[7], v16))
      ...
      && (unsigned int)UMPDOBJ::ThunkDDIOBJ(v12, (UMPDOBJ *)((char *)v12 + 272), (const void **)&Src[5], 4u)
