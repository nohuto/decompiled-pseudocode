/*
 * XREFs of ?bWiden@WIDENER@@IEAAHXZ @ 0x1C0131798
 * Callers:
 ...
 *     ?vNextEvent@LINER@@QEAAXXZ @ 0x1C0132254 (-vNextEvent@LINER@@QEAAXXZ.c)
 *     ?efNextStyleLength@STYLER@@IEAA?AVEFLOAT@@XZ @ 0x1C02C70B0 (-efNextStyleLength@STYLER@@IEAA-AVEFLOAT@@XZ.c)
 *     ?efWorldLength@STYLER@@IEAA?AVEFLOAT@@VEVECTORFX@@@Z @ 0x1C02C70E8 (-efWorldLength@STYLER@@IEAA-AVEFLOAT@@VEVECTORFX@@@Z.c)
 ...
 *     ?vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ @ 0x1C02C7A04 (-vPrependBeforeFigure@WIDEPATHOBJ@@QEAAXXZ.c)
 *     ?vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ @ 0x1C02C7A68 (-vPrependBeforeSubpath@WIDEPATHOBJ@@QEAAXXZ.c)
 */
