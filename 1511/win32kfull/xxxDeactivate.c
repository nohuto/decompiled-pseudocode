/*
 * XREFs of xxxDeactivate @ 0x1C008C738
 * Callers:
...
__int64 __fastcall xxxDeactivate(__int64 a1, int a2, char a3)
{
  ...
  if ( v9 )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v40;
    v40[1] = v9;
    ++*(_DWORD *)(v9 + 8);
    xxxSendMessage(*(struct tagWND **)(*(_QWORD *)(a1 + 384) + 64LL), 0x1Fu, 0LL, 0LL);
  ...
  if ( v10 )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = &v38;
    ...
    if ( (a3 & 1) == 0 && !xxxSendMessage((struct tagWND *)v10, 0x86u, 0LL, 0LL) )
    {
      ...
      result = PopAndFreeW32ThreadLock((__int64)v42);
      goto LABEL_28;
    }
    ...
    if ( v17 == v10 )
    {
      ...
      HMAssignmentUnlock(*(_QWORD *)(a1 + 384) + 80LL);
    }
    SetOrClrWF(0, (_DWORD *)v10, 0x40u, 1);
    PostIAMShellHookMessageEx(*(_QWORD *)(gptiCurrent + 408LL), 0x25u, *(_QWORD *)v10);
    ThreadUnlock1(v19, v18);
    if ( (*(_BYTE *)(v11 + 440) & 1) != 0 )
      v11 = 0LL;
    v35 = v11;
    PopAndFreeW32ThreadLock((__int64)v42);
    v20 = v11;
    v4 = a2;
  }
  else
  ...
  *(_QWORD *)(gptiCurrent + 368LL) = &v38;
  ...
  if ( (a3 & 1) != 0 || xxxSendMessage((struct tagWND *)v10, 0x86u, 0LL, 0LL) )
  {
    ...
    if ( v34 == v10 )
    {
      ...
      result = HMAssignmentUnlock(*(_QWORD *)(a1 + 384) + 80LL);
    }
LABEL_21:
    v25 = (_QWORD *)(*(_QWORD *)(a1 + 384) + 72LL);
    if ( !*v25 )
      goto LABEL_28;
...
LABEL_28:
  ...
  if ( a1 != gptiCurrent )
    return PopAndFreeW32ThreadLock((__int64)v43);
  return result;
}
