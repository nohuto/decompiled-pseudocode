/*
 * XREFs of xxxRemoteStopScreenUpdates @ 0x1C009D96C
 * Callers:
 *     xxxRemoteDisconnect @ 0x1C009DC30 (xxxRemoteDisconnect.c)
 *     xxxRemoteReconnect @ 0x1C014DAC0 (xxxRemoteReconnect.c)
 *     xxxRemotePassthruEnable @ 0x1C02039A0 (xxxRemotePassthruEnable.c)
 *     xxxRemoteShadowSetup @ 0x1C0203AB0 (xxxRemoteShadowSetup.c)
 *     xxxRemoteShadowStop @ 0x1C0203B00 (xxxRemoteShadowStop.c)
 *     NtUserRemoteStopScreenUpdates @ 0x1C021F3C0 (NtUserRemoteStopScreenUpdates.c)
 * Callees:
  ...
  if ( !gbFreezeScreenUpdates )
  {
    ...
    if ( gspdeskDisconnect )
    {
      ...
      if ( (((unsigned __int8)v0 ^ v2) & 2) != 0 )
        xxxButtonEvent(2u, gptCursorAsync, 0LL, 1u, v1, v3, 0LL, 0LL, 0LL, 0, 0, 0, 0, 0, 0LL, v7);
      v4 = 0LL;
      gwMKButtonState = v0;
      v9 = 0LL;
      v5 = 0;
