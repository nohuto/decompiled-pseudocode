/*
 * XREFs of ?bComputeGISET@@YAHPEAU_IFIMETRICS@@PEAVPFE@@PEAPEAU_GISET@@@Z @ 0x1C00170B0
 * Callers:
 ...
 * Callees:
 *     ?cComputeGISET@@YAKPEAGKPEAU_GISET@@K@Z @ 0x1C0013CF0 (-cComputeGISET@@YAKPEAGKPEAU_GISET@@K@Z.c)
...
__int64 __fastcall bComputeGISET(struct _IFIMETRICS *a1, struct PFE *a2, struct _GISET **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( v9 == gppdevTrueType || v9 == (struct PDEV *)qword_1C032F218 && !*(_DWORD *)(*(_QWORD *)(v5 + 80) + 8LL) )
  {
    v10 = 1;
  }
  else
  ...
  if ( !v10 )
  {
    if ( !dpwszFamilyName )
    {
      ...
      if ( v14 <= 0xFFFFFFFF )
      {
        v15 = PALLOCMEM2((unsigned int)v14);
        v16 = (void *)v15;
        if ( v15 )
        {
          v17 = (_WORD *)v15;
          ...
          v25 = (struct _GISET *)PALLOCMEM2((unsigned int)(4 * v24 + 8));
          v26 = v25;
          if ( v25 )
          {
