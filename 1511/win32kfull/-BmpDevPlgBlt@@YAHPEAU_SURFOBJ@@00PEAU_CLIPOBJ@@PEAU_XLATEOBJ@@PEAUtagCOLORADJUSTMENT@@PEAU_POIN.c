/*
 * XREFs of ?BmpDevPlgBlt@@YAHPEAU_SURFOBJ@@00PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAUtagCOLORADJUSTMENT@@PEAU_POINTL@@PEAU_POINTFIX@@PEAU_RECTL@@4K@Z @ 0x1C028CD20
 * Callers:
 *     <none>
 * Callees:
        ...
        if ( v19 )
        {
          do
          {
            ...
            if ( v20 )
            {
              ...
              {
                if ( *(_QWORD *)(*(_QWORD *)(v20 + 1816) + 624LL) )
                {
                  ...
                  (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, struct _SURFOBJ *, struct _CLIPOBJ *, struct _XLATEOBJ *, struct tagCOLORADJUSTMENT *, struct _POINTL *, struct _POINTFIX *, struct _RECTL *, struct _POINTL *, unsigned int))(v22 + 624))(
                    v25,
                    v24,
                    DevBitmap,
                    a4,
