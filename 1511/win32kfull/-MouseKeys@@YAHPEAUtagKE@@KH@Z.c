/*
 * XREFs of ?MouseKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C01EDE30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MouseKeys(struct tagKE *a1)
{
  ...
  {
    if ( (xmmword_1C032229C & 4) != 0 && v1 == gNumLockVk && (*((_WORD *)a1 + 1) & 0x8000) == 0 && v3 == 17 )
    {
      gMKPreviousVk = *((_BYTE *)a1 + 2);
      if ( (xmmword_1C032229C & 0x10) != 0 )
      {
        v4 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(grpdeskRitInput + 24LL) + 24LL) + 16LL);
        PostEventMessageEx(v4, *(_QWORD *)(v4 + 384), 0xEu, 0LL, 0, 0LL, 0LL, 0LL);
      }
  ...
  if ( v2 )
  {
    if ( gMKPreviousVk == v1 )
    {
      ...
      {
        FindTimer(0LL, gtmridMKMoveCursor, 4u, 1, 0LL);
        v11 = gNumLockVk;
  ...
  else
  {
    ...
    gMKPreviousVk = v1;
    return off_1C02EA1E0[v8](word_1C02EAA70[v8]);
  }
}
