/*
 * XREFs of ?MulCopyBits@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@PEAU_POINTL@@@Z @ 0x1C0295040
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( ((_DWORD)hdev[538] & 0x8000) == 0 )
      {
        ...
        if ( (unsigned int)IsMetaDevBitmapForMirroring(a1) )
        {
          ...
          if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 112) & 0x400) != 0 )
            v13 = (*(__int64 (__fastcall **)(__int64, struct _SURFOBJ *, __int64, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))(*(_QWORD *)(v22 + 56) + 2872LL))(
                    v26,
                    v23,
                    v24,
                    a4,
...
LABEL_16:
        if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 112) & 0x400) != 0 )
          v15 = (*(__int64 (__fastcall **)(_QWORD, struct _SURFOBJ *, __int64, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))(*(_QWORD *)(v22 + 56) + 2872LL))(
      ...
      if ( ((_DWORD)hdev[538] & 0x8000) == 0 || *(_WORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 100) )
      {
        ...
        v16 = (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(v23) + 112) & 0x400) != 0
            ? (*(__int64 (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, __int64, struct _XLATEOBJ *, struct _RECTL *, struct _POINTL *))(*(_QWORD *)(v22 + 56) + 2872LL))(
                a1,
                v23,
                v24,
                a4,
