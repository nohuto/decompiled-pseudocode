/*
 * XREFs of itrp_FLIPRGON @ 0x1C013E590
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_FLIPRGON(__int64 a1)
{
  ...
  v20 = qword_1C0323E18 - 4;
  v4 = *(_DWORD *)(qword_1C0323E18 - 4);
  v5 = *(_WORD **)(qword_1C0323E30 + 344);
  v17 = v5;
  LOWORD(v6) = v5[4];
  v7 = v5[6];
  ...
  {
    if ( v4 >= *(_DWORD *)(qword_1C0323E30 + 440) || v4 < 0 )
      goto LABEL_37;
    v19 = 4;
  }
