/*
 * XREFs of ?TransformHimetricDeltaToScreenDelta@@YAXPEAUtagHID_POINTER_DEVICE_INFO@@UtagPOINT@@PEAU2@@Z @ 0x1C01F2918
 * Callers:
        ...
        struct tagPOINT *a3)
{
  ...
  if ( (*(_DWORD *)(PsGetCurrentProcessWin32Process(a1) + 776) & 0x2000) != 0
    ...
    || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
      ? (v5 = 0LL)
      : (v5 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
                        + 244LL) & 1),
        !(_DWORD)v5) )
  {
    if ( (*(_DWORD *)(PsGetCurrentProcessWin32Process(v5) + 776) & 0x2000) != 0
      && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
        ...
        : (v7 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
          ...
          v7) )
    {
      v6 = (__m128i *)(*((_QWORD *)a1 + 35) + 60LL);
    }
    else
    {
      v6 = (__m128i *)(*((_QWORD *)a1 + 35) + 28LL);
    }
  }
  else
  {
    v6 = (__m128i *)(*((_QWORD *)a1 + 35) + 44LL);
  }
  v8 = *v6;
  v9 = EngMulDiv(a2.x, _mm_cvtsi128_si32(_mm_srli_si128(*v6, 8)) - _mm_cvtsi128_si32(*v6), *((_DWORD *)a1 + 37));
  v10 = *((_DWORD *)a1 + 38);
  a3->x = v9;
  a3->y = EngMulDiv(a2.y, _mm_cvtsi128_si32(_mm_srli_si128(v8, 12)) - _mm_cvtsi128_si32(_mm_srli_si128(v8, 4)), v10);
}
