/*
 * XREFs of ?xxxForceSizeRecToDockTarget@@YAHPEAU_MOVESIZEDATA@@W4eTHRESHOLD_MARGIN_DIRECTION@@PEAUtagMONITOR@@PEAKPEAUtagRECT@@PEAPEAUtagCHECKPOINT@@@Z @ 0x1C0207A2C
 * Callers:
        ...
        struct tagCHECKPOINT **a6)
{
  ...
  if ( v11 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
  {
    if ( v11 != 1
      || (v12 = a3 + 54, (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v10 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0) )
    {
      v12 = a3 + 38;
    }
  }
