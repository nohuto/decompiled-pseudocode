/*
 * XREFs of GetDeviceButtons @ 0x1C01CC804
 * Callers:
 ...
 * Callees:
 *     PbuttonToCursor @ 0x1C01CDE5C (PbuttonToCursor.c)
 *     AllocatePTPButtons @ 0x1C01D0754 (AllocatePTPButtons.c)
 */
...
__int64 __fastcall GetDeviceButtons(__int64 a1, struct _HIDP_PREPARSED_DATA *a2, _WORD *a3, unsigned int a4)
{
  ...
  if ( !v26 )
    v10 = *(_WORD *)(a1 + 732);
  ButtonCaps = (struct _HIDP_BUTTON_CAPS *)Win32AllocPool(72 * v4);
  if ( !ButtonCaps )
  {
  ...
  *(_DWORD *)(a1 + 312) = ButtonCapsLength;
  if ( (unsigned int)(v13 - 6) > 1 )
  {
    v15 = *(unsigned int *)(a1 + 720);
    *(_DWORD *)(a1 + 308) = v15;
    if ( v13 == 8 )
      SpecificButtonCaps = AllocatePTPButtons(a1, ButtonCaps, (unsigned int)v14);
    else
      *(_QWORD *)(a1 + 328) = Win32AllocPoolZInit(12 * v15, 2019849045LL);
    if ( SpecificButtonCaps >= 0 && *(_QWORD *)(a1 + 328) )
    {
      v16 = 0;
      if ( *(_DWORD *)(a1 + 308) )
      {
        ...
        do
        {
          ...
          ++v16;
          v19 = 3 * v18;
          *(_DWORD *)(*(_QWORD *)(a1 + 328) + 4 * v19 + 4) = v17;
          *(_DWORD *)(*(_QWORD *)(a1 + 328) + 4 * v19) = 1;
        }
        while ( v16 < *(_DWORD *)(a1 + 308) );
        g_ulNextCursor = v17;
      }
      goto LABEL_35;
    }
...
LABEL_33:
  ...
  *(_DWORD *)(v21 + 4) = v31;
  **(_DWORD **)(a1 + 328) = ((__int64 (*)(void))PbuttonToCursor)();
  if ( v8 > v28 )
  {
    *(_DWORD *)(*(_QWORD *)(a1 + 328) + 16LL) = v32;
    *(_DWORD *)(*(_QWORD *)(a1 + 328) + 12LL) = PbuttonToCursor(69LL);
  }
LABEL_35:
...
LABEL_38:
  ...
  {
    v29 = Win32AllocPool(2LL * *(unsigned int *)(a1 + 312));
    *(_QWORD *)(a1 + 1416) = v29;
    if ( !v29 )
