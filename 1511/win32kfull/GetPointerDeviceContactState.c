/*
 * XREFs of GetPointerDeviceContactState @ 0x1C01CCC50
 * Callers:
 ...
 *     SqmPointerDeviceDown @ 0x1C01CE5B0 (SqmPointerDeviceDown.c)
        ...
        _DWORD *a9)
{
  ...
  *(_DWORD *)(v13 + v12 + 2248) = v11;
  if ( *(_DWORD *)(v10 + 720) == 1 && (*(_DWORD *)(v10 + 252) & 0x80u) == 0 )
    *a3 = *(_WORD *)(*(_QWORD *)(v10 + 328) + 4LL);
...
LABEL_15:
          ...
          *(_DWORD *)(v13 + v19 + 2392) |= 2u;
          v20 = *(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392);
          ...
          else
          {
            ...
            *((_DWORD *)a3 + 5) |= 0x10014u;
            if ( (*(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) & 1) != 0 )
              dword_1C032BAEC = 1;
            else
    ...
    v23 = 1;
    if ( (unsigned int)(*(_DWORD *)(v10 + 24) - 1) <= 4 && (*(_DWORD *)(v10 + 252) & 0x10) == 0 )
      *((_DWORD *)a3 + 5) |= 0x4000u;
    if ( (unsigned int)(*(_DWORD *)(v10 + 24) - 6) > 1 )
    {
LABEL_45:
      if ( *(_DWORD *)(v10 + 720) == 1 && (*(_DWORD *)(v10 + 252) & 0x80u) == 0 )
        *(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2332) = *a3;
      if ( !v46 )
      {
        if ( (*(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) & 4) != 0 )
        {
          if ( (unsigned int)(*(_DWORD *)(v10 + 24) - 6) <= 1 && gSqmPenDownCount )
            --gSqmPenDownCount;
          *((_DWORD *)a3 + 5) |= 0x40000u;
          if ( (unsigned int)IsFrameReportingPointerDevice(v10)
            && ((unsigned __int8)*(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) & (unsigned __int8)v27) != 0 )
          {
            *(_DWORD *)(*(_QWORD *)(v10 + 712) + 56LL) = v27;
          }
          *(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) &= ~2u;
          v28 = *(unsigned int *)(v13 + *(_QWORD *)(v10 + 696) + 2392);
        ...
        v29 = *(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392);
        if ( (v29 & 4) == 0 && (v29 & 1) != 0 && !dword_1C0323FA4 )
          dword_1C032BAEC = 0;
        *(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) &= ~4u;
      }
      if ( (*(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) & 1) != 0 )
        *((_DWORD *)a3 + 5) |= 0x2000u;
      v30 = 0x10000LL;
      ...
      if ( (unsigned int)(*(_DWORD *)(v10 + 24) - 6) <= 1 )
      {
        ...
        if ( (v32 & 0x10000) != 0 )
        {
          *(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) ^= (*(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) ^ (16 * (a3[52] & 1))) & 0x10;
        }
        else if ( (v32 & 0x40000) != 0 )
        {
          *(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) &= ~0x10u;
        }
        if ( (*(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) & 0x10) != 0 )
        {
          v33 = *((_DWORD *)a3 + 5);
          if ( (v33 & 4) != 0 )
...
LABEL_96:
          ...
          if ( (v38 & 2) == 0 && !v36 )
          {
            ...
            *v49 = 1;
            ...
            if ( *(_QWORD *)(v10 + 712) )
              *(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) |= 0x400u;
            else
      ...
      if ( (v35 & 0x20) == 0 )
      {
        ...
        if ( !(_DWORD)v30 )
          v31 = 3221225628LL;
        if ( (*(_DWORD *)(v13 + *(_QWORD *)(v10 + 696) + 2392) & 0x20) != 0 )
        {
