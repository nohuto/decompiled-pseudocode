/*
 * XREFs of ReadDefaultAccelerationCurves @ 0x1C010FF1C
 * Callers:
...
__int64 __fastcall ReadDefaultAccelerationCurves(__int64 a1)
{
  ...
  else
  {
    if ( gbNewMouseInit )
      goto LABEL_5;
    v4 = xmmword_1C0320040;
    v5 = xmmword_1C0320050;
    v6 = qword_1C0320060;
    v7 = xmmword_1C0320018;
    v8 = xmmword_1C0320028;
    v9 = qword_1C0320038;
  }
  qword_1C0322078 = v9;
  xmmword_1C0322068 = v8;
  gDefyTxfTP = v7;
  qword_1C0322050 = v6;
  xmmword_1C0322040 = v5;
  gDefxTxfTP = v4;
  qword_1C03220C8 = v9;
  xmmword_1C03220B8 = v8;
  gDefyTxf = v7;
  qword_1C03220A0 = v6;
  xmmword_1C0322090 = v5;
  gDefxTxf = v4;
LABEL_5:
  gbNewMouseInit = 1;
  return result;
