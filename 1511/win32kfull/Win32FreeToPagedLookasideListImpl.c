/*
 * XREFs of Win32FreeToPagedLookasideListImpl @ 0x1C00C38F0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall Win32FreeToPagedLookasideListImpl(__int64 a1, struct _SLIST_ENTRY *a2)
{
...
LABEL_5:
  ...
  v2 = a2 - 1;
  v8 = 0LL;
  result = NSInstrumentation::CPointerHashTable::Remove(v7, &a2[-1], (void **)&v8);
  if ( result )
  {
