/*
 * XREFs of FindBestPos @ 0x1C0134B7C
 * Callers:
        ...
        unsigned __int64 a9)
{
  ...
  if ( a7 )
  {
    ...
    if ( v13 )
    {
      if ( v16 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
      {
        if ( v16 == 1 && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 408LL) + 8LL) + 244LL) & 1) != 0 )
    ...
    else if ( v16 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
    {
      if ( v16 == 1 && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 408LL) + 8LL) + 244LL) & 1) != 0 )
        v15 = a8 + 34;
    }
    ...
    if ( v16 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
    {
      if ( v16 != 1
        || (p_bottom = &a8[6].bottom,
            (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v14 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0) )
      {
  ...
  else
  {
               ...
               !(_DWORD)v26) )
    {
      if ( (*(_DWORD *)(PsGetCurrentProcessWin32Process(v26) + 776) & 0x2000) != 0 )
      {
        v26 = *(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
