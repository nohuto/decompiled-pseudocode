/*
 * XREFs of ?PanUnlockDisplayArea@@YAXPEAUDHPDEV__@@PEAU_RECTL@@@Z @ 0x1C02892F0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?ShadowUnLock@@YAXPEAU_PANDEV@@@Z @ 0x1C0289410 (-ShadowUnLock@@YAXPEAU_PANDEV@@@Z.c)
 */
...
void __fastcall PanUnlockDisplayArea(struct DHPDEV__ *a1, struct _RECTL *a2)
{
  ...
  _DWORD v15[4]; // [rsp+30h] [rbp-10h] BYREF
