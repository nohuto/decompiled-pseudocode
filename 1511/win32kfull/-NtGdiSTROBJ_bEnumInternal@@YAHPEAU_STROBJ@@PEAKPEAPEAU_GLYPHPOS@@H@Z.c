/*
 * XREFs of ?NtGdiSTROBJ_bEnumInternal@@YAHPEAU_STROBJ@@PEAKPEAPEAU_GLYPHPOS@@H@Z @ 0x1C02A9654
 * Callers:
 *     NtGdiSTROBJ_bEnum @ 0x1C02AEBD0 (NtGdiSTROBJ_bEnum.c)
 *     NtGdiSTROBJ_bEnumPositionsOnly @ 0x1C02AEBE0 (NtGdiSTROBJ_bEnumPositionsOnly.c)
 * Callees:
 ...
 *     STROBJ_bEnumPositionsOnly @ 0x1C02B6790 (STROBJ_bEnumPositionsOnly.c)
 */
