 ...
 * Callees:
 *     ?PlatformFree@NSInstrumentation@@YAXPEAX@Z @ 0x1C00EC9A0 (-PlatformFree@NSInstrumentation@@YAXPEAX@Z.c)
 *     I_PlaySoundkPostMessage @ 0x1C00F0C88 (I_PlaySoundkPostMessage.c)
 *     PlaySndClient_midl_user_allocate @ 0x1C00F0CD0 (PlaySndClient_midl_user_allocate.c)
 */
