/*
 * XREFs of FindNCHit @ 0x1C0102F28
 * Callers:
...
LABEL_9:
      if ( IsDPIDWMSysMet(8uLL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
          ? (v12 = 0)
          : (v12 = v9 & *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                              + 8LL)
                                  + 244LL)),
            v12) )
      {
      ...
      if ( (unsigned int)IsDPIAbsoluteSysMet(0x2DuLL) )
      {
          ...
          || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v59) + 776) & 0x4000) != 0 )
        {
          goto LABEL_110;
             ...
             || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
               ? (v64 = 0)
               : (v64 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                              + 8LL)
                                  + 244LL) & 1),
                 !v64) )
      {
...
LABEL_133:
      if ( IsDPIDWMSysMet(2uLL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
          ? (v71 = 0)
          : (v71 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                         + 8LL)
                             + 244LL) & 1),
            v71) )
      {
  ...
  if ( (unsigned int)IsDPIAbsoluteSysMet(2uLL) )
  {
      ...
      || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v77) + 776) & 0x4000) != 0 )
    {
      goto LABEL_153;
         ...
         || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
           ? (v82 = 0)
           : (v82 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                          + 8LL)
                              + 244LL) & 1),
             !v82) )
  {
  ...
  if ( (unsigned int)IsDPIAbsoluteSysMet(3uLL) )
  {
      ...
      || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v85) + 776) & 0x4000) != 0 )
    {
      goto LABEL_174;
         ...
         || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
           ? (v90 = 0)
           : (v90 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                          + 8LL)
                              + 244LL) & 1),
             !v90) )
  {
    ...
    if ( (unsigned int)IsDPIAbsoluteSysMet(0x2EuLL) )
    {
        ...
        || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v182) + 776) & 0x4000) != 0 )
      {
        goto LABEL_426;
           ...
           || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
             ? (v187 = 0)
             : (v187 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                             + 8LL)
                                 + 244LL) & 1),
               !v187) )
    {
LABEL_426:
      if ( IsDPIDWMSysMet(0x2EuLL)
        ...
        && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
          ? (v184 = 0)
          : (v184 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                          + 8LL)
                              + 244LL) & 1),
            v184) )
      {
      ...
      if ( (unsigned int)IsDPIAbsoluteSysMet(0x2DuLL) )
      {
          ...
          || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v190) + 776) & 0x4000) != 0 )
        {
          goto LABEL_445;
             ...
             || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
               ? (v195 = 0)
               : (v195 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                               + 8LL)
                                   + 244LL) & 1),
                 !v195) )
      {
LABEL_445:
        if ( IsDPIDWMSysMet(0x2DuLL)
          ...
          && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
            ? (v192 = 0)
            : (v192 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                            + 8LL)
                                + 244LL) & 1),
              v192) )
        {
...
LABEL_195:
  if ( IsDPIDWMSysMet(6uLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
      ? (v95 = 0)
      : (v95 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
                         + 244LL) & 1),
        v95) )
  {
...
LABEL_214:
  if ( IsDPIDWMSysMet(5uLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
      ? (v103 = 0)
      : (v103 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
                          + 244LL) & 1),
        v103) )
  {
      ...
      if ( (unsigned int)IsDPIAbsoluteSysMet(0x34uLL) )
      {
          ...
          || (*(_DWORD *)(PsGetCurrentProcessWin32Process(v123) + 776) & 0x4000) != 0 )
        {
          goto LABEL_256;
             ...
             || (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
               ? (v128 = 0)
               : (v128 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                               + 8LL)
                                   + 244LL) & 1),
                 !v128) )
      {
LABEL_256:
        if ( IsDPIDWMSysMet(0x34uLL)
          ...
          && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
            ? (v125 = 0)
            : (v125 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
                                            + 8LL)
                                + 244LL) & 1),
              v125) )
        {
...
LABEL_275:
  if ( IsDPIDWMSysMet(0x1FuLL)
    ...
    && (!*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408)
      ? (v133 = 0)
      : (v133 = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(W32GetThreadWin32Thread((__int64)KeGetCurrentThread()) + 408) + 8LL)
                          + 244LL) & 1),
        v133) )
  {
