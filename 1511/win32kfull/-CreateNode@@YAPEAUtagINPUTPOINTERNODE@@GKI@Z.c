/*
 * XREFs of ?CreateNode@@YAPEAUtagINPUTPOINTERNODE@@GKI@Z @ 0x1C01FC4E0
 * Callers:
...
struct tagINPUTPOINTERNODE *__fastcall CreateNode(__int16 a1, unsigned int a2, unsigned int a3)
{
  ...
  if ( !v6 )
    return 0LL;
  v7 = word_1C032F148++;
  if ( (unsigned __int16)word_1C032F148 < 2u )
    word_1C032F148 = 2;
  *(_WORD *)(v6 + 32) = v7;
  *(_WORD *)(v6 + 34) = a1;
  *(_DWORD *)(v6 + 40) = a2;
  ...
  *(_DWORD *)(v6 + 152) = v8 | 0x480;
  ...
  v10 = qword_1C03277E0;
  *(_QWORD *)v6 = qword_1C03277E0;
  *(_QWORD *)(v6 + 8) = &qword_1C03277E0;
  if ( *(__int64 **)(v10 + 8) != &qword_1C03277E0 )
    __fastfail(3u);
  *(_QWORD *)(v10 + 8) = v6;
  v11 = qword_1C03277F0;
  qword_1C03277E0 = v6;
  *(_QWORD *)(v6 + 16) = qword_1C03277F0;
  *(_QWORD *)(v6 + 24) = &qword_1C03277F0;
  if ( *(__int64 **)(v11 + 8) != &qword_1C03277F0 )
    __fastfail(3u);
  *(_QWORD *)(v11 + 8) = v6 + 16;
  qword_1C03277F0 = v6 + 16;
