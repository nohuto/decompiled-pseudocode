/*
 * XREFs of ?xxxTA_AccelerateMenu@@YAIQEAUtagWND@@QEAUtagMENU@@IQEAPEAUHMENU__@@@Z @ 0x1C014BEE8
 * Callers:
        ...
        HMENU *const a4)
{
  ...
  if ( (unsigned int)v10 >= *((_DWORD *)a2 + 13)
    ...
    && (v14 = *v13,
        *a4 = v14,
        _InterlockedAdd(&glSendMessage, 1u),
        xxxSendTransformableMessageTimeout(a1, 279LL, (unsigned __int64)v14, v10, 0, 0, 0LL, 1, 1),
