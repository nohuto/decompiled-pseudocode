/*
 * XREFs of MagSetLensContextInformation @ 0x1C01FE00C
 * Callers:
 ...
 *     ?MagpUpdateInputTransfrom@@YAJPEAU_MAGN_INPUT_TRANSFORM@@@Z @ 0x1C01FD66C (-MagpUpdateInputTransfrom@@YAJPEAU_MAGN_INPUT_TRANSFORM@@@Z.c)
