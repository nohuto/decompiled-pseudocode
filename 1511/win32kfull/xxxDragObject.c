/*
 * XREFs of xxxDragObject @ 0x1C023CA6C
 * Callers:
  ...
  if ( result )
  {
    ...
    *(_QWORD *)(v11 + 24) = a4;
    if ( a5 )
      ...
      v13 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 384LL) + 320LL);
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = &v44;
    v45 = 0LL;
    while ( *(_QWORD *)(*(_QWORD *)(gptiCurrent + 384LL) + 64LL) == a2 )
    {
      ...
      while ( (unsigned int)xxxInternalGetMessage(v51, 0LL, 0x100u, 0x109u, 1u, 0) )
        ;
      if ( *(_QWORD *)(*(_QWORD *)(gptiCurrent + 384LL) + 64LL) != a2
      ...
      *(_QWORD *)(v11 + 32) = *(_QWORD *)((char *)&v46[2] + 4);
      ...
      if ( a2 )
      {
        ...
        xxxSendTransformableMessageTimeout((struct tagWND *)a2, 557LL, v30, v11, 0, 0, 0LL, 1, 1);
      }
      if ( v43 == (struct tagWND *)HMValidateHandleNoSecure(*(_QWORD *)(v11 + 8), 1) )
      {
        ...
        {
          _InterlockedIncrement(&glSendMessage);
          xxxSendTransformableMessageTimeout(v43, 559LL, 0LL, v11, 0, 0, 0LL, 1, 1);
        }
      }
      else
      {
        ...
        {
          _InterlockedIncrement(&glSendMessage);
          xxxSendTransformableMessageTimeout(v43, 558LL, 0LL, v11 + 48, 0, 0, 0LL, 1, 1);
        }
        ...
        *(_QWORD *)(gptiCurrent + 368LL) = &v44;
        ...
        if ( v31 )
        {
          ...
          xxxSendTransformableMessageTimeout((struct tagWND *)v31, 558LL, 1uLL, v11, 0, 0, 0LL, 1, 1);
        }
      }
    ...
    else
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v36 + 16) + 440LL) |= 0x20u;
      if ( a2 )
        v37 = *(_QWORD *)a2;
      _InterlockedIncrement(&glSendMessage);
      v38 = xxxSendTransformableMessageTimeout((struct tagWND *)v36, 554LL, v37, v11, 0, 0, 0LL, 1, 1);
