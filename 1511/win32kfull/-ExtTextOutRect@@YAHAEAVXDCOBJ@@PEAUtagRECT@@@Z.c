/*
 * XREFs of ?ExtTextOutRect@@YAHAEAVXDCOBJ@@PEAUtagRECT@@@Z @ 0x1C003FDF8
 * Callers:
...
__int64 __fastcall ExtTextOutRect(struct XDCOBJ *a1, struct tagRECT *a2)
{
  ...
  if ( (unsigned int)ERECTL::bOffsetAdd((ERECTL *)&v23, v11, v9) )
  {
    ...
    {
      v13 = *(struct REGION **)(v10 + 1528);
      v12 = v10 + 2160;
      if ( !v13 )
        v13 = *(struct REGION **)(v10 + 1520);
      XCLIPOBJ::vSetup((XCLIPOBJ *)(v10 + 2160), v13, (struct ERECTL *)&v23, 2);
      v23 = *(struct _RECTL *)(v10 + 2164);
      if ( (unsigned int)ERECTL::bEmpty((ERECTL *)&v23) )
        return v4;
    }
    v14 = *(_QWORD *)(*(_QWORD *)a1 + 80LL);
    v15 = *(_QWORD *)a1 + 1992LL;
