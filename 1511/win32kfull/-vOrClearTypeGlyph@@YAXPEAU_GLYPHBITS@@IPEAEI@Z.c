/*
 * XREFs of ?vOrClearTypeGlyph@@YAXPEAU_GLYPHBITS@@IPEAEI@Z @ 0x1C02648D4
 * Callers:
 *     draw_clrt_f_ntb_o_to_temp_start @ 0x1C0264D80 (draw_clrt_f_ntb_o_to_temp_start.c)
 * Callees:
 *     <none>
 */
...
LABEL_20:
    ...
    v13 = (unsigned __int8 *)off_1C031B228;
    v14 = aj - a3;
    while ( 1 )
    {
      v15 = *v11;
