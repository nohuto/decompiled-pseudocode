/*
 * XREFs of ?xxxFKRepeatRateTimer@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C01EE730
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxFKRepeatRateTimer(struct tagWND *a1, __int64 a2, __int64 a3)
{
  ...
  gtmridFKResponse = SetRITTimer(a3, HIDWORD(xmmword_1C03222CC), (__int64)xxxFKRepeatRateTimer, 1);
