/*
 * XREFs of itrp_UpdateGlobalGS @ 0x1C00A3588
 * Callers:
        ...
        __int64 a13)
{
  ...
  *(_QWORD *)(a1 + 344) = a7;
  *(_QWORD *)(a1 + 352) = a7 ^ a1 ^ *(_QWORD *)(a1 + 8) ^ MEMORY[0xFFFFF78000000330];
  result = a8;
  *(_WORD *)(a1 + 360) = a8;
  v19 = a8 ^ (unsigned __int64)MEMORY[0xFFFFF78000000330];
  *(_BYTE *)(a1 + 341) = 0;
  *(_QWORD *)(a1 + 368) = a1 ^ *(_QWORD *)(a1 + 16) ^ v19;
  *(_WORD *)(a1 + 396) = 1;
  *(_DWORD *)(a1 + 400) = 10000;
  *(_DWORD *)(a1 + 404) = 100;
