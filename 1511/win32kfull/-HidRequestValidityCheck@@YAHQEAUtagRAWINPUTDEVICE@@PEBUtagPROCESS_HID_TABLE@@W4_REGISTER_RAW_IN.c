/*
 * XREFs of ?HidRequestValidityCheck@@YAHQEAUtagRAWINPUTDEVICE@@PEBUtagPROCESS_HID_TABLE@@W4_REGISTER_RAW_INPUT_INTERNAL@@@Z @ 0x1C0089530
 * Callers:
...
LABEL_17:
  ...
  if ( *(_QWORD *)(*(_QWORD *)(v4 + 16) + 376LL) == PsGetCurrentProcessWin32Process(v9) )
  {
LABEL_22:
