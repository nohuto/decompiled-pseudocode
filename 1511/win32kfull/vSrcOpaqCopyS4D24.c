/*
 * XREFs of vSrcOpaqCopyS4D24 @ 0x1C0265200
 * Callers:
 *     <none>
 * Callees:
 *     ?vUnlock@SEMOBJ@@QEAAXXZ @ 0x1C00E14B8 (-vUnlock@SEMOBJ@@QEAAXXZ.c)
 *     ?pvFillOpaqTable@@YAPEAXKKKPEAVSURFACE@@@Z @ 0x1C00F9674 (-pvFillOpaqTable@@YAPEAXKKKPEAVSURFACE@@@Z.c)
 */
        ...
        struct SURFACE *a11)
{
  ...
  HSEMAPHORE v52; // [rsp+70h] [rbp-58h] BYREF
