/*
 * XREFs of UserActivateDwmInputProcessing @ 0x1C009FAB0
 * Callers:
 *     <none>
 * Callees:
 *     WaitForRitDisEngagement @ 0x1C009FBB8 (WaitForRitDisEngagement.c)
 *     ?InitalizeDitInfoObjectArray@@YAJPEAUDIT_INFO@@@Z @ 0x1C009FC5C (-InitalizeDitInfoObjectArray@@YAJPEAUDIT_INFO@@@Z.c)
 */
