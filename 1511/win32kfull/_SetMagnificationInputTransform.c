/*
 * XREFs of _SetMagnificationInputTransform @ 0x1C00D3DDC
 * Callers:
 ...
 *     ?ComputeMagnificationFactor@@YAXPEAU_MAGNIFICATION_INPUT_TRANSFORM@@@Z @ 0x1C0203B2C (-ComputeMagnificationFactor@@YAXPEAU_MAGNIFICATION_INPUT_TRANSFORM@@@Z.c)
  ...
  if ( !v2 )
  {
    if ( !*(_QWORD *)(v3 + 208) )
    {
      ...
      *(_QWORD *)&v23 = gptiCurrent;
      ...
      AcquireMagInputLock();
      v18 = (_OWORD *)Win32AllocPool(48LL);
      *(_QWORD *)(v3 + 208) = v18;
      if ( !v18 )
      {
        UserSetLastError(14);
