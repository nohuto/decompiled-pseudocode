/*
 * XREFs of IsPointerInputRedirected @ 0x1C01FBE2C
 * Callers:
 *     ArbitratePrimaryStatus @ 0x1C01C8F58 (ArbitratePrimaryStatus.c)
 *     IsPointerInputTypeRedirected @ 0x1C01FBEC0 (IsPointerInputTypeRedirected.c)
...
__int64 __fastcall IsPointerInputRedirected(__int64 a1, __int64 a2, int a3, _QWORD *a4)
{
  ...
  v6 = *v10;
  if ( v6 && a1 == *(_QWORD *)(*(_QWORD *)(v6 + 16) + 376LL) )
    v6 = 0LL;
LABEL_8:
  if ( a4 )
    *a4 = v6;
