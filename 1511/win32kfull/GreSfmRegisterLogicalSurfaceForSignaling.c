/*
 * XREFs of GreSfmRegisterLogicalSurfaceForSignaling @ 0x1C01020AC
 * Callers:
 ...
 *     ?SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z @ 0x1C007B524 (-SignalOnDirty@SFMLOGICALSURFACE@@QEAAJH@Z.c)
 */
