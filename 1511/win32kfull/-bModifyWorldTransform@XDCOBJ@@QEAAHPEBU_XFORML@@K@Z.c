/*
 * XREFs of ?bModifyWorldTransform@XDCOBJ@@QEAAHPEBU_XFORML@@K@Z @ 0x1C002D6D8
 * Callers:
 ...
 *     ?bWorldXformIdentity@@YAHPEBU_XFORML@@@Z @ 0x1C012C040 (-bWorldXformIdentity@@YAHPEBU_XFORML@@@Z.c)
  ...
  if ( a3 > 1 )
  {
    if ( a3 <= 3 )
    {
      ...
      if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 80LL) + 352LL) & 2) != 0
        ...
        && (unsigned int)EXFORMOBJ::bMultToWorld((EXFORMOBJ *)v15, (struct MATRIX *)&Buf1, a3) )
      {
