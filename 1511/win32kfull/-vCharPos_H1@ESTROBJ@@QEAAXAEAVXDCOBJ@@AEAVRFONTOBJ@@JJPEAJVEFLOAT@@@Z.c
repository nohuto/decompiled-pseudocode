/*
 * XREFs of ?vCharPos_H1@ESTROBJ@@QEAAXAEAVXDCOBJ@@AEAVRFONTOBJ@@JJPEAJVEFLOAT@@@Z @ 0x1C0029860
 * Callers:
        ...
        float a7)
{
  ...
  {
    result = RFONTOBJ::bGetGlyphMetrics(a3, (struct RFONTOBJ *)(unsigned int)v15, v10, v11, a2, (struct ESTROBJ *)a1);
    if ( (_DWORD)result )
      goto LABEL_12;
    return result;
  }
  ...
  if ( *v18 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( (unsigned int)v22 >= *((_DWORD *)v19 + 1) )
      {
        ...
        {
          result = (__int64)RFONTOBJ::wpgdGetLinkMetricsPlus(v49, v58, (struct ESTROBJ *)a1, v14, v11, v55, &v57, 1);
          v26 = (struct _GLYPHDATA *)result;
          if ( !result )
            return result;
          goto LABEL_8;
        }
      ...
      if ( !*v25 )
      {
        result = RFONTOBJ::bInsertMetricsPlus(v59, v25, *v14);
        if ( !(_DWORD)result )
          return result;
