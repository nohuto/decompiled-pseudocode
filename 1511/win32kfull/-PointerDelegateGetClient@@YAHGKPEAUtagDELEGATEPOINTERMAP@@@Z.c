/*
 * XREFs of ?PointerDelegateGetClient@@YAHGKPEAUtagDELEGATEPOINTERMAP@@@Z @ 0x1C01F9304
 * Callers:
 *     ValidateDelegatePointerList @ 0x1C01E16B4 (ValidateDelegatePointerList.c)
 * Callees:
 *     ?DelegateCaptureInt@@YAPEAUtagWND@@PEAUtagPOINTERCAPTUREDATA@@H@Z @ 0x1C01FC644 (-DelegateCaptureInt@@YAPEAUtagWND@@PEAUtagPOINTERCAPTUREDATA@@H@Z.c)
