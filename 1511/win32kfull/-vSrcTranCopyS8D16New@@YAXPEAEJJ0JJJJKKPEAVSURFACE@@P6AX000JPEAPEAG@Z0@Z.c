/*
 * XREFs of ?vSrcTranCopyS8D16New@@YAXPEAEJJ0JJJJKKPEAVSURFACE@@P6AX000JPEAPEAG@Z0@Z @ 0x1C0264B78
 * Callers:
 ...
 *     ulBlendPixelCT @ 0x1C0153378 (ulBlendPixelCT.c)
 *     ?vCopyAlphaBuffer16bpp@@YAXPEAE00JPEAPEAG@Z @ 0x1C0264844 (-vCopyAlphaBuffer16bpp@@YAXPEAE00JPEAPEAG@Z.c)
 */
      ...
      if ( *v20 )
      {
        ...
        else
        {
          if ( (_DWORD)v23 == 114 )
            ...
            v25 = ulBlendPixelCT((__int64)v28, v24, (unsigned __int8 *)off_1C031B228 + 4 * v23);
          *(_WORD *)v21 = v25;
        }
      }
      --v22;
