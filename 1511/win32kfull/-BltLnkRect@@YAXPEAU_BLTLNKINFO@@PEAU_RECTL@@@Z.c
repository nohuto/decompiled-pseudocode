/*
 * XREFs of ?BltLnkRect@@YAXPEAU_BLTLNKINFO@@PEAU_RECTL@@@Z @ 0x1C003AE10
 * Callers:
 ...
 *     ?BltLnkAccel6666@@YAXPEAE0JJJJ@Z @ 0x1C02D3160 (-BltLnkAccel6666@@YAXPEAE0JJJJ@Z.c)
 *     ?BltLnkAccel8888@@YAXPEAE0JJJJ@Z @ 0x1C02D31F8 (-BltLnkAccel8888@@YAXPEAE0JJJJ@Z.c)
 *     ?BltLnkAccelEEEE@@YAXPEAE0JJJJ@Z @ 0x1C02D3298 (-BltLnkAccelEEEE@@YAXPEAE0JJJJ@Z.c)
 */
...
void __fastcall BltLnkRect(struct _BLTLNKINFO *a1, struct _RECTL *a2)
{
  ...
  unsigned int v62; // [rsp+CCh] [rbp-5CCh]
  __int64 v63; // [rsp+D0h] [rbp-5C8h]
