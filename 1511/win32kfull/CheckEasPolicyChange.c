/*
 * XREFs of CheckEasPolicyChange @ 0x1C01D3770
 * Callers:
...
__int64 CheckEasPolicyChange()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C032F1A8 != KeyInformation[0] )
  {
    qword_1C032F1A8 = KeyInformation[0];
    return 1;
  }
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( qword_1C032F1A0 != KeyInformation[0] )
  {
    qword_1C032F1A0 = KeyInformation[0];
    return 1;
  }
  return v0;
}
