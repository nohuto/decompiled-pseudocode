/*
 * XREFs of ?bRemoveMergeFont@XDCOBJ@@QEAAHU_UNIVERSAL_FONT_ID@@@Z @ 0x1C02A4450
 * Callers:
...
LABEL_8:
    ...
    if ( v2 )
    {
      if ( v4 == *(_QWORD **)(*(_QWORD *)a1 + 2464LL) )
        *(_QWORD *)(*(_QWORD *)a1 + 2464LL) = v4[1];
      else
        v5[1] = v4[1];
      Win32FreePool(v4);
    }
