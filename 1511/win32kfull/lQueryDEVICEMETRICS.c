/*
 * XREFs of lQueryDEVICEMETRICS @ 0x1C01154D0
 * Callers:
  ...
  *(_DWORD *)(a3 + 20) = 0;
  ...
  if ( (*(_DWORD *)(a1 + 40) & 0x4000) != 0 )
  {
    if ( v8 && (*(_DWORD *)(a1 + 116) & 3) != 0 )
      v41 = (__int16)__ROR2__(*(_WORD *)(v8 + 76), 8);
    else
      v41 = -(__int16)__ROR2__(*(_WORD *)(v10 + v7 + 38), 8);
    *(_DWORD *)(a3 + 108) -= FixMul(v41, 22272);
    *(_DWORD *)(a3 + 112) += FixMul(v42, 22272);
  }
  *(_DWORD *)(a3 + 116) = *(unsigned __int16 *)(*(_QWORD *)(a1 + 8) + 324LL);
  ...
  else
  {
    ...
    *(_DWORD *)(a3 + 36) = v31 >> 1;
    ...
    v57 = 0.0;
    bFToL(v25, &v57, 0LL);
    v33 = v32 + (SLODWORD(v57) >> 3);
    v57 = 0.0;
    *(_DWORD *)(a3 + 108) = v33 >> 1;
    bFToL(v34, &v57, v35);
    v37 = v36 + (SLODWORD(v57) >> 3);
    v57 = 0.0;
    *(_DWORD *)(a3 + 112) = v37 >> 1;
    bFToL(v38, &v57, v39);
    *(_DWORD *)(a3 + 116) = (int)(v18 + (SLODWORD(v57) >> 3)) >> 1;
  }
  ...
  {
    v40 = (unsigned int)*(__int16 *)(*(_QWORD *)(a1 + 8) + 430LL);
    if ( ((unsigned __int8)*(_DWORD *)(a1 + 116) & (unsigned __int8)v18) != 0 )
    {
      *(_DWORD *)(a3 + 100) = ((v9 * (int)v40) >> 12) + 16;
