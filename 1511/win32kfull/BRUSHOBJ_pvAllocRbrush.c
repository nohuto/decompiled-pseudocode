/*
 * XREFs of BRUSHOBJ_pvAllocRbrush @ 0x1C025AD60
 * Callers:
 *     VerifierBRUSHOBJ_pvAllocRbrush @ 0x1C02906C0 (VerifierBRUSHOBJ_pvAllocRbrush.c)
 *     ?MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z @ 0x1C0296AC0 (-MulRealizeBrush@@YAHPEAU_BRUSHOBJ@@PEAU_SURFOBJ@@11PEAU_XLATEOBJ@@K@Z.c)
 * Callees:
