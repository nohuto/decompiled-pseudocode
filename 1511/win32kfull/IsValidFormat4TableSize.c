/*
 * XREFs of IsValidFormat4TableSize @ 0x1C0012D04
 * Callers:
 *     bVerifyMsftTable @ 0x1C0012B34 (bVerifyMsftTable.c)
 *     bVerifyMsftTableGeneral @ 0x1C0245698 (bVerifyMsftTableGeneral.c)
 * Callees:
 *     <none>
 */
