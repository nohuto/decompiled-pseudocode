/*
 * XREFs of DCEHitTestWindow @ 0x1C01E4C8C
 * Callers:
 ...
 *     ?DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z @ 0x1C01E44D8 (-DCEPointInTriangle@@YAHPEAU_D3DVERTEX@@MM@Z.c)
 *     BuildVertexList @ 0x1C01E4A80 (BuildVertexList.c)
