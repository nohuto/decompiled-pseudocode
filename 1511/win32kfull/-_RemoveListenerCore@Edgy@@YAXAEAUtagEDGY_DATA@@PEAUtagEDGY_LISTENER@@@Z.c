/*
 * XREFs of ?_RemoveListenerCore@Edgy@@YAXAEAUtagEDGY_DATA@@PEAUtagEDGY_LISTENER@@@Z @ 0x1C00FDE80
 * Callers:
 *     EdgyUnregisterListener @ 0x1C00FDE28 (EdgyUnregisterListener.c)
 *     ?OnDeviceRemoval@Edgy@@YAXPEAX@Z @ 0x1C0229554 (-OnDeviceRemoval@Edgy@@YAXPEAX@Z.c)
 * Callees:
