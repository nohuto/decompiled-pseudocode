/*
 * XREFs of _InitializeTouchInjectionWithQDCData @ 0x1C01DD078
 * Callers:
...
__int64 __fastcall InitializeTouchInjectionWithQDCData(unsigned int a1, unsigned int a2, __int64 a3, __int64 a4)
{
  ...
  if ( !gbEnforceUIPI || (v13 = 1, *(int *)(a3 + 12) >= 0) )
    v13 = 0;
  *(_DWORD *)(*(_QWORD *)(PseudoDigitizerDevice + 416) + 252LL) ^= (*(_DWORD *)(*(_QWORD *)(PseudoDigitizerDevice + 416)
                                                                              + 252LL) ^ (v13 << 6)) & 0x40;
  if ( !*(_QWORD *)(a3 + 848) )
  {
...
LABEL_4:
  ...
  *(_QWORD *)(a3 + 848) = v10;
  ...
  v15 = v5;
  *(_QWORD *)v10 = *(_QWORD *)(*(_QWORD *)(PseudoDigitizerDevice + 416) + 280LL);
  *(_DWORD *)(v10 + 16) = a2;
  *(_DWORD *)(v10 + 20) = v5;
