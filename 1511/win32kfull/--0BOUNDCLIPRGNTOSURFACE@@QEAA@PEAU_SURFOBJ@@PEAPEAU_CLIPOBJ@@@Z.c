/*
 * XREFs of ??0BOUNDCLIPRGNTOSURFACE@@QEAA@PEAU_SURFOBJ@@PEAPEAU_CLIPOBJ@@@Z @ 0x1C013CD30
 * Callers:
 ...
 *     ?bContain@ERECTL@@QEAAHAEAU_RECTL@@@Z @ 0x1C013CEC4 (-bContain@ERECTL@@QEAAHAEAU_RECTL@@@Z.c)
  ...
  if ( a3 )
  {
    if ( *a3 )
    {
      ...
      *(_QWORD *)&v13.left = 0LL;
      ...
      if ( !(unsigned int)ERECTL::bContain((ERECTL *)&v13, &v9) )
      {
