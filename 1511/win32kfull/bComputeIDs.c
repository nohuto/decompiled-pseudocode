/*
 * XREFs of bComputeIDs @ 0x1C00128C0
 * Callers:
 *     bVerifyTTF @ 0x1C0011B78 (bVerifyTTF.c)
 * Callees:
 *     vDetectOldBiDiFonts @ 0x1C000F598 (vDetectOldBiDiFonts.c)
 *     bVerifyMsftTable @ 0x1C0012B34 (bVerifyMsftTable.c)
 *     bCvtUnToMac @ 0x1C02453EC (bCvtUnToMac.c)
 *     bVerifyMsftHighByteTable @ 0x1C0245498 (bVerifyMsftHighByteTable.c)
