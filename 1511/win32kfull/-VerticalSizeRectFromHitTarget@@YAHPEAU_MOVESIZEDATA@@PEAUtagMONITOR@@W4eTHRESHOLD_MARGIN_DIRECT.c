/*
 * XREFs of ?VerticalSizeRectFromHitTarget@@YAHPEAU_MOVESIZEDATA@@PEAUtagMONITOR@@W4eTHRESHOLD_MARGIN_DIRECTION@@1HH@Z @ 0x1C02065B0
 * Callers:
...
__int64 __fastcall VerticalSizeRectFromHitTarget(__int64 a1, __int64 a2, int a3, __int64 a4, int a5)
{
  ...
  if ( v9 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
  {
    if ( v9 != 1
      || (v10 = (__int128 *)(v6 + 108),
          (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0) )
    {
      v10 = (__int128 *)(v6 + 76);
    }
  }
  ...
  if ( a4 )
  {
    if ( v9 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
    {
      if ( v9 != 1
        || (v12 = *(_QWORD *)(v7 + 16),
            v11 = a4 + 108,
            (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(v12 + 408) + 8LL) + 244LL) & 1) == 0) )
      {
        v11 = a4 + 76;
      }
    }
  ...
  if ( a3 )
  {
    ...
    else
    {
      ...
      v16 = v6;
      v23 = *(_DWORD *)(v22 + 344);
      if ( v23 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v22 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
      {
        if ( v23 == 1 && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v22 + 16) + 408LL) + 8LL) + 244LL) & 1) != 0 )
          v24 = (__int128 *)(v6 + 108);
        else
          v24 = (__int128 *)(v6 + 76);
      }
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      if ( v32 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v31 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
      {
        if ( v32 != 1
          || (v33 = v30 + 108,
              (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v31 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0) )
        {
          v33 = v30 + 76;
        }
      }
    ...
    else
    {
      ...
      v30 = v6;
      v37 = *(_DWORD *)(v36 + 344);
      if ( v37 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v36 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
      {
        if ( v37 == 1 && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v36 + 16) + 408LL) + 8LL) + 244LL) & 1) != 0 )
          v38 = (__int128 *)(v6 + 108);
        else
          v38 = (__int128 *)(v6 + 76);
      }
