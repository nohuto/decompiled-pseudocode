/*
 * XREFs of ?_SfnINBOXSTRING@@YA_JJPEAUtagWND@@I_K_J1P6A_JXZKPEAUtagSMS@@@Z @ 0x1C013F684
 * Callers:
 *     SfnINCBOXSTRING @ 0x1C013F5D0 (SfnINCBOXSTRING.c)
 *     SfnINLBOXSTRING @ 0x1C013F630 (SfnINLBOXSTRING.c)
 * Callees:
