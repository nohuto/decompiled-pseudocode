/*
 * XREFs of ?vSpComputeUnlockedRegion@@YAXPEAU_SPRITESTATE@@@Z @ 0x1C00FAA54
 * Callers:
 ...
 *     DxDdEnumLockedSurfaceRect @ 0x1C02625C4 (DxDdEnumLockedSurfaceRect.c)
...
void __fastcall vSpComputeUnlockedRegion(struct _SPRITESTATE *a1)
{
  ...
  _BYTE v21[80]; // [rsp+98h] [rbp-70h] BYREF
  struct _RECTL v22; // [rsp+E8h] [rbp-20h] BYREF
  struct _RECTL v23; // [rsp+F8h] [rbp-10h] BYREF
