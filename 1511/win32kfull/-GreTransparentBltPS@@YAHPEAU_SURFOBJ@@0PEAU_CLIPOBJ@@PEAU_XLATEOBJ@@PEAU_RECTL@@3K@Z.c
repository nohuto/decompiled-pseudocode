/*
 * XREFs of ?GreTransparentBltPS@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3K@Z @ 0x1C0284214
 * Callers:
      ...
      if ( v19 < v20 )
      {
        ...
        if ( v21 < v22 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( !v26 )
              break;
            vTransparentScan(v31, v32, v23, v24, a4, &v28, a7);
            v23 = v27;
            ++v24;
            ++v28.top;
            ++v28.bottom;
