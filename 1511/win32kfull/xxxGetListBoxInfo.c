/*
 * XREFs of xxxGetListBoxInfo @ 0x1C023C344
 * Callers:
 *     NtUserGetListBoxInfo @ 0x1C021B010 (NtUserGetListBoxInfo.c)
 * Callees:
...
__int64 __fastcall xxxGetListBoxInfo(__int64 a1)
{
  ...
  if ( v3 )
  {
    v4 = *(PRKPROCESS **)(*(_QWORD *)(v1 + 16) + 376LL);
...
LABEL_19:
    ...
    return xxxSendTransformableMessageTimeout((struct tagWND *)v1, 434LL, 0LL, 0LL, 0, 0, 0LL, 1, 1);
  }
}
