/*
 * XREFs of SfnTOUCHHITTESTING @ 0x1C02133B0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v10 = 0LL;
  result = AllocCallbackMessage(88, 1u, 48LL, v31, 1, 0x200uLL);
  v12 = result;
  if ( result )
  {
    ...
    *((_DWORD *)v12 + 12) = a2;
    *((_QWORD *)v12 + 7) = a3;
    if ( (int)CaptureCallbackData((struct _CAPTUREBUF *)v12, a4, 0x30u, (void **)v12 + 8) < 0 )
      goto LABEL_23;
    *((_QWORD *)v12 + 9) = a5;
    *((_QWORD *)v12 + 10) = a6;
    ...
    *((_QWORD *)v12 + 2) = 0LL;
    v17 = KeUserModeCallback(114LL, v12, *(unsigned int *)v12, &v25, &v24);
