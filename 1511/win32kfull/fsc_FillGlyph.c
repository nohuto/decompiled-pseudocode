/*
 * XREFs of fsc_FillGlyph @ 0x1C00A809C
 * Callers:
...
__int64 __fastcall fsc_FillGlyph(__int64 a1, __int16 *a2, __int64 a3, __int16 a4, unsigned __int16 a5)
{
  ...
  qword_1C0323D18 = *(_QWORD *)(a3 + 32);
  qword_1C0323D28 = v17;
  v18 = v16 + *(int *)(a3 + 8);
  qword_1C0323D20 = v16;
  qword_1C0323D30 = v18;
  qword_1C0323CC8 = (__int64)CalcHorizLineSubpix;
  qword_1C0323CE0 = (__int64)CalcVertLineSubpix;
  qword_1C0323CD0 = (__int64)CalcHorizSpSubpix;
  qword_1C0323CE8 = (__int64)CalcVertSpSubpix;
  qword_1C0323CD8 = (__int64)CalcHorizEpSubpix;
  qword_1C0323CF0 = (__int64)CalcVertEpSubpix;
  v19 = v13 < v14 || v12 > v7;
  v48 = (v13 << 6) - 32;
  v47 = (v12 << 6) + 32;
    ...
    if ( *(_WORD *)v10 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v22 != v23 )
        {
          ...
          {
            v38 = dword_1C0323D0C;
            *(_DWORD *)(qword_1C0323CF8 + 4LL * dword_1C0323D0C) = v33;
            *(_DWORD *)(qword_1C0323D00 + 4 * v38) = v36;
            dword_1C0323D0C = v38 + 1;
            if ( (int)v38 + 1 > dword_1C0323D08 )
              return 6656LL;
          }
          if ( v53 )
          {
