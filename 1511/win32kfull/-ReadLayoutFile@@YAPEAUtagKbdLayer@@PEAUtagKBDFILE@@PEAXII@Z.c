/*
 * XREFs of ?ReadLayoutFile@@YAPEAUtagKbdLayer@@PEAUtagKBDFILE@@PEAXII@Z @ 0x1C00FFE94
 * Callers:
 ...
 *     strcmp_0 @ 0x1C0152932 (strcmp_0.c)
 *     memmove @ 0x1C0152980 (memmove.c)
 *     ?ValidateKbdNLSTable@@YAHPEBUtagKbdNlsLayer@@@Z @ 0x1C02292A4 (-ValidateKbdNLSTable@@YAHPEBUtagKbdNlsLayer@@@Z.c)
 */
        ...
        if ( v19 )
        {
          ...
          while ( v21 >= (unsigned __int64)v14 && (v20 || v23 - 1 >= v21) && v23 < (unsigned __int64)v16 )
          {
            ...
            if ( v28 < v181 || &v28[v26] < v28 || &v28[v26] >= v16 )
              break;
            v29 = (unsigned __int64 *)Win32AllocPool((unsigned int)v26);
            v30 = v29;
            if ( v29 )
            {
              v31 = v182;
