/*
 * XREFs of FinishStockFontInit @ 0x1C0110A30
 * Callers:
...
void __fastcall FinishStockFontInit(unsigned int c)
{
  ...
  if ( v23 )
  {
    ...
    *(&gahStockObjects96 + 17) = (void * near *)GreCreateFontIndirectW((__int64)a);
    v9 = (__int64)*(&gahStockObjects96 + 17);
    if ( v9 )
      GreSetLFONTOwner(v9, 0, v8);
  }
  v10 = 0;
  if ( c > 0x6C )
  {
