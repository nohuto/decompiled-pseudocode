/*
 * XREFs of itrp_ExecutePrePgm @ 0x1C00A5C38
 * Callers:
...
__int64 __fastcall itrp_ExecutePrePgm(int a1, int a2, __int64 a3, __int64 a4)
{
  __int128 v4; // xmm0
  __int128 v7; // xmm1
  unsigned int v8; // ecx
  ...
  *(_QWORD *)(a3 + 152) = v7;
  v10 = *(_QWORD *)(a3 + 200);
  if ( v10 )
    v8 = itrp_Execute(a1, a2, v10, (int)v10 + *(_DWORD *)(a3 + 208), a3, a4);
