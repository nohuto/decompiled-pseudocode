/*
 * XREFs of bInitStockFontsInternal @ 0x1C0378158
 * Callers:
 *     bInitStockFonts @ 0x1C03797F0 (bInitStockFonts.c)
 * Callees:
...
unsigned __int16 *bInitStockFontsInternal()
{
  ...
  if ( result )
  {
    ...
    v7 = (void *)hfontCreate(Src, 1, 2, 0LL);
