/*
 * XREFs of HT_HalftoneBitmap @ 0x1C00BD0EC
 * Callers:
 *     EngHTBlt @ 0x1C00BAC98 (EngHTBlt.c)
 * Callees:
 *     SanityCheckDimension @ 0x1C00BD380 (SanityCheckDimension.c)
 *     AAHalftoneBitmap @ 0x1C00BE678 (AAHalftoneBitmap.c)
 *     pDCIAdjClr @ 0x1C00BEF78 (pDCIAdjClr.c)
 *     CheckABInfo @ 0x1C024D61C (CheckABInfo.c)
 */
...
__int64 HT_HalftoneBitmap(int a1, int a2, __int64 a3, __int64 a4, __int64 a5, ...)
{
  ...
  if ( (v11 & 0x100) != 0 )
    v12 |= 0x20u;
  v16 = pDCIAdjClr(v15, a2, (unsigned int)&pv, 4 * (v9 + (unsigned int)v14) + 688, v12, (_DWORD)pv, (__int64)&v27);
  if ( !v16 )
    return v27;
  v17 = (char *)pv + 312;
  *((_QWORD *)pv + 40) = pv;
