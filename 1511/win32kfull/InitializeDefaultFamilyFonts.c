/*
 * XREFs of InitializeDefaultFamilyFonts @ 0x1C03788F0
 * Callers:
 *     vInitMapper @ 0x1C0378A10 (vInitMapper.c)
 * Callees:
...
int InitializeDefaultFamilyFonts()
{
  ...
  if ( result >= 0 )
  {
    for ( i = 0LL; i < 6; ++i )
    {
      if ( bQueryValueKey(*(PCWSTR *)&gaMix[i * 8 + 24], Handle, KeyValueInformation, 0x54u) && v8 == 1 )
      {
        v2 = 33LL;
