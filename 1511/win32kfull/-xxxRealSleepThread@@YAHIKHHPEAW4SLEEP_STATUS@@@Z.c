/*
 * XREFs of ?xxxRealSleepThread@@YAHIKHHPEAW4SLEEP_STATUS@@@Z @ 0x1C005B640
 * Callers:
 ...
 * Callees:
 *     IsMulDestroyBrushInternalSupported @ 0x1C000CEC0 (IsMulDestroyBrushInternalSupported.c)
...
__int64 __fastcall xxxRealSleepThread(unsigned int a1, __int64 a2, int a3, int a4, enum SLEEP_STATUS *a5)
{
  ...
  *(_DWORD *)v7 = 0;
  ...
  v30 = gptiCurrent;
  v26 = *(_WORD *)(*(_QWORD *)(gptiCurrent + 400LL) + 10LL);
LABEL_10:
  ...
  else
  {
    ...
    if ( !v10 && (*(_BYTE *)(v12 + 6) & 0x40) != 0 )
    {
      ...
      *(_WORD *)(*(_QWORD *)(gptiCurrent + 400LL) + 4LL) |= *(_WORD *)(gptiCurrent + 752LL) & *(_WORD *)(v13 + 6);
        ...
        if ( v9 != 1 )
        {
          if ( (*(_DWORD *)(gptiCurrent + 440LL) & 0x1000) != 0 )
          {
            if ( *(_QWORD *)(*(_QWORD *)(gptiCurrent + 536LL) + 24LL) )
            {
              ...
              a2 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 536LL) + 24LL);
...
LABEL_78:
  *(_WORD *)(*(_QWORD *)(gptiCurrent + 400LL) + 10LL) = v26;
  if ( v8 )
