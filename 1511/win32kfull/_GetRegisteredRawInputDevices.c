/*
 * XREFs of _GetRegisteredRawInputDevices @ 0x1C01D5938
 * Callers:
 *     NtUserGetRegisteredRawInputDevices @ 0x1C021BDF0 (NtUserGetRegisteredRawInputDevices.c)
 * Callees:
 *     UserSetLastError @ 0x1C00503B0 (UserSetLastError.c)
 *     ?IsKeyboardDevice@@YAHGG@Z @ 0x1C0089A34 (-IsKeyboardDevice@@YAHGG@Z.c)
 *     ?IsMouseDevice@@YAHGG@Z @ 0x1C01025A4 (-IsMouseDevice@@YAHGG@Z.c)
 *     ?SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z @ 0x1C01D45A4 (-SortRegisteredDevices@@YAXPEAUtagRAWINPUTDEVICE@@H@Z.c)
 */
