/*
 * XREFs of OutputAATo24BPP_BGR @ 0x1C02511B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall OutputAATo24BPP_BGR(unsigned int *a1, __int64 a2, unsigned __int64 a3, __int64 a4, __int64 a5)
{
  ...
  if ( (result & 0x80u) == 0LL )
  {
    if ( (unsigned __int64)v6 < a3 )
    {
      ...
      do
      {
        *(v8 - 2) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)v6[2] + 512));
        *(v8 - 1) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)v6[1] + 256));
        result = *v6;
        v6 += 4;
  ...
  else if ( (unsigned __int64)v6 < a3 )
  {
    ...
    do
    {
      if ( v6[3] )
      {
        *(v7 - 2) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)v6[2] + 512));
        *(v7 - 1) = ~*(_BYTE *)(a5 + 4LL * ((unsigned int)v6[1] + 256));
        result = *v6;
