/*
 * XREFs of Win32FreePoolImpl @ 0x1C00C5C50
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Win32FreePoolImpl(char *a1)
{
  ...
  if ( v3
    && ((unsigned __int16)a1 & 0xFFFu) >= 0x10uLL
    && NSInstrumentation::CPointerHashTable::Remove(v3, a1 - 16, (void **)&v6) )
  {
