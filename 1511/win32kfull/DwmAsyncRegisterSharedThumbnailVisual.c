/*
 * XREFs of DwmAsyncRegisterSharedThumbnailVisual @ 0x1C0009BF8
 * Callers:
 *     DwmAsyncRegisterSharedThumbnailVisualApiExt @ 0x1C0009BC0 (DwmAsyncRegisterSharedThumbnailVisualApiExt.c)
 * Callees:
