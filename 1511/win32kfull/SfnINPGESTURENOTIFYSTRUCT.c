/*
 * XREFs of SfnINPGESTURENOTIFYSTRUCT @ 0x1C02113F0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a6)
{
  ...
  if ( a1 )
    ...
    v10 = 0LL;
  result = AllocCallbackMessage(88, 1u, *(unsigned int *)a4, v31, 1, 0x200uLL);
  v12 = result;
  if ( result )
  {
    ...
    *((_QWORD *)v12 + 2) = 0LL;
    v17 = KeUserModeCallback(113LL, v12, *(unsigned int *)v12, &v25, &v24);
