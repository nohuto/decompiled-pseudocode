/*
 * XREFs of InternalRegisterClassEx @ 0x1C011C78C
 * Callers:
...
_QWORD *__fastcall InternalRegisterClassEx(__int64 a1, __int16 a2, __int16 a3)
{
  ...
  struct _STRING v34; // [rsp+58h] [rbp-40h] BYREF
  ...
  *(_DWORD *)((char *)&DestinationString.Buffer + 2) = 0;
  ...
  if ( Atom
    && !v7
    && (InnerGetClassPtr(Atom, *(_QWORD *)(gptiCurrent + 376LL) + 320LL, v6)
...
LABEL_62:
  ...
  if ( (*(_DWORD *)(gptiCurrent + 440LL) & 4) == 0 )
    v13 = *(struct tagDESKTOP **)(gptiCurrent + 408LL);
  v14 = (a3 & 8) + 160;
...
LABEL_58:
  ...
  {
    v22 = ValidateClassAtomForRegisterClass(*(struct tagPROCESSINFO **)(gptiCurrent + 376LL), v21);
  }
  if ( !v22 )
  {
LABEL_57:
  ...
  *((_WORD *)v17 + 5) = v22;
  ...
  {
    v24 = ValidateClassAtomForRegisterClass(*(struct tagPROCESSINFO **)(gptiCurrent + 376LL), v23);
  }
  if ( !v24 )
  {
LABEL_55:
...
LABEL_48:
  ...
  {
    *v17 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 328LL);
    *(_QWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 328LL) = v17;
  }
  else
  {
    *v17 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 320LL);
    *(_QWORD *)(*(_QWORD *)(gptiCurrent + 376LL) + 320LL) = v17;
  }
  return v17;
}
