/*
 * XREFs of ?pvFileUMPD@RFONTOBJ@@QEAAPEAXPEAKPEAPEAX@Z @ 0x1C029B510
 * Callers:
 ...
 * Callees:
 *     ?pchTranslateUMPD@RFONTOBJ@@QEAAPEADPEADPEAPEAX@Z @ 0x1C029B2A0 (-pchTranslateUMPD@RFONTOBJ@@QEAAPEADPEADPEAPEAX@Z.c)
