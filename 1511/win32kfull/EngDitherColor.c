/*
 * XREFs of EngDitherColor @ 0x1C027D170
 * Callers:
 ...
 *     ?vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z @ 0x1C027C954 (-vComputeSubspaces@@YAPEAU_VERTEX_DATA@@KPEAU1@@Z.c)
 *     ?vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x1C027CBD4 (-vDitherColor4bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z.c)
 *     ?vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z @ 0x1C027CEC4 (-vDitherColor8bpp@@YAXPEAKPEAU_VERTEX_DATA@@1K@Z.c)
 */
...
ULONG __stdcall EngDitherColor(HDEV hdev, ULONG iMode, ULONG rgb, ULONG *pul)
{
  ...
  v4 = 0;
  v6 = rgb;
  if ( *((_DWORD *)hdev + 534) == 524296 )
  {
    if ( iMode == 2 )
    {
      memset(pul, 0, 0x20uLL);
      v10 = ((unsigned int)(unsigned __int8)((unsigned __int16)(28 * BYTE2(rgb) + 77 * v6 + 151 * BYTE1(rgb)) >> 8) + 1) >> 2;
      if ( v10 )
      {
        v11 = v10;
        do
        {
          v12 = jSwapSubSpace[v11 + 191];
