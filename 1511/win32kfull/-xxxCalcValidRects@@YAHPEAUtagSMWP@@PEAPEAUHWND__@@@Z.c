/*
 * XREFs of ?xxxCalcValidRects@@YAHPEAUtagSMWP@@PEAPEAUHWND__@@@Z @ 0x1C0056A14
 * Callers:
...
__int64 __fastcall xxxCalcValidRects(struct tagSMWP *a1, HWND *a2)
{
  ...
  *(_QWORD *)(gptiCurrent + 368LL) = v100;
  ...
  while ( 1 )
  {
    ...
    if ( !*(_QWORD *)v8 )
      goto LABEL_19;
    v20 = HMValidateHandleNoSecure(*(_QWORD *)v8, 1);
    if ( !v20 || !(unsigned int)IsStillWindowC(*(HWND *)(v8 + 8)) )
    {
      *(_QWORD *)v8 = 0LL;
      *(_DWORD *)(v8 + 32) = 6159;
      goto LABEL_19;
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v98;
    ...
    if ( (v21 & 0x400) == 0 )
    {
      ...
      if ( gfShellFrameHangResilient
        ...
        && gptiCurrent != *(_QWORD *)(v20 + 16) )
      {
        if ( *(_DWORD *)(*(_QWORD *)(gptiCurrent + 384LL) + 336LL) != 1 )
          xxxSendTransformableMessageTimeout((struct tagWND *)v20, 0x46u, 0LL, v8, 2, 50, (__int64)v99, 1, 0);
      }
      else
      {
        _InterlockedAdd(&glSendMessage, 1u);
        xxxSendTransformableMessageTimeout((struct tagWND *)v20, 0x46u, 0LL, v8, 0, 0, 0LL, 1, 0);
      }
      *(_DWORD *)(v8 + 32) |= v24;
      v26 = *(_DWORD *)(v8 + 32);
      *(_QWORD *)v8 = v19;
      if ( (v26 & 4) == 0 && (v25 || *(_WORD *)(v8 + 8) != (_WORD)v22) )
      {
        if ( !(unsigned int)IsStillWindowC(*(HWND *)(v8 + 8)) )
          break;
        if ( *(_WORD *)(v8 + 8) != (_WORD)v22 || *(_QWORD *)(v8 + 8) >= 0xFFFFFFFFFFFFFFFEuLL )
        {
          v42 = CheckTopmost((struct tagWINDOWPOS *)v8);
          if ( v42 )
          {
            if ( *(_DWORD *)(v20 + 304) == 1 )
              SetTopmostEnum((struct tagWND *)v20, v42 == 1, (*(_DWORD *)(v8 + 32) >> 9) & 1);
          }
        }
      }
    }
    v27 = *(_DWORD *)(v20 + 112);
    v28 = *(unsigned int *)(v20 + 116);
    v29 = v27;
    v93 = v27;
    v89 = v28;
    *(_DWORD *)(v8 + 80) = v27;
    *(_DWORD *)(v8 + 84) = v28;
    if ( v6 != GetDesktopWindow(v20, v28) )
    {
      v27 -= *(_DWORD *)(v6 + 128);
      v30 -= *(_DWORD *)(v6 + 132);
      v93 = v27;
      v89 = v30;
      if ( (*(_BYTE *)(v6 + 50) & 0x40) != 0 && (*(_BYTE *)(v20 + 55) & 0xC0) == 0x40 )
      {
        v29 = *(_DWORD *)(v6 + 136) - *(_DWORD *)(v20 + 120);
        v88 = v31;
      }
      else
      {
    ...
    v32 = *(_DWORD *)(v20 + 120) - *(_DWORD *)(v20 + 112);
    v33 = *(_DWORD *)(v20 + 124) - *(_DWORD *)(v20 + 116);
    *(_DWORD *)(v8 + 32) |= 0x1800u;
    v91 = v32;
    if ( (*(_BYTE *)(v20 + 289) & 3) != 0 && (*(_DWORD *)(v8 + 32) & 0x100000) != 0 )
    {
      ExtendArrangedRectangleByFrameMargin((struct tagWND *)v20, (struct tagSIZERECT *)(v8 + 16));
      v30 = v89;
    }
    v34 = *(_DWORD *)(v8 + 32);
    v35 = (LONG *)(v8 + 16);
    ...
    else
    {
      ...
      if ( (*(_BYTE *)(v20 + 55) & 0x20) != 0 && (unsigned int)IsTrayWindow(v20) )
      {
        *v35 = -32000;
        *(_DWORD *)(v8 + 20) = -32000;
      }
...
LABEL_38:
    ...
    if ( (*(_BYTE *)(v20 + 55) & 0x20) != 0 && GetProp(v20, (unsigned __int16)atomCheckpointProp, 1LL) )
    {
...
LABEL_39:
    ...
    if ( (*(_BYTE *)(v20 + 51) & 2) == 0 && GetStyleWindow(v20, 2818) )
      *(_DWORD *)(v8 + 32) |= 0x100u;
    ...
    if ( (v10 & 8) == 0 && ((*(_DWORD *)(v8 + 32) & 0x18E7) == 0x1807 || !(unsigned int)FChildVisible(v20)) )
    {
      v10 = (unsigned int)v10 | 8;
      *(_DWORD *)(v8 + 32) = v10;
    }
    if ( (*(_DWORD *)(v8 + 32) & 2) == 0 && (*(_BYTE *)(v20 + 45) & 1) == 0 )
    {
      AppCompatFlags = GetAppCompatFlags(0LL);
      if ( (AppCompatFlags & 0x20000) != 0 )
        v36 = 1;
    }
    if ( (*(_DWORD *)(v8 + 156) & 0x20) != 0 && (*(_WORD *)(v20 + 66) & 0x3FFF) == 0x2A4 )
    {
      if ( (unsigned int)IsWindowBroadcastingDpiToChildrenX(v20) )
      {
        ...
        v96.top = v76;
        v96.bottom = v78;
        NewMonitor = GetNewMonitor((struct tagWND *)v20, &v96, 0LL);
    ...
    *(_DWORD *)(v8 + 156) |= 4u;
    if ( (*(_BYTE *)(v20 + 55) & 0x40) == 0 && *(char *)(v20 + 48) >= 0 )
      xxxCheckFullScreen(v20, v8 + 16);
    v43 = *(_OWORD *)(v8 + 16);
    v101[0] = *(_OWORD *)v8;
    v44 = *(_QWORD *)(v8 + 32);
    v104 = v101;
    ...
    v101[1] = v43;
    v102 = v44;
    GetRect(v20, &v103[1], 66LL);
    GetRect(v20, &v103[2], 65LL);
    v45 = v103[2];
    v46 = DWORD2(v103[2]) - LODWORD(v103[2]);
    v47 = DWORD1(v103[2]);
    v87 = HIDWORD(v103[2]) - DWORD1(v103[2]);
    _InterlockedAdd(&glSendMessage, 1u);
    v48 = xxxSendTransformableMessageTimeout((struct tagWND *)v20, 0x83u, 1uLL, (__int64)v103, 0, 0, 0LL, 1, 0);
    if ( !(unsigned int)IsStillWindowC(*(HWND *)(v8 + 8)) )
      break;
    ...
    *(_DWORD *)(v8 + 52) = HIDWORD(v103[0]) - DWORD1(v103[0]);
    ...
    if ( (v11 & 0x100) == 0 && !v94 && (*(_BYTE *)(v20 + 48) & 0x20) == 0 )
    {
...
LABEL_11:
            ...
            else
            {
              ...
              *(_DWORD *)(v8 + 56) = v13;
              *(_DWORD *)(v8 + 60) = v14;
              if ( v6 != GetDesktopWindow(v20, v13) )
              {
                *(_DWORD *)(v8 + 56) = v10 + *(_DWORD *)(v6 + 128);
                *(_DWORD *)(v8 + 60) = v15 + *(_DWORD *)(v6 + 132);
              }
              *(_DWORD *)(v8 + 64) = *(_DWORD *)(v8 + 56) + *(_DWORD *)(v8 + 24);
              *(_DWORD *)(v8 + 68) = *(_DWORD *)(v8 + 28) + *(_DWORD *)(v8 + 60);
            }
            if ( (*(_BYTE *)(v20 + 50) & 0x40) != 0 )
              v16 = *v35 + *(_DWORD *)(v8 + 24) - v91 - v27;
            else
              v16 = *v35 - v27;
            v17 = (unsigned int)(*(_DWORD *)(v8 + 20) - v12);
            *(_DWORD *)(v8 + 72) = v16;
            v18 = *(_DWORD *)(v8 + 32);
            *(_DWORD *)(v8 + 76) = v17;
            if ( (v18 & 2) == 0 )
            {
              *(_DWORD *)(v8 + 32) = v18 & 0xFFFFEFFF;
              *(_DWORD *)(v8 + 40) = *(_DWORD *)(v8 + 72) + *(_DWORD *)(v20 + 128);
              *(_DWORD *)(v8 + 44) = *(_DWORD *)(v20 + 132) + v17;
              if ( v6 != GetDesktopWindow(v20, v10) )
              {
                *(_DWORD *)(v8 + 40) -= *(_DWORD *)(v6 + 128);
                *(_DWORD *)(v8 + 44) -= *(_DWORD *)(v6 + 132);
              }
              *(_DWORD *)(v8 + 48) = *(_DWORD *)(v20 + 136) - *(_DWORD *)(v20 + 128);
              v17 = (unsigned int)(*(_DWORD *)(v20 + 140) - *(_DWORD *)(v20 + 132));
              *(_DWORD *)(v8 + 52) = v17;
            }
LABEL_18:
            ThreadUnlock1(v17, v10);
            v9 = v90;
            v2 = v95;
            goto LABEL_19;
          }
      ...
      if ( (v46 == (_DWORD)v10 || (v48 & 0x100) == 0 && (*(_BYTE *)(*(_QWORD *)(v20 + 152) + 84LL) & 2) == 0)
        && (v87 == *(_DWORD *)(v8 + 52) || (v48 & 0x200) == 0 && (*(_BYTE *)(*(_QWORD *)(v20 + 152) + 84LL) & 1) == 0) )
      {
        v51 = (unsigned int)(DWORD2(v103[2]) - LODWORD(v103[2]));
        v52 = HIDWORD(v103[2]) - DWORD1(v103[2]);
        v53 = v103[1];
        v54 = DWORD2(v103[1]) - LODWORD(v103[1]);
        v55 = DWORD1(v103[1]);
        v56 = HIDWORD(v103[1]) - DWORD1(v103[1]);
        if ( ((v48 & 0x80u) != 0) != ((*(_BYTE *)(v20 + 50) & 0x40) != 0) )
        {
          if ( (*(_BYTE *)(v20 + 50) & 0x40) != 0 && (int)v51 > v54 )
            v84 = v51 - v54;
          else
            v84 = v54 - v51;
        ...
        *(_OWORD *)(v8 + 56) = v103[1];
        if ( v6 != GetDesktopWindow(v20, v51) )
        {
          v17 = *(unsigned int *)(v6 + 132);
          v57 = *(_DWORD *)(v6 + 128);
          *(_DWORD *)(v8 + 56) += v57;
          *(_DWORD *)(v8 + 64) += v57;
          *(_DWORD *)(v8 + 68) += v17;
