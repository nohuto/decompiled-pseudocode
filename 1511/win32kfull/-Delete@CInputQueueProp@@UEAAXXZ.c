/*
 * XREFs of ?Delete@CInputQueueProp@@UEAAXXZ @ 0x1C00CF320
 * Callers:
 *     <none>
 * Callees:
 *     ?Reset@?$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z @ 0x1C00CF434 (-Reset@-$CDynamicArray@PEAVIInputQueue@@$0HHHAHDFF@@@QEAAX_N@Z.c)
