/*
 * XREFs of ?GestureContactProcessing@@YAXPEBUtagPOINTERINPUTFRAME@@PEAUtagPOINTERINFONODE@@PEAUtagTPSTATE@@PEAUtagHID_POINTER_DEVICE_INFO@@HHKPEAH@Z @ 0x1C01F16F8
 * Callers:
        ...
        int *a8)
{
  ...
  if ( !v13 )
    goto LABEL_7;
  while ( __CFSHR__(*((_DWORD *)a3 + 386), 11) )
  {
    if ( *((_DWORD *)a3 + 325) == (unsigned int)*(unsigned __int16 *)(v15 + 48) % *((_DWORD *)a3 + 327) )
      goto LABEL_5;
LABEL_14:
    v15 += 216LL;
    if ( ++v14 >= v13 )
...
LABEL_17:
    if ( a2 )
    {
      FixupPrimaryGestureContact(a2, (unsigned int)*((unsigned __int16 *)a2 + 24) % *((_DWORD *)a3 + 327), a3, a4, v10);
      v9 = 0LL;
    }
  }
  if ( !a6 )
  ...
  for ( i = *((_QWORD *)a1 + 9); v18 < *((_DWORD *)a1 + 6); ++v18 )
  {
    ...
    if ( v20 )
    {
      v21 = (unsigned int)v20 % *((_DWORD *)a3 + 327);
      v22 = v21;
      ...
      if ( a6 == (_DWORD)v9 )
      {
        v23 = (__int64 *)*((_QWORD *)a3 + 166);
        if ( v23 )
          v24 = *v23;
        else
          v24 = v9;
        *(_QWORD *)(i + 24) = v24;
        *(_DWORD *)(i + 212) = *((_DWORD *)a3 + 388);
      }
      else
      {
      ...
      if ( a7 == 1 && (*(_DWORD *)(i + 68) & 0x40000) == 0 )
      {
        ...
        if ( (v29 & 0x8000) != 0 )
        {
          if ( v27 - *((_QWORD *)a3 + 184) > (unsigned __int64)(gliQpcFreq.QuadPart
                                                              * (unsigned int)dword_1C0321F38
                                                              / 1000) )
          {
            *(_DWORD *)(i + 68) = 0x40000;
            *((_DWORD *)v28 + 53) |= 0x10000u;
            *a8 = 1;
            if ( a6 == (_DWORD)v9 )
            {
