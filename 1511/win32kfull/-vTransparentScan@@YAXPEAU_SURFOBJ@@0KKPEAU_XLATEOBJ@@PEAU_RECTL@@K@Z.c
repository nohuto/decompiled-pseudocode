/*
 * XREFs of ?vTransparentScan@@YAXPEAU_SURFOBJ@@0KKPEAU_XLATEOBJ@@PEAU_RECTL@@K@Z @ 0x1C0285E60
 * Callers:
 ...
 *     ?ReadScanLine@@YAKPEAEKKKK@Z @ 0x1C0284518 (-ReadScanLine@@YAKPEAEKKKK@Z.c)
 *     ?SkipScanLine@@YAKPEAEKKKK@Z @ 0x1C02845F4 (-SkipScanLine@@YAKPEAEKKKK@Z.c)
 */
    ...
    do
    {
      ...
      if ( ScanLine - 1 > v7 )
      {
        ...
        if ( (*(_DWORD *)(v13 + 112) & 0x400) != 0 )
          (*(void (__fastcall **)(struct _SURFOBJ *, struct _SURFOBJ *, _QWORD, struct _XLATEOBJ *, __int128 *, _DWORD *))(v14 + 2872))(
            v20,
            a2,
            0LL,
            v19,
