/*
 * XREFs of ?InProcessDeviceTypeRequestTable@@YAPEAUtagPROCESS_HID_REQUEST@@PEAUtagPROCESS_HID_TABLE@@GG@Z @ 0x1C0089978
 * Callers:
...
LABEL_5:
  ...
  if ( result )
  {
    if ( v5 != result )
    {
      ...
      if ( *(struct tagPROCESS_HID_REQUEST **)(*(_QWORD *)result + 8LL) != result || *v10 != result )
        __fastfail(3u);
      ...
      *((_QWORD *)result + 1) = v3;
      if ( *(struct tagPROCESS_HID_REQUEST **)(v11 + 8) != v3 )
        __fastfail(3u);
      *(_QWORD *)(v11 + 8) = result;
      *(_QWORD *)v3 = result;
    }
...
LABEL_13:
  ...
  if ( *(struct tagPROCESS_HID_REQUEST **)v12 != result )
  {
    ...
    *((_QWORD *)result + 1) = v12;
    if ( *((struct tagPROCESS_HID_REQUEST **)v15 + 1) != v12 )
      __fastfail(3u);
    *((_QWORD *)v15 + 1) = result;
    *(_QWORD *)v12 = result;
  }
