/*
 * XREFs of ?UpdateInputCaptureAndGetTarget@@YAPEAUtagWND@@PEBUtagPOINTEREVENTINT@@PEAUtagINPUTPOINTERNODE@@IPEAUHWND__@@PEAGPEAI@Z @ 0x1C01FD048
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  {
    InputProcessContext = GetInputProcessContext((unsigned __int64)v8[3]);
    ...
    if ( !v27 )
    {
      ...
      {
        v22 = a6;
        if ( (*(_DWORD *)(v21 + 1544) & 0x4000000) != 0 )
        {
          v15 = 1;
          *a6 = *(_DWORD *)(v21 + 1552);
          *((_DWORD *)a2 + 38) |= 0x40u;
