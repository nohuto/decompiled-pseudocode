/*
 * XREFs of ?RedirAlphaBlend@@YAHPEAU_SURFOBJ@@0PEAU_CLIPOBJ@@PEAU_XLATEOBJ@@PEAU_RECTL@@3PEAU_BLENDOBJ@@@Z @ 0x1C028E410
 * Callers:
 *     <none>
 * Callees:
        ...
        BLENDOBJ *pBlendObj)
{
  ...
  struct SURFACE *v22[2]; // [rsp+58h] [rbp-41h] BYREF
