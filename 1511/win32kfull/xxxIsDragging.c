/*
 * XREFs of xxxIsDragging @ 0x1C014C940
 * Callers:
 *     xxxSysCommand @ 0x1C0109460 (xxxSysCommand.c)
 *     NtUserDragDetect @ 0x1C0218D30 (NtUserDragDetect.c)
 * Callees:
  ...
  do
  {
    while ( 1 )
    {
      while ( (unsigned int)xxxInternalGetMessage(v30, 0LL, 0x200u, 0x20Eu, 1u, 0)
           ...
           || *(_QWORD *)(*(_QWORD *)(gptiCurrent + 384LL) + 64LL) != a1 )
      {
        if ( *(_QWORD *)(*(_QWORD *)(gptiCurrent + 384LL) + 64LL) != a1 || DWORD2(v30[0]) == 514 )
          goto LABEL_15;
        if ( DWORD2(v30[0]) == 35 )
        {
...
LABEL_16:
      ...
      if ( gfShellFrameHangResilient && *(_QWORD *)(gptiCurrent + 1224LL) )
        break;
