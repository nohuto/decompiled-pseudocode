/*
 * XREFs of ?SetWinlogonHotKeys@@YAXXZ @ 0x1C009E784
 * Callers:
...
void SetWinlogonHotKeys(void)
{
  ...
  RegisterHotKey(0LL, (__int64)WinlogonHotkeyCallback, 10LL, 8202LL, BugCheckParameter2d);
  LODWORD(BugCheckParameter2e) = 13;
  RegisterHotKey(0LL, (__int64)WinlogonHotkeyCallback, 13LL, 24584LL, BugCheckParameter2e);
