/*
 * XREFs of ?xxxWindowHitTestFromTargetingProperty@@YAPEAUHWND__@@PEAUtagWND@@UtagPOINT@@PEAUtagPNTRWINDOWHITTTESTARGS@@PEAHW4tagTARGETING_PROPERTY@@UtagRECT@@@Z @ 0x1C022CF48
 * Callers:
 ...
 *     ?OffsetInContact@@YAHUtagPOINT@@PEBUtagTOUCHTARGETINGCONTACT@@0@Z @ 0x1C022B160 (-OffsetInContact@@YAHUtagPOINT@@PEBUtagTOUCHTARGETINGCONTACT@@0@Z.c)
  ...
  *a4 = 1;
  if ( a5 == 1 && (*(_QWORD *)(a1 + 16) == gptiCurrent || *(_QWORD *)(a1 + 312) == gptiCurrent) )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v37;
    ...
    v11 = xxxSendTransformableMessageTimeout((struct tagWND *)a1, 589LL, 0LL, (__int64)&v39, 0, 0, 0LL, 1, 0);
