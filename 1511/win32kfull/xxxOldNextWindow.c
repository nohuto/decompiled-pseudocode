/*
 * XREFs of xxxOldNextWindow @ 0x1C0201B8C
 * Callers:
...
LABEL_38:
  ...
  if ( v31 && v31 != v4 )
  {
    if ( (*(_BYTE *)(v4 + 48) & 8) == 0 )
    {
      v48 = *(_QWORD *)(gptiCurrent + 368LL);
      *(_QWORD *)(gptiCurrent + 368LL) = &v48;
      v49 = v31;
      ++*(_DWORD *)(v31 + 8);
      xxxSetWindowPos((struct tagWND *)v4, 1, 0, 0, 0, 0, 25619);
...
LABEL_39:
            ...
            if ( !v4 )
            {
              v4 = *(_QWORD *)(*(_QWORD *)(gptiCurrent + 384LL) + 80LL);
              ThreadLockExchange(v4, (__int64)v46);
            }
            if ( !(unsigned int)xxxCallMsgFilter((__int64)v47, 6u) )
              break;
      ...
      if ( v38 )
      {
        if ( v38 != v4 )
        {
          ...
          *(_QWORD *)(gptiCurrent + 368LL) = &v48;
          v49 = v38;
          ++*(_DWORD *)(v38 + 8);
          xxxSetWindowPos((struct tagWND *)v38, 1, 0, 0, 0, 0, 25619);
