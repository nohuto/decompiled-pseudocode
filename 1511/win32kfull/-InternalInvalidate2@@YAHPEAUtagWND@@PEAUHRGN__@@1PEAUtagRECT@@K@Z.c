/*
 * XREFs of ?InternalInvalidate2@@YAHPEAUtagWND@@PEAUHRGN__@@1PEAUtagRECT@@K@Z @ 0x1C00526DC
 * Callers:
 ...
 *     LogicalToPhysicalInPlaceRect @ 0x1C01E5840 (LogicalToPhysicalInPlaceRect.c)
...
LABEL_51:
  ...
  if ( *((_QWORD *)v7 + 11)
    ...
    && (v11 = Win32AllocPool(8LL), (v12 = v11) != 0) )
  {
    v13 = v82;
    v14 = DWORD2(v82);
    *(_BYTE *)(v11 + 4) = 1;
...
LABEL_78:
  ...
  if ( (*((_BYTE *)v7 + 46) & 0x40) != 0 )
    PixieHack((struct tagWND *)v7, &v81);
  ...
  if ( v75 )
  {
    ...
    if ( (v51 & 0x20) == 0 && (v5 & 0x40) == 0 && ((v5 & 0x80u) != 0 || (v51 & 2) == 0) )
    {
      ...
      if ( (v5 & 1) != 0 )
        v70 |= 0x404u;
      if ( (unsigned int)IntersectRect(&v83, &v81, v7 + 32)
