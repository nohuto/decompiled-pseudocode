/*
 * XREFs of ?PreserveShellArrangementDuringTopBottomSize@@YAHPEBU_MOVESIZEDATA@@@Z @ 0x1C0205DD4
 * Callers:
 ...
 *     ?GetShellArrangedWindowType@@YA?AW4SHELL_ARRANGEMENT_TYPE@@QEBU_MOVESIZEDATA@@K@Z @ 0x1C020548C (-GetShellArrangedWindowType@@YA-AW4SHELL_ARRANGEMENT_TYPE@@QEBU_MOVESIZEDATA@@K@Z.c)
 */
...
__int64 __fastcall PreserveShellArrangementDuringTopBottomSize(const struct _MOVESIZEDATA *a1)
{
    ...
    && ((v2 = *((_DWORD *)a1 + 40), (unsigned int)(v2 - 6) <= 2) || (unsigned int)(v2 - 3) <= 2) )
  {
    ...
    if ( v5 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
    {
      if ( v5 == 1 && (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 16) + 408LL) + 8LL) + 244LL) & 1) != 0 )
    ...
    {
      v10 = dword_1C02EABD0[ShellArrangedWindowType];
