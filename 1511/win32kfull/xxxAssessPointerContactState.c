/*
 * XREFs of xxxAssessPointerContactState @ 0x1C01CF118
 * Callers:
      ...
      while ( 1 )
      {
        ...
        while ( 1 )
        {
          ...
          if ( !LODWORD(v5[v4 + 146].Flink) )
            goto LABEL_24;
          if ( (unsigned int)(v2 - LODWORD(v5[v4 + 140].Blink)) <= LODWORD(Blink[55].Flink)
          ...
          if ( (unsigned int)(LODWORD(Blink[1].Blink) - 6) > 1 || !LOWORD(Blink[93].Blink) )
          {
...
LABEL_27:
        if ( (HIDWORD(Blink[15].Blink) & 0x100) != 0
          && (gptiCurrent == gptiRit || (unsigned int)IsDwmInputThread(gptiRit, v4 * 16, v5, v6)) )
        {
          v14 = HMValidateHandleNoRip((__int64)Blink[46].Flink, 19);
          if ( LODWORD(Blink[1].Blink) == 8 )
          {
            HoldingFrameForDevice = FindHoldingFrameForDevice(Blink[46].Flink);
            if ( HoldingFrameForDevice )
            {
              ...
              if ( v16 )
              {
                ...
                if ( (*(_DWORD *)(v16 + 1544) & 0x400000) != 0 )
                {
                  SendEndInertia((struct tagTPSTATE *)v16);
                  *(_DWORD *)(v16 + 1544) &= ~0x400000u;
                }
              }
            }
          }
