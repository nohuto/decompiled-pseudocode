/*
 * XREFs of ?RefreshMiPIdleNotificationTimer@@YAXPEAUtagWND@@@Z @ 0x1C00087A0
 * Callers:
...
void __fastcall RefreshMiPIdleNotificationTimer(struct tagWND *a1)
{
  ...
  v4 = *(_QWORD *)(*(_QWORD *)(v1 + 1112) + 8LL);
  if ( *(_QWORD *)a1 != v4 )
  {
    v5 = ValidateHwnd(v4);
    if ( v5 )
      FindTimer(v5, 65523, 2, 1, 0LL);
    *(_QWORD *)(*(_QWORD *)(v1 + 1112) + 8LL) = *(_QWORD *)a1;
    *(_DWORD *)(*(_QWORD *)(v1 + 1112) + 16LL) = v3 - 101;
  }
  v6 = *(_QWORD *)(v1 + 1112);
