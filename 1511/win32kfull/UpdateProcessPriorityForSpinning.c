/*
 * XREFs of UpdateProcessPriorityForSpinning @ 0x1C00815F4
 * Callers:
...
__int64 __fastcall UpdateProcessPriorityForSpinning(__int64 a1)
{
  ...
  if ( (*(_DWORD *)(a1 + 440) & 0x400) != 0 )
  {
    ...
    if ( (v7 & 0x800) == 0 )
    {
      *(_DWORD *)(v1 + 12) = v7 | 0x800;
      ...
      if ( (*(_DWORD *)(result + 776) & 0xC0000) == 0x40000 )
      {
        v6 = 2LL;
  ...
  else
  {
    ...
    if ( (v4 & 0x800) != 0 )
    {
      for ( i = *(_QWORD *)(v1 + 296); i; i = *(_QWORD *)(i + 584) )
      {
      ...
      *(_DWORD *)(v1 + 12) = v4 & 0xFFFFF7FF;
      result = *(_QWORD *)(a1 + 376);
      if ( (*(_DWORD *)(result + 776) & 0xC0000) == 0x80000 )
      {
        v6 = 1LL;
        return SetForegroundPriorityProcess(v1, a1, v6);
      }
