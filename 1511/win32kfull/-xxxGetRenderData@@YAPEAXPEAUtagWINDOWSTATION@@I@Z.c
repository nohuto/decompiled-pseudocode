/*
 * XREFs of ?xxxGetRenderData@@YAPEAXPEAUtagWINDOWSTATION@@I@Z @ 0x1C01F0774
 * Callers:
...
void *__fastcall xxxGetRenderData(struct tagWINDOWSTATION *a1, unsigned int a2)
{
  ...
  if ( v4 )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v15;
    v15[1] = v9;
    ++*(_DWORD *)(v9 + 8);
    v10 = xxxSendTransformableMessageTimeout(*((struct tagWND **)a1 + 10), 773LL, v3, 0LL, 66, 30000, &v17, 1, 0) != 0;
