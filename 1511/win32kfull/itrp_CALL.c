/*
 * XREFs of itrp_CALL @ 0x1C00C5070
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_CALL(__int64 a1)
{
  ...
  if ( (qword_1C0323E30 ^ *(_QWORD *)qword_1C0323E30 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0323E30 + 424)) != *(_QWORD *)(qword_1C0323E30 + 432)
    || (v7 = qword_1C0323E18, !((qword_1C0323E18 - *(_QWORD *)qword_1C0323E30) >> 2)) )
  {
  ...
  qword_1C0323E18 -= 4LL;
  v8 = *(int *)(v7 - 4);
  if ( (int)v8 >= *(unsigned __int16 *)(*(_QWORD *)(qword_1C0323E30 + 344) + 20LL) || (int)v8 < 0 )
  {
    result = qword_1C0323E88;
    dword_1C0323E80 = 4372;
    return result;
  }
  v9 = (int *)(*(_QWORD *)(qword_1C0323E30 + 160) + 8 * v8);
  v10 = *((_WORD *)v9 + 3);
  if ( v10 >= 2u )
  {
    result = qword_1C0323E88;
  ...
  v11 = v10;
  v12 = *(_QWORD *)(qword_1C0323E30 + 16LL * v10 + 200);
  v13 = (unsigned __int8 *)(v12 + *v9);
  if ( (unsigned __int64)v13 < v12
    || (v14 = &v13[*((unsigned __int16 *)v9 + 2)],
        (unsigned __int64)v14 > v12 + *(unsigned int *)(qword_1C0323E30 + 16 * (v11 + 13)))
    || v14 < v13 )
  {
    result = qword_1C0323E88;
  ...
  if ( (unsigned int)(v8 - 64) <= 2
    ...
    && (*(_WORD *)(qword_1C0323E30 + 454) & 0x100) != 0 )
  {
    v23 = *(_QWORD *)(qword_1C0323E30 + 8);
    v5 = 1;
    v2 = *(_DWORD *)(v23 + 88);
    *(_DWORD *)(v23 + 88) = 0;
    v1 = qword_1C0323E30;
