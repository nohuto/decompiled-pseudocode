/*
 * XREFs of ?bSpTransferShape@@YAHPEAVSPRITE@@0@Z @ 0x1C026FD4C
 * Callers:
  ...
  if ( v5 )
  {
    ...
    else
    {
      ...
      if ( (unsigned int)EXLATEOBJ::bInitXlateObj(
                           ...
                           0) )
      {
        v9 = SURFOBJ_TO_SURFACE_NOT_NULL(*(_QWORD *)(*((_QWORD *)a1 + 2) + 40LL));
        bSpCreateShape(
          a1,
          (struct _POINTL *)a2 + 17,
          *((struct _SURFOBJ **)a2 + 16),
          v11,
          (struct _RECTL *)a2 + 6,
          *(struct PALETTE **)(v9 + 120),
          0,
          1u,
          0LL);
      }
      EXLATEOBJ::vAltUnlock((EXLATEOBJ *)&v11, v8);
    }
    if ( *((_QWORD *)a1 + 16) )
    {
