/*
 * XREFs of ?GetMaxCountFeatureDetails@@YAJPEAUtagHID_POINTER_DEVICE_INFO@@PEAU_HIDP_PREPARSED_DATA@@PEAU_HIDP_CAPS@@PEAU_DEVICE_OBJECT@@PEAU_FILE_OBJECT@@E@Z @ 0x1C01C6AB8
 * Callers:
...
LABEL_7:
  ...
  v14 = HidP_GetUsageValue(HidP_Feature, 0xDu, 0, 0x55u, a1 + 180, a2, (PCHAR)OutputBuffer, a3->FeatureReportByteLength);
  if ( v14 >= 0 && (v16 = a1[180]) != 0 )
  {
    if ( v16 > 0x100 )
    {
