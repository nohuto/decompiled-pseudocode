/*
 * XREFs of ?vSpRedrawUncoveredArea@@YAXPEAVSPRITE@@PEAU_RECTL@@@Z @ 0x1C0277848
 * Callers:
...
void __fastcall vSpRedrawUncoveredArea(struct SPRITE *a1, struct _RECTL *a2)
{
  ...
  struct _RECTL *v34; // [rsp+60h] [rbp-A0h]
  __int64 v35; // [rsp+68h] [rbp-98h]
  struct SPRITE *v36; // [rsp+70h] [rbp-90h]
...
LABEL_69:
            ...
            v36 = pSpFindInZ(*((struct SPRITE **)v13 + 3), v14);
            v13 = v36;
            if ( !v36 )
            {
              v2 = v41;
...
LABEL_50:
              ...
              if ( (*(_DWORD *)(SURFOBJ_TO_SURFACE_NOT_NULL(Composite) + 112) & 0x400) == 0 )
                goto LABEL_59;
              v24 = (BOOL (__stdcall *)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))*((_QWORD *)Composite->hdev + 169);
            }
            else
            {
              if ( v22->iType == 1
...
LABEL_59:
              ...
              v24 = *(BOOL (__stdcall **)(SURFOBJ *, SURFOBJ *, CLIPOBJ *, XLATEOBJ *, RECTL *, POINTL *))(*(_QWORD *)(*((_QWORD *)a1 + 20) + 24LL) + 1352LL);
            }
LABEL_60:
            OffCopyBits(
