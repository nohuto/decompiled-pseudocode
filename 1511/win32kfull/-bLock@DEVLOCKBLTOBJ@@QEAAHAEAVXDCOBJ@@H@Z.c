/*
 * XREFs of ?bLock@DEVLOCKBLTOBJ@@QEAAHAEAVXDCOBJ@@H@Z @ 0x1C002FE9C
 * Callers:
...
__int64 __fastcall DEVLOCKBLTOBJ::bLock(DEVLOCKBLTOBJ *this, DC **a2)
{
  ...
  *((_QWORD *)this + 17) = *(_QWORD *)*a2;
  if ( (unsigned int)TrapAppContainerRenderingWrap(a2, (char *)this + 128, (char *)this + 120, (char *)this + 144) != 1 )
    return 0LL;
  *((_QWORD *)this + 12) = 0LL;
  *((_QWORD *)this + 10) = 0LL;
  v6 = *a2;
