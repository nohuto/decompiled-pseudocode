/*
 * XREFs of ?GetFONTOBJXform@UMPDOBJ@@QEAAPEAU_XFORMOBJ@@PEAU_FONTOBJ@@@Z @ 0x1C02865E0
 * Callers:
  ...
  if ( result )
  {
    ...
    if ( !v5 )
    {
      ...
      if ( v4 == (struct _XFORMOBJ *)-216LL
        || !(unsigned int)UMPDOBJ::ThunkDDIOBJ(this, (UMPDOBJ *)((char *)this + 288), (const void **)&v7, 4u) )
      {
        v5 = 0LL;
      }
      else
