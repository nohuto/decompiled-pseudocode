/*
 * XREFs of ?GeneratePointerMessage@@YAHPEBUtagPOINTERINFONODE@@_KIKHHPEAUHWND__@@@Z @ 0x1C01F7CA4
 * Callers:
 ...
 *     GetPointerInputSource @ 0x1C02024F4 (GetPointerInputSource.c)
 */
      ...
      if ( (unsigned int)v22 <= (unsigned int)v18 )
      {
          ...
          || (v23 = HIDWORD(v22), v18 >>= 32, (_DWORD)v23 != (_DWORD)v18) && (_DWORD)v23 != -1 && (_DWORD)v18 != -1 )
        {
          if ( !v13 )
          {
            UserSetLastError(5);
LABEL_32:
            EtwTraceUIPIInputError(gptiCurrent, *(_QWORD *)(v16 + 16), v17, *(_QWORD *)(v17 + 372), 8);
            return 0LL;
          }
        }
      }
  ...
  if ( (unsigned int)IsDwmInputThread(v18, v15, v19, 0xFFFFFFFFLL) )
  {
    if ( (*(_DWORD *)a1 & 0x800) == 0 && !v13 )
    {
      ...
      {
        v25 = *(_QWORD *)(v17 + 372);
        v26 = *(_QWORD *)(*(_QWORD *)(v24 + 416) + 1552LL);
        if ( gbEnforceUIPI )
        {
...
LABEL_43:
  ...
  if ( (v30 & 0x2000) != 0 && (v30 & 0x10000) != 0 )
  {
    ...
    v31 = *(_QWORD *)(*(_QWORD *)(v16 + 16) + 408LL);
    if ( v31 )
    {
      if ( *(_QWORD *)(v31 + 24) )
      {
