/*
 * XREFs of ?xxxSizeRectFromHitTarget@@YAXPEAU_MOVESIZEDATA@@PEAUtagMONITOR@@W4eTHRESHOLD_MARGIN_DIRECTION@@@Z @ 0x1C020AAA4
 * Callers:
...
__int64 __fastcall xxxSizeRectFromHitTarget(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( v8 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
  {
    if ( v8 != 1
      || (result = a2 + 108, (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0) )
    {
      result = a2 + 76;
    }
  }
