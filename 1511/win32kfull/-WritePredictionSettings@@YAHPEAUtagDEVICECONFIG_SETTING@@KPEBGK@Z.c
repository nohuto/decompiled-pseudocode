/*
 * XREFs of ?WritePredictionSettings@@YAHPEAUtagDEVICECONFIG_SETTING@@KPEBGK@Z @ 0x1C0224E4C
 * Callers:
...
__int64 __fastcall WritePredictionSettings(struct tagDEVICECONFIG_SETTING *a1, __int64 a2, const unsigned __int16 *a3)
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  do
  {
    v6 = WritePointerDeviceCfgSetting(KeyHandle, *v4, 4u, (unsigned __int8 *)&dword_1C031F044[4 * v3], 4u);
    if ( v6 < 0 )
      break;
    ++v3;
    v4 += 2;
