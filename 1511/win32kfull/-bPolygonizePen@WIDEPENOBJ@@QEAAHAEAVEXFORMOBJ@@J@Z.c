/*
 * XREFs of ?bPolygonizePen@WIDEPENOBJ@@QEAAHAEAVEXFORMOBJ@@J@Z @ 0x1C013103C
 * Callers:
...
__int64 __fastcall WIDEPENOBJ::bPolygonizePen(WIDEPENOBJ *this, struct EXFORMOBJ *a2, unsigned int a3)
{
  ...
  if ( !(unsigned int)WIDEPATHOBJ::bValid(this) )
    return 0LL;
  if ( !(unsigned int)bTurnLeftRandom((struct EVECTORFX *)&v13, (struct EVECTORFX *)&v14) )
  {
    LODWORD(v14) = -(int)v14;
  ...
  v9 = v13.x - ((unsigned __int64)(1922922357LL * v13.x) >> 32);
  v10 = v13.y - ((unsigned __int64)(1922922357LL * v13.y) >> 32);
  v26 = -v13.y;
  v22 = HIDWORD(v14) - v10;
  v19 = v10 + HIDWORD(v14);
  v20 = v14;
  v11 = v14 - ((unsigned __int64)(1922922357LL * (int)v14) >> 32);
  v15 = v13;
  v12 = HIDWORD(v14) - ((unsigned __int64)(1922922357LL * SHIDWORD(v14)) >> 32);
  v17 = v12 + v13.y;
  v25 = -v13.x;
  v24 = v12 - v13.y;
  v23 = v11 - v13.x;
