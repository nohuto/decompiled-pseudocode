/*
 * XREFs of ?ReadLinearityData@@YAHPEAUtagHID_POINTER_DEVICE_INFO@@U_UNICODE_STRING@@PEAX@Z @ 0x1C0094A4C
 * Callers:
 ...
 *     ?GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C0094E10 (-GetDeviceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
 */
  ...
  if ( Buffer )
  {
    ...
    *(_QWORD *)&v17.Length = 0LL;
    if ( (int)GetDeviceId(&v16, &v26, (unsigned __int16 **)&v17) >= 0 )
    {
      ...
      v12 = (unsigned __int16 *)Win32AllocPool(2 * v11 + 2);
      v7 = v12;
      if ( v12 )
      {
