/*
 * XREFs of ?ToggleKeys@@YAHPEAUtagKE@@KH@Z @ 0x1C01EE1F0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ToggleKeys(struct tagKE *a1, unsigned int a2, int a3)
{
  ...
  switch ( v3 )
  {
    ...
    case 145:
LABEL_16:
      if ( (dword_1C03222BC & 1) != 0 && !v4 )
      {
        v7 = v5 & 3;
        v8 = (unsigned __int8)gafAsyncKeyState[(unsigned __int64)(unsigned __int8)v3 >> 2];
...
LABEL_8:
    ...
    || (xmmword_1C032229C & 4) == 0 )
  {
    ...
    else if ( !gtmridToggleKeys && (dword_1C03222BC & 4) != 0 )
    {
      v6 = *(_BYTE *)a1;
