/*
 * XREFs of ?xxxProcessMousePromotionQueue@@YAXXZ @ 0x1C023ABBC
 * Callers:
 ...
 *     ?DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z @ 0x1C0239FD4 (-DequeueMousePromotionEntry@@YAPEAUtagMOUSE_PROMOTION_ENTRY@@AEAUtagMOUSE_PROMOTION_QUEUE@@@Z.c)
...
void xxxProcessMousePromotionQueue(void)
{
  ...
  v0 = 0;
  if ( !qword_1C0323610 && qword_1C0323590 )
  {
    dword_1C0323618 &= ~1u;
    qword_1C0323610 = gptiCurrent;
    v3 = DequeueMousePromotionEntry((struct tagMOUSE_PROMOTION_QUEUE *)&qword_1C0323590);
    if ( v3 )
    {
      while ( 1 )
      {
        if ( (*((_DWORD *)v3 + 10) & 0x20) == 0
          || !gspwndMouseOwner
          || (v6 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)gspwndMouseOwner + 2) + 376LL) + 832LL),
              v7 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)v4 + 376LL) + 832LL),
              !gbEnforceUIPI)
