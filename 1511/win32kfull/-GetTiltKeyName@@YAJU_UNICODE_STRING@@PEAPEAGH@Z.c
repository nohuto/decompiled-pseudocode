/*
 * XREFs of ?GetTiltKeyName@@YAJU_UNICODE_STRING@@PEAPEAGH@Z @ 0x1C01C32A0
 * Callers:
 ...
 *     ?GetInstanceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z @ 0x1C01C3210 (-GetInstanceId@@YAJU_UNICODE_STRING@@PEAPEAG1@Z.c)
 */
...
__int64 __fastcall GetTiltKeyName(struct _UNICODE_STRING *a1, unsigned __int16 **a2)
{
  ...
  *a2 = 0LL;
  ...
  if ( DeviceId < 0 )
    goto LABEL_11;
  v6 = v12 - v11;
  v7 = (unsigned __int16 *)Win32AllocPool(2 * v6 + 2);
  *a2 = v7;
  if ( !v7 )
    return 3221225628LL;
