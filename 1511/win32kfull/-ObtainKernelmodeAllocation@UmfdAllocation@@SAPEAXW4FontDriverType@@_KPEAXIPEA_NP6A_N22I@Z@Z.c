/*
 * XREFs of ?ObtainKernelmodeAllocation@UmfdAllocation@@SAPEAXW4FontDriverType@@_KPEAXIPEA_NP6A_N22I@Z@Z @ 0x1C02D6C2C
 * Callers:
 ...
 *     ??1?$unique_ptr@VUmfdAllocation@@V_lambda_45e705c273fec8437d54f19484ab56d0_@@@@QEAA@XZ @ 0x1C02D6C08 (--1-$unique_ptr@VUmfdAllocation@@V_lambda_45e705c273fec8437d54f19484ab56d0_@@@@QEAA@XZ.c)
 ...
 *     ?TryProbeForRead@@YA_NPEAXII@Z @ 0x1C02D6ED0 (-TryProbeForRead@@YA_NPEAXII@Z.c)
...
LABEL_21:
  unique_ptr<UmfdAllocation,_lambda_45e705c273fec8437d54f19484ab56d0_>::~unique_ptr<UmfdAllocation,_lambda_45e705c273fec8437d54f19484ab56d0_>(&v20);
  return (char *)v13;
}
