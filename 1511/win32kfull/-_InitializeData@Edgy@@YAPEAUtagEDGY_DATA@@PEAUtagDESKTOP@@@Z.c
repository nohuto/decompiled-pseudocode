/*
 * XREFs of ?_InitializeData@Edgy@@YAPEAUtagEDGY_DATA@@PEAUtagDESKTOP@@@Z @ 0x1C00FE244
 * Callers:
...
struct tagEDGY_DATA *__fastcall Edgy::_InitializeData(Edgy *this, struct tagDESKTOP *a2)
{
  ...
  result = (struct tagEDGY_DATA *)*((_QWORD *)this + 29);
  if ( !result )
  {
    v4 = Win32AllocPoolZInit(288LL, 1684370261LL);
    v5 = v4;
    if ( v4 )
    {
      memmove((void *)(v4 + 20), &unk_1C02E5D30, 0x9CuLL);
      *(_DWORD *)(v5 + 252) = 350;
      *(_DWORD *)(v5 + 264) = 4000;
      *(_DWORD *)(v5 + 268) = 4000;
      *(_DWORD *)(v5 + 272) = 450;
      *(_QWORD *)(v5 + 280) = 450 * gliQpcFreq.QuadPart / 1000;
      *((_QWORD *)this + 29) = v5;
    }
