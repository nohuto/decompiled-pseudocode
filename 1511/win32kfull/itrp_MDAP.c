/*
 * XREFs of itrp_MDAP @ 0x1C00B5960
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall itrp_MDAP(__int64 a1, char a2)
{
  ...
  if ( (qword_1C0323E30 ^ *(_QWORD *)qword_1C0323E30 ^ MEMORY[0xFFFFF78000000330] ^ *(_QWORD *)(qword_1C0323E30 + 424)) != *(_QWORD *)(qword_1C0323E30 + 432)
    || (v6 = qword_1C0323E18, !((qword_1C0323E18 - *(_QWORD *)qword_1C0323E30) >> 2)) )
  {
...
LABEL_44:
  ...
  if ( (int)v9 >= *(_DWORD *)(qword_1C0323E30 + 440) || (int)v9 < 0 )
    goto LABEL_44;
LABEL_11:
  ...
  if ( v19 >= 1 && v19 <= v13 && (int)v9 >= *(__int16 *)(*(_QWORD *)(LocalGS + 64) + 2LL * v19 - 2) + v7 + 1 )
    goto LABEL_44;
  LODWORD(qword_1C0323E40) = v9;
  HIDWORD(qword_1C0323E40) = v9;
  if ( (a2 & 1) != 0 )
  {
    v20 = InvokeProject(
    ...
    v21 = InvokeRoundValue(*(unsigned int *)(v2 + 128), v20, *(unsigned int *)(qword_1C0323E30 + 32));
    v2 = qword_1C0323E30;
    v22 = v21 - v20;
  }
  else
  ...
  switch ( dword_1C0323E5C )
  {
    ...
    case 4:
      *(_DWORD *)(*(_QWORD *)(v2 + 16) + 4 * v9) += v22;
      break;
    case 5:
      itrp_ChangeCvtSlow((unsigned int)(dword_1C0323E5C - 4), (unsigned int)v9, v22);
      break;
    default:
