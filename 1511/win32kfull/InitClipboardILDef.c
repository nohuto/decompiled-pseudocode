/*
 * XREFs of InitClipboardILDef @ 0x1C0112840
 * Callers:
 *     <none>
 * Callees:
 *     ?GetClipILIndexFromName@@YAIPEAGI@Z @ 0x1C01F0018 (-GetClipILIndexFromName@@YAIPEAGI@Z.c)
 */
...
int InitClipboardILDef()
{
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( !v2
    ...
    || (v2 = (int *)Win32AllocPool(v3), (v1 = v2) == 0LL) )
  {
LABEL_2:
    dword_1C031B09C = 0;
    dword_1C031B084 = 0;
