/*
 * XREFs of ?MulRenderHint@@YAJPEAUDHPDEV__@@K_KPEAX@Z @ 0x1C0296B10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MulRenderHint(struct DHPDEV__ *a1, unsigned int a2, __int64 a3, __int64 **a4)
{
  ...
  {
    v10 = v4[6];
    v11 = *(__int64 (__fastcall **)(_QWORD, _QWORD, __int64, __int64 **))(v10 + 3464);
    if ( v11 )
    {
      if ( (*(_DWORD *)(v10 + 1848) & 0x8000000) != 0 )
      {
        v12 = a4;
      }
      else
      ...
      v9 = v11(*(_QWORD *)(v10 + 1824), a2, a3, v12);
    }
    else
    {
      v9 = -1073741822;
