/*
 * XREFs of NtUserGetWOWClass @ 0x1C021C270
 * Callers:
 *     <none>
 * Callees:
...
_QWORD *__fastcall NtUserGetWOWClass(__int64 a1, int *a2)
{
  ...
  if ( v6 >= W32UserProbeAddress || (unsigned __int16)v4 > (unsigned __int16)HIWORD(*a2) || v6 <= (unsigned __int64)v5 )
    *W32UserProbeAddress = 0;
  WOWClass = GetWOWClass(a1, v5);
