/*
 * XREFs of _RegisterPointerDeviceNotifications @ 0x1C0108D38
 * Callers:
...
__int64 __fastcall RegisterPointerDeviceNotifications(struct _LIST_ENTRY *a1, int a2)
{
  ...
  if ( v7 )
  {
    ...
    *((_DWORD *)v8 + 2) = a2;
    v9 = (struct _LIST_ENTRY **)qword_1C0323FC8;
