/*
 * XREFs of itrp_Super45Round @ 0x1C02DDA74
 * Callers:
...
__int64 __fastcall itrp_Super45Round(int a1, __int16 a2)
{
  ...
  v3 = *(__int16 *)(qword_1C0323E30 + 140);
  v4 = *(_WORD *)(qword_1C0323E30 + 146) - *(_WORD *)(qword_1C0323E30 + 144);
  if ( a1 < 0 )
  {
    v7 = ((__int16)(a2 + v4 - a1) << 14) / *(__int16 *)(qword_1C0323E30 + 140);
  ...
  {
    v5 = v3 * ((__int16)(((__int16)(a2 + a1 + v4) << 14) / *(__int16 *)(qword_1C0323E30 + 140)) & 0xFFFFFFFFFFFFFFC0uLL);
    result = v2 + ((((unsigned int)v5 >> 13) + 1) >> 1) + (HIDWORD(v5) << 18);
  }
  v8 = *(__int16 *)(qword_1C0323E30 + 144);
