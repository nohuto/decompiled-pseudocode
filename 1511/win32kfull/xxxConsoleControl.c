/*
 * XREFs of xxxConsoleControl @ 0x1C0073248
 * Callers:
 ...
 *     SetVDMCursorBounds @ 0x1C01E6E44 (SetVDMCursorBounds.c)
...
__int64 __fastcall xxxConsoleControl(int a1, struct _CONSOLE_PROCESS_INFO *a2, int a3)
{
  ...
  if ( !v8 )
  {
    if ( a3 == 16 )
    {
      ...
      if ( v15 )
      {
        *(_DWORD *)(*(_QWORD *)(v15 + 16) + 756LL) = *((_DWORD *)a2 + 2);
        return v3;
      }
    }
    return (unsigned int)-1073741811;
  ...
  if ( v9 )
  {
    ...
    if ( a3 == 16 )
    {
      ...
      if ( v11 )
      {
        if ( *(_QWORD *)(*(_QWORD *)(v11 + 16) + 376LL) == PsGetCurrentProcessWin32Process(v10) )
        {
          UserAtomicCheck::UserAtomicCheck((UserAtomicCheck *)&Object);
          xxxSetWindowLong(v11, 0, *((_DWORD *)a2 + 2), 0, 1);
          xxxSetWindowLong(v11, 4, *((_DWORD *)a2 + 3), 0, 1);
