/*
 * XREFs of fs_ConvertGrayLevels @ 0x1C02D9508
 * Callers:
...
__int64 __fastcall fs_ConvertGrayLevels(__int64 a1, __int16 a2, __int16 a3)
{
    ...
    switch ( a3 )
    {
      case 2:
        ...
        if ( v18 )
        {
          ...
          do
          {
            *(_BYTE *)(v24 + *(_QWORD *)(a1 + 88)) = Gray4To5Table[*(_BYTE *)(v24 + *(_QWORD *)(a1 + 88)) & 3];
            ++v24;
            --v25;
          }
          while ( v25 );
      ...
      case 4:
        ...
        if ( v18 )
        {
          ...
          do
          {
            *(_BYTE *)(v22 + *(_QWORD *)(a1 + 88)) = Gray16To5Table[*(_BYTE *)(v22 + *(_QWORD *)(a1 + 88)) & 0xF];
            ++v22;
            --v23;
          }
          while ( v23 );
      ...
      case 8:
        ...
        if ( v18 )
        {
          ...
          do
          {
            *(_BYTE *)(v20 + *(_QWORD *)(a1 + 88)) = Gray16To5Table[(unsigned __int16)(*(char *)(v20
                                                                                               + *(_QWORD *)(a1 + 88)) >> 4)];
            ++v20;
            --v21;
          }
  ...
  if ( a3 == 4 )
  {
    ...
    if ( v4 )
    {
      ...
      do
      {
        *(_BYTE *)(*(_QWORD *)(a1 + 88) + v7) = Gray16To65Table[*(_BYTE *)(*(_QWORD *)(a1 + 88) + v7) & 0xF];
        ++v7;
        --v8;
      }
      while ( v8 );
  ...
  if ( v4 )
  {
    ...
    do
    {
      *(_BYTE *)(*(_QWORD *)(a1 + 88) + v5) = Gray16To65Table[(unsigned __int16)(*(char *)(*(_QWORD *)(a1 + 88) + v5) >> 4)];
      ++v5;
      --v6;
    }
    while ( v6 );
