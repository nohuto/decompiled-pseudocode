/*
 * XREFs of NtUserSetWindowDisplayAffinity @ 0x1C0220B40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtUserSetWindowDisplayAffinity(__int64 a1, int a2)
{
  ...
  if ( v4 )
  {
    if ( *(_QWORD *)(*(_QWORD *)(v4 + 16) + 376LL) != PsGetCurrentProcessWin32Process(v6) )
    {
      v9 = 5;
LABEL_14:
      UserSetLastError(v9);
    ...
    v10 = *(_QWORD *)(v8 + 88);
    if ( v10 && (*(_DWORD *)(*(_QWORD *)(v10 + 16) + 1072LL) & 0x40000) != 0 )
      v8 = *(_QWORD *)(v8 + 88);
