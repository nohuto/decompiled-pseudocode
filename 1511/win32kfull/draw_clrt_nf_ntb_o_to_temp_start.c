/*
 * XREFs of draw_clrt_nf_ntb_o_to_temp_start @ 0x1C00A10B0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        int a7)
{
  ...
  do
  {
    ...
    v13 = v11[2];
    v25 = v13;
    result = (unsigned __int8 *)(a3 + (unsigned int)(v7 * (*v8 + v11[1] - a7)) + *v11 + *(v8 - 1) - a4);
    v14 = v7;
    v15 = (unsigned __int8 *)off_1C031B228;
