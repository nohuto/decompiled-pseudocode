/*
 * XREFs of ?xxxContScroll@@YAXPEAUtagWND@@I_K_J@Z @ 0x1C0232080
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall xxxContScroll(struct tagWND *a1)
{
  ...
  v2 = *(_QWORD *)(*((_QWORD *)a1 + 2) + 632LL);
  if ( v2 )
  {
    xxxTrackBox(a1);
    if ( v2 == *(_QWORD *)(*((_QWORD *)a1 + 2) + 632LL) && (*(_DWORD *)v2 & 1) != 0 )
    {
      v3 = SetSystemTimer((__int64)a1, 65534LL, *(_DWORD *)(gpsi + 3992LL) >> 3, (__int64)xxxContScroll, 0);
