/*
 * XREFs of ?BasicTargetingHitTest@@YAHPEAUtagWND@@PEAUtagTOUCHTARGETINGCONTACT@@UtagPOINT@@PEAGPEAU3@HPEAUtagRECT@@W4tagTARGETING_PROPERTY@@HKH@Z @ 0x1C022ABA0
 * Callers:
 ...
 *     TouchTargetingRankForRegion @ 0x1C024C56C (TouchTargetingRankForRegion.c)
 */
