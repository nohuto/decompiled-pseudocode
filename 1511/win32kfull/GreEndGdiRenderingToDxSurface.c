/*
 * XREFs of GreEndGdiRenderingToDxSurface @ 0x1C0039C08
 * Callers:
 *     NtGdiEndGdiRendering @ 0x1C0039BC0 (NtGdiEndGdiRendering.c)
 * Callees:
  ...
  if ( v10 )
  {
    if ( (a1 & 0x800000) == 0 )
    {
      if ( (unsigned int)GreGetObjectOwner(a1, 5LL) )
      {
        ...
        if ( v12 || *(_QWORD *)(v10 + 216) )
        {
          v9 = 1;
          *(_WORD *)(v10 + 102) |= 0x200u;
          if ( v12 )
          {
            v13 = *(__int64 (__fastcall **)(__int64, _QWORD, __int64, __int64))(v11 + 3520);
            v9 = 0;
            if ( v13 )
