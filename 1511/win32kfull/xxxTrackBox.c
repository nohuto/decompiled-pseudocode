/*
 * XREFs of xxxTrackBox @ 0x1C0235880
 * Callers:
...
void __fastcall xxxTrackBox(struct tagWND *a1, int a2, __int64 a3, int a4)
{
  ...
  if ( v7 && (!a2 || BYTE1(a2) == 2) )
  {
    ...
    v9 = v8;
    if ( v8 == (*(_DWORD *)v7 & 1)
      || (zzzDrawInvertScrollArea(a1, (struct tagRECT *)v7, v8, *(_DWORD *)(v7 + 56)),
          v7 == *(_QWORD *)(*((_QWORD *)a1 + 2) + 632LL)) )
    {
      v10 = *(_DWORD *)(gpsi + 3992LL) >> 3;
      v11 = a2 - 512;
      if ( v11 )
      {
        v12 = v11 - 1;
        if ( v12 )
        {
          if ( v12 == 1 )
            xxxEndScroll(a1, 0);
LABEL_17:
          if ( v7 == *(_QWORD *)(*((_QWORD *)a1 + 2) + 632LL) )
            *(_DWORD *)v7 ^= (v9 ^ (unsigned __int8)*(_DWORD *)v7) & 1;
          return;
        }
        *(_QWORD *)(v7 + 64) = 0LL;
        v10 = *(_DWORD *)(gpsi + 3992LL);
      }
      if ( v9 )
      {
        if ( v9 != (*(_DWORD *)v7 & 1) )
        {
          v13 = SetSystemTimer((__int64)a1, 65534LL, v10, (__int64)xxxContScroll, 0);
          v14 = *(struct tagWND **)(v7 + 24);
          *(_QWORD *)(v7 + 64) = v13;
          if ( v14 )
            xxxDoScroll(*(struct tagWND **)(v7 + 16), v14, *(_DWORD *)(v7 + 56), 0, (*(_DWORD *)v7 >> 1) & 1);
        }
      }
      goto LABEL_17;
    }
