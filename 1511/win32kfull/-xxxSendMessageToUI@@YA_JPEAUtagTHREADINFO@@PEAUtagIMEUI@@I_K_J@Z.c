/*
 * XREFs of ?xxxSendMessageToUI@@YA_JPEAUtagTHREADINFO@@PEAUtagIMEUI@@I_K_J@Z @ 0x1C01E3094
 * Callers:
...
__int64 __fastcall xxxSendMessageToUI(PRKPROCESS **a1, struct tagIMEUI *a2, __int64 a3, unsigned __int64 a4)
{
  ...
  if ( v13 )
  {
    ...
    *(_QWORD *)(gptiCurrent + 368LL) = v14;
    ...
    v17 = xxxSendTransformableMessageTimeout((struct tagWND *)v13, 642LL, a4, 0LL, 0, 0, 0LL, 1, 1);
