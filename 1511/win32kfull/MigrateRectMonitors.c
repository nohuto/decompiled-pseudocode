/*
 * XREFs of MigrateRectMonitors @ 0x1C020B510
 * Callers:
        ...
        char a8)
{
  ...
  v10 = *(_DWORD *)(a1 + 344);
  v64 = v8;
  if ( v10 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
  {
    if ( v10 != 1
      || (v13 = (_DWORD *)(a3 + 108),
  ...
  {
    v20 = *(_DWORD *)(a1 + 344);
    if ( v20 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
    {
      if ( v20 != 1
        || (v21 = a5 + 108, (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0) )
      {
        v21 = a5 + 76;
      }
    }
    ...
    {
      if ( v20 != 1
        || (v22 = a6 + 108, (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0) )
      {
        v22 = a6 + 76;
      }
    }
  ...
  {
    v24 = *(_DWORD *)(a1 + 344);
    if ( v24 || (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0 )
    {
      if ( v24 != 1
        || (v23 = (__m128i *)(a5 + 108),
            (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 16) + 408LL) + 8LL) + 244LL) & 1) == 0) )
