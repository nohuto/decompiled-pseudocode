/*
 * XREFs of ?CreatePointerDeviceProcessEvent@@YAHKHEPEAGPEAPEAX@Z @ 0x1C009E334
 * Callers:
 *     CreatePointerDeviceProcessEvents @ 0x1C009E2E0 (CreatePointerDeviceProcessEvents.c)
 * Callees:
 *     ?StringCchPrintfW@@YAJPEAG_KPEBGZZ @ 0x1C009E600 (-StringCchPrintfW@@YAJPEAG_KPEBGZZ.c)
  ...
  *(_WORD *)&v26.Value[4] = 256;
  ...
  if ( v12 >= 0 )
  {
    ...
    if ( v11 >= 0 )
    {
      ...
      v18 = (struct _ACL *)Win32AllocPool(v17 + 40LL);
      v7 = v18;
      if ( v18 )
      {
        v19 = v18 + 5;
