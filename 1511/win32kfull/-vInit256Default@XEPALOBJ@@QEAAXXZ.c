/*
 * XREFs of ?vInit256Default@XEPALOBJ@@QEAAXXZ @ 0x1C012D044
 * Callers:
...
void __fastcall XEPALOBJ::vInit256Default(XEPALOBJ *this)
{
  ...
  {
    v4 = 19 - v1;
    *(_DWORD *)(v3 + *(_QWORD *)(*(_QWORD *)this + 128LL)) = *(_DWORD *)(v3 + logDefaultPal + 4);
    v3 += 4LL;
    v5 = 255 - v1++;
    *(_DWORD *)(*(_QWORD *)(*(_QWORD *)this + 128LL) + 4 * v5) = *((_DWORD *)&logDefaultPal + v4 + 1);
  }
  while ( v1 < 0xA );
}
