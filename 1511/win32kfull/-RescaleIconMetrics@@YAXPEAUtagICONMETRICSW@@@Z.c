...
void __fastcall RescaleIconMetrics(struct tagICONMETRICSW *a1)
{
  ...
  v2 = EngMulDiv(*((_DWORD *)a1 + 1), *(unsigned __int16 *)(gpsi + 7286LL), 96);
  v3 = *((_DWORD *)a1 + 2);
  *((_DWORD *)a1 + 1) = v2;
  *((_DWORD *)a1 + 2) = EngMulDiv(v3, *(unsigned __int16 *)(gpsi + 7286LL), 96);
  *((_DWORD *)a1 + 4) = EngMulDiv(*((_DWORD *)a1 + 4), *(unsigned __int16 *)(gpsi + 7286LL), 96);
  *((_DWORD *)a1 + 5) = EngMulDiv(*((_DWORD *)a1 + 5), *(unsigned __int16 *)(gpsi + 7286LL), 96);
}
