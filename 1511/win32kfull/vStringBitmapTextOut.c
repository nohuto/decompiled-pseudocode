/*
 * XREFs of vStringBitmapTextOut @ 0x1C028B648
 * Callers:
 ...
 *     vDrawGlyph @ 0x1C028B42C (vDrawGlyph.c)
 */

char __fastcall vStringBitmapTextOut(__int64 a1, __int64 a2, unsigned int a3)
{
  int v3; // ebx
  int v4; // ebp
  PGLYPHPOS v6; // r8
