/*
 * XREFs of PepIdlePrepare @ 0x1C00037A0
 * Callers:
 *     <none>
 * Callees:
 *     AcpiCStateIdlePrepare @ 0x1C00021F0 (AcpiCStateIdlePrepare.c)
 *     PepIdleCancel @ 0x1C0003B90 (PepIdleCancel.c)
...
__int64 __fastcall PepIdlePrepare(__int64 a1)
{
  ...
  if ( dword_1C0009870 >= (unsigned int)dword_1C00093A4 )
  {
    ...
    v18 = !v7;
    if ( (int)((__int64 (__fastcall *)(_QWORD, ULONG_PTR *))qword_1C0009618)(
    ...
    if ( !LOBYTE(BugCheckParameter3[1]) )
    {
      ...
      if ( LODWORD(BugCheckParameter3[4]) != -1 && LODWORD(BugCheckParameter3[4]) >= dword_1C0009878 )
    ...
    if ( LODWORD(BugCheckParameter3[2]) )
    {
      do
      {
        ...
        if ( (_DWORD)v11 != 255 && ((unsigned int)v11 >= *(_DWORD *)(v12 + 1060) || v8) )
          KeBugCheckEx(0x143u, 2uLL, 1uLL, v11, *(_QWORD *)(v12 + 640));
