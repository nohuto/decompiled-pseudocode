/*
 * XREFs of AcpiCStateNotifyWorker @ 0x1C0011540
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall AcpiCStateNotifyWorker(__int64 a1, struct _IO_WORKITEM *a2)
{
  ...
  if ( (*(_DWORD *)(v7 + 248) & 0x7F070) != 0 )
  {
    ...
    {
      PoolWithTag = v11;
      inited = InitAcpiIdleDomain(v7, &v12, v11);
      v3 = v12;
      if ( inited < 0 )
        v3 = 0LL;
    }
