/*
 * XREFs of RegisterKernelPackage @ 0x1C0018950
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
    ...
    if ( !ProcessorPackage )
      goto LABEL_13;
    v5 = (__int64 **)qword_1C00093E0;
    *(_QWORD *)ProcessorPackage = &qword_1C00093D8;
    *(_QWORD *)(ProcessorPackage + 8) = v5;
    if ( *v5 != &qword_1C00093D8 )
      __fastfail(3u);
    *v5 = (__int64 *)ProcessorPackage;
    qword_1C00093E0 = ProcessorPackage;
  }
  *(_QWORD *)(a1 + 1008) = ProcessorPackage;
  ++*(_DWORD *)(ProcessorPackage + 204);
  v6 = a1 + 1016;
  v7 = *(_QWORD **)(ProcessorPackage + 24);
  *(_QWORD *)(a1 + 1016) = ProcessorPackage + 16;
  *(_QWORD *)(a1 + 1024) = v7;
