/*
 * XREFs of RegisterHvPackage @ 0x1C001AD30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RegisterHvPackage(__int64 a1)
{
  ...
  if ( v2 >= 0 )
  {
    ...
    while ( (__int64 *)v3 != &qword_1C00093D8 );
    if ( !v5 )
    {
LABEL_6:
      v5 = 0LL;
      ...
      if ( !v5 )
        goto LABEL_23;
      v10 = (__int64 **)qword_1C00093E0;
      *(_QWORD *)v5 = &qword_1C00093D8;
      *(_QWORD *)(v5 + 8) = v10;
      if ( *v10 != &qword_1C00093D8 )
        __fastfail(3u);
      *v10 = (__int64 *)v5;
      qword_1C00093E0 = v5;
    }
