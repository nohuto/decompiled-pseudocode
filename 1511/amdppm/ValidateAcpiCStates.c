/*
 * XREFs of ValidateAcpiCStates @ 0x1C001C85C
 * Callers:
...
LABEL_8:
  ...
  if ( v2 )
  {
    for ( i = a1 + 4;
       ...
       && *i != 1
       && (*i == 2
        || IsValidAcpiGenericAddress((char *)&dword_1C0009AB4) && IsValidAcpiGenericAddress((char *)&dword_1C0009A84))
       && IsValidAcpiGenericAddress((char *)&dword_1C0009A9C);
          i += 20 )
    {
      if ( ++v5 >= v2 )
        return v1;
