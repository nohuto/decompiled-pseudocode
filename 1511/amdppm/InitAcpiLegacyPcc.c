/*
 * XREFs of InitAcpiLegacyPcc @ 0x1C001D9F8
 * Callers:
...
__int64 __fastcall InitAcpiLegacyPcc(_QWORD *a1)
{
  ...
  if ( v2 >= 0 )
  {
    (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, _QWORD, _QWORD))(WdfFunctions_01015 + 2504))(
      ...
      a1[24],
      0LL);
    v2 = AcpiEval_PCCP((__int64)a1, a1 + 64);
    if ( v2 >= 0 )
    {
      v2 = -1073741811;
      v3 = (_DWORD *)a1[64];
      if ( qword_1C0009810 && *v3 <= (unsigned int)(dword_1C0009818 - 4) )
        v2 = (unsigned int)(dword_1C0009818 - 4) < v3[1] ? 0xC000000D : 0;
      if ( v2 < 0 )
        goto LABEL_9;
      if ( (unsigned int)(dword_1C000980C - 1) <= 0x26 )
      {
        v2 = -1073741823;
LABEL_9:
        a1[31] &= ~0x80000000uLL;
