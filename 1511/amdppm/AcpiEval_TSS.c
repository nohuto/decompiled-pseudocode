/*
 * XREFs of AcpiEval_TSS @ 0x1C0010424
 * Callers:
...
__int64 __fastcall AcpiEval_TSS(__int64 a1, _QWORD *a2)
{
  ...
  v35 = AcpiParseULong;
  P = 0LL;
  _InterlockedOr((volatile signed __int32 *)(a1 + 1036), 0x800u);
  v6 = AcpiEvaluateMethod(a1, 1397970015, 0LL, (unsigned int **)&P, &v15);
  if ( v6 >= 0 )
  {
    *(_QWORD *)(a1 + 240) |= *(_DWORD *)(a1 + 248) & 0x3000000;
    if ( v15 && (v7 = (unsigned int *)P, (v9 = *((_DWORD *)P + 2)) != 0) )
    {
...
LABEL_4:
  _InterlockedOr((volatile signed __int32 *)(a1 + 1040), 0x800u);
  v7 = (unsigned int *)P;
LABEL_5:
  if ( v7 )
