/*
 * XREFs of PepParkMask @ 0x1C0004DB0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PepParkMask(__int64 a1, __int64 a2)
{
  ...
  if ( !PepSkipParkNotification && dword_1C0009870 >= (unsigned int)dword_1C00093A4 )
  {
    memset(PepParkLists, 0, (unsigned int)(16 * dword_1C00093A4));
    v4 = 0;
    KeInitializeEnumerationContext(v10, &unk_1C0009638);
    if ( !(unsigned int)KeEnumerateNextProcessor(&v11, v10) )
    {
      do
      {
        ...
        *(_QWORD *)&PepParkLists[16 * v4] = *(_QWORD *)(v6 + 1048);
      ...
      if ( v4 )
      {
        ...
        v7 = v4;
        v9 = PepParkLists;
        if ( (int)((__int64 (__fastcall *)(_QWORD, int *))qword_1C0009610)(*(_QWORD *)(v6 + 1048), &v7) < 0 )
