    ...
    if ( ProcessorNumber >= 0 )
    {
      ...
      else
      {
        if ( (v5 & 0x8000000) == 0 )
        {
          ...
          {
            v25 = 2;
            v10 = *(unsigned int *)(qword_1C0009810 + 28);
            v22 = v10;
            v24 = 100 * *(_DWORD *)(qword_1C0009810 + 36) / (unsigned int)v10;
            v23 = 100 * *(_DWORD *)(qword_1C0009810 + 32) / (unsigned int)v10;
          }
          else
          {
            if ( (v5 & 0x73300000) == 0 )
        ...
        if ( !v13 )
        {
          ...
          if ( RegistryDwordValueNoDefault < 0 )
            v10 = 0LL;
          v16 = 100LL * *(_QWORD *)(a1 + 328);
          v22 = v10;
          v27 = v16 / v15;
          v17 = 100LL * *(_QWORD *)(a1 + 344) / v15;
          v18 = 100LL * *(_QWORD *)(a1 + 352) / v15;
          if ( !(_DWORD)v18 )
            LODWORD(v18) = 1;
          v23 = v18;
          if ( !(_DWORD)v17 )
