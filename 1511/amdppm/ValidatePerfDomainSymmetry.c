/*
 * XREFs of ValidatePerfDomainSymmetry @ 0x1C001CAC0
 * Callers:
 ...
 *     ValidatePctPtcSymmetry @ 0x1C001CF3C (ValidatePctPtcSymmetry.c)
 */
...
__int64 __fastcall ValidatePerfDomainSymmetry(_QWORD *a1)
{
  ...
  _QWORD v43[2]; // [rsp+40h] [rbp-91h] BYREF
  _QWORD *v44; // [rsp+50h] [rbp-81h]
...
LABEL_57:
      ...
      if ( (v9 & 0x70000000) == 0 )
        goto LABEL_29;
      if ( (int)ValidatePctPtcSymmetry(v8, v1 + 45, v5, v1 + 45) < 0 )
      {
        v3 |= 0x70000000uLL;
        v42 = v3;
      }
      ...
      if ( (v9 & 0x40000000) != 0 )
      {
        v8 = v1[49];
        v10 = (_DWORD *)v7[49];
        if ( !v8 || !v10 || (v11 = *(_DWORD *)v8, *(_DWORD *)v8 != *v10) )
        {
LABEL_18:
          v3 |= 0x40000000uLL;
          v42 = v3;
...
LABEL_29:
      if ( (v9 & 0x3300000) != 0 )
      {
        if ( (int)ValidatePctPtcSymmetry(v8, v1 + 52, v5, v1 + 52) < 0 )
        {
          v3 |= 0x3300000uLL;
          v42 = v3;
        }
        v16 = (char *)v1[55];
        v17 = (_DWORD *)v7[55];
        if ( !v16 || !v17 || (v18 = *(_DWORD *)v16, *(_DWORD *)v16 != *v17) )
        {
LABEL_40:
          v3 |= 0x3300000uLL;
          v42 = v3;
