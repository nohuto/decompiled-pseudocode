/*
 * XREFs of DecodeAcpiTStates @ 0x1C001BC28
 * Callers:
 *     RegisterHvPerfStates @ 0x1C001A490 (RegisterHvPerfStates.c)
 * Callees:
 *     DecodeControlStatusRegisterIo @ 0x1C001BD54 (DecodeControlStatusRegisterIo.c)
 */
        ...
        _DWORD *a7)
{
  ...
  *a5 = 0LL;
  *a7 = 0;
  if ( v12 == 127 && (*(_DWORD *)(a1 + 248) & 0x2000000) != 0 && dword_1C0009570 )
  {
    *a2 = *a2 & 0xFFFFFFFFFFFFFLL | 0x10000000000000LL;
    *(_DWORD *)a2 = dword_1C0009570;
    *a4 = qword_1C0009578;
  }
