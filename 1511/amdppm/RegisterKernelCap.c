/*
 * XREFs of RegisterKernelCap @ 0x1C0017780
 * Callers:
...
__int64 __fastcall RegisterKernelCap(__int64 a1)
{
  ...
  else
  {
    ...
    v9 = 0LL;
    v10 = *(_DWORD *)(v8 + 44);
    if ( !v10 || (v9 = *(unsigned int *)(a1 + 400), (_DWORD)v9 == v10 - 1) )
    {
      if ( *(_DWORD *)(v8 + 48) )
        v9 = (unsigned int)(v10 + *(_DWORD *)(a1 + 448));
    }
  ...
  HIDWORD(v16) = *(_DWORD *)(a1 + 664);
  v12 = v17;
  if ( v4 < 0x64 )
    v12 = v3;
  LODWORD(v16) = v4;
  v17 = v12;
  ((void (__fastcall *)(int *))qword_1C0009590)(&v14);
  return 0LL;
}
