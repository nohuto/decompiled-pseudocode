/*
 * XREFs of AcpiEval_CSD @ 0x1C001071C
 * Callers:
 *     InitAcpiIdleDomain @ 0x1C0018C88 (InitAcpiIdleDomain.c)
 * Callees:
...
__int64 __fastcall AcpiEval_CSD(__int64 a1, _QWORD *a2)
{
  ...
  v39 = AcpiParseULong;
  P = 0LL;
  _InterlockedOr((volatile signed __int32 *)(a1 + 1036), 0x10u);
  v6 = AcpiEvaluateMethod(a1, 1146307423, 0LL, (unsigned int **)&P, &v15);
  if ( v6 >= 0 )
  {
    if ( v15 && (v7 = P, (v9 = *((_DWORD *)P + 2)) != 0) )
    {
...
LABEL_4:
  _InterlockedOr((volatile signed __int32 *)(a1 + 1040), 0x10u);
  if ( v5 )
