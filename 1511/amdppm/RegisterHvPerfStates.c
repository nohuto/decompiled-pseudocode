/*
 * XREFs of RegisterHvPerfStates @ 0x1C001A490
 * Callers:
 *     <none>
 * Callees:
 ...
 *     DecodeAcpiPStates @ 0x1C001BA84 (DecodeAcpiPStates.c)
 *     DecodeAcpiTStates @ 0x1C001BC28 (DecodeAcpiTStates.c)
 */
...
LABEL_18:
    ...
    if ( v3 )
      v3[770] = dword_1C0009760;
    if ( v5 )
      v5[802] = dword_1C0009760;
    ++dword_1C0009760;
    v8 = 0;
