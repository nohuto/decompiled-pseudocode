/*
 * XREFs of UpdateKernelPlatformStates @ 0x1C0002E90
 * Callers:
...
LABEL_26:
    ...
    ProcessorNumberFromIndex = ((__int64 (__fastcall *)(_BYTE *))qword_1C00095B0)(v3);
  ...
  if ( v4 )
  {
    ...
    if ( v6 )
    {
      ...
      do
      {
        ...
        *v4 = v21;
        v4[8] = v5;
        if ( (int)((__int64 (__fastcall *)(_QWORD, _DWORD *, __int64))qword_1C0009620)(*(_QWORD *)(a1 + 1048), v4, v23) >= 0 )
        {
