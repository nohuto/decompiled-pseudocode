/*
 * XREFs of GetWmiBiosInfoV1 @ 0x1C00019C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_18:
  ...
  *(_DWORD *)(a3 + 16) = *(_DWORD *)(v10 + 56);
  do
  {
    v14 = *((unsigned __int8 *)v11 + v13++ + 360);
    *v12++ = v14;
  }
  while ( v13 < 4 );
  v15 = (_DWORD *)(a3 + 48);
  *(_QWORD *)(a3 + 40) = *(_QWORD *)((char *)v11 + 364);
  for ( i = 0LL; i < 4; ++i )
  {
    v17 = *((unsigned __int8 *)v11 + i + 372);
    *v15++ = v17;
  }
  *(_QWORD *)(a3 + 64) = v11[47];
  v18 = (unsigned int *)v11[48];
  if ( !v18 )
  {
    *(_QWORD *)(a3 + 72) = 0LL;
    *(_QWORD *)(a3 + 80) = 0LL;
