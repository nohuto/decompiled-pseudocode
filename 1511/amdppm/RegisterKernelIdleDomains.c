/*
 * XREFs of RegisterKernelIdleDomains @ 0x1C0016630
 * Callers:
...
LABEL_20:
      ...
      *(_QWORD *)(v20 + 24) = v25;
      ...
      if ( *(_DWORD *)(v20 + 32) != *(_DWORD *)(v20 + 44) )
        goto LABEL_29;
      v27 = i;
      v28 = *(_DWORD *)(*(_QWORD *)(a1 + 472) + 24 * (i + 1LL));
      if ( v28 < *v5 )
        break;
LABEL_30:
      v29 = *(_DWORD **)(a1 + 472);
    ...
    KeOrAffinityEx(*(_QWORD *)(32LL * v28 + *(_QWORD *)(a1 + 656) + 16) + 48LL, v35, v35);
LABEL_29:
    v27 = i;
    goto LABEL_30;
  }
