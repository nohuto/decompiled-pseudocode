/*
 * XREFs of InitAcpi1CStates @ 0x1C0015080
 * Callers:
...
__int64 __fastcall InitAcpi1CStates(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_QWORD *)(a1 + 240) |= v3 & 7;
  ...
  if ( (v3 & 2) != 0
    ...
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0009A9C, v3, a3, 1LL)
    && (unsigned __int8)IsValidAcpiGenericAddress(a1 + 168, v3, a3, v8)
    && dword_1C00093A4 == (_DWORD)v8 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1032), v8);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1036), v8);
    v8 = 2LL;
    v6 = 1;
  }
  if ( (*(_BYTE *)(a1 + 248) & 4) != 0
    && (unsigned __int16)word_1C0009A82 <= 0x3E8u
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0009AB4, v3, a3, v8)
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0009A84, v9, v10, v8)
    && (unsigned __int8)IsValidAcpiGenericAddress(&dword_1C0009A9C, v11, v12, v8)
    && (unsigned __int8)IsValidAcpiGenericAddress(a1 + 168, v13, v14, v8)
    && dword_1C00093A4 == 1 )
  {
    _InterlockedOr((volatile signed __int32 *)(a1 + 1032), 2u);
    _InterlockedOr((volatile signed __int32 *)(a1 + 1036), 2u);
    LODWORD(v8) = v8 + 1;
    v7 = 1;
  }
  ...
  if ( PoolWithTag )
  {
    ...
    *((_WORD *)v17 + 9) = 0;
    ...
    if ( v7 )
    {
      ...
      HIWORD(v17[5 * *v17 + 4]) = word_1C0009A82;
      v17[5 * *v17 + 5] = 0;
      if ( *(_DWORD *)(a1 + 172) != -5 )
      {
        LOBYTE(v17[5 * *v17 + 1]) = 1;
