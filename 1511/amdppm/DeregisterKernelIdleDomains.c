/*
 * XREFs of DeregisterKernelIdleDomains @ 0x1C0016960
 * Callers:
...
__int64 __fastcall DeregisterKernelIdleDomains(__int64 a1)
{
  ...
  if ( v2 )
  {
    ...
    if ( *v2 )
    {
      do
      {
        v5 = (_QWORD *)(32LL * v4 + *(_QWORD *)(a1 + 656) + 8LL);
        v6 = v5[1];
        if ( v6 )
        {
          KeCopyAffinityEx(v29, v6 + 48);
          v7 = *(unsigned int **)(a1 + 656);
          v8 = 1;
          v9 = (_QWORD *)v5[1];
          v10 = v9 + 2;
    ...
    v23 = *(_DWORD *)(*(_QWORD *)(a1 + 640) + 56LL);
    v24 = 0LL;
    for ( j = 0; (unsigned int)v24 < v23; j = v24 )
    {
      *(_QWORD *)(*(_QWORD *)(a1 + 640) + 72 * v24 + 120) = 0LL;
      v24 = j + 1;
    }
    ExFreePoolWithTag(*(PVOID *)(a1 + 656), 0x72637250u);
    *(_QWORD *)(a1 + 656) = 0LL;
  }
  else
  {
