/*
 * XREFs of USBParseGetMicArrayDescriptor @ 0x1C001CAFC
 * Callers:
...
__int64 __fastcall USBParseGetMicArrayDescriptor(__int64 a1, __int64 a2, _QWORD *a3)
{
  ...
  {
    PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, v18, 0x41627845u);
    if ( PoolWithTag )
    {
...
LABEL_13:
  ...
  {
    v12 = *(void **)(a1 + 8);
    v16 = ExAllocatePoolWithTag(PagedPool, 12 * ((unsigned int)(unsigned __int16)PoolWithTag[17] - 1) + 30, 0x41627845u);
    v7 = v16;
    if ( v16 )
