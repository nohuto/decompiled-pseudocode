/*
 * XREFs of USBMidiInPipePrimer @ 0x1C0020E64
 * Callers:
 ...
 *     USBMidiInInitializeUrbAndIrp @ 0x1C0020D7C (USBMidiInInitializeUrbAndIrp.c)
 */
...
__int64 __fastcall USBMidiInPipePrimer(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  if ( v6 )
  {
    ...
    *(_BYTE *)(*(_QWORD *)(a2 + 40) + v15 + 40) = 0;
    KeInitializeEvent((PRKEVENT)(*(_QWORD *)(a2 + 40) + v15 + 136), NotificationEvent, 0);
    KeInitializeEvent((PRKEVENT)(*(_QWORD *)(a2 + 40) + v15 + 112), NotificationEvent, 0);
    KeInitializeSpinLock((PKSPIN_LOCK)(*(_QWORD *)(a2 + 40) + v15 + 104));
    ...
    *v16 = v16;
    if ( a4 )
    {
      *(_QWORD *)(*(_QWORD *)(a2 + 40) + v15 + 96) = IoAllocateWorkItem(*(PDEVICE_OBJECT *)(v7 + 40));
      ...
      PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, 16 * bDescriptorType * ((unsigned int)*v21 + 192), 0x41627845u);
