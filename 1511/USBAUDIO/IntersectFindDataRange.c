/*
 * XREFs of IntersectFindDataRange @ 0x1C001588C
 * Callers:
 *     PinDataFormatIntersection @ 0x1C0014C50 (PinDataFormatIntersection.c)
 * Callees:
 *     IntersectFindBestMatch @ 0x1C0015700 (IntersectFindBestMatch.c)
 */
