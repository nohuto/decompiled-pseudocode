/*
 * XREFs of USBHwGetSetByte @ 0x1C001B630
 * Callers:
 *     USBCntrlGetSetBoolean @ 0x1C001F340 (USBCntrlGetSetBoolean.c)
 *     USBType1SetCopyProtect @ 0x1C001FEA0 (USBType1SetCopyProtect.c)
 * Callees:
