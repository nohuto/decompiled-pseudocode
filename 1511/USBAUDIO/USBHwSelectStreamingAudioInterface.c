/*
 * XREFs of USBHwSelectStreamingAudioInterface @ 0x1C001BB9C
 * Callers:
...
__int64 __fastcall USBHwSelectStreamingAudioInterface(__int64 a1, _BYTE *a2)
{
  ...
  if ( !*(_BYTE *)(v6 + 64) && !*(_BYTE *)(v6 + 67) )
  {
    ...
    v9 = 24 * (v8 + 1);
    v29 = 24 * (v8 - 1) + 80;
    PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPool, v29, 0x41627845u);
    v11 = PoolWithTag;
    if ( !PoolWithTag )
    {
LABEL_32:
      ...
      if ( !v27 )
      {
        ...
        *(_QWORD *)(v20 + 64) = *((_QWORD *)v11 + 8);
        ...
        else
        {
          ...
          v24 = ExAllocatePoolWithTag(NonPagedPool, 24LL * *(unsigned int *)(v20 + 56), 0x41627845u);
          *(_QWORD *)(v20 + 72) = v24;
          if ( !v24 )
            v4 = -1073741670;
        }
