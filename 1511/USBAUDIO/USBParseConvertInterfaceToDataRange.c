/*
 * XREFs of USBParseConvertInterfaceToDataRange @ 0x1C001E70C
 * Callers:
        ...
        __int64 a3)
{
  ...
  PUSB_COMMON_DESCRIPTOR v10; // r13
  ...
  PUSB_COMMON_DESCRIPTOR v17; // rdx
  UCHAR bLength; // al
  ...
  *(_DWORD *)(a3 + 208) = *(unsigned __int16 *)&v10[2].bDescriptorType;
  *(_QWORD *)(a3 + 136) = a2;
  ...
  *(_DWORD *)(a3 + 212) = (unsigned __int16)EndpointDescriptor[2];
  ...
  {
    v33 = EndpointDescriptor[4].bLength & 0xF;
    ...
    v14 = USBParseFindDescriptorInConfiguration(
            ...
            5);
    v15 = v14;
    if ( !v14 || (v14[1].bLength & 0xF) != v33 || NextAudioInterface && v14 > (PUSB_COMMON_DESCRIPTOR)NextAudioInterface )
      v15 = 0LL;
    *(_QWORD *)(a3 + 176) = v15;
  }
  ...
  *(_QWORD *)(a3 + 160) = v16;
  ...
  else
  {
    if ( !*(_WORD *)&v10[2].bDescriptorType )
      return (unsigned int)-1073741198;
    if ( *(unsigned __int16 *)&v10[2].bDescriptorType <= 2u )
    {
  ...
  *(_DWORD *)(a3 + 72) = v25;
  ...
  v6 = p_bLength[7];
LABEL_46:
  v26 = *v5 + ((v5[1] + (v5[2] << 8)) << 8);
  *(_DWORD *)(a3 + 76) = v26;
  *(_DWORD *)(a3 + 80) = v26;
  *(_DWORD *)(a3 + 108) = v6;
  if ( v6 )
  {
    PoolWithTag = ExAllocatePoolWithTag(PagedPool, 4LL * v6, 0x41627845u);
  ...
  {
    *(_DWORD *)(a3 + 80) = v5[3] + ((v5[4] + (v5[5] << 8)) << 8);
  }
  return v3;
}
