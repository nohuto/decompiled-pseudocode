/*
 * XREFs of USBHwSyncGetStringDescriptor @ 0x1C001C180
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  if ( Descriptor >= 0
    || ((a5 = 255, (v12 = ExAllocatePoolWithTag(NonPagedPool, 0x88uLL, 0x41627845u)) == 0LL)
      ? (v13 = -1073741670)
        ...
        v13 >= 0) )
  {
    ...
    v15 = v14;
    a5 = v14;
    PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, 0x88uLL, 0x41627845u);
    if ( PoolWithTag )
    {
