/*
 * XREFs of USBDeviceStart @ 0x1C001AAD0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     USBHwGetAudioConfigurationDescriptor @ 0x1C001B898 (USBHwGetAudioConfigurationDescriptor.c)
 *     USBHwSelectAudioConfiguration @ 0x1C001B9F8 (USBHwSelectAudioConfiguration.c)
 *     USBHwGetDeviceIDString @ 0x1C001C2E4 (USBHwGetDeviceIDString.c)
 *     USBHwLogStartFailure @ 0x1C001C584 (USBHwLogStartFailure.c)
...
__int64 __fastcall USBDeviceStart(__int64 a1)
{
  ...
  if ( !Irp )
    goto LABEL_11;
  PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, 0x48uLL, 0x41627845u);
  if ( PoolWithTag )
  {
...
LABEL_12:
  ...
  LODWORD(v37) = 18;
  Status = -1073741670;
  v13 = (unsigned __int16 *)ExAllocatePoolWithTag(NonPagedPool, 0x12uLL, 0x41627845u);
  if ( v13 )
  {
    v14 = ExAllocatePoolWithTag(NonPagedPool, 0x88uLL, 0x41627845u);
    if ( v14 )
  ...
  if ( Status < 0 )
    goto LABEL_97;
  if ( ExAllocatePoolWithTag(NonPagedPool, 9uLL, 0x41627845u) )
  {
  ...
  {
    *(_QWORD *)(v3 + 48) = v19;
    AudioSpecificInterface = USBParseGetAudioSpecificInterface(v4, v19);
    if ( AudioSpecificInterface )
    {
      v21 = *(unsigned __int16 *)(AudioSpecificInterface + 3);
      *(_DWORD *)(v3 + 8) = v21;
      if ( v21 >= 0x200 )
        Status = -1073741735;
      goto LABEL_67;
...
LABEL_97:
  ...
  if ( *((_BYTE *)v2 + 15) )
  {
    ...
    do
      ++v11;
    while ( v35[v11] );
    USBHwLogStartFailure(a1, (unsigned int)DeviceIDString, v35);
    v27 = v39;
  }
  else
  {
...
LABEL_83:
  *(_BYTE *)(v3 + 212) = 0;
  ...
  v37 = 0LL;
  if ( (int)RegistryReadPnPKeyValue(v28, L"CapturePacketsPerUrb", v23, &v37) >= 0 )
  {
    v29 = v37;
    v30 = *(_DWORD *)v37;
    if ( *(_DWORD *)v37 >= 3u )
