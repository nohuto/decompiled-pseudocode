/*
 * XREFs of USBHwStopAllMIDIPipes @ 0x1C001C114
 * Callers:
 *     USBDeviceStop @ 0x1C001B210 (USBDeviceStop.c)
 *     USBDeviceSetPowerState @ 0x1C001B300 (USBDeviceSetPowerState.c)
 * Callees:
 *     USBHwStopMIDIPipe @ 0x1C00024EC (USBHwStopMIDIPipe.c)
 */
