/*
 * XREFs of DeviceStart @ 0x1C0013250
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RegistryGetIdleInfo @ 0x1C001A0F4 (RegistryGetIdleInfo.c)
 *     InitializeIrpThreadAndQueue @ 0x1C001A760 (InitializeIrpThreadAndQueue.c)
 */
