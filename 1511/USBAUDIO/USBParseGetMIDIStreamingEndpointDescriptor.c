/*
 * XREFs of USBParseGetMIDIStreamingEndpointDescriptor @ 0x1C001D128
 * Callers:
        ...
        unsigned int a3)
{
  ...
  DescriptorInConfiguration = USBParseFindDescriptorInConfiguration(a1, (char *)&v7[*v7], 37);
  if ( !DescriptorInConfiguration )
    return 0LL;
  v10 = a3 + 1;
  if ( (unsigned int)v10 >= v4[4] )
  {
    v12 = USBParseFindDescriptorInConfiguration(a1, (char *)&v4[*v4], 4);
    if ( !v12 )
