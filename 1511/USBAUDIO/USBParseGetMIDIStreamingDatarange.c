/*
 * XREFs of USBParseGetMIDIStreamingDatarange @ 0x1C001ECA8
 * Callers:
        ...
        _QWORD *PoolWithTag)
{
  ...
  unsigned int bDescriptorType; // edx
  struct _USB_COMMON_DESCRIPTOR *v25; // rcx
  __int64 v26; // rdx
  char v27; // al
  int v28; // eax
  bool v29; // zf
  ...
  if ( i == v13 )
  {
    ...
    PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, v16, 0x41627845u);
    i = PoolWithTag;
    if ( PoolWithTag )
    ...
    *v13 = i;
    i[3] = v11;
    i[6] = i + 7;
    DescriptorInConfiguration = USBParseFindDescriptorInConfiguration((unsigned __int16 *)&a2->bLength, (char *)v11, 36);
  ...
  if ( v8 >= 0 )
  {
    ...
    if ( v11->bNumEndpoints )
    {
      while ( 1 )
      {
        ...
        if ( (unsigned int)v22 >= v11->bNumEndpoints )
        {
          if ( !v21 )
      ...
      *((_OWORD *)v12 + 1) = xmmword_1C000ACA0;
      *((_OWORD *)v12 + 2) = xmmword_1C000ACB0;
      *((_OWORD *)v12 + 3) = xmmword_1C000ACC0;
      *((_DWORD *)v12 + 24) = v27 < 0 ? 16 : 8;
      *((_OWORD *)v12 + 4) = xmmword_1C000ACD0;
      *((_OWORD *)v12 + 5) = xmmword_1C000ACE0;
      *a5 = v12;
      v28 = 88;
      v29 = *((_DWORD *)v12 + 24) == 16;
      if ( *((_DWORD *)v12 + 24) == 16 )
        v28 = 32864;
      *((_DWORD *)v12 + 28) = v28;
