/*
 * XREFs of USBHwSelectAudioConfiguration @ 0x1C001B9F8
 * Callers:
 ...
 *     USBParseCreateMIDLegacyInterfaceList @ 0x1C001C908 (USBParseCreateMIDLegacyInterfaceList.c)
