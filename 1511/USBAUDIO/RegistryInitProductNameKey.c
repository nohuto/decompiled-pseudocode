/*
 * XREFs of RegistryInitProductNameKey @ 0x1C0019EC8
 * Callers:
 *     FilterInitComponentId @ 0x1C0013C04 (FilterInitComponentId.c)
 * Callees:
 *     RegistryCreateMediaCategoriesKey @ 0x1C0019DF4 (RegistryCreateMediaCategoriesKey.c)
 */
