/*
 * XREFs of PinMatchChannelConfigToFormat @ 0x1C001405C
 * Callers:
 *     PinValidateDataFormat @ 0x1C0014108 (PinValidateDataFormat.c)
 *     IntersectConvertDatarangeToFormat @ 0x1C0015580 (IntersectConvertDatarangeToFormat.c)
 * Callees:
