/*
 * XREFs of USBHwSelectStreamingMIDIInterface @ 0x1C001BE54
 * Callers:
...
__int64 __fastcall USBHwSelectStreamingMIDIInterface(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( !*(_BYTE *)(v8 + 4) )
    return 3221225858LL;
  v10 = 24 * (v9 + 1);
  PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, (unsigned int)(24 * (v9 - 1) + 80), 0x41627845u);
  v11 = PoolWithTag;
  i = -1073741670;
  if ( PoolWithTag )
  {
    ...
    *(_BYTE *)(a2 + 16) = 1;
    ...
    if ( a3 )
    {
      *(_DWORD *)(a2 + 32) = v22;
      v23 = *(void **)(a1 + 8);
      v24 = ExAllocatePoolWithTag(NonPagedPool, (unsigned int)(168 * v22), 0x41627845u);
      *(_QWORD *)(a2 + 40) = v24;
      if ( v24 )
