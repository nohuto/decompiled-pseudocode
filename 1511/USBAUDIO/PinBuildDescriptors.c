/*
 * XREFs of PinBuildDescriptors @ 0x1C0014D94
 * Callers:
 ...
 *     PinGetTerminalUnit @ 0x1C0014D64 (PinGetTerminalUnit.c)
 */
...
__int64 __fastcall PinBuildDescriptors(__int64 a1, _QWORD *a2, _DWORD *a3, _DWORD *a4)
{
  ...
  __int64 v76; // [rsp+60h] [rbp-51h] BYREF
  int v77; // [rsp+68h] [rbp-49h] BYREF
  unsigned int v78; // [rsp+6Ch] [rbp-45h]
  char *v79; // [rsp+70h] [rbp-41h] BYREF
  unsigned __int64 v80; // [rsp+78h] [rbp-39h] BYREF
  _QWORD *v81; // [rsp+80h] [rbp-31h]
  _QWORD *v82; // [rsp+88h] [rbp-29h]
  char *v83; // [rsp+90h] [rbp-21h]
  ...
  *a4 = 176;
  ...
  if ( v23 <= 0xFFFFFFFF
    ...
    && (v24 = v23 + v22,
        v15 = 0,
        PoolWithTag = ExAllocatePoolWithTag(NonPagedPool, (unsigned int)v23 + v22, 0x41627845u),
        v82 = PoolWithTag,
        v26 = PoolWithTag,
        (*a2 = PoolWithTag) != 0LL) )
  {
    ...
    v83 = v28;
    v79 = &v28[v23];
    v76 = (__int64)&v28[16 * v88 + v23];
    v80 = v76 + 8 * (v87 + (unsigned __int64)v75);
    if ( v9 )
    {
      v30 = (char *)v26 + 68;
      v31 = v76;
      ...
      while ( 1 )
      {
        ...
        *(_DWORD *)((char *)v26 + v57 + 68) = 4;
        ...
        if ( v15 >= 0 )
        {
          ...
          v68 = (unsigned __int16 *)&unk_1C000A2F2;
          v69 = 0LL;
