/*
 * XREFs of PbmReportApplicationState @ 0x1800051A4
 * Callers:
 *     s_pbmReportApplicationState @ 0x180005350 (s_pbmReportApplicationState.c)
 * Callees:
...
__int64 __fastcall PbmReportApplicationState(void *a1, __int64 a2, unsigned int a3)
{
  ...
  if ( g_ApplicationManager )
  {
    ...
    else
    {
      ...
      if ( v7 >= 0 )
      {
        v5 = QueueApplicationManagerWorkItem<ApplicationStateChangedContext>(v9, (__int64)v13);
        if ( v5 >= 0 )
          v10 = 0LL;
      }
      if ( v10 )
