/*
 * XREFs of ?GetPacketSizesFromConstraints@@YAJPEBU_KSAUDIO_PACKETSIZE_CONSTRAINTS@@KGU_GUID@@_K22PEAI333@Z @ 0x1800A6B18
 * Callers:
        ...
        unsigned int *a11)
{
  ...
  unsigned int v34[17]; // [rsp+24h] [rbp-44h] BYREF
  ...
  if ( *((_DWORD *)a1 + 3) )
  {
    while ( *((_QWORD *)a1 + 3 * v27 + 2) != *(_QWORD *)&a4->Data1
         || *((_QWORD *)a1 + 3 * v27 + 3) != *(_QWORD *)a4->Data4 )
    {
      if ( ++v27 >= *((_DWORD *)a1 + 3) )
        goto LABEL_22;
    }
    v28 = 3LL * v27;
    if ( v12 <= *((unsigned int *)a1 + 2 * v28 + 9) )
      v12 = *((unsigned int *)a1 + 2 * v28 + 9);
    if ( *((_DWORD *)a1 + 2 * v28 + 8) )
      v21 = *((_DWORD *)a1 + 2 * v28 + 8);
  }
LABEL_22:
  v29 = v33;
  if ( (int)HnsToBlocksRU(v12, v33, v15, v34) < 0 )
    goto LABEL_29;
  v30 = v34[0];
  if ( v21 > v34[0] )
    v30 = v21;
  ...
  if ( a11 )
  {
    if ( (int)HnsToBlocksRU(0x186A0uLL, v29, v15, &v33) < 0 )
    {
LABEL_29:
      v23 = -2004287480;
        ...
        && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
      {
        WPP_SF_D(
          *((_QWORD *)WPP_GLOBAL_Control + 2),
          0xAu,
          (__int64)&WPP_3a6e6d7d967de63f72de1f5a056e09fa_Traceguids,
          -2004287480);
      }
      return v23;
    }
