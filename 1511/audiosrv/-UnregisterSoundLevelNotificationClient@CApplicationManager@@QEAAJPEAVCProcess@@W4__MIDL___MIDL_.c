/*
 * XREFs of ?UnregisterSoundLevelNotificationClient@CApplicationManager@@QEAAJPEAVCProcess@@W4__MIDL___MIDL_itf_audiosrv_0000_0000_0002@@@Z @ 0x18009F2E4
 * Callers:
...
__int64 __fastcall CApplicationManager::UnregisterSoundLevelNotificationClient(__int64 a1, struct CProcess *a2, int a3)
{
  ...
  CProcess::RegisteredForSoundLevelNotifications((__int64)a2, 0, a3);
