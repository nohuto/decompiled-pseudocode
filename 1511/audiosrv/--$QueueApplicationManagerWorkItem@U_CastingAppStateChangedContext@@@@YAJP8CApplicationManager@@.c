/*
 * XREFs of ??$QueueApplicationManagerWorkItem@U_CastingAppStateChangedContext@@@@YAJP8CApplicationManager@@EAAJPEAU_CastingAppStateChangedContext@@@Z0@Z @ 0x180003164
 * Callers:
...
__int64 __fastcall QueueApplicationManagerWorkItem<_CastingAppStateChangedContext>(__int64 a1, __int64 a2)
{
  ...
  if ( v3 )
  {
    *v3 = &CGenericApplicationManagerWorkItem<_CastingAppStateChangedContext>::`vftable';
