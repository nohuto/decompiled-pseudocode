/*
 * XREFs of ?GrowBuffer@?$CAtlArray@VCVolumeUnit@@V?$CElementTraits@VCVolumeUnit@@@ATL@@@ATL@@AEAA_N_K@Z @ 0x18004239C
 * Callers:
...
char __fastcall ATL::CAtlArray<CVolumeUnit,ATL::CElementTraits<CVolumeUnit>>::GrowBuffer(__int64 a1, size_t a2)
{
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    if ( v8 )
    {
      v10 = memmove_s(v8, 56LL * *(_QWORD *)(a1 + 8), *(const void *const *)a1, 56LL * *(_QWORD *)(a1 + 8));
      if ( v10 )
      {
        if ( v10 == 12 )
