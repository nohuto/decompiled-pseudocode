/*
 * XREFs of ?FindMuteControlForEndpoint@CMuteHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x18004135C
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 19LL, &WPP_f04eba8ba5fc4b283a8b90cd0990f6b1_Traceguids, this);
    v6 = v17;
  }
  if ( a2 )
  {
      ...
      if ( v7 >= 0 )
      {
        ...
        if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control )
        {
          ...
          if ( v8 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
            ...
            && *((_BYTE *)v8 + 25) >= 4u )
          {
            WPP_SF_q(*((_QWORD *)v8 + 2), 21LL, &WPP_f04eba8ba5fc4b283a8b90cd0990f6b1_Traceguids, this);
          }
        }
        v9 = v17;
        if ( v17 != a2 )
