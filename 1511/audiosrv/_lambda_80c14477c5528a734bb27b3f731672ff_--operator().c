/*
 * XREFs of _lambda_80c14477c5528a734bb27b3f731672ff_::operator() @ 0x18008DFDC
 * Callers:
...
__int64 __fastcall lambda_80c14477c5528a734bb27b3f731672ff_::operator()(__int64 a1, _QWORD *a2)
{
  __int64 v3; // rdi
  ...
  if ( **(int **)a1 >= 0 && (int)Microsoft::WRL::WeakRef::As<IInspectable>(a2, v5) >= 0 && v5[0] )
  {
    ...
    if ( (int)Microsoft::WRL::ComPtr<IInspectable>::As<IStreamGroupProxy>(v5, &v8) >= 0 )
    {
      ...
      if ( (*(int (__fastcall **)(__int64, __int64 *))(*(_QWORD *)v3 + 176LL))(v3, &v7) >= 0
        && v7 == **(_QWORD **)(a1 + 8) )
      {
        try
        {
