/*
 * XREFs of ?UnregisterStreamVolumeNotifications@CAudioStream@@UEAAJPEAUIAudioStreamVolumeCallback@@@Z @ 0x18007DDE0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct IAudioStreamVolumeCallback *a2)
{
  ...
  v9 = a2;
  ATL::CCritSecLock::CCritSecLock((ATL::CCritSecLock *)&v7, (struct _RTL_CRITICAL_SECTION *)((char *)this + 184));
  v4 = 0;
  if ( a2 )
  {
    ...
    if ( v5 )
    {
      ATL::CAtlList<unsigned long,ATL::CElementTraits<unsigned long>>::RemoveAt((char *)this + 224, v5);
