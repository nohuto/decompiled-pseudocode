/*
 * XREFs of ??0CPolicyConfig@@QEAA@XZ @ 0x18004320C
 * Callers:
...
CPolicyConfig *__fastcall CPolicyConfig::CPolicyConfig(CPolicyConfig *this)
{
  ...
  *((_DWORD *)this + 28) = 10;
  ...
  `eh vector constructor iterator'(
    ...
    0x48uLL,
    3,
    (void (*)(void *))ATL::CAtlMap<unsigned long,ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>,ATL::CElementTraits<unsigned long>,ATL::CElementTraits<ATL::CStringT<unsigned short,ATL::StrTraitATL<unsigned short,ATL::ChTraitsCRT<unsigned short>>>>>::`default constructor closure',
