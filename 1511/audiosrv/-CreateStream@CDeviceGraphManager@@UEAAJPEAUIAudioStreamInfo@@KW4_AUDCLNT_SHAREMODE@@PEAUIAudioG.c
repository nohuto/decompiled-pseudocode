/*
 * XREFs of ?CreateStream@CDeviceGraphManager@@UEAAJPEAUIAudioStreamInfo@@KW4_AUDCLNT_SHAREMODE@@PEAUIAudioGraphCallback@@KPEAUAUDIO_DEVICE_MODE_DESCRIPTOR@@PEAUSYSTEM_AUDIO_STREAM_DESCRIPTOR@@PEAUStreamGroupParams@@PEAUSYSTEM_AUDIO_STREAM@@@Z @ 0x180007B10
 * Callers:
 *     <none>
 * Callees:
        ...
        struct SYSTEM_AUDIO_STREAM *a10)
{
  ...
  __int64 (__fastcall *v15)(CSharedStreamGroupProxy *, struct IAudioStreamInfo *, struct SYSTEM_AUDIO_STREAM_DESCRIPTOR *, struct IAudioGraphCallback *, struct SYSTEM_AUDIO_STREAM *); // rbp
  int Stream; // eax
  CSharedStreamGroupProxy *v17; // r14
    ...
    if ( StreamGroup < 0
      || ((v14 = v19,
           *((_QWORD *)a8 + 13) = *(_QWORD *)a9,
           v15 = *(__int64 (__fastcall **)(CSharedStreamGroupProxy *, struct IAudioStreamInfo *, struct SYSTEM_AUDIO_STREAM_DESCRIPTOR *, struct IAudioGraphCallback *, struct SYSTEM_AUDIO_STREAM *))(*(_QWORD *)v14 + 88LL),
           v15 != CSharedStreamGroupProxy::CreateStream)
        ? (Stream = v15(v14, a2, a8, a5, a10))
