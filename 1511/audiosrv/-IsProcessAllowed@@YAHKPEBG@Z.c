/*
 * XREFs of ?IsProcessAllowed@@YAHKPEBG@Z @ 0x18002CAA0
 * Callers:
...
LABEL_16:
  ...
  if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 14LL, &WPP_8fcf0ce21d4e3a3e0240111d41fb5ad7_Traceguids, v9);
LABEL_18:
    v10 = WPP_GLOBAL_Control;
  }
  if ( v8 < 0
    && v10 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    && (*((_DWORD *)v10 + 7) & 0x100) != 0
    && *((_BYTE *)v10 + 25) >= 2u )
  {
    WPP_SF_D(*((_QWORD *)v10 + 2), 15LL, &WPP_8fcf0ce21d4e3a3e0240111d41fb5ad7_Traceguids, (unsigned int)v8);
  }
  if ( v14 )
