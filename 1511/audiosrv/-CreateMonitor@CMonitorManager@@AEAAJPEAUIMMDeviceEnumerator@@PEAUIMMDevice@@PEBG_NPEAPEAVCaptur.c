/*
 * XREFs of ?CreateMonitor@CMonitorManager@@AEAAJPEAUIMMDeviceEnumerator@@PEAUIMMDevice@@PEBG_NPEAPEAVCaptureMonitor@1@@Z @ 0x180092340
 * Callers:
...
LABEL_24:
  ...
  if ( v9 )
  {
    ...
    if ( v12 >= 0 )
    {
      v15 = (__int64)v9;
      v9 = 0LL;
      *v10 = (struct CMonitorManager::CaptureMonitor *)v15;
      v13 = WPP_GLOBAL_Control;
      if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
        && (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x800000) != 0
...
LABEL_25:
  ...
  else
  {
    ...
    if ( (*((_DWORD *)WPP_GLOBAL_Control + 7) & 0x800000) == 0 || *((_BYTE *)WPP_GLOBAL_Control + 25) < 2u )
      goto LABEL_28;
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x4Du, (__int64)&WPP_ddb6baaf2876bc9badd045ab2d226c42_Traceguids);
  }
LABEL_27:
  v13 = WPP_GLOBAL_Control;
LABEL_28:
  if ( v13 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)v13 + 25) >= 2u )
  {
    WPP_SF_D(*((_QWORD *)v13 + 2), 0x4Fu, (__int64)&WPP_ddb6baaf2876bc9badd045ab2d226c42_Traceguids, v12);
  }
LABEL_32:
  if ( v9 )
