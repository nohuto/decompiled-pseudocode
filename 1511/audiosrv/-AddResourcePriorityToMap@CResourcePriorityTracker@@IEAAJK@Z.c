/*
 * XREFs of ?AddResourcePriorityToMap@CResourcePriorityTracker@@IEAAJK@Z @ 0x18000D350
 * Callers:
...
__int64 __fastcall CResourcePriorityTracker::AddResourcePriorityToMap(CResourcePriorityTracker *this, unsigned int a2)
{
  ...
  if ( v5 == v3 )
  {
    try
    {
      v11 = a2;
      v12 = 1;
      v6 = (void *)std::_Tree_buy<std::pair<unsigned long const,unsigned long>>::_Buynode<std::pair<unsigned long,int>>(
                     v2,
                     &v11);
