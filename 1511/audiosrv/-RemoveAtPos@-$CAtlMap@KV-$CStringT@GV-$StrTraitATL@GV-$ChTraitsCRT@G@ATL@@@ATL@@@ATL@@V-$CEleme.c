/*
 * XREFs of ?RemoveAtPos@?$CAtlMap@KV?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@V?$CElementTraits@K@2@V?$CElementTraits@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@@2@@ATL@@QEAAXPEAU__POSITION@@@Z @ 0x18008421C
 * Callers:
 *     _ATL::CAtlMap_unsigned_long_ATL::CStringT_unsigned_short_ATL::StrTraitATL_unsigned_short_ATL::ChTraitsCRT_unsigned_short______ATL::CElementTraits_unsigned_long__ATL::CElementTraits_ATL::CStringT_unsigned_short_ATL::StrTraitATL_unsigned_short_ATL::ChTraitsCRT_unsigned_short_________::SetAt_::_1_::catch$0 @ 0x180084874 (_ATL--CAtlMap_unsigned_long_ATL--CStringT_unsigned_short_ATL--StrTraitATL_unsigned__ea_180084874.c)
 * Callees:
