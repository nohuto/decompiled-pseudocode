/*
 * XREFs of ?GetPolicyVolumeForStream@CAudioSession@@IEAAMPEAUSessionPolicyGains@@PEAVCAudioStream@@@Z @ 0x180001554
 * Callers:
        ...
        struct CAudioStream *a3)
{
  ...
  if ( !IsAnAlwaysAudibleStreamType )
    v12 = v12 * *((float *)a2 + 4);
  if ( (*(unsigned int (__fastcall **)(CWindowsPolicyManager *, _QWORD))(*(_QWORD *)v11 + 176LL))(
         v11,
         *((unsigned int *)a3 + 76)) )
  {
