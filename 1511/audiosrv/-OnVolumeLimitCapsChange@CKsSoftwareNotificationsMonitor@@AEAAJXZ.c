/*
 * XREFs of ?OnVolumeLimitCapsChange@CKsSoftwareNotificationsMonitor@@AEAAJXZ @ 0x18008AC94
 * Callers:
 *     ?OnNotify@CKsSoftwareNotificationsMonitor@@UEAAJKPEBU_GUID@@@Z @ 0x18008AC70 (-OnNotify@CKsSoftwareNotificationsMonitor@@UEAAJKPEBU_GUID@@@Z.c)
 * Callees:
      ...
      if ( v3 >= 0 )
      {
        ...
        if ( v3 >= 0 )
        {
          ...
          if ( v3 >= 0 )
          {
            ...
            v15 = v10;
            v13 = 2 * v4 + 2;
            v3 = StringCbCopyW(v14, 0x1E0uLL, (size_t *)pv);
            if ( v3 >= 0 )
            {
              if ( (Microsoft_Windows_AudioEnableBits & 0x200) != 0 )
