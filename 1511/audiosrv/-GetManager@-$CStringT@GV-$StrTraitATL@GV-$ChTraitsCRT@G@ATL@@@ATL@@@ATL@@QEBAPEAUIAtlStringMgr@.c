/*
 * XREFs of ?GetManager@?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@QEBAPEAUIAtlStringMgr@2@XZ @ 0x180073E8C
 * Callers:
        ...
        _QWORD *a1)
{
  ...
  v1 = *(_QWORD *)(*a1 - 24LL);
  if ( v1 )
    result = (*(__int64 (__fastcall **)(_QWORD))(*(_QWORD *)v1 + 32LL))(*(_QWORD *)(*a1 - 24LL));
  else
    result = 0LL;
  if ( !result )
    return (*(__int64 (__fastcall **)(void *))(ATL::g_strmgr + 32LL))(&ATL::g_strmgr);
  return result;
}
