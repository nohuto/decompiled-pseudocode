/*
 * XREFs of ?SetOffloadDeviceFormat@@YAJPEBGPEAUtWAVEFORMATEX@@@Z @ 0x18006951C
 * Callers:
...
LABEL_10:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x23u, (__int64)&WPP_35438112b434e0062086f6d4e2d2e42c_Traceguids, v4);
  }
LABEL_14:
  if ( v6 )
