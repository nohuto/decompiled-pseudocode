/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@M@Z @ 0x180020DE0
 * Callers:
 ...
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x1800A8258 (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
 */
