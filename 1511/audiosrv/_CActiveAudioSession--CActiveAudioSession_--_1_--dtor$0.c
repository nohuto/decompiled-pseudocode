/*
 * XREFs of _CActiveAudioSession::CActiveAudioSession_::_1_::dtor$0 @ 0x18004C2C6
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall CActiveAudioSession::CActiveAudioSession_::_1_::dtor_0(__int64 a1, __int64 a2)
{
