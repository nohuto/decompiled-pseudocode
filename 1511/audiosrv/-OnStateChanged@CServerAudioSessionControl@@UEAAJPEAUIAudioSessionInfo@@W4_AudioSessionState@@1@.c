/*
 * XREFs of ?OnStateChanged@CServerAudioSessionControl@@UEAAJPEAUIAudioSessionInfo@@W4_AudioSessionState@@1@Z @ 0x180015BA0
 * Callers:
        ...
        enum _AudioSessionState a4)
{
  ...
  {
    WPP_SF_S(*((_QWORD *)WPP_GLOBAL_Control + 2), 30LL, &WPP_72a29e54739c88f9bde176df428e8cf6_Traceguids, 0LL);
  }
  v22 = 0;
  ...
  if ( v7 )
  {
    ...
    *v12 = v10;
    ...
    {
      v16 = 2147483646 - v14;
      v17 = *(_QWORD *)(*((_QWORD *)this + 9) + 856LL) - (_QWORD)v15;
      while ( v16 + v14 )
      {
