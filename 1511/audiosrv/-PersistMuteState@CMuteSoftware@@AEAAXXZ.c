/*
 * XREFs of ?PersistMuteState@CMuteSoftware@@AEAAXXZ @ 0x18006C5E8
 * Callers:
 ...
 *     WPP_SF_Sl @ 0x18006CC30 (WPP_SF_Sl.c)
 */
...
void __fastcall CMuteSoftware::PersistMuteState(const wchar_t **this)
{
    ...
    && (*(int (__fastcall **)(__int64, __int64, __int64 *))(*(_QWORD *)v7 + 32LL))(v7, 1LL, &v6) >= 0 )
  {
    ...
    if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_Sl(*((_QWORD *)WPP_GLOBAL_Control + 2), 35, v2, (unsigned int)this[4], *((_DWORD *)this + 6));
    }
    if ( *((_DWORD *)this + 6) )
      LOWORD(v4) = -1;
    else
