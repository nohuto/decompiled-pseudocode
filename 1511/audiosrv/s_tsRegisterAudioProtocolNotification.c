/*
 * XREFs of s_tsRegisterAudioProtocolNotification @ 0x18002C2C0
 * Callers:
 *     <none>
 * Callees:
 *     ?AddHead@?$TList@UAUDIOPROTOCOLNOTIFY@@@@QEAAPEAXPEAUAUDIOPROTOCOLNOTIFY@@@Z @ 0x18002C3B8 (-AddHead@-$TList@UAUDIOPROTOCOLNOTIFY@@@@QEAAPEAXPEAUAUDIOPROTOCOLNOTIFY@@@Z.c)
