/*
 * XREFs of ?NewState@CPerStreamVolumeAudioSession@@EEAAXW4_AudioSessionState@@@Z @ 0x180035880
 * Callers:
...
{
  int v4; // ebp
  __int64 (__fastcall *v5)(CAudioSession *); // rbx
  void (__fastcall **v6[2])(_QWORD, volatile signed __int32 **); // [rsp+30h] [rbp-38h] BYREF
  int v7; // [rsp+40h] [rbp-28h]
  enum _AudioSessionState v8; // [rsp+44h] [rbp-24h]
...
LABEL_10:
  *((_DWORD *)this + 118) = a2;
  ...
  if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 125LL, &WPP_c7c899a03615192e0a524739b215c826_Traceguids, this);
  }
