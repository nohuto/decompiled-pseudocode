/*
 * XREFs of ??1?$CAtlArray@V?$CComPtr@UISessionInternalEvents@@@ATL@@V?$CElementTraits@V?$CComPtr@UISessionInternalEvents@@@ATL@@@2@@ATL@@QEAA@XZ @ 0x18003A0FC
 * Callers:
 *     ??1CAudioSession@@MEAA@XZ @ 0x180027698 (--1CAudioSession@@MEAA@XZ.c)
 *     _CLockedList_ATL::CComPtr_ISessionInternalEvents__0_0_::ForEachEntry_::_1_::dtor$0 @ 0x18004A6D0 (_CLockedList_ATL--CComPtr_ISessionInternalEvents__0_0_--ForEachEntry_--_1_--dtor$0.c)
 * Callees:
        ...
        __int64 a1)
{
  ...
  __int64 v5; // rdi
  __int64 (__fastcall *v6)(CServerAudioSessionControl *); // rbp
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    for ( i = 0LL; i < v3; ++i )
    {
      ...
      if ( v5 )
      {
        v6 = *(__int64 (__fastcall **)(CServerAudioSessionControl *))(*(_QWORD *)v5 + 16LL);
