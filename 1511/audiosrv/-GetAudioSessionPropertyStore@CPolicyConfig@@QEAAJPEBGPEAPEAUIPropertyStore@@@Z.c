/*
 * XREFs of ?GetAudioSessionPropertyStore@CPolicyConfig@@QEAAJPEBGPEAPEAUIPropertyStore@@@Z @ 0x18001AE40
 * Callers:
...
LABEL_2:
    ...
    if ( v8 )
    {
      *(_QWORD *)v8 = &CAudioSessionStore::`vftable';
      ...
      {
        WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 74LL, &WPP_fc485e014cea5a4c1924790da308a5ac_Traceguids, v8);
      }
      v8[2] = 1;
      v8[10] = 0;
      *((_QWORD *)v8 + 2) = 0LL;
    ...
    try
    {
      v12 = ATL::CAtlList<CGainStage *,ATL::CElementTraits<CGainStage *>>::NewNode((char *)v4 + 72, &v18, v10, *v6);
      if ( *v6 )
        *(_QWORD *)(*v6 + 8) = v12;
      else
        *((_QWORD *)v4 + 10) = v12;
