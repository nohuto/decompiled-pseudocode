/*
 * XREFs of ?MuteControlsOnPath@CMonitor@@CAJPEAUIPartsList@@@Z @ 0x180097CD4
 * Callers:
...
__int64 __fastcall CMonitor::MuteControlsOnPath(struct IPartsList *a1)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x43u, (__int64)&WPP_b190cc602318435bf1a291092083f9b6_Traceguids);
  }
