/*
 * XREFs of ?QueryInterface@CaptureMonitor@CMonitorManager@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800953D0
 * Callers:
 *     <none>
 * Callees:
        ...
        void **a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x59u, (__int64)&WPP_ddb6baaf2876bc9badd045ab2d226c42_Traceguids, v3);
  }
  return v3;
}
