/*
 * XREFs of ?TS_SessionIdStreamStopped@@YAJKPEAUIAudioStreamInfo@@PEBG@Z @ 0x18002F8C0
 * Callers:
...
__int64 __fastcall TS_SessionIdStreamStopped(DWORD a1, struct IAudioStreamInfo *a2, const unsigned __int16 *a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 49LL, &WPP_a039a10251cf52648c3361a61631dc40_Traceguids, a1);
  }
  v12 = 0LL;
  v7 = qword_1800E68A0;
  while ( v7 )
...
LABEL_8:
    ...
    if ( !v9 )
      goto LABEL_9;
    v11 = (*(__int64 (__fastcall **)(_QWORD, struct IAudioStreamInfo *, const unsigned __int16 *))(*(_QWORD *)v9 + 32LL))(
            *((_QWORD *)v8 + 39),
            a2,
            a3);
    goto LABEL_16;
...
LABEL_9:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 50LL, &WPP_a039a10251cf52648c3361a61631dc40_Traceguids, v4);
  }
  return v4;
}
