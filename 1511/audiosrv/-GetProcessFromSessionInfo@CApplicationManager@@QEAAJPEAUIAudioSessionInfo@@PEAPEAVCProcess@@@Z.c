/*
 * XREFs of ?GetProcessFromSessionInfo@CApplicationManager@@QEAAJPEAUIAudioSessionInfo@@PEAPEAVCProcess@@@Z @ 0x18001D5A0
 * Callers:
 ...
 *     ?GetImplementation@CProcess@@UEAAJPEAPEAV1@@Z @ 0x180028EB0 (-GetImplementation@CProcess@@UEAAJPEAPEAV1@@Z.c)
...
{
  int v4; // edi
  __int64 (__fastcall *v5)(CAudioSession *__hidden, struct IAudioProcess **); // rdi
  int Process; // eax
  CProcess *v7; // rbx
  __int64 (__fastcall *v8)(CProcess *__hidden, struct CProcess **); // rdi
  int v9; // eax
  ...
  if ( v4 >= 0 )
  {
    v5 = *(__int64 (__fastcall **)(CAudioSession *__hidden, struct IAudioProcess **))(*(_QWORD *)a2 + 24LL);
  ...
  if ( v4 >= 0 )
  {
    v8 = *(__int64 (__fastcall **)(CProcess *__hidden, struct CProcess **))(*(_QWORD *)v7 + 24LL);
