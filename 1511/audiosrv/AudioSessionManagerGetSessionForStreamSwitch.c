/*
 * XREFs of AudioSessionManagerGetSessionForStreamSwitch @ 0x18007BE10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionManagerGetSessionForStreamSwitch(__int64 **a1, unsigned __int16 *a2, _QWORD *a3)
{
  __int64 *v3; // r14
  int v6; // edi
  ...
  *a3 = 0LL;
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x5Eu, (__int64)&WPP_9fafadcf3cd06ed99ec4193376114500_Traceguids, *v3);
  }
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x5Fu, (__int64)&WPP_9fafadcf3cd06ed99ec4193376114500_Traceguids, v6);
  }
  CAudioSessionInstanceId::~CAudioSessionInstanceId((CAudioSessionInstanceId *)v21);
