/*
 * XREFs of ?CheckADGStatus@CAudioDGProcess@@QEAAJXZ @ 0x18003375C
 * Callers:
...
__int64 __fastcall CAudioDGProcess::CheckADGStatus(CAudioDGProcess *this)
{
  ...
  if ( LOBYTE(v1[2].OwningThread) )
  {
    ...
    v10 = 35LL;
LABEL_61:
    WPP_SF_D(*((_QWORD *)v5 + 2), v10, &WPP_785362db39762c5e6daaa474a87b7ce9_Traceguids, OwningThread_high);
    v5 = WPP_GLOBAL_Control;
    goto LABEL_6;
  }
  if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Au, (__int64)&WPP_785362db39762c5e6daaa474a87b7ce9_Traceguids);
  }
    ...
    while ( 1 )
    {
      ...
      if ( v7 != 258 )
      {
        ...
        if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Du, (__int64)&WPP_785362db39762c5e6daaa474a87b7ce9_Traceguids);
        }
...
LABEL_6:
  if ( ADGProcessBindingHandle >= 0 )
  {
    if ( v5 == (TraceLoggingHProvider)&WPP_GLOBAL_Control || (*((_BYTE *)v5 + 28) & 4) == 0 || *((_BYTE *)v5 + 25) < 4u )
      goto LABEL_10;
    v11 = 36LL;
    goto LABEL_67;
  }
...
LABEL_10:
  ...
  if ( ADGProcessBindingHandle < 0
    && v5 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    && (*((_BYTE *)v5 + 28) & 4) != 0
    && *((_BYTE *)v5 + 25) >= 2u )
  {
    WPP_SF_D(
