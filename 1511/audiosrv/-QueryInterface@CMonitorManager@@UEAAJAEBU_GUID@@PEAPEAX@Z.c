/*
 * XREFs of ?QueryInterface@CMonitorManager@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x180095280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMonitorManager::QueryInterface(CMonitorManager *this, const struct _GUID *a2, void **a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x58u, (__int64)&WPP_ddb6baaf2876bc9badd045ab2d226c42_Traceguids, v3);
  }
  return v3;
}
