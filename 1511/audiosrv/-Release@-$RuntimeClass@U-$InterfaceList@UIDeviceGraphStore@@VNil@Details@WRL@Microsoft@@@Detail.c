/*
 * XREFs of ?Release@?$RuntimeClass@U?$InterfaceList@UIDeviceGraphStore@@VNil@Details@WRL@Microsoft@@@Details@WRL@Microsoft@@U?$RuntimeClassFlags@$01@34@$00$0A@$0A@@Details@WRL@Microsoft@@UEAAKXZ @ 0x180044A00
 * Callers:
 ...
 *     ??1?$ComPtr@VCDeviceGraphStore@@@WRL@Microsoft@@QEAA@XZ @ 0x180066878 (--1-$ComPtr@VCDeviceGraphStore@@@WRL@Microsoft@@QEAA@XZ.c)
 * Callees:
