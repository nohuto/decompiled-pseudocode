/*
 * XREFs of ?EndpointRequiresAC97VistaShim@@YAHPEAUIMMDevice@@@Z @ 0x180087284
 * Callers:
...
__int64 __fastcall EndpointRequiresAC97VistaShim(struct IMMDevice *a1)
{
  ...
  *(_QWORD *)pdwType = 0LL;
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x73u, (__int64)&WPP_8fcf0ce21d4e3a3e0240111d41fb5ad7_Traceguids, v3);
  }
  if ( v10 )
