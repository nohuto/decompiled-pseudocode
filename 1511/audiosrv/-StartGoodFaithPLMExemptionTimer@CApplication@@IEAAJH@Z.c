/*
 * XREFs of ?StartGoodFaithPLMExemptionTimer@CApplication@@IEAAJH@Z @ 0x1800A0D4C
 * Callers:
...
__int64 __fastcall CApplication::StartGoodFaithPLMExemptionTimer(CApplication *this)
{
  ...
  v2 = 0;
  ATL::CCritSecLock::CCritSecLock((ATL::CCritSecLock *)&v6, (struct _RTL_CRITICAL_SECTION *)((char *)this + 288));
  ...
  if ( !*((_QWORD *)this + 41) )
  {
    v3 = (*(__int64 (__fastcall **)(CAudioThreadPool *, _QWORD, CApplication *))(*(_QWORD *)ThreadPool + 8LL))(
           ThreadPool,
    ...
    *((_QWORD *)this + 41) = v3;
    if ( v3 )
    {
      ...
      v9 = -1;
      *((_DWORD *)this + 85) = 1;
      (*(void (__fastcall **)(CAudioThreadPool *, __int64, int *, _QWORD, int))(*(_QWORD *)ThreadPool + 24LL))(
        ThreadPool,
        v3,
        &v8,
        0LL,
