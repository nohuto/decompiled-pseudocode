/*
 * XREFs of AudioSessionMeterGetChannelsPeakValues @ 0x180079450
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall AudioSessionMeterGetChannelsPeakValues(_QWORD *a1, unsigned int a2, __int64 a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x52u, (__int64)&WPP_72a29e54739c88f9bde176df428e8cf6_Traceguids, v3);
  }
