/*
 * XREFs of ??$AsWeak@UIStreamGroupProxy@@@WRL@Microsoft@@YAJPEAUIStreamGroupProxy@@PEAVWeakRef@01@@Z @ 0x18000DC6C
 * Callers:
        ...
        volatile signed __int32 **a2)
{
  ...
  int v4; // edi
  __int64 (__fastcall *v5)(__int64, volatile signed __int32 **); // rdi
  ...
  {
    v13 = 0LL;
    v5 = *(__int64 (__fastcall **)(__int64, volatile signed __int32 **))(*(_QWORD *)v14 + 24LL);
    if ( (char *)v5 == (char *)Microsoft::WRL::Details::RuntimeClass<Microsoft::WRL::Details::InterfaceList<CBaseStreamGroupProxy,Microsoft::WRL::Details::InterfaceList<IInspectable,Microsoft::WRL::Details::Nil>>,Microsoft::WRL::RuntimeClassFlags<3>,1,1,0>::GetWeakReference )
