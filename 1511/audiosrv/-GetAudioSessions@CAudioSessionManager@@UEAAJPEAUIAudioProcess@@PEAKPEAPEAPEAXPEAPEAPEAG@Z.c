/*
 * XREFs of ?GetAudioSessions@CAudioSessionManager@@UEAAJPEAUIAudioProcess@@PEAKPEAPEAPEAXPEAPEAPEAG@Z @ 0x18007A7B0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_Ddq @ 0x18007C064 (WPP_SF_Ddq.c)
 */
...
LABEL_22:
  ...
  while ( 1 )
  {
    ...
    if ( *((_DWORD *)v25 + 118) == 2 )
      goto LABEL_54;
    if ( v26 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
      && (*((_BYTE *)v26 + 28) & 0x40) != 0
      && *((_BYTE *)v26 + 25) >= 4u )
    {
      WPP_SF_qS(*((_QWORD *)v26 + 2), 0x37u, (__int64)&WPP_9fafadcf3cd06ed99ec4193376114500_Traceguids, v25, 0LL);
    }
...
LABEL_54:
  ...
  if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x38u, (__int64)&WPP_9fafadcf3cd06ed99ec4193376114500_Traceguids, v17);
  }
  v19 = v40;
LABEL_61:
  if ( v19 < 0 )
...
LABEL_76:
  ...
  *v37 = (unsigned __int16 **)v9;
  ...
  if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
  {
    WPP_SF_Ddq(*((_QWORD *)WPP_GLOBAL_Control + 2), v35, &WPP_GLOBAL_Control, (unsigned int)v17, *v35, *v36);
    v38 = WPP_GLOBAL_Control;
  }
  if ( v17 < 0
    && v38 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    && (*((_BYTE *)v38 + 28) & 0x40) != 0
    && *((_BYTE *)v38 + 25) >= 2u )
  {
    WPP_SF_D(*((_QWORD *)v38 + 2), 0x3Bu, (__int64)&WPP_9fafadcf3cd06ed99ec4193376114500_Traceguids, v17);
  }
