/*
 * XREFs of ??1?$CSimpleMap@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAUDuckingDescriptor@@V?$CSimpleMapEqualHelper@V?$CStringT@GV?$StrTraitATL@GV?$ChTraitsCRT@G@ATL@@@ATL@@@ATL@@PEAUDuckingDescriptor@@@2@@ATL@@QEAA@XZ @ 0x180066C60
 * Callers:
 *     _CProcess::_CProcess_::_1_::dtor$6 @ 0x18004B578 (_CProcess--_CProcess_--_1_--dtor$6.c)
 *     _CProcess::_CProcess_::_1_::dtor$7 @ 0x18004B58B (_CProcess--_CProcess_--_1_--dtor$7.c)
 *     _CProcess::CProcess_::_1_::dtor$6 @ 0x18004B62C (_CProcess--CProcess_--_1_--dtor$6.c)
 *     _CProcess::CProcess_::_1_::dtor$7 @ 0x18004B63F (_CProcess--CProcess_--_1_--dtor$7.c)
 *     _TSSession::_TSSession_::_1_::dtor$2 @ 0x18009BC2A (_TSSession--_TSSession_--_1_--dtor$2.c)
 *     _TSSession::_TSSession_::_1_::dtor$8 @ 0x18009BC9C (_TSSession--_TSSession_--_1_--dtor$8.c)
 * Callees:
