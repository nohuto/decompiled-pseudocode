/*
 * XREFs of ?OnMonitorEnabledChanged@CMonitorManager@@AEAAXPEBGPEBU_tagpropertykey@@@Z @ 0x180094790
 * Callers:
 *     <none>
 * Callees:
      ...
      if ( MonitorForCaptureDeviceIfAppropriate >= 0 )
      {
        ...
        if ( v14 )
        {
          ...
          if ( v7 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
            ...
            && *((_BYTE *)v7 + 25) >= 4u )
          {
            WPP_SF_S(*((_QWORD *)v7 + 2), 0x26u, (__int64)&WPP_ddb6baaf2876bc9badd045ab2d226c42_Traceguids, a2);
          }
