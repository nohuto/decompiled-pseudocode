/*
 * XREFs of ?GetInstanceId@CAudioSession@@UEAAJPEAPEAG@Z @ 0x180073CB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CAudioSession::GetInstanceId(const wchar_t **this, unsigned __int16 **a2)
{
  ...
  v4 = CAudioSessionInstanceId::ToString((__int64)(this + 98), &v10);
  v5 = v10;
  v6 = v4;
  if ( v4 >= 0 )
  {
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, (__int64)&WPP_c7c899a03615192e0a524739b215c826_Traceguids, v6);
  }
LABEL_14:
