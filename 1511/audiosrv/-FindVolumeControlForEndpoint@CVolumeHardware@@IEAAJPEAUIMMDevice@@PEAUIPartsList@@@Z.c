/*
 * XREFs of ?FindVolumeControlForEndpoint@CVolumeHardware@@IEAAJPEAUIMMDevice@@PEAUIPartsList@@@Z @ 0x180041AA0
 * Callers:
        ...
        struct IPartsList *a3)
{
  ...
  {
    WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 52LL, &WPP_d155ec871d18c6e5af7e88d93bf1f92f_Traceguids, this);
    v6 = v17;
  }
  if ( a2 )
  {
    ...
    if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control )
    {
      ...
      if ( v8 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
        ...
        && *((_BYTE *)v8 + 25) >= 4u )
      {
        WPP_SF_q(*((_QWORD *)v8 + 2), 54LL, &WPP_d155ec871d18c6e5af7e88d93bf1f92f_Traceguids, this);
      }
    }
    v9 = v17;
    if ( v17 != a2 )
    ...
    if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      WPP_SF_q(*((_QWORD *)WPP_GLOBAL_Control + 2), 55LL, &WPP_d155ec871d18c6e5af7e88d93bf1f92f_Traceguids, this);
    }
