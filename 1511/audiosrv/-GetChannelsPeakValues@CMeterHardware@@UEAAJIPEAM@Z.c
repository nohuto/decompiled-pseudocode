/*
 * XREFs of ?GetChannelsPeakValues@CMeterHardware@@UEAAJIPEAM@Z @ 0x18006B7B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CMeterHardware::GetChannelsPeakValues(CMeterHardware *this, unsigned int a2, float *a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x19u, (__int64)&WPP_c4b6e3fb0b78b7ef89729a36f54e7633_Traceguids, v5);
  }
  return v5;
}
