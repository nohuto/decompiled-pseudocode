/*
 * XREFs of ?SetMasterVolumeLevelScalar@CVolumeControlBase@@UEAAJMPEBU_GUID@@@Z @ 0x18006EBC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WPP_SF_qggg @ 0x18006FB30 (WPP_SF_qggg.c)
 */
        ...
        const struct _GUID *a3)
{
  ...
  if ( a2 != CVolumeUnit::GetWiper((CVolumeUnit *)(*((_QWORD *)this + 4) + 56 * v6)) )
  {
    ...
    {
      WPP_SF_qg_guid_(*((_QWORD *)WPP_GLOBAL_Control + 2), 35, v7, (_DWORD)this, COERCE_UNSIGNED_INT64(a2), (__int64)a3);
    }
    ...
    if ( (TraceLoggingHProvider *)v9 != &WPP_GLOBAL_Control
      ...
      && *(_BYTE *)(v9 + 25) >= 4u )
    {
      WPP_SF_qdg(*(_QWORD *)(v9 + 16), 36LL, &WPP_d155ec871d18c6e5af7e88d93bf1f92f_Traceguids, this, v10, a2);
    }
    ...
    for ( i = 0; i < *((_DWORD *)this + 17); ++i )
    {
      if ( i != *((_DWORD *)this + 16) )
      {
        ...
        if ( (TraceLoggingHProvider *)v22 != &WPP_GLOBAL_Control
