/*
 * XREFs of ?QueueDuckingWorkItem@CDuckingManager@@AEAAJPEBGKW4DUCK_WORK_ITEM_TYPE@@H@Z @ 0x1800A350C
 * Callers:
...
__int64 __fastcall CDuckingManager::QueueDuckingWorkItem(__int64 a1, _WORD *a2, int a3, int a4, int a5)
{
  __int64 v8; // r15
  _QWORD *v9; // rax
...
LABEL_23:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x32u, (__int64)&WPP_7126b4a398f34fc137826d3414d4a173_Traceguids, v11);
    goto LABEL_23;
  }
LABEL_24:
  if ( v11 < 0
    && v16 != (TraceLoggingHProvider)&WPP_GLOBAL_Control
    && (*((_DWORD *)v16 + 7) & 0x8000000) != 0
    && *((_BYTE *)v16 + 25) >= 2u )
  {
    WPP_SF_D(*((_QWORD *)v16 + 2), 0x33u, (__int64)&WPP_7126b4a398f34fc137826d3414d4a173_Traceguids, v11);
  }
