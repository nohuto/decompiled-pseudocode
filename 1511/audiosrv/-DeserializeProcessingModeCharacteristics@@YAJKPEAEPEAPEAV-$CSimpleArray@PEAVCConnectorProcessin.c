/*
 * XREFs of ?DeserializeProcessingModeCharacteristics@@YAJKPEAEPEAPEAV?$CSimpleArray@PEAVCConnectorProcessingModeCharacteristics@@V?$CSimpleArrayEqualHelper@PEAVCConnectorProcessingModeCharacteristics@@@ATL@@@ATL@@@Z @ 0x18003F870
 * Callers:
...
__int64 __fastcall DeserializeProcessingModeCharacteristics(unsigned int a1, _DWORD *a2, void ***a3)
{
  ...
  CConnectorProcessingModeCharacteristics *v22; // [rsp+30h] [rbp-58h] BYREF
  _DWORD *v23; // [rsp+38h] [rbp-50h]
  _DWORD *v25; // [rsp+A8h] [rbp+20h]
...
LABEL_19:
          ...
          {
            v19 = v18;
            if ( v12 < (unsigned __int64)*((unsigned __int16 *)v13 + 16) + 34 )
            {
              v3 = -2147023728;
              goto LABEL_30;
            }
            v3 = CConnectorProcessingModeCharacteristics::AddConnectorFormat(
                   v18,
                   (const struct tWAVEFORMATEX *)(v13 + 4),
                   v13[1],
                   *v13,
                   v13[2],
                   v13[3]);
