/*
 * XREFs of ?OnAutoUnduckWorkItem@CDuckingManager@@AEAAJPEAVCDuckWorkItem@@@Z @ 0x1800A310C
 * Callers:
...
__int64 __fastcall CDuckingManager::OnAutoUnduckWorkItem(CDuckingManager *this, unsigned __int16 **a2)
{
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x37u, (__int64)&WPP_7126b4a398f34fc137826d3414d4a173_Traceguids);
  }
