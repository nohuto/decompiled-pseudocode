/*
 * XREFs of ?OnDuckWorkItem@CDuckingManager@@CAXPEAU_TP_CALLBACK_INSTANCE@@PEAXPEAU_TP_WORK@@@Z @ 0x1800A33E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CDuckingManager::OnDuckWorkItem(struct _TP_CALLBACK_INSTANCE *a1, char *a2, struct _TP_WORK *a3)
{
  ...
  v5 = (struct CDuckWorkItem *)ATL::CAtlList<COnDeviceWorkItem *,ATL::CElementTraits<COnDeviceWorkItem *>>::RemoveHead((__int64)(a2 + 248));
