/*
 * XREFs of ?LoadMuteState@CMuteSoftware@@AEAAJXZ @ 0x18006C2D8
 * Callers:
 *     ?GetLevelData@CMuteSoftware@@MEAAJXZ @ 0x18006C000 (-GetLevelData@CMuteSoftware@@MEAAJXZ.c)
 * Callees:
      ...
      if ( v3 >= 0 && (_WORD)pvar == 11 )
      {
        ...
        *((_DWORD *)this + 6) = v5;
        if ( WPP_GLOBAL_Control != (TraceLoggingHProvider)&WPP_GLOBAL_Control
          ...
          && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
        {
          WPP_SF_Sl(*((_QWORD *)WPP_GLOBAL_Control + 2), 32, v4, *((_QWORD *)this + 4), v5);
        }
      }
