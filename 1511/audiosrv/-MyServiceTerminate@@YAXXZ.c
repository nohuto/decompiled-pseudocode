/*
 * XREFs of ?MyServiceTerminate@@YAXXZ @ 0x18009A6FC
 * Callers:
 ...
 *     McGenEventUnregister @ 0x18009AB60 (McGenEventUnregister.c)
 */
...
void MyServiceTerminate(void)
{
  ...
  if ( g_EventWorkerThreadHandle )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xEu, (__int64)&WPP_908455377377748732ca9cb03e87474b_Traceguids);
    }
