/*
 * XREFs of ?StringCbCopyExW@@YAJPEAG_KPEBGPEAPEAGPEA_KK@Z @ 0x18006B088
 * Callers:
 ...
 *     StringCopyWorkerW_1 @ 0x18006B26C (StringCopyWorkerW_1.c)
        ...
        DWORD a6)
{
  ...
  else
  {
    ...
    if ( (a6 & 0x100) != 0 )
    {
      v13 = (const wchar_t *)&word_1800AFAB8;
      if ( pszSrc )
        v13 = pszSrc;
      pszSrc = v13;
    }
    ...
    else if ( v8 )
    {
      ...
      if ( v11 >= 0 )
      {
        if ( (dwFlags & 0x200) != 0 )
        {
          v14 = (cbDest & 1) + 2 * v8;
          if ( v14 > 2 )
            memset_0(v12 + 1, (unsigned __int8)dwFlags, v14 - 2);
        }
        goto LABEL_21;
      }
    }
