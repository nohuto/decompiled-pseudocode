/*
 * XREFs of ?UpdateStreamResourcePriority@CBaseStreamGroupProxy@@UEAAJW4_ResourcePriorityAction@@KK@Z @ 0x18000BE30
 * Callers:
        ...
        unsigned int a4)
{
  ...
  __int64 (__fastcall *v20)(__int64, unsigned int, unsigned int, unsigned int); // rdi
  ...
  if ( v20 == CSaDeviceProxy::UpdateStreamGroupResourcePriority )
    return CSaDeviceProxy::UpdateStreamGroupResourcePriority(*(_QWORD *)(a1 + 72), 1u, v19, v10);
  else
    return v20(*(_QWORD *)(a1 + 72), 1u, v19, v10);
}
