/*
 * XREFs of ?TsSessionIdReleaseEndpointVolumeReference@@YAJKPEBGPEAH1PEAM11@Z @ 0x18009D278
 * Callers:
        ...
        int *a7)
{
  ...
  *a4 = 0;
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x28u, (__int64)&WPP_a039a10251cf52648c3361a61631dc40_Traceguids, v8);
  }
  return 0LL;
}
