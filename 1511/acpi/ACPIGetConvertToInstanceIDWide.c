/*
 * XREFs of ACPIGetConvertToInstanceIDWide @ 0x1C001E84C
 * Callers:
...
__int64 __fastcall ACPIGetConvertToInstanceIDWide(_QWORD *a1, int a2, __int64 a3, int a4, char **a5, _DWORD *a6)
{
  __int64 v8; // rbx
  char *v9; // rdi
  __int64 v11; // rbx
  ...
  if ( (a4 & 0x4000000) == 0 && (*a1 & 0x1000000000000LL) != 0 )
  {
    v11 = -1LL;
    do
      ++v11;
    while ( *(_BYTE *)(a1[70] + v11) );
    ...
    RtlStringCchPrintfA(v9, (unsigned int)v8, "%s", (const char *)a1[70]);
    v13 = 2 * v8;
    goto LABEL_14;
  }
  if ( a2 < 0 )
