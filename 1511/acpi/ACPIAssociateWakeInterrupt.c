/*
 * XREFs of ACPIAssociateWakeInterrupt @ 0x1C00413BC
 * Callers:
 *     ACPIWakeEmulationEnable @ 0x1C0041D20 (ACPIWakeEmulationEnable.c)
 * Callees:
 ...
 *     ACPIDereferenceWakeInterrupt @ 0x1C0041798 (ACPIDereferenceWakeInterrupt.c)
 *     ACPIFindWakeInterruptForVector @ 0x1C00418A8 (ACPIFindWakeInterruptForVector.c)
 *     OSPowerTryAcquireWakeInterruptChangeStateLock @ 0x1C0041F74 (OSPowerTryAcquireWakeInterruptChangeStateLock.c)
...
__int64 __fastcall ACPIAssociateWakeInterrupt(__int64 a1)
{
  ...
  if ( (int)ACPIFindWakeInterruptForVector(v8, v7, &v19) < 0 )
  {
    ...
    *v15 = a1;
    *(_QWORD *)(v9 + 24) = a1;
    v16 = (__int64 **)qword_1C0059458;
    *(_QWORD *)v9 = &AcpiPowerWaitWakeInterruptList;
    *(_QWORD *)(v9 + 8) = v16;
    if ( *v16 != &AcpiPowerWaitWakeInterruptList )
      __fastfail(3u);
    *v16 = (__int64 *)v9;
    qword_1C0059458 = v9;
    v12 = 5;
