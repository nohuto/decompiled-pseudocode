/*
 * XREFs of ACPIEcStartDeviceWorker @ 0x1C003A9C0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ACPIEcInstallOpRegionHandler @ 0x1C007A224 (ACPIEcInstallOpRegionHandler.c)
 *     ACPIEcGetResources @ 0x1C007A28C (ACPIEcGetResources.c)
 */
