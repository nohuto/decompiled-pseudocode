/*
 * XREFs of CreateNativeNameSpaceObject @ 0x1C00052C0
 * Callers:
 ...
 *     SetClearAssociatedNativeObjectNoLock @ 0x1C00056D0 (SetClearAssociatedNativeObjectNoLock.c)
 *     GetNextNameSegment @ 0x1C00056EC (GetNextNameSegment.c)
