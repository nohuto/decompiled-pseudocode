/*
 * XREFs of PnpCmResourcesToBiosResources @ 0x1C0072EE4
 * Callers:
 *     ACPIInitStartDevice @ 0x1C00083A0 (ACPIInitStartDevice.c)
 * Callees:
 *     PnpiCmResourceToBiosIrq @ 0x1C0073018 (PnpiCmResourceToBiosIrq.c)
 *     PnpiCmResourceToBiosIoPort @ 0x1C007306C (PnpiCmResourceToBiosIoPort.c)
 *     PnpiCmResourceToBiosAddress @ 0x1C007E9C8 (PnpiCmResourceToBiosAddress.c)
 *     PnpiCmResourceToBiosAddressDouble @ 0x1C007EAA8 (PnpiCmResourceToBiosAddressDouble.c)
 *     PnpiCmResourceToBiosAddressQuad @ 0x1C007EB6C (PnpiCmResourceToBiosAddressQuad.c)
 *     PnpiCmResourceToBiosExtendedIrq @ 0x1C007EC0C (PnpiCmResourceToBiosExtendedIrq.c)
 *     PnpiCmResourceToBiosGpioInterruptIoDescriptor @ 0x1C007ECAC (PnpiCmResourceToBiosGpioInterruptIoDescriptor.c)
 *     PnpiCmResourceToBiosIoFixedPort @ 0x1C007ED08 (PnpiCmResourceToBiosIoFixedPort.c)
 *     PnpiCmResourceToBiosMemory @ 0x1C007ED54 (PnpiCmResourceToBiosMemory.c)
 *     PnpiCmResourceToBiosMemory32 @ 0x1C007EDBC (PnpiCmResourceToBiosMemory32.c)
 */
