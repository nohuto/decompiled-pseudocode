/*
 * XREFs of ArbInitializeArbiterInstance @ 0x1C006DEBC
 * Callers:
 *     AcpiInitializeBusNumberArbiter @ 0x1C0079A40 (AcpiInitializeBusNumberArbiter.c)
 *     AcpiInitializeMemoryArbiter @ 0x1C007B714 (AcpiInitializeMemoryArbiter.c)
 *     AcpiInitializePortArbiter @ 0x1C007C76C (AcpiInitializePortArbiter.c)
 *     AcpiIrqLibInitializeGlobalState @ 0x1C0086DD4 (AcpiIrqLibInitializeGlobalState.c)
 * Callees:
 *     RtlInitializeRangeList_0 @ 0x1C0024C86 (RtlInitializeRangeList_0.c)
