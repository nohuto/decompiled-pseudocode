/*
 * XREFs of AcpiQueryPciBusInterface @ 0x1C006E828
 * Callers:
...
__int64 __fastcall AcpiQueryPciBusInterface(ULONG_PTR BugCheckParameter3)
{
  ...
  _QWORD v8[2]; // [rsp+40h] [rbp-C8h] BYREF
  __int64 v9; // [rsp+50h] [rbp-B8h]
  PVOID v10; // [rsp+58h] [rbp-B0h]
  __int32 *v11; // [rsp+60h] [rbp-A8h]
  _WORD v12[128]; // [rsp+88h] [rbp-80h] BYREF
  ...
  if ( PoolWithTag )
  {
    ...
    {
      LOWORD(v8[0]) = 2075;
      v8[1] = &GUID_BUS_INTERFACE_STANDARD;
      LODWORD(v9) = 65600;
      v11 = &v7;
      v10 = PoolWithTag;
      v4 = ACPIInternalSendSynchronousIrp(AttachedDeviceReference, (__int64)v8, 0LL);
