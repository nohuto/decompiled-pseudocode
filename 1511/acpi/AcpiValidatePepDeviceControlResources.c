/*
 * XREFs of AcpiValidatePepDeviceControlResources @ 0x1C007C36C
 * Callers:
 *     AcpiTranslatePepDeviceControlResourcesInternal @ 0x1C007C27C (AcpiTranslatePepDeviceControlResourcesInternal.c)
 * Callees:
 *     AMLICheckIfIoRangeValid @ 0x1C0042028 (AMLICheckIfIoRangeValid.c)
 *     AMLIValidateFirmwareMemoryAddress @ 0x1C004233C (AMLIValidateFirmwareMemoryAddress.c)
 */
