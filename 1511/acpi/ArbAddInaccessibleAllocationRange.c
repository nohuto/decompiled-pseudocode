/*
 * XREFs of ArbAddInaccessibleAllocationRange @ 0x1C0080CB8
 * Callers:
 *     ACPIBusIrpStartDevice @ 0x1C0066B20 (ACPIBusIrpStartDevice.c)
 * Callees:
 *     RtlAddRange_0 @ 0x1C0024C8C (RtlAddRange_0.c)
 *     ZwClose_0 @ 0x1C0024C98 (ZwClose_0.c)
 *     ZwOpenKey_0 @ 0x1C0024CC2 (ZwOpenKey_0.c)
