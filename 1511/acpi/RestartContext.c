/*
 * XREFs of RestartContext @ 0x1C0006440
 * Callers:
 ...
 *     RestartCtxtCallback @ 0x1C0006350 (RestartCtxtCallback.c)
 *     SleepQueueDpc @ 0x1C0024AB0 (SleepQueueDpc.c)
...
__int64 __fastcall RestartContext(PSLIST_ENTRY ListEntry, char a2)
{
  ...
  {
    v10 = _InterlockedExchangeAdd((_DWORD *)&qword_1C005A1F8 + 1, 1u);
    if ( (_DWORD)qword_1C005A1F8 == 204 )
      v11 = v10 % 0xCC;
    else
      v11 = v10 % (unsigned int)qword_1C005A1F8;
    v12 = 72LL * v11;
