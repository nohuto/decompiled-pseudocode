...
__int64 CatError(const char *a1, ...)
{
  ...
  va_start(argList, a1);
  RtlStringCchCatA(byte_1C005A22C, 0x100uLL, "\n");
  v1 = -1LL;
  do
    ++v1;
  while ( byte_1C005A22C[v1] );
  RtlStringCchVPrintfA(&byte_1C005A22C[v1], 256 - v1, a1, argList);
  ConPrintf(byte_1C005A22C);
  result = ConPrintf("\n");
