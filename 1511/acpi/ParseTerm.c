/*
 * XREFs of ParseTerm @ 0x1C000F430
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ParseTerm(__int64 a1, __int64 a2, unsigned __int64 a3)
{
  __int64 v3; // rdi
  __int64 v4; // r14
  __int64 v5; // r11
  ...
  __int64 j; // rbx
  __int16 v42; // ax
  __int64 (__fastcall *v43)(__int64, __int64, unsigned __int64, __int64); // rax
  __int64 v44; // r10
  __int64 (__fastcall *v45)(__int64, __int64, _QWORD, __int64, _DWORD, __int64); // r11
  __int64 v46; // rbx
  ...
  __int64 v161; // rax
  int v162; // eax
  __int64 (__fastcall *v163)(__int64, __int64, _QWORD, __int64, _DWORD, __int64); // rax
  __int64 v164; // r10
  __int64 v165; // r10
  unsigned int v166; // [rsp+40h] [rbp-C0h]
  __int64 v167; // [rsp+48h] [rbp-B8h]
  __int64 v169; // [rsp+60h] [rbp-A0h] BYREF
  __int64 v170; // [rsp+68h] [rbp-98h] BYREF
  __int64 v171; // [rsp+70h] [rbp-90h] BYREF
  const void **v172; // [rsp+78h] [rbp-88h]
  __int64 v173; // [rsp+80h] [rbp-80h]
  char pszDest; // [rsp+90h] [rbp-70h] BYREF
  char v175; // [rsp+91h] [rbp-6Fh] BYREF
  char Src; // [rsp+190h] [rbp+90h] BYREF
  char v177; // [rsp+191h] [rbp+91h] BYREF
  ...
  {
LABEL_5:
    NameSpaceObjectNoLock = v166;
    v9 = (char **)(v4 + 120);
    v172 = (const void **)(v4 + 120);
    a3 = 0x1C0000000uLL;
...
LABEL_87:
    ...
    while ( 1 )
    {
      ...
      *(_DWORD *)(v3 + 72) = v10 + 1;
      ...
      if ( (_DWORD)v17 != 10 && (dword_1C005A158[4 * v18] & 1) != 0 && (_DWORD)v17 != -1 )
      {
        ConPrintf("\nHit Breakpoint %d.\n");
      ...
      {
        *v9 = v19 + 1;
        OpcodeTerm = FindOpcodeTerm((unsigned __int8)v19[1], v17, v15, 2LL);
      }
      else
      {
      ...
      if ( !OpcodeTerm )
      {
        ...
        PrintDebugMessage(134, *(unsigned __int8 *)*v172, (unsigned int)*v172, 0, 0LL);
      ...
      if ( (v22 & 8) == 0 )
      {
        if ( (v22 & 0x10) != 0 )
        {
          NameSpaceObjectNoLock = ParseString(v172, v13, 0);
          goto LABEL_82;
        }
        if ( (v22 & 2) != 0 )
        {
          NameSpaceObjectNoLock = ParseArgObj(v4, v13);
          goto LABEL_82;
        }
        if ( (v22 & 4) != 0 )
        {
          v147 = (unsigned int)**(unsigned __int8 **)(v4 + 120) - 96;
          CopyObjData(v13, *(_QWORD *)(v4 + 96) + 8 * (v147 + 4 * v147 + 9));
          if ( (gDebugger & 0xD0) != 0 )
          {
            ConPrintf("Local%d=");
            PrintObject(v167);
        ...
        if ( (v22 & 0x20) != 0 )
        {
          ...
          else
          {
            if ( *v23 != 94 )
            {
              ...
              while ( 2 )
              {
                if ( (unsigned __int64)(unsigned int)v25 + 4 >= 0x100 )
                {
...
LABEL_64:
                  if ( !NameSpaceObjectNoLock )
                  {
                    ...
                    if ( *(_WORD *)(v40 + 58) == 8 )
                    {
                      NameSpaceObjectNoLock = PushCall(v4, v40, v167);
                    }
                    else
                    {
                      NameSpaceObjectNoLock = 0;
                      for ( j = v40 + 56; ; j = *(_QWORD *)(j + 16) )
                      {
                        while ( 1 )
                        {
                          v42 = *(_WORD *)(j + 2);
                      ...
                      if ( v42 == 5 )
                      {
                        v138 = HeapAlloc(v4 + 432, 1297237576LL, 48LL);
                        if ( v138 )
                        {
                          *(_QWORD *)(v138 + 8) = *(_QWORD *)(v4 + 416);
                          *(_QWORD *)(v4 + 416) = v138;
                          *(_QWORD *)(v138 + 24) = AccFieldUnit;
                          *(_DWORD *)v138 = 1430668097;
                          *(_QWORD *)(v138 + 32) = j;
                          *(_DWORD *)(v138 + 16) = 0x10000;
                          *(_QWORD *)(v138 + 40) = v167;
                        }
                        else
                        {
                      ...
                      {
                        NameSpaceObjectNoLock = ReadField(v4, j, *(_QWORD *)(j + 32) + 12LL, v167);
                      }
                      else
                      {
                        if ( v167 != j )
                        {
                          *(_OWORD *)v167 = *(_OWORD *)j;
                          *(_OWORD *)(v167 + 16) = *(_OWORD *)(j + 16);
                          *(_QWORD *)(v167 + 32) = *(_QWORD *)(j + 32);
                          if ( (*(_BYTE *)j & 1) != 0 )
                          {
                    ...
                    if ( (gdwfAMLI & 4) != 0
                      && _InterlockedExchangeAdd((volatile signed __int32 *)(v40 + 104), 0xFFFFFFFF) == 1 )
                    {
                      *(_WORD *)(v40 + 56) |= 4u;
                    ...
                    if ( (gdwfAMLI & 4) != 0
                      && _InterlockedExchangeAdd((volatile signed __int32 *)0x68, 0xFFFFFFFF) == 1 )
                    {
                      MEMORY[0x38] |= 4u;
...
LABEL_50:
          ...
          NameSpaceObjectNoLock = ParseNameTail((char **)(v4 + 120), (__int64)&Src);
          goto LABEL_53;
        }
        if ( (v22 & 0x40) != 0 )
        {
        ...
        if ( (unsigned int)(*(_DWORD *)(v81 + 8) - v81 - 48) >= 0x70 )
        {
          v87 = v81;
          v170 = v81;
          while ( 1 )
          {
            ...
            if ( v82 )
              break;
            if ( (unsigned int)(*(_DWORD *)(v87 + 8) - *(_DWORD *)(v87 + 32)) >= 0x70 )
            {
              v82 = *(_QWORD *)(v87 + 32);
              *(_QWORD *)(v87 + 32) = v82 + 112;
              *(_DWORD *)(v82 + 4) = 112;
              goto LABEL_155;
            }
            v83 = v87;
          ...
          ListRemoveEntry(v82 + 16, v87 + 40, v85, v86);
          if ( *(_DWORD *)(v82 + 4) >= 0x90u )
          {
            *(_DWORD *)(v82 + 112) = 0;
            v152 = *(_DWORD *)(v82 + 4) - 112;
            *(_QWORD *)(v82 + 120) = v87;
            *(_DWORD *)(v82 + 116) = v152;
            *(_DWORD *)(v82 + 4) = 112;
...
LABEL_156:
          ...
          {
            if ( v81 == gpheapGlobal )
              v153 = NewGlobalHeap(&v170);
            else
              v153 = NewLocalHeap(&v170, v84, v85, v86);
            if ( !v153 )
            {
              v87 = v170;
              *(_QWORD *)(v170 + 16) = v81;
        ...
        *(_DWORD *)(v82 + 92) = v92;
        if ( (_DWORD)v92 )
        {
          ...
          byte_1C005AAD8 = KeAcquireSpinLockRaiseToDpc(&gmutHeap);
          if ( v98 <= *(_DWORD *)(v93 + 8) - (int)v93 - 48 )
          {
            v102 = v93;
            v169 = v93;
            while ( 1 )
            ...
            if ( *(unsigned int *)(v95 + 4) >= (unsigned __int64)v98 + 32 )
            {
              v148 = v95 + v98;
              *(_DWORD *)v148 = 0;
              v149 = *(_DWORD *)(v95 + 4) - v98;
              *(_QWORD *)(v148 + 8) = v102;
              *(_DWORD *)(v148 + 4) = v149;
              *(_DWORD *)(v95 + 4) = v98;
              HeapInsertFreeList(v102);
            }
LABEL_173:
            if ( v95 )
            {
LABEL_174:
            ...
            {
              if ( v93 == gpheapGlobal )
                v154 = NewGlobalHeap(&v169);
              else
                v154 = NewLocalHeap(&v169, v99, v100, v101);
              if ( !v154 )
              {
                v102 = v169;
                *(_QWORD *)(v169 + 16) = v93;
    ...
    switch ( v14 )
    {
      case 'B':
        ...
        *(_BYTE *)(v13 + 16) = *(*v9)++;
        ...
        goto LABEL_85;
      case 'D':
        NameSpaceObjectNoLock = ParseInteger(v9, v13, 4LL, 2LL);
        goto LABEL_83;
      case 'N':
        v107 = *v9;
...
LABEL_236:
              ...
              if ( v122 == gpheapGlobal )
                v162 = NewGlobalHeap(&v171);
              else
                v162 = NewLocalHeap(&v171, v125, v126, v127);
              if ( !v162 )
              {
                v128 = v171;
                *(_QWORD *)(v171 + 16) = v122;
...
LABEL_240:
            *(_QWORD *)(v167 + 32) = v132;
            if ( v132 )
            {
              memmove(v132, &pszDest, *(unsigned int *)(v167 + 24));
            }
            else
            {
              LogError(3221225626LL);
...
LABEL_214:
        ...
        goto LABEL_215;
      case 'O':
        NameSpaceObjectNoLock = ParseIntObj((_WORD **)v9, v13, 1);
        if ( NameSpaceObjectNoLock == -1072431103 )
        {
          NameSpaceObjectNoLock = ParseString((const void **)v9, v167, 1);
          if ( NameSpaceObjectNoLock == -1072431103 )
          {
            v141 = **v9;
            if ( (unsigned __int8)(v141 - 17) <= 2u )
            {
              v142 = PushTerm(v4, (unsigned int)*v9, v12, (unsigned int)*(&OpcodeTable + v141), v167);
              ++*v9;
              NameSpaceObjectNoLock = v142;
            }
          }
        }
        goto LABEL_83;
      case 'S':
        NameSpaceObjectNoLock = ParseSuperName(v4, v13, 0LL, v12);
        goto LABEL_83;
      case 'W':
        NameSpaceObjectNoLock = ParseInteger(v9, v13, 2LL, 2LL);
        goto LABEL_83;
      case 's':
        LOBYTE(a3) = 1;
        NameSpaceObjectNoLock = ParseSuperName(v4, v13, a3, v12);
        goto LABEL_83;
      default:
...
LABEL_90:
    ...
    if ( *(int *)(a2 + 28) < 0 )
    {
      v163 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, _DWORD, __int64))(a2 + 32);
      if ( v163 )
      {
        NameSpaceObjectNoLock = v163(
                                  12LL,
                                  1LL,
                                  *(unsigned int *)(a2 + 8),
                                  *(_QWORD *)(v3 + 64) + 112LL,
...
LABEL_91:
    ...
    if ( (gDebugger & 0xD0) != 0 && *(_DWORD *)(v3 + 76) )
      ConPrintf(")");
    v43 = *(__int64 (__fastcall **)(__int64, __int64, unsigned __int64, __int64))(*(_QWORD *)(v3 + 56) + 48LL);
    if ( v43 )
    {
      NameSpaceObjectNoLock = v43(v4, v3, a3, v6);
      if ( NameSpaceObjectNoLock || v3 != *(_QWORD *)(v4 + 416) )
        return NameSpaceObjectNoLock;
    }
    goto LABEL_95;
  }
...
LABEL_95:
  ...
  {
    v44 = *(_QWORD *)(v3 + 56);
    v45 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, __int64, _DWORD, __int64))(v44 + 32);
    if ( v45 )
    {
      if ( *(int *)(v44 + 28) >= 0 )
      {
...
LABEL_98:
  ...
  if ( v47 )
  {
    ...
    do
    {
      ...
      {
        v139 = *(_QWORD *)(v46 + 8);
        if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v139 + 8), 0xFFFFFFFF) == 1
          && (*(_BYTE *)v139 & 8) != 0 )
        {
          FreeData((_QWORD *)v139);
        }
      }
...
LABEL_119:
  v66 = *(unsigned int *)(v61 + 4);
  v67 = (_QWORD **)(v66 + v61 + 16);
  if ( *(_QWORD ***)(v61 + 24) == v67 )
  {
    *(_DWORD *)(v61 + 4) = *(_DWORD *)(v66 + v61 + 4) + v66;
    if ( v67[1] == v67 )
    {
      *(_QWORD *)(v64 + 40) = 0LL;
    }
  ...
  if ( v61 == v68 + v69 )
  {
    *(_DWORD *)(v68 + 4) = v69 + *(_DWORD *)(v61 + 4);
    ListRemoveEntry(v61 + 16, v64 + 40, v63, v62);
    v61 = v165;
  }
  if ( *(_QWORD *)(v64 + 32) <= v61 + (unsigned __int64)*(unsigned int *)(v61 + 4) )
  {
    *(_QWORD *)(v64 + 32) = v61;
    v70 = (_QWORD **)(v61 + 16);
    if ( v70[1] == v70 )
