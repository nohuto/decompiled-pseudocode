/*
 * XREFs of ACPIBusIrpSetSystemPower @ 0x1C0036C64
 * Callers:
 ...
 *     ACPIDispatchPowerIrpSuccess @ 0x1C003A2D0 (ACPIDispatchPowerIrpSuccess.c)
 */
  ...
  else
  {
    ...
    else
    {
      ...
      if ( *(_DWORD *)(DeviceExtension + 328) != v9.SystemState )
      {
        ...
        *(_BYTE *)(v13 + 3) |= 1u;
        _InterlockedIncrement((volatile signed __int32 *)(DeviceExtension + 672));
        PoRequestPowerIrp(DeviceObject, 2u, v9, (PREQUEST_POWER_COMPLETE)ACPIBusIrpSetSystemPowerComplete, Context, 0LL);
        return 259LL;
      }
    }
