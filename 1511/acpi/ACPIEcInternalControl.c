/*
 * XREFs of ACPIEcInternalControl @ 0x1C0079DD4
 * Callers:
 ...
 *     ACPIEcDisconnectHandler @ 0x1C007A570 (ACPIEcDisconnectHandler.c)
 */
...
__int64 __fastcall ACPIEcInternalControl(ULONG_PTR a1, IRP *a2)
{
  ...
  v4 = -1073741811;
  v5 = *(_QWORD *)(ACPIInternalGetDeviceExtension(a1) + 176);
