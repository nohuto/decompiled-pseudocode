/*
 * XREFs of ACPIBuildSynchronizationRequestInternal @ 0x1C0021214
 * Callers:
 *     ACPIBuildDeviceDpc @ 0x1C001B910 (ACPIBuildDeviceDpc.c)
 *     ACPIGetWorkerForInteger @ 0x1C001CBB0 (ACPIGetWorkerForInteger.c)
 *     ACPIBuildSynchronizationRequest @ 0x1C0036660 (ACPIBuildSynchronizationRequest.c)
 *     OSNotifyDeviceCheck @ 0x1C003DA98 (OSNotifyDeviceCheck.c)
 *     OSNotifyDeviceEject @ 0x1C003DB94 (OSNotifyDeviceEject.c)
