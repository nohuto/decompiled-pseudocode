        ...
        char a7)
{
  ...
  {
    v14 = _InterlockedExchangeAdd((_DWORD *)&qword_1C005A1F8 + 1, 1u);
    if ( (_DWORD)qword_1C005A1F8 == 204 )
      v15 = v14 % 0xCC;
    else
      v15 = v14 % (unsigned int)qword_1C005A1F8;
    v16 = 72LL * v15;
  ...
  *((_QWORD *)&v17[24].Next + 1) = (char *)v17 + 392;
  ...
  if ( gplistCtxtHead )
  {
    *((_QWORD *)&v17[1].Next + 1) = gplistCtxtHead;
    v24->Next = *(_SLIST_ENTRY **)gplistCtxtHead;
    *(_QWORD *)(*(_QWORD *)gplistCtxtHead + 8LL) = v24;
    *(_QWORD *)gplistCtxtHead = v24;
  }
  else
  {
    ...
    if ( *(_WORD *)(a1 + 58) == 8 )
    {
      ...
      if ( v49 )
      {
        ...
        *(_QWORD *)(v49 + 48) = a1;
        ...
        if ( *(_WORD *)(a1 + 58) == 8 && (*(_WORD *)v27 & 0x200) != 0 )
...
LABEL_101:
    ...
    if ( (unsigned int)(*((_DWORD *)&v17[27].Next + 2) - ((_DWORD)v17 + 432) - 48) >= 0x48 )
    {
      ...
      while ( 1 )
      {
        ...
        if ( v36 )
        {
          ...
          while ( 1 )
          {
            ...
            v30 = (_SLIST_ENTRY *)(v60 - 16);
            if ( *(_DWORD *)(v60 - 12) >= 0x48u )
              break;
            v60 = *(_QWORD *)(v60 + 8);
            if ( v60 == v36 )
            {
              v61 = HIDWORD(v30->Next) < 0x48;
              break;
            }
          }
          if ( v61 )
        ...
        {
          v30 = v34[2].Next;
          v34[2].Next = (_SLIST_ENTRY *)((char *)v30 + 72);
          HIDWORD(v30->Next) = 72;
          goto LABEL_33;
        }
        v31 = v34;
      ...
      ListRemoveEntry(&v30[1], &v34[2].Next + 1, v33, 0LL);
      if ( HIDWORD(v30->Next) >= 0x68 )
      {
        *((_DWORD *)&v30[4].Next + 2) = v35;
        v62 = HIDWORD(v30->Next) - 72;
        v30[5].Next = v34;
        *((_DWORD *)&v30[4].Next + 3) = v62;
        HIDWORD(v30->Next) = 72;
...
LABEL_33:
      ...
      if ( !v63 )
      {
        ...
        *((_QWORD *)&v31[1].Next + 1) = v34;
        ...
        HIDWORD(v30->Next) = 72;
LABEL_34:
        LODWORD(v30->Next) = 1297237576;
        *((_QWORD *)&v30->Next + 1) = v34;
        memset(&v30[1], 0, 0x38uLL);
      }
    }
    KeReleaseSpinLock(&gmutHeap, byte_1C005AAD8);
    if ( v30 && (v37 = v30 + 1) != 0LL )
    {
    ...
    if ( !Field )
    {
      ...
      {
        Field = ReadField(v17, v27, *(_QWORD *)(v27 + 32) + 12LL, &v17[8]);
      }
      else
      {
        if ( v28 != (struct _SLIST_ENTRY *)v27 )
        {
          *v28 = *(struct _SLIST_ENTRY *)v27;
          v17[9] = *(PSLIST_ENTRY)(v27 + 16);
          v17[10].Next = *(_SLIST_ENTRY **)(v27 + 32);
          if ( (*(_BYTE *)v27 & 1) != 0 )
          {
...
LABEL_52:
  ...
  if ( (gDebugger & 0x8000) != 0 && P )
  {
    v45 = _InterlockedExchangeAdd((_DWORD *)&qword_1C005A1F8 + 1, 1u);
    if ( (_DWORD)qword_1C005A1F8 == 204 )
      v46 = v45 % 0xCC;
    else
      v46 = v45 % (unsigned int)qword_1C005A1F8;
    v47 = 72LL * v46;
