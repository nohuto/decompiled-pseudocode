/*
 * XREFs of OSInitializeCallbacks @ 0x1C0084000
 * Callers:
 ...
 *     CmosGetInterface @ 0x1C0065CF4 (CmosGetInterface.c)
 */
...
void OSInitializeCallbacks()
{
  ...
  CmosGetInterface(*(PDEVICE_OBJECT *)(v0 + 712));
  v2 = KeAcquireSpinLockRaiseToDpc(&AcpiDeviceTreeLock);
  --*(_DWORD *)(RootDeviceExtension + 676);
