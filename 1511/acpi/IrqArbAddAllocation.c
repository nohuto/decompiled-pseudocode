/*
 * XREFs of IrqArbAddAllocation @ 0x1C0069680
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IrqArbpLookupIsaOverrideByGsiv @ 0x1C006B2D0 (IrqArbpLookupIsaOverrideByGsiv.c)
...
LABEL_31:
      ...
      PoolWithTag = ExAllocatePoolWithTag(v31, 88LL * (v26 - 1) + 136, 0x49706341u);
...
LABEL_53:
            ...
            while ( 1 )
            {
              ...
              *(v40 - 5) = v43;
              v40[8] = v39 + v14;
              if ( (int)IrqArbGetDeviceIrql(&UserData[22 * v39 + 12], &UserData[22 * v39 + 14]) < 0 )
                break;
              v40 += 22;
              if ( ++v39 >= v26 )
                goto LABEL_53;
