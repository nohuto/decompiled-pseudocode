/*
 * XREFs of ACPIInterruptDispatchEventDpc @ 0x1C0024420
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( (_DWORD)v5 )
    {
      ...
      while ( 1 )
      {
        ...
        while ( v18 )
        {
          ...
          BYTE1(v31) = 1 << v20;
          BYTE2(v31) = v17;
          byte_1C0057097 = (v17 & (unsigned __int8)v21) != 0 ? 76 : 69;
          byte_1C0057098 = HexDigit[(unsigned __int64)(unsigned int)v22 >> 4];
          byte_1C0057099 = HexDigit[v22 & 0xF];
          if ( (int)AMLIGetNameSpaceObject(byte_1C0057090) < 0 )
            goto LABEL_27;
