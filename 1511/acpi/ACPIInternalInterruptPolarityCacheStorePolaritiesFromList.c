/*
 * XREFs of ACPIInternalInterruptPolarityCacheStorePolaritiesFromList @ 0x1C001DB84
 * Callers:
 ...
 * Callees:
 *     ACPIInternalInterruptPolarityCacheStorePolarity @ 0x1C001DC20 (ACPIInternalInterruptPolarityCacheStorePolarity.c)
 */
