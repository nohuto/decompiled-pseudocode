/*
 * XREFs of AcpiDeviceResetInvokeReset @ 0x1C0039E34
 * Callers:
  ...
  if ( v9 )
  {
    ...
    if ( *v10 != v10 )
    {
      do
      {
        ...
        {
          *(_QWORD *)(*(_QWORD *)(v13 + 32) + 904LL) |= 0x10000000uLL;
          ACPIDeviceInitializePowerRequest(*(_QWORD *)(v13 + 32), (POWER_STATE)4, 0LL, 0LL, 0, 0, 0);
        }
      }
      while ( v11 != (_QWORD *)(*(_QWORD *)(v7 + 72) + 48LL) );
    }
    ACPIDeviceInternalSynchronizeRequest(a1, (int)AcpiDeviceResetCompleteReset, v7);
  }
  else
  {
    v14.SystemState = *(_SYSTEM_POWER_STATE *)(a1 + 328);
