/*
 * XREFs of ACPIRootInitialize @ 0x1C0065EA0
 * Callers:
 *     ACPITableLoad @ 0x1C0006C60 (ACPITableLoad.c)
 * Callees:
 *     AMLISetNSObjectContext @ 0x1C00048C0 (AMLISetNSObjectContext.c)
...
__int64 ACPIRootInitialize()
{
  ...
  *(_QWORD *)(RootDeviceExtension + 704) = v20;
  ...
  {
    LODWORD(v20) = 0;
    if ( !(unsigned int)ACPIEvaluateOscWheaMethodOnRootBus(v9, v8, v10, v11, (__int64)&v20) )
      v1 = 1;
  }
  ...
  *(_OWORD *)v22 = SB_OSC_UUID;
  if ( !(unsigned int)ACPIAmliEvaluateOsc(v15, (int)v22, v13, 2, &v20) )
  {
  ...
  *(_OWORD *)v23 = SB_OSC_IOV_UUID;
  ACPIAmliEvaluateOsc(v17, (int)v23, v16, 1, &v21);
