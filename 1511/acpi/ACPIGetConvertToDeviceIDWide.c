/*
 * XREFs of ACPIGetConvertToDeviceIDWide @ 0x1C001E568
 * Callers:
 ...
 *     ACPIAmliDoubleToNameWide @ 0x1C001E794 (ACPIAmliDoubleToNameWide.c)
 *     ACPIGetProcessorIDWide @ 0x1C001EC10 (ACPIGetProcessorIDWide.c)
 *     memset @ 0x1C00251C0 (memset.c)
 */

__int64 __fastcall ACPIGetConvertToDeviceIDWide(_QWORD *a1, int a2, __int64 a3, int a4, char **a5, int *a6)
{
  int v8; // ebp
  char *v9; // rbx
  int v11; // eax
  ...
  if ( (a4 & 0x4000000) == 0 && (*a1 & 0x800000000000LL) != 0 )
  {
    ...
    RtlStringCchPrintfA(v9, v18, "%s", a1[69]);
    goto LABEL_22;
  }
  if ( a2 < 0 )
