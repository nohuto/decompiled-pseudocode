/*
 * XREFs of PciConfigSpaceHandlerWorker @ 0x1C0008D90
 * Callers:
...
LABEL_13:
    ...
    if ( *a4 )
    {
      if ( *a4 == 1 )
      {
        ...
        v26 = 0LL;
        Offset = v23;
        v28 = (unsigned __int16 *)&unk_1C004C2A2;
        do
        {
          ...
          v40 = v24;
          v28 = &PciConfigDisallowedRanges[v26 + 1];
        }
        while ( *v28 );
        if ( !v25 )
        {
...
LABEL_16:
  ...
  if ( v16 < 0 )
  {
    ...
    if ( v36 )
    {
      dword_1C005ADA0 = *(_DWORD *)(*(_QWORD *)v36 + 32LL);
      byte_1C005ADA4 = 0;
    }
    v37 = *((_QWORD *)a4 + 7);
    if ( v37 )
    {
      dword_1C005ADA0 = *(_DWORD *)(*(_QWORD *)v37 + 32LL);
      byte_1C005ADA4 = 0;
    }
  }
