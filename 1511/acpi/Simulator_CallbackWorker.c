/*
 * XREFs of Simulator_CallbackWorker @ 0x1C0042410
 * Callers:
 *     <none>
 * Callees:
 *     FreeDataBuffs @ 0x1C000F3B0 (FreeDataBuffs.c)
 *     AMLIResumeInterpreter @ 0x1C0042224 (AMLIResumeInterpreter.c)
 *     Simulator_DuplicateObjData @ 0x1C00425AC (Simulator_DuplicateObjData.c)
 *     Simulator_EvaluateNode @ 0x1C00425F4 (Simulator_EvaluateNode.c)
 *     Simulator_GetChildNode @ 0x1C00426F0 (Simulator_GetChildNode.c)
 *     Simulator_GetSiblingNode @ 0x1C0042734 (Simulator_GetSiblingNode.c)
