/*
 * XREFs of RunContext @ 0x1C00028F0
 * Callers:
 *     InsertReadyQueue @ 0x1C0003250 (InsertReadyQueue.c)
 *     DispatchCtxtQueue @ 0x1C001F5B0 (DispatchCtxtQueue.c)
 * Callees:
...
__int64 __fastcall RunContext(PSLIST_ENTRY ListEntry)
{
  ...
  *((_QWORD *)&ListEntry[25].Next + 1) = KeGetCurrentThread();
  ...
  {
    v12 = _InterlockedExchangeAdd((_DWORD *)&qword_1C005A1F8 + 1, 1u);
    if ( (_DWORD)qword_1C005A1F8 == 204 )
      v13 = v12 % 0xCC;
    else
      v13 = v12 % (unsigned int)qword_1C005A1F8;
    v14 = 72LL * v13;
...
LABEL_27:
          ...
          if ( (v19 & 0x20) != 0 )
          {
            ...
            else if ( v21 )
            {
              ...
              if ( (gDebugger & 0x8000) != 0 && P )
              {
                v28 = _InterlockedExchangeAdd((_DWORD *)&qword_1C005A1F8 + 1, 1u);
                if ( (_DWORD)qword_1C005A1F8 == 204 )
                  v29 = v28 % 0xCC;
                else
                  v29 = v28 % (unsigned int)qword_1C005A1F8;
                v30 = 72LL * v29;
...
LABEL_45:
  ...
  if ( (gDebugger & 0x8000) != 0 && P )
  {
    v46 = _InterlockedExchangeAdd((_DWORD *)&qword_1C005A1F8 + 1, 1u);
    if ( (_DWORD)qword_1C005A1F8 == 204 )
      v47 = v46 % 0xCC;
    else
      v47 = v46 % (unsigned int)qword_1C005A1F8;
    v48 = 72LL * v47;
