...
__int64 __fastcall NVMeCompletionDpcRoutine(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_OWORD *)(a3 + 152) = v24;
  ...
  if ( *(_BYTE *)(a2 + 17) )
  {
    ...
    *(_QWORD *)(a2 + 8LL * (unsigned int)(*(_DWORD *)(a2 + 3232))++ + 3240) = v26;
    result = (unsigned int)-(*(_DWORD *)(a2 + 3232) < 0x400u);
    *(_DWORD *)(a2 + 3232) &= result;
  }
LABEL_51:
  if ( *(_BYTE *)(a2 + 18) == 1 )
  {
