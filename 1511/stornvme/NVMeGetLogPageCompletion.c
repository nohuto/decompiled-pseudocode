/*
 * XREFs of NVMeGetLogPageCompletion @ 0x1C000C140
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  if ( *(_BYTE *)(a2 + 3) == 14 || (result = *(unsigned int *)(a1 + 20), (result & 0xE) != 0) )
  {
    ...
    {
      result = *(_QWORD *)(v2 + 96);
      v10 = *(_QWORD *)(result + 4192);
      if ( v10 )
        result = StorPortExtendedFunction(25LL, a1, v10, *(unsigned int *)(result + 4200));
      *(_QWORD *)(v6 + 4192) = 0LL;
      *(_DWORD *)(v6 + 4200) = 0;
    }
LABEL_25:
  ...
  if ( *(_QWORD *)(v6 + 4192) )
  {
    ...
    v9 = *(_QWORD *)(v8 + 4192);
    if ( v9 )
      StorPortExtendedFunction(25LL, a1, v9, *(unsigned int *)(v8 + 4200));
    *(_QWORD *)(v6 + 4192) = 0LL;
    *(_DWORD *)(v6 + 4200) = 0;
    *(_BYTE *)(v6 + 4186) = 1;
  }
