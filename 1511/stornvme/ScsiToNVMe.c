/*
 * XREFs of ScsiToNVMe @ 0x1C00088F0
 * Callers:
 ...
 *     ScsiReportLunsCommand @ 0x1C00065F8 (ScsiReportLunsCommand.c)
 ...
 *     NVMeSplitIoCommand @ 0x1C00087F4 (NVMeSplitIoCommand.c)
...
__int64 __fastcall ScsiToNVMe(__int64 a1, __int64 a2)
{
  ...
  if ( *(_QWORD *)(a1 + 8 * v9 + 1176) == v5 || (v5 = v27, v27 < 6) || !v8 )
  {
    LOBYTE(v5) = 32;
    LOBYTE(v6) = 8;
