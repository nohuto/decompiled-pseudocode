/*
 * XREFs of ProtocolCommandToNVMe @ 0x1C000A8FC
 * Callers:
 *     NVMeHwBuildIo @ 0x1C0001F40 (NVMeHwBuildIo.c)
 * Callees:
 *     SglToPrp @ 0x1C0006094 (SglToPrp.c)
 *     FillClippedSGL @ 0x1C0006250 (FillClippedSGL.c)
 *     SrbAssignQueueId @ 0x1C000646C (SrbAssignQueueId.c)
 *     NVMeValidateProtocolCommandRequest @ 0x1C000A4F4 (NVMeValidateProtocolCommandRequest.c)
