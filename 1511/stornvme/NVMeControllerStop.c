/*
 * XREFs of NVMeControllerStop @ 0x1C0004994
 * Callers:
 ...
 *     IoQueuesFreeResources @ 0x1C0003F94 (IoQueuesFreeResources.c)
 *     NVMePowerCleanUp @ 0x1C00057F4 (NVMePowerCleanUp.c)
...
bool __fastcall NVMeControllerStop(__int64 a1)
{
  ...
  *(_WORD *)(a1 + 192) = 0;
  if ( !*(_BYTE *)(a1 + 16) )
    StorPortExtendedFunction(1LL, a1, *(_QWORD *)(a1 + 1176), v9);
  memset((void *)(a1 + 1176), 0, 0x7F8uLL);
  result = v2;
  *(_DWORD *)(a1 + 140) = 0;
  return result;
}
