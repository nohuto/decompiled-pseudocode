/*
 * XREFs of NVMeMaxOperationalPower @ 0x1C0005C68
 * Callers:
 *     NVMeHwAdapterControl @ 0x1C0001BB0 (NVMeHwAdapterControl.c)
 * Callees:
 *     NVMePerfStateTransition @ 0x1C0005844 (NVMePerfStateTransition.c)
 */
    ...
    *(_BYTE *)(a1 + 1120) = v11;
    StorPortDebugPrint(
      ...
      *(_QWORD *)(a2 + 8),
      ...
      v10);
    if ( (*(_DWORD *)(a1 + 1112) & 4) != 0 && *(unsigned __int8 *)(a1 + 1119) != v12 )
    {
      if ( _interlockedbittestandset((volatile signed __int32 *)(a1 + 1152), 0) )
      {
        *(_DWORD *)(a1 + 1112) |= 0x80u;
      }
