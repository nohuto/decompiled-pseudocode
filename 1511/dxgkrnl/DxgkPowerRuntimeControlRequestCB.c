/*
 * XREFs of DxgkPowerRuntimeControlRequestCB @ 0x1C001D320
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  v10 = *(_QWORD *)(*(_QWORD *)(a1 + 64) + 2544LL);
  ...
  if ( v10 && *(_BYTE *)(v10 + 2465) )
    return PoFxPowerControl(*(_QWORD *)(v10 + 2032), a2, a3, a4, a5, a6, a7);
