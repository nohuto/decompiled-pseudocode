/*
 * XREFs of ?DuplicateSurfacesForOpen@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_OPENSWAPCHAIN@@@Z @ 0x1C0166104
 * Callers:
...
__int64 __fastcall DXGSWAPCHAIN::DuplicateSurfacesForOpen(UINT *this, struct _D3DKMT_OPENSWAPCHAIN *a2)
{
  ...
  v10 = v7;
  pNtSurfaceHandles = (HANDLE *)(this + 38);
  if ( v7 )
    pNtSurfaceHandles = (HANDLE *)(this + 24);
  ...
  else
  {
    ...
    while ( 1 )
    {
      v27 = *((_QWORD *)this + 9) + 56LL * (unsigned int)v14;
...
LABEL_13:
  if ( (int)v4 < 0 )
  {
    v23 = (struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_INFO *)(this + 38);
    if ( v5 )
      v23 = (struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_INFO *)(this + 24);
