/*
 * XREFs of DxgkReleaseKeyedMutex2 @ 0x1C0152750
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkReleaseKeyedMutex2(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v22; // rcx
  __int64 v23; // r8
  _BYTE v24[64]; // [rsp+B0h] [rbp+B0h] BYREF
...
LABEL_6:
    if ( !v9 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
      Template_q(v8, &EventProfilerExit, v7, 2069);
    return 3221225485LL;
  }
  if ( v3 >= MmUserProbeAddress )
    v3 = MmUserProbeAddress;
  *(_OWORD *)(((unsigned __int64)v24 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) = *(_OWORD *)v3;
  *(_OWORD *)(((unsigned __int64)v24 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20) = *(_OWORD *)(v3 + 16);
  *(_QWORD *)(((unsigned __int64)v24 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30) = *(_QWORD *)(v3 + 32);
  ...
  v18 = DXGKEYEDMUTEX::ReleaseSync(
          ...
          *(char **)(((unsigned __int64)v24 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28),
          *(_DWORD *)(((unsigned __int64)v24 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30));
  v20 = v18;
  if ( v18 < 0 )
  {
  ...
  DXGKEYEDMUTEXBYHANDLE::~DXGKEYEDMUTEXBYHANDLE((DXGKEYEDMUTEX **)((unsigned __int64)v24 & 0xFFFFFFFFFFFFFFC0uLL));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v22, &EventProfilerExit, v23, 2069);
