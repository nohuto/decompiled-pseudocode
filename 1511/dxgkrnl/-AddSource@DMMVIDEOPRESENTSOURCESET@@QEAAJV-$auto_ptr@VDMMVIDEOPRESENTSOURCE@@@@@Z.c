/*
 * XREFs of ?AddSource@DMMVIDEOPRESENTSOURCESET@@QEAAJV?$auto_ptr@VDMMVIDEOPRESENTSOURCE@@@@@Z @ 0x1C00DC358
 * Callers:
 ...
 *     ?Add@?$Set@VDMMVIDEOPRESENTSOURCE@@@@QEAAEQEAVDMMVIDEOPRESENTSOURCE@@@Z @ 0x1C000E5AC (-Add@-$Set@VDMMVIDEOPRESENTSOURCE@@@@QEAAEQEAVDMMVIDEOPRESENTSOURCE@@@Z.c)
...
__int64 __fastcall DMMVIDEOPRESENTSOURCESET::AddSource(__int64 a1, _QWORD *a2)
{
  ...
  v4 = IndexedSet<DMMVIDEOPRESENTSOURCE>::FindById(a1, *(_DWORD *)(*a2 + 24LL));
  if ( v4 )
    LODWORD(v6) = v4 != v5;
  else
