/*
 * XREFs of ?WaitUntilAllocationsNotBusy@DXGDEVICE@@QEAAXIPEAVDXGRESOURCE@@PEAPEAVDXGALLOCATION@@@Z @ 0x1C01335F4
 * Callers:
        ...
        struct DXGALLOCATION **a4)
{
  ...
  if ( a3 )
  {
    for ( i = *((_QWORD *)a3 + 3); i; i = *(_QWORD *)(i + 64) )
      (*(void (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 424LL)
                                                                          + 8LL)
                                                              + 592LL))(
