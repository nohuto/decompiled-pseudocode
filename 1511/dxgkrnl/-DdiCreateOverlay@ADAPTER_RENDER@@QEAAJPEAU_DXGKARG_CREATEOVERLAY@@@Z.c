/*
 * XREFs of ?DdiCreateOverlay@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_CREATEOVERLAY@@@Z @ 0x1C0126B98
 * Callers:
...
LABEL_13:
  ...
  v15 = *(_DWORD *)(v10 + 136);
LABEL_14:
  v17 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_CREATEOVERLAY *))(*((_QWORD *)this + 2) + 552LL))(
  ...
  v25[3] = v17;
  v25[4] = a2->OverlayInfo.hAllocation;
  v25[5] = a2->hOverlay;
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v28, &EventProfilerExit, v29, 5032);
