/*
 * XREFs of ?CheckMultiPlaneOverlaySupport@DXGDEVICE@@QEAAJIPEAUD3DKMT_CHECK_MULTIPLANE_OVERLAY_PLANE@@_NPEAH@Z @ 0x1C0139024
 * Callers:
        ...
        int *a5)
{
  ...
  *a5 = 0;
  ...
  if ( *(_BYTE *)(v9 + 1860) && *(_QWORD *)(v9 + 760) )
  {
        ...
        if ( v18 >= 0 )
        {
          ...
          if ( v49 )
          {
            ...
            *(_QWORD *)&p_SrcRect[-1].left = *(_QWORD *)(v28 + 16);
            v33 = *p_VidPnSourceId;
            if ( (_DWORD)v33 == ((*(_DWORD *)(v28 + 4) >> 6) & 0xF) && (unsigned int)v33 < *((_DWORD *)this + 710) )
            {
              if ( v47
                && !ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(*((_QWORD *)this + 354) + 1984LL), this, v33) )
              {
              ...
              *p_SrcRect = *(RECT *)(p_VidPnSourceId + 2);
              ...
              if ( !*(p_VidPnSourceId - 2) && !*(p_VidPnSourceId - 1)
                || (v41 = *((_QWORD *)this + 2),
                    ...
                    LODWORD(v55) = 0,
                    LODWORD(v54) = 0,
                    (*(void (__fastcall **)(_QWORD, __int64, LUID *, __int64, char *, int *, __int64 *, unsigned int *, char *, __int64 *))(*(_QWORD *)(*(_QWORD *)(v41 + 400) + 8LL) + 320LL))(
                      *(_QWORD *)(v41 + 408),
                      v42,
