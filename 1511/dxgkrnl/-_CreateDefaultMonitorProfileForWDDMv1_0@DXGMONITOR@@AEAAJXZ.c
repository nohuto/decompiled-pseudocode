/*
 * XREFs of ?_CreateDefaultMonitorProfileForWDDMv1_0@DXGMONITOR@@AEAAJXZ @ 0x1C018A63C
 * Callers:
...
__int64 __fastcall DXGMONITOR::_CreateDefaultMonitorProfileForWDDMv1_0(DXGMONITOR *this)
{
  ...
  *(_QWORD *)(v2 + 24) = this;
  ...
  v7 = (unsigned __int16 *)&unk_1C00317C0;
  v8 = 0LL;
  ...
  while ( 2 )
  {
    ...
    do
    {
      ...
      if ( VideoModeDescriptor < 0 )
      {
        ...
        v26 = 2LL;
        v27 = v25;
        v28 = (unsigned __int16 *)((char *)&unk_1C00317C0 + 4 * v8);
        v29 = (_QWORD *)(v25 + 24);
        do
        {
          v30 = *v28++;
      ...
      *v16 = (*((_DWORD *)this + 39))++;
      LODWORD(v15) = sub_1C00E21C4(v33, (__int64)(v16 + 2));
      if ( (int)v15 < 0 )
      {
