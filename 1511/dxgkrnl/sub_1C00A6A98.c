/*
 * XREFs of sub_1C00A6A98 @ 0x1C00A6A98
 * Callers:
...
__int64 __fastcall sub_1C00A6A98(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        _QWORD *a4,
        ...
        if ( NextMode )
        {
          do
          {
            ...
            if ( NextMode == (struct DMMVIDPNSOURCEMODE *)v16
              || (LOBYTE(v24) = v15, !(unsigned __int8)sub_1C00A6C58(a1, v8, NextMode, v24)) )
            {
            ...
            {
              ++*(_DWORD *)(v18 + a1 + 104);
              if ( (unsigned int)sub_1C00A6D34(a1, v36, v8, (_DWORD)NextMode, (__int64)v17, v15) == 1
                && (!v16 || (unsigned int)sub_1C00A6D34(a1, v36, v8, (_DWORD)NextMode, v16, v15) == -1) )
              {
