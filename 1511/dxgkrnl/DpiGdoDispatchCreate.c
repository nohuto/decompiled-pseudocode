/*
 * XREFs of DpiGdoDispatchCreate @ 0x1C00BC5F0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DpiGdoDispatchCreate(__int64 a1, IRP *a2)
{
  ...
  else if ( *(_BYTE *)(v3 + 1091) && *(_BYTE *)(v3 + 480) )
  {
    v6 = dword_1C0046FB0 != 4 ? 0xC0000001 : 0;
  }
  else
  {
    KeEnterCriticalRegion();
    v4 = (struct _ERESOURCE *)(v3 + 2440);
    ExAcquireResourceExclusiveLite((PERESOURCE)(v3 + 2440), 1u);
    v5 = *(_DWORD *)(v3 + 236);
