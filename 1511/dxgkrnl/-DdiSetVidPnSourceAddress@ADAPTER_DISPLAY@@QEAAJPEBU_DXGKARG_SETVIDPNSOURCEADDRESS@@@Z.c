/*
 * XREFs of ?DdiSetVidPnSourceAddress@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETVIDPNSOURCEADDRESS@@@Z @ 0x1C0007278
 * Callers:
        ...
        __int64 a3)
{
  ...
  {
    v13 = (*(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETVIDPNSOURCEADDRESS *))(v6 + 480))(
            *(_QWORD *)(v6 + 224),
            a2);
    goto LABEL_20;
  }
...
LABEL_29:
  ...
  v12 = *(_DWORD *)(v8 + 136);
LABEL_15:
  v13 = (*(__int64 (__fastcall **)(_QWORD, const struct _DXGKARG_SETVIDPNSOURCEADDRESS *))(*((_QWORD *)this + 2) + 480LL))(
...
LABEL_20:
  ...
  v14[7] = hAllocation;
  if ( v13 != -1073741811 && v13 != -1073741801 && v13 )
  {
    v23 = WdLogNewEntry5_WdError();
    *(_QWORD *)(v23 + 24) = (int)v13;
    WdLogEvent5_WdError(v23);
  }
  if ( v5 )
    DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(hAllocation, &EventProfilerExit, v15, 5010LL);
  return v13;
}
