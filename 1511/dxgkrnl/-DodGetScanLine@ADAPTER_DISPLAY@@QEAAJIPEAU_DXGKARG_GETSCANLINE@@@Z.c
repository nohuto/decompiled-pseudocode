/*
 * XREFs of ?DodGetScanLine@ADAPTER_DISPLAY@@QEAAJIPEAU_DXGKARG_GETSCANLINE@@@Z @ 0x1C0129DDC
 * Callers:
        ...
        struct _DXGKARG_GETSCANLINE *a3)
{
  ...
  if ( *(_BYTE *)(v3 + 96) )
    ...
    BLTQUEUE::GetScanLineEmulation((BLTQUEUE *)(*(_QWORD *)(v3 + 8) + 2408LL * a2), &a3->ScanLine, &a3->InVerticalBlank);
  return v4;
}
