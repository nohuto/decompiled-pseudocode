/*
 * XREFs of ?GetCahcedBufferSizes@QDC_CACHE@@QEAAJIPEAI0@Z @ 0x1C00AAFFC
 * Callers:
        ...
        unsigned int *a4)
{
  ...
  if ( *(_BYTE *)this )
  {
    *(_QWORD *)(WdLogNewEntry5_WdTrace(this, a2, a3, a4) + 24) = 226LL;
    return 3221225659LL;
  }
  else
  {
    DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v14, this[1]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v14);
    CacheEntry = QDC_CACHE::FindCacheEntry((QDC_CACHE *)this, 1, v6);
    if ( CacheEntry )
    {
      v12 = 0;
      *a3 = *((_DWORD *)CacheEntry + 2);
      *a4 = *((_DWORD *)CacheEntry + 6);
    }
    else
    {
      v12 = -1073741823;
      *(_QWORD *)(WdLogNewEntry5_WdTrace(v9, 0LL, v10, v11) + 24) = v6;
    }
    if ( v14[8] )
