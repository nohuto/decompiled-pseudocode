/*
 * XREFs of ??0?$DXGPOINTERARRAYORDEREDACQUIRE@VDXGSYNCOBJECT@@$1?AcquireSyncObjectMutex@@YAXPEAV1@@Z$1?ReleaseSyncObjectMutex@@YAX0@Z$01@@QEAA@PEAPEAVDXGSYNCOBJECT@@IE@Z @ 0x1C000BDA8
 * Callers:
  ...
  *(_BYTE *)(a1 + 32) = 1;
  if ( v5 )
  {
    ...
    for ( i = 0LL;
          ...
          DXGFASTMUTEX::Acquire((union _LARGE_INTEGER *)(*(_QWORD *)(*(_QWORD *)a1 + 8 * i++) + 32LL)) )
    {
      ;
    }
    *(_BYTE *)(a1 + 32) = 0;
