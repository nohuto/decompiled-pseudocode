        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( !v11 )
    return 3223192324LL;
  v17 = 0LL;
  v14 = (void **)Set<DMMVIDEOPRESENTSOURCE>::SetEnumerator<_D3DKMDT_VIDEO_PRESENT_SOURCE>::CreateInstance(&v18, v11);
  auto_ptr<Set<DMMVIDEOPRESENTTARGET>::SetEnumerator<_D3DKMDT_VIDEO_PRESENT_TARGET>>::operator=((void **)&v17, v14);
  operator delete(v18);
  if ( v17 )
  {
    v15 = *(_DWORD *)(v12 + 24);
