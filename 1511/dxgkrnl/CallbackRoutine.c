/*
 * XREFs of CallbackRoutine @ 0x1C001D9E0
 * Callers:
 *     <none>
 * Callees:
        ...
        ULONG ReasonSpecificDataLength)
{
  ...
  {
    if ( KiBugCheckData == 278 && qword_1C0047DD8 )
    {
      v4 = (unsigned int)(dword_1C0047DD4 - 1);
      if ( dword_1C0047DD4 != 1 )
      {
        do
        {
          if ( *(_BYTE *)(v4 + qword_1C0047DD8) )
            break;
          v5 = (_DWORD)v4 == 1;
      ...
      v6 = v4 + 1;
      v7 = xmmword_1C0047118;
      ReasonSpecificData[4] = qword_1C0047DD8;
    ...
    else
    {
      ...
      *((_OWORD *)ReasonSpecificData + 1) = xmmword_1C0047118;
      if ( v5 )
      {
