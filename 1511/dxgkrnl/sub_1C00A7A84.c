/*
 * XREFs of sub_1C00A7A84 @ 0x1C00A7A84
 * Callers:
...
__int64 __fastcall sub_1C00A7A84(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  VIDPN_MGR *v4; // rax
  unsigned int v5; // edi
...
LABEL_13:
    ...
    while ( 1 )
    {
      if ( *(_WORD *)(a1 + v8 + 68) >= *(_WORD *)(a1 + v8 + 70) )
        goto LABEL_46;
      v24 = sub_1C00A6A98(a1, a2, v50, v16, v45, v22, &v48);
      v23 = v24;
      if ( v24 < 0 )
        break;
      v22 = v48;
      ...
      if ( (int)v23 >= 0 )
      {
        *(_QWORD *)(WdLogNewEntry5_WdTrace(v21, v18, v19, v20) + 24) = v22;
        v25 = v50;
        if ( (int)sub_1C00A7CC8(a1, a2, v50) >= 0 && (int)sub_1C00A7D7C(a1, a2, v25) >= 0 )
          goto LABEL_21;
        LODWORD(v23) = -1071774970;
      }
      ++*(_DWORD *)(a1 + v8 + 76);
...
LABEL_46:
  ...
  if ( (int)sub_1C00A7CC8(a1, a2, v6) < 0 || (int)sub_1C00A7D7C(a1, a2, v6) < 0 )
  {
