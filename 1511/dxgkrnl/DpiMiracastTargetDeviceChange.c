/*
 * XREFs of DpiMiracastTargetDeviceChange @ 0x1C0025250
 * Callers:
 *     <none>
 * Callees:
      ...
      else
      {
        ...
        *((_QWORD *)Context + 11) = 0LL;
        ...
        if ( v15 )
        {
          ...
          *v24 = v23;
          v23[1] = v24;
          v25 = (__int64 **)qword_1C0047028;
          *(_QWORD *)Context = &qword_1C0047020;
          *((_QWORD *)Context + 1) = v25;
          if ( *v25 != &qword_1C0047020 )
            __fastfail(3u);
          *v25 = (__int64 *)Context;
          qword_1C0047028 = (__int64)Context;
