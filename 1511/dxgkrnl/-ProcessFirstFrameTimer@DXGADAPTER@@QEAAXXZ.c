/*
 * XREFs of ?ProcessFirstFrameTimer@DXGADAPTER@@QEAAXXZ @ 0x1C001B32C
 * Callers:
 *     ?DxgkpFirstFrameTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z @ 0x1C001ABD0 (-DxgkpFirstFrameTimerDpc@@YAXPEAU_KDPC@@PEAX11@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::ProcessFirstFrameTimer(KSPIN_LOCK *this)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel(this + 389, &LockHandle);
  v2 = 0;
  for ( *((_BYTE *)this + 3120) = 0; v2 < *((_DWORD *)this + 734); ++v2 )
  {
    v3 = 248LL * v2;
    v4 = this[366];
    if ( *(_BYTE *)(v4 + v3 + 240) )
