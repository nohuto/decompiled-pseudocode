/*
 * XREFs of DxgkFlipOverlay @ 0x1C01491D0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  *(_OWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28) = *v4;
  *(_OWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = v4[1];
  v13 = *(unsigned int *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28);
...
LABEL_14:
  ...
  v18 = (*(_DWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x2C) >> 6) & 0xFFFFFF;
  if ( v18 < *((_DWORD *)Current + 58)
    && (v19 = *((_QWORD *)Current + 27),
        v20 = *(_DWORD *)(v19 + 16LL * v18 + 8),
        ((*(_DWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x2C) >> 26) & 0x30) == (*(_BYTE *)(v19 + 16LL * v18 + 8) & 0x30))
    && (v20 & 0x1000) == 0
    && (v20 & 0xF) != 0
  ...
  if ( !v21 )
  {
    ...
    v26[4] = -1073741811LL;
LABEL_24:
    v26[3] = *(unsigned int *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x2C);
...
LABEL_25:
  ...
  COREOVERLAYACCESS::COREOVERLAYACCESS((COREOVERLAYACCESS *)(v3 + 72), v21);
  v27 = COREOVERLAYACCESS::AcquireShared((COREOVERLAYACCESS *)(v3 + 72));
  if ( v27 >= 0 )
  {
    ...
    COREOVERLAYACCESS::~COREOVERLAYACCESS((COREOVERLAYACCESS *)(v3 + 72));
    goto LABEL_25;
  }
  COREOVERLAYACCESS::~COREOVERLAYACCESS((COREOVERLAYACCESS *)(v3 + 72));
  if ( *(_QWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 8) )
  ...
  DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v28, &EventProfilerExit, v29, 2024);
