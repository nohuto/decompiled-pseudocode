/*
 * XREFs of sub_1C018AF58 @ 0x1C018AF58
 * Callers:
...
char __fastcall sub_1C018AF58(__int64 a1, __int64 a2, int a3)
{
  __int64 v6; // rax
  __int64 v7; // rax
  int v9; // r8d
  ...
  else
  {
    ...
    v10 = v9 * (unsigned int)*(_QWORD *)(a1 + 20) / (unsigned int)HIDWORD(*(_QWORD *)(a1 + 20));
    if ( (int)(v10 - *(_DWORD *)(a2 + 20) / *(_DWORD *)(a2 + 24)) < 0
      && *(_DWORD *)(a1 + 20) / *(_DWORD *)(a1 + 24) - 60 < 0 )
    {
      return 0;
    }
    if ( (int)(v10 - *(_DWORD *)(a2 + 28) / *(_DWORD *)(a2 + 32)) > 0
      && *(_DWORD *)(a1 + 20) / *(_DWORD *)(a1 + 24) - 61 > 0 )
    {
      return 0;
    }
