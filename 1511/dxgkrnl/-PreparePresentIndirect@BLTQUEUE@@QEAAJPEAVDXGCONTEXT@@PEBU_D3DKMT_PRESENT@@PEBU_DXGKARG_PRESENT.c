/*
 * XREFs of ?PreparePresentIndirect@BLTQUEUE@@QEAAJPEAVDXGCONTEXT@@PEBU_D3DKMT_PRESENT@@PEBU_DXGKARG_PRESENT@@PEAVCOREDEVICEACCESS@@PEAVBLTENTRY@@@Z @ 0x1C015E028
 * Callers:
        ...
        struct BLTENTRY *a6)
{
  ...
  if ( v6 )
  {
    ...
    if ( (a3->Flags.Value & 0x400000) != 0 )
    {
      ...
      if ( pPresentRegions )
      {
        ...
        if ( v20->DirtyRectCount )
        {
          ...
          v23 = (struct DXGSWAPCHAIN **)*((_QWORD *)this + 298);
    ...
    v32 = (struct DXGSWAPCHAIN **)*((_QWORD *)this + 298);
    v45 = 0LL;
    v44[0] = PresentCount;
