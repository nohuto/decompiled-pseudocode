/*
 * XREFs of ?TdrCollectDbgInfoStage2@@YAXPEAU_TDR_RECOVERY_CONTEXT@@@Z @ 0x1C0143D70
 * Callers:
    ...
    if ( v3 )
    {
      if ( !v2 )
      {
        if ( *(_QWORD *)(*((_QWORD *)a1 + 4) + 1984LL) )
        {
          ...
          v9 = (unsigned int *)*((_QWORD *)a1 + 355);
          CTDR_DUMP_BUFFER::ShrinkLastSegment((CTDR_DUMP_BUFFER *)v9);
          *((_QWORD *)a1 + 354) = v9[6];
          *((_DWORD *)a1 + 32) = 5;
          TdrUpdateDbgReport(a1, 1);
        }
        v10 = (char *)CTDR_DUMP_BUFFER::AddSegment(*((CTDR_DUMP_BUFFER **)a1 + 355), 7, 0x804u);
        v11 = v10;
        if ( v10 )
        {
        ...
        v15 = (unsigned int *)*((_QWORD *)a1 + 355);
        CTDR_DUMP_BUFFER::ShrinkLastSegment((CTDR_DUMP_BUFFER *)v15);
        *((_QWORD *)a1 + 354) = v15[6];
        *((_DWORD *)a1 + 32) = 7;
        TdrUpdateDbgReport(a1, 1);
      }
      v16 = (CTDR_DUMP_BUFFER *)*((_QWORD *)a1 + 355);
      if ( v16 )
