/*
 * XREFs of DxgNotifyDpcCB @ 0x1C000B360
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgNotifyDpcCB(__int64 a1)
{
  ...
  if ( (_InterlockedCompareExchange((volatile signed __int32 *)(*(_QWORD *)(a1 + 64) + 2560LL), 0, 0) & 1) != 0 )
  {
    v2 = *(struct DXGADAPTER **)(*(_QWORD *)(a1 + 64) + 2544LL);
    if ( v2 )
    {
      v3 = *((_QWORD *)v2 + 249);
      if ( v3 )
      {
        (*(void (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(v3 + 400) + 8LL) + 16LL))(a1);
      }
      else
      {
        v6 = *(DXGDODPRESENT **)(*((_QWORD *)v2 + 248) + 320LL);
        if ( v6 )
