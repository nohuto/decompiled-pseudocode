/*
 * XREFs of MonitorDestroySimulatedMonitor @ 0x1C018694C
 * Callers:
...
__int64 __fastcall MonitorDestroySimulatedMonitor(PERESOURCE *this, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *(_QWORD *)(v6 + 32) = this;
  ...
  v13 = MONITOR_MGR::_HandleRemoveSimulatedMonitor((struct _FAST_MUTEX *)v9[1].OwnerTable, v4);
  MONITOR_MGR::_LogMonitorPresentEvent(OwnerTable, 1073741826, v4, v13, 0LL);
  return v13;
}
