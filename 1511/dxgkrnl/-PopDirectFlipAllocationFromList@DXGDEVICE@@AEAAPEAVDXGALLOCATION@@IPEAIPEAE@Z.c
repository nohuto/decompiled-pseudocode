/*
 * XREFs of ?PopDirectFlipAllocationFromList@DXGDEVICE@@AEAAPEAVDXGALLOCATION@@IPEAIPEAE@Z @ 0x1C006CCB8
 * Callers:
        ...
        unsigned __int8 *a4)
{
  ...
  if ( *a4 )
  {
    ...
    *(_QWORD *)(v13 + 24) = 7782LL;
    WdLogEvent5_WdAssertion(v13);
  }
  v9 = *((_DWORD *)this + v4 + 292);
  v10 = v4;
  if ( *a3 < v9 )
  {
    v14 = this[v4 + 130];
