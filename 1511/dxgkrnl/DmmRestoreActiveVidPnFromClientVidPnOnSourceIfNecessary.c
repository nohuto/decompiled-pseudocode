/*
 * XREFs of DmmRestoreActiveVidPnFromClientVidPnOnSourceIfNecessary @ 0x1C00C5508
 * Callers:
...
LABEL_32:
  ...
  EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>((__int64)&v68, v6);
  v62 = 0LL;
  ClientVidPnFromActive = VIDPN_MGR::CreateClientVidPnFromActive(v6, (__int64 *)&v62, v7, v8);
  ...
  while ( 1 )
  {
    ...
    PathSourceFromTarget = DMMVIDPNTOPOLOGY::GetPathSourceFromTarget(v63, v21, v15, v16);
...
LABEL_60:
      v49 = ADAPTER_DISPLAY::SetVidPnSourceVisibility(
              *(ADAPTER_DISPLAY **)(a1 + 1984),
              ...
              0LL,
              1024,
              *(struct DXGDEVICE **)(1016LL * ((*(_DWORD *)(a2 + 4) >> 6) & 0xF)
                                   + *(_QWORD *)(*(_QWORD *)(a1 + 1984) + 136LL)
                                   + 672),
              0);
      v51 = v49;
      if ( v49 < 0 )
