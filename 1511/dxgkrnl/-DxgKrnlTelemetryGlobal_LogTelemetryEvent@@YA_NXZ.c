/*
 * XREFs of ?DxgKrnlTelemetryGlobal_LogTelemetryEvent@@YA_NXZ @ 0x1C00010E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
bool DxgKrnlTelemetryGlobal_LogTelemetryEvent(void)
{
  ...
  if ( v1 - g_DxgKrnlTelemetryProviderGlobal > 600000000 )
  {
    ...
    if ( dword_1C0046C30 <= v4 )
      v2 = 0;
    else
      v2 = dword_1C0046C30 - v4;
LABEL_4:
    dword_1C0046C30 = v2;
LABEL_5:
    v0 = v2 < 0x3E8;
  ...
  if ( (unsigned int)dword_1C0046C30 < 0x3E8 )
  {
    v2 = dword_1C0046C30 + 1;
    goto LABEL_4;
  }
LABEL_6:
