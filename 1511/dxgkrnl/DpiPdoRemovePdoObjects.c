/*
 * XREFs of DpiPdoRemovePdoObjects @ 0x1C0172A80
 * Callers:
...
__int64 __fastcall DpiPdoRemovePdoObjects(__int64 a1, char a2)
{
  ...
  v5 = (struct _ERESOURCE *)(v2 + 1976);
  ExAcquireResourceExclusiveLite((PERESOURCE)(v2 + 1976), 1u);
  for ( i = *(_QWORD *)(v2 + 1968); i; i += 120LL )
  {
    if ( !*(_DWORD *)i )
      break;
    v9 = *(_QWORD *)(i + 40);
