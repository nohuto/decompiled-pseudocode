/*
 * XREFs of ?DdiSetPointerPosition@ADAPTER_DISPLAY@@QEAAJPEBU_DXGKARG_SETPOINTERPOSITION@@@Z @ 0x1C0099628
 * Callers:
...
LABEL_22:
  v11 = 0;
LABEL_12:
  v13 = (*(int (__fastcall **)(_QWORD, const struct _DXGKARG_SETPOINTERPOSITION *))(*((_QWORD *)this + 2) + 400LL))(
  ...
  v17[5] = a2->Flags.Value & 1;
  v17[6] = a2->X;
  Y = a2->Y;
  v17[7] = Y;
  if ( (_DWORD)v13 )
  {
    v27 = WdLogNewEntry5_WdError(Y);
    *(_QWORD *)(v27 + 24) = v13;
    WdLogEvent5_WdError(v27);
  }
  DXGADAPTER::ReleaseDdiSync(*((DXGADAPTER **)this + 2));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v19, &EventProfilerExit, v20, 5019);
