/*
 * XREFs of ?DiscardPendingPresent@BLTQUEUE@@AEAAXXZ @ 0x1C015DC70
 * Callers:
 ...
 *     ?ReleasePresentDoneEvent@BLTENTRY@@QEAAXE@Z @ 0x1C015EA94 (-ReleasePresentDoneEvent@BLTENTRY@@QEAAXE@Z.c)
 */
