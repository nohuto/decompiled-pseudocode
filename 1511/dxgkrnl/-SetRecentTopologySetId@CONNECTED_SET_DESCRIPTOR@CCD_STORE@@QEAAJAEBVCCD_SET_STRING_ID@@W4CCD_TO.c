/*
 * XREFs of ?SetRecentTopologySetId@CONNECTED_SET_DESCRIPTOR@CCD_STORE@@QEAAJAEBVCCD_SET_STRING_ID@@W4CCD_TOPOLOGY_CLASS@@@Z @ 0x1C005E568
 * Callers:
...
__int64 __fastcall CCD_STORE::CONNECTED_SET_DESCRIPTOR::SetRecentTopologySetId(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( a3 <= 8 && (v6 = 278, _bittest(&v6, a3)) )
  {
    ...
    v7 = sub_1C005D888(*(HANDLE *)(a1 + 96), &ValueName, (PCANSI_STRING)(a2 + 8));
    v9 = v7;
    if ( v7 < 0 )
      goto LABEL_10;
    ...
    v11 = sub_1C005D888(*(HANDLE *)(a1 + 96), &ValueName, (PCANSI_STRING)(a2 + 8));
    v9 = v11;
    if ( v11 < 0 )
    {
LABEL_10:
    ...
    else
    {
      ...
      if ( v12 )
        CCD_SET_STRING_ID::operator=(v12);
    }
