/*
 * XREFs of ?FlushScheduler@DXGDEVICE@@QEAAXW4DXGDEVICE_FLUSHSCHEDULER_REASON@@@Z @ 0x1C006E298
 * Callers:
...
void __fastcall DXGDEVICE::FlushScheduler(_QWORD *a1, int a2)
{
  ...
  if ( (*(int (__fastcall **)(_QWORD, _QWORD *))(*(_QWORD *)(*(_QWORD *)(a1[2] + 400LL) + 8LL) + 136LL))(a1[68], v14) < 0 )
  {
    v13 = WdLogNewEntry5_WdAssertion(v7);
    *(_QWORD *)(v13 + 24) = 4681LL;
