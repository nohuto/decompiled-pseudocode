/*
 * XREFs of DxgkQueryResourceInfo @ 0x1C00BB840
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkQueryResourceInfo(_OWORD *a1, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = 2004;
  ...
  if ( Current )
  {
    ...
    *(_OWORD *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) = *v7;
    *(_OWORD *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28) = v7[1];
    DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE(
      (DXGDEVICEBYHANDLE *)((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL),
      *(_DWORD *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18),
      Current,
      (struct DXGDEVICE **)(v3 + 16));
    v9 = *(_QWORD *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10);
    if ( v9 )
    {
      ...
      COREDEVICEACCESS::COREDEVICEACCESS(v3 + 64, v9, 0, v10, 0);
      ...
      else
      {
        Resource = DXGDEVICE::QueryResourceInfo<_D3DKMT_QUERYRESOURCEINFO>(
                     v9,
                     (_DWORD *)(v3 + 24),
                     *(_DWORD *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x1C));
        if ( Resource < 0 )
        {
          COREDEVICEACCESS::~COREDEVICEACCESS((COREDEVICEACCESS *)(v3 + 64));
          DXGDEVICEACCESSLOCKSHARED::~DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)(v3 + 8));
        ...
        else
        {
          ...
          *a1 = *(_OWORD *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18);
          a1[1] = *(_OWORD *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28);
          COREDEVICEACCESS::~COREDEVICEACCESS((COREDEVICEACCESS *)(v3 + 64));
          DXGDEVICEACCESSLOCKSHARED::~DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)(v3 + 8));
          DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL));
          if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    ...
    *(_QWORD *)(v25 + 24) = *(unsigned int *)(((unsigned __int64)&v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18);
