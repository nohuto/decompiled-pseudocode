/*
 * XREFs of ?DdiGetStandardAllocationDriverData@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_GETSTANDARDALLOCATIONDRIVERDATA@@@Z @ 0x1C0069D6C
 * Callers:
...
LABEL_23:
  v12 = 0;
LABEL_12:
  v14 = (*(int (__fastcall **)(_QWORD, struct _DXGKARG_GETSTANDARDALLOCATIONDRIVERDATA *))(*((_QWORD *)this + 2) + 336LL))(
  ...
  v17[3] = v14;
  v17[4] = a2->AllocationPrivateDriverDataSize;
  v17[5] = a2->ResourcePrivateDriverDataSize;
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v19, &EventProfilerExit, v20, 5004);
