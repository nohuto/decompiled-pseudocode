/*
 * XREFs of ?LatencyToleranceTimerNotification@DXGADAPTER@@QEAAX_K@Z @ 0x1C001ADB8
 * Callers:
 *     ?DxgkLatencyToleranceTimerNotification@@YAXQEAX_K@Z @ 0x1C012C1A0 (-DxgkLatencyToleranceTimerNotification@@YAXQEAX_K@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::LatencyToleranceTimerNotification(KSPIN_LOCK *this, __int64 a2)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v21, this + 311, 1);
  v4 = this + 309;
  v5 = (_QWORD *)this[309];
  while ( v5 != v4 )
  {
...
LABEL_19:
      ...
      else
      {
        ...
        DXGADAPTER::SetPowerComponentLatencyCB(
          (DXGADAPTER *)this,
          *((_DWORD *)v6 + 1),
          *(_QWORD *)(this[289] + 16LL * v8));
        *((_DWORD *)v6 + 96) = v8;
        v6[49] = a2 + *(_QWORD *)(this[289] + 16LL * v8 + 8);
        if ( v8 == *((_DWORD *)v6 + 97) )
        {
          v9 = v6 + 50;
          v10 = *v9;
  ...
  if ( (_QWORD *)*v4 == v4 )
    *((_BYTE *)this + 2460) = 0;
  v17 = this[249];
  v18 = *(_QWORD *)(*(_QWORD *)(v17 + 400) + 8LL);
  v19 = *(void (__fastcall **)(_QWORD, __int64))(v18 + 752);
  LOBYTE(v18) = *((_BYTE *)this + 2460);
  v19(*(_QWORD *)(v17 + 408), v18);
  if ( v24 )
  {
    v24 = 0;
    *(_QWORD *)(v22 + 8) = 0LL;
