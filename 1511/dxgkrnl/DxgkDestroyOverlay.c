/*
 * XREFs of DxgkDestroyOverlay @ 0x1C0148DC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkDestroyOverlay(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v28; // r8
  int v29; // edx
  unsigned int v30[2]; // [rsp+60h] [rbp+0h] BYREF

  v3 = (unsigned int *)((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL);
  v4 = (_QWORD *)a1;
...
LABEL_6:
  ...
  *(_QWORD *)v3 = *v4;
  ...
  v13 = *(struct DXGDEVICE **)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20);
  *(_QWORD *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28) = v13;
  if ( !v13 )
  {
  ...
  if ( *(_DWORD *)(*(_QWORD *)(*((_QWORD *)v13 + 2) + 16LL) + 160LL) != 4 )
  {
    ...
    v21 = (*(_DWORD *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 4) >> 6) & 0xFFFFFF;
    if ( v21 < *((_DWORD *)Current + 58)
      && (v19 = *((_QWORD *)Current + 27),
          v17 = *(unsigned int *)(v19 + 16LL * v21 + 8),
          v18 = (*(_DWORD *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 4) >> 26) & 0x30,
          ((*(_DWORD *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 4) >> 26) & 0x30) == (*(_BYTE *)(v19 + 16LL * v21 + 8) & 0x30))
      && (v17 & 0x1000) == 0
      && (v17 & 0xF) != 0
    ...
    if ( v22 )
    {
      v24 = *(DXGDEVICE **)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20);
      if ( v24 == *((DXGDEVICE **)v22 + 2) )
      {
        if ( !DXGDEVICE::IsSupportOverlay(*(DXGDEVICE **)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20)) )
        {
        ...
        if ( v21 < *((_DWORD *)Current + 58) )
        {
          ...
          v29 = *(_DWORD *)(v28 + 16LL * v21 + 8);
          if ( ((*(_DWORD *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 4) >> 26) & 0x30) == (*(_BYTE *)(v28 + 16LL * v21 + 8) & 0x30)
            && (v29 & 0x1000) == 0
            && (v29 & 0xF) != 0 )
          {
            *(_DWORD *)(v28
                      + 16LL * ((*(_DWORD *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 4) >> 6) & 0xFFFFFF)
                      + 8) |= 0x1000u;
          }
        }
        ...
        DXGOVERLAYMUTEX::DXGOVERLAYMUTEX(
          ...
          *(struct ADAPTER_RENDER **)(*(_QWORD *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28) + 16LL));
        DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)(v3 + 18));
        DXGDEVICE::DestroyOverlay(v24, v22);
        DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)(v3 + 18));
        DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)(v3 + 18));
        COREACCESS::~COREACCESS((COREACCESS *)(v3 + 12));
        if ( *(_QWORD *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) )
      ...
      v25[3] = *(unsigned int *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 4);
      v25[4] = *v3;
      v25[5] = -1073741811LL;
...
LABEL_35:
    ...
    else
    {
      ...
      *(_QWORD *)(v23 + 24) = *(unsigned int *)(((unsigned __int64)v30 & 0xFFFFFFFFFFFFFFC0uLL) + 4);
