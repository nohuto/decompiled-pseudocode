/*
 * XREFs of ?DisplayConfigDestroySimulatedMonitors@@YAJPEAVDXGADAPTER@@PEAX@Z @ 0x1C00C29A0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_8:
  ...
  v9[3] = this;
  v9[4] = (int)HIDWORD(*(_QWORD *)((char *)this + 252));
  v9[5] = *((unsigned int *)this + 63);
LABEL_6:
