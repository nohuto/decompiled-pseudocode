/*
 * XREFs of ?PinPathContentScaling@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_SCALING@@_N@Z @ 0x1C0177BC4
 * Callers:
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_SCALING a3)
{
  ...
  v17 = VIDPN_MGR::FormalizeVidPnChange(this, v16, 7, 1, &v22);
  v10 = v17;
  if ( v17 < 0 )
  {
    if ( v17 == -1071774970 )
