/*
 * XREFs of ?IsValidCheckSum@EDID_PARSER@MonDescParser@@QEBA_NH@Z @ 0x1C000AB20
 * Callers:
 *     ?Initialize@EDID_PARSER@MonDescParser@@QEAA_NPEAEI@Z @ 0x1C000AB5C (-Initialize@EDID_PARSER@MonDescParser@@QEAA_NPEAEI@Z.c)
 * Callees:
 *     ?IsValidCheckSum@EDID_PARSER@MonDescParser@@AEBA_NPEAT_EDID_V1_BLOCK@@@Z @ 0x1C000ABB8 (-IsValidCheckSum@EDID_PARSER@MonDescParser@@AEBA_NPEAT_EDID_V1_BLOCK@@@Z.c)
 */
