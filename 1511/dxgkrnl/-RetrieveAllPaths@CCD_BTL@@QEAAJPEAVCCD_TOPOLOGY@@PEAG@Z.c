/*
 * XREFs of ?RetrieveAllPaths@CCD_BTL@@QEAAJPEAVCCD_TOPOLOGY@@PEAG@Z @ 0x1C006043C
 * Callers:
 ...
 *     ?_SortPathsModalityByPriorityOrder@CCD_BTL_ACTIVE_PATHS_COLLECTOR@@AEAAJXZ @ 0x1C00A1BA0 (-_SortPathsModalityByPriorityOrder@CCD_BTL_ACTIVE_PATHS_COLLECTOR@@AEAAJXZ.c)
...
__int64 __fastcall CCD_BTL::RetrieveAllPaths(CCD_BTL *this, struct CCD_TOPOLOGY *a2, unsigned __int16 *a3)
{
  ...
  result = DXGGLOBAL::IterateAdaptersWithCallback(Global, sub_1C00C5900, &v15, 1LL);
  if ( (int)result >= 0 )
  {
