/*
 * XREFs of ?IsDisplayingOnVidPnSource@DXGDEVICE@@QEAA_NI@Z @ 0x1C013AC6C
 * Callers:
 *     DXGDEVICE_IsDisplayingOnVidPnSource @ 0x1C001D280 (DXGDEVICE_IsDisplayingOnVidPnSource.c)
 * Callees:
