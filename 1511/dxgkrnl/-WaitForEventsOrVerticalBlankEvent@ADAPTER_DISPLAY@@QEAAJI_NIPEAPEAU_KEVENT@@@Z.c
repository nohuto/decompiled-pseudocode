/*
 * XREFs of ?WaitForEventsOrVerticalBlankEvent@ADAPTER_DISPLAY@@QEAAJI_NIPEAPEAU_KEVENT@@@Z @ 0x1C009A200
 * Callers:
        ...
        PVOID *Object)
{
  ...
  {
    v11 = (__int64)this[17] + 800;
    Timeout.QuadPart = -800000LL;
    *Object = (PVOID)(v11 + 1016 * v8);
    if ( a3 )
      v12 = UserRequest;
    else
      v12 = Executive;
