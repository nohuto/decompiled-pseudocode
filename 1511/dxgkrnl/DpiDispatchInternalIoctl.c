/*
 * XREFs of DpiDispatchInternalIoctl @ 0x1C00C2280
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiDispatchInternalIoctl(__int64 a1, IRP *a2)
{
  ...
  v5 = *(_QWORD *)(a1 + 64);
  v6 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v5 + 64), a2, &byte_1C00ED620, 1u, 0x20u);
  v11 = v6;
  if ( v6 < 0 )
  {
    v19 = WdLogNewEntry5_WdWarning(v8, v7, v9, v10);
    *(_QWORD *)(v19 + 24) = &DpiDispatchInternalIoctl;
    *(_QWORD *)(v19 + 32) = v11;
