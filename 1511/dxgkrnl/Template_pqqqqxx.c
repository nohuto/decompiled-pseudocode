/*
 * XREFs of Template_pqqqqxx @ 0x1C001D5B0
 * Callers:
...
NTSTATUS Template_pqqqqxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v14 = 8LL;
  v16 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &DevicePresentStateEvent, 0LL, 7u, &UserData);
}
