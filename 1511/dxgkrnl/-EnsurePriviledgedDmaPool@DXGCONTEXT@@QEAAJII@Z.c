/*
 * XREFs of ?EnsurePriviledgedDmaPool@DXGCONTEXT@@QEAAJII@Z @ 0x1C00854C4
 * Callers:
...
__int64 __fastcall DXGCONTEXT::EnsurePriviledgedDmaPool(DXGCONTEXT *this, int a2, int a3)
{
  ...
  {
    v13 = 1;
    v8 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, DXGCONTEXT *, char, _DWORD, int, int, _DWORD, _DWORD))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 424LL) + 8LL) + 416LL))(
    ...
    *((_QWORD *)this + 26) = v8;
    if ( v8 )
    {
      v3 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 16LL) + 424LL)
                                                          + 8LL)
                                              + 424LL))(v8);
      if ( v3 >= 0 )
      {
    ...
    {
      v12 = WdLogNewEntry5_WdWarning(0LL, v9, v10, v11);
      v3 = -1073741801;
      *(_QWORD *)(v12 + 24) = this;
