/*
 * XREFs of ?RetrieveActiveTopology@CCD_BTL@@QEAAJ_N0PEAVCCD_TOPOLOGY@@PEAG@Z @ 0x1C006031C
 * Callers:
        ...
        CCD_BTL *a5)
{
  ...
  LODWORD(v9) = DXGGLOBAL::IterateAdaptersWithCallback(Global, sub_1C00BF1C0, &v17, 1LL);
  if ( (int)v9 >= 0 )
  {
