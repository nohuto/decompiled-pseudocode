/*
 * XREFs of DpiPdoDestroyPendingPdoObjects @ 0x1C0172260
 * Callers:
...
__int64 __fastcall DpiPdoDestroyPendingPdoObjects(__int64 a1)
{
  ...
  v1 = (struct _IO_REMOVE_LOCK **)(*(_QWORD *)(a1 + 64) + 2320LL);
  while ( *v1 != (struct _IO_REMOVE_LOCK *)v1 )
  {
    ...
    *(_QWORD *)(v3 + 8) = v1;
    v4 = IoAcquireRemoveLockEx(v2 + 2, DpiPdoDestroyPendingPdoObjects, &byte_1C00ED620, 1u, 0x20u);
    v8 = v4;
    if ( v4 >= 0 )
    {
