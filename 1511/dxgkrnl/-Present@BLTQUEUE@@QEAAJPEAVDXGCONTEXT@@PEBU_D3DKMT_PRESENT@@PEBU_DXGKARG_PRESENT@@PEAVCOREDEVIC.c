/*
 * XREFs of ?Present@BLTQUEUE@@QEAAJPEAVDXGCONTEXT@@PEBU_D3DKMT_PRESENT@@PEBU_DXGKARG_PRESENT@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C015E204
 * Callers:
        ...
        struct COREDEVICEACCESS *a5)
{
  ...
  v10 = *((unsigned int *)this + 168);
  if ( (v10 & 1) == 0 )
    goto LABEL_5;
  Value = (struct _D3DKMT_PRESENT *)v6->Flags.Value;
  if ( ((unsigned __int8)Value & 7) == 0
    || (v10 = *(_QWORD *)(*(_QWORD *)(*((_QWORD *)a2 + 2) + 16LL) + 16LL), (*(_DWORD *)(v10 + 284) & 0x10) == 0) )
  {
...
LABEL_34:
      ...
      if ( (*((_DWORD *)DXGDODPRESENT::GetAdapter(*(DXGDODPRESENT **)this) + 71) & 0x100) != 0 )
      {
        v46 = (struct _KMUTANT *)*((_QWORD *)this + 299);
...
LABEL_58:
      if ( (int)v35 >= 0 )
      {
        ...
        *((LARGE_INTEGER *)this + 71) = KeQueryPerformanceCounter(0LL);
