/*
 * XREFs of ?NotifyPrimaryMonitorPowerChange@DXGADAPTER@@QEAAXE@Z @ 0x1C001B11C
 * Callers:
 *     ?DxgkPowerSettingCallback@@YAJPEBU_GUID@@PEAXK1@Z @ 0x1C012C1B0 (-DxgkPowerSettingCallback@@YAJPEBU_GUID@@PEAXK1@Z.c)
 * Callees:
...
void __fastcall DXGADAPTER::NotifyPrimaryMonitorPowerChange(KSPIN_LOCK *this, char a2)
{
  ...
  DXGAUTOSPINLOCK::DXGAUTOSPINLOCK((DXGAUTOSPINLOCK *)v12, this + 311, 1);
  ...
  *((_BYTE *)this + 2466) = a2;
  ...
  if ( !a2 )
    v7 = (char *)(this + 283);
  this[289] = (KSPIN_LOCK)v7;
  DXGADAPTER::UpdateLatencyTolerances((DXGADAPTER *)this);
  if ( this[254] )
  {
    v8 = (DXGADAPTER *)this[318];
    while ( v8 != (DXGADAPTER *)(this + 318) )
    {
      v9 = (char *)v8 - 424;
      v10 = *((int *)v8 - 10);
      v8 = *(DXGADAPTER **)v8;
      v11 = *(_QWORD *)(this[289] + 16 * v10);
      if ( v11 != *((_QWORD *)v9 + 46) )
