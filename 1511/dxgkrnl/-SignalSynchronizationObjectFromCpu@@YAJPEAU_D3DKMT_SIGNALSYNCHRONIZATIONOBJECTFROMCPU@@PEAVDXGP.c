/*
 * XREFs of ?SignalSynchronizationObjectFromCpu@@YAJPEAU_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMCPU@@PEAVDXGPROCESS@@PEAVDXGDEVICE@@@Z @ 0x1C01517B4
 * Callers:
...
LABEL_47:
    ...
    else
    {
      ...
      {
LABEL_39:
        v32 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, const UINT64 *))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)a3 + 2) + 400LL)
                                                                                             + 8LL)
                                                                                 + 552LL))(
                a1->ObjectCount,
                Elements,
  ...
  v14 = (struct DXGPROCESS *)((char *)a2 + 192);
  while ( 1 )
  {
...
LABEL_49:
  PagedPoolZeroedArray<_DEVICE_OBJECT *,8>::~PagedPoolZeroedArray<_DEVICE_OBJECT *,8>(v46);
  v38 = P;
  if ( P != &v42 && P )
