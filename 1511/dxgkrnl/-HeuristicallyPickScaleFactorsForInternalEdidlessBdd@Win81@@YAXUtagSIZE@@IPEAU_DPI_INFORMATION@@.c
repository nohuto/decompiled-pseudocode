/*
 * XREFs of ?HeuristicallyPickScaleFactorsForInternalEdidlessBdd@Win81@@YAXUtagSIZE@@IPEAU_DPI_INFORMATION@@@Z @ 0x1C0168E20
 * Callers:
        ...
        struct _DPI_INFORMATION *a4)
{
  ...
  do
  {
    ...
    HIDWORD(v10) = v6 / *v5;
    v11 = v10;
    if ( Win81::operator>=(&v11, dword_1C002F108) )
      break;
    v5 = (_DWORD *)(v9 - 4);
    --v8;
  }
  while ( v8 );
  *(_DWORD *)(v7 + 12) = PairedScaleFactorsArray_Win81[v8];
}
