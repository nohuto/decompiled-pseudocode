/*
 * XREFs of ?GetCurrentTvStandard@@YAIPEAVDXGADAPTER@@I@Z @ 0x1C0152F08
 * Callers:
...
__int64 __fastcall GetCurrentTvStandard(struct DXGADAPTER *a1, int a2)
{
  unsigned int v2; // edx
  unsigned int v3; // eax
  ...
  v7 = 0;
  DmmGetClientVidPnTargetModeInfo((int)a1, a2, (int)&v7, (int)&v5, (__int64)&v6, 0LL, 0LL, 0LL);
  v2 = 16;
  if ( v7 > 16 )
  {
    if ( v7 <= 21 )
