/*
 * XREFs of DpiFdoCreateRelatedObjects @ 0x1C00D4150
 * Callers:
...
__int64 __fastcall DpiFdoCreateRelatedObjects(__int64 a1, unsigned int a2, ULONG *a3)
{
  __int64 v3; // rsi
  __int64 v7; // rbx
  __int64 v8; // rcx
  ...
  LODWORD(v7) = DpiFdoInvalidateChildRelations(a1, 0x18u);
  if ( (int)v7 < 0 )
    goto LABEL_8;
  if ( (*(_BYTE *)(v3 + 2552) & 1) != 0 )
  {
    DxgkAcquireAdapterCoreSync(*(_QWORD *)(v3 + 2544), 2);
    v7 = (int)DmmInitializeAdapter(*(DXGADAPTER **)(v3 + 2544));
