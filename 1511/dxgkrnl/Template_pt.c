/*
 * XREFs of Template_pt @ 0x1C00236C8
 * Callers:
...
NTSTATUS Template_pt(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  v7 = 0;
  v6 = 4;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventDpiFdoThermalActiveCooling, 0LL, 2u, &v4);
}
