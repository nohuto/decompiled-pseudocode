/*
 * XREFs of ?AcquireFirstModeInfo@DXGK_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C017EFD0
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE **a3)
{
  ...
  __int64 v22; // rax
  __int64 v23; // rax
  struct DMMVIDPNSOURCEMODE *(__fastcall *v25)(DMMVIDPNSOURCEMODESET *); // [rsp+20h] [rbp-18h] BYREF
  ...
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v15 )
    {
      v26 = 0;
      v27 = 0LL;
      v25 = DMMVIDPNSOURCEMODESET::GetFirstMode;
