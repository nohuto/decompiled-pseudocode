/*
 * XREFs of ?DdiStopCapture@ADAPTER_RENDER@@QEAAJPEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C0128C78
 * Callers:
 *     ?ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z @ 0x1C001D170 (-ADAPTER_RENDER_DdiStopCapture@@YAJPEAVADAPTER_RENDER@@PEAU_DXGKARG_STOPCAPTURE@@@Z.c)
 * Callees:
...
LABEL_13:
  ...
  v15 = *(_DWORD *)(v10 + 136);
LABEL_14:
  v17 = (void *)(*(int (__fastcall **)(_QWORD, struct _DXGKARG_STOPCAPTURE *))(*((_QWORD *)this + 2) + 536LL))(
  ...
  v25[4].hAllocation = *(HANDLE *)(*((_QWORD *)this + 2) + 224LL);
