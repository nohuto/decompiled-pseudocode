/*
 * XREFs of ?TdrInit@@YAXXZ @ 0x1C00CD940
 * Callers:
...
void TdrInit(void)
{
  ...
  if ( dword_1C0047164 != v31 )
  {
    v20 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v20 + 24) = v31;
    *(_QWORD *)(v20 + 32) = (unsigned int)dword_1C0047164;
  ...
  if ( dword_1C0047168 != v33 )
  {
    v21 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v21 + 24) = v33;
    *(_QWORD *)(v21 + 32) = (unsigned int)dword_1C0047168;
  ...
  if ( dword_1C004716C != v28 )
  {
    v22 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v22 + 24) = v28;
    *(_QWORD *)(v22 + 32) = (unsigned int)dword_1C004716C;
  ...
  if ( dword_1C0047170 != v29 )
  {
    v23 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v23 + 24) = v29;
    *(_QWORD *)(v23 + 32) = (unsigned int)dword_1C0047170;
  ...
  if ( dword_1C0047178 != v30 )
  {
    v24 = WdLogNewEntry5_WdWarning(v3, v2, v4, v5);
    *(_QWORD *)(v24 + 24) = v30;
    *(_QWORD *)(v24 + 32) = (unsigned int)dword_1C0047178;
  ...
  if ( dword_1C004717C != v32 )
  {
    v25 = WdLogNewEntry5_WdWarning(3600LL, v2, v4, v5);
    *(_QWORD *)(v25 + 24) = v32;
    *(_QWORD *)(v25 + 32) = (unsigned int)dword_1C004717C;
    WdLogEvent5_WdWarning(v25);
  }
  LOBYTE(v13) = 1;
  byte_1C0047174 = (unsigned __int8)WdIsDebuggerPresent(v13) != 0;
  if ( v27 <= 3 )
    v0 = v27;
  g_TdrDebugMode = v0;
  if ( v0 != v27 )
