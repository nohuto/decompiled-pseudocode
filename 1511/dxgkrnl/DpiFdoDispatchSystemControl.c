/*
 * XREFs of DpiFdoDispatchSystemControl @ 0x1C016BBC0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall DpiFdoDispatchSystemControl(PDEVICE_OBJECT DeviceObject, PIRP Irp)
{
  ...
  if ( DeviceExtension[2368] == 1 )
  {
    v3 = WmiSystemControl((PWMILIB_CONTEXT)(DeviceExtension + 2376), DeviceObject, Irp, &IrpDisposition);
    if ( IrpDisposition )
    {
