/*
 * XREFs of ?_ProcessMonitorResolutionKey@DXGMONITOR@@AEAAJPEAXPEAU_KEY_BASIC_INFORMATION@@@Z @ 0x1C00E0D54
 * Callers:
        ...
        struct _KEY_BASIC_INFORMATION *a3)
{
  ...
  v44.Buffer = a3->Name;
  if ( !(unsigned __int8)sub_1C00E26C4(&v44, &v39, &v38) )
  {
  ...
  while ( 1 )
  {
    ...
    v40 = 0;
    v41 = 0;
    v23 = sub_1C0188988((_DWORD)v42, (unsigned int)&v38, (unsigned int)&v39, (unsigned int)&v40, (__int64)&v41);
    operator delete(v42);
    if ( !v23 )
      break;
