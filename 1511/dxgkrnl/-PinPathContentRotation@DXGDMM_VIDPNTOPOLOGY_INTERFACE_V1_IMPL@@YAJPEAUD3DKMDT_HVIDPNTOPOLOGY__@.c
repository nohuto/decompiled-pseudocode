/*
 * XREFs of ?PinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@IIW4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C00BCF80
 * Callers:
 *     <none>
 * Callees:
    ...
    else
    {
      ...
      if ( Path )
      {
        ...
        else
        {
          ...
          v23 = VIDPN_MGR::FormalizeVidPnChange(*(VIDPN_MGR **)(Container + 48), v22, 9, a5, v37);
          v5 = v23;
          if ( v23 < 0 )
          {
            if ( v23 == -1071774970 )
