/*
 * XREFs of ?GetDoDCddShadowSession@ADAPTER_DISPLAY@@QEBAPEAXIPEAI@Z @ 0x1C012C790
 * Callers:
...
void *__fastcall ADAPTER_DISPLAY::GetDoDCddShadowSession(DXGADAPTER **this, unsigned int a2, unsigned int *a3)
{
  ...
  if ( a2 >= *((_DWORD *)this + 26) )
  {
    ...
    *(_QWORD *)(v6 + 24) = 11021LL;
    WdLogEvent5_WdAssertion(v6);
  }
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(this[2]) )
  {
    v8 = WdLogNewEntry5_WdAssertion(v7);
    *(_QWORD *)(v8 + 24) = 11022LL;
    WdLogEvent5_WdAssertion(v8);
  }
  if ( *((_QWORD *)this[2] + 249) )
  {
    v9 = WdLogNewEntry5_WdAssertion(v7);
    *(_QWORD *)(v9 + 24) = 11023LL;
    WdLogEvent5_WdAssertion(v9);
  }
  v10 = 1016 * v4;
  v11 = *(void **)((char *)this[17] + v10 + 616);
  if ( v11 )
