/*
 * XREFs of ?RemoveVidPnOwnership@ADAPTER_DISPLAY@@QEAAXI@Z @ 0x1C0007B24
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::RemoveVidPnOwnership(OUTPUTDUPL_MGR **this, unsigned int a2)
{
  ...
  v4 = 1016LL * a2;
  if ( !*(_QWORD *)((char *)this[17] + v4 + 672) )
  {
    v6 = WdLogNewEntry5_WdAssertion(this);
    *(_QWORD *)(v6 + 24) = 4064LL;
    WdLogEvent5_WdAssertion(v6);
  }
  if ( !*(_DWORD *)((char *)this[17] + v4 + 680) )
  {
  ...
  *(_QWORD *)((char *)this[17] + v4 + 672) = 0LL;
  *(_DWORD *)((char *)this[17] + v4 + 680) = 0;
  *(_DWORD *)((char *)this[17] + v4 + 684) = 0;
  *(_QWORD *)((char *)this[17] + v4 + 688) = 0LL;
  OUTPUTDUPL_MGR::ProcessReleaseVidPnOwnership(this[16], a2);
}
