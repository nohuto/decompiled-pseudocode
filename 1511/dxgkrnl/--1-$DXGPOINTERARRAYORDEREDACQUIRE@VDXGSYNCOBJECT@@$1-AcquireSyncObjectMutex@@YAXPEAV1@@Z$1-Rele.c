/*
 * XREFs of ??1?$DXGPOINTERARRAYORDEREDACQUIRE@VDXGSYNCOBJECT@@$1?AcquireSyncObjectMutex@@YAXPEAV1@@Z$1?ReleaseSyncObjectMutex@@YAX0@Z$01@@QEAA@XZ @ 0x1C000BD50
 * Callers:
  ...
  if ( *(_QWORD *)a1 )
  {
    if ( !*(_BYTE *)(a1 + 32) )
    {
      for ( i = 0LL;
            ...
            DXGFASTMUTEX::Release((DXGFASTMUTEX *)(*(_QWORD *)(*(_QWORD *)a1 + 8 * i++) + 32LL)) )
      {
        ;
      }
    }
