/*
 * XREFs of ?DdiQueryAdapterInfo@DXGADAPTER@@QEAAJPEBU_DXGKARG_QUERYADAPTERINFO@@@Z @ 0x1C0079C70
 * Callers:
 *     DXGADAPTER_DdiQueryAdapterInfo @ 0x1C00104B0 (DXGADAPTER_DdiQueryAdapterInfo.c)
...
LABEL_25:
  v12 = 0;
LABEL_12:
  v14 = (*((int (__fastcall **)(_QWORD, const struct _DXGKARG_QUERYADAPTERINFO *))this + 37))(
          *((_QWORD *)this + 28),
          a2);
  ...
  if ( (_DWORD)v14 != -1073741811 && (_DWORD)v14 != -1073741822 && (_DWORD)v14 != -1073741801 && (_DWORD)v14 )
  {
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v19, &EventProfilerExit, v20, 5000);
