/*
 * XREFs of ?DdiQueryVidPnHWCapability@ADAPTER_DISPLAY@@QEAAJPEAU_DXGKARG_QUERYVIDPNHWCAPABILITY@@@Z @ 0x1C0099168
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (int)DXGADAPTER::GetDriverVersion(this[2]) < 1105 )
  {
    ...
    *(_QWORD *)(v22 + 24) = 29042LL;
    WdLogEvent5_WdAssertion(v22);
  }
  if ( !*((_QWORD *)this[2] + 82) )
  {
    v23 = WdLogNewEntry5_WdAssertion(v5);
    *(_QWORD *)(v23 + 24) = 29043LL;
...
LABEL_27:
  v12 = 0;
LABEL_16:
  v14 = (*((int (__fastcall **)(_QWORD, struct _DXGKARG_QUERYVIDPNHWCAPABILITY *))this[2] + 82))(
          *((_QWORD *)this[2] + 28),
          a2);
