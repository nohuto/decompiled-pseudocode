/*
 * XREFs of ?Lock@DXGDEVICE@@QEAAJPEAU_D3DKMT_LOCK@@PEAVCOREDEVICEACCESS@@@Z @ 0x1C006DBF8
 * Callers:
...
LABEL_39:
    ...
    LODWORD(v26) = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)(v26 + 8) + 264LL))(v25, v27);
    ...
    LODWORD(v23) = (*(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, __int64))(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 2) + 424LL)
                                                                                          + 8LL)
                                                                              + 592LL))(
