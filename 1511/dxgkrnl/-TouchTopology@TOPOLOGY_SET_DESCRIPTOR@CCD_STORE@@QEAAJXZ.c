/*
 * XREFs of ?TouchTopology@TOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@QEAAJXZ @ 0x1C006098C
 * Callers:
 ...
 *     ?_UpdateTimestampTopologySetCallback@?A0x55dd27e3@@YAJPEAVTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@PEAX@Z @ 0x1C00C6C60 (-_UpdateTimestampTopologySetCallback@-A0x55dd27e3@@YAJPEAVTOPOLOGY_SET_DESCRIPTOR@CCD_STORE@@PEA.c)
 * Callees:
 *     <none>
 */
