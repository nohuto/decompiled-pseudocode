/*
 * XREFs of ?SqmAdapterInformation@DXGADAPTER@@QEAAXXZ @ 0x1C00D6CEC
 * Callers:
...
void __fastcall DXGADAPTER::SqmAdapterInformation(DXGADAPTER *this)
{
  ...
  v2 = 0;
  v3 = (ADAPTER_RENDER *)*((_QWORD *)this + 249);
  if ( v3 )
  ...
  LOBYTE(v2) = *((_BYTE *)this + 1863) != 0;
  DxgkSqmGenericDword(&Dxgk_SqmSetDwordEvt, 12051, v2);
  *(_DWORD *)(*((_QWORD *)this + 394) + 424LL) = *((_DWORD *)this + 65);
  *(_QWORD *)(*((_QWORD *)this + 394) + 432LL) = *((_QWORD *)this + 132);
}
