/*
 * XREFs of Template_qqqiiqttddtqq @ 0x1C0020BB4
 * Callers:
...
NTSTATUS __fastcall Template_qqqiiqttddtqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a16)
{
  ...
  int v42; // [rsp+138h] [rbp+38h] BYREF
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v39 = 4LL;
  v41 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &Dxgk_Diag_OutputDupl_Get_Frame_Data, 0LL, 0xDu, &UserData);
}
