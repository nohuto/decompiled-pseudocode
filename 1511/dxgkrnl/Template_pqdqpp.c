/*
 * XREFs of Template_pqdqpp @ 0x1C0022828
 * Callers:
...
NTSTATUS Template_pqdqpp(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 8LL;
  v14 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventIndirectSwapChainOpen, 0LL, 6u, &UserData);
}
