/*
 * XREFs of ?ProcessPresent@OUTPUTDUPL_CONTEXT@@QEAAJPEAVDXGCONTEXT@@PEBU_D3DKMT_OUTPUTDUPLPRESENT@@PEAVAUTOEXPANDALLOCATION@@PEAPEAV2@@Z @ 0x1C015C7C8
 * Callers:
        ...
        struct DXGCONTEXT **a5)
{
  ...
  struct DXGCONTEXT *v20; // [rsp+28h] [rbp-30h]
  int v21; // [rsp+30h] [rbp-28h]
  const struct _D3DKMT_OUTPUTDUPLPRESENT *v22; // [rsp+38h] [rbp-20h]
  struct AUTOEXPANDALLOCATION *v23; // [rsp+40h] [rbp-18h]
  struct DXGCONTEXT **v24; // [rsp+48h] [rbp-10h]
