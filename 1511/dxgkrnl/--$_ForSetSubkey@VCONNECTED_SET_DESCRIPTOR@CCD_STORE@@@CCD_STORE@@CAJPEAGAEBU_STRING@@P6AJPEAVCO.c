/*
 * XREFs of ??$_ForSetSubkey@VCONNECTED_SET_DESCRIPTOR@CCD_STORE@@@CCD_STORE@@CAJPEAGAEBU_STRING@@P6AJPEAVCONNECTED_SET_DESCRIPTOR@0@PEAX@Z3_N@Z @ 0x1C005E190
 * Callers:
        ...
        __int64 a4)
{
  ...
  *(_DWORD *)((char *)&v29.Buffer + 2) = 0;
  ...
  if ( v10 < 0 )
    goto LABEL_9;
  v26 = 2;
  v9 = (int)sub_1C005F34C((int)&Handle, 983103, (int)v28, (int)&v29, &v26);
  ...
  if ( v26 == 1 )
  {
    ...
    *(_DWORD *)&ValueName.Length = 786442;
    v25 = sub_1C005D888(Handle, &ValueName, a2);
    v9 = v25;
    if ( v25 < 0 )
    {
      ZwClose(Handle);
