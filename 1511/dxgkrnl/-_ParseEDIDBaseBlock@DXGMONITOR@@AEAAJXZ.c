/*
 * XREFs of ?_ParseEDIDBaseBlock@DXGMONITOR@@AEAAJXZ @ 0x1C00DF9A8
 * Callers:
 ...
 *     sub_1C00E2128 @ 0x1C00E2128 (sub_1C00E2128.c)
  ...
  if ( v73 )
  {
    ...
    *(_QWORD *)&v72 = 0x800000008LL;
    for ( *((_QWORD *)&v72 + 1) = 8LL; v19 < *v3; ++v19 )
    {
      ...
      *v20 = (*((_DWORD *)this + 39))++;
      v23 = 28LL * v19;
      v24 = sub_1C00E21C4(&v3[v23 + 2], v20 + 2);
      v29 = v24;
      if ( v24 < 0
        || (v22[16] = 2,
            *(_OWORD *)(v22 + 17) = v72,
            ...
            v30 < 0) )
      {
        v65 = WdLogNewEntry5_WdWarning(v26, v25, v27, v28);
        *(_QWORD *)(v65 + 24) = this[16] + 3;
        *(_QWORD *)(v65 + 32) = v29;
      ...
      {
        v31 = sub_1C00E2128(LOBYTE(v3[v23 + 29]), v22 + 28);
        v35 = v31;
        if ( v31 >= 0 )
        {
        ...
        v67 = WdLogNewEntry5_WdWarning(0LL, v32, v33, v34);
        *(_QWORD *)(v67 + 24) = this[16] + 3;
        *(_QWORD *)(v67 + 32) = v35;
        WdLogEvent5_WdWarning(v67);
        v66 = (unsigned int)v35;
      }
      MonitorLogBadEDID(this[16] + 3, v66);
      operator delete(v22);
      LOBYTE(v1) = v74;
    }
  }
...
LABEL_32:
  ...
  v45 = v73;
  v46 = (char *)operator new[](52LL * (v73 - 1) + 56, 0x4D677844u, PagedPool);
  v4 = v46;
  if ( !v46 )
  {
LABEL_55:
    v71 = WdLogNewEntry5_WdError(v21);
  ...
  if ( v47 >= 0 )
  {
    ...
    if ( v45 )
    {
      while ( 1 )
      {
        ...
        if ( !v49 )
          goto LABEL_55;
        v51 = sub_1C00E350C(&v4[52 * v48 + 4], v49);
        v56 = v51;
        if ( v51 < 0 )
        {
          v70 = WdLogNewEntry5_WdWarning(v53, v52, v54, v55);
          *(_QWORD *)(v70 + 24) = this[16] + 3;
          *(_QWORD *)(v70 + 32) = v56;
...
LABEL_52:
  v69 = WdLogNewEntry5_WdError(v18);
  *(_QWORD *)(v69 + 24) = v12;
