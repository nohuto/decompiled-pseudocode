/*
 * XREFs of ?AcquireNextModeInfo@DXGDMM_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@QEBU_D3DKMDT_VIDPN_SOURCE_MODE@@PEAPEBU3@@Z @ 0x1C00E4A30
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE **a4)
{
  ...
  __int64 v8; // rcx
  __int64 v9; // r14
  struct D3DKMDT_HVIDPNSOURCEMODESET__ *v10; // rsi
  __int64 v11; // rdi
  __int64 v12; // rcx
  int v13; // eax
  __int64 v14; // rdx
...
LABEL_21:
  ...
  *(_QWORD *)&a3->Id = 0LL;
  ...
  if ( !DoublyLinkedList<DMMVIDPNSOURCEMODE>::ContainsByReference(v9 + 32, v11) )
  {
...
LABEL_16:
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v15, &EventProfilerExit, v16, 6004);
  return v7;
}
