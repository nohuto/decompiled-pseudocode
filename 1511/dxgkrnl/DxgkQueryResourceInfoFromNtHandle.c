/*
 * XREFs of DxgkQueryResourceInfoFromNtHandle @ 0x1C00BB5D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkQueryResourceInfoFromNtHandle(ULONG64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_DWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20) = 2073;
  ...
  if ( Current )
  {
    ...
    *(_OWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28) = *v7;
    *(_OWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = v7[1];
    DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE(
      (DXGDEVICEBYHANDLE *)((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL),
      *(_DWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28),
      Current,
      (struct DXGDEVICE **)(v3 + 16));
    v9 = *(_QWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10);
    if ( v9 )
    {
      DXGDEVICEACCESSLOCKSHARED::DXGDEVICEACCESSLOCKSHARED(
        ...
        *(struct DXGDEVICE **)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10));
...
LABEL_26:
      ...
      v17 = *(void **)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x30);
      ...
      *(_QWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x50) = v23;
      if ( v18 != -1073741788 )
      {
        if ( v18 >= 0 )
        {
          ...
          else
          {
            ...
            *(_OWORD *)a1 = *(_OWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28);
            *(_OWORD *)(a1 + 16) = *(_OWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38);
            *(_QWORD *)(a1 + 32) = *(_QWORD *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x48);
            COREDEVICEACCESS::~COREDEVICEACCESS((COREDEVICEACCESS *)(v3 + 96));
            DXGDEVICEACCESSLOCKSHARED::~DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)(v3 + 8));
            DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL));
            if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    ...
    else
    {
      ...
      *(_QWORD *)(v34 + 24) = *(unsigned int *)(((unsigned __int64)&v41 & 0xFFFFFFFFFFFFFFC0uLL) + 0x28);
      v29 = -1073741811;
