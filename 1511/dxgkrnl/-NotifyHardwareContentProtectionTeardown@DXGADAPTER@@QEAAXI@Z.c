/*
 * XREFs of ?NotifyHardwareContentProtectionTeardown@DXGADAPTER@@QEAAXI@Z @ 0x1C001B03C
 * Callers:
 *     DxgkHardwareContentProtectionTeardownCB @ 0x1C001D310 (DxgkHardwareContentProtectionTeardownCB.c)
 * Callees:
...
LABEL_7:
  ...
  *((_DWORD *)PoolWithTag + 3) = PsGetCurrentProcessSessionId();
  v9[2] = *(_QWORD *)((char *)this + 252);
  v11 = (struct _DEVICE_OBJECT *)*((_QWORD *)this + 22);
  ...
  if ( !WorkItem )
  {
    ...
    *(_QWORD *)(v10 + 24) = 2518LL;
    goto LABEL_7;
  }
  v17 = WdLogNewEntry5_WdEvent();
  *(_QWORD *)(v17 + 24) = 2522LL;
