/*
 * XREFs of ?DodSetIndirectSwapchain@ADAPTER_DISPLAY@@QEAAJIPEAX@Z @ 0x1C0129E34
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DodSetIndirectSwapchain(ADAPTER_DISPLAY *this, __int64 a2, void *a3, __int64 a4)
{
  ...
  if ( !*((_QWORD *)this + 40) )
    return 3221225485LL;
  if ( (unsigned int)a2 >= *((_DWORD *)this + 26) )
  {
...
LABEL_5:
  ...
  if ( *(_QWORD *)(v9 + 1304) )
  {
    v10 = (*(__int64 (__fastcall **)(_QWORD, _QWORD))(v9 + 1304))(*(_QWORD *)(v9 + 1280), (unsigned int)a2);
    v12 = v10;
    if ( v10 >= 0 )
    {
      return BLTQUEUE::SetIndirectSwapChainHandles(
               (BLTQUEUE *)(*(_QWORD *)(*((_QWORD *)this + 40) + 8LL) + 2408 * v5),
               a3);
    }
    else
    {
