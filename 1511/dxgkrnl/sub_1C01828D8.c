/*
 * XREFs of sub_1C01828D8 @ 0x1C01828D8
 * Callers:
...
__int64 __fastcall sub_1C01828D8(unsigned __int8 *a1, __int64 a2, __int64 a3, _DWORD *a4)
{
...
LABEL_11:
  ...
  else
  {
    ...
    {
      LOBYTE(a2) = 1;
      if ( (unsigned __int8)sub_1C0182B10(NextMode, a2, 0LL) )
      {
        v21 = a4[26];
        if ( (!v21 || *((_DWORD *)NextMode + 24) == v21)
          && ((*((_DWORD *)a1 + 1) & 0x20000) != 0
           || (unsigned int)sub_1C00A0948((__int64)NextMode + 76, (__int64)&a1[v18 + 36]) != 1) )
        {
          if ( v19 )
          {
            if ( (unsigned int)sub_1C00A1AD0(
