/*
 * XREFs of ?DodGetOpmMftContext@ADAPTER_DISPLAY@@QEAAJIPEA_K@Z @ 0x1C0129D60
 * Callers:
...
__int64 __fastcall ADAPTER_DISPLAY::DodGetOpmMftContext(ADAPTER_DISPLAY *this, __int64 a2, unsigned __int64 *a3)
{
  ...
  if ( *(_QWORD *)(v4 + 1312) )
  {
    v7 = (*(__int64 (__fastcall **)(_QWORD, __int64, unsigned __int64 *))(v4 + 1312))(*(_QWORD *)(v4 + 1280), a2, a3);
    v9 = v7;
    if ( v7 < 0 )
    {
