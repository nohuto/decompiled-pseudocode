/*
 * XREFs of ?SetPowerComponentResidencyCB@DXGADAPTER@@QEAAXI_K@Z @ 0x1C001BB3C
 * Callers:
 *     DxgkSetPowerComponentResidencyCB @ 0x1C001D400 (DxgkSetPowerComponentResidencyCB.c)
...
void __fastcall DXGADAPTER::SetPowerComponentResidencyCB(DXGADAPTER *this, int a2, __int64 a3)
{
  ...
  if ( *((_BYTE *)this + 2465) )
  {
    ...
    *(_QWORD *)(520LL * v5 + *((_QWORD *)this + 253) + 376) = a3;
    PoFxSetComponentResidency(*((_QWORD *)this + 254), v5, a3);
  }
}
