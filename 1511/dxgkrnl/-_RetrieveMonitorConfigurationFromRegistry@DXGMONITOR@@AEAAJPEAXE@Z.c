/*
 * XREFs of ?_RetrieveMonitorConfigurationFromRegistry@DXGMONITOR@@AEAAJPEAXE@Z @ 0x1C00E0A1C
 * Callers:
...
__int64 __fastcall DXGMONITOR::_RetrieveMonitorConfigurationFromRegistry(DXGMONITOR *this, void *a2, char a3)
{
  ...
  _BYTE v29[32]; // [rsp+88h] [rbp+17h] BYREF
  unsigned int v30; // [rsp+F0h] [rbp+7Fh] BYREF
  ...
  do
  {
    ...
    if ( !((unsigned __int8 (__fastcall *)(DXGMONITOR *, _QWORD))v4[2])(this, v30) )
    {
