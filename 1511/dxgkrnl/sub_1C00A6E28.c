/*
 * XREFs of sub_1C00A6E28 @ 0x1C00A6E28
 * Callers:
...
__int64 __fastcall sub_1C00A6E28(__int64 a1, unsigned __int16 a2, __int64 a3, __int64 a4)
{
  __int64 v6; // rbx
  unsigned int v7; // edx
  ...
  if ( ((*(_DWORD *)v6 & 1) == 0
    ...
    && (*(_DWORD *)v6 & 2) != 0 )
  {
    v9 = (const struct _D3DDDI_RATIONAL *)(v6 + 44);
    if ( *(_DWORD *)(v6 + 48) )
    {
      if ( v9->Numerator )
      {
