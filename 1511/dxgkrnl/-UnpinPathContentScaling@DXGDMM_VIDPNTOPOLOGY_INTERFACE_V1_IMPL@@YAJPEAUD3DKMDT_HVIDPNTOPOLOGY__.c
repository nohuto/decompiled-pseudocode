/*
 * XREFs of ?UnpinPathContentScaling@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_N@Z @ 0x1C00E4770
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  if ( v8 )
  {
    ...
    if ( Path )
    {
      ...
      v16 = VIDPN_MGR::FormalizeVidPnChange(*(VIDPN_MGR **)(Container + 48), v15, 8, a4, v24);
      v6 = v16;
      if ( v16 < 0 )
      {
