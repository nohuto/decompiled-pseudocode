/*
 * XREFs of ?SetGivenPathDataFromActivePath@CCD_TOPOLOGY@@QEAAXPEAU_D3DKMT_PATHMODALITY_DESCRIPTOR@@PEBV1@@Z @ 0x1C018225C
 * Callers:
        ...
        const struct CCD_TOPOLOGY *a3)
{
  ...
  if ( *(_WORD *)(v8 + 20) )
  {
    ...
    {
      v10 = *(unsigned int *)(v9 + v8 + 132);
      if ( (unsigned int)v10 <= *(_DWORD *)(v9 + v8 + 84) )
      {
        v11 = *(_DWORD *)(v9 + v8 + 136);
        if ( v11 <= *(_DWORD *)(v9 + v8 + 88) && *(_DWORD *)(v9 + v8 + 168) == 1 )
        {
          if ( ((*((_DWORD *)a2 + 30) - 2) & 0xFFFFFFFD) != 0 )
          {
            if ( (unsigned int)v10 < *((_DWORD *)a2 + 35) )
              return;
          ...
          if ( !v12 )
          {
            if ( (*(_DWORD *)a2 & 0x100) != 0 )
            {
              ...
              *(_QWORD *)(v13 + 24) = 3074LL;
              WdLogEvent5_WdAssertion(v13);
            }
            if ( (*(_DWORD *)a2 & 1) != 0 )
            {
              v14 = WdLogNewEntry5_WdAssertion(v10);
              *(_QWORD *)(v14 + 24) = 3075LL;
              WdLogEvent5_WdAssertion(v14);
            }
            if ( (*((_DWORD *)a2 + 1) & 0x100) != 0 )
            {
              v15 = WdLogNewEntry5_WdAssertion(v10);
              *(_QWORD *)(v15 + 24) = 3076LL;
              WdLogEvent5_WdAssertion(v15);
            }
            if ( (*((_DWORD *)a2 + 1) & 1) != 0 )
            {
              v16 = WdLogNewEntry5_WdAssertion(v10);
              *(_QWORD *)(v16 + 24) = 3077LL;
              WdLogEvent5_WdAssertion(v16);
            }
            *(_OWORD *)((char *)a2 + 84) = *(_OWORD *)(v9 + v8 + 132);
            *(_OWORD *)((char *)a2 + 100) = *(_OWORD *)(v9 + v8 + 148);
