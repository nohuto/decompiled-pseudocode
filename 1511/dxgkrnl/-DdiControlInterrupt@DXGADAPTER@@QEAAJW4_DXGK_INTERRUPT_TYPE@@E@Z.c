/*
 * XREFs of ?DdiControlInterrupt@DXGADAPTER@@QEAAJW4_DXGK_INTERRUPT_TYPE@@E@Z @ 0x1C0079BF0
 * Callers:
 *     DXGADAPTER_DdiControlInterrupt @ 0x1C000CA60 (DXGADAPTER_DdiControlInterrupt.c)
...
LABEL_17:
  LOBYTE(v11) = a3;
  v20 = (*((int (__fastcall **)(_QWORD, _QWORD, __int64))this + 68))(*((_QWORD *)this + 28), (unsigned int)v4, v11);
