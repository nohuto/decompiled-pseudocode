/*
 * XREFs of DpiGetDbgInfoAdapters @ 0x1C002325C
 * Callers:
      ...
      if ( (__int64 *)*v5 != v5 )
      {
        do
        {
          if ( *((_DWORD *)v5 + 4) == 1953656900 && *((_DWORD *)v5 + 5) == 2 && *((_DWORD *)v5 + 59) == 2 )
          {
            if ( v2 >= 7 )
              break;
            DriverVersion = DXGADAPTER::GetDriverVersion((DXGADAPTER *)v5[318]);
            *(_DWORD *)(a1 + 8 * v7) = DriverVersion;
            *(_DWORD *)(a1 + 8 * v7 + 4) = *((_DWORD *)v5 + 265);
            *(_DWORD *)(a1 + 8 * v7 + 8) = *((_DWORD *)v5 + 266);
            *(_DWORD *)(a1 + 8 * v7 + 12) ^= (*(_DWORD *)(a1 + 8 * v7 + 12) ^ (*(_DWORD *)(v5[318] + 160) == 1)) & 1;
            *(_DWORD *)(a1 + 8 * v7 + 12) ^= (*(_DWORD *)(a1 + 8 * v7 + 12) ^ (2 * *((unsigned __int8 *)v5 + 1088))) & 2;
            v2 = v8 + 1;
          }
          v5 = (__int64 *)*v5;
        }
