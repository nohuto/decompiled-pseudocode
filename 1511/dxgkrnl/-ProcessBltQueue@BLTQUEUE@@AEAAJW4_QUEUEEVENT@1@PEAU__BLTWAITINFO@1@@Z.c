/*
 * XREFs of ?ProcessBltQueue@BLTQUEUE@@AEAAJW4_QUEUEEVENT@1@PEAU__BLTWAITINFO@1@@Z @ 0x1C00BFA8C
 * Callers:
...
LABEL_31:
    ...
    v5 = -1;
    if ( (*((_DWORD *)DXGDODPRESENT::GetAdapter(*(DXGDODPRESENT **)a1) + 71) & 0x100) != 0 )
    {
      v22 = *(struct _KMUTANT **)(a1 + 2392);
  ...
  if ( v10 )
  {
    ...
    v11 = 1;
LABEL_10:
    *(_DWORD *)(a1 + 664) ^= (*(_DWORD *)(a1 + 664) ^ (2 * v11)) & 2;
    if ( v10 )
    {
      v12 = *(unsigned int *)(a1 + 576);
      *(LARGE_INTEGER *)(a1 + 40 * v12 + 592) = KeQueryPerformanceCounter(0LL);
      *(_DWORD *)(a1 + 40 * v12 + 600) = v5;
    }
    *(_WORD *)(a1 + 261) = 0;
