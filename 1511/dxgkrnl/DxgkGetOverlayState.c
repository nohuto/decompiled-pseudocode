/*
 * XREFs of DxgkGetOverlayState @ 0x1C0149510
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  *(_QWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) = *(_QWORD *)v13;
  *(_DWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18) = *(_DWORD *)(v13 + 8);
  v14 = *(unsigned int *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10);
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE(
    (DXGDEVICEBYHANDLE *)((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL),
    *(_DWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10),
    (struct _KTHREAD **)Current,
    (struct DXGDEVICE **)(v3 + 32));
  v16 = *(struct ADAPTER_RENDER ***)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20);
  if ( !v16 )
  {
...
LABEL_15:
  ...
  *(_QWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38) = (char *)Current + 192;
  DXGPUSHLOCK::AcquireShared((struct DXGPROCESS *)((char *)Current + 192));
  v18 = (*(_DWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x14) >> 6) & 0xFFFFFF;
  if ( v18 < *((_DWORD *)Current + 58)
    && (v19 = *((_QWORD *)Current + 27),
        v20 = *(_DWORD *)(v19 + 16LL * v18 + 8),
        *(_DWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x14) >> 30 == ((v20 >> 4) & 3))
    && (v20 & 0x1000) == 0
    && (v20 & 0xF) != 0
  ...
  ExReleasePushLockSharedEx(*(_QWORD *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x38), 0LL);
  ...
  if ( !v21 )
  {
    ...
    v26[4] = -1073741811LL;
LABEL_25:
    v26[3] = *(unsigned int *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x14);
    WdLogEvent5_WdWarning(v26);
LABEL_26:
    DXGDEVICEACCESSLOCKSHARED::~DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)(v3 + 8));
    goto LABEL_15;
  }
  if ( v16 != *((struct ADAPTER_RENDER ***)v21 + 2) )
  {
    v26 = (_QWORD *)WdLogNewEntry5_WdWarning(v23, v22, v24, v25);
    v26[4] = v14;
    OverlayState = -1073741811;
  ...
  COREOVERLAYACCESS::COREOVERLAYACCESS((COREOVERLAYACCESS *)(v3 + 64), v21);
  v27 = COREOVERLAYACCESS::AcquireShared((COREOVERLAYACCESS *)(v3 + 64));
  if ( v27 >= 0 )
  {
    if ( !DXGDEVICE::IsSupportOverlay((DXGDEVICE *)v16) )
    {
      v30 = WdLogNewEntry5_WdAssertion(v29);
      *(_QWORD *)(v30 + 24) = 1037LL;
      WdLogEvent5_WdAssertion(v30);
    }
    DXGOVERLAYMUTEX::DXGOVERLAYMUTEX((DXGOVERLAYMUTEX *)(v3 + 40), v16[2]);
    DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)(v3 + 40));
    OverlayState = DXGOVERLAY::GetOverlayState(v21, (struct _D3DKMT_GETOVERLAYSTATE *)(v3 + 16));
    DXGAUTOMUTEX::Release((DXGAUTOMUTEX *)(v3 + 40));
    if ( OverlayState < 0 )
    {
      DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)(v3 + 40));
      COREOVERLAYACCESS::~COREOVERLAYACCESS((COREOVERLAYACCESS *)(v3 + 64));
      DXGDEVICEACCESSLOCKSHARED::~DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)(v3 + 8));
      DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL));
      goto LABEL_6;
    }
    ...
    *v31 = *(_BYTE *)(((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL) + 0x18);
    DXGPROCESSCOPYPROTECTIONMUTEX::~DXGPROCESSCOPYPROTECTIONMUTEX((DXGPROCESSCOPYPROTECTIONMUTEX *)(v3 + 40));
    COREOVERLAYACCESS::~COREOVERLAYACCESS((COREOVERLAYACCESS *)(v3 + 64));
    goto LABEL_26;
  }
  ...
  DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)((unsigned __int64)&v32 & 0xFFFFFFFFFFFFFFC0uLL));
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(qword_1C00467F0, &EventProfilerExit, v28, 2057);
