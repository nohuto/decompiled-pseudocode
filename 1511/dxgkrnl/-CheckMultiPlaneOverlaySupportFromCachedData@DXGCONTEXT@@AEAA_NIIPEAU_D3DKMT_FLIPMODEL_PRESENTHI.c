/*
 * XREFs of ?CheckMultiPlaneOverlaySupportFromCachedData@DXGCONTEXT@@AEAA_NIIPEAU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@@Z @ 0x1C01608C0
 * Callers:
 ...
 *     ?OverlayAttributesEqual@@YA_NAEBU_DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES@@0_N@Z @ 0x1C01617C0 (-OverlayAttributesEqual@@YA_NAEBU_DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES@@0_N@Z.c)
 */
...
LABEL_4:
  ...
  v28 = *(const struct _DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES **)(v27 + 872);
  v29 = *(_DWORD *)(v27 + 868);
