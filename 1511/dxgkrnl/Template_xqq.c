/*
 * XREFs of Template_xqq @ 0x1C0027BAC
 * Callers:
...
NTSTATUS Template_xqq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v7, va2);
  v8 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventMiracastDeviceStateChange, 0LL, 3u, &UserData);
}
