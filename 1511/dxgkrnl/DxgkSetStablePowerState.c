/*
 * XREFs of DxgkSetStablePowerState @ 0x1C014E7D0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( PairingAdapters >= 0 )
  {
    ...
    if ( v22 >= 0 )
    {
      ...
      *((_QWORD *)Current + 19) = KeGetCurrentThread();
      ...
      v37 = *(_QWORD *)(v33 + 1992);
      KeEnterCriticalRegion();
      ExAcquirePushLockExclusiveEx(v37 + 1128, 0LL);
      *(_QWORD *)(v37 + 1136) = KeGetCurrentThread();
      if ( *(_DWORD *)(((unsigned __int64)v47 & 0xFFFFFFFFFFFFFFC0uLL) + 0xC) )
      {
        if ( !*(_DWORD *)(v35 + 28) )
          ADAPTER_RENDER::AddStablePowerReference(*(ADAPTER_RENDER **)(v33 + 1992));
        ++*(_DWORD *)(v35 + 28);
      }
      else
      {
        ...
        if ( v42 )
        {
          ...
          *(_DWORD *)(v35 + 28) = v44;
          if ( !v44 )
            ADAPTER_RENDER::ReleaseStablePowerReference(*(ADAPTER_RENDER **)(v33 + 1992), v38, v40);
        }
        else
        {
      ...
      *(_QWORD *)(v37 + 1136) = 0LL;
      ExReleasePushLockExclusiveEx(v37 + 1128, 0LL);
      KeLeaveCriticalRegion();
      *((_QWORD *)Current + 19) = 0LL;
      ExReleasePushLockExclusiveEx((char *)Current + 144, 0LL);
      KeLeaveCriticalRegion();
