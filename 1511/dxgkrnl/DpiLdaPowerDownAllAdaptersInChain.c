/*
 * XREFs of DpiLdaPowerDownAllAdaptersInChain @ 0x1C0174260
 * Callers:
...
__int64 __fastcall DpiLdaPowerDownAllAdaptersInChain(__int64 a1, __int64 a2)
{
  ...
  if ( *(_DWORD *)(v7 + 1520) )
  {
    ...
    while ( 1 )
    {
      v21 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v7 + 1512) + 8 * v17) + 64LL);
      v4 = DpiFdoSetAdapterPowerState(
             *(PDEVICE_OBJECT *)(v21 + 24),
             *(POWER_STATE *)(v21 + 4 * v18 + 1128),
             v20,
             v19,
             v8);
      if ( v4 < 0 )
      ...
      if ( (unsigned int)v17 >= *(_DWORD *)(v7 + 1520) )
        return (unsigned int)v4;
      v8 = v27;
    }
    v4 = -1071774666;
