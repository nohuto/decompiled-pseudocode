/*
 * XREFs of ?GetVidSchCompanionContext@DXGCONTEXT@@QEAAPEAU_VIDSCH_CONTEXT@@XZ @ 0x1C0137030
 * Callers:
...
struct _VIDSCH_CONTEXT *__fastcall DXGCONTEXT::GetVidSchCompanionContext(DXGCONTEXT *this)
{
  ...
  if ( !*((_QWORD *)this + 28) )
  {
    ...
    v3 = *((_QWORD *)this + 2);
    LODWORD(v5) = 64;
    *((_QWORD *)this + 28) = (*(__int64 (__fastcall **)(DXGCONTEXT *, __int64 *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(v3 + 16) + 400LL)
                                                                                            + 8LL)
                                                                                + 216LL))(
                               this,
                               &v5);
