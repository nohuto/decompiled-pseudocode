/*
 * XREFs of ?CalculateMinMaxOverride@Win81@@YAXKUtagSIZE@@PEAJ1QEBUDPI_SCALE_FACTOR_COLLECTION@1@@Z @ 0x1C016887C
 * Callers:
 ...
 * Callees:
 *     ??PWin81@@YA_NAEBUtagSIZE@@0@Z @ 0x1C01687A0 (--PWin81@@YA_NAEBUtagSIZE@@0@Z.c)
 */
...
void __fastcall Win81::CalculateMinMaxOverride(Win81 *this, __int64 a2, struct tagSIZE a3, int *a4)
{
  ...
  *a4 = 0;
  v4 = 0LL;
  while ( dword_1C002F320[v4] != (_DWORD)this )
  {
  ...
  *(_DWORD *)a3.cx = -(int)v4;
  ...
  if ( (unsigned int)v4 < 4 )
  {
    ...
    while ( 1 )
    {
      v7 = dword_1C002F320[v5];
      LODWORD(v12) = v6 / v7;
      HIDWORD(v12) = 100 * v11 / v7;
      v13 = v12;
      if ( Win81::operator>=(&v13, dword_1C002F108) )
        break;
      v5 = v8 - 1;
      if ( v5 <= v10 )
        return;
