/*
 * XREFs of ?Unlock@DXGDEVICE@@QEAAJPEBU_D3DKMT_UNLOCK@@E@Z @ 0x1C006DF2C
 * Callers:
      ...
      if ( v29 )
      {
        if ( !*((_DWORD *)this + 70) )
        {
          ...
          if ( (v23 & 4) != 0 )
          {
            ...
            {
              v24 = (v23 >> 6) & 0xF;
              COREACCESS::COREACCESS((COREACCESS *)v30, *((struct DXGADAPTER *const *)this + 354));
              COREACCESS::AcquireShared((COREACCESS *)v30);
              if ( *((_DWORD *)this + 88) == 1
                && ADAPTER_DISPLAY::IsVidPnSourceOwner(*(DXGADAPTER ***)(*((_QWORD *)this + 354) + 1984LL), this, v24) )
              {
                DisplayedPrimary = DXGDEVICE::GetDisplayedPrimary(this, v24);
