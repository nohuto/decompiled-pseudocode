/*
 * XREFs of ?ProcessHasVidPnSourceOwner@ADAPTER_DISPLAY@@QEBAEPEBVDXGPROCESS@@W4_D3DKMT_VIDPNSOURCEOWNER_TYPE@@W4DXGDEVICECLIENT_TYPE@@@Z @ 0x1C012D6BC
 * Callers:
...
char __fastcall ADAPTER_DISPLAY::ProcessHasVidPnSourceOwner(__int64 a1, __int64 a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v10 )
    {
      if ( a2 == *(_QWORD *)(v10 + 40) && !*(_DWORD *)(v10 + 280) && *(_DWORD *)(v9 + v8 + 680) == 3 )
        break;
    }
    if ( ++v7 >= v6 )
      return 0;
