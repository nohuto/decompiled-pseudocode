/*
 * XREFs of ?DestroyKeyedMutex@DXGGLOBAL@@QEAAXPEAVDXGKEYEDMUTEX@@@Z @ 0x1C005C330
 * Callers:
...
void __fastcall DXGGLOBAL::DestroyKeyedMutex(union _LARGE_INTEGER *this, struct DXGKEYEDMUTEX *a2)
{
