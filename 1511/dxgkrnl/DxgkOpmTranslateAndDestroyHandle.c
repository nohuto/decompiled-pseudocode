/*
 * XREFs of DxgkOpmTranslateAndDestroyHandle @ 0x1C0131378
 * Callers:
...
__int64 __fastcall DxgkOpmTranslateAndDestroyHandle(DXGADAPTER ***this, _QWORD *a2, void **a3)
{
  ...
  if ( v10 )
  {
    if ( v10[31] != KeGetCurrentThread() )
    {
      v11 = WdLogNewEntry5_WdAssertion(v10);
      *(_QWORD *)(v11 + 24) = 9566LL;
      WdLogEvent5_WdAssertion(v11);
    }
    return ADAPTER_DISPLAY::OpmTranslateAndDestroyHandle(this[248], a2, a3);
  }
  else
  {
