/*
 * XREFs of Template_pqqqxx @ 0x1C001C56C
 * Callers:
...
NTSTATUS Template_pqqqxx(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 8LL;
  v14 = 8LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &Dxgk_PowerComponentIdleState, 0LL, 6u, &UserData);
}
