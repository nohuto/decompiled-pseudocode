/*
 * XREFs of DmmGetCurrentIntegerVSyncFromClientVidPnSource @ 0x1C00C4540
 * Callers:
...
LABEL_27:
  ...
  if ( v11 )
  {
    ...
    if ( v39 )
    {
      v16 = *(_QWORD *)(*((_QWORD *)a1 + 248) + 136LL);
      v41 = 1016 * v5;
      Path = DMMVIDPNTOPOLOGY::FindPath((DMMVIDPNTOPOLOGY *)(v39 + 96), v5, *(_DWORD *)(v16 + 1016 * v5 + 956));
      if ( Path && (v19 = *((_QWORD *)Path + 12)) != 0 )
      {
        ...
        if ( !DXGADAPTER::IsCoreResourceSharedOwner(*(DXGADAPTER **)(v25 + 16)) )
        {
          ...
          *(_QWORD *)(v36 + 24) = 4258LL;
          WdLogEvent5_WdAssertion(v36);
        }
        if ( (unsigned int)v5 >= *(_DWORD *)(v25 + 104) )
        {
          v37 = WdLogNewEntry5_WdAssertion(v27);
          *(_QWORD *)(v37 + 24) = 4259LL;
          WdLogEvent5_WdAssertion(v37);
        }
        v28 = *(_DWORD *)(*(_QWORD *)(v25 + 136) + v41 + 960);
        if ( v44 != 1 || v28 != v26 + 1 )
          v28 = v26;
        *a3 = v28;
    ...
    DXGFASTMUTEX::Release(*(DXGFASTMUTEX **)(v43 + 40));
    return v4;
  }
  else
  {
