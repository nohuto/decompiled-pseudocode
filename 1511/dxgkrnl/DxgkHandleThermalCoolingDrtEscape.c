/*
 * XREFs of DxgkHandleThermalCoolingDrtEscape @ 0x1C016FBA0
 * Callers:
...
__int64 __fastcall DxgkHandleThermalCoolingDrtEscape(__int64 a1, __int64 a2)
{
  ...
  {
    *(_DWORD *)(a2 + 16) = 0;
    v5 = *(_QWORD *)(*(_QWORD *)(v2 + 3360) + 48LL) != 0LL;
    *(_DWORD *)(a2 + 16) = v5;
    *(_DWORD *)(a2 + 16) = v5 ^ (v5 ^ (unsigned __int8)(2 * (*(_QWORD *)(*(_QWORD *)(v2 + 3360) + 56LL) != 0LL))) & 2;
  }
  return 0LL;
}
