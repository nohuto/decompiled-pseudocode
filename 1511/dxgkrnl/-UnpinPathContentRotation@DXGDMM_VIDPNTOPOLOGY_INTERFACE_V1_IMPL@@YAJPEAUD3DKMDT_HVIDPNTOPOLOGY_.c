/*
 * XREFs of ?UnpinPathContentRotation@DXGDMM_VIDPNTOPOLOGY_INTERFACE_V1_IMPL@@YAJPEAUD3DKMDT_HVIDPNTOPOLOGY__@@II_N@Z @ 0x1C00E4680
 * Callers:
 *     <none>
 * Callees:
        ...
        char a4)
{
  ...
  if ( v8 )
  {
    ...
    if ( Path )
    {
      ...
      v16 = VIDPN_MGR::FormalizeVidPnChange(*(VIDPN_MGR **)(Container + 48), v15, 10, a4, v24);
      v6 = v16;
      if ( v16 < 0 )
      {
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v17, &EventProfilerExit, v18, 6029);
