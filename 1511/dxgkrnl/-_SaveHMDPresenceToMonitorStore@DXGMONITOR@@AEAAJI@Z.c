/*
 * XREFs of ?_SaveHMDPresenceToMonitorStore@DXGMONITOR@@AEAAJI@Z @ 0x1C0188CB4
 * Callers:
...
__int64 __fastcall DXGMONITOR::_SaveHMDPresenceToMonitorStore(UNICODE_STRING *this, int a2)
{
  __int64 result; // rax
  __int64 v4; // rbx
  __int64 v5; // rcx
