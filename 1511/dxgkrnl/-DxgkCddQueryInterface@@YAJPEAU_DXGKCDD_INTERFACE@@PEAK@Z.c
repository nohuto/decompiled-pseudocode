/*
 * XREFs of ?DxgkCddQueryInterface@@YAJPEAU_DXGKCDD_INTERFACE@@PEAK@Z @ 0x1C00C1110
 * Callers:
...
LABEL_14:
  ...
  PairingAdapters = DxgkpGetPairingAdapters(*((struct DXGADAPTER **)a1 + 1), *((_DWORD *)a1 + 4), 0LL, &v16);
  v10 = PairingAdapters;
  ...
  if ( v11 && !*((_QWORD *)v11 + 248) )
  {
    v13 = WdLogNewEntry5_WdAssertion(v7);
    *(_QWORD *)(v13 + 24) = 3984LL;
  ...
  *((_QWORD *)a1 + 60) = DxgkCddDestroyVirtualFrameBuffer;
  *((_QWORD *)a1 + 61) = DxgkGetVirtualFrameBufferAccessCount;
  *((_QWORD *)a1 + 62) = DxgkIsPrimarySource;
  *a2 = 504;
  if ( v11 )
