/*
 * XREFs of IopDevObjApplyPostCreationSettings @ 0x1C00E5DEC
 * Callers:
 *     IoDevObjCreateDeviceSecure @ 0x1C00E55A0 (IoDevObjCreateDeviceSecure.c)
 * Callees:
 *     SeUtilSecurityInfoFromSecurityDescriptor @ 0x1C00E5EA4 (SeUtilSecurityInfoFromSecurityDescriptor.c)
 */
