/*
 * XREFs of ?UpdatePathSupportInfo@DMMVIDPNTOPOLOGY@@QEAAJIIPEBU_D3DKMDT_VIDPN_PRESENT_PATH_SCALING_SUPPORT@@PEBU_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION_SUPPORT@@PEBU_D3DKMDT_VIDPN_PRESENT_PATH_COPYPROTECTION_SUPPORT@@@Z @ 0x1C0090948
 * Callers:
    ...
    if ( Path )
    {
      ...
      if ( IsSourceAndTargetPinned )
      {
        if ( DMMVIDPNPRESENTPATH::DoSourceTargetResolutionsMatch((DMMVIDPNPRESENTPATH *)v13) )
        {
          ...
          v25 = 1;
          v21 = (const struct _D3DKMDT_VIDPN_PRESENT_PATH_SCALING_SUPPORT *)&v25;
          v15 = (struct _D3DKMDT_VIDPN_PRESENT_PATH_SCALING_SUPPORT *)v13;
          goto LABEL_11;
        }
        v15 = (struct _D3DKMDT_VIDPN_PRESENT_PATH_SCALING_SUPPORT *)v13;
