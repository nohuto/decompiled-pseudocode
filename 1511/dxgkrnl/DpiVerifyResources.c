/*
 * XREFs of DpiVerifyResources @ 0x1C0170400
 * Callers:
 *     DpMapMemory @ 0x1C016A940 (DpMapMemory.c)
 * Callees:
        ...
        _QWORD *a7)
{
  ...
  *a7 = 0LL;
  ...
  if ( a2->QuadPart == 786432 || v15.QuadPart == 655360 || v15.QuadPart == 944 || v15.QuadPart == 960 )
  {
    ...
    {
      v16 = *(__int64 (__fastcall **)(__int64, union _LARGE_INTEGER, _QWORD, BOOL *))(v7 + 592);
      if ( v16 )
      {
        v17 = *a2;
        v18 = *(_QWORD *)(v7 + 568);
...
LABEL_33:
  if ( v11 )
  {
    v25 = (struct _KMUTANT *)(v7 + 1304);
    KeWaitForSingleObject((PVOID)(v7 + 1304), Executive, 0, 0, 0LL);
    v26 = *(__int64 **)(v7 + 1288);
    v27 = v26;
    if ( (__int64 *)*v26 != v26 )
    {
