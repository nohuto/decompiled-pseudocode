/*
 * XREFs of DxgkDestroyCsrssProcess @ 0x1C00C6B88
 * Callers:
...
void __fastcall DxgkDestroyCsrssProcess(__int64 a1)
{
  ...
  v4 = *((_QWORD *)SessionData + 2324);
  if ( v4 != PsGetCurrentProcess() )
  {
  ...
  v6 = (_QWORD *)*((_QWORD *)SessionData + 2320);
  while ( v6 != (_QWORD *)((char *)SessionData + 18560) )
  {
    v9 = (DXGADAPTER **)(v6 - 4);
    v6 = (_QWORD *)*v6;
    ...
    v10 = v9[4];
    v11 = (DXGADAPTER ***)v9[5];
    if ( *((DXGADAPTER ***)v10 + 1) != v9 + 4 || *v11 != v9 + 4 )
      __fastfail(3u);
    *v11 = (DXGADAPTER **)v10;
    *((_QWORD *)v10 + 1) = v11;
    if ( v9 )
