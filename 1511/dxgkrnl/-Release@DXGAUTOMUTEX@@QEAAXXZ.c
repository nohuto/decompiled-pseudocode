/*
 * XREFs of ?Release@DXGAUTOMUTEX@@QEAAXXZ @ 0x1C0006E64
 * Callers:
...
void __fastcall DXGAUTOMUTEX::Release(DXGAUTOMUTEX *this)
{
  ...
  *((_BYTE *)this + 8) = 0;
  v3 = *(_QWORD *)this;
  if ( *(struct _KTHREAD **)v3 != KeGetCurrentThread() )
  {
  ...
  if ( (*(_DWORD *)(v3 + 12))-- == 1 )
  {
    *(_QWORD *)v3 = 0LL;
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v3 + 8), 0xFFFFFFFF) != 1 )
      KeSetEvent((PRKEVENT)(v3 + 24), 0, 0);
  }
  else
  {
    _InterlockedAdd((volatile signed __int32 *)(v3 + 8), 0xFFFFFFFF);
  }
