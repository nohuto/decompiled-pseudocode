/*
 * XREFs of ?ConvertThunkOverlayToPackedAttributes@DXGCONTEXT@@AEAAXPEAU_VIDSCH_LAYER_ATTRIBUTE@@AEBUD3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES@@@Z @ 0x1C0161048
 * Callers:
        ...
        const struct D3DKMT_MULTIPLANE_OVERLAY_ATTRIBUTES *a3)
{
  ...
  *((_DWORD *)a2 + 7) ^= (*((_DWORD *)a2 + 7) ^ (32 * a3->VideoFrameFormat)) & 0x60;
  v9 = *((_DWORD *)a2 + 7) ^ (*((_DWORD *)a2 + 7) ^ ((a3->YCbCrFlags & 1) << 7)) & 0x80u;
  *((_DWORD *)a2 + 7) = v9;
  v10 = v9 ^ ((unsigned __int16)v9 ^ (((a3->YCbCrFlags & 2) != 0) << 8)) & 0x100;
  *((_DWORD *)a2 + 7) = v10;
  *((_DWORD *)a2 + 7) = v10 ^ ((unsigned __int16)v10 ^ (((a3->YCbCrFlags & 4) != 0) << 9)) & 0x200;
  if ( a3->StereoFormat > (unsigned int)DXGKMT_MULTIPLANE_OVERLAY_STEREO_FORMAT_CHECKERBOARD )
  {
    v11 = WdLogNewEntry5_WdAssertion(v9);
    *(_QWORD *)(v11 + 24) = 1255LL;
