/*
 * XREFs of ?FindIndirectOutputDuplMgr@DXGGLOBAL@@QEAAJPEAU_LUID@@0PEAPEAVOUTPUTDUPL_MGR@@@Z @ 0x1C0145BA0
 * Callers:
        ...
        struct OUTPUTDUPL_MGR **a4)
{
  ...
  DXGAUTOMUTEX::DXGAUTOMUTEX((DXGAUTOMUTEX *)v12, (DXGGLOBAL *)((char *)this + 1128));
  DXGAUTOMUTEX::Acquire((DXGAUTOMUTEX *)v12);
  v8 = (_QWORD *)((char *)this + 1192);
