/*
 * XREFs of ?AddSource@DXGPORTDMM_VIDEOPRESENTSOURCESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDEOPRESENTSOURCESET__@@PEBU_D3DKMDT_VIDEO_PRESENT_SOURCE@@@Z @ 0x1C00DC1B0
 * Callers:
 *     <none>
 * Callees:
  ...
  *(_QWORD *)(v6 + 32) = this;
  if ( a2 )
  {
    ...
    if ( v9 )
    {
      ...
      {
        v26 = v10;
        v15 = DMMVIDEOPRESENTSOURCESET::AddSource(v9, &v26);
        v20 = v15;
        if ( v15 >= 0 )
