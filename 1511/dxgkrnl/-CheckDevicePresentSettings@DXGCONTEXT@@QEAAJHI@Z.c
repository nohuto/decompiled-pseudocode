/*
 * XREFs of ?CheckDevicePresentSettings@DXGCONTEXT@@QEAAJHI@Z @ 0x1C01604D4
 * Callers:
...
__int64 __fastcall DXGCONTEXT::CheckDevicePresentSettings(DXGCONTEXT *this, int a2, unsigned int a3)
{
  ...
  if ( DXGDEVICE::IsVSyncAvailable(*((DXGDEVICE **)this + 2), (unsigned int)v4) )
    goto LABEL_10;
...
LABEL_10:
    v19 = *((_QWORD *)this + 2);
    if ( *(_DWORD *)(v19 + 280) == 1 && (*(_DWORD *)(v19 + 4 * v4 + 976) & 0x100) == 0 )
    {
      v17 = (_QWORD *)WdLogNewEntry5_WdEvent(v14, v13, v15, v16);
      v11 = -1071775739LL;
      goto LABEL_7;
