/*
 * XREFs of ?DestroyLocalClient@DXGSWAPCHAIN@@AEAAXPEAUSWAPCHAIN_CLIENT_INFO@1@@Z @ 0x1C0165DDC
 * Callers:
...
void __fastcall DXGSWAPCHAIN::DestroyLocalClient(DXGSWAPCHAIN *this, struct DXGSWAPCHAIN::SWAPCHAIN_CLIENT_INFO *a2)
{
  ...
  {
    v8 = 56LL * i;
    v9 = *((_QWORD *)this + 9) + 16 * (*((int *)a2 + 10) + 2LL);
    v10 = *(void **)(v9 + v8);
    if ( v10 )
    {
      ObCloseHandle(v10, 1);
    ...
    v11 = *(_DWORD *)(*((_QWORD *)this + 9) + 16LL * *((int *)a2 + 10) + v8 + 28);
    if ( v11 )
    {
      if ( Current )
      {
        ...
        if ( v15 )
        {
          ...
          DXGGLOBAL::DestroySyncObject(Global, v15, v11);
        }
      }
      *(_DWORD *)(*((_QWORD *)this + 9) + 16LL * *((int *)a2 + 10) + v8 + 28) = 0;
    }
  }
  *((_QWORD *)a2 + 2) = 0LL;
}
