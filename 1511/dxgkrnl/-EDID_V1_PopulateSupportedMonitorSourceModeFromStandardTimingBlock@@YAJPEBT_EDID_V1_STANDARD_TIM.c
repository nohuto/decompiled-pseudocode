/*
 * XREFs of ?EDID_V1_PopulateSupportedMonitorSourceModeFromStandardTimingBlock@@YAJPEBT_EDID_V1_STANDARD_TIMING@@EW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@EPEAU_VideoModeDescriptor@@@Z @ 0x1C000EF60
 * Callers:
 *     EDIDV1_ObtainSupportedMonitorSourceModes @ 0x1C000EBBC (EDIDV1_ObtainSupportedMonitorSourceModes.c)
 * Callees:
 *     GTF_GetVideoModeDescriptor @ 0x1C000F058 (GTF_GetVideoModeDescriptor.c)
 *     ?CalculateVerticalActivePixelsFrom@@YAJGGGPEAG@Z @ 0x1C000F48C (-CalculateVerticalActivePixelsFrom@@YAJGGGPEAG@Z.c)
 */
