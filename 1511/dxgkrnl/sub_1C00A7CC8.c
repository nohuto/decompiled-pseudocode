/*
 * XREFs of sub_1C00A7CC8 @ 0x1C00A7CC8
 * Callers:
...
__int64 __fastcall sub_1C00A7CC8(_QWORD *a1, __int64 a2, unsigned __int16 a3)
{
  __int64 v3; // r15
  int *v5; // rdi
  __int64 v6; // rbp
  ...
  if ( !DMMVIDPNPRESENTPATH::DoSourceTargetResolutionsMatch(Path) )
  {
    ...
    if ( (unsigned int)(v6 - 2) > 3 && (_DWORD)v6 != 255
      || (v14 = sub_1C00A7E48(v5, a2, (unsigned int)v6, *(unsigned int *)&v28), v14 == -1071774970) )
    {
      if ( (dword_1C004802C & 1) == 0 )
      {
        v25 = *(VIDPN_MGR **)(a2 + 48);
        dword_1C004802C |= 1u;
        dword_1C0047FF0[0] = VIDPN_MGR::GetAdapterDefaultScaling(v25);
        dword_1C0047FF4 = 3;
        dword_1C0047FF8 = 4;
        dword_1C0047FFC = 2;
      }
      ...
      do
      {
        if ( (unsigned int)v26 >= 4 )
          break;
        v9 = dword_1C0047FF0;
        v10 = (unsigned int)dword_1C0047FF0[v26];
        if ( (_DWORD)v10 != (_DWORD)v6 )
          v14 = sub_1C00A7E48(v5, a2, v10, *(unsigned int *)&v28);
...
LABEL_22:
  ...
  {
LABEL_3:
    v14 = sub_1C00A7E48(v5, a2, 1LL, *(unsigned int *)&v28);
    if ( v14 >= 0 )
      return 0LL;
  ...
  result = sub_1C00A7E48(v5, a2, 5LL, *(unsigned int *)&v28);
  if ( (int)result < 0 )
  {
