/*
 * XREFs of ?ForcePStateAcrossNodes@DXGADAPTER@@QEAAXI@Z @ 0x1C012C5AC
 * Callers:
...
void __fastcall DXGADAPTER::ForcePStateAcrossNodes(DXGADAPTER *this, unsigned int a2)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 734); ++i )
    DXGPOWERSTATISTICSTRANSITIONENGINE::ForcePState((KSPIN_LOCK *)(248LL * i + *((_QWORD *)this + 366) + 136LL), a2);
}
