/*
 * XREFs of ?_GetMonitorInformationForTargets@MONITOR_MGR@@QEAAJP6AJPEAX0IW4_DMM_VIDPN_MONITOR_TYPE@@EE@Z0I@Z @ 0x1C0098160
 * Callers:
        ...
        int a4)
{
  ...
  do
  {
    LODWORD(v8) = DmmGetNextVideoPresentTarget(*(_QWORD *)(*((_QWORD *)this + 1) + 16LL), v7, &v24);
    if ( (int)v8 < 0 )
      break;
    v9 = *((_QWORD *)this + 1);
    v10 = 0;
    ...
    v25 = 0LL;
    MonitorInstance = MONITOR_MGR::_GetMonitorInstance((struct _FAST_MUTEX *)this, v24, 0, (ULONG **)&v25);
    ...
    v10 = *((_DWORD *)v8 + 94);
    MonitorInstance = MONITOR_MGR::_GetMonitorInstance((struct _FAST_MUTEX *)this, v24, 1, (ULONG **)&v25);
    LODWORD(v8) = MonitorInstance;
    if ( MonitorInstance < 0 )
    {
LABEL_7:
