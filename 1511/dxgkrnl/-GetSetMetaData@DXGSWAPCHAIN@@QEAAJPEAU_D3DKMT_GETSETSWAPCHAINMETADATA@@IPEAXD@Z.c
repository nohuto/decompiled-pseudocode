/*
 * XREFs of ?GetSetMetaData@DXGSWAPCHAIN@@QEAAJPEAU_D3DKMT_GETSETSWAPCHAINMETADATA@@IPEAXD@Z @ 0x1C0166414
 * Callers:
        ...
        char a5)
{
  ...
  if ( !(_DWORD)v7 || a2->bSetMetaData )
  {
    ...
    if ( bGlobalMetaData )
    {
      v14 = (DXGSWAPCHAIN *)((char *)this + 80);
      v15 = (struct _KTHREAD **)this;
      if ( a2->bSetMetaData )
      {
