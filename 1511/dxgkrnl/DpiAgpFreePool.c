/*
 * XREFs of DpiAgpFreePool @ 0x1C0172FD0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiAgpFreePool(__int64 a1, __int64 a2)
{
  ...
  KeWaitForSingleObject((PVOID)(v5 + 1384), Executive, 0, 0, 0LL);
  v6 = *(unsigned int **)(v5 + 1368);
  v7 = v6;
  v8 = *(unsigned int **)v6;
...
LABEL_11:
  KeReleaseMutex((PRKMUTEX)(v5 + 1384), 0);
  if ( !v3 )
  {
LABEL_12:
    v2 = -1073741811;
