/*
 * XREFs of ?AcquireFirstModeInfo@DXGDMM_VIDPNSOURCEMODESET_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPNSOURCEMODESET__@@PEAPEBU_D3DKMDT_VIDPN_SOURCE_MODE@@@Z @ 0x1C00E9C80
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DKMDT_VIDPN_SOURCE_MODE **a3)
{
  ...
  __int64 v19; // rax
  __int64 v20; // rax
  struct DMMVIDPNSOURCEMODE *(__fastcall *v21)(DMMVIDPNSOURCEMODESET *); // [rsp+20h] [rbp-18h] BYREF
  ...
  if ( a2 )
  {
    *(_QWORD *)a2 = 0LL;
    ...
    if ( v6 )
    {
      v22 = 0;
      v23 = 0LL;
      v21 = DMMVIDPNSOURCEMODESET::GetFirstMode;
