/*
 * XREFs of ?_IsModeInActiveSizeRange@DXGMONITOR@@AEAAJAEBU_D3DKMDT_VIDEO_SIGNAL_INFO@@W4_DMM_MODE_PRUNING_ALGORITHM@@PEAEQEAW4_D3DKMDT_MODE_PRUNING_REASON@@@Z @ 0x1C018B26C
 * Callers:
...
__int64 __fastcall DXGMONITOR::_IsModeInActiveSizeRange(__int64 a1, _DWORD *a2, int a3, char *a4, _DWORD *a5)
{
  ...
  v16 = sub_1C018B0CC(a2, (unsigned int *)v14, a3);
  *a4 = v16;
  if ( !v16 )
    return 0LL;
  if ( *v14 == 4 )
