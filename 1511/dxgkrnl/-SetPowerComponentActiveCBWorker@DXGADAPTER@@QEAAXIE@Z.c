/*
 * XREFs of ?SetPowerComponentActiveCBWorker@DXGADAPTER@@QEAAXIE@Z @ 0x1C001B724
 * Callers:
 *     ?SetPowerComponentActiveCB@DXGADAPTER@@QEAAXIE@Z @ 0x1C001B5FC (-SetPowerComponentActiveCB@DXGADAPTER@@QEAAXIE@Z.c)
 ...
 *     ?RecordActivity@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ @ 0x1C001EDE8 (-RecordActivity@DXGPOWERSTATISTICSTRANSITIONENGINE@@QEAAXXZ.c)
...
void __fastcall DXGADAPTER::SetPowerComponentActiveCBWorker(DXGADAPTER *this, unsigned int a2, __int64 a3)
{
  ...
  if ( v7 )
  {
    ...
    if ( *((_DWORD *)this + 676) )
    {
      KeAcquireInStackQueuedSpinLock((PKSPIN_LOCK)this + 389, &LockHandle);
      *(_BYTE *)(*(_QWORD *)(v6 + 512) + 240LL) = 1;
      if ( !*((_BYTE *)this + 3120) )
      {
        *((_BYTE *)this + 3120) = 1;
        DXGADAPTER::AcquireReference(this);
        KeSetTimer((PKTIMER)((char *)this + 2984), (LARGE_INTEGER)-120000LL, (PKDPC)((char *)this + 3048));
      }
...
LABEL_20:
  ...
  if ( !*(_BYTE *)(v6 + 360) )
  {
    KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)this + 320, &v21);
    v12 = v6 + 440;
    if ( !*(_QWORD *)(v6 + 440) )
    {
    ...
    *(_QWORD *)(v13 + 8) = v14;
    *(_QWORD *)v12 = 0LL;
    if ( *((DXGADAPTER **)this + 314) == (DXGADAPTER *)((char *)this + 2512) )
    {
      KeCancelTimer((PKTIMER)((char *)this + 2576));
      *((_BYTE *)this + 2461) = 0;
    }
    KeReleaseInStackQueuedSpinLockFromDpcLevel(&v21);
...
LABEL_25:
  ...
  if ( v8 )
  {
    ...
    PoFxActivateComponent(*((_QWORD *)this + 254), (unsigned int)v3, v19);
    if ( v9 )
    {
      if ( bTracingEnabled && (Microsoft_Windows_DxgKrnlEnableBits & 0x8000) != 0 )
        Template_pqq(v16, (unsigned int)&Dxgk_ReportPowerComponentState, v17, (_DWORD)this, v3, 0);
      PoFxIdleComponent(*((_QWORD *)this + 254), (unsigned int)v3, 0LL);
    }
  }
  if ( v10 )
  {
