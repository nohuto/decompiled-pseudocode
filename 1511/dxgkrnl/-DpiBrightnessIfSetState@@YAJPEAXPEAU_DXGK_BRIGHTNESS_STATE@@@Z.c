/*
 * XREFs of ?DpiBrightnessIfSetState@@YAJPEAXPEAU_DXGK_BRIGHTNESS_STATE@@@Z @ 0x1C0171060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightnessIfSetState(_QWORD *a1, struct _DXGK_BRIGHTNESS_STATE *a2)
{
  ...
  if ( *(_QWORD *)(v2 + 3256) )
  {
    ...
    if ( v5 >= 0 )
    {
      v5 = (*(__int64 (__fastcall **)(_QWORD, struct _DXGK_BRIGHTNESS_STATE *))(v2 + 3256))(*(_QWORD *)(v2 + 3200), a2);
