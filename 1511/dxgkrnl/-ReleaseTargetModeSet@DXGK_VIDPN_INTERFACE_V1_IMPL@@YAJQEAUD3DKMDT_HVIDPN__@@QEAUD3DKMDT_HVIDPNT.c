/*
 * XREFs of ?ReleaseTargetModeSet@DXGK_VIDPN_INTERFACE_V1_IMPL@@YAJQEAUD3DKMDT_HVIDPN__@@QEAUD3DKMDT_HVIDPNTARGETMODESET__@@@Z @ 0x1C0091690
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a4)
{
  ...
  *(_QWORD *)(v6 + 32) = this;
  ...
  if ( v9 )
  {
    ...
    v12 = (struct DMMVIDPNTARGETMODESET *)v10;
    if ( v10 )
    {
      v13 = *(DMMVIDPNTARGET **)(v10 + 112);
      if ( !v13 )
      {
  ...
  if ( (qword_1C00467F0 & 2) != 0 && (Microsoft_Windows_DxgKrnlEnableBits & 0x4000) != 0 )
    Template_q(v15, &EventProfilerExit, v16, 7049);
  return v7;
}
