/*
 * XREFs of ?GetAdditionalTiming@DXGK_MONITOR_INTERFACE_V2_IMPL@@KAJQEAXIPEAIPEAPEAU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z @ 0x1C0187DB0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  if ( DxgAdapter )
  {
    if ( !DXGADAPTER::IsCoreResourceSharedOwner(DxgAdapter) || (v20 = *((_QWORD *)v14 + 248)) == 0 )
    {
      v11 = WdLogNewEntry5_WdError(v19);
      *(_QWORD *)(v11 + 24) = a1;
      goto LABEL_14;
    }
    v21 = *(struct _FAST_MUTEX **)(v20 + 120);
    if ( !v21 )
    {
      v11 = WdLogNewEntry5_WdError(v19);
      *(_QWORD *)(v11 + 24) = v14;
