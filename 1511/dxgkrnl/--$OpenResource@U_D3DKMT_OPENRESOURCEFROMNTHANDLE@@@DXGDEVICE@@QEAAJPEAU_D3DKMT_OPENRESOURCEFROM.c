/*
 * XREFs of ??$OpenResource@U_D3DKMT_OPENRESOURCEFROMNTHANDLE@@@DXGDEVICE@@QEAAJPEAU_D3DKMT_OPENRESOURCEFROMNTHANDLE@@IPEAU_DXGSHAREDALLOCOBJECT@@IPEAVCOREDEVICEACCESS@@HPEAU_EPROCESS@@PEAIPEA_K@Z @ 0x1C006E3D0
 * Callers:
        ...
        unsigned __int64 *a10)
{
  ...
  _D3DKMT_CREATEALLOCATION v60; // [rsp+70h] [rbp-49h] BYREF
...
LABEL_41:
  ...
  v18 = *(unsigned int *)(*(_QWORD *)(v21 + 120) - 44LL);
  if ( (v18 & 2) != 0 && !(*(unsigned int (**)(void))(*(_QWORD *)(*((_QWORD *)this + 5) + 80LL) + 208LL))() )
  {
  ...
  if ( *(_DWORD *)(v21 + 116) != *(_DWORD *)(a2 + 16) )
  {
    v53 = (_QWORD *)WdLogNewEntry5_WdError(v18);
    v53[3] = this;
    v54 = *(unsigned int *)(v21 + 116);
...
LABEL_47:
  ...
  if ( v22 )
    memmove(*(void **)(a2 + 40), *(const void **)(v21 + 88), v22);
  ...
  if ( (_DWORD)v28 != *(_DWORD *)(v21 + 112) )
  {
    v51 = (_QWORD *)WdLogNewEntry5_WdWarning(v30, v28, v26, v29);
    v51[3] = this;
    v51[4] = *(unsigned int *)(a2 + 48);
    v55 = *(unsigned int *)(v21 + 112);
    goto LABEL_47;
  }
  if ( (_DWORD)v28 )
    memmove(v29, *(const void **)(v21 + 104), v28);
  v31 = 0LL;
  v32 = *(char **)(a2 + 72);
  v33 = *(_QWORD **)(v21 + 120);
  v61 = v32;
