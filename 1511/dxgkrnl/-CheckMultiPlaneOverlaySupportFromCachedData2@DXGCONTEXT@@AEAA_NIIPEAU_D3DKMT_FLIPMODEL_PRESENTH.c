/*
 * XREFs of ?CheckMultiPlaneOverlaySupportFromCachedData2@DXGCONTEXT@@AEAA_NIIPEAU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@@Z @ 0x1C01605D4
 * Callers:
 ...
 *     ?ConvertPackedAttributesToDDI2@@YAXAEBU_VIDSCH_LAYER_ATTRIBUTE@@PEAU_DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES2@@@Z @ 0x1C0160BF0 (-ConvertPackedAttributesToDDI2@@YAXAEBU_VIDSCH_LAYER_ATTRIBUTE@@PEAU_DXGK_MULTIPLANE_OVERLAY_ATT.c)
 *     ?OverlayAttributesEqual2@@YA_NAEBU_DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES2@@0_N@Z @ 0x1C01616D8 (-OverlayAttributesEqual2@@YA_NAEBU_DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES2@@0_N@Z.c)
 */
        ...
        struct _D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN *a4)
{
  ...
  *(_QWORD *)&v42[0].0 = this;
  v7 = *(_QWORD *)(v4 + 16);
  *(_QWORD *)v41 = a4;
  v8 = *(unsigned int *)(*(_QWORD *)(v7 + 16) + 1864LL);
  v9 = 112 * v8;
  v10 = (unsigned int)v8;
...
LABEL_4:
  ...
  (*(void (__fastcall **)(_QWORD, _QWORD, char *, __int64 *, unsigned int *, int *))(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)v6 + 2) + 16LL) + 400LL)
                                                                                               + 8LL)
                                                                                   + 328LL))(
  ...
  v28 = *(const struct _DXGK_MULTIPLANE_OVERLAY_ATTRIBUTES2 **)(v27 + 872);
  v29 = *(_DWORD *)(v27 + 868);
  if ( v28 && *(_DWORD *)(v27 + 864) == v21 )
  {
    v30 = 0;
    if ( !v21 )
    {
