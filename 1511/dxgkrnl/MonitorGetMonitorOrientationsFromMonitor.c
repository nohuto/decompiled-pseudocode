/*
 * XREFs of MonitorGetMonitorOrientationsFromMonitor @ 0x1C0186B94
 * Callers:
...
__int64 __fastcall MonitorGetMonitorOrientationsFromMonitor(struct HDXGMONITOR__ *a1, _DWORD *a2, _DWORD *a3)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    ExAcquireResourceSharedLite((PERESOURCE)((char *)v7 + 240), 1u);
    if ( a2 )
      *a2 = *((_DWORD *)v7 + 99);
    if ( a3 )
      *a3 = *((_DWORD *)v7 + 101);
    ExReleaseResourceLite((PERESOURCE)((char *)v7 + 240));
