/*
 * XREFs of EDIDV1_ObtainSupportedMonitorSourceModes @ 0x1C000EBBC
 * Callers:
 ...
 *     ?FindMonitorSourceMode@@YA_KPEAU_VideoModeDescriptor@@_K0@Z @ 0x1C000EF2C (-FindMonitorSourceMode@@YA_KPEAU_VideoModeDescriptor@@_K0@Z.c)
 *     ?EDID_V1_PopulateSupportedMonitorSourceModeFromStandardTimingBlock@@YAJPEBT_EDID_V1_STANDARD_TIMING@@EW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@EPEAU_VideoModeDescriptor@@@Z @ 0x1C000EF60 (-EDID_V1_PopulateSupportedMonitorSourceModeFromStandardTimingBlock@@YAJPEBT_EDID_V1_STANDARD_TIM.c)
 ...
 *     ?EDID_V1_PopulateSupportedMonitorSourceModeFromDetailedTimingBlock@@YAJPEBU_EDID_V1_DETAILED_TIMING@@W4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@PEAU_VideoModeDescriptor@@@Z @ 0x1C000F5EC (-EDID_V1_PopulateSupportedMonitorSourceModeFromDetailedTimingBlock@@YAJPEBU_EDID_V1_DETAILED_TIM.c)
 *     ?EDID_V1_PopulateSupportedMonitorSourceModesFromEstablishedTimingsBlock@@YAJPEBT_EDID_V1_ESTABLISHED_TIMING@@GG_KW4__WMI_MONITOR_CAPABILITY_ORIGIN_TYPE@@PEAU_VideoModeDescriptor@@@Z @ 0x1C000F944 (-EDID_V1_PopulateSupportedMonitorSourceModesFromEstablishedTimingsBlock@@YAJPEBT_EDID_V1_ESTABLI.c)
        ...
        struct _VideoModeDescriptor *a5)
{
  ...
  if ( (int)result >= 0 )
  {
    ...
    v32[0] = 0;
    v11 = 0;
    result = EDID_V1_CountListedSupportedMonitorSourceModes(v10, &v35, v34, &v33, &v41, v32);
    if ( (int)result >= 0 )
    {
      v12 = v35;
      if ( v35 > 0x11u )
