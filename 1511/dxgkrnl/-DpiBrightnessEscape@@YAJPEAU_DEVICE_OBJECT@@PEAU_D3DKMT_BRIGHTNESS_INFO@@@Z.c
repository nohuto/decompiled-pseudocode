/*
 * XREFs of ?DpiBrightnessEscape@@YAJPEAU_DEVICE_OBJECT@@PEAU_D3DKMT_BRIGHTNESS_INFO@@@Z @ 0x1C0170828
 * Callers:
...
__int64 __fastcall DpiBrightnessEscape(struct _DEVICE_OBJECT *a1, struct _D3DKMT_BRIGHTNESS_INFO *a2, __int64 a3)
{
  ...
  if ( DeviceExtension[1597] != 2 )
    return 3221225659LL;
  Type = a2->Type;
  v7 = 0;
  if ( a2->Type == D3DKMT_BRIGHTNESS_INFO_TOGGLE_LOGGING )
  {
    v8 = *((_BYTE *)DeviceExtension + 2977) == 0;
    *((_BYTE *)DeviceExtension + 2977) = v8;
    LOBYTE(a2->ChildUid) = v8;
    return 0LL;
  }
  if ( Type != D3DKMT_BRIGHTNESS_INFO_BEGIN_MANUAL_MODE && !*((_BYTE *)DeviceExtension + 2976) )
    return 3221226538LL;
  v9 = Type - 1;
  if ( v9 )
  {
    ...
    if ( v10 )
    {
      ...
      if ( v11 )
      {
          ...
          if ( v13 )
          {
            ...
            if ( v14 )
            {
              ...
              if ( v15 )
              {
                ...
                if ( v16 )
                {
                  if ( v16 == 1 )
                  {
                    *((_BYTE *)DeviceExtension + 2976) = 0;
                    if ( (*((int (__fastcall **)(_QWORD, char *))DeviceExtension + 406))(
                           *((_QWORD *)DeviceExtension + 400),
                           &v31) >= 0
                      && (v31 & 1) != 0 )
                    {
                      v30 |= 1u;
                      (*((void (__fastcall **)(_QWORD, int *))DeviceExtension + 407))(
                        *((_QWORD *)DeviceExtension + 400),
                        &v30);
                    }
                    LOBYTE(v17) = *((_BYTE *)DeviceExtension + 2984);
                    sub_1C01714CC(a1, DeviceExtension + 1596, v17);
                ...
                else
                {
                  ...
                  *((_BYTE *)DeviceExtension + 2976) = v30 != 0;
                  sub_1C0171454(a1, DeviceExtension + 1596);
                }
                return v7;
              }
              return (unsigned int)(*((__int64 (__fastcall **)(_QWORD, ULONG *))DeviceExtension + 409))(
                                     *((_QWORD *)DeviceExtension + 400),
                                     &a2->ChildUid);
            }
            else
            {
              if ( (int)a2->ChildUid > 3 )
                return 3221225485LL;
              return (unsigned int)sub_1C0171454(a1, DeviceExtension + 1596);
            }
          }
          else
          {
            return (unsigned int)(*((__int64 (__fastcall **)(_QWORD, ULONG *))DeviceExtension + 407))(
                                   *((_QWORD *)DeviceExtension + 400),
                                   &a2->ChildUid);
          }
        }
        ...
        {
          return (unsigned int)(*((__int64 (__fastcall **)(_QWORD, ULONG *))DeviceExtension + 406))(
                                 *((_QWORD *)DeviceExtension + 400),
                                 &a2->ChildUid);
        }
      }
      else
      {
        ...
        return (unsigned int)sub_1C01714CC(a1, DeviceExtension + 1596, a3);
      }
    }
    else
    {
      return (unsigned int)(*((__int64 (__fastcall **)(_QWORD, ULONG *))DeviceExtension + 405))(
                             *((_QWORD *)DeviceExtension + 400),
                             &a2->ChildUid);
    }
  }
  ...
  {
    return (unsigned int)(*((__int64 (__fastcall **)(_QWORD, __int64, ULONG *, char *))DeviceExtension + 403))(
                           *((_QWORD *)DeviceExtension + 400),
                           256LL,
                           &a2->ChildUid,
                           (char *)&a2->ChildUid + 1);
