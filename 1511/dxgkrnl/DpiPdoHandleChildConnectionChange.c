/*
 * XREFs of DpiPdoHandleChildConnectionChange @ 0x1C00E2F00
 * Callers:
        ...
        char a7)
{
  ...
  v12 = (struct _ERESOURCE *)(v7 + 1976);
  ExAcquireResourceExclusiveLite((PERESOURCE)(v7 + 1976), 1u);
  v16 = *(_QWORD *)(v7 + 1968);
  if ( v16 )
  {
    if ( !*(_DWORD *)v16 )
    ...
    if ( *(_DWORD *)v16 )
    {
      _InterlockedOr((volatile signed __int32 *)(v7 + 2292), 4u);
      *(_BYTE *)(v16 + 48) = a4;
      if ( a4 == 1 )
      {
        LOBYTE(Timeout) = (_BYTE)a6;
        v17 = DpiPdoAddPdo(a1, v16, a3, a5, Timeout, a7);
      }
      else
      {
        v17 = DpiPdoRemovePdo(a1, v16);
      }
      v18 = v17;
    }
    else
