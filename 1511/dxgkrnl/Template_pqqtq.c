/*
 * XREFs of Template_pqqtq @ 0x1C002300C
 * Callers:
...
NTSTATUS Template_pqqtq(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v10 = 4LL;
  v12 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &EventDxgkCbIndicateChildStatus, 0LL, 5u, &UserData);
}
