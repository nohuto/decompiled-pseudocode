/*
 * XREFs of ?SetUnsupportedMonitorModesFlag@CCD_BTL@@QEAAJ_N@Z @ 0x1C01835CC
 * Callers:
 *     DxgkSetGlobalRawmodeFlag @ 0x1C01560D0 (DxgkSetGlobalRawmodeFlag.c)
 * Callees:
 *     DxgkLogCodePointPacket @ 0x1C000A1C4 (DxgkLogCodePointPacket.c)
 */

__int64 __fastcall CCD_BTL::SetUnsupportedMonitorModesFlag(CCD_BTL *this, char a2)
{
  NTSTATUS v4; // eax
  __int64 v5; // rcx
  __int64 v6; // rbx
  ...
  DxgkLogCodePointPacket(0x29u, *((_BYTE *)this + 128) != 0, a2 != 0, 0);
  *((_BYTE *)this + 128) = a2;
