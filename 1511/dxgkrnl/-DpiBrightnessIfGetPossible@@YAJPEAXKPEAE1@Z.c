/*
 * XREFs of ?DpiBrightnessIfGetPossible@@YAJPEAXKPEAE1@Z @ 0x1C0170DE0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DpiBrightnessIfGetPossible(_QWORD *a1, unsigned int a2, unsigned __int8 *a3, unsigned __int8 *a4)
{
  ...
  v4 = a1[8];
  v9 = -1073741661;
  KeWaitForSingleObject((PVOID)(v4 + 2992), Executive, 0, 0, 0LL);
  if ( *(_QWORD *)(v4 + 3224) )
  {
    v9 = DpiAcquireCoreSyncAccessSafe((__int64)a1, 0);
    if ( v9 >= 0 )
    {
      v9 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, unsigned __int8 *, unsigned __int8 *))(v4 + 3224))(
             *(_QWORD *)(v4 + 3200),
             a2,
             a3,
             a4);
  ...
  KeReleaseMutex((PRKMUTEX)(v4 + 2992), 0);
