/*
 * XREFs of ?InvalidateDisplayModeListCacheOnSource@ADAPTER_DISPLAY@@QEAAXI@Z @ 0x1C012CDA4
 * Callers:
...
void __fastcall ADAPTER_DISPLAY::InvalidateDisplayModeListCacheOnSource(PERESOURCE **this, unsigned int a2)
{
  ...
  v10 = 127 * v3;
  BYTE4(this[17][v10 + 122]) = 0;
  LODWORD(this[17][v10 + 124]) = -1;
  HIDWORD(this[17][v10 + 124]) = -1;
}
