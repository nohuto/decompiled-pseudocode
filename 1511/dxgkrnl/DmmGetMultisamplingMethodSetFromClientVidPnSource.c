/*
 * XREFs of DmmGetMultisamplingMethodSetFromClientVidPnSource @ 0x1C017A7E0
 * Callers:
...
LABEL_7:
  ...
  v16 = *(struct VIDPN_MGR **)(v15 + 112);
  if ( v16 )
  {
    EXCLUSIVEACCESS<VIDPN_MGR>::EXCLUSIVEACCESS<VIDPN_MGR>((__int64)&v52, *(_QWORD *)(v15 + 112));
    a8 = 0LL;
          ...
          if ( BestMatch )
          {
            ...
            if ( v34 >= 0 )
            {
              ...
              if ( v22 == (struct D3DKMDT_HVIDPN__ *)-88LL )
                ...
                v37 = v22;
              v38 = VIDPN_MGR::FormalizeVidPnChange(v16, v37, 3, 1, &v53);
              v43 = v38;
              if ( v38 >= 0 )
              {
    ...
    DXGFASTMUTEX::Release(*(DXGFASTMUTEX **)(v52 + 40));
