/*
 * XREFs of ?PinPathContentRotation@VIDPN_MGR@@QEBAJQEAVDMMVIDPNPRESENTPATH@@W4_D3DKMDT_VIDPN_PRESENT_PATH_ROTATION@@_N@Z @ 0x1C0177AA8
 * Callers:
 ...
 *     ?GetContainer@?$ContainedBy@VDMMVIDPNTOPOLOGY@@@@QEBAPEAVDMMVIDPNTOPOLOGY@@XZ @ 0x1C002B820 (-GetContainer@-$ContainedBy@VDMMVIDPNTOPOLOGY@@@@QEBAPEAVDMMVIDPNTOPOLOGY@@XZ.c)
        ...
        enum _D3DKMDT_VIDPN_PRESENT_PATH_ROTATION a3)
{
  ...
  v17 = VIDPN_MGR::FormalizeVidPnChange(this, v16, 9, 1, &v22);
  v10 = v17;
  if ( v17 < 0 )
  {
    if ( v17 == -1071774970 )
