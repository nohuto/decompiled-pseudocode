/*
 * XREFs of sub_1C005D98C @ 0x1C005D98C
 * Callers:
...
__int64 __fastcall sub_1C005D98C(const WCHAR *a1, PCWSTR SourceString, __int64 a3, int a4, __int64 a5)
{
  __int64 v9; // rbx
  int v10; // eax
  __int64 v11; // rcx
  ...
  {
    v10 = sub_1C005F2F8((int)&Path, 983103, (int)a1, SourceString, &v22);
    v9 = v10;
    if ( v10 < 0 )
    {
