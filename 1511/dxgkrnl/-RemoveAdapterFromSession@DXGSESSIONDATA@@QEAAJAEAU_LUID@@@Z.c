/*
 * XREFs of ?RemoveAdapterFromSession@DXGSESSIONDATA@@QEAAJAEAU_LUID@@@Z @ 0x1C009ED90
 * Callers:
...
__int64 __fastcall DXGSESSIONDATA::RemoveAdapterFromSession(DXGSESSIONDATA *this, struct _LUID *a2)
{
  ...
  if ( SessionAdapterFromLuid )
  {
    if ( (*((_DWORD *)SessionAdapterFromLuid + 12))-- == 1 )
    {
      ...
      v9 = (SESSION_ADAPTER **)*((_QWORD *)v6 + 5);
      if ( v8[1] != (SESSION_ADAPTER *)((char *)v6 + 32) || *v9 != (SESSION_ADAPTER *)((char *)v6 + 32) )
        __fastfail(3u);
