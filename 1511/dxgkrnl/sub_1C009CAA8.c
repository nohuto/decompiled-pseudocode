/*
 * XREFs of sub_1C009CAA8 @ 0x1C009CAA8
 * Callers:
...
__int64 __fastcall sub_1C009CAA8(__int64 a1, unsigned int a2, __int64 a3)
{
  _DWORD *v3; // rdi
  ...
  while ( 1 )
  {
    ...
    if ( NextFrequencyRange == 1075708748 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          if ( v31 == 1 && (v29 || (unsigned __int8)sub_1C009D020(a3) && v8 >= 8) )
          {
            v8 = 11;
            v24 = v12;
          }
          if ( (unsigned __int8)sub_1C009D008(a3) )
          {
            ...
            if ( v6 < 0x300 )
              v6 = 768;
            v20 = BmlCompareModeExtents(&qword_1C002F110, &v24);
            v21 = v24;
            if ( v20 == 1 )
              v21 = 0x30000000400LL;
            v24 = v21;
        ...
        v15 = sub_1C009CF24(v25, (unsigned int)v23, a3);
        if ( v15 == 11 )
        {
          v29 = 1;
          v15 = 0;
