/*
 * XREFs of DxgkSetVidPnSourceHwProtection @ 0x1C0132720
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
  ...
  if ( v19 >= 0 )
  {
    ...
    if ( (unsigned int)v28 >= *(_DWORD *)(*(_QWORD *)(v16 + 1984) + 104LL) )
    {
    ...
    {
      *(_BYTE *)(*(_QWORD *)(*(_QWORD *)(v16 + 1984) + 136LL) + 1016 * v28 + 1000) = v11 != 0;
      v36 = *(_QWORD *)(v16 + 1984);
      if ( v11 )
      {
        *(_BYTE *)(v36 + 328) = 1;
      ...
      else
      {
        *(_BYTE *)(v36 + 328) = 0;
        ...
        if ( v39 )
        {
          while ( !*(_BYTE *)(1016LL * v37 + *(_QWORD *)(v38 + 136) + 1000) )
          {
            if ( ++v37 >= v39 )
              goto LABEL_36;
          }
...
LABEL_36:
      if ( !v11 )
      {
        v40 = *(ADAPTER_DISPLAY **)(v16 + 1984);
        if ( *(_BYTE *)(*((_QWORD *)v40 + 17) + 1016 * v28 + 1001) )
        {
