/*
 * XREFs of ?DxgkPowerSettingCallback@@YAJPEBU_GUID@@PEAXK1@Z @ 0x1C012C1B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkPowerSettingCallback(LPCGUID SettingGuid, _DWORD *Value, ULONG ValueLength, KSPIN_LOCK *Context)
{
  __int64 v4; // rax
