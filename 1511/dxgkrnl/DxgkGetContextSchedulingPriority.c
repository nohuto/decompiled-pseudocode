/*
 * XREFs of DxgkGetContextSchedulingPriority @ 0x1C005CA40
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( Current )
  {
    ...
    *(_QWORD *)v3 = *v7;
    ...
    if ( v12 )
    {
      ...
      COREDEVICEACCESS::COREDEVICEACCESS((__int64)(v3 + 8), *(_QWORD *)(v12 + 16), 0, v13, 0);
      v14 = COREDEVICEACCESS::AcquireShared((COREDEVICEACCESS *)(v3 + 8));
      if ( v14 < 0 )
      {
