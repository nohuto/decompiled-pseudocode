/*
 * XREFs of ?GetCurrentContentResolution@@YAJQEAXIPEAPEBUtagRECT@@PEAU1@PEAK@Z @ 0x1C00AD5B4
 * Callers:
        ...
        unsigned int *a5)
{
  ...
  if ( !DXGADAPTER::IsCoreResourceSharedOwner(a1) )
  {
    ...
    *(_QWORD *)(v17 + 24) = 1156LL;
    WdLogEvent5_WdAssertion(v17);
  }
  v10 = *((_QWORD *)a1 + 248);
  v11 = *(_QWORD *)(v10 + 136) + 1016 * v6;
  if ( !v11 )
  {
    v18 = WdLogNewEntry5_WdAssertion(v10);
    *(_QWORD *)(v18 + 24) = 1159LL;
