/*
 * XREFs of Template_qqqqqqqddqq @ 0x1C0020EF4
 * Callers:
...
NTSTATUS __fastcall Template_qqqqqqqddqq(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        char a14)
{
  ...
  char *v16; // [rsp+40h] [rbp-A9h]
  __int64 v17; // [rsp+48h] [rbp-A1h]
  char *v18; // [rsp+50h] [rbp-99h]
  __int64 v19; // [rsp+58h] [rbp-91h]
  char *v20; // [rsp+60h] [rbp-89h]
  __int64 v21; // [rsp+68h] [rbp-81h]
  ...
  int v36; // [rsp+118h] [rbp+2Fh] BYREF
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v33 = 4LL;
  v35 = 4LL;
  return EtwWrite(Microsoft_Windows_DxgKrnlHandle, &Dxgk_Diag_OutputDupl_Get_Pointer_Shape_Data, 0LL, 0xBu, &UserData);
}
