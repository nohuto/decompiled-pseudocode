/*
 * XREFs of DxgkQueryAllocationResidency @ 0x1C00BB470
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DxgkQueryAllocationResidency(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  __int64 v24; // rcx
  __int64 v25; // r8
  struct DXGDEVICE *v26; // [rsp+70h] [rbp+0h] BYREF
  ...
  *(_OWORD *)(((unsigned __int64)&v26 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10) = *v4;
  *(_OWORD *)(((unsigned __int64)&v26 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20) = v4[1];
  DXGDEVICEBYHANDLE::DXGDEVICEBYHANDLE(
    (DXGDEVICEBYHANDLE *)(v3 + 8),
    *(_DWORD *)(((unsigned __int64)&v26 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10),
    Current,
    (struct DXGDEVICE **)((unsigned __int64)&v26 & 0xFFFFFFFFFFFFFFC0uLL));
  v8 = *(DXGDEVICE **)v3;
  if ( !*(_QWORD *)v3 )
  {
    v22 = WdLogNewEntry5_WdError(v7);
    *(_QWORD *)(v22 + 24) = *(unsigned int *)(((unsigned __int64)&v26 & 0xFFFFFFFFFFFFFFC0uLL) + 0x10);
    AllocationResidency = -1073741811;
  ...
  DXGDEVICEACCESSLOCKSHARED::DXGDEVICEACCESSLOCKSHARED(
    (DXGDEVICEACCESSLOCKSHARED *)((unsigned __int64)&v26 & 0xFFFFFFFFFFFFFFC0uLL),
    *(struct DXGDEVICE **)v3);
  COREDEVICEACCESS::COREDEVICEACCESS(v3 + 48, (__int64)v8, 0, v9, 0);
  v10 = COREDEVICEACCESS::AcquireShared((COREDEVICEACCESS *)(v3 + 48));
  v15 = v10;
  if ( v10 >= 0 )
  {
    AllocationResidency = DXGDEVICE::QueryAllocationResidency(
                            v8,
                            (struct _D3DKMT_QUERYALLOCATIONRESIDENCY *)(v3 + 16),
                            v13,
                            v14);
    COREDEVICEACCESS::~COREDEVICEACCESS((COREDEVICEACCESS *)(v3 + 48));
    DXGDEVICEACCESSLOCKSHARED::~DXGDEVICEACCESSLOCKSHARED((DXGDEVICEACCESSLOCKSHARED *)((unsigned __int64)&v26 & 0xFFFFFFFFFFFFFFC0uLL));
    DXGDEVICEBYHANDLE::~DXGDEVICEBYHANDLE((DXGDEVICEBYHANDLE *)(v3 + 8));
LABEL_8:
    v18 = qword_1C00467F0;
    v19 = (qword_1C00467F0 & 2) == 0;
