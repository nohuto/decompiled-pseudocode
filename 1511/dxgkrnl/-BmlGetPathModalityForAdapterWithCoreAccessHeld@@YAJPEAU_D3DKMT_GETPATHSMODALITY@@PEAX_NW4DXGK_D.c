/*
 * XREFs of ?BmlGetPathModalityForAdapterWithCoreAccessHeld@@YAJPEAU_D3DKMT_GETPATHSMODALITY@@PEAX_NW4DXGK_DIAG_CCD_BML_ORIGIN@@IPEAPEAUD3DKMDT_HVIDPN__@@@Z @ 0x1C00A7368
 * Callers:
        ...
        __int64 a6)
{
  ...
  v6 = (unsigned __int16 *)&unk_1C00468A0;
  v11 = 0;
  do
  {
    v12 = v6[1];
    ...
    LOBYTE(v22) = a3;
    v23[0] = 1;
    v14 = sub_1C00A7420(v13, v12, a1, a2, v22, a4, a5, a6, v23);
    v19 = v14;
    if ( v14 != -1071774970 )
      break;
    if ( !v23[0] )
      return (unsigned int)v19;
    DxgkLogCodePointPacket(0x17u, v11++, *v6, -1071774970);
    v6 += 2;
  }
  while ( v11 < 5 );
  if ( (int)v19 >= 0 )
