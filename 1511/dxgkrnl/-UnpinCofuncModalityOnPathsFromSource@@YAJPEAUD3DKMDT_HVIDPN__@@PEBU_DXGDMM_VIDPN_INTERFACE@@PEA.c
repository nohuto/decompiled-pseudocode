/*
 * XREFs of ?UnpinCofuncModalityOnPathsFromSource@@YAJPEAUD3DKMDT_HVIDPN__@@PEBU_DXGDMM_VIDPN_INTERFACE@@PEAUD3DKMDT_HVIDPNTOPOLOGY__@@PEBU_DXGDMM_VIDPNTOPOLOGY_INTERFACE@@I_K@Z @ 0x1C00E79A0
 * Callers:
...
LABEL_46:
  ...
  if ( !v58 )
  {
    ...
    *(_QWORD *)(v42 + 24) = 3129LL;
    WdLogEvent5_WdAssertion(v42);
  }
  if ( !v60 )
  {
    v43 = WdLogNewEntry5_WdAssertion(v13);
    *(_QWORD *)(v43 + 24) = 3130LL;
...
LABEL_33:
  ...
  while ( 1 )
  {
    ...
    if ( a5 == -1 )
    {
      ...
      *(_QWORD *)(v44 + 24) = 3184LL;
      WdLogEvent5_WdAssertion(v44);
    }
    v23 = (*((__int64 (__fastcall **)(struct D3DKMDT_HVIDPNTOPOLOGY__ *, _QWORD))a4 + 14))(a3, (unsigned int)v10);
    v14 = v23;
    if ( v23 < 0 )
    {
LABEL_40:
...
LABEL_45:
    ...
    if ( !v58 )
    {
      ...
      *(_QWORD *)(v45 + 24) = 3229LL;
      WdLogEvent5_WdAssertion(v45);
    }
    if ( !v61 )
    {
      v46 = WdLogNewEntry5_WdAssertion(v26);
      *(_QWORD *)(v46 + 24) = 3230LL;
