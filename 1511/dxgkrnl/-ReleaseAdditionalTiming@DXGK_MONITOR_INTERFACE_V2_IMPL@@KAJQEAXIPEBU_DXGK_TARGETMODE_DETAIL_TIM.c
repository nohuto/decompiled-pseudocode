/*
 * XREFs of ?ReleaseAdditionalTiming@DXGK_MONITOR_INTERFACE_V2_IMPL@@KAJQEAXIPEBU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z @ 0x1C01882D0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?_ReleaseAdditionalTiming@DXGMONITOR@@QEAAJPEBU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z @ 0x1C0189058 (-_ReleaseAdditionalTiming@DXGMONITOR@@QEAAJPEBU_DXGK_TARGETMODE_DETAIL_TIMING@@@Z.c)
 */
...
LABEL_13:
  ...
  if ( DxgAdapter )
  {
    if ( !DXGADAPTER::IsCoreResourceSharedOwner(DxgAdapter) || (v19 = *((_QWORD *)v13 + 248)) == 0 )
    {
      v10 = WdLogNewEntry5_WdError(v18);
      *(_QWORD *)(v10 + 24) = a1;
      goto LABEL_13;
    }
    v20 = *(struct _FAST_MUTEX **)(v19 + 120);
    if ( !v20 )
    {
      v10 = WdLogNewEntry5_WdError(v18);
      *(_QWORD *)(v10 + 24) = v13;
