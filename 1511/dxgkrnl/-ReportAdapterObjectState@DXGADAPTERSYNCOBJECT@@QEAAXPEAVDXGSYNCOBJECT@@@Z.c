/*
 * XREFs of ?ReportAdapterObjectState@DXGADAPTERSYNCOBJECT@@QEAAXPEAVDXGSYNCOBJECT@@@Z @ 0x1C015154C
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( bTracingEnabled )
  {
    ...
    {
      if ( (Microsoft_Windows_DxgKrnlEnableBits & 0x80u) != 0 )
        Template_pp(v5, &EventReportSyncObject, a3, a2, *((unsigned int *)a2 + 24));
    }
  }
}
