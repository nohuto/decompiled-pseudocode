/*
 * XREFs of bDynamicRemoveAllDriverRealizations @ 0x1C005AFC0
 * Callers:
...
__int64 __fastcall bDynamicRemoveAllDriverRealizations(__int64 a1, __int64 a2)
{
  ...
  if ( v3 )
  {
    v7 = *(void (__fastcall **)(__int64))(a1 + 3064);
    if ( v7 )
    {
      if ( (*(_DWORD *)(a1 + 56) & 0x800000) != 0 )
        v11 = *(_QWORD *)(*(_QWORD *)(a1 + 3544) + 1560LL);
      else
        v11 = *(_QWORD *)(a1 + 1560);
      while ( v11 )
      {
      ...
      if ( (*(_DWORD *)(a1 + 56) & 0x800000) != 0 )
        v12 = *(_QWORD *)(*(_QWORD *)(a1 + 3544) + 1552LL);
      else
        v12 = *(_QWORD *)(a1 + 1552);
      while ( v12 )
      {
