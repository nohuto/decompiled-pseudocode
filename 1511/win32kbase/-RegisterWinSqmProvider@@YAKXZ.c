/*
 * XREFs of ?RegisterWinSqmProvider@@YAKXZ @ 0x1C0067808
 * Callers:
...
__int64 RegisterWinSqmProvider(void)
{
  ...
  v1 = _InterlockedCompareExchange64(&qword_1C01071F0, 255LL, 0LL);
  if ( v1 )
  {
    switch ( v1 )
    {
      ...
      case 255LL:
        ...
        while ( v0 < 10 );
        if ( v0 == 10 )
          v4 = _InterlockedCompareExchange64(&qword_1C01071F0, 204LL, 255LL);
  ...
  {
    v2 = EtwRegister(&Microsoft_Windows_SQM_Provider, 0LL, 0LL, (PREGHANDLE)&WPP_MAIN_CB.DeviceQueue.DeviceListHead);
    if ( (unsigned int)IsSessionDisabled(0LL, 0) )
      *(_DWORD *)&WPP_MAIN_CB.DeviceQueue.Type |= 1u;
