/*
 * XREFs of CitDisplayRequestChange @ 0x1C000EC40
 * Callers:
...
void __fastcall CitDisplayRequestChange(unsigned int a1)
{
  ...
  {
    v2 = a1 != 0;
    if ( (a1 != 0) != ((*((_BYTE *)qword_1C0107180 + 432) & 4) != 0) )
    {
      ...
      CIT_USER_ACTIVE_TRACKER::OnDisplayRequiredChange(
        (struct _CIT_IMPACT_CONTEXT *)((char *)qword_1C0107180 + 560),
        v3,
        a1);
      if ( !v2 )
      {
        CitpBitmapUpdateForTimeRange((struct _CIT_IMPACT_CONTEXT *)((char *)v1 + 16), *((_DWORD *)v1 + 133), v3);
        v5 = *((_DWORD *)v1 + 32);
        v6 = -1;
        v7 = -1;
        v8 = v3 - *((_DWORD *)v1 + 133);
