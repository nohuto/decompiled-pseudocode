/*
 * XREFs of Template_xq @ 0x1C00AF7E8
 * Callers:
 *     NtDCompositionBeginFrame @ 0x1C003AE80 (NtDCompositionBeginFrame.c)
 *     EtwUpdateEvent @ 0x1C0072E10 (EtwUpdateEvent.c)
 *     EtwTraceKillTimer @ 0x1C00743F0 (EtwTraceKillTimer.c)
 *     EtwTraceCompositionSurfaceObjectUpdateEvent @ 0x1C0074A40 (EtwTraceCompositionSurfaceObjectUpdateEvent.c)
 *     EtwLogicalSurfCreateEvent @ 0x1C00790A0 (EtwLogicalSurfCreateEvent.c)
 *     EtwLogicalSurfDestroyEvent @ 0x1C00790E0 (EtwLogicalSurfDestroyEvent.c)
 *     EtwTraceDCompBeginFrameEvent @ 0x1C00ABA20 (EtwTraceDCompBeginFrameEvent.c)
 * Callees:
