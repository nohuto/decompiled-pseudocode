/*
 * XREFs of ?ConvertDisplayConfigPathIntoExistingPathModalityAtIdx@@YAJPEAUDISPLAYCONFIG_PATH_INFO@@IIIPEAUDISPLAYCONFIG_MODE_INFO@@IHPEAU_D3DKMT_GETPATHSMODALITY@@PEAH@Z @ 0x1C00B9E2C
 * Callers:
 ...
 *     ?ConvertDCPixelFormatToD3DDI@@YAHW4DISPLAYCONFIG_PIXELFORMAT@@PEAW4_D3DDDIFORMAT@@@Z @ 0x1C00B9DC8 (-ConvertDCPixelFormatToD3DDI@@YAHW4DISPLAYCONFIG_PIXELFORMAT@@PEAW4_D3DDDIFORMAT@@@Z.c)
...
LABEL_61:
  ...
  *((_DWORD *)v16 + 12) = v45 | 0x800;
  ...
  {
LABEL_62:
    *((_DWORD *)v16 + 33) = *((_DWORD *)v18 + 4);
    *((_DWORD *)v16 + 34) = *((_DWORD *)v18 + 5);
    *((_DWORD *)v16 + 35) = *((_DWORD *)v18 + 4);
    *((_DWORD *)v16 + 36) = *((_DWORD *)v18 + 5);
  ...
  {
LABEL_58:
    *((_DWORD *)v16 + 33) = *((_DWORD *)v15 + 4);
    *((_DWORD *)v16 + 34) = *((_DWORD *)v15 + 5);
    *((_DWORD *)v16 + 35) = *((_DWORD *)v15 + 4);
    *((_DWORD *)v16 + 36) = *((_DWORD *)v15 + 5);
