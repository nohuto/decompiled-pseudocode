/*
 * XREFs of Template_pqq @ 0x1C00BFED0
 * Callers:
 *     EtwTraceBeginPointerMessageRetrieve @ 0x1C00AB7C0 (EtwTraceBeginPointerMessageRetrieve.c)
 *     EtwTraceEndPointerMessageRetrieve @ 0x1C00ABCB0 (EtwTraceEndPointerMessageRetrieve.c)
 *     EtwTranslationUpdateOffset @ 0x1C00BFDC0 (EtwTranslationUpdateOffset.c)
 *     EtwTranslationUpdateOffsetDWM @ 0x1C00BFDF0 (EtwTranslationUpdateOffsetDWM.c)
 * Callees:
