/*
 * XREFs of ?GrepGetRegionPtrData@@YAKPEAVREGION@@KPEAU_RGNDATA@@@Z @ 0x1C00BF6CC
 * Callers:
 ...
 * Callees:
 *     ?vDownload@RGNOBJ@@QEAAXPEAX@Z @ 0x1C00287E0 (-vDownload@RGNOBJ@@QEAAXPEAX@Z.c)
 *     ?sizeSave@RGNOBJ@@QEAAKXZ @ 0x1C0028850 (-sizeSave@RGNOBJ@@QEAAKXZ.c)
 */
