/*
 * XREFs of IsDCELogicalSpeedTopLevelHitTestSupported_0 @ 0x1C00024F0
 * Callers:
...
// attributes: thunk
__int64 IsDCELogicalSpeedTopLevelHitTestSupported_0()
{
  return IsDCELogicalSpeedTopLevelHitTestSupported();
}
