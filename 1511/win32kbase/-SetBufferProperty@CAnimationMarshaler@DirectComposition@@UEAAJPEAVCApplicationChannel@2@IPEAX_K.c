/*
 * XREFs of ?SetBufferProperty@CAnimationMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAX_KPEA_N@Z @ 0x1C00187B0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_21:
  ...
  if ( v15 != 1 || (a5 & 0xF) != 0 || (*((_BYTE *)this + 184) & 2) == 0 )
    return (unsigned int)-1073741811;
  v16 = a5 >> 4;
  v17 = 1;
