/*
 * XREFs of ??0CApplicationChannel@DirectComposition@@IEAA@PEAVCConnection@1@_N@Z @ 0x1C001A780
 * Callers:
        ...
        char a3)
{
  ...
  *((_QWORD *)this + 12) = 8LL;
  RtlInitializeGenericTable(
    ...
    DirectComposition::CGenericTable<unsigned int,DirectComposition::CDuplicatedVisualMarshaler,1952727876,1>::AllocateTableEntry,
