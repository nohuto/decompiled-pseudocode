/*
 * XREFs of xxxODI_ColorInit @ 0x1C006C4E0
 * Callers:
...
__int64 __fastcall xxxODI_ColorInit(__int64 a1)
{
  ...
  unsigned int v16[32]; // [rsp+50h] [rbp-B0h] BYREF
  ...
  *((_OWORD *)gpsi + 223) = gargbInitial;
  v2[224] = xmmword_1C00EB900;
  v2[225] = xmmword_1C00EB910;
  v2[226] = xmmword_1C00EB920;
  v2[227] = xmmword_1C00EB930;
  v2[228] = xmmword_1C00EB940;
  v2[229] = xmmword_1C00EB950;
  ...
  *((_DWORD *)v5 + 891) = *((_DWORD *)v5 + 922);
  do
  {
    ...
    v7 = &v16[v4];
    v8 = v18;
    v9 = *(_DWORD *)((char *)gpsi + (_QWORD)&v16[v4] + 3568LL - (_QWORD)v16);
    if ( v6 )
    {
      v10 = &v14;
      v11 = 0;
  ...
  while ( v3 < 0x1F );
  return xxxSetSysColors(a1, v3, v17, v16, 6);
}
