/*
 * XREFs of LogicalToPhysicalDPIPoint @ 0x1C0048930
 * Callers:
...
__int64 __fastcall LogicalToPhysicalDPIPoint(__int64 a1, __int64 a2, unsigned int a3, __int64 *a4)
{
  ...
  if ( (a3 & 0xE0) == 0 )
  {
    v8 = *(_DWORD *)(PsGetCurrentProcessWin32Process(a1) + 776);
    if ( (v8 & 0x6000) != 0 )
    {
      v9 = 32;
      if ( (v8 & 0x2000) != 0 )
  ...
  else
  {
    ...
    if ( (v5 & 0x100) != 0 && !*a4 && *(_DWORD *)(gpDispInfo + 80) > 1u )
    {
      ...
      if ( v32 >= 0 )
      {
        ...
        if ( v33 )
        {
          ...
          if ( v31 == (_DWORD)v34 || v31 <= 0 && (int)v34 <= 0 )
          {
            ...
            {
              v38 = v35 >> 16;
              v39 = qword_1C0102D48 + (unsigned int)(v37 * dword_1C0102D50);
              if ( ((_WORD)v38 == *(_WORD *)(v39 + 18)
                 || (_WORD)v38 == 0xFFFF
                 || !(_WORD)v38 && PsGetCurrentProcessWow64Process(v34, v38, v37))
                && (*(_BYTE *)(v39 + 17) & 1) == 0
                && *(_BYTE *)(v39 + 16) == 12 )
              {
                v36 = *(_QWORD *)v39;
    ...
    else
    {
      ...
      v25 = 1;
      *(_DWORD *)a1 = v15 + v24;
      v26 = *(_DWORD *)(a2 + 4) - HIDWORD(v40);
      if ( v26 < 0 )
      {
        v25 = -1;
        v26 = HIDWORD(v40) - *(_DWORD *)(a2 + 4);
      }
      if ( v20
