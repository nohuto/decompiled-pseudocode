/*
 * XREFs of ?Create@CSharedReadInteractionMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00E01A0
 * Callers:
 *     CreateSharedReadInteractionMarshaler @ 0x1C00E02D0 (CreateSharedReadInteractionMarshaler.c)
 * Callees:
