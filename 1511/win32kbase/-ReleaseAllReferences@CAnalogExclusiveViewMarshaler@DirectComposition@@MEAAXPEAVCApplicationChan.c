/*
 * XREFs of ?ReleaseAllReferences@CAnalogExclusiveViewMarshaler@DirectComposition@@MEAAXPEAVCApplicationChannel@2@@Z @ 0x1C00DA920
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall DirectComposition::CAnalogExclusiveViewMarshaler::ReleaseAllReferences(
