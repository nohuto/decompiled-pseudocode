/*
 * XREFs of ?GetWindowForInputType@CompositionInputObject@@QEBAJW4CompositionInputType@@PEAPEAUHWND__@@@Z @ 0x1C00E0650
 * Callers:
...
LABEL_12:
    ...
    v6 = (*(__int64 (__fastcall **)(__int64, _QWORD *))(*(_QWORD *)v10 + 32LL))(v10, a3);
    goto LABEL_12;
  }
  return (unsigned int)v6;
}
