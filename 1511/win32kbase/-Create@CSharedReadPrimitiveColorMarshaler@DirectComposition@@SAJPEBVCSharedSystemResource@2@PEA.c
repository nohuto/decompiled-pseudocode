/*
 * XREFs of ?Create@CSharedReadPrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00DFA68
 * Callers:
 *     CreateSharedReadPrimitiveColorMarshaler @ 0x1C00DFC00 (CreateSharedReadPrimitiveColorMarshaler.c)
 * Callees:
