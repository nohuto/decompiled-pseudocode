/*
 * XREFs of IsPDEVOBJ_bCreateHalftoneBrushesSupported_0 @ 0x1C0001140
 * Callers:
...
// attributes: thunk
__int64 IsPDEVOBJ_bCreateHalftoneBrushesSupported_0()
{
  return IsPDEVOBJ_bCreateHalftoneBrushesSupported();
}
