/*
 * XREFs of Template_qqhhh @ 0x1C00AE4D8
 * Callers:
...
NTSTATUS __fastcall Template_qqhhh(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6, char a7, char a8)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v15 = 2LL;
  v17 = 2LL;
  return EtwWrite(Microsoft_Windows_Win32kHandle, &PowerDisplayEvent, &W32kControlGuid, 5u, &UserData);
}
