/*
 * XREFs of ?Reassign@CAnimationBinding@DirectComposition@@QEAAXPEAVCBaseAnimation@2@PEAVCApplicationChannel@2@@Z @ 0x1C0004458
 * Callers:
        ...
        struct DirectComposition::CApplicationChannel *a3)
{
  ...
  if ( a2 != v5 )
  {
    ...
    v9 = (**(__int64 (__fastcall ***)(struct DirectComposition::CBaseAnimation *))a2)(a2);
    ++*(_DWORD *)(v9 + 20);
    *((_QWORD *)this + 3) = a2;
