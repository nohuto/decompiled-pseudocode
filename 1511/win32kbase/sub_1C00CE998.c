/*
 * XREFs of sub_1C00CE998 @ 0x1C00CE998
 * Callers:
 ...
 *     RtlStringCchPrintfW @ 0x1C00CFC1C (RtlStringCchPrintfW.c)
 */

NTSTATUS __fastcall sub_1C00CE998(
        __int64 a1,
        void *a2,
        unsigned int a3,
        __int64 a4,
        ...
        _WORD *a7)
{
  ...
  if ( RtlAppendUnicodeStringToString(&DestinationString, (PCUNICODE_STRING)(a1 + 200)) < 0 )
  {
    v19 = 14;
    return WPP_RECORDER_SF_(
             (__int64)WPP_GLOBAL_Control->DeviceExtension,
