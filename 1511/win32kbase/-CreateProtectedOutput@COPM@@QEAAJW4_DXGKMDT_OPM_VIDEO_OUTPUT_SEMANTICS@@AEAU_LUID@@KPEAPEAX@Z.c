/*
 * XREFs of ?CreateProtectedOutput@COPM@@QEAAJW4_DXGKMDT_OPM_VIDEO_OUTPUT_SEMANTICS@@AEAU_LUID@@KPEAPEAX@Z @ 0x1C0082B6C
 * Callers:
        ...
        void **a5)
{
  ...
  v17 = this;
  v5 = qword_1C01045D8;
  CAutoMutex::CAutoMutex((CAutoMutex *)v16, (struct CMutex *)((char *)qword_1C01045D8 + 24));
  v9 = 0;
  v15 = 0LL;
  v10 = 0;
  LODWORD(v17) = 0;
