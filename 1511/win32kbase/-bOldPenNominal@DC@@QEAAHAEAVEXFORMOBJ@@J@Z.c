/*
 * XREFs of ?bOldPenNominal@DC@@QEAAHAEAVEXFORMOBJ@@J@Z @ 0x1C0081290
 * Callers:
...
__int64 __fastcall DC::bOldPenNominal(DC *this, struct EXFORMOBJ *a2, int a3)
{
  ...
  if ( (*(_DWORD *)(*((_QWORD *)this + 10) + 352LL) & 0x20) != 0 )
  {
    ...
    v16 = a3;
    v15 = 0LL;
    if ( (unsigned int)EXFORMOBJ::bXform(a2, (struct _VECTORL *)&v14, (struct _VECTORFX *)&v14, 2uLL) )
    {
      v6 = v14;
      if ( v14 < 0 )
        v6 = -v14;
  ...
  else
  {
    v17 = a3;
    v18 = 0;
    if ( (unsigned int)EXFORMOBJ::bXform(a2, (struct _VECTORL *)&v17, (struct _VECTORFX *)&v17, 1uLL) )
    {
      v4 = v17;
      if ( v17 < 0 )
        v4 = -v17;
