/*
 * XREFs of ?CitpSavedDataPrune@@YAJPEAX@Z @ 0x1C00E59E4
 * Callers:
 ...
 *     ?CitpSaveKeyFromString@@YAXPEAU_CIT_SAVE_KEY@@PEAG@Z @ 0x1C00E4DA4 (-CitpSaveKeyFromString@@YAXPEAU_CIT_SAVE_KEY@@PEAG@Z.c)
 */
...
__int64 __fastcall CitpSavedDataPrune(HANDLE KeyHandle)
{
  ...
  v38 = (__int64)dword_1C010714C << 10;
  v2 = 0;
  KeyHandlea = KeyHandle;
  v3 = 0LL;
  SystemTime.QuadPart = MEMORY[0xFFFFF78000000014];
  ExSystemTimeToLocalTime(&SystemTime, &LocalTime);
  v39 = LocalTime.QuadPart - 10000000LL * (unsigned int)dword_1C0107148;
...
LABEL_21:
        ...
        v5 = 0;
        v24 = 0;
        while ( v14 != (unsigned __int8 *)&v31 && (v2 > dword_1C0107144 || v3 > v38) )
        {
          v25 = *(_QWORD **)v14;
          ...
          if ( v26 < 0 )
          {
            CitpLogFailureWorker((unsigned int)v26, v27, 4847);
            ++v24;
            v5 = v28;
          }
...
LABEL_49:
  ...
  {
    CitpLogFailureWorker(v7, v6, 4712);
  }
