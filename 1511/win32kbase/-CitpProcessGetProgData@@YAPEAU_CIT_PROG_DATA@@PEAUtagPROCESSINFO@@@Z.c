/*
 * XREFs of ?CitpProcessGetProgData@@YAPEAU_CIT_PROG_DATA@@PEAUtagPROCESSINFO@@@Z @ 0x1C00E4420
 * Callers:
...
struct _CIT_PROG_DATA *__fastcall CitpProcessGetProgData(struct tagPROCESSINFO *a1)
{
  ...
  if ( v4 )
  {
    ...
    if ( (unsigned int)v5 < *((_DWORD *)qword_1C0107180 + 90) )
    {
      v6 = *((_QWORD *)qword_1C0107180 + 38) + 176 * v5;
      if ( *(_WORD *)(v6 + 32) == v4 )
      {
