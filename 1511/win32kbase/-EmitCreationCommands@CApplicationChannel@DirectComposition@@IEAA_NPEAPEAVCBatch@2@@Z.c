/*
 * XREFs of ?EmitCreationCommands@CApplicationChannel@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C001C40C
 * Callers:
  ...
  if ( *((_QWORD *)this + 50) )
  {
    do
    {
      ...
      *(_DWORD *)(*((_QWORD *)this + 50) + 16LL) |= 2u;
      ...
      if ( (*(_DWORD *)(v5 + 16) & 4) != 0 )
      {
        v7 = (*(__int64 (__fastcall **)(__int64, __int64))(*(_QWORD *)v5 + 112LL))(v5, 90LL);
        v8 = (char *)this + 416;
        if ( !v7 )
          v8 = (char *)this + 408;
