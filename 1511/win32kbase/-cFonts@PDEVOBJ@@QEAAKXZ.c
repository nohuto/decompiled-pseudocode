/*
 * XREFs of ?cFonts@PDEVOBJ@@QEAAKXZ @ 0x1C0038360
 * Callers:
...
__int64 __fastcall PDEVOBJ::cFonts(PDEVOBJ *this)
{
  ...
  v1 = *(_QWORD *)this;
  if ( *(_DWORD *)(*(_QWORD *)this + 2128LL) == -1 )
  {
    v4 = *(__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD, char *))(v1 + 2928);
    if ( v4 )
      *(_DWORD *)(*(_QWORD *)this + 2128LL) = v4(*(_QWORD *)(v1 + 1824), 0LL, 0LL, &v5);
    else
      *(_DWORD *)(v1 + 2128) = 0;
  }
  return *(unsigned int *)(*(_QWORD *)this + 2128LL);
}
