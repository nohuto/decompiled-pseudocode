/*
 * XREFs of ?DwmInputThread@CInputManager@@IEAAJPEAX0P6AHPEAUtagDITCALLBACKSTRUCT@@@ZH@Z @ 0x1C004FE44
 * Callers:
 *     NtCompositionInputThread @ 0x1C004FD40 (NtCompositionInputThread.c)
 * Callees:
 *     UserActivateDwmInputProcessing_0 @ 0x1C0002F30 (UserActivateDwmInputProcessing_0.c)
 *     UserProcessDwmInput_0 @ 0x1C0002F38 (UserProcessDwmInput_0.c)
        ...
        int a5)
{
  ...
  __int64 v20; // rdx
  __int64 v21; // rcx
  HANDLE v23; // [rsp+30h] [rbp-28h] BYREF
  ...
  if ( v8 >= 0 )
  {
    v8 = rimConvertUserToKernelEventHandle(a3, &v23);
    if ( v8 >= 0 )
    {
