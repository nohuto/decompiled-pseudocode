/*
 * XREFs of ?OpenSharedHandle@CSharedWritePrimitiveColorMarshaler@DirectComposition@@UEAAJPEAPEAX@Z @ 0x1C00DFBB0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
int __fastcall DirectComposition::CSharedWritePrimitiveColorMarshaler::OpenSharedHandle(
