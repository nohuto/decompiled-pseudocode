/*
 * XREFs of ?SetReferenceProperty@CAnalogTextureTargetMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAVCResourceMarshaler@2@PEA_N@Z @ 0x1C00DAB50
 * Callers:
 *     <none>
 * Callees:
