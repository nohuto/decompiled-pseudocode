/*
 * XREFs of ?vLockNoDrawing@DEVLOCKOBJ@@QEAAXAEAVXDCOBJ@@@Z @ 0x1C002B8A0
 * Callers:
  ...
  if ( (*(_DWORD *)(v4 + 56) & 1) != 0 )
  {
    *((_QWORD *)this + 1) = ghsemDynamicModeChange;
    ...
    if ( gbLockEtw && (Microsoft_Windows_Win32kEnableBits & 0x10) != 0 )
      Template_pz(this, &LockAcquireShared, v4, v5, L"ghsemDynamicModeChange");
    *((_DWORD *)this + 6) |= 8u;
