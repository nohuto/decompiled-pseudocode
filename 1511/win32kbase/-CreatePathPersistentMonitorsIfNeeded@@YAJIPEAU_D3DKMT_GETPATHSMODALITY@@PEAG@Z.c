/*
 * XREFs of ?CreatePathPersistentMonitorsIfNeeded@@YAJIPEAU_D3DKMT_GETPATHSMODALITY@@PEAG@Z @ 0x1C007BEC8
 * Callers:
        ...
        unsigned __int16 *a3)
{
  ...
  for ( i = 0; i < *((unsigned __int16 *)a2 + 10); ++i )
  {
    ...
    if ( (*(_DWORD *)((_BYTE *)a2 + v7 + 48) & 0x11000000) != 0x1000000 )
    {
      if ( (v8 & 0x2000000) != 0 )
      {
        v11 = ((__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, __int64))qword_1C0104150)(
