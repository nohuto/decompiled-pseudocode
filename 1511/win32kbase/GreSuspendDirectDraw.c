/*
 * XREFs of GreSuspendDirectDraw @ 0x1C0078370
 * Callers:
...
void __fastcall GreSuspendDirectDraw(__int64 a1, int a2)
{
  ...
  __int64 v11; // rdx
  __int64 v12; // r8
  struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C j; // rcx
  struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C v14; // rax
  ...
  int v24; // ecx
  struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C v25; // rax
  struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C v26; // rbx
  __int64 v27; // [rsp+20h] [rbp-28h] BYREF
  struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C v28; // [rsp+28h] [rbp-20h] BYREF
  struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C v29; // [rsp+30h] [rbp-18h] BYREF
    ...
    if ( (v8 & 1) != 0 )
    {
      if ( (v8 & 0x20000) != 0 )
      {
        for ( i = 0LL; ; i = v26 )
        {
          ...
          if ( !*(_QWORD *)&v25 )
            break;
          v24 = *(_DWORD *)(*(_QWORD *)&v25 + 56LL) & 0x20001;
          v28 = v25;
          if ( v24 == 1
            && (unsigned int)PDEVOBJ::bLddmDriver((PDEVOBJ *)&v28)
            && *(_QWORD *)(*(_QWORD *)&v26 + 40LL) == a1 )
          {
  ...
  if ( (v31 & 1) != 0 && !gProtocolType )
  {
    ...
    for ( j = 0LL; ; j = (struct _KDEVICE_QUEUE::$9FAF936D47973D5FBAA72DAF24011AE0::$18E3EACC1E717291AA7C720ECCD5C45C)v16 )
    {
      v14 = hdevEnumerate(j, v11, v12);
      v16 = (__int64)v14;
      if ( !*(_QWORD *)&v14 )
        break;
      v17 = *(_DWORD *)(*(_QWORD *)&v14 + 56LL) & 0x20401;
      v29 = v14;
      if ( v17 == 1 && (unsigned int)PDEVOBJ::bLddmDriver((PDEVOBJ *)&v29) )
      {
        GreLockVisRgn(v16, v11, v12);
        GreLockDisplayDevice(v16);
        v18 = ((__int64 (__fastcall *)(_QWORD, _QWORD, char *))qword_1C01042C0)(
