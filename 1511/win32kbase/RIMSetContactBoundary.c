/*
 * XREFs of RIMSetContactBoundary @ 0x1C00CF618
 * Callers:
 ...
 * Callees:
 *     IsApplyMagInputTransformSupported_0 @ 0x1C0002ED8 (IsApplyMagInputTransformSupported_0.c)
 *     ApplyMagInputTransform_0 @ 0x1C0002EE0 (ApplyMagInputTransform_0.c)
