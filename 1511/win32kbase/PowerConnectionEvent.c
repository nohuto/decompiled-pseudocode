/*
 * XREFs of PowerConnectionEvent @ 0x1C0068D58
 * Callers:
...
NTSTATUS __fastcall PowerConnectionEvent(int a1)
{
  ...
  InputBuffer = a1;
  v1 = gbConnected != 0;
  if ( dword_1C01047F4 != v1 )
  {
    dword_1C01047F4 = gbConnected != 0;
    UpdateLastInput((MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24, 0xDu);
