/*
 * XREFs of ?_AddWin32TriageDataToDump@@YAJPEAUtagWIN32_TRIAGE_DATA@@@Z @ 0x1C00B2908
 * Callers:
...
__int64 __fastcall _AddWin32TriageDataToDump(struct tagWIN32_TRIAGE_DATA *a1)
{
  ...
  for ( i = *(_QWORD *)(*(_QWORD *)a1 + 296LL); i; i = *(_QWORD *)(i + 584) )
  ...
  if ( v3 )
  {
    ...
    _AddMemoryBlockToLiveTriageDump(a1, *(void **)(*(_QWORD *)(*(_QWORD *)a1 + 296LL) + 416LL));
  }
