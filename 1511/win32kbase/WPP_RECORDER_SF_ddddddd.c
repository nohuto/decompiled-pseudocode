/*
 * XREFs of WPP_RECORDER_SF_ddddddd @ 0x1C00D4D80
 * Callers:
...
__int64 WPP_RECORDER_SF_ddddddd(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 8) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 3u )
    ((void (__fastcall *)(struct _DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))pfnWppTraceMessage)(
      ...
      43LL,
      &WPP_746cccc7ccbdb71cc07ee6fb0ef29515_Traceguids,
      11LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 11;
  return WppAutoLogTrace(a1, 3LL, 4LL, &WPP_746cccc7ccbdb71cc07ee6fb0ef29515_Traceguids, v7, (__int64 *)va);
}
