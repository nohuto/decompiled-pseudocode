/*
 * XREFs of WmsgpPostMessage @ 0x1C0128404
 * Callers:
 *     PostWinlogonMessage @ 0x1C0080870 (PostWinlogonMessage.c)
 * Callees:
 *     ClientI_WMsgkSendMessage @ 0x1C00808D0 (ClientI_WMsgkSendMessage.c)
 *     WMsg_midl_user_allocate @ 0x1C0080910 (WMsg_midl_user_allocate.c)
 *     WMsg_midl_user_free @ 0x1C00D5060 (WMsg_midl_user_free.c)
 */
