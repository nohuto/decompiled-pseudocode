/*
 * XREFs of ?EmitSwapChain@CAnalogExclusiveViewMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00DA850
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CAnalogExclusiveViewMarshaler::EmitSwapChain(
