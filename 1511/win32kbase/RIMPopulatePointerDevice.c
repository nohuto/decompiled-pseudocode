/*
 * XREFs of RIMPopulatePointerDevice @ 0x1C00C3E6C
 * Callers:
...
__int64 __fastcall RIMPopulatePointerDevice(__int64 a1, __int64 a2, struct _HIDP_PREPARSED_DATA *a3, __int16 *a4)
{
  ...
  if ( !v13 )
    return 0LL;
  v38 = rimHidP_GetSpecificValueCaps(HidP_Input, 0, *(_WORD *)(a2 + 732), 0, v13, &v46, v5);
  v14 = v38;
  if ( v38 >= 0 )
  {
    v15 = 0;
    ...
    if ( v46 )
    {
      do
      {
        ...
        {
          v19 = 60LL * v16;
          *(_WORD *)(v19 + a2 + 336) = v13[v15].UsagePage;
          *(_WORD *)(v19 + a2 + 348) = v13[v15].Range.UsageMin;
          *(_DWORD *)(v19 + a2 + 340) = v13[v15].ReportID;
          *(_WORD *)(v19 + a2 + 346) = v13[v15].LinkUsagePage;
          *(_DWORD *)(v19 + a2 + 352) = v13[v15].HasNull;
          *(_DWORD *)(v19 + a2 + 368) = v13[v15].LogicalMin;
          *(_DWORD *)(v19 + a2 + 372) = v13[v15].LogicalMax;
          *(_DWORD *)(v19 + a2 + 376) = v13[v15].PhysicalMin;
          *(_DWORD *)(v19 + a2 + 380) = v13[v15].PhysicalMax;
          *(_WORD *)(v19 + a2 + 392) = v13[v15].BitSize;
          if ( (*(_DWORD *)(a2 + 252) & 0x10000) != 0 )
          {
            if ( v13[v15].Range.UsageMin == 48 && v13[v15].UsagePage == 1 )
            {
              ...
              v41[2] = v23;
              v41[3] = v20;
              *(_DWORD *)(a2 + 164) = RIMComputeSpecificHighMetricValue(
            ...
            if ( v13[v15].Range.UsageMin == 49 && v13[v15].UsagePage == 1 )
            {
              ...
              v39[2] = v27;
              v39[3] = v24;
              *(_DWORD *)(a2 + 168) = RIMComputeSpecificHighMetricValue(
    ...
    v33 = (*(_DWORD *)(a2 + 252) & 0x10000) == 0;
    *(_DWORD *)(a2 + 728) = v16;
    if ( !v33 )
      v14 = RIMIDEValidateDeviceSize(a2, v6, v36);
    if ( v14 >= 0 && (int)RIMGetDeviceButtons(a1, a2, (__int64)v5, v48, v34) >= 0 )
      v7 = 1;
  }
  Win32FreePool();
  return v7;
