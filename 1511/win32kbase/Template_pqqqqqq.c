/*
 * XREFs of Template_pqqqqqq @ 0x1C00BFF50
 * Callers:
 *     EtwDevLockEndUpdate @ 0x1C0071150 (EtwDevLockEndUpdate.c)
 *     EtwDevLockEndTightUpdate @ 0x1C0076490 (EtwDevLockEndTightUpdate.c)
 * Callees:
