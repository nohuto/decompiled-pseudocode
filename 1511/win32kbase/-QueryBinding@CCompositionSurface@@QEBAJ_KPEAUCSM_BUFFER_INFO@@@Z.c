/*
 * XREFs of ?QueryBinding@CCompositionSurface@@QEBAJ_KPEAUCSM_BUFFER_INFO@@@Z @ 0x1C003A6C0
 * Callers:
...
__int64 __fastcall CCompositionSurface::QueryBinding(CCompositionSurface *this, __int64 a2, struct CSM_BUFFER_INFO *a3)
{
  ...
  *((_QWORD *)a3 + 1) = 0LL;
  ...
  if ( (int)result >= 0 )
    return (*(__int64 (__fastcall **)(struct CCompositionBuffer *, __int64))(*(_QWORD *)v5 + 32LL))(v5, v4);
  return result;
}
