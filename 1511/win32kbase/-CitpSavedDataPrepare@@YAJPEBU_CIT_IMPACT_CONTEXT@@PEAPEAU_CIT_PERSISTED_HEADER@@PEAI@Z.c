/*
 * XREFs of ?CitpSavedDataPrepare@@YAJPEBU_CIT_IMPACT_CONTEXT@@PEAPEAU_CIT_PERSISTED_HEADER@@PEAI@Z @ 0x1C00E5424
 * Callers:
 ...
 *     ?AdvanceToNext@?$CIT_PERSISTED_SECTION@UCIT_PERSISTED_USE_DATA@@@@QEAAXXZ @ 0x1C00E3AE4 (-AdvanceToNext@-$CIT_PERSISTED_SECTION@UCIT_PERSISTED_USE_DATA@@@@QEAAXXZ.c)
...
LABEL_14:
  ...
  v18[1] = LocalTime;
  v18[10].LowPart = 88;
  v18[7].QuadPart = qword_1C0107198;
  v18[6] = *(union _LARGE_INTEGER *)((char *)v4 + 600);
  v20 = -1;
  if ( qword_1C0107130 / 0x989680uLL <= 0xFFFFFFFF )
    v20 = qword_1C0107130 / 0x989680uLL;
  v18[8].LowPart = v20;
  if ( qword_1C0107138 / 0x989680uLL <= 0xFFFFFFFF )
    v19 = qword_1C0107138 / 0x989680uLL;
  v21 = v76;
  v18[8].HighPart = v19;
  v18[9].LowPart = uMultiplier;
  v18[9].HighPart = dword_1C010711C;
  v18[4].LowPart = 24;
  v18[4].HighPart = 88;
    ...
    do
    {
      ...
      if ( *(_BYTE *)(v31 + 34) || *(_BYTE *)(v31 + 35) )
      {
        ...
        *QuadPart = v30;
        ...
        v41[3] = 24;
        CIT_PERSISTED_SECTION<CIT_PERSISTED_USE_DATA>::AdvanceToNext((__int64)v50);
        CitpBaseDataOutput<CIT_PERSISTED_USE_DATA,_CIT_USE_DATA>((__int64)&v54, v42, v31 + 88, (__int64)v42);
        v23 = dword_1C010711C;
        v27 = v45;
