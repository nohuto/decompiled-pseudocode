/*
 * XREFs of UserProcessThawCallout @ 0x1C000EA64
 * Callers:
 ...
 *     IsResumeThreadQueueSupported_0 @ 0x1C0002028 (IsResumeThreadQueueSupported_0.c)
 *     ResumeThreadQueue_0 @ 0x1C0002030 (ResumeThreadQueue_0.c)
...
__int64 __fastcall UserProcessThawCallout(__int64 a1)
{
  ...
  if ( ProcessWin32Process )
  {
    ...
    *(_DWORD *)(ProcessWin32Process + 776) &= ~0x400u;
