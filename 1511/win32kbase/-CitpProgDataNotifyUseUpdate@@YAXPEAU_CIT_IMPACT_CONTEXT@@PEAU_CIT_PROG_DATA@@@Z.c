/*
 * XREFs of ?CitpProgDataNotifyUseUpdate@@YAXPEAU_CIT_IMPACT_CONTEXT@@PEAU_CIT_PROG_DATA@@@Z @ 0x1C00E48F0
 * Callers:
...
void __fastcall CitpProgDataNotifyUseUpdate(struct _CIT_IMPACT_CONTEXT *a1, struct _CIT_PROG_DATA *a2)
{
  ...
  struct _CIT_IMPACT_CONTEXT **v7; // r10
  __int64 v8; // rax
  __int64 *v9; // r11
  __int64 *v10; // rdx
  __int64 **v11; // rcx
  struct _CIT_IMPACT_CONTEXT *v12; // rcx
  __int64 v13; // rcx
  ...
  if ( *((_BYTE *)a2 + 34) )
  {
    ...
    *v6 = (struct _CIT_IMPACT_CONTEXT *)v5;
    v7 = (struct _CIT_IMPACT_CONTEXT **)((char *)a1 + 328);
    *(_QWORD *)(v5 + 8) = v6;
    v8 = *((_QWORD *)a1 + 41);
    *(_QWORD *)v4 = v8;
    *((_QWORD *)v4 + 1) = (char *)a1 + 328;
    ...
    *v7 = v4;
                 ...
                 - *((unsigned int *)v9 + 29)) >= 0 )
    {
      ...
      *v9 = (__int64)*v7;
      v9[1] = (__int64)v7;
      if ( *((struct _CIT_IMPACT_CONTEXT ***)v12 + 1) != v7 )
        __fastfail(3u);
      *((_QWORD *)v12 + 1) = v9;
      *v7 = (struct _CIT_IMPACT_CONTEXT *)v9;
      *((_WORD *)v9 + 9) = 1;
      v13 = *(_QWORD *)v4;
