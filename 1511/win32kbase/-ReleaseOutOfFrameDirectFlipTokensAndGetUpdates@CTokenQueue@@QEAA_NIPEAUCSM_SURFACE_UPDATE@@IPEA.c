/*
 * XREFs of ?ReleaseOutOfFrameDirectFlipTokensAndGetUpdates@CTokenQueue@@QEAA_NIPEAUCSM_SURFACE_UPDATE@@IPEAIPEA_NPEAPEAVCToken@@@Z @ 0x1C00E2CD0
 * Callers:
      ...
      *(_QWORD *)(v22 + 8) = v30;
      if ( v20 != v30 )
      {
        ...
        do
        {
          ...
          {
            *((_DWORD *)a3 + 63) = (*(__int64 (__fastcall **)(const struct CToken *))(*(_QWORD *)v24 + 120LL))(v24);
            v21 = 1;
