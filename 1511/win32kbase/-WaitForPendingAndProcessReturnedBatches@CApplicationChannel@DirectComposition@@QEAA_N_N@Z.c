/*
 * XREFs of ?WaitForPendingAndProcessReturnedBatches@CApplicationChannel@DirectComposition@@QEAA_N_N@Z @ 0x1C00D74CC
 * Callers:
        ...
        char a2)
{
  ...
  do
  {
    if ( *((int *)this + 43) <= 0 )
      break;
    if ( v5 && KeWaitForSingleObject(**((PVOID **)this + 20), UserRequest, 0, 1u, 0LL) )
      v7 = 0;
