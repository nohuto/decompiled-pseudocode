/*
 * XREFs of Template_hh @ 0x1C00ADACC
 * Callers:
 *     EtwTraceBeginPointerMessageGeneration @ 0x1C00AB790 (EtwTraceBeginPointerMessageGeneration.c)
 *     EtwTraceEndPointerMessageGeneration @ 0x1C00ABC80 (EtwTraceEndPointerMessageGeneration.c)
 * Callees:
