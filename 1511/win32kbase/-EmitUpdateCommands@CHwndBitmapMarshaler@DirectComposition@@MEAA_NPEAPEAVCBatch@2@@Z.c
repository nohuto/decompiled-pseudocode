/*
 * XREFs of ?EmitUpdateCommands@CHwndBitmapMarshaler@DirectComposition@@MEAA_NPEAPEAVCBatch@2@@Z @ 0x1C00DB630
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall DirectComposition::CHwndBitmapMarshaler::EmitUpdateCommands(
