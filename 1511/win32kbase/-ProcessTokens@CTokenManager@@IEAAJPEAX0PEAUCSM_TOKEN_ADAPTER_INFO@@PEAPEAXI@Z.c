/*
 * XREFs of ?ProcessTokens@CTokenManager@@IEAAJPEAX0PEAUCSM_TOKEN_ADAPTER_INFO@@PEAPEAXI@Z @ 0x1C003D07C
 * Callers:
        ...
        unsigned int a6)
{
  ...
  if ( !_InterlockedCompareExchange64((volatile signed __int64 *)v6 + 5, (signed __int64)KeGetCurrentThread(), 0LL) )
  {
