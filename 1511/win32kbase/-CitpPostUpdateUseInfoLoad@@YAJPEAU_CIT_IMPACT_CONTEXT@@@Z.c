/*
 * XREFs of ?CitpPostUpdateUseInfoLoad@@YAJPEAU_CIT_IMPACT_CONTEXT@@@Z @ 0x1C0065E04
 * Callers:
...
__int64 __fastcall CitpPostUpdateUseInfoLoad(struct _CIT_IMPACT_CONTEXT *a1)
{
  ...
  v1 = (_OWORD *)((char *)a1 + 632);
  KeyHandle = 0LL;
  v35 = 0;
  memset((char *)a1 + 632, 0, 0x50uLL);
  *((_DWORD *)a1 + 199) = 0;
    ...
    if ( (int)result >= 0 )
    {
             ...
             &ResultLength) >= 0 )
      {
        if ( v40 == 80 )
        {
          ...
          {
            v5 = *(_OWORD *)&v41[8];
            *(_OWORD *)((char *)a1 + 712) = *(_OWORD *)v41;
            v6 = *(_OWORD *)&v41[16];
            *(_OWORD *)((char *)a1 + 728) = v5;
            v7 = *(_OWORD *)&v41[24];
            *(_OWORD *)((char *)a1 + 744) = v6;
            v8 = *(_OWORD *)&v41[32];
            *(_OWORD *)((char *)a1 + 760) = v7;
            *(_OWORD *)((char *)a1 + 776) = v8;
            goto LABEL_8;
          }
          goto LABEL_25;
        }
...
LABEL_25:
      ...
      *(_OWORD *)((char *)a1 + 712) = *(_OWORD *)v41;
      v30 = *(_OWORD *)&v41[16];
      *(_OWORD *)((char *)a1 + 728) = v29;
      v31 = *(_OWORD *)&v41[24];
      *(_OWORD *)((char *)a1 + 744) = v30;
      v32 = *(_OWORD *)&v41[32];
      *(_OWORD *)((char *)a1 + 760) = v31;
      *(_OWORD *)((char *)a1 + 776) = v32;
...
LABEL_22:
        ...
        CIT_USER_ACTIVE_TRACKER::CalculateUpToTime((struct _CIT_IMPACT_CONTEXT *)((char *)a1 + 536), v20);
        v21 = *((_QWORD *)a1 + 69);
        v22 = (unsigned int)dword_1C0107154;
