/*
 * XREFs of ?ReleaseAllBuffers@CCompositionSurface@@IEAA_NXZ @ 0x1C003A134
 * Callers:
 *     ?Delete@CCompositionSurface@@MEAAJPEAU_WIN32_DELETEMETHOD_PARAMETERS@@@Z @ 0x1C003A3A0 (-Delete@CCompositionSurface@@MEAAJPEAU_WIN32_DELETEMETHOD_PARAMETERS@@@Z.c)
  ...
  if ( *((_DWORD *)this + 20) )
  {
    ...
    *(_QWORD *)(v5 + 8) = v3;
    if ( v4 != (__int64 *)v3 )
    {
      ...
      {
        if ( v4 != (__int64 *)24 )
          (*(void (__fastcall **)(__int64 *, __int64))*(v4 - 3))(v4 - 3, 1LL);
        v4 = *v3;
        v6 = **v3;
