/*
 * XREFs of ?PruneModesByDisplayDeviceCaps@@YAKPEAUtagGRAPHICS_DEVICE@@KPEAUtagDEVMODEMARK@@@Z @ 0x1C0060B6C
 * Callers:
  ...
  *((_DWORD *)a1 + 40) = v3 & 0xF7FFFFFF;
  ...
  if ( v9 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        if ( (int)((__int64 (__fastcall *)(__int64, _QWORD, PVOID *, struct _DEVICE_OBJECT **))qword_1C01042C8)(
                    v16 + 8 + 4 * v17,
