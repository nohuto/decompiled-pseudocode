/*
 * XREFs of ?EmitBeginTime@CAnimationMarshaler@DirectComposition@@IEAA_NPEAPEAVCBatch@2@@Z @ 0x1C0018368
 * Callers:
        ...
        struct DirectComposition::CBatch **a2)
{
  ...
  if ( !*((_QWORD *)this + 12) || !*((_QWORD *)this + 13) || (*((_DWORD *)this + 8) & 0x100) != 0 )
    return 1;
