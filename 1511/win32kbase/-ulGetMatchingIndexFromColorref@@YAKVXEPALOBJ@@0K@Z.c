/*
 * XREFs of ?ulGetMatchingIndexFromColorref@@YAKVXEPALOBJ@@0K@Z @ 0x1C005C120
 * Callers:
...
__int64 __fastcall ulGetMatchingIndexFromColorref(_DWORD *a1, __int64 a2, unsigned int a3)
{
  ...
  struct _SINGLE_LIST_ENTRY *v13; // [rsp+48h] [rbp+28h] BYREF
  ...
  if ( !a1 || (a1[6] & 0x800) != 0 )
  {
    if ( (a3 & 0x3000000) != 0 )
    {
      ...
      if ( (struct _SINGLE_LIST_ENTRY *)a2 == WPP_MAIN_CB.Dpc.DpcListEntry.Next )
      {
    ...
    if ( (a3 & 0x10FF0000) != 0x10FF0000 )
    {
      ...
      else
      {
        if ( v12 )
        {
          Next_low = LODWORD(Next[13].Next);
          v13 = Next;
          result = XEPALOBJ::ulDispatchGFPEFunction(&v13, Next_low, v12);
        }
  ...
  return XEPALOBJ::ulDispatchGFPEFunction(&v10, (unsigned int)a1[26], v4);
}
