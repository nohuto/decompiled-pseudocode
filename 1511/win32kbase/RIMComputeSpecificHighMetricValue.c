/*
 * XREFs of RIMComputeSpecificHighMetricValue @ 0x1C0078B0C
 * Callers:
 ...
 * Callees:
 *     RIMComputePower @ 0x1C0078BD0 (RIMComputePower.c)
 */
...
__int64 __fastcall RIMComputeSpecificHighMetricValue(int a1, __int64 a2)
{
  ...
  if ( (unsigned int)v7 < 5 )
  {
    ...
    if ( (unsigned int)(v8 - 1) <= 1 )
    {
      ...
      if ( v3 < 0xB )
      {
        v9 = RIMComputePower(word_1C00EBA30[2 * v3 + 1]);
        if ( v11 >= 0 )
        {
          v5 = v10 * v9 * v4;
        }
