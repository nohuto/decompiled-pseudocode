/*
 * XREFs of NtGdiGetStats @ 0x1C00B61E0
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall NtGdiGetStats(int a1, int a2, unsigned int a3, volatile void *a4, unsigned int Length)
{
  ...
  if ( v9 >= 0 )
  {
    ...
    else
    {
      ...
      {
        if ( v10 == 1 || v10 == (*((_DWORD *)WPP_MAIN_CB.Dpc.SystemArgument2 + 6 * i + 2) & 0xFFFFFFFE) )
        {
          v12 = *((unsigned __int8 *)WPP_MAIN_CB.Dpc.SystemArgument2 + 24 * i + 14);
          ++*((_DWORD *)a4 + v12);
        }
      }
    }
