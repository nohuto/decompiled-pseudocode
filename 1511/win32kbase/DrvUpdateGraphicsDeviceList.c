/*
 * XREFs of DrvUpdateGraphicsDeviceList @ 0x1C001E650
 * Callers:
 ...
 *     ?DrvSortGraphicsDeviceList@@YAXXZ @ 0x1C007DB50 (-DrvSortGraphicsDeviceList@@YAXXZ.c)
...
__int64 __fastcall DrvUpdateGraphicsDeviceList(int a1, int a2)
{
  ...
  char v57; // [rsp+48h] [rbp-C0h]
  NTSTATUS v58; // [rsp+4Ch] [rbp-BCh] BYREF
  __int64 v59; // [rsp+50h] [rbp-B8h]
  PVOID v60; // [rsp+58h] [rbp-B0h] BYREF
  void *DeviceRegKey; // [rsp+60h] [rbp-A8h] BYREF
  int v62; // [rsp+68h] [rbp-A0h] BYREF
  unsigned int v63; // [rsp+6Ch] [rbp-9Ch] BYREF
  ...
  *(_QWORD *)(v5 + 32) = v3;
  ...
  if ( (_DWORD)v3 )
  {
    gcNextGlobalDeviceNumber = (int)WPP_MAIN_CB.Queue.Wcb.DeviceContext;
    ...
    if ( gProtocolType != -1 && gcNextGlobalDeviceNumber <= v63 )
    {
      if ( (_DWORD)v2 )
      {
        ...
        else
        {
          ...
          v12 = StringCchPrintfW((wchar_t *)&QueryTable, 0x32uLL, L"\\Device\\%s%d", qword_1C0104868, Environment);
        }
        if ( v12 >= 0 )
        {
...
LABEL_134:
            ...
            *(_DWORD *)(v18 + 272) = 0;
            if ( (int)GreDeviceIoControlEx(v24, 0x232033u, 0LL, 0, v68, 0x18u, (__int64)&v62, 1u) >= 0 )
            {
              if ( v68[0] != 2 )
              {
...
LABEL_42:
          ...
          else
          {
            ...
            if ( v58 >= 0 )
            {
              v60 = 0LL;
              LODWORD(v28) = 0;
              if ( (int)GreDeviceIoControlEx(DeviceObject, 0x23201Bu, 0LL, 0, &v60, 8u, (__int64)&v62, 1u) >= 0 )
              {
                if ( v60 )
                {
                  v19 = 1;
...
LABEL_117:
                ...
                *(_QWORD *)(v18 + 304) = 0LL;
                *(_QWORD *)(v18 + 312) = 0LL;
                if ( (int)((__int64 (*)(void))qword_1C0104278)() >= 0 )
...
LABEL_6:
  ...
  if ( (_DWORD)v3 )
  {
    LODWORD(WPP_MAIN_CB.Queue.Wcb.DeviceContext) = gcNextGlobalDeviceNumber;
