/*
 * XREFs of RecalculateQueueInfo @ 0x1C0070750
 * Callers:
        ...
        if ( v12[139] )
        {
          ...
          if ( (result & 4) == 0 )
          {
            ...
            if ( (int)result >= 0 )
            {
              ...
              {
                *(_DWORD *)v12[139] &= ~1u;
                if ( *(_QWORD *)(v12[139] + 8LL) && (int)IsPostMousePointerLeaveAndCleanupSupported_0() >= 0 )
                {
                  HMValidateHandleNoSecure(*(_QWORD *)(v12[139] + 8LL));
