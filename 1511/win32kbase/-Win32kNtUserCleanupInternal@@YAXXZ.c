/*
 * XREFs of ?Win32kNtUserCleanupInternal@@YAXXZ @ 0x1C00634A8
 * Callers:
 *     ?Win32kNtUserCleanup@@YAHXZ @ 0x1C00632A8 (-Win32kNtUserCleanup@@YAHXZ.c)
 * Callees:
 *     IsCleanupPointerInputSupported_0 @ 0x1C0002530 (IsCleanupPointerInputSupported_0.c)
 *     CleanupPointerInput_0 @ 0x1C0002538 (CleanupPointerInput_0.c)
 *     IsFreeImeHotKeysSupported_0 @ 0x1C0002540 (IsFreeImeHotKeysSupported_0.c)
 *     FreeImeHotKeys_0 @ 0x1C0002548 (FreeImeHotKeys_0.c)
 *     IsGetgpastrSetupExeSupported_0 @ 0x1C0002550 (IsGetgpastrSetupExeSupported_0.c)
 *     GetgpastrSetupExe_0 @ 0x1C0002558 (GetgpastrSetupExe_0.c)
 *     IsGetglpSetupProgramsSupported_0 @ 0x1C0002560 (IsGetglpSetupProgramsSupported_0.c)
 *     GetglpSetupPrograms_0 @ 0x1C0002568 (GetglpSetupPrograms_0.c)
 *     IsGetpbwlCacheSupported_0 @ 0x1C0002570 (IsGetpbwlCacheSupported_0.c)
 *     GetpbwlCache_0 @ 0x1C0002578 (GetpbwlCache_0.c)
 *     IsFreeTimerSupported_0 @ 0x1C0002580 (IsFreeTimerSupported_0.c)
 *     FreeTimer_0 @ 0x1C0002590 (FreeTimer_0.c)
 *     IsCleanupDesktopsMonitorsAndWindowsSnapShotSupported_0 @ 0x1C0002598 (IsCleanupDesktopsMonitorsAndWindowsSnapShotSupported_0.c)
 *     CleanupDesktopsMonitorsAndWindowsSnapShot_0 @ 0x1C00025A0 (CleanupDesktopsMonitorsAndWindowsSnapShot_0.c)
 *     IsCleanupModuleAllocationsSupported_0 @ 0x1C00025A8 (IsCleanupModuleAllocationsSupported_0.c)
 *     CleanupModuleAllocations_0 @ 0x1C00025B0 (CleanupModuleAllocations_0.c)
 *     IsCleanupHidRequestListSupported_0 @ 0x1C00025B8 (IsCleanupHidRequestListSupported_0.c)
 *     CleanupHidRequestList_0 @ 0x1C00025C0 (CleanupHidRequestList_0.c)
 *     IsFreeDeviceInfoSupported_0 @ 0x1C00025C8 (IsFreeDeviceInfoSupported_0.c)
 *     FreeDeviceInfo_0 @ 0x1C00025D0 (FreeDeviceInfo_0.c)
 *     IsCleanupFeedbackDataSupported_0 @ 0x1C00025D8 (IsCleanupFeedbackDataSupported_0.c)
 *     CleanupFeedbackData_0 @ 0x1C00025E0 (CleanupFeedbackData_0.c)
 *     IsFreeSMSSupported_0 @ 0x1C00025E8 (IsFreeSMSSupported_0.c)
 *     FreeSMS_0 @ 0x1C00025F0 (FreeSMS_0.c)
 *     IsGetSMSLookasideSupported_0 @ 0x1C00025F8 (IsGetSMSLookasideSupported_0.c)
 *     GetSMSLookaside_0 @ 0x1C0002600 (GetSMSLookaside_0.c)
 *     IsCleanupKeyboardLayoutsSupported_0 @ 0x1C0002608 (IsCleanupKeyboardLayoutsSupported_0.c)
 *     CleanupKeyboardLayouts_0 @ 0x1C0002610 (CleanupKeyboardLayouts_0.c)
...
void Win32kNtUserCleanupInternal(void)
{
  ...
  while ( (__int64)v0 <= (__int64)dword_1C0101B20 );
  if ( gpresUser )
  {
  ...
  if ( gpJobsList )
  {
    do
    {
      ...
      RtlDestroyAtomTable((PRTL_ATOM_TABLE)v3[2]);
      Win32FreePool();
    }
    while ( v2 );
    gpJobsList = 0LL;
  ...
  if ( (int)IsFreeSMSSupported_0() >= 0 )
  {
    ...
    if ( gsmsList )
    {
      while ( v4 != (void ***)&gsmsList )
      {
        v5 = *v4;
        if ( v4[1] != &gsmsList || v5[1] != v4 )
          __fastfail(3u);
        gsmsList = *v4;
        v5[1] = &gsmsList;
        FreeSMS_0();
    ...
    qword_1C0106728 = (__int64)&gsmsList;
    gsmsList = &gsmsList;
  }
