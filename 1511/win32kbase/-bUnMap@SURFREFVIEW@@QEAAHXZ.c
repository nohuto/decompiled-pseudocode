/*
 * XREFs of ?bUnMap@SURFREFVIEW@@QEAAHXZ @ 0x1C0036E50
 * Callers:
...
__int64 __fastcall SURFREFVIEW::bUnMap(SURFREFVIEW *this)
{
  ...
  if ( v3 )
  {
    ...
    v4 = *(_QWORD *)this;
    v2 = 1;
    if ( (*(_QWORD *)(*(_QWORD *)this + 240LL) || (*(_DWORD *)(v4 + 116) & 1) != 0)
      && (*(_WORD *)(v4 + 102) & 0x800) != 0 )
    {
      W32PIDLOCK::vUnlockSingleThread((W32PIDLOCK *)(v4 + 264));
      W32PIDLOCK::vUnlockSimple((W32PIDLOCK *)(v4 + 264));
    }
  }
  *(_QWORD *)this = 0LL;
  return v2;
