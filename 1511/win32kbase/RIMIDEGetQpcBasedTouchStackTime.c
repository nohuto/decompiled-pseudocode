/*
 * XREFs of RIMIDEGetQpcBasedTouchStackTime @ 0x1C00C6960
 * Callers:
...
__int64 __fastcall RIMIDEGetQpcBasedTouchStackTime(__int64 a1)
{
  ...
  return 10000 * (unsigned int)(PerformanceCounter.QuadPart / *(__int64 *)(a1 + 688))
       + (unsigned int)((unsigned __int64)(10000 * (PerformanceCounter.QuadPart % *(_QWORD *)(a1 + 688)))
                      / *(_QWORD *)(a1 + 688));
}
