/*
 * XREFs of ?OpenSwapChainHandles@CFlipExBuffer@@UEBAJPEAUCSM_SWAPCHAIN_HANDLE_INFO@@@Z @ 0x1C003E0C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CFlipExBuffer::OpenSwapChainHandles(CFlipExBuffer *this, HANDLE *a2)
{
  ...
  if ( *((_QWORD *)this + 45) )
  {
    AccessMode = (unsigned int)UserIsCurrentProcessDwm() == 0;
    ObjectType = (struct _OBJECT_TYPE *)((__int64 (*)(void))qword_1C0104350)();
  ...
  if ( !*((_DWORD *)this + 72) )
    return (unsigned int)v4;
  v5 = 0LL;
  for ( i = (CFlipExBuffer *)*((_QWORD *)this + 34); ; i = *(CFlipExBuffer **)i )
  {
    if ( i == (CFlipExBuffer *)((char *)this + 272) )
    {
      *((_DWORD *)a2 + 2) = v5;
      return (unsigned int)v4;
    }
...
LABEL_8:
  ...
  v4 = CBufferRealization::OpenDxSurfaceHandle((CFlipExBuffer *)((char *)i - 8), *((_DWORD *)this + 45), &v11);
  if ( v4 >= 0 )
  {
    a2[v5 + 2] = v11;
