/*
 * XREFs of rimLoadImage @ 0x1C006741C
 * Callers:
...
struct _SYSTEM_GDI_DRIVER_INFORMATION *rimLoadImage()
{
  ...
  if ( ZwQuerySystemInformation(SystemModuleInformation, v6, v5, &ReturnLength) >= 0 )
  {
    ...
    if ( *v7 )
    {
      ...
      v9 = *(void **)&v7[74 * v8 + 6];
      qword_1C01046A8 = (__int64)RtlImageDirectoryEntryToData(v9, 1u, 0, &Size);
      AddressOfEntryPoint = RtlImageNtHeader(v9)->OptionalHeader.AddressOfEntryPoint;
      qword_1C0104698 = 0LL;
      qword_1C01046A0 = (__int64)v9 + AddressOfEntryPoint;
      v1 = 1;
      qword_1C0104690 = (__int64)v9;
    }
  }
LABEL_14:
  Win32FreePool();
