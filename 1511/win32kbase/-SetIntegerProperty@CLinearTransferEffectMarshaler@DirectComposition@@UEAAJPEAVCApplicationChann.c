/*
 * XREFs of ?SetIntegerProperty@CLinearTransferEffectMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@I_JPEA_N@Z @ 0x1C00DEF00
 * Callers:
 *     <none>
 * Callees:
 *     <none>
        ...
        bool *a5)
{
  ...
  switch ( a3 )
  {
    case 2:
      ...
      *((_BYTE *)this + 120) ^= (v5 ^ *((_BYTE *)this + 120)) & 1;
      return 0LL;
    case 5:
      *a5 = v5 != ((*((_BYTE *)this + 120) & 2) != 0);
      v6 = (*((_BYTE *)this + 120) ^ (2 * v5)) & 2;
      goto LABEL_10;
    case 8:
      *a5 = v5 != ((*((_BYTE *)this + 120) & 8) != 0);
      v6 = (*((_BYTE *)this + 120) ^ (8 * v5)) & 8;
      goto LABEL_10;
    case 11:
      *a5 = v5 != ((*((_BYTE *)this + 120) & 4) != 0);
      v6 = (*((_BYTE *)this + 120) ^ (4 * v5)) & 4;
      goto LABEL_10;
    case 12:
      *a5 = v5 != ((*((_BYTE *)this + 120) & 0x10) != 0);
      v6 = (*((_BYTE *)this + 120) ^ (16 * v5)) & 0x10;
LABEL_10:
      *((_BYTE *)this + 120) ^= v6;
      return 0LL;
  }
