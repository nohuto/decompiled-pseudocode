/*
 * XREFs of ?GreGetRandomRgnApiExt@@YAHPEAUHDC__@@PEAUHRGN__@@H@Z @ 0x1C00B8380
 * Callers:
 *     <none>
 * Callees:
 *     IsGreGetRandomRgnSupported_0 @ 0x1C0001548 (IsGreGetRandomRgnSupported_0.c)
 *     GreGetRandomRgn_0 @ 0x1C0001550 (GreGetRandomRgn_0.c)
 */
