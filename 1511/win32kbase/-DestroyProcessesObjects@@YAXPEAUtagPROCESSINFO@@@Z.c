/*
 * XREFs of ?DestroyProcessesObjects@@YAXPEAUtagPROCESSINFO@@@Z @ 0x1C0041CF0
 * Callers:
 *     xxxDestroyThreadInfo @ 0x1C0040170 (xxxDestroyThreadInfo.c)
 * Callees:
 *     StopFade_0 @ 0x1C00023E0 (StopFade_0.c)
 *     IsZombieCursorSupported_0 @ 0x1C0002938 (IsZombieCursorSupported_0.c)
 *     ZombieCursor_0 @ 0x1C0002940 (ZombieCursor_0.c)
 ...
 *     FixupGlobalCursor @ 0x1C007ADA0 (FixupGlobalCursor.c)
 */
...
void __fastcall DestroyProcessesObjects(struct tagPROCESSINFO *a1)
{
  ...
  if ( qword_1C0104A78 )
  {
    ...
    if ( (unsigned int)GreGetObjectOwner(qword_1C0104A70, 1LL) == (CurrentProcessId & 0xFFFFFFFC) )
      StopFade_0();
  }
  ...
  while ( v4 );
  v6 = qword_1C0102D48;
  v7 = qword_1C0102D48 + 24LL * (unsigned int)giheLast;
  if ( qword_1C0102D48 <= v7 )
  {
    do
    {
      v8 = *(_BYTE *)(v6 + 16);
      if ( v8 && (*((_BYTE *)&unk_1C00ED3AC + 16 * v8) & 2) != 0 && *(struct tagPROCESSINFO **)(v6 + 8) == a1 )
      {
        if ( v2 && v8 == 3 )
          FixupGlobalCursor(*(_QWORD *)v6, a1);
        if ( (*(_BYTE *)(v6 + 17) & 1) == 0 )
          HMDestroyUnlockedObject((unsigned __int8 *)v6);
        v9 = *(_BYTE *)(v6 + 16);
        if ( v9 && gptiRit )
        {
          if ( v9 == 3 )
