/*
 * XREFs of EnterSharedCrit @ 0x1C0043160
 * Callers:
 *     <none>
 * Callees:
...
struct tagTHREADINFO *__fastcall EnterSharedCrit(__int64 a1, int a2)
{
  ...
  while ( 1 )
  {
    ...
    if ( v3 || (PVOID)PsGetCurrentProcess(v11, v10) == gpepCSRSS && a2 && v5 != (struct tagTHREADINFO *)gptiTSRequest )
      break;
  ...
  if ( v12 )
  {
    ...
    if ( (*(_QWORD *)&WPP_MAIN_CB.AlignmentRequirement & 0x200000010000000LL) != 0 )
    {
        ...
        && (Microsoft_Windows_Win32kEnableBits & 0x400000) != 0 )
      {
        ...
        Template_xqx(v15, (unsigned int)&AcquiredSharedUserCritEvent, v14, v13.LowPart, 0, gullUserCritAcquireToken);
      }
    }
