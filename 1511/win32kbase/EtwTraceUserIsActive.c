/*
 * XREFs of EtwTraceUserIsActive @ 0x1C00762C0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall EtwTraceUserIsActive(_DWORD *a1, LONGLONG *a2, __int64 a3, int a4)
{
  ...
  if ( (unsigned int)(v6 - LODWORD(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)) < 0xEA60 )
    return 0LL;
  LODWORD(WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc) = v6;
  if ( !gptiForeground )
  {
    v9 = 0;
    v11 = 0LL;
...
LABEL_6:
  ...
  if ( (*(_QWORD *)&WPP_MAIN_CB.AlignmentRequirement & 0x8000000000020000uLL) != 0
    ...
    && (qword_1C01020B0 & 0x8000000000020000uLL) != 0
    && (qword_1C01020B8 & 0x8000000000020000uLL) == qword_1C01020B8
