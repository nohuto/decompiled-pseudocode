/*
 * XREFs of Template_hhq @ 0x1C00ADB40
 * Callers:
 *     EtwTracePointerCoalesce @ 0x1C00ABE80 (EtwTracePointerCoalesce.c)
 *     EtwTracePointerNoCoalesce @ 0x1C00AC100 (EtwTracePointerNoCoalesce.c)
 * Callees:
