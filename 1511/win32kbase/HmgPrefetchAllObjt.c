/*
 * XREFs of HmgPrefetchAllObjt @ 0x1C00719D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall HmgPrefetchAllObjt(char a1, __int64 a2)
{
  ...
  if ( (unsigned int)gcMaxHmgr > 1 )
  {
    do
    {
      result = (__int64)WPP_MAIN_CB.Dpc.SystemArgument2;
      if ( *((_BYTE *)WPP_MAIN_CB.Dpc.SystemArgument2 + 24 * v5 + 14) == a1 )
      {
        v8 = *((_QWORD *)WPP_MAIN_CB.Dpc.SystemArgument2 + 3 * v5);
        if ( v8 )
        {
          result = 2LL * v4++;
          v13[result - 1] = v8;
