/*
 * XREFs of ?MarkImmersiveProcess@@YAXPEAUtagPROCESSINFO@@PEAXW4_PROCESS_IMMERSIVE_TYPE@@@Z @ 0x1C00465F4
 * Callers:
...
__int64 __fastcall MarkImmersiveProcess(__int64 a1, __int64 a2, int a3)
{
  ...
  *(_DWORD *)(a1 + 776) ^= (*(_DWORD *)(a1 + 776) ^ (16 * a3)) & 0x30;
  if ( a3 == 1 )
  {
    if ( (int)RtlQueryPackageClaims(a2, 0LL, 0LL, 0LL, 0LL, 0LL, &v8) >= 0 )
    {
      if ( !(unsigned __int8)ExQueryFastCacheDevLicense() || (unsigned __int64)BYTE2(v8) - 4 > 1 )
        v3 = 0;
      *(_DWORD *)(a1 + 776) ^= (*(_DWORD *)(a1 + 776) ^ (v3 << 9)) & 0x200;
    }
    if ( gfMiPAutoOptIn )
      *(_DWORD *)(a1 + 776) |= 4u;
  }
  ...
  result = (*(_DWORD *)(a1 + 776) ^ ((unsigned __int8)SeSecurityAttributePresent(a2, &DestinationString) << 15)) & 0x8000;
