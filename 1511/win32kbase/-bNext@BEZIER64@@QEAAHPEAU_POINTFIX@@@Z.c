/*
 * XREFs of ?bNext@BEZIER64@@QEAAHPEAU_POINTFIX@@@Z @ 0x1C00B68F0
 * Callers:
 *     ?pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z @ 0x1C006F658 (-pprFlattenRec@EPATHOBJ@@IEAAPEAU_PATHRECORD@@PEAU2@@Z.c)
 * Callees:
 *     ?vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z @ 0x1C0070374 (-vBoundBox@@YAXPEAU_POINTFIX@@PEAU_RECTFX@@@Z.c)
 *     ?vInit@HFDBASIS64@@QEAAXJJJJ@Z @ 0x1C00891F8 (-vInit@HFDBASIS64@@QEAAXJJJJ@Z.c)
 *     ?bIntersect@@YAHPEAU_RECTFX@@0@Z @ 0x1C00B68C8 (-bIntersect@@YAHPEAU_RECTFX@@0@Z.c)
 *     ?vError@HFDBASIS64@@QEAAXPEA_J@Z @ 0x1C00B6DB0 (-vError@HFDBASIS64@@QEAAXPEA_J@Z.c)
 *     ?vParentError@HFDBASIS64@@QEAAXPEA_J@Z @ 0x1C00B6F30 (-vParentError@HFDBASIS64@@QEAAXPEA_J@Z.c)
 *     ?vUntransform@HFDBASIS64@@QEAAXPEAJ@Z @ 0x1C00B6FA8 (-vUntransform@HFDBASIS64@@QEAAXPEAJ@Z.c)
 */
