/*
 * XREFs of ?ConvertDisplayConfigScalingToPathModalityForPath@@YAJPEAUDISPLAYCONFIG_PATH_INFO@@PEAU_D3DKMT_PATHMODALITY_DESCRIPTOR@@PEAH@Z @ 0x1C00BA384
 * Callers:
        ...
        int *a3)
{
  ...
  else if ( (int)((__int64 (__fastcall *)(__int64, char *, int *))qword_1C01041D0)(v4, (char *)a2 + 8, v5) < 0 )
  {
    return 3221225485LL;
  }
  v7 = *v5;
