/*
 * XREFs of ?SeverCrossChannelLink@CDuplicatedVisualMarshaler@DirectComposition@@IEAAXPEAVCApplicationChannel@2@@Z @ 0x1C0013F98
 * Callers:
 ...
 *     ?DetachFromParent@CDuplicatedVisualMarshaler@DirectComposition@@MEAA_NPEAVCApplicationChannel@2@@Z @ 0x1C0013F60 (-DetachFromParent@CDuplicatedVisualMarshaler@DirectComposition@@MEAA_NPEAVCApplicationChannel@2@.c)
 * Callees:
        ...
        DirectComposition::CConnection **a2)
{
  ...
  v4 = *(_DWORD *)(*((_QWORD *)this + 28) + 8LL);
  DirectComposition::CConnection::ReferenceSystemResource(a2[5], v4);
  v5 = (DirectComposition::CConnection *)*((_QWORD *)this + 28);
  *(_QWORD *)v5 = a2[49];
  a2[49] = v5;
