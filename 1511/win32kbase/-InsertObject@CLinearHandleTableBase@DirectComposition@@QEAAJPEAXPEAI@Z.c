/*
 * XREFs of ?InsertObject@CLinearHandleTableBase@DirectComposition@@QEAAJPEAXPEAI@Z @ 0x1C001DF84
 * Callers:
...
__int64 __fastcall DirectComposition::CLinearHandleTableBase::InsertObject(
