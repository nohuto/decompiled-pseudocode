/*
 * XREFs of ?bComputeUnits@EXFORMOBJ@@QEAAHJPEAVPOINTFL@@PEAVEFLOAT@@1@Z @ 0x1C00B34C0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct EFLOAT *a5)
{
  ...
  float v19; // xmm8_4
  float *v20; // rax
  float v22[12]; // [rsp+20h] [rbp-50h] BYREF
  ...
  {
    v18 = (__m128i)COERCE_UNSIGNED_INT((float)v8);
    *(float *)v18.m128i_i32 = *(float *)v18.m128i_i32 / 10.0;
    LODWORD(v19) = efCos(_mm_cvtsi128_si32(v18));
    v22[0] = v19;
    LODWORD(v22[1]) = efSin(_mm_cvtsi128_si32(v18));
    if ( (v12 & 2) == 0 )
    {
      if ( !(unsigned int)EXFORMOBJ::bXform(this, (struct VECTORFL *)v22, (struct VECTORFL *)v22, 1LL) )
        return v5;
      v19 = v22[0];
    }
  ...
  *(_QWORD *)v22 = __PAIR64__(LODWORD(v15), LODWORD(v14));
  v24 = v13;
  if ( EFLOAT::bIsZero((EFLOAT *)&v24) )
    return v5;
  if ( (v16 & 2) != 0 )
