/*
 * XREFs of ?GetPayloadWritePointer@CBatch@DirectComposition@@QEAA_N_KPEAPEAX@Z @ 0x1C001A314
 * Callers:
 ...
 * Callees:
 *     ?UseSpace@CBatchSharedMemoryPool@DirectComposition@@QEAAPEAX_K@Z @ 0x1C001A250 (-UseSpace@CBatchSharedMemoryPool@DirectComposition@@QEAAPEAX_K@Z.c)
 */
        ...
        void **a3)
{
  ...
  v4 = (void *)DirectComposition::CBatchSharedMemoryPool::UseSpace(this[12], a2);
  if ( v4 )
  {
    *(_QWORD *)(v5 + 112) += v6;
    *a3 = v4;
