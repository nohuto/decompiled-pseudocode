/*
 * XREFs of RIMGetPTPClickButtonState @ 0x1C00D1D6C
 * Callers:
        ...
        int *a6)
{
  ...
  v9 = 0LL;
  v10 = 0;
  v11 = (_DWORD *)(*(_QWORD *)(a2 + 696) + 2400LL * v22);
  v20 = *(_DWORD *)(a2 + 312);
  v12 = *(unsigned __int16 **)(a2 + 1416);
  v23 = (MEMORY[0xFFFFF78000000320] * (unsigned __int64)MEMORY[0xFFFFF78000000004]) >> 24;
  v21 = v12;
  if ( rimHidP_GetUsages(HidP_Input, 9u, 0, v12, &v20, a3, a5, a4) >= 0 && v20 )
  {
    v13 = v21;
...
LABEL_22:
      ...
      {
        case 1u:
          *(_DWORD *)(*(_QWORD *)(a2 + 712) + 4LL) |= 4u;
          break;
        case 2u:
          *(_DWORD *)(*(_QWORD *)(a2 + 712) + 4LL) |= 8u;
          break;
        case 3u:
          *(_DWORD *)(*(_QWORD *)(a2 + 712) + 4LL) |= 0x10u;
          break;
      }
      goto LABEL_28;
    }
