/*
 * XREFs of HMFreeObject @ 0x1C0041860
 * Callers:
...
__int64 __fastcall HMFreeObject(_QWORD *BaseAddress)
{
  ...
  v1 = 0LL;
  v3 = qword_1C0102D48 + dword_1C0102D50 * (unsigned int)(unsigned __int16)*(_DWORD *)BaseAddress;
  v4 = *((_BYTE *)&unk_1C00ED3AC + 16 * *(unsigned __int8 *)(v3 + 16));
  if ( (v4 & 2) != 0 )
  {
    v5 = *(_QWORD *)(v3 + 8);
  }
  ...
  {
    v6 = *(_BYTE *)(v3 + 16);
    if ( (v6 == 19 || v6 == 22) && dword_1C01016C0 )
    {
      if ( v6 == 19 )
      {
  ...
  *(_QWORD *)(v3 + 16) = 0LL;
  *(_WORD *)(v3 + 18) = v7;
  v8 = (v3 - qword_1C0102D48) / 24;
  if ( (v8 & 1) != 0 )
  {
    *(_QWORD *)v3 = qword_1C0103528;
    qword_1C0103528 = v8;
  }
  else
  {
    *(_QWORD *)v3 = qword_1C0103520;
    qword_1C0103520 = v8;
  }
