/*
 * XREFs of ?CalculateUpToTime@CIT_USER_ACTIVE_TRACKER@@QEAAXI@Z @ 0x1C00478F8
 * Callers:
...
void __fastcall CIT_USER_ACTIVE_TRACKER::CalculateUpToTime(CIT_USER_ACTIVE_TRACKER *this, unsigned int a2)
{
  ...
  else
  {
    v4 = dword_1C0107150;
    dword_1C0104708 |= 1u;
    dword_1C010470C = dword_1C0107150;
  }
  v5 = *((_DWORD *)this + 2);
  v6 = a2 - v5;
  if ( a2 != v5 )
    ...
    if ( a2 < v5 )
    {
      ...
      if ( (unsigned int)v2 < *((_DWORD *)v3 + 2) )
      {
        ...
        if ( v6 > v10 || v6 > 0x240C8400 )
        {
          ++*((_DWORD *)v3 + 3);
          *((_DWORD *)v3 + 2) = v2;
          *((_DWORD *)v3 + 1) = v2 - dword_1C010470C;
