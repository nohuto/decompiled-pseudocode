/*
 * XREFs of ?DxgkEngGetRgnDataApiExt@@YAIPEAUHRGN__@@IPEAU_RGNDATA@@@Z @ 0x1C00B8150
 * Callers:
 *     <none>
 * Callees:
 *     IsDxgkEngGetRgnDataSupported_0 @ 0x1C00014B0 (IsDxgkEngGetRgnDataSupported_0.c)
 *     DxgkEngGetRgnData_0 @ 0x1C00014B8 (DxgkEngGetRgnData_0.c)
 */
