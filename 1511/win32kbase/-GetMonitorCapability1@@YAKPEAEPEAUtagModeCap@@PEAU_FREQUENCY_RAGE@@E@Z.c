/*
 * XREFs of ?GetMonitorCapability1@@YAKPEAEPEAUtagModeCap@@PEAU_FREQUENCY_RAGE@@E@Z @ 0x1C0060618
 * Callers:
  ...
  *((_DWORD *)a3 + 5) = -1;
  ...
  for ( i = 0; i < 13; ++i )
  {
    *v15 = 0;
    v15[1] = -1;
    *(v15 - 1) = a4 == 0 ? 0x38 : 0;
    if ( ((a1[((int)(((unsigned __int64)(1840700269LL * i) >> 32) - i) >> 2)
            + ((unsigned int)(((unsigned __int64)(1840700269LL * i) >> 32) - i) >> 31)
            + 36] >> ((char)i % 7)) & 1) != 0 )
  ...
  do
  {
    if ( *v17 >= 2u )
    {
      ...
      v40 = 8 * *v17 + 248;
      v42 = v19;
      v41 = (unsigned int)(v40 * v112.m128i_i32[v18]) / v111.m128i_i32[v18];
  ...
  {
    v22 = *(v20 - 4);
    if ( (v22 || *(v20 - 3)) && (v23 = *v20) != 0 )
    {
      v24 = v20[3];
      v25 = *v20;
      v26 = 16 * (v23 & 0xF0) + *(v20 - 2);
      v27 = v20[1] + 16 * (v24 & 0xF0);
      v40 = v26;
      v41 = v27;
      if ( v26 && v27 )
      {
        ...
        v29 = 10000
            * (v22 + (*(v20 - 3) << 8))
            / ((v26 + ((v23 & 0xF) << 8) + *(v20 - 1))
             * (v27 + ((v24 & 0xF) << 8) + (unsigned int)v20[2]));
        v42 = 10000
            * (v22 + (*(v20 - 3) << 8))
            / ((v26 + ((v25 & 0xF) << 8) + *(v20 - 1))
             * (v27 + ((v24 & 0xF) << 8) + (unsigned int)v20[2]));
    ...
    else
    {
      ...
      if ( v34 == -6 )
      {
        ...
        do
        {
          if ( *v36 >= 2u )
          {
            ...
            v40 = 8 * *v36 + 248;
            v42 = v39;
            v41 = (unsigned int)(v40 * v112.m128i_i32[v38]) / v111.m128i_i32[v38];
            inserted = InsertModecapList((struct tagModeCap *)&v40, a2, inserted);
          }
          v36 += 2;
          --v37;
      ...
      else if ( v34 == -3 )
      {
        *(_DWORD *)a3 = v20[1];
        *((_DWORD *)a3 + 1) = v20[2];
        *((_DWORD *)a3 + 2) = 1000 * v20[3];
        v35 = v20[4];
        *((_DWORD *)a3 + 4) = 0;
        *((_DWORD *)a3 + 3) = 1000 * v35;
        *((_DWORD *)a3 + 5) = 10000000 * v20[5];
      }
    }
    v20 += 18;
    --v21;
  ...
  if ( (int)(inserted - 2) >= 0 )
  {
    v31 = (unsigned int *)((char *)a2 + 24 * v30 + 8);
    do
    {
      v32 = v31[6];
      if ( *v31 < v32 )
