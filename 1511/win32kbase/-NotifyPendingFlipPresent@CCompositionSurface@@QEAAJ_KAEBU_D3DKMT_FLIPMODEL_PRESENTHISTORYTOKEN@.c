/*
 * XREFs of ?NotifyPendingFlipPresent@CCompositionSurface@@QEAAJ_KAEBU_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN@@_NPEA_N3@Z @ 0x1C003A598
 * Callers:
        ...
        bool *a6)
{
  ...
  {
    LOBYTE(v12) = a4;
    (*(void (__fastcall **)(struct CCompositionBuffer *, const struct _D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN *, __int64, bool *, bool *))(*(_QWORD *)v11 + 48LL))(
      v11,
      a3,
      v12,
      a5,
