/*
 * XREFs of ??1CAnimationMarshaler@DirectComposition@@UEAA@XZ @ 0x1C00183E4
 * Callers:
        ...
        DirectComposition::CAnimationMarshaler *this)
{
  ...
  *((_QWORD *)this + 2) = &DirectComposition::CAnimationMarshaler::`vftable'{for `DirectComposition::CNotifiedDeletionResource'};
  ...
  if ( v2 )
    Win32FreePool(v2);
  v3 = (DirectComposition::CAnimationMarshaler **)*((_QWORD *)this + 15);
  v4 = (DirectComposition::CAnimationMarshaler **)*((_QWORD *)this + 16);
  if ( v3[1] != (DirectComposition::CAnimationMarshaler *)((char *)this + 120)
    || *v4 != (DirectComposition::CAnimationMarshaler *)((char *)this + 120) )
  {
    __fastfail(3u);
  }
  *v4 = (DirectComposition::CAnimationMarshaler *)v3;
  ...
  if ( *((_QWORD *)this + 8) )
  {
    do
    {
      v5 = (DirectComposition::CAnimationTimeList *)*((_QWORD *)this + 8);
      v6 = *((_QWORD *)v5 + 2);
