/*
 * XREFs of ?Create@CSharedReadAnimationTriggerMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00DFEF4
 * Callers:
 *     CreateSharedReadAnimationTriggerMarshaler @ 0x1C00DFFA0 (CreateSharedReadAnimationTriggerMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedReadAnimationTriggerMarshaler **a2)
{
  ...
  if ( v5 )
  {
    v6 = (*(__int64 (__fastcall **)(struct DirectComposition::CSharedReadAnimationTriggerMarshaler *, const struct DirectComposition::CSharedSystemResource *))(*(_QWORD *)v5 + 224LL))(
           v5,
           a1);
    if ( v6 < 0 )
    {
