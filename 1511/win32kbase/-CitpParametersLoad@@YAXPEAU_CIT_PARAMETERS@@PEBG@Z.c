/*
 * XREFs of ?CitpParametersLoad@@YAXPEAU_CIT_PARAMETERS@@PEBG@Z @ 0x1C006825C
 * Callers:
...
void __fastcall CitpParametersLoad(struct _CIT_PARAMETERS *a1, const unsigned __int16 *a2)
{
  ...
  {
    *((_BYTE *)a1 + 88) = (unsigned int)WinSqmIsOptedInEx(4LL) != 0;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    if ( v3 < 0 )
    {
      CitpLogFailureWorker(v3, v4, 0xB69u);
    }
    else
    {
