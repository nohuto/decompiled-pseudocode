/*
 * XREFs of RIMAddSimulatedPointerDeviceData @ 0x1C00C47F4
 * Callers:
...
LABEL_6:
  ...
  v12 = RIMSetContactBoundary(a2, a4 + 128, *(_QWORD *)(2400LL * a3 + *(_QWORD *)(a2 + 696) + 2284), 0, 0);
  if ( (v12 & 0x80000000) == 0 )
    goto LABEL_6;
  return v12;
}
