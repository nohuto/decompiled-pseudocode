/*
 * XREFs of ?ulDispatchGFPEFunction@XEPALOBJ@@QEAAKW4GFPE_FUNCTION_ID@@K@Z @ 0x1C00B4A10
 * Callers:
 ...
 *     ?ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z @ 0x1C00705A8 (-ulIndexedGetMatchFromPalentry@@YAKPEAVPALETTE@@K@Z.c)
 */

__int64 __fastcall XEPALOBJ::ulDispatchGFPEFunction(struct PALETTE **a1, int a2, unsigned int a3)
{
  ...
  struct _SINGLE_LIST_ENTRY *v10; // [rsp+58h] [rbp+20h] BYREF
  ...
  if ( (_DWORD)result == -1 )
  {
    v10 = (struct _SINGLE_LIST_ENTRY *)v8;
    return XEPALOBJ::ulGetNearestFromPalentryNoExactMatchFirst(&v10, v9);
  }
  return result;
}
