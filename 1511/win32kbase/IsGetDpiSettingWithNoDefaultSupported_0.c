/*
 * XREFs of IsGetDpiSettingWithNoDefaultSupported_0 @ 0x1C0001718
 * Callers:
...
// attributes: thunk
__int64 IsGetDpiSettingWithNoDefaultSupported_0()
{
  return IsGetDpiSettingWithNoDefaultSupported();
}
