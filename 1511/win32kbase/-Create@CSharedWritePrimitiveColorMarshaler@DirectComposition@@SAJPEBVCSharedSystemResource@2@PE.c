/*
 * XREFs of ?Create@CSharedWritePrimitiveColorMarshaler@DirectComposition@@SAJPEBVCSharedSystemResource@2@PEAPEAV12@@Z @ 0x1C00DFB00
 * Callers:
 *     CreateSharedWritePrimitiveColorMarshaler @ 0x1C00DFC40 (CreateSharedWritePrimitiveColorMarshaler.c)
 * Callees:
        ...
        struct DirectComposition::CSharedWritePrimitiveColorMarshaler **a2)
{
  ...
  v4 = (struct DirectComposition::CSharedWritePrimitiveColorMarshaler *)Win32AllocPoolWithQuotaZInit(0x40uLL);
  v5 = v4;
  if ( v4 )
  {
    *((_DWORD *)v4 + 5) = 1;
    *(_QWORD *)v4 = &DirectComposition::CSharedWritePrimitiveColorMarshaler::`vftable';
  }
  else
  {
    v5 = 0LL;
  ...
  if ( v5 )
  {
    ...
    if ( v6 < 0 )
    {
      (*(void (__fastcall **)(struct DirectComposition::CSharedWritePrimitiveColorMarshaler *, __int64))(*(_QWORD *)v5 + 96LL))(
        v5,
        1LL);
      v5 = 0LL;
    }
