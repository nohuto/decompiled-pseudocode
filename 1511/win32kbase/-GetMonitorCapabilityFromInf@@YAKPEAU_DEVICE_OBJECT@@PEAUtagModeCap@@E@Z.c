/*
 * XREFs of ?GetMonitorCapabilityFromInf@@YAKPEAU_DEVICE_OBJECT@@PEAUtagModeCap@@E@Z @ 0x1C0061120
 * Callers:
 ...
 *     __report_rangecheckfailure @ 0x1C00A8F78 (__report_rangecheckfailure.c)
 */
...
__int64 __fastcall GetMonitorCapabilityFromInf(struct _DEVICE_OBJECT *a1, struct tagModeCap *a2, char a3)
{
  ...
  _BYTE KeyInformation[8]; // [rsp+B0h] [rbp-50h] BYREF
  int v26; // [rsp+B8h] [rbp-48h]
  int v27; // [rsp+BCh] [rbp-44h]
  wchar_t Src[120]; // [rsp+C0h] [rbp-40h] BYREF
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    v6 = 0;
    for ( i = 0; ZwEnumerateKey(KeyHandle, i, KeyBasicInformation, KeyInformation, 0x100u, &ResultLength) >= 0; i = v6 )
    {
      ++v6;
      DestinationString.Buffer = Src;
      v16 = v6;
      DestinationString.Length = v27;
      DestinationString.MaximumLength = v27;
      v8 = (unsigned __int16)v27;
      if ( (unsigned __int16)v27 >= 0x100u )
        v8 = 256LL;
      wcsncpy_s(Dst, 0x80uLL, Src, v8 >> 1);
        ...
        if ( ZwOpenKey(&Handle, 0x2000000u, &ObjectAttributes) >= 0 )
        {
          ...
          do
          {
            ...
            if ( ZwQueryValueKey(
                   ...
                   &ResultLength) >= 0 )
            {
              wcsncpy_s(Dst, 0x80uLL, (const wchar_t *)&KeyInformation[v26], 0x7FuLL);
              v22 = 0;
              v20 = -1;
              v23 = -1;
              v21 = a3 == 0 ? 0x38 : 0;
