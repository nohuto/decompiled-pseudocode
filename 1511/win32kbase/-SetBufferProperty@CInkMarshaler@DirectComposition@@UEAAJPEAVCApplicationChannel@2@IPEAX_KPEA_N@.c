/*
 * XREFs of ?SetBufferProperty@CInkMarshaler@DirectComposition@@UEAAJPEAVCApplicationChannel@2@IPEAX_KPEA_N@Z @ 0x1C00D7DA0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_29:
  ...
  if ( v9 == 2 )
  {
    if ( a4 && a5 == 36 )
    {
      ...
      if ( !v10 )
        return (unsigned int)-1073741811;
      v11 = DirectComposition::CInkMarshaler::SetSegments(this, (int)v10 - 1, a4, 1u, a6);
      goto LABEL_29;
    }
LABEL_30:
    v6 = -1073741811;
