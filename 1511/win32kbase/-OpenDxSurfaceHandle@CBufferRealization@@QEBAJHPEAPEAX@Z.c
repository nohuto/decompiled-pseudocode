/*
 * XREFs of ?OpenDxSurfaceHandle@CBufferRealization@@QEBAJHPEAPEAX@Z @ 0x1C004D56C
 * Callers:
...
NTSTATUS __fastcall CBufferRealization::OpenDxSurfaceHandle(CBufferRealization *this, int a2, void **a3)
{
  ...
  *a3 = 0LL;
  ...
  if ( a2 )
    v5 = 983041;
  AccessMode = (unsigned int)UserIsCurrentProcessDwm(this) == 0;
  ObjectType = (struct _OBJECT_TYPE *)((__int64 (*)(void))qword_1C0104348)();
