/*
 * XREFs of NtDCompositionSynchronize @ 0x1C0072B70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionSynchronize(__int64 a1, _QWORD *a2)
{
  __int64 v3; // r14
  int v4; // ebx
  ...
  if ( v4 >= 0 )
  {
    ...
    v4 = DirectComposition::CSynchronizationManager::Synchronize(*((struct DirectComposition::CBatch **)v5 + 15));
    if ( v4 >= 0 )
    {
      v3 = *(_QWORD *)(*((_QWORD *)v5 + 15) + 40LL);
      v8 = v3;
    }
