/*
 * XREFs of NtDCompositionCapturePointer @ 0x1C00D5BB0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionCapturePointer(__int64 a1, unsigned int a2, unsigned int a3)
{
  int v5; // edi
  unsigned int v6; // r8d
  ...
  if ( v5 >= 0 )
  {
    v6 = a3;
    v7 = v9;
    v5 = DirectComposition::CApplicationChannel::CapturePointer(v9, a2, v6);
