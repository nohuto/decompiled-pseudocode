/*
 * XREFs of RIMTransformCoordinates @ 0x1C00CF730
 * Callers:
 *     RIMApplyTransforms @ 0x1C00CEB84 (RIMApplyTransforms.c)
 * Callees:
 *     ApiSetAdjustLinearity @ 0x1C00CE6D4 (ApiSetAdjustLinearity.c)
 */
...
LABEL_18:
  ...
  *v4 = v16;
  if ( v15 > v13 || v16 > v14 )
    v7 = 1;
  if ( v36 && *(_QWORD *)(*(_QWORD *)(a2 + 320) + 80LL) )
  {
    ApiSetAdjustLinearity();
    v15 = v32;
    *v8 = v32;
  ...
  {
    v24 = 2400LL * a3;
    *(_DWORD *)(v24 + *(_QWORD *)(a2 + 696) + 2308) = v15;
    *(_DWORD *)(v24 + *(_QWORD *)(a2 + 696) + 2312) = *v4;
    *(_DWORD *)(v24 + *(_QWORD *)(a2 + 696) + 2392) |= 0x80u;
  ...
  else
  {
    ...
    if ( (result & 0x80u) != 0LL )
    {
      *(_DWORD *)(v27 + v26 + 2392) = result | 0x100;
      v28 = *(_DWORD *)(v27 + *(_QWORD *)(a2 + 696) + 2308);
      if ( v28 <= v13 && v28 )
      {
        v12 = v29;
        v13 = v14;
