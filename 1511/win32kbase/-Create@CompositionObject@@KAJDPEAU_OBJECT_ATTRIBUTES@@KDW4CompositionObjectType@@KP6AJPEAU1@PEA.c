/*
 * XREFs of ?Create@CompositionObject@@KAJDPEAU_OBJECT_ATTRIBUTES@@KDW4CompositionObjectType@@KP6AJPEAU1@PEAXPEAPEAVICompositionObject@@@Z3PEAPEAX@Z @ 0x1C0071FC8
 * Callers:
 ...
 *     NtCreateCompositionSurfaceHandle @ 0x1C00754D0 (NtCreateCompositionSurfaceHandle.c)
        ...
        void **Handle)
{
  ...
  {
    v10 = ObCreateObject(a1, ExCompositionObjectType, a2, a4, 0LL, a6, 0, 0, Object);
    if ( v10 >= 0 )
    {
