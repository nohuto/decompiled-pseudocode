/*
 * XREFs of NtDCompositionSetResourceHandleProperty @ 0x1C007D6A0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NtDCompositionSetResourceHandleProperty(__int64 a1, int a2, unsigned int a3, void *a4)
{
  int v7; // edi
  void *v8; // r9
