/*
 * XREFs of ?AddNotificationToken@SfmTokenArray@@QEAAJPEAU_D3DKMT_PRESENTHISTORYTOKEN@@@Z @ 0x1C004E930
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SfmTokenArray::AddNotificationToken(SfmTokenArray *this, struct _D3DKMT_PRESENTHISTORYTOKEN *a2)
{
  ...
  result = SfmTokenArray::EnsureTokenBufferSize(this, 1);
  if ( (int)result >= 0 )
  {
    v5 = ++*((_DWORD *)this + 3);
    if ( v5 > *((_DWORD *)this + 2) )
      *((_DWORD *)this + 2) = v5;
    v6 = *(_QWORD *)this + 40 * (v5 - 1);
