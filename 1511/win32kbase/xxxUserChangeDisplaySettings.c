/*
 * XREFs of xxxUserChangeDisplaySettings @ 0x1C0052F30
 * Callers:
        ...
        unsigned int a7)
{
  ...
  *(_DWORD *)&ActivityId.Data4[4] = 0;
  ...
  v11 = xxxUserChangeDisplaySettingsInternal((__int64)a1, a2, a3, a4, a5, a6, a7);
  v28 = v11;
  ...
  if ( v12 )
  {
    ...
    *((_QWORD *)v12 + 7) = v34;
    ...
    v23 = dword_1C0101D10;
    if ( dword_1C0101D10 > 5u && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0101D10, 0x200000000000uLL) )
    {
      ...
      v88 = &v27;
      v89 = 1LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0101D10, &unk_1C00ED9B7, &ActivityId, v26, 9u, &pData);
      v23 = dword_1C0101D10;
    }
    if ( (v13[35] & 1) != 0 && v23 > 5 && TlgKeywordOn((TraceLoggingHProvider)&dword_1C0101D10, 0x200000000000uLL) )
    {
      v33 = v13[16];
      v56 = &v33;
      v57 = 4LL;
      ...
      v74 = &v30;
      v75 = 4LL;
      TlgWrite((TraceLoggingHProvider)&dword_1C0101D10, &unk_1C00ED92A, &ActivityId, v24, 0xCu, &v55);
    }
    Win32FreePool();
  }
  return v11;
