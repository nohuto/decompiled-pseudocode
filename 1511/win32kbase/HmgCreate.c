/*
 * XREFs of HmgCreate @ 0x1C006CE6C
 * Callers:
 *     InitializeGre @ 0x1C013A000 (InitializeGre.c)
 * Callees:
 *     GetMaxGdiHandleCount_0 @ 0x1C0001298 (GetMaxGdiHandleCount_0.c)
 *     GetgvsStateWrap_0 @ 0x1C00012A0 (GetgvsStateWrap_0.c)
...
__int64 HmgCreate()
{
  ...
  LODWORD(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink) = GetMaxGdiHandleCount_0();
  ...
  if ( !(unsigned int)HmgInitializeLookAsideList(1u, 0x9D8u, v0, 0x28u) )
    return 0LL;
  ...
  RegionSize = 24LL * LODWORD(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink);
  ...
  WPP_MAIN_CB.Dpc.DpcData = PALLOCMEM2(
                              (unsigned int)(8 * LODWORD(WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Blink)),
                              1819297863LL,
                              0);
  if ( !WPP_MAIN_CB.Dpc.DpcData )
    return 0LL;
  WPP_MAIN_CB.Dpc.SystemArgument2 = gpGdiSharedMemory;
  WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink = (struct _LIST_ENTRY *)((char *)gpGdiSharedMemory + 1572864);
  ...
  *(_QWORD *)&WPP_MAIN_CB.ActiveThreadCount = PALLOCMEM2(0x1000uLL, 1836345415LL, 0);
  v12 = (void **)Win32AllocPoolNonPaged();
  gpTmpGlobalFree = v12;
  if ( !*(_QWORD *)&WPP_MAIN_CB.ActiveThreadCount || !v12 )
    return 0LL;
  *v12 = *(void **)&WPP_MAIN_CB.ActiveThreadCount;
  return 1LL;
}
