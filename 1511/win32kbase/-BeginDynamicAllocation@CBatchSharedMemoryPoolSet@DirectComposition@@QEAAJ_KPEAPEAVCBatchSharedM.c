/*
 * XREFs of ?BeginDynamicAllocation@CBatchSharedMemoryPoolSet@DirectComposition@@QEAAJ_KPEAPEAVCBatchSharedMemoryPool@2@PEA_K@Z @ 0x1C0073734
 * Callers:
...
LABEL_6:
    ...
    *((_QWORD *)this + 1) = this;
    if ( *((DirectComposition::CBatchSharedMemoryPoolSet **)v14 + 1) != this )
      __fastfail(3u);
    *((_QWORD *)v14 + 1) = this;
LABEL_18:
    *(_QWORD *)this = this;
...
LABEL_14:
  ...
  if ( v9 >= 0 )
  {
    ...
    *(_QWORD *)this = *(_QWORD *)this;
    *((_QWORD *)this + 1) = this;
    if ( *((DirectComposition::CBatchSharedMemoryPoolSet **)v15 + 1) != this )
      __fastfail(3u);
    *((_QWORD *)v15 + 1) = this;
    goto LABEL_18;
  }
