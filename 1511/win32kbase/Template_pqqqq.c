/*
 * XREFs of Template_pqqqq @ 0x1C00ADED4
 * Callers:
 *     EtwTraceTimerProc @ 0x1C00706C0 (EtwTraceTimerProc.c)
 *     EtwDirtyRectUpdate @ 0x1C0071130 (EtwDirtyRectUpdate.c)
 *     EtwTraceInternalSetTimer @ 0x1C0072C40 (EtwTraceInternalSetTimer.c)
 *     EtwLogicalSurfRemovedTranslationFromDirtyEvent @ 0x1C00BFBB0 (EtwLogicalSurfRemovedTranslationFromDirtyEvent.c)
 *     EtwLogicalSurfRemovedTranslationFromMoveEvent @ 0x1C00BFBF0 (EtwLogicalSurfRemovedTranslationFromMoveEvent.c)
 *     EtwTranslationUpdate @ 0x1C00BFD80 (EtwTranslationUpdate.c)
 * Callees:
