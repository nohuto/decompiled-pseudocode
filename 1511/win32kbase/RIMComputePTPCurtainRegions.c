/*
 * XREFs of RIMComputePTPCurtainRegions @ 0x1C00CECE8
 * Callers:
 ...
 *     EtwTraceTouchPadCurtainSize @ 0x1C00AC560 (EtwTraceTouchPadCurtainSize.c)
...
__int64 __fastcall RIMComputePTPCurtainRegions(__int64 a1, const wchar_t *a2)
{
  ...
  PCWSTR SourceString[4]; // [rsp+B0h] [rbp-58h]
  char KeyValueInformation[4]; // [rsp+D0h] [rbp-38h] BYREF
  int v33; // [rsp+D4h] [rbp-34h]
  int v34; // [rsp+D8h] [rbp-30h]
  __int32 v35; // [rsp+DCh] [rbp-2Ch]
