...
void __fastcall IopLiveDumpBufferDumpData(__int64 *a1, unsigned int *a2)
{
  ...
  if ( v3 < *(_DWORD *)(v2 + 560) )
  {
    ...
    while ( 1 )
    {
      ...
      IopLiveDumpGetCapturePagesNoLock(v5, v4, (unsigned int)v27, v8, (__int64)&v21, (__int64)&v26);
      KxReleaseSpinLock((PKSPIN_LOCK)(v4 + 24));
      v9 = v21;
      if ( !v21 )
        break;
      v10 = 0;
      v22 = *(_DWORD **)(*(_QWORD *)(v4 + 64) + 8 * v26);
      v11 = 0;
      v12 = v27;
      do
      {
        ...
        *(_QWORD *)(v7 + 8 * v13) = *v12;
        if ( v11 == 16 || v11 && v10 == v9 - 1 )
        {
          ...
          *(_WORD *)(v14 + 8) = 8 * (((unsigned __int64)(v15 + 4095) >> 12) + 6);
          MmMapMemoryDumpMdlEx(*(_QWORD *)v6, v15, *(_QWORD *)(v6 + 8), 0LL);
