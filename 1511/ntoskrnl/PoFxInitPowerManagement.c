/*
 * XREFs of PoFxInitPowerManagement @ 0x14076E46C
 * Callers:
...
__int64 PoFxInitPowerManagement()
{
  ...
  *(_QWORD *)&PopFxResidentTimer.Processor = 0LL;
  ...
  v0 = 4LL;
  qword_1402DF118 = (__int64)&SocSubsystemsList;
  v1 = (__int64 (__fastcall **)(__int64))&unk_1402DF150;
  SocSubsystemsList = (__int64)&SocSubsystemsList;
  v2 = (char *)&unk_1402DF2A1;
  do
  {
    v1[3] = 0LL;
  ...
  *(_QWORD *)&PopPepIdleTimer.Header.Lock = 9LL;
  qword_1402DD998 = (__int64)&PopPepDeviceList;
  PopPepDeviceList = (__int64)&PopPepDeviceList;
  qword_1402DDA70 = (__int64)PopPepIdleTimeoutRoutine;
