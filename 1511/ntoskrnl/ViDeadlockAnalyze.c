/*
 * XREFs of ViDeadlockAnalyze @ 0x1406CCCBC
 * Callers:
 ...
 *     ViDeadlockAddParticipant @ 0x1406CC944 (ViDeadlockAddParticipant.c)
 *     ViDeadlockAnalyze @ 0x1406CCCBC (ViDeadlockAnalyze.c)
 *     ViDeadlockCertify @ 0x1406CCFCC (ViDeadlockCertify.c)
    ...
    if ( (unsigned int)ViDeadlockCertify(a5, a2) )
    {
      *((_QWORD *)v13 + 4107) = a1;
      ViDeadlockPreprocessOptions(
        ...
        a2,
        0LL);
      VfReportIssueWithOptions(196, 4097, a1, a2, 0LL, byte_1402D407C);
      return 0LL;
    }
    v6 = 0;
LABEL_33:
