/*
 * XREFs of PpmPerfSnapUtility @ 0x140046280
 * Callers:
...
char __fastcall PpmPerfSnapUtility(struct _KPRCB *a1)
{
  ...
  __int64 v28; // rcx
  __int64 v29; // rcx
  bool v30; // [rsp+30h] [rbp-B8h]
  __int16 Group; // [rsp+34h] [rbp-B4h] BYREF
  unsigned int v32; // [rsp+38h] [rbp-B0h]
  unsigned __int64 v33; // [rsp+40h] [rbp-A8h] BYREF
  unsigned int v34; // [rsp+48h] [rbp-A0h] BYREF
  unsigned __int64 v35; // [rsp+50h] [rbp-98h]
  __int64 v36; // [rsp+60h] [rbp-88h] BYREF
  ...
  if ( result )
  {
    ...
    if ( LatestPerformancePercent != a1->PowerState.LatestPerformancePercent )
    {
      ...
      if ( PpmEtwRegistered )
      {
        ...
        if ( PpmEtwHandle )
        {
          if ( (v28 = *(_QWORD *)(PpmEtwHandle + 32), *(_DWORD *)(v28 + 80))
            && (unsigned __int8)(*(_BYTE *)(v28 + 84) - 1) > 2u
            && *(char *)(v28 + 96) < 0
            && (*(_QWORD *)(v28 + 104) & 0x80LL) == *(_QWORD *)(v28 + 104)
            || *(_BYTE *)(PpmEtwHandle + 100)
            && (LOBYTE(v27) = 4,
                (unsigned __int8)EtwpLevelKeywordEnabled(*(_QWORD *)(PpmEtwHandle + 40) + 80LL, v27, 128LL)) )
          {
            Group = a1->Group;
            v36 = PpmConvertTime(v7, PopQpcFrequency, 1000000LL);
    ...
    a1->PowerState.LatestPerformancePercent = v35;
    a1->PowerState.LatestAffinitizedPercent = v32;
    if ( PerfConstraint )
    {
      v23 = v8;
      if ( !v8 )
    ...
    *(_OWORD *)PerfCheck->Snap.TaggedThreadCycles = *(_OWORD *)PerfCheck->TempSnap.TaggedThreadCycles;
    ...
    else
    {
      ...
      {
        v29 = a1->PowerState.FFHThrottleStateInfo.MismatchCount + 1;
        a1->PowerState.FFHThrottleStateInfo.MismatchCount = v29;
        if ( !((unsigned int)v29 % PopProcessorThrottleLogInterval) || (_DWORD)v29 == 1 )
        {
          LODWORD(v29) = KeGetPcr()->Prcb.Number;
          PopDiagTraceIllegalProcessorThrottle(v29, v33, &a1->PowerState.FFHThrottleStateInfo.LastLogTickCount);
        }
      }
    }
    a1->PowerState.FFHThrottleStateInfo.LastValue = v33;
