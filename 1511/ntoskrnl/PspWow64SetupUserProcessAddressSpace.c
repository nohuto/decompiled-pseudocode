/*
 * XREFs of PspWow64SetupUserProcessAddressSpace @ 0x14009B4B0
 * Callers:
...
int __fastcall PspWow64SetupUserProcessAddressSpace(__int64 a1, __int64 a2, __int64 a3)
{
  int result; // eax
  __int64 v6; // rcx
  ...
  if ( !*(_QWORD *)(a1 + 1064) && !*(_QWORD *)(a2 + 1064) )
    return 0;
  result = PspWow64CurrentPeb((unsigned __int64 *)&v7);
  if ( result >= 0 )
  {
    v6 = v7;
    *(_DWORD *)(a3 + 220) = v7;
