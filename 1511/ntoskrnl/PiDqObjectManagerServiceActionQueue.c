/*
 * XREFs of PiDqObjectManagerServiceActionQueue @ 0x14045E118
 * Callers:
 *     <none>
 * Callees:
 ...
 *     IoClearActivityIdThread @ 0x140099C20 (IoClearActivityIdThread.c)
 *     IoSetActivityIdThread @ 0x140099C34 (IoSetActivityIdThread.c)
...
LABEL_49:
    ...
    while ( 1 )
    {
      ...
      *(_QWORD *)(v12 + 8) = P;
      if ( (_BYTE)v3 && OwnerTable )
      {
        ...
        do
        {
          ...
          if ( *(_QWORD *)(*v6 + 224) <= *((_QWORD *)v11 + 3) )
          {
            ...
            {
              v30 = *(_OWORD *)*(_QWORD *)(v14 + 24);
              v3 = IoSetActivityIdThread(&v30);
              v24 = 1;
            }
      ...
      PiPnpRtlObjectEventRelease(*((char **)v11 + 2));
