/*
 * XREFs of ViXdvSearchAllThunkArrays @ 0x1406B9270
 * Callers:
 *     ViXdvBindXdvDDIWrappers @ 0x1406B8EA0 (ViXdvBindXdvDDIWrappers.c)
 * Callees:
 *     ViXdvSearchAndReplaceThunkArray @ 0x1406B92D4 (ViXdvSearchAndReplaceThunkArray.c)
 *     ViXdvSearchAndReplaceThunkArrayOrderDependent @ 0x1406B931C (ViXdvSearchAndReplaceThunkArrayOrderDependent.c)
 */
