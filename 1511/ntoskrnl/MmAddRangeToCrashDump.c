/*
 * XREFs of MmAddRangeToCrashDump @ 0x1401D61E4
 * Callers:
...
__int64 __fastcall MmAddRangeToCrashDump(__int64 (__fastcall **a1)(_QWORD, __int64, __int64), __int64 *a2, __int64 a3)
{
  ...
  if ( (KiBugCheckActive & 3) == 0 && (struct _KTHREAD *)qword_1402FEC88 != KeGetCurrentThread() )
    v9 = ExAcquireSpinLockShared(&dword_1402FE9C8);
  v10 = MiAddRangeToCrashDump(a1, (__int64 *)v4, v6, (__int64)v12, 3u);
  if ( v9 != 17 )
    ExReleaseSpinLockShared(&dword_1402FE9C8, v9);
  return v10;
}
