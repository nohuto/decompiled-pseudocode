/*
 * XREFs of WheapWmiExecutePolicyManagementMethod @ 0x1402176BC
 * Callers:
 *     WheapWmiExecuteMethod @ 0x14021759C (WheapWmiExecuteMethod.c)
 * Callees:
 *     WheapGetAllPolicyBufferSize @ 0x14054F7E0 (WheapGetAllPolicyBufferSize.c)
 *     WheapCommitPolicy @ 0x1406784F4 (WheapCommitPolicy.c)
 *     WheapGetAllPolicyValues @ 0x1406785D8 (WheapGetAllPolicyValues.c)
 *     WheapGetPolicyValue @ 0x140678618 (WheapGetPolicyValue.c)
 *     WheapSetPolicyValue @ 0x14067869C (WheapSetPolicyValue.c)
 */
