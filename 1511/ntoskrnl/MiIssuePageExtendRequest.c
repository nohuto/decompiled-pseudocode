/*
 * XREFs of MiIssuePageExtendRequest @ 0x1401DCCB8
 * Callers:
...
__int64 __fastcall MiIssuePageExtendRequest(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  if ( (void (__fastcall *)(int *))KeGetCurrentThread()[1].ApcState.ApcListHead[1].Flink == MiDereferenceSegmentThread
    || KeGetCurrentIrql() >= 2u )
  {
    return 0LL;
  }
...
LABEL_12:
  ...
  {
    v12 = ExAcquireSpinLockExclusive((PEX_SPIN_LOCK)(a1 + 1536));
    if ( !v23 )
    {
      if ( v28 )
      {
    ...
    ExReleaseSpinLockExclusive((PEX_SPIN_LOCK)(a1 + 1536), v12);
  }
  LOBYTE(v8) = v20 != 0;
  return v8;
}
