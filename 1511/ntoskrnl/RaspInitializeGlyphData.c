/*
 * XREFs of RaspInitializeGlyphData @ 0x14011D968
 * Callers:
...
__int64 __fastcall RaspInitializeGlyphData(__int64 a1, int a2, __int64 *a3, __int64 a4)
{
  ...
  __int64 v57; // [rsp+40h] [rbp-18h] BYREF
  __int16 v58[8]; // [rsp+48h] [rbp-10h] BYREF
  ...
  FioFwReadUshortAtOffset(v55, v7 + 2, (_WORD *)&v57 + 1);
  v7 += 4;
  FioFwReadUshortAtOffset(v55, v7, (_WORD *)&v57 + 2);
  FioFwReadUshortAtOffset(v55, v7 + 2, (_WORD *)&v57 + 3);
  v9 = v7 + 4;
  FioFwReadUshortAtOffset(v55, v9, v58);
  v10 = v57;
  if ( (v57 & 0x8000u) != 0LL )
    return 3221225485LL;
  if ( (_WORD)v57 )
  ...
  else
  {
    ...
    {
      v51 = SWORD1(v57);
      *(_DWORD *)(v50 + 2) = SWORD1(v57);
      *(_WORD *)v50 = 0;
      *(_DWORD *)(v50 + 6) = SWORD2(v57);
      *(_DWORD *)(v50 + 10) = SHIWORD(v57);
      *(_DWORD *)(v50 + 14) = v58[0];
      *(_QWORD *)(v50 + 18) = v51;
      *a3 = v50;
      return 0LL;
