/*
 * XREFs of SeQuerySecureBootPolicyValue @ 0x140654934
 * Callers:
 *     <none>
 * Callees:
 *     memmove @ 0x140166980 (memmove.c)
 *     SepSecureBootFindMatchingRegistryRule @ 0x140654C24 (SepSecureBootFindMatchingRegistryRule.c)
 *     SepSecureBootGetPolicyValueByRef @ 0x140654D54 (SepSecureBootGetPolicyValueByRef.c)
 */
  ...
  if ( qword_14031C950 )
  {
    ...
    if ( MatchingRegistryRule )
    {
      PolicyValueByRef = SepSecureBootGetPolicyValueByRef(
                           qword_1403351D8 + *(unsigned int *)(MatchingRegistryRule + 12),
                           a3,
                           &Src,
                           &Size);
