/*
 * XREFs of IopLiveDumpAllocAndInitResources @ 0x1405FCA38
 * Callers:
 ...
 *     HvlGetHypervisorEncryptionDomain @ 0x140127248 (HvlGetHypervisorEncryptionDomain.c)
 ...
 *     IopLiveDumpResetCorralContext @ 0x1403AAAB4 (IopLiveDumpResetCorralContext.c)
...
LABEL_38:
  if ( stru_1402D1D70.LevelPlus1 > 5 && TlgKeywordOn(&stru_1402D1D70, 0x400000000000uLL) )
  {
    v45 = 8;
    v46 = 0;
    v41 = (MEMORY[0xFFFFF78000000008] - v3) / 0x2710uLL;
    v44 = &v41;
    TlgWrite(&stru_1402D1D70, &unk_140253B8D, (LPCGUID)(a1 + 624), (LPCGUID)(a1 + 608), 3u, &pData);
  }
  if ( v2 )
