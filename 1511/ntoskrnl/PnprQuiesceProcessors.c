/*
 * XREFs of PnprQuiesceProcessors @ 0x1403B079C
 * Callers:
...
SIZE_T PnprQuiesceProcessors()
{
  ...
  {
    if ( off_1402D2748(v10, PnprContext, v11) < 0 )
    {
      v13 = PnprContext;
...
LABEL_14:
  ...
  off_1402D26F8(0LL, *(_QWORD *)(v12 + 10632), v11);
  ...
  *(_QWORD *)(v27 + 200) = 1LL;
  if ( *(_DWORD *)(v42 + 16) )
  {
    ...
    *(_DWORD *)(PnprContext + 10764) = v43;
    v46 = off_1402D26F8((PVOID)1, *(_QWORD *)(v44 + 10632), v45);
