/*
 * XREFs of sub_140215C6C @ 0x140215C6C
 * Callers:
...
__int64 __fastcall sub_140215C6C(ULONG a1, unsigned int a2, __int64 a3, HANDLE *a4)
{
  __int64 v6; // rcx
  int v7; // edi
  NTSTATUS v8; // eax
  ...
  v7 = sub_140215DBC(v6, a2, &DestinationString, a4, &v17);
  if ( v7 >= 0 && v17 == 2 )
  {
    v12 = 0LL;
    ResultLength = 0;
    ...
    if ( ResultLength && (v8 == -1073741789 || v8 == -2147483643) )
    {
      ...
      if ( StringRoutine )
      {
          ...
          && *(_DWORD *)(StringRoutine + 4) == 1 )
        {
          ...
          if ( (int)sub_140215DBC(v10, a2, &v15, &v12, &v17) >= 0 )
          {
            ZwClose(*a4);
            *a4 = v12;
          }
