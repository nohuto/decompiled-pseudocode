/*
 * XREFs of PopScanIdleList @ 0x1400990D8
 * Callers:
...
__int64 PopScanIdleList()
{
  ...
  v24 = dword_1402DE2A4;
  v3 = 0;
  v29 = *((_DWORD *)PopPolicy + 53);
  v23 = PopCurrentCoalescingSpindownTimeout;
  ...
  else
  {
      ...
      do
      {
        ...
        *((_DWORD *)v6 - 5) += v15;
        ...
        if ( *((_DWORD *)v14 + 12) == 1 )
        {
          if ( v17 == -1 )
            v17 = v29;
          v19 = PopCoalescingCheck(v23, v17, v16);
          v17 = v19;
          if ( v19 )
            ++v13;
          v3 = v24;
    ...
    if ( PopBackgroundTaskIgnoreCount )
      v8 = --PopBackgroundTaskIgnoreCount;
    v9 = dword_1402DEAC8 % (unsigned int)PopIdleScanInterval;
    v10 = dword_1402DEAC8 / (unsigned int)PopIdleScanInterval;
    if ( !dword_1402DEACC
    ...
    if ( !v2 || v1 )
    {
      if ( !v7 && !dword_1402DE28C )
      {
        PopGetPowerSettingValue(&GUID_IDLE_BACKGROUND_TASK, v9, 3LL, &v27);
        ++v27;
      ...
      if ( !v8 && PopBackgroundTaskAllowed && PopSIdle >= 50 && !dword_1402DE28C )
      {
        PopGetPowerSettingValue(&GUID_BACKGROUND_TASK_NOTIFICATION, v9, 0LL, &v27);
        ++v27;
