/*
 * XREFs of LdrpResSearchResourceMappedFile @ 0x14009B520
 * Callers:
 *     LdrResSearchResource @ 0x140464D10 (LdrResSearchResource.c)
 *     LdrResGetRCConfig @ 0x140509F8C (LdrResGetRCConfig.c)
 * Callees:
 *     LdrpFindMessageInAlternateModule @ 0x1400DD5C8 (LdrpFindMessageInAlternateModule.c)
        ...
        __int64 a9)
{
  ...
  if ( (v10 & 0x10) == 0 && (unsigned int)(a5 - 1) <= 2 )
  {
      ...
      || (_WORD)v14 == 3072 )
    {
      ...
      {
        v15 |= LdrIsResItemExist(ullAugend, a4, 0LL);
        v16 = a5;
      }
    }
    else
