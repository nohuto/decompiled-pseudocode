/*
 * XREFs of PopWriteHeaderPages @ 0x14039FEF0
 * Callers:
...
__int64 __fastcall PopWriteHeaderPages(__int64 a1, _DWORD *a2)
{
  ...
  if ( *(_QWORD *)(a1 + 248) )
  {
    ...
    *(_DWORD *)(a1 + 184) = 1;
    ...
    if ( v18 != v17 )
    {
      ...
      KeBugCheckEx(0xA0u, 3uLL, (unsigned int)a2[209], v19, 0x1BEAuLL);
    }
  }
  ...
  *v23 = *v21;
  ...
  if ( v26 != v25 )
  {
    ...
    KeBugCheckEx(0xA0u, 3uLL, (unsigned int)a2[20], v27, 0x1C00uLL);
  }
  ...
  if ( v29 != v28 )
  {
    ...
    KeBugCheckEx(0xA0u, 4uLL, (unsigned int)a2[20], v30, 0x1C07uLL);
  }
  return 0LL;
}
