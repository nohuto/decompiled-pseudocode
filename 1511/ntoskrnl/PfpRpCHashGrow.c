/*
 * XREFs of PfpRpCHashGrow @ 0x1404BA288
 * Callers:
...
__int64 __fastcall PfpRpCHashGrow(__int64 a1, __m128i *a2, unsigned __int64 *a3, __int64 *a4)
{
  ...
  else
  {
    ...
    if ( PoolWithTag )
    {
      ...
      memset(PoolWithTag, 0, v16 << v12);
      v17 = (__int64 *)Src.m128i_i64[0];
      v18 = Src.m128i_i64[0] + (unsigned int)(Src.m128i_i32[3] << v32);
      v27 = v18;
