/*
 * XREFs of SmKmStoreFileGetExtents @ 0x14065B648
 * Callers:
        ...
        unsigned int *a10)
{
  ...
  struct _PRIVILEGE_SET **v40; // [rsp+78h] [rbp-51h]
  unsigned int *v41; // [rsp+80h] [rbp-49h]
  _DWORD *v42; // [rsp+88h] [rbp-41h]
  _QWORD *v43; // [rsp+90h] [rbp-39h]
