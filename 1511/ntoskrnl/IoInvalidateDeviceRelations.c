/*
 * XREFs of IoInvalidateDeviceRelations @ 0x1400D1570
 * Callers:
 *     VerifierIoInvalidateDeviceRelations @ 0x14020B928 (VerifierIoInvalidateDeviceRelations.c)
...
void __stdcall IoInvalidateDeviceRelations(PDEVICE_OBJECT DeviceObject, DEVICE_RELATION_TYPE Type)
{
  ...
  if ( !DeviceNode || (DeviceNode[99] & 0x20000) != 0 )
  {
    ...
    if ( v6 )
    {
      ...
      IoAddTriageDumpDataBlock(v6, 712LL);
      if ( *v7 )
      {
