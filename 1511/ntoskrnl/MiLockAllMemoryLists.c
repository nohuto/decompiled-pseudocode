/*
 * XREFs of MiLockAllMemoryLists @ 0x140117C78
 * Callers:
...
__int64 MiLockAllMemoryLists()
{
  ...
  while ( 2 )
  {
    ...
    v3 = v1 < qword_1402FEC08->SizeOfBitMap ? v1 : 0;
    v4 = qword_1402FEC08->SizeOfBitMap - 1;
...
LABEL_13:
    ...
    {
      v1 = v11 + 1;
      v12 = *(_QWORD *)(qword_1402FEC28 + 8 * v11);
      if ( (*(_DWORD *)(v12 + 4) & 4) != 0 )
      {
        v13 = *(struct _KLOCK_QUEUE_HANDLE **)(v12 + 4936);
        KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v12 + 3552), v13);
        v14 = dword_1402FE70C;
        v15 = (__int64 *)(v12 + 1600);
        LODWORD(v16) = 1;
        v17 = 2LL;
        while ( 1 )
        {
          ...
          if ( v14 )
          {
            ...
            while ( (unsigned int)v0 < dword_1402FE70C );
          }
          ++v15;
          if ( !--v17 )
            break;
        ...
        while ( v20 );
        KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v12 + 6048), &v13[v16]);
        v21 = (unsigned int)(v16 + 1);
        v22 = (KSPIN_LOCK *)(v12 + 2912);
        v23 = 16LL;
        do
        {
        ...
        if ( KeNumberNodes )
        {
          v25 = (KSPIN_LOCK *)(*(_QWORD *)(v12 + 40) + 1328LL);
          do
          {
        ...
        KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)(v12 + 6112), &v13[v21]);
        v0 = 0LL;
      }
      continue;
    }
