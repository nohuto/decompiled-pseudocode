/*
 * XREFs of HdlspKernelAddLogEntry @ 0x1406D771C
 * Callers:
...
LABEL_44:
  ...
  if ( a1 == 1 )
  {
    if ( a2 )
    {
      ...
      v8 = v7 < 80 - v6 ? (unsigned __int64)*a2 >> 1 : 79 - v6;
      v9 = (const void *)*((_QWORD *)a2 + 1);
      memmove(&Dst[v6], v9, 2 * v8);
      if ( *((_WORD *)v9 + v7 - 1) )
        Dst[v8 + v6] = 0;
    }
  }
  do
    ++v5;
  while ( Dst[v5] );
  return HdlspDispatch(17, (__int64)Dst, 2 * v5 + 2, 0LL, 0LL);
}
