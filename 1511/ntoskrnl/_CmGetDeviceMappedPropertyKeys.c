/*
 * XREFs of _CmGetDeviceMappedPropertyKeys @ 0x140697E34
 * Callers:
        ...
        unsigned int *a7)
{
  ...
  const wchar_t *v33; // [rsp+98h] [rbp+10h]
  ...
  *a7 = 0;
  ...
  while ( 1 )
  {
    ...
    if ( a4 )
      break;
    result = CmGetDeviceMappedPropertyFromRegProp(a1, a2, a3, *v8, v31, 0LL, 0, (int *)&a7);
...
LABEL_19:
  ...
  while ( 2 )
  {
    ...
    if ( !a4 )
    {
      result = CmGetDeviceMappedPropertyFromInstanceKeyRegValue(v32, (__int64)v33, v34, *v18, v31, 0LL, 0, &a7);
      if ( (_DWORD)result == -1073741789 || !(_DWORD)result )
      {
        v20 = 1;
      }
...
LABEL_37:
  ...
  while ( 2 )
  {
    ...
    if ( !a4 )
    {
      result = CmGetDeviceMappedPropertyFromComposite(v32, v33, (size_t)v34, *v25, v31, 0LL, 0, (int *)&a7);
      if ( (_DWORD)result == -1073741789 || !(_DWORD)result )
      {
        v27 = 1;
      }
