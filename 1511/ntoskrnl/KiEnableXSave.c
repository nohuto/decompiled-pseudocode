/*
 * XREFs of KiEnableXSave @ 0x1403A6504
 * Callers:
 *     KiRestoreXSaveSupport @ 0x1403A32D8 (KiRestoreXSaveSupport.c)
 *     KiInitializeKernel @ 0x1403A9234 (KiInitializeKernel.c)
 *     KiConfigureDynamicProcessor @ 0x1403B130C (KiConfigureDynamicProcessor.c)
 * Callees:
 *     <none>
 */
