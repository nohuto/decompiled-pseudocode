/*
 * XREFs of PpmInfoAdjustSetting @ 0x1404549D4
 * Callers:
 *     PpmSetProfilePolicySetting @ 0x140454614 (PpmSetProfilePolicySetting.c)
 * Callees:
 *     PpmPerfComputePerfReductionTolerance @ 0x14012F7BC (PpmPerfComputePerfReductionTolerance.c)
 *     PpmInfoWriteData @ 0x140454A8C (PpmInfoWriteData.c)
 */
