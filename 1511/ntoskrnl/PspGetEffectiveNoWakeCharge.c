/*
 * XREFs of PspGetEffectiveNoWakeCharge @ 0x1403EC4EC
 * Callers:
  ...
  if ( (result & 0x800) != 0 )
  {
    if ( *(_DWORD *)(a1 + 864) )
    {
      ...
      *a2 = v5;
      ...
      {
        v6 = *(_QWORD *)(a1 + 1064);
        if ( !v6 || (*(_DWORD *)(v6 + 1296) & 0x1000) == 0 || !*(_DWORD *)(v6 + 864) )
        {
          *a3 = v5;
          if ( v6 )
            _InterlockedOr((volatile signed __int32 *)(v6 + 1296), 0x400000u);
        }
      }
    }
  }
  if ( (*(_DWORD *)(a1 + 1296) & 0x400000) != 0 )
  {
    result = *(_QWORD *)(a1 + 1064);
    if ( result )
      _InterlockedOr((volatile signed __int32 *)(result + 1296), 0x400000u);
