/*
 * XREFs of NtCreateSymbolicLinkObject @ 0x1404B0E34
 * Callers:
        ...
        PUNICODE_STRING Name)
{
  ...
  _DWORD v34[4]; // [rsp+70h] [rbp-E8h] BYREF
  NTSTATUS v35; // [rsp+80h] [rbp-D8h] BYREF
  ...
  if ( PreviousMode )
  {
    ...
    if ( ObjectName )
    {
      ...
      if ( v9 )
      {
        ...
        if ( (unsigned __int64)v10 > MmUserProbeAddress || v10 < DestinationString.Buffer )
    ...
    if ( v32.MaximumLength )
    {
      ...
      if ( (unsigned __int64)v11 > MmUserProbeAddress || v11 < v32.Buffer )
        *(_BYTE *)MmUserProbeAddress = 0;
    }
    v12 = SymbolicLinkHandle;
...
LABEL_27:
  ...
  if ( EtwApiCallsProvRegHandle )
  {
    ...
    *(_QWORD *)&UserData[v25].Size = 2LL;
    v26 = v22 + 1;
    v27 = v26;
    UserData[v27].Ptr = (ULONGLONG)v34;
    *(_QWORD *)&UserData[v27].Size = 4LL;
    v28 = ++v26;
    UserData[v28].Ptr = (ULONGLONG)&v35;
