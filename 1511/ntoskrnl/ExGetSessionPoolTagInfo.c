/*
 * XREFs of ExGetSessionPoolTagInfo @ 0x1400E6F20
 * Callers:
 *     ExGetAttachedSessionPoolTagInfo @ 0x1404AC3E0 (ExGetAttachedSessionPoolTagInfo.c)
...
__int64 __fastcall ExGetSessionPoolTagInfo(__int64 a1, unsigned int a2, _DWORD *a3, _DWORD *a4)
{
  ...
  PoolWithTag = *(_QWORD *)(KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.Bitmap[2] + 7928);
  v20 = PoolWithTag;
  ...
  if ( PoolWithTag )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      memmove(
        (void *)PoolWithTag,
        *(const void **)(KeGetCurrentThread()->ApcState.Process[1].ActiveProcessors.Bitmap[2] + 7920),
        v8);
      KeReleaseInStackQueuedSpinLock(&LockHandle);
      goto LABEL_5;
    }
