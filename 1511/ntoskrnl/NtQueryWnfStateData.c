        ...
        __int64 a6)
{
  ...
  *(_QWORD *)v35 = 0LL;
  ...
  v42[1] = 0LL;
  v33 = a2;
  NameInstance = ExpCaptureWnfStateName(a1, &v39);
  if ( NameInstance >= 0 )
  {
    if ( PreviousMode )
    {
    ...
    NameInstance = ExpWnfCaptureScopeInstanceId(v9, a3, v11, &Sid, v42);
    if ( NameInstance >= 0 )
    {
      if ( PreviousMode )
      {
