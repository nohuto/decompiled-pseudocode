/*
 * XREFs of PopBatteryUpdateCompositeInformation @ 0x1406370C8
 * Callers:
...
__int64 PopBatteryUpdateCompositeInformation()
{
  ...
  *(__m128i *)((char *)&qword_1402DE420 + 4) = v10[1];
  ...
  PopChangeCapability(&unk_1402DDF7F, 0LL);
