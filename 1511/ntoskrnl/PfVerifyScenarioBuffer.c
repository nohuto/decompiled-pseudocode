/*
 * XREFs of PfVerifyScenarioBuffer @ 0x1404D2320
 * Callers:
 ...
 *     PfVerifyScenarioId @ 0x1404D3218 (PfVerifyScenarioId.c)
...
__int64 __fastcall PfVerifyScenarioBuffer(unsigned int *a1, unsigned int a2, int *a3)
{
  ...
  __int64 v78; // [rsp+20h] [rbp-128h]
  __int64 v79; // [rsp+28h] [rbp-120h]
  int v80; // [rsp+30h] [rbp-118h]
  unsigned int v81; // [rsp+34h] [rbp-114h]
  unsigned int v82; // [rsp+38h] [rbp-110h]
  unsigned __int64 v83; // [rsp+40h] [rbp-108h]
  unsigned int v85; // [rsp+50h] [rbp-F8h]
  unsigned __int64 v86; // [rsp+58h] [rbp-F0h]
  char v87; // [rsp+60h] [rbp-E8h]
  int v88; // [rsp+68h] [rbp-E0h]
  unsigned int v89; // [rsp+6Ch] [rbp-DCh]
  unsigned __int64 v90; // [rsp+70h] [rbp-D8h] BYREF
  int v91; // [rsp+78h] [rbp-D0h]
  unsigned __int64 v92; // [rsp+80h] [rbp-C8h]
  int *v93; // [rsp+88h] [rbp-C0h]
  unsigned __int64 v94; // [rsp+90h] [rbp-B8h]
  _WORD v95[16]; // [rsp+98h] [rbp-B0h] BYREF
  wchar_t pszDest[40]; // [rsp+C0h] [rbp-88h] BYREF
  ...
  else if ( *a1 == 30 && a1[1] == 1094927187 )
  {
    ...
    else if ( a2 == a1[3] )
    {
      ...
      else
      {
        ...
        v89 = v6;
        if ( v6 > 0x4000
          || (v7 = a1[28], v85 = v7, (unsigned int)v7 > 0x4000)
          ...
          else if ( (unsigned __int8)PfVerifyScenarioId(a1 + 4) )
          {
            ...
            if ( (v13 & 3) != 0 )
            {
              v3 = 38;
                   ...
                   || (v14 = (char *)v12 + v10, v86 = (unsigned __int64)v12 + v10, v13 >= (unsigned __int64)v12 + v10) )
            {
              v3 = 40;
            }
            else
                          ...
                          else
                          {
                            ...
                            else
                            {
                              ...
                              else
                              {
                                ...
                                while ( 1 )
                                {
                                  v27 = (int *)(v13 + 32LL * v26);
                                  v93 = v27;
                                  v28 = v18 + (unsigned int)v27[3];
                                  if ( (v28 & 1) != 0 )
                                  {
                                    v3 = 77;
                                    goto LABEL_66;
...
LABEL_87:
                                          ...
                                          if ( v51 < (unsigned __int64)v12 || v51 >= v86 )
                                          {
                                            v3 = 200;
                                            goto LABEL_66;
                                          }
                                          v52 = (unsigned __int16 *)(v51 + 2LL * v48[1]);
                                          if ( (char *)v52 + 1 < (char *)v12 || (unsigned __int64)v52 + 1 >= v86 )
                                          {
                                            v3 = 210;
                                            goto LABEL_66;
                                          }
                                          ...
                                          v12 = a1;
                                          if ( v58 < a1 || (unsigned __int64)v58 >= v86 )
                                          {
                                            v3 = 230;
                                            goto LABEL_66;
                                          }
                                          ...
                                          v60 = (char *)v58 + v59 - 1;
                                          if ( v60 < (char *)a1 || (unsigned __int64)v60 >= v86 )
                                          {
                                            v3 = 245;
                                            goto LABEL_66;
                                          }
                                          ...
                                          if ( v68 )
                                          {
                                            while ( v72 >= v12 && (unsigned __int64)v72 < v86 )
                                            {
                                              if ( (unsigned int *)((char *)v72 + 3) < v12
                                                || (unsigned __int64)v72 + 3 >= v86 )
                                              {
                                                v3 = 290;
                                                goto LABEL_66;
                                              }
...
LABEL_129:
                                        ...
                                        while ( !(unsigned __int8)PfMetadataRecordIsEqual(v83 + 96LL * v49, &v90, v50) )
                                        {
                                          v49 = v76 + 1;
                                          if ( v49 >= v77 )
                                            goto LABEL_87;
