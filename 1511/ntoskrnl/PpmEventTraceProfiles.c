/*
 * XREFs of PpmEventTraceProfiles @ 0x140544114
 * Callers:
 ...
 *     PpmEndProfileAccumulation @ 0x14063D42C (PpmEndProfileAccumulation.c)
 */
  ...
  if ( PpmEtwRegistered )
  {
    ...
    if ( (_BYTE)v1 )
    {
      ...
      while ( 1 )
      {
        ...
        v22 = 1;
        v25 = 4;
        UserData.Size = 2 * LODWORD(pcchLength[0]) + 2;
        v18 = v7 + 1;
        v21 = v7 + 4;
        v24 = (char *)v7 + 28;
        v27 = (char *)v7 + 12;
        ...
        if ( v5 == PpmProfileCount )
          break;
        v6 = (STRSAFE_PCNZWCH *)(PpmProfiles + 2864LL * v5++);
      }
      v4[353] = v15;
    }
  }
