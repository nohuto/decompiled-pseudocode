/*
 * XREFs of BcpDisplayCriticalString @ 0x14021FB28
 * Callers:
 ...
 *     BgpRasGetGlyphAdvanceWidth @ 0x14021EFD0 (BgpRasGetGlyphAdvanceWidth.c)
 *     BgpFoGetStringAdvanceWidth @ 0x14021F8F0 (BgpFoGetStringAdvanceWidth.c)
 *     BcpPrintSpaces @ 0x140220348 (BcpPrintSpaces.c)
...
__int64 __fastcall BcpDisplayCriticalString(__int16 *a1, int a2, unsigned int a3, int a4)
{
  ...
  v7 = 0;
  v38 = 0;
  v35 = (_DWORD *)((char *)&unk_1402CF700 + 56 * a4);
  v8 = v35[3] + v35[7] + v35[5];
  v33 = v35[3] + v35[7];
  v9 = *(_QWORD *)(qword_140306360 + 24);
  *(_DWORD *)(v9 + 56) = a2;
  v10 = (int *)(v9 + 40);
  v34 = v9 + 40;
  *(_DWORD *)(qword_140306360 + 8) = a2;
  ...
  if ( (*a1 & 0xFFFE) != 0 )
  {
    while ( 1 )
    {
        ...
        if ( *(_WORD *)(v18 + 2LL * v15) != 32 )
        {
          while ( 1 )
          {
            ...
            if ( v8 < v19 + v11 && v16 )
            {
              if ( v11 < v8 )
              {
                v25 = BcpPrintSpaces(qword_140306360, v11, v8, v14, v32, (__int64)&v39);
      ...
      if ( v11 < v8 )
      {
        if ( (int)BcpPrintSpaces(qword_140306360, v11, v8, v14, v32, (__int64)&v39) < 0 )
          goto LABEL_33;
        v16 = v39;
      }
      v11 = v33;
