/*
 * XREFs of PpmIdleCheckProcessorStateEligibility @ 0x1401E7744
 * Callers:
 *     PpmIdleSelectStates @ 0x140134970 (PpmIdleSelectStates.c)
 *     PpmIdleSelectCoordinatedProcessorDependency @ 0x1401E7D30 (PpmIdleSelectCoordinatedProcessorDependency.c)
 * Callees:
 *     PpmCheckIdleVeto @ 0x1401E6E0C (PpmCheckIdleVeto.c)
 */
