/*
 * XREFs of CcInitializeBcbProfiler @ 0x14072D2C4
 * Callers:
 ...
 *     KiGetLoadOptions @ 0x140772590 (KiGetLoadOptions.c)
 */
...
char CcInitializeBcbProfiler()
{
  ...
  {
    v86 = 1610612746;
    SubStr[0] = __ROR4__(1610612746, 61);
    v87 = 14207;
    SubStr[1] = __ROR4__(65, 192);
    v88 = 140;
    SubStr[2] = __ROL4__(140, 63);
    v76 = 69;
    SubStr[3] = __ROR4__(69, 64);
    v77 = 45889;
    SubStr[4] = __ROR4__(33792, 201);
    v75 = -1073741805;
    SubStr[5] = __ROL4__(-1073741805, 66);
    v67 = 632;
    SubStr[6] = __ROR4__(632, 67);
    v78 = 22034244;
    SubStr[7] = __ROR4__(22020096, 210);
    v69 = -805306367;
    SubStr[8] = __ROL4__(-805306367, 69);
    SubStr[9] = 0;
...
LABEL_58:
        v74 = 324608;
        KeBugCheckEx(__ROR4__(324608, 170), 6uLL, (ULONG_PTR)v8, v17, 0LL);
      }
        ...
        if ( PoolWithTag )
        {
          ...
          *(_QWORD *)&Dpc[2].Header.Lock = v41;
          ...
          if ( v7 )
          {
            ...
            *(_QWORD *)&Dpc[3].Header.Lock = sub_1403B4000;
            Dpc[2].Dpc = 0LL;
          }
          v57 = __rdtsc();
          v58 = __ROR8__(v57, 3);
