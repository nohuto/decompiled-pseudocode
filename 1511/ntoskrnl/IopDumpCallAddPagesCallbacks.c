/*
 * XREFs of IopDumpCallAddPagesCallbacks @ 0x1401B9374
 * Callers:
...
char __fastcall IopDumpCallAddPagesCallbacks(int a1)
{
  ...
  while ( 1 )
  {
    ...
    if ( (__int64 *)v3 == &KeBugCheckAddRemovePagesCallbackListHead )
      break;
    LOBYTE(v1) = KeValidateBugCheckCallbackRecord(v3, 4LL, &v13);
    if ( (_BYTE)v1 )
    {
      v6 = 0LL;
      v8 = a1;
      ...
      do
      {
        ...
        v10 = 0LL;
        v12 = 0;
        (*(void (__fastcall **)(__int64, __int64, __int64 *))(v3 + 16))(4LL, v3, &v6);
        if ( v4 >= 0 )
        {
          if ( v10 )
            v4 = IopAddPageDumpRange((__int64)&v6, &v12);
        }
      }
      while ( v12 );
      LOBYTE(v1) = (v4 < 0) + 3;
