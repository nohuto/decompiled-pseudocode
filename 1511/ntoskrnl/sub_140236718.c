/*
 * XREFs of sub_140236718 @ 0x140236718
 * Callers:
...
__int64 __fastcall sub_140236718(_DWORD *a1, unsigned int a2, int a3)
{
  _DWORD *v4; // rdi
  __int64 v5; // rbx
  char v6; // r12
  ...
  if ( a3 != 3 )
  {
    ...
    if ( v7 )
    {
      ...
      v10 += ((((unsigned int)(((v14 ^ v13) * (unsigned __int128)0x7010008004002001uLL) >> 64) ^ (67117057
           ...
           + 4096;
      v115 = v10 + a2;
      v15 = (*((__int64 (__fastcall **)(__int64, __int64))v4 + 62))(v115 + 8, 0xFFFFFFFFLL);
      v16 = (_QWORD *)v15;
      if ( !v15 )
        goto LABEL_12;
      if ( !(*((unsigned __int8 (__fastcall **)(__int64, _QWORD, __int64))v4 + 64))(
              v15,
              ((_DWORD)v115 + 4095) & 0xFFFFF000,
              64LL) )
      {
        (*((void (__fastcall **)(_QWORD *, __int64))v4 + 63))(v16, v115);
        goto LABEL_12;
      }
      *v16 = v115 + 8;
      v17 = (__int64)(v16 + 1);
    ...
    {
      v17 = (*((__int64 (__fastcall **)(_QWORD, _QWORD, _QWORD))v4 + 30))(v6 == 0 ? 0x200 : 0, v10 + a2, v114);
    }
    if ( v17 )
    {
      v18 = (_QWORD *)v17;
      ...
      if ( v35 )
      {
        ...
        *(_QWORD *)(v35 + 1336) = v17;
        if ( (v40 & 0x10000000) == 0 )
          *(_DWORD *)(v35 + 1680) = v40 | 0x20000000;
...
LABEL_12:
  ...
  *(_QWORD *)&v46 = __rdtsc();
  ...
  v52 = (*((__int64 (__fastcall **)(__int64, _QWORD, __int64))v4 + 30))(512LL, (unsigned int)(v50 + 32), v48);
  v104 = v52;
  if ( !v52 )
  {
    ++v4[452];
LABEL_87:
  ...
  *(_QWORD *)(v63 + 24) = v62;
  ...
  if ( (v75 & 0x1000000) != 0 )
    ...
    v4[420] = v75 | 0x1000000;
  v110 = a2 + v116;
  v76 = (*((__int64 (__fastcall **)(_QWORD, __int64, _QWORD, __int64, int, int))v4 + 96))(0LL, -1LL, 0LL, v110, 1, v74);
  v105 = v76;
  if ( !v76
    || (*(_QWORD *)v63 = v76, (v77 = (*((__int64 (__fastcall **)(__int64, _QWORD))v4 + 97))(v110, v113)) == 0)
    || (*(_QWORD *)(v63 + 8) = v77,
        v106 = (*((__int64 (__fastcall **)(__int64, _QWORD, __int64, __int64))v4 + 98))(v77, v113, v105, 1LL),
        !(*((unsigned __int8 (__fastcall **)(__int64, _QWORD, __int64))v4 + 64))(
           v106,
           ((_DWORD)v110 + 4095) & 0xFFFFF000,
           64LL)) )
  {
    (*((void (__fastcall **)(__int64))v4 + 100))(v63);
    goto LABEL_87;
  }
  v78 = v107;
  v79 = (_QWORD *)v106;
  ...
  if ( v106 + v108 )
  {
    ...
    v102 = *(_DWORD *)(v97 + 1680);
    *(_DWORD *)(v97 + 1364) = v89;
    *(_QWORD *)(v97 + 1336) = v63;
    *(_DWORD *)(v97 + 1588) = 3;
    if ( (v102 & 0x10000000) == 0 )
      *(_DWORD *)(v97 + 1680) = v102 | 0x20000000;
    return v97;
  }
  return 0LL;
}
