/*
 * XREFs of CmpGetNameControlBlock @ 0x1403FAA10
 * Callers:
...
char *__fastcall CmpGetNameControlBlock(unsigned __int16 *a1, _BYTE *a2)
{
  ...
  __int16 v39; // [rsp+68h] [rbp+10h]
  char v40; // [rsp+68h] [rbp+10h]
  unsigned __int16 v41; // [rsp+70h] [rbp+18h]
...
LABEL_30:
  ...
  while ( 1 )
  {
    ...
    if ( (*(_DWORD *)v17 & 1) == 0 )
      break;
    if ( !(unsigned int)CmpCompareCompressedName(v16, v17 + 26, v13, 2LL, v37) )
      goto LABEL_41;
LABEL_20:
    v15 = *(_QWORD *)(v15 + 8);
    if ( !v15 )
