/*
 * XREFs of KiApcInterruptShadow @ 0x140224A00
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall KiApcInterruptShadow(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
  ...
  return KiApcInterrupt(a1, a2, a3, a4, a5);
}
