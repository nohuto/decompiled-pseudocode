/*
 * XREFs of WmipQueryAllData @ 0x1403D3044
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  LODWORD(v35) = 16;
  P = v46;
  v9 = WmipPrepareForWnodeAD((_DWORD)v7, (unsigned int)&v42, (unsigned int)&v35, (unsigned int)&P, (__int64)&v32);
  if ( v9 < 0 )
    goto LABEL_40;
  if ( (_BYTE)v32 )
  {
  ...
  do
  {
    ...
    *(_OWORD *)(v14 + 6) = v16;
    ...
    if ( v23 )
      ...
      v24 = WmipSendWmiIrp(0LL, v22, (__int64)(v14 + 6), v17, (__int64)v14, &v42);
    v14[1] = 0;
    if ( v24 < 0 )
      goto LABEL_66;
    if ( (v14[11] & 0x20) != 0 )
