/*
 * XREFs of CmpCreateHwProfileFriendlyName @ 0x1405E81F0
 * Callers:
 ...
 *     KeGetBugMessageResourceEntry @ 0x1401C5CA0 (KeGetBugMessageResourceEntry.c)
...
__int64 __fastcall CmpCreateHwProfileFriendlyName(void *a1, char a2, unsigned int a3, UNICODE_STRING *a4)
{
  ...
  STRING SourceString; // [rsp+A8h] [rbp-58h] BYREF
