/*
 * XREFs of _CmEnumDevicesInContainerWithCallbackWorker @ 0x1406951E4
 * Callers:
...
__int64 __fastcall CmEnumDevicesInContainerWithCallbackWorker(
        ...
        __int64 a2,
        void *a3,
        __int64 (__fastcall *a4)(__int64 *, PVOID, __int64),
        __int64 a5,
        int a6)
{
    ...
    while ( 1 )
    {
      ...
      if ( v16 != -1073741789 )
      {
        ...
        for ( i = 0; ; ++i )
        {
          ...
          {
            a6 = 200;
            v20 = PnpCtxRegEnumValue(v18, Handle, i, PoolWithTag, (unsigned int *)&a6, &v23, 0LL, 0LL);
            v11 = v20;
            if ( v20 == -2147483622 )
            {
              v11 = 0;
