/*
 * XREFs of IoSetDevicePropertyData @ 0x14051C7A0
 * Callers:
 *     VerifierIoSetDevicePropertyData @ 0x1406C0854 (VerifierIoSetDevicePropertyData.c)
 * Callees:
        ...
        PVOID Data)
{
  ...
  if ( !DeviceNode || (DeviceNode[99] & 0x20000) != 0 )
  {
    ...
    if ( v14 )
    {
      ...
      IoAddTriageDumpDataBlock((int)v14, 712);
      if ( *v15 )
      {
