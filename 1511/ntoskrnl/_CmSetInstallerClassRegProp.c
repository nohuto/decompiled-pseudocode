/*
 * XREFs of _CmSetInstallerClassRegProp @ 0x140694708
 * Callers:
 *     PiCMSetRegistryProperty @ 0x1406140E8 (PiCMSetRegistryProperty.c)
 *     _CmSetInstallerClassMappedPropertyFromRegProp @ 0x14069925C (_CmSetInstallerClassMappedPropertyFromRegProp.c)
 * Callees:
        ...
        unsigned int a7)
{
  ...
  memset(&SecurityDescriptorLength[1], 0, 0x50uLL);
  v11 = *(__int64 (__fastcall **)(__int64, __int64, __int64, __int64, int, _QWORD *))(a1 + 320);
