/*
 * XREFs of CmSetAcpiHwProfile @ 0x14051CDBC
 * Callers:
        ...
        _BYTE *a5)
{
  ...
  HANDLE *v35; // [rsp+A8h] [rbp-58h]
  PVOID v36; // [rsp+B0h] [rbp-50h] BYREF
  unsigned int v37; // [rsp+B8h] [rbp-48h] BYREF
  HANDLE v38; // [rsp+C0h] [rbp-40h] BYREF
  ULONG ResultLength; // [rsp+C8h] [rbp-38h] BYREF
  HANDLE v40; // [rsp+D0h] [rbp-30h] BYREF
  ULONG Disposition; // [rsp+D8h] [rbp-28h] BYREF
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  {
    AcpiProfileInformation = CmpGetAcpiProfileInformation((int)KeyHandle, (int)&P, (int)&v36, v11, &KeyValueInformation);
    if ( AcpiProfileInformation < 0 )
    {
LABEL_53:
      v9 = P;
