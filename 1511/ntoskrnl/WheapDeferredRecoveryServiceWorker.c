/*
 * XREFs of WheapDeferredRecoveryServiceWorker @ 0x140216ED4
 * Callers:
 *     <none>
 * Callees:
...
__int64 WheapDeferredRecoveryServiceWorker()
{
  ...
  do
  {
    v0 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&WheapDispatchPtr.Dpc.DpcData);
    v1 = WheaPassiveDrsList;
    WheaPassiveDrsList = *(_QWORD *)WheaPassiveDrsList;
    KeReleaseSpinLock((PKSPIN_LOCK)&WheapDispatchPtr.Dpc.DpcData, v0);
