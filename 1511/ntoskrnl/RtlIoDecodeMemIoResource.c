/*
 * XREFs of RtlIoDecodeMemIoResource @ 0x1401361E8
 * Callers:
 *     IopGenericScoreRequirement @ 0x14052BF84 (IopGenericScoreRequirement.c)
 *     PnpFilterResourceRequirementsList @ 0x14052C73C (PnpFilterResourceRequirementsList.c)
 *     IopGenericUnpackRequirement @ 0x14052DD68 (IopGenericUnpackRequirement.c)
 * Callees:
 *     <none>
 */
