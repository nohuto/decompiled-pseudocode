/*
 * XREFs of PopTimeoutWakeTracking @ 0x14011A6EC
 * Callers:
 *     PopWakeSourceTimeoutWorker @ 0x1404F8AE8 (PopWakeSourceTimeoutWorker.c)
 * Callees:
...
void __fastcall PopTimeoutWakeTracking(_QWORD *a1)
{
  ...
  if ( a1 == (_QWORD *)PopCurrentWakeInfo )
  {
    ...
    {
      for ( i = qword_1402DECC8; (PVOID *)i != &PopWakeSourceWorkList; i = *(_QWORD *)(i + 8) )
      {
        if ( *(_QWORD **)(i + 24) == a1 )
        {
          *(_QWORD *)(i + 32) = &v5;
