/*
 * XREFs of PpmParkRecordNodeStatistics @ 0x1400761E0
 * Callers:
 *     PpmCheckRecordAllUtility @ 0x140075CB0 (PpmCheckRecordAllUtility.c)
 * Callees:
      ...
      if ( PpmEtwRegistered )
      {
        if ( PpmEtwHandle )
        {
          ...
          if ( (unsigned __int8)EtwpLevelKeywordEnabled(*(_QWORD *)(PpmEtwHandle + 32) + 80LL, v16, 2LL)
            || *(_BYTE *)(v21 + 100) && (unsigned __int8)EtwpLevelKeywordEnabled(*(_QWORD *)(v21 + 40) + 80LL, v18, v19) )
          {
