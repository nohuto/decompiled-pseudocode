/*
 * XREFs of PnprMapPhysicalPages @ 0x1403AFCD0
 * Callers:
 *     PnprMapTargetSparePhysicalPages @ 0x1403AFE94 (PnprMapTargetSparePhysicalPages.c)
 * Callees:
...
__int64 __fastcall PnprMapPhysicalPages(PMDL *a1, __int64 a2, unsigned __int64 *a3, _QWORD *a4)
{
  SIZE_T v4; // r10
  int v8; // eax
  int v9; // eax
