/*
 * XREFs of KiMcheckAbortShadow @ 0x140224880
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall KiMcheckAbortShadow(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        __int64 a4,
        ...
        __int64 a8)
{
  ...
  if ( v8 != KernelDirectoryTableBase && !_bittest(MK_FP(__GS__, 28696LL), 1u) )
    __writecr3(KernelDirectoryTableBase);
  return ((__int64 (__fastcall *)(__int64, __int64))KiMcheckAbort)(a1, a2);
}
