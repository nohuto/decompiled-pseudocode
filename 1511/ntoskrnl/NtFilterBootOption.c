...
LABEL_32:
              ...
              if ( *((_WORD *)qword_14031C950 + 18) )
              {
                while ( 1 )
                {
                  if ( *(_DWORD *)(qword_1403351C8 + 12LL * v11 + 4) == a3 )
                  {
                    v12 = *(_DWORD *)(qword_1403351C8 + 12LL * v11);
                    if ( !v12 || v12 == v6 )
                    {
                      v13 = *(_WORD *)(*(unsigned int *)(qword_1403351C8 + 12LL * v11 + 8) + qword_1403351D8);
                      if ( ((v13 & 0x20) == 0 || (dword_140306884 & 4) != 0)
                        && ((v13 & 0x40) == 0 || (dword_140306884 & 0x10) != 0) )
                      {
                        break;
                      }
                    }
                  }
                  if ( ++v11 >= *((unsigned __int16 *)qword_14031C950 + 18) )
                    goto LABEL_56;
                }
                v14 = 3LL * v11;
                if ( v7 == 1 )
                {
                  v16 = SepSecureBootValidateBcdDataAgainstBcdRule(qword_1403351C8 + 4 * v14, a4, v8);
                }
                else
                {
                  v16 = 0;
                  v15 = *(unsigned int *)(qword_1403351C8 + 4 * v14 + 8);
                  if ( (*(_BYTE *)(v15 + qword_1403351D8) & 0x1F) != 8 || *(_WORD *)(v15 + qword_1403351D8 + 2) )
                    v16 = -1069350910;
                }
              }
              goto LABEL_56;
