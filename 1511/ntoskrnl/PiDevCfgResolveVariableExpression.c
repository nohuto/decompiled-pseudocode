/*
 * XREFs of PiDevCfgResolveVariableExpression @ 0x14060AB00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiDevCfgResolveVariableExpression(__int64 a1, void *a2, __int64 a3)
{
  ...
  PVOID *v152; // rbx
  void *v153; // rcx
  unsigned __int16 v155; // [rsp+30h] [rbp-89h]
  unsigned int v156; // [rsp+34h] [rbp-85h]
  unsigned int v157; // [rsp+38h] [rbp-81h]
  int v158; // [rsp+48h] [rbp-71h]
  __int64 *P; // [rsp+50h] [rbp-69h]
  UNICODE_STRING *v160; // [rsp+60h] [rbp-59h] BYREF
  unsigned int v161; // [rsp+68h] [rbp-51h] BYREF
  PVOID v162; // [rsp+70h] [rbp-49h] BYREF
  UNICODE_STRING String2; // [rsp+78h] [rbp-41h] BYREF
  UNICODE_STRING String1; // [rsp+88h] [rbp-31h] BYREF
  unsigned int v165; // [rsp+98h] [rbp-21h]
  _WORD *v166; // [rsp+A0h] [rbp-19h]
  __int64 v167; // [rsp+A8h] [rbp-11h]
  __int64 v168; // [rsp+B0h] [rbp-9h]
  __int64 v169; // [rsp+B8h] [rbp-1h] BYREF
  __int64 v170; // [rsp+C0h] [rbp+7h]
  __int64 v171; // [rsp+C8h] [rbp+Fh]
...
LABEL_19:
      ...
      {
        v160 = 0LL;
        v18 = PiDevCfgResolveVariable(v168, v10, &v160);
        RegistryValue = v18;
        if ( v18 >= 0 )
        {
          v13[v3] = (__int64)v160;
...
LABEL_339:
      ...
      if ( (_DWORD)v3 == 1 )
      {
        RegistryValue = PiDevCfgCopyVariableData(v167, *v13);
        goto LABEL_343;
      }
      v5 = (PVOID *)P;
      RegistryValue = -1073741823;
