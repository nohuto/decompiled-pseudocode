/*
 * XREFs of PiAuCreateStandardSecurityObject @ 0x140769FCC
 * Callers:
...
__int64 __fastcall PiAuCreateStandardSecurityObject(PSID *a1)
{
  ...
  PVOID v21; // rax
  PVOID *v22; // r14
  ULONG BufferLength[2]; // [rsp+38h] [rbp-99h] BYREF
  __int64 v25; // [rsp+40h] [rbp-91h]
  _BYTE SecurityDescriptor[48]; // [rsp+48h] [rbp-89h] BYREF
  PVOID v27[16]; // [rsp+78h] [rbp-59h] BYREF
