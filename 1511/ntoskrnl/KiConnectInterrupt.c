/*
 * XREFs of KiConnectInterrupt @ 0x14012286C
 * Callers:
 ...
 *     KiInsertInterruptObjectOrdered @ 0x1401C9E08 (KiInsertInterruptObjectOrdered.c)
 */
...
__int64 __fastcall KiConnectInterrupt(__int64 a1)
{
  ...
  v8 = (__int64 (__fastcall *)())&KeGetPcr()->IdtBase[v1];
  v9 = *(_BYTE *)(a1 + 95) == 0;
  LOWORD(v17) = *(_WORD *)v8;
  ...
  if ( v9 )
  {
    ...
    v8 = (__int64 (__fastcall *)())((char *)v10 + 8 * v1);
    if ( v17 == v8 )
    {
