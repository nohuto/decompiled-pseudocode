/*
 * XREFs of KeBalanceSetManager @ 0x1401373C4
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ExpScanSystemLookasideList @ 0x1400D0110 (ExpScanSystemLookasideList.c)
...
void __noreturn KeBalanceSetManager()
{
  ...
  unsigned __int8 v17[112]; // [rsp+60h] [rbp-88h] BYREF
  ...
  Object[1] = (PVOID)(qword_140301330 + 104);
  while ( 1 )
  {
    while ( 1 )
    {
    ...
    HvlpEnterIumSecureMode(1u, 209, 0, v17);
