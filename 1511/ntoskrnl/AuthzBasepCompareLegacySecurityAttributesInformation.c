/*
 * XREFs of AuthzBasepCompareLegacySecurityAttributesInformation @ 0x1404C288C
 * Callers:
 ...
 *     AuthzBasepCompareSecurityAttribute @ 0x1403B4E90 (AuthzBasepCompareSecurityAttribute.c)
