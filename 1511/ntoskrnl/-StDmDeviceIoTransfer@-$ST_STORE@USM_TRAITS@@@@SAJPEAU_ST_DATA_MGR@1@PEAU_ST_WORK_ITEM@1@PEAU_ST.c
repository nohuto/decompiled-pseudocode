/*
 * XREFs of ?StDmDeviceIoTransfer@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_WORK_ITEM@1@PEAU_ST_DEVICE_IO@1@@Z @ 0x140204F78
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDmDeviceIoTransfer(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  while ( (unsigned __int64)v8 < v10 )
  {
    ...
    result = ST_STORE<SM_TRAITS>::StDmSinglePageTransfer(
               a1,
               *(_QWORD *)(a1 + 360),
               v11 + (unsigned int)(16 * (*v8 - *(_DWORD *)(a3 + 16))),
               a2 | ((unsigned __int64)*(unsigned int *)(a3 + 20) >> 4) & 1,
               v12,
               (__int64)v8,
               0LL);
    if ( (int)result < 0 )
