/*
 * XREFs of BiConvertNtDeviceToBootEnvironment @ 0x1404FDCF4
 * Callers:
...
LABEL_10:
  ...
  if ( !v12 )
  {
    ...
    if ( !(_DWORD)v41 )
      goto LABEL_10;
    Src = 0LL;
    PartitionDevice = BiConvertNtFilePathToBootEnvironment((char *)a1 + v41, a2 - (unsigned int)v41, a1 + 12, a3, &Src);
    if ( PartitionDevice < 0 )
      goto LABEL_7;
    v37 = (unsigned int *)Src;
    v42 = *((_DWORD *)Src + 1) + 20;
...
LABEL_39:
  ...
  if ( !v13 )
  {
    ...
    if ( !(_DWORD)v36 )
      goto LABEL_10;
    Src = 0LL;
    PartitionDevice = BiConvertNtFilePathToBootEnvironment((char *)a1 + v36, a2 - (unsigned int)v36, a1 + 12, 0LL, &Src);
    if ( PartitionDevice < 0 )
      goto LABEL_7;
    v37 = (unsigned int *)Src;
    v38 = *((_DWORD *)Src + 1) + 40;
      ...
      *((_DWORD *)v7 + 2) = v28;
      ...
      if ( P )
      {
        ...
        *((_DWORD *)v31 + 2) = v45 + v32;
        memmove(&v31[v45], P, *((unsigned int *)P + 2));
        *((_DWORD *)v7 + 6) = v29;
      }
      goto LABEL_6;
    }
...
LABEL_11:
  ...
  PartitionDevice = BiConvertNtDeviceToBootEnvironment(v18, v19, 0LL, &P);
  if ( PartitionDevice >= 0 )
  {
    v45 = 40;
    v17 = (unsigned int)(*((_DWORD *)P + 2) + 70);
