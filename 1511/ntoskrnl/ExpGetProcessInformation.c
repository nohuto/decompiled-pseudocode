...
__int64 __fastcall ExpGetProcessInformation(__int64 a1, UINT a2, UINT *a3, _DWORD *a4, int a5)
{
  ...
  UINT uAddend[2]; // [rsp+B8h] [rbp-3A0h] BYREF
  UINT v101[2]; // [rsp+C0h] [rbp-398h] BYREF
  ...
  _BYTE v120[144]; // [rsp+280h] [rbp-1D8h] BYREF
  _BYTE v121[256]; // [rsp+310h] [rbp-148h] BYREF

  v111 = a1;
  v90 = a3;
  *(_QWORD *)v101 = 130LL;
  v83 = 0;
  *(_QWORD *)uAddend = 254LL;
  v84 = 0LL;
  v78 = 0;
  Object = 0LL;
  uAugend = 0;
...
LABEL_11:
      if ( !v6 )
      {
        if ( v78 >= 0 && v89 && (*(_DWORD *)v89 = 0, PackageIdentity < 0) )
        {
          v78 = PackageIdentity;
        }
        else if ( v90 )
...
LABEL_238:
                ...
                if ( *(_QWORD *)uAddend )
                {
                  if ( *(_QWORD *)uAddend > 0xFFFFFFFFuLL )
                  {
                    v78 = -1073741820;
                    goto LABEL_238;
                  }
                  v87 = uAddend[0];
                  v72 = RtlUIntAdd(v9, uAddend[0], &uAugend);
                  v10 = v72;
                  PackageIdentity = v72;
                  if ( v72 < 0 )
                  {
                ...
                if ( *(_QWORD *)v101 )
                {
                  if ( *(_QWORD *)v101 > 0xFFFFFFFFuLL )
                  {
                    v78 = -1073741820;
                    goto LABEL_238;
                  }
                  v87 = v101[0];
                  v73 = RtlUIntAdd(v9, v101[0], &uAugend);
                  v10 = v73;
                  PackageIdentity = v73;
                  if ( v73 < 0 )
                  {
