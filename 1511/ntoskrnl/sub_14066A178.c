/*
 * XREFs of sub_14066A178 @ 0x14066A178
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_14066A178(_DWORD *a1, _DWORD *a2, unsigned int a3, _DWORD *a4, _BYTE *a5)
{
  int v9; // ebx
  int v10; // eax
...
LABEL_21:
  ...
  {
    *a5 = 1;
    return (unsigned int)sub_1405174E0(a1, a2, a3, a4, 0);
  }
  else
  {
    v23 = -1073741772;
