/*
 * XREFs of KsepMatchInitBiosInfo @ 0x14076CB4C
 * Callers:
...
__int64 KsepMatchInitBiosInfo()
{
  ...
  KeyHandle = 0LL;
  memset(&qword_14031BAC0, 0, 0x38uLL);
  v0 = -1;
  ...
  if ( v1 >= 0 )
  {
    ...
    if ( MULTISZ >= 0 )
    {
      ...
      MULTISZ = KsepRegistryQueryMULTISZ(KeyHandle, L"SystemBiosVersion", (__int64)&unk_140306400, 520LL, (__int64)&v15);
      word_140306606 = 0;
      v5 = 0LL;
      v6 = &unk_140306400;
      while ( *v6 != 32 )
...
LABEL_11:
  ...
  {
    qword_14031BAC0 = (__int64)&unk_140306400;
    dword_14031BAE8 = v0;
  }
