/*
 * XREFs of RaspGetXExtent @ 0x140137618
 * Callers:
 *     BcpGetCharacterMaxResourceProfile @ 0x140137EF0 (BcpGetCharacterMaxResourceProfile.c)
 ...
 *     RaspGetCacheEntry @ 0x14011E8AC (RaspGetCacheEntry.c)
...
__int64 __fastcall RaspGetXExtent(unsigned __int16 a1, __int64 a2, _DWORD *a3, __int64 a4, int a5, __int64 a6)
{
  ...
  if ( a1 >= 0x20u )
  {
    v14 = *(_DWORD *)(a2 + 16);
    a6 = *(_QWORD *)(a2 + 8);
    RaspGetCacheEntry(&RaspBitmapCache, a1, v14, *(_DWORD *)(a6 + 40), a6, &v22);
    Memory = v22;
    if ( v22 )
    {
LABEL_3:
