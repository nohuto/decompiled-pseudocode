/*
 * XREFs of RtlCreateInvertedFunctionTableCacheEntry @ 0x14074BEE8
 * Callers:
...
void __fastcall RtlCreateInvertedFunctionTableCacheEntry(ULONG_PTR a1, int a2)
{
  ...
  {
    v7 = *(_OWORD *)&xmmword_1402CFDD0;
    v8 = qword_1402CFDE0;
    v5 = (PVOID)xmmword_1402CFDD0;
  }
  else
  {
  ...
  *(&xmmword_1402CFDD0 + 1) = v6;
  xmmword_1402CFDD0 = (ULONG_PTR)v5;
  LODWORD(qword_1402CFDE0) = a2;
  HIDWORD(qword_1402CFDE0) = v3;
