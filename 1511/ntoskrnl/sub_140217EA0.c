/*
 * XREFs of sub_140217EA0 @ 0x140217EA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PsQueryThreadTerminationPort @ 0x1403B4228 (PsQueryThreadTerminationPort.c)
 *     KeRundownApcQueues @ 0x1403EFBC4 (KeRundownApcQueues.c)
 */

void __fastcall __noreturn sub_140217EA0(__int64 a1)
{
