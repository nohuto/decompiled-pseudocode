/*
 * XREFs of PfSnDeactivateTrace @ 0x1400FA91C
 * Callers:
...
LABEL_9:
  ...
  v9 = KeAcquireSpinLockRaiseToDpc(&qword_1403058D0);
  KeReleaseSpinLock(&qword_1403058D0, v9);
  ExReleaseRundownProtection_0(a1 + 45);
  PfSnCancelTraceTimer(a1);
  ExWaitForRundownProtectionRelease(a1 + 45);
  v10 = KeAcquireSpinLockRaiseToDpc(&qword_1403058D0);
  Count = a1[1].Count;
  ...
  *(_QWORD *)(Count + 8) = v12;
  KeReleaseSpinLock(&qword_1403058D0, v10);
  return 0LL;
}
