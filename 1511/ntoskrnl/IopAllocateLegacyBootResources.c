/*
 * XREFs of IopAllocateLegacyBootResources @ 0x140760FA8
 * Callers:
  ...
  if ( IopInitHalDeviceNode )
  {
    if ( IopInitHalResources )
    {
      ...
      if ( v4 )
      {
        ...
        IopAllocateBootResources(1u, *(_QWORD *)(IopInitHalDeviceNode + 32), (__int64)v4);
...
LABEL_5:
  ...
  while ( v6 )
  {
    ...
    {
      IopAllocateBootResources(4u, v6[1], v6[2]);
      if ( !v6[1] )
