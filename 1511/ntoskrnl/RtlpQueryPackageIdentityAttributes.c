/*
 * XREFs of RtlpQueryPackageIdentityAttributes @ 0x1400FB2E4
 * Callers:
...
__int64 __fastcall RtlpQueryPackageIdentityAttributes(int a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( a4 )
    v7 = 2;
  LODWORD(v11) = 672;
  result = SeQuerySecurityAttributesToken(a1, (int)&dword_14023EA50, v7, (void *)a3, v11, (__int64)&v13);
  if ( (int)result < 0 )
  {
    ...
    if ( v7 == 1 )
      return result;
    LODWORD(v12) = 672;
    result = SeQuerySecurityAttributesToken(a1, (int)&dword_14023EA50, 1, (void *)a3, v12, (__int64)&v13);
    if ( (int)result < 0 )
      return result;
    v4 = 0;
  }
