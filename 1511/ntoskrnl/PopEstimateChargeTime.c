/*
 * XREFs of PopEstimateChargeTime @ 0x14063727C
 * Callers:
...
unsigned __int64 PopEstimateChargeTime()
{
  ...
  {
    for ( i = qword_1402DE3F0; (__int64 *)i != &qword_1402DE3F0; i = *(_QWORD *)i )
    {
      v8 = *(_DWORD *)(i + 64);
      v9 = *(_DWORD *)(i + 88);
      if ( v8 != -1 && v9 != -1 && v9 < v8 )
  ...
  if ( pCallbackContext.LevelPlus1 > 5 && TlgKeywordOn(&pCallbackContext, 0x400000000000uLL) )
  {
    ...
    v32 = 8;
    v35 = 4;
    TlgWrite(&pCallbackContext, &unk_14025487A, 0LL, 0LL, 8u, &pData);
  }
  return v0;
}
