/*
 * XREFs of DrvDbSetDeviceIdDriverInfMatches @ 0x14069B588
 * Callers:
...
__int64 __fastcall DrvDbSetDeviceIdDriverInfMatches(__int64 a1, void *a2, const wchar_t *a3, __int64 a4)
{
  ...
  v5 = a2;
  v33 = 0;
  v6 = PnpCtxRegQueryInfoKey(a1, a2, 0LL, a4, &v39, &MaxCount);
  if ( v6 >= 0 )
  {
    v7 = MaxCount + 1;
    if ( v4 )
    {
      ...
      if ( v39 )
      {
        ...
        {
          MaxCount = v7;
          v16 = PnpCtxRegEnumValue(v13, v5, v15, PoolWithTag, &MaxCount, &v33, 0LL, 0LL);
          v6 = v16;
          if ( v16 < 0 )
            break;
          if ( v33 == 3 || !v33 )
...
LABEL_37:
      if ( v6 >= 0 )
      {
        while ( *v4 )
        {
          v6 = DrvDbSplitDeviceIdDriverInfMatch(v4, (NTSTRSAFE_PWSTR)PoolWithTag, v7, (__int64)v34);
          if ( v6 < 0 )
            break;
          v24 = v34[0]
    ...
    else
    {
      ...
      if ( v26 )
      {
        ...
        {
          MaxCount = v7;
          v29 = PnpCtxRegEnumValue(v27, v5, v28, PoolWithTag, &MaxCount, 0LL, 0LL, 0LL);
          v6 = v29;
          if ( v29 < 0 )
            break;
