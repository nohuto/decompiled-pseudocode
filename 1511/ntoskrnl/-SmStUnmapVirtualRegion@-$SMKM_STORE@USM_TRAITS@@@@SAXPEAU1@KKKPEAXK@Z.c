/*
 * XREFs of ?SmStUnmapVirtualRegion@?$SMKM_STORE@USM_TRAITS@@@@SAXPEAU1@KKKPEAXK@Z @ 0x140110A14
 * Callers:
 ...
 *     ?SmStFindVirtualLockedRegion@?$SMKM_STORE@USM_TRAITS@@@@SAPEAU_SM_VIRTUAL_LOCKED_REGION@@PEAU1@KPEAX@Z @ 0x140110B1C (-SmStFindVirtualLockedRegion@-$SMKM_STORE@USM_TRAITS@@@@SAPEAU_SM_VIRTUAL_LOCKED_REGION@@PEAU1@K.c)
 */
        ...
        unsigned int a6)
{
  ...
  if ( (a6 & 4) != 0 )
  {
    ...
    SmKmUnlockMdl(*VirtualLockedRegion, *(_QWORD *)(a1 + 4928), a1 + 4816);
    SmFpFree(*(_QWORD *)(a1 + 4928), 2, a1 + 4816, *VirtualLockedRegion);
