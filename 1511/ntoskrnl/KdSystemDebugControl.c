/*
 * XREFs of KdSystemDebugControl @ 0x1406196A8
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KdpSysGetVersion @ 0x1406AA434 (KdpSysGetVersion.c)
 *     KdpSysCheckLowMemory @ 0x1406AC788 (KdpSysCheckLowMemory.c)
 *     KdpSysReadBusData @ 0x1406AC7A4 (KdpSysReadBusData.c)
        ...
        KPROCESSOR_MODE a7)
{
  ...
  if ( a1 > 14 )
  {
    ...
    if ( !v19 )
    {
      ...
      v37 = *a2;
      v38 = a2[1];
      v26 = _mm_cvtsi128_si32(v38);
      if ( v26 )
      {
        v15 = ExLockUserBuffer(v37.m128i_u64[1], v26, a7, IoReadAccess, &v27[1], &v28);
        if ( v15 >= 0 )
        {
    ...
    if ( !v22 )
    {
      ...
      v39 = *a2;
      v40 = a2[1];
      v25 = _mm_cvtsi128_si32(v40);
      if ( v25 )
      {
        v15 = ExLockUserBuffer(v39.m128i_u64[1], v25, a7, IoWriteAccess, &v27[1], &v28);
        if ( v15 >= 0 )
        {
  ...
  if ( !v9 )
  {
    ...
    if ( (_DWORD)v44 )
    {
      ...
      if ( v15 >= 0 )
      {
        Msr = KdpCopyMemoryChunks((PVOID)v43.m128i_i64[0], 0, (__int64)v27);
        goto LABEL_83;
      }
      goto LABEL_84;
    }
  ...
  if ( !v11 )
  {
    ...
    if ( (_DWORD)v48 )
    {
      ...
      if ( v15 >= 0 )
      {
        Msr = KdpCopyMemoryChunks((PVOID)v47.m128i_i64[0], 2, (__int64)v27);
        goto LABEL_83;
      }
      goto LABEL_84;
    }
