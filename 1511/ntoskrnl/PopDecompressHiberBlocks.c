/*
 * XREFs of PopDecompressHiberBlocks @ 0x1403A2574
 * Callers:
 *     PopRestoreHiberContext @ 0x1403A2150 (PopRestoreHiberContext.c)
 * Callees:
 *     RtlDecompressBufferProgress @ 0x14011906C (RtlDecompressBufferProgress.c)
 ...
 *     PopReadProducerConsumerBuffer @ 0x1403A29E0 (PopReadProducerConsumerBuffer.c)
        ...
        void (__fastcall *a5)(_DWORD *))
{
  ...
  v5 = 0;
  v6 = (int)qword_1402DE378;
  v47 = a5;
  v48 = 0LL;
  v44 = (char *)qword_1402DE378;
  v43 = 0;
  while ( 1 )
  {
    PopHiberCheckForDebugBreak();
    if ( !qword_1402DE788 && BugCheckParameter3[48] == KeGetCurrentPrcb()->Number && byte_1402DE320 )
      qword_1402DE788 = KeQueryPerformanceCounter(0LL).QuadPart;
    Number = KeGetCurrentPrcb()->Number;
    if ( BugCheckParameter3[48] == (_DWORD)Number
      && !byte_1402DE321
      && ((unsigned int)dword_1402DE304 > 0x640 || !byte_1402DE320) )
    {
      v37 = __rdtsc();
      if ( byte_140305B50 )
      {
      ...
      v38 = __rdtsc();
      qword_1402DE770 += (((unsigned __int64)HIDWORD(v38) << 32) | (unsigned int)v38) - v37;
    }
    v42 = 4;
    ...
    if ( !v12 )
      break;
    ProducerConsumerBuffer = (_DWORD *)PopReadProducerConsumerBuffer(v12, 4, (unsigned int)&v50, v6, (__int64)a2, 1);
    ...
    v55 = 0LL;
    v57 = 0;
    MmMapMemoryDumpMdlEx(v25, v16, (__int64)&v51, 1LL);
    v26 = (*v19 >> 8) & 0x3FFFFF;
    v27 = __rdtsc();
    if ( v26 == (_DWORD)v24 )
    {
