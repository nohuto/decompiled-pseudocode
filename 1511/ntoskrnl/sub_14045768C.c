/*
 * XREFs of sub_14045768C @ 0x14045768C
 * Callers:
 *     sub_14045751C @ 0x14045751C (sub_14045751C.c)
 *     sub_1404960C8 @ 0x1404960C8 (sub_1404960C8.c)
 * Callees:
...
__int64 __fastcall sub_14045768C(unsigned __int16 *a1, __int128 *a2, __int64 a3)
{
  char v3; // bp
  char *v7; // rdi
  __int128 v8; // xmm0
  ...
  v12 = sub_1404577BC(a3, v14, v7, v9);
  if ( v7 )
