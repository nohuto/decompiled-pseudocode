/*
 * XREFs of SepMakeLogonSessionsSiblings @ 0x1406543DC
 * Callers:
...
__int64 __fastcall SepMakeLogonSessionsSiblings(_DWORD *a1, _DWORD *a2)
{
  ...
  v15 = *v9;
  v16 = 0;
  while ( v15 && (!PsEqualCurrentServerSilo(v15[20]) || *a1 != *((_DWORD *)v15 + 2) || a1[1] != *((_DWORD *)v15 + 3)) )
    v15 = (__int64 *)*v15;
  for ( i = *v8;
        i && (!PsEqualCurrentServerSilo(i[20]) || *a2 != *((_DWORD *)i + 2) || a2[1] != *((_DWORD *)i + 3));
        i = (__int64 *)*i )
  {
    ;
  }
