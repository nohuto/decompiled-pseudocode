/*
 * XREFs of WdipSemLoadNextScenario @ 0x140533420
 * Callers:
...
__int64 __fastcall WdipSemLoadNextScenario(HANDLE KeyHandle, ULONG Index, GUID *Guid)
{
  ...
  WCHAR v40[64]; // [rsp+110h] [rbp+10h] BYREF
  WCHAR SourceString[64]; // [rsp+190h] [rbp+90h] BYREF
...
LABEL_11:
    ...
    if ( v8 >= 0 )
    {
      v16 = WdipSemQueryValueFromRegistry(Handle, &v32, (__int64)&ResultLength);
      v8 = v16;
      if ( v16 < 0 )
      {
        if ( v16 != -1073741772 )
      ...
      v20 = WdipSemQueryValueFromRegistry(Handle, &v33, (__int64)&ResultLength);
      v8 = v20;
      if ( v20 >= 0 )
      {
        *(_DWORD *)&Guid[2].Data2 = v33;
        goto LABEL_35;
      }
      if ( v20 == -1073741772 )
      {
...
LABEL_68:
        ...
        if ( !v7 )
        {
          ...
          while ( 1 )
          {
            ...
            memset(v6, 0, 0x30uLL);
            NextContextProvider = WdipSemLoadNextContextProvider(v35, v25++, v6);
