/*
 * XREFs of IoRegisterDeviceInterface @ 0x14050927C
 * Callers:
 *     PiSwCompleteCreate @ 0x1404E4050 (PiSwCompleteCreate.c)
 *     VerifierIoRegisterDeviceInterface @ 0x1406C07E4 (VerifierIoRegisterDeviceInterface.c)
 * Callees:
 *     RtlInitUnicodeStringEx @ 0x14008FB20 (RtlInitUnicodeStringEx.c)
 *     wcspbrk @ 0x140146488 (wcspbrk.c)
