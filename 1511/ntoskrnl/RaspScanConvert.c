/*
 * XREFs of RaspScanConvert @ 0x14011CDB0
 * Callers:
 *     RaspRasterize @ 0x14011DD98 (RaspRasterize.c)
 * Callees:
 *     RaspTestIntersection @ 0x14011D1D0 (RaspTestIntersection.c)
 *     BgpFmRoundUp @ 0x14011D598 (BgpFmRoundUp.c)
 *     BgpFmRoundDefault @ 0x14011D5B0 (BgpFmRoundDefault.c)
        ...
        __int64 a8)
{
  ...
  if ( v11 )
  {
    v26 = qword_14072BA80;
    v52 = qword_14072BA80;
    SegmentList = BgpGxInitializeRectangle(v53, 1LL, qword_14072BA80, 3140LL);
    if ( SegmentList < 0 )
      goto LABEL_28;
  }
  else
