/*
 * XREFs of _winput_s @ 0x14014C6F4
 * Callers:
 ...
 *     sub_14014C5F8 @ 0x14014C5F8 (sub_14014C5F8.c)
...
LABEL_178:
          ...
          {
            v53 = sub_14014C224(v38, 0LL, (wint_t *)&v57, &v59, (void **)v72, v15, File, Src, &v67);
          }
          LOWORD(v5) = v57;
          if ( v53 )
            goto LABEL_204;
