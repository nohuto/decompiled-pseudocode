/*
 * XREFs of BiAddBootEntryToEfiBootManagerDisplayOrder @ 0x14068EC74
 * Callers:
...
__int64 __fastcall BiAddBootEntryToEfiBootManagerDisplayOrder(__int64 a1, __int64 a2)
{
  ...
  Src = 0LL;
  Handle[0] = 0LL;
  v3 = BcdOpenObject(a1, (__int128 *)&GUID_FIRMWARE_BOOTMGR, Handle);
  if ( v3 < 0 )
    goto LABEL_17;
...
LABEL_11:
      ...
      if ( PoolWithTag )
      {
        ...
        *PoolWithTag = *(_OWORD *)(a2 + 16);
        ...
        v3 = BcdSetElementDataWithFlags((__int64)Handle[0], 0x24000001u, v12, (__int64)v10, v5 + 16);
