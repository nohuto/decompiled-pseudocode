/*
 * XREFs of MiCheckHintedPageFileSpace @ 0x1400F5524
 * Callers:
...
__int64 __fastcall MiCheckHintedPageFileSpace(__int64 a1, unsigned int a2, unsigned int a3, char a4)
{
  ...
  if ( _bittest64(*(const signed __int64 **)(v6 + 16), v4) )
    return 0LL;
  v9 = RtlLengthCurrentClearRunForward((int *)(v6 + 24), v4, a3);
  if ( v9 != a3 && (a4 & 0x40) == 0 )
    return 0LL;
  result = RtlLengthCurrentClearRunForward((int *)(*(_QWORD *)(a1 + 112) + 8LL), v4, v9);
