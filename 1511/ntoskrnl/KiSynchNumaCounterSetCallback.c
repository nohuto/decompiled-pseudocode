/*
 * XREFs of KiSynchNumaCounterSetCallback @ 0x14061A56C
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiAddSynchCounters @ 0x14054F6AC (KiAddSynchCounters.c)
...
int __fastcall KiSynchNumaCounterSetCallback(int a1, __int64 a2)
{
  ...
  struct _PCW_DATA v16; // [rsp+38h] [rbp-C8h] BYREF
  ...
  for ( i = KeNumberNodes != 0; i; i = v5 < v4 )
  {
    ...
    if ( v8 )
    {
      ...
      {
        v11 = (const void *)(KiProcessorBlock[Id] + 24960);
        KiAddSynchCounters(v22, (__int64)v11);
        KiAddSynchCounters(v21, v12);
        LODWORD(Data) = v10;
