/*
 * XREFs of PopSqmThermalCriticalEvent @ 0x14063E108
 * Callers:
...
char __fastcall PopSqmThermalCriticalEvent(__int64 a1, unsigned int a2, int a3)
{
  ...
  bool v17; // [rsp+31h] [rbp-88h] BYREF
  char v18; // [rsp+32h] [rbp-87h] BYREF
  ...
  if ( DeviceNode )
  {
    DeviceAttachmentBaseRef = *(PDEVICE_OBJECT *)(a1 + 832);
    if ( pCallbackContext.LevelPlus1 > 5 )
    {
      ...
      if ( (_BYTE)DeviceAttachmentBaseRef )
      {
        ...
        LOBYTE(DeviceAttachmentBaseRef) = TlgWrite(&pCallbackContext, &unk_140254E31, 0LL, 0LL, 0xBu, &pData);
      }
    }
  }
  if ( v7 )
