/*
 * XREFs of MiUnlockAllMemoryLists @ 0x1401181CC
 * Callers:
...
__int64 MiUnlockAllMemoryLists()
{
  ...
  while ( 2 )
  {
    ...
    v2 = v0 < qword_1402FEC08->SizeOfBitMap ? v0 : 0;
    v3 = qword_1402FEC08->SizeOfBitMap - 1;
...
LABEL_22:
      if ( !v2 )
        goto LABEL_13;
      SizeOfBitMap = v0 + 1;
      if ( v0 + 1 > qword_1402FEC08->SizeOfBitMap )
...
LABEL_13:
    ...
    {
      v0 = v10 + 1;
      v11 = *(_QWORD *)(qword_1402FEC28 + 8 * v10);
      if ( (*(_DWORD *)(v11 + 4) & 4) != 0 )
      {
        v12 = *(_QWORD *)(v11 + 4936);
        v13 = 0;
        ...
        for ( i = (unsigned __int16)KeNumberNodes;
              v13 < (unsigned int)(unsigned __int16)KeNumberNodes + 2 * dword_1402FE70C + 27;
