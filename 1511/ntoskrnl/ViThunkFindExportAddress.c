/*
 * XREFs of ViThunkFindExportAddress @ 0x14074AC34
 * Callers:
 *     ViThunkFindAllExportAddresses @ 0x14074ABC8 (ViThunkFindAllExportAddresses.c)
 * Callees:
 *     RtlImageDirectoryEntryToData @ 0x140035E48 (RtlImageDirectoryEntryToData.c)
 *     ViThunkIsExportAddressShared @ 0x14074AD50 (ViThunkIsExportAddressShared.c)
 */
