/*
 * XREFs of VerifierExInitializeLookasideListEx @ 0x1406C88A8
 * Callers:
 *     <none>
 * Callees:
 *     XdvExInitializeLookasideListExInternal @ 0x14020B940 (XdvExInitializeLookasideListExInternal.c)
        ...
        __int16 a8)
{
  ...
  if ( v13 >= 0 )
  {
    if ( (IsEnabled || KernelVerifier)
      && (PVOID (__stdcall *)(POOL_TYPE, SIZE_T, ULONG))a1[6] == ExAllocatePoolEx
