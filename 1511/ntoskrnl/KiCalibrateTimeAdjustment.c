/*
 * XREFs of KiCalibrateTimeAdjustment @ 0x14039FC48
 * Callers:
 *     <none>
 * Callees:
 ...
 *     KiPollFreezeExecution @ 0x1400F3EAC (KiPollFreezeExecution.c)
 *     KeRebaselineInterruptTime @ 0x140118D34 (KeRebaselineInterruptTime.c)
 *     RtlEnlargedUnsignedDivide @ 0x140118D58 (RtlEnlargedUnsignedDivide.c)
...
ULONG_PTR __fastcall KiCalibrateTimeAdjustment(ULONG_PTR Argument)
{
  ...
  LARGE_INTEGER v22; // [rsp+50h] [rbp-48h] BYREF
  ...
  if ( CurrentPrcb->Number == *(_DWORD *)(Argument + 4) )
  {
    ...
    MEMORY[0xFFFFF78000000328] = HIDWORD(v23);
  ...
  if ( *(_BYTE *)Argument )
  {
    ...
    if ( (xmmword_140382290 & 0x8000) != 0 )
    {
      ...
      v25 = 8;
      v24 = &v22;
      result = EtwTraceKernelEvent((int)&v24, 1, 0x80008000, 0x1232u, 4200450);
    }
  }
