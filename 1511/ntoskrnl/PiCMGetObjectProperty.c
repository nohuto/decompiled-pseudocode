/*
 * XREFs of PiCMGetObjectProperty @ 0x14043A998
 * Callers:
...
__int64 __fastcall PiCMGetObjectProperty(ULONG64 a1, unsigned int a2, __int64 a3, unsigned int a4, int a5, _DWORD *a6)
{
  _DWORD *v6; // rdi
