/*
 * XREFs of PfpVolumeOpenAndVerify @ 0x1404BB8EC
 * Callers:
 *     PfpPrefetchRequestPerform @ 0x1404DC998 (PfpPrefetchRequestPerform.c)
 * Callees:
 *     PfVolumeSupportedForPrefetch @ 0x1400EEDFC (PfVolumeSupportedForPrefetch.c)
  ...
  if ( v7 >= 0 )
  {
    ...
    if ( (DevicePowerState & 0xC0000000) != 0xC0000000 )
    {
      if ( DevicePowerState == 259 )
        KeBugCheckEx(0x191u, 0x130EuLL, 0LL, 0LL, 0LL);
