/*
 * XREFs of PpmCheckComputeHeteroResponse @ 0x1401F3220
 * Callers:
 *     <none>
 * Callees:
 *     PpmParkCalculateUnparkCount @ 0x1400764E0 (PpmParkCalculateUnparkCount.c)
 ...
 *     PpmHeteroUtilityGreaterThanOrEqualThreshold @ 0x1401F3658 (PpmHeteroUtilityGreaterThanOrEqualThreshold.c)
 */
...
LABEL_23:
    ...
    {
      if ( v22 < *((unsigned __int8 *)v28 + 103) )
      {
LABEL_36:
        v4[114] |= 6u;
        if ( !v4[107] )
        ...
        LODWORD(v26) = v23;
        LOBYTE(v25) = v19;
        PpmEventTraceHeteroResponse((__int64)v4, (__int64)Base, v33, NumOfElements, v25, v26);
        v0 = PpmParkNumNodes;
        goto LABEL_42;
      }
      v3 |= 0x20u;
    ...
    {
      if ( v21 != 1 || v22 < *((unsigned __int8 *)v28 + 102) )
        goto LABEL_36;
      v3 |= 0x40u;
    }
    v4[107] = v19;
