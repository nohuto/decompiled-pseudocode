/*
 * XREFs of RtlCreateAtomTableEx @ 0x14009A2A8
 * Callers:
 *     RtlCreateAtomTable @ 0x140460C3C (RtlCreateAtomTable.c)
 * Callees:
 *     memset @ 0x140166CC0 (memset.c)
 *     RtlpFreeAtom @ 0x1404603BC (RtlpFreeAtom.c)
 *     RtlpInitializeLockAtomTable @ 0x140460B18 (RtlpInitializeLockAtomTable.c)
