/*
 * XREFs of PpmParkDistributeUtility @ 0x140076840
 * Callers:
...
char PpmParkDistributeUtility()
{
  ...
  int v40; // [rsp+90h] [rbp+28h]

  v38 = LOBYTE(PpmCurrentProfile[174 * dword_1402DE28C + 14]) != 0;
  v0 = PpmParkNumNodes;
  v1 = 0LL;
  v40 = 0;
  if ( !PpmParkNumNodes )
...
LABEL_46:
    ...
    if ( v4 <= 1 )
      v4 = 1;
    v15 = v4;
    if ( (unsigned __int8)v2[110] < v4 )
      v15 = (unsigned __int8)v2[110];
    if ( v15 <= 1 )
      v15 = 1;
    if ( v4 == 8 )
      v16 = v5 >> 3;
    ...
    while ( 1 )
    {
      ...
      if ( !v19 )
        break;
LABEL_22:
      _BitScanForward64(&v22, v19);
      v20 = v17;
      v36 = v19 & ~(1LL << v22);
      v39 = KiProcessorNumberToIndexMappingTable[64 * v17 + (unsigned __int8)v22];
      if ( v39 >= (unsigned int)KeNumberProcessors_0 )
        v23 = 0LL;
      else
        v23 = KiProcessorBlock[v39];
      v24 = *(_DWORD *)(v23 + 24236);
      if ( v16 <= v24 )
      {
        v6 ^= *(_QWORD *)(v23 + 1608);
        if ( v18 <= v24 )
        {
          ...
          v33 = v18;
          v17 = v37;
          if ( *(_DWORD *)(v23 + 24240) > v18 )
            v33 = *(_DWORD *)(v23 + 24240);
          v19 = v36;
          *(_DWORD *)(v23 + 24236) = v33;
        }
        else
        {
          v17 = v37;
          v19 = v36;
          *(_DWORD *)(v23 + 24236) = v18;
        }
      }
      else
      {
