/*
 * XREFs of KeMarkHiberPhase @ 0x14039F518
 * Callers:
...
void __fastcall KeMarkHiberPhase(_QWORD *Address)
{
  ...
  if ( *(_DWORD *)(v1 + 36) )
  {
    PoSetHiberRange(
      ...
      0x10000u,
      Address,
      ((((((_DWORD)KeNumberProcessors_0 << 6) + 32831) & 0xFFFFFFC0) + 31936) & 0xFFFFF000) + 20480,
      0x6370654Bu);
  }
  else
  {
  ...
  if ( qword_1402E2678 )
    PoSetHiberRange(0LL, 0x10000u, qword_1402E2678, 16 * (unsigned int)(unsigned __int8)qword_1402E2668, 0x7272744Du);
  if ( qword_1402E2680 )
    PoSetHiberRange(0LL, 0x10000u, qword_1402E2680, 0x58uLL, 0x7272744Du);
  v8 = *(_QWORD **)(v1 + 8);
