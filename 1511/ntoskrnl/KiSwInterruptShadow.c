/*
 * XREFs of KiSwInterruptShadow @ 0x140224A80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall KiSwInterruptShadow(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
