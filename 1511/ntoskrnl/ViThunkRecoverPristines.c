/*
 * XREFs of ViThunkRecoverPristines @ 0x1406C392C
 * Callers:
 *     VfThunkAddSpecialDriverThunks @ 0x1406C3140 (VfThunkAddSpecialDriverThunks.c)
 * Callees:
 *     ViThunkReplacePristine @ 0x1406C3CD4 (ViThunkReplacePristine.c)
 *     ViThunkReplaceSpecialPristine @ 0x1406C3D3C (ViThunkReplaceSpecialPristine.c)
 */
