/*
 * XREFs of ViAllocateMapRegistersFromFile @ 0x1406BC964
 * Callers:
 ...
 *     ViTagBuffer @ 0x1406BE69C (ViTagBuffer.c)
 */
        ...
        _DWORD *a5)
{
      ...
      do
      {
        ...
        if ( *v14 && v17 >= v9 && v17 < (unsigned __int64)v16 )
        {
          ViHalPreprocessOptions(
            ...
            (const void *)v9,
            v16);
          VfReportIssueWithOptions(230, 29, v9, (int)v16, *v14, byte_1402D4004);
        }
        v14 += 4;
      }
      while ( v14 < v15 );
  ...
  if ( (_DWORD)v12 )
  {
    ...
    ViHalPreprocessOptions(byte_1402D4008, "Map registers needed: %x available: %x", 0x10000000, 2);
    VfReportIssueWithOptions(230, 0, 2, v12, v11, byte_1402D4008);
  }
  else
  {
LABEL_17:
    ...
    if ( (_DWORD)v12 )
    {
      ...
      do
      {
        ...
        *((_DWORD *)v19 + 3) = 2 - (v21 != 0);
        ...
        ViTagBuffer(v19[2] + (v9 & 0xFFF) + 4096, *((unsigned int *)v19 + 2), 3LL);
