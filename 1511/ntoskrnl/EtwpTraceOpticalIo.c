/*
 * XREFs of EtwpTraceOpticalIo @ 0x14020F4BC
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall EtwpTraceOpticalIo(int a1, int a2, __int64 a3, __int64 a4)
{
  ...
  IO_STATUS_BLOCK *v30; // [rsp+40h] [rbp-19h]
...
LABEL_5:
    ...
    case 0xE:
      ...
      if ( ScsiPassThroughCdb )
      {
        ...
        ScsiPassThroughCdb = (IO_STATUS_BLOCK *)((BYTE5(ScsiPassThroughCdb->Pointer) | (unsigned __int64)((BYTE4(ScsiPassThroughCdb->Pointer) | ((BYTE3(ScsiPassThroughCdb->Pointer) | (BYTE2(ScsiPassThroughCdb->Pointer) << 8)) << 8)) << 8)) << 11);
        if ( ((Status - 40) & 0x7F) != 0 )
        {
          if ( ((Status - 42) & 0x7F) != 0 )
          {
