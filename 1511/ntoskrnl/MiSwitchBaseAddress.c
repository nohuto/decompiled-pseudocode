/*
 * XREFs of MiSwitchBaseAddress @ 0x1404B1F88
 * Callers:
 ...
 *     MiApplyBytestreamFixup @ 0x1400EA000 (MiApplyBytestreamFixup.c)
 */

__int64 __fastcall MiSwitchBaseAddress(__int64 *a1, __int64 a2, int a3, unsigned int a4)
{
  int v4; // r10d
  __int64 v5; // rdi
  __int64 v7; // rsi
