/*
 * XREFs of RtlpGenericRandomPatternWorker @ 0x1401FCB3C
 * Callers:
 *     RtlScrubMemory @ 0x1401FC4F0 (RtlScrubMemory.c)
 * Callees:
 *     RtlpFillMemoryRandomUp @ 0x1401FC620 (RtlpFillMemoryRandomUp.c)
 *     RtlpTestMemoryRandomUp @ 0x1401FD030 (RtlpTestMemoryRandomUp.c)
 */
