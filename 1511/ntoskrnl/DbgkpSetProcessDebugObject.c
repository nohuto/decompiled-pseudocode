/*
 * XREFs of DbgkpSetProcessDebugObject @ 0x1405EF678
 * Callers:
...
LABEL_35:
    ...
    if ( v10 < 0 )
    {
      ...
      v18->Flink = v17;
      v17->Blink = v18;
      v16 = (struct _LIST_ENTRY *)v26;
      *(_QWORD *)&v11->Header.Lock = &v25;
      v11->Header.WaitListHead.Flink = v16;
      if ( (__int64 **)v16->Flink != &v25 )
        __fastfail(3u);
    }
    else
    {
    ...
    v16->Flink = (struct _LIST_ENTRY *)v11;
    v26 = v11;
LABEL_32:
    ...
    if ( (v19 & 8) != 0 )
    {
      ...
      ExReleaseRundownProtection_0((PEX_RUNDOWN_REF)&Blink[106]);
    }
    CurrentThread = v22;
    v10 = v4;
    goto LABEL_35;
