/*
 * XREFs of ?StCompactionPickPriority@?$ST_STORE@USM_TRAITS@@@@SAKPEAU_ST_DATA_MGR@1@PEAPEAT_ST_REGION_STATE@1@K1K@Z @ 0x14011198C
 * Callers:
        ...
        void *a4)
{
  ...
  if ( v11 )
  {
    v12 = (unsigned __int8)*(_DWORD *)(a1 + 128);
    do
    {
      if ( v12 )
        v13 = 0;
  ...
  {
    v20 = *(v18 - 1);
    if ( v20 > 1 && v19 < v20 * *(_DWORD *)(a1 + 168) - *v18 )
    {
      v19 = v20 * *(_DWORD *)(a1 + 168) - *v18;
      v17 = v10;
    }
    v18 -= 10;
    --v10;
