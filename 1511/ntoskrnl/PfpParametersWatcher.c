/*
 * XREFs of PfpParametersWatcher @ 0x140631D64
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PfSnDetermineEnablePrefetcher @ 0x14054B930 (PfSnDetermineEnablePrefetcher.c)
 *     PfpParametersPropagate @ 0x140631C58 (PfpParametersPropagate.c)
 */

__int64 __fastcall PfpParametersWatcher(__int64 a1)
{
  ...
  PfLockExclusiveAcquire((unsigned __int64 *)(a1 + 504));
  v3 = *(void **)(a1 + 8);
  if ( v3 )
  {
