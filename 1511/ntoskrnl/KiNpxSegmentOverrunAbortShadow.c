/*
 * XREFs of KiNpxSegmentOverrunAbortShadow @ 0x140224480
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall __noreturn KiNpxSegmentOverrunAbortShadow(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
