/*
 * XREFs of MiCopyToCfgBitMap @ 0x1404163B0
 * Callers:
        ...
        int a7)
{
  ...
  ULONG_PTR v45; // [rsp+128h] [rbp+28h]
  ...
  {
    PoolWithTag = (char *)qword_1402FF258;
    if ( !a3 )
      PoolWithTag = (char *)qword_1402FF260;
  }
  v46 = PoolWithTag;
  v41 = PoolWithTag;
LABEL_5:
  ...
  v14 = Size;
  v44 = (Size >> 12) + (((Size & 0xFFF) + 4095 + (BugCheckParameter2 & 0xFFF)) >> 12);
  v15 = 0;
  while ( v14 )
  {
    v16 = v11 - 1;
  ...
  if ( a3 )
  {
    if ( v15 < 0 )
    {
      if ( v13 == v19 || v15 == -1073741818 )
        return (unsigned int)v15;
      v20 = (v13 - (v19 & 0xFFFFFFFFFFFFF000uLL)) >> 12;
    }
