/*
 * XREFs of KiSystemStartup @ 0x14039C010
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall __noreturn KiSystemStartup(PDRIVER_OBJECT DriverObject, PUNICODE_STRING RegistryPath)
{
  ...
  if ( !v2 )
    v2 = (DRIVER_DISPATCH *)&unk_140320180;
  ...
  *MK_FP(43, _RDX + 12) = *MK_FP(43, v9 + 72);
  ...
  if ( !*MK_FP(43, &KeGetPcr()->Prcb.Number) )
  {
    v19 = __rdtsc();
    v17 = __ROR8__(v19, 49);
    v20 = __ROL8__(ExpSecurityCookieRandomData ^ v17 ^ v19, 16);
    LOWORD(v20) = 0;
    _security_cookie = __ROR8__(v20, 16);
  ...
  *MK_FP(43, &CurrentThread->WaitBlockFill11[70]) = 2;
  ...
  while ( !v22 );
  KiIdleLoop((__int64)CurrentThread, v17, v18);
}
