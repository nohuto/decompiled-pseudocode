/*
 * XREFs of LdrResGetRCConfig @ 0x140509F8C
 * Callers:
 ...
 *     CheckOneBitValidFlag @ 0x1401F7B38 (CheckOneBitValidFlag.c)
...
LABEL_11:
  ...
  {
    v15 = LdrpResSearchResourceMappedFile(ullAugend, v41[0], v11, (__int64)v43, 3, &v40, &v42, 0LL, 0LL);
    if ( v15 < 0 )
    {
      if ( v15 != -1073741701 )
        v15 = -1073741686;
