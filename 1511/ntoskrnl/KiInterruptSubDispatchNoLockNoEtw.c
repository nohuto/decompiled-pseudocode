/*
 * XREFs of KiInterruptSubDispatchNoLockNoEtw @ 0x140155260
 * Callers:
...
char __fastcall KiInterruptSubDispatchNoLockNoEtw(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbp
  __int64 v5; // rsi
  ...
  *(_QWORD *)(v5 + 136) = v4 - 128;
  result = KiCallInterruptServiceRoutine(v5, 0);
  _disable();
  return result;
}
