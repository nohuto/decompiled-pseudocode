/*
 * XREFs of ObReferenceFileObjectForWrite @ 0x1404369A0
 * Callers:
...
__int64 __fastcall ObReferenceFileObjectForWrite(ULONG_PTR BugCheckParameter1, char a2, _QWORD *a3, _DWORD *a4)
{
  ...
  __int64 v11; // r15
  __int16 v12; // cx
  $E81C3296F15336D9BF9B2D43BB137B25 *v13; // rcx
  int v14; // ebx
  void *v15; // rdi
  int v16; // r8d
  int v17; // r8d
...
LABEL_3:
      ...
      if ( !v12 )
      {
        ...
        if ( ($E81C3296F15336D9BF9B2D43BB137B25 *)v13->ApcState.ApcListHead[0].Flink != v13
        ...
        *a4 = v18 & 7;
        if ( (v23 & 0x1FFFFFF & v17) != 0 )
        {
          ...
          if ( (*(_BYTE *)(v24 + 26) & 0x40) == 0 )
            goto LABEL_19;
          v19 = ObpInfoMaskToOffset[*(_BYTE *)(v24 + 26) & 0x7F];
          if ( v24 == v19 )
            goto LABEL_19;
          if ( *(_QWORD *)(v24 - v19 + 16) != 1LL )
          {
            v14 = v24;
LABEL_19:
