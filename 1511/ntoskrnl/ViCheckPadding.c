/*
 * XREFs of ViCheckPadding @ 0x1406BCC98
 * Callers:
 ...
 *     ViHasBufferBeenTouched @ 0x1406BDBAC (ViHasBufferBeenTouched.c)
 */
    ...
    if ( a4 )
    {
      ...
      if ( HasBufferBeenTouched )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)4);
        VfReportIssueWithOptions(230, 15, 4, v4, HasBufferBeenTouched, byte_1402D3FF0);
      }
      ...
      if ( v12 )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)0x1000000F,
          (const void *)5);
        VfReportIssueWithOptions(230, 15, 5, v4, v12, byte_1402D3FF4);
      }
    }
    else
    {
      ...
      if ( v6 )
      {
        ViHalPreprocessOptions(
          ...
          (const void *)0x1000000F);
        VfReportIssueWithOptions(230, 15, 3, v7, 0LL, &dword_1402D3FFC);
      }
    }
  }
}
