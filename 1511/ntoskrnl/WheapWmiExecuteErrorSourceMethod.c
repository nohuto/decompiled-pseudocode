/*
 * XREFs of WheapWmiExecuteErrorSourceMethod @ 0x1402171B4
 * Callers:
 *     WheapWmiExecuteMethod @ 0x14021759C (WheapWmiExecuteMethod.c)
 * Callees:
 *     __security_check_cookie @ 0x140143620 (__security_check_cookie.c)
 *     WheapGetErrorSource @ 0x140216730 (WheapGetErrorSource.c)
 */
        ...
        if ( v11 )
        {
          ...
          if ( a4 >= 4 )
          {
            ...
            if ( a2 >= 4 )
            {
              ...
              if ( ErrorSource )
              {
                if ( *(_DWORD *)((char *)ErrorSource + 101) != 1 )
                {
                  v13 = PshedDisableErrorSource((char *)ErrorSource + 89);
LABEL_17:
                  v5 = v13;
                  goto LABEL_18;
                }
        ...
        else if ( a4 >= 4 )
        {
          ...
          if ( a2 >= 4 )
          {
            ...
            if ( v14 )
            {
              if ( *(_DWORD *)((char *)v14 + 101) != 2 )
              {
                v13 = PshedEnableErrorSource((char *)v14 + 89);
                goto LABEL_17;
              }
LABEL_18:
              *a3 = v5;
...
LABEL_28:
      ...
      *((_DWORD *)v17 + 18) = v15[18];
      v5 = PshedSetErrorSourceInfo(v43, v17, 0LL, 128LL);
      *a3 = v5;
    }
    else
    {
  ...
  else
  {
    if ( !dword_1403069B4 )
      goto LABEL_35;
    v7 = 972 * dword_1403069B4 + 12;
    if ( v7 > a2 )
      goto LABEL_37;
    *a3 = 0;
    v34 = (__int64 *)qword_1403069B8;
    v35 = a3 + 3;
    v36 = 0;
    for ( i = 0; v34 != &qword_1403069B8; v34 = (__int64 *)*v34 )
    {
      if ( i >= dword_1403069B4 )
        break;
      v38 = v35;
      v39 = (char *)v34 + 89;
      v40 = 7LL;
