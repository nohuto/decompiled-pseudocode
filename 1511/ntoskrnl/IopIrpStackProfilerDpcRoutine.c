/*
 * XREFs of IopIrpStackProfilerDpcRoutine @ 0x1400E8A9C
 * Callers:
 *     <none>
 * Callees:
 *     KeGetPrcb @ 0x14009DB9C (KeGetPrcb.c)
 *     IopProcessIrpStackProfiler @ 0x1400E8CBC (IopProcessIrpStackProfiler.c)
 *     __security_check_cookie @ 0x140143620 (__security_check_cookie.c)
 *     _local_unwind @ 0x140143D90 (_local_unwind.c)
 *     KiCustomAccessRoutine2 @ 0x14015D580 (KiCustomAccessRoutine2.c)
...
__int64 __fastcall IopIrpStackProfilerDpcRoutine(__int64 a1, __int64 a2, __int64 a3, unsigned __int64 a4)
{
        ...
        result = (unsigned int)KeNumberProcessors_0 )
  {
    ...
    if ( Prcb )
    {
      v4 += (unsigned int)(*(_DWORD *)(Prcb + 25808) - *(_DWORD *)(Prcb + 25892));
      v8 = 0LL;
      v9 = (_DWORD *)(Prcb + 25728);
      do
      {
