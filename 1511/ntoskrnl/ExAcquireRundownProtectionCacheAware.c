/*
 * XREFs of ExAcquireRundownProtectionCacheAware @ 0x1400D5490
 * Callers:
 *     VerifierExAcquireRundownProtectionCacheAware @ 0x1406C0350 (VerifierExAcquireRundownProtectionCacheAware.c)
 * Callees:
