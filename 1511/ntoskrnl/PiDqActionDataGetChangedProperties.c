/*
 * XREFs of PiDqActionDataGetChangedProperties @ 0x140460C90
 * Callers:
        ...
        unsigned int *a10)
{
  ...
  NTSTRSAFE_PCWSTR v48; // [rsp+88h] [rbp-41h]
  ...
  *(_QWORD *)v45 = a3;
  ...
  if ( *(_DWORD *)(a8 + 76) )
  {
    while ( 1 )
    {
      ...
      if ( !Handle )
      {
        v11 = PiDqOpenObjectRegKey(1, v45[0], v43, 1, 0, v49, (__int64)&Handle);
        if ( v11 == -1073741772 )
        {
          Handle = (HANDLE)-1LL;
          v11 = 0;
