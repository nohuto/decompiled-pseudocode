/*
 * XREFs of FsRtlIsHpfsDbcsLegal @ 0x1405F5098
 * Callers:
 *     FsRtlIsHpfsDbcsLegal @ 0x1405F5098 (FsRtlIsHpfsDbcsLegal.c)
 * Callees:
          ...
          do
          {
            ...
            if ( v15 >= 0x80u && (_BYTE)NlsMbOemCodePageTag && NlsOemLeadByteInfoTable[v15] )
            {
              ...
              ++v13;
                   ...
                   && (((WildCardsPermissible != 0 ? 8 : 0) | 2) & byte_1402453B0[(unsigned __int8)v14[v13]]) == 0 )
            {
              return 0;
            }
            ++v13;
