/*
 * XREFs of PiUEventInit @ 0x140756CC8
 * Callers:
...
__int64 __fastcall PiUEventInit(int a1)
{
  ...
  else
  {
    ...
    do
    {
      *(_QWORD *)((char *)&unk_1402FA728 + v3) = (char *)&PiUEventDevInterfaceClientList + v3;
      *(_QWORD *)((char *)&PiUEventDevInterfaceClientList + v3) = (char *)&PiUEventDevInterfaceClientList + v3;
      *(_QWORD *)((char *)&unk_1402FA808 + v3) = (char *)&PiUEventDevInstanceClientList + v3;
      *(_QWORD *)((char *)&PiUEventDevInstanceClientList + v3) = (char *)&PiUEventDevInstanceClientList + v3;
      *(_QWORD *)((char *)&unk_1402FA8E8 + v3) = (char *)&PiUEventDevInstancePropertyClientList + v3;
      ...
      *(_QWORD *)((char *)&unk_1402FA9C8 + v3) = (char *)&PiUEventDevHandleClientList + v3;
      v3 += 16LL;
      *v4 = v4;
      --v2;
    }
    while ( v2 );
    qword_1402FAAE8 = (__int64)&PiUEventUsermodeEventQueue;
    PiUEventUsermodeEventQueue = (__int64)&PiUEventUsermodeEventQueue;
    qword_1402FAB48 = (__int64)&PiUEventBroadcastEventQueue;
