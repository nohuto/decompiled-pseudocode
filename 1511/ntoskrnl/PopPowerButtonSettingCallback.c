/*
 * XREFs of PopPowerButtonSettingCallback @ 0x14053DD44
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PopPowerButtonSettingCallback(__int64 *a1, unsigned int *a2, int a3)
{
  ...
  if ( v19 )
  {
    ...
    if ( v20 )
    {
      ...
      if ( v21 )
      {
        v23 = *(_QWORD *)&GUID_LIDOPEN_POWERSTATE.Data1 - v18;
        if ( *(_QWORD *)&GUID_LIDOPEN_POWERSTATE.Data1 == v18 )
          v23 = *(_QWORD *)GUID_LIDOPEN_POWERSTATE.Data4 - a1[1];
        if ( !v23 && a3 == 4 && a2 )
        {
          v27 = DWORD2(v30);
          if ( *a2 <= 7 )
  ...
  if ( a3 != 4 || !a2 || (v23 = *a2, (unsigned int)v23 > 8) || (v24 = 333, !_bittest(&v24, v23)) )
  {
    v25 = -1073741811;
    goto LABEL_18;
  }
...
LABEL_17:
  LOBYTE(v23) = 1;
  v25 = PopApplyPolicy(v23, 0LL, &v28, 232LL);
LABEL_18:
