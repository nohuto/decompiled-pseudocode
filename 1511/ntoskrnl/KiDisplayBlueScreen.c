/*
 * XREFs of KiDisplayBlueScreen @ 0x1401C6018
 * Callers:
 ...
 *     KeGetBugMessageText @ 0x1401C5CCC (KeGetBugMessageText.c)
...
void __fastcall KiDisplayBlueScreen(int a1)
{
  ...
  if ( (dword_1402D4BB0 & 2) != 0 )
    BgpFwDisplayBugCheckScreen(v14, (unsigned int)&qword_1402E8808, v3, (unsigned int)&v21, a1);
  BgpFwReleaseLock();
