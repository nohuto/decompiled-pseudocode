...
__int64 __fastcall ExpSetBootEntry(int a1, unsigned int *a2, unsigned int *a3)
{
  ...
  struct _FILE_PATH *v17; // rsi
  __int64 v18; // r13
  __int64 v19; // rsi
  struct _FILE_PATH *v20; // r15
  char *v21; // r13
  int v22; // eax
...
LABEL_85:
      ...
      if ( EnvironmentVariable < 0 )
        goto LABEL_34;
      v47 = 1;
      v20 = (struct _FILE_PATH *)((char *)v15 + v15[11] + 28);
    }
    else
    {
      v47 = 0;
    ...
    v17 = (struct _FILE_PATH *)((char *)v15 + v46);
    v44 = v17;
    ...
    if ( EnvironmentVariable >= 0 )
    {
      ...
      {
        Length = v17->Length;
        v42 = (struct _FILE_PATH *)((char *)v15 + v46);
      }
      else
      {
...
LABEL_56:
        ...
        *((_WORD *)v31 + 2) = OutputFilePathLength;
        ...
        else
        {
          ...
          *((_DWORD *)v36 + 3) = v27;
          v37 = (struct _FILE_PATH *)&v36[v15[11]];
          v41 = v45;
