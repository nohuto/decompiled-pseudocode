/*
 * XREFs of KsepDsEventDataIrp @ 0x1401CDA30
 * Callers:
 *     KseDsCallbackHookIrpFunction @ 0x1401CD45C (KseDsCallbackHookIrpFunction.c)
 *     KseDsCallbackHookIrpDeviceControlFunction @ 0x1401CD4D0 (KseDsCallbackHookIrpDeviceControlFunction.c)
 * Callees:
