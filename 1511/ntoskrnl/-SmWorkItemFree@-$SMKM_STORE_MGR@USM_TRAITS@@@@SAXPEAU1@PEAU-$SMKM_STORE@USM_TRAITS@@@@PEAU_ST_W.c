/*
 * XREFs of ?SmWorkItemFree@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAXPEAU1@PEAU?$SMKM_STORE@USM_TRAITS@@@@PEAU_ST_WORK_ITEM_HDR@@PEAJ@Z @ 0x14010D188
 * Callers:
...
LABEL_13:
  ...
  {
    if ( LOWORD(stru_140304DA0.Alignment) >= 0x1000u )
      ExFreePoolWithTag((PVOID)a3, 0);
    else
      RtlpInterlockedPushEntrySList(&stru_140304DA0, (PSLIST_ENTRY)a3);
    goto LABEL_6;
  }
...
LABEL_7:
  ...
  {
    if ( v11 )
      SmFpFree(&dword_140304DB0, 0LL, v4, v4);
  }
  if ( v9 )
    goto LABEL_13;
}
