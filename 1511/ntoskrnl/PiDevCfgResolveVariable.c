/*
 * XREFs of PiDevCfgResolveVariable @ 0x1405156FC
 * Callers:
...
__int64 __fastcall PiDevCfgResolveVariable(__int64 a1, const WCHAR *a2, UNICODE_STRING **a3)
{
  ...
  unsigned int v4; // ebx
  unsigned int *v5; // r14
  __int64 (__fastcall *v6)(__int64, HANDLE, UNICODE_STRING *); // r13
  int v7; // r15d
  NTSTATUS v8; // eax
  ULONG v9; // ecx
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( v13 >= 0 )
  {
    RegistryValue = IopGetRegistryValue(KeyHandle, (const WCHAR *)&dword_1406A7164, 0, &P);
    v5 = (unsigned int *)P;
    v4 = RegistryValue;
    if ( RegistryValue < 0 )
      goto LABEL_29;
    ...
    v15 = (const wchar_t **)&off_1406A3390;
    ...
    v6 = (__int64 (__fastcall *)(__int64, HANDLE, UNICODE_STRING *))*(&funcs_14051594E + 2 * v17);
    if ( !v6 )
    {
LABEL_11:
      v4 = -1073741772;
...
LABEL_29:
  ...
  {
    v4 = 0;
    v18 = (const wchar_t **)&off_1406A2EF0;
    v19 = 0LL;
