/*
 * XREFs of EmpParseTargetRuleStringIndexList @ 0x140760518
 * Callers:
 ...
 *     EmpInfParseGetStringIndexFromName @ 0x140760758 (EmpInfParseGetStringIndexFromName.c)
 */
        ...
        if ( &a2[-v14] != (_BYTE *)-1LL )
        {
          ...
          if ( PoolWithTag )
          {
            if ( (unsigned __int64)&a2[-v14 + 1] <= 0x7FFFFFFF )
            {
              ...
              else if ( (int)sub_14013524C(PoolWithTag, (__int64)&a2[-v14 + 1], v15, v14, (__int64)&a2[-v14]) >= 0 )
              {
                if ( v11 < v24 )
                {
                  v7 = v23;
