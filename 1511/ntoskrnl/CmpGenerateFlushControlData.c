/*
 * XREFs of CmpGenerateFlushControlData @ 0x1403D4100
 * Callers:
  ...
  if ( (v10 & 2) == 0 )
  {
    ...
    if ( (((*(_DWORD *)(a1 + 5360) & 0x800) == 0) & (unsigned __int8)v10) != 0 )
    {
      ...
      if ( (*a3 & 0x48) == 8 )
      {
        ...
        {
          *a3 |= 2u;
          if ( (unsigned __int8)HvIsCurrentLogSwappable(a1, a2, a3, (unsigned int)*a3) )
            v18 = v17 | 0x20;
          else
            v18 = v17 | 0x40;
          *a3 = v18;
      ...
      else
      {
        v13 = v11 | 1u;
        *a3 = v13;
        if ( (unsigned __int8)HvIsCurrentLogSwappable(a1, a2, a3, v13) )
        {
          v16 = v14 | 0x20;
        }
        else
