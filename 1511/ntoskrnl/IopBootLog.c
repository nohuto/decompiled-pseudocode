/*
 * XREFs of IopBootLog @ 0x1404C4034
 * Callers:
...
void __fastcall IopBootLog(PCUNICODE_STRING Source, char a2)
{
  ...
  *(_DWORD *)&DestinationString.Length = 0x1000000;
  ...
  if ( qword_1406FB018 )
  {
    ...
    ++LODWORD(qword_1406FB018[10].Buffer);
    RtlStringCchPrintfW(pszDest, 0x100uLL, L"%d");
    RtlCreateUnicodeString(&UnicodeString, pszDest);
    RtlInitUnicodeString(&ValueName, &word_140551830);
    if ( BYTE4(qword_1406FB018[10].Buffer) )
    {
