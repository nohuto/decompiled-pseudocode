/*
 * XREFs of HvlpSetPowerProperty @ 0x1401B2EF8
 * Callers:
 *     PpmScaleIdleStateValues @ 0x1401244B0 (PpmScaleIdleStateValues.c)
 *     HvlConfigureIdleStates @ 0x1401B2390 (HvlConfigureIdleStates.c)
 *     HvlRegisterPerfFeedbackCounters @ 0x1401B2B3C (HvlRegisterPerfFeedbackCounters.c)
 *     HvlpPowerPolicySettingCallback @ 0x1401B2E20 (HvlpPowerPolicySettingCallback.c)
