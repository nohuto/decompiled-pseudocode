/*
 * XREFs of CmpDoFileWrite @ 0x1403DD10C
 * Callers:
 *     CmpFileWrite @ 0x1403D2964 (CmpFileWrite.c)
 *     CmpWriteOffsetArrayToFile @ 0x1405E5958 (CmpWriteOffsetArrayToFile.c)
 * Callees:
 *     CmpSetRespectIoPriorityThread @ 0x14001B3E0 (CmpSetRespectIoPriorityThread.c)
        ...
        char a7)
{
  ...
  if ( PoolWithTag )
  {
    ...
    if ( (a7 & 1) != 0 )
    {
      v31 = CmpSetIoPriorityThread((__int64)KeGetCurrentThread(), 0LL);
...
LABEL_55:
    CmRegistryIODebug = 2;
    qword_1406FBDA8 = (__int64)a3;
    dword_1406FBDB0 = Event;
    if ( v16 > 0 )
