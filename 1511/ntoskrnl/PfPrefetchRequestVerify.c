/*
 * XREFs of PfPrefetchRequestVerify @ 0x1404A2C9C
 * Callers:
 *     PfpPrefetchRequest @ 0x1404A29D8 (PfpPrefetchRequest.c)
 * Callees:
 *     PfPrefetchRequestVerifyRanges @ 0x1404A2BBC (PfPrefetchRequestVerifyRanges.c)
 *     PfPrefetchRequestVerifyPath @ 0x1404A2EF8 (PfPrefetchRequestVerifyPath.c)
 *     PfRequestRangeCheck @ 0x1404A2F80 (PfRequestRangeCheck.c)
