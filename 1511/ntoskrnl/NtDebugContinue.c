/*
 * XREFs of NtDebugContinue @ 0x1405EFD9C
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall NtDebugContinue(HANDLE DebugObject, PCLIENT_ID AppClientId, NTSTATUS ContinueStatus)
{
  ...
  if ( result >= 0 )
  {
    ...
    while ( 1 )
    {
      if ( *(HANDLE *)(v10 + 40) == v15.UniqueProcess )
      {
        if ( v7 )
        {
          *(_DWORD *)(v10 + 76) &= ~4u;
...
LABEL_21:
          ...
          *(_DWORD *)(v8 + 72) = 0;
          DbgkpWakeTarget(v8, v13, v14);
          return v6;
        }
        if ( *(HANDLE *)(v10 + 48) == v15.UniqueThread && (*(_DWORD *)(v10 + 76) & 1) != 0 )
        {
          v11 = *(_QWORD *)v10;
          v12 = *(_QWORD **)(v10 + 8);
