/*
 * XREFs of _raise_exc_ex @ 0x1401481F0
 * Callers:
 *     _raise_exc @ 0x1401481C8 (_raise_exc.c)
 *     _raise_excf @ 0x140148478 (_raise_excf.c)
 * Callees:
        ...
        int a7)
{
  ...
  __int64 result; // rax
  unsigned int *v22; // [rsp+30h] [rbp+8h] BYREF
