/*
 * XREFs of _woutput_l @ 0x1401467A8
 * Callers:
 ...
 *     write_multi_char @ 0x140147114 (write_multi_char.c)
 *     write_string @ 0x140147168 (write_string.c)
 *     _get_printf_count_output @ 0x1401480D0 (_get_printf_count_output.c)
 */
...
LABEL_122:
                  v35 = v7 - v12 - v34;
                  if ( (v6 & 0xC) == 0 )
                    write_multi_char(32LL, v35, v54, &v43);
                  write_string(v50, v34, v54, &v43);
                  v36 = v54;
                  if ( (v6 & 0xC) == 8 )
                    write_multi_char(48LL, v35, v54, &v43);
                  if ( v48 || (int)v12 <= 0 )
                  {
                    write_string(v14, (unsigned int)v12, v36, &v43);
LABEL_136:
                    v11 = v43;
                  }
                  else
                  {
                    ...
                    {
                      --v38;
                      v39 = safecrt_mbtowc(&v51, v37, _mb_cur_max);
                      v40 = v39;
                      if ( v39 == 2 )
                        --v38;
                      if ( v39 <= 0 )
                        break;
                      write_char(v51, v54, &v43);
                      v37 += v40;
                      if ( v38 <= 0 )
                      {
                        v36 = v54;
                  ...
                  write_multi_char(32LL, v35, v36, &v43);
                  v5 = v56;
                  v7 = v46;
LABEL_140:
                  v8 = v45;
