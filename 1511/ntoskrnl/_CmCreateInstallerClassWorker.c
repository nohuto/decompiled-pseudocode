/*
 * XREFs of _CmCreateInstallerClassWorker @ 0x1406929FC
 * Callers:
...
__int64 __fastcall CmCreateInstallerClassWorker(__int64 a1, __int64 a2, int a3, __int64 *a4, bool *a5, __int16 a6)
{
  int v9; // ebx
  bool v10; // dl
  ...
  {
    v9 = CmOpenInstallerClassRegKey(a1, a2, 32LL, 0LL, a3, 1, (__int64)a4, (__int64)v12);
    if ( v9 >= 0 )
    {
      v10 = v12[0] == 1;
      *a5 = v12[0] == 1;
