/*
 * XREFs of CmpGetCallbackObjectContext @ 0x1403E7C40
 * Callers:
...
__int64 __fastcall CmpGetCallbackObjectContext(__int64 a1, __int64 *a2)
{
  ...
  __int64 v14; // rdx
  __int64 v15; // rcx
  $E81C3296F15336D9BF9B2D43BB137B25 *v16; // rcx
  ...
  v7 = KeAbPreAcquire((ULONG_PTR)&CmpContextListLock, 0LL, 0LL);
...
LABEL_8:
  ...
  {
    v16 = &v11->152;
    if ( ($E81C3296F15336D9BF9B2D43BB137B25 *)v16->ApcState.ApcListHead[0].Flink != v16 && !v11->SpecialApcDisable )
