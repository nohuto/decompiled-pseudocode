/*
 * XREFs of SepSetTokenLowboxNumber @ 0x1403BED94
 * Callers:
...
LABEL_3:
  ...
  v20 = KeAbPreAcquire((ULONG_PTR)&LowboxSessionMapLock, 0LL, 0LL);
  ...
  if ( TokenSessionMapEntry == -1073741275 )
  {
    ...
    v23 = KeAbPreAcquire((ULONG_PTR)&LowboxSessionMapLock, 0LL, 0LL);
