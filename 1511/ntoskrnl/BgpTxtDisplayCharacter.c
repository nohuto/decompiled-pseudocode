/*
 * XREFs of BgpTxtDisplayCharacter @ 0x14011C070
 * Callers:
 ...
 *     TxtpGetCacheEntry @ 0x14011C290 (TxtpGetCacheEntry.c)
...
LABEL_5:
    ...
    if ( (v36 & 1) != 0 || (dword_1402D4BB0 & 0x1000000) != 0 || (v14 = BgpGxDrawRectangle(v11, &v28), v14 >= 0) )
    {
      if ( v12 )
  ...
  v14 = BgpGxConvertRectangle(v11, BitsPerPixel, &v31, 0LL);
  if ( v14 >= 0 )
  {
    if ( v11 != v9 )
