/*
 * XREFs of KdpSetContextEx @ 0x1401C23CC
 * Callers:
 ...
 *     KdpSanitizeContextFlags @ 0x1406AD76C (KdpSanitizeContextFlags.c)
 */
...
__int64 __fastcall KdpSetContextEx(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( v6 < 0x280u && KiProcessorBlock[v6] && KdpContextSent )
  {
    ...
    {
      KdpQuickMoveMemory((char *)&unk_140332038 + v4, *(_QWORD *)(a2 + 8), (unsigned int)v7);
      if ( v10 == v9 )
      {
        v11 = *(_WORD *)(a1 + 6);
        if ( v11 != (unsigned __int16)KeGetPcr()->Prcb.Number )
          a3 = *(_QWORD *)(KiProcessorBlock[v11] + 25216);
        KdpSanitizeContextFlags(&unk_140332038, (unsigned int)v9, &v15);
        KdpCopyContext(a3, v15, &unk_140332038);
      }
      *(_DWORD *)(a1 + 8) = 0;
      *(_DWORD *)(a1 + 24) = v7;
    }
