/*
 * XREFs of LdrProcessRelocationBlockLongLong @ 0x140520A4C
 * Callers:
 *     LdrRelocateImage @ 0x14052097C (LdrRelocateImage.c)
 * Callees:
 *     LdrpGenericProcessRelocation @ 0x140133088 (LdrpGenericProcessRelocation.c)
 *     LdrpArmProcessRelocation @ 0x1401FB530 (LdrpArmProcessRelocation.c)
 *     LdrpThumbProcessRelocation @ 0x1401FB600 (LdrpThumbProcessRelocation.c)
 */
