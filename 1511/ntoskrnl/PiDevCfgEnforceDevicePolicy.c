/*
 * XREFs of PiDevCfgEnforceDevicePolicy @ 0x140514D5C
 * Callers:
...
LABEL_38:
  v18 = PiDevCfgQueryPolicyStringList(Handle, L"AllowDeviceIDs", &v36);
  v19 = (wchar_t *)v36;
  if ( v18 < 0 )
    v19 = 0LL;
  v20 = PiDevCfgQueryPolicyStringList(Handle, L"DenyDeviceIDs", &v38);
  v21 = (wchar_t *)v38;
  if ( v20 < 0 )
    v21 = 0LL;
  if ( v19 || v21 )
