/*
 * XREFs of KiFindNextTimerDueTime @ 0x140049AE0
 * Callers:
...
LABEL_56:
  ...
  while ( 2 )
  {
    ...
    while ( 1 )
    {
      ...
      {
        v25 = (_QWORD *)(qword_140383178[0] + 8 * (v23 >> 6));
        v26 = ((1LL << (v23 & 0x3F)) - 1) | ~*v25;
        if ( v26 == -1 )
        {
          while ( (unsigned __int64)++v25 <= qword_140383178[0] + 8 * (v24 >> 6) )
          {
            v26 = ~*v25;
            if ( *v25 )
              goto LABEL_29;
...
LABEL_29:
        ...
        v27 = v26 + (((__int64)v25 - qword_140383178[0]) >> 3 << 6);
        if ( v27 > v24 )
          goto LABEL_69;
        if ( v27 != -1LL )
          break;
