/*
 * XREFs of PopFxRegisterDeviceWorker @ 0x14051BB30
 * Callers:
        ...
        __int64 **a9)
{
  ...
  __int64 *v92; // [rsp+78h] [rbp-B0h] BYREF
...
LABEL_8:
      ...
      if ( v10 )
      {
        ...
        v71 = 8LL * v10;
        v82 = (v71 + v23 + 3) & 0xFFFFFFFFFFFFFFFCuLL;
        v22 = v71 + v82;
      }
      v24 = ((int)(8 * a5 + 16) + 7LL) & 0xFFFFFFFFFFFFFFF8uLL;
      v90 = v24;
      v84 = (v24 + 40LL * a5 + 7) & 0xFFFFFFFFFFFFFFF8uLL;
      v25 = v21 + v84;
      Size = v21 + v84;
      AcpiDeviceByUniqueId = PopFxFindAcpiDeviceByUniqueId(a2, &v92);
      v13 = v92;
      if ( AcpiDeviceByUniqueId >= 0 )
      {
        v30 = v92;
        BugCheckParameter2 = (ULONG_PTR)v92;
LABEL_17:
        v32 = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, v22, 0x4D584650u);
        if ( !v32 || (v101 = ExAllocatePoolWithTag(NonPagedPoolNx, v25, 0x4D584650u), (v33 = v101) == 0LL) )
        {
          v31 = -1073741670;
          goto LABEL_53;
        }
...
LABEL_34:
          ...
          if ( (unsigned int)v41 >= a5 )
          {
            ...
            do
            {
              ...
              PopFxActivateComponent((__int64)v30, v62, 0LL, 1);
              ++v58;
              v60 += 8LL;
            }
            while ( v58 < v9 );
...
LABEL_79:
        ...
        while ( 1 )
        {
          ...
          if ( v93 - v32 > v54 )
            goto LABEL_79;
          v56 = v93;
          *((_DWORD *)v93 + 4) = *(_DWORD *)(v55 + 24 * v53 + 16);
          *(_QWORD *)v56 = *(_QWORD *)(v55 + 24 * v53);
          *((_QWORD *)v56 + 1) = *(_QWORD *)(v55 + 24 * v53 + 8);
          v93 = v56 + 24;
          if ( (unsigned __int64)&v85[v94 + 16] > v51 - 24 )
            goto LABEL_79;
          *((_DWORD *)v85 + 4) = *(_DWORD *)(v55 + 24 * v53 + 16);
          *(_QWORD *)v85 = *(_QWORD *)(v55 + 24 * v53);
          *((_QWORD *)v85 + 1) = *(_QWORD *)(v55 + 24 * v53 + 8);
