/*
 * XREFs of _PnpOpenObjectRegKeyDispatch @ 0x14043E824
 * Callers:
 *     _PnpOpenObjectRegKey @ 0x14043E904 (_PnpOpenObjectRegKey.c)
 * Callees:
 *     memset @ 0x140166CC0 (memset.c)
 *     _PnpCtxGetObjectDispatchCallback @ 0x14043DD40 (_PnpCtxGetObjectDispatchCallback.c)
 */
  ...
  else
  {
    ...
    if ( ObjectDispatchCallback >= 0 )
    {
      if ( v15 )
      {
        ...
        LODWORD(v16[0]) = a4;
        HIDWORD(v16[2]) = v13;
        ObjectDispatchCallback = v15(a1, a2, a3, 2LL, v16);
        if ( ObjectDispatchCallback >= 0 )
          *a7 = v16[2];
      }
      else
