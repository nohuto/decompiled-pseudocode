/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x1401FD124
 * Callers:
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      do
      {
        v26 = (unsigned __int16)XpressHashFunction[*v24] ^ (unsigned __int16)word_14023DF00[v24[2]] ^ (unsigned __int64)(unsigned __int16)word_14023DD00[v24[1]];
        v27 = *(_QWORD *)&a6[8 * v26];
        *(_QWORD *)&a6[8 * v26] = v24++;
