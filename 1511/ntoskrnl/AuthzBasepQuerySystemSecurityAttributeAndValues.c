/*
 * XREFs of AuthzBasepQuerySystemSecurityAttributeAndValues @ 0x1403C576C
 * Callers:
 *     AuthzBasepEvaluateAceCondition @ 0x140006054 (AuthzBasepEvaluateAceCondition.c)
 *     AuthzBasepRestartOperandValueEnumeration @ 0x14021B514 (AuthzBasepRestartOperandValueEnumeration.c)
 * Callees:
