/*
 * XREFs of PopVerifySystemPowerPolicy @ 0x14053E494
 * Callers:
...
__int64 __fastcall PopVerifySystemPowerPolicy(_OWORD *a1, __int64 a2)
{
  ...
  *(_QWORD *)(a2 + 224) = *((_QWORD *)v4 + 12);
  ...
  else if ( (_BYTE)word_1402DDF64 )
  {
    *(_DWORD *)(a2 + 72) = 3;
  }
  else if ( byte_1402DDF63 )
  {
    *(_DWORD *)(a2 + 72) = 2;
  }
  v5 = (int *)(a2 + 68);
  ...
  if ( *(_DWORD *)(a2 + 212) < (unsigned int)qword_1402DDE70 )
    *(_DWORD *)(a2 + 212) = qword_1402DDE70;
  if ( *(_DWORD *)(a2 + 212) > HIDWORD(qword_1402DDE70) )
    *(_DWORD *)(a2 + 212) = HIDWORD(qword_1402DDE70);
  ...
  {
    v15 = *v14 == 3;
    PopVerifyPowerActionPolicy(v12 - 3);
    if ( v15 && *v14 < 3 )
    {
      *v14 = 6;
      PopVerifyPowerActionPolicy(v14);
    }
    PopVerifySystemPowerState(v12, 1);
    if ( *v14 == 2 && v14[3] > 4 )
    {
      v14[3] = 4;
  ...
  if ( !*(_DWORD *)(a2 + 92) )
    *(_DWORD *)(a2 + 92) = 1;
  if ( *(_DWORD *)(a2 + 88) && !byte_1402DDF67 )
    *(_DWORD *)(a2 + 88) = 0;
