/*
 * XREFs of KiInterruptSubDispatchNoLock @ 0x140155130
 * Callers:
...
void __fastcall KiInterruptSubDispatchNoLock(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  __int64 v4; // rbp
  __int64 v5; // rsi
  ...
  *(_BYTE *)(v4 + 243) = (WORD2(PerfGlobalGroupMask) & 0x4000) != 0;
  ...
  v17 = KiCallInterruptServiceRoutine(v5, 0);
  if ( *(_BYTE *)(v4 + 243) )
  {
    v18 = v17;
