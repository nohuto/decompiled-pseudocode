/*
 * XREFs of IopPerfCompleteRequest @ 0x1401BC7C4
 * Callers:
...
void __fastcall IopPerfCompleteRequest(ULONG_PTR BugCheckParameter1, char a2)
{
  ...
  ULONG_PTR *v20; // [rsp+78h] [rbp+Fh] BYREF
  ...
  if ( *(_WORD *)BugCheckParameter1 == 6 )
  {
    ...
    if ( v5 <= (char)(v4 + 1) )
    {
      ...
      if ( (IopPerfStatus & 1) != 0 )
      {
        ...
        v23 = v18;
        v24 = 20;
        EtwTraceKernelEvent((int)&v23, 1, 0x20000010u, 0x134u, 4200450);
        if ( !v7 )
        {
LABEL_24:
          ...
          v12 = v9;
          v21 = 12;
          EtwTraceKernelEvent((int)&v20, 1, 0x20000010u, 0x135u, 4200450);
          return;
        }
        v15 = 0LL;
