/*
 * XREFs of KsepGetShimCallbacksForDriver @ 0x1403B684C
 * Callers:
    ...
    while ( 1 )
    {
      if ( (*(_DWORD *)(*(_QWORD *)v10 + 28LL) & 4) == 0 )
      {
        ...
        if ( !v12 )
        {
          ...
          v14 = KsepDebugFlag;
          dword_1402E1EA4[2 * v13] = -1073740768;
        ...
        switch ( v18[v20 + 2] )
        {
          ...
          default:
            if ( (unsigned int)(v21 - 100) > 0x1B )
            {
              ...
              v25 = KsepDebugFlag;
              dword_1402E1EA4[2 * v24] = -1073741811;
...
LABEL_40:
              v26 = KsepDebugFlag;
              dword_1402E1EA4[2 * v23] = -1073741823;
              if ( (v26 & 2) != 0 )
