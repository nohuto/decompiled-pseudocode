/*
 * XREFs of KseShimDriverIoCallbacks @ 0x1403B6740
 * Callers:
...
__int64 __fastcall KseShimDriverIoCallbacks(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  _BYTE *v18; // r9
  __int64 v19; // rbx
  __int64 (__fastcall *v20)(__int64, __int64); // rdx
  __int64 (__fastcall *v21)(__int64, __int64); // r10
        ...
        if ( ShimCallbacksForDriver >= 0 )
        {
          ...
          if ( ShimCallbacksForDriver >= 0 )
          {
            ...
            if ( NonPaged )
            {
              ...
              v17 = (__int64 (__fastcall **)(__int64, __int64))(a1 + 14);
              ...
              do
              {
                ...
                if ( *v17 )
                {
                  ...
                  {
                    v21 = *(__int64 (__fastcall **)(__int64, __int64))((char *)v17 + (_QWORD)v18 - 112);
                    if ( v21 )
                    {
                      *(__int64 (__fastcall **)(__int64, __int64))((char *)v17 + v16 - 80) = v20;
                      *v17 = v21;
                    }
                  }
                }
