/*
 * XREFs of PnpTraceRebalanceResult @ 0x1406148CC
 * Callers:
...
BOOLEAN __fastcall PnpTraceRebalanceResult(__int64 a1, UCHAR a2)
{
  ...
  result = TraceLoggingProviderEnabled(&stru_1402CFD80, a2, 0x400000000000uLL);
  if ( result )
  {
    if ( !v3 || !*(_QWORD *)(v3 + 32) || !*(_QWORD *)(v3 + 16) )
      __fastfail(5u);
    v4 = MEMORY[0xFFFFF78000000008];
    if ( stru_1402CFD80.LevelPlus1 > 5 )
    {
      result = TlgKeywordOn(&stru_1402CFD80, 0x400000000000uLL);
      if ( result )
      {
        v8 = v4 - *((_QWORD *)v6 + 6);
        v12 = *v6;
        ...
        v40 = 8LL;
        v42 = 8LL;
        return TlgWrite(&stru_1402CFD80, &unk_140253E2D, 0LL, 0LL, 0xFu, &pData);
      }
    }
  }
  return result;
