/*
 * XREFs of PoFxPowerControl @ 0x14011748C
 * Callers:
 *     VerifierPoFxPowerControl @ 0x1406C0B68 (VerifierPoFxPowerControl.c)
 * Callees:
 *     IoAcquireRemoveLockEx @ 0x1400DAFE0 (IoAcquireRemoveLockEx.c)
 *     IoReleaseRemoveLockEx @ 0x1400E26D0 (IoReleaseRemoveLockEx.c)
 *     PopPluginRequestPowerControl @ 0x1401EC088 (PopPluginRequestPowerControl.c)
 */
