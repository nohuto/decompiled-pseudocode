/*
 * XREFs of PpmEventProcessorPerfStateChange @ 0x14012438C
 * Callers:
...
__int64 __fastcall PpmEventProcessorPerfStateChange(struct _KPRCB *a1, _DWORD *a2)
{
  ...
  if ( (xmmword_140382290 & 0x8000) != 0 && a1 == KeGetCurrentPrcb() )
  {
    ...
    v17 = &v14;
    EtwTraceKernelEvent((int)&v17, 1, 0x80008000, 0x1233u, 4200450);
  }
  ...
  return PpmEventPerfState(&PPM_ETW_PROCESSOR_PERF_STATE_CHANGE, a1->Number, PerfConstraint->SelectedPercent, a2[92]);
}
