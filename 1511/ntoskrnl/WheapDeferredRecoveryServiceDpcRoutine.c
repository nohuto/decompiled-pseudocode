/*
 * XREFs of WheapDeferredRecoveryServiceDpcRoutine @ 0x140216DEC
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall WheapDeferredRecoveryServiceDpcRoutine(ULONG_PTR BugCheckParameter2)
{
  ...
  {
    v6 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)&WheapDispatchPtr.Dpc.DpcData);
    *(_QWORD *)v2 = WheaPassiveDrsList;
    WheaPassiveDrsList = v2;
    KeReleaseSpinLock((PKSPIN_LOCK)&WheapDispatchPtr.Dpc.DpcData, v6);
