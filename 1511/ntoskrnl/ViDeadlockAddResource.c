/*
 * XREFs of ViDeadlockAddResource @ 0x1406CC970
 * Callers:
        ...
        __int64 a6)
{
  ...
  if ( v11 )
  {
    ...
    {
      ViDeadlockPreprocessOptions(byte_1402D4078, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(196, 4101, a1, v11, 0LL, byte_1402D4078);
    }
    if ( *(_QWORD *)(v11 + 16) )
    {
      ViDeadlockPreprocessOptions(byte_1402D4070, "Re-initializing active lock 0x%p.", (const void *)0x1005);
      VfReportIssueWithOptions(196, 4101, a1, v11, 1uLL, byte_1402D4070);
    }
