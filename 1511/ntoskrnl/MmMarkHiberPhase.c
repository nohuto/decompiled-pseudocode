/*
 * XREFs of MmMarkHiberPhase @ 0x14039EE0C
 * Callers:
...
unsigned __int64 MmMarkHiberPhase()
{
  ...
  PoSetHiberRange(0LL, 0x10000u, CurrentProcess, 0x798uLL, 0x62706D4Du);
  DeepFreezeStartTime = (void *)PsGetCurrentProcess()[2].DeepFreezeStartTime;
  ...
  return MiEnumerateKernelLeafPtes(
           (void (__fastcall *)(__int64, unsigned __int64, unsigned __int64))MiMarkHiberNotCachedPages,
           0LL);
}
