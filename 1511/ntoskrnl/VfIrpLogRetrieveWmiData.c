/*
 * XREFs of VfIrpLogRetrieveWmiData @ 0x1406CAC34
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  _QWORD *v18; // rax
  _QWORD *v19; // r15
  struct _OBJECT_NAME_INFORMATION *v20; // rax
  void *v21; // rcx
  ...
  if ( *v12 != v12 )
  {
    while ( 1 )
    {
      ...
      if ( v14 == -1073741820 )
      {
        ...
        v20 = (struct _OBJECT_NAME_INFORMATION *)ExAllocatePoolWithTag(PagedPool, ReturnLength, 0x74496656u);
        PoolWithTag = v20;
        if ( !v20 )
