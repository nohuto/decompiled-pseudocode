/*
 * XREFs of RtlGetProductInfo @ 0x14013EF74
 * Callers:
 *     ExpUpdateProductSuiteType @ 0x14076B2E0 (ExpUpdateProductSuiteType.c)
 * Callees:
 *     sub_14013F0AC @ 0x14013F0AC (sub_14013F0AC.c)
        ...
        PULONG ReturnedProductType)
{
  ...
  *ReturnedProductType = 0;
  v7 = *(_OWORD *)Type_8;
  v17 = xmmword_140250350;
  if ( (int)sub_14013F0AC(Type_8, &v17) < 0 )
    return 0;
  ...
  if ( ZwQueryLicenseValue((PUNICODE_STRING)&stru_140243A28, &Type, v18, 0xC8u, &ResultDataSize) < 0 )
    goto LABEL_7;
