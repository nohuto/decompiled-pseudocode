/*
 * XREFs of KiFilterFiberContext @ 0x14072DA40
 * Callers:
...
__int64 __fastcall KiFilterFiberContext(__int64 a1)
{
  ...
  *(_QWORD *)&v8 = __rdtsc();
  ...
  v11 = ((0x7010008004002001LL * (v10 ^ (unsigned __int64)v8)) ^ (((v10 ^ (unsigned __int64)v8)
      ...
      % 6;
  v12 = sub_14072EAFC((v9 ^ *((_QWORD *)&v8 + 1)) % 0xD, v11, v6, a1, 1);
  if ( !v12 )
    goto LABEL_15;
  if ( v6 == 2 )
  {
    ...
    v12 = sub_14072EAFC(v15, v18, 2, a1, 0);
  }
  if ( !v12 )
    goto LABEL_15;
  if ( !qword_1403821C0 && !a1 && (int)KiSwInterruptPresent() >= 0 )
    v12 = sub_14072EAFC(0, 7, 1, 0, 0);
  if ( !v12 )
LABEL_15:
    v4 = 0;
  _disable();
