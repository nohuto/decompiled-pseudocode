/*
 * XREFs of IopGetBootDiskInformationLite @ 0x14075F42C
 * Callers:
 *     IoGetBootDiskInformationLite @ 0x14052830C (IoGetBootDiskInformationLite.c)
 * Callees:
 ...
 *     IopAddBootDiskInformation @ 0x140134FD0 (IopAddBootDiskInformation.c)
