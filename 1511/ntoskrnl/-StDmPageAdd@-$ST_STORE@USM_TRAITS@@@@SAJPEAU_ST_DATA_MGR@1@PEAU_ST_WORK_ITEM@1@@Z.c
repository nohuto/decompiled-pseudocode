/*
 * XREFs of ?StDmPageAdd@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_ST_WORK_ITEM@1@@Z @ 0x14010C31C
 * Callers:
 ...
 *     StIoCountsMovePeriod @ 0x140207BF0 (StIoCountsMovePeriod.c)
 */
