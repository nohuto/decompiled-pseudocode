/*
 * XREFs of FsRtlCancellableWaitForMultipleObjects @ 0x14048BD50
 * Callers:
 *     FsRtlCancellableWaitForSingleObject @ 0x140489AA0 (FsRtlCancellableWaitForSingleObject.c)
 *     VerifierFsRtlCancellableWaitForMultipleObjects @ 0x1406C0480 (VerifierFsRtlCancellableWaitForMultipleObjects.c)
 * Callees:
