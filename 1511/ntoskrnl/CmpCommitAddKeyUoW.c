/*
 * XREFs of CmpCommitAddKeyUoW @ 0x1404B3A00
 * Callers:
...
__int64 __fastcall CmpCommitAddKeyUoW(__int64 a1, __int64 *a2)
{
  ...
  if ( !v8 )
    return 3221225626LL;
  if ( !HvpMarkCellDirty(v7, *(unsigned int *)(*(_QWORD *)(a1 + 48) + 40LL), 1)
    || !HvpMarkCellDirty(
  ...
  if ( v9 == -1 )
    return 3221225626LL;
  if ( CmpAddSubKeyEx(v7, *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 72LL) + 40LL), v9, 0) )
  {
    v10 = *(_QWORD *)(a1 + 48);
    *(_DWORD *)(a1 + 80) = *(_DWORD *)(v10 + 40);
    *(_DWORD *)(v10 + 40) = v9;
    v11 = (*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, int *))(v7 + 8))(v7, v9, &v18);
    v12 = *(unsigned int *)(v11 + 44);
    *(_DWORD *)(v11 + 16) = *(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 72LL) + 40LL);
    CmpAssignSecurityToKcb(*(_QWORD *)(a1 + 48), v12, 0LL, 0, 0);
    v13 = *a2;
    *(_QWORD *)(v8 + 4) = *a2;
    *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 48) + 72LL) + 168LL) = v13;
    ...
    if ( *(_DWORD *)(v8 + 56) < v15 )
      *(_DWORD *)(v8 + 56) = v15;
    (*(void (__fastcall **)(ULONG_PTR, int *))(v7 + 16))(v7, &v18);
  }
  else
  {
    v6 = -1073741670;
  ...
  (*(void (__fastcall **)(__int64, int *))(v16 + 16))(v16, &v19);
  if ( v6 < 0 )
    CmpFreeKeyByCell(v7, v9, 0);
