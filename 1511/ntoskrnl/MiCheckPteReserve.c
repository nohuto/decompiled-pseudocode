/*
 * XREFs of MiCheckPteReserve @ 0x1401E06C0
 * Callers:
...
__int64 __fastcall MiCheckPteReserve(__int64 a1, ULONG_PTR a2)
{
  ...
  if ( v4 < v7 )
  {
    do
    {
      if ( !_bittest64((const signed __int64 *)qword_1402FF0C8, v5) )
        KeBugCheckEx(0xDAu, 0x201uLL, v3, v3 + (((v5 - v4) << 11) & 0xFFFFFFFFFFFFF000uLL), a2);
      v8 = v5 & 0x1F;
      LOBYTE(v9) = 1;
      v10 = (volatile signed __int32 *)(qword_1402FF0C8 + 4 * (v5 >> 5));
      if ( v8 + 1 > 0x20 )
      {
        if ( (v5 & 0x1F) != 0 )
        {
...
LABEL_14:
  ...
  v13 = v5 & 0x1F;
  v14 = (volatile signed __int32 *)(qword_1402FF0C8 + 4 * (v5 >> 5));
  if ( v13 + 2 <= 0x20 )
  {
    v15 = 3 << v13;
LABEL_24:
