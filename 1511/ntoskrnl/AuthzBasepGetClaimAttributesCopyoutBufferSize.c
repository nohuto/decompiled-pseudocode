/*
 * XREFs of AuthzBasepGetClaimAttributesCopyoutBufferSize @ 0x140683F44
 * Callers:
 *     AuthzBasepQueryClaimAttributesToken @ 0x1404ADE78 (AuthzBasepQueryClaimAttributesToken.c)
 * Callees:
 *     AuthzBasepGetClaimAttributeValueCopyoutBufferSize @ 0x140683DAC (AuthzBasepGetClaimAttributeValueCopyoutBufferSize.c)
 */
