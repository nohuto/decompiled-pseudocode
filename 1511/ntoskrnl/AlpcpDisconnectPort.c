/*
 * XREFs of AlpcpDisconnectPort @ 0x14047F358
 * Callers:
...
__int64 __fastcall AlpcpDisconnectPort(char *Object, char a2)
{
  ...
  v5 = KeAbPreAcquire((ULONG_PTR)(v2 - 2), 0LL, 0LL);
  v6 = v5;
  ...
  v9 = KeAbPreAcquire((ULONG_PTR)(Object + 352), 0LL, 0LL);
  v10 = v9;
    ...
    if ( v7 )
    {
      ...
      while ( 1 )
      {
        ...
        *(_QWORD *)(v20[0] + 8LL) = v20;
        ...
        if ( v21 )
        {
          v19 = KeAbPreAcquire(v21 + 352, 0LL, 0LL);
