/*
 * XREFs of ?StDmRegionGetKeys@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_STDM_SEARCH_RESULTS@1@KKKPEAT_SM_PAGE_KEY@@PEAK@Z @ 0x140206538
 * Callers:
...
LABEL_20:
      ...
      {
        v16[1] = v18;
        LeafSibling = (_DWORD *)B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeFindLeafSiblingEx(
                                  a1 + 64,
                                  v9,
                                  2);
        if ( !LeafSibling )
        ...
        if ( LeafSibling == (_DWORD *)-1LL )
          return 3221225478LL;
        v17 = &LeafSibling[2 * (unsigned __int16)*LeafSibling + 2];
        v16[1] = v17;
      }
      if ( v17 == (_DWORD *)-1LL )
        return 3221225478LL;
      if ( v17 )
      {
        v20 = *v17 & *(_DWORD *)(a1 + 160);
        if ( *v17 >> *(_DWORD *)(a1 + 164) == a3 )
        {
          *v8++ = v17[1];
          if ( v20 )
            continue;
