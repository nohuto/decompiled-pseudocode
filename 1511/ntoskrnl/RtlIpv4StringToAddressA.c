/*
 * XREFs of RtlIpv4StringToAddressA @ 0x1401FA3C0
 * Callers:
 *     RtlIpv4StringToAddressExA @ 0x1401FA628 (RtlIpv4StringToAddressExA.c)
 * Callees:
 *     __security_check_cookie @ 0x140143620 (__security_check_cookie.c)
 *     __isascii @ 0x140144880 (__isascii.c)
 *     isdigit @ 0x14014488C (isdigit.c)
 *     islower @ 0x1401448AC (islower.c)
 *     isxdigit @ 0x14014492C (isxdigit.c)
 */
...
LABEL_51:
  *Terminator = S;
  Addr->S_un.S_addr = _byteswap_ulong(v25);
  return 0;
}
