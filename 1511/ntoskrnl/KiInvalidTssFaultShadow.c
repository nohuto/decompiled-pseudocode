/*
 * XREFs of KiInvalidTssFaultShadow @ 0x140224500
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall __noreturn KiInvalidTssFaultShadow(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, char a6)
{
