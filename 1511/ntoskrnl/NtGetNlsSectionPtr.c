...
NTSTATUS __fastcall NtGetNlsSectionPtr(int a1, unsigned int a2, unsigned __int64 a3, PVOID *a4, ULONG_PTR *a5)
{
  ...
  v12 = v9;
  result = RtlpInitNlsSectionName(a1, a2, v30, (__int64)a4, &v27);
  if ( result >= 0 )
  {
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    else
    {
      ...
      if ( v14 < 0 )
      {
        result = RtlpInitNlsFileName(a1, a2, v31, v15, &v26);
        if ( result < 0 )
          return result;
        v28.Length = 48;
