/*
 * XREFs of DrvDbGetDriverDatabaseMappedProperty @ 0x1405422FC
 * Callers:
...
LABEL_14:
    ...
    if ( a3 && (!v9 || ((__int64)v9[3].Buffer & 0x10) == 0)
      || (!v9 || ((__int64)v9[3].Buffer & 0x10) == 0
        ...
        : (v36 = DrvDbOpenObjectRegKey((__int64 **)a1, *(__int64 **)(a1 + 32), 1u, a2, 1, 0, &Handle, 0LL)),
          DatabaseNode = v36,
          v36 >= 0) )
    {
      if ( Handle )
