/*
 * XREFs of DrvDbSetDriverPackageMappedProperty @ 0x14069C28C
 * Callers:
 ...
 *     DrvDbGetDriverPackageSignerName @ 0x14069B3FC (DrvDbGetDriverPackageSignerName.c)
 *     DrvDbSetDriverPackageMappedProperty @ 0x14069C28C (DrvDbSetDriverPackageMappedProperty.c)
        ...
        unsigned int a7)
{
  ...
  if ( v21 )
  {
    ...
    if ( a3 )
      v25 = a3;
    v26 = PnpCtxRegQueryValue(v23, v25, L"Version", &v51, PoolWithTag, &v58);
    v13 = v26;
    if ( v26 == -1073741772 )
    {
...
LABEL_38:
        ...
        if ( a3 )
          v30 = a3;
        v31 = PnpCtxRegSetValue(v29, v30, (__int64)L"Version", 3LL, (__int64)v24, 0x30u);
LABEL_104:
        v13 = v31;
        goto LABEL_105;
      }
...
LABEL_100:
  ...
  if ( a5 == 7 )
  {
    ...
    if ( *v33 == 218103811 )
    {
      ...
      if ( a3 )
        v39 = a3;
      if ( (unsigned int)DrvDbGetDriverPackageSignerName((__int64)v33, v34, (__int64)v39, 0LL, 0, &v58) == -1073741789
        && v58 == 18 )
      {
...
LABEL_28:
        ...
        if ( a3 )
          v43 = a3;
        if ( (int)DrvDbGetDriverPackageSignerName(v41, v40, (__int64)v43, P, 18, &v58) >= 0
          && v58
          && !v42[v58 - 1]
...
LABEL_101:
  ...
  if ( a3 )
    v46 = a3;
  if ( (unsigned int)DrvDbGetDriverPackageSignerName((__int64)v33, 0LL, (__int64)v46, 0LL, 0, &v58) != -1073741275 )
    goto LABEL_101;
  v47 = (int)Handle;
  if ( a3 )
    v47 = (int)a3;
