/*
 * XREFs of PfTCreateTraceDump @ 0x140483950
 * Callers:
...
__int64 __fastcall PfTCreateTraceDump(_QWORD *a1)
{
  ...
  v5 = 0;
  v6 = 0;
  for ( i = 0; (__int64 *)v2 != &qword_1403024D8; v2 = *(_QWORD *)v2 )
    i += *(_DWORD *)(v2 + 32);
  v8 = 2LL * i;
  ...
  *(_QWORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 8) = PoolWithTag;
  ...
  v10 = qword_1403024E0;
  v11 = &qword_1403024B0;
  *(_WORD *)(((unsigned __int64)&v71 & 0xFFFFFFFFFFFFFFE0uLL) + 2) = *(_WORD *)(qword_1403024E0 + 36);
  do
  {
    v11 = (__int64 *)v11[1];
    v12 = 0;
      ...
      do
      {
        ...
        if ( v18 != 0xFFFF )
        {
          ...
          if ( v18 < v19 || v18 >= (unsigned int)v19 + *(_DWORD *)(v3 + 32) )
          {
            ...
            {
              v69 = *(_QWORD *)(v69 + 8);
              if ( (__int64 *)v69 == &qword_1403024D8 )
                v69 = v10;
              if ( v69 == v3 )
                break;
              v70 = *(_WORD *)(v69 + 36);
...
LABEL_26:
  ...
  while ( v11 != (__int64 *)qword_1403024B0 );
  if ( v5 )
  {
    v26 = 16 * v5;
    v27 = 32 * v6;
              ...
              do
              {
                ...
                if ( v48 != 0xFFFF )
                {
                  ...
                  if ( v48 < v49 || v48 >= (unsigned int)v49 + *(_DWORD *)(v3 + 32) )
                  {
                    ...
                    {
                      v67 = *(_QWORD *)(v67 + 8);
                      if ( (__int64 *)v67 == &qword_1403024D8 )
                        v67 = v45;
                      if ( v67 == v3 )
                        break;
                      v68 = *(_WORD *)(v67 + 36);
...
LABEL_53:
        ...
        if ( v33 == (__int64 *)qword_1403024B0 )
          break;
        v4 = 0;
      }
...
LABEL_63:
  PfTFreeBufferList(&unk_140302498);
  PfTFreeBufferList(&unk_1403024C0);
  return v58;
}
