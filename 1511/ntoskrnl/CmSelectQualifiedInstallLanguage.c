/*
 * XREFs of CmSelectQualifiedInstallLanguage @ 0x14075424C
 * Callers:
...
__int64 __fastcall CmSelectQualifiedInstallLanguage(__int64 a1, unsigned int a2, _DWORD *a3, int a4)
{
  ...
  if ( a3 )
  {
    *a3 = 0;
    ...
    if ( v10 != -1 )
    {
      v11 = qword_14071A138(&CmControlHive, v10, &Size_4);
      if ( v11 )
      {
        RtlInitUnicodeString(&DestinationString, L"PreferredUILanguages");
        ValueByName = CmpFindValueByName((__int64)&CmControlHive, v11);
        v13 = ValueByName;
        if ( ValueByName != -1 )
        {
          v27 = qword_14071A138(&CmControlHive, ValueByName, &v34);
          if ( v27 )
          {
            if ( *(_DWORD *)(v27 + 12) == 7 )
            {
              ...
              if ( v28 )
              {
                ...
                qword_14071A140(&CmControlHive, &v40);
              }
            }
            qword_14071A140(&CmControlHive, &v34);
          }
        }
        qword_14071A140(&CmControlHive, &Size_4);
      }
    }
    v14 = CmpWalkPath((__int64)&CmControlHive, a2, L"MUI\\UILanguages");
    if ( v14 == -1 )
      return v9;
    v15 = (_DWORD *)qword_14071A138(&CmControlHive, v14, &v39);
    v32 = v15;
    if ( !v15 )
      return v9;
    v9 &= ~2u;
LABEL_12:
    ...
    while ( 1 )
    {
      ...
      if ( v41 == -1 )
        break;
      v18 = qword_14071A138(&CmControlHive, v41, &v33);
      v15 = v32;
      if ( v18 )
      {
        RtlInitUnicodeString(&DestinationString, L"Type");
        v19 = CmpFindValueByName((__int64)&CmControlHive, v18);
        v20 = v19;
        if ( v19 == -1 )
          goto LABEL_58;
        v21 = qword_14071A138(&CmControlHive, v19, &v34);
        if ( !v21 )
          goto LABEL_58;
        if ( *(_DWORD *)(v21 + 12) == 4 )
        {
          ...
          if ( (v22 & 3) != 0 )
            v16 = (v22 & 0x10) != 0;
          qword_14071A140(&CmControlHive, (char *)&v40 + 4);
        }
        qword_14071A140(&CmControlHive, &v34);
        if ( !v16 )
          goto LABEL_58;
...
LABEL_58:
          qword_14071A140(&CmControlHive, &v33);
          v15 = v32;
          v4 = v31;
          v7 = v29;
        }
...
LABEL_42:
    ...
    qword_14071A140(&CmControlHive, &v39);
    if ( v7 || v8 )
      v9 &= ~4u;
    if ( v30 )
    {
