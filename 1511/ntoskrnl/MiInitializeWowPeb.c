/*
 * XREFs of MiInitializeWowPeb @ 0x140461E70
 * Callers:
...
__int64 __fastcall MiInitializeWowPeb(__int64 a1, __int64 a2, __int64 a3, __int64 a4, __int64 a5)
{
  ...
  BOOLEAN MappedAsImage; // [rsp+B8h] [rbp+20h]

  if ( *(_QWORD *)(a4 + 1064) )
  {
    result = MmCheckImageMapping(a4);
    if ( (int)result < 0 )
      return result;
    ...
    *(_DWORD *)(a1 + 8) = *(unsigned __int16 *)(a2 + 74);
    ...
    if ( v12 )
    {
      ...
      if ( (v14 & qword_1403825B8[*(unsigned __int16 *)(a5 + 8)]) != v14 )
        v14 = 0LL;
      *(_QWORD *)a5 = v14;
    }
  }
  ...
  if ( (int)result >= 0 )
  {
    ...
    {
      result = MmGetSectionInformation(*(_QWORD *)(a4 + 952), 1);
      if ( (int)result < 0 )
        return result;
    ...
    *(_QWORD *)(v17 + 112) = qword_1402FE690;
    *(_DWORD *)(v17 + 520) = dword_140381114;
    *(_DWORD *)(v17 + 144) = *(_DWORD *)(a1 + 72);
    *(_DWORD *)(v17 + 128) = qword_140381128;
    *(_DWORD *)(v17 + 132) = qword_140381120;
