/*
 * XREFs of KeSetTimeAdjustment @ 0x1401C3FD8
 * Callers:
 ...
 *     RtlGenerateQpcToIncrementConstants @ 0x14014036C (RtlGenerateQpcToIncrementConstants.c)
 */
...
__int64 __fastcall KeSetTimeAdjustment(unsigned int a1)
{
  ...
  if ( v3 - 2 <= 0xFFFFFFFD )
  {
    v5 = RtlGenerateQpcToIncrementConstants(v3, &v7);
    v6 = v7;
