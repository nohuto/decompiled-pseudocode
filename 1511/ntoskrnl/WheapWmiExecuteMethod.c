/*
 * XREFs of WheapWmiExecuteMethod @ 0x14021759C
 * Callers:
 *     WheaWmiDispatch @ 0x140141638 (WheaWmiDispatch.c)
 * Callees:
 *     WheapWmiExecuteErrorInjectionMethod @ 0x1402170E8 (WheapWmiExecuteErrorInjectionMethod.c)
