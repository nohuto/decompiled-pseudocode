/*
 * XREFs of KsepDsEventDriverLoad @ 0x1401CDCD0
 * Callers:
 *     KseDsHookDriverTargeted @ 0x1401CD6F4 (KseDsHookDriverTargeted.c)
 * Callees:
...
char __fastcall KsepDsEventDriverLoad(unsigned __int16 *a1, __int64 a2, int a3, int a4, char a5)
{
  ...
  if ( KseEtwHandle )
  {
    ...
    if ( (_BYTE)v5 )
    {
      ...
      v21 = 4;
      v12 = 8;
      LOBYTE(v5) = EtwWrite(v6, &KseDsEventDriverLoad, 0LL, 5u, &UserData);
    }
  }
  return (char)v5;
}
