/*
 * XREFs of ExpGetDeviceDataInformation @ 0x14066ABBC
 * Callers:
...
__int64 __fastcall ExpGetDeviceDataInformation(int a1, unsigned __int64 a2, int a3)
{
  ...
  const WCHAR *v15; // [rsp+A8h] [rbp+20h] BYREF
  ...
  *(_OWORD *)Length = *(_OWORD *)(a2 + 32);
  ...
  if ( v6 >= 0 )
  {
    if ( a1 != 136 || (v6 = ExpStringCapture(&v15, &v12), v6 >= 0) )
    {
      ...
      if ( a1 == 136 )
        DeviceData = KseQueryDeviceData((WCHAR *)SourceString, v15, Length, (_DWORD *)Length + 1, PoolWithQuotaTag);
      else
