/*
 * XREFs of CmpRundownUnitOfWork @ 0x1403DE734
 * Callers:
...
_QWORD *__fastcall CmpRundownUnitOfWork(_QWORD *BugCheckParameter4)
{
  ...
  if ( (_QWORD *)*BugCheckParameter4 != BugCheckParameter4 )
  {
    ...
    v6 = (_QWORD *)BugCheckParameter4[1];
    if ( *(_QWORD **)(*BugCheckParameter4 + 8LL) != BugCheckParameter4 || (_QWORD *)*v6 != BugCheckParameter4 )
      __fastfail(3u);
    *v6 = v5;
    *(_QWORD *)(v5 + 8) = v6;
