/*
 * XREFs of NormBuffer__LastStartBasePair @ 0x1401FB168
 * Callers:
 *     Normalization__NormalizeCharacter @ 0x14064BE24 (Normalization__NormalizeCharacter.c)
 * Callees:
 *     NormBuffer__LastStartBase @ 0x1401FB140 (NormBuffer__LastStartBase.c)
 *     Normalization__CanCombinableCharactersCombine @ 0x14064B0BC (Normalization__CanCombinableCharactersCombine.c)
 *     Normalization__GetSecondDecomposedCharPlane0 @ 0x14064B4C8 (Normalization__GetSecondDecomposedCharPlane0.c)
 */
