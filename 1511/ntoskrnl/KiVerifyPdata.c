/*
 * XREFs of KiVerifyPdata @ 0x140767708
 * Callers:
...
__int64 __fastcall KiVerifyPdata(ULONG_PTR BugCheckParameter2)
{
  ...
  if ( BugCheckParameter2 < *(&xmmword_1402CFDD0 + 1)
    || BugCheckParameter2 >= *(&xmmword_1402CFDD0 + 1) + (unsigned int)qword_1402CFDE0 )
  {
    v2 = (unsigned int *)RtlpxLookupFunctionTable(BugCheckParameter2, &v7);
  }
  else
  {
    v2 = (unsigned int *)xmmword_1402CFDD0;
    BugCheckParameter3 = qword_1402CFDE0;
  }
  result = v9;
  if ( v2 )
  {
