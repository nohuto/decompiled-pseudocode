/*
 * XREFs of MfgInitSystem @ 0x1407720A4
 * Callers:
...
__int64 __fastcall MfgInitSystem(__int64 a1)
{
  ...
  LODWORD(qword_1402D6368) = *(_DWORD *)(v2 + 2456);
  PoolWithTag = ExAllocatePoolWithTag(PagedPool, WORD1(qword_1402D6368), 0x5067664Du);
  qword_1402D6370 = PoolWithTag;
  if ( PoolWithTag )
  {
    inited = RtlStringCbCopyW((NTSTRSAFE_PWSTR)PoolWithTag, WORD1(qword_1402D6368), *(NTSTRSAFE_PCWSTR *)(v2 + 2464));
    if ( inited < 0 )
      goto LABEL_22;
    ...
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    ObjectAttributes.ObjectName = (PUNICODE_STRING)&qword_1402D6368;
    *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
    ...
    inited = ZwSetValueKey(KeyHandle, &ValueName, 0, 1u, qword_1402D6370, WORD1(qword_1402D6368));
    if ( inited < 0 )
      goto LABEL_22;
