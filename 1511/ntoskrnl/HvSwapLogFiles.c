/*
 * XREFs of HvSwapLogFiles @ 0x1404BF75C
 * Callers:
...
__int64 __fastcall HvSwapLogFiles(__int64 a1)
{
  ...
  if ( stru_1402CFD30.LevelPlus1 > 5 && TlgKeywordOn(&stru_1402CFD30, 0x200000000000uLL) )
  {
    v10 = *(_DWORD *)(a1 + 1400);
    v23 = 0;
    v26 = 0;
    ...
    v40 = 4;
    v43 = 8;
    TlgWrite(&stru_1402CFD30, &unk_1402535FC, 0LL, 0LL, 0xAu, &pData);
  }
  v8 = *(_DWORD *)(a1 + 148) - 4;
  *(_QWORD *)(a1 + 176) = v3;
  *(_DWORD *)(a1 + 160) = 0;
