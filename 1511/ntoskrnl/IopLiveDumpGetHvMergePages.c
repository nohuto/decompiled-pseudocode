/*
 * XREFs of IopLiveDumpGetHvMergePages @ 0x1405FD484
 * Callers:
...
char __fastcall IopLiveDumpGetHvMergePages(__int64 a1, unsigned __int64 *a2, _QWORD *a3, _DWORD *a4, __int64 *a5)
{
  ...
  else
  {
    ...
    *(_QWORD *)(a1 + 232) = v5 + v14;
    v19 = (__int64 *)((v17 << 12) + *(_QWORD *)(*(_QWORD *)(a1 + 552) + 8 * v15) + 8LL * *(unsigned int *)(a1 + 224));
    if ( (_DWORD)v14 )
    {
      do
      {
        ...
        *a2 = v20;
        ...
        else
        {
          ...
          *(_DWORD *)(a1 + 224) = 0;
          v19 = (__int64 *)(*(_QWORD *)(*(_QWORD *)(a1 + 552) + 8LL * *(_QWORD *)(a1 + 208))
                          + (*(_QWORD *)(a1 + 216) << 12));
        }
        ++a2;
        --v18;
