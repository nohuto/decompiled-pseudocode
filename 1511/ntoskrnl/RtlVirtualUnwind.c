/*
 * XREFs of RtlVirtualUnwind @ 0x1400F0A68
 * Callers:
...
LABEL_5:
  ...
  else
  {
    ...
    if ( *(_BYTE *)(v9 + 2) )
    {
      do
      {
        v66 = *(unsigned __int16 *)(v9 + 2LL * v65 + 4);
        if ( (BYTE1(v66) & 0xF) == 3 )
          break;
  ...
  if ( v15 >= 2 )
  {
    if ( *(_BYTE *)(v9 + 2) )
    {
      ...
      if ( (HIBYTE(v43) & 0xF) == 6 )
      {
        ...
        if ( (v43 & 0x1000) != 0 )
        {
          v46 = v10->EndAddress - (unsigned __int8)v43;
          if ( v45 - v46 < (unsigned int)(unsigned __int8)v43 )
          {
LABEL_97:
            RtlpUnwindEpilogue(v12, ControlPc, v45 - v46, (_DWORD)v10, (__int64)v17, (__int64)ContextPointers, 0LL, 0LL);
            return v8;
          }
        }
        for ( i = 1; i < *(unsigned __int8 *)(v9 + 2); ++i )
        {
          v48 = *(_WORD *)(v9 + 2LL * i + 4);
          if ( (HIBYTE(v48) & 0xF) != 6 )
            break;
          v49 = (unsigned __int8)v48 + (HIBYTE(v48) >> 4 << 8);
          if ( !v49 )
            break;
          v46 = v10->EndAddress - v49;
          if ( v45 - v46 < v44 )
            goto LABEL_97;
        }
      }
...
LABEL_74:
    ...
    if ( *(_BYTE *)(ControlPc + 1) != 0x8D )
      goto LABEL_76;
    v58 = *(_BYTE *)(ControlPc + 2) & 7 | (8 * (v56 & 1));
    if ( !v58 || v58 != (*(_BYTE *)(v9 + 3) & 0xF) )
      goto LABEL_76;
...
LABEL_144:
  ...
  v59 = *(_BYTE *)(ControlPc + 1);
  if ( v59 != -125 || *(_BYTE *)(ControlPc + 2) != 0xC4 )
  {
    if ( v59 == -127 && *(_BYTE *)(ControlPc + 2) == 0xC4 )
      goto LABEL_144;
    goto LABEL_74;
  }
LABEL_148:
  for ( j = (_BYTE *)(ControlPc + 4); ; j += 2 )
  {
LABEL_76:
    while ( (*j & 0xF8) == 0x58 )
      ++j;
  ...
  if ( *j == 0xF2 )
    ++j;
  v60 = *j;
  if ( (unsigned __int8)(*j + 62) <= 1u || v60 == -13 && j[1] == 0xC3 )
  {
LABEL_163:
    v76 = (char *)ControlPc;
  ...
  while ( 1 )
  {
    ...
    if ( v22[2] )
    {
      do
      {
        ...
        {
          v61 = RtlpUnwindOpSlots(*(unsigned __int16 *)&v22[2 * (unsigned int)v24 + 4]);
          v19 = v90;
          LODWORD(v24) = v61 + v24;
        }
        else
...
LABEL_204:
                    ...
                    if ( ControlPc <= (unsigned __int64)MmHighestUserAddress )
                    {
                      if ( ((unsigned __int8)v41 & 3) != 0 )
                        ExRaiseDatatypeMisalignment();
                      if ( ControlPc <= (unsigned __int64)MmHighestUserAddress && ((unsigned __int8)v42 & 3) != 0 )
                        ExRaiseDatatypeMisalignment();
                    }
                    v17->Rip = *v41;
                    v17->Rsp = *v42;
          ...
          else if ( (v22[2 * (unsigned int)v24 + 5] & 0xF) != 0 )
          {
            ...
            if ( v28 )
            {
              ...
              if ( v29 )
              {
                ...
                {
                  v53 = *(&v17->Rax + (v22[3] & 0xF));
                  v17->Rsp = v53;
                  v17->Rsp = v53 - (v22[3] & 0xF0);
                }
              }
              else
              {
    ...
    if ( (*v22 & 0x20) == 0 )
      break;
    v50 = (unsigned __int8)v22[2];
    if ( (v50 & 1) != 0 )
      ++v50;
    v10 = (PRUNTIME_FUNCTION)&v22[2 * v50 + 4];
