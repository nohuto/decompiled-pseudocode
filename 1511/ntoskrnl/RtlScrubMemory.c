/*
 * XREFs of RtlScrubMemory @ 0x1401FC4F0
 * Callers:
 ...
 *     RtlpGenericRandomPatternWorker @ 0x1401FCB3C (RtlpGenericRandomPatternWorker.c)
 *     RtlpGenericStrideWorker @ 0x1401FCE4C (RtlpGenericStrideWorker.c)
 */
