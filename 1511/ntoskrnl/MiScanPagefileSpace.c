/*
 * XREFs of MiScanPagefileSpace @ 0x140625888
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MiScanPagefileSpace(__int64 a1)
{
  __int16 v1; // r12
  int v2; // ebp
  _DWORD *v4; // r15
  ...
  do
  {
    ...
    if ( v5 < v6 )
    {
      ...
      {
        v8 = *(_QWORD *)(v7 + 24);
        if ( ((HIDWORD(v8) >> 8) & 0x3FF) == v1 )
        {
          v9 = *(_BYTE *)(v7 + 18);
          if ( (((v9 & 7) - 2) & 0xFA) == 0
            && (v9 & 7) != 6
            && (*(_DWORD *)v7 & 0x400LL) == 0
            && (unsigned int)MI_GET_PAGING_FILE_OFFSET(v7)
            && (v8 & 0xFFFFFFFFFLL) != 0xFFFFFFFFDLL
            && *(_WORD *)(v7 + 16)
            && (v9 & 0x28) == 0
            && (*(_BYTE *)(v7 + 19) & 0x10) == 0 )
          {
