/*
 * XREFs of ?StDeviceIoIssue@?$ST_STORE@USM_TRAITS@@@@SAJPEAU_ST_DATA_MGR@1@PEAU_PF_QUEUE@@@Z @ 0x140204540
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StDeviceIoIssue(__int64 a1, __int64 *a2)
{
  ...
  while ( 1 )
  {
    ...
    *a2 = *(_QWORD *)*a2 & 0xFFFFFFFFFFFFFFF8uLL;
    ...
    v9 = (16 * (v7 & *(_DWORD *)(a1 + 160))) & ~(*(_DWORD *)(a1 + 144) - 1);
    v10 = v7 >> *(_DWORD *)(a1 + 164);
    v11 = *(_DWORD *)(v6 + 28);
    v12 = v11 >> 5;
    if ( *(_QWORD *)(a1 + 1080) && (v11 & 4) == 0 )
      *(LARGE_INTEGER *)(v8 + 1) = KeQueryPerformanceCounter(0LL);
    StEtaIoStart(*(_QWORD *)(a1 + 440), v12, 0LL, (v6 + 8) | (*(_DWORD *)(v6 + 28) >> 3) & 1);
    *(_DWORD *)(v6 + 28) |= 8u;
    v4 = SmIssueIo(
           *(_QWORD *)(a1 + 152),
           v10,
           v9,
           v12,
           ~(*(unsigned int *)(a1 + 144) - 1LL) & ((unsigned __int64)&v8[4 * *v8 + 2] + *(unsigned int *)(a1 + 144) + 3),
           v6 | 1);
    if ( v4 < 0 )
    {
      *(_DWORD *)(v6 + 28) |= 1u;
