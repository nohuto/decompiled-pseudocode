/*
 * XREFs of RtlpGenericInverseCouplingWorker @ 0x1401FC790
 * Callers:
 *     RtlScrubMemory @ 0x1401FC4F0 (RtlScrubMemory.c)
 * Callees:
 *     RtlpTestAndFillMemoryUp @ 0x1401FCFF4 (RtlpTestAndFillMemoryUp.c)
 *     RtlpTestMemory @ 0x1401FD014 (RtlpTestMemory.c)
 */
