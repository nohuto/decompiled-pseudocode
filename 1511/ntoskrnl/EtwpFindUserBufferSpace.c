/*
 * XREFs of EtwpFindUserBufferSpace @ 0x1404CB178
 * Callers:
 *     EtwpRealtimeInjectEtwBuffer @ 0x1404CAF98 (EtwpRealtimeInjectEtwBuffer.c)
 * Callees:
 *     RtlFindNextAlignedForwardRunClear @ 0x1400F49FC (RtlFindNextAlignedForwardRunClear.c)
 *     RtlInterlockedSetClearRun @ 0x1400F4B10 (RtlInterlockedSetClearRun.c)
