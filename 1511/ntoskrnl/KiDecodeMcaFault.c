/*
 * XREFs of KiDecodeMcaFault @ 0x14014D4C0
 * Callers:
 *     KiMachineCheckControl @ 0x14015DD20 (KiMachineCheckControl.c)
 * Callees:
 *     KeTestSpinLock @ 0x1400CFE90 (KeTestSpinLock.c)
...
__int64 KiDecodeMcaFault()
{
  ...
  if ( !KeTestSpinLock((PKSPIN_LOCK)CompleteDev + 174) )
    return (*((__int64 (__fastcall **)(_BYTE *, _QWORD))CompleteDev + 71))(CompleteDev + 1392, 0LL);
  v2 = *((unsigned int *)CompleteDev + 341);
  v3 = *((_QWORD *)CompleteDev + 167);
  v4 = (__int64 (__fastcall *)(__int64, __int64, _QWORD, __int64))*((_QWORD *)CompleteDev + 31);
  v5 = *((unsigned int *)CompleteDev + 336);
