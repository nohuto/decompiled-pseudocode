/*
 * XREFs of KiExceptionDispatch @ 0x140165BC0
 * Callers:
...
__int64 __fastcall KiExceptionDispatch(int a1, unsigned int a2, void *a3, unsigned __int64 a4, char a5)
{
  ...
  _DWORD v28[12]; // [rsp+0h] [rbp-1D8h] BYREF
  __int128 v29; // [rsp+30h] [rbp-1A8h]
  __int128 v30; // [rsp+40h] [rbp-198h]
  __int128 v31; // [rsp+50h] [rbp-188h]
  __int128 v32; // [rsp+60h] [rbp-178h]
  __int128 v33; // [rsp+70h] [rbp-168h]
  __int128 v34; // [rsp+80h] [rbp-158h]
  __int128 v35; // [rsp+90h] [rbp-148h]
  __int128 v36; // [rsp+A0h] [rbp-138h]
  __int128 v37; // [rsp+B0h] [rbp-128h]
  __int128 v38; // [rsp+C0h] [rbp-118h]
  int v39; // [rsp+D0h] [rbp-108h]
  int v40; // [rsp+D8h] [rbp-100h]
  int v41; // [rsp+E0h] [rbp-F8h]
  int v42; // [rsp+E8h] [rbp-F0h]
  int v43; // [rsp+F0h] [rbp-E8h]
  int v44; // [rsp+F8h] [rbp-E0h]
  __int64 v45; // [rsp+100h] [rbp-D8h]
  __int64 v46; // [rsp+108h] [rbp-D0h]
  __int64 v47; // [rsp+110h] [rbp-C8h]
  __int64 v48; // [rsp+118h] [rbp-C0h]
  __int64 v49; // [rsp+120h] [rbp-B8h]
  ...
  KiDispatchException(&ExceptionRecord, (__int64)v28, v6 - 128, *(_BYTE *)(v6 + 240) & 1, 1);
  _disable();
  if ( (*(_BYTE *)(v6 + 240) & 1) == 0 )
  {
