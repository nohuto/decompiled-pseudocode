/*
 * XREFs of VfXdvDriverCaptureIoCallbacks @ 0x1406B2474
 * Callers:
  ...
  if ( !*(_QWORD *)&DriverExtension[1].ServiceKeyName.Length )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      *v5 = a1->DriverInit;
      ...
      v8 = (__int64 (__fastcall **)(__int64, __int64))(v5 + 4);
      do
      {
        v9 = *(__int64 (__fastcall **)(__int64, __int64))((char *)v8 + (char *)a1 - (char *)v5 + 80);
      ...
      DriverStartIo = (__int64 (__fastcall *)(__int64, __int64))a1->DriverStartIo;
