/*
 * XREFs of WdipSemLoadScenarioTable @ 0x140533138
 * Callers:
 ...
 *     WdipSemUpdateProviderEntriesForScenario @ 0x140533AFC (WdipSemUpdateProviderEntriesForScenario.c)
 *     WdipSemUpdateProviderTableWithScenario @ 0x140533BAC (WdipSemUpdateProviderTableWithScenario.c)
 *     WdipSemEnableAllProviders @ 0x140533D04 (WdipSemEnableAllProviders.c)
 *     WdipSemAddScenarioToTable @ 0x140533E04 (WdipSemAddScenarioToTable.c)
...
LABEL_14:
        if ( (int)WdipSemOpenRegistryKey(L"Instrumentation") >= 0 )
        {
          ...
          while ( 1 )
          {
            ...
            if ( (unsigned int)dword_1402DA9E0 >= 0x40 )
              break;
            v9 = dword_1402DA780;
