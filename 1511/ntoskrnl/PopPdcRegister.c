/*
 * XREFs of PopPdcRegister @ 0x1405495D4
 * Callers:
...
__int64 __fastcall PopPdcRegister(__int64 a1, _QWORD *a2)
{
  ...
  if ( a2 )
  {
    ...
    *(_OWORD *)&xmmword_1402DDFD0 = *(_OWORD *)(a1 + 24);
    *(_OWORD *)&xmmword_1402DDFE0 = *(_OWORD *)(a1 + 40);
    *(_OWORD *)&xmmword_1402DDFF0 = *(_OWORD *)(a1 + 56);
    *(_OWORD *)&xmmword_1402DE000 = *(_OWORD *)(a1 + 72);
    *(_OWORD *)&xmmword_1402DE010 = *(_OWORD *)(a1 + 88);
    qword_1402DE020 = *(_QWORD *)(a1 + 104);
    *a2 = PdcPoResiliencyClient;
    ...
    a2[19] = PdcPoQueryExpectedStandbyTime;
