/*
 * XREFs of IoWritePartitionTable @ 0x1405F5BF8
 * Callers:
 *     FstubWritePartitionTableMBR @ 0x1405F6578 (FstubWritePartitionTableMBR.c)
 *     VerifierIoWritePartitionTable @ 0x1406C08AC (VerifierIoWritePartitionTable.c)
 * Callees:
 ...
 *     HalpCalculateChsValues @ 0x1405F5AE8 (HalpCalculateChsValues.c)
 */
