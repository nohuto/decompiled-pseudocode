/*
 * XREFs of RtlFindClearBitsAndSet @ 0x140006F80
 * Callers:
...
LABEL_50:
      while ( 1 )
      {
        ...
        v35 = &v15[(unsigned __int64)(NumberToFind - v33) >> 6];
        while ( ++v15 != v35 )
        {
          if ( *v15 )
            goto LABEL_59;
        ...
        if ( !v36 )
          goto LABEL_14;
        v26 = !_BitScanForward64((unsigned __int64 *)&v37, *v15);
        if ( v26 )
          LODWORD(v37) = 64;
...
LABEL_59:
        ...
        while ( *v15 );
        v26 = !_BitScanReverse64((unsigned __int64 *)&v38, *(v15 - 1));
        if ( v26 )
          goto LABEL_82;
        v33 = 63 - v38;
      }
...
LABEL_38:
    ...
    while ( 1 )
    {
      while ( 1 )
      {
        ...
        v26 = !_BitScanReverse64((unsigned __int64 *)&v39, v16);
        if ( !v26 )
          v18 = 63 - v39;
        ...
        if ( v40 >= 0x40 )
          break;
LABEL_71:
        v26 = !_BitScanForward64((unsigned __int64 *)&v41, v16);
        if ( v26 )
          LODWORD(v41) = 64;
