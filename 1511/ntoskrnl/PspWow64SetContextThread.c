...
__int64 __fastcall PspWow64SetContextThread(__int64 a1, _DWORD *a2, int a3, char a4)
{
  __int64 v5; // rdi
  ULONG_PTR v7; // r12
  _DWORD *v8; // rcx
  ...
  if ( (int)result >= 0 )
  {
    ...
    result = RtlGetExtendedContextLength(*(unsigned int *)&v30[3]);
    if ( (int)result >= 0 )
    {
      ...
      result = RtlInitializeExtendedContext((__int64)&v29, v11, &v31);
      if ( (int)result >= 0 )
      {
        v18 = v31;
        result = RtlpReadExtendedContext(v17, 1, v31, v11, v5, 0LL);
        if ( (int)result >= 0 )
        {
LABEL_14:
            ...
            if ( (int)result >= 0 )
            {
              ...
              else
              {
                ...
                if ( (int)result >= 0 )
                {
                  ...
                  v22 = alloca(v21);
                  v23 = alloca(v21);
                  result = RtlInitializeExtendedContext((__int64)&v29, 0x10001Fu, &v33);
                  if ( (int)result >= 0 )
                  {
                    result = PspGetContextThreadInternal(a1, (__int64)&v29, 0, 1, 1);
                    if ( (int)result >= 0 )
                    {
                      result = v19 ? RtlCopyContext(v36, *v16, v16) : RtlpWow64SetContextOnAmd64(v36, &v29, v16, &v29);
                      if ( (int)result >= 0 )
                      {
                        if ( v36[2] != 35
