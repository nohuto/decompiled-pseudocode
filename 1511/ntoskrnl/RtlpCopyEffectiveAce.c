/*
 * XREFs of RtlpCopyEffectiveAce @ 0x140471F40
 * Callers:
        ...
        _BYTE *a16)
{
  ...
  void *v68; // [rsp+70h] [rbp-69h]
  __int64 v69; // [rsp+78h] [rbp-61h]
  unsigned __int8 *v70; // [rsp+80h] [rbp-59h]
