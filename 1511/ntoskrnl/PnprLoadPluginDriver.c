/*
 * XREFs of PnprLoadPluginDriver @ 0x140610774
 * Callers:
...
__int64 __fastcall PnprLoadPluginDriver(char **a1, _DWORD *a2)
{
  ...
  if ( PluginDriverImagePath < 0 )
    goto LABEL_26;
  v5 = MmLoadSystemImage(&DestinationString, 0LL, 0LL, 2, &v16, &v17);
  v6 = v16;
