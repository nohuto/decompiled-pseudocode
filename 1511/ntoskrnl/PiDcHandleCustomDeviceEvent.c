/*
 * XREFs of PiDcHandleCustomDeviceEvent @ 0x1404E218C
 * Callers:
...
__int64 __fastcall PiDcHandleCustomDeviceEvent(__int64 a1)
{
  ...
  wchar_t pszSrc[40]; // [rsp+B0h] [rbp-50h] BYREF
  ...
  if ( !v4 )
  {
    ...
    {
      DeviceRelations = PnpQueryDeviceRelations(*(_QWORD *)(a1 + 144), 6, 0LL, (__int64)&v21);
      if ( DeviceRelations >= 0 )
      {
        v6 = v21;
        if ( !v21 )
                ...
                if ( v14 )
                {
                  ...
                  if ( DeviceRegProp != -1073741275 )
                  {
                    ...
                    if ( wcsicmp(pszSrc, Str2) )
                    {
                      ...
                      {
                        DeviceRelations = CmMoveBaseContainer(v17, v26, pszSrc, Str2);
