/*
 * XREFs of MmGetSessionMappedViewInformation @ 0x1406213A0
 * Callers:
...
__int64 __fastcall MmGetSessionMappedViewInformation(unsigned __int64 a1, unsigned int a2, _DWORD *a3, _DWORD *a4)
{
  ...
  struct _MDL *v20; // [rsp+40h] [rbp-39h] BYREF
  ...
  if ( a2 )
  {
    result = ExLockUserBuffer(a1, a2, KeGetCurrentThread()->PreviousMode, IoWriteAccess, &v18, &v20);
    if ( (int)result < 0 )
      return result;
    v7 = v18;
  }
    ...
    if ( *v21 == -1 || SessionId == *v21 )
    {
      if ( (int)MmAttachSession((ULONG_PTR)v13) >= 0 )
      {
        ...
        if ( v15 <= a2 )
        {
          ...
          MiGetSystemPteStatistics(v16 + 7824, &v22, &v23);
