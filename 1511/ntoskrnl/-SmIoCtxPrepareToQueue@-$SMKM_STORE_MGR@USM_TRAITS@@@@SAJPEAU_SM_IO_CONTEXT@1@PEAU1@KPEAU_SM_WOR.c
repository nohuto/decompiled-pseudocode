/*
 * XREFs of ?SmIoCtxPrepareToQueue@?$SMKM_STORE_MGR@USM_TRAITS@@@@SAJPEAU_SM_IO_CONTEXT@1@PEAU1@KPEAU_SM_WORK_ITEM@1@PEAU_SM_QUEUE_CONTEXT@1@@Z @ 0x14010E5D8
 * Callers:
  ...
  *(_QWORD *)&v19 = 0LL;
  ...
  if ( (v9 & 0xFFFFFFFD) == 0 )
  {
    ...
    if ( (v13 & 2) != 0 )
    {
      ...
      v8 = SmFpAllocate((PEX_SPIN_LOCK)(a2 + 9824), v14);
      if ( !v8 )
      {
        v16 = -1073741670;
        goto LABEL_18;
