/*
 * XREFs of LdrpResSearchResourceInsideDirectory @ 0x140465BDC
 * Callers:
 ...
 *     RtlULongLongSub @ 0x1400DC7B4 (RtlULongLongSub.c)
        ...
        _WORD *a13)
{
  ...
  ULONGLONG v72; // [rsp+60h] [rbp-C8h]
  int v73; // [rsp+68h] [rbp-C0h] BYREF
  __int16 v74; // [rsp+6Ch] [rbp-BCh]
  int v75; // [rsp+70h] [rbp-B8h]
  ULONGLONG v76; // [rsp+78h] [rbp-B0h]
  int v77; // [rsp+80h] [rbp-A8h]
  ...
  int v85; // [rsp+CCh] [rbp-5Ch]
  int v86; // [rsp+D0h] [rbp-58h]
  unsigned __int64 v87; // [rsp+D8h] [rbp-50h]
  unsigned __int64 *v88; // [rsp+E0h] [rbp-48h]
  ULONGLONG v89; // [rsp+E8h] [rbp-40h]
...
LABEL_130:
                              if ( v21 )
                              {
                                if ( v76 && RtlULongLongAdd(v13, v36, &pullResult) >= 0 )
                                {
