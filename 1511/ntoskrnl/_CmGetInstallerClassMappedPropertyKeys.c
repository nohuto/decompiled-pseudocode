/*
 * XREFs of _CmGetInstallerClassMappedPropertyKeys @ 0x1406985C8
 * Callers:
...
LABEL_19:
  ...
  while ( 2 )
  {
    ...
    if ( !a4 )
    {
      result = CmGetInstallerClassMappedPropertyFromRegValue(v35, (__int64)v36, v37, *v18, v34, 0LL, 0, &a7);
      if ( (_DWORD)result == -1073741789 || !(_DWORD)result )
      {
        v20 = 1;
      }
