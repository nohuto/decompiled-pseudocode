/*
 * XREFs of DrvDbDispatchDeviceId @ 0x1404C6A64
 * Callers:
 *     <none>
 * Callees:
...
LABEL_11:
  ...
  if ( v14 )
  {
    ...
    {
      DeviceIdMappedProperty = DrvDbDeleteObjectRegKey(v22[0], 5LL, a2, 2LL);
    }
    goto LABEL_11;
  }
  v21 = *a5;
  LODWORD(v22[0]) = 0;
  LODWORD(v9) = DrvDbOpenObjectRegKey(v10, 0LL, 5u, a2, v21, 1, a5 + 2, v22);
  if ( (int)v9 >= 0 )
