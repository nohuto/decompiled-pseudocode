/*
 * XREFs of MiTransientCombineAddress @ 0x140116E50
 * Callers:
...
__int64 __fastcall MiTransientCombineAddress(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  if ( !dword_1402FEA44 )
    return 0LL;
  v6 = ExAcquireSpinLockShared(&dword_1402FEA40);
  v7 = (_QWORD *)qword_1402FEA48;
  while ( v7 )
  {
    v8 = v7[3];
    if ( a1 > v8 )
  ...
  ExReleaseSpinLockShared(&dword_1402FEA40, v6);
  LOBYTE(v2) = v7 != 0LL;
  return v2;
}
