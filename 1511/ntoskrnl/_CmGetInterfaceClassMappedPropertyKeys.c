/*
 * XREFs of _CmGetInterfaceClassMappedPropertyKeys @ 0x140698B48
 * Callers:
...
LABEL_37:
  ...
  if ( (int)result >= 0 )
  {
    ...
    while ( 1 )
    {
      ...
      if ( a4 )
        goto LABEL_38;
      result = CmGetInterfaceClassMappedPropertyFromComposite((__int64)a1, a2, (__int64)a3, *v14, v20, 0LL, 0, &a7);
      if ( (_DWORD)result == -1073741789 || !(_DWORD)result )
      {
        v16 = 1;
      }
