/*
 * XREFs of RtlInitializeHistoryTable @ 0x14076E324
 * Callers:
 *     KiCompleteKernelInit @ 0x1403A9A9C (KiCompleteKernelInit.c)
 * Callees:
 *     RtlLookupFunctionEntry @ 0x140025E10 (RtlLookupFunctionEntry.c)
 *     RtlpFunctionAddressTableEntry @ 0x14076E408 (RtlpFunctionAddressTableEntry.c)
 */
...
PRUNTIME_FUNCTION RtlInitializeHistoryTable()
{
  ...
  for ( i = 0; i < 0xC; ++i )
  {
    ...
    *(_QWORD *)&RtlpUnwindHistoryTable[2 * v3 + 8] = v2;
    if ( v4 < qword_1403815D8 )
      qword_1403815D8 = v4;
    if ( v5 > qword_1403815E0 )
      qword_1403815E0 = v5;
  }
