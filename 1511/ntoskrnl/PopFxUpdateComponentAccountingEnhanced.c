/*
 * XREFs of PopFxUpdateComponentAccountingEnhanced @ 0x140125FFC
 * Callers:
 ...
 *     PopPepStartComponentIdleStateChangeActivity @ 0x140126660 (PopPepStartComponentIdleStateChangeActivity.c)
 * Callees:
