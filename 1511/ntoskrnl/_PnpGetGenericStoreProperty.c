/*
 * XREFs of _PnpGetGenericStoreProperty @ 0x14043F704
 * Callers:
        ...
        _DWORD *a8)
{
  ...
  unsigned __int16 v19; // [rsp+98h] [rbp-78h] BYREF
  HANDLE Handle; // [rsp+A0h] [rbp-70h] BYREF
  __int64 v21; // [rsp+A8h] [rbp-68h]
  _DWORD *v22; // [rsp+B0h] [rbp-60h]
  ...
  *a8 = 0;
  ...
  {
    v10 = (int)v23;
    v11 = PnpOpenPropertiesKey(v23, v21, pszDest, 1u, 0, (__int64)pszFormat, &Handle);
    v9 = v11;
    if ( v11 == -1073741772 )
    {
LABEL_4:
