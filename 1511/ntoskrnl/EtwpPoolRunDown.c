/*
 * XREFs of EtwpPoolRunDown @ 0x140665B54
 * Callers:
      ...
      if ( PoolTagInfo >= 0 )
      {
        ...
        if ( *v2 )
        {
          do
          {
            ...
            v37 = v11;
            v46 = 40 * v11;
            EtwpLogKernelEvent((__int64)&v42, a1, 2LL, v5, 0x401802u);
            v10 += 10 * v37;
            v9 -= v37;
          }
          while ( v9 );
      ...
      if ( BigPoolInfo >= 0 )
      {
        ...
        if ( *v2 )
        {
          do
          {
            ...
            v37 = v18;
            v46 = 24 * v18;
            EtwpLogKernelEvent((__int64)&v42, a1, 2LL, v12, 0x401802u);
            v17 += 6 * v37;
            v16 -= v37;
          }
          while ( v16 );
          ...
          if ( SessionPoolTagInfo >= 0 )
          {
            ...
            if ( v37 )
            {
              do
              {
                ...
                v37 = v26;
                v49 = 40 * v26;
                EtwpLogKernelEvent((__int64)&v42, a1, 3LL, v20, 0x401802u);
                v25 += 10 * v37;
                v24 -= v37;
              }
              while ( v24 );
          ...
          if ( v30 >= 0 )
          {
            ...
            if ( v32 )
            {
              do
              {
                ...
                v37 = v33;
                v49 = 24 * v33;
                EtwpLogKernelEvent((__int64)&v42, a1, 3LL, v27, 0x401802u);
                v31 += 6 * v37;
                v32 -= v37;
              }
              while ( v32 );
