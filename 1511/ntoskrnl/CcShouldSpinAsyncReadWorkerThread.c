/*
 * XREFs of CcShouldSpinAsyncReadWorkerThread @ 0x1400FFC1C
 * Callers:
...
LABEL_7:
    ...
    {
      *a1 = 0LL;
      v11 = KeAbPreAcquire((ULONG_PTR)&CcAsyncReadWorkQueueLock, 0LL, 0LL);
      v12 = _interlockedbittestandset64((volatile signed __int32 *)&CcAsyncReadWorkQueueLock, 0LL);
      v13 = v11;
      if ( v12 )
        ExfAcquirePushLockExclusiveEx(&CcAsyncReadWorkQueueLock, v11, (ULONG_PTR)&CcAsyncReadWorkQueueLock);
      if ( v13 )
        *(_BYTE *)(v13 + 26) |= 1u;
      v14 = *v9;
      if ( *v9 != (__int64 *)v9 )
