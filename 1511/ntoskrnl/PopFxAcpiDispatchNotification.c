/*
 * XREFs of PopFxAcpiDispatchNotification @ 0x1401F4824
 * Callers:
 *     PoFxPlatformRequestHandler @ 0x14013F158 (PoFxPlatformRequestHandler.c)
 * Callees:
 ...
 *     PopFxAcpiValidateParameters @ 0x1401F4E30 (PopFxAcpiValidateParameters.c)
