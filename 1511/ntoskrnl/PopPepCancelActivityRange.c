/*
 * XREFs of PopPepCancelActivityRange @ 0x1400DC0F4
 * Callers:
 *     PopPepCancelActivities @ 0x1400DB8A4 (PopPepCancelActivities.c)
...
int *__fastcall PopPepCancelActivityRange(__int64 a1, int a2, int a3, int a4, volatile signed __int32 *a5)
{
  ...
  {
    v5 = (int **)(a1 + 8LL * a3);
    result = (int *)&unk_14023D1F8;
    v7 = (_DWORD *)((char *)&unk_14023D1F8 + 136 * a2 + 4 * a3);
