/*
 * XREFs of RtlpLocateRelatedBlocks @ 0x1401FF7BC
 * Callers:
...
LABEL_70:
    ...
    v25 = 2LL * v24;
    if ( v14 )
      word_1402D3720 = *(_WORD *)(a1 + 140) ^ *(_WORD *)(v14 + 12);
    if ( v15 )
    {
      if ( *(_DWORD *)(a1 + 124) )
      {
    ...
    if ( word_1402D3720 == (_WORD)result )
    {
      if ( word_1402D3724 != (*(_WORD *)(a1 + 140) ^ *(_WORD *)(v15 + 8 * v25 + 12)) )
        dword_1402D36C8 = 7;
    }
    else
    {
