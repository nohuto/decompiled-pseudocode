/*
 * XREFs of EtwTracePool @ 0x140150068
 * Callers:
        ...
        unsigned __int64 a5)
{
  ...
  while ( !v12 )
  {
    ...
    {
      v17 = (unsigned int *)(0x140000000LL + 20 * v13 + 2981316);
...
LABEL_17:
    ...
    EtwpLogKernelEvent((__int64)&v25, (unsigned __int16)EtwpSystemLogger[2 * v14], v9, v8, 0x1401B02u);
LABEL_21:
