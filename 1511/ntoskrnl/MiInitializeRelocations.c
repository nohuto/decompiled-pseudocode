/*
 * XREFs of MiInitializeRelocations @ 0x14074C01C
 * Callers:
...
__int64 MiInitializeRelocations()
{
  ...
  if ( !PoolWithTag )
    return 0LL;
  dword_1402FE450 = 10240;
  qword_1402FE458 = (__int64)PoolWithTag;
  memset(PoolWithTag, 0, 0x500uLL);
  v1 = ExAllocatePoolWithTag(PagedPool, 0x500uLL, 0x69526D4Du);
  if ( !v1 )
    return 0LL;
  dword_1402FE468 = 10240;
  qword_1402FE470 = (__int64)v1;
  memset(v1, 0, 0x500uLL);
  v2 = ExAllocatePoolWithTag(PagedPool, 0x10000uLL, 0x69526D4Du);
  if ( !v2 )
    return 0LL;
  dword_1402FE478 = 524286;
  qword_1402FE480 = (__int64)v2;
  memset(v2, 0, 0x10000uLL);
  v3 = (unsigned int *)ExAllocatePoolWithTag(PagedPool, 0x500uLL, 0x69526D4Du);
  if ( !v3 )
    return 0LL;
  stru_1402FE488.SizeOfBitMap = 10240;
  stru_1402FE488.Buffer = v3;
  memset(v3, 0, 0x500uLL);
  dword_1402FE440 = (unsigned __int8)ExGenRandom(1);
  dword_1402FE460 = (unsigned int)ExGenRandom(1) % 0x2800;
  v4 = ExGenRandom(1);
  result = 1LL;
  dword_1402FE464 = v4 % 0x7FFFE;
  return result;
}
