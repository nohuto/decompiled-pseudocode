/*
 * XREFs of PnpAssignResourcesToDevices @ 0x1404F2504
 * Callers:
...
__int64 __fastcall PnpAssignResourcesToDevices(unsigned int a1, _DWORD *a2, _DWORD *a3)
{
  _DWORD *v6; // rbx
  __int64 v7; // rsi
  __int64 v8; // rdx
  ...
  return PnpAllocateResources(a1, a2, 0, a3);
}
