/*
 * XREFs of ViPostPoolAllocation @ 0x1406B6854
 * Callers:
...
LABEL_18:
  ...
  *(_QWORD *)(a1 + 16) = v10;
  if ( (a2 & 1) != 0 )
  {
    ...
    if ( v14 > *(_DWORD *)(v8 + 88) )
      *(_DWORD *)(v8 + 88) = v14;
    v15 = v10 + _InterlockedExchangeAdd64(&qword_1402E18D0, v10);
    if ( v15 > qword_1402E18E0 )
      qword_1402E18E0 = v15;
    v16 = _InterlockedIncrement(&dword_1402E18C0);
    if ( v16 > dword_1402E18C8 )
      dword_1402E18C8 = v16;
  }
  else
  {
    ...
    if ( v18 > *(_DWORD *)(v8 + 92) )
      *(_DWORD *)(v8 + 92) = v18;
    v19 = v10 + _InterlockedExchangeAdd64(&qword_1402E18D8, v10);
    if ( v19 > qword_1402E18E8 )
      qword_1402E18E8 = v19;
    v20 = _InterlockedIncrement(&dword_1402E18C4);
    if ( v20 > dword_1402E18CC )
      dword_1402E18CC = v20;
  }
  result = v2;
  *v12 = a1;
