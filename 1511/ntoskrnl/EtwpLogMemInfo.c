/*
 * XREFs of EtwpLogMemInfo @ 0x14020E8A4
 * Callers:
...
void __fastcall EtwpLogMemInfo(unsigned int *a1, __int64 a2, __int64 a3)
{
  ...
  if ( a1 )
  {
    EtwpLogKernelEvent((__int64)&v9, *a1, 2LL, 0x270u, 0x401803u);
  }
  else
  {
    if ( (dword_1402D84A4 & 0x80000) != 0 )
      EtwWrite(EtwpMemoryProvRegHandle, &KERNEL_MEM_EVENT_MEMINFO, 0LL, 3u, &UserData);
    EtwTraceKernelEvent((int)&v9, 2, 0x20080000u, 0x270u, 4200451);
  }
}
