/*
 * XREFs of PfpPfnPrioRequest @ 0x140415750
 * Callers:
...
__int64 __fastcall PfpPfnPrioRequest(__int64 a1, char a2, unsigned int *a3)
{
  ...
  if ( v6 == 6 )
  {
    ...
    if ( v9 >= 0 )
    {
      ...
      if ( (char *)Src + 192 < v11 )
      {
        while ( MI_IS_PFN(*((_QWORD *)v10 + 1)) )
        {
          MiIdentifyPfnWrapper(48 * v12 - v13, (__int64)v10);
          v10 += 24;
          if ( v10 >= v11 )
            goto LABEL_7;
        }
...
LABEL_7:
      ...
      if ( a2 )
      {
        ...
        if ( *(_DWORD *)(a1 + 24) )
        {
          ...
          if ( v14 > v15 || v15 >= MmUserProbeAddress )
          {
  ...
  else
  {
    ...
    v9 = PfpCopyUserPfnPrioRequest(*(_QWORD *)(a1 + 16), v19, v6, (unsigned int)&Src, a2, 0);
    if ( v9 >= 0 )
    {
      v5 = Src;
      v20 = (char *)Src + 192;
      v21 = *((_QWORD *)Src + 1);
      if ( *(_DWORD *)(a1 + 8) == 7 )
        v22 = MmSetPfnListPriorities(v21, v20);
      else
