/*
 * XREFs of _CmSetInstallerClassMappedPropertyFromRegValue @ 0x1406993A0
 * Callers:
        ...
        ULONG a7)
{
  ...
  if ( a3 || (v8 = CmOpenInstallerClassRegKey((int)a1, a2, 32LL, 0LL, 3, 0, (__int64)&v37, 0LL), v8 >= 0) )
  {
...
LABEL_62:
          ...
          if ( a3 )
            v32 = a3;
          v33 = PnpCtxRegSetValue(v19, v32, v20, v21, (__int64)a6, a7);
          if ( v33 < 0 )
            v8 = v33;
          goto LABEL_66;
        }
...
LABEL_33:
      ...
      if ( a3 )
        v30 = a3;
      v8 = PnpOpenPropertiesKey(a1, (__int64)v30, 0LL, 2u, 1, v35, &Handle);
      if ( v8 < 0 )
        goto LABEL_66;
      v27 = Handle;
...
LABEL_32:
    ...
    v28 = PnpCtxRegSetValue(v19, v27, v20, v21, (__int64)v26, 4u);
    if ( v28 == -1073741444 )
    {
      v8 = -1073741772;
    }
