/*
 * XREFs of DbgkpLkmdLaunchSnapApc @ 0x1405F1178
 * Callers:
 *     DbgkpLkmdSnapThread @ 0x1401ABABC (DbgkpLkmdSnapThread.c)
 * Callees:
...
__int64 __fastcall DbgkpLkmdLaunchSnapApc(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  *((_QWORD *)PoolWithTag + 14) = a4;
  ...
  if ( (unsigned __int8)KeInsertQueueApc((__int64)v9, (__int64)v9, (__int64)v11, 2) )
  {
