/*
 * XREFs of _RtlpMuiRegPopulateBaseLanguages @ 0x1406A084C
 * Callers:
 *     _RtlpMuiRegInitPartialLanguage @ 0x1406A07F8 (_RtlpMuiRegInitPartialLanguage.c)
 * Callees:
 ...
 *     NtQueryInstallUILanguage @ 0x1404B58EC (NtQueryInstallUILanguage.c)
