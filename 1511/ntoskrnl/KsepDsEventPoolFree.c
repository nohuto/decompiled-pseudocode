/*
 * XREFs of KsepDsEventPoolFree @ 0x1401CE340
 * Callers:
 *     KseDsHookExFreePool @ 0x1401CD7C4 (KseDsHookExFreePool.c)
 *     KseDsHookExFreePoolWithTag @ 0x1401CD7EC (KseDsHookExFreePoolWithTag.c)
 * Callees:
