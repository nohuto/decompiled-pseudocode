/*
 * XREFs of EtwpEnumerateAddressSpace @ 0x1403F4C98
 * Callers:
...
LABEL_9:
  ...
  v39 = 0;
  v38 = 0;
  v10 = (_QWORD *)MmEnumerateAddressSpaceAndReferenceImages(v4, v5);
  v51 = v10;
  if ( !v10 )
    goto LABEL_30;
  if ( !*v10 )
    ...
    *(v11 - 1) &= 0xFFFFFFFFFFFFFFFCuLL;
    if ( !v14 )
    {
      ...
      *v11 &= 0xFFFFFFFFFFFFE03FuLL;
      ...
      v48 = 0LL;
      if ( FltMgrCallbacks
        && (*(int (__fastcall **)(__int64, __int64, void *, __int64 *))(FltMgrCallbacks + 16))(
             v12->m128i_i64[0],
             512LL,
             v7,
             &v48) >= 0
        || (int)ObQueryNameStringMode(v12->m128i_i64[0], (_DWORD)v7, 0x2000, (unsigned int)&v38, 0) >= 0 )
      {
        ...
        else
        {
          v36 = v16;
          v18 = v46;
          PerfLogImageUnload(v7, 0LL, *(_QWORD *)(v46 + 744), *v11, v11[2], *((_DWORD *)v11 + 8), v36, v17, 0);
        }
      }
      else
      {
...
LABEL_50:
    if ( a2 )
    {
      ...
      v59 = v21;
      v60 = 0;
      EtwpLogKernelEvent((__int64)&v58, v42, 1LL, v22, v33);
    }
    else
    {
      v34 = 5249282;
      ...
      v56 = v21;
      v57 = 0;
      EtwTraceKernelEvent((int)&v55, 1, v23, v22, v34);
    }
LABEL_27:
    LOWORD(v8) = v40;
    v11 += 6;
