/*
 * XREFs of PopPepTryPowerUpComponent @ 0x1400DC878
 * Callers:
 *     PopPepTriggerComponentActivatingActivity @ 0x1400DC804 (PopPepTriggerComponentActivatingActivity.c)
 *     PopPepTriggerComponentIdleStateChangeActivity @ 0x140126AE0 (PopPepTriggerComponentIdleStateChangeActivity.c)
 * Callees:
