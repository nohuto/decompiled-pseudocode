/*
 * XREFs of FsRtlCheckUpperOplock @ 0x1404C6440
 * Callers:
 *     <none>
 * Callees:
...
LABEL_35:
          if ( !v10 && (*(_DWORD *)(v23 + 144) & v9) != 0 )
          {
            ...
            v10 = FsRtlpOplockBreakByCacheFlags(
                    ...
                    0LL);
            if ( v22 )
              v10 = FsRtlpOplockBreakByCacheFlags((_QWORD *)v23, (__int64)v24, 0LL, a6, 0x2000, v19, a4, v21, &v25, 0LL);
          }
          goto LABEL_39;
        }
