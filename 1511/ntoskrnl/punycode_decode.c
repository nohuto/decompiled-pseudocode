/*
 * XREFs of punycode_decode @ 0x14064A390
 * Callers:
 *     RtlIdnToUnicode @ 0x140649B24 (RtlIdnToUnicode.c)
 * Callees:
 *     _wcsnicmp @ 0x140144480 (_wcsnicmp.c)
 *     FindLabelEnd @ 0x1401FAC0C (FindLabelEnd.c)
 *     InsertChar @ 0x1401FAC68 (InsertChar.c)
 *     ValidateStd3Range @ 0x1401FAC88 (ValidateStd3Range.c)
 *     adapt @ 0x1401FACC0 (adapt.c)
 */
