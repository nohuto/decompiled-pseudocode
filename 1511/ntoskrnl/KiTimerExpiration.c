/*
 * XREFs of KiTimerExpiration @ 0x1401153FC
 * Callers:
...
__int64 __fastcall KiTimerExpiration(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( result )
  {
    v12 = *(unsigned int *)(v9 + 26784);
    *(_DWORD *)(a1 + 26784) = ((_BYTE)v12 + 1) & 0xF;
    *(_QWORD *)(a1 + 16 * (v12 + 1658)) = v10;
    *(LARGE_INTEGER *)(a1 + 16 * (v12 + 1658) + 8) = KeQueryPerformanceCounter(0LL);
    v13 = a3 >> 18;
    if ( (DWORD2(PerfGlobalGroupMask) & 0x20000) != 0 )
    {
      ...
      v18 = a3;
      v20 = 8;
      EtwTraceKernelEvent((int)&v19, 1, 0x40020000u, 0xF50u, 1538);
    }
    v14 = 0LL;
    v15 = v13 - v4 + 1;
    if ( v15 > 0x100 )
