/*
 * XREFs of PfSnParametersRead @ 0x140540E38
 * Callers:
...
__int64 __fastcall PfSnParametersRead(__int64 a1)
{
  ...
  _OWORD *v38; // [rsp+50h] [rbp-B8h]
  _BYTE v39[16]; // [rsp+58h] [rbp-B0h] BYREF
  char v40; // [rsp+68h] [rbp-A0h] BYREF
  ...
  *((_QWORD *)v4 + 2) = v14;
  ...
  LODWORD(v35) = 4;
  PfpGetParameter(v15, (__int64)&v35);
  result = PfSnParametersVerify(v39);
  v24 = v38;
  if ( (int)result >= 0 )
  {
    v25 = v39;
