/*
 * XREFs of WheapInitializeErrorSource @ 0x14053F834
 * Callers:
 ...
 * Callees:
 *     WheapInitializeErrorRecordWrapper @ 0x14013E678 (WheapInitializeErrorRecordWrapper.c)
...
__int64 __fastcall WheapInitializeErrorSource(__int64 a1)
{
  ...
  v3 = 0;
  if ( (*((int (__fastcall **)(__int64, __int64))&unk_14031C5F0 + 6 * v1))(a1 + 89, a1 + 68) >= 0 )
  {
    v4 = *(_DWORD *)(a1 + 68);
