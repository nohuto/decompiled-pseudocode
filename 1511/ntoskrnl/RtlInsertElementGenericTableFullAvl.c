/*
 * XREFs of RtlInsertElementGenericTableFullAvl @ 0x1400904D0
 * Callers:
 ...
 * Callees:
 *     RebalanceNode @ 0x1400905FC (RebalanceNode.c)
  ...
  if ( BufferSize + 32 >= BufferSize )
  {
    ...
    if ( v11 )
    {
      ...
      if ( SearchResult )
      {
        ...
        if ( v13->Balance == (_BYTE)v15 )
        {
          RebalanceNode(v13, v15, v14, 0xFFFFFFFFLL);
        }
        else
        {
          v13->Balance = 0;
