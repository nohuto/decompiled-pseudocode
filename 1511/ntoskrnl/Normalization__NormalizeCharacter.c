/*
 * XREFs of Normalization__NormalizeCharacter @ 0x14064BE24
 * Callers:
 *     Normalization__AppendDecomposedChar @ 0x14064AFB4 (Normalization__AppendDecomposedChar.c)
 *     Normalization__Normalize @ 0x14064BC78 (Normalization__Normalize.c)
 * Callees:
 *     ComposeHangulLV @ 0x1401FAD78 (ComposeHangulLV.c)
 *     ComposeHangulLVT @ 0x1401FADA0 (ComposeHangulLVT.c)
 *     IsHangulLV @ 0x1401FADD0 (IsHangulLV.c)
 *     NormBuffer__Append @ 0x1401FAE08 (NormBuffer__Append.c)
 ...
 *     NormBuffer__RewindOutputCharacter @ 0x1401FB3C4 (NormBuffer__RewindOutputCharacter.c)
 *     Normalization__AppendDecomposedChar @ 0x14064AFB4 (Normalization__AppendDecomposedChar.c)
