/*
 * XREFs of EtwpTraceStackWalk @ 0x140211040
 * Callers:
...
void __fastcall EtwpTraceStackWalk(int a1, unsigned int a2, __int64 a3, __int64 *a4)
{
  ...
  v24 = a3;
  v22 = a4;
  if ( KeQueryCurrentStackInformation(&v21, &v23, &v28) && v21 && v21 != 5 )
  {
    v6 = 256;
    ...
    if ( (a2 & 0x1000) != 0 )
    {
      ...
      if ( KeGetCurrentThread()->ApcState.Process[2].ActiveProcessors.Bitmap[7] )
      {
...
LABEL_25:
        ...
        EtwpLogKernelEvent((__int64)&v29, (unsigned __int16)a1, 2LL, 0x1820u, v18);
      }
    }
    if ( v6 == 256 )
