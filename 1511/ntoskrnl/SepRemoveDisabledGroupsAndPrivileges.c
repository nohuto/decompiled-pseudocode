/*
 * XREFs of SepRemoveDisabledGroupsAndPrivileges @ 0x1404B49E0
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  if ( *(_DWORD *)(a1 + 124) )
  {
    while ( 1 )
    {
      ...
      {
        v13 = SepSidInSidAndAttributes(v9, (unsigned int)a3, a3, *(_QWORD *)(v12 + 16LL * v8));
        if ( v13 )
          goto LABEL_23;
      }
      if ( (a2 & 4) != 0 )
