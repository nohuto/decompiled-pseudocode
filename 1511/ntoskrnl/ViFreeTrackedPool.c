/*
 * XREFs of ViFreeTrackedPool @ 0x1406B65E0
 * Callers:
...
__int64 __fastcall ViFreeTrackedPool(__int64 a1, __int64 a2, char a3, int a4)
{
  ...
  *(_QWORD *)(v9 + 16) |= 1uLL;
  ...
  if ( (a3 & 1) != 0 )
  {
    ...
    _InterlockedExchangeAdd64(&qword_1402E18D0, v11);
    _InterlockedDecrement(&dword_1402E18C0);
  }
  else
  {
    result = _InterlockedExchangeAdd64((volatile signed __int64 *)(v10 + 104), v11);
    _InterlockedDecrement((volatile signed __int32 *)(v10 + 84));
    _InterlockedExchangeAdd64(&qword_1402E18D8, v11);
    _InterlockedDecrement(&dword_1402E18C4);
  }
  return result;
}
