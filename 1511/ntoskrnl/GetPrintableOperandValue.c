/*
 * XREFs of GetPrintableOperandValue @ 0x140689058
 * Callers:
 ...
 *     GetPrintableOperandValue @ 0x140689058 (GetPrintableOperandValue.c)
 *     ULongAddStringSize @ 0x14068BA2C (ULongAddStringSize.c)
 */
        ...
        char a8)
{
  ...
  wchar_t *v60; // [rsp+50h] [rbp-B0h] BYREF
...
LABEL_41:
                ...
                for ( i = v21; ; v23 = i )
                {
                  ...
                  if ( PrintableOperandValue )
                    goto LABEL_82;
                  v62 += *a4;
                  if ( (int)ULongAddStringSize((unsigned int)v67, v60, &v63) < 0 )
                    goto LABEL_22;
                  v25 = v63 + 4;
                  v64 = v25;
                  ...
                  *a3 = v28;
                  ...
                  if ( RtlStringCchPrintfW(
                         &v28[((unsigned __int64)(unsigned int)v67 >> 1) - 2],
                         (unsigned __int64)(v64 - (unsigned int)v67 + 4) >> 1,
                         L"%ls, ",
                         v60) < 0 )
                    goto LABEL_71;
                  SddlpFree(v60);
          ...
          if ( (unsigned int)(a2 - 1) >= 4 )
          {
            ...
            *a4 = 5;
            if ( Size <= 0x44 && a2 - 5 >= Size )
            {
              ...
              PrintableOperandValue = LocalGetStringForSid(Sid1, &v60, *(__int64 *)v68, v12, v52, a8);
              if ( PrintableOperandValue )
                goto LABEL_82;
              *a4 += Size;
              v13 = -1LL;
...
LABEL_22:
              ...
              *a3 = v16;
              if ( v16 )
              {
                if ( RtlStringCchPrintfW(v16, v15 >> 1, L"SID(%ls)", v60) >= 0 )
                  goto LABEL_82;
                goto LABEL_71;
              }
LABEL_62:
