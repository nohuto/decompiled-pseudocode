/*
 * XREFs of KiNpxNotAvailableFaultShadow @ 0x140224380
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall __noreturn KiNpxNotAvailableFaultShadow(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
