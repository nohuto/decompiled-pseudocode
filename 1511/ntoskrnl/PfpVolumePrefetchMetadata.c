/*
 * XREFs of PfpVolumePrefetchMetadata @ 0x1404DC308
 * Callers:
...
__int64 __fastcall PfpVolumePrefetchMetadata(_QWORD *a1, unsigned int a2)
{
  ...
  int v32; // [rsp+58h] [rbp-A0h]
  struct _IO_STATUS_BLOCK IoStatusBlock; // [rsp+60h] [rbp-98h] BYREF
  _BYTE v34[16]; // [rsp+70h] [rbp-88h] BYREF
  _BYTE v35[120]; // [rsp+80h] [rbp-78h] BYREF
  unsigned int v36; // [rsp+100h] [rbp+8h]
  int v38; // [rsp+110h] [rbp+18h] BYREF
  int v39; // [rsp+118h] [rbp+20h] BYREF
  ...
  *((_QWORD *)InputBuffer + 1) = (8 * (v9 & 7)) | (unsigned __int64)(*(_DWORD *)(*a1 + 28LL) & 7);
  if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
    MmQueryMemoryListInformation((_OWORD *)a1 + 3, 0xB0u, v11, &v39);
  v12 = 0LL;
...
LABEL_53:
      ...
      v18 = NtFsControlFile(
              *(HANDLE *)((v3 << 6) + a1[2]),
              ...
              0);
      if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
        PfpUpdateRepurposedByPrefetch((_OWORD *)a1 + 3, InputBuffer[1], v30);
      if ( v18 < 0 )
        goto LABEL_15;
      if ( v18 == 259 )
        KeBugCheckEx(0x191u, 0x15C1uLL, 0LL, 0LL, 0LL);
      v9 = v36;
    }
    while ( (unsigned int)v12 < *(_DWORD *)(v10 + 8 * v5 + 12) >> 1 );
    if ( v4 )
        ...
        while ( 1 )
        {
          ...
          v18 = NtFsControlFile(
                  *(HANDLE *)((v31 << 6) + a1[2]),
                  ...
                  0);
          if ( (*(_DWORD *)(*a1 + 80LL) & 4) != 0 )
            PfpUpdateRepurposedByPrefetch((_OWORD *)a1 + 3, InputBuffer[1], v28);
          if ( v18 < 0 )
            goto LABEL_15;
          if ( v18 == 259 )
            KeBugCheckEx(0x191u, 0x1626uLL, 0LL, 0LL, 0LL);
          if ( v23 >= *(_DWORD *)(v4 + 16) )
            break;
          v9 = v36;
        }
  ...
  if ( (*(_DWORD *)(v10 + 8 * v5 + 12) & 0xFFFFFFFE) != 0 )
  {
    do
    {
      v17 = (int *)(*(_QWORD *)(v10 + 8 * v5 + 16) + 48 * v16);
      if ( (*v17 & 2) != 0 )
      {
        PfpFileSetupObjectAttributes((__int64)a1, v17, a2, (__int64)v34, (__int64)v35, &v38);
