/*
 * XREFs of FsRtlUninitializeSmallMcb @ 0x140237C60
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FsRtlUninitializeSmallMcb(unsigned __int64 a1)
{
  ...
  if ( *(_QWORD *)(CompleteDev + 1392) )
    return (*(__int64 (__fastcall **)(unsigned __int64, _QWORD))(CompleteDev + 568))(CompleteDev + 1392, 0LL);
  v2 = (__int64 (__fastcall *)())CompleteDev;
  v3 = *(_QWORD *)(CompleteDev + 1336);
  v4 = *(__int64 (__fastcall **)(__int64, __int64, _QWORD, unsigned __int64))(CompleteDev + 248);
  v5 = *(unsigned int *)(CompleteDev + 1364);
  v6 = *(_QWORD *)(CompleteDev + 1344);
  ...
  v9 = (unsigned __int64 *)&loc_140237CE6;
  do
  {
    v10 = *v9 ^ v7;
    *v9 = v10;
