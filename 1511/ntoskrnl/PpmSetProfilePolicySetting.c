/*
 * XREFs of PpmSetProfilePolicySetting @ 0x140454614
 * Callers:
      ...
      if ( !v16 )
      {
        ...
        *(_QWORD *)&v48.Data1 = PpmCurrentProfile;
        ...
        if ( !v20 )
        {
          ...
          v23 = PpmInfoAdjustSetting((_DWORD)v9, 1392 * v5 + (unsigned int)&PpmDefaultProfile[5], v14, v19, v47, a5);
          v25 = v14;
          v21[v14] |= v18;
          if ( v23 )
          {
            LOBYTE(v24) = v14;
            LOBYTE(v25) = byte_1402DC368;
            ...
            if ( PpmProfileCount )
            {
              ...
              do
              {
                if ( (v28[v14] & v18) == 0 && (!v14 || (v18 & *v28) == 0) )
                {
                  ...
                  PpmInfoAdjustSetting((_DWORD)v9, (_DWORD)v28, v14, v19, v47, a5);
                  if ( *(_QWORD **)&v48.Data1 == &v28[v44 / 0xFFFFFFFFFFFFFFF8uLL - 5] && v41 == v46 )
                    v6 = 1;
                }
                v28 += 358;
                --v27;
...
LABEL_20:
        ...
        if ( PpmProfileCount )
        {
          ...
          if ( (*((_BYTE *)v9 + 37) & 4) != 0 && !v14 && (v18 & *(_QWORD *)(v35 + 8)) == 0 )
            v19 = 1;
          v37 = PpmInfoAdjustSetting((_DWORD)v9, v35, v14, v19, v47, a5);
          v39 = v14;
