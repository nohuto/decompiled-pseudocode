/*
 * XREFs of CcInsertVacbArray @ 0x1401377B4
 * Callers:
  ...
  do
  {
    if ( *(result - 2) )
    {
      ...
      *v7 = result;
      ...
      qword_1402FD8F8 = (__int64)result;
    }
    else
    {
      v6 = (__int64 **)qword_1402FD8E8;
      ...
      *v6 = result;
      ++CcNumberOfFreeVacbs;
      qword_1402FD8E8 = (__int64)result;
    }
    ++v4;
    result += 5;
  }
