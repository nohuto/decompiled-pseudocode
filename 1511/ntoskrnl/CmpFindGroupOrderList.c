/*
 * XREFs of CmpFindGroupOrderList @ 0x140754014
 * Callers:
...
__int64 __fastcall CmpFindGroupOrderList(__int64 a1, __int64 a2)
{
  ...
  if ( !v3 )
    return 0xFFFFFFFFLL;
  SubKeyByName = CmpFindSubKeyByName(a1, v3, (const UNICODE_STRING *)&CmpControlString);
  ...
  if ( !v5 )
    return 0xFFFFFFFFLL;
  v6 = CmpFindSubKeyByName(a1, v5, (const UNICODE_STRING *)&CmpGroupOrderListString);
  (*(void (__fastcall **)(__int64, int *))(a1 + 16))(a1, &v8);
  return v6;
}
