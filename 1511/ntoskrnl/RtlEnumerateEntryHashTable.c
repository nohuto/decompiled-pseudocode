/*
 * XREFs of RtlEnumerateEntryHashTable @ 0x1400CFC90
 * Callers:
 *     SepCleanupMarkedForDeletionEntries @ 0x1400CFBA4 (SepCleanupMarkedForDeletionEntries.c)
 *     RtlWeaklyEnumerateEntryHashTable @ 0x1401F9434 (RtlWeaklyEnumerateEntryHashTable.c)
...
LABEL_7:
  ...
  if ( (PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR)v16->Blink != Flink )
    __fastfail(3u);
