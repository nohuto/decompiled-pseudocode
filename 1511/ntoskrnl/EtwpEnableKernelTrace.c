/*
 * XREFs of EtwpEnableKernelTrace @ 0x1404B8278
 * Callers:
...
LABEL_56:
  ...
  {
    v11 = v20[0] | 0x2000000;
    qword_1402C7390 = (__int64)EtwpTraceFileIo;
    v20[0] |= 0x2000000u;
  }
  if ( (a2->m128i_i32[0] & 0x4000000) != 0 )
  {
    v11 |= 0x4000000u;
    qword_1402C7388 = (__int64)EtwpTraceFileIo;
    v20[0] = v11;
  }
  if ( (a2->m128i_i32[0] & 0x200) != 0 )
  {
    v11 |= 0x200u;
    qword_1402C7380 = (__int64)EtwpTraceFileName;
    v20[0] = v11;
  }
  if ( (a2->m128i_i32[0] & 0x100) != 0 )
  {
    ...
    qword_1402C7370 = (__int64)EtwpTraceRedirectedIo;
    v20[0] = v11;
  }
  if ( (a2->m128i_i32[0] & 0x400) != 0 )
  {
    v11 |= 0x400u;
    qword_1402FDEA0 = (__int64)EtwpTraceIoInit;
    v20[0] = v11;
  }
  v12 = v20[4];
  ...
  {
    v12 = v20[4] | 1;
    qword_1402FDEA8 = (__int64)EtwpTraceOpticalIo;
    v20[4] |= 1u;
  }
  if ( (a2[1].m128i_i32[0] & 2) != 0 )
  {
    v12 |= 2u;
    qword_1402FDEB0 = (__int64)EtwpTraceOpticalIoInit;
    v20[4] = v12;
  }
  ...
  {
    v12 |= 0x400000u;
    qword_1402C7350 = (__int64)EtwpTraceFltIo;
    v20[4] = v12;
  }
  if ( (a2[1].m128i_i32[0] & 0x80000) != 0 )
  {
    v12 |= 0x80000u;
    qword_1402C7358 = (__int64)EtwpTraceFltIo;
    v20[4] = v12;
  }
  if ( (a2[1].m128i_i32[0] & 0x100000) != 0 )
  {
    v12 |= 0x100000u;
    qword_1402C7360 = (__int64)EtwpTraceFltTimedIo;
    v20[4] = v12;
  }
  if ( (a2[1].m128i_i32[0] & 0x200000) != 0 )
  {
    v12 |= 0x200000u;
    qword_1402C7368 = (__int64)EtwpTraceFltTimedIo;
    v20[4] = v12;
  }
  if ( (a2[1].m128i_i32[0] & 0x1000000) != 0 )
  {
    v12 |= 0x1000000u;
    qword_1402D21E0 = (__int64)EtwpTraceWdf;
    v20[4] = v12;
  }
  if ( (a2[1].m128i_i32[0] & 0x2000000) != 0 )
  {
    v12 |= 0x2000000u;
    qword_1402D21E8 = (__int64)EtwpTraceWdf;
    v20[4] = v12;
  }
  if ( (a2->m128i_i32[2] & 0x8000000) != 0 )
  {
    v20[2] |= 0x8000000u;
    qword_1402D21F0 = (__int64)EtwpSystemTraceWdf;
  }
  v13 = a2->m128i_i32[0];
...
LABEL_49:
    ...
    if ( (a2->m128i_i32[1] & 0x400) != 0 )
    {
      for ( i = 0; i < EtwpPmcProfile; ++i )
        KeStartProfile((ULONG_PTR)qword_1402D81B8 + 248 * i);
      v20[1] = v8 | 0x400;
    }
