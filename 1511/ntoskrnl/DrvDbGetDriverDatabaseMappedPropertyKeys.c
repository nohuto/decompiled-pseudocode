/*
 * XREFs of DrvDbGetDriverDatabaseMappedPropertyKeys @ 0x14069ADE0
 * Callers:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  if ( CompositeMappedPropertyKeys >= 0 )
  {
    ...
    CompositeMappedPropertyKeys = DrvDbFindDatabaseNode((__int64)a1, a2, &v23);
    if ( CompositeMappedPropertyKeys >= 0 )
    {
      v15 = v23;
      if ( ((__int64)v23[3].Buffer & 0x10) != 0 )
      {
        LOBYTE(v19) = 0;
        LODWORD(v18) = 1;
        CompositeMappedPropertyKeys = DrvDbOpenObjectRegKey(a1, a1[4], 1u, a2, v18, v19, &v22, 0LL);
        if ( CompositeMappedPropertyKeys < 0 )
          goto LABEL_20;
        CompositeMappedPropertyKeys = DrvDbGetRegValueMappedPropertyKeys(
                                        v16,
                                        (_DWORD)v22,
                                        (unsigned int)&off_14025E820,
                                        2,
                                        v9,
                                        v6,
                                        (__int64)&v20);
...
LABEL_20:
      ...
      if ( !a3 )
      {
        CompositeMappedPropertyKeys = DrvDbOpenDriverDatabaseRegKey(a1, a2, 1u, 0, (__int64)&Handle, 0LL);
        if ( CompositeMappedPropertyKeys < 0 )
          goto LABEL_20;
