/*
 * XREFs of CcSetLogHandleForFileEx @ 0x1400E5A90
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall CcSetLogHandleForFileEx(__int64 a1, __int64 a2, __int64 a3, __int64 a4, PVOID Object)
{
  ...
  if ( a2 )
  {
    ...
    if ( *(_DWORD *)(v8 + 112) )
    {
      v16 = (__int64 **)qword_1402FD998;
      *v10 = (__int64)&CcDirtySharedCacheMapWithLogHandleList;
      *(_QWORD *)(v8 + 128) = v16;
      if ( *v16 != &CcDirtySharedCacheMapWithLogHandleList )
        __fastfail(3u);
      *v16 = v10;
      qword_1402FD998 = v8 + 120;
    }
    else
    {
      v11 = (__int64 **)qword_1402FD978;
      *v10 = (__int64)&CcCleanSharedCacheMapWithLogHandleList;
      *(_QWORD *)(v8 + 128) = v11;
      if ( *v11 != &CcCleanSharedCacheMapWithLogHandleList )
        __fastfail(3u);
      *v11 = v10;
      qword_1402FD978 = v8 + 120;
    }
