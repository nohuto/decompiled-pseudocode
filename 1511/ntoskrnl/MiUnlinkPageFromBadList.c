/*
 * XREFs of MiUnlinkPageFromBadList @ 0x1401E0238
 * Callers:
...
signed __int64 __fastcall MiUnlinkPageFromBadList(_QWORD *a1)
{
  ...
  KeAcquireInStackQueuedSpinLockAtDpcLevel((PKSPIN_LOCK)v3 + 444, &LockHandle);
  v4 = *a1 & 0xFFFFFFFFFLL;
  ...
  if ( dword_1402FEC90 == 1 )
  {
    v6 = v2 & 0x1F;
    LOBYTE(v7) = 1;
    v8 = (volatile signed __int32 *)stru_1402FECA8.Buffer + (v2 >> 5);
    if ( v6 + 1 <= 0x20 )
    {
      v9 = 1 << v6;
LABEL_16:
