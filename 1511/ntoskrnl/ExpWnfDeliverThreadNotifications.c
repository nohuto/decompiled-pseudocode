/*
 * XREFs of ExpWnfDeliverThreadNotifications @ 0x1403E3FEC
 * Callers:
...
__int64 __fastcall ExpWnfDeliverThreadNotifications(unsigned __int64 *a1, _QWORD *a2, int a3)
{
  ...
  v20 = a3 - 48;
LABEL_2:
  v4 = KeAbPreAcquire((ULONG_PTR)(a1 + 10), 0LL, 0LL);
  ...
  if ( v4 )
    *(_BYTE *)(v4 + 26) |= 1u;
  v5 = KeAbPreAcquire((ULONG_PTR)(a1 + 13), 0LL, 0LL);
  v6 = v5;
      ...
      *(unsigned __int64 *)((char *)v9 + 124) = 0LL;
      if ( v10 )
      {
        if ( (v18 & 1) != 0 && _InterlockedExchangeAdd((volatile signed __int32 *)(v10 + 164), 0xFFFFFFFF) == 1 )
        {
          ...
          ExpWnfNotifyNameSubscribers(v10, 8LL, 1LL, 1LL);
          ExReleaseRundownProtection_0((PEX_RUNDOWN_REF)(v10 + 8));
          goto LABEL_2;
        }
        ExReleaseRundownProtection_0((PEX_RUNDOWN_REF)(v10 + 8));
