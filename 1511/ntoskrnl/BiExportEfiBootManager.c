/*
 * XREFs of BiExportEfiBootManager @ 0x1406902DC
 * Callers:
 ...
 *     BiTranslateDisplayOrder @ 0x1406910C0 (BiTranslateDisplayOrder.c)
...
__int64 __fastcall BiExportEfiBootManager(__int64 a1, __int64 a2)
{
  ...
  void *v26; // [rsp+50h] [rbp-9h] BYREF
  _DWORD *v27; // [rsp+58h] [rbp-1h] BYREF
  ULONG *v28; // [rsp+60h] [rbp+7h] BYREF
  ...
  *(_QWORD *)&Count[1] = 0LL;
  ...
  v6 = 0LL;
  v27 = 0LL;
  v7 = BcdOpenObject(a1, (__int128 *)&GUID_FIRMWARE_BOOTMGR, &Count[1]);
  v8 = v7;
  if ( v7 < 0 )
  {
    if ( v7 == -1073741772 )
...
LABEL_10:
    ...
    v15 = BiGetElement(*(__int64 *)&Count[1], 0x25000004u, &v28, &v20);
    v4 = v28;
    v8 = v15;
    if ( v15 < 0 )
    {
    ...
    v17 = BiGetElement(*(__int64 *)&Count[1], 0x24000002u, &v26, &v20);
    v2 = v26;
    v8 = v17;
    if ( v17 < 0 )
    {
...
LABEL_29:
          v20 = 0;
          v18 = BiQueryBootOptions(&v27, &v20);
          v6 = v27;
    ...
    {
      v3 |= 2u;
      v8 = BiTranslateObjectIdentifier(v24, v26, &v20);
      if ( v8 >= 0 )
      {
