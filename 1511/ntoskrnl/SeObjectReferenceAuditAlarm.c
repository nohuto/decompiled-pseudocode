/*
 * XREFs of SeObjectReferenceAuditAlarm @ 0x1404709B4
 * Callers:
...
LABEL_27:
  SeExamineGlobalSacl(
    (PUNICODE_STRING)(ObTypeIndexTable[(unsigned __int8)ObHeaderCookie ^ v10[-1].Spare2[63] ^ (unsigned __int64)(unsigned __int8)((unsigned __int16)((_WORD)v10 - 48) >> 8)]
                    + 16),
    v21,
    v18,
    DesiredAccess,
  ...
  if ( (_BYTE)GenerateAudit || GenerateAlarm )
    SepAdtObjectReferenceAuditAlarm(v10);
}
