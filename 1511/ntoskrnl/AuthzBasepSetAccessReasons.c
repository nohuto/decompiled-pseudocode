/*
 * XREFs of AuthzBasepSetAccessReasons @ 0x1400D5CC0
 * Callers:
 ...
 *     AuthzBasepSetTypeListAccessReasons @ 0x14012BE3C (AuthzBasepSetTypeListAccessReasons.c)
 *     SepCommonAccessCheckEx @ 0x140135324 (SepCommonAccessCheckEx.c)
 *     SepNormalAccessCheckEx @ 0x140135D0C (SepNormalAccessCheckEx.c)
 *     AuthzBasepUpdateParentTypeList @ 0x14021A260 (AuthzBasepUpdateParentTypeList.c)
 * Callees:
 *     <none>
 */
