/*
 * XREFs of PipMigratePnpState @ 0x1407711B4
 * Callers:
...
__int64 PipMigratePnpState()
{
  ...
  {
    v24 = 4;
    v6 = PnpCtxRegQueryValue(v3, v18, L"MigrationStatus", &v25, &v26, &v24);
...
LABEL_2:
    ...
    if ( v7 >= 0 )
    {
      ...
      {
        v24 = 8;
        CachedContextBaseKey = PnpCtxRegQueryValue(v3, v17, L"MigrationTime", &v25, Source2, &v24);
        if ( CachedContextBaseKey >= 0 )
        {
          if ( v25 == 3 && v24 == 8 )
          {
            ...
            if ( CachedContextBaseKey < 0 )
              goto LABEL_3;
            v24 = 8;
            v9 = PnpCtxRegQueryValue(v3, v17, L"MigrationTime", &v25, Source1, &v24);
...
LABEL_30:
              v26 = 259;
              CachedContextBaseKey = PnpCtxRegSetValue(v3, v18, (__int64)L"MigrationStatus", 4LL, (__int64)&v26, 4u);
              if ( CachedContextBaseKey < 0 )
                goto LABEL_3;
              ...
              v24 = 4;
              v0 = 1;
              CachedContextBaseKey = PnpCtxRegQueryValue(v3, v18, L"TargetVersion", &v25, &v27, &v24);
              if ( CachedContextBaseKey < 0 )
                goto LABEL_45;
              if ( v25 != 4 || v24 != 4 )
              {
              ...
              CachedContextBaseKey = PnpCtxRegCopyTree(v3, (int)v19, 0, (int)v20, 0LL);
              if ( CachedContextBaseKey < 0 )
                goto LABEL_45;
...
LABEL_45:
              ...
              PnpCtxRegSetValue(v3, v18, (__int64)L"MigrationStatus", 4LL, (__int64)&v26, 4u);
              goto LABEL_46;
            }
          }
          CachedContextBaseKey = -1073741823;
