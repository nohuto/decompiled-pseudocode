/*
 * XREFs of PnpFindBestConfigurationWorker @ 0x140529B7C
 * Callers:
 *     PnpFindBestConfiguration @ 0x140529B2C (PnpFindBestConfiguration.c)
 * Callees:
 *     IopSaveRestoreConfiguration @ 0x14051937C (IopSaveRestoreConfiguration.c)
 *     IopRetestConfiguration @ 0x14051A9FC (IopRetestConfiguration.c)
 *     IopSelectNextConfiguration @ 0x1405294F8 (IopSelectNextConfiguration.c)
 *     IopTestConfiguration @ 0x140529D00 (IopTestConfiguration.c)
 *     PnpSelectFirstConfiguration @ 0x140529E24 (PnpSelectFirstConfiguration.c)
 *     IopAddRemoveReqDescs @ 0x14052B634 (IopAddRemoveReqDescs.c)
 */
