/*
 * XREFs of PiControlQueryConflictList @ 0x140615E78
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall PiControlQueryConflictList(__int64 a1, unsigned __int16 *a2, __int64 a3, char a4)
{
  ...
  {
    UserModeCallersCopy = PiControlAllocateBufferForUserModeCaller(&v17, *((_DWORD *)a2 + 10), a4, *v5);
    if ( UserModeCallersCopy < 0
    ...
    else
    {
      ...
      if ( v12 )
      {
        ...
        if ( v14 )
        {
          ...
          {
            UserModeCallersCopy = IopQueryConflictList((_DWORD)v10, (_DWORD)P, v13, (_DWORD)v17, *((_DWORD *)a2 + 10));
            v15 = PiControlMakeUserModeCallersCopy((void **)v5, v9, *((_DWORD *)a2 + 10), 1u, a4, 0);
            if ( v15 < 0 )
