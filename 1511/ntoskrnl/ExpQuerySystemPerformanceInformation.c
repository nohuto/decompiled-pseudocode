/*
 * XREFs of ExpQuerySystemPerformanceInformation @ 0x1403CB0D0
 * Callers:
 *     ExpQuerySystemInformation @ 0x140472CC0 (ExpQuerySystemInformation.c)
 * Callees:
 *     MmGetWorkingSetLeafSize @ 0x140014174 (MmGetWorkingSetLeafSize.c)
 *     MmGetSharedCommit @ 0x140014188 (MmGetSharedCommit.c)
 *     MmGetResidentAvailablePages @ 0x140014190 (MmGetResidentAvailablePages.c)
 *     ExQueryPoolUsage @ 0x1400141B0 (ExQueryPoolUsage.c)
 *     MiMaximumCommitmentAvailable @ 0x140014408 (MiMaximumCommitmentAvailable.c)
 *     MiFreePoolPagesLeft @ 0x140014424 (MiFreePoolPagesLeft.c)
 *     MmGetSystemPageCounts @ 0x14001444C (MmGetSystemPageCounts.c)
...
void *__fastcall ExpQuerySystemPerformanceInformation(unsigned int a1, void *a2, unsigned int a3)
{
  ...
  if ( a1 )
  {
    ...
    {
      v34 = (_DWORD *)*v32++;
      v20 = (unsigned int)(v34[2852] + v20);
      v21 = (unsigned int)(v34[2853] + v21);
      v22 += v34[2854];
      v23 += v34[5946];
      v24 += v34[2855];
      v25 += v34[2856];
  ...
  v75 = v30;
  v76 = v31;
  v83[1] = MmGetNumberOfFreeSystemPtes(v30, v31, v20, v21);
