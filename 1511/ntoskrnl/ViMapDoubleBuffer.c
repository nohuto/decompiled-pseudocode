/*
 * XREFs of ViMapDoubleBuffer @ 0x1406BDE24
 * Callers:
...
__int64 __fastcall ViMapDoubleBuffer(__int64 a1, __int64 a2, unsigned __int64 a3, unsigned int a4, char a5)
{
  ...
  if ( !a4 )
  {
    ViHalPreprocessOptions(&byte_1402D4028, "Driver is attempting to map a 0-length transfer.", 33LL, a1, 0LL, 0LL);
    Priority = (CHAR *)&byte_1402D4028;
    v9 = 0;
...
LABEL_3:
  ...
  {
    v13 = 1;
    ViHalPreprocessOptions(&dword_1402D4020, "Virtual address %p is before the first MDL %p.", 268435487LL, 1LL, a3, a2);
    Priority = (CHAR *)&dword_1402D4020;
    v9 = a3;
...
LABEL_10:
  ...
  {
    ViHalPreprocessOptions(&dword_1402D4018, "Virtual address %p is after the first MDL %p.", 268435487LL, 2LL, a3, a2);
    Priority = (CHAR *)&dword_1402D4018;
    v9 = a3;
    *(_QWORD *)BugCheckOnFailure = a2;
    v10 = 2;
LABEL_11:
