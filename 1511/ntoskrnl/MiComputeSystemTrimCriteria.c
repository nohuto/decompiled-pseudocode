/*
 * XREFs of MiComputeSystemTrimCriteria @ 0x140014E30
 * Callers:
...
__int64 __fastcall MiComputeSystemTrimCriteria(_QWORD *a1, __int64 a2)
{
  ...
  *(_QWORD *)(v2 + 8 * v13 + 2216) = v12;
  ...
  {
    v36 = v10 - (AvailablePagesBelowPriority >> 2);
...
LABEL_34:
  if ( AvailablePagesBelowPriority && v29 < AvailablePagesBelowPriority )
