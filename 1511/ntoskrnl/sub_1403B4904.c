/*
 * XREFs of sub_1403B4904 @ 0x1403B4904
 * Callers:
...
__int64 __fastcall sub_1403B4904(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
  unsigned int i; // edx
...
LABEL_49:
  ...
  if ( (v14 & 0x80000000) == 0 )
  {
    if ( v7 && *(_DWORD *)a1 > 4u )
    {
      ...
      if ( !*v7 )
        v18 = 0LL;
      v19 = qword_1406FB408 ? qword_1406FB408(v18) : -1073741637;
      v20 = *(_DWORD *)(a2 + 32);
