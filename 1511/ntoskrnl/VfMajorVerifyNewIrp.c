/*
 * XREFs of VfMajorVerifyNewIrp @ 0x1406C2838
 * Callers:
        ...
        __int64 a5))(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD)
{
  ...
  if ( v11 )
    v11(a1);
  result = qword_1406E18C0;
  if ( qword_1406E18C0 )
    return (__int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _QWORD))qword_1406E18C0(a1, a2, a3, a4, a5);
  return result;
}
