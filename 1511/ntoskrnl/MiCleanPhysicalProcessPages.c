/*
 * XREFs of MiCleanPhysicalProcessPages @ 0x140626B7C
 * Callers:
...
void __fastcall MiCleanPhysicalProcessPages(__int64 a1)
{
  ...
  __int64 v4; // rdi
  unsigned __int64 SetBits; // r14
  unsigned __int64 v6; // r12
  int *ProcessPartition; // [rsp+28h] [rbp-E0h]
  ...
  if ( *(_QWORD *)(a1 + 1584) )
  {
    ...
    do
    {
      ...
      *v3 = SetBits;
      ...
      if ( v4 == 64 )
      {
        _InterlockedExchangeAdd64((volatile signed __int64 *)ProcessPartition + 767, 0xFFFFFFFFFFFFFFC0uLL);
        v9 = 0LL;
        v10 = 560;
        v11 = 0LL;
        v12 = 0x40000LL;
    ...
    if ( v4 )
    {
      _InterlockedExchangeAdd64((volatile signed __int64 *)ProcessPartition + 767, -v4);
      v9 = 0LL;
      v11 = 0LL;
