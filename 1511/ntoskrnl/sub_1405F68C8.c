 ...
 * Callees:
 *     HvcallInitInputControl @ 0x140167030 (HvcallInitInputControl.c)
 ...
 *     HvcallInitiateHypercall @ 0x140217E8C (HvcallInitiateHypercall.c)
 */

__int64 __fastcall sub_1405F68C8(__int64 a1, int a2)
{
  int v4; // ebp
  __int64 result; // rax
  __int64 v6; // rax
