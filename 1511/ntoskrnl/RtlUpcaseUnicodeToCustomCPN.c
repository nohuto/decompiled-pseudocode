/*
 * XREFs of RtlUpcaseUnicodeToCustomCPN @ 0x140645F80
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
LABEL_99:
  ...
  if ( v8 )
  {
    ...
    do
    {
      ...
      if ( v39 )
        v40 = DBCSOffsets[(unsigned __int8)v38 + (unsigned __int64)v39];
      else
          ...
          v40 += *(_WORD *)(v36
                          ...
                          * ((v40 & 0xF)
                           + (unsigned int)*(unsigned __int16 *)(v36
                                                               + 2LL
                                                               * (((v40 >> 4) & 0xF)
                                                                + (unsigned int)*(unsigned __int16 *)(v36 + 2 * ((unsigned __int64)v40 >> 8))))));
        else
          v40 -= 32;
      }
      v41 = v40;
