/*
 * XREFs of ?SmStMapPhysicalRegion@?$SMKM_STORE@USM_TRAITS@@@@SAPEAXPEAU1@KKKK@Z @ 0x140202E30
 * Callers:
        ...
        char a5)
{
  ...
  {
    v10 = SmFpAllocate((PEX_SPIN_LOCK)(a1 + 5048), 5, (__int64)KeGetCurrentThread(), v9, a5 & 1);
    if ( !v10 )
      return v10;
  }
  if ( (a5 & 0x10) != 0 )
