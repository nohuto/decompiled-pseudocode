/*
 * XREFs of PfSnAsyncPrefetchWorker @ 0x1404DEC44
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall PfSnAsyncPrefetchWorker(PVOID P)
{
  ...
  $D4FCF91253F76F57393CBFE908971F67 v16; // [rsp+B8h] [rbp-9h] BYREF
      ...
      if ( PoolWithTag )
      {
        ...
        *(_DWORD *)(v15[1] + 56) = 15;
        if ( (int)PfpPrefetchSharedStart(v15[1]) >= 0 && (int)PfSnOpenVolumesForPrefetch(v15, v14) >= 0 )
        {
          ...
          {
            _InterlockedExchange((volatile __int32 *)(*((_QWORD *)P + 27) + 1816LL), 5000);
...
LABEL_21:
  _InterlockedExchange((volatile __int32 *)(*((_QWORD *)P + 27) + 1816LL), 0);
  v12 = *((_QWORD *)P + 28);
  if ( v12 )
  {
