/*
 * XREFs of KiInterruptDispatchNoLockNoEtw @ 0x140155800
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall KiInterruptDispatchNoLockNoEtw(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
  __int64 v5; // rbp
  ...
  KiInterruptSubDispatchNoLockNoEtw((__int64)KeGetPcr()->Prcb.IsrStack, (__int64)&retaddr, a3, a4);
