/*
 * XREFs of WdipSemLoadNextContextProvider @ 0x140532EC4
 * Callers:
...
__int64 __fastcall WdipSemLoadNextContextProvider(HANDLE KeyHandle, ULONG Index, GUID *Guid)
{
  ...
  if ( v6 >= 0 )
  {
    ...
    *((_WORD *)&KeyInformation[4] + ((unsigned __int64)KeyInformation[3] >> 1)) = 0;
    ...
    if ( v6 < 0 )
      goto LABEL_24;
    v8 = WdipSemQueryValueFromRegistry(Handle, &v19, (__int64)&ResultLength);
    v6 = v8;
    if ( v8 < 0 )
    {
      if ( v8 != -1073741772 )
    ...
    if ( v12 >= 0 )
    {
      Guid[2].Data1 = v16;
LABEL_21:
      v13 = WdipSemQueryValueFromRegistry(Handle, &v18, (__int64)&ResultLength);
      v6 = v13;
      if ( v13 >= 0 )
      {
        *(_DWORD *)&Guid[2].Data2 = v18;
      }
