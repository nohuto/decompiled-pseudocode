/*
 * XREFs of KiVmbusInterrupt2Shadow @ 0x140224F00
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
__int64 __fastcall KiVmbusInterrupt2Shadow(__int64 a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
