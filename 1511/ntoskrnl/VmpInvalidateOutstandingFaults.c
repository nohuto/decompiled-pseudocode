/*
 * XREFs of VmpInvalidateOutstandingFaults @ 0x14020C814
 * Callers:
...
__int64 __fastcall VmpInvalidateOutstandingFaults(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  ...
  v4 = a2 + a3 - 1;
  v6 = 0LL;
  ExAcquireSpinLockSharedAtDpcLevel((PEX_SPIN_LOCK)(a1 + 56));
  v7 = *(_QWORD **)(a1 + 40);
  v8 = 0LL;
  while ( v7 )
  {
  ...
  ExReleaseSpinLockSharedFromDpcLevel((PEX_SPIN_LOCK)(a1 + 56));
  return v6;
}
