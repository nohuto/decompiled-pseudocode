/*
 * XREFs of sub_14067B814 @ 0x14067B814
 * Callers:
...
__int64 __fastcall sub_14067B814(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  signed int v7; // ebx
  unsigned int *v8; // rcx
  unsigned int *v9; // rax
...
LABEL_50:
  ...
  if ( !v49 )
    v50 = 0LL;
  if ( qword_1406FB3F8 )
    v51 = qword_1406FB3F8((unsigned int)v65, v32, v39, v38, v45, v44, v50, v49);
  else
    v51 = -1073741637;
  v7 = v51;
  if ( v51 < 0 )
