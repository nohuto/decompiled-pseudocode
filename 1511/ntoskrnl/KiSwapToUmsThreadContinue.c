/*
 * XREFs of KiSwapToUmsThreadContinue @ 0x1401CCA04
 * Callers:
 *     KiUmsTrapEntryContinue @ 0x140166500 (KiUmsTrapEntryContinue.c)
 *     KiUmsCallEntryContinue @ 0x1401666C0 (KiUmsCallEntryContinue.c)
