/*
 * XREFs of KeSaveExtendedAndSupervisorState @ 0x140022478
 * Callers:
 ...
 *     XSaveSHelper @ 0x14015C300 (XSaveSHelper.c)
...
LABEL_12:
        result = KeAllocateXStateContext((__int64)(a2 + 3), BugCheckParameter3, v9);
        if ( (int)result < 0 )
          return result;
        goto LABEL_13;
      }
