/*
 * XREFs of PopWriteHiberPages @ 0x1403A0160
 * Callers:
...
__int64 __fastcall PopWriteHiberPages(__int64 a1, __int64 a2, unsigned __int64 a3, __int64 a4)
{
  ...
  if ( *(int *)(v9 + 188) >= 0 )
  {
    if ( (a4 + a3) << 12 > qword_1402DE2F0 )
    {
      ...
      KeBugCheckEx(0xA0u, 0xBuLL, qword_1402DE2F0, *(unsigned int *)(v9 + 184), BugCheckParameter4);
    }
    if ( a3 > 0xFFFFFFFFFFFFFLL )
      PopInternalError(0xA1F44uLL);
    ...
    while ( v12 )
    {
      ...
      v22 = __rdtsc();
      dword_1402DE7E0 += v16;
      qword_1402DE620 += (((unsigned __int64)HIDWORD(v22) << 32) | (unsigned int)v22) - v20;
      result = v27;
      v12 -= v27;
      v11 += v27;
      a2 += v27;
