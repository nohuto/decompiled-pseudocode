/*
 * XREFs of EtwTraceJob @ 0x140660A24
 * Callers:
...
__int64 __fastcall EtwTraceJob(__int64 a1, __int64 a2, __int64 a3, unsigned int a4, unsigned __int16 a5)
{
  __int64 v6; // r10
  __int64 v7; // r11
  int v8; // r8d
