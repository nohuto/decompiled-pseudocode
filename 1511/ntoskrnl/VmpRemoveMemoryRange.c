...
LABEL_9:
  ...
  v12 = v9 - 3;
  v13 = v9[3];
  if ( v13 == v10 && (v14 = v12[7], v14 == a2[7]) && v12[8] == a2[8] && v12[9] == a2[9] )
  {
    VmpProcessInvalidateSlat(SpinLock, v13, v14 - v13 + 1);
    RtlRbRemoveNode((unsigned __int64 *)(SpinLock + 8), v12 + 3);
    RtlRbRemoveNode((unsigned __int64 *)(SpinLock + 24), v12);
