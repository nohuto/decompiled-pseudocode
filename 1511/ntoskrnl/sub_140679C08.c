/*
 * XREFs of sub_140679C08 @ 0x140679C08
 * Callers:
...
__int64 __fastcall sub_140679C08(__int64 a1, __int64 a2, __int64 a3, __int64 a4)
{
  unsigned int *v4; // rax
  signed int v7; // ebx
  unsigned int i; // ecx
...
LABEL_15:
  if ( v7 >= 0 )
  {
    v13 = qword_1406FB380 ? qword_1406FB380() : -1073741637;
    v7 = v13;
    if ( v13 >= 0 )
    {
      v14 = *(_DWORD *)(a2 + 32);
