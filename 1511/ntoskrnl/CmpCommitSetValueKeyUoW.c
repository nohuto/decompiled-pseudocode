/*
 * XREFs of CmpCommitSetValueKeyUoW @ 0x1403D7548
 * Callers:
...
__int64 __fastcall CmpCommitSetValueKeyUoW(__int64 a1, __int64 *a2)
{
  ...
  _WORD v27[12]; // [rsp+60h] [rbp-18h] BYREF
...
LABEL_37:
  ...
  if ( (unsigned __int8)HvpMarkCellDirty(v8, *(unsigned int *)(*(_QWORD *)(a1 + 48) + 40LL)) )
  {
    *(_DWORD *)(a1 + 72) = *(_DWORD *)(*(_QWORD *)(a1 + 48) + 40LL) >> 31;
    ...
    if ( PoolWithTag )
    {
      CmpInitializeValueNameString(v10, v27, PoolWithTag);
      if ( (unsigned __int8)CmpFindNameInList(v8, (int)v5 + 36, (unsigned int)v27, 0, (__int64)&v25, (__int64)&v31) )
      {
        if ( *(_DWORD *)(a1 + 68) != 5 || (v19 = v31, v31 == -1) )
        {
          v21[0] = v11;
          v14 = CmpSetValueKeyNew(v8, *(_DWORD *)(v10 + 12), (__int64)Src, *(size_t *)v21, *(_DWORD *)(a1 + 72));
        }
        else
        {
          v31 = -1;
          if ( !(*(__int64 (__fastcall **)(ULONG_PTR, _QWORD, int *))(v8 + 8))(v8, v19, &v31) )
          {
            v14 = -1073741670;
LABEL_19:
            v6 = P;
        ...
        if ( v14 >= 0 )
        {
          HvpMarkCellDirty(v8, *(unsigned int *)(a1 + 84));
          v15 = v27[0];
