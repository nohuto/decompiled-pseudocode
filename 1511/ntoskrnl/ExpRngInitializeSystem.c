/*
 * XREFs of ExpRngInitializeSystem @ 0x14076B0AC
 * Callers:
...
__int64 ExpRngInitializeSystem()
{
  _OWORD *v0; // r8
  unsigned int v1; // r9d
  __int64 v2; // rdi
  ...
  memmove(&ExpLeftoverBootRngData, (const void *)(v1 + v2 + 1128), 4LL * ((1024 - v1) >> 2));
  memset((void *)(v2 + 1128), 0, 0x400uLL);
