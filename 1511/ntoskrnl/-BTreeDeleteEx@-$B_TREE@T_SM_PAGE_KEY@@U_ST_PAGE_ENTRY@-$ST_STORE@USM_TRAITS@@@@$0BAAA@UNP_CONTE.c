/*
 * XREFs of ?BTreeDeleteEx@?$B_TREE@T_SM_PAGE_KEY@@U_ST_PAGE_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@@@SAJPEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x14010FD10
 * Callers:
        ...
        __int64 a2)
{
  ...
  v3 = 0;
  v5 = (int **)(*(_QWORD *)a2 + 16LL * (unsigned int)(*(_DWORD *)(a2 + 24) - 1));
  v6 = *v5;
  v7 = v5[1];
  v8 = **v5;
  v9 = (__int64)*v5 + 16LL * (unsigned __int16)v8 - (_QWORD)v7;
  if ( v9 )
    memmove(v7, v7 + 4, (size_t)*v5 + 16LL * (unsigned __int16)v8 - (_QWORD)v7);
  --*(_WORD *)v6;
  if ( *((_BYTE *)v6 + 3) )
    --*((_QWORD *)a1 + 1);
  v10 = *v6;
  ...
  else
  {
    if ( (unsigned __int16)v10 < 0x7Fu )
    {
      ...
      if ( v15 < 0x7F )
      {
        ...
        if ( (v14 & 1) != 0 )
        {
          v21 = (int *)(v14 & 0xFFFFFFFFFFFFFFFEuLL);
          *v5 = v21;
          v5[1] = (int *)((char *)v21 + 16 * ((unsigned __int16)*v21 + 1LL) - v9);
        }
      }
      else
      {
