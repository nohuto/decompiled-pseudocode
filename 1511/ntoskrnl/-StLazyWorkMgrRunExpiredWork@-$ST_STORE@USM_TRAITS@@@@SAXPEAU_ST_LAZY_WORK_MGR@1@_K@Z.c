/*
 * XREFs of ?StLazyWorkMgrRunExpiredWork@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_LAZY_WORK_MGR@1@_K@Z @ 0x140111F54
 * Callers:
...
__int64 __fastcall ST_STORE<SM_TRAITS>::StLazyWorkMgrRunExpiredWork(unsigned __int64 a1, unsigned __int64 a2)
{
  ...
  *(_DWORD *)(a1 + 200) |= 1u;
  ...
  while ( v3 )
  {
    ...
    v11[4] = v10;
    v3 &= ~(1 << v10);
    ST_STORE<SM_TRAITS>::StWorkItemProcess(a1 - 4224, (unsigned __int64)v11 + 1);
  }
  *(_DWORD *)(a1 + 200) &= ~1u;
