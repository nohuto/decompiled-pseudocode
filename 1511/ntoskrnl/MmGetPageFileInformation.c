/*
 * XREFs of MmGetPageFileInformation @ 0x1404A6778
 * Callers:
...
__int64 __fastcall MmGetPageFileInformation(__int64 a1, unsigned int a2, int a3, unsigned int *a4)
{
  ...
  *(_DWORD *)(a1 + 4) = 0;
  ...
  while ( v10 < v9 )
  {
    v13 = *(int **)&MiSystemPartition[2 * v10 + 1432];
    v14 = *((_BYTE *)v13 + 204);
    if ( (v14 & 0x10) == 0 && (v14 & 0x40) == 0 )
    {
      ...
      *(_DWORD *)(v12 + 12) = v18;
      ...
      WORD3(v22) = 0;
      LOWORD(v22) = *(_WORD *)(*(_QWORD *)&MiSystemPartition[2 * v10 + 1432] + 96LL);
      ...
      *(_OWORD *)(v12 + 16) = v22;
      ...
      memmove(
        (void *)(v12 + v8),
        *(const void **)(*(_QWORD *)&MiSystemPartition[2 * v10 + 1432] + 104LL),
