/*
 * XREFs of PpDevCfgProcessDeviceExtensions @ 0x14060D284
 * Callers:
  ...
  *(_DWORD *)&DestinationString.Length = 0;
  ...
  do
  {
    ...
    else
    {
      ...
      inited = PiDevCfgAppendMultiSz(&v29, (const void **)(v5 + 40), 0LL, 0);
      if ( inited < 0 )
        goto LABEL_61;
      v7 = 0;
      v8 = &v28;
