/*
 * XREFs of IopErrorLogThread @ 0x140503EFC
 * Callers:
 *     <none>
 * Callees:
...
LABEL_14:
      ...
      while ( 1 )
      {
        v11 = ObQueryNameStringMode(*(char **)(v0 + 24), (__int64)p_P, v7, &v14, 0);
        if ( v11 != -1073741820 )
          break;
        if ( v6 )
          goto LABEL_15;
        p_P = (UNICODE_STRING *)sub_1401BD574(PagedPool, v14);
        if ( !p_P )
          goto LABEL_15;
        v7 = v14;
        v6 = 1;
      ...
      {
LABEL_15:
        RtlInitUnicodeString(&v19, &word_140551830);
        v8 = 0;
      }
      pszDest[0] = 0;
      v23[0] = 0;
