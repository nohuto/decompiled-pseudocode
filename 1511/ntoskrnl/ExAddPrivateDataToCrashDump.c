/*
 * XREFs of ExAddPrivateDataToCrashDump @ 0x1402129B4
 * Callers:
  ...
  while ( 1 )
  {
    ...
    if ( v3 >= 0x280 )
    {
      ...
      if ( ExpNumberOfNonPagedPools )
      {
        while ( 1 )
        {
          v7 = MmAddRangeToCrashDump(a1, (__int64 *)ExpNonPagedPoolDescriptor[v6], 8832LL);
          if ( v7 < 0 )
          {
            v1 = v7;
            if ( v7 == -1073741789 )
...
LABEL_10:
        ...
        {
LABEL_14:
          v10 = MmAddRangeToCrashDump(a1, (__int64 *)ExpSessionPoolTrackTable, 40 * ExpSessionPoolTrackTableSize);
          if ( v10 < 0 )
        ...
        else
        {
          while ( 1 )
          {
            v9 = MmAddRangeToCrashDump(a1, (__int64 *)ExpPagedPoolDescriptor[v8], 4416LL);
            if ( v9 < 0 )
            {
              v1 = v9;
              if ( v9 == -1073741789 )
