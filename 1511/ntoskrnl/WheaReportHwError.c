/*
 * XREFs of WheaReportHwError @ 0x140216078
 * Callers:
 *     <none>
 * Callees:
 ...
 *     WheapApplyThresholdChecks @ 0x140216454 (WheapApplyThresholdChecks.c)
 *     WheapAttemptErrorRecovery @ 0x140216530 (WheapAttemptErrorRecovery.c)
...
__int64 __fastcall WheaReportHwError(__int64 a1)
{
  ...
  *(_DWORD *)(v11 + 24) ^= (*(_DWORD *)(v11 + 24) ^ (*(_DWORD *)(a1 + 12) >> 2)) & 8;
  v15 = (*((__int64 (__fastcall **)(__int64, __int64, __int64, __int64, _QWORD))&unk_14031C600 + 6 * *(int *)(v10 + 40)))(
          v10 + 89,
          a1,
          v11 + 40,
          v14,
...
LABEL_25:
        ...
        {
          if ( LODWORD(WheapDispatchPtr.Queue.ListEntry.Flink) == 1 )
