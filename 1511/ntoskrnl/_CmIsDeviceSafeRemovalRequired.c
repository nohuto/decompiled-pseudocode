/*
 * XREFs of _CmIsDeviceSafeRemovalRequired @ 0x14045C2F8
 * Callers:
...
bool __fastcall CmIsDeviceSafeRemovalRequired(__int64 a1, const WCHAR *a2, __int64 a3)
{
  ...
  _BYTE v22[4]; // [rsp+78h] [rbp-88h] BYREF
  int v23; // [rsp+7Ch] [rbp-84h] BYREF
  _DWORD v24[4]; // [rsp+80h] [rbp-80h] BYREF
  ...
  v24[0] = 0;
  v6 = 0;
  if ( (int)CmGetDeviceStatus(a1, a2, a3, &v19, &v20, v24, v15) >= 0 )
  {
    v7 = v19;
    v17 = 4;
    DeviceRegProp = CmGetDeviceRegProp(a1, (__int64)a2, a3, 16, (__int64)v22, (__int64)&v18, (__int64)&v17);
    v9 = v18;
    if ( DeviceRegProp < 0 )
      v9 = 0;
    v18 = v9;
    ...
    if ( (v7 & 8) != 0 || (v9 & 2) != 0 )
    {
      ...
      if ( !v10 && v6 )
      {
        ...
        {
          v21 = 200;
          if ( (int)CmGetDeviceParent(a1, pszDest, pszSrc, &v21) < 0 )
            return v10;
          v17 = 4;
          v13 = CmGetDeviceRegProp(a1, (__int64)pszSrc, 0LL, 16, (__int64)v22, (__int64)&v18, (__int64)&v17);
          v14 = v18;
          if ( v13 < 0 )
            v14 = 0;
          v18 = v14;
