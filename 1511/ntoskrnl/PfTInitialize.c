/*
 * XREFs of PfTInitialize @ 0x14054089C
 * Callers:
...
__int64 __fastcall PfTInitialize(__int64 a1, __int64 a2, char a3)
{
  ...
  __int64 (__fastcall *v16)(struct _EX_RUNDOWN_REF *); // [rsp+38h] [rbp-18h]
  ...
  *(_QWORD *)(a1 + 520) = a1 + 520;
  ...
  v12 = 1280206416;
  v16 = (__int64 (__fastcall *)(struct _EX_RUNDOWN_REF *))PfpSectInfoHandleOutOfBuffers;
  LOBYTE(v7) = a3;
  v13 = 1;
  v14 = 64;
  v15 = 64LL;
