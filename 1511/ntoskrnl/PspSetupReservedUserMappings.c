/*
 * XREFs of PspSetupReservedUserMappings @ 0x1404B7C1C
 * Callers:
...
__int64 __fastcall PspSetupReservedUserMappings(_KPROCESS *a1, $D4FCF91253F76F57393CBFE908971F67 *a2, _QWORD *a3)
{
  int v5; // ebx
  ...
  if ( !v5 && !a3[31] )
    return 0LL;
  VirtualMemory = 0;
  KiStackAttachProcess(a1, 0LL, (__int64)a2);
  if ( !v5 )
    goto LABEL_10;
  BaseAddress = (PVOID)4;
  if ( v5 == 32 )
