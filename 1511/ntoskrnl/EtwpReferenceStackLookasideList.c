/*
 * XREFs of EtwpReferenceStackLookasideList @ 0x14066676C
 * Callers:
...
struct _SLIST_ENTRY *EtwpReferenceStackLookasideList()
{
  ...
  v0 = 2 * KeNumberProcessors_0 * _InterlockedIncrement(&dword_1403062B0);
  do
  {
    ...
    result = (struct _SLIST_ENTRY *)(unsigned int)_InterlockedIncrement(&dword_1403062B4);
  }
  while ( (int)result < v0 );
  return result;
}
