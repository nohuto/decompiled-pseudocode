/*
 * XREFs of HvlpLogIommuInitStatus @ 0x1401B4F1C
 * Callers:
...
__int64 HvlpLogIommuInitStatus()
{
  ...
  v0 = (_DWORD *)HvlpAcquireHypercallPage(v8, 1, (__int64)v23, 8LL);
  v1 = HvlpAcquireHypercallPage(v9, 2, (__int64)v24, 1032LL);
  v2 = v9[3];
  v3 = v8[3];
  v4 = (_OWORD *)v1;
  *v0 = 5;
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v20 = 8LL;
  v22 = 8LL;
  result = sub_1401B5178(&HV_EVENTLOG_IOMMU_INIT, 7u, &UserData);
  if ( BYTE1(v9[4].LowPart) && v9[5].QuadPart == 1 )
  {
    if ( v9[8].QuadPart )
      return sub_1401B5178(&HV_EVENTLOG_IOMMU_INIT_POLICY_ENABLE, 0, 0LL);
  }
  return result;
}
