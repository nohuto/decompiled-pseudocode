/*
 * XREFs of MiExtendPagingFiles @ 0x1406256F8
 * Callers:
...
void __fastcall MiExtendPagingFiles(__int64 a1)
{
  ...
  {
    _mm_lfence();
    v6 = *(_QWORD *)(v1 + 8 * v4 + 5728);
    if ( *(_QWORD *)(v6 + 8) - *(_QWORD *)v6 < v3 )
      return;
    v7 = MiAttemptPageFileExtension(*(_QWORD *)(v1 + 8 * v4 + 5728), v3);
    v8 = v7;
