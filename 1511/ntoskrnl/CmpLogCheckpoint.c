/*
 * XREFs of CmpLogCheckpoint @ 0x1404BAB0C
 * Callers:
...
__int64 __fastcall CmpLogCheckpoint(__int64 a1, __int64 a2, char a3)
{
  ...
  while ( 1 )
  {
    ...
    if ( !NextElement )
      break;
    v17 = (const CLFS_LSN *)(NextElement + 96);
    if ( !ClfsLsnInvalid((const CLFS_LSN *)NextElement + 12) )
    {
  ...
  if ( PoolWithTag )
  {
    ClfsGetLogFileInformation(*(PLOG_FILE_OBJECT *)(a1 + 88), PoolWithTag, &v22);
  ...
  if ( v14 )
  {
    ClfsGetLogFileInformation(*(PLOG_FILE_OBJECT *)(a1 + 88), v14, &v21);
