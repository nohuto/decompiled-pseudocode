/*
 * XREFs of EtwpLogSessionWorkingSetInfo @ 0x1406617E8
 * Callers:
    ...
    if ( (unsigned int)MmQuerySessionWorkingSetInformation((__int64)PoolWithTag, &v13) != -1073741820 )
    {
      if ( v13 )
      {
        ...
        if ( v4 )
        {
          ...
          if ( a1 )
          {
            EtwpLogKernelEvent((__int64)&UserData, *a1, 2LL, 0x27Eu, 0x401804u);
          }
          else
          {
            if ( (DWORD1(PerfGlobalGroupMask) & 0x800000) != 0 )
              EtwTraceKernelEvent((int)&UserData, 2, 0x20800000u, 0x27Eu, 4200452);
