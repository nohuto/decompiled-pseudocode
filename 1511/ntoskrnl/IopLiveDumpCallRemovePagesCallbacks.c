/*
 * XREFs of IopLiveDumpCallRemovePagesCallbacks @ 0x1403AE450
 * Callers:
...
char __fastcall IopLiveDumpCallRemovePagesCallbacks(__int64 a1)
{
  ...
  _QWORD v28[6]; // [rsp+A8h] [rbp-70h] BYREF
  struct _EVENT_DATA_DESCRIPTOR UserData; // [rsp+D8h] [rbp-40h] BYREF
