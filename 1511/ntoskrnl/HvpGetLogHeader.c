/*
 * XREFs of HvpGetLogHeader @ 0x1405EC47C
 * Callers:
 ...
 *     HvpDetermineLatestLogFile @ 0x1405EE0E0 (HvpDetermineLatestLogFile.c)
 */
        ...
        _OWORD *a7)
{
  ...
  char v64; // [rsp+4Ch] [rbp-B4h] BYREF
  char v65; // [rsp+4Dh] [rbp-B3h]
  char v66; // [rsp+4Eh] [rbp-B2h] BYREF
  char v67; // [rsp+4Fh] [rbp-B1h] BYREF
  ...
  int FileInformation; // [rsp+88h] [rbp-78h] BYREF
...
LABEL_22:
  if ( stru_1402CFD30.LevelPlus1 > 5 )
  {
    ...
    v90 = 4;
    v93 = 4;
    TlgWrite(&stru_1402CFD30, &unk_1402536FA, 0LL, 0LL, 7u, &pData);
  }
  if ( !a7 )
  {
    if ( v12 )
...
LABEL_92:
        if ( v12 == 2 )
        {
          ...
          if ( v59 <= v27 )
          {
            v62 = __PAIR64__(v26, HIDWORD(v62));
            goto LABEL_99;
          }
        }
        else if ( v12 != 1 )
...
LABEL_101:
  ...
  while ( v56 );
  if ( v17 == 1 && stru_1402CFD30.LevelPlus1 > 5 && TlgKeywordOn(&stru_1402CFD30, 0x400000000000uLL) )
    TlgWrite(&stru_1402CFD30, &unk_1402536D6, 0LL, 0LL, 2u, &v78);
  return v17;
}
