/*
 * XREFs of ?BTreeSearchResultDeref@?$B_TREE@KU_ST_REGION_ENTRY@?$ST_STORE@USM_TRAITS@@@@$0BAAA@UNP_CONTEXT@@@@SAXPEAU1@PEAUSEARCH_RESULT@1@@Z @ 0x1400F7010
 * Callers:
...
void __fastcall B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeSearchResultDeref(
        __int64 *a1,
        __int64 a2)
{
  _DWORD **v4; // rax
    ...
    if ( v5 == -1 )
    {
      ...
      if ( v6 )
      {
        ...
        if ( v6 != *a1 )
        {
          ...
          v11 = alloca(v10);
          v12 = alloca(v10);
          B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeSearchResultInit(v23, 2LL);
          v24 = 0;
          v25 = v21[0];
          v23[0] = v21;
          ...
          if ( v14 <= v15 + 16 )
            ...
            v16 = (void **)(v14 - 8);
          B_TREE<unsigned long,ST_STORE<SM_TRAITS>::_ST_REGION_ENTRY,4096,NP_CONTEXT>::BTreeSearchResultDeref(a1, v23);
          if ( *(_DWORD *)a1[2] != -1 )
