/*
 * XREFs of sub_14067C9CC @ 0x14067C9CC
 * Callers:
...
__int64 __fastcall sub_14067C9CC(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  int v6; // edx
  unsigned int *v7; // rcx
  unsigned int *v8; // rax
...
LABEL_81:
    if ( v6 < 0 )
      return (unsigned int)v6;
    v6 = sub_140668B98(v54, v30, v31, (_DWORD)a2 != 0, v56 != 0);
    if ( v6 < 0 )
      return (unsigned int)v6;
    if ( &v56 )
    {
