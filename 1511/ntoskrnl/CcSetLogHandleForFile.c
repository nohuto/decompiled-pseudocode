/*
 * XREFs of CcSetLogHandleForFile @ 0x1401A957C
 * Callers:
 *     <none>
 * Callees:
    ...
    if ( *((_DWORD *)SharedCacheMap + 28) )
    {
      ...
      *((_QWORD *)SharedCacheMap + 16) = v12;
      if ( *v12 != &CcDirtySharedCacheMapWithLogHandleList )
        __fastfail(3u);
      *v12 = v11;
      qword_1402FD998 = (__int64)(SharedCacheMap + 120);
    }
    else
    {
      v13 = (__int64 **)qword_1402FD978;
      ...
      *((_QWORD *)SharedCacheMap + 16) = v13;
      if ( *v13 != &CcCleanSharedCacheMapWithLogHandleList )
        __fastfail(3u);
      *v13 = v11;
      qword_1402FD978 = (__int64)(SharedCacheMap + 120);
    }
  }
