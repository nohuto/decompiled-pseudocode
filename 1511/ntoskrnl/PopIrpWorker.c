/*
 * XREFs of PopIrpWorker @ 0x1401212D0
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __fastcall PopIrpWorker(__int64 *Entry)
{
  ...
  {
    if ( *Entry )
      KeReleaseSemaphoreEx(*Entry, 0, 1LL, v3, 0);
  ...
  v31[1] = qword_1402DD1E8;
  if ( *(__int64 **)qword_1402DD1E8 != &PopIrpThreadList )
    __fastfail(3u);
  *(_QWORD *)qword_1402DD1E8 = v31;
  qword_1402DD1E8 = (__int64)v31;
LABEL_7:
  ...
  do
  {
    if ( KeWaitForSingleObject(&PopIrpWorkerSemaphore, Executive, 0, 0, Timeout) != 258 )
    {
      ...
      *(_QWORD *)(v6 + 8) = &PopIrpWorkerList;
      ...
      v14 = 2LL;
      v15 = *(_QWORD *)(v8 + 72LL * *(char *)(v8 + 66) + 200);
