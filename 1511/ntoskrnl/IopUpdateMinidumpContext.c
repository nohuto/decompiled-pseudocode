/*
 * XREFs of IopUpdateMinidumpContext @ 0x1401B9CA4
 * Callers:
...
LABEL_9:
  ...
  if ( a1 == 257 && !a3 )
  {
    ...
    IoAddTriageDumpDataBlock(*(_QWORD *)(a4 + 25216), 1232);
    v18 = *(_QWORD *)(v17 + 88);
    v19 = *(_QWORD *)(*(_QWORD *)(a4 + 25216) + 152LL) - 4096LL;
...
LABEL_39:
  for ( i = (__int64 *)PopThermal; i != &PopThermal; i = (__int64 *)*i )
    result = IoAddTriageDumpDataBlock((int)i, 840);
  if ( v6 )
  {
