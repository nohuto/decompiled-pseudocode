/*
 * XREFs of EtwpApplyStackWalkFilter @ 0x1402113F8
 * Callers:
 ...
 * Callees:
 *     EtwpPerfectHashFunctionSearch @ 0x140211474 (EtwpPerfectHashFunctionSearch.c)
 */
...
bool __fastcall EtwpApplyStackWalkFilter(__int64 a1, __int64 a2, unsigned int a3, char a4)
{
  ...
  if ( a4 )
  {
    ...
    __writecr8(2uLL);
    if ( *(_QWORD *)(*(_QWORD *)(a2 + 368) + 72LL * a3 + 40) )
    {
  ...
  else if ( *(_QWORD *)(*(_QWORD *)(a2 + 368) + 72LL * a3 + 40) )
  {
