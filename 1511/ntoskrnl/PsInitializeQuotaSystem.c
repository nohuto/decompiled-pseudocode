/*
 * XREFs of PsInitializeQuotaSystem @ 0x14074B984
 * Callers:
 *     MiInitSystem @ 0x14074C59C (MiInitSystem.c)
 *     InitBootProcessor @ 0x140763EA0 (InitBootProcessor.c)
 * Callees:
 *     PspRegisterResource @ 0x1401330F4 (PspRegisterResource.c)
 *     ExAllocatePoolWithTag @ 0x140238380 (ExAllocatePoolWithTag.c)
 *     PspSanitizeResourceLimits @ 0x140520ACC (PspSanitizeResourceLimits.c)
 *     PspInitializeQuotaExpansionDescriptor @ 0x14074BAB4 (PspInitializeQuotaExpansionDescriptor.c)
 */
...
char __fastcall PsInitializeQuotaSystem(int a1)
{
  ...
  if ( a1 )
  {
    ...
    PspInitializeQuotaExpansionDescriptor((unsigned int)&unk_1402DC158, v11, 0x80000, v12);
LABEL_9:
  ...
  while ( (__int64)v2 < (__int64)&MiPermanentIoSpaceEnd );
