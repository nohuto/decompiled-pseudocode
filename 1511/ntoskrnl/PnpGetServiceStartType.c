/*
 * XREFs of PnpGetServiceStartType @ 0x140503E5C
 * Callers:
    ...
    if ( v10 >= 0 )
    {
      ...
      else
      {
        if ( *(_QWORD *)&PiPnpRtlCtx )
          ...
          v13 = 0LL;
        v14 = SysCtxRegOpenKey(v13, qword_14031D100, (__int64)L"*Driver", 0, 0x20019u, (__int64)&qword_14031D0F8);
        if ( v14 == -1073741772 )
        {
          v12 = -1LL;
          qword_14031D0F8 = -1LL;
