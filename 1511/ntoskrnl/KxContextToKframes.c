/*
 * XREFs of KxContextToKframes @ 0x14002DEA0
 * Callers:
...
LABEL_38:
  ...
  if ( (a4 & 0x100010) != 0x100010 )
    return v5;
  v14 = *(_QWORD *)(a3 + 72);
  if ( a5 && v14 > (unsigned __int64)MmHighestUserAddress )
    v14 = 0LL;
  *(_QWORD *)(a1 + 216) = v14;
  v15 = *(_QWORD *)(a3 + 80);
  if ( a5 && v15 > (unsigned __int64)MmHighestUserAddress )
    v15 = 0LL;
  *(_QWORD *)(a1 + 224) = v15;
  v16 = *(_QWORD *)(a3 + 88);
  if ( a5 && v16 > (unsigned __int64)MmHighestUserAddress )
    v16 = 0LL;
  *(_QWORD *)(a1 + 232) = v16;
  v17 = *(_QWORD *)(a3 + 96);
  if ( a5 && v17 > (unsigned __int64)MmHighestUserAddress )
    v17 = 0LL;
  *(_QWORD *)(a1 + 240) = v17;
  *(_QWORD *)(a1 + 248) = 0LL;
