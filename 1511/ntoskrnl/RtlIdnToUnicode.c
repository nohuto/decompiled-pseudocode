/*
 * XREFs of RtlIdnToUnicode @ 0x140649B24
 * Callers:
 *     <none>
 * Callees:
        ...
        PLONG DestinationStringLength)
{
  ...
  if ( result >= 0 )
  {
    ...
    if ( (v8 & 8) == 0 && !Normalized[0] )
    {
      ...
      if ( v13 < v11 - (v9 != 0) )
      {
        v14 = v11 - ((v9 != 0) + 1) - (int)v13;
        LODWORD(pcchLength) = v11 - ((v9 != 0) + 1) - v13;
        ...
        if ( RtlIsNormalizedString((((v8 & 1) == 0) << 8) | 0xD, (PCWSTR)(v12 + 2), pcchLength, Normalized) < 0
          || !Normalized[0] )
        {
    ...
    if ( DestinationString && *DestinationStringLength )
    {
      if ( v11 > *DestinationStringLength )
        return -1073741789;
      memmove(DestinationString, SourceStringa, 2LL * v11);
    }
