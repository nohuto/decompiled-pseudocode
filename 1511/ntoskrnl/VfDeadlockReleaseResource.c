/*
 * XREFs of VfDeadlockReleaseResource @ 0x1406CC480
 * Callers:
      ...
      else
      {
        if ( v21 != 1 || (_DWORD)v4 != 2 )
        {
          ViDeadlockPreprocessOptions(
            ...
            (const void *)0x1009);
          VfReportIssueWithOptions(196, 4105, (int)a1, *v20, v4, byte_1402D406C);
LABEL_58:
          v33 = v41;
        ...
        else
        {
          ...
          if ( (ViDeadlockResourceTypeInfo[*(int *)v26[7]] & 4) == 0 && (ViDeadlockResourceTypeInfo[*v20] & 4) == 0 )
          {
            ...
            ViDeadlockPreprocessOptions(
              ...
              *(_QWORD *)(v26[7] + 8),
              v11);
            VfReportIssueWithOptions(196, 4099, (int)a1, *(_QWORD *)(v26[7] + 8), (ULONG_PTR)v11, byte_1402D4064);
            v28 = ViDeadlockGlobals;
          }
          while ( (int *)v26[7] != v20 )
          {
...
LABEL_57:
           ...
           && *((_DWORD *)ViDeadlockGlobals + 8282) <= ViDeadlockChildrenCountMaximum )
    {
      ...
      VfReportIssueWithOptions(196, 4103, (int)a1, (int)v20, v25, &dword_1402D4060);
    }
    goto LABEL_58;
  }
LABEL_60:
