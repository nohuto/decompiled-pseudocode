/*
 * XREFs of ExpWnfWriteStateData @ 0x1403E68DC
 * Callers:
...
__int64 __fastcall ExpWnfWriteStateData(__int64 a1, const void *a2, unsigned int a3, int a4, int a5)
{
  ...
  $D4FCF91253F76F57393CBFE908971F67 v27; // [rsp+70h] [rbp-88h] BYREF
  ...
  *(_DWORD *)&ValueName.Length = 2228224;
  ...
  else
  {
    ...
    {
      v17 = 1;
      KiStackAttachProcess(v16, 0LL, (__int64)&v27);
    }
  ...
  *((_DWORD *)PoolWithTag + 1) = v6;
  v19 = KeAbPreAcquire(a1 + 80, 0LL, 0LL);
  v20 = v19;
