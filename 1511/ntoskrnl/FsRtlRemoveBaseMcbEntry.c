/*
 * XREFs of FsRtlRemoveBaseMcbEntry @ 0x1400D6DF4
 * Callers:
      ...
      if ( (unsigned int)(v31 - 1) >= v4 + v3 )
      {
        if ( v29[2 * v41 + 1] != -1 )
        {
          ...
          *((_DWORD *)Mcb->Mapping + 2 * v35) = v3 + v4;
          if ( (_DWORD)v6 )
            v36 = *((_DWORD *)Mcb->Mapping + 2 * (unsigned int)(v6 - 1));
          else
            v36 = 0;
          if ( (_DWORD)v6 == -1 )
            v37 = 0;
          else
            v37 = *((_DWORD *)Mcb->Mapping + 2 * v6);
...
LABEL_17:
    ...
    if ( v41 == v12 )
    {
      ...
      if ( v14 != -1 )
      {
        v34 = v41 == 1 ? 0 : Mapping[2 * v41 - 4];
        if ( v14 - v34 + Mapping[2 * v13] - 1 != -1 )
          goto LABEL_57;
      }
