/*
 * XREFs of sub_1404962F4 @ 0x1404962F4
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall sub_1404962F4(__int64 a1, __int64 a2, __int64 a3)
{
  _DWORD *v6; // rdi
  int v7; // eax
  int v8; // ecx
  ...
  {
    v18 = 66067;
    v7 = sub_1404964E4(a2, 1507330LL, &v18, 8LL, &v18, 8, 0LL, 0LL);
    v8 = v18;
    if ( v7 < 0 )
      v8 = v7;
    v18 = v8;
    v16 = 16843009;
    v9 = sub_1404964E4(a2, 1507330LL, &v16, 10LL, &v16, 10, 0LL, 0LL);
    if ( v9 < 0 )
    {
      *(_BYTE *)(a3 + 33) |= 0x20u;
      v16 = v9;
  ...
  v10 = sub_1404577BC(a1, (__int64)v15, &v16, 6u);
  if ( v10 >= 0 )
  {
    ...
    v10 = sub_1404577BC(a1, (__int64)v15, v6, v11);
    if ( v6 )
