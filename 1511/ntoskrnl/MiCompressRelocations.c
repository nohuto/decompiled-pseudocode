/*
 * XREFs of MiCompressRelocations @ 0x1403C5A60
 * Callers:
...
char *__fastcall MiCompressRelocations(_QWORD *P, int a2)
{
  ...
  if ( !v3 )
    return (char *)v6;
  PoolWithTag = (char *)ExAllocatePoolWithTag(PagedPool, v7 + 8 * (v6[6] + 9LL), 0x65526D4Du);
  v39 = PoolWithTag;
  v19 = PoolWithTag;
  if ( !PoolWithTag )
    return (char *)v6;
  ...
  *((_QWORD *)PoolWithTag + 8) = v6[8];
  PoolWithTag[60] = v5;
  *(_QWORD *)PoolWithTag = PoolWithTag + 72;
  v23 = (__int64)&PoolWithTag[8 * v6[6] + 72];
