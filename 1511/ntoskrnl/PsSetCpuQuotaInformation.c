/*
 * XREFs of PsSetCpuQuotaInformation @ 0x1401F50E0
 * Callers:
 ...
 *     MmGetSessionSchedulingGroup @ 0x14054F6E8 (MmGetSessionSchedulingGroup.c)
...
__int64 __fastcall PsSetCpuQuotaInformation(unsigned __int64 a1, unsigned int a2, KPROCESSOR_MODE a3)
{
  ...
  if ( a3 )
  {
    ...
    if ( a3 )
    {
      ...
      if ( a1 + v4 > MmUserProbeAddress || a1 + v4 < a1 )
