/*
 * XREFs of _CmValidateDeviceInterfaceName @ 0x14043AD30
 * Callers:
...
NTSTATUS __fastcall CmValidateDeviceInterfaceName(__int64 a1, __int64 a2)
{
  ...
  if ( RtlInitUnicodeStringEx(&DestinationString, (PCWSTR)a2) < 0
    ...
    || !RtlPrefixUnicodeString(&stru_14023BA68, &DestinationString, 0)
    && !RtlPrefixUnicodeString(&stru_14023BA78, &DestinationString, 0) )
  {
    return -1073741773;
  }
  v5 = *(_WORD *)(a2 + 8);
