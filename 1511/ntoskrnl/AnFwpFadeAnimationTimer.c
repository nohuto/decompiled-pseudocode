/*
 * XREFs of AnFwpFadeAnimationTimer @ 0x1406DAF40
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( byte_1403069E6 )
  {
    ...
    v58 = qword_1402CF6C0;
    v56 = qword_1402CF6F0;
    v10 = 10 * (dword_1402CF670 - dword_1402CF670 / (unsigned int)(dword_1402D4BB4 - dword_1402CF674));
    v14 = 0;
    if ( (unsigned int)BgpGetBitsPerPixel() == 24 )
    {
      if ( !v5 )
      {
        ...
        v32 = 0;
        v33 = *(_QWORD *)(v12 + 24);
        for ( i = *(_QWORD *)(qword_1402CF6B8 + 24); v32 < *(_DWORD *)(v31 + 12); ++v32 )
        {
          v35 = *(_BYTE *)(v32 + i);
          if ( v35 )
          {
    ...
    else
    {
      if ( !v5 )
      {
        ...
        v16 = 0;
        v17 = *(_QWORD *)(v12 + 24);
        v18 = *(_QWORD *)(qword_1402CF6B8 + 24);
        if ( *(_DWORD *)(qword_1402CF6B8 + 12) )
        {
          do
          {
            if ( *(_DWORD *)(v16 + v18) )
    ...
    if ( !v6 )
    {
      if ( !v54 && !v4 || (BgpGxDrawRectangle(v55, (__int64)&xmmword_1402CF690), !v4) )
        v6 = 1;
    }
    if ( !v7 )
    {
      if ( v54 || v4 )
        BgpGxDrawRectangle(v56, (__int64)&xmmword_1402CF6C8);
      if ( !v30 )
        v7 = 1;
    }
    ...
    if ( v14 || v30 || v4 )
    {
      byte_1402CF680 = v6;
      byte_1402CF681 = v7;
      dword_1402CF670 = v10 / 0xA;
      dword_1402CF674 = v54 + 1;
      byte_1402CF682 = v5;
    }
    else
    {
      byte_1403069E6 = 0;
      KeCancelTimer(&stru_14031C3A0);
      KeSetEvent(&stru_14031C380, 0, 0);
    }
  }
  BgpFwReleaseLock();
}
