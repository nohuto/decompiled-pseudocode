/*
 * XREFs of PopFxRegisterComponentPerfStates @ 0x140634CF4
 * Callers:
 ...
 *     PopPluginRegisterComponentPerfStates @ 0x1401EBE44 (PopPluginRegisterComponentPerfStates.c)
        ...
        if ( v46 || (v8 & 1) != 0 )
        {
          ...
          if ( (_DWORD)v14 )
          {
            ...
            do
            {
              ...
              {
                v26 = *v25;
                v52 = (*v25 * (unsigned __int128)(unsigned int)(DWORD2(v19) + 16)) >> 64;
