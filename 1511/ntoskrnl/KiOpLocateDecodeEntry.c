/*
 * XREFs of KiOpLocateDecodeEntry @ 0x140023934
 * Callers:
...
__int64 __fastcall KiOpLocateDecodeEntry(__int64 a1)
{
  ...
  if ( *(_BYTE *)(a1 + 49) )
  {
    ...
    v3 = &DEVPKEY_Device_DriverProblemDesc;
  }
  else
  {
    v2 = (const DEVPROPKEY *)&KiOpOneByteTable;
    v3 = (const DEVPROPKEY *)&EtwpNull;
  }
  while ( 1 )
  {
    v4 = *(_BYTE *)(a1 + 48);
    ...
    if ( v2->fmtid.Data4[0] == 0xFF && v2->fmtid.Data4[1] == 0xFF && v2->fmtid.Data4[2] == 0xFF )
      break;
    if ( !*(_BYTE *)(a1 + 72) )
    {
