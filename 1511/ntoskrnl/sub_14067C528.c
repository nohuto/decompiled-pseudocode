...
__int64 __fastcall sub_14067C528(__int64 a1, __int64 a2, int a3, __int64 a4)
{
  int v6; // ebx
...
LABEL_51:
    ...
    v47 = v36;
    updated = ExUpdateOsPfnInRegistry(2 * v20 + 2, P, 2 * v50 + 2, v36);
    if ( updated >= 0 )
    {
      updated = qword_1406FB400 ? qword_1406FB400(P) : -1073741637;
