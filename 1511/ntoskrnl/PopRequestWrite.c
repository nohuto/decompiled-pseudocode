/*
 * XREFs of PopRequestWrite @ 0x1403A1D5C
 * Callers:
 *     PopWriteHiberImage @ 0x1403A0D54 (PopWriteHiberImage.c)
 *     PopCompressCallback @ 0x1403A1D48 (PopCompressCallback.c)
 * Callees:
  ...
  while ( 1 )
  {
    ...
    if ( v7 == 1 )
    {
      BugCheckParameter4 = (*(int (__fastcall **)(__int64, ULONG_PTR, __int64))(*(_QWORD *)(v6 + 168) + 128LL))(
                             ...
                             v3);
      v22 = __rdtsc();
      qword_1402DE628 += (((unsigned __int64)HIDWORD(v22) << 32) | (unsigned int)v22) - v20;
...
LABEL_26:
    ...
    {
      qword_1402DE620 += v19 - *(_QWORD *)(v6 + 344);
      ProducerConsumerBufferComplete(v5, v5 + 48, *(_QWORD *)(v6 + 392), *(unsigned int *)(v6 + 368));
      v32 = __rdtsc();
      qword_1402DE648 += (((unsigned __int64)HIDWORD(v32) << 32) | (unsigned int)v32) - v20;
      qword_1402DE7D8 += *(_QWORD *)(v6 + 368);
      dword_1402DE7E0 += (unsigned __int64)(*(_QWORD *)(v6 + 360) + 4095LL) >> 12;
      v33 = *(_QWORD *)(v6 + 360);
      *(_QWORD *)(v6 + 384) += v33;
      *(_QWORD *)(v6 + 352) += v33;
      *(_QWORD *)(v6 + 360) = 0LL;
  ...
  if ( Buffer )
  {
    ...
    *(_QWORD *)(v6 + 368) = v24;
    if ( v23 + v14 > qword_1402DE2F0 )
    {
      ...
      KeBugCheckEx(0xA0u, 0xBuLL, qword_1402DE2F0, *(unsigned int *)(v6 + 184), RemainingHibernateRangeDataSize);
    }
    LOBYTE(v16) = 1;
    ...
    *(_QWORD *)(v6 + 360) = v14;
    ...
    v30 = (*(int (__fastcall **)(__int64, ULONG_PTR, __int64, _QWORD))(*(_QWORD *)(v6 + 168) + 128LL))(
            ...
            0LL);
    v31 = __rdtsc();
    qword_1402DE628 += (((unsigned __int64)HIDWORD(v31) << 32) | (unsigned int)v31) - v29;
...
LABEL_29:
      ...
      v35 = __rdtsc();
      qword_1402DE628 += (((unsigned __int64)HIDWORD(v35) << 32) | (unsigned int)v35) - v29;
