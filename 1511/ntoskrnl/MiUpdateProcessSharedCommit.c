/*
 * XREFs of MiUpdateProcessSharedCommit @ 0x14049C8D0
 * Callers:
...
_QWORD *__fastcall MiUpdateProcessSharedCommit(__int64 a1)
{
  ...
  if ( (_DWORD)result )
  {
    ...
    while ( v5 )
    {
      v6 = v5[3];
      if ( (v6 & 1) != 0 )
        _InterlockedExchangeAdd64((volatile signed __int64 *)((v6 & 0xFFFFFFFFFFFFFFFEuLL) + 1312), v3);
      else
        _InterlockedExchangeAdd64((volatile signed __int64 *)(v6 + 1888), v3);
      result = (_QWORD *)v5[1];
      v7 = v5;
      if ( result )
      {
