/*
 * XREFs of VfXdvExcludeParseRegistryString @ 0x1407858B0
 * Callers:
      ...
      do
      {
        ...
        else
        {
          ...
          if ( v7 )
          {
            ...
            {
              VfDriverLock();
              v9 = (__int64 **)qword_1402DB2E8;
              *v8 = (__int64)&VfXdvExcludedDriversList;
              v8[1] = (__int64)v9;
              if ( *v9 != &VfXdvExcludedDriversList )
                __fastfail(3u);
              *v9 = v8;
              qword_1402DB2E8 = (__int64)v8;
