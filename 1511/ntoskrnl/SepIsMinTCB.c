/*
 * XREFs of SepIsMinTCB @ 0x14044880C
 * Callers:
...
__int64 __fastcall SepIsMinTCB(PCUNICODE_STRING String2, unsigned int a2, char a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  if ( !_InterlockedCompareExchange64((volatile signed __int64 *)&qword_14031A508, 0LL, 0LL) )
  {
  ...
  v9 = qword_14031A508;
  v10 = 42;
  Length = qword_14031A508->Length;
  if ( qword_14031A508->Length < 0x2Au )
    v10 = Length;
  v12 = String2->Length;
  if ( v12 <= v10 )
    return (unsigned int)-1073741275;
  ...
  if ( Buffer[1] == 63 )
  {
    if ( !RtlPrefixUnicodeString(qword_14031A508, String2, 1u) && !RtlPrefixUnicodeString(v9 + 1, String2, 1u) )
      return (unsigned int)-1073741275;
  }
  else
  {
    if ( !RtlPrefixUnicodeString(&stru_14023BDF0, String2, 1u) && !RtlPrefixUnicodeString(&stru_14025CF50, String2, 1u) )
      return (unsigned int)-1073741275;
    Length = 42;
  }
  v17[0] = v12 - Length;
