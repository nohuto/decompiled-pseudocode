/*
 * XREFs of LocalGetRelativeAttributeForString @ 0x14068A048
 * Callers:
 ...
 *     IsLegalAttributeChar2 @ 0x1406898A8 (IsLegalAttributeChar2.c)
 */
        ...
        char a8)
{
  ...
  int v96; // [rsp+68h] [rbp-31h]
  unsigned int v97; // [rsp+6Ch] [rbp-2Dh]
