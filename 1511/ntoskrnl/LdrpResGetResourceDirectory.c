/*
 * XREFs of LdrpResGetResourceDirectory @ 0x140464F18
 * Callers:
 ...
 *     LdrpSectionTableFromVirtualAddress @ 0x1404E9C88 (LdrpSectionTableFromVirtualAddress.c)
 */
        ...
        PIMAGE_NT_HEADERS *a5)
{
  ...
  PIMAGE_NT_HEADERS *v29; // [rsp+198h] [rbp+20h]
  ...
  if ( result >= 0 )
  {
    ...
    if ( Magic == 267 )
    {
      ...
      ullAddend = *(_OWORD *)&NtHeader->OptionalHeader.DataDirectory[0].VirtualAddress;
    ...
    if ( !v15 )
      return -1073741687;
    if ( v5 < (unsigned __int64)MmHighestUserAddress && v5 + v15 >= (unsigned __int64)MmHighestUserAddress )
      return -1073741701;
    if ( v7 || v15 < HIDWORD(v22) )
    {
      if ( RtlULongLongAdd(v5, v15, (ULONGLONG *)&NtHeader) < 0 )
        return -1073741701;
      v16 = NtHeader;
      v17 = v28;
    }
    else
    {
      ...
      if ( !v18[4] )
        return -1073741687;
      v16 = (PIMAGE_NT_HEADERS)(v5 + v18[5] - (unsigned __int64)v18[3] + v15);
    }
    if ( !v16 )
      return -1073741687;
    if ( v9 )
    {
      if ( (unsigned __int64)v16 <= v5 )
        return -1073741701;
      v19 = (v5 & 0xFFFFFFFFFFFFFFFCuLL) + v17;
      if ( (unsigned __int64)&v16->FileHeader.NumberOfSymbols > v19 )
        return -1073741701;
      PointerToSymbolTable = v16->FileHeader.PointerToSymbolTable;
      PointerToSymbolTable_high = HIWORD(v16->FileHeader.PointerToSymbolTable);
      if ( !PointerToSymbolTable && !PointerToSymbolTable_high )
        return -1073741686;
      if ( (unsigned __int64)v16 + 8 * PointerToSymbolTable_high + 8 * PointerToSymbolTable > v19 )
        return -1073741701;
    }
    *v29 = v16;
    *a5 = v12;
