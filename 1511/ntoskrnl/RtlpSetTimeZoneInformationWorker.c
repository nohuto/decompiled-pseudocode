/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x140648FF8
 * Callers:
 *     ExpRefreshTimeZoneInformation @ 0x14053B5FC (ExpRefreshTimeZoneInformation.c)
 *     RtlSetDynamicTimeZoneInformation @ 0x140648FE0 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x140648FEC (RtlSetTimeZoneInformation.c)
 *     ExpSetTimeZoneInformation @ 0x14066BA58 (ExpSetTimeZoneInformation.c)
 * Callees:
 *     wcsnlen @ 0x140145CD8 (wcsnlen.c)
