/*
 * XREFs of KsepSkipDriverUnloadEventDriverUnload @ 0x1401CE708
 * Callers:
 *     KseSkipDriverUnloadCallbackHookDriverUnload @ 0x1401CE5E8 (KseSkipDriverUnloadCallbackHookDriverUnload.c)
 *     KseSkipDriverUnloadHookDriverUntargeted @ 0x1401CE60C (KseSkipDriverUnloadHookDriverUntargeted.c)
 * Callees:
