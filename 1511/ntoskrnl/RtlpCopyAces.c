/*
 * XREFs of RtlpCopyAces @ 0x140471900
 * Callers:
        ...
        __int64 a14)
{
  ...
  unsigned int *v51; // [rsp+C0h] [rbp-58h]
  __int64 v52; // [rsp+C8h] [rbp-50h]
  __int64 v53; // [rsp+D0h] [rbp-48h]
  __int64 v54; // [rsp+D8h] [rbp-40h]
  ...
  if ( *(_WORD *)(a14 + 4) )
  {
    ...
    while ( v22 < *(unsigned __int16 *)(a14 + 4) );
    v18 = 0;
  }
  if ( v19 <= a14 + (unsigned __int64)*(unsigned __int16 *)(a14 + 2) )
    v21 = (int *)v19;
...
LABEL_11:
        if ( !v26 )
        {
          ...
          if ( v21 && v27 <= a14 + *(unsigned __int16 *)(a14 + 2) - (_QWORD)v21 )
          {
            if ( !v18 )
            {
...
LABEL_49:
            ...
            if ( *(_BYTE *)v23 > 8u || *(_DWORD *)(v23 + 4) || !v40 )
            {
              ...
              if ( (unsigned int)v27 > 0xFFFF )
                return 3221225597LL;
              if ( *(unsigned __int16 *)(v23 + 2) > a14 + *(unsigned __int16 *)(a14 + 2) - (_QWORD)v37 )
              {
                v18 = 1;
                v41 = 1;
              }
