/*
 * XREFs of PopPepInitializeVetoMasks @ 0x1401EDA28
 * Callers:
 ...
 *     PopFxEnableEnhancedAccounting @ 0x1401ECF64 (PopFxEnableEnhancedAccounting.c)
...
void __fastcall PopPepInitializeVetoMasks(__int64 a1, unsigned int a2)
{
  ...
  if ( v6 )
  {
    ...
    *(_BYTE *)(v2 + 576) = 0;
    ...
    {
      v12 = PopFxEnableEnhancedAccounting((unsigned int *)&v36);
      v13 = 0;
      v34 = v12;
      v14 = v44;
      v15 = 1;
    ...
    *(_DWORD *)(v2 + 584) = v11;
    ...
    v21 = *(int *)(a1 + 156);
    if ( (_DWORD)v21 != 4 )
      PopPepUpdateIdleStateRefCount(0, *(_DWORD *)(a1 + 4 * v21 + 140), 1LL);
    if ( *(_DWORD *)(a1 + 168) )
    {
      do
      {
        ...
        *(_BYTE *)(v23 + 8) = 0;
        ...
        if ( v25 == PopFxProcessorPlugin )
        {
          ...
          if ( (*(unsigned __int8 (__fastcall **)(__int64, __int64 *))(v25 + 96))(27LL, &v40) )
          {
            ...
            v34 = PopFxEnableEnhancedAccounting((unsigned int *)&v36);
            v26 = v44;
            v27 = 0;
            v28 = 1;
            if ( a2 )
