        ...
        int a9)
{
  ...
  _DWORD *PoolWithTag; // [rsp+88h] [rbp-40h]
  _QWORD *P; // [rsp+90h] [rbp-38h]
  unsigned int *v33; // [rsp+98h] [rbp-30h]
...
LABEL_11:
    ...
    v28 = v20;
    v29 = a1[4];
    if ( !v29 || (v33 = (unsigned int *)*((_QWORD *)a1 + 3)) == 0LL )
    {
      v29 = a9;
      v33 = a8;
      if ( !a8 )
    ...
    if ( EmpEvaluateParseNodeMapping(v33, v29, a2, a3, a4, a5, a6, a7, P, v28, v12, v27, v21, v34) )
    {
      v22 = *a1 == 0;
      v23 = PoolWithTag;
      if ( !v22 )
      ...
      v15 = (*(__int64 (__fastcall **)(PVOID, _QWORD, _QWORD *, _QWORD, _DWORD *, unsigned int, _QWORD))(v14 + 16))(
              v30,
              v34,
              P,
              v28,
