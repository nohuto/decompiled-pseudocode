/*
 * XREFs of DrvDbGetDriverInfFileMappedPropertyKeys @ 0x14069B178
 * Callers:
        ...
        _DWORD *a6)
{
  ...
  *a6 = 0;
  if ( !a3 )
  {
    v12 = 0;
    v11 = 1;
    RegValueMappedPropertyKeys = DrvDbOpenObjectRegKey(a1, 0LL, 3u, a2, v11, v12, &Handle, 0LL);
