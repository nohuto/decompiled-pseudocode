/*
 * XREFs of SepSecureBootValidateBcdDataAgainstBcdRule @ 0x140654F9C
 * Callers:
 ...
 *     SepSecureBootGetQWordPolicyValue @ 0x140654DDC (SepSecureBootGetQWordPolicyValue.c)
 */
    ...
    switch ( *(_BYTE *)(a1 + 7) & 0xF )
    {
      ...
      case 5:
        if ( a3 != 8 )
          return (unsigned int)-1069350910;
        v7 = *a2;
        v8 = qword_1403351D8 + *(unsigned int *)(a1 + 8);
        v10 = *a2;
