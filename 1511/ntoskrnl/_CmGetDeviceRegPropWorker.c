/*
 * XREFs of _CmGetDeviceRegPropWorker @ 0x14043C61C
 * Callers:
 ...
 *     RtlStringCbCopyNExW @ 0x1400EC0D4 (RtlStringCbCopyNExW.c)
...
LABEL_16:
  ...
  v20 = *(__int64 (__fastcall **)(__int64, HANDLE, const wchar_t *, int *, NTSTRSAFE_PWSTR, unsigned int *, __int64))(v19 + 336);
  v21 = Handle;
  if ( v18 )
    v21 = v18;
  cbDest_4 = v13;
  ...
  if ( (int)(InstallerClassRegProp + 0x80000000) >= 0 && InstallerClassRegProp != -1073741789 )
    goto LABEL_46;
  if ( (v23 = v38, v38 == 1) && cbDest_4 < 2 || cbDest_4 < 2 && v38 == 7 || v38 == 4 && cbDest_4 != 4 )
  {
LABEL_40:
    inited = -1073741275;
    goto LABEL_30;
