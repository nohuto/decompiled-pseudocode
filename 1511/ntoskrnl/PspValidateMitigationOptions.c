/*
 * XREFs of PspValidateMitigationOptions @ 0x1404C1ED4
 * Callers:
...
__int64 __fastcall PspValidateMitigationOptions(__int64 a1, __int64 a2)
{
  ...
  if ( (a1 & 0xF888888888888888uLL) != 0
    ...
    || (a1 & 0x3000000000LL) == 0x3000000000LL
  ...
  result = 3221225485LL;
  if ( (a1 & 0x30000000000000LL) != 0x30000000000000LL && (a1 & 0x300000000000000LL) != 0x300000000000000LL )
    return 0LL;
  return result;
}
