/*
 * XREFs of NormBuffer__ReplaceLastStartBasePair @ 0x1401FB354
 * Callers:
 ...
 *     Normalization__GetThirdAndLastDecomposedCharPlane0 @ 0x14064B534 (Normalization__GetThirdAndLastDecomposedCharPlane0.c)
 */
