/*
 * XREFs of MiGetSystemAddressForImage @ 0x1403CC454
 * Callers:
 ...
 *     MiImageSuitableForSystem @ 0x1403CC5D4 (MiImageSuitableForSystem.c)
...
unsigned __int64 __fastcall MiGetSystemAddressForImage(__int64 a1, char a2, _DWORD *a3)
{
  ...
  int v54; // [rsp+B8h] [rbp-B0h]
  int v55; // [rsp+BCh] [rbp-ACh]
  __int64 v56; // [rsp+C0h] [rbp-A8h]
  ...
  *a3 = 1;
  ...
  if ( v7 )
  {
    ...
    {
      v11 = (__int64)v9[14];
      if ( v11 && v5 == MiSectionControlArea(v11) )
      {
        *v12 = 0;
        v8 = 1;
        break;
  ...
  if ( v27[0] )
    goto LABEL_18;
  v55 = MiMapImageInSystemSpace(v5, 3u, (__int64)BaseAddress);
  if ( v55 < 0 )
    return 0LL;
  v16 = BaseAddress[0];
...
LABEL_55:
  ...
  if ( v25 < 0 )
    return 0LL;
  if ( (int)MiRelocateImage(*(_QWORD *)v5, (__int64)&ImageBase_high, v53, v14, 1) < 0 )
    return 0LL;
  MiImageSuitableForSystem(v5, v27, v26);
  if ( !v27[0] && (*(_DWORD *)(v5 + 56) & 0x40000000) == 0 )
    return 0LL;
LABEL_18:
  v15 = MiSelectSystemImageAddress(v14);
  v7 = v15;
  if ( v15 )
  {
    v4 = 1;
    ...
    {
LABEL_56:
      MiReturnSystemImageAddress(v7, (unsigned int)(v6 << 12));
      return 0LL;
    }
LABEL_14:
    if ( (a2 & 1) == 0 || (int)MiSessionInsertImage(v7, v5) >= 0 )
      return v7;
    if ( v4 == 1 )
