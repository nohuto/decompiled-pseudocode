/*
 * XREFs of PpmResetPerfTimes @ 0x140125844
 * Callers:
 *     PpmResetPerfEngineForProcessor @ 0x140119D38 (PpmResetPerfEngineForProcessor.c)
 *     PpmCheckReset @ 0x140141394 (PpmCheckReset.c)
 * Callees:
 *     PpmSnapPerformanceAccumulation @ 0x1400466A0 (PpmSnapPerformanceAccumulation.c)
 *     PpmResetPerformanceAccumulation @ 0x1401258A8 (PpmResetPerformanceAccumulation.c)
 */
