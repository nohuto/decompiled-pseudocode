/*
 * XREFs of CmpInitGlobalQuotaAllowed @ 0x140770A9C
 * Callers:
...
LABEL_7:
  ...
  if ( CmSystemHiveLimitSize )
  {
    ...
    CmSystemHiveLimitSize <<= 20;
  }
  else
  {
    LODWORD(v3) = 393216;
    result = *(_QWORD *)(*(_QWORD *)qword_1402FEC28 + 5712LL) >> 1;
    if ( result < 0x60000 )
      v3 = *(_QWORD *)(*(_QWORD *)qword_1402FEC28 + 5712LL) >> 1;
    CmSystemHiveLimitSize = (_DWORD)v3 << 12;
  }
  return result;
}
