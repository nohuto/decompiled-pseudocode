/*
 * XREFs of EtwpTraceSystemShutdown @ 0x1406625C8
 * Callers:
...
char EtwpTraceSystemShutdown()
{
  ...
  {
    result = TlgKeywordOn(&stru_1402D1AD0, 0x200000000000uLL);
    if ( result )
    {
      v8 = 0;
      v11 = 0;
      ...
      v7 = 4;
      v10 = 8;
      result = TlgWrite(&stru_1402D1AD0, &unk_140254FDE, 0LL, 0LL, 4u, &pData);
    }
  }
