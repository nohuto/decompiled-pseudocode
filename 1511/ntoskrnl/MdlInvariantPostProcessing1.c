/*
 * XREFs of MdlInvariantPostProcessing1 @ 0x14020B4C4
 * Callers:
 ...
 *     RtlpComputeCrcInternal @ 0x1401044D8 (RtlpComputeCrcInternal.c)
 *     MdlInvariantFindMdlInfo @ 0x14020B344 (MdlInvariantFindMdlInfo.c)
      ...
      && (unsigned int)MmMdlPageContentsState(v5, 2u) == 1 )
    {
      ...
      if ( MdlInfo || *(_BYTE *)a3 != 4 )
      {
        v11 = (*(_BYTE *)(v10 + 10) & 5) != 0
            ? *(PVOID *)(v10 + 24)
            : MmMapLockedPagesSpecifyCache((PMDL)v10, 0, MmCached, 0LL, 0, 0x20u);
        if ( v11 )
        {
          if ( !MdlInfo
