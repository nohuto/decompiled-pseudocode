/*
 * XREFs of RtlpCreateHashTable @ 0x1400E5870
 * Callers:
 *     RtlCreateHashTable @ 0x1400E5860 (RtlCreateHashTable.c)
 *     RtlCreateHashTableEx @ 0x1401429E0 (RtlCreateHashTableEx.c)
 * Callees:
 *     RtlpInitializeSecondLevelDir @ 0x1400E59E8 (RtlpInitializeSecondLevelDir.c)
