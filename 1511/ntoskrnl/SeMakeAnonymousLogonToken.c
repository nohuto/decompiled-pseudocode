/*
 * XREFs of SeMakeAnonymousLogonToken @ 0x14075C6E4
 * Callers:
...
__int64 SeMakeAnonymousLogonToken()
{
  ...
  struct _SID_AND_ATTRIBUTES v23; // [rsp+108h] [rbp-20h] BYREF
  ...
  *(_DWORD *)&TimeFields.Minute = 0;
  ...
  v1 = *(unsigned __int8 *)(*(_QWORD *)&SeLowMandatorySid + 1LL);
  v23.Sid = SeWorldSid;
  *(_QWORD *)&TimeFields.Year = SeAnonymousLogonSid;
  v23.Attributes = 7;
  v25 = 96;
  v2 = ((4 * v1 + 11) & 0xFFFFFFFC) + 16 + ((4 * *((unsigned __int8 *)SeWorldSid + 1) + 11) & 0xFFFFFFFC);
