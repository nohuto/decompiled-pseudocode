/*
 * XREFs of AlpcpInitializeMessageLog @ 0x140547EA0
 * Callers:
...
LABEL_11:
    ...
    if ( a1 )
    {
      ...
      do
      {
        v13 = (__int64 *)&v8[64 * v12];
        v13[7] = (__int64)(v13 + 6);
        v13[6] = (__int64)(v13 + 6);
        v14 = (__int64 **)qword_1402E1E58;
        *v13 = (__int64)&AlpcpFreeMessageLogListHead;
        v13[1] = (__int64)v14;
        if ( *v14 != &AlpcpFreeMessageLogListHead )
          __fastfail(3u);
        ++v11;
        *v14 = v13;
        v12 = v11;
        qword_1402E1E58 = (__int64)v13;
      }
      while ( v11 < a1 );
    }
    if ( a2 )
    {
      v15 = (__int64 **)qword_1402E1E88;
      v16 = 0LL;
      do
      {
