/*
 * XREFs of AdtpWriteToEtwEx @ 0x14021D4CC
 * Callers:
...
__int64 __fastcall AdtpWriteToEtwEx(__int64 a1, _BYTE *a2)
{
  ...
  __int16 v14; // [rsp+44h] [rbp-BCh] BYREF
  ...
  *a2 = 0;
  ...
  if ( *(_QWORD *)(a1 + 56) )
  {
    ...
    v6 = AdtpPackageParameters(0LL, a1, v5, (__int64)v26, (__int64)v22, (__int64)&v23, v13, (__int64)v25);
    if ( v6 < 0 )
    {
      v4 = v13[0];
    }
    ...
    {
      v8 = *(_WORD *)(a1 + 20);
      if ( v8 && (int)AdtpGetCategoryAndSubCategoryId(v8, &v14, &v15) >= 0 )
      {
        v9 = (unsigned __int16)(v14 + 48) << 8;
        LOWORD(v9) = v15 + ((v14 + 48) << 8);
      }
      else
      {
        v9 = 65280LL;
      ...
      {
LABEL_15:
        v6 = EtwWriteKMSecurityEvent(&v16, v9, v13[0], (unsigned __int64)&v23 & -(__int64)(v13[0] != 0));
        if ( v6 == -1073741058 )
          *a2 = 1;
      }
    }
