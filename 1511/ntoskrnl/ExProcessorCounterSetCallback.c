/*
 * XREFs of ExProcessorCounterSetCallback @ 0x1404D07B8
 * Callers:
 *     <none>
 * Callees:
...
int __fastcall ExProcessorCounterSetCallback(int a1, __int64 *a2)
{
  ...
  _QWORD v47[24]; // [rsp+C8h] [rbp-40h] BYREF
  _QWORD v48[24]; // [rsp+188h] [rbp+80h] BYREF
  __int64 v49; // [rsp+248h] [rbp+140h] BYREF
  __int64 v50; // [rsp+250h] [rbp+148h]
  __int64 v51; // [rsp+258h] [rbp+150h]
  __int64 v52; // [rsp+260h] [rbp+158h]
  int v53; // [rsp+268h] [rbp+160h]
  __int64 v54; // [rsp+270h] [rbp+168h]
  __int64 v55; // [rsp+278h] [rbp+170h]
  int v56; // [rsp+280h] [rbp+178h]
  int v57; // [rsp+284h] [rbp+17Ch]
  int v58; // [rsp+288h] [rbp+180h]
  __int64 v59; // [rsp+290h] [rbp+188h]
  __int64 v60; // [rsp+298h] [rbp+190h]
  __int64 v61; // [rsp+2A0h] [rbp+198h]
  __int64 v62; // [rsp+2A8h] [rbp+1A0h]
  __int64 v63; // [rsp+2B0h] [rbp+1A8h]
  __int64 v64; // [rsp+2B8h] [rbp+1B0h]
  __int64 v65; // [rsp+2C0h] [rbp+1B8h]
  int v66; // [rsp+2CCh] [rbp+1C4h]
  int v67; // [rsp+2D0h] [rbp+1C8h]
  unsigned int v68; // [rsp+2D8h] [rbp+1D0h]
  unsigned int v69; // [rsp+2DCh] [rbp+1D4h]
  __int64 v70; // [rsp+2E0h] [rbp+1D8h]
  __int64 v71; // [rsp+2E8h] [rbp+1E0h]
  __int64 v72; // [rsp+2F0h] [rbp+1E8h]
  __int64 v73; // [rsp+2F8h] [rbp+1F0h]
  int v74; // [rsp+300h] [rbp+1F8h]
  int v75; // [rsp+304h] [rbp+1FCh]
  ...
  if ( v6 )
  {
    ...
    v5 = (v7 & 0x3F000000) != 0;
    v33 = v5;
    if ( swscanf_s(*(const wchar_t **)(a2[1] + 8), L"%u,%u", &v36, (char *)&v36 + 4) == 2 )
    {
      ...
      LOBYTE(v29) = v9;
      LOBYTE(v10) = v4;
      ExpQueryProcessorInformationCounters(KiProcessorBlock[v28], (_DWORD)v29, v10, v11, (__int64)&v49);
      v30 = (const UNICODE_STRING *)a2[1];
      v42.Data = &v49;
      v42.Size = 192;
      v31 = PcwAddInstance(v8, v30, v28, 1u, &v42);
      if ( v31 < 0 )
        return v31;
      return v2;
    }
...
LABEL_19:
    if ( v15 > 1 )
    {
      v47[0] /= (unsigned __int64)v15;
      v47[1] /= (unsigned __int64)v15;
      v47[2] /= (unsigned __int64)v15;
      v47[3] /= (unsigned __int64)v15;
      v47[6] /= (unsigned __int64)v15;
      v47[5] /= (unsigned __int64)v15;
      v47[9] /= (unsigned __int64)v15;
      v47[10] /= (unsigned __int64)v15;
      v47[11] /= (unsigned __int64)v15;
      v47[15] /= (unsigned __int64)v15;
      HIDWORD(v47[16]) /= v15;
      LODWORD(v47[17]) /= v15;
    }
    if ( v5 )
    {
      LODWORD(v47[18]) = v16 / v15;
      HIDWORD(v47[18]) = v14 / v15;
      v47[19] /= (unsigned __int64)v15;
      v47[20] /= (unsigned __int64)v15;
    }
    if ( v4 )
      LODWORD(v47[23]) /= v15;
    ...
    v41.Data = v47;
    v41.Size = 192;
    return PcwAddInstance(v8, &DestinationString, KeMaximumProcessors + (unsigned __int16)KeNumberNodes, 1u, &v41);
  }
  while ( 1 )
  {
...
LABEL_10:
    ...
    if ( (_BYTE)v34 )
      LODWORD(v48[23]) /= v18;
    RtlStringCbPrintfW(pszDest, 0x1AuLL, L"%u,_Total", (unsigned int)v36);
    RtlInitUnicodeString(&DestinationString, pszDest);
    v8 = Buffer;
    v46.Data = v48;
    v46.Size = 192;
    result = PcwAddInstance(Buffer, &DestinationString, v36 + KeMaximumProcessors, 1u, &v46);
    if ( result < 0 )
      return result;
    goto LABEL_17;
  }
  while ( 1 )
  {
    ...
    Affinity.Mask = v26;
    ExpQueryProcessorInformationCounters(v24, v25, v23, v22, (__int64)&v49);
    LODWORD(Data) = HIDWORD(v36);
    RtlStringCbPrintfW(pszDest, 0x1AuLL, L"%u,%u", (unsigned int)v36, Data);
    RtlInitUnicodeString(&DestinationString, pszDest);
    v45.Size = 192;
    v45.Data = &v49;
    result = PcwAddInstance(v8, &DestinationString, FirstSetRightGroupAffinity, 1u, &v45);
    if ( result < 0 )
      return result;
    v48[13] += v63;
    v47[0] += v49;
    ...
    v47[10] += v60;
    v47[22] += v73;
    v14 = (unsigned __int64)v42.Data + v69;
    v47[19] += v70;
    v47[13] += v63;
    v47[11] += v61;
    v47[14] += v64;
    ...
    v8 = Buffer;
    Mask = Affinity.Mask;
    v42.Data = (const void *)v14;
    if ( ++HIDWORD(v36) >= (unsigned int)Count[0] )
    {
      v19 = v40;
      v20 = v39;
      goto LABEL_10;
