/*
 * XREFs of EtwpLogTxREvent @ 0x1406619CC
 * Callers:
 *     EtwpTraceRegistryTransaction @ 0x14066250C (EtwpTraceRegistryTransaction.c)
 * Callees:
        ...
        __int64 a7)
{
  ...
  v18[v12 - 1] = &EtwpNull;
  v18[v12] = 2LL;
  EtwpLogKernelEvent((__int64)&v17, a1, v9 + 1, a2 | 0x900, 0x501902u);
}
