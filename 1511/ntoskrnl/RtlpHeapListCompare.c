/*
 * XREFs of RtlpHeapListCompare @ 0x1400D4B20
 * Callers:
 *     RtlpHeapAddListEntry @ 0x1400D3CC4 (RtlpHeapAddListEntry.c)
 *     RtlpHeapRemoveListEntry @ 0x1400D47F0 (RtlpHeapRemoveListEntry.c)
 *     RtlpHeapFindListLookupEntry @ 0x1400D494C (RtlpHeapFindListLookupEntry.c)
 * Callees:
