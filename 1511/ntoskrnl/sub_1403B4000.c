/*
 * XREFs of sub_1403B4000 @ 0x1403B4000
 * Callers:
 *     <none>
 * Callees:
...
BOOLEAN __fastcall sub_1403B4000(PKDPC Dpc)
{
  _QWORD *v1; // r9
  ...
  if ( v13 != Dpc[2].DeferredRoutine )
  {
    ...
    v23 = 0x8B4E8A3A03F5E2FEuLL;
    CcAdjustBcbDepth(
      (unsigned int)__ROR4__(530, 225),
