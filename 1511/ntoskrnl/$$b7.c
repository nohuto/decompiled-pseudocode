...
__int64 __fastcall __b7(__int64 a1, unsigned __int64 a2, __int64 a3)
{
  unsigned int v4; // edi
  ...
  v4 = 0;
  v7 = 0;
  (*(void (__fastcall **)(struct _KTHREAD *))(a1 + 352))(KeGetCurrentThread());
  LOBYTE(v8) = 1;
  (*(void (__fastcall **)(_QWORD, __int64))(a1 + 224))(*(_QWORD *)(a1 + 1096), v8);
  ...
  (*(void (__fastcall **)(_QWORD, PVOID *))(a1 + 272))(*(_QWORD *)(a1 + 1096), v10);
  (*(void (**)(void))(a1 + 360))();
  return v7;
}
