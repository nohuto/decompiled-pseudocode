/*
 * XREFs of ExpAeThresholdInitWorker @ 0x1401372C0
 * Callers:
 *     <none>
 * Callees:
 *     KeYieldProcessorEx @ 0x14007CAC0 (KeYieldProcessorEx.c)
 *     ExpAeMeasureContention @ 0x140137374 (ExpAeMeasureContention.c)
 */
  ...
  if ( (v8 & 0x7FFFFFFF) != 0 )
  {
    *(_DWORD *)((unsigned __int64)v13 & 0xFFFFFFFFFFFFFFC0uLL) = 0;
    while ( (*(_DWORD *)a4 & 0x80000000) != v9 )
      KeYieldProcessorEx((_DWORD *)((unsigned __int64)v13 & 0xFFFFFFFFFFFFFFC0uLL), a2, (__int64)a3);
  }
  else
  {
