/*
 * XREFs of ?StDmComputeSpaceUsageForPriority@?$ST_STORE@USM_TRAITS@@@@SAXPEAU_ST_DATA_MGR@1@KPEAK11@Z @ 0x14010E474
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  if ( v12 < v10 || v7 * (*(_DWORD *)(a1 + 168) - v11 + 1) < v8 )
    goto LABEL_4;
  v14 = *(_DWORD *)(a1 + 16LL * a2 + 648);
  if ( v14 != -1 )
    v12 = v11 + (*(_WORD *)(*(_QWORD *)(a1 + 472) + 2LL * v14) & 0x1FFF) - v10 + v12 - 1;
  if ( v12 < v10 )
LABEL_4:
    v12 = 0;
  *a3 += v7;
