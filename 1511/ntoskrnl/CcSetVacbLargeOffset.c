/*
 * XREFs of CcSetVacbLargeOffset @ 0x1400E0C5C
 * Callers:
...
char __fastcall CcSetVacbLargeOffset(__int64 a1, __int64 a2, unsigned __int64 a3, _QWORD *a4)
{
  ...
  do
  {
    ...
    LODWORD(v12) = v11 + v12;
    v48[v15] = v16;
    *(_QWORD *)&v48[2 * v15 + 8] = v4;
    v47 = (unsigned int)v16;
    VacbLevel = *(_QWORD *)(v4 + 8LL * (unsigned int)v16);
    if ( !VacbLevel )
    {
      ...
      if ( !v6 )
      {
        ...
        LOBYTE(v16) = v29 != 0;
        v44[0] = v44;
        if ( !(unsigned __int8)CcAllocateVacbLevels((unsigned int)(v13 + 1), v16, v44) )
          return 0;
        v6 = v44;
        v42 = v44;
      }
