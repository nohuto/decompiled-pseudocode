/*
 * XREFs of AdtpPackageParameters @ 0x14013B28C
 * Callers:
 *     AdtpWriteToEtwEx @ 0x14021D4CC (AdtpWriteToEtwEx.c)
 *     AdtpWriteToEtw @ 0x14053A414 (AdtpWriteToEtw.c)
 * Callees:
 *     AdtpIsCorrectlyFormedUnicodeString @ 0x14013B7D0 (AdtpIsCorrectlyFormedUnicodeString.c)
 ...
 *     AdtpEtwBuildDashString @ 0x1404C6638 (AdtpEtwBuildDashString.c)
...
LABEL_49:
          ...
          switch ( v20 )
          {
            case 8:
              ...
              if ( *(_DWORD *)(v19 + v14 + 4) < v64 || v63 > 0x41 )
                goto LABEL_89;
            ...
            case 6:
              v48 = 2LL * v10;
              v10 += v18;
              v49 = 4 * (unsigned __int8)byte_1406FBE69 + 8;
