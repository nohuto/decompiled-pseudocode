/*
 * XREFs of HvlpSetLogicalProcessorProperty @ 0x1401AFC8C
 * Callers:
 *     HvlConfigurePcc @ 0x1401B2410 (HvlConfigurePcc.c)
 *     HvlConfigurePerfStateCap @ 0x1401B245C (HvlConfigurePerfStateCap.c)
 *     HvlConfigurePerfStates @ 0x1401B248C (HvlConfigurePerfStates.c)
 *     HvlConfigureThrottleStates @ 0x1401B2520 (HvlConfigureThrottleStates.c)
 * Callees:
