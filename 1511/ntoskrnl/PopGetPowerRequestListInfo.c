/*
 * XREFs of PopGetPowerRequestListInfo @ 0x140633C50
 * Callers:
...
__int64 __fastcall PopGetPowerRequestListInfo(_QWORD *a1, _DWORD *a2)
{
  ...
  while ( v4 != &PopPowerRequestObjectList )
  {
    ...
    v5 = (v20 + 31 + v5) & 0xFFFFFFFFFFFFFFF8uLL;
    if ( v5 > 0xFFFFFFFF )
    {
      v9 = -1073741789;
      goto LABEL_19;
    ...
    *v8 = PopPowerRequestObjectCount;
    ...
    while ( 1 )
    {
      ...
      *(_DWORD *)((char *)v8 + v13) = *(_DWORD *)(v12 + 20);
      ...
      v17 = *(_QWORD *)(v12 + 80);
      v20 = v14 - 24;
      v9 = PoStoreDiagnosticContext(v17, (_QWORD *)((char *)v8 + v13 + 24), &v20);
      if ( v9 < 0 )
        goto LABEL_17;
      v18 = (v20 + 31) & 0xFFFFFFFFFFFFFFF8uLL;
      if ( v14 < v18 )
        break;
      *v10 = v13;
      v14 -= v18;
