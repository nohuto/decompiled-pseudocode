/*
 * XREFs of SeSecurityDescriptorChangedAuditAlarm @ 0x140495460
 * Callers:
        ...
        __int64 a13)
{
  ...
  v18 = SepAdtAuditThisEventWithContext(141LL, 1u, 0, (__int64)&SubjectContext);
  if ( v18 && a11 )
    v14 = a8 & 0x20;
  if ( (a7 & 0x1000000) != 0 )
  {
    if ( (unsigned __int8)SepAdtAuditThisEventWithContext(139LL, 1u, 0, (__int64)&SubjectContext) )
      v14 |= a8 & 8;
    if ( v18 && a12 )
      v14 |= a8 & 0x40;
  }
