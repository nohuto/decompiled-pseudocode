/*
 * XREFs of NtQueueApcThreadEx @ 0x1404B1628
 * Callers:
 *     NtQueueApcThread @ 0x1404B1600 (NtQueueApcThread.c)
 * Callees:
  ...
  if ( result >= 0 )
  {
    ...
    else if ( ReserveHandle )
    {
      ...
      if ( v15 >= 0 )
      {
        ...
        {
          v13 = PspUserApcReserveKernelRoutine;
          v11 = Object;
...
LABEL_7:
    ...
    else
    {
      ...
      if ( PoolWithQuotaTag )
      {
        v13 = (__int64 (__fastcall *)())PspQueueApcSpecialApc;
        v14 = ExFreePool;
        goto LABEL_7;
      }
      v15 = -1073741801;
