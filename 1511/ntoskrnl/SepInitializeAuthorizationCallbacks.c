/*
 * XREFs of SepInitializeAuthorizationCallbacks @ 0x14075BABC
 * Callers:
...
__int64 __fastcall SepInitializeAuthorizationCallbacks(__int64 a1, __int64 a2)
{
  ...
  v6 = 1;
  v5 = 6;
  if ( (int)ExRegisterHost((__int64 **)&SepAuthExtensionHost, a2, (unsigned __int16 *)&v4) < 0 )
  ...
  v4 = 65539;
  v6 = 512;
  result = ExRegisterHost((__int64 **)&SepBCryptExtensionHost, v2, (unsigned __int16 *)&v4);
  if ( (int)result < 0 )
