/*
 * XREFs of MiDeleteTebRange @ 0x1404A9390
 * Callers:
...
void __fastcall MiDeleteTebRange(__int64 a1, unsigned __int64 a2, unsigned __int64 a3, __int16 a4)
{
  ...
  v14 = (a2 >> 12) - (*(unsigned int *)(a1 + 24) | ((unsigned __int64)v9[32] << 32));
  v15 = v12;
  ...
  *(_DWORD *)(v13 + 44) -= a3 >> 12;
  ...
  {
    v21 = v13 + 16;
    v22 = (__int64 *)(16LL * *(unsigned __int16 *)(v13 + 40) - 0xA7FEF7FBD88LL);
    v23 = *v22;
    *(_QWORD *)(v13 + 16) = *v22;
    *(_QWORD *)(v13 + 24) = v22;
  ...
  else if ( v15 == 1 )
  {
    ...
    v26 = *(_QWORD *)(v13 + 16);
    v27 = *(_QWORD **)(v13 + 24);
    if ( *(_QWORD *)(v26 + 8) != v13 + 16 || (_QWORD *)*v27 != v25 )
      __fastfail(3u);
    *v27 = v26;
    *(_QWORD *)(v26 + 8) = v27;
    *v25 = 0LL;
