/*
 * XREFs of ViGenericVerifyIrpStackDownward @ 0x1406B7AFC
 * Callers:
 *     <none>
 * Callees:
 ...
 *     VfMajorIsValidIrpStatus @ 0x1406C24CC (VfMajorIsValidIrpStatus.c)
        ...
        const void *a7)
{
  ...
  BOOL v19; // [rsp+30h] [rbp-C8h]
  unsigned int v20; // [rsp+34h] [rbp-C4h]
  ...
  v11 = *(_QWORD *)(a1 + 240);
  v21 = v10 != *(_DWORD *)(a5 + 96);
  v19 = *(_QWORD *)(*(_QWORD *)a1 + 56LL) != *(_QWORD *)(a5 + 104);
