/*
 * XREFs of AlpcpCancelMessagesByRequestor @ 0x14047F6F8
 * Callers:
...
LABEL_33:
          ...
          *(_DWORD *)(v14 + 224) = 2621440;
          if ( v20 )
          {
            ...
            {
              KeReleaseSemaphoreEx(*(_QWORD *)(v14 + 32) + 1592LL, 1, 1LL, v17, 2);
              *(_QWORD *)(v14 + 32) = 0LL;
              *(_WORD *)(v14 - 30) -= 3;
              goto LABEL_38;
            }
...
LABEL_38:
            ...
            *(_WORD *)(v14 + 228) &= ~0x2000u;
            ...
            if ( v22 )
            {
              PsReleaseProcessWakeCounter(v22, *(unsigned int *)(v14 + 248));
              *(_QWORD *)(v14 + 200) = 0LL;
            }
            if ( v18 )
              v14 = *a3;
