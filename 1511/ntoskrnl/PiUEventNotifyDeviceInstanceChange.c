/*
 * XREFs of PiUEventNotifyDeviceInstanceChange @ 0x1404BECFC
 * Callers:
    ...
    *((_QWORD *)&v12 + 1) = &unk_1402FA8D0;
    do
    {
      ...
      while ( v9 != v8 )
      {
        v11 = v9;
        v9 = (_QWORD *)*v9;
        if ( v7 || !wcsicmp(v5, *(const wchar_t **)(v11[3] + 16LL)) )
        {
          if ( (unsigned __int8)PiUEventApplyAdditionalFilters(a1, v11) )
            v2 = PiUEventNotifyClient(a1, v11);
        }
      }
      ++v7;
