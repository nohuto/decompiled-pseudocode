/*
 * XREFs of PpmInstallNewIdleStates @ 0x140139824
 * Callers:
 *     PpmIdleInstallDefaultStates @ 0x140139814 (PpmIdleInstallDefaultStates.c)
 * Callees:
 ...
 *     PpmDeepestHardwareIdleState @ 0x140139D54 (PpmDeepestHardwareIdleState.c)
...
__int64 __fastcall PpmInstallNewIdleStates(__int64 a1, __int64 a2, int a3)
{
  ...
  _QWORD *v42; // [rsp+50h] [rbp-108h]
  _QWORD v43[22]; // [rsp+60h] [rbp-F8h] BYREF
...
LABEL_4:
  ...
  if ( (_DWORD)v6 )
  {
    ...
    v39 = (v11 + 7 + 24 * v7) & 0xFFFFFFF8;
    v12 = (((v39 + 992 * v6 + 47) & 0xFFFFFFF8) + 4 * v6 + 15) & 0xFFFFFFF8;
    if ( PpmIdleVetoList )
    ...
    if ( PoolWithTag )
    {
      ...
      *((_QWORD *)v14 + 7) = 1310740LL;
      ...
      v17 = (char *)v14 + ((((v39 + 992 * (_DWORD)v6 + 47) & 0xFFFFFFF8) + 4 * (_DWORD)v6 + 15) & 0xFFFFFFF8);
      ...
      v23 = (char *)v42 + v39;
      v42[91] = (char *)v42 + ((v39 + 992 * (_DWORD)v6 + 47) & 0xFFFFFFF8);
      *(_DWORD *)v23 = v6;
      if ( Sizea )
      {
        v32 = v23 + 192;
      ...
      *(_QWORD *)(v41 + 8) = v23;
      ...
      v43[0] = 1310721LL;
      memset(&v43[1], 0, 0xA0uLL);
      KeAddProcessorAffinityEx(v43, *(_DWORD *)(v27 + 36));
      PpmDeepestHardwareIdleState(v42);
      off_1402D2718();
      if ( *((_DWORD *)v42 + 8) != 1 && *(_BYTE *)v42 == 1 )
