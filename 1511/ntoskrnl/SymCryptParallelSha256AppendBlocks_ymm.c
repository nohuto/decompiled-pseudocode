/*
 * XREFs of SymCryptParallelSha256AppendBlocks_ymm @ 0x14021C240
 * Callers:
...
__int64 __fastcall SymCryptParallelSha256AppendBlocks_ymm(__int64 *a1, __int64 *a2, unsigned __int64 a3, __int64 _R9)
{
  ...
  __int64 v150; // r14
  __int64 result; // rax
  __int64 v356; // [rsp+28h] [rbp+0h] BYREF
  ...
  if ( a3 >= 0x40 )
  {
    ...
    do
    {
      ...
      _RAX = _R9 + 672;
      v102 = (unsigned int)(unsigned __int8)v49 + 24;
      do
      {
        __asm
        {
      ...
      __asm
      {
        vmovdqu ymm14, ymmword ptr [r9+160h]
        vmovdqu ymm15, ymmword ptr [r9+140h]
        vmovdqu ymm13, ymmword ptr [r9+120h]
        vmovdqu ymm9, ymmword ptr [r9+100h]
      }
      _R11 = (char *)&unk_140250008;
      v150 = 16LL;
      _R8 = _R9 + 224;
      do
      {
        ...
        _R8 += 128LL;
        __asm { vbroadcastss ymm7, dword ptr [r11] }
        _R11 += 16;
        __asm
        {
          vpslld  ymm4, ymm9, 7
          ...
          vpand   ymm2, ymm13, ymmword ptr [rbp+0]
          vpaddd  ymm0, ymm3, ymm6
          vpaddd  ymm7, ymm0, ymm7
          vpor    ymm0, ymm13, ymmword ptr [rbp+0]
          vpand   ymm1, ymm0, ymm14
          vpor    ymm6, ymm1, ymm2
          vpaddd  ymm8, ymm7, ymm15
          ...
          vpxor   ymm1, ymm0, ymm5
          vpaddd  ymm2, ymm1, ymm7
          vbroadcastss ymm7, dword ptr [r11-0Ch]
      ...
      __asm
      {
        vpaddd  ymm1, ymm14, ymmword ptr [r9+60h]
        vmovdqu ymmword ptr [r9+160h], ymm1
        vpaddd  ymm2, ymm15, ymmword ptr [r9+40h]
        vmovdqu ymmword ptr [r9+60h], ymm1
        vmovdqu ymmword ptr [r9+140h], ymm2
        vpaddd  ymm1, ymm13, ymmword ptr [r9+20h]
        vmovdqu ymm13, cs:__ymm@0c0d0e0f08090a0b04050607000102030c0d0e0f08090a0b0405060700010203
