/*
 * XREFs of PopMarkHiberPhase @ 0x14039F3F4
 * Callers:
...
void __fastcall PopMarkHiberPhase(char *Address)
{
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_1402DE330, Length, 0);
  ...
  PoSetHiberRange(0LL, 0x10000u, qword_1402DE2F8, (unsigned int)dword_1402DE300, 0);
