/*
 * XREFs of KsepDsEventPoolAllocate @ 0x1401CE260
 * Callers:
 *     KseDsHookExAllocatePool @ 0x1401CD724 (KseDsHookExAllocatePool.c)
 *     KseDsHookExAllocatePoolWithTag @ 0x1401CD770 (KseDsHookExAllocatePoolWithTag.c)
 * Callees:
