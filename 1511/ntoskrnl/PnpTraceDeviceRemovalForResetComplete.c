/*
 * XREFs of PnpTraceDeviceRemovalForResetComplete @ 0x14061441C
 * Callers:
...
char __fastcall PnpTraceDeviceRemovalForResetComplete(__int64 a1, UCHAR a2)
{
  ...
  LARGE_INTEGER v12; // [rsp+40h] [rbp-C0h] BYREF
  ...
  LARGE_INTEGER *v28; // [rsp+E0h] [rbp-20h]
  ...
  LOBYTE(v2) = TraceLoggingProviderEnabled(&stru_1402CFD80, a2, 0x400000000000uLL);
  if ( (_BYTE)v2 )
  {
    v2 = *(_QWORD *)(v3 + 184);
    if ( v2 )
    ...
    {
      LOBYTE(v2) = TlgKeywordOn(&stru_1402CFD80, 0x400000000000uLL);
      if ( (_BYTE)v2 )
      {
        v11 = *(_DWORD *)(v4 + 300);
        v10 = *(_DWORD *)(v5 + 164);
        ...
        v33 = 2LL;
        v35[1] = v6;
        LOBYTE(v2) = TlgWrite(&stru_1402CFD80, &unk_140253CD9, 0LL, 0LL, 0xDu, &pData);
      }
    }
  }
  return v2;
