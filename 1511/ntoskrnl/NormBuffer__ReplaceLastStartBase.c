/*
 * XREFs of NormBuffer__ReplaceLastStartBase @ 0x1401FB2E4
 * Callers:
 ...
 *     Normalization__GetSecondAndThirdDecomposedCharPlane0 @ 0x14064B400 (Normalization__GetSecondAndThirdDecomposedCharPlane0.c)
 */
