/*
 * XREFs of ExpSnapShotHandleTables @ 0x14066CAC8
 * Callers:
 *     ObGetHandleInformation @ 0x14062DF24 (ObGetHandleInformation.c)
        ...
        char a5)
{
  ...
  *a2 = 0;
  ...
  v10 = KeAbPreAcquire((ULONG_PTR)&HandleTableListLock, 0LL, 0LL);
  ...
  KiLeaveCriticalRegionUnsafe(v18);
  return v9;
}
