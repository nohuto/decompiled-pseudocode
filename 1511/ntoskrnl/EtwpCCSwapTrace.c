/*
 * XREFs of EtwpCCSwapTrace @ 0x14011EBF0
 * Callers:
  ...
  if ( v10 )
  {
    ...
    if ( v13 )
    {
      ...
      if ( v11 > 1 || v17 > 7 || v12 >= 0x20000 )
      {
        ...
        if ( v21 == 5 )
          v22 = 16 * *(unsigned __int8 *)(a1 + 643);
        else
          v22 = 16 * *(unsigned __int8 *)(a1 + 388) - 385;
        v20 = 8;
        v28 ^= ((unsigned __int16)v28 ^ v22) & 0x3F0;
      }
      else
      {
        v18 = *(_BYTE *)(a1 + 388);
        ...
        if ( v18 == 5 )
          v19 = *(unsigned __int8 *)(a1 + 643) << 9;
        else
          v19 = (*(unsigned __int8 *)(a1 + 388) << 9) - 12289;
        v20 = 4;
        Src ^= ((unsigned __int16)Src ^ v19) & 0x7E00;
      }
    }
    else if ( v12 >= 0x4000 )
    {
