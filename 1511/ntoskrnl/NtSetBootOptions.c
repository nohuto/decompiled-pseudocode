/*
 * XREFs of NtSetBootOptions @ 0x14067254C
 * Callers:
 *     <none>
 * Callees:
...
NTSTATUS __stdcall NtSetBootOptions(PBOOT_OPTIONS BootOptions, ULONG FieldsToChange)
{
  ...
  if ( PreviousMode )
  {
    ...
    if ( (unsigned __int64)v8 > MmUserProbeAddress || v8 < (char *)BootOptions )
  ...
  if ( v11 >= 0 && (v2 & 2) != 0 )
    v11 = IoSetEnvironmentVariableEx((__int64)L"BootNext", (__int64)&EfiBootVariablesGuid, (__int64)v14, 2, 1);
