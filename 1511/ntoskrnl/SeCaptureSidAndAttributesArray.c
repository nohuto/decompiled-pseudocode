/*
 * XREFs of SeCaptureSidAndAttributesArray @ 0x140478E80
 * Callers:
        ...
        unsigned int *a9)
{
  ...
  if ( a3 )
  {
    ...
    if ( v15 )
    {
      ...
      v18 = &Src[v15];
      if ( (unsigned __int64)v18 > MmUserProbeAddress || v18 < Src )
    ...
    while ( v19 < a2 )
    {
      ...
      if ( v21 + 1 >= MmUserProbeAddress )
        v22 = (unsigned __int8 *)MmUserProbeAddress;
      v23 = *v22;
      if ( v23 > 0xF )
      {
        v14 = -1073741704;
      ...
      *((_DWORD *)v24 + 2) = v25;
      if ( v25 )
      {
        ...
        if ( (*(_QWORD *)v24 & 3) != 0 )
          ExRaiseDatatypeMisalignment();
        v27 = v26 + v25;
        if ( v27 > MmUserProbeAddress || v27 < v26 )
          *(_BYTE *)MmUserProbeAddress = 0;
      }
