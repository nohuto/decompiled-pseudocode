/*
 * XREFs of PopThermalWorker @ 0x14054C618
 * Callers:
 *     <none>
 * Callees:
 ...
 *     PopFireThermalWmiEvent @ 0x1401EE560 (PopFireThermalWmiEvent.c)
...
LABEL_64:
  ...
  if ( *(_BYTE *)(a1 + 64) == 1 )
  {
    *(_QWORD *)(a1 + 328) = MEMORY[0xFFFFF78000000014];
    ...
    {
      *(_BYTE *)(a1 + 65) = v16 | 2;
      PopDiagTraceThermalZoneEnumeration((char *)(a1 + 240), (unsigned __int16 *)(a1 + 824), BugCheckParameter4);
    }
    ...
    if ( (_DWORD)v34 )
    {
      ...
      if ( v35 <= v3 )
        *(_DWORD *)(a1 + 240) = 0;
        ...
        KeSetTimer((PKTIMER)(a1 + 112), (LARGE_INTEGER)(v3 - v35), (PKDPC)(a1 + 176));
    }
  }
LABEL_21:
  v12 = 88;
