/*
 * XREFs of CmpRegisterCallbackInternal @ 0x140548A24
 * Callers:
 *     CmRegisterCallback @ 0x140548A04 (CmRegisterCallback.c)
 *     CmRegisterCallbackEx @ 0x1405DD104 (CmRegisterCallbackEx.c)
 * Callees:
