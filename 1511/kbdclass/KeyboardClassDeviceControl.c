 ...
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qqLd @ 0x1C0001DB0 (WPP_RECORDER_SF_qqLd.c)
 *     WPP_RECORDER_SF_qqL @ 0x1C0001E70 (WPP_RECORDER_SF_qqL.c)
 *     KeyboardCallAllPorts @ 0x1C0004520 (KeyboardCallAllPorts.c)
 *     WPP_RECORDER_SF_ @ 0x1C0005388 (WPP_RECORDER_SF_.c)
 *     WPP_RECORDER_SF_qqd @ 0x1C0005D3C (WPP_RECORDER_SF_qqd.c)
 *     WPP_RECORDER_SF_qqdL @ 0x1C0005E84 (WPP_RECORDER_SF_qqdL.c)
 *     WPP_RECORDER_SF_qqdd @ 0x1C0005F9C (WPP_RECORDER_SF_qqdd.c)
 */
...
__int64 __fastcall KeyboardClassDeviceControl(__int64 a1, __int64 a2)
{
  ...
  v8 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)(v5 + 32), (PVOID)v2, &byte_1C000D540, 1u, 0x20u);
  v9 = v8;
  if ( v8 < 0 )
  {
    *(_DWORD *)(v2 + 48) = v8;
...
LABEL_16:
        ...
        *(_BYTE *)(*(_QWORD *)(v2 + 184) - 72LL) = 15;
        if ( v4 )
        {
          if ( IoAcquireRemoveLockEx(v7, (PVOID)v2, &byte_1C000D540, 1u, 0x20u) < 0 )
