 ...
 *     WppInitKm @ 0x1C000CD00 (WppInitKm.c)
 *     WppLoadTracingSupport @ 0x1C000CDA0 (WppLoadTracingSupport.c)
        ...
        if ( v19 >= 0 )
        {
          ...
          *(_QWORD *)v20 = v30;
          ...
          if ( IoGetDeviceObjectPointer(&Destination, 0x80u, &FileObject, (PDEVICE_OBJECT *)v20 + 2) >= 0 )
          {
            ...
            if ( v23 >= 0 )
            {
              v25 = (__int64 **)qword_1C00094B0;
              v26 = (__int64 *)(v20 + 336);
              *v26 = (__int64)&qword_1C00094A8;
              v26[1] = (__int64)v25;
              if ( *v25 != &qword_1C00094A8 )
                __fastfail(3u);
              *v25 = v26;
