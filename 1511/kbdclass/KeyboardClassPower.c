/*
 * XREFs of KeyboardClassPower @ 0x1C0001550
 * Callers:
 *     <none>
 * Callees:
 *     WPP_RECORDER_SF_qqsd @ 0x1C0001470 (WPP_RECORDER_SF_qqsd.c)
 *     WPP_RECORDER_SF_qq @ 0x1C00018D0 (WPP_RECORDER_SF_qq.c)
 *     KeyboardClassCheckWaitWakeEnabled @ 0x1C00046FC (KeyboardClassCheckWaitWakeEnabled.c)
 *     KeyboardClassCreateWaitWakeIrp @ 0x1C000CFF0 (KeyboardClassCreateWaitWakeIrp.c)
 */
