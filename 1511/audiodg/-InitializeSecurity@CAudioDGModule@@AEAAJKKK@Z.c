/*
 * XREFs of ?InitializeSecurity@CAudioDGModule@@AEAAJKKK@Z @ 0x14000854C
 * Callers:
...
LABEL_37:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 33LL, &WPP_bda7893d5b5a9c157c1c64dd23f2c3f0_Traceguids, 12320LL);
  }
  ...
  if ( v7 < 0 )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      v14 = 34LL;
LABEL_47:
      WPP_SF_D(v13[2], v14, &WPP_bda7893d5b5a9c157c1c64dd23f2c3f0_Traceguids, (unsigned int)v7);
    }
  }
  else
  {
