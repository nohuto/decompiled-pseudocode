/*
 * XREFs of ?GetClientReleaseEvent@CSystemAudioDeviceSharedBase@@UEAAJIPEA_K@Z @ 0x14002BF70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned __int64 *a3)
{
  ...
  v6 = (*(__int64 (__fastcall **)(_QWORD, _QWORD, unsigned __int64 *))(**((_QWORD **)this + 38) + 32LL))(
         *((_QWORD *)this + 38),
         a2,
         a3);
  if ( v6 < 0
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, (__int64)&WPP_c59105ced4022a196d4cc1b91b2ab5a7_Traceguids, v6);
  }
  if ( v9 )
