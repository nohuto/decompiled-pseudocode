/*
 * XREFs of _recalloc @ 0x140018FD0
 * Callers:
 ...
 *     ?Add@?$CSimpleMap@KPEAVCVpoContext@@V?$CSimpleMapEqualHelper@KPEAVCVpoContext@@@ATL@@@ATL@@QEAAHAEBKAEBQEAVCVpoContext@@@Z @ 0x140001584 (-Add@-$CSimpleMap@KPEAVCVpoContext@@V-$CSimpleMapEqualHelper@KPEAVCVpoContext@@@ATL@@@ATL@@QEAAH.c)
 ...
 * Callees:
 *     _errno_0 @ 0x140019626 (_errno_0.c)
 *     _invalid_parameter @ 0x140019634 (_invalid_parameter.c)
 */
