/*
 * XREFs of ?GetVolumeChannelCount@CSystemAudioDeviceOffload@@UEAAJPEAI@Z @ 0x14002DDF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CSystemAudioDeviceOffload::GetVolumeChannelCount(CSystemAudioDeviceOffload *this, unsigned int *a2)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x11u, (__int64)&WPP_0c9f4c97d2e4db079a99cda1b29d38b3_Traceguids, v2);
  }
