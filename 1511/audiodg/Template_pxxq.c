/*
 * XREFs of Template_pxxq @ 0x14003C0E4
 * Callers:
...
ULONG Template_pxxq(__int64 a1, __int64 a2, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  va_copy(v8, va3);
  v9 = 4LL;
  return EventWrite(Microsoft_Windows_AudioHandle, &EVT_GLITCH_CP_CLIENT_OUTPUT_SERVER_OVERREAD, 4u, &UserData);
}
