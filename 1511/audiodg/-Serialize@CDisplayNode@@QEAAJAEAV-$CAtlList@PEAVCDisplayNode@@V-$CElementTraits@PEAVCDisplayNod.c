/*
 * XREFs of ?Serialize@CDisplayNode@@QEAAJAEAV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@AEAPEAEAEAI@Z @ 0x140034254
 * Callers:
 ...
 *     ?GetDisplayName@CDisplayNode@@QEAAPEBDXZ @ 0x140033B70 (-GetDisplayName@CDisplayNode@@QEAAPEBDXZ.c)
  ...
  *a4 += v12 + 1;
  ...
  else
  {
    *a4 += 4;
    ...
    {
      Next = ATL::CAtlList<CDisplayNode *,ATL::CElementTraits<CDisplayNode *>>::GetNext(v17, &i);
      v19 = *(_QWORD *)(a2 + 16);
      v20 = 0;
      v8 = -2147023728;
      v21 = *Next;
