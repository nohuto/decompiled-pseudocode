/*
 * XREFs of ?Create@CAudioMediaType@@SAJPEBUtWAVEFORMATEX@@IPEAPEAUIAudioMediaType@@M@Z @ 0x140011480
 * Callers:
 ...
 * Callees:
 *     ?IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z @ 0x140013A4C (-IsValidPcmWfx@@YAHPEBUtWAVEFORMATEX@@@Z.c)
        ...
        float a4)
{
  ...
  unsigned int (__fastcall *v28)(CAudioMediaType *__hidden); // rsi
