/*
 * XREFs of ?GetClientReleaseEvent@CAudioDeviceGraph@@UEAAJIPEA_K@Z @ 0x140031E60
 * Callers:
 *     <none>
 * Callees:
...
LABEL_54:
  ...
  {
    WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x26u, (__int64)&WPP_121a146f95c1699d0b0c4e89abf4320a_Traceguids);
  }
  if ( !v6 )
  {
  ...
  if ( v10 >= 0 && *a3 )
  {
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 4u )
    {
      v12 = 40;
LABEL_31:
      WPP_SF_D((__int64)v11[2], v12, (__int64)&WPP_121a146f95c1699d0b0c4e89abf4320a_Traceguids, v10);
      v11 = (_UNKNOWN **)WPP_GLOBAL_Control;
    }
  }
  else
  ...
  if ( v7 )
  {
    if ( v11 != &WPP_GLOBAL_Control && (*((_DWORD *)v11 + 7) & 0x20000) != 0 && *((_BYTE *)v11 + 25) >= 4u )
      WPP_SF_((__int64)v11[2], 0x2Au, (__int64)&WPP_121a146f95c1699d0b0c4e89abf4320a_Traceguids);
    *a3 = 0LL;
  }
