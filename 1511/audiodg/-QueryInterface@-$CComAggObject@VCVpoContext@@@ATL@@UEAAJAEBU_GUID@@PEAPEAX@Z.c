/*
 * XREFs of ?QueryInterface@?$CComAggObject@VCVpoContext@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1400349B0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ATL::CComAggObject<CVpoContext>::QueryInterface(char *a1, const struct _GUID *a2, _QWORD *a3)
{
  unsigned int v3; // edi
