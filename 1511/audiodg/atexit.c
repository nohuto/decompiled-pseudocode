 ...
 *     ATL::_dynamic_initializer_for__g_strheap__ @ 0x140001100 (ATL--_dynamic_initializer_for__g_strheap__.c)
 ...
 *     _dynamic_initializer_for__g_CrossProcessTelemetryProviderRegistration__ @ 0x140001170 (_dynamic_initializer_for__g_CrossProcessTelemetryProviderRegistration__.c)
 * Callees:
