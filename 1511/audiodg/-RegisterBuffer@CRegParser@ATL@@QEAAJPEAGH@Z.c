/*
 * XREFs of ?RegisterBuffer@CRegParser@ATL@@QEAAJPEAGH@Z @ 0x1400383D8
 * Callers:
 ...
 *     ?SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ @ 0x140039024 (-SkipWhiteSpace@CRegParser@ATL@@IEAAXXZ.c)
 */
