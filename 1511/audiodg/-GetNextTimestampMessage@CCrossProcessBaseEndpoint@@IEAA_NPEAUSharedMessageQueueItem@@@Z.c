/*
 * XREFs of ?GetNextTimestampMessage@CCrossProcessBaseEndpoint@@IEAA_NPEAUSharedMessageQueueItem@@@Z @ 0x140039E54
 * Callers:
        ...
        struct SharedMessageQueueItem *a2)
{
  ...
  if ( (_DWORD)v5 != *(_DWORD *)(*((_QWORD *)this + 8) + 4LL) )
  {
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x1Fu, (__int64)&WPP_69a2f442a7c70e07fee70227292c43c2_Traceguids, 0);
    }
  }
  return v2;
}
