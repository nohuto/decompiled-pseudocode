/*
 * XREFs of ?DisconnectStreamGroup@CSystemAudioDeviceSharedBase@@UEAAJPEAUIStreamGroupInternal@@@Z @ 0x1400058B0
 * Callers:
...
{
  _BOOL8 (__fastcall *v4)(CStreamGroup *); // rbx
  bool IsActive; // al
  _QWORD *v6; // rcx
  int v7; // eax
  int v8; // ebx
  ...
  if ( v8 < 0 && v6 != &WPP_GLOBAL_Control && (*((_DWORD *)v6 + 7) & 0x200) != 0 && *((_BYTE *)v6 + 25) >= 2u )
    WPP_SF_D(v6[2], 35LL, &WPP_c59105ced4022a196d4cc1b91b2ab5a7_Traceguids, (unsigned int)v8);
  if ( v11 )
