/*
 * XREFs of __wmainCRTStartup @ 0x140018B90
 * Callers:
 *     wWinMainCRTStartup @ 0x140018E10 (wWinMainCRTStartup.c)
 * Callees:
 *     wWinMain @ 0x14000195C (wWinMain.c)
 *     _XcptFilter_0 @ 0x14001909E (_XcptFilter_0.c)
 *     _amsg_exit_0 @ 0x140019154 (_amsg_exit_0.c)
 *     _IsNonwritableInCurrentImage @ 0x1400191B0 (_IsNonwritableInCurrentImage.c)
 *     _initterm_0 @ 0x14001932A (_initterm_0.c)
