/*
 * XREFs of ?RegisterThread@GraphStreamingResourceManager@@UEAAJPEAXPEAPEAUThreadRegistrationToken__@@@Z @ 0x140009CF0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_6:
  ...
  v9 = *(__int64 (__fastcall **)(GraphStreamingResourceManager *, void *, struct GraphStreamingResourceManager::HandleRegistrations::_t *))(*((_QWORD *)v5 - 1) + 48LL);
  if ( v9 == GraphStreamingResourceManager::InitialRegisterForThread )
    v10 = GraphStreamingResourceManager::InitialRegisterForThread(
