/*
 * XREFs of ?Add@?$CSimpleMap@U_GUID@@PEAVCPipeInstance@@V?$CSimpleMapEqualHelper@U_GUID@@PEAVCPipeInstance@@@ATL@@@ATL@@QEAAHAEBU_GUID@@AEBQEAVCPipeInstance@@@Z @ 0x1400310A0
 * Callers:
