/*
 * XREFs of ?GetDevicePosition@CCrossProcessClientOutputEndpoint@@UEAAJPEA_K0@Z @ 0x14003B440
 * Callers:
 *     <none>
 * Callees:
...
LABEL_12:
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0xBu, (__int64)&WPP_a879fc58190d540fda30a047280e1908_Traceguids, v6);
  }
