/*
 * XREFs of _TlgEnableCallback @ 0x140017890
 * Callers:
 *     <none>
 * Callees:
...
{
  int v7; // eax
  void (__fastcall *v8)(LPCGUID, _QWORD, UCHAR, ULONGLONG, ULONGLONG, PEVENT_FILTER_DESCRIPTOR, _QWORD); // rsi
  ...
  if ( pCallbackContext )
  {
    ...
    v8 = (void (__fastcall *)(LPCGUID, _QWORD, UCHAR, ULONGLONG, ULONGLONG, PEVENT_FILTER_DESCRIPTOR, _QWORD))*((_QWORD *)pCallbackContext + 5);
    if ( v8 )
