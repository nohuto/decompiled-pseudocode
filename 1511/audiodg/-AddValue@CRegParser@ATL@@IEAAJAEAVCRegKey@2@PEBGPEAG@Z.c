/*
 * XREFs of ?AddValue@CRegParser@ATL@@IEAAJAEAVCRegKey@2@PEBGPEAG@Z @ 0x1400366B0
 * Callers:
 ...
 *     ?VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z @ 0x140039474 (-VTFromRegType@CRegParser@ATL@@KAHPEBGAEAG@Z.c)
 */
        ...
        unsigned __int16 *a4)
{
  ...
  struct ATL::CRegKey *v30; // [rsp+60h] [rbp-2178h]
  ATL::CRegParser *v31; // [rsp+68h] [rbp-2170h]
