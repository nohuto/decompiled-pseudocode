/*
 * XREFs of ??1CCrossProcessBaseClientEndpoint@@UEAA@XZ @ 0x140035DA4
 * Callers:
 *     ??1CCrossProcessClientInputEndpoint@@UEAA@XZ @ 0x140035E20 (--1CCrossProcessClientInputEndpoint@@UEAA@XZ.c)
