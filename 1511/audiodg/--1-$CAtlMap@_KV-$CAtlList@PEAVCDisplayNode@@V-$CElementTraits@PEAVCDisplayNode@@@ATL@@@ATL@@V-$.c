/*
 * XREFs of ??1?$CAtlMap@_KV?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@V?$CElementTraits@_K@2@V?$CElementTraits@V?$CAtlList@PEAVCDisplayNode@@V?$CElementTraits@PEAVCDisplayNode@@@ATL@@@ATL@@@2@@ATL@@QEAA@XZ @ 0x1400267D4
 * Callers:
 *     _PublishDeviceGraphWnfState_::_1_::dtor$1 @ 0x14001B3EC (_PublishDeviceGraphWnfState_--_1_--dtor$1.c)
 *     _PublishDeviceGraphWnfState_::_1_::dtor$2 @ 0x14001B3F8 (_PublishDeviceGraphWnfState_--_1_--dtor$2.c)
 * Callees:
  ...
  if ( *(_QWORD *)a1 )
  {
    for ( i = 0LL; (unsigned int)i < *(_DWORD *)(a1 + 16); i = (unsigned int)(i + 1) )
    {
      ...
      while ( v3 )
      {
        ...
        v5 = (_QWORD *)(v3 + 56);
        v3 = *(_QWORD *)(v3 + 56);
        ATL::CAtlList<CDisplayNode *,ATL::CElementTraits<CDisplayNode *>>::RemoveAll(v4 + 8);
        *v5 = *(_QWORD *)(a1 + 64);
        v6 = --*(_QWORD *)(a1 + 8);
        *(_QWORD *)(a1 + 64) = v4;
