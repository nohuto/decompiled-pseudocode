/*
 * XREFs of ?CreateDeviceProcessNode@CDeviceProcessNode@@SAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@PEAPEAV1@@Z @ 0x140015B0C
 * Callers:
        ...
        struct CDeviceProcessNode **a2)
{
  ...
  if ( v4 )
  {
    ...
    {
      WPP_SF_(*((_QWORD *)WPP_GLOBAL_Control + 2), 13LL, &WPP_a99c0ea68331a2f1b88ee9cd60aee7de_Traceguids);
    }
  ...
  if ( v8 != &WPP_GLOBAL_Control && (*((_DWORD *)v8 + 7) & 0x20000) != 0 && *((_BYTE *)v8 + 25) >= 2u )
    WPP_SF_D(v8[2], 15LL, &WPP_a99c0ea68331a2f1b88ee9cd60aee7de_Traceguids, (unsigned int)v6);
  return (unsigned int)v6;
}
