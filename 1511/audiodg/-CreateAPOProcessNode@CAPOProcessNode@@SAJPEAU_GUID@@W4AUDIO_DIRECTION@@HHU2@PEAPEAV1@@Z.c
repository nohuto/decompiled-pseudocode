/*
 * XREFs of ?CreateAPOProcessNode@CAPOProcessNode@@SAJPEAU_GUID@@W4AUDIO_DIRECTION@@HHU2@PEAPEAV1@@Z @ 0x140011770
 * Callers:
 ...
 *     _wcsicmp_0 @ 0x140018FBA (_wcsicmp_0.c)
        ...
        _QWORD *a6)
{
  ...
  {
    WPP_SF__guid_(*((_QWORD *)WPP_GLOBAL_Control + 2), 18LL, &WPP_a99c0ea68331a2f1b88ee9cd60aee7de_Traceguids, a1);
    v11 = WPP_GLOBAL_Control;
  }
  v12 = 0;
  if ( &v50 )
  {
    v13 = RegOpenKeyExW(HKEY_CLASSES_ROOT, L"AudioEngine\\AudioProcessingObjects", 0, 0x20019u, &hKey);
    Common = v13;
    if ( v13 )
    {
      if ( v13 > 0 )
        Common = (unsigned __int16)v13 | 0x80070000;
    }
    else
    {
      lpClass = 0LL;
      ...
      do
      {
        ...
        lpsz = lpClass;
        cchName = 512;
        v18 = RegEnumKeyExW(hKey, v16, Name, &cchName, (LPDWORD)lpClass, lpClass, (LPDWORD)lpClass, &ftLastWriteTime);
        if ( !v18 || v18 == 234 )
        {
          Common = StringFromCLSID(a1, &lpsz);
          if ( Common >= 0 && !wcsicmp_0(Name, lpsz) )
          {
            v25 = RegOpenKeyExW(v17, Name, 0, 0x20019u, &phkResult);
            Common = v25;
            if ( v25 )
            {
              if ( v25 > 0 )
        ...
        if ( v53 == 1 && v52 == 1 )
        {
          ...
          if ( v20 )
          {
            ...
            if ( ftLastWriteTime )
            {
              ...
              *(_DWORD *)v21.dwLowDateTime = v8;
              *(_DWORD *)(*(_QWORD *)&v21 + 4LL) = a4;
              *(_OWORD *)(*(_QWORD *)&v21 + 8LL) = v22;
              *(_OWORD *)(*(_QWORD *)&v21 + 24LL) = v23;
              *v6 = v20;
              v20[4] = v21;
  ...
  if ( v11 != &WPP_GLOBAL_Control && (*((_DWORD *)v11 + 7) & 0x20000) != 0 && *((_BYTE *)v11 + 25) >= 2u )
    WPP_SF_D(v11[2], 19LL, &WPP_a99c0ea68331a2f1b88ee9cd60aee7de_Traceguids, (unsigned int)Common);
  return (unsigned int)Common;
}
