/*
 * XREFs of ?AddHead@?$CAtlList@PEAVCStreamInstance@@V?$CElementTraits@PEAVCStreamInstance@@@ATL@@@ATL@@QEAAPEAU__POSITION@@AEBQEAVCStreamInstance@@@Z @ 0x1400269B8
 * Callers:
 ...
 *     ?LinkToLeftDisplayNode@CDisplayNode@@QEAAJPEAV1@@Z @ 0x140034030 (-LinkToLeftDisplayNode@CDisplayNode@@QEAAJPEAV1@@Z.c)
 * Callees:
        ...
        __int64 a3)
{
  ...
  result = ATL::CAtlList<CDisplayNode *,ATL::CElementTraits<CDisplayNode *>>::NewNode((__int64)a1, a2, a3, *a1);
  if ( *a1 )
    *(_QWORD *)(*a1 + 8) = result;
  else
    a1[1] = (__int64)result;
