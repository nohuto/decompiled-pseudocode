/*
 * XREFs of ?IsEqual@CAudioMediaType@@UEAAJPEAUIAudioMediaType@@PEAK@Z @ 0x140034E20
 * Callers:
 *     <none>
 * Callees:
 *     __security_check_cookie @ 0x140018E40 (__security_check_cookie.c)
 *     memcmp_0 @ 0x140019B46 (memcmp_0.c)
...
__int64 __fastcall CAudioMediaType::IsEqual(struct IAudioMediaType *this, struct IAudioMediaType *a2, unsigned int *a3)
{
  ...
  __int64 v6; // rax
  __int64 v7; // r9
  struct IAudioMediaTypeVtbl *lpVtbl; // r8
  ...
  if ( a2 && a3 )
  {
    *a3 = 0;
    ...
    if ( lpVtbl )
    {
      ...
      {
        v17 = *(_QWORD *)(v7 + 24) - (unsigned __int64)lpVtbl->IsCompressedFormat;
        if ( !v17 )
          v17 = *(_QWORD *)(v7 + 32) - (unsigned __int64)lpVtbl->IsEqual;
        if ( v17 )
          return 1;
      }
      if ( v9 != Release )
      ...
      *a3 = v20;
      ...
      if ( *(_WORD *)v7 != 1 )
        v21 = *(unsigned __int16 *)(v7 + 16) + 18;
      if ( v22 == v21 )
      {
        if ( memcmp_0((char *)&v23->Release + 2, (const void *)(v7 + 18), *(unsigned __int16 *)(v7 + 16)) )
          return 1;
        *a3 = v20 | 8;
      }
    }
