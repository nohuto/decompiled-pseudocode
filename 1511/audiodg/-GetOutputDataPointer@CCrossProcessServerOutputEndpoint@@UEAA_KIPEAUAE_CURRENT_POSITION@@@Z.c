/*
 * XREFs of ?GetOutputDataPointer@CCrossProcessServerOutputEndpoint@@UEAA_KIPEAUAE_CURRENT_POSITION@@@Z @ 0x140018390
 * Callers:
 *     <none>
 * Callees:
      ...
      && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 5u )
    {
      ...
      WPP_SF_DDDD(
        *((_QWORD *)WPP_GLOBAL_Control + 2),
        0xAu,
        &WPP_b13bd2a1e9ef5ff2d9119971e2144d05_Traceguids,
        v25,
        v32,
        v33,
        v34);
