/*
 * XREFs of ?GetMeteringData@CSystemAudioDeviceOffload@@UEAAJPEAUAUDIO_METER_DATA@@I@Z @ 0x14002DB70
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x14u, (__int64)&WPP_0c9f4c97d2e4db079a99cda1b29d38b3_Traceguids, v8);
  }
