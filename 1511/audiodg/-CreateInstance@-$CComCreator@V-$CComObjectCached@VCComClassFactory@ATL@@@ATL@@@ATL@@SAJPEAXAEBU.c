/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObjectCached@VCComClassFactory@ATL@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140004E50
 * Callers:
 ...
 *     ?QueryInterface@?$CComObjectCached@VCComClassFactory@ATL@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1400084B0 (-QueryInterface@-$CComObjectCached@VCComClassFactory@ATL@@@ATL@@UEAAJAEBU_GUID@@PEAPEAX@Z.c)
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  {
    *((_QWORD *)v8 + 8) = v5;
    v6 = ATL::CComCriticalSection::Init((struct _RTL_CRITICAL_SECTION *)(v8 + 16));
    if ( v6 < 0
      || ((v8[56] = 1,
