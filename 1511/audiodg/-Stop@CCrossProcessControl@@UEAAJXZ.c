/*
 * XREFs of ?Stop@CCrossProcessControl@@UEAAJXZ @ 0x14003AA30
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCrossProcessControl::Stop(CCrossProcessControl *this)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x22u, (__int64)&WPP_69a2f442a7c70e07fee70227292c43c2_Traceguids, v2);
  }
