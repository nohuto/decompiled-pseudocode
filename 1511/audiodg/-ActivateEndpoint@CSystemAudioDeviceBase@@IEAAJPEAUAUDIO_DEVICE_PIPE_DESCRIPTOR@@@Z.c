/*
 * XREFs of ?ActivateEndpoint@CSystemAudioDeviceBase@@IEAAJPEAUAUDIO_DEVICE_PIPE_DESCRIPTOR@@@Z @ 0x14002A034
 * Callers:
...
LABEL_10:
          ...
          *((_DWORD *)v9 + 1) = GetSessionIdFromEndpointId(*((_QWORD *)a2 + 7));
          *((_DWORD *)v9 + 2) = *((_DWORD *)a2 + 24);
          *(_OWORD *)(v9 + 12) = *(_OWORD *)((char *)a2 + 100);
          *(_OWORD *)(v9 + 28) = *((_OWORD *)a2 + 9);
    ...
    && *((_BYTE *)WPP_GLOBAL_Control + 25) >= 2u )
  {
    WPP_SF_Ds(
      *((_QWORD *)WPP_GLOBAL_Control + 2),
      14,
      (unsigned int)&WPP_91e5ae5427249e0fd614445eea075fb4_Traceguids,
      v4,
