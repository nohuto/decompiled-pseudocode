/*
 * XREFs of ?GetPositionForOffload@CSystemAudioDeviceSharedBase@@UEAAJPEA_K0@Z @ 0x14002C520
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x14002BEB8 (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
        ...
        unsigned __int64 *a3)
{
  ...
  {
    WPP_SF_ii(*((_QWORD *)WPP_GLOBAL_Control + 2), 20LL, &WPP_c59105ced4022a196d4cc1b91b2ab5a7_Traceguids, *a2, *a3);
  }
  if ( v10 )
