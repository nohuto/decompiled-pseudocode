/*
 * XREFs of ?SetEngineThreadPriority@@YAJW4AudioThreadPriorityLevel@@PEAPEAX@Z @ 0x14003D050
 * Callers:
 *     ?EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ @ 0x14002BEB8 (-EnableMMCSS@CSystemAudioDeviceSharedBase@@IEAAJXZ.c)
 * Callees:
 *     ?ResetEngineThreadPriority@@YAJPEAPEAX@Z @ 0x14003D000 (-ResetEngineThreadPriority@@YAJPEAPEAX@Z.c)
 */
