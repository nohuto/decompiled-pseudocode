/*
 * XREFs of ?GetLatency@CSystemAudioDeviceSharedBase@@UEAAJ_KPEA_J@Z @ 0x14002C460
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 *a3)
{
  ...
  {
    WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 0x18u, (__int64)&WPP_c59105ced4022a196d4cc1b91b2ab5a7_Traceguids, v6);
  }
  if ( v9 )
