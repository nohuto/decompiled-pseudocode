/*
 * XREFs of ?AddConnectionsAndActivateAPOs@CPipeInstance@@QEAAJXZ @ 0x14000DBF0
 * Callers:
...
__int64 __fastcall CPipeInstance::AddConnectionsAndActivateAPOs(CPipeInstance *this)
{
  ...
  if ( v4 )
  {
    ...
    do
    {
      ...
      v5 = WPP_GLOBAL_Control;
LABEL_19:
      if ( v5 == (_DWORD *)&WPP_GLOBAL_Control || (v5[7] & 0x20000) == 0 || *((_BYTE *)v5 + 25) < 2u )
        goto LABEL_9;
      WPP_SF_D(*((_QWORD *)v5 + 2), 12LL, &WPP_5d27bd7bd7bfafaac91857425b42f44a_Traceguids, (unsigned int)v3);
LABEL_8:
      v5 = WPP_GLOBAL_Control;
LABEL_9:
      if ( v3 < 0 )
...
LABEL_23:
    ...
    if ( v5 != (_DWORD *)&WPP_GLOBAL_Control && (v5[7] & 0x20000) != 0 && *((_BYTE *)v5 + 25) >= 2u )
      WPP_SF_D(*((_QWORD *)v5 + 2), 47LL, &WPP_b52afc5823799b3c24512fb75c28f887_Traceguids, (unsigned int)v3);
