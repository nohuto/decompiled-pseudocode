/*
 * XREFs of ?IsRightFormatSupported@CProcessNode@@UEAAJPEAUIAudioMediaType@@PEAPEAU2@0@Z @ 0x140010DE0
 * Callers:
...
LABEL_26:
    ...
    {
      WPP_SF_D(*((_QWORD *)WPP_GLOBAL_Control + 2), 12LL, &WPP_a99c0ea68331a2f1b88ee9cd60aee7de_Traceguids, v10);
    }
    return v10;
  }
