/*
 * XREFs of ?CreateInstance@?$CComCreator@V?$CComObject@VCCrossProcessClientOutputEndpoint@@@ATL@@@ATL@@SAJPEAXAEBU_GUID@@PEAPEAX@Z @ 0x140037590
 * Callers:
        ...
        _QWORD *a3)
{
  ...
  *a3 = 0LL;
  ...
  try
  {
    ...
    v8 = (CCrossProcessClientOutputEndpoint *)AERTAllocate(0x208uLL, v7);
    if ( v8 )
      v9 = (volatile signed __int32 *)ATL::CComObject<CCrossProcessClientOutputEndpoint>::CComObject<CCrossProcessClientOutputEndpoint>(v8);
    else
      v9 = 0LL;
    v12 = v9;
  }
  ...
  if ( v9 )
  {
    _InterlockedIncrement(v9 + 114);
    v6 = ATL::CComSafeDeleteCriticalSection::Init((ATL::CComSafeDeleteCriticalSection *)(v9 + 116));
    if ( v6 >= 0 )
      v6 = 0;
    _InterlockedDecrement(v9 + 114);
