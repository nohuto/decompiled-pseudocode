        ...
        PVOID Parameters)
{
  ...
  v44 = 0;
  HeapHandle = 0LL;
  if ( dword_1801420A8 && !HeapBase && !Lock )
  {
    v36 = qword_1801420D8;
    ((void (__cdecl *)(PRTL_DYNAMIC_HASH_TABLE, PRTL_DYNAMIC_HASH_TABLE_ENUMERATOR))_guard_check_icall_fptr)(
      qword_1801420D8,
      0LL);
    v32 = (_WORD *)((__int64 (__fastcall *)(_QWORD, _QWORD, SIZE_T, SIZE_T, _QWORD, PVOID))v36)(
                     Flags,
                     0LL,
                     ReserveSize,
                     v48,
...
LABEL_50:
  ...
  if ( !*((_QWORD *)&v57[4] + 1) )
  {
    ...
    if ( v47 )
    {
      RtlpSecMemFreeVirtualMemory(v16, BaseAddress, (ULONG_PTR *)&v47, 0x8000u);
...
LABEL_89:
  ...
  if ( HeapHandle )
  {
    ...
    {
      v43 = 0LL;
      RtlpSecMemFreeVirtualMemory(v16, &HeapHandle, &v43, 0x8000u);
    }
  }
  return v32;
}
