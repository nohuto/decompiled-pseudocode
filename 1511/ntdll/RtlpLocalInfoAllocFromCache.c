/*
 * XREFs of RtlpLocalInfoAllocFromCache @ 0x18004F7C8
 * Callers:
 ...
 *     RtlpLfhFindClearBitAndSet @ 0x18004FAB4 (RtlpLfhFindClearBitAndSet.c)
...
LABEL_1:
    ...
    v6 = RtlpTryAcquireSubSegmentLock(v3, 1);
    v7 = v6;
    if ( v6 == -1 )
      goto LABEL_41;
    v8 = *(_QWORD *)(v3 + 8);
    if ( !v8 || *(_QWORD *)v3 != a1 || !(_WORD)v6 )
    {
      *(_DWORD *)(v3 + 32) = v6;
LABEL_41:
      v14 = 0LL;
    ...
    v12 = RtlpLowFragHeapRandomData[LowFragHeapDataSlot];
    ...
    *(_DWORD *)(v3 + 32) = (v7 - 1) | (ClearBitAndSet << 16);
    ...
    {
      RtlpLogHeapFailure(14, *(_QWORD *)(*(_QWORD *)(*(_QWORD *)a1 + 24LL) + 24LL), v14, 0, 0LL, 0LL);
      goto LABEL_41;
    }
LABEL_8:
    if ( v4 && dword_1801433A4 + 1 < (unsigned int)RtlpAffinityState )
...
LABEL_11:
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        do
        {
          ...
          if ( *v20 )
          {
            ...
            if ( v27 > v17 && !RtlpIsSubSegmentReuseThresholdExceeded(a1, *v20) )
            {
              v16 = (volatile signed __int32 *)v21;
              v17 = v27;
              v18 = (volatile signed __int64 *)(a1 + 8 * (v19 + 2LL));
            }
          }
          ++v19;
          ++v20;
        ...
        v22 = (_SLIST_HEADER *)(*(_QWORD *)(*(_QWORD *)(v48 + 24) + 8LL * *(unsigned __int16 *)(a1 + 172) + 1192) + 144LL);
        while ( 1 )
        {
      ...
      if ( !v24 )
        *(_WORD *)(a1 + 174) = (unsigned __int8)(((__int64)v18 - a1 - 16) >> 3);
LABEL_22:
      if ( !v16 )
        break;
    ...
    v29 = 0LL;
    v30 = 0LL;
    v31 = (_SLIST_HEADER *)(*(_QWORD *)(*(_QWORD *)(v48 + 24) + 8LL * *(unsigned __int16 *)(a1 + 172) + 1192) + 144LL);
...
LABEL_82:
    ...
    if ( RtlpIsSubSegmentReuseable((__int64)v26, (__int64)v16) )
    {
      while ( 1 )
      {
        v37 = *((_DWORD *)v16 + 11);
