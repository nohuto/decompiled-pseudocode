/*
 * XREFs of RtlRemovePrivileges @ 0x180083C80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlRemovePrivileges(__int64 a1, _DWORD *a2, unsigned int a3)
{
  ...
  _DWORD v10[104]; // [rsp+40h] [rbp-1B8h] BYREF

  v3 = 0LL;
  v4 = 0;
  if ( a3 )
  {
    while ( (unsigned int)(*a2 - 2) <= 0x21 )
    {
      v3 |= 1LL << *a2;
      ++v4;
      ++a2;
...
LABEL_4:
    ...
    if ( (int)result >= 0 )
    {
      ...
      if ( v3 )
        ...
        return NtAdjustPrivilegesToken(a1, 0LL, v10, 416LL, 0LL, 0LL);
    }
  }
  return result;
}
