/*
 * XREFs of vDbgPrintExWithPrefixInternal @ 0x180049998
 * Callers:
 *     DbgPrintEx @ 0x1800492F0 (DbgPrintEx.c)
 *     DbgPrint @ 0x180049950 (DbgPrint.c)
 *     LdrpLogDbgPrint @ 0x1800C9198 (LdrpLogDbgPrint.c)
 *     DbgPrintReturnControlC @ 0x1800D3720 (DbgPrintReturnControlC.c)
 *     vDbgPrintEx @ 0x1800D37D0 (vDbgPrintEx.c)
 *     vDbgPrintExWithPrefix @ 0x1800D3800 (vDbgPrintExWithPrefix.c)
 * Callees:
 *     RtlRaiseException @ 0x180036970 (RtlRaiseException.c)
 *     __security_check_cookie @ 0x180095840 (__security_check_cookie.c)
 *     _vsnprintf @ 0x180096DC0 (_vsnprintf.c)
 *     ZwQueryDebugFilterState @ 0x1800A7650 (ZwQueryDebugFilterState.c)
 *     DbgBreakPointWithStatus @ 0x1800A8880 (DbgBreakPointWithStatus.c)
 *     DebugPrint @ 0x1800A8890 (DebugPrint.c)
