/*
 * XREFs of RtlpConvertToAutoInheritSecurityObject @ 0x1800D7E34
 * Callers:
 *     RtlConvertToAutoInheritSecurityObject @ 0x1800CC5F0 (RtlConvertToAutoInheritSecurityObject.c)
 * Callees:
