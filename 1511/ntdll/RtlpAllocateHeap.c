        ...
        _DWORD *a6)
{
  ...
  unsigned __int64 v226; // [rsp+F8h] [rbp-200h] BYREF
  unsigned __int64 v227; // [rsp+100h] [rbp-1F8h]
  __int64 v228; // [rsp+108h] [rbp-1F0h]
...
LABEL_30:
  ...
  if ( v11 > *((unsigned int *)Src + 37) )
  {
    if ( (Src[112] & 2) != 0 )
    {
      ...
      v225 = 0LL;
      v226 = v187 + v274 + 4096;
      HeapProtection = RtlpGetHeapProtection(Src, 1);
      ...
      if ( (int)ZwAllocateVirtualMemory(-1LL, &v194, 0LL, &v274, 4096, HeapProtection) >= 0 )
      {
        ...
        *((_QWORD *)Src + 69) += v274;
        ...
        if ( (*((_DWORD *)Src + 28) & 0x8000000) != 0 )
          *(_WORD *)(v194 + 16) = RtlLogStackBackTraceEx(1LL);
  ...
  if ( (a2 & 0x800000) == 0 )
  {
    if ( v10 < *((unsigned __int16 *)Src + 196) )
    {
      ...
      if ( ((unsigned __int8)(1 << (v10 & 7)) & (unsigned __int8)Src[(v10 >> 3) + 394]) != 0 )
        goto LABEL_58;
      v23 = (unsigned __int16 *)(*((_QWORD *)Src + 48) + 2 * v10);
      v267 = v23;
      v24 = *v23 + 33;
      *v23 = v24;
      if ( !v209 )
...
LABEL_58:
  if ( a5 && *a5 )
  {
    ...
    {
      RtlpLogHeapFailure(12, (_DWORD)Src, v28 + 16, v32, v31, 0LL);
      goto LABEL_77;
    }
    *((_QWORD *)Src + 24) -= *(unsigned __int16 *)(v28 + 8);
    ...
    if ( v33 )
    {
      ...
      v260 = v34;
      LOBYTE(v35) = 1;
      RtlpHeapRemoveListEntry((_DWORD)Src, (_DWORD)v33, v35, v28 + 16, v34, *(unsigned __int16 *)(v28 + 8));
    }
    *v30 = v29;
    *(_QWORD *)(v29 + 8) = v30;
    v36 = (char *)(v28 + 10);
    if ( (*(_BYTE *)(v28 + 10) & 8) != 0 && !(unsigned __int8)RtlpCommitBlock(Src, v28) )
    {
      RtlpDeCommitFreeBlock((unsigned __int64)Src, v28, *(unsigned __int16 *)(v28 + 8), 1);
LABEL_77:
  ...
  v40 = v39 - 1;
  for ( j = (unsigned int)(v39 - 1); ; j = v40 )
  {
LABEL_83:
    v41 = v40 - *((_DWORD *)i + 6);
    v42 = 0LL;
    ...
    else
    {
      ...
      if ( *((_DWORD *)Src + 31) )
      {
        ...
        if ( HIBYTE(v233) != ((unsigned __int8)v233 ^ (unsigned __int8)(BYTE1(v233) ^ BYTE2(v233))) )
          RtlpLogHeapFailure(3, (_DWORD)Src, v45, 0, 0LL, 0LL);
      }
      ...
      if ( v250 <= 0 )
      {
        ...
        if ( *((_DWORD *)Src + 31) )
        {
          v235 = v48 ^ *((_DWORD *)Src + 34);
          if ( HIBYTE(v235) != ((unsigned __int8)v235 ^ (unsigned __int8)(BYTE1(v235) ^ BYTE2(v235))) )
            RtlpLogHeapFailure(3, (_DWORD)Src, v47, 0, 0LL, 0LL);
        }
        v241 = v11 - (unsigned __int16)v235;
        if ( v241 > 0 )
        {
          if ( *i || (_DWORD)j != *((_DWORD *)i + 2) - 1 )
          {
            v51 = (unsigned int)v41 >> 5;
            v211 = (unsigned int)v41 >> 5;
            v52 = ((unsigned int)(*((_DWORD *)i + 2) - *((_DWORD *)i + 6)) >> 5) - 1;
            v53 = (unsigned int *)(i[5] + 4 * v51);
            v262 = v53;
          ...
          else
          {
            ...
            for ( k = *(char ***)(i[6] + 8 * v41); v43 != k; k = (char **)*k )
            {
              v50 = *((_DWORD *)k - 2);
              v232 = v50;
              if ( *((_DWORD *)Src + 31) )
              {
                v232 = v50 ^ *((_DWORD *)Src + 34);
...
LABEL_470:
  ...
  {
LABEL_164:
    v75 = (char *)RtlpExtendHeap((__int64)Src, v274);
    v28 = (__int64)v75;
    v210 = v75;
    if ( v75 )
    {
      ...
      if ( *v204 != v61 || (char *)v60 != v58 )
        goto LABEL_161;
      *((_QWORD *)Src + 24) -= *(unsigned __int16 *)(v28 + 8);
      v77 = (__int64 *)*((_QWORD *)Src + 39);
      if ( v77 )
      {
        v78 = *(unsigned __int16 *)(v28 + 8);
        while ( 1 )
        {
          v79 = *((unsigned int *)v77 + 2);
          if ( v78 < v79 )
            break;
          if ( !*v77 )
          {
        ...
        if ( v85 == v58 )
        {
          ...
          else
          {
            ...
            {
              LOBYTE(v84) = 1;
              if ( !(unsigned int)RtlpHeapListCompare(Src, v87, v80, v84) )
              {
                *(_QWORD *)(v83 + v77[6]) = v87;
                goto LABEL_190;
              }
            }
            *(_QWORD *)(v83 + v77[6]) = 0LL;
          }
          *(_DWORD *)(v77[5] + 4LL * (v81 >> 5)) &= ~(1 << (v81 & 0x1F));
        }
      }
LABEL_190:
      v88 = v204;
...
LABEL_494:
  ...
  if ( *((_DWORD *)Src + 31) )
  {
    *(_DWORD *)(v28 + 8) ^= *((_DWORD *)Src + 34);
    if ( *(_BYTE *)(v28 + 11) != (*(_BYTE *)(v28 + 8) ^ (unsigned __int8)(*(_BYTE *)(v28 + 9) ^ *(_BYTE *)(v28 + 10))) )
      RtlpAnalyzeHeapFailure(Src, v42 - 16);
  }
  ...
  {
LABEL_161:
    RtlpLogHeapFailure(12, (_DWORD)Src, (_DWORD)v58, v61, v60, 0LL);
    goto LABEL_495;
  }
  *((_QWORD *)Src + 24) -= v57;
  v62 = (__int64 *)*((_QWORD *)Src + 39);
  if ( !v62 )
    goto LABEL_157;
  ...
  else
  {
    ...
    if ( *(_QWORD *)v58 != v62[4] )
    {
      ...
      if ( *((_DWORD *)Src + 31) )
      {
        v224 = v73 ^ *((_DWORD *)Src + 34);
        if ( HIBYTE(v224) != (BYTE1(v224) ^ (unsigned __int8)(v224 ^ BYTE2(v224))) )
        {
          RtlpLogHeapFailure(3, (_DWORD)Src, v72 - 16, 0, 0LL, 0LL);
          v59 = v228;
        }
      }
      if ( !(v65 - (unsigned __int16)v224) )
      {
        *(_QWORD *)(v68 + v62[6]) = v72;
        v28 = (__int64)v210;
        goto LABEL_157;
      }
      v28 = (__int64)v210;
    }
    *(_QWORD *)(v68 + v62[6]) = 0LL;
  }
  *(_DWORD *)(v62[5] + 4LL * (v66 >> 5)) &= ~(1 << (v66 & 0x1F));
LABEL_157:
  v74 = v204;
  *v204 = v59;
  *(_QWORD *)(v59 + 8) = v74;
...
LABEL_193:
  ...
  if ( !v199 && (v89 & 4) != 0 )
  {
    ...
    v92 = RtlCompareMemoryUlong(v28 + 32, v91, 4277075694LL);
    if ( v92 != v91 )
    {
      if ( NtCurrentPeb()->Ldr )
  ...
  if ( (*v36 & 1) != 0 )
  {
    RtlpLogHeapFailure(3, (_DWORD)Src, v28, 0, 0LL, 0LL);
    goto LABEL_495;
  }
  *v36 = v197;
  v93 = v216;
  v94 = (__int64 *)(*(unsigned __int16 *)(v28 + 8) - v216);
  v268 = v94;
  *(_WORD *)(v28 + 8) = v216;
  v95 = v273;
  v96 = v274 - v273;
  ...
  *(_BYTE *)(v28 + 11) = 0;
  ...
  if ( v99 )
  {
    v100 = (char *)((v28 & 0xFFFFFFFFFFFF0000uLL) - ((unsigned __int64)v99 << 16) + 0x10000);
    v255 = v100;
  }
  else
  {
  ...
  *(_BYTE *)(v101 + 10) = v89;
  *(_BYTE *)(v101 + 15) = 0;
  *(_WORD *)(v101 + 12) = v93 ^ *((_WORD *)Src + 70);
  v102 = (char *)*((_QWORD *)v100 + 5);
  if ( v102 == v100 )
  {
    LOBYTE(v103) = 0;
  }
  ...
  *(_BYTE *)(v101 + 14) = v103;
  *(_BYTE *)(v101 + 11) = 0;
  *(_WORD *)(v101 + 8) = (_WORD)v94;
  while ( 1 )
  {
    v104 = v101 + 16LL * (_QWORD)v94;
    if ( ((*(_BYTE *)(v104 + 10) ^ (unsigned __int8)(Src[138] & (*((_DWORD *)Src + 31) >> 20))) & 1) != 0 )
    {
      *(_WORD *)(v104 + 12) = (unsigned __int16)v94 ^ *((_WORD *)Src + 70);
      if ( !v98 )
      {
        ...
        *(_BYTE *)(v101 + 15) = 0;
        v106 = Src + 336;
        v107 = (__int64 *)*((_QWORD *)Src + 39);
        if ( v107 )
        {
          while ( 1 )
          {
            v108 = *((unsigned int *)v107 + 2);
          ...
          {
LABEL_229:
            v109 = (unsigned int)((_DWORD)v94 - *((_DWORD *)v107 + 6));
            v110 = 0LL;
            v111 = (_QWORD *)v107[4];
            v112 = (_QWORD *)v111[1];
            if ( v111 == v112 )
            ...
            else
            {
              ...
              if ( v248 <= 0 )
              {
                ...
                if ( *((_DWORD *)Src + 31) )
                {
                  v236 = v116 ^ *((_DWORD *)Src + 34);
                  if ( HIBYTE(v236) != ((unsigned __int8)v236 ^ (unsigned __int8)(BYTE1(v236) ^ BYTE2(v236))) )
                    RtlpLogHeapFailure(3, (_DWORD)Src, v115, 0, 0LL, 0LL);
                }
                v252 = v105 - (unsigned __int16)v236;
                if ( v252 > 0 )
                {
                  if ( *v107 || (_DWORD)v218 != *((_DWORD *)v107 + 2) - 1 )
                  {
                    v119 = (unsigned int)v109 >> 5;
                    v212 = (unsigned int)v109 >> 5;
                    v120 = ((unsigned int)(*((_DWORD *)v107 + 2) - *((_DWORD *)v107 + 6)) >> 5) - 1;
                    v121 = (unsigned int *)(v107[5] + 4 * v119);
                    v245 = v121;
                    ...
                    v110 = *(_QWORD **)(v107[6] + 8 * v124);
                  }
                  else
                  {
                    if ( *((_DWORD *)v107 + 3) )
                      v109 = (unsigned int)(2 * v109);
                    for ( m = *(_QWORD **)(v107[6] + 8 * v109); v111 != m; m = (_QWORD *)*m )
                    {
                      v118 = *((_DWORD *)m - 2);
                      v231 = v118;
                      if ( *((_DWORD *)Src + 31) )
                      {
                        v231 = v118 ^ *((_DWORD *)Src + 34);
...
LABEL_271:
        ...
        while ( v106 != v110 )
        {
          if ( *((_DWORD *)Src + 31) )
          {
            v125 = *((_DWORD *)v110 - 2);
            v265 = v125;
            if ( (v125 & *((_DWORD *)Src + 31)) != 0 )
              v265 = v125 ^ *((_DWORD *)Src + 34);
            v126 = v265;
          }
          else
          {
        ...
        *((_QWORD *)Src + 24) += *(unsigned __int16 *)(v101 + 8);
        ...
        if ( v129 )
        {
          ...
          v135 = 8 * v134;
          v204 = (__int64 *)(8 * v134);
          v136 = *(_QWORD *)(8 * v134 + v129[6]);
          if ( (_DWORD)v130 == *((_DWORD *)v129 + 2) - 1 )
            ++*((_DWORD *)v129 + 5);
          if ( !v136 )
            goto LABEL_300;
          ...
          if ( *((_DWORD *)Src + 31) )
          {
            v229 = v137 ^ *((_DWORD *)Src + 34);
            if ( HIBYTE(v229) != (BYTE2(v229) ^ (unsigned __int8)(BYTE1(v229) ^ v229)) )
            {
              RtlpLogHeapFailure(3, (_DWORD)Src, v136 - 16, 0, 0LL, 0LL);
              v135 = (__int64)v204;
            }
          }
          ...
          if ( v244 <= 0 )
LABEL_300:
            *(_QWORD *)(v135 + v129[6]) = v127;
          if ( !v136 )
            *(_DWORD *)(v129[5] + 4LL * (v133 >> 5)) |= 1 << (v133 & 0x1F);
        }
        goto LABEL_305;
      }
      *(_BYTE *)(v101 + 10) &= 0xF0u;
...
LABEL_315:
      v140 = Src + 336;
      if ( *((_QWORD *)Src + 39) )
        Entry = (_QWORD *)RtlpFindEntry(Src, (unsigned __int16)v94);
      else
        Entry = (_QWORD *)*v140;
      while ( v140 != Entry )
      {
        if ( *((_DWORD *)Src + 31) )
        {
          v142 = *((_DWORD *)Entry - 2);
          v264 = v142;
          if ( (v142 & *((_DWORD *)Src + 31)) != 0 )
            v264 = v142 ^ *((_DWORD *)Src + 34);
          v143 = v264;
        }
        else
        {
      ...
      *((_QWORD *)Src + 24) += *(unsigned __int16 *)(v101 + 8);
      v146 = (__int64 **)*((_QWORD *)Src + 39);
      if ( v146 )
      {
        v147 = *(unsigned __int16 *)(v101 + 8);
        while ( 1 )
        {
          v148 = *((unsigned int *)v146 + 2);
          if ( v147 < v148 )
            break;
          if ( !*v146 )
          {
...
LABEL_304:
        LOBYTE(v148) = 1;
        RtlpHeapAddListEntry((_DWORD)Src, (_DWORD)v146, v148, (_DWORD)v144, v147, *(unsigned __int16 *)(v101 + 8));
        goto LABEL_305;
      }
      goto LABEL_305;
    }
    if ( *((_DWORD *)Src + 31) )
    {
      *(_DWORD *)(v104 + 8) ^= *((_DWORD *)Src + 34);
      if ( *(_BYTE *)(v104 + 11) != (*(_BYTE *)(v104 + 8) ^ (unsigned __int8)(*(_BYTE *)(v104 + 9) ^ *(_BYTE *)(v104 + 10))) )
        RtlpAnalyzeHeapFailure(Src, v101 + 16LL * (_QWORD)v94);
    }
    v149 = *(_QWORD *)(v104 + 16);
    ...
    if ( *v150 == v152 && v151 == v104 + 16 )
      break;
    RtlpLogHeapFailure(12, (_DWORD)Src, v104 + 16, v152, v151, 0LL);
LABEL_415:
    if ( (_DWORD)v197 )
    {
  ...
  *((_QWORD *)Src + 24) -= *(unsigned __int16 *)(v104 + 8);
  v153 = (__int64 **)*((_QWORD *)Src + 39);
  if ( v153 )
  {
    v154 = *(unsigned __int16 *)(v104 + 8);
    while ( 1 )
    {
      v155 = *((unsigned int *)v153 + 2);
      if ( v154 < v155 )
        break;
      if ( !*v153 )
      {
    ...
    v249 = v154;
    LOBYTE(v155) = 1;
    RtlpHeapRemoveListEntry((_DWORD)Src, (_DWORD)v153, v155, v104 + 16, v154, *(unsigned __int16 *)(v104 + 8));
  }
  *v150 = v149;
  *(_QWORD *)(v149 + 8) = v150;
  if ( (*(_BYTE *)(v104 + 10) & 8) != 0 && !(unsigned __int8)RtlpCommitBlock(Src, v101 + 16LL * (_QWORD)v94) )
  {
    RtlpDeCommitFreeBlock((unsigned __int64)Src, v101 + 16LL * (_QWORD)v94, *(unsigned __int16 *)(v104 + 8), 1);
    goto LABEL_415;
  }
  if ( v98 )
  {
    ...
    if ( (v156 & 4) != 0 )
    {
      ...
      v158 = RtlCompareMemoryUlong(v104 + 32, v157, 4277075694LL);
      if ( v158 != v157 )
      {
        if ( NtCurrentPeb()->Ldr )
          DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
        ...
        DbgPrint(
          ...
          (const void *)(v101 + 16LL * (_QWORD)v94),
          (const void *)(v104 + v158 + 32));
        RtlpBreakPointHeap(v101 + 16LL * (_QWORD)v94);
        v98 = v219;
      }
    }
  }
  *(_BYTE *)(v101 + 10) = *(_BYTE *)(v104 + 10);
  v159 = (unsigned __int64)v94 + *(unsigned __int16 *)(v104 + 8);
  v204 = (__int64 *)v159;
  if ( v159 > 0xFF00 )
  {
    RtlpInsertFreeBlock((unsigned __int64)Src, v101, v159);
    goto LABEL_418;
  }
  *(_WORD *)(v101 + 8) = v159;
  *(_WORD *)(16 * v159 + v101 + 12) = v159 ^ *((_WORD *)Src + 70);
  if ( v98 )
  {
    *(_BYTE *)(v101 + 10) &= 0xF0u;
    *(_BYTE *)(v101 + 15) = 0;
  ...
  if ( v199 )
  {
    ...
    if ( v193 )
    {
      if ( (*((_DWORD *)Src + 29) & 0x1000000) == 0 )
      {
        ++*((_DWORD *)Src + 150);
        v175 = *((_DWORD *)Src + 152);
        if ( *((_DWORD *)Src + 150) > v175 )
        {
          *((_DWORD *)Src + 150) = 0;
          v176 = *((_QWORD *)Src + 67) - 16LL * *((_QWORD *)Src + 24);
          if ( v176 > *((_QWORD *)Src + 79) )
            *((_QWORD *)Src + 79) = v176;
          *((_QWORD *)Src + 80) = v176;
        }
        if ( ++*((_DWORD *)Src + 153) >= 0x1000u )
        {
          if ( Src[378] != 2 || (v177 = 4, *((_DWORD *)Src + 154) <= 0x10u) )
            v177 = 8;
          if ( *((_DWORD *)Src + 151) > (unsigned int)(4096 >> v177) && v175 < 0x10000 )
            *((_DWORD *)Src + 152) = 2 * v175;
          *((_DWORD *)Src + 151) = 0;
          *((_DWORD *)Src + 153) = 0;
        }
      }
      ...
      if ( v20 )
      {
        *(_QWORD *)(v178 + 16) = 0LL;
        ...
        if ( v179 != -2 )
        {
          ...
          {
            v180 = v179 & 2 | 1;
            v181 = _InterlockedCompareExchange((volatile signed __int32 *)(v178 + 8), v180 + v179, v179);
            v20 = v179 == v181;
            v179 = v181;
          }
          while ( !v20 );
  ...
  *(_BYTE *)(v213 + 11) = 0;
  if ( (*(_BYTE *)(v185 + 10) & 2) != 0 )
  {
    ...
    *ExtraStuffPointer = 0LL;
    ...
    if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
      *((_WORD *)v238 + 1) = RtlpUpdateTagEntry((_DWORD)Src, (a2 >> 18) & 0xFFF, 0, *v173, 0);
  }
  else if ( (NtCurrentPeb()->NtGlobalFlag & 0x800) != 0 )
  {
    *(_BYTE *)(v185 + 11) = RtlpUpdateTagEntry((_DWORD)Src, (unsigned __int8)(a2 >> 18), 0, *v173, 0);
  }
  if ( *((_DWORD *)Src + 31) )
  {
