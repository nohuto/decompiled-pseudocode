/*
 * XREFs of TpAllocWork @ 0x18000CDC0
 * Callers:
...
__int64 __fastcall TpAllocWork(_PEB_LDR_DATA *Ldr, __int64 a2, __int64 a3, __int64 a4)
{
  int v5; // r12d
  ...
  else
  {
    *(_QWORD *)&v7->Length = 0LL;
    Heap = RtlAllocateHeap(NtCurrentPeb()->ProcessHeap, (TppHeapTag + 0x200000) | 8u, 232LL);
    v10 = (_QWORD *)Heap;
    v15 = Heap;
    if ( Heap )
    {
      *(_QWORD *)(Heap + 168) = retaddr;
      v11 = TppWorkInitialize(Heap, v5, a4, v8, (__int64)TppWorkpCleanupGroupMemberVFuncs, (__int64)TppWorkpTaskVFuncs);
      v13 = v11;
      if ( v11 >= 0 )
      {
        v10[10] = a2;
