/*
 * XREFs of SbpUpdateCache @ 0x1800721FC
 * Callers:
 *     SbSelectProcedure @ 0x18000EFD0 (SbSelectProcedure.c)
 * Callees:
 *     SbpFindMatchingContext @ 0x180072368 (SbpFindMatchingContext.c)
...
__int64 __fastcall SbpUpdateCache(__int64 a1, __int64 a2, __int64 a3, unsigned int a4)
{
  ...
  v4 = a3;
  v27 = a3;
  if ( !(unsigned int)SbAtomicCaptureContextGuid(a4, v28, &v26) )
    return 0LL;
  v8 = *(_DWORD **)(a2 + 24);
  for ( i = 0LL; (unsigned int)i < *v8; v4 = v27 )
  {
    v10 = *(_QWORD *)&v8[2 * i + 2];
    if ( v10 )
    {
