/*
 * XREFs of RtlpValidateHeapSegment @ 0x1800F01C8
 * Callers:
    ...
    *a6 = i;
    if ( BaseAddress[31] != (_DWORD)v8 )
    {
      *(_DWORD *)(i + 8) ^= BaseAddress[34];
      ...
      {
        RtlpAnalyzeHeapFailure(BaseAddress, i);
        v8 = 0LL;
      }
    }
    ...
    if ( (v17 & 1) != 0 )
    {
      ...
      if ( (*(_BYTE *)(i + 10) & 4) != 0 )
      {
        v22 = RtlpCheckBusyBlockTail((__int64)BaseAddress, i);
        v8 = 0LL;
        if ( !v22 )
        {
          v23 = BaseAddress[31] == 0;
          goto LABEL_118;
        }
      }
    }
    ...
    {
      if ( ((v17 >> 2) & ((BaseAddress[28] & 0x40) != 0)) != 0 )
      {
        v24 = v18 - 32;
        if ( (v17 & 2) != 0 && v24 > 4 )
          v24 = v18 - 36;
...
LABEL_35:
            ...
            *(_QWORD *)(v27 + 8) = v25;
            if ( (*(_BYTE *)(i + 10) & 8) != 0 )
            {
              v34 = RtlpCommitBlock(BaseAddress, i);
              v8 = 0LL;
              if ( !v34 )
              {
                RtlpDeCommitFreeBlock((unsigned __int64)BaseAddress, i, *(unsigned __int16 *)(i + 8), 1);
                goto LABEL_39;
              }
            }
            v35 = *(unsigned __int16 *)(i + 8);
            v36 = (_QWORD **)(BaseAddress + 84);
            *(_BYTE *)(i + 10) = (_BYTE)v8;
            *(_BYTE *)(i + 15) = (_BYTE)v8;
            ...
            {
              Entry = (_QWORD *)RtlpFindEntry((__int64)BaseAddress, (unsigned int)v35);
              v8 = 0LL;
            }
            if ( v36 != Entry )
            {
            ...
            {
              RtlpLogHeapFailure(12, 0LL, (__int64)Entry, 0LL, *v41, (__int64)v8);
              v8 = 0LL;
            }
            *((_QWORD *)BaseAddress + 24) += *(unsigned __int16 *)(i + 8);
            ...
            if ( v42 )
            {
              ...
              v45 = *(_DWORD *)(v42 + 8) - 1;
LABEL_64:
              RtlpHeapAddListEntry((__int64)BaseAddress, v42, 1, i + 16, v45, *(unsigned __int16 *)(i + 8));
              v8 = 0LL;
            }
            if ( BaseAddress[31] != (_DWORD)v8 )
            {
          ...
          {
            RtlpLogHeapFailure(12, (__int64)BaseAddress, i + 16, v29, v28, (__int64)v8);
LABEL_39:
            v8 = 0LL;
          }
          v9 = a4;
    ...
    v48 = *(_BYTE *)(i + 14);
    if ( v48 )
      v49 = (_DWORD *)((i & 0xFFFFFFFFFFFF0000uLL) - ((unsigned __int64)v48 << 16) + 0x10000);
    else
      v49 = BaseAddress;
    if ( v49 != (_DWORD *)a2 )
    {
