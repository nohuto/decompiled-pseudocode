/*
 * XREFs of RtlpHpSegWalkHeap @ 0x18004FE60
 * Callers:
...
LABEL_27:
    ...
    || (*(_BYTE *)(32LL * (unsigned int)((v3 - (v3 & 0xFFFFFFFFFFF00000uLL)) >> 12) + (v3 & 0xFFFFFFFFFFF00000uLL) + 0x18) & 8) == 0 )
  {
    ...
    if ( (*(_BYTE *)(v8 + 24) & 1) != 0 )
      v11 = RtlpHpLfhSubsegmentWalk((int)a1 + 272, v10, v9, (unsigned int)&v25, (__int64)&v24, (__int64)v23);
    else
      v11 = RtlpHpVsSubsegmentWalk((int)a1 + 168, v10, v9, (unsigned int)&v25, (__int64)&v24, (__int64)v23);
    *(_QWORD *)a2 = v11;
    if ( !v11 )
      goto LABEL_13;
...
LABEL_14:
      ...
      if ( (*(_BYTE *)(v8 + 24) & 1) != 0 )
      {
        v22 = RtlpHpLfhSubsegmentWalk((int)a1 + 272, v16, v17, (unsigned int)&v25, (__int64)&v24, (__int64)v23);
        *(_QWORD *)a2 = v22;
        if ( v22 )
        {
          RtlpHpSegReportBusyBlock(a1, a2, v25, v24, v23[0]);
      ...
      {
        v18 = RtlpHpVsSubsegmentWalk((int)a1 + 168, v16, v17, (unsigned int)&v25, (__int64)&v24, (__int64)v23);
        *(_QWORD *)a2 = v18;
        if ( v18 )
        {
          RtlpHpSegReportBusyBlock(a1, a2, v25, v24, v23[0]);
