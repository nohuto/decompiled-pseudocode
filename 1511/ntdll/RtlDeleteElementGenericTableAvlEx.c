/*
 * XREFs of RtlDeleteElementGenericTableAvlEx @ 0x180068990
 * Callers:
 *     RtlDeleteElementGenericTableAvl @ 0x1800686F0 (RtlDeleteElementGenericTableAvl.c)
 * Callees:
 *     DeleteNodeFromTree @ 0x1800689FC (DeleteNodeFromTree.c)
 *     RealPredecessor @ 0x180068CB8 (RealPredecessor.c)
