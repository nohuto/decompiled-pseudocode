/*
 * XREFs of RtlCompressBufferXpressHuffMax @ 0x18009103C
 * Callers:
        ...
        unsigned __int8 *a6)
{
  ...
  unsigned __int64 XpressCallback; // [rsp+C0h] [rbp+8h]
  ...
  if ( a4 >= 0x12C )
  {
    ...
    *((_QWORD *)a6 + 0x8000) = 0LL;
    ...
    while ( 1 )
    {
      ...
      do
      {
        v22 = (unsigned __int16)XpressHashFunction[*v20] ^ (unsigned __int16)word_180111A00[v20[2]] ^ (unsigned __int64)(unsigned __int16)word_180111800[v20[1]];
        v23 = *(_QWORD *)&a6[8 * v22];
        *(_QWORD *)&a6[8 * v22] = v20++;
      ...
      v24 = 0LL;
LABEL_15:
      if ( (unsigned __int64)v11 < XpressCallback )
        goto LABEL_18;
      if ( (unsigned __int64)v11 < v17 )
        break;
      v14 = (int *)v70;
