/*
 * XREFs of RtlpPrintErrorInformation @ 0x1800F1D10
 * Callers:
...
ULONG RtlpPrintErrorInformation()
{
  ...
  if ( NtCurrentPeb()->Ldr )
    ...
    DbgPrint("HEAP: ");
  DbgPrint("Heap error detected at %p (heap handle %p)\n", (const void *)qword_1801422C8, (const void *)qword_1801422C0);
  if ( dword_1801422B8 > 7 )
  {
    switch ( dword_1801422B8 )
    {
      case 8:
  ...
  else if ( dword_1801422B8 == 7 )
  {
    v0 = "heap_failure_buffer_underrun";
  }
  else if ( dword_1801422B8 )
  {
    switch ( dword_1801422B8 )
    {
      case 1:
  ...
  if ( qword_1801422E0 )
  {
    if ( NtCurrentPeb()->Ldr )
      ...
      DbgPrint("HEAP: ");
    DbgPrint("Parameter3: %p\n", (const void *)qword_1801422E0);
  }
  if ( qword_1801422E8 || qword_1801422F0 )
  {
    if ( NtCurrentPeb()->Ldr )
      DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
    else
    ...
    DbgPrint(
      ...
      (const void *)qword_1801422E8,
      (const void *)qword_1801422F0);
  }
  if ( NtCurrentPeb()->Ldr )
    DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
  else
