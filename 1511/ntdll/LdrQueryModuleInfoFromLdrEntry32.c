/*
 * XREFs of LdrQueryModuleInfoFromLdrEntry32 @ 0x180087800
 * Callers:
...
NTSTATUS __fastcall LdrQueryModuleInfoFromLdrEntry32(_QWORD *a1, __int64 a2, __int64 a3, __int64 a4, char a5)
{
  NTSTATUS result; // eax
  int v10; // edi
  __int64 v11; // rdx
  ...
  result = LdrpReadMemory(a1, a3, (__int64)v15, 72LL);
  if ( result >= 0 )
  {
    *(_QWORD *)(a2 + 16) = v16;
    *(_DWORD *)(a2 + 24) = v17;
    ...
    *(_WORD *)(a2 + 36) = v22;
    if ( (a5 & 2) != 0 )
    {
      ...
      do
      {
        if ( (int)LdrpReadMemory(a1, v11, (__int64)&v12, 4LL) < 0 )
          break;
        v11 = v12;
        if ( v12 == a4 )
          break;
    ...
    v13[0] = v18;
    v13[1] = v19;
    return LdrpGetModuleName((__int64)a1, (__int64)v13, a2, 1);
  }
  return result;
}
