/*
 * XREFs of _RtlpMuiRegAddBaseLanguage @ 0x1800ECD2C
 * Callers:
 ...
 *     RtlpMuiRegGetOrAddLangInfo @ 0x1800EC074 (RtlpMuiRegGetOrAddLangInfo.c)
...
__int64 __fastcall RtlpMuiRegAddBaseLanguage(__int64 a1, _WORD *a2, unsigned int a3, __int64 a4, wchar_t *a5)
{
  ...
  __int64 v23; // rdx
  _WORD *v24; // rcx
  char v26; // [rsp+30h] [rbp-71h] BYREF
  char v27; // [rsp+31h] [rbp-70h]
  __int16 v28[2]; // [rsp+34h] [rbp-6Dh] BYREF
  char v29; // [rsp+38h] [rbp-69h] BYREF
  char v30; // [rsp+39h] [rbp-68h]
  int v31; // [rsp+3Ch] [rbp-65h] BYREF
  int v32; // [rsp+40h] [rbp-61h]
  wchar_t *String2; // [rsp+48h] [rbp-59h]
  int inited; // [rsp+50h] [rbp-51h]
  __int64 v35; // [rsp+58h] [rbp-49h]
  signed int v36; // [rsp+60h] [rbp-41h]
  _WORD *v37; // [rsp+68h] [rbp-39h]
  _UNICODE_STRING DestinationString; // [rsp+70h] [rbp-31h] BYREF
  _WORD v39[2]; // [rsp+80h] [rbp-21h] BYREF
  __int16 v40; // [rsp+84h] [rbp-1Dh]
  __int16 v41; // [rsp+86h] [rbp-1Bh]
  __int16 v42; // [rsp+88h] [rbp-19h]
  _WORD v43[10]; // [rsp+8Ch] [rbp-15h] BYREF
    ...
    *(_WORD *)(a4 + 2 * v10 + 20) = 0;
    ...
    if ( v27 )
    {
      ...
      *(_WORD *)(a4 + 2 * v10 + 20) = v31;
      ...
      {
        LanguageSpec = RtlpMuiRegGetLanguageSpec(v35, String2, &v29, v12, (__int16 *)&v31);
        v16 = v29;
        if ( LanguageSpec < 0 )
        {
      ...
      if ( v9 )
      {
        ...
        do
        {
          if ( !*v9 || v18 >= 8 )
            break;
          v19 = RtlpMuiRegGetLanguageSpec(v35, v9, &v26, v12, v28);
          v8 = v26;
          v5 = v28[0];
...
LABEL_43:
          v23 = v36;
          v24 = v37;
          v37[4] = v37[4] & ~(3 << (2 * v36)) | ((v8 & 3) << (2 * v36));
          v24[v23 + 6] = v5;
          return (unsigned int)v13;
        }
        v5 = v41;
    ...
    if ( !v27 )
      goto LABEL_43;
    v39[0] &= ~0x20u;
    v13 = RtlpMuiRegGetOrAddLangInfo((__int64 *)(v35 + 24), (__int64)v39, v28);
    if ( v13 >= 0 )
    {
      v5 = v28[0];
      v8 = 2;
