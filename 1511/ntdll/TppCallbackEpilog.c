/*
 * XREFs of TppCallbackEpilog @ 0x18002C870
 * Callers:
...
void __fastcall TppCallbackEpilog(__int64 *a1)
{
  ...
  __int64 v9; // rbx
  void (__fastcall *v10)(__int64, __int64, unsigned __int64, __int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD)); // rdi
  __int64 v11; // r8
  int v12; // r10d
  __int64 v13; // r9
  __int64 v14; // r8
  ...
  while ( 2 )
  {
    ...
    *((_DWORD *)a1 + 36) = v2 ^ (1 << v3);
    if ( v3 == 9 )
    {
      v9 = a1[23];
      a1[23] = 0LL;
      v10 = *(void (__fastcall **)(__int64, __int64, unsigned __int64, __int64 (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD)))(*(_QWORD *)(v9 + 8) + 8LL);
...
LABEL_47:
      ...
      case 4:
        ...
        else
        {
          ...
          while ( v16 != v15 );
          v17 = *(_QWORD *)(*(_QWORD *)(v13 + 136) + 56LL);
        }
        if ( v12 == 2 )
        {
          v30[0] = 0;
        ...
        goto LABEL_12;
      case 5:
        TppBarrierAdjust((unsigned __int64 *)(a1[22] + 32), -1, 0);
        a1[22] = 0LL;
        goto LABEL_12;
      case 7:
