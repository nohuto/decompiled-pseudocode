/*
 * XREFs of EtwpUpdateEnableInfoAndCallback @ 0x180054738
 * Callers:
 ...
 *     EtwpUpdatePrivateEnableInfo @ 0x1800828A4 (EtwpUpdatePrivateEnableInfo.c)
 *     EtwpIsPrivateLoggerOn @ 0x180083214 (EtwpIsPrivateLoggerOn.c)
 */
