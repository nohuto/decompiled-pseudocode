/*
 * XREFs of EtwEventWriteString @ 0x1800F3AE0
 * Callers:
 *     <none>
 * Callees:
 *     RtlNtStatusToDosError @ 0x180048C10 (RtlNtStatusToDosError.c)
 *     EtwpReleasePrivateBuffers @ 0x180049F80 (EtwpReleasePrivateBuffers.c)
...
ULONG __cdecl EtwEventWriteString(REGHANDLE RegHandle, UCHAR Level, ULONGLONG Keyword, PCWSTR String)
{
  ...
  if ( v7 || v9 )
  {
    ...
    *(_QWORD *)&v19 = 0LL;
    ...
    if ( v9 )
    {
      v4 = EtwpWriteToPrivateBuffers(v5, &v19, 0, 0, 4, &v20, 0LL, 1u, (__int64)&v14, (__int64)v26);
      if ( v4 )
        goto LABEL_35;
    }
    if ( v7 )
