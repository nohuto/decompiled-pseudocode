/*
 * XREFs of Normalization__IsNormalized @ 0x180002758
 * Callers:
 ...
 *     Normalization__GetLastChar @ 0x1800E8838 (Normalization__GetLastChar.c)
 */
...
LABEL_5:
  ...
  while ( 1 )
  {
    while ( 1 )
    {
      ...
      if ( v10 != 255 )
      {
        v11 = *(_BYTE *)((v7 & 0x7F) + ((unsigned __int64)v10 << 7) + *(_QWORD *)(a1 + 40) - 128);
        if ( v11 )
        {
          v12 = v11 & 0xC0;
          v23 = v11 & 0xC0;
            ...
            if ( (v11 & 0x80) != 0 )
            {
              ...
              if ( (v29 & 0xBF) != 0 )
              {
                ...
                if ( ((((v21 | v22) - 64) & 0xBF) == 0 || v22 == 64 && (!v21 || v21 == 63))
                  && (unsigned int)Normalization__CanCombinableCharactersCombine(a1, v25, (unsigned int)v7) )
                {
                  goto LABEL_89;
                }
...
LABEL_69:
                ...
                CanCombinableCharactersCombine = Normalization__CanCombineWithStartBase(a1, &v26, v25, (unsigned int)v7);
LABEL_88:
...
LABEL_79:
              ...
              CanCombineWithStartFirstPair = Normalization__CanCombineWithStartBase(a1, &v26, v18, (unsigned int)v7);
LABEL_83:
