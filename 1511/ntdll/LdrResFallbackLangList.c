...
LABEL_27:
    ...
    if ( (_DWORD)v15 )
    {
      ...
      if ( !v16 )
      {
        if ( !v6 )
          goto LABEL_35;
        if ( (int)RtlpResUltimateFallbackInfo(v6, a2, &SourceString, &v33, a4) < 0 )
          goto LABEL_34;
...
LABEL_35:
      ...
      if ( v17 )
      {
        ...
        if ( (_DWORD)v18 )
        {
          ...
          CurrentLocale = -4370;
          v25 = NtQueryDefaultLocale(0LL, &v32, a3, 0LL);
          a3 = v42;
          v6 = a1;
          v11 = v25;
          a2 = v41;
        ...
        else
        {
          LODWORD(v18) = 1;
          CurrentLocale = -4370;
          v26 = NtQueryDefaultLocale(v18, &v30, a3, 0LL);
          a3 = v42;
          v6 = a1;
          v11 = v26;
          a2 = v41;
