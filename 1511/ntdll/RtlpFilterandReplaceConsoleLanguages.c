...
__int64 __fastcall RtlpFilterandReplaceConsoleLanguages(__int64 a1, __int64 a2, __int64 a3, __int16 a4, __int64 *a5)
{
  ...
  __int64 v16[3]; // [rsp+48h] [rbp-B8h] BYREF
  ...
  *(_DWORD *)((char *)&v15.Buffer + 2) = 0;
  ...
  if ( !a1 || !a2 || !a5 || !*a5 )
    return 3221225485LL;
  LangFallbackList = LdrpCreateLangFallbackList(v16, a2, 25, 0);
...
LABEL_10:
      ...
      for ( i = 0; i < *(unsigned __int16 *)(v11 + 4); ++i )
      {
        *(_DWORD *)&v15.Length = 11141120;
        v15.Buffer = v17;
        LangFallbackList = GetNameFromLangListNode(a2, (_WORD *)(*(_QWORD *)(v11 + 24) + 6LL * i), &v15);
        if ( LangFallbackList < 0 )
          break;
