/*
 * XREFs of RtlpCheckRelativeDrive @ 0x18004D078
 * Callers:
 ...
 *     RtlSetThreadErrorMode @ 0x18004D200 (RtlSetThreadErrorMode.c)
...
NTSTATUS __fastcall RtlpCheckRelativeDrive(unsigned __int16 a1)
{
  NTSTATUS v2; // ebx
  ...
  *(_DWORD *)&Value.Length = 34078720;
  Value.Buffer = (unsigned __int16 *)&v13;
  ...
  else
  {
    ...
    Value.Buffer = (unsigned __int16 *)&v12;
