/*
 * XREFs of RtlpSetTimeZoneInformationWorker @ 0x1800DC2C8
 * Callers:
 *     RtlSetDynamicTimeZoneInformation @ 0x1800DC220 (RtlSetDynamicTimeZoneInformation.c)
 *     RtlSetTimeZoneInformation @ 0x1800DC230 (RtlSetTimeZoneInformation.c)
 * Callees:
