/*
 * XREFs of CsrpConnectToServer @ 0x1800520A4
 * Callers:
 ...
 *     ZwConnectPort @ 0x1800A63D0 (ZwConnectPort.c)
...
__int64 __fastcall CsrpConnectToServer(_WORD *Src, int a2, __int64 *a3, int a4, _DWORD *a5)
{
  ...
  if ( v10 > 0xFFFF )
    return 3221225734LL;
  word_1801459E2 = 2 * v9 + 28;
  Heap = (char *)RtlAllocateHeap(CsrHeap, NtdllBaseTag, v10);
  qword_1801459E8 = (__int64)Heap;
  v12 = Heap;
  if ( !Heap )
    return 3221225495LL;
  v13 = 2 * v9;
  ...
  *((_QWORD *)v15 + 2) = *(_QWORD *)L"ction";
  ...
  v36 = 48;
  CsrPortName = (_WORD)v15 - qword_1801459E8 + 26;
  v38 = &CsrPortName;
  v37 = 0LL;
  v39 = 64;
  v40 = 0LL;
  ...
  if ( v16 >= 0 )
  {
    ...
    *((_DWORD *)v15 + 2) = *(_DWORD *)L"ort";
    v15[6] = aApiport[6];
    CsrPortName = (_WORD)v15 - qword_1801459E8 + 14;
    v46 = 2;
    v47 = 257;
    v22 = 0x10000LL;
...
LABEL_24:
  RtlFreeHeap(CsrHeap, 0, qword_1801459E8);
