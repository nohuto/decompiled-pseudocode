/*
 * XREFs of RtlpTreeDoubleRotateNodes @ 0x18007DF2C
 * Callers:
 *     RtlAvlRemoveNode @ 0x18007D9E0 (RtlAvlRemoveNode.c)
 *     RtlAvlInsertNodeEx @ 0x18007DD70 (RtlAvlInsertNodeEx.c)
 * Callees:
 *     <none>
 */
