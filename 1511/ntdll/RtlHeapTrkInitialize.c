...
NTSTATUS __fastcall RtlHeapTrkInitialize(void *a1)
{
  ...
  if ( result >= 0 )
  {
    if ( !PerformanceFrequency.QuadPart )
      return -1073741823;
    dword_1801463E0 = *((_DWORD *)BaseAddress + 14);
    ...
    if ( !(unsigned __int8)RtlpHeapTrkAllocCacheAligned(&qword_180146360, &qword_180147310, 8LL, 16LL) )
      goto LABEL_27;
    qword_1801463A8 = (__int64)RtlAllocateHeap(HeapHandle, 0, 0x1EEF0uLL);
    if ( !qword_1801463A8 )
      goto LABEL_27;
    v4 = (char *)RtlAllocateHeap(HeapHandle, 0, 0x1EEF0uLL);
    qword_1801463A0 = (__int64)v4;
    if ( !v4 )
      goto LABEL_27;
    v5 = (_QWORD *)qword_1801463A8;
    v6 = 7919LL;
    SectionHandle = a1;
    v7 = qword_1801463A8 - (_QWORD)v4;
    dword_180145FB4 = 0;
    v8 = &v4[-qword_1801463A8];
    do
    {
