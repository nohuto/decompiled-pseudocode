/*
 * XREFs of RtlUpcaseUnicodeToOemN @ 0x1800799F0
 * Callers:
...
LABEL_35:
                v26 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 5) + v10));
                if ( v26 >= 0x61u )
                {
                  if ( v26 > 0x7Au )
                    v26 += *(_WORD *)(v15
              ...
              v27 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 4) + v10));
              if ( v27 >= 0x61u )
              {
                if ( v27 > 0x7Au )
                  v27 += *(_WORD *)(v15
            ...
            v28 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 3) + v10));
            if ( v28 >= 0x61u )
            {
              if ( v28 > 0x7Au )
                v28 += *(_WORD *)(v15
          ...
          v29 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 2) + v10));
          if ( v29 >= 0x61u )
          {
            if ( v29 > 0x7Au )
              v29 += *(_WORD *)(v15
        ...
        v30 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 1) + v10));
        if ( v30 >= 0x61u )
        {
          if ( v30 > 0x7Au )
            v30 += *(_WORD *)(v15
    ...
    if ( (_DWORD)v12 != 9 )
    {
      if ( (_DWORD)v12 != 10 )
      {
        if ( (_DWORD)v12 != 11 )
        {
          if ( (_DWORD)v12 != 12 )
          {
            if ( (_DWORD)v12 != 13 )
            {
              if ( (_DWORD)v12 != 14 )
              {
                ...
                v16 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 15) + v10));
                if ( v16 >= 0x61u )
                {
                  if ( v16 > 0x7Au )
                    v16 += *(_WORD *)(v15
                ...
                *(v13 - 15) = *(_BYTE *)(v16 + v10);
              }
              v17 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 14) + v10));
              if ( v17 >= 0x61u )
              {
                if ( v17 > 0x7Au )
                  v17 += *(_WORD *)(v15
              ...
              *(v13 - 14) = *(_BYTE *)(v17 + v10);
            }
            v18 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 13) + v10));
            if ( v18 >= 0x61u )
            {
              if ( v18 > 0x7Au )
                v18 += *(_WORD *)(v15
            ...
            *(v13 - 13) = *(_BYTE *)(v18 + v10);
          }
          v19 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 12) + v10));
          if ( v19 >= 0x61u )
          {
            if ( v19 > 0x7Au )
              v19 += *(_WORD *)(v15
          ...
          *(v13 - 12) = *(_BYTE *)(v19 + v10);
        }
        v20 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 11) + v10));
        if ( v20 >= 0x61u )
        {
          if ( v20 > 0x7Au )
            v20 += *(_WORD *)(v15
        ...
        *(v13 - 11) = *(_BYTE *)(v20 + v10);
      }
      v21 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 10) + v10));
      if ( v21 >= 0x61u )
      {
        if ( v21 > 0x7Au )
          v21 += *(_WORD *)(v15
                          ...
                          * ((v21 & 0xF)
                           + (unsigned int)*(unsigned __int16 *)(v15
                                                               + 2LL
                                                               * (((v21 >> 4) & 0xF)
                                                                + (unsigned int)*(unsigned __int16 *)(v15 + 2 * ((unsigned __int64)v21 >> 8))))));
        else
          v21 -= 32;
      }
      *(v13 - 10) = *(_BYTE *)(v21 + v10);
    }
    v22 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 9) + v10));
    if ( v22 >= 0x61u )
    {
      if ( v22 > 0x7Au )
        v22 += *(_WORD *)(v15
    ...
    *(v13 - 9) = *(_BYTE *)(v22 + v10);
LABEL_29:
    v23 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 8) + v10));
    if ( v23 >= 0x61u )
    {
      if ( v23 > 0x7Au )
        v23 += *(_WORD *)(v15
    ...
    *(v13 - 8) = *(_BYTE *)(v23 + v10);
LABEL_31:
    v24 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 7) + v10));
    if ( v24 >= 0x61u )
    {
      if ( v24 > 0x7Au )
        v24 += *(_WORD *)(v15
    ...
    *(v13 - 7) = *(_BYTE *)(v24 + v10);
LABEL_33:
    v25 = *(_WORD *)(v11 + 2LL * *(unsigned __int8 *)(*(v14 - 6) + v10));
    if ( v25 >= 0x61u )
    {
      if ( v25 > 0x7Au )
        v25 += *(_WORD *)(v15
  ...
  if ( v6 )
  {
    ...
    do
    {
      ...
      if ( NlsOemLeadByteInfoTable[HIBYTE(v40)] )
        v41 = *(_WORD *)(v38
                       + 2
                       * ((unsigned __int8)v40 + (unsigned __int64)(unsigned __int16)NlsOemLeadByteInfoTable[HIBYTE(v40)]));
      else
