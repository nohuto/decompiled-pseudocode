/*
 * XREFs of RtlpQueryFilesInAssemblyInformationActivationContextDetailedInformation @ 0x1800D2C08
 * Callers:
        ...
        size_t *a5)
{
  ...
  RtlpLocateActivationContextSectionForQuery(&v29, (int *)&v30, a3, a4, v5, 0x68uLL, a1, v28, 2u, &v31, &a5);
  if ( v29 == 2 )
    return v30;
  v12 = v31;
  v13 = a2[1];
...
LABEL_15:
  ...
  v18 = 3LL * v17;
  v19 = (_DWORD *)(v31 + *(unsigned int *)(v16 + 24LL * v17 + 12));
  if ( !v19 )
    return (unsigned int)-1072365547;
  v20 = 32LL;
  if ( *(_DWORD *)(v16 + 8 * v18 + 8) )
    v20 = *(unsigned int *)(v16 + 8 * v18 + 8) + 34LL;
  if ( v19[2] )
    v20 += (unsigned int)v19[2] + 2LL;
  if ( v20 > a4 )
  {
    if ( v5 )
      *v5 = v20;
  ...
  v21 = a3 + 8;
  *a3 = v19[1];
  a3[1] = *(_DWORD *)(v16 + 8 * v18 + 8);
  a3[2] = v19[2];
  *((_QWORD *)a3 + 2) = 0LL;
  *((_QWORD *)a3 + 3) = 0LL;
  if ( *(_DWORD *)(v16 + 8 * v18 + 8) )
  {
    memmove(a3 + 8, (const void *)(v12 + *(unsigned int *)(v16 + 8 * v18 + 4)), *(unsigned int *)(v16 + 8 * v18 + 8));
    *((_QWORD *)a3 + 2) = v21;
    v22 = (_WORD *)((char *)v21 + *(unsigned int *)(v16 + 8 * v18 + 8));
    *v22 = 0;
    v21 = v22 + 1;
  }
  if ( v19[2] )
  {
    if ( v19[4] )
    {
      v23 = v12 + 44LL * (unsigned int)v19[4];
      if ( v23 )
      {
        *((_QWORD *)a3 + 3) = v21;
        v24 = 0;
