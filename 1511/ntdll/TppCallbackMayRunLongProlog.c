/*
 * XREFs of TppCallbackMayRunLongProlog @ 0x180072898
 * Callers:
        ...
        signed __int32 *a5)
{
  ...
  v8 = *(_QWORD *)(a1 + 184);
  if ( v8 )
    v9 = *(volatile signed __int32 **)(v8 + 136);
  else
    v9 = *(volatile signed __int32 **)(a1 + 128);
  if ( !v9 )
    return 3221225485LL;
  if ( (volatile signed __int32 *)TppPoolpSerializedPool == v9 )
    return 3221225659LL;
  ...
  *(_DWORD *)(a1 + 72) = a2;
  if ( v14 )
    TppFastAlpcAdjustConcurrencyCount(v14);
  *a3 = v9;
  *a4 = v10;
  *a5 = v11;
  return 0LL;
