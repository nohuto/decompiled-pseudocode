/*
 * XREFs of LZNT1CompressChunk @ 0x180089EF4
 * Callers:
 *     RtlCompressBufferLZNT1 @ 0x180089E00 (RtlCompressBufferLZNT1.c)
 * Callees:
 *     RtlEndStrongEnumerationHashTable @ 0x180081AE0 (RtlEndStrongEnumerationHashTable.c)
 *     LZNT1FindMatchStandard @ 0x18008A1D0 (LZNT1FindMatchStandard.c)
...
LABEL_18:
  ...
  v22 = (unsigned int *)&unk_180102EAC;
  v30 = (unsigned int *)&unk_180102EAC;
  v23 = a4 + 2;
  do
  {
    if ( &Src[*v22] < v17 )
