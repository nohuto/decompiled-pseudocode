/*
 * XREFs of EvtIntReportEventWorker @ 0x18004819C
 * Callers:
 *     EvtIntReportEventAndSourceAsync @ 0x180048130 (EvtIntReportEventAndSourceAsync.c)
 *     EvtIntReportAuthzEventAndSourceAsync @ 0x1800F4830 (EvtIntReportAuthzEventAndSourceAsync.c)
 * Callees:
 *     RtlValidSid @ 0x180019A30 (RtlValidSid.c)
 *     RtlFreeHeap @ 0x1800207C0 (RtlFreeHeap.c)
 *     RtlAllocateHeap @ 0x1800255D0 (RtlAllocateHeap.c)
 *     RtlSetLastWin32Error @ 0x180048BE0 (RtlSetLastWin32Error.c)
 *     EtwEventWriteFull @ 0x180049BF0 (EtwEventWriteFull.c)
        ...
        __int64 a11)
{
  ...
  if ( v17 > 0x20 )
  {
    Heap = (_BYTE *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 8u, 16LL * v17);
    v48 = Heap;
    if ( !Heap )
    {
      v38 = 8;
  ...
  if ( v13 )
  {
    ...
    {
      v38 = 87;
      local_unwind(v51, &loc_1800484EC);
      goto LABEL_33;
    }
