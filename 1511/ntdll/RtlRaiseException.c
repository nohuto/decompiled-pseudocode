...
LABEL_5:
  if ( v9 < 2 )
  {
    ...
    v34 = *(_BYTE *)(Rip + 2) & 7;
    v11 = v34 | (8 * (*(_BYTE *)Rip & 1u));
    if ( !(v34 | (8 * (*(_BYTE *)Rip & 1))) || (_DWORD)v11 != (*(_BYTE *)(v8 + 3) & 0xF) )
      goto LABEL_8;
    v35 = v4 & 0xF8;
    if ( v35 != 96 )
    {
...
LABEL_36:
      ...
      {
        v61 = (_DWORD *)RtlpSameFunction(p_BeginAddress, v6, v40 + v6);
        if ( !v61 || v40 == *v61 )
        {
          Rsp = (DWORD64 *)ContextRecord.Rsp;
          goto LABEL_98;
...
LABEL_34:
        ...
        v54 = (unsigned __int8)v17[2];
        if ( (v54 & 1) != 0 )
          ++v54;
        ++v14;
        p_BeginAddress = (unsigned int *)&v17[2 * v54 + 4];
        if ( v14 > 0x20 )
      ...
      while ( 1 )
      {
        ...
        {
          v58 = RtlpUnwindOpSlots(*(_WORD *)&v17[2 * v15 + 4]);
          Rsp = (DWORD64 *)ContextRecord.Rsp;
          v15 = (unsigned int)(v58 + v15);
          goto LABEL_33;
        }
        v20 = v17[2 * v15 + 5] & 0xF;
        if ( v20 > 5 )
...
LABEL_141:
          ...
          else
          {
            ...
            v51 = (ULONGLONG *)(v63 + 16 * (unsigned int)*(unsigned __int16 *)&v17[2 * v15 + 4]);
            v52 = 2LL * (unsigned int)v19;
            *(&ContextRecord.Xmm0.Low + 2 * (unsigned int)v19) = *v51;
            v53 = v51[1];
          }
          *(&ContextRecord.Xmm0.High + v52) = v53;
        }
        else
        {
          if ( v20 == 5 )
...
LABEL_107:
  ...
  if ( !*(_BYTE *)(v8 + 2) )
    goto LABEL_17;
  v42 = HIBYTE(*(_WORD *)(v8 + 4));
  if ( (v42 & 0xF) != 6 )
    goto LABEL_17;
  v43 = *(unsigned __int8 *)(v8 + 4);
  v4 = (unsigned int)(Rip - v6);
  if ( (v42 & 0x10) == 0 || (v44 = p_BeginAddress[1] - v43, (unsigned int)v4 - v44 >= v43) )
  {
    v45 = *(unsigned __int8 *)(v8 + 2);
    for ( j = 1; j < v45; ++j )
    {
      v47 = HIBYTE(*(_WORD *)(v8 + 2LL * j + 4));
      if ( (v47 & 0xF) != 6 )
        break;
      v48 = *(unsigned __int8 *)(v8 + 2LL * j + 4) + ((unsigned __int8)v47 >> 4 << 8);
      if ( !v48 )
        break;
      v44 = p_BeginAddress[1] - v48;
      if ( (unsigned int)v4 - v44 < v43 )
        goto LABEL_136;
    }
    goto LABEL_17;
  }
LABEL_136:
  RtlpUnwindEpilogue(v6, (_DWORD)Rsp, v4 - v44, (_DWORD)p_BeginAddress, (__int64)&ContextRecord, 0LL, 0LL, 0LL);
LABEL_37:
  ...
  if ( !RtlDispatchException((__int64)v26, (__int64)&ContextRecord) )
  {
    v4 = 0LL;
LABEL_144:
