/*
 * XREFs of RtlpHpLfhSubsegmentWalk @ 0x180050388
 * Callers:
 ...
 *     RtlpHpLfhSubsegmentSizeBlockInternal @ 0x18004F200 (RtlpHpLfhSubsegmentSizeBlockInternal.c)
 */
...
__int64 __fastcall RtlpHpLfhSubsegmentWalk(__int64 a1, __int64 a2, __int64 a3, _DWORD *a4, _DWORD *a5, int *a6)
{
  ...
  else
  {
    ...
    if ( *(_DWORD *)(v26 + 72) )
    {
      v28 = (v27 * (unsigned __int64)*(unsigned int *)(v26 + 72)) >> *(_BYTE *)(v26 + 76);
      v29 = v27 - v28 * (unsigned __int16)v7;
    }
    else
    {
      v30 = *(_BYTE *)(v26 + 76);
