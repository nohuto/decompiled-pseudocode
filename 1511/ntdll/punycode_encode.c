/*
 * XREFs of punycode_encode @ 0x18006900C
 * Callers:
 *     RtlpNameprepAsciiWorker @ 0x180069B44 (RtlpNameprepAsciiWorker.c)
 * Callees:
 *     RtlStringCopyWorkerW @ 0x180001B08 (RtlStringCopyWorkerW.c)
 *     adapt @ 0x180002228 (adapt.c)
 *     FindLabelEnd @ 0x18006A9CC (FindLabelEnd.c)
 *     ValidateStd3Range @ 0x18008BD34 (ValidateStd3Range.c)
 *     _wcsnicmp @ 0x1800970B0 (_wcsnicmp.c)
 *     GetUTF32 @ 0x1800E7318 (GetUTF32.c)
 */
