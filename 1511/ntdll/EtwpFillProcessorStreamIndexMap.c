/*
 * XREFs of EtwpFillProcessorStreamIndexMap @ 0x1800F40C4
 * Callers:
...
__int64 __fastcall EtwpFillProcessorStreamIndexMap(__int64 a1, unsigned __int16 a2, __int64 a3, unsigned int a4)
{
  ...
  v13 = 0;
  v14 = 0;
  for ( j = Heap + 8LL * a2; v14 < a4; v14 += (*(unsigned __int16 *)(v14 + a3 + 4) + 7) & 0xFFFFFFF8 )
  {
    v16 = 0;
    for ( *(_QWORD *)(Heap + 8LL * v13) = j + 2LL * v12; (unsigned int)v16 < *(_DWORD *)(v14 + a3 + 44); ++v16 )
    {
      v17 = v12;
      *(_WORD *)(j + 2LL * v12) = v12;
      ++v12;
