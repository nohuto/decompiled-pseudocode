...
__int64 __fastcall sxsisol_SearchActCtxForDllName(__int128 *a1, char a2, _QWORD *a3, __int64 a4, unsigned __int16 *a5)
{
  ...
  volatile signed __int32 *v57; // [rsp+30h] [rbp-D0h]
  int v58; // [rsp+38h] [rbp-C8h] BYREF
  unsigned __int16 v59; // [rsp+3Ch] [rbp-C4h] BYREF
  ...
  *(_OWORD *)Src = v8;
  ...
  v57 = (volatile signed __int32 *)v64[7];
  if ( LODWORD(v64[2]) < 0x14
    || HIDWORD(v64[0]) != 1
    || (v14 = v64[1], v15 = v64[6], v16 = *(unsigned int *)(v64[1] + 16LL), (unsigned int)v16 > LODWORD(v64[6]))
...
LABEL_58:
  ...
  if ( (v64[8] & 0x200000000LL) != 0 )
    v20 |= 2u;
  AssemblyStorageRoot = RtlGetAssemblyStorageRoot(v20, v64[7], v64[8], (unsigned int)&v60, v56, (__int64)&v58);
  v11 = AssemblyStorageRoot;
  if ( AssemblyStorageRoot >= 0 )
  {
LABEL_26:
    v22 = 0;
    v23 = v64[5] + *(unsigned int *)(v14 + 16);
    *a3 = 0LL;
...
LABEL_39:
      ...
      if ( v24 )
      {
        ...
        while ( 1 )
        {
          ...
          v44 = (const void *)(v64[5] + *(unsigned int *)(v23 + 8 * v42 + 4));
          v45 = v43 + *a5 + 2LL;
          if ( v45 > 0xFFFE )
            break;
...
LABEL_70:
        ...
        if ( (*(_BYTE *)(v14 + 4) & 8) != 0 )
        {
          CharInUnicodeString = RtlFindCharInUnicodeString(1LL, Src, &RtlDosPathSeperatorsString, &v59);
          ...
          v35 = -2 - v59 + LOWORD(Src[0]);
          v34 = (char *)Src[1] + 2 * ((unsigned __int64)v59 >> 1) + 2;
        }
        else
        {
          v34 = (char *)Src[1];
