...
__int64 __fastcall RtlpHpTagContextGetTag(__int64 a1, unsigned __int64 a2)
{
  ...
  *((_QWORD *)&v13 + 1) = 0LL;
  *(_QWORD *)&v13 = NtCurrentTeb()->SubProcessTag;
  v3 = v13 - RtlpHpNullGUID;
  if ( (_QWORD)v13 == RtlpHpNullGUID )
    v3 = *((_QWORD *)&v13 + 1) - qword_180146270;
  if ( v3 )
  {
    v5 = &v13;
    v6 = 314159LL;
    ...
    do
    {
      ...
      v9 = (char *)(*((unsigned __int8 *)v5 - 3)
                  + 37
                  * (*((unsigned __int8 *)v5 - 4)
                   + 37
                   * (*((unsigned __int8 *)v5 - 5)
                    + 37 * (*((unsigned __int8 *)v5 - 6) + 37 * (*((unsigned __int8 *)v5 - 7) + 37 * (v8 + 37 * v6))))));
      v6 = *((unsigned __int8 *)v5 - 1) + 37 * (*((unsigned __int8 *)v5 - 2) + 37LL * (_QWORD)v9);
      --v7;
    }
    while ( v7 );
    if ( !a2 )
      a2 = 16LL;
    RtlAcquireSRWLockShared(&RtlpHpTagContext, v9, (__int64)v5, 0LL);
    Mapping = RtlpHpTagContextFindMapping((__int64)&RtlpHpTagContext, &v13, v6);
    if ( Mapping )
    {
    ...
    if ( !v4 )
      return (unsigned __int16)RtlpHpTagContextAllocateTag(v11, &v13, v6, a2);
  }
  else
  {
    return 0;
