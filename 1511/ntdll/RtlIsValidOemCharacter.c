/*
 * XREFs of RtlIsValidOemCharacter @ 0x1800E5B0C
 * Callers:
 *     GetNextWchar @ 0x1800E5344 (GetNextWchar.c)
 * Callees:
 *     <none>
 */
...
char __fastcall RtlIsValidOemCharacter(unsigned __int16 *a1)
{
  ...
  if ( NlsMbOemCodePageTag )
  {
    ...
    {
      v6 = (unsigned __int8)v5 + (unsigned __int64)(unsigned __int16)NlsOemLeadByteInfoTable[HIBYTE(v5)];
