...
LABEL_109:
  ...
  if ( (v3 & 0x1C00) == 0 )
    LOWORD(v3) = v3 | 0x800;
  if ( (v3 & 0x80u) == 0 )
    ProcessRegistryInfo = RtlpCreateProcessRegistryInfo((__int64 *)&v56, 6144LL, a3);
  else
    ProcessRegistryInfo = RtlpInitializeLangRegistryInfo((__int64 *)&v56);
