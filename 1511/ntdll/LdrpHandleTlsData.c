...
__int64 __fastcall LdrpHandleTlsData(__int64 a1)
{
  ...
  if ( !LdrpActiveThreadCount )
    return 0LL;
  v2 = RtlImageDirectoryEntryToData(*(PVOID *)(a1 + 48), 1u, 9u, &Size);
  if ( !v2 )
    return 0LL;
  ...
  TlsEntry = LdrpAllocateTlsEntry((_DWORD)v2, v31, (unsigned int)&Size, (unsigned int)&v26, (__int64)&v37);
  v27 = TlsEntry;
  if ( TlsEntry < 0 )
  {
    v23 = v31;
