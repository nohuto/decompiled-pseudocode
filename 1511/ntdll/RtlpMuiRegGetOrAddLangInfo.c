/*
 * XREFs of RtlpMuiRegGetOrAddLangInfo @ 0x1800EC074
 * Callers:
 ...
 * Callees:
 *     RtlpMuiRegGetLangInfoIndex @ 0x1800EBF3C (RtlpMuiRegGetLangInfoIndex.c)
...
__int64 __fastcall RtlpMuiRegGetOrAddLangInfo(__int64 *a1, __int64 a2, _WORD *a3)
{
  ...
  if ( LangInfoIndex < 0 )
  {
    ...
    if ( *(_WORD *)(v6 + 6) >= v9 )
    {
      ...
      if ( (int)v10 >= v9 )
        v6 = RtlpMuiRegResizeLanguages(v6, v10, v8);
      if ( !v6 )
        return 3221225495LL;
      *a1 = v6;
    }
