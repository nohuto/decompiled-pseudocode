/*
 * XREFs of RtlQueryInformationActivationContext @ 0x18000D770
 * Callers:
 ...
 *     RtlQueryInformationActiveActivationContext @ 0x180081B80 (RtlQueryInformationActiveActivationContext.c)
 * Callees:
...
LABEL_28:
  ...
  LoadedDllByHandle = LdrpFindLoadedDllByHandle(ActivationContext, &v21, &v23);
