...
LABEL_18:
        LOBYTE(v13) = 1;
        RtlpHeapRemoveListEntry(a1, (_DWORD)v17, v13, v11 + 16, v20, *(unsigned __int16 *)(v11 + 8));
      }
      *v12 = v14;
      *(_QWORD *)(v14 + 8) = v12;
      if ( (*(_BYTE *)(v11 + 10) & 8) == 0 || RtlpCommitBlock(a1, a3 + 16 * a7) )
      {
        ...
        *(_WORD *)(a3 + 8) = v24;
        *(_WORD *)(16 * v24 + a3 + 12) = *(_WORD *)(a1 + 140) ^ v24;
        *(_BYTE *)(a3 + 15) = 0;
        if ( !a5 )
        {
          *(_BYTE *)(a3 + 10) = 0;
          v25 = (_QWORD *)(a1 + 336);
          if ( *(_QWORD *)(a1 + 312) )
            Entry = (_QWORD *)RtlpFindEntry(a1, (unsigned __int16)v24);
          else
            Entry = (_QWORD *)*v25;
          if ( v25 != Entry )
          {
...
LABEL_67:
        ...
        v39 = (_QWORD *)(a1 + 336);
        if ( *(_QWORD *)(a1 + 312) )
          v40 = (_QWORD *)RtlpFindEntry(a1, (unsigned __int16)v24);
        else
          v40 = (_QWORD *)*v39;
        if ( v39 != v40 )
        {
  ...
  *(_BYTE *)(a3 + 15) = 0;
  if ( !a5 )
  {
    *(_BYTE *)(a3 + 10) = 0;
    v48 = (_QWORD *)(a1 + 336);
    if ( *(_QWORD *)(a1 + 312) )
      v49 = (_QWORD *)RtlpFindEntry(a1, (unsigned __int16)a7);
    else
      v49 = (_QWORD *)*v48;
    if ( v48 != v49 )
    {
...
LABEL_121:
  ...
  v58 = (_QWORD *)(a1 + 336);
  if ( *(_QWORD *)(a1 + 312) )
    v59 = (_QWORD *)RtlpFindEntry(a1, (unsigned __int16)a7);
  else
    v59 = (_QWORD *)*v58;
  if ( v58 != v59 )
  {
