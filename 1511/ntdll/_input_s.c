 ...
 *     ReadString_0 @ 0x1800A2000 (ReadString_0.c)
 *     ReadStringDelimited_0 @ 0x1800A21B4 (ReadStringDelimited_0.c)
 *     _inc_0 @ 0x1800A231C (_inc_0.c)
 */
...
__int64 __fastcall input_s(FILE *a1, unsigned __int8 *a2, _DWORD *a3)
{
  ...
  char v53; // [rsp+51h] [rbp-48h]
  char v54; // [rsp+52h] [rbp-47h]
  int v55; // [rsp+54h] [rbp-45h] BYREF
...
LABEL_171:
            ...
            if ( v32 == 123 )
            {
              v49 = ReadStringDelimited_0(v35, &v70, &v56, &v55, (__int64)&v67, v15, v29, v28, &v62);
              v4 = v70;
            }
            else
            {
              v49 = ReadString_0(v35, 0LL, &v56, &v55, (__int64)&v67, v15, v29, v28, &v62);
            }
            v5 = v56;
            if ( v49 )
              goto LABEL_190;
