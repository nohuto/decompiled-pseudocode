...
_DWORD *__fastcall LdrpGetRcConfig(__int64 a1, __int64 a2, char a3, char a4)
{
  ...
  unsigned int *v11; // [rsp+58h] [rbp-50h] BYREF
  ...
  if ( a4 )
  {
    result = (_DWORD *)LdrpGetFromMUIMemCache(a1, 0, 0LL, 8);
    v10 = result;
  ...
  v13[2] = 0LL;
  v13[0] = L"MUI";
  v8 = LdrpSearchResourceSection_U(a1, (__int64)v13, 3LL, 0x30u, (__int64 *)&v11);
  if ( v8 < 0 )
    goto LABEL_14;
  v8 = LdrpAccessResourceDataNoMultipleLanguage(a1, v11, (unsigned __int64 *)&v10, &v12);
  if ( v8 < 0 )
    goto LABEL_14;
  v9 = v10;
  if ( *v10 != -20054323 )
