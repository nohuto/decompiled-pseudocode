/*
 * XREFs of RtlActivateActivationContextEx @ 0x180042000
 * Callers:
 *     RtlActivateActivationContext @ 0x180041FB0 (RtlActivateActivationContext.c)
 * Callees:
        ...
        unsigned __int64 *a4)
{
  ...
  if ( a4 )
    *a4 = 0LL;
  v6 = (volatile signed __int32 *)&unk_180101268;
