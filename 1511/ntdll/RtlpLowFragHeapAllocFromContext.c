...
__int64 __fastcall RtlpLowFragHeapAllocFromContext(__int64 a1, unsigned __int16 a2, __int64 a3, char a4)
{
  ...
  __int64 v131; // rcx
  __int64 result; // rax
  signed __int32 v133[14]; // [rsp+0h] [rbp-B8h] BYREF
  volatile signed __int64 *v134; // [rsp+38h] [rbp-80h]
  signed __int64 v135; // [rsp+40h] [rbp-78h]
  unsigned __int16 *v136; // [rsp+48h] [rbp-70h]
  __int64 v137; // [rsp+50h] [rbp-68h]
  __int64 v138; // [rsp+58h] [rbp-60h]
  PSLIST_HEADER ListHead; // [rsp+60h] [rbp-58h]
  unsigned int v141; // [rsp+C8h] [rbp+10h]
  ...
  if ( v4 && (*((_BYTE *)v7 + 3) & 1) != 0 )
  {
    ...
    if ( (int)v6 < 0 || qword_1801433A8[(int)v6] != UniqueThread_low )
    {
      ...
      v141 = v10 & CurrentProcessorNumber;
...
LABEL_46:
        ...
        {
          if ( (a4 & 8) != 0 )
            memset((void *)(v38 + 16), 0, v138 - 8);
          v131 = v138 - a3;
          if ( (unsigned __int64)(v138 - a3) >= 0x3F )
          {
            *(_QWORD *)(v38 + 16LL * *v136) = v131;
            result = v38 + 16;
            *(_BYTE *)(v38 + 15) = -65;
          }
          else
...
LABEL_69:
        ...
        if ( v41 )
        {
          v48 = (union _SLIST_HEADER *)(*(_QWORD *)(*(_QWORD *)(v137 + 24)
                                                  + 8LL * *(unsigned __int16 *)(v13 + 172)
                                                  + 1192)
                                      + 144LL);
...
LABEL_76:
      ...
      v54 = 0LL;
      v55 = 0LL;
      v56 = (union _SLIST_HEADER *)(*(_QWORD *)(*(_QWORD *)(v137 + 24) + 8LL * *(unsigned __int16 *)(v13 + 172) + 1192)
                                  + 144LL);
...
LABEL_119:
    ...
    do
    {
      ...
      {
        v135 = v78 | 0x100000000LL;
      }
    }
    while ( v80 != _InterlockedCompareExchange64((volatile signed __int64 *)(a1 + 80), v135, v80) );
    if ( !v81 || v79 )
    {
      v82 = 3;
      if ( v79 )
    ...
    if ( (_BYTE)v86 == 18 || v77 >= 0x400 )
LABEL_173:
      v88 = 1;
    else
      v88 = 0;
    v89 = (unsigned __int16)RtlpBucketBlockSizes[*((unsigned __int8 *)v76 + 2)];
    v90 = (unsigned __int8)v86 - 7;
    v91 = a1 + 48 * (v90 + 2);
    ++*(_WORD *)(v91 + 28);
    v92 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)v91);
    if ( v92 )
    {
      ++*(_WORD *)(v91 + 32);
      goto LABEL_181;
    ...
    if ( (unsigned __int8)v86 > 7u
      && (v92 = RtlpInterlockedPopEntrySList((PSLIST_HEADER)(a1 + 48 * ((unsigned __int8)v86 - 8 + 2LL)))) != 0LL )
    {
LABEL_181:
      v93 = 1LL << LOBYTE(v92[1].Next);
      UserBlockFromHeap = (__int64)v92;
      if ( v93 > 0xF0000 )
        v93 = 983040LL;
      v95 = v93 + WORD1(v92[1].Next);
      if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
        RtlpLogHeapSubSegmentAllocCached(*(_QWORD *)(a1 + 24), v92, v95, v89 + 16);
      _InterlockedExchangeAdd64((volatile signed __int64 *)(a1 + 72), -(__int64)v95);
    }
    else
    {
      UserBlockFromHeap = RtlpAllocateUserBlockFromHeap(*(_QWORD *)(a1 + 24), (unsigned __int8)v86, v89 + 16, v88);
      if ( UserBlockFromHeap )
        _InterlockedIncrement((volatile signed __int32 *)(a1 + 48 * v90 + 112));
    }
    v96 = *(unsigned __int16 *)(v91 + 28);
    if ( v96 > 0x40 )
    {
      if ( v96 < *(unsigned __int16 *)(v91 + 30) + (*(unsigned __int16 *)(v91 + 30) >> 1)
        && *(unsigned __int16 *)(v91 + 32) < v96 - (v96 >> 1) )
      {
        v97 = *(_DWORD *)(v91 + 20);
        if ( v97 >= 2 )
        {
          v98 = *(_DWORD *)(v91 + 24);
          if ( v98 > 2 )
            _InterlockedCompareExchange((volatile signed __int32 *)(v91 + 24), v98 - 1, v98);
        }
        else
        {
          _InterlockedCompareExchange((volatile signed __int32 *)(v91 + 20), v97 + 1, v97);
        }
      }
      *(_WORD *)(v91 + 28) = 0;
      *(_WORD *)(v91 + 30) = 0;
    ...
    if ( !UserBlockFromHeap )
      return 0LL;
    v99 = 1LL << *(_BYTE *)(UserBlockFromHeap + 16);
    if ( v99 > 0xF0000 )
      v99 = 983040LL;
    v100 = v99 + *(unsigned __int16 *)(UserBlockFromHeap + 18);
    _InterlockedIncrement((volatile signed __int32 *)(a1 + 56));
    v101 = RtlpInterlockedPopEntrySList(ListHead);
    if ( v101 )
    {
      p_Next = &v101[-3].Next;
    }
    ...
    {
      v102 = RtlpLowFragHeapAllocateFromZone(a1, v141);
      p_Next = (_QWORD *)v102;
      if ( !v102 )
        break;
      *(_QWORD *)(v102 + 8) = 0LL;
    ...
    {
      v104 = (__int64)v136;
      *((_BYTE *)p_Next + 43) = v141;
      RtlpSubSegmentInitialize(
        a1,
        (_DWORD)p_Next,
        UserBlockFromHeap,
        (unsigned __int16)RtlpBucketBlockSizes[*(unsigned __int8 *)(v104 + 2)],
        v100,
        v104);
      ...
      *(_DWORD *)(UserBlockFromHeap + 20) = -253701952;
      do
      {
        v105 = *((_DWORD *)p_Next + 11);
        if ( !v105 || (v105 & 6) != 0 )
          goto LABEL_213;
      }
      while ( v105 != _InterlockedCompareExchange((volatile signed __int32 *)p_Next + 11, v105 | 6, v105) );
      v106 = (_QWORD *)*p_Next;
      if ( *p_Next != v13 )
      {
        ...
        if ( !RtlpIsSubSegmentReuseable((__int64)v106, (__int64)p_Next) )
          goto LABEL_213;
        do
        {
          v115 = *((_DWORD *)p_Next + 11);
          if ( !v115 || (v115 & 2) != 0 )
            goto LABEL_213;
        }
        while ( v115 != _InterlockedCompareExchange((volatile signed __int32 *)p_Next + 11, v115 | 2, v115) );
        v116 = (_QWORD *)*p_Next;
        v117 = 0;
        while ( 1 )
        {
          v118 = ((_BYTE)v117 + (unsigned __int8)*((_WORD *)v116 + 87)) & 0xF;
          v119 = (__int64 **)v116[v118 + 2];
          v120 = &v116[v118];
          if ( v119 )
          {
            if ( (*((_DWORD *)v119 + 11) & 1) == 0
              && v119 == (__int64 **)_InterlockedCompareExchange64(
                                       v120 + 2,
                                       (signed __int64)p_Next,
                                       (signed __int64)v119) )
            {
              _m_prefetchw((char *)v119 + 44);
              if ( _InterlockedAnd((volatile signed __int32 *)v119 + 11, 0xFFFFFFFD) == 2 )
              {
                v108 = **v119;
                *v119 = 0LL;
                v107 = v119 + 6;
LABEL_212:
                RtlpInterlockedPushEntrySList(v108, v107);
              }
              do
              {
LABEL_213:
                v109 = *((_DWORD *)p_Next + 11);
                if ( !v109 || (v109 & 2) != 0 )
                  goto LABEL_9;
              }
              while ( v109 != _InterlockedCompareExchange((volatile signed __int32 *)p_Next + 11, v109 | 2, v109) );
              v110 = (_QWORD *)*p_Next;
              for ( i = 0; i < 0x10; ++i )
              {
                v112 = ((_BYTE)i + (unsigned __int8)*((_WORD *)v110 + 87)) & 0xF;
                v113 = (__int64 **)v110[v112 + 2];
                v114 = &v110[v112];
                if ( v113 )
                {
                  if ( (*((_DWORD *)v113 + 11) & 1) == 0
                    && v113 == (__int64 **)_InterlockedCompareExchange64(
                                             v114 + 2,
                                             (signed __int64)p_Next,
                                             (signed __int64)v113) )
                  {
                ...
                else if ( !_InterlockedCompareExchange64(v114 + 2, (signed __int64)p_Next, 0LL) )
                {
                  goto LABEL_9;
                }
              }
...
LABEL_120:
          ...
          else if ( !_InterlockedCompareExchange64(v120 + 2, (signed __int64)p_Next, 0LL) )
          {
            goto LABEL_213;
          }
          ...
          {
            v107 = p_Next + 6;
            v108 = *(_QWORD *)(*(_QWORD *)(*(_QWORD *)*p_Next + 24LL)
      ...
      v121 = _InterlockedExchange64((volatile __int64 *)(v13 + 8), (__int64)p_Next);
      if ( v121 )
      {
        _m_prefetchw((const void *)(v121 + 44));
        v122 = *(_DWORD *)(v121 + 44);
        do
        {
          v123 = v122;
          v122 = _InterlockedCompareExchange((volatile signed __int32 *)(v121 + 44), v122 & 0xFFFFFFF9, v122);
        }
        while ( v123 != v122 );
        if ( v122 == 6 )
        {
          v124 = **(_QWORD **)v121;
          *(_QWORD *)v121 = 0LL;
          RtlpInterlockedPushEntrySList(v124, v121 + 48);
          continue;
        }
        if ( *(_WORD *)(v121 + 32) && !(unsigned __int8)RtlpIsSubSegmentReuseThresholdExceeded(v13, v121) )
        {
          do
          {
            v125 = *(_DWORD *)(v121 + 44);
          ...
          while ( v125 != _InterlockedCompareExchange((volatile signed __int32 *)(v121 + 44), v125 | 2, v125) );
          v126 = *(unsigned __int16 **)v121;
          for ( j = 0; j < 0x10; ++j )
          {
            v128 = ((_BYTE)j + (unsigned __int8)v126[87]) & 0xF;
            v113 = *(__int64 ***)&v126[4 * v128 + 8];
            v129 = &v126[4 * v128];
            if ( v113 )
            {
              if ( (*((_DWORD *)v113 + 11) & 1) == 0
              ...
              {
LABEL_260:
                _m_prefetchw((char *)v113 + 44);
                if ( _InterlockedAnd((volatile signed __int32 *)v113 + 11, 0xFFFFFFFD) == 2 )
                {
                  v130 = **v113;
                  *v113 = 0LL;
                  RtlpInterlockedPushEntrySList(v130, v113 + 6);
                }
                goto LABEL_9;
              }
            }
            else if ( !_InterlockedCompareExchange64((volatile signed __int64 *)v129 + 2, v121, 0LL) )
            {
              goto LABEL_9;
            }
          }
          v67 = *(unsigned __int16 **)v121;
          v68 = (_QWORD *)(v121 + 48);
          goto LABEL_120;
        }
      }
  ...
  RtlpFreeUserBlock(a1, (__int64 *)UserBlockFromHeap);
  return 0LL;
}
