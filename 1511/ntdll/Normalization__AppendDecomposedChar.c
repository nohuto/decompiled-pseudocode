/*
 * XREFs of Normalization__AppendDecomposedChar @ 0x18006A9FC
 * Callers:
...
__int64 __fastcall Normalization__AppendDecomposedChar(__int64 a1, int a2, __int64 a3)
{
  ...
  for ( j = v6 & 0x1FFF; v10 > 0; ++j )
  {
    ...
    if ( (unsigned int)(v13 - 55296) <= 0x7FF )
    {
      ++j;
      --v10;
      v13 = (unsigned int)*(unsigned __int16 *)(v12 + 2LL * j) + (((_DWORD)v13 - 55287) << 10);
    }
    LOBYTE(a3) = *(_BYTE *)(((__int64)(int)v13 >> 7) + *(_QWORD *)(a1 + 32));
