...
unsigned __int64 __fastcall RtlpHpAllocateHeap(__int64 a1, size_t a2, int a3, __int16 a4)
{
  ...
  if ( (v5 & 0x1000000) == 0 )
  {
    ...
    {
      v5 |= 8u;
      if ( (int)RtlpCallInterceptRoutine(v9, a1, 0, 1, (__int64)&v21) < 0 )
      {
        v10 = 0LL;
LABEL_5:
        v20 = 0;
LABEL_6:
  ...
  if ( v10 < a2 || a2 > 0x7FFFFFFFFFFFFFFFLL )
    goto LABEL_5;
  v13 = RtlpHpAllocateHeapInternal(a1, a2, v10, v5 & 0x13000003, &v20);
  v11 = v13;
  if ( v13 )
  {
    if ( (v5 & 0x30000F08) != 0 )
    {
      v15 = RtlpHpExtrasAppend(a1, v13, a2, v14, v21, v5, a4);
      v17 = v15;
      if ( v9 )
      {
        *(_BYTE *)(v15 + 2) &= 0xF0u;
        *(_BYTE *)(v15 + 2) |= v9 & 0xF;
        ...
        if ( (int)RtlpCallInterceptRoutine(v9, a1, v18, 2, v17 + 16) < 0 )
        {
          RtlFreeHeap(a1, 0, v11);
          goto LABEL_6;
        }
      }
    }
...
LABEL_7:
  if ( MEMORY[0x7FFE0380] && (NtCurrentPeb()->TracingFlags & 1) != 0 )
    RtlpLogHeapAllocateEvent(a1, v11, v10);
  return v11;
}
