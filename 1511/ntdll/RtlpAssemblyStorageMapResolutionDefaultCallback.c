...
char __fastcall RtlpAssemblyStorageMapResolutionDefaultCallback(int a1, __int64 a2, _DWORD *a3)
{
  ...
  _BYTE v30[12]; // [rsp+90h] [rbp-70h] BYREF
  unsigned int v31; // [rsp+9Ch] [rbp-64h]
  ...
  if ( !v5 )
  {
    ...
    LOBYTE(v9) = DbgPrintEx(51LL, 0LL, "SXS: Unable to open registry key %wZ Status = 0x%08lx\n", &unk_180101470, v14);
    *(_BYTE *)(a2 + 56) = 1;
    goto LABEL_41;
  }
  v6 = v5 - 1;
    ...
    if ( *(_QWORD *)(a2 + 8) == 1LL )
    {
      ...
      *(_WORD *)(a2 + 24) = 0;
      ...
      else
      {
        ...
        v9 = *(_QWORD *)(a2 + 32);
        *(_OWORD *)((unsigned __int16)Length + v9) = *(_OWORD *)L"\\WinSxS\\";
        *(_WORD *)(a2 + 24) = Length + 16;
      }
      return v9;
    }
    LOBYTE(v9) = -1;
    if ( *(_QWORD *)(a2 + 8) > 0xFFFFFFFFuLL || (v16 = *(HANDLE *)a2, v17 = *(_DWORD *)(a2 + 8), v20 = 0, !v16) )
    {
      *(_BYTE *)(a2 + 17) = 1;
      return v9;
    }
    LODWORD(v9) = ((__int64 (__fastcall *)(HANDLE, _QWORD, _QWORD, _BYTE *, int, int *))NtEnumerateKey)(
                    v16,
                    (unsigned int)(v17 - 2),
                    0LL,
                    v30,
