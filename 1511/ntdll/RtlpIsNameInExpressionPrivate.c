/*
 * XREFs of RtlpIsNameInExpressionPrivate @ 0x1800E7754
 * Callers:
 ...
 *     RtlDoesNameContainWildCards @ 0x1800E765C (RtlDoesNameContainWildCards.c)
 */
...
char __fastcall RtlpIsNameInExpressionPrivate(unsigned __int16 *a1, unsigned __int16 *a2, char a3, __int64 a4)
{
  ...
  _QWORD v55[2]; // [rsp+60h] [rbp-98h] BYREF
  ...
  if ( **((_WORD **)a1 + 1) != 42 )
    goto LABEL_17;
  v12 = *(__m128i *)a1;
  v55[0] = v12.m128i_i64[0];
  LOWORD(v55[0]) = v12.m128i_i16[0] - 2;
  v55[1] = _mm_srli_si128(v12, 8).m128i_u64[0] + 2;
  if ( RtlDoesNameContainWildCards((unsigned __int16 *)v55) )
  {
    v8 = a1;
LABEL_17:
    v57[0] = 0;
...
LABEL_18:
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        {
          v53 = *v8 >> 1;
          Heap = (char *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, 8LL * (unsigned int)(v53 + 1));
          v9 = (unsigned __int64)Heap;
          if ( !Heap )
            RtlRaiseStatus(-1073741801);
          v8 = a1;
          v21 = v49;
          *(_OWORD *)Heap = *(_OWORD *)v19;
          v32 = *((_OWORD *)v19 + 1);
          v19 = Heap;
          v33 = &Heap[2 * (2 * v53 + 2)];
          *((_OWORD *)Heap + 1) = v32;
