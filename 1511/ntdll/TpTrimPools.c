...
LABEL_25:
    ...
    RtlAcquireSRWLockExclusive((unsigned __int64)(v17 + 18), v22, v23, v24);
    v44 = 0;
    v13 = 1;
    if ( (int)NtSetInformationWorkerFactory(*((_QWORD *)v17 + 7), 12LL, &v44) >= 0 && v44 )
    {
      v25 = 0;
