...
LABEL_26:
    ...
    if ( Heap )
    {
      ...
      *(_DWORD *)(v19 + 80) = 3;
      v49 = v19;
      v50 = 0;
      v21 = NtSetInformationProcess(-1LL, 53LL, &v49, 16LL);
      if ( (v21 & 0x80000000) != 0 )
      {
        if ( qword_1801552F0 )
      ...
      else
      {
        ...
        RtlAcquireSRWLockExclusive((unsigned __int64)&RtlpDynamicFunctionTableLock, v24, v25, v26);
        for ( i = (__int64 *)RtlpDynamicFunctionTable; i != &RtlpDynamicFunctionTable; i = (__int64 *)*i )
        {
          if ( a5 < i[5] && a6 > i[4] )
          {
            if ( i[4] != a5 || i[5] != a6 )
            {
              ...
              v50 = 1;
              NtSetInformationProcess(-1LL, 53LL, &v49, 16LL);
              if ( qword_1801552F0 )
              ...
              if ( qword_1801552F0 )
              {
                RtlAcquireSRWLockExclusive((unsigned __int64)&LdrpMrdataLock, v44, v45, v46);
        ...
        *a1 = v19;
        if ( !qword_1801552F0 )
          return v21;
        RtlAcquireSRWLockExclusive((unsigned __int64)&LdrpMrdataLock, v32, v33, v34);
        v35 = *(_DWORD *)LdrpMrdataHeapUnprotected;
        if ( !*(_DWORD *)LdrpMrdataHeapUnprotected )
        {
          RtlReleaseSRWLockExclusive(&LdrpMrdataLock);
