/*
 * XREFs of EtwpFinalizeRelogFileHeaderStats @ 0x1800F4648
 * Callers:
...
__int64 __fastcall EtwpFinalizeRelogFileHeaderStats(__int64 a1, __int64 a2, unsigned int a3, int a4, int a5)
{
  ...
  {
    *(_DWORD *)(v6 + a2 + 68) = a4 + *(_DWORD *)(*(_QWORD *)(a1 + 520) + 12 * v5);
    *(_DWORD *)(v6 + a2 + 80) += *(_DWORD *)(*(_QWORD *)(a1 + 520) + 12 * v5 + 4);
    *(_DWORD *)(v6 + a2 + 308) += a5 + *(_DWORD *)(*(_QWORD *)(a1 + 520) + 12 * v5 + 8);
    if ( !(_DWORD)v5 )
    {
      ++*(_DWORD *)(v6 + a2 + 68);
