/*
 * XREFs of RtlInitializeNtUserPfn @ 0x1800954D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlInitializeNtUserPfn(_OWORD *a1, __int64 a2, _OWORD *a3, __int64 a4, __int64 a5, __int64 a6)
{
  ...
  *(_OWORD *)off_180155170 = *(_OWORD *)a5;
  *(_OWORD *)off_180155180 = *(_OWORD *)(a5 + 16);
  *(_OWORD *)off_180155190 = *(_OWORD *)(a5 + 32);
  *(_OWORD *)off_1801551A0 = *(_OWORD *)(a5 + 48);
