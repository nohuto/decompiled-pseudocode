/*
 * XREFs of _handle_error @ 0x18009D630
 * Callers:
 *     atan @ 0x180097610 (atan.c)
 *     atan2 @ 0x180097880 (atan2.c)
 *     ceil @ 0x180098160 (ceil.c)
 *     cos @ 0x180098280 (cos.c)
 *     sin @ 0x1800986A0 (sin.c)
 *     floor @ 0x180098C80 (floor.c)
 *     log @ 0x180098EB0 (log.c)
 *     sqrt @ 0x180099C80 (sqrt.c)
 *     tan @ 0x18009AB40 (tan.c)
 *     _pow_special @ 0x18009E790 (_pow_special.c)
 * Callees:
 *     __security_check_cookie @ 0x180095840 (__security_check_cookie.c)
 *     _call_matherr @ 0x18009D504 (_call_matherr.c)
 *     _exception_enabled @ 0x18009D570 (_exception_enabled.c)
 *     _raise_exc @ 0x18009E0EC (_raise_exc.c)
