/*
 * XREFs of RtlpHeapTrkInterceptor @ 0x180094F10
 * Callers:
...
LABEL_11:
    if ( a2 )
    {
      ...
      else if ( dword_1801463E0 == 2 )
      {
        ...
        v10 = CurrentProcessorNumber < dword_1801463D8 ? CurrentProcessorNumber : 0;
        v11 = (unsigned int)v10;
        v12 = **(_DWORD **)(qword_1801463B8 + 8 * v10);
        v13 = (MEMORY[0x7FFE0320] * (unsigned __int64)MEMORY[0x7FFE0004]) >> 24;
        if ( (unsigned int)(v13 - v12) >= 0x3E8
          && v12 == _InterlockedCompareExchange(
                      *(volatile signed __int32 **)(qword_1801463B8 + 8LL * (unsigned int)v10),
                      v13,
                      v12) )
        {
