...
_QWORD *__fastcall RtlpHeapTrkTrackRemoveHeap(__int64 a1, char *a2, __int64 a3, __int64 a4)
{
  ...
  {
    v6 = v5 & 0xF;
    RtlAcquireSRWLockExclusive(*(_QWORD *)(qword_180146358 + 8 * v6), a2, a3, a4);
    v7 = (_QWORD *)(16LL * v5 + qword_1801463A8);
    v8 = (_QWORD *)*v7;
    while ( v8 != v7 )
    {
      v9 = v8[2] == a1;
    ...
    RtlReleaseSRWLockExclusive(*(volatile signed __int64 **)(qword_180146358 + 8 * v6));
    ++v5;
  }
  while ( v5 < 0x1EEF );
  while ( 1 )
  {
    ...
    *(_QWORD *)(v16 + 8) = v17;
    ...
    RtlFreeHeap(qword_1801463C0, 0, v14);
  }
  return result;
}
