        ...
        PLARGE_INTEGER Timeout)
{
  ...
  NTSTATUS v18; // eax
  unsigned int v20; // [rsp+54h] [rbp-5C4h]
  HANDLE TargetHandle; // [rsp+58h] [rbp-5C0h] BYREF
  HANDLE SnapshotHandle; // [rsp+60h] [rbp-5B8h] BYREF
  HANDLE v23; // [rsp+68h] [rbp-5B0h] BYREF
  HANDLE SectionHandle; // [rsp+70h] [rbp-5A8h] BYREF
  HANDLE EventHandle; // [rsp+78h] [rbp-5A0h] BYREF
  HANDLE Handle; // [rsp+80h] [rbp-598h] BYREF
  __int64 v27; // [rsp+88h] [rbp-590h] BYREF
  int v28; // [rsp+90h] [rbp-588h] BYREF
  LARGE_INTEGER MaximumSize; // [rsp+98h] [rbp-580h] BYREF
  unsigned int v30; // [rsp+A0h] [rbp-578h]
  PVOID v31; // [rsp+A8h] [rbp-570h]
  int v32; // [rsp+B0h] [rbp-568h]
  PVOID BaseAddress; // [rsp+B8h] [rbp-560h] BYREF
  PLARGE_INTEGER Timeouta; // [rsp+C0h] [rbp-558h]
  HANDLE Handles[2]; // [rsp+C8h] [rbp-550h] BYREF
  ULONG_PTR ViewSize; // [rsp+D8h] [rbp-540h] BYREF
  _QWORD v37[2]; // [rsp+E0h] [rbp-538h] BYREF
  _OBJECT_ATTRIBUTES ObjectAttributes; // [rsp+F0h] [rbp-528h] BYREF
  __int64 v39; // [rsp+120h] [rbp-4F8h]
  __int64 v40; // [rsp+128h] [rbp-4F0h]
  _BYTE ThreadInformation[24]; // [rsp+130h] [rbp-4E8h] BYREF
  __int64 v42; // [rsp+148h] [rbp-4D0h]
  char v43; // [rsp+160h] [rbp-4B8h] BYREF
  _QWORD v44[4]; // [rsp+5D0h] [rbp-48h] BYREF
  ...
  *(_OWORD *)&ObjectAttributes.SecurityDescriptor = 0LL;
  ...
  if ( (int)RtlQueryResourcePolicy(0, 0, (__int64)&v28, 4LL) < 0 || v28 > 10 )
  {
    SnapshotHandle = &v43;
