/*
 * XREFs of RtlpGetLengthWithoutLastPathElement @ 0x18006EA74
 * Callers:
 *     RtlGetLengthWithoutLastFullDosOrNtPathElement @ 0x18006EA60 (RtlGetLengthWithoutLastFullDosOrNtPathElement.c)
 * Callees:
