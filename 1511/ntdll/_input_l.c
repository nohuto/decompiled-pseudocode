/*
 * XREFs of _input_l @ 0x18009EBE0
 * Callers:
 *     <none>
 * Callees:
 *     _invalid_parameter @ 0x180095768 (_invalid_parameter.c)
 *     isleadbyte @ 0x180098D88 (isleadbyte.c)
...
__int64 __fastcall input_l(FILE *Stream, unsigned __int8 *a2, __int64 a3, __int64 a4)
{
  ...
  unsigned int v66; // [rsp+78h] [rbp+7h] BYREF
  int v67; // [rsp+7Ch] [rbp+Bh]
  __int64 *v68; // [rsp+80h] [rbp+Fh]
  char SrcCh[8]; // [rsp+88h] [rbp+17h] BYREF
  __int64 v70; // [rsp+90h] [rbp+1Fh]
...
LABEL_171:
      ...
      if ( v30 == 123 )
      {
        v47 = ReadStringDelimited(v33, &v72, &v59, &v57, SrcCh, v31, Stream, &v66);
        v5 = v72;
      }
      else
      {
        v47 = ReadString(v33, 0LL, &v59, &v57, SrcCh, v31, Stream, &v66);
      }
      v7 = v59;
      v4 = 0;
      if ( !v47 )
