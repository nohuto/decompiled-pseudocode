/*
 * XREFs of RtlCreateSystemVolumeInformationFolder @ 0x180087F00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RtlCreateSystemVolumeInformationFolder(unsigned __int16 *a1)
{
  ...
  unsigned __int16 *v21; // [rsp+F8h] [rbp+6Fh] BYREF
  unsigned __int16 *v22; // [rsp+100h] [rbp+77h] BYREF
  ...
  Heap = (unsigned __int16 *)RtlAllocateHeap((__int64)NtCurrentPeb()->ProcessHeap, 0, (unsigned __int16)(v2 + 2));
  v11.Buffer = Heap;
  if ( !Heap )
    return 3221225626LL;
