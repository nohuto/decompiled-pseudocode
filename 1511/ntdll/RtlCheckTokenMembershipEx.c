/*
 * XREFs of RtlCheckTokenMembershipEx @ 0x18005E3A0
 * Callers:
 *     RtlCapabilityCheck @ 0x18005DE30 (RtlCapabilityCheck.c)
 *     RtlCheckTokenMembership @ 0x1800D6D60 (RtlCheckTokenMembership.c)
 * Callees:
  ...
  if ( (a3 & 0xFFFFFFFE) == 0 )
  {
    ...
    else
    {
      ...
      if ( v9 == -1073741700 )
      {
        ...
        v24[0] = 12;
        v25 = 1;
        v9 = NtDuplicateToken(Handle, 12LL, &v17, 0LL, 2, &v12);
        NtClose(Handle);
      }
      if ( v9 < 0 )
      {
