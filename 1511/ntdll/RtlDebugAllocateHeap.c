/*
 * XREFs of RtlDebugAllocateHeap @ 0x180092580
 * Callers:
...
__int64 __fastcall RtlDebugAllocateHeap(_DWORD *Src, unsigned int a2, unsigned __int64 a3)
{
  ...
  {
    v6 = (__int64 (__fastcall *)(_DWORD *, _QWORD, unsigned __int64))qword_1801420C0;
...
LABEL_33:
  ...
  if ( (v17->NtGlobalFlag & 0x800) != 0 && v21 && v21 == word_180143628 && *((_WORD *)Src + 104) == word_18014362A )
  {
    if ( NtCurrentPeb()->Ldr )
      DbgPrint("HEAP[%wZ]: ", &NtCurrentPeb()->Ldr->InLoadOrderModuleList.Flink[5].Blink);
    else
