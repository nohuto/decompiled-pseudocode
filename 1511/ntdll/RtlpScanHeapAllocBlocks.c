/*
 * XREFs of RtlpScanHeapAllocBlocks @ 0x1800E4828
 * Callers:
...
char RtlpScanHeapAllocBlocks()
{
  ...
  for ( j = RtlpLeakList; (__int64 *)j != &RtlpLeakList; j = *(_QWORD *)j )
  {
    ...
    if ( BlockInfo )
    {
      if ( qword_180143AA8 )
      {
        ...
        ((void (__fastcall *)(_QWORD, _QWORD, _QWORD, SIZE_T, _DWORD, _QWORD))qword_180143AA8)(
          0LL,
          *(_QWORD *)(v14 + 8),
          *(_QWORD *)(j + 16),
          v15,
  ...
  if ( qword_180143AA8 )
    ((void (__fastcall *)(_QWORD, _QWORD, _QWORD, _QWORD, _DWORD, _QWORD))qword_180143AA8)(0LL, 0LL, 0LL, 0LL, 0, 0LL);
  return 1;
}
