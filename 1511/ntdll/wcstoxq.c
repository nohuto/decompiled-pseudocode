/*
 * XREFs of wcstoxq @ 0x180097264
 * Callers:
 *     _wcstoi64 @ 0x180097200 (_wcstoi64.c)
 *     _wcstoui64 @ 0x180097230 (_wcstoui64.c)
 * Callees:
 *     _errno @ 0x180082280 (_errno.c)
 *     _invalid_parameter @ 0x180095768 (_invalid_parameter.c)
 *     _iswctype_l @ 0x180098E50 (_iswctype_l.c)
 *     _wchartodigit @ 0x18009D0BC (_wchartodigit.c)
 */
