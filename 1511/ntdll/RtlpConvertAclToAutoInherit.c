        ...
        _DWORD *a9)
{
  ...
  ACCESS_MASK v61; // [rsp+A0h] [rbp-70h] BYREF
  ...
  PVOID BaseAddress; // [rsp+D8h] [rbp-38h] BYREF
  __int64 v70; // [rsp+E0h] [rbp-30h] BYREF
  int v71; // [rsp+E8h] [rbp-28h] BYREF
  _DWORD *v72; // [rsp+F0h] [rbp-20h]
  __int64 v73; // [rsp+F8h] [rbp-18h]
  __int64 v74; // [rsp+100h] [rbp-10h]
  ...
  *a8 = 0LL;
  ...
  v16 = RtlpInheritAcl(
          ...
          GenericMapping,
          2,
          (unsigned __int64)&v70 & -(__int64)(v70 != 0),
          v70 != 0,
          &BaseAddress,
          &v62,
          &v71);
...
LABEL_60:
            ...
            v61 = *((_DWORD *)v28 + 1);
            RtlMapGenericMask(&v61, GenericMapping);
            if ( *v28 <= 0xAu && _bittest(&v22, *v28) )
              v29 = GenericMapping->GenericAll & v61;
            else
              v29 = (GenericMapping->GenericAll | 0x1000000) & v61;
            v18 = 0LL;
            if ( v29 )
            {
              v30 = v28[1] & 3;
              ...
              if ( v30 | ~v28[1] & 8 )
              {
                ...
                if ( v9->AceCount )
                {
                  ...
                  do
                  {
                    v35 = RtlpCompareAces(v28, (unsigned __int8 *)v19, (void *)v73, (void *)v74);
                    v18 = 0LL;
                    if ( v35 )
                    {
                      v29 &= ~*(v34 - 3);
