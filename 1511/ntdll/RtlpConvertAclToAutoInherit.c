/*
 * XREFs of RtlpConvertAclToAutoInherit @ 0x1800D7628
 * Callers:
 ...
 *     RtlpCompareAces @ 0x1800D7484 (RtlpCompareAces.c)
 */
        ...
        _DWORD *a9)
{
  ...
  unsigned __int8 *v67; // [rsp+C0h] [rbp-50h] BYREF
  int v68; // [rsp+C8h] [rbp-48h]
  int v69; // [rsp+CCh] [rbp-44h]
  unsigned __int64 v70; // [rsp+D0h] [rbp-40h]
  unsigned __int64 v71; // [rsp+D8h] [rbp-38h] BYREF
  __int64 v72; // [rsp+E0h] [rbp-30h] BYREF
  int v73; // [rsp+E8h] [rbp-28h] BYREF
  _DWORD *v74; // [rsp+F0h] [rbp-20h]
  _WORD *v75; // [rsp+F8h] [rbp-18h]
  _WORD *v76; // [rsp+100h] [rbp-10h]
  ...
  *a8 = 0LL;
  ...
  v16 = RtlpInheritAcl(
          ...
          (__int64)a7,
          2,
          (unsigned __int64)&v72 & -(__int64)(v72 != 0),
          v72 != 0,
          &v71,
          v63,
          &v73);
...
LABEL_60:
            ...
            if ( v29 )
            {
              ...
              if ( v30 | ~v28[1] & 8 )
              {
                ...
                if ( v9[2] )
                {
                  ...
                  do
                  {
                    v35 = RtlpCompareAces(v28, (unsigned __int8 *)v19, v75, v76);
                    v18 = 0LL;
                    if ( v35 )
                    {
                      v29 &= ~*(v34 - 3);
        ...
        v43 = v67;
        ProcessHeap = v65;
        v44 = RtlAllocateHeap((__int64)v65, NtdllBaseTag + 1310720, v38 + (unsigned int)*((unsigned __int16 *)v67 + 1));
        v10 = v66;
        *v66 = v44;
        if ( !v44 )
          goto LABEL_101;
        ...
        if ( (int)RtlCreateAcl(v44, v38 + (unsigned int)*((unsigned __int16 *)v43 + 1), v45) >= 0 )
        {
          ...
          v55 = (unsigned __int64)v67;
          memmove(v47, v67 + 8, (unsigned int)*((unsigned __int16 *)v43 + 1) - 8);
          v10 = v66;
          v13 = v70;
...
LABEL_105:
  ...
  if ( v67 )
    RtlFreeHeap((__int64)ProcessHeap, 0, (unsigned __int64)v67);
  return (unsigned int)v15;
}
