...
LABEL_8:
    ...
    else
    {
      ...
      v36 = (v35
          ...
          / (v32 * v35 + v33);
      v29 = v36 + qword_180103CF0[v30] - (0.333333333332241 - v36 * v36 * 0.1999991803898914) * (v36 * v36) * v36;
    }
    if ( v27 )
    {
      v31 = *(double *)&qword_18013F058 - v31;
      v29 = *(double *)&qword_18013F060 - v29;
    }
    if ( v6 )
    {
      v31 = *(double *)&qword_18013F048 - v31;
      v29 = *(double *)&qword_18013F050 - v29;
    }
    v37 = v31 + v29;
    if ( v7 )
      *(_QWORD *)&v37 ^= _xmm;
