...
__int64 __fastcall LdrAddDllDirectory(unsigned __int16 *a1, __int64 *a2)
{
  ...
  v6 = RtlDosPathNameToRelativeNtPathName(0, 0, (__m128i *)a1, 0LL, &v20, 0LL, 0LL, 0LL);
  if ( v6 >= 0 )
  {
    v22 = 48;
    v23 = 0LL;
  ...
  *(_WORD *)(v8 + 16) = *a1;
  RtlAcquireSRWLockExclusive((unsigned __int64)&LdrpDllDirectoryLock, v9, v10, v11);
  v12 = *a1 + (unsigned __int16)word_180142080 + 2;
  v19[16] = v12;
  if ( v12 > 0xFFFE )
  {
    local_unwind(v27, &loc_1800C75C4);
LABEL_12:
    __fastfail(3u);
  }
  word_180142080 = v12;
  ...
  *(_QWORD *)(v8 + 8) = &LdrpUserDllDirectories;
  ...
  RtlAcquireSRWLockExclusive((unsigned __int64)&RtlpCachedPathLock, v14, v15, v16);
