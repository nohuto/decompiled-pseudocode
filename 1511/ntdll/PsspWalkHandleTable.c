/*
 * XREFs of PsspWalkHandleTable @ 0x18008A7C0
 * Callers:
 *     PsspCaptureHandleInformation @ 0x18008A588 (PsspCaptureHandleInformation.c)
 * Callees:
 *     RtlEndStrongEnumerationHashTable @ 0x180081AE0 (RtlEndStrongEnumerationHashTable.c)
 *     PsspDumpObject_Event @ 0x18008AD40 (PsspDumpObject_Event.c)
 *     __security_check_cookie @ 0x180095840 (__security_check_cookie.c)
 *     _wcsicmp @ 0x180096F90 (_wcsicmp.c)
 *     NtClose @ 0x1800A52A0 (NtClose.c)
 *     ZwQueryObject @ 0x1800A52C0 (ZwQueryObject.c)
...
void __fastcall PsspWalkHandleTable(
        ...
        unsigned int a3,
        int a4,
        unsigned __int8 (__fastcall *a5)(__int64, _QWORD, _QWORD, __int64, unsigned __int64, unsigned __int64, unsigned __int64, unsigned __int64, int),
        __int64 a6)
{
  unsigned int v7; // ebx
  char v8; // di
  ...
  unsigned __int8 (__fastcall *v20)(__int64, _QWORD, _QWORD, __int64, unsigned __int64, unsigned __int64, unsigned __int64, unsigned __int64, int); // [rsp+70h] [rbp-90h]
  ...
  if ( a3 )
  {
    while ( 1 )
    {
      ...
      v14 = 0;
      v15 = 0;
      if ( (int)ZwDuplicateObject(a1, v9, -1LL, &Handle, 0, 0, 2) < 0 )
        goto LABEL_20;
      v10 = 4;
...
LABEL_22:
    ...
    if ( (v8 & 0x10) != 0 && (int)ZwQueryObject(Handle, 0LL, v25, 56LL, 0LL) >= 0 )
      v10 = 20;
    v15 = 0;
    if ( (v8 & 0x20) != 0 )
    {
      v12 = 0;
      v13 = (const wchar_t **)&off_180111210;
      ...
      if ( ((int (__fastcall *)(HANDLE, _BYTE *, __int64, int *))*(&funcs_18008A975 + 3 * v12))(Handle, v26, 64LL, &v15) >= 0 )
      {
        if ( v15 )
        {
          v10 |= 0x20u;
          v14 = (char)(&off_180111210)[3 * v12 + 1];
        }
      }
    }
LABEL_19:
...
LABEL_20:
    ...
    if ( !v20(
            ...
            *a2,
            v11,
            (unsigned __int64)v23 & -(__int64)((v10 & 4) != 0),
