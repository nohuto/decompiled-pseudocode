/*
 * XREFs of EtwpWriteToPrivateBuffers @ 0x180049FD4
 * Callers:
    ...
    *(_GUID *)(v29 + 64) = ActivityId;
    ...
    if ( Src )
    {
      ...
      *(_DWORD *)(v45 + 1) = 12;
      ...
      v49 = v45 + 4;
      v50 = v46;
      memmove(v45 + 4, v33, v46);
      memset((char *)v49 + v50, 0, v48);
      *(_WORD *)(v30 + 4) |= 1u;
      v51 = v79;
      v32 = *v79 + v68;
      v68 = v32;
    ...
    if ( v73 )
    {
      ...
      *(_DWORD *)(v52 + 1) = 11;
      v52[3] = v53;
      v85 = v52 + 4;
      memset((char *)v52 + v53 + 8, 0, (unsigned __int16)(v54 - v53 - 8));
      *(_WORD *)(v30 + 4) |= 1u;
      v68 = *v52 + v32;
      if ( v17 )
        v17[2] |= 1u;
    ...
    if ( a8 )
    {
      ...
      do
      {
        ...
        if ( v38 )
        {
          if ( v38 == 1 )
          {
            v43 = *((unsigned int *)v34 - 1);
            v44 = (char *)v85;
            memmove(v85, *(const void **)(v34 - 12), v43);
            v85 = &v44[v43];
          }
          else if ( v38 == 3 && v37 == 8 )
          {
