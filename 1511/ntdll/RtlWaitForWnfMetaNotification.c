/*
 * XREFs of RtlWaitForWnfMetaNotification @ 0x18004EFC0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_9:
      ...
      if ( v8 >= 0 )
      {
        ...
        v14 = 0;
        v15 = EventHandle;
        v8 = RtlRegisterForWnfMetaNotification(&v12, StateName.Data[0], a2, (int)RtlpWnfMetaCallbackProc, (__int64)&v14);
        if ( v8 >= 0 )
        {
