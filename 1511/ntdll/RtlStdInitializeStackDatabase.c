/*
 * XREFs of RtlStdInitializeStackDatabase @ 0x1800E9300
 * Callers:
...
LABEL_16:
    ...
    *(_QWORD *)(a1 + 184) = *(_QWORD *)(a1 + 168);
    if ( *(_BYTE *)(a1 + 128) )
    {
      memset((void *)(a1 + 728), 0, 16LL * *(unsigned int *)(a1 + 720));
    }
    else
    {
    ...
    v12 = 208LL;
    v13 = 32LL;
    *(_QWORD *)(a1 + 160) = a1 + v11;
    *(_QWORD *)(a1 + 120) = *(_QWORD *)(a1 + 160);
    do
    {
      RtlInitializeSListHead((PSLIST_HEADER)(v12 + a1));
      v12 += 16LL;
      --v13;
    }
    while ( v13 );
  ...
  v18 = (v9 + 4095) & 0xFFFFFFFFFFFFF000uLL;
