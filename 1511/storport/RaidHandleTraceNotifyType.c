/*
 * XREFs of RaidHandleTraceNotifyType @ 0x1C0030368
 * Callers:
 ...
 *     PortTraceErrorWritePacket @ 0x1C003DDC0 (PortTraceErrorWritePacket.c)
 *     PortTraceErrorFreeDriver @ 0x1C0059A98 (PortTraceErrorFreeDriver.c)
 */
