/*
 * XREFs of RaidUnitCompleteResetRequest @ 0x1C0033F70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidUnitCompleteResetRequest(const struct _TlgProvider_t *a1, __int64 a2, __int64 a3, __int64 a4)
{
  ...
  if ( v12 == 16 && (unsigned int)dword_1C0048030 > 5 && TlgKeywordOn(a1, 0x400000000000uLL) )
  {
    v15 = *(_QWORD *)(v7 + 24);
    v16 = v15 + 5192;
    v24 = *(_DWORD *)(v15 + 56);
    ...
    v37 = 1LL;
    v39 = 1LL;
    TlgWrite(v13, &unk_1C0040212, (LPCGUID)(v7 + 1688), v14, 9u, &v25);
  }
