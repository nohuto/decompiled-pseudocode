/*
 * XREFs of RaidRegisterPerfStates @ 0x1C002D3B8
 * Callers:
 ...
 *     RaidGetStorPoFxPerfState @ 0x1C00293B4 (RaidGetStorPoFxPerfState.c)
 *     RaidValidatePerfSets @ 0x1C002DDC8 (RaidValidatePerfSets.c)
 */
