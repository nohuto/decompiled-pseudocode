/*
 * XREFs of DeviceIdShimHookDeviceControl @ 0x1C003C480
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall DeviceIdShimHookDeviceControl(__int64 a1, __int64 a2)
{
      ...
      if ( (*v6 & 0x1F) == 0xD && *((_DWORD *)v5 + 6) == 2954240 )
      {
        ...
        if ( v8 )
        {
          if ( !v8[1] && *v8 == 2 && (unsigned int)v9 >= 8 )
          {
            ...
            (*(void (__fastcall **)(__int64, __int64, void *, __int64))(qword_1C00480D8 + 8))(
              a1,
              a2,
  ...
  v10 = (*(__int64 (__fastcall **)(_QWORD, _BYTE *))qword_1C00480D8)(*(_QWORD *)(a1 + 8), v6);
  return (*(__int64 (__fastcall **)(__int64, __int64))(v10 + 8 * v7 + 32))(a1, a2);
}
