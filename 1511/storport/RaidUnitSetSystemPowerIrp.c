/*
 * XREFs of RaidUnitSetSystemPowerIrp @ 0x1C0007E80
 * Callers:
...
__int64 __fastcall RaidUnitSetSystemPowerIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 192) = EaLength;
  ...
  {
    WPP_SF_qqD(WPP_GLOBAL_Control->AttachedDevice, 57LL, &WPP_bd41b0a71fae7a1a3137e05edf146d17_Traceguids, a1, a2, v12);
  }
  return v12;
}
