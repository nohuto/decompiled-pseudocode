/*
 * XREFs of RaidAdapterDeferredRoutine @ 0x1C00147E0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     RaidFreeDeferredItem @ 0x1C0014920 (RaidFreeDeferredItem.c)
 ...
 *     RaidAdapterRequestTimer @ 0x1C002487C (RaidAdapterRequestTimer.c)
 *     WPP_SF_ddd @ 0x1C0027818 (WPP_SF_ddd.c)
 *     RaidUnitProcessAsyncNotification @ 0x1C0034ACC (RaidUnitProcessAsyncNotification.c)
 *     StorSetIoGatewayNotBusy @ 0x1C003691C (StorSetIoGatewayNotBusy.c)
 */
...
LABEL_52:
  ...
  if ( v8 )
  {
    ...
    HighPart = a2[4].HighPart;
    v24 = HighPart;
    v13 = RaidAdapterFindUnit(v3, HighPart);
    v14 = v13;
    if ( !v13 )
    {
      v15 = WPP_GLOBAL_Control;
...
LABEL_24:
    ...
    if ( KeCancelTimer((PKTIMER)(v13 + 792)) && (unsigned int)RaidResumeUnitQueue(v14) )
