/*
 * XREFs of RaUnitStorageQueryDeviceProtocolSpecificPropertyIoctl @ 0x1C0033350
 * Callers:
...
LABEL_14:
    ...
    if ( Length < IrpCount + (unsigned __int64)HIDWORD(MasterIrp->AssociatedIrp.SystemBuffer) + 8 )
      goto LABEL_5;
    v9 = RaBuildQueryProtocolSpecificPropertyBufferForMiniport(*(_QWORD *)(a1 + 8), (__int64)a2, &P, &v15);
    if ( v9 < 0 )
    {
      v3 = (unsigned int *)P;
    }
    ...
    {
      v3 = (unsigned int *)P;
      v9 = RaidUnitSendSrbIoControlSynchronously(v5, (_DWORD)a2, (_DWORD)P, v15, 0LL);
      if ( v9 >= 0 )
      {
        *(_DWORD *)&MasterIrp->Type = 48;
        *(_DWORD *)(&MasterIrp->Size + 1) = 48;
