/*
 * XREFs of Template_pqqccc @ 0x1C002C130
 * Callers:
...
NTSTATUS Template_pqqccc(__int64 a1, __int64 a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 1LL;
  v14 = 1LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventPortPauseDevice, 0LL, 6u, &UserData);
}
