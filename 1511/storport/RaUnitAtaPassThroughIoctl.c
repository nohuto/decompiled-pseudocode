 ...
 *     RaUnitSetAtaPassThroughCdb @ 0x1C0001498 (RaUnitSetAtaPassThroughCdb.c)
  ...
  if ( (*(_DWORD *)(*(_QWORD *)(*(_QWORD *)(a1 + 24) + 528LL) + 184LL) & 2) != 0 )
  {
    ...
    if ( Status >= 0 )
    {
      ...
      if ( IoIs32bitProcess(a2) )
      {
        ...
        v39 = v25->AssociatedIrp.MasterIrp;
        v38 = *(&v25->Flags + 1);
        v36 = v26;
        v37 = v27;
      }
...
LABEL_13:
  ...
  if ( StorEtwLoggingEnabled )
  {
    ...
    if ( ((__int64)WPP_MAIN_CB.Dpc.DpcData & 0x80000) != 0 )
      Template_pq(v23, &EventNonReadWriteRequestComplete, P, a2, Status);
  }
