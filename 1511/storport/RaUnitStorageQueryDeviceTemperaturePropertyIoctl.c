/*
 * XREFs of RaUnitStorageQueryDeviceTemperaturePropertyIoctl @ 0x1C0033514
 * Callers:
...
LABEL_16:
  ...
  v9 = RaBuildQueryTemperaturePropertyBufferForMiniport(*(_QWORD *)(a1 + 8), (__int64)a2, &P, &v12);
  if ( v9 < 0 )
  {
    v3 = (char *)P;
  }
  ...
  {
    v3 = (char *)P;
    v9 = RaidUnitSendSrbIoControlSynchronously(a1, (_DWORD)a2, (_DWORD)P, v12, 0LL);
