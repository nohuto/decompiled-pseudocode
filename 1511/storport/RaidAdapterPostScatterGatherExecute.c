/*
 * XREFs of RaidAdapterPostScatterGatherExecute @ 0x1C0005330
 * Callers:
 ...
 *     RaAllocateConcurrentChannelToken @ 0x1C0007650 (RaAllocateConcurrentChannelToken.c)
...
LABEL_73:
    *(_BYTE *)(v6 + 3) = 5;
    RaidAdapterRequestComplete(v7, a2);
    return 0LL;
  }
  if ( *(int *)(v3 + 428) > 0 )
  {
...
LABEL_10:
  ...
  *(_BYTE *)(a2 + 16) = *(_BYTE *)(a2 + 16) & 0xE3 | 0xC;
  ...
  if ( *(_BYTE *)(v7 + 4450) )
  {
    ...
    {
      RaidAdapterReleaseInterruptLock(v7, *(unsigned __int8 *)(((unsigned __int64)&v40 & 0xFFFFFFFFFFFFFFC0uLL) + 0x20));
    }
  }
  if ( (qword_1C0048010 & 4) != 0 && *(_DWORD *)(v7 + 5060) && *(_QWORD *)(v7 + 5064) )
  {
