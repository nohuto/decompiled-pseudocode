/*
 * XREFs of Template_qcc @ 0x1C0035F48
 * Callers:
...
NTSTATUS __fastcall Template_qcc(__int64 a1, __int64 a2, __int64 a3, int a4, char a5, char a6)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v10 = &a6;
  v11 = 1LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, &EventTargetReset, 0LL, 3u, &UserData);
}
