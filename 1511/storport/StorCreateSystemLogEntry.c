/*
 * XREFs of StorCreateSystemLogEntry @ 0x1C00315CC
 * Callers:
 *     StorpLogSystemEvent @ 0x1C002BA58 (StorpLogSystemEvent.c)
 * Callees:
 *     memmove @ 0x1C0015B80 (memmove.c)
 *     memset @ 0x1C0015EC0 (memset.c)
 *     RaidScsiErrorToIoError @ 0x1C00313B8 (RaidScsiErrorToIoError.c)
 *     RtlStringCchCopyW @ 0x1C00313F8 (RtlStringCchCopyW.c)
 *     RtlStringCchLengthW @ 0x1C0031470 (RtlStringCchLengthW.c)
 */
