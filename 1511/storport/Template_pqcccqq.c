/*
 * XREFs of Template_pqcccqq @ 0x1C002F57C
 * Callers:
...
NTSTATUS Template_pqcccqq(__int64 a1, const EVENT_DESCRIPTOR *a2, __int64 a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v14 = 4LL;
  v16 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, a2, 0LL, 7u, &UserData);
}
