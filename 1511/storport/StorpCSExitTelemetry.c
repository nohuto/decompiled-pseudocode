/*
 * XREFs of StorpCSExitTelemetry @ 0x1C0038794
 * Callers:
...
void __fastcall StorpCSExitTelemetry(__int64 a1)
{
  ...
  if ( a1 )
  {
    ...
    if ( *(_QWORD *)(a1 + 5088) )
    {
      ...
      if ( (unsigned int)dword_1C0048030 > 5 && TlgKeywordOn(v6, 0x400000000000uLL) )
      {
        v37 = *(_DWORD *)(a1 + 56);
        v10 = *(_QWORD *)(v9 + 8);
        v45 = v8;
        ...
        v126 = 8LL;
        v128 = 4LL;
        TlgWrite(v11, &unk_1C00405F8, v7, v8, 0x11u, &pData);
      }
    }
    ...
    for ( i = *(__int64 **)(a1 + 120); i != (__int64 *)(a1 + 120); i = (__int64 *)*i )
    {
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 6)) )
      {
        v13 = i[208];
        if ( v13 )
          i[209] += (v2 - v13) / 0x2710uLL;
        v14 = i[210];
        if ( v14 )
          i[211] += (v2 - v14) / 0x2710uLL;
        v15 = (const struct _TlgProvider_t *)i[207];
        if ( v15 )
        ...
        if ( (unsigned int)dword_1C0048030 > 5 )
        {
          if ( TlgKeywordOn(v15, 0x400000000000uLL) )
          {
            ...
            v95 = 8LL;
            v97 = 4LL;
            TlgWrite(v20, &unk_1C00411B0, (LPCGUID)1, v16, 0x17u, &v55);
          }
        }
        ExReleaseRundownProtectionCacheAware((PEX_RUNDOWN_REF_CACHE_AWARE)i[175]);
      }
      *(__int64 *)((char *)i + 1716) = 0LL;
      *(__int64 *)((char *)i + 1724) = 0LL;
    }
