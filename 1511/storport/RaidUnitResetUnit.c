/*
 * XREFs of RaidUnitResetUnit @ 0x1C003511C
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetLun @ 0x1C00382F0 (StorpAggregateHierarchicalResetLun.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0048030 > 5 )
      {
        ...
        v45 = 1LL;
        v47 = 8LL;
        TlgWrite((TraceLoggingHProvider)(v22 + 5192), &unk_1C0040283, v17, v18, 0xAu, &pData);
      }
