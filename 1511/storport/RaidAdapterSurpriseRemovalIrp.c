/*
 * XREFs of RaidAdapterSurpriseRemovalIrp @ 0x1C0057390
 * Callers:
 ...
 *     RaidAdapterMarkChildrenMissing @ 0x1C0024194 (RaidAdapterMarkChildrenMissing.c)
...
NTSTATUS __fastcall RaidAdapterSurpriseRemovalIrp(__int64 a1, IRP *a2)
{
  ...
  *(_DWORD *)(a1 + 88) = 5;
  ...
  if ( (unsigned int)dword_1C0048030 > 5 && TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
  {
    v21 = 0;
    v24 = 0;
    v27 = 0;
    ...
    v29 = 1;
    v32 = 4;
    TlgWrite((TraceLoggingHProvider)4, &unk_1C003FCB7, v9, v10, 7u, &pData);
  }
