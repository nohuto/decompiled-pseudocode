/*
 * XREFs of StorpLogPerAdapterStatistics @ 0x1C0038E94
 * Callers:
...
void __fastcall StorpLogPerAdapterStatistics(__int64 a1)
{
  ...
  if ( ((_DWORD)v2
     ...
     || *(_DWORD *)(a1 + 5248)
     || *(_DWORD *)(a1 + 5260))
    && (unsigned int)dword_1C0048030 > 5
    && TlgKeywordOn(v2, 0x400000000000uLL) )
  {
    v20 = *(_DWORD *)(a1 + 56);
    v26[0] = *(_DWORD *)(a1 + 5216);
    v12 = *(_BYTE *)(a1 + 5220);
    v16 = *(_DWORD *)(a1 + 5224);
    v24 = *(_DWORD *)(a1 + 5228);
    v14 = *(_BYTE *)(a1 + 5232);
    ...
    v59 = 4LL;
    v61 = 1LL;
    TlgWrite(v3, &unk_1C0040495, v4, v5, 0x13u, &pData);
  }
    ...
    && TlgKeywordOn(v6, 0x400000000000uLL) )
  {
    ...
    v59 = 4LL;
    v61 = 1LL;
    TlgWrite(v7, &unk_1C0040D2A, v8, v9, 0x13u, &pData);
  }
