/*
 * XREFs of RaidAdapterPowerDownDeviceCompletion @ 0x1C00094E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall RaidAdapterPowerDownDeviceCompletion(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 25LL, &WPP_bd41b0a71fae7a1a3137e05edf146d17_Traceguids, v2, a2);
  }
  if ( *(_BYTE *)(a2 + 65) )
