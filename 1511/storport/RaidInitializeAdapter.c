/*
 * XREFs of RaidInitializeAdapter @ 0x1C0051794
 * Callers:
 ...
 *     StorpInitializeAdapterTelemetry @ 0x1C0014224 (StorpInitializeAdapterTelemetry.c)
 *     RaGetBusInterface @ 0x1C001441C (RaGetBusInterface.c)
 *     PortGetLinkTimeoutValue @ 0x1C00144B8 (PortGetLinkTimeoutValue.c)
 *     RaidAllocateDeviceProperty @ 0x1C0014524 (RaidAllocateDeviceProperty.c)
    ...
    *(UUID *)(a1 + 5192) = Uuid;
    ...
    if ( (unsigned int)dword_1C0048030 > 5 )
    {
      if ( TlgKeywordOn(v27, 0x400000000000uLL) )
      {
        ...
        v63 = 4LL;
        v65 = 4LL;
        TlgWrite(v28, &unk_1C003FC2B, v29, v30, 8u, &pData);
      }
    }
    KeInitializeDpc(
