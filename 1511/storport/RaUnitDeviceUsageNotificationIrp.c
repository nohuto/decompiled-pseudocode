/*
 * XREFs of RaUnitDeviceUsageNotificationIrp @ 0x1C000D4F0
 * Callers:
 ...
 *     RaidSecondaryDumpRegister @ 0x1C0014938 (RaidSecondaryDumpRegister.c)
...
LABEL_8:
  ...
  if ( CurrentStackLocation->Parameters.Create.Options == 4 )
  {
    ...
    if ( (unsigned int)dword_1C0048030 > 5 && TlgKeywordOn(v9, 0x400000000000uLL) )
    {
      ...
      v41 = 1LL;
      v43 = 1LL;
      TlgWrite(v16, &unk_1C004014B, v17, v18, 8u, &pData);
    }
  }
LABEL_9:
