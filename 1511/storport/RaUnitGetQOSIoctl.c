/*
 * XREFs of RaUnitGetQOSIoctl @ 0x1C0032070
 * Callers:
...
__int64 __fastcall RaUnitGetQOSIoctl(__int64 a1, IRP *a2)
{
  ...
  if ( a2->Tail.Overlay.CurrentStackLocation->Parameters.Read.Length >= 0x24 )
  {
    ...
    *(_DWORD *)(&MasterIrp->Size + 1) = 36;
    LOBYTE(MasterIrp->MdlAddress) = *(_BYTE *)(a1 + 2528);
    LODWORD(MasterIrp->ThreadListEntry.Flink) = *(_DWORD *)(a1 + 2540);
    HIDWORD(MasterIrp->MdlAddress) = *(_DWORD *)(a1 + 2532);
    *(&MasterIrp->Flags + 1) = 1000 * *(_DWORD *)(a1 + 2544);
    v6 = *(_DWORD *)(a1 + 2536);
    if ( v6 == -1 )
    ...
    v5 = 0;
    MasterIrp->AssociatedIrp.IrpCount = 1000 * *(_DWORD *)(a1 + 2548);
