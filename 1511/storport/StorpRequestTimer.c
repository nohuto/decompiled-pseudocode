/*
 * XREFs of StorpRequestTimer @ 0x1C00064C0
 * Callers:
        ...
        unsigned __int64 a6)
{
  ...
  if ( !a1 || !a2 || !a3 )
  {
    ...
    {
      WPP_SF_qqq(WPP_GLOBAL_Control->AttachedDevice, 72LL, &WPP_a7c96fc4c7d54bab161cb0c6c8756061_Traceguids, a1, a2, a3);
    }
    return 3238002694LL;
  }
  v10 = **(_DWORD ***)(a1 - 16);
  ...
  if ( !*(_QWORD *)a2 || *v11 )
  {
    ...
    v9 = a2;
LABEL_27:
    WPP_SF_q(v15->AttachedDevice, v16, &WPP_a7c96fc4c7d54bab161cb0c6c8756061_Traceguids, v9);
    return 3238002694LL;
  }
  if ( a5 )
  {
