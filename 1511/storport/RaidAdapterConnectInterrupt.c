/*
 * XREFs of RaidAdapterConnectInterrupt @ 0x1C0012B84
 * Callers:
 *     RaidAdapterStartMiniport @ 0x1C0012798 (RaidAdapterStartMiniport.c)
 * Callees:
 *     RaidGetResourceListInterrupt @ 0x1C0012E68 (RaidGetResourceListInterrupt.c)
...
__int64 __fastcall RaidAdapterConnectInterrupt(__int64 a1)
{
  ...
  if ( *v2 && *(_QWORD *)(a1 + 288) )
  {
    ...
    WPP_SF_(v10->AttachedDevice, v11, &WPP_187a9a52e0a035763cd3db40300053e1_Traceguids, v6);
    return ResourceListInterrupt;
  }
  return 0LL;
}
