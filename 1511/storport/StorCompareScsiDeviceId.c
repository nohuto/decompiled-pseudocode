/*
 * XREFs of StorCompareScsiDeviceId @ 0x1C000CED8
 * Callers:
 *     StorCompareScsiIdentity @ 0x1C000CD54 (StorCompareScsiIdentity.c)
 * Callees:
 *     StorGetNextVPDIdDescriptor @ 0x1C000D018 (StorGetNextVPDIdDescriptor.c)
 *     StorInitVPDIdEnumeration @ 0x1C000D05C (StorInitVPDIdEnumeration.c)
