/*
 * XREFs of RaidSelectDeviceDumpCollectionMode @ 0x1C000F7D4
 * Callers:
 ...
 *     RaidRegGetDeviceDumpSupportLevel @ 0x1C001008C (RaidRegGetDeviceDumpSupportLevel.c)
 *     RaidRegGetDeviceDumpMaxSize @ 0x1C00100F8 (RaidRegGetDeviceDumpMaxSize.c)
