/*
 * XREFs of Template_pcxxpc @ 0x1C0037D1C
 * Callers:
...
NTSTATUS Template_pcxxpc(__int64 a1, const EVENT_DESCRIPTOR *a2, const GUID *a3, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v12 = 8LL;
  v14 = 1LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, a2, a3, 6u, &UserData);
}
