/*
 * XREFs of RaUnitRequestPowerUp @ 0x1C0008EC4
 * Callers:
...
__int64 __fastcall RaUnitRequestPowerUp(__int64 a1)
{
  ...
  else
  {
    ...
    if ( v2 == 259 )
    {
      ...
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 63LL, &WPP_bd41b0a71fae7a1a3137e05edf146d17_Traceguids, v4);
      }
      *(_BYTE *)(a1 + 144) |= 0x80u;
      KeReleaseInStackQueuedSpinLock(&LockHandle);
    ...
    else
    {
      ...
      {
        WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 62LL, &WPP_bd41b0a71fae7a1a3137e05edf146d17_Traceguids, v5);
      }
