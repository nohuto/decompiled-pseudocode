/*
 * XREFs of RaidPnPPassToMiniPort @ 0x1C0010A08
 * Callers:
...
__int64 __fastcall RaidPnPPassToMiniPort(__int64 a1, __int64 a2, char a3, __int64 a4, int a5)
{
  ...
  *(_QWORD *)(v13 + 176) = *((_QWORD *)Srb + 6);
  ...
  RaSrbSetMiniportContext(v5, Srb, BaseAddress + 1056, 0LL);
  if ( **(_DWORD **)(a1 + 64) == 1 )
  {
    v17 = v9[88];
    if ( *(_BYTE *)(v5 + 402) == 1 )
...
LABEL_61:
        WPP_SF_ddd(v18->AttachedDevice, v27, &WPP_187a9a52e0a035763cd3db40300053e1_Traceguids, v29, v28, v26);
      }
    }
  }
  else
  ...
  if ( (*(_BYTE *)(v13 + 17) & 1) != 0 )
  {
    RaidAdapterPoFxIdleComponentFromMiniport(v5, *(unsigned int *)(v13 + 748), v21, v22);
    *(_BYTE *)(v13 + 17) &= ~1u;
  }
  if ( v9 )
  {
    ...
    if ( (*(_BYTE *)(v13 + 17) & 2) != 0 )
    {
      RaidUnitPoFxIdleComponentFromMiniport(v9, *(unsigned int *)(v13 + 748));
      *(_BYTE *)(v13 + 17) &= ~2u;
    }
  }
  else if ( *(_QWORD *)(v5 + 5088) )
