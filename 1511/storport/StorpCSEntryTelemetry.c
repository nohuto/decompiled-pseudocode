/*
 * XREFs of StorpCSEntryTelemetry @ 0x1C00383C4
 * Callers:
  ...
  if ( a1 )
  {
    ...
    *(_DWORD *)(a1 + 5432) = 0;
    ...
    if ( v5 )
    {
      ...
      if ( (unsigned int)dword_1C0048030 > 5 && TlgKeywordOn((TraceLoggingHProvider)v5, 0x400000000000uLL) )
      {
        v24 = *(_DWORD *)(a1 + 56);
        v55 = a1 + 5192;
        v57 = &v24;
        ...
        v58 = 4LL;
        v60 = 8LL;
        TlgWrite(v8, &unk_1C004100B, v9, v10, 5u, &pData);
      }
    }
      ...
      if ( RaidUnitCheckAndAcquirePoFx((__int64)(i - 6)) )
      {
        ...
        if ( (unsigned int)dword_1C0048030 > 5 )
        {
          if ( TlgKeywordOn(v13, 0x400000000000uLL) )
          {
            ...
            v51 = 8LL;
            v53 = 4LL;
            TlgWrite(v14, &unk_1C0040F2F, v15, v16, 0xDu, &v31);
          }
        }
