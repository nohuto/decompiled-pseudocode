/*
 * XREFs of RaValidateProtocolCommandIoctl @ 0x1C0030EC8
 * Callers:
...
__int64 __fastcall RaValidateProtocolCommandIoctl(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned int)v5 >= 0x54 )
  {
    if ( *v4 != 1
      ...
      || v4[2] != 3
      || v4[6] != 64
      || (v6 = (unsigned int)v4[7], (_DWORD)v6)
      && ((v7 = (unsigned int)v4[11], v7 < 0x90) || (v7 & 7) != 0 || *(unsigned int *)(v2 + 8) < v7 + v6)
      || (v8 = (unsigned int)v4[8], (_DWORD)v8)
      && ((v9 = (unsigned int)v4[12], v9 < 0x90) || (v9 & 7) != 0 || v5 < v9 + v8)
      || (v10 = (unsigned int)v4[9], (_DWORD)v10)
      && ((v11 = (unsigned int)v4[13], v11 < 0x90) || (v11 & 7) != 0 || *(unsigned int *)(v2 + 8) < v11 + v10)
      || (_DWORD)v8 && (_DWORD)v6 && (unsigned int)v4[12] < v6 + (unsigned __int64)(unsigned int)v4[11]
      || (_DWORD)v10
      ...
      || (v12 = v4[14], (unsigned int)(v12 - 1) > 1)
      || v12 == 1 && (unsigned __int8)v4[20] < 0xC0u
