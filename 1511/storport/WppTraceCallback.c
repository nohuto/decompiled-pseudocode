/*
 * XREFs of WppTraceCallback @ 0x1C00579C0
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int *a6)
{
  ...
  *a6 = 0;
  ...
  {
    v22 = LODWORD(WPP_MAIN_CB.SecurityDescriptor) == 2;
    v24 = *((_QWORD *)a4 + 1);
    *(_QWORD *)(v21 + 24) = v24;
    if ( v22 )
    {
      if ( !((unsigned int (__fastcall *)(__int64, char *, __int64, unsigned int **, unsigned int *))WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink)(
              3LL,
              &v25,
              4LL,
              &a6,
              a4) )
        *(_BYTE *)(v21 + 41) = v25;
      return ((unsigned int (__fastcall *)(__int64, __int64, __int64, unsigned int **, unsigned int *))WPP_MAIN_CB.DeviceLock.Header.WaitListHead.Flink)(
               2LL,
               v21 + 44,
               4LL,
               &a6,
