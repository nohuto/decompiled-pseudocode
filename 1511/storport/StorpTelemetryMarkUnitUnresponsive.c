/*
 * XREFs of StorpTelemetryMarkUnitUnresponsive @ 0x1C003A420
 * Callers:
...
void __fastcall StorpTelemetryMarkUnitUnresponsive(__int64 a1)
{
  ...
  if ( (*(_BYTE *)(a1 + 146) & 2) == 0 && (unsigned int)dword_1C0048030 > 5 )
  {
    if ( TlgKeywordOn((TraceLoggingHProvider)a1, 0x400000000000uLL) )
    {
      ...
      v35 = 4LL;
      v37 = 4LL;
      TlgWrite((TraceLoggingHProvider)v5, &unk_1C0040303, v2, (LPCGUID)v3, 0xDu, &pData);
    }
  }
}
