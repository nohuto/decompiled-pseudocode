/*
 * XREFs of RaUnitAsyncError @ 0x1C0010D24
 * Callers:
...
LABEL_4:
  ...
  if ( *(_BYTE *)(a1 + 2528) || (v14 = *(_DWORD *)(a1 + 1512), ByteOffset.LowPart >= v14) && v14 && v10 != 37 )
  {
    if ( v9 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v9->Timer) & 8) != 0 && BYTE1(v9->Timer) >= 3u )
      WPP_SF_qdq(v9->AttachedDevice, 57LL, &WPP_GLOBAL_Control, a1, ByteOffset.LowPart, v2);
    *(_BYTE *)(v2 + 3) = 4;
    if ( v5 == 8 )
      *v6 = 40;
LABEL_9:
  ...
  if ( v9 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v9->Timer) & 8) != 0 && BYTE1(v9->Timer) >= 4u )
    WPP_SF_qdq(v9->AttachedDevice, 56LL, &WPP_GLOBAL_Control, a1, ByteOffset.LowPart, v2);
