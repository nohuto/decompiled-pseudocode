/*
 * XREFs of RaidUnitPendingDpcRoutine @ 0x1C0006610
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemArgument2)
{
  ...
  if ( *(int *)(v4 + 1488) <= 0 )
  {
    if ( (int)StorTickEventQueue(*(_QWORD *)(v4 + 200), DeferredContext, SystemArgument1, SystemArgument2) < 0 )
    {
      if ( (qword_1C0048010 & 0x400) != 0 )
      ...
      if ( v11 != -1 )
      {
        ...
        if ( !v11 || v11 < (unsigned int)v10 )
        {
          ...
          *(_BYTE *)(v4 + 146) |= 2u;
          ...
          WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 60LL, &WPP_1d8d08be2a000b079c42763d1a0090f2_Traceguids, v4);
        }
      }
    }
  }
...
LABEL_31:
  ...
  else if ( v6 )
  {
    if ( v15 != (PDEVICE_OBJECT)&WPP_GLOBAL_Control && (HIDWORD(v15->Timer) & 8) != 0 && BYTE1(v15->Timer) >= 2u )
      WPP_SF_q(v15->AttachedDevice, 61LL, &WPP_1d8d08be2a000b079c42763d1a0090f2_Traceguids, v4);
