/*
 * XREFs of StorPortGetDeviceBase @ 0x1C0012C30
 * Callers:
 *     StorPortGetDeviceBaseVrfy @ 0x1C005A1A0 (StorPortGetDeviceBaseVrfy.c)
 * Callees:
 *     RaidAllocateAddressMapping @ 0x1C0012CE0 (RaidAllocateAddressMapping.c)
 *     RaidTranslateResourceListAddress @ 0x1C0012D70 (RaidTranslateResourceListAddress.c)
