/*
 * XREFs of RaUnitHwFirmwareGetInfoIoctl @ 0x1C0032244
 * Callers:
 ...
 *     RaTranslateMiniportFirmwareInfoToHwFirmwareInfo @ 0x1C0030CDC (RaTranslateMiniportFirmwareInfoToHwFirmwareInfo.c)
