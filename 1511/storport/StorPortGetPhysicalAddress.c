/*
 * XREFs of StorPortGetPhysicalAddress @ 0x1C00133B0
 * Callers:
 *     StorPortGetPhysicalAddressVrfy @ 0x1C005A1F0 (StorPortGetPhysicalAddressVrfy.c)
 * Callees:
...
PHYSICAL_ADDRESS __fastcall StorPortGetPhysicalAddress(__int64 a1, __int64 a2, void *a3, unsigned int *a4)
{
  ...
  if ( a2 )
  {
    ...
    if ( (_BYTE)v21 == 40 )
    {
      ...
      if ( !v35 )
      {
        GetSrbScsiData(a2, 0LL, 0LL, 0LL, &v32, &v34);
        v7 = v34;
        v8 = v32;
      }
  ...
  else if ( a2 )
  {
    ...
    else
    {
      ...
      if ( v14 > (unsigned __int64)a3 || (unsigned __int64)a3 >= v14 + v15 )
      {
        v26 = *(unsigned int **)(v25 + 152);
        v27 = (_DWORD)a3 - v13;
      }
      else
      {
        v26 = *(unsigned int **)(v25 + 112);
        v27 = (_DWORD)a3 - v14;
      }
      v28 = 0LL;
      if ( v26 )
