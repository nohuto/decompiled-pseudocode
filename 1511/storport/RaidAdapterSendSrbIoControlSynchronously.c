/*
 * XREFs of RaidAdapterSendSrbIoControlSynchronously @ 0x1C0024FE0
 * Callers:
 ...
 *     RaidAdapterHwFirmwareGetInfoFromMiniport @ 0x1C0023EA4 (RaidAdapterHwFirmwareGetInfoFromMiniport.c)
 *     RaidGetStorageAdapterPhysicalTopologyProperty @ 0x1C00262D0 (RaidGetStorageAdapterPhysicalTopologyProperty.c)
 *     RaidGetStorageAdapterProtocolSpecificProperty @ 0x1C0026418 (RaidGetStorageAdapterProtocolSpecificProperty.c)
 *     RaidGetStorageAdapterTemperatureProperty @ 0x1C00265C4 (RaidGetStorageAdapterTemperatureProperty.c)
 * Callees:
        ...
        int a7)
{
  ...
  Irp = a2;
  v10 = 0LL;
  v11 = ((*(_DWORD *)(a1 + 444) + 7) & 0xFFFFFFF8) + 1056;
  v12 = 0LL;
