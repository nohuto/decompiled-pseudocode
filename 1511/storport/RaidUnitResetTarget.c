/*
 * XREFs of RaidUnitResetTarget @ 0x1C0034E70
 * Callers:
 ...
 *     StorpAggregateHierarchicalResetTarget @ 0x1C0038344 (StorpAggregateHierarchicalResetTarget.c)
 */
  ...
  if ( Srb )
  {
    ...
    if ( v13 )
    {
      ...
      if ( (unsigned int)dword_1C0048030 > 5 )
      {
        ...
        v41 = 1LL;
        v43 = 8LL;
        TlgWrite((TraceLoggingHProvider)8, &unk_1C00400D9, v18, v19, 8u, &pData);
      }
