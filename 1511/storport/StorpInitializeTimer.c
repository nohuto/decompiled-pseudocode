/*
 * XREFs of StorpInitializeTimer @ 0x1C00098CC
 * Callers:
...
__int64 __fastcall StorpInitializeTimer(__int64 a1, _QWORD *a2)
{
  ...
  if ( !a1 || !a2 )
  {
    ...
    {
      WPP_SF_qq(WPP_GLOBAL_Control->AttachedDevice, 69LL, &WPP_a7c96fc4c7d54bab161cb0c6c8756061_Traceguids, a1, a2);
    }
    return 3238002694LL;
  }
  if ( KeGetCurrentIrql() <= 2u )
  {
    ...
    if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
      ...
      && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    {
      WPP_SF_q(WPP_GLOBAL_Control->AttachedDevice, 71LL, &WPP_a7c96fc4c7d54bab161cb0c6c8756061_Traceguids, a1);
    }
    return 3238002694LL;
  }
  if ( WPP_GLOBAL_Control != (PDEVICE_OBJECT)&WPP_GLOBAL_Control
    ...
    && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
  {
    WPP_SF_(WPP_GLOBAL_Control->AttachedDevice, 70LL, &WPP_a7c96fc4c7d54bab161cb0c6c8756061_Traceguids, a1);
  }
  return 3238002696LL;
}
