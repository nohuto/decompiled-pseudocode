/*
 * XREFs of Template_qqqqqqqqqqcccqqtt @ 0x1C0028FD4
 * Callers:
...
NTSTATUS __fastcall Template_qqqqqqqqqqcccqqtt(
        __int64 a1,
        ...
        char a20)
{
  ...
  *(_QWORD *)&UserData.Size = 4LL;
  ...
  v51 = 4LL;
  v53 = 4LL;
  return EtwWrite(Microsoft_Windows_StorPortHandle, a2, 0LL, 0x11u, &UserData);
}
