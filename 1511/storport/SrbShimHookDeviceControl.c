/*
 * XREFs of SrbShimHookDeviceControl @ 0x1C003C830
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall SrbShimHookDeviceControl(__int64 a1, __int64 a2)
{
  ...
  if ( *((_DWORD *)v2 + 6) == 2954240 )
  {
    ...
    if ( v6 )
    {
      if ( !v6[1] && *v6 == 1 && *((_DWORD *)v2 + 2) >= 0x20u )
      {
        ...
        (*(void (__fastcall **)(__int64, __int64, __int64 (__fastcall *)(), _QWORD))(qword_1C0048110 + 8))(
          a1,
          a2,
  ...
  v7 = (*(__int64 (__fastcall **)(_QWORD))qword_1C0048110)(*(_QWORD *)(a1 + 8));
