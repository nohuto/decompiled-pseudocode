/*
 * XREFs of ?InitializeResources@FxDmaEnabler@@AEAAJPEAU_FxDmaDescription@@@Z @ 0x1C0029B28
 * Callers:
...
__int64 __fastcall FxDmaEnabler::InitializeResources(FxDmaEnabler *this, _FxDmaDescription *AdapterInfo)
{
    ...
    if ( (v10 & 8) != 0 )
    {
      ...
      if ( _a2 < 0 )
      {
        if ( this->m_ObjectSize )
          ...
          v18 = 0LL;
        WPP_IFR_SF_qd(*p_m_Globals, 2u, 0xFu, 0x13u, WPP_FxDmaEnabler_cpp_Traceguids, v18, _a2);
        return v12;
      }
    }
    else if ( (v10 & 4) != 0 )
  ...
  else
  {
    if ( this->m_ObjectSize )
      ...
      _a1 = 0LL;
    WPP_IFR_SF_qd(m_Globals, 2u, 0xFu, 0x12u, WPP_FxDmaEnabler_cpp_Traceguids, _a1, -1073741823);
    return 3221225473LL;
  }
}
