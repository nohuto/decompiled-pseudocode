/*
 * XREFs of ?DisconnectInternal@FxInterrupt@@QEAAXXZ @ 0x1C000F2BC
 * Callers:
...
void __fastcall FxInterrupt::DisconnectInternal(FxInterrupt *this)
{
  ...
  *(&params.Version + 1) = 0;
  ...
  params.Version = FxLibraryGlobals.ProcessorGroupSupport != 0 ? 4 : 1;
  (*(void (__fastcall **)(_IO_DISCONNECT_INTERRUPT_PARAMETERS *))(v2 + 1128))(&params);
}
