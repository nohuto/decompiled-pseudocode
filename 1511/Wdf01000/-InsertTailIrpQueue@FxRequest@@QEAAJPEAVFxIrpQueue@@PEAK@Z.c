/*
 * XREFs of ?InsertTailIrpQueue@FxRequest@@QEAAJPEAVFxIrpQueue@@PEAK@Z @ 0x1C0022B10
 * Callers:
...
int __fastcall FxRequest::InsertTailIrpQueue(FxRequest *this, FxIrpQueue *IrpQueue, unsigned int *a3)
{
  ...
  if ( result >= 0 )
  {
    FxObject::AddRef(this, (void *)0x75657551, 1892, "minkernel\\wdf\\framework\\shared\\core\\fxrequest.cpp");
    ...
    if ( inserted < 0 )
    {
      ...
      v10->Release(this, (void *)1969583441, 1908, "minkernel\\wdf\\framework\\shared\\core\\fxrequest.cpp");
    }
    return inserted;
  }
  return result;
