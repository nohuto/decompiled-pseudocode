/*
 * XREFs of ?Initialize@FxDevice@@QEAAJPEAUWDFDEVICE_INIT@@PEAU_WDF_OBJECT_ATTRIBUTES@@@Z @ 0x1C001AF10
 * Callers:
 ...
 *     ?ConfigureAutoForwardCleanupClose@FxDevice@@QEAAXPEAUWDFDEVICE_INIT@@@Z @ 0x1C001AD2C (-ConfigureAutoForwardCleanupClose@FxDevice@@QEAAXPEAUWDFDEVICE_INIT@@@Z.c)
        ...
        _WDF_OBJECT_ATTRIBUTES *DeviceAttributes)
{
  ...
  FxTagTracker *v79; // rcx
  const _GUID *Tag; // [rsp+20h] [rbp-98h]
  FxVerifierLock *v81; // [rsp+50h] [rbp-68h] BYREF
  FxVerifierLock *v82[5]; // [rsp+58h] [rbp-60h] BYREF
  void *retaddr; // [rsp+B8h] [rbp+0h]
  char v84; // [rsp+C0h] [rbp+8h]
  FxVerifierLock *VerifierLock; // [rsp+C8h] [rbp+10h] BYREF
  FxVerifierLock *v86; // [rsp+D8h] [rbp+20h] BYREF
  ...
  if ( v12->m_ObjectState == 1 )
  {
    if ( !v12->m_ParentObject )
    {
      ...
      if ( this->m_ObjectState == 1 )
      {
        ...
        v12->m_ChildEntry.Flink = &this->m_ChildListHead;
...
LABEL_128:
  ...
  if ( m_Globals->FxVerifierHandle )
  {
    v73 = *p_m_RequestLookasideListElementSize + 32;
    if ( v73 < *p_m_RequestLookasideListElementSize )
    {
      *p_m_RequestLookasideListElementSize = -1LL;
      id = -1073741675;
    }
    ...
    {
      *p_m_RequestLookasideListElementSize = v73;
      id = 0;
    }
  }
  if ( id < 0 )
  ...
  if ( v32 )
  {
    ...
    *(_QWORD *)&v32[1].m_Type = 0LL;
    ...
    if ( SLOBYTE(v32->m_ObjectFlags) < 0 )
    {
      ...
      {
        v86 = 0LL;
        FxVerifierLock::CreateAndInitialize(&v86, v74, v32);
        v32[-1].m_ChildEntry.Blink = (_LIST_ENTRY *)v86;
      }
    }
  ...
  if ( v32->m_ObjectState == 1 )
  {
    ...
    else
    {
      ...
      if ( this->m_ObjectState == 1 )
      {
        ...
        v32->m_ChildEntry.Flink = &this->m_ChildListHead;
  ...
  if ( v46 )
  {
    ...
    *(_DWORD *)&v46->m_ObjectFlags = 0x10000;
    ...
    if ( SLOBYTE(v46->m_ObjectFlags) < 0 )
    {
      ...
      {
        v81 = 0LL;
        FxVerifierLock::CreateAndInitialize(&v81, v76, v46);
        *(_QWORD *)&v46[-1].m_UpdateEvent.m_Event.m_DbgFlagIsInitialized = v81;
      }
    }
...
LABEL_148:
  ...
  if ( SLOBYTE(v46->m_ObjectFlags) < 0 )
  {
    v77 = (FxTagTracker *)v46[-1].m_UpdateEvent.m_Event.m_Event.Header.WaitListHead.Blink;
    if ( v77 )
      FxTagTracker::UpdateTagHistory(v77, 0LL, 0, 0LL, TagAddRef, v48);
  }
...
LABEL_152:
  ...
  if ( this->m_ObjectState == 1 )
  {
    ...
    v46->m_ChildEntry.Flink = &this->m_ChildListHead;
  ...
  if ( v58 )
  {
    ...
    *(_DWORD *)&v58->m_ObjectFlags = 0x10000;
    ...
    if ( SLOBYTE(v58->m_ObjectFlags) < 0 )
    {
      ...
      {
        v82[0] = 0LL;
        FxVerifierLock::CreateAndInitialize(v82, v78, v58);
        v58[-1].m_DynamicDispatchInfoListHead.Flink = (_LIST_ENTRY *)v82[0];
      }
    }
...
LABEL_159:
  ...
  if ( SLOBYTE(v58->m_ObjectFlags) < 0 )
  {
    v79 = *(FxTagTracker **)&v58[-1].m_RandomSeed;
    if ( v79 )
      FxTagTracker::UpdateTagHistory(v79, 0LL, 0, 0LL, TagAddRef, v60);
  }
  ...
  if ( v58->m_ObjectState == 1 )
  {
    if ( !v58->m_ParentObject )
    {
      ...
      if ( this->m_ObjectState == 1 )
      {
        ...
        v58->m_ChildEntry.Flink = &this->m_ChildListHead;
