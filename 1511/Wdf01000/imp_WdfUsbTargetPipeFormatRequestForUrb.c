/*
 * XREFs of imp_WdfUsbTargetPipeFormatRequestForUrb @ 0x1C00348E0
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDFMEMORY_OFFSET *UrbOffsets)
{
  ...
  else
  {
    ...
    v14 = -1073741811;
    WPP_IFR_SF_qid(m_Globals, 2u, 0xEu, 0x2Au, WPP_FxUsbPipeAPI_cpp_Traceguids, UrbMemory, v13, -1073741811);
  }
  return v14;
}
