/*
 * XREFs of ?Register@_FX_DRIVER_TRACKER_CACHE_AWARE@@QEAAJPEAU_FX_DRIVER_GLOBALS@@@Z @ 0x1C0020CE8
 * Callers:
 *     FxRegisterBugCheckCallback @ 0x1C0020C04 (FxRegisterBugCheckCallback.c)
 * Callees:
 *     WdmlibProcgrpInitialize @ 0x1C00BCBB0 (WdmlibProcgrpInitialize.c)
 */
