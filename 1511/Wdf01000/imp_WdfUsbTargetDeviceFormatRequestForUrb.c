/*
 * XREFs of imp_WdfUsbTargetDeviceFormatRequestForUrb @ 0x1C00346A0
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDFMEMORY_OFFSET *UrbOffsets)
{
  ...
  if ( UrbOffsets )
  {
    v10 = UrbOffsets->BufferLength + UrbOffsets->BufferOffset;
    if ( v10 < UrbOffsets->BufferLength || v10 > pMemory->GetBufferSize(pMemory) )
      return 3221225621LL;
  }
  ...
  else
  {
    ...
    v14 = -1073741811;
    WPP_IFR_SF_qid(m_Globals, 2u, 0xEu, 0xFu, WPP_FxUsbDeviceApiKm_cpp_Traceguids, UrbMemory, v13, -1073741811);
  }
  return v14;
}
