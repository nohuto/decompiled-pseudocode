/*
 * XREFs of ?PowerNotRequiredCallbackWorker@FxPoxInterface@@AEAAXE@Z @ 0x1C008E0FC
 * Callers:
 ...
 *     ?PowerNotRequiredCallback@FxPoxInterface@@CAXPEAX@Z @ 0x1C008E640 (-PowerNotRequiredCallback@FxPoxInterface@@CAXPEAX@Z.c)
 * Callees:
