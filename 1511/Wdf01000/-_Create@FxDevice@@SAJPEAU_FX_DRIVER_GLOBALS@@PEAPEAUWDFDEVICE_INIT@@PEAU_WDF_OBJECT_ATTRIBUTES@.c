/*
 * XREFs of ?_Create@FxDevice@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAPEAUWDFDEVICE_INIT@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAPEAV1@@Z @ 0x1C001A4F0
 * Callers:
...
LABEL_89:
  ...
  *v29 = &FxObject::`vftable'.Public.DriverName[8];
  v32 = 224LL;
  v29[15] = 0LL;
  v29[16] = v29 + 15;
  v29[18] = 0LL;
  ...
  *((_WORD *)v29 + 12) |= 0x800u;
  ...
  if ( v33->FxPoolTrackingOn )
    ...
    v34 = 0LL;
  v35 = (unsigned __int64 **)FxPoolAllocator(v33, &v33->FxPoolFrameworks, v31, v32, v33->Tag, v34);
  v37 = v35;
  if ( !v35 )
    goto LABEL_81;
  if ( v33->FxVerifierHandle )
  ...
  if ( !v37 )
    goto LABEL_81;
  v37[2] = (unsigned __int64 *)v33;
  *v37 = (unsigned __int64 *)&FxObject::`vftable';
  *((_DWORD *)v37 + 2) = 4145;
  v37[7] = 0LL;
  *((_BYTE *)v37 + 48) = 1;
  *((_DWORD *)v37 + 3) = 1;
  *((_DWORD *)v37 + 6) = 0x10000;
  v37[8] = 0LL;
  v37[5] = (unsigned __int64 *)(v37 + 4);
  v37[4] = (unsigned __int64 *)(v37 + 4);
  v37[10] = (unsigned __int64 *)(v37 + 9);
  v37[9] = (unsigned __int64 *)(v37 + 9);
  v38 = v37[2];
  v37[11] = 0LL;
  v37[12] = 0LL;
  if ( *((_BYTE *)v38 + 316) )
    FxObject::Vf_VerifyConstruct((FxObject *)v37, v36, 0);
  *v37 = (unsigned __int64 *)&FxNonPagedObject::`vftable';
  v37[14] = 0LL;
  *((_BYTE *)v37 + 104) = 1;
  if ( *((char *)v37 + 24) < 0 )
  {
    ...
    if ( v51->FxVerifierLock )
    {
      ...
      *(v37 - 3) = (unsigned __int64 *)object;
    }
  }
  *v37 = &FxObject::`vftable'.BugCheckCallbackRecord.Checksum;
  v37[16] = 0LL;
  *((_BYTE *)v37 + 176) = 0;
  ...
  *((_WORD *)v37 + 12) |= 0x811u;
  ...
  v37[16] = (unsigned __int64 *)WorkItem;
  if ( !WorkItem )
  {
    WPP_IFR_SF_(v39, 2u, 0x12u, 0xDu, WPP_FxSystemWorkitem_cpp_Traceguids);
    ((void (__fastcall *)(unsigned __int64 **, _QWORD, _QWORD, _QWORD))(*v37)[2])(v37, 0LL, 0LL, 0LL);
LABEL_81:
    v19 = -1073741670;
