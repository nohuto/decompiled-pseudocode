/*
 * XREFs of ?TimedOutIoIncrement@FxPowerIdleMachine@@KA?AW4FxPowerIdleStates@@PEAV1@@Z @ 0x1C008A550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall FxPowerIdleMachine::TimedOutIoIncrement(FxPowerIdleMachine *This, __int64 a2, unsigned __int8 a3)
{
  ...
  if ( (This->m_Flags & 0x40) != 0 )
  {
    ...
    if ( m_DeviceBase->m_ObjectSize )
      ...
      _a1 = 0LL;
    WPP_IFR_SF_q(Next->m_Globals, 4u, 0xCu, 0xAu, WPP_PowerIdleStateMachine_cpp_Traceguids, _a1);
  }
  else
  {
