/*
 * XREFs of imp_WdfIoTargetFormatRequestForInternalIoctlOthers @ 0x1C0031DD0
 * Callers:
 *     <none>
 * Callees:
        ...
        _WDFMEMORY_OFFSET *OtherArg4Offsets)
{
  ...
  do
  {
    ...
    if ( v19 )
    {
      ...
      if ( v26 )
      {
        v34 = v26->BufferLength + v26->BufferOffset;
        if ( v34 < v26->BufferLength || (v28 = v27->GetBufferSize(v27), v34 > v28) )
        {
          v24 = -1073741675;
      ...
      FxRequestBuffer::SetMemory(&args[v35], pMemory[v18], v26);
    }
