/*
 * XREFs of imp_WdfIoQueueFindRequest @ 0x1C0003000
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFREQUEST__ **OutRequest)
{
  ...
  $62629F1B78C8AA6D0A69F9052F9E18D0 *v20; // rdx
  _QWORD *v21; // rcx
  bool v22; // r9
  _QWORD *v23; // r8
  int v24; // edi
  $62629F1B78C8AA6D0A69F9052F9E18D0 *v26; // r12
  int v27; // r8d
  ...
  FxRequest *v35; // [rsp+60h] [rbp-38h]
  _FX_DRIVER_GLOBALS *v36; // [rsp+68h] [rbp-30h]
  ...
  if ( !v16 )
  {
    if ( *(_WORD *)(v12 + 10) )
      ...
      _a1 = 0LL;
    v24 = -1073741808;
    WPP_IFR_SF_qd(v18, 2u, 0xDu, 0x1Du, (const _GUID *)&FxObject::`vftable'.DebugExtension, _a1, -1073741808);
  ...
  if ( *(char *)(v12 + 24) < 0 && (v30 = *(FxVerifierLock **)(v12 - 24)) != 0LL )
  {
    FxVerifierLock::Lock(v30, &PreviousIrql, v8);
    v19 = PreviousIrql;
  }
  else
  {
...
LABEL_19:
  ...
  while ( 1 )
  {
    if ( !*((_BYTE *)v23 - 100) )
    {
      v26 = ($62629F1B78C8AA6D0A69F9052F9E18D0 *)*(v23 - 3);
      if ( !v22 )
      {
        v22 = v26 == v20;
        goto LABEL_65;
...
LABEL_25:
  if ( *(char *)(v12 + 24) < 0 && (v31 = *(FxVerifierLock **)(v12 - 24)) != 0LL )
    FxVerifierLock::Unlock(v31, v19, (unsigned __int8)v23);
  else
