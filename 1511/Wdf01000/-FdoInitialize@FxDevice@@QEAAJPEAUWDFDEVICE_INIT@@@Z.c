/*
 * XREFs of ?FdoInitialize@FxDevice@@QEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C001C310
 * Callers:
    ...
    if ( v9->m_ObjectState == 1 )
    {
      if ( !v9->m_ParentObject )
      {
        ...
        if ( this->m_ObjectState == 1 )
        {
          ...
          v9->m_ChildEntry.Flink = &this->m_ChildListHead;
...
LABEL_16:
        ...
        {
          v24 = this->m_PkgPnp;
          v24[1].m_ChildEntry.Flink = (_LIST_ENTRY *)DeviceInit->Fdo.EventCallbacks.EvtDeviceFilterAddResourceRequirements;
          v24[1].m_ChildEntry.Blink = (_LIST_ENTRY *)DeviceInit->Fdo.EventCallbacks.EvtDeviceFilterRemoveResourceRequirements;
          v24[1].m_DisposeSingleEntry.Next = (_SINGLE_LIST_ENTRY *)DeviceInit->Fdo.EventCallbacks.EvtDeviceRemoveAddedResources;
        }
