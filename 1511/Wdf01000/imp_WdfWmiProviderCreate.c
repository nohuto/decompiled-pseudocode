/*
 * XREFs of imp_WdfWmiProviderCreate @ 0x1C0060D40
 * Callers:
 *     <none>
 * Callees:
        ...
        WDFWMIPROVIDER__ **WmiProvider)
{
  ...
  {
    return FxWmiProvider::_Create(v5, (unsigned __int64)Device, ProviderAttributes, WmiProviderConfig, v9, &pProvider);
  }
