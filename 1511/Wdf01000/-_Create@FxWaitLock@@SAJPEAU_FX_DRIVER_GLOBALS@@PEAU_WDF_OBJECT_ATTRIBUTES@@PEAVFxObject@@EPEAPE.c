/*
 * XREFs of ?_Create@FxWaitLock@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxObject@@EPEAPEAUWDFWAITLOCK__@@@Z @ 0x1C0023B6C
 * Callers:
        ...
        WDFWAITLOCK__ **LockHandle)
{
  ...
  *LockHandle = 0LL;
  ...
  if ( FxDriverGlobals->FxPoolTrackingOn )
    ...
    Caller = 0LL;
  v14 = FxPoolAllocator(FxDriverGlobals, &FxDriverGlobals->FxPoolFrameworks, v7, (SIZE_T)LockHandle, Tag, Caller);
  v15 = v14;
  if ( v14 )
  {
  ...
  if ( v15 )
  {
    ...
    *v15 = &FxObject::`vftable';
    ...
    v15[7] = 0LL;
    *((_BYTE *)v15 + 48) = 1;
    FxObject::Construct((FxObject *)v15, 0LL);
    *((_BYTE *)v15 + 128) = 0;
