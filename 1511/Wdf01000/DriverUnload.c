/*
 * XREFs of DriverUnload @ 0x1C00576F0
 * Callers:
 *     <none>
 * Callees:
 *     ?WdfDeleteKmdfVersionFromRegistry@@YAXPEAU_DRIVER_OBJECT@@@Z @ 0x1C0057580 (-WdfDeleteKmdfVersionFromRegistry@@YAXPEAU_DRIVER_OBJECT@@@Z.c)
 */
