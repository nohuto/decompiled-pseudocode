/*
 * XREFs of imp_WdfDmaTransactionSetChannelConfigurationCallback @ 0x1C0058B80
 * Callers:
 *     <none>
 * Callees:
        ...
        FxObject *ConfigureContext)
{
  ...
  {
    WPP_IFR_SF_ql(m_Globals, 2u, 0xFu, 0x19u, WPP_FxDmaTransactionAPI_cpp_Traceguids, DmaTransaction, _a2);
