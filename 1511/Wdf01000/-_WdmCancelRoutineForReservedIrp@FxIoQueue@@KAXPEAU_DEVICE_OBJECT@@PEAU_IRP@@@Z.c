/*
 * XREFs of ?_WdmCancelRoutineForReservedIrp@FxIoQueue@@KAXPEAU_DEVICE_OBJECT@@PEAU_IRP@@@Z @ 0x1C0083B20
 * Callers:
 *     <none>
 * Callees:
 *     <none>
...
void __fastcall FxIoQueue::_WdmCancelRoutineForReservedIrp(_DEVICE_OBJECT *DeviceObject, _IRP *Irp)
{
  ...
  if ( (void **)Flink->Blink != &Irp->Tail.CompletionKey + 6 || Blink->Flink != p_ListEntry )
    __fastfail(3u);
  Blink->Flink = Flink;
  Flink->Blink = Blink;
