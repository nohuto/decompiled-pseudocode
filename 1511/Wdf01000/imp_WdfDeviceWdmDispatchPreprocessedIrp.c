/*
 * XREFs of imp_WdfDeviceWdmDispatchPreprocessedIrp @ 0x1C001ABE0
 * Callers:
 *     <none>
 * Callees:
        ...
        _IRP *Irp)
{
  ...
  if ( (v10->MajorFunction == 22 || MajorFunction == 23 || MajorFunction == 27 && v10->MinorFunction != 2)
    && (v12 = IoAcquireRemoveLockEx((PIO_REMOVE_LOCK)&v5->m_DeviceObject.m_DeviceObject[1], Irp, &id, 1u, 0x20u),
        v13 = v12,
        v12 < 0) )
  {
