/*
 * XREFs of imp_WdfIoResourceListCreate @ 0x1C0071DA0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0FxIoResList@@QEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxIoResReqList@@@Z @ 0x1C002210C (--0FxIoResList@@QEAA@PEAU_FX_DRIVER_GLOBALS@@PEAVFxIoResReqList@@@Z.c)
        ...
        WDFIORESLIST__ **ResourceList)
{
  ...
  *ResourceList = 0LL;
  ...
  if ( (int)result >= 0 )
  {
    ...
    if ( v11 )
    {
      v12 = FxObject::Commit(v11, Attributes, (void **)ResourceList, pIoResReqList, 1u);
      if ( v12 < 0 )
