/*
 * XREFs of ?_PnpQueryId@FxPkgPdo@@CAJPEAVFxPkgPnp@@PEAVFxIrp@@@Z @ 0x1C002D640
 * Callers:
 *     <none>
 * Callees:
 *     ?FxCalculateTotalMultiSzStringSize@@YA_KPEBG@Z @ 0x1C002D834 (-FxCalculateTotalMultiSzStringSize@@YA_KPEBG@Z.c)
