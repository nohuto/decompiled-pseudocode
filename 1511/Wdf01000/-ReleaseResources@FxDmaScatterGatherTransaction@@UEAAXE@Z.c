/*
 * XREFs of ?ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z @ 0x1C005B390
 * Callers:
 *     <none>
 * Callees:
 *     ?PutScatterGatherList@FxDmaScatterGatherTransaction@@AEAAXPEAU_SCATTER_GATHER_LIST@@@Z @ 0x1C005AF9C (-PutScatterGatherList@FxDmaScatterGatherTransaction@@AEAAXPEAU_SCATTER_GATHER_LIST@@@Z.c)
 */
