/*
 * XREFs of FxpBugCheckCallbackFilter @ 0x1C008FDD8
 * Callers:
 *     FxpBugCheckCallback @ 0x1C008FD30 (FxpBugCheckCallback.c)
 * Callees:
 *     FxpIsAddressKnownToWdf @ 0x1C008FE58 (FxpIsAddressKnownToWdf.c)
 */
