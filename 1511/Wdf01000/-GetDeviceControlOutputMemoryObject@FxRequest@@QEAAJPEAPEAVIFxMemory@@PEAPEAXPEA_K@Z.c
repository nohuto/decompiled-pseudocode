/*
 * XREFs of ?GetDeviceControlOutputMemoryObject@FxRequest@@QEAAJPEAPEAVIFxMemory@@PEAPEAXPEA_K@Z @ 0x1C00081A0
 * Callers:
        ...
        unsigned __int64 *Length)
{
  ...
  {
    FxNonPagedObject::Lock(this, (unsigned __int8 *)&irql, (unsigned __int8)Buffer);
    v4 = irql;
  }
...
$Done_1:
  if ( (this->m_RequestBaseStaticFlags & 2) == 0 )
    FxNonPagedObject::Unlock(this, v4, MajorFunction);
  if ( v7 >= 0 )
  {
