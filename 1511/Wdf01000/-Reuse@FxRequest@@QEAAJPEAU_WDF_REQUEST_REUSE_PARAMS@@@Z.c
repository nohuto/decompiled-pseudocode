/*
 * XREFs of ?Reuse@FxRequest@@QEAAJPEAU_WDF_REQUEST_REUSE_PARAMS@@@Z @ 0x1C00229D0
 * Callers:
  ...
  if ( m_Irp )
  {
    if ( this->m_IrpAllocation != 1 )
    {
      if ( this->m_Refcnt == 1 )
      {
        ...
        {
          FxObject::AddRef(this, (void *)0x43524344, 2387, "minkernel\\wdf\\framework\\shared\\core\\fxrequest.cpp");
