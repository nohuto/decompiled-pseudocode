/*
 * XREFs of ?SetState@FxIoQueue@@QEAAXW4_FX_IO_QUEUE_SET_STATE@@@Z @ 0x1C001EB28
 * Callers:
...
void __fastcall FxIoQueue::SetState(FxIoQueue *this, _FX_IO_QUEUE_SET_STATE NewStatus)
{
  ...
  if ( (NewStatus & 0x7FFCFFF0) != 0 )
  {
    if ( this->m_ObjectSize )
      ...
      _a1 = 0LL;
    WPP_IFR_SF_q(m_Globals, 2u, 0xDu, 0x14u, (const _GUID *)&FxObject::`vftable'.DebugExtension, _a1);
    ...
    if ( (NewStatus & 1) != 0 )
    {
      ...
      if ( (m_QueueState & 0x10000) != 0 )
      {
        if ( this->m_ObjectSize )
          ...
          v7 = 0LL;
        WPP_IFR_SF_q(m_Globals, 4u, 0xDu, 0x15u, (const _GUID *)&FxObject::`vftable'.DebugExtension, v7);
      }
      else
      {
