/*
 * XREFs of PiRegStateReadStackCreationSettingsFromKey @ 0x1C00BDBD4
 * Callers:
 ...
 *     CmRegUtilUcValueGetFullBuffer @ 0x1C00BE2D4 (CmRegUtilUcValueGetFullBuffer.c)
 *     CmRegUtilWstrValueGetDword @ 0x1C00BE510 (CmRegUtilWstrValueGetDword.c)
 */
        ...
        STACK_CREATION_SETTINGS *StackCreationSettings)
{
  ...
  Dword = CmRegUtilWstrValueGetDword(ClassOrDeviceKey, L"DeviceType", v9, p_DeviceType);
  inited = Dword;
  if ( Dword < 0 )
  {
    if ( Dword != -1073741772 )
  ...
  v15 = CmRegUtilWstrValueGetDword(ClassOrDeviceKey, L"DeviceCharacteristics", v14, p_Characteristics);
  inited = v15;
  if ( v15 < 0 )
  {
    if ( v15 != -1073741772 )
  ...
  v17 = CmRegUtilWstrValueGetDword(ClassOrDeviceKey, L"Exclusive", v16, p_Exclusivity);
  inited = v17;
  if ( v17 >= 0 )
  {
