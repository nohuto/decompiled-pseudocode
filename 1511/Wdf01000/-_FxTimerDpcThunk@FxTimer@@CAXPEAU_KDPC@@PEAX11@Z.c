/*
 * XREFs of ?_FxTimerDpcThunk@FxTimer@@CAXPEAU_KDPC@@PEAX11@Z @ 0x1C0002150
 * Callers:
 *     <none>
 * Callees:
 *     ?TimerHandler@FxTimer@@QEAAXXZ @ 0x1C00022B4 (-TimerHandler@FxTimer@@QEAAXXZ.c)
  ...
  if ( _a1 )
  {
    ...
    if ( !_a1->m_Enqueued )
    {
      if ( !_a1->m_RunningDown )
      {
        ...
        if ( SLOBYTE(_a1->m_ObjectFlags) < 0
          && (v11 = (FxVerifierLock *)_a1[-1].m_RemoveEvent.m_Event.m_Event.Header.WaitListHead.Flink) != 0LL )
        {
