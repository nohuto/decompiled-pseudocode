/*
 * XREFs of ?Vf_VerifyCancelForDriver@FxIoQueue@@QEAAXPEAU_FX_DRIVER_GLOBALS@@PEAVFxRequest@@@Z @ 0x1C00BA77C
 * Callers:
        ...
        unsigned __int64 Request)
{
  ...
  if ( *(_WORD *)(Request + 10) )
    ...
    _a1 = 0LL;
  WPP_IFR_SF_qq(FxDriverGlobals, 3u, 0xDu, 0x4Du, (const _GUID *)&FxObject::`vftable'.DebugExtension, _a1, _a2);
  if ( *(_QWORD *)(Request + 288) != Request + 288 )
  {
    ...
    if ( *(_WORD *)(Request + 10) )
      ...
      v9 = 0LL;
    WPP_IFR_SF_qq(FxDriverGlobals, 2u, 0xDu, 0x4Eu, (const _GUID *)&FxObject::`vftable'.DebugExtension, v9, v8);
