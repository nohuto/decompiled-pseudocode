/*
 * XREFs of ?QueryUsbCapability@FxUsbDevice@@QEAAJPEBU_GUID@@KPEAXPEAK@Z @ 0x1C007DB14
 * Callers:
        ...
        const _GUID *ResultLength)
{
  ...
  {
    v8 = -1073741436;
    WPP_IFR_SF_d(this->m_Globals, 2u, 0xEu, 0x19u, WPP_FxusbDeviceKm_cpp_Traceguids, -1073741436);
  }
  return v8;
}
