/*
 * XREFs of WPP_IFR_SF_dq @ 0x1C0059230
 * Callers:
 ...
 *     ?FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ @ 0x1C005A5B0 (-FreeMapRegistersAndAdapter@FxDmaPacketTransaction@@MEAAXXZ.c)
