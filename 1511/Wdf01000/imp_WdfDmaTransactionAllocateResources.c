/*
 * XREFs of imp_WdfDmaTransactionAllocateResources @ 0x1C0057FB0
 * Callers:
 *     <none>
 * Callees:
        ...
        void *EvtReserveDmaContext)
{
  ...
  if ( FxDmaEnabler::GetDmaDescription(pDmaTrans->m_DmaEnabler, WdfDmaDirectionReadFromDevice)->m_SimplexAdapterInfo.DeviceDescription.Version != 3 )
  {
    if ( *(_WORD *)(v11 + 10) )
      ...
      _a2 = 0LL;
    v14 = -1073741808;
    WPP_IFR_SF_qid(m_Globals, 2u, 0xFu, 0x1Fu, WPP_FxDmaTransactionAPI_cpp_Traceguids, DmaTransaction, _a2, -1073741808);
    goto LABEL_14;
  }
  v15 = *(_DWORD *)(v11 + 376);
