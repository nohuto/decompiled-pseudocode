/*
 * XREFs of DriverEntry @ 0x1C0030EC0
 * Callers:
 *     GsDriverEntry @ 0x1C00BF000 (GsDriverEntry.c)
 * Callees:
 *     ?WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z @ 0x1C0031040 (-WdfWriteKmdfVersionToRegistry@@YAXPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@@Z.c)
 *     ?FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z @ 0x1C003124C (-FxLibraryCreateDevice@@YAJPEAU_UNICODE_STRING@@@Z.c)
 *     __security_check_cookie @ 0x1C0035B00 (__security_check_cookie.c)
 *     memset @ 0x1C0036C40 (memset.c)
 *     ?FxLibraryCleanup@@YAXXZ @ 0x1C005755C (-FxLibraryCleanup@@YAXXZ.c)
 */
