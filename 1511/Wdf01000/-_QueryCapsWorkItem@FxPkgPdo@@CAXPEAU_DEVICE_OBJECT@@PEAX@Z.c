/*
 * XREFs of ?_QueryCapsWorkItem@FxPkgPdo@@CAXPEAU_DEVICE_OBJECT@@PEAX@Z @ 0x1C0084930
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall FxPkgPdo::_QueryCapsWorkItem(_DEVICE_OBJECT *DeviceObject, _IRP *Context)
{
  ...
  FxIrp irp; // [rsp+20h] [rbp-88h] BYREF
  MxDeviceObject parentDeviceObject; // [rsp+28h] [rbp-80h] BYREF
