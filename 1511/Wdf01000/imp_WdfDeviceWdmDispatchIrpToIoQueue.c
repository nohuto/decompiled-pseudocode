/*
 * XREFs of imp_WdfDeviceWdmDispatchIrpToIoQueue @ 0x1C0022200
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int Flags)
{
  ...
  FxDeviceBase *v72; // [rsp+60h] [rbp-21h]
  FxRequest *ReservedRequest; // [rsp+68h] [rbp-19h] BYREF
  void *v74; // [rsp+70h] [rbp-11h] BYREF
  FxVerifierLock *VerifierLock; // [rsp+78h] [rbp-9h] BYREF
  FxPkgIo *v76; // [rsp+80h] [rbp-1h]
  FxIoInCallerContext *InCallerContextInfo; // [rsp+88h] [rbp+7h]
  void *v78; // [rsp+90h] [rbp+Fh] BYREF
  ...
  {
    FxObjectHandleGetPtrQI((FxObject *)v12, &v74, (void *)Queue, 0x1003u, v13);
    v9 = (FxDevice *)PPObject;
  ...
  {
    v50 = v72;
    ++LODWORD(v72[2].m_ChildEntry.Flink);
  ...
  if ( v24 )
  {
    ...
    if ( LOBYTE(VerifierLock[1].m_Mutex.m_Lock.Event.Header.WaitListHead.Blink) )
    {
      FxPoolInsertNonPagedAllocateTracker(
        ...
        v24,
        (unsigned __int64)v72[2].m_CallbackLockObjectPtr,
    ...
    *p_Flink = v24;
    ...
    if ( !p_m_ExecutionLevel )
      v22 = (__int64)&v72[2].m_ExecutionLevel;
...
LABEL_63:
        ...
        {
          FxObjectHandleGetPtr(v27->m_Globals, *(_QWORD *)(p_m_ExecutionLevel + 32), 0x1000u, &v78);
          v34 = (FxObject *)v78;
        }
  ...
  _a1 = -1073741670;
  WPP_IFR_SF_d(v72->m_Globals, 2u, 0x10u, 0xAu, WPP_FxRequest_cpp_Traceguids, -1073741670);
LABEL_64:
  v40 = (char)Request;
  v41 = v76;
  if ( (_BYTE)Request )
...
LABEL_132:
    ...
    if ( (v76->m_Globals->FxEnhancedVerifierOptions & 0xF0000) != 0 )
      _a1 = FxPkgIo::VerifierFreeRequestToTestForwardProgess(v76, v21);
    v40 = (char)Request;
  }
  if ( _a1 < 0 )
    goto LABEL_116;
...
LABEL_121:
  ...
  if ( v21->m_Reserved )
    FxObject::AddRef(v21, (void *)0x50647746, 2286, "minkernel\\wdf\\framework\\shared\\irphandlers\\io\\fxioqueue.cpp");
  _a4 = *(_DWORD *)(v12 + 188);
  if ( (_a4 & 1) == 0 )
  {
    ...
    if ( v62->FxVerboseOn )
    {
      ...
      if ( *(_WORD *)(v12 + 10) )
        ...
        v65 = 0LL;
      WPP_IFR_SF_qLsqd(v62, 5u, (unsigned int)_a5, 0x27u, Offset, v65, _a4, _a5, globals, -1073741436);
    }
  ...
  {
    if ( *(_WORD *)(v12 + 10) )
      v66 = (const void *)(v12 ^ 0xFFFFFFFFFFFFFFF8uLL);
    else
      v66 = 0LL;
    if ( v21->m_ObjectSize )
      v5 = (const void *)((unsigned __int64)v21 ^ 0xFFFFFFFFFFFFFFF8uLL);
    WPP_IFR_SF_qq(v47, 5u, 0xDu, 0x28u, (const _GUID *)&FxObject::`vftable'.DebugExtension, v5, v66);
  }
  ...
  if ( v21->m_Reserved )
  {
    if ( *(_DWORD *)(v12 + 368) )
    {
      ...
      FxNonPagedObject::Unlock((FxNonPagedObject *)v12, PreviousIrql, v67);
      goto LABEL_81;
    }
    v21 = ReservedRequest;
    v44 = PreviousIrql;
