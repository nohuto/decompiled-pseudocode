/*
 * XREFs of ?_RegInfo@FxWmiIrpHandler@@CAJPEAV1@PEAU_IRP@@PEAVFxWmiProvider@@PEAVFxWmiInstance@@@Z @ 0x1C002C5C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_5:
  ...
  else
  {
    ...
    if ( v17 <= LowPart )
    {
      ...
      {
        *v22 = *(_WORD *)v34;
        memmove(v22 + 1, v34[1], *(unsigned __int16 *)v34);
      }
      else
      {
        *v22 = 0;
      }
      v23 = (unsigned __int16 *)((char *)Parameters + v33);
