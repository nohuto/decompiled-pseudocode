/*
 * XREFs of imp_WdfDeviceWdmGetAttachedDevice @ 0x1C00019E0
 * Callers:
 *     <none>
 * Callees:
...
_DEVICE_OBJECT *__fastcall imp_WdfDeviceWdmGetAttachedDevice(_WDF_DRIVER_GLOBALS *DriverGlobals, WDFDEVICE__ *Device)
{
  ...
  FxObjectHandleGetPtr((_FX_DRIVER_GLOBALS *)&DriverGlobals[-8].DriverName[16], Device, 0x1030u, (void **)&pDevice);
