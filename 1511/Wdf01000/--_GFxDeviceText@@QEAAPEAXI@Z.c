/*
 * XREFs of ??_GFxDeviceText@@QEAAPEAXI@Z @ 0x1C0063598
 * Callers:
 ...
 *     ?_CleanupList@FxDeviceText@@SAHPEAU_SINGLE_LIST_ENTRY@@@Z @ 0x1C006A6F4 (-_CleanupList@FxDeviceText@@SAHPEAU_SINGLE_LIST_ENTRY@@@Z.c)
 * Callees:
