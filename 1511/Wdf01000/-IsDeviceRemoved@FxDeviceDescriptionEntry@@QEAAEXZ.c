/*
 * XREFs of ?IsDeviceRemoved@FxDeviceDescriptionEntry@@QEAAEXZ @ 0x1C005FBA4
 * Callers:
 *     ?PnpEventCheckForDevicePresenceOverload@FxPkgPdo@@EEAA?AW4_WDF_DEVICE_PNP_STATE@@XZ @ 0x1C0084430 (-PnpEventCheckForDevicePresenceOverload@FxPkgPdo@@EEAA-AW4_WDF_DEVICE_PNP_STATE@@XZ.c)
 * Callees:
