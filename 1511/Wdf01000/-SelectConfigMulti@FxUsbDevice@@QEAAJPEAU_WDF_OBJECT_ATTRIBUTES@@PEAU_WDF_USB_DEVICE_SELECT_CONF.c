/*
 * XREFs of ?SelectConfigMulti@FxUsbDevice@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAU_WDF_USB_DEVICE_SELECT_CONFIG_PARAMS@@@Z @ 0x1C007DC6C
 * Callers:
 ...
 *     ?FxUsbParseConfigurationDescriptor@@YAPEAU_USB_INTERFACE_DESCRIPTOR@@PEAU_USB_CONFIGURATION_DESCRIPTOR@@EE@Z @ 0x1C0080C00 (-FxUsbParseConfigurationDescriptor@@YAPEAU_USB_INTERFACE_DESCRIPTOR@@PEAU_USB_CONFIGURATION_DESC.c)
 */
        ...
        _WDF_USB_DEVICE_SELECT_CONFIG_PARAMS *Params)
{
  ...
  _USB_INTERFACE_DESCRIPTOR *v28; // rax
  int _a4; // eax
  const void *v30; // rdi
  int v31; // ecx
  ...
  unsigned __int8 *v38; // [rsp+60h] [rbp-158h]
  void *PPObject; // [rsp+68h] [rbp-150h] BYREF
  ...
  v9 = PipesAttributes;
  v10 = 0;
  v38 = p_NumberOfConfiguredInterfaces;
...
LABEL_17:
  ...
  v13[v10].InterfaceDescriptor = v28;
  if ( v28 )
  {
    ++v10;
    goto LABEL_17;
