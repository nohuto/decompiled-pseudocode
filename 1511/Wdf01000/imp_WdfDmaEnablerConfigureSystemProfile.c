/*
 * XREFs of imp_WdfDmaEnablerConfigureSystemProfile @ 0x1C0059350
 * Callers:
 *     <none>
 * Callees:
...
LABEL_7:
  ...
  {
    v8 = -1073741820;
    WPP_IFR_SF_DDd(m_Globals, v6, 0xFu, 0x15u, WPP_FxDmaEnablerAPI_cpp_Traceguids, ProfileConfig->Size, 32, -1073741820);
    goto LABEL_7;
  }
