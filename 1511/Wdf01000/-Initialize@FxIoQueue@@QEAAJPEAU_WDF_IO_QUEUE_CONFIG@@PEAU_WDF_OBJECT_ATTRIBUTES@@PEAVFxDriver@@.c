/*
 * XREFs of ?Initialize@FxIoQueue@@QEAAJPEAU_WDF_IO_QUEUE_CONFIG@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@E@Z @ 0x1C001EDF0
 * Callers:
 ...
 *     ?ConfigureConstraints@FxIoQueue@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@@Z @ 0x1C001EBE0 (-ConfigureConstraints@FxIoQueue@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@@Z.c)
        ...
        unsigned __int8 InitialPowerStateOn)
{
  ...
  if ( DispatchType == WdfIoQueueDispatchManual )
  {
      ...
      || pConfig->EvtIoInternalDeviceControl )
    {
      if ( this->m_ObjectSize )
        ...
        v20 = 0LL;
      WPP_IFR_SF_qd(m_Globals, 2u, 0xDu, 0xEu, (const _GUID *)&FxObject::`vftable'.DebugExtension, v20, -1073741811);
      return 3221225485LL;
    }
  }
         ...
         && !pConfig->EvtIoInternalDeviceControl )
  {
    WPP_IFR_SF_d(m_Globals, 2u, 0xDu, 0xDu, (const _GUID *)&FxObject::`vftable'.DebugExtension, -1071644149);
    return 3223323147LL;
  }
  if ( pConfig->Size > 0x50 )
  {
    ...
    if ( NumberOfPresentedRequests && ((DispatchType - 1) & 0xFFFFFFFD) == 0 )
    {
      if ( this->m_ObjectSize )
        ...
        v21 = 0LL;
      WPP_IFR_SF_qd(m_Globals, 2u, 0xDu, 0xFu, (const _GUID *)&FxObject::`vftable'.DebugExtension, v21, -1073741811);
      return 3221225485LL;
    }
  ...
  if ( this->m_PassiveLevel )
  {
    ...
    if ( _a1 < 0 )
    {
      WPP_IFR_SF_d(m_Globals, 2u, 0xDu, 0x10u, (const _GUID *)&FxObject::`vftable'.DebugExtension, _a1);
      return v19;
    }
  }
...
LABEL_17:
  ...
  if ( (m_QueueState & 0x10000) != 0 )
  {
    ...
    WPP_IFR_SF_q(v16, 4u, 0xDu, 0x15u, (const _GUID *)&FxObject::`vftable'.DebugExtension, v15);
  }
  else
  {
