/*
 * XREFs of ?AddUsageDevice@FxPkgPnp@@QEAAJPEAU_DEVICE_OBJECT@@@Z @ 0x1C0087C00
 * Callers:
...
LABEL_11:
    ...
    else
    {
      ...
      WPP_IFR_SF_qd(this->m_Globals, 2u, 0xCu, 0x45u, WPP_FxPkgPnp_cpp_Traceguids, v11, -1073741670);
    }
  ...
  if ( !v15 )
    return 3221225626LL;
  v16 = FxTransactionedList::Add(this->m_UsageDependentDeviceList, this->m_Globals, (FxTransactionedEntry *)(v15 + 104));
  if ( v16 < 0 )
