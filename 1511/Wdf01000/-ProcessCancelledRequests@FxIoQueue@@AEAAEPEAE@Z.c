/*
 * XREFs of ?ProcessCancelledRequests@FxIoQueue@@AEAAEPEAE@Z @ 0x1C001E920
 * Callers:
...
unsigned __int8 __fastcall FxIoQueue::ProcessCancelledRequests(FxIoQueue *this, unsigned __int8 *PreviousIrql)
{
  ...
  while ( p_m_Cancelled->Flink != p_m_Cancelled )
  {
    ...
    WPP_IFR_SF_qq(m_Globals, 4u, 0xDu, 0x52u, (const _GUID *)&FxObject::`vftable'.DebugExtension, _a1, _a2);
    ...
    v9->Release(v9, (void *)1969583441, 4909, "minkernel\\wdf\\framework\\shared\\irphandlers\\io\\fxioqueue.cpp");
