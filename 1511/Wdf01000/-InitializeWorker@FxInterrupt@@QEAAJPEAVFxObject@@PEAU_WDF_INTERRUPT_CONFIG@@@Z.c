/*
 * XREFs of ?InitializeWorker@FxInterrupt@@QEAAJPEAVFxObject@@PEAU_WDF_INTERRUPT_CONFIG@@@Z @ 0x1C002EEA8
 * Callers:
...
LABEL_7:
  ...
  if ( !m_DeviceBase || v12 != m_DeviceBase || (unsigned __int16)(m_Type - 4098) > 1u )
  {
    if ( Parent->m_ObjectSize )
      v21 = (const void *)((unsigned __int64)Parent ^ 0xFFFFFFFFFFFFFFF8uLL);
    else
      v21 = 0LL;
    v20 = -1073741811;
    WPP_IFR_SF_qid(
