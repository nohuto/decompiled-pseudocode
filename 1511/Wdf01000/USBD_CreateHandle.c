/*
 * XREFs of USBD_CreateHandle @ 0x1C008F244
 * Callers:
 ...
 *     USBDInternal_BuildAndSendQueryInterfaceSynchronously @ 0x1C008EC78 (USBDInternal_BuildAndSendQueryInterfaceSynchronously.c)
        ...
        USBD_HANDLE__ **USBDHandle)
{
  ...
  unsigned __int16 *servicePath; // [rsp+38h] [rbp-C8h] BYREF
...
LABEL_59:
  ...
  if ( USBDHandle )
  {
    ...
    *((_DWORD *)v12 + 43) = 1;
    ...
    {
      v14 = LOBYTE(WPP_GLOBAL_WDF_Control.Queue.Wcb.DeviceObject) == 0;
      *((_DWORD *)v12 + 42) = 1536;
      if ( !v14 )
        DbgPrintEx(
          0x4Du,
