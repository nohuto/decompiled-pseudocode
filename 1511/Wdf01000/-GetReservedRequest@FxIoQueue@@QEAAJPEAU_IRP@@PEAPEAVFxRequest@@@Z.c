/*
 * XREFs of ?GetReservedRequest@FxIoQueue@@QEAAJPEAU_IRP@@PEAPEAVFxRequest@@@Z @ 0x1C00836D0
 * Callers:
 ...
 *     ?QueueForwardProgressIrpLocked@FxIoQueue@@AEAAJPEAU_IRP@@@Z @ 0x1C008399C (-QueueForwardProgressIrpLocked@FxIoQueue@@AEAAJPEAU_IRP@@@Z.c)
 */
...
LABEL_18:
  ...
  else
  {
    ...
    v18->m_ForwardProgressList.Flink = p_m_ReservedRequestInUseList;
