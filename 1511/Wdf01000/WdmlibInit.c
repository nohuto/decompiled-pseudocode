/*
 * XREFs of WdmlibInit @ 0x1C00BCB44
 * Callers:
 *     WdmlibIoCreateDeviceSecure @ 0x1C00BCAB4 (WdmlibIoCreateDeviceSecure.c)
 * Callees:
 *     <none>
 */

int (__fastcall *WdmlibInit())(_IRP *, unsigned int)
{
  int (__fastcall *result)(_IRP *, unsigned int); // rax
  ...
  result = (int (__fastcall *)(_IRP *, unsigned int))MmGetSystemRoutineAddress(&functionName);
  PfnIoValidateDeviceIoControlAccess = result;
  WdmlibInitialized = 1;
  return result;
}
