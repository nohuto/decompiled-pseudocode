/*
 * XREFs of ?Vf_VerifyCompleteInternal@FxRequest@@AEAAXPEAU_FX_DRIVER_GLOBALS@@J@Z @ 0x1C00B998C
 * Callers:
  ...
  if ( FxDriverGlobals >= 0 )
  {
    ...
    if ( flags > id )
    {
      if ( this->m_ObjectSize )
        ...
        v16 = 0LL;
      WPP_IFR_SF_qDxD(*p_m_Globals, flags, (unsigned int)m_Irp, level, traceGuid, v16, level, flags, id);
      if ( this->m_ObjectSize )
      ...
      FxVerifierBugCheckWorker(v18, WDF_REQUEST_FATAL_ERROR, 4uLL, (ULONG_PTR)&data);
    }
  }
LABEL_15:
