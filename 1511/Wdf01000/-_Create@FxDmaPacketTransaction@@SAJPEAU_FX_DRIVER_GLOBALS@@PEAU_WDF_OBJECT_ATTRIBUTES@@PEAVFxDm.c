/*
 * XREFs of ?_Create@FxDmaPacketTransaction@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDmaEnabler@@PEAPEAUWDFDMATRANSACTION__@@@Z @ 0x1C005C780
 * Callers:
 ...
 *     ??0FxDmaPacketTransaction@@IEAA@PEAU_FX_DRIVER_GLOBALS@@GGPEAVFxDmaEnabler@@@Z @ 0x1C005972C (--0FxDmaPacketTransaction@@IEAA@PEAU_FX_DRIVER_GLOBALS@@GGPEAVFxDmaEnabler@@@Z.c)
 */
        ...
        WDFDMATRANSACTION__ **Transaction)
{
  ...
  $4E78FAD6283A805B24C30083E98044BF *v10; // rax
  ...
  if ( v14 )
  {
    v16 = FxObject::Commit(v14, Attributes, &hTransaction, DmaEnabler, 1u);
    if ( v16 < 0 )
