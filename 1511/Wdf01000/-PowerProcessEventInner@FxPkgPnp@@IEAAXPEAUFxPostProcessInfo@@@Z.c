/*
 * XREFs of ?PowerProcessEventInner@FxPkgPnp@@IEAAXPEAUFxPostProcessInfo@@@Z @ 0x1C0014E10
 * Callers:
 *     ?_PowerProcessEventInner@FxPkgPnp@@KAXPEAV1@PEAUFxPostProcessInfo@@PEAX@Z @ 0x1C0012920 (-_PowerProcessEventInner@FxPkgPnp@@KAXPEAV1@PEAUFxPostProcessInfo@@PEAX@Z.c)
 ...
 *     ?Invoke@FxPowerStateCallback@@QEAAXW4_WDF_DEVICE_POWER_STATE@@W4_WDF_STATE_NOTIFICATION_TYPE@@PEAUWDFDEVICE__@@PEBU_WDF_DEVICE_POWER_NOTIFICATION_DATA@@@Z @ 0x1C008644C (-Invoke@FxPowerStateCallback@@QEAAXW4_WDF_DEVICE_POWER_STATE@@W4_WDF_STATE_NOTIFICATION_TYPE@@PE.c)
 */
...
void __fastcall FxPkgPnp::PowerProcessEventInner(FxPkgPnp *this, FxPostProcessInfo *Info)
{
  ...
  while ( 1 )
  {
    ...
    if ( !OtherTargetStates || (v28 = 0LL, OtherTargetStates->PowerEvent == PowerEventMaximum) )
    {
LABEL_43:
    ...
    else
    {
      ...
      while ( OtherTargetStates[v29].PowerEvent != v7 )
      {
        ...
        v29 = v28;
        if ( OtherTargetStates[v28].PowerEvent == PowerEventMaximum )
          goto LABEL_43;
      }
      _a3 = OtherTargetStates[v28].TargetState;
LABEL_11:
      ...
      do
      {
        ...
        if ( FxPkgPnp::m_WdfPowerStates[v24].StateFunc )
        {
          ...
          if ( (_a3 & 0x8000) != 0 )
          {
            ...
            if ( v48->m_SharedPower.m_ExtendWatchDogTimer )
      ...
      if ( TimerContext.m_Timer.m_IsExtTimer )
      {
        ...
        {
          LOBYTE(v22) = 1;
          ExDeleteTimer(TimerContext.m_Timer.m_KernelExTimer, v22, 0LL, 0LL);
        }
      }
    }
  }
