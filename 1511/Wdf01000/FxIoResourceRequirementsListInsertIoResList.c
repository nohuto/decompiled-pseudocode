/*
 * XREFs of FxIoResourceRequirementsListInsertIoResList @ 0x1C0071B18
 * Callers:
 *     imp_WdfIoResourceRequirementsListAppendIoResList @ 0x1C0071FF0 (imp_WdfIoResourceRequirementsListAppendIoResList.c)
 *     imp_WdfIoResourceRequirementsListInsertIoResList @ 0x1C0072000 (imp_WdfIoResourceRequirementsListInsertIoResList.c)
 * Callees:
