/*
 * XREFs of ?_Create@FxMemoryBuffer@@SAJPEAU_FX_DRIVER_GLOBALS@@PEAU_WDF_OBJECT_ATTRIBUTES@@K_KW4_POOL_TYPE@@PEAPEAVFxMemoryObject@@@Z @ 0x1C002E26C
 * Callers:
        ...
        FxMemoryObject **Object)
{
  ...
  if ( v8 )
  {
    ...
    v8->FxObject::__vftable = (FxMemoryObject_vtbl *)&FxObject::`vftable'.WdfLogHeader;
