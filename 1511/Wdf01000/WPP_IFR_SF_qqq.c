/*
 * XREFs of WPP_IFR_SF_qqq @ 0x1C005D374
 * Callers:
 ...
 *     ?PreMapTransfer@FxDmaSystemTransaction@@MEAAEXZ @ 0x1C005AEA0 (-PreMapTransfer@FxDmaSystemTransaction@@MEAAEXZ.c)
 ...
 *     ?ForceReconnect@FxInterrupt@@QEAAJXZ @ 0x1C008C83C (-ForceReconnect@FxInterrupt@@QEAAJXZ.c)
