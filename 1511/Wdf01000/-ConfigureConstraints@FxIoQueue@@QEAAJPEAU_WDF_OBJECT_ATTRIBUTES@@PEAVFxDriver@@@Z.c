/*
 * XREFs of ?ConfigureConstraints@FxIoQueue@@QEAAJPEAU_WDF_OBJECT_ATTRIBUTES@@PEAVFxDriver@@@Z @ 0x1C001EBE0
 * Callers:
...
LABEL_18:
  ...
  if ( Caller && (m_Globals = this->m_Globals, Caller != m_Globals->Driver) )
  {
    if ( this->m_ObjectSize )
      ...
      _a1 = 0LL;
    WPP_IFR_SF_qd(m_Globals, 2u, 0xDu, 0x12u, (const _GUID *)&FxObject::`vftable'.DebugExtension, _a1, -1073741811);
  }
  else
  {
    if ( v8 == globals )
