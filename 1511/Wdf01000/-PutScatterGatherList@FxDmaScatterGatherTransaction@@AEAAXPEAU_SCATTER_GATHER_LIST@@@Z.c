/*
 * XREFs of ?PutScatterGatherList@FxDmaScatterGatherTransaction@@AEAAXPEAU_SCATTER_GATHER_LIST@@@Z @ 0x1C005AF9C
 * Callers:
 *     ?ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z @ 0x1C005B390 (-ReleaseResources@FxDmaScatterGatherTransaction@@UEAAXE@Z.c)
 *     ?TransferCompleted@FxDmaScatterGatherTransaction@@UEAAJXZ @ 0x1C005C3D0 (-TransferCompleted@FxDmaScatterGatherTransaction@@UEAAJXZ.c)
 * Callees:
 *     <none>
 */
