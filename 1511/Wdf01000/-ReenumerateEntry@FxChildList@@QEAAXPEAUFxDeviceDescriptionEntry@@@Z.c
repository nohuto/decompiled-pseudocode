/*
 * XREFs of ?ReenumerateEntry@FxChildList@@QEAAXPEAUFxDeviceDescriptionEntry@@@Z @ 0x1C0060148
 * Callers:
 *     ?AskParentToRemoveAndReenumerate@FxPkgPdo@@EEAAJXZ @ 0x1C0084340 (-AskParentToRemoveAndReenumerate@FxPkgPdo@@EEAAJXZ.c)
 * Callees:
