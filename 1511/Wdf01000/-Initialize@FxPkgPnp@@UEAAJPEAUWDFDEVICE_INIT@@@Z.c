/*
 * XREFs of ?Initialize@FxPkgPnp@@UEAAJPEAUWDFDEVICE_INIT@@@Z @ 0x1C0016240
 * Callers:
 ...
 *     ?RegisterCallbacks@FxPkgPnp@@QEAAJPEAU_WDF_PNPPOWER_EVENT_CALLBACKS@@@Z @ 0x1C0014810 (-RegisterCallbacks@FxPkgPnp@@QEAAJPEAU_WDF_PNPPOWER_EVENT_CALLBACKS@@@Z.c)
...
__int64 __fastcall FxPkgPnp::Initialize(FxPkgPnp *this, WDFDEVICE_INIT *DeviceInit)
{
        ...
        if ( (int)FxCalculateObjectTotalSize2(m_Globals, 0x98u, 0, 0LL, Size) >= 0 )
        {
          ...
          if ( v32 )
          {
            ...
            *(_DWORD *)&v32->m_ObjectFlags = 0x10000;
            ...
            v32->__vftable = (FxCmResList_vtbl *)&FxIoResList::`vftable';
              ...
              if ( v32->m_ObjectState == 1 )
              {
                ...
                else
                {
                  ...
                  if ( Driver->m_ObjectState == 1 )
                  {
                    ...
                    v32->m_ChildEntry.Flink = &Driver->m_ChildListHead;
      ...
      if ( v15->m_ObjectState == 1 )
      {
        ...
        else
        {
          ...
          if ( m_DeviceBase->m_ObjectState == 1 )
          {
            ...
            v15->m_ChildEntry.Flink = &m_DeviceBase->m_ChildListHead;
