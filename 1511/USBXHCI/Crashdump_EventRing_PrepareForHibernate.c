/*
 * XREFs of Crashdump_EventRing_PrepareForHibernate @ 0x1C0036DF0
 * Callers:
...
ULONG __fastcall Crashdump_EventRing_PrepareForHibernate(__int64 a1, __int64 a2)
{
  ...
  v2 = 0;
  v4 = **(_QWORD **)(a2 + 32);
  *(_QWORD *)(a1 + 72) = *(_QWORD *)(v4 + 144);
  v5 = *(_DWORD *)(v4 + 120);
  *(_DWORD *)(a1 + 80) = v5;
  *(_DWORD *)(a1 + 84) = *(_DWORD *)(v4 + 124);
  *(_DWORD *)(a1 + 88) = *(_DWORD *)(v4 + 128);
  *(_DWORD *)(a1 + 92) = *(_DWORD *)(v4 + 132);
  *(_DWORD *)(a1 + 96) = *(_DWORD *)(v4 + 136);
  *(_QWORD *)(a1 + 104) = *(_QWORD *)(v4 + 152);
  *(_OWORD *)(a1 + 112) = *(_OWORD *)(v4 + 168);
  v6 = *(_QWORD **)(a1 + 112);
  if ( v5 )
  {
    do
    {
      PoSetHiberRange(0LL, 0x10000u, v6, 0x50uLL, 0x43434858u);
