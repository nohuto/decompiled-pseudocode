/*
 * XREFs of Controller_WdfEvtDeviceFilterRemoveResourceRequirements @ 0x1C004AE70
 * Callers:
 *     <none>
 * Callees:
 ...
 *     Interrupter_DetermineSecondaryInterrupterCount @ 0x1C00517FC (Interrupter_DetermineSecondaryInterrupterCount.c)
