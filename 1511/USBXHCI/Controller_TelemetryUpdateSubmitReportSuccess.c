/*
 * XREFs of Controller_TelemetryUpdateSubmitReportSuccess @ 0x1C0050064
 * Callers:
...
__int64 __fastcall Controller_TelemetryUpdateSubmitReportSuccess(_QWORD *a1, int a2)
{
  ...
  v9 = 0LL;
  if ( (a2 & 0xFFFFEFC0) != 0 )
    WPP_RECORDER_SF_d(a1[8], 2u, 3u, 0xDFu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, a2);
  ...
  LODWORD(v7) = result;
  result = WPP_RECORDER_SF_d(a1[8], 3u, 3u, v6, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v7);
LABEL_14:
  if ( v9 )
