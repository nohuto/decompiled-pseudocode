/*
 * XREFs of Controller_TelemetryReportWorker @ 0x1C001F5A0
 * Callers:
 *     <none>
 * Callees:
...
LONG __fastcall Controller_TelemetryReportWorker(__int64 a1)
{
  ...
  v5 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
         ...
         a1,
         off_1C00412C8);
  WPP_RECORDER_SF_(v4[8], 4u, 3u, 0xD4u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
  ...
  *(_DWORD *)(v5 + 80) = 0;
  ...
  if ( v9 == -1073741789 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        WPP_RECORDER_SF_d(v4[8], 2u, 3u, 0xD7u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v12);
      }
      v14 = v11;
      goto LABEL_16;
    }
    WPP_RECORDER_SF_(v4[8], 2u, 3u, 0xD6u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
  }
  else
  {
    WPP_RECORDER_SF_d(v4[8], 2u, 3u, 0xD5u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v9);
  }
  while ( 1 )
  {
