/*
 * XREFs of Controller_WdfEvtTimerFunction @ 0x1C0004270
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Controller_WdfEvtTimerFunction(__int64 a1)
{
  ...
  if ( v5 == -1 )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(v2 + 64), 3, 3, 162, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
    LOBYTE(v25) = 1;
  ...
  {
    LOBYTE(v4) = 1;
    WPP_RECORDER_SF_(*(_QWORD *)(v2 + 64), v4, 3, 163, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
  ...
  {
    LOBYTE(v4) = 1;
    WPP_RECORDER_SF_(*(_QWORD *)(v2 + 64), v4, 3, 164, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
  ...
  else
  {
    if ( ++*(_DWORD *)(v2 + 292) == 60 )
    {
      *(_QWORD *)(v2 + 288) = 0LL;
      LOBYTE(v4) = 4;
      WPP_RECORDER_SF_(*(_QWORD *)(v2 + 64), v4, 3, 167, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
    }
    v6 = *(_QWORD *)(v3 + 88);
    if ( *(_QWORD *)(v6 + 232) )
    {
