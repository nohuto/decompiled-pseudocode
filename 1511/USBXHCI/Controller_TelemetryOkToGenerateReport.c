/*
 * XREFs of Controller_TelemetryOkToGenerateReport @ 0x1C004FE00
 * Callers:
...
char __fastcall Controller_TelemetryOkToGenerateReport(_QWORD *a1, __int64 a2, int a3)
{
  ...
  {
    WPP_RECORDER_SF_L(a1[8], 4u, 3u, 0xCDu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, a3);
    goto LABEL_24;
  }
  v6 = a3 - 4109;
  if ( !v6 )
...
LABEL_14:
    ...
    if ( (int)(v10 + 0x80000000) >= 0 && v10 != -1073741772 )
    {
      ...
      LODWORD(v13) = v10;
LABEL_15:
      WPP_RECORDER_SF_d(a1[8], 3u, 3u, v9, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v13);
      goto LABEL_24;
    }
  }
  else
