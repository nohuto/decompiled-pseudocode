/*
 * XREFs of RootHub_HandlePortStatusChangeEvent @ 0x1C0026EF4
 * Callers:
 ...
 *     RootHub_HideInvalidDebugPortStatusAndChange @ 0x1C0027060 (RootHub_HideInvalidDebugPortStatusAndChange.c)
 */
...
char __fastcall RootHub_HandlePortStatusChangeEvent(_QWORD *a1, __int64 a2)
{
  ...
  else
  {
    ...
    if ( !result )
      return ((__int64 (__fastcall *)(void *, _QWORD))qword_1C0042770)(WPP_MAIN_CB.Dpc.DpcData, *a1);
  }
  return result;
}
