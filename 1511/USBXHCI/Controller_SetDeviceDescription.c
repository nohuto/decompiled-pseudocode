/*
 * XREFs of Controller_SetDeviceDescription @ 0x1C004B870
 * Callers:
 ...
 *     RtlUnalignedStringCbLengthW @ 0x1C0009C98 (RtlUnalignedStringCbLengthW.c)
 *     RtlStringCbPrintfW @ 0x1C0009CFC (RtlStringCbPrintfW.c)
 *     RootHub_GetHighestUsbVersionSupported @ 0x1C0009DB0 (RootHub_GetHighestUsbVersionSupported.c)
...
LABEL_8:
    if ( RtlFindMessage(
           *(PVOID *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 24LL),
           ...
           &v38) < 0 )
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0x8Fu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
      return;
    }
    v7 = v38->Length - 4;
    pcbLength = v7;
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0x90u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
      return;
    }
...
LABEL_21:
        ...
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0x92u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
      }
      else
      {
        WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 4u, 3u, 0x93u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
        if ( RtlFindMessage(
               *(PVOID *)(*(_QWORD *)&WPP_MAIN_CB.Queue.Wcb.NumberOfMapRegisters + 24LL),
               0xBu,
               0,
