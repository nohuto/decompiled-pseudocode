/*
 * XREFs of Interrupter_AffinitizeMSIXDescriptors @ 0x1C0051648
 * Callers:
...
void __fastcall Interrupter_AffinitizeMSIXDescriptors(__int64 a1, __int64 a2, unsigned int a3)
{
  ...
  if ( v3 )
  {
    ...
    v8 = (*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, _QWORD))(WdfFunctions_01015 + 2328))(
           WdfDriverGlobals,
           a2,
           a3);
    v9 = 0;
    ...
    v11 = v8;
    for ( i = 0;
          i < (*(unsigned int (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64))(WdfFunctions_01015 + 2384))(
                WdfDriverGlobals,
                v11);
          ++i )
    {
      ...
      if ( *(_BYTE *)(v13 + 1) == 2 && (*(_BYTE *)(v13 + 4) & 3) == 3 )
      {
        ...
        (*(void (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, __int128 *, _QWORD))(WdfFunctions_01015 + 2376))(
          WdfDriverGlobals,
          v11,
          &v19,
          i);
