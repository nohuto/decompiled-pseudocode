/*
 * XREFs of WPP_RECORDER_SF_DDDDL @ 0x1C002C698
 * Callers:
 *     Isoch_ProcessSegment @ 0x1C002B490 (Isoch_ProcessSegment.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_DDDDL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 2u )
    (*(void (__fastcall **)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
      ...
      0LL);
  LOWORD(v7) = 29;
  return WppAutoLogTrace(a1, 2LL, 13LL, &WPP_1085b84f9451ac90e0467fe3bd281904_Traceguids, v7, (__int64 *)va);
}
