/*
 * XREFs of WPP_RECORDER_SF_DDqqDD @ 0x1C002D064
 * Callers:
...
__int64 WPP_RECORDER_SF_DDqqDD(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x1000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    (*(void (__fastcall **)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
      WPP_GLOBAL_Control->AttachedDevice,
      43LL,
      &WPP_1085b84f9451ac90e0467fe3bd281904_Traceguids,
      47LL,
      (__int64 *)va,
      4LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 47;
  return WppAutoLogTrace(a1, 4LL, 13LL, &WPP_1085b84f9451ac90e0467fe3bd281904_Traceguids, v7, (__int64 *)va);
}
