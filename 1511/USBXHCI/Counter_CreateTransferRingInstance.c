/*
 * XREFs of Counter_CreateTransferRingInstance @ 0x1C0052968
 * Callers:
...
NTSTATUS __fastcall Counter_CreateTransferRingInstance(__int64 *a1, int a2, PPCW_INSTANCE *a3)
{
  ...
  if ( *(_BYTE *)(WPP_MAIN_CB.Dpc.ProcessorHistory + 28) && !a3[4] )
  {
    v5 = *a1;
    ...
    v10.Data = a3;
    v10.Size = 40;
    return PcwCreateInstance(a3 + 4, (PPCW_REGISTRATION)WPP_MAIN_CB.Dpc.SystemArgument1, &DestinationString, 1u, &v10);
  }
  return result;
}
