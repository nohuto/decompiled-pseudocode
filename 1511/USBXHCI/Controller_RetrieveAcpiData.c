/*
 * XREFs of Controller_RetrieveAcpiData @ 0x1C004F7C0
 * Callers:
...
__int64 __fastcall Controller_RetrieveAcpiData(__int64 a1, __int64 a2, char *a3)
{
  ...
  if ( v7 == -2147483643 )
  {
    ...
    if ( PoolWithTag )
    {
      ...
      {
        LODWORD(v16) = v13;
        WPP_RECORDER_SF_d(a2, 2u, 3u, 0x8Du, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v16);
      }
      if ( v12 != v20 )
    ...
    {
      LODWORD(v15) = v9;
      WPP_RECORDER_SF_d(a2, 2u, 3u, 0x8Cu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v15);
  ...
  {
    LODWORD(v15) = v7;
    WPP_RECORDER_SF_d(a2, 2u, 3u, 0x8Bu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v15);
  }
  return v8;
}
