/*
 * XREFs of Bulk_ProcessStreamOnEndpointStopOrHalt @ 0x1C002DFE0
 * Callers:
 *     Bulk_EP_EndpointHalted @ 0x1C002D970 (Bulk_EP_EndpointHalted.c)
 *     Bulk_EP_FSEReceived @ 0x1C002D9D0 (Bulk_EP_FSEReceived.c)
 * Callees:
