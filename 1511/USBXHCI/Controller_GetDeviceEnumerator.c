/*
 * XREFs of Controller_GetDeviceEnumerator @ 0x1C004AB90
 * Callers:
...
__int64 __fastcall Controller_GetDeviceEnumerator(__int64 a1, __int64 a2)
{
  ...
  {
    v8 = DeviceProperty;
    WPP_RECORDER_SF_d(a2, 2u, 3u, 0x5Eu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v8);
  }
  ...
  LODWORD(v7) = v3;
  WPP_RECORDER_SF_L(a2, 4u, 3u, 0x5Fu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v7);
  return v3;
}
