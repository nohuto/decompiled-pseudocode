/*
 * XREFs of Endpoint_ControlEndpointResetCompletion @ 0x1C0020940
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall Endpoint_ControlEndpointResetCompletion(_QWORD *a1, int a2, _QWORD *a3)
{
  ...
  if ( a2 == 3 )
  {
    ...
    WPP_RECORDER_SF_dd(v3[10], 4u, 0xCu, 0x51u, (__int64)&WPP_abc35e7fa23aea6eb35de0ce9b7cef50_Traceguids, v12, v14);
  }
  else
  {
    v6 = *((_BYTE *)a1 + 68);
