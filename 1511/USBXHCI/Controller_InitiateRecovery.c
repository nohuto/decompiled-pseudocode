/*
 * XREFs of Controller_InitiateRecovery @ 0x1C001E69C
 * Callers:
...
char __fastcall Controller_InitiateRecovery(_QWORD *a1, __int64 a2, int a3)
{
  ...
  LOBYTE(v6) = WPP_RECORDER_SF_(a1[8], 4u, 3u, 0xDBu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
  if ( (a3 & 2) != 0 )
  {
    v6 = *((_DWORD *)a1 + 72);
    if ( v6 > 0xA )
  ...
  while ( a3 )
  {
    if ( (a3 & 0x18) != 0 )
    {
      if ( (*(_DWORD *)(a2 + 84) & 2) == 0 )
      {
        ...
        KeFlushQueuedDpcs();
        ((void (__fastcall *)(void *, _QWORD))qword_1C0042760)(WPP_MAIN_CB.Dpc.DpcData, a1[1]);
        if ( (a3 & 8) != 0 )
      ...
      {
        WPP_RECORDER_SF_(a1[8], 4u, 3u, 0xDDu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
        v10 = *a1;
        v14 = 0x200000002LL;
        v15 = 0x200000002LL;
        v13 = 28;
    ...
    {
      LOBYTE(v6) = ((__int64 (__fastcall *)(void *, _QWORD))qword_1C0042750)(WPP_MAIN_CB.Dpc.DpcData, a1[1]);
      a3 &= ~2u;
    }
    else
    {
