/*
 * XREFs of Controller_WdfEvtDeviceD0Exit @ 0x1C0004F40
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceD0Exit(__int64 a1, unsigned int a2)
{
  ...
  *(_DWORD *)(v4 + 280) = a2;
  ...
  else
  {
    ...
    RootHub_D0Exit(*(_QWORD *)(v4 + 120), a2, *(_DWORD *)(v4 + 300));
    ...
    {
      WPP_RECORDER_SF_(*(_QWORD *)(v4 + 64), 4u, 3u, 0x56u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
    }
    else
    {
