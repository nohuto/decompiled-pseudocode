/*
 * XREFs of Counter_Register @ 0x1C004C7EC
 * Callers:
...
NTSTATUS Counter_Register()
{
  ...
  if ( *(_BYTE *)(WPP_MAIN_CB.Dpc.ProcessorHistory + 28) )
  {
    ...
    Info.CounterCount = 6;
    PcwRegister((PPCW_REGISTRATION *)&WPP_MAIN_CB.Dpc.DeferredRoutine, &Info);
    v1 = 2359330;
    ...
    Info.Name = (const _UNICODE_STRING *)&v1;
    Info.CounterCount = 7;
    return PcwRegister((PPCW_REGISTRATION *)&WPP_MAIN_CB.Dpc.SystemArgument1, &Info);
  }
  return result;
}
