/*
 * XREFs of Controller_ConfigureSxWakeSettings @ 0x1C0048A14
 * Callers:
...
__int64 __fastcall Controller_ConfigureSxWakeSettings(__int64 *a1)
{
  ...
  {
    v5 = result;
    return WPP_RECORDER_SF_d(a1[8], 2u, 3u, 0x1Fu, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, v5);
  }
  return result;
}
