/*
 * XREFs of Control_MapTransfer @ 0x1C0001C24
 * Callers:
 ...
 *     Control_Transfer_ConfigureBuffer @ 0x1C0029890 (Control_Transfer_ConfigureBuffer.c)
  ...
  if ( v3 )
  {
    if ( !*(_BYTE *)(a1 + 272) || v3 > 8 || (*(_DWORD *)(v4 + 32) & 1) != 0 )
    {
      if ( (unsigned __int8)TR_IsUrbUsingChainedMdl(v4)
        || v6 > *(_DWORD *)(a1 + 24)
        || (v7 = TR_AcquireDoubleBuffer(a1), *(_QWORD *)(v1 + 72) = v7, v8 = v7 == 0, v5 = 2, v8) )
      {
        v5 = 3;
      }
    }
