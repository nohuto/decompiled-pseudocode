/*
 * XREFs of Crashdump_UsbDevice_ResetPort @ 0x1C0038CB8
 * Callers:
 *     Crashdump_InitializeWithControllerReset @ 0x1C0034FD0 (Crashdump_InitializeWithControllerReset.c)
 *     Crashdump_ResetDevice @ 0x1C00354A0 (Crashdump_ResetDevice.c)
 * Callees:
 *     Crashdump_UsbDevice_ChangePortFeature @ 0x1C0037DF8 (Crashdump_UsbDevice_ChangePortFeature.c)
