/*
 * XREFs of Crashdump_CommonBufferAcquire @ 0x1C003490C
 * Callers:
 ...
 *     Crashdump_Endpoint_Initialize @ 0x1C0037480 (Crashdump_Endpoint_Initialize.c)
 *     Crashdump_UsbDevice_Initialize @ 0x1C00388E4 (Crashdump_UsbDevice_Initialize.c)
 * Callees:
...
__int64 __fastcall Crashdump_CommonBufferAcquire(__int64 a1, int a2, __int64 a3)
{
  ...
  {
    v6 = 0;
    if ( !*(_DWORD *)(a1 + 508) || ((v7 = *(_DWORD *)(a1 + 512) & 0xFFF) != 0 ? (v8 = 4096 - v7) : (v8 = 0), v4 > v8) )
    {
      v9 = CommonBuffer_AcquireBuffer(*(KSPIN_LOCK **)(a1 + 480), 0x1000u, a1, 0x31706D44u);
      if ( !v9 )
        return (unsigned int)-1073741670;
      v10 = *(_QWORD *)(a1 + 488);
      *v9 = v10;
      v9[1] = a1 + 488;
      if ( *(_QWORD *)(v10 + 8) != a1 + 488 )
        __fastfail(3u);
      *(_QWORD *)(v10 + 8) = v9;
      *(_QWORD *)(a1 + 488) = v9;
      ++*(_DWORD *)(a1 + 504);
    ...
    *(_DWORD *)(a3 + 16) = v4;
    v12 = *(_QWORD *)(v11 + 16);
    *(_QWORD *)(a3 + 8) = v12;
    *(_QWORD *)(a3 + 8) = v12 + *(unsigned int *)(a1 + 512);
    v13 = *(_QWORD *)(v11 + 24);
    *(_QWORD *)a3 = v13;
    *(_QWORD *)a3 = v13 + *(unsigned int *)(a1 + 512);
    *(_DWORD *)(a1 + 508) += v4;
    *(_DWORD *)(a1 + 512) += v4;
    DbgPrintEx(
      0x93u,
