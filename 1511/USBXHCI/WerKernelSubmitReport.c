/*
 * XREFs of WerKernelSubmitReport @ 0x1C003B2BC
 * Callers:
 ...
 *     StringCchCopyNW @ 0x1C003AFC0 (StringCchCopyNW.c)
 *     WerStartSystemErrorHandler @ 0x1C003B818 (WerStartSystemErrorHandler.c)
 *     WerWaitForSystemErrorHandler @ 0x1C003B920 (WerWaitForSystemErrorHandler.c)
 *     WerpAllocateAndInitializeSid @ 0x1C003B9C8 (WerpAllocateAndInitializeSid.c)
 *     WerpFreeMem @ 0x1C003BBFC (WerpFreeMem.c)
 *     WerpGetRegistryKey @ 0x1C003BC14 (WerpGetRegistryKey.c)
 *     WerpParseKeyName @ 0x1C003BCF4 (WerpParseKeyName.c)
 */
