/*
 * XREFs of Controller_WdfEvtDeviceArmWakeFromS0 @ 0x1C001FA10
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall Controller_WdfEvtDeviceArmWakeFromS0(__int64 a1)
{
  ...
  v2 = *(_QWORD *)((*(__int64 (__fastcall **)(PWDF_DRIVER_GLOBALS, __int64, void *))(WdfFunctions_01015 + 1616))(
                 ...
                 + 8);
  v3 = *(_QWORD *)(v2 + 120);
  WPP_RECORDER_SF_q(*(_QWORD *)(v2 + 64), 4u, 3u, 0x59u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids, a1);
  v4 = 0;
