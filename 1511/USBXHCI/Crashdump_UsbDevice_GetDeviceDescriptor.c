/*
 * XREFs of Crashdump_UsbDevice_GetDeviceDescriptor @ 0x1C003854C
 * Callers:
...
__int64 __fastcall Crashdump_UsbDevice_GetDeviceDescriptor(_QWORD *a1, unsigned __int8 **a2)
{
  ...
  v3 = *a1;
  memset(*(void **)(*a1 + 440LL), 0, *(unsigned int *)(*a1 + 448LL));
  v4 = a1[19];
  v5 = *(unsigned __int8 **)(v3 + 440);
  v8 = 0x40000001000680LL;
  LODWORD(v8) = Crashdump_Endpoint_SendControlTransfer(v4, &v8, 18, (_QWORD *)(v3 + 432));
  v6 = v8;
  if ( (int)v8 >= 0 )
  {
    DbgPrintEx(
