/*
 * XREFs of Crashdump_InitializeWithControllerReset @ 0x1C0034FD0
 * Callers:
 *     Crashdump_Initialize @ 0x1C0034B70 (Crashdump_Initialize.c)
 * Callees:
 *     Crashdump_Register_LogRHPortInfo @ 0x1C0035F44 (Crashdump_Register_LogRHPortInfo.c)
 *     Crashdump_Register_ResetController @ 0x1C0036080 (Crashdump_Register_ResetController.c)
 *     Crashdump_Register_ResetPort @ 0x1C0036134 (Crashdump_Register_ResetPort.c)
 *     Crashdump_Register_StartController @ 0x1C0036488 (Crashdump_Register_StartController.c)
 *     Crashdump_Register_UpdateDeviceSlotInfo @ 0x1C00365E4 (Crashdump_Register_UpdateDeviceSlotInfo.c)
 ...
 *     Crashdump_UsbDevice_GetPortType @ 0x1C003884C (Crashdump_UsbDevice_GetPortType.c)
...
__int64 __fastcall Crashdump_InitializeWithControllerReset(__int64 a1)
{
  ...
  *(_BYTE *)(a1 + 616) = 1;
  ...
  if ( v2 >= 0 )
  {
    ...
    Crashdump_EventRing_PrepareForDump(a1 + 64);
    v6 = Crashdump_Command_PrepareForDump(a1 + 320);
    v3 = v6;
    if ( v6 >= 0 )
    {
      ...
      if ( started >= 0 )
      {
        Crashdump_Register_LogRHPortInfo(a1, *(unsigned int *)(a1 + 536));
        v8 = Crashdump_Command_TestCommandRingOperation(a1 + 320);
        v3 = v8;
        if ( v8 >= 0 )
        {
          v9 = 0LL;
          if ( *(_DWORD *)(a1 + 528) )
          {
            while ( 1 )
            {
              ...
              if ( (_DWORD)v9 )
              {
                ...
                else
                {
                  PortType = Crashdump_UsbDevice_GetPortType(
                               *(_QWORD *)(a1 + 560) + 408 * v11,
                               *(unsigned int *)(a1 + 4LL * (unsigned int)(v9 - 1) + 536),
                               &v21);
                  v3 = PortType;
                  if ( PortType < 0 )
                  {
              ...
              v3 = Crashdump_UsbDevice_ReConfigureOnControllerReset(
                     *(_QWORD *)(a1 + 560) + 408LL * (unsigned int)v9,
                     v12);
              if ( (v3 & 0x80000000) == 0 )
              {
                v9 = (unsigned int)(v9 + 1);
                if ( (unsigned int)v9 < *(_DWORD *)(a1 + 528) )
                  continue;
              }
              return v3;
            }
