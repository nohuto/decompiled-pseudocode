/*
 * XREFs of Controller_TelemetryReport @ 0x1C001F240
 * Callers:
 ...
 *     TelemetryData_InsertTriageDataBlock @ 0x1C003AD3C (TelemetryData_InsertTriageDataBlock.c)
...
void __fastcall Controller_TelemetryReport(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4, unsigned int a5)
{
  ...
  *(_QWORD *)&pszDest[32] = a1;
  ...
  if ( !Report )
  {
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0xD2u, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
    return;
  }
