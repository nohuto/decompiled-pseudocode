/*
 * XREFs of Endpoint_SM_CompleteResetRequestFromClient @ 0x1C00233AC
 * Callers:
 *     Endpoint_SM_OkToCompleteEndpointResetRequest @ 0x1C002343C (Endpoint_SM_OkToCompleteEndpointResetRequest.c)
 *     ESM_CompletingResetRequestWhenEndpointNotHalted @ 0x1C003A2C0 (ESM_CompletingResetRequestWhenEndpointNotHalted.c)
 * Callees:
