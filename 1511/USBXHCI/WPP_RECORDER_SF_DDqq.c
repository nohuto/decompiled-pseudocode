/*
 * XREFs of WPP_RECORDER_SF_ddqq @ 0x1C0032BFC
 * Callers:
...
__int64 WPP_RECORDER_SF_ddqq(__int64 a1, _DWORD a2, _DWORD a3, _DWORD a4, __int64 a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x400) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 5u )
    (*(void (__fastcall **)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
      ...
      0LL);
  LOWORD(v7) = 62;
  return WppAutoLogTrace(a1, 5LL, 11LL, &WPP_87fc70acbba44992ba40c6b485cfec47_Traceguids, v7, (__int64 *)va);
}
