/*
 * XREFs of WPP_RECORDER_SF_qLLL @ 0x1C0039FCC
 * Callers:
 ...
 *     ESM_FindAndSetTargetState @ 0x1C0039898 (ESM_FindAndSetTargetState.c)
 * Callees:
...
__int64 WPP_RECORDER_SF_qLLL(__int64 a1, __int64 a2, __int64 a3, __int64 a4, int a5, ...)
{
  ...
  if ( (HIDWORD(WPP_GLOBAL_Control->Timer) & 0x8000) != 0 && BYTE1(WPP_GLOBAL_Control->Timer) >= 4u )
    (*(void (__fastcall **)(_DEVICE_OBJECT *, __int64, void *, __int64, __int64 *, __int64, __int64 *, __int64, __int64 *, __int64, char *, __int64, _QWORD))&WPP_MAIN_CB.Dpc.TargetInfoAsUlong)(
      ...
      43LL,
      &WPP_6899952d98f15f214358840d05b5a2ec_Traceguids,
      12LL,
      (__int64 *)va,
      8LL,
      (__int64 *)va1,
      ...
      0LL);
  LOWORD(v7) = 12;
  return WppAutoLogTrace(a1, 4LL, 16LL, &WPP_6899952d98f15f214358840d05b5a2ec_Traceguids, v7, (__int64 *)va);
}
