/*
 * XREFs of UsbDevice_InitializeEndpointContext @ 0x1C0030B74
 * Callers:
 ...
 *     Endpoint_GetMaxPrimaryStreams @ 0x1C0021DB0 (Endpoint_GetMaxPrimaryStreams.c)
 */
...
__int64 __fastcall UsbDevice_InitializeEndpointContext(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  *(_WORD *)(a3 + 6) = *(_WORD *)(a2 + 100) & 0x7FF;
  v7 = *(_BYTE *)(a2 + 99) & 3;
  if ( v7 == 1
    || (*(_QWORD *)(*(_QWORD *)a2 + 232LL) & 0x10000000000000LL) != 0
    && v7 == 3
    && *(char *)(a2 + 98) < 0
