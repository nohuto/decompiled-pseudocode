/*
 * XREFs of Endpoint_SM_AcknowledgeControllerResetComplete @ 0x1C002337C
 * Callers:
 *     ESM_AcknowledgingControllerResetCompleteInDisabled @ 0x1C003A0E0 (ESM_AcknowledgingControllerResetCompleteInDisabled.c)
 * Callees:
 *     <none>
 */
