/*
 * XREFs of Controller_PopulateDeviceFlagsFromKse @ 0x1C0008A30
 * Callers:
 ...
 *     RtlStringCchPrintfW @ 0x1C0008CA0 (RtlStringCchPrintfW.c)
...
__int64 __fastcall Controller_PopulateDeviceFlagsFromKse(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( !WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc )
    return WPP_RECORDER_SF_S(*(_QWORD *)(a1 + 64), 3u, a3, 0x9Eu, v14, pszDest);
  if ( *(_DWORD *)(a1 + 148) == 1 )
  {
  ...
  if ( ((int (__fastcall *)(wchar_t *, const wchar_t *, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(
         ...
         &v20) >= 0 )
  {
    WPP_RECORDER_SF_xS(*(_QWORD *)(a1 + 64), v5, v6, 152, v15, v20, (__int64)pszDest);
    v3 = 1;
    *(_QWORD *)(a1 + 232) |= v20;
  }
  if ( *(_DWORD *)(a1 + 148) == 1 )
  ...
  if ( ((int (__fastcall *)(wchar_t *, const wchar_t *, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(
         ...
         &v18) >= 0 )
  {
    WPP_RECORDER_SF_xS(*(_QWORD *)(a1 + 64), v7, a3, 153, v14, v18, (__int64)pszDest);
    v3 = 1;
    *(_QWORD *)(a1 + 232) |= v18;
  }
  if ( *(_QWORD *)(a1 + 224) != -1LL )
  {
    ...
    if ( ((int (__fastcall *)(wchar_t *, const wchar_t *, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(
           ...
           &v16) >= 0 )
    {
      WPP_RECORDER_SF_xS(*(_QWORD *)(a1 + 64), v11, a3, 154, v14, v16, (__int64)pszDest);
      v3 = 1;
      *(_QWORD *)(a1 + 232) |= v16;
    }
  }
  if ( *(_DWORD *)(a1 + 148) == 1 )
  {
    ...
    if ( ((int (__fastcall *)(wchar_t *, const wchar_t *, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(
           ...
           &v17) >= 0 )
    {
      WPP_RECORDER_SF_xS(*(_QWORD *)(a1 + 64), v8, a3, 155, v14, v17, (__int64)pszDest);
      v3 = 1;
      *(_QWORD *)(a1 + 232) |= v17;
    }
    if ( *(_DWORD *)(a1 + 148) == 1 )
    {
      ...
      if ( ((int (__fastcall *)(wchar_t *, const wchar_t *, __int64 *))WPP_MAIN_CB.Queue.Wcb.BufferChainingDpc)(
             ...
             &v19) >= 0 )
      {
        WPP_RECORDER_SF_xS(*(_QWORD *)(a1 + 64), v9, a3, 156, v14, v19, (__int64)pszDest);
        v3 = 1;
        *(_QWORD *)(a1 + 232) |= v19;
      }
    }
  ...
  else
  {
    if ( (result & 0x1000000) == 0 )
      goto LABEL_19;
    WPP_RECORDER_SF_(*(_QWORD *)(a1 + 64), 2u, 3u, 0x9Du, (__int64)&WPP_a6e1c58309a3d9966a339d413262311d_Traceguids);
