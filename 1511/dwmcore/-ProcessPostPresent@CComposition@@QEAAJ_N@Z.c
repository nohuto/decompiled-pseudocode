/*
 * XREFs of ?ProcessPostPresent@CComposition@@QEAAJ_N@Z @ 0x180095920
 * Callers:
...
__int64 __fastcall CComposition::ProcessPostPresent(CComposition *this, char a2)
{
  ...
  *(_DWORD *)(v6 + 336) = 0;
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x6F6u);
    goto LABEL_25;
  }
  v9 = *((_QWORD *)v4 + 4);
  v10 = 0;
  ...
  if ( *(_DWORD *)(v9 + 48) )
  {
    ...
    do
    {
      ...
      if ( v15 == CHwndRenderTarget::IsOfType )
        v16 = CHwndRenderTarget::IsOfType(v14, 37);
      else
        v16 = v15(*(_QWORD *)(v13 + *(_QWORD *)(v9 + 24)), 37);
      v17 = !v16;
      v18 = *(_QWORD *)(v9 + 24);
      if ( v17 )
      {
    ...
    v7 = (int)hEvent;
    if ( v11 )
      SetEvent(*(HANDLE *)(*((_QWORD *)v39 + 63) + 96LL));
    v3 = v40;
  }
  ...
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x704u);
    goto LABEL_25;
  }
  v22 = *((_QWORD *)v4 + 43);
  if ( v22 )
  ...
  v23 = (_QWORD *)*((_QWORD *)v4 + 62);
  v39 = v19;
  v7 = 0;
  v24 = NtDCompositionDiscardFrame(*v23, &v39);
  if ( v24 < 0 )
  {
    v7 = v24 | 0x10000000;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v24 | 0x10000000, 0xA2u);
  }
  if ( v7 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x716u);
    goto LABEL_25;
  }
LABEL_24:
  if ( *((_DWORD *)v4 + 182) )
...
LABEL_25:
  ...
  if ( v25 )
  {
    v37 = (*(__int64 (__fastcall **)(_QWORD, bool))(**(_QWORD **)(v25 + 24) + 96LL))(*(_QWORD *)(v25 + 24), v3 == 0);
    v38 = v37;
    if ( v37 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v37, 0x722u);
    if ( !v7 || v7 >= 0 && v38 < 0 )
