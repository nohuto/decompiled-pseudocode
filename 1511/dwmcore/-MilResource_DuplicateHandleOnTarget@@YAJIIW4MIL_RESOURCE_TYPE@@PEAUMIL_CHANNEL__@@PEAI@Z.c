/*
 * XREFs of ?MilResource_DuplicateHandleOnTarget@@YAJIIW4MIL_RESOURCE_TYPE@@PEAUMIL_CHANNEL__@@PEAI@Z @ 0x1800B1B80
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall MilResource_DuplicateHandleOnTarget(int a1, int a2, int a3, __int64 a4, _DWORD *a5)
{
  _DWORD *v9; // rdi
  __int64 v10; // rcx
  int v11; // eax
