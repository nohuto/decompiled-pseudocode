/*
 * XREFs of ?GetBounds@CHwDisplayRenderTarget@@UEAAXPEAUMilRectF@@@Z @ 0x180081B00
 * Callers:
 *     ?GetBounds@CHwDisplayRenderTarget@@WLA@EAAXPEAUMilRectF@@@Z @ 0x1800BDE40 (-GetBounds@CHwDisplayRenderTarget@@WLA@EAAXPEAUMilRectF@@@Z.c)
 * Callees:
