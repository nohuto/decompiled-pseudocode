/*
 * XREFs of ?SetD2DEffectProperties@CTurbulenceEffect@@MEAAJPEAUID2D1Effect@@@Z @ 0x180133CC0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CTurbulenceEffect::SetD2DEffectProperties(CTurbulenceEffect *this, struct ID2D1Effect *a2)
{
  ...
  if ( v5 >= 0 )
  {
    ...
    v16 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 50), (__m128)*((unsigned int *)this + 51)).m128_u64[0];
    v8 = v7(a2, 2LL, 0LL, &v16, 8);
    v6 = v8;
    if ( v8 >= 0 )
    {
      v9 = *(__int64 (__fastcall **)(struct ID2D1Effect *, __int64, _QWORD, unsigned __int64 *, int))(*(_QWORD *)a2 + 72LL);
      v16 = _mm_unpacklo_ps((__m128)*((unsigned int *)this + 52), (__m128)*((unsigned int *)this + 53)).m128_u64[0];
