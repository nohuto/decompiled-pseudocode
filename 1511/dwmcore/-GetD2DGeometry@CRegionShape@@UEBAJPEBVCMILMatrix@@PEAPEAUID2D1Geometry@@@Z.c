/*
 * XREFs of ?GetD2DGeometry@CRegionShape@@UEBAJPEBVCMILMatrix@@PEAPEAUID2D1Geometry@@@Z @ 0x18004E2D0
 * Callers:
        ...
        struct ID2D1Geometry **a3)
{
  ...
  int *v7; // r14
  __int64 v8; // rdi
  void (*v9)(WPF::ProcessHeapImpl *__hidden, void *); // rbx
  ...
  if ( a2 )
  {
    ...
    if ( !is_mul_ok(RectCount, 0x10uLL) )
      v12 = -1LL;
    v13 = (CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                                        WPF::g_pProcessHeap,
                                                        v12);
    v7 = (int *)v13;
    if ( v13 )
...
LABEL_7:
  ...
  {
    ((void (__fastcall *)(WPF::ProcessHeapImpl *, int *))v9)(WPF::g_pProcessHeap, v7);
  }
  return v6;
}
