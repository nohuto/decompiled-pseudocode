/*
 * XREFs of ?RemoveUnbackedSurfaces@COverlayContext@@AEAAXAEAV?$DynArray@PEAUOverlayPlaneInfo@COverlayContext@@$0A@@@@Z @ 0x180111950
 * Callers:
...
__int64 __fastcall COverlayContext::RemoveUnbackedSurfaces(__int64 a1, __int64 a2)
{
  ...
  for ( i = 0LL; (unsigned int)i < v2; i = (unsigned int)(i + 1) )
  {
    ...
    if ( *(_BYTE *)(v5 + 161) && *(_BYTE *)(v5 + 165) )
    {
      ...
      {
        result = v6;
        if ( *(_QWORD *)(v5 + 168) == **(_QWORD **)(*(_QWORD *)a2 + 8LL * v6) )
          break;
        if ( ++v6 >= v2 )
          goto LABEL_9;
      }
