/*
 * XREFs of ?TryFastWarpLock@CBitmapOfDeviceBitmaps@@AEAA_NAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAPEAEPEAI2PEAPEAUIUnknown@@@Z @ 0x1801496C0
 * Callers:
 ...
 * Callees:
 *     ?GetSingleContributorToRealizationAreaNoRef@CBitmapOfDeviceBitmaps@@QEAA_NAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@AEAPEAVCHwDeviceBitmapColorSource@@@Z @ 0x1800F3514 (-GetSingleContributorToRealizationAreaNoRef@CBitmapOfDeviceBitmaps@@QEAA_NAEBV-$TMilRect@IUMilRe.c)
        ...
        _QWORD *a6)
{
  ...
  *a4 = 0;
  ...
  {
    a5 = 0LL;
    if ( CWarpLockSubresource::Create(*(struct CD3DVidMemOnlyTexture **)(v17 + 160), &a5) >= 0 )
    {
      v12 = a5;
      v7 = 1;
      v13 = *(_DWORD *)(a1 + 188);
