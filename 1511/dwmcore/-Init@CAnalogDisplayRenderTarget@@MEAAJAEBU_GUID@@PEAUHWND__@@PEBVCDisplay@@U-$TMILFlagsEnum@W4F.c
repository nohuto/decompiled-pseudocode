/*
 * XREFs of ?Init@CAnalogDisplayRenderTarget@@MEAAJAEBU_GUID@@PEAUHWND__@@PEBVCDisplay@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@@Z @ 0x18013DEB0
 * Callers:
 *     <none>
 * Callees:
        ...
        int a5)
{
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0xB3u);
  return v7;
}
