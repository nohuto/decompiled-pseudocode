/*
 * XREFs of ?CalcEdgesAndControlPoints@CRoundedRectangleShape@@AEBAXPEAUMilPoint2F@@PEA_NPEAH@Z @ 0x1801592D8
 * Callers:
        ...
        int *a4)
{
  ...
  *((_QWORD *)&v30 + 1) = __PAIR64__(LODWORD(v7), LODWORD(v6));
  ...
  v16 = (CBaseMatrix *)*((_QWORD *)this + 8);
  if ( v16 )
  {
    CBaseMatrix::Transform(v16, (const struct MilPoint2F *)&v25, a2, 20);
  }
  else
  {
    v17 = v26;
