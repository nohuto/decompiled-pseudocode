/*
 * XREFs of ?Max@CExpressionValueStack@@QEAAJXZ @ 0x18011C9C0
 * Callers:
...
__int64 __fastcall CExpressionValueStack::Max(CExpressionValueStack *this)
{
  ...
  __m128 v20; // [rsp+30h] [rbp-40h]
  __int64 v21; // [rsp+30h] [rbp-40h]
  __m128i v22; // [rsp+40h] [rbp-30h]
  ...
  if ( v1 >= 2 )
  {
    ...
    if ( *(_DWORD *)v5 == *(_DWORD *)(v4 + 8 * v6) )
    {
      switch ( LODWORD(v7) )
      {
        ...
        case 0x23:
          v26 = *((_QWORD *)v5 + 1);
          v15 = (__m128)HIDWORD(v26);
          v25 = *(_QWORD *)(v4 + 8 * v6 + 8);
          if ( *((float *)&v26 + 1) <= *((float *)&v25 + 1) )
            v15 = (__m128)HIDWORD(v25);
          v16 = (__m128)(unsigned int)v26;
          if ( *(float *)&v26 <= *(float *)&v25 )
            v16 = (__m128)(unsigned int)v25;
          CExpressionValue::SetDataType(v5);
          *((_QWORD *)v5 + 1) = _mm_unpacklo_ps(v16, v15).m128_u64[0];
          break;
        case 0x34:
          v24 = *((_QWORD *)v5 + 1);
          v21 = *(_QWORD *)(v4 + 8 * v6 + 8);
          v12 = v5[4];
          if ( v12 <= *(float *)(v4 + 8 * v6 + 16) )
            v12 = *(float *)(v4 + 8 * v6 + 16);
          v13 = (__m128)HIDWORD(v24);
          if ( *((float *)&v24 + 1) <= *((float *)&v21 + 1) )
            v13 = (__m128)HIDWORD(v21);
          v14 = (__m128)(unsigned int)v24;
          if ( *(float *)&v24 <= *(float *)&v21 )
          ...
          *((_QWORD *)v5 + 1) = _mm_unpacklo_ps(v14, v13).m128_u64[0];
          ...
          break;
        case 0x45:
          v20 = (__m128)_mm_loadu_si128((const __m128i *)(v5 + 2));
          v22 = _mm_loadu_si128((const __m128i *)(v4 + 8 * v6 + 8));
          v8 = _mm_shuffle_ps(v20, v20, 255).m128_f32[0];
          if ( v8 <= *(float *)(v4 + 8 * v6 + 20) )
            v8 = *(float *)(v4 + 8 * v6 + 20);
          v9 = v20.m128_i32[2];
          if ( v20.m128_f32[2] <= *(float *)&v22.m128i_i32[2] )
            v9 = v22.m128i_i32[2];
          v10 = v20.m128_i32[1];
          if ( v20.m128_f32[1] <= *(float *)&v22.m128i_i32[1] )
            v10 = v22.m128i_i32[1];
          v11 = v20.m128_i32[0];
          if ( v20.m128_f32[0] <= *(float *)v22.m128i_i32 )
            v11 = v22.m128i_i32[0];
          *(_QWORD *)&v23 = __PAIR64__(v10, v11);
          *((_QWORD *)&v23 + 1) = __PAIR64__(LODWORD(v8), v9);
          CExpressionValue::SetDataType(v5);
          *(_OWORD *)(v5 + 2) = v23;
          break;
        default:
