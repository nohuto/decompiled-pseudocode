/*
 * XREFs of ??0CDxHandleStereoBitmapRealization@@IEAA@AEBU_GUID@@AEBUCSM_BUFFER_ATTRIBUTES@@AEBUCSM_REALIZATION_INFO@@@Z @ 0x18015CA2C
 * Callers:
        ...
        const struct CSM_REALIZATION_INFO *a4)
{
  ...
  *((_QWORD *)this + 62) = &CDxHandleAdvancedDirectFlipBitmapRealization::`vftable'{for `ID2DBitmapCache'};
