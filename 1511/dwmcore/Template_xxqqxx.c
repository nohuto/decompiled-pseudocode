/*
 * XREFs of Template_xxqqxx @ 0x18014ABFC
 * Callers:
...
ULONG Template_xxqqxx(__int64 a1, __int64 a2, ...)
{
  ...
  *(_QWORD *)&UserData.Size = 8LL;
  ...
  v11 = 8LL;
  v13 = 8LL;
  return EventWrite(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_DETECT_REMOTEAPPWINDOW_STATE, 6u, &UserData);
}
