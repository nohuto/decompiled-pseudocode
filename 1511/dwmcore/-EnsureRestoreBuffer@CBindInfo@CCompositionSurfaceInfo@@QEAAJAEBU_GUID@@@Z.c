/*
 * XREFs of ?EnsureRestoreBuffer@CBindInfo@CCompositionSurfaceInfo@@QEAAJAEBU_GUID@@@Z @ 0x180130280
 * Callers:
        ...
        struct _GUID *a2)
{
  ...
  v2 = 0;
  v3 = (CCompositionSurfaceInfo::CBindInfo *)((char *)this + 80);
  if ( !*((_QWORD *)this + 10) )
  {
    v19 = 0;
    v18 = 0;
    ...
    *(_QWORD *)v13 = "DWM Rendertarget (DFlip+ restore buffer)";
    ...
    v10 = (*(__int64 (__fastcall **)(__int64))(*(_QWORD *)v8 + 120LL))(v8);
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, RenderTargetBitmap, 0x6B0u);
    }
  }
  return v2;
}
