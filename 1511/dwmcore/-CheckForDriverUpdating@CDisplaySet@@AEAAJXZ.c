/*
 * XREFs of ?CheckForDriverUpdating@CDisplaySet@@AEAAJXZ @ 0x18006FA84
 * Callers:
  ...
  *((_BYTE *)this + 112) = 0;
  if ( *((_DWORD *)this + 18) )
  {
    while ( 1 )
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, AdapterNoRefFromLuid, 0x19Cu);
      }
      else
      {
        v8 = v15;
      ...
      *((_BYTE *)this + 112) = 0;
      v12 = CDXGIEnumeration::GetAdapterNoRefFromLuid(v10, v11[29], &v16);
      v1 = v12;
      if ( v12 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x126u);
      }
      else if ( v16 )
      {
      ...
      if ( v1 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v1, 0x51Fu);
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v1, 0x51Du);
  }
  return (unsigned int)v1;
}
