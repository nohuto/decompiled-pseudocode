/*
 * XREFs of ?AddToPreviousFrameInvalidRegion@CHwFullScreenRenderTarget@@MEAAJAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180074310
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( *(_QWORD *)(a1 + 336) )
  {
    ...
    if ( RectRgn )
    {
      ...
      if ( !CombineRgn(*(HRGN *)(a1 + 336), *(HRGN *)(a1 + 336), RectRgn, 2) )
      {
        ...
        if ( v2 >= 0 )
          v2 = -2003304445;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x408u);
      }
    ...
    else
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x403u);
    }
  }
  else
  {
    ...
    *(_QWORD *)(a1 + 336) = v7;
    if ( !v7 )
    {
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v2, 0x3FCu);
    }
  }
