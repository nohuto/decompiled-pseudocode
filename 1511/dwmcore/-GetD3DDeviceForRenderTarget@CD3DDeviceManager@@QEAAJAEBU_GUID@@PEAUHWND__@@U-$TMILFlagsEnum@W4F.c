/*
 * XREFs of ?GetD3DDeviceForRenderTarget@CD3DDeviceManager@@QEAAJAEBU_GUID@@PEAUHWND__@@U?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@U_LUID@@PEAPEAVCD3DDeviceLevel1@@@Z @ 0x1800712FC
 * Callers:
...
LABEL_14:
    MilInstrumentationCheckHR(0x14u, &dword_18016FE48, 1u, v13, v14);
    goto LABEL_4;
  }
  if ( (v16 & 0x10) == 0 )
  {
...
LABEL_4:
  CGuard<CCriticalSection>::~CGuard<CCriticalSection>(&a6);
  return v11;
}
