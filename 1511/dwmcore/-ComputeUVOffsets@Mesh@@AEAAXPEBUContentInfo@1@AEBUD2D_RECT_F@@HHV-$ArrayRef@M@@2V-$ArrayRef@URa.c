/*
 * XREFs of ?ComputeUVOffsets@Mesh@@AEAAXPEBUContentInfo@1@AEBUD2D_RECT_F@@HHV?$ArrayRef@M@@2V?$ArrayRef@URampPair@CoordMap@@@@3V4@4@Z @ 0x180118C3C
 * Callers:
 ...
 * Callees:
 *     ?ComputeSourceOffsets@Mesh@@CAXMMMMV?$ArrayRef@M@@V?$ArrayRef@URampPair@CoordMap@@@@V2@@Z @ 0x1801189C0 (-ComputeSourceOffsets@Mesh@@CAXMMMMV-$ArrayRef@M@@V-$ArrayRef@URampPair@CoordMap@@@@V2@@Z.c)
 */
