/*
 * XREFs of ?Present@CSwapChainBase@@QEAAJPEAUHRGN__@@IIPEAURenderTargetPresentParameters@@@Z @ 0x180072F94
 * Callers:
 ...
 *     ?SupportsMoveOptimization@CDWMSwapChain@@MEBA_NXZ @ 0x1800731B0 (-SupportsMoveOptimization@CDWMSwapChain@@MEBA_NXZ.c)
