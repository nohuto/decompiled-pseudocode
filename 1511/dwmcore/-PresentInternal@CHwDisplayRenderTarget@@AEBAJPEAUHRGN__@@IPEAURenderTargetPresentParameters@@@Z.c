/*
 * XREFs of ?PresentInternal@CHwDisplayRenderTarget@@AEBAJPEAUHRGN__@@IPEAURenderTargetPresentParameters@@@Z @ 0x1800817BC
 * Callers:
        ...
        struct RenderTargetPresentParameters *a4)
{
  ...
  v5 = v4;
  if ( v4 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x702u);
  return v5;
}
