/*
 * XREFs of ?SetScale@CComponentTransform3D@@AEAAJMMM@Z @ 0x18012FA78
 * Callers:
...
__int64 __fastcall CComponentTransform3D::SetScale(CComponentTransform3D *this, float a2, float a3, float a4)
{
  ...
  v4 = 0;
  if ( *((double *)this + 28) != a2 || *((double *)this + 29) != a3 || *((double *)this + 30) != a4 )
  {
    *((double *)this + 28) = a2;
    *((double *)this + 29) = a3;
    *((double *)this + 30) = a4;
    ...
    *(float *)&v8[1] = a3;
    *(float *)&v8[2] = a4;
    v6 = CPropertyChangeResource::NotifyVector3PropertyChanged(this, 22LL, (const struct D2DVector3 *)v8);
    v4 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x110u);
  }
  return v4;
}
