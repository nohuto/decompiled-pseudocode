/*
 * XREFs of ?Interpolate@HslCoordinateSpace@Animations@Components@@SAXNW4Dwm__AnimationType@23@PEAVValue@23@11@Z @ 0x1801657C4
 * Callers:
 ...
 *     ?Compute@?$LinearInterpolation@VHslCoordinateSpace@Animations@Components@@@Animations@Components@@UEAAXMW4Dwm__AnimationType@23@PEAVValue@23@11@Z @ 0x180162500 (-Compute@-$LinearInterpolation@VHslCoordinateSpace@Animations@Components@@@Animations@Components.c)
 * Callees:
