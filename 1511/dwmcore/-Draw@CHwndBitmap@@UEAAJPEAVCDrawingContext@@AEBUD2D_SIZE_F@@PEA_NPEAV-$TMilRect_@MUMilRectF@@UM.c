/*
 * XREFs of ?Draw@CHwndBitmap@@UEAAJPEAVCDrawingContext@@AEBUD2D_SIZE_F@@PEA_NPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18000F450
 * Callers:
...
__int64 __fastcall CHwndBitmap::Draw(__int64 a1, _DWORD *a2)
{
  unsigned int v2; // ebx
  __int64 v5; // rdx
  bool v6; // r8
  ...
  v2 = 0;
  if ( !a2[62] || a2[63] || a2[64] || CDrawingContext::IsIn3DMode((CDrawingContext *)(a2 + 14)) )
  {
    if ( a1 == 16 )
      v10 = 0LL;
    else
      v10 = (struct CCommandListBitmapRepresentation *)(a1 + 56);
    v11 = CDrawingContext::DrawCommandListBitmapRepresentation((CDrawingContext *)a2, v10, 0LL);
    v2 = v11;
    if ( v11 >= 0 )
      return v2;
