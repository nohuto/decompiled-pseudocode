/*
 * XREFs of ?CalcImageTransform@CCompositionSurfaceBitmap@@AEAA_NPEBUD2D_SIZE_F@@PEAVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18000CB04
 * Callers:
...
char __fastcall CCompositionSurfaceBitmap::CalcImageTransform(__int64 a1, __int64 a2, __int64 a3, _QWORD *a4)
{
  ...
  if ( (unsigned __int8)CCompositionSurfaceBitmap::BoundsFromLayoutSize(a1, a2, v9) )
    return CCompositionSurfaceBitmap::AppendSizePreferenceTransform(a1 + 40, v9, a3) | Transform;
  return Transform;
}
