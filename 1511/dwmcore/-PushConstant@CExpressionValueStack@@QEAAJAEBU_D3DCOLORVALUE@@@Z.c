/*
 * XREFs of ?PushConstant@CExpressionValueStack@@QEAAJAEBU_D3DCOLORVALUE@@@Z @ 0x18011DFE8
 * Callers:
 ...
 *     ?SetColorValue@CKeyframeAnimation@@UEAAJMMMM@Z @ 0x18012C380 (-SetColorValue@CKeyframeAnimation@@UEAAJMMMM@Z.c)
 * Callees:
...
__int64 __fastcall CExpressionValueStack::PushConstant(CExpressionValueStack *this, const struct _D3DCOLORVALUE *a2)
{
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x3BDu);
  }
  return v5;
}
