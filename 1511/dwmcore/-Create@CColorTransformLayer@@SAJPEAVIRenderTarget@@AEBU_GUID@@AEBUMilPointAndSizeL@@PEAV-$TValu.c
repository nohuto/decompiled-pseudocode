/*
 * XREFs of ?Create@CColorTransformLayer@@SAJPEAVIRenderTarget@@AEBU_GUID@@AEBUMilPointAndSizeL@@PEAV?$TValueResource@UMilColorTransform@@UMILCMD_COLORTRANSFORMRESOURCE@@$0DE@@@PEAPEAV1@@Z @ 0x180115720
 * Callers:
        ...
        CExternalLayer **a5)
{
  ...
  struct IRenderTargetBitmap *v23; // [rsp+50h] [rbp-30h] BYREF
  ...
  *a5 = 0LL;
  ...
  if ( v11 >= 0 )
  {
    ...
    *(_QWORD *)&v28[4] = 0LL;
    HIDWORD(v27) = v13;
    v14 = (*(__int64 (__fastcall **)(__int64 *, CExternalLayer ***, int *))(*a1 + 104))(a1, &a5, &v29);
    v12 = v14;
    if ( v14 >= 0 )
    {
      v25 = 48;
