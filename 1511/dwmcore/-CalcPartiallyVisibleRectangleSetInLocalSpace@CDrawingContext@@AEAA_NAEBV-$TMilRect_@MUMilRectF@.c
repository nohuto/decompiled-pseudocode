/*
 * XREFs of ?CalcPartiallyVisibleRectangleSetInLocalSpace@CDrawingContext@@AEAA_NAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@PEAI@Z @ 0x18003F7B0
 * Callers:
 ...
 *     ?SetInverse@MILMatrix3x2@@QEAAXAEBV1@@Z @ 0x18001C790 (-SetInverse@MILMatrix3x2@@QEAAXAEBV1@@Z.c)
  ...
  if ( v12 )
  {
    ...
    *(_QWORD *)((char *)&v22 + 4) = __PAIR64__(*((_DWORD *)TopByReference + 4), v15);
    ...
    for ( i = 0; i < v21; i = v19 + 1 )
    {
      ...
      if ( !TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEmpty((float *)&v26) )
      {
        v20 = 2LL * v4++;
        *(_OWORD *)(a3 + 8 * v20) = v26;
      }
