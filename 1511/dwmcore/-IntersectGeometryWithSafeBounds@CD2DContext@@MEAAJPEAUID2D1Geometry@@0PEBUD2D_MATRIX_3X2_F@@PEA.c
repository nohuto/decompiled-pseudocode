/*
 * XREFs of ?IntersectGeometryWithSafeBounds@CD2DContext@@MEAAJPEAUID2D1Geometry@@0PEBUD2D_MATRIX_3X2_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAPEAU2@@Z @ 0x180147990
 * Callers:
 *     <none>
 * Callees:
                ...
                if ( *(float *)&X <= *(float *)&v41 )
                {
                  ...
                  *(float *)&v42 = v24 + 1.0;
                  ...
                  if ( v25 >= 0 )
                  {
                    ...
                    {
                      MilInstrumentationCheckHR(0x14u, 0LL, 0, v29, 0x7BDu);
                    }
                  }
                  else
                  {
                    MilInstrumentationCheckHR(0x14u, 0LL, 0, v25, 0x7B3u);
                  }
                }
              }
              else
              {
                MilInstrumentationCheckHR(0x14u, 0LL, 0, v17, 0x785u);
              }
            }
            else
            {
              MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x780u);
            }
          }
          else
          {
            MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x77Eu);
          }
        }
        else
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0x776u);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x775u);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x774u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x773u);
  }
  if ( v33 )
  {
