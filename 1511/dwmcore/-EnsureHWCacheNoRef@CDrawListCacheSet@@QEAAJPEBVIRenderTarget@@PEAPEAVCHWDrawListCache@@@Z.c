/*
 * XREFs of ?EnsureHWCacheNoRef@CDrawListCacheSet@@QEAAJPEBVIRenderTarget@@PEAPEAVCHWDrawListCache@@@Z @ 0x1800FC14C
 * Callers:
...
LABEL_5:
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x1B5u);
    v10 = v18;
    goto LABEL_16;
  }
  ...
  *(_QWORD *)&v17 = v18;
  ...
  if ( (int)v12 + 1 >= (unsigned int)v12 )
  {
    ...
    {
      v16 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this, 16, 1, &v17);
      v14 = v16;
      if ( v16 < 0 )
