/*
 * XREFs of ?FindOrCreateResourceNoRef@?$CDeviceResourceTable@VCD3DPixelShader@@VCCompiledEffectTemplate@@VCD3DDeviceLevel1@@@@QEAAJPEAVCD3DDeviceLevel1@@PEAPEAVCD3DPixelShader@@@Z @ 0x18012DC1C
 * Callers:
...
LABEL_34:
    ...
    if ( v15 > *(_DWORD *)(a1 + 36) )
    {
      v18 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 16, 8, 1, &v20);
      v16 = v18;
      if ( v18 < 0 )
