/*
 * XREFs of ?SetTransform@CCoRenderVisualProxy@@UEAAJPEBU_D3DMATRIX@@0@Z @ 0x18010FB50
 * Callers:
 *     <none>
 * Callees:
        ...
        const struct _D3DMATRIX *a3)
{
  ...
  if ( !*(_QWORD *)(*((_QWORD *)this + 3) + 336LL) )
  {
    ...
    if ( v7 )
    {
      ...
      *(_DWORD *)(v7 + 160) = 1065353216;
      *(_DWORD *)(v7 + 180) = 1065353216;
    }
    else
    {
      v8 = 0LL;
  ...
  v11 = *(_QWORD *)(*((_QWORD *)this + 3) + 336LL);
  if ( a3 )
  {
    v12 = *(_OWORD *)&a3->_21;
    v20[0] = *(_OWORD *)&a3->_11;
    ...
    v21[2] = v17;
    v21[3] = v18;
    D2DMatrixMultiply((struct D2DMatrix *)(v11 + 120), (const struct D2DMatrix *)v21, (const struct D2DMatrix *)v20);
  }
  else
  {
    *(_OWORD *)(v11 + 120) = *(_OWORD *)&a2->_11;
    *(_OWORD *)(v11 + 136) = *(_OWORD *)&a2->_21;
    *(_OWORD *)(v11 + 152) = *(_OWORD *)&a2->_31;
    *(_OWORD *)(v11 + 168) = *(_OWORD *)&a2->_41;
  }
