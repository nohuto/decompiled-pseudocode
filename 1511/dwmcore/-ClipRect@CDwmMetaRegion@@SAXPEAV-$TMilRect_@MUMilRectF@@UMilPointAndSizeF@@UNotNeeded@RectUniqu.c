/*
 * XREFs of ?ClipRect@CDwmMetaRegion@@SAXPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x180116BF0
 * Callers:
...
void __fastcall CDwmMetaRegion::ClipRect(float *a1, float *a2)
{
  ...
  __m128i v41; // xmm1
  float v42; // [rsp+30h] [rbp-58h]
  float v43; // [rsp+30h] [rbp-58h]
  struct _RGNDATA *v44[2]; // [rsp+38h] [rbp-50h] BYREF
