/*
 * XREFs of ?GetGeometryBounds@CGeometry2DGroup@@UEAAXPEAV?$CRectF@ULocalRenderingHPC@CoordinateSpace@@@@@Z @ 0x180132E50
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (v4 & 6) == 2 )
  {
    if ( (*(_BYTE *)(a1 + 136) & 2) != 0 )
    {
      ...
      for ( i = 0uLL; (unsigned int)v5 < *(_DWORD *)(a1 + 80); v5 = (unsigned int)(v5 + 1) )
      {
        ...
        if ( v6 )
        {
          (*(void (__fastcall **)(__int64, float *))(*(_QWORD *)v6 + 120LL))(v6, v10);
