/*
 * XREFs of ?GetIteratorForState@CPrimitiveGroupDrawListGenerator@@QEBA?AVIterator@CPrimitiveBuffer@@I@Z @ 0x18002FFDC
 * Callers:
 ...
 *     ??0Iterator@CPrimitiveBuffer@@QEAA@AEBUD2D1_COMPOSITOR_DRAWING_STATE@@PEBV1@@Z @ 0x1800BD17C (--0Iterator@CPrimitiveBuffer@@QEAA@AEBUD2D1_COMPOSITOR_DRAWING_STATE@@PEBV1@@Z.c)
 */
