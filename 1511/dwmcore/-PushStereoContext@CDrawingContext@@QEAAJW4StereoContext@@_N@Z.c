/*
 * XREFs of ?PushStereoContext@CDrawingContext@@QEAAJW4StereoContext@@_N@Z @ 0x1800F3A4C
 * Callers:
...
__int64 __fastcall CDrawingContext::PushStereoContext(__int64 a1, __int64 a2, char a3)
{
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x1161u);
    v8 = v15;
    goto LABEL_15;
  }
  v8 = v15;
  ...
  if ( v9 + 1 < v9 )
  {
    ...
    v7 = -2147024362;
LABEL_13:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x1166u);
    goto LABEL_15;
  }
  if ( v10 > *(_DWORD *)(a1 + 540) )
  {
    v13 = DynArrayImpl<0>::AddMultipleAndSet(a1 + 520, 8, 1, &v15);
    v11 = v13;
    if ( v13 < 0 )
  ...
  if ( v12 >= 0 )
    ...
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x1169u);
LABEL_15:
  if ( v7 < 0 && v5 )
    --*(_DWORD *)(a1 + 544);
  if ( v8 )
