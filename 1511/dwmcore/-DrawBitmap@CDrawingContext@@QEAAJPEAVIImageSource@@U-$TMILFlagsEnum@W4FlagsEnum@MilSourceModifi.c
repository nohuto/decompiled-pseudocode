/*
 * XREFs of ?DrawBitmap@CDrawingContext@@QEAAJPEAVIImageSource@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@@Z @ 0x1800427B4
 * Callers:
        ...
        int a3)
{
  ...
  unsigned int v15[4]; // [rsp+58h] [rbp-18h] BYREF
    ...
    && v12 )
  {
    ...
    *(float *)&v15[3] = (float)v14[1];
    ...
    v6 = v9;
    if ( v9 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x6B1u);
  }
  else
  {
    v5 = CDrawingContext::ImageSourceToBitmapSource(this, a2, 0LL, (struct MilRectF *)v15, &v13);
    v6 = v5;
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x6BBu);
    }
    else if ( v13 )
    {
      ...
      v6 = v7;
      if ( v7 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x6C4u);
    }
  }
  if ( v12 )
