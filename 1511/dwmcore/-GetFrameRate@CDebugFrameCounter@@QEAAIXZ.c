/*
 * XREFs of ?GetFrameRate@CDebugFrameCounter@@QEAAIXZ @ 0x1801039E8
 * Callers:
 ...
 * Callees:
 *     ?GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ @ 0x1801039BC (-GetFrameCountInternal@CDebugFrameCounter@@IEAAIXZ.c)
 */
