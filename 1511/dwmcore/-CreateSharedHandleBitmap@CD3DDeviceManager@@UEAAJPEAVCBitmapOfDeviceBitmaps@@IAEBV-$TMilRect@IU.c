/*
 * XREFs of ?CreateSharedHandleBitmap@CD3DDeviceManager@@UEAAJPEAVCBitmapOfDeviceBitmaps@@IAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAW4DXGI_FORMAT@@_N3AEBU_GUID@@U_LUID@@VDisplayId@@PEAPEAX@Z @ 0x1800FEC50
 * Callers:
 ...
 *     ?GetExistingSharedColorSourceHandle@CHwBitmapCache@@QEBAPEAXIVDisplayId@@_NPEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAW4DXGI_FORMAT@@@Z @ 0x18014B99C (-GetExistingSharedColorSourceHandle@CHwBitmapCache@@QEBAPEAXIVDisplayId@@_NPEBV-$TMilRect@IUMilR.c)
 */
        ...
        _QWORD *a11)
{
  ...
  *a11 = 0LL;
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_180183F24, 1u, v18, 0x843u);
    return v19;
  }
  ...
  {
    ++*((_DWORD *)v37 + 126);
    *((_DWORD *)v21 + 127) = GetCurrentThreadId();
    if ( a2 )
    ...
    if ( Cache < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_180183F24, 1u, Cache, 0x854u);
LABEL_10:
    ...
    else
    {
      if ( a6 )
      {
        ...
        {
          MilInstrumentationCheckHR(0x14u, &dword_180183F24, 1u, CurrentDisplaySet, 0x871u);
          CGuard<CD3DDeviceLevel1>::~CGuard<CD3DDeviceLevel1>((__int64 *)&v37);
          v13 = v39;
LABEL_27:
          if ( v38 )
        ...
        {
          MilInstrumentationCheckHR(0x14u, &dword_180183F24, 1u, SupportedTextureFormat, 0x879u);
          goto LABEL_10;
        }
        v25 = a10;
      }
      ...
      {
        MilInstrumentationCheckHR(0x14u, &dword_180183F24, 1u, SharedColorSource, 0x887u);
        CGuard<CD3DDeviceLevel1>::~CGuard<CD3DDeviceLevel1>((__int64 *)&v37);
        v15 = v40;
        goto LABEL_25;
      }
      ...
      if ( v33 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_180183F24, 1u, v33, 0x88Bu);
        CGuard<CD3DDeviceLevel1>::~CGuard<CD3DDeviceLevel1>((__int64 *)&v37);
        goto LABEL_25;
      }
    }
...
LABEL_25:
  ...
  MilInstrumentationCheckHR(0x14u, &dword_180183F24, 1u, D3DDevice, 0x845u);
LABEL_29:
  if ( v21 )
    CMILPoolResource::Release((CD3DDeviceLevel1 *)((char *)v21 + 384));
  if ( v13 )
