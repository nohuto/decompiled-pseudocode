/*
 * XREFs of ?SetTopRightRadiusY@CRectangleGeometry@@AEAAJM@Z @ 0x180065690
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetTopRightRadiusY(CRectangleGeometry *this, float a2)
{
  unsigned int v2; // ebx
  int v5; // eax
  ...
  if ( *((float *)this + 33) != a2 )
  {
    *((float *)this + 33) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyFloatPropertyChanged(this, 7LL, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x205u);
  }
  return v2;
}
