/*
 * XREFs of ?PurgeOldRenderPassInfos@CVisual@@QEAAXXZ @ 0x180120A40
 * Callers:
...
void __fastcall CVisual::PurgeOldRenderPassInfos(CVisual *this)
{
  ...
  v1 = (CVisual *)((char *)this + 312);
  v2 = 5;
  v3 = (CVisual *)*((_QWORD *)this + 39);
  v4 = v16;
  v5 = 0;
  v13[0] = v16;
  v6 = 0LL;
  ...
  while ( 1 )
  {
    ...
    if ( (unsigned int)v7 >= v5 )
    {
      ...
      v9 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v13, 8, 1, &v12);
      if ( v9 < 0 )
