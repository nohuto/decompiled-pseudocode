/*
 * XREFs of ?SendResponse@MagnifierCaptureBitsResponse@@UEAAJJ@Z @ 0x18010AB80
 * Callers:
...
__int64 __fastcall MagnifierCaptureBitsResponse::SendResponse(MagnifierCaptureBitsResponse *this, int a2)
{
  ...
  if ( a2 >= 0 )
  {
    ...
    if ( v4 )
    {
      ...
      v6 = 0LL;
      v7 = *(_DWORD *)(*((_QWORD *)this + 20) + 328LL);
      *v4 = v7;
      v4[1] = *(_DWORD *)(*((_QWORD *)this + 20) + 332LL);
      v4[2] = *((_DWORD *)this + 46);
      v4[3] = *((_DWORD *)this + 47);
      if ( v7 )
      {
