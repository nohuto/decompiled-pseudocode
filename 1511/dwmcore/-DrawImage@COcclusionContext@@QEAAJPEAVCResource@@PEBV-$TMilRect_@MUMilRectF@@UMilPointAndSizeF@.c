/*
 * XREFs of ?DrawImage@COcclusionContext@@QEAAJPEAVCResource@@PEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@U?$TMILFlagsEnum@W4FlagsEnum@MilSourceModification@@@@@Z @ 0x180055C9C
 * Callers:
        ...
        char a4)
{
  ...
  if ( !*(_DWORD *)(a1 + 656) )
  {
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, DoesImageOcclude, 0x529u);
    }
    else if ( v10 )
    {
      v8 = COcclusionContext::CollectRectangleForOcclusion(a1, a3);
      v4 = v8;
      if ( v8 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x52Fu);
    }
  }
  return v4;
}
