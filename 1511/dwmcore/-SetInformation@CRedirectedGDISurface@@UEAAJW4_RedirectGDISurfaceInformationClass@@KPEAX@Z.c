/*
 * XREFs of ?SetInformation@CRedirectedGDISurface@@UEAAJW4_RedirectGDISurfaceInformationClass@@KPEAX@Z @ 0x1800A5940
 * Callers:
...
__int64 __fastcall CRedirectedGDISurface::SetInformation(__int64 a1, int a2, unsigned int a3, unsigned int *a4)
{
  ...
  if ( a2 == 1 )
  {
    ...
    {
      SetLastError(0);
      if ( (unsigned int)DwmHLSurfSetSignalOnDirty(*(_QWORD *)(a1 + 16), 0LL, qword_1801A4058, *a4) )
        return v4;
    ...
    v4 = -2147024872;
LABEL_24:
    MilInstrumentationCheckHR(0x14u, &dword_180179E68, 1u, v8, v10);
    return v4;
  }
  if ( a2 != 4 )
  {
