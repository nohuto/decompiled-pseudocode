/*
 * XREFs of ?StopInteraction@CInteractionContextWrapper@@UEAAJXZ @ 0x180002630
 * Callers:
 *     <none>
 * Callees:
        ...
        const GUID *a4)
{
  ...
  if ( *((_QWORD *)this + 3) )
  {
    ...
    if ( v7 >= 0 )
    {
      (*(void (__fastcall **)(CInteractionContextWrapper *, _QWORD))(*(_QWORD *)this + 56LL))(this, (unsigned int)v7);
      v5 = v7;
    }
  }
  else
  ...
  if ( (unsigned int)pRelatedActivityId > 4 && (qword_18019E950 & 2) != 0 && (qword_18019E958 & 2) == qword_18019E958 )
  {
    ...
    v11 = 8;
    v14 = 4;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_18017EDF5, (LPCGUID)4, a4, 4u, &pData);
