/*
 * XREFs of ?AddSharedSurfaceEntry@CFlipChain@@AEAAJAEBUSharedSurfaceEntry@SharedBufferDataFlipChain@@PEAI@Z @ 0x1801255E0
 * Callers:
        ...
        unsigned int *a3)
{
  ...
  if ( (int)v4 + 1 >= (unsigned int)v4 )
  {
    ...
    {
      v8 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 216, 88, 1, a2);
      v6 = v8;
      if ( v8 < 0 )
