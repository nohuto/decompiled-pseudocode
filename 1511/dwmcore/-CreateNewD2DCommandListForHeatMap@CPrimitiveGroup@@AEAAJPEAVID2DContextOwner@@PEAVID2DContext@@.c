/*
 * XREFs of ?CreateNewD2DCommandListForHeatMap@CPrimitiveGroup@@AEAAJPEAVID2DContextOwner@@PEAVID2DContext@@PEAPEAVCD2DCommandList@@@Z @ 0x1801275D0
 * Callers:
...
LABEL_20:
  ...
  {
    v16 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 88, 8, 1, &v18);
    v13 = v16;
    if ( v16 < 0 )
