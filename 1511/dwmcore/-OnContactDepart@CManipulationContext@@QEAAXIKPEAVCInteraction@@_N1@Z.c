/*
 * XREFs of ?OnContactDepart@CManipulationContext@@QEAAXIKPEAVCInteraction@@_N1@Z @ 0x18000582C
 * Callers:
        ...
        char a6)
{
  ...
  CManipulationContext::CleanTreeState(v6, (struct CInteraction **)this, *((RTL_SRWLOCK **)this + 5), a6, a3);
  Microsoft::WRL::ComPtr<CInteraction>::InternalRelease((__int64 *)&v14);
}
