/*
 * XREFs of ?ProcessAppend@CTransformGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_TRANSFORMGROUP@@PEBXI@Z @ 0x180066B30
 * Callers:
        ...
        ...)
{
  ...
  if ( v6.m128i_i32[1] )
  {
    v8 = UnmarshalResourceArray(&v10, va, (unsigned int)_mm_cvtsi128_si32(v6), 57LL);
    v5 = v8;
    if ( v8 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x9F9u);
    if ( v5 < 0 && Src )
