/*
 * XREFs of ?DrawMesh2D@COcclusionContext@@UEAAJPEAVCGeometry2D@@PEAVCImageSource@@@Z @ 0x180114920
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CImageSource *a3)
{
  ...
  if ( (*(unsigned __int8 (__fastcall **)(char *, __int64))(*((_QWORD *)a3 + 2) + 48LL))((char *)a3 + 16, 56LL) )
  {
    ...
    *((_QWORD *)&v11 + 1) = a3;
    ...
    if ( (int)v5 + 1 >= (unsigned int)v5 )
    {
      ...
      {
        v9 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 728, 40, 1, &v11);
        if ( v9 < 0 )
