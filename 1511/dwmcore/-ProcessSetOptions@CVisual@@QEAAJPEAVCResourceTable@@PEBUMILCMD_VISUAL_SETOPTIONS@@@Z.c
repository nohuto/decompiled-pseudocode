/*
 * XREFs of ?ProcessSetOptions@CVisual@@QEAAJPEAVCResourceTable@@PEBUMILCMD_VISUAL_SETOPTIONS@@@Z @ 0x1800481A4
 * Callers:
        ...
        const struct MILCMD_VISUAL_SETOPTIONS *a3)
{
  ...
  v5 = this;
  v6 = *((_DWORD *)a3 + 3);
  v7 = *((unsigned __int8 *)this + 74);
  if ( ((v7 >> 2) & 1) != (v6 != 0) )
  {
    *((_BYTE *)v5 + 74) = v7 ^ (v7 ^ (4 * (v6 != 0))) & 4;
