/*
 * XREFs of ?CurrentRedrawRegionColor@CComposition@@QEAA?AU_D3DCOLORVALUE@@XZ @ 0x180100D24
 * Callers:
        ...
        struct _D3DCOLORVALUE *__return_ptr retstr)
{
  ...
  v2 = *((_QWORD *)this + 44);
  if ( v2 != *((_QWORD *)this + 139) )
  {
    *((_QWORD *)this + 139) = v2;
    *((_DWORD *)this + 276) = ((unsigned __int8)*((_DWORD *)this + 276) + 1) & 3;
  }
  result = retstr;
  *(struct _D3DCOLORVALUE *)&retstr->r = *((struct _D3DCOLORVALUE *)this + *((unsigned int *)this + 276) + 65);
  return result;
}
