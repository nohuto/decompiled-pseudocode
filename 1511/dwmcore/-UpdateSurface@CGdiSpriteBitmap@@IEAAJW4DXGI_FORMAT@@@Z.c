/*
 * XREFs of ?UpdateSurface@CGdiSpriteBitmap@@IEAAJW4DXGI_FORMAT@@@Z @ 0x180087F88
 * Callers:
...
__int64 __fastcall CGdiSpriteBitmap::UpdateSurface(CGdiSpriteBitmap *this, enum DXGI_FORMAT a2)
{
  ...
  {
    Information = CRedirectedGDISurface::GetInformation(*((_QWORD *)this + 70) + 16LL, 2LL, v25, &v26);
    *((_DWORD *)this + 110) = 0;
    *((_DWORD *)this + 142) = 0;
    *((_DWORD *)this + 22) = v32;
    if ( Information >= 0 )
  ...
  v12 = v33;
  *((_DWORD *)this + 24) = v33;
  *((_DWORD *)this + 25) = (unsigned int)HasAlphaChannel(v12) != 0 ? 1 : 3;
