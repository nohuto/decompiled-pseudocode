/*
 * XREFs of ?CollectOcclusionHelper@CWindowNode@@AEAAJPEAVCResource@@V?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@PEAVCOcclusionContext@@PEAVCShape@@_N@Z @ 0x180061690
 * Callers:
        ...
        char a6)
{
  ...
  *a3 += a1[270];
  ...
  if ( a6 )
  {
    v17 = COcclusionContext::DrawImage(a4, a2, v20, a1[274]);
    v7 = v17;
    if ( v17 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v17, 0xC5Eu);
  }
  else if ( a5 )
  {
    v18 = COcclusionContext::DrawClippedImage(a4, (__int64)a2, v20, a5, a1[274]);
    v7 = v18;
    if ( v18 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v18, 0xC65u);
  }
  return v7;
}
