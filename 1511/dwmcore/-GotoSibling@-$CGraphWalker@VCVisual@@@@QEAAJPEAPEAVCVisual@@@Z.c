/*
 * XREFs of ?GotoSibling@?$CGraphWalker@VCVisual@@@@QEAAJPEAPEAVCVisual@@@Z @ 0x180005FF0
 * Callers:
 ...
 * Callees:
 *     ?GetChildAt@CVisual@@QEAAPEAV1@I@Z @ 0x180009634 (-GetChildAt@CVisual@@QEAAPEAV1@I@Z.c)
 */
