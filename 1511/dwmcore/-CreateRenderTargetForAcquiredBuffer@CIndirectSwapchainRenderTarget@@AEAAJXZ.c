/*
 * XREFs of ?CreateRenderTargetForAcquiredBuffer@CIndirectSwapchainRenderTarget@@AEAAJXZ @ 0x1800AED80
 * Callers:
...
__int64 __fastcall CIndirectSwapchainRenderTarget::CreateRenderTargetForAcquiredBuffer(struct _LUID *this)
{
  ...
  v22 = 0LL;
  v25 = 0;
  LowPart = this[44].LowPart;
  v24 = 1;
  if ( LowPart )
  {
    v4 = this[41];
    while ( *(_QWORD *)(*(_QWORD *)&v4 + 16LL * v2) != *(_QWORD *)&this[51] )
    {
      if ( ++v2 >= LowPart )
        goto LABEL_7;
    }
...
LABEL_7:
  v5 = (***(__int64 (__fastcall ****)(_QWORD, GUID *, __int64 *))&this[51])(
         *(_QWORD *)&this[51],
...
LABEL_34:
    ...
    if ( v11 > this[43].HighPart )
    {
      v16 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v9, 16, 1, &v20);
      v12 = v16;
      if ( v16 < 0 )
...
LABEL_33:
    ...
    v6 = 0;
    if ( v15 > this[24].HighPart )
    {
      v18 = DynArrayImpl<0>::AddMultipleAndSet((__int64)&this[22], 8, 1, &v21);
      v12 = v18;
      if ( v18 < 0 )
    ...
    {
      *(_QWORD *)(*(_QWORD *)&this[22] + 8LL * this[25].LowPart) = v21;
      this[25].LowPart = v15;
    }
