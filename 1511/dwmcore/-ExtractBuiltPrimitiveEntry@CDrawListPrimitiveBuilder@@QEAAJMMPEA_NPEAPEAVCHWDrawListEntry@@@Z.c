/*
 * XREFs of ?ExtractBuiltPrimitiveEntry@CDrawListPrimitiveBuilder@@QEAAJMMPEA_NPEAPEAVCHWDrawListEntry@@@Z @ 0x180034204
 * Callers:
        ...
        struct CHWDrawListEntry **a5)
{
  ...
  *a4 = *((_BYTE *)this + 2185);
  ...
  if ( !v8 )
    goto LABEL_5;
  v10 = (const unsigned __int16 *)*((_QWORD *)this + 258);
  v11 = *((_DWORD *)this + 34);
