/*
 * XREFs of ?Reset@CDWMInputThread@@QEAAJXZ @ 0x1800A6498
 * Callers:
...
__int64 __fastcall CDWMInputThread::Reset(HANDLE *this)
{
  ...
  if ( !this[1] )
  {
    ...
    {
      v5 = -2147467260;
      MilInstrumentationCheckHR(0x14u, &dword_180179C14, 1u, -2147467260, 0x72u);
    }
    else
    {
      ...
      v5 = -2147024882;
      MilInstrumentationCheckHR(0x14u, &dword_180179C14, 1u, -2147024882, 0x82u);
    }
    v1 = v5;
