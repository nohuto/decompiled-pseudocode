/*
 * XREFs of ?InsertAt@?$DynArray@UOverlayPlaneInfo@COverlayContext@@$0A@@@QEAAJAEBUOverlayPlaneInfo@COverlayContext@@I@Z @ 0x180111110
 * Callers:
        ...
        unsigned int a3)
{
  ...
  __int128 v27; // xmm1
  _OWORD *v28; // rdx
  _OWORD *v30; // [rsp+40h] [rbp+8h] BYREF

  v4 = a3;
  if ( a3 <= *(_DWORD *)(a1 + 24) )
  {
    v30 = (_OWORD *)a2;
    v6 = DynArrayImpl<0>::Grow(a1, 0xE0u, 1, 0, (unsigned __int64 *)&v30);
    v5 = v6;
    if ( v6 >= 0 )
    {
      ++*(_DWORD *)(a1 + 24);
      ...
      {
        v9 = (_OWORD *)(v7 + 224LL * v8);
        do
        {
          v10 = v9 + 8;
          v11 = (_OWORD *)(v7 + 224LL * --v8);
          v12 = v11[1];
          *v9 = *v11;
          v13 = v11[2];
          v9[1] = v12;
      ...
      v24 = v30;
      v25 = (_OWORD *)(v7 + 224 * v4);
      if ( v30 >= v25 && (unsigned __int64)v30 < 224 * (unsigned __int64)*(unsigned int *)(a1 + 24) + v7 - 224 )
        v24 = v30 + 14;
      *v25 = *v24;
      v25[1] = v24[1];
      v25[2] = v24[2];
