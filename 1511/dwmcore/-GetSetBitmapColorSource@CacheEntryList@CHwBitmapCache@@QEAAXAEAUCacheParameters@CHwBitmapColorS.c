/*
 * XREFs of ?GetSetBitmapColorSource@CacheEntryList@CHwBitmapCache@@QEAAXAEAUCacheParameters@CHwBitmapColorSource@@AEAPEAV4@PEAPEAV4@@Z @ 0x18008BC6C
 * Callers:
 ...
 *     ?CheckSizeLayoutMatch@CacheEntryList@CHwBitmapCache@@CA?AW4Enum@SizeLayoutMatch@12@AEBUCacheSizeLayoutParameters@CHwBitmapColorSource@@0@Z @ 0x18008BE74 (-CheckSizeLayoutMatch@CacheEntryList@CHwBitmapCache@@CA-AW4Enum@SizeLayoutMatch@12@AEBUCacheSize.c)
...
LABEL_21:
  if ( (int)DynArrayImpl<1>::AddMultiple(this, 72LL, 1LL, &v32) >= 0 )
  {
    ...
    *(_QWORD *)(v22 + 48) = *((_QWORD *)a2 + 6);
    *(_DWORD *)(v22 + 56) = *((_DWORD *)a2 + 14);
    *(_QWORD *)(v22 + 64) = v23;
    if ( v23 )
      (**v23)(v23);
  }
