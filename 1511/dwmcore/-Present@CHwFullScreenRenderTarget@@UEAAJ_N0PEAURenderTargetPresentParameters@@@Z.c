/*
 * XREFs of ?Present@CHwFullScreenRenderTarget@@UEAAJ_N0PEAURenderTargetPresentParameters@@@Z @ 0x180074220
 * Callers:
        ...
        struct RenderTargetPresentParameters *a4)
{
  ...
  {
    v12 = *(__int64 (__fastcall **)(CHwFullScreenRenderTarget *__hidden, bool))(*(_QWORD *)v4 + 264LL);
