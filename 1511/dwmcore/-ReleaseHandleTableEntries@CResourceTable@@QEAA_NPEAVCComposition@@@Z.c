/*
 * XREFs of ?ReleaseHandleTableEntries@CResourceTable@@QEAA_NPEAVCComposition@@@Z @ 0x180094424
 * Callers:
...
char __fastcall CResourceTable::ReleaseHandleTableEntries(CResourceTable *this, struct CComposition *a2)
{
  char v2; // r8
  unsigned int i; // ebx
  __int64 v6; // rax
