/*
 * XREFs of ?IsOverlayAssigned@COverlayContext@@QEAA_NPEBVCVisual@@PEAVISwapChainContent@@PEA_N@Z @ 0x1800FB734
 * Callers:
        ...
        bool *a4)
{
  ...
  if ( v4 )
  {
    ...
    {
      v8 = 224LL * v6;
      if ( *(const struct CVisual **)(v8 + v7) == a2 && *(struct ISwapChainContent **)(v8 + v7 + 8) == a3 )
        break;
      if ( ++v6 >= v4 )
        return v5;
    }
    if ( v6 != -1 )
    {
      ...
      if ( a4 )
      {
        v9 = COverlayContext::RequiresFrontPlane((struct COverlayContext::OverlayPlaneInfo *)(v7 + 224LL * v6));
        *v10 = v9;
      }
    }
  }
