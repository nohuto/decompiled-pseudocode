/*
 * XREFs of ?ConfigureInteractionContext@CInteractionContextWrapper@@AEAAJPEAUHINTERACTIONCONTEXT__@@AEBUSetupInfo@@@Z @ 0x1800FB8CC
 * Callers:
 ...
 *     ?ApplySetupInfo@CInteractionContextWrapper@@UEAAJAEBUSetupInfo@@@Z @ 0x180143000 (-ApplySetupInfo@CInteractionContextWrapper@@UEAAJAEBUSetupInfo@@@Z.c)
 * Callees:
      ...
      if ( v11 >= 0 )
      {
        ...
        if ( v19 >= 0 )
        {
            ...
            && (qword_18019E958 & 2) == qword_18019E958 )
          {
            ...
            v36 = 4;
            v39 = 4;
            TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_18017EBB8, (LPCGUID)4, v16, 7u, &pData);
            v11 = v19;
          }
          if ( v11 >= 0 )
          {
