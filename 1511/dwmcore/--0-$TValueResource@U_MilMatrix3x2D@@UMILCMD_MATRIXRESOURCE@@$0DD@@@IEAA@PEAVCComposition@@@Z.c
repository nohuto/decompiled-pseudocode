/*
 * XREFs of ??0?$TValueResource@U_MilMatrix3x2D@@UMILCMD_MATRIXRESOURCE@@$0DD@@@IEAA@PEAVCComposition@@@Z @ 0x180112868
 * Callers:
...
__int64 __fastcall TValueResource<_MilMatrix3x2D,MILCMD_MATRIXRESOURCE,51>::TValueResource<_MilMatrix3x2D,MILCMD_MATRIXRESOURCE,51>(
        __int64 a1,
        __int64 a2)
{
  __int64 result; // rax
