/*
 * XREFs of ?HasValidDeviceBitmapObject@CGdiSpriteBitmap@@QEAA_NPEAPEAUIMilRedirectedGDISurface@@@Z @ 0x180124F2C
 * Callers:
...
char __fastcall CGdiSpriteBitmap::HasValidDeviceBitmapObject(CMILCOMBase **this, struct IMilRedirectedGDISurface **a2)
{
  ...
  if ( this[21] )
  {
    ...
    if ( v5 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_180183BD0, 2u, v5, 0x667u);
      return v2;
    }
    v6 = this[70];
    if ( !this[23] )
    {
      ...
      if ( Interface < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_180183BD0, 2u, Interface, 0x66Fu);
        return v2;
      }
      return 1;
    }
    ...
    if ( Information < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_180183BD0, 2u, Information, 0x676u);
      return v2;
    }
    if ( v13 == 2 && this[23] == *(CMILCOMBase **)&v16[1] )
    {
      ...
      if ( v9 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_180183BD0, 2u, v9, 0x67Fu);
        return v2;
      }
      return 1;
    }
