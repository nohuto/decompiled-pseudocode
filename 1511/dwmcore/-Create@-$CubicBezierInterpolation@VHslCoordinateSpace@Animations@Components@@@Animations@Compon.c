/*
 * XREFs of ?Create@?$CubicBezierInterpolation@VHslCoordinateSpace@Animations@Components@@@Animations@Components@@SAJMMMMPEAPEAVInterpolation@23@@Z @ 0x180162638
 * Callers:
        ...
        __int64 *a5)
{
  ...
  {
    *(_DWORD *)(v5 + 8) = 1;
    *(_QWORD *)v5 = &Components::Animations::CubicBezierInterpolation<Components::Animations::HslCoordinateSpace>::`vftable';
  }
  else
  {
    v5 = 0LL;
