/*
 * XREFs of ?FillTextureWithTransformedSource@CHwBitmapColorSource@@AEAAJPEAVIBitmapSource@@@Z @ 0x18003166C
 * Callers:
 ...
 * Callees:
 *     ?ComputePrefilteredDirtyRects@CHwBitmapColorSource@@AEAAIPEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@IPEAV2@@Z @ 0x18001CD6C (-ComputePrefilteredDirtyRects@CHwBitmapColorSource@@AEAAIPEBV-$TMilRect@IUMilRectU@@UNotNeeded@R.c)
 ...
 *     ??$ExtendBaseByAdjacentSectionsOfRect@V?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@@YAXAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@0AEAV0@@Z @ 0x18014D130 (--$ExtendBaseByAdjacentSectionsOfRect@V-$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@@@YAX.c)
 *     ?UpdateFromReusableSource@CHwBitmapColorSource@@AEAAJPEAVIBitmapSource@@PEAV1@IPEAV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAIPEAPEAV3@IPEBQEAV?$DynArray@V?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@$0A@@@3@Z @ 0x18014D66C (-UpdateFromReusableSource@CHwBitmapColorSource@@AEAAJPEAVIBitmapSource@@PEAV1@IPEAV-$TMilRect@IU.c)
 */
        ...
        struct IUnknown *a2)
{
  ...
  _OWORD v41[9]; // [rsp+A0h] [rbp-60h] BYREF
  ...
  if ( v11
    || (v22 = CHwBitmapColorSource::ComputePrefilteredDirtyRects((unsigned int *)this, v13, v32, (__int64)v41),
        (v24 = v22) != 0)
    && TMilRect<unsigned int,MilRectU,RectUniqueness::NotNeeded>::DoesContain((__int64)v41, (__int64)this + 172) )
  {
    v14 = *v5;
    v15 = 1;
    v31 = 1;
  ...
  v34 = (__m128i *)v41;
  `vector constructor iterator'(
    (CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)v42,
    0xB0uLL,
    2,
...
LABEL_18:
    if ( v15 )
    {
      ...
      v3 = v37;
      if ( v37 && *(int *)(*((_QWORD *)this + 2) + 612LL) < 40960 && v17 == *((struct IUnknown **)this + 14) )
      {
        v28 = (*(__int64 (__fastcall **)(CBitmapLock *, struct IUnknown **))(*(_QWORD *)v37 + 80LL))(v37, &v36);
        v2 = v28;
        if ( v28 < 0 )
        {
...
LABEL_26:
        ...
        if ( v36 )
          CD3DResourceManager::ReleaseD3DResourceSourceAfterFrameRetiresInDriver(
            (CD3DResourceManager *)(*((_QWORD *)this + 2) + 848LL),
            v36);
        v17 = v35;
      }
