/*
 * XREFs of ?QueryResourceResidency@CD3DDeviceLevel1@@QEAAJPEAUID3D11Resource@@PEAW4DXGI_RESIDENCY@@@Z @ 0x18002433C
 * Callers:
        ...
        enum DXGI_RESIDENCY *a3)
{
  ...
  v3 = (__int64 (__fastcall ***)(_QWORD, GUID *, __int64 *))*((_QWORD *)this + 69);
  v12 = 0LL;
  v13 = 0LL;
  v11[0] = 0LL;
  ...
  if ( v6 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0x10AFu);
  }
  else
  {
    ...
    if ( v8 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x10B5u);
    }
    else
    {
      v11[0] = v13;
      ...
      v7 = v9;
      if ( v9 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x10BBu);
    }
  }
  if ( v12 )
