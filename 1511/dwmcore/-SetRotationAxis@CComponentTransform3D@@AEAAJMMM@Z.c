/*
 * XREFs of ?SetRotationAxis@CComponentTransform3D@@AEAAJMMM@Z @ 0x18012F948
 * Callers:
...
__int64 __fastcall CComponentTransform3D::SetRotationAxis(CComponentTransform3D *this, float a2, float a3, float a4)
{
  ...
  v4 = 0;
  if ( *((double *)this + 24) != a2 || *((double *)this + 25) != a3 || *((double *)this + 26) != a4 )
  {
    *((double *)this + 24) = a2;
    *((double *)this + 25) = a3;
    *((double *)this + 26) = a4;
    ...
    *(float *)&v8[1] = a3;
    *(float *)&v8[2] = a4;
    v6 = CPropertyChangeResource::NotifyVector3PropertyChanged(this, 21LL, (const struct D2DVector3 *)v8);
    v4 = v6;
    if ( v6 < 0 )
