/*
 * XREFs of ?CreateSlowHitTestRegion@CPrimitiveGroup@@AEBAJXZ @ 0x180091F88
 * Callers:
...
__int64 __fastcall CPrimitiveGroup::CreateSlowHitTestRegion(CPrimitiveGroup *this)
{
  ...
  while ( v4 < v5 )
  {
    ...
    {
      v3 = -2147467259;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x547u);
      goto LABEL_45;
    }
    v8 = *v6 == 0;
    v9 = *(float *)v7;
    ...
    if ( !v8 )
    {
      ...
      {
        v3 = -2147467259;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x564u);
        goto LABEL_45;
      }
      v12 = &v47;
      v13 = 4LL;
  ...
  while ( 1 )
  {
    ...
    {
      v3 = -2147467259;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x596u);
      goto LABEL_45;
    }
    v27 = 0;
