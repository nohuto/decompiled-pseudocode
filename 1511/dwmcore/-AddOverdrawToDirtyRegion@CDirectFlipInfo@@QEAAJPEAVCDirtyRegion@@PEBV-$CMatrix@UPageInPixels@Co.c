/*
 * XREFs of ?AddOverdrawToDirtyRegion@CDirectFlipInfo@@QEAAJPEAVCDirtyRegion@@PEBV?$CMatrix@UPageInPixels@CoordinateSpace@@UDeviceHPC@2@@@@Z @ 0x180108EA0
 * Callers:
        ...
        const struct CBaseMatrix *a3)
{
  ...
  if ( *(_QWORD *)(a1 + 48) )
  {
    ...
    while ( (unsigned __int64)v13 < v12 )
    {
      ...
      v7 = CDirtyRegion::Add(a2, 0LL, 0LL, v16);
      v3 = v7;
      if ( v7 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0x23Eu);
        return v3;
      }
