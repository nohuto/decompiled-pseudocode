/*
 * XREFs of ?NotifyDirtyClip@CWindowNode@@QEAAJPEAVCResourceTable@@PEAUHRGN__@@@Z @ 0x180063538
 * Callers:
...
__int64 __fastcall CWindowNode::NotifyDirtyClip(CWindowNode *this, struct CResourceTable *a2, HRGN a3)
{
  ...
  if ( (*((_BYTE *)this + 1225) || !*((_BYTE *)this + 1196)) && v8 )
    return (unsigned int)v7;
  v41 = 0LL;
  if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
    Template_xdd(v10, v9, *((_QWORD *)this + 103), *((_DWORD *)this + 260) != 0, *((_QWORD *)this + 129) != 0LL);
  if ( !*((_DWORD *)this + 260) || !*((_QWORD *)this + 129) )
    goto LABEL_21;
  ...
  if ( LatestValidSpriteImage )
  {
    if ( EventEnabled(Microsoft_Windows_Dwm_CoreHandle, &EVTDESC_ETWGUID_PRE_DWMCLIPWINDOW) )
    {
      ...
      if ( v27 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v27, 0x329u);
        v5 = v37;
        goto LABEL_23;
      }
      v5 = v37;
    ...
    v13 = (*(__int64 (__fastcall **)(struct ISpriteImage *, HRGN))(*(_QWORD *)LatestValidSpriteImage + 232LL))(
  ...
  v15 = *((_DWORD *)this + 210) - *((_DWORD *)this + 226);
  LODWORD(v37) = *((_DWORD *)this + 211) - *((_DWORD *)this + 227);
  v14 = (int)v37;
  SetLastError(0);
  v16 = v14;
  v17 = hrgn;
...
LABEL_57:
    ...
    if ( LatestValidSpriteImage
      && (*(unsigned __int8 (__fastcall **)(struct ISpriteImage *))(*(_QWORD *)LatestValidSpriteImage + 184LL))(LatestValidSpriteImage) )
    {
      CGeometry::GetShapeDataNoRef(*((CGeometry **)this + 129), (const struct D2D_SIZE_F *)((char *)this + 132), &v41);
    }
    *((_BYTE *)this + 1224) = 1;
    SetLastError(0);
...
LABEL_21:
      if ( (Microsoft_Windows_Dwm_CoreEnableBits & 2) != 0 )
        Template_x(v10, &EVTDESC_ETWGUID_DWMCLIPWINDOW_Stop, *((_QWORD *)this + 103));
      goto LABEL_23;
    }
    v35 = GetLastError();
    v7 = v35;
...
LABEL_55:
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v19, 0x34Au);
  v4 = v38;
LABEL_23:
  if ( v5 )
