/*
 * XREFs of ?IsOfType@?$TValueResource@UMilRectF@@UMILCMD_RECTRESOURCE@@$0DB@@@UEBA_NW4MIL_RESOURCE_TYPE@@@Z @ 0x1800ABEA0
 * Callers:
...
bool __fastcall TValueResource<MilRectF,MILCMD_RECTRESOURCE,49>::IsOfType(__int64 a1, int a2)
{
  return a2 == 49;
}
