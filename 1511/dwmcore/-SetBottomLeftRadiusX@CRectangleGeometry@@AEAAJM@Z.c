/*
 * XREFs of ?SetBottomLeftRadiusX@CRectangleGeometry@@AEAAJM@Z @ 0x180065648
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetBottomLeftRadiusX(CRectangleGeometry *this, float a2)
{
  ...
  if ( *((float *)this + 34) != a2 )
  {
    *((float *)this + 34) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyFloatPropertyChanged(this, 8LL, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x219u);
  }
  return v2;
}
