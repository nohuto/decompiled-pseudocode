/*
 * XREFs of ?AddRenderTarget@CDesktopRenderTarget@@AEAAJPEAVCHwndRenderTarget@@@Z @ 0x18007566C
 * Callers:
...
__int64 __fastcall CDesktopRenderTarget::AddRenderTarget(CDesktopRenderTarget *this, CDisplay **a2)
{
  ...
  if ( *((_QWORD *)this + 7) )
  {
    v4 = (*((__int64 (__fastcall **)(CDisplay **, _QWORD))*a2 + 23))(a2, *((_QWORD *)this + 7));
    v5 = v4;
    if ( v4 < 0 )
    {
      v11 = 777;
...
LABEL_17:
  ...
  {
    v10 = DynArrayImpl<0>::AddMultipleAndSet((char *)this + 88, 8LL, 1LL, &v12);
    v9 = v10;
    if ( v10 < 0 )
