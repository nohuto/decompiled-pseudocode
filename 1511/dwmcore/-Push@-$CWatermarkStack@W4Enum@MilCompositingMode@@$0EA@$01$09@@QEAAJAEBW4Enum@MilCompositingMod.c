/*
 * XREFs of ?Push@?$CWatermarkStack@W4Enum@MilCompositingMode@@$0EA@$01$09@@QEAAJAEBW4Enum@MilCompositingMode@@@Z @ 0x18015B178
 * Callers:
...
__int64 __fastcall CWatermarkStack<enum MilCompositingMode::Enum,64,2,10>::Push(unsigned int *a1, _DWORD *a2)
{
  ...
  if ( *a1 == v2 )
  {
    ...
    if ( (unsigned int)v7 <= 0x40 )
      LODWORD(v7) = 64;
    v8 = WPF::HrMalloc((WPF *)a1, 4uLL, (unsigned int)v7, &v13);
    v6 = v8;
    if ( v8 < 0 )
    {
