/*
 * XREFs of ?SetColors@CGradientColorData@@QEAAJPEBU_D3DCOLORVALUE@@I@Z @ 0x18015A5B4
 * Callers:
...
LABEL_53:
    ...
    if ( v9 > *((_DWORD *)this + 5) )
    {
      v14 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this, 16, 1, a2);
      v10 = v14;
      if ( v14 < 0 )
...
LABEL_20:
    ...
    {
      v18 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this, 16, 1, a2);
      v13 = v18;
      if ( v18 < 0 )
...
LABEL_28:
  ...
  {
    v21 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this, 16, a3, a2);
    v20 = v21;
    if ( v21 < 0 )
...
LABEL_38:
  ...
  if ( v16 > *((_DWORD *)v4 + 5) )
  {
    v25 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v4, 4, 1, &v33);
    v17 = v25;
    if ( v25 < 0 )
  ...
  if ( v8 > 1 )
  {
    while ( 1 )
    {
      ...
      if ( v24 > *((_DWORD *)v4 + 5) )
      {
        v26 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v4, 4, 1, &v33);
        v27 = v26;
        if ( v26 < 0 )
...
LABEL_52:
  ...
  if ( v29 > *((_DWORD *)v4 + 5) )
  {
    v31 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v4, 4, 1, &v33);
    v30 = v31;
    if ( v31 < 0 )
