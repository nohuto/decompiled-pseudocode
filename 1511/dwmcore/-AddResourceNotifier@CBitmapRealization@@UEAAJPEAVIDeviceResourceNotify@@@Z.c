/*
 * XREFs of ?AddResourceNotifier@CBitmapRealization@@UEAAJPEAVIDeviceResourceNotify@@@Z @ 0x180083330
 * Callers:
...
__int64 __fastcall CBitmapRealization::AddResourceNotifier(CBitmapRealization *this, struct IDeviceResourceNotify *a2)
{
  ...
  else
  {
    ...
    {
      v6 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 288, 8, 1, &v7);
      v4 = v6;
      if ( v6 < 0 )
