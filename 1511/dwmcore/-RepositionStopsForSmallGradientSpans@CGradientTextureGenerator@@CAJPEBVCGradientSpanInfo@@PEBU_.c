/*
 * XREFs of ?RepositionStopsForSmallGradientSpans@CGradientTextureGenerator@@CAJPEBVCGradientSpanInfo@@PEBU_D3DCOLORVALUE@@1PEAV?$DynArray@UMILGradientStop@@$0A@@@@Z @ 0x18016782C
 * Callers:
...
LABEL_31:
    ...
    if ( v19 > *(_DWORD *)(a4 + 20) )
    {
      v24 = DynArrayImpl<0>::AddMultipleAndSet(a4, 20, 1, v34);
      v20 = v24;
      if ( v24 < 0 )
...
LABEL_30:
  ...
  if ( v23 > *(_DWORD *)(a4 + 20) )
  {
    v32 = DynArrayImpl<0>::AddMultipleAndSet(a4, 20, 1, v34);
    v20 = v32;
    if ( v32 < 0 )
