/*
 * XREFs of ?UnRegisterNNotifiersInternal@CVisualGroup@@AEAAXPEAPEAVCVisual@@I@Z @ 0x1801249AC
 * Callers:
      ...
      if ( v7 < v8 )
      {
        ...
        if ( (unsigned int)i < v8 )
        {
          if ( (unsigned int)i < v8 - 1 )
          {
            ...
            while ( (unsigned int)v12 < *((_DWORD *)v6 + 184) - 1 );
          }
          --*((_DWORD *)v6 + 184);
        }
      }
