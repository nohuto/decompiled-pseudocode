/*
 * XREFs of ?EvaluateCondition@ValueTrigger@Animations@Components@@QEAA_NPEAVValue@23@@Z @ 0x180165E8C
 * Callers:
        ...
        struct Components::Animations::Value *a2)
{
  ...
  Components::Animations::Value::GetColor((__int64)a2, (__int64)&v18);
  Components::Animations::Value::GetColor((__int64)v22, (__int64)&v14);
  v7 = *((_DWORD *)this + 2);
  if ( !v7 )
  {
