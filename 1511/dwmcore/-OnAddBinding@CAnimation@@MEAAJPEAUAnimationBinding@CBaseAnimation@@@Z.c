/*
 * XREFs of ?OnAddBinding@CAnimation@@MEAAJPEAUAnimationBinding@CBaseAnimation@@@Z @ 0x180083DE0
 * Callers:
 ...
 *     ?GetPrimitive@CSharedSectionAnimationPrimitiveBuffer@@UEAAPEBUDwmAnimationPrimitive@@I@Z @ 0x1800A94E0 (-GetPrimitive@CSharedSectionAnimationPrimitiveBuffer@@UEAAPEBUDwmAnimationPrimitive@@I@Z.c)
...
__int64 __fastcall CAnimation::OnAddBinding(CAnimation *this, struct CBaseAnimation::AnimationBinding *a2)
{
  ...
  if ( v2 )
  {
    ...
    if ( v6 )
    {
      ...
      {
        CAnimationInterpolator::GetInterpolatedValue((CAnimation **)this + 31, *((_QWORD *)v6 + 1), &v12, 0LL);
