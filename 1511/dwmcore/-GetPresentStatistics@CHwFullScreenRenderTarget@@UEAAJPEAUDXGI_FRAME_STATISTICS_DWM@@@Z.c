/*
 * XREFs of ?GetPresentStatistics@CHwFullScreenRenderTarget@@UEAAJPEAUDXGI_FRAME_STATISTICS_DWM@@@Z @ 0x180073E60
 * Callers:
...
LABEL_10:
  ...
  {
    v10 = *(__int64 (__fastcall **)(CDWMSwapChain *, struct DXGI_FRAME_STATISTICS_DWM *))(*(_QWORD *)v9 + 280LL);
  ...
  TranslateDXGIorD3DErrorInContext((unsigned int)v4, 0LL, &v13);
  result = v13;
