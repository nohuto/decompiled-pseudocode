/*
 * XREFs of ?CopyTexture@CD3DDeviceLevel1@@QEAAJPEAUID3D11Texture2D@@IAEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAVIBitmapDest@@@Z @ 0x180011778
 * Callers:
        ...
        __int64 *a5)
{
  ...
  *(_QWORD *)&v47 = "DWM Temp Readback (bitmap1)";
  ...
  if ( v12 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v12, 0xCA7u);
    goto LABEL_16;
  }
  ...
  *(_DWORD *)(a1 + 508) = CurrentThreadId;
  ...
  v16 = (*(__int64 (__fastcall **)(_QWORD, __int64, _QWORD, __int64, _DWORD, unsigned __int8 **))(**(_QWORD **)(a1 + 560)
                                                                                                + 112LL))(
          *(_QWORD *)(a1 + 560),
          v31,
          0LL,
  ...
  if ( v16 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v16, 0xCCEu);
    goto LABEL_16;
  }
  v43 = v53;
  v44 = 0LL;
  ...
  *(_QWORD *)&v47 = 0LL;
  ...
  if ( v18 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v18, 0xCECu);
  }
  else
  {
    ...
    if ( v19 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v19, 0xCF1u);
    }
    else
    {
      ...
      if ( v22 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v22, 0xD09u);
        v8 = v33;
      }
      else
      {
        v23 = IsEqualPixelFormatInfo((const struct PixelFormatInfo *)&v43, (const struct PixelFormatInfo *)&v37);
        v8 = v33;
        if ( v23 )
        {
          v24 = v33;
        ...
        v29 = CFormatConverter::HrConvertBitmap(v33, (const struct PixelFormatInfo *)&v37, &v34);
        v13 = v29;
        if ( v29 >= 0 )
        {
          v9 = v34;
          v24 = v34;
LABEL_8:
          v25 = (*(__int64 (__fastcall **)(__int64, unsigned int *, __int64 **))(*(_QWORD *)v30 + 72LL))(
                  v30,
                  &v32,
                  &v35);
          v13 = v25;
          if ( v25 < 0 )
          {
            MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v25, 0xD1Cu);
          }
          else
          {
            v26 = (*(__int64 (__fastcall **)(__int64, struct IUnknown **))(*(_QWORD *)v30 + 64LL))(v30, &v36);
            v13 = v26;
            if ( v26 < 0 )
            {
              MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v26, 0xD1Du);
            }
            else
            {
              v27 = (*(__int64 (__fastcall **)(struct IBitmapSource *, __int128 *, _QWORD, _QWORD, __int64 *))(*(_QWORD *)v24 + 72LL))(
                      v24,
                      &v47,
                      (unsigned int)v36,
                      v32,
              ...
              v13 = v27;
              if ( v27 < 0 )
                MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v27, 0xD30u);
            }
          }
          goto LABEL_12;
        }
        MilInstrumentationCheckHR(0x14u, &dword_180170188, 0xAu, v29, 0xD17u);
        v9 = v34;
      }
    }
  }
LABEL_12:
  (*(void (__fastcall **)(_QWORD, __int64, _QWORD))(**(_QWORD **)(a1 + 560) + 120LL))(*(_QWORD *)(a1 + 560), v31, 0LL);
  if ( v9 )
...
LABEL_16:
  ...
  return CD3DDeviceLevel1::TranslateDriverError(a1, v13, 0LL);
}
