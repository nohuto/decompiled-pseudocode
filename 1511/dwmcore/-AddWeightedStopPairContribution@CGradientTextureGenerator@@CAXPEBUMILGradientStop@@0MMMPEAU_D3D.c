/*
 * XREFs of ?AddWeightedStopPairContribution@CGradientTextureGenerator@@CAXPEBUMILGradientStop@@0MMMPEAU_D3DCOLORVALUE@@@Z @ 0x18016731C
 * Callers:
 ...
 *     ?IsPositionLessThanOrEqual@CGradientTextureGenerator@@CAHMM@Z @ 0x180167750 (-IsPositionLessThanOrEqual@CGradientTextureGenerator@@CAHMM@Z.c)
 */
