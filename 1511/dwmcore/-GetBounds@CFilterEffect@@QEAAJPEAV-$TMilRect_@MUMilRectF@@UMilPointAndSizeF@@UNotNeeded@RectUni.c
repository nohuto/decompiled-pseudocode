/*
 * XREFs of ?GetBounds@CFilterEffect@@QEAAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x18001A944
 * Callers:
  ...
  *(_DWORD *)(v3 + 32) = v8;
  ...
  if ( !(_DWORD)v9 )
  {
    ...
    *(_OWORD *)&v39[4] = v10;
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0xEEu);
      goto LABEL_8;
    }
LABEL_6:
    (*(void (__fastcall **)(__int64, __int128 *, __int64))(*(_QWORD *)v3 + 112LL))(a1, &v28, v35);
    goto LABEL_7;
  }
  v13 = 0LL;
  v37 = *(int *)(v3 + 152);
  ...
  while ( 1 )
  {
    v14 = *(_QWORD *)(*(_QWORD *)(v3 + 144) + 8 * v13);
    v15 = *(_QWORD *)(v3 + 136);
    v34 = v14;
...
LABEL_20:
    ...
    *(_OWORD *)&v39[4] = v38;
    if ( v5 + 1 < v5 )
    {
      ...
      v4 = -2147024362;
LABEL_30:
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v25, 0x11Bu);
      goto LABEL_7;
    }
    v4 = 0;
    if ( v20 > v30 )
  ...
  {
    Bounds = CFilterEffect::GetBounds(*(_QWORD *)(v14 + 24), v33, &v38);
    v4 = Bounds;
    if ( Bounds < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, Bounds, 0x102u);
      goto LABEL_7;
    }
    goto LABEL_18;
  }
  if ( (*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(v14 + 24) + 48LL))(
         *(_QWORD *)(v14 + 24),
         87LL) )
  {
    v18 = *(__m128i *)(v34 + 4);
