/*
 * XREFs of ?RegisterVisualGroup@CVisual@@QEAAJPEAVCVisualGroup@@@Z @ 0x180120BA4
 * Callers:
...
__int64 __fastcall CVisual::RegisterVisualGroup(CVisual *this, struct CVisualGroup *a2)
{
  ...
  v10 = a2;
  v2 = 0;
  v3 = (struct CVisualGroup **)*((_QWORD *)this + 89);
  for ( i = 0; i < *((_DWORD *)this + 184); ++v3 )
  {
    if ( a2 == *v3 )
      break;
    ++i;
  }
  if ( i >= *((_DWORD *)this + 184) )
  {
    v5 = *((_DWORD *)this + 184);
    v6 = v5 + 1;
    if ( v5 + 1 < v5 )
    {
      ...
      v2 = -2147024362;
LABEL_12:
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v7, 0xBEBu);
      return v2;
    }
    if ( v6 > *((_DWORD *)this + 183) )
    {
      v8 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 712, 8, 1, &v10);
      v7 = v8;
      if ( v8 < 0 )
    ...
    {
      *(_QWORD *)(*((_QWORD *)this + 89) + 8LL * *((unsigned int *)this + 184)) = v10;
      *((_DWORD *)this + 184) = v6;
    }
  }
  return v2;
