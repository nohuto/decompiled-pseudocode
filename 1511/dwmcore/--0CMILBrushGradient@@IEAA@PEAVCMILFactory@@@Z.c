/*
 * XREFs of ??0CMILBrushGradient@@IEAA@PEAVCMILFactory@@@Z @ 0x180014D20
 * Callers:
 *     ??0CLinearGradientLegacyMilBrush@@IEAA@PEAVCComposition@@@Z @ 0x180013948 (--0CLinearGradientLegacyMilBrush@@IEAA@PEAVCComposition@@@Z.c)
 * Callees:
 *     ??0CMILBrushWithCache@@QEAA@XZ @ 0x180069298 (--0CMILBrushWithCache@@QEAA@XZ.c)
 */
