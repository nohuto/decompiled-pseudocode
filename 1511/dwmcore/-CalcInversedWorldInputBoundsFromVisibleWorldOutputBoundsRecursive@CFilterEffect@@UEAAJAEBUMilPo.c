/*
 * XREFs of ?CalcInversedWorldInputBoundsFromVisibleWorldOutputBoundsRecursive@CFilterEffect@@UEAAJAEBUMilPoint2F@@AEBV?$CRectF@UDeviceHPC@CoordinateSpace@@@@11PEAV3@2@Z @ 0x18001A5E0
 * Callers:
 *     <none>
 * Callees:
        ...
        __int64 a7)
{
  ...
  {
    v10 = -2147467259;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x18Du);
    goto LABEL_4;
  }
  (*(void (__fastcall **)(_DWORD *, float *, __int64, _DWORD *, __int64, __int128 *, __int128 *))(*(_QWORD *)a1 + 152LL))(
    a1,
    a2,
    a3,
    a1 + 44,
  ...
  if ( v14 > 0 )
  {
    while ( 1 )
    {
      ...
      *(_OWORD *)v59 = v56;
      v8 = a2;
      v22 = (*(__int64 (__fastcall **)(__int64, float *, _BYTE *, __int64, __int64, __int64, __int128 *))(*(_QWORD *)v21 + 136LL))(
              v21,
              a2,
              v59,
              v21 + 176,
...
LABEL_38:
  (*(void (__fastcall **)(_DWORD *, __int128 *, __int128 *))(*(_QWORD *)a1 + 112LL))(a1, &v51, &v57);
  v40 = *((float *)&v57 + 1);
  v41 = *(float *)&v57 + *v8;
  v42 = *((float *)&v57 + 2);
  *(float *)a7 = v41;
