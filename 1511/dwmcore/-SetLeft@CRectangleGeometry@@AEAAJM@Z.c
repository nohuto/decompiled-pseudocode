/*
 * XREFs of ?SetLeft@CRectangleGeometry@@AEAAJM@Z @ 0x1800658D8
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetLeft(CRectangleGeometry *this, float a2)
{
  ...
  if ( *((float *)this + 26) != a2 )
  {
    *((float *)this + 26) = a2;
    ...
    v5 = CPropertyChangeResource::NotifyFloatPropertyChanged(this, 0LL, a2);
    v2 = v5;
    if ( v5 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x179u);
  }
  return v2;
}
