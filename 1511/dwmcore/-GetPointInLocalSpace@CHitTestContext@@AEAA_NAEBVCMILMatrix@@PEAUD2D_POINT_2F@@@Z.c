/*
 * XREFs of ?GetPointInLocalSpace@CHitTestContext@@AEAA_NAEBVCMILMatrix@@PEAUD2D_POINT_2F@@@Z @ 0x18000801C
 * Callers:
        ...
        struct D2D_POINT_2F *a3)
{
  ...
  result = 0;
  v4 = (float)(*((float *)a2 + 3) * *((float *)this + 24)) - *(float *)a2;
  v5 = (float)(*((float *)a2 + 3) * *((float *)this + 25)) - *((float *)a2 + 1);
  v6 = (float)(*((float *)a2 + 7) * *((float *)this + 25)) - *((float *)a2 + 5);
  v7 = (float)(*((float *)this + 24) * *((float *)a2 + 7)) - *((float *)a2 + 4);
  if ( (float)(v4 * v6) != (float)(v5 * v7) )
  {
    v8 = (float)(v4 * v6) - (float)(v5 * v7);
    v9 = *((float *)a2 + 15);
    result = 1;
    v10 = (float)(v9 * *((float *)this + 25)) - *((float *)a2 + 13);
    v11 = (float)(v9 * *((float *)this + 24)) - *((float *)a2 + 12);
