/*
 * XREFs of ?SetInteractionConfiguration@CInteractionProcessor@@QEAAJW4Enum@InteractionConfigurationUpdateType@@W42InteractionInputType@@PEBXI@Z @ 0x1800A7EB0
 * Callers:
...
LABEL_10:
    ...
    if ( a2 )
      v15 = a1 + 320;
    v13 = `anonymous namespace'::SetArrayConfiguration<DwmTouchInteractionConfigurationPrimitive>(a4, a5, v15);
    if ( v13 >= 0 )
    {
      if ( !a2 )
        *(_BYTE *)(a1 + 264) |= 1u;
  ...
  else
  {
    ...
    if ( a2 )
      v16 = a1 + 288;
    v13 = `anonymous namespace'::SetArrayConfiguration<DwmTouchInteractionConfigurationPrimitive>(a4, a5, v16);
    if ( v13 >= 0 )
    {
      if ( !a2 )
        *(_BYTE *)(a1 + 128) |= 1u;
