/*
 * XREFs of ?ProcessSetColorProperty@CPropertyBagBase@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PROPERTYBAGBASE_SETCOLORPROPERTY@@@Z @ 0x1800F9648
 * Callers:
        ...
        const struct MILCMD_PROPERTYBAGBASE_SETCOLORPROPERTY *a3)
{
  ...
  v7 = *((_OWORD *)a3 + 1);
  v4 = v3(this, *((unsigned int *)a3 + 3), *((unsigned int *)a3 + 2), 70LL, &v7);
  v5 = v4;
  if ( v4 < 0 )
