/*
 * XREFs of ?Create@CD3DPixelShader@@SAJPEAVCD3DDeviceLevel1@@PEBX_KPEAPEAV1@@Z @ 0x1801499A8
 * Callers:
...
LABEL_6:
  ...
  v12 = (*(__int64 (__fastcall **)(_QWORD, const void *, __int64, _QWORD, struct ID3D11Buffer **))(**((_QWORD **)a1 + 69)
                                                                                                 + 120LL))(
          *((_QWORD *)a1 + 69),
          a2,
          a3,
...
LABEL_9:
  ...
  v12 = CD3DConstantBuffer::Initialize(v9, (struct CD3DDeviceLevel1 *)((char *)a1 + 848), a3, v15);
  v10 = v12;
  if ( v12 < 0 )
  {
    v14 = 46;
