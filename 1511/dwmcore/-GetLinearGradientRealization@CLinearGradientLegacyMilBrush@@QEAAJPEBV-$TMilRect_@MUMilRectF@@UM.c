/*
 * XREFs of ?GetLinearGradientRealization@CLinearGradientLegacyMilBrush@@QEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAVCGradientColorData@@PEAVCMILBrushLinearGradient@@@Z @ 0x180013E48
 * Callers:
 ...
 *     ?SetWrapMode@CMILBrushGradient@@UEAAJW4Enum@MilGradientWrapMode@@@Z @ 0x180014CA0 (-SetWrapMode@CMILBrushGradient@@UEAAJW4Enum@MilGradientWrapMode@@@Z.c)
...
LABEL_3:
  ...
  else
  {
    ...
    *(_QWORD *)(a4 + 148) = v14[0];
    *(_QWORD *)(a4 + 140) = v10;
    v11 = CMILBrushGradient::SetWrapMode(a4 + 120, *(unsigned int *)(a1 + 112));
    v8 = v11;
    if ( v11 < 0 )
    {
