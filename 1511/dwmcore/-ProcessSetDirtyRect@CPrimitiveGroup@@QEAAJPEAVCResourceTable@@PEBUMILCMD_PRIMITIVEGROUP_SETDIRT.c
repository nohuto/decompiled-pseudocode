/*
 * XREFs of ?ProcessSetDirtyRect@CPrimitiveGroup@@QEAAJPEAVCResourceTable@@PEBUMILCMD_PRIMITIVEGROUP_SETDIRTYRECT@@PEBXI@Z @ 0x18009145C
 * Callers:
        ...
        unsigned int a5)
{
  ...
  if ( v6 && a5 == 16LL * v6 )
  {
         ...
         && *(float *)&a4[4 * v11 + 3] <= 16777216.0 )
    {
      ...
      v24 = FastRegion::CRegion::Union(this + 54, (const struct FastRegion::Internal::CRgnData **)&v27);
      if ( v24 < 0 )
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v24, 0x18Eu);
        break;
      }
      if ( (unsigned int)++v11 >= *((_DWORD *)a3 + 2) )
      {
        CResource::NotifyOnChanged(this, 1u, (CCompositionSurfaceBitmap *)this);
        v10 = 0;
        break;
      }
      v5 = v27;
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x17Eu);
  }
  *(_DWORD *)this[54] = 0;
  if ( v10 )
