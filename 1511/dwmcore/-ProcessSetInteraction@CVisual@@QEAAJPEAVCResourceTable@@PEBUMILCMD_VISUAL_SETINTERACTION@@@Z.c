/*
 * XREFs of ?ProcessSetInteraction@CVisual@@QEAAJPEAVCResourceTable@@PEBUMILCMD_VISUAL_SETINTERACTION@@@Z @ 0x180048530
 * Callers:
        ...
        const struct MILCMD_VISUAL_SETINTERACTION *a3)
{
  ...
  if ( v3 )
  {
    Resource = CResourceTable::GetResource(a2, v3, 96LL);
    if ( Resource )
  ...
  v9 = v8;
  if ( v8 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0xA09u);
  return v9;
}
