/*
 * XREFs of ?HrCalcRequiredBufferSizeWorker@@YAJIIIIPEAI@Z @ 0x1800A15A0
 * Callers:
...
LABEL_14:
    v5 = -2147024362;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024362, v13);
    return v5;
  }
  ...
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024809, 0x63Fu);
    return v5;
  }
  v11 = v6 * v8;
  if ( v11 > 0xFFFFFFFF )
