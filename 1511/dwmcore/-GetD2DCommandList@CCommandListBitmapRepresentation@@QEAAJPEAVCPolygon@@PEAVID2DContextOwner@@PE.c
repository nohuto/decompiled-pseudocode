/*
 * XREFs of ?GetD2DCommandList@CCommandListBitmapRepresentation@@QEAAJPEAVCPolygon@@PEAVID2DContextOwner@@PEAVID2DContext@@PEAPEAUID2D1PrivateCompositorCommandList@@@Z @ 0x18000B538
 * Callers:
...
LABEL_24:
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, D2DBitmapRealization, 0x6Du);
      goto LABEL_11;
    }
    if ( !v34 )
      goto LABEL_19;
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v22, 0x7Du);
      v6 = v36;
      goto LABEL_11;
    }
    ...
    *(_DWORD *)(v25 + 144) = *((_DWORD *)this + 74);
    ...
    if ( v26 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v26, 0x9Bu);
      goto LABEL_11;
    }
