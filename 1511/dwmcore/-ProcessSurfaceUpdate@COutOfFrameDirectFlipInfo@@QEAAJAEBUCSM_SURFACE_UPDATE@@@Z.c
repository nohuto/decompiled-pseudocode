/*
 * XREFs of ?ProcessSurfaceUpdate@COutOfFrameDirectFlipInfo@@QEAAJAEBUCSM_SURFACE_UPDATE@@@Z @ 0x1800ADEF0
 * Callers:
        ...
        const struct CSM_SURFACE_UPDATE *a2)
{
  ...
  *((_DWORD *)this + 26) = *((_DWORD *)a2 + 63);
  *((_QWORD *)this + 12) = *((_QWORD *)a2 + 1);
  v2 = CCompositionSurfaceInfo::ProcessSurfaceUpdate(*((CCompositionSurfaceInfo **)this + 4), a2);
  v3 = v2;
  if ( v2 < 0 )
