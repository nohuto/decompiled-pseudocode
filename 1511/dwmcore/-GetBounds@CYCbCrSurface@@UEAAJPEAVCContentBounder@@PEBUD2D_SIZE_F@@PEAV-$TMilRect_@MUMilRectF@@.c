/*
 * XREFs of ?GetBounds@CYCbCrSurface@@UEAAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x180127B10
 * Callers:
 *     <none>
 * Callees:
 *     <none>
