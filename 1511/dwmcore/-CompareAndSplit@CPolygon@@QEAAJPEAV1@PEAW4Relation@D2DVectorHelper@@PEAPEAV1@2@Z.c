/*
 * XREFs of ?CompareAndSplit@CPolygon@@QEAAJPEAV1@PEAW4Relation@D2DVectorHelper@@PEAPEAV1@2@Z @ 0x180131084
 * Callers:
 ...
 *     ?ClassifyPoint@D2DVectorHelper@@YA?AW4Relation@1@AEBUD2D_VECTOR_4F@@0@Z @ 0x180131028 (-ClassifyPoint@D2DVectorHelper@@YA-AW4Relation@1@AEBUD2D_VECTOR_4F@@0@Z.c)
    ...
    if ( v31 == 1 )
    {
      if ( v29 == 2 )
      {
        ...
        if ( (unsigned int)(HIDWORD(v117) + 1) < HIDWORD(v117) )
        {
          ...
          v7 = -2147024362;
LABEL_101:
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v37, 0x11Du);
          goto LABEL_137;
        }
        if ( v33 > (unsigned int)v117 )
        {
          v36 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v115, 20, 1, &v106);
          v37 = v36;
          if ( v36 < 0 )
        ...
        if ( (unsigned int)(HIDWORD(v134) + 1) < HIDWORD(v134) )
        {
          ...
          v7 = -2147024362;
LABEL_99:
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v42, 0x120u);
          goto LABEL_137;
        }
        if ( v38 > (unsigned int)v134 )
        {
          v41 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v132, 20, 1, &v106);
          v42 = v41;
          if ( v41 < 0 )
      ...
      if ( v28 + 1 < v28 )
      {
        ...
        v7 = -2147024362;
LABEL_103:
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v46, 0x125u);
        goto LABEL_137;
      }
      v7 = 0;
      if ( v28 + 1 > (unsigned int)v117 )
      {
        v45 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v115, 20, 1, &v108);
        v46 = v45;
        if ( v45 < 0 )
    ...
    if ( v31 == 2 )
    {
      if ( v29 == 1 )
      {
        ...
        if ( (unsigned int)(HIDWORD(v117) + 1) < HIDWORD(v117) )
        {
          ...
          v7 = -2147024362;
LABEL_107:
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v52, 0x136u);
          goto LABEL_137;
        }
        if ( v48 > (unsigned int)v117 )
        {
          v51 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v115, 20, 1, &v106);
          v52 = v51;
          if ( v51 < 0 )
        ...
        if ( (unsigned int)(HIDWORD(v134) + 1) < HIDWORD(v134) )
        {
          ...
          v7 = -2147024362;
LABEL_105:
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v57, 0x139u);
          goto LABEL_137;
        }
        if ( v53 > (unsigned int)v134 )
        {
          v56 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v132, 20, 1, &v106);
          v57 = v56;
          if ( v56 < 0 )
      ...
      if ( (unsigned int)(HIDWORD(v134) + 1) < HIDWORD(v134) )
      {
        ...
        v7 = -2147024362;
LABEL_109:
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v62, 0x13Fu);
        goto LABEL_137;
      }
      v7 = 0;
      if ( v58 > (unsigned int)v134 )
      {
        v61 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v132, 20, 1, &v108);
        v62 = v61;
        if ( v61 < 0 )
    ...
    if ( v29 == 1 )
    {
      if ( v27 == 2 )
      {
        ...
        if ( v28 + 1 < v28 )
        {
          ...
          v7 = -2147024362;
LABEL_113:
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v66, 0x151u);
          goto LABEL_137;
        }
        if ( v28 + 1 > (unsigned int)v117 )
        {
          v65 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v115, 20, 1, &v106);
          v66 = v65;
          if ( v65 < 0 )
        ...
        if ( (unsigned int)(HIDWORD(v134) + 1) < HIDWORD(v134) )
        {
          ...
          v7 = -2147024362;
LABEL_111:
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v73, 0x154u);
          goto LABEL_137;
        }
        v7 = 0;
        if ( v68 <= (unsigned int)v134 )
          goto LABEL_62;
        v72 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v132, 20, 1, &v106);
        v73 = v72;
        if ( v72 < 0 )
...
LABEL_82:
      if ( v28 + 1 < v28 )
      {
        ...
        v7 = -2147024362;
LABEL_135:
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v83, 0x163u);
        goto LABEL_137;
      }
      if ( v28 + 1 > (unsigned int)v117 )
      {
        v82 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v115, 20, 1, &v108);
        v83 = v82;
        if ( v82 < 0 )
      ...
      if ( (unsigned int)(HIDWORD(v134) + 1) < HIDWORD(v134) )
      {
        ...
        v7 = -2147024362;
LABEL_133:
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v85, 0x164u);
        goto LABEL_137;
      }
      v7 = 0;
      if ( v68 <= (unsigned int)v134 )
      ...
      v84 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v132, 20, 1, &v108);
      v85 = v84;
      if ( v84 < 0 )
    ...
    if ( v28 + 1 < v28 )
    {
      ...
      v7 = -2147024362;
LABEL_117:
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v77, 0x15Cu);
      goto LABEL_137;
    }
    if ( v28 + 1 > (unsigned int)v117 )
    {
      v76 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v115, 20, 1, &v106);
      v77 = v76;
      if ( v76 < 0 )
    ...
    if ( (unsigned int)(HIDWORD(v134) + 1) < HIDWORD(v134) )
    {
      ...
      v7 = -2147024362;
LABEL_115:
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v79, 0x15Fu);
      goto LABEL_137;
    }
    v7 = 0;
    if ( v68 <= (unsigned int)v134 )
...
LABEL_63:
    ...
    v78 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v132, 20, 1, &v106);
    v79 = v78;
    if ( v78 < 0 )
  ...
  if ( v10 )
  {
    *(_DWORD *)a3 = 3;
    ...
    if ( v87 >= 0 )
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v90, 0x187u);
        v89 = v96;
        v13 = v97;
      }
    }
    ...
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v87, 0x186u);
      v89 = v96;
    }
    if ( v89 )
