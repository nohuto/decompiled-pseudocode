/*
 * XREFs of ?CreateNewD2DCommandList@CAtlasedRects@@AEAAJPEAVID2DContextOwner@@PEAVID2DContext@@PEAUID2D1Bitmap@@PEAPEAVCAtlasedRectsCommandList@@@Z @ 0x180025620
 * Callers:
    ...
    *(_QWORD *)&v57 = 0x3F8000003F800000LL;
    ...
    do
    {
      ...
      *(_QWORD *)&v66 = _mm_unpacklo_ps((__m128)0LL, (__m128)0LL).m128_u64[0];
      MILMatrix3x2::InferAffineMatrix(v63, v49, &v56);
      v21.m128_f32[0] = 1.0
...
LABEL_34:
  ...
  if ( v39 > *((_DWORD *)v6 + 23) )
  {
    v43 = DynArrayImpl<0>::AddMultipleAndSet((char *)v6 + 72, 8LL, 1LL, &v45);
    v42 = v43;
    if ( v43 < 0 )
