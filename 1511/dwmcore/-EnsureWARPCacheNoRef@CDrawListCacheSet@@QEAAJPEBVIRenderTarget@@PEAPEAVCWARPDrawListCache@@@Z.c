/*
 * XREFs of ?EnsureWARPCacheNoRef@CDrawListCacheSet@@QEAAJPEBVIRenderTarget@@PEAPEAVCWARPDrawListCache@@@Z @ 0x180117AB4
 * Callers:
...
LABEL_5:
  ...
  *(_QWORD *)&v18 = v19;
  ...
  if ( (int)v13 + 1 >= (unsigned int)v13 )
  {
    ...
    {
      v17 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v12, 16, 1, &v18);
      v15 = v17;
      if ( v17 < 0 )
...
LABEL_15:
  ...
  v3 = -2147024362;
LABEL_22:
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x1DDu);
LABEL_16:
  if ( v10 )
