/*
 * XREFs of ?ProcessSetDxClip@CWindowNode@@QEAAJPEAVCResourceTable@@PEBUMILCMD_WINDOWNODE_SETDXCLIP@@@Z @ 0x18005E4E8
 * Callers:
        ...
        const struct MILCMD_WINDOWNODE_SETDXCLIP *a3)
{
  ...
  if ( (_DWORD)v6 )
  {
    Resource = (CGeometry *)CResourceTable::GetResource(a2, v6, 65LL);
    if ( !Resource )
    {
      v7 = -2003303421;
  ...
  if ( Resource != *((CGeometry **)this + 143) )
  {
    v11 = 0;
    if ( Resource )
    {
      ShapeDataNoRef = CGeometry::GetShapeDataNoRef(Resource, (const struct D2D_SIZE_F *)((char *)this + 132), v15);
      v7 = ShapeDataNoRef;
      if ( ShapeDataNoRef < 0 )
      {
        v14 = 2262;
    ...
    v13 = (CGeometry *)*((_QWORD *)this + 143);
    if ( v13 )
    {
      ShapeDataNoRef = CGeometry::GetShapeDataNoRef(v13, (const struct D2D_SIZE_F *)((char *)this + 132), v16);
      v7 = ShapeDataNoRef;
      if ( ShapeDataNoRef < 0 )
      {
        v14 = 2267;
    ...
    if ( v3 && CShape::IsAxisAlignedRectangle(v3) && v4 && CShape::IsAxisAlignedRectangle(v4) )
    {
      ...
      CWindowNode::GetGeometryBounds(this, *((_QWORD *)this + 143), v16);
