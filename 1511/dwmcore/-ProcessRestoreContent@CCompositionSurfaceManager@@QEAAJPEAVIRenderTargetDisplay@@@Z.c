/*
 * XREFs of ?ProcessRestoreContent@CCompositionSurfaceManager@@QEAAJPEAVIRenderTargetDisplay@@@Z @ 0x18002B914
 * Callers:
        ...
        struct IRenderTargetDisplay *a2)
{
  ...
  __int64 (__fastcall *v8)(CBitmapRealization *__hidden, const struct _GUID *, void **); // rsi
  int v9; // eax
  int v11; // eax
  ...
  while ( 1 )
  {
    ...
    if ( v7 )
    {
      v8 = **(__int64 (__fastcall ***)(CBitmapRealization *__hidden, const struct _GUID *, void **))v7;
