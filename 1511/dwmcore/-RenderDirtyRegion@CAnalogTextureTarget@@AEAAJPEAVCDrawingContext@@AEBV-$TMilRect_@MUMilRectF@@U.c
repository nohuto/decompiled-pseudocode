/*
 * XREFs of ?RenderDirtyRegion@CAnalogTextureTarget@@AEAAJPEAVCDrawingContext@@AEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@_NPEA_N@Z @ 0x18013C614
 * Callers:
        ...
        _BYTE *a5)
{
  ...
  v7 = 0;
  OptimizedDirtyRects = CDirtyRegion::GetOptimizedDirtyRects(*(CDirtyRegion **)(a1 + 200));
  v10 = *(unsigned int *)(v9 + 440);
  v11 = OptimizedDirtyRects;
  `vector constructor iterator'(
    (CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)v28,
    16LL,
    8,
  ...
  *a5 = 0;
  ...
  for ( i = v28; ; ++i )
  {
    ...
    if ( v23 < 0 )
      break;
    (*(void (__fastcall **)(__int64, __int128 *))(*(_QWORD *)(*(_QWORD *)(a1 + 184) + 176LL) + 208LL))(
      *(_QWORD *)(a1 + 184) + 176LL,
      &v27);
    if ( ++v20 >= v12 )
    {
  ...
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v23, 0x27Cu);
  return v7;
}
