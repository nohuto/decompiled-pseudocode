/*
 * XREFs of ?NotifyTreeDirtyRegion@CHwndRenderTarget@@UEAAXPEBVCVisualTree@@PEBVCDirtyRegion@@@Z @ 0x18007C670
 * Callers:
        ...
        const struct CDirtyRegion *a3)
{
  ...
  *((_QWORD *)this + 8) = a3;
  ...
  v8[8] = v9;
  if ( (v9 & 6) == 2 && (*(unsigned int (__fastcall **)(_DWORD *, _QWORD, _QWORD))(*(_QWORD *)v8 + 96LL))(v8, 0LL, 0LL) )
  {
    v10 = *((_QWORD *)v8 + 3);
    if ( (v10 & 2) != 0 )
