/*
 * XREFs of ?AllocateHwBrush@CHwBrushPoolManager@@QEAAJPEAVCMILBrush@@AEBVCHwBrushContext@@QEAPEAVCHwBrush@@@Z @ 0x180012B40
 * Callers:
 ...
 * Callees:
 *     ?Remove@CHwBrushPoolManager@@AEAAXPEAVCHwCacheablePoolBrush@@@Z @ 0x180012AFC (-Remove@CHwBrushPoolManager@@AEAAXPEAVCHwCacheablePoolBrush@@@Z.c)
...
LABEL_5:
  ...
  while ( v8 < 0 );
  if ( v8 >= 0
    || (v13 = (*(__int64 (__fastcall **)(CHwBrushPoolManager *, struct CMILBrush *, const struct CHwBrushContext *, struct CHwBrush **const))(*(_QWORD *)this + 24LL))(
                this,
                a2,
                a3,
                a4),
  ...
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x1D8u);
  }
