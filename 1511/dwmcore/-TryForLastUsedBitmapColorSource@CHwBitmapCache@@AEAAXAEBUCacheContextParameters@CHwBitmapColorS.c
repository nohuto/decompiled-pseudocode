/*
 * XREFs of ?TryForLastUsedBitmapColorSource@CHwBitmapCache@@AEAAXAEBUCacheContextParameters@CHwBitmapColorSource@@AEAV?$CDelayComputedBounds@URealizationSampling@CoordinateSpace@@@@PEAVCMILBrushBitmap@@AEAPEAV3@3@Z @ 0x18008B728
 * Callers:
...
void CHwBitmapCache::TryForLastUsedBitmapColorSource(CHwBitmapCache *this, __int64 a2, __int64 a3, ...)
{
  ...
  struct CHwBitmapColorSource **v17; // [rsp+78h] [rbp+30h]
      ...
      && *((_DWORD *)this + 138) == *(_DWORD *)(a2 + 40) )
    {
      ...
      if ( v7 == *(_BYTE *)(a2 + 44) && (v7 != 1 || CColorKey::operator==((CHwBitmapCache *)((char *)this + 560))) )
      {
        ...
        if ( !DisplayId::IsSpecific((DisplayId *)va) || *(_DWORD *)(a2 + 28) == v8 )
        {
          ...
          if ( CHwBitmapColorSource::CheckRequiredRealizationBounds(
                 *((_DWORD **)this + 63),
                 a3,
                 *(_DWORD *)(a2 + 8),
                 *(_DWORD *)(a2 + 40),
