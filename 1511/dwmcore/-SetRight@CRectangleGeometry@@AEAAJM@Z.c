/*
 * XREFs of ?SetRight@CRectangleGeometry@@AEAAJM@Z @ 0x18006580C
 * Callers:
...
__int64 __fastcall CRectangleGeometry::SetRight(CRectangleGeometry *this, float a2)
{
  ...
  if ( *((float *)this + 28) != a2 )
  {
    *((float *)this + 28) = a2;
    ...
    v4 = CPropertyChangeResource::NotifyFloatPropertyChanged(this, 2LL, a2);
    v2 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x1A1u);
  }
  return v2;
}
