/*
 * XREFs of ?ReverseAndLeftShift@?A0xe8837992@@YA?AUD2DMatrix@@AEBU2@@Z @ 0x180142C90
 * Callers:
...
__int64 __fastcall `anonymous namespace'::ReverseAndLeftShift(__int64 a1, int *a2)
{
  int v2; // xmm1_4
  int v3; // xmm0_4
  int v4; // xmm1_4
  ...
  while ( v13 );
  `anonymous namespace'::ConvertVectorArrayToMatrix(v12, (int *)&v17);
  return v15;
}
