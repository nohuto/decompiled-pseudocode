/*
 * XREFs of ?RecordWindowMoveOptimization@CDrawingContext@@QEAAJPEAVCWindowNode@@PEAUHWND__@@PEA_N@Z @ 0x18003C848
 * Callers:
        ...
        bool *a4)
{
  ...
  if ( v13 )
  {
    ...
    if ( v14 )
    {
      LocalToWorldTransform = (*(__int64 (__fastcall **)(_QWORD, unsigned __int64 *))(*(_QWORD *)v14 + 200LL))(
                                *((_QWORD *)this + 46),
                                &v47);
...
LABEL_14:
      ...
      v36 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)this + 46) + 208LL))(*((_QWORD *)this + 46));
      ...
      if ( v39 >= 0 )
      {
        ...
        v4 = v41;
        if ( v41 < 0 )
          MilInstrumentationCheckHR(0x14u, 0LL, 0, v41, 0x1D24u);
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v39, 0x1D1Eu);
      }
      if ( v40 )
