/*
 * XREFs of ?DrawBitmapWithCompositeMode@CD2DContext@@MEAAJPEBVID2DContextOwner@@PEAUID2D1Bitmap1@@PEBUD2D_RECT_F@@PEBUD2D_POINT_2F@@MW4D2D1_COMPOSITE_MODE@@W4D2D1_BORDER_MODE@@W4D2D1_INTERPOLATION_MODE@@@Z @ 0x1801467A0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ??0CMILMatrix@@QEAA@PEBUD2D_MATRIX_4X4_F@@@Z @ 0x1801461C0 (--0CMILMatrix@@QEAA@PEBUD2D_MATRIX_4X4_F@@@Z.c)
 */
        ...
        enum D2D1_INTERPOLATION_MODE a9)
{
  ...
  if ( v45[0] )
  {
    ...
    *(_OWORD *)v45 = *(_OWORD *)v45[0];
    ...
    if ( v20 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v20, 0x4B5u);
      goto LABEL_47;
    }
    ...
    if ( v22 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v22, 0x4BDu);
      goto LABEL_47;
    }
    v12 = v15;
  }
  ...
  *(_OWORD *)&v46.m[3][0] = 0uLL;
  ...
  if ( v25 )
  {
    ...
    if ( v27 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v27, 0x4E8u);
      goto LABEL_47;
    }
  }
  else
  {
    ...
    if ( v28 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v28, 0x4EDu);
      goto LABEL_47;
    }
  }
  ...
  if ( v29 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v29, 0x4F1u);
    goto LABEL_47;
  }
  v23 = a3;
  v12 = v16;
LABEL_31:
  ...
  if ( v34 >= 0 )
  {
    ...
    if ( v35 >= 0 )
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v36, 0x524u);
      }
    }
    else
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v35, 0x521u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v34, 0x51Bu);
  }
LABEL_47:
  if ( v42 )
