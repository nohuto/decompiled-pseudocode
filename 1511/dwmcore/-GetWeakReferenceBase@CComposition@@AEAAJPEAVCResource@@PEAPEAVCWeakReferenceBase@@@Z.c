/*
 * XREFs of ?GetWeakReferenceBase@CComposition@@AEAAJPEAVCResource@@PEAPEAVCWeakReferenceBase@@@Z @ 0x1800948C4
 * Callers:
        ...
        struct CWeakReferenceBase **a3)
{
  ...
  if ( (*((_BYTE *)a2 + 32) & 8) != 0 )
  {
    v13[0] = 0LL;
    v13[1] = a2;
    v12 = (struct CWeakReferenceBase **)RtlLookupElementGenericTable((PRTL_GENERIC_TABLE)((char *)this + 928), v13);
    v4 = *v12;
    ++*((_DWORD *)*v12 + 4);
  }
  else
  {
    ...
    if ( v9 )
    {
      ...
      Buffer[1] = a2;
      NewElement = 0;
      inserted = RtlInsertElementGenericTable((PRTL_GENERIC_TABLE)((char *)this + 928), Buffer, 0x10u, &NewElement);
      *(_QWORD *)(v9 + 8) = inserted;
      ...
      {
        v3 = -2147024882;
        MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x1277u);
      }
      if ( v9 )
    ...
    {
      v3 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x126Fu);
    }
  }
  *a3 = v4;
  return v3;
