/*
 * XREFs of ??4?$ComPtr@VCManipulationFrame@@@WRL@Microsoft@@QEAAAEAV012@AEBV012@@Z @ 0x180003C34
 * Callers:
...
__int64 *__fastcall Microsoft::WRL::ComPtr<CManipulationFrame>::operator=(__int64 *a1, __int64 *a2)
{
  __int64 v2; // rdi
