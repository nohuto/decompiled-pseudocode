/*
 * XREFs of ?GetContentAsSpriteNoRef@CVisual@@AEBA_NPEAPEAVCSpriteVisualContent@@@Z @ 0x18004882C
 * Callers:
...
char __fastcall CVisual::GetContentAsSpriteNoRef(CVisual *this, struct CSpriteVisualContent **a2)
{
  ...
  if ( v2 )
  {
    ...
    if ( v6 == CRenderData::IsOfType )
      v7 = CRenderData::IsOfType(v2, 76LL);
    else
      v7 = v6(v2, 76LL);
    if ( v7 )
    {
      v3 = 1;
      *a2 = (struct CSpriteVisualContent *)*((_QWORD *)this + 45);
    }
  }
  return v3;
}
