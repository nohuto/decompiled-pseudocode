/*
 * XREFs of ?GetGeometryBounds@CAtlasedRectsGroup@@UEAAXPEAV?$CRectF@ULocalRenderingHPC@CoordinateSpace@@@@@Z @ 0x180026580
 * Callers:
 *     <none>
 * Callees:
 *     ?AdvanceFrame@CRenderTarget@@UEAAX_K_N@Z @ 0x18001DE90 (-AdvanceFrame@CRenderTarget@@UEAAX_K_N@Z.c)
 *     ?GetGeometryBounds@CAtlasedRectsMesh@@UEAAXPEAV?$CRectF@ULocalRenderingHPC@CoordinateSpace@@@@@Z @ 0x180026ED0 (-GetGeometryBounds@CAtlasedRectsMesh@@UEAAXPEAV-$CRectF@ULocalRenderingHPC@CoordinateSpace@@@@@Z.c)
  ...
  if ( (v4 & 6) == 2 )
  {
    if ( (*(_BYTE *)(a1 + 180) & 1) != 0 )
    {
      ...
      for ( i = 0uLL; (unsigned int)v5 < *(_DWORD *)(a1 + 144); v5 = (unsigned int)(v5 + 1) )
      {
        ...
        if ( v6 )
        {
          v7 = *(void (__fastcall **)(__int64, _BYTE *))(*(_QWORD *)v6 + 112LL);
