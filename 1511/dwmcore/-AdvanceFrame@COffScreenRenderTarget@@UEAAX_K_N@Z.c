/*
 * XREFs of ?AdvanceFrame@COffScreenRenderTarget@@UEAAX_K_N@Z @ 0x1801079F0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall COffScreenRenderTarget::AdvanceFrame(COffScreenRenderTarget *this)
{
  ...
  if ( CurrentDisplaySet >= 0 )
  {
    ...
    {
      v4 = (*(__int64 (__fastcall **)(_QWORD, struct _LUID *, _QWORD))(**(_QWORD **)(*((_QWORD *)this + 17) + 8 * i)
                                                                     + 104LL))(
             *(_QWORD *)(*((_QWORD *)this + 17) + 8 * i),
             &v7,
             0LL);
      if ( v4 >= 0 )
      {
        ...
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, ExistingDevice, 0xE1u);
        }
      }
      else
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0xD9u);
      }
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, CurrentDisplaySet, 0xD2u);
  }
  if ( v9 )
