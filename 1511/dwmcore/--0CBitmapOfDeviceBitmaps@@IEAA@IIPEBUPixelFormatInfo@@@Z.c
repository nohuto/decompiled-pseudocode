/*
 * XREFs of ??0CBitmapOfDeviceBitmaps@@IEAA@IIPEBUPixelFormatInfo@@@Z @ 0x18008AFCC
 * Callers:
        ...
        const struct PixelFormatInfo *a4)
{
  ...
  *((_QWORD *)this + 33) = &CBitmapOfDeviceBitmaps::`vftable'{for `IDeviceResourceNotify'};
  DynArrayIA<CBitmapOfDeviceBitmaps::DeviceBitmapInfo,2,1>::DynArrayIA<CBitmapOfDeviceBitmaps::DeviceBitmapInfo,2,1>((__int64)this + 296);
  *((_DWORD *)this + 136) = 0;
