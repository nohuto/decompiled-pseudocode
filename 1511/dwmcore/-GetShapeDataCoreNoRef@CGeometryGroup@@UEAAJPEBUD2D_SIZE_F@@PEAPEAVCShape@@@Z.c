/*
 * XREFs of ?GetShapeDataCoreNoRef@CGeometryGroup@@UEAAJPEBUD2D_SIZE_F@@PEAPEAVCShape@@@Z @ 0x1801354F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct CShape **a3)
{
  ...
  CShape *v20; // [rsp+80h] [rbp+18h] BYREF
  ...
  *((_DWORD *)this + 8) = v9;
  if ( (v9 & 6) == 2 )
  {
    ShapeDataNoRef = CGeometry::GetShapeDataNoRef(**((const struct D2DMatrix ****)this + 16), a2, &v20);
    v3 = ShapeDataNoRef;
    if ( ShapeDataNoRef >= 0 )
    {
      ...
      while ( 1 )
      {
        ShapeDataNoRef = CGeometry::GetShapeDataNoRef(
                           *(const struct D2DMatrix ***)(*((_QWORD *)this + 16) + 8LL * v14),
                           a2,
                           &v19);
        v3 = ShapeDataNoRef;
        if ( ShapeDataNoRef < 0 )
...
LABEL_17:
  v16 = (void (__fastcall ***)(_QWORD, __int64))*((_QWORD *)this + 17);
  if ( v16 )
