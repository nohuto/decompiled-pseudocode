/*
 * XREFs of ?InternalSetAtIndex@?$CMap@IUTargetingInfo@@V?$CMapEqualHelper@IUTargetingInfo@@@@@@QEAAXHAEBIAEBUTargetingInfo@@@Z @ 0x180005050
 * Callers:
 ...
 * Callees:
 *     ??0TargetingInfo@@QEAA@AEBU0@@Z @ 0x180003634 (--0TargetingInfo@@QEAA@AEBU0@@Z.c)
 */
