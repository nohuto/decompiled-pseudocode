/*
 * XREFs of ?Reset@CCrossThreadComposition@@UEAAXXZ @ 0x180082090
 * Callers:
...
void __fastcall CCrossThreadComposition::Reset(CCrossThreadComposition *this, int a2)
{
  ...
  for ( i = 0; i < *((_DWORD *)this + 116); *(_QWORD *)(v4 + 8) = 0LL )
  {
    v4 = *((_QWORD *)this + 55) + 16LL * i;
  ...
  *((_DWORD *)this + 116) = 0;
  DynArrayImpl<0>::ShrinkToSize((_QWORD *)this + 55, 0x10u);
}
