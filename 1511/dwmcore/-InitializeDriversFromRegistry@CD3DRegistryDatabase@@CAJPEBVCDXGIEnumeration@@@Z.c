/*
 * XREFs of ?InitializeDriversFromRegistry@CD3DRegistryDatabase@@CAJPEBVCDXGIEnumeration@@@Z @ 0x18006A5DC
 * Callers:
  ...
  if ( *((_DWORD *)a1 + 22) )
  {
    ...
    while ( 1 )
    {
      ...
      if ( v4 + 1 < v4 )
        break;
      v6 = 0;
      if ( v5 > dword_1801A3E1C )
      {
        v10 = DynArrayImpl<0>::AddMultipleAndSet(&CD3DRegistryDatabase::m_rgAdapterErrorCounts, 12LL, 1LL, &v11);
        v6 = v10;
        if ( v10 < 0 )
