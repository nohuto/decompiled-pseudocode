/*
 * XREFs of ?IsHigherProprity@COverlayContext@@CA_NPEAUOverlayPlaneInfo@1@0@Z @ 0x1801114A4
 * Callers:
        ...
        struct COverlayContext::OverlayPlaneInfo *a2)
{
  ...
  v4 = 0;
  v5 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)a1 + 1) + 104LL))(*((_QWORD *)a1 + 1));
  v6 = (*(__int64 (__fastcall **)(_QWORD))(**((_QWORD **)a2 + 1) + 104LL))(*((_QWORD *)a2 + 1));
  if ( v5 && !v6 )
    return 1;
  if ( v5 == v6 )
  {
    ...
    if ( v8 == v7 )
    {
      ...
      if ( v9 == *((_BYTE *)a2 + 160) )
      {
        ...
        if ( v10 > v11 )
          return 1;
        if ( v10 == v11 && *((_BYTE *)a1 + 176) )
          return *((_BYTE *)a2 + 176) == 0;
      }
    }
  }
  return v4;
