/*
 * XREFs of ??0?$LocalMILObject@VCImmediateBrushRealizer@@@@QEAA@XZ @ 0x1800AC364
 * Callers:
...
CImmediateBrushRealizer *__fastcall LocalMILObject<CImmediateBrushRealizer>::LocalMILObject<CImmediateBrushRealizer>(
        CImmediateBrushRealizer *a1)
{
  CImmediateBrushRealizer::CImmediateBrushRealizer(a1);
  *(_QWORD *)a1 = &LocalMILObject<CImmediateBrushRealizer>::`vftable';
  return a1;
}
