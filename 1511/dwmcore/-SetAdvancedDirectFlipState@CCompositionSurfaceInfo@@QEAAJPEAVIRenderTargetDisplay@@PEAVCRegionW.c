/*
 * XREFs of ?SetAdvancedDirectFlipState@CCompositionSurfaceInfo@@QEAAJPEAVIRenderTargetDisplay@@PEAVCRegionWrapper@@@Z @ 0x18013043C
 * Callers:
        ...
        struct CRegionWrapper *a3)
{
  ...
  if ( !*((_QWORD *)this + 16) )
  {
    ...
    if ( (*(unsigned __int8 (__fastcall **)(struct IRenderTargetDisplay *, _QWORD))(*(_QWORD *)a2 + 336LL))(a2, v14[0]) )
      goto LABEL_9;
    ...
    if ( v11 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x10Bu);
      goto LABEL_11;
    }
  }
  a2 = 0LL;
LABEL_9:
  ...
  v6 = v12;
  if ( v12 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x111u);
LABEL_11:
  if ( v15 )
