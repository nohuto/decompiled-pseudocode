/*
 * XREFs of ?CalculateTransform@CHwndRenderTarget@@AEAAXW4DXGI_MODE_ROTATION@@PEBUtagRECT@@PEAV?$CMatrix@UDeviceHPC@CoordinateSpace@@U12@@@PEAU?$TMILFlagsEnum@W4FlagsEnum@MilRTInitialization@@@@@Z @ 0x18007BCB0
 * Callers:
        ...
        _DWORD *a5)
{
  ...
  *(_OWORD *)(a1 + 132) = IdentityMatrix;
  v9 = *a3;
  *(_OWORD *)(a1 + 148) = *(&IdentityMatrix + 1);
  *(_OWORD *)(a1 + 164) = *(_OWORD *)ymmword_18019E9D0.m256_f32;
  v10 = *(_OWORD *)&ymmword_18019E9D0.m256_f32[4];
  *(_DWORD *)(a1 + 124) = v6 - v9;
  v11 = a3[3];
  *(_DWORD *)(a1 + 120) = a2;
  v12 = a3[1];
