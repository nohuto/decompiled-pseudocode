/*
 * XREFs of ?DiscardRectangle@CHwDisplayRenderTarget@@UEAAXAEBUMilRectF@@@Z @ 0x1800805D0
 * Callers:
 *     ?DiscardRectangle@CHwDisplayRenderTarget@@WLA@EAAXAEBUMilRectF@@@Z @ 0x1800BD850 (-DiscardRectangle@CHwDisplayRenderTarget@@WLA@EAAXAEBUMilRectF@@@Z.c)
 * Callees:
...
void __fastcall CHwDisplayRenderTarget::DiscardRectangle(CHwDisplayRenderTarget *this, const struct MilRectF *a2)
{
  ...
  *(float *)&v5 = *(float *)&v5 + 6291456.25;
  ...
  if ( v8 )
  {
    (*(void (__fastcall **)(_QWORD, __int64, int *, __int64))(**(_QWORD **)(v2 + 560) + 1064LL))(
      *(_QWORD *)(v2 + 560),
      v8,
      &v13,
      1LL);
