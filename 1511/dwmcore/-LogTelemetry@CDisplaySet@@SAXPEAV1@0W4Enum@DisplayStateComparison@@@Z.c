/*
 * XREFs of ?LogTelemetry@CDisplaySet@@SAXPEAV1@0W4Enum@DisplayStateComparison@@@Z @ 0x1800B3404
 * Callers:
...
void __fastcall CDisplaySet::LogTelemetry(__int64 a1, __int64 a2, int a3, const GUID *a4)
{
  ...
  if ( a1 )
  {
    ...
    if ( !v10 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x668u);
      return;
    }
...
LABEL_7:
      ...
      && (qword_18019E8D8 & 0x400000000000LL) == qword_18019E8D8 )
    {
      ...
      v36 = 0;
      v38 = 2LL;
      TlgWrite((TraceLoggingHProvider)&dword_18019E8C0, &unk_18017E008, (LPCGUID)v4, a4, 0xAu, &pData);
    }
    goto LABEL_9;
  }
  MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x676u);
LABEL_9:
  if ( v7 )
