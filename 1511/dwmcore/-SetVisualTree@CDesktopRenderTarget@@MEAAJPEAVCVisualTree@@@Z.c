/*
 * XREFs of ?SetVisualTree@CDesktopRenderTarget@@MEAAJPEAVCVisualTree@@@Z @ 0x180075320
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDesktopRenderTarget::SetVisualTree(CDesktopRenderTarget *this, struct CVisualTree *a2)
{
  ...
  if ( v2
    && (*(_BYTE *)(v2 + 32) = 0,
        ...
        v13 < 0) )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x3D9u);
  }
  else
  {
          ...
          *((_DWORD *)this + 28)) )
    {
      while ( 1 )
      {
        v8 = CMonitorTreeAssociation::AddMonitorTree(
               *(CMonitorTreeAssociation **)(*((_QWORD *)this + 2) + 24LL),
               *(HMONITOR *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*((_QWORD *)this + 11) + 8 * v7) + 80LL) + 136LL) + 24LL),
               a2);
        v3 = v8;
        if ( v8 < 0 )
          break;
      ...
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x3EAu);
    }
    else
    {
LABEL_8:
      ...
      if ( *((_DWORD *)this + 28) )
      {
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v10, 0x3FBu);
      }
      else
      {
LABEL_11:
        v11 = (CComposeTop *)*((_QWORD *)this + 37);
        if ( v11 )
        {
