/*
 * XREFs of ?StopAnalyzingAnimationScenario@CAnimationTracking@@AEAAXIAEBUTelFrameInfo@1@@Z @ 0x180028FF8
 * Callers:
  ...
  *(_QWORD *)v75 = v10 * v7 / 0x2710uLL;
  ...
  if ( ScenarioName )
  {
    ...
    if ( wcsncmp(ScenarioName, String2, v28) )
    {
      ...
      {
        v27 = 4;
        if ( (qword_18019E910 & 0x400000000004LL) != 0 && (qword_18019E918 & 0x400000000004LL) == qword_18019E918 )
        {
          ...
          v97 = 4LL;
          v99 = 4LL;
          TlgCreateWsz(&v100, v49);
          v51 = (const WCHAR *)&unk_18016D648;
          if ( *(_QWORD *)(v5 + 136) )
            v51 = *(const WCHAR **)(v5 + 136);
          TlgCreateWsz(&v101, v51);
          v102 = v5 + 20;
          v103 = 4LL;
          ...
          v106 = 4LL;
          v105 = &v68;
          TlgWrite((TraceLoggingHProvider)&hProvider, &unk_18017D0BF, v52, v53, 0x13u, &pData);
        }
      }
    }
  }
  ...
  if ( *v8 || v62 >= 0xC8 )
  {
    if ( *(_DWORD *)v5 )
    {
      ...
      if ( v31 )
      {
        if ( *(_WORD *)(v31 + 38) && v31 + *(unsigned __int16 *)(v31 + 38) )
        {
          if ( *(_WORD *)(v31 + 38) )
            v32 = v31 + *(unsigned __int16 *)(v31 + 38);
          else
            v32 = 0LL;
          LODWORD(cData) = *(_DWORD *)(v31 + 28);
          StringCchPrintfW((wchar_t *)&pData, 0x80uLL, L"%ws|%X|%ws", ScenarioName, cData, v32);
          v29 = v62;
...
LABEL_54:
    if ( v29 >= 0xC8 )
    {
      ...
      if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x400) != 0 )
      {
        if ( *(_QWORD *)(v5 + 128) )
          v40 = *(void **)(v5 + 128);
        Template_qqqzzq(v48, v27, v29, v45, v48, (__int64)ScenarioName, (__int64)v40, *(_DWORD *)(v5 + 20));
        v29 = v62;
      }
    }
    v14 = v69;
  ...
  if ( *(_DWORD *)v5 )
    v30 = *(unsigned __int16 **)(v5 + 128);
  else
    v30 = 0LL;
  if ( !*(_DWORD *)v5 )
    v3 = (const struct _GUID *)(v5 + 4);
  CAnimationTracking::UpdateLongtermStatistics(v73, v3, v30, v9, v14, v64, v29, v75[0], *(_DWORD *)(v5 + 36));
  v4 = v73;
LABEL_33:
