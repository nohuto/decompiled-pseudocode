/*
 * XREFs of ?Init@CRegionShape@@IEAAJPEBV?$TMilRect_@HUtagRECT@@UMilPointAndSizeL@@U_CMilRectL_@RectUniqueness@@@@I@Z @ 0x18004E200
 * Callers:
...
__int64 __fastcall CRegionShape::Init(_QWORD *a1, const struct tagRECT *a2, unsigned int a3)
{
  ...
  int v11; // eax
  CD2DFactory *v13; // [rsp+60h] [rbp+8h] BYREF
