/*
 * XREFs of ?GetTransform@CDxHandleBitmapRealization@@UEBA_NPEAVCMILMatrix@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800328A0
 * Callers:
 ...
 * Callees:
 *     ?GetRotation@CDxHandleBitmapRealization@@UEBA?AW4DXGI_MODE_ROTATION@@XZ @ 0x18000CF00 (-GetRotation@CDxHandleBitmapRealization@@UEBA-AW4DXGI_MODE_ROTATION@@XZ.c)
...
bool __fastcall CDxHandleBitmapRealization::GetTransform(__int64 a1, __int64 a2, __int128 *a3)
{
  ...
  float v16; // xmm7_4
  float v17; // xmm6_4
  __int64 (__fastcall *v18)(CDxHandleBitmapRealization *); // r15
  int v19; // eax
  int v20; // xmm1_4
  int v21; // xmm0_4
  int v22; // xmm1_4
  int v23; // xmm0_4
  int v24; // xmm1_4
  void (__fastcall *v26)(CDxHandleBitmapRealization *, unsigned int *, unsigned int *); // r12
  float v27; // xmm0_4
  float v28; // xmm4_4
...
LABEL_16:
  if ( a3 )
    *a3 = v41;
  return (unsigned int)D2DMatrixIsIdentity((const struct D2DMatrix *)a2) == 0;
}
