/*
 * XREFs of ?CreateFromExistingTexture@CHwDeviceBitmapColorSource@@SAJPEAVCD3DDeviceLevel1@@PEAVIBitmapSource@@IVDisplayId@@AEBV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAVCD3DVidMemOnlyTexture@@PEAPEAV1@@Z @ 0x18002AE04
 * Callers:
        ...
        CHwDeviceBitmapColorSource **a7)
{
  ...
  int v23; // [rsp+B4h] [rbp-1Dh]

  v23 = 0;
  if ( *(_QWORD *)(a6 + 248) )
  {
    v9 = (*(__int64 (__fastcall **)(__int64, __int64, __int64))(*(_QWORD *)a2 + 32LL))(a2, a2, a5);
    v10 = CHwDeviceBitmapColorSource::CalcCacheParametersFromVidMemTexture((_DWORD *)a6, v9, a4, (__int64)v20);
    v11 = v10;
    if ( v10 >= 0 )
      goto LABEL_3;
    v18 = 237;
...
LABEL_13:
  ...
  v10 = CHwDeviceBitmapColorSource::CalcCacheParametersFromBitmapSource(a2, *(unsigned int *)(a6 + 152), a5);
  v11 = v10;
  if ( v10 < 0 )
  {
    v18 = 245;
