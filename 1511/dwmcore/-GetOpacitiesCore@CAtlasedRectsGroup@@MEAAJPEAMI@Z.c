/*
 * XREFs of ?GetOpacitiesCore@CAtlasedRectsGroup@@MEAAJPEAMI@Z @ 0x1800261F0
 * Callers:
 *     <none>
 * Callees:
  ...
  if ( (v7 & 6) == 2 )
  {
    for ( i = 0LL; (unsigned int)i < *((_DWORD *)this + 36); i = (unsigned int)(i + 1) )
    {
      ...
      if ( v9 )
      {
        ...
        v12 = RectangleCount;
        v13 = *(__int64 (__fastcall **)(CAtlasedRectsMesh *__hidden, float *, unsigned int))(*(_QWORD *)v9 + 136LL);
