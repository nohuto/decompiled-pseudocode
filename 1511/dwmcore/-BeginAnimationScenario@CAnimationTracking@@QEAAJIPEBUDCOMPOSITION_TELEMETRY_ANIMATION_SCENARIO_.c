/*
 * XREFs of ?BeginAnimationScenario@CAnimationTracking@@QEAAJIPEBUDCOMPOSITION_TELEMETRY_ANIMATION_SCENARIO_PACKED_INFO@@PEBGAEBUTelFrameInfo@1@@Z @ 0x180028550
 * Callers:
    ...
    if ( v24 )
    {
      ...
      else
      {
        ...
        if ( *(_WORD *)(v16 + 4) == v18 )
        {
          ...
          {
            if ( *((_QWORD *)v12 + 7) )
              v17 = TickCount64 - *((_QWORD *)v12 + 14) > v19;
            else
              v17 = (unsigned int)v19 < *((_DWORD *)a3 + 6);
          }
          v20 = v17;
          if ( TickCount64 + *((unsigned int *)a3 + 6) > *((_QWORD *)v12 + 15) )
            v20 = 1;
          if ( v20 )
          {
LABEL_21:
        ...
        if ( v21 > *((_QWORD *)v12 + 13) + 5000LL )
          v21 = *((_QWORD *)v12 + 13) + 5000LL;
        if ( *((_QWORD *)v12 + 15) >= v21 )
          return v7;
        *((_QWORD *)v12 + 15) = v21;
      }
    }
