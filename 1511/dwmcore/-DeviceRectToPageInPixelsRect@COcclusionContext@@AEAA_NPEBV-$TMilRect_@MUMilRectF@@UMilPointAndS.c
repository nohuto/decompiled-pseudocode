/*
 * XREFs of ?DeviceRectToPageInPixelsRect@COcclusionContext@@AEAA_NPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@PEAV2@@Z @ 0x180055C30
 * Callers:
...
bool __fastcall COcclusionContext::DeviceRectToPageInPixelsRect(__int64 a1, const struct MilRectF *a2, float *a3)
{
  float *v3; // r11
  ...
  return !TMilRect<float,MilRectF,RectUniqueness::NotNeeded>::IsEmpty(v3);
}
