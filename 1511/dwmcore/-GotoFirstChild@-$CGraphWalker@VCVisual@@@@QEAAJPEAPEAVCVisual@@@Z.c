/*
 * XREFs of ?GotoFirstChild@?$CGraphWalker@VCVisual@@@@QEAAJPEAPEAVCVisual@@@Z @ 0x180006060
 * Callers:
  ...
  *a2 = 0LL;
  ...
  if ( (_DWORD)v5 )
  {
    *(_QWORD *)&v11 = *(_QWORD *)(a1 + 16);
    ...
    v6 = CWatermarkStack<CGraphWalker<CVisual>::CFrame,64,2,10>::Push((unsigned int *)(a1 + 32), &v11);
    v7 = v6;
    if ( v6 < 0 )
    {
