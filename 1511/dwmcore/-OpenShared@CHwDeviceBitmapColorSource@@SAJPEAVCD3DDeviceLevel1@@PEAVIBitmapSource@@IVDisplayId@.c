/*
 * XREFs of ?OpenShared@CHwDeviceBitmapColorSource@@SAJPEAVCD3DDeviceLevel1@@PEAVIBitmapSource@@IVDisplayId@@PEAX_NIPEAPEAV1@@Z @ 0x18002B094
 * Callers:
        ...
        CHwDeviceBitmapColorSource **a8)
{
  ...
  *a8 = 0LL;
  ...
  if ( v11 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x232u);
  }
  else
  {
    v14 = *((_DWORD *)v17 + 34);
    ...
    v13 = v15;
    if ( v15 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v15, 0x247u);
  }
  if ( v12 )
