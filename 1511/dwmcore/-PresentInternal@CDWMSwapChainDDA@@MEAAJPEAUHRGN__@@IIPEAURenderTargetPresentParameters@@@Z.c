/*
 * XREFs of ?PresentInternal@CDWMSwapChainDDA@@MEAAJPEAUHRGN__@@IIPEAURenderTargetPresentParameters@@@Z @ 0x18014C660
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CDWMSwapChainDDA::PresentInternal(CDWMSwapChainDDA *this, HRGN a2, unsigned int a3, unsigned int a4)
{
  ...
  if ( g_LockAndReadDDATarget )
    CD3DDeviceLevel1::ReadTexture(*((CD3DDeviceLevel1 **)this + 50), v34);
  if ( !*((_QWORD *)this + 37) )
  {
...
LABEL_31:
    ...
    v14 = v29;
    if ( v29 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v29, 0x104u);
  ...
  while ( 1 )
  {
    ...
    *(_OWORD *)&v40[8] = v22;
    ...
    if ( v23 > v19 )
    {
      v27 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v35, 24, 1, v40);
      v28 = v27;
      if ( v27 < 0 )
...
LABEL_30:
  ...
  v14 = -2147024362;
LABEL_42:
  MilInstrumentationCheckHR(0x14u, 0LL, 0, v28, 0xF8u);
  DynArrayImpl<1>::~DynArrayImpl<1>((void **)v35);
LABEL_36:
  if ( v8 )
