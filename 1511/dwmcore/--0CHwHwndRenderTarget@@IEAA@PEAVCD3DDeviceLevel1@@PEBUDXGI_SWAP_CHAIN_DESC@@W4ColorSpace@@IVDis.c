/*
 * XREFs of ??0CHwHwndRenderTarget@@IEAA@PEAVCD3DDeviceLevel1@@PEBUDXGI_SWAP_CHAIN_DESC@@W4ColorSpace@@IVDisplayId@@@Z @ 0x18014FBF4
 * Callers:
...
__int64 __fastcall CHwHwndRenderTarget::CHwHwndRenderTarget(
        __int64 a1,
        __int64 a2,
        __int64 a3,
        int a4,
        ...
        unsigned int a6)
{
  ...
  *(_QWORD *)(a1 + 120) = &CHwHwndRenderTarget::`vftable'{for `CMILCOMBase'};
