/*
 * XREFs of ?InitColorKey@CBitmapColorKey@@AEAAJPEBVCColorKey@@@Z @ 0x1800B9904
 * Callers:
...
LABEL_4:
      v3 = -2003292288;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003292288, v93);
      return v3;
    }
  ...
  {
    case 2:
      *(__m128i *)((char *)this + 84) = v6;
      *(struct _D3DCOLORVALUE *)((char *)this + 116) = *(struct _D3DCOLORVALUE *)&v8.r;
      return v3;
    case 10:
    ...
    case 28:
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(a2);
      v26 = (int)floor_0((float)(*(float *)&a2->m128i_i32[3] * 255.0) + 0.5);
      v27 = -1;
      if ( v26 <= 255 )
      {
        v28 = 0;
      ...
      v29 = Convert_scRGB_Channel_To_sRGB_Byte(v95.r) << 8;
      v30 = (Convert_scRGB_Channel_To_sRGB_Byte(v95.g) | v29) << 8;
      v31 = (v28 << 24) | Convert_scRGB_Channel_To_sRGB_Byte(v95.b) | v30;
      *((_BYTE *)this + 74) = v31;
      *((_BYTE *)this + 72) = BYTE2(v31);
      *((_BYTE *)this + 73) = BYTE1(v31);
      *((_BYTE *)this + 75) = HIBYTE(v31);
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(v7);
      v32 = (int)floor_0((float)(*(float *)&v7->m128i_i32[3] * 255.0) + 0.5);
      if ( v32 <= 255 )
      {
        v27 = 0;
        if ( v32 >= 0 )
      ...
      v33 = Convert_scRGB_Channel_To_sRGB_Byte(v95.r) << 8;
      v34 = Convert_scRGB_Channel_To_sRGB_Byte(v95.g);
      v35 = (v27 << 24) | Convert_scRGB_Channel_To_sRGB_Byte(v95.b) | ((v34 | v33) << 8);
      *((_BYTE *)this + 106) = v35;
      *((_BYTE *)this + 104) = BYTE2(v35);
      *((_BYTE *)this + 107) = HIBYTE(v35);
      *((_BYTE *)this + 105) = BYTE1(v35);
      break;
    default:
      ...
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(a2);
      v18 = (int)floor_0((float)(*(float *)&a2->m128i_i32[3] * 255.0) + 0.5);
      v19 = -1;
      if ( v18 <= 255 )
      {
        v20 = 0;
      ...
      v21 = Convert_scRGB_Channel_To_sRGB_Byte(v95.r) << 8;
      v22 = (Convert_scRGB_Channel_To_sRGB_Byte(v95.g) | v21) << 8;
      *((_DWORD *)this + 17) = (v20 << 24) | Convert_scRGB_Channel_To_sRGB_Byte(v95.b) | v22;
      *(struct _D3DCOLORVALUE *)&v95.r = (struct _D3DCOLORVALUE)_mm_loadu_si128(v7);
      v23 = (int)floor_0((float)(*(float *)&v7->m128i_i32[3] * 255.0) + 0.5);
      if ( v23 <= 255 )
      {
        v19 = 0;
        if ( v23 >= 0 )
      ...
      v24 = Convert_scRGB_Channel_To_sRGB_Byte(v95.r) << 8;
      v25 = Convert_scRGB_Channel_To_sRGB_Byte(v95.g);
      *((_DWORD *)this + 25) = (v19 << 24) | Convert_scRGB_Channel_To_sRGB_Byte(v95.b) | ((v25 | v24) << 8);
      break;
  }
  return v3;
}
