/*
 * XREFs of ?CopyRegion@CRegionShape@@QEBAJPEBVCMILMatrix@@PEAPEAV1@@Z @ 0x180158C20
 * Callers:
...
{
  __int64 v3; // r13
  const struct tagRECT *v4; // r15
  unsigned int RectCount; // eax
  __int64 v8; // rsi
  unsigned int v9; // esi
  __int64 v10; // rdi
  CBitmapOfDeviceBitmaps::DeviceBitmapInfo *v11; // rax
  __int64 v12; // rdi
  __int64 v13; // rbx
  ...
  struct tagRECT v29; // [rsp+48h] [rbp-18h]
    ...
    if ( v3 )
    {
      *(_QWORD *)v26 = (unsigned int)CRegionShape::GetRectCount((CRegionShape *)this);
      ...
      if ( !is_mul_ok(*(unsigned __int64 *)v26, 0x10uLL) )
        v10 = -1LL;
      v11 = (CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                                          WPF::g_pProcessHeap,
                                                          v10);
      v4 = (const struct tagRECT *)v11;
      if ( v11 )
      ...
      if ( v4 )
      {
        ...
        while ( v14 < (unsigned int)CRegionShape::GetRectCount((CRegionShape *)this) )
        {
          ...
          *(float *)&v26[1] = v15;
          ...
          ++v14;
          v29.top = (int)*(float *)&v26[1];
          v29.left = (int)*(float *)v26;
          v29.right = (int)v27;
          v29.bottom = (int)v28;
          *(const struct tagRECT *)((char *)v4 + 8 * v18) = v29;
        }
