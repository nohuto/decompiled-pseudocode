/*
 * XREFs of ?CopyLeftToRightBuffer@CHwStereoFullScreenRenderTarget@@UEAAJPEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@0@Z @ 0x18014EB70
 * Callers:
 *     <none>
 * Callees:
...
LABEL_28:
    ...
    if ( (Microsoft_Windows_Dwm_CoreEnableBits & 0x20) != 0 )
      Template_x(v11, (const EVENT_DESCRIPTOR *)"z", a1[5]);
    if ( nCount )
    {
      x = v35.x;
      v25 = p_rect + 4;
