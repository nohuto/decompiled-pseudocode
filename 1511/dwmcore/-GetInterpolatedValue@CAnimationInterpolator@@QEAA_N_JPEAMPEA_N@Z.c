/*
 * XREFs of ?GetInterpolatedValue@CAnimationInterpolator@@QEAA_N_JPEAMPEA_N@Z @ 0x180016270
 * Callers:
...
char __fastcall CAnimationInterpolator::GetInterpolatedValue(CAnimation **this, __int64 a2, float *a3, bool *a4)
{
  ...
  if ( !PrimitiveAtIndex )
    return 0;
  CurrentPrimitive = CAnimationInterpolator::FindCurrentPrimitive((CAnimationInterpolator *)this, a2);
  if ( CurrentPrimitive )
  {
...
LABEL_10:
      ...
      if ( !v18 )
      {
        v14 = CAnimationInterpolator::InterpolateSinusoidal((CAnimationInterpolator *)this, v11, a2);
        goto LABEL_9;
      }
      if ( v18 == 2 )
      {
