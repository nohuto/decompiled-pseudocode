/*
 * XREFs of ?GetD2DEffectNoRef@CFilterEffect@@QEAAJPEAUID2D1Bitmap1@@PEAVID2DContext@@PEAVID2DContextOwner@@PEAPEAUID2D1Effect@@@Z @ 0x18001AAF4
 * Callers:
        ...
        struct ID2D1Effect **a5)
{
  ...
  *((_DWORD *)this + 8) = v9;
  ...
  ResourceNoRef = CDeviceResourceTable<CD2DEffect,CFilterEffect,ID2DContext>::FindOrCreateResourceNoRef((CFilterEffect *)((char *)this + 56));
  v11 = ResourceNoRef;
  if ( ResourceNoRef < 0 )
  {
  ...
  v12 = (*(__int64 (__fastcall **)(CFilterEffect *, struct ID2D1Effect *))(*(_QWORD *)this + 104LL))(this, v6);
  v11 = v12;
  if ( v12 < 0 )
  {
...
LABEL_33:
  ...
  {
    v18 = *((_QWORD *)v13 + 17);
    v27 = *(_QWORD *)(*((_QWORD *)v13 + 18) + 8 * v17);
    v25 = *(_DWORD *)(v18 + 4 * v17);
    v19 = *(struct ID2D1Effect **)(v27 + 24);
    v28 = v19;
    if ( !v19 )
    {
      (*(void (__fastcall **)(struct ID2D1Effect *, _QWORD, struct ID2D1Bitmap1 *, __int64))(*(_QWORD *)v6 + 112LL))(
...
LABEL_29:
  ...
  if ( !(*(unsigned __int8 (__fastcall **)(_QWORD, __int64))(**(_QWORD **)(v27 + 24) + 48LL))(
          *(_QWORD *)(v27 + 24),
          87LL) )
  {
    v11 = -2147467263;
  ...
  InputEffectForAtlasedSurface = CFilterEffect::GetInputEffectForAtlasedSurface(
                                   ...
                                   *(struct CCompositionSurfaceBitmap **)(v27 + 24),
                                   &v26);
