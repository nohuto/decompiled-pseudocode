/*
 * XREFs of ?ProcessInnerExpression@CKeyframeAnimation@@UEAAJIPEAM@Z @ 0x18012C0C0
 * Callers:
 *     <none>
 * Callees:
...
LABEL_20:
  ...
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x460u);
    goto LABEL_19;
  }
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x462u);
    goto LABEL_19;
  }
  if ( v13 != 18 )
  {
