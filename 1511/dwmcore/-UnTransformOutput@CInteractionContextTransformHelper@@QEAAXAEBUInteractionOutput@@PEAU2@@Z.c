/*
 * XREFs of ?UnTransformOutput@CInteractionContextTransformHelper@@QEAAXAEBUInteractionOutput@@PEAU2@@Z @ 0x18015A07C
 * Callers:
        ...
        struct InteractionOutput *a3)
{
  ...
  *((_OWORD *)a3 + 2) = *((_OWORD *)a2 + 2);
  ...
  {
    TransformTranslateDelta(*(float *)(v3 + 8), *(float *)(v3 + 12), v4, (float *)(v5 + 8), (float *)(v5 + 12));
    v11 = *(_QWORD *)(v6 + 36);
    ...
    v7.m128_f32[0] = (float)((float)(*((float *)&v11 + 1) * v9->m128_f32[3]) + (float)(*(float *)&v11 * v9->m128_f32[1]))
                   + v9[1].m128_f32[1];
    *(_QWORD *)(v10 + 36) = _mm_unpacklo_ps(v8, v7).m128_u64[0];
    TransformTranslateDelta(*(float *)(v6 + 24), *(float *)(v6 + 28), v9, (float *)(v10 + 24), (float *)(v10 + 28));
  }
}
