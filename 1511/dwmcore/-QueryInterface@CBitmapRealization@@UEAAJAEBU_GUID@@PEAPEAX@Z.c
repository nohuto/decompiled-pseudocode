/*
 * XREFs of ?QueryInterface@CBitmapRealization@@UEAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800830F0
 * Callers:
 ...
 *     ?QueryInterface@CBitmapRealization@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800BF380 (-QueryInterface@CBitmapRealization@@WBA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CBitmapRealization@@WHA@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800BF390 (-QueryInterface@CBitmapRealization@@WHA@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 *     ?QueryInterface@CBitmapRealization@@WHI@EAAJAEBU_GUID@@PEAPEAX@Z @ 0x1800BF3A0 (-QueryInterface@CBitmapRealization@@WHI@EAAJAEBU_GUID@@PEAPEAX@Z.c)
 * Callees:
