/*
 * XREFs of ?UpdateFromReusableSource@CHwBitmapColorSource@@AEAAJPEAVIBitmapSource@@PEAV1@IPEAV?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@PEAIPEAPEAV3@IPEBQEAV?$DynArray@V?$TMilRect@IUMilRectU@@UNotNeeded@RectUniqueness@@@@$0A@@@3@Z @ 0x18014D66C
 * Callers:
...
LABEL_21:
    ...
    {
      v41 = DynArrayImpl<0>::AddMultipleAndSet(v19, 16, 1, v39);
      v42 = v41;
      if ( v41 < 0 )
