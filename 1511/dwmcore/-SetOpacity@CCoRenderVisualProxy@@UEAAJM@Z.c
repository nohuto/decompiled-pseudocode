/*
 * XREFs of ?SetOpacity@CCoRenderVisualProxy@@UEAAJM@Z @ 0x18010F990
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall CCoRenderVisualProxy::SetOpacity(CCoRenderVisualProxy *this, float a2)
{
  ...
  if ( v5 < 0.0000011920929 || *(_QWORD *)(*((_QWORD *)this + 3) + 392LL) )
    goto LABEL_10;
  ...
  if ( v6 )
  {
    ...
    *(_QWORD *)(v6 + 56) = 0x3FF0000000000000LL;
  }
  else
  {
    v3 = 0LL;
  ...
  {
LABEL_10:
    v9 = *(_QWORD *)(*((_QWORD *)this + 3) + 392LL);
    if ( v9 )
    {
      v10 = (*(__int64 (__fastcall **)(__int64, _QWORD, __int64, float *))(*(_QWORD *)v9 + 80LL))(v9, 0LL, 18LL, &v12);
      v2 = v10;
      if ( v10 < 0 )
