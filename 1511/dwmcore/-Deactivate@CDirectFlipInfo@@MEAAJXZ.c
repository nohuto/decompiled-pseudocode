/*
 * XREFs of ?Deactivate@CDirectFlipInfo@@MEAAJXZ @ 0x1800071E0
 * Callers:
...
__int64 __fastcall CDirectFlipInfo::Deactivate(CDirectFlipInfo *this)
{
  ...
  else
  {
    ...
    if ( v4 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v4, 0x15Bu);
    }
    else
    {
      v5 = (*(__int64 (__fastcall **)(__int64, _QWORD))(*(_QWORD *)v7 + 328LL))(v7, 0LL);
      v3 = v5;
      if ( v5 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x15Du);
    }
  }
  if ( v7 )
    (*(void (__fastcall **)(__int64))(*(_QWORD *)v7 + 16LL))(v7);
  (*(void (__fastcall **)(_QWORD, char *, _QWORD))(**((_QWORD **)this + 2) + 104LL))(*((_QWORD *)this + 2), &v8, 0LL);
  *((_DWORD *)this + 14) = (*(_BYTE *)(*((_QWORD *)this + 4) + 172LL) != 0) + 2;
  return v3;
}
