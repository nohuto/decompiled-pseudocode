/*
 * XREFs of ?HrLock@CBitmap@@IEAAJIIPEBUPixelFormatInfo@@IIPEAXW4WICBitmapLockFlags@@PEAPEAVIBitmapLock@@_NPEAUIUnknown@@@Z @ 0x180089310
 * Callers:
        ...
        struct IUnknown *a11)
{
  ...
  CBitmapLock *v18; // rax
  CBitmapLock *v19; // rsi
  __int64 (__fastcall *v20)(CBitmapOfDeviceBitmaps *); // rdi
