/*
 * XREFs of ?GetFirstAvailableD3DDevice@CD3DDeviceManager@@QEAAJAEBU_GUID@@PEAPEAVCD3DDeviceLevel1@@@Z @ 0x180144A60
 * Callers:
...
LABEL_3:
    v8 = D3DDevice;
LABEL_8:
    MilInstrumentationCheckHR(0x14u, &dword_180183F24, 1u, v8, v11);
    goto LABEL_9;
  }
  v9 = *((_QWORD *)this + 9);
  if ( !*(_DWORD *)(v9 + 88) )
