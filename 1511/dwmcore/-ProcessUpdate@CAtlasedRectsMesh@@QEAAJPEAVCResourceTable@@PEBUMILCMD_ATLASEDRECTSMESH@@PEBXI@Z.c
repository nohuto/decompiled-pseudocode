/*
 * XREFs of ?ProcessUpdate@CAtlasedRectsMesh@@QEAAJPEAVCResourceTable@@PEBUMILCMD_ATLASEDRECTSMESH@@PEBXI@Z @ 0x180026A60
 * Callers:
        ...
        unsigned int a5)
{
  ...
  *((_DWORD *)this + 37) = v10;
  if ( v10 )
  {
    ...
    v11 = WPF::HrAlloc(v7, v10, (unsigned __int64)(this + 19), v8);
    v12 = v11;
    if ( v11 < 0 )
    {
      v17 = 568;
...
LABEL_26:
  ...
  *((_DWORD *)this + 40) = v19;
  ...
  v11 = WPF::HrAlloc(v7, (unsigned int)v19, (unsigned __int64)(this + 21), v8);
  v12 = v11;
  if ( v11 < 0 )
  {
    v17 = 601;
...
LABEL_11:
  *((_DWORD *)this + 44) = HIDWORD(v19);
  if ( HIDWORD(v19) )
  {
    ...
    {
      v11 = WPF::HrAlloc(v7, HIDWORD(v19), (unsigned __int64)(this + 23), v8);
      v12 = v11;
      if ( v11 >= 0 )
      {
