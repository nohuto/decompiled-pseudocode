/*
 * XREFs of ?ExcludeFromVisibleRegion@CVisual@@QEAAJAEAV?$CRectF@UDeviceHPC@CoordinateSpace@@@@PEAVCDrawingContext@@@Z @ 0x18004D87C
 * Callers:
...
__int64 __fastcall CVisual::ExcludeFromVisibleRegion(CVisual *a1, __int64 a2, const struct CDrawingContext *a3)
{
  ...
  if ( MoveRenderPassInfoRef )
  {
    ...
    v3 = v6;
    if ( v6 < 0 )
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v6, 0xDE3u);
  }
  return v3;
}
