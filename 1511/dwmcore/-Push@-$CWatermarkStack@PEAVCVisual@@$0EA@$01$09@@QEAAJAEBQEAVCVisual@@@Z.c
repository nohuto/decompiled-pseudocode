/*
 * XREFs of ?Push@?$CWatermarkStack@PEAVCVisual@@$0EA@$01$09@@QEAAJAEBQEAVCVisual@@@Z @ 0x1800A4470
 * Callers:
...
__int64 __fastcall CWatermarkStack<CVisual *,64,2,10>::Push(unsigned int *a1, _QWORD *a2)
{
  ...
  if ( (unsigned int)v7 <= 0x40 )
    LODWORD(v7) = 64;
  v8 = WPF::HrMalloc((WPF *)a1, 8LL, (unsigned int)v7, (unsigned __int64)&v14, v13);
  v6 = v8;
  if ( v8 < 0 )
  {
...
LABEL_14:
  ...
  v10 = v14;
  v6 = 0;
  memcpy_0(v14, *((const void **)a1 + 2), (unsigned int)v9);
