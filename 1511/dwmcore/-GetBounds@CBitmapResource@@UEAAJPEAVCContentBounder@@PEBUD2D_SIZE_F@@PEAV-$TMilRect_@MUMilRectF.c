/*
 * XREFs of ?GetBounds@CBitmapResource@@UEAAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18005C570
 * Callers:
 ...
 *     ?GetBounds@CBitmapResource@@W7EAAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x1800BD230 (-GetBounds@CBitmapResource@@W7EAAJPEAVCContentBounder@@PEBUD2D_SIZE_F@@PEAV-$TMilRect_@MUMilRect.c)
 * Callees:
...
{
  __int64 v4; // rbx
  __int64 (__fastcall *v6)(CBitmap *__hidden, unsigned int *, unsigned int *); // rsi
  int Size; // eax
  unsigned int v8; // ebx
  int v9; // eax
  float v10; // xmm1_4
  ...
  if ( v4 )
  {
    v6 = *(__int64 (__fastcall **)(CBitmap *__hidden, unsigned int *, unsigned int *))(*(_QWORD *)v4 + 56LL);
