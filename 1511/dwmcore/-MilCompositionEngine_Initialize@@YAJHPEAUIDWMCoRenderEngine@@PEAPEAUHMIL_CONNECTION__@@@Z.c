/*
 * XREFs of ?MilCompositionEngine_Initialize@@YAJHPEAUIDWMCoRenderEngine@@PEAPEAUHMIL_CONNECTION__@@@Z @ 0x1800B4410
 * Callers:
 *     <none>
 * Callees:
        ...
        struct HMIL_CONNECTION__ **a3)
{
  ...
  if ( a3 )
  {
    ...
    v5 = v4;
    if ( v4 < 0 )
      MilInstrumentationCheckHR(0x14u, &dword_180177D58, 1u, v4, 0x54u);
    else
      *a3 = v7;
  }
  else
  {
    v5 = -2147024809;
    MilInstrumentationCheckHR(0x14u, &dword_180177D58, 1u, -2147024809, 0x50u);
  }
  return v5;
}
