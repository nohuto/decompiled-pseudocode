/*
 * XREFs of ?PresentSwapChainInternal@CD3DDeviceLevel1@@AEAAJPEAVCSwapChainBase@@PEAUHWND__@@PEAUHRGN__@@KIPEA_NPEAURenderTargetPresentParameters@@@Z @ 0x180022AD4
 * Callers:
        ...
        struct RenderTargetPresentParameters *a8)
{
  ...
  *a7 = 0;
  ...
  while ( CD3DResourceManager::FreeSomeVideoMemory((CD3DDeviceLevel1 *)((char *)this + 848), (int)a7) );
  *((_BYTE *)this + 1039) = 0;
  switch ( v14 )
  {
    case -2147467259:
    ...
    case -2005270496:
LABEL_14:
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0xBEAu);
      if ( !hWnd || IsWindow(hWnd) )
      {
        v15 = (struct _LUID)*((_QWORD *)this + 74);
        v14 = -2005270523;
...
LABEL_17:
  ...
  if ( v14 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v14, 0xC02u);
LABEL_19:
  TranslateDXGIorD3DErrorInContext((unsigned int)v14, 1LL, &a7);
  v16 = (unsigned int)a7;
  if ( (int)a7 < 0 )
