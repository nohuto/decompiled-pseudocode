/*
 * XREFs of ?ProcessAddTimeEvents@CAnimation@@QEAAJPEAVCResourceTable@@PEBUMILCMD_ANIMATION_ADDTIMEEVENTS@@PEBXI@Z @ 0x1800839F0
 * Callers:
...
LABEL_8:
  ...
  v10 = DynArrayImpl<0>::AddMultipleAndSet((__int64)v5, 16, v7, a4);
  v9 = v10;
  if ( v10 < 0 )
  {
