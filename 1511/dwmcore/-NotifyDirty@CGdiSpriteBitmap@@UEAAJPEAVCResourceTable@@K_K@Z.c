/*
 * XREFs of ?NotifyDirty@CGdiSpriteBitmap@@UEAAJPEAVCResourceTable@@K_K@Z @ 0x180086E50
 * Callers:
        ...
        __int64 a4)
{
  ...
  if ( a2 && (a3 & 6) == 6 )
  {
    ...
    if ( v9 < 0 )
    {
      v25 = 1088;
LABEL_57:
      MilInstrumentationCheckHR(0x14u, &dword_180178F08, 4u, v9, v25);
      goto LABEL_24;
    }
    goto LABEL_21;
  }
  ...
  *((_QWORD *)&v35 + 1) = &v29;
  v36 = &v30;
  if ( (int)CRedirectedGDISurface::GetInformation(v11 + 16, 0LL, &v32, &v33) < 0 )
    goto LABEL_21;
  if ( (a3 & 5) != 0 )
    *((_BYTE *)this + 372) |= 2u;
  if ( (a3 & 4) != 0 && v26 )
  ...
  if ( v13 )
  {
    ...
    if ( v14 < 0 )
    {
      MilInstrumentationCheckHR(0x14u, &dword_180178F08, 4u, v14, 0x48Bu);
      v5 = v31;
      goto LABEL_24;
    }
    v5 = v31;
