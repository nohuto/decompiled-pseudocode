/*
 * XREFs of ?ClipToNode@CWindowNode@@AEAA_NAEBUtagRECT@@AEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18001B3A8
 * Callers:
...
bool __fastcall CWindowNode::ClipToNode(__int64 a1, const RECT *a2, __int64 a3)
{
  ...
  CopyRect(&rcDst, (const RECT *)(a1 + 840));
