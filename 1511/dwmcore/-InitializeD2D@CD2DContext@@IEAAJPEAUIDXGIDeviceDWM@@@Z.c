/*
 * XREFs of ?InitializeD2D@CD2DContext@@IEAAJPEAUIDXGIDeviceDWM@@@Z @ 0x180022270
 * Callers:
...
__int64 __fastcall CD2DContext::InitializeD2D(struct CD2DResourceManager **this, struct IDXGIDeviceDWM *a2)
{
            ...
            else
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  if ( v16 < 0 )
                  {
                    MilInstrumentationCheckHR(0x14u, 0LL, 0, v16, 0x3Cu);
                  }
                  else
                  {
                    v17 = *v13;
                    ...
                    if ( v18 < 0 )
                    {
                      MilInstrumentationCheckHR(0x14u, 0LL, 0, v18, 0x3Fu);
                    }
                    else
                    {
                      ...
                      if ( v19 < 0 )
                      {
                        MilInstrumentationCheckHR(0x14u, 0LL, 0, v19, 0x41u);
                      }
                      else
                      {
  ...
  TranslateDXGIorD3DErrorInContext(v6, 0LL, &v22);
  return v22;
}
