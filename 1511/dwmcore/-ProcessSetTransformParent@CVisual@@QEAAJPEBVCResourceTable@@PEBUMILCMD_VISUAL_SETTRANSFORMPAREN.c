/*
 * XREFs of ?ProcessSetTransformParent@CVisual@@QEAAJPEBVCResourceTable@@PEBUMILCMD_VISUAL_SETTRANSFORMPARENT@@@Z @ 0x180047E90
 * Callers:
        ...
        const struct MILCMD_VISUAL_SETTRANSFORMPARENT *a3)
{
  ...
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x730u);
  }
  else
  {
    v8 = (struct CWeakReferenceBase *)*((_QWORD *)this + 43);
    if ( v8 )
    ...
    else
    {
      ...
      if ( Resource )
      {
        ...
        {
          MilInstrumentationCheckHR(0x14u, 0LL, 0, WeakReferenceBase, 0x73Fu);
          return v4;
        }
        v10 = v14;
      }
      v12 = (struct CWeakReferenceBase *)*((_QWORD *)this + 43);
      if ( v12 )
