/*
 * XREFs of ?Create@MeshGraph@Mesh@@SAJHHHHPEAPEAU12@@Z @ 0x180068ADC
 * Callers:
...
__int64 __fastcall Mesh::MeshGraph::Create(int a1, int a2, int a3, int a4, struct Mesh::MeshGraph **a5)
{
  ...
  int v9; // eax
  CBitmapOfDeviceBitmaps::DeviceBitmapInfo *v10; // r14
  CBitmapOfDeviceBitmaps::DeviceBitmapInfo *v11; // r15
  __int64 v12; // rdi
  CBitmapOfDeviceBitmaps::DeviceBitmapInfo *v13; // rax
  __int64 v14; // rdi
  CBitmapOfDeviceBitmaps::DeviceBitmapInfo *v15; // rax
  __int64 v16; // rdi
  __int64 v17; // rdi
  __int64 v18; // rsi
  __int64 v19; // rax
  ...
  if ( a1 > 0 )
  {
    ...
    if ( !is_mul_ok(a1, 0x48uLL) )
      v12 = -1LL;
    v13 = (CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                                        WPF::g_pProcessHeap,
                                                        v12,
                                                        -1LL);
    v10 = v13;
    if ( v13 )
      `vector constructor iterator'(
        ...
        72LL,
        a1,
        (void (__fastcall *)(CBitmapOfDeviceBitmaps::DeviceBitmapInfo *))Mesh::MeshVertex::MeshVertex);
    else
      v10 = 0LL;
    if ( !v10 )
    {
      v5 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x15D0u);
      v20 = 0LL;
LABEL_37:
  ...
  if ( v9 > 0 )
  {
    ...
    if ( !is_mul_ok(v9, 0x58uLL) )
      v14 = -1LL;
    v15 = (CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                                        WPF::g_pProcessHeap,
                                                        v14,
                                                        -1LL);
    v11 = v15;
    if ( v15 )
      `vector constructor iterator'(
        ...
        88LL,
        v26,
        (void (__fastcall *)(CBitmapOfDeviceBitmaps::DeviceBitmapInfo *))Mesh::MeshLine::MeshLine);
    else
      v11 = 0LL;
    if ( !v11 )
    {
...
LABEL_22:
  ...
  {
    v5 = -2147024882;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x15EAu);
    goto LABEL_37;
  }
