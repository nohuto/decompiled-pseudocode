/*
 * XREFs of ?OnTaskCompleted_AnyThread@CEffectCompilationService@@AEAAXPEAVCEffectCompilationTask@@_N@Z @ 0x1801059B8
 * Callers:
        ...
        char a3)
{
  ...
  if ( !*((_BYTE *)this + 80) )
  {
    ...
    if ( (unsigned int)i < v6 )
    {
      ...
      if ( a3 )
      {
        DynArray<CWARPCallbackRenderer *,0>::RemoveAt((char *)this + 88, (unsigned int)i);
        --*((_DWORD *)this + 21);
      }
