/*
 * XREFs of ??$SetOutputTexel@I@CGradientTextureGenerator@@CAXPEBU_D3DCOLORVALUE@@W4Enum@MilColorInterpolationMode@@PEAI@Z @ 0x1801670FC
 * Callers:
 ...
 *     ?Premultiply@@YAII@Z @ 0x180158348 (-Premultiply@@YAII@Z.c)
 */
