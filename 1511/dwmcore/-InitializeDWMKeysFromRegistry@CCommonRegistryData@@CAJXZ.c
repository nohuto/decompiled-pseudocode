/*
 * XREFs of ?InitializeDWMKeysFromRegistry@CCommonRegistryData@@CAJXZ @ 0x1800AF5E0
 * Callers:
...
__int64 CCommonRegistryData::InitializeDWMKeysFromRegistry(void)
{
  ...
  v8 = 0;
  if ( RegGetHKLMDword(L"Software\\Microsoft\\Windows\\Dwm", L"EnableDesktopPlaneSplit", &v8) )
    CCommonRegistryData::m_fEnableDesktopPlaneSplit = v8 != 0;
  v8 = 0;
  if ( RegGetHKLMDword(L"Software\\Microsoft\\Windows\\Dwm", L"DisableAdvancedDirectFlip", &v8) )
    CCommonRegistryData::m_fDisableAdvancedDirectFlip = v8 != 0;
  v8 = 0;
