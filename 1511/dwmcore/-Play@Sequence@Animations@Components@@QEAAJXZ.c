/*
 * XREFs of ?Play@Sequence@Animations@Components@@QEAAJXZ @ 0x1801646EC
 * Callers:
 ...
 *     ?SortKeyFrames@Sequence@Animations@Components@@AEAAXXZ @ 0x180164BC8 (-SortKeyFrames@Sequence@Animations@Components@@AEAAXXZ.c)
