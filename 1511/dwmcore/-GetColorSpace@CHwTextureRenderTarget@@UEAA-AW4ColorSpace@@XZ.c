/*
 * XREFs of ?GetColorSpace@CHwTextureRenderTarget@@UEAA?AW4ColorSpace@@XZ @ 0x18002C630
 * Callers:
 ...
 *     ?GetColorSpace@CHwTextureRenderTarget@@WLA@EAA?AW4ColorSpace@@XZ @ 0x1800BDFF0 (-GetColorSpace@CHwTextureRenderTarget@@WLA@EAA-AW4ColorSpace@@XZ.c)
 * Callees:
 *     <none>
 */
