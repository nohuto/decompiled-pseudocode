/*
 * XREFs of ??$TransferVertices2D_Vector@$00@@YAXPEBUCCommonTransferParameters@@AEBUD2D_MATRIX_3X2_F@@@Z @ 0x1800163C0
 * Callers:
...
_UNKNOWN **__fastcall TransferVertices2D_Vector<1>(__int64 *a1, unsigned int *a2)
{
  ...
  if ( v13 )
  {
    do
    {
      ...
      result = (_UNKNOWN **)(_mm_movemask_ps(_mm_cmpeq_ps(v26, (__m128)DirectX::g_XMZero)) & 3);
      if ( (_BYTE)result != 3 )
      {
