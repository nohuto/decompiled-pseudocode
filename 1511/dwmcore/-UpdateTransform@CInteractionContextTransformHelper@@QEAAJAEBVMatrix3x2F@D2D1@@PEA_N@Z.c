/*
 * XREFs of ?UpdateTransform@CInteractionContextTransformHelper@@QEAAJAEBVMatrix3x2F@D2D1@@PEA_N@Z @ 0x1800FE2A0
 * Callers:
 ...
 *     GetIndividualScales @ 0x180159E70 (GetIndividualScales.c)
 *     GetInverse @ 0x180159F54 (GetInverse.c)
 *     IsEqualMatrix @ 0x18015A020 (IsEqualMatrix.c)
 */
        ...
        bool *a3)
{
  ...
  if ( !(unsigned __int8)IsEqualMatrix(a2, this, 0LL) )
  {
    ...
    if ( Inverse >= 0 )
    {
      ...
      v26 = 1.0;
      v32 = v8;
      Inverse = GetIndividualScales(&v31, &v25, &v26);
      if ( Inverse >= 0 )
      {
        v9 = *((_QWORD *)a2 + 2);
        v31 = *(_OWORD *)a2;
        ...
        *((float *)&v31 + 2) = *((float *)&v31 + 2) * (float)(1.0 / v25);
        *(float *)&v31 = *(float *)&v31 * (float)(1.0 / v25);
        v12 = (__m128)HIDWORD(v9);
        *((float *)&v31 + 1) = *((float *)&v31 + 1) * (float)(1.0 / v26);
        v11.m128_f32[0] = *(float *)&v9 * (float)(1.0 / v25);
        *((float *)&v31 + 3) = *((float *)&v31 + 3) * (float)(1.0 / v26);
        v12.m128_f32[0] = *((float *)&v9 + 1) * (float)(1.0 / v26);
