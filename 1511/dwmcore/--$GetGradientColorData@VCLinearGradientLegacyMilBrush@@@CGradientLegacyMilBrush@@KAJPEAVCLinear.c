/*
 * XREFs of ??$GetGradientColorData@VCLinearGradientLegacyMilBrush@@@CGradientLegacyMilBrush@@KAJPEAVCLinearGradientLegacyMilBrush@@PEAVCGradientColorData@@@Z @ 0x1800136B0
 * Callers:
        ...
        CGradientColorData *a2)
{
  ...
  *((_DWORD *)a2 + 6) = 0;
  *((_DWORD *)a2 + 14) = 0;
  Opacity = CLegacyMilBrush::GetOpacity(a1, *(_QWORD *)(a1 + 80), &v14);
  v6 = Opacity;
  if ( Opacity < 0 )
  {
