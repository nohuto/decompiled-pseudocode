/*
 * XREFs of ?GetShapeRegion@CShape@@QEAAJPEAPEAUHRGN__@@@Z @ 0x1801588EC
 * Callers:
...
__int64 __fastcall CShape::GetShapeRegion(CShape *this, HRGN *a2)
{
  ...
  HRGN v5; // r15
  __int64 v6; // rbx
  CBitmapOfDeviceBitmaps::DeviceBitmapInfo *v7; // rax
  CBitmapOfDeviceBitmaps::DeviceBitmapInfo *v8; // rsi
  __m128 v9; // xmm2
  int v10; // ebx
  __int64 v11; // rdi
  CBitmapOfDeviceBitmaps::DeviceBitmapInfo *v12; // rax
  signed int v13; // eax
  DWORD v14; // edx
  ...
  if ( (*(unsigned int (__fastcall **)(CShape *))(*(_QWORD *)this + 8LL))(this) )
  {
    ...
    if ( !is_mul_ok(RectCount, 0x10uLL) )
      v11 = -1LL;
    v12 = (CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                                        WPF::g_pProcessHeap,
                                                        v11);
    v8 = v12;
    if ( v12 )
    ...
    {
      v3 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x2B1u);
      goto LABEL_41;
    }
    v10 = RectCount;
  ...
  else
  {
    ...
    if ( !is_mul_ok(1uLL, 0x10uLL) )
      v6 = -1LL;
    v7 = (CBitmapOfDeviceBitmaps::DeviceBitmapInfo *)(*(__int64 (__fastcall **)(WPF::ProcessHeapImpl *, __int64))(*(_QWORD *)WPF::g_pProcessHeap + 8LL))(
                                                       WPF::g_pProcessHeap,
                                                       v6);
    v8 = v7;
    if ( v7 )
