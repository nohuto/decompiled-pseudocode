/*
 * XREFs of ?GetBoundsInternal@CHwndBitmap@@AEBAJPEAV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@@Z @ 0x18000F500
 * Callers:
...
__int64 __fastcall CHwndBitmap::GetBoundsInternal(__int64 a1, __int64 a2)
{
  ...
  float v11[6]; // [rsp+40h] [rbp-20h]

  v4 = 0;
  if ( CHwndBitmap::IsValidVisual((CHwndBitmap *)a1) && (v5 = *(CVisualTree **)(a1 + 456)) != 0LL )
  {
    Bounds = CVisualTree::GetBounds(v5);
    v4 = Bounds;
    if ( Bounds < 0 )
    {
