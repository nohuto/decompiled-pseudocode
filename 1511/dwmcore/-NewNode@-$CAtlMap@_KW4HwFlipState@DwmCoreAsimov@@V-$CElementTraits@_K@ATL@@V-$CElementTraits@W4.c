/*
 * XREFs of ?NewNode@?$CAtlMap@_KW4HwFlipState@DwmCoreAsimov@@V?$CElementTraits@_K@ATL@@V?$CElementTraits@W4HwFlipState@DwmCoreAsimov@@@4@@ATL@@AEAAPEAVCNode@12@_KII@Z @ 0x180069A50
 * Callers:
...
__int64 __fastcall ATL::CAtlMap<unsigned __int64,enum DwmCoreAsimov::HwFlipState,ATL::CElementTraits<unsigned __int64>,ATL::CElementTraits<enum DwmCoreAsimov::HwFlipState>>::NewNode(
        __int64 a1,
        __int64 a2,
        unsigned int a3,
        int a4)
{
  ...
  if ( !*(_QWORD *)(a1 + 64) )
  {
    ...
    v9 = *(_DWORD *)(a1 + 52);
    for ( i = (__int64)v8 + 32 * (unsigned int)(v9 - 1) + 8; --v9 >= 0; i -= 32LL )
    {
