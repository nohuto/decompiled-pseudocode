/*
 * XREFs of ?CreateAndAddDDARenderTarget@CDesktopRenderTarget@@AEAAJPEAVCDisplay@@@Z @ 0x180106CE0
 * Callers:
...
__int64 __fastcall CDesktopRenderTarget::CreateAndAddDDARenderTarget(CDesktopRenderTarget *this, struct CDisplay *a2)
{
  ...
  {
    v6 = -2147024882;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x286u);
    goto LABEL_26;
  }
  ...
  if ( v7 + 1 < v7 )
  {
    ...
    v6 = -2147024362;
LABEL_15:
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x289u);
    goto LABEL_26;
  }
  if ( v8 > *((_DWORD *)this + 27) )
  {
    v11 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 88, 8, 1, &v20);
    v9 = v11;
    if ( v11 < 0 )
  ...
  v16 = *((_BYTE *)this + 304);
  v15 = *((_DWORD *)this + 68);
  v19 = *(_OWORD *)((char *)this + 276);
  inited = CHwndRenderTarget::InitFullScreen((__int64)v20, (__int64)this, (__int64)a2, &v19, v15, v16, v17, v18);
  v6 = inited;
  if ( inited >= 0 )
  {
    if ( *((_QWORD *)this + 7)
      && (v12 = (*(__int64 (__fastcall **)(struct CHwndRenderTarget *, _QWORD))(*(_QWORD *)v20 + 184LL))(
                  v20,
                  *((_QWORD *)this + 7)),
          v6 = v12,
          v12 < 0) )
    {
      MilInstrumentationCheckHR(0x14u, 0LL, 0, v12, 0x29Eu);
    }
    else
    {
      ...
      if ( v13 >= 0 )
        ...
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v13, 0x2A4u);
    }
  }
  else
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, inited, 0x296u);
  }
  if ( v6 < 0 )
