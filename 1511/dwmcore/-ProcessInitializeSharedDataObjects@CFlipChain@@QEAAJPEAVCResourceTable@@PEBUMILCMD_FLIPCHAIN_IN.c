/*
 * XREFs of ?ProcessInitializeSharedDataObjects@CFlipChain@@QEAAJPEAVCResourceTable@@PEBUMILCMD_FLIPCHAIN_INITIALIZESHAREDDATAOBJECTS@@@Z @ 0x1800F4780
 * Callers:
        ...
        const struct MILCMD_FLIPCHAIN_INITIALIZESHAREDDATAOBJECTS *a3)
{
  ...
  v9 = CLocalMrowWriter<SharedBufferDataFlipChain>::Create(this, v3);
  v10 = v9;
  if ( v9 >= 0 )
  {
