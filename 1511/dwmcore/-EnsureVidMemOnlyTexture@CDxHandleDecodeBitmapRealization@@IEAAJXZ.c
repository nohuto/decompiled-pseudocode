/*
 * XREFs of ?EnsureVidMemOnlyTexture@CDxHandleDecodeBitmapRealization@@IEAAJXZ @ 0x18015F6E0
 * Callers:
 *     ?GetTextureFormat@CDxHandleDecodeBitmapRealization@@UEAA?AW4DXGI_FORMAT@@XZ @ 0x18015E890 (-GetTextureFormat@CDxHandleDecodeBitmapRealization@@UEAA-AW4DXGI_FORMAT@@XZ.c)
...
__int64 __fastcall CDxHandleDecodeBitmapRealization::EnsureVidMemOnlyTexture(CDxHandleDecodeBitmapRealization *this)
{
  ...
  {
    v3 = -2147467259;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147467259, 0x134u);
LABEL_13:
    if ( v2 )
  ...
  if ( v5 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v5, 0x11Fu);
    return v3;
  }
  ...
  if ( D3DDevice < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, D3DDevice, 0x123u);
    v1 = v12;
    goto LABEL_15;
  }
  v1 = v12;
  v8 = CD3DVidMemOnlyTexture::OpenSharedTexture(&v13, v7, (__int64 **)v12, *((void **)this + 38), 1, 0, &v11);
  v3 = v8;
  if ( v8 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x12Bu);
    v2 = v11;
    goto LABEL_13;
  }
  v2 = v11;
  ...
  if ( v9 < 0 )
  {
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v9, 0x12Du);
    goto LABEL_13;
  }
  *((_QWORD *)this + 57) = v2;
LABEL_15:
  if ( v1 )
    CMILPoolResource::Release((struct CD3DDeviceLevel1 *)((char *)v1 + 384));
  return v3;
}
