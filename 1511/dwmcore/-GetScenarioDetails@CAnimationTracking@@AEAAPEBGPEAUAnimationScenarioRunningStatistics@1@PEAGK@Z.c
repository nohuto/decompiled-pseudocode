/*
 * XREFs of ?GetScenarioDetails@CAnimationTracking@@AEAAPEBGPEAUAnimationScenarioRunningStatistics@1@PEAGK@Z @ 0x180029A68
 * Callers:
        ...
        unsigned __int16 *a3)
{
  ...
  if ( *(_DWORD *)a2 )
  {
    ...
    {
      return (unsigned __int16 *)&unk_18016D648;
    }
  }
  else
  {
