/*
 * XREFs of ??$ComputeHandledInteractionsFromLocal@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@CInteractionProcessor@@AEAA?AUInteractionAxis@@PEAV?$CInputTypeContext@UDwmTouchpadInteractionConfigurationPrimitive@@U?$TMILFlagsEnum@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@W4FlagsEnum@DwmInteractionTypeTouchpadPrimitiveType@@@@AEBUD2DVector3@@PEAUD2DMatrix@@@Z @ 0x180140988
 * Callers:
        ...
        struct D2DMatrix *a5)
{
  ...
  v5 = (__int64)a3 + 20;
  v10 = (_OWORD *)`anonymous namespace'::ReverseAndLeftShift(v21, (char *)a3 + 20);
  *(_OWORD *)a5 = *v10;
  *((_OWORD *)a5 + 1) = v10[1];
  *((_OWORD *)a5 + 2) = v10[2];
  *((_OWORD *)a5 + 3) = v10[3];
  ...
  if ( (unsigned int)pRelatedActivityId > 4 && (qword_18019E950 & 2) != 0 && (qword_18019E958 & 2) == qword_18019E958 )
  {
    ...
    v76 = 4LL;
    v78 = 4LL;
    TlgWrite((TraceLoggingHProvider)&pRelatedActivityId, &unk_18017E3BE, v12, v13, 0x1Au, &pData);
  }
