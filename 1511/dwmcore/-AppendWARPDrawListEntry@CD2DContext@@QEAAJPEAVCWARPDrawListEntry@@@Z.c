/*
 * XREFs of ?AppendWARPDrawListEntry@CD2DContext@@QEAAJPEAVCWARPDrawListEntry@@@Z @ 0x1801462B8
 * Callers:
...
LABEL_12:
    ...
    *((_QWORD *)this + 42) = *(_QWORD *)(*((_QWORD *)this + 43) + 8LL * v10);
    DynArray<CWARPCallbackRenderer *,0>::RemoveAt((__int64 *)this + 43, v10);
LABEL_13:
    appended = CWARPCallbackRenderer::AppendWARPDrawListEntry(*((CWARPCallbackRenderer **)this + 42), a2);
    v6 = appended;
    if ( appended >= 0 )
      goto LABEL_16;
    v13 = 611;
...
LABEL_15:
  ...
  if ( v7 + 1 >= v7 )
  {
    if ( v8 > *((_DWORD *)this + 91) )
    {
      v12 = DynArrayImpl<0>::AddMultipleAndSet((__int64)this + 344, 8, 1, &v14);
      v9 = v12;
      if ( v12 < 0 )
    ...
    {
      *(_QWORD *)(*((_QWORD *)this + 43) + 8LL * *((unsigned int *)this + 92)) = v14;
      *((_DWORD *)this + 92) = v8;
    }
    v14 = 0LL;
    goto LABEL_12;
