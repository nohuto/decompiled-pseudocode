/*
 * XREFs of ?ApiSetExpression@Animation@Animations@Components@@QEAAJHPEAUIKeyframeAnimationOwner@@IW4Dwm__AnimationType@23@@Z @ 0x180161628
 * Callers:
  ...
  if ( v10 )
  {
    ...
    *(_DWORD *)(v10 + 24) = a4;
    v11 = Components::Animations::Sequence::SetKeyframeValue(
            *(Components::Animations::Sequence **)(a1 + 24),
            a2,
            (struct Components::Animations::Input *)v10);
    if ( v11 >= 0 )
      v11 = 0;
    Components::Animations::Input::Release((Components::Animations::Input *)v10);
  }
  else
  {
