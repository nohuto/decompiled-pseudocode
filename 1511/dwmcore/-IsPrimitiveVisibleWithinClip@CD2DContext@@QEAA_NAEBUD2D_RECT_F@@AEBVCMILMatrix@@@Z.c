/*
 * XREFs of ?IsPrimitiveVisibleWithinClip@CD2DContext@@QEAA_NAEBUD2D_RECT_F@@AEBVCMILMatrix@@@Z @ 0x1800FA424
 * Callers:
        ...
        const struct CMILMatrix *a3)
{
  ...
  do
  {
    CBaseMatrix::Transform(a3, (const struct MilPoint2F *)&v24[v17], (struct MilPoint2F *)&v22, 1);
    if ( v16 <= *((float *)&v22 + 1) )
      v16 = *((float *)&v22 + 1);
    if ( v18 <= *(float *)&v22 )
      v18 = *(float *)&v22;
