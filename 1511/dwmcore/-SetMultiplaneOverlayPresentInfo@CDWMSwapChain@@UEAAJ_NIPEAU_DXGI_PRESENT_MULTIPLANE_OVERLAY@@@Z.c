/*
 * XREFs of ?SetMultiplaneOverlayPresentInfo@CDWMSwapChain@@UEAAJ_NIPEAU_DXGI_PRESENT_MULTIPLANE_OVERLAY@@@Z @ 0x1800B9570
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _DXGI_PRESENT_MULTIPLANE_OVERLAY *a4)
{
  ...
  if ( a2 )
  {
    ...
    *((_QWORD *)this + 48) = v10;
      ...
      *((_DWORD *)this + 95) = v5;
      for ( i = 0; i < *((_DWORD *)this + 95); ++i )
      {
        ...
        *(_OWORD *)(v12 + v13 + 112) = *(_OWORD *)((char *)a4 + v13 + 112);
        v14 = *(_QWORD *)(*((_QWORD *)this + 48) + v13 + 8);
        if ( v14 )
    ...
    {
      v8 = -2147024882;
      MilInstrumentationCheckHR(0x14u, 0LL, 0, -2147024882, 0x42Fu);
    }
  }
  return v8;
}
