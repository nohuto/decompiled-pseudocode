/*
 * XREFs of ?NeedsDesktopMoves@CDisplay@@QEBA_NXZ @ 0x1800707C0
 * Callers:
...
__int64 __fastcall CDisplay::NeedsDesktopMoves(CDisplay *this)
{
  __int64 result; // rax

  result = 0LL;
  if ( *((_BYTE *)this + 304) || *((_BYTE *)this + 303) || *((_BYTE *)this + 220) || *((_DWORD *)this + 54) )
    return 1LL;
  return result;
}
