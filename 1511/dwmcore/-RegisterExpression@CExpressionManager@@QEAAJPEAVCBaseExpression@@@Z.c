/*
 * XREFs of ?RegisterExpression@CExpressionManager@@QEAAJPEAVCBaseExpression@@@Z @ 0x18011E5E4
 * Callers:
        ...
        __int64 a3)
{
  ...
  if ( (int)v4 + 1 >= (unsigned int)v4 )
  {
    ...
    {
      v15 = DynArrayImpl<1>::AddMultipleAndSet((__int64)this + 184, 8u, a3, &v25);
      v8 = v15;
      if ( v15 < 0 )
    ...
    v5 = 1;
    v10 = *((_DWORD *)this + 4);
    v11 = (*(__int64 (__fastcall **)(struct CBaseExpression *))(*(_QWORD *)v25 + 112LL))(v25);
    if ( v11 > v10 )
      v10 = v11;
    v12 = v25;
    *((_DWORD *)this + 4) = v10;
    ...
    Element = CGenericTableMap<ObjectPropertyReference,CTargetMapEntry>::FindElement(
                ...
                v19);
    if ( Element
      || (Element = RtlInsertElementGenericTable((PRTL_GENERIC_TABLE)((char *)this + 248), &Buffer, 0x18u, &NewElement)) != 0LL )
    {
...
LABEL_23:
    DynArray<CBaseExpression *,1>::Remove(v3, (__int64 *)&v25);
