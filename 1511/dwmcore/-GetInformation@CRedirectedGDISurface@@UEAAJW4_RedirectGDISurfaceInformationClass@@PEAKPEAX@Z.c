/*
 * XREFs of ?GetInformation@CRedirectedGDISurface@@UEAAJW4_RedirectGDISurfaceInformationClass@@PEAKPEAX@Z @ 0x1800A5760
 * Callers:
...
LABEL_38:
      v4 = v15;
LABEL_21:
      MilInstrumentationCheckHR(0x14u, &dword_180174E58, 3u, v15, v17);
      return v4;
    }
    v18 = 0;
    v19 = 0LL;
