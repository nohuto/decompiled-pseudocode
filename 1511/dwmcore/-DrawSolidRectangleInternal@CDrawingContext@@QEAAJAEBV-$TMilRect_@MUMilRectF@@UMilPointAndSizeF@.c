/*
 * XREFs of ?DrawSolidRectangleInternal@CDrawingContext@@QEAAJAEBV?$TMilRect_@MUMilRectF@@UMilPointAndSizeF@@UNotNeeded@RectUniqueness@@@@AEBU_D3DCOLORVALUE@@@Z @ 0x180046F78
 * Callers:
        ...
        const struct _D3DCOLORVALUE *a3)
{
  ...
  struct ID2D1PrivateCompositorRenderer **v8; // r14
  enum D2D1_ANTIALIAS_MODE v9; // esi
  __int64 (__fastcall *v10)(struct ID2D1PrivateCompositorRenderer **, const struct ID2DContextOwner *, const struct D2D_RECT_F *, const struct _D3DCOLORVALUE *, enum D2D1_ANTIALIAS_MODE, enum D2D1_PRIMITIVE_BLEND); // rbp
  int v11; // eax
  ...
  v8 = *(struct ID2D1PrivateCompositorRenderer ***)(a1 + 376);
  v9 = *(_DWORD *)(a1 + 248) != 0;
  v10 = (__int64 (__fastcall *)(struct ID2D1PrivateCompositorRenderer **, const struct ID2DContextOwner *, const struct D2D_RECT_F *, const struct _D3DCOLORVALUE *, enum D2D1_ANTIALIAS_MODE, enum D2D1_PRIMITIVE_BLEND))*((_QWORD *)*v8 + 19);
  if ( v10 == CD2DContext::FillRectangleWithSolidColor )
    v11 = CD2DContext::FillRectangleWithSolidColor(v8, v5, &v15, a3, v9, v7);
  else
    v11 = v10(v8, v5, &v15, a3, v9, v7);
  v12 = v11;
  if ( v11 < 0 )
    MilInstrumentationCheckHR(0x14u, 0LL, 0, v11, 0x3B7u);
  return v12;
}
