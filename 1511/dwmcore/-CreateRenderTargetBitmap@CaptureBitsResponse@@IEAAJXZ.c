/*
 * XREFs of ?CreateRenderTargetBitmap@CaptureBitsResponse@@IEAAJXZ @ 0x18010A258
 * Callers:
...
__int64 __fastcall CaptureBitsResponse::CreateRenderTargetBitmap(CaptureBitsResponse *this)
{
  ...
  if ( CurrentDisplaySet >= 0 )
  {
    v6 = *((_DWORD *)v30 + 10);
    v7 = DisplayId::All;
    v8 = (struct _LUID)g_luidZero;
    if ( v6 < *((_DWORD *)v30 + 18) )
      v8 = *(struct _LUID *)(*(_QWORD *)(*((_QWORD *)v30 + 6) + 8LL * v6) + 232LL);
...
LABEL_12:
      ...
      v5 = v22;
      if ( v22 < 0 )
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v22, 0x1D4u);
    }
  }
  else
  {
