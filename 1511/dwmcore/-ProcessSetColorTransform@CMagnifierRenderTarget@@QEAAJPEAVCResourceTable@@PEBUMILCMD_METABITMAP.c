/*
 * XREFs of ?ProcessSetColorTransform@CMagnifierRenderTarget@@QEAAJPEAVCResourceTable@@PEBUMILCMD_METABITMAPRENDERTARGET_SETCOLORTRANSFORM@@@Z @ 0x1800F3EFC
 * Callers:
        ...
        const struct MILCMD_METABITMAPRENDERTARGET_SETCOLORTRANSFORM *a3)
{
  ...
  if ( !v5 || (Resource = (struct CResource *)CResourceTable::GetResource((__int64)a2, v5, 0x34u)) != 0LL )
  {
    if ( Resource != this[11] )
    {
      ...
      {
        MilInstrumentationCheckHR(0x14u, 0LL, 0, v8, 0x2E5u);
      }
    }
  }
  else
  {
    v4 = -2003303421;
    MilInstrumentationCheckHR(0x14u, 0LL, 0, -2003303421, 0x2DCu);
  }
  return v4;
}
