/*
 * XREFs of ?Create@CD3DConstantBuffer@@SAJPEAVCD3DDeviceLevel1@@IW4D3D11_USAGE@@PEBXPEAPEAV1@@Z @ 0x180148838
 * Callers:
...
LABEL_9:
  ...
  v14 = CD3DConstantBuffer::Initialize(v9, (struct CD3DDeviceLevel1 *)((char *)a1 + 848), a2, v17);
  v11 = v14;
  if ( v14 < 0 )
  {
    v16 = 60;
