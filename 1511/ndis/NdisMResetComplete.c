/*
 * XREFs of NdisMResetComplete @ 0x1C0058590
 * Callers:
...
void __stdcall NdisMResetComplete(NDIS_HANDLE MiniportAdapterHandle, NDIS_STATUS Status, BOOLEAN AddressingReset)
{
  ...
  if ( (unsigned __int8)byte_1C0083718 >= 4u )
    WPP_SF_q(0x49u, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, (__int64)MiniportAdapterHandle);
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 726412;
  if ( v8 )
  {
    DbgPrintEx(
      0x78u,
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 0;
  ...
  if ( (unsigned __int8)byte_1C0083718 >= 4u )
    WPP_SF_q(0x4Au, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, (__int64)MiniportAdapterHandle);
}
