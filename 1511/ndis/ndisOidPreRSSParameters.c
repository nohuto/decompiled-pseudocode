/*
 * XREFs of ndisOidPreRSSParameters @ 0x1C00AAB00
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreRSSParameters(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0x9Cu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v1, v5, v3);
  if ( *(_DWORD *)(v3 + 4) == 2 )
  {
    if ( !*(_QWORD *)a1 )
      goto LABEL_8;
...
LABEL_8:
  ...
  {
    LODWORD(v7) = v4;
    WPP_SF_qqDD(0x9Du, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v1, v5, v7, *(_DWORD *)(a1 + 40));
  }
  return v4;
}
