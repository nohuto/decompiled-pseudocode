/*
 * XREFs of ndisSriovInterfaceWriteVfConfigBlock @ 0x1C00D6190
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceWriteVfConfigBlock(void *a1, __int16 a2, int a3, const void *a4, size_t Size)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x5Du, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x5Eu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
