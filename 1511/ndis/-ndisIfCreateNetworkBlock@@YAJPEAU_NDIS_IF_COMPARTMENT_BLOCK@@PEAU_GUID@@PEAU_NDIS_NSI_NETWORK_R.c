/*
 * XREFs of ?ndisIfCreateNetworkBlock@@YAJPEAU_NDIS_IF_COMPARTMENT_BLOCK@@PEAU_GUID@@PEAU_NDIS_NSI_NETWORK_RW@@PEAPEAU_NDIS_IF_NETWORK_BLOCK@@@Z @ 0x1C0020810
 * Callers:
        ...
        _LIST_ENTRY ***a4)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qq(124LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a2);
...
LABEL_18:
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qqqL(125LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a2, *a4, v8);
  return v8;
}
