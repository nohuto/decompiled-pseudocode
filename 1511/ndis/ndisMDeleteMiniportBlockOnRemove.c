/*
 * XREFs of ndisMDeleteMiniportBlockOnRemove @ 0x1C00989B0
 * Callers:
 ...
 *     ?ndisGetNthEntry@@YAPEAU_NDIS_EVENT_LOG_ENTRY@@PEAU_NDIS_EVENT_LOG@@K@Z @ 0x1C00275CC (-ndisGetNthEntry@@YAPEAU_NDIS_EVENT_LOG_ENTRY@@PEAU_NDIS_EVENT_LOG@@K@Z.c)
...
void __fastcall ndisMDeleteMiniportBlockOnRemove(char *P)
{
  ...
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v28, &ndisPcwMutex);
  v7 = *((_QWORD *)P + 5);
  if ( v7 )
    *(_QWORD *)(v7 + 176) = 0LL;
  ...
  *((_QWORD *)P + 567) = 0LL;
  ...
  v22 = (_QWORD *)*((_QWORD *)P + 686);
  if ( v22 )
  {
    *v22 = 0LL;
    ExFreePoolWithTag(*((PVOID *)P + 686), 0);
    *((_QWORD *)P + 686) = 0LL;
  }
