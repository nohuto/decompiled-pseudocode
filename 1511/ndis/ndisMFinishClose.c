/*
 * XREFs of ndisMFinishClose @ 0x1C00E1498
 * Callers:
 ...
 *     ndisMCoFreeResources @ 0x1C00F3E04 (ndisMCoFreeResources.c)
 */
...
void __fastcall ndisMFinishClose(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_q(0xCu, &WPP_11d423e8e1961e492b47e90eefd811d6_Traceguids, a1);
  ndisReferenceMiniportNoCheck(v1, 0x30u);
  ...
  *(_QWORD *)(a1 + 368) = a1;
  ...
  ndisDereferenceMiniport(v1, 0x30u);
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_q(0xDu, &WPP_11d423e8e1961e492b47e90eefd811d6_Traceguids, a1);
}
