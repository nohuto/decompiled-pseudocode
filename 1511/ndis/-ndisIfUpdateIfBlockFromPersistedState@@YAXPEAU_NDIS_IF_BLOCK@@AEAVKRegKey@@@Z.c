/*
 * XREFs of ?ndisIfUpdateIfBlockFromPersistedState@@YAXPEAU_NDIS_IF_BLOCK@@AEAVKRegKey@@@Z @ 0x1C0013F54
 * Callers:
...
void __fastcall ndisIfUpdateIfBlockFromPersistedState(struct _NDIS_IF_BLOCK *a1, struct KRegKey *a2)
{
  ...
  *(_QWORD *)&P.Data1 = 0LL;
  ...
  if ( v10 >= 0
    && (int)ndisIfUpdateInterfaceIsolationNetworkId(a1, &v15, 0) < 0
    && (unsigned __int8)byte_1C008371D >= 3u )
  {
