/*
 * XREFs of ndisIovAllocateVF @ 0x1C00D2C68
 * Callers:
...
char __fastcall ndisIovAllocateVF(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x1Fu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3);
  ...
  *(_DWORD *)(*(_QWORD *)(a1 + 32) + 60LL) = 0;
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x20u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, *(_DWORD *)(a1 + 40));
  return v4;
}
