/*
 * XREFs of ndisPostSetOpenRSSParameters @ 0x1C0023660
 * Callers:
...
void __fastcall ndisPostSetOpenRSSParameters(_QWORD *a1, __int64 a2, int a3)
{
  ...
  {
    WPP_SF_qqd(158LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2, a3);
    a3 = v20;
  }
  v6 = 0;
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqqL(159LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, a1, a2, a3);
}
