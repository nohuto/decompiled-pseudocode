/*
 * XREFs of ?ndisPDDetachQueueFromEC@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z @ 0x1C00DA60C
 * Callers:
 ...
 *     ?NdisPDDetachQueueFromEC@@YAXPEAU_NDIS_PD_QUEUE@@@Z @ 0x1C00D8660 (-NdisPDDetachQueueFromEC@@YAXPEAU_NDIS_PD_QUEUE@@@Z.c)
