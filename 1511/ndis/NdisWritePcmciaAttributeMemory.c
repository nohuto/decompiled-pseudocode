/*
 * XREFs of NdisWritePcmciaAttributeMemory @ 0x1C005BE70
 * Callers:
 *     <none>
 * Callees:
...
ULONG __stdcall NdisWritePcmciaAttributeMemory(NDIS_HANDLE NdisAdapterHandle, ULONG Offset, PVOID Buffer, ULONG Length)
{
  ...
  if ( (unsigned __int8)byte_1C008370E >= 4u )
    WPP_SF_q(0x1Eu, &WPP_6d008e340352ce512a7732a5bb09c858_Traceguids, (__int64)NdisAdapterHandle);
  SetBusConfigSpace = ndisGetSetBusConfigSpace((_DWORD)NdisAdapterHandle, Offset, v5, Length, 1, 0);
  v9 = SetBusConfigSpace;
  if ( (unsigned __int8)byte_1C008370E >= 4u )
    WPP_SF_qD(0x1Fu, &WPP_6d008e340352ce512a7732a5bb09c858_Traceguids, (__int64)NdisAdapterHandle, SetBusConfigSpace);
  return v9;
}
