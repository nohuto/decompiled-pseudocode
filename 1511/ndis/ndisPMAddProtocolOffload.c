/*
 * XREFs of ndisPMAddProtocolOffload @ 0x1C00010F8
 * Callers:
 ...
 *     ndisGetPMProtocolOffloadSize @ 0x1C00ADF24 (ndisGetPMProtocolOffloadSize.c)
 *     ndisRemovePMLowestPriorityEntry @ 0x1C00C4A7C (ndisRemovePMLowestPriorityEntry.c)
 */
...
__int64 __fastcall ndisPMAddProtocolOffload(char *MiniportAdapterHandle, __int64 a2, PNDIS_OID_REQUEST Request)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(98LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, MiniportAdapterHandle, a2, Request);
  ...
  while ( 1 )
  {
    *(_DWORD *)&Request->NdisReserved[16] |= 0x2000000u;
    ...
    if ( !v7 )
    {
      ...
      *((_DWORD *)MiniportAdapterHandle + 464) = 2760019;
...
LABEL_22:
        v19 = SetMiniport;
LABEL_27:
        WPP_SF_d(v18, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v19);
        goto LABEL_7;
      }
      v7 = 1;
    }
  ...
  if ( SetMiniport && (unsigned __int8)byte_1C0083715 >= 2u )
  {
    v18 = 99LL;
    goto LABEL_22;
  }
...
LABEL_8:
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqqL(103LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, MiniportAdapterHandle, a2, Request, v9);
  return v9;
}
