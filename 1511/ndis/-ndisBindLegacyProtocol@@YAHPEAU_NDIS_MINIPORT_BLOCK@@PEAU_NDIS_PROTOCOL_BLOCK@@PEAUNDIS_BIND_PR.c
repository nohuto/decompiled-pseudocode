/*
 * XREFs of ?ndisBindLegacyProtocol@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_PROTOCOL_BLOCK@@PEAUNDIS_BIND_PROTOCOL_LINK@@@Z @ 0x1C00D7258
 * Callers:
 ...
 *     ndisUpdateMinimumStackVersion @ 0x1C00A5490 (ndisUpdateMinimumStackVersion.c)
 */
        ...
        struct NDIS_BIND_PROTOCOL_LINK *a3)
{
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_qq(0xAu, &WPP_6e95c490e51e9748073b6395c0120650_Traceguids, a1, a2);
    ...
    || PnPDeviceState == NdisPnPDeviceStopped )
  {
    if ( (unsigned __int8)byte_1C008370D >= 3u )
      WPP_SF_qq(0xBu, &WPP_6e95c490e51e9748073b6395c0120650_Traceguids, a1, a2);
  }
  else if ( a1->EthDB )
  {
    ...
    if ( ndisReferenceProtocol((__int64)a2, 7u) )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        if ( !a2->Ref.Closing )
        {
          ...
          {
            LODWORD(Timeout) = v18;
            WPP_SF_ZZL(0xCu, v16, (__int64 *)&a2->Name, (__int64 *)a1->pAdapterInstanceName, Timeout);
          }
        }
  ...
  {
    LODWORD(Timeout) = v32;
    WPP_SF_qqd(0xDu, &WPP_6e95c490e51e9748073b6395c0120650_Traceguids, a1, a2, Timeout);
  }
