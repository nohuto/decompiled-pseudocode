/*
 * XREFs of ?ndisSetupDeviceStart@@YAJPEAUNDIS_SETUP_DEVICE_EXTENSION@@PEAU_IRP@@@Z @ 0x1C00DC888
 * Callers:
...
int __fastcall ndisSetupDeviceStart(struct NDIS_SETUP_DEVICE_EXTENSION *a1, struct _IRP *a2)
{
  ...
  if ( v6 < 0 && (unsigned __int8)ndisWppEnabledLevelPerFlag >= 3u )
    WPP_SF_Zd(0xAu, &WPP_16c498e586029ff04e68784cec121b68_Traceguids, (__int64 *)&a1->SymbolicName, v6);
