/*
 * XREFs of ndisMInitializeScatterGatherDma @ 0x1C00A9E6C
 * Callers:
 *     NdisMRegisterScatterGatherDma @ 0x1C00A9D80 (NdisMRegisterScatterGatherDma.c)
 *     NdisMInitializeScatterGatherDma @ 0x1C00C63C0 (NdisMInitializeScatterGatherDma_ea_1C00C63C0.c)
 * Callees:
 *     NdisWriteErrorLogEntry @ 0x1C0016460 (NdisWriteErrorLogEntry.c)
 *     ndisAssignSGListLookasideList @ 0x1C0021AD0 (ndisAssignSGListLookasideList.c)
