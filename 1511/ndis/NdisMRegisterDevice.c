/*
 * XREFs of NdisMRegisterDevice @ 0x1C00EE0C0
 * Callers:
 *     <none>
 * Callees:
    ...
    *((_DWORD *)pDeviceObject + 12) &= ~0x80u;
    ...
    if ( Device >= 0 )
    {
      ...
      *(_QWORD *)&v14->DeviceLock.Header.Lock = &v14->SectorSize;
      ...
      v19 = v11 + 10;
      v20 = *v19;
      v14->DriverObject = *v19;
      v14->NextDevice = (_DEVICE_OBJECT *)v19;
      if ( (_DRIVER_OBJECT **)v20->DeviceObject != v19 )
        __fastfail(3u);
      v20->DeviceObject = (_DEVICE_OBJECT *)p_DriverObject;
      *v19 = (_DRIVER_OBJECT *)p_DriverObject;
