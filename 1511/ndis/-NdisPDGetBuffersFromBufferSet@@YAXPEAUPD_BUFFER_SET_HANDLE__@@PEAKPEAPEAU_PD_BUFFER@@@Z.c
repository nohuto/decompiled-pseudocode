/*
 * XREFs of ?NdisPDGetBuffersFromBufferSet@@YAXPEAUPD_BUFFER_SET_HANDLE__@@PEAKPEAPEAU_PD_BUFFER@@@Z @ 0x1C006B4F0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _PD_BUFFER **a3)
{
  ...
  *a3 = v10;
  if ( (unsigned __int8)byte_1C0083724 >= 4u )
    WPP_SF_qD(0x52u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, (__int64)a1, *a2);
}
