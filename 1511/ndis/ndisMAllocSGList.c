/*
 * XREFs of ndisMAllocSGList @ 0x1C0047730
 * Callers:
 ...
 *     ?NdisQueryPacket@@YAXPEAU_NDIS_PACKET@@PEAI1PEAPEAU_MDL@@1@Z @ 0x1C00470F0 (-NdisQueryPacket@@YAXPEAU_NDIS_PACKET@@PEAI1PEAPEAU_MDL@@1@Z.c)
...
LABEL_34:
    if ( (unsigned __int8)byte_1C008370A >= 2u )
      WPP_SF_d(0xEu, &WPP_e661d27027f753e153c509da19b80f2a_Traceguids, v19);
    if ( v18 )
      IoFreeMdl(v18);
    if ( v17 )
