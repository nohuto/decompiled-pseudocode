/*
 * XREFs of NdisMRestartComplete @ 0x1C0019690
 * Callers:
...
void __stdcall NdisMRestartComplete(NDIS_HANDLE MiniportAdapterHandle, NDIS_STATUS Status)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(146LL, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, MiniportAdapterHandle);
  ...
  *((_QWORD *)MiniportAdapterHandle + 283) = 0LL;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(147LL, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, MiniportAdapterHandle);
}
