/*
 * XREFs of ndisOidPMRemove @ 0x1C009361C
 * Callers:
...
__int64 __fastcall ndisOidPMRemove(char *MiniportAdapterHandle, __int64 a2, PNDIS_OID_REQUEST Request)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qD(0x4Bu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, (__int64)MiniportAdapterHandle, Oid);
  ...
  *(_DWORD *)&Request->NdisReserved[16] |= 0x2000000u;
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
  {
    ...
    WPP_SF_qdD(0x4Du, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, (__int64)MiniportAdapterHandle, Oid, v13);
  }
  return SetMiniport;
}
