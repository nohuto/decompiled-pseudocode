/*
 * XREFs of NdisRegisterProtocol @ 0x1C00C96E0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisRegisterProtocol(int *a1, __int64 *a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)byte_1C008370C >= 4u )
    WPP_SF_Z(0xEu, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, (__int64 *)(a3 + 88));
...
LABEL_8:
  *a1 = v4;
  ...
  {
    LODWORD(v16) = v4;
    WPP_SF_qZL(0xFu, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, v9, (__int64 *)(a3 + 88), v16);
  }
