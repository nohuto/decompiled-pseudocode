/*
 * XREFs of NdisQueryAdapterInstanceName @ 0x1C0055E60
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisQueryAdapterInstanceName(PNDIS_STRING pAdapterInstanceName, NDIS_HANDLE NdisBindingHandle)
{
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_q(0x32u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, (__int64)NdisBindingHandle);
...
LABEL_10:
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_qZL(0x33u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, (__int64)NdisBindingHandle, (__int64 *)v6, v5);
  return v5;
}
