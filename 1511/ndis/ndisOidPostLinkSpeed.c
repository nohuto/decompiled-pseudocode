/*
 * XREFs of ndisOidPostLinkSpeed @ 0x1C0043090
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostLinkSpeed(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(0x4Bu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, v1);
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(0x4Cu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, v1);
}
