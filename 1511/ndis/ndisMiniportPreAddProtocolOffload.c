/*
 * XREFs of ndisMiniportPreAddProtocolOffload @ 0x1C0093254
 * Callers:
...
__int64 __fastcall ndisMiniportPreAddProtocolOffload(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(0x5Du, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, a2);
  v8 = *(_DWORD **)(a2 + 40);
  *a3 = 1;
...
LABEL_34:
      ...
      if ( (unsigned __int8)byte_1C0083715 >= 2u )
        WPP_SF_d(0x5Eu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v18);
    }
    v3 = -1073676267;
  }
  else
...
LABEL_15:
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qdD(0x5Fu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, (unsigned __int8)*a3, v3);
  return v3;
}
