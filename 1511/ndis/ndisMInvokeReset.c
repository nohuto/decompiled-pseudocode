/*
 * XREFs of ndisMInvokeReset @ 0x1C0059DDC
 * Callers:
...
__int64 __fastcall ndisMInvokeReset(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083718 >= 4u )
    WPP_SF_q(0xDEu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1);
  v5 = (*(__int64 (__fastcall **)(_QWORD, __int64))(v2 + 216))(*(_QWORD *)(a1 + 24), a2);
  v6 = v5;
  if ( (unsigned __int8)byte_1C0083718 >= 4u )
    WPP_SF_qD(0xDFu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, v5);
  return v6;
}
