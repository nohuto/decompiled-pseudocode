/*
 * XREFs of ?ndisPcwMatchInstance@@YAEPEAU_NDIS_MINIPORT_BLOCK@@KPEBU_UNICODE_STRING@@@Z @ 0x1C00D2270
 * Callers:
        ...
        const struct _UNICODE_STRING *a3)
{
  ...
  *(_DWORD *)&v10.Length = 33685504;
  ...
  if ( ndisPcwGetInstanceName(a1, a2, &v10) >= 0 )
  {
    ...
    {
      v10.Length = 0;
      if ( ndisPcwGetInstanceName(a1, (const struct _UNICODE_STRING *)0xFFF, &v10) >= 0 )
      {
        if ( ndisWildCardStringMatch(a3, &v10, v8) )
          return 1;
        v10.Length = 0;
        if ( ndisPcwGetInstanceName(0LL, (const struct _UNICODE_STRING *)0xFFFFFFFELL, &v10) >= 0 )
        {
