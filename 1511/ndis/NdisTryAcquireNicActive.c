/*
 * XREFs of NdisTryAcquireNicActive @ 0x1C0010C70
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisTryAcquireNicActive(__int64 a1, enum _NDIS_PM_COMPONENT_ID a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_qD(40LL, &WPP_8e7c3e95f556d2aee27bc2d35efa6f2a_Traceguids, a1, (unsigned int)a2);
  ...
  if ( *(_QWORD *)(v2 + 4520) )
  {
    ...
    if ( (unsigned __int8)byte_1C0083715 >= 4u )
      WPP_SF_DDD(43LL, &WPP_8e7c3e95f556d2aee27bc2d35efa6f2a_Traceguids, v12, v3, v6);
    return v12;
  }
  else
  {
    if ( (unsigned __int8)v8 >= 3u )
      WPP_SF_(41LL, &WPP_8e7c3e95f556d2aee27bc2d35efa6f2a_Traceguids, v8);
    return 3221225659LL;
  }
}
