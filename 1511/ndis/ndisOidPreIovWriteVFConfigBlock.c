/*
 * XREFs of ndisOidPreIovWriteVFConfigBlock @ 0x1C00D51A0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovWriteVFConfigBlock(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x41u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v1);
    v4 = byte_1C0083721;
  }
  v5 = 1;
  if ( *(_DWORD *)(v1 + 4) != 1 )
...
LABEL_16:
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x42u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v5, v11);
  }
  return v5;
}
