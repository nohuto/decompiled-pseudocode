/*
 * XREFs of ndisMSetSriovAttributes @ 0x1C0099C80
 * Callers:
 ...
 *     ndisIovInitVf @ 0x1C00D3240 (ndisIovInitVf.c)
 */
...
__int64 __fastcall ndisMSetSriovAttributes(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_qq(0x7Eu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 48);
...
LABEL_22:
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_qqd(0x7Fu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, a2, LocallyUniqueId);
