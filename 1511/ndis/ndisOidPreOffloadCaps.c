/*
 * XREFs of ndisOidPreOffloadCaps @ 0x1C0043940
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreOffloadCaps(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0xD5u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v1, v4, v3);
  *((_DWORD *)a1 + 10) = -1073741637;
  ...
  if ( (*(_DWORD *)(v3 + 4) & 0xFFFFFFFD) == 0 )
  {
    if ( a1[2] )
    {
      ...
      *(_DWORD *)(*(_QWORD *)(v5 + 32) + 1856LL) = 2310377;
      v8 = *(_BYTE *)(v5 + 60);
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
  {
    v11 = *((_DWORD *)a1 + 10);
    LODWORD(v10) = v6;
    WPP_SF_qqDD(0xD6u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v1, v4, v10, v11);
  }
  return v6;
}
