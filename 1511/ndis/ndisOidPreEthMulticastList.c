/*
 * XREFs of ndisOidPreEthMulticastList @ 0x1C0096AC0
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisQueryOpenEthMulticastList @ 0x1C00C1968 (ndisQueryOpenEthMulticastList.c)
...
unsigned __int8 __fastcall ndisOidPreEthMulticastList(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqqq(0x7Au, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v5, v3, v1, a1);
  v6 = *(_DWORD *)(v1 + 4);
  if ( v6 == 2 )
  {
    if ( *(_QWORD *)a1 )
...
LABEL_10:
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
  {
    ...
    LODWORD(v11) = v4;
    WPP_SF_qqDD(0x7Bu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v5, v3, v11, v12);
  }
  return v4;
}
