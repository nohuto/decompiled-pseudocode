/*
 * XREFs of ndisPostRemoveMiniportWakeUpPattern @ 0x1C0046638
 * Callers:
...
void __fastcall ndisPostRemoveMiniportWakeUpPattern(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqd(39LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
    v6 = 0;
...
LABEL_31:
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqd(40LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, a2, a3);
}
