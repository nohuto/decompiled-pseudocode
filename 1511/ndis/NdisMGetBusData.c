/*
 * XREFs of NdisMGetBusData @ 0x1C0021A30
 * Callers:
        ...
        ULONG Length)
{
  ...
  if ( (unsigned __int8)byte_1C008370E >= 4u )
    WPP_SF_q(32LL, &WPP_6d008e340352ce512a7732a5bb09c858_Traceguids, NdisMiniportHandle);
  ...
  if ( (unsigned __int8)byte_1C008370E >= 4u )
    WPP_SF_qD(33LL, &WPP_6d008e340352ce512a7732a5bb09c858_Traceguids, NdisMiniportHandle, v9);
  return v9;
}
