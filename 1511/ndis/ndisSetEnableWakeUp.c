/*
 * XREFs of ndisSetEnableWakeUp @ 0x1C00C4DE4
 * Callers:
 *     ndisOidPreEnableWakeUp @ 0x1C00C32C0 (ndisOidPreEnableWakeUp.c)
 * Callees:
 *     WPP_SF_qqq @ 0x1C00384C4 (WPP_SF_qqq.c)
 *     WPP_SF_ @ 0x1C003EBD4 (WPP_SF_.c)
 *     Template_jqxtpp @ 0x1C00452AC (Template_jqxtpp.c)
 *     ndisXlateWakeUpEnableToPMParametersOid @ 0x1C0046FB0 (ndisXlateWakeUpEnableToPMParametersOid.c)
...
unsigned __int8 __fastcall ndisSetEnableWakeUp(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0xCu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v5, v1, v3);
  *(_DWORD *)(a1 + 40) = 0;
  if ( v3[12] < 4u )
  {
    v3[14] = 4;
...
LABEL_7:
  ...
  if ( *(_QWORD *)(a1 + 24) )
  {
    ...
    *(_DWORD *)(a1 + 40) = v7;
    ...
    {
      if ( (unsigned __int8)byte_1C0083712 >= 4u )
        WPP_SF_(0xDu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids);
  ...
  if ( *(_QWORD *)a1 )
  {
    ...
    else
    {
      ...
      *(_DWORD *)(a1 + 40) = v11;
      ...
      {
        if ( (unsigned __int8)byte_1C0083712 >= 4u )
          WPP_SF_qqq(0xEu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v5, v1, v3);
        if ( (Microsoft_Windows_NDISEnableBits & 0x10) != 0 )
          Template_jqxtpp(
            v13,
            v12,
...
LABEL_8:
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0xFu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v5, v1, v3);
  return v2;
}
