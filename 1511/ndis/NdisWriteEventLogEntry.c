/*
 * XREFs of NdisWriteEventLogEntry @ 0x1C0056190
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Data)
{
  ...
  {
    WPP_SF_qdD(0x2Eu, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, (__int64)LogHandle, EventCode, UniqueEventValue);
    v12 = LogHandle;
  }
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_(0x2Fu, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids);
  return v7;
}
