/*
 * XREFs of ndisIfCreateInterfaceForiScsi @ 0x1C00BF8C8
 * Callers:
        ...
        UINT32 *a5)
{
  ...
  *(_DWORD *)&ValueName.Length = 1703960;
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qq(0xCDu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, KeyHandle, a2);
  *a5 = -1;
  QueryTable.Flags = 16;
  Context = 0LL;
...
LABEL_20:
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qq(0xCEu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, KeyHandle, a2);
