/*
 * XREFs of ndisSriovInterfaceReadVfConfigBlock @ 0x1C00D5C00
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceReadVfConfigBlock(void *a1, __int16 a2, int a3, void *a4, unsigned int Size)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x5Bu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x5Cu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
