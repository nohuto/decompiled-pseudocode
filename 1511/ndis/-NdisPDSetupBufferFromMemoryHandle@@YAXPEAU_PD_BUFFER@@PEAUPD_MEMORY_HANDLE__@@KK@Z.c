/*
 * XREFs of ?NdisPDSetupBufferFromMemoryHandle@@YAXPEAU_PD_BUFFER@@PEAUPD_MEMORY_HANDLE__@@KK@Z @ 0x1C006B970
 * Callers:
 *     <none>
 * Callees:
        ...
        unsigned int a4)
{
  ...
  if ( (*(_BYTE *)(BugCheckParameter4 + 54) & 1) != 0
    || (v6 = *(_DWORD *)(BugCheckParameter3 + 32), a3 >= v6)
    || a4 > v6 - a3 )
  {
    ndisBugCheckEx(0x23uLL, 7uLL, BugCheckParameter3, BugCheckParameter4);
  }
  *(_QWORD *)(BugCheckParameter4 + 32) = a3 + *(_QWORD *)(BugCheckParameter3 + 48);
  v7 = a3 + *(_QWORD *)(BugCheckParameter3 + 40);
