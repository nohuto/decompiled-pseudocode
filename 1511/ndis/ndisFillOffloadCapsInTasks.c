/*
 * XREFs of ndisFillOffloadCapsInTasks @ 0x1C00419D0
 * Callers:
...
void __fastcall ndisFillOffloadCapsInTasks(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_q(0xCFu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1);
    v8 = byte_1C0083712;
  }
  v9 = *(_QWORD *)(a2 + 40);
  v10 = 28;
  ...
  *(_DWORD *)(a2 + 52) = v10;
  if ( (unsigned __int8)v8 >= 4u )
    WPP_SF_q(0xD0u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1);
}
