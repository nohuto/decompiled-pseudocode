/*
 * XREFs of ndisPostSetMiniportRSSParameters @ 0x1C0023808
 * Callers:
...
void __fastcall ndisPostSetMiniportRSSParameters(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqd(160LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2, a3);
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqd(161LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2, a3);
}
