/*
 * XREFs of ?ndisSetupDeviceRemove@@YAJPEAUNDIS_SETUP_DEVICE_EXTENSION@@PEAU_IRP@@@Z @ 0x1C00DC7E0
 * Callers:
...
__int64 __fastcall ndisSetupDeviceRemove(NDIS_SETUP_DEVICE_EXTENSION *this, PIRP Irp)
{
  ...
  IoAcquireRemoveLockEx(&this->RemoveLock, Irp, &byte_1C00AF320, 1u, 0x20u);
