/*
 * XREFs of ndisRemoveOpenWakeUpPattern @ 0x1C0046C84
 * Callers:
...
void __fastcall ndisRemoveOpenWakeUpPattern(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqd(37LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, a2, a3);
  if ( !a3 )
  {
    v6 = *(_DWORD **)(a1 + 496);
    v7 = 0LL;
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqd(38LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, a2, a3);
}
