/*
 * XREFs of ?NdisTraceLoggingRssConfiguration@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_CONFIGURATION_PARAMETER@@H@Z @ 0x1C0018548
 * Callers:
        ...
        struct _NDIS_CONFIGURATION_PARAMETER *a2)
{
  ...
  if ( (unsigned int)dword_1C0082040 > 5 && TlgKeywordOn(a1, 0x200000000000uLL) )
  {
    ...
    v14 = 4LL;
    v13 = &v6;
    TlgWrite(v2, &unk_1C0072EBA, v3, v4, 5u, &pData);
  }
}
