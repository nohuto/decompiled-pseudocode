/*
 * XREFs of ndisMDeferredSendSG @ 0x1C00501D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSendSG(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_q(0x28u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1);
...
LABEL_11:
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_q(0x29u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1);
  return 0;
}
