/*
 * XREFs of NdisRegisterDeviceEx @ 0x1C0022EC0
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisDeviceHandle)
{
  ...
  const GUID *v32; // [rsp+38h] [rbp-60h]
  KSPIN_LOCK *v33; // [rsp+50h] [rbp-48h]
  PDEVICE_OBJECT DeviceObject; // [rsp+A0h] [rbp+8h] BYREF
  PDEVICE_OBJECT *v35; // [rsp+B0h] [rbp+18h]
  PNDIS_HANDLE v36; // [rsp+B8h] [rbp+20h]

  v36 = NdisDeviceHandle;
  v35 = pDeviceObject;
  DriverObjectExtension = 0LL;
  v33 = 0LL;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(102LL, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, NdisHandle);
  *pDeviceObject = 0LL;
  ...
  else
  {
    switch ( v9 )
    {
      case 4:
        ...
        v33 = (KSPIN_LOCK *)NdisHandle;
        break;
      case 17:
        DriverObjectExtension = (char *)*((_QWORD *)NdisHandle + 477);
  ...
  if ( SymbolicLink >= 0 )
  {
    ...
    *((_WORD *)DeviceExtension + 145) = DeviceObjectAttributes->SymbolicName->Length + 2;
    ...
    if ( DriverObjectExtension )
    {
      ...
      v25 = (KSPIN_LOCK *)(DriverObjectExtension + 80);
      v26 = *v25;
      *v18 = *v25;
      DeviceExtension[2] = (KSPIN_LOCK)v25;
      if ( *(KSPIN_LOCK **)(v26 + 8) != v25 )
        __fastfail(3u);
      *(_QWORD *)(v26 + 8) = v18;
      v27 = v23;
      *v25 = (KSPIN_LOCK)v18;
    ...
    else
    {
      if ( !v33 )
        goto LABEL_17;
      DeviceExtension[3] = (KSPIN_LOCK)v33;
      v24 = KeAcquireSpinLockRaiseToDpc(v33 + 5);
      v29 = v33[7];
      *v18 = v29;
      DeviceExtension[2] = (KSPIN_LOCK)(v33 + 7);
      if ( *(KSPIN_LOCK **)(v29 + 8) != v33 + 7 )
        __fastfail(3u);
      *(_QWORD *)(v29 + 8) = v18;
      v27 = v33 + 5;
      v33[7] = (KSPIN_LOCK)v18;
    }
...
LABEL_18:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(103LL, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, NdisHandle, (unsigned int)SymbolicLink);
  return SymbolicLink;
}
