/*
 * XREFs of ndisSetupNoFilterHandlers @ 0x1C0019358
 * Callers:
...
__int64 __fastcall ndisSetupNoFilterHandlers(__int64 a1)
{
  ...
  {
    WPP_SF_q(65LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, a1);
    v2 = (unsigned __int8)ndisWppEnabledLevelPerFlag;
  }
  ...
  *(_QWORD *)(a1 + 2528) = v8;
  if ( v2 >= 4u )
    return WPP_SF_q(66LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, a1);
  return result;
}
