/*
 * XREFs of ndisOidPreIovReadVFConfigSpace @ 0x1C00D47F0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovReadVFConfigSpace(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x3Bu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v1);
    v4 = byte_1C0083721;
  }
  if ( *(_DWORD *)(v1 + 4) != 12 )
    goto LABEL_4;
...
LABEL_22:
  ...
  {
    v11 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x3Cu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v5, v11);
  }
  return v5;
}
