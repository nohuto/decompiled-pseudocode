/*
 * XREFs of ?UnbindOnAttach@BindRules@Ndis@@YAXPEAUBindStack@2@@Z @ 0x1C00A4010
 * Callers:
      ...
      if ( v3 )
      {
          ...
          && (unsigned __int8)byte_1C0083723 >= 4u )
        {
          ...
          if ( (unsigned __int8)byte_1C0083723 >= 4u )
          {
            v18 = 49;
LABEL_47:
            WPP_SF_Zq(v18, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v21, v20);
          }
        }
      }
      else
  ...
  for ( j = 0LL; (_DWORD)j != v12; j = (unsigned int)(j + 1) )
  {
    ...
    if ( v3 )
    {
        ...
        && (unsigned __int8)byte_1C0083723 >= 4u )
      {
        ...
        v19 = 52;
LABEL_49:
        WPP_SF_Zq(v19, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v21, v20);
        continue;
      }
    }
    else
