/*
 * XREFs of ndisHandleUModePnPOp @ 0x1C00936F0
 * Callers:
...
__int64 __fastcall ndisHandleUModePnPOp(__int64 a1)
{
  ...
  if ( v5 == 1 )
  {
    if ( (unsigned __int8)byte_1C0083714 >= 4u )
    {
      ...
      if ( *(_DWORD *)a1 != 1 )
        v9 = "TDI ";
      WPP_SF_sZZ(0x1Bu, v2, v9, (__int64 *)(a1 + 40), (unsigned __int16 *)(a1 + 24));
    }
...
LABEL_23:
  ...
  else if ( v5 == 2 )
  {
    if ( (unsigned __int8)byte_1C0083714 >= 4u )
    {
      ...
      if ( *(_DWORD *)a1 != 1 )
        v11 = "TDI ";
      WPP_SF_sZZ(0x1Cu, v2, v11, (__int64 *)(a1 + 40), (unsigned __int16 *)(a1 + 24));
    }
    if ( (Microsoft_Windows_NDISEnableBits & 0x100000000LL) != 0 )
    {
  ...
  if ( *(_DWORD *)a1 == 1 )
  {
    ...
    if ( v12 > 9 )
    {
      if ( v12 > 0xB )
      {
        if ( v12 == 14 )
        {
          v6 = ndisIfAliasChange((__int64 *)(a1 + 24), a1 + 40);
          goto LABEL_7;
        }
        if ( v12 != 15 )
          goto LABEL_10;
...
LABEL_38:
        v6 = ndisHandleProtocolReconfigNotification((PCUNICODE_STRING)(a1 + 24), (PCUNICODE_STRING)(a1 + 40), v12);
        goto LABEL_7;
      }
