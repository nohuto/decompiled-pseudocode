/*
 * XREFs of ndisPmInitializeMiniport @ 0x1C00EF3B0
 * Callers:
...
__int64 __fastcall ndisPmInitializeMiniport(struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_q(0x2Eu, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)a1);
  ...
  *(_QWORD *)&a1[2].LevelPlus1 = a1 + 2;
  ...
  if ( v13 )
  {
    ...
    if ( (unsigned __int8)byte_1C0083715 >= 2u )
      WPP_SF_qD(0x30u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)a1, v13);
  ...
  else
  {
    ...
    v25 = (unsigned __int8)ndisIfSetInterfaceState(a1, 0LL, v16);
    if ( ((__int64)a1[1].AnnotationFunc & 0x20000000) != 0 )
      ndisMSetIndicatePacketHandler((__int64)a1);
    if ( (unsigned __int8)byte_1C0083715 >= 4u )
      WPP_SF_q(0x31u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)a1);
    ...
    {
      WPP_SF_q(0x32u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)a1);
    }
...
LABEL_68:
  ...
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_qD(0x33u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)a1, v13);
  return v13;
}
