/*
 * XREFs of ndisOidPMAddRemove @ 0x1C000B4D0
 * Callers:
...
__int64 __fastcall ndisOidPMAddRemove(char *MiniportAdapterHandle, __int64 a2, PNDIS_OID_REQUEST Request)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(63LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, MiniportAdapterHandle, a2, Request);
  if ( !KeGetCurrentIrql() )
  {
    ...
    switch ( Oid )
    {
      case 0xFD01010A:
        ...
        v8 = v7;
        if ( !v7 || (unsigned __int8)byte_1C0083715 < 2u )
          goto LABEL_6;
        v11 = 65LL;
        break;
      case 0xFD01010D:
    ...
    WPP_SF_d(v11, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v7);
LABEL_6:
    if ( (unsigned __int8)byte_1C0083712 >= 4u )
      WPP_SF_qqqL(68LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, MiniportAdapterHandle, a2, Request, v8);
    return v8;
  }
  ...
  if ( v10 )
  {
    if ( (unsigned __int8)byte_1C0083715 >= 2u )
      WPP_SF_dd(64LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, Request->DATA.QUERY_INFORMATION.Oid, v10);
    return v8;
  }
  return 259LL;
}
