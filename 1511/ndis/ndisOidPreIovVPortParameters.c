/*
 * XREFs of ndisOidPreIovVPortParameters @ 0x1C00D4D20
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovVPortParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x37u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v1, v3);
    v7 = byte_1C0083721;
  }
  v8 = *(_DWORD *)(v3 + 4);
  ...
  *(_DWORD *)(a1 + 40) = 0;
  ...
  if ( v1 )
  {
    ...
    {
      v12 = *(_QWORD *)(v1 + 4672);
      if ( !v12 || !*(_QWORD *)(v1 + 3616) || (*(_BYTE *)(v12 + 8) & 3) != 3 )
        goto LABEL_5;
    }
    v13 = *(_DWORD *)(v3 + 4);
    if ( (v13 & v10) != 0 )
...
LABEL_51:
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qqDD(0x38u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v1, v4, v2, *(_DWORD *)(a1 + 40));
  return v2;
}
