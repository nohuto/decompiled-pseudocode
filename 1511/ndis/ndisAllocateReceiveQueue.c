/*
 * XREFs of ndisAllocateReceiveQueue @ 0x1C0038570
 * Callers:
 *     ndisOidPreRcvFilterAllocateQueue @ 0x1C00BE5E0 (ndisOidPreRcvFilterAllocateQueue.c)
 * Callees:
 ...
 *     ndisAddReceiveQueueToList @ 0x1C0038510 (ndisAddReceiveQueueToList.c)
...
char __fastcall ndisAllocateReceiveQueue(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083720 >= 4u )
    WPP_SF_q(0xEu, &WPP_5bdf5f30a197d5f3fc0ac0df652068c7_Traceguids, v4);
  v8 = 1096;
...
LABEL_61:
  ...
  {
    if ( v12 )
      ndisMDereferenceOpenUnlocked(v38, 0xAu);
    if ( v13 )
  ...
  if ( (unsigned __int8)byte_1C0083720 >= 4u )
    WPP_SF_qdD(15LL, &WPP_5bdf5f30a197d5f3fc0ac0df652068c7_Traceguids, v4, *(unsigned int *)(a1 + 40), v42);
  return v7;
}
