/*
 * XREFs of ?NdisTraceLoggingComfirmIdleNotification@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_DEVICE_POWER_STATE@@J@Z @ 0x1C006D780
 * Callers:
        ...
        enum _NDIS_DEVICE_POWER_STATE a2)
{
  ...
  if ( (unsigned int)dword_1C0082040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v6 = (int)v4;
      v14 = 4LL;
      TlgWrite(v2, &unk_1C00732A5, v3, v4, 5u, &pData);
    }
  }
}
