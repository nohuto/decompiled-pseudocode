/*
 * XREFs of ndisOidPreIovEnumVPorts @ 0x1C0065770
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumVPorts(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qq(0x35u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, a1, v1);
  *(_DWORD *)(v2 + 60) = 0;
  v9 = (_DWORD *)v7[4];
  if ( v9[1] == 12 )
  {
...
LABEL_72:
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x36u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v1, *((_DWORD *)v7 + 10));
  return v8;
}
