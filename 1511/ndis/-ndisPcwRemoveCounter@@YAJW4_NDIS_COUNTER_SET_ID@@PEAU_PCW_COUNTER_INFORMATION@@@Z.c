/*
 * XREFs of ?ndisPcwRemoveCounter@@YAJW4_NDIS_COUNTER_SET_ID@@PEAU_PCW_COUNTER_INFORMATION@@@Z @ 0x1C00D24F4
 * Callers:
...
__int64 __fastcall ndisPcwRemoveCounter(int a1, __int64 a2)
{
  ...
  v4 = 0LL;
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v10, &ndisPcwMutex);
