/*
 * XREFs of ndisPostSetRemoveWakeUpPattern @ 0x1C00469E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisPostSetRemoveWakeUpPattern(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0x29u, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v1, v4, v3);
  if ( *(_DWORD *)(a1 + 40) )
  {
    v7 = *(_QWORD **)(v3 + 144);
    if ( v7 )
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0x2Au, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v1, v4, v3);
}
