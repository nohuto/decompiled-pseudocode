/*
 * XREFs of ndisMOpenAdapter @ 0x1C00E340C
 * Callers:
 ...
 *     ethAllocateOpenMulticastBuffer @ 0x1C001A030 (ethAllocateOpenMulticastBuffer.c)
...
void __fastcall ndisMOpenAdapter(_DWORD *a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_qqq(0x25u, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, v3, a3, a2);
...
LABEL_13:
  ...
  *(_QWORD *)(a2 + 568) = *(_QWORD *)(a2 + 296);
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_qq(0x68u, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a3, a2);
  v14 = *(unsigned int *)(a3 + 1520);
  if ( (((_DWORD)v14 - 1) & 0xFFFFFFFC) != 0 || (_DWORD)v14 == 3 )
  {
    if ( (unsigned __int8)byte_1C008370D >= 4u )
      WPP_SF_qq(0x69u, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a3, a2);
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
  {
    ...
    WPP_SF_qqd(0x6Au, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a3, a2, v22);
  }
  if ( !(_BYTE)v6 )
  {
    *a1 = -1073676281;
  ...
  v7 = 1;
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_qq(0x2Au, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, a2, v3);
  ...
  {
    LODWORD(v22) = v16;
    WPP_SF_qqd(0x2Bu, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, a2, v3, v22);
  }
  if ( !v16 )
  {
    v4 = 0;
...
LABEL_41:
  ...
  {
    LODWORD(v23) = *a1;
    WPP_SF_qqqL(0x27u, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, v3, a3, a2, v23);
  }
}
