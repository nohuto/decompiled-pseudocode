/*
 * XREFs of ?ndisMSetPacketDirectAttributes@@YAHPEAXPEBT_NDIS_MINIPORT_ADAPTER_ATTRIBUTES@@@Z @ 0x1C00DA378
 * Callers:
...
__int64 __fastcall ndisMSetPacketDirectAttributes(_QWORD *a1, const union _NDIS_MINIPORT_ADAPTER_ATTRIBUTES *a2)
{
  ...
  v2 = (struct _NDIS_PD_BLOCK *)a1[686];
  v3 = a1;
  if ( !v2 )
  {
    v4 = -1073741637;
    ...
    if ( v2->PDEnabledRegistryValue )
    {
      ...
      if ( v4 == -1073740007 )
      {
        ...
        if ( (unsigned __int8)byte_1C0083724 >= 2u )
          WPP_SF_qD(0x10u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, (__int64)v3, PDDomainId);
        v2->PDDomainId = 0;
...
LABEL_3:
    if ( (unsigned __int8)byte_1C0083724 >= 2u )
      WPP_SF_qD(0x12u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, (__int64)v3, v4);
