/*
 * XREFs of NdisMAllocateSharedMemory @ 0x1C00AABE0
 * Callers:
        ...
        PNDIS_PHYSICAL_ADDRESS PhysicalAddress)
{
  ...
  {
    WPP_SF_qD(0x1Cu, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)MiniportAdapterHandle, Length);
    v9 = byte_1C008371C;
    Cached = v19;
  }
...
LABEL_14:
        ...
        if ( (unsigned __int8)byte_1C008371C >= 4u )
          WPP_SF_qLq(0x1Fu, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)MiniportAdapterHandle, v12);
        return;
      }
      *(_DWORD *)(v16 + 4092) = 0;
  ...
  *VirtualAddress = 0LL;
  if ( (unsigned __int8)v9 >= 4u )
    WPP_SF_qD(0x1Du, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)MiniportAdapterHandle, v7);
}
