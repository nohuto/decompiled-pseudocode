/*
 * XREFs of NdisCmActivateVc @ 0x1C00F07A0
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisCmActivateVc(NDIS_HANDLE NdisVcHandle, PCO_CALL_PARAMETERS CallParameters)
{
  ...
  if ( (unsigned __int8)byte_1C008371A >= 4u )
    WPP_SF_qqq(
      0x22u,
      &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids,
      NdisVcHandle,
      v2,
  ...
  if ( (unsigned __int8)byte_1C008371A >= 4u )
    WPP_SF_qD(0x23u, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids, (__int64)NdisVcHandle, v9);
  return v9;
}
