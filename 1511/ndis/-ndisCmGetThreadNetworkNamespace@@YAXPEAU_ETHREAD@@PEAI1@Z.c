/*
 * XREFs of ?ndisCmGetThreadNetworkNamespace@@YAXPEAU_ETHREAD@@PEAI1@Z @ 0x1C000F778
 * Callers:
 *     ndisNsiGetAllThreadInformation @ 0x1C0096740 (ndisNsiGetAllThreadInformation.c)
 * Callees:
 *     ?ndisCmGetThreadSessionId@@YAKPEAU_ETHREAD@@@Z @ 0x1C0060DC0 (-ndisCmGetThreadSessionId@@YAKPEAU_ETHREAD@@@Z.c)
 */

void __fastcall ndisCmGetThreadNetworkNamespace(PETHREAD Thread, unsigned int *a2, unsigned int *a3)
{
