/*
 * XREFs of ?ndisDoPeriodicReceivesIndication@@YAKPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NET_BUFFER_LIST@@@Z @ 0x1C0001380
 * Callers:
...
LABEL_21:
          ...
          else
          {
            ...
            *((_DWORD *)v15 + 10) = v6;
            *((_DWORD *)v15 + 11) = v8;
            ndisSortNetBufferLists(v15, v18, 0LL);
            v21 = 0LL;
            if ( *((_QWORD *)v15 + 8) || *((_DWORD *)v15 + 172) )
            {
              ...
              {
                ndisIndicateXlatedPacketsToNdis5Protocols(v15);
                v21 = 0LL;
              }
              if ( !SingleActiveOpen )
              {
                ...
                if ( EthDB->FTypeOpenList )
                {
                  ...
                  {
                    ndisIndicateToPmodeOpens(v15, v20, 0LL);
                    v21 = 0LL;
                  }
                  v32 = 1;
                  if ( v31 )
                  {
                    do
                    {
                      ...
                      ndisMIndicateNetBufferListsToOpen(
                        ...
                        *(_QWORD *)&v15[40 * v33 + 64],
                        v30,
                        *(unsigned int *)&v15[40 * v33 + 80],
                        v29);
                    }
                    while ( v32 <= v31 );
                    v21 = 0LL;
      ...
      {
        WPP_SF_(10LL, &WPP_abea78df5d3bc502c1918c83347dcce9_Traceguids, 0LL);
        v21 = 0LL;
      }
LABEL_52:
      if ( !v5 )
      ...
      if ( Microsoft_Windows_Networking_CorrelationEnabled )
        ndisMarkNetBufferListCorrelationIdsAsUsed(v5, v20, 0LL);
...
LABEL_95:
      ...
      if ( ndisNblTrackerMode != (_DWORD)v21 )
      {
...
LABEL_82:
      ...
      if ( v4->Header.Type == 5 )
      {
        ...
        v69 = (int)v21;
        v71 = 1;
        if ( (int)ndisExpandStack(ndisDataPathExpandStackCallback, v64) < 0 )
