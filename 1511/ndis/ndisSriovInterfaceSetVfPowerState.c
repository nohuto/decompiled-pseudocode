/*
 * XREFs of ndisSriovInterfaceSetVfPowerState @ 0x1C00D5ED0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceSetVfPowerState(void *a1, __int16 a2, int a3, char a4)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x65u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1);
  *(_DWORD *)v12 = 1048960;
  *(_WORD *)&v12[4] = a2;
  *(_DWORD *)&v12[8] = a3;
  v12[12] = a4;
  ...
  *(_DWORD *)&v11[48] = 16;
  ...
  v9 = SetMiniport;
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x66u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1, SetMiniport);
  return v9;
}
