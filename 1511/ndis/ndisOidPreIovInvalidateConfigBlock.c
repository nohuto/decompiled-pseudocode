/*
 * XREFs of ndisOidPreIovInvalidateConfigBlock @ 0x1C00D4190
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovInvalidateConfigBlock(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qqqq(0x15u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, *a1, a1[3], a1[1], a1[4]);
  ...
  if ( v3 >= 4u )
  {
    v6 = *((_DWORD *)a1 + 10);
    LODWORD(v5) = v2;
    WPP_SF_qqqDD(0x16u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, *a1, a1[3], a1[1], v5, v6);
  }
  return v2;
}
