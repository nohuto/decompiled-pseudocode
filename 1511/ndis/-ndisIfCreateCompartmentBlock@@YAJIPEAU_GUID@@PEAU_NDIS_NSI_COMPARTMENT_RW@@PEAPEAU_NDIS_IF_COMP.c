/*
 * XREFs of ?ndisIfCreateCompartmentBlock@@YAJIPEAU_GUID@@PEAU_NDIS_NSI_COMPARTMENT_RW@@PEAPEAU_NDIS_IF_COMPARTMENT_BLOCK@@@Z @ 0x1C00206B4
 * Callers:
 ...
 *     ?ndisIfFindAvailableCompartmentId@@YAIPEBU_GUID@@@Z @ 0x1C003C6DC (-ndisIfFindAvailableCompartmentId@@YAIPEBU_GUID@@@Z.c)
        ...
        struct _NDIS_IF_COMPARTMENT_BLOCK **a4)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_dq(122LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a3);
  *a4 = 0LL;
  PoolWithTag = (char *)ExAllocatePoolWithTag(NonPagedPoolNx, 0x6B0uLL, 0x6669444Eu);
  v11 = PoolWithTag;
  if ( !PoolWithTag )
  {
    v5 = -1073741670;
