/*
 * XREFs of ?ndisBindEnumerateProtocolDrivers@@YAXP6AXPEAXV?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@@Z0@Z @ 0x1C00A5984
 * Callers:
 *     ?ndisVBusNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z @ 0x1C0099ED0 (-ndisVBusNmrClientAttachProvider@@YAJPEAX0PEBU_NPI_REGISTRATION_INSTANCE@@@Z.c)
 ...
 *     ?ndisVBusDetachComplete@@YAXPEAX@Z @ 0x1C00D7760 (-ndisVBusDetachComplete@@YAXPEAX@Z.c)
 * Callees:
 ...
 *     ??_GKRefHolder@?$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@QEAAPEAXI@Z @ 0x1C00C94FC (--_GKRefHolder@-$KRef@UNDIS_BIND_PROTOCOL_DRIVER@@@@QEAAPEAXI@Z.c)
 */
        ...
        __int64 a2)
{
  ...
  KLockThisShared::KLockThisShared((KLockThisShared *)&v7, (struct KPushLockBase *)(qword_1C00837F0 + 8));
  v4 = qword_1C00837F0;
  for ( i = 0LL; i < *(unsigned int *)(v4 + 64); ++i )
  {
    ...
    v4 = qword_1C00837F0;
    v7.m_State = Shared;
    if ( *(unsigned int *)(qword_1C00837F0 + 64) < i )
      goto LABEL_16;
    if ( i >= *(unsigned int *)(qword_1C00837F0 + 64) )
      __fastfail(0xBAD0FFu);
    if ( (*(_QWORD *)(*(_QWORD *)(qword_1C00837F0 + 72) + 8 * i) != 0LL) != (v6 != 0LL) )
LABEL_16:
      i = 0LL;
    if ( v6 )
    {
