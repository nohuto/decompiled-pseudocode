/*
 * XREFs of ndisGetOrCreateFilterInstanceKey @ 0x1C00C87F0
 * Callers:
        ...
        PUNICODE_STRING Destination)
{
  ...
  unsigned int v38; // [rsp+8Ch] [rbp-74h]
  ...
  UNICODE_STRING Sourcea; // [rsp+C8h] [rbp-38h] BYREF
  ...
  *(_DWORD *)&Sourcea.Length = 262146;
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qqq(0x61u, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, Source, a3, a2);
  if ( !*(_QWORD *)(v7 + 16) )
  {
    v8 = -1073741811;
    goto LABEL_20;
...
LABEL_40:
  ...
  for ( i = 0; i <= 0x270F; ++i )
  {
    ...
    v37 = 0;
    v17 = ZwEnumerateKey(KeyHandle, i, KeyBasicInformation, v10, 0x216u, &v37);
    if ( v17 == -2147483622 )
      break;
    if ( v17 )
      goto LABEL_61;
    ...
    v22 = RegistryValues;
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
      WPP_SF_dd(0x62u, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, RegistryValues, v32);
    if ( v22 )
      goto LABEL_61;
...
LABEL_24:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
  {
    ...
    WPP_SF_qqqL(0x63u, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, v6, v7, v41, ResultLength);
  }
  return v8;
}
