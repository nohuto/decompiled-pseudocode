/*
 * XREFs of ?ndisCoIndicatePromiscPacket@@YAXPEAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OPEN_BLOCK@@PEAU_NDIS_PACKET@@EE@Z @ 0x1C004D3C8
 * Callers:
    ...
    do
    {
      ...
      if ( (v8->OpenFlags & 4) != 0 )
      {
        ...
        else
        {
          ...
          {
            WPP_SF_(0xAu, &WPP_8f35a3663126a6381ade30b0d8399dbd_Traceguids);
          }
        }
      }
      v8 = FilterNextOpen;
