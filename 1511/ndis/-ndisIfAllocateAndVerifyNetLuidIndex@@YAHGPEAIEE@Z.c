/*
 * XREFs of ?ndisIfAllocateAndVerifyNetLuidIndex@@YAHGPEAIEE@Z @ 0x1C009E688
 * Callers:
...
LABEL_5:
    ...
    ndisUsedIndicesMutexOwner = 2231127;
...
LABEL_12:
  ...
  if ( (unsigned __int8)v11 >= 3u )
    WPP_SF_d(0x24u, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, v5);
  return 3221226224LL;
}
