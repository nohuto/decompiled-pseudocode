/*
 * XREFs of ndisOidPreIovVFParameters @ 0x1C00D4B40
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovVFParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x27u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v1);
    v4 = byte_1C0083721;
  }
  v5 = 12LL;
  if ( *(_DWORD *)(v1 + 4) != 12 )
...
LABEL_20:
  if ( (unsigned __int8)v4 >= 4u )
    WPP_SF_qdD(0x28u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v6, *(_DWORD *)(a1 + 40));
  return v6;
}
