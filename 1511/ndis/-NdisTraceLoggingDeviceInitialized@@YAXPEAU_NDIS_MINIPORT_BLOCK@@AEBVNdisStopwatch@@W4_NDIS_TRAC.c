/*
 * XREFs of ?NdisTraceLoggingDeviceInitialized@@YAXPEAU_NDIS_MINIPORT_BLOCK@@AEBVNdisStopwatch@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@H@Z @ 0x1C0018314
 * Callers:
 ...
 *     ?GetElapsedTimeInMilliseconds@NdisStopwatch@@QEBA_JXZ @ 0x1C0018700 (-GetElapsedTimeInMilliseconds@NdisStopwatch@@QEBA_JXZ.c)
...
void __fastcall NdisTraceLoggingDeviceInitialized(const struct _TlgProvider_t *a1, __int64 a2, int a3, int a4)
{
  ...
  if ( a4 )
  {
    if ( (unsigned int)dword_1C0082040 > 5 && TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v19 = 4;
      v22 = 16;
      TlgWrite((TraceLoggingHProvider)4, &unk_1C007301E, v9, v10, 5u, &pData);
    }
  }
  else if ( (unsigned int)dword_1C0082040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v16 = 4;
      v19 = 16;
      TlgWrite((TraceLoggingHProvider)4, &unk_1C00731BA, v7, v8, 4u, &pData);
    }
  }
}
