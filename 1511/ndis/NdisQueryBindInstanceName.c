/*
 * XREFs of NdisQueryBindInstanceName @ 0x1C0055F70
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisQueryBindInstanceName(PNDIS_STRING pAdapterInstanceName, NDIS_HANDLE BindingContext)
{
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_q(0x30u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, (__int64)BindingContext);
...
LABEL_10:
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_qqd(0x31u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, BindingContext, v5, v4);
  return v4;
}
