/*
 * XREFs of NdisEnumerateFilterModules @ 0x1C0052790
 * Callers:
 *     <none>
 * Callees:
        ...
        PULONG BytesWritten)
{
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_q(0x29u, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, (__int64)NdisHandle);
  switch ( *(_BYTE *)v5 )
  {
    case 5:
      v7 = (_QWORD *)v5[4];
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_qD(0x2Au, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, (__int64)v5, v9);
  return v9;
}
