/*
 * XREFs of ndisReleaseReadWriteLockX @ 0x1C0055964
 * Callers:
 *     NdisDprReleaseReadWriteLock @ 0x1C0055030 (NdisDprReleaseReadWriteLock.c)
 * Callees:
 *     ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C0054ED4 (-ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z.c)
 */
