/*
 * XREFs of ndisGetPortList @ 0x1C001E120
 * Callers:
...
__int64 __fastcall ndisGetPortList(__int64 a1, _QWORD *a2)
{
  ...
  if ( (unsigned __int8)byte_1C008371E >= 4u )
    WPP_SF_q(36LL, &WPP_19165d00fb3b32ae989335dc29d87a5c_Traceguids, a1);
  *a2 = 0LL;
  NewIrql = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 96));
  v5 = *(_DWORD *)(a1 + 2792) + 1;
  *(_QWORD *)(a1 + 520) = KeGetCurrentThread();
  *(_DWORD *)(a1 + 1856) = 2360578;
  ...
  if ( PoolWithTag )
  {
    ...
    *((_QWORD *)v7 + 8) = *(_QWORD *)(a1 + 800);
    v7[18] = *(_DWORD *)(*(_QWORD *)(a1 + 4096) + 532LL);
    v11 = v7;
    v7[19] = *(_DWORD *)(a1 + 3368);
    v7[20] = *(_DWORD *)(a1 + 3372);
    v7[21] = *(_DWORD *)(a1 + 3376);
    v7[22] = *(_DWORD *)(a1 + 3380);
    while ( v8 != (__int64 *)(a1 + 2760) && v10 < v5 )
    {
      if ( *((_DWORD *)v8 + 4) == 4 )
      {
        v11 = v9;
  ...
  *(_DWORD *)(a1 + 1856) = 0;
  ...
  if ( !v4 )
    *a2 = v7;
  if ( (unsigned __int8)byte_1C008371E >= 4u )
    WPP_SF_qD(37LL, &WPP_19165d00fb3b32ae989335dc29d87a5c_Traceguids, a1, v4);
  return v4;
}
