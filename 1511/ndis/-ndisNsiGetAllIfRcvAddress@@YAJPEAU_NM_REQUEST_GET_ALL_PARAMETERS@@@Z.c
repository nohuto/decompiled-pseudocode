/*
 * XREFs of ?ndisNsiGetAllIfRcvAddress@@YAJPEAU_NM_REQUEST_GET_ALL_PARAMETERS@@@Z @ 0x1C003D550
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiGetAllIfRcvAddress(struct _NM_REQUEST_GET_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_q(0x5Eu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, (__int64)a1);
...
LABEL_41:
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qD(0x5Fu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, (__int64)a1, IfRcvAddressRodInformation);
