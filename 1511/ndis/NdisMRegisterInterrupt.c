/*
 * XREFs of NdisMRegisterInterrupt @ 0x1C00CD670
 * Callers:
 *     <none>
 * Callees:
        ...
        NDIS_INTERRUPT_MODE InterruptMode)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0xCu, &WPP_34eaeff8600c26a691447e424419d251_Traceguids, (__int64)MiniportAdapterHandle, InterruptLevel);
  ...
  *((_DWORD *)MiniportAdapterHandle + 30) &= ~0x20u;
  ...
  if ( v11 )
  {
    if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 2u )
      WPP_SF_qD(0xDu, &WPP_34eaeff8600c26a691447e424419d251_Traceguids, (__int64)MiniportAdapterHandle, v7);
  ...
  if ( v26 )
  {
    ...
    *(_WORD *)&Parameters.MessageBased.SynchronizeIrql = v8;
    ...
    if ( v19 < 0 )
    {
      v11 = -1073741823;
      if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
        WPP_SF_dd(0xEu, &WPP_34eaeff8600c26a691447e424419d251_Traceguids, v8, v16);
      if ( (Microsoft_Windows_NDISEnableBits & 0x100) != 0 )
        Template_jqxqqq(
          v20,
          &RegisterInterruptFailed,
...
LABEL_23:
  ...
  {
    LODWORD(v23) = v11;
    WPP_SF_qdD(0xFu, &WPP_34eaeff8600c26a691447e424419d251_Traceguids, (__int64)MiniportAdapterHandle, v8, v23);
  }
  return v11;
}
