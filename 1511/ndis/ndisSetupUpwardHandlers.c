/*
 * XREFs of ndisSetupUpwardHandlers @ 0x1C001A128
 * Callers:
...
__int64 (__fastcall *__fastcall ndisSetupUpwardHandlers(__int64 a1))(ULONG_PTR BugCheckParameter2)
{
  ...
  {
    WPP_SF_q(69LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, a1);
    v5 = (unsigned __int8)ndisWppEnabledLevelPerFlag;
  }
...
LABEL_24:
  if ( v5 >= 4u )
    return (__int64 (__fastcall *)(ULONG_PTR))WPP_SF_q(70LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, a1);
  return result;
}
