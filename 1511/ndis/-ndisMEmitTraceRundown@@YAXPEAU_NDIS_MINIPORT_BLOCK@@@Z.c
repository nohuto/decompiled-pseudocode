/*
 * XREFs of ?ndisMEmitTraceRundown@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0049AB4
 * Callers:
...
void __fastcall ndisMEmitTraceRundown(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( byte_1C0083709 )
  {
    WPP_SF_qqZ(91LL, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, a1, a1->DriverHandle, a1->pAdapterInstanceName);
    if ( byte_1C0083709 )
    {
      WPP_SF_DDDDD(
        a1->DriverHandle,
        ...
        *((unsigned __int16 *)&a1->NetLuid.Info + 3),
        (a1->NetLuid.Value >> 24) & 0xFFFFFF);
      if ( byte_1C0083709 )
        WPP_SF_dd(0x5Du, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, a1->State, a1->PnPDeviceState);
    }
  }
  if ( a1->AoAc )
  ...
  {
    if ( byte_1C0083709 )
      WPP_SF_(0x5Eu, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids);
  }
  else
  {
    if ( byte_1C0083709 )
      WPP_SF_(0x5Fu, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids);
    for ( i = a1->LowestFilter; i; i = i->HigherFilter )
    {
      if ( byte_1C0083709 )
        WPP_SF_qqZ(96LL, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, i, i->FilterDriver, i->FilterFriendlyName);
    }
  }
  if ( a1->OpenQueue )
  {
    if ( byte_1C0083709 )
      WPP_SF_(0x62u, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids);
  ...
  {
    WPP_SF_(0x61u, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids);
  }
