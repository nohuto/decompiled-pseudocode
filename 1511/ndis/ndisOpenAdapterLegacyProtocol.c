/*
 * XREFs of ndisOpenAdapterLegacyProtocol @ 0x1C00568B4
 * Callers:
 ...
 *     NdisOpenAdapter @ 0x1C00ED6C0 (NdisOpenAdapter.c)
 * Callees:
...
LABEL_18:
          ...
          else
          {
            *a4 = v27;
            ...
            else
            {
              ...
              *(_DWORD *)(BindingAdapter + 1856) = 984279;
              LODWORD(v32) = *v32;
              ...
              if ( ((unsigned int)v32 & 0x40000) == 0 )
              {
                ...
                *v34 = 1;
                v33 = v54;
                *(_DWORD *)(BindingAdapter + 1860) = 984286;
                BindingAdapter = v48;
              ...
              {
                if ( (unsigned __int8)byte_1C008370D >= 4u )
                  WPP_SF_qqq(0x17u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, OpenBlock, v17, BindingAdapter);
                if ( v61 )
                {
                ...
                if ( (*v50 & 0x20000) != 0 && OpenBlock->ProtocolHandle->CoAfRegisterNotifyHandler )
                {
                  ...
                  {
                    WPP_SF_q(0x18u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, (__int64)OpenBlock);
                  }
                }
              }
              if ( (*v50 & 0x40000) == 0 )
  ...
  if ( DynamicBinding )
  {
      ...
      && (unsigned __int8)byte_1C0083723 >= 4u )
    {
      ...
      WPP_SF_Zq(0x16u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, (__int64 *)v58[1], v58[0]);
    }
  }
  else
  {
...
LABEL_84:
  ...
  {
    LODWORD(v46) = *a1;
    WPP_SF_qqqL(0x19u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, v17, BindingAdapter, OpenBlock, v46);
  }
}
