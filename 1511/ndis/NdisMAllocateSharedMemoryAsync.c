/*
 * XREFs of NdisMAllocateSharedMemoryAsync @ 0x1C005B3E0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID Context)
{
  ...
  if ( (unsigned __int8)byte_1C008371C >= 4u )
    WPP_SF_qD(0x20u, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)MiniportAdapterHandle, Length);
...
LABEL_13:
  if ( (unsigned __int8)byte_1C008371C >= 4u )
    WPP_SF_d(0x21u, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, v9);
  return v9;
}
