/*
 * XREFs of NdisMCmCreateVc @ 0x1C00F2B40
 * Callers:
 *     <none>
 * Callees:
        ...
        PNDIS_HANDLE NdisVcHandle)
{
  ...
  *NdisVcHandle = 0LL;
  ...
  p_Blink = &v12[1].Blink;
  v19 = (*(__int64 (__fastcall **)(_QWORD, _LIST_ENTRY *, _LIST_ENTRY **))(*((_QWORD *)NdisAfHandle + 46) + 1032LL))(
  ...
  v12[6].Blink = *p_Blink;
  v12[6].Flink = *(_LIST_ENTRY **)(*((_QWORD *)NdisAfHandle + 46) + 1040LL);
  ExInterlockedInsertHeadList(
    (PLIST_ENTRY)(*((_QWORD *)NdisAfHandle + 46) + 1096LL),
    v12 + 2,
  ...
  if ( *(_BYTE *)(*(_QWORD *)(*((_QWORD *)NdisAfHandle + 46) + 24LL) + 56LL) < 6u )
  {
    if ( LOBYTE(v12[12].Flink[2].Flink) >= 6u )
    {
      if ( (unsigned __int8)byte_1C008371A >= 4u )
        WPP_SF_(0x20u, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids);
      v12[15].Blink = 0LL;
    ...
    if ( (unsigned __int8)byte_1C008371A >= 4u )
      WPP_SF_(0x21u, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids);
    v12[15].Blink = 0LL;
...
LABEL_36:
  ...
  {
    if ( (unsigned __int8)byte_1C008371A >= 4u )
      WPP_SF_(0x1Fu, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids);
    v12[16].Blink = 0LL;
  ...
  if ( (unsigned __int8)byte_1C008371A >= 4u )
    WPP_SF_(0x1Eu, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids);
  v12[16].Blink = 0LL;
