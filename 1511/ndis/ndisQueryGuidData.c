/*
 * XREFs of ndisQueryGuidData @ 0x1C009F550
 * Callers:
 ...
 *     ndisWmiQueryPMActiveCapabilities @ 0x1C00C54C4 (ndisWmiQueryPMActiveCapabilities.c)
        ...
        struct _NDIS_MINIPORT_BLOCK *a7)
{
  ...
  *(_DWORD *)((char *)&UnicodeString.Buffer + 2) = 0;
  ...
  if ( (unsigned __int8)byte_1C0083719 >= 4u )
    WPP_SF_qq(0x1Eu, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a3, a7);
  if ( !(_DWORD)v8 )
    goto LABEL_35;
  memset(a1, 0, v8);
  ...
  if ( !SourceString )
  {
    if ( (unsigned __int8)byte_1C0083719 >= 2u )
      WPP_SF_q(0x1Fu, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, (__int64)a3);
    goto LABEL_38;
  }
...
LABEL_35:
  ...
  *(_DWORD *)&v44[48] = v8;
  ...
  {
    if ( (unsigned __int8)byte_1C0083719 >= 2u )
      WPP_SF_qD(0x20u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, (__int64)a7, SetMiniport);
...
LABEL_32:
  ...
  {
    LODWORD(v38) = v14;
    WPP_SF_qqd(0x21u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a3, v43, v38);
  }
