/*
 * XREFs of ndisHandleLegacyTransport @ 0x1C00AC19C
 * Callers:
...
__int64 __fastcall ndisHandleLegacyTransport(__int64 a1)
{
  ...
  {
    WPP_SF_q(0x2Bu, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, a1);
    v2 = byte_1C008370C;
  }
  Context = 0LL;
...
LABEL_9:
          if ( (unsigned __int8)byte_1C008370C >= 4u )
            WPP_SF_(0x2Du, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids);
  ...
  if ( (unsigned __int8)v2 >= 4u )
    WPP_SF_(0x2Cu, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids);
  return 3221225473LL;
}
