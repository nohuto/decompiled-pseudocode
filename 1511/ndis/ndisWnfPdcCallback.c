/*
 * XREFs of ndisWnfPdcCallback @ 0x1C004B250
 * Callers:
 *     <none>
 * Callees:
 ...
 *     TemplateEventDescriptor @ 0x1C0049D58 (TemplateEventDescriptor.c)
...
__int64 __fastcall ndisWnfPdcCallback(__int64 a1, __int64 a2, __int64 a3, int a4)
{
  ...
  {
    WPP_SF_d(0x68u, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, v5);
  }
  return 0LL;
}
