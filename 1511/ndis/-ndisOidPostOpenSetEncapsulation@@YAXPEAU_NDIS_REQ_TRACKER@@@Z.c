/*
 * XREFs of ?ndisOidPostOpenSetEncapsulation@@YAXPEAU_NDIS_REQ_TRACKER@@@Z @ 0x1C0023A3C
 * Callers:
...
void __fastcall ndisOidPostOpenSetEncapsulation(struct _NDIS_REQ_TRACKER *a1)
{
  ...
  {
    WPP_SF_qqq(197LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, *(_QWORD *)(v3 + 16), v1, v3);
    v4 = byte_1C0083712;
  }
  v5 = *(_QWORD *)(v3 + 792);
  if ( v5 )
  ...
  if ( (unsigned __int8)v4 >= 4u )
    WPP_SF_qq(198LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, v1);
}
