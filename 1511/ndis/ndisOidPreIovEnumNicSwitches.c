/*
 * XREFs of ndisOidPreIovEnumNicSwitches @ 0x1C0065290
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumNicSwitches(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x13u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, a1);
...
LABEL_19:
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x14u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v3;
}
