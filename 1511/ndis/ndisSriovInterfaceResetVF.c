/*
 * XREFs of ndisSriovInterfaceResetVF @ 0x1C00D5DA0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceResetVF(void *a1, __int16 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x63u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1);
  v7 = 393600;
  v8 = a2;
  memset(v9, 0, sizeof(v9));
  *(_DWORD *)&v9[88] |= 8u;
  ...
  *(_DWORD *)&v9[48] = 6;
  ...
  v5 = SetMiniport;
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x64u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1, SetMiniport);
  return v5;
}
