/*
 * XREFs of ?NdisTraceLoggingChecksumConfigOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0017B24
 * Callers:
...
void __fastcall NdisTraceLoggingChecksumConfigOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  ...
  if ( (unsigned int)dword_1C0082040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v27 = (char)v14;
      v83 = 1LL;
      TlgWrite(v14, &unk_1C00736D5, v3, (LPCGUID)v4, 0x19u, &pData);
    }
  }
}
