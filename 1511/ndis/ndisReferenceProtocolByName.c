/*
 * XREFs of ndisReferenceProtocolByName @ 0x1C00ED714
 * Callers:
...
__int64 __fastcall ndisReferenceProtocolByName(__int64 *SourceString, __int64 *a2, char a3, unsigned __int8 a4)
{
  ...
  if ( (unsigned __int8)byte_1C008370C >= 4u )
    WPP_SF_Z(0x23u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, SourceString);
...
LABEL_24:
  if ( (unsigned __int8)byte_1C008370C >= 4u )
    WPP_SF_qD(0x24u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, *a2, v8);
  return v8;
}
