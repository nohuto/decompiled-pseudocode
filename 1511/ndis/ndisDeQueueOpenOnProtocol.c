/*
 * XREFs of ndisDeQueueOpenOnProtocol @ 0x1C00E1698
 * Callers:
...
void __fastcall ndisDeQueueOpenOnProtocol(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_qq(0x2Cu, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, a1, a2);
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_qq(0x2Du, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, a1, a2);
}
