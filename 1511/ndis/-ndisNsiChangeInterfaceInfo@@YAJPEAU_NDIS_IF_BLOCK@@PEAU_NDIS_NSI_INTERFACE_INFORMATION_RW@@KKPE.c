/*
 * XREFs of ?ndisNsiChangeInterfaceInfo@@YAJPEAU_NDIS_IF_BLOCK@@PEAU_NDIS_NSI_INTERFACE_INFORMATION_RW@@KKPEAK@Z @ 0x1C0018A58
 * Callers:
        ...
        unsigned __int16 *a5)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qq(118LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a2);
...
LABEL_14:
  ...
  *(_DWORD *)&ifL2NetworkInfo->Length = v16;
  if ( !v16 )
    v9 = -1073741811;
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qqd(119LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a2, v9);
  return v9;
}
