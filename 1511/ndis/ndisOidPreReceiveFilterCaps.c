/*
 * XREFs of ndisOidPreReceiveFilterCaps @ 0x1C00BE8B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreReceiveFilterCaps(__int64 *a1)
{
  ...
  {
    WPP_SF_qqq(0xAu, &WPP_5bdf5f30a197d5f3fc0ac0df652068c7_Traceguids, v1, v5, v3);
    v6 = byte_1C0083712;
  }
  *((_DWORD *)a1 + 10) = 0;
...
LABEL_23:
  if ( (unsigned __int8)v6 >= 4u )
  {
    v13 = *((_DWORD *)a1 + 10);
    LODWORD(v12) = v4;
    WPP_SF_qqDD(0xBu, &WPP_5bdf5f30a197d5f3fc0ac0df652068c7_Traceguids, v1, v5, v12, v13);
  }
  return v4;
}
