/*
 * XREFs of ndisOidPostIovCreateVPort @ 0x1C0064BC0
 * Callers:
 *     <none>
 * Callees:
 *     WPP_SF_qq @ 0x1C0026510 (WPP_SF_qq.c)
 *     ndisIovAddVPortToPFList @ 0x1C0063D40 (ndisIovAddVPortToPFList.c)
 *     ndisIovAddVPortToVFList @ 0x1C0063D8C (ndisIovAddVPortToVFList.c)
 */
...
void __fastcall ndisOidPostIovCreateVPort(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qq(0x2Fu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v1);
  if ( *a1 )
  {
    v4 = *(_QWORD *)(v1 + 152);
    if ( *((_DWORD *)a1 + 10) )
...
LABEL_13:
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qq(0x30u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v1);
}
