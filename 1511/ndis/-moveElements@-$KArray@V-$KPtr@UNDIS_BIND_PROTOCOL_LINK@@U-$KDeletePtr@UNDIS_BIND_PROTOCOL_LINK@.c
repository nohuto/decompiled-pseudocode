/*
 * XREFs of ?moveElements@?$KArray@V?$KPtr@UNDIS_BIND_PROTOCOL_LINK@@U?$KDeletePtr@UNDIS_BIND_PROTOCOL_LINK@@@@@@@Rtl@@AEAAXKKK@Z @ 0x1C00A6120
 * Callers:
  ...
  if ( a2 != a3 && a4 )
  {
    if ( a2 >= a3 )
    {
      ...
      if ( v19 < a3 + a4 )
      {
        ...
        do
        {
          result = KPtr<NDIS_BIND_PROTOCOL_LINK,KDeletePtr<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'(v25 + *(_QWORD *)(a1 + 16));
          v26 = *(_QWORD *)(a1 + 16);
          if ( v24 + v26 )
          {
            result = *(_QWORD *)(v26 + 8LL * (v19 + v20));
      ...
      if ( v19 < a2 + a4 )
      {
        ...
        do
        {
          result = KPtr<NDIS_BIND_PROTOCOL_LINK,KDeletePtr<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'(v28 + *(_QWORD *)(a1 + 16));
          v28 += 8LL;
          --v29;
        }
        while ( v29 );
    ...
    else
    {
      ...
      if ( v8 > a3 )
      {
        ...
        {
          v16 = v8 - 1;
          result = KPtr<NDIS_BIND_PROTOCOL_LINK,KDeletePtr<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'(*(_QWORD *)(a1 + 16) + 8 * v16);
          v17 = *(_QWORD *)(a1 + 16);
          v18 = (__int64 *)(v17 + 8 * v16);
          if ( v18 )
          {
            result = *(_QWORD *)(v17 + 8LL * (v8 + v15 - 1));
      ...
      while ( v8 > a2 )
        result = KPtr<NDIS_BIND_PROTOCOL_LINK,KDeletePtr<NDIS_BIND_PROTOCOL_LINK>>::`scalar deleting destructor'(*(_QWORD *)(a1 + 16) + 8LL * --v8);
    }
  }
  return result;
}
