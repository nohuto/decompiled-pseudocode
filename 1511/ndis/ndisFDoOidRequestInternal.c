/*
 * XREFs of ndisFDoOidRequestInternal @ 0x1C0007FE0
 * Callers:
...
void __fastcall ndisFDoOidRequestInternal(KSPIN_LOCK *Parameter)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_q(47LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, Parameter);
  while ( 1 )
  {
    v2 = -1073741823;
    v3 = 0LL;
    ...
    *((_DWORD *)Parameter + 40) = 0;
    ...
    {
      LODWORD(v24) = v8;
      WPP_SF_qqDDD(48LL, v27, Parameter, v9, v24, v10, v27);
    }
    if ( v11 != 1 )
    {
      ...
      *((_DWORD *)Parameter + 40) = 0;
      ...
      else
      {
        ...
        *((_DWORD *)Parameter + 40) = 0;
        ...
        v28 = 0LL;
        if ( (unsigned __int8)byte_1C0083712 >= 4u )
          WPP_SF_qLq(120LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, Parameter, v17, v9);
        LOBYTE(v15) = 1;
        ...
        if ( !v18 )
        {
          ...
          {
            if ( (unsigned __int8)byte_1C0083712 >= 4u )
              WPP_SF_qqd(121LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, v9, v28, *((_DWORD *)v28 + 8));
            v22 = v20;
          }
          else
          {
        ...
        if ( (unsigned __int8)byte_1C0083712 >= 4u )
        {
          WPP_SF_qLqL(122LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, Parameter, v17, v9, v21);
          v23 = byte_1C0083712;
        }
        if ( v21 != 259 )
        {
          ...
          if ( (unsigned __int8)v23 >= 4u )
          {
            ...
            WPP_SF_qqDD(49LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, Parameter, v9, v24, v21);
          }
          v26[4] = v9;
          v26[2] = Parameter;
          LODWORD(v26[5]) = v21;
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_q(50LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, Parameter);
}
