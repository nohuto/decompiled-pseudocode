/*
 * XREFs of ndisIndicateXlatedPacketsToNdis5Protocols @ 0x1C0061CB4
 * Callers:
...
void __fastcall ndisIndicateXlatedPacketsToNdis5Protocols(__int64 *a1)
{
  ...
  struct _NDIS_PACKET **v14; // [rsp+28h] [rbp-D8h] BYREF
  ...
  do
  {
    ...
    if ( v1[v6 + 8] )
    {
      ...
      v7 = v21;
      v19 = 0;
      v14 = (struct _NDIS_PACKET **)&v23;
      v20 = v21;
      v15 = 32;
      do
      {
        v8 = ndisXlateRecvNetBufferListsToPacketArray((__int64 *)&v14);
        v9 = v19;
        v10 = v14;
        v12 = v8;
        (*(void (__fastcall **)(__int64, struct _NDIS_PACKET **, _QWORD))(v7 + 3440))(v7, v14, v19);
