/*
 * XREFs of ndisWmiRegister @ 0x1C009F778
 * Callers:
...
__int64 __fastcall ndisWmiRegister(__int64 a1, __int64 a2, int *a3, unsigned int a4, unsigned int *a5)
{
  ...
  if ( (unsigned __int8)byte_1C0083719 >= 4u )
    WPP_SF_q(0x15u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1);
  *a5 = 0;
  if ( a2 )
  {
    if ( (unsigned __int8)byte_1C0083719 >= 4u )
      WPP_SF_q(0x18u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1);
    v5 = -1073741811;
    goto LABEL_7;
  }
  if ( !*(_QWORD *)(a1 + 1368) && (unsigned int)ndisQuerySupportedGuidToOidList(a1) )
  {
    if ( (unsigned __int8)byte_1C0083719 >= 2u )
      WPP_SF_q(0x16u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1);
    goto LABEL_32;
  }
  v12 = *(_WORD *)(a1 + 1388);
  if ( v12 )
...
LABEL_32:
  ...
  if ( a4 < v16 )
  {
    ...
    *a5 = 4;
    if ( (unsigned __int8)byte_1C0083719 < 4u )
      return v5;
    WPP_SF_q(0x17u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1);
  }
  else
  {
    *a5 = v16;
...
LABEL_7:
  if ( (unsigned __int8)byte_1C0083719 >= 4u )
    WPP_SF_qD(0x19u, &WPP_d937986e7c9cfac467ff151df8b76bd8_Traceguids, a1, v5);
  return v5;
}
