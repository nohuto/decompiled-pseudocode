/*
 * XREFs of ndisSetOpenEthAddDeleteMulticast @ 0x1C00AD9B4
 * Callers:
...
unsigned __int8 __fastcall ndisSetOpenEthAddDeleteMulticast(__int64 a1, __int64 a2, int *a3)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0x68u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, a1, a2);
  IsValidMulticastFilter = ndisIsValidMulticastFilter(*(_QWORD *)(a1 + 16), a1, a2);
  if ( IsValidMulticastFilter )
  {
    if ( (unsigned __int8)byte_1C0083712 < 4u )
      goto LABEL_36;
    WPP_SF_(0x69u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids);
LABEL_34:
    if ( (unsigned __int8)byte_1C0083712 >= 4u )
      WPP_SF_qqqDD(0x6Bu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, a1, a2, IsValidMulticastFilter, v4);
LABEL_36:
    if ( !IsValidMulticastFilter )
      goto LABEL_37;
    goto LABEL_56;
...
LABEL_33:
  ...
  *(_DWORD *)(a2 + 56) = 0;
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
  {
    WPP_SF_qqq(0x6Au, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, a1, a2);
    goto LABEL_34;
  }
LABEL_56:
