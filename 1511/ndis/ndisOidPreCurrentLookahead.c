/*
 * XREFs of ndisOidPreCurrentLookahead @ 0x1C0023CB0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreCurrentLookahead(_QWORD *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(81LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, *a1, v1);
  v4 = *(_DWORD *)(v1 + 4);
  if ( (v4 & 0xFFFFFFFD) != 0 )
  {
    if ( v4 != 1 )
    ...
    *((_DWORD *)a1 + 10) = 0;
    ...
    {
      if ( (unsigned __int8)byte_1C0083712 >= 4u )
        WPP_SF_qqd(82LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, 0LL, v1, *((_DWORD *)a1 + 10));
    }
    else
    {
      v5 = **(_DWORD **)(v1 + 40);
...
LABEL_17:
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(83LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, *a1, v1);
  return v3;
}
