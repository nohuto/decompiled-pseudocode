/*
 * XREFs of ndisIfSetIfDescr @ 0x1C003FF20
 * Callers:
...
__int64 __fastcall ndisIfSetIfDescr(__int64 a1)
{
  ...
  *(_DWORD *)&String2.Length = 0;
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_q(0xBFu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1);
  if ( a1 )
  {
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qD(0xC0u, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, updated);
  return updated;
}
