/*
 * XREFs of ?ndisAoAcTraceRundown@@YAXPEAU_NDIS_MINIPORT_BLOCK@@@Z @ 0x1C0049964
 * Callers:
...
void __fastcall ndisAoAcTraceRundown(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( TempRefReason && byte_1C0083709 )
    WPP_SF_d(0x58u, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, TempRefReason);
  ...
  while ( OpenQueue )
  {
    ...
    if ( AoAcReferences && byte_1C0083709 )
      WPP_SF_Zd(
        0x5Au,
        &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids,
