/*
 * XREFs of ndisQueueRestoreRequestsOnTop @ 0x1C0044B50
 * Callers:
 ...
 *     ndisFQueueOidRequest @ 0x1C0041970 (ndisFQueueOidRequest.c)
...
__int64 __fastcall ndisQueueRestoreRequestsOnTop(__int64 a1, __int64 **a2, int a3, char a4)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qD(0x3Bu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a3);
  ...
  else
  {
    ...
    if ( *(_BYTE *)v13 == 5 )
    {
      while ( 1 )
      {
        v6 = ndisReferenceRef((PKSPIN_LOCK)(v13 + 312));
        if ( v6 == 1 )
          break;
        v13 = *(_QWORD *)(v13 + 416);
        if ( *(_BYTE *)v13 != 5 )
...
LABEL_11:
  ...
  if ( v4 )
  {
    if ( !v6 )
      goto LABEL_47;
    v15 = ndisReferenceRef((PKSPIN_LOCK)(v4 + 312));
  }
  else
  {
...
LABEL_49:
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqd(60LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v9, a2, v10);
  return v10;
}
