/*
 * XREFs of ndisSriovInterfaceWriteVFConfig @ 0x1C00D6000
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisSriovInterfaceWriteVFConfig(void *a1, const void *a2, __int16 a3, int a4, size_t Size)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x59u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1);
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x5Au, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1, SetMiniport);
  return SetMiniport;
}
