/*
 * XREFs of ndisRegisterMiniportDriver @ 0x1C00EE988
 * Callers:
...
__int64 __fastcall ndisRegisterMiniportDriver(struct _DRIVER_OBJECT **a1, _QWORD *a2, unsigned int a3, PVOID *a4)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xEu, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)a1);
  if ( !a1 )
  {
    v4 = -1073741823;
    goto LABEL_36;
...
LABEL_36:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0xFu, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)DriverObjectExtension);
  return v4;
}
