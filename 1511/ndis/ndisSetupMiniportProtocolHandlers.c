/*
 * XREFs of ndisSetupMiniportProtocolHandlers @ 0x1C001AB8C
 * Callers:
...
_UNKNOWN **__fastcall ndisSetupMiniportProtocolHandlers(_QWORD *a1, __int64 a2, __int64 a3)
{
  ...
  {
    result = (_UNKNOWN **)WPP_SF_qqq(136LL, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a2, a3, a1);
    v9 = byte_1C008370D;
  }
  if ( !v7 )
    goto LABEL_14;
...
LABEL_14:
  ...
  if ( (unsigned __int8)v9 >= 4u )
    return (_UNKNOWN **)WPP_SF_qqq(137LL, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a2, a3, a1);
  return result;
}
