/*
 * XREFs of ndisOidPostMediaState @ 0x1C00432E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostMediaState(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(0x4Du, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, v1);
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(0x4Eu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, v1);
}
