/*
 * XREFs of ndisEtwRegisterGuids @ 0x1C00ACA3C
 * Callers:
...
__int64 __fastcall ndisEtwRegisterGuids(char *a1, unsigned int a2, unsigned int *a3)
{
  ...
  {
    WPP_SF_(0x4Eu, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids);
    v6 = (unsigned __int8)ndisWppEnabledLevelPerFlag;
  }
  if ( !a3 || !a1 || a2 < 4 )
    return 3221225485LL;
  ...
  *a3 = 0;
  ...
  else
  {
    ...
    *((_WORD *)v10 + 15) = aMofresourcenam[14];
    if ( v6 >= 4u )
      WPP_SF_d(0x4Fu, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, 0);
    return 0LL;
  }
  return result;
}
