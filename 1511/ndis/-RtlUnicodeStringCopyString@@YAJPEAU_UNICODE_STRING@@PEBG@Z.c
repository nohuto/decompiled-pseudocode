/*
 * XREFs of ?RtlUnicodeStringCopyString@@YAJPEAU_UNICODE_STRING@@PEBG@Z @ 0x1C0063438
 * Callers:
 ...
 *     RtlWideCharArrayCopyStringWorker @ 0x1C00634C4 (RtlWideCharArrayCopyStringWorker.c)
 */
