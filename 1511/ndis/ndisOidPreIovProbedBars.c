/*
 * XREFs of ndisOidPreIovProbedBars @ 0x1C00D45B0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovProbedBars(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x49u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v1);
    v4 = byte_1C0083721;
  }
  v5 = 0;
  if ( *(_DWORD *)(v1 + 4) )
...
LABEL_12:
  ...
  {
    v7 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x4Au, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v5, v7);
  }
  return v5;
}
