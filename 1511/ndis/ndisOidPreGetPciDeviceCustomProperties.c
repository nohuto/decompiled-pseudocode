/*
 * XREFs of ndisOidPreGetPciDeviceCustomProperties @ 0x1C00C03D0
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreGetPciDeviceCustomProperties(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0xAAu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, 0LL, v1);
    v4 = byte_1C0083712;
  }
  ...
  {
    v8 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0xABu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v3, 1, v8);
  }
  return 1;
}
