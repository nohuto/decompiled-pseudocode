/*
 * XREFs of ndisOidPreIovCreateNicSwitch @ 0x1C00D39F0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovCreateNicSwitch(struct _NDIS_MINIPORT_BLOCK **a1)
{
  ...
  {
    WPP_SF_qqqq(0xCu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v1, a1[3], a1[1], v3);
    v5 = byte_1C0083721;
  }
  v6 = 0;
  if ( !*a1 )
...
LABEL_9:
  if ( (unsigned __int8)v5 >= 4u )
  {
    v17 = *((_DWORD *)a1 + 10);
    LODWORD(v16) = v4;
    WPP_SF_qqqDD(0xDu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, *a1, a1[3], a1[1], v16, v17);
  }
  return v4;
}
