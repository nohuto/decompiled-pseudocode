/*
 * XREFs of ?ndisNsiSetNetworkInfo@@YAJPEAU_NM_REQUEST_SET_PARAMETER@@@Z @ 0x1C003E2D0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiSetNetworkInfo(struct _NM_REQUEST_SET_PARAMETER *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_q(0x70u, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, (__int64)a1);
...
LABEL_32:
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qD(0x71u, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, (__int64)a1, v1);
  return v1;
}
