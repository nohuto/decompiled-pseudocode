/*
 * XREFs of ?NdisTraceLoggingMiniportWakeReason@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_NDIS_PM_WAKE_REASON_TYPE@@@Z @ 0x1C006DBC4
 * Callers:
...
void __fastcall NdisTraceLoggingMiniportWakeReason(const struct _TlgProvider_t *a1, enum _NDIS_PM_WAKE_REASON_TYPE a2)
{
  ...
  if ( (unsigned int)dword_1C0082040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      v5 = (int)v4;
      v11 = 4;
      TlgWrite((TraceLoggingHProvider)4, &unk_1C0072DAC, v3, v4, 4u, &pData);
    }
  }
}
