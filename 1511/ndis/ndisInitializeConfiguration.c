/*
 * XREFs of ndisInitializeConfiguration @ 0x1C009D18C
 * Callers:
 ...
 *     ndisReadPMRegistry @ 0x1C009D98C (ndisReadPMRegistry.c)
...
__int64 __fastcall ndisInitializeConfiguration(__int64 a1, __int64 a2, const WCHAR *a3)
{
  ...
  v27 = -1;
  v30.Buffer = L"BusNumber";
  IntegerData = 18;
  *(_DWORD *)&v30.Length = 1310738;
  v33.Buffer = L"SlotNumber";
  *(_DWORD *)&v33.Length = 1441812;
  v36.Buffer = L"BusType";
  LOWORD(v7) = 20;
  *(_DWORD *)&v36.Length = 1048590;
  Keyword.Buffer = L"PnPCapabilities";
  *(_DWORD *)&Keyword.Length = 2097182;
  v34.Buffer = L"RemoteBootCard";
  *(_DWORD *)&v34.Length = 1966108;
  v32.Buffer = L"NdisDriverVerifyFlags";
  *(_DWORD *)&v32.Length = 2883626;
  v31.Buffer = L"SGMapRegistersNeeded";
  *(_DWORD *)&v31.Length = 2752552;
  v25 = 1;
  memset(v39, 0, sizeof(v39));
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_q(0xAu, &WPP_8578613493474478f9fbc41c93fda03c_Traceguids, a2);
  *(_DWORD *)a1 = 8913162;
...
LABEL_16:
    ...
    if ( v17 )
    {
      ...
      if ( PropertyBuffer == *(_QWORD *)&GUID_BUS_TYPE_ISAPNP.Data1 )
        v19 = v38 - *(_QWORD *)GUID_BUS_TYPE_ISAPNP.Data4;
      if ( !v19 )
      {
        IntegerData = 14;
        goto LABEL_16;
...
LABEL_60:
      if ( IntegerData == 1 )
      {
        v22 = IoGetDeviceProperty(*(PDEVICE_OBJECT *)(a2 + 3888), DevicePropertyLegacyBusType, 4u, &v25, &ResultLength);
        IntegerData = v25;
        DeviceProperty = v22;
      }
      goto LABEL_17;
  ...
  else
  {
    *(_DWORD *)(a2 + 3768) = IntegerData;
    ...
    if ( IoGetDeviceProperty(*(PDEVICE_OBJECT *)(a2 + 3888), DevicePropertyBusNumber, 4u, &v27, &ResultLength) >= 0
      || (NdisReadConfiguration(&Status, &ParameterValue, ConfigurationHandle, &v30, NdisParameterInteger), Status) )
    {
      v14 = v27;
    }
    else
    ...
    *(_WORD *)(a2 + 3732) = v7;
    ...
    NdisReadConfiguration(&Status, &ParameterValue, ConfigurationHandle, &v32, NdisParameterHexInteger);
    if ( !Status )
...
LABEL_40:
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_q(0xBu, &WPP_8578613493474478f9fbc41c93fda03c_Traceguids, a2);
  return v8;
}
