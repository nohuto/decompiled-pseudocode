/*
 * XREFs of ndisPMAddWOLPattern @ 0x1C00048A8
 * Callers:
...
__int64 __fastcall ndisPMAddWOLPattern(char *MiniportAdapterHandle, __int64 a2, PNDIS_OID_REQUEST Request)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(78LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, MiniportAdapterHandle, a2, Request);
    ...
    *(_DWORD *)&Request->NdisReserved[16] |= 0x2000000u;
    ...
    if ( !v7 )
    {
      ...
      *((_QWORD *)MiniportAdapterHandle + 65) = KeGetCurrentThread();
      ...
      NewIrql = v12;
      *((_DWORD *)MiniportAdapterHandle + 464) = 2758022;
...
LABEL_27:
      v20 = SetMiniport;
LABEL_32:
      WPP_SF_d(v19, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v20);
      goto LABEL_7;
    }
  }
...
LABEL_7:
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqqL(83LL, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, MiniportAdapterHandle, a2, Request, v9);
  return v9;
}
