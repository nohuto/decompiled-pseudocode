/*
 * XREFs of ndisImmediateReadWriteSharedMemory @ 0x1C00C8188
 * Callers:
 *     NdisImmediateReadSharedMemory @ 0x1C00C7BA0 (NdisImmediateReadSharedMemory.c)
 *     NdisImmediateWriteSharedMemory @ 0x1C00C7C50 (NdisImmediateWriteSharedMemory.c)
 * Callees:
