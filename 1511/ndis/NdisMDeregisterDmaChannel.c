/*
 * XREFs of NdisMDeregisterDmaChannel @ 0x1C00EDEC0
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisMDeregisterDmaChannel(NDIS_HANDLE MiniportDmaHandle)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_(0x27u, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_(0x28u, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids);
}
