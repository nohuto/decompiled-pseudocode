/*
 * XREFs of ?ndisPDPcwQueueDepthCallback@@YAJW4_PCW_CALLBACK_TYPE@@PEAT_PCW_CALLBACK_INFORMATION@@PEAX@Z @ 0x1C006BD60
 * Callers:
 *     <none>
 * Callees:
 *     ?ndisCountSetBits64@@YAK_K@Z @ 0x1C006BA44 (-ndisCountSetBits64@@YAK_K@Z.c)
...
__int64 __fastcall ndisPDPcwQueueDepthCallback(int a1, union _PCW_CALLBACK_INFORMATION *a2, void *a3)
{
  ...
  v5 = 0;
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v19, (struct KPushLockBase *)(qword_1C00837E0 + 8));
  v6 = qword_1C00837E0;
  v7 = qword_1C00837E0 + 16;
  v8 = *(_QWORD **)(qword_1C00837E0 + 16);
  while ( v8 != (_QWORD *)v7 )
  {
    v9 = (__int64 *)v8[6];
    if ( v9 != v8 + 6 )
        ...
        for ( i = (__int64 *)v9[15]; i != v9 + 15; i = (__int64 *)*i )
        {
          if ( a1 >= 0 )
          {
            ...
            else if ( a1 == 2 )
            {
              ...
              v17.Data = 0LL;
              v17.Size = 8;
              v5 = PcwAddInstance(Buffer, (PCUNICODE_STRING)i + 2, v15, 1u, &v17);
              if ( v5 < 0 )
                goto LABEL_11;
            }
            else if ( a1 == 3 )
            {
              ...
              if ( InstanceId == -1 || InstanceId == *((_DWORD *)i + 6) )
              {
                ...
                Data.Data = (char *)i + 52;
                Data.Size = 8;
                v5 = PcwAddInstance(v13, (PCUNICODE_STRING)i + 2, v12, 1u, &Data);
                goto LABEL_11;
              }
            }
          }
