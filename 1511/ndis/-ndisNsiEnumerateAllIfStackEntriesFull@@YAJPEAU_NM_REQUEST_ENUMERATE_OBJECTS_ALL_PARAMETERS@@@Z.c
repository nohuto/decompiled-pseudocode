/*
 * XREFs of ?ndisNsiEnumerateAllIfStackEntriesFull@@YAJPEAU_NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS@@@Z @ 0x1C0010890
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisNsiEnumerateAllIfStackEntriesFull(struct _NM_REQUEST_ENUMERATE_OBJECTS_ALL_PARAMETERS *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_q(100LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1);
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qD(101LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, v8);
  return v8;
}
