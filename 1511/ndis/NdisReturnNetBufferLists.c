/*
 * XREFs of NdisReturnNetBufferLists @ 0x1C000CF90
 * Callers:
        ...
        ULONG ReturnFlags)
{
  ...
  PNET_BUFFER_LIST v55; // [rsp+88h] [rbp-80h] BYREF
  PNET_BUFFER_LIST v56; // [rsp+90h] [rbp-78h]
  ...
  if ( (DatapathEventsMask & 0x180028) != 0 || (v52.DatapathCyclesMask & 0x10) != 0 )
  {
    ...
    if ( (DatapathEventsMask & 0x100020) != 0 )
    {
      ...
      {
        ndisPcwAddEvent(&v52, 5uLL, v45);
        DatapathEventsMask = v52.DatapathEventsMask;
        v9 = 0LL;
      }
      if ( !v3 && (DatapathEventsMask & 0x100000) != 0 )
      {
        ndisPcwAddEvent(&v52, 0x1CuLL, v45);
        v9 = 0LL;
      }
    }
  ...
  if ( Microsoft_Windows_Networking_CorrelationEnabled )
    ndisMarkNetBufferListCorrelationIdsAsUsed(v4, NetBufferLists, v9);
  if ( *(_DWORD *)(v5 + 3272) )
  {
    v4 = (PNET_BUFFER_LIST)ndisReturnPeriodicReceives(v5, v4);
    v9 = 0LL;
  }
  if ( v4 )
  {
    if ( ndisNblTrackerMode )
    {
      ...
      {
        ndisNblTrackerRecordEvent(v4, v14, 0x87u, (void *)v15, ReturnFlags & 1);
        v18 = v16;
      }
      ...
      v22 = (_SLIST_HEADER *)v4;
      v23 = v16;
      do
      {
        v24 = v22[22].Alignment;
        v25 = v53;
        do
        {
          if ( v22[22].Alignment != v24 )
            break;
          if ( !v24 && !v22[7].Region )
          {
          ...
          if ( (v24 & 4) != 0 || (Region = v22[7].Region) == 0 )
          {
    ...
    if ( ndisIterativeDataPathDisabled || (ReturnFlags & 1) == 0 && KeGetCurrentIrql() != 2 )
    {
      if ( *(_BYTE *)v5 == 5 )
      {
        ...
        if ( (int)ndisExpandStack(ndisDataPathExpandStackCallback, v58) < 0 )
          ndisQueueStackExpansionFallbackNbls((struct _NDIS_FILTER_BLOCK *)v5, v4, 0);
        goto LABEL_13;
      }
LABEL_12:
      (*(void (__fastcall **)(_QWORD, PNET_BUFFER_LIST, _QWORD))(v5 + 2648))(*(_QWORD *)(v5 + 2536), v4, ReturnFlags);
LABEL_13:
      if ( (v54.DatapathCyclesMask & 0x20) != 0 )
      {
