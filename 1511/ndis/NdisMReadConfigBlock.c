/*
 * XREFs of NdisMReadConfigBlock @ 0x1C00D2AF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall NdisMReadConfigBlock(_QWORD *a1, unsigned int a2, __int64 a3, unsigned int a4)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x7Du, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1);
  ...
  if ( v8 && (v9 = a1[616]) != 0 && (v10 = a1[584]) != 0 && (*(_BYTE *)(v10 + 8) & 5) == 5 )
    ...
    v11 = -1073741637;
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x7Eu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)a1);
  return v11;
}
