/*
 * XREFs of ?NdisPDPIClearReceiveFilter@@YAXPEAUNDIS_PD_FILTER_HANDLE__@@@Z @ 0x1C00D90D0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisPDPIClearReceiveFilter(_QWORD *P)
{
  ...
  if ( (unsigned __int8)byte_1C0083724 >= 4u )
    WPP_SF_q(0x32u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, (__int64)P);
  ...
  *v8 = 0LL;
  ...
  if ( (unsigned __int8)byte_1C0083724 >= 4u )
    WPP_SF_q(0x33u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, (__int64)P);
}
