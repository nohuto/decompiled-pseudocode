/*
 * XREFs of ?ndisReleaseReadLockSharedRefCnt@@YAXPEAU_NDIS_RW_LOCK@@@Z @ 0x1C0054ED4
 * Callers:
 *     NdisReleaseReadWriteLock @ 0x1C0010340 (NdisReleaseReadWriteLock.c)
 *     ndisReleaseReadWriteLockX @ 0x1C0055964 (ndisReleaseReadWriteLockX.c)
 * Callees:
 *     <none>
 */
