/*
 * XREFs of NdisSetOptionalHandlers @ 0x1C009CC50
 * Callers:
 *     <none>
 * Callees:
 ...
 *     ndisSetSSHandlers @ 0x1C00D6B34 (ndisSetSSHandlers.c)
 *     ?ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z @ 0x1C00DAAEC (-ndisPDSetBufferManagerHandlers@@YAHPEAXPEBU_NDIS_DRIVER_OPTIONAL_HANDLERS@@@Z.c)
 */
...
NDIS_STATUS __stdcall NdisSetOptionalHandlers(NDIS_HANDLE NdisHandle, PNDIS_DRIVER_OPTIONAL_HANDLERS OptionalHandlers)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x6Au, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)NdisHandle);
...
LABEL_19:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x6Bu, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)NdisHandle, v4);
  return v4;
}
