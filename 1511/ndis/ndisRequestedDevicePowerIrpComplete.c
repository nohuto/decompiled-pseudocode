/*
 * XREFs of ndisRequestedDevicePowerIrpComplete @ 0x1C0012CF0
 * Callers:
        ...
        PIO_STATUS_BLOCK IoStatus)
{
  ...
  {
    WPP_SF_q(55LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, DeviceObject);
  ...
  if ( IoStatus->Status < 0 )
  {
    if ( (unsigned __int8)byte_1C0083715 >= 2u )
      WPP_SF_q(57LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, DeviceObject);
  ...
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_q(58LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, DeviceObject);
}
