/*
 * XREFs of NdisMRegisterIoPortRange @ 0x1C00CC9B0
 * Callers:
 *     <none>
 * Callees:
        ...
        UINT NumberOfPorts)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x14u, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)MiniportAdapterHandle);
  if ( (*((_DWORD *)MiniportAdapterHandle + 934) & 0x20) != 0 )
    goto LABEL_4;
...
LABEL_4:
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(0x15u, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, (__int64)MiniportAdapterHandle, v4);
  return v4;
}
