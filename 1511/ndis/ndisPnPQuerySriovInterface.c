/*
 * XREFs of ndisPnPQuerySriovInterface @ 0x1C00D53F4
 * Callers:
...
__int64 __fastcall ndisPnPQuerySriovInterface(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x55u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, a1);
  v5 = *(_QWORD *)(a2 + 184);
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x56u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, a1, v4);
  return v4;
}
