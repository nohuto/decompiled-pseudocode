/*
 * XREFs of ?ndisNsiGetInterfaceRosInformation@@YAJPEAU_NDIS_IF_BLOCK@@0PEAU_NM_REQUEST_GET_PARAMETER@@@Z @ 0x1C00956F0
 * Callers:
        ...
        struct _NM_REQUEST_GET_PARAMETER *a3)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qq(0x4Eu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a3);
  v7 = (char *)*((_QWORD *)v5 + 5);
  v8 = *((_DWORD *)v5 + 13);
  v9 = *((_DWORD *)v5 + 12);
  if ( v7 )
...
LABEL_21:
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qqd(0x4Fu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, v5, v3);
  return v3;
}
