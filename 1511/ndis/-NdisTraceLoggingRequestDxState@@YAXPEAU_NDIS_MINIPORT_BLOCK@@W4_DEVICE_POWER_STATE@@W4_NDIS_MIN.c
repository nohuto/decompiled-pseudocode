/*
 * XREFs of ?NdisTraceLoggingRequestDxState@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_DEVICE_POWER_STATE@@W4_NDIS_MINIPORT_EVENT@@J@Z @ 0x1C00124F8
 * Callers:
        ...
        enum _NDIS_MINIPORT_EVENT a3)
{
  ...
  if ( (unsigned int)dword_1C0082040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x400000000000uLL) )
    {
      ...
      v9 = (int)v5;
      v19 = 4LL;
      TlgWrite(v3, &unk_1C0073E9D, v4, v5, 6u, &pData);
    }
  }
}
