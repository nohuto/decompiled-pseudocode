/*
 * XREFs of ndisOidPreIovPfLuid @ 0x1C00D44C0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreIovPfLuid(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0x4Du, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v3, v1);
    v5 = byte_1C0083721;
  }
  if ( *(_DWORD *)(v1 + 4) )
    goto LABEL_12;
...
LABEL_14:
  ...
  {
    v9 = *(_DWORD *)(a1 + 40);
    WPP_SF_qdD(0x4Eu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, (__int64)v3, v4, v9);
  }
  return v4;
}
