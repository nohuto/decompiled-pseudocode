/*
 * XREFs of NdisIfDeregisterProvider @ 0x1C003E700
 * Callers:
 *     <none>
 * Callees:
...
void __stdcall NdisIfDeregisterProvider(NDIS_HANDLE NdisProviderHandle)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_q(0x15u, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, (__int64)NdisProviderHandle);
  ...
  *v4 = v3;
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_q(0x16u, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, (__int64)NdisProviderHandle);
}
