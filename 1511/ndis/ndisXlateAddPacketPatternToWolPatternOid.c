/*
 * XREFs of ndisXlateAddPacketPatternToWolPatternOid @ 0x1C00C5884
 * Callers:
  ...
  if ( PoolWithTag )
  {
    ...
    *((_DWORD *)v6 + 4) = *(_DWORD *)(a1 + 48);
    ...
    if ( (unsigned __int8)byte_1C0083712 >= 4u )
      WPP_SF_q(0x6Du, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1);
    ExFreePoolWithTag(v6, 0);
  }
  else if ( (unsigned __int8)byte_1C0083712 >= 4u )
  {
    WPP_SF_q(0x6Cu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1);
  }
  v2 = -1073741670;
  *a2 = 1;
  return v2;
