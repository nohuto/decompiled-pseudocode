/*
 * XREFs of NdisFOidRequest @ 0x1C00068D0
 * Callers:
 *     <none>
 * Callees:
...
NDIS_STATUS __stdcall NdisFOidRequest(NDIS_HANDLE NdisFilterHandle, PNDIS_OID_REQUEST OidRequest)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(51LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, NdisFilterHandle, OidRequest);
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qD(52LL, &WPP_350f249dad1d39316f5dcf1630ed8af4_Traceguids, OidRequest, v4);
  return v4;
}
