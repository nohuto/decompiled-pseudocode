/*
 * XREFs of ?ndisIfCreateInterface@@YAJPEAU_NDIS_IF_NETWORK_BLOCK@@EPEAU_NDIS_NSI_COMPARTMENT_RW@@PEAT_NET_LUID_LH@@PEAU_NDIS_NSI_INTERFACE_PERSIST_RW@@PEAU_NDIS_FILTER_BLOCK@@W4NdisIfBlockSource@@@Z @ 0x1C009F918
 * Callers:
 ...
 *     ?ndisIfUpdateLoopbackInterfaceOnNetwork@@YAXPEAU_NDIS_IF_NETWORK_BLOCK@@T_NET_LUID_LH@@@Z @ 0x1C0020018 (-ndisIfUpdateLoopbackInterfaceOnNetwork@@YAXPEAU_NDIS_IF_NETWORK_BLOCK@@T_NET_LUID_LH@@@Z.c)
 ...
 *     NdisIfAllocateNetLuidIndexEx @ 0x1C00BF790 (NdisIfAllocateNetLuidIndexEx.c)
        ...
        enum NdisIfBlockSource a7)
{
  ...
  *(_DWORD *)&Source.Length = 262146;
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qqqqq(0x7Eu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a3, a4, a5, a6);
  if ( !a1
...
LABEL_77:
          ...
          *((_QWORD *)v13 + 79) = 1LL;
          if ( v43 )
          {
            RtlInitUnicodeString(&DestinationString, &xmmword_1C0083452);
            ...
            *((_WORD *)v13 + 24) = Destination.Length;
            RtlInitUnicodeString(&DestinationString, &xmmword_1C0083242);
            *(_DWORD *)&Destination.Length = 0x2000000;
