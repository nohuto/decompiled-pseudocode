/*
 * XREFs of NdisCoDeleteVc @ 0x1C00F1F40
 * Callers:
 *     NdisMCmDeleteVc @ 0x1C00F3050 (NdisMCmDeleteVc.c)
 * Callees:
...
NDIS_STATUS __stdcall NdisCoDeleteVc(NDIS_HANDLE NdisVcHandle)
{
      ...
      if ( WnodeEventItem )
      {
        ...
        if ( v6 < 0 )
        {
          if ( (unsigned __int8)byte_1C0083719 >= 2u )
            WPP_SF_d(0x1Cu, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids, v6);
          if ( (Microsoft_Windows_NDISEnableBits & 0x1000) != 0 )
            Template_qqq(
              v7,
              &IoWMIWriteEventFailed,
              (const GUID *)(*((_QWORD *)NdisVcHandle + 24) + 4064LL),
              v8,
              210,
              0);
  ...
  if ( (unsigned __int8)byte_1C008371A >= 4u )
    WPP_SF_d(0x1Du, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids, v5);
  return v5;
}
