/*
 * XREFs of ?ndisBindReadFilterDriverFromV1Registry@@YA_NPEAUNDIS_BIND_FILTER_DRIVER@@@Z @ 0x1C00DCB7C
 * Callers:
...
bool __fastcall ndisBindReadFilterDriverFromV1Registry(struct NDIS_BIND_FILTER_DRIVER *a1)
{
  ...
  else
  {
    ...
    {
      WPP_SF_Sd(0x13u, &WPP_10e48bb64bbb401b7e1b3e1f08acf4e0_Traceguids, Dest, v3);
    }
