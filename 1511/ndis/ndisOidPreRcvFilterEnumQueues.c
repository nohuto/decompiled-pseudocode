/*
 * XREFs of ndisOidPreRcvFilterEnumQueues @ 0x1C0039910
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreRcvFilterEnumQueues(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083720 >= 4u )
    WPP_SF_q(0x1Cu, &WPP_5bdf5f30a197d5f3fc0ac0df652068c7_Traceguids, a1);
...
LABEL_32:
  if ( (unsigned __int8)byte_1C0083720 >= 4u )
    WPP_SF_qD(0x1Du, &WPP_5bdf5f30a197d5f3fc0ac0df652068c7_Traceguids, v1, *(_DWORD *)(a1 + 40));
  return v5;
}
