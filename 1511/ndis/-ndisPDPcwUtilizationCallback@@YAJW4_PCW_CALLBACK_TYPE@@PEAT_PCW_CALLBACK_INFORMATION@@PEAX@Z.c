/*
 * XREFs of ?ndisPDPcwUtilizationCallback@@YAJW4_PCW_CALLBACK_TYPE@@PEAT_PCW_CALLBACK_INFORMATION@@PEAX@Z @ 0x1C006BF20
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisPDPcwUtilizationCallback(int a1, union _PCW_CALLBACK_INFORMATION *a2, void *a3)
{
  ...
  v5 = 0;
  KLockThisExclusive::KLockThisExclusive((KLockThisExclusive *)&v20, (struct KPushLockBase *)(qword_1C00837E0 + 8));
  v7 = qword_1C00837E0;
  v8 = qword_1C00837E0 + 16;
  v9 = *(_QWORD **)(qword_1C00837E0 + 16);
  while ( v9 != (_QWORD *)v8 )
  {
    v10 = (__int64 *)v9[6];
    if ( v10 != v9 + 6 )
