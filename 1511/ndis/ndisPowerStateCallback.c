/*
 * XREFs of ndisPowerStateCallback @ 0x1C0099FF0
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisPowerStateCallback(LPCGUID SettingGuid, int *Value, ULONG ValueLength, PVOID Context)
{
  ...
  if ( Value && ValueLength >= 4 )
  {
    if ( (unsigned __int8)byte_1C0083715 >= 4u )
      WPP_SF_d(0x3Du, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, *Value);
    ...
    if ( (unsigned __int8)byte_1C0083715 >= 4u )
      WPP_SF_d(0x3Eu, &WPP_6772f755ba2ecdacbfb9b612c2ccccf9_Traceguids, *Value);
  }
  return 0LL;
}
