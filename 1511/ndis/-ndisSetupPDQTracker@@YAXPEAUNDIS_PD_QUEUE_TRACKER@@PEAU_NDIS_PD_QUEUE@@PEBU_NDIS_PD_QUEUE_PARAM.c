/*
 * XREFs of ?ndisSetupPDQTracker@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@PEAU_NDIS_PD_QUEUE@@PEBU_NDIS_PD_QUEUE_PARAMETERS@@PEAUNDIS_PD_ASSOCIATION@@PEAUNDIS_PD_COUNTER@@EE@Z @ 0x1C00DAFA8
 * Callers:
 ...
 *     ?ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z @ 0x1C00DA2F8 (-ndisInitPDQAWM@@YAXPEAUNDIS_PD_QUEUE_TRACKER@@@Z.c)
 */
        ...
        unsigned __int8 a7)
{
  ...
  *((_DWORD *)DeferredContext + 70) = _InterlockedIncrement((volatile signed __int32 *)(qword_1C00837E0 + 8244));
  if ( a7 )
    ndisInitPDQAWM((char *)DeferredContext);
  v10 = (struct KPushLockBase *)qword_1C00837E0;
  *((_QWORD *)a2 + 2) = *((_QWORD *)a2 + 1);
  *((_QWORD *)a2 + 3) = DeferredContext;
  *((_QWORD *)a2 + 1) = &unk_1C0074EA0;
