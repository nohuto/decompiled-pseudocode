/*
 * XREFs of ?ndisMRestartMiniportInner@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_RESTART_ATTRIBUTES@@@Z @ 0x1C00E3284
 * Callers:
 ...
 *     ndisLWM5RestartMinport @ 0x1C0059590 (ndisLWM5RestartMinport.c)
