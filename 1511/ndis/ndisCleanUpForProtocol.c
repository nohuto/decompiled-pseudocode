/*
 * XREFs of ndisCleanUpForProtocol @ 0x1C00993D0
 * Callers:
...
void __fastcall ndisCleanUpForProtocol(__int64 a1, int a2)
{
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_q(0x37u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, a1);
  v3 = *(_DWORD **)(a1 + 16);
  if ( *(_DWORD *)(a1 + 432) )
  {
    v6 = 0;
  ...
  if ( (unsigned __int8)byte_1C008370D >= 4u )
    WPP_SF_q(0x38u, &WPP_e424ef97f2a14b5e115affaca25388e5_Traceguids, a1);
}
