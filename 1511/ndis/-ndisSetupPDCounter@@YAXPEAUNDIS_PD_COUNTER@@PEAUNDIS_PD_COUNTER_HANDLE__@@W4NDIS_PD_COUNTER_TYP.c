/*
 * XREFs of ?ndisSetupPDCounter@@YAXPEAUNDIS_PD_COUNTER@@PEAUNDIS_PD_COUNTER_HANDLE__@@W4NDIS_PD_COUNTER_TYPE@@PEAUNDIS_PD_ASSOCIATION@@E@Z @ 0x1C00DAEFC
 * Callers:
...
void __fastcall ndisSetupPDCounter(__int64 a1, __int64 a2, int a3, __int64 a4, char a5)
{
  ...
  *(_QWORD *)(a1 + 56) = a2;
  v7 = (struct KPushLockBase *)qword_1C00837E0;
  *(_BYTE *)(a1 + 68) = a5;
  *(_DWORD *)(a1 + 64) = a3;
  *(_QWORD *)(a1 + 40) = a4;
