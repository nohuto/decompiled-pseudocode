/*
 * XREFs of ?NdisTraceLoggingRareFilterPath@@YAXPEAU_NDIS_FILTER_DRIVER_BLOCK@@W4NdisTLFilterEvent@@H@Z @ 0x1C00DC2D8
 * Callers:
  ...
  if ( a1 )
  {
    if ( (unsigned int)dword_1C0082040 > 5 )
    {
      if ( TlgKeywordOn(a1, 0x200000000000uLL) )
      {
        ...
        v11 = v3;
        v28 = 4;
        TlgWrite((TraceLoggingHProvider)4, &unk_1C0073AA8, v1, (LPCGUID)v2, 8u, &pData);
      }
    }
  }
  else if ( (unsigned int)dword_1C0082040 > 5 && TlgKeywordOn(0LL, 0x200000000000uLL) )
  {
    v16 = 0;
    v19 = 0;
    v14 = &v11;
    ...
    v12[0] = v9;
    v18 = 4;
    TlgWrite((TraceLoggingHProvider)4, &unk_1C007390E, v7, v8, 4u, &pData);
  }
}
