/*
 * XREFs of ?ndisIfGetMiniportStatistics@@YAHPEAU_NDIS_MINIPORT_BLOCK@@PEAXPEAU_NDIS_FILTER_BLOCK@@@Z @ 0x1C0094F08
 * Callers:
        ...
        struct _NDIS_FILTER_BLOCK *a3)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qqq(0x3Cu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a2, a3);
  memset(a2, 0, 0x90uLL);
...
LABEL_9:
  ndisDereferenceMiniportForNsi((__int64)a1, 3u, 0x39u);
LABEL_10:
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qqqL(0x3Du, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a2, a3, SetMiniport);
  return 0LL;
}
