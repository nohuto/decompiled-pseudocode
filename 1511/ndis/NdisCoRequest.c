/*
 * XREFs of NdisCoRequest @ 0x1C00F2720
 * Callers:
 *     <none>
 * Callees:
        ...
        _QWORD *a5)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0x43u, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids, NdisBindingHandle, P, a5);
...
LABEL_29:
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqq(0x44u, &WPP_d29b05a9accab437aa613ff999d87cb7_Traceguids, NdisBindingHandle, P, a5);
  return v13;
}
