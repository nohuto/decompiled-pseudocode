/*
 * XREFs of Duplicate802_11AttachAttributesCommon @ 0x1C006F110
 * Callers:
 *     Duplicate802_11AttachAttributes @ 0x1C006F0F4 (Duplicate802_11AttachAttributes.c)
 * Callees:
 *     NdisAllocateMemoryWithTag @ 0x1C00241D0 (NdisAllocateMemoryWithTag.c)
 *     memmove @ 0x1C0026C00 (memmove.c)
 *     memset @ 0x1C0026F40 (memset.c)
 *     PrivateULongMult @ 0x1C006FBD4 (PrivateULongMult.c)
 */
        ...
        _QWORD *a9)
{
  ...
  size_t v98; // [rsp+2Ch] [rbp-4Ch] BYREF
  unsigned int v99; // [rsp+34h] [rbp-44h]
  size_t v100; // [rsp+38h] [rbp-40h] BYREF
  int v101; // [rsp+40h] [rbp-38h] BYREF
  ...
  *a9 = 0LL;
  ...
  if ( v18 )
  {
    ...
    {
      v17 = PrivateULongMult(v23, 8LL, v103);
      if ( v17 )
        return v17;
      if ( v10 + v103[0] < v10 )
        return (unsigned int)-1073676267;
    ...
    if ( v14 >= 3 )
    {
      ...
      if ( (_DWORD)v24 )
      {
        ...
        {
          v17 = PrivateULongMult(v24, 8LL, (char *)&v100 + 4);
          if ( v17 )
            return v17;
          if ( v10 + HIDWORD(v100) < v10 )
            return (unsigned int)-1073676267;
          v10 += HIDWORD(v100);
        }
      }
  ...
  if ( v14 >= 2 )
  {
    ...
    *(_QWORD *)&v103[1] = v26;
    ...
    if ( v11 )
    {
      ...
      {
        v17 = PrivateULongMult(v33, 8LL, &v102);
        if ( v17 )
          return v17;
        v35 = v34 + v102;
        if ( v34 + (unsigned int)v102 < v34 )
          return (unsigned int)-1073676267;
        v32 = v34 + v102;
        a5 = v35;
      }
  ...
  {
    v17 = PrivateULongMult(v42, 3LL, &v98);
    if ( v17 )
      return v17;
    v43 = v98 + 72;
    a7 = v98 + 72;
    if ( (unsigned int)v98 >= 0xFFFFFFB8 )
      return (unsigned int)-1073676267;
  }
  v44 = *(unsigned int *)(v40 + 32);
  if ( (_DWORD)v44 && *(_QWORD *)(v40 + 40) )
  {
    v17 = PrivateULongMult(v44, 6LL, (char *)&v98 + 4);
    if ( v17 )
      return v17;
    v45 = v43 + HIDWORD(v98);
    if ( v43 + HIDWORD(v98) < v43 )
      return (unsigned int)-1073676267;
    v43 += HIDWORD(v98);
    a7 = v45;
  }
  ...
  if ( HIDWORD(v102) )
  {
    ...
    if ( *(_QWORD *)&v103[1] )
    {
      ...
      *(_QWORD *)v51 = *(_QWORD *)v70;
      ...
      v51 = (char *)VirtualAddress + HIDWORD(v102);
      VirtualAddress = v51;
    }
  }
  if ( a5 && v11 )
