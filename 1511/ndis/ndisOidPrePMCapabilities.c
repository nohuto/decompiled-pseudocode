/*
 * XREFs of ndisOidPrePMCapabilities @ 0x1C00C3390
 * Callers:
 *     ndisOidPrePMCurrentCapabilities @ 0x1C00C3520 (ndisOidPrePMCurrentCapabilities.c)
 *     ndisOidPrePMHardwareCapabilities @ 0x1C00C3530 (ndisOidPrePMHardwareCapabilities.c)
 * Callees:
...
unsigned __int8 __fastcall ndisOidPrePMCapabilities(__int64 a1, char a2)
{
  ...
  {
    WPP_SF_qq(0x30u, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v2, v4);
    v7 = byte_1C0083712;
  }
  v8 = *(_QWORD *)(a1 + 24);
  if ( v8
  ...
  if ( (unsigned __int8)v7 >= 4u )
    WPP_SF_qdD(0x31u, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v2, *(_DWORD *)(a1 + 40), v6);
  return v6;
}
