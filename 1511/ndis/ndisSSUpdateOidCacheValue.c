/*
 * XREFs of ndisSSUpdateOidCacheValue @ 0x1C0067720
 * Callers:
 *     ndisOidPostStatistics @ 0x1C000F750 (ndisOidPostStatistics.c)
 * Callees:
    ...
    *((_BYTE *)v3 + 20) = 0;
    if ( !*(_DWORD *)(v4 + 40) )
    {
      ...
      if ( *(_DWORD *)(v1 + 48) >= v6 )
      {
        ...
        {
          WPP_SF_q(0x24u, &WPP_77f927e78de9b0c34f4631dbdb483858_Traceguids, v2);
        }
      }
    }
  }
