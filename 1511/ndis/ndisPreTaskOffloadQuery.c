/*
 * XREFs of ndisPreTaskOffloadQuery @ 0x1C00443A4
 * Callers:
...
char __fastcall ndisPreTaskOffloadQuery(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qqDD(0xCBu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v6, a1, 1, *(_DWORD *)(a2 + 40));
  if ( !*(_QWORD *)(v6 + 4152) )
    goto LABEL_16;
...
LABEL_17:
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
  {
    ...
    LODWORD(v13) = 1;
    WPP_SF_qqDD(0xCCu, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v6, a1, v13, v14);
  }
  return 1;
}
