/*
 * XREFs of ndisMRestoreFilterSettings @ 0x1C0042990
 * Callers:
...
__int64 __fastcall ndisMRestoreFilterSettings(__int64 a1, _QWORD *a2, unsigned __int8 a3)
{
  ...
  {
    WPP_SF_qqd(99LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2, a3);
    a3 = v49;
  }
  v52 = a2 != 0LL;
  v8 = !a2 && !a3;
...
LABEL_99:
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qD(0x64u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, v47);
  return v47;
}
