/*
 * XREFs of ndisMSendPacketsToMiniport @ 0x1C00517C0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendPacketsToMiniport(KSPIN_LOCK *MiniportAdapterHandle, __int64 *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_qqd(0xCu, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, MiniportAdapterHandle, a2, a3);
  v18 = 0;
  ...
  *((_DWORD *)MiniportAdapterHandle + 464) = 0;
  ...
  {
    LODWORD(v17) = a3;
    WPP_SF_qqd(0xDu, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, MiniportAdapterHandle, a2, v17);
  }
}
