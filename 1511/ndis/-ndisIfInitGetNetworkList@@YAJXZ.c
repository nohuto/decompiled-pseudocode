/*
 * XREFs of ?ndisIfInitGetNetworkList@@YAJXZ @ 0x1C0020220
 * Callers:
...
__int64 __fastcall ndisIfInitGetNetworkList(__int64 a1, __int64 a2, __int64 a3)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_(31LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a3);
...
LABEL_23:
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_d(32LL, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, (unsigned int)v4);
