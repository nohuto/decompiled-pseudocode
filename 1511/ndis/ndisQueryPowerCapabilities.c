/*
 * XREFs of ndisQueryPowerCapabilities @ 0x1C00AAE3C
 * Callers:
...
__int64 __fastcall ndisQueryPowerCapabilities(char *NdisAdapterHandle)
{
  ...
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_q(0xDu, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)NdisAdapterHandle);
  ...
  if ( *((_QWORD *)NdisAdapterHandle + 487) )
  {
    ...
    if ( Irp )
    {
      ...
      *(_WORD *)&CurrentStackLocation[-1].MajorFunction = 2331;
      ...
      {
        if ( (unsigned __int8)byte_1C0083715 >= 4u )
          WPP_SF_qD(0xFu, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)NdisAdapterHandle, v18);
        goto LABEL_19;
      }
...
LABEL_19:
    ...
    if ( (unsigned __int8)byte_1C0083715 >= 2u )
      WPP_SF_q(0xEu, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)NdisAdapterHandle);
    NdisWriteErrorLogEntry(NdisAdapterHandle, 0xC0001389, 0);
    v2 = -1073741670;
  }
LABEL_20:
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_qD(0x10u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)NdisAdapterHandle, v2);
  return v2;
}
