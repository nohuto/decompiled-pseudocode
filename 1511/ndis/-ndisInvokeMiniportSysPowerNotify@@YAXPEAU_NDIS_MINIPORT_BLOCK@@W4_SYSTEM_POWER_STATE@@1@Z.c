/*
 * XREFs of ?ndisInvokeMiniportSysPowerNotify@@YAXPEAU_NDIS_MINIPORT_BLOCK@@W4_SYSTEM_POWER_STATE@@1@Z @ 0x1C001268C
 * Callers:
        ...
        enum _SYSTEM_POWER_STATE a3)
{
  ...
  if ( DriverHandle->SysPowerNotifyHandler && (a1->PnPFlags & 0x4000) == 0 )
  {
    ...
    if ( (unsigned __int8)byte_1C0083715 >= 4u )
      WPP_SF_q(11LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, a1);
    DriverHandle->SysPowerNotifyHandler(a1->MiniportAdapterContext, (_NDIS_MINIPORT_SYSPOWER_NOTIFY *)v5);
    if ( (unsigned __int8)byte_1C0083715 >= 4u )
      WPP_SF_q(12LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, a1);
  }
}
