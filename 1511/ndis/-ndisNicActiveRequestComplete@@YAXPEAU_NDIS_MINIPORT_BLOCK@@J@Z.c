/*
 * XREFs of ?ndisNicActiveRequestComplete@@YAXPEAU_NDIS_MINIPORT_BLOCK@@J@Z @ 0x1C0069868
 * Callers:
...
void __fastcall ndisNicActiveRequestComplete(struct _NDIS_MINIPORT_BLOCK *a1, int a2)
{
  ...
  if ( a2 )
  {
    ...
    if ( (unsigned __int8)byte_1C0083715 >= 2u )
      WPP_SF_dq(0x12u, &WPP_8e7c3e95f556d2aee27bc2d35efa6f2a_Traceguids, a2, a1);
  }
  else
  {
