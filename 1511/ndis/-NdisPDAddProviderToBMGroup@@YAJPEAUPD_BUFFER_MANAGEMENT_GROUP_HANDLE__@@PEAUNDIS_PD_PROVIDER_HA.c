/*
 * XREFs of ?NdisPDAddProviderToBMGroup@@YAJPEAUPD_BUFFER_MANAGEMENT_GROUP_HANDLE__@@PEAUNDIS_PD_PROVIDER_HANDLE__@@@Z @ 0x1C00D79B0
 * Callers:
 *     <none>
 * Callees:
        ...
        struct NDIS_PD_PROVIDER_HANDLE__ *a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083724 >= 4u )
    WPP_SF_qq(0x48u, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, a1, a2);
  ...
  if ( *(char **)v7 != v7 )
  {
    if ( *(_QWORD *)(*(_QWORD *)(*((_QWORD *)i + 7) + 5488LL) + 72LL) == *(_QWORD *)(*(_QWORD *)(*(_QWORD *)(*(_QWORD *)v7 + 32LL)
                                                                                               + 5488LL)
                                                                                   + 72LL) )
    {
      v9 = (char **)*((_QWORD *)a1 + 5);
  ...
  *((_QWORD *)a1 + 5) = v6;
  if ( (unsigned __int8)byte_1C0083724 >= 4u )
  {
    WPP_SF_qq(
      ...
      a1,
      *(_QWORD *)(*(_QWORD *)(*((_QWORD *)i + 7) + 5488LL) + 72LL));
LABEL_17:
    if ( (unsigned __int8)byte_1C0083724 >= 4u )
    {
      v11 = v2;
      WPP_SF_qqd(0x4Au, &WPP_1c2478f64746bbfe15c5e36ca64a789d_Traceguids, a1, a2, v11);
    }
  }
