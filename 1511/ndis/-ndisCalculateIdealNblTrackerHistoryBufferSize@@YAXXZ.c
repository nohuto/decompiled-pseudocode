/*
 * XREFs of ?ndisCalculateIdealNblTrackerHistoryBufferSize@@YAXXZ @ 0x1C00D0460
 * Callers:
 *     ?ndisNblTrackerInitialize@@YAXXZ @ 0x1C00FC150 (-ndisNblTrackerInitialize@@YAXXZ.c)
 * Callees:
 *     __security_check_cookie @ 0x1C00264F0 (__security_check_cookie.c)
 *     memset @ 0x1C0026F40 (memset.c)
 *     ?ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z @ 0x1C010074C (-ndisIsValidNblTrackerHistoryBufferSize@@YA_N_KK@Z.c)
 */
