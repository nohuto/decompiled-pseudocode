/*
 * XREFs of ndisIovCreateVPort @ 0x1C00D2E78
 * Callers:
...
char __fastcall ndisIovCreateVPort(__int64 a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_q(0x2Du, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v4);
...
LABEL_45:
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x2Eu, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v4, *(_DWORD *)(a1 + 40));
  return v7;
}
