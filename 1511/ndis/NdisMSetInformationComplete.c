/*
 * XREFs of NdisMSetInformationComplete @ 0x1C00406E0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall NdisMSetInformationComplete(ULONG_PTR BugCheckParameter2, unsigned int a2)
{
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qD(0x47u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, BugCheckParameter2, a2);
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_q(0x48u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, BugCheckParameter2);
}
