/*
 * XREFs of ndisMediaDisconnectComplete @ 0x1C005F230
 * Callers:
 *     <none>
 * Callees:
        ...
        struct _TlgProvider_t *Context)
{
  ...
  {
    WPP_SF_q(0x11u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)Context);
  ...
  if ( (AnnotationFunc_high & 0x200) != 0 )
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0083715 >= 4u )
        WPP_SF_q(0x13u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)Context);
  ...
  {
    if ( (unsigned __int8)byte_1C0083715 >= 4u )
      WPP_SF_q(0x12u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)Context);
    Context[8].ProviderMetadataPtr = 0LL;
    Context[29].LevelPlus1 = 0;
    KeReleaseSpinLock(&Context[1].RegHandle, v6);
  }
  if ( (unsigned __int8)byte_1C0083715 >= 4u )
    WPP_SF_q(0x14u, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, (__int64)Context);
}
