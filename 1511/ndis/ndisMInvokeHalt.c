/*
 * XREFs of ndisMInvokeHalt @ 0x1C0098F98
 * Callers:
...
void __fastcall ndisMInvokeHalt(__int64 a1, _NDIS_HALT_ACTION a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0xCDu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, v2);
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qq(0xCEu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, v2);
}
