/*
 * XREFs of ndisMSendCompleteSG @ 0x1C0050C70
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisMSendCompleteSG(struct _NDIS_MINIPORT_BLOCK *a1, struct _NDIS_PACKET *a2, unsigned int a3)
{
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_qqd(0x24u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1, a2, a3);
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_qq(0x25u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, a1, a2);
}
