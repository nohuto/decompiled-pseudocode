/*
 * XREFs of ndisMDeferredSend @ 0x1C004F660
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisMDeferredSend(struct _NDIS_MINIPORT_BLOCK *a1)
{
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_q(0x18u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, (__int64)a1);
  while ( a1->FirstPendingPacket && (a1->Flags & 0x400000) != 0 )
  {
    ...
    if ( v5 != (struct _NDIS_MINIPORT_BLOCK *)&a1->PacketList )
      a1->FirstPendingPacket = (_NDIS_PACKET *)&v5[-1].PendingMacAddress.Address[10];
...
LABEL_11:
  ...
  if ( (unsigned __int8)byte_1C008370A >= 4u )
    WPP_SF_q(0x19u, &WPP_28e0ced77d8c435d2081eccb5146e802_Traceguids, (__int64)a1);
  return 0;
}
