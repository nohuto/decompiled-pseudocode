/*
 * XREFs of ?CoalesceFilterAttachDuringBoot@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUBindStack@2@@Z @ 0x1C00A4240
 * Callers:
        ...
        struct Ndis::BindStack *a3)
{
  ...
  if ( this->InitMode )
  {
      ...
      if ( *(_DWORD *)(v9 + 72) || *(_DWORD *)(v9 + 44) )
      {
        ...
        if ( (*(_DWORD *)(v10 + 56) & 1) == 0 && !*(_QWORD *)(v10 + 72) && !*(_BYTE *)(v9 + 24) )
        {
            ...
            && (unsigned __int8)byte_1C0083723 >= 4u )
          {
            ...
            WPP_SF_Zq(0x23u, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v16, v15);
          }
    ...
    if ( (Lock != 0) != ((Lock & 0xFFFFFEFF) != 0) || !a2->ShortRef.SpinLock )
    {
      ...
      v14 = (unsigned __int8)byte_1C0083723 < 4u;
      *(_BYTE *)(a2->ShortRef.SpinLock + 5312) = 1;
      if ( !v14 )
      {
        ndisGetBindLinkNameForTracing(this, (struct NDIS_PNPTRACE_LOCALS *)&v15);
        WPP_SF_Zq(0x25u, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v16, v15);
      }
    }
  ...
  else
  {
    ...
    if ( (v5 != 0) != ((v5 & 0xFFFFFEFF) != 0) || !a2->ShortRef.SpinLock )
    {
      ...
      *(_BYTE *)(a2->ShortRef.SpinLock + 5312) = 1;
      ...
      {
        ndisGetBindLinkNameForTracing(this, (struct NDIS_PNPTRACE_LOCALS *)&v15);
        WPP_SF_Zq(0x27u, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v16, v15);
      }
    }
    v6 = HIDWORD(a2->Lock);
    ...
    if ( (v6 != 0) != ((v6 & 0xFFFFFFBF) != 0) || !a2->ShortRef.SpinLock )
    {
      ...
      *(_BYTE *)(a2->ShortRef.SpinLock + 5312) = 1;
      if ( !v14 )
      {
        ...
        v13 = 40;
LABEL_47:
        WPP_SF_Zq(v13, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, v16, v15);
      }
    }
  }
}
