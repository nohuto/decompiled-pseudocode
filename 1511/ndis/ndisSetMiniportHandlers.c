/*
 * XREFs of ndisSetMiniportHandlers @ 0x1C00E2FB0
 * Callers:
...
void __fastcall ndisSetMiniportHandlers(__int64 a1)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x8Eu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1);
  v2 = *(_BYTE *)(a1 + 32) < 6u;
  ...
  *(_QWORD *)(a1 + 2336) = a1;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(0x8Fu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1);
}
