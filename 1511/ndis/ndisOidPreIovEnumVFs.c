/*
 * XREFs of ndisOidPreIovEnumVFs @ 0x1C0065470
 * Callers:
 *     <none>
 * Callees:
...
char __fastcall ndisOidPreIovEnumVFs(__int64 *a1)
{
  ...
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qq(0x29u, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, a1, v1);
  *(_DWORD *)(v2 + 60) = 0;
...
LABEL_48:
  if ( (unsigned __int8)byte_1C0083721 >= 4u )
    WPP_SF_qD(0x2Au, &WPP_3dc44b73c4002d6e64e2a4fa1641c080_Traceguids, v1, v6[10]);
  return v7;
}
