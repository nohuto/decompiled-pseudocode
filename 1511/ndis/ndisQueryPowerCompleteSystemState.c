/*
 * XREFs of ndisQueryPowerCompleteSystemState @ 0x1C0013060
 * Callers:
 *     <none>
 * Callees:
...
__int64 __fastcall ndisQueryPowerCompleteSystemState(int a1, unsigned int *a2, __int64 a3)
{
  ...
  {
    WPP_SF_qD(34LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, a3, a2[12]);
    v5 = byte_1C0083715;
  }
  v6 = a2[12];
  if ( (int)v6 < 0 )
  {
    if ( (unsigned __int8)v5 >= 4u )
      WPP_SF_qD(35LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, a3, v6);
  ...
  else
  {
    ...
    {
      if ( (unsigned __int8)byte_1C0083715 >= 4u )
        WPP_SF_qD(36LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, a3, (unsigned int)v7);
      if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
        Template_jqxq(
          v8,
    ...
    if ( (unsigned __int8)byte_1C0083715 >= 4u )
      WPP_SF_q(37LL, &WPP_22c072e0c2b3ae0d66e251cc0b513786_Traceguids, a3);
