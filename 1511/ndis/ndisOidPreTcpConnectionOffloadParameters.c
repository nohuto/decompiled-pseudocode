/*
 * XREFs of ndisOidPreTcpConnectionOffloadParameters @ 0x1C00C12C0
 * Callers:
 *     <none>
 * Callees:
...
unsigned __int8 __fastcall ndisOidPreTcpConnectionOffloadParameters(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(0xE0u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v2, v4);
    v7 = byte_1C0083712;
  }
  ...
  {
    v10 = v3;
    WPP_SF_qdD(0xE1u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v2, *(_DWORD *)(a1 + 40), v10);
  }
  return v3;
}
