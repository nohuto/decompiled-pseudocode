/*
 * XREFs of ndisSetMiniportRSSParameters @ 0x1C0023250
 * Callers:
...
unsigned __int8 __fastcall ndisSetMiniportRSSParameters(__int64 a1, __int64 a2, int *a3)
{
  ...
  {
    WPP_SF_qq(145LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2);
    v6 = byte_1C0083712;
  }
  *(_DWORD *)(a2 + 56) = 0;
  v7 = 1;
...
LABEL_27:
      ...
      v17 = 147LL;
LABEL_26:
      WPP_SF_qq(v17, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2);
      v6 = byte_1C0083712;
      goto LABEL_27;
    }
    if ( v11 >= 3u )
    ...
    if ( v8 < v10 )
    {
      *(_DWORD *)(a2 + 56) = v10;
      ...
      v16 = 149LL;
LABEL_23:
      WPP_SF_qqd(v16, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2, -1073676268);
      v6 = byte_1C0083712;
      goto LABEL_17;
    }
  }
...
LABEL_36:
    ...
    v18 = 150LL;
LABEL_35:
    WPP_SF_qqd(v18, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2, 0);
    v6 = byte_1C0083712;
    goto LABEL_36;
  }
...
LABEL_17:
  *a3 = v14;
  ...
  {
    LODWORD(v19) = v7;
    WPP_SF_qqDD(153LL, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2, v19, v14);
  }
