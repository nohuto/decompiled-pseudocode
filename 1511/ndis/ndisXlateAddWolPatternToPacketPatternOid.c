/*
 * XREFs of ndisXlateAddWolPatternToPacketPatternOid @ 0x1C00C5A2C
 * Callers:
...
__int64 __fastcall ndisXlateAddWolPatternToPacketPatternOid(__int64 a1, _BYTE *a2)
{
  ...
  *a2 = 0;
    ...
    if ( PoolWithTag )
    {
      ...
      *((_DWORD *)v8 + 4) = *(_DWORD *)(a1 + 48);
      ...
      if ( (unsigned __int8)byte_1C0083712 >= 4u )
        WPP_SF_q(0x70u, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1);
      ExFreePoolWithTag(v8, 0);
    }
    else if ( (unsigned __int8)byte_1C0083712 >= 4u )
    {
      WPP_SF_q(0x6Fu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1);
    }
    v3 = -1073741670;
    *a2 = 1;
  }
  ...
  {
    if ( (unsigned __int8)byte_1C0083712 >= 4u )
      WPP_SF_qD(0x6Eu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, v6);
    *a2 = 1;
