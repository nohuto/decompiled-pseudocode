/*
 * XREFs of ndisPeriodicReceivesTimer @ 0x1C000FDB0
 * Callers:
 *     <none>
 * Callees:
        ...
        PVOID SystemSpecific3)
{
  ...
  v4 = 0LL;
  v5 = (char *)qword_1C0082D80 + 64 * (unsigned __int64)KeGetPcr()->Prcb.Number;
  ...
  if ( *(char **)v5 == v5 )
  {
    *((_DWORD *)qword_1C0082D78 + KeGetPcr()->Prcb.Number) = 0;
  }
  else
  {
    v7 = DueTime;
