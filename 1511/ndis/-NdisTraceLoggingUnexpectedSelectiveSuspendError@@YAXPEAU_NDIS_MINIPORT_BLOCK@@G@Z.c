/*
 * XREFs of ?NdisTraceLoggingUnexpectedSelectiveSuspendError@@YAXPEAU_NDIS_MINIPORT_BLOCK@@G@Z @ 0x1C006E648
 * Callers:
...
void __fastcall NdisTraceLoggingUnexpectedSelectiveSuspendError(const struct _TlgProvider_t *a1)
{
  ...
  if ( (unsigned int)dword_1C0082040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v7 = 16;
      v10 = 4;
      TlgWrite((TraceLoggingHProvider)4, &unk_1C0073B50, v2, v3, 4u, &pData);
    }
  }
}
