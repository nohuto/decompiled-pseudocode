/*
 * XREFs of ndisSubmitIdleRequest @ 0x1C0068170
 * Callers:
...
__int64 __fastcall ndisSubmitIdleRequest(struct _NDIS_MINIPORT_BLOCK *a1, unsigned __int8 a2)
{
  ...
  if ( (SelectiveSuspend->Flags.Value & 4) != 0 || !ndisReferenceMiniport((__int64)a1) )
  {
  ...
  else
  {
    ...
    if ( v8 == 259 )
    {
      if ( (unsigned __int8)byte_1C0083716 >= 4u )
        WPP_SF_qD(0xEu, &WPP_77f927e78de9b0c34f4631dbdb483858_Traceguids, (__int64)a1, a2);
    ...
    else
    {
      ...
      if ( (unsigned __int8)byte_1C0083716 >= 2u )
        WPP_SF_dq(0xDu, &WPP_77f927e78de9b0c34f4631dbdb483858_Traceguids, v8, a1);
      if ( (Microsoft_Windows_NDISEnableBits & 0x800) != 0 )
      {
        LODWORD(v16) = v8;
