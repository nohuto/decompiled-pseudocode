/*
 * XREFs of ndisRejectUnsupportedPMOffloads @ 0x1C00C467C
 * Callers:
    ...
    if ( !ndisIsPMProtocolOffloadSupported(*(_DWORD *)(i + 60), (__int64)MiniportAdapterHandle) )
    {
      ...
      if ( v5 == v4 )
      {
        if ( (unsigned __int8)byte_1C0083715 >= 2u )
          WPP_SF_d(0x7Au, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v5);
      }
      else
      {
        memset(v11, 0, sizeof(v11));
        ...
        *(_DWORD *)&v11[48] = 4;
        ...
        if ( (unsigned __int8)byte_1C0083715 >= 2u )
          WPP_SF_d(0x7Bu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, SetMiniport);
      }
      return KeReleaseSemaphore((PRKSEMAPHORE)(MiniportAdapterHandle + 4008), 0, 1, 0);
    }
  }
