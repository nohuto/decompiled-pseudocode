/*
 * XREFs of ?NdisTraceLoggingGreTaskHardwareOffloads@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OFFLOAD@@@Z @ 0x1C0015B70
 * Callers:
...
void __fastcall NdisTraceLoggingGreTaskHardwareOffloads(const struct _TlgProvider_t *a1, struct _NDIS_OFFLOAD *a2)
{
  __int64 v2; // rcx
  const GUID *v3; // r8
  __int64 v4; // r9
  ...
  if ( (unsigned int)dword_1C0082040 > 5 )
  {
    if ( TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      ...
      v23 = 1LL;
      v25 = 4LL;
      TlgWrite(v7, &unk_1C0072F3D, v3, (LPCGUID)v4, 8u, &pData);
    }
  }
}
