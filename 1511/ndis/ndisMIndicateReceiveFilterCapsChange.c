/*
 * XREFs of ndisMIndicateReceiveFilterCapsChange @ 0x1C001623C
 * Callers:
    ...
    if ( v9 >= 0x38u )
    {
      if ( a3[1] )
      {
        if ( a5 )
          ...
          v10 = a2 == 1073872912 ? *(void **)(a1 + 3592) : *(void **)(a1 + 3584);
        if ( v10 )
        {
          v11 = 84LL;
          if ( v9 < 0x54u )
          ...
          if ( a2 == 1073872912 )
          {
            *(_DWORD *)(a1 + 3580) = *((_DWORD *)a3 + 3);
            *(_DWORD *)(a1 + 3576) = *((_DWORD *)a3 + 2);
          }
          return 1;
        }
      }
