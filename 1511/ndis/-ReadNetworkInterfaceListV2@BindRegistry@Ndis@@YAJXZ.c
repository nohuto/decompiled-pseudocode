/*
 * XREFs of ?ReadNetworkInterfaceListV2@BindRegistry@Ndis@@YAJXZ @ 0x1C00A7A68
 * Callers:
...
__int64 __fastcall Ndis::BindRegistry::ReadNetworkInterfaceListV2(Ndis::BindRegistry *this)
{
  ...
  v1 = KRegKey::Open(
         (KRegKey *)&v13,
         8u,
         (wchar_t *)L"\\Registry\\Machine\\System\\CurrentControlSet\\Control\\NetworkSetup2\\Interfaces",
         0LL);
  v2 = v1;
  if ( v1 == -1073741772 )
    goto LABEL_18;
