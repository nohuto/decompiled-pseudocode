/*
 * XREFs of ndisIfRemoveIfBlockMiniportAssociation @ 0x1C009880C
 * Callers:
...
void __fastcall ndisIfRemoveIfBlockMiniportAssociation(__int64 a1, __int64 a2, int a3)
{
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qq(0xCFu, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a2);
  ...
  *(_DWORD *)(*(_QWORD *)(a2 + 4096) + 1192LL) = a3;
  ...
  if ( (unsigned __int8)byte_1C008371D >= 4u )
    WPP_SF_qq(0xD0u, &WPP_9ad27b6b93e84bf4e83fa1333fca0937_Traceguids, a1, a2);
}
