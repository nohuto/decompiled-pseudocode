/*
 * XREFs of ?UpdateProtocols@BindRegistry@Ndis@@YA_NPEAU_NDIS_MINIPORT_BLOCK@@AEAV?$KArray@V?$KPtr@UNDIS_BIND_PROTOCOL_LINK@@U?$KDeletePtr@UNDIS_BIND_PROTOCOL_LINK@@@@@@@Rtl@@1W4Flags@ReadBindingsOptions@2@@Z @ 0x1C00A5F3C
 * Callers:
...
char __fastcall Ndis::BindRegistry::UpdateProtocols(_NDIS_MINIPORT_BLOCK *a1, __int64 a2, __int64 a3, char a4)
{
  unsigned __int64 v4; // rax
  unsigned __int64 v5; // rbx
  unsigned __int64 v6; // rsi
  _NDIS_MINIPORT_BLOCK *v10; // r10
  struct NDIS_BIND_PROTOCOL_LINK **v11; // r9
  __int64 v13; // r14
  __int64 v14; // rdi
  KRef<NDIS_BIND_PROTOCOL_DRIVER>::KRefHolder *p; // rcx
  KRef<NDIS_BIND_PROTOCOL_DRIVER>::KRefHolder *v16; // rdx
  int v17; // r8d
  Ndis::BindState *v18; // rdi
  char v19; // al
  unsigned __int16 v20; // cx
  int v21; // r8d
  Ndis::BindState *v22; // rdi
  char v23; // al
  unsigned __int16 v24; // cx
  __int64 v25; // rsi
  Ndis::BindState *v26; // rdi
  int v27; // r8d
  char v28; // al
...
LABEL_71:
  ...
  while ( 1 )
  {
    ...
    v11 = (struct NDIS_BIND_PROTOCOL_LINK **)(*(_QWORD *)(a3 + 16) + 8 * v6);
    if ( v5 >= *(unsigned int *)(a2 + 8) )
      break;
    v13 = *(_QWORD *)(a2 + 16);
    v14 = *(_QWORD *)(v13 + 8 * v5);
    p = (*v11)->BindDriver._p;
    v16 = *(KRef<NDIS_BIND_PROTOCOL_DRIVER>::KRefHolder **)(v14 + 104);
    if ( v16 == p )
    {
      v17 = *(_DWORD *)(v14 + 44);
...
LABEL_6:
  ...
  if ( Ndis::BindRegistry::AddBindingToSet<NDIS_BIND_PROTOCOL_LINK>(v10, a2, v5, v11) )
    goto LABEL_5;
  return 0;
}
