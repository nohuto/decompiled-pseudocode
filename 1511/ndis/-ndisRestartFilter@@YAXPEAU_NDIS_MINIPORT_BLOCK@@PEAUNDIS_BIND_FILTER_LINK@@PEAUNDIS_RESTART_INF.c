/*
 * XREFs of ?ndisRestartFilter@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUNDIS_BIND_FILTER_LINK@@PEAUNDIS_RESTART_INFORMATION@@@Z @ 0x1C00A1020
 * Callers:
        ...
        struct NDIS_RESTART_INFORMATION *a3)
{
  ...
  if ( restarted )
  {
      ...
      && (unsigned __int8)byte_1C0083723 >= 4u )
    {
      ...
      if ( (unsigned __int8)byte_1C0083723 >= 4u )
        WPP_SF_Zq(0x15u, &WPP_f895400b377d408c29ede7c9eddd0dec_Traceguids, v13, v12);
    }
  ...
  else
  {
      ...
      && (unsigned __int8)byte_1C0083723 >= 4u )
    {
      ndisGetBindLinkNameForTracing(a2, (struct NDIS_PNPTRACE_LOCALS *)&v12);
      if ( (unsigned __int8)byte_1C0083723 >= 4u )
        WPP_SF_Zq(0x14u, &WPP_f895400b377d408c29ede7c9eddd0dec_Traceguids, v13, v12);
    }
