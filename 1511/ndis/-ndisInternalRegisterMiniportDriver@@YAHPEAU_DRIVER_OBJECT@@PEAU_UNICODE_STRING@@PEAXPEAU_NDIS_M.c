/*
 * XREFs of ?ndisInternalRegisterMiniportDriver@@YAHPEAU_DRIVER_OBJECT@@PEAU_UNICODE_STRING@@PEAXPEAU_NDIS_MINIPORT_DRIVER_CHARACTERISTICS@@PEAPEAX@Z @ 0x1C0021D94
 * Callers:
 *     NdisMRegisterMiniportDriver @ 0x1C00AA0A0 (NdisMRegisterMiniportDriver.c)
 ...
 *     ndisGetServiceNameFromRegPath @ 0x1C00AA10C (ndisGetServiceNameFromRegPath.c)
 */
        ...
        void **a5)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(95LL, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, DriverObject);
...
LABEL_78:
  ...
  if ( !MinorNdisVersion
    || (v18 = a4->DirectOidRequestHandler == 0LL, v18 == (a4->CancelDirectOidRequestHandler == 0LL)) )
  {
    v19 = 1313425732LL;
    if ( (a4->Flags & 1) == 0 )
      v19 = 1313687876LL;
    if ( IoAllocateDriverObjectExtension(DriverObject, (PVOID)v19, a2->Length + 1194, &DriverObjectExtension) < 0 )
    {
      v24 = -1073741670;
      goto LABEL_57;
    }
    v21 = (_NDIS_M_DRIVER_BLOCK *)operator new(v20, DriverObjectExtension);
    v6 = v21;
    if ( v21 )
    {
      v21->UnhookedCharacteristics._p = 0LL;
      v21->HookRegistered = 0;
      memset(v21, 0, sizeof(_NDIS_M_DRIVER_BLOCK));
    ...
    ndisInitializeRef(&v6->Ref, v22);
    v23 = a5;
    *a5 = v6;
    v24 = ndisMInvokeSetOptions(v6);
    if ( v24 )
    {
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(96LL, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, DriverObject);
  v24 = -1073676283;
...
LABEL_57:
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(97LL, &WPP_6d2291d8c38fd3ff1a6681445a412419_Traceguids, v6);
  return v24;
}
