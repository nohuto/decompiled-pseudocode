/*
 * XREFs of ndisSetAddWakeUpPattern @ 0x1C00C4AC8
 * Callers:
 ...
 *     ndisGetNewPatternEntryId @ 0x1C0097548 (ndisGetNewPatternEntryId.c)
 *     ndisPMPatternIdExist @ 0x1C00ACF34 (ndisPMPatternIdExist.c)
...
__int64 __fastcall ndisSetAddWakeUpPattern(__int64 a1, __int64 a2, _BYTE *a3)
{
  ...
  {
    WPP_SF_qq(0x1Au, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, a2);
    v4 = a2 + 72;
  }
  *(_QWORD *)(a1 + 192) = 0LL;
  *(_DWORD *)(a2 + 56) = 0;
...
LABEL_11:
    ...
    if ( (unsigned __int8)byte_1C0083712 >= 2u )
      WPP_SF_(0x1Cu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids);
    goto LABEL_44;
  }
...
LABEL_24:
    ...
    if ( v23 > 0xFFFF && ndisPMPatternIdExist(v16, v23) )
    {
      if ( (unsigned __int8)byte_1C0083715 >= 2u )
        WPP_SF_d(0x1Bu, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, v24);
    }
    else
    {
...
LABEL_44:
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qdD(0x1Du, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, (unsigned __int8)*a3, v11);
  return v11;
}
