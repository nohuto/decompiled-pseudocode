/*
 * XREFs of ndisIfReadInterfaceAddDeviceParameters @ 0x1C009BDDC
 * Callers:
...
__int64 __fastcall ndisIfReadInterfaceAddDeviceParameters(unsigned int *a1)
{
  ...
  {
    v17 = 0;
    if ( KRegKey::QueryValueUlong((KRegKey *)&Handle, L"NetLuidIndex", &v17) < 0
      || (v18 = 0, KRegKey::QueryValueUlong((KRegKey *)&Handle, L"IfType", &v18) < 0)
      || (v3 = v17,
          *((_WORD *)a1 + 11) = v18,
          *((_QWORD *)a1 + 2) = *((_QWORD *)a1 + 2) & 0xFFFF000000000000uLL | ((unsigned __int64)(v3 & 0xFFFFFF) << 24),
          KRegKey::QueryValueUlong((KRegKey *)&Handle, L"PhysicalMediaType", a1 + 7) < 0)
      || (*((_BYTE *)a1 + 24) = 1, KRegKey::QueryValueUlong((KRegKey *)&Handle, L"Characteristics", a1 + 15) < 0) )
    {
      v2 = -1073741491;
    }
    else
    {
      ...
      if ( v2 >= 0 )
      {
        ...
        KPtr<Rtl::KString,KDeletePtr<Rtl::KString>>::reset(a1 + 10, v4);
        if ( *((_QWORD *)a1 + 5) )
          v2 = 0;
        else
          v2 = -1073741670;
