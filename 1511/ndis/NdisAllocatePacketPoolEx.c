/*
 * XREFs of NdisAllocatePacketPoolEx @ 0x1C00167F0
 * Callers:
 *     NdisAllocatePacketPool @ 0x1C004BA30 (NdisAllocatePacketPool.c)
        ...
        UINT ProtocolReservedLength)
{
  ...
  if ( (unsigned __int8)byte_1C008371C >= 4u )
    WPP_SF_(10LL, &WPP_67b83ca0c3bb11ebff428113d40c1d7a_Traceguids, NumberOfDescriptors);
  *PoolHandle = 0LL;
    ...
    && (PoolWithTag = ExAllocatePoolWithTag(NonPagedPoolNx, 0x70uLL, v10), (v15 = PoolWithTag) != 0LL) )
  {
    ...
    *((_DWORD *)v15 + 4) = 0;
    ...
    v15[11] = ndisGlobalPacketPoolList.Flink;
    v15[12] = &ndisGlobalPacketPoolList;
    if ( Flink->Blink != &ndisGlobalPacketPoolList )
      __fastfail(3u);
    Flink->Blink = v19;
    ...
    if ( (unsigned __int8)byte_1C008371C >= 4u )
      WPP_SF_d(11LL, &WPP_67b83ca0c3bb11ebff428113d40c1d7a_Traceguids, (unsigned int)*Status);
  }
  else
  {
LABEL_28:
