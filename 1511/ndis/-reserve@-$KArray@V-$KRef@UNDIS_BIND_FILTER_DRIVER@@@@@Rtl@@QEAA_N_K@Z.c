/*
 * XREFs of ?reserve@?$KArray@V?$KRef@UNDIS_BIND_FILTER_DRIVER@@@@@Rtl@@QEAA_N_K@Z @ 0x1C00A778C
 * Callers:
    ...
    if ( is_mul_ok(8uLL, a2) )
    {
      ...
      if ( PoolWithTag )
      {
        ...
        if ( *(_QWORD *)(a1 + 16) )
        {
          ...
          {
            do
              KRef<NDIS_BIND_FILTER_DRIVER>::unref((volatile signed __int32 **)(*(_QWORD *)(a1 + 16) + 8LL * v4++));
