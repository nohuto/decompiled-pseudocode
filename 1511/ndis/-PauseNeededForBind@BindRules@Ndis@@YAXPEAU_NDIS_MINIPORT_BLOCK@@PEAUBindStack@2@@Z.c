/*
 * XREFs of ?PauseNeededForBind@BindRules@Ndis@@YAXPEAU_NDIS_MINIPORT_BLOCK@@PEAUBindStack@2@@Z @ 0x1C00A3898
 * Callers:
          ...
          *(_BYTE *)(a2->ShortRef.SpinLock + 5312) = 1;
          if ( (unsigned __int8)v25 >= 4u )
          {
            ...
            if ( (unsigned __int8)byte_1C0083723 >= 4u )
            {
              v26 = 62;
LABEL_56:
              WPP_SF_Zq(v26, &WPP_53645ffc4554d120dec6fc6e0dcf42a1_Traceguids, (__int64 *)v28[1], v28[0]);
            }
          }
        }
        return;
  ...
  if ( LODWORD(a2->Lock) )
  {
    ...
    if ( v20 != v22 || !a2->ShortRef.SpinLock )
    {
      ...
      if ( (unsigned __int8)byte_1C0083723 >= 5u )
      {
        WPP_SF_dd(0xFu, &WPP_eaee9154efd950f31d396ed7715513d8_Traceguids, v21, v21 | 4);
        v27 = byte_1C0083723;
      }
      *(_BYTE *)(a2->ShortRef.SpinLock + 5312) = 1;
  ...
  else
  {
    ...
    if ( v20 != v22 || !a2->ShortRef.SpinLock )
    {
      ...
      if ( (unsigned __int8)byte_1C0083723 >= 5u )
      {
        WPP_SF_dd(0xFu, &WPP_eaee9154efd950f31d396ed7715513d8_Traceguids, v21, v21 & 0xFFFFFFFB);
        v24 = byte_1C0083723;
      }
      *(_BYTE *)(a2->ShortRef.SpinLock + 5312) = 1;
