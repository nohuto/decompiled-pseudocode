/*
 * XREFs of ndisMRestoreOpenHandlers @ 0x1C0012760
 * Callers:
...
__int64 __fastcall ndisMRestoreOpenHandlers(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_qD(88LL, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, (unsigned __int8)a2);
  LOBYTE(a2) = v2;
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    return WPP_SF_q(89LL, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1);
  return result;
}
