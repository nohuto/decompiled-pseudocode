/*
 * XREFs of ?ndisNicActiveAcquire@@YAJPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_DEVICE_OBJECT_OPEN_CONTEXT@@PEAU_NDIS_PM_NIC_ACTIVE@@PEAU_IRP@@@Z @ 0x1C0069480
 * Callers:
        ...
        struct _IRP *a4)
{
  ...
  {
    if ( AoAc->ActiveRef == 1 && (unsigned __int8)byte_1C0083710 >= 4u )
      WPP_SF_LqZ(
        0xCu,
    ...
    if ( v16 != 259 )
    {
      if ( v16 && (unsigned __int8)byte_1C0083715 >= 2u )
        WPP_SF_dq(0xDu, &WPP_8e7c3e95f556d2aee27bc2d35efa6f2a_Traceguids, v16, a1);
  ...
  {
    LODWORD(v18) = v5;
    WPP_SF_qdD(0xEu, &WPP_8e7c3e95f556d2aee27bc2d35efa6f2a_Traceguids, (__int64)a1, ActiveRef, v18);
  }
  return v5;
}
