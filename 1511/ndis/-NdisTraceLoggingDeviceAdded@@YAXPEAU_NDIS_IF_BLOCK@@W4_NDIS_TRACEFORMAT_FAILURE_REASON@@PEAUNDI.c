/*
 * XREFs of ?NdisTraceLoggingDeviceAdded@@YAXPEAU_NDIS_IF_BLOCK@@W4_NDIS_TRACEFORMAT_FAILURE_REASON@@PEAUNDIS_ADDDEVICE_PARAMETERS@@JPEBG@Z @ 0x1C00181C4
 * Callers:
 *     ndisAddDevice @ 0x1C00E1708 (ndisAddDevice.c)
 * Callees:
 *     _TlgWrite @ 0x1C0015DA0 (_TlgWrite.c)
 *     _TlgCreateWsz @ 0x1C0016730 (_TlgCreateWsz.c)
...
void __fastcall NdisTraceLoggingDeviceAdded(const struct _TlgProvider_t *a1, int a2, __int64 a3, int a4)
{
  ...
  if ( a4 < 0 )
  {
    if ( (unsigned int)dword_1C0082040 > 5 && TlgKeywordOn(a1, 0x200000000000uLL) )
    {
      v24 = 0;
      v27 = 0;
      v15 = (const WCHAR *)qword_1C0027C20;
      v30 = 0;
      v33 = 0;
      v22 = &v19;
      v19 = v12;
      ...
      TlgWrite(v16, &unk_1C0073209, v17, v18, 7u, &pData);
    }
  }
  else if ( (unsigned int)dword_1C0082040 > 5 && TlgKeywordOn(a1, 0x200000000000uLL) )
  {
    v7 = *(_DWORD *)(v5 + 4);
    v24 = 0;
    v27 = 0;
    ...
    v32 = 2;
    v8 = (const WCHAR *)qword_1C0027C20;
    ...
    TlgWrite(v9, &unk_1C007418E, v10, v11, 0xAu, &pData);
  }
}
