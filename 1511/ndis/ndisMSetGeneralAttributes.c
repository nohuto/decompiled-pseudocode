/*
 * XREFs of ndisMSetGeneralAttributes @ 0x1C0017278
 * Callers:
...
__int64 __fastcall ndisMSetGeneralAttributes(struct _NDIS_MINIPORT_BLOCK *a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_q(114LL, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1);
  v4 = 0LL;
...
LABEL_32:
  ...
  *(_DWORD *)&a1->TopRecvScaleCapabilities.NumberOfIndirectionTableEntries = v19;
  ...
  if ( (unsigned __int8)ndisWppEnabledLevelPerFlag >= 4u )
    WPP_SF_qD(115LL, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, 0LL);
  return 0LL;
}
