/*
 * XREFs of ndisSetRestoreMulticastList @ 0x1C00C1ABC
 * Callers:
...
void __fastcall ndisSetRestoreMulticastList(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(0x78u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2);
  v5 = v2;
  v6 = *v2;
...
LABEL_18:
  ...
  *(_DWORD *)(a2 + 48) = 6 * *((_DWORD *)v2 + 92);
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(0x79u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2);
}
