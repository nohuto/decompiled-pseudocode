/*
 * XREFs of ndisMSetNicSwitchAttributes @ 0x1C0099964
 * Callers:
...
__int64 __fastcall ndisMSetNicSwitchAttributes(void **a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083714 >= 4u )
    WPP_SF_qq(0x7Cu, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, a2);
  v5 = *(_QWORD *)(a2 + 32);
  v6 = *(_BYTE *)(v5 + 1);
  if ( v6
...
LABEL_27:
  ...
  {
    v23 = v4;
    WPP_SF_qqd(0x7Du, &WPP_bb11c1e4a73cb58e8208f2e892716016_Traceguids, a1, a2, v23);
  }
  return v4;
}
