/*
 * XREFs of ?ndisCoIndicatePromiscNetBuffer@@YAXPEAXPEAU_NDIS_MINIPORT_BLOCK@@PEAU_NDIS_OPEN_BLOCK@@PEAU_NET_BUFFER_LIST@@KKE@Z @ 0x1C002561C
 * Callers:
        ...
        char a7)
{
  ...
  char v16; // r15
  _NDIS_PACKET **v17; // r12
  void *v18; // r14
  __int64 v19; // r13
  _NDIS_PACKET *v20; // rbx
  _NDIS_PACKET *v21; // r8
