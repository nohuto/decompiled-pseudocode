/*
 * XREFs of ndisPreRemoveMiniportWakeUpPattern @ 0x1C00C4054
 * Callers:
...
char __fastcall ndisPreRemoveMiniportWakeUpPattern(__int64 a1, __int64 a2)
{
  ...
  {
    WPP_SF_qq(0x23u, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, a2);
    v6 = byte_1C0083712;
  }
...
LABEL_25:
  ...
  if ( (unsigned __int8)v6 >= 4u )
    WPP_SF_qq(0x24u, &WPP_6e2fc96078008429fd92c28490874609_Traceguids, a1, a2);
  return v4;
}
