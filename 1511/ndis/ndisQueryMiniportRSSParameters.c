/*
 * XREFs of ndisQueryMiniportRSSParameters @ 0x1C00447A0
 * Callers:
...
__int64 __fastcall ndisQueryMiniportRSSParameters(__int64 a1, __int64 a2)
{
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qq(0x84u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, a2);
  v5 = KeAcquireSpinLockRaiseToDpc((PKSPIN_LOCK)(a1 + 96));
  *(_QWORD *)(a1 + 520) = KeGetCurrentThread();
  *(_DWORD *)(a1 + 1856) = 2304664;
  if ( *(_WORD *)(a1 + 2730) )
  {
    v6 = *(_QWORD *)(a1 + 552);
    if ( v6 )
  ...
  if ( (unsigned __int8)byte_1C0083712 >= 4u )
    WPP_SF_qD(0x85u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, a1, v3);
  return v3;
}
