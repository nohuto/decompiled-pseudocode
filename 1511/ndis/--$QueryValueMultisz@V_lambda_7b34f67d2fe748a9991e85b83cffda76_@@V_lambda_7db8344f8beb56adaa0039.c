/*
 * XREFs of ??$QueryValueMultisz@V_lambda_7b34f67d2fe748a9991e85b83cffda76_@@V_lambda_7db8344f8beb56adaa003951e6a1fc8c_@@@KRegKey@@QEAAJPEBU_UNICODE_STRING@@V_lambda_7b34f67d2fe748a9991e85b83cffda76_@@V_lambda_7db8344f8beb56adaa003951e6a1fc8c_@@@Z @ 0x1C00DD264
 * Callers:
...
__int64 KRegKey::QueryValueMultisz<_lambda_7b34f67d2fe748a9991e85b83cffda76_,_lambda_7db8344f8beb56adaa003951e6a1fc8c_>(
        HANDLE *a1,
        _UNICODE_STRING *a2,
        __int64 a3,
        ...)
  ...
  if ( v15 <= 0x80 )
  {
    ...
    while ( *v12 )
    {
      ...
      do
        ++v18;
      while ( *v18 );
      v9 = lambda_7db8344f8beb56adaa003951e6a1fc8c_::operator()((__int64 *)va, v12, v17);
      if ( v9 < 0 )
        goto LABEL_17;
      v12 = v18 + 1;
      ++v17;
