/*
 * XREFs of ?ndisRegisterProtocolDriverCommon@@YAXPEAU_NDIS_PROTOCOL_BLOCK@@@Z @ 0x1C001EBD4
 * Callers:
 ...
 *     ?SetDirty@BindEngine@Ndis@@QEAAXXZ @ 0x1C00AE54C (-SetDirty@BindEngine@Ndis@@QEAAXXZ.c)
 */
