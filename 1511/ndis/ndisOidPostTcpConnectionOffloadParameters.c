/*
 * XREFs of ndisOidPostTcpConnectionOffloadParameters @ 0x1C00436A0
 * Callers:
 *     <none>
 * Callees:
...
void __fastcall ndisOidPostTcpConnectionOffloadParameters(__int64 a1)
{
  ...
  {
    WPP_SF_qq(0xE2u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v1, v3);
    v4 = byte_1C0083712;
  }
  ...
  if ( (unsigned __int8)v4 >= 4u )
    WPP_SF_qD(0xE3u, &WPP_7d93857a3aef6cac0cffd1e7320acdf9_Traceguids, v1, *(_DWORD *)(a1 + 40));
}
